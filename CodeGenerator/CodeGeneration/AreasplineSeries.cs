...
namespace Highsoft.Web.Mvc
{
	public partial class AreasplineSeries
	{
		public AreasplineSeries()
		{
			...
			PointPlacement = PointPlacement_DefaultValue = AreasplineSeriesPointPlacement.Null;
			...
			Zones = Zones_DefaultValue = new AreasplineSeriesZones();
		...
		/// </summary>
		public AreasplineSeriesData Data { get; set; }
		private AreasplineSeriesData Data_DefaultValue { get; set; }
