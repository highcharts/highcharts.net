...
{
	public partial class AreasplinerangeSeriesStatesHover  : BaseObject
	{
		public AreasplinerangeSeriesStatesHover()
		{
			...
			Marker = Marker_DefaultValue = new AreasplinerangeSeriesStatesHoverMarker();
		...
		/// </summary>
		public AreasplinerangeSeriesStatesHoverHalo Halo { get; set; }
		private AreasplinerangeSeriesStatesHoverHalo Halo_DefaultValue { get; set; }
		...
		/// 
		/// </summary>
		public AreasplinerangeSeriesStatesHoverMarker Marker { get; set; }
		private AreasplinerangeSeriesStatesHoverMarker Marker_DefaultValue { get; set; }
