...
{
	public partial class ColumnSeriesMarker  : BaseObject
	{
		public ColumnSeriesMarker()
		{
			...
			States = States_DefaultValue = new ColumnSeriesMarkerStates();
		...
		/// 
		/// </summary>
		public ColumnSeriesMarkerStates States { get; set; }
		private ColumnSeriesMarkerStates States_DefaultValue { get; set; }
