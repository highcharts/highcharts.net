...
{
	public partial class ColumnSeriesMarkerStates  : BaseObject
	{
		public ColumnSeriesMarkerStates()
		{
			Hover = Hover_DefaultValue = new ColumnSeriesMarkerStatesHover();
			Select = Select_DefaultValue = new ColumnSeriesMarkerStatesSelect();
