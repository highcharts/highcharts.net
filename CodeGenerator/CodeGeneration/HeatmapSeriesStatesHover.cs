...
{
	public partial class HeatmapSeriesStatesHover  
	{
		public HeatmapSeriesStatesHover()
		{
			Enabled = Enabled_DefaultValue = true;
			Halo = Halo_DefaultValue = new HeatmapSeriesStatesHoverHalo();
			LineWidth = LineWidth_DefaultValue = 2;
			LineWidthPlus = LineWidthPlus_DefaultValue = 1;
			Marker = Marker_DefaultValue = new HeatmapSeriesStatesHoverMarker();
		...
		/// 
		/// </summary>
		public HeatmapSeriesStatesHoverMarker Marker { get; set; }
		private HeatmapSeriesStatesHoverMarker Marker_DefaultValue { get; set; }
