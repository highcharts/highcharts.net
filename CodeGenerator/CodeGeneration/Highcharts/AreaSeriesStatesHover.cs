...
{
	public partial class AreaSeriesStatesHover  : BaseObject
	{
		public AreaSeriesStatesHover()
		{
			Enabled = Enabled_DefaultValue = true;
			Halo = Halo_DefaultValue = new AreaSeriesStatesHoverHalo();
			LineWidth = LineWidth_DefaultValue = 2;
			LineWidthPlus = LineWidthPlus_DefaultValue = 1;
			Marker = Marker_DefaultValue = new AreaSeriesStatesHoverMarker();
