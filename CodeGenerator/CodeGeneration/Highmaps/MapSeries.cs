...
{
	public partial class MapSeries  : Series
	{
		public MapSeries()
		{
			...
			Cursor = Cursor_DefaultValue = MapSeriesCursor.Null;
			DashStyle = DashStyle_DefaultValue = MapSeriesDashStyle.Solid;
			Data = Data_DefaultValue = new List<MapSeriesData>();
			DataLabels = DataLabels_DefaultValue = new MapSeriesDataLabels();
			EnableMouseTracking = EnableMouseTracking_DefaultValue = true;
			Events = Events_DefaultValue = new MapSeriesEvents();
			Id = Id_DefaultValue = "";
			...
			Point = Point_DefaultValue = new MapSeriesPoint();
			Selected = Selected_DefaultValue = false;
			Shadow = Shadow_DefaultValue = new Shadow() { Enabled = false };
			ShowCheckbox = ShowCheckbox_DefaultValue = false;
			ShowInLegend = ShowInLegend_DefaultValue = true;
			States = States_DefaultValue = new MapSeriesStates();
			StickyTracking = StickyTracking_DefaultValue = false;
			Tooltip = Tooltip_DefaultValue = new MapSeriesTooltip();
			Type = Type_DefaultValue = MapSeriesType.Null;
		...
		/// </summary>
		public MapSeriesCursor Cursor { get; set; }
		private MapSeriesCursor Cursor_DefaultValue { get; set; }
		...
		/// 
		/// </summary>
		public MapSeriesEvents Events { get; set; }
		private MapSeriesEvents Events_DefaultValue { get; set; }
		...
		/// </summary>
		public MapSeriesPoint Point { get; set; }
		private MapSeriesPoint Point_DefaultValue { get; set; }
		...
		/// </summary>
		public MapSeriesStates States { get; set; }
		private MapSeriesStates States_DefaultValue { get; set; }
		...
		/// </summary>
		public MapSeriesTooltip Tooltip { get; set; }
		private MapSeriesTooltip Tooltip_DefaultValue { get; set; }
		...
		/// </summary>
		public MapSeriesType Type { get; set; }
		private MapSeriesType Type_DefaultValue { get; set; }
