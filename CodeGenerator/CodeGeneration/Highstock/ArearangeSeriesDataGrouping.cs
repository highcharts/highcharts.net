...
namespace Highsoft.Web.Mvc.Stocks
{
	public partial class ArearangeSeriesDataGrouping  : BaseObject
	{
		...
		internal override Hashtable ToHashtable()
		{
			...
			if (Approximation != Approximation_DefaultValue) { h.Add("approximation",Approximation); Highstock.AddFunction("ArearangeSeriesDataGroupingApproximation.approximation", Approximation); }  
