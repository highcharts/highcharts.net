...
namespace Highsoft.Web.Mvc.Highstock
{
	public partial class CandleStickSeries  : Series
	{
		public CandleStickSeries()
		{
			...
			UpColor = UpColor_DefaultValue = "'white'";
			...
			Zones = Zones_DefaultValue = new CandleStickSeriesZones();
