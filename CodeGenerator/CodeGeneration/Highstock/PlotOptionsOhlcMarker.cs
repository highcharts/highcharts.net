...
{
	public partial class PlotOptionsOhlcMarker  : BaseObject
	{
		public PlotOptionsOhlcMarker()
		{
			...
			States = States_DefaultValue = new PlotOptionsOhlcMarkerStates();
		...
		/// 
		/// </summary>
		public PlotOptionsOhlcMarkerStates States { get; set; }
		private PlotOptionsOhlcMarkerStates States_DefaultValue { get; set; }
