...
namespace Highsoft.Web.Mvc.Highstock
{
	public partial class PolygonSeriesDataGrouping  : BaseObject
	{
		...
		internal override Hashtable ToHashtable()
		{
			...
			if (Approximation != Approximation_DefaultValue) { h.Add("approximation",Approximation); Highstock.AddFunction("PolygonSeriesDataGroupingApproximation.approximation", Approximation); }  
