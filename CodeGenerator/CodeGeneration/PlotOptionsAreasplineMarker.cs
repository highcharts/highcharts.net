...
{
	public partial class PlotOptionsAreasplineMarker  : BaseObject
	{
		public PlotOptionsAreasplineMarker()
		{
			...
			States = States_DefaultValue = new PlotOptionsAreasplineMarkerStates();
			Symbol = Symbol_DefaultValue = PlotOptionsAreasplineMarkerSymbol.Null;
		...
		private PlotOptionsAreasplineMarkerStates States_DefaultValue { get; set; }
		...
		/// </summary>
		public PlotOptionsAreasplineMarkerSymbol Symbol { get; set; }
		private PlotOptionsAreasplineMarkerSymbol Symbol_DefaultValue { get; set; }
