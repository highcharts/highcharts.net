...
{
	public partial class PlotOptionsBubbleStatesHover  
	{
		public PlotOptionsBubbleStatesHover()
		{
			...
			Marker = Marker_DefaultValue = new PlotOptionsBubbleStatesHoverMarker();
		...
		private PlotOptionsBubbleStatesHoverMarker Marker_DefaultValue { get; set; }
