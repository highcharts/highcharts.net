...
{
	public partial class PlotOptionsBubbleTooltip 
	{
		...
		internal Hashtable ToHashtable()
		{
			...
			if (PointFormatter != PointFormatter_DefaultValue) { h.Add("pointFormatter",PointFormatter); Highcharts.AddFunction("PlotOptionsBubbleTooltipPointFormatter.pointFormatter", PointFormatter); }  
