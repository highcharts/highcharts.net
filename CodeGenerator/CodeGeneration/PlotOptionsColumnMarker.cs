...
{
	public partial class PlotOptionsColumnMarker  : BaseObject
	{
		public PlotOptionsColumnMarker()
		{
			...
			States = States_DefaultValue = new PlotOptionsColumnMarkerStates();
		...
		/// 
		/// </summary>
		public PlotOptionsColumnMarkerStates States { get; set; }
		private PlotOptionsColumnMarkerStates States_DefaultValue { get; set; }
