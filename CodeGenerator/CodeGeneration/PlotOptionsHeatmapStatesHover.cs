...
{
	public partial class PlotOptionsHeatmapStatesHover  
	{
		public PlotOptionsHeatmapStatesHover()
		{
			Enabled = Enabled_DefaultValue = true;
			Halo = Halo_DefaultValue = new PlotOptionsHeatmapStatesHoverHalo();
			LineWidth = LineWidth_DefaultValue = 2;
			LineWidthPlus = LineWidthPlus_DefaultValue = 1;
			Marker = Marker_DefaultValue = new PlotOptionsHeatmapStatesHoverMarker();
		...
		/// 
		/// </summary>
		public PlotOptionsHeatmapStatesHoverMarker Marker { get; set; }
		private PlotOptionsHeatmapStatesHoverMarker Marker_DefaultValue { get; set; }
