...
{
	public partial class PlotOptionsPolygonTooltip  
	{
		...
		internal Hashtable ToHashtable()
		{
			...
			if (PointFormatter != PointFormatter_DefaultValue) { h.Add("pointFormatter",PointFormatter); Highcharts.AddFunction("PlotOptionsPolygonTooltipPointFormatter.pointFormatter", PointFormatter); }  
