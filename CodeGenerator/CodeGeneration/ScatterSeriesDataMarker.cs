...
{
	public partial class ScatterSeriesDataMarker  : BaseObject
	{
		public ScatterSeriesDataMarker()
		{
			...
			States = States_DefaultValue = new ScatterSeriesDataMarkerStates();
			Symbol = Symbol_DefaultValue = ScatterSeriesDataMarkerSymbol.Null;
		...
		/// 
		/// </summary>
		public ScatterSeriesDataMarkerStates States { get; set; }
		private ScatterSeriesDataMarkerStates States_DefaultValue { get; set; }
		...
		/// </summary>
		public ScatterSeriesDataMarkerSymbol Symbol { get; set; }
		private ScatterSeriesDataMarkerSymbol Symbol_DefaultValue { get; set; }
