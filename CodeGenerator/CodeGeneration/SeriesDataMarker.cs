...
{
	public partial class SeriesDataMarker
	{
		public SeriesDataMarker()
		{
			...
			States = States_DefaultValue = new SeriesDataMarkerStates();
			Symbol = Symbol_DefaultValue = SeriesDataMarkerSymbol.Null;
		...
		private SeriesDataMarkerStates States_DefaultValue { get; set; }
		...
		/// </summary>
		public SeriesDataMarkerSymbol Symbol { get; set; }
		private SeriesDataMarkerSymbol Symbol_DefaultValue { get; set; }
