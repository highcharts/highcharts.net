...
{
	public partial class SolidgaugeSeriesStatesHoverMarker  
	{
		public SolidgaugeSeriesStatesHoverMarker()
		{
			...
			Symbol = Symbol_DefaultValue = SolidgaugeSeriesStatesHoverMarkerSymbol.Null;
		...
		/// </summary>
		public SolidgaugeSeriesStatesHoverMarkerSymbol Symbol { get; set; }
		private SolidgaugeSeriesStatesHoverMarkerSymbol Symbol_DefaultValue { get; set; }
