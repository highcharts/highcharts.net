...
namespace Highsoft.Web.Mvc
{
	public partial class SplineSeries
	{
		public SplineSeries()
		{
			...
			PointPlacement = PointPlacement_DefaultValue = SplineSeriesPointPlacement.Null;
			...
			Zones = Zones_DefaultValue = new SplineSeriesZones();
