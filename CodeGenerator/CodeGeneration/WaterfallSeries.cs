...
{
	public partial class WaterfallSeries
	{
		public WaterfallSeries()
		{
			...
			Data = Data_DefaultValue = new WaterfallSeriesData();
			...
			PointPlacement = PointPlacement_DefaultValue = WaterfallSeriesPointPlacement.Null;
		...
		/// </summary>
		public WaterfallSeriesData Data { get; set; }
		private WaterfallSeriesData Data_DefaultValue { get; set; }
