...
public partial class generatoraspx : System.Web.UI.Page
{
    ...
    Hashtable enumMappings; // maps enums values that do not complile (e.g. special characters like "-" or "/" to other types
    ...
    private void GenerateEnum(ApiItem apiItem)
    {
        ...
        for (int i = 0; i < apiItem.Values.Count; i++)
        {
            ...
            if (!String.IsNullOrEmpty(apiItem.Values[i]))
            {
                ...
                if (enumMappings[enumValue] != null)
                    enumValue = enumMappings[enumValue] as string;
    ...
    {
        enumMappings.Add("triangle-down", "triangledown");
        enumMappings.Add("image/png", "imagepng");
        enumMappings.Add("image/jpeg", "imagejpeg");
        enumMappings.Add("application/pdf", "applicationpdf");
        enumMappings.Add("image/svg+xml", "imagesvgxml");
    }
