...
namespace Highsoft.Web.Mvc
{
	public partial class AreaSeries
	{
		public AreaSeries()
		{
			...
			Data = Data_DefaultValue = new AreaSeriesData();
			...
			PointPlacement = PointPlacement_DefaultValue = AreaSeriesPointPlacement.Null;
		...
		/// </summary>
		public AreaSeriesData Data { get; set; }
		private AreaSeriesData Data_DefaultValue { get; set; }
