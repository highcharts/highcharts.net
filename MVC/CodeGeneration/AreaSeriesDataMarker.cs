...
{
	public partial class AreaSeriesDataMarker  : BaseObject
	{
		public AreaSeriesDataMarker()
		{
			...
			States = States_DefaultValue = new AreaSeriesDataMarkerStates();
			Symbol = Symbol_DefaultValue = AreaSeriesDataMarkerSymbol.Null;
		...
		/// 
		/// </summary>
		public AreaSeriesDataMarkerStates States { get; set; }
		private AreaSeriesDataMarkerStates States_DefaultValue { get; set; }
		...
		/// </summary>
		public AreaSeriesDataMarkerSymbol Symbol { get; set; }
		private AreaSeriesDataMarkerSymbol Symbol_DefaultValue { get; set; }
