...
{
	public partial class AreaSeriesMarker  : BaseObject
	{
		public AreaSeriesMarker()
		{
			...
			States = States_DefaultValue = new AreaSeriesMarkerStates();
			Symbol = Symbol_DefaultValue = AreaSeriesMarkerSymbol.Null;
		...
		/// 
		/// </summary>
		public AreaSeriesMarkerStates States { get; set; }
		private AreaSeriesMarkerStates States_DefaultValue { get; set; }
		...
		/// </summary>
		public AreaSeriesMarkerSymbol Symbol { get; set; }
		private AreaSeriesMarkerSymbol Symbol_DefaultValue { get; set; }
