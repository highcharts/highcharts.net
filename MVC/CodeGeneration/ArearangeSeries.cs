...
{
	public partial class ArearangeSeries
	{
		public ArearangeSeries()
		{
			...
			Data = Data_DefaultValue = new ArearangeSeriesData();
			...
			PointPlacement = PointPlacement_DefaultValue = ArearangeSeriesPointPlacement.Null;
			...
			Step = Step_DefaultValue = ArearangeSeriesStep.False;
			...
			Zones = Zones_DefaultValue = new ArearangeSeriesZones();
