...
{
	public partial class AreasplineSeriesDataMarker  : BaseObject
	{
		public AreasplineSeriesDataMarker()
		{
			...
			States = States_DefaultValue = new AreasplineSeriesDataMarkerStates();
			Symbol = Symbol_DefaultValue = AreasplineSeriesDataMarkerSymbol.Null;
		...
		/// 
		/// </summary>
		public AreasplineSeriesDataMarkerStates States { get; set; }
		private AreasplineSeriesDataMarkerStates States_DefaultValue { get; set; }
		...
		/// </summary>
		public AreasplineSeriesDataMarkerSymbol Symbol { get; set; }
		private AreasplineSeriesDataMarkerSymbol Symbol_DefaultValue { get; set; }
