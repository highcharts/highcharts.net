...
namespace Highsoft.Web.Mvc
{
	public partial class AreasplinerangeSeries
	{
		public AreasplinerangeSeries()
		{
			...
			Data = Data_DefaultValue = new AreasplinerangeSeriesData();
			...
			PointPlacement = PointPlacement_DefaultValue = AreasplinerangeSeriesPointPlacement.Null;
			...
			Step = Step_DefaultValue = AreasplinerangeSeriesStep.False;
