...
namespace Highsoft.Web.Mvc
{
	public partial class BarSeries : Series
	{
		public BarSeries()
		{
			...
			PointPlacement = PointPlacement_DefaultValue = BarSeriesPointPlacement.Null;
			...
			Zones = Zones_DefaultValue = new BarSeriesZones();
		...
		/// </summary>
		public BarSeriesZones Zones { get; set; }
		private BarSeriesZones Zones_DefaultValue { get; set; }
