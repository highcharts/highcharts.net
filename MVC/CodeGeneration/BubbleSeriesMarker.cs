...
{
	public partial class BubbleSeriesMarker
	{
		public BubbleSeriesMarker()
		{
			...
			Symbol = Symbol_DefaultValue = BubbleSeriesMarkerSymbol.Null;
		...
		/// </summary>
		public BubbleSeriesMarkerSymbol Symbol { get; set; }
		private BubbleSeriesMarkerSymbol Symbol_DefaultValue { get; set; }
