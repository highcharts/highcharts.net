...
{
	public partial class ErrorbarSeries
	{
		public ErrorbarSeries()
		{
			...
			Data = Data_DefaultValue = new ErrorbarSeriesData();
			...
			PointPlacement = PointPlacement_DefaultValue = ErrorbarSeriesPointPlacement.Null;
			...
			Zones = Zones_DefaultValue = new ErrorbarSeriesZones();
