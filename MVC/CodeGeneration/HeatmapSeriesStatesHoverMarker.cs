...
{
	public partial class HeatmapSeriesStatesHoverMarker  : BaseObject
	{
		public HeatmapSeriesStatesHoverMarker()
		{
			...
			Symbol = Symbol_DefaultValue = HeatmapSeriesStatesHoverMarkerSymbol.Null;
		...
		/// </summary>
		public HeatmapSeriesStatesHoverMarkerSymbol Symbol { get; set; }
		private HeatmapSeriesStatesHoverMarkerSymbol Symbol_DefaultValue { get; set; }
