...
{
	public partial class LineSeriesMarker  : BaseObject
	{
		public LineSeriesMarker()
		{
			...
			States = States_DefaultValue = new LineSeriesMarkerStates();
			Symbol = Symbol_DefaultValue = LineSeriesMarkerSymbol.Null;
		...
		/// 
		/// </summary>
		public LineSeriesMarkerStates States { get; set; }
		private LineSeriesMarkerStates States_DefaultValue { get; set; }
		...
		/// </summary>
		public LineSeriesMarkerSymbol Symbol { get; set; }
		private LineSeriesMarkerSymbol Symbol_DefaultValue { get; set; }
