...
{
	public partial class PlotOptionsBarStatesHoverMarker
	{
		public PlotOptionsBarStatesHoverMarker()
		{
			...
			Symbol = Symbol_DefaultValue = PlotOptionsBarStatesHoverMarkerSymbol.Null;
		...
		/// </summary>
		public PlotOptionsBarStatesHoverMarkerSymbol Symbol { get; set; }
		private PlotOptionsBarStatesHoverMarkerSymbol Symbol_DefaultValue { get; set; }
