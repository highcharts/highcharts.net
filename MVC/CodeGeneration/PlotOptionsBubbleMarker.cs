...
{
	public partial class PlotOptionsBubbleMarker
	{
		public PlotOptionsBubbleMarker()
		{
			...
			Symbol = Symbol_DefaultValue = PlotOptionsBubbleMarkerSymbol.Null;
		...
		/// </summary>
		public PlotOptionsBubbleMarkerSymbol Symbol { get; set; }
		private PlotOptionsBubbleMarkerSymbol Symbol_DefaultValue { get; set; }
