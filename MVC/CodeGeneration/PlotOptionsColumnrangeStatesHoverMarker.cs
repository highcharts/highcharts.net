...
{
	public partial class PlotOptionsColumnrangeStatesHoverMarker
	{
		public PlotOptionsColumnrangeStatesHoverMarker()
		{
			...
			Symbol = Symbol_DefaultValue = PlotOptionsColumnrangeStatesHoverMarkerSymbol.Null;
		...
		private  States_DefaultValue { get; set; }
		...
		/// </summary>
		public PlotOptionsColumnrangeStatesHoverMarkerSymbol Symbol { get; set; }
		private PlotOptionsColumnrangeStatesHoverMarkerSymbol Symbol_DefaultValue { get; set; }
