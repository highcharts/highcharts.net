...
{
	public partial class PlotOptionsErrorbarTooltip 
	{
		...
		internal Hashtable ToHashtable()
		{
			...
			if (PointFormatter != PointFormatter_DefaultValue) { h.Add("pointFormatter",PointFormatter); Highcharts.AddFunction("PlotOptionsErrorbarTooltipPointFormatter.pointFormatter", PointFormatter); }  
