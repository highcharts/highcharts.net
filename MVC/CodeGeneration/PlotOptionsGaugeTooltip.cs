...
namespace Highsoft.Web.Mvc
{
	public partial class PlotOptionsGaugeTooltip  : BaseObject
	{
		...
		internal override Hashtable ToHashtable()
		{
			...
			if (PointFormatter != PointFormatter_DefaultValue) { h.Add("pointFormatter",PointFormatter); Highcharts.AddFunction("PlotOptionsGaugeTooltipPointFormatter.pointFormatter", PointFormatter); }  
