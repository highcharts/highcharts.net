...
{
	public partial class PlotOptionsLineMarker  : BaseObject
	{
		public PlotOptionsLineMarker()
		{
			...
			States = States_DefaultValue = new PlotOptionsLineMarkerStates();
			Symbol = Symbol_DefaultValue = PlotOptionsLineMarkerSymbol.Null;
		...
		private PlotOptionsLineMarkerStates States_DefaultValue { get; set; }
		...
		/// </summary>
		public PlotOptionsLineMarkerSymbol Symbol { get; set; }
		private PlotOptionsLineMarkerSymbol Symbol_DefaultValue { get; set; }
