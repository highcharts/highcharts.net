...
{
	public partial class PlotOptionsPolygonMarker  : BaseObject
	{
		public PlotOptionsPolygonMarker()
		{
			...
			Symbol = Symbol_DefaultValue = PlotOptionsPolygonMarkerSymbol.Null;
		...
		/// </summary>
		public PlotOptionsPolygonMarkerSymbol Symbol { get; set; }
		private PlotOptionsPolygonMarkerSymbol Symbol_DefaultValue { get; set; }
