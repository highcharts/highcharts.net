...
{
	public partial class PlotOptionsScatterMarker 
	{
		public PlotOptionsScatterMarker()
		{
			...
			States = States_DefaultValue = new PlotOptionsScatterMarkerStates();
			Symbol = Symbol_DefaultValue = PlotOptionsScatterMarkerSymbol.Null;
		...
		private PlotOptionsScatterMarkerStates States_DefaultValue { get; set; }
		...
		/// </summary>
		public PlotOptionsScatterMarkerSymbol Symbol { get; set; }
		private PlotOptionsScatterMarkerSymbol Symbol_DefaultValue { get; set; }
