...
{
	public partial class PlotOptionsScatterStatesHoverMarker
	{
		public PlotOptionsScatterStatesHoverMarker()
		{
			...
			Symbol = Symbol_DefaultValue = PlotOptionsScatterStatesHoverMarkerSymbol.Null;
		...
		/// </summary>
		public PlotOptionsScatterStatesHoverMarkerSymbol Symbol { get; set; }
		private PlotOptionsScatterStatesHoverMarkerSymbol Symbol_DefaultValue { get; set; }
