...
{
	public partial class PlotOptionsWaterfallStatesHover
	{
		public PlotOptionsWaterfallStatesHover()
		{
			Enabled = Enabled_DefaultValue = true;
			Halo = Halo_DefaultValue = new PlotOptionsWaterfallStatesHoverHalo();
			LineWidth = LineWidth_DefaultValue = 2;
			LineWidthPlus = LineWidthPlus_DefaultValue = 1;
			Marker = Marker_DefaultValue = new PlotOptionsWaterfallStatesHoverMarker();
		...
		private PlotOptionsWaterfallStatesHoverHalo Halo_DefaultValue { get; set; }
		...
		private PlotOptionsWaterfallStatesHoverMarker Marker_DefaultValue { get; set; }
