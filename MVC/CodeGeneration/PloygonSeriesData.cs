...
{
	public partial class PloygonSeriesData  : BaseObject
	{
		public PloygonSeriesData()
		{
			Color = Color_DefaultValue = "undefined";
			DataLabels = DataLabels_DefaultValue = null;
			Drilldown = Drilldown_DefaultValue = "";
			Events = Events_DefaultValue = new PloygonSeriesDataEvents();
			Id = Id_DefaultValue = null;
			Marker = Marker_DefaultValue = new PloygonSeriesDataMarker();
		...
		/// </summary>
		public PloygonSeriesDataEvents Events { get; set; }
		private PloygonSeriesDataEvents Events_DefaultValue { get; set; }
		...
		/// 
		/// </summary>
		public PloygonSeriesDataMarker Marker { get; set; }
		private PloygonSeriesDataMarker Marker_DefaultValue { get; set; }
