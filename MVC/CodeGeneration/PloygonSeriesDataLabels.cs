...
{
	public partial class PloygonSeriesDataLabels  : BaseObject
	{
		public PloygonSeriesDataLabels()
		{
			Align = Align_DefaultValue = PloygonSeriesDataLabelsAlign.Center;
			...
			Overflow = Overflow_DefaultValue = PloygonSeriesDataLabelsOverflow.Justify;
			...
			VerticalAlign = VerticalAlign_DefaultValue = PloygonSeriesDataLabelsVerticalAlign.Null;
			X = X_DefaultValue = 0;
			Y = Y_DefaultValue = -6;
		...
		/// </summary>
		public PloygonSeriesDataLabelsAlign Align { get; set; }
		private PloygonSeriesDataLabelsAlign Align_DefaultValue { get; set; }
		...
		/// </summary>
		public PloygonSeriesDataLabelsOverflow Overflow { get; set; }
		private PloygonSeriesDataLabelsOverflow Overflow_DefaultValue { get; set; }
		...
		/// </summary>
		public PloygonSeriesDataLabelsVerticalAlign VerticalAlign { get; set; }
		private PloygonSeriesDataLabelsVerticalAlign VerticalAlign_DefaultValue { get; set; }
		...
		internal override Hashtable ToHashtable()
		{
			...
			if (Formatter != Formatter_DefaultValue) { h.Add("formatter",Formatter); Highcharts.AddFunction("PloygonSeriesDataLabelsFormatter.formatter", Formatter); }  
