...
{
	public partial class PloygonSeriesDataMarker  : BaseObject
	{
		public PloygonSeriesDataMarker()
		{
			...
			States = States_DefaultValue = new PloygonSeriesDataMarkerStates();
			Symbol = Symbol_DefaultValue = PloygonSeriesDataMarkerSymbol.Null;
		...
		/// 
		/// </summary>
		public PloygonSeriesDataMarkerStates States { get; set; }
		private PloygonSeriesDataMarkerStates States_DefaultValue { get; set; }
		...
		/// </summary>
		public PloygonSeriesDataMarkerSymbol Symbol { get; set; }
		private PloygonSeriesDataMarkerSymbol Symbol_DefaultValue { get; set; }
