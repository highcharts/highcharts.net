...
{
	public partial class PloygonSeriesMarker  : BaseObject
	{
		public PloygonSeriesMarker()
		{
			...
			States = States_DefaultValue = new PloygonSeriesMarkerStates();
			Symbol = Symbol_DefaultValue = PloygonSeriesMarkerSymbol.Null;
		...
		/// 
		/// </summary>
		public PloygonSeriesMarkerStates States { get; set; }
		private PloygonSeriesMarkerStates States_DefaultValue { get; set; }
		...
		/// </summary>
		public PloygonSeriesMarkerSymbol Symbol { get; set; }
		private PloygonSeriesMarkerSymbol Symbol_DefaultValue { get; set; }
