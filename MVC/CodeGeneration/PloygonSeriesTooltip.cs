...
{
	public partial class PloygonSeriesTooltip  : BaseObject
	{
		public PloygonSeriesTooltip()
		{
		...
		internal override Hashtable ToHashtable()
		{
			...
			if (PointFormatter != PointFormatter_DefaultValue) { h.Add("pointFormatter",PointFormatter); Highcharts.AddFunction("PloygonSeriesTooltipPointFormatter.pointFormatter", PointFormatter); }  
