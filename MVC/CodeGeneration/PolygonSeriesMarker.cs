...
namespace Highsoft.Web.Mvc
{
	public partial class PolygonSeriesMarker  : BaseObject
	{
		public PolygonSeriesMarker()
		{
			...
			Symbol = Symbol_DefaultValue = PolygonSeriesMarkerSymbol.Null;
		...
		/// </summary>
		public PolygonSeriesMarkerSymbol Symbol { get; set; }
		private PolygonSeriesMarkerSymbol Symbol_DefaultValue { get; set; }
