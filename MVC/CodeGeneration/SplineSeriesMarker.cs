...
{
	public partial class SplineSeriesMarker  : BaseObject
	{
		public SplineSeriesMarker()
		{
			...
			States = States_DefaultValue = new SplineSeriesMarkerStates();
			Symbol = Symbol_DefaultValue = SplineSeriesMarkerSymbol.Null;
		...
		/// 
		/// </summary>
		public SplineSeriesMarkerStates States { get; set; }
		private SplineSeriesMarkerStates States_DefaultValue { get; set; }
		...
		/// </summary>
		public SplineSeriesMarkerSymbol Symbol { get; set; }
		private SplineSeriesMarkerSymbol Symbol_DefaultValue { get; set; }
