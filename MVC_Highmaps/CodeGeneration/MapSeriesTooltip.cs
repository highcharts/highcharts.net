...
namespace Highsoft.Web.Mvc.Maps
{
	public partial class MapSeriesTooltip  : BaseObject
	{
		...
		internal override Hashtable ToHashtable()
		{
			...
			if (PointFormatter != PointFormatter_DefaultValue) { h.Add("pointFormatter",PointFormatter); Highmaps.AddFunction("MapSeriesTooltipPointFormatter.pointFormatter", PointFormatter); }  
