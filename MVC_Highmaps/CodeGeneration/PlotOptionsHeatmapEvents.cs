...
namespace Highsoft.Web.Mvc.Maps
{
	public partial class PlotOptionsHeatmapEvents  : BaseObject
	{
		...
		internal override Hashtable ToHashtable()
		{
			...
			if (CheckboxClick != CheckboxClick_DefaultValue) { h.Add("checkboxClick",CheckboxClick); Highmaps.AddFunction("PlotOptionsHeatmapEventsCheckboxClick.checkboxClick", CheckboxClick); }  
			if (Click != Click_DefaultValue) { h.Add("click",Click); Highmaps.AddFunction("PlotOptionsHeatmapEventsClick.click", Click); }  
			if (Hide != Hide_DefaultValue) { h.Add("hide",Hide); Highmaps.AddFunction("PlotOptionsHeatmapEventsHide.hide", Hide); }  
			if (LegendItemClick != LegendItemClick_DefaultValue) { h.Add("legendItemClick",LegendItemClick); Highmaps.AddFunction("PlotOptionsHeatmapEventsLegendItemClick.legendItemClick", LegendItemClick); }  
			if (MouseOut != MouseOut_DefaultValue) { h.Add("mouseOut",MouseOut); Highmaps.AddFunction("PlotOptionsHeatmapEventsMouseOut.mouseOut", MouseOut); }  
			if (MouseOver != MouseOver_DefaultValue) { h.Add("mouseOver",MouseOver); Highmaps.AddFunction("PlotOptionsHeatmapEventsMouseOver.mouseOver", MouseOver); }  
			if (Show != Show_DefaultValue) { h.Add("show",Show); Highmaps.AddFunction("PlotOptionsHeatmapEventsShow.show", Show); }  
