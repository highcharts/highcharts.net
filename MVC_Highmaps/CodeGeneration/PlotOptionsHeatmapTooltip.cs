...
namespace Highsoft.Web.Mvc.Maps
{
	public partial class PlotOptionsHeatmapTooltip  : BaseObject
	{
		...
		internal override Hashtable ToHashtable()
		{
			...
			if (PointFormatter != PointFormatter_DefaultValue) { h.Add("pointFormatter",PointFormatter); Highmaps.AddFunction("PlotOptionsHeatmapTooltipPointFormatter.pointFormatter", PointFormatter); }  
