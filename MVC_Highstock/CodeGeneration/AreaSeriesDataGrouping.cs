...
namespace Highsoft.Web.Mvc.Highstock
{
	public partial class AreaSeriesDataGrouping  : BaseObject
	{
		...
		internal override Hashtable ToHashtable()
		{
			...
			if (Approximation != Approximation_DefaultValue) { h.Add("approximation",Approximation); Highstock.AddFunction("AreaSeriesDataGroupingApproximation.approximation", Approximation); }  
