...
namespace Highsoft.Web.Mvc.Highstock
{
	public partial class CandleStickSeriesDataGrouping  : BaseObject
	{
		...
		internal override Hashtable ToHashtable()
		{
			...
			if (Approximation != Approximation_DefaultValue) { h.Add("approximation",Approximation); Highstock.AddFunction("CandleStickSeriesDataGroupingApproximation.approximation", Approximation); }  
