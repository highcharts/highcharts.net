...
namespace Highsoft.Web.Mvc
{
	public partial class ChartEvents  : BaseObject
	{
		...
		internal override Hashtable ToHashtable()
		{
			...
			if (Drilldown != Drilldown_DefaultValue) { h.Add("drilldown",Drilldown); Highstock.AddFunction("ChartEventsDrilldown.drilldown", Drilldown); }  
			if (Drillup != Drillup_DefaultValue) { h.Add("drillup",Drillup); Highstock.AddFunction("ChartEventsDrillup.drillup", Drillup); }  
