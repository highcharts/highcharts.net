...
namespace Highsoft.Web.Mvc.Stocks
{
	public partial class ColumnrangeSeriesDataGrouping  : BaseObject
	{
		...
		internal override Hashtable ToHashtable()
		{
			...
			if (Approximation != Approximation_DefaultValue) { h.Add("approximation",Approximation); Highstock.AddFunction("ColumnrangeSeriesDataGroupingApproximation.approximation", Approximation); }  
