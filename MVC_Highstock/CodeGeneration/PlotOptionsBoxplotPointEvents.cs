...
namespace Highsoft.Web.Mvc
{
	public partial class PlotOptionsBoxplotPointEvents  : BaseObject
	{
		...
		internal override Hashtable ToHashtable()
		{
			...
			if (Click != Click_DefaultValue) { h.Add("click",Click); Highstock.AddFunction("PlotOptionsBoxplotPointEventsClick.click", Click); }  
			if (MouseOut != MouseOut_DefaultValue) { h.Add("mouseOut",MouseOut); Highstock.AddFunction("PlotOptionsBoxplotPointEventsMouseOut.mouseOut", MouseOut); }  
			if (MouseOver != MouseOver_DefaultValue) { h.Add("mouseOver",MouseOver); Highstock.AddFunction("PlotOptionsBoxplotPointEventsMouseOver.mouseOver", MouseOver); }  
			if (Remove != Remove_DefaultValue) { h.Add("remove",Remove); Highstock.AddFunction("PlotOptionsBoxplotPointEventsRemove.remove", Remove); }  
			if (Select != Select_DefaultValue) { h.Add("select",Select); Highstock.AddFunction("PlotOptionsBoxplotPointEventsSelect.select", Select); }  
			if (Unselect != Unselect_DefaultValue) { h.Add("unselect",Unselect); Highstock.AddFunction("PlotOptionsBoxplotPointEventsUnselect.unselect", Unselect); }  
			if (Update != Update_DefaultValue) { h.Add("update",Update); Highstock.AddFunction("PlotOptionsBoxplotPointEventsUpdate.update", Update); }  
