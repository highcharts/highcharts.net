...
{
	public partial class PlotOptionsCandlestickMarker  : BaseObject
	{
		public PlotOptionsCandlestickMarker()
		{
			...
			States = States_DefaultValue = new PlotOptionsCandlestickMarkerStates();
		...
		/// 
		/// </summary>
		public PlotOptionsCandlestickMarkerStates States { get; set; }
		private PlotOptionsCandlestickMarkerStates States_DefaultValue { get; set; }
