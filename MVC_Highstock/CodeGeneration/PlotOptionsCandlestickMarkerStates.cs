...
{
	public partial class PlotOptionsCandlestickMarkerStates  : BaseObject
	{
		public PlotOptionsCandlestickMarkerStates()
		{
			Hover = Hover_DefaultValue = new PlotOptionsCandlestickMarkerStatesHover();
			Select = Select_DefaultValue = new PlotOptionsCandlestickMarkerStatesSelect();
