...
namespace Highstock.Web.Mvc
{
	public partial class PlotOptionsColumnDataGrouping  : BaseObject
	{
		...
		internal override Hashtable ToHashtable()
		{
			...
			if (Approximation != Approximation_DefaultValue) { h.Add("approximation",Approximation); Highstock.AddFunction("PlotOptionsColumnDataGroupingApproximation.approximation", Approximation); }  
