...
namespace Highsoft.Web.Mvc.Highstock
{
	public partial class SplineSeriesDataGrouping  : BaseObject
	{
		...
		internal override Hashtable ToHashtable()
		{
			...
			if (Approximation != Approximation_DefaultValue) { h.Add("approximation",Approximation); Highstock.AddFunction("SplineSeriesDataGroupingApproximation.approximation", Approximation); }  
