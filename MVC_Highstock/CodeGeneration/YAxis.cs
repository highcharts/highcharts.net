...
namespace Highsoft.Web.Mvc
{
	public partial class YAxis  : BaseObject
	{
		...
		internal override Hashtable ToHashtable()
		{
			...
			if (GridLineInterpolation != GridLineInterpolation_DefaultValue) h.Add("gridLineInterpolation", Highstock.FirstCharacterToLower(GridLineInterpolation.ToString()));
