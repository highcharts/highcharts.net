...
namespace Highsoft.Web.Mvc.Maps
{
	public partial class Navigation  : BaseObject
	{
		...
		/// <summary>
		/// <p>A collection of options for buttons appearing in the exporting module.</p><p>The examples below are using basic Highcharts, but the syntax is exactly the same for Highmaps.</p>
		/// </summary>
