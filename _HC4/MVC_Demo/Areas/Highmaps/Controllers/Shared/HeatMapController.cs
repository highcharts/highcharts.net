...
namespace MVC_Demo.Areas.Highmaps.Controllers.Shared
{
    public partial class SharedController : Controller
    {
        public ActionResult HeatMap()
        {
            ...
            data.Add(new HeatmapSeriesData { X = 0, Y = 0, Value = 1110 , Color = "#FF0808"});
            data.Add(new HeatmapSeriesData { X = 0, Y = 1, Value = 1119 });
            data.Add(new HeatmapSeriesData { X = 0, Y = 2, Value = 128 });
            data.Add(new HeatmapSeriesData { X = 0, Y = 3, Value = 1124 });
            data.Add(new HeatmapSeriesData { X = 0, Y = 4, Value = 1167 });
            data.Add(new HeatmapSeriesData { X = 1, Y = 4, Value = 192 });
            data.Add(new HeatmapSeriesData { X = 1, Y = 1, Value = 158 });
            data.Add(new HeatmapSeriesData { X = 1, Y = 2, Value = 178 });
            data.Add(new HeatmapSeriesData { X = 1, Y = 3, Value = 117 });
            data.Add(new HeatmapSeriesData { X = 1, Y = 4, Value = 148 });
