...
{
	public partial class MapBubbleSeriesDataLabels  : BaseObject
	{
		public MapBubbleSeriesDataLabels()
		{
			Align = Align_DefaultValue = MapBubbleSeriesDataLabelsAlign.Center;
			...
			Overflow = Overflow_DefaultValue = MapBubbleSeriesDataLabelsOverflow.Justify;
			...
			VerticalAlign = VerticalAlign_DefaultValue = MapBubbleSeriesDataLabelsVerticalAlign.Null;
			X = X_DefaultValue = 0;
			Y = Y_DefaultValue = -6;
		...
		/// </summary>
		public MapBubbleSeriesDataLabelsAlign Align { get; set; }
		private MapBubbleSeriesDataLabelsAlign Align_DefaultValue { get; set; }
		...
		/// </summary>
		public MapBubbleSeriesDataLabelsOverflow Overflow { get; set; }
		private MapBubbleSeriesDataLabelsOverflow Overflow_DefaultValue { get; set; }
		...
		/// </summary>
		public MapBubbleSeriesDataLabelsVerticalAlign VerticalAlign { get; set; }
		private MapBubbleSeriesDataLabelsVerticalAlign VerticalAlign_DefaultValue { get; set; }
		...
		internal override Hashtable ToHashtable()
		{
			...
			if (Formatter != Formatter_DefaultValue) { h.Add("formatter",Formatter); Highmaps.AddFunction("MapBubbleSeriesDataLabelsFormatter.formatter", Formatter); }  
