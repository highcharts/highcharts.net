...
namespace Highsoft.Web.Mvc.Maps
{
	public partial class MapBubbleSeriesTooltip  : BaseObject
	{
		...
		internal override Hashtable ToHashtable()
		{
			...
			if (PointFormatter != PointFormatter_DefaultValue) { h.Add("pointFormatter",PointFormatter); Highmaps.AddFunction("MapBubbleSeriesTooltipPointFormatter.pointFormatter", PointFormatter); }  
