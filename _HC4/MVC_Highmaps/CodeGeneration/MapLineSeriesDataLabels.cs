...
{
	public partial class MapLineSeriesDataLabels  : BaseObject
	{
		public MapLineSeriesDataLabels()
		{
			Align = Align_DefaultValue = MapLineSeriesDataLabelsAlign.Center;
			...
			Overflow = Overflow_DefaultValue = MapLineSeriesDataLabelsOverflow.Justify;
			...
			VerticalAlign = VerticalAlign_DefaultValue = MapLineSeriesDataLabelsVerticalAlign.Null;
			X = X_DefaultValue = 0;
			Y = Y_DefaultValue = -6;
		...
		/// </summary>
		public MapLineSeriesDataLabelsAlign Align { get; set; }
		private MapLineSeriesDataLabelsAlign Align_DefaultValue { get; set; }
		...
		/// </summary>
		public MapLineSeriesDataLabelsOverflow Overflow { get; set; }
		private MapLineSeriesDataLabelsOverflow Overflow_DefaultValue { get; set; }
		...
		/// </summary>
		public MapLineSeriesDataLabelsVerticalAlign VerticalAlign { get; set; }
		private MapLineSeriesDataLabelsVerticalAlign VerticalAlign_DefaultValue { get; set; }
		...
		internal override Hashtable ToHashtable()
		{
			...
			if (Formatter != Formatter_DefaultValue) { h.Add("formatter",Formatter); Highmaps.AddFunction("MapLineSeriesDataLabelsFormatter.formatter", Formatter); }  
