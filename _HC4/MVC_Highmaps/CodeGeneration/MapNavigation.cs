...
namespace Highsoft.Web.Mvc.Maps
{
	public partial class MapNavigation  : BaseObject
	{
		public MapNavigation()
		{
			...
			EnableDoubleClickZoom = EnableDoubleClickZoom_DefaultValue = false;
			EnableDoubleClickZoomTo = EnableDoubleClickZoomTo_DefaultValue = false;
			EnableMouseWheelZoom = EnableMouseWheelZoom_DefaultValue = false;
			EnableTouchZoom = EnableTouchZoom_DefaultValue = false;
