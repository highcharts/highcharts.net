...
{
	public partial class PlotOptionsMapDataLabels  : BaseObject
	{
		public PlotOptionsMapDataLabels()
		{
			Align = Align_DefaultValue = PlotOptionsMapDataLabelsAlign.Center;
			...
			Overflow = Overflow_DefaultValue = PlotOptionsMapDataLabelsOverflow.Justify;
			...
			VerticalAlign = VerticalAlign_DefaultValue = PlotOptionsMapDataLabelsVerticalAlign.Null;
			X = X_DefaultValue = 0;
			Y = Y_DefaultValue = -6;
		...
		/// </summary>
		public PlotOptionsMapDataLabelsAlign Align { get; set; }
		private PlotOptionsMapDataLabelsAlign Align_DefaultValue { get; set; }
		...
		/// </summary>
		public PlotOptionsMapDataLabelsOverflow Overflow { get; set; }
		private PlotOptionsMapDataLabelsOverflow Overflow_DefaultValue { get; set; }
		...
		/// </summary>
		public PlotOptionsMapDataLabelsVerticalAlign VerticalAlign { get; set; }
		private PlotOptionsMapDataLabelsVerticalAlign VerticalAlign_DefaultValue { get; set; }
		...
		internal override Hashtable ToHashtable()
		{
			...
			if (Formatter != Formatter_DefaultValue) { h.Add("formatter",Formatter); Highmaps.AddFunction("PlotOptionsMapDataLabelsFormatter.formatter", Formatter); }  
