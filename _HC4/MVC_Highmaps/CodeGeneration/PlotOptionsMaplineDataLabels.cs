...
{
	public partial class PlotOptionsMaplineDataLabels  : BaseObject
	{
		public PlotOptionsMaplineDataLabels()
		{
			Align = Align_DefaultValue = PlotOptionsMaplineDataLabelsAlign.Center;
			...
			Overflow = Overflow_DefaultValue = PlotOptionsMaplineDataLabelsOverflow.Justify;
			...
			VerticalAlign = VerticalAlign_DefaultValue = PlotOptionsMaplineDataLabelsVerticalAlign.Null;
			X = X_DefaultValue = 0;
			Y = Y_DefaultValue = -6;
		...
		/// </summary>
		public PlotOptionsMaplineDataLabelsAlign Align { get; set; }
		private PlotOptionsMaplineDataLabelsAlign Align_DefaultValue { get; set; }
		...
		/// </summary>
		public PlotOptionsMaplineDataLabelsOverflow Overflow { get; set; }
		private PlotOptionsMaplineDataLabelsOverflow Overflow_DefaultValue { get; set; }
		...
		/// </summary>
		public PlotOptionsMaplineDataLabelsVerticalAlign VerticalAlign { get; set; }
		private PlotOptionsMaplineDataLabelsVerticalAlign VerticalAlign_DefaultValue { get; set; }
		...
		internal override Hashtable ToHashtable()
		{
			...
			if (Formatter != Formatter_DefaultValue) { h.Add("formatter",Formatter); Highmaps.AddFunction("PlotOptionsMaplineDataLabelsFormatter.formatter", Formatter); }  
