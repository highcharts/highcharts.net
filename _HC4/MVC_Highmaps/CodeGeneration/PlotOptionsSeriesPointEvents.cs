...
namespace Highsoft.Web.Mvc.Maps
{
	public partial class PlotOptionsSeriesPointEvents  : BaseObject
	{
		...
		internal override Hashtable ToHashtable()
		{
			...
			if (Click != Click_DefaultValue) { h.Add("click",Click); Highmaps.AddFunction("PlotOptionsSeriesPointEventsClick.click", Click); }  
			if (MouseOut != MouseOut_DefaultValue) { h.Add("mouseOut",MouseOut); Highmaps.AddFunction("PlotOptionsSeriesPointEventsMouseOut.mouseOut", MouseOut); }  
			if (MouseOver != MouseOver_DefaultValue) { h.Add("mouseOver",MouseOver); Highmaps.AddFunction("PlotOptionsSeriesPointEventsMouseOver.mouseOver", MouseOver); }  
			if (Remove != Remove_DefaultValue) { h.Add("remove",Remove); Highmaps.AddFunction("PlotOptionsSeriesPointEventsRemove.remove", Remove); }  
			if (Select != Select_DefaultValue) { h.Add("select",Select); Highmaps.AddFunction("PlotOptionsSeriesPointEventsSelect.select", Select); }  
			if (Unselect != Unselect_DefaultValue) { h.Add("unselect",Unselect); Highmaps.AddFunction("PlotOptionsSeriesPointEventsUnselect.unselect", Unselect); }  
			if (Update != Update_DefaultValue) { h.Add("update",Update); Highmaps.AddFunction("PlotOptionsSeriesPointEventsUpdate.update", Update); }  
