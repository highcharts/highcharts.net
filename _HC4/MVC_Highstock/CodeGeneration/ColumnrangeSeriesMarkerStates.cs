...
{
	public partial class ColumnrangeSeriesMarkerStates  : BaseObject
	{
		public ColumnrangeSeriesMarkerStates()
		{
			Hover = Hover_DefaultValue = new ColumnrangeSeriesMarkerStatesHover();
			Select = Select_DefaultValue = new ColumnrangeSeriesMarkerStatesSelect();
