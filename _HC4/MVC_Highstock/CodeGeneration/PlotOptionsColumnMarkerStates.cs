...
{
	public partial class PlotOptionsColumnMarkerStates  : BaseObject
	{
		public PlotOptionsColumnMarkerStates()
		{
			Hover = Hover_DefaultValue = new PlotOptionsColumnMarkerStatesHover();
			Select = Select_DefaultValue = new PlotOptionsColumnMarkerStatesSelect();
