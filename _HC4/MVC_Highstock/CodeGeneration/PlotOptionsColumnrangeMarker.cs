...
{
	public partial class PlotOptionsColumnrangeMarker  : BaseObject
	{
		public PlotOptionsColumnrangeMarker()
		{
			...
			States = States_DefaultValue = new PlotOptionsColumnrangeMarkerStates();
		...
		/// 
		/// </summary>
		public PlotOptionsColumnrangeMarkerStates States { get; set; }
		private PlotOptionsColumnrangeMarkerStates States_DefaultValue { get; set; }
