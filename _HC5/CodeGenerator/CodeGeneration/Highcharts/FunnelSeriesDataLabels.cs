...
namespace Highsoft.Web.Mvc.Charts
{
	public partial class FunnelSeriesDataLabels  : BaseObject
	{
		public FunnelSeriesDataLabels()
		{
			...
			Overflow = Overflow_DefaultValue = FunnelSeriesDataLabelsOverflow.Justify;
			...
			VerticalAlign = VerticalAlign_DefaultValue = FunnelSeriesDataLabelsVerticalAlign.Null;
			X = X_DefaultValue = 0;
			Y = Y_DefaultValue = -6;
		...
		/// </summary>
		public FunnelSeriesDataLabelsVerticalAlign VerticalAlign { get; set; }
		private FunnelSeriesDataLabelsVerticalAlign VerticalAlign_DefaultValue { get; set; }
		...
		internal override Hashtable ToHashtable()
		{
			...
			if (Formatter != Formatter_DefaultValue) { h.Add("formatter",Formatter); Highcharts.AddFunction("FunnelSeriesDataLabelsFormatter.formatter", Formatter); }  
