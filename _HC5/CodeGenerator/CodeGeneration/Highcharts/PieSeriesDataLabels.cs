...
{
	public partial class PieSeriesDataLabels  : BaseObject
	{
		public PieSeriesDataLabels()
		{
			...
			Overflow = Overflow_DefaultValue = PieSeriesDataLabelsOverflow.Justify;
			...
			VerticalAlign = VerticalAlign_DefaultValue = PieSeriesDataLabelsVerticalAlign.Null;
			X = X_DefaultValue = 0;
			Y = Y_DefaultValue = -6;
		...
		/// <summary>
		/// <p>The color of the line connecting the data label to the pie slice. The default color is the same as the point's color.</p><p>In <a href="http://www.highcharts.com/docs/chart-design-and-style/style-by-css">styled mode</a>, the connector stroke is given in the <code>.highcharts-data-label-connector</code> class.</p>
		/// </summary>
		...
		/// <summary>
		/// <p>The width of the line connecting the data label to the pie slice.</p><p>In <a href="http://www.highcharts.com/docs/chart-design-and-style/style-by-css">styled mode</a>, the connector stroke width is given in the <code>.highcharts-data-label-connector</code> class.</p>
		/// </summary>
		...
		/// </summary>
		public PieSeriesDataLabelsOverflow Overflow { get; set; }
		private PieSeriesDataLabelsOverflow Overflow_DefaultValue { get; set; }
		...
		/// </summary>
		public PieSeriesDataLabelsVerticalAlign VerticalAlign { get; set; }
		private PieSeriesDataLabelsVerticalAlign VerticalAlign_DefaultValue { get; set; }
		...
		internal override Hashtable ToHashtable()
		{
			...
			if (Formatter != Formatter_DefaultValue) { h.Add("formatter",Formatter); Highcharts.AddFunction("PieSeriesDataLabelsFormatter.formatter", Formatter); }  
