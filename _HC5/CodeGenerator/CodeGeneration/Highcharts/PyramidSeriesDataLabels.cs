...
namespace Highsoft.Web.Mvc.Charts
{
	public partial class PyramidSeriesDataLabels  : BaseObject
	{
		public PyramidSeriesDataLabels()
		{
			...
			VerticalAlign = VerticalAlign_DefaultValue = PyramidSeriesDataLabelsVerticalAlign.Null;
			X = X_DefaultValue = 0;
			Y = Y_DefaultValue = -6;
		...
		internal override Hashtable ToHashtable()
		{
			...
			if (Formatter != Formatter_DefaultValue) { h.Add("formatter",Formatter); Highcharts.AddFunction("PyramidSeriesDataLabelsFormatter.formatter", Formatter); }  
