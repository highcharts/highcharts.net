...
namespace Highsoft.Web.Mvc.Stocks
{
	public partial class AreaSeries  : Series
	{
		public AreaSeries()
		{
			...
			Step = Step_DefaultValue = AreaSeriesStep.False;
			...
			Zones = Zones_DefaultValue = new AreaSeriesZones();
