...
namespace Highsoft.Web.Mvc.Stocks
{
	public partial class PlotOptionsAreaDataGrouping  : BaseObject
	{
		...
		internal override Hashtable ToHashtable()
		{
			...
			if (Approximation != Approximation_DefaultValue) { h.Add("approximation",Approximation); Highstock.AddFunction("PlotOptionsAreaDataGroupingApproximation.approximation", Approximation); }  
