...
namespace Highsoft.Web.Mvc.Stocks
{
	public partial class PlotOptionsAreasplineDataGrouping  : BaseObject
	{
		...
		internal override Hashtable ToHashtable()
		{
			...
			if (Approximation != Approximation_DefaultValue) { h.Add("approximation",Approximation); Highstock.AddFunction("PlotOptionsAreasplineDataGroupingApproximation.approximation", Approximation); }  
