...
{
	public partial class PlotOptionsColumnrangeMarkerStates  : BaseObject
	{
		public PlotOptionsColumnrangeMarkerStates()
		{
			Hover = Hover_DefaultValue = new PlotOptionsColumnrangeMarkerStatesHover();
			Select = Select_DefaultValue = new PlotOptionsColumnrangeMarkerStatesSelect();
