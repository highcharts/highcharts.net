...
namespace Highsoft.Web.Mvc.Stocks
{
	public partial class PlotOptionsSeriesDataGrouping  : BaseObject
	{
		...
		internal override Hashtable ToHashtable()
		{
			...
			if (Approximation != Approximation_DefaultValue) { h.Add("approximation",Approximation); Highstock.AddFunction("PlotOptionsSeriesDataGroupingApproximation.approximation", Approximation); }  
