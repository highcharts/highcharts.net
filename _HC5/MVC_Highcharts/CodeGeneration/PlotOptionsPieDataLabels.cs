...
namespace Highsoft.Web.Mvc.Charts
{
	public partial class PlotOptionsPieDataLabels  : BaseObject
	{
		public PlotOptionsPieDataLabels()
		{
			...
			VerticalAlign = VerticalAlign_DefaultValue = PlotOptionsPieDataLabelsVerticalAlign.Null;
			X = X_DefaultValue = 0;
			Y = Y_DefaultValue = -6;
		...
		internal override Hashtable ToHashtable()
		{
			...
			if (Formatter != Formatter_DefaultValue) { h.Add("formatter",Formatter); Highcharts.AddFunction("PlotOptionsPieDataLabelsFormatter.formatter", Formatter); }  
