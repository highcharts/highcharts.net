...
namespace Highsoft.Web.Mvc.Charts
{
	public partial class ZAxis  : BaseObject
	{
		public ZAxis()
		{
			...
			TickmarkPlacement = TickmarkPlacement_DefaultValue = ZAxisTickmarkPlacement.Null;
		...
		internal override Hashtable ToHashtable()
		{
			...
			if (Crosshair != Crosshair_DefaultValue) h.Add("crosshair", Crosshair);
			...
			if (TickPositioner != TickPositioner_DefaultValue) { h.Add("tickPositioner",TickPositioner); Highcharts.AddFunction("ZAxisTickPositioner.tickPositioner", TickPositioner); }  
