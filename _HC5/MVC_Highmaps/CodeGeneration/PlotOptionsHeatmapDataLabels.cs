...
namespace Highsoft.Web.Mvc.Maps
{
	public partial class PlotOptionsHeatmapDataLabels  : BaseObject
	{
		public PlotOptionsHeatmapDataLabels()
		{
			...
			VerticalAlign = VerticalAlign_DefaultValue = PlotOptionsHeatmapDataLabelsVerticalAlign.Null;
			X = X_DefaultValue = 0;
			Y = Y_DefaultValue = -6;
		...
		internal override Hashtable ToHashtable()
		{
			...
			if (Formatter != Formatter_DefaultValue) { h.Add("formatter",Formatter); Highmaps.AddFunction("PlotOptionsHeatmapDataLabelsFormatter.formatter", Formatter); }  
