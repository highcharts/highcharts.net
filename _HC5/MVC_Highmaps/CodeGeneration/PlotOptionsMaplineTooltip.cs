...
namespace Highsoft.Web.Mvc.Maps
{
	public partial class PlotOptionsMaplineTooltip  : BaseObject
	{
		...
		internal override Hashtable ToHashtable()
		{
			...
			if (PointFormatter != PointFormatter_DefaultValue) { h.Add("pointFormatter",PointFormatter); Highmaps.AddFunction("PlotOptionsMaplineTooltipPointFormatter.pointFormatter", PointFormatter); }  
