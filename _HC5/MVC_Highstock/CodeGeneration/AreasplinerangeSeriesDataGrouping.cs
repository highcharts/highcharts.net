...
namespace Highsoft.Web.Mvc.Stocks
{
	public partial class AreasplinerangeSeriesDataGrouping  : BaseObject
	{
		...
		internal override Hashtable ToHashtable()
		{
			...
			if (Approximation != Approximation_DefaultValue) { h.Add("approximation",Approximation); Highstock.AddFunction("AreasplinerangeSeriesDataGroupingApproximation.approximation", Approximation); }  
