...
{
    public partial class ColumnSeriesDataGrouping : BaseObject
    {
        public ColumnSeriesDataGrouping()
        {
            ...
            //Units = Units_DefaultValue = @"[['millisecond',[1,2,5,10,20,25,50,100,200,500]],['second',[1,2,5,10,15,30]],['minute',[1,2,5,10,15,30]],['hour',[1,2,3,4,6,8,12]],['day',[1]],['week',[1]],['month',[1,3,6]],['year',null]]";
        ...
        //private string Units_DefaultValue { get; set; }
        ...
        internal override Hashtable ToHashtable()
        {
            ...
            if (Approximation != Approximation_DefaultValue) { h.Add("approximation", Approximation); Highstock.AddFunction("ColumnSeriesDataGroupingApproximation.approximation", Approximation); }
