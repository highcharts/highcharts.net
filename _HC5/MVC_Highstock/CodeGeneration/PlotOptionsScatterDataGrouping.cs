...
namespace Highsoft.Web.Mvc.Stocks
{
	public partial class PlotOptionsScatterDataGrouping  : BaseObject
	{
		...
		internal override Hashtable ToHashtable()
		{
			...
			if (Approximation != Approximation_DefaultValue) { h.Add("approximation",Approximation); Highstock.AddFunction("PlotOptionsScatterDataGroupingApproximation.approximation", Approximation); }  
