...
{
	public partial class BellcurveSeriesDragDropDragHandle  : BaseObject
	{
		public BellcurveSeriesDragDropDragHandle()
		{
		...
		internal override Hashtable ToHashtable()
		{
			...
			if (PathFormatter != PathFormatter_DefaultValue) { h.Add("pathFormatter",PathFormatter); Highcharts.AddFunction("BellcurveSeriesDragDropDragHandlePathFormatter.pathFormatter", PathFormatter); }  
