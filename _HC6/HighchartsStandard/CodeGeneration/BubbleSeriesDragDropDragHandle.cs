...
{
	public partial class BubbleSeriesDragDropDragHandle  : BaseObject
	{
		public BubbleSeriesDragDropDragHandle()
		{
		...
		internal override Hashtable ToHashtable()
		{
			...
			if (PathFormatter != PathFormatter_DefaultValue) { h.Add("pathFormatter",PathFormatter); Highcharts.AddFunction("BubbleSeriesDragDropDragHandlePathFormatter.pathFormatter", PathFormatter); }  
