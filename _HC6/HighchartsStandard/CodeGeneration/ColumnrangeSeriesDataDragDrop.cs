...
{
	public partial class ColumnrangeSeriesDataDragDrop  : BaseObject
	{
		public ColumnrangeSeriesDataDragDrop()
		{
			DraggableX = DraggableX_DefaultValue = null;
			DraggableY = DraggableY_DefaultValue = null;
			DragHandle = DragHandle_DefaultValue = new ColumnrangeSeriesDataDragDropDragHandle();
			...
			GuideBox = GuideBox_DefaultValue = new ColumnrangeSeriesDataDragDropGuideBox();
		...
		/// </summary>
		public ColumnrangeSeriesDataDragDropDragHandle DragHandle { get; set; }
		private ColumnrangeSeriesDataDragDropDragHandle DragHandle_DefaultValue { get; set; }
		...
		/// </summary>
		public ColumnrangeSeriesDataDragDropGuideBox GuideBox { get; set; }
		private ColumnrangeSeriesDataDragDropGuideBox GuideBox_DefaultValue { get; set; }
