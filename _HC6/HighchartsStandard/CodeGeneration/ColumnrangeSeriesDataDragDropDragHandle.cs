...
{
	public partial class ColumnrangeSeriesDataDragDropDragHandle  : BaseObject
	{
		public ColumnrangeSeriesDataDragDropDragHandle()
		{
		...
		internal override Hashtable ToHashtable()
		{
			...
			if (PathFormatter != PathFormatter_DefaultValue) { h.Add("pathFormatter",PathFormatter); Highcharts.AddFunction("ColumnrangeSeriesDataDragDropDragHandlePathFormatter.pathFormatter", PathFormatter); }  
