...
{
	public partial class FunnelSeriesDataDragDropDragHandle  : BaseObject
	{
		public FunnelSeriesDataDragDropDragHandle()
		{
		...
		internal override Hashtable ToHashtable()
		{
			...
			if (PathFormatter != PathFormatter_DefaultValue) { h.Add("pathFormatter",PathFormatter); Highcharts.AddFunction("FunnelSeriesDataDragDropDragHandlePathFormatter.pathFormatter", PathFormatter); }  
