...
{
	public partial class FunnelSeriesDragDrop  : BaseObject
	{
		public FunnelSeriesDragDrop()
		{
			DraggableX = DraggableX_DefaultValue = null;
			DraggableY = DraggableY_DefaultValue = null;
			DragHandle = DragHandle_DefaultValue = new FunnelSeriesDragDropDragHandle();
			...
			GuideBox = GuideBox_DefaultValue = new FunnelSeriesDragDropGuideBox();
		...
		/// </summary>
		public FunnelSeriesDragDropDragHandle DragHandle { get; set; }
		private FunnelSeriesDragDropDragHandle DragHandle_DefaultValue { get; set; }
		...
		/// </summary>
		public FunnelSeriesDragDropGuideBox GuideBox { get; set; }
		private FunnelSeriesDragDropGuideBox GuideBox_DefaultValue { get; set; }
