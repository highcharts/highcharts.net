...
{
	public partial class GaugeSeriesDragDrop  : BaseObject
	{
		public GaugeSeriesDragDrop()
		{
			DraggableX = DraggableX_DefaultValue = null;
			DraggableY = DraggableY_DefaultValue = null;
			DragHandle = DragHandle_DefaultValue = new GaugeSeriesDragDropDragHandle();
			...
			GuideBox = GuideBox_DefaultValue = new GaugeSeriesDragDropGuideBox();
		...
		/// </summary>
		public GaugeSeriesDragDropDragHandle DragHandle { get; set; }
		private GaugeSeriesDragDropDragHandle DragHandle_DefaultValue { get; set; }
