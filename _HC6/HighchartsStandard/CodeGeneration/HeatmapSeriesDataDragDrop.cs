...
{
	public partial class HeatmapSeriesDataDragDrop  : BaseObject
	{
		public HeatmapSeriesDataDragDrop()
		{
			DraggableX = DraggableX_DefaultValue = null;
			DraggableY = DraggableY_DefaultValue = null;
			DragHandle = DragHandle_DefaultValue = new HeatmapSeriesDataDragDropDragHandle();
			...
			GuideBox = GuideBox_DefaultValue = new HeatmapSeriesDataDragDropGuideBox();
		...
		/// </summary>
		public HeatmapSeriesDataDragDropDragHandle DragHandle { get; set; }
		private HeatmapSeriesDataDragDropDragHandle DragHandle_DefaultValue { get; set; }
		...
		/// </summary>
		public HeatmapSeriesDataDragDropGuideBox GuideBox { get; set; }
		private HeatmapSeriesDataDragDropGuideBox GuideBox_DefaultValue { get; set; }
