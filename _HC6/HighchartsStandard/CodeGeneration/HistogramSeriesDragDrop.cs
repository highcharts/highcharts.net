...
{
	public partial class HistogramSeriesDragDrop  : BaseObject
	{
		public HistogramSeriesDragDrop()
		{
			DraggableX = DraggableX_DefaultValue = null;
			DraggableY = DraggableY_DefaultValue = null;
			DragHandle = DragHandle_DefaultValue = new HistogramSeriesDragDropDragHandle();
			...
			GuideBox = GuideBox_DefaultValue = new HistogramSeriesDragDropGuideBox();
		...
		/// </summary>
		public HistogramSeriesDragDropDragHandle DragHandle { get; set; }
		private HistogramSeriesDragDropDragHandle DragHandle_DefaultValue { get; set; }
		...
		/// </summary>
		public HistogramSeriesDragDropGuideBox GuideBox { get; set; }
		private HistogramSeriesDragDropGuideBox GuideBox_DefaultValue { get; set; }
