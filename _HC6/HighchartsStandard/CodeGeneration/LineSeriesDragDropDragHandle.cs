...
{
	public partial class LineSeriesDragDropDragHandle  : BaseObject
	{
		public LineSeriesDragDropDragHandle()
		{
		...
		internal override Hashtable ToHashtable()
		{
			...
			if (PathFormatter != PathFormatter_DefaultValue) { h.Add("pathFormatter",PathFormatter); Highcharts.AddFunction("LineSeriesDragDropDragHandlePathFormatter.pathFormatter", PathFormatter); }  
