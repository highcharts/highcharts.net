...
{
	public partial class PlotOptionsErrorbarDragDrop  : BaseObject
	{
		public PlotOptionsErrorbarDragDrop()
		{
			...
			GuideBox = GuideBox_DefaultValue = new PlotOptionsErrorbarDragDropGuideBox();
		...
		/// </summary>
		public PlotOptionsErrorbarDragDropDragHandle DragHandle { get; set; }
		private PlotOptionsErrorbarDragDropDragHandle DragHandle_DefaultValue { get; set; }
		...
		/// </summary>
		public PlotOptionsErrorbarDragDropGuideBox GuideBox { get; set; }
		private PlotOptionsErrorbarDragDropGuideBox GuideBox_DefaultValue { get; set; }
