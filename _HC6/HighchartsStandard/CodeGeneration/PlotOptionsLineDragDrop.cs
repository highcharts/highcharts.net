...
{
	public partial class PlotOptionsLineDragDrop  : BaseObject
	{
		public PlotOptionsLineDragDrop()
		{
			DraggableX = DraggableX_DefaultValue = null;
			DraggableY = DraggableY_DefaultValue = null;
			DragHandle = DragHandle_DefaultValue = new PlotOptionsLineDragDropDragHandle();
			...
			GuideBox = GuideBox_DefaultValue = new PlotOptionsLineDragDropGuideBox();
		...
		/// </summary>
		public PlotOptionsLineDragDropDragHandle DragHandle { get; set; }
		private PlotOptionsLineDragDropDragHandle DragHandle_DefaultValue { get; set; }
		...
		/// </summary>
		public PlotOptionsLineDragDropGuideBox GuideBox { get; set; }
		private PlotOptionsLineDragDropGuideBox GuideBox_DefaultValue { get; set; }
