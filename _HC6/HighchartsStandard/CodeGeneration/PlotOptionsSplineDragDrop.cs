...
{
	public partial class PlotOptionsSplineDragDrop  : BaseObject
	{
		public PlotOptionsSplineDragDrop()
		{
			DraggableX = DraggableX_DefaultValue = null;
			DraggableY = DraggableY_DefaultValue = null;
			DragHandle = DragHandle_DefaultValue = new PlotOptionsSplineDragDropDragHandle();
			...
			GuideBox = GuideBox_DefaultValue = new PlotOptionsSplineDragDropGuideBox();
		...
		/// </summary>
		public PlotOptionsSplineDragDropDragHandle DragHandle { get; set; }
		private PlotOptionsSplineDragDropDragHandle DragHandle_DefaultValue { get; set; }
		...
		/// </summary>
		public PlotOptionsSplineDragDropGuideBox GuideBox { get; set; }
		private PlotOptionsSplineDragDropGuideBox GuideBox_DefaultValue { get; set; }
