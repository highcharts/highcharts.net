...
{
	public partial class PlotOptionsVariablepieDragDropDragHandle  : BaseObject
	{
		public PlotOptionsVariablepieDragDropDragHandle()
		{
		...
		internal override Hashtable ToHashtable()
		{
			...
			if (PathFormatter != PathFormatter_DefaultValue) { h.Add("pathFormatter",PathFormatter); Highcharts.AddFunction("PlotOptionsVariablepieDragDropDragHandlePathFormatter.pathFormatter", PathFormatter); }  
