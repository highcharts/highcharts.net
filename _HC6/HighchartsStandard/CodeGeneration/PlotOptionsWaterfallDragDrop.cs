...
{
	public partial class PlotOptionsWaterfallDragDrop  : BaseObject
	{
		public PlotOptionsWaterfallDragDrop()
		{
			DraggableX = DraggableX_DefaultValue = null;
			DraggableY = DraggableY_DefaultValue = null;
			DragHandle = DragHandle_DefaultValue = new PlotOptionsWaterfallDragDropDragHandle();
			...
			GuideBox = GuideBox_DefaultValue = new PlotOptionsWaterfallDragDropGuideBox();
		...
		/// </summary>
		public PlotOptionsWaterfallDragDropDragHandle DragHandle { get; set; }
		private PlotOptionsWaterfallDragDropDragHandle DragHandle_DefaultValue { get; set; }
		...
		/// </summary>
		public PlotOptionsWaterfallDragDropGuideBox GuideBox { get; set; }
		private PlotOptionsWaterfallDragDropGuideBox GuideBox_DefaultValue { get; set; }
