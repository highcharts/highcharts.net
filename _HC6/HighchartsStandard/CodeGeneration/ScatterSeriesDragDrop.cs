...
{
	public partial class ScatterSeriesDragDrop  : BaseObject
	{
		public ScatterSeriesDragDrop()
		{
			DraggableX = DraggableX_DefaultValue = null;
			DraggableY = DraggableY_DefaultValue = null;
			DragHandle = DragHandle_DefaultValue = new ScatterSeriesDragDropDragHandle();
			...
			GuideBox = GuideBox_DefaultValue = new ScatterSeriesDragDropGuideBox();
		...
		/// </summary>
		public ScatterSeriesDragDropDragHandle DragHandle { get; set; }
		private ScatterSeriesDragDropDragHandle DragHandle_DefaultValue { get; set; }
		...
		/// </summary>
		public ScatterSeriesDragDropGuideBox GuideBox { get; set; }
		private ScatterSeriesDragDropGuideBox GuideBox_DefaultValue { get; set; }
