...
{
	public partial class SolidgaugeSeriesDataDragDrop  : BaseObject
	{
		public SolidgaugeSeriesDataDragDrop()
		{
			DraggableX = DraggableX_DefaultValue = null;
			DraggableY = DraggableY_DefaultValue = null;
			DragHandle = DragHandle_DefaultValue = new SolidgaugeSeriesDataDragDropDragHandle();
			...
			GuideBox = GuideBox_DefaultValue = new SolidgaugeSeriesDataDragDropGuideBox();
		...
		/// </summary>
		public SolidgaugeSeriesDataDragDropDragHandle DragHandle { get; set; }
		private SolidgaugeSeriesDataDragDropDragHandle DragHandle_DefaultValue { get; set; }
		...
		/// </summary>
		public SolidgaugeSeriesDataDragDropGuideBox GuideBox { get; set; }
		private SolidgaugeSeriesDataDragDropGuideBox GuideBox_DefaultValue { get; set; }
