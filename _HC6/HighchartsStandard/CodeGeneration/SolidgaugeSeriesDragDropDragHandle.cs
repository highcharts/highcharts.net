...
{
	public partial class SolidgaugeSeriesDragDropDragHandle  : BaseObject
	{
		public SolidgaugeSeriesDragDropDragHandle()
		{
		...
		internal override Hashtable ToHashtable()
		{
			...
			if (PathFormatter != PathFormatter_DefaultValue) { h.Add("pathFormatter",PathFormatter); Highcharts.AddFunction("SolidgaugeSeriesDragDropDragHandlePathFormatter.pathFormatter", PathFormatter); }  
