...
{
	public partial class StreamgraphSeriesStatesHover  : BaseObject
	{
		public StreamgraphSeriesStatesHover()
		{
			Animation = Animation_DefaultValue = new Animation() { Enabled = true };
			AnimationBool = AnimationBool_DefaultValue = null;
			Enabled = Enabled_DefaultValue = true;
			Halo = Halo_DefaultValue = new StreamgraphSeriesStatesHoverHalo();
			LineWidth = LineWidth_DefaultValue = null;
			LineWidthPlus = LineWidthPlus_DefaultValue = 1;
			Marker = Marker_DefaultValue = new StreamgraphSeriesStatesHoverMarker();
		...
		/// </summary>
		public StreamgraphSeriesStatesHoverHalo Halo { get; set; }
		private StreamgraphSeriesStatesHoverHalo Halo_DefaultValue { get; set; }
		...
		/// </summary>
		public StreamgraphSeriesStatesHoverMarker Marker { get; set; }
		private StreamgraphSeriesStatesHoverMarker Marker_DefaultValue { get; set; }
