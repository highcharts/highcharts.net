...
{
	public partial class SunburstSeriesDataDragDrop  : BaseObject
	{
		public SunburstSeriesDataDragDrop()
		{
			DraggableX = DraggableX_DefaultValue = null;
			DraggableY = DraggableY_DefaultValue = null;
			DragHandle = DragHandle_DefaultValue = new SunburstSeriesDataDragDropDragHandle();
			...
			GuideBox = GuideBox_DefaultValue = new SunburstSeriesDataDragDropGuideBox();
		...
		/// </summary>
		public SunburstSeriesDataDragDropDragHandle DragHandle { get; set; }
		private SunburstSeriesDataDragDropDragHandle DragHandle_DefaultValue { get; set; }
		...
		/// </summary>
		public SunburstSeriesDataDragDropGuideBox GuideBox { get; set; }
		private SunburstSeriesDataDragDropGuideBox GuideBox_DefaultValue { get; set; }
