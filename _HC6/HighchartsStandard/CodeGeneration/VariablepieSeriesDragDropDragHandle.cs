...
{
	public partial class VariablepieSeriesDragDropDragHandle  : BaseObject
	{
		public VariablepieSeriesDragDropDragHandle()
		{
		...
		internal override Hashtable ToHashtable()
		{
			...
			if (PathFormatter != PathFormatter_DefaultValue) { h.Add("pathFormatter",PathFormatter); Highcharts.AddFunction("VariablepieSeriesDragDropDragHandlePathFormatter.pathFormatter", PathFormatter); }  
