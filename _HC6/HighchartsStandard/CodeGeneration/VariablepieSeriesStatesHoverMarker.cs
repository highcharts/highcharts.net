...
{
	public partial class VariablepieSeriesStatesHoverMarker  : BaseObject
	{
		public VariablepieSeriesStatesHoverMarker()
		{
			...
			States = States_DefaultValue = new VariablepieSeriesStatesHoverMarkerStates();
		...
		/// </summary>
		public VariablepieSeriesStatesHoverMarkerStates States { get; set; }
		private VariablepieSeriesStatesHoverMarkerStates States_DefaultValue { get; set; }
