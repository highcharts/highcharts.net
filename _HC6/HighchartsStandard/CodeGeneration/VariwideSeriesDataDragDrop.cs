...
{
	public partial class VariwideSeriesDataDragDrop  : BaseObject
	{
		public VariwideSeriesDataDragDrop()
		{
			DraggableX = DraggableX_DefaultValue = null;
			DraggableY = DraggableY_DefaultValue = null;
			DragHandle = DragHandle_DefaultValue = new VariwideSeriesDataDragDropDragHandle();
			...
			GuideBox = GuideBox_DefaultValue = new VariwideSeriesDataDragDropGuideBox();
		...
		/// </summary>
		public VariwideSeriesDataDragDropDragHandle DragHandle { get; set; }
		private VariwideSeriesDataDragDropDragHandle DragHandle_DefaultValue { get; set; }
		...
		/// </summary>
		public VariwideSeriesDataDragDropGuideBox GuideBox { get; set; }
		private VariwideSeriesDataDragDropGuideBox GuideBox_DefaultValue { get; set; }
