...
{
	public partial class VariwideSeriesDragDropDragHandle  : BaseObject
	{
		public VariwideSeriesDragDropDragHandle()
		{
		...
		internal override Hashtable ToHashtable()
		{
			...
			if (PathFormatter != PathFormatter_DefaultValue) { h.Add("pathFormatter",PathFormatter); Highcharts.AddFunction("VariwideSeriesDragDropDragHandlePathFormatter.pathFormatter", PathFormatter); }  
