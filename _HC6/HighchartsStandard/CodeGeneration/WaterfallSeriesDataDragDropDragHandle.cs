...
{
	public partial class WaterfallSeriesDataDragDropDragHandle  : BaseObject
	{
		public WaterfallSeriesDataDragDropDragHandle()
		{
		...
		internal override Hashtable ToHashtable()
		{
			...
			if (PathFormatter != PathFormatter_DefaultValue) { h.Add("pathFormatter",PathFormatter); Highcharts.AddFunction("WaterfallSeriesDataDragDropDragHandlePathFormatter.pathFormatter", PathFormatter); }  
