...
{
	public partial class WindbarbSeriesDragDropDragHandle  : BaseObject
	{
		public WindbarbSeriesDragDropDragHandle()
		{
		...
		internal override Hashtable ToHashtable()
		{
			...
			if (PathFormatter != PathFormatter_DefaultValue) { h.Add("pathFormatter",PathFormatter); Highcharts.AddFunction("WindbarbSeriesDragDropDragHandlePathFormatter.pathFormatter", PathFormatter); }  
