...
{
	public partial class WordcloudSeriesDragDropDragHandle  : BaseObject
	{
		public WordcloudSeriesDragDropDragHandle()
		{
		...
		internal override Hashtable ToHashtable()
		{
			...
			if (PathFormatter != PathFormatter_DefaultValue) { h.Add("pathFormatter",PathFormatter); Highcharts.AddFunction("WordcloudSeriesDragDropDragHandlePathFormatter.pathFormatter", PathFormatter); }  
