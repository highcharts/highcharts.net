...
{
	public partial class AdSeriesIkhLabel  : BaseObject
	{
		public AdSeriesIkhLabel()
		{
			...
			Style = Style_DefaultValue = new AdSeriesIkhLabelStyle();
		...
		/// </summary>
		public AdSeriesIkhLabelStyle Style { get; set; }
		private AdSeriesIkhLabelStyle Style_DefaultValue { get; set; }
