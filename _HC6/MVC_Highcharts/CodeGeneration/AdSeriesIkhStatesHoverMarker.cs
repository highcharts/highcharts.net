...
{
	public partial class AdSeriesIkhStatesHoverMarker  : BaseObject
	{
		public AdSeriesIkhStatesHoverMarker()
		{
			LineWidth = LineWidth_DefaultValue = 0;
			LineColor = LineColor_DefaultValue = "#ffffff";
			Radius = Radius_DefaultValue = 4;
			States = States_DefaultValue = new AdSeriesIkhStatesHoverMarkerStates();
		...
		/// </summary>
		public AdSeriesIkhStatesHoverMarkerStates States { get; set; }
		private AdSeriesIkhStatesHoverMarkerStates States_DefaultValue { get; set; }
