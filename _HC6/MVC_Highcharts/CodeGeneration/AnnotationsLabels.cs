...
namespace Highsoft.Web.Mvc.Charts
{
	public partial class AnnotationsLabels  : BaseObject
	{
		...
		/// <summary>
		/// <p>This option defines the point to which the label will be connected.It can be either the point which exists in the series - it is referencedby the point&#39;s id - or a new point with defined x, y properiesand optionally axes.</p>
		/// </summary>
		...
		internal override Hashtable ToHashtable()
		{
			...
			if (Formatter != Formatter_DefaultValue) { h.Add("formatter",Formatter); Highcharts.AddFunction("AnnotationsLabelsFormatter.formatter", Formatter); }  
