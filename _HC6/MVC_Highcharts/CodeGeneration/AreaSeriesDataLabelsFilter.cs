...
{
	public partial class AreaSeriesDataLabelsFilter  : BaseObject
	{
		...
		/// </summary>
		public AreaSeriesDataLabelsFilterValue Value { get; set; }
		private AreaSeriesDataLabelsFilterValue Value_DefaultValue { get; set; }
