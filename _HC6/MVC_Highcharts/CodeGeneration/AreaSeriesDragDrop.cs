...
{
	public partial class AreaSeriesDragDrop  : BaseObject
	{
		public AreaSeriesDragDrop()
		{
			DraggableX = DraggableX_DefaultValue = null;
			DraggableY = DraggableY_DefaultValue = null;
			DragHandle = DragHandle_DefaultValue = new AreaSeriesDragDropDragHandle();
			...
			GuideBox = GuideBox_DefaultValue = new AreaSeriesDragDropGuideBox();
		...
		/// </summary>
		public AreaSeriesDragDropDragHandle DragHandle { get; set; }
		private AreaSeriesDragDropDragHandle DragHandle_DefaultValue { get; set; }
		...
		/// </summary>
		public AreaSeriesDragDropGuideBox GuideBox { get; set; }
		private AreaSeriesDragDropGuideBox GuideBox_DefaultValue { get; set; }
