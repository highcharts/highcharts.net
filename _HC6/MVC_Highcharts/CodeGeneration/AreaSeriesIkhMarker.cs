...
{
	public partial class AreaSeriesIkhMarker  : BaseObject
	{
		public AreaSeriesIkhMarker()
		{
			LineWidth = LineWidth_DefaultValue = 0;
			LineColor = LineColor_DefaultValue = "#ffffff";
			Radius = Radius_DefaultValue = 4;
			States = States_DefaultValue = new AreaSeriesIkhMarkerStates();
		...
		/// </summary>
		public AreaSeriesIkhMarkerStates States { get; set; }
		private AreaSeriesIkhMarkerStates States_DefaultValue { get; set; }
