...
{
	public partial class AreaSeriesIkhStatesSelectMarker  : BaseObject
	{
		public AreaSeriesIkhStatesSelectMarker()
		{
			LineWidth = LineWidth_DefaultValue = 0;
			LineColor = LineColor_DefaultValue = "#ffffff";
			Radius = Radius_DefaultValue = 4;
			States = States_DefaultValue = new AreaSeriesIkhStatesSelectMarkerStates();
		...
		/// </summary>
		public AreaSeriesIkhStatesSelectMarkerStates States { get; set; }
		private AreaSeriesIkhStatesSelectMarkerStates States_DefaultValue { get; set; }
