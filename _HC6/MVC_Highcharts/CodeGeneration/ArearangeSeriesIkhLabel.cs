...
{
	public partial class ArearangeSeriesIkhLabel  : BaseObject
	{
		public ArearangeSeriesIkhLabel()
		{
			...
			Style = Style_DefaultValue = new ArearangeSeriesIkhLabelStyle();
		...
		/// </summary>
		public ArearangeSeriesIkhLabelStyle Style { get; set; }
		private ArearangeSeriesIkhLabelStyle Style_DefaultValue { get; set; }
