...
{
	public partial class ArearangeSeriesIkhMarker  : BaseObject
	{
		public ArearangeSeriesIkhMarker()
		{
			LineWidth = LineWidth_DefaultValue = 0;
			LineColor = LineColor_DefaultValue = "#ffffff";
			Radius = Radius_DefaultValue = 4;
			States = States_DefaultValue = new ArearangeSeriesIkhMarkerStates();
		...
		/// </summary>
		public ArearangeSeriesIkhMarkerStates States { get; set; }
		private ArearangeSeriesIkhMarkerStates States_DefaultValue { get; set; }
