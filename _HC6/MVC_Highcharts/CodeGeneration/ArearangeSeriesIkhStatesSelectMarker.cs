...
{
	public partial class ArearangeSeriesIkhStatesSelectMarker  : BaseObject
	{
		public ArearangeSeriesIkhStatesSelectMarker()
		{
			LineWidth = LineWidth_DefaultValue = 0;
			LineColor = LineColor_DefaultValue = "#ffffff";
			Radius = Radius_DefaultValue = 4;
			States = States_DefaultValue = new ArearangeSeriesIkhStatesSelectMarkerStates();
		...
		/// </summary>
		public ArearangeSeriesIkhStatesSelectMarkerStates States { get; set; }
		private ArearangeSeriesIkhStatesSelectMarkerStates States_DefaultValue { get; set; }
