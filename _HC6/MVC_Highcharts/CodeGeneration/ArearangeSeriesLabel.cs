...
{
	public partial class ArearangeSeriesLabel  : BaseObject
	{
		public ArearangeSeriesLabel()
		{
			...
			Style = Style_DefaultValue = new ArearangeSeriesLabelStyle();
		...
		/// </summary>
		public ArearangeSeriesLabelEnabled Enabled { get; set; }
		private ArearangeSeriesLabelEnabled Enabled_DefaultValue { get; set; }
		 

		/// <summary>
		/// Allow labels to be placed distant to the graph if necessary,and draw a connector line to the graph.
		/// </summary>
		public ArearangeSeriesLabelConnectorAllowed ConnectorAllowed { get; set; }
		private ArearangeSeriesLabelConnectorAllowed ConnectorAllowed_DefaultValue { get; set; }
		 

		/// <summary>
		/// If the label is closer than this to a neighbour graph, draw aconnector.
		/// </summary>
		public ArearangeSeriesLabelConnectorNeighbourDistance ConnectorNeighbourDistance { get; set; }
		private ArearangeSeriesLabelConnectorNeighbourDistance ConnectorNeighbourDistance_DefaultValue { get; set; }
		...
		/// </summary>
		public ArearangeSeriesLabelStyle Style { get; set; }
		private ArearangeSeriesLabelStyle Style_DefaultValue { get; set; }
