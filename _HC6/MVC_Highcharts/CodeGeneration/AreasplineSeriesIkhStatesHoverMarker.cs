...
{
	public partial class AreasplineSeriesIkhStatesHoverMarker  : BaseObject
	{
		public AreasplineSeriesIkhStatesHoverMarker()
		{
			LineWidth = LineWidth_DefaultValue = 0;
			LineColor = LineColor_DefaultValue = "#ffffff";
			Radius = Radius_DefaultValue = 4;
			States = States_DefaultValue = new AreasplineSeriesIkhStatesHoverMarkerStates();
		...
		/// </summary>
		public AreasplineSeriesIkhStatesHoverMarkerStates States { get; set; }
		private AreasplineSeriesIkhStatesHoverMarkerStates States_DefaultValue { get; set; }
