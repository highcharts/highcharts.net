...
{
	public partial class AreasplineSeriesIkhStatesSelectMarker  : BaseObject
	{
		public AreasplineSeriesIkhStatesSelectMarker()
		{
			LineWidth = LineWidth_DefaultValue = 0;
			LineColor = LineColor_DefaultValue = "#ffffff";
			Radius = Radius_DefaultValue = 4;
			States = States_DefaultValue = new AreasplineSeriesIkhStatesSelectMarkerStates();
		...
		/// </summary>
		public AreasplineSeriesIkhStatesSelectMarkerStates States { get; set; }
		private AreasplineSeriesIkhStatesSelectMarkerStates States_DefaultValue { get; set; }
