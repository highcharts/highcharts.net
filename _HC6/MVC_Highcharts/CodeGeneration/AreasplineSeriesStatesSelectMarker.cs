...
{
	public partial class AreasplineSeriesStatesSelectMarker  : BaseObject
	{
		public AreasplineSeriesStatesSelectMarker()
		{
			LineWidth = LineWidth_DefaultValue = 0;
			LineColor = LineColor_DefaultValue = "#ffffff";
			Radius = Radius_DefaultValue = 4;
			States = States_DefaultValue = new AreasplineSeriesStatesSelectMarkerStates();
		...
		/// </summary>
		public AreasplineSeriesStatesSelectMarkerStates States { get; set; }
		private AreasplineSeriesStatesSelectMarkerStates States_DefaultValue { get; set; }
