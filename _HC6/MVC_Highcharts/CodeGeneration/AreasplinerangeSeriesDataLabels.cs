...
namespace Highsoft.Web.Mvc.Charts
{
	public partial class AreasplinerangeSeriesDataLabels  : BaseObject
	{
		...
		{
			Align = Align_DefaultValue = AreasplinerangeSeriesDataLabelsAlign.Null;
			VerticalAlign = VerticalAlign_DefaultValue = AreasplinerangeSeriesDataLabelsVerticalAlign.Null;
