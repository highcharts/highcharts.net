...
{
	public partial class AreasplinerangeSeriesIkhLabel  : BaseObject
	{
		public AreasplinerangeSeriesIkhLabel()
		{
			...
			Style = Style_DefaultValue = new AreasplinerangeSeriesIkhLabelStyle();
		...
		/// </summary>
		public AreasplinerangeSeriesIkhLabelStyle Style { get; set; }
		private AreasplinerangeSeriesIkhLabelStyle Style_DefaultValue { get; set; }
