...
{
	public partial class AreasplinerangeSeriesIkhMarker  : BaseObject
	{
		public AreasplinerangeSeriesIkhMarker()
		{
			LineWidth = LineWidth_DefaultValue = 0;
			LineColor = LineColor_DefaultValue = "#ffffff";
			Radius = Radius_DefaultValue = 4;
			States = States_DefaultValue = new AreasplinerangeSeriesIkhMarkerStates();
		...
		/// </summary>
		public AreasplinerangeSeriesIkhMarkerStates States { get; set; }
		private AreasplinerangeSeriesIkhMarkerStates States_DefaultValue { get; set; }
