...
{
	public partial class AreasplinerangeSeriesLabel  : BaseObject
	{
		...
		/// </summary>
		public AreasplinerangeSeriesLabelEnabled Enabled { get; set; }
		private AreasplinerangeSeriesLabelEnabled Enabled_DefaultValue { get; set; }
		 

		/// <summary>
		/// Allow labels to be placed distant to the graph if necessary,and draw a connector line to the graph.
		/// </summary>
		public AreasplinerangeSeriesLabelConnectorAllowed ConnectorAllowed { get; set; }
		private AreasplinerangeSeriesLabelConnectorAllowed ConnectorAllowed_DefaultValue { get; set; }
		 

		/// <summary>
		/// If the label is closer than this to a neighbour graph, draw aconnector.
		/// </summary>
		public AreasplinerangeSeriesLabelConnectorNeighbourDistance ConnectorNeighbourDistance { get; set; }
		private AreasplinerangeSeriesLabelConnectorNeighbourDistance ConnectorNeighbourDistance_DefaultValue { get; set; }
