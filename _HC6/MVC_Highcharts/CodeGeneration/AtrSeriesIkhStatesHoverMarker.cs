...
{
	public partial class AtrSeriesIkhStatesHoverMarker  : BaseObject
	{
		public AtrSeriesIkhStatesHoverMarker()
		{
			LineWidth = LineWidth_DefaultValue = 0;
			LineColor = LineColor_DefaultValue = "#ffffff";
			Radius = Radius_DefaultValue = 4;
			States = States_DefaultValue = new AtrSeriesIkhStatesHoverMarkerStates();
		...
		/// </summary>
		public AtrSeriesIkhStatesHoverMarkerStates States { get; set; }
		private AtrSeriesIkhStatesHoverMarkerStates States_DefaultValue { get; set; }
