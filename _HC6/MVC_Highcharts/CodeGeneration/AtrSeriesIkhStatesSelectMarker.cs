...
{
	public partial class AtrSeriesIkhStatesSelectMarker  : BaseObject
	{
		public AtrSeriesIkhStatesSelectMarker()
		{
			LineWidth = LineWidth_DefaultValue = 0;
			LineColor = LineColor_DefaultValue = "#ffffff";
			Radius = Radius_DefaultValue = 4;
			States = States_DefaultValue = new AtrSeriesIkhStatesSelectMarkerStates();
		...
		/// </summary>
		public AtrSeriesIkhStatesSelectMarkerStates States { get; set; }
		private AtrSeriesIkhStatesSelectMarkerStates States_DefaultValue { get; set; }
