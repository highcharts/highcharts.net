...
{
	public partial class AtrSeriesStatesSelectMarker  : BaseObject
	{
		public AtrSeriesStatesSelectMarker()
		{
			LineWidth = LineWidth_DefaultValue = 0;
			LineColor = LineColor_DefaultValue = "#ffffff";
			Radius = Radius_DefaultValue = 4;
			States = States_DefaultValue = new AtrSeriesStatesSelectMarkerStates();
		...
		/// </summary>
		public AtrSeriesStatesSelectMarkerStates States { get; set; }
		private AtrSeriesStatesSelectMarkerStates States_DefaultValue { get; set; }
