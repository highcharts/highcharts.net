...
{
	public partial class BarSeriesIkhLabel  : BaseObject
	{
		public BarSeriesIkhLabel()
		{
			...
			Style = Style_DefaultValue = new BarSeriesIkhLabelStyle();
		...
		/// </summary>
		public BarSeriesIkhLabelStyle Style { get; set; }
		private BarSeriesIkhLabelStyle Style_DefaultValue { get; set; }
