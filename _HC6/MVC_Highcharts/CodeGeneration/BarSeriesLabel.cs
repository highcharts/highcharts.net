...
{
	public partial class BarSeriesLabel  : BaseObject
	{
		public BarSeriesLabel()
		{
			...
			Style = Style_DefaultValue = new BarSeriesLabelStyle();
		...
		/// </summary>
		public BarSeriesLabelEnabled Enabled { get; set; }
		private BarSeriesLabelEnabled Enabled_DefaultValue { get; set; }
		 

		/// <summary>
		/// Allow labels to be placed distant to the graph if necessary,and draw a connector line to the graph.
		/// </summary>
		public BarSeriesLabelConnectorAllowed ConnectorAllowed { get; set; }
		private BarSeriesLabelConnectorAllowed ConnectorAllowed_DefaultValue { get; set; }
		 

		/// <summary>
		/// If the label is closer than this to a neighbour graph, draw aconnector.
		/// </summary>
		public BarSeriesLabelConnectorNeighbourDistance ConnectorNeighbourDistance { get; set; }
		private BarSeriesLabelConnectorNeighbourDistance ConnectorNeighbourDistance_DefaultValue { get; set; }
		...
		/// </summary>
		public BarSeriesLabelStyle Style { get; set; }
		private BarSeriesLabelStyle Style_DefaultValue { get; set; }
