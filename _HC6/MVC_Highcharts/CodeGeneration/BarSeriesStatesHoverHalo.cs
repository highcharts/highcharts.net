...
{
	public partial class BarSeriesStatesHoverHalo  : BaseObject
	{
		...
		/// </summary>
		public BarSeriesStatesHoverHaloAttributes Attributes { get; set; }
		private BarSeriesStatesHoverHaloAttributes Attributes_DefaultValue { get; set; }
