...
namespace Highsoft.Web.Mvc.Charts
{
	public partial class BarSeriesStatesHoverMarker  : BaseObject
	{
		public BarSeriesStatesHoverMarker()
		{
			...
			States = States_DefaultValue = new BarSeriesStatesHoverMarkerStates();
		...
		/// </summary>
		public BarSeriesStatesHoverMarkerStates States { get; set; }
		private BarSeriesStatesHoverMarkerStates States_DefaultValue { get; set; }
