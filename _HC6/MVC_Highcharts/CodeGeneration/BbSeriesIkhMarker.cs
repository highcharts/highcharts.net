...
{
	public partial class BbSeriesIkhMarker  : BaseObject
	{
		public BbSeriesIkhMarker()
		{
			LineWidth = LineWidth_DefaultValue = 0;
			LineColor = LineColor_DefaultValue = "#ffffff";
			Radius = Radius_DefaultValue = 4;
			States = States_DefaultValue = new BbSeriesIkhMarkerStates();
		...
		/// </summary>
		public BbSeriesIkhMarkerStates States { get; set; }
		private BbSeriesIkhMarkerStates States_DefaultValue { get; set; }
