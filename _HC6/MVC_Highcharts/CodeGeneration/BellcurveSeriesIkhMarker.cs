...
{
	public partial class BellcurveSeriesIkhMarker  : BaseObject
	{
		public BellcurveSeriesIkhMarker()
		{
			LineWidth = LineWidth_DefaultValue = 0;
			LineColor = LineColor_DefaultValue = "#ffffff";
			Radius = Radius_DefaultValue = 4;
			States = States_DefaultValue = new BellcurveSeriesIkhMarkerStates();
		...
		/// </summary>
		public BellcurveSeriesIkhMarkerStates States { get; set; }
		private BellcurveSeriesIkhMarkerStates States_DefaultValue { get; set; }
