...
{
	public partial class BellcurveSeriesIkhStatesHoverMarker  : BaseObject
	{
		public BellcurveSeriesIkhStatesHoverMarker()
		{
			LineWidth = LineWidth_DefaultValue = 0;
			LineColor = LineColor_DefaultValue = "#ffffff";
			Radius = Radius_DefaultValue = 4;
			States = States_DefaultValue = new BellcurveSeriesIkhStatesHoverMarkerStates();
		...
		/// </summary>
		public BellcurveSeriesIkhStatesHoverMarkerStates States { get; set; }
		private BellcurveSeriesIkhStatesHoverMarkerStates States_DefaultValue { get; set; }
