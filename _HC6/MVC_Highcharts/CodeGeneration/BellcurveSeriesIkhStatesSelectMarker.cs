...
{
	public partial class BellcurveSeriesIkhStatesSelectMarker  : BaseObject
	{
		public BellcurveSeriesIkhStatesSelectMarker()
		{
			LineWidth = LineWidth_DefaultValue = 0;
			LineColor = LineColor_DefaultValue = "#ffffff";
			Radius = Radius_DefaultValue = 4;
			States = States_DefaultValue = new BellcurveSeriesIkhStatesSelectMarkerStates();
		...
		/// </summary>
		public BellcurveSeriesIkhStatesSelectMarkerStates States { get; set; }
		private BellcurveSeriesIkhStatesSelectMarkerStates States_DefaultValue { get; set; }
