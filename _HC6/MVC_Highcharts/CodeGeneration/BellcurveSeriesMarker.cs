...
{
	public partial class BellcurveSeriesMarker  : BaseObject
	{
		public BellcurveSeriesMarker()
		{
			LineWidth = LineWidth_DefaultValue = 0;
			LineColor = LineColor_DefaultValue = "#ffffff";
			Radius = Radius_DefaultValue = 4;
			States = States_DefaultValue = new BellcurveSeriesMarkerStates();
		...
		/// </summary>
		public BellcurveSeriesMarkerStates States { get; set; }
		private BellcurveSeriesMarkerStates States_DefaultValue { get; set; }
