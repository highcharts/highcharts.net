...
namespace Highsoft.Web.Mvc.Charts
{
	public partial class BoxplotSeries  : Series
	{
		public BoxplotSeries()
		{
			...
			Linecap = Linecap_DefaultValue = BoxplotSeriesLinecap.Round;
			Step = Step_DefaultValue = BoxplotSeriesStep.Null;
		...
		/// <summary>
		/// <p>An array of data points for the series. For the <code>boxplot</code> seriestype, points can be given in the following ways:</p><ol><li><p>An array of arrays with 6 or 5 values. In this case, the valuescorrespond to <code>x,low,q1,median,q3,high</code>. If the first value is astring, it is applied as the name of the point, and the <code>x</code> valueis inferred. The <code>x</code> value can also be omitted, in which case theinner arrays should be of length 5. Then the <code>x</code> value is automaticallycalculated, either starting at 0 and incremented by 1, or from <code>pointStart</code>and <code>pointInterval</code> given in the series options.</p><pre><code class="lang-js">data: [    [0, 3, 0, 10, 3, 5],    [1, 7, 8, 7, 2, 9],    [2, 6, 9, 5, 1, 3]]</code></pre></li><li><p>An array of objects with named values. The objects are pointconfiguration objects as seen below. If the total number of datapoints exceeds the series&#39; <a href="#series.boxplot.turboThreshold">turboThreshold</a>,this option is not available.</p><pre><code class="lang-js">data: [{    x: 1,    low: 4,    q1: 9,    median: 9,    q3: 1,    high: 10,    name: &quot;Point2&quot;,    color: &quot;#00FF00&quot;}, {    x: 1,    low: 5,    q1: 7,    median: 3,    q3: 6,    high: 2,    name: &quot;Point1&quot;,    color: &quot;#FF00FF&quot;}]</code></pre></li></ol>
		/// </summary>
		...
		/// <summary>
		/// <p>The line width of the whiskers, the horizontal lines marking lowand high values. When <code>null</code>, the general <a href="#plotOptions.boxplot.lineWidth">lineWidth</a> applies.</p>
		/// </summary>
		...
		/// </summary>
		public BoxplotSeriesMarker Marker { get; set; }
		private BoxplotSeriesMarker Marker_DefaultValue { get; set; }
		...
		/// </summary>
		public BoxplotSeriesDashStyle DashStyle { get; set; }
		private BoxplotSeriesDashStyle DashStyle_DefaultValue { get; set; }
		 

		/// <summary>
		/// <p>The line cap used for line ends and line joins on the graph.</p>
		/// </summary>
		public BoxplotSeriesLinecap Linecap { get; set; }
		private BoxplotSeriesLinecap Linecap_DefaultValue { get; set; }
		 

		/// <summary>
		/// <p>Whether to apply steps to the line. Possible values are <code>left</code>, <code>center</code>and <code>right</code>.</p>
		/// </summary>
		public BoxplotSeriesStep Step { get; set; }
		private BoxplotSeriesStep Step_DefaultValue { get; set; }
