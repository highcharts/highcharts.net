...
{
	public partial class BoxplotSeriesIkhMarker  : BaseObject
	{
		public BoxplotSeriesIkhMarker()
		{
			LineWidth = LineWidth_DefaultValue = 0;
			LineColor = LineColor_DefaultValue = "#ffffff";
			Radius = Radius_DefaultValue = 4;
			States = States_DefaultValue = new BoxplotSeriesIkhMarkerStates();
		...
		/// </summary>
		public BoxplotSeriesIkhMarkerStates States { get; set; }
		private BoxplotSeriesIkhMarkerStates States_DefaultValue { get; set; }
