...
namespace Highsoft.Web.Mvc.Charts
{
	public partial class BoxplotSeriesStatesHoverMarker  : BaseObject
	{
		public BoxplotSeriesStatesHoverMarker()
		{
			...
			States = States_DefaultValue = new BoxplotSeriesStatesHoverMarkerStates();
		...
		/// </summary>
		public BoxplotSeriesStatesHoverMarkerStates States { get; set; }
		private BoxplotSeriesStatesHoverMarkerStates States_DefaultValue { get; set; }
