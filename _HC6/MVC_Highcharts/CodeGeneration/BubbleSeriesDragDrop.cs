...
{
	public partial class BubbleSeriesDragDrop  : BaseObject
	{
		public BubbleSeriesDragDrop()
		{
			DraggableX = DraggableX_DefaultValue = null;
			DraggableY = DraggableY_DefaultValue = null;
			DragHandle = DragHandle_DefaultValue = new BubbleSeriesDragDropDragHandle();
			...
			GuideBox = GuideBox_DefaultValue = new BubbleSeriesDragDropGuideBox();
		...
		/// </summary>
		public BubbleSeriesDragDropDragHandle DragHandle { get; set; }
		private BubbleSeriesDragDropDragHandle DragHandle_DefaultValue { get; set; }
		...
		/// </summary>
		public BubbleSeriesDragDropGuideBox GuideBox { get; set; }
		private BubbleSeriesDragDropGuideBox GuideBox_DefaultValue { get; set; }
