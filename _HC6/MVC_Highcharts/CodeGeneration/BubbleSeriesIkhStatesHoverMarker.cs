...
{
	public partial class BubbleSeriesIkhStatesHoverMarker  : BaseObject
	{
		public BubbleSeriesIkhStatesHoverMarker()
		{
			LineWidth = LineWidth_DefaultValue = 0;
			LineColor = LineColor_DefaultValue = "#ffffff";
			Radius = Radius_DefaultValue = 4;
			States = States_DefaultValue = new BubbleSeriesIkhStatesHoverMarkerStates();
		...
		/// </summary>
		public BubbleSeriesIkhStatesHoverMarkerStates States { get; set; }
		private BubbleSeriesIkhStatesHoverMarkerStates States_DefaultValue { get; set; }
