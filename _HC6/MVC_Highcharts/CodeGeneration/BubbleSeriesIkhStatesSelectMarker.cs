...
{
	public partial class BubbleSeriesIkhStatesSelectMarker  : BaseObject
	{
		public BubbleSeriesIkhStatesSelectMarker()
		{
			LineWidth = LineWidth_DefaultValue = 0;
			LineColor = LineColor_DefaultValue = "#ffffff";
			Radius = Radius_DefaultValue = 4;
			States = States_DefaultValue = new BubbleSeriesIkhStatesSelectMarkerStates();
		...
		/// </summary>
		public BubbleSeriesIkhStatesSelectMarkerStates States { get; set; }
		private BubbleSeriesIkhStatesSelectMarkerStates States_DefaultValue { get; set; }
