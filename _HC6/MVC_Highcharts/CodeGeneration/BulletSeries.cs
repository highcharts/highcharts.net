...
namespace Highsoft.Web.Mvc.Charts
{
	public partial class BulletSeries  : Series
	{
		public BulletSeries()
		{
			...
			Type = Type_DefaultValue = BulletSeriesType.Null;
			...
			DashStyle = DashStyle_DefaultValue = BulletSeriesDashStyle.Solid;
			Linecap = Linecap_DefaultValue = BulletSeriesLinecap.Round;
			Step = Step_DefaultValue = BulletSeriesStep.Null;
		...
		/// <summary>
		/// <p>An array of data points for the series. For the <code>bullet</code> series type,points can be given in the following ways:</p><ol><li><p>An array of arrays with 3 or 2 values. In this case, the valuescorrespond to <code>x,y,target</code>. If the first value is a string,it is applied as the name of the point, and the <code>x</code> value is inferred.The <code>x</code> value can also be omitted, in which case the inner arraysshould be of length 2. Then the <code>x</code> value is automatically calculated,either starting at 0 and incremented by 1, or from <code>pointStart</code>and <code>pointInterval</code> given in the series options.</p><pre><code class="lang-js">data: [    [0, 40, 75],    [1, 50, 50],    [2, 60, 40]]</code></pre></li><li><p>An array of objects with named values. The objects are pointconfiguration objects as seen below. If the total number of datapoints exceeds the series&#39; <a href="#series.bullet.turboThreshold">turboThreshold</a>,this option is not available.</p><pre><code class="lang-js">data: [{    x: 0,    y: 40,    target: 75,    name: &quot;Point1&quot;,    color: &quot;#00FF00&quot;}, {    x: 1,    y: 60,    target: 40,    name: &quot;Point2&quot;,    color: &quot;#FF00FF&quot;}]</code></pre></li></ol>
		/// </summary>
		...
		/// </summary>
		public BulletSeriesType Type { get; set; }
		private BulletSeriesType Type_DefaultValue { get; set; }
		...
		/// </summary>
		public BulletSeriesMarker Marker { get; set; }
		private BulletSeriesMarker Marker_DefaultValue { get; set; }
		...
		/// </summary>
		public BulletSeriesLinecap Linecap { get; set; }
		private BulletSeriesLinecap Linecap_DefaultValue { get; set; }
		 

		/// <summary>
		/// <p>Whether to apply steps to the line. Possible values are <code>left</code>, <code>center</code>and <code>right</code>.</p>
		/// </summary>
		public BulletSeriesStep Step { get; set; }
		private BulletSeriesStep Step_DefaultValue { get; set; }
		...
		internal override Hashtable ToHashtable()
		{
			...
			if (PointDescriptionFormatter != PointDescriptionFormatter_DefaultValue) { h.Add("pointDescriptionFormatter",PointDescriptionFormatter); Highcharts.AddFunction("BulletSeriesPointDescriptionFormatter.pointDescriptionFormatter", PointDescriptionFormatter); }  
