...
{
	public partial class BulletSeriesDataDragDrop  : BaseObject
	{
		public BulletSeriesDataDragDrop()
		{
			DraggableX = DraggableX_DefaultValue = null;
			DraggableY = DraggableY_DefaultValue = null;
			DragHandle = DragHandle_DefaultValue = new BulletSeriesDataDragDropDragHandle();
			...
			GuideBox = GuideBox_DefaultValue = new BulletSeriesDataDragDropGuideBox();
		...
		/// </summary>
		public BulletSeriesDataDragDropDragHandle DragHandle { get; set; }
		private BulletSeriesDataDragDropDragHandle DragHandle_DefaultValue { get; set; }
		...
		/// </summary>
		public BulletSeriesDataDragDropGuideBox GuideBox { get; set; }
		private BulletSeriesDataDragDropGuideBox GuideBox_DefaultValue { get; set; }
