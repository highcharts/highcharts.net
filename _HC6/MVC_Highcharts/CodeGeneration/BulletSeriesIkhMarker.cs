...
{
	public partial class BulletSeriesIkhMarker  : BaseObject
	{
		public BulletSeriesIkhMarker()
		{
			LineWidth = LineWidth_DefaultValue = 0;
			LineColor = LineColor_DefaultValue = "#ffffff";
			Radius = Radius_DefaultValue = 4;
			States = States_DefaultValue = new BulletSeriesIkhMarkerStates();
		...
		/// </summary>
		public BulletSeriesIkhMarkerStates States { get; set; }
		private BulletSeriesIkhMarkerStates States_DefaultValue { get; set; }
