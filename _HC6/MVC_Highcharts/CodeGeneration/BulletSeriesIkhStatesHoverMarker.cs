...
{
	public partial class BulletSeriesIkhStatesHoverMarker  : BaseObject
	{
		public BulletSeriesIkhStatesHoverMarker()
		{
			LineWidth = LineWidth_DefaultValue = 0;
			LineColor = LineColor_DefaultValue = "#ffffff";
			Radius = Radius_DefaultValue = 4;
			States = States_DefaultValue = new BulletSeriesIkhStatesHoverMarkerStates();
		...
		/// </summary>
		public BulletSeriesIkhStatesHoverMarkerStates States { get; set; }
		private BulletSeriesIkhStatesHoverMarkerStates States_DefaultValue { get; set; }
