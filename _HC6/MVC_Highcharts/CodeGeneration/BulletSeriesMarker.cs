...
{
	public partial class BulletSeriesMarker  : BaseObject
	{
		public BulletSeriesMarker()
		{
			LineWidth = LineWidth_DefaultValue = 0;
			LineColor = LineColor_DefaultValue = "#ffffff";
			Radius = Radius_DefaultValue = 4;
			States = States_DefaultValue = new BulletSeriesMarkerStates();
		...
		/// </summary>
		public BulletSeriesMarkerStates States { get; set; }
		private BulletSeriesMarkerStates States_DefaultValue { get; set; }
