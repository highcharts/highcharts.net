...
{
	public partial class CandleStickSeriesIkhLabel  : BaseObject
	{
		public CandleStickSeriesIkhLabel()
		{
			...
			Style = Style_DefaultValue = new CandleStickSeriesIkhLabelStyle();
		...
		/// </summary>
		public CandleStickSeriesIkhLabelStyle Style { get; set; }
		private CandleStickSeriesIkhLabelStyle Style_DefaultValue { get; set; }
