...
{
	public partial class CandleStickSeriesIkhMarker  : BaseObject
	{
		public CandleStickSeriesIkhMarker()
		{
			LineWidth = LineWidth_DefaultValue = 0;
			LineColor = LineColor_DefaultValue = "#ffffff";
			Radius = Radius_DefaultValue = 4;
			States = States_DefaultValue = new CandleStickSeriesIkhMarkerStates();
		...
		/// </summary>
		public CandleStickSeriesIkhMarkerStates States { get; set; }
		private CandleStickSeriesIkhMarkerStates States_DefaultValue { get; set; }
