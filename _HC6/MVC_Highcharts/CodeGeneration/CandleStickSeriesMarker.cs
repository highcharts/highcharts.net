...
{
	public partial class CandleStickSeriesMarker  : BaseObject
	{
		public CandleStickSeriesMarker()
		{
			LineWidth = LineWidth_DefaultValue = 0;
			LineColor = LineColor_DefaultValue = "#ffffff";
			Radius = Radius_DefaultValue = 4;
			States = States_DefaultValue = new CandleStickSeriesMarkerStates();
		...
		/// </summary>
		public CandleStickSeriesMarkerStates States { get; set; }
		private CandleStickSeriesMarkerStates States_DefaultValue { get; set; }
