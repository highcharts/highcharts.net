...
{
	public partial class CandleStickSeriesStatesSelectMarker  : BaseObject
	{
		public CandleStickSeriesStatesSelectMarker()
		{
			LineWidth = LineWidth_DefaultValue = 0;
			LineColor = LineColor_DefaultValue = "#ffffff";
			Radius = Radius_DefaultValue = 4;
			States = States_DefaultValue = new CandleStickSeriesStatesSelectMarkerStates();
		...
		/// </summary>
		public CandleStickSeriesStatesSelectMarkerStates States { get; set; }
		private CandleStickSeriesStatesSelectMarkerStates States_DefaultValue { get; set; }
