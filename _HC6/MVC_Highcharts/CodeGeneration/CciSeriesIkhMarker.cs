...
{
	public partial class CciSeriesIkhMarker  : BaseObject
	{
		public CciSeriesIkhMarker()
		{
			LineWidth = LineWidth_DefaultValue = 0;
			LineColor = LineColor_DefaultValue = "#ffffff";
			Radius = Radius_DefaultValue = 4;
			States = States_DefaultValue = new CciSeriesIkhMarkerStates();
		...
		/// </summary>
		public CciSeriesIkhMarkerStates States { get; set; }
		private CciSeriesIkhMarkerStates States_DefaultValue { get; set; }
