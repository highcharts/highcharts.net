...
{
	public partial class CciSeriesIkhStatesHoverMarker  : BaseObject
	{
		public CciSeriesIkhStatesHoverMarker()
		{
			LineWidth = LineWidth_DefaultValue = 0;
			LineColor = LineColor_DefaultValue = "#ffffff";
			Radius = Radius_DefaultValue = 4;
			States = States_DefaultValue = new CciSeriesIkhStatesHoverMarkerStates();
		...
		/// </summary>
		public CciSeriesIkhStatesHoverMarkerStates States { get; set; }
		private CciSeriesIkhStatesHoverMarkerStates States_DefaultValue { get; set; }
