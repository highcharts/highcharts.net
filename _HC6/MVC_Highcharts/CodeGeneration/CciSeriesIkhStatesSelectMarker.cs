...
{
	public partial class CciSeriesIkhStatesSelectMarker  : BaseObject
	{
		public CciSeriesIkhStatesSelectMarker()
		{
			LineWidth = LineWidth_DefaultValue = 0;
			LineColor = LineColor_DefaultValue = "#ffffff";
			Radius = Radius_DefaultValue = 4;
			States = States_DefaultValue = new CciSeriesIkhStatesSelectMarkerStates();
		...
		/// </summary>
		public CciSeriesIkhStatesSelectMarkerStates States { get; set; }
		private CciSeriesIkhStatesSelectMarkerStates States_DefaultValue { get; set; }
