...
{
	public partial class CciSeriesStatesHoverMarker  : BaseObject
	{
		public CciSeriesStatesHoverMarker()
		{
			LineWidth = LineWidth_DefaultValue = 0;
			LineColor = LineColor_DefaultValue = "#ffffff";
			Radius = Radius_DefaultValue = 4;
			States = States_DefaultValue = new CciSeriesStatesHoverMarkerStates();
		...
		/// </summary>
		public CciSeriesStatesHoverMarkerStates States { get; set; }
		private CciSeriesStatesHoverMarkerStates States_DefaultValue { get; set; }
