...
{
	public partial class CmfSeriesIkhLabel  : BaseObject
	{
		public CmfSeriesIkhLabel()
		{
			...
			Style = Style_DefaultValue = new CmfSeriesIkhLabelStyle();
		...
		/// </summary>
		public CmfSeriesIkhLabelStyle Style { get; set; }
		private CmfSeriesIkhLabelStyle Style_DefaultValue { get; set; }
