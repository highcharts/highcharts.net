...
{
	public partial class CmfSeriesIkhStatesHoverMarker  : BaseObject
	{
		public CmfSeriesIkhStatesHoverMarker()
		{
			LineWidth = LineWidth_DefaultValue = 0;
			LineColor = LineColor_DefaultValue = "#ffffff";
			Radius = Radius_DefaultValue = 4;
			States = States_DefaultValue = new CmfSeriesIkhStatesHoverMarkerStates();
		...
		/// </summary>
		public CmfSeriesIkhStatesHoverMarkerStates States { get; set; }
		private CmfSeriesIkhStatesHoverMarkerStates States_DefaultValue { get; set; }
