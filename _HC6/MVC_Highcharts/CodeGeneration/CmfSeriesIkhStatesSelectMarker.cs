...
{
	public partial class CmfSeriesIkhStatesSelectMarker  : BaseObject
	{
		public CmfSeriesIkhStatesSelectMarker()
		{
			LineWidth = LineWidth_DefaultValue = 0;
			LineColor = LineColor_DefaultValue = "#ffffff";
			Radius = Radius_DefaultValue = 4;
			States = States_DefaultValue = new CmfSeriesIkhStatesSelectMarkerStates();
		...
		/// </summary>
		public CmfSeriesIkhStatesSelectMarkerStates States { get; set; }
		private CmfSeriesIkhStatesSelectMarkerStates States_DefaultValue { get; set; }
