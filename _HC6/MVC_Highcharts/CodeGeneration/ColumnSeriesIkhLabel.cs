...
{
	public partial class ColumnSeriesIkhLabel  : BaseObject
	{
		public ColumnSeriesIkhLabel()
		{
			...
			Style = Style_DefaultValue = new ColumnSeriesIkhLabelStyle();
		...
		/// </summary>
		public ColumnSeriesIkhLabelStyle Style { get; set; }
		private ColumnSeriesIkhLabelStyle Style_DefaultValue { get; set; }
