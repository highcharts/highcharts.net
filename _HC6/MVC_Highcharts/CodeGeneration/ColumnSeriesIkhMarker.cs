...
{
	public partial class ColumnSeriesIkhMarker  : BaseObject
	{
		public ColumnSeriesIkhMarker()
		{
			LineWidth = LineWidth_DefaultValue = 0;
			LineColor = LineColor_DefaultValue = "#ffffff";
			Radius = Radius_DefaultValue = 4;
			States = States_DefaultValue = new ColumnSeriesIkhMarkerStates();
		...
		/// </summary>
		public ColumnSeriesIkhMarkerStates States { get; set; }
		private ColumnSeriesIkhMarkerStates States_DefaultValue { get; set; }
