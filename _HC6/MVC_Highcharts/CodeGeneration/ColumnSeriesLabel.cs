...
{
	public partial class ColumnSeriesLabel  : BaseObject
	{
		public ColumnSeriesLabel()
		{
			...
			Style = Style_DefaultValue = new ColumnSeriesLabelStyle();
		...
		/// </summary>
		public ColumnSeriesLabelEnabled Enabled { get; set; }
		private ColumnSeriesLabelEnabled Enabled_DefaultValue { get; set; }
		 

		/// <summary>
		/// Allow labels to be placed distant to the graph if necessary,and draw a connector line to the graph.
		/// </summary>
		public ColumnSeriesLabelConnectorAllowed ConnectorAllowed { get; set; }
		private ColumnSeriesLabelConnectorAllowed ConnectorAllowed_DefaultValue { get; set; }
		 

		/// <summary>
		/// If the label is closer than this to a neighbour graph, draw aconnector.
		/// </summary>
		public ColumnSeriesLabelConnectorNeighbourDistance ConnectorNeighbourDistance { get; set; }
		private ColumnSeriesLabelConnectorNeighbourDistance ConnectorNeighbourDistance_DefaultValue { get; set; }
		...
		/// </summary>
		public ColumnSeriesLabelStyle Style { get; set; }
		private ColumnSeriesLabelStyle Style_DefaultValue { get; set; }
