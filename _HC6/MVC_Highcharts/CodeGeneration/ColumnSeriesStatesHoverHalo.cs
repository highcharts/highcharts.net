...
{
	public partial class ColumnSeriesStatesHoverHalo  : BaseObject
	{
		...
		/// </summary>
		public ColumnSeriesStatesHoverHaloAttributes Attributes { get; set; }
		private ColumnSeriesStatesHoverHaloAttributes Attributes_DefaultValue { get; set; }
