...
{
	public partial class ColumnrangeSeriesIkhLabel  : BaseObject
	{
		public ColumnrangeSeriesIkhLabel()
		{
			...
			Style = Style_DefaultValue = new ColumnrangeSeriesIkhLabelStyle();
		...
		/// </summary>
		public ColumnrangeSeriesIkhLabelStyle Style { get; set; }
		private ColumnrangeSeriesIkhLabelStyle Style_DefaultValue { get; set; }
