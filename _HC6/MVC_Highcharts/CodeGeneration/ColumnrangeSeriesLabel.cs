...
{
	public partial class ColumnrangeSeriesLabel  : BaseObject
	{
		public ColumnrangeSeriesLabel()
		{
			...
			Style = Style_DefaultValue = new ColumnrangeSeriesLabelStyle();
		...
		/// </summary>
		public ColumnrangeSeriesLabelEnabled Enabled { get; set; }
		private ColumnrangeSeriesLabelEnabled Enabled_DefaultValue { get; set; }
		 

		/// <summary>
		/// Allow labels to be placed distant to the graph if necessary,and draw a connector line to the graph.
		/// </summary>
		public ColumnrangeSeriesLabelConnectorAllowed ConnectorAllowed { get; set; }
		private ColumnrangeSeriesLabelConnectorAllowed ConnectorAllowed_DefaultValue { get; set; }
		 

		/// <summary>
		/// If the label is closer than this to a neighbour graph, draw aconnector.
		/// </summary>
		public ColumnrangeSeriesLabelConnectorNeighbourDistance ConnectorNeighbourDistance { get; set; }
		private ColumnrangeSeriesLabelConnectorNeighbourDistance ConnectorNeighbourDistance_DefaultValue { get; set; }
		...
		/// </summary>
		public ColumnrangeSeriesLabelStyle Style { get; set; }
		private ColumnrangeSeriesLabelStyle Style_DefaultValue { get; set; }
