...
{
	public partial class EmaSeriesIkhLabel  : BaseObject
	{
		public EmaSeriesIkhLabel()
		{
			...
			Style = Style_DefaultValue = new EmaSeriesIkhLabelStyle();
		...
		/// </summary>
		public EmaSeriesIkhLabelStyle Style { get; set; }
		private EmaSeriesIkhLabelStyle Style_DefaultValue { get; set; }
