...
{
	public partial class EmaSeriesIkhMarker  : BaseObject
	{
		public EmaSeriesIkhMarker()
		{
			LineWidth = LineWidth_DefaultValue = 0;
			LineColor = LineColor_DefaultValue = "#ffffff";
			Radius = Radius_DefaultValue = 4;
			States = States_DefaultValue = new EmaSeriesIkhMarkerStates();
		...
		/// </summary>
		public EmaSeriesIkhMarkerStates States { get; set; }
		private EmaSeriesIkhMarkerStates States_DefaultValue { get; set; }
