...
{
	public partial class EmaSeriesIkhStatesHoverMarker  : BaseObject
	{
		public EmaSeriesIkhStatesHoverMarker()
		{
			LineWidth = LineWidth_DefaultValue = 0;
			LineColor = LineColor_DefaultValue = "#ffffff";
			Radius = Radius_DefaultValue = 4;
			States = States_DefaultValue = new EmaSeriesIkhStatesHoverMarkerStates();
		...
		/// </summary>
		public EmaSeriesIkhStatesHoverMarkerStates States { get; set; }
		private EmaSeriesIkhStatesHoverMarkerStates States_DefaultValue { get; set; }
