...
{
	public partial class EmaSeriesLabel  : BaseObject
	{
		public EmaSeriesLabel()
		{
			...
			Style = Style_DefaultValue = new EmaSeriesLabelStyle();
		...
		/// </summary>
		public EmaSeriesLabelStyle Style { get; set; }
		private EmaSeriesLabelStyle Style_DefaultValue { get; set; }
