...
{
	public partial class ErrorbarSeries  : Series
	{
		public ErrorbarSeries()
		{
			...
			Grouping = Grouping_DefaultValue = null;
			LinkedTo = LinkedTo_DefaultValue = ":previous";
			Tooltip = Tooltip_DefaultValue = new ErrorbarSeriesTooltip();
			...
			DataLabels = DataLabels_DefaultValue = new ErrorbarSeriesDataLabels();
			...
			Label = Label_DefaultValue = new ErrorbarSeriesLabel();
			AllowPointSelect = AllowPointSelect_DefaultValue = false;
			ShowCheckbox = ShowCheckbox_DefaultValue = false;
			Animation = Animation_DefaultValue = new Animation() { Enabled = true };
			Events = Events_DefaultValue = new ErrorbarSeriesEvents();
			Point = Point_DefaultValue = new ErrorbarSeriesPoint();
			TurboThreshold = TurboThreshold_DefaultValue = 1000;
			FindNearestPointBy = FindNearestPointBy_DefaultValue = ErrorbarSeriesFindNearestPointBy.X;
			...
			PointIntervalUnit = PointIntervalUnit_DefaultValue = ErrorbarSeriesPointIntervalUnit.Null;
			...
			Zones = Zones_DefaultValue = new ErrorbarSeriesZone();
			Marker = Marker_DefaultValue = new ErrorbarSeriesMarker();
			ConnectNulls = ConnectNulls_DefaultValue = false;
			DashStyle = DashStyle_DefaultValue = ErrorbarSeriesDashStyle.Solid;
			Linecap = Linecap_DefaultValue = ErrorbarSeriesLinecap.Round;
			Step = Step_DefaultValue = ErrorbarSeriesStep.Null;
		...
		/// <summary>
		/// <p>The main color of the bars. This can be overridden by <a href="#plotOptions.errorbar.stemColor">stemColor</a> and <a href="#plotOptions.errorbar.whiskerColor">whiskerColor</a>individually.</p>
		/// </summary>
		...
		/// <summary>
		/// <p>The parent series of the error bar. The default value links it tothe previous series. Otherwise, use the id of the parent series.</p>
		/// </summary>
		...
		/// <summary>
		/// <p>The line width of the whiskers, the horizontal lines marking lowand high values. When <code>null</code>, the general <a href="#plotOptions.errorbar.lineWidth">lineWidth</a> applies.</p>
		/// </summary>
		...
		/// <summary>
		/// <p>The Y axis value to serve as the base for the columns, for distinguishingbetween values above and below a threshold. If <code>null</code>, the columnsextend from the padding Y axis minimum.</p>
		/// </summary>
		...
		/// <summary>
		/// <p>The length of the whiskers, the horizontal lines marking low andhigh values. It can be a numerical pixel value, or a percentagevalue of the box width. Set <code>0</code> to disable whiskers.</p>
		/// </summary>
		...
		/// <summary>
		/// <p>The width of the line surrounding the box. If any of <a href="#plotOptions.boxplot.stemWidth">stemWidth</a>, <a href="#plotOptions.boxplot.medianWidth">medianWidth</a>or <a href="#plotOptions.boxplot.whiskerWidth">whiskerWidth</a> are <code>null</code>, the lineWidth also applies to these lines.</p>
		/// </summary>
		...
		/// <summary>
		/// <p>The pixel width of the median line. If <code>null</code>, the <a href="#plotOptions.boxplot.lineWidth">lineWidth</a> is used.</p>
		/// </summary>
		...
		/// <summary>
		/// <p>The color of the median line. If <code>null</code>, the general series colorapplies.</p>
		/// </summary>
		...
		/// <summary>
		/// <p>The color of the stem, the vertical line extending from the box tothe whiskers. If <code>null</code>, the series color is used.</p>
		/// </summary>
		...
		/// <summary>
		/// <p>The dash style of the stem, the vertical line extending from thebox to the whiskers.</p>
		/// </summary>
		...
		/// <summary>
		/// <p>The width of the stem, the vertical line extending from the box tothe whiskers. If <code>null</code>, the width is inherited from the <a href="#plotOptions.boxplot.lineWidth">lineWidth</a> option.</p>
		/// </summary>
		...
		/// <summary>
		/// <p>The color of the whiskers, the horizontal lines marking low and highvalues. When <code>null</code>, the general series color is used.</p>
		/// </summary>
		...
		/// </summary>
		public ErrorbarSeriesDataLabels DataLabels { get; set; }
		private ErrorbarSeriesDataLabels DataLabels_DefaultValue { get; set; }
		...
		/// </summary>
		public ErrorbarSeriesLabel Label { get; set; }
		private ErrorbarSeriesLabel Label_DefaultValue { get; set; }
		...
		/// </summary>
		public ErrorbarSeriesFindNearestPointBy FindNearestPointBy { get; set; }
		private ErrorbarSeriesFindNearestPointBy FindNearestPointBy_DefaultValue { get; set; }
		...
		/// </summary>
		public ErrorbarSeriesStacking Stacking { get; set; }
		private ErrorbarSeriesStacking Stacking_DefaultValue { get; set; }
		...
		/// </summary>
		public ErrorbarSeriesZone Zones { get; set; }
		private ErrorbarSeriesZone Zones_DefaultValue { get; set; }
		...
		/// </summary>
		public ErrorbarSeriesMarker Marker { get; set; }
		private ErrorbarSeriesMarker Marker_DefaultValue { get; set; }
		...
		/// </summary>
		public ErrorbarSeriesDashStyle DashStyle { get; set; }
		private ErrorbarSeriesDashStyle DashStyle_DefaultValue { get; set; }
		 

		/// <summary>
		/// <p>The line cap used for line ends and line joins on the graph.</p>
		/// </summary>
		public ErrorbarSeriesLinecap Linecap { get; set; }
		private ErrorbarSeriesLinecap Linecap_DefaultValue { get; set; }
		 

		/// <summary>
		/// <p>Whether to apply steps to the line. Possible values are <code>left</code>, <code>center</code>and <code>right</code>.</p>
		/// </summary>
		public ErrorbarSeriesStep Step { get; set; }
		private ErrorbarSeriesStep Step_DefaultValue { get; set; }
		...
		internal override Hashtable ToHashtable()
		{
			...
			if (PointDescriptionFormatter != PointDescriptionFormatter_DefaultValue) { h.Add("pointDescriptionFormatter",PointDescriptionFormatter); Highcharts.AddFunction("ErrorbarSeriesPointDescriptionFormatter.pointDescriptionFormatter", PointDescriptionFormatter); }  
