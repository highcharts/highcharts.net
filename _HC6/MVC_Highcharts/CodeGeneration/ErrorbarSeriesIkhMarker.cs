...
{
	public partial class ErrorbarSeriesIkhMarker  : BaseObject
	{
		public ErrorbarSeriesIkhMarker()
		{
			LineWidth = LineWidth_DefaultValue = 0;
			LineColor = LineColor_DefaultValue = "#ffffff";
			Radius = Radius_DefaultValue = 4;
			States = States_DefaultValue = new ErrorbarSeriesIkhMarkerStates();
		...
		/// </summary>
		public ErrorbarSeriesIkhMarkerStates States { get; set; }
		private ErrorbarSeriesIkhMarkerStates States_DefaultValue { get; set; }
