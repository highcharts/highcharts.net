...
{
	public partial class ErrorbarSeriesIkhStatesHoverMarker  : BaseObject
	{
		public ErrorbarSeriesIkhStatesHoverMarker()
		{
			LineWidth = LineWidth_DefaultValue = 0;
			LineColor = LineColor_DefaultValue = "#ffffff";
			Radius = Radius_DefaultValue = 4;
			States = States_DefaultValue = new ErrorbarSeriesIkhStatesHoverMarkerStates();
		...
		/// </summary>
		public ErrorbarSeriesIkhStatesHoverMarkerStates States { get; set; }
		private ErrorbarSeriesIkhStatesHoverMarkerStates States_DefaultValue { get; set; }
