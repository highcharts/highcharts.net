...
{
	public partial class ErrorbarSeriesMarker  : BaseObject
	{
		public ErrorbarSeriesMarker()
		{
			LineWidth = LineWidth_DefaultValue = 0;
			LineColor = LineColor_DefaultValue = "#ffffff";
			Radius = Radius_DefaultValue = 4;
			States = States_DefaultValue = new ErrorbarSeriesMarkerStates();
		...
		/// </summary>
		public ErrorbarSeriesMarkerStates States { get; set; }
		private ErrorbarSeriesMarkerStates States_DefaultValue { get; set; }
