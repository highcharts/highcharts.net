...
{
	public partial class FlagsSeriesMarker  : BaseObject
	{
		public FlagsSeriesMarker()
		{
			LineWidth = LineWidth_DefaultValue = 0;
			LineColor = LineColor_DefaultValue = "#ffffff";
			Radius = Radius_DefaultValue = 4;
			States = States_DefaultValue = new FlagsSeriesMarkerStates();
		...
		/// </summary>
		public FlagsSeriesMarkerStates States { get; set; }
		private FlagsSeriesMarkerStates States_DefaultValue { get; set; }
