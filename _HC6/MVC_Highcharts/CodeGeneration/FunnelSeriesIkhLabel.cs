...
{
	public partial class FunnelSeriesIkhLabel  : BaseObject
	{
		public FunnelSeriesIkhLabel()
		{
			...
			Style = Style_DefaultValue = new FunnelSeriesIkhLabelStyle();
		...
		/// </summary>
		public FunnelSeriesIkhLabelStyle Style { get; set; }
		private FunnelSeriesIkhLabelStyle Style_DefaultValue { get; set; }
