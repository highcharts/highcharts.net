...
{
	public partial class FunnelSeriesIkhStatesSelectMarker  : BaseObject
	{
		public FunnelSeriesIkhStatesSelectMarker()
		{
			LineWidth = LineWidth_DefaultValue = 0;
			LineColor = LineColor_DefaultValue = "#ffffff";
			Radius = Radius_DefaultValue = 4;
			States = States_DefaultValue = new FunnelSeriesIkhStatesSelectMarkerStates();
		...
		/// </summary>
		public FunnelSeriesIkhStatesSelectMarkerStates States { get; set; }
		private FunnelSeriesIkhStatesSelectMarkerStates States_DefaultValue { get; set; }
