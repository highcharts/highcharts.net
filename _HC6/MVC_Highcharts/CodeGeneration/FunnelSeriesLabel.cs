...
{
	public partial class FunnelSeriesLabel  : BaseObject
	{
		public FunnelSeriesLabel()
		{
			...
			Style = Style_DefaultValue = new FunnelSeriesLabelStyle();
		...
		/// </summary>
		public FunnelSeriesLabelEnabled Enabled { get; set; }
		private FunnelSeriesLabelEnabled Enabled_DefaultValue { get; set; }
		 

		/// <summary>
		/// Allow labels to be placed distant to the graph if necessary,and draw a connector line to the graph.
		/// </summary>
		public FunnelSeriesLabelConnectorAllowed ConnectorAllowed { get; set; }
		private FunnelSeriesLabelConnectorAllowed ConnectorAllowed_DefaultValue { get; set; }
		 

		/// <summary>
		/// If the label is closer than this to a neighbour graph, draw aconnector.
		/// </summary>
		public FunnelSeriesLabelConnectorNeighbourDistance ConnectorNeighbourDistance { get; set; }
		private FunnelSeriesLabelConnectorNeighbourDistance ConnectorNeighbourDistance_DefaultValue { get; set; }
		...
		/// </summary>
		public FunnelSeriesLabelStyle Style { get; set; }
		private FunnelSeriesLabelStyle Style_DefaultValue { get; set; }
