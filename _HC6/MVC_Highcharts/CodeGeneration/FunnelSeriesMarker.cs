...
{
	public partial class FunnelSeriesMarker  : BaseObject
	{
		public FunnelSeriesMarker()
		{
			LineWidth = LineWidth_DefaultValue = 0;
			LineColor = LineColor_DefaultValue = "#ffffff";
			Radius = Radius_DefaultValue = 4;
			States = States_DefaultValue = new FunnelSeriesMarkerStates();
		...
		/// </summary>
		public FunnelSeriesMarkerStates States { get; set; }
		private FunnelSeriesMarkerStates States_DefaultValue { get; set; }
