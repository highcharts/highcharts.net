...
namespace Highsoft.Web.Mvc.Charts
{
	public partial class FunnelSeriesPointEvents  : BaseObject
	{
		...
		internal override Hashtable ToHashtable()
		{
			...
			if (LegendItemClick != LegendItemClick_DefaultValue) { h.Add("legendItemClick",LegendItemClick); Highcharts.AddFunction("FunnelSeriesPointEventsLegendItemClick.legendItemClick", LegendItemClick); }  
