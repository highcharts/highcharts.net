...
{
	public partial class FunnelSeriesStatesHoverHalo  : BaseObject
	{
		...
		/// </summary>
		public FunnelSeriesStatesHoverHaloAttributes Attributes { get; set; }
		private FunnelSeriesStatesHoverHaloAttributes Attributes_DefaultValue { get; set; }
