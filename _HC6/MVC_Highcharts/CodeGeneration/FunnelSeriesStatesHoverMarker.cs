...
namespace Highsoft.Web.Mvc.Charts
{
	public partial class FunnelSeriesStatesHoverMarker  : BaseObject
	{
		public FunnelSeriesStatesHoverMarker()
		{
			...
			States = States_DefaultValue = new FunnelSeriesStatesHoverMarkerStates();
		...
		/// </summary>
		public FunnelSeriesStatesHoverMarkerStates States { get; set; }
		private FunnelSeriesStatesHoverMarkerStates States_DefaultValue { get; set; }
