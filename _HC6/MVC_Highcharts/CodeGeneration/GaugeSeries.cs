...
namespace Highsoft.Web.Mvc.Charts
{
	public partial class GaugeSeries  : Series
	{
		public GaugeSeries()
		{
			...
			Label = Label_DefaultValue = new GaugeSeriesLabel();
			...
			Marker = Marker_DefaultValue = new GaugeSeriesMarker();
			CropThreshold = CropThreshold_DefaultValue = 300;
			SoftThreshold = SoftThreshold_DefaultValue = true;
			TurboThreshold = TurboThreshold_DefaultValue = 1000;
			FindNearestPointBy = FindNearestPointBy_DefaultValue = GaugeSeriesFindNearestPointBy.X;
			AnimationLimit = AnimationLimit_DefaultValue = null;
			ConnectNulls = ConnectNulls_DefaultValue = false;
			DashStyle = DashStyle_DefaultValue = GaugeSeriesDashStyle.Solid;
			GetExtremesFromAll = GetExtremesFromAll_DefaultValue = false;
			PointPlacement = PointPlacement_DefaultValue = new PointPlacement();
			Stacking = Stacking_DefaultValue = GaugeSeriesStacking.Null;
			Step = Step_DefaultValue = GaugeSeriesStep.Null;
			Threshold = Threshold_DefaultValue = 0;
			ZoneAxis = ZoneAxis_DefaultValue = "y";
			Zones = Zones_DefaultValue = new List<GaugeSeriesZone>();
		...
		/// <summary>
		/// <p>Options for the dial or arrow pointer of the gauge.</p><p>In styled mode, the dial is styled with the <code>.highcharts-gauge-series .highcharts-dial</code> rule.</p>
		/// </summary>
		...
		/// <summary>
		/// <p>Options for the pivot or the center point of the gauge.</p><p>In styled mode, the pivot is styled with the <code>.highcharts-gauge-series .highcharts-pivot</code> rule.</p>
		/// </summary>
		...
		/// </summary>
		public GaugeSeriesLabel Label { get; set; }
		private GaugeSeriesLabel Label_DefaultValue { get; set; }
		...
		/// </summary>
		public GaugeSeriesMarker Marker { get; set; }
		private GaugeSeriesMarker Marker_DefaultValue { get; set; }
		...
		/// </summary>
		public GaugeSeriesFindNearestPointBy FindNearestPointBy { get; set; }
		private GaugeSeriesFindNearestPointBy FindNearestPointBy_DefaultValue { get; set; }
		...
		/// </summary>
		public GaugeSeriesDashStyle DashStyle { get; set; }
		private GaugeSeriesDashStyle DashStyle_DefaultValue { get; set; }
		...
		/// </summary>
		public GaugeSeriesStacking Stacking { get; set; }
		private GaugeSeriesStacking Stacking_DefaultValue { get; set; }
		 

		/// <summary>
		/// <p>Whether to apply steps to the line. Possible values are <code>left</code>, <code>center</code>and <code>right</code>.</p>
		/// </summary>
		public GaugeSeriesStep Step { get; set; }
		private GaugeSeriesStep Step_DefaultValue { get; set; }
		...
		/// </summary>
		public List<GaugeSeriesZone> Zones { get; set; }
		private List<GaugeSeriesZone> Zones_DefaultValue { get; set; }
		...
		internal override Hashtable ToHashtable()
		{
			...
			if (PointDescriptionFormatter != PointDescriptionFormatter_DefaultValue) { h.Add("pointDescriptionFormatter",PointDescriptionFormatter); Highcharts.AddFunction("GaugeSeriesPointDescriptionFormatter.pointDescriptionFormatter", PointDescriptionFormatter); }  
