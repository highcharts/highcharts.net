...
{
	public partial class GaugeSeriesIkhLabel  : BaseObject
	{
		public GaugeSeriesIkhLabel()
		{
			...
			Style = Style_DefaultValue = new GaugeSeriesIkhLabelStyle();
		...
		/// </summary>
		public GaugeSeriesIkhLabelStyle Style { get; set; }
		private GaugeSeriesIkhLabelStyle Style_DefaultValue { get; set; }
