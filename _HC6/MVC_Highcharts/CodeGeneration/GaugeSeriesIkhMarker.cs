...
{
	public partial class GaugeSeriesIkhMarker  : BaseObject
	{
		public GaugeSeriesIkhMarker()
		{
			LineWidth = LineWidth_DefaultValue = 0;
			LineColor = LineColor_DefaultValue = "#ffffff";
			Radius = Radius_DefaultValue = 4;
			States = States_DefaultValue = new GaugeSeriesIkhMarkerStates();
		...
		/// </summary>
		public GaugeSeriesIkhMarkerStates States { get; set; }
		private GaugeSeriesIkhMarkerStates States_DefaultValue { get; set; }
