...
{
	public partial class GaugeSeriesIkhStatesSelectMarker  : BaseObject
	{
		public GaugeSeriesIkhStatesSelectMarker()
		{
			LineWidth = LineWidth_DefaultValue = 0;
			LineColor = LineColor_DefaultValue = "#ffffff";
			Radius = Radius_DefaultValue = 4;
			States = States_DefaultValue = new GaugeSeriesIkhStatesSelectMarkerStates();
		...
		/// </summary>
		public GaugeSeriesIkhStatesSelectMarkerStates States { get; set; }
		private GaugeSeriesIkhStatesSelectMarkerStates States_DefaultValue { get; set; }
