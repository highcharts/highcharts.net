...
{
	public partial class GaugeSeriesLabel  : BaseObject
	{
		public GaugeSeriesLabel()
		{
			...
			Style = Style_DefaultValue = new GaugeSeriesLabelStyle();
		...
		/// </summary>
		public GaugeSeriesLabelEnabled Enabled { get; set; }
		private GaugeSeriesLabelEnabled Enabled_DefaultValue { get; set; }
		 

		/// <summary>
		/// Allow labels to be placed distant to the graph if necessary,and draw a connector line to the graph.
		/// </summary>
		public GaugeSeriesLabelConnectorAllowed ConnectorAllowed { get; set; }
		private GaugeSeriesLabelConnectorAllowed ConnectorAllowed_DefaultValue { get; set; }
		 

		/// <summary>
		/// If the label is closer than this to a neighbour graph, draw aconnector.
		/// </summary>
		public GaugeSeriesLabelConnectorNeighbourDistance ConnectorNeighbourDistance { get; set; }
		private GaugeSeriesLabelConnectorNeighbourDistance ConnectorNeighbourDistance_DefaultValue { get; set; }
		...
		/// </summary>
		public GaugeSeriesLabelStyle Style { get; set; }
		private GaugeSeriesLabelStyle Style_DefaultValue { get; set; }
