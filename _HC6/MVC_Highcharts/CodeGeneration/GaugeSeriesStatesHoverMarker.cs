...
namespace Highsoft.Web.Mvc.Charts
{
	public partial class GaugeSeriesStatesHoverMarker  : BaseObject
	{
		public GaugeSeriesStatesHoverMarker()
		{
			...
			States = States_DefaultValue = new GaugeSeriesStatesHoverMarkerStates();
		...
		/// </summary>
		public GaugeSeriesStatesHoverMarkerStates States { get; set; }
		private GaugeSeriesStatesHoverMarkerStates States_DefaultValue { get; set; }
