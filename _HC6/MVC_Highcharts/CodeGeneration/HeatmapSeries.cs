...
namespace Highsoft.Web.Mvc.Charts
{
	public partial class HeatmapSeries  : Series
	{
		public HeatmapSeries()
		{
			...
			FindNearestPointBy = FindNearestPointBy_DefaultValue = HeatmapSeriesFindNearestPointBy.Xy;
			...
			Zones = Zones_DefaultValue = new HeatmapSeriesZone();
		...
		/// </summary>
		public HeatmapSeriesZone Zones { get; set; }
		private HeatmapSeriesZone Zones_DefaultValue { get; set; }
