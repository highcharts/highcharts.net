...
namespace Highsoft.Web.Mvc.Charts
{
	public partial class HeatmapSeriesDataLabels  : BaseObject
	{
		public HeatmapSeriesDataLabels()
		{
			...
			VerticalAlign = VerticalAlign_DefaultValue = HeatmapSeriesDataLabelsVerticalAlign.Middle;
			Crop = Crop_DefaultValue = null;
			Overflow = Overflow_DefaultValue = HeatmapSeriesDataLabelsOverflow.Null;
