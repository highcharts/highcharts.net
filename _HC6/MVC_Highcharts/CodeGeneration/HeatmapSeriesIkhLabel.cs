...
{
	public partial class HeatmapSeriesIkhLabel  : BaseObject
	{
		public HeatmapSeriesIkhLabel()
		{
			...
			Style = Style_DefaultValue = new HeatmapSeriesIkhLabelStyle();
		...
		/// </summary>
		public HeatmapSeriesIkhLabelStyle Style { get; set; }
		private HeatmapSeriesIkhLabelStyle Style_DefaultValue { get; set; }
