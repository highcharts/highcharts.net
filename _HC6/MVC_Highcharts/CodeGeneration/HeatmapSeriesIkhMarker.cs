...
{
	public partial class HeatmapSeriesIkhMarker  : BaseObject
	{
		public HeatmapSeriesIkhMarker()
		{
			LineWidth = LineWidth_DefaultValue = 0;
			LineColor = LineColor_DefaultValue = "#ffffff";
			Radius = Radius_DefaultValue = 4;
			States = States_DefaultValue = new HeatmapSeriesIkhMarkerStates();
		...
		/// </summary>
		public HeatmapSeriesIkhMarkerStates States { get; set; }
		private HeatmapSeriesIkhMarkerStates States_DefaultValue { get; set; }
