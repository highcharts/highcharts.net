...
{
	public partial class HeatmapSeriesLabel  : BaseObject
	{
		public HeatmapSeriesLabel()
		{
			...
			Style = Style_DefaultValue = new HeatmapSeriesLabelStyle();
		...
		/// </summary>
		public HeatmapSeriesLabelEnabled Enabled { get; set; }
		private HeatmapSeriesLabelEnabled Enabled_DefaultValue { get; set; }
		 

		/// <summary>
		/// Allow labels to be placed distant to the graph if necessary,and draw a connector line to the graph.
		/// </summary>
		public HeatmapSeriesLabelConnectorAllowed ConnectorAllowed { get; set; }
		private HeatmapSeriesLabelConnectorAllowed ConnectorAllowed_DefaultValue { get; set; }
		 

		/// <summary>
		/// If the label is closer than this to a neighbour graph, draw aconnector.
		/// </summary>
		public HeatmapSeriesLabelConnectorNeighbourDistance ConnectorNeighbourDistance { get; set; }
		private HeatmapSeriesLabelConnectorNeighbourDistance ConnectorNeighbourDistance_DefaultValue { get; set; }
		...
		/// </summary>
		public HeatmapSeriesLabelStyle Style { get; set; }
		private HeatmapSeriesLabelStyle Style_DefaultValue { get; set; }
