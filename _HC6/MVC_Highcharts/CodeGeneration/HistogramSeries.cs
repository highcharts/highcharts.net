...
namespace Highsoft.Web.Mvc.Charts
{
	public partial class HistogramSeries  : Series
	{
		public HistogramSeries()
		{
			...
			Zones = Zones_DefaultValue = new HistogramSeriesZone();
			BoostThreshold = BoostThreshold_DefaultValue = 5000;
			LineWidth = LineWidth_DefaultValue = 2;
			Marker = Marker_DefaultValue = new HistogramSeriesMarker();
			ConnectNulls = ConnectNulls_DefaultValue = false;
			DashStyle = DashStyle_DefaultValue = HistogramSeriesDashStyle.Solid;
			Linecap = Linecap_DefaultValue = HistogramSeriesLinecap.Round;
			PointInterval = PointInterval_DefaultValue = 1;
			PointIntervalUnit = PointIntervalUnit_DefaultValue = HistogramSeriesPointIntervalUnit.Null;
			Stacking = Stacking_DefaultValue = HistogramSeriesStacking.Null;
			Step = Step_DefaultValue = HistogramSeriesStep.Null;
		...
		/// </summary>
		public HistogramSeriesZone Zones { get; set; }
		private HistogramSeriesZone Zones_DefaultValue { get; set; }
		...
		/// </summary>
		public HistogramSeriesMarker Marker { get; set; }
		private HistogramSeriesMarker Marker_DefaultValue { get; set; }
		...
		/// </summary>
		public HistogramSeriesDashStyle DashStyle { get; set; }
		private HistogramSeriesDashStyle DashStyle_DefaultValue { get; set; }
		 

		/// <summary>
		/// <p>The line cap used for line ends and line joins on the graph.</p>
		/// </summary>
		public HistogramSeriesLinecap Linecap { get; set; }
		private HistogramSeriesLinecap Linecap_DefaultValue { get; set; }
		...
		/// </summary>
		public HistogramSeriesPointIntervalUnit PointIntervalUnit { get; set; }
		private HistogramSeriesPointIntervalUnit PointIntervalUnit_DefaultValue { get; set; }
		...
		/// </summary>
		public HistogramSeriesStacking Stacking { get; set; }
		private HistogramSeriesStacking Stacking_DefaultValue { get; set; }
		 

		/// <summary>
		/// <p>Whether to apply steps to the line. Possible values are <code>left</code>, <code>center</code>and <code>right</code>.</p>
		/// </summary>
		public HistogramSeriesStep Step { get; set; }
		private HistogramSeriesStep Step_DefaultValue { get; set; }
