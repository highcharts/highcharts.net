...
{
	public partial class HistogramSeriesIkhMarker  : BaseObject
	{
		public HistogramSeriesIkhMarker()
		{
			LineWidth = LineWidth_DefaultValue = 0;
			LineColor = LineColor_DefaultValue = "#ffffff";
			Radius = Radius_DefaultValue = 4;
			States = States_DefaultValue = new HistogramSeriesIkhMarkerStates();
		...
		/// </summary>
		public HistogramSeriesIkhMarkerStates States { get; set; }
		private HistogramSeriesIkhMarkerStates States_DefaultValue { get; set; }
