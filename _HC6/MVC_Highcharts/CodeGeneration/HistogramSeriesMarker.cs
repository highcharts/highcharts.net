...
{
	public partial class HistogramSeriesMarker  : BaseObject
	{
		public HistogramSeriesMarker()
		{
			LineWidth = LineWidth_DefaultValue = 0;
			LineColor = LineColor_DefaultValue = "#ffffff";
			Radius = Radius_DefaultValue = 4;
			States = States_DefaultValue = new HistogramSeriesMarkerStates();
		...
		/// </summary>
		public HistogramSeriesMarkerStates States { get; set; }
		private HistogramSeriesMarkerStates States_DefaultValue { get; set; }
