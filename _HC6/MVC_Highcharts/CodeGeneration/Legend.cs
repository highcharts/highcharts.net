...
namespace Highsoft.Web.Mvc.Charts
{
	public partial class Legend  : BaseObject
	{
		...
		/// <summary>
		/// <p>Line height for the legend items. Deprecated as of 2.1. Instead,the line height for each item can be set using itemStyle.lineHeight,and the padding between items using itemMarginTop and itemMarginBottom.</p>
		/// </summary>
		...
		/// <summary>
		/// <p>Whether to show the symbol on the right side of the text rather thanthe left side. This is common in Arabic and Hebraic.</p>
		/// </summary>
