...
{
	public partial class LineSeriesDragDrop  : BaseObject
	{
		public LineSeriesDragDrop()
		{
			DraggableX = DraggableX_DefaultValue = null;
			DraggableY = DraggableY_DefaultValue = null;
			DragHandle = DragHandle_DefaultValue = new LineSeriesDragDropDragHandle();
			...
			GuideBox = GuideBox_DefaultValue = new LineSeriesDragDropGuideBox();
		...
		/// </summary>
		public LineSeriesDragDropDragHandle DragHandle { get; set; }
		private LineSeriesDragDropDragHandle DragHandle_DefaultValue { get; set; }
		...
		/// </summary>
		public LineSeriesDragDropGuideBox GuideBox { get; set; }
		private LineSeriesDragDropGuideBox GuideBox_DefaultValue { get; set; }
