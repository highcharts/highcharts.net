...
{
	public partial class LineSeriesIkhLabel  : BaseObject
	{
		public LineSeriesIkhLabel()
		{
			...
			Style = Style_DefaultValue = new LineSeriesIkhLabelStyle();
		...
		/// </summary>
		public LineSeriesIkhLabelStyle Style { get; set; }
		private LineSeriesIkhLabelStyle Style_DefaultValue { get; set; }
