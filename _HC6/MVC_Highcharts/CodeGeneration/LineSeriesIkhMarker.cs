...
{
	public partial class LineSeriesIkhMarker  : BaseObject
	{
		public LineSeriesIkhMarker()
		{
			LineWidth = LineWidth_DefaultValue = 0;
			LineColor = LineColor_DefaultValue = "#ffffff";
			Radius = Radius_DefaultValue = 4;
			States = States_DefaultValue = new LineSeriesIkhMarkerStates();
		...
		/// </summary>
		public LineSeriesIkhMarkerStates States { get; set; }
		private LineSeriesIkhMarkerStates States_DefaultValue { get; set; }
