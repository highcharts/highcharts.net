...
{
	public partial class LineSeriesIkhStatesHoverMarker  : BaseObject
	{
		public LineSeriesIkhStatesHoverMarker()
		{
			LineWidth = LineWidth_DefaultValue = 0;
			LineColor = LineColor_DefaultValue = "#ffffff";
			Radius = Radius_DefaultValue = 4;
			States = States_DefaultValue = new LineSeriesIkhStatesHoverMarkerStates();
		...
		/// </summary>
		public LineSeriesIkhStatesHoverMarkerStates States { get; set; }
		private LineSeriesIkhStatesHoverMarkerStates States_DefaultValue { get; set; }
