...
{
	public partial class LineSeriesIkhStatesSelectMarker  : BaseObject
	{
		public LineSeriesIkhStatesSelectMarker()
		{
			LineWidth = LineWidth_DefaultValue = 0;
			LineColor = LineColor_DefaultValue = "#ffffff";
			Radius = Radius_DefaultValue = 4;
			States = States_DefaultValue = new LineSeriesIkhStatesSelectMarkerStates();
		...
		/// </summary>
		public LineSeriesIkhStatesSelectMarkerStates States { get; set; }
		private LineSeriesIkhStatesSelectMarkerStates States_DefaultValue { get; set; }
