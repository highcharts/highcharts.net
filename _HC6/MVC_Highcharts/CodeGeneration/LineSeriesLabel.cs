...
{
	public partial class LineSeriesLabel  : BaseObject
	{
		public LineSeriesLabel()
		{
			...
			Style = Style_DefaultValue = new LineSeriesLabelStyle();
		...
		/// </summary>
		public LineSeriesLabelEnabled Enabled { get; set; }
		private LineSeriesLabelEnabled Enabled_DefaultValue { get; set; }
		 

		/// <summary>
		/// Allow labels to be placed distant to the graph if necessary,and draw a connector line to the graph.
		/// </summary>
		public LineSeriesLabelConnectorAllowed ConnectorAllowed { get; set; }
		private LineSeriesLabelConnectorAllowed ConnectorAllowed_DefaultValue { get; set; }
		 

		/// <summary>
		/// If the label is closer than this to a neighbour graph, draw aconnector.
		/// </summary>
		public LineSeriesLabelConnectorNeighbourDistance ConnectorNeighbourDistance { get; set; }
		private LineSeriesLabelConnectorNeighbourDistance ConnectorNeighbourDistance_DefaultValue { get; set; }
		...
		/// </summary>
		public LineSeriesLabelStyle Style { get; set; }
		private LineSeriesLabelStyle Style_DefaultValue { get; set; }
