...
{
	public partial class LineSeriesStatesHoverHalo  : BaseObject
	{
		...
		/// </summary>
		public LineSeriesStatesHoverHaloAttributes Attributes { get; set; }
		private LineSeriesStatesHoverHaloAttributes Attributes_DefaultValue { get; set; }
