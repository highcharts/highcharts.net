...
namespace Highsoft.Web.Mvc.Charts
{
	public partial class LineSeriesStatesHoverMarker  : BaseObject
	{
		public LineSeriesStatesHoverMarker()
		{
			...
			States = States_DefaultValue = new LineSeriesStatesHoverMarkerStates();
		...
		/// </summary>
		public LineSeriesStatesHoverMarkerStates States { get; set; }
		private LineSeriesStatesHoverMarkerStates States_DefaultValue { get; set; }
