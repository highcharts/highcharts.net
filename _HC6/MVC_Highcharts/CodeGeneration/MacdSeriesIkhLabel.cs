...
{
	public partial class MacdSeriesIkhLabel  : BaseObject
	{
		public MacdSeriesIkhLabel()
		{
			...
			Style = Style_DefaultValue = new MacdSeriesIkhLabelStyle();
		...
		/// </summary>
		public MacdSeriesIkhLabelStyle Style { get; set; }
		private MacdSeriesIkhLabelStyle Style_DefaultValue { get; set; }
