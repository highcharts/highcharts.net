...
{
	public partial class MacdSeriesIkhStatesSelectMarker  : BaseObject
	{
		public MacdSeriesIkhStatesSelectMarker()
		{
			LineWidth = LineWidth_DefaultValue = 0;
			LineColor = LineColor_DefaultValue = "#ffffff";
			Radius = Radius_DefaultValue = 4;
			States = States_DefaultValue = new MacdSeriesIkhStatesSelectMarkerStates();
		...
		/// </summary>
		public MacdSeriesIkhStatesSelectMarkerStates States { get; set; }
		private MacdSeriesIkhStatesSelectMarkerStates States_DefaultValue { get; set; }
