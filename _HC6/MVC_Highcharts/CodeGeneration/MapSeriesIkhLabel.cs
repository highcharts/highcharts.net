...
{
	public partial class MapSeriesIkhLabel  : BaseObject
	{
		public MapSeriesIkhLabel()
		{
			...
			Style = Style_DefaultValue = new MapSeriesIkhLabelStyle();
		...
		/// </summary>
		public MapSeriesIkhLabelStyle Style { get; set; }
		private MapSeriesIkhLabelStyle Style_DefaultValue { get; set; }
