...
{
	public partial class MapSeriesLabel  : BaseObject
	{
		public MapSeriesLabel()
		{
			...
			Style = Style_DefaultValue = new MapSeriesLabelStyle();
		...
		/// </summary>
		public MapSeriesLabelStyle Style { get; set; }
		private MapSeriesLabelStyle Style_DefaultValue { get; set; }
