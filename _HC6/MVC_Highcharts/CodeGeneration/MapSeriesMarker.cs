...
{
	public partial class MapSeriesMarker  : BaseObject
	{
		public MapSeriesMarker()
		{
			...
			States = States_DefaultValue = new MapSeriesMarkerStates();
		...
		/// </summary>
		public MapSeriesMarkerStates States { get; set; }
		private MapSeriesMarkerStates States_DefaultValue { get; set; }
