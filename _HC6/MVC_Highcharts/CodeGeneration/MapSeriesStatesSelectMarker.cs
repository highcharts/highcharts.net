...
{
	public partial class MapSeriesStatesSelectMarker  : BaseObject
	{
		public MapSeriesStatesSelectMarker()
		{
			LineWidth = LineWidth_DefaultValue = 0;
			LineColor = LineColor_DefaultValue = "#ffffff";
			Radius = Radius_DefaultValue = 4;
			States = States_DefaultValue = new MapSeriesStatesSelectMarkerStates();
		...
		/// </summary>
		public MapSeriesStatesSelectMarkerStates States { get; set; }
		private MapSeriesStatesSelectMarkerStates States_DefaultValue { get; set; }
