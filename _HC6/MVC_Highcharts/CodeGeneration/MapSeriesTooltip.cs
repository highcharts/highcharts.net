...
{
	public partial class MapSeriesTooltip  : BaseObject
	{
		public MapSeriesTooltip()
		{
		...
		internal override Hashtable ToHashtable()
		{
			...
			if (PointFormatter != PointFormatter_DefaultValue) { h.Add("pointFormatter",PointFormatter); Highcharts.AddFunction("MapSeriesTooltipPointFormatter.pointFormatter", PointFormatter); }  
