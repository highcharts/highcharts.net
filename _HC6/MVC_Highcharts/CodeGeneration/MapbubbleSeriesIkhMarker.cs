...
{
	public partial class MapbubbleSeriesIkhMarker  : BaseObject
	{
		public MapbubbleSeriesIkhMarker()
		{
			LineWidth = LineWidth_DefaultValue = 0;
			LineColor = LineColor_DefaultValue = "#ffffff";
			Radius = Radius_DefaultValue = 4;
			States = States_DefaultValue = new MapbubbleSeriesIkhMarkerStates();
		...
		/// </summary>
		public MapbubbleSeriesIkhMarkerStates States { get; set; }
		private MapbubbleSeriesIkhMarkerStates States_DefaultValue { get; set; }
