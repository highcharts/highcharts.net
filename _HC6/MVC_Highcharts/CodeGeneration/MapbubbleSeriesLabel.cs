...
{
	public partial class MapbubbleSeriesLabel  : BaseObject
	{
		public MapbubbleSeriesLabel()
		{
			...
			Style = Style_DefaultValue = new MapbubbleSeriesLabelStyle();
		...
		/// </summary>
		public MapbubbleSeriesLabelStyle Style { get; set; }
		private MapbubbleSeriesLabelStyle Style_DefaultValue { get; set; }
