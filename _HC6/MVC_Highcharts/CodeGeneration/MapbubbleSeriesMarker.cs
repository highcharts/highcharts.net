...
{
	public partial class MapbubbleSeriesMarker  : BaseObject
	{
		public MapbubbleSeriesMarker()
		{
			LineColor = LineColor_DefaultValue = null;
			LineWidth = LineWidth_DefaultValue = null;
			States = States_DefaultValue = new MapbubbleSeriesMarkerStates();
		...
		/// </summary>
		public MapbubbleSeriesMarkerStates States { get; set; }
		private MapbubbleSeriesMarkerStates States_DefaultValue { get; set; }
