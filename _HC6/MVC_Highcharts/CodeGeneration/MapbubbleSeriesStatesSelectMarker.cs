...
{
	public partial class MapbubbleSeriesStatesSelectMarker  : BaseObject
	{
		public MapbubbleSeriesStatesSelectMarker()
		{
			LineWidth = LineWidth_DefaultValue = 0;
			LineColor = LineColor_DefaultValue = "#ffffff";
			Radius = Radius_DefaultValue = 4;
			States = States_DefaultValue = new MapbubbleSeriesStatesSelectMarkerStates();
		...
		/// </summary>
		public MapbubbleSeriesStatesSelectMarkerStates States { get; set; }
		private MapbubbleSeriesStatesSelectMarkerStates States_DefaultValue { get; set; }
