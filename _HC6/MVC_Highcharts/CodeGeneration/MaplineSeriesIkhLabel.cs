...
{
	public partial class MaplineSeriesIkhLabel  : BaseObject
	{
		public MaplineSeriesIkhLabel()
		{
			...
			Style = Style_DefaultValue = new MaplineSeriesIkhLabelStyle();
		...
		/// </summary>
		public MaplineSeriesIkhLabelStyle Style { get; set; }
		private MaplineSeriesIkhLabelStyle Style_DefaultValue { get; set; }
