...
{
	public partial class MaplineSeriesMarker  : BaseObject
	{
		public MaplineSeriesMarker()
		{
			LineWidth = LineWidth_DefaultValue = 0;
			LineColor = LineColor_DefaultValue = "#ffffff";
			Radius = Radius_DefaultValue = 4;
			States = States_DefaultValue = new MaplineSeriesMarkerStates();
		...
		/// </summary>
		public MaplineSeriesMarkerStates States { get; set; }
		private MaplineSeriesMarkerStates States_DefaultValue { get; set; }
