...
{
	public partial class MaplineSeriesStatesSelectMarker  : BaseObject
	{
		public MaplineSeriesStatesSelectMarker()
		{
			LineWidth = LineWidth_DefaultValue = 0;
			LineColor = LineColor_DefaultValue = "#ffffff";
			Radius = Radius_DefaultValue = 4;
			States = States_DefaultValue = new MaplineSeriesStatesSelectMarkerStates();
		...
		/// </summary>
		public MaplineSeriesStatesSelectMarkerStates States { get; set; }
		private MaplineSeriesStatesSelectMarkerStates States_DefaultValue { get; set; }
