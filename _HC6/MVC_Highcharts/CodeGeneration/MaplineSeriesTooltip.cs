...
namespace Highsoft.Web.Mvc.Charts
{
	public partial class MaplineSeriesTooltip  : BaseObject
	{
		...
		internal override Hashtable ToHashtable()
		{
			...
			if (PointFormatter != PointFormatter_DefaultValue) { h.Add("pointFormatter",PointFormatter); Highcharts.AddFunction("MaplineSeriesTooltipPointFormatter.pointFormatter", PointFormatter); }  
