...
{
	public partial class MappointSeriesIkhStatesHoverMarker  : BaseObject
	{
		public MappointSeriesIkhStatesHoverMarker()
		{
			LineWidth = LineWidth_DefaultValue = 0;
			LineColor = LineColor_DefaultValue = "#ffffff";
			Radius = Radius_DefaultValue = 4;
			States = States_DefaultValue = new MappointSeriesIkhStatesHoverMarkerStates();
		...
		/// </summary>
		public MappointSeriesIkhStatesHoverMarkerStates States { get; set; }
		private MappointSeriesIkhStatesHoverMarkerStates States_DefaultValue { get; set; }
