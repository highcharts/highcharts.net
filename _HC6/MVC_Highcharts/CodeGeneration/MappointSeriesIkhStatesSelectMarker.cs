...
{
	public partial class MappointSeriesIkhStatesSelectMarker  : BaseObject
	{
		public MappointSeriesIkhStatesSelectMarker()
		{
			LineWidth = LineWidth_DefaultValue = 0;
			LineColor = LineColor_DefaultValue = "#ffffff";
			Radius = Radius_DefaultValue = 4;
			States = States_DefaultValue = new MappointSeriesIkhStatesSelectMarkerStates();
		...
		/// </summary>
		public MappointSeriesIkhStatesSelectMarkerStates States { get; set; }
		private MappointSeriesIkhStatesSelectMarkerStates States_DefaultValue { get; set; }
