...
{
	public partial class MappointSeriesLabel  : BaseObject
	{
		public MappointSeriesLabel()
		{
			...
			Style = Style_DefaultValue = new MappointSeriesLabelStyle();
		...
		/// </summary>
		public MappointSeriesLabelStyle Style { get; set; }
		private MappointSeriesLabelStyle Style_DefaultValue { get; set; }
