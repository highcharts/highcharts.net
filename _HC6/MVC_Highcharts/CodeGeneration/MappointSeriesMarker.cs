...
{
	public partial class MappointSeriesMarker  : BaseObject
	{
		public MappointSeriesMarker()
		{
			Enabled = Enabled_DefaultValue = null;
			LineWidth = LineWidth_DefaultValue = 0;
			LineColor = LineColor_DefaultValue = "#ffffff";
			Radius = Radius_DefaultValue = 4;
			States = States_DefaultValue = new MappointSeriesMarkerStates();
		...
		/// </summary>
		public MappointSeriesMarkerStates States { get; set; }
		private MappointSeriesMarkerStates States_DefaultValue { get; set; }
