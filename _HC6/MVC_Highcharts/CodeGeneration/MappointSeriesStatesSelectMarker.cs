...
{
	public partial class MappointSeriesStatesSelectMarker  : BaseObject
	{
		public MappointSeriesStatesSelectMarker()
		{
			LineWidth = LineWidth_DefaultValue = 0;
			LineColor = LineColor_DefaultValue = "#ffffff";
			Radius = Radius_DefaultValue = 4;
			States = States_DefaultValue = new MappointSeriesStatesSelectMarkerStates();
		...
		/// </summary>
		public MappointSeriesStatesSelectMarkerStates States { get; set; }
		private MappointSeriesStatesSelectMarkerStates States_DefaultValue { get; set; }
