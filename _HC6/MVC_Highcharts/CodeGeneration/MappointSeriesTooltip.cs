...
namespace Highsoft.Web.Mvc.Charts
{
	public partial class MappointSeriesTooltip  : BaseObject
	{
		...
		internal override Hashtable ToHashtable()
		{
			...
			if (PointFormatter != PointFormatter_DefaultValue) { h.Add("pointFormatter",PointFormatter); Highcharts.AddFunction("MappointSeriesTooltipPointFormatter.pointFormatter", PointFormatter); }  
