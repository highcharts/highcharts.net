...
{
	public partial class MfiSeriesIkhLabel  : BaseObject
	{
		public MfiSeriesIkhLabel()
		{
			...
			Style = Style_DefaultValue = new MfiSeriesIkhLabelStyle();
		...
		/// </summary>
		public MfiSeriesIkhLabelStyle Style { get; set; }
		private MfiSeriesIkhLabelStyle Style_DefaultValue { get; set; }
