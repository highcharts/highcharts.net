...
{
	public partial class MfiSeriesIkhMarker  : BaseObject
	{
		public MfiSeriesIkhMarker()
		{
			LineWidth = LineWidth_DefaultValue = 0;
			LineColor = LineColor_DefaultValue = "#ffffff";
			Radius = Radius_DefaultValue = 4;
			States = States_DefaultValue = new MfiSeriesIkhMarkerStates();
		...
		/// </summary>
		public MfiSeriesIkhMarkerStates States { get; set; }
		private MfiSeriesIkhMarkerStates States_DefaultValue { get; set; }
