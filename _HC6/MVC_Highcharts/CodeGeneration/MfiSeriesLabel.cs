...
{
	public partial class MfiSeriesLabel  : BaseObject
	{
		public MfiSeriesLabel()
		{
			...
			Style = Style_DefaultValue = new MfiSeriesLabelStyle();
		...
		/// </summary>
		public MfiSeriesLabelStyle Style { get; set; }
		private MfiSeriesLabelStyle Style_DefaultValue { get; set; }
