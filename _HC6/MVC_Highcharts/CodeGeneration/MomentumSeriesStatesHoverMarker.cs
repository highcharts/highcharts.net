...
{
	public partial class MomentumSeriesStatesHoverMarker  : BaseObject
	{
		public MomentumSeriesStatesHoverMarker()
		{
			LineWidth = LineWidth_DefaultValue = 0;
			LineColor = LineColor_DefaultValue = "#ffffff";
			Radius = Radius_DefaultValue = 4;
			States = States_DefaultValue = new MomentumSeriesStatesHoverMarkerStates();
		...
		/// </summary>
		public MomentumSeriesStatesHoverMarkerStates States { get; set; }
		private MomentumSeriesStatesHoverMarkerStates States_DefaultValue { get; set; }
