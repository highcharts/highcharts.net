...
{
	public partial class OhlcSeriesIkhLabel  : BaseObject
	{
		public OhlcSeriesIkhLabel()
		{
			...
			Style = Style_DefaultValue = new OhlcSeriesIkhLabelStyle();
		...
		/// </summary>
		public OhlcSeriesIkhLabelStyle Style { get; set; }
		private OhlcSeriesIkhLabelStyle Style_DefaultValue { get; set; }
