...
{
	public partial class OhlcSeriesIkhMarker  : BaseObject
	{
		public OhlcSeriesIkhMarker()
		{
			LineWidth = LineWidth_DefaultValue = 0;
			LineColor = LineColor_DefaultValue = "#ffffff";
			Radius = Radius_DefaultValue = 4;
			States = States_DefaultValue = new OhlcSeriesIkhMarkerStates();
		...
		/// </summary>
		public OhlcSeriesIkhMarkerStates States { get; set; }
		private OhlcSeriesIkhMarkerStates States_DefaultValue { get; set; }
