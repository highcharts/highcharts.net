...
{
	public partial class OhlcSeriesIkhStatesHoverMarker  : BaseObject
	{
		public OhlcSeriesIkhStatesHoverMarker()
		{
			LineWidth = LineWidth_DefaultValue = 0;
			LineColor = LineColor_DefaultValue = "#ffffff";
			Radius = Radius_DefaultValue = 4;
			States = States_DefaultValue = new OhlcSeriesIkhStatesHoverMarkerStates();
		...
		/// </summary>
		public OhlcSeriesIkhStatesHoverMarkerStates States { get; set; }
		private OhlcSeriesIkhStatesHoverMarkerStates States_DefaultValue { get; set; }
