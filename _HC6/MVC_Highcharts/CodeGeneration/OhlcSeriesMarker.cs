...
{
	public partial class OhlcSeriesMarker  : BaseObject
	{
		public OhlcSeriesMarker()
		{
			LineWidth = LineWidth_DefaultValue = 0;
			LineColor = LineColor_DefaultValue = "#ffffff";
			Radius = Radius_DefaultValue = 4;
			States = States_DefaultValue = new OhlcSeriesMarkerStates();
		...
		/// </summary>
		public OhlcSeriesMarkerStates States { get; set; }
		private OhlcSeriesMarkerStates States_DefaultValue { get; set; }
