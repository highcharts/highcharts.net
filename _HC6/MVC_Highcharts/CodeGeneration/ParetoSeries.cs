...
namespace Highsoft.Web.Mvc.Charts
{
	public partial class ParetoSeries  : Series
	{
		public ParetoSeries()
		{
			...
			FindNearestPointBy = FindNearestPointBy_DefaultValue = ParetoSeriesFindNearestPointBy.X;
			Keys = Keys_DefaultValue = new List<string>();
			NegativeColor = NegativeColor_DefaultValue = "null";
			PointInterval = PointInterval_DefaultValue = 1;
			PointIntervalUnit = PointIntervalUnit_DefaultValue = ParetoSeriesPointIntervalUnit.Null;
			PointPlacement = PointPlacement_DefaultValue = new PointPlacement();
			PointStart = PointStart_DefaultValue = 0;
			Shadow = Shadow_DefaultValue = new Shadow() { Enabled = false };
			Stacking = Stacking_DefaultValue = ParetoSeriesStacking.Null;
			Step = Step_DefaultValue = ParetoSeriesStep.Null;
			Threshold = Threshold_DefaultValue = 0;
			ZoneAxis = ZoneAxis_DefaultValue = "y";
			Zones = Zones_DefaultValue = new List<ParetoSeriesZone>();
		...
		/// </summary>
		public ParetoSeriesFindNearestPointBy FindNearestPointBy { get; set; }
		private ParetoSeriesFindNearestPointBy FindNearestPointBy_DefaultValue { get; set; }
		...
		/// </summary>
		public ParetoSeriesPointIntervalUnit PointIntervalUnit { get; set; }
		private ParetoSeriesPointIntervalUnit PointIntervalUnit_DefaultValue { get; set; }
		...
		/// </summary>
		public ParetoSeriesStacking Stacking { get; set; }
		private ParetoSeriesStacking Stacking_DefaultValue { get; set; }
		 

		/// <summary>
		/// <p>Whether to apply steps to the line. Possible values are <code>left</code>, <code>center</code>and <code>right</code>.</p>
		/// </summary>
		public ParetoSeriesStep Step { get; set; }
		private ParetoSeriesStep Step_DefaultValue { get; set; }
		...
		/// </summary>
		public List<ParetoSeriesZone> Zones { get; set; }
		private List<ParetoSeriesZone> Zones_DefaultValue { get; set; }
