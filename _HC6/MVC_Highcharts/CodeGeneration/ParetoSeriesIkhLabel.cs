...
{
	public partial class ParetoSeriesIkhLabel  : BaseObject
	{
		public ParetoSeriesIkhLabel()
		{
			...
			Style = Style_DefaultValue = new ParetoSeriesIkhLabelStyle();
		...
		/// </summary>
		public ParetoSeriesIkhLabelStyle Style { get; set; }
		private ParetoSeriesIkhLabelStyle Style_DefaultValue { get; set; }
