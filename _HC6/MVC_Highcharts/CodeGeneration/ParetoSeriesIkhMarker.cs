...
{
	public partial class ParetoSeriesIkhMarker  : BaseObject
	{
		public ParetoSeriesIkhMarker()
		{
			LineWidth = LineWidth_DefaultValue = 0;
			LineColor = LineColor_DefaultValue = "#ffffff";
			Radius = Radius_DefaultValue = 4;
			States = States_DefaultValue = new ParetoSeriesIkhMarkerStates();
		...
		/// </summary>
		public ParetoSeriesIkhMarkerStates States { get; set; }
		private ParetoSeriesIkhMarkerStates States_DefaultValue { get; set; }
