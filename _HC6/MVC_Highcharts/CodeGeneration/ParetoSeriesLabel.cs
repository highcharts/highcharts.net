...
{
	public partial class ParetoSeriesLabel  : BaseObject
	{
		public ParetoSeriesLabel()
		{
			...
			Style = Style_DefaultValue = new ParetoSeriesLabelStyle();
		...
		/// </summary>
		public ParetoSeriesLabelEnabled Enabled { get; set; }
		private ParetoSeriesLabelEnabled Enabled_DefaultValue { get; set; }
		 

		/// <summary>
		/// Allow labels to be placed distant to the graph if necessary,and draw a connector line to the graph.
		/// </summary>
		public ParetoSeriesLabelConnectorAllowed ConnectorAllowed { get; set; }
		private ParetoSeriesLabelConnectorAllowed ConnectorAllowed_DefaultValue { get; set; }
		 

		/// <summary>
		/// If the label is closer than this to a neighbour graph, draw aconnector.
		/// </summary>
		public ParetoSeriesLabelConnectorNeighbourDistance ConnectorNeighbourDistance { get; set; }
		private ParetoSeriesLabelConnectorNeighbourDistance ConnectorNeighbourDistance_DefaultValue { get; set; }
		...
		/// </summary>
		public ParetoSeriesLabelStyle Style { get; set; }
		private ParetoSeriesLabelStyle Style_DefaultValue { get; set; }
