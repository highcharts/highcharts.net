...
{
	public partial class ParetoSeriesStatesHoverMarker  : BaseObject
	{
		public ParetoSeriesStatesHoverMarker()
		{
			...
			States = States_DefaultValue = new ParetoSeriesStatesHoverMarkerStates();
		...
		/// </summary>
		public ParetoSeriesStatesHoverMarkerStates States { get; set; }
		private ParetoSeriesStatesHoverMarkerStates States_DefaultValue { get; set; }
