...
namespace Highsoft.Web.Mvc.Charts
{
	public partial class PieSeries  : Series
	{
		public PieSeries()
		{
			...
			Marker = Marker_DefaultValue = new PieSeriesMarker();
			CropThreshold = CropThreshold_DefaultValue = 300;
			SoftThreshold = SoftThreshold_DefaultValue = true;
			TurboThreshold = TurboThreshold_DefaultValue = 1000;
			FindNearestPointBy = FindNearestPointBy_DefaultValue = PieSeriesFindNearestPointBy.X;
			AnimationLimit = AnimationLimit_DefaultValue = null;
			ConnectNulls = ConnectNulls_DefaultValue = false;
			DashStyle = DashStyle_DefaultValue = PieSeriesDashStyle.Solid;
			GetExtremesFromAll = GetExtremesFromAll_DefaultValue = false;
			NegativeColor = NegativeColor_DefaultValue = "null";
			PointInterval = PointInterval_DefaultValue = 1;
			PointIntervalUnit = PointIntervalUnit_DefaultValue = PieSeriesPointIntervalUnit.Null;
			PointPlacement = PointPlacement_DefaultValue = new PointPlacement();
			PointStart = PointStart_DefaultValue = 0;
			Stacking = Stacking_DefaultValue = PieSeriesStacking.Null;
			Step = Step_DefaultValue = PieSeriesStep.Null;
			Threshold = Threshold_DefaultValue = 0;
			ZoneAxis = ZoneAxis_DefaultValue = "y";
			Zones = Zones_DefaultValue = new PieSeriesZone();
		...
		/// <summary>
		/// <p>An array of data points for the series. For the <code>pie</code> series type,points can be given in the following ways:</p><ol><li><p>An array of numerical values. In this case, the numerical valueswill be interpreted as <code>y</code> options. Example:</p><pre><code class="lang-js">data: [0, 5, 3, 5]</code></pre></li><li><p>An array of objects with named values. The objects are pointconfiguration objects as seen below. If the total number of datapoints exceeds the series&#39; <a href="#series.pie.turboThreshold">turboThreshold</a>,this option is not available.</p><p>```jsdata: [{y: 1,name: &quot;Point2&quot;,color: &quot;#00FF00&quot;}, {y: 7,name: &quot;Point1&quot;,color: &quot;#FF00FF&quot;}]</pre></p></li></ol>
		/// </summary>
		...
		/// </summary>
		public PieSeriesMarker Marker { get; set; }
		private PieSeriesMarker Marker_DefaultValue { get; set; }
		...
		/// </summary>
		public PieSeriesFindNearestPointBy FindNearestPointBy { get; set; }
		private PieSeriesFindNearestPointBy FindNearestPointBy_DefaultValue { get; set; }
		...
		/// </summary>
		public PieSeriesDashStyle DashStyle { get; set; }
		private PieSeriesDashStyle DashStyle_DefaultValue { get; set; }
		...
		/// </summary>
		public PieSeriesPointIntervalUnit PointIntervalUnit { get; set; }
		private PieSeriesPointIntervalUnit PointIntervalUnit_DefaultValue { get; set; }
		...
		/// </summary>
		public PieSeriesStacking Stacking { get; set; }
		private PieSeriesStacking Stacking_DefaultValue { get; set; }
		 

		/// <summary>
		/// <p>Whether to apply steps to the line. Possible values are <code>left</code>, <code>center</code>and <code>right</code>.</p>
		/// </summary>
		public PieSeriesStep Step { get; set; }
		private PieSeriesStep Step_DefaultValue { get; set; }
		...
		/// </summary>
		public PieSeriesZone Zones { get; set; }
		private PieSeriesZone Zones_DefaultValue { get; set; }
