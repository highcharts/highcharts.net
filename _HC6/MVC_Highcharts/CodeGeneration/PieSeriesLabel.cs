...
{
	public partial class PieSeriesLabel  : BaseObject
	{
		public PieSeriesLabel()
		{
			...
			Style = Style_DefaultValue = new PieSeriesLabelStyle();
		...
		/// </summary>
		public PieSeriesLabelEnabled Enabled { get; set; }
		private PieSeriesLabelEnabled Enabled_DefaultValue { get; set; }
		 

		/// <summary>
		/// Allow labels to be placed distant to the graph if necessary,and draw a connector line to the graph.
		/// </summary>
		public PieSeriesLabelConnectorAllowed ConnectorAllowed { get; set; }
		private PieSeriesLabelConnectorAllowed ConnectorAllowed_DefaultValue { get; set; }
		 

		/// <summary>
		/// If the label is closer than this to a neighbour graph, draw aconnector.
		/// </summary>
		public PieSeriesLabelConnectorNeighbourDistance ConnectorNeighbourDistance { get; set; }
		private PieSeriesLabelConnectorNeighbourDistance ConnectorNeighbourDistance_DefaultValue { get; set; }
		...
		private PieSeriesLabelStyle Style_DefaultValue { get; set; }
