...
namespace Highsoft.Web.Mvc.Charts
{
	public partial class PieSeriesStatesHoverMarker  : BaseObject
	{
		public PieSeriesStatesHoverMarker()
		{
			...
			States = States_DefaultValue = new PieSeriesStatesHoverMarkerStates();
		...
		/// </summary>
		public PieSeriesStatesHoverMarkerStates States { get; set; }
		private PieSeriesStatesHoverMarkerStates States_DefaultValue { get; set; }
