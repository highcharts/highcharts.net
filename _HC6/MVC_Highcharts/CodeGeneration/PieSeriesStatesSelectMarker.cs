...
{
	public partial class PieSeriesStatesSelectMarker  : BaseObject
	{
		public PieSeriesStatesSelectMarker()
		{
			LineWidth = LineWidth_DefaultValue = 0;
			LineColor = LineColor_DefaultValue = "#ffffff";
			Radius = Radius_DefaultValue = 4;
			States = States_DefaultValue = new PieSeriesStatesSelectMarkerStates();
		...
		/// </summary>
		public PieSeriesStatesSelectMarkerStates States { get; set; }
		private PieSeriesStatesSelectMarkerStates States_DefaultValue { get; set; }
