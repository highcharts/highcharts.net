...
{
	public partial class PivotpointsSeriesIkhLabel  : BaseObject
	{
		public PivotpointsSeriesIkhLabel()
		{
			...
			Style = Style_DefaultValue = new PivotpointsSeriesIkhLabelStyle();
		...
		/// </summary>
		public PivotpointsSeriesIkhLabelStyle Style { get; set; }
		private PivotpointsSeriesIkhLabelStyle Style_DefaultValue { get; set; }
