...
{
	public partial class PivotpointsSeriesIkhStatesHoverMarker  : BaseObject
	{
		public PivotpointsSeriesIkhStatesHoverMarker()
		{
			LineWidth = LineWidth_DefaultValue = 0;
			LineColor = LineColor_DefaultValue = "#ffffff";
			Radius = Radius_DefaultValue = 4;
			States = States_DefaultValue = new PivotpointsSeriesIkhStatesHoverMarkerStates();
		...
		/// </summary>
		public PivotpointsSeriesIkhStatesHoverMarkerStates States { get; set; }
		private PivotpointsSeriesIkhStatesHoverMarkerStates States_DefaultValue { get; set; }
