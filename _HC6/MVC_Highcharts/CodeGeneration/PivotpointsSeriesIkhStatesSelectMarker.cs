...
{
	public partial class PivotpointsSeriesIkhStatesSelectMarker  : BaseObject
	{
		public PivotpointsSeriesIkhStatesSelectMarker()
		{
			LineWidth = LineWidth_DefaultValue = 0;
			LineColor = LineColor_DefaultValue = "#ffffff";
			Radius = Radius_DefaultValue = 4;
			States = States_DefaultValue = new PivotpointsSeriesIkhStatesSelectMarkerStates();
		...
		/// </summary>
		public PivotpointsSeriesIkhStatesSelectMarkerStates States { get; set; }
		private PivotpointsSeriesIkhStatesSelectMarkerStates States_DefaultValue { get; set; }
