...
{
	public partial class PlotOptionsAdMarker  : BaseObject
	{
		public PlotOptionsAdMarker()
		{
			LineWidth = LineWidth_DefaultValue = 0;
			LineColor = LineColor_DefaultValue = "#ffffff";
			Radius = Radius_DefaultValue = 4;
			States = States_DefaultValue = new PlotOptionsAdMarkerStates();
		...
		/// </summary>
		public PlotOptionsAdMarkerStates States { get; set; }
		private PlotOptionsAdMarkerStates States_DefaultValue { get; set; }
