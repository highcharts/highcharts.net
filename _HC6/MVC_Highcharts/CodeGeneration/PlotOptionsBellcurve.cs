...
namespace Highsoft.Web.Mvc.Charts
{
	public partial class PlotOptionsBellcurve  : BaseObject
	{
		public PlotOptionsBellcurve()
		{
			...
			Zones = Zones_DefaultValue = new PlotOptionsBellcurveZone();
		...
		/// </summary>
		public PlotOptionsBellcurveZone Zones { get; set; }
		private PlotOptionsBellcurveZone Zones_DefaultValue { get; set; }
