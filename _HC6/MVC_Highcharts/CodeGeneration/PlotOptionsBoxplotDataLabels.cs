...
namespace Highsoft.Web.Mvc.Charts
{
	public partial class PlotOptionsBoxplotDataLabels  : BaseObject
	{
		...
		{
			Align = Align_DefaultValue = PlotOptionsBoxplotDataLabelsAlign.Null;
			VerticalAlign = VerticalAlign_DefaultValue = PlotOptionsBoxplotDataLabelsVerticalAlign.Null;
		...
		internal override Hashtable ToHashtable()
		{
			...
			if (Formatter != Formatter_DefaultValue) { h.Add("formatter",Formatter); Highcharts.AddFunction("PlotOptionsBoxplotDataLabelsFormatter.formatter", Formatter); }  
