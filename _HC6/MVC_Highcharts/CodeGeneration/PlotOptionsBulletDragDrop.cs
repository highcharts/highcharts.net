...
{
	public partial class PlotOptionsBulletDragDrop  : BaseObject
	{
		public PlotOptionsBulletDragDrop()
		{
			DraggableTarget = DraggableTarget_DefaultValue = true;
			DraggableX = DraggableX_DefaultValue = null;
			DraggableY = DraggableY_DefaultValue = null;
			DragHandle = DragHandle_DefaultValue = new PlotOptionsBulletDragDropDragHandle();
			...
			GuideBox = GuideBox_DefaultValue = new PlotOptionsBulletDragDropGuideBox();
		...
		/// </summary>
		public bool? DraggableTarget { get; set; }
		private bool? DraggableTarget_DefaultValue { get; set; }
		...
		/// </summary>
		public PlotOptionsBulletDragDropDragHandle DragHandle { get; set; }
		private PlotOptionsBulletDragDropDragHandle DragHandle_DefaultValue { get; set; }
		...
		/// </summary>
		public PlotOptionsBulletDragDropGuideBox GuideBox { get; set; }
		private PlotOptionsBulletDragDropGuideBox GuideBox_DefaultValue { get; set; }
		...
		internal override Hashtable ToHashtable()
		{
			...
			if (DraggableTarget != DraggableTarget_DefaultValue) h.Add("draggableTarget",DraggableTarget);
