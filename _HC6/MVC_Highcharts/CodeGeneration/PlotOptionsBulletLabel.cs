...
{
	public partial class PlotOptionsBulletLabel  : BaseObject
	{
		public PlotOptionsBulletLabel()
		{
			...
			Style = Style_DefaultValue = new PlotOptionsBulletLabelStyle();
		...
		/// </summary>
		public PlotOptionsBulletLabelEnabled Enabled { get; set; }
		private PlotOptionsBulletLabelEnabled Enabled_DefaultValue { get; set; }
		 

		/// <summary>
		/// Allow labels to be placed distant to the graph if necessary,and draw a connector line to the graph.
		/// </summary>
		public PlotOptionsBulletLabelConnectorAllowed ConnectorAllowed { get; set; }
		private PlotOptionsBulletLabelConnectorAllowed ConnectorAllowed_DefaultValue { get; set; }
		 

		/// <summary>
		/// If the label is closer than this to a neighbour graph, draw aconnector.
		/// </summary>
		public PlotOptionsBulletLabelConnectorNeighbourDistance ConnectorNeighbourDistance { get; set; }
		private PlotOptionsBulletLabelConnectorNeighbourDistance ConnectorNeighbourDistance_DefaultValue { get; set; }
		...
		/// </summary>
		public PlotOptionsBulletLabelStyle Style { get; set; }
		private PlotOptionsBulletLabelStyle Style_DefaultValue { get; set; }
