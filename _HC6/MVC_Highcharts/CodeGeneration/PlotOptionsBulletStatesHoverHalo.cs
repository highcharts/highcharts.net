...
{
	public partial class PlotOptionsBulletStatesHoverHalo  : BaseObject
	{
		...
		/// </summary>
		public PlotOptionsBulletStatesHoverHaloAttributes Attributes { get; set; }
		private PlotOptionsBulletStatesHoverHaloAttributes Attributes_DefaultValue { get; set; }
