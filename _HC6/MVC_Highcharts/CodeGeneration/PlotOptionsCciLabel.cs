...
{
	public partial class PlotOptionsCciLabel  : BaseObject
	{
		public PlotOptionsCciLabel()
		{
			...
			Style = Style_DefaultValue = new PlotOptionsCciLabelStyle();
		...
		/// </summary>
		public PlotOptionsCciLabelStyle Style { get; set; }
		private PlotOptionsCciLabelStyle Style_DefaultValue { get; set; }
