...
namespace Highsoft.Web.Mvc.Charts
{
	public partial class PlotOptionsColumnrangeDataLabels  : BaseObject
	{
		...
		{
			Align = Align_DefaultValue = PlotOptionsColumnrangeDataLabelsAlign.Null;
			VerticalAlign = VerticalAlign_DefaultValue = PlotOptionsColumnrangeDataLabelsVerticalAlign.Null;
