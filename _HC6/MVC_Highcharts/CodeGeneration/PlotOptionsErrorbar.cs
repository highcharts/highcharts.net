...
namespace Highsoft.Web.Mvc.Charts
{
	public partial class PlotOptionsErrorbar  : BaseObject
	{
		public PlotOptionsErrorbar()
		{
			...
			PointIntervalUnit = PointIntervalUnit_DefaultValue = PlotOptionsErrorbarPointIntervalUnit.Null;
			...
			Stacking = Stacking_DefaultValue = PlotOptionsErrorbarStacking.Null;
			Visible = Visible_DefaultValue = true;
			ZoneAxis = ZoneAxis_DefaultValue = "y";
			Zones = Zones_DefaultValue = new PlotOptionsErrorbarZone();
		...
		private PlotOptionsErrorbarZone Zones_DefaultValue { get; set; }
