...
namespace Highsoft.Web.Mvc.Charts
{
	public partial class PlotOptionsErrorbarDataLabels  : BaseObject
	{
		...
		{
			Align = Align_DefaultValue = PlotOptionsErrorbarDataLabelsAlign.Null;
			VerticalAlign = VerticalAlign_DefaultValue = PlotOptionsErrorbarDataLabelsVerticalAlign.Null;
