...
namespace Highsoft.Web.Mvc.Charts
{
	public partial class PlotOptionsErrorbarLabel  : BaseObject
	{
		public PlotOptionsErrorbarLabel()
		{
			...
			Style = Style_DefaultValue = new PlotOptionsErrorbarLabelStyle();
		...
		/// </summary>
		public PlotOptionsErrorbarLabelEnabled Enabled { get; set; }
		private PlotOptionsErrorbarLabelEnabled Enabled_DefaultValue { get; set; }
		 

		/// <summary>
		/// Allow labels to be placed distant to the graph if necessary,and draw a connector line to the graph.
		/// </summary>
		public PlotOptionsErrorbarLabelConnectorAllowed ConnectorAllowed { get; set; }
		private PlotOptionsErrorbarLabelConnectorAllowed ConnectorAllowed_DefaultValue { get; set; }
		 

		/// <summary>
		/// If the label is closer than this to a neighbour graph, draw aconnector.
		/// </summary>
		public PlotOptionsErrorbarLabelConnectorNeighbourDistance ConnectorNeighbourDistance { get; set; }
		private PlotOptionsErrorbarLabelConnectorNeighbourDistance ConnectorNeighbourDistance_DefaultValue { get; set; }
		...
		/// </summary>
		public PlotOptionsErrorbarLabelStyle Style { get; set; }
		private PlotOptionsErrorbarLabelStyle Style_DefaultValue { get; set; }
