...
{
	public partial class PlotOptionsFlagsStatesSelectMarker  : BaseObject
	{
		public PlotOptionsFlagsStatesSelectMarker()
		{
			LineWidth = LineWidth_DefaultValue = 0;
			LineColor = LineColor_DefaultValue = "#ffffff";
			Radius = Radius_DefaultValue = 4;
			States = States_DefaultValue = new PlotOptionsFlagsStatesSelectMarkerStates();
		...
		/// </summary>
		public PlotOptionsFlagsStatesSelectMarkerStates States { get; set; }
		private PlotOptionsFlagsStatesSelectMarkerStates States_DefaultValue { get; set; }
