...
{
	public partial class PlotOptionsFunnelDataLabelsFilter  : BaseObject
	{
		public PlotOptionsFunnelDataLabelsFilter()
		{
		...
		/// </summary>
		public PlotOptionsFunnelDataLabelsFilterValue Value { get; set; }
		private PlotOptionsFunnelDataLabelsFilterValue Value_DefaultValue { get; set; }
