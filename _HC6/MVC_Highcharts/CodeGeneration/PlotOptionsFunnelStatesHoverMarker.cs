...
namespace Highsoft.Web.Mvc.Charts
{
	public partial class PlotOptionsFunnelStatesHoverMarker  : BaseObject
	{
		public PlotOptionsFunnelStatesHoverMarker()
		{
			...
			States = States_DefaultValue = new PlotOptionsFunnelStatesHoverMarkerStates();
		...
		/// </summary>
		public PlotOptionsFunnelStatesHoverMarkerStates States { get; set; }
		private PlotOptionsFunnelStatesHoverMarkerStates States_DefaultValue { get; set; }
