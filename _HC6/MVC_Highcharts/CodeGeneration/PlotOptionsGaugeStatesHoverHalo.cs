...
{
	public partial class PlotOptionsGaugeStatesHoverHalo  : BaseObject
	{
		public PlotOptionsGaugeStatesHoverHalo()
		{
		...
		private PlotOptionsGaugeStatesHoverHaloAttributes Attributes_DefaultValue { get; set; }
