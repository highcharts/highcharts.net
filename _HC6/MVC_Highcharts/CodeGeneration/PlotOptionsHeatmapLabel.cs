...
{
	public partial class PlotOptionsHeatmapLabel  : BaseObject
	{
		public PlotOptionsHeatmapLabel()
		{
			...
			Style = Style_DefaultValue = new PlotOptionsHeatmapLabelStyle();
		...
		/// </summary>
		public PlotOptionsHeatmapLabelEnabled Enabled { get; set; }
		private PlotOptionsHeatmapLabelEnabled Enabled_DefaultValue { get; set; }
		 

		/// <summary>
		/// Allow labels to be placed distant to the graph if necessary,and draw a connector line to the graph.
		/// </summary>
		public PlotOptionsHeatmapLabelConnectorAllowed ConnectorAllowed { get; set; }
		private PlotOptionsHeatmapLabelConnectorAllowed ConnectorAllowed_DefaultValue { get; set; }
		 

		/// <summary>
		/// If the label is closer than this to a neighbour graph, draw aconnector.
		/// </summary>
		public PlotOptionsHeatmapLabelConnectorNeighbourDistance ConnectorNeighbourDistance { get; set; }
		private PlotOptionsHeatmapLabelConnectorNeighbourDistance ConnectorNeighbourDistance_DefaultValue { get; set; }
		...
		/// </summary>
		public PlotOptionsHeatmapLabelStyle Style { get; set; }
		private PlotOptionsHeatmapLabelStyle Style_DefaultValue { get; set; }
