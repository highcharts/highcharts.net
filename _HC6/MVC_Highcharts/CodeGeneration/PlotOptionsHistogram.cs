...
namespace Highsoft.Web.Mvc.Charts
{
	public partial class PlotOptionsHistogram  : BaseObject
	{
		...
		/// <summary>
		/// <p>A preferable number of bins. It is a suggestion, so a histogram may havea different number of bins. By default it is set to the square of thebase series&#39; data length. Available options are: <code>square-root</code>,<code>sturges</code>, <code>rice</code>. You can also define a function which takes a<code>baseSeries</code> as a parameter and should return a positive integer.</p>
		/// </summary>
		...
		/// <summary>
		/// <p>Width of each bin. By default the bin&#39;s width is calculated as <code>(max - min) / number of bins</code>.This option takes precedence over <a href="#plotOptions.histogram.binsNumber">binsNumber</a>.</p>
		/// </summary>
		...
		internal override Hashtable ToHashtable()
		{
			...
			if (PointDescriptionFormatter != PointDescriptionFormatter_DefaultValue) { h.Add("pointDescriptionFormatter",PointDescriptionFormatter); Highcharts.AddFunction("PlotOptionsHistogramPointDescriptionFormatter.pointDescriptionFormatter", PointDescriptionFormatter); }  
