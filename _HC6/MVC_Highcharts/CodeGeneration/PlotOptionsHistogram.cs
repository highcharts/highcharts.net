...
namespace Highsoft.Web.Mvc.Charts
{
	public partial class PlotOptionsHistogram  : BaseObject
	{
		public PlotOptionsHistogram()
		{
			...
			Zones = Zones_DefaultValue = new PlotOptionsHistogramZone();
		...
		/// </summary>
		public PlotOptionsHistogramZone Zones { get; set; }
		private PlotOptionsHistogramZone Zones_DefaultValue { get; set; }
