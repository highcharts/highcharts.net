...
namespace Highsoft.Web.Mvc.Charts
{
	public partial class PlotOptionsHistogramDataLabels  : BaseObject
	{
		...
		{
			Align = Align_DefaultValue = PlotOptionsHistogramDataLabelsAlign.Null;
			VerticalAlign = VerticalAlign_DefaultValue = PlotOptionsHistogramDataLabelsVerticalAlign.Null;
