...
{
	public partial class PlotOptionsHistogramDragDrop  : BaseObject
	{
		public PlotOptionsHistogramDragDrop()
		{
			DraggableX = DraggableX_DefaultValue = null;
			DraggableY = DraggableY_DefaultValue = null;
			DragHandle = DragHandle_DefaultValue = new PlotOptionsHistogramDragDropDragHandle();
			...
			GuideBox = GuideBox_DefaultValue = new PlotOptionsHistogramDragDropGuideBox();
		...
		/// </summary>
		public PlotOptionsHistogramDragDropDragHandle DragHandle { get; set; }
		private PlotOptionsHistogramDragDropDragHandle DragHandle_DefaultValue { get; set; }
		...
		/// </summary>
		public PlotOptionsHistogramDragDropGuideBox GuideBox { get; set; }
		private PlotOptionsHistogramDragDropGuideBox GuideBox_DefaultValue { get; set; }
