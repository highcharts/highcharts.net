...
{
	public partial class PlotOptionsHistogramLabel  : BaseObject
	{
		public PlotOptionsHistogramLabel()
		{
			...
			Style = Style_DefaultValue = new PlotOptionsHistogramLabelStyle();
		...
		/// </summary>
		public PlotOptionsHistogramLabelEnabled Enabled { get; set; }
		private PlotOptionsHistogramLabelEnabled Enabled_DefaultValue { get; set; }
		 

		/// <summary>
		/// Allow labels to be placed distant to the graph if necessary,and draw a connector line to the graph.
		/// </summary>
		public PlotOptionsHistogramLabelConnectorAllowed ConnectorAllowed { get; set; }
		private PlotOptionsHistogramLabelConnectorAllowed ConnectorAllowed_DefaultValue { get; set; }
		 

		/// <summary>
		/// If the label is closer than this to a neighbour graph, draw aconnector.
		/// </summary>
		public PlotOptionsHistogramLabelConnectorNeighbourDistance ConnectorNeighbourDistance { get; set; }
		private PlotOptionsHistogramLabelConnectorNeighbourDistance ConnectorNeighbourDistance_DefaultValue { get; set; }
		...
		/// </summary>
		public PlotOptionsHistogramLabelStyle Style { get; set; }
		private PlotOptionsHistogramLabelStyle Style_DefaultValue { get; set; }
