...
{
	public partial class PlotOptionsIkhStatesHoverMarker  : BaseObject
	{
		public PlotOptionsIkhStatesHoverMarker()
		{
			LineWidth = LineWidth_DefaultValue = 0;
			LineColor = LineColor_DefaultValue = "#ffffff";
			Radius = Radius_DefaultValue = 4;
			States = States_DefaultValue = new PlotOptionsIkhStatesHoverMarkerStates();
		...
		/// </summary>
		public PlotOptionsIkhStatesHoverMarkerStates States { get; set; }
		private PlotOptionsIkhStatesHoverMarkerStates States_DefaultValue { get; set; }
