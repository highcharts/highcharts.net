...
{
	public partial class PlotOptionsMacdMarker  : BaseObject
	{
		public PlotOptionsMacdMarker()
		{
			LineWidth = LineWidth_DefaultValue = 0;
			LineColor = LineColor_DefaultValue = "#ffffff";
			Radius = Radius_DefaultValue = 4;
			States = States_DefaultValue = new PlotOptionsMacdMarkerStates();
		...
		/// </summary>
		public PlotOptionsMacdMarkerStates States { get; set; }
		private PlotOptionsMacdMarkerStates States_DefaultValue { get; set; }
