...
{
	public partial class PlotOptionsMacdStatesHoverMarker  : BaseObject
	{
		public PlotOptionsMacdStatesHoverMarker()
		{
			LineWidth = LineWidth_DefaultValue = 0;
			LineColor = LineColor_DefaultValue = "#ffffff";
			Radius = Radius_DefaultValue = 4;
			States = States_DefaultValue = new PlotOptionsMacdStatesHoverMarkerStates();
		...
		/// </summary>
		public PlotOptionsMacdStatesHoverMarkerStates States { get; set; }
		private PlotOptionsMacdStatesHoverMarkerStates States_DefaultValue { get; set; }
