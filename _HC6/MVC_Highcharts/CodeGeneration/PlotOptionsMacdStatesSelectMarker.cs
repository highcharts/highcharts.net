...
{
	public partial class PlotOptionsMacdStatesSelectMarker  : BaseObject
	{
		public PlotOptionsMacdStatesSelectMarker()
		{
			LineWidth = LineWidth_DefaultValue = 0;
			LineColor = LineColor_DefaultValue = "#ffffff";
			Radius = Radius_DefaultValue = 4;
			States = States_DefaultValue = new PlotOptionsMacdStatesSelectMarkerStates();
		...
		/// </summary>
		public PlotOptionsMacdStatesSelectMarkerStates States { get; set; }
		private PlotOptionsMacdStatesSelectMarkerStates States_DefaultValue { get; set; }
