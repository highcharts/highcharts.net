...
{
	public partial class PlotOptionsMapStatesHoverMarker  : BaseObject
	{
		public PlotOptionsMapStatesHoverMarker()
		{
			LineWidth = LineWidth_DefaultValue = 0;
			LineColor = LineColor_DefaultValue = "#ffffff";
			Radius = Radius_DefaultValue = 4;
			States = States_DefaultValue = new PlotOptionsMapStatesHoverMarkerStates();
		...
		/// </summary>
		public PlotOptionsMapStatesHoverMarkerStates States { get; set; }
		private PlotOptionsMapStatesHoverMarkerStates States_DefaultValue { get; set; }
