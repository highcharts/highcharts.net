...
namespace Highsoft.Web.Mvc.Charts
{
	public partial class PlotOptionsMapTooltip  : BaseObject
	{
		...
		internal override Hashtable ToHashtable()
		{
			...
			if (PointFormatter != PointFormatter_DefaultValue) { h.Add("pointFormatter",PointFormatter); Highcharts.AddFunction("PlotOptionsMapTooltipPointFormatter.pointFormatter", PointFormatter); }  
