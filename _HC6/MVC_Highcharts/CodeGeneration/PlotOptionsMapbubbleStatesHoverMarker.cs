...
{
	public partial class PlotOptionsMapbubbleStatesHoverMarker  : BaseObject
	{
		public PlotOptionsMapbubbleStatesHoverMarker()
		{
			LineWidth = LineWidth_DefaultValue = 0;
			LineColor = LineColor_DefaultValue = "#ffffff";
			Radius = Radius_DefaultValue = 4;
			States = States_DefaultValue = new PlotOptionsMapbubbleStatesHoverMarkerStates();
		...
		/// </summary>
		public PlotOptionsMapbubbleStatesHoverMarkerStates States { get; set; }
		private PlotOptionsMapbubbleStatesHoverMarkerStates States_DefaultValue { get; set; }
