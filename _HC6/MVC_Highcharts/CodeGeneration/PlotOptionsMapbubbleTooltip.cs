...
namespace Highsoft.Web.Mvc.Charts
{
	public partial class PlotOptionsMapbubbleTooltip  : BaseObject
	{
		...
		internal override Hashtable ToHashtable()
		{
			...
			if (PointFormatter != PointFormatter_DefaultValue) { h.Add("pointFormatter",PointFormatter); Highcharts.AddFunction("PlotOptionsMapbubbleTooltipPointFormatter.pointFormatter", PointFormatter); }  
