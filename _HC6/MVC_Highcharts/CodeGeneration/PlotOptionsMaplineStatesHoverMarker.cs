...
{
	public partial class PlotOptionsMaplineStatesHoverMarker  : BaseObject
	{
		public PlotOptionsMaplineStatesHoverMarker()
		{
			LineWidth = LineWidth_DefaultValue = 0;
			LineColor = LineColor_DefaultValue = "#ffffff";
			Radius = Radius_DefaultValue = 4;
			States = States_DefaultValue = new PlotOptionsMaplineStatesHoverMarkerStates();
		...
		/// </summary>
		public PlotOptionsMaplineStatesHoverMarkerStates States { get; set; }
		private PlotOptionsMaplineStatesHoverMarkerStates States_DefaultValue { get; set; }
