...
namespace Highsoft.Web.Mvc.Charts
{
	public partial class PlotOptionsMaplineTooltip  : BaseObject
	{
		...
		internal override Hashtable ToHashtable()
		{
			...
			if (PointFormatter != PointFormatter_DefaultValue) { h.Add("pointFormatter",PointFormatter); Highcharts.AddFunction("PlotOptionsMaplineTooltipPointFormatter.pointFormatter", PointFormatter); }  
