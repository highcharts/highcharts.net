...
{
	public partial class PlotOptionsMappointMarker  : BaseObject
	{
		public PlotOptionsMappointMarker()
		{
			Enabled = Enabled_DefaultValue = null;
			LineWidth = LineWidth_DefaultValue = 0;
			LineColor = LineColor_DefaultValue = "#ffffff";
			Radius = Radius_DefaultValue = 4;
			States = States_DefaultValue = new PlotOptionsMappointMarkerStates();
		...
		/// </summary>
		public PlotOptionsMappointMarkerStates States { get; set; }
		private PlotOptionsMappointMarkerStates States_DefaultValue { get; set; }
