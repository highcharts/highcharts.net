...
{
	public partial class PlotOptionsMappointStatesHoverMarker  : BaseObject
	{
		public PlotOptionsMappointStatesHoverMarker()
		{
			LineWidth = LineWidth_DefaultValue = 0;
			LineColor = LineColor_DefaultValue = "#ffffff";
			Radius = Radius_DefaultValue = 4;
			States = States_DefaultValue = new PlotOptionsMappointStatesHoverMarkerStates();
		...
		/// </summary>
		public PlotOptionsMappointStatesHoverMarkerStates States { get; set; }
		private PlotOptionsMappointStatesHoverMarkerStates States_DefaultValue { get; set; }
