...
namespace Highsoft.Web.Mvc.Charts
{
	public partial class PlotOptionsMappointTooltip  : BaseObject
	{
		...
		internal override Hashtable ToHashtable()
		{
			...
			if (PointFormatter != PointFormatter_DefaultValue) { h.Add("pointFormatter",PointFormatter); Highcharts.AddFunction("PlotOptionsMappointTooltipPointFormatter.pointFormatter", PointFormatter); }  
