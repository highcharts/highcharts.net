...
{
	public partial class PlotOptionsMomentumLabel  : BaseObject
	{
		public PlotOptionsMomentumLabel()
		{
			...
			Style = Style_DefaultValue = new PlotOptionsMomentumLabelStyle();
		...
		/// </summary>
		public PlotOptionsMomentumLabelStyle Style { get; set; }
		private PlotOptionsMomentumLabelStyle Style_DefaultValue { get; set; }
