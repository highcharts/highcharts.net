...
{
	public partial class PlotOptionsOhlcLabel  : BaseObject
	{
		public PlotOptionsOhlcLabel()
		{
			...
			Style = Style_DefaultValue = new PlotOptionsOhlcLabelStyle();
		...
		/// </summary>
		public PlotOptionsOhlcLabelStyle Style { get; set; }
		private PlotOptionsOhlcLabelStyle Style_DefaultValue { get; set; }
