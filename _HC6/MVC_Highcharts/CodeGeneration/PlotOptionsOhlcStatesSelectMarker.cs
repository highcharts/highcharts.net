...
{
	public partial class PlotOptionsOhlcStatesSelectMarker  : BaseObject
	{
		public PlotOptionsOhlcStatesSelectMarker()
		{
			LineWidth = LineWidth_DefaultValue = 0;
			LineColor = LineColor_DefaultValue = "#ffffff";
			Radius = Radius_DefaultValue = 4;
			States = States_DefaultValue = new PlotOptionsOhlcStatesSelectMarkerStates();
		...
		/// </summary>
		public PlotOptionsOhlcStatesSelectMarkerStates States { get; set; }
		private PlotOptionsOhlcStatesSelectMarkerStates States_DefaultValue { get; set; }
