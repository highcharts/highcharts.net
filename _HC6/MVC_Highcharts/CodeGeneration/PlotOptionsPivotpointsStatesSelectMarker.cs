...
{
	public partial class PlotOptionsPivotpointsStatesSelectMarker  : BaseObject
	{
		public PlotOptionsPivotpointsStatesSelectMarker()
		{
			LineWidth = LineWidth_DefaultValue = 0;
			LineColor = LineColor_DefaultValue = "#ffffff";
			Radius = Radius_DefaultValue = 4;
			States = States_DefaultValue = new PlotOptionsPivotpointsStatesSelectMarkerStates();
		...
		/// </summary>
		public PlotOptionsPivotpointsStatesSelectMarkerStates States { get; set; }
		private PlotOptionsPivotpointsStatesSelectMarkerStates States_DefaultValue { get; set; }
