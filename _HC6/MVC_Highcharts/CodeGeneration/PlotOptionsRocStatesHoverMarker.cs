...
{
	public partial class PlotOptionsRocStatesHoverMarker  : BaseObject
	{
		public PlotOptionsRocStatesHoverMarker()
		{
			LineWidth = LineWidth_DefaultValue = 0;
			LineColor = LineColor_DefaultValue = "#ffffff";
			Radius = Radius_DefaultValue = 4;
			States = States_DefaultValue = new PlotOptionsRocStatesHoverMarkerStates();
		...
		/// </summary>
		public PlotOptionsRocStatesHoverMarkerStates States { get; set; }
		private PlotOptionsRocStatesHoverMarkerStates States_DefaultValue { get; set; }
