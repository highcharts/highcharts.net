...
{
	public partial class PlotOptionsSankeyLabel  : BaseObject
	{
		public PlotOptionsSankeyLabel()
		{
			...
			Style = Style_DefaultValue = new PlotOptionsSankeyLabelStyle();
		...
		/// </summary>
		public PlotOptionsSankeyLabelEnabled Enabled { get; set; }
		private PlotOptionsSankeyLabelEnabled Enabled_DefaultValue { get; set; }
		 

		/// <summary>
		/// Allow labels to be placed distant to the graph if necessary,and draw a connector line to the graph.
		/// </summary>
		public PlotOptionsSankeyLabelConnectorAllowed ConnectorAllowed { get; set; }
		private PlotOptionsSankeyLabelConnectorAllowed ConnectorAllowed_DefaultValue { get; set; }
		 

		/// <summary>
		/// If the label is closer than this to a neighbour graph, draw aconnector.
		/// </summary>
		public PlotOptionsSankeyLabelConnectorNeighbourDistance ConnectorNeighbourDistance { get; set; }
		private PlotOptionsSankeyLabelConnectorNeighbourDistance ConnectorNeighbourDistance_DefaultValue { get; set; }
		...
		/// </summary>
		public PlotOptionsSankeyLabelStyle Style { get; set; }
		private PlotOptionsSankeyLabelStyle Style_DefaultValue { get; set; }
