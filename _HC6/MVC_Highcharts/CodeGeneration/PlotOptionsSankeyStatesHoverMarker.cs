...
{
	public partial class PlotOptionsSankeyStatesHoverMarker  : BaseObject
	{
		public PlotOptionsSankeyStatesHoverMarker()
		{
			LineWidth = LineWidth_DefaultValue = 0;
			LineColor = LineColor_DefaultValue = "#ffffff";
			Radius = Radius_DefaultValue = 4;
			States = States_DefaultValue = new PlotOptionsSankeyStatesHoverMarkerStates();
		...
		/// </summary>
		public PlotOptionsSankeyStatesHoverMarkerStates States { get; set; }
		private PlotOptionsSankeyStatesHoverMarkerStates States_DefaultValue { get; set; }
