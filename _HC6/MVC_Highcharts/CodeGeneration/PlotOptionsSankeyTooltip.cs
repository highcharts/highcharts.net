...
namespace Highsoft.Web.Mvc.Charts
{
	public partial class PlotOptionsSankeyTooltip  : BaseObject
	{
		...
		/// <summary>
		/// <p>The <a href="http://www.highcharts.com/docs/chart-concepts/labels-and-string-formatting">format string</a> specifying what to show for <em>nodes</em> in tooltipof a sankey diagram series.</p>
		/// </summary>
		...
		internal override Hashtable ToHashtable()
		{
			...
			if (PointFormatter != PointFormatter_DefaultValue) { h.Add("pointFormatter",PointFormatter); Highcharts.AddFunction("PlotOptionsSankeyTooltipPointFormatter.pointFormatter", PointFormatter); }  
