...
namespace Highsoft.Web.Mvc.Charts
{
	public partial class PlotOptionsScatter3d  : BaseObject
	{
		public PlotOptionsScatter3d()
		{
			...
			FindNearestPointBy = FindNearestPointBy_DefaultValue = PlotOptionsScatter3dFindNearestPointBy.Xy;
			...
			Zones = Zones_DefaultValue = new PlotOptionsScatter3dZone();
		...
		/// </summary>
		public PlotOptionsScatter3dZone Zones { get; set; }
		private PlotOptionsScatter3dZone Zones_DefaultValue { get; set; }
