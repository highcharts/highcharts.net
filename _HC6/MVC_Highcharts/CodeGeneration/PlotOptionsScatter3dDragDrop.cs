...
{
	public partial class PlotOptionsScatter3dDragDrop  : BaseObject
	{
		public PlotOptionsScatter3dDragDrop()
		{
			DraggableX = DraggableX_DefaultValue = null;
			DraggableY = DraggableY_DefaultValue = null;
			DragHandle = DragHandle_DefaultValue = new PlotOptionsScatter3dDragDropDragHandle();
			...
			GuideBox = GuideBox_DefaultValue = new PlotOptionsScatter3dDragDropGuideBox();
		...
		/// </summary>
		public PlotOptionsScatter3dDragDropDragHandle DragHandle { get; set; }
		private PlotOptionsScatter3dDragDropDragHandle DragHandle_DefaultValue { get; set; }
		...
		/// </summary>
		public PlotOptionsScatter3dDragDropGuideBox GuideBox { get; set; }
		private PlotOptionsScatter3dDragDropGuideBox GuideBox_DefaultValue { get; set; }
