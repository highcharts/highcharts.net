...
namespace Highsoft.Web.Mvc.Charts
{
	public partial class PlotOptionsScatter3dTooltip  : BaseObject
	{
		...
		internal override Hashtable ToHashtable()
		{
			...
			if (PointFormatter != PointFormatter_DefaultValue) { h.Add("pointFormatter",PointFormatter); Highcharts.AddFunction("PlotOptionsScatter3dTooltipPointFormatter.pointFormatter", PointFormatter); }  
