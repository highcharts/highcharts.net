...
namespace Highsoft.Web.Mvc.Charts
{
	...
	{
		public PlotOptionsScatterLabel()
		{
			...
			Style = Style_DefaultValue = new PlotOptionsScatterLabelStyle();
		...
		/// </summary>
		public PlotOptionsScatterLabelEnabled Enabled { get; set; }
		private PlotOptionsScatterLabelEnabled Enabled_DefaultValue { get; set; }
		 

		/// <summary>
		/// Allow labels to be placed distant to the graph if necessary,and draw a connector line to the graph.
		/// </summary>
		public PlotOptionsScatterLabelConnectorAllowed ConnectorAllowed { get; set; }
		private PlotOptionsScatterLabelConnectorAllowed ConnectorAllowed_DefaultValue { get; set; }
		 

		/// <summary>
		/// If the label is closer than this to a neighbour graph, draw aconnector.
		/// </summary>
		public PlotOptionsScatterLabelConnectorNeighbourDistance ConnectorNeighbourDistance { get; set; }
		private PlotOptionsScatterLabelConnectorNeighbourDistance ConnectorNeighbourDistance_DefaultValue { get; set; }
		...
		/// </summary>
		public PlotOptionsScatterLabelStyle Style { get; set; }
		private PlotOptionsScatterLabelStyle Style_DefaultValue { get; set; }
