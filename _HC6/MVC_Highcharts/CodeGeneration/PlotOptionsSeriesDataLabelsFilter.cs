...
{
	public partial class PlotOptionsSeriesDataLabelsFilter  : BaseObject
	{
		...
		/// </summary>
		public PlotOptionsSeriesDataLabelsFilterValue Value { get; set; }
		private PlotOptionsSeriesDataLabelsFilterValue Value_DefaultValue { get; set; }
