...
{
	public partial class PlotOptionsSolidgaugeLabel  : BaseObject
	{
		public PlotOptionsSolidgaugeLabel()
		{
			...
			Style = Style_DefaultValue = new PlotOptionsSolidgaugeLabelStyle();
		...
		/// </summary>
		public PlotOptionsSolidgaugeLabelEnabled Enabled { get; set; }
		private PlotOptionsSolidgaugeLabelEnabled Enabled_DefaultValue { get; set; }
		 

		/// <summary>
		/// Allow labels to be placed distant to the graph if necessary,and draw a connector line to the graph.
		/// </summary>
		public PlotOptionsSolidgaugeLabelConnectorAllowed ConnectorAllowed { get; set; }
		private PlotOptionsSolidgaugeLabelConnectorAllowed ConnectorAllowed_DefaultValue { get; set; }
		 

		/// <summary>
		/// If the label is closer than this to a neighbour graph, draw aconnector.
		/// </summary>
		public PlotOptionsSolidgaugeLabelConnectorNeighbourDistance ConnectorNeighbourDistance { get; set; }
		private PlotOptionsSolidgaugeLabelConnectorNeighbourDistance ConnectorNeighbourDistance_DefaultValue { get; set; }
		...
		/// </summary>
		public PlotOptionsSolidgaugeLabelStyle Style { get; set; }
		private PlotOptionsSolidgaugeLabelStyle Style_DefaultValue { get; set; }
