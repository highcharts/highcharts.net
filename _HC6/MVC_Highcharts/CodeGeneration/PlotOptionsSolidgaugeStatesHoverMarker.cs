...
namespace Highsoft.Web.Mvc.Charts
{
	public partial class PlotOptionsSolidgaugeStatesHoverMarker  : BaseObject
	{
		public PlotOptionsSolidgaugeStatesHoverMarker()
		{
			...
			States = States_DefaultValue = new PlotOptionsSolidgaugeStatesHoverMarkerStates();
		...
		/// </summary>
		public PlotOptionsSolidgaugeStatesHoverMarkerStates States { get; set; }
		private PlotOptionsSolidgaugeStatesHoverMarkerStates States_DefaultValue { get; set; }
