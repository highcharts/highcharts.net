...
namespace Highsoft.Web.Mvc.Charts
{
	public partial class PlotOptionsTilemap  : BaseObject
	{
		public PlotOptionsTilemap()
		{
			...
			FindNearestPointBy = FindNearestPointBy_DefaultValue = PlotOptionsTilemapFindNearestPointBy.Xy;
			...
			Zones = Zones_DefaultValue = new PlotOptionsTilemapZone();
		...
		/// </summary>
		public PlotOptionsTilemapZone Zones { get; set; }
		private PlotOptionsTilemapZone Zones_DefaultValue { get; set; }
