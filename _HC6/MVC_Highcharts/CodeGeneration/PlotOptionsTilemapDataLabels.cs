...
namespace Highsoft.Web.Mvc.Charts
{
	public partial class PlotOptionsTilemapDataLabels  : BaseObject
	{
		public PlotOptionsTilemapDataLabels()
		{
			...
			VerticalAlign = VerticalAlign_DefaultValue = PlotOptionsTilemapDataLabelsVerticalAlign.Middle;
			Crop = Crop_DefaultValue = null;
			Overflow = Overflow_DefaultValue = PlotOptionsTilemapDataLabelsOverflow.Null;
