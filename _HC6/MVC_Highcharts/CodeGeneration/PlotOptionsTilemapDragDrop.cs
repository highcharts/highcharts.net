...
{
	public partial class PlotOptionsTilemapDragDrop  : BaseObject
	{
		public PlotOptionsTilemapDragDrop()
		{
			DraggableX = DraggableX_DefaultValue = null;
			DraggableY = DraggableY_DefaultValue = null;
			DragHandle = DragHandle_DefaultValue = new PlotOptionsTilemapDragDropDragHandle();
			...
			GuideBox = GuideBox_DefaultValue = new PlotOptionsTilemapDragDropGuideBox();
		...
		/// </summary>
		public PlotOptionsTilemapDragDropDragHandle DragHandle { get; set; }
		private PlotOptionsTilemapDragDropDragHandle DragHandle_DefaultValue { get; set; }
		...
		/// </summary>
		public PlotOptionsTilemapDragDropGuideBox GuideBox { get; set; }
		private PlotOptionsTilemapDragDropGuideBox GuideBox_DefaultValue { get; set; }
