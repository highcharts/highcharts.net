...
namespace Highsoft.Web.Mvc.Charts
{
	public partial class PlotOptionsTilemapStatesHover  : BaseObject
	{
		public PlotOptionsTilemapStatesHover()
		{
			...
			Marker = Marker_DefaultValue = new PlotOptionsTilemapStatesHoverMarker();
		...
		/// </summary>
		public PlotOptionsTilemapStatesHoverMarker Marker { get; set; }
		private PlotOptionsTilemapStatesHoverMarker Marker_DefaultValue { get; set; }
