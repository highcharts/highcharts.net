...
namespace Highsoft.Web.Mvc.Charts
{
	public partial class PlotOptionsTreemap  : BaseObject
	{
		public PlotOptionsTreemap()
		{
			...
			FindNearestPointBy = FindNearestPointBy_DefaultValue = PlotOptionsTreemapFindNearestPointBy.Xy;
			...
			Zones = Zones_DefaultValue = new PlotOptionsTreemapZone();
		...
		private PlotOptionsTreemapZone Zones_DefaultValue { get; set; }
