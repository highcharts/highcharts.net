...
{
	public partial class PlotOptionsTreemapDrillUpButtonPosition  : BaseObject
	{
		...
		/// </summary>
		public PlotOptionsTreemapDrillUpButtonPositionY Y { get; set; }
		private PlotOptionsTreemapDrillUpButtonPositionY Y_DefaultValue { get; set; }
