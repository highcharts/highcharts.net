...
namespace Highsoft.Web.Mvc.Charts
{
	public partial class PlotOptionsTreemapStatesHoverMarker  : BaseObject
	{
		public PlotOptionsTreemapStatesHoverMarker()
		{
			...
			States = States_DefaultValue = new PlotOptionsTreemapStatesHoverMarkerStates();
		...
		/// </summary>
		public PlotOptionsTreemapStatesHoverMarkerStates States { get; set; }
		private PlotOptionsTreemapStatesHoverMarkerStates States_DefaultValue { get; set; }
