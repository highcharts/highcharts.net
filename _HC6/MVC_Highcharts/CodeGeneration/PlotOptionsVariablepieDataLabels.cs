...
namespace Highsoft.Web.Mvc.Charts
{
	public partial class PlotOptionsVariablepieDataLabels  : BaseObject
	{
		public PlotOptionsVariablepieDataLabels()
		{
			...
			Style = Style_DefaultValue = new PlotOptionsVariablepieDataLabelsStyle();
		...
		/// </summary>
		public PlotOptionsVariablepieDataLabelsStyle Style { get; set; }
		private PlotOptionsVariablepieDataLabelsStyle Style_DefaultValue { get; set; }
		...
		internal override Hashtable ToHashtable()
		{
			...
			if (Formatter != Formatter_DefaultValue) { h.Add("formatter",Formatter); Highcharts.AddFunction("PlotOptionsVariablepieDataLabelsFormatter.formatter", Formatter); }  
