...
namespace Highsoft.Web.Mvc.Charts
{
	public partial class PlotOptionsVariwide  : BaseObject
	{
		public PlotOptionsVariwide()
		{
			...
			Zones = Zones_DefaultValue = new PlotOptionsVariwideZone();
			
		}	
		

		/// <summary>
		/// <p>In a variwide chart, the point padding is 0 in order to express the horizontal stacking of items.</p>
		/// </summary>
		...
		/// <summary>
		/// <p>In a variwide chart, the group padding is 0 in order to express the horizontal stacking of items.</p>
		/// </summary>
		...
		/// </summary>
		public PlotOptionsVariwideZone Zones { get; set; }
		private PlotOptionsVariwideZone Zones_DefaultValue { get; set; }
