...
namespace Highsoft.Web.Mvc.Charts
{
	public partial class PlotOptionsVariwideDataLabels  : BaseObject
	{
		...
		{
			Align = Align_DefaultValue = PlotOptionsVariwideDataLabelsAlign.Null;
			VerticalAlign = VerticalAlign_DefaultValue = PlotOptionsVariwideDataLabelsVerticalAlign.Null;
