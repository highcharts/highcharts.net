...
{
	public partial class PlotOptionsVbpMarker  : BaseObject
	{
		public PlotOptionsVbpMarker()
		{
			LineWidth = LineWidth_DefaultValue = 0;
			LineColor = LineColor_DefaultValue = "#ffffff";
			Radius = Radius_DefaultValue = 4;
			States = States_DefaultValue = new PlotOptionsVbpMarkerStates();
		...
		/// </summary>
		public PlotOptionsVbpMarkerStates States { get; set; }
		private PlotOptionsVbpMarkerStates States_DefaultValue { get; set; }
