...
{
	public partial class PlotOptionsVbpStatesHoverMarker  : BaseObject
	{
		public PlotOptionsVbpStatesHoverMarker()
		{
			LineWidth = LineWidth_DefaultValue = 0;
			LineColor = LineColor_DefaultValue = "#ffffff";
			Radius = Radius_DefaultValue = 4;
			States = States_DefaultValue = new PlotOptionsVbpStatesHoverMarkerStates();
		...
		/// </summary>
		public PlotOptionsVbpStatesHoverMarkerStates States { get; set; }
		private PlotOptionsVbpStatesHoverMarkerStates States_DefaultValue { get; set; }
