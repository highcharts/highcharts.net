...
{
	public partial class PlotOptionsVectorLabel  : BaseObject
	{
		public PlotOptionsVectorLabel()
		{
			...
			Style = Style_DefaultValue = new PlotOptionsVectorLabelStyle();
		...
		/// </summary>
		public PlotOptionsVectorLabelEnabled Enabled { get; set; }
		private PlotOptionsVectorLabelEnabled Enabled_DefaultValue { get; set; }
		 

		/// <summary>
		/// Allow labels to be placed distant to the graph if necessary,and draw a connector line to the graph.
		/// </summary>
		public PlotOptionsVectorLabelConnectorAllowed ConnectorAllowed { get; set; }
		private PlotOptionsVectorLabelConnectorAllowed ConnectorAllowed_DefaultValue { get; set; }
		 

		/// <summary>
		/// If the label is closer than this to a neighbour graph, draw aconnector.
		/// </summary>
		public PlotOptionsVectorLabelConnectorNeighbourDistance ConnectorNeighbourDistance { get; set; }
		private PlotOptionsVectorLabelConnectorNeighbourDistance ConnectorNeighbourDistance_DefaultValue { get; set; }
		...
		/// </summary>
		public PlotOptionsVectorLabelStyle Style { get; set; }
		private PlotOptionsVectorLabelStyle Style_DefaultValue { get; set; }
