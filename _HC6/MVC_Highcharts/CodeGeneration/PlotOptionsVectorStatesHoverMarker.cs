...
{
	public partial class PlotOptionsVectorStatesHoverMarker  : BaseObject
	{
		public PlotOptionsVectorStatesHoverMarker()
		{
			LineWidth = LineWidth_DefaultValue = 0;
			LineColor = LineColor_DefaultValue = "#ffffff";
			Radius = Radius_DefaultValue = 4;
			States = States_DefaultValue = new PlotOptionsVectorStatesHoverMarkerStates();
		...
		/// </summary>
		public PlotOptionsVectorStatesHoverMarkerStates States { get; set; }
		private PlotOptionsVectorStatesHoverMarkerStates States_DefaultValue { get; set; }
