...
namespace Highsoft.Web.Mvc.Charts
{
	public partial class PlotOptionsVectorTooltip  : BaseObject
	{
		...
		internal override Hashtable ToHashtable()
		{
			...
			if (PointFormatter != PointFormatter_DefaultValue) { h.Add("pointFormatter",PointFormatter); Highcharts.AddFunction("PlotOptionsVectorTooltipPointFormatter.pointFormatter", PointFormatter); }  
