...
namespace Highsoft.Web.Mvc.Charts
{
	public partial class PlotOptionsWaterfallDataLabels  : BaseObject
	{
		public PlotOptionsWaterfallDataLabels()
		{
			...
			Align = Align_DefaultValue = PlotOptionsWaterfallDataLabelsAlign.Null;
			VerticalAlign = VerticalAlign_DefaultValue = PlotOptionsWaterfallDataLabelsVerticalAlign.Null;
