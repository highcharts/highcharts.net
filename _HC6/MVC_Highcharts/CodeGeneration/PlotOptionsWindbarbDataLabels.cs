...
namespace Highsoft.Web.Mvc.Charts
{
	public partial class PlotOptionsWindbarbDataLabels  : BaseObject
	{
		...
		{
			Align = Align_DefaultValue = PlotOptionsWindbarbDataLabelsAlign.Null;
			VerticalAlign = VerticalAlign_DefaultValue = PlotOptionsWindbarbDataLabelsVerticalAlign.Null;
