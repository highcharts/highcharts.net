...
namespace Highsoft.Web.Mvc.Charts
{
	public partial class PlotOptionsWindbarbStatesHover  : BaseObject
	{
		public PlotOptionsWindbarbStatesHover()
		{
			...
			Marker = Marker_DefaultValue = new PlotOptionsWindbarbStatesHoverMarker();
			Halo = Halo_DefaultValue = new PlotOptionsWindbarbStatesHoverHalo();
		...
		/// </summary>
		public PlotOptionsWindbarbStatesHoverMarker Marker { get; set; }
		private PlotOptionsWindbarbStatesHoverMarker Marker_DefaultValue { get; set; }
		...
		/// </summary>
		public PlotOptionsWindbarbStatesHoverHalo Halo { get; set; }
		private PlotOptionsWindbarbStatesHoverHalo Halo_DefaultValue { get; set; }
