...
namespace Highsoft.Web.Mvc.Charts
{
	public partial class PlotOptionsWindbarbTooltip  : BaseObject
	{
		...
		internal override Hashtable ToHashtable()
		{
			...
			if (PointFormatter != PointFormatter_DefaultValue) { h.Add("pointFormatter",PointFormatter); Highcharts.AddFunction("PlotOptionsWindbarbTooltipPointFormatter.pointFormatter", PointFormatter); }  
