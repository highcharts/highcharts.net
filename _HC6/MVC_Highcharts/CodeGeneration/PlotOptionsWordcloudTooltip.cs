...
namespace Highsoft.Web.Mvc.Charts
{
	public partial class PlotOptionsWordcloudTooltip  : BaseObject
	{
		...
		internal override Hashtable ToHashtable()
		{
			...
			if (PointFormatter != PointFormatter_DefaultValue) { h.Add("pointFormatter",PointFormatter); Highcharts.AddFunction("PlotOptionsWordcloudTooltipPointFormatter.pointFormatter", PointFormatter); }  
