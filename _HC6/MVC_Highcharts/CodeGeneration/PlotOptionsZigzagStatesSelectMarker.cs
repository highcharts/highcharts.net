...
{
	public partial class PlotOptionsZigzagStatesSelectMarker  : BaseObject
	{
		public PlotOptionsZigzagStatesSelectMarker()
		{
			LineWidth = LineWidth_DefaultValue = 0;
			LineColor = LineColor_DefaultValue = "#ffffff";
			Radius = Radius_DefaultValue = 4;
			States = States_DefaultValue = new PlotOptionsZigzagStatesSelectMarkerStates();
		...
		/// </summary>
		public PlotOptionsZigzagStatesSelectMarkerStates States { get; set; }
		private PlotOptionsZigzagStatesSelectMarkerStates States_DefaultValue { get; set; }
