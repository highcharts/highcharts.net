...
namespace Highsoft.Web.Mvc.Charts
{
	public partial class PolygonSeries  : Series
	{
		public PolygonSeries()
		{
			...
			TrackByArea = TrackByArea_DefaultValue = null;
			LineWidth = LineWidth_DefaultValue = 0;
			FindNearestPointBy = FindNearestPointBy_DefaultValue = PolygonSeriesFindNearestPointBy.Xy;
			...
			Zones = Zones_DefaultValue = new PolygonSeriesZone();
		...
		/// </summary>
		public PolygonSeriesZone Zones { get; set; }
		private PolygonSeriesZone Zones_DefaultValue { get; set; }
		...
		internal override Hashtable ToHashtable()
		{
			...
			if (PointDescriptionFormatter != PointDescriptionFormatter_DefaultValue) { h.Add("pointDescriptionFormatter",PointDescriptionFormatter); Highcharts.AddFunction("PolygonSeriesPointDescriptionFormatter.pointDescriptionFormatter", PointDescriptionFormatter); }  
