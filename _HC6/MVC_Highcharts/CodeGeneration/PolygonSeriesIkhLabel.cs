...
{
	public partial class PolygonSeriesIkhLabel  : BaseObject
	{
		public PolygonSeriesIkhLabel()
		{
			...
			Style = Style_DefaultValue = new PolygonSeriesIkhLabelStyle();
		...
		/// </summary>
		public PolygonSeriesIkhLabelStyle Style { get; set; }
		private PolygonSeriesIkhLabelStyle Style_DefaultValue { get; set; }
