...
{
	public partial class PolygonSeriesLabel  : BaseObject
	{
		public PolygonSeriesLabel()
		{
			...
			Style = Style_DefaultValue = new PolygonSeriesLabelStyle();
		...
		/// </summary>
		public PolygonSeriesLabelEnabled Enabled { get; set; }
		private PolygonSeriesLabelEnabled Enabled_DefaultValue { get; set; }
		 

		/// <summary>
		/// Allow labels to be placed distant to the graph if necessary,and draw a connector line to the graph.
		/// </summary>
		public PolygonSeriesLabelConnectorAllowed ConnectorAllowed { get; set; }
		private PolygonSeriesLabelConnectorAllowed ConnectorAllowed_DefaultValue { get; set; }
		 

		/// <summary>
		/// If the label is closer than this to a neighbour graph, draw aconnector.
		/// </summary>
		public PolygonSeriesLabelConnectorNeighbourDistance ConnectorNeighbourDistance { get; set; }
		private PolygonSeriesLabelConnectorNeighbourDistance ConnectorNeighbourDistance_DefaultValue { get; set; }
		...
		/// </summary>
		public PolygonSeriesLabelStyle Style { get; set; }
		private PolygonSeriesLabelStyle Style_DefaultValue { get; set; }
