...
{
	public partial class PriceenvelopesSeriesIkhLabel  : BaseObject
	{
		public PriceenvelopesSeriesIkhLabel()
		{
			...
			Style = Style_DefaultValue = new PriceenvelopesSeriesIkhLabelStyle();
		...
		/// </summary>
		public PriceenvelopesSeriesIkhLabelStyle Style { get; set; }
		private PriceenvelopesSeriesIkhLabelStyle Style_DefaultValue { get; set; }
