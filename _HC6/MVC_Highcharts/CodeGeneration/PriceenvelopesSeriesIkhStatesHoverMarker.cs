...
{
	public partial class PriceenvelopesSeriesIkhStatesHoverMarker  : BaseObject
	{
		public PriceenvelopesSeriesIkhStatesHoverMarker()
		{
			LineWidth = LineWidth_DefaultValue = 0;
			LineColor = LineColor_DefaultValue = "#ffffff";
			Radius = Radius_DefaultValue = 4;
			States = States_DefaultValue = new PriceenvelopesSeriesIkhStatesHoverMarkerStates();
		...
		/// </summary>
		public PriceenvelopesSeriesIkhStatesHoverMarkerStates States { get; set; }
		private PriceenvelopesSeriesIkhStatesHoverMarkerStates States_DefaultValue { get; set; }
