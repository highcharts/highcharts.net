...
{
	public partial class PriceenvelopesSeriesStatesHoverMarker  : BaseObject
	{
		public PriceenvelopesSeriesStatesHoverMarker()
		{
			LineWidth = LineWidth_DefaultValue = 0;
			LineColor = LineColor_DefaultValue = "#ffffff";
			Radius = Radius_DefaultValue = 4;
			States = States_DefaultValue = new PriceenvelopesSeriesStatesHoverMarkerStates();
		...
		/// </summary>
		public PriceenvelopesSeriesStatesHoverMarkerStates States { get; set; }
		private PriceenvelopesSeriesStatesHoverMarkerStates States_DefaultValue { get; set; }
