...
{
	public partial class PriceenvelopesSeriesStatesSelectMarker  : BaseObject
	{
		public PriceenvelopesSeriesStatesSelectMarker()
		{
			LineWidth = LineWidth_DefaultValue = 0;
			LineColor = LineColor_DefaultValue = "#ffffff";
			Radius = Radius_DefaultValue = 4;
			States = States_DefaultValue = new PriceenvelopesSeriesStatesSelectMarkerStates();
		...
		/// </summary>
		public PriceenvelopesSeriesStatesSelectMarkerStates States { get; set; }
		private PriceenvelopesSeriesStatesSelectMarkerStates States_DefaultValue { get; set; }
