...
{
	public partial class PsarSeriesIkhStatesHoverMarker  : BaseObject
	{
		public PsarSeriesIkhStatesHoverMarker()
		{
			LineWidth = LineWidth_DefaultValue = 0;
			LineColor = LineColor_DefaultValue = "#ffffff";
			Radius = Radius_DefaultValue = 4;
			States = States_DefaultValue = new PsarSeriesIkhStatesHoverMarkerStates();
		...
		/// </summary>
		public PsarSeriesIkhStatesHoverMarkerStates States { get; set; }
		private PsarSeriesIkhStatesHoverMarkerStates States_DefaultValue { get; set; }
