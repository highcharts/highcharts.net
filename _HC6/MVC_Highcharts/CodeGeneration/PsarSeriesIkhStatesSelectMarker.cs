...
{
	public partial class PsarSeriesIkhStatesSelectMarker  : BaseObject
	{
		public PsarSeriesIkhStatesSelectMarker()
		{
			LineWidth = LineWidth_DefaultValue = 0;
			LineColor = LineColor_DefaultValue = "#ffffff";
			Radius = Radius_DefaultValue = 4;
			States = States_DefaultValue = new PsarSeriesIkhStatesSelectMarkerStates();
		...
		/// </summary>
		public PsarSeriesIkhStatesSelectMarkerStates States { get; set; }
		private PsarSeriesIkhStatesSelectMarkerStates States_DefaultValue { get; set; }
