...
namespace Highsoft.Web.Mvc.Charts
{
	public partial class PyramidSeries  : Series
	{
		public PyramidSeries()
		{
			...
			Marker = Marker_DefaultValue = new PyramidSeriesMarker();
			CropThreshold = CropThreshold_DefaultValue = 300;
			SoftThreshold = SoftThreshold_DefaultValue = true;
			TurboThreshold = TurboThreshold_DefaultValue = 1000;
			FindNearestPointBy = FindNearestPointBy_DefaultValue = PyramidSeriesFindNearestPointBy.X;
			AnimationLimit = AnimationLimit_DefaultValue = null;
			ConnectNulls = ConnectNulls_DefaultValue = false;
			DashStyle = DashStyle_DefaultValue = PyramidSeriesDashStyle.Solid;
			GetExtremesFromAll = GetExtremesFromAll_DefaultValue = false;
			NegativeColor = NegativeColor_DefaultValue = "null";
			PointInterval = PointInterval_DefaultValue = 1;
			PointIntervalUnit = PointIntervalUnit_DefaultValue = PyramidSeriesPointIntervalUnit.Null;
			PointPlacement = PointPlacement_DefaultValue = new PointPlacement();
			PointStart = PointStart_DefaultValue = 0;
			Stacking = Stacking_DefaultValue = PyramidSeriesStacking.Null;
		...
		/// <summary>
		/// <p>An array of data points for the series. For the <code>pyramid</code> seriestype, points can be given in the following ways:</p><ol><li><p>An array of numerical values. In this case, the numerical valueswill be interpreted as <code>y</code> options. Example:</p><pre><code class="lang-js">data: [0, 5, 3, 5]</code></pre></li><li><p>An array of objects with named values. The objects are pointconfiguration objects as seen below. If the total number of datapoints exceeds the series&#39; <a href="#series.pyramid.turboThreshold">turboThreshold</a>,this option is not available.</p><pre><code class="lang-js">data: [{    y: 9,    name: &quot;Point2&quot;,    color: &quot;#00FF00&quot;}, {    y: 6,    name: &quot;Point1&quot;,    color: &quot;#FF00FF&quot;}]</code></pre></li></ol>
		/// </summary>
		...
		/// <summary>
		/// <p>The pyramid neck width is zero by default, as opposed to the funnel, which shares the same layout logic.</p>
		/// </summary>
		...
		/// <summary>
		/// <p>The pyramid is reversed by default, as opposed to the funnel, whichshares the layout engine, and is not reversed.</p>
		/// </summary>
		...
		/// </summary>
		public PyramidSeriesMarker Marker { get; set; }
		private PyramidSeriesMarker Marker_DefaultValue { get; set; }
		...
		/// </summary>
		public PyramidSeriesFindNearestPointBy FindNearestPointBy { get; set; }
		private PyramidSeriesFindNearestPointBy FindNearestPointBy_DefaultValue { get; set; }
		...
		/// </summary>
		public PyramidSeriesDashStyle DashStyle { get; set; }
		private PyramidSeriesDashStyle DashStyle_DefaultValue { get; set; }
		...
		/// </summary>
		public PyramidSeriesPointIntervalUnit PointIntervalUnit { get; set; }
		private PyramidSeriesPointIntervalUnit PointIntervalUnit_DefaultValue { get; set; }
		...
		/// </summary>
		public PyramidSeriesStacking Stacking { get; set; }
		private PyramidSeriesStacking Stacking_DefaultValue { get; set; }
		 

		/// <summary>
		/// <p>Whether to apply steps to the line. Possible values are <code>left</code>, <code>center</code>and <code>right</code>.</p>
		/// </summary>
		public PyramidSeriesStep Step { get; set; }
		private PyramidSeriesStep Step_DefaultValue { get; set; }
