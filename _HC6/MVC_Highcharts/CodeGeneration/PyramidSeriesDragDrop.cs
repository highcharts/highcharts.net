...
{
	public partial class PyramidSeriesDragDrop  : BaseObject
	{
		public PyramidSeriesDragDrop()
		{
			DraggableX = DraggableX_DefaultValue = null;
			DraggableY = DraggableY_DefaultValue = null;
			DragHandle = DragHandle_DefaultValue = new PyramidSeriesDragDropDragHandle();
			...
			GuideBox = GuideBox_DefaultValue = new PyramidSeriesDragDropGuideBox();
		...
		/// </summary>
		public PyramidSeriesDragDropDragHandle DragHandle { get; set; }
		private PyramidSeriesDragDropDragHandle DragHandle_DefaultValue { get; set; }
		...
		/// </summary>
		public PyramidSeriesDragDropGuideBox GuideBox { get; set; }
		private PyramidSeriesDragDropGuideBox GuideBox_DefaultValue { get; set; }
