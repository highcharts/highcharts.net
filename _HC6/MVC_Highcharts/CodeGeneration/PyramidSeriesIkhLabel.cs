...
{
	public partial class PyramidSeriesIkhLabel  : BaseObject
	{
		public PyramidSeriesIkhLabel()
		{
			...
			Style = Style_DefaultValue = new PyramidSeriesIkhLabelStyle();
		...
		/// </summary>
		public PyramidSeriesIkhLabelStyle Style { get; set; }
		private PyramidSeriesIkhLabelStyle Style_DefaultValue { get; set; }
