...
{
	public partial class PyramidSeriesIkhStatesHoverMarker  : BaseObject
	{
		public PyramidSeriesIkhStatesHoverMarker()
		{
			LineWidth = LineWidth_DefaultValue = 0;
			LineColor = LineColor_DefaultValue = "#ffffff";
			Radius = Radius_DefaultValue = 4;
			States = States_DefaultValue = new PyramidSeriesIkhStatesHoverMarkerStates();
		...
		/// </summary>
		public PyramidSeriesIkhStatesHoverMarkerStates States { get; set; }
		private PyramidSeriesIkhStatesHoverMarkerStates States_DefaultValue { get; set; }
