...
{
	public partial class PyramidSeriesLabel  : BaseObject
	{
		public PyramidSeriesLabel()
		{
			...
			Style = Style_DefaultValue = new PyramidSeriesLabelStyle();
		...
		/// </summary>
		public PyramidSeriesLabelEnabled Enabled { get; set; }
		private PyramidSeriesLabelEnabled Enabled_DefaultValue { get; set; }
		 

		/// <summary>
		/// Allow labels to be placed distant to the graph if necessary,and draw a connector line to the graph.
		/// </summary>
		public PyramidSeriesLabelConnectorAllowed ConnectorAllowed { get; set; }
		private PyramidSeriesLabelConnectorAllowed ConnectorAllowed_DefaultValue { get; set; }
		 

		/// <summary>
		/// If the label is closer than this to a neighbour graph, draw aconnector.
		/// </summary>
		public PyramidSeriesLabelConnectorNeighbourDistance ConnectorNeighbourDistance { get; set; }
		private PyramidSeriesLabelConnectorNeighbourDistance ConnectorNeighbourDistance_DefaultValue { get; set; }
		...
		/// </summary>
		public PyramidSeriesLabelStyle Style { get; set; }
		private PyramidSeriesLabelStyle Style_DefaultValue { get; set; }
