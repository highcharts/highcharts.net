...
namespace Highsoft.Web.Mvc.Charts
{
	public partial class PyramidSeriesPointEvents  : BaseObject
	{
		...
		internal override Hashtable ToHashtable()
		{
			...
			if (LegendItemClick != LegendItemClick_DefaultValue) { h.Add("legendItemClick",LegendItemClick); Highcharts.AddFunction("PyramidSeriesPointEventsLegendItemClick.legendItemClick", LegendItemClick); }  
