...
{
	public partial class PyramidSeriesStatesHover  : BaseObject
	{
		public PyramidSeriesStatesHover()
		{
			Animation = Animation_DefaultValue = new Animation() { Enabled = true };
			LineWidthPlus = LineWidthPlus_DefaultValue = 1;
			Marker = Marker_DefaultValue = new PyramidSeriesStatesHoverMarker();
			Halo = Halo_DefaultValue = new PyramidSeriesStatesHoverHalo();
