...
{
	public partial class RocSeriesIkhStatesSelectMarker  : BaseObject
	{
		public RocSeriesIkhStatesSelectMarker()
		{
			LineWidth = LineWidth_DefaultValue = 0;
			LineColor = LineColor_DefaultValue = "#ffffff";
			Radius = Radius_DefaultValue = 4;
			States = States_DefaultValue = new RocSeriesIkhStatesSelectMarkerStates();
		...
		/// </summary>
		public RocSeriesIkhStatesSelectMarkerStates States { get; set; }
		private RocSeriesIkhStatesSelectMarkerStates States_DefaultValue { get; set; }
