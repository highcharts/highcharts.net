...
{
	public partial class RocSeriesLabel  : BaseObject
	{
		public RocSeriesLabel()
		{
			...
			Style = Style_DefaultValue = new RocSeriesLabelStyle();
		...
		/// </summary>
		public RocSeriesLabelStyle Style { get; set; }
		private RocSeriesLabelStyle Style_DefaultValue { get; set; }
