...
{
	public partial class RocSeriesStatesSelectMarker  : BaseObject
	{
		public RocSeriesStatesSelectMarker()
		{
			LineWidth = LineWidth_DefaultValue = 0;
			LineColor = LineColor_DefaultValue = "#ffffff";
			Radius = Radius_DefaultValue = 4;
			States = States_DefaultValue = new RocSeriesStatesSelectMarkerStates();
		...
		/// </summary>
		public RocSeriesStatesSelectMarkerStates States { get; set; }
		private RocSeriesStatesSelectMarkerStates States_DefaultValue { get; set; }
