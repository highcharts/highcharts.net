...
{
	public partial class RsiSeriesIkhMarker  : BaseObject
	{
		public RsiSeriesIkhMarker()
		{
			LineWidth = LineWidth_DefaultValue = 0;
			LineColor = LineColor_DefaultValue = "#ffffff";
			Radius = Radius_DefaultValue = 4;
			States = States_DefaultValue = new RsiSeriesIkhMarkerStates();
		...
		/// </summary>
		public RsiSeriesIkhMarkerStates States { get; set; }
		private RsiSeriesIkhMarkerStates States_DefaultValue { get; set; }
