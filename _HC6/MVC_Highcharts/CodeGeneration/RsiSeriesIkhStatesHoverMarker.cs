...
{
	public partial class RsiSeriesIkhStatesHoverMarker  : BaseObject
	{
		public RsiSeriesIkhStatesHoverMarker()
		{
			LineWidth = LineWidth_DefaultValue = 0;
			LineColor = LineColor_DefaultValue = "#ffffff";
			Radius = Radius_DefaultValue = 4;
			States = States_DefaultValue = new RsiSeriesIkhStatesHoverMarkerStates();
		...
		/// </summary>
		public RsiSeriesIkhStatesHoverMarkerStates States { get; set; }
		private RsiSeriesIkhStatesHoverMarkerStates States_DefaultValue { get; set; }
