...
{
	public partial class RsiSeriesStatesSelectMarker  : BaseObject
	{
		public RsiSeriesStatesSelectMarker()
		{
			LineWidth = LineWidth_DefaultValue = 0;
			LineColor = LineColor_DefaultValue = "#ffffff";
			Radius = Radius_DefaultValue = 4;
			States = States_DefaultValue = new RsiSeriesStatesSelectMarkerStates();
		...
		/// </summary>
		public RsiSeriesStatesSelectMarkerStates States { get; set; }
		private RsiSeriesStatesSelectMarkerStates States_DefaultValue { get; set; }
