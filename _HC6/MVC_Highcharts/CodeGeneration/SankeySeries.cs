...
namespace Highsoft.Web.Mvc.Charts
{
	public partial class SankeySeries  : Series
	{
		public SankeySeries()
		{
			...
			Type = Type_DefaultValue = SankeySeriesType.Null;
			...
			Label = Label_DefaultValue = new SankeySeriesLabel();
			...
			Marker = Marker_DefaultValue = new SankeySeriesMarker();
			CropThreshold = CropThreshold_DefaultValue = 300;
			SoftThreshold = SoftThreshold_DefaultValue = true;
			FindNearestPointBy = FindNearestPointBy_DefaultValue = SankeySeriesFindNearestPointBy.X;
			AnimationLimit = AnimationLimit_DefaultValue = null;
			ConnectNulls = ConnectNulls_DefaultValue = false;
			DashStyle = DashStyle_DefaultValue = SankeySeriesDashStyle.Solid;
			Linecap = Linecap_DefaultValue = SankeySeriesLinecap.Round;
			NegativeColor = NegativeColor_DefaultValue = "null";
			PointInterval = PointInterval_DefaultValue = 1;
			PointIntervalUnit = PointIntervalUnit_DefaultValue = SankeySeriesPointIntervalUnit.Null;
			PointPlacement = PointPlacement_DefaultValue = new PointPlacement();
			PointStart = PointStart_DefaultValue = 0;
			Shadow = Shadow_DefaultValue = new Shadow() { Enabled = false };
			Stacking = Stacking_DefaultValue = SankeySeriesStacking.Null;
			Step = Step_DefaultValue = SankeySeriesStep.Null;
			Threshold = Threshold_DefaultValue = 0;
			ZoneAxis = ZoneAxis_DefaultValue = "y";
			Zones = Zones_DefaultValue = new List<SankeySeriesZone>();
		...
		/// <summary>
		/// <p>A collection of options for the individual nodes. The nodes in a sankey diagram are auto-generated instances of <code>Highcharts.Point</code>, but options canbe applied here and linked by the <code>id</code>.</p>
		/// </summary>
		public SankeySeriesNodes Nodes { get; set; }
		private SankeySeriesNodes Nodes_DefaultValue { get; set; }
		 

		/// <summary>
		/// <p>An array of data points for the series. For the <code>sankey</code> series type,points can be given in the following way:</p><p>An array of objects with named values. The objects are pointconfiguration objects as seen below. If the total number of datapoints exceeds the series&#39; <a href="#series.area.turboThreshold">turboThreshold</a>,this option is not available.</p><pre><code class="lang-js">    data: [{        from: &#39;Category1&#39;,        to: &#39;Category2&#39;,        weight: 2    }, {        from: &#39;Category1&#39;,        to: &#39;Category3&#39;,        weight: 5    }]</code></pre>
		/// </summary>
		...
		/// </summary>
		public SankeySeriesMarker Marker { get; set; }
		private SankeySeriesMarker Marker_DefaultValue { get; set; }
		...
		/// </summary>
		public SankeySeriesFindNearestPointBy FindNearestPointBy { get; set; }
		private SankeySeriesFindNearestPointBy FindNearestPointBy_DefaultValue { get; set; }
		...
		/// </summary>
		public SankeySeriesLinecap Linecap { get; set; }
		private SankeySeriesLinecap Linecap_DefaultValue { get; set; }
		...
		/// </summary>
		public SankeySeriesPointIntervalUnit PointIntervalUnit { get; set; }
		private SankeySeriesPointIntervalUnit PointIntervalUnit_DefaultValue { get; set; }
		...
		/// </summary>
		public SankeySeriesStacking Stacking { get; set; }
		private SankeySeriesStacking Stacking_DefaultValue { get; set; }
		 

		/// <summary>
		/// <p>Whether to apply steps to the line. Possible values are <code>left</code>, <code>center</code>and <code>right</code>.</p>
		/// </summary>
		public SankeySeriesStep Step { get; set; }
		private SankeySeriesStep Step_DefaultValue { get; set; }
		...
		/// </summary>
		public List<SankeySeriesZone> Zones { get; set; }
		private List<SankeySeriesZone> Zones_DefaultValue { get; set; }
		...
		internal override Hashtable ToHashtable()
		{
			...
			if (PointDescriptionFormatter != PointDescriptionFormatter_DefaultValue) { h.Add("pointDescriptionFormatter",PointDescriptionFormatter); Highcharts.AddFunction("SankeySeriesPointDescriptionFormatter.pointDescriptionFormatter", PointDescriptionFormatter); }  
