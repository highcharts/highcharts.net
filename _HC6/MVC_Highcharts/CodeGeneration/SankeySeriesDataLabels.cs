...
namespace Highsoft.Web.Mvc.Charts
{
	public partial class SankeySeriesDataLabels  : BaseObject
	{
		public SankeySeriesDataLabels()
		{
			...
			NodeFormat = NodeFormat_DefaultValue = "{point.name}";
			Format = Format_DefaultValue = "''";
			Inside = Inside_DefaultValue = null;
			Align = Align_DefaultValue = SankeySeriesDataLabelsAlign.Null;
			VerticalAlign = VerticalAlign_DefaultValue = SankeySeriesDataLabelsVerticalAlign.Null;
			...
			Overflow = Overflow_DefaultValue = SankeySeriesDataLabelsOverflow.Justify;
		...
		/// <summary>
		/// <p>The <a href="http://www.highcharts.com/docs/chart-concepts/labels-and-string-formatting">format string</a> specifying what to show for <em>nodes</em> in the sankey diagram.</p>
		/// </summary>
		...
		/// <summary>
		/// <p>The <a href="http://www.highcharts.com/docs/chart-concepts/labels-and-string-formatting">format string</a> specifying what to show for <em>links</em> in the sankey diagram. Defaults to an empty string, in effect disabling thelabels.</p>
		/// </summary>
		...
		/// </summary>
		public SankeySeriesDataLabelsOverflow Overflow { get; set; }
		private SankeySeriesDataLabelsOverflow Overflow_DefaultValue { get; set; }
		...
		internal override Hashtable ToHashtable()
		{
			...
			if (Formatter != Formatter_DefaultValue) { h.Add("formatter",Formatter); Highcharts.AddFunction("SankeySeriesDataLabelsFormatter.formatter", Formatter); }  
