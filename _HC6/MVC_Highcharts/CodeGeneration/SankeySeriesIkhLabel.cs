...
{
	public partial class SankeySeriesIkhLabel  : BaseObject
	{
		public SankeySeriesIkhLabel()
		{
			...
			Style = Style_DefaultValue = new SankeySeriesIkhLabelStyle();
		...
		/// </summary>
		public SankeySeriesIkhLabelStyle Style { get; set; }
		private SankeySeriesIkhLabelStyle Style_DefaultValue { get; set; }
