...
{
	public partial class SankeySeriesIkhMarker  : BaseObject
	{
		public SankeySeriesIkhMarker()
		{
			LineWidth = LineWidth_DefaultValue = 0;
			LineColor = LineColor_DefaultValue = "#ffffff";
			Radius = Radius_DefaultValue = 4;
			States = States_DefaultValue = new SankeySeriesIkhMarkerStates();
		...
		/// </summary>
		public SankeySeriesIkhMarkerStates States { get; set; }
		private SankeySeriesIkhMarkerStates States_DefaultValue { get; set; }
