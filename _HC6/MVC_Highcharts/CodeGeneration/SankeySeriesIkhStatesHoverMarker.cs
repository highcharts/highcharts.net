...
{
	public partial class SankeySeriesIkhStatesHoverMarker  : BaseObject
	{
		public SankeySeriesIkhStatesHoverMarker()
		{
			LineWidth = LineWidth_DefaultValue = 0;
			LineColor = LineColor_DefaultValue = "#ffffff";
			Radius = Radius_DefaultValue = 4;
			States = States_DefaultValue = new SankeySeriesIkhStatesHoverMarkerStates();
		...
		/// </summary>
		public SankeySeriesIkhStatesHoverMarkerStates States { get; set; }
		private SankeySeriesIkhStatesHoverMarkerStates States_DefaultValue { get; set; }
