...
{
	public partial class SankeySeriesIkhStatesSelectMarker  : BaseObject
	{
		public SankeySeriesIkhStatesSelectMarker()
		{
			LineWidth = LineWidth_DefaultValue = 0;
			LineColor = LineColor_DefaultValue = "#ffffff";
			Radius = Radius_DefaultValue = 4;
			States = States_DefaultValue = new SankeySeriesIkhStatesSelectMarkerStates();
		...
		/// </summary>
		public SankeySeriesIkhStatesSelectMarkerStates States { get; set; }
		private SankeySeriesIkhStatesSelectMarkerStates States_DefaultValue { get; set; }
