...
{
	public partial class SankeySeriesMarker  : BaseObject
	{
		public SankeySeriesMarker()
		{
			LineWidth = LineWidth_DefaultValue = 0;
			LineColor = LineColor_DefaultValue = "#ffffff";
			Radius = Radius_DefaultValue = 4;
			States = States_DefaultValue = new SankeySeriesMarkerStates();
		...
		/// </summary>
		public SankeySeriesMarkerStates States { get; set; }
		private SankeySeriesMarkerStates States_DefaultValue { get; set; }
