...
namespace Highsoft.Web.Mvc.Charts
{
	public partial class Scatter3dSeries  : Series
	{
		public Scatter3dSeries()
		{
			...
			FindNearestPointBy = FindNearestPointBy_DefaultValue = Scatter3dSeriesFindNearestPointBy.Xy;
		...
		/// <summary>
		/// <p>An array of data points for the series. For the <code>scatter3d</code> seriestype, points can be given in the following ways:</p><ol><li><p>An array of arrays with 3 values. In this case, the values correspondto <code>x,y,z</code>. If the first value is a string, it is applied as the nameof the point, and the <code>x</code> value is inferred.</p><pre><code class="lang-js">data: [    [0, 0, 1],    [1, 8, 7],    [2, 9, 2]]</code></pre></li><li><p>An array of objects with named values. The objects are pointconfiguration objects as seen below. If the total number of datapoints exceeds the series&#39; <a href="#series.scatter3d.turboThreshold">turboThreshold</a>,this option is not available.</p><pre><code class="lang-js">data: [{    x: 1,    y: 2,    z: 24,    name: &quot;Point2&quot;,    color: &quot;#00FF00&quot;}, {    x: 1,    y: 4,    z: 12,    name: &quot;Point1&quot;,    color: &quot;#FF00FF&quot;}]</code></pre></li></ol>
		/// </summary>
