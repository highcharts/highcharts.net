...
{
	public partial class Scatter3dSeriesDataDragDropDragHandle  : BaseObject
	{
		public Scatter3dSeriesDataDragDropDragHandle()
		{
		...
		internal override Hashtable ToHashtable()
		{
			...
			if (PathFormatter != PathFormatter_DefaultValue) { h.Add("pathFormatter",PathFormatter); Highcharts.AddFunction("Scatter3dSeriesDataDragDropDragHandlePathFormatter.pathFormatter", PathFormatter); }  
