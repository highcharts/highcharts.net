...
{
	public partial class Scatter3dSeriesIkhLabel  : BaseObject
	{
		public Scatter3dSeriesIkhLabel()
		{
			...
			Style = Style_DefaultValue = new Scatter3dSeriesIkhLabelStyle();
		...
		/// </summary>
		public Scatter3dSeriesIkhLabelStyle Style { get; set; }
		private Scatter3dSeriesIkhLabelStyle Style_DefaultValue { get; set; }
