...
{
	public partial class Scatter3dSeriesIkhMarker  : BaseObject
	{
		public Scatter3dSeriesIkhMarker()
		{
			LineWidth = LineWidth_DefaultValue = 0;
			LineColor = LineColor_DefaultValue = "#ffffff";
			Radius = Radius_DefaultValue = 4;
			States = States_DefaultValue = new Scatter3dSeriesIkhMarkerStates();
		...
		/// </summary>
		public Scatter3dSeriesIkhMarkerStates States { get; set; }
		private Scatter3dSeriesIkhMarkerStates States_DefaultValue { get; set; }
