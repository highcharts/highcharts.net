...
{
	public partial class ScatterSeriesDataDragDrop  : BaseObject
	{
		public ScatterSeriesDataDragDrop()
		{
			DraggableX = DraggableX_DefaultValue = null;
			DraggableY = DraggableY_DefaultValue = null;
			DragHandle = DragHandle_DefaultValue = new ScatterSeriesDataDragDropDragHandle();
			...
			GuideBox = GuideBox_DefaultValue = new ScatterSeriesDataDragDropGuideBox();
		...
		/// </summary>
		public ScatterSeriesDataDragDropDragHandle DragHandle { get; set; }
		private ScatterSeriesDataDragDropDragHandle DragHandle_DefaultValue { get; set; }
		...
		/// </summary>
		public ScatterSeriesDataDragDropGuideBox GuideBox { get; set; }
		private ScatterSeriesDataDragDropGuideBox GuideBox_DefaultValue { get; set; }
