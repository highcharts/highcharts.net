...
{
	public partial class ScatterSeriesDataLabelsFilter  : BaseObject
	{
		...
		/// </summary>
		public ScatterSeriesDataLabelsFilterValue Value { get; set; }
		private ScatterSeriesDataLabelsFilterValue Value_DefaultValue { get; set; }
