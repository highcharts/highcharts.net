...
{
	public partial class ScatterSeriesIkhLabel  : BaseObject
	{
		public ScatterSeriesIkhLabel()
		{
			...
			Style = Style_DefaultValue = new ScatterSeriesIkhLabelStyle();
		...
		/// </summary>
		public ScatterSeriesIkhLabelStyle Style { get; set; }
		private ScatterSeriesIkhLabelStyle Style_DefaultValue { get; set; }
