...
{
	public partial class ScatterSeriesStatesHover  : BaseObject
	{
		public ScatterSeriesStatesHover()
		{
			Animation = Animation_DefaultValue = new Animation() { Enabled = true };
			LineWidthPlus = LineWidthPlus_DefaultValue = 1;
			Marker = Marker_DefaultValue = new ScatterSeriesStatesHoverMarker();
			Halo = Halo_DefaultValue = new ScatterSeriesStatesHoverHalo();
		...
		/// </summary>
		public ScatterSeriesStatesHoverMarker Marker { get; set; }
		private ScatterSeriesStatesHoverMarker Marker_DefaultValue { get; set; }
		...
		/// </summary>
		public ScatterSeriesStatesHoverHalo Halo { get; set; }
		private ScatterSeriesStatesHoverHalo Halo_DefaultValue { get; set; }
