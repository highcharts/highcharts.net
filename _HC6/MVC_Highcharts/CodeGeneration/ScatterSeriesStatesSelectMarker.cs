...
{
	public partial class ScatterSeriesStatesSelectMarker  : BaseObject
	{
		public ScatterSeriesStatesSelectMarker()
		{
			...
			States = States_DefaultValue = new ScatterSeriesStatesSelectMarkerStates();
		...
		/// </summary>
		public ScatterSeriesStatesSelectMarkerStates States { get; set; }
		private ScatterSeriesStatesSelectMarkerStates States_DefaultValue { get; set; }
