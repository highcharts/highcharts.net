...
{
	public partial class SmaSeriesIkhLabel  : BaseObject
	{
		public SmaSeriesIkhLabel()
		{
			...
			Style = Style_DefaultValue = new SmaSeriesIkhLabelStyle();
		...
		/// </summary>
		public SmaSeriesIkhLabelStyle Style { get; set; }
		private SmaSeriesIkhLabelStyle Style_DefaultValue { get; set; }
