...
{
	public partial class SmaSeriesIkhStatesHoverMarker  : BaseObject
	{
		public SmaSeriesIkhStatesHoverMarker()
		{
			LineWidth = LineWidth_DefaultValue = 0;
			LineColor = LineColor_DefaultValue = "#ffffff";
			Radius = Radius_DefaultValue = 4;
			States = States_DefaultValue = new SmaSeriesIkhStatesHoverMarkerStates();
		...
		/// </summary>
		public SmaSeriesIkhStatesHoverMarkerStates States { get; set; }
		private SmaSeriesIkhStatesHoverMarkerStates States_DefaultValue { get; set; }
