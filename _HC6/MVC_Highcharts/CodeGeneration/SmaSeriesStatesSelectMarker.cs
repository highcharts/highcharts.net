...
{
	public partial class SmaSeriesStatesSelectMarker  : BaseObject
	{
		public SmaSeriesStatesSelectMarker()
		{
			LineWidth = LineWidth_DefaultValue = 0;
			LineColor = LineColor_DefaultValue = "#ffffff";
			Radius = Radius_DefaultValue = 4;
			States = States_DefaultValue = new SmaSeriesStatesSelectMarkerStates();
		...
		/// </summary>
		public SmaSeriesStatesSelectMarkerStates States { get; set; }
		private SmaSeriesStatesSelectMarkerStates States_DefaultValue { get; set; }
