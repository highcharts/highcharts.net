...
namespace Highsoft.Web.Mvc.Charts
{
	public partial class SolidgaugeSeries  : Series
	{
		public SolidgaugeSeries()
		{
			...
			States = States_DefaultValue = new SolidgaugeSeriesStates();
			...
			Marker = Marker_DefaultValue = new SolidgaugeSeriesMarker();
			CropThreshold = CropThreshold_DefaultValue = 300;
			SoftThreshold = SoftThreshold_DefaultValue = true;
			TurboThreshold = TurboThreshold_DefaultValue = 1000;
			FindNearestPointBy = FindNearestPointBy_DefaultValue = SolidgaugeSeriesFindNearestPointBy.X;
			AnimationLimit = AnimationLimit_DefaultValue = null;
			ConnectNulls = ConnectNulls_DefaultValue = false;
			DashStyle = DashStyle_DefaultValue = SolidgaugeSeriesDashStyle.Solid;
		...
		/// </summary>
		public SolidgaugeSeriesMarker Marker { get; set; }
		private SolidgaugeSeriesMarker Marker_DefaultValue { get; set; }
		...
		/// </summary>
		public SolidgaugeSeriesFindNearestPointBy FindNearestPointBy { get; set; }
		private SolidgaugeSeriesFindNearestPointBy FindNearestPointBy_DefaultValue { get; set; }
		...
		/// </summary>
		public SolidgaugeSeriesDashStyle DashStyle { get; set; }
		private SolidgaugeSeriesDashStyle DashStyle_DefaultValue { get; set; }
		...
		/// </summary>
		public SolidgaugeSeriesStacking Stacking { get; set; }
		private SolidgaugeSeriesStacking Stacking_DefaultValue { get; set; }
		 

		/// <summary>
		/// <p>Whether to apply steps to the line. Possible values are <code>left</code>, <code>center</code>and <code>right</code>.</p>
		/// </summary>
		public SolidgaugeSeriesStep Step { get; set; }
		private SolidgaugeSeriesStep Step_DefaultValue { get; set; }
