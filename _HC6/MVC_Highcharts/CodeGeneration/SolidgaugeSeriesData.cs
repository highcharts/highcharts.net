...
namespace Highsoft.Web.Mvc.Charts
{
	public partial class SolidgaugeSeriesData  : BaseObject
	{
		...
		/// <summary>
		/// <p>The inner radius of an individual point in a solid gauge. Can begiven as a number (pixels) or percentage string.</p>
		/// </summary>
		...
		/// <summary>
		/// <p>The outer radius of an individual point in a solid gauge. Can begiven as a number (pixels) or percentage string.</p>
		/// </summary>
