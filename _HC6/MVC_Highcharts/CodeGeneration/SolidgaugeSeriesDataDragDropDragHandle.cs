...
{
	public partial class SolidgaugeSeriesDataDragDropDragHandle  : BaseObject
	{
		public SolidgaugeSeriesDataDragDropDragHandle()
		{
		...
		internal override Hashtable ToHashtable()
		{
			...
			if (PathFormatter != PathFormatter_DefaultValue) { h.Add("pathFormatter",PathFormatter); Highcharts.AddFunction("SolidgaugeSeriesDataDragDropDragHandlePathFormatter.pathFormatter", PathFormatter); }  
