...
namespace Highsoft.Web.Mvc.Charts
{
	public partial class SolidgaugeSeriesDataLabels  : BaseObject
	{
		...
		/// 
		/// </summary>
		public SolidgaugeSeriesDataLabelsDefer Defer { get; set; }
		private SolidgaugeSeriesDataLabelsDefer Defer_DefaultValue { get; set; }
		...
		/// 
		/// </summary>
		public SolidgaugeSeriesDataLabelsCrop Crop { get; set; }
		private SolidgaugeSeriesDataLabelsCrop Crop_DefaultValue { get; set; }
