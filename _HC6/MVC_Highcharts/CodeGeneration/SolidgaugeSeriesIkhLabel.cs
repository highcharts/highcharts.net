...
{
	public partial class SolidgaugeSeriesIkhLabel  : BaseObject
	{
		public SolidgaugeSeriesIkhLabel()
		{
			...
			Style = Style_DefaultValue = new SolidgaugeSeriesIkhLabelStyle();
		...
		/// </summary>
		public SolidgaugeSeriesIkhLabelStyle Style { get; set; }
		private SolidgaugeSeriesIkhLabelStyle Style_DefaultValue { get; set; }
