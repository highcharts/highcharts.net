...
{
	public partial class SolidgaugeSeriesIkhMarker  : BaseObject
	{
		public SolidgaugeSeriesIkhMarker()
		{
			LineWidth = LineWidth_DefaultValue = 0;
			LineColor = LineColor_DefaultValue = "#ffffff";
			Radius = Radius_DefaultValue = 4;
			States = States_DefaultValue = new SolidgaugeSeriesIkhMarkerStates();
		...
		/// </summary>
		public SolidgaugeSeriesIkhMarkerStates States { get; set; }
		private SolidgaugeSeriesIkhMarkerStates States_DefaultValue { get; set; }
