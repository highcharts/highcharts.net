...
{
	public partial class SolidgaugeSeriesIkhStatesSelectMarker  : BaseObject
	{
		public SolidgaugeSeriesIkhStatesSelectMarker()
		{
			LineWidth = LineWidth_DefaultValue = 0;
			LineColor = LineColor_DefaultValue = "#ffffff";
			Radius = Radius_DefaultValue = 4;
			States = States_DefaultValue = new SolidgaugeSeriesIkhStatesSelectMarkerStates();
		...
		/// </summary>
		public SolidgaugeSeriesIkhStatesSelectMarkerStates States { get; set; }
		private SolidgaugeSeriesIkhStatesSelectMarkerStates States_DefaultValue { get; set; }
