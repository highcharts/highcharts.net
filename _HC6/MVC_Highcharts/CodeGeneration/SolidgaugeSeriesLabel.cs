...
{
	public partial class SolidgaugeSeriesLabel  : BaseObject
	{
		public SolidgaugeSeriesLabel()
		{
			...
			Style = Style_DefaultValue = new SolidgaugeSeriesLabelStyle();
		...
		/// </summary>
		public SolidgaugeSeriesLabelEnabled Enabled { get; set; }
		private SolidgaugeSeriesLabelEnabled Enabled_DefaultValue { get; set; }
		 

		/// <summary>
		/// Allow labels to be placed distant to the graph if necessary,and draw a connector line to the graph.
		/// </summary>
		public SolidgaugeSeriesLabelConnectorAllowed ConnectorAllowed { get; set; }
		private SolidgaugeSeriesLabelConnectorAllowed ConnectorAllowed_DefaultValue { get; set; }
		 

		/// <summary>
		/// If the label is closer than this to a neighbour graph, draw aconnector.
		/// </summary>
		public SolidgaugeSeriesLabelConnectorNeighbourDistance ConnectorNeighbourDistance { get; set; }
		private SolidgaugeSeriesLabelConnectorNeighbourDistance ConnectorNeighbourDistance_DefaultValue { get; set; }
		...
		/// </summary>
		public SolidgaugeSeriesLabelStyle Style { get; set; }
		private SolidgaugeSeriesLabelStyle Style_DefaultValue { get; set; }
