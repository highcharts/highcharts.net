...
{
	public partial class SolidgaugeSeriesMarker  : BaseObject
	{
		public SolidgaugeSeriesMarker()
		{
			LineWidth = LineWidth_DefaultValue = 0;
			LineColor = LineColor_DefaultValue = "#ffffff";
			Radius = Radius_DefaultValue = 4;
			States = States_DefaultValue = new SolidgaugeSeriesMarkerStates();
		...
		/// </summary>
		public SolidgaugeSeriesMarkerStates States { get; set; }
		private SolidgaugeSeriesMarkerStates States_DefaultValue { get; set; }
