...
{
	public partial class SolidgaugeSeriesStatesSelectMarker  : BaseObject
	{
		public SolidgaugeSeriesStatesSelectMarker()
		{
			LineWidth = LineWidth_DefaultValue = 0;
			LineColor = LineColor_DefaultValue = "#ffffff";
			Radius = Radius_DefaultValue = 4;
			States = States_DefaultValue = new SolidgaugeSeriesStatesSelectMarkerStates();
		...
		/// </summary>
		public SolidgaugeSeriesStatesSelectMarkerStates States { get; set; }
		private SolidgaugeSeriesStatesSelectMarkerStates States_DefaultValue { get; set; }
