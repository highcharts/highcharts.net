...
{
	public partial class SplineSeriesIkhLabel  : BaseObject
	{
		public SplineSeriesIkhLabel()
		{
			...
			Style = Style_DefaultValue = new SplineSeriesIkhLabelStyle();
		...
		/// </summary>
		public SplineSeriesIkhLabelStyle Style { get; set; }
		private SplineSeriesIkhLabelStyle Style_DefaultValue { get; set; }
