...
{
	public partial class SplineSeriesIkhStatesHoverMarker  : BaseObject
	{
		public SplineSeriesIkhStatesHoverMarker()
		{
			LineWidth = LineWidth_DefaultValue = 0;
			LineColor = LineColor_DefaultValue = "#ffffff";
			Radius = Radius_DefaultValue = 4;
			States = States_DefaultValue = new SplineSeriesIkhStatesHoverMarkerStates();
		...
		/// </summary>
		public SplineSeriesIkhStatesHoverMarkerStates States { get; set; }
		private SplineSeriesIkhStatesHoverMarkerStates States_DefaultValue { get; set; }
