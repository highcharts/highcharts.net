...
{
	public partial class StochasticSeriesIkhLabel  : BaseObject
	{
		public StochasticSeriesIkhLabel()
		{
			...
			Style = Style_DefaultValue = new StochasticSeriesIkhLabelStyle();
		...
		/// </summary>
		public StochasticSeriesIkhLabelStyle Style { get; set; }
		private StochasticSeriesIkhLabelStyle Style_DefaultValue { get; set; }
