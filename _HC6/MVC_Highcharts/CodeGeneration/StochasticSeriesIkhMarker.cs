...
{
	public partial class StochasticSeriesIkhMarker  : BaseObject
	{
		public StochasticSeriesIkhMarker()
		{
			LineWidth = LineWidth_DefaultValue = 0;
			LineColor = LineColor_DefaultValue = "#ffffff";
			Radius = Radius_DefaultValue = 4;
			States = States_DefaultValue = new StochasticSeriesIkhMarkerStates();
		...
		/// </summary>
		public StochasticSeriesIkhMarkerStates States { get; set; }
		private StochasticSeriesIkhMarkerStates States_DefaultValue { get; set; }
