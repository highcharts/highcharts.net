...
{
	public partial class StochasticSeriesIkhStatesHoverMarker  : BaseObject
	{
		public StochasticSeriesIkhStatesHoverMarker()
		{
			LineWidth = LineWidth_DefaultValue = 0;
			LineColor = LineColor_DefaultValue = "#ffffff";
			Radius = Radius_DefaultValue = 4;
			States = States_DefaultValue = new StochasticSeriesIkhStatesHoverMarkerStates();
		...
		/// </summary>
		public StochasticSeriesIkhStatesHoverMarkerStates States { get; set; }
		private StochasticSeriesIkhStatesHoverMarkerStates States_DefaultValue { get; set; }
