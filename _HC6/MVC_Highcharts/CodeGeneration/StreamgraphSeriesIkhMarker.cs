...
{
	public partial class StreamgraphSeriesIkhMarker  : BaseObject
	{
		public StreamgraphSeriesIkhMarker()
		{
			LineWidth = LineWidth_DefaultValue = 0;
			LineColor = LineColor_DefaultValue = "#ffffff";
			Radius = Radius_DefaultValue = 4;
			States = States_DefaultValue = new StreamgraphSeriesIkhMarkerStates();
		...
		/// </summary>
		public StreamgraphSeriesIkhMarkerStates States { get; set; }
		private StreamgraphSeriesIkhMarkerStates States_DefaultValue { get; set; }
