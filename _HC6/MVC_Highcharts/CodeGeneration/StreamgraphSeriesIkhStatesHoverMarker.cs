...
{
	public partial class StreamgraphSeriesIkhStatesHoverMarker  : BaseObject
	{
		public StreamgraphSeriesIkhStatesHoverMarker()
		{
			LineWidth = LineWidth_DefaultValue = 0;
			LineColor = LineColor_DefaultValue = "#ffffff";
			Radius = Radius_DefaultValue = 4;
			States = States_DefaultValue = new StreamgraphSeriesIkhStatesHoverMarkerStates();
		...
		/// </summary>
		public StreamgraphSeriesIkhStatesHoverMarkerStates States { get; set; }
		private StreamgraphSeriesIkhStatesHoverMarkerStates States_DefaultValue { get; set; }
