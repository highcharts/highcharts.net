...
{
	public partial class StreamgraphSeriesLabel  : BaseObject
	{
		public StreamgraphSeriesLabel()
		{
			...
			Style = Style_DefaultValue = new StreamgraphSeriesLabelStyle();
		...
		/// </summary>
		public StreamgraphSeriesLabelEnabled Enabled { get; set; }
		private StreamgraphSeriesLabelEnabled Enabled_DefaultValue { get; set; }
		 

		/// <summary>
		/// Allow labels to be placed distant to the graph if necessary,and draw a connector line to the graph.
		/// </summary>
		public StreamgraphSeriesLabelConnectorAllowed ConnectorAllowed { get; set; }
		private StreamgraphSeriesLabelConnectorAllowed ConnectorAllowed_DefaultValue { get; set; }
		 

		/// <summary>
		/// If the label is closer than this to a neighbour graph, draw aconnector.
		/// </summary>
		public StreamgraphSeriesLabelConnectorNeighbourDistance ConnectorNeighbourDistance { get; set; }
		private StreamgraphSeriesLabelConnectorNeighbourDistance ConnectorNeighbourDistance_DefaultValue { get; set; }
		...
		/// </summary>
		public StreamgraphSeriesLabelStyle Style { get; set; }
		private StreamgraphSeriesLabelStyle Style_DefaultValue { get; set; }
