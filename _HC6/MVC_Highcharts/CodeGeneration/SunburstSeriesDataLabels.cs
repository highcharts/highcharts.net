...
namespace Highsoft.Web.Mvc.Charts
{
	public partial class SunburstSeriesDataLabels  : BaseObject
	{
		...
		/// <summary>
		/// <p>Decides how the data label will be rotated according to the perimeterof the sunburst. It can either be parallel or perpendicular to theperimeter.<code>series.rotation</code> takes precedence over <code>rotationMode</code>.</p>
		/// </summary>
