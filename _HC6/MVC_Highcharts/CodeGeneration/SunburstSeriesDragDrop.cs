...
{
	public partial class SunburstSeriesDragDrop  : BaseObject
	{
		public SunburstSeriesDragDrop()
		{
			DraggableX = DraggableX_DefaultValue = null;
			DraggableY = DraggableY_DefaultValue = null;
			DragHandle = DragHandle_DefaultValue = new SunburstSeriesDragDropDragHandle();
			...
			GuideBox = GuideBox_DefaultValue = new SunburstSeriesDragDropGuideBox();
		...
		/// </summary>
		public SunburstSeriesDragDropDragHandle DragHandle { get; set; }
		private SunburstSeriesDragDropDragHandle DragHandle_DefaultValue { get; set; }
		...
		/// </summary>
		public SunburstSeriesDragDropGuideBox GuideBox { get; set; }
		private SunburstSeriesDragDropGuideBox GuideBox_DefaultValue { get; set; }
