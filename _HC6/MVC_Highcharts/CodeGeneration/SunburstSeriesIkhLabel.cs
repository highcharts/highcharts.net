...
{
	public partial class SunburstSeriesIkhLabel  : BaseObject
	{
		public SunburstSeriesIkhLabel()
		{
			...
			Style = Style_DefaultValue = new SunburstSeriesIkhLabelStyle();
		...
		/// </summary>
		public SunburstSeriesIkhLabelStyle Style { get; set; }
		private SunburstSeriesIkhLabelStyle Style_DefaultValue { get; set; }
