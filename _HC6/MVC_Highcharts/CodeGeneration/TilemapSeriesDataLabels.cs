...
namespace Highsoft.Web.Mvc.Charts
{
	public partial class TilemapSeriesDataLabels  : BaseObject
	{
		public TilemapSeriesDataLabels()
		{
			...
			VerticalAlign = VerticalAlign_DefaultValue = TilemapSeriesDataLabelsVerticalAlign.Middle;
			Crop = Crop_DefaultValue = null;
			Overflow = Overflow_DefaultValue = TilemapSeriesDataLabelsOverflow.Null;
