...
{
	public partial class TilemapSeriesIkhLabel  : BaseObject
	{
		public TilemapSeriesIkhLabel()
		{
			...
			Style = Style_DefaultValue = new TilemapSeriesIkhLabelStyle();
		...
		/// </summary>
		public TilemapSeriesIkhLabelStyle Style { get; set; }
		private TilemapSeriesIkhLabelStyle Style_DefaultValue { get; set; }
