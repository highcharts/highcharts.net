...
{
	public partial class TilemapSeriesIkhStatesHoverMarker  : BaseObject
	{
		public TilemapSeriesIkhStatesHoverMarker()
		{
			LineWidth = LineWidth_DefaultValue = 0;
			LineColor = LineColor_DefaultValue = "#ffffff";
			Radius = Radius_DefaultValue = 4;
			States = States_DefaultValue = new TilemapSeriesIkhStatesHoverMarkerStates();
		...
		/// </summary>
		public TilemapSeriesIkhStatesHoverMarkerStates States { get; set; }
		private TilemapSeriesIkhStatesHoverMarkerStates States_DefaultValue { get; set; }
