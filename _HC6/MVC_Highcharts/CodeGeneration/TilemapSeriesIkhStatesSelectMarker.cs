...
{
	public partial class TilemapSeriesIkhStatesSelectMarker  : BaseObject
	{
		public TilemapSeriesIkhStatesSelectMarker()
		{
			LineWidth = LineWidth_DefaultValue = 0;
			LineColor = LineColor_DefaultValue = "#ffffff";
			Radius = Radius_DefaultValue = 4;
			States = States_DefaultValue = new TilemapSeriesIkhStatesSelectMarkerStates();
		...
		/// </summary>
		public TilemapSeriesIkhStatesSelectMarkerStates States { get; set; }
		private TilemapSeriesIkhStatesSelectMarkerStates States_DefaultValue { get; set; }
