...
{
	public partial class TilemapSeriesMarker  : BaseObject
	{
		public TilemapSeriesMarker()
		{
			LineWidth = LineWidth_DefaultValue = 0;
			LineColor = LineColor_DefaultValue = "#ffffff";
			Radius = Radius_DefaultValue = 4;
			States = States_DefaultValue = new TilemapSeriesMarkerStates();
		...
		/// </summary>
		public TilemapSeriesMarkerStates States { get; set; }
		private TilemapSeriesMarkerStates States_DefaultValue { get; set; }
