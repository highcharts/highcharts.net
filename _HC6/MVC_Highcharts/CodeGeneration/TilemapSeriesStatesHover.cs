...
{
	public partial class TilemapSeriesStatesHover  : BaseObject
	{
		...
		/// </summary>
		public TilemapSeriesStatesHoverMarker Marker { get; set; }
		private TilemapSeriesStatesHoverMarker Marker_DefaultValue { get; set; }
