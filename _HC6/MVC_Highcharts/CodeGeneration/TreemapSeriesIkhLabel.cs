...
{
	public partial class TreemapSeriesIkhLabel  : BaseObject
	{
		public TreemapSeriesIkhLabel()
		{
			...
			Style = Style_DefaultValue = new TreemapSeriesIkhLabelStyle();
		...
		/// </summary>
		public TreemapSeriesIkhLabelStyle Style { get; set; }
		private TreemapSeriesIkhLabelStyle Style_DefaultValue { get; set; }
