...
{
	public partial class TreemapSeriesIkhMarker  : BaseObject
	{
		public TreemapSeriesIkhMarker()
		{
			LineWidth = LineWidth_DefaultValue = 0;
			LineColor = LineColor_DefaultValue = "#ffffff";
			Radius = Radius_DefaultValue = 4;
			States = States_DefaultValue = new TreemapSeriesIkhMarkerStates();
		...
		/// </summary>
		public TreemapSeriesIkhMarkerStates States { get; set; }
		private TreemapSeriesIkhMarkerStates States_DefaultValue { get; set; }
