...
{
	public partial class TreemapSeriesIkhStatesHoverMarker  : BaseObject
	{
		public TreemapSeriesIkhStatesHoverMarker()
		{
			LineWidth = LineWidth_DefaultValue = 0;
			LineColor = LineColor_DefaultValue = "#ffffff";
			Radius = Radius_DefaultValue = 4;
			States = States_DefaultValue = new TreemapSeriesIkhStatesHoverMarkerStates();
		...
		/// </summary>
		public TreemapSeriesIkhStatesHoverMarkerStates States { get; set; }
		private TreemapSeriesIkhStatesHoverMarkerStates States_DefaultValue { get; set; }
