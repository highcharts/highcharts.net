...
{
	public partial class TreemapSeriesIkhStatesSelectMarker  : BaseObject
	{
		public TreemapSeriesIkhStatesSelectMarker()
		{
			LineWidth = LineWidth_DefaultValue = 0;
			LineColor = LineColor_DefaultValue = "#ffffff";
			Radius = Radius_DefaultValue = 4;
			States = States_DefaultValue = new TreemapSeriesIkhStatesSelectMarkerStates();
		...
		/// </summary>
		public TreemapSeriesIkhStatesSelectMarkerStates States { get; set; }
		private TreemapSeriesIkhStatesSelectMarkerStates States_DefaultValue { get; set; }
