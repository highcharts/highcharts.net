...
{
	public partial class TreemapSeriesMarker  : BaseObject
	{
		public TreemapSeriesMarker()
		{
			LineWidth = LineWidth_DefaultValue = 0;
			LineColor = LineColor_DefaultValue = "#ffffff";
			Radius = Radius_DefaultValue = 4;
			States = States_DefaultValue = new TreemapSeriesMarkerStates();
		...
		/// </summary>
		public TreemapSeriesMarkerStates States { get; set; }
		private TreemapSeriesMarkerStates States_DefaultValue { get; set; }
