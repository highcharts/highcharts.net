...
{
	public partial class TreemapSeriesStatesSelectMarker  : BaseObject
	{
		public TreemapSeriesStatesSelectMarker()
		{
			LineWidth = LineWidth_DefaultValue = 0;
			LineColor = LineColor_DefaultValue = "#ffffff";
			Radius = Radius_DefaultValue = 4;
			States = States_DefaultValue = new TreemapSeriesStatesSelectMarkerStates();
		...
		/// </summary>
		public TreemapSeriesStatesSelectMarkerStates States { get; set; }
		private TreemapSeriesStatesSelectMarkerStates States_DefaultValue { get; set; }
