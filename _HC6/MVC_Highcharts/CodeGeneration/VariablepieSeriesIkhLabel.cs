...
{
	public partial class VariablepieSeriesIkhLabel  : BaseObject
	{
		public VariablepieSeriesIkhLabel()
		{
			...
			Style = Style_DefaultValue = new VariablepieSeriesIkhLabelStyle();
		...
		/// </summary>
		public VariablepieSeriesIkhLabelStyle Style { get; set; }
		private VariablepieSeriesIkhLabelStyle Style_DefaultValue { get; set; }
