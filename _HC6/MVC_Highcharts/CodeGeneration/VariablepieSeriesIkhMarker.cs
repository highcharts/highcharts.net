...
{
	public partial class VariablepieSeriesIkhMarker  : BaseObject
	{
		public VariablepieSeriesIkhMarker()
		{
			LineWidth = LineWidth_DefaultValue = 0;
			LineColor = LineColor_DefaultValue = "#ffffff";
			Radius = Radius_DefaultValue = 4;
			States = States_DefaultValue = new VariablepieSeriesIkhMarkerStates();
		...
		/// </summary>
		public VariablepieSeriesIkhMarkerStates States { get; set; }
		private VariablepieSeriesIkhMarkerStates States_DefaultValue { get; set; }
