...
{
	public partial class VariablepieSeriesIkhStatesSelectMarker  : BaseObject
	{
		public VariablepieSeriesIkhStatesSelectMarker()
		{
			LineWidth = LineWidth_DefaultValue = 0;
			LineColor = LineColor_DefaultValue = "#ffffff";
			Radius = Radius_DefaultValue = 4;
			States = States_DefaultValue = new VariablepieSeriesIkhStatesSelectMarkerStates();
		...
		/// </summary>
		public VariablepieSeriesIkhStatesSelectMarkerStates States { get; set; }
		private VariablepieSeriesIkhStatesSelectMarkerStates States_DefaultValue { get; set; }
