...
namespace Highsoft.Web.Mvc.Charts
{
	public partial class VariablepieSeriesPointEvents  : BaseObject
	{
		...
		internal override Hashtable ToHashtable()
		{
			...
			if (LegendItemClick != LegendItemClick_DefaultValue) { h.Add("legendItemClick",LegendItemClick); Highcharts.AddFunction("VariablepieSeriesPointEventsLegendItemClick.legendItemClick", LegendItemClick); }  
