...
namespace Highsoft.Web.Mvc.Charts
{
	public partial class VariwideSeries  : Series
	{
		public VariwideSeries()
		{
			...
			Zones = Zones_DefaultValue = new VariwideSeriesZone();
			BoostThreshold = BoostThreshold_DefaultValue = 5000;
			LineWidth = LineWidth_DefaultValue = 2;
			Marker = Marker_DefaultValue = new VariwideSeriesMarker();
			ConnectNulls = ConnectNulls_DefaultValue = false;
			DashStyle = DashStyle_DefaultValue = VariwideSeriesDashStyle.Solid;
			Linecap = Linecap_DefaultValue = VariwideSeriesLinecap.Round;
			Step = Step_DefaultValue = VariwideSeriesStep.Null;
		...
		/// </summary>
		public VariwideSeriesZone Zones { get; set; }
		private VariwideSeriesZone Zones_DefaultValue { get; set; }
		...
		/// </summary>
		public VariwideSeriesMarker Marker { get; set; }
		private VariwideSeriesMarker Marker_DefaultValue { get; set; }
		...
		/// </summary>
		public VariwideSeriesLinecap Linecap { get; set; }
		private VariwideSeriesLinecap Linecap_DefaultValue { get; set; }
		 

		/// <summary>
		/// <p>Whether to apply steps to the line. Possible values are <code>left</code>, <code>center</code>and <code>right</code>.</p>
		/// </summary>
		public VariwideSeriesStep Step { get; set; }
		private VariwideSeriesStep Step_DefaultValue { get; set; }
