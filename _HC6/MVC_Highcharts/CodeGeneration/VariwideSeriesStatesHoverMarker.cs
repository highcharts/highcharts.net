...
{
	public partial class VariwideSeriesStatesHoverMarker  : BaseObject
	{
		public VariwideSeriesStatesHoverMarker()
		{
			...
			States = States_DefaultValue = new VariwideSeriesStatesHoverMarkerStates();
		...
		/// </summary>
		public VariwideSeriesStatesHoverMarkerStates States { get; set; }
		private VariwideSeriesStatesHoverMarkerStates States_DefaultValue { get; set; }
