...
{
	public partial class VariwideSeriesStatesSelectMarker  : BaseObject
	{
		public VariwideSeriesStatesSelectMarker()
		{
			LineWidth = LineWidth_DefaultValue = 0;
			LineColor = LineColor_DefaultValue = "#ffffff";
			Radius = Radius_DefaultValue = 4;
			States = States_DefaultValue = new VariwideSeriesStatesSelectMarkerStates();
		...
		/// </summary>
		public VariwideSeriesStatesSelectMarkerStates States { get; set; }
		private VariwideSeriesStatesSelectMarkerStates States_DefaultValue { get; set; }
