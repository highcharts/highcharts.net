...
{
	public partial class VbpSeriesIkhMarker  : BaseObject
	{
		public VbpSeriesIkhMarker()
		{
			LineWidth = LineWidth_DefaultValue = 0;
			LineColor = LineColor_DefaultValue = "#ffffff";
			Radius = Radius_DefaultValue = 4;
			States = States_DefaultValue = new VbpSeriesIkhMarkerStates();
		...
		/// </summary>
		public VbpSeriesIkhMarkerStates States { get; set; }
		private VbpSeriesIkhMarkerStates States_DefaultValue { get; set; }
