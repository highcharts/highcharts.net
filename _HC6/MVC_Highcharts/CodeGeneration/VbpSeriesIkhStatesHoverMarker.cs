...
{
	public partial class VbpSeriesIkhStatesHoverMarker  : BaseObject
	{
		public VbpSeriesIkhStatesHoverMarker()
		{
			LineWidth = LineWidth_DefaultValue = 0;
			LineColor = LineColor_DefaultValue = "#ffffff";
			Radius = Radius_DefaultValue = 4;
			States = States_DefaultValue = new VbpSeriesIkhStatesHoverMarkerStates();
		...
		/// </summary>
		public VbpSeriesIkhStatesHoverMarkerStates States { get; set; }
		private VbpSeriesIkhStatesHoverMarkerStates States_DefaultValue { get; set; }
