...
{
	public partial class VbpSeriesLabel  : BaseObject
	{
		public VbpSeriesLabel()
		{
			...
			Style = Style_DefaultValue = new VbpSeriesLabelStyle();
		...
		/// </summary>
		public VbpSeriesLabelStyle Style { get; set; }
		private VbpSeriesLabelStyle Style_DefaultValue { get; set; }
