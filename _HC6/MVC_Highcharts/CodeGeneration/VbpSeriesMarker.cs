...
{
	public partial class VbpSeriesMarker  : BaseObject
	{
		public VbpSeriesMarker()
		{
			LineWidth = LineWidth_DefaultValue = 0;
			LineColor = LineColor_DefaultValue = "#ffffff";
			Radius = Radius_DefaultValue = 4;
			States = States_DefaultValue = new VbpSeriesMarkerStates();
		...
		/// </summary>
		public VbpSeriesMarkerStates States { get; set; }
		private VbpSeriesMarkerStates States_DefaultValue { get; set; }
