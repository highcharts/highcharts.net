...
{
	public partial class VbpSeriesStatesSelectMarker  : BaseObject
	{
		public VbpSeriesStatesSelectMarker()
		{
			LineWidth = LineWidth_DefaultValue = 0;
			LineColor = LineColor_DefaultValue = "#ffffff";
			Radius = Radius_DefaultValue = 4;
			States = States_DefaultValue = new VbpSeriesStatesSelectMarkerStates();
		...
		/// </summary>
		public VbpSeriesStatesSelectMarkerStates States { get; set; }
		private VbpSeriesStatesSelectMarkerStates States_DefaultValue { get; set; }
