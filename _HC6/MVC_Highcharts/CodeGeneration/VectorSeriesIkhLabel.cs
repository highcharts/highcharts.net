...
{
	public partial class VectorSeriesIkhLabel  : BaseObject
	{
		public VectorSeriesIkhLabel()
		{
			...
			Style = Style_DefaultValue = new VectorSeriesIkhLabelStyle();
		...
		/// </summary>
		public VectorSeriesIkhLabelStyle Style { get; set; }
		private VectorSeriesIkhLabelStyle Style_DefaultValue { get; set; }
