...
{
	public partial class VectorSeriesIkhMarker  : BaseObject
	{
		public VectorSeriesIkhMarker()
		{
			LineWidth = LineWidth_DefaultValue = 0;
			LineColor = LineColor_DefaultValue = "#ffffff";
			Radius = Radius_DefaultValue = 4;
			States = States_DefaultValue = new VectorSeriesIkhMarkerStates();
		...
		/// </summary>
		public VectorSeriesIkhMarkerStates States { get; set; }
		private VectorSeriesIkhMarkerStates States_DefaultValue { get; set; }
