...
{
	public partial class VectorSeriesIkhStatesHoverMarker  : BaseObject
	{
		public VectorSeriesIkhStatesHoverMarker()
		{
			LineWidth = LineWidth_DefaultValue = 0;
			LineColor = LineColor_DefaultValue = "#ffffff";
			Radius = Radius_DefaultValue = 4;
			States = States_DefaultValue = new VectorSeriesIkhStatesHoverMarkerStates();
		...
		/// </summary>
		public VectorSeriesIkhStatesHoverMarkerStates States { get; set; }
		private VectorSeriesIkhStatesHoverMarkerStates States_DefaultValue { get; set; }
