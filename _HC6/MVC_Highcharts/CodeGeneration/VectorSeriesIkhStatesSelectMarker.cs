...
{
	public partial class VectorSeriesIkhStatesSelectMarker  : BaseObject
	{
		public VectorSeriesIkhStatesSelectMarker()
		{
			LineWidth = LineWidth_DefaultValue = 0;
			LineColor = LineColor_DefaultValue = "#ffffff";
			Radius = Radius_DefaultValue = 4;
			States = States_DefaultValue = new VectorSeriesIkhStatesSelectMarkerStates();
		...
		/// </summary>
		public VectorSeriesIkhStatesSelectMarkerStates States { get; set; }
		private VectorSeriesIkhStatesSelectMarkerStates States_DefaultValue { get; set; }
