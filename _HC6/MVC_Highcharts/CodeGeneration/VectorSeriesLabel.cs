...
{
	public partial class VectorSeriesLabel  : BaseObject
	{
		public VectorSeriesLabel()
		{
			...
			Style = Style_DefaultValue = new VectorSeriesLabelStyle();
		...
		/// </summary>
		public VectorSeriesLabelEnabled Enabled { get; set; }
		private VectorSeriesLabelEnabled Enabled_DefaultValue { get; set; }
		 

		/// <summary>
		/// Allow labels to be placed distant to the graph if necessary,and draw a connector line to the graph.
		/// </summary>
		public VectorSeriesLabelConnectorAllowed ConnectorAllowed { get; set; }
		private VectorSeriesLabelConnectorAllowed ConnectorAllowed_DefaultValue { get; set; }
		 

		/// <summary>
		/// If the label is closer than this to a neighbour graph, draw aconnector.
		/// </summary>
		public VectorSeriesLabelConnectorNeighbourDistance ConnectorNeighbourDistance { get; set; }
		private VectorSeriesLabelConnectorNeighbourDistance ConnectorNeighbourDistance_DefaultValue { get; set; }
		...
		/// </summary>
		public VectorSeriesLabelStyle Style { get; set; }
		private VectorSeriesLabelStyle Style_DefaultValue { get; set; }
