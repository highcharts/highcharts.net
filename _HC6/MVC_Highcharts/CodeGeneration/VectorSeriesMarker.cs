...
{
	public partial class VectorSeriesMarker  : BaseObject
	{
		public VectorSeriesMarker()
		{
			LineWidth = LineWidth_DefaultValue = 0;
			LineColor = LineColor_DefaultValue = "#ffffff";
			Radius = Radius_DefaultValue = 4;
			States = States_DefaultValue = new VectorSeriesMarkerStates();
		...
		/// </summary>
		public VectorSeriesMarkerStates States { get; set; }
		private VectorSeriesMarkerStates States_DefaultValue { get; set; }
