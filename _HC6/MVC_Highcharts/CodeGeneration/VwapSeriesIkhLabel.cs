...
{
	public partial class VwapSeriesIkhLabel  : BaseObject
	{
		public VwapSeriesIkhLabel()
		{
			...
			Style = Style_DefaultValue = new VwapSeriesIkhLabelStyle();
		...
		/// </summary>
		public VwapSeriesIkhLabelStyle Style { get; set; }
		private VwapSeriesIkhLabelStyle Style_DefaultValue { get; set; }
