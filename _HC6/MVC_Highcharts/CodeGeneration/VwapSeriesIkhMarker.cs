...
{
	public partial class VwapSeriesIkhMarker  : BaseObject
	{
		public VwapSeriesIkhMarker()
		{
			LineWidth = LineWidth_DefaultValue = 0;
			LineColor = LineColor_DefaultValue = "#ffffff";
			Radius = Radius_DefaultValue = 4;
			States = States_DefaultValue = new VwapSeriesIkhMarkerStates();
		...
		/// </summary>
		public VwapSeriesIkhMarkerStates States { get; set; }
		private VwapSeriesIkhMarkerStates States_DefaultValue { get; set; }
