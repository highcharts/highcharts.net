...
{
	public partial class VwapSeriesIkhStatesHoverMarker  : BaseObject
	{
		public VwapSeriesIkhStatesHoverMarker()
		{
			LineWidth = LineWidth_DefaultValue = 0;
			LineColor = LineColor_DefaultValue = "#ffffff";
			Radius = Radius_DefaultValue = 4;
			States = States_DefaultValue = new VwapSeriesIkhStatesHoverMarkerStates();
		...
		/// </summary>
		public VwapSeriesIkhStatesHoverMarkerStates States { get; set; }
		private VwapSeriesIkhStatesHoverMarkerStates States_DefaultValue { get; set; }
