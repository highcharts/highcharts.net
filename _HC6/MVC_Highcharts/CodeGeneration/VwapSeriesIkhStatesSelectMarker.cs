...
{
	public partial class VwapSeriesIkhStatesSelectMarker  : BaseObject
	{
		public VwapSeriesIkhStatesSelectMarker()
		{
			LineWidth = LineWidth_DefaultValue = 0;
			LineColor = LineColor_DefaultValue = "#ffffff";
			Radius = Radius_DefaultValue = 4;
			States = States_DefaultValue = new VwapSeriesIkhStatesSelectMarkerStates();
		...
		/// </summary>
		public VwapSeriesIkhStatesSelectMarkerStates States { get; set; }
		private VwapSeriesIkhStatesSelectMarkerStates States_DefaultValue { get; set; }
