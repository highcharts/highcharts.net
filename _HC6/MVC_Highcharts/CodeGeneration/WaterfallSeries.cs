...
{
	public partial class WaterfallSeries  : Series
	{
		public WaterfallSeries()
		{
			...
			Type = Type_DefaultValue = WaterfallSeriesType.Null;
			...
			PointIntervalUnit = PointIntervalUnit_DefaultValue = WaterfallSeriesPointIntervalUnit.Null;
			...
			Stacking = Stacking_DefaultValue = WaterfallSeriesStacking.Null;
			Visible = Visible_DefaultValue = true;
			ZoneAxis = ZoneAxis_DefaultValue = "y";
			Zones = Zones_DefaultValue = new WaterfallSeriesZone();
			Marker = Marker_DefaultValue = new WaterfallSeriesMarker();
			ConnectNulls = ConnectNulls_DefaultValue = false;
			Linecap = Linecap_DefaultValue = WaterfallSeriesLinecap.Round;
			Step = Step_DefaultValue = WaterfallSeriesStep.Null;
		...
		/// <summary>
		/// <p>The color of the line that connects columns in a waterfall series.</p><p>In styled mode, the stroke can be set with the <code>.highcharts-graph</code> class.</p>
		/// </summary>
		...
		/// <summary>
		/// <p>A name for the dash style to use for the line connecting the columnsof the waterfall series. Possible values:</p><ul><li>Solid</li><li>ShortDash</li><li>ShortDot</li><li>ShortDashDot</li><li>ShortDashDotDot</li><li>Dot</li><li>Dash</li><li>LongDash</li><li>DashDot</li><li>LongDashDot</li><li>LongDashDotDot</li></ul><p>In styled mode, the stroke dash-array can be set with the <code>.highcharts-graph</code> class.</p>
		/// </summary>
		...
		/// <summary>
		/// <p>The color of the border of each waterfall column.</p><p>In styled mode, the border stroke can be set with the <code>.highcharts-point</code> class.</p>
		/// </summary>
		...
		/// <summary>
		/// <p>The color used specifically for positive point columns. When notspecified, the general series color is used.</p><p>In styled mode, the waterfall colors can be set with the<code>.highcharts-point-negative</code>, <code>.highcharts-sum</code> and<code>.highcharts-intermediate-sum</code> classes.</p>
		/// </summary>
		...
		/// </summary>
		public WaterfallSeriesLabel Label { get; set; }
		private WaterfallSeriesLabel Label_DefaultValue { get; set; }
		...
		/// </summary>
		public WaterfallSeriesFindNearestPointBy FindNearestPointBy { get; set; }
		private WaterfallSeriesFindNearestPointBy FindNearestPointBy_DefaultValue { get; set; }
		...
		/// </summary>
		public WaterfallSeriesStacking Stacking { get; set; }
		private WaterfallSeriesStacking Stacking_DefaultValue { get; set; }
		...
		/// </summary>
		public WaterfallSeriesZone Zones { get; set; }
		private WaterfallSeriesZone Zones_DefaultValue { get; set; }
		...
		/// </summary>
		public WaterfallSeriesMarker Marker { get; set; }
		private WaterfallSeriesMarker Marker_DefaultValue { get; set; }
		...
		/// </summary>
		public WaterfallSeriesLinecap Linecap { get; set; }
		private WaterfallSeriesLinecap Linecap_DefaultValue { get; set; }
		 

		/// <summary>
		/// <p>Whether to apply steps to the line. Possible values are <code>left</code>, <code>center</code>and <code>right</code>.</p>
		/// </summary>
		public WaterfallSeriesStep Step { get; set; }
		private WaterfallSeriesStep Step_DefaultValue { get; set; }
		...
		internal override Hashtable ToHashtable()
		{
			...
			if (PointDescriptionFormatter != PointDescriptionFormatter_DefaultValue) { h.Add("pointDescriptionFormatter",PointDescriptionFormatter); Highcharts.AddFunction("WaterfallSeriesPointDescriptionFormatter.pointDescriptionFormatter", PointDescriptionFormatter); }  
