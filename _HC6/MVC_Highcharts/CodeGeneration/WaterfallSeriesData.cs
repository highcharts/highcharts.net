...
namespace Highsoft.Web.Mvc.Charts
{
	public partial class WaterfallSeriesData  : BaseObject
	{
		...
		/// <summary>
		/// <p>When this property is true, the points acts as a summary column forthe values added or substracted since the last intermediate sum,or since the start of the series. The <code>y</code> value is ignored.</p>
		/// </summary>
		...
		/// <summary>
		/// <p>When this property is true, the point display the total sum acrossthe entire series. The <code>y</code> value is ignored.</p>
		/// </summary>
