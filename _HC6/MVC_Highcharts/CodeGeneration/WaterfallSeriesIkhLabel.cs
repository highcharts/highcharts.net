...
{
	public partial class WaterfallSeriesIkhLabel  : BaseObject
	{
		public WaterfallSeriesIkhLabel()
		{
			...
			Style = Style_DefaultValue = new WaterfallSeriesIkhLabelStyle();
		...
		/// </summary>
		public WaterfallSeriesIkhLabelStyle Style { get; set; }
		private WaterfallSeriesIkhLabelStyle Style_DefaultValue { get; set; }
