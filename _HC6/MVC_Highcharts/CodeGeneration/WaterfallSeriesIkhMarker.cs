...
{
	public partial class WaterfallSeriesIkhMarker  : BaseObject
	{
		public WaterfallSeriesIkhMarker()
		{
			LineWidth = LineWidth_DefaultValue = 0;
			LineColor = LineColor_DefaultValue = "#ffffff";
			Radius = Radius_DefaultValue = 4;
			States = States_DefaultValue = new WaterfallSeriesIkhMarkerStates();
		...
		/// </summary>
		public WaterfallSeriesIkhMarkerStates States { get; set; }
		private WaterfallSeriesIkhMarkerStates States_DefaultValue { get; set; }
