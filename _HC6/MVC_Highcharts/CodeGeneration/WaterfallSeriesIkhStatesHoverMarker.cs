...
{
	public partial class WaterfallSeriesIkhStatesHoverMarker  : BaseObject
	{
		public WaterfallSeriesIkhStatesHoverMarker()
		{
			LineWidth = LineWidth_DefaultValue = 0;
			LineColor = LineColor_DefaultValue = "#ffffff";
			Radius = Radius_DefaultValue = 4;
			States = States_DefaultValue = new WaterfallSeriesIkhStatesHoverMarkerStates();
		...
		/// </summary>
		public WaterfallSeriesIkhStatesHoverMarkerStates States { get; set; }
		private WaterfallSeriesIkhStatesHoverMarkerStates States_DefaultValue { get; set; }
