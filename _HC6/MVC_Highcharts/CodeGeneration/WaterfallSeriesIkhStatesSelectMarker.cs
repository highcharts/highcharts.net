...
{
	public partial class WaterfallSeriesIkhStatesSelectMarker  : BaseObject
	{
		public WaterfallSeriesIkhStatesSelectMarker()
		{
			LineWidth = LineWidth_DefaultValue = 0;
			LineColor = LineColor_DefaultValue = "#ffffff";
			Radius = Radius_DefaultValue = 4;
			States = States_DefaultValue = new WaterfallSeriesIkhStatesSelectMarkerStates();
		...
		/// </summary>
		public WaterfallSeriesIkhStatesSelectMarkerStates States { get; set; }
		private WaterfallSeriesIkhStatesSelectMarkerStates States_DefaultValue { get; set; }
