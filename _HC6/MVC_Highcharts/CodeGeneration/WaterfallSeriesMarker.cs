...
{
	public partial class WaterfallSeriesMarker  : BaseObject
	{
		public WaterfallSeriesMarker()
		{
			LineWidth = LineWidth_DefaultValue = 0;
			LineColor = LineColor_DefaultValue = "#ffffff";
			Radius = Radius_DefaultValue = 4;
			States = States_DefaultValue = new WaterfallSeriesMarkerStates();
		...
		/// </summary>
		public WaterfallSeriesMarkerStates States { get; set; }
		private WaterfallSeriesMarkerStates States_DefaultValue { get; set; }
