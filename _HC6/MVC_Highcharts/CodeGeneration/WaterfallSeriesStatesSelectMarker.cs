...
{
	public partial class WaterfallSeriesStatesSelectMarker  : BaseObject
	{
		public WaterfallSeriesStatesSelectMarker()
		{
			LineWidth = LineWidth_DefaultValue = 0;
			LineColor = LineColor_DefaultValue = "#ffffff";
			Radius = Radius_DefaultValue = 4;
			States = States_DefaultValue = new WaterfallSeriesStatesSelectMarkerStates();
		...
		/// </summary>
		public WaterfallSeriesStatesSelectMarkerStates States { get; set; }
		private WaterfallSeriesStatesSelectMarkerStates States_DefaultValue { get; set; }
