...
{
	public partial class WindbarbSeriesDataDragDropDragHandle  : BaseObject
	{
		public WindbarbSeriesDataDragDropDragHandle()
		{
		...
		internal override Hashtable ToHashtable()
		{
			...
			if (PathFormatter != PathFormatter_DefaultValue) { h.Add("pathFormatter",PathFormatter); Highcharts.AddFunction("WindbarbSeriesDataDragDropDragHandlePathFormatter.pathFormatter", PathFormatter); }  
