...
{
	public partial class WindbarbSeriesIkhLabel  : BaseObject
	{
		public WindbarbSeriesIkhLabel()
		{
			...
			Style = Style_DefaultValue = new WindbarbSeriesIkhLabelStyle();
		...
		/// </summary>
		public WindbarbSeriesIkhLabelStyle Style { get; set; }
		private WindbarbSeriesIkhLabelStyle Style_DefaultValue { get; set; }
