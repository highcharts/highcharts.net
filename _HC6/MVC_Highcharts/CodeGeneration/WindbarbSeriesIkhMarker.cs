...
{
	public partial class WindbarbSeriesIkhMarker  : BaseObject
	{
		public WindbarbSeriesIkhMarker()
		{
			LineWidth = LineWidth_DefaultValue = 0;
			LineColor = LineColor_DefaultValue = "#ffffff";
			Radius = Radius_DefaultValue = 4;
			States = States_DefaultValue = new WindbarbSeriesIkhMarkerStates();
		...
		/// </summary>
		public WindbarbSeriesIkhMarkerStates States { get; set; }
		private WindbarbSeriesIkhMarkerStates States_DefaultValue { get; set; }
