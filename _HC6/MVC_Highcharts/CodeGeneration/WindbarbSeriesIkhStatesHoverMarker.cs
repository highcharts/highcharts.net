...
{
	public partial class WindbarbSeriesIkhStatesHoverMarker  : BaseObject
	{
		public WindbarbSeriesIkhStatesHoverMarker()
		{
			LineWidth = LineWidth_DefaultValue = 0;
			LineColor = LineColor_DefaultValue = "#ffffff";
			Radius = Radius_DefaultValue = 4;
			States = States_DefaultValue = new WindbarbSeriesIkhStatesHoverMarkerStates();
		...
		/// </summary>
		public WindbarbSeriesIkhStatesHoverMarkerStates States { get; set; }
		private WindbarbSeriesIkhStatesHoverMarkerStates States_DefaultValue { get; set; }
