...
{
	public partial class WindbarbSeriesLabel  : BaseObject
	{
		public WindbarbSeriesLabel()
		{
			...
			Style = Style_DefaultValue = new WindbarbSeriesLabelStyle();
		...
		/// </summary>
		public WindbarbSeriesLabelEnabled Enabled { get; set; }
		private WindbarbSeriesLabelEnabled Enabled_DefaultValue { get; set; }
		 

		/// <summary>
		/// Allow labels to be placed distant to the graph if necessary,and draw a connector line to the graph.
		/// </summary>
		public WindbarbSeriesLabelConnectorAllowed ConnectorAllowed { get; set; }
		private WindbarbSeriesLabelConnectorAllowed ConnectorAllowed_DefaultValue { get; set; }
		 

		/// <summary>
		/// If the label is closer than this to a neighbour graph, draw aconnector.
		/// </summary>
		public WindbarbSeriesLabelConnectorNeighbourDistance ConnectorNeighbourDistance { get; set; }
		private WindbarbSeriesLabelConnectorNeighbourDistance ConnectorNeighbourDistance_DefaultValue { get; set; }
		...
		/// </summary>
		public WindbarbSeriesLabelStyle Style { get; set; }
		private WindbarbSeriesLabelStyle Style_DefaultValue { get; set; }
