...
{
	public partial class WindbarbSeriesMarker  : BaseObject
	{
		public WindbarbSeriesMarker()
		{
			LineWidth = LineWidth_DefaultValue = 0;
			LineColor = LineColor_DefaultValue = "#ffffff";
			Radius = Radius_DefaultValue = 4;
			States = States_DefaultValue = new WindbarbSeriesMarkerStates();
		...
		/// </summary>
		public WindbarbSeriesMarkerStates States { get; set; }
		private WindbarbSeriesMarkerStates States_DefaultValue { get; set; }
