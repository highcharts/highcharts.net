...
namespace Highsoft.Web.Mvc.Charts
{
	public partial class WindbarbSeriesStatesHover  : BaseObject
	{
		public WindbarbSeriesStatesHover()
		{
			...
			Marker = Marker_DefaultValue = new WindbarbSeriesStatesHoverMarker();
		...
		/// </summary>
		public WindbarbSeriesStatesHoverMarker Marker { get; set; }
		private WindbarbSeriesStatesHoverMarker Marker_DefaultValue { get; set; }
		...
		/// </summary>
		public WindbarbSeriesStatesHoverHalo Halo { get; set; }
		private WindbarbSeriesStatesHoverHalo Halo_DefaultValue { get; set; }
