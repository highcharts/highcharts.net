...
{
	public partial class WmaSeriesIkhLabel  : BaseObject
	{
		public WmaSeriesIkhLabel()
		{
			...
			Style = Style_DefaultValue = new WmaSeriesIkhLabelStyle();
		...
		/// </summary>
		public WmaSeriesIkhLabelStyle Style { get; set; }
		private WmaSeriesIkhLabelStyle Style_DefaultValue { get; set; }
