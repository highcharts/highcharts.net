...
{
	public partial class WmaSeriesIkhStatesHoverMarker  : BaseObject
	{
		public WmaSeriesIkhStatesHoverMarker()
		{
			LineWidth = LineWidth_DefaultValue = 0;
			LineColor = LineColor_DefaultValue = "#ffffff";
			Radius = Radius_DefaultValue = 4;
			States = States_DefaultValue = new WmaSeriesIkhStatesHoverMarkerStates();
		...
		/// </summary>
		public WmaSeriesIkhStatesHoverMarkerStates States { get; set; }
		private WmaSeriesIkhStatesHoverMarkerStates States_DefaultValue { get; set; }
