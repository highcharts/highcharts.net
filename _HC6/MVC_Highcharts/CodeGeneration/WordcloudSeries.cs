...
namespace Highsoft.Web.Mvc.Charts
{
	public partial class WordcloudSeries  : Series
	{
		...
		/// <summary>
		/// <p>An array of data points for the series. For the <code>wordcloud</code> seriestype, points can be given in the following ways:</p><ol><li><p>An array of arrays with 2 values. In this case, the valuescorrespond to <code>name,weight</code>. </p><pre><code class="lang-js">data: [    [&#39;Lorem&#39;, 4],    [&#39;Ipsum&#39;, 1]]</code></pre></li><li><p>An array of objects with named values. The objects are pointconfiguration objects as seen below. If the total number of datapoints exceeds the series&#39; <a href="#series.arearange.turboThreshold">turboThreshold</a>,this option is not available.</p><pre><code class="lang-js">data: [{    name: &quot;Lorem&quot;,    weight: 4}, {    name: &quot;Ipsum&quot;,    weight: 1}]</code></pre></li></ol>
		/// </summary>
