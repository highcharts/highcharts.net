...
{
	public partial class WordcloudSeriesDragDrop  : BaseObject
	{
		public WordcloudSeriesDragDrop()
		{
			DraggableX = DraggableX_DefaultValue = null;
			DraggableY = DraggableY_DefaultValue = null;
			DragHandle = DragHandle_DefaultValue = new WordcloudSeriesDragDropDragHandle();
			...
			GuideBox = GuideBox_DefaultValue = new WordcloudSeriesDragDropGuideBox();
		...
		/// </summary>
		public WordcloudSeriesDragDropDragHandle DragHandle { get; set; }
		private WordcloudSeriesDragDropDragHandle DragHandle_DefaultValue { get; set; }
		...
		/// </summary>
		public WordcloudSeriesDragDropGuideBox GuideBox { get; set; }
		private WordcloudSeriesDragDropGuideBox GuideBox_DefaultValue { get; set; }
