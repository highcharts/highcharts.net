...
{
	public partial class WordcloudSeriesIkhLabel  : BaseObject
	{
		public WordcloudSeriesIkhLabel()
		{
			...
			Style = Style_DefaultValue = new WordcloudSeriesIkhLabelStyle();
		...
		/// </summary>
		public WordcloudSeriesIkhLabelStyle Style { get; set; }
		private WordcloudSeriesIkhLabelStyle Style_DefaultValue { get; set; }
