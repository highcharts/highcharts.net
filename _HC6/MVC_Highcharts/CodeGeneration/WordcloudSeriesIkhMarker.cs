...
{
	public partial class WordcloudSeriesIkhMarker  : BaseObject
	{
		public WordcloudSeriesIkhMarker()
		{
			LineWidth = LineWidth_DefaultValue = 0;
			LineColor = LineColor_DefaultValue = "#ffffff";
			Radius = Radius_DefaultValue = 4;
			States = States_DefaultValue = new WordcloudSeriesIkhMarkerStates();
		...
		/// </summary>
		public WordcloudSeriesIkhMarkerStates States { get; set; }
		private WordcloudSeriesIkhMarkerStates States_DefaultValue { get; set; }
