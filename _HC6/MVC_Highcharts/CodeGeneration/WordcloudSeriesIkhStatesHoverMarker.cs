...
{
	public partial class WordcloudSeriesIkhStatesHoverMarker  : BaseObject
	{
		public WordcloudSeriesIkhStatesHoverMarker()
		{
			LineWidth = LineWidth_DefaultValue = 0;
			LineColor = LineColor_DefaultValue = "#ffffff";
			Radius = Radius_DefaultValue = 4;
			States = States_DefaultValue = new WordcloudSeriesIkhStatesHoverMarkerStates();
		...
		/// </summary>
		public WordcloudSeriesIkhStatesHoverMarkerStates States { get; set; }
		private WordcloudSeriesIkhStatesHoverMarkerStates States_DefaultValue { get; set; }
