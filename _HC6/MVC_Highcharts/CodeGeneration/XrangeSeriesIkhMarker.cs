...
{
	public partial class XrangeSeriesIkhMarker  : BaseObject
	{
		public XrangeSeriesIkhMarker()
		{
			LineWidth = LineWidth_DefaultValue = 0;
			LineColor = LineColor_DefaultValue = "#ffffff";
			Radius = Radius_DefaultValue = 4;
			States = States_DefaultValue = new XrangeSeriesIkhMarkerStates();
		...
		/// </summary>
		public XrangeSeriesIkhMarkerStates States { get; set; }
		private XrangeSeriesIkhMarkerStates States_DefaultValue { get; set; }
