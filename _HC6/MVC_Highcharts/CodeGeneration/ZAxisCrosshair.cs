...
{
	public partial class ZAxisCrosshair  : BaseObject
	{
		public ZAxisCrosshair()
		{
			ClassName = ClassName_DefaultValue = "";
			Color = Color_DefaultValue = null;
			DashStyle = DashStyle_DefaultValue = ZAxisCrosshairDashStyle.Solid;
		...
		/// </summary>
		public ZAxisCrosshairDashStyle DashStyle { get; set; }
		private ZAxisCrosshairDashStyle DashStyle_DefaultValue { get; set; }
