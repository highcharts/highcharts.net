...
{
	public partial class ZigzagSeriesIkhLabel  : BaseObject
	{
		public ZigzagSeriesIkhLabel()
		{
			...
			Style = Style_DefaultValue = new ZigzagSeriesIkhLabelStyle();
		...
		/// </summary>
		public ZigzagSeriesIkhLabelStyle Style { get; set; }
		private ZigzagSeriesIkhLabelStyle Style_DefaultValue { get; set; }
