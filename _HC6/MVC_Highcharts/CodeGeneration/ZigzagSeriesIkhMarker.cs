...
{
	public partial class ZigzagSeriesIkhMarker  : BaseObject
	{
		public ZigzagSeriesIkhMarker()
		{
			LineWidth = LineWidth_DefaultValue = 0;
			LineColor = LineColor_DefaultValue = "#ffffff";
			Radius = Radius_DefaultValue = 4;
			States = States_DefaultValue = new ZigzagSeriesIkhMarkerStates();
		...
		/// </summary>
		public ZigzagSeriesIkhMarkerStates States { get; set; }
		private ZigzagSeriesIkhMarkerStates States_DefaultValue { get; set; }
