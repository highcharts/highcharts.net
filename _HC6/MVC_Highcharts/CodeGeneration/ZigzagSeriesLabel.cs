...
{
	public partial class ZigzagSeriesLabel  : BaseObject
	{
		public ZigzagSeriesLabel()
		{
			...
			Style = Style_DefaultValue = new ZigzagSeriesLabelStyle();
		...
		/// </summary>
		public ZigzagSeriesLabelStyle Style { get; set; }
		private ZigzagSeriesLabelStyle Style_DefaultValue { get; set; }
