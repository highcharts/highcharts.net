...
namespace Highsoft.Web.Mvc.Maps
{
	public partial class Chart  : BaseObject
	{
		public Chart()
		{
			...
			Type = Type_DefaultValue = ChartType.Map;
		...
		/// <summary>
		/// <p>The button that appears after a selection zoom, allowing the user to reset zoom. In Highmaps, the reset zoom button is rarely used, as the controls for mapNavigation are used instead.</p><p>For live demos, see the <a href="/highcharts/#chart.resetZoomButton">resetZoomButton options for basic Highcharts</a>.</p>
		/// </summary>
		...
		/// <summary>
		/// <p>The space between the bottom edge of the chart and the content (plot area, title, subtitle or  legend in top position).</p>
		/// </summary>
		...
		/// <summary>
		/// <p>The space between the left edge of the chart and the content (plot area,title, subtitle or  legend in top position).</p>
		/// </summary>
		...
		/// <summary>
		/// <p>The space between the right edge of the chart and the content (plot area, title, subtitle or  legend in top position).</p>
		/// </summary>
		...
		/// <summary>
		/// <p>The space between the top edge of the chart and the content (plot area, title, subtitle or  legend in top position).</p>
		/// </summary>
