...
namespace Highsoft.Web.Mvc.Maps
{
	public partial class ColorAxisEvents  : BaseObject
	{
		...
		internal override Hashtable ToHashtable()
		{
			...
			if (AfterSetExtremes != AfterSetExtremes_DefaultValue) { h.Add("afterSetExtremes",AfterSetExtremes); Highmaps.AddFunction("ColorAxisEventsAfterSetExtremes.afterSetExtremes", AfterSetExtremes); }  
			if (SetExtremes != SetExtremes_DefaultValue) { h.Add("setExtremes",SetExtremes); Highmaps.AddFunction("ColorAxisEventsSetExtremes.setExtremes", SetExtremes); }  
