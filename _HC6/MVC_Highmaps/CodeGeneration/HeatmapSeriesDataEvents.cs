...
namespace Highsoft.Web.Mvc.Maps
{
	public partial class HeatmapSeriesDataEvents  : BaseObject
	{
		...
		internal override Hashtable ToHashtable()
		{
			...
			if (Click != Click_DefaultValue) { h.Add("click",Click); Highmaps.AddFunction("HeatmapSeriesDataEventsClick.click", Click); }  
			if (MouseOut != MouseOut_DefaultValue) { h.Add("mouseOut",MouseOut); Highmaps.AddFunction("HeatmapSeriesDataEventsMouseOut.mouseOut", MouseOut); }  
			if (MouseOver != MouseOver_DefaultValue) { h.Add("mouseOver",MouseOver); Highmaps.AddFunction("HeatmapSeriesDataEventsMouseOver.mouseOver", MouseOver); }  
			if (Remove != Remove_DefaultValue) { h.Add("remove",Remove); Highmaps.AddFunction("HeatmapSeriesDataEventsRemove.remove", Remove); }  
			if (Select != Select_DefaultValue) { h.Add("select",Select); Highmaps.AddFunction("HeatmapSeriesDataEventsSelect.select", Select); }  
			if (Unselect != Unselect_DefaultValue) { h.Add("unselect",Unselect); Highmaps.AddFunction("HeatmapSeriesDataEventsUnselect.unselect", Unselect); }  
			if (Update != Update_DefaultValue) { h.Add("update",Update); Highmaps.AddFunction("HeatmapSeriesDataEventsUpdate.update", Update); }  
