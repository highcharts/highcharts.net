...
namespace Highsoft.Web.Mvc.Maps
{
	public partial class HeatmapSeriesTooltip  : BaseObject
	{
		...
		internal override Hashtable ToHashtable()
		{
			...
			if (PointFormatter != PointFormatter_DefaultValue) { h.Add("pointFormatter",PointFormatter); Highmaps.AddFunction("HeatmapSeriesTooltipPointFormatter.pointFormatter", PointFormatter); }  
