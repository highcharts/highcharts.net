...
namespace Highsoft.Web.Mvc.Maps
{
	public partial class Legend  : BaseObject
	{
		public Legend()
		{
			...
			ItemDistance = ItemDistance_DefaultValue = 8;
		...
		/// <summary>
		/// <p>Options for the paging or navigation appearing when the legend is overflown. When <a href="#legend.useHTML">legend.useHTML</a> is enabled, navigation is disabled.</p><p>For demo cases, see the <a href="/highcharts/#legend.navigation">legend.navigation options for basic Highcharts</a>.
		/// </summary>
		...
		/// <summary>
		/// Whether to apply a drop shadow to the legend. A <code>backgroundColor</code> also needs to be applied for this to take effect. The shadow can also be an object configuration containing <code>color</code>, <code>offsetX</code>, <code>offsetY</code>, <code>opacity</code> and <code>width</code>.
		/// </summary>
		...
		internal override Hashtable ToHashtable()
		{
			...
			if (LabelFormatter != LabelFormatter_DefaultValue) { h.Add("labelFormatter",LabelFormatter); Highmaps.AddFunction("LegendLabelFormatter.labelFormatter", LabelFormatter); }  
			if (Layout != Layout_DefaultValue) h.Add("layout", Highmaps.FirstCharacterToLower(Layout.ToString()));
