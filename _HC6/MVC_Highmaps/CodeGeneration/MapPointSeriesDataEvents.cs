...
{
	public partial class MapPointSeriesDataEvents  : BaseObject
	{
		public MapPointSeriesDataEvents()
		{
		...
		internal override Hashtable ToHashtable()
		{
			...
			if (Click != Click_DefaultValue) { h.Add("click",Click); Highmaps.AddFunction("MapPointSeriesDataEventsClick.click", Click); }  
			if (MouseOut != MouseOut_DefaultValue) { h.Add("mouseOut",MouseOut); Highmaps.AddFunction("MapPointSeriesDataEventsMouseOut.mouseOut", MouseOut); }  
			if (MouseOver != MouseOver_DefaultValue) { h.Add("mouseOver",MouseOver); Highmaps.AddFunction("MapPointSeriesDataEventsMouseOver.mouseOver", MouseOver); }  
			if (Remove != Remove_DefaultValue) { h.Add("remove",Remove); Highmaps.AddFunction("MapPointSeriesDataEventsRemove.remove", Remove); }  
			if (Select != Select_DefaultValue) { h.Add("select",Select); Highmaps.AddFunction("MapPointSeriesDataEventsSelect.select", Select); }  
			if (Unselect != Unselect_DefaultValue) { h.Add("unselect",Unselect); Highmaps.AddFunction("MapPointSeriesDataEventsUnselect.unselect", Unselect); }  
			if (Update != Update_DefaultValue) { h.Add("update",Update); Highmaps.AddFunction("MapPointSeriesDataEventsUpdate.update", Update); }  
