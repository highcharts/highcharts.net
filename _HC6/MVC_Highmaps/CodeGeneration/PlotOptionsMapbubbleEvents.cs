...
{
	public partial class PlotOptionsMapbubbleEvents  : BaseObject
	{
		public PlotOptionsMapbubbleEvents()
		{
		...
		internal override Hashtable ToHashtable()
		{
			...
			if (CheckboxClick != CheckboxClick_DefaultValue) { h.Add("checkboxClick",CheckboxClick); Highmaps.AddFunction("PlotOptionsMapbubbleEventsCheckboxClick.checkboxClick", CheckboxClick); }  
			if (Click != Click_DefaultValue) { h.Add("click",Click); Highmaps.AddFunction("PlotOptionsMapbubbleEventsClick.click", Click); }  
			if (Hide != Hide_DefaultValue) { h.Add("hide",Hide); Highmaps.AddFunction("PlotOptionsMapbubbleEventsHide.hide", Hide); }  
			if (LegendItemClick != LegendItemClick_DefaultValue) { h.Add("legendItemClick",LegendItemClick); Highmaps.AddFunction("PlotOptionsMapbubbleEventsLegendItemClick.legendItemClick", LegendItemClick); }  
			if (MouseOut != MouseOut_DefaultValue) { h.Add("mouseOut",MouseOut); Highmaps.AddFunction("PlotOptionsMapbubbleEventsMouseOut.mouseOut", MouseOut); }  
			if (MouseOver != MouseOver_DefaultValue) { h.Add("mouseOver",MouseOver); Highmaps.AddFunction("PlotOptionsMapbubbleEventsMouseOver.mouseOver", MouseOver); }  
			if (Show != Show_DefaultValue) { h.Add("show",Show); Highmaps.AddFunction("PlotOptionsMapbubbleEventsShow.show", Show); }  
