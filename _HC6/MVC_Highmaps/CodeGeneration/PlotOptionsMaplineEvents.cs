...
{
	public partial class PlotOptionsMaplineEvents  : BaseObject
	{
		public PlotOptionsMaplineEvents()
		{
		...
		internal override Hashtable ToHashtable()
		{
			...
			if (CheckboxClick != CheckboxClick_DefaultValue) { h.Add("checkboxClick",CheckboxClick); Highmaps.AddFunction("PlotOptionsMaplineEventsCheckboxClick.checkboxClick", CheckboxClick); }  
			if (Click != Click_DefaultValue) { h.Add("click",Click); Highmaps.AddFunction("PlotOptionsMaplineEventsClick.click", Click); }  
			if (Hide != Hide_DefaultValue) { h.Add("hide",Hide); Highmaps.AddFunction("PlotOptionsMaplineEventsHide.hide", Hide); }  
			if (LegendItemClick != LegendItemClick_DefaultValue) { h.Add("legendItemClick",LegendItemClick); Highmaps.AddFunction("PlotOptionsMaplineEventsLegendItemClick.legendItemClick", LegendItemClick); }  
			if (MouseOut != MouseOut_DefaultValue) { h.Add("mouseOut",MouseOut); Highmaps.AddFunction("PlotOptionsMaplineEventsMouseOut.mouseOut", MouseOut); }  
			if (MouseOver != MouseOver_DefaultValue) { h.Add("mouseOver",MouseOver); Highmaps.AddFunction("PlotOptionsMaplineEventsMouseOver.mouseOver", MouseOver); }  
			if (Show != Show_DefaultValue) { h.Add("show",Show); Highmaps.AddFunction("PlotOptionsMaplineEventsShow.show", Show); }  
