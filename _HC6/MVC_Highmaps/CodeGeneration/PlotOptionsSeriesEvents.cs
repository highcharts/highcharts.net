...
namespace Highsoft.Web.Mvc.Maps
{
	public partial class PlotOptionsSeriesEvents  : BaseObject
	{
		...
		internal override Hashtable ToHashtable()
		{
			...
			if (CheckboxClick != CheckboxClick_DefaultValue) { h.Add("checkboxClick",CheckboxClick); Highmaps.AddFunction("PlotOptionsSeriesEventsCheckboxClick.checkboxClick", CheckboxClick); }  
			if (Click != Click_DefaultValue) { h.Add("click",Click); Highmaps.AddFunction("PlotOptionsSeriesEventsClick.click", Click); }  
			if (Hide != Hide_DefaultValue) { h.Add("hide",Hide); Highmaps.AddFunction("PlotOptionsSeriesEventsHide.hide", Hide); }  
			if (LegendItemClick != LegendItemClick_DefaultValue) { h.Add("legendItemClick",LegendItemClick); Highmaps.AddFunction("PlotOptionsSeriesEventsLegendItemClick.legendItemClick", LegendItemClick); }  
			if (MouseOut != MouseOut_DefaultValue) { h.Add("mouseOut",MouseOut); Highmaps.AddFunction("PlotOptionsSeriesEventsMouseOut.mouseOut", MouseOut); }  
			if (MouseOver != MouseOver_DefaultValue) { h.Add("mouseOver",MouseOver); Highmaps.AddFunction("PlotOptionsSeriesEventsMouseOver.mouseOver", MouseOver); }  
			if (Show != Show_DefaultValue) { h.Add("show",Show); Highmaps.AddFunction("PlotOptionsSeriesEventsShow.show", Show); }  
