...
namespace Highsoft.Web.Mvc.Maps
{
	public partial class XAxis  : BaseObject
	{
		...
		internal override Hashtable ToHashtable()
		{
            ...
            if (Crosshair != Crosshair_DefaultValue) h.Add("crosshair", Crosshair.ToHashtable());// HashifyList(Crosshair));
			...
			if (TickPositioner != TickPositioner_DefaultValue) { h.Add("tickPositioner",TickPositioner); Highmaps.AddFunction("XAxisTickPositioner.tickPositioner", TickPositioner); }  
