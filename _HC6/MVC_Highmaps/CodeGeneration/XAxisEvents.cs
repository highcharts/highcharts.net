...
namespace Highsoft.Web.Mvc.Maps
{
	public partial class XAxisEvents  : BaseObject
	{
		...
		internal override Hashtable ToHashtable()
		{
			...
			if (AfterSetExtremes != AfterSetExtremes_DefaultValue) { h.Add("afterSetExtremes",AfterSetExtremes); Highmaps.AddFunction("XAxisEventsAfterSetExtremes.afterSetExtremes", AfterSetExtremes); }  
			if (SetExtremes != SetExtremes_DefaultValue) { h.Add("setExtremes",SetExtremes); Highmaps.AddFunction("XAxisEventsSetExtremes.setExtremes", SetExtremes); }  
