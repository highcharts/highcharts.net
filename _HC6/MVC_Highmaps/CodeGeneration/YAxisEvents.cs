...
namespace Highsoft.Web.Mvc.Maps
{
	public partial class YAxisEvents  : BaseObject
	{
		...
		internal override Hashtable ToHashtable()
		{
			...
			if (AfterSetExtremes != AfterSetExtremes_DefaultValue) { h.Add("afterSetExtremes",AfterSetExtremes); Highmaps.AddFunction("YAxisEventsAfterSetExtremes.afterSetExtremes", AfterSetExtremes); }  
			if (SetExtremes != SetExtremes_DefaultValue) { h.Add("setExtremes",SetExtremes); Highmaps.AddFunction("YAxisEventsSetExtremes.setExtremes", SetExtremes); }  
