...
namespace Highsoft.Web.Mvc.Stocks
{
	public partial class AdSeries  : Series
	{
		public AdSeries()
		{
			Ikh = Ikh_DefaultValue = new AdSeriesIkh();
			Id = Id_DefaultValue = null;
			Index = Index_DefaultValue = null;
			LegendIndex = LegendIndex_DefaultValue = null;
			Name = Name_DefaultValue = "Accumulation/Distribution";
			...
			PointIntervalUnit = PointIntervalUnit_DefaultValue = AdSeriesPointIntervalUnit.Null;
			PointPlacement = PointPlacement_DefaultValue = new PointPlacement();
			PointStart = PointStart_DefaultValue = 0;
			Stacking = Stacking_DefaultValue = AdSeriesStacking.Null;
		...
		/// </summary>
		public AdSeriesIkh Ikh { get; set; }
		private AdSeriesIkh Ikh_DefaultValue { get; set; }
		...
		/// </summary>
		public AdSeriesPointIntervalUnit PointIntervalUnit { get; set; }
		private AdSeriesPointIntervalUnit PointIntervalUnit_DefaultValue { get; set; }
		...
		/// </summary>
		public AdSeriesStacking Stacking { get; set; }
		private AdSeriesStacking Stacking_DefaultValue { get; set; }
