...
{
	public partial class AdSeriesData  : BaseObject
	{
		public AdSeriesData()
		{
			...
			DragDrop = DragDrop_DefaultValue = new AdSeriesDataDragDrop();
			Drilldown = Drilldown_DefaultValue = "";
			Events = Events_DefaultValue = new AdSeriesDataEvents();
			Id = Id_DefaultValue = "";
			Labelrank = Labelrank_DefaultValue = null;
			Marker = Marker_DefaultValue = new AdSeriesDataMarker();
		...
		/// </summary>
		public AdSeriesDataDragDrop DragDrop { get; set; }
		private AdSeriesDataDragDrop DragDrop_DefaultValue { get; set; }
		...
		/// </summary>
		public AdSeriesDataEvents Events { get; set; }
		private AdSeriesDataEvents Events_DefaultValue { get; set; }
		...
		/// 
		/// </summary>
		public AdSeriesDataMarker Marker { get; set; }
		private AdSeriesDataMarker Marker_DefaultValue { get; set; }
