...
{
	public partial class AdSeriesDataDragDrop  : BaseObject
	{
		public AdSeriesDataDragDrop()
		{
			DraggableX = DraggableX_DefaultValue = null;
			DraggableY = DraggableY_DefaultValue = null;
			DragHandle = DragHandle_DefaultValue = new AdSeriesDataDragDropDragHandle();
			...
			GuideBox = GuideBox_DefaultValue = new AdSeriesDataDragDropGuideBox();
		...
		/// </summary>
		public AdSeriesDataDragDropDragHandle DragHandle { get; set; }
		private AdSeriesDataDragDropDragHandle DragHandle_DefaultValue { get; set; }
		...
		/// </summary>
		public AdSeriesDataDragDropGuideBox GuideBox { get; set; }
		private AdSeriesDataDragDropGuideBox GuideBox_DefaultValue { get; set; }
