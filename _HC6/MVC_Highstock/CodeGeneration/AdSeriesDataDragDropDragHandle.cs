...
{
	public partial class AdSeriesDataDragDropDragHandle  : BaseObject
	{
		public AdSeriesDataDragDropDragHandle()
		{
		...
		internal override Hashtable ToHashtable()
		{
			...
			if (PathFormatter != PathFormatter_DefaultValue) { h.Add("pathFormatter",PathFormatter); Highstock.AddFunction("AdSeriesDataDragDropDragHandlePathFormatter.pathFormatter", PathFormatter); }  
