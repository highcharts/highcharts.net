...
namespace Highsoft.Web.Mvc.Stocks
{
	public partial class AdSeriesDataGrouping  : BaseObject
	{
		...
		{
			Approximation = Approximation_DefaultValue = AdSeriesDataGroupingApproximation.Average;
		...
		/// </summary>
		public AdSeriesDataGroupingApproximation Approximation { get; set; }
		private AdSeriesDataGroupingApproximation Approximation_DefaultValue { get; set; }
		...
		/// </summary>
		public AdSeriesDataGroupingUnits Units { get; set; }
		private AdSeriesDataGroupingUnits Units_DefaultValue { get; set; }
