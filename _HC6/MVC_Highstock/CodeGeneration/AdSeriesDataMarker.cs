...
{
	public partial class AdSeriesDataMarker  : BaseObject
	{
		public AdSeriesDataMarker()
		{
			...
			States = States_DefaultValue = new AdSeriesDataMarkerStates();
		...
		/// </summary>
		public AdSeriesDataMarkerStates States { get; set; }
		private AdSeriesDataMarkerStates States_DefaultValue { get; set; }
