...
{
	public partial class AdSeriesIkh  : BaseObject
	{
		public AdSeriesIkh()
		{
			Name = Name_DefaultValue = "SMA (14)";
			Tooltip = Tooltip_DefaultValue = new AdSeriesIkhTooltip();
			LinkedTo = LinkedTo_DefaultValue = null;
			Params = Params_DefaultValue = new AdSeriesIkhParams();
			Linecap = Linecap_DefaultValue = AdSeriesIkhLinecap.Round;
			BoostThreshold = BoostThreshold_DefaultValue = 5000;
			GapSize = GapSize_DefaultValue = 0;
			GapUnit = GapUnit_DefaultValue = AdSeriesIkhGapUnit.Relative;
			Label = Label_DefaultValue = new AdSeriesIkhLabel();
			DataGrouping = DataGrouping_DefaultValue = new AdSeriesIkhDataGrouping();
			LineWidth = LineWidth_DefaultValue = 2;
			AllowPointSelect = AllowPointSelect_DefaultValue = false;
			ShowCheckbox = ShowCheckbox_DefaultValue = false;
			Animation = Animation_DefaultValue = new Animation() { Enabled = true };
			Events = Events_DefaultValue = new AdSeriesIkhEvents();
			Marker = Marker_DefaultValue = new AdSeriesIkhMarker();
			Point = Point_DefaultValue = new AdSeriesIkhPoint();
			DataLabels = DataLabels_DefaultValue = new AdSeriesIkhDataLabels();
			CropThreshold = CropThreshold_DefaultValue = 300;
			SoftThreshold = SoftThreshold_DefaultValue = true;
			States = States_DefaultValue = new AdSeriesIkhStates();
			StickyTracking = StickyTracking_DefaultValue = null;
			TurboThreshold = TurboThreshold_DefaultValue = 1000;
			FindNearestPointBy = FindNearestPointBy_DefaultValue = AdSeriesIkhFindNearestPointBy.X;
			AnimationLimit = AnimationLimit_DefaultValue = null;
			ClassName = ClassName_DefaultValue = null;
			Color = Color_DefaultValue = null;
			ColorIndex = ColorIndex_DefaultValue = null;
			ConnectNulls = ConnectNulls_DefaultValue = false;
			Cursor = Cursor_DefaultValue = AdSeriesIkhCursor.Null;
			DashStyle = DashStyle_DefaultValue = AdSeriesIkhDashStyle.Solid;
			...
			Step = Step_DefaultValue = AdSeriesIkhStep.Null;
			Threshold = Threshold_DefaultValue = 0;
			Visible = Visible_DefaultValue = true;
			ZoneAxis = ZoneAxis_DefaultValue = "y";
			Zones = Zones_DefaultValue = new List<AdSeriesIkhZone>();
			...
			PointIntervalUnit = PointIntervalUnit_DefaultValue = AdSeriesIkhPointIntervalUnit.Null;
			PointPlacement = PointPlacement_DefaultValue = new PointPlacement();
			PointStart = PointStart_DefaultValue = 0;
			Stacking = Stacking_DefaultValue = AdSeriesIkhStacking.Null;
			Compare = Compare_DefaultValue = "undefined";
			CompareBase = CompareBase_DefaultValue = AdSeriesIkhCompareBase.Min;
		...
		/// </summary>
		public AdSeriesIkhTooltip Tooltip { get; set; }
		private AdSeriesIkhTooltip Tooltip_DefaultValue { get; set; }
		...
		/// 
		/// </summary>
		public AdSeriesIkhParams Params { get; set; }
		private AdSeriesIkhParams Params_DefaultValue { get; set; }
		...
		/// </summary>
		public AdSeriesIkhLinecap Linecap { get; set; }
		private AdSeriesIkhLinecap Linecap_DefaultValue { get; set; }
		...
		/// </summary>
		public AdSeriesIkhGapUnit GapUnit { get; set; }
		private AdSeriesIkhGapUnit GapUnit_DefaultValue { get; set; }
		...
		/// </summary>
		public AdSeriesIkhLabel Label { get; set; }
		private AdSeriesIkhLabel Label_DefaultValue { get; set; }
		...
		/// </summary>
		public AdSeriesIkhDataGrouping DataGrouping { get; set; }
		private AdSeriesIkhDataGrouping DataGrouping_DefaultValue { get; set; }
		...
		/// </summary>
		public AdSeriesIkhEvents Events { get; set; }
		private AdSeriesIkhEvents Events_DefaultValue { get; set; }
		...
		/// </summary>
		public AdSeriesIkhMarker Marker { get; set; }
		private AdSeriesIkhMarker Marker_DefaultValue { get; set; }
		 

		/// <summary>
		/// <p>Properties for each single point.</p>
		/// </summary>
		public AdSeriesIkhPoint Point { get; set; }
		private AdSeriesIkhPoint Point_DefaultValue { get; set; }
		...
		/// </summary>
		public AdSeriesIkhDataLabels DataLabels { get; set; }
		private AdSeriesIkhDataLabels DataLabels_DefaultValue { get; set; }
		...
		/// </summary>
		public AdSeriesIkhStates States { get; set; }
		private AdSeriesIkhStates States_DefaultValue { get; set; }
		...
		/// </summary>
		public AdSeriesIkhFindNearestPointBy FindNearestPointBy { get; set; }
		private AdSeriesIkhFindNearestPointBy FindNearestPointBy_DefaultValue { get; set; }
		...
		/// </summary>
		public AdSeriesIkhCursor Cursor { get; set; }
		private AdSeriesIkhCursor Cursor_DefaultValue { get; set; }
		...
		/// </summary>
		public AdSeriesIkhDashStyle DashStyle { get; set; }
		private AdSeriesIkhDashStyle DashStyle_DefaultValue { get; set; }
		...
		/// </summary>
		public AdSeriesIkhStep Step { get; set; }
		private AdSeriesIkhStep Step_DefaultValue { get; set; }
		...
		/// </summary>
		public List<AdSeriesIkhZone> Zones { get; set; }
		private List<AdSeriesIkhZone> Zones_DefaultValue { get; set; }
		...
		/// </summary>
		public AdSeriesIkhPointIntervalUnit PointIntervalUnit { get; set; }
		private AdSeriesIkhPointIntervalUnit PointIntervalUnit_DefaultValue { get; set; }
		...
		/// </summary>
		public AdSeriesIkhStacking Stacking { get; set; }
		private AdSeriesIkhStacking Stacking_DefaultValue { get; set; }
		...
		/// </summary>
		public AdSeriesIkhCompareBase CompareBase { get; set; }
		private AdSeriesIkhCompareBase CompareBase_DefaultValue { get; set; }
		...
		internal override Hashtable ToHashtable()
		{
			...
			if (PointDescriptionFormatter != PointDescriptionFormatter_DefaultValue) { h.Add("pointDescriptionFormatter",PointDescriptionFormatter); Highstock.AddFunction("AdSeriesIkhPointDescriptionFormatter.pointDescriptionFormatter", PointDescriptionFormatter); }  
