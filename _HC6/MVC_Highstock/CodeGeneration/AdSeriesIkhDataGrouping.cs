...
{
	public partial class AdSeriesIkhDataGrouping  : BaseObject
	{
		public AdSeriesIkhDataGrouping()
		{
			Approximation = Approximation_DefaultValue = AdSeriesIkhDataGroupingApproximation.Average;
		...
		/// </summary>
		public AdSeriesIkhDataGroupingApproximation Approximation { get; set; }
		private AdSeriesIkhDataGroupingApproximation Approximation_DefaultValue { get; set; }
