...
{
	public partial class AdSeriesIkhDataLabels  : BaseObject
	{
		public AdSeriesIkhDataLabels()
		{
			Align = Align_DefaultValue = AdSeriesIkhDataLabelsAlign.Center;
			Formatter = Formatter_DefaultValue = "";
			Style = Style_DefaultValue = new AdSeriesIkhDataLabelsStyle();
			VerticalAlign = VerticalAlign_DefaultValue = AdSeriesIkhDataLabelsVerticalAlign.Bottom;
			X = X_DefaultValue = 0;
			Y = Y_DefaultValue = -6;
			...
			Overflow = Overflow_DefaultValue = AdSeriesIkhDataLabelsOverflow.Justify;
		...
		/// </summary>
		public AdSeriesIkhDataLabelsAlign Align { get; set; }
		private AdSeriesIkhDataLabelsAlign Align_DefaultValue { get; set; }
		...
		/// </summary>
		public AdSeriesIkhDataLabelsStyle Style { get; set; }
		private AdSeriesIkhDataLabelsStyle Style_DefaultValue { get; set; }
		...
		/// </summary>
		public AdSeriesIkhDataLabelsVerticalAlign VerticalAlign { get; set; }
		private AdSeriesIkhDataLabelsVerticalAlign VerticalAlign_DefaultValue { get; set; }
		...
		/// </summary>
		public AdSeriesIkhDataLabelsOverflow Overflow { get; set; }
		private AdSeriesIkhDataLabelsOverflow Overflow_DefaultValue { get; set; }
		...
		internal override Hashtable ToHashtable()
		{
			...
			if (Formatter != Formatter_DefaultValue) { h.Add("formatter",Formatter); Highstock.AddFunction("AdSeriesIkhDataLabelsFormatter.formatter", Formatter); }  
