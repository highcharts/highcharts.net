...
{
	public partial class AdSeriesIkhMarker  : BaseObject
	{
		public AdSeriesIkhMarker()
		{
			LineWidth = LineWidth_DefaultValue = 0;
			LineColor = LineColor_DefaultValue = "#ffffff";
			Radius = Radius_DefaultValue = 4;
			States = States_DefaultValue = new AdSeriesIkhMarkerStates();
		...
		/// </summary>
		public AdSeriesIkhMarkerStates States { get; set; }
		private AdSeriesIkhMarkerStates States_DefaultValue { get; set; }
