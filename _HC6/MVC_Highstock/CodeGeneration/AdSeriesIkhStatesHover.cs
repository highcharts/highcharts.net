...
{
	public partial class AdSeriesIkhStatesHover  : BaseObject
	{
		public AdSeriesIkhStatesHover()
		{
			LineWidthPlus = LineWidthPlus_DefaultValue = 1;
			Marker = Marker_DefaultValue = new AdSeriesIkhStatesHoverMarker();
			Halo = Halo_DefaultValue = new AdSeriesIkhStatesHoverHalo();
		...
		/// </summary>
		public AdSeriesIkhStatesHoverMarker Marker { get; set; }
		private AdSeriesIkhStatesHoverMarker Marker_DefaultValue { get; set; }
		...
		/// </summary>
		public AdSeriesIkhStatesHoverHalo Halo { get; set; }
		private AdSeriesIkhStatesHoverHalo Halo_DefaultValue { get; set; }
