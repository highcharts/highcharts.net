...
{
	public partial class AdSeriesIkhTooltip  : BaseObject
	{
		public AdSeriesIkhTooltip()
		{
			ValueDecimals = ValueDecimals_DefaultValue = null;
			DateTimeLabelFormats = DateTimeLabelFormats_DefaultValue = new AdSeriesIkhTooltipDateTimeLabelFormats();
		...
		/// </summary>
		public AdSeriesIkhTooltipDateTimeLabelFormats DateTimeLabelFormats { get; set; }
		private AdSeriesIkhTooltipDateTimeLabelFormats DateTimeLabelFormats_DefaultValue { get; set; }
		...
		internal override Hashtable ToHashtable()
		{
			...
			if (PointFormatter != PointFormatter_DefaultValue) { h.Add("pointFormatter",PointFormatter); Highstock.AddFunction("AdSeriesIkhTooltipPointFormatter.pointFormatter", PointFormatter); }  
