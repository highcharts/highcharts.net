...
{
	public partial class AdSeriesStatesHoverMarker  : BaseObject
	{
		public AdSeriesStatesHoverMarker()
		{
			...
			States = States_DefaultValue = new AdSeriesStatesHoverMarkerStates();
		...
		/// </summary>
		public AdSeriesStatesHoverMarkerStates States { get; set; }
		private AdSeriesStatesHoverMarkerStates States_DefaultValue { get; set; }
