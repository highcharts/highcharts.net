...
namespace Highsoft.Web.Mvc.Stocks
{
	public partial class AdSeriesTooltip  : BaseObject
	{
		public AdSeriesTooltip()
		{
			...
			DateTimeLabelFormats = DateTimeLabelFormats_DefaultValue = new AdSeriesTooltipDateTimeLabelFormats();
		...
		/// </summary>
		public AdSeriesTooltipDateTimeLabelFormats DateTimeLabelFormats { get; set; }
		private AdSeriesTooltipDateTimeLabelFormats DateTimeLabelFormats_DefaultValue { get; set; }
