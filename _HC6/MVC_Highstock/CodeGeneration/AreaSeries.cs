...
namespace Highsoft.Web.Mvc.Stocks
{
	public partial class AreaSeries  : Series
	{
		public AreaSeries()
		{
			...
			Ikh = Ikh_DefaultValue = new AreaSeriesIkh();
		...
		/// </summary>
		public AreaSeriesIkh Ikh { get; set; }
		private AreaSeriesIkh Ikh_DefaultValue { get; set; }
