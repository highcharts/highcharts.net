...
{
	public partial class AreaSeriesIkhDataLabels  : BaseObject
	{
		public AreaSeriesIkhDataLabels()
		{
			Align = Align_DefaultValue = AreaSeriesIkhDataLabelsAlign.Center;
			Formatter = Formatter_DefaultValue = "";
			Style = Style_DefaultValue = new AreaSeriesIkhDataLabelsStyle();
			VerticalAlign = VerticalAlign_DefaultValue = AreaSeriesIkhDataLabelsVerticalAlign.Bottom;
			X = X_DefaultValue = 0;
			Y = Y_DefaultValue = -6;
			...
			Overflow = Overflow_DefaultValue = AreaSeriesIkhDataLabelsOverflow.Justify;
		...
		/// </summary>
		public AreaSeriesIkhDataLabelsAlign Align { get; set; }
		private AreaSeriesIkhDataLabelsAlign Align_DefaultValue { get; set; }
		...
		/// </summary>
		public AreaSeriesIkhDataLabelsStyle Style { get; set; }
		private AreaSeriesIkhDataLabelsStyle Style_DefaultValue { get; set; }
		...
		/// </summary>
		public AreaSeriesIkhDataLabelsVerticalAlign VerticalAlign { get; set; }
		private AreaSeriesIkhDataLabelsVerticalAlign VerticalAlign_DefaultValue { get; set; }
		...
		/// </summary>
		public AreaSeriesIkhDataLabelsOverflow Overflow { get; set; }
		private AreaSeriesIkhDataLabelsOverflow Overflow_DefaultValue { get; set; }
		...
		internal override Hashtable ToHashtable()
		{
			...
			if (Formatter != Formatter_DefaultValue) { h.Add("formatter",Formatter); Highstock.AddFunction("AreaSeriesIkhDataLabelsFormatter.formatter", Formatter); }  
