...
{
	public partial class AreaSeriesIkhLabel  : BaseObject
	{
		public AreaSeriesIkhLabel()
		{
			...
			Style = Style_DefaultValue = new AreaSeriesIkhLabelStyle();
		...
		/// </summary>
		public AreaSeriesIkhLabelStyle Style { get; set; }
		private AreaSeriesIkhLabelStyle Style_DefaultValue { get; set; }
