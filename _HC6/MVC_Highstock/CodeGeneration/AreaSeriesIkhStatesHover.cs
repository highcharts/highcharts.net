...
{
	public partial class AreaSeriesIkhStatesHover  : BaseObject
	{
		public AreaSeriesIkhStatesHover()
		{
			LineWidthPlus = LineWidthPlus_DefaultValue = 1;
			Marker = Marker_DefaultValue = new AreaSeriesIkhStatesHoverMarker();
			Halo = Halo_DefaultValue = new AreaSeriesIkhStatesHoverHalo();
		...
		/// </summary>
		public AreaSeriesIkhStatesHoverMarker Marker { get; set; }
		private AreaSeriesIkhStatesHoverMarker Marker_DefaultValue { get; set; }
		...
		/// </summary>
		public AreaSeriesIkhStatesHoverHalo Halo { get; set; }
		private AreaSeriesIkhStatesHoverHalo Halo_DefaultValue { get; set; }
