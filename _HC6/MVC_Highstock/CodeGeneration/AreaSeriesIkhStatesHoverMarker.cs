...
{
	public partial class AreaSeriesIkhStatesHoverMarker  : BaseObject
	{
		public AreaSeriesIkhStatesHoverMarker()
		{
			LineWidth = LineWidth_DefaultValue = 0;
			LineColor = LineColor_DefaultValue = "#ffffff";
			Radius = Radius_DefaultValue = 4;
			States = States_DefaultValue = new AreaSeriesIkhStatesHoverMarkerStates();
		...
		/// </summary>
		public AreaSeriesIkhStatesHoverMarkerStates States { get; set; }
		private AreaSeriesIkhStatesHoverMarkerStates States_DefaultValue { get; set; }
