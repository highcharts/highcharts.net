...
{
	public partial class AreaSeriesIkhTooltip  : BaseObject
	{
		public AreaSeriesIkhTooltip()
		{
			ValueDecimals = ValueDecimals_DefaultValue = null;
			DateTimeLabelFormats = DateTimeLabelFormats_DefaultValue = new AreaSeriesIkhTooltipDateTimeLabelFormats();
		...
		/// </summary>
		public AreaSeriesIkhTooltipDateTimeLabelFormats DateTimeLabelFormats { get; set; }
		private AreaSeriesIkhTooltipDateTimeLabelFormats DateTimeLabelFormats_DefaultValue { get; set; }
		...
		internal override Hashtable ToHashtable()
		{
			...
			if (PointFormatter != PointFormatter_DefaultValue) { h.Add("pointFormatter",PointFormatter); Highstock.AddFunction("AreaSeriesIkhTooltipPointFormatter.pointFormatter", PointFormatter); }  
