...
namespace Highsoft.Web.Mvc.Stocks
{
	public partial class ArearangeSeries  : Series
	{
		public ArearangeSeries()
		{
			...
			Ikh = Ikh_DefaultValue = new ArearangeSeriesIkh();
			...
			Zones = Zones_DefaultValue = new ArearangeSeriesZone();
		...
		/// </summary>
		public ArearangeSeriesIkh Ikh { get; set; }
		private ArearangeSeriesIkh Ikh_DefaultValue { get; set; }
		...
		/// </summary>
		public ArearangeSeriesZone Zones { get; set; }
		private ArearangeSeriesZone Zones_DefaultValue { get; set; }
