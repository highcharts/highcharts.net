...
namespace Highsoft.Web.Mvc.Stocks
{
	public partial class ArearangeSeries  : Series
	{
		public ArearangeSeries()
		{
			...
			NavigatorOptions = NavigatorOptions_DefaultValue = new ArearangeSeriesNavigatorOptions();
		...
		/// </summary>
		public ArearangeSeriesNavigatorOptions NavigatorOptions { get; set; }
		private ArearangeSeriesNavigatorOptions NavigatorOptions_DefaultValue { get; set; }
