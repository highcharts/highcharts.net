...
{
	public partial class ArearangeSeriesIkh  : BaseObject
	{
		public ArearangeSeriesIkh()
		{
			Name = Name_DefaultValue = "SMA (14)";
			Tooltip = Tooltip_DefaultValue = new ArearangeSeriesIkhTooltip();
			LinkedTo = LinkedTo_DefaultValue = null;
			Params = Params_DefaultValue = new ArearangeSeriesIkhParams();
			Linecap = Linecap_DefaultValue = ArearangeSeriesIkhLinecap.Round;
			BoostThreshold = BoostThreshold_DefaultValue = 5000;
			GapSize = GapSize_DefaultValue = 0;
			GapUnit = GapUnit_DefaultValue = ArearangeSeriesIkhGapUnit.Relative;
			Label = Label_DefaultValue = new ArearangeSeriesIkhLabel();
			DataGrouping = DataGrouping_DefaultValue = new ArearangeSeriesIkhDataGrouping();
			LineWidth = LineWidth_DefaultValue = 2;
			AllowPointSelect = AllowPointSelect_DefaultValue = false;
			ShowCheckbox = ShowCheckbox_DefaultValue = false;
			Animation = Animation_DefaultValue = new Animation() { Enabled = true };
			Events = Events_DefaultValue = new ArearangeSeriesIkhEvents();
			Marker = Marker_DefaultValue = new ArearangeSeriesIkhMarker();
			Point = Point_DefaultValue = new ArearangeSeriesIkhPoint();
			DataLabels = DataLabels_DefaultValue = new ArearangeSeriesIkhDataLabels();
			CropThreshold = CropThreshold_DefaultValue = 300;
			SoftThreshold = SoftThreshold_DefaultValue = true;
			States = States_DefaultValue = new ArearangeSeriesIkhStates();
			StickyTracking = StickyTracking_DefaultValue = null;
			TurboThreshold = TurboThreshold_DefaultValue = 1000;
			FindNearestPointBy = FindNearestPointBy_DefaultValue = ArearangeSeriesIkhFindNearestPointBy.X;
			AnimationLimit = AnimationLimit_DefaultValue = null;
			ClassName = ClassName_DefaultValue = null;
			Color = Color_DefaultValue = null;
			ColorIndex = ColorIndex_DefaultValue = null;
			ConnectNulls = ConnectNulls_DefaultValue = false;
			Cursor = Cursor_DefaultValue = ArearangeSeriesIkhCursor.Null;
			DashStyle = DashStyle_DefaultValue = ArearangeSeriesIkhDashStyle.Solid;
			...
			Step = Step_DefaultValue = ArearangeSeriesIkhStep.Null;
			Threshold = Threshold_DefaultValue = 0;
			Visible = Visible_DefaultValue = true;
			ZoneAxis = ZoneAxis_DefaultValue = "y";
			Zones = Zones_DefaultValue = new List<ArearangeSeriesIkhZone>();
			...
			PointIntervalUnit = PointIntervalUnit_DefaultValue = ArearangeSeriesIkhPointIntervalUnit.Null;
			PointPlacement = PointPlacement_DefaultValue = new PointPlacement();
			PointStart = PointStart_DefaultValue = 0;
			Stacking = Stacking_DefaultValue = ArearangeSeriesIkhStacking.Null;
			Compare = Compare_DefaultValue = "undefined";
			CompareBase = CompareBase_DefaultValue = ArearangeSeriesIkhCompareBase.Min;
		...
		/// </summary>
		public ArearangeSeriesIkhTooltip Tooltip { get; set; }
		private ArearangeSeriesIkhTooltip Tooltip_DefaultValue { get; set; }
		...
		/// 
		/// </summary>
		public ArearangeSeriesIkhParams Params { get; set; }
		private ArearangeSeriesIkhParams Params_DefaultValue { get; set; }
		...
		/// </summary>
		public ArearangeSeriesIkhLinecap Linecap { get; set; }
		private ArearangeSeriesIkhLinecap Linecap_DefaultValue { get; set; }
		...
		/// </summary>
		public ArearangeSeriesIkhGapUnit GapUnit { get; set; }
		private ArearangeSeriesIkhGapUnit GapUnit_DefaultValue { get; set; }
		...
		/// </summary>
		public ArearangeSeriesIkhLabel Label { get; set; }
		private ArearangeSeriesIkhLabel Label_DefaultValue { get; set; }
		...
		/// </summary>
		public ArearangeSeriesIkhDataGrouping DataGrouping { get; set; }
		private ArearangeSeriesIkhDataGrouping DataGrouping_DefaultValue { get; set; }
		...
		/// </summary>
		public ArearangeSeriesIkhEvents Events { get; set; }
		private ArearangeSeriesIkhEvents Events_DefaultValue { get; set; }
		...
		/// </summary>
		public ArearangeSeriesIkhMarker Marker { get; set; }
		private ArearangeSeriesIkhMarker Marker_DefaultValue { get; set; }
		 

		/// <summary>
		/// <p>Properties for each single point.</p>
		/// </summary>
		public ArearangeSeriesIkhPoint Point { get; set; }
		private ArearangeSeriesIkhPoint Point_DefaultValue { get; set; }
		...
		/// </summary>
		public ArearangeSeriesIkhDataLabels DataLabels { get; set; }
		private ArearangeSeriesIkhDataLabels DataLabels_DefaultValue { get; set; }
		...
		/// </summary>
		public ArearangeSeriesIkhStates States { get; set; }
		private ArearangeSeriesIkhStates States_DefaultValue { get; set; }
		...
		/// </summary>
		public ArearangeSeriesIkhFindNearestPointBy FindNearestPointBy { get; set; }
		private ArearangeSeriesIkhFindNearestPointBy FindNearestPointBy_DefaultValue { get; set; }
		...
		/// </summary>
		public ArearangeSeriesIkhCursor Cursor { get; set; }
		private ArearangeSeriesIkhCursor Cursor_DefaultValue { get; set; }
		...
		/// </summary>
		public ArearangeSeriesIkhDashStyle DashStyle { get; set; }
		private ArearangeSeriesIkhDashStyle DashStyle_DefaultValue { get; set; }
		...
		/// </summary>
		public ArearangeSeriesIkhStep Step { get; set; }
		private ArearangeSeriesIkhStep Step_DefaultValue { get; set; }
		...
		/// </summary>
		public List<ArearangeSeriesIkhZone> Zones { get; set; }
		private List<ArearangeSeriesIkhZone> Zones_DefaultValue { get; set; }
		...
		/// </summary>
		public ArearangeSeriesIkhPointIntervalUnit PointIntervalUnit { get; set; }
		private ArearangeSeriesIkhPointIntervalUnit PointIntervalUnit_DefaultValue { get; set; }
		...
		/// </summary>
		public ArearangeSeriesIkhStacking Stacking { get; set; }
		private ArearangeSeriesIkhStacking Stacking_DefaultValue { get; set; }
		...
		/// </summary>
		public ArearangeSeriesIkhCompareBase CompareBase { get; set; }
		private ArearangeSeriesIkhCompareBase CompareBase_DefaultValue { get; set; }
		...
		internal override Hashtable ToHashtable()
		{
			...
			if (PointDescriptionFormatter != PointDescriptionFormatter_DefaultValue) { h.Add("pointDescriptionFormatter",PointDescriptionFormatter); Highstock.AddFunction("ArearangeSeriesIkhPointDescriptionFormatter.pointDescriptionFormatter", PointDescriptionFormatter); }  
