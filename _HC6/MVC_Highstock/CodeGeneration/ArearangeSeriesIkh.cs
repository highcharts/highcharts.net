...
namespace Highsoft.Web.Mvc.Stocks
{
	public partial class ArearangeSeriesIkh  : BaseObject
	{
		public ArearangeSeriesIkh()
		{
			...
			Zones = Zones_DefaultValue = new ArearangeSeriesIkhZone();
		...
		/// </summary>
		public ArearangeSeriesIkhZone Zones { get; set; }
		private ArearangeSeriesIkhZone Zones_DefaultValue { get; set; }
