...
{
	public partial class ArearangeSeriesIkhDataGrouping  : BaseObject
	{
		public ArearangeSeriesIkhDataGrouping()
		{
			Approximation = Approximation_DefaultValue = ArearangeSeriesIkhDataGroupingApproximation.Average;
		...
		/// </summary>
		public ArearangeSeriesIkhDataGroupingApproximation Approximation { get; set; }
		private ArearangeSeriesIkhDataGroupingApproximation Approximation_DefaultValue { get; set; }
