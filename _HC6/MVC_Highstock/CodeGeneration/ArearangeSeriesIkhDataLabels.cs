...
{
	public partial class ArearangeSeriesIkhDataLabels  : BaseObject
	{
		public ArearangeSeriesIkhDataLabels()
		{
			Align = Align_DefaultValue = ArearangeSeriesIkhDataLabelsAlign.Center;
			Formatter = Formatter_DefaultValue = "";
			Style = Style_DefaultValue = new ArearangeSeriesIkhDataLabelsStyle();
			VerticalAlign = VerticalAlign_DefaultValue = ArearangeSeriesIkhDataLabelsVerticalAlign.Bottom;
			X = X_DefaultValue = 0;
			Y = Y_DefaultValue = -6;
			...
			Overflow = Overflow_DefaultValue = ArearangeSeriesIkhDataLabelsOverflow.Justify;
		...
		/// </summary>
		public ArearangeSeriesIkhDataLabelsAlign Align { get; set; }
		private ArearangeSeriesIkhDataLabelsAlign Align_DefaultValue { get; set; }
		...
		/// </summary>
		public ArearangeSeriesIkhDataLabelsStyle Style { get; set; }
		private ArearangeSeriesIkhDataLabelsStyle Style_DefaultValue { get; set; }
		...
		/// </summary>
		public ArearangeSeriesIkhDataLabelsVerticalAlign VerticalAlign { get; set; }
		private ArearangeSeriesIkhDataLabelsVerticalAlign VerticalAlign_DefaultValue { get; set; }
		...
		/// </summary>
		public ArearangeSeriesIkhDataLabelsOverflow Overflow { get; set; }
		private ArearangeSeriesIkhDataLabelsOverflow Overflow_DefaultValue { get; set; }
		...
		internal override Hashtable ToHashtable()
		{
			...
			if (Formatter != Formatter_DefaultValue) { h.Add("formatter",Formatter); Highstock.AddFunction("ArearangeSeriesIkhDataLabelsFormatter.formatter", Formatter); }  
