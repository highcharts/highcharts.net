...
{
	public partial class ArearangeSeriesIkhEvents  : BaseObject
	{
		public ArearangeSeriesIkhEvents()
		{
		...
		internal override Hashtable ToHashtable()
		{
			...
			if (AfterAnimate != AfterAnimate_DefaultValue) { h.Add("afterAnimate",AfterAnimate); Highstock.AddFunction("ArearangeSeriesIkhEventsAfterAnimate.afterAnimate", AfterAnimate); }  
			if (CheckboxClick != CheckboxClick_DefaultValue) { h.Add("checkboxClick",CheckboxClick); Highstock.AddFunction("ArearangeSeriesIkhEventsCheckboxClick.checkboxClick", CheckboxClick); }  
			if (Click != Click_DefaultValue) { h.Add("click",Click); Highstock.AddFunction("ArearangeSeriesIkhEventsClick.click", Click); }  
			if (Hide != Hide_DefaultValue) { h.Add("hide",Hide); Highstock.AddFunction("ArearangeSeriesIkhEventsHide.hide", Hide); }  
			if (LegendItemClick != LegendItemClick_DefaultValue) { h.Add("legendItemClick",LegendItemClick); Highstock.AddFunction("ArearangeSeriesIkhEventsLegendItemClick.legendItemClick", LegendItemClick); }  
			if (MouseOut != MouseOut_DefaultValue) { h.Add("mouseOut",MouseOut); Highstock.AddFunction("ArearangeSeriesIkhEventsMouseOut.mouseOut", MouseOut); }  
			if (MouseOver != MouseOver_DefaultValue) { h.Add("mouseOver",MouseOver); Highstock.AddFunction("ArearangeSeriesIkhEventsMouseOver.mouseOver", MouseOver); }  
			if (Show != Show_DefaultValue) { h.Add("show",Show); Highstock.AddFunction("ArearangeSeriesIkhEventsShow.show", Show); }  
