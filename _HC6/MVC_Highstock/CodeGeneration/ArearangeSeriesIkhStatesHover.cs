...
{
	public partial class ArearangeSeriesIkhStatesHover  : BaseObject
	{
		public ArearangeSeriesIkhStatesHover()
		{
			LineWidthPlus = LineWidthPlus_DefaultValue = 1;
			Marker = Marker_DefaultValue = new ArearangeSeriesIkhStatesHoverMarker();
			Halo = Halo_DefaultValue = new ArearangeSeriesIkhStatesHoverHalo();
		...
		/// </summary>
		public ArearangeSeriesIkhStatesHoverMarker Marker { get; set; }
		private ArearangeSeriesIkhStatesHoverMarker Marker_DefaultValue { get; set; }
		...
		/// </summary>
		public ArearangeSeriesIkhStatesHoverHalo Halo { get; set; }
		private ArearangeSeriesIkhStatesHoverHalo Halo_DefaultValue { get; set; }
