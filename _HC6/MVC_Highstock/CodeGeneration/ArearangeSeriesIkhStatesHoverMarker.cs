...
{
	public partial class ArearangeSeriesIkhStatesHoverMarker  : BaseObject
	{
		public ArearangeSeriesIkhStatesHoverMarker()
		{
			LineWidth = LineWidth_DefaultValue = 0;
			LineColor = LineColor_DefaultValue = "#ffffff";
			Radius = Radius_DefaultValue = 4;
			States = States_DefaultValue = new ArearangeSeriesIkhStatesHoverMarkerStates();
		...
		/// </summary>
		public ArearangeSeriesIkhStatesHoverMarkerStates States { get; set; }
		private ArearangeSeriesIkhStatesHoverMarkerStates States_DefaultValue { get; set; }
