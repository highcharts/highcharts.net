...
{
	public partial class ArearangeSeriesIkhTooltip  : BaseObject
	{
		public ArearangeSeriesIkhTooltip()
		{
			ValueDecimals = ValueDecimals_DefaultValue = null;
			DateTimeLabelFormats = DateTimeLabelFormats_DefaultValue = new ArearangeSeriesIkhTooltipDateTimeLabelFormats();
		...
		/// </summary>
		public ArearangeSeriesIkhTooltipDateTimeLabelFormats DateTimeLabelFormats { get; set; }
		private ArearangeSeriesIkhTooltipDateTimeLabelFormats DateTimeLabelFormats_DefaultValue { get; set; }
		...
		internal override Hashtable ToHashtable()
		{
			...
			if (PointFormatter != PointFormatter_DefaultValue) { h.Add("pointFormatter",PointFormatter); Highstock.AddFunction("ArearangeSeriesIkhTooltipPointFormatter.pointFormatter", PointFormatter); }  
