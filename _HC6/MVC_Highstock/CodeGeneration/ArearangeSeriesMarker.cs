...
{
	public partial class ArearangeSeriesMarker  : BaseObject
	{
		public ArearangeSeriesMarker()
		{
			...
			States = States_DefaultValue = new ArearangeSeriesMarkerStates();
		...
		/// </summary>
		public ArearangeSeriesMarkerStates States { get; set; }
		private ArearangeSeriesMarkerStates States_DefaultValue { get; set; }
