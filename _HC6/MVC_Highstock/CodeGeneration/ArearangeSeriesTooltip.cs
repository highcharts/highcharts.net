...
namespace Highsoft.Web.Mvc.Stocks
{
	public partial class ArearangeSeriesTooltip  : BaseObject
	{
		public ArearangeSeriesTooltip()
		{
			...
			DateTimeLabelFormats = DateTimeLabelFormats_DefaultValue = new ArearangeSeriesTooltipDateTimeLabelFormats();
		...
		/// </summary>
		public ArearangeSeriesTooltipDateTimeLabelFormats DateTimeLabelFormats { get; set; }
		private ArearangeSeriesTooltipDateTimeLabelFormats DateTimeLabelFormats_DefaultValue { get; set; }
