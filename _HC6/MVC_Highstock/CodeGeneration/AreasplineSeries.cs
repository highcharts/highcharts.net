...
namespace Highsoft.Web.Mvc.Stocks
{
	public partial class AreasplineSeries  : Series
	{
		public AreasplineSeries()
		{
			...
			Ikh = Ikh_DefaultValue = new AreasplineSeriesIkh();
		...
		/// </summary>
		public AreasplineSeriesIkh Ikh { get; set; }
		private AreasplineSeriesIkh Ikh_DefaultValue { get; set; }
