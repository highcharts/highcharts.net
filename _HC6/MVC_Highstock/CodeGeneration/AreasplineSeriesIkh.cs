...
{
	public partial class AreasplineSeriesIkh  : BaseObject
	{
		public AreasplineSeriesIkh()
		{
			Name = Name_DefaultValue = "SMA (14)";
			Tooltip = Tooltip_DefaultValue = new AreasplineSeriesIkhTooltip();
			LinkedTo = LinkedTo_DefaultValue = null;
			Params = Params_DefaultValue = new AreasplineSeriesIkhParams();
			Linecap = Linecap_DefaultValue = AreasplineSeriesIkhLinecap.Round;
			BoostThreshold = BoostThreshold_DefaultValue = 5000;
			GapSize = GapSize_DefaultValue = 0;
			GapUnit = GapUnit_DefaultValue = AreasplineSeriesIkhGapUnit.Relative;
			Label = Label_DefaultValue = new AreasplineSeriesIkhLabel();
			DataGrouping = DataGrouping_DefaultValue = new AreasplineSeriesIkhDataGrouping();
			LineWidth = LineWidth_DefaultValue = 2;
			AllowPointSelect = AllowPointSelect_DefaultValue = false;
			ShowCheckbox = ShowCheckbox_DefaultValue = false;
			Animation = Animation_DefaultValue = new Animation() { Enabled = true };
			Events = Events_DefaultValue = new AreasplineSeriesIkhEvents();
			Marker = Marker_DefaultValue = new AreasplineSeriesIkhMarker();
			Point = Point_DefaultValue = new AreasplineSeriesIkhPoint();
			DataLabels = DataLabels_DefaultValue = new AreasplineSeriesIkhDataLabels();
			CropThreshold = CropThreshold_DefaultValue = 300;
			SoftThreshold = SoftThreshold_DefaultValue = true;
			States = States_DefaultValue = new AreasplineSeriesIkhStates();
			StickyTracking = StickyTracking_DefaultValue = null;
			TurboThreshold = TurboThreshold_DefaultValue = 1000;
			FindNearestPointBy = FindNearestPointBy_DefaultValue = AreasplineSeriesIkhFindNearestPointBy.X;
			AnimationLimit = AnimationLimit_DefaultValue = null;
			ClassName = ClassName_DefaultValue = null;
			Color = Color_DefaultValue = null;
			ColorIndex = ColorIndex_DefaultValue = null;
			ConnectNulls = ConnectNulls_DefaultValue = false;
			Cursor = Cursor_DefaultValue = AreasplineSeriesIkhCursor.Null;
			DashStyle = DashStyle_DefaultValue = AreasplineSeriesIkhDashStyle.Solid;
			...
			Step = Step_DefaultValue = AreasplineSeriesIkhStep.Null;
			Threshold = Threshold_DefaultValue = 0;
			Visible = Visible_DefaultValue = true;
			ZoneAxis = ZoneAxis_DefaultValue = "y";
			Zones = Zones_DefaultValue = new List<AreasplineSeriesIkhZone>();
			...
			PointIntervalUnit = PointIntervalUnit_DefaultValue = AreasplineSeriesIkhPointIntervalUnit.Null;
			PointPlacement = PointPlacement_DefaultValue = new PointPlacement();
			PointStart = PointStart_DefaultValue = 0;
			Stacking = Stacking_DefaultValue = AreasplineSeriesIkhStacking.Null;
			Compare = Compare_DefaultValue = "undefined";
			CompareBase = CompareBase_DefaultValue = AreasplineSeriesIkhCompareBase.Min;
		...
		/// </summary>
		public AreasplineSeriesIkhTooltip Tooltip { get; set; }
		private AreasplineSeriesIkhTooltip Tooltip_DefaultValue { get; set; }
		...
		/// 
		/// </summary>
		public AreasplineSeriesIkhParams Params { get; set; }
		private AreasplineSeriesIkhParams Params_DefaultValue { get; set; }
		...
		/// </summary>
		public AreasplineSeriesIkhLinecap Linecap { get; set; }
		private AreasplineSeriesIkhLinecap Linecap_DefaultValue { get; set; }
		...
		/// </summary>
		public AreasplineSeriesIkhGapUnit GapUnit { get; set; }
		private AreasplineSeriesIkhGapUnit GapUnit_DefaultValue { get; set; }
		...
		/// </summary>
		public AreasplineSeriesIkhLabel Label { get; set; }
		private AreasplineSeriesIkhLabel Label_DefaultValue { get; set; }
		...
		/// </summary>
		public AreasplineSeriesIkhDataGrouping DataGrouping { get; set; }
		private AreasplineSeriesIkhDataGrouping DataGrouping_DefaultValue { get; set; }
		...
		/// </summary>
		public AreasplineSeriesIkhEvents Events { get; set; }
		private AreasplineSeriesIkhEvents Events_DefaultValue { get; set; }
		...
		/// </summary>
		public AreasplineSeriesIkhMarker Marker { get; set; }
		private AreasplineSeriesIkhMarker Marker_DefaultValue { get; set; }
		 

		/// <summary>
		/// <p>Properties for each single point.</p>
		/// </summary>
		public AreasplineSeriesIkhPoint Point { get; set; }
		private AreasplineSeriesIkhPoint Point_DefaultValue { get; set; }
		...
		/// </summary>
		public AreasplineSeriesIkhDataLabels DataLabels { get; set; }
		private AreasplineSeriesIkhDataLabels DataLabels_DefaultValue { get; set; }
		...
		/// </summary>
		public AreasplineSeriesIkhStates States { get; set; }
		private AreasplineSeriesIkhStates States_DefaultValue { get; set; }
		...
		/// </summary>
		public AreasplineSeriesIkhFindNearestPointBy FindNearestPointBy { get; set; }
		private AreasplineSeriesIkhFindNearestPointBy FindNearestPointBy_DefaultValue { get; set; }
		...
		/// </summary>
		public AreasplineSeriesIkhCursor Cursor { get; set; }
		private AreasplineSeriesIkhCursor Cursor_DefaultValue { get; set; }
		...
		/// </summary>
		public AreasplineSeriesIkhDashStyle DashStyle { get; set; }
		private AreasplineSeriesIkhDashStyle DashStyle_DefaultValue { get; set; }
		...
		/// </summary>
		public AreasplineSeriesIkhStep Step { get; set; }
		private AreasplineSeriesIkhStep Step_DefaultValue { get; set; }
		...
		/// </summary>
		public List<AreasplineSeriesIkhZone> Zones { get; set; }
		private List<AreasplineSeriesIkhZone> Zones_DefaultValue { get; set; }
		...
		/// </summary>
		public AreasplineSeriesIkhPointIntervalUnit PointIntervalUnit { get; set; }
		private AreasplineSeriesIkhPointIntervalUnit PointIntervalUnit_DefaultValue { get; set; }
		...
		/// </summary>
		public AreasplineSeriesIkhStacking Stacking { get; set; }
		private AreasplineSeriesIkhStacking Stacking_DefaultValue { get; set; }
		...
		/// </summary>
		public AreasplineSeriesIkhCompareBase CompareBase { get; set; }
		private AreasplineSeriesIkhCompareBase CompareBase_DefaultValue { get; set; }
		...
		internal override Hashtable ToHashtable()
		{
			...
			if (PointDescriptionFormatter != PointDescriptionFormatter_DefaultValue) { h.Add("pointDescriptionFormatter",PointDescriptionFormatter); Highstock.AddFunction("AreasplineSeriesIkhPointDescriptionFormatter.pointDescriptionFormatter", PointDescriptionFormatter); }  
