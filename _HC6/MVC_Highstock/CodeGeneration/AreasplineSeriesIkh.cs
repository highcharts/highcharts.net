...
namespace Highsoft.Web.Mvc.Stocks
{
	public partial class AreasplineSeriesIkh  : BaseObject
	{
		public AreasplineSeriesIkh()
		{
			...
			Zones = Zones_DefaultValue = new AreasplineSeriesIkhZone();
		...
		/// </summary>
		public AreasplineSeriesIkhZone Zones { get; set; }
		private AreasplineSeriesIkhZone Zones_DefaultValue { get; set; }
