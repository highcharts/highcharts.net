...
{
	public partial class AreasplineSeriesIkhDataGrouping  : BaseObject
	{
		public AreasplineSeriesIkhDataGrouping()
		{
			Approximation = Approximation_DefaultValue = AreasplineSeriesIkhDataGroupingApproximation.Average;
		...
		/// </summary>
		public AreasplineSeriesIkhDataGroupingApproximation Approximation { get; set; }
		private AreasplineSeriesIkhDataGroupingApproximation Approximation_DefaultValue { get; set; }
