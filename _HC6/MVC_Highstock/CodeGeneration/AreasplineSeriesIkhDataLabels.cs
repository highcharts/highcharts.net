...
{
	public partial class AreasplineSeriesIkhDataLabels  : BaseObject
	{
		public AreasplineSeriesIkhDataLabels()
		{
			Align = Align_DefaultValue = AreasplineSeriesIkhDataLabelsAlign.Center;
			Formatter = Formatter_DefaultValue = "";
			Style = Style_DefaultValue = new AreasplineSeriesIkhDataLabelsStyle();
			VerticalAlign = VerticalAlign_DefaultValue = AreasplineSeriesIkhDataLabelsVerticalAlign.Bottom;
			X = X_DefaultValue = 0;
			Y = Y_DefaultValue = -6;
			...
			Overflow = Overflow_DefaultValue = AreasplineSeriesIkhDataLabelsOverflow.Justify;
		...
		/// </summary>
		public AreasplineSeriesIkhDataLabelsAlign Align { get; set; }
		private AreasplineSeriesIkhDataLabelsAlign Align_DefaultValue { get; set; }
		...
		/// </summary>
		public AreasplineSeriesIkhDataLabelsStyle Style { get; set; }
		private AreasplineSeriesIkhDataLabelsStyle Style_DefaultValue { get; set; }
		...
		/// </summary>
		public AreasplineSeriesIkhDataLabelsVerticalAlign VerticalAlign { get; set; }
		private AreasplineSeriesIkhDataLabelsVerticalAlign VerticalAlign_DefaultValue { get; set; }
		...
		/// </summary>
		public AreasplineSeriesIkhDataLabelsOverflow Overflow { get; set; }
		private AreasplineSeriesIkhDataLabelsOverflow Overflow_DefaultValue { get; set; }
		...
		internal override Hashtable ToHashtable()
		{
			...
			if (Formatter != Formatter_DefaultValue) { h.Add("formatter",Formatter); Highstock.AddFunction("AreasplineSeriesIkhDataLabelsFormatter.formatter", Formatter); }  
