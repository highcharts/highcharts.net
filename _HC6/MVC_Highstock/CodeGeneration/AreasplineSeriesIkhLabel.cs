...
{
	public partial class AreasplineSeriesIkhLabel  : BaseObject
	{
		public AreasplineSeriesIkhLabel()
		{
			...
			Style = Style_DefaultValue = new AreasplineSeriesIkhLabelStyle();
		...
		/// </summary>
		public AreasplineSeriesIkhLabelStyle Style { get; set; }
		private AreasplineSeriesIkhLabelStyle Style_DefaultValue { get; set; }
