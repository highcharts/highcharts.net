...
{
	public partial class AreasplineSeriesIkhMarker  : BaseObject
	{
		public AreasplineSeriesIkhMarker()
		{
			LineWidth = LineWidth_DefaultValue = 0;
			LineColor = LineColor_DefaultValue = "#ffffff";
			Radius = Radius_DefaultValue = 4;
			States = States_DefaultValue = new AreasplineSeriesIkhMarkerStates();
		...
		/// </summary>
		public AreasplineSeriesIkhMarkerStates States { get; set; }
		private AreasplineSeriesIkhMarkerStates States_DefaultValue { get; set; }
