...
{
	public partial class AreasplineSeriesIkhStatesHover  : BaseObject
	{
		public AreasplineSeriesIkhStatesHover()
		{
			LineWidthPlus = LineWidthPlus_DefaultValue = 1;
			Marker = Marker_DefaultValue = new AreasplineSeriesIkhStatesHoverMarker();
			Halo = Halo_DefaultValue = new AreasplineSeriesIkhStatesHoverHalo();
		...
		/// </summary>
		public AreasplineSeriesIkhStatesHoverMarker Marker { get; set; }
		private AreasplineSeriesIkhStatesHoverMarker Marker_DefaultValue { get; set; }
		...
		/// </summary>
		public AreasplineSeriesIkhStatesHoverHalo Halo { get; set; }
		private AreasplineSeriesIkhStatesHoverHalo Halo_DefaultValue { get; set; }
