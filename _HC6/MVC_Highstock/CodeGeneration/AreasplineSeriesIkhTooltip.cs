...
{
	public partial class AreasplineSeriesIkhTooltip  : BaseObject
	{
		public AreasplineSeriesIkhTooltip()
		{
			ValueDecimals = ValueDecimals_DefaultValue = null;
			DateTimeLabelFormats = DateTimeLabelFormats_DefaultValue = new AreasplineSeriesIkhTooltipDateTimeLabelFormats();
		...
		/// </summary>
		public AreasplineSeriesIkhTooltipDateTimeLabelFormats DateTimeLabelFormats { get; set; }
		private AreasplineSeriesIkhTooltipDateTimeLabelFormats DateTimeLabelFormats_DefaultValue { get; set; }
		...
		internal override Hashtable ToHashtable()
		{
			...
			if (PointFormatter != PointFormatter_DefaultValue) { h.Add("pointFormatter",PointFormatter); Highstock.AddFunction("AreasplineSeriesIkhTooltipPointFormatter.pointFormatter", PointFormatter); }  
