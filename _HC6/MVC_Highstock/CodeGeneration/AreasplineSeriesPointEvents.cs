...
namespace Highsoft.Web.Mvc.Stocks
{
	public partial class AreasplineSeriesPointEvents  : BaseObject
	{
		...
		internal override Hashtable ToHashtable()
		{
			...
			if (Drag != Drag_DefaultValue) { h.Add("drag",Drag); Highstock.AddFunction("AreasplineSeriesPointEventsDrag.drag", Drag); }  
			if (DragStart != DragStart_DefaultValue) { h.Add("dragStart",DragStart); Highstock.AddFunction("AreasplineSeriesPointEventsDragStart.dragStart", DragStart); }  
			if (Drop != Drop_DefaultValue) { h.Add("drop",Drop); Highstock.AddFunction("AreasplineSeriesPointEventsDrop.drop", Drop); }  
