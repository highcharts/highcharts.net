...
namespace Highsoft.Web.Mvc.Stocks
{
	public partial class AreasplinerangeSeries  : Series
	{
		public AreasplinerangeSeries()
		{
			...
			Ikh = Ikh_DefaultValue = new AreasplinerangeSeriesIkh();
		...
		/// </summary>
		public AreasplinerangeSeriesIkh Ikh { get; set; }
		private AreasplinerangeSeriesIkh Ikh_DefaultValue { get; set; }
