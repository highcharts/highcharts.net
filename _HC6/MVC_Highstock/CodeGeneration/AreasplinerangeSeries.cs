...
namespace Highsoft.Web.Mvc.Stocks
{
	public partial class AreasplinerangeSeries  : Series
	{
		...
		{
			Data = Data_DefaultValue = new List<AreasplinerangeSeries>();
			Id = Id_DefaultValue = "";
		...
		/// </summary>
		public List<AreasplinerangeSeries> Data { get; set; }
		private List<AreasplinerangeSeries> Data_DefaultValue { get; set; }
