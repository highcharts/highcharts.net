...
namespace Highsoft.Web.Mvc.Stocks
{
	public partial class AreasplinerangeSeriesIkh  : BaseObject
	{
		public AreasplinerangeSeriesIkh()
		{
			...
			Zones = Zones_DefaultValue = new AreasplinerangeSeriesIkhZone();
		...
		/// </summary>
		public AreasplinerangeSeriesIkhZone Zones { get; set; }
		private AreasplinerangeSeriesIkhZone Zones_DefaultValue { get; set; }
