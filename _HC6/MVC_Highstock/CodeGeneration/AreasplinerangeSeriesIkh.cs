...
{
	public partial class AreasplinerangeSeriesIkh  : BaseObject
	{
		public AreasplinerangeSeriesIkh()
		{
			Name = Name_DefaultValue = "SMA (14)";
			Tooltip = Tooltip_DefaultValue = new AreasplinerangeSeriesIkhTooltip();
			LinkedTo = LinkedTo_DefaultValue = null;
			Params = Params_DefaultValue = new AreasplinerangeSeriesIkhParams();
			Linecap = Linecap_DefaultValue = AreasplinerangeSeriesIkhLinecap.Round;
			BoostThreshold = BoostThreshold_DefaultValue = 5000;
			GapSize = GapSize_DefaultValue = 0;
			GapUnit = GapUnit_DefaultValue = AreasplinerangeSeriesIkhGapUnit.Relative;
			Label = Label_DefaultValue = new AreasplinerangeSeriesIkhLabel();
			DataGrouping = DataGrouping_DefaultValue = new AreasplinerangeSeriesIkhDataGrouping();
			LineWidth = LineWidth_DefaultValue = 2;
			AllowPointSelect = AllowPointSelect_DefaultValue = false;
			ShowCheckbox = ShowCheckbox_DefaultValue = false;
			Animation = Animation_DefaultValue = new Animation() { Enabled = true };
			Events = Events_DefaultValue = new AreasplinerangeSeriesIkhEvents();
			Marker = Marker_DefaultValue = new AreasplinerangeSeriesIkhMarker();
			Point = Point_DefaultValue = new AreasplinerangeSeriesIkhPoint();
			DataLabels = DataLabels_DefaultValue = new AreasplinerangeSeriesIkhDataLabels();
			CropThreshold = CropThreshold_DefaultValue = 300;
			SoftThreshold = SoftThreshold_DefaultValue = true;
			States = States_DefaultValue = new AreasplinerangeSeriesIkhStates();
			StickyTracking = StickyTracking_DefaultValue = null;
			TurboThreshold = TurboThreshold_DefaultValue = 1000;
			FindNearestPointBy = FindNearestPointBy_DefaultValue = AreasplinerangeSeriesIkhFindNearestPointBy.X;
			AnimationLimit = AnimationLimit_DefaultValue = null;
			ClassName = ClassName_DefaultValue = null;
			Color = Color_DefaultValue = null;
			ColorIndex = ColorIndex_DefaultValue = null;
			ConnectNulls = ConnectNulls_DefaultValue = false;
			Cursor = Cursor_DefaultValue = AreasplinerangeSeriesIkhCursor.Null;
			DashStyle = DashStyle_DefaultValue = AreasplinerangeSeriesIkhDashStyle.Solid;
			...
			Step = Step_DefaultValue = AreasplinerangeSeriesIkhStep.Null;
			Threshold = Threshold_DefaultValue = 0;
			Visible = Visible_DefaultValue = true;
			ZoneAxis = ZoneAxis_DefaultValue = "y";
			Zones = Zones_DefaultValue = new List<AreasplinerangeSeriesIkhZone>();
			...
			PointIntervalUnit = PointIntervalUnit_DefaultValue = AreasplinerangeSeriesIkhPointIntervalUnit.Null;
			PointPlacement = PointPlacement_DefaultValue = new PointPlacement();
			PointStart = PointStart_DefaultValue = 0;
			Stacking = Stacking_DefaultValue = AreasplinerangeSeriesIkhStacking.Null;
			Compare = Compare_DefaultValue = "undefined";
			CompareBase = CompareBase_DefaultValue = AreasplinerangeSeriesIkhCompareBase.Min;
		...
		/// </summary>
		public AreasplinerangeSeriesIkhTooltip Tooltip { get; set; }
		private AreasplinerangeSeriesIkhTooltip Tooltip_DefaultValue { get; set; }
		...
		/// 
		/// </summary>
		public AreasplinerangeSeriesIkhParams Params { get; set; }
		private AreasplinerangeSeriesIkhParams Params_DefaultValue { get; set; }
		...
		/// </summary>
		public AreasplinerangeSeriesIkhLinecap Linecap { get; set; }
		private AreasplinerangeSeriesIkhLinecap Linecap_DefaultValue { get; set; }
		...
		/// </summary>
		public AreasplinerangeSeriesIkhGapUnit GapUnit { get; set; }
		private AreasplinerangeSeriesIkhGapUnit GapUnit_DefaultValue { get; set; }
		...
		/// </summary>
		public AreasplinerangeSeriesIkhLabel Label { get; set; }
		private AreasplinerangeSeriesIkhLabel Label_DefaultValue { get; set; }
		...
		/// </summary>
		public AreasplinerangeSeriesIkhDataGrouping DataGrouping { get; set; }
		private AreasplinerangeSeriesIkhDataGrouping DataGrouping_DefaultValue { get; set; }
		...
		/// </summary>
		public AreasplinerangeSeriesIkhEvents Events { get; set; }
		private AreasplinerangeSeriesIkhEvents Events_DefaultValue { get; set; }
		...
		/// </summary>
		public AreasplinerangeSeriesIkhMarker Marker { get; set; }
		private AreasplinerangeSeriesIkhMarker Marker_DefaultValue { get; set; }
		 

		/// <summary>
		/// <p>Properties for each single point.</p>
		/// </summary>
		public AreasplinerangeSeriesIkhPoint Point { get; set; }
		private AreasplinerangeSeriesIkhPoint Point_DefaultValue { get; set; }
		...
		/// </summary>
		public AreasplinerangeSeriesIkhDataLabels DataLabels { get; set; }
		private AreasplinerangeSeriesIkhDataLabels DataLabels_DefaultValue { get; set; }
		...
		/// </summary>
		public AreasplinerangeSeriesIkhStates States { get; set; }
		private AreasplinerangeSeriesIkhStates States_DefaultValue { get; set; }
		...
		/// </summary>
		public AreasplinerangeSeriesIkhFindNearestPointBy FindNearestPointBy { get; set; }
		private AreasplinerangeSeriesIkhFindNearestPointBy FindNearestPointBy_DefaultValue { get; set; }
		...
		/// </summary>
		public AreasplinerangeSeriesIkhCursor Cursor { get; set; }
		private AreasplinerangeSeriesIkhCursor Cursor_DefaultValue { get; set; }
		...
		/// </summary>
		public AreasplinerangeSeriesIkhDashStyle DashStyle { get; set; }
		private AreasplinerangeSeriesIkhDashStyle DashStyle_DefaultValue { get; set; }
		...
		/// </summary>
		public AreasplinerangeSeriesIkhStep Step { get; set; }
		private AreasplinerangeSeriesIkhStep Step_DefaultValue { get; set; }
		...
		/// </summary>
		public List<AreasplinerangeSeriesIkhZone> Zones { get; set; }
		private List<AreasplinerangeSeriesIkhZone> Zones_DefaultValue { get; set; }
		...
		/// </summary>
		public AreasplinerangeSeriesIkhPointIntervalUnit PointIntervalUnit { get; set; }
		private AreasplinerangeSeriesIkhPointIntervalUnit PointIntervalUnit_DefaultValue { get; set; }
		...
		/// </summary>
		public AreasplinerangeSeriesIkhStacking Stacking { get; set; }
		private AreasplinerangeSeriesIkhStacking Stacking_DefaultValue { get; set; }
		...
		/// </summary>
		public AreasplinerangeSeriesIkhCompareBase CompareBase { get; set; }
		private AreasplinerangeSeriesIkhCompareBase CompareBase_DefaultValue { get; set; }
		...
		internal override Hashtable ToHashtable()
		{
			...
			if (PointDescriptionFormatter != PointDescriptionFormatter_DefaultValue) { h.Add("pointDescriptionFormatter",PointDescriptionFormatter); Highstock.AddFunction("AreasplinerangeSeriesIkhPointDescriptionFormatter.pointDescriptionFormatter", PointDescriptionFormatter); }  
