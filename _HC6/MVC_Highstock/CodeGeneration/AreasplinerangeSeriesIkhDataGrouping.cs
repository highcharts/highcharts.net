...
{
	public partial class AreasplinerangeSeriesIkhDataGrouping  : BaseObject
	{
		public AreasplinerangeSeriesIkhDataGrouping()
		{
			Approximation = Approximation_DefaultValue = AreasplinerangeSeriesIkhDataGroupingApproximation.Average;
		...
		/// </summary>
		public AreasplinerangeSeriesIkhDataGroupingApproximation Approximation { get; set; }
		private AreasplinerangeSeriesIkhDataGroupingApproximation Approximation_DefaultValue { get; set; }
