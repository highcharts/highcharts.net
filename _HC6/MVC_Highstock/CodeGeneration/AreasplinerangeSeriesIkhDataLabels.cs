...
{
	public partial class AreasplinerangeSeriesIkhDataLabels  : BaseObject
	{
		public AreasplinerangeSeriesIkhDataLabels()
		{
			Align = Align_DefaultValue = AreasplinerangeSeriesIkhDataLabelsAlign.Center;
			Formatter = Formatter_DefaultValue = "";
			Style = Style_DefaultValue = new AreasplinerangeSeriesIkhDataLabelsStyle();
			VerticalAlign = VerticalAlign_DefaultValue = AreasplinerangeSeriesIkhDataLabelsVerticalAlign.Bottom;
			X = X_DefaultValue = 0;
			Y = Y_DefaultValue = -6;
			...
			Overflow = Overflow_DefaultValue = AreasplinerangeSeriesIkhDataLabelsOverflow.Justify;
		...
		/// </summary>
		public AreasplinerangeSeriesIkhDataLabelsAlign Align { get; set; }
		private AreasplinerangeSeriesIkhDataLabelsAlign Align_DefaultValue { get; set; }
		...
		/// </summary>
		public AreasplinerangeSeriesIkhDataLabelsStyle Style { get; set; }
		private AreasplinerangeSeriesIkhDataLabelsStyle Style_DefaultValue { get; set; }
		...
		/// </summary>
		public AreasplinerangeSeriesIkhDataLabelsVerticalAlign VerticalAlign { get; set; }
		private AreasplinerangeSeriesIkhDataLabelsVerticalAlign VerticalAlign_DefaultValue { get; set; }
		...
		/// </summary>
		public AreasplinerangeSeriesIkhDataLabelsOverflow Overflow { get; set; }
		private AreasplinerangeSeriesIkhDataLabelsOverflow Overflow_DefaultValue { get; set; }
		...
		internal override Hashtable ToHashtable()
		{
			...
			if (Formatter != Formatter_DefaultValue) { h.Add("formatter",Formatter); Highstock.AddFunction("AreasplinerangeSeriesIkhDataLabelsFormatter.formatter", Formatter); }  
