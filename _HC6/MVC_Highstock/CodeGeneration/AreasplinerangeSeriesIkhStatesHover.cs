...
{
	public partial class AreasplinerangeSeriesIkhStatesHover  : BaseObject
	{
		public AreasplinerangeSeriesIkhStatesHover()
		{
			LineWidthPlus = LineWidthPlus_DefaultValue = 1;
			Marker = Marker_DefaultValue = new AreasplinerangeSeriesIkhStatesHoverMarker();
			Halo = Halo_DefaultValue = new AreasplinerangeSeriesIkhStatesHoverHalo();
		...
		/// </summary>
		public AreasplinerangeSeriesIkhStatesHoverMarker Marker { get; set; }
		private AreasplinerangeSeriesIkhStatesHoverMarker Marker_DefaultValue { get; set; }
		...
		/// </summary>
		public AreasplinerangeSeriesIkhStatesHoverHalo Halo { get; set; }
		private AreasplinerangeSeriesIkhStatesHoverHalo Halo_DefaultValue { get; set; }
