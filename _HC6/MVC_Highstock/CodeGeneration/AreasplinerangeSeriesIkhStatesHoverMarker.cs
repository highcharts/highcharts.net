...
{
	public partial class AreasplinerangeSeriesIkhStatesHoverMarker  : BaseObject
	{
		public AreasplinerangeSeriesIkhStatesHoverMarker()
		{
			LineWidth = LineWidth_DefaultValue = 0;
			LineColor = LineColor_DefaultValue = "#ffffff";
			Radius = Radius_DefaultValue = 4;
			States = States_DefaultValue = new AreasplinerangeSeriesIkhStatesHoverMarkerStates();
		...
		/// </summary>
		public AreasplinerangeSeriesIkhStatesHoverMarkerStates States { get; set; }
		private AreasplinerangeSeriesIkhStatesHoverMarkerStates States_DefaultValue { get; set; }
