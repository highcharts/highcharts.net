...
{
	public partial class AreasplinerangeSeriesIkhStatesSelectMarker  : BaseObject
	{
		public AreasplinerangeSeriesIkhStatesSelectMarker()
		{
			LineWidth = LineWidth_DefaultValue = 0;
			LineColor = LineColor_DefaultValue = "#ffffff";
			Radius = Radius_DefaultValue = 4;
			States = States_DefaultValue = new AreasplinerangeSeriesIkhStatesSelectMarkerStates();
		...
		/// </summary>
		public AreasplinerangeSeriesIkhStatesSelectMarkerStates States { get; set; }
		private AreasplinerangeSeriesIkhStatesSelectMarkerStates States_DefaultValue { get; set; }
