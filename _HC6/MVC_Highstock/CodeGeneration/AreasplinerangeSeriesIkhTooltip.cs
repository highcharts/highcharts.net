...
{
	public partial class AreasplinerangeSeriesIkhTooltip  : BaseObject
	{
		public AreasplinerangeSeriesIkhTooltip()
		{
			ValueDecimals = ValueDecimals_DefaultValue = null;
			DateTimeLabelFormats = DateTimeLabelFormats_DefaultValue = new AreasplinerangeSeriesIkhTooltipDateTimeLabelFormats();
		...
		/// </summary>
		public AreasplinerangeSeriesIkhTooltipDateTimeLabelFormats DateTimeLabelFormats { get; set; }
		private AreasplinerangeSeriesIkhTooltipDateTimeLabelFormats DateTimeLabelFormats_DefaultValue { get; set; }
		...
		internal override Hashtable ToHashtable()
		{
			...
			if (PointFormatter != PointFormatter_DefaultValue) { h.Add("pointFormatter",PointFormatter); Highstock.AddFunction("AreasplinerangeSeriesIkhTooltipPointFormatter.pointFormatter", PointFormatter); }  
