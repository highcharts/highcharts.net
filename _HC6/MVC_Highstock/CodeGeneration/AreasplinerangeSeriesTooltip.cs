...
namespace Highsoft.Web.Mvc.Stocks
{
	public partial class AreasplinerangeSeriesTooltip  : BaseObject
	{
		public AreasplinerangeSeriesTooltip()
		{
			...
			DateTimeLabelFormats = DateTimeLabelFormats_DefaultValue = new AreasplinerangeSeriesTooltipDateTimeLabelFormats();
		...
		/// </summary>
		public AreasplinerangeSeriesTooltipDateTimeLabelFormats DateTimeLabelFormats { get; set; }
		private AreasplinerangeSeriesTooltipDateTimeLabelFormats DateTimeLabelFormats_DefaultValue { get; set; }
