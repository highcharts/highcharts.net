...
{
	public partial class AtrSeriesData  : BaseObject
	{
		public AtrSeriesData()
		{
			...
			DragDrop = DragDrop_DefaultValue = new AtrSeriesDataDragDrop();
			Drilldown = Drilldown_DefaultValue = "";
			Events = Events_DefaultValue = new AtrSeriesDataEvents();
			Id = Id_DefaultValue = "";
			Labelrank = Labelrank_DefaultValue = null;
			Marker = Marker_DefaultValue = new AtrSeriesDataMarker();
		...
		/// </summary>
		public AtrSeriesDataDragDrop DragDrop { get; set; }
		private AtrSeriesDataDragDrop DragDrop_DefaultValue { get; set; }
		...
		/// </summary>
		public AtrSeriesDataEvents Events { get; set; }
		private AtrSeriesDataEvents Events_DefaultValue { get; set; }
		...
		/// 
		/// </summary>
		public AtrSeriesDataMarker Marker { get; set; }
		private AtrSeriesDataMarker Marker_DefaultValue { get; set; }
