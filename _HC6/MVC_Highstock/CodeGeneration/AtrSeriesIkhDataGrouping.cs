...
{
	public partial class AtrSeriesIkhDataGrouping  : BaseObject
	{
		public AtrSeriesIkhDataGrouping()
		{
			Approximation = Approximation_DefaultValue = AtrSeriesIkhDataGroupingApproximation.Average;
		...
		/// </summary>
		public AtrSeriesIkhDataGroupingApproximation Approximation { get; set; }
		private AtrSeriesIkhDataGroupingApproximation Approximation_DefaultValue { get; set; }
