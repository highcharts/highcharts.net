...
{
	public partial class AtrSeriesIkhDataLabels  : BaseObject
	{
		public AtrSeriesIkhDataLabels()
		{
			Align = Align_DefaultValue = AtrSeriesIkhDataLabelsAlign.Center;
			Formatter = Formatter_DefaultValue = "";
			Style = Style_DefaultValue = new AtrSeriesIkhDataLabelsStyle();
			VerticalAlign = VerticalAlign_DefaultValue = AtrSeriesIkhDataLabelsVerticalAlign.Bottom;
			X = X_DefaultValue = 0;
			Y = Y_DefaultValue = -6;
			...
			Overflow = Overflow_DefaultValue = AtrSeriesIkhDataLabelsOverflow.Justify;
		...
		/// </summary>
		public AtrSeriesIkhDataLabelsAlign Align { get; set; }
		private AtrSeriesIkhDataLabelsAlign Align_DefaultValue { get; set; }
		...
		/// </summary>
		public AtrSeriesIkhDataLabelsStyle Style { get; set; }
		private AtrSeriesIkhDataLabelsStyle Style_DefaultValue { get; set; }
		...
		/// </summary>
		public AtrSeriesIkhDataLabelsVerticalAlign VerticalAlign { get; set; }
		private AtrSeriesIkhDataLabelsVerticalAlign VerticalAlign_DefaultValue { get; set; }
		...
		/// </summary>
		public AtrSeriesIkhDataLabelsOverflow Overflow { get; set; }
		private AtrSeriesIkhDataLabelsOverflow Overflow_DefaultValue { get; set; }
		...
		internal override Hashtable ToHashtable()
		{
			...
			if (Formatter != Formatter_DefaultValue) { h.Add("formatter",Formatter); Highstock.AddFunction("AtrSeriesIkhDataLabelsFormatter.formatter", Formatter); }  
