...
{
	public partial class AtrSeriesIkhLabel  : BaseObject
	{
		public AtrSeriesIkhLabel()
		{
			...
			Style = Style_DefaultValue = new AtrSeriesIkhLabelStyle();
		...
		/// </summary>
		public AtrSeriesIkhLabelStyle Style { get; set; }
		private AtrSeriesIkhLabelStyle Style_DefaultValue { get; set; }
