...
{
	public partial class AtrSeriesIkhMarker  : BaseObject
	{
		public AtrSeriesIkhMarker()
		{
			LineWidth = LineWidth_DefaultValue = 0;
			LineColor = LineColor_DefaultValue = "#ffffff";
			Radius = Radius_DefaultValue = 4;
			States = States_DefaultValue = new AtrSeriesIkhMarkerStates();
		...
		/// </summary>
		public AtrSeriesIkhMarkerStates States { get; set; }
		private AtrSeriesIkhMarkerStates States_DefaultValue { get; set; }
