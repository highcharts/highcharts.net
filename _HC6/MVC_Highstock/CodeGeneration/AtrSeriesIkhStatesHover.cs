...
{
	public partial class AtrSeriesIkhStatesHover  : BaseObject
	{
		public AtrSeriesIkhStatesHover()
		{
			LineWidthPlus = LineWidthPlus_DefaultValue = 1;
			Marker = Marker_DefaultValue = new AtrSeriesIkhStatesHoverMarker();
			Halo = Halo_DefaultValue = new AtrSeriesIkhStatesHoverHalo();
		...
		/// </summary>
		public AtrSeriesIkhStatesHoverMarker Marker { get; set; }
		private AtrSeriesIkhStatesHoverMarker Marker_DefaultValue { get; set; }
		...
		/// </summary>
		public AtrSeriesIkhStatesHoverHalo Halo { get; set; }
		private AtrSeriesIkhStatesHoverHalo Halo_DefaultValue { get; set; }
