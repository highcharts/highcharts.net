...
{
	public partial class AtrSeriesIkhTooltip  : BaseObject
	{
		public AtrSeriesIkhTooltip()
		{
			ValueDecimals = ValueDecimals_DefaultValue = null;
			DateTimeLabelFormats = DateTimeLabelFormats_DefaultValue = new AtrSeriesIkhTooltipDateTimeLabelFormats();
		...
		/// </summary>
		public AtrSeriesIkhTooltipDateTimeLabelFormats DateTimeLabelFormats { get; set; }
		private AtrSeriesIkhTooltipDateTimeLabelFormats DateTimeLabelFormats_DefaultValue { get; set; }
		...
		internal override Hashtable ToHashtable()
		{
			...
			if (PointFormatter != PointFormatter_DefaultValue) { h.Add("pointFormatter",PointFormatter); Highstock.AddFunction("AtrSeriesIkhTooltipPointFormatter.pointFormatter", PointFormatter); }  
