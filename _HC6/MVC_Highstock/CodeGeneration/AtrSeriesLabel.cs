...
{
	public partial class AtrSeriesLabel  : BaseObject
	{
		public AtrSeriesLabel()
		{
			...
			Style = Style_DefaultValue = new AtrSeriesLabelStyle();
		...
		/// </summary>
		public AtrSeriesLabelStyle Style { get; set; }
		private AtrSeriesLabelStyle Style_DefaultValue { get; set; }
