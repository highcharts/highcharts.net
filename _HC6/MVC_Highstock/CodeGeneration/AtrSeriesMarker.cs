...
{
	public partial class AtrSeriesMarker  : BaseObject
	{
		public AtrSeriesMarker()
		{
			LineWidth = LineWidth_DefaultValue = 0;
			LineColor = LineColor_DefaultValue = "#ffffff";
			Radius = Radius_DefaultValue = 4;
			States = States_DefaultValue = new AtrSeriesMarkerStates();
		...
		/// </summary>
		public AtrSeriesMarkerStates States { get; set; }
		private AtrSeriesMarkerStates States_DefaultValue { get; set; }
