...
{
	public partial class AtrSeriesStatesHoverMarker  : BaseObject
	{
		public AtrSeriesStatesHoverMarker()
		{
			...
			States = States_DefaultValue = new AtrSeriesStatesHoverMarkerStates();
		...
		/// </summary>
		public AtrSeriesStatesHoverMarkerStates States { get; set; }
		private AtrSeriesStatesHoverMarkerStates States_DefaultValue { get; set; }
