...
namespace Highsoft.Web.Mvc.Stocks
{
	public partial class AtrSeriesTooltip  : BaseObject
	{
		public AtrSeriesTooltip()
		{
			...
			DateTimeLabelFormats = DateTimeLabelFormats_DefaultValue = new AtrSeriesTooltipDateTimeLabelFormats();
		...
		/// </summary>
		public AtrSeriesTooltipDateTimeLabelFormats DateTimeLabelFormats { get; set; }
		private AtrSeriesTooltipDateTimeLabelFormats DateTimeLabelFormats_DefaultValue { get; set; }
