...
{
	public partial class BarSeriesDataGrouping  : BaseObject
	{
		...
		/// </summary>
		public BarSeriesDataGroupingApproximation Approximation { get; set; }
		private BarSeriesDataGroupingApproximation Approximation_DefaultValue { get; set; }
