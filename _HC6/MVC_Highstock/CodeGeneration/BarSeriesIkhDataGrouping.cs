...
{
	public partial class BarSeriesIkhDataGrouping  : BaseObject
	{
		public BarSeriesIkhDataGrouping()
		{
			Approximation = Approximation_DefaultValue = BarSeriesIkhDataGroupingApproximation.Average;
		...
		/// </summary>
		public BarSeriesIkhDataGroupingApproximation Approximation { get; set; }
		private BarSeriesIkhDataGroupingApproximation Approximation_DefaultValue { get; set; }
