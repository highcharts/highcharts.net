...
{
	public partial class BarSeriesIkhDataLabels  : BaseObject
	{
		public BarSeriesIkhDataLabels()
		{
			Align = Align_DefaultValue = BarSeriesIkhDataLabelsAlign.Center;
			Formatter = Formatter_DefaultValue = "";
			Style = Style_DefaultValue = new BarSeriesIkhDataLabelsStyle();
			VerticalAlign = VerticalAlign_DefaultValue = BarSeriesIkhDataLabelsVerticalAlign.Bottom;
			X = X_DefaultValue = 0;
			Y = Y_DefaultValue = -6;
			...
			Overflow = Overflow_DefaultValue = BarSeriesIkhDataLabelsOverflow.Justify;
		...
		/// </summary>
		public BarSeriesIkhDataLabelsAlign Align { get; set; }
		private BarSeriesIkhDataLabelsAlign Align_DefaultValue { get; set; }
		...
		/// </summary>
		public BarSeriesIkhDataLabelsStyle Style { get; set; }
		private BarSeriesIkhDataLabelsStyle Style_DefaultValue { get; set; }
		...
		/// </summary>
		public BarSeriesIkhDataLabelsVerticalAlign VerticalAlign { get; set; }
		private BarSeriesIkhDataLabelsVerticalAlign VerticalAlign_DefaultValue { get; set; }
		...
		/// </summary>
		public BarSeriesIkhDataLabelsOverflow Overflow { get; set; }
		private BarSeriesIkhDataLabelsOverflow Overflow_DefaultValue { get; set; }
		...
		internal override Hashtable ToHashtable()
		{
			...
			if (Formatter != Formatter_DefaultValue) { h.Add("formatter",Formatter); Highstock.AddFunction("BarSeriesIkhDataLabelsFormatter.formatter", Formatter); }  
