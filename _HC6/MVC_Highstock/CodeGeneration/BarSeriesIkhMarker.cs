...
{
	public partial class BarSeriesIkhMarker  : BaseObject
	{
		public BarSeriesIkhMarker()
		{
			LineWidth = LineWidth_DefaultValue = 0;
			LineColor = LineColor_DefaultValue = "#ffffff";
			Radius = Radius_DefaultValue = 4;
			States = States_DefaultValue = new BarSeriesIkhMarkerStates();
		...
		/// </summary>
		public BarSeriesIkhMarkerStates States { get; set; }
		private BarSeriesIkhMarkerStates States_DefaultValue { get; set; }
