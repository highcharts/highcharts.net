...
{
	public partial class BarSeriesIkhStatesHover  : BaseObject
	{
		public BarSeriesIkhStatesHover()
		{
			LineWidthPlus = LineWidthPlus_DefaultValue = 1;
			Marker = Marker_DefaultValue = new BarSeriesIkhStatesHoverMarker();
			Halo = Halo_DefaultValue = new BarSeriesIkhStatesHoverHalo();
		...
		/// </summary>
		public BarSeriesIkhStatesHoverMarker Marker { get; set; }
		private BarSeriesIkhStatesHoverMarker Marker_DefaultValue { get; set; }
		...
		/// </summary>
		public BarSeriesIkhStatesHoverHalo Halo { get; set; }
		private BarSeriesIkhStatesHoverHalo Halo_DefaultValue { get; set; }
