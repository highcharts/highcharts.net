...
{
	public partial class BarSeriesIkhStatesHoverMarker  : BaseObject
	{
		public BarSeriesIkhStatesHoverMarker()
		{
			LineWidth = LineWidth_DefaultValue = 0;
			LineColor = LineColor_DefaultValue = "#ffffff";
			Radius = Radius_DefaultValue = 4;
			States = States_DefaultValue = new BarSeriesIkhStatesHoverMarkerStates();
		...
		/// </summary>
		public BarSeriesIkhStatesHoverMarkerStates States { get; set; }
		private BarSeriesIkhStatesHoverMarkerStates States_DefaultValue { get; set; }
