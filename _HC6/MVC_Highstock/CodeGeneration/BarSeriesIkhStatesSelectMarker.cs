...
{
	public partial class BarSeriesIkhStatesSelectMarker  : BaseObject
	{
		public BarSeriesIkhStatesSelectMarker()
		{
			LineWidth = LineWidth_DefaultValue = 0;
			LineColor = LineColor_DefaultValue = "#ffffff";
			Radius = Radius_DefaultValue = 4;
			States = States_DefaultValue = new BarSeriesIkhStatesSelectMarkerStates();
		...
		/// </summary>
		public BarSeriesIkhStatesSelectMarkerStates States { get; set; }
		private BarSeriesIkhStatesSelectMarkerStates States_DefaultValue { get; set; }
