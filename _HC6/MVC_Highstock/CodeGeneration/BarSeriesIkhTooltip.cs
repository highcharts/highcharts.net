...
{
	public partial class BarSeriesIkhTooltip  : BaseObject
	{
		public BarSeriesIkhTooltip()
		{
			ValueDecimals = ValueDecimals_DefaultValue = null;
			DateTimeLabelFormats = DateTimeLabelFormats_DefaultValue = new BarSeriesIkhTooltipDateTimeLabelFormats();
		...
		/// </summary>
		public BarSeriesIkhTooltipDateTimeLabelFormats DateTimeLabelFormats { get; set; }
		private BarSeriesIkhTooltipDateTimeLabelFormats DateTimeLabelFormats_DefaultValue { get; set; }
		...
		internal override Hashtable ToHashtable()
		{
			...
			if (PointFormatter != PointFormatter_DefaultValue) { h.Add("pointFormatter",PointFormatter); Highstock.AddFunction("BarSeriesIkhTooltipPointFormatter.pointFormatter", PointFormatter); }  
