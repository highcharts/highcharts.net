...
{
	public partial class BarSeriesMarker  : BaseObject
	{
		public BarSeriesMarker()
		{
			LineWidth = LineWidth_DefaultValue = 0;
			LineColor = LineColor_DefaultValue = "#ffffff";
			Radius = Radius_DefaultValue = 4;
			States = States_DefaultValue = new BarSeriesMarkerStates();
		...
		/// </summary>
		public BarSeriesMarkerStates States { get; set; }
		private BarSeriesMarkerStates States_DefaultValue { get; set; }
