...
{
	public partial class BarSeriesStatesSelectMarker  : BaseObject
	{
		public BarSeriesStatesSelectMarker()
		{
			LineWidth = LineWidth_DefaultValue = 0;
			LineColor = LineColor_DefaultValue = "#ffffff";
			Radius = Radius_DefaultValue = 4;
			States = States_DefaultValue = new BarSeriesStatesSelectMarkerStates();
		...
		/// </summary>
		public BarSeriesStatesSelectMarkerStates States { get; set; }
		private BarSeriesStatesSelectMarkerStates States_DefaultValue { get; set; }
