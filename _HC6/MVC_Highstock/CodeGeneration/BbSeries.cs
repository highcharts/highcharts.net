...
namespace Highsoft.Web.Mvc.Stocks
{
	public partial class BbSeries  : Series
	{
		public BbSeries()
		{
			Ikh = Ikh_DefaultValue = new BbSeriesIkh();
			Id = Id_DefaultValue = null;
			Index = Index_DefaultValue = null;
			LegendIndex = LegendIndex_DefaultValue = null;
			Name = Name_DefaultValue = "BB (20, 2)";
			...
			Zones = Zones_DefaultValue = new BbSeriesZone();
			...
			PointIntervalUnit = PointIntervalUnit_DefaultValue = BbSeriesPointIntervalUnit.Null;
			PointPlacement = PointPlacement_DefaultValue = new PointPlacement();
			PointStart = PointStart_DefaultValue = 0;
			Stacking = Stacking_DefaultValue = BbSeriesStacking.Null;
		...
		/// </summary>
		public BbSeriesIkh Ikh { get; set; }
		private BbSeriesIkh Ikh_DefaultValue { get; set; }
		...
		/// </summary>
		public BbSeriesZone Zones { get; set; }
		private BbSeriesZone Zones_DefaultValue { get; set; }
		...
		/// </summary>
		public BbSeriesPointIntervalUnit PointIntervalUnit { get; set; }
		private BbSeriesPointIntervalUnit PointIntervalUnit_DefaultValue { get; set; }
		...
		/// </summary>
		public BbSeriesStacking Stacking { get; set; }
		private BbSeriesStacking Stacking_DefaultValue { get; set; }
