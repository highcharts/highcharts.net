...
{
	public partial class BbSeriesData  : BaseObject
	{
		public BbSeriesData()
		{
			...
			DragDrop = DragDrop_DefaultValue = new BbSeriesDataDragDrop();
			Drilldown = Drilldown_DefaultValue = "";
			Events = Events_DefaultValue = new BbSeriesDataEvents();
			Id = Id_DefaultValue = "";
			Labelrank = Labelrank_DefaultValue = null;
			Marker = Marker_DefaultValue = new BbSeriesDataMarker();
		...
		/// </summary>
		public BbSeriesDataDragDrop DragDrop { get; set; }
		private BbSeriesDataDragDrop DragDrop_DefaultValue { get; set; }
		...
		/// </summary>
		public BbSeriesDataEvents Events { get; set; }
		private BbSeriesDataEvents Events_DefaultValue { get; set; }
		...
		/// 
		/// </summary>
		public BbSeriesDataMarker Marker { get; set; }
		private BbSeriesDataMarker Marker_DefaultValue { get; set; }
