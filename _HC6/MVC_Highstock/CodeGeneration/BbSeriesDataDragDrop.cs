...
{
	public partial class BbSeriesDataDragDrop  : BaseObject
	{
		public BbSeriesDataDragDrop()
		{
			DraggableX = DraggableX_DefaultValue = null;
			DraggableY = DraggableY_DefaultValue = null;
			DragHandle = DragHandle_DefaultValue = new BbSeriesDataDragDropDragHandle();
			...
			GuideBox = GuideBox_DefaultValue = new BbSeriesDataDragDropGuideBox();
		...
		/// </summary>
		public BbSeriesDataDragDropDragHandle DragHandle { get; set; }
		private BbSeriesDataDragDropDragHandle DragHandle_DefaultValue { get; set; }
		...
		/// </summary>
		public BbSeriesDataDragDropGuideBox GuideBox { get; set; }
		private BbSeriesDataDragDropGuideBox GuideBox_DefaultValue { get; set; }
