...
{
	public partial class BbSeriesDataDragDropDragHandle  : BaseObject
	{
		public BbSeriesDataDragDropDragHandle()
		{
		...
		internal override Hashtable ToHashtable()
		{
			...
			if (PathFormatter != PathFormatter_DefaultValue) { h.Add("pathFormatter",PathFormatter); Highstock.AddFunction("BbSeriesDataDragDropDragHandlePathFormatter.pathFormatter", PathFormatter); }  
