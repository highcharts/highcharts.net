...
{
	public partial class BbSeriesDataMarker  : BaseObject
	{
		public BbSeriesDataMarker()
		{
			...
			States = States_DefaultValue = new BbSeriesDataMarkerStates();
		...
		/// </summary>
		public BbSeriesDataMarkerStates States { get; set; }
		private BbSeriesDataMarkerStates States_DefaultValue { get; set; }
