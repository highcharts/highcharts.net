...
{
	public partial class BbSeriesIkhDataGrouping  : BaseObject
	{
		public BbSeriesIkhDataGrouping()
		{
			Approximation = Approximation_DefaultValue = BbSeriesIkhDataGroupingApproximation.Average;
		...
		/// </summary>
		public BbSeriesIkhDataGroupingApproximation Approximation { get; set; }
		private BbSeriesIkhDataGroupingApproximation Approximation_DefaultValue { get; set; }
