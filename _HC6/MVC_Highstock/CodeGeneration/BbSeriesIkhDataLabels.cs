...
{
	public partial class BbSeriesIkhDataLabels  : BaseObject
	{
		public BbSeriesIkhDataLabels()
		{
			Align = Align_DefaultValue = BbSeriesIkhDataLabelsAlign.Center;
			Formatter = Formatter_DefaultValue = "";
			Style = Style_DefaultValue = new BbSeriesIkhDataLabelsStyle();
			VerticalAlign = VerticalAlign_DefaultValue = BbSeriesIkhDataLabelsVerticalAlign.Bottom;
			X = X_DefaultValue = 0;
			Y = Y_DefaultValue = -6;
			...
			Overflow = Overflow_DefaultValue = BbSeriesIkhDataLabelsOverflow.Justify;
		...
		/// </summary>
		public BbSeriesIkhDataLabelsAlign Align { get; set; }
		private BbSeriesIkhDataLabelsAlign Align_DefaultValue { get; set; }
		...
		/// </summary>
		public BbSeriesIkhDataLabelsStyle Style { get; set; }
		private BbSeriesIkhDataLabelsStyle Style_DefaultValue { get; set; }
		...
		/// </summary>
		public BbSeriesIkhDataLabelsVerticalAlign VerticalAlign { get; set; }
		private BbSeriesIkhDataLabelsVerticalAlign VerticalAlign_DefaultValue { get; set; }
		...
		/// </summary>
		public BbSeriesIkhDataLabelsOverflow Overflow { get; set; }
		private BbSeriesIkhDataLabelsOverflow Overflow_DefaultValue { get; set; }
		...
		internal override Hashtable ToHashtable()
		{
			...
			if (Formatter != Formatter_DefaultValue) { h.Add("formatter",Formatter); Highstock.AddFunction("BbSeriesIkhDataLabelsFormatter.formatter", Formatter); }  
