...
{
	public partial class BbSeriesIkhLabel  : BaseObject
	{
		public BbSeriesIkhLabel()
		{
			...
			Style = Style_DefaultValue = new BbSeriesIkhLabelStyle();
		...
		/// </summary>
		public BbSeriesIkhLabelStyle Style { get; set; }
		private BbSeriesIkhLabelStyle Style_DefaultValue { get; set; }
