...
{
	public partial class BbSeriesIkhStatesHover  : BaseObject
	{
		public BbSeriesIkhStatesHover()
		{
			LineWidthPlus = LineWidthPlus_DefaultValue = 1;
			Marker = Marker_DefaultValue = new BbSeriesIkhStatesHoverMarker();
			Halo = Halo_DefaultValue = new BbSeriesIkhStatesHoverHalo();
		...
		/// </summary>
		public BbSeriesIkhStatesHoverMarker Marker { get; set; }
		private BbSeriesIkhStatesHoverMarker Marker_DefaultValue { get; set; }
		...
		/// </summary>
		public BbSeriesIkhStatesHoverHalo Halo { get; set; }
		private BbSeriesIkhStatesHoverHalo Halo_DefaultValue { get; set; }
