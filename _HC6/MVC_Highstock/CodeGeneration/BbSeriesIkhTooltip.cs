...
{
	public partial class BbSeriesIkhTooltip  : BaseObject
	{
		public BbSeriesIkhTooltip()
		{
			ValueDecimals = ValueDecimals_DefaultValue = null;
			DateTimeLabelFormats = DateTimeLabelFormats_DefaultValue = new BbSeriesIkhTooltipDateTimeLabelFormats();
		...
		/// </summary>
		public BbSeriesIkhTooltipDateTimeLabelFormats DateTimeLabelFormats { get; set; }
		private BbSeriesIkhTooltipDateTimeLabelFormats DateTimeLabelFormats_DefaultValue { get; set; }
		...
		internal override Hashtable ToHashtable()
		{
			...
			if (PointFormatter != PointFormatter_DefaultValue) { h.Add("pointFormatter",PointFormatter); Highstock.AddFunction("BbSeriesIkhTooltipPointFormatter.pointFormatter", PointFormatter); }  
