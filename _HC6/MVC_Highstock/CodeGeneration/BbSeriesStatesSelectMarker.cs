...
namespace Highsoft.Web.Mvc.Stocks
{
	public partial class BbSeriesStatesSelectMarker  : BaseObject
	{
		public BbSeriesStatesSelectMarker()
		{
			...
			States = States_DefaultValue = new BbSeriesStatesSelectMarkerStates();
		...
		/// </summary>
		public BbSeriesStatesSelectMarkerStates States { get; set; }
		private BbSeriesStatesSelectMarkerStates States_DefaultValue { get; set; }
