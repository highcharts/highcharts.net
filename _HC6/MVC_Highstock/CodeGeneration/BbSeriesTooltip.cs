...
namespace Highsoft.Web.Mvc.Stocks
{
	public partial class BbSeriesTooltip  : BaseObject
	{
		public BbSeriesTooltip()
		{
			...
			DateTimeLabelFormats = DateTimeLabelFormats_DefaultValue = new BbSeriesTooltipDateTimeLabelFormats();
		...
		/// </summary>
		public BbSeriesTooltipDateTimeLabelFormats DateTimeLabelFormats { get; set; }
		private BbSeriesTooltipDateTimeLabelFormats DateTimeLabelFormats_DefaultValue { get; set; }
