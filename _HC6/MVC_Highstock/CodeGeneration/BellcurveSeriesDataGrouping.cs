...
{
	public partial class BellcurveSeriesDataGrouping  : BaseObject
	{
		...
		/// </summary>
		public BellcurveSeriesDataGroupingApproximation Approximation { get; set; }
		private BellcurveSeriesDataGroupingApproximation Approximation_DefaultValue { get; set; }
