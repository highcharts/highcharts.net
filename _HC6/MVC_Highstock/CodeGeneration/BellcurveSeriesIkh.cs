...
namespace Highsoft.Web.Mvc.Stocks
{
	public partial class BellcurveSeriesIkh  : BaseObject
	{
		public BellcurveSeriesIkh()
		{
			...
			Zones = Zones_DefaultValue = new BellcurveSeriesIkhZone();
		...
		/// </summary>
		public BellcurveSeriesIkhZone Zones { get; set; }
		private BellcurveSeriesIkhZone Zones_DefaultValue { get; set; }
