...
{
	public partial class BellcurveSeriesIkh  : BaseObject
	{
		public BellcurveSeriesIkh()
		{
			Name = Name_DefaultValue = "SMA (14)";
			Tooltip = Tooltip_DefaultValue = new BellcurveSeriesIkhTooltip();
			LinkedTo = LinkedTo_DefaultValue = null;
			Params = Params_DefaultValue = new BellcurveSeriesIkhParams();
			Linecap = Linecap_DefaultValue = BellcurveSeriesIkhLinecap.Round;
			BoostThreshold = BoostThreshold_DefaultValue = 5000;
			GapSize = GapSize_DefaultValue = 0;
			GapUnit = GapUnit_DefaultValue = BellcurveSeriesIkhGapUnit.Relative;
			Label = Label_DefaultValue = new BellcurveSeriesIkhLabel();
			DataGrouping = DataGrouping_DefaultValue = new BellcurveSeriesIkhDataGrouping();
			LineWidth = LineWidth_DefaultValue = 2;
			AllowPointSelect = AllowPointSelect_DefaultValue = false;
			ShowCheckbox = ShowCheckbox_DefaultValue = false;
			Animation = Animation_DefaultValue = new Animation() { Enabled = true };
			Events = Events_DefaultValue = new BellcurveSeriesIkhEvents();
			Marker = Marker_DefaultValue = new BellcurveSeriesIkhMarker();
			Point = Point_DefaultValue = new BellcurveSeriesIkhPoint();
			DataLabels = DataLabels_DefaultValue = new BellcurveSeriesIkhDataLabels();
			CropThreshold = CropThreshold_DefaultValue = 300;
			SoftThreshold = SoftThreshold_DefaultValue = true;
			States = States_DefaultValue = new BellcurveSeriesIkhStates();
			StickyTracking = StickyTracking_DefaultValue = null;
			TurboThreshold = TurboThreshold_DefaultValue = 1000;
			FindNearestPointBy = FindNearestPointBy_DefaultValue = BellcurveSeriesIkhFindNearestPointBy.X;
			AnimationLimit = AnimationLimit_DefaultValue = null;
			ClassName = ClassName_DefaultValue = null;
			Color = Color_DefaultValue = null;
			ColorIndex = ColorIndex_DefaultValue = null;
			ConnectNulls = ConnectNulls_DefaultValue = false;
			Cursor = Cursor_DefaultValue = BellcurveSeriesIkhCursor.Null;
			DashStyle = DashStyle_DefaultValue = BellcurveSeriesIkhDashStyle.Solid;
			...
			Step = Step_DefaultValue = BellcurveSeriesIkhStep.Null;
			Threshold = Threshold_DefaultValue = 0;
			Visible = Visible_DefaultValue = true;
			ZoneAxis = ZoneAxis_DefaultValue = "y";
			Zones = Zones_DefaultValue = new List<BellcurveSeriesIkhZone>();
			...
			PointIntervalUnit = PointIntervalUnit_DefaultValue = BellcurveSeriesIkhPointIntervalUnit.Null;
			PointPlacement = PointPlacement_DefaultValue = new PointPlacement();
			PointStart = PointStart_DefaultValue = 0;
			Stacking = Stacking_DefaultValue = BellcurveSeriesIkhStacking.Null;
			Compare = Compare_DefaultValue = "undefined";
			CompareBase = CompareBase_DefaultValue = BellcurveSeriesIkhCompareBase.Min;
		...
		/// </summary>
		public BellcurveSeriesIkhTooltip Tooltip { get; set; }
		private BellcurveSeriesIkhTooltip Tooltip_DefaultValue { get; set; }
		...
		/// 
		/// </summary>
		public BellcurveSeriesIkhParams Params { get; set; }
		private BellcurveSeriesIkhParams Params_DefaultValue { get; set; }
		...
		/// </summary>
		public BellcurveSeriesIkhLinecap Linecap { get; set; }
		private BellcurveSeriesIkhLinecap Linecap_DefaultValue { get; set; }
		...
		/// </summary>
		public BellcurveSeriesIkhGapUnit GapUnit { get; set; }
		private BellcurveSeriesIkhGapUnit GapUnit_DefaultValue { get; set; }
		...
		/// </summary>
		public BellcurveSeriesIkhLabel Label { get; set; }
		private BellcurveSeriesIkhLabel Label_DefaultValue { get; set; }
		...
		/// </summary>
		public BellcurveSeriesIkhDataGrouping DataGrouping { get; set; }
		private BellcurveSeriesIkhDataGrouping DataGrouping_DefaultValue { get; set; }
		...
		/// </summary>
		public BellcurveSeriesIkhEvents Events { get; set; }
		private BellcurveSeriesIkhEvents Events_DefaultValue { get; set; }
		...
		/// </summary>
		public BellcurveSeriesIkhMarker Marker { get; set; }
		private BellcurveSeriesIkhMarker Marker_DefaultValue { get; set; }
		 

		/// <summary>
		/// <p>Properties for each single point.</p>
		/// </summary>
		public BellcurveSeriesIkhPoint Point { get; set; }
		private BellcurveSeriesIkhPoint Point_DefaultValue { get; set; }
		...
		/// </summary>
		public BellcurveSeriesIkhDataLabels DataLabels { get; set; }
		private BellcurveSeriesIkhDataLabels DataLabels_DefaultValue { get; set; }
		...
		/// </summary>
		public BellcurveSeriesIkhStates States { get; set; }
		private BellcurveSeriesIkhStates States_DefaultValue { get; set; }
		...
		/// </summary>
		public BellcurveSeriesIkhFindNearestPointBy FindNearestPointBy { get; set; }
		private BellcurveSeriesIkhFindNearestPointBy FindNearestPointBy_DefaultValue { get; set; }
		...
		/// </summary>
		public BellcurveSeriesIkhCursor Cursor { get; set; }
		private BellcurveSeriesIkhCursor Cursor_DefaultValue { get; set; }
		...
		/// </summary>
		public BellcurveSeriesIkhDashStyle DashStyle { get; set; }
		private BellcurveSeriesIkhDashStyle DashStyle_DefaultValue { get; set; }
		...
		/// </summary>
		public BellcurveSeriesIkhStep Step { get; set; }
		private BellcurveSeriesIkhStep Step_DefaultValue { get; set; }
		...
		/// </summary>
		public List<BellcurveSeriesIkhZone> Zones { get; set; }
		private List<BellcurveSeriesIkhZone> Zones_DefaultValue { get; set; }
		...
		/// </summary>
		public BellcurveSeriesIkhPointIntervalUnit PointIntervalUnit { get; set; }
		private BellcurveSeriesIkhPointIntervalUnit PointIntervalUnit_DefaultValue { get; set; }
		...
		/// </summary>
		public BellcurveSeriesIkhStacking Stacking { get; set; }
		private BellcurveSeriesIkhStacking Stacking_DefaultValue { get; set; }
		...
		/// </summary>
		public BellcurveSeriesIkhCompareBase CompareBase { get; set; }
		private BellcurveSeriesIkhCompareBase CompareBase_DefaultValue { get; set; }
		...
		internal override Hashtable ToHashtable()
		{
			...
			if (PointDescriptionFormatter != PointDescriptionFormatter_DefaultValue) { h.Add("pointDescriptionFormatter",PointDescriptionFormatter); Highstock.AddFunction("BellcurveSeriesIkhPointDescriptionFormatter.pointDescriptionFormatter", PointDescriptionFormatter); }  
