...
{
	public partial class BellcurveSeriesIkhDataGrouping  : BaseObject
	{
		public BellcurveSeriesIkhDataGrouping()
		{
			Approximation = Approximation_DefaultValue = BellcurveSeriesIkhDataGroupingApproximation.Average;
		...
		/// </summary>
		public BellcurveSeriesIkhDataGroupingApproximation Approximation { get; set; }
		private BellcurveSeriesIkhDataGroupingApproximation Approximation_DefaultValue { get; set; }
