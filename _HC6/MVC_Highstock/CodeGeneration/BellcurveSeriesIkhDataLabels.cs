...
{
	public partial class BellcurveSeriesIkhDataLabels  : BaseObject
	{
		public BellcurveSeriesIkhDataLabels()
		{
			Align = Align_DefaultValue = BellcurveSeriesIkhDataLabelsAlign.Center;
			Formatter = Formatter_DefaultValue = "";
			Style = Style_DefaultValue = new BellcurveSeriesIkhDataLabelsStyle();
			VerticalAlign = VerticalAlign_DefaultValue = BellcurveSeriesIkhDataLabelsVerticalAlign.Bottom;
			X = X_DefaultValue = 0;
			Y = Y_DefaultValue = -6;
			...
			Overflow = Overflow_DefaultValue = BellcurveSeriesIkhDataLabelsOverflow.Justify;
		...
		/// </summary>
		public BellcurveSeriesIkhDataLabelsAlign Align { get; set; }
		private BellcurveSeriesIkhDataLabelsAlign Align_DefaultValue { get; set; }
		...
		/// </summary>
		public BellcurveSeriesIkhDataLabelsStyle Style { get; set; }
		private BellcurveSeriesIkhDataLabelsStyle Style_DefaultValue { get; set; }
		...
		/// </summary>
		public BellcurveSeriesIkhDataLabelsVerticalAlign VerticalAlign { get; set; }
		private BellcurveSeriesIkhDataLabelsVerticalAlign VerticalAlign_DefaultValue { get; set; }
		...
		/// </summary>
		public BellcurveSeriesIkhDataLabelsOverflow Overflow { get; set; }
		private BellcurveSeriesIkhDataLabelsOverflow Overflow_DefaultValue { get; set; }
		...
		internal override Hashtable ToHashtable()
		{
			...
			if (Formatter != Formatter_DefaultValue) { h.Add("formatter",Formatter); Highstock.AddFunction("BellcurveSeriesIkhDataLabelsFormatter.formatter", Formatter); }  
