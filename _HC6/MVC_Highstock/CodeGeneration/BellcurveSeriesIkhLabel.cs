...
{
	public partial class BellcurveSeriesIkhLabel  : BaseObject
	{
		public BellcurveSeriesIkhLabel()
		{
			...
			Style = Style_DefaultValue = new BellcurveSeriesIkhLabelStyle();
		...
		/// </summary>
		public BellcurveSeriesIkhLabelStyle Style { get; set; }
		private BellcurveSeriesIkhLabelStyle Style_DefaultValue { get; set; }
