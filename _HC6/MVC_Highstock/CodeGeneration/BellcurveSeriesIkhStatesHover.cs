...
{
	public partial class BellcurveSeriesIkhStatesHover  : BaseObject
	{
		public BellcurveSeriesIkhStatesHover()
		{
			LineWidthPlus = LineWidthPlus_DefaultValue = 1;
			Marker = Marker_DefaultValue = new BellcurveSeriesIkhStatesHoverMarker();
			Halo = Halo_DefaultValue = new BellcurveSeriesIkhStatesHoverHalo();
		...
		/// </summary>
		public BellcurveSeriesIkhStatesHoverMarker Marker { get; set; }
		private BellcurveSeriesIkhStatesHoverMarker Marker_DefaultValue { get; set; }
		...
		/// </summary>
		public BellcurveSeriesIkhStatesHoverHalo Halo { get; set; }
		private BellcurveSeriesIkhStatesHoverHalo Halo_DefaultValue { get; set; }
