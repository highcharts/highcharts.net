...
{
	public partial class BellcurveSeriesIkhTooltip  : BaseObject
	{
		public BellcurveSeriesIkhTooltip()
		{
			ValueDecimals = ValueDecimals_DefaultValue = null;
			DateTimeLabelFormats = DateTimeLabelFormats_DefaultValue = new BellcurveSeriesIkhTooltipDateTimeLabelFormats();
		...
		/// </summary>
		public BellcurveSeriesIkhTooltipDateTimeLabelFormats DateTimeLabelFormats { get; set; }
		private BellcurveSeriesIkhTooltipDateTimeLabelFormats DateTimeLabelFormats_DefaultValue { get; set; }
		...
		internal override Hashtable ToHashtable()
		{
			...
			if (PointFormatter != PointFormatter_DefaultValue) { h.Add("pointFormatter",PointFormatter); Highstock.AddFunction("BellcurveSeriesIkhTooltipPointFormatter.pointFormatter", PointFormatter); }  
