...
{
	public partial class BoxplotSeriesDataGrouping  : BaseObject
	{
		public BoxplotSeriesDataGrouping()
		{
			GroupPixelWidth = GroupPixelWidth_DefaultValue = 10;
			Approximation = Approximation_DefaultValue = BoxplotSeriesDataGroupingApproximation.Average;
		...
		/// </summary>
		public BoxplotSeriesDataGroupingApproximation Approximation { get; set; }
		private BoxplotSeriesDataGroupingApproximation Approximation_DefaultValue { get; set; }
