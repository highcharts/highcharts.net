...
{
	public partial class BoxplotSeriesIkh  : BaseObject
	{
		public BoxplotSeriesIkh()
		{
			Name = Name_DefaultValue = "SMA (14)";
			Tooltip = Tooltip_DefaultValue = new BoxplotSeriesIkhTooltip();
			LinkedTo = LinkedTo_DefaultValue = null;
			Params = Params_DefaultValue = new BoxplotSeriesIkhParams();
			Linecap = Linecap_DefaultValue = BoxplotSeriesIkhLinecap.Round;
			BoostThreshold = BoostThreshold_DefaultValue = 5000;
			GapSize = GapSize_DefaultValue = 0;
			GapUnit = GapUnit_DefaultValue = BoxplotSeriesIkhGapUnit.Relative;
			Label = Label_DefaultValue = new BoxplotSeriesIkhLabel();
			DataGrouping = DataGrouping_DefaultValue = new BoxplotSeriesIkhDataGrouping();
			LineWidth = LineWidth_DefaultValue = 2;
			AllowPointSelect = AllowPointSelect_DefaultValue = false;
			ShowCheckbox = ShowCheckbox_DefaultValue = false;
			Animation = Animation_DefaultValue = new Animation() { Enabled = true };
			Events = Events_DefaultValue = new BoxplotSeriesIkhEvents();
			Marker = Marker_DefaultValue = new BoxplotSeriesIkhMarker();
			Point = Point_DefaultValue = new BoxplotSeriesIkhPoint();
			DataLabels = DataLabels_DefaultValue = new BoxplotSeriesIkhDataLabels();
			CropThreshold = CropThreshold_DefaultValue = 300;
			SoftThreshold = SoftThreshold_DefaultValue = true;
			States = States_DefaultValue = new BoxplotSeriesIkhStates();
			StickyTracking = StickyTracking_DefaultValue = null;
			TurboThreshold = TurboThreshold_DefaultValue = 1000;
			FindNearestPointBy = FindNearestPointBy_DefaultValue = BoxplotSeriesIkhFindNearestPointBy.X;
			AnimationLimit = AnimationLimit_DefaultValue = null;
			ClassName = ClassName_DefaultValue = null;
			Color = Color_DefaultValue = null;
			ColorIndex = ColorIndex_DefaultValue = null;
			ConnectNulls = ConnectNulls_DefaultValue = false;
			Cursor = Cursor_DefaultValue = BoxplotSeriesIkhCursor.Null;
			DashStyle = DashStyle_DefaultValue = BoxplotSeriesIkhDashStyle.Solid;
			...
			Step = Step_DefaultValue = BoxplotSeriesIkhStep.Null;
			Threshold = Threshold_DefaultValue = 0;
			Visible = Visible_DefaultValue = true;
			ZoneAxis = ZoneAxis_DefaultValue = "y";
			Zones = Zones_DefaultValue = new List<BoxplotSeriesIkhZone>();
			...
			PointIntervalUnit = PointIntervalUnit_DefaultValue = BoxplotSeriesIkhPointIntervalUnit.Null;
			PointPlacement = PointPlacement_DefaultValue = new PointPlacement();
			PointStart = PointStart_DefaultValue = 0;
			Stacking = Stacking_DefaultValue = BoxplotSeriesIkhStacking.Null;
			Compare = Compare_DefaultValue = "undefined";
			CompareBase = CompareBase_DefaultValue = BoxplotSeriesIkhCompareBase.Min;
		...
		/// </summary>
		public BoxplotSeriesIkhTooltip Tooltip { get; set; }
		private BoxplotSeriesIkhTooltip Tooltip_DefaultValue { get; set; }
		...
		/// 
		/// </summary>
		public BoxplotSeriesIkhParams Params { get; set; }
		private BoxplotSeriesIkhParams Params_DefaultValue { get; set; }
		...
		/// </summary>
		public BoxplotSeriesIkhLinecap Linecap { get; set; }
		private BoxplotSeriesIkhLinecap Linecap_DefaultValue { get; set; }
		...
		/// </summary>
		public BoxplotSeriesIkhGapUnit GapUnit { get; set; }
		private BoxplotSeriesIkhGapUnit GapUnit_DefaultValue { get; set; }
		...
		/// </summary>
		public BoxplotSeriesIkhLabel Label { get; set; }
		private BoxplotSeriesIkhLabel Label_DefaultValue { get; set; }
		...
		/// </summary>
		public BoxplotSeriesIkhDataGrouping DataGrouping { get; set; }
		private BoxplotSeriesIkhDataGrouping DataGrouping_DefaultValue { get; set; }
		...
		/// </summary>
		public BoxplotSeriesIkhEvents Events { get; set; }
		private BoxplotSeriesIkhEvents Events_DefaultValue { get; set; }
		...
		/// </summary>
		public BoxplotSeriesIkhMarker Marker { get; set; }
		private BoxplotSeriesIkhMarker Marker_DefaultValue { get; set; }
		 

		/// <summary>
		/// <p>Properties for each single point.</p>
		/// </summary>
		public BoxplotSeriesIkhPoint Point { get; set; }
		private BoxplotSeriesIkhPoint Point_DefaultValue { get; set; }
		...
		/// </summary>
		public BoxplotSeriesIkhDataLabels DataLabels { get; set; }
		private BoxplotSeriesIkhDataLabels DataLabels_DefaultValue { get; set; }
		...
		/// </summary>
		public BoxplotSeriesIkhStates States { get; set; }
		private BoxplotSeriesIkhStates States_DefaultValue { get; set; }
		...
		/// </summary>
		public BoxplotSeriesIkhFindNearestPointBy FindNearestPointBy { get; set; }
		private BoxplotSeriesIkhFindNearestPointBy FindNearestPointBy_DefaultValue { get; set; }
		...
		/// </summary>
		public BoxplotSeriesIkhCursor Cursor { get; set; }
		private BoxplotSeriesIkhCursor Cursor_DefaultValue { get; set; }
		...
		/// </summary>
		public BoxplotSeriesIkhDashStyle DashStyle { get; set; }
		private BoxplotSeriesIkhDashStyle DashStyle_DefaultValue { get; set; }
		...
		/// </summary>
		public BoxplotSeriesIkhStep Step { get; set; }
		private BoxplotSeriesIkhStep Step_DefaultValue { get; set; }
		...
		/// </summary>
		public List<BoxplotSeriesIkhZone> Zones { get; set; }
		private List<BoxplotSeriesIkhZone> Zones_DefaultValue { get; set; }
		...
		/// </summary>
		public BoxplotSeriesIkhPointIntervalUnit PointIntervalUnit { get; set; }
		private BoxplotSeriesIkhPointIntervalUnit PointIntervalUnit_DefaultValue { get; set; }
		...
		/// </summary>
		public BoxplotSeriesIkhStacking Stacking { get; set; }
		private BoxplotSeriesIkhStacking Stacking_DefaultValue { get; set; }
		...
		/// </summary>
		public BoxplotSeriesIkhCompareBase CompareBase { get; set; }
		private BoxplotSeriesIkhCompareBase CompareBase_DefaultValue { get; set; }
		...
		internal override Hashtable ToHashtable()
		{
			...
			if (PointDescriptionFormatter != PointDescriptionFormatter_DefaultValue) { h.Add("pointDescriptionFormatter",PointDescriptionFormatter); Highstock.AddFunction("BoxplotSeriesIkhPointDescriptionFormatter.pointDescriptionFormatter", PointDescriptionFormatter); }  
