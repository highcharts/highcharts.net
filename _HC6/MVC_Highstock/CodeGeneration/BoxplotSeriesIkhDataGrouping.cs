...
{
	public partial class BoxplotSeriesIkhDataGrouping  : BaseObject
	{
		...
		/// </summary>
		public BoxplotSeriesIkhDataGroupingApproximation Approximation { get; set; }
		private BoxplotSeriesIkhDataGroupingApproximation Approximation_DefaultValue { get; set; }
