...
{
	public partial class BoxplotSeriesIkhDataLabels  : BaseObject
	{
		public BoxplotSeriesIkhDataLabels()
		{
			Align = Align_DefaultValue = BoxplotSeriesIkhDataLabelsAlign.Center;
			Formatter = Formatter_DefaultValue = "";
			Style = Style_DefaultValue = new BoxplotSeriesIkhDataLabelsStyle();
			VerticalAlign = VerticalAlign_DefaultValue = BoxplotSeriesIkhDataLabelsVerticalAlign.Bottom;
			X = X_DefaultValue = 0;
			Y = Y_DefaultValue = -6;
			...
			Overflow = Overflow_DefaultValue = BoxplotSeriesIkhDataLabelsOverflow.Justify;
		...
		/// </summary>
		public BoxplotSeriesIkhDataLabelsAlign Align { get; set; }
		private BoxplotSeriesIkhDataLabelsAlign Align_DefaultValue { get; set; }
		...
		/// </summary>
		public BoxplotSeriesIkhDataLabelsStyle Style { get; set; }
		private BoxplotSeriesIkhDataLabelsStyle Style_DefaultValue { get; set; }
		...
		/// </summary>
		public BoxplotSeriesIkhDataLabelsVerticalAlign VerticalAlign { get; set; }
		private BoxplotSeriesIkhDataLabelsVerticalAlign VerticalAlign_DefaultValue { get; set; }
		...
		/// </summary>
		public BoxplotSeriesIkhDataLabelsOverflow Overflow { get; set; }
		private BoxplotSeriesIkhDataLabelsOverflow Overflow_DefaultValue { get; set; }
		...
		internal override Hashtable ToHashtable()
		{
			...
			if (Formatter != Formatter_DefaultValue) { h.Add("formatter",Formatter); Highstock.AddFunction("BoxplotSeriesIkhDataLabelsFormatter.formatter", Formatter); }  
