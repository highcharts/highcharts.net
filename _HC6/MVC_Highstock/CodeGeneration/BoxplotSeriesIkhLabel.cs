...
{
	public partial class BoxplotSeriesIkhLabel  : BaseObject
	{
		public BoxplotSeriesIkhLabel()
		{
			...
			Style = Style_DefaultValue = new BoxplotSeriesIkhLabelStyle();
		...
		/// </summary>
		public BoxplotSeriesIkhLabelStyle Style { get; set; }
		private BoxplotSeriesIkhLabelStyle Style_DefaultValue { get; set; }
