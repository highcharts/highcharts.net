...
{
	public partial class BoxplotSeriesIkhStatesHover  : BaseObject
	{
		public BoxplotSeriesIkhStatesHover()
		{
			LineWidthPlus = LineWidthPlus_DefaultValue = 1;
			Marker = Marker_DefaultValue = new BoxplotSeriesIkhStatesHoverMarker();
			Halo = Halo_DefaultValue = new BoxplotSeriesIkhStatesHoverHalo();
		...
		/// </summary>
		public BoxplotSeriesIkhStatesHoverMarker Marker { get; set; }
		private BoxplotSeriesIkhStatesHoverMarker Marker_DefaultValue { get; set; }
		...
		/// </summary>
		public BoxplotSeriesIkhStatesHoverHalo Halo { get; set; }
		private BoxplotSeriesIkhStatesHoverHalo Halo_DefaultValue { get; set; }
