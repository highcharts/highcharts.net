...
{
	public partial class BoxplotSeriesIkhStatesHoverMarker  : BaseObject
	{
		public BoxplotSeriesIkhStatesHoverMarker()
		{
			LineWidth = LineWidth_DefaultValue = 0;
			LineColor = LineColor_DefaultValue = "#ffffff";
			Radius = Radius_DefaultValue = 4;
			States = States_DefaultValue = new BoxplotSeriesIkhStatesHoverMarkerStates();
		...
		/// </summary>
		public BoxplotSeriesIkhStatesHoverMarkerStates States { get; set; }
		private BoxplotSeriesIkhStatesHoverMarkerStates States_DefaultValue { get; set; }
