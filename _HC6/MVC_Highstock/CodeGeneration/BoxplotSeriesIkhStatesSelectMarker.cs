...
{
	public partial class BoxplotSeriesIkhStatesSelectMarker  : BaseObject
	{
		public BoxplotSeriesIkhStatesSelectMarker()
		{
			LineWidth = LineWidth_DefaultValue = 0;
			LineColor = LineColor_DefaultValue = "#ffffff";
			Radius = Radius_DefaultValue = 4;
			States = States_DefaultValue = new BoxplotSeriesIkhStatesSelectMarkerStates();
		...
		/// </summary>
		public BoxplotSeriesIkhStatesSelectMarkerStates States { get; set; }
		private BoxplotSeriesIkhStatesSelectMarkerStates States_DefaultValue { get; set; }
