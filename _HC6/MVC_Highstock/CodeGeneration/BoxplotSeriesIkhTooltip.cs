...
{
	public partial class BoxplotSeriesIkhTooltip  : BaseObject
	{
		public BoxplotSeriesIkhTooltip()
		{
			ValueDecimals = ValueDecimals_DefaultValue = null;
			DateTimeLabelFormats = DateTimeLabelFormats_DefaultValue = new BoxplotSeriesIkhTooltipDateTimeLabelFormats();
		...
		/// </summary>
		public BoxplotSeriesIkhTooltipDateTimeLabelFormats DateTimeLabelFormats { get; set; }
		private BoxplotSeriesIkhTooltipDateTimeLabelFormats DateTimeLabelFormats_DefaultValue { get; set; }
		...
		internal override Hashtable ToHashtable()
		{
			...
			if (PointFormatter != PointFormatter_DefaultValue) { h.Add("pointFormatter",PointFormatter); Highstock.AddFunction("BoxplotSeriesIkhTooltipPointFormatter.pointFormatter", PointFormatter); }  
