...
{
	public partial class BoxplotSeriesMarker  : BaseObject
	{
		public BoxplotSeriesMarker()
		{
			LineWidth = LineWidth_DefaultValue = 0;
			LineColor = LineColor_DefaultValue = "#ffffff";
			Radius = Radius_DefaultValue = 4;
			States = States_DefaultValue = new BoxplotSeriesMarkerStates();
		...
		/// </summary>
		public BoxplotSeriesMarkerStates States { get; set; }
		private BoxplotSeriesMarkerStates States_DefaultValue { get; set; }
