...
namespace Highsoft.Web.Mvc.Stocks
{
	public partial class BubbleSeries  : Series
	{
		public BubbleSeries()
		{
			...
			NavigatorOptions = NavigatorOptions_DefaultValue = new BubbleSeriesNavigatorOptions();
		...
		/// </summary>
		public BubbleSeriesNavigatorOptions NavigatorOptions { get; set; }
		private BubbleSeriesNavigatorOptions NavigatorOptions_DefaultValue { get; set; }
