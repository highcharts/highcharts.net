...
{
	public partial class BubbleSeriesDataGrouping  : BaseObject
	{
		public BubbleSeriesDataGrouping()
		{
			Approximation = Approximation_DefaultValue = BubbleSeriesDataGroupingApproximation.Average;
		...
		/// </summary>
		public BubbleSeriesDataGroupingApproximation Approximation { get; set; }
		private BubbleSeriesDataGroupingApproximation Approximation_DefaultValue { get; set; }
		...
		/// </summary>
		public BubbleSeriesDataGroupingUnits Units { get; set; }
		private BubbleSeriesDataGroupingUnits Units_DefaultValue { get; set; }
