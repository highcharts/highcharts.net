...
{
	public partial class BubbleSeriesIkh  : BaseObject
	{
		public BubbleSeriesIkh()
		{
			Name = Name_DefaultValue = "SMA (14)";
			Tooltip = Tooltip_DefaultValue = new BubbleSeriesIkhTooltip();
			LinkedTo = LinkedTo_DefaultValue = null;
			Params = Params_DefaultValue = new BubbleSeriesIkhParams();
			Linecap = Linecap_DefaultValue = BubbleSeriesIkhLinecap.Round;
			BoostThreshold = BoostThreshold_DefaultValue = 5000;
			GapSize = GapSize_DefaultValue = 0;
			GapUnit = GapUnit_DefaultValue = BubbleSeriesIkhGapUnit.Relative;
			Label = Label_DefaultValue = new BubbleSeriesIkhLabel();
			DataGrouping = DataGrouping_DefaultValue = new BubbleSeriesIkhDataGrouping();
			LineWidth = LineWidth_DefaultValue = 2;
			AllowPointSelect = AllowPointSelect_DefaultValue = false;
			ShowCheckbox = ShowCheckbox_DefaultValue = false;
			Animation = Animation_DefaultValue = new Animation() { Enabled = true };
			Events = Events_DefaultValue = new BubbleSeriesIkhEvents();
			Marker = Marker_DefaultValue = new BubbleSeriesIkhMarker();
			Point = Point_DefaultValue = new BubbleSeriesIkhPoint();
			DataLabels = DataLabels_DefaultValue = new BubbleSeriesIkhDataLabels();
			CropThreshold = CropThreshold_DefaultValue = 300;
			SoftThreshold = SoftThreshold_DefaultValue = true;
			States = States_DefaultValue = new BubbleSeriesIkhStates();
			StickyTracking = StickyTracking_DefaultValue = null;
			TurboThreshold = TurboThreshold_DefaultValue = 1000;
			FindNearestPointBy = FindNearestPointBy_DefaultValue = BubbleSeriesIkhFindNearestPointBy.X;
			AnimationLimit = AnimationLimit_DefaultValue = null;
			ClassName = ClassName_DefaultValue = null;
			Color = Color_DefaultValue = null;
			ColorIndex = ColorIndex_DefaultValue = null;
			ConnectNulls = ConnectNulls_DefaultValue = false;
			Cursor = Cursor_DefaultValue = BubbleSeriesIkhCursor.Null;
			DashStyle = DashStyle_DefaultValue = BubbleSeriesIkhDashStyle.Solid;
			...
			Step = Step_DefaultValue = BubbleSeriesIkhStep.Null;
			Threshold = Threshold_DefaultValue = 0;
			Visible = Visible_DefaultValue = true;
			ZoneAxis = ZoneAxis_DefaultValue = "y";
			Zones = Zones_DefaultValue = new List<BubbleSeriesIkhZone>();
			...
			PointIntervalUnit = PointIntervalUnit_DefaultValue = BubbleSeriesIkhPointIntervalUnit.Null;
			PointPlacement = PointPlacement_DefaultValue = new PointPlacement();
			PointStart = PointStart_DefaultValue = 0;
			Stacking = Stacking_DefaultValue = BubbleSeriesIkhStacking.Null;
			Compare = Compare_DefaultValue = "undefined";
			CompareBase = CompareBase_DefaultValue = BubbleSeriesIkhCompareBase.Min;
		...
		/// </summary>
		public BubbleSeriesIkhTooltip Tooltip { get; set; }
		private BubbleSeriesIkhTooltip Tooltip_DefaultValue { get; set; }
		...
		/// 
		/// </summary>
		public BubbleSeriesIkhParams Params { get; set; }
		private BubbleSeriesIkhParams Params_DefaultValue { get; set; }
		...
		/// </summary>
		public BubbleSeriesIkhLinecap Linecap { get; set; }
		private BubbleSeriesIkhLinecap Linecap_DefaultValue { get; set; }
		...
		/// </summary>
		public BubbleSeriesIkhGapUnit GapUnit { get; set; }
		private BubbleSeriesIkhGapUnit GapUnit_DefaultValue { get; set; }
		...
		/// </summary>
		public BubbleSeriesIkhLabel Label { get; set; }
		private BubbleSeriesIkhLabel Label_DefaultValue { get; set; }
		...
		/// </summary>
		public BubbleSeriesIkhDataGrouping DataGrouping { get; set; }
		private BubbleSeriesIkhDataGrouping DataGrouping_DefaultValue { get; set; }
		...
		/// </summary>
		public BubbleSeriesIkhEvents Events { get; set; }
		private BubbleSeriesIkhEvents Events_DefaultValue { get; set; }
		...
		/// </summary>
		public BubbleSeriesIkhMarker Marker { get; set; }
		private BubbleSeriesIkhMarker Marker_DefaultValue { get; set; }
		 

		/// <summary>
		/// <p>Properties for each single point.</p>
		/// </summary>
		public BubbleSeriesIkhPoint Point { get; set; }
		private BubbleSeriesIkhPoint Point_DefaultValue { get; set; }
		...
		/// </summary>
		public BubbleSeriesIkhDataLabels DataLabels { get; set; }
		private BubbleSeriesIkhDataLabels DataLabels_DefaultValue { get; set; }
		...
		/// </summary>
		public BubbleSeriesIkhStates States { get; set; }
		private BubbleSeriesIkhStates States_DefaultValue { get; set; }
		...
		/// </summary>
		public BubbleSeriesIkhFindNearestPointBy FindNearestPointBy { get; set; }
		private BubbleSeriesIkhFindNearestPointBy FindNearestPointBy_DefaultValue { get; set; }
		...
		/// </summary>
		public BubbleSeriesIkhCursor Cursor { get; set; }
		private BubbleSeriesIkhCursor Cursor_DefaultValue { get; set; }
		...
		/// </summary>
		public BubbleSeriesIkhDashStyle DashStyle { get; set; }
		private BubbleSeriesIkhDashStyle DashStyle_DefaultValue { get; set; }
		...
		/// </summary>
		public BubbleSeriesIkhStep Step { get; set; }
		private BubbleSeriesIkhStep Step_DefaultValue { get; set; }
		...
		/// </summary>
		public List<BubbleSeriesIkhZone> Zones { get; set; }
		private List<BubbleSeriesIkhZone> Zones_DefaultValue { get; set; }
		...
		/// </summary>
		public BubbleSeriesIkhPointIntervalUnit PointIntervalUnit { get; set; }
		private BubbleSeriesIkhPointIntervalUnit PointIntervalUnit_DefaultValue { get; set; }
		...
		/// </summary>
		public BubbleSeriesIkhStacking Stacking { get; set; }
		private BubbleSeriesIkhStacking Stacking_DefaultValue { get; set; }
		...
		/// </summary>
		public BubbleSeriesIkhCompareBase CompareBase { get; set; }
		private BubbleSeriesIkhCompareBase CompareBase_DefaultValue { get; set; }
		...
		internal override Hashtable ToHashtable()
		{
			...
			if (PointDescriptionFormatter != PointDescriptionFormatter_DefaultValue) { h.Add("pointDescriptionFormatter",PointDescriptionFormatter); Highstock.AddFunction("BubbleSeriesIkhPointDescriptionFormatter.pointDescriptionFormatter", PointDescriptionFormatter); }  
