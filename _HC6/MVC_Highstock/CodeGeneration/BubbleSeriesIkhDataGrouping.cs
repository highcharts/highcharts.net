...
{
	public partial class BubbleSeriesIkhDataGrouping  : BaseObject
	{
		public BubbleSeriesIkhDataGrouping()
		{
			Approximation = Approximation_DefaultValue = BubbleSeriesIkhDataGroupingApproximation.Average;
		...
		/// </summary>
		public BubbleSeriesIkhDataGroupingApproximation Approximation { get; set; }
		private BubbleSeriesIkhDataGroupingApproximation Approximation_DefaultValue { get; set; }
