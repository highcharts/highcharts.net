...
{
	public partial class BubbleSeriesIkhDataLabels  : BaseObject
	{
		public BubbleSeriesIkhDataLabels()
		{
			Align = Align_DefaultValue = BubbleSeriesIkhDataLabelsAlign.Center;
			Formatter = Formatter_DefaultValue = "";
			Style = Style_DefaultValue = new BubbleSeriesIkhDataLabelsStyle();
			VerticalAlign = VerticalAlign_DefaultValue = BubbleSeriesIkhDataLabelsVerticalAlign.Bottom;
			X = X_DefaultValue = 0;
			Y = Y_DefaultValue = -6;
			...
			Overflow = Overflow_DefaultValue = BubbleSeriesIkhDataLabelsOverflow.Justify;
		...
		/// </summary>
		public BubbleSeriesIkhDataLabelsAlign Align { get; set; }
		private BubbleSeriesIkhDataLabelsAlign Align_DefaultValue { get; set; }
		...
		/// </summary>
		public BubbleSeriesIkhDataLabelsStyle Style { get; set; }
		private BubbleSeriesIkhDataLabelsStyle Style_DefaultValue { get; set; }
		...
		/// </summary>
		public BubbleSeriesIkhDataLabelsVerticalAlign VerticalAlign { get; set; }
		private BubbleSeriesIkhDataLabelsVerticalAlign VerticalAlign_DefaultValue { get; set; }
		...
		/// </summary>
		public BubbleSeriesIkhDataLabelsOverflow Overflow { get; set; }
		private BubbleSeriesIkhDataLabelsOverflow Overflow_DefaultValue { get; set; }
		...
		internal override Hashtable ToHashtable()
		{
			...
			if (Formatter != Formatter_DefaultValue) { h.Add("formatter",Formatter); Highstock.AddFunction("BubbleSeriesIkhDataLabelsFormatter.formatter", Formatter); }  
