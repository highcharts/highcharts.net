...
{
	public partial class BubbleSeriesIkhLabel  : BaseObject
	{
		public BubbleSeriesIkhLabel()
		{
			...
			Style = Style_DefaultValue = new BubbleSeriesIkhLabelStyle();
		...
		/// </summary>
		public BubbleSeriesIkhLabelStyle Style { get; set; }
		private BubbleSeriesIkhLabelStyle Style_DefaultValue { get; set; }
