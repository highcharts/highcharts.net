...
{
	public partial class BubbleSeriesIkhStatesHover  : BaseObject
	{
		public BubbleSeriesIkhStatesHover()
		{
			LineWidthPlus = LineWidthPlus_DefaultValue = 1;
			Marker = Marker_DefaultValue = new BubbleSeriesIkhStatesHoverMarker();
			Halo = Halo_DefaultValue = new BubbleSeriesIkhStatesHoverHalo();
		...
		/// </summary>
		public BubbleSeriesIkhStatesHoverMarker Marker { get; set; }
		private BubbleSeriesIkhStatesHoverMarker Marker_DefaultValue { get; set; }
		...
		/// </summary>
		public BubbleSeriesIkhStatesHoverHalo Halo { get; set; }
		private BubbleSeriesIkhStatesHoverHalo Halo_DefaultValue { get; set; }
