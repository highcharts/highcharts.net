...
{
	public partial class BubbleSeriesIkhTooltip  : BaseObject
	{
		public BubbleSeriesIkhTooltip()
		{
			ValueDecimals = ValueDecimals_DefaultValue = null;
			DateTimeLabelFormats = DateTimeLabelFormats_DefaultValue = new BubbleSeriesIkhTooltipDateTimeLabelFormats();
		...
		/// </summary>
		public BubbleSeriesIkhTooltipDateTimeLabelFormats DateTimeLabelFormats { get; set; }
		private BubbleSeriesIkhTooltipDateTimeLabelFormats DateTimeLabelFormats_DefaultValue { get; set; }
		...
		internal override Hashtable ToHashtable()
		{
			...
			if (PointFormatter != PointFormatter_DefaultValue) { h.Add("pointFormatter",PointFormatter); Highstock.AddFunction("BubbleSeriesIkhTooltipPointFormatter.pointFormatter", PointFormatter); }  
