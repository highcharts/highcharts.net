...
namespace Highsoft.Web.Mvc.Stocks
{
	public partial class BubbleSeriesTooltip  : BaseObject
	{
		public BubbleSeriesTooltip()
		{
			...
			DateTimeLabelFormats = DateTimeLabelFormats_DefaultValue = new BubbleSeriesTooltipDateTimeLabelFormats();
		...
		/// </summary>
		public BubbleSeriesTooltipDateTimeLabelFormats DateTimeLabelFormats { get; set; }
		private BubbleSeriesTooltipDateTimeLabelFormats DateTimeLabelFormats_DefaultValue { get; set; }
