...
{
	public partial class BulletSeriesDataGrouping  : BaseObject
	{
		public BulletSeriesDataGrouping()
		{
			GroupPixelWidth = GroupPixelWidth_DefaultValue = 10;
			Approximation = Approximation_DefaultValue = BulletSeriesDataGroupingApproximation.Average;
		...
		/// </summary>
		public BulletSeriesDataGroupingApproximation Approximation { get; set; }
		private BulletSeriesDataGroupingApproximation Approximation_DefaultValue { get; set; }
