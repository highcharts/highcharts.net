...
{
	public partial class BulletSeriesIkh  : BaseObject
	{
		public BulletSeriesIkh()
		{
			Name = Name_DefaultValue = "SMA (14)";
			Tooltip = Tooltip_DefaultValue = new BulletSeriesIkhTooltip();
			LinkedTo = LinkedTo_DefaultValue = null;
			Params = Params_DefaultValue = new BulletSeriesIkhParams();
			Linecap = Linecap_DefaultValue = BulletSeriesIkhLinecap.Round;
			BoostThreshold = BoostThreshold_DefaultValue = 5000;
			GapSize = GapSize_DefaultValue = 0;
			GapUnit = GapUnit_DefaultValue = BulletSeriesIkhGapUnit.Relative;
			Label = Label_DefaultValue = new BulletSeriesIkhLabel();
			DataGrouping = DataGrouping_DefaultValue = new BulletSeriesIkhDataGrouping();
			LineWidth = LineWidth_DefaultValue = 2;
			AllowPointSelect = AllowPointSelect_DefaultValue = false;
			ShowCheckbox = ShowCheckbox_DefaultValue = false;
			Animation = Animation_DefaultValue = new Animation() { Enabled = true };
			Events = Events_DefaultValue = new BulletSeriesIkhEvents();
			Marker = Marker_DefaultValue = new BulletSeriesIkhMarker();
			Point = Point_DefaultValue = new BulletSeriesIkhPoint();
			DataLabels = DataLabels_DefaultValue = new BulletSeriesIkhDataLabels();
			CropThreshold = CropThreshold_DefaultValue = 300;
			SoftThreshold = SoftThreshold_DefaultValue = true;
			States = States_DefaultValue = new BulletSeriesIkhStates();
			StickyTracking = StickyTracking_DefaultValue = null;
			TurboThreshold = TurboThreshold_DefaultValue = 1000;
			FindNearestPointBy = FindNearestPointBy_DefaultValue = BulletSeriesIkhFindNearestPointBy.X;
			AnimationLimit = AnimationLimit_DefaultValue = null;
			ClassName = ClassName_DefaultValue = null;
			Color = Color_DefaultValue = null;
			ColorIndex = ColorIndex_DefaultValue = null;
			ConnectNulls = ConnectNulls_DefaultValue = false;
			Cursor = Cursor_DefaultValue = BulletSeriesIkhCursor.Null;
			DashStyle = DashStyle_DefaultValue = BulletSeriesIkhDashStyle.Solid;
			...
			Step = Step_DefaultValue = BulletSeriesIkhStep.Null;
			Threshold = Threshold_DefaultValue = 0;
			Visible = Visible_DefaultValue = true;
			ZoneAxis = ZoneAxis_DefaultValue = "y";
			Zones = Zones_DefaultValue = new List<BulletSeriesIkhZone>();
			...
			PointIntervalUnit = PointIntervalUnit_DefaultValue = BulletSeriesIkhPointIntervalUnit.Null;
			PointPlacement = PointPlacement_DefaultValue = new PointPlacement();
			PointStart = PointStart_DefaultValue = 0;
			Stacking = Stacking_DefaultValue = BulletSeriesIkhStacking.Null;
			Compare = Compare_DefaultValue = "undefined";
			CompareBase = CompareBase_DefaultValue = BulletSeriesIkhCompareBase.Min;
		...
		/// </summary>
		public BulletSeriesIkhTooltip Tooltip { get; set; }
		private BulletSeriesIkhTooltip Tooltip_DefaultValue { get; set; }
		...
		/// 
		/// </summary>
		public BulletSeriesIkhParams Params { get; set; }
		private BulletSeriesIkhParams Params_DefaultValue { get; set; }
		...
		/// </summary>
		public BulletSeriesIkhLinecap Linecap { get; set; }
		private BulletSeriesIkhLinecap Linecap_DefaultValue { get; set; }
		...
		/// </summary>
		public BulletSeriesIkhGapUnit GapUnit { get; set; }
		private BulletSeriesIkhGapUnit GapUnit_DefaultValue { get; set; }
		...
		/// </summary>
		public BulletSeriesIkhLabel Label { get; set; }
		private BulletSeriesIkhLabel Label_DefaultValue { get; set; }
		...
		/// </summary>
		public BulletSeriesIkhDataGrouping DataGrouping { get; set; }
		private BulletSeriesIkhDataGrouping DataGrouping_DefaultValue { get; set; }
		...
		/// </summary>
		public BulletSeriesIkhEvents Events { get; set; }
		private BulletSeriesIkhEvents Events_DefaultValue { get; set; }
		...
		/// </summary>
		public BulletSeriesIkhMarker Marker { get; set; }
		private BulletSeriesIkhMarker Marker_DefaultValue { get; set; }
		 

		/// <summary>
		/// <p>Properties for each single point.</p>
		/// </summary>
		public BulletSeriesIkhPoint Point { get; set; }
		private BulletSeriesIkhPoint Point_DefaultValue { get; set; }
		...
		/// </summary>
		public BulletSeriesIkhDataLabels DataLabels { get; set; }
		private BulletSeriesIkhDataLabels DataLabels_DefaultValue { get; set; }
		...
		/// </summary>
		public BulletSeriesIkhStates States { get; set; }
		private BulletSeriesIkhStates States_DefaultValue { get; set; }
		...
		/// </summary>
		public BulletSeriesIkhFindNearestPointBy FindNearestPointBy { get; set; }
		private BulletSeriesIkhFindNearestPointBy FindNearestPointBy_DefaultValue { get; set; }
		...
		/// </summary>
		public BulletSeriesIkhCursor Cursor { get; set; }
		private BulletSeriesIkhCursor Cursor_DefaultValue { get; set; }
		...
		/// </summary>
		public BulletSeriesIkhDashStyle DashStyle { get; set; }
		private BulletSeriesIkhDashStyle DashStyle_DefaultValue { get; set; }
		...
		/// </summary>
		public BulletSeriesIkhStep Step { get; set; }
		private BulletSeriesIkhStep Step_DefaultValue { get; set; }
		...
		/// </summary>
		public List<BulletSeriesIkhZone> Zones { get; set; }
		private List<BulletSeriesIkhZone> Zones_DefaultValue { get; set; }
		...
		/// </summary>
		public BulletSeriesIkhPointIntervalUnit PointIntervalUnit { get; set; }
		private BulletSeriesIkhPointIntervalUnit PointIntervalUnit_DefaultValue { get; set; }
		...
		/// </summary>
		public BulletSeriesIkhStacking Stacking { get; set; }
		private BulletSeriesIkhStacking Stacking_DefaultValue { get; set; }
		...
		/// </summary>
		public BulletSeriesIkhCompareBase CompareBase { get; set; }
		private BulletSeriesIkhCompareBase CompareBase_DefaultValue { get; set; }
		...
		internal override Hashtable ToHashtable()
		{
			...
			if (PointDescriptionFormatter != PointDescriptionFormatter_DefaultValue) { h.Add("pointDescriptionFormatter",PointDescriptionFormatter); Highstock.AddFunction("BulletSeriesIkhPointDescriptionFormatter.pointDescriptionFormatter", PointDescriptionFormatter); }  
