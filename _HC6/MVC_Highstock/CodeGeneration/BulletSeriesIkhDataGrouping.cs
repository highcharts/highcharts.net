...
{
	public partial class BulletSeriesIkhDataGrouping  : BaseObject
	{
		public BulletSeriesIkhDataGrouping()
		{
			Approximation = Approximation_DefaultValue = BulletSeriesIkhDataGroupingApproximation.Average;
		...
		/// </summary>
		public BulletSeriesIkhDataGroupingApproximation Approximation { get; set; }
		private BulletSeriesIkhDataGroupingApproximation Approximation_DefaultValue { get; set; }
