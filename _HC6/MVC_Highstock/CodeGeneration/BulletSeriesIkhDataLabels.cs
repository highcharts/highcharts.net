...
{
	public partial class BulletSeriesIkhDataLabels  : BaseObject
	{
		public BulletSeriesIkhDataLabels()
		{
			Align = Align_DefaultValue = BulletSeriesIkhDataLabelsAlign.Center;
			Formatter = Formatter_DefaultValue = "";
			Style = Style_DefaultValue = new BulletSeriesIkhDataLabelsStyle();
			VerticalAlign = VerticalAlign_DefaultValue = BulletSeriesIkhDataLabelsVerticalAlign.Bottom;
			X = X_DefaultValue = 0;
			Y = Y_DefaultValue = -6;
			...
			Overflow = Overflow_DefaultValue = BulletSeriesIkhDataLabelsOverflow.Justify;
		...
		/// </summary>
		public BulletSeriesIkhDataLabelsAlign Align { get; set; }
		private BulletSeriesIkhDataLabelsAlign Align_DefaultValue { get; set; }
		...
		/// </summary>
		public BulletSeriesIkhDataLabelsStyle Style { get; set; }
		private BulletSeriesIkhDataLabelsStyle Style_DefaultValue { get; set; }
		...
		/// </summary>
		public BulletSeriesIkhDataLabelsVerticalAlign VerticalAlign { get; set; }
		private BulletSeriesIkhDataLabelsVerticalAlign VerticalAlign_DefaultValue { get; set; }
		...
		/// </summary>
		public BulletSeriesIkhDataLabelsOverflow Overflow { get; set; }
		private BulletSeriesIkhDataLabelsOverflow Overflow_DefaultValue { get; set; }
		...
		internal override Hashtable ToHashtable()
		{
			...
			if (Formatter != Formatter_DefaultValue) { h.Add("formatter",Formatter); Highstock.AddFunction("BulletSeriesIkhDataLabelsFormatter.formatter", Formatter); }  
