...
{
	public partial class BulletSeriesIkhLabel  : BaseObject
	{
		public BulletSeriesIkhLabel()
		{
			...
			Style = Style_DefaultValue = new BulletSeriesIkhLabelStyle();
		...
		/// </summary>
		public BulletSeriesIkhLabelStyle Style { get; set; }
		private BulletSeriesIkhLabelStyle Style_DefaultValue { get; set; }
