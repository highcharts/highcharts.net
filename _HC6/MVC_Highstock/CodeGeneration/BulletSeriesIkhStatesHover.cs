...
{
	public partial class BulletSeriesIkhStatesHover  : BaseObject
	{
		public BulletSeriesIkhStatesHover()
		{
			LineWidthPlus = LineWidthPlus_DefaultValue = 1;
			Marker = Marker_DefaultValue = new BulletSeriesIkhStatesHoverMarker();
			Halo = Halo_DefaultValue = new BulletSeriesIkhStatesHoverHalo();
		...
		/// </summary>
		public BulletSeriesIkhStatesHoverMarker Marker { get; set; }
		private BulletSeriesIkhStatesHoverMarker Marker_DefaultValue { get; set; }
		...
		/// </summary>
		public BulletSeriesIkhStatesHoverHalo Halo { get; set; }
		private BulletSeriesIkhStatesHoverHalo Halo_DefaultValue { get; set; }
