...
{
	public partial class BulletSeriesIkhStatesSelectMarker  : BaseObject
	{
		public BulletSeriesIkhStatesSelectMarker()
		{
			LineWidth = LineWidth_DefaultValue = 0;
			LineColor = LineColor_DefaultValue = "#ffffff";
			Radius = Radius_DefaultValue = 4;
			States = States_DefaultValue = new BulletSeriesIkhStatesSelectMarkerStates();
		...
		/// </summary>
		public BulletSeriesIkhStatesSelectMarkerStates States { get; set; }
		private BulletSeriesIkhStatesSelectMarkerStates States_DefaultValue { get; set; }
