...
{
	public partial class BulletSeriesIkhTooltip  : BaseObject
	{
		public BulletSeriesIkhTooltip()
		{
			ValueDecimals = ValueDecimals_DefaultValue = null;
			DateTimeLabelFormats = DateTimeLabelFormats_DefaultValue = new BulletSeriesIkhTooltipDateTimeLabelFormats();
		...
		/// </summary>
		public BulletSeriesIkhTooltipDateTimeLabelFormats DateTimeLabelFormats { get; set; }
		private BulletSeriesIkhTooltipDateTimeLabelFormats DateTimeLabelFormats_DefaultValue { get; set; }
		...
		internal override Hashtable ToHashtable()
		{
			...
			if (PointFormatter != PointFormatter_DefaultValue) { h.Add("pointFormatter",PointFormatter); Highstock.AddFunction("BulletSeriesIkhTooltipPointFormatter.pointFormatter", PointFormatter); }  
