...
{
	public partial class BulletSeriesStatesSelectMarker  : BaseObject
	{
		public BulletSeriesStatesSelectMarker()
		{
			LineWidth = LineWidth_DefaultValue = 0;
			LineColor = LineColor_DefaultValue = "#ffffff";
			Radius = Radius_DefaultValue = 4;
			States = States_DefaultValue = new BulletSeriesStatesSelectMarkerStates();
		...
		/// </summary>
		public BulletSeriesStatesSelectMarkerStates States { get; set; }
		private BulletSeriesStatesSelectMarkerStates States_DefaultValue { get; set; }
