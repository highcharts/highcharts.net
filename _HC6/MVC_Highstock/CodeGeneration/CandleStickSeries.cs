...
{
	public partial class CandleStickSeries  : BaseObject
	{
		public CandleStickSeries()
		{
			...
			Ikh = Ikh_DefaultValue = new CandleStickSeriesIkh();
			...
			Zones = Zones_DefaultValue = new CandleStickSeriesZone();
			...
			GapUnit = GapUnit_DefaultValue = CandleStickSeriesGapUnit.Relative;
			Marker = Marker_DefaultValue = new CandleStickSeriesMarker();
			ConnectNulls = ConnectNulls_DefaultValue = false;
			DashStyle = DashStyle_DefaultValue = CandleStickSeriesDashStyle.Solid;
			Linecap = Linecap_DefaultValue = CandleStickSeriesLinecap.Round;
			Step = Step_DefaultValue = CandleStickSeriesStep.Null;
		...
		/// </summary>
		public CandleStickSeriesIkh Ikh { get; set; }
		private CandleStickSeriesIkh Ikh_DefaultValue { get; set; }
		...
		/// <summary>
		/// <p>The color of the line/border of the candlestick.</p><p>In styled mode, the line stroke can be set with the <code>.highcharts-candlestick-series .highcahrts-point</code> rule.</p>
		/// </summary>
		...
		/// <summary>
		/// <p>The pixel width of the candlestick line/border. Defaults to <code>1</code>.</p><p>In styled mode, the line stroke width can be set with the <code>.highcharts-candlestick-series .highcahrts-point</code> rule.</p>
		/// </summary>
		...
		/// <summary>
		/// <p>The fill color of the candlestick when values are rising.</p><p>In styled mode, the up color can be set with the <code>.highcharts-candlestick-series .highcharts-point-up</code> rule.</p>
		/// </summary>
		...
		/// <summary>
		/// <p>The specific line color for up candle sticks. The default is to inheritthe general <code>lineColor</code> setting.</p>
		/// </summary>
		...
		/// </summary>
		public CandleStickSeriesZone Zones { get; set; }
		private CandleStickSeriesZone Zones_DefaultValue { get; set; }
		...
		/// </summary>
		public CandleStickSeriesGapUnit GapUnit { get; set; }
		private CandleStickSeriesGapUnit GapUnit_DefaultValue { get; set; }
		...
		/// </summary>
		public CandleStickSeriesLinecap Linecap { get; set; }
		private CandleStickSeriesLinecap Linecap_DefaultValue { get; set; }
		 

		/// <summary>
		/// <p>Whether to apply steps to the line. Possible values are <code>left</code>, <code>center</code>and <code>right</code>.</p>
		/// </summary>
		public CandleStickSeriesStep Step { get; set; }
		private CandleStickSeriesStep Step_DefaultValue { get; set; }
