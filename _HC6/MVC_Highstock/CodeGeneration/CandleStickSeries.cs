...
namespace Highsoft.Web.Mvc.Stocks
{
	public partial class CandlestickSeries  : Series
	{
		public CandlestickSeries()
		{
			...
			NavigatorOptions = NavigatorOptions_DefaultValue = new CandlestickSeriesNavigatorOptions();
		...
		/// </summary>
		public CandlestickSeriesNavigatorOptions NavigatorOptions { get; set; }
		private CandlestickSeriesNavigatorOptions NavigatorOptions_DefaultValue { get; set; }
