...
{
	public partial class CandlestickSeriesDataGrouping  : BaseObject
	{
		...
		/// </summary>
		public CandlestickSeriesDataGroupingApproximation Approximation { get; set; }
		private CandlestickSeriesDataGroupingApproximation Approximation_DefaultValue { get; set; }
		...
		/// </summary>
		public CandlestickSeriesDataGroupingUnits Units { get; set; }
		private CandlestickSeriesDataGroupingUnits Units_DefaultValue { get; set; }
