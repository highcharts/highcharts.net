...
{
	public partial class CandleStickSeriesIkh  : BaseObject
	{
		public CandleStickSeriesIkh()
		{
			Name = Name_DefaultValue = "SMA (14)";
			Tooltip = Tooltip_DefaultValue = new CandleStickSeriesIkhTooltip();
			LinkedTo = LinkedTo_DefaultValue = null;
			Params = Params_DefaultValue = new CandleStickSeriesIkhParams();
			Linecap = Linecap_DefaultValue = CandleStickSeriesIkhLinecap.Round;
			BoostThreshold = BoostThreshold_DefaultValue = 5000;
			GapSize = GapSize_DefaultValue = 0;
			GapUnit = GapUnit_DefaultValue = CandleStickSeriesIkhGapUnit.Relative;
			Label = Label_DefaultValue = new CandleStickSeriesIkhLabel();
			DataGrouping = DataGrouping_DefaultValue = new CandleStickSeriesIkhDataGrouping();
			LineWidth = LineWidth_DefaultValue = 2;
			AllowPointSelect = AllowPointSelect_DefaultValue = false;
			ShowCheckbox = ShowCheckbox_DefaultValue = false;
			Animation = Animation_DefaultValue = new Animation() { Enabled = true };
			Events = Events_DefaultValue = new CandleStickSeriesIkhEvents();
			Marker = Marker_DefaultValue = new CandleStickSeriesIkhMarker();
			Point = Point_DefaultValue = new CandleStickSeriesIkhPoint();
			DataLabels = DataLabels_DefaultValue = new CandleStickSeriesIkhDataLabels();
			CropThreshold = CropThreshold_DefaultValue = 300;
			SoftThreshold = SoftThreshold_DefaultValue = true;
			States = States_DefaultValue = new CandleStickSeriesIkhStates();
			StickyTracking = StickyTracking_DefaultValue = null;
			TurboThreshold = TurboThreshold_DefaultValue = 1000;
			FindNearestPointBy = FindNearestPointBy_DefaultValue = CandleStickSeriesIkhFindNearestPointBy.X;
			AnimationLimit = AnimationLimit_DefaultValue = null;
			ClassName = ClassName_DefaultValue = null;
			Color = Color_DefaultValue = null;
			ColorIndex = ColorIndex_DefaultValue = null;
			ConnectNulls = ConnectNulls_DefaultValue = false;
			Cursor = Cursor_DefaultValue = CandleStickSeriesIkhCursor.Null;
			DashStyle = DashStyle_DefaultValue = CandleStickSeriesIkhDashStyle.Solid;
			...
			Step = Step_DefaultValue = CandleStickSeriesIkhStep.Null;
			Threshold = Threshold_DefaultValue = 0;
			Visible = Visible_DefaultValue = true;
			ZoneAxis = ZoneAxis_DefaultValue = "y";
			Zones = Zones_DefaultValue = new List<CandleStickSeriesIkhZone>();
			...
			PointIntervalUnit = PointIntervalUnit_DefaultValue = CandleStickSeriesIkhPointIntervalUnit.Null;
			PointPlacement = PointPlacement_DefaultValue = new PointPlacement();
			PointStart = PointStart_DefaultValue = 0;
			Stacking = Stacking_DefaultValue = CandleStickSeriesIkhStacking.Null;
			Compare = Compare_DefaultValue = "undefined";
			CompareBase = CompareBase_DefaultValue = CandleStickSeriesIkhCompareBase.Min;
		...
		/// </summary>
		public CandleStickSeriesIkhTooltip Tooltip { get; set; }
		private CandleStickSeriesIkhTooltip Tooltip_DefaultValue { get; set; }
		...
		/// 
		/// </summary>
		public CandleStickSeriesIkhParams Params { get; set; }
		private CandleStickSeriesIkhParams Params_DefaultValue { get; set; }
		...
		/// </summary>
		public CandleStickSeriesIkhLinecap Linecap { get; set; }
		private CandleStickSeriesIkhLinecap Linecap_DefaultValue { get; set; }
		...
		/// </summary>
		public CandleStickSeriesIkhGapUnit GapUnit { get; set; }
		private CandleStickSeriesIkhGapUnit GapUnit_DefaultValue { get; set; }
		...
		/// </summary>
		public CandleStickSeriesIkhLabel Label { get; set; }
		private CandleStickSeriesIkhLabel Label_DefaultValue { get; set; }
		...
		/// </summary>
		public CandleStickSeriesIkhDataGrouping DataGrouping { get; set; }
		private CandleStickSeriesIkhDataGrouping DataGrouping_DefaultValue { get; set; }
		...
		/// </summary>
		public CandleStickSeriesIkhEvents Events { get; set; }
		private CandleStickSeriesIkhEvents Events_DefaultValue { get; set; }
		...
		/// </summary>
		public CandleStickSeriesIkhMarker Marker { get; set; }
		private CandleStickSeriesIkhMarker Marker_DefaultValue { get; set; }
		 

		/// <summary>
		/// <p>Properties for each single point.</p>
		/// </summary>
		public CandleStickSeriesIkhPoint Point { get; set; }
		private CandleStickSeriesIkhPoint Point_DefaultValue { get; set; }
		...
		/// </summary>
		public CandleStickSeriesIkhDataLabels DataLabels { get; set; }
		private CandleStickSeriesIkhDataLabels DataLabels_DefaultValue { get; set; }
		...
		/// </summary>
		public CandleStickSeriesIkhStates States { get; set; }
		private CandleStickSeriesIkhStates States_DefaultValue { get; set; }
		...
		/// </summary>
		public CandleStickSeriesIkhFindNearestPointBy FindNearestPointBy { get; set; }
		private CandleStickSeriesIkhFindNearestPointBy FindNearestPointBy_DefaultValue { get; set; }
		...
		/// </summary>
		public CandleStickSeriesIkhCursor Cursor { get; set; }
		private CandleStickSeriesIkhCursor Cursor_DefaultValue { get; set; }
		...
		/// </summary>
		public CandleStickSeriesIkhDashStyle DashStyle { get; set; }
		private CandleStickSeriesIkhDashStyle DashStyle_DefaultValue { get; set; }
		...
		/// </summary>
		public CandleStickSeriesIkhStep Step { get; set; }
		private CandleStickSeriesIkhStep Step_DefaultValue { get; set; }
		...
		/// </summary>
		public List<CandleStickSeriesIkhZone> Zones { get; set; }
		private List<CandleStickSeriesIkhZone> Zones_DefaultValue { get; set; }
		...
		/// </summary>
		public CandleStickSeriesIkhPointIntervalUnit PointIntervalUnit { get; set; }
		private CandleStickSeriesIkhPointIntervalUnit PointIntervalUnit_DefaultValue { get; set; }
		...
		/// </summary>
		public CandleStickSeriesIkhStacking Stacking { get; set; }
		private CandleStickSeriesIkhStacking Stacking_DefaultValue { get; set; }
		...
		/// </summary>
		public CandleStickSeriesIkhCompareBase CompareBase { get; set; }
		private CandleStickSeriesIkhCompareBase CompareBase_DefaultValue { get; set; }
		...
		internal override Hashtable ToHashtable()
		{
			...
			if (PointDescriptionFormatter != PointDescriptionFormatter_DefaultValue) { h.Add("pointDescriptionFormatter",PointDescriptionFormatter); Highstock.AddFunction("CandleStickSeriesIkhPointDescriptionFormatter.pointDescriptionFormatter", PointDescriptionFormatter); }  
