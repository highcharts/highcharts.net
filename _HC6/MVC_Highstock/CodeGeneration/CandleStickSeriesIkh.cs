...
namespace Highsoft.Web.Mvc.Stocks
{
	public partial class CandleStickSeriesIkh  : BaseObject
	{
		public CandleStickSeriesIkh()
		{
			...
			Zones = Zones_DefaultValue = new CandleStickSeriesIkhZone();
		...
		/// </summary>
		public CandleStickSeriesIkhZone Zones { get; set; }
		private CandleStickSeriesIkhZone Zones_DefaultValue { get; set; }
