...
{
	public partial class CandleStickSeriesIkhDataGrouping  : BaseObject
	{
		public CandleStickSeriesIkhDataGrouping()
		{
			Approximation = Approximation_DefaultValue = CandleStickSeriesIkhDataGroupingApproximation.Average;
		...
		/// </summary>
		public CandleStickSeriesIkhDataGroupingApproximation Approximation { get; set; }
		private CandleStickSeriesIkhDataGroupingApproximation Approximation_DefaultValue { get; set; }
