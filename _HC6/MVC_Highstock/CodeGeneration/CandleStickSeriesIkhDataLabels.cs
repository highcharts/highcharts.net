...
{
	public partial class CandleStickSeriesIkhDataLabels  : BaseObject
	{
		public CandleStickSeriesIkhDataLabels()
		{
			Align = Align_DefaultValue = CandleStickSeriesIkhDataLabelsAlign.Center;
			Formatter = Formatter_DefaultValue = "";
			Style = Style_DefaultValue = new CandleStickSeriesIkhDataLabelsStyle();
			VerticalAlign = VerticalAlign_DefaultValue = CandleStickSeriesIkhDataLabelsVerticalAlign.Bottom;
			X = X_DefaultValue = 0;
			Y = Y_DefaultValue = -6;
			...
			Overflow = Overflow_DefaultValue = CandleStickSeriesIkhDataLabelsOverflow.Justify;
		...
		/// </summary>
		public CandleStickSeriesIkhDataLabelsAlign Align { get; set; }
		private CandleStickSeriesIkhDataLabelsAlign Align_DefaultValue { get; set; }
		...
		/// </summary>
		public CandleStickSeriesIkhDataLabelsStyle Style { get; set; }
		private CandleStickSeriesIkhDataLabelsStyle Style_DefaultValue { get; set; }
		...
		/// </summary>
		public CandleStickSeriesIkhDataLabelsVerticalAlign VerticalAlign { get; set; }
		private CandleStickSeriesIkhDataLabelsVerticalAlign VerticalAlign_DefaultValue { get; set; }
		...
		/// </summary>
		public CandleStickSeriesIkhDataLabelsOverflow Overflow { get; set; }
		private CandleStickSeriesIkhDataLabelsOverflow Overflow_DefaultValue { get; set; }
		...
		internal override Hashtable ToHashtable()
		{
			...
			if (Formatter != Formatter_DefaultValue) { h.Add("formatter",Formatter); Highstock.AddFunction("CandleStickSeriesIkhDataLabelsFormatter.formatter", Formatter); }  
