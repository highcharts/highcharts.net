...
{
	public partial class CandleStickSeriesIkhStatesHover  : BaseObject
	{
		public CandleStickSeriesIkhStatesHover()
		{
			LineWidthPlus = LineWidthPlus_DefaultValue = 1;
			Marker = Marker_DefaultValue = new CandleStickSeriesIkhStatesHoverMarker();
			Halo = Halo_DefaultValue = new CandleStickSeriesIkhStatesHoverHalo();
		...
		/// </summary>
		public CandleStickSeriesIkhStatesHoverMarker Marker { get; set; }
		private CandleStickSeriesIkhStatesHoverMarker Marker_DefaultValue { get; set; }
		...
		/// </summary>
		public CandleStickSeriesIkhStatesHoverHalo Halo { get; set; }
		private CandleStickSeriesIkhStatesHoverHalo Halo_DefaultValue { get; set; }
