...
{
	public partial class CandleStickSeriesIkhStatesHoverMarker  : BaseObject
	{
		public CandleStickSeriesIkhStatesHoverMarker()
		{
			LineWidth = LineWidth_DefaultValue = 0;
			LineColor = LineColor_DefaultValue = "#ffffff";
			Radius = Radius_DefaultValue = 4;
			States = States_DefaultValue = new CandleStickSeriesIkhStatesHoverMarkerStates();
		...
		/// </summary>
		public CandleStickSeriesIkhStatesHoverMarkerStates States { get; set; }
		private CandleStickSeriesIkhStatesHoverMarkerStates States_DefaultValue { get; set; }
