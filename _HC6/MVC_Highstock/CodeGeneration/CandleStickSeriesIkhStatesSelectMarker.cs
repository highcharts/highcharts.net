...
{
	public partial class CandleStickSeriesIkhStatesSelectMarker  : BaseObject
	{
		public CandleStickSeriesIkhStatesSelectMarker()
		{
			LineWidth = LineWidth_DefaultValue = 0;
			LineColor = LineColor_DefaultValue = "#ffffff";
			Radius = Radius_DefaultValue = 4;
			States = States_DefaultValue = new CandleStickSeriesIkhStatesSelectMarkerStates();
		...
		/// </summary>
		public CandleStickSeriesIkhStatesSelectMarkerStates States { get; set; }
		private CandleStickSeriesIkhStatesSelectMarkerStates States_DefaultValue { get; set; }
