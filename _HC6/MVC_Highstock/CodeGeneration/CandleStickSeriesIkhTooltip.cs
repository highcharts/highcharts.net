...
{
	public partial class CandleStickSeriesIkhTooltip  : BaseObject
	{
		public CandleStickSeriesIkhTooltip()
		{
			ValueDecimals = ValueDecimals_DefaultValue = null;
			DateTimeLabelFormats = DateTimeLabelFormats_DefaultValue = new CandleStickSeriesIkhTooltipDateTimeLabelFormats();
		...
		/// </summary>
		public CandleStickSeriesIkhTooltipDateTimeLabelFormats DateTimeLabelFormats { get; set; }
		private CandleStickSeriesIkhTooltipDateTimeLabelFormats DateTimeLabelFormats_DefaultValue { get; set; }
		...
		internal override Hashtable ToHashtable()
		{
			...
			if (PointFormatter != PointFormatter_DefaultValue) { h.Add("pointFormatter",PointFormatter); Highstock.AddFunction("CandleStickSeriesIkhTooltipPointFormatter.pointFormatter", PointFormatter); }  
