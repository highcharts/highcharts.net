...
namespace Highsoft.Web.Mvc.Stocks
{
	public partial class CandleStickSeriesTooltip  : BaseObject
	{
		public CandleStickSeriesTooltip()
		{
			...
			DateTimeLabelFormats = DateTimeLabelFormats_DefaultValue = new CandleStickSeriesTooltipDateTimeLabelFormats();
		...
		/// </summary>
		public CandleStickSeriesTooltipDateTimeLabelFormats DateTimeLabelFormats { get; set; }
		private CandleStickSeriesTooltipDateTimeLabelFormats DateTimeLabelFormats_DefaultValue { get; set; }
