...
{
	public partial class CciSeriesData  : BaseObject
	{
		public CciSeriesData()
		{
			...
			DragDrop = DragDrop_DefaultValue = new CciSeriesDataDragDrop();
			Drilldown = Drilldown_DefaultValue = "";
			Events = Events_DefaultValue = new CciSeriesDataEvents();
			Id = Id_DefaultValue = "";
			Labelrank = Labelrank_DefaultValue = null;
			Marker = Marker_DefaultValue = new CciSeriesDataMarker();
		...
		/// </summary>
		public CciSeriesDataDragDrop DragDrop { get; set; }
		private CciSeriesDataDragDrop DragDrop_DefaultValue { get; set; }
		...
		/// </summary>
		public CciSeriesDataEvents Events { get; set; }
		private CciSeriesDataEvents Events_DefaultValue { get; set; }
		...
		/// 
		/// </summary>
		public CciSeriesDataMarker Marker { get; set; }
		private CciSeriesDataMarker Marker_DefaultValue { get; set; }
