...
{
	public partial class CciSeriesDataDragDrop  : BaseObject
	{
		public CciSeriesDataDragDrop()
		{
			DraggableX = DraggableX_DefaultValue = null;
			DraggableY = DraggableY_DefaultValue = null;
			DragHandle = DragHandle_DefaultValue = new CciSeriesDataDragDropDragHandle();
			...
			GuideBox = GuideBox_DefaultValue = new CciSeriesDataDragDropGuideBox();
		...
		/// </summary>
		public CciSeriesDataDragDropDragHandle DragHandle { get; set; }
		private CciSeriesDataDragDropDragHandle DragHandle_DefaultValue { get; set; }
		...
		/// </summary>
		public CciSeriesDataDragDropGuideBox GuideBox { get; set; }
		private CciSeriesDataDragDropGuideBox GuideBox_DefaultValue { get; set; }
