...
namespace Highsoft.Web.Mvc.Stocks
{
	public partial class CciSeriesDataLabels  : BaseObject
	{
		public CciSeriesDataLabels()
		{
			...
			Style = Style_DefaultValue = new CciSeriesDataLabelsStyle();
		...
		/// </summary>
		public CciSeriesDataLabelsStyle Style { get; set; }
		private CciSeriesDataLabelsStyle Style_DefaultValue { get; set; }
