...
{
	public partial class CciSeriesDataMarker  : BaseObject
	{
		public CciSeriesDataMarker()
		{
			...
			States = States_DefaultValue = new CciSeriesDataMarkerStates();
		...
		/// </summary>
		public CciSeriesDataMarkerStates States { get; set; }
		private CciSeriesDataMarkerStates States_DefaultValue { get; set; }
