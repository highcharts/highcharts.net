...
{
	public partial class CciSeriesIkhDataGrouping  : BaseObject
	{
		public CciSeriesIkhDataGrouping()
		{
			Approximation = Approximation_DefaultValue = CciSeriesIkhDataGroupingApproximation.Average;
		...
		/// </summary>
		public CciSeriesIkhDataGroupingApproximation Approximation { get; set; }
		private CciSeriesIkhDataGroupingApproximation Approximation_DefaultValue { get; set; }
