...
{
	public partial class CciSeriesIkhDataLabels  : BaseObject
	{
		public CciSeriesIkhDataLabels()
		{
			Align = Align_DefaultValue = CciSeriesIkhDataLabelsAlign.Center;
			Formatter = Formatter_DefaultValue = "";
			Style = Style_DefaultValue = new CciSeriesIkhDataLabelsStyle();
			VerticalAlign = VerticalAlign_DefaultValue = CciSeriesIkhDataLabelsVerticalAlign.Bottom;
			X = X_DefaultValue = 0;
			Y = Y_DefaultValue = -6;
			...
			Overflow = Overflow_DefaultValue = CciSeriesIkhDataLabelsOverflow.Justify;
		...
		/// </summary>
		public CciSeriesIkhDataLabelsAlign Align { get; set; }
		private CciSeriesIkhDataLabelsAlign Align_DefaultValue { get; set; }
		...
		/// </summary>
		public CciSeriesIkhDataLabelsStyle Style { get; set; }
		private CciSeriesIkhDataLabelsStyle Style_DefaultValue { get; set; }
		...
		/// </summary>
		public CciSeriesIkhDataLabelsVerticalAlign VerticalAlign { get; set; }
		private CciSeriesIkhDataLabelsVerticalAlign VerticalAlign_DefaultValue { get; set; }
		...
		/// </summary>
		public CciSeriesIkhDataLabelsOverflow Overflow { get; set; }
		private CciSeriesIkhDataLabelsOverflow Overflow_DefaultValue { get; set; }
		...
		internal override Hashtable ToHashtable()
		{
			...
			if (Formatter != Formatter_DefaultValue) { h.Add("formatter",Formatter); Highstock.AddFunction("CciSeriesIkhDataLabelsFormatter.formatter", Formatter); }  
