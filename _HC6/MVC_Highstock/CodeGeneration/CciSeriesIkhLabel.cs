...
{
	public partial class CciSeriesIkhLabel  : BaseObject
	{
		public CciSeriesIkhLabel()
		{
			...
			Style = Style_DefaultValue = new CciSeriesIkhLabelStyle();
		...
		/// </summary>
		public CciSeriesIkhLabelStyle Style { get; set; }
		private CciSeriesIkhLabelStyle Style_DefaultValue { get; set; }
