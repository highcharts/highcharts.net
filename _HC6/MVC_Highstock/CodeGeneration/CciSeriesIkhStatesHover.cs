...
{
	public partial class CciSeriesIkhStatesHover  : BaseObject
	{
		public CciSeriesIkhStatesHover()
		{
			LineWidthPlus = LineWidthPlus_DefaultValue = 1;
			Marker = Marker_DefaultValue = new CciSeriesIkhStatesHoverMarker();
			Halo = Halo_DefaultValue = new CciSeriesIkhStatesHoverHalo();
		...
		/// </summary>
		public CciSeriesIkhStatesHoverMarker Marker { get; set; }
		private CciSeriesIkhStatesHoverMarker Marker_DefaultValue { get; set; }
		...
		/// </summary>
		public CciSeriesIkhStatesHoverHalo Halo { get; set; }
		private CciSeriesIkhStatesHoverHalo Halo_DefaultValue { get; set; }
