...
{
	public partial class CciSeriesIkhTooltip  : BaseObject
	{
		public CciSeriesIkhTooltip()
		{
			ValueDecimals = ValueDecimals_DefaultValue = null;
			DateTimeLabelFormats = DateTimeLabelFormats_DefaultValue = new CciSeriesIkhTooltipDateTimeLabelFormats();
		...
		/// </summary>
		public CciSeriesIkhTooltipDateTimeLabelFormats DateTimeLabelFormats { get; set; }
		private CciSeriesIkhTooltipDateTimeLabelFormats DateTimeLabelFormats_DefaultValue { get; set; }
		...
		internal override Hashtable ToHashtable()
		{
			...
			if (PointFormatter != PointFormatter_DefaultValue) { h.Add("pointFormatter",PointFormatter); Highstock.AddFunction("CciSeriesIkhTooltipPointFormatter.pointFormatter", PointFormatter); }  
