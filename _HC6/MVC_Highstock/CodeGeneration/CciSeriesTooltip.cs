...
namespace Highsoft.Web.Mvc.Stocks
{
	public partial class CciSeriesTooltip  : BaseObject
	{
		public CciSeriesTooltip()
		{
			...
			DateTimeLabelFormats = DateTimeLabelFormats_DefaultValue = new CciSeriesTooltipDateTimeLabelFormats();
		...
		/// </summary>
		public CciSeriesTooltipDateTimeLabelFormats DateTimeLabelFormats { get; set; }
		private CciSeriesTooltipDateTimeLabelFormats DateTimeLabelFormats_DefaultValue { get; set; }
