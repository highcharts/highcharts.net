...
{
	public partial class ChartParallelAxesCrosshairLabel  : BaseObject
	{
		public ChartParallelAxesCrosshairLabel()
		{
		...
		internal override Hashtable ToHashtable()
		{
			...
			if (Formatter != Formatter_DefaultValue) { h.Add("formatter",Formatter); Highstock.AddFunction("ChartParallelAxesCrosshairLabelFormatter.formatter", Formatter); }  
