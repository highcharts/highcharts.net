...
namespace Highsoft.Web.Mvc.Stocks
{
	public partial class CmfSeries  : Series
	{
		public CmfSeries()
		{
			Ikh = Ikh_DefaultValue = new CmfSeriesIkh();
			Id = Id_DefaultValue = null;
			Index = Index_DefaultValue = null;
			LegendIndex = LegendIndex_DefaultValue = null;
			Name = Name_DefaultValue = "Chaikin Money Flow (14)";
			...
			PointIntervalUnit = PointIntervalUnit_DefaultValue = CmfSeriesPointIntervalUnit.Null;
			PointPlacement = PointPlacement_DefaultValue = new PointPlacement();
			PointStart = PointStart_DefaultValue = 0;
			Stacking = Stacking_DefaultValue = CmfSeriesStacking.Null;
		...
		/// </summary>
		public CmfSeriesIkh Ikh { get; set; }
		private CmfSeriesIkh Ikh_DefaultValue { get; set; }
		...
		/// </summary>
		public CmfSeriesPointIntervalUnit PointIntervalUnit { get; set; }
		private CmfSeriesPointIntervalUnit PointIntervalUnit_DefaultValue { get; set; }
		...
		/// </summary>
		public CmfSeriesStacking Stacking { get; set; }
		private CmfSeriesStacking Stacking_DefaultValue { get; set; }
