...
{
	public partial class CmfSeriesData  : BaseObject
	{
		public CmfSeriesData()
		{
			...
			DragDrop = DragDrop_DefaultValue = new CmfSeriesDataDragDrop();
			Drilldown = Drilldown_DefaultValue = "";
			Events = Events_DefaultValue = new CmfSeriesDataEvents();
			Id = Id_DefaultValue = "";
			Labelrank = Labelrank_DefaultValue = null;
			Marker = Marker_DefaultValue = new CmfSeriesDataMarker();
		...
		/// </summary>
		public CmfSeriesDataDragDrop DragDrop { get; set; }
		private CmfSeriesDataDragDrop DragDrop_DefaultValue { get; set; }
		...
		/// </summary>
		public CmfSeriesDataEvents Events { get; set; }
		private CmfSeriesDataEvents Events_DefaultValue { get; set; }
		...
		/// 
		/// </summary>
		public CmfSeriesDataMarker Marker { get; set; }
		private CmfSeriesDataMarker Marker_DefaultValue { get; set; }
