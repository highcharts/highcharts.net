...
{
	public partial class CmfSeriesDataDragDropDragHandle  : BaseObject
	{
		public CmfSeriesDataDragDropDragHandle()
		{
		...
		internal override Hashtable ToHashtable()
		{
			...
			if (PathFormatter != PathFormatter_DefaultValue) { h.Add("pathFormatter",PathFormatter); Highstock.AddFunction("CmfSeriesDataDragDropDragHandlePathFormatter.pathFormatter", PathFormatter); }  
