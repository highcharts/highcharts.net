...
namespace Highsoft.Web.Mvc.Stocks
{
	public partial class CmfSeriesDataLabels  : BaseObject
	{
		public CmfSeriesDataLabels()
		{
			...
			Style = Style_DefaultValue = new CmfSeriesDataLabelsStyle();
		...
		/// </summary>
		public CmfSeriesDataLabelsStyle Style { get; set; }
		private CmfSeriesDataLabelsStyle Style_DefaultValue { get; set; }
