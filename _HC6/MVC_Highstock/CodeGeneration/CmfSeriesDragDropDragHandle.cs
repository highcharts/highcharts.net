...
{
	public partial class CmfSeriesDragDropDragHandle  : BaseObject
	{
		public CmfSeriesDragDropDragHandle()
		{
		...
		internal override Hashtable ToHashtable()
		{
			...
			if (PathFormatter != PathFormatter_DefaultValue) { h.Add("pathFormatter",PathFormatter); Highstock.AddFunction("CmfSeriesDragDropDragHandlePathFormatter.pathFormatter", PathFormatter); }  
