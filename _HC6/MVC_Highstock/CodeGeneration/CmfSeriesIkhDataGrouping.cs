...
{
	public partial class CmfSeriesIkhDataGrouping  : BaseObject
	{
		public CmfSeriesIkhDataGrouping()
		{
			Approximation = Approximation_DefaultValue = CmfSeriesIkhDataGroupingApproximation.Average;
		...
		/// </summary>
		public CmfSeriesIkhDataGroupingApproximation Approximation { get; set; }
		private CmfSeriesIkhDataGroupingApproximation Approximation_DefaultValue { get; set; }
