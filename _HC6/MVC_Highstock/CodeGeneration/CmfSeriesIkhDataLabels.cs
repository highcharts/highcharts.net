...
{
	public partial class CmfSeriesIkhDataLabels  : BaseObject
	{
		public CmfSeriesIkhDataLabels()
		{
			Align = Align_DefaultValue = CmfSeriesIkhDataLabelsAlign.Center;
			Formatter = Formatter_DefaultValue = "";
			Style = Style_DefaultValue = new CmfSeriesIkhDataLabelsStyle();
			VerticalAlign = VerticalAlign_DefaultValue = CmfSeriesIkhDataLabelsVerticalAlign.Bottom;
			X = X_DefaultValue = 0;
			Y = Y_DefaultValue = -6;
			...
			Overflow = Overflow_DefaultValue = CmfSeriesIkhDataLabelsOverflow.Justify;
		...
		/// </summary>
		public CmfSeriesIkhDataLabelsAlign Align { get; set; }
		private CmfSeriesIkhDataLabelsAlign Align_DefaultValue { get; set; }
		...
		/// </summary>
		public CmfSeriesIkhDataLabelsStyle Style { get; set; }
		private CmfSeriesIkhDataLabelsStyle Style_DefaultValue { get; set; }
		...
		/// </summary>
		public CmfSeriesIkhDataLabelsVerticalAlign VerticalAlign { get; set; }
		private CmfSeriesIkhDataLabelsVerticalAlign VerticalAlign_DefaultValue { get; set; }
		...
		/// </summary>
		public CmfSeriesIkhDataLabelsOverflow Overflow { get; set; }
		private CmfSeriesIkhDataLabelsOverflow Overflow_DefaultValue { get; set; }
		...
		internal override Hashtable ToHashtable()
		{
			...
			if (Formatter != Formatter_DefaultValue) { h.Add("formatter",Formatter); Highstock.AddFunction("CmfSeriesIkhDataLabelsFormatter.formatter", Formatter); }  
