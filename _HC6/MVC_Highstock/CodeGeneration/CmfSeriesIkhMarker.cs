...
{
	public partial class CmfSeriesIkhMarker  : BaseObject
	{
		public CmfSeriesIkhMarker()
		{
			LineWidth = LineWidth_DefaultValue = 0;
			LineColor = LineColor_DefaultValue = "#ffffff";
			Radius = Radius_DefaultValue = 4;
			States = States_DefaultValue = new CmfSeriesIkhMarkerStates();
		...
		/// </summary>
		public CmfSeriesIkhMarkerStates States { get; set; }
		private CmfSeriesIkhMarkerStates States_DefaultValue { get; set; }
