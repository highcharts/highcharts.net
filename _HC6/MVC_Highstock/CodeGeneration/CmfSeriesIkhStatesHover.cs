...
{
	public partial class CmfSeriesIkhStatesHover  : BaseObject
	{
		public CmfSeriesIkhStatesHover()
		{
			LineWidthPlus = LineWidthPlus_DefaultValue = 1;
			Marker = Marker_DefaultValue = new CmfSeriesIkhStatesHoverMarker();
			Halo = Halo_DefaultValue = new CmfSeriesIkhStatesHoverHalo();
		...
		/// </summary>
		public CmfSeriesIkhStatesHoverMarker Marker { get; set; }
		private CmfSeriesIkhStatesHoverMarker Marker_DefaultValue { get; set; }
		...
		/// </summary>
		public CmfSeriesIkhStatesHoverHalo Halo { get; set; }
		private CmfSeriesIkhStatesHoverHalo Halo_DefaultValue { get; set; }
