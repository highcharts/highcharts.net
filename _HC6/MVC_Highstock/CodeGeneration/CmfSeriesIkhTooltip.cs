...
{
	public partial class CmfSeriesIkhTooltip  : BaseObject
	{
		public CmfSeriesIkhTooltip()
		{
			ValueDecimals = ValueDecimals_DefaultValue = null;
			DateTimeLabelFormats = DateTimeLabelFormats_DefaultValue = new CmfSeriesIkhTooltipDateTimeLabelFormats();
		...
		/// </summary>
		public CmfSeriesIkhTooltipDateTimeLabelFormats DateTimeLabelFormats { get; set; }
		private CmfSeriesIkhTooltipDateTimeLabelFormats DateTimeLabelFormats_DefaultValue { get; set; }
		...
		internal override Hashtable ToHashtable()
		{
			...
			if (PointFormatter != PointFormatter_DefaultValue) { h.Add("pointFormatter",PointFormatter); Highstock.AddFunction("CmfSeriesIkhTooltipPointFormatter.pointFormatter", PointFormatter); }  
