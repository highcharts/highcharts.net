...
namespace Highsoft.Web.Mvc.Stocks
{
	public partial class CmfSeriesTooltip  : BaseObject
	{
		public CmfSeriesTooltip()
		{
			...
			DateTimeLabelFormats = DateTimeLabelFormats_DefaultValue = new CmfSeriesTooltipDateTimeLabelFormats();
		...
		/// </summary>
		public CmfSeriesTooltipDateTimeLabelFormats DateTimeLabelFormats { get; set; }
		private CmfSeriesTooltipDateTimeLabelFormats DateTimeLabelFormats_DefaultValue { get; set; }
