...
namespace Highsoft.Web.Mvc.Stocks
{
	public partial class ColumnSeries  : Series
	{
		public ColumnSeries()
		{
			...
			Ikh = Ikh_DefaultValue = new ColumnSeriesIkh();
			...
			Zones = Zones_DefaultValue = new ColumnSeriesZone();
			...
			GapUnit = GapUnit_DefaultValue = ColumnSeriesGapUnit.Relative;
			LineWidth = LineWidth_DefaultValue = 2;
			Marker = Marker_DefaultValue = new ColumnSeriesMarker();
			ConnectNulls = ConnectNulls_DefaultValue = false;
			DashStyle = DashStyle_DefaultValue = ColumnSeriesDashStyle.Solid;
			Linecap = Linecap_DefaultValue = ColumnSeriesLinecap.Round;
			Step = Step_DefaultValue = ColumnSeriesStep.Null;
		...
		/// </summary>
		public ColumnSeriesIkh Ikh { get; set; }
		private ColumnSeriesIkh Ikh_DefaultValue { get; set; }
		...
		/// </summary>
		public ColumnSeriesZone Zones { get; set; }
		private ColumnSeriesZone Zones_DefaultValue { get; set; }
		...
		/// </summary>
		public ColumnSeriesGapUnit GapUnit { get; set; }
		private ColumnSeriesGapUnit GapUnit_DefaultValue { get; set; }
		...
		/// </summary>
		public ColumnSeriesLinecap Linecap { get; set; }
		private ColumnSeriesLinecap Linecap_DefaultValue { get; set; }
		 

		/// <summary>
		/// <p>Whether to apply steps to the line. Possible values are <code>left</code>, <code>center</code>and <code>right</code>.</p>
		/// </summary>
		public ColumnSeriesStep Step { get; set; }
		private ColumnSeriesStep Step_DefaultValue { get; set; }
		...
		internal override Hashtable ToHashtable()
		{
			...
			if (PointDescriptionFormatter != PointDescriptionFormatter_DefaultValue) { h.Add("pointDescriptionFormatter",PointDescriptionFormatter); Highstock.AddFunction("ColumnSeriesPointDescriptionFormatter.pointDescriptionFormatter", PointDescriptionFormatter); }  
