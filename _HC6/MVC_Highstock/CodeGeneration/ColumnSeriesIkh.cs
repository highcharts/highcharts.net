...
{
	public partial class ColumnSeriesIkh  : BaseObject
	{
		public ColumnSeriesIkh()
		{
			Name = Name_DefaultValue = "SMA (14)";
			Tooltip = Tooltip_DefaultValue = new ColumnSeriesIkhTooltip();
			LinkedTo = LinkedTo_DefaultValue = null;
			Params = Params_DefaultValue = new ColumnSeriesIkhParams();
			Linecap = Linecap_DefaultValue = ColumnSeriesIkhLinecap.Round;
			BoostThreshold = BoostThreshold_DefaultValue = 5000;
			GapSize = GapSize_DefaultValue = 0;
			GapUnit = GapUnit_DefaultValue = ColumnSeriesIkhGapUnit.Relative;
			Label = Label_DefaultValue = new ColumnSeriesIkhLabel();
			DataGrouping = DataGrouping_DefaultValue = new ColumnSeriesIkhDataGrouping();
			LineWidth = LineWidth_DefaultValue = 2;
			AllowPointSelect = AllowPointSelect_DefaultValue = false;
			ShowCheckbox = ShowCheckbox_DefaultValue = false;
			Animation = Animation_DefaultValue = new Animation() { Enabled = true };
			Events = Events_DefaultValue = new ColumnSeriesIkhEvents();
			Marker = Marker_DefaultValue = new ColumnSeriesIkhMarker();
			Point = Point_DefaultValue = new ColumnSeriesIkhPoint();
			DataLabels = DataLabels_DefaultValue = new ColumnSeriesIkhDataLabels();
			CropThreshold = CropThreshold_DefaultValue = 300;
			SoftThreshold = SoftThreshold_DefaultValue = true;
			States = States_DefaultValue = new ColumnSeriesIkhStates();
			StickyTracking = StickyTracking_DefaultValue = null;
			TurboThreshold = TurboThreshold_DefaultValue = 1000;
			FindNearestPointBy = FindNearestPointBy_DefaultValue = ColumnSeriesIkhFindNearestPointBy.X;
			AnimationLimit = AnimationLimit_DefaultValue = null;
			ClassName = ClassName_DefaultValue = null;
			Color = Color_DefaultValue = null;
			ColorIndex = ColorIndex_DefaultValue = null;
			ConnectNulls = ConnectNulls_DefaultValue = false;
			Cursor = Cursor_DefaultValue = ColumnSeriesIkhCursor.Null;
			DashStyle = DashStyle_DefaultValue = ColumnSeriesIkhDashStyle.Solid;
			...
			Step = Step_DefaultValue = ColumnSeriesIkhStep.Null;
			Threshold = Threshold_DefaultValue = 0;
			Visible = Visible_DefaultValue = true;
			ZoneAxis = ZoneAxis_DefaultValue = "y";
			Zones = Zones_DefaultValue = new List<ColumnSeriesIkhZone>();
			...
			PointIntervalUnit = PointIntervalUnit_DefaultValue = ColumnSeriesIkhPointIntervalUnit.Null;
			PointPlacement = PointPlacement_DefaultValue = new PointPlacement();
			PointStart = PointStart_DefaultValue = 0;
			Stacking = Stacking_DefaultValue = ColumnSeriesIkhStacking.Null;
			Compare = Compare_DefaultValue = "undefined";
			CompareBase = CompareBase_DefaultValue = ColumnSeriesIkhCompareBase.Min;
		...
		/// </summary>
		public ColumnSeriesIkhTooltip Tooltip { get; set; }
		private ColumnSeriesIkhTooltip Tooltip_DefaultValue { get; set; }
		...
		/// 
		/// </summary>
		public ColumnSeriesIkhParams Params { get; set; }
		private ColumnSeriesIkhParams Params_DefaultValue { get; set; }
		...
		/// </summary>
		public ColumnSeriesIkhLinecap Linecap { get; set; }
		private ColumnSeriesIkhLinecap Linecap_DefaultValue { get; set; }
		...
		/// </summary>
		public ColumnSeriesIkhGapUnit GapUnit { get; set; }
		private ColumnSeriesIkhGapUnit GapUnit_DefaultValue { get; set; }
		...
		/// </summary>
		public ColumnSeriesIkhLabel Label { get; set; }
		private ColumnSeriesIkhLabel Label_DefaultValue { get; set; }
		...
		/// </summary>
		public ColumnSeriesIkhDataGrouping DataGrouping { get; set; }
		private ColumnSeriesIkhDataGrouping DataGrouping_DefaultValue { get; set; }
		...
		/// </summary>
		public ColumnSeriesIkhEvents Events { get; set; }
		private ColumnSeriesIkhEvents Events_DefaultValue { get; set; }
		...
		/// </summary>
		public ColumnSeriesIkhMarker Marker { get; set; }
		private ColumnSeriesIkhMarker Marker_DefaultValue { get; set; }
		 

		/// <summary>
		/// <p>Properties for each single point.</p>
		/// </summary>
		public ColumnSeriesIkhPoint Point { get; set; }
		private ColumnSeriesIkhPoint Point_DefaultValue { get; set; }
		...
		/// </summary>
		public ColumnSeriesIkhDataLabels DataLabels { get; set; }
		private ColumnSeriesIkhDataLabels DataLabels_DefaultValue { get; set; }
		...
		/// </summary>
		public ColumnSeriesIkhStates States { get; set; }
		private ColumnSeriesIkhStates States_DefaultValue { get; set; }
		...
		/// </summary>
		public ColumnSeriesIkhFindNearestPointBy FindNearestPointBy { get; set; }
		private ColumnSeriesIkhFindNearestPointBy FindNearestPointBy_DefaultValue { get; set; }
		...
		/// </summary>
		public ColumnSeriesIkhCursor Cursor { get; set; }
		private ColumnSeriesIkhCursor Cursor_DefaultValue { get; set; }
		...
		/// </summary>
		public ColumnSeriesIkhDashStyle DashStyle { get; set; }
		private ColumnSeriesIkhDashStyle DashStyle_DefaultValue { get; set; }
		...
		/// </summary>
		public ColumnSeriesIkhStep Step { get; set; }
		private ColumnSeriesIkhStep Step_DefaultValue { get; set; }
		...
		/// </summary>
		public List<ColumnSeriesIkhZone> Zones { get; set; }
		private List<ColumnSeriesIkhZone> Zones_DefaultValue { get; set; }
		...
		/// </summary>
		public ColumnSeriesIkhPointIntervalUnit PointIntervalUnit { get; set; }
		private ColumnSeriesIkhPointIntervalUnit PointIntervalUnit_DefaultValue { get; set; }
		...
		/// </summary>
		public ColumnSeriesIkhStacking Stacking { get; set; }
		private ColumnSeriesIkhStacking Stacking_DefaultValue { get; set; }
		...
		/// </summary>
		public ColumnSeriesIkhCompareBase CompareBase { get; set; }
		private ColumnSeriesIkhCompareBase CompareBase_DefaultValue { get; set; }
		...
		internal override Hashtable ToHashtable()
		{
			...
			if (PointDescriptionFormatter != PointDescriptionFormatter_DefaultValue) { h.Add("pointDescriptionFormatter",PointDescriptionFormatter); Highstock.AddFunction("ColumnSeriesIkhPointDescriptionFormatter.pointDescriptionFormatter", PointDescriptionFormatter); }  
