...
{
	public partial class ColumnSeriesIkhDataGrouping  : BaseObject
	{
		public ColumnSeriesIkhDataGrouping()
		{
			Approximation = Approximation_DefaultValue = ColumnSeriesIkhDataGroupingApproximation.Average;
		...
		/// </summary>
		public ColumnSeriesIkhDataGroupingApproximation Approximation { get; set; }
		private ColumnSeriesIkhDataGroupingApproximation Approximation_DefaultValue { get; set; }
