...
{
	public partial class ColumnSeriesIkhDataLabels  : BaseObject
	{
		public ColumnSeriesIkhDataLabels()
		{
			Align = Align_DefaultValue = ColumnSeriesIkhDataLabelsAlign.Center;
			Formatter = Formatter_DefaultValue = "";
			Style = Style_DefaultValue = new ColumnSeriesIkhDataLabelsStyle();
			VerticalAlign = VerticalAlign_DefaultValue = ColumnSeriesIkhDataLabelsVerticalAlign.Bottom;
			X = X_DefaultValue = 0;
			Y = Y_DefaultValue = -6;
			...
			Overflow = Overflow_DefaultValue = ColumnSeriesIkhDataLabelsOverflow.Justify;
		...
		/// </summary>
		public ColumnSeriesIkhDataLabelsAlign Align { get; set; }
		private ColumnSeriesIkhDataLabelsAlign Align_DefaultValue { get; set; }
		...
		/// </summary>
		public ColumnSeriesIkhDataLabelsStyle Style { get; set; }
		private ColumnSeriesIkhDataLabelsStyle Style_DefaultValue { get; set; }
		...
		/// </summary>
		public ColumnSeriesIkhDataLabelsVerticalAlign VerticalAlign { get; set; }
		private ColumnSeriesIkhDataLabelsVerticalAlign VerticalAlign_DefaultValue { get; set; }
		...
		/// </summary>
		public ColumnSeriesIkhDataLabelsOverflow Overflow { get; set; }
		private ColumnSeriesIkhDataLabelsOverflow Overflow_DefaultValue { get; set; }
		...
		internal override Hashtable ToHashtable()
		{
			...
			if (Formatter != Formatter_DefaultValue) { h.Add("formatter",Formatter); Highstock.AddFunction("ColumnSeriesIkhDataLabelsFormatter.formatter", Formatter); }  
