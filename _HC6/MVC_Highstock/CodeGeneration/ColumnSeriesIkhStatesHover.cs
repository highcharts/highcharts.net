...
{
	public partial class ColumnSeriesIkhStatesHover  : BaseObject
	{
		public ColumnSeriesIkhStatesHover()
		{
			LineWidthPlus = LineWidthPlus_DefaultValue = 1;
			Marker = Marker_DefaultValue = new ColumnSeriesIkhStatesHoverMarker();
			Halo = Halo_DefaultValue = new ColumnSeriesIkhStatesHoverHalo();
		...
		/// </summary>
		public ColumnSeriesIkhStatesHoverMarker Marker { get; set; }
		private ColumnSeriesIkhStatesHoverMarker Marker_DefaultValue { get; set; }
		...
		/// </summary>
		public ColumnSeriesIkhStatesHoverHalo Halo { get; set; }
		private ColumnSeriesIkhStatesHoverHalo Halo_DefaultValue { get; set; }
