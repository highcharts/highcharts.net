...
{
	public partial class ColumnSeriesIkhStatesHoverMarker  : BaseObject
	{
		public ColumnSeriesIkhStatesHoverMarker()
		{
			LineWidth = LineWidth_DefaultValue = 0;
			LineColor = LineColor_DefaultValue = "#ffffff";
			Radius = Radius_DefaultValue = 4;
			States = States_DefaultValue = new ColumnSeriesIkhStatesHoverMarkerStates();
		...
		/// </summary>
		public ColumnSeriesIkhStatesHoverMarkerStates States { get; set; }
		private ColumnSeriesIkhStatesHoverMarkerStates States_DefaultValue { get; set; }
