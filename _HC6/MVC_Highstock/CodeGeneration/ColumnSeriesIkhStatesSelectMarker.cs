...
{
	public partial class ColumnSeriesIkhStatesSelectMarker  : BaseObject
	{
		public ColumnSeriesIkhStatesSelectMarker()
		{
			LineWidth = LineWidth_DefaultValue = 0;
			LineColor = LineColor_DefaultValue = "#ffffff";
			Radius = Radius_DefaultValue = 4;
			States = States_DefaultValue = new ColumnSeriesIkhStatesSelectMarkerStates();
		...
		/// </summary>
		public ColumnSeriesIkhStatesSelectMarkerStates States { get; set; }
		private ColumnSeriesIkhStatesSelectMarkerStates States_DefaultValue { get; set; }
