...
{
	public partial class ColumnSeriesIkhTooltip  : BaseObject
	{
		public ColumnSeriesIkhTooltip()
		{
			ValueDecimals = ValueDecimals_DefaultValue = null;
			DateTimeLabelFormats = DateTimeLabelFormats_DefaultValue = new ColumnSeriesIkhTooltipDateTimeLabelFormats();
		...
		/// </summary>
		public ColumnSeriesIkhTooltipDateTimeLabelFormats DateTimeLabelFormats { get; set; }
		private ColumnSeriesIkhTooltipDateTimeLabelFormats DateTimeLabelFormats_DefaultValue { get; set; }
		...
		internal override Hashtable ToHashtable()
		{
			...
			if (PointFormatter != PointFormatter_DefaultValue) { h.Add("pointFormatter",PointFormatter); Highstock.AddFunction("ColumnSeriesIkhTooltipPointFormatter.pointFormatter", PointFormatter); }  
