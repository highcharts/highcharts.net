...
namespace Highsoft.Web.Mvc.Stocks
{
	public partial class ColumnSeriesTooltip  : BaseObject
	{
		public ColumnSeriesTooltip()
		{
			...
			DateTimeLabelFormats = DateTimeLabelFormats_DefaultValue = new ColumnSeriesTooltipDateTimeLabelFormats();
		...
		/// </summary>
		public ColumnSeriesTooltipDateTimeLabelFormats DateTimeLabelFormats { get; set; }
		private ColumnSeriesTooltipDateTimeLabelFormats DateTimeLabelFormats_DefaultValue { get; set; }
