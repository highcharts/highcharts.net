...
namespace Highsoft.Web.Mvc.Stocks
{
	public partial class ColumnrangeSeries  : Series
	{
		public ColumnrangeSeries()
		{
			...
			Ikh = Ikh_DefaultValue = new ColumnrangeSeriesIkh();
			...
			GapUnit = GapUnit_DefaultValue = ColumnrangeSeriesGapUnit.Relative;
		...
		/// </summary>
		public ColumnrangeSeriesIkh Ikh { get; set; }
		private ColumnrangeSeriesIkh Ikh_DefaultValue { get; set; }
		...
		/// </summary>
		public ColumnrangeSeriesGapUnit GapUnit { get; set; }
		private ColumnrangeSeriesGapUnit GapUnit_DefaultValue { get; set; }
