...
namespace Highsoft.Web.Mvc.Stocks
{
	public partial class ColumnrangeSeriesIkh  : BaseObject
	{
		public ColumnrangeSeriesIkh()
		{
			...
			Zones = Zones_DefaultValue = new ColumnrangeSeriesIkhZone();
		...
		/// </summary>
		public ColumnrangeSeriesIkhZone Zones { get; set; }
		private ColumnrangeSeriesIkhZone Zones_DefaultValue { get; set; }
