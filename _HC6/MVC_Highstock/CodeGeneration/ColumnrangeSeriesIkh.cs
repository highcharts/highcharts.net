...
{
	public partial class ColumnrangeSeriesIkh  : BaseObject
	{
		public ColumnrangeSeriesIkh()
		{
			Name = Name_DefaultValue = "SMA (14)";
			Tooltip = Tooltip_DefaultValue = new ColumnrangeSeriesIkhTooltip();
			LinkedTo = LinkedTo_DefaultValue = null;
			Params = Params_DefaultValue = new ColumnrangeSeriesIkhParams();
			Linecap = Linecap_DefaultValue = ColumnrangeSeriesIkhLinecap.Round;
			BoostThreshold = BoostThreshold_DefaultValue = 5000;
			GapSize = GapSize_DefaultValue = 0;
			GapUnit = GapUnit_DefaultValue = ColumnrangeSeriesIkhGapUnit.Relative;
			Label = Label_DefaultValue = new ColumnrangeSeriesIkhLabel();
			DataGrouping = DataGrouping_DefaultValue = new ColumnrangeSeriesIkhDataGrouping();
			LineWidth = LineWidth_DefaultValue = 2;
			AllowPointSelect = AllowPointSelect_DefaultValue = false;
			ShowCheckbox = ShowCheckbox_DefaultValue = false;
			Animation = Animation_DefaultValue = new Animation() { Enabled = true };
			Events = Events_DefaultValue = new ColumnrangeSeriesIkhEvents();
			Marker = Marker_DefaultValue = new ColumnrangeSeriesIkhMarker();
			Point = Point_DefaultValue = new ColumnrangeSeriesIkhPoint();
			DataLabels = DataLabels_DefaultValue = new ColumnrangeSeriesIkhDataLabels();
			CropThreshold = CropThreshold_DefaultValue = 300;
			SoftThreshold = SoftThreshold_DefaultValue = true;
			States = States_DefaultValue = new ColumnrangeSeriesIkhStates();
			StickyTracking = StickyTracking_DefaultValue = null;
			TurboThreshold = TurboThreshold_DefaultValue = 1000;
			FindNearestPointBy = FindNearestPointBy_DefaultValue = ColumnrangeSeriesIkhFindNearestPointBy.X;
			AnimationLimit = AnimationLimit_DefaultValue = null;
			ClassName = ClassName_DefaultValue = null;
			Color = Color_DefaultValue = null;
			ColorIndex = ColorIndex_DefaultValue = null;
			ConnectNulls = ConnectNulls_DefaultValue = false;
			Cursor = Cursor_DefaultValue = ColumnrangeSeriesIkhCursor.Null;
			DashStyle = DashStyle_DefaultValue = ColumnrangeSeriesIkhDashStyle.Solid;
			...
			Step = Step_DefaultValue = ColumnrangeSeriesIkhStep.Null;
			Threshold = Threshold_DefaultValue = 0;
			Visible = Visible_DefaultValue = true;
			ZoneAxis = ZoneAxis_DefaultValue = "y";
			Zones = Zones_DefaultValue = new List<ColumnrangeSeriesIkhZone>();
			...
			PointIntervalUnit = PointIntervalUnit_DefaultValue = ColumnrangeSeriesIkhPointIntervalUnit.Null;
			PointPlacement = PointPlacement_DefaultValue = new PointPlacement();
			PointStart = PointStart_DefaultValue = 0;
			Stacking = Stacking_DefaultValue = ColumnrangeSeriesIkhStacking.Null;
			Compare = Compare_DefaultValue = "undefined";
			CompareBase = CompareBase_DefaultValue = ColumnrangeSeriesIkhCompareBase.Min;
		...
		/// </summary>
		public ColumnrangeSeriesIkhTooltip Tooltip { get; set; }
		private ColumnrangeSeriesIkhTooltip Tooltip_DefaultValue { get; set; }
		...
		/// 
		/// </summary>
		public ColumnrangeSeriesIkhParams Params { get; set; }
		private ColumnrangeSeriesIkhParams Params_DefaultValue { get; set; }
		...
		/// </summary>
		public ColumnrangeSeriesIkhLinecap Linecap { get; set; }
		private ColumnrangeSeriesIkhLinecap Linecap_DefaultValue { get; set; }
		...
		/// </summary>
		public ColumnrangeSeriesIkhGapUnit GapUnit { get; set; }
		private ColumnrangeSeriesIkhGapUnit GapUnit_DefaultValue { get; set; }
		...
		/// </summary>
		public ColumnrangeSeriesIkhLabel Label { get; set; }
		private ColumnrangeSeriesIkhLabel Label_DefaultValue { get; set; }
		...
		/// </summary>
		public ColumnrangeSeriesIkhDataGrouping DataGrouping { get; set; }
		private ColumnrangeSeriesIkhDataGrouping DataGrouping_DefaultValue { get; set; }
		...
		/// </summary>
		public ColumnrangeSeriesIkhEvents Events { get; set; }
		private ColumnrangeSeriesIkhEvents Events_DefaultValue { get; set; }
		...
		/// </summary>
		public ColumnrangeSeriesIkhMarker Marker { get; set; }
		private ColumnrangeSeriesIkhMarker Marker_DefaultValue { get; set; }
		 

		/// <summary>
		/// <p>Properties for each single point.</p>
		/// </summary>
		public ColumnrangeSeriesIkhPoint Point { get; set; }
		private ColumnrangeSeriesIkhPoint Point_DefaultValue { get; set; }
		...
		/// </summary>
		public ColumnrangeSeriesIkhDataLabels DataLabels { get; set; }
		private ColumnrangeSeriesIkhDataLabels DataLabels_DefaultValue { get; set; }
		...
		/// </summary>
		public ColumnrangeSeriesIkhStates States { get; set; }
		private ColumnrangeSeriesIkhStates States_DefaultValue { get; set; }
		...
		/// </summary>
		public ColumnrangeSeriesIkhFindNearestPointBy FindNearestPointBy { get; set; }
		private ColumnrangeSeriesIkhFindNearestPointBy FindNearestPointBy_DefaultValue { get; set; }
		...
		/// </summary>
		public ColumnrangeSeriesIkhCursor Cursor { get; set; }
		private ColumnrangeSeriesIkhCursor Cursor_DefaultValue { get; set; }
		...
		/// </summary>
		public ColumnrangeSeriesIkhDashStyle DashStyle { get; set; }
		private ColumnrangeSeriesIkhDashStyle DashStyle_DefaultValue { get; set; }
		...
		/// </summary>
		public ColumnrangeSeriesIkhStep Step { get; set; }
		private ColumnrangeSeriesIkhStep Step_DefaultValue { get; set; }
		...
		/// </summary>
		public List<ColumnrangeSeriesIkhZone> Zones { get; set; }
		private List<ColumnrangeSeriesIkhZone> Zones_DefaultValue { get; set; }
		...
		/// </summary>
		public ColumnrangeSeriesIkhPointIntervalUnit PointIntervalUnit { get; set; }
		private ColumnrangeSeriesIkhPointIntervalUnit PointIntervalUnit_DefaultValue { get; set; }
		...
		/// </summary>
		public ColumnrangeSeriesIkhStacking Stacking { get; set; }
		private ColumnrangeSeriesIkhStacking Stacking_DefaultValue { get; set; }
		...
		/// </summary>
		public ColumnrangeSeriesIkhCompareBase CompareBase { get; set; }
		private ColumnrangeSeriesIkhCompareBase CompareBase_DefaultValue { get; set; }
		...
		internal override Hashtable ToHashtable()
		{
			...
			if (PointDescriptionFormatter != PointDescriptionFormatter_DefaultValue) { h.Add("pointDescriptionFormatter",PointDescriptionFormatter); Highstock.AddFunction("ColumnrangeSeriesIkhPointDescriptionFormatter.pointDescriptionFormatter", PointDescriptionFormatter); }  
