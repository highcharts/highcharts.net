...
{
	public partial class ColumnrangeSeriesIkhDataGrouping  : BaseObject
	{
		public ColumnrangeSeriesIkhDataGrouping()
		{
			Approximation = Approximation_DefaultValue = ColumnrangeSeriesIkhDataGroupingApproximation.Average;
		...
		/// </summary>
		public ColumnrangeSeriesIkhDataGroupingApproximation Approximation { get; set; }
		private ColumnrangeSeriesIkhDataGroupingApproximation Approximation_DefaultValue { get; set; }
