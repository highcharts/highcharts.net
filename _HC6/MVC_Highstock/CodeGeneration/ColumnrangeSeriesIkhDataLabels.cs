...
{
	public partial class ColumnrangeSeriesIkhDataLabels  : BaseObject
	{
		public ColumnrangeSeriesIkhDataLabels()
		{
			Align = Align_DefaultValue = ColumnrangeSeriesIkhDataLabelsAlign.Center;
			Formatter = Formatter_DefaultValue = "";
			Style = Style_DefaultValue = new ColumnrangeSeriesIkhDataLabelsStyle();
			VerticalAlign = VerticalAlign_DefaultValue = ColumnrangeSeriesIkhDataLabelsVerticalAlign.Bottom;
			X = X_DefaultValue = 0;
			Y = Y_DefaultValue = -6;
			...
			Overflow = Overflow_DefaultValue = ColumnrangeSeriesIkhDataLabelsOverflow.Justify;
		...
		/// </summary>
		public ColumnrangeSeriesIkhDataLabelsAlign Align { get; set; }
		private ColumnrangeSeriesIkhDataLabelsAlign Align_DefaultValue { get; set; }
		...
		/// </summary>
		public ColumnrangeSeriesIkhDataLabelsStyle Style { get; set; }
		private ColumnrangeSeriesIkhDataLabelsStyle Style_DefaultValue { get; set; }
		...
		/// </summary>
		public ColumnrangeSeriesIkhDataLabelsVerticalAlign VerticalAlign { get; set; }
		private ColumnrangeSeriesIkhDataLabelsVerticalAlign VerticalAlign_DefaultValue { get; set; }
		...
		/// </summary>
		public ColumnrangeSeriesIkhDataLabelsOverflow Overflow { get; set; }
		private ColumnrangeSeriesIkhDataLabelsOverflow Overflow_DefaultValue { get; set; }
		...
		internal override Hashtable ToHashtable()
		{
			...
			if (Formatter != Formatter_DefaultValue) { h.Add("formatter",Formatter); Highstock.AddFunction("ColumnrangeSeriesIkhDataLabelsFormatter.formatter", Formatter); }  
