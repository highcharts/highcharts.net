...
{
	public partial class ColumnrangeSeriesIkhMarker  : BaseObject
	{
		public ColumnrangeSeriesIkhMarker()
		{
			LineWidth = LineWidth_DefaultValue = 0;
			LineColor = LineColor_DefaultValue = "#ffffff";
			Radius = Radius_DefaultValue = 4;
			States = States_DefaultValue = new ColumnrangeSeriesIkhMarkerStates();
		...
		/// </summary>
		public ColumnrangeSeriesIkhMarkerStates States { get; set; }
		private ColumnrangeSeriesIkhMarkerStates States_DefaultValue { get; set; }
