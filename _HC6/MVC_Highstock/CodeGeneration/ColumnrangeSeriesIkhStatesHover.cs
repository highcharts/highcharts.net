...
{
	public partial class ColumnrangeSeriesIkhStatesHover  : BaseObject
	{
		public ColumnrangeSeriesIkhStatesHover()
		{
			LineWidthPlus = LineWidthPlus_DefaultValue = 1;
			Marker = Marker_DefaultValue = new ColumnrangeSeriesIkhStatesHoverMarker();
			Halo = Halo_DefaultValue = new ColumnrangeSeriesIkhStatesHoverHalo();
		...
		/// </summary>
		public ColumnrangeSeriesIkhStatesHoverMarker Marker { get; set; }
		private ColumnrangeSeriesIkhStatesHoverMarker Marker_DefaultValue { get; set; }
		...
		/// </summary>
		public ColumnrangeSeriesIkhStatesHoverHalo Halo { get; set; }
		private ColumnrangeSeriesIkhStatesHoverHalo Halo_DefaultValue { get; set; }
