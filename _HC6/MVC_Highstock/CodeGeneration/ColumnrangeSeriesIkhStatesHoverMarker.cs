...
{
	public partial class ColumnrangeSeriesIkhStatesHoverMarker  : BaseObject
	{
		public ColumnrangeSeriesIkhStatesHoverMarker()
		{
			LineWidth = LineWidth_DefaultValue = 0;
			LineColor = LineColor_DefaultValue = "#ffffff";
			Radius = Radius_DefaultValue = 4;
			States = States_DefaultValue = new ColumnrangeSeriesIkhStatesHoverMarkerStates();
		...
		/// </summary>
		public ColumnrangeSeriesIkhStatesHoverMarkerStates States { get; set; }
		private ColumnrangeSeriesIkhStatesHoverMarkerStates States_DefaultValue { get; set; }
