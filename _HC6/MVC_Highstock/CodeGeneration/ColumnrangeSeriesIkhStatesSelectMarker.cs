...
{
	public partial class ColumnrangeSeriesIkhStatesSelectMarker  : BaseObject
	{
		public ColumnrangeSeriesIkhStatesSelectMarker()
		{
			LineWidth = LineWidth_DefaultValue = 0;
			LineColor = LineColor_DefaultValue = "#ffffff";
			Radius = Radius_DefaultValue = 4;
			States = States_DefaultValue = new ColumnrangeSeriesIkhStatesSelectMarkerStates();
		...
		/// </summary>
		public ColumnrangeSeriesIkhStatesSelectMarkerStates States { get; set; }
		private ColumnrangeSeriesIkhStatesSelectMarkerStates States_DefaultValue { get; set; }
