...
{
	public partial class ColumnrangeSeriesIkhTooltip  : BaseObject
	{
		public ColumnrangeSeriesIkhTooltip()
		{
			ValueDecimals = ValueDecimals_DefaultValue = null;
			DateTimeLabelFormats = DateTimeLabelFormats_DefaultValue = new ColumnrangeSeriesIkhTooltipDateTimeLabelFormats();
		...
		/// </summary>
		public ColumnrangeSeriesIkhTooltipDateTimeLabelFormats DateTimeLabelFormats { get; set; }
		private ColumnrangeSeriesIkhTooltipDateTimeLabelFormats DateTimeLabelFormats_DefaultValue { get; set; }
		...
		internal override Hashtable ToHashtable()
		{
			...
			if (PointFormatter != PointFormatter_DefaultValue) { h.Add("pointFormatter",PointFormatter); Highstock.AddFunction("ColumnrangeSeriesIkhTooltipPointFormatter.pointFormatter", PointFormatter); }  
