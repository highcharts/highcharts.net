...
{
	public partial class ColumnrangeSeriesMarker  : BaseObject
	{
		public ColumnrangeSeriesMarker()
		{
			LineWidth = LineWidth_DefaultValue = 0;
			LineColor = LineColor_DefaultValue = "#ffffff";
			Radius = Radius_DefaultValue = 4;
			States = States_DefaultValue = new ColumnrangeSeriesMarkerStates();
		...
		/// </summary>
		public ColumnrangeSeriesMarkerStates States { get; set; }
		private ColumnrangeSeriesMarkerStates States_DefaultValue { get; set; }
