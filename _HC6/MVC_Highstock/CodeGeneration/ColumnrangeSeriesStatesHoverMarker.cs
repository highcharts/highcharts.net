...
namespace Highsoft.Web.Mvc.Stocks
{
	public partial class ColumnrangeSeriesStatesHoverMarker  : BaseObject
	{
		public ColumnrangeSeriesStatesHoverMarker()
		{
			...
			States = States_DefaultValue = new ColumnrangeSeriesStatesHoverMarkerStates();
		...
		/// </summary>
		public ColumnrangeSeriesStatesHoverMarkerStates States { get; set; }
		private ColumnrangeSeriesStatesHoverMarkerStates States_DefaultValue { get; set; }
