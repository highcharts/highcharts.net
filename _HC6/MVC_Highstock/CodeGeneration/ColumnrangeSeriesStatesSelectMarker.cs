...
{
	public partial class ColumnrangeSeriesStatesSelectMarker  : BaseObject
	{
		public ColumnrangeSeriesStatesSelectMarker()
		{
			LineWidth = LineWidth_DefaultValue = 0;
			LineColor = LineColor_DefaultValue = "#ffffff";
			Radius = Radius_DefaultValue = 4;
			States = States_DefaultValue = new ColumnrangeSeriesStatesSelectMarkerStates();
		...
		/// </summary>
		public ColumnrangeSeriesStatesSelectMarkerStates States { get; set; }
		private ColumnrangeSeriesStatesSelectMarkerStates States_DefaultValue { get; set; }
