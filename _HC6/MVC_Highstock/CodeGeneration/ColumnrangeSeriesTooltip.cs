...
namespace Highsoft.Web.Mvc.Stocks
{
	public partial class ColumnrangeSeriesTooltip  : BaseObject
	{
		public ColumnrangeSeriesTooltip()
		{
			...
			DateTimeLabelFormats = DateTimeLabelFormats_DefaultValue = new ColumnrangeSeriesTooltipDateTimeLabelFormats();
		...
		/// </summary>
		public ColumnrangeSeriesTooltipDateTimeLabelFormats DateTimeLabelFormats { get; set; }
		private ColumnrangeSeriesTooltipDateTimeLabelFormats DateTimeLabelFormats_DefaultValue { get; set; }
