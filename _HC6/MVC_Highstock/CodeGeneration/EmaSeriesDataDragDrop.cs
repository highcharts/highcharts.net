...
{
	public partial class EmaSeriesDataDragDrop  : BaseObject
	{
		public EmaSeriesDataDragDrop()
		{
			DraggableX = DraggableX_DefaultValue = null;
			DraggableY = DraggableY_DefaultValue = null;
			DragHandle = DragHandle_DefaultValue = new EmaSeriesDataDragDropDragHandle();
			...
			GuideBox = GuideBox_DefaultValue = new EmaSeriesDataDragDropGuideBox();
		...
		/// </summary>
		public EmaSeriesDataDragDropDragHandle DragHandle { get; set; }
		private EmaSeriesDataDragDropDragHandle DragHandle_DefaultValue { get; set; }
		...
		/// </summary>
		public EmaSeriesDataDragDropGuideBox GuideBox { get; set; }
		private EmaSeriesDataDragDropGuideBox GuideBox_DefaultValue { get; set; }
