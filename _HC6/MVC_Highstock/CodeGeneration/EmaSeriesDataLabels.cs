...
namespace Highsoft.Web.Mvc.Stocks
{
	public partial class EmaSeriesDataLabels  : BaseObject
	{
		public EmaSeriesDataLabels()
		{
			...
			Style = Style_DefaultValue = new EmaSeriesDataLabelsStyle();
		...
		/// </summary>
		public EmaSeriesDataLabelsStyle Style { get; set; }
		private EmaSeriesDataLabelsStyle Style_DefaultValue { get; set; }
