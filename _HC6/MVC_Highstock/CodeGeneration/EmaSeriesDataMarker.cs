...
{
	public partial class EmaSeriesDataMarker  : BaseObject
	{
		public EmaSeriesDataMarker()
		{
			...
			States = States_DefaultValue = new EmaSeriesDataMarkerStates();
		...
		/// </summary>
		public EmaSeriesDataMarkerStates States { get; set; }
		private EmaSeriesDataMarkerStates States_DefaultValue { get; set; }
