...
{
	public partial class EmaSeriesIkhDataGrouping  : BaseObject
	{
		public EmaSeriesIkhDataGrouping()
		{
			Approximation = Approximation_DefaultValue = EmaSeriesIkhDataGroupingApproximation.Average;
		...
		/// </summary>
		public EmaSeriesIkhDataGroupingApproximation Approximation { get; set; }
		private EmaSeriesIkhDataGroupingApproximation Approximation_DefaultValue { get; set; }
