...
{
	public partial class EmaSeriesIkhDataLabels  : BaseObject
	{
		public EmaSeriesIkhDataLabels()
		{
			Align = Align_DefaultValue = EmaSeriesIkhDataLabelsAlign.Center;
			Formatter = Formatter_DefaultValue = "";
			Style = Style_DefaultValue = new EmaSeriesIkhDataLabelsStyle();
			VerticalAlign = VerticalAlign_DefaultValue = EmaSeriesIkhDataLabelsVerticalAlign.Bottom;
			X = X_DefaultValue = 0;
			Y = Y_DefaultValue = -6;
			...
			Overflow = Overflow_DefaultValue = EmaSeriesIkhDataLabelsOverflow.Justify;
		...
		/// </summary>
		public EmaSeriesIkhDataLabelsAlign Align { get; set; }
		private EmaSeriesIkhDataLabelsAlign Align_DefaultValue { get; set; }
		...
		/// </summary>
		public EmaSeriesIkhDataLabelsStyle Style { get; set; }
		private EmaSeriesIkhDataLabelsStyle Style_DefaultValue { get; set; }
		...
		/// </summary>
		public EmaSeriesIkhDataLabelsVerticalAlign VerticalAlign { get; set; }
		private EmaSeriesIkhDataLabelsVerticalAlign VerticalAlign_DefaultValue { get; set; }
		...
		/// </summary>
		public EmaSeriesIkhDataLabelsOverflow Overflow { get; set; }
		private EmaSeriesIkhDataLabelsOverflow Overflow_DefaultValue { get; set; }
		...
		internal override Hashtable ToHashtable()
		{
			...
			if (Formatter != Formatter_DefaultValue) { h.Add("formatter",Formatter); Highstock.AddFunction("EmaSeriesIkhDataLabelsFormatter.formatter", Formatter); }  
