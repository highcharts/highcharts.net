...
{
	public partial class EmaSeriesIkhStatesHover  : BaseObject
	{
		public EmaSeriesIkhStatesHover()
		{
			LineWidthPlus = LineWidthPlus_DefaultValue = 1;
			Marker = Marker_DefaultValue = new EmaSeriesIkhStatesHoverMarker();
			Halo = Halo_DefaultValue = new EmaSeriesIkhStatesHoverHalo();
		...
		/// </summary>
		public EmaSeriesIkhStatesHoverMarker Marker { get; set; }
		private EmaSeriesIkhStatesHoverMarker Marker_DefaultValue { get; set; }
		...
		/// </summary>
		public EmaSeriesIkhStatesHoverHalo Halo { get; set; }
		private EmaSeriesIkhStatesHoverHalo Halo_DefaultValue { get; set; }
