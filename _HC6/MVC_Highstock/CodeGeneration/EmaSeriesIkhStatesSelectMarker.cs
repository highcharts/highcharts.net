...
{
	public partial class EmaSeriesIkhStatesSelectMarker  : BaseObject
	{
		public EmaSeriesIkhStatesSelectMarker()
		{
			LineWidth = LineWidth_DefaultValue = 0;
			LineColor = LineColor_DefaultValue = "#ffffff";
			Radius = Radius_DefaultValue = 4;
			States = States_DefaultValue = new EmaSeriesIkhStatesSelectMarkerStates();
		...
		/// </summary>
		public EmaSeriesIkhStatesSelectMarkerStates States { get; set; }
		private EmaSeriesIkhStatesSelectMarkerStates States_DefaultValue { get; set; }
