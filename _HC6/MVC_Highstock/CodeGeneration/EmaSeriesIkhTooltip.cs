...
{
	public partial class EmaSeriesIkhTooltip  : BaseObject
	{
		public EmaSeriesIkhTooltip()
		{
			ValueDecimals = ValueDecimals_DefaultValue = null;
			DateTimeLabelFormats = DateTimeLabelFormats_DefaultValue = new EmaSeriesIkhTooltipDateTimeLabelFormats();
		...
		/// </summary>
		public EmaSeriesIkhTooltipDateTimeLabelFormats DateTimeLabelFormats { get; set; }
		private EmaSeriesIkhTooltipDateTimeLabelFormats DateTimeLabelFormats_DefaultValue { get; set; }
		...
		internal override Hashtable ToHashtable()
		{
			...
			if (PointFormatter != PointFormatter_DefaultValue) { h.Add("pointFormatter",PointFormatter); Highstock.AddFunction("EmaSeriesIkhTooltipPointFormatter.pointFormatter", PointFormatter); }  
