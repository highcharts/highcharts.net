...
{
	public partial class EmaSeriesMarker  : BaseObject
	{
		public EmaSeriesMarker()
		{
			LineWidth = LineWidth_DefaultValue = 0;
			LineColor = LineColor_DefaultValue = "#ffffff";
			Radius = Radius_DefaultValue = 4;
			States = States_DefaultValue = new EmaSeriesMarkerStates();
		...
		/// </summary>
		public EmaSeriesMarkerStates States { get; set; }
		private EmaSeriesMarkerStates States_DefaultValue { get; set; }
