...
{
	public partial class EmaSeriesStatesHoverMarker  : BaseObject
	{
		public EmaSeriesStatesHoverMarker()
		{
			...
			States = States_DefaultValue = new EmaSeriesStatesHoverMarkerStates();
		...
		/// </summary>
		public EmaSeriesStatesHoverMarkerStates States { get; set; }
		private EmaSeriesStatesHoverMarkerStates States_DefaultValue { get; set; }
