...
namespace Highsoft.Web.Mvc.Stocks
{
	public partial class EmaSeriesTooltip  : BaseObject
	{
		public EmaSeriesTooltip()
		{
			...
			DateTimeLabelFormats = DateTimeLabelFormats_DefaultValue = new EmaSeriesTooltipDateTimeLabelFormats();
		...
		/// </summary>
		public EmaSeriesTooltipDateTimeLabelFormats DateTimeLabelFormats { get; set; }
		private EmaSeriesTooltipDateTimeLabelFormats DateTimeLabelFormats_DefaultValue { get; set; }
