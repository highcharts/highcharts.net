...
{
	public partial class ErrorbarSeriesDataGrouping  : BaseObject
	{
		public ErrorbarSeriesDataGrouping()
		{
			GroupPixelWidth = GroupPixelWidth_DefaultValue = 10;
			Approximation = Approximation_DefaultValue = ErrorbarSeriesDataGroupingApproximation.Average;
		...
		/// </summary>
		public ErrorbarSeriesDataGroupingApproximation Approximation { get; set; }
		private ErrorbarSeriesDataGroupingApproximation Approximation_DefaultValue { get; set; }
