...
{
	public partial class ErrorbarSeriesIkh  : BaseObject
	{
		public ErrorbarSeriesIkh()
		{
			Name = Name_DefaultValue = "SMA (14)";
			Tooltip = Tooltip_DefaultValue = new ErrorbarSeriesIkhTooltip();
			LinkedTo = LinkedTo_DefaultValue = null;
			Params = Params_DefaultValue = new ErrorbarSeriesIkhParams();
			Linecap = Linecap_DefaultValue = ErrorbarSeriesIkhLinecap.Round;
			BoostThreshold = BoostThreshold_DefaultValue = 5000;
			GapSize = GapSize_DefaultValue = 0;
			GapUnit = GapUnit_DefaultValue = ErrorbarSeriesIkhGapUnit.Relative;
			Label = Label_DefaultValue = new ErrorbarSeriesIkhLabel();
			DataGrouping = DataGrouping_DefaultValue = new ErrorbarSeriesIkhDataGrouping();
			LineWidth = LineWidth_DefaultValue = 2;
			AllowPointSelect = AllowPointSelect_DefaultValue = false;
			ShowCheckbox = ShowCheckbox_DefaultValue = false;
			Animation = Animation_DefaultValue = new Animation() { Enabled = true };
			Events = Events_DefaultValue = new ErrorbarSeriesIkhEvents();
			Marker = Marker_DefaultValue = new ErrorbarSeriesIkhMarker();
			Point = Point_DefaultValue = new ErrorbarSeriesIkhPoint();
			DataLabels = DataLabels_DefaultValue = new ErrorbarSeriesIkhDataLabels();
			CropThreshold = CropThreshold_DefaultValue = 300;
			SoftThreshold = SoftThreshold_DefaultValue = true;
			States = States_DefaultValue = new ErrorbarSeriesIkhStates();
			StickyTracking = StickyTracking_DefaultValue = null;
			TurboThreshold = TurboThreshold_DefaultValue = 1000;
			FindNearestPointBy = FindNearestPointBy_DefaultValue = ErrorbarSeriesIkhFindNearestPointBy.X;
			AnimationLimit = AnimationLimit_DefaultValue = null;
			ClassName = ClassName_DefaultValue = null;
			Color = Color_DefaultValue = null;
			ColorIndex = ColorIndex_DefaultValue = null;
			ConnectNulls = ConnectNulls_DefaultValue = false;
			Cursor = Cursor_DefaultValue = ErrorbarSeriesIkhCursor.Null;
			DashStyle = DashStyle_DefaultValue = ErrorbarSeriesIkhDashStyle.Solid;
			...
			Step = Step_DefaultValue = ErrorbarSeriesIkhStep.Null;
			Threshold = Threshold_DefaultValue = 0;
			Visible = Visible_DefaultValue = true;
			ZoneAxis = ZoneAxis_DefaultValue = "y";
			Zones = Zones_DefaultValue = new List<ErrorbarSeriesIkhZone>();
			...
			PointIntervalUnit = PointIntervalUnit_DefaultValue = ErrorbarSeriesIkhPointIntervalUnit.Null;
			PointPlacement = PointPlacement_DefaultValue = new PointPlacement();
			PointStart = PointStart_DefaultValue = 0;
			Stacking = Stacking_DefaultValue = ErrorbarSeriesIkhStacking.Null;
			Compare = Compare_DefaultValue = "undefined";
			CompareBase = CompareBase_DefaultValue = ErrorbarSeriesIkhCompareBase.Min;
		...
		/// </summary>
		public ErrorbarSeriesIkhTooltip Tooltip { get; set; }
		private ErrorbarSeriesIkhTooltip Tooltip_DefaultValue { get; set; }
		...
		/// 
		/// </summary>
		public ErrorbarSeriesIkhParams Params { get; set; }
		private ErrorbarSeriesIkhParams Params_DefaultValue { get; set; }
		...
		/// </summary>
		public ErrorbarSeriesIkhLinecap Linecap { get; set; }
		private ErrorbarSeriesIkhLinecap Linecap_DefaultValue { get; set; }
		...
		/// </summary>
		public ErrorbarSeriesIkhGapUnit GapUnit { get; set; }
		private ErrorbarSeriesIkhGapUnit GapUnit_DefaultValue { get; set; }
		...
		/// </summary>
		public ErrorbarSeriesIkhLabel Label { get; set; }
		private ErrorbarSeriesIkhLabel Label_DefaultValue { get; set; }
		...
		/// </summary>
		public ErrorbarSeriesIkhDataGrouping DataGrouping { get; set; }
		private ErrorbarSeriesIkhDataGrouping DataGrouping_DefaultValue { get; set; }
		...
		/// </summary>
		public ErrorbarSeriesIkhEvents Events { get; set; }
		private ErrorbarSeriesIkhEvents Events_DefaultValue { get; set; }
		...
		/// </summary>
		public ErrorbarSeriesIkhMarker Marker { get; set; }
		private ErrorbarSeriesIkhMarker Marker_DefaultValue { get; set; }
		 

		/// <summary>
		/// <p>Properties for each single point.</p>
		/// </summary>
		public ErrorbarSeriesIkhPoint Point { get; set; }
		private ErrorbarSeriesIkhPoint Point_DefaultValue { get; set; }
		...
		/// </summary>
		public ErrorbarSeriesIkhDataLabels DataLabels { get; set; }
		private ErrorbarSeriesIkhDataLabels DataLabels_DefaultValue { get; set; }
		...
		/// </summary>
		public ErrorbarSeriesIkhStates States { get; set; }
		private ErrorbarSeriesIkhStates States_DefaultValue { get; set; }
		...
		/// </summary>
		public ErrorbarSeriesIkhFindNearestPointBy FindNearestPointBy { get; set; }
		private ErrorbarSeriesIkhFindNearestPointBy FindNearestPointBy_DefaultValue { get; set; }
		...
		/// </summary>
		public ErrorbarSeriesIkhCursor Cursor { get; set; }
		private ErrorbarSeriesIkhCursor Cursor_DefaultValue { get; set; }
		...
		/// </summary>
		public ErrorbarSeriesIkhDashStyle DashStyle { get; set; }
		private ErrorbarSeriesIkhDashStyle DashStyle_DefaultValue { get; set; }
		...
		/// </summary>
		public ErrorbarSeriesIkhStep Step { get; set; }
		private ErrorbarSeriesIkhStep Step_DefaultValue { get; set; }
		...
		/// </summary>
		public List<ErrorbarSeriesIkhZone> Zones { get; set; }
		private List<ErrorbarSeriesIkhZone> Zones_DefaultValue { get; set; }
		...
		/// </summary>
		public ErrorbarSeriesIkhPointIntervalUnit PointIntervalUnit { get; set; }
		private ErrorbarSeriesIkhPointIntervalUnit PointIntervalUnit_DefaultValue { get; set; }
		...
		/// </summary>
		public ErrorbarSeriesIkhStacking Stacking { get; set; }
		private ErrorbarSeriesIkhStacking Stacking_DefaultValue { get; set; }
		...
		/// </summary>
		public ErrorbarSeriesIkhCompareBase CompareBase { get; set; }
		private ErrorbarSeriesIkhCompareBase CompareBase_DefaultValue { get; set; }
		...
		internal override Hashtable ToHashtable()
		{
			...
			if (PointDescriptionFormatter != PointDescriptionFormatter_DefaultValue) { h.Add("pointDescriptionFormatter",PointDescriptionFormatter); Highstock.AddFunction("ErrorbarSeriesIkhPointDescriptionFormatter.pointDescriptionFormatter", PointDescriptionFormatter); }  
