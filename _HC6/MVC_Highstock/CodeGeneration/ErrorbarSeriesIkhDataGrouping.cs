...
{
	public partial class ErrorbarSeriesIkhDataGrouping  : BaseObject
	{
		public ErrorbarSeriesIkhDataGrouping()
		{
			Approximation = Approximation_DefaultValue = ErrorbarSeriesIkhDataGroupingApproximation.Average;
		...
		/// </summary>
		public ErrorbarSeriesIkhDataGroupingApproximation Approximation { get; set; }
		private ErrorbarSeriesIkhDataGroupingApproximation Approximation_DefaultValue { get; set; }
