...
{
	public partial class ErrorbarSeriesIkhDataLabels  : BaseObject
	{
		public ErrorbarSeriesIkhDataLabels()
		{
			Align = Align_DefaultValue = ErrorbarSeriesIkhDataLabelsAlign.Center;
			Formatter = Formatter_DefaultValue = "";
			Style = Style_DefaultValue = new ErrorbarSeriesIkhDataLabelsStyle();
			VerticalAlign = VerticalAlign_DefaultValue = ErrorbarSeriesIkhDataLabelsVerticalAlign.Bottom;
			X = X_DefaultValue = 0;
			Y = Y_DefaultValue = -6;
			...
			Overflow = Overflow_DefaultValue = ErrorbarSeriesIkhDataLabelsOverflow.Justify;
		...
		/// </summary>
		public ErrorbarSeriesIkhDataLabelsAlign Align { get; set; }
		private ErrorbarSeriesIkhDataLabelsAlign Align_DefaultValue { get; set; }
		...
		/// </summary>
		public ErrorbarSeriesIkhDataLabelsStyle Style { get; set; }
		private ErrorbarSeriesIkhDataLabelsStyle Style_DefaultValue { get; set; }
		...
		/// </summary>
		public ErrorbarSeriesIkhDataLabelsVerticalAlign VerticalAlign { get; set; }
		private ErrorbarSeriesIkhDataLabelsVerticalAlign VerticalAlign_DefaultValue { get; set; }
		...
		/// </summary>
		public ErrorbarSeriesIkhDataLabelsOverflow Overflow { get; set; }
		private ErrorbarSeriesIkhDataLabelsOverflow Overflow_DefaultValue { get; set; }
		...
		internal override Hashtable ToHashtable()
		{
			...
			if (Formatter != Formatter_DefaultValue) { h.Add("formatter",Formatter); Highstock.AddFunction("ErrorbarSeriesIkhDataLabelsFormatter.formatter", Formatter); }  
