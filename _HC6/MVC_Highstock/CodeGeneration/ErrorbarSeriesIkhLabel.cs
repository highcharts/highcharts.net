...
{
	public partial class ErrorbarSeriesIkhLabel  : BaseObject
	{
		public ErrorbarSeriesIkhLabel()
		{
			...
			Style = Style_DefaultValue = new ErrorbarSeriesIkhLabelStyle();
		...
		/// </summary>
		public ErrorbarSeriesIkhLabelStyle Style { get; set; }
		private ErrorbarSeriesIkhLabelStyle Style_DefaultValue { get; set; }
