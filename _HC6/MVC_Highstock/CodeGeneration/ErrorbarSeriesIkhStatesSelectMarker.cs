...
{
	public partial class ErrorbarSeriesIkhStatesSelectMarker  : BaseObject
	{
		public ErrorbarSeriesIkhStatesSelectMarker()
		{
			LineWidth = LineWidth_DefaultValue = 0;
			LineColor = LineColor_DefaultValue = "#ffffff";
			Radius = Radius_DefaultValue = 4;
			States = States_DefaultValue = new ErrorbarSeriesIkhStatesSelectMarkerStates();
		...
		/// </summary>
		public ErrorbarSeriesIkhStatesSelectMarkerStates States { get; set; }
		private ErrorbarSeriesIkhStatesSelectMarkerStates States_DefaultValue { get; set; }
