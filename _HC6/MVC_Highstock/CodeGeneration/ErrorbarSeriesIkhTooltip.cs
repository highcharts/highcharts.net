...
{
	public partial class ErrorbarSeriesIkhTooltip  : BaseObject
	{
		public ErrorbarSeriesIkhTooltip()
		{
			ValueDecimals = ValueDecimals_DefaultValue = null;
			DateTimeLabelFormats = DateTimeLabelFormats_DefaultValue = new ErrorbarSeriesIkhTooltipDateTimeLabelFormats();
		...
		/// </summary>
		public ErrorbarSeriesIkhTooltipDateTimeLabelFormats DateTimeLabelFormats { get; set; }
		private ErrorbarSeriesIkhTooltipDateTimeLabelFormats DateTimeLabelFormats_DefaultValue { get; set; }
		...
		internal override Hashtable ToHashtable()
		{
			...
			if (PointFormatter != PointFormatter_DefaultValue) { h.Add("pointFormatter",PointFormatter); Highstock.AddFunction("ErrorbarSeriesIkhTooltipPointFormatter.pointFormatter", PointFormatter); }  
