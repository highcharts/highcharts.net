...
namespace Highsoft.Web.Mvc.Stocks
{
	public partial class ErrorbarSeriesStatesHoverMarker  : BaseObject
	{
		public ErrorbarSeriesStatesHoverMarker()
		{
			...
			States = States_DefaultValue = new ErrorbarSeriesStatesHoverMarkerStates();
		...
		/// </summary>
		public ErrorbarSeriesStatesHoverMarkerStates States { get; set; }
		private ErrorbarSeriesStatesHoverMarkerStates States_DefaultValue { get; set; }
