...
namespace Highsoft.Web.Mvc.Stocks
{
	public partial class FlagsSeries  : Series
	{
		public FlagsSeries()
		{
			...
			NavigatorOptions = NavigatorOptions_DefaultValue = new FlagsSeriesNavigatorOptions();
		...
		/// </summary>
		public FlagsSeriesNavigatorOptions NavigatorOptions { get; set; }
		private FlagsSeriesNavigatorOptions NavigatorOptions_DefaultValue { get; set; }
