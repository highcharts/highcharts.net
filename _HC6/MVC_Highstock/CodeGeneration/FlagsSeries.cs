...
{
	public partial class FlagsSeries  : BaseObject
	{
		public FlagsSeries()
		{
			Data = Data_DefaultValue = new List<FlagsSeriesData>();
			Ikh = Ikh_DefaultValue = new FlagsSeriesIkh();
			...
			Zones = Zones_DefaultValue = new FlagsSeriesZone();
			...
			GapUnit = GapUnit_DefaultValue = FlagsSeriesGapUnit.Relative;
			DataGrouping = DataGrouping_DefaultValue = new FlagsSeriesDataGrouping();
			Animation = Animation_DefaultValue = new Animation() { Enabled = true };
			Marker = Marker_DefaultValue = new FlagsSeriesMarker();
			TurboThreshold = TurboThreshold_DefaultValue = 1000;
			ConnectNulls = ConnectNulls_DefaultValue = false;
			DashStyle = DashStyle_DefaultValue = FlagsSeriesDashStyle.Solid;
			Linecap = Linecap_DefaultValue = FlagsSeriesLinecap.Round;
			Step = Step_DefaultValue = FlagsSeriesStep.Null;
			
		}	
		

		/// <summary>
		/// <p>An array of data points for the series. For the <code>flags</code> series type,points can be given in the following ways:</p><ol><li><p>An array of objects with named values. The objects are pointconfiguration objects as seen below. If the total number of datapoints exceeds the series&#39; <a href="#series.flags.turboThreshold">turboThreshold</a>,this option is not available.</p><p>```jsdata: [{x: 1,title: &quot;A&quot;,text: &quot;First event&quot;}, {x: 1,title: &quot;B&quot;,text: &quot;Second event&quot;}]</pre></p></li></ol>
		/// </summary>
		...
		/// </summary>
		public FlagsSeriesIkh Ikh { get; set; }
		private FlagsSeriesIkh Ikh_DefaultValue { get; set; }
		...
		/// </summary>
		public FlagsSeriesZone Zones { get; set; }
		private FlagsSeriesZone Zones_DefaultValue { get; set; }
		...
		/// </summary>
		public FlagsSeriesGapUnit GapUnit { get; set; }
		private FlagsSeriesGapUnit GapUnit_DefaultValue { get; set; }
		...
		/// </summary>
		public FlagsSeriesMarker Marker { get; set; }
		private FlagsSeriesMarker Marker_DefaultValue { get; set; }
		...
		/// </summary>
		public FlagsSeriesLinecap Linecap { get; set; }
		private FlagsSeriesLinecap Linecap_DefaultValue { get; set; }
		 

		/// <summary>
		/// <p>Whether to apply steps to the line. Possible values are <code>left</code>, <code>center</code>and <code>right</code>.</p>
		/// </summary>
		public FlagsSeriesStep Step { get; set; }
		private FlagsSeriesStep Step_DefaultValue { get; set; }
