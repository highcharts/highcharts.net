...
{
	public partial class FlagsSeriesDataGrouping  : BaseObject
	{
		public FlagsSeriesDataGrouping()
		{
			Approximation = Approximation_DefaultValue = FlagsSeriesDataGroupingApproximation.Average;
		...
		/// </summary>
		public FlagsSeriesDataGroupingApproximation Approximation { get; set; }
		private FlagsSeriesDataGroupingApproximation Approximation_DefaultValue { get; set; }
