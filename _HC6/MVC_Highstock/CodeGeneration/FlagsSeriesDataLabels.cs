...
namespace Highsoft.Web.Mvc.Stocks
{
	public partial class FlagsSeriesDataLabels  : BaseObject
	{
		public FlagsSeriesDataLabels()
		{
			...
			Style = Style_DefaultValue = new FlagsSeriesDataLabelsStyle();
		...
		/// </summary>
		public FlagsSeriesDataLabelsStyle Style { get; set; }
		private FlagsSeriesDataLabelsStyle Style_DefaultValue { get; set; }
