...
{
	public partial class FlagsSeriesIkhDataGrouping  : BaseObject
	{
		public FlagsSeriesIkhDataGrouping()
		{
			Approximation = Approximation_DefaultValue = FlagsSeriesIkhDataGroupingApproximation.Average;
		...
		/// </summary>
		public FlagsSeriesIkhDataGroupingApproximation Approximation { get; set; }
		private FlagsSeriesIkhDataGroupingApproximation Approximation_DefaultValue { get; set; }
