...
{
	public partial class FlagsSeriesIkhDataLabels  : BaseObject
	{
		public FlagsSeriesIkhDataLabels()
		{
			Align = Align_DefaultValue = FlagsSeriesIkhDataLabelsAlign.Center;
			Formatter = Formatter_DefaultValue = "";
			Style = Style_DefaultValue = new FlagsSeriesIkhDataLabelsStyle();
			VerticalAlign = VerticalAlign_DefaultValue = FlagsSeriesIkhDataLabelsVerticalAlign.Bottom;
			X = X_DefaultValue = 0;
			Y = Y_DefaultValue = -6;
			...
			Overflow = Overflow_DefaultValue = FlagsSeriesIkhDataLabelsOverflow.Justify;
		...
		/// </summary>
		public FlagsSeriesIkhDataLabelsAlign Align { get; set; }
		private FlagsSeriesIkhDataLabelsAlign Align_DefaultValue { get; set; }
		...
		/// </summary>
		public FlagsSeriesIkhDataLabelsStyle Style { get; set; }
		private FlagsSeriesIkhDataLabelsStyle Style_DefaultValue { get; set; }
		...
		/// </summary>
		public FlagsSeriesIkhDataLabelsVerticalAlign VerticalAlign { get; set; }
		private FlagsSeriesIkhDataLabelsVerticalAlign VerticalAlign_DefaultValue { get; set; }
		...
		/// </summary>
		public FlagsSeriesIkhDataLabelsOverflow Overflow { get; set; }
		private FlagsSeriesIkhDataLabelsOverflow Overflow_DefaultValue { get; set; }
		...
		internal override Hashtable ToHashtable()
		{
			...
			if (Formatter != Formatter_DefaultValue) { h.Add("formatter",Formatter); Highstock.AddFunction("FlagsSeriesIkhDataLabelsFormatter.formatter", Formatter); }  
