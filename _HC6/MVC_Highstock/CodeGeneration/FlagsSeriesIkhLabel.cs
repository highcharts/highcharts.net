...
{
	public partial class FlagsSeriesIkhLabel  : BaseObject
	{
		public FlagsSeriesIkhLabel()
		{
			...
			Style = Style_DefaultValue = new FlagsSeriesIkhLabelStyle();
		...
		/// </summary>
		public FlagsSeriesIkhLabelStyle Style { get; set; }
		private FlagsSeriesIkhLabelStyle Style_DefaultValue { get; set; }
