...
{
	public partial class FlagsSeriesIkhMarker  : BaseObject
	{
		public FlagsSeriesIkhMarker()
		{
			LineWidth = LineWidth_DefaultValue = 0;
			LineColor = LineColor_DefaultValue = "#ffffff";
			Radius = Radius_DefaultValue = 4;
			States = States_DefaultValue = new FlagsSeriesIkhMarkerStates();
		...
		/// </summary>
		public FlagsSeriesIkhMarkerStates States { get; set; }
		private FlagsSeriesIkhMarkerStates States_DefaultValue { get; set; }
