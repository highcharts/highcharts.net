...
{
	public partial class FlagsSeriesIkhStatesHover  : BaseObject
	{
		public FlagsSeriesIkhStatesHover()
		{
			LineWidthPlus = LineWidthPlus_DefaultValue = 1;
			Marker = Marker_DefaultValue = new FlagsSeriesIkhStatesHoverMarker();
			Halo = Halo_DefaultValue = new FlagsSeriesIkhStatesHoverHalo();
		...
		/// </summary>
		public FlagsSeriesIkhStatesHoverMarker Marker { get; set; }
		private FlagsSeriesIkhStatesHoverMarker Marker_DefaultValue { get; set; }
		...
		/// </summary>
		public FlagsSeriesIkhStatesHoverHalo Halo { get; set; }
		private FlagsSeriesIkhStatesHoverHalo Halo_DefaultValue { get; set; }
