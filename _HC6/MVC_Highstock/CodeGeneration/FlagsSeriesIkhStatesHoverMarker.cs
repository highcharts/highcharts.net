...
{
	public partial class FlagsSeriesIkhStatesHoverMarker  : BaseObject
	{
		public FlagsSeriesIkhStatesHoverMarker()
		{
			LineWidth = LineWidth_DefaultValue = 0;
			LineColor = LineColor_DefaultValue = "#ffffff";
			Radius = Radius_DefaultValue = 4;
			States = States_DefaultValue = new FlagsSeriesIkhStatesHoverMarkerStates();
		...
		/// </summary>
		public FlagsSeriesIkhStatesHoverMarkerStates States { get; set; }
		private FlagsSeriesIkhStatesHoverMarkerStates States_DefaultValue { get; set; }
