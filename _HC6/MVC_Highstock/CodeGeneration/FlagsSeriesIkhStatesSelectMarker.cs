...
{
	public partial class FlagsSeriesIkhStatesSelectMarker  : BaseObject
	{
		public FlagsSeriesIkhStatesSelectMarker()
		{
			LineWidth = LineWidth_DefaultValue = 0;
			LineColor = LineColor_DefaultValue = "#ffffff";
			Radius = Radius_DefaultValue = 4;
			States = States_DefaultValue = new FlagsSeriesIkhStatesSelectMarkerStates();
		...
		/// </summary>
		public FlagsSeriesIkhStatesSelectMarkerStates States { get; set; }
		private FlagsSeriesIkhStatesSelectMarkerStates States_DefaultValue { get; set; }
