...
{
	public partial class FlagsSeriesIkhTooltip  : BaseObject
	{
		public FlagsSeriesIkhTooltip()
		{
			ValueDecimals = ValueDecimals_DefaultValue = null;
			DateTimeLabelFormats = DateTimeLabelFormats_DefaultValue = new FlagsSeriesIkhTooltipDateTimeLabelFormats();
		...
		/// </summary>
		public FlagsSeriesIkhTooltipDateTimeLabelFormats DateTimeLabelFormats { get; set; }
		private FlagsSeriesIkhTooltipDateTimeLabelFormats DateTimeLabelFormats_DefaultValue { get; set; }
		...
		internal override Hashtable ToHashtable()
		{
			...
			if (PointFormatter != PointFormatter_DefaultValue) { h.Add("pointFormatter",PointFormatter); Highstock.AddFunction("FlagsSeriesIkhTooltipPointFormatter.pointFormatter", PointFormatter); }  
