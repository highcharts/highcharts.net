...
{
	public partial class FlagsSeriesStatesHoverMarker  : BaseObject
	{
		public FlagsSeriesStatesHoverMarker()
		{
			LineWidth = LineWidth_DefaultValue = 0;
			LineColor = LineColor_DefaultValue = "#ffffff";
			Radius = Radius_DefaultValue = 4;
			States = States_DefaultValue = new FlagsSeriesStatesHoverMarkerStates();
		...
		/// </summary>
		public FlagsSeriesStatesHoverMarkerStates States { get; set; }
		private FlagsSeriesStatesHoverMarkerStates States_DefaultValue { get; set; }
