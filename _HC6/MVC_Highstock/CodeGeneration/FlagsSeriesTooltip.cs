...
namespace Highsoft.Web.Mvc.Stocks
{
	public partial class FlagsSeriesTooltip  : BaseObject
	{
		public FlagsSeriesTooltip()
		{
			...
			DateTimeLabelFormats = DateTimeLabelFormats_DefaultValue = new FlagsSeriesTooltipDateTimeLabelFormats();
		...
		/// </summary>
		public FlagsSeriesTooltipDateTimeLabelFormats DateTimeLabelFormats { get; set; }
		private FlagsSeriesTooltipDateTimeLabelFormats DateTimeLabelFormats_DefaultValue { get; set; }
