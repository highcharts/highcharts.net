...
{
	public partial class FunnelSeriesDataGrouping  : BaseObject
	{
		public FunnelSeriesDataGrouping()
		{
			Approximation = Approximation_DefaultValue = FunnelSeriesDataGroupingApproximation.Average;
		...
		/// </summary>
		public FunnelSeriesDataGroupingApproximation Approximation { get; set; }
		private FunnelSeriesDataGroupingApproximation Approximation_DefaultValue { get; set; }
