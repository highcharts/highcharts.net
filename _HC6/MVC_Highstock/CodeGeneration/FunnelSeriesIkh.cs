...
{
	public partial class FunnelSeriesIkh  : BaseObject
	{
		public FunnelSeriesIkh()
		{
			Name = Name_DefaultValue = "SMA (14)";
			Tooltip = Tooltip_DefaultValue = new FunnelSeriesIkhTooltip();
			LinkedTo = LinkedTo_DefaultValue = null;
			Params = Params_DefaultValue = new FunnelSeriesIkhParams();
			Linecap = Linecap_DefaultValue = FunnelSeriesIkhLinecap.Round;
			BoostThreshold = BoostThreshold_DefaultValue = 5000;
			GapSize = GapSize_DefaultValue = 0;
			GapUnit = GapUnit_DefaultValue = FunnelSeriesIkhGapUnit.Relative;
			Label = Label_DefaultValue = new FunnelSeriesIkhLabel();
			DataGrouping = DataGrouping_DefaultValue = new FunnelSeriesIkhDataGrouping();
			LineWidth = LineWidth_DefaultValue = 2;
			AllowPointSelect = AllowPointSelect_DefaultValue = false;
			ShowCheckbox = ShowCheckbox_DefaultValue = false;
			Animation = Animation_DefaultValue = new Animation() { Enabled = true };
			Events = Events_DefaultValue = new FunnelSeriesIkhEvents();
			Marker = Marker_DefaultValue = new FunnelSeriesIkhMarker();
			Point = Point_DefaultValue = new FunnelSeriesIkhPoint();
			DataLabels = DataLabels_DefaultValue = new FunnelSeriesIkhDataLabels();
			CropThreshold = CropThreshold_DefaultValue = 300;
			SoftThreshold = SoftThreshold_DefaultValue = true;
			States = States_DefaultValue = new FunnelSeriesIkhStates();
			StickyTracking = StickyTracking_DefaultValue = null;
			TurboThreshold = TurboThreshold_DefaultValue = 1000;
			FindNearestPointBy = FindNearestPointBy_DefaultValue = FunnelSeriesIkhFindNearestPointBy.X;
			AnimationLimit = AnimationLimit_DefaultValue = null;
			ClassName = ClassName_DefaultValue = null;
			Color = Color_DefaultValue = null;
			ColorIndex = ColorIndex_DefaultValue = null;
			ConnectNulls = ConnectNulls_DefaultValue = false;
			Cursor = Cursor_DefaultValue = FunnelSeriesIkhCursor.Null;
			DashStyle = DashStyle_DefaultValue = FunnelSeriesIkhDashStyle.Solid;
			...
			Step = Step_DefaultValue = FunnelSeriesIkhStep.Null;
			Threshold = Threshold_DefaultValue = 0;
			Visible = Visible_DefaultValue = true;
			ZoneAxis = ZoneAxis_DefaultValue = "y";
			Zones = Zones_DefaultValue = new List<FunnelSeriesIkhZone>();
			...
			PointIntervalUnit = PointIntervalUnit_DefaultValue = FunnelSeriesIkhPointIntervalUnit.Null;
			PointPlacement = PointPlacement_DefaultValue = new PointPlacement();
			PointStart = PointStart_DefaultValue = 0;
			Stacking = Stacking_DefaultValue = FunnelSeriesIkhStacking.Null;
			Compare = Compare_DefaultValue = "undefined";
			CompareBase = CompareBase_DefaultValue = FunnelSeriesIkhCompareBase.Min;
		...
		/// </summary>
		public FunnelSeriesIkhTooltip Tooltip { get; set; }
		private FunnelSeriesIkhTooltip Tooltip_DefaultValue { get; set; }
		...
		/// 
		/// </summary>
		public FunnelSeriesIkhParams Params { get; set; }
		private FunnelSeriesIkhParams Params_DefaultValue { get; set; }
		...
		/// </summary>
		public FunnelSeriesIkhLinecap Linecap { get; set; }
		private FunnelSeriesIkhLinecap Linecap_DefaultValue { get; set; }
		...
		/// </summary>
		public FunnelSeriesIkhGapUnit GapUnit { get; set; }
		private FunnelSeriesIkhGapUnit GapUnit_DefaultValue { get; set; }
		...
		/// </summary>
		public FunnelSeriesIkhLabel Label { get; set; }
		private FunnelSeriesIkhLabel Label_DefaultValue { get; set; }
		...
		/// </summary>
		public FunnelSeriesIkhDataGrouping DataGrouping { get; set; }
		private FunnelSeriesIkhDataGrouping DataGrouping_DefaultValue { get; set; }
		...
		/// </summary>
		public FunnelSeriesIkhEvents Events { get; set; }
		private FunnelSeriesIkhEvents Events_DefaultValue { get; set; }
		...
		/// </summary>
		public FunnelSeriesIkhMarker Marker { get; set; }
		private FunnelSeriesIkhMarker Marker_DefaultValue { get; set; }
		 

		/// <summary>
		/// <p>Properties for each single point.</p>
		/// </summary>
		public FunnelSeriesIkhPoint Point { get; set; }
		private FunnelSeriesIkhPoint Point_DefaultValue { get; set; }
		...
		/// </summary>
		public FunnelSeriesIkhDataLabels DataLabels { get; set; }
		private FunnelSeriesIkhDataLabels DataLabels_DefaultValue { get; set; }
		...
		/// </summary>
		public FunnelSeriesIkhStates States { get; set; }
		private FunnelSeriesIkhStates States_DefaultValue { get; set; }
		...
		/// </summary>
		public FunnelSeriesIkhFindNearestPointBy FindNearestPointBy { get; set; }
		private FunnelSeriesIkhFindNearestPointBy FindNearestPointBy_DefaultValue { get; set; }
		...
		/// </summary>
		public FunnelSeriesIkhCursor Cursor { get; set; }
		private FunnelSeriesIkhCursor Cursor_DefaultValue { get; set; }
		...
		/// </summary>
		public FunnelSeriesIkhDashStyle DashStyle { get; set; }
		private FunnelSeriesIkhDashStyle DashStyle_DefaultValue { get; set; }
		...
		/// </summary>
		public FunnelSeriesIkhStep Step { get; set; }
		private FunnelSeriesIkhStep Step_DefaultValue { get; set; }
		...
		/// </summary>
		public List<FunnelSeriesIkhZone> Zones { get; set; }
		private List<FunnelSeriesIkhZone> Zones_DefaultValue { get; set; }
		...
		/// </summary>
		public FunnelSeriesIkhPointIntervalUnit PointIntervalUnit { get; set; }
		private FunnelSeriesIkhPointIntervalUnit PointIntervalUnit_DefaultValue { get; set; }
		...
		/// </summary>
		public FunnelSeriesIkhStacking Stacking { get; set; }
		private FunnelSeriesIkhStacking Stacking_DefaultValue { get; set; }
		...
		/// </summary>
		public FunnelSeriesIkhCompareBase CompareBase { get; set; }
		private FunnelSeriesIkhCompareBase CompareBase_DefaultValue { get; set; }
		...
		internal override Hashtable ToHashtable()
		{
			...
			if (PointDescriptionFormatter != PointDescriptionFormatter_DefaultValue) { h.Add("pointDescriptionFormatter",PointDescriptionFormatter); Highstock.AddFunction("FunnelSeriesIkhPointDescriptionFormatter.pointDescriptionFormatter", PointDescriptionFormatter); }  
