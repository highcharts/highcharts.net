...
{
	public partial class FunnelSeriesIkhDataGrouping  : BaseObject
	{
		public FunnelSeriesIkhDataGrouping()
		{
			Approximation = Approximation_DefaultValue = FunnelSeriesIkhDataGroupingApproximation.Average;
		...
		/// </summary>
		public FunnelSeriesIkhDataGroupingApproximation Approximation { get; set; }
		private FunnelSeriesIkhDataGroupingApproximation Approximation_DefaultValue { get; set; }
