...
{
	public partial class FunnelSeriesIkhDataLabels  : BaseObject
	{
		public FunnelSeriesIkhDataLabels()
		{
			Align = Align_DefaultValue = FunnelSeriesIkhDataLabelsAlign.Center;
			Formatter = Formatter_DefaultValue = "";
			Style = Style_DefaultValue = new FunnelSeriesIkhDataLabelsStyle();
			VerticalAlign = VerticalAlign_DefaultValue = FunnelSeriesIkhDataLabelsVerticalAlign.Bottom;
			X = X_DefaultValue = 0;
			Y = Y_DefaultValue = -6;
			...
			Overflow = Overflow_DefaultValue = FunnelSeriesIkhDataLabelsOverflow.Justify;
		...
		/// </summary>
		public FunnelSeriesIkhDataLabelsAlign Align { get; set; }
		private FunnelSeriesIkhDataLabelsAlign Align_DefaultValue { get; set; }
		...
		/// </summary>
		public FunnelSeriesIkhDataLabelsStyle Style { get; set; }
		private FunnelSeriesIkhDataLabelsStyle Style_DefaultValue { get; set; }
		...
		/// </summary>
		public FunnelSeriesIkhDataLabelsVerticalAlign VerticalAlign { get; set; }
		private FunnelSeriesIkhDataLabelsVerticalAlign VerticalAlign_DefaultValue { get; set; }
		...
		/// </summary>
		public FunnelSeriesIkhDataLabelsOverflow Overflow { get; set; }
		private FunnelSeriesIkhDataLabelsOverflow Overflow_DefaultValue { get; set; }
		...
		internal override Hashtable ToHashtable()
		{
			...
			if (Formatter != Formatter_DefaultValue) { h.Add("formatter",Formatter); Highstock.AddFunction("FunnelSeriesIkhDataLabelsFormatter.formatter", Formatter); }  
