...
{
	public partial class FunnelSeriesIkhMarker  : BaseObject
	{
		public FunnelSeriesIkhMarker()
		{
			LineWidth = LineWidth_DefaultValue = 0;
			LineColor = LineColor_DefaultValue = "#ffffff";
			Radius = Radius_DefaultValue = 4;
			States = States_DefaultValue = new FunnelSeriesIkhMarkerStates();
		...
		/// </summary>
		public FunnelSeriesIkhMarkerStates States { get; set; }
		private FunnelSeriesIkhMarkerStates States_DefaultValue { get; set; }
