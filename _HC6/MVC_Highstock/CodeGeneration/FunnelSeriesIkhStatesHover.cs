...
{
	public partial class FunnelSeriesIkhStatesHover  : BaseObject
	{
		public FunnelSeriesIkhStatesHover()
		{
			LineWidthPlus = LineWidthPlus_DefaultValue = 1;
			Marker = Marker_DefaultValue = new FunnelSeriesIkhStatesHoverMarker();
			Halo = Halo_DefaultValue = new FunnelSeriesIkhStatesHoverHalo();
		...
		/// </summary>
		public FunnelSeriesIkhStatesHoverMarker Marker { get; set; }
		private FunnelSeriesIkhStatesHoverMarker Marker_DefaultValue { get; set; }
		...
		/// </summary>
		public FunnelSeriesIkhStatesHoverHalo Halo { get; set; }
		private FunnelSeriesIkhStatesHoverHalo Halo_DefaultValue { get; set; }
