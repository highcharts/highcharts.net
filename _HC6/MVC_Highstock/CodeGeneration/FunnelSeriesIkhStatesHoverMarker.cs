...
{
	public partial class FunnelSeriesIkhStatesHoverMarker  : BaseObject
	{
		public FunnelSeriesIkhStatesHoverMarker()
		{
			LineWidth = LineWidth_DefaultValue = 0;
			LineColor = LineColor_DefaultValue = "#ffffff";
			Radius = Radius_DefaultValue = 4;
			States = States_DefaultValue = new FunnelSeriesIkhStatesHoverMarkerStates();
		...
		/// </summary>
		public FunnelSeriesIkhStatesHoverMarkerStates States { get; set; }
		private FunnelSeriesIkhStatesHoverMarkerStates States_DefaultValue { get; set; }
