...
{
	public partial class FunnelSeriesIkhTooltip  : BaseObject
	{
		public FunnelSeriesIkhTooltip()
		{
			ValueDecimals = ValueDecimals_DefaultValue = null;
			DateTimeLabelFormats = DateTimeLabelFormats_DefaultValue = new FunnelSeriesIkhTooltipDateTimeLabelFormats();
		...
		/// </summary>
		public FunnelSeriesIkhTooltipDateTimeLabelFormats DateTimeLabelFormats { get; set; }
		private FunnelSeriesIkhTooltipDateTimeLabelFormats DateTimeLabelFormats_DefaultValue { get; set; }
		...
		internal override Hashtable ToHashtable()
		{
			...
			if (PointFormatter != PointFormatter_DefaultValue) { h.Add("pointFormatter",PointFormatter); Highstock.AddFunction("FunnelSeriesIkhTooltipPointFormatter.pointFormatter", PointFormatter); }  
