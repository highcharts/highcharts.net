...
{
	public partial class GaugeSeriesDataGrouping  : BaseObject
	{
		...
		/// </summary>
		public GaugeSeriesDataGroupingApproximation Approximation { get; set; }
		private GaugeSeriesDataGroupingApproximation Approximation_DefaultValue { get; set; }
