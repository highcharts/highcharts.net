...
{
	public partial class GaugeSeriesIkh  : BaseObject
	{
		public GaugeSeriesIkh()
		{
			Name = Name_DefaultValue = "SMA (14)";
			Tooltip = Tooltip_DefaultValue = new GaugeSeriesIkhTooltip();
			LinkedTo = LinkedTo_DefaultValue = null;
			Params = Params_DefaultValue = new GaugeSeriesIkhParams();
			Linecap = Linecap_DefaultValue = GaugeSeriesIkhLinecap.Round;
			BoostThreshold = BoostThreshold_DefaultValue = 5000;
			GapSize = GapSize_DefaultValue = 0;
			GapUnit = GapUnit_DefaultValue = GaugeSeriesIkhGapUnit.Relative;
			Label = Label_DefaultValue = new GaugeSeriesIkhLabel();
			DataGrouping = DataGrouping_DefaultValue = new GaugeSeriesIkhDataGrouping();
			LineWidth = LineWidth_DefaultValue = 2;
			AllowPointSelect = AllowPointSelect_DefaultValue = false;
			ShowCheckbox = ShowCheckbox_DefaultValue = false;
			Animation = Animation_DefaultValue = new Animation() { Enabled = true };
			Events = Events_DefaultValue = new GaugeSeriesIkhEvents();
			Marker = Marker_DefaultValue = new GaugeSeriesIkhMarker();
			Point = Point_DefaultValue = new GaugeSeriesIkhPoint();
			DataLabels = DataLabels_DefaultValue = new GaugeSeriesIkhDataLabels();
			CropThreshold = CropThreshold_DefaultValue = 300;
			SoftThreshold = SoftThreshold_DefaultValue = true;
			States = States_DefaultValue = new GaugeSeriesIkhStates();
			StickyTracking = StickyTracking_DefaultValue = null;
			TurboThreshold = TurboThreshold_DefaultValue = 1000;
			FindNearestPointBy = FindNearestPointBy_DefaultValue = GaugeSeriesIkhFindNearestPointBy.X;
			AnimationLimit = AnimationLimit_DefaultValue = null;
			ClassName = ClassName_DefaultValue = null;
			Color = Color_DefaultValue = null;
			ColorIndex = ColorIndex_DefaultValue = null;
			ConnectNulls = ConnectNulls_DefaultValue = false;
			Cursor = Cursor_DefaultValue = GaugeSeriesIkhCursor.Null;
			DashStyle = DashStyle_DefaultValue = GaugeSeriesIkhDashStyle.Solid;
			...
			Step = Step_DefaultValue = GaugeSeriesIkhStep.Null;
			Threshold = Threshold_DefaultValue = 0;
			Visible = Visible_DefaultValue = true;
			ZoneAxis = ZoneAxis_DefaultValue = "y";
			Zones = Zones_DefaultValue = new List<GaugeSeriesIkhZone>();
			...
			PointIntervalUnit = PointIntervalUnit_DefaultValue = GaugeSeriesIkhPointIntervalUnit.Null;
			PointPlacement = PointPlacement_DefaultValue = new PointPlacement();
			PointStart = PointStart_DefaultValue = 0;
			Stacking = Stacking_DefaultValue = GaugeSeriesIkhStacking.Null;
			Compare = Compare_DefaultValue = "undefined";
			CompareBase = CompareBase_DefaultValue = GaugeSeriesIkhCompareBase.Min;
		...
		/// </summary>
		public GaugeSeriesIkhTooltip Tooltip { get; set; }
		private GaugeSeriesIkhTooltip Tooltip_DefaultValue { get; set; }
		...
		/// 
		/// </summary>
		public GaugeSeriesIkhParams Params { get; set; }
		private GaugeSeriesIkhParams Params_DefaultValue { get; set; }
		...
		/// </summary>
		public GaugeSeriesIkhLinecap Linecap { get; set; }
		private GaugeSeriesIkhLinecap Linecap_DefaultValue { get; set; }
		...
		/// </summary>
		public GaugeSeriesIkhGapUnit GapUnit { get; set; }
		private GaugeSeriesIkhGapUnit GapUnit_DefaultValue { get; set; }
		...
		/// </summary>
		public GaugeSeriesIkhLabel Label { get; set; }
		private GaugeSeriesIkhLabel Label_DefaultValue { get; set; }
		...
		/// </summary>
		public GaugeSeriesIkhDataGrouping DataGrouping { get; set; }
		private GaugeSeriesIkhDataGrouping DataGrouping_DefaultValue { get; set; }
		...
		/// </summary>
		public GaugeSeriesIkhEvents Events { get; set; }
		private GaugeSeriesIkhEvents Events_DefaultValue { get; set; }
		...
		/// </summary>
		public GaugeSeriesIkhMarker Marker { get; set; }
		private GaugeSeriesIkhMarker Marker_DefaultValue { get; set; }
		 

		/// <summary>
		/// <p>Properties for each single point.</p>
		/// </summary>
		public GaugeSeriesIkhPoint Point { get; set; }
		private GaugeSeriesIkhPoint Point_DefaultValue { get; set; }
		...
		/// </summary>
		public GaugeSeriesIkhDataLabels DataLabels { get; set; }
		private GaugeSeriesIkhDataLabels DataLabels_DefaultValue { get; set; }
		...
		/// </summary>
		public GaugeSeriesIkhStates States { get; set; }
		private GaugeSeriesIkhStates States_DefaultValue { get; set; }
		...
		/// </summary>
		public GaugeSeriesIkhFindNearestPointBy FindNearestPointBy { get; set; }
		private GaugeSeriesIkhFindNearestPointBy FindNearestPointBy_DefaultValue { get; set; }
		...
		/// </summary>
		public GaugeSeriesIkhCursor Cursor { get; set; }
		private GaugeSeriesIkhCursor Cursor_DefaultValue { get; set; }
		...
		/// </summary>
		public GaugeSeriesIkhDashStyle DashStyle { get; set; }
		private GaugeSeriesIkhDashStyle DashStyle_DefaultValue { get; set; }
		...
		/// </summary>
		public GaugeSeriesIkhStep Step { get; set; }
		private GaugeSeriesIkhStep Step_DefaultValue { get; set; }
		...
		/// </summary>
		public List<GaugeSeriesIkhZone> Zones { get; set; }
		private List<GaugeSeriesIkhZone> Zones_DefaultValue { get; set; }
		...
		/// </summary>
		public GaugeSeriesIkhPointIntervalUnit PointIntervalUnit { get; set; }
		private GaugeSeriesIkhPointIntervalUnit PointIntervalUnit_DefaultValue { get; set; }
		...
		/// </summary>
		public GaugeSeriesIkhStacking Stacking { get; set; }
		private GaugeSeriesIkhStacking Stacking_DefaultValue { get; set; }
		...
		/// </summary>
		public GaugeSeriesIkhCompareBase CompareBase { get; set; }
		private GaugeSeriesIkhCompareBase CompareBase_DefaultValue { get; set; }
		...
		internal override Hashtable ToHashtable()
		{
			...
			if (PointDescriptionFormatter != PointDescriptionFormatter_DefaultValue) { h.Add("pointDescriptionFormatter",PointDescriptionFormatter); Highstock.AddFunction("GaugeSeriesIkhPointDescriptionFormatter.pointDescriptionFormatter", PointDescriptionFormatter); }  
