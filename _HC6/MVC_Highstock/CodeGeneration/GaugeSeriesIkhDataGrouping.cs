...
{
	public partial class GaugeSeriesIkhDataGrouping  : BaseObject
	{
		public GaugeSeriesIkhDataGrouping()
		{
			Approximation = Approximation_DefaultValue = GaugeSeriesIkhDataGroupingApproximation.Average;
		...
		/// </summary>
		public GaugeSeriesIkhDataGroupingApproximation Approximation { get; set; }
		private GaugeSeriesIkhDataGroupingApproximation Approximation_DefaultValue { get; set; }
