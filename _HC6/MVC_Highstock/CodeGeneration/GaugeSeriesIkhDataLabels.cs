...
{
	public partial class GaugeSeriesIkhDataLabels  : BaseObject
	{
		public GaugeSeriesIkhDataLabels()
		{
			Align = Align_DefaultValue = GaugeSeriesIkhDataLabelsAlign.Center;
			Formatter = Formatter_DefaultValue = "";
			Style = Style_DefaultValue = new GaugeSeriesIkhDataLabelsStyle();
			VerticalAlign = VerticalAlign_DefaultValue = GaugeSeriesIkhDataLabelsVerticalAlign.Bottom;
			X = X_DefaultValue = 0;
			Y = Y_DefaultValue = -6;
			...
			Overflow = Overflow_DefaultValue = GaugeSeriesIkhDataLabelsOverflow.Justify;
		...
		/// </summary>
		public GaugeSeriesIkhDataLabelsAlign Align { get; set; }
		private GaugeSeriesIkhDataLabelsAlign Align_DefaultValue { get; set; }
		...
		/// </summary>
		public GaugeSeriesIkhDataLabelsStyle Style { get; set; }
		private GaugeSeriesIkhDataLabelsStyle Style_DefaultValue { get; set; }
		...
		/// </summary>
		public GaugeSeriesIkhDataLabelsVerticalAlign VerticalAlign { get; set; }
		private GaugeSeriesIkhDataLabelsVerticalAlign VerticalAlign_DefaultValue { get; set; }
		...
		/// </summary>
		public GaugeSeriesIkhDataLabelsOverflow Overflow { get; set; }
		private GaugeSeriesIkhDataLabelsOverflow Overflow_DefaultValue { get; set; }
		...
		internal override Hashtable ToHashtable()
		{
			...
			if (Formatter != Formatter_DefaultValue) { h.Add("formatter",Formatter); Highstock.AddFunction("GaugeSeriesIkhDataLabelsFormatter.formatter", Formatter); }  
