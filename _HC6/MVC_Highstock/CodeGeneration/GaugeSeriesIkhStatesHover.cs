...
{
	public partial class GaugeSeriesIkhStatesHover  : BaseObject
	{
		public GaugeSeriesIkhStatesHover()
		{
			LineWidthPlus = LineWidthPlus_DefaultValue = 1;
			Marker = Marker_DefaultValue = new GaugeSeriesIkhStatesHoverMarker();
			Halo = Halo_DefaultValue = new GaugeSeriesIkhStatesHoverHalo();
		...
		/// </summary>
		public GaugeSeriesIkhStatesHoverMarker Marker { get; set; }
		private GaugeSeriesIkhStatesHoverMarker Marker_DefaultValue { get; set; }
		...
		/// </summary>
		public GaugeSeriesIkhStatesHoverHalo Halo { get; set; }
		private GaugeSeriesIkhStatesHoverHalo Halo_DefaultValue { get; set; }
