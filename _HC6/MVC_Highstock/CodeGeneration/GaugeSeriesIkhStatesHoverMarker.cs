...
{
	public partial class GaugeSeriesIkhStatesHoverMarker  : BaseObject
	{
		public GaugeSeriesIkhStatesHoverMarker()
		{
			LineWidth = LineWidth_DefaultValue = 0;
			LineColor = LineColor_DefaultValue = "#ffffff";
			Radius = Radius_DefaultValue = 4;
			States = States_DefaultValue = new GaugeSeriesIkhStatesHoverMarkerStates();
		...
		/// </summary>
		public GaugeSeriesIkhStatesHoverMarkerStates States { get; set; }
		private GaugeSeriesIkhStatesHoverMarkerStates States_DefaultValue { get; set; }
