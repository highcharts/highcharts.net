...
{
	public partial class GaugeSeriesIkhTooltip  : BaseObject
	{
		public GaugeSeriesIkhTooltip()
		{
			ValueDecimals = ValueDecimals_DefaultValue = null;
			DateTimeLabelFormats = DateTimeLabelFormats_DefaultValue = new GaugeSeriesIkhTooltipDateTimeLabelFormats();
		...
		/// </summary>
		public GaugeSeriesIkhTooltipDateTimeLabelFormats DateTimeLabelFormats { get; set; }
		private GaugeSeriesIkhTooltipDateTimeLabelFormats DateTimeLabelFormats_DefaultValue { get; set; }
		...
		internal override Hashtable ToHashtable()
		{
			...
			if (PointFormatter != PointFormatter_DefaultValue) { h.Add("pointFormatter",PointFormatter); Highstock.AddFunction("GaugeSeriesIkhTooltipPointFormatter.pointFormatter", PointFormatter); }  
