...
{
	public partial class GaugeSeriesMarker  : BaseObject
	{
		public GaugeSeriesMarker()
		{
			LineWidth = LineWidth_DefaultValue = 0;
			LineColor = LineColor_DefaultValue = "#ffffff";
			Radius = Radius_DefaultValue = 4;
			States = States_DefaultValue = new GaugeSeriesMarkerStates();
		...
		/// </summary>
		public GaugeSeriesMarkerStates States { get; set; }
		private GaugeSeriesMarkerStates States_DefaultValue { get; set; }
