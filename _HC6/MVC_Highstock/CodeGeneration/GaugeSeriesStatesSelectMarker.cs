...
{
	public partial class GaugeSeriesStatesSelectMarker  : BaseObject
	{
		public GaugeSeriesStatesSelectMarker()
		{
			LineWidth = LineWidth_DefaultValue = 0;
			LineColor = LineColor_DefaultValue = "#ffffff";
			Radius = Radius_DefaultValue = 4;
			States = States_DefaultValue = new GaugeSeriesStatesSelectMarkerStates();
		...
		/// </summary>
		public GaugeSeriesStatesSelectMarkerStates States { get; set; }
		private GaugeSeriesStatesSelectMarkerStates States_DefaultValue { get; set; }
