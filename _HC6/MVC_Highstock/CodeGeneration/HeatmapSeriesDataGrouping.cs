...
{
	public partial class HeatmapSeriesDataGrouping  : BaseObject
	{
		public HeatmapSeriesDataGrouping()
		{
			Approximation = Approximation_DefaultValue = HeatmapSeriesDataGroupingApproximation.Average;
		...
		/// </summary>
		public HeatmapSeriesDataGroupingApproximation Approximation { get; set; }
		private HeatmapSeriesDataGroupingApproximation Approximation_DefaultValue { get; set; }
