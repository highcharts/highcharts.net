...
{
	public partial class HeatmapSeriesIkh  : BaseObject
	{
		public HeatmapSeriesIkh()
		{
			Name = Name_DefaultValue = "SMA (14)";
			Tooltip = Tooltip_DefaultValue = new HeatmapSeriesIkhTooltip();
			LinkedTo = LinkedTo_DefaultValue = null;
			Params = Params_DefaultValue = new HeatmapSeriesIkhParams();
			Linecap = Linecap_DefaultValue = HeatmapSeriesIkhLinecap.Round;
			BoostThreshold = BoostThreshold_DefaultValue = 5000;
			GapSize = GapSize_DefaultValue = 0;
			GapUnit = GapUnit_DefaultValue = HeatmapSeriesIkhGapUnit.Relative;
			Label = Label_DefaultValue = new HeatmapSeriesIkhLabel();
			DataGrouping = DataGrouping_DefaultValue = new HeatmapSeriesIkhDataGrouping();
			LineWidth = LineWidth_DefaultValue = 2;
			AllowPointSelect = AllowPointSelect_DefaultValue = false;
			ShowCheckbox = ShowCheckbox_DefaultValue = false;
			Animation = Animation_DefaultValue = new Animation() { Enabled = true };
			Events = Events_DefaultValue = new HeatmapSeriesIkhEvents();
			Marker = Marker_DefaultValue = new HeatmapSeriesIkhMarker();
			Point = Point_DefaultValue = new HeatmapSeriesIkhPoint();
			DataLabels = DataLabels_DefaultValue = new HeatmapSeriesIkhDataLabels();
			CropThreshold = CropThreshold_DefaultValue = 300;
			SoftThreshold = SoftThreshold_DefaultValue = true;
			States = States_DefaultValue = new HeatmapSeriesIkhStates();
			StickyTracking = StickyTracking_DefaultValue = null;
			TurboThreshold = TurboThreshold_DefaultValue = 1000;
			FindNearestPointBy = FindNearestPointBy_DefaultValue = HeatmapSeriesIkhFindNearestPointBy.X;
			AnimationLimit = AnimationLimit_DefaultValue = null;
			ClassName = ClassName_DefaultValue = null;
			Color = Color_DefaultValue = null;
			ColorIndex = ColorIndex_DefaultValue = null;
			ConnectNulls = ConnectNulls_DefaultValue = false;
			Cursor = Cursor_DefaultValue = HeatmapSeriesIkhCursor.Null;
			DashStyle = DashStyle_DefaultValue = HeatmapSeriesIkhDashStyle.Solid;
			...
			Step = Step_DefaultValue = HeatmapSeriesIkhStep.Null;
			Threshold = Threshold_DefaultValue = 0;
			Visible = Visible_DefaultValue = true;
			ZoneAxis = ZoneAxis_DefaultValue = "y";
			Zones = Zones_DefaultValue = new List<HeatmapSeriesIkhZone>();
			...
			PointIntervalUnit = PointIntervalUnit_DefaultValue = HeatmapSeriesIkhPointIntervalUnit.Null;
			PointPlacement = PointPlacement_DefaultValue = new PointPlacement();
			PointStart = PointStart_DefaultValue = 0;
			Stacking = Stacking_DefaultValue = HeatmapSeriesIkhStacking.Null;
			Compare = Compare_DefaultValue = "undefined";
			CompareBase = CompareBase_DefaultValue = HeatmapSeriesIkhCompareBase.Min;
		...
		/// </summary>
		public HeatmapSeriesIkhTooltip Tooltip { get; set; }
		private HeatmapSeriesIkhTooltip Tooltip_DefaultValue { get; set; }
		...
		/// 
		/// </summary>
		public HeatmapSeriesIkhParams Params { get; set; }
		private HeatmapSeriesIkhParams Params_DefaultValue { get; set; }
		...
		/// </summary>
		public HeatmapSeriesIkhLinecap Linecap { get; set; }
		private HeatmapSeriesIkhLinecap Linecap_DefaultValue { get; set; }
		...
		/// </summary>
		public HeatmapSeriesIkhGapUnit GapUnit { get; set; }
		private HeatmapSeriesIkhGapUnit GapUnit_DefaultValue { get; set; }
		...
		/// </summary>
		public HeatmapSeriesIkhLabel Label { get; set; }
		private HeatmapSeriesIkhLabel Label_DefaultValue { get; set; }
		...
		/// </summary>
		public HeatmapSeriesIkhDataGrouping DataGrouping { get; set; }
		private HeatmapSeriesIkhDataGrouping DataGrouping_DefaultValue { get; set; }
		...
		/// </summary>
		public HeatmapSeriesIkhEvents Events { get; set; }
		private HeatmapSeriesIkhEvents Events_DefaultValue { get; set; }
		...
		/// </summary>
		public HeatmapSeriesIkhMarker Marker { get; set; }
		private HeatmapSeriesIkhMarker Marker_DefaultValue { get; set; }
		 

		/// <summary>
		/// <p>Properties for each single point.</p>
		/// </summary>
		public HeatmapSeriesIkhPoint Point { get; set; }
		private HeatmapSeriesIkhPoint Point_DefaultValue { get; set; }
		...
		/// </summary>
		public HeatmapSeriesIkhDataLabels DataLabels { get; set; }
		private HeatmapSeriesIkhDataLabels DataLabels_DefaultValue { get; set; }
		...
		/// </summary>
		public HeatmapSeriesIkhStates States { get; set; }
		private HeatmapSeriesIkhStates States_DefaultValue { get; set; }
		...
		/// </summary>
		public HeatmapSeriesIkhFindNearestPointBy FindNearestPointBy { get; set; }
		private HeatmapSeriesIkhFindNearestPointBy FindNearestPointBy_DefaultValue { get; set; }
		...
		/// </summary>
		public HeatmapSeriesIkhCursor Cursor { get; set; }
		private HeatmapSeriesIkhCursor Cursor_DefaultValue { get; set; }
		...
		/// </summary>
		public HeatmapSeriesIkhDashStyle DashStyle { get; set; }
		private HeatmapSeriesIkhDashStyle DashStyle_DefaultValue { get; set; }
		...
		/// </summary>
		public HeatmapSeriesIkhStep Step { get; set; }
		private HeatmapSeriesIkhStep Step_DefaultValue { get; set; }
		...
		/// </summary>
		public List<HeatmapSeriesIkhZone> Zones { get; set; }
		private List<HeatmapSeriesIkhZone> Zones_DefaultValue { get; set; }
		...
		/// </summary>
		public HeatmapSeriesIkhPointIntervalUnit PointIntervalUnit { get; set; }
		private HeatmapSeriesIkhPointIntervalUnit PointIntervalUnit_DefaultValue { get; set; }
		...
		/// </summary>
		public HeatmapSeriesIkhStacking Stacking { get; set; }
		private HeatmapSeriesIkhStacking Stacking_DefaultValue { get; set; }
		...
		/// </summary>
		public HeatmapSeriesIkhCompareBase CompareBase { get; set; }
		private HeatmapSeriesIkhCompareBase CompareBase_DefaultValue { get; set; }
		...
		internal override Hashtable ToHashtable()
		{
			...
			if (PointDescriptionFormatter != PointDescriptionFormatter_DefaultValue) { h.Add("pointDescriptionFormatter",PointDescriptionFormatter); Highstock.AddFunction("HeatmapSeriesIkhPointDescriptionFormatter.pointDescriptionFormatter", PointDescriptionFormatter); }  
