...
{
	public partial class HeatmapSeriesIkhDataGrouping  : BaseObject
	{
		...
		/// </summary>
		public HeatmapSeriesIkhDataGroupingApproximation Approximation { get; set; }
		private HeatmapSeriesIkhDataGroupingApproximation Approximation_DefaultValue { get; set; }
