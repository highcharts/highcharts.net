...
{
	public partial class HeatmapSeriesIkhDataLabels  : BaseObject
	{
		public HeatmapSeriesIkhDataLabels()
		{
			Align = Align_DefaultValue = HeatmapSeriesIkhDataLabelsAlign.Center;
			Formatter = Formatter_DefaultValue = "";
			Style = Style_DefaultValue = new HeatmapSeriesIkhDataLabelsStyle();
			VerticalAlign = VerticalAlign_DefaultValue = HeatmapSeriesIkhDataLabelsVerticalAlign.Bottom;
			X = X_DefaultValue = 0;
			Y = Y_DefaultValue = -6;
			...
			Overflow = Overflow_DefaultValue = HeatmapSeriesIkhDataLabelsOverflow.Justify;
		...
		/// </summary>
		public HeatmapSeriesIkhDataLabelsAlign Align { get; set; }
		private HeatmapSeriesIkhDataLabelsAlign Align_DefaultValue { get; set; }
		...
		/// </summary>
		public HeatmapSeriesIkhDataLabelsStyle Style { get; set; }
		private HeatmapSeriesIkhDataLabelsStyle Style_DefaultValue { get; set; }
		...
		/// </summary>
		public HeatmapSeriesIkhDataLabelsVerticalAlign VerticalAlign { get; set; }
		private HeatmapSeriesIkhDataLabelsVerticalAlign VerticalAlign_DefaultValue { get; set; }
		...
		/// </summary>
		public HeatmapSeriesIkhDataLabelsOverflow Overflow { get; set; }
		private HeatmapSeriesIkhDataLabelsOverflow Overflow_DefaultValue { get; set; }
		...
		internal override Hashtable ToHashtable()
		{
			...
			if (Formatter != Formatter_DefaultValue) { h.Add("formatter",Formatter); Highstock.AddFunction("HeatmapSeriesIkhDataLabelsFormatter.formatter", Formatter); }  
