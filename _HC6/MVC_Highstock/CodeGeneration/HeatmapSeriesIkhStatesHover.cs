...
{
	public partial class HeatmapSeriesIkhStatesHover  : BaseObject
	{
		public HeatmapSeriesIkhStatesHover()
		{
			LineWidthPlus = LineWidthPlus_DefaultValue = 1;
			Marker = Marker_DefaultValue = new HeatmapSeriesIkhStatesHoverMarker();
			Halo = Halo_DefaultValue = new HeatmapSeriesIkhStatesHoverHalo();
		...
		/// </summary>
		public HeatmapSeriesIkhStatesHoverMarker Marker { get; set; }
		private HeatmapSeriesIkhStatesHoverMarker Marker_DefaultValue { get; set; }
		...
		/// </summary>
		public HeatmapSeriesIkhStatesHoverHalo Halo { get; set; }
		private HeatmapSeriesIkhStatesHoverHalo Halo_DefaultValue { get; set; }
