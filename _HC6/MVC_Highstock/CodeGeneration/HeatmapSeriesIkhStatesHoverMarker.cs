...
{
	public partial class HeatmapSeriesIkhStatesHoverMarker  : BaseObject
	{
		public HeatmapSeriesIkhStatesHoverMarker()
		{
			LineWidth = LineWidth_DefaultValue = 0;
			LineColor = LineColor_DefaultValue = "#ffffff";
			Radius = Radius_DefaultValue = 4;
			States = States_DefaultValue = new HeatmapSeriesIkhStatesHoverMarkerStates();
		...
		/// </summary>
		public HeatmapSeriesIkhStatesHoverMarkerStates States { get; set; }
		private HeatmapSeriesIkhStatesHoverMarkerStates States_DefaultValue { get; set; }
