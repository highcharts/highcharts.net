...
{
	public partial class HeatmapSeriesIkhStatesSelectMarker  : BaseObject
	{
		public HeatmapSeriesIkhStatesSelectMarker()
		{
			LineWidth = LineWidth_DefaultValue = 0;
			LineColor = LineColor_DefaultValue = "#ffffff";
			Radius = Radius_DefaultValue = 4;
			States = States_DefaultValue = new HeatmapSeriesIkhStatesSelectMarkerStates();
		...
		/// </summary>
		public HeatmapSeriesIkhStatesSelectMarkerStates States { get; set; }
		private HeatmapSeriesIkhStatesSelectMarkerStates States_DefaultValue { get; set; }
