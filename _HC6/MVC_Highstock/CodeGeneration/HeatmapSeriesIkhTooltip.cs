...
{
	public partial class HeatmapSeriesIkhTooltip  : BaseObject
	{
		public HeatmapSeriesIkhTooltip()
		{
			ValueDecimals = ValueDecimals_DefaultValue = null;
			DateTimeLabelFormats = DateTimeLabelFormats_DefaultValue = new HeatmapSeriesIkhTooltipDateTimeLabelFormats();
		...
		/// </summary>
		public HeatmapSeriesIkhTooltipDateTimeLabelFormats DateTimeLabelFormats { get; set; }
		private HeatmapSeriesIkhTooltipDateTimeLabelFormats DateTimeLabelFormats_DefaultValue { get; set; }
		...
		internal override Hashtable ToHashtable()
		{
			...
			if (PointFormatter != PointFormatter_DefaultValue) { h.Add("pointFormatter",PointFormatter); Highstock.AddFunction("HeatmapSeriesIkhTooltipPointFormatter.pointFormatter", PointFormatter); }  
