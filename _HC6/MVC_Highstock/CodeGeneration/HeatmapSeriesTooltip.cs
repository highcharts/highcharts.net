...
namespace Highsoft.Web.Mvc.Stocks
{
	public partial class HeatmapSeriesTooltip  : BaseObject
	{
		public HeatmapSeriesTooltip()
		{
			...
			DateTimeLabelFormats = DateTimeLabelFormats_DefaultValue = new HeatmapSeriesTooltipDateTimeLabelFormats();
		...
		/// </summary>
		public HeatmapSeriesTooltipDateTimeLabelFormats DateTimeLabelFormats { get; set; }
		private HeatmapSeriesTooltipDateTimeLabelFormats DateTimeLabelFormats_DefaultValue { get; set; }
		...
		internal override Hashtable ToHashtable()
		{
			...
			if (PointFormatter != PointFormatter_DefaultValue) { h.Add("pointFormatter",PointFormatter); Highstock.AddFunction("HeatmapSeriesTooltipPointFormatter.pointFormatter", PointFormatter); }  
