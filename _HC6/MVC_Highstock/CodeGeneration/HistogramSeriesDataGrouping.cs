...
{
	public partial class HistogramSeriesDataGrouping  : BaseObject
	{
		public HistogramSeriesDataGrouping()
		{
			GroupPixelWidth = GroupPixelWidth_DefaultValue = 10;
			Approximation = Approximation_DefaultValue = HistogramSeriesDataGroupingApproximation.Average;
		...
		/// </summary>
		public HistogramSeriesDataGroupingApproximation Approximation { get; set; }
		private HistogramSeriesDataGroupingApproximation Approximation_DefaultValue { get; set; }
