...
namespace Highsoft.Web.Mvc.Stocks
{
	public partial class HistogramSeriesIkh  : BaseObject
	{
		public HistogramSeriesIkh()
		{
			...
			Zones = Zones_DefaultValue = new HistogramSeriesIkhZone();
		...
		/// </summary>
		public HistogramSeriesIkhZone Zones { get; set; }
		private HistogramSeriesIkhZone Zones_DefaultValue { get; set; }
