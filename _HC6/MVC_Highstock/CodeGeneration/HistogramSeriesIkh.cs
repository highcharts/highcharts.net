...
{
	public partial class HistogramSeriesIkh  : BaseObject
	{
		public HistogramSeriesIkh()
		{
			Name = Name_DefaultValue = "SMA (14)";
			Tooltip = Tooltip_DefaultValue = new HistogramSeriesIkhTooltip();
			LinkedTo = LinkedTo_DefaultValue = null;
			Params = Params_DefaultValue = new HistogramSeriesIkhParams();
			Linecap = Linecap_DefaultValue = HistogramSeriesIkhLinecap.Round;
			BoostThreshold = BoostThreshold_DefaultValue = 5000;
			GapSize = GapSize_DefaultValue = 0;
			GapUnit = GapUnit_DefaultValue = HistogramSeriesIkhGapUnit.Relative;
			Label = Label_DefaultValue = new HistogramSeriesIkhLabel();
			DataGrouping = DataGrouping_DefaultValue = new HistogramSeriesIkhDataGrouping();
			LineWidth = LineWidth_DefaultValue = 2;
			AllowPointSelect = AllowPointSelect_DefaultValue = false;
			ShowCheckbox = ShowCheckbox_DefaultValue = false;
			Animation = Animation_DefaultValue = new Animation() { Enabled = true };
			Events = Events_DefaultValue = new HistogramSeriesIkhEvents();
			Marker = Marker_DefaultValue = new HistogramSeriesIkhMarker();
			Point = Point_DefaultValue = new HistogramSeriesIkhPoint();
			DataLabels = DataLabels_DefaultValue = new HistogramSeriesIkhDataLabels();
			CropThreshold = CropThreshold_DefaultValue = 300;
			SoftThreshold = SoftThreshold_DefaultValue = true;
			States = States_DefaultValue = new HistogramSeriesIkhStates();
			StickyTracking = StickyTracking_DefaultValue = null;
			TurboThreshold = TurboThreshold_DefaultValue = 1000;
			FindNearestPointBy = FindNearestPointBy_DefaultValue = HistogramSeriesIkhFindNearestPointBy.X;
			AnimationLimit = AnimationLimit_DefaultValue = null;
			ClassName = ClassName_DefaultValue = null;
			Color = Color_DefaultValue = null;
			ColorIndex = ColorIndex_DefaultValue = null;
			ConnectNulls = ConnectNulls_DefaultValue = false;
			Cursor = Cursor_DefaultValue = HistogramSeriesIkhCursor.Null;
			DashStyle = DashStyle_DefaultValue = HistogramSeriesIkhDashStyle.Solid;
			...
			Step = Step_DefaultValue = HistogramSeriesIkhStep.Null;
			Threshold = Threshold_DefaultValue = 0;
			Visible = Visible_DefaultValue = true;
			ZoneAxis = ZoneAxis_DefaultValue = "y";
			Zones = Zones_DefaultValue = new List<HistogramSeriesIkhZone>();
			...
			PointIntervalUnit = PointIntervalUnit_DefaultValue = HistogramSeriesIkhPointIntervalUnit.Null;
			PointPlacement = PointPlacement_DefaultValue = new PointPlacement();
			PointStart = PointStart_DefaultValue = 0;
			Stacking = Stacking_DefaultValue = HistogramSeriesIkhStacking.Null;
			Compare = Compare_DefaultValue = "undefined";
			CompareBase = CompareBase_DefaultValue = HistogramSeriesIkhCompareBase.Min;
		...
		/// </summary>
		public HistogramSeriesIkhTooltip Tooltip { get; set; }
		private HistogramSeriesIkhTooltip Tooltip_DefaultValue { get; set; }
		...
		/// 
		/// </summary>
		public HistogramSeriesIkhParams Params { get; set; }
		private HistogramSeriesIkhParams Params_DefaultValue { get; set; }
		...
		/// </summary>
		public HistogramSeriesIkhLinecap Linecap { get; set; }
		private HistogramSeriesIkhLinecap Linecap_DefaultValue { get; set; }
		...
		/// </summary>
		public HistogramSeriesIkhGapUnit GapUnit { get; set; }
		private HistogramSeriesIkhGapUnit GapUnit_DefaultValue { get; set; }
		...
		/// </summary>
		public HistogramSeriesIkhLabel Label { get; set; }
		private HistogramSeriesIkhLabel Label_DefaultValue { get; set; }
		...
		/// </summary>
		public HistogramSeriesIkhDataGrouping DataGrouping { get; set; }
		private HistogramSeriesIkhDataGrouping DataGrouping_DefaultValue { get; set; }
		...
		/// </summary>
		public HistogramSeriesIkhEvents Events { get; set; }
		private HistogramSeriesIkhEvents Events_DefaultValue { get; set; }
		...
		/// </summary>
		public HistogramSeriesIkhMarker Marker { get; set; }
		private HistogramSeriesIkhMarker Marker_DefaultValue { get; set; }
		 

		/// <summary>
		/// <p>Properties for each single point.</p>
		/// </summary>
		public HistogramSeriesIkhPoint Point { get; set; }
		private HistogramSeriesIkhPoint Point_DefaultValue { get; set; }
		...
		/// </summary>
		public HistogramSeriesIkhDataLabels DataLabels { get; set; }
		private HistogramSeriesIkhDataLabels DataLabels_DefaultValue { get; set; }
		...
		/// </summary>
		public HistogramSeriesIkhStates States { get; set; }
		private HistogramSeriesIkhStates States_DefaultValue { get; set; }
		...
		/// </summary>
		public HistogramSeriesIkhFindNearestPointBy FindNearestPointBy { get; set; }
		private HistogramSeriesIkhFindNearestPointBy FindNearestPointBy_DefaultValue { get; set; }
		...
		/// </summary>
		public HistogramSeriesIkhCursor Cursor { get; set; }
		private HistogramSeriesIkhCursor Cursor_DefaultValue { get; set; }
		...
		/// </summary>
		public HistogramSeriesIkhDashStyle DashStyle { get; set; }
		private HistogramSeriesIkhDashStyle DashStyle_DefaultValue { get; set; }
		...
		/// </summary>
		public HistogramSeriesIkhStep Step { get; set; }
		private HistogramSeriesIkhStep Step_DefaultValue { get; set; }
		...
		/// </summary>
		public List<HistogramSeriesIkhZone> Zones { get; set; }
		private List<HistogramSeriesIkhZone> Zones_DefaultValue { get; set; }
		...
		/// </summary>
		public HistogramSeriesIkhPointIntervalUnit PointIntervalUnit { get; set; }
		private HistogramSeriesIkhPointIntervalUnit PointIntervalUnit_DefaultValue { get; set; }
		...
		/// </summary>
		public HistogramSeriesIkhStacking Stacking { get; set; }
		private HistogramSeriesIkhStacking Stacking_DefaultValue { get; set; }
		...
		/// </summary>
		public HistogramSeriesIkhCompareBase CompareBase { get; set; }
		private HistogramSeriesIkhCompareBase CompareBase_DefaultValue { get; set; }
		...
		internal override Hashtable ToHashtable()
		{
			...
			if (PointDescriptionFormatter != PointDescriptionFormatter_DefaultValue) { h.Add("pointDescriptionFormatter",PointDescriptionFormatter); Highstock.AddFunction("HistogramSeriesIkhPointDescriptionFormatter.pointDescriptionFormatter", PointDescriptionFormatter); }  
