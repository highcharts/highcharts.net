...
{
	public partial class HistogramSeriesIkhDataGrouping  : BaseObject
	{
		public HistogramSeriesIkhDataGrouping()
		{
			Approximation = Approximation_DefaultValue = HistogramSeriesIkhDataGroupingApproximation.Average;
		...
		/// </summary>
		public HistogramSeriesIkhDataGroupingApproximation Approximation { get; set; }
		private HistogramSeriesIkhDataGroupingApproximation Approximation_DefaultValue { get; set; }
