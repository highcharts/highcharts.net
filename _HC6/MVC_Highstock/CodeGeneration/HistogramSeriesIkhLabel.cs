...
{
	public partial class HistogramSeriesIkhLabel  : BaseObject
	{
		public HistogramSeriesIkhLabel()
		{
			...
			Style = Style_DefaultValue = new HistogramSeriesIkhLabelStyle();
		...
		/// </summary>
		public HistogramSeriesIkhLabelStyle Style { get; set; }
		private HistogramSeriesIkhLabelStyle Style_DefaultValue { get; set; }
