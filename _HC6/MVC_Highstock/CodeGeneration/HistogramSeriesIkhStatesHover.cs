...
{
	public partial class HistogramSeriesIkhStatesHover  : BaseObject
	{
		public HistogramSeriesIkhStatesHover()
		{
			LineWidthPlus = LineWidthPlus_DefaultValue = 1;
			Marker = Marker_DefaultValue = new HistogramSeriesIkhStatesHoverMarker();
			Halo = Halo_DefaultValue = new HistogramSeriesIkhStatesHoverHalo();
		...
		/// </summary>
		public HistogramSeriesIkhStatesHoverMarker Marker { get; set; }
		private HistogramSeriesIkhStatesHoverMarker Marker_DefaultValue { get; set; }
		...
		/// </summary>
		public HistogramSeriesIkhStatesHoverHalo Halo { get; set; }
		private HistogramSeriesIkhStatesHoverHalo Halo_DefaultValue { get; set; }
