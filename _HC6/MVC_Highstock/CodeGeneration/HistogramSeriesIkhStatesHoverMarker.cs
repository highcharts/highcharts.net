...
{
	public partial class HistogramSeriesIkhStatesHoverMarker  : BaseObject
	{
		public HistogramSeriesIkhStatesHoverMarker()
		{
			LineWidth = LineWidth_DefaultValue = 0;
			LineColor = LineColor_DefaultValue = "#ffffff";
			Radius = Radius_DefaultValue = 4;
			States = States_DefaultValue = new HistogramSeriesIkhStatesHoverMarkerStates();
		...
		/// </summary>
		public HistogramSeriesIkhStatesHoverMarkerStates States { get; set; }
		private HistogramSeriesIkhStatesHoverMarkerStates States_DefaultValue { get; set; }
