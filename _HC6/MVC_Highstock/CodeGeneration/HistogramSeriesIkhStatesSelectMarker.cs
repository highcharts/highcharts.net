...
{
	public partial class HistogramSeriesIkhStatesSelectMarker  : BaseObject
	{
		public HistogramSeriesIkhStatesSelectMarker()
		{
			LineWidth = LineWidth_DefaultValue = 0;
			LineColor = LineColor_DefaultValue = "#ffffff";
			Radius = Radius_DefaultValue = 4;
			States = States_DefaultValue = new HistogramSeriesIkhStatesSelectMarkerStates();
		...
		/// </summary>
		public HistogramSeriesIkhStatesSelectMarkerStates States { get; set; }
		private HistogramSeriesIkhStatesSelectMarkerStates States_DefaultValue { get; set; }
