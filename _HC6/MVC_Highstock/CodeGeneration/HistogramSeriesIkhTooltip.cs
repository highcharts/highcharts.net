...
{
	public partial class HistogramSeriesIkhTooltip  : BaseObject
	{
		public HistogramSeriesIkhTooltip()
		{
			ValueDecimals = ValueDecimals_DefaultValue = null;
			DateTimeLabelFormats = DateTimeLabelFormats_DefaultValue = new HistogramSeriesIkhTooltipDateTimeLabelFormats();
		...
		/// </summary>
		public HistogramSeriesIkhTooltipDateTimeLabelFormats DateTimeLabelFormats { get; set; }
		private HistogramSeriesIkhTooltipDateTimeLabelFormats DateTimeLabelFormats_DefaultValue { get; set; }
		...
		internal override Hashtable ToHashtable()
		{
			...
			if (PointFormatter != PointFormatter_DefaultValue) { h.Add("pointFormatter",PointFormatter); Highstock.AddFunction("HistogramSeriesIkhTooltipPointFormatter.pointFormatter", PointFormatter); }  
