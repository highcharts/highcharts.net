...
{
	public partial class IkhSeriesDataDragDropDragHandle  : BaseObject
	{
		public IkhSeriesDataDragDropDragHandle()
		{
		...
		internal override Hashtable ToHashtable()
		{
			...
			if (PathFormatter != PathFormatter_DefaultValue) { h.Add("pathFormatter",PathFormatter); Highstock.AddFunction("IkhSeriesDataDragDropDragHandlePathFormatter.pathFormatter", PathFormatter); }  
