...
namespace Highsoft.Web.Mvc.Stocks
{
	public partial class IkhSeriesDataLabels  : BaseObject
	{
		public IkhSeriesDataLabels()
		{
			...
			Style = Style_DefaultValue = new IkhSeriesDataLabelsStyle();
		...
		/// </summary>
		public IkhSeriesDataLabelsStyle Style { get; set; }
		private IkhSeriesDataLabelsStyle Style_DefaultValue { get; set; }
