...
{
	public partial class IkhSeriesDataMarker  : BaseObject
	{
		public IkhSeriesDataMarker()
		{
			...
			States = States_DefaultValue = new IkhSeriesDataMarkerStates();
		...
		/// </summary>
		public IkhSeriesDataMarkerStates States { get; set; }
		private IkhSeriesDataMarkerStates States_DefaultValue { get; set; }
