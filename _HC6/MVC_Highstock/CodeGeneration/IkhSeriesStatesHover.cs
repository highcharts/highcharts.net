...
{
	public partial class IkhSeriesStatesHover  : BaseObject
	{
		public IkhSeriesStatesHover()
		{
			LineWidthPlus = LineWidthPlus_DefaultValue = 1;
			Marker = Marker_DefaultValue = new IkhSeriesStatesHoverMarker();
			Halo = Halo_DefaultValue = new IkhSeriesStatesHoverHalo();
		...
		/// </summary>
		public IkhSeriesStatesHoverMarker Marker { get; set; }
		private IkhSeriesStatesHoverMarker Marker_DefaultValue { get; set; }
		...
		/// </summary>
		public IkhSeriesStatesHoverHalo Halo { get; set; }
		private IkhSeriesStatesHoverHalo Halo_DefaultValue { get; set; }
