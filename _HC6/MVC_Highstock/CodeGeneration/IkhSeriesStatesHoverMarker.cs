...
{
	public partial class IkhSeriesStatesHoverMarker  : BaseObject
	{
		public IkhSeriesStatesHoverMarker()
		{
			LineWidth = LineWidth_DefaultValue = 0;
			LineColor = LineColor_DefaultValue = "#ffffff";
			Radius = Radius_DefaultValue = 4;
			States = States_DefaultValue = new IkhSeriesStatesHoverMarkerStates();
		...
		/// </summary>
		public IkhSeriesStatesHoverMarkerStates States { get; set; }
		private IkhSeriesStatesHoverMarkerStates States_DefaultValue { get; set; }
