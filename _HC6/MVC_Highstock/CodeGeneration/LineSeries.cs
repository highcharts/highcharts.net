...
namespace Highsoft.Web.Mvc.Stocks
{
	public partial class LineSeries  : Series
	{
		public LineSeries()
		{
			...
			Ikh = Ikh_DefaultValue = new LineSeriesIkh();
		...
		/// </summary>
		public LineSeriesIkh Ikh { get; set; }
		private LineSeriesIkh Ikh_DefaultValue { get; set; }
		...
		internal override Hashtable ToHashtable()
		{
			...
			if (PointDescriptionFormatter != PointDescriptionFormatter_DefaultValue) { h.Add("pointDescriptionFormatter",PointDescriptionFormatter); Highstock.AddFunction("LineSeriesPointDescriptionFormatter.pointDescriptionFormatter", PointDescriptionFormatter); }  
