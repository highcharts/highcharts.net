...
{
	public partial class LineSeriesDataGrouping  : BaseObject
	{
		public LineSeriesDataGrouping()
		{
			Approximation = Approximation_DefaultValue = LineSeriesDataGroupingApproximation.Average;
		...
		/// </summary>
		public LineSeriesDataGroupingApproximation Approximation { get; set; }
		private LineSeriesDataGroupingApproximation Approximation_DefaultValue { get; set; }
		...
		/// </summary>
		public LineSeriesDataGroupingUnits Units { get; set; }
		private LineSeriesDataGroupingUnits Units_DefaultValue { get; set; }
