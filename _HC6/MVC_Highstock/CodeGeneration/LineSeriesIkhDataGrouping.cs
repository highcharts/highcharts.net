...
{
	public partial class LineSeriesIkhDataGrouping  : BaseObject
	{
		public LineSeriesIkhDataGrouping()
		{
			Approximation = Approximation_DefaultValue = LineSeriesIkhDataGroupingApproximation.Average;
		...
		/// </summary>
		public LineSeriesIkhDataGroupingApproximation Approximation { get; set; }
		private LineSeriesIkhDataGroupingApproximation Approximation_DefaultValue { get; set; }
