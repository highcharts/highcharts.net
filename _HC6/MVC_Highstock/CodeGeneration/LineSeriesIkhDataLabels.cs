...
{
	public partial class LineSeriesIkhDataLabels  : BaseObject
	{
		public LineSeriesIkhDataLabels()
		{
			Align = Align_DefaultValue = LineSeriesIkhDataLabelsAlign.Center;
			Formatter = Formatter_DefaultValue = "";
			Style = Style_DefaultValue = new LineSeriesIkhDataLabelsStyle();
			VerticalAlign = VerticalAlign_DefaultValue = LineSeriesIkhDataLabelsVerticalAlign.Bottom;
			X = X_DefaultValue = 0;
			Y = Y_DefaultValue = -6;
			...
			Overflow = Overflow_DefaultValue = LineSeriesIkhDataLabelsOverflow.Justify;
		...
		/// </summary>
		public LineSeriesIkhDataLabelsAlign Align { get; set; }
		private LineSeriesIkhDataLabelsAlign Align_DefaultValue { get; set; }
		...
		/// </summary>
		public LineSeriesIkhDataLabelsStyle Style { get; set; }
		private LineSeriesIkhDataLabelsStyle Style_DefaultValue { get; set; }
		...
		/// </summary>
		public LineSeriesIkhDataLabelsVerticalAlign VerticalAlign { get; set; }
		private LineSeriesIkhDataLabelsVerticalAlign VerticalAlign_DefaultValue { get; set; }
		...
		/// </summary>
		public LineSeriesIkhDataLabelsOverflow Overflow { get; set; }
		private LineSeriesIkhDataLabelsOverflow Overflow_DefaultValue { get; set; }
		...
		internal override Hashtable ToHashtable()
		{
			...
			if (Formatter != Formatter_DefaultValue) { h.Add("formatter",Formatter); Highstock.AddFunction("LineSeriesIkhDataLabelsFormatter.formatter", Formatter); }  
