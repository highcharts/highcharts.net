...
{
	public partial class LineSeriesIkhStatesHover  : BaseObject
	{
		public LineSeriesIkhStatesHover()
		{
			LineWidthPlus = LineWidthPlus_DefaultValue = 1;
			Marker = Marker_DefaultValue = new LineSeriesIkhStatesHoverMarker();
			Halo = Halo_DefaultValue = new LineSeriesIkhStatesHoverHalo();
		...
		/// </summary>
		public LineSeriesIkhStatesHoverMarker Marker { get; set; }
		private LineSeriesIkhStatesHoverMarker Marker_DefaultValue { get; set; }
		...
		/// </summary>
		public LineSeriesIkhStatesHoverHalo Halo { get; set; }
		private LineSeriesIkhStatesHoverHalo Halo_DefaultValue { get; set; }
