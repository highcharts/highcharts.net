...
{
	public partial class LineSeriesIkhTooltip  : BaseObject
	{
		public LineSeriesIkhTooltip()
		{
			ValueDecimals = ValueDecimals_DefaultValue = null;
			DateTimeLabelFormats = DateTimeLabelFormats_DefaultValue = new LineSeriesIkhTooltipDateTimeLabelFormats();
		...
		/// </summary>
		public LineSeriesIkhTooltipDateTimeLabelFormats DateTimeLabelFormats { get; set; }
		private LineSeriesIkhTooltipDateTimeLabelFormats DateTimeLabelFormats_DefaultValue { get; set; }
		...
		internal override Hashtable ToHashtable()
		{
			...
			if (PointFormatter != PointFormatter_DefaultValue) { h.Add("pointFormatter",PointFormatter); Highstock.AddFunction("LineSeriesIkhTooltipPointFormatter.pointFormatter", PointFormatter); }  
