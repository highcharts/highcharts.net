...
namespace Highsoft.Web.Mvc.Stocks
{
	public partial class LineSeriesTooltip  : BaseObject
	{
		...
		{
			DateTimeLabelFormats = DateTimeLabelFormats_DefaultValue = new LineSeriesTooltipDateTimeLabelFormats();
		...
		/// </summary>
		public LineSeriesTooltipDateTimeLabelFormats DateTimeLabelFormats { get; set; }
		private LineSeriesTooltipDateTimeLabelFormats DateTimeLabelFormats_DefaultValue { get; set; }
