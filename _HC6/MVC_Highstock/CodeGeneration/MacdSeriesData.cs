...
{
	public partial class MacdSeriesData  : BaseObject
	{
		public MacdSeriesData()
		{
			...
			DragDrop = DragDrop_DefaultValue = new MacdSeriesDataDragDrop();
			Drilldown = Drilldown_DefaultValue = "";
			Events = Events_DefaultValue = new MacdSeriesDataEvents();
			Id = Id_DefaultValue = "";
			Labelrank = Labelrank_DefaultValue = null;
			Marker = Marker_DefaultValue = new MacdSeriesDataMarker();
		...
		/// </summary>
		public MacdSeriesDataDragDrop DragDrop { get; set; }
		private MacdSeriesDataDragDrop DragDrop_DefaultValue { get; set; }
		...
		/// </summary>
		public MacdSeriesDataEvents Events { get; set; }
		private MacdSeriesDataEvents Events_DefaultValue { get; set; }
		...
		/// 
		/// </summary>
		public MacdSeriesDataMarker Marker { get; set; }
		private MacdSeriesDataMarker Marker_DefaultValue { get; set; }
