...
{
	public partial class MacdSeriesDataDragDrop  : BaseObject
	{
		public MacdSeriesDataDragDrop()
		{
			DraggableX = DraggableX_DefaultValue = null;
			DraggableY = DraggableY_DefaultValue = null;
			DragHandle = DragHandle_DefaultValue = new MacdSeriesDataDragDropDragHandle();
			...
			GuideBox = GuideBox_DefaultValue = new MacdSeriesDataDragDropGuideBox();
		...
		/// </summary>
		public MacdSeriesDataDragDropDragHandle DragHandle { get; set; }
		private MacdSeriesDataDragDropDragHandle DragHandle_DefaultValue { get; set; }
		...
		/// </summary>
		public MacdSeriesDataDragDropGuideBox GuideBox { get; set; }
		private MacdSeriesDataDragDropGuideBox GuideBox_DefaultValue { get; set; }
