...
{
	public partial class MacdSeriesDataDragDropDragHandle  : BaseObject
	{
		public MacdSeriesDataDragDropDragHandle()
		{
		...
		internal override Hashtable ToHashtable()
		{
			...
			if (PathFormatter != PathFormatter_DefaultValue) { h.Add("pathFormatter",PathFormatter); Highstock.AddFunction("MacdSeriesDataDragDropDragHandlePathFormatter.pathFormatter", PathFormatter); }  
