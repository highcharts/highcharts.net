...
{
	public partial class MacdSeriesDataMarker  : BaseObject
	{
		public MacdSeriesDataMarker()
		{
			...
			States = States_DefaultValue = new MacdSeriesDataMarkerStates();
		...
		/// </summary>
		public MacdSeriesDataMarkerStates States { get; set; }
		private MacdSeriesDataMarkerStates States_DefaultValue { get; set; }
