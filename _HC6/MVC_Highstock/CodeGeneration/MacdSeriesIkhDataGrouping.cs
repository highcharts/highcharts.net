...
{
	public partial class MacdSeriesIkhDataGrouping  : BaseObject
	{
		...
		/// </summary>
		public MacdSeriesIkhDataGroupingApproximation Approximation { get; set; }
		private MacdSeriesIkhDataGroupingApproximation Approximation_DefaultValue { get; set; }
