...
{
	public partial class MacdSeriesIkhDataLabels  : BaseObject
	{
		public MacdSeriesIkhDataLabels()
		{
			Align = Align_DefaultValue = MacdSeriesIkhDataLabelsAlign.Center;
			Formatter = Formatter_DefaultValue = "";
			Style = Style_DefaultValue = new MacdSeriesIkhDataLabelsStyle();
			VerticalAlign = VerticalAlign_DefaultValue = MacdSeriesIkhDataLabelsVerticalAlign.Bottom;
			X = X_DefaultValue = 0;
			Y = Y_DefaultValue = -6;
			...
			Overflow = Overflow_DefaultValue = MacdSeriesIkhDataLabelsOverflow.Justify;
		...
		/// </summary>
		public MacdSeriesIkhDataLabelsAlign Align { get; set; }
		private MacdSeriesIkhDataLabelsAlign Align_DefaultValue { get; set; }
		...
		/// </summary>
		public MacdSeriesIkhDataLabelsStyle Style { get; set; }
		private MacdSeriesIkhDataLabelsStyle Style_DefaultValue { get; set; }
		...
		/// </summary>
		public MacdSeriesIkhDataLabelsVerticalAlign VerticalAlign { get; set; }
		private MacdSeriesIkhDataLabelsVerticalAlign VerticalAlign_DefaultValue { get; set; }
		...
		/// </summary>
		public MacdSeriesIkhDataLabelsOverflow Overflow { get; set; }
		private MacdSeriesIkhDataLabelsOverflow Overflow_DefaultValue { get; set; }
		...
		internal override Hashtable ToHashtable()
		{
			...
			if (Formatter != Formatter_DefaultValue) { h.Add("formatter",Formatter); Highstock.AddFunction("MacdSeriesIkhDataLabelsFormatter.formatter", Formatter); }  
