...
{
	public partial class MacdSeriesIkhMarker  : BaseObject
	{
		public MacdSeriesIkhMarker()
		{
			LineWidth = LineWidth_DefaultValue = 0;
			LineColor = LineColor_DefaultValue = "#ffffff";
			Radius = Radius_DefaultValue = 4;
			States = States_DefaultValue = new MacdSeriesIkhMarkerStates();
		...
		/// </summary>
		public MacdSeriesIkhMarkerStates States { get; set; }
		private MacdSeriesIkhMarkerStates States_DefaultValue { get; set; }
