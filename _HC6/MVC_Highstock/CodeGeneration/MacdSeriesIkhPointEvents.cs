...
{
	public partial class MacdSeriesIkhPointEvents  : BaseObject
	{
		public MacdSeriesIkhPointEvents()
		{
		...
		internal override Hashtable ToHashtable()
		{
			...
			if (Click != Click_DefaultValue) { h.Add("click",Click); Highstock.AddFunction("MacdSeriesIkhPointEventsClick.click", Click); }  
			if (MouseOut != MouseOut_DefaultValue) { h.Add("mouseOut",MouseOut); Highstock.AddFunction("MacdSeriesIkhPointEventsMouseOut.mouseOut", MouseOut); }  
			if (MouseOver != MouseOver_DefaultValue) { h.Add("mouseOver",MouseOver); Highstock.AddFunction("MacdSeriesIkhPointEventsMouseOver.mouseOver", MouseOver); }  
			if (Remove != Remove_DefaultValue) { h.Add("remove",Remove); Highstock.AddFunction("MacdSeriesIkhPointEventsRemove.remove", Remove); }  
			if (Select != Select_DefaultValue) { h.Add("select",Select); Highstock.AddFunction("MacdSeriesIkhPointEventsSelect.select", Select); }  
			if (Unselect != Unselect_DefaultValue) { h.Add("unselect",Unselect); Highstock.AddFunction("MacdSeriesIkhPointEventsUnselect.unselect", Unselect); }  
			if (Update != Update_DefaultValue) { h.Add("update",Update); Highstock.AddFunction("MacdSeriesIkhPointEventsUpdate.update", Update); }  
