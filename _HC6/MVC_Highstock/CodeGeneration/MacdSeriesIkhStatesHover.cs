...
{
	public partial class MacdSeriesIkhStatesHover  : BaseObject
	{
		public MacdSeriesIkhStatesHover()
		{
			LineWidthPlus = LineWidthPlus_DefaultValue = 1;
			Marker = Marker_DefaultValue = new MacdSeriesIkhStatesHoverMarker();
			Halo = Halo_DefaultValue = new MacdSeriesIkhStatesHoverHalo();
		...
		/// </summary>
		public MacdSeriesIkhStatesHoverMarker Marker { get; set; }
		private MacdSeriesIkhStatesHoverMarker Marker_DefaultValue { get; set; }
		...
		/// </summary>
		public MacdSeriesIkhStatesHoverHalo Halo { get; set; }
		private MacdSeriesIkhStatesHoverHalo Halo_DefaultValue { get; set; }
