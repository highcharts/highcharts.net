...
{
	public partial class MacdSeriesIkhStatesHoverMarker  : BaseObject
	{
		public MacdSeriesIkhStatesHoverMarker()
		{
			LineWidth = LineWidth_DefaultValue = 0;
			LineColor = LineColor_DefaultValue = "#ffffff";
			Radius = Radius_DefaultValue = 4;
			States = States_DefaultValue = new MacdSeriesIkhStatesHoverMarkerStates();
		...
		/// </summary>
		public MacdSeriesIkhStatesHoverMarkerStates States { get; set; }
		private MacdSeriesIkhStatesHoverMarkerStates States_DefaultValue { get; set; }
