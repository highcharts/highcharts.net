...
{
	public partial class MacdSeriesIkhTooltip  : BaseObject
	{
		public MacdSeriesIkhTooltip()
		{
			ValueDecimals = ValueDecimals_DefaultValue = null;
			DateTimeLabelFormats = DateTimeLabelFormats_DefaultValue = new MacdSeriesIkhTooltipDateTimeLabelFormats();
		...
		/// </summary>
		public MacdSeriesIkhTooltipDateTimeLabelFormats DateTimeLabelFormats { get; set; }
		private MacdSeriesIkhTooltipDateTimeLabelFormats DateTimeLabelFormats_DefaultValue { get; set; }
		...
		internal override Hashtable ToHashtable()
		{
			...
			if (PointFormatter != PointFormatter_DefaultValue) { h.Add("pointFormatter",PointFormatter); Highstock.AddFunction("MacdSeriesIkhTooltipPointFormatter.pointFormatter", PointFormatter); }  
