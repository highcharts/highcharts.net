...
{
	public partial class MacdSeriesLabel  : BaseObject
	{
		public MacdSeriesLabel()
		{
			...
			Style = Style_DefaultValue = new MacdSeriesLabelStyle();
		...
		/// </summary>
		public MacdSeriesLabelStyle Style { get; set; }
		private MacdSeriesLabelStyle Style_DefaultValue { get; set; }
