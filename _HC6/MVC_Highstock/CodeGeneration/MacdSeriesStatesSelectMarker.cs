...
{
	public partial class MacdSeriesStatesSelectMarker  : BaseObject
	{
		public MacdSeriesStatesSelectMarker()
		{
			LineWidth = LineWidth_DefaultValue = 0;
			LineColor = LineColor_DefaultValue = "#ffffff";
			Radius = Radius_DefaultValue = 4;
			States = States_DefaultValue = new MacdSeriesStatesSelectMarkerStates();
		...
		/// </summary>
		public MacdSeriesStatesSelectMarkerStates States { get; set; }
		private MacdSeriesStatesSelectMarkerStates States_DefaultValue { get; set; }
