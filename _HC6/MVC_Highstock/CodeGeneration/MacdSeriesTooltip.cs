...
namespace Highsoft.Web.Mvc.Stocks
{
	public partial class MacdSeriesTooltip  : BaseObject
	{
		public MacdSeriesTooltip()
		{
			...
			DateTimeLabelFormats = DateTimeLabelFormats_DefaultValue = new MacdSeriesTooltipDateTimeLabelFormats();
		...
		/// </summary>
		public MacdSeriesTooltipDateTimeLabelFormats DateTimeLabelFormats { get; set; }
		private MacdSeriesTooltipDateTimeLabelFormats DateTimeLabelFormats_DefaultValue { get; set; }
