...
{
	public partial class MapSeriesDataGrouping  : BaseObject
	{
		public MapSeriesDataGrouping()
		{
			Approximation = Approximation_DefaultValue = MapSeriesDataGroupingApproximation.Average;
		...
		/// </summary>
		public MapSeriesDataGroupingApproximation Approximation { get; set; }
		private MapSeriesDataGroupingApproximation Approximation_DefaultValue { get; set; }
