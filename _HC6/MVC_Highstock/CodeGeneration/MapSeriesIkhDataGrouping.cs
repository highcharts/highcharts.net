...
{
	public partial class MapSeriesIkhDataGrouping  : BaseObject
	{
		public MapSeriesIkhDataGrouping()
		{
			Approximation = Approximation_DefaultValue = MapSeriesIkhDataGroupingApproximation.Average;
		...
		/// </summary>
		public MapSeriesIkhDataGroupingApproximation Approximation { get; set; }
		private MapSeriesIkhDataGroupingApproximation Approximation_DefaultValue { get; set; }
