...
{
	public partial class MapSeriesIkhDataLabels  : BaseObject
	{
		public MapSeriesIkhDataLabels()
		{
			Align = Align_DefaultValue = MapSeriesIkhDataLabelsAlign.Center;
			Formatter = Formatter_DefaultValue = "";
			Style = Style_DefaultValue = new MapSeriesIkhDataLabelsStyle();
			VerticalAlign = VerticalAlign_DefaultValue = MapSeriesIkhDataLabelsVerticalAlign.Bottom;
			X = X_DefaultValue = 0;
			Y = Y_DefaultValue = -6;
			...
			Overflow = Overflow_DefaultValue = MapSeriesIkhDataLabelsOverflow.Justify;
		...
		/// </summary>
		public MapSeriesIkhDataLabelsAlign Align { get; set; }
		private MapSeriesIkhDataLabelsAlign Align_DefaultValue { get; set; }
		...
		/// </summary>
		public MapSeriesIkhDataLabelsStyle Style { get; set; }
		private MapSeriesIkhDataLabelsStyle Style_DefaultValue { get; set; }
		...
		/// </summary>
		public MapSeriesIkhDataLabelsVerticalAlign VerticalAlign { get; set; }
		private MapSeriesIkhDataLabelsVerticalAlign VerticalAlign_DefaultValue { get; set; }
		...
		/// </summary>
		public MapSeriesIkhDataLabelsOverflow Overflow { get; set; }
		private MapSeriesIkhDataLabelsOverflow Overflow_DefaultValue { get; set; }
		...
		internal override Hashtable ToHashtable()
		{
			...
			if (Formatter != Formatter_DefaultValue) { h.Add("formatter",Formatter); Highstock.AddFunction("MapSeriesIkhDataLabelsFormatter.formatter", Formatter); }  
