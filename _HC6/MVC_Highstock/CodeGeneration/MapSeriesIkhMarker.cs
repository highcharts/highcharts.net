...
{
	public partial class MapSeriesIkhMarker  : BaseObject
	{
		public MapSeriesIkhMarker()
		{
			LineWidth = LineWidth_DefaultValue = 0;
			LineColor = LineColor_DefaultValue = "#ffffff";
			Radius = Radius_DefaultValue = 4;
			States = States_DefaultValue = new MapSeriesIkhMarkerStates();
		...
		/// </summary>
		public MapSeriesIkhMarkerStates States { get; set; }
		private MapSeriesIkhMarkerStates States_DefaultValue { get; set; }
