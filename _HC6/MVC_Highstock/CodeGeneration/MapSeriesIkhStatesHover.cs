...
{
	public partial class MapSeriesIkhStatesHover  : BaseObject
	{
		public MapSeriesIkhStatesHover()
		{
			LineWidthPlus = LineWidthPlus_DefaultValue = 1;
			Marker = Marker_DefaultValue = new MapSeriesIkhStatesHoverMarker();
			Halo = Halo_DefaultValue = new MapSeriesIkhStatesHoverHalo();
		...
		/// </summary>
		public MapSeriesIkhStatesHoverMarker Marker { get; set; }
		private MapSeriesIkhStatesHoverMarker Marker_DefaultValue { get; set; }
		...
		/// </summary>
		public MapSeriesIkhStatesHoverHalo Halo { get; set; }
		private MapSeriesIkhStatesHoverHalo Halo_DefaultValue { get; set; }
