...
{
	public partial class MapSeriesIkhStatesHoverMarker  : BaseObject
	{
		public MapSeriesIkhStatesHoverMarker()
		{
			LineWidth = LineWidth_DefaultValue = 0;
			LineColor = LineColor_DefaultValue = "#ffffff";
			Radius = Radius_DefaultValue = 4;
			States = States_DefaultValue = new MapSeriesIkhStatesHoverMarkerStates();
		...
		/// </summary>
		public MapSeriesIkhStatesHoverMarkerStates States { get; set; }
		private MapSeriesIkhStatesHoverMarkerStates States_DefaultValue { get; set; }
