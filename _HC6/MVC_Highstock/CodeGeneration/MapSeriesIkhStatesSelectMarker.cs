...
{
	public partial class MapSeriesIkhStatesSelectMarker  : BaseObject
	{
		public MapSeriesIkhStatesSelectMarker()
		{
			LineWidth = LineWidth_DefaultValue = 0;
			LineColor = LineColor_DefaultValue = "#ffffff";
			Radius = Radius_DefaultValue = 4;
			States = States_DefaultValue = new MapSeriesIkhStatesSelectMarkerStates();
		...
		/// </summary>
		public MapSeriesIkhStatesSelectMarkerStates States { get; set; }
		private MapSeriesIkhStatesSelectMarkerStates States_DefaultValue { get; set; }
