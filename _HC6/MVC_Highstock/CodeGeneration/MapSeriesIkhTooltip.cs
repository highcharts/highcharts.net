...
{
	public partial class MapSeriesIkhTooltip  : BaseObject
	{
		public MapSeriesIkhTooltip()
		{
			ValueDecimals = ValueDecimals_DefaultValue = null;
			DateTimeLabelFormats = DateTimeLabelFormats_DefaultValue = new MapSeriesIkhTooltipDateTimeLabelFormats();
		...
		/// </summary>
		public MapSeriesIkhTooltipDateTimeLabelFormats DateTimeLabelFormats { get; set; }
		private MapSeriesIkhTooltipDateTimeLabelFormats DateTimeLabelFormats_DefaultValue { get; set; }
		...
		internal override Hashtable ToHashtable()
		{
			...
			if (PointFormatter != PointFormatter_DefaultValue) { h.Add("pointFormatter",PointFormatter); Highstock.AddFunction("MapSeriesIkhTooltipPointFormatter.pointFormatter", PointFormatter); }  
