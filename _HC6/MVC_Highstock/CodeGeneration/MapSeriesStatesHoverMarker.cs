...
{
	public partial class MapSeriesStatesHoverMarker  : BaseObject
	{
		public MapSeriesStatesHoverMarker()
		{
			LineWidth = LineWidth_DefaultValue = 0;
			LineColor = LineColor_DefaultValue = "#ffffff";
			Radius = Radius_DefaultValue = 4;
			States = States_DefaultValue = new MapSeriesStatesHoverMarkerStates();
		...
		/// </summary>
		public MapSeriesStatesHoverMarkerStates States { get; set; }
		private MapSeriesStatesHoverMarkerStates States_DefaultValue { get; set; }
