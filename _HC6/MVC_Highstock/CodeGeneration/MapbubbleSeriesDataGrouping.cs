...
{
	public partial class MapbubbleSeriesDataGrouping  : BaseObject
	{
		...
		/// </summary>
		public MapbubbleSeriesDataGroupingApproximation Approximation { get; set; }
		private MapbubbleSeriesDataGroupingApproximation Approximation_DefaultValue { get; set; }
