...
{
	public partial class MapbubbleSeriesIkh  : BaseObject
	{
		public MapbubbleSeriesIkh()
		{
			Name = Name_DefaultValue = "SMA (14)";
			Tooltip = Tooltip_DefaultValue = new MapbubbleSeriesIkhTooltip();
			LinkedTo = LinkedTo_DefaultValue = null;
			Params = Params_DefaultValue = new MapbubbleSeriesIkhParams();
			Linecap = Linecap_DefaultValue = MapbubbleSeriesIkhLinecap.Round;
			BoostThreshold = BoostThreshold_DefaultValue = 5000;
			GapSize = GapSize_DefaultValue = 0;
			GapUnit = GapUnit_DefaultValue = MapbubbleSeriesIkhGapUnit.Relative;
			Label = Label_DefaultValue = new MapbubbleSeriesIkhLabel();
			DataGrouping = DataGrouping_DefaultValue = new MapbubbleSeriesIkhDataGrouping();
			LineWidth = LineWidth_DefaultValue = 2;
			AllowPointSelect = AllowPointSelect_DefaultValue = false;
			ShowCheckbox = ShowCheckbox_DefaultValue = false;
			Animation = Animation_DefaultValue = new Animation() { Enabled = true };
			Events = Events_DefaultValue = new MapbubbleSeriesIkhEvents();
			Marker = Marker_DefaultValue = new MapbubbleSeriesIkhMarker();
			Point = Point_DefaultValue = new MapbubbleSeriesIkhPoint();
			DataLabels = DataLabels_DefaultValue = new MapbubbleSeriesIkhDataLabels();
			CropThreshold = CropThreshold_DefaultValue = 300;
			SoftThreshold = SoftThreshold_DefaultValue = true;
			States = States_DefaultValue = new MapbubbleSeriesIkhStates();
			StickyTracking = StickyTracking_DefaultValue = null;
			TurboThreshold = TurboThreshold_DefaultValue = 1000;
			FindNearestPointBy = FindNearestPointBy_DefaultValue = MapbubbleSeriesIkhFindNearestPointBy.X;
			AnimationLimit = AnimationLimit_DefaultValue = null;
			ClassName = ClassName_DefaultValue = null;
			Color = Color_DefaultValue = null;
			ColorIndex = ColorIndex_DefaultValue = null;
			ConnectNulls = ConnectNulls_DefaultValue = false;
			Cursor = Cursor_DefaultValue = MapbubbleSeriesIkhCursor.Null;
			DashStyle = DashStyle_DefaultValue = MapbubbleSeriesIkhDashStyle.Solid;
			...
			Step = Step_DefaultValue = MapbubbleSeriesIkhStep.Null;
			Threshold = Threshold_DefaultValue = 0;
			Visible = Visible_DefaultValue = true;
			ZoneAxis = ZoneAxis_DefaultValue = "y";
			Zones = Zones_DefaultValue = new List<MapbubbleSeriesIkhZone>();
			...
			PointIntervalUnit = PointIntervalUnit_DefaultValue = MapbubbleSeriesIkhPointIntervalUnit.Null;
			PointPlacement = PointPlacement_DefaultValue = new PointPlacement();
			PointStart = PointStart_DefaultValue = 0;
			Stacking = Stacking_DefaultValue = MapbubbleSeriesIkhStacking.Null;
			Compare = Compare_DefaultValue = "undefined";
			CompareBase = CompareBase_DefaultValue = MapbubbleSeriesIkhCompareBase.Min;
		...
		/// </summary>
		public MapbubbleSeriesIkhTooltip Tooltip { get; set; }
		private MapbubbleSeriesIkhTooltip Tooltip_DefaultValue { get; set; }
		...
		/// 
		/// </summary>
		public MapbubbleSeriesIkhParams Params { get; set; }
		private MapbubbleSeriesIkhParams Params_DefaultValue { get; set; }
		...
		/// </summary>
		public MapbubbleSeriesIkhLinecap Linecap { get; set; }
		private MapbubbleSeriesIkhLinecap Linecap_DefaultValue { get; set; }
		...
		/// </summary>
		public MapbubbleSeriesIkhGapUnit GapUnit { get; set; }
		private MapbubbleSeriesIkhGapUnit GapUnit_DefaultValue { get; set; }
		...
		/// </summary>
		public MapbubbleSeriesIkhLabel Label { get; set; }
		private MapbubbleSeriesIkhLabel Label_DefaultValue { get; set; }
		...
		/// </summary>
		public MapbubbleSeriesIkhDataGrouping DataGrouping { get; set; }
		private MapbubbleSeriesIkhDataGrouping DataGrouping_DefaultValue { get; set; }
		...
		/// </summary>
		public MapbubbleSeriesIkhEvents Events { get; set; }
		private MapbubbleSeriesIkhEvents Events_DefaultValue { get; set; }
		...
		/// </summary>
		public MapbubbleSeriesIkhMarker Marker { get; set; }
		private MapbubbleSeriesIkhMarker Marker_DefaultValue { get; set; }
		 

		/// <summary>
		/// <p>Properties for each single point.</p>
		/// </summary>
		public MapbubbleSeriesIkhPoint Point { get; set; }
		private MapbubbleSeriesIkhPoint Point_DefaultValue { get; set; }
		...
		/// </summary>
		public MapbubbleSeriesIkhDataLabels DataLabels { get; set; }
		private MapbubbleSeriesIkhDataLabels DataLabels_DefaultValue { get; set; }
		...
		/// </summary>
		public MapbubbleSeriesIkhStates States { get; set; }
		private MapbubbleSeriesIkhStates States_DefaultValue { get; set; }
		...
		/// </summary>
		public MapbubbleSeriesIkhFindNearestPointBy FindNearestPointBy { get; set; }
		private MapbubbleSeriesIkhFindNearestPointBy FindNearestPointBy_DefaultValue { get; set; }
		...
		/// </summary>
		public MapbubbleSeriesIkhCursor Cursor { get; set; }
		private MapbubbleSeriesIkhCursor Cursor_DefaultValue { get; set; }
		...
		/// </summary>
		public MapbubbleSeriesIkhDashStyle DashStyle { get; set; }
		private MapbubbleSeriesIkhDashStyle DashStyle_DefaultValue { get; set; }
		...
		/// </summary>
		public MapbubbleSeriesIkhStep Step { get; set; }
		private MapbubbleSeriesIkhStep Step_DefaultValue { get; set; }
		...
		/// </summary>
		public List<MapbubbleSeriesIkhZone> Zones { get; set; }
		private List<MapbubbleSeriesIkhZone> Zones_DefaultValue { get; set; }
		...
		/// </summary>
		public MapbubbleSeriesIkhPointIntervalUnit PointIntervalUnit { get; set; }
		private MapbubbleSeriesIkhPointIntervalUnit PointIntervalUnit_DefaultValue { get; set; }
		...
		/// </summary>
		public MapbubbleSeriesIkhStacking Stacking { get; set; }
		private MapbubbleSeriesIkhStacking Stacking_DefaultValue { get; set; }
		...
		/// </summary>
		public MapbubbleSeriesIkhCompareBase CompareBase { get; set; }
		private MapbubbleSeriesIkhCompareBase CompareBase_DefaultValue { get; set; }
		...
		internal override Hashtable ToHashtable()
		{
			...
			if (PointDescriptionFormatter != PointDescriptionFormatter_DefaultValue) { h.Add("pointDescriptionFormatter",PointDescriptionFormatter); Highstock.AddFunction("MapbubbleSeriesIkhPointDescriptionFormatter.pointDescriptionFormatter", PointDescriptionFormatter); }  
