...
namespace Highsoft.Web.Mvc.Stocks
{
	public partial class MapbubbleSeriesIkh  : BaseObject
	{
		public MapbubbleSeriesIkh()
		{
			...
			Zones = Zones_DefaultValue = new MapbubbleSeriesIkhZone();
		...
		/// </summary>
		public MapbubbleSeriesIkhZone Zones { get; set; }
		private MapbubbleSeriesIkhZone Zones_DefaultValue { get; set; }
