...
{
	public partial class MapbubbleSeriesIkhDataGrouping  : BaseObject
	{
		public MapbubbleSeriesIkhDataGrouping()
		{
			Approximation = Approximation_DefaultValue = MapbubbleSeriesIkhDataGroupingApproximation.Average;
		...
		/// </summary>
		public MapbubbleSeriesIkhDataGroupingApproximation Approximation { get; set; }
		private MapbubbleSeriesIkhDataGroupingApproximation Approximation_DefaultValue { get; set; }
