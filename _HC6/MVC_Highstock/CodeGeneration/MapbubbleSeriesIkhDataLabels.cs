...
{
	public partial class MapbubbleSeriesIkhDataLabels  : BaseObject
	{
		public MapbubbleSeriesIkhDataLabels()
		{
			Align = Align_DefaultValue = MapbubbleSeriesIkhDataLabelsAlign.Center;
			Formatter = Formatter_DefaultValue = "";
			Style = Style_DefaultValue = new MapbubbleSeriesIkhDataLabelsStyle();
			VerticalAlign = VerticalAlign_DefaultValue = MapbubbleSeriesIkhDataLabelsVerticalAlign.Bottom;
			X = X_DefaultValue = 0;
			Y = Y_DefaultValue = -6;
			...
			Overflow = Overflow_DefaultValue = MapbubbleSeriesIkhDataLabelsOverflow.Justify;
		...
		/// </summary>
		public MapbubbleSeriesIkhDataLabelsAlign Align { get; set; }
		private MapbubbleSeriesIkhDataLabelsAlign Align_DefaultValue { get; set; }
		...
		/// </summary>
		public MapbubbleSeriesIkhDataLabelsStyle Style { get; set; }
		private MapbubbleSeriesIkhDataLabelsStyle Style_DefaultValue { get; set; }
		...
		/// </summary>
		public MapbubbleSeriesIkhDataLabelsVerticalAlign VerticalAlign { get; set; }
		private MapbubbleSeriesIkhDataLabelsVerticalAlign VerticalAlign_DefaultValue { get; set; }
		...
		/// </summary>
		public MapbubbleSeriesIkhDataLabelsOverflow Overflow { get; set; }
		private MapbubbleSeriesIkhDataLabelsOverflow Overflow_DefaultValue { get; set; }
		...
		internal override Hashtable ToHashtable()
		{
			...
			if (Formatter != Formatter_DefaultValue) { h.Add("formatter",Formatter); Highstock.AddFunction("MapbubbleSeriesIkhDataLabelsFormatter.formatter", Formatter); }  
