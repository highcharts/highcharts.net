...
{
	public partial class MapbubbleSeriesIkhLabel  : BaseObject
	{
		public MapbubbleSeriesIkhLabel()
		{
			...
			Style = Style_DefaultValue = new MapbubbleSeriesIkhLabelStyle();
		...
		/// </summary>
		public MapbubbleSeriesIkhLabelStyle Style { get; set; }
		private MapbubbleSeriesIkhLabelStyle Style_DefaultValue { get; set; }
