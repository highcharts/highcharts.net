...
{
	public partial class MapbubbleSeriesIkhStatesHover  : BaseObject
	{
		public MapbubbleSeriesIkhStatesHover()
		{
			LineWidthPlus = LineWidthPlus_DefaultValue = 1;
			Marker = Marker_DefaultValue = new MapbubbleSeriesIkhStatesHoverMarker();
			Halo = Halo_DefaultValue = new MapbubbleSeriesIkhStatesHoverHalo();
		...
		/// </summary>
		public MapbubbleSeriesIkhStatesHoverMarker Marker { get; set; }
		private MapbubbleSeriesIkhStatesHoverMarker Marker_DefaultValue { get; set; }
		...
		/// </summary>
		public MapbubbleSeriesIkhStatesHoverHalo Halo { get; set; }
		private MapbubbleSeriesIkhStatesHoverHalo Halo_DefaultValue { get; set; }
