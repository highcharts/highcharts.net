...
{
	public partial class MapbubbleSeriesIkhStatesHoverMarker  : BaseObject
	{
		public MapbubbleSeriesIkhStatesHoverMarker()
		{
			LineWidth = LineWidth_DefaultValue = 0;
			LineColor = LineColor_DefaultValue = "#ffffff";
			Radius = Radius_DefaultValue = 4;
			States = States_DefaultValue = new MapbubbleSeriesIkhStatesHoverMarkerStates();
		...
		/// </summary>
		public MapbubbleSeriesIkhStatesHoverMarkerStates States { get; set; }
		private MapbubbleSeriesIkhStatesHoverMarkerStates States_DefaultValue { get; set; }
