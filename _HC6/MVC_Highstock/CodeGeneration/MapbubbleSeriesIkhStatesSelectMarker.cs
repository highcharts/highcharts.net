...
{
	public partial class MapbubbleSeriesIkhStatesSelectMarker  : BaseObject
	{
		public MapbubbleSeriesIkhStatesSelectMarker()
		{
			LineWidth = LineWidth_DefaultValue = 0;
			LineColor = LineColor_DefaultValue = "#ffffff";
			Radius = Radius_DefaultValue = 4;
			States = States_DefaultValue = new MapbubbleSeriesIkhStatesSelectMarkerStates();
		...
		/// </summary>
		public MapbubbleSeriesIkhStatesSelectMarkerStates States { get; set; }
		private MapbubbleSeriesIkhStatesSelectMarkerStates States_DefaultValue { get; set; }
