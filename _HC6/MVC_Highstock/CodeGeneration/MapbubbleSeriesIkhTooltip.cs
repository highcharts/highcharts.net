...
{
	public partial class MapbubbleSeriesIkhTooltip  : BaseObject
	{
		public MapbubbleSeriesIkhTooltip()
		{
			ValueDecimals = ValueDecimals_DefaultValue = null;
			DateTimeLabelFormats = DateTimeLabelFormats_DefaultValue = new MapbubbleSeriesIkhTooltipDateTimeLabelFormats();
		...
		/// </summary>
		public MapbubbleSeriesIkhTooltipDateTimeLabelFormats DateTimeLabelFormats { get; set; }
		private MapbubbleSeriesIkhTooltipDateTimeLabelFormats DateTimeLabelFormats_DefaultValue { get; set; }
		...
		internal override Hashtable ToHashtable()
		{
			...
			if (PointFormatter != PointFormatter_DefaultValue) { h.Add("pointFormatter",PointFormatter); Highstock.AddFunction("MapbubbleSeriesIkhTooltipPointFormatter.pointFormatter", PointFormatter); }  
