...
{
	public partial class MapbubbleSeriesStatesHoverMarker  : BaseObject
	{
		public MapbubbleSeriesStatesHoverMarker()
		{
			LineWidth = LineWidth_DefaultValue = 0;
			LineColor = LineColor_DefaultValue = "#ffffff";
			Radius = Radius_DefaultValue = 4;
			States = States_DefaultValue = new MapbubbleSeriesStatesHoverMarkerStates();
		...
		/// </summary>
		public MapbubbleSeriesStatesHoverMarkerStates States { get; set; }
		private MapbubbleSeriesStatesHoverMarkerStates States_DefaultValue { get; set; }
