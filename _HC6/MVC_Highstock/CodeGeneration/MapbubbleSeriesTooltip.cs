...
{
	public partial class MapbubbleSeriesTooltip  : BaseObject
	{
		public MapbubbleSeriesTooltip()
		{
			PointFormat = PointFormat_DefaultValue = "{point.name}: {point.z}";
			...
			DateTimeLabelFormats = DateTimeLabelFormats_DefaultValue = new MapbubbleSeriesTooltipDateTimeLabelFormats();
		...
		/// </summary>
		public MapbubbleSeriesTooltipDateTimeLabelFormats DateTimeLabelFormats { get; set; }
		private MapbubbleSeriesTooltipDateTimeLabelFormats DateTimeLabelFormats_DefaultValue { get; set; }
		...
		internal override Hashtable ToHashtable()
		{
			...
			if (PointFormatter != PointFormatter_DefaultValue) { h.Add("pointFormatter",PointFormatter); Highstock.AddFunction("MapbubbleSeriesTooltipPointFormatter.pointFormatter", PointFormatter); }  
