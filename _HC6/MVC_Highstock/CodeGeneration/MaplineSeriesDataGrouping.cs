...
{
	public partial class MaplineSeriesDataGrouping  : BaseObject
	{
		public MaplineSeriesDataGrouping()
		{
			Approximation = Approximation_DefaultValue = MaplineSeriesDataGroupingApproximation.Average;
		...
		/// </summary>
		public MaplineSeriesDataGroupingApproximation Approximation { get; set; }
		private MaplineSeriesDataGroupingApproximation Approximation_DefaultValue { get; set; }
