...
{
	public partial class MaplineSeriesIkh  : BaseObject
	{
		public MaplineSeriesIkh()
		{
			Name = Name_DefaultValue = "SMA (14)";
			Tooltip = Tooltip_DefaultValue = new MaplineSeriesIkhTooltip();
			LinkedTo = LinkedTo_DefaultValue = null;
			Params = Params_DefaultValue = new MaplineSeriesIkhParams();
			Linecap = Linecap_DefaultValue = MaplineSeriesIkhLinecap.Round;
			BoostThreshold = BoostThreshold_DefaultValue = 5000;
			GapSize = GapSize_DefaultValue = 0;
			GapUnit = GapUnit_DefaultValue = MaplineSeriesIkhGapUnit.Relative;
			Label = Label_DefaultValue = new MaplineSeriesIkhLabel();
			DataGrouping = DataGrouping_DefaultValue = new MaplineSeriesIkhDataGrouping();
			LineWidth = LineWidth_DefaultValue = 2;
			AllowPointSelect = AllowPointSelect_DefaultValue = false;
			ShowCheckbox = ShowCheckbox_DefaultValue = false;
			Animation = Animation_DefaultValue = new Animation() { Enabled = true };
			Events = Events_DefaultValue = new MaplineSeriesIkhEvents();
			Marker = Marker_DefaultValue = new MaplineSeriesIkhMarker();
			Point = Point_DefaultValue = new MaplineSeriesIkhPoint();
			DataLabels = DataLabels_DefaultValue = new MaplineSeriesIkhDataLabels();
			CropThreshold = CropThreshold_DefaultValue = 300;
			SoftThreshold = SoftThreshold_DefaultValue = true;
			States = States_DefaultValue = new MaplineSeriesIkhStates();
			StickyTracking = StickyTracking_DefaultValue = null;
			TurboThreshold = TurboThreshold_DefaultValue = 1000;
			FindNearestPointBy = FindNearestPointBy_DefaultValue = MaplineSeriesIkhFindNearestPointBy.X;
			AnimationLimit = AnimationLimit_DefaultValue = null;
			ClassName = ClassName_DefaultValue = null;
			Color = Color_DefaultValue = null;
			ColorIndex = ColorIndex_DefaultValue = null;
			ConnectNulls = ConnectNulls_DefaultValue = false;
			Cursor = Cursor_DefaultValue = MaplineSeriesIkhCursor.Null;
			DashStyle = DashStyle_DefaultValue = MaplineSeriesIkhDashStyle.Solid;
			...
			Step = Step_DefaultValue = MaplineSeriesIkhStep.Null;
			Threshold = Threshold_DefaultValue = 0;
			Visible = Visible_DefaultValue = true;
			ZoneAxis = ZoneAxis_DefaultValue = "y";
			Zones = Zones_DefaultValue = new List<MaplineSeriesIkhZone>();
			...
			PointIntervalUnit = PointIntervalUnit_DefaultValue = MaplineSeriesIkhPointIntervalUnit.Null;
			PointPlacement = PointPlacement_DefaultValue = new PointPlacement();
			PointStart = PointStart_DefaultValue = 0;
			Stacking = Stacking_DefaultValue = MaplineSeriesIkhStacking.Null;
			Compare = Compare_DefaultValue = "undefined";
			CompareBase = CompareBase_DefaultValue = MaplineSeriesIkhCompareBase.Min;
		...
		/// </summary>
		public MaplineSeriesIkhTooltip Tooltip { get; set; }
		private MaplineSeriesIkhTooltip Tooltip_DefaultValue { get; set; }
		...
		/// 
		/// </summary>
		public MaplineSeriesIkhParams Params { get; set; }
		private MaplineSeriesIkhParams Params_DefaultValue { get; set; }
		...
		/// </summary>
		public MaplineSeriesIkhLinecap Linecap { get; set; }
		private MaplineSeriesIkhLinecap Linecap_DefaultValue { get; set; }
		...
		/// </summary>
		public MaplineSeriesIkhGapUnit GapUnit { get; set; }
		private MaplineSeriesIkhGapUnit GapUnit_DefaultValue { get; set; }
		...
		/// </summary>
		public MaplineSeriesIkhLabel Label { get; set; }
		private MaplineSeriesIkhLabel Label_DefaultValue { get; set; }
		...
		/// </summary>
		public MaplineSeriesIkhDataGrouping DataGrouping { get; set; }
		private MaplineSeriesIkhDataGrouping DataGrouping_DefaultValue { get; set; }
		...
		/// </summary>
		public MaplineSeriesIkhEvents Events { get; set; }
		private MaplineSeriesIkhEvents Events_DefaultValue { get; set; }
		...
		/// </summary>
		public MaplineSeriesIkhMarker Marker { get; set; }
		private MaplineSeriesIkhMarker Marker_DefaultValue { get; set; }
		 

		/// <summary>
		/// <p>Properties for each single point.</p>
		/// </summary>
		public MaplineSeriesIkhPoint Point { get; set; }
		private MaplineSeriesIkhPoint Point_DefaultValue { get; set; }
		...
		/// </summary>
		public MaplineSeriesIkhDataLabels DataLabels { get; set; }
		private MaplineSeriesIkhDataLabels DataLabels_DefaultValue { get; set; }
		...
		/// </summary>
		public MaplineSeriesIkhStates States { get; set; }
		private MaplineSeriesIkhStates States_DefaultValue { get; set; }
		...
		/// </summary>
		public MaplineSeriesIkhFindNearestPointBy FindNearestPointBy { get; set; }
		private MaplineSeriesIkhFindNearestPointBy FindNearestPointBy_DefaultValue { get; set; }
		...
		/// </summary>
		public MaplineSeriesIkhCursor Cursor { get; set; }
		private MaplineSeriesIkhCursor Cursor_DefaultValue { get; set; }
		...
		/// </summary>
		public MaplineSeriesIkhDashStyle DashStyle { get; set; }
		private MaplineSeriesIkhDashStyle DashStyle_DefaultValue { get; set; }
		...
		/// </summary>
		public MaplineSeriesIkhStep Step { get; set; }
		private MaplineSeriesIkhStep Step_DefaultValue { get; set; }
		...
		/// </summary>
		public List<MaplineSeriesIkhZone> Zones { get; set; }
		private List<MaplineSeriesIkhZone> Zones_DefaultValue { get; set; }
		...
		/// </summary>
		public MaplineSeriesIkhPointIntervalUnit PointIntervalUnit { get; set; }
		private MaplineSeriesIkhPointIntervalUnit PointIntervalUnit_DefaultValue { get; set; }
		...
		/// </summary>
		public MaplineSeriesIkhStacking Stacking { get; set; }
		private MaplineSeriesIkhStacking Stacking_DefaultValue { get; set; }
		...
		/// </summary>
		public MaplineSeriesIkhCompareBase CompareBase { get; set; }
		private MaplineSeriesIkhCompareBase CompareBase_DefaultValue { get; set; }
		...
		internal override Hashtable ToHashtable()
		{
			...
			if (PointDescriptionFormatter != PointDescriptionFormatter_DefaultValue) { h.Add("pointDescriptionFormatter",PointDescriptionFormatter); Highstock.AddFunction("MaplineSeriesIkhPointDescriptionFormatter.pointDescriptionFormatter", PointDescriptionFormatter); }  
