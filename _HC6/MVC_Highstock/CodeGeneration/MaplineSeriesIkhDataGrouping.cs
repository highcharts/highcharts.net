...
{
	public partial class MaplineSeriesIkhDataGrouping  : BaseObject
	{
		...
		/// </summary>
		public MaplineSeriesIkhDataGroupingApproximation Approximation { get; set; }
		private MaplineSeriesIkhDataGroupingApproximation Approximation_DefaultValue { get; set; }
