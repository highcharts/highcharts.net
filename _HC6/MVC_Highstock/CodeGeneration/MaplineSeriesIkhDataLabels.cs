...
{
	public partial class MaplineSeriesIkhDataLabels  : BaseObject
	{
		public MaplineSeriesIkhDataLabels()
		{
			Align = Align_DefaultValue = MaplineSeriesIkhDataLabelsAlign.Center;
			Formatter = Formatter_DefaultValue = "";
			Style = Style_DefaultValue = new MaplineSeriesIkhDataLabelsStyle();
			VerticalAlign = VerticalAlign_DefaultValue = MaplineSeriesIkhDataLabelsVerticalAlign.Bottom;
			X = X_DefaultValue = 0;
			Y = Y_DefaultValue = -6;
			...
			Overflow = Overflow_DefaultValue = MaplineSeriesIkhDataLabelsOverflow.Justify;
		...
		/// </summary>
		public MaplineSeriesIkhDataLabelsAlign Align { get; set; }
		private MaplineSeriesIkhDataLabelsAlign Align_DefaultValue { get; set; }
		...
		/// </summary>
		public MaplineSeriesIkhDataLabelsStyle Style { get; set; }
		private MaplineSeriesIkhDataLabelsStyle Style_DefaultValue { get; set; }
		...
		/// </summary>
		public MaplineSeriesIkhDataLabelsVerticalAlign VerticalAlign { get; set; }
		private MaplineSeriesIkhDataLabelsVerticalAlign VerticalAlign_DefaultValue { get; set; }
		...
		/// </summary>
		public MaplineSeriesIkhDataLabelsOverflow Overflow { get; set; }
		private MaplineSeriesIkhDataLabelsOverflow Overflow_DefaultValue { get; set; }
		...
		internal override Hashtable ToHashtable()
		{
			...
			if (Formatter != Formatter_DefaultValue) { h.Add("formatter",Formatter); Highstock.AddFunction("MaplineSeriesIkhDataLabelsFormatter.formatter", Formatter); }  
