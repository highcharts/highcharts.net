...
{
	public partial class MaplineSeriesIkhMarker  : BaseObject
	{
		public MaplineSeriesIkhMarker()
		{
			LineWidth = LineWidth_DefaultValue = 0;
			LineColor = LineColor_DefaultValue = "#ffffff";
			Radius = Radius_DefaultValue = 4;
			States = States_DefaultValue = new MaplineSeriesIkhMarkerStates();
		...
		/// </summary>
		public MaplineSeriesIkhMarkerStates States { get; set; }
		private MaplineSeriesIkhMarkerStates States_DefaultValue { get; set; }
