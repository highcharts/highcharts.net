...
{
	public partial class MaplineSeriesIkhStatesHover  : BaseObject
	{
		public MaplineSeriesIkhStatesHover()
		{
			LineWidthPlus = LineWidthPlus_DefaultValue = 1;
			Marker = Marker_DefaultValue = new MaplineSeriesIkhStatesHoverMarker();
			Halo = Halo_DefaultValue = new MaplineSeriesIkhStatesHoverHalo();
		...
		/// </summary>
		public MaplineSeriesIkhStatesHoverMarker Marker { get; set; }
		private MaplineSeriesIkhStatesHoverMarker Marker_DefaultValue { get; set; }
		...
		/// </summary>
		public MaplineSeriesIkhStatesHoverHalo Halo { get; set; }
		private MaplineSeriesIkhStatesHoverHalo Halo_DefaultValue { get; set; }
