...
{
	public partial class MaplineSeriesIkhStatesHoverMarker  : BaseObject
	{
		public MaplineSeriesIkhStatesHoverMarker()
		{
			LineWidth = LineWidth_DefaultValue = 0;
			LineColor = LineColor_DefaultValue = "#ffffff";
			Radius = Radius_DefaultValue = 4;
			States = States_DefaultValue = new MaplineSeriesIkhStatesHoverMarkerStates();
		...
		/// </summary>
		public MaplineSeriesIkhStatesHoverMarkerStates States { get; set; }
		private MaplineSeriesIkhStatesHoverMarkerStates States_DefaultValue { get; set; }
