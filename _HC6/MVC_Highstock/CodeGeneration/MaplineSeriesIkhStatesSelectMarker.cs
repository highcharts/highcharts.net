...
{
	public partial class MaplineSeriesIkhStatesSelectMarker  : BaseObject
	{
		public MaplineSeriesIkhStatesSelectMarker()
		{
			LineWidth = LineWidth_DefaultValue = 0;
			LineColor = LineColor_DefaultValue = "#ffffff";
			Radius = Radius_DefaultValue = 4;
			States = States_DefaultValue = new MaplineSeriesIkhStatesSelectMarkerStates();
		...
		/// </summary>
		public MaplineSeriesIkhStatesSelectMarkerStates States { get; set; }
		private MaplineSeriesIkhStatesSelectMarkerStates States_DefaultValue { get; set; }
