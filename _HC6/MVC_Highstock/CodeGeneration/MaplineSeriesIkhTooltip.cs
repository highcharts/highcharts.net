...
{
	public partial class MaplineSeriesIkhTooltip  : BaseObject
	{
		public MaplineSeriesIkhTooltip()
		{
			ValueDecimals = ValueDecimals_DefaultValue = null;
			DateTimeLabelFormats = DateTimeLabelFormats_DefaultValue = new MaplineSeriesIkhTooltipDateTimeLabelFormats();
		...
		/// </summary>
		public MaplineSeriesIkhTooltipDateTimeLabelFormats DateTimeLabelFormats { get; set; }
		private MaplineSeriesIkhTooltipDateTimeLabelFormats DateTimeLabelFormats_DefaultValue { get; set; }
		...
		internal override Hashtable ToHashtable()
		{
			...
			if (PointFormatter != PointFormatter_DefaultValue) { h.Add("pointFormatter",PointFormatter); Highstock.AddFunction("MaplineSeriesIkhTooltipPointFormatter.pointFormatter", PointFormatter); }  
