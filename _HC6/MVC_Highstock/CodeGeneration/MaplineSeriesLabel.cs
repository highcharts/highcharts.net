...
{
	public partial class MaplineSeriesLabel  : BaseObject
	{
		public MaplineSeriesLabel()
		{
			...
			Style = Style_DefaultValue = new MaplineSeriesLabelStyle();
		...
		/// </summary>
		public MaplineSeriesLabelStyle Style { get; set; }
		private MaplineSeriesLabelStyle Style_DefaultValue { get; set; }
