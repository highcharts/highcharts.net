...
{
	public partial class MaplineSeriesStatesHoverMarker  : BaseObject
	{
		public MaplineSeriesStatesHoverMarker()
		{
			LineWidth = LineWidth_DefaultValue = 0;
			LineColor = LineColor_DefaultValue = "#ffffff";
			Radius = Radius_DefaultValue = 4;
			States = States_DefaultValue = new MaplineSeriesStatesHoverMarkerStates();
		...
		/// </summary>
		public MaplineSeriesStatesHoverMarkerStates States { get; set; }
		private MaplineSeriesStatesHoverMarkerStates States_DefaultValue { get; set; }
