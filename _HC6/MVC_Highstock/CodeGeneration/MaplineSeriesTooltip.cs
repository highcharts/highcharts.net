...
{
	public partial class MaplineSeriesTooltip  : BaseObject
	{
		public MaplineSeriesTooltip()
		{
			...
			DateTimeLabelFormats = DateTimeLabelFormats_DefaultValue = new MaplineSeriesTooltipDateTimeLabelFormats();
		...
		/// </summary>
		public MaplineSeriesTooltipDateTimeLabelFormats DateTimeLabelFormats { get; set; }
		private MaplineSeriesTooltipDateTimeLabelFormats DateTimeLabelFormats_DefaultValue { get; set; }
		...
		internal override Hashtable ToHashtable()
		{
			...
			if (PointFormatter != PointFormatter_DefaultValue) { h.Add("pointFormatter",PointFormatter); Highstock.AddFunction("MaplineSeriesTooltipPointFormatter.pointFormatter", PointFormatter); }  
