...
{
	public partial class MappointSeriesDataGrouping  : BaseObject
	{
		public MappointSeriesDataGrouping()
		{
			Approximation = Approximation_DefaultValue = MappointSeriesDataGroupingApproximation.Average;
		...
		/// </summary>
		public MappointSeriesDataGroupingApproximation Approximation { get; set; }
		private MappointSeriesDataGroupingApproximation Approximation_DefaultValue { get; set; }
