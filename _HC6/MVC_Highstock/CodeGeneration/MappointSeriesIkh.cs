...
{
	public partial class MappointSeriesIkh  : BaseObject
	{
		public MappointSeriesIkh()
		{
			Name = Name_DefaultValue = "SMA (14)";
			Tooltip = Tooltip_DefaultValue = new MappointSeriesIkhTooltip();
			LinkedTo = LinkedTo_DefaultValue = null;
			Params = Params_DefaultValue = new MappointSeriesIkhParams();
			Linecap = Linecap_DefaultValue = MappointSeriesIkhLinecap.Round;
			BoostThreshold = BoostThreshold_DefaultValue = 5000;
			GapSize = GapSize_DefaultValue = 0;
			GapUnit = GapUnit_DefaultValue = MappointSeriesIkhGapUnit.Relative;
			Label = Label_DefaultValue = new MappointSeriesIkhLabel();
			DataGrouping = DataGrouping_DefaultValue = new MappointSeriesIkhDataGrouping();
			LineWidth = LineWidth_DefaultValue = 2;
			AllowPointSelect = AllowPointSelect_DefaultValue = false;
			ShowCheckbox = ShowCheckbox_DefaultValue = false;
			Animation = Animation_DefaultValue = new Animation() { Enabled = true };
			Events = Events_DefaultValue = new MappointSeriesIkhEvents();
			Marker = Marker_DefaultValue = new MappointSeriesIkhMarker();
			Point = Point_DefaultValue = new MappointSeriesIkhPoint();
			DataLabels = DataLabels_DefaultValue = new MappointSeriesIkhDataLabels();
			CropThreshold = CropThreshold_DefaultValue = 300;
			SoftThreshold = SoftThreshold_DefaultValue = true;
			States = States_DefaultValue = new MappointSeriesIkhStates();
			StickyTracking = StickyTracking_DefaultValue = null;
			TurboThreshold = TurboThreshold_DefaultValue = 1000;
			FindNearestPointBy = FindNearestPointBy_DefaultValue = MappointSeriesIkhFindNearestPointBy.X;
			AnimationLimit = AnimationLimit_DefaultValue = null;
			ClassName = ClassName_DefaultValue = null;
			Color = Color_DefaultValue = null;
			ColorIndex = ColorIndex_DefaultValue = null;
			ConnectNulls = ConnectNulls_DefaultValue = false;
			Cursor = Cursor_DefaultValue = MappointSeriesIkhCursor.Null;
			DashStyle = DashStyle_DefaultValue = MappointSeriesIkhDashStyle.Solid;
			...
			Step = Step_DefaultValue = MappointSeriesIkhStep.Null;
			Threshold = Threshold_DefaultValue = 0;
			Visible = Visible_DefaultValue = true;
			ZoneAxis = ZoneAxis_DefaultValue = "y";
			Zones = Zones_DefaultValue = new List<MappointSeriesIkhZone>();
			...
			PointIntervalUnit = PointIntervalUnit_DefaultValue = MappointSeriesIkhPointIntervalUnit.Null;
			PointPlacement = PointPlacement_DefaultValue = new PointPlacement();
			PointStart = PointStart_DefaultValue = 0;
			Stacking = Stacking_DefaultValue = MappointSeriesIkhStacking.Null;
			Compare = Compare_DefaultValue = "undefined";
			CompareBase = CompareBase_DefaultValue = MappointSeriesIkhCompareBase.Min;
		...
		/// </summary>
		public MappointSeriesIkhTooltip Tooltip { get; set; }
		private MappointSeriesIkhTooltip Tooltip_DefaultValue { get; set; }
		...
		/// 
		/// </summary>
		public MappointSeriesIkhParams Params { get; set; }
		private MappointSeriesIkhParams Params_DefaultValue { get; set; }
		...
		/// </summary>
		public MappointSeriesIkhLinecap Linecap { get; set; }
		private MappointSeriesIkhLinecap Linecap_DefaultValue { get; set; }
		...
		/// </summary>
		public MappointSeriesIkhGapUnit GapUnit { get; set; }
		private MappointSeriesIkhGapUnit GapUnit_DefaultValue { get; set; }
		...
		/// </summary>
		public MappointSeriesIkhLabel Label { get; set; }
		private MappointSeriesIkhLabel Label_DefaultValue { get; set; }
		...
		/// </summary>
		public MappointSeriesIkhDataGrouping DataGrouping { get; set; }
		private MappointSeriesIkhDataGrouping DataGrouping_DefaultValue { get; set; }
		...
		/// </summary>
		public MappointSeriesIkhEvents Events { get; set; }
		private MappointSeriesIkhEvents Events_DefaultValue { get; set; }
		...
		/// </summary>
		public MappointSeriesIkhMarker Marker { get; set; }
		private MappointSeriesIkhMarker Marker_DefaultValue { get; set; }
		 

		/// <summary>
		/// <p>Properties for each single point.</p>
		/// </summary>
		public MappointSeriesIkhPoint Point { get; set; }
		private MappointSeriesIkhPoint Point_DefaultValue { get; set; }
		...
		/// </summary>
		public MappointSeriesIkhDataLabels DataLabels { get; set; }
		private MappointSeriesIkhDataLabels DataLabels_DefaultValue { get; set; }
		...
		/// </summary>
		public MappointSeriesIkhStates States { get; set; }
		private MappointSeriesIkhStates States_DefaultValue { get; set; }
		...
		/// </summary>
		public MappointSeriesIkhFindNearestPointBy FindNearestPointBy { get; set; }
		private MappointSeriesIkhFindNearestPointBy FindNearestPointBy_DefaultValue { get; set; }
		...
		/// </summary>
		public MappointSeriesIkhCursor Cursor { get; set; }
		private MappointSeriesIkhCursor Cursor_DefaultValue { get; set; }
		...
		/// </summary>
		public MappointSeriesIkhDashStyle DashStyle { get; set; }
		private MappointSeriesIkhDashStyle DashStyle_DefaultValue { get; set; }
		...
		/// </summary>
		public MappointSeriesIkhStep Step { get; set; }
		private MappointSeriesIkhStep Step_DefaultValue { get; set; }
		...
		/// </summary>
		public List<MappointSeriesIkhZone> Zones { get; set; }
		private List<MappointSeriesIkhZone> Zones_DefaultValue { get; set; }
		...
		/// </summary>
		public MappointSeriesIkhPointIntervalUnit PointIntervalUnit { get; set; }
		private MappointSeriesIkhPointIntervalUnit PointIntervalUnit_DefaultValue { get; set; }
		...
		/// </summary>
		public MappointSeriesIkhStacking Stacking { get; set; }
		private MappointSeriesIkhStacking Stacking_DefaultValue { get; set; }
		...
		/// </summary>
		public MappointSeriesIkhCompareBase CompareBase { get; set; }
		private MappointSeriesIkhCompareBase CompareBase_DefaultValue { get; set; }
		...
		internal override Hashtable ToHashtable()
		{
			...
			if (PointDescriptionFormatter != PointDescriptionFormatter_DefaultValue) { h.Add("pointDescriptionFormatter",PointDescriptionFormatter); Highstock.AddFunction("MappointSeriesIkhPointDescriptionFormatter.pointDescriptionFormatter", PointDescriptionFormatter); }  
