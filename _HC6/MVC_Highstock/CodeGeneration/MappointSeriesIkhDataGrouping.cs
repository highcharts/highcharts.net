...
{
	public partial class MappointSeriesIkhDataGrouping  : BaseObject
	{
		public MappointSeriesIkhDataGrouping()
		{
			Approximation = Approximation_DefaultValue = MappointSeriesIkhDataGroupingApproximation.Average;
		...
		/// </summary>
		public MappointSeriesIkhDataGroupingApproximation Approximation { get; set; }
		private MappointSeriesIkhDataGroupingApproximation Approximation_DefaultValue { get; set; }
