...
{
	public partial class MappointSeriesIkhDataLabels  : BaseObject
	{
		public MappointSeriesIkhDataLabels()
		{
			Align = Align_DefaultValue = MappointSeriesIkhDataLabelsAlign.Center;
			Formatter = Formatter_DefaultValue = "";
			Style = Style_DefaultValue = new MappointSeriesIkhDataLabelsStyle();
			VerticalAlign = VerticalAlign_DefaultValue = MappointSeriesIkhDataLabelsVerticalAlign.Bottom;
			X = X_DefaultValue = 0;
			Y = Y_DefaultValue = -6;
			...
			Overflow = Overflow_DefaultValue = MappointSeriesIkhDataLabelsOverflow.Justify;
		...
		/// </summary>
		public MappointSeriesIkhDataLabelsAlign Align { get; set; }
		private MappointSeriesIkhDataLabelsAlign Align_DefaultValue { get; set; }
		...
		/// </summary>
		public MappointSeriesIkhDataLabelsStyle Style { get; set; }
		private MappointSeriesIkhDataLabelsStyle Style_DefaultValue { get; set; }
		...
		/// </summary>
		public MappointSeriesIkhDataLabelsVerticalAlign VerticalAlign { get; set; }
		private MappointSeriesIkhDataLabelsVerticalAlign VerticalAlign_DefaultValue { get; set; }
		...
		/// </summary>
		public MappointSeriesIkhDataLabelsOverflow Overflow { get; set; }
		private MappointSeriesIkhDataLabelsOverflow Overflow_DefaultValue { get; set; }
		...
		internal override Hashtable ToHashtable()
		{
			...
			if (Formatter != Formatter_DefaultValue) { h.Add("formatter",Formatter); Highstock.AddFunction("MappointSeriesIkhDataLabelsFormatter.formatter", Formatter); }  
