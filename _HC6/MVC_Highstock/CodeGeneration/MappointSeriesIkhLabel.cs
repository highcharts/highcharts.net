...
{
	public partial class MappointSeriesIkhLabel  : BaseObject
	{
		public MappointSeriesIkhLabel()
		{
			...
			Style = Style_DefaultValue = new MappointSeriesIkhLabelStyle();
		...
		/// </summary>
		public MappointSeriesIkhLabelStyle Style { get; set; }
		private MappointSeriesIkhLabelStyle Style_DefaultValue { get; set; }
