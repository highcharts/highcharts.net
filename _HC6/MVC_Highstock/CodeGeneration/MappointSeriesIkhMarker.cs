...
{
	public partial class MappointSeriesIkhMarker  : BaseObject
	{
		public MappointSeriesIkhMarker()
		{
			LineWidth = LineWidth_DefaultValue = 0;
			LineColor = LineColor_DefaultValue = "#ffffff";
			Radius = Radius_DefaultValue = 4;
			States = States_DefaultValue = new MappointSeriesIkhMarkerStates();
		...
		/// </summary>
		public MappointSeriesIkhMarkerStates States { get; set; }
		private MappointSeriesIkhMarkerStates States_DefaultValue { get; set; }
