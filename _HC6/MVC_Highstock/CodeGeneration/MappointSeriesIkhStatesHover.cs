...
{
	public partial class MappointSeriesIkhStatesHover  : BaseObject
	{
		public MappointSeriesIkhStatesHover()
		{
			LineWidthPlus = LineWidthPlus_DefaultValue = 1;
			Marker = Marker_DefaultValue = new MappointSeriesIkhStatesHoverMarker();
			Halo = Halo_DefaultValue = new MappointSeriesIkhStatesHoverHalo();
		...
		/// </summary>
		public MappointSeriesIkhStatesHoverMarker Marker { get; set; }
		private MappointSeriesIkhStatesHoverMarker Marker_DefaultValue { get; set; }
		...
		/// </summary>
		public MappointSeriesIkhStatesHoverHalo Halo { get; set; }
		private MappointSeriesIkhStatesHoverHalo Halo_DefaultValue { get; set; }
