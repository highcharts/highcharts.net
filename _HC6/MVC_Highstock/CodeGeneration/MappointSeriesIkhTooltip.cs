...
{
	public partial class MappointSeriesIkhTooltip  : BaseObject
	{
		public MappointSeriesIkhTooltip()
		{
			ValueDecimals = ValueDecimals_DefaultValue = null;
			DateTimeLabelFormats = DateTimeLabelFormats_DefaultValue = new MappointSeriesIkhTooltipDateTimeLabelFormats();
		...
		/// </summary>
		public MappointSeriesIkhTooltipDateTimeLabelFormats DateTimeLabelFormats { get; set; }
		private MappointSeriesIkhTooltipDateTimeLabelFormats DateTimeLabelFormats_DefaultValue { get; set; }
		...
		internal override Hashtable ToHashtable()
		{
			...
			if (PointFormatter != PointFormatter_DefaultValue) { h.Add("pointFormatter",PointFormatter); Highstock.AddFunction("MappointSeriesIkhTooltipPointFormatter.pointFormatter", PointFormatter); }  
