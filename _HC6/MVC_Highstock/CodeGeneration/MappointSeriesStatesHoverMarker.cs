...
{
	public partial class MappointSeriesStatesHoverMarker  : BaseObject
	{
		public MappointSeriesStatesHoverMarker()
		{
			LineWidth = LineWidth_DefaultValue = 0;
			LineColor = LineColor_DefaultValue = "#ffffff";
			Radius = Radius_DefaultValue = 4;
			States = States_DefaultValue = new MappointSeriesStatesHoverMarkerStates();
		...
		/// </summary>
		public MappointSeriesStatesHoverMarkerStates States { get; set; }
		private MappointSeriesStatesHoverMarkerStates States_DefaultValue { get; set; }
