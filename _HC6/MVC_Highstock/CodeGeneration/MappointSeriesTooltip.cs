...
{
	public partial class MappointSeriesTooltip  : BaseObject
	{
		public MappointSeriesTooltip()
		{
			...
			DateTimeLabelFormats = DateTimeLabelFormats_DefaultValue = new MappointSeriesTooltipDateTimeLabelFormats();
		...
		/// </summary>
		public MappointSeriesTooltipDateTimeLabelFormats DateTimeLabelFormats { get; set; }
		private MappointSeriesTooltipDateTimeLabelFormats DateTimeLabelFormats_DefaultValue { get; set; }
		...
		internal override Hashtable ToHashtable()
		{
			...
			if (PointFormatter != PointFormatter_DefaultValue) { h.Add("pointFormatter",PointFormatter); Highstock.AddFunction("MappointSeriesTooltipPointFormatter.pointFormatter", PointFormatter); }  
