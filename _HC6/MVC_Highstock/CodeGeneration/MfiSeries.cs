...
namespace Highsoft.Web.Mvc.Stocks
{
	public partial class MfiSeries  : Series
	{
		public MfiSeries()
		{
			...
			Data = Data_DefaultValue = new List<MfiSeriesData>();
		...
		/// <summary>
		/// An array of data points for the series. For the `mfi` series type,points are calculated dynamically.
		/// </summary>
		public List<MfiSeriesData> Data { get; set; }
		private List<MfiSeriesData> Data_DefaultValue { get; set; }
