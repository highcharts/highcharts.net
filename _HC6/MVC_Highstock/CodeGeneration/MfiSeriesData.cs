...
{
	public partial class MfiSeriesData  : BaseObject
	{
		public MfiSeriesData()
		{
			...
			DragDrop = DragDrop_DefaultValue = new MfiSeriesDataDragDrop();
			Drilldown = Drilldown_DefaultValue = "";
			Events = Events_DefaultValue = new MfiSeriesDataEvents();
			Id = Id_DefaultValue = "";
			Labelrank = Labelrank_DefaultValue = null;
			Marker = Marker_DefaultValue = new MfiSeriesDataMarker();
		...
		/// </summary>
		public MfiSeriesDataDragDrop DragDrop { get; set; }
		private MfiSeriesDataDragDrop DragDrop_DefaultValue { get; set; }
		...
		/// </summary>
		public MfiSeriesDataEvents Events { get; set; }
		private MfiSeriesDataEvents Events_DefaultValue { get; set; }
		...
		/// 
		/// </summary>
		public MfiSeriesDataMarker Marker { get; set; }
		private MfiSeriesDataMarker Marker_DefaultValue { get; set; }
