...
{
	public partial class MfiSeriesDataDragDropDragHandle  : BaseObject
	{
		public MfiSeriesDataDragDropDragHandle()
		{
		...
		internal override Hashtable ToHashtable()
		{
			...
			if (PathFormatter != PathFormatter_DefaultValue) { h.Add("pathFormatter",PathFormatter); Highstock.AddFunction("MfiSeriesDataDragDropDragHandlePathFormatter.pathFormatter", PathFormatter); }  
