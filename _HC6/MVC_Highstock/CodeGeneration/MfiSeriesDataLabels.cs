...
namespace Highsoft.Web.Mvc.Stocks
{
	public partial class MfiSeriesDataLabels  : BaseObject
	{
		public MfiSeriesDataLabels()
		{
			...
			Style = Style_DefaultValue = new MfiSeriesDataLabelsStyle();
		...
		/// </summary>
		public MfiSeriesDataLabelsStyle Style { get; set; }
		private MfiSeriesDataLabelsStyle Style_DefaultValue { get; set; }
