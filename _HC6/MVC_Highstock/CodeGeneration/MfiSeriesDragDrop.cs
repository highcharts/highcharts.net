...
{
	public partial class MfiSeriesDragDrop  : BaseObject
	{
		public MfiSeriesDragDrop()
		{
			DraggableX = DraggableX_DefaultValue = null;
			DraggableY = DraggableY_DefaultValue = null;
			DragHandle = DragHandle_DefaultValue = new MfiSeriesDragDropDragHandle();
			...
			GuideBox = GuideBox_DefaultValue = new MfiSeriesDragDropGuideBox();
		...
		/// </summary>
		public MfiSeriesDragDropDragHandle DragHandle { get; set; }
		private MfiSeriesDragDropDragHandle DragHandle_DefaultValue { get; set; }
		...
		/// </summary>
		public MfiSeriesDragDropGuideBox GuideBox { get; set; }
		private MfiSeriesDragDropGuideBox GuideBox_DefaultValue { get; set; }
