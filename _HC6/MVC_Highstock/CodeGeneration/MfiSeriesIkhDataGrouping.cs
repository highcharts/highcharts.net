...
{
	public partial class MfiSeriesIkhDataGrouping  : BaseObject
	{
		public MfiSeriesIkhDataGrouping()
		{
			Approximation = Approximation_DefaultValue = MfiSeriesIkhDataGroupingApproximation.Average;
		...
		/// </summary>
		public MfiSeriesIkhDataGroupingApproximation Approximation { get; set; }
		private MfiSeriesIkhDataGroupingApproximation Approximation_DefaultValue { get; set; }
