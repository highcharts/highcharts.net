...
{
	public partial class MfiSeriesIkhDataLabels  : BaseObject
	{
		public MfiSeriesIkhDataLabels()
		{
			Align = Align_DefaultValue = MfiSeriesIkhDataLabelsAlign.Center;
			Formatter = Formatter_DefaultValue = "";
			Style = Style_DefaultValue = new MfiSeriesIkhDataLabelsStyle();
			VerticalAlign = VerticalAlign_DefaultValue = MfiSeriesIkhDataLabelsVerticalAlign.Bottom;
			X = X_DefaultValue = 0;
			Y = Y_DefaultValue = -6;
			...
			Overflow = Overflow_DefaultValue = MfiSeriesIkhDataLabelsOverflow.Justify;
		...
		/// </summary>
		public MfiSeriesIkhDataLabelsAlign Align { get; set; }
		private MfiSeriesIkhDataLabelsAlign Align_DefaultValue { get; set; }
		...
		/// </summary>
		public MfiSeriesIkhDataLabelsStyle Style { get; set; }
		private MfiSeriesIkhDataLabelsStyle Style_DefaultValue { get; set; }
		...
		/// </summary>
		public MfiSeriesIkhDataLabelsVerticalAlign VerticalAlign { get; set; }
		private MfiSeriesIkhDataLabelsVerticalAlign VerticalAlign_DefaultValue { get; set; }
		...
		/// </summary>
		public MfiSeriesIkhDataLabelsOverflow Overflow { get; set; }
		private MfiSeriesIkhDataLabelsOverflow Overflow_DefaultValue { get; set; }
		...
		internal override Hashtable ToHashtable()
		{
			...
			if (Formatter != Formatter_DefaultValue) { h.Add("formatter",Formatter); Highstock.AddFunction("MfiSeriesIkhDataLabelsFormatter.formatter", Formatter); }  
