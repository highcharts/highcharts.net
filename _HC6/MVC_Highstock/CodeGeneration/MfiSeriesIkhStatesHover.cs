...
{
	public partial class MfiSeriesIkhStatesHover  : BaseObject
	{
		public MfiSeriesIkhStatesHover()
		{
			LineWidthPlus = LineWidthPlus_DefaultValue = 1;
			Marker = Marker_DefaultValue = new MfiSeriesIkhStatesHoverMarker();
			Halo = Halo_DefaultValue = new MfiSeriesIkhStatesHoverHalo();
		...
		/// </summary>
		public MfiSeriesIkhStatesHoverMarker Marker { get; set; }
		private MfiSeriesIkhStatesHoverMarker Marker_DefaultValue { get; set; }
		...
		/// </summary>
		public MfiSeriesIkhStatesHoverHalo Halo { get; set; }
		private MfiSeriesIkhStatesHoverHalo Halo_DefaultValue { get; set; }
