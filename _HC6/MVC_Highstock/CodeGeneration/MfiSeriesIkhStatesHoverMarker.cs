...
{
	public partial class MfiSeriesIkhStatesHoverMarker  : BaseObject
	{
		public MfiSeriesIkhStatesHoverMarker()
		{
			LineWidth = LineWidth_DefaultValue = 0;
			LineColor = LineColor_DefaultValue = "#ffffff";
			Radius = Radius_DefaultValue = 4;
			States = States_DefaultValue = new MfiSeriesIkhStatesHoverMarkerStates();
		...
		/// </summary>
		public MfiSeriesIkhStatesHoverMarkerStates States { get; set; }
		private MfiSeriesIkhStatesHoverMarkerStates States_DefaultValue { get; set; }
