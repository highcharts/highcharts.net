...
{
	public partial class MfiSeriesIkhStatesSelectMarker  : BaseObject
	{
		public MfiSeriesIkhStatesSelectMarker()
		{
			LineWidth = LineWidth_DefaultValue = 0;
			LineColor = LineColor_DefaultValue = "#ffffff";
			Radius = Radius_DefaultValue = 4;
			States = States_DefaultValue = new MfiSeriesIkhStatesSelectMarkerStates();
		...
		/// </summary>
		public MfiSeriesIkhStatesSelectMarkerStates States { get; set; }
		private MfiSeriesIkhStatesSelectMarkerStates States_DefaultValue { get; set; }
