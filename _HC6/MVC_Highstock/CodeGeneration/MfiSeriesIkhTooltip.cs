...
{
	public partial class MfiSeriesIkhTooltip  : BaseObject
	{
		public MfiSeriesIkhTooltip()
		{
			ValueDecimals = ValueDecimals_DefaultValue = null;
			DateTimeLabelFormats = DateTimeLabelFormats_DefaultValue = new MfiSeriesIkhTooltipDateTimeLabelFormats();
		...
		/// </summary>
		public MfiSeriesIkhTooltipDateTimeLabelFormats DateTimeLabelFormats { get; set; }
		private MfiSeriesIkhTooltipDateTimeLabelFormats DateTimeLabelFormats_DefaultValue { get; set; }
		...
		internal override Hashtable ToHashtable()
		{
			...
			if (PointFormatter != PointFormatter_DefaultValue) { h.Add("pointFormatter",PointFormatter); Highstock.AddFunction("MfiSeriesIkhTooltipPointFormatter.pointFormatter", PointFormatter); }  
