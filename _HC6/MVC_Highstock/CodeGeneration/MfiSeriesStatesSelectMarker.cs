...
{
	public partial class MfiSeriesStatesSelectMarker  : BaseObject
	{
		public MfiSeriesStatesSelectMarker()
		{
			LineWidth = LineWidth_DefaultValue = 0;
			LineColor = LineColor_DefaultValue = "#ffffff";
			Radius = Radius_DefaultValue = 4;
			States = States_DefaultValue = new MfiSeriesStatesSelectMarkerStates();
		...
		/// </summary>
		public MfiSeriesStatesSelectMarkerStates States { get; set; }
		private MfiSeriesStatesSelectMarkerStates States_DefaultValue { get; set; }
