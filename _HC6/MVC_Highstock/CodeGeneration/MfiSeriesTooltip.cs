...
namespace Highsoft.Web.Mvc.Stocks
{
	public partial class MfiSeriesTooltip  : BaseObject
	{
		public MfiSeriesTooltip()
		{
			...
			DateTimeLabelFormats = DateTimeLabelFormats_DefaultValue = new MfiSeriesTooltipDateTimeLabelFormats();
		...
		/// </summary>
		public MfiSeriesTooltipDateTimeLabelFormats DateTimeLabelFormats { get; set; }
		private MfiSeriesTooltipDateTimeLabelFormats DateTimeLabelFormats_DefaultValue { get; set; }
