...
namespace Highsoft.Web.Mvc.Stocks
{
	public partial class MomentumSeriesDataLabels  : BaseObject
	{
		public MomentumSeriesDataLabels()
		{
			...
			Style = Style_DefaultValue = new MomentumSeriesDataLabelsStyle();
		...
		/// </summary>
		public MomentumSeriesDataLabelsStyle Style { get; set; }
		private MomentumSeriesDataLabelsStyle Style_DefaultValue { get; set; }
