...
{
	public partial class MomentumSeriesDataMarker  : BaseObject
	{
		public MomentumSeriesDataMarker()
		{
			...
			States = States_DefaultValue = new MomentumSeriesDataMarkerStates();
		...
		/// </summary>
		public MomentumSeriesDataMarkerStates States { get; set; }
		private MomentumSeriesDataMarkerStates States_DefaultValue { get; set; }
