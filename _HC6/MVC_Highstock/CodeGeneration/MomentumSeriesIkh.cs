...
{
	public partial class MomentumSeriesIkh  : BaseObject
	{
		public MomentumSeriesIkh()
		{
			Name = Name_DefaultValue = "SMA (14)";
			Tooltip = Tooltip_DefaultValue = new MomentumSeriesIkhTooltip();
			LinkedTo = LinkedTo_DefaultValue = null;
			Params = Params_DefaultValue = new MomentumSeriesIkhParams();
			Linecap = Linecap_DefaultValue = MomentumSeriesIkhLinecap.Round;
			BoostThreshold = BoostThreshold_DefaultValue = 5000;
			GapSize = GapSize_DefaultValue = 0;
			GapUnit = GapUnit_DefaultValue = MomentumSeriesIkhGapUnit.Relative;
			Label = Label_DefaultValue = new MomentumSeriesIkhLabel();
			DataGrouping = DataGrouping_DefaultValue = new MomentumSeriesIkhDataGrouping();
			LineWidth = LineWidth_DefaultValue = 2;
			AllowPointSelect = AllowPointSelect_DefaultValue = false;
			ShowCheckbox = ShowCheckbox_DefaultValue = false;
			Animation = Animation_DefaultValue = new Animation() { Enabled = true };
			Events = Events_DefaultValue = new MomentumSeriesIkhEvents();
			Marker = Marker_DefaultValue = new MomentumSeriesIkhMarker();
			Point = Point_DefaultValue = new MomentumSeriesIkhPoint();
			DataLabels = DataLabels_DefaultValue = new MomentumSeriesIkhDataLabels();
			CropThreshold = CropThreshold_DefaultValue = 300;
			SoftThreshold = SoftThreshold_DefaultValue = true;
			States = States_DefaultValue = new MomentumSeriesIkhStates();
			StickyTracking = StickyTracking_DefaultValue = null;
			TurboThreshold = TurboThreshold_DefaultValue = 1000;
			FindNearestPointBy = FindNearestPointBy_DefaultValue = MomentumSeriesIkhFindNearestPointBy.X;
			AnimationLimit = AnimationLimit_DefaultValue = null;
			ClassName = ClassName_DefaultValue = null;
			Color = Color_DefaultValue = null;
			ColorIndex = ColorIndex_DefaultValue = null;
			ConnectNulls = ConnectNulls_DefaultValue = false;
			Cursor = Cursor_DefaultValue = MomentumSeriesIkhCursor.Null;
			DashStyle = DashStyle_DefaultValue = MomentumSeriesIkhDashStyle.Solid;
			...
			Step = Step_DefaultValue = MomentumSeriesIkhStep.Null;
			Threshold = Threshold_DefaultValue = 0;
			Visible = Visible_DefaultValue = true;
			ZoneAxis = ZoneAxis_DefaultValue = "y";
			Zones = Zones_DefaultValue = new List<MomentumSeriesIkhZone>();
			...
			PointIntervalUnit = PointIntervalUnit_DefaultValue = MomentumSeriesIkhPointIntervalUnit.Null;
			PointPlacement = PointPlacement_DefaultValue = new PointPlacement();
			PointStart = PointStart_DefaultValue = 0;
			Stacking = Stacking_DefaultValue = MomentumSeriesIkhStacking.Null;
			Compare = Compare_DefaultValue = "undefined";
			CompareBase = CompareBase_DefaultValue = MomentumSeriesIkhCompareBase.Min;
		...
		/// </summary>
		public MomentumSeriesIkhTooltip Tooltip { get; set; }
		private MomentumSeriesIkhTooltip Tooltip_DefaultValue { get; set; }
		...
		/// 
		/// </summary>
		public MomentumSeriesIkhParams Params { get; set; }
		private MomentumSeriesIkhParams Params_DefaultValue { get; set; }
		...
		/// </summary>
		public MomentumSeriesIkhLinecap Linecap { get; set; }
		private MomentumSeriesIkhLinecap Linecap_DefaultValue { get; set; }
		...
		/// </summary>
		public MomentumSeriesIkhGapUnit GapUnit { get; set; }
		private MomentumSeriesIkhGapUnit GapUnit_DefaultValue { get; set; }
		...
		/// </summary>
		public MomentumSeriesIkhLabel Label { get; set; }
		private MomentumSeriesIkhLabel Label_DefaultValue { get; set; }
		...
		/// </summary>
		public MomentumSeriesIkhDataGrouping DataGrouping { get; set; }
		private MomentumSeriesIkhDataGrouping DataGrouping_DefaultValue { get; set; }
		...
		/// </summary>
		public MomentumSeriesIkhEvents Events { get; set; }
		private MomentumSeriesIkhEvents Events_DefaultValue { get; set; }
		...
		/// </summary>
		public MomentumSeriesIkhMarker Marker { get; set; }
		private MomentumSeriesIkhMarker Marker_DefaultValue { get; set; }
		 

		/// <summary>
		/// <p>Properties for each single point.</p>
		/// </summary>
		public MomentumSeriesIkhPoint Point { get; set; }
		private MomentumSeriesIkhPoint Point_DefaultValue { get; set; }
		...
		/// </summary>
		public MomentumSeriesIkhDataLabels DataLabels { get; set; }
		private MomentumSeriesIkhDataLabels DataLabels_DefaultValue { get; set; }
		...
		/// </summary>
		public MomentumSeriesIkhStates States { get; set; }
		private MomentumSeriesIkhStates States_DefaultValue { get; set; }
		...
		/// </summary>
		public MomentumSeriesIkhFindNearestPointBy FindNearestPointBy { get; set; }
		private MomentumSeriesIkhFindNearestPointBy FindNearestPointBy_DefaultValue { get; set; }
		...
		/// </summary>
		public MomentumSeriesIkhCursor Cursor { get; set; }
		private MomentumSeriesIkhCursor Cursor_DefaultValue { get; set; }
		...
		/// </summary>
		public MomentumSeriesIkhDashStyle DashStyle { get; set; }
		private MomentumSeriesIkhDashStyle DashStyle_DefaultValue { get; set; }
		...
		/// </summary>
		public MomentumSeriesIkhStep Step { get; set; }
		private MomentumSeriesIkhStep Step_DefaultValue { get; set; }
		...
		/// </summary>
		public List<MomentumSeriesIkhZone> Zones { get; set; }
		private List<MomentumSeriesIkhZone> Zones_DefaultValue { get; set; }
		...
		/// </summary>
		public MomentumSeriesIkhPointIntervalUnit PointIntervalUnit { get; set; }
		private MomentumSeriesIkhPointIntervalUnit PointIntervalUnit_DefaultValue { get; set; }
		...
		/// </summary>
		public MomentumSeriesIkhStacking Stacking { get; set; }
		private MomentumSeriesIkhStacking Stacking_DefaultValue { get; set; }
		...
		/// </summary>
		public MomentumSeriesIkhCompareBase CompareBase { get; set; }
		private MomentumSeriesIkhCompareBase CompareBase_DefaultValue { get; set; }
		...
		internal override Hashtable ToHashtable()
		{
			...
			if (PointDescriptionFormatter != PointDescriptionFormatter_DefaultValue) { h.Add("pointDescriptionFormatter",PointDescriptionFormatter); Highstock.AddFunction("MomentumSeriesIkhPointDescriptionFormatter.pointDescriptionFormatter", PointDescriptionFormatter); }  
