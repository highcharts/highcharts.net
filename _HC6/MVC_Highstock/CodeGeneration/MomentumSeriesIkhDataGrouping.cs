...
{
	public partial class MomentumSeriesIkhDataGrouping  : BaseObject
	{
		public MomentumSeriesIkhDataGrouping()
		{
			Approximation = Approximation_DefaultValue = MomentumSeriesIkhDataGroupingApproximation.Average;
		...
		/// </summary>
		public MomentumSeriesIkhDataGroupingApproximation Approximation { get; set; }
		private MomentumSeriesIkhDataGroupingApproximation Approximation_DefaultValue { get; set; }
