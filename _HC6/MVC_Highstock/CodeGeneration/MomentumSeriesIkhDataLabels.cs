...
{
	public partial class MomentumSeriesIkhDataLabels  : BaseObject
	{
		public MomentumSeriesIkhDataLabels()
		{
			Align = Align_DefaultValue = MomentumSeriesIkhDataLabelsAlign.Center;
			Formatter = Formatter_DefaultValue = "";
			Style = Style_DefaultValue = new MomentumSeriesIkhDataLabelsStyle();
			VerticalAlign = VerticalAlign_DefaultValue = MomentumSeriesIkhDataLabelsVerticalAlign.Bottom;
			X = X_DefaultValue = 0;
			Y = Y_DefaultValue = -6;
			...
			Overflow = Overflow_DefaultValue = MomentumSeriesIkhDataLabelsOverflow.Justify;
		...
		/// </summary>
		public MomentumSeriesIkhDataLabelsAlign Align { get; set; }
		private MomentumSeriesIkhDataLabelsAlign Align_DefaultValue { get; set; }
		...
		/// </summary>
		public MomentumSeriesIkhDataLabelsStyle Style { get; set; }
		private MomentumSeriesIkhDataLabelsStyle Style_DefaultValue { get; set; }
		...
		/// </summary>
		public MomentumSeriesIkhDataLabelsVerticalAlign VerticalAlign { get; set; }
		private MomentumSeriesIkhDataLabelsVerticalAlign VerticalAlign_DefaultValue { get; set; }
		...
		/// </summary>
		public MomentumSeriesIkhDataLabelsOverflow Overflow { get; set; }
		private MomentumSeriesIkhDataLabelsOverflow Overflow_DefaultValue { get; set; }
		...
		internal override Hashtable ToHashtable()
		{
			...
			if (Formatter != Formatter_DefaultValue) { h.Add("formatter",Formatter); Highstock.AddFunction("MomentumSeriesIkhDataLabelsFormatter.formatter", Formatter); }  
