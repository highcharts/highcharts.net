...
{
	public partial class MomentumSeriesIkhLabel  : BaseObject
	{
		public MomentumSeriesIkhLabel()
		{
			...
			Style = Style_DefaultValue = new MomentumSeriesIkhLabelStyle();
		...
		/// </summary>
		public MomentumSeriesIkhLabelStyle Style { get; set; }
		private MomentumSeriesIkhLabelStyle Style_DefaultValue { get; set; }
