...
{
	public partial class MomentumSeriesIkhMarker  : BaseObject
	{
		public MomentumSeriesIkhMarker()
		{
			LineWidth = LineWidth_DefaultValue = 0;
			LineColor = LineColor_DefaultValue = "#ffffff";
			Radius = Radius_DefaultValue = 4;
			States = States_DefaultValue = new MomentumSeriesIkhMarkerStates();
		...
		/// </summary>
		public MomentumSeriesIkhMarkerStates States { get; set; }
		private MomentumSeriesIkhMarkerStates States_DefaultValue { get; set; }
