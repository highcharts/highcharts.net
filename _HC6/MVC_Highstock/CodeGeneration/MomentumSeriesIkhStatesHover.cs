...
{
	public partial class MomentumSeriesIkhStatesHover  : BaseObject
	{
		public MomentumSeriesIkhStatesHover()
		{
			LineWidthPlus = LineWidthPlus_DefaultValue = 1;
			Marker = Marker_DefaultValue = new MomentumSeriesIkhStatesHoverMarker();
			Halo = Halo_DefaultValue = new MomentumSeriesIkhStatesHoverHalo();
		...
		/// </summary>
		public MomentumSeriesIkhStatesHoverMarker Marker { get; set; }
		private MomentumSeriesIkhStatesHoverMarker Marker_DefaultValue { get; set; }
		...
		/// </summary>
		public MomentumSeriesIkhStatesHoverHalo Halo { get; set; }
		private MomentumSeriesIkhStatesHoverHalo Halo_DefaultValue { get; set; }
