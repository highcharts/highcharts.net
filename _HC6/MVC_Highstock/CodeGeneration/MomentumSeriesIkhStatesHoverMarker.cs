...
{
	public partial class MomentumSeriesIkhStatesHoverMarker  : BaseObject
	{
		public MomentumSeriesIkhStatesHoverMarker()
		{
			LineWidth = LineWidth_DefaultValue = 0;
			LineColor = LineColor_DefaultValue = "#ffffff";
			Radius = Radius_DefaultValue = 4;
			States = States_DefaultValue = new MomentumSeriesIkhStatesHoverMarkerStates();
		...
		/// </summary>
		public MomentumSeriesIkhStatesHoverMarkerStates States { get; set; }
		private MomentumSeriesIkhStatesHoverMarkerStates States_DefaultValue { get; set; }
