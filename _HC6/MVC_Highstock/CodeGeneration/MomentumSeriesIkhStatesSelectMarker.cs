...
{
	public partial class MomentumSeriesIkhStatesSelectMarker  : BaseObject
	{
		public MomentumSeriesIkhStatesSelectMarker()
		{
			LineWidth = LineWidth_DefaultValue = 0;
			LineColor = LineColor_DefaultValue = "#ffffff";
			Radius = Radius_DefaultValue = 4;
			States = States_DefaultValue = new MomentumSeriesIkhStatesSelectMarkerStates();
		...
		/// </summary>
		public MomentumSeriesIkhStatesSelectMarkerStates States { get; set; }
		private MomentumSeriesIkhStatesSelectMarkerStates States_DefaultValue { get; set; }
