...
{
	public partial class MomentumSeriesIkhTooltip  : BaseObject
	{
		public MomentumSeriesIkhTooltip()
		{
			ValueDecimals = ValueDecimals_DefaultValue = null;
			DateTimeLabelFormats = DateTimeLabelFormats_DefaultValue = new MomentumSeriesIkhTooltipDateTimeLabelFormats();
		...
		/// </summary>
		public MomentumSeriesIkhTooltipDateTimeLabelFormats DateTimeLabelFormats { get; set; }
		private MomentumSeriesIkhTooltipDateTimeLabelFormats DateTimeLabelFormats_DefaultValue { get; set; }
		...
		internal override Hashtable ToHashtable()
		{
			...
			if (PointFormatter != PointFormatter_DefaultValue) { h.Add("pointFormatter",PointFormatter); Highstock.AddFunction("MomentumSeriesIkhTooltipPointFormatter.pointFormatter", PointFormatter); }  
