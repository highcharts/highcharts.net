...
{
	public partial class MomentumSeriesStatesSelectMarker  : BaseObject
	{
		public MomentumSeriesStatesSelectMarker()
		{
			LineWidth = LineWidth_DefaultValue = 0;
			LineColor = LineColor_DefaultValue = "#ffffff";
			Radius = Radius_DefaultValue = 4;
			States = States_DefaultValue = new MomentumSeriesStatesSelectMarkerStates();
		...
		/// </summary>
		public MomentumSeriesStatesSelectMarkerStates States { get; set; }
		private MomentumSeriesStatesSelectMarkerStates States_DefaultValue { get; set; }
