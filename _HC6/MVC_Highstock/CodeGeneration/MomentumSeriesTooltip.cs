...
namespace Highsoft.Web.Mvc.Stocks
{
	public partial class MomentumSeriesTooltip  : BaseObject
	{
		public MomentumSeriesTooltip()
		{
			...
			DateTimeLabelFormats = DateTimeLabelFormats_DefaultValue = new MomentumSeriesTooltipDateTimeLabelFormats();
		...
		/// </summary>
		public MomentumSeriesTooltipDateTimeLabelFormats DateTimeLabelFormats { get; set; }
		private MomentumSeriesTooltipDateTimeLabelFormats DateTimeLabelFormats_DefaultValue { get; set; }
