...
{
	public partial class NavigatorSeriesDataGrouping  : BaseObject
	{
		public NavigatorSeriesDataGrouping()
		{
			...
			GroupPixelWidth = GroupPixelWidth_DefaultValue = null;
			Smoothed = Smoothed_DefaultValue = null;
		...
		/// </summary>
		public NavigatorSeriesDataGroupingApproximation Approximation { get; set; }
		private NavigatorSeriesDataGroupingApproximation Approximation_DefaultValue { get; set; }
