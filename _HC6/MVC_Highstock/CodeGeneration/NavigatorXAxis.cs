...
namespace Highsoft.Web.Mvc.Stocks
{
	public partial class NavigatorXAxis  : BaseObject
	{
		...
		/// <summary>
		/// <p>Additional range on the right side of the xAxis. Works similar toxAxis.maxPadding, but value is set in milliseconds.Can be set for both, main xAxis and navigator&#39;s xAxis.</p>
		/// </summary>
		...
		/// </summary>
		public NavigatorXAxisPlotBands PlotBands { get; set; }
		private NavigatorXAxisPlotBands PlotBands_DefaultValue { get; set; }
		...
		/// </summary>
		public NavigatorXAxisPlotLines PlotLines { get; set; }
		private NavigatorXAxisPlotLines PlotLines_DefaultValue { get; set; }
