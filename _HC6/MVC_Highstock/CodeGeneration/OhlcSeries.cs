...
namespace Highsoft.Web.Mvc.Stocks
{
	public partial class OhlcSeries  : Series
	{
		public OhlcSeries()
		{
			...
			NavigatorOptions = NavigatorOptions_DefaultValue = new OhlcSeriesNavigatorOptions();
		...
		/// </summary>
		public OhlcSeriesNavigatorOptions NavigatorOptions { get; set; }
		private OhlcSeriesNavigatorOptions NavigatorOptions_DefaultValue { get; set; }
