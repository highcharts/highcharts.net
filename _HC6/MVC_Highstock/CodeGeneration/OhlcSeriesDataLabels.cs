...
namespace Highsoft.Web.Mvc.Stocks
{
	public partial class OhlcSeriesDataLabels  : BaseObject
	{
		public OhlcSeriesDataLabels()
		{
			...
			Style = Style_DefaultValue = new OhlcSeriesDataLabelsStyle();
		...
		/// </summary>
		public OhlcSeriesDataLabelsStyle Style { get; set; }
		private OhlcSeriesDataLabelsStyle Style_DefaultValue { get; set; }
