...
{
	public partial class OhlcSeriesIkhDataGrouping  : BaseObject
	{
		public OhlcSeriesIkhDataGrouping()
		{
			Approximation = Approximation_DefaultValue = OhlcSeriesIkhDataGroupingApproximation.Average;
		...
		/// </summary>
		public OhlcSeriesIkhDataGroupingApproximation Approximation { get; set; }
		private OhlcSeriesIkhDataGroupingApproximation Approximation_DefaultValue { get; set; }
