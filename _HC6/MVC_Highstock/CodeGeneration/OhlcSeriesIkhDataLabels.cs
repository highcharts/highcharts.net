...
{
	public partial class OhlcSeriesIkhDataLabels  : BaseObject
	{
		public OhlcSeriesIkhDataLabels()
		{
			Align = Align_DefaultValue = OhlcSeriesIkhDataLabelsAlign.Center;
			Formatter = Formatter_DefaultValue = "";
			Style = Style_DefaultValue = new OhlcSeriesIkhDataLabelsStyle();
			VerticalAlign = VerticalAlign_DefaultValue = OhlcSeriesIkhDataLabelsVerticalAlign.Bottom;
			X = X_DefaultValue = 0;
			Y = Y_DefaultValue = -6;
			...
			Overflow = Overflow_DefaultValue = OhlcSeriesIkhDataLabelsOverflow.Justify;
		...
		/// </summary>
		public OhlcSeriesIkhDataLabelsAlign Align { get; set; }
		private OhlcSeriesIkhDataLabelsAlign Align_DefaultValue { get; set; }
		...
		/// </summary>
		public OhlcSeriesIkhDataLabelsStyle Style { get; set; }
		private OhlcSeriesIkhDataLabelsStyle Style_DefaultValue { get; set; }
		...
		/// </summary>
		public OhlcSeriesIkhDataLabelsVerticalAlign VerticalAlign { get; set; }
		private OhlcSeriesIkhDataLabelsVerticalAlign VerticalAlign_DefaultValue { get; set; }
		...
		/// </summary>
		public OhlcSeriesIkhDataLabelsOverflow Overflow { get; set; }
		private OhlcSeriesIkhDataLabelsOverflow Overflow_DefaultValue { get; set; }
		...
		internal override Hashtable ToHashtable()
		{
			...
			if (Formatter != Formatter_DefaultValue) { h.Add("formatter",Formatter); Highstock.AddFunction("OhlcSeriesIkhDataLabelsFormatter.formatter", Formatter); }  
