...
{
	public partial class OhlcSeriesIkhStatesHover  : BaseObject
	{
		public OhlcSeriesIkhStatesHover()
		{
			LineWidthPlus = LineWidthPlus_DefaultValue = 1;
			Marker = Marker_DefaultValue = new OhlcSeriesIkhStatesHoverMarker();
			Halo = Halo_DefaultValue = new OhlcSeriesIkhStatesHoverHalo();
		...
		/// </summary>
		public OhlcSeriesIkhStatesHoverMarker Marker { get; set; }
		private OhlcSeriesIkhStatesHoverMarker Marker_DefaultValue { get; set; }
		...
		/// </summary>
		public OhlcSeriesIkhStatesHoverHalo Halo { get; set; }
		private OhlcSeriesIkhStatesHoverHalo Halo_DefaultValue { get; set; }
