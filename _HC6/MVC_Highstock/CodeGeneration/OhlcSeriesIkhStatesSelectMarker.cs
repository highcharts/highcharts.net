...
{
	public partial class OhlcSeriesIkhStatesSelectMarker  : BaseObject
	{
		public OhlcSeriesIkhStatesSelectMarker()
		{
			LineWidth = LineWidth_DefaultValue = 0;
			LineColor = LineColor_DefaultValue = "#ffffff";
			Radius = Radius_DefaultValue = 4;
			States = States_DefaultValue = new OhlcSeriesIkhStatesSelectMarkerStates();
		...
		/// </summary>
		public OhlcSeriesIkhStatesSelectMarkerStates States { get; set; }
		private OhlcSeriesIkhStatesSelectMarkerStates States_DefaultValue { get; set; }
