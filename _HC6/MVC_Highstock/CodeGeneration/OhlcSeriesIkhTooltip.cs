...
{
	public partial class OhlcSeriesIkhTooltip  : BaseObject
	{
		public OhlcSeriesIkhTooltip()
		{
			ValueDecimals = ValueDecimals_DefaultValue = null;
			DateTimeLabelFormats = DateTimeLabelFormats_DefaultValue = new OhlcSeriesIkhTooltipDateTimeLabelFormats();
		...
		/// </summary>
		public OhlcSeriesIkhTooltipDateTimeLabelFormats DateTimeLabelFormats { get; set; }
		private OhlcSeriesIkhTooltipDateTimeLabelFormats DateTimeLabelFormats_DefaultValue { get; set; }
		...
		internal override Hashtable ToHashtable()
		{
			...
			if (PointFormatter != PointFormatter_DefaultValue) { h.Add("pointFormatter",PointFormatter); Highstock.AddFunction("OhlcSeriesIkhTooltipPointFormatter.pointFormatter", PointFormatter); }  
