...
{
	public partial class OhlcSeriesMarkerStates  : BaseObject
	{
		public OhlcSeriesMarkerStates()
		{
			Hover = Hover_DefaultValue = new OhlcSeriesMarkerStatesHover();
			Select = Select_DefaultValue = new OhlcSeriesMarkerStatesSelect();
