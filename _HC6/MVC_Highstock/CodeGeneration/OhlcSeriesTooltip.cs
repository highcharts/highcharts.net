...
namespace Highsoft.Web.Mvc.Stocks
{
	public partial class OhlcSeriesTooltip  : BaseObject
	{
		public OhlcSeriesTooltip()
		{
			...
			DateTimeLabelFormats = DateTimeLabelFormats_DefaultValue = new OhlcSeriesTooltipDateTimeLabelFormats();
		...
		/// </summary>
		public OhlcSeriesTooltipDateTimeLabelFormats DateTimeLabelFormats { get; set; }
		private OhlcSeriesTooltipDateTimeLabelFormats DateTimeLabelFormats_DefaultValue { get; set; }
