...
{
	public partial class ParetoSeriesDataGrouping  : BaseObject
	{
		public ParetoSeriesDataGrouping()
		{
			Approximation = Approximation_DefaultValue = ParetoSeriesDataGroupingApproximation.Average;
		...
		/// </summary>
		public ParetoSeriesDataGroupingApproximation Approximation { get; set; }
		private ParetoSeriesDataGroupingApproximation Approximation_DefaultValue { get; set; }
