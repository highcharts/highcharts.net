...
{
	public partial class ParetoSeriesIkh  : BaseObject
	{
		public ParetoSeriesIkh()
		{
			Name = Name_DefaultValue = "SMA (14)";
			Tooltip = Tooltip_DefaultValue = new ParetoSeriesIkhTooltip();
			LinkedTo = LinkedTo_DefaultValue = null;
			Params = Params_DefaultValue = new ParetoSeriesIkhParams();
			Linecap = Linecap_DefaultValue = ParetoSeriesIkhLinecap.Round;
			BoostThreshold = BoostThreshold_DefaultValue = 5000;
			GapSize = GapSize_DefaultValue = 0;
			GapUnit = GapUnit_DefaultValue = ParetoSeriesIkhGapUnit.Relative;
			Label = Label_DefaultValue = new ParetoSeriesIkhLabel();
			DataGrouping = DataGrouping_DefaultValue = new ParetoSeriesIkhDataGrouping();
			LineWidth = LineWidth_DefaultValue = 2;
			AllowPointSelect = AllowPointSelect_DefaultValue = false;
			ShowCheckbox = ShowCheckbox_DefaultValue = false;
			Animation = Animation_DefaultValue = new Animation() { Enabled = true };
			Events = Events_DefaultValue = new ParetoSeriesIkhEvents();
			Marker = Marker_DefaultValue = new ParetoSeriesIkhMarker();
			Point = Point_DefaultValue = new ParetoSeriesIkhPoint();
			DataLabels = DataLabels_DefaultValue = new ParetoSeriesIkhDataLabels();
			CropThreshold = CropThreshold_DefaultValue = 300;
			SoftThreshold = SoftThreshold_DefaultValue = true;
			States = States_DefaultValue = new ParetoSeriesIkhStates();
			StickyTracking = StickyTracking_DefaultValue = null;
			TurboThreshold = TurboThreshold_DefaultValue = 1000;
			FindNearestPointBy = FindNearestPointBy_DefaultValue = ParetoSeriesIkhFindNearestPointBy.X;
			AnimationLimit = AnimationLimit_DefaultValue = null;
			ClassName = ClassName_DefaultValue = null;
			Color = Color_DefaultValue = null;
			ColorIndex = ColorIndex_DefaultValue = null;
			ConnectNulls = ConnectNulls_DefaultValue = false;
			Cursor = Cursor_DefaultValue = ParetoSeriesIkhCursor.Null;
			DashStyle = DashStyle_DefaultValue = ParetoSeriesIkhDashStyle.Solid;
			...
			Step = Step_DefaultValue = ParetoSeriesIkhStep.Null;
			Threshold = Threshold_DefaultValue = 0;
			Visible = Visible_DefaultValue = true;
			ZoneAxis = ZoneAxis_DefaultValue = "y";
			Zones = Zones_DefaultValue = new List<ParetoSeriesIkhZone>();
			...
			PointIntervalUnit = PointIntervalUnit_DefaultValue = ParetoSeriesIkhPointIntervalUnit.Null;
			PointPlacement = PointPlacement_DefaultValue = new PointPlacement();
			PointStart = PointStart_DefaultValue = 0;
			Stacking = Stacking_DefaultValue = ParetoSeriesIkhStacking.Null;
			Compare = Compare_DefaultValue = "undefined";
			CompareBase = CompareBase_DefaultValue = ParetoSeriesIkhCompareBase.Min;
		...
		/// </summary>
		public ParetoSeriesIkhTooltip Tooltip { get; set; }
		private ParetoSeriesIkhTooltip Tooltip_DefaultValue { get; set; }
		...
		/// 
		/// </summary>
		public ParetoSeriesIkhParams Params { get; set; }
		private ParetoSeriesIkhParams Params_DefaultValue { get; set; }
		...
		/// </summary>
		public ParetoSeriesIkhLinecap Linecap { get; set; }
		private ParetoSeriesIkhLinecap Linecap_DefaultValue { get; set; }
		...
		/// </summary>
		public ParetoSeriesIkhGapUnit GapUnit { get; set; }
		private ParetoSeriesIkhGapUnit GapUnit_DefaultValue { get; set; }
		...
		/// </summary>
		public ParetoSeriesIkhLabel Label { get; set; }
		private ParetoSeriesIkhLabel Label_DefaultValue { get; set; }
		...
		/// </summary>
		public ParetoSeriesIkhDataGrouping DataGrouping { get; set; }
		private ParetoSeriesIkhDataGrouping DataGrouping_DefaultValue { get; set; }
		...
		/// </summary>
		public ParetoSeriesIkhEvents Events { get; set; }
		private ParetoSeriesIkhEvents Events_DefaultValue { get; set; }
		...
		/// </summary>
		public ParetoSeriesIkhMarker Marker { get; set; }
		private ParetoSeriesIkhMarker Marker_DefaultValue { get; set; }
		 

		/// <summary>
		/// <p>Properties for each single point.</p>
		/// </summary>
		public ParetoSeriesIkhPoint Point { get; set; }
		private ParetoSeriesIkhPoint Point_DefaultValue { get; set; }
		...
		/// </summary>
		public ParetoSeriesIkhDataLabels DataLabels { get; set; }
		private ParetoSeriesIkhDataLabels DataLabels_DefaultValue { get; set; }
		...
		/// </summary>
		public ParetoSeriesIkhStates States { get; set; }
		private ParetoSeriesIkhStates States_DefaultValue { get; set; }
		...
		/// </summary>
		public ParetoSeriesIkhFindNearestPointBy FindNearestPointBy { get; set; }
		private ParetoSeriesIkhFindNearestPointBy FindNearestPointBy_DefaultValue { get; set; }
		...
		/// </summary>
		public ParetoSeriesIkhCursor Cursor { get; set; }
		private ParetoSeriesIkhCursor Cursor_DefaultValue { get; set; }
		...
		/// </summary>
		public ParetoSeriesIkhDashStyle DashStyle { get; set; }
		private ParetoSeriesIkhDashStyle DashStyle_DefaultValue { get; set; }
		...
		/// </summary>
		public ParetoSeriesIkhStep Step { get; set; }
		private ParetoSeriesIkhStep Step_DefaultValue { get; set; }
		...
		/// </summary>
		public List<ParetoSeriesIkhZone> Zones { get; set; }
		private List<ParetoSeriesIkhZone> Zones_DefaultValue { get; set; }
		...
		/// </summary>
		public ParetoSeriesIkhPointIntervalUnit PointIntervalUnit { get; set; }
		private ParetoSeriesIkhPointIntervalUnit PointIntervalUnit_DefaultValue { get; set; }
		...
		/// </summary>
		public ParetoSeriesIkhStacking Stacking { get; set; }
		private ParetoSeriesIkhStacking Stacking_DefaultValue { get; set; }
		...
		/// </summary>
		public ParetoSeriesIkhCompareBase CompareBase { get; set; }
		private ParetoSeriesIkhCompareBase CompareBase_DefaultValue { get; set; }
		...
		internal override Hashtable ToHashtable()
		{
			...
			if (PointDescriptionFormatter != PointDescriptionFormatter_DefaultValue) { h.Add("pointDescriptionFormatter",PointDescriptionFormatter); Highstock.AddFunction("ParetoSeriesIkhPointDescriptionFormatter.pointDescriptionFormatter", PointDescriptionFormatter); }  
