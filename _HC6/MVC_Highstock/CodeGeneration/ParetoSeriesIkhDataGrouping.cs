...
{
	public partial class ParetoSeriesIkhDataGrouping  : BaseObject
	{
		...
		/// </summary>
		public ParetoSeriesIkhDataGroupingApproximation Approximation { get; set; }
		private ParetoSeriesIkhDataGroupingApproximation Approximation_DefaultValue { get; set; }
