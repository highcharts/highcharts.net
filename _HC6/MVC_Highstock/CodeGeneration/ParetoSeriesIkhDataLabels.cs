...
{
	public partial class ParetoSeriesIkhDataLabels  : BaseObject
	{
		public ParetoSeriesIkhDataLabels()
		{
			Align = Align_DefaultValue = ParetoSeriesIkhDataLabelsAlign.Center;
			Formatter = Formatter_DefaultValue = "";
			Style = Style_DefaultValue = new ParetoSeriesIkhDataLabelsStyle();
			VerticalAlign = VerticalAlign_DefaultValue = ParetoSeriesIkhDataLabelsVerticalAlign.Bottom;
			X = X_DefaultValue = 0;
			Y = Y_DefaultValue = -6;
			...
			Overflow = Overflow_DefaultValue = ParetoSeriesIkhDataLabelsOverflow.Justify;
		...
		/// </summary>
		public ParetoSeriesIkhDataLabelsAlign Align { get; set; }
		private ParetoSeriesIkhDataLabelsAlign Align_DefaultValue { get; set; }
		...
		/// </summary>
		public ParetoSeriesIkhDataLabelsStyle Style { get; set; }
		private ParetoSeriesIkhDataLabelsStyle Style_DefaultValue { get; set; }
		...
		/// </summary>
		public ParetoSeriesIkhDataLabelsVerticalAlign VerticalAlign { get; set; }
		private ParetoSeriesIkhDataLabelsVerticalAlign VerticalAlign_DefaultValue { get; set; }
		...
		/// </summary>
		public ParetoSeriesIkhDataLabelsOverflow Overflow { get; set; }
		private ParetoSeriesIkhDataLabelsOverflow Overflow_DefaultValue { get; set; }
		...
		internal override Hashtable ToHashtable()
		{
			...
			if (Formatter != Formatter_DefaultValue) { h.Add("formatter",Formatter); Highstock.AddFunction("ParetoSeriesIkhDataLabelsFormatter.formatter", Formatter); }  
