...
{
	public partial class ParetoSeriesIkhStatesHover  : BaseObject
	{
		public ParetoSeriesIkhStatesHover()
		{
			LineWidthPlus = LineWidthPlus_DefaultValue = 1;
			Marker = Marker_DefaultValue = new ParetoSeriesIkhStatesHoverMarker();
			Halo = Halo_DefaultValue = new ParetoSeriesIkhStatesHoverHalo();
		...
		/// </summary>
		public ParetoSeriesIkhStatesHoverMarker Marker { get; set; }
		private ParetoSeriesIkhStatesHoverMarker Marker_DefaultValue { get; set; }
		...
		/// </summary>
		public ParetoSeriesIkhStatesHoverHalo Halo { get; set; }
		private ParetoSeriesIkhStatesHoverHalo Halo_DefaultValue { get; set; }
