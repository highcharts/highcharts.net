...
{
	public partial class ParetoSeriesIkhTooltip  : BaseObject
	{
		public ParetoSeriesIkhTooltip()
		{
			ValueDecimals = ValueDecimals_DefaultValue = null;
			DateTimeLabelFormats = DateTimeLabelFormats_DefaultValue = new ParetoSeriesIkhTooltipDateTimeLabelFormats();
		...
		/// </summary>
		public ParetoSeriesIkhTooltipDateTimeLabelFormats DateTimeLabelFormats { get; set; }
		private ParetoSeriesIkhTooltipDateTimeLabelFormats DateTimeLabelFormats_DefaultValue { get; set; }
		...
		internal override Hashtable ToHashtable()
		{
			...
			if (PointFormatter != PointFormatter_DefaultValue) { h.Add("pointFormatter",PointFormatter); Highstock.AddFunction("ParetoSeriesIkhTooltipPointFormatter.pointFormatter", PointFormatter); }  
