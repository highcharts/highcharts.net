...
{
	public partial class PieSeriesDataGrouping  : BaseObject
	{
		public PieSeriesDataGrouping()
		{
			Approximation = Approximation_DefaultValue = PieSeriesDataGroupingApproximation.Average;
		...
		/// </summary>
		public PieSeriesDataGroupingApproximation Approximation { get; set; }
		private PieSeriesDataGroupingApproximation Approximation_DefaultValue { get; set; }
