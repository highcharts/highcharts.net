...
{
	public partial class PieSeriesIkhDataGrouping  : BaseObject
	{
		public PieSeriesIkhDataGrouping()
		{
			Approximation = Approximation_DefaultValue = PieSeriesIkhDataGroupingApproximation.Average;
		...
		/// </summary>
		public PieSeriesIkhDataGroupingApproximation Approximation { get; set; }
		private PieSeriesIkhDataGroupingApproximation Approximation_DefaultValue { get; set; }
