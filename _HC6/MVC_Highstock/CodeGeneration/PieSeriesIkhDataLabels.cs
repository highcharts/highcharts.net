...
{
	public partial class PieSeriesIkhDataLabels  : BaseObject
	{
		public PieSeriesIkhDataLabels()
		{
			Align = Align_DefaultValue = PieSeriesIkhDataLabelsAlign.Center;
			Formatter = Formatter_DefaultValue = "";
			Style = Style_DefaultValue = new PieSeriesIkhDataLabelsStyle();
			VerticalAlign = VerticalAlign_DefaultValue = PieSeriesIkhDataLabelsVerticalAlign.Bottom;
			X = X_DefaultValue = 0;
			Y = Y_DefaultValue = -6;
			...
			Overflow = Overflow_DefaultValue = PieSeriesIkhDataLabelsOverflow.Justify;
		...
		/// </summary>
		public PieSeriesIkhDataLabelsAlign Align { get; set; }
		private PieSeriesIkhDataLabelsAlign Align_DefaultValue { get; set; }
		...
		/// </summary>
		public PieSeriesIkhDataLabelsStyle Style { get; set; }
		private PieSeriesIkhDataLabelsStyle Style_DefaultValue { get; set; }
		...
		/// </summary>
		public PieSeriesIkhDataLabelsVerticalAlign VerticalAlign { get; set; }
		private PieSeriesIkhDataLabelsVerticalAlign VerticalAlign_DefaultValue { get; set; }
		...
		/// </summary>
		public PieSeriesIkhDataLabelsOverflow Overflow { get; set; }
		private PieSeriesIkhDataLabelsOverflow Overflow_DefaultValue { get; set; }
		...
		internal override Hashtable ToHashtable()
		{
			...
			if (Formatter != Formatter_DefaultValue) { h.Add("formatter",Formatter); Highstock.AddFunction("PieSeriesIkhDataLabelsFormatter.formatter", Formatter); }  
