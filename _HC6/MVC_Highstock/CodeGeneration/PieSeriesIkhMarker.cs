...
{
	public partial class PieSeriesIkhMarker  : BaseObject
	{
		public PieSeriesIkhMarker()
		{
			LineWidth = LineWidth_DefaultValue = 0;
			LineColor = LineColor_DefaultValue = "#ffffff";
			Radius = Radius_DefaultValue = 4;
			States = States_DefaultValue = new PieSeriesIkhMarkerStates();
		...
		/// </summary>
		public PieSeriesIkhMarkerStates States { get; set; }
		private PieSeriesIkhMarkerStates States_DefaultValue { get; set; }
