...
{
	public partial class PieSeriesIkhStatesHover  : BaseObject
	{
		public PieSeriesIkhStatesHover()
		{
			LineWidthPlus = LineWidthPlus_DefaultValue = 1;
			Marker = Marker_DefaultValue = new PieSeriesIkhStatesHoverMarker();
			Halo = Halo_DefaultValue = new PieSeriesIkhStatesHoverHalo();
		...
		/// </summary>
		public PieSeriesIkhStatesHoverMarker Marker { get; set; }
		private PieSeriesIkhStatesHoverMarker Marker_DefaultValue { get; set; }
		...
		/// </summary>
		public PieSeriesIkhStatesHoverHalo Halo { get; set; }
		private PieSeriesIkhStatesHoverHalo Halo_DefaultValue { get; set; }
