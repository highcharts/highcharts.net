...
{
	public partial class PieSeriesIkhStatesSelectMarker  : BaseObject
	{
		public PieSeriesIkhStatesSelectMarker()
		{
			LineWidth = LineWidth_DefaultValue = 0;
			LineColor = LineColor_DefaultValue = "#ffffff";
			Radius = Radius_DefaultValue = 4;
			States = States_DefaultValue = new PieSeriesIkhStatesSelectMarkerStates();
		...
		/// </summary>
		public PieSeriesIkhStatesSelectMarkerStates States { get; set; }
		private PieSeriesIkhStatesSelectMarkerStates States_DefaultValue { get; set; }
