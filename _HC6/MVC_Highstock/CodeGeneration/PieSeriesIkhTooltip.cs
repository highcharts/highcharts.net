...
{
	public partial class PieSeriesIkhTooltip  : BaseObject
	{
		public PieSeriesIkhTooltip()
		{
			ValueDecimals = ValueDecimals_DefaultValue = null;
			DateTimeLabelFormats = DateTimeLabelFormats_DefaultValue = new PieSeriesIkhTooltipDateTimeLabelFormats();
		...
		/// </summary>
		public PieSeriesIkhTooltipDateTimeLabelFormats DateTimeLabelFormats { get; set; }
		private PieSeriesIkhTooltipDateTimeLabelFormats DateTimeLabelFormats_DefaultValue { get; set; }
		...
		internal override Hashtable ToHashtable()
		{
			...
			if (PointFormatter != PointFormatter_DefaultValue) { h.Add("pointFormatter",PointFormatter); Highstock.AddFunction("PieSeriesIkhTooltipPointFormatter.pointFormatter", PointFormatter); }  
