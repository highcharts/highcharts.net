...
{
	public partial class PieSeriesMarker  : BaseObject
	{
		public PieSeriesMarker()
		{
			LineWidth = LineWidth_DefaultValue = 0;
			LineColor = LineColor_DefaultValue = "#ffffff";
			Radius = Radius_DefaultValue = 4;
			States = States_DefaultValue = new PieSeriesMarkerStates();
		...
		/// </summary>
		public PieSeriesMarkerStates States { get; set; }
		private PieSeriesMarkerStates States_DefaultValue { get; set; }
