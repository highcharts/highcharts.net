...
namespace Highsoft.Web.Mvc.Stocks
{
	public partial class PivotpointsSeries  : Series
	{
		...
		{
			Ikh = Ikh_DefaultValue = new PivotpointsSeriesIkh();
			Id = Id_DefaultValue = null;
			Index = Index_DefaultValue = null;
			LegendIndex = LegendIndex_DefaultValue = null;
			Name = Name_DefaultValue = "Pivot Points (28)";
			...
			EnableMouseTracking = EnableMouseTracking_DefaultValue = null;
			...
			PointIntervalUnit = PointIntervalUnit_DefaultValue = PivotpointsSeriesPointIntervalUnit.Null;
			PointPlacement = PointPlacement_DefaultValue = new PointPlacement();
			PointStart = PointStart_DefaultValue = 0;
			Stacking = Stacking_DefaultValue = PivotpointsSeriesStacking.Null;
		...
		/// </summary>
		public PivotpointsSeriesIkh Ikh { get; set; }
		private PivotpointsSeriesIkh Ikh_DefaultValue { get; set; }
		...
		/// </summary>
		public PivotpointsSeriesPointIntervalUnit PointIntervalUnit { get; set; }
		private PivotpointsSeriesPointIntervalUnit PointIntervalUnit_DefaultValue { get; set; }
		...
		/// </summary>
		public PivotpointsSeriesStacking Stacking { get; set; }
		private PivotpointsSeriesStacking Stacking_DefaultValue { get; set; }
