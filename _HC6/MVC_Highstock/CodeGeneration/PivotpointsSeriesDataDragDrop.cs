...
{
	public partial class PivotpointsSeriesDataDragDrop  : BaseObject
	{
		public PivotpointsSeriesDataDragDrop()
		{
			DraggableX = DraggableX_DefaultValue = null;
			DraggableY = DraggableY_DefaultValue = null;
			DragHandle = DragHandle_DefaultValue = new PivotpointsSeriesDataDragDropDragHandle();
			...
			GuideBox = GuideBox_DefaultValue = new PivotpointsSeriesDataDragDropGuideBox();
		...
		/// </summary>
		public PivotpointsSeriesDataDragDropDragHandle DragHandle { get; set; }
		private PivotpointsSeriesDataDragDropDragHandle DragHandle_DefaultValue { get; set; }
		...
		/// </summary>
		public PivotpointsSeriesDataDragDropGuideBox GuideBox { get; set; }
		private PivotpointsSeriesDataDragDropGuideBox GuideBox_DefaultValue { get; set; }
