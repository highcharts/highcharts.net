...
{
	public partial class PivotpointsSeriesDataGrouping  : BaseObject
	{
		...
		/// </summary>
		public PivotpointsSeriesDataGroupingApproximation Approximation { get; set; }
		private PivotpointsSeriesDataGroupingApproximation Approximation_DefaultValue { get; set; }
		...
		/// </summary>
		public PivotpointsSeriesDataGroupingUnits Units { get; set; }
		private PivotpointsSeriesDataGroupingUnits Units_DefaultValue { get; set; }
