...
namespace Highsoft.Web.Mvc.Stocks
{
	public partial class PivotpointsSeriesDataLabels  : BaseObject
	{
		public PivotpointsSeriesDataLabels()
		{
			...
			Style = Style_DefaultValue = new PivotpointsSeriesDataLabelsStyle();
		...
		/// </summary>
		public PivotpointsSeriesDataLabelsStyle Style { get; set; }
		private PivotpointsSeriesDataLabelsStyle Style_DefaultValue { get; set; }
