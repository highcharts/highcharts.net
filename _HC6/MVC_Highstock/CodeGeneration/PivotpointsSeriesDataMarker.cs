...
{
	public partial class PivotpointsSeriesDataMarker  : BaseObject
	{
		public PivotpointsSeriesDataMarker()
		{
			LineWidth = LineWidth_DefaultValue = 0;
			LineColor = LineColor_DefaultValue = "#ffffff";
			Radius = Radius_DefaultValue = 4;
			States = States_DefaultValue = new PivotpointsSeriesDataMarkerStates();
		...
		/// </summary>
		public PivotpointsSeriesDataMarkerStates States { get; set; }
		private PivotpointsSeriesDataMarkerStates States_DefaultValue { get; set; }
