...
{
	public partial class PivotpointsSeriesDragDrop  : BaseObject
	{
		public PivotpointsSeriesDragDrop()
		{
			DraggableX = DraggableX_DefaultValue = null;
			DraggableY = DraggableY_DefaultValue = null;
			DragHandle = DragHandle_DefaultValue = new PivotpointsSeriesDragDropDragHandle();
			...
			GuideBox = GuideBox_DefaultValue = new PivotpointsSeriesDragDropGuideBox();
		...
		/// </summary>
		public PivotpointsSeriesDragDropDragHandle DragHandle { get; set; }
		private PivotpointsSeriesDragDropDragHandle DragHandle_DefaultValue { get; set; }
		...
		/// </summary>
		public PivotpointsSeriesDragDropGuideBox GuideBox { get; set; }
		private PivotpointsSeriesDragDropGuideBox GuideBox_DefaultValue { get; set; }
