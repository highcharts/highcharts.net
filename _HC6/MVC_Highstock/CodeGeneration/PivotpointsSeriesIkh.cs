...
{
	public partial class PivotpointsSeriesIkh  : BaseObject
	{
		public PivotpointsSeriesIkh()
		{
			Name = Name_DefaultValue = "SMA (14)";
			Tooltip = Tooltip_DefaultValue = new PivotpointsSeriesIkhTooltip();
			LinkedTo = LinkedTo_DefaultValue = null;
			Params = Params_DefaultValue = new PivotpointsSeriesIkhParams();
			Linecap = Linecap_DefaultValue = PivotpointsSeriesIkhLinecap.Round;
			BoostThreshold = BoostThreshold_DefaultValue = 5000;
			GapSize = GapSize_DefaultValue = 0;
			GapUnit = GapUnit_DefaultValue = PivotpointsSeriesIkhGapUnit.Relative;
			Label = Label_DefaultValue = new PivotpointsSeriesIkhLabel();
			DataGrouping = DataGrouping_DefaultValue = new PivotpointsSeriesIkhDataGrouping();
			LineWidth = LineWidth_DefaultValue = 2;
			AllowPointSelect = AllowPointSelect_DefaultValue = false;
			ShowCheckbox = ShowCheckbox_DefaultValue = false;
			Animation = Animation_DefaultValue = new Animation() { Enabled = true };
			Events = Events_DefaultValue = new PivotpointsSeriesIkhEvents();
			Marker = Marker_DefaultValue = new PivotpointsSeriesIkhMarker();
			Point = Point_DefaultValue = new PivotpointsSeriesIkhPoint();
			DataLabels = DataLabels_DefaultValue = new PivotpointsSeriesIkhDataLabels();
			CropThreshold = CropThreshold_DefaultValue = 300;
			SoftThreshold = SoftThreshold_DefaultValue = true;
			States = States_DefaultValue = new PivotpointsSeriesIkhStates();
			StickyTracking = StickyTracking_DefaultValue = null;
			TurboThreshold = TurboThreshold_DefaultValue = 1000;
			FindNearestPointBy = FindNearestPointBy_DefaultValue = PivotpointsSeriesIkhFindNearestPointBy.X;
			AnimationLimit = AnimationLimit_DefaultValue = null;
			ClassName = ClassName_DefaultValue = null;
			Color = Color_DefaultValue = null;
			ColorIndex = ColorIndex_DefaultValue = null;
			ConnectNulls = ConnectNulls_DefaultValue = false;
			Cursor = Cursor_DefaultValue = PivotpointsSeriesIkhCursor.Null;
			DashStyle = DashStyle_DefaultValue = PivotpointsSeriesIkhDashStyle.Solid;
			...
			Step = Step_DefaultValue = PivotpointsSeriesIkhStep.Null;
			Threshold = Threshold_DefaultValue = 0;
			Visible = Visible_DefaultValue = true;
			ZoneAxis = ZoneAxis_DefaultValue = "y";
			Zones = Zones_DefaultValue = new List<PivotpointsSeriesIkhZone>();
			...
			PointIntervalUnit = PointIntervalUnit_DefaultValue = PivotpointsSeriesIkhPointIntervalUnit.Null;
			PointPlacement = PointPlacement_DefaultValue = new PointPlacement();
			PointStart = PointStart_DefaultValue = 0;
			Stacking = Stacking_DefaultValue = PivotpointsSeriesIkhStacking.Null;
			Compare = Compare_DefaultValue = "undefined";
			CompareBase = CompareBase_DefaultValue = PivotpointsSeriesIkhCompareBase.Min;
		...
		/// </summary>
		public PivotpointsSeriesIkhTooltip Tooltip { get; set; }
		private PivotpointsSeriesIkhTooltip Tooltip_DefaultValue { get; set; }
		...
		/// 
		/// </summary>
		public PivotpointsSeriesIkhParams Params { get; set; }
		private PivotpointsSeriesIkhParams Params_DefaultValue { get; set; }
		...
		/// </summary>
		public PivotpointsSeriesIkhLinecap Linecap { get; set; }
		private PivotpointsSeriesIkhLinecap Linecap_DefaultValue { get; set; }
		...
		/// </summary>
		public PivotpointsSeriesIkhGapUnit GapUnit { get; set; }
		private PivotpointsSeriesIkhGapUnit GapUnit_DefaultValue { get; set; }
		...
		/// </summary>
		public PivotpointsSeriesIkhLabel Label { get; set; }
		private PivotpointsSeriesIkhLabel Label_DefaultValue { get; set; }
		...
		/// </summary>
		public PivotpointsSeriesIkhDataGrouping DataGrouping { get; set; }
		private PivotpointsSeriesIkhDataGrouping DataGrouping_DefaultValue { get; set; }
		...
		/// </summary>
		public PivotpointsSeriesIkhEvents Events { get; set; }
		private PivotpointsSeriesIkhEvents Events_DefaultValue { get; set; }
		...
		/// </summary>
		public PivotpointsSeriesIkhMarker Marker { get; set; }
		private PivotpointsSeriesIkhMarker Marker_DefaultValue { get; set; }
		 

		/// <summary>
		/// <p>Properties for each single point.</p>
		/// </summary>
		public PivotpointsSeriesIkhPoint Point { get; set; }
		private PivotpointsSeriesIkhPoint Point_DefaultValue { get; set; }
		...
		/// </summary>
		public PivotpointsSeriesIkhDataLabels DataLabels { get; set; }
		private PivotpointsSeriesIkhDataLabels DataLabels_DefaultValue { get; set; }
		...
		/// </summary>
		public PivotpointsSeriesIkhStates States { get; set; }
		private PivotpointsSeriesIkhStates States_DefaultValue { get; set; }
		...
		/// </summary>
		public PivotpointsSeriesIkhFindNearestPointBy FindNearestPointBy { get; set; }
		private PivotpointsSeriesIkhFindNearestPointBy FindNearestPointBy_DefaultValue { get; set; }
		...
		/// </summary>
		public PivotpointsSeriesIkhCursor Cursor { get; set; }
		private PivotpointsSeriesIkhCursor Cursor_DefaultValue { get; set; }
		...
		/// </summary>
		public PivotpointsSeriesIkhDashStyle DashStyle { get; set; }
		private PivotpointsSeriesIkhDashStyle DashStyle_DefaultValue { get; set; }
		...
		/// </summary>
		public PivotpointsSeriesIkhStep Step { get; set; }
		private PivotpointsSeriesIkhStep Step_DefaultValue { get; set; }
		...
		/// </summary>
		public List<PivotpointsSeriesIkhZone> Zones { get; set; }
		private List<PivotpointsSeriesIkhZone> Zones_DefaultValue { get; set; }
		...
		/// </summary>
		public PivotpointsSeriesIkhPointIntervalUnit PointIntervalUnit { get; set; }
		private PivotpointsSeriesIkhPointIntervalUnit PointIntervalUnit_DefaultValue { get; set; }
		...
		/// </summary>
		public PivotpointsSeriesIkhStacking Stacking { get; set; }
		private PivotpointsSeriesIkhStacking Stacking_DefaultValue { get; set; }
		...
		/// </summary>
		public PivotpointsSeriesIkhCompareBase CompareBase { get; set; }
		private PivotpointsSeriesIkhCompareBase CompareBase_DefaultValue { get; set; }
		...
		internal override Hashtable ToHashtable()
		{
			...
			if (PointDescriptionFormatter != PointDescriptionFormatter_DefaultValue) { h.Add("pointDescriptionFormatter",PointDescriptionFormatter); Highstock.AddFunction("PivotpointsSeriesIkhPointDescriptionFormatter.pointDescriptionFormatter", PointDescriptionFormatter); }  
