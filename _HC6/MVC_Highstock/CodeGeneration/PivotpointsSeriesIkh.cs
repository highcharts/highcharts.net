...
namespace Highsoft.Web.Mvc.Stocks
{
	public partial class PivotpointsSeriesIkh  : BaseObject
	{
		public PivotpointsSeriesIkh()
		{
			...
			Zones = Zones_DefaultValue = new PivotpointsSeriesIkhZone();
		...
		/// </summary>
		public PivotpointsSeriesIkhZone Zones { get; set; }
		private PivotpointsSeriesIkhZone Zones_DefaultValue { get; set; }
