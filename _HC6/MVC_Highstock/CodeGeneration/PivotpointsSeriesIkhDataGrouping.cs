...
{
	public partial class PivotpointsSeriesIkhDataGrouping  : BaseObject
	{
		public PivotpointsSeriesIkhDataGrouping()
		{
			Approximation = Approximation_DefaultValue = PivotpointsSeriesIkhDataGroupingApproximation.Average;
		...
		/// </summary>
		public PivotpointsSeriesIkhDataGroupingApproximation Approximation { get; set; }
		private PivotpointsSeriesIkhDataGroupingApproximation Approximation_DefaultValue { get; set; }
