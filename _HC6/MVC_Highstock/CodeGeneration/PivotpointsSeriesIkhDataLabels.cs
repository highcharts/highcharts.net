...
{
	public partial class PivotpointsSeriesIkhDataLabels  : BaseObject
	{
		public PivotpointsSeriesIkhDataLabels()
		{
			Align = Align_DefaultValue = PivotpointsSeriesIkhDataLabelsAlign.Center;
			Formatter = Formatter_DefaultValue = "";
			Style = Style_DefaultValue = new PivotpointsSeriesIkhDataLabelsStyle();
			VerticalAlign = VerticalAlign_DefaultValue = PivotpointsSeriesIkhDataLabelsVerticalAlign.Bottom;
			X = X_DefaultValue = 0;
			Y = Y_DefaultValue = -6;
			...
			Overflow = Overflow_DefaultValue = PivotpointsSeriesIkhDataLabelsOverflow.Justify;
		...
		/// </summary>
		public PivotpointsSeriesIkhDataLabelsAlign Align { get; set; }
		private PivotpointsSeriesIkhDataLabelsAlign Align_DefaultValue { get; set; }
		...
		/// </summary>
		public PivotpointsSeriesIkhDataLabelsStyle Style { get; set; }
		private PivotpointsSeriesIkhDataLabelsStyle Style_DefaultValue { get; set; }
		...
		/// </summary>
		public PivotpointsSeriesIkhDataLabelsVerticalAlign VerticalAlign { get; set; }
		private PivotpointsSeriesIkhDataLabelsVerticalAlign VerticalAlign_DefaultValue { get; set; }
		...
		/// </summary>
		public PivotpointsSeriesIkhDataLabelsOverflow Overflow { get; set; }
		private PivotpointsSeriesIkhDataLabelsOverflow Overflow_DefaultValue { get; set; }
		...
		internal override Hashtable ToHashtable()
		{
			...
			if (Formatter != Formatter_DefaultValue) { h.Add("formatter",Formatter); Highstock.AddFunction("PivotpointsSeriesIkhDataLabelsFormatter.formatter", Formatter); }  
