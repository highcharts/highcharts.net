...
{
	public partial class PivotpointsSeriesIkhMarker  : BaseObject
	{
		public PivotpointsSeriesIkhMarker()
		{
			LineWidth = LineWidth_DefaultValue = 0;
			LineColor = LineColor_DefaultValue = "#ffffff";
			Radius = Radius_DefaultValue = 4;
			States = States_DefaultValue = new PivotpointsSeriesIkhMarkerStates();
		...
		/// </summary>
		public PivotpointsSeriesIkhMarkerStates States { get; set; }
		private PivotpointsSeriesIkhMarkerStates States_DefaultValue { get; set; }
