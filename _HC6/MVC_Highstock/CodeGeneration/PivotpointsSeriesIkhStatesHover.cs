...
{
	public partial class PivotpointsSeriesIkhStatesHover  : BaseObject
	{
		public PivotpointsSeriesIkhStatesHover()
		{
			LineWidthPlus = LineWidthPlus_DefaultValue = 1;
			Marker = Marker_DefaultValue = new PivotpointsSeriesIkhStatesHoverMarker();
			Halo = Halo_DefaultValue = new PivotpointsSeriesIkhStatesHoverHalo();
		...
		/// </summary>
		public PivotpointsSeriesIkhStatesHoverMarker Marker { get; set; }
		private PivotpointsSeriesIkhStatesHoverMarker Marker_DefaultValue { get; set; }
		...
		/// </summary>
		public PivotpointsSeriesIkhStatesHoverHalo Halo { get; set; }
		private PivotpointsSeriesIkhStatesHoverHalo Halo_DefaultValue { get; set; }
