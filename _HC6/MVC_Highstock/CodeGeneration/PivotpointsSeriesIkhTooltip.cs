...
{
	public partial class PivotpointsSeriesIkhTooltip  : BaseObject
	{
		public PivotpointsSeriesIkhTooltip()
		{
			ValueDecimals = ValueDecimals_DefaultValue = null;
			DateTimeLabelFormats = DateTimeLabelFormats_DefaultValue = new PivotpointsSeriesIkhTooltipDateTimeLabelFormats();
		...
		/// </summary>
		public PivotpointsSeriesIkhTooltipDateTimeLabelFormats DateTimeLabelFormats { get; set; }
		private PivotpointsSeriesIkhTooltipDateTimeLabelFormats DateTimeLabelFormats_DefaultValue { get; set; }
		...
		internal override Hashtable ToHashtable()
		{
			...
			if (PointFormatter != PointFormatter_DefaultValue) { h.Add("pointFormatter",PointFormatter); Highstock.AddFunction("PivotpointsSeriesIkhTooltipPointFormatter.pointFormatter", PointFormatter); }  
