...
{
	public partial class PivotpointsSeriesLabel  : BaseObject
	{
		public PivotpointsSeriesLabel()
		{
			...
			Style = Style_DefaultValue = new PivotpointsSeriesLabelStyle();
		...
		/// </summary>
		public PivotpointsSeriesLabelStyle Style { get; set; }
		private PivotpointsSeriesLabelStyle Style_DefaultValue { get; set; }
