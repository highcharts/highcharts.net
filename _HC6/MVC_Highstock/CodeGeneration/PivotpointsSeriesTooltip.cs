...
namespace Highsoft.Web.Mvc.Stocks
{
	public partial class PivotpointsSeriesTooltip  : BaseObject
	{
		public PivotpointsSeriesTooltip()
		{
			...
			DateTimeLabelFormats = DateTimeLabelFormats_DefaultValue = new PivotpointsSeriesTooltipDateTimeLabelFormats();
		...
		/// </summary>
		public PivotpointsSeriesTooltipDateTimeLabelFormats DateTimeLabelFormats { get; set; }
		private PivotpointsSeriesTooltipDateTimeLabelFormats DateTimeLabelFormats_DefaultValue { get; set; }
