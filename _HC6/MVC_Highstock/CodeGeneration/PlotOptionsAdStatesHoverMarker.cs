...
{
	public partial class PlotOptionsAdStatesHoverMarker  : BaseObject
	{
		public PlotOptionsAdStatesHoverMarker()
		{
			...
			States = States_DefaultValue = new PlotOptionsAdStatesHoverMarkerStates();
		...
		/// </summary>
		public PlotOptionsAdStatesHoverMarkerStates States { get; set; }
		private PlotOptionsAdStatesHoverMarkerStates States_DefaultValue { get; set; }
