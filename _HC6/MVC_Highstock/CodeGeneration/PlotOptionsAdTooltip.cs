...
namespace Highsoft.Web.Mvc.Stocks
{
	public partial class PlotOptionsAdTooltip  : BaseObject
	{
		public PlotOptionsAdTooltip()
		{
			...
			DateTimeLabelFormats = DateTimeLabelFormats_DefaultValue = new PlotOptionsAdTooltipDateTimeLabelFormats();
		...
		/// </summary>
		public PlotOptionsAdTooltipDateTimeLabelFormats DateTimeLabelFormats { get; set; }
		private PlotOptionsAdTooltipDateTimeLabelFormats DateTimeLabelFormats_DefaultValue { get; set; }
