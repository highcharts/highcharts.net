...
namespace Highsoft.Web.Mvc.Stocks
{
	public partial class PlotOptionsArearangeTooltip  : BaseObject
	{
		public PlotOptionsArearangeTooltip()
		{
			...
			DateTimeLabelFormats = DateTimeLabelFormats_DefaultValue = new PlotOptionsArearangeTooltipDateTimeLabelFormats();
		...
		/// </summary>
		public PlotOptionsArearangeTooltipDateTimeLabelFormats DateTimeLabelFormats { get; set; }
		private PlotOptionsArearangeTooltipDateTimeLabelFormats DateTimeLabelFormats_DefaultValue { get; set; }
		...
		internal override Hashtable ToHashtable()
		{
			...
			if (PointFormatter != PointFormatter_DefaultValue) { h.Add("pointFormatter",PointFormatter); Highstock.AddFunction("PlotOptionsArearangeTooltipPointFormatter.pointFormatter", PointFormatter); }  
