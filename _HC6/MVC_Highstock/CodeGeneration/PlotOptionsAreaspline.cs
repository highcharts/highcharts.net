...
namespace Highsoft.Web.Mvc.Stocks
{
	public partial class PlotOptionsAreaspline  : BaseObject
	{
		public PlotOptionsAreaspline()
		{
			...
			NavigatorOptions = NavigatorOptions_DefaultValue = new PlotOptionsAreasplineNavigatorOptions();
		...
		/// </summary>
		public PlotOptionsAreasplineNavigatorOptions NavigatorOptions { get; set; }
		private PlotOptionsAreasplineNavigatorOptions NavigatorOptions_DefaultValue { get; set; }
