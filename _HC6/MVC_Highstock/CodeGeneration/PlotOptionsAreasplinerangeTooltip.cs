...
namespace Highsoft.Web.Mvc.Stocks
{
	public partial class PlotOptionsAreasplinerangeTooltip  : BaseObject
	{
		public PlotOptionsAreasplinerangeTooltip()
		{
			...
			DateTimeLabelFormats = DateTimeLabelFormats_DefaultValue = new PlotOptionsAreasplinerangeTooltipDateTimeLabelFormats();
		...
		/// </summary>
		public PlotOptionsAreasplinerangeTooltipDateTimeLabelFormats DateTimeLabelFormats { get; set; }
		private PlotOptionsAreasplinerangeTooltipDateTimeLabelFormats DateTimeLabelFormats_DefaultValue { get; set; }
