...
{
	public partial class PlotOptionsBarDataGrouping  : BaseObject
	{
		public PlotOptionsBarDataGrouping()
		{
			GroupPixelWidth = GroupPixelWidth_DefaultValue = 10;
			Approximation = Approximation_DefaultValue = PlotOptionsBarDataGroupingApproximation.Average;
		...
		/// </summary>
		public PlotOptionsBarDataGroupingApproximation Approximation { get; set; }
		private PlotOptionsBarDataGroupingApproximation Approximation_DefaultValue { get; set; }
