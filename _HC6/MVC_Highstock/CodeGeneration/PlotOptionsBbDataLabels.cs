...
namespace Highsoft.Web.Mvc.Stocks
{
	public partial class PlotOptionsBbDataLabels  : BaseObject
	{
		public PlotOptionsBbDataLabels()
		{
			...
			Style = Style_DefaultValue = new PlotOptionsBbDataLabelsStyle();
		...
		/// </summary>
		public PlotOptionsBbDataLabelsStyle Style { get; set; }
		private PlotOptionsBbDataLabelsStyle Style_DefaultValue { get; set; }
