...
{
	public partial class PlotOptionsBbTooltip  : BaseObject
	{
		public PlotOptionsBbTooltip()
		{
			...
			DateTimeLabelFormats = DateTimeLabelFormats_DefaultValue = new PlotOptionsBbTooltipDateTimeLabelFormats();
		...
		/// </summary>
		public PlotOptionsBbTooltipDateTimeLabelFormats DateTimeLabelFormats { get; set; }
		private PlotOptionsBbTooltipDateTimeLabelFormats DateTimeLabelFormats_DefaultValue { get; set; }
		...
		internal override Hashtable ToHashtable()
		{
			...
			if (PointFormatter != PointFormatter_DefaultValue) { h.Add("pointFormatter",PointFormatter); Highstock.AddFunction("PlotOptionsBbTooltipPointFormatter.pointFormatter", PointFormatter); }  
