...
{
	public partial class PlotOptionsBellcurveDataGrouping  : BaseObject
	{
		public PlotOptionsBellcurveDataGrouping()
		{
			Approximation = Approximation_DefaultValue = PlotOptionsBellcurveDataGroupingApproximation.Average;
		...
		/// </summary>
		public PlotOptionsBellcurveDataGroupingApproximation Approximation { get; set; }
		private PlotOptionsBellcurveDataGroupingApproximation Approximation_DefaultValue { get; set; }
