...
namespace Highsoft.Web.Mvc.Stocks
{
	public partial class PlotOptionsBoxplotDataGrouping  : BaseObject
	{
		public PlotOptionsBoxplotDataGrouping()
		{
			...
			Approximation = Approximation_DefaultValue = PlotOptionsBoxplotDataGroupingApproximation.Average;
		...
		/// </summary>
		public PlotOptionsBoxplotDataGroupingApproximation Approximation { get; set; }
		private PlotOptionsBoxplotDataGroupingApproximation Approximation_DefaultValue { get; set; }
