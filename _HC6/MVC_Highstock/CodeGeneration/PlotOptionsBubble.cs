...
namespace Highsoft.Web.Mvc.Stocks
{
	public partial class PlotOptionsBubble  : BaseObject
	{
		public PlotOptionsBubble()
		{
			...
			NavigatorOptions = NavigatorOptions_DefaultValue = new PlotOptionsBubbleNavigatorOptions();
		...
		/// </summary>
		public PlotOptionsBubbleNavigatorOptions NavigatorOptions { get; set; }
		private PlotOptionsBubbleNavigatorOptions NavigatorOptions_DefaultValue { get; set; }
