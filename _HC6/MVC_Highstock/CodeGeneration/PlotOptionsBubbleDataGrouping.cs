...
{
	public partial class PlotOptionsBubbleDataGrouping  : BaseObject
	{
		public PlotOptionsBubbleDataGrouping()
		{
			Approximation = Approximation_DefaultValue = PlotOptionsBubbleDataGroupingApproximation.Average;
		...
		/// </summary>
		public PlotOptionsBubbleDataGroupingApproximation Approximation { get; set; }
		private PlotOptionsBubbleDataGroupingApproximation Approximation_DefaultValue { get; set; }
		...
		/// </summary>
		public PlotOptionsBubbleDataGroupingUnits Units { get; set; }
		private PlotOptionsBubbleDataGroupingUnits Units_DefaultValue { get; set; }
