...
{
	public partial class PlotOptionsBubbleStatesHoverMarker  : BaseObject
	{
		public PlotOptionsBubbleStatesHoverMarker()
		{
			LineWidth = LineWidth_DefaultValue = 0;
			LineColor = LineColor_DefaultValue = "#ffffff";
			Radius = Radius_DefaultValue = 4;
			States = States_DefaultValue = new PlotOptionsBubbleStatesHoverMarkerStates();
		...
		/// </summary>
		public PlotOptionsBubbleStatesHoverMarkerStates States { get; set; }
		private PlotOptionsBubbleStatesHoverMarkerStates States_DefaultValue { get; set; }
