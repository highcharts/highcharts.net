...
namespace Highsoft.Web.Mvc.Stocks
{
	public partial class PlotOptionsBubbleTooltip  : BaseObject
	{
		public PlotOptionsBubbleTooltip()
		{
			...
			DateTimeLabelFormats = DateTimeLabelFormats_DefaultValue = new PlotOptionsBubbleTooltipDateTimeLabelFormats();
		...
		/// </summary>
		public PlotOptionsBubbleTooltipDateTimeLabelFormats DateTimeLabelFormats { get; set; }
		private PlotOptionsBubbleTooltipDateTimeLabelFormats DateTimeLabelFormats_DefaultValue { get; set; }
		...
		internal override Hashtable ToHashtable()
		{
			...
			if (PointFormatter != PointFormatter_DefaultValue) { h.Add("pointFormatter",PointFormatter); Highstock.AddFunction("PlotOptionsBubbleTooltipPointFormatter.pointFormatter", PointFormatter); }  
