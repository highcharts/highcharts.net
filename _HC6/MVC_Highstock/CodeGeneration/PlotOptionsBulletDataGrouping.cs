...
{
	public partial class PlotOptionsBulletDataGrouping  : BaseObject
	{
		...
		/// </summary>
		public PlotOptionsBulletDataGroupingApproximation Approximation { get; set; }
		private PlotOptionsBulletDataGroupingApproximation Approximation_DefaultValue { get; set; }
