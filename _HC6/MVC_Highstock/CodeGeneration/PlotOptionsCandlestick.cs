...
namespace Highsoft.Web.Mvc.Stocks
{
	public partial class PlotOptionsCandlestick  : BaseObject
	{
		public PlotOptionsCandlestick()
		{
			...
			Zones = Zones_DefaultValue = new PlotOptionsCandlestickZone();
		...
		/// </summary>
		public PlotOptionsCandlestickZone Zones { get; set; }
		private PlotOptionsCandlestickZone Zones_DefaultValue { get; set; }
