...
{
	public partial class PlotOptionsCandlestickDataGrouping  : BaseObject
	{
		...
		/// </summary>
		public PlotOptionsCandlestickDataGroupingApproximation Approximation { get; set; }
		private PlotOptionsCandlestickDataGroupingApproximation Approximation_DefaultValue { get; set; }
		...
		/// </summary>
		public PlotOptionsCandlestickDataGroupingUnits Units { get; set; }
		private PlotOptionsCandlestickDataGroupingUnits Units_DefaultValue { get; set; }
