...
namespace Highsoft.Web.Mvc.Stocks
{
	public partial class PlotOptionsCandlestickDataLabels  : BaseObject
	{
		...
		{
			Align = Align_DefaultValue = PlotOptionsCandlestickDataLabelsAlign.Null;
			VerticalAlign = VerticalAlign_DefaultValue = PlotOptionsCandlestickDataLabelsVerticalAlign.Null;
