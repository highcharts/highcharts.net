...
namespace Highsoft.Web.Mvc.Stocks
{
	public partial class PlotOptionsCandlestickDataLabels  : BaseObject
	{
		public PlotOptionsCandlestickDataLabels()
		{
			...
			Style = Style_DefaultValue = new PlotOptionsCandlestickDataLabelsStyle();
		...
		/// </summary>
		public PlotOptionsCandlestickDataLabelsStyle Style { get; set; }
		private PlotOptionsCandlestickDataLabelsStyle Style_DefaultValue { get; set; }
