...
{
	public partial class PlotOptionsCandlestickTooltip  : BaseObject
	{
		public PlotOptionsCandlestickTooltip()
		{
			...
			DateTimeLabelFormats = DateTimeLabelFormats_DefaultValue = new PlotOptionsCandlestickTooltipDateTimeLabelFormats();
		...
		/// </summary>
		public PlotOptionsCandlestickTooltipDateTimeLabelFormats DateTimeLabelFormats { get; set; }
		private PlotOptionsCandlestickTooltipDateTimeLabelFormats DateTimeLabelFormats_DefaultValue { get; set; }
		...
		internal override Hashtable ToHashtable()
		{
			...
			if (PointFormatter != PointFormatter_DefaultValue) { h.Add("pointFormatter",PointFormatter); Highstock.AddFunction("PlotOptionsCandlestickTooltipPointFormatter.pointFormatter", PointFormatter); }  
