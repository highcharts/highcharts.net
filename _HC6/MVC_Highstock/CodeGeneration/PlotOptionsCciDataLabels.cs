...
namespace Highsoft.Web.Mvc.Stocks
{
	public partial class PlotOptionsCciDataLabels  : BaseObject
	{
		public PlotOptionsCciDataLabels()
		{
			...
			Style = Style_DefaultValue = new PlotOptionsCciDataLabelsStyle();
		...
		/// </summary>
		public PlotOptionsCciDataLabelsStyle Style { get; set; }
		private PlotOptionsCciDataLabelsStyle Style_DefaultValue { get; set; }
