...
{
	public partial class PlotOptionsCciStatesHover  : BaseObject
	{
		public PlotOptionsCciStatesHover()
		{
			LineWidthPlus = LineWidthPlus_DefaultValue = 1;
			Marker = Marker_DefaultValue = new PlotOptionsCciStatesHoverMarker();
			Halo = Halo_DefaultValue = new PlotOptionsCciStatesHoverHalo();
		...
		/// </summary>
		public PlotOptionsCciStatesHoverMarker Marker { get; set; }
		private PlotOptionsCciStatesHoverMarker Marker_DefaultValue { get; set; }
		...
		/// </summary>
		public PlotOptionsCciStatesHoverHalo Halo { get; set; }
		private PlotOptionsCciStatesHoverHalo Halo_DefaultValue { get; set; }
