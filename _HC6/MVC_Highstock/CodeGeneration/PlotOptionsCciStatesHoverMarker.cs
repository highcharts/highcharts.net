...
{
	public partial class PlotOptionsCciStatesHoverMarker  : BaseObject
	{
		public PlotOptionsCciStatesHoverMarker()
		{
			...
			States = States_DefaultValue = new PlotOptionsCciStatesHoverMarkerStates();
		...
		/// </summary>
		public PlotOptionsCciStatesHoverMarkerStates States { get; set; }
		private PlotOptionsCciStatesHoverMarkerStates States_DefaultValue { get; set; }
