...
namespace Highsoft.Web.Mvc.Stocks
{
	public partial class PlotOptionsCciTooltip  : BaseObject
	{
		public PlotOptionsCciTooltip()
		{
			...
			DateTimeLabelFormats = DateTimeLabelFormats_DefaultValue = new PlotOptionsCciTooltipDateTimeLabelFormats();
		...
		/// </summary>
		public PlotOptionsCciTooltipDateTimeLabelFormats DateTimeLabelFormats { get; set; }
		private PlotOptionsCciTooltipDateTimeLabelFormats DateTimeLabelFormats_DefaultValue { get; set; }
