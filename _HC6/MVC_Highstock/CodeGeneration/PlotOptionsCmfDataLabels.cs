...
namespace Highsoft.Web.Mvc.Stocks
{
	public partial class PlotOptionsCmfDataLabels  : BaseObject
	{
		public PlotOptionsCmfDataLabels()
		{
			...
			Style = Style_DefaultValue = new PlotOptionsCmfDataLabelsStyle();
		...
		/// </summary>
		public PlotOptionsCmfDataLabelsStyle Style { get; set; }
		private PlotOptionsCmfDataLabelsStyle Style_DefaultValue { get; set; }
