...
{
	public partial class PlotOptionsCmfLabel  : BaseObject
	{
		public PlotOptionsCmfLabel()
		{
			...
			Style = Style_DefaultValue = new PlotOptionsCmfLabelStyle();
		...
		/// </summary>
		public PlotOptionsCmfLabelStyle Style { get; set; }
		private PlotOptionsCmfLabelStyle Style_DefaultValue { get; set; }
