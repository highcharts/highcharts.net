...
{
	public partial class PlotOptionsColumnDataGrouping  : BaseObject
	{
		public PlotOptionsColumnDataGrouping()
		{
			Approximation = Approximation_DefaultValue = PlotOptionsColumnDataGroupingApproximation.Average;
		...
		/// </summary>
		public PlotOptionsColumnDataGroupingApproximation Approximation { get; set; }
		private PlotOptionsColumnDataGroupingApproximation Approximation_DefaultValue { get; set; }
		...
		/// </summary>
		public PlotOptionsColumnDataGroupingUnits Units { get; set; }
		private PlotOptionsColumnDataGroupingUnits Units_DefaultValue { get; set; }
