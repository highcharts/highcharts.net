...
namespace Highsoft.Web.Mvc.Stocks
{
	public partial class PlotOptionsColumnTooltip  : BaseObject
	{
		public PlotOptionsColumnTooltip()
		{
			...
			DateTimeLabelFormats = DateTimeLabelFormats_DefaultValue = new PlotOptionsColumnTooltipDateTimeLabelFormats();
		...
		/// </summary>
		public PlotOptionsColumnTooltipDateTimeLabelFormats DateTimeLabelFormats { get; set; }
		private PlotOptionsColumnTooltipDateTimeLabelFormats DateTimeLabelFormats_DefaultValue { get; set; }
		...
		internal override Hashtable ToHashtable()
		{
			...
			if (PointFormatter != PointFormatter_DefaultValue) { h.Add("pointFormatter",PointFormatter); Highstock.AddFunction("PlotOptionsColumnTooltipPointFormatter.pointFormatter", PointFormatter); }  
