...
namespace Highsoft.Web.Mvc.Stocks
{
	public partial class PlotOptionsColumnrangeTooltip  : BaseObject
	{
		public PlotOptionsColumnrangeTooltip()
		{
			...
			DateTimeLabelFormats = DateTimeLabelFormats_DefaultValue = new PlotOptionsColumnrangeTooltipDateTimeLabelFormats();
		...
		/// </summary>
		public PlotOptionsColumnrangeTooltipDateTimeLabelFormats DateTimeLabelFormats { get; set; }
		private PlotOptionsColumnrangeTooltipDateTimeLabelFormats DateTimeLabelFormats_DefaultValue { get; set; }
