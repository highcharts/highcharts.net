...
{
	public partial class PlotOptionsEmaStatesHover  : BaseObject
	{
		public PlotOptionsEmaStatesHover()
		{
			LineWidthPlus = LineWidthPlus_DefaultValue = 1;
			Marker = Marker_DefaultValue = new PlotOptionsEmaStatesHoverMarker();
			Halo = Halo_DefaultValue = new PlotOptionsEmaStatesHoverHalo();
		...
		/// </summary>
		public PlotOptionsEmaStatesHoverMarker Marker { get; set; }
		private PlotOptionsEmaStatesHoverMarker Marker_DefaultValue { get; set; }
		...
		/// </summary>
		public PlotOptionsEmaStatesHoverHalo Halo { get; set; }
		private PlotOptionsEmaStatesHoverHalo Halo_DefaultValue { get; set; }
