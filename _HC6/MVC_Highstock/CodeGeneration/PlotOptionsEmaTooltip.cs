...
namespace Highsoft.Web.Mvc.Stocks
{
	public partial class PlotOptionsEmaTooltip  : BaseObject
	{
		public PlotOptionsEmaTooltip()
		{
			...
			DateTimeLabelFormats = DateTimeLabelFormats_DefaultValue = new PlotOptionsEmaTooltipDateTimeLabelFormats();
		...
		/// </summary>
		public PlotOptionsEmaTooltipDateTimeLabelFormats DateTimeLabelFormats { get; set; }
		private PlotOptionsEmaTooltipDateTimeLabelFormats DateTimeLabelFormats_DefaultValue { get; set; }
