...
namespace Highsoft.Web.Mvc.Stocks
{
	public partial class PlotOptionsErrorbar  : BaseObject
	{
		public PlotOptionsErrorbar()
		{
			...
			DataGrouping = DataGrouping_DefaultValue = new PlotOptionsErrorbarDataGrouping();
			...
			CompareBase = CompareBase_DefaultValue = PlotOptionsErrorbarCompareBase.Min;
		...
		/// </summary>
		public PlotOptionsErrorbarCompareBase CompareBase { get; set; }
		private PlotOptionsErrorbarCompareBase CompareBase_DefaultValue { get; set; }
		...
		internal override Hashtable ToHashtable()
		{
			...
			if (PointDescriptionFormatter != PointDescriptionFormatter_DefaultValue) { h.Add("pointDescriptionFormatter",PointDescriptionFormatter); Highstock.AddFunction("PlotOptionsErrorbarPointDescriptionFormatter.pointDescriptionFormatter", PointDescriptionFormatter); }  
