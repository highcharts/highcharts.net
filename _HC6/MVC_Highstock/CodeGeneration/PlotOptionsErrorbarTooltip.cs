...
namespace Highsoft.Web.Mvc.Stocks
{
	public partial class PlotOptionsErrorbarTooltip  : BaseObject
	{
		public PlotOptionsErrorbarTooltip()
		{
			...
			DateTimeLabelFormats = DateTimeLabelFormats_DefaultValue = new PlotOptionsErrorbarTooltipDateTimeLabelFormats();
		...
		/// </summary>
		public PlotOptionsErrorbarTooltipDateTimeLabelFormats DateTimeLabelFormats { get; set; }
		private PlotOptionsErrorbarTooltipDateTimeLabelFormats DateTimeLabelFormats_DefaultValue { get; set; }
		...
		internal override Hashtable ToHashtable()
		{
			...
			if (PointFormatter != PointFormatter_DefaultValue) { h.Add("pointFormatter",PointFormatter); Highstock.AddFunction("PlotOptionsErrorbarTooltipPointFormatter.pointFormatter", PointFormatter); }  
