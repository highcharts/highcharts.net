...
{
	public partial class PlotOptionsFlagsStatesHoverMarker  : BaseObject
	{
		public PlotOptionsFlagsStatesHoverMarker()
		{
			...
			States = States_DefaultValue = new PlotOptionsFlagsStatesHoverMarkerStates();
		...
		/// </summary>
		public PlotOptionsFlagsStatesHoverMarkerStates States { get; set; }
		private PlotOptionsFlagsStatesHoverMarkerStates States_DefaultValue { get; set; }
