...
namespace Highsoft.Web.Mvc.Stocks
{
	public partial class PlotOptionsFlagsTooltip  : BaseObject
	{
		public PlotOptionsFlagsTooltip()
		{
			...
			DateTimeLabelFormats = DateTimeLabelFormats_DefaultValue = new PlotOptionsFlagsTooltipDateTimeLabelFormats();
		...
		/// </summary>
		public PlotOptionsFlagsTooltipDateTimeLabelFormats DateTimeLabelFormats { get; set; }
		private PlotOptionsFlagsTooltipDateTimeLabelFormats DateTimeLabelFormats_DefaultValue { get; set; }
