...
{
	public partial class PlotOptionsFunnelDataGrouping  : BaseObject
	{
		...
		/// </summary>
		public PlotOptionsFunnelDataGroupingApproximation Approximation { get; set; }
		private PlotOptionsFunnelDataGroupingApproximation Approximation_DefaultValue { get; set; }
