...
{
	public partial class PlotOptionsFunnelStatesSelectMarker  : BaseObject
	{
		public PlotOptionsFunnelStatesSelectMarker()
		{
			LineWidth = LineWidth_DefaultValue = 0;
			LineColor = LineColor_DefaultValue = "#ffffff";
			Radius = Radius_DefaultValue = 4;
			States = States_DefaultValue = new PlotOptionsFunnelStatesSelectMarkerStates();
		...
		/// </summary>
		public PlotOptionsFunnelStatesSelectMarkerStates States { get; set; }
		private PlotOptionsFunnelStatesSelectMarkerStates States_DefaultValue { get; set; }
