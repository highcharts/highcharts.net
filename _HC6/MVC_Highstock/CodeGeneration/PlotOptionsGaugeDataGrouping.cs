...
{
	public partial class PlotOptionsGaugeDataGrouping  : BaseObject
	{
		public PlotOptionsGaugeDataGrouping()
		{
			Approximation = Approximation_DefaultValue = PlotOptionsGaugeDataGroupingApproximation.Average;
		...
		/// </summary>
		public PlotOptionsGaugeDataGroupingApproximation Approximation { get; set; }
		private PlotOptionsGaugeDataGroupingApproximation Approximation_DefaultValue { get; set; }
