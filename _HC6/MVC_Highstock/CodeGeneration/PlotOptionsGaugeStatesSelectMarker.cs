...
{
	public partial class PlotOptionsGaugeStatesSelectMarker  : BaseObject
	{
		public PlotOptionsGaugeStatesSelectMarker()
		{
			LineWidth = LineWidth_DefaultValue = 0;
			LineColor = LineColor_DefaultValue = "#ffffff";
			Radius = Radius_DefaultValue = 4;
			States = States_DefaultValue = new PlotOptionsGaugeStatesSelectMarkerStates();
		...
		/// </summary>
		public PlotOptionsGaugeStatesSelectMarkerStates States { get; set; }
		private PlotOptionsGaugeStatesSelectMarkerStates States_DefaultValue { get; set; }
