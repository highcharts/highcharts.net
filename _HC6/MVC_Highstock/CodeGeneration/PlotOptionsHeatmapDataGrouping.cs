...
{
	public partial class PlotOptionsHeatmapDataGrouping  : BaseObject
	{
		public PlotOptionsHeatmapDataGrouping()
		{
			Approximation = Approximation_DefaultValue = PlotOptionsHeatmapDataGroupingApproximation.Average;
		...
		/// </summary>
		public PlotOptionsHeatmapDataGroupingApproximation Approximation { get; set; }
		private PlotOptionsHeatmapDataGroupingApproximation Approximation_DefaultValue { get; set; }
