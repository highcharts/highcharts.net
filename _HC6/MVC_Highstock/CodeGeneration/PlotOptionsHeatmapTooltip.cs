...
namespace Highsoft.Web.Mvc.Stocks
{
	public partial class PlotOptionsHeatmapTooltip  : BaseObject
	{
		public PlotOptionsHeatmapTooltip()
		{
			...
			DateTimeLabelFormats = DateTimeLabelFormats_DefaultValue = new PlotOptionsHeatmapTooltipDateTimeLabelFormats();
		...
		/// </summary>
		public PlotOptionsHeatmapTooltipDateTimeLabelFormats DateTimeLabelFormats { get; set; }
		private PlotOptionsHeatmapTooltipDateTimeLabelFormats DateTimeLabelFormats_DefaultValue { get; set; }
		...
		internal override Hashtable ToHashtable()
		{
			...
			if (PointFormatter != PointFormatter_DefaultValue) { h.Add("pointFormatter",PointFormatter); Highstock.AddFunction("PlotOptionsHeatmapTooltipPointFormatter.pointFormatter", PointFormatter); }  
