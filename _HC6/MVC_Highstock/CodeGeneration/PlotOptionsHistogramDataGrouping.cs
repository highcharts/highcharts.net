...
{
	public partial class PlotOptionsHistogramDataGrouping  : BaseObject
	{
		public PlotOptionsHistogramDataGrouping()
		{
			GroupPixelWidth = GroupPixelWidth_DefaultValue = 10;
			Approximation = Approximation_DefaultValue = PlotOptionsHistogramDataGroupingApproximation.Average;
		...
		/// </summary>
		public PlotOptionsHistogramDataGroupingApproximation Approximation { get; set; }
		private PlotOptionsHistogramDataGroupingApproximation Approximation_DefaultValue { get; set; }
