...
namespace Highsoft.Web.Mvc.Stocks
{
	public partial class PlotOptionsIkh  : BaseObject
	{
		...
		{
			Name = Name_DefaultValue = "IKH (52, 26, 9)";
			...
			Zones = Zones_DefaultValue = new PlotOptionsIkhZone();
		...
		/// </summary>
		public PlotOptionsIkhZone Zones { get; set; }
		private PlotOptionsIkhZone Zones_DefaultValue { get; set; }
