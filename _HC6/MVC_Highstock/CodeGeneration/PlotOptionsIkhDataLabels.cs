...
namespace Highsoft.Web.Mvc.Stocks
{
	public partial class PlotOptionsIkhDataLabels  : BaseObject
	{
		public PlotOptionsIkhDataLabels()
		{
			...
			Style = Style_DefaultValue = new PlotOptionsIkhDataLabelsStyle();
		...
		/// </summary>
		public PlotOptionsIkhDataLabelsStyle Style { get; set; }
		private PlotOptionsIkhDataLabelsStyle Style_DefaultValue { get; set; }
