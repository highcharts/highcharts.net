...
{
	public partial class PlotOptionsIkhTooltip  : BaseObject
	{
		public PlotOptionsIkhTooltip()
		{
			...
			DateTimeLabelFormats = DateTimeLabelFormats_DefaultValue = new PlotOptionsIkhTooltipDateTimeLabelFormats();
		...
		/// </summary>
		public PlotOptionsIkhTooltipDateTimeLabelFormats DateTimeLabelFormats { get; set; }
		private PlotOptionsIkhTooltipDateTimeLabelFormats DateTimeLabelFormats_DefaultValue { get; set; }
		...
		internal override Hashtable ToHashtable()
		{
			...
			if (PointFormatter != PointFormatter_DefaultValue) { h.Add("pointFormatter",PointFormatter); Highstock.AddFunction("PlotOptionsIkhTooltipPointFormatter.pointFormatter", PointFormatter); }  
