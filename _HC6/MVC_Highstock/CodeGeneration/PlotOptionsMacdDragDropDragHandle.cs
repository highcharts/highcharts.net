...
{
	public partial class PlotOptionsMacdDragDropDragHandle  : BaseObject
	{
		public PlotOptionsMacdDragDropDragHandle()
		{
		...
		internal override Hashtable ToHashtable()
		{
			...
			if (PathFormatter != PathFormatter_DefaultValue) { h.Add("pathFormatter",PathFormatter); Highstock.AddFunction("PlotOptionsMacdDragDropDragHandlePathFormatter.pathFormatter", PathFormatter); }  
