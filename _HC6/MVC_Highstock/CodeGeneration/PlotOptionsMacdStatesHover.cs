...
{
	public partial class PlotOptionsMacdStatesHover  : BaseObject
	{
		public PlotOptionsMacdStatesHover()
		{
			Halo = Halo_DefaultValue = new PlotOptionsMacdStatesHoverHalo();
			LineWidthPlus = LineWidthPlus_DefaultValue = 1;
			Marker = Marker_DefaultValue = new PlotOptionsMacdStatesHoverMarker();
		...
		/// </summary>
		public PlotOptionsMacdStatesHoverMarker Marker { get; set; }
		private PlotOptionsMacdStatesHoverMarker Marker_DefaultValue { get; set; }
