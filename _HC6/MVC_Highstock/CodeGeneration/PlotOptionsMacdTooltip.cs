...
namespace Highsoft.Web.Mvc.Stocks
{
	public partial class PlotOptionsMacdTooltip  : BaseObject
	{
		public PlotOptionsMacdTooltip()
		{
			...
			DateTimeLabelFormats = DateTimeLabelFormats_DefaultValue = new PlotOptionsMacdTooltipDateTimeLabelFormats();
		...
		/// </summary>
		public PlotOptionsMacdTooltipDateTimeLabelFormats DateTimeLabelFormats { get; set; }
		private PlotOptionsMacdTooltipDateTimeLabelFormats DateTimeLabelFormats_DefaultValue { get; set; }
		...
		internal override Hashtable ToHashtable()
		{
			...
			if (PointFormatter != PointFormatter_DefaultValue) { h.Add("pointFormatter",PointFormatter); Highstock.AddFunction("PlotOptionsMacdTooltipPointFormatter.pointFormatter", PointFormatter); }  
