...
{
	public partial class PlotOptionsMapDataGrouping  : BaseObject
	{
		public PlotOptionsMapDataGrouping()
		{
			Approximation = Approximation_DefaultValue = PlotOptionsMapDataGroupingApproximation.Average;
		...
		/// </summary>
		public PlotOptionsMapDataGroupingApproximation Approximation { get; set; }
		private PlotOptionsMapDataGroupingApproximation Approximation_DefaultValue { get; set; }
