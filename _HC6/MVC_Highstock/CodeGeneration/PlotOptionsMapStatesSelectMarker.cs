...
{
	public partial class PlotOptionsMapStatesSelectMarker  : BaseObject
	{
		public PlotOptionsMapStatesSelectMarker()
		{
			LineWidth = LineWidth_DefaultValue = 0;
			LineColor = LineColor_DefaultValue = "#ffffff";
			Radius = Radius_DefaultValue = 4;
			States = States_DefaultValue = new PlotOptionsMapStatesSelectMarkerStates();
		...
		/// </summary>
		public PlotOptionsMapStatesSelectMarkerStates States { get; set; }
		private PlotOptionsMapStatesSelectMarkerStates States_DefaultValue { get; set; }
