...
{
	public partial class PlotOptionsMapTooltip  : BaseObject
	{
		public PlotOptionsMapTooltip()
		{
			...
			DateTimeLabelFormats = DateTimeLabelFormats_DefaultValue = new PlotOptionsMapTooltipDateTimeLabelFormats();
		...
		/// </summary>
		public PlotOptionsMapTooltipDateTimeLabelFormats DateTimeLabelFormats { get; set; }
		private PlotOptionsMapTooltipDateTimeLabelFormats DateTimeLabelFormats_DefaultValue { get; set; }
		...
		internal override Hashtable ToHashtable()
		{
			...
			if (PointFormatter != PointFormatter_DefaultValue) { h.Add("pointFormatter",PointFormatter); Highstock.AddFunction("PlotOptionsMapTooltipPointFormatter.pointFormatter", PointFormatter); }  
