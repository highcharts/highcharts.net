...
{
	public partial class PlotOptionsMapbubbleDataGrouping  : BaseObject
	{
		public PlotOptionsMapbubbleDataGrouping()
		{
			Approximation = Approximation_DefaultValue = PlotOptionsMapbubbleDataGroupingApproximation.Average;
		...
		/// </summary>
		public PlotOptionsMapbubbleDataGroupingApproximation Approximation { get; set; }
		private PlotOptionsMapbubbleDataGroupingApproximation Approximation_DefaultValue { get; set; }
