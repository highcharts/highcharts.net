...
{
	public partial class PlotOptionsMapbubbleLabel  : BaseObject
	{
		public PlotOptionsMapbubbleLabel()
		{
			...
			Style = Style_DefaultValue = new PlotOptionsMapbubbleLabelStyle();
		...
		/// </summary>
		public PlotOptionsMapbubbleLabelStyle Style { get; set; }
		private PlotOptionsMapbubbleLabelStyle Style_DefaultValue { get; set; }
