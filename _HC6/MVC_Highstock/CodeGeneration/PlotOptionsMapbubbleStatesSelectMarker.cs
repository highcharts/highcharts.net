...
{
	public partial class PlotOptionsMapbubbleStatesSelectMarker  : BaseObject
	{
		public PlotOptionsMapbubbleStatesSelectMarker()
		{
			LineWidth = LineWidth_DefaultValue = 0;
			LineColor = LineColor_DefaultValue = "#ffffff";
			Radius = Radius_DefaultValue = 4;
			States = States_DefaultValue = new PlotOptionsMapbubbleStatesSelectMarkerStates();
		...
		/// </summary>
		public PlotOptionsMapbubbleStatesSelectMarkerStates States { get; set; }
		private PlotOptionsMapbubbleStatesSelectMarkerStates States_DefaultValue { get; set; }
