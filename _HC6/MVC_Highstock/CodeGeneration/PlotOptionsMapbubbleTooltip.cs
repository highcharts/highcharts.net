...
namespace Highsoft.Web.Mvc.Stocks
{
	public partial class PlotOptionsMapbubbleTooltip  : BaseObject
	{
		public PlotOptionsMapbubbleTooltip()
		{
			...
			DateTimeLabelFormats = DateTimeLabelFormats_DefaultValue = new PlotOptionsMapbubbleTooltipDateTimeLabelFormats();
		...
		/// </summary>
		public PlotOptionsMapbubbleTooltipDateTimeLabelFormats DateTimeLabelFormats { get; set; }
		private PlotOptionsMapbubbleTooltipDateTimeLabelFormats DateTimeLabelFormats_DefaultValue { get; set; }
		...
		internal override Hashtable ToHashtable()
		{
			...
			if (PointFormatter != PointFormatter_DefaultValue) { h.Add("pointFormatter",PointFormatter); Highstock.AddFunction("PlotOptionsMapbubbleTooltipPointFormatter.pointFormatter", PointFormatter); }  
