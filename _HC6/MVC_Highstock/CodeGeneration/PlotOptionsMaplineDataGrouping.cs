...
{
	public partial class PlotOptionsMaplineDataGrouping  : BaseObject
	{
		public PlotOptionsMaplineDataGrouping()
		{
			Approximation = Approximation_DefaultValue = PlotOptionsMaplineDataGroupingApproximation.Average;
		...
		/// </summary>
		public PlotOptionsMaplineDataGroupingApproximation Approximation { get; set; }
		private PlotOptionsMaplineDataGroupingApproximation Approximation_DefaultValue { get; set; }
