...
{
	public partial class PlotOptionsMaplineLabel  : BaseObject
	{
		public PlotOptionsMaplineLabel()
		{
			...
			Style = Style_DefaultValue = new PlotOptionsMaplineLabelStyle();
		...
		/// </summary>
		public PlotOptionsMaplineLabelStyle Style { get; set; }
		private PlotOptionsMaplineLabelStyle Style_DefaultValue { get; set; }
