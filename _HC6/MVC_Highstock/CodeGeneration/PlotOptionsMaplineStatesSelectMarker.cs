...
{
	public partial class PlotOptionsMaplineStatesSelectMarker  : BaseObject
	{
		public PlotOptionsMaplineStatesSelectMarker()
		{
			LineWidth = LineWidth_DefaultValue = 0;
			LineColor = LineColor_DefaultValue = "#ffffff";
			Radius = Radius_DefaultValue = 4;
			States = States_DefaultValue = new PlotOptionsMaplineStatesSelectMarkerStates();
		...
		/// </summary>
		public PlotOptionsMaplineStatesSelectMarkerStates States { get; set; }
		private PlotOptionsMaplineStatesSelectMarkerStates States_DefaultValue { get; set; }
