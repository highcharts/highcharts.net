...
{
	public partial class PlotOptionsMaplineTooltip  : BaseObject
	{
		public PlotOptionsMaplineTooltip()
		{
			...
			DateTimeLabelFormats = DateTimeLabelFormats_DefaultValue = new PlotOptionsMaplineTooltipDateTimeLabelFormats();
		...
		/// </summary>
		public PlotOptionsMaplineTooltipDateTimeLabelFormats DateTimeLabelFormats { get; set; }
		private PlotOptionsMaplineTooltipDateTimeLabelFormats DateTimeLabelFormats_DefaultValue { get; set; }
		...
		internal override Hashtable ToHashtable()
		{
			...
			if (PointFormatter != PointFormatter_DefaultValue) { h.Add("pointFormatter",PointFormatter); Highstock.AddFunction("PlotOptionsMaplineTooltipPointFormatter.pointFormatter", PointFormatter); }  
