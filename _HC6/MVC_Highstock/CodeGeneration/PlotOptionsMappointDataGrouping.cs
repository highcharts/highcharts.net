...
{
	public partial class PlotOptionsMappointDataGrouping  : BaseObject
	{
		public PlotOptionsMappointDataGrouping()
		{
			Approximation = Approximation_DefaultValue = PlotOptionsMappointDataGroupingApproximation.Average;
		...
		/// </summary>
		public PlotOptionsMappointDataGroupingApproximation Approximation { get; set; }
		private PlotOptionsMappointDataGroupingApproximation Approximation_DefaultValue { get; set; }
