...
{
	public partial class PlotOptionsMappointLabel  : BaseObject
	{
		public PlotOptionsMappointLabel()
		{
			...
			Style = Style_DefaultValue = new PlotOptionsMappointLabelStyle();
		...
		/// </summary>
		public PlotOptionsMappointLabelStyle Style { get; set; }
		private PlotOptionsMappointLabelStyle Style_DefaultValue { get; set; }
