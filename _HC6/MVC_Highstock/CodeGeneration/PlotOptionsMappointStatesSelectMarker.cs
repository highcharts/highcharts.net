...
{
	public partial class PlotOptionsMappointStatesSelectMarker  : BaseObject
	{
		public PlotOptionsMappointStatesSelectMarker()
		{
			LineWidth = LineWidth_DefaultValue = 0;
			LineColor = LineColor_DefaultValue = "#ffffff";
			Radius = Radius_DefaultValue = 4;
			States = States_DefaultValue = new PlotOptionsMappointStatesSelectMarkerStates();
		...
		/// </summary>
		public PlotOptionsMappointStatesSelectMarkerStates States { get; set; }
		private PlotOptionsMappointStatesSelectMarkerStates States_DefaultValue { get; set; }
