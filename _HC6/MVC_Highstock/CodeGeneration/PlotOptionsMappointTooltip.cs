...
{
	public partial class PlotOptionsMappointTooltip  : BaseObject
	{
		public PlotOptionsMappointTooltip()
		{
			...
			DateTimeLabelFormats = DateTimeLabelFormats_DefaultValue = new PlotOptionsMappointTooltipDateTimeLabelFormats();
		...
		/// </summary>
		public PlotOptionsMappointTooltipDateTimeLabelFormats DateTimeLabelFormats { get; set; }
		private PlotOptionsMappointTooltipDateTimeLabelFormats DateTimeLabelFormats_DefaultValue { get; set; }
		...
		internal override Hashtable ToHashtable()
		{
			...
			if (PointFormatter != PointFormatter_DefaultValue) { h.Add("pointFormatter",PointFormatter); Highstock.AddFunction("PlotOptionsMappointTooltipPointFormatter.pointFormatter", PointFormatter); }  
