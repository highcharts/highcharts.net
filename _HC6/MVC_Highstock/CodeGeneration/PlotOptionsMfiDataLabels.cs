...
namespace Highsoft.Web.Mvc.Stocks
{
	public partial class PlotOptionsMfiDataLabels  : BaseObject
	{
		public PlotOptionsMfiDataLabels()
		{
			...
			Style = Style_DefaultValue = new PlotOptionsMfiDataLabelsStyle();
		...
		/// </summary>
		public PlotOptionsMfiDataLabelsStyle Style { get; set; }
		private PlotOptionsMfiDataLabelsStyle Style_DefaultValue { get; set; }
