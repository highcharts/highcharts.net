...
{
	public partial class PlotOptionsMfiMarker  : BaseObject
	{
		public PlotOptionsMfiMarker()
		{
			LineWidth = LineWidth_DefaultValue = 0;
			LineColor = LineColor_DefaultValue = "#ffffff";
			Radius = Radius_DefaultValue = 4;
			States = States_DefaultValue = new PlotOptionsMfiMarkerStates();
		...
		/// </summary>
		public PlotOptionsMfiMarkerStates States { get; set; }
		private PlotOptionsMfiMarkerStates States_DefaultValue { get; set; }
