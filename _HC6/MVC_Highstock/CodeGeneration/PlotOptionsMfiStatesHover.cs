...
{
	public partial class PlotOptionsMfiStatesHover  : BaseObject
	{
		public PlotOptionsMfiStatesHover()
		{
			LineWidthPlus = LineWidthPlus_DefaultValue = 1;
			Marker = Marker_DefaultValue = new PlotOptionsMfiStatesHoverMarker();
			Halo = Halo_DefaultValue = new PlotOptionsMfiStatesHoverHalo();
		...
		/// </summary>
		public PlotOptionsMfiStatesHoverMarker Marker { get; set; }
		private PlotOptionsMfiStatesHoverMarker Marker_DefaultValue { get; set; }
		...
		/// </summary>
		public PlotOptionsMfiStatesHoverHalo Halo { get; set; }
		private PlotOptionsMfiStatesHoverHalo Halo_DefaultValue { get; set; }
