...
{
	public partial class PlotOptionsMfiStatesHoverMarker  : BaseObject
	{
		public PlotOptionsMfiStatesHoverMarker()
		{
			...
			States = States_DefaultValue = new PlotOptionsMfiStatesHoverMarkerStates();
		...
		/// </summary>
		public PlotOptionsMfiStatesHoverMarkerStates States { get; set; }
		private PlotOptionsMfiStatesHoverMarkerStates States_DefaultValue { get; set; }
