...
namespace Highsoft.Web.Mvc.Stocks
{
	public partial class PlotOptionsMfiTooltip  : BaseObject
	{
		public PlotOptionsMfiTooltip()
		{
			...
			DateTimeLabelFormats = DateTimeLabelFormats_DefaultValue = new PlotOptionsMfiTooltipDateTimeLabelFormats();
		...
		/// </summary>
		public PlotOptionsMfiTooltipDateTimeLabelFormats DateTimeLabelFormats { get; set; }
		private PlotOptionsMfiTooltipDateTimeLabelFormats DateTimeLabelFormats_DefaultValue { get; set; }
