...
namespace Highsoft.Web.Mvc.Stocks
{
	public partial class PlotOptionsMomentum  : BaseObject
	{
		public PlotOptionsMomentum()
		{
			...
			Zones = Zones_DefaultValue = new PlotOptionsMomentumZone();
		...
		/// </summary>
		public PlotOptionsMomentumZone Zones { get; set; }
		private PlotOptionsMomentumZone Zones_DefaultValue { get; set; }
