...
namespace Highsoft.Web.Mvc.Stocks
{
	public partial class PlotOptionsMomentumDataLabels  : BaseObject
	{
		public PlotOptionsMomentumDataLabels()
		{
			...
			Style = Style_DefaultValue = new PlotOptionsMomentumDataLabelsStyle();
		...
		/// </summary>
		public PlotOptionsMomentumDataLabelsStyle Style { get; set; }
		private PlotOptionsMomentumDataLabelsStyle Style_DefaultValue { get; set; }
