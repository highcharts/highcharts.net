...
{
	public partial class PlotOptionsMomentumStatesSelectMarker  : BaseObject
	{
		public PlotOptionsMomentumStatesSelectMarker()
		{
			LineWidth = LineWidth_DefaultValue = 0;
			LineColor = LineColor_DefaultValue = "#ffffff";
			Radius = Radius_DefaultValue = 4;
			States = States_DefaultValue = new PlotOptionsMomentumStatesSelectMarkerStates();
		...
		/// </summary>
		public PlotOptionsMomentumStatesSelectMarkerStates States { get; set; }
		private PlotOptionsMomentumStatesSelectMarkerStates States_DefaultValue { get; set; }
