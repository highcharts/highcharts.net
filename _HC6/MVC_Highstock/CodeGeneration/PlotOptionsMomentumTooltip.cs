...
namespace Highsoft.Web.Mvc.Stocks
{
	public partial class PlotOptionsMomentumTooltip  : BaseObject
	{
		public PlotOptionsMomentumTooltip()
		{
			...
			DateTimeLabelFormats = DateTimeLabelFormats_DefaultValue = new PlotOptionsMomentumTooltipDateTimeLabelFormats();
		...
		/// </summary>
		public PlotOptionsMomentumTooltipDateTimeLabelFormats DateTimeLabelFormats { get; set; }
		private PlotOptionsMomentumTooltipDateTimeLabelFormats DateTimeLabelFormats_DefaultValue { get; set; }
