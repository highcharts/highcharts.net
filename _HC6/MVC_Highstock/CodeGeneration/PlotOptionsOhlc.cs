...
namespace Highsoft.Web.Mvc.Stocks
{
	public partial class PlotOptionsOhlc  : BaseObject
	{
		public PlotOptionsOhlc()
		{
			...
			NavigatorOptions = NavigatorOptions_DefaultValue = new PlotOptionsOhlcNavigatorOptions();
		...
		/// </summary>
		public PlotOptionsOhlcNavigatorOptions NavigatorOptions { get; set; }
		private PlotOptionsOhlcNavigatorOptions NavigatorOptions_DefaultValue { get; set; }
