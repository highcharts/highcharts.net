...
{
	public partial class PlotOptionsOhlcDataGrouping  : BaseObject
	{
		public PlotOptionsOhlcDataGrouping()
		{
			GroupPixelWidth = GroupPixelWidth_DefaultValue = 5;
			Approximation = Approximation_DefaultValue = PlotOptionsOhlcDataGroupingApproximation.Null;
		...
		/// </summary>
		public PlotOptionsOhlcDataGroupingApproximation Approximation { get; set; }
		private PlotOptionsOhlcDataGroupingApproximation Approximation_DefaultValue { get; set; }
