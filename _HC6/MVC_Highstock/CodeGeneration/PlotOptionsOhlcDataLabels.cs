...
namespace Highsoft.Web.Mvc.Stocks
{
	public partial class PlotOptionsOhlcDataLabels  : BaseObject
	{
		public PlotOptionsOhlcDataLabels()
		{
			...
			Style = Style_DefaultValue = new PlotOptionsOhlcDataLabelsStyle();
		...
		/// </summary>
		public PlotOptionsOhlcDataLabelsStyle Style { get; set; }
		private PlotOptionsOhlcDataLabelsStyle Style_DefaultValue { get; set; }
