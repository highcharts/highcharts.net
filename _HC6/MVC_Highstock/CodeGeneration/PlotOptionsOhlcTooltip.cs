...
{
	public partial class PlotOptionsOhlcTooltip  : BaseObject
	{
		public PlotOptionsOhlcTooltip()
		{
			...
			DateTimeLabelFormats = DateTimeLabelFormats_DefaultValue = new PlotOptionsOhlcTooltipDateTimeLabelFormats();
		...
		/// </summary>
		public PlotOptionsOhlcTooltipDateTimeLabelFormats DateTimeLabelFormats { get; set; }
		private PlotOptionsOhlcTooltipDateTimeLabelFormats DateTimeLabelFormats_DefaultValue { get; set; }
		...
		internal override Hashtable ToHashtable()
		{
			...
			if (PointFormatter != PointFormatter_DefaultValue) { h.Add("pointFormatter",PointFormatter); Highstock.AddFunction("PlotOptionsOhlcTooltipPointFormatter.pointFormatter", PointFormatter); }  
