...
{
	public partial class PlotOptionsParetoDataGrouping  : BaseObject
	{
		public PlotOptionsParetoDataGrouping()
		{
			Approximation = Approximation_DefaultValue = PlotOptionsParetoDataGroupingApproximation.Average;
		...
		/// </summary>
		public PlotOptionsParetoDataGroupingApproximation Approximation { get; set; }
		private PlotOptionsParetoDataGroupingApproximation Approximation_DefaultValue { get; set; }
