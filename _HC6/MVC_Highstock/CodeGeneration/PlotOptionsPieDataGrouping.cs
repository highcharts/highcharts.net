...
{
	public partial class PlotOptionsPieDataGrouping  : BaseObject
	{
		public PlotOptionsPieDataGrouping()
		{
			Approximation = Approximation_DefaultValue = PlotOptionsPieDataGroupingApproximation.Average;
		...
		/// </summary>
		public PlotOptionsPieDataGroupingApproximation Approximation { get; set; }
		private PlotOptionsPieDataGroupingApproximation Approximation_DefaultValue { get; set; }
