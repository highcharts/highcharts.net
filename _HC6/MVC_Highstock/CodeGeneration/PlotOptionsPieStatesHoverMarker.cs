...
namespace Highsoft.Web.Mvc.Stocks
{
	public partial class PlotOptionsPieStatesHoverMarker  : BaseObject
	{
		public PlotOptionsPieStatesHoverMarker()
		{
			...
			States = States_DefaultValue = new PlotOptionsPieStatesHoverMarkerStates();
		...
		/// </summary>
		public PlotOptionsPieStatesHoverMarkerStates States { get; set; }
		private PlotOptionsPieStatesHoverMarkerStates States_DefaultValue { get; set; }
