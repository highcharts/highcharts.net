...
namespace Highsoft.Web.Mvc.Stocks
{
	public partial class PlotOptionsPivotpoints  : BaseObject
	{
		public PlotOptionsPivotpoints()
		{
			...
			Zones = Zones_DefaultValue = new PlotOptionsPivotpointsZone();
		...
		/// </summary>
		public PlotOptionsPivotpointsZone Zones { get; set; }
		private PlotOptionsPivotpointsZone Zones_DefaultValue { get; set; }
