...
{
	public partial class PlotOptionsPivotpointsDataGrouping  : BaseObject
	{
		public PlotOptionsPivotpointsDataGrouping()
		{
			Approximation = Approximation_DefaultValue = PlotOptionsPivotpointsDataGroupingApproximation.Average;
		...
		/// </summary>
		public PlotOptionsPivotpointsDataGroupingApproximation Approximation { get; set; }
		private PlotOptionsPivotpointsDataGroupingApproximation Approximation_DefaultValue { get; set; }
		...
		/// </summary>
		public PlotOptionsPivotpointsDataGroupingUnits Units { get; set; }
		private PlotOptionsPivotpointsDataGroupingUnits Units_DefaultValue { get; set; }
