...
{
	public partial class PlotOptionsPivotpointsLabel  : BaseObject
	{
		public PlotOptionsPivotpointsLabel()
		{
			...
			Style = Style_DefaultValue = new PlotOptionsPivotpointsLabelStyle();
		...
		/// </summary>
		public PlotOptionsPivotpointsLabelStyle Style { get; set; }
		private PlotOptionsPivotpointsLabelStyle Style_DefaultValue { get; set; }
