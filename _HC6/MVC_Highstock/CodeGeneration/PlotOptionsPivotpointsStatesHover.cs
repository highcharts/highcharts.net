...
{
	public partial class PlotOptionsPivotpointsStatesHover  : BaseObject
	{
		public PlotOptionsPivotpointsStatesHover()
		{
			Enabled = Enabled_DefaultValue = true;
			Halo = Halo_DefaultValue = new PlotOptionsPivotpointsStatesHoverHalo();
			LineWidth = LineWidth_DefaultValue = null;
			LineWidthPlus = LineWidthPlus_DefaultValue = 1;
			Marker = Marker_DefaultValue = new PlotOptionsPivotpointsStatesHoverMarker();
		...
		/// </summary>
		public PlotOptionsPivotpointsStatesHoverHalo Halo { get; set; }
		private PlotOptionsPivotpointsStatesHoverHalo Halo_DefaultValue { get; set; }
		...
		/// </summary>
		public PlotOptionsPivotpointsStatesHoverMarker Marker { get; set; }
		private PlotOptionsPivotpointsStatesHoverMarker Marker_DefaultValue { get; set; }
