...
namespace Highsoft.Web.Mvc.Stocks
{
	public partial class PlotOptionsPivotpointsTooltip  : BaseObject
	{
		public PlotOptionsPivotpointsTooltip()
		{
			...
			DateTimeLabelFormats = DateTimeLabelFormats_DefaultValue = new PlotOptionsPivotpointsTooltipDateTimeLabelFormats();
		...
		/// </summary>
		public PlotOptionsPivotpointsTooltipDateTimeLabelFormats DateTimeLabelFormats { get; set; }
		private PlotOptionsPivotpointsTooltipDateTimeLabelFormats DateTimeLabelFormats_DefaultValue { get; set; }
