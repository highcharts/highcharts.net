...
namespace Highsoft.Web.Mvc.Stocks
{
	public partial class PlotOptionsPolygon  : BaseObject
	{
		public PlotOptionsPolygon()
		{
			...
			FindNearestPointBy = FindNearestPointBy_DefaultValue = PlotOptionsPolygonFindNearestPointBy.Xy;
			...
			Zones = Zones_DefaultValue = new PlotOptionsPolygonZone();
		...
		private PlotOptionsPolygonZone Zones_DefaultValue { get; set; }
