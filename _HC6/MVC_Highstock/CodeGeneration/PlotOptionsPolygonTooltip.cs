...
namespace Highsoft.Web.Mvc.Stocks
{
	public partial class PlotOptionsPolygonTooltip  : BaseObject
	{
		public PlotOptionsPolygonTooltip()
		{
			...
			DateTimeLabelFormats = DateTimeLabelFormats_DefaultValue = new PlotOptionsPolygonTooltipDateTimeLabelFormats();
		...
		/// </summary>
		public PlotOptionsPolygonTooltipDateTimeLabelFormats DateTimeLabelFormats { get; set; }
		private PlotOptionsPolygonTooltipDateTimeLabelFormats DateTimeLabelFormats_DefaultValue { get; set; }
		...
		internal override Hashtable ToHashtable()
		{
			...
			if (PointFormatter != PointFormatter_DefaultValue) { h.Add("pointFormatter",PointFormatter); Highstock.AddFunction("PlotOptionsPolygonTooltipPointFormatter.pointFormatter", PointFormatter); }  
