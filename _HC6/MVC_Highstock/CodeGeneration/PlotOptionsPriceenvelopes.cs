...
namespace Highsoft.Web.Mvc.Stocks
{
	public partial class PlotOptionsPriceenvelopes  : BaseObject
	{
		public PlotOptionsPriceenvelopes()
		{
			...
			Zones = Zones_DefaultValue = new PlotOptionsPriceenvelopesZone();
		...
		/// </summary>
		public PlotOptionsPriceenvelopesZone Zones { get; set; }
		private PlotOptionsPriceenvelopesZone Zones_DefaultValue { get; set; }
