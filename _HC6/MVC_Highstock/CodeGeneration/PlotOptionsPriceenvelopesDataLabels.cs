...
namespace Highsoft.Web.Mvc.Stocks
{
	public partial class PlotOptionsPriceenvelopesDataLabels  : BaseObject
	{
		public PlotOptionsPriceenvelopesDataLabels()
		{
			...
			Style = Style_DefaultValue = new PlotOptionsPriceenvelopesDataLabelsStyle();
		...
		/// </summary>
		public PlotOptionsPriceenvelopesDataLabelsStyle Style { get; set; }
		private PlotOptionsPriceenvelopesDataLabelsStyle Style_DefaultValue { get; set; }
