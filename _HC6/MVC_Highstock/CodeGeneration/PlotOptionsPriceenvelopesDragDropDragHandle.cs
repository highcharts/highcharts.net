...
{
	public partial class PlotOptionsPriceenvelopesDragDropDragHandle  : BaseObject
	{
		public PlotOptionsPriceenvelopesDragDropDragHandle()
		{
		...
		internal override Hashtable ToHashtable()
		{
			...
			if (PathFormatter != PathFormatter_DefaultValue) { h.Add("pathFormatter",PathFormatter); Highstock.AddFunction("PlotOptionsPriceenvelopesDragDropDragHandlePathFormatter.pathFormatter", PathFormatter); }  
