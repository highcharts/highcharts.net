...
{
	public partial class PlotOptionsPriceenvelopesMarker  : BaseObject
	{
		public PlotOptionsPriceenvelopesMarker()
		{
			...
			States = States_DefaultValue = new PlotOptionsPriceenvelopesMarkerStates();
		...
		/// </summary>
		public PlotOptionsPriceenvelopesMarkerStates States { get; set; }
		private PlotOptionsPriceenvelopesMarkerStates States_DefaultValue { get; set; }
