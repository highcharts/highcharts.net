...
namespace Highsoft.Web.Mvc.Stocks
{
	public partial class PlotOptionsPriceenvelopesTooltip  : BaseObject
	{
		public PlotOptionsPriceenvelopesTooltip()
		{
			...
			DateTimeLabelFormats = DateTimeLabelFormats_DefaultValue = new PlotOptionsPriceenvelopesTooltipDateTimeLabelFormats();
		...
		/// </summary>
		public PlotOptionsPriceenvelopesTooltipDateTimeLabelFormats DateTimeLabelFormats { get; set; }
		private PlotOptionsPriceenvelopesTooltipDateTimeLabelFormats DateTimeLabelFormats_DefaultValue { get; set; }
		...
		internal override Hashtable ToHashtable()
		{
			...
			if (PointFormatter != PointFormatter_DefaultValue) { h.Add("pointFormatter",PointFormatter); Highstock.AddFunction("PlotOptionsPriceenvelopesTooltipPointFormatter.pointFormatter", PointFormatter); }  
