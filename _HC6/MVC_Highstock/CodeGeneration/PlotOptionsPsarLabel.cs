...
{
	public partial class PlotOptionsPsarLabel  : BaseObject
	{
		public PlotOptionsPsarLabel()
		{
			...
			Style = Style_DefaultValue = new PlotOptionsPsarLabelStyle();
		...
		/// </summary>
		public PlotOptionsPsarLabelStyle Style { get; set; }
		private PlotOptionsPsarLabelStyle Style_DefaultValue { get; set; }
