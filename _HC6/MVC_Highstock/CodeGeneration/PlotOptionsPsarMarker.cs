...
{
	public partial class PlotOptionsPsarMarker  : BaseObject
	{
		public PlotOptionsPsarMarker()
		{
			...
			States = States_DefaultValue = new PlotOptionsPsarMarkerStates();
		...
		/// </summary>
		public PlotOptionsPsarMarkerStates States { get; set; }
		private PlotOptionsPsarMarkerStates States_DefaultValue { get; set; }
