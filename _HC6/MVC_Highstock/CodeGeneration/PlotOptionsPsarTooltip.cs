...
namespace Highsoft.Web.Mvc.Stocks
{
	public partial class PlotOptionsPsarTooltip  : BaseObject
	{
		public PlotOptionsPsarTooltip()
		{
			...
			DateTimeLabelFormats = DateTimeLabelFormats_DefaultValue = new PlotOptionsPsarTooltipDateTimeLabelFormats();
		...
		/// </summary>
		public PlotOptionsPsarTooltipDateTimeLabelFormats DateTimeLabelFormats { get; set; }
		private PlotOptionsPsarTooltipDateTimeLabelFormats DateTimeLabelFormats_DefaultValue { get; set; }
