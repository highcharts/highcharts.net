...
namespace Highsoft.Web.Mvc.Stocks
{
	public partial class PlotOptionsRocDataLabels  : BaseObject
	{
		public PlotOptionsRocDataLabels()
		{
			...
			Style = Style_DefaultValue = new PlotOptionsRocDataLabelsStyle();
		...
		/// </summary>
		public PlotOptionsRocDataLabelsStyle Style { get; set; }
		private PlotOptionsRocDataLabelsStyle Style_DefaultValue { get; set; }
