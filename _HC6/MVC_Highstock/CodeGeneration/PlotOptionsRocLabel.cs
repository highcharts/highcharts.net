...
{
	public partial class PlotOptionsRocLabel  : BaseObject
	{
		public PlotOptionsRocLabel()
		{
			...
			Style = Style_DefaultValue = new PlotOptionsRocLabelStyle();
		...
		/// </summary>
		public PlotOptionsRocLabelStyle Style { get; set; }
		private PlotOptionsRocLabelStyle Style_DefaultValue { get; set; }
