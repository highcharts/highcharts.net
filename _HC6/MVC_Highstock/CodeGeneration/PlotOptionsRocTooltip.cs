...
namespace Highsoft.Web.Mvc.Stocks
{
	public partial class PlotOptionsRocTooltip  : BaseObject
	{
		public PlotOptionsRocTooltip()
		{
			...
			DateTimeLabelFormats = DateTimeLabelFormats_DefaultValue = new PlotOptionsRocTooltipDateTimeLabelFormats();
		...
		/// </summary>
		public PlotOptionsRocTooltipDateTimeLabelFormats DateTimeLabelFormats { get; set; }
		private PlotOptionsRocTooltipDateTimeLabelFormats DateTimeLabelFormats_DefaultValue { get; set; }
