...
{
	public partial class PlotOptionsRsiDataGrouping  : BaseObject
	{
		...
		/// </summary>
		public PlotOptionsRsiDataGroupingApproximation Approximation { get; set; }
		private PlotOptionsRsiDataGroupingApproximation Approximation_DefaultValue { get; set; }
		...
		/// </summary>
		public PlotOptionsRsiDataGroupingUnits Units { get; set; }
		private PlotOptionsRsiDataGroupingUnits Units_DefaultValue { get; set; }
