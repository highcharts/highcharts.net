...
{
	public partial class PlotOptionsRsiLabel  : BaseObject
	{
		public PlotOptionsRsiLabel()
		{
			...
			Style = Style_DefaultValue = new PlotOptionsRsiLabelStyle();
		...
		/// </summary>
		public PlotOptionsRsiLabelStyle Style { get; set; }
		private PlotOptionsRsiLabelStyle Style_DefaultValue { get; set; }
