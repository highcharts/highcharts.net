...
{
	public partial class PlotOptionsRsiStatesHoverMarker  : BaseObject
	{
		public PlotOptionsRsiStatesHoverMarker()
		{
			...
			States = States_DefaultValue = new PlotOptionsRsiStatesHoverMarkerStates();
		...
		/// </summary>
		public PlotOptionsRsiStatesHoverMarkerStates States { get; set; }
		private PlotOptionsRsiStatesHoverMarkerStates States_DefaultValue { get; set; }
