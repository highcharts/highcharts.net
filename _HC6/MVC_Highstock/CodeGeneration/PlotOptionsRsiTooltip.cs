...
namespace Highsoft.Web.Mvc.Stocks
{
	public partial class PlotOptionsRsiTooltip  : BaseObject
	{
		public PlotOptionsRsiTooltip()
		{
			...
			DateTimeLabelFormats = DateTimeLabelFormats_DefaultValue = new PlotOptionsRsiTooltipDateTimeLabelFormats();
		...
		/// </summary>
		public PlotOptionsRsiTooltipDateTimeLabelFormats DateTimeLabelFormats { get; set; }
		private PlotOptionsRsiTooltipDateTimeLabelFormats DateTimeLabelFormats_DefaultValue { get; set; }
