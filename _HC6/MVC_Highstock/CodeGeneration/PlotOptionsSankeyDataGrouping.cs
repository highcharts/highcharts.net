...
{
	public partial class PlotOptionsSankeyDataGrouping  : BaseObject
	{
		public PlotOptionsSankeyDataGrouping()
		{
			GroupPixelWidth = GroupPixelWidth_DefaultValue = 10;
			Approximation = Approximation_DefaultValue = PlotOptionsSankeyDataGroupingApproximation.Average;
		...
		/// </summary>
		public PlotOptionsSankeyDataGroupingApproximation Approximation { get; set; }
		private PlotOptionsSankeyDataGroupingApproximation Approximation_DefaultValue { get; set; }
