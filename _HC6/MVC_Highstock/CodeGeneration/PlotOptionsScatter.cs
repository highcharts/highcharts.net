...
namespace Highsoft.Web.Mvc.Stocks
{
	public partial class PlotOptionsScatter  : BaseObject
	{
		public PlotOptionsScatter()
		{
			...
			FindNearestPointBy = FindNearestPointBy_DefaultValue = PlotOptionsScatterFindNearestPointBy.Xy;
			...
			Zones = Zones_DefaultValue = new PlotOptionsScatterZone();
		...
		private PlotOptionsScatterZone Zones_DefaultValue { get; set; }
