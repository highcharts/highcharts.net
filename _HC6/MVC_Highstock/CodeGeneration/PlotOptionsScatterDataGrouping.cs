...
{
	public partial class PlotOptionsScatterDataGrouping  : BaseObject
	{
		public PlotOptionsScatterDataGrouping()
		{
			Approximation = Approximation_DefaultValue = PlotOptionsScatterDataGroupingApproximation.Average;
		...
		/// </summary>
		public PlotOptionsScatterDataGroupingApproximation Approximation { get; set; }
		private PlotOptionsScatterDataGroupingApproximation Approximation_DefaultValue { get; set; }
		...
		/// </summary>
		public PlotOptionsScatterDataGroupingUnits Units { get; set; }
		private PlotOptionsScatterDataGroupingUnits Units_DefaultValue { get; set; }
