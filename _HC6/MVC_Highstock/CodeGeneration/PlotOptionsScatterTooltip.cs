...
namespace Highsoft.Web.Mvc.Stocks
{
	public partial class PlotOptionsScatterTooltip  : BaseObject
	{
		public PlotOptionsScatterTooltip()
		{
			...
			DateTimeLabelFormats = DateTimeLabelFormats_DefaultValue = new PlotOptionsScatterTooltipDateTimeLabelFormats();
		...
		/// </summary>
		public PlotOptionsScatterTooltipDateTimeLabelFormats DateTimeLabelFormats { get; set; }
		private PlotOptionsScatterTooltipDateTimeLabelFormats DateTimeLabelFormats_DefaultValue { get; set; }
		...
		internal override Hashtable ToHashtable()
		{
			...
			if (PointFormatter != PointFormatter_DefaultValue) { h.Add("pointFormatter",PointFormatter); Highstock.AddFunction("PlotOptionsScatterTooltipPointFormatter.pointFormatter", PointFormatter); }  
