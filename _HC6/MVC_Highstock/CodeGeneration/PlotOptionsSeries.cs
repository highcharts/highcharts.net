...
namespace Highsoft.Web.Mvc.Stocks
{
	public partial class PlotOptionsSeries  : BaseObject
	{
		public PlotOptionsSeries()
		{
			...
			NavigatorOptions = NavigatorOptions_DefaultValue = new PlotOptionsSeriesNavigatorOptions();
			...
			CompareBase = CompareBase_DefaultValue = PlotOptionsSeriesCompareBase.0;
		...
		/// </summary>
		public PlotOptionsSeriesNavigatorOptions NavigatorOptions { get; set; }
		private PlotOptionsSeriesNavigatorOptions NavigatorOptions_DefaultValue { get; set; }
