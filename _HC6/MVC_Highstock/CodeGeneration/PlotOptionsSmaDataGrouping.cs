...
{
	public partial class PlotOptionsSmaDataGrouping  : BaseObject
	{
		public PlotOptionsSmaDataGrouping()
		{
			Approximation = Approximation_DefaultValue = PlotOptionsSmaDataGroupingApproximation.Average;
		...
		/// </summary>
		public PlotOptionsSmaDataGroupingApproximation Approximation { get; set; }
		private PlotOptionsSmaDataGroupingApproximation Approximation_DefaultValue { get; set; }
		...
		/// </summary>
		public PlotOptionsSmaDataGroupingUnits Units { get; set; }
		private PlotOptionsSmaDataGroupingUnits Units_DefaultValue { get; set; }
