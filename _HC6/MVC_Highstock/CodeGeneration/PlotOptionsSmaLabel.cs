...
{
	public partial class PlotOptionsSmaLabel  : BaseObject
	{
		public PlotOptionsSmaLabel()
		{
			...
			Style = Style_DefaultValue = new PlotOptionsSmaLabelStyle();
		...
		/// </summary>
		public PlotOptionsSmaLabelStyle Style { get; set; }
		private PlotOptionsSmaLabelStyle Style_DefaultValue { get; set; }
