...
namespace Highsoft.Web.Mvc.Stocks
{
	public partial class PlotOptionsSmaTooltip  : BaseObject
	{
		public PlotOptionsSmaTooltip()
		{
			...
			DateTimeLabelFormats = DateTimeLabelFormats_DefaultValue = new PlotOptionsSmaTooltipDateTimeLabelFormats();
		...
		/// </summary>
		public PlotOptionsSmaTooltipDateTimeLabelFormats DateTimeLabelFormats { get; set; }
		private PlotOptionsSmaTooltipDateTimeLabelFormats DateTimeLabelFormats_DefaultValue { get; set; }
		...
		internal override Hashtable ToHashtable()
		{
			...
			if (PointFormatter != PointFormatter_DefaultValue) { h.Add("pointFormatter",PointFormatter); Highstock.AddFunction("PlotOptionsSmaTooltipPointFormatter.pointFormatter", PointFormatter); }  
