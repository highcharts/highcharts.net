...
{
	public partial class PlotOptionsSolidgaugeDataGrouping  : BaseObject
	{
		public PlotOptionsSolidgaugeDataGrouping()
		{
			Approximation = Approximation_DefaultValue = PlotOptionsSolidgaugeDataGroupingApproximation.Average;
		...
		/// </summary>
		public PlotOptionsSolidgaugeDataGroupingApproximation Approximation { get; set; }
		private PlotOptionsSolidgaugeDataGroupingApproximation Approximation_DefaultValue { get; set; }
