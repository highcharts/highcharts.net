...
{
	public partial class PlotOptionsSolidgaugeStatesSelectMarker  : BaseObject
	{
		public PlotOptionsSolidgaugeStatesSelectMarker()
		{
			LineWidth = LineWidth_DefaultValue = 0;
			LineColor = LineColor_DefaultValue = "#ffffff";
			Radius = Radius_DefaultValue = 4;
			States = States_DefaultValue = new PlotOptionsSolidgaugeStatesSelectMarkerStates();
		...
		/// </summary>
		public PlotOptionsSolidgaugeStatesSelectMarkerStates States { get; set; }
		private PlotOptionsSolidgaugeStatesSelectMarkerStates States_DefaultValue { get; set; }
