...
namespace Highsoft.Web.Mvc.Stocks
{
	public partial class PlotOptionsStochasticDataLabels  : BaseObject
	{
		public PlotOptionsStochasticDataLabels()
		{
			...
			Style = Style_DefaultValue = new PlotOptionsStochasticDataLabelsStyle();
		...
		/// </summary>
		public PlotOptionsStochasticDataLabelsStyle Style { get; set; }
		private PlotOptionsStochasticDataLabelsStyle Style_DefaultValue { get; set; }
