...
{
	public partial class PlotOptionsStochasticLabel  : BaseObject
	{
		public PlotOptionsStochasticLabel()
		{
			...
			Style = Style_DefaultValue = new PlotOptionsStochasticLabelStyle();
		...
		/// </summary>
		public PlotOptionsStochasticLabelStyle Style { get; set; }
		private PlotOptionsStochasticLabelStyle Style_DefaultValue { get; set; }
