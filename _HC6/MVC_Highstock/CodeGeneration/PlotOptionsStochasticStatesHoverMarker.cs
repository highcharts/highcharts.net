...
{
	public partial class PlotOptionsStochasticStatesHoverMarker  : BaseObject
	{
		public PlotOptionsStochasticStatesHoverMarker()
		{
			...
			States = States_DefaultValue = new PlotOptionsStochasticStatesHoverMarkerStates();
		...
		/// </summary>
		public PlotOptionsStochasticStatesHoverMarkerStates States { get; set; }
		private PlotOptionsStochasticStatesHoverMarkerStates States_DefaultValue { get; set; }
