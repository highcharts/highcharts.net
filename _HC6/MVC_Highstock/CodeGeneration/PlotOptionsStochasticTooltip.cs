...
{
	public partial class PlotOptionsStochasticTooltip  : BaseObject
	{
		public PlotOptionsStochasticTooltip()
		{
			...
			DateTimeLabelFormats = DateTimeLabelFormats_DefaultValue = new PlotOptionsStochasticTooltipDateTimeLabelFormats();
		...
		/// </summary>
		public PlotOptionsStochasticTooltipDateTimeLabelFormats DateTimeLabelFormats { get; set; }
		private PlotOptionsStochasticTooltipDateTimeLabelFormats DateTimeLabelFormats_DefaultValue { get; set; }
		...
		internal override Hashtable ToHashtable()
		{
			...
			if (PointFormatter != PointFormatter_DefaultValue) { h.Add("pointFormatter",PointFormatter); Highstock.AddFunction("PlotOptionsStochasticTooltipPointFormatter.pointFormatter", PointFormatter); }  
