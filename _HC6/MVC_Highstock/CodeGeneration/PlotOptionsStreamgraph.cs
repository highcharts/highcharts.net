...
namespace Highsoft.Web.Mvc.Stocks
{
	public partial class PlotOptionsStreamgraph  : BaseObject
	{
		public PlotOptionsStreamgraph()
		{
			...
			Stacking = Stacking_DefaultValue = PlotOptionsStreamgraphStacking.Stream;
			...
			Zones = Zones_DefaultValue = new PlotOptionsStreamgraphZone();
		...
		/// </summary>
		public PlotOptionsStreamgraphZone Zones { get; set; }
		private PlotOptionsStreamgraphZone Zones_DefaultValue { get; set; }
