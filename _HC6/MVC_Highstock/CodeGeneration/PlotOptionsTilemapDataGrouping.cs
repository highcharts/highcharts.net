...
{
	public partial class PlotOptionsTilemapDataGrouping  : BaseObject
	{
		public PlotOptionsTilemapDataGrouping()
		{
			Approximation = Approximation_DefaultValue = PlotOptionsTilemapDataGroupingApproximation.Average;
		...
		/// </summary>
		public PlotOptionsTilemapDataGroupingApproximation Approximation { get; set; }
		private PlotOptionsTilemapDataGroupingApproximation Approximation_DefaultValue { get; set; }
