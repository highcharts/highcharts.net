...
{
	public partial class PlotOptionsTilemapStatesHoverMarkerStates  : BaseObject
	{
		...
		/// </summary>
		public PlotOptionsTilemapStatesHoverMarkerStatesHover Hover { get; set; }
		private PlotOptionsTilemapStatesHoverMarkerStatesHover Hover_DefaultValue { get; set; }
		...
		/// </summary>
		public PlotOptionsTilemapStatesHoverMarkerStatesSelect Select { get; set; }
		private PlotOptionsTilemapStatesHoverMarkerStatesSelect Select_DefaultValue { get; set; }
