...
namespace Highsoft.Web.Mvc.Stocks
{
	public partial class PlotOptionsTilemapTooltip  : BaseObject
	{
		public PlotOptionsTilemapTooltip()
		{
			...
			DateTimeLabelFormats = DateTimeLabelFormats_DefaultValue = new PlotOptionsTilemapTooltipDateTimeLabelFormats();
		...
		/// </summary>
		public PlotOptionsTilemapTooltipDateTimeLabelFormats DateTimeLabelFormats { get; set; }
		private PlotOptionsTilemapTooltipDateTimeLabelFormats DateTimeLabelFormats_DefaultValue { get; set; }
		...
		internal override Hashtable ToHashtable()
		{
			...
			if (PointFormatter != PointFormatter_DefaultValue) { h.Add("pointFormatter",PointFormatter); Highstock.AddFunction("PlotOptionsTilemapTooltipPointFormatter.pointFormatter", PointFormatter); }  
