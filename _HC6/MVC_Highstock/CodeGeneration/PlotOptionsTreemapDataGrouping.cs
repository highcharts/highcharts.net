...
{
	public partial class PlotOptionsTreemapDataGrouping  : BaseObject
	{
		...
		/// </summary>
		public PlotOptionsTreemapDataGroupingApproximation Approximation { get; set; }
		private PlotOptionsTreemapDataGroupingApproximation Approximation_DefaultValue { get; set; }
