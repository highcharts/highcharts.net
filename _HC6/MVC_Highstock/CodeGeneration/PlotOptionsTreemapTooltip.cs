...
{
	public partial class PlotOptionsTreemapTooltip  : BaseObject
	{
		public PlotOptionsTreemapTooltip()
		{
			...
			DateTimeLabelFormats = DateTimeLabelFormats_DefaultValue = new PlotOptionsTreemapTooltipDateTimeLabelFormats();
		...
		/// </summary>
		public PlotOptionsTreemapTooltipDateTimeLabelFormats DateTimeLabelFormats { get; set; }
		private PlotOptionsTreemapTooltipDateTimeLabelFormats DateTimeLabelFormats_DefaultValue { get; set; }
		...
		internal override Hashtable ToHashtable()
		{
			...
			if (PointFormatter != PointFormatter_DefaultValue) { h.Add("pointFormatter",PointFormatter); Highstock.AddFunction("PlotOptionsTreemapTooltipPointFormatter.pointFormatter", PointFormatter); }  
