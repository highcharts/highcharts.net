...
{
	public partial class PlotOptionsVariwideDataGrouping  : BaseObject
	{
		public PlotOptionsVariwideDataGrouping()
		{
			GroupPixelWidth = GroupPixelWidth_DefaultValue = 10;
			Approximation = Approximation_DefaultValue = PlotOptionsVariwideDataGroupingApproximation.Average;
		...
		/// </summary>
		public PlotOptionsVariwideDataGroupingApproximation Approximation { get; set; }
		private PlotOptionsVariwideDataGroupingApproximation Approximation_DefaultValue { get; set; }
