...
{
	public partial class PlotOptionsVbpDragDropDragHandle  : BaseObject
	{
		public PlotOptionsVbpDragDropDragHandle()
		{
		...
		internal override Hashtable ToHashtable()
		{
			...
			if (PathFormatter != PathFormatter_DefaultValue) { h.Add("pathFormatter",PathFormatter); Highstock.AddFunction("PlotOptionsVbpDragDropDragHandlePathFormatter.pathFormatter", PathFormatter); }  
