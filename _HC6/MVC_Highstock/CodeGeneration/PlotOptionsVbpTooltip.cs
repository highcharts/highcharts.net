...
namespace Highsoft.Web.Mvc.Stocks
{
	public partial class PlotOptionsVbpTooltip  : BaseObject
	{
		public PlotOptionsVbpTooltip()
		{
			...
			DateTimeLabelFormats = DateTimeLabelFormats_DefaultValue = new PlotOptionsVbpTooltipDateTimeLabelFormats();
		...
		/// </summary>
		public PlotOptionsVbpTooltipDateTimeLabelFormats DateTimeLabelFormats { get; set; }
		private PlotOptionsVbpTooltipDateTimeLabelFormats DateTimeLabelFormats_DefaultValue { get; set; }
