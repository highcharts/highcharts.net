...
namespace Highsoft.Web.Mvc.Stocks
{
	public partial class PlotOptionsVectorTooltip  : BaseObject
	{
		public PlotOptionsVectorTooltip()
		{
			...
			DateTimeLabelFormats = DateTimeLabelFormats_DefaultValue = new PlotOptionsVectorTooltipDateTimeLabelFormats();
		...
		/// </summary>
		public PlotOptionsVectorTooltipDateTimeLabelFormats DateTimeLabelFormats { get; set; }
		private PlotOptionsVectorTooltipDateTimeLabelFormats DateTimeLabelFormats_DefaultValue { get; set; }
		...
		internal override Hashtable ToHashtable()
		{
			...
			if (PointFormatter != PointFormatter_DefaultValue) { h.Add("pointFormatter",PointFormatter); Highstock.AddFunction("PlotOptionsVectorTooltipPointFormatter.pointFormatter", PointFormatter); }  
