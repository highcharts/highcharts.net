...
{
	public partial class PlotOptionsVwapStatesHover  : BaseObject
	{
		public PlotOptionsVwapStatesHover()
		{
			LineWidthPlus = LineWidthPlus_DefaultValue = 1;
			Marker = Marker_DefaultValue = new PlotOptionsVwapStatesHoverMarker();
			Halo = Halo_DefaultValue = new PlotOptionsVwapStatesHoverHalo();
		...
		/// </summary>
		public PlotOptionsVwapStatesHoverMarker Marker { get; set; }
		private PlotOptionsVwapStatesHoverMarker Marker_DefaultValue { get; set; }
		...
		/// </summary>
		public PlotOptionsVwapStatesHoverHalo Halo { get; set; }
		private PlotOptionsVwapStatesHoverHalo Halo_DefaultValue { get; set; }
