...
{
	public partial class PlotOptionsWaterfallDataGrouping  : BaseObject
	{
		public PlotOptionsWaterfallDataGrouping()
		{
			GroupPixelWidth = GroupPixelWidth_DefaultValue = 10;
			Approximation = Approximation_DefaultValue = PlotOptionsWaterfallDataGroupingApproximation.Average;
		...
		/// </summary>
		public PlotOptionsWaterfallDataGroupingApproximation Approximation { get; set; }
		private PlotOptionsWaterfallDataGroupingApproximation Approximation_DefaultValue { get; set; }
