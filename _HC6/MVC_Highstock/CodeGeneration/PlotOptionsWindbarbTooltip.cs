...
namespace Highsoft.Web.Mvc.Stocks
{
	public partial class PlotOptionsWindbarbTooltip  : BaseObject
	{
		public PlotOptionsWindbarbTooltip()
		{
			...
			DateTimeLabelFormats = DateTimeLabelFormats_DefaultValue = new PlotOptionsWindbarbTooltipDateTimeLabelFormats();
		...
		/// <summary>
		/// <p>The default point format for the wind barb tooltip. Note the <code>point.beaufort</code> property that refers to the Beaufort wind scale. Thenames can be internationalized by modifying<code>Highcharts.seriesTypes.windbarb.prototype.beaufortNames</code>.</p>
		/// </summary>
		...
		/// </summary>
		public PlotOptionsWindbarbTooltipDateTimeLabelFormats DateTimeLabelFormats { get; set; }
		private PlotOptionsWindbarbTooltipDateTimeLabelFormats DateTimeLabelFormats_DefaultValue { get; set; }
		...
		internal override Hashtable ToHashtable()
		{
			...
			if (PointFormatter != PointFormatter_DefaultValue) { h.Add("pointFormatter",PointFormatter); Highstock.AddFunction("PlotOptionsWindbarbTooltipPointFormatter.pointFormatter", PointFormatter); }  
