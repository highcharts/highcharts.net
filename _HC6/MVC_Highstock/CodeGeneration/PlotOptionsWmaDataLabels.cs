...
namespace Highsoft.Web.Mvc.Stocks
{
	public partial class PlotOptionsWmaDataLabels  : BaseObject
	{
		public PlotOptionsWmaDataLabels()
		{
			...
			Style = Style_DefaultValue = new PlotOptionsWmaDataLabelsStyle();
		...
		/// </summary>
		public PlotOptionsWmaDataLabelsStyle Style { get; set; }
		private PlotOptionsWmaDataLabelsStyle Style_DefaultValue { get; set; }
