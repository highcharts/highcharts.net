...
{
	public partial class PlotOptionsWmaLabel  : BaseObject
	{
		public PlotOptionsWmaLabel()
		{
			...
			Style = Style_DefaultValue = new PlotOptionsWmaLabelStyle();
		...
		/// </summary>
		public PlotOptionsWmaLabelStyle Style { get; set; }
		private PlotOptionsWmaLabelStyle Style_DefaultValue { get; set; }
