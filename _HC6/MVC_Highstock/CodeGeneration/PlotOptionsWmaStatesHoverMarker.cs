...
{
	public partial class PlotOptionsWmaStatesHoverMarker  : BaseObject
	{
		public PlotOptionsWmaStatesHoverMarker()
		{
			...
			States = States_DefaultValue = new PlotOptionsWmaStatesHoverMarkerStates();
		...
		/// </summary>
		public PlotOptionsWmaStatesHoverMarkerStates States { get; set; }
		private PlotOptionsWmaStatesHoverMarkerStates States_DefaultValue { get; set; }
