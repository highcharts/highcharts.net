...
namespace Highsoft.Web.Mvc.Stocks
{
	public partial class PlotOptionsZigzagDataLabels  : BaseObject
	{
		public PlotOptionsZigzagDataLabels()
		{
			...
			Style = Style_DefaultValue = new PlotOptionsZigzagDataLabelsStyle();
		...
		/// </summary>
		public PlotOptionsZigzagDataLabelsStyle Style { get; set; }
		private PlotOptionsZigzagDataLabelsStyle Style_DefaultValue { get; set; }
