...
{
	public partial class PlotOptionsZigzagLabel  : BaseObject
	{
		public PlotOptionsZigzagLabel()
		{
			...
			Style = Style_DefaultValue = new PlotOptionsZigzagLabelStyle();
		...
		/// </summary>
		public PlotOptionsZigzagLabelStyle Style { get; set; }
		private PlotOptionsZigzagLabelStyle Style_DefaultValue { get; set; }
