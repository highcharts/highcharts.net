...
{
	public partial class PlotOptionsZigzagMarker  : BaseObject
	{
		public PlotOptionsZigzagMarker()
		{
			...
			States = States_DefaultValue = new PlotOptionsZigzagMarkerStates();
		...
		/// </summary>
		public PlotOptionsZigzagMarkerStates States { get; set; }
		private PlotOptionsZigzagMarkerStates States_DefaultValue { get; set; }
