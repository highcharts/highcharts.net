...
{
	public partial class PolygonSeries  : BaseObject
	{
		public PolygonSeries()
		{
			...
			Ikh = Ikh_DefaultValue = new PolygonSeriesIkh();
		...
		/// </summary>
		public PolygonSeriesIkh Ikh { get; set; }
		private PolygonSeriesIkh Ikh_DefaultValue { get; set; }
