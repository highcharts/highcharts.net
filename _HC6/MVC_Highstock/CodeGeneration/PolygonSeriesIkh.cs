...
{
	public partial class PolygonSeriesIkh  : BaseObject
	{
		public PolygonSeriesIkh()
		{
			Name = Name_DefaultValue = "SMA (14)";
			Tooltip = Tooltip_DefaultValue = new PolygonSeriesIkhTooltip();
			LinkedTo = LinkedTo_DefaultValue = null;
			Params = Params_DefaultValue = new PolygonSeriesIkhParams();
			Linecap = Linecap_DefaultValue = PolygonSeriesIkhLinecap.Round;
			BoostThreshold = BoostThreshold_DefaultValue = 5000;
			GapSize = GapSize_DefaultValue = 0;
			GapUnit = GapUnit_DefaultValue = PolygonSeriesIkhGapUnit.Relative;
			Label = Label_DefaultValue = new PolygonSeriesIkhLabel();
			DataGrouping = DataGrouping_DefaultValue = new PolygonSeriesIkhDataGrouping();
			LineWidth = LineWidth_DefaultValue = 2;
			AllowPointSelect = AllowPointSelect_DefaultValue = false;
			ShowCheckbox = ShowCheckbox_DefaultValue = false;
			Animation = Animation_DefaultValue = new Animation() { Enabled = true };
			Events = Events_DefaultValue = new PolygonSeriesIkhEvents();
			Marker = Marker_DefaultValue = new PolygonSeriesIkhMarker();
			Point = Point_DefaultValue = new PolygonSeriesIkhPoint();
			DataLabels = DataLabels_DefaultValue = new PolygonSeriesIkhDataLabels();
			CropThreshold = CropThreshold_DefaultValue = 300;
			SoftThreshold = SoftThreshold_DefaultValue = true;
			States = States_DefaultValue = new PolygonSeriesIkhStates();
			StickyTracking = StickyTracking_DefaultValue = null;
			TurboThreshold = TurboThreshold_DefaultValue = 1000;
			FindNearestPointBy = FindNearestPointBy_DefaultValue = PolygonSeriesIkhFindNearestPointBy.X;
			AnimationLimit = AnimationLimit_DefaultValue = null;
			ClassName = ClassName_DefaultValue = null;
			Color = Color_DefaultValue = null;
			ColorIndex = ColorIndex_DefaultValue = null;
			ConnectNulls = ConnectNulls_DefaultValue = false;
			Cursor = Cursor_DefaultValue = PolygonSeriesIkhCursor.Null;
			DashStyle = DashStyle_DefaultValue = PolygonSeriesIkhDashStyle.Solid;
			...
			Step = Step_DefaultValue = PolygonSeriesIkhStep.Null;
			Threshold = Threshold_DefaultValue = 0;
			Visible = Visible_DefaultValue = true;
			ZoneAxis = ZoneAxis_DefaultValue = "y";
			Zones = Zones_DefaultValue = new List<PolygonSeriesIkhZone>();
			...
			PointIntervalUnit = PointIntervalUnit_DefaultValue = PolygonSeriesIkhPointIntervalUnit.Null;
			PointPlacement = PointPlacement_DefaultValue = new PointPlacement();
			PointStart = PointStart_DefaultValue = 0;
			Stacking = Stacking_DefaultValue = PolygonSeriesIkhStacking.Null;
			Compare = Compare_DefaultValue = "undefined";
			CompareBase = CompareBase_DefaultValue = PolygonSeriesIkhCompareBase.Min;
		...
		/// </summary>
		public PolygonSeriesIkhTooltip Tooltip { get; set; }
		private PolygonSeriesIkhTooltip Tooltip_DefaultValue { get; set; }
		...
		/// 
		/// </summary>
		public PolygonSeriesIkhParams Params { get; set; }
		private PolygonSeriesIkhParams Params_DefaultValue { get; set; }
		...
		/// </summary>
		public PolygonSeriesIkhLinecap Linecap { get; set; }
		private PolygonSeriesIkhLinecap Linecap_DefaultValue { get; set; }
		...
		/// </summary>
		public PolygonSeriesIkhGapUnit GapUnit { get; set; }
		private PolygonSeriesIkhGapUnit GapUnit_DefaultValue { get; set; }
		...
		/// </summary>
		public PolygonSeriesIkhLabel Label { get; set; }
		private PolygonSeriesIkhLabel Label_DefaultValue { get; set; }
		...
		/// </summary>
		public PolygonSeriesIkhDataGrouping DataGrouping { get; set; }
		private PolygonSeriesIkhDataGrouping DataGrouping_DefaultValue { get; set; }
		...
		/// </summary>
		public PolygonSeriesIkhEvents Events { get; set; }
		private PolygonSeriesIkhEvents Events_DefaultValue { get; set; }
		...
		/// </summary>
		public PolygonSeriesIkhMarker Marker { get; set; }
		private PolygonSeriesIkhMarker Marker_DefaultValue { get; set; }
		 

		/// <summary>
		/// <p>Properties for each single point.</p>
		/// </summary>
		public PolygonSeriesIkhPoint Point { get; set; }
		private PolygonSeriesIkhPoint Point_DefaultValue { get; set; }
		...
		/// </summary>
		public PolygonSeriesIkhDataLabels DataLabels { get; set; }
		private PolygonSeriesIkhDataLabels DataLabels_DefaultValue { get; set; }
		...
		/// </summary>
		public PolygonSeriesIkhStates States { get; set; }
		private PolygonSeriesIkhStates States_DefaultValue { get; set; }
		...
		/// </summary>
		public PolygonSeriesIkhFindNearestPointBy FindNearestPointBy { get; set; }
		private PolygonSeriesIkhFindNearestPointBy FindNearestPointBy_DefaultValue { get; set; }
		...
		/// </summary>
		public PolygonSeriesIkhCursor Cursor { get; set; }
		private PolygonSeriesIkhCursor Cursor_DefaultValue { get; set; }
		...
		/// </summary>
		public PolygonSeriesIkhDashStyle DashStyle { get; set; }
		private PolygonSeriesIkhDashStyle DashStyle_DefaultValue { get; set; }
		...
		/// </summary>
		public PolygonSeriesIkhStep Step { get; set; }
		private PolygonSeriesIkhStep Step_DefaultValue { get; set; }
		...
		/// </summary>
		public List<PolygonSeriesIkhZone> Zones { get; set; }
		private List<PolygonSeriesIkhZone> Zones_DefaultValue { get; set; }
		...
		/// </summary>
		public PolygonSeriesIkhPointIntervalUnit PointIntervalUnit { get; set; }
		private PolygonSeriesIkhPointIntervalUnit PointIntervalUnit_DefaultValue { get; set; }
		...
		/// </summary>
		public PolygonSeriesIkhStacking Stacking { get; set; }
		private PolygonSeriesIkhStacking Stacking_DefaultValue { get; set; }
		...
		/// </summary>
		public PolygonSeriesIkhCompareBase CompareBase { get; set; }
		private PolygonSeriesIkhCompareBase CompareBase_DefaultValue { get; set; }
		...
		internal override Hashtable ToHashtable()
		{
			...
			if (PointDescriptionFormatter != PointDescriptionFormatter_DefaultValue) { h.Add("pointDescriptionFormatter",PointDescriptionFormatter); Highstock.AddFunction("PolygonSeriesIkhPointDescriptionFormatter.pointDescriptionFormatter", PointDescriptionFormatter); }  
