...
{
	public partial class PolygonSeriesIkhDataGrouping  : BaseObject
	{
		public PolygonSeriesIkhDataGrouping()
		{
			Approximation = Approximation_DefaultValue = PolygonSeriesIkhDataGroupingApproximation.Average;
		...
		/// </summary>
		public PolygonSeriesIkhDataGroupingApproximation Approximation { get; set; }
		private PolygonSeriesIkhDataGroupingApproximation Approximation_DefaultValue { get; set; }
