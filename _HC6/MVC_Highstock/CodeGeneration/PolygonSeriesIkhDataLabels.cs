...
{
	public partial class PolygonSeriesIkhDataLabels  : BaseObject
	{
		public PolygonSeriesIkhDataLabels()
		{
			Align = Align_DefaultValue = PolygonSeriesIkhDataLabelsAlign.Center;
			Formatter = Formatter_DefaultValue = "";
			Style = Style_DefaultValue = new PolygonSeriesIkhDataLabelsStyle();
			VerticalAlign = VerticalAlign_DefaultValue = PolygonSeriesIkhDataLabelsVerticalAlign.Bottom;
			X = X_DefaultValue = 0;
			Y = Y_DefaultValue = -6;
			...
			Overflow = Overflow_DefaultValue = PolygonSeriesIkhDataLabelsOverflow.Justify;
		...
		/// </summary>
		public PolygonSeriesIkhDataLabelsAlign Align { get; set; }
		private PolygonSeriesIkhDataLabelsAlign Align_DefaultValue { get; set; }
		...
		/// </summary>
		public PolygonSeriesIkhDataLabelsStyle Style { get; set; }
		private PolygonSeriesIkhDataLabelsStyle Style_DefaultValue { get; set; }
		...
		/// </summary>
		public PolygonSeriesIkhDataLabelsVerticalAlign VerticalAlign { get; set; }
		private PolygonSeriesIkhDataLabelsVerticalAlign VerticalAlign_DefaultValue { get; set; }
		...
		/// </summary>
		public PolygonSeriesIkhDataLabelsOverflow Overflow { get; set; }
		private PolygonSeriesIkhDataLabelsOverflow Overflow_DefaultValue { get; set; }
		...
		internal override Hashtable ToHashtable()
		{
			...
			if (Formatter != Formatter_DefaultValue) { h.Add("formatter",Formatter); Highstock.AddFunction("PolygonSeriesIkhDataLabelsFormatter.formatter", Formatter); }  
