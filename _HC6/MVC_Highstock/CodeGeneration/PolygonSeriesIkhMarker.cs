...
{
	public partial class PolygonSeriesIkhMarker  : BaseObject
	{
		public PolygonSeriesIkhMarker()
		{
			LineWidth = LineWidth_DefaultValue = 0;
			LineColor = LineColor_DefaultValue = "#ffffff";
			Radius = Radius_DefaultValue = 4;
			States = States_DefaultValue = new PolygonSeriesIkhMarkerStates();
		...
		/// </summary>
		public PolygonSeriesIkhMarkerStates States { get; set; }
		private PolygonSeriesIkhMarkerStates States_DefaultValue { get; set; }
