...
{
	public partial class PolygonSeriesIkhStatesHover  : BaseObject
	{
		public PolygonSeriesIkhStatesHover()
		{
			LineWidthPlus = LineWidthPlus_DefaultValue = 1;
			Marker = Marker_DefaultValue = new PolygonSeriesIkhStatesHoverMarker();
			Halo = Halo_DefaultValue = new PolygonSeriesIkhStatesHoverHalo();
		...
		/// </summary>
		public PolygonSeriesIkhStatesHoverMarker Marker { get; set; }
		private PolygonSeriesIkhStatesHoverMarker Marker_DefaultValue { get; set; }
		...
		/// </summary>
		public PolygonSeriesIkhStatesHoverHalo Halo { get; set; }
		private PolygonSeriesIkhStatesHoverHalo Halo_DefaultValue { get; set; }
