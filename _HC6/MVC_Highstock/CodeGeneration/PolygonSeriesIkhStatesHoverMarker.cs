...
{
	public partial class PolygonSeriesIkhStatesHoverMarker  : BaseObject
	{
		public PolygonSeriesIkhStatesHoverMarker()
		{
			LineWidth = LineWidth_DefaultValue = 0;
			LineColor = LineColor_DefaultValue = "#ffffff";
			Radius = Radius_DefaultValue = 4;
			States = States_DefaultValue = new PolygonSeriesIkhStatesHoverMarkerStates();
		...
		/// </summary>
		public PolygonSeriesIkhStatesHoverMarkerStates States { get; set; }
		private PolygonSeriesIkhStatesHoverMarkerStates States_DefaultValue { get; set; }
