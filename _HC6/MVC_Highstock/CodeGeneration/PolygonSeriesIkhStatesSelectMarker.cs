...
{
	public partial class PolygonSeriesIkhStatesSelectMarker  : BaseObject
	{
		public PolygonSeriesIkhStatesSelectMarker()
		{
			LineWidth = LineWidth_DefaultValue = 0;
			LineColor = LineColor_DefaultValue = "#ffffff";
			Radius = Radius_DefaultValue = 4;
			States = States_DefaultValue = new PolygonSeriesIkhStatesSelectMarkerStates();
		...
		/// </summary>
		public PolygonSeriesIkhStatesSelectMarkerStates States { get; set; }
		private PolygonSeriesIkhStatesSelectMarkerStates States_DefaultValue { get; set; }
