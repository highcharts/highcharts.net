...
{
	public partial class PolygonSeriesIkhTooltip  : BaseObject
	{
		public PolygonSeriesIkhTooltip()
		{
			ValueDecimals = ValueDecimals_DefaultValue = null;
			DateTimeLabelFormats = DateTimeLabelFormats_DefaultValue = new PolygonSeriesIkhTooltipDateTimeLabelFormats();
		...
		/// </summary>
		public PolygonSeriesIkhTooltipDateTimeLabelFormats DateTimeLabelFormats { get; set; }
		private PolygonSeriesIkhTooltipDateTimeLabelFormats DateTimeLabelFormats_DefaultValue { get; set; }
		...
		internal override Hashtable ToHashtable()
		{
			...
			if (PointFormatter != PointFormatter_DefaultValue) { h.Add("pointFormatter",PointFormatter); Highstock.AddFunction("PolygonSeriesIkhTooltipPointFormatter.pointFormatter", PointFormatter); }  
