...
{
	public partial class PolygonSeriesStatesSelectMarker  : BaseObject
	{
		public PolygonSeriesStatesSelectMarker()
		{
			LineWidth = LineWidth_DefaultValue = 0;
			LineColor = LineColor_DefaultValue = "#ffffff";
			Radius = Radius_DefaultValue = 4;
			States = States_DefaultValue = new PolygonSeriesStatesSelectMarkerStates();
		...
		/// </summary>
		public PolygonSeriesStatesSelectMarkerStates States { get; set; }
		private PolygonSeriesStatesSelectMarkerStates States_DefaultValue { get; set; }
