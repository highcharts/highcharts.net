...
namespace Highsoft.Web.Mvc.Stocks
{
	public partial class PolygonSeriesTooltip  : BaseObject
	{
		public PolygonSeriesTooltip()
		{
			...
			DateTimeLabelFormats = DateTimeLabelFormats_DefaultValue = new PolygonSeriesTooltipDateTimeLabelFormats();
		...
		/// </summary>
		public PolygonSeriesTooltipDateTimeLabelFormats DateTimeLabelFormats { get; set; }
		private PolygonSeriesTooltipDateTimeLabelFormats DateTimeLabelFormats_DefaultValue { get; set; }
