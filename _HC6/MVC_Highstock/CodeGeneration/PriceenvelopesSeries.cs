...
namespace Highsoft.Web.Mvc.Stocks
{
	public partial class PriceenvelopesSeries  : Series
	{
		...
		{
			Ikh = Ikh_DefaultValue = new PriceenvelopesSeriesIkh();
			Id = Id_DefaultValue = null;
			Index = Index_DefaultValue = null;
			LegendIndex = LegendIndex_DefaultValue = null;
			Name = Name_DefaultValue = "Price envelopes (20, 0.1, 0.1)";
			...
			PointIntervalUnit = PointIntervalUnit_DefaultValue = PriceenvelopesSeriesPointIntervalUnit.Null;
			PointPlacement = PointPlacement_DefaultValue = new PointPlacement();
			PointStart = PointStart_DefaultValue = 0;
			Stacking = Stacking_DefaultValue = PriceenvelopesSeriesStacking.Null;
		...
		/// </summary>
		public PriceenvelopesSeriesIkh Ikh { get; set; }
		private PriceenvelopesSeriesIkh Ikh_DefaultValue { get; set; }
		...
		/// </summary>
		public PriceenvelopesSeriesPointIntervalUnit PointIntervalUnit { get; set; }
		private PriceenvelopesSeriesPointIntervalUnit PointIntervalUnit_DefaultValue { get; set; }
		...
		/// </summary>
		public PriceenvelopesSeriesStacking Stacking { get; set; }
		private PriceenvelopesSeriesStacking Stacking_DefaultValue { get; set; }
