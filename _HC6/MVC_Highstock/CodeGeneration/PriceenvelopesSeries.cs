...
namespace Highsoft.Web.Mvc.Stocks
{
	public partial class PriceenvelopesSeries  : Series
	{
		public PriceenvelopesSeries()
		{
			...
			Zones = Zones_DefaultValue = new PriceenvelopesSeriesZone();
		...
		/// </summary>
		public PriceenvelopesSeriesZone Zones { get; set; }
		private PriceenvelopesSeriesZone Zones_DefaultValue { get; set; }
