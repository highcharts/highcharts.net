...
{
	public partial class PriceenvelopesSeriesDataDragDrop  : BaseObject
	{
		public PriceenvelopesSeriesDataDragDrop()
		{
			DraggableX = DraggableX_DefaultValue = null;
			DraggableY = DraggableY_DefaultValue = null;
			DragHandle = DragHandle_DefaultValue = new PriceenvelopesSeriesDataDragDropDragHandle();
			...
			GuideBox = GuideBox_DefaultValue = new PriceenvelopesSeriesDataDragDropGuideBox();
		...
		/// </summary>
		public PriceenvelopesSeriesDataDragDropDragHandle DragHandle { get; set; }
		private PriceenvelopesSeriesDataDragDropDragHandle DragHandle_DefaultValue { get; set; }
		...
		/// </summary>
		public PriceenvelopesSeriesDataDragDropGuideBox GuideBox { get; set; }
		private PriceenvelopesSeriesDataDragDropGuideBox GuideBox_DefaultValue { get; set; }
