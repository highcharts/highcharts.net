...
{
	public partial class PriceenvelopesSeriesDataDragDropDragHandle  : BaseObject
	{
		public PriceenvelopesSeriesDataDragDropDragHandle()
		{
		...
		internal override Hashtable ToHashtable()
		{
			...
			if (PathFormatter != PathFormatter_DefaultValue) { h.Add("pathFormatter",PathFormatter); Highstock.AddFunction("PriceenvelopesSeriesDataDragDropDragHandlePathFormatter.pathFormatter", PathFormatter); }  
