...
{
	public partial class PriceenvelopesSeriesDataGrouping  : BaseObject
	{
		public PriceenvelopesSeriesDataGrouping()
		{
			Approximation = Approximation_DefaultValue = PriceenvelopesSeriesDataGroupingApproximation.Average;
		...
		/// </summary>
		public PriceenvelopesSeriesDataGroupingApproximation Approximation { get; set; }
		private PriceenvelopesSeriesDataGroupingApproximation Approximation_DefaultValue { get; set; }
		...
		/// </summary>
		public PriceenvelopesSeriesDataGroupingUnits Units { get; set; }
		private PriceenvelopesSeriesDataGroupingUnits Units_DefaultValue { get; set; }
