...
namespace Highsoft.Web.Mvc.Stocks
{
	public partial class PriceenvelopesSeriesDataLabels  : BaseObject
	{
		public PriceenvelopesSeriesDataLabels()
		{
			...
			Style = Style_DefaultValue = new PriceenvelopesSeriesDataLabelsStyle();
		...
		/// </summary>
		public PriceenvelopesSeriesDataLabelsStyle Style { get; set; }
		private PriceenvelopesSeriesDataLabelsStyle Style_DefaultValue { get; set; }
