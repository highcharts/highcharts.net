...
{
	public partial class PriceenvelopesSeriesDataMarker  : BaseObject
	{
		public PriceenvelopesSeriesDataMarker()
		{
			...
			States = States_DefaultValue = new PriceenvelopesSeriesDataMarkerStates();
		...
		/// </summary>
		public PriceenvelopesSeriesDataMarkerStates States { get; set; }
		private PriceenvelopesSeriesDataMarkerStates States_DefaultValue { get; set; }
