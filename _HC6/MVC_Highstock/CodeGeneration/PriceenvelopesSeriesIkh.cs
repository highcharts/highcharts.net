...
{
	public partial class PriceenvelopesSeriesIkh  : BaseObject
	{
		public PriceenvelopesSeriesIkh()
		{
			Name = Name_DefaultValue = "SMA (14)";
			Tooltip = Tooltip_DefaultValue = new PriceenvelopesSeriesIkhTooltip();
			LinkedTo = LinkedTo_DefaultValue = null;
			Params = Params_DefaultValue = new PriceenvelopesSeriesIkhParams();
			Linecap = Linecap_DefaultValue = PriceenvelopesSeriesIkhLinecap.Round;
			BoostThreshold = BoostThreshold_DefaultValue = 5000;
			GapSize = GapSize_DefaultValue = 0;
			GapUnit = GapUnit_DefaultValue = PriceenvelopesSeriesIkhGapUnit.Relative;
			Label = Label_DefaultValue = new PriceenvelopesSeriesIkhLabel();
			DataGrouping = DataGrouping_DefaultValue = new PriceenvelopesSeriesIkhDataGrouping();
			LineWidth = LineWidth_DefaultValue = 2;
			AllowPointSelect = AllowPointSelect_DefaultValue = false;
			ShowCheckbox = ShowCheckbox_DefaultValue = false;
			Animation = Animation_DefaultValue = new Animation() { Enabled = true };
			Events = Events_DefaultValue = new PriceenvelopesSeriesIkhEvents();
			Marker = Marker_DefaultValue = new PriceenvelopesSeriesIkhMarker();
			Point = Point_DefaultValue = new PriceenvelopesSeriesIkhPoint();
			DataLabels = DataLabels_DefaultValue = new PriceenvelopesSeriesIkhDataLabels();
			CropThreshold = CropThreshold_DefaultValue = 300;
			SoftThreshold = SoftThreshold_DefaultValue = true;
			States = States_DefaultValue = new PriceenvelopesSeriesIkhStates();
			StickyTracking = StickyTracking_DefaultValue = null;
			TurboThreshold = TurboThreshold_DefaultValue = 1000;
			FindNearestPointBy = FindNearestPointBy_DefaultValue = PriceenvelopesSeriesIkhFindNearestPointBy.X;
			AnimationLimit = AnimationLimit_DefaultValue = null;
			ClassName = ClassName_DefaultValue = null;
			Color = Color_DefaultValue = null;
			ColorIndex = ColorIndex_DefaultValue = null;
			ConnectNulls = ConnectNulls_DefaultValue = false;
			Cursor = Cursor_DefaultValue = PriceenvelopesSeriesIkhCursor.Null;
			DashStyle = DashStyle_DefaultValue = PriceenvelopesSeriesIkhDashStyle.Solid;
			...
			Step = Step_DefaultValue = PriceenvelopesSeriesIkhStep.Null;
			Threshold = Threshold_DefaultValue = 0;
			Visible = Visible_DefaultValue = true;
			ZoneAxis = ZoneAxis_DefaultValue = "y";
			Zones = Zones_DefaultValue = new List<PriceenvelopesSeriesIkhZone>();
			...
			PointIntervalUnit = PointIntervalUnit_DefaultValue = PriceenvelopesSeriesIkhPointIntervalUnit.Null;
			PointPlacement = PointPlacement_DefaultValue = new PointPlacement();
			PointStart = PointStart_DefaultValue = 0;
			Stacking = Stacking_DefaultValue = PriceenvelopesSeriesIkhStacking.Null;
			Compare = Compare_DefaultValue = "undefined";
			CompareBase = CompareBase_DefaultValue = PriceenvelopesSeriesIkhCompareBase.Min;
		...
		/// </summary>
		public PriceenvelopesSeriesIkhTooltip Tooltip { get; set; }
		private PriceenvelopesSeriesIkhTooltip Tooltip_DefaultValue { get; set; }
		...
		/// 
		/// </summary>
		public PriceenvelopesSeriesIkhParams Params { get; set; }
		private PriceenvelopesSeriesIkhParams Params_DefaultValue { get; set; }
		...
		/// </summary>
		public PriceenvelopesSeriesIkhLinecap Linecap { get; set; }
		private PriceenvelopesSeriesIkhLinecap Linecap_DefaultValue { get; set; }
		...
		/// </summary>
		public PriceenvelopesSeriesIkhGapUnit GapUnit { get; set; }
		private PriceenvelopesSeriesIkhGapUnit GapUnit_DefaultValue { get; set; }
		...
		/// </summary>
		public PriceenvelopesSeriesIkhLabel Label { get; set; }
		private PriceenvelopesSeriesIkhLabel Label_DefaultValue { get; set; }
		...
		/// </summary>
		public PriceenvelopesSeriesIkhDataGrouping DataGrouping { get; set; }
		private PriceenvelopesSeriesIkhDataGrouping DataGrouping_DefaultValue { get; set; }
		...
		/// </summary>
		public PriceenvelopesSeriesIkhEvents Events { get; set; }
		private PriceenvelopesSeriesIkhEvents Events_DefaultValue { get; set; }
		...
		/// </summary>
		public PriceenvelopesSeriesIkhMarker Marker { get; set; }
		private PriceenvelopesSeriesIkhMarker Marker_DefaultValue { get; set; }
		 

		/// <summary>
		/// <p>Properties for each single point.</p>
		/// </summary>
		public PriceenvelopesSeriesIkhPoint Point { get; set; }
		private PriceenvelopesSeriesIkhPoint Point_DefaultValue { get; set; }
		...
		/// </summary>
		public PriceenvelopesSeriesIkhDataLabels DataLabels { get; set; }
		private PriceenvelopesSeriesIkhDataLabels DataLabels_DefaultValue { get; set; }
		...
		/// </summary>
		public PriceenvelopesSeriesIkhStates States { get; set; }
		private PriceenvelopesSeriesIkhStates States_DefaultValue { get; set; }
		...
		/// </summary>
		public PriceenvelopesSeriesIkhFindNearestPointBy FindNearestPointBy { get; set; }
		private PriceenvelopesSeriesIkhFindNearestPointBy FindNearestPointBy_DefaultValue { get; set; }
		...
		/// </summary>
		public PriceenvelopesSeriesIkhCursor Cursor { get; set; }
		private PriceenvelopesSeriesIkhCursor Cursor_DefaultValue { get; set; }
		...
		/// </summary>
		public PriceenvelopesSeriesIkhDashStyle DashStyle { get; set; }
		private PriceenvelopesSeriesIkhDashStyle DashStyle_DefaultValue { get; set; }
		...
		/// </summary>
		public PriceenvelopesSeriesIkhStep Step { get; set; }
		private PriceenvelopesSeriesIkhStep Step_DefaultValue { get; set; }
		...
		/// </summary>
		public List<PriceenvelopesSeriesIkhZone> Zones { get; set; }
		private List<PriceenvelopesSeriesIkhZone> Zones_DefaultValue { get; set; }
		...
		/// </summary>
		public PriceenvelopesSeriesIkhPointIntervalUnit PointIntervalUnit { get; set; }
		private PriceenvelopesSeriesIkhPointIntervalUnit PointIntervalUnit_DefaultValue { get; set; }
		...
		/// </summary>
		public PriceenvelopesSeriesIkhStacking Stacking { get; set; }
		private PriceenvelopesSeriesIkhStacking Stacking_DefaultValue { get; set; }
		...
		/// </summary>
		public PriceenvelopesSeriesIkhCompareBase CompareBase { get; set; }
		private PriceenvelopesSeriesIkhCompareBase CompareBase_DefaultValue { get; set; }
		...
		internal override Hashtable ToHashtable()
		{
			...
			if (PointDescriptionFormatter != PointDescriptionFormatter_DefaultValue) { h.Add("pointDescriptionFormatter",PointDescriptionFormatter); Highstock.AddFunction("PriceenvelopesSeriesIkhPointDescriptionFormatter.pointDescriptionFormatter", PointDescriptionFormatter); }  
