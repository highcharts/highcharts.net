...
namespace Highsoft.Web.Mvc.Stocks
{
	public partial class PriceenvelopesSeriesIkh  : BaseObject
	{
		public PriceenvelopesSeriesIkh()
		{
			...
			Zones = Zones_DefaultValue = new PriceenvelopesSeriesIkhZone();
		...
		/// </summary>
		public PriceenvelopesSeriesIkhZone Zones { get; set; }
		private PriceenvelopesSeriesIkhZone Zones_DefaultValue { get; set; }
