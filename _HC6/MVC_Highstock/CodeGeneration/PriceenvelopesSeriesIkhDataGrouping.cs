...
{
	public partial class PriceenvelopesSeriesIkhDataGrouping  : BaseObject
	{
		public PriceenvelopesSeriesIkhDataGrouping()
		{
			Approximation = Approximation_DefaultValue = PriceenvelopesSeriesIkhDataGroupingApproximation.Average;
		...
		/// </summary>
		public PriceenvelopesSeriesIkhDataGroupingApproximation Approximation { get; set; }
		private PriceenvelopesSeriesIkhDataGroupingApproximation Approximation_DefaultValue { get; set; }
