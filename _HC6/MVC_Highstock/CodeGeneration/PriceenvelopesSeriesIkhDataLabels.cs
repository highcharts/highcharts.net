...
{
	public partial class PriceenvelopesSeriesIkhDataLabels  : BaseObject
	{
		public PriceenvelopesSeriesIkhDataLabels()
		{
			Align = Align_DefaultValue = PriceenvelopesSeriesIkhDataLabelsAlign.Center;
			Formatter = Formatter_DefaultValue = "";
			Style = Style_DefaultValue = new PriceenvelopesSeriesIkhDataLabelsStyle();
			VerticalAlign = VerticalAlign_DefaultValue = PriceenvelopesSeriesIkhDataLabelsVerticalAlign.Bottom;
			X = X_DefaultValue = 0;
			Y = Y_DefaultValue = -6;
			...
			Overflow = Overflow_DefaultValue = PriceenvelopesSeriesIkhDataLabelsOverflow.Justify;
		...
		/// </summary>
		public PriceenvelopesSeriesIkhDataLabelsAlign Align { get; set; }
		private PriceenvelopesSeriesIkhDataLabelsAlign Align_DefaultValue { get; set; }
		...
		/// </summary>
		public PriceenvelopesSeriesIkhDataLabelsStyle Style { get; set; }
		private PriceenvelopesSeriesIkhDataLabelsStyle Style_DefaultValue { get; set; }
		...
		/// </summary>
		public PriceenvelopesSeriesIkhDataLabelsVerticalAlign VerticalAlign { get; set; }
		private PriceenvelopesSeriesIkhDataLabelsVerticalAlign VerticalAlign_DefaultValue { get; set; }
		...
		/// </summary>
		public PriceenvelopesSeriesIkhDataLabelsOverflow Overflow { get; set; }
		private PriceenvelopesSeriesIkhDataLabelsOverflow Overflow_DefaultValue { get; set; }
		...
		internal override Hashtable ToHashtable()
		{
			...
			if (Formatter != Formatter_DefaultValue) { h.Add("formatter",Formatter); Highstock.AddFunction("PriceenvelopesSeriesIkhDataLabelsFormatter.formatter", Formatter); }  
