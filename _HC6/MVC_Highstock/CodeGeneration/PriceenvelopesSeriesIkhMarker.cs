...
{
	public partial class PriceenvelopesSeriesIkhMarker  : BaseObject
	{
		public PriceenvelopesSeriesIkhMarker()
		{
			LineWidth = LineWidth_DefaultValue = 0;
			LineColor = LineColor_DefaultValue = "#ffffff";
			Radius = Radius_DefaultValue = 4;
			States = States_DefaultValue = new PriceenvelopesSeriesIkhMarkerStates();
		...
		/// </summary>
		public PriceenvelopesSeriesIkhMarkerStates States { get; set; }
		private PriceenvelopesSeriesIkhMarkerStates States_DefaultValue { get; set; }
