...
{
	public partial class PriceenvelopesSeriesIkhStatesHover  : BaseObject
	{
		public PriceenvelopesSeriesIkhStatesHover()
		{
			LineWidthPlus = LineWidthPlus_DefaultValue = 1;
			Marker = Marker_DefaultValue = new PriceenvelopesSeriesIkhStatesHoverMarker();
			Halo = Halo_DefaultValue = new PriceenvelopesSeriesIkhStatesHoverHalo();
		...
		/// </summary>
		public PriceenvelopesSeriesIkhStatesHoverMarker Marker { get; set; }
		private PriceenvelopesSeriesIkhStatesHoverMarker Marker_DefaultValue { get; set; }
		...
		/// </summary>
		public PriceenvelopesSeriesIkhStatesHoverHalo Halo { get; set; }
		private PriceenvelopesSeriesIkhStatesHoverHalo Halo_DefaultValue { get; set; }
