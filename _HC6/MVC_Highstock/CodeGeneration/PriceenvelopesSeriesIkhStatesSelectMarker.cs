...
{
	public partial class PriceenvelopesSeriesIkhStatesSelectMarker  : BaseObject
	{
		public PriceenvelopesSeriesIkhStatesSelectMarker()
		{
			LineWidth = LineWidth_DefaultValue = 0;
			LineColor = LineColor_DefaultValue = "#ffffff";
			Radius = Radius_DefaultValue = 4;
			States = States_DefaultValue = new PriceenvelopesSeriesIkhStatesSelectMarkerStates();
		...
		/// </summary>
		public PriceenvelopesSeriesIkhStatesSelectMarkerStates States { get; set; }
		private PriceenvelopesSeriesIkhStatesSelectMarkerStates States_DefaultValue { get; set; }
