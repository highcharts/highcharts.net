...
{
	public partial class PriceenvelopesSeriesIkhTooltip  : BaseObject
	{
		public PriceenvelopesSeriesIkhTooltip()
		{
			ValueDecimals = ValueDecimals_DefaultValue = null;
			DateTimeLabelFormats = DateTimeLabelFormats_DefaultValue = new PriceenvelopesSeriesIkhTooltipDateTimeLabelFormats();
		...
		/// </summary>
		public PriceenvelopesSeriesIkhTooltipDateTimeLabelFormats DateTimeLabelFormats { get; set; }
		private PriceenvelopesSeriesIkhTooltipDateTimeLabelFormats DateTimeLabelFormats_DefaultValue { get; set; }
		...
		internal override Hashtable ToHashtable()
		{
			...
			if (PointFormatter != PointFormatter_DefaultValue) { h.Add("pointFormatter",PointFormatter); Highstock.AddFunction("PriceenvelopesSeriesIkhTooltipPointFormatter.pointFormatter", PointFormatter); }  
