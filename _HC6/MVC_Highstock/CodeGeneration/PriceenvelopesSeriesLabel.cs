...
{
	public partial class PriceenvelopesSeriesLabel  : BaseObject
	{
		public PriceenvelopesSeriesLabel()
		{
			...
			Style = Style_DefaultValue = new PriceenvelopesSeriesLabelStyle();
		...
		/// </summary>
		public PriceenvelopesSeriesLabelStyle Style { get; set; }
		private PriceenvelopesSeriesLabelStyle Style_DefaultValue { get; set; }
