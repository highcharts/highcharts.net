...
{
	public partial class PriceenvelopesSeriesParams  : BaseObject
	{
		public PriceenvelopesSeriesParams()
		{
		...
		/// <summary>
		/// <p>Percentage above the moving average that should be displayed.0.1 means 110%. Relative to the calculated value.</p>
		/// </summary>
		...
		/// <summary>
		/// <p>Percentage below the moving average that should be displayed.0.1 means 90%. Relative to the calculated value.</p>
		/// </summary>
