...
namespace Highsoft.Web.Mvc.Stocks
{
	public partial class PriceenvelopesSeriesTooltip  : BaseObject
	{
		public PriceenvelopesSeriesTooltip()
		{
			...
			DateTimeLabelFormats = DateTimeLabelFormats_DefaultValue = new PriceenvelopesSeriesTooltipDateTimeLabelFormats();
		...
		/// </summary>
		public PriceenvelopesSeriesTooltipDateTimeLabelFormats DateTimeLabelFormats { get; set; }
		private PriceenvelopesSeriesTooltipDateTimeLabelFormats DateTimeLabelFormats_DefaultValue { get; set; }
