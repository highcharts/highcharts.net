...
namespace Highsoft.Web.Mvc.Stocks
{
	public partial class PsarSeries  : Series
	{
		public PsarSeries()
		{
			...
			Data = Data_DefaultValue = new List<PsarSeriesData>();
		...
		/// <summary>
		/// An array of data points for the series. For the `psar` series type,points are calculated dynamically.
		/// </summary>
		public List<PsarSeriesData> Data { get; set; }
		private List<PsarSeriesData> Data_DefaultValue { get; set; }
