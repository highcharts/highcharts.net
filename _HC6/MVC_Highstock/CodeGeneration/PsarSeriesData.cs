...
{
	public partial class PsarSeriesData  : BaseObject
	{
		public PsarSeriesData()
		{
			...
			DragDrop = DragDrop_DefaultValue = new PsarSeriesDataDragDrop();
			Drilldown = Drilldown_DefaultValue = "";
			Events = Events_DefaultValue = new PsarSeriesDataEvents();
			Id = Id_DefaultValue = "";
			Labelrank = Labelrank_DefaultValue = null;
			Marker = Marker_DefaultValue = new PsarSeriesDataMarker();
		...
		/// </summary>
		public PsarSeriesDataDragDrop DragDrop { get; set; }
		private PsarSeriesDataDragDrop DragDrop_DefaultValue { get; set; }
		...
		/// </summary>
		public PsarSeriesDataEvents Events { get; set; }
		private PsarSeriesDataEvents Events_DefaultValue { get; set; }
		...
		/// 
		/// </summary>
		public PsarSeriesDataMarker Marker { get; set; }
		private PsarSeriesDataMarker Marker_DefaultValue { get; set; }
