...
{
	public partial class PsarSeriesDataDragDrop  : BaseObject
	{
		public PsarSeriesDataDragDrop()
		{
			DraggableX = DraggableX_DefaultValue = null;
			DraggableY = DraggableY_DefaultValue = null;
			DragHandle = DragHandle_DefaultValue = new PsarSeriesDataDragDropDragHandle();
			...
			GuideBox = GuideBox_DefaultValue = new PsarSeriesDataDragDropGuideBox();
		...
		/// </summary>
		public PsarSeriesDataDragDropDragHandle DragHandle { get; set; }
		private PsarSeriesDataDragDropDragHandle DragHandle_DefaultValue { get; set; }
		...
		/// </summary>
		public PsarSeriesDataDragDropGuideBox GuideBox { get; set; }
		private PsarSeriesDataDragDropGuideBox GuideBox_DefaultValue { get; set; }
