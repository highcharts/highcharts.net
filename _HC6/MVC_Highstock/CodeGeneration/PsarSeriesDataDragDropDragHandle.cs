...
{
	public partial class PsarSeriesDataDragDropDragHandle  : BaseObject
	{
		public PsarSeriesDataDragDropDragHandle()
		{
		...
		internal override Hashtable ToHashtable()
		{
			...
			if (PathFormatter != PathFormatter_DefaultValue) { h.Add("pathFormatter",PathFormatter); Highstock.AddFunction("PsarSeriesDataDragDropDragHandlePathFormatter.pathFormatter", PathFormatter); }  
