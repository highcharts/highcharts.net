...
namespace Highsoft.Web.Mvc.Stocks
{
	public partial class PsarSeriesDataLabels  : BaseObject
	{
		public PsarSeriesDataLabels()
		{
			...
			Style = Style_DefaultValue = new PsarSeriesDataLabelsStyle();
		...
		/// </summary>
		public PsarSeriesDataLabelsStyle Style { get; set; }
		private PsarSeriesDataLabelsStyle Style_DefaultValue { get; set; }
