...
{
	public partial class PsarSeriesDataMarker  : BaseObject
	{
		public PsarSeriesDataMarker()
		{
			...
			States = States_DefaultValue = new PsarSeriesDataMarkerStates();
		...
		/// </summary>
		public PsarSeriesDataMarkerStates States { get; set; }
		private PsarSeriesDataMarkerStates States_DefaultValue { get; set; }
