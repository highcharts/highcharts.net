...
{
	public partial class PsarSeriesDragDrop  : BaseObject
	{
		public PsarSeriesDragDrop()
		{
			DraggableX = DraggableX_DefaultValue = null;
			DraggableY = DraggableY_DefaultValue = null;
			DragHandle = DragHandle_DefaultValue = new PsarSeriesDragDropDragHandle();
			...
			GuideBox = GuideBox_DefaultValue = new PsarSeriesDragDropGuideBox();
		...
		/// </summary>
		public PsarSeriesDragDropDragHandle DragHandle { get; set; }
		private PsarSeriesDragDropDragHandle DragHandle_DefaultValue { get; set; }
		...
		/// </summary>
		public PsarSeriesDragDropGuideBox GuideBox { get; set; }
		private PsarSeriesDragDropGuideBox GuideBox_DefaultValue { get; set; }
