...
{
	public partial class PsarSeriesIkhDataGrouping  : BaseObject
	{
		public PsarSeriesIkhDataGrouping()
		{
			Approximation = Approximation_DefaultValue = PsarSeriesIkhDataGroupingApproximation.Average;
		...
		/// </summary>
		public PsarSeriesIkhDataGroupingApproximation Approximation { get; set; }
		private PsarSeriesIkhDataGroupingApproximation Approximation_DefaultValue { get; set; }
