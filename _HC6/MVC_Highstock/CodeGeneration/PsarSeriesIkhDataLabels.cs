...
{
	public partial class PsarSeriesIkhDataLabels  : BaseObject
	{
		public PsarSeriesIkhDataLabels()
		{
			Align = Align_DefaultValue = PsarSeriesIkhDataLabelsAlign.Center;
			Formatter = Formatter_DefaultValue = "";
			Style = Style_DefaultValue = new PsarSeriesIkhDataLabelsStyle();
			VerticalAlign = VerticalAlign_DefaultValue = PsarSeriesIkhDataLabelsVerticalAlign.Bottom;
			X = X_DefaultValue = 0;
			Y = Y_DefaultValue = -6;
			...
			Overflow = Overflow_DefaultValue = PsarSeriesIkhDataLabelsOverflow.Justify;
		...
		/// </summary>
		public PsarSeriesIkhDataLabelsAlign Align { get; set; }
		private PsarSeriesIkhDataLabelsAlign Align_DefaultValue { get; set; }
		...
		/// </summary>
		public PsarSeriesIkhDataLabelsStyle Style { get; set; }
		private PsarSeriesIkhDataLabelsStyle Style_DefaultValue { get; set; }
		...
		/// </summary>
		public PsarSeriesIkhDataLabelsVerticalAlign VerticalAlign { get; set; }
		private PsarSeriesIkhDataLabelsVerticalAlign VerticalAlign_DefaultValue { get; set; }
		...
		/// </summary>
		public PsarSeriesIkhDataLabelsOverflow Overflow { get; set; }
		private PsarSeriesIkhDataLabelsOverflow Overflow_DefaultValue { get; set; }
		...
		internal override Hashtable ToHashtable()
		{
			...
			if (Formatter != Formatter_DefaultValue) { h.Add("formatter",Formatter); Highstock.AddFunction("PsarSeriesIkhDataLabelsFormatter.formatter", Formatter); }  
