...
{
	public partial class PsarSeriesIkhMarker  : BaseObject
	{
		public PsarSeriesIkhMarker()
		{
			LineWidth = LineWidth_DefaultValue = 0;
			LineColor = LineColor_DefaultValue = "#ffffff";
			Radius = Radius_DefaultValue = 4;
			States = States_DefaultValue = new PsarSeriesIkhMarkerStates();
		...
		/// </summary>
		public PsarSeriesIkhMarkerStates States { get; set; }
		private PsarSeriesIkhMarkerStates States_DefaultValue { get; set; }
