...
{
	public partial class PsarSeriesIkhStatesHover  : BaseObject
	{
		public PsarSeriesIkhStatesHover()
		{
			LineWidthPlus = LineWidthPlus_DefaultValue = 1;
			Marker = Marker_DefaultValue = new PsarSeriesIkhStatesHoverMarker();
			Halo = Halo_DefaultValue = new PsarSeriesIkhStatesHoverHalo();
		...
		/// </summary>
		public PsarSeriesIkhStatesHoverMarker Marker { get; set; }
		private PsarSeriesIkhStatesHoverMarker Marker_DefaultValue { get; set; }
		...
		/// </summary>
		public PsarSeriesIkhStatesHoverHalo Halo { get; set; }
		private PsarSeriesIkhStatesHoverHalo Halo_DefaultValue { get; set; }
