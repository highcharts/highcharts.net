...
{
	public partial class PsarSeriesIkhTooltip  : BaseObject
	{
		public PsarSeriesIkhTooltip()
		{
			ValueDecimals = ValueDecimals_DefaultValue = null;
			DateTimeLabelFormats = DateTimeLabelFormats_DefaultValue = new PsarSeriesIkhTooltipDateTimeLabelFormats();
		...
		/// </summary>
		public PsarSeriesIkhTooltipDateTimeLabelFormats DateTimeLabelFormats { get; set; }
		private PsarSeriesIkhTooltipDateTimeLabelFormats DateTimeLabelFormats_DefaultValue { get; set; }
		...
		internal override Hashtable ToHashtable()
		{
			...
			if (PointFormatter != PointFormatter_DefaultValue) { h.Add("pointFormatter",PointFormatter); Highstock.AddFunction("PsarSeriesIkhTooltipPointFormatter.pointFormatter", PointFormatter); }  
