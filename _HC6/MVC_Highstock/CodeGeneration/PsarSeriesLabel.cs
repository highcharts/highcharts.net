...
{
	public partial class PsarSeriesLabel  : BaseObject
	{
		public PsarSeriesLabel()
		{
			...
			Style = Style_DefaultValue = new PsarSeriesLabelStyle();
		...
		/// </summary>
		public PsarSeriesLabelStyle Style { get; set; }
		private PsarSeriesLabelStyle Style_DefaultValue { get; set; }
