...
namespace Highsoft.Web.Mvc.Stocks
{
	public partial class PsarSeriesTooltip  : BaseObject
	{
		public PsarSeriesTooltip()
		{
			...
			DateTimeLabelFormats = DateTimeLabelFormats_DefaultValue = new PsarSeriesTooltipDateTimeLabelFormats();
		...
		/// </summary>
		public PsarSeriesTooltipDateTimeLabelFormats DateTimeLabelFormats { get; set; }
		private PsarSeriesTooltipDateTimeLabelFormats DateTimeLabelFormats_DefaultValue { get; set; }
