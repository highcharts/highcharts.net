...
{
	public partial class PyramidSeriesDataGrouping  : BaseObject
	{
		...
		/// </summary>
		public PyramidSeriesDataGroupingApproximation Approximation { get; set; }
		private PyramidSeriesDataGroupingApproximation Approximation_DefaultValue { get; set; }
