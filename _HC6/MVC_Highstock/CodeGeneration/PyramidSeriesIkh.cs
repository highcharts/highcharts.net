...
{
	public partial class PyramidSeriesIkh  : BaseObject
	{
		public PyramidSeriesIkh()
		{
			Name = Name_DefaultValue = "SMA (14)";
			Tooltip = Tooltip_DefaultValue = new PyramidSeriesIkhTooltip();
			LinkedTo = LinkedTo_DefaultValue = null;
			Params = Params_DefaultValue = new PyramidSeriesIkhParams();
			Linecap = Linecap_DefaultValue = PyramidSeriesIkhLinecap.Round;
			BoostThreshold = BoostThreshold_DefaultValue = 5000;
			GapSize = GapSize_DefaultValue = 0;
			GapUnit = GapUnit_DefaultValue = PyramidSeriesIkhGapUnit.Relative;
			Label = Label_DefaultValue = new PyramidSeriesIkhLabel();
			DataGrouping = DataGrouping_DefaultValue = new PyramidSeriesIkhDataGrouping();
			LineWidth = LineWidth_DefaultValue = 2;
			AllowPointSelect = AllowPointSelect_DefaultValue = false;
			ShowCheckbox = ShowCheckbox_DefaultValue = false;
			Animation = Animation_DefaultValue = new Animation() { Enabled = true };
			Events = Events_DefaultValue = new PyramidSeriesIkhEvents();
			Marker = Marker_DefaultValue = new PyramidSeriesIkhMarker();
			Point = Point_DefaultValue = new PyramidSeriesIkhPoint();
			DataLabels = DataLabels_DefaultValue = new PyramidSeriesIkhDataLabels();
			CropThreshold = CropThreshold_DefaultValue = 300;
			SoftThreshold = SoftThreshold_DefaultValue = true;
			States = States_DefaultValue = new PyramidSeriesIkhStates();
			StickyTracking = StickyTracking_DefaultValue = null;
			TurboThreshold = TurboThreshold_DefaultValue = 1000;
			FindNearestPointBy = FindNearestPointBy_DefaultValue = PyramidSeriesIkhFindNearestPointBy.X;
			AnimationLimit = AnimationLimit_DefaultValue = null;
			ClassName = ClassName_DefaultValue = null;
			Color = Color_DefaultValue = null;
			ColorIndex = ColorIndex_DefaultValue = null;
			ConnectNulls = ConnectNulls_DefaultValue = false;
			Cursor = Cursor_DefaultValue = PyramidSeriesIkhCursor.Null;
			DashStyle = DashStyle_DefaultValue = PyramidSeriesIkhDashStyle.Solid;
			...
			Step = Step_DefaultValue = PyramidSeriesIkhStep.Null;
			Threshold = Threshold_DefaultValue = 0;
			Visible = Visible_DefaultValue = true;
			ZoneAxis = ZoneAxis_DefaultValue = "y";
			Zones = Zones_DefaultValue = new List<PyramidSeriesIkhZone>();
			...
			PointIntervalUnit = PointIntervalUnit_DefaultValue = PyramidSeriesIkhPointIntervalUnit.Null;
			PointPlacement = PointPlacement_DefaultValue = new PointPlacement();
			PointStart = PointStart_DefaultValue = 0;
			Stacking = Stacking_DefaultValue = PyramidSeriesIkhStacking.Null;
			Compare = Compare_DefaultValue = "undefined";
			CompareBase = CompareBase_DefaultValue = PyramidSeriesIkhCompareBase.Min;
		...
		/// </summary>
		public PyramidSeriesIkhTooltip Tooltip { get; set; }
		private PyramidSeriesIkhTooltip Tooltip_DefaultValue { get; set; }
		...
		/// 
		/// </summary>
		public PyramidSeriesIkhParams Params { get; set; }
		private PyramidSeriesIkhParams Params_DefaultValue { get; set; }
		...
		/// </summary>
		public PyramidSeriesIkhLinecap Linecap { get; set; }
		private PyramidSeriesIkhLinecap Linecap_DefaultValue { get; set; }
		...
		/// </summary>
		public PyramidSeriesIkhGapUnit GapUnit { get; set; }
		private PyramidSeriesIkhGapUnit GapUnit_DefaultValue { get; set; }
		...
		/// </summary>
		public PyramidSeriesIkhLabel Label { get; set; }
		private PyramidSeriesIkhLabel Label_DefaultValue { get; set; }
		...
		/// </summary>
		public PyramidSeriesIkhDataGrouping DataGrouping { get; set; }
		private PyramidSeriesIkhDataGrouping DataGrouping_DefaultValue { get; set; }
		...
		/// </summary>
		public PyramidSeriesIkhEvents Events { get; set; }
		private PyramidSeriesIkhEvents Events_DefaultValue { get; set; }
		...
		/// </summary>
		public PyramidSeriesIkhMarker Marker { get; set; }
		private PyramidSeriesIkhMarker Marker_DefaultValue { get; set; }
		 

		/// <summary>
		/// <p>Properties for each single point.</p>
		/// </summary>
		public PyramidSeriesIkhPoint Point { get; set; }
		private PyramidSeriesIkhPoint Point_DefaultValue { get; set; }
		...
		/// </summary>
		public PyramidSeriesIkhDataLabels DataLabels { get; set; }
		private PyramidSeriesIkhDataLabels DataLabels_DefaultValue { get; set; }
		...
		/// </summary>
		public PyramidSeriesIkhStates States { get; set; }
		private PyramidSeriesIkhStates States_DefaultValue { get; set; }
		...
		/// </summary>
		public PyramidSeriesIkhFindNearestPointBy FindNearestPointBy { get; set; }
		private PyramidSeriesIkhFindNearestPointBy FindNearestPointBy_DefaultValue { get; set; }
		...
		/// </summary>
		public PyramidSeriesIkhCursor Cursor { get; set; }
		private PyramidSeriesIkhCursor Cursor_DefaultValue { get; set; }
		...
		/// </summary>
		public PyramidSeriesIkhDashStyle DashStyle { get; set; }
		private PyramidSeriesIkhDashStyle DashStyle_DefaultValue { get; set; }
		...
		/// </summary>
		public PyramidSeriesIkhStep Step { get; set; }
		private PyramidSeriesIkhStep Step_DefaultValue { get; set; }
		...
		/// </summary>
		public List<PyramidSeriesIkhZone> Zones { get; set; }
		private List<PyramidSeriesIkhZone> Zones_DefaultValue { get; set; }
		...
		/// </summary>
		public PyramidSeriesIkhPointIntervalUnit PointIntervalUnit { get; set; }
		private PyramidSeriesIkhPointIntervalUnit PointIntervalUnit_DefaultValue { get; set; }
		...
		/// </summary>
		public PyramidSeriesIkhStacking Stacking { get; set; }
		private PyramidSeriesIkhStacking Stacking_DefaultValue { get; set; }
		...
		/// </summary>
		public PyramidSeriesIkhCompareBase CompareBase { get; set; }
		private PyramidSeriesIkhCompareBase CompareBase_DefaultValue { get; set; }
		...
		internal override Hashtable ToHashtable()
		{
			...
			if (PointDescriptionFormatter != PointDescriptionFormatter_DefaultValue) { h.Add("pointDescriptionFormatter",PointDescriptionFormatter); Highstock.AddFunction("PyramidSeriesIkhPointDescriptionFormatter.pointDescriptionFormatter", PointDescriptionFormatter); }  
