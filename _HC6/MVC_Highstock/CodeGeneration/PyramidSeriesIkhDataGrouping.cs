...
{
	public partial class PyramidSeriesIkhDataGrouping  : BaseObject
	{
		public PyramidSeriesIkhDataGrouping()
		{
			Approximation = Approximation_DefaultValue = PyramidSeriesIkhDataGroupingApproximation.Average;
		...
		/// </summary>
		public PyramidSeriesIkhDataGroupingApproximation Approximation { get; set; }
		private PyramidSeriesIkhDataGroupingApproximation Approximation_DefaultValue { get; set; }
