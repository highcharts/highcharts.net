...
{
	public partial class PyramidSeriesIkhDataLabels  : BaseObject
	{
		public PyramidSeriesIkhDataLabels()
		{
			Align = Align_DefaultValue = PyramidSeriesIkhDataLabelsAlign.Center;
			Formatter = Formatter_DefaultValue = "";
			Style = Style_DefaultValue = new PyramidSeriesIkhDataLabelsStyle();
			VerticalAlign = VerticalAlign_DefaultValue = PyramidSeriesIkhDataLabelsVerticalAlign.Bottom;
			X = X_DefaultValue = 0;
			Y = Y_DefaultValue = -6;
			...
			Overflow = Overflow_DefaultValue = PyramidSeriesIkhDataLabelsOverflow.Justify;
		...
		/// </summary>
		public PyramidSeriesIkhDataLabelsAlign Align { get; set; }
		private PyramidSeriesIkhDataLabelsAlign Align_DefaultValue { get; set; }
		...
		/// </summary>
		public PyramidSeriesIkhDataLabelsStyle Style { get; set; }
		private PyramidSeriesIkhDataLabelsStyle Style_DefaultValue { get; set; }
		...
		/// </summary>
		public PyramidSeriesIkhDataLabelsVerticalAlign VerticalAlign { get; set; }
		private PyramidSeriesIkhDataLabelsVerticalAlign VerticalAlign_DefaultValue { get; set; }
		...
		/// </summary>
		public PyramidSeriesIkhDataLabelsOverflow Overflow { get; set; }
		private PyramidSeriesIkhDataLabelsOverflow Overflow_DefaultValue { get; set; }
		...
		internal override Hashtable ToHashtable()
		{
			...
			if (Formatter != Formatter_DefaultValue) { h.Add("formatter",Formatter); Highstock.AddFunction("PyramidSeriesIkhDataLabelsFormatter.formatter", Formatter); }  
