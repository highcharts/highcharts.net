...
{
	public partial class PyramidSeriesIkhMarker  : BaseObject
	{
		public PyramidSeriesIkhMarker()
		{
			LineWidth = LineWidth_DefaultValue = 0;
			LineColor = LineColor_DefaultValue = "#ffffff";
			Radius = Radius_DefaultValue = 4;
			States = States_DefaultValue = new PyramidSeriesIkhMarkerStates();
		...
		/// </summary>
		public PyramidSeriesIkhMarkerStates States { get; set; }
		private PyramidSeriesIkhMarkerStates States_DefaultValue { get; set; }
