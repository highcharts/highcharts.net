...
{
	public partial class PyramidSeriesIkhStatesHover  : BaseObject
	{
		public PyramidSeriesIkhStatesHover()
		{
			LineWidthPlus = LineWidthPlus_DefaultValue = 1;
			Marker = Marker_DefaultValue = new PyramidSeriesIkhStatesHoverMarker();
			Halo = Halo_DefaultValue = new PyramidSeriesIkhStatesHoverHalo();
		...
		/// </summary>
		public PyramidSeriesIkhStatesHoverMarker Marker { get; set; }
		private PyramidSeriesIkhStatesHoverMarker Marker_DefaultValue { get; set; }
		...
		/// </summary>
		public PyramidSeriesIkhStatesHoverHalo Halo { get; set; }
		private PyramidSeriesIkhStatesHoverHalo Halo_DefaultValue { get; set; }
