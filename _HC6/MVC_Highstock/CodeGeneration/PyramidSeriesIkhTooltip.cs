...
{
	public partial class PyramidSeriesIkhTooltip  : BaseObject
	{
		public PyramidSeriesIkhTooltip()
		{
			ValueDecimals = ValueDecimals_DefaultValue = null;
			DateTimeLabelFormats = DateTimeLabelFormats_DefaultValue = new PyramidSeriesIkhTooltipDateTimeLabelFormats();
		...
		/// </summary>
		public PyramidSeriesIkhTooltipDateTimeLabelFormats DateTimeLabelFormats { get; set; }
		private PyramidSeriesIkhTooltipDateTimeLabelFormats DateTimeLabelFormats_DefaultValue { get; set; }
		...
		internal override Hashtable ToHashtable()
		{
			...
			if (PointFormatter != PointFormatter_DefaultValue) { h.Add("pointFormatter",PointFormatter); Highstock.AddFunction("PyramidSeriesIkhTooltipPointFormatter.pointFormatter", PointFormatter); }  
