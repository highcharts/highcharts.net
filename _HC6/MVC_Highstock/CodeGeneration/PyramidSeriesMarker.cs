...
{
	public partial class PyramidSeriesMarker  : BaseObject
	{
		public PyramidSeriesMarker()
		{
			LineWidth = LineWidth_DefaultValue = 0;
			LineColor = LineColor_DefaultValue = "#ffffff";
			Radius = Radius_DefaultValue = 4;
			States = States_DefaultValue = new PyramidSeriesMarkerStates();
		...
		/// </summary>
		public PyramidSeriesMarkerStates States { get; set; }
		private PyramidSeriesMarkerStates States_DefaultValue { get; set; }
