...
{
	public partial class PyramidSeriesStatesSelectMarker  : BaseObject
	{
		public PyramidSeriesStatesSelectMarker()
		{
			LineWidth = LineWidth_DefaultValue = 0;
			LineColor = LineColor_DefaultValue = "#ffffff";
			Radius = Radius_DefaultValue = 4;
			States = States_DefaultValue = new PyramidSeriesStatesSelectMarkerStates();
		...
		/// </summary>
		public PyramidSeriesStatesSelectMarkerStates States { get; set; }
		private PyramidSeriesStatesSelectMarkerStates States_DefaultValue { get; set; }
