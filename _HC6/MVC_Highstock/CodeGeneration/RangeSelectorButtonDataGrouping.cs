...
{
	public partial class RangeSelectorButtonDataGrouping  : BaseObject
	{
		public RangeSelectorButtonDataGrouping()
		{
			Approximation = Approximation_DefaultValue = RangeSelectorButtonDataGroupingApproximation.Average;
		...
		/// </summary>
		public RangeSelectorButtonDataGroupingApproximation Approximation { get; set; }
		private RangeSelectorButtonDataGroupingApproximation Approximation_DefaultValue { get; set; }
