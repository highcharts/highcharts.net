...
{
	public partial class RocSeriesData  : BaseObject
	{
		public RocSeriesData()
		{
			...
			DragDrop = DragDrop_DefaultValue = new RocSeriesDataDragDrop();
			Drilldown = Drilldown_DefaultValue = "";
			Events = Events_DefaultValue = new RocSeriesDataEvents();
			Id = Id_DefaultValue = "";
			Labelrank = Labelrank_DefaultValue = null;
			Marker = Marker_DefaultValue = new RocSeriesDataMarker();
		...
		/// </summary>
		public RocSeriesDataDragDrop DragDrop { get; set; }
		private RocSeriesDataDragDrop DragDrop_DefaultValue { get; set; }
		...
		/// </summary>
		public RocSeriesDataEvents Events { get; set; }
		private RocSeriesDataEvents Events_DefaultValue { get; set; }
		...
		/// 
		/// </summary>
		public RocSeriesDataMarker Marker { get; set; }
		private RocSeriesDataMarker Marker_DefaultValue { get; set; }
