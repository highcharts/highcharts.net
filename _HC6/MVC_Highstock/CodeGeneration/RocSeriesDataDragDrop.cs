...
{
	public partial class RocSeriesDataDragDrop  : BaseObject
	{
		public RocSeriesDataDragDrop()
		{
			DraggableX = DraggableX_DefaultValue = null;
			DraggableY = DraggableY_DefaultValue = null;
			DragHandle = DragHandle_DefaultValue = new RocSeriesDataDragDropDragHandle();
			...
			GuideBox = GuideBox_DefaultValue = new RocSeriesDataDragDropGuideBox();
		...
		/// </summary>
		public RocSeriesDataDragDropDragHandle DragHandle { get; set; }
		private RocSeriesDataDragDropDragHandle DragHandle_DefaultValue { get; set; }
		...
		/// </summary>
		public RocSeriesDataDragDropGuideBox GuideBox { get; set; }
		private RocSeriesDataDragDropGuideBox GuideBox_DefaultValue { get; set; }
