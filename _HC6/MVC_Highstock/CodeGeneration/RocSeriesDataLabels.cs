...
namespace Highsoft.Web.Mvc.Stocks
{
	public partial class RocSeriesDataLabels  : BaseObject
	{
		public RocSeriesDataLabels()
		{
			...
			Style = Style_DefaultValue = new RocSeriesDataLabelsStyle();
		...
		/// </summary>
		public RocSeriesDataLabelsStyle Style { get; set; }
		private RocSeriesDataLabelsStyle Style_DefaultValue { get; set; }
