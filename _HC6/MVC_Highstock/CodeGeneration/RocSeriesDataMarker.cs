...
{
	public partial class RocSeriesDataMarker  : BaseObject
	{
		public RocSeriesDataMarker()
		{
			...
			States = States_DefaultValue = new RocSeriesDataMarkerStates();
		...
		/// </summary>
		public RocSeriesDataMarkerStates States { get; set; }
		private RocSeriesDataMarkerStates States_DefaultValue { get; set; }
