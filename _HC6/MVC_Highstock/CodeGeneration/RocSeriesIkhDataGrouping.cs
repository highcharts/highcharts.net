...
{
	public partial class RocSeriesIkhDataGrouping  : BaseObject
	{
		public RocSeriesIkhDataGrouping()
		{
			Approximation = Approximation_DefaultValue = RocSeriesIkhDataGroupingApproximation.Average;
		...
		/// </summary>
		public RocSeriesIkhDataGroupingApproximation Approximation { get; set; }
		private RocSeriesIkhDataGroupingApproximation Approximation_DefaultValue { get; set; }
