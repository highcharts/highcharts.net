...
{
	public partial class RocSeriesIkhDataLabels  : BaseObject
	{
		public RocSeriesIkhDataLabels()
		{
			Align = Align_DefaultValue = RocSeriesIkhDataLabelsAlign.Center;
			Formatter = Formatter_DefaultValue = "";
			Style = Style_DefaultValue = new RocSeriesIkhDataLabelsStyle();
			VerticalAlign = VerticalAlign_DefaultValue = RocSeriesIkhDataLabelsVerticalAlign.Bottom;
			X = X_DefaultValue = 0;
			Y = Y_DefaultValue = -6;
			...
			Overflow = Overflow_DefaultValue = RocSeriesIkhDataLabelsOverflow.Justify;
		...
		/// </summary>
		public RocSeriesIkhDataLabelsAlign Align { get; set; }
		private RocSeriesIkhDataLabelsAlign Align_DefaultValue { get; set; }
		...
		/// </summary>
		public RocSeriesIkhDataLabelsStyle Style { get; set; }
		private RocSeriesIkhDataLabelsStyle Style_DefaultValue { get; set; }
		...
		/// </summary>
		public RocSeriesIkhDataLabelsVerticalAlign VerticalAlign { get; set; }
		private RocSeriesIkhDataLabelsVerticalAlign VerticalAlign_DefaultValue { get; set; }
		...
		/// </summary>
		public RocSeriesIkhDataLabelsOverflow Overflow { get; set; }
		private RocSeriesIkhDataLabelsOverflow Overflow_DefaultValue { get; set; }
		...
		internal override Hashtable ToHashtable()
		{
			...
			if (Formatter != Formatter_DefaultValue) { h.Add("formatter",Formatter); Highstock.AddFunction("RocSeriesIkhDataLabelsFormatter.formatter", Formatter); }  
