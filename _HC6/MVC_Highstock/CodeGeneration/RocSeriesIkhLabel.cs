...
{
	public partial class RocSeriesIkhLabel  : BaseObject
	{
		public RocSeriesIkhLabel()
		{
			...
			Style = Style_DefaultValue = new RocSeriesIkhLabelStyle();
		...
		/// </summary>
		public RocSeriesIkhLabelStyle Style { get; set; }
		private RocSeriesIkhLabelStyle Style_DefaultValue { get; set; }
