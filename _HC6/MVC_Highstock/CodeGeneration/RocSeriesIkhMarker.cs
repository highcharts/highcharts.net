...
{
	public partial class RocSeriesIkhMarker  : BaseObject
	{
		public RocSeriesIkhMarker()
		{
			LineWidth = LineWidth_DefaultValue = 0;
			LineColor = LineColor_DefaultValue = "#ffffff";
			Radius = Radius_DefaultValue = 4;
			States = States_DefaultValue = new RocSeriesIkhMarkerStates();
		...
		/// </summary>
		public RocSeriesIkhMarkerStates States { get; set; }
		private RocSeriesIkhMarkerStates States_DefaultValue { get; set; }
