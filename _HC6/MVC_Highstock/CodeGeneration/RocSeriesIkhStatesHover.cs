...
{
	public partial class RocSeriesIkhStatesHover  : BaseObject
	{
		public RocSeriesIkhStatesHover()
		{
			LineWidthPlus = LineWidthPlus_DefaultValue = 1;
			Marker = Marker_DefaultValue = new RocSeriesIkhStatesHoverMarker();
			Halo = Halo_DefaultValue = new RocSeriesIkhStatesHoverHalo();
		...
		/// </summary>
		public RocSeriesIkhStatesHoverMarker Marker { get; set; }
		private RocSeriesIkhStatesHoverMarker Marker_DefaultValue { get; set; }
		...
		/// </summary>
		public RocSeriesIkhStatesHoverHalo Halo { get; set; }
		private RocSeriesIkhStatesHoverHalo Halo_DefaultValue { get; set; }
