...
{
	public partial class RocSeriesIkhStatesHoverMarker  : BaseObject
	{
		public RocSeriesIkhStatesHoverMarker()
		{
			LineWidth = LineWidth_DefaultValue = 0;
			LineColor = LineColor_DefaultValue = "#ffffff";
			Radius = Radius_DefaultValue = 4;
			States = States_DefaultValue = new RocSeriesIkhStatesHoverMarkerStates();
		...
		/// </summary>
		public RocSeriesIkhStatesHoverMarkerStates States { get; set; }
		private RocSeriesIkhStatesHoverMarkerStates States_DefaultValue { get; set; }
