...
{
	public partial class RocSeriesIkhTooltip  : BaseObject
	{
		public RocSeriesIkhTooltip()
		{
			ValueDecimals = ValueDecimals_DefaultValue = null;
			DateTimeLabelFormats = DateTimeLabelFormats_DefaultValue = new RocSeriesIkhTooltipDateTimeLabelFormats();
		...
		/// </summary>
		public RocSeriesIkhTooltipDateTimeLabelFormats DateTimeLabelFormats { get; set; }
		private RocSeriesIkhTooltipDateTimeLabelFormats DateTimeLabelFormats_DefaultValue { get; set; }
		...
		internal override Hashtable ToHashtable()
		{
			...
			if (PointFormatter != PointFormatter_DefaultValue) { h.Add("pointFormatter",PointFormatter); Highstock.AddFunction("RocSeriesIkhTooltipPointFormatter.pointFormatter", PointFormatter); }  
