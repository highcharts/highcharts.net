...
namespace Highsoft.Web.Mvc.Stocks
{
	public partial class RocSeriesTooltip  : BaseObject
	{
		public RocSeriesTooltip()
		{
			...
			DateTimeLabelFormats = DateTimeLabelFormats_DefaultValue = new RocSeriesTooltipDateTimeLabelFormats();
		...
		/// </summary>
		public RocSeriesTooltipDateTimeLabelFormats DateTimeLabelFormats { get; set; }
		private RocSeriesTooltipDateTimeLabelFormats DateTimeLabelFormats_DefaultValue { get; set; }
