...
{
	public partial class RsiSeriesDataGrouping  : BaseObject
	{
		public RsiSeriesDataGrouping()
		{
			Approximation = Approximation_DefaultValue = RsiSeriesDataGroupingApproximation.Average;
		...
		/// </summary>
		public RsiSeriesDataGroupingApproximation Approximation { get; set; }
		private RsiSeriesDataGroupingApproximation Approximation_DefaultValue { get; set; }
		...
		/// </summary>
		public RsiSeriesDataGroupingUnits Units { get; set; }
		private RsiSeriesDataGroupingUnits Units_DefaultValue { get; set; }
