...
namespace Highsoft.Web.Mvc.Stocks
{
	public partial class RsiSeriesDataLabels  : BaseObject
	{
		public RsiSeriesDataLabels()
		{
			...
			Style = Style_DefaultValue = new RsiSeriesDataLabelsStyle();
		...
		/// </summary>
		public RsiSeriesDataLabelsStyle Style { get; set; }
		private RsiSeriesDataLabelsStyle Style_DefaultValue { get; set; }
