...
{
	public partial class RsiSeriesDataMarker  : BaseObject
	{
		public RsiSeriesDataMarker()
		{
			...
			States = States_DefaultValue = new RsiSeriesDataMarkerStates();
		...
		/// </summary>
		public RsiSeriesDataMarkerStates States { get; set; }
		private RsiSeriesDataMarkerStates States_DefaultValue { get; set; }
