...
{
	public partial class RsiSeriesIkhDataGrouping  : BaseObject
	{
		public RsiSeriesIkhDataGrouping()
		{
			Approximation = Approximation_DefaultValue = RsiSeriesIkhDataGroupingApproximation.Average;
		...
		/// </summary>
		public RsiSeriesIkhDataGroupingApproximation Approximation { get; set; }
		private RsiSeriesIkhDataGroupingApproximation Approximation_DefaultValue { get; set; }
