...
{
	public partial class RsiSeriesIkhDataLabels  : BaseObject
	{
		public RsiSeriesIkhDataLabels()
		{
			Align = Align_DefaultValue = RsiSeriesIkhDataLabelsAlign.Center;
			Formatter = Formatter_DefaultValue = "";
			Style = Style_DefaultValue = new RsiSeriesIkhDataLabelsStyle();
			VerticalAlign = VerticalAlign_DefaultValue = RsiSeriesIkhDataLabelsVerticalAlign.Bottom;
			X = X_DefaultValue = 0;
			Y = Y_DefaultValue = -6;
			...
			Overflow = Overflow_DefaultValue = RsiSeriesIkhDataLabelsOverflow.Justify;
		...
		/// </summary>
		public RsiSeriesIkhDataLabelsAlign Align { get; set; }
		private RsiSeriesIkhDataLabelsAlign Align_DefaultValue { get; set; }
		...
		/// </summary>
		public RsiSeriesIkhDataLabelsStyle Style { get; set; }
		private RsiSeriesIkhDataLabelsStyle Style_DefaultValue { get; set; }
		...
		/// </summary>
		public RsiSeriesIkhDataLabelsVerticalAlign VerticalAlign { get; set; }
		private RsiSeriesIkhDataLabelsVerticalAlign VerticalAlign_DefaultValue { get; set; }
		...
		/// </summary>
		public RsiSeriesIkhDataLabelsOverflow Overflow { get; set; }
		private RsiSeriesIkhDataLabelsOverflow Overflow_DefaultValue { get; set; }
		...
		internal override Hashtable ToHashtable()
		{
			...
			if (Formatter != Formatter_DefaultValue) { h.Add("formatter",Formatter); Highstock.AddFunction("RsiSeriesIkhDataLabelsFormatter.formatter", Formatter); }  
