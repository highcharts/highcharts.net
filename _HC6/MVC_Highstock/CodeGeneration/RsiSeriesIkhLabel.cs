...
{
	public partial class RsiSeriesIkhLabel  : BaseObject
	{
		public RsiSeriesIkhLabel()
		{
			...
			Style = Style_DefaultValue = new RsiSeriesIkhLabelStyle();
		...
		/// </summary>
		public RsiSeriesIkhLabelStyle Style { get; set; }
		private RsiSeriesIkhLabelStyle Style_DefaultValue { get; set; }
