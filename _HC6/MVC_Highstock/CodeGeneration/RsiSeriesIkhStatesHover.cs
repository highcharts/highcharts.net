...
{
	public partial class RsiSeriesIkhStatesHover  : BaseObject
	{
		public RsiSeriesIkhStatesHover()
		{
			LineWidthPlus = LineWidthPlus_DefaultValue = 1;
			Marker = Marker_DefaultValue = new RsiSeriesIkhStatesHoverMarker();
			Halo = Halo_DefaultValue = new RsiSeriesIkhStatesHoverHalo();
		...
		/// </summary>
		public RsiSeriesIkhStatesHoverMarker Marker { get; set; }
		private RsiSeriesIkhStatesHoverMarker Marker_DefaultValue { get; set; }
		...
		/// </summary>
		public RsiSeriesIkhStatesHoverHalo Halo { get; set; }
		private RsiSeriesIkhStatesHoverHalo Halo_DefaultValue { get; set; }
