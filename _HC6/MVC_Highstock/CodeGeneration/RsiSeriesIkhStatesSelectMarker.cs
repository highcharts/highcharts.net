...
{
	public partial class RsiSeriesIkhStatesSelectMarker  : BaseObject
	{
		public RsiSeriesIkhStatesSelectMarker()
		{
			LineWidth = LineWidth_DefaultValue = 0;
			LineColor = LineColor_DefaultValue = "#ffffff";
			Radius = Radius_DefaultValue = 4;
			States = States_DefaultValue = new RsiSeriesIkhStatesSelectMarkerStates();
		...
		/// </summary>
		public RsiSeriesIkhStatesSelectMarkerStates States { get; set; }
		private RsiSeriesIkhStatesSelectMarkerStates States_DefaultValue { get; set; }
