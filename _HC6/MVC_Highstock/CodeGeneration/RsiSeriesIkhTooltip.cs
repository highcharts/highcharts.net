...
{
	public partial class RsiSeriesIkhTooltip  : BaseObject
	{
		public RsiSeriesIkhTooltip()
		{
			ValueDecimals = ValueDecimals_DefaultValue = null;
			DateTimeLabelFormats = DateTimeLabelFormats_DefaultValue = new RsiSeriesIkhTooltipDateTimeLabelFormats();
		...
		/// </summary>
		public RsiSeriesIkhTooltipDateTimeLabelFormats DateTimeLabelFormats { get; set; }
		private RsiSeriesIkhTooltipDateTimeLabelFormats DateTimeLabelFormats_DefaultValue { get; set; }
		...
		internal override Hashtable ToHashtable()
		{
			...
			if (PointFormatter != PointFormatter_DefaultValue) { h.Add("pointFormatter",PointFormatter); Highstock.AddFunction("RsiSeriesIkhTooltipPointFormatter.pointFormatter", PointFormatter); }  
