...
{
	public partial class RsiSeriesMarker  : BaseObject
	{
		public RsiSeriesMarker()
		{
			...
			States = States_DefaultValue = new RsiSeriesMarkerStates();
		...
		/// </summary>
		public RsiSeriesMarkerStates States { get; set; }
		private RsiSeriesMarkerStates States_DefaultValue { get; set; }
