...
{
	public partial class RsiSeriesStatesHoverMarker  : BaseObject
	{
		public RsiSeriesStatesHoverMarker()
		{
			...
			States = States_DefaultValue = new RsiSeriesStatesHoverMarkerStates();
		...
		/// </summary>
		public RsiSeriesStatesHoverMarkerStates States { get; set; }
		private RsiSeriesStatesHoverMarkerStates States_DefaultValue { get; set; }
