...
namespace Highsoft.Web.Mvc.Stocks
{
	public partial class RsiSeriesTooltip  : BaseObject
	{
		public RsiSeriesTooltip()
		{
			...
			DateTimeLabelFormats = DateTimeLabelFormats_DefaultValue = new RsiSeriesTooltipDateTimeLabelFormats();
		...
		/// </summary>
		public RsiSeriesTooltipDateTimeLabelFormats DateTimeLabelFormats { get; set; }
		private RsiSeriesTooltipDateTimeLabelFormats DateTimeLabelFormats_DefaultValue { get; set; }
