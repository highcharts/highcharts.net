...
{
	public partial class SankeySeriesDataGrouping  : BaseObject
	{
		public SankeySeriesDataGrouping()
		{
			GroupPixelWidth = GroupPixelWidth_DefaultValue = 10;
			Approximation = Approximation_DefaultValue = SankeySeriesDataGroupingApproximation.Average;
		...
		/// </summary>
		public SankeySeriesDataGroupingApproximation Approximation { get; set; }
		private SankeySeriesDataGroupingApproximation Approximation_DefaultValue { get; set; }
