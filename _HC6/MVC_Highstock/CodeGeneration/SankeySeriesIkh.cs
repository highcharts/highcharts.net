...
{
	public partial class SankeySeriesIkh  : BaseObject
	{
		public SankeySeriesIkh()
		{
			Name = Name_DefaultValue = "SMA (14)";
			Tooltip = Tooltip_DefaultValue = new SankeySeriesIkhTooltip();
			LinkedTo = LinkedTo_DefaultValue = null;
			Params = Params_DefaultValue = new SankeySeriesIkhParams();
			Linecap = Linecap_DefaultValue = SankeySeriesIkhLinecap.Round;
			BoostThreshold = BoostThreshold_DefaultValue = 5000;
			GapSize = GapSize_DefaultValue = 0;
			GapUnit = GapUnit_DefaultValue = SankeySeriesIkhGapUnit.Relative;
			Label = Label_DefaultValue = new SankeySeriesIkhLabel();
			DataGrouping = DataGrouping_DefaultValue = new SankeySeriesIkhDataGrouping();
			LineWidth = LineWidth_DefaultValue = 2;
			AllowPointSelect = AllowPointSelect_DefaultValue = false;
			ShowCheckbox = ShowCheckbox_DefaultValue = false;
			Animation = Animation_DefaultValue = new Animation() { Enabled = true };
			Events = Events_DefaultValue = new SankeySeriesIkhEvents();
			Marker = Marker_DefaultValue = new SankeySeriesIkhMarker();
			Point = Point_DefaultValue = new SankeySeriesIkhPoint();
			DataLabels = DataLabels_DefaultValue = new SankeySeriesIkhDataLabels();
			CropThreshold = CropThreshold_DefaultValue = 300;
			SoftThreshold = SoftThreshold_DefaultValue = true;
			States = States_DefaultValue = new SankeySeriesIkhStates();
			StickyTracking = StickyTracking_DefaultValue = null;
			TurboThreshold = TurboThreshold_DefaultValue = 1000;
			FindNearestPointBy = FindNearestPointBy_DefaultValue = SankeySeriesIkhFindNearestPointBy.X;
			AnimationLimit = AnimationLimit_DefaultValue = null;
			ClassName = ClassName_DefaultValue = null;
			Color = Color_DefaultValue = null;
			ColorIndex = ColorIndex_DefaultValue = null;
			ConnectNulls = ConnectNulls_DefaultValue = false;
			Cursor = Cursor_DefaultValue = SankeySeriesIkhCursor.Null;
			DashStyle = DashStyle_DefaultValue = SankeySeriesIkhDashStyle.Solid;
			...
			Step = Step_DefaultValue = SankeySeriesIkhStep.Null;
			Threshold = Threshold_DefaultValue = 0;
			Visible = Visible_DefaultValue = true;
			ZoneAxis = ZoneAxis_DefaultValue = "y";
			Zones = Zones_DefaultValue = new List<SankeySeriesIkhZone>();
			...
			PointIntervalUnit = PointIntervalUnit_DefaultValue = SankeySeriesIkhPointIntervalUnit.Null;
			PointPlacement = PointPlacement_DefaultValue = new PointPlacement();
			PointStart = PointStart_DefaultValue = 0;
			Stacking = Stacking_DefaultValue = SankeySeriesIkhStacking.Null;
			Compare = Compare_DefaultValue = "undefined";
			CompareBase = CompareBase_DefaultValue = SankeySeriesIkhCompareBase.Min;
		...
		/// </summary>
		public SankeySeriesIkhTooltip Tooltip { get; set; }
		private SankeySeriesIkhTooltip Tooltip_DefaultValue { get; set; }
		...
		/// 
		/// </summary>
		public SankeySeriesIkhParams Params { get; set; }
		private SankeySeriesIkhParams Params_DefaultValue { get; set; }
		...
		/// </summary>
		public SankeySeriesIkhLinecap Linecap { get; set; }
		private SankeySeriesIkhLinecap Linecap_DefaultValue { get; set; }
		...
		/// </summary>
		public SankeySeriesIkhGapUnit GapUnit { get; set; }
		private SankeySeriesIkhGapUnit GapUnit_DefaultValue { get; set; }
		...
		/// </summary>
		public SankeySeriesIkhLabel Label { get; set; }
		private SankeySeriesIkhLabel Label_DefaultValue { get; set; }
		...
		/// </summary>
		public SankeySeriesIkhDataGrouping DataGrouping { get; set; }
		private SankeySeriesIkhDataGrouping DataGrouping_DefaultValue { get; set; }
		...
		/// </summary>
		public SankeySeriesIkhEvents Events { get; set; }
		private SankeySeriesIkhEvents Events_DefaultValue { get; set; }
		...
		/// </summary>
		public SankeySeriesIkhMarker Marker { get; set; }
		private SankeySeriesIkhMarker Marker_DefaultValue { get; set; }
		 

		/// <summary>
		/// <p>Properties for each single point.</p>
		/// </summary>
		public SankeySeriesIkhPoint Point { get; set; }
		private SankeySeriesIkhPoint Point_DefaultValue { get; set; }
		...
		/// </summary>
		public SankeySeriesIkhDataLabels DataLabels { get; set; }
		private SankeySeriesIkhDataLabels DataLabels_DefaultValue { get; set; }
		...
		/// </summary>
		public SankeySeriesIkhStates States { get; set; }
		private SankeySeriesIkhStates States_DefaultValue { get; set; }
		...
		/// </summary>
		public SankeySeriesIkhFindNearestPointBy FindNearestPointBy { get; set; }
		private SankeySeriesIkhFindNearestPointBy FindNearestPointBy_DefaultValue { get; set; }
		...
		/// </summary>
		public SankeySeriesIkhCursor Cursor { get; set; }
		private SankeySeriesIkhCursor Cursor_DefaultValue { get; set; }
		...
		/// </summary>
		public SankeySeriesIkhDashStyle DashStyle { get; set; }
		private SankeySeriesIkhDashStyle DashStyle_DefaultValue { get; set; }
		...
		/// </summary>
		public SankeySeriesIkhStep Step { get; set; }
		private SankeySeriesIkhStep Step_DefaultValue { get; set; }
		...
		/// </summary>
		public List<SankeySeriesIkhZone> Zones { get; set; }
		private List<SankeySeriesIkhZone> Zones_DefaultValue { get; set; }
		...
		/// </summary>
		public SankeySeriesIkhPointIntervalUnit PointIntervalUnit { get; set; }
		private SankeySeriesIkhPointIntervalUnit PointIntervalUnit_DefaultValue { get; set; }
		...
		/// </summary>
		public SankeySeriesIkhStacking Stacking { get; set; }
		private SankeySeriesIkhStacking Stacking_DefaultValue { get; set; }
		...
		/// </summary>
		public SankeySeriesIkhCompareBase CompareBase { get; set; }
		private SankeySeriesIkhCompareBase CompareBase_DefaultValue { get; set; }
		...
		internal override Hashtable ToHashtable()
		{
			...
			if (PointDescriptionFormatter != PointDescriptionFormatter_DefaultValue) { h.Add("pointDescriptionFormatter",PointDescriptionFormatter); Highstock.AddFunction("SankeySeriesIkhPointDescriptionFormatter.pointDescriptionFormatter", PointDescriptionFormatter); }  
