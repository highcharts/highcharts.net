...
{
	public partial class SankeySeriesIkhDataGrouping  : BaseObject
	{
		public SankeySeriesIkhDataGrouping()
		{
			Approximation = Approximation_DefaultValue = SankeySeriesIkhDataGroupingApproximation.Average;
		...
		/// </summary>
		public SankeySeriesIkhDataGroupingApproximation Approximation { get; set; }
		private SankeySeriesIkhDataGroupingApproximation Approximation_DefaultValue { get; set; }
