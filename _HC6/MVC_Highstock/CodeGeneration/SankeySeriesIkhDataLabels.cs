...
{
	public partial class SankeySeriesIkhDataLabels  : BaseObject
	{
		public SankeySeriesIkhDataLabels()
		{
			Align = Align_DefaultValue = SankeySeriesIkhDataLabelsAlign.Center;
			Formatter = Formatter_DefaultValue = "";
			Style = Style_DefaultValue = new SankeySeriesIkhDataLabelsStyle();
			VerticalAlign = VerticalAlign_DefaultValue = SankeySeriesIkhDataLabelsVerticalAlign.Bottom;
			X = X_DefaultValue = 0;
			Y = Y_DefaultValue = -6;
			...
			Overflow = Overflow_DefaultValue = SankeySeriesIkhDataLabelsOverflow.Justify;
		...
		/// </summary>
		public SankeySeriesIkhDataLabelsAlign Align { get; set; }
		private SankeySeriesIkhDataLabelsAlign Align_DefaultValue { get; set; }
		...
		/// </summary>
		public SankeySeriesIkhDataLabelsStyle Style { get; set; }
		private SankeySeriesIkhDataLabelsStyle Style_DefaultValue { get; set; }
		...
		/// </summary>
		public SankeySeriesIkhDataLabelsVerticalAlign VerticalAlign { get; set; }
		private SankeySeriesIkhDataLabelsVerticalAlign VerticalAlign_DefaultValue { get; set; }
		...
		/// </summary>
		public SankeySeriesIkhDataLabelsOverflow Overflow { get; set; }
		private SankeySeriesIkhDataLabelsOverflow Overflow_DefaultValue { get; set; }
		...
		internal override Hashtable ToHashtable()
		{
			...
			if (Formatter != Formatter_DefaultValue) { h.Add("formatter",Formatter); Highstock.AddFunction("SankeySeriesIkhDataLabelsFormatter.formatter", Formatter); }  
