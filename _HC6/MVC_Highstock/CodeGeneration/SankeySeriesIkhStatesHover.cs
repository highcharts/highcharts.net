...
{
	public partial class SankeySeriesIkhStatesHover  : BaseObject
	{
		public SankeySeriesIkhStatesHover()
		{
			LineWidthPlus = LineWidthPlus_DefaultValue = 1;
			Marker = Marker_DefaultValue = new SankeySeriesIkhStatesHoverMarker();
			Halo = Halo_DefaultValue = new SankeySeriesIkhStatesHoverHalo();
		...
		/// </summary>
		public SankeySeriesIkhStatesHoverMarker Marker { get; set; }
		private SankeySeriesIkhStatesHoverMarker Marker_DefaultValue { get; set; }
		...
		/// </summary>
		public SankeySeriesIkhStatesHoverHalo Halo { get; set; }
		private SankeySeriesIkhStatesHoverHalo Halo_DefaultValue { get; set; }
