...
{
	public partial class SankeySeriesIkhTooltip  : BaseObject
	{
		public SankeySeriesIkhTooltip()
		{
			ValueDecimals = ValueDecimals_DefaultValue = null;
			DateTimeLabelFormats = DateTimeLabelFormats_DefaultValue = new SankeySeriesIkhTooltipDateTimeLabelFormats();
		...
		/// </summary>
		public SankeySeriesIkhTooltipDateTimeLabelFormats DateTimeLabelFormats { get; set; }
		private SankeySeriesIkhTooltipDateTimeLabelFormats DateTimeLabelFormats_DefaultValue { get; set; }
		...
		internal override Hashtable ToHashtable()
		{
			...
			if (PointFormatter != PointFormatter_DefaultValue) { h.Add("pointFormatter",PointFormatter); Highstock.AddFunction("SankeySeriesIkhTooltipPointFormatter.pointFormatter", PointFormatter); }  
