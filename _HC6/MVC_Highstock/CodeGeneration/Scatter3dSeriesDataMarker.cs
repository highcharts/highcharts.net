...
{
	public partial class Scatter3dSeriesDataMarker  : BaseObject
	{
		public Scatter3dSeriesDataMarker()
		{
			LineWidth = LineWidth_DefaultValue = 0;
			LineColor = LineColor_DefaultValue = "#ffffff";
			Radius = Radius_DefaultValue = 4;
			States = States_DefaultValue = new Scatter3dSeriesDataMarkerStates();
		...
		/// </summary>
		public Scatter3dSeriesDataMarkerStates States { get; set; }
		private Scatter3dSeriesDataMarkerStates States_DefaultValue { get; set; }
