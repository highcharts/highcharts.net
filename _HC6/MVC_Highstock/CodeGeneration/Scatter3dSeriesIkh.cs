...
{
	public partial class Scatter3dSeriesIkh  : BaseObject
	{
		public Scatter3dSeriesIkh()
		{
			Name = Name_DefaultValue = "SMA (14)";
			Tooltip = Tooltip_DefaultValue = new Scatter3dSeriesIkhTooltip();
			LinkedTo = LinkedTo_DefaultValue = null;
			Params = Params_DefaultValue = new Scatter3dSeriesIkhParams();
			Linecap = Linecap_DefaultValue = Scatter3dSeriesIkhLinecap.Round;
			BoostThreshold = BoostThreshold_DefaultValue = 5000;
			GapSize = GapSize_DefaultValue = 0;
			GapUnit = GapUnit_DefaultValue = Scatter3dSeriesIkhGapUnit.Relative;
			Label = Label_DefaultValue = new Scatter3dSeriesIkhLabel();
			DataGrouping = DataGrouping_DefaultValue = new Scatter3dSeriesIkhDataGrouping();
			LineWidth = LineWidth_DefaultValue = 2;
			AllowPointSelect = AllowPointSelect_DefaultValue = false;
			ShowCheckbox = ShowCheckbox_DefaultValue = false;
			Animation = Animation_DefaultValue = new Animation() { Enabled = true };
			Events = Events_DefaultValue = new Scatter3dSeriesIkhEvents();
			Marker = Marker_DefaultValue = new Scatter3dSeriesIkhMarker();
			Point = Point_DefaultValue = new Scatter3dSeriesIkhPoint();
			DataLabels = DataLabels_DefaultValue = new Scatter3dSeriesIkhDataLabels();
			CropThreshold = CropThreshold_DefaultValue = 300;
			SoftThreshold = SoftThreshold_DefaultValue = true;
			States = States_DefaultValue = new Scatter3dSeriesIkhStates();
			StickyTracking = StickyTracking_DefaultValue = null;
			TurboThreshold = TurboThreshold_DefaultValue = 1000;
			FindNearestPointBy = FindNearestPointBy_DefaultValue = Scatter3dSeriesIkhFindNearestPointBy.X;
			AnimationLimit = AnimationLimit_DefaultValue = null;
			ClassName = ClassName_DefaultValue = null;
			Color = Color_DefaultValue = null;
			ColorIndex = ColorIndex_DefaultValue = null;
			ConnectNulls = ConnectNulls_DefaultValue = false;
			Cursor = Cursor_DefaultValue = Scatter3dSeriesIkhCursor.Null;
			DashStyle = DashStyle_DefaultValue = Scatter3dSeriesIkhDashStyle.Solid;
			...
			Step = Step_DefaultValue = Scatter3dSeriesIkhStep.Null;
			Threshold = Threshold_DefaultValue = 0;
			Visible = Visible_DefaultValue = true;
			ZoneAxis = ZoneAxis_DefaultValue = "y";
			Zones = Zones_DefaultValue = new List<Scatter3dSeriesIkhZone>();
			...
			PointIntervalUnit = PointIntervalUnit_DefaultValue = Scatter3dSeriesIkhPointIntervalUnit.Null;
			PointPlacement = PointPlacement_DefaultValue = new PointPlacement();
			PointStart = PointStart_DefaultValue = 0;
			Stacking = Stacking_DefaultValue = Scatter3dSeriesIkhStacking.Null;
			Compare = Compare_DefaultValue = "undefined";
			CompareBase = CompareBase_DefaultValue = Scatter3dSeriesIkhCompareBase.Min;
		...
		/// </summary>
		public Scatter3dSeriesIkhTooltip Tooltip { get; set; }
		private Scatter3dSeriesIkhTooltip Tooltip_DefaultValue { get; set; }
		...
		/// 
		/// </summary>
		public Scatter3dSeriesIkhParams Params { get; set; }
		private Scatter3dSeriesIkhParams Params_DefaultValue { get; set; }
		...
		/// </summary>
		public Scatter3dSeriesIkhLinecap Linecap { get; set; }
		private Scatter3dSeriesIkhLinecap Linecap_DefaultValue { get; set; }
		...
		/// </summary>
		public Scatter3dSeriesIkhGapUnit GapUnit { get; set; }
		private Scatter3dSeriesIkhGapUnit GapUnit_DefaultValue { get; set; }
		...
		/// </summary>
		public Scatter3dSeriesIkhLabel Label { get; set; }
		private Scatter3dSeriesIkhLabel Label_DefaultValue { get; set; }
		...
		/// </summary>
		public Scatter3dSeriesIkhDataGrouping DataGrouping { get; set; }
		private Scatter3dSeriesIkhDataGrouping DataGrouping_DefaultValue { get; set; }
		...
		/// </summary>
		public Scatter3dSeriesIkhEvents Events { get; set; }
		private Scatter3dSeriesIkhEvents Events_DefaultValue { get; set; }
		...
		/// </summary>
		public Scatter3dSeriesIkhMarker Marker { get; set; }
		private Scatter3dSeriesIkhMarker Marker_DefaultValue { get; set; }
		 

		/// <summary>
		/// <p>Properties for each single point.</p>
		/// </summary>
		public Scatter3dSeriesIkhPoint Point { get; set; }
		private Scatter3dSeriesIkhPoint Point_DefaultValue { get; set; }
		...
		/// </summary>
		public Scatter3dSeriesIkhDataLabels DataLabels { get; set; }
		private Scatter3dSeriesIkhDataLabels DataLabels_DefaultValue { get; set; }
		...
		/// </summary>
		public Scatter3dSeriesIkhStates States { get; set; }
		private Scatter3dSeriesIkhStates States_DefaultValue { get; set; }
		...
		/// </summary>
		public Scatter3dSeriesIkhFindNearestPointBy FindNearestPointBy { get; set; }
		private Scatter3dSeriesIkhFindNearestPointBy FindNearestPointBy_DefaultValue { get; set; }
		...
		/// </summary>
		public Scatter3dSeriesIkhCursor Cursor { get; set; }
		private Scatter3dSeriesIkhCursor Cursor_DefaultValue { get; set; }
		...
		/// </summary>
		public Scatter3dSeriesIkhDashStyle DashStyle { get; set; }
		private Scatter3dSeriesIkhDashStyle DashStyle_DefaultValue { get; set; }
		...
		/// </summary>
		public Scatter3dSeriesIkhStep Step { get; set; }
		private Scatter3dSeriesIkhStep Step_DefaultValue { get; set; }
		...
		/// </summary>
		public List<Scatter3dSeriesIkhZone> Zones { get; set; }
		private List<Scatter3dSeriesIkhZone> Zones_DefaultValue { get; set; }
		...
		/// </summary>
		public Scatter3dSeriesIkhPointIntervalUnit PointIntervalUnit { get; set; }
		private Scatter3dSeriesIkhPointIntervalUnit PointIntervalUnit_DefaultValue { get; set; }
		...
		/// </summary>
		public Scatter3dSeriesIkhStacking Stacking { get; set; }
		private Scatter3dSeriesIkhStacking Stacking_DefaultValue { get; set; }
		...
		/// </summary>
		public Scatter3dSeriesIkhCompareBase CompareBase { get; set; }
		private Scatter3dSeriesIkhCompareBase CompareBase_DefaultValue { get; set; }
		...
		internal override Hashtable ToHashtable()
		{
			...
			if (PointDescriptionFormatter != PointDescriptionFormatter_DefaultValue) { h.Add("pointDescriptionFormatter",PointDescriptionFormatter); Highstock.AddFunction("Scatter3dSeriesIkhPointDescriptionFormatter.pointDescriptionFormatter", PointDescriptionFormatter); }  
