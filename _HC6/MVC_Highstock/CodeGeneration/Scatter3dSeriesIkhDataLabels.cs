...
{
	public partial class Scatter3dSeriesIkhDataLabels  : BaseObject
	{
		public Scatter3dSeriesIkhDataLabels()
		{
			Align = Align_DefaultValue = Scatter3dSeriesIkhDataLabelsAlign.Center;
			Formatter = Formatter_DefaultValue = "";
			Style = Style_DefaultValue = new Scatter3dSeriesIkhDataLabelsStyle();
			VerticalAlign = VerticalAlign_DefaultValue = Scatter3dSeriesIkhDataLabelsVerticalAlign.Bottom;
			X = X_DefaultValue = 0;
			Y = Y_DefaultValue = -6;
			...
			Overflow = Overflow_DefaultValue = Scatter3dSeriesIkhDataLabelsOverflow.Justify;
		...
		/// </summary>
		public Scatter3dSeriesIkhDataLabelsAlign Align { get; set; }
		private Scatter3dSeriesIkhDataLabelsAlign Align_DefaultValue { get; set; }
		...
		/// </summary>
		public Scatter3dSeriesIkhDataLabelsStyle Style { get; set; }
		private Scatter3dSeriesIkhDataLabelsStyle Style_DefaultValue { get; set; }
		...
		/// </summary>
		public Scatter3dSeriesIkhDataLabelsVerticalAlign VerticalAlign { get; set; }
		private Scatter3dSeriesIkhDataLabelsVerticalAlign VerticalAlign_DefaultValue { get; set; }
		...
		/// </summary>
		public Scatter3dSeriesIkhDataLabelsOverflow Overflow { get; set; }
		private Scatter3dSeriesIkhDataLabelsOverflow Overflow_DefaultValue { get; set; }
		...
		internal override Hashtable ToHashtable()
		{
			...
			if (Formatter != Formatter_DefaultValue) { h.Add("formatter",Formatter); Highstock.AddFunction("Scatter3dSeriesIkhDataLabelsFormatter.formatter", Formatter); }  
