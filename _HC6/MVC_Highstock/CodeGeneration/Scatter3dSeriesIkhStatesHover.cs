...
{
	public partial class Scatter3dSeriesIkhStatesHover  : BaseObject
	{
		public Scatter3dSeriesIkhStatesHover()
		{
			LineWidthPlus = LineWidthPlus_DefaultValue = 1;
			Marker = Marker_DefaultValue = new Scatter3dSeriesIkhStatesHoverMarker();
			Halo = Halo_DefaultValue = new Scatter3dSeriesIkhStatesHoverHalo();
		...
		/// </summary>
		public Scatter3dSeriesIkhStatesHoverMarker Marker { get; set; }
		private Scatter3dSeriesIkhStatesHoverMarker Marker_DefaultValue { get; set; }
		...
		/// </summary>
		public Scatter3dSeriesIkhStatesHoverHalo Halo { get; set; }
		private Scatter3dSeriesIkhStatesHoverHalo Halo_DefaultValue { get; set; }
