...
{
	public partial class Scatter3dSeriesIkhStatesHoverMarker  : BaseObject
	{
		public Scatter3dSeriesIkhStatesHoverMarker()
		{
			LineWidth = LineWidth_DefaultValue = 0;
			LineColor = LineColor_DefaultValue = "#ffffff";
			Radius = Radius_DefaultValue = 4;
			States = States_DefaultValue = new Scatter3dSeriesIkhStatesHoverMarkerStates();
		...
		/// </summary>
		public Scatter3dSeriesIkhStatesHoverMarkerStates States { get; set; }
		private Scatter3dSeriesIkhStatesHoverMarkerStates States_DefaultValue { get; set; }
