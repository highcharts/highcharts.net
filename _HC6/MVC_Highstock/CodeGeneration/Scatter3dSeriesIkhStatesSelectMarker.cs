...
{
	public partial class Scatter3dSeriesIkhStatesSelectMarker  : BaseObject
	{
		public Scatter3dSeriesIkhStatesSelectMarker()
		{
			LineWidth = LineWidth_DefaultValue = 0;
			LineColor = LineColor_DefaultValue = "#ffffff";
			Radius = Radius_DefaultValue = 4;
			States = States_DefaultValue = new Scatter3dSeriesIkhStatesSelectMarkerStates();
		...
		/// </summary>
		public Scatter3dSeriesIkhStatesSelectMarkerStates States { get; set; }
		private Scatter3dSeriesIkhStatesSelectMarkerStates States_DefaultValue { get; set; }
