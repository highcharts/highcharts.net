...
{
	public partial class Scatter3dSeriesIkhTooltip  : BaseObject
	{
		public Scatter3dSeriesIkhTooltip()
		{
			ValueDecimals = ValueDecimals_DefaultValue = null;
			DateTimeLabelFormats = DateTimeLabelFormats_DefaultValue = new Scatter3dSeriesIkhTooltipDateTimeLabelFormats();
		...
		/// </summary>
		public Scatter3dSeriesIkhTooltipDateTimeLabelFormats DateTimeLabelFormats { get; set; }
		private Scatter3dSeriesIkhTooltipDateTimeLabelFormats DateTimeLabelFormats_DefaultValue { get; set; }
		...
		internal override Hashtable ToHashtable()
		{
			...
			if (PointFormatter != PointFormatter_DefaultValue) { h.Add("pointFormatter",PointFormatter); Highstock.AddFunction("Scatter3dSeriesIkhTooltipPointFormatter.pointFormatter", PointFormatter); }  
