...
namespace Highsoft.Web.Mvc.Stocks
{
	public partial class Scatter3dSeriesTooltip  : BaseObject
	{
		public Scatter3dSeriesTooltip()
		{
			...
			DateTimeLabelFormats = DateTimeLabelFormats_DefaultValue = new Scatter3dSeriesTooltipDateTimeLabelFormats();
		...
		/// </summary>
		public Scatter3dSeriesTooltipDateTimeLabelFormats DateTimeLabelFormats { get; set; }
		private Scatter3dSeriesTooltipDateTimeLabelFormats DateTimeLabelFormats_DefaultValue { get; set; }
		...
		internal override Hashtable ToHashtable()
		{
			...
			if (PointFormatter != PointFormatter_DefaultValue) { h.Add("pointFormatter",PointFormatter); Highstock.AddFunction("Scatter3dSeriesTooltipPointFormatter.pointFormatter", PointFormatter); }  
