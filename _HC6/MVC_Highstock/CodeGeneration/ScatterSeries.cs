...
namespace Highsoft.Web.Mvc.Stocks
{
	public partial class ScatterSeries  : Series
	{
		public ScatterSeries()
		{
			...
			Ikh = Ikh_DefaultValue = new ScatterSeriesIkh();
			...
			FindNearestPointBy = FindNearestPointBy_DefaultValue = ScatterSeriesFindNearestPointBy.Xy;
		...
		/// </summary>
		public ScatterSeriesIkh Ikh { get; set; }
		private ScatterSeriesIkh Ikh_DefaultValue { get; set; }
