...
{
	public partial class ScatterSeriesIkh  : BaseObject
	{
		public ScatterSeriesIkh()
		{
			Name = Name_DefaultValue = "SMA (14)";
			Tooltip = Tooltip_DefaultValue = new ScatterSeriesIkhTooltip();
			LinkedTo = LinkedTo_DefaultValue = null;
			Params = Params_DefaultValue = new ScatterSeriesIkhParams();
			Linecap = Linecap_DefaultValue = ScatterSeriesIkhLinecap.Round;
			BoostThreshold = BoostThreshold_DefaultValue = 5000;
			GapSize = GapSize_DefaultValue = 0;
			GapUnit = GapUnit_DefaultValue = ScatterSeriesIkhGapUnit.Relative;
			Label = Label_DefaultValue = new ScatterSeriesIkhLabel();
			DataGrouping = DataGrouping_DefaultValue = new ScatterSeriesIkhDataGrouping();
			LineWidth = LineWidth_DefaultValue = 2;
			AllowPointSelect = AllowPointSelect_DefaultValue = false;
			ShowCheckbox = ShowCheckbox_DefaultValue = false;
			Animation = Animation_DefaultValue = new Animation() { Enabled = true };
			Events = Events_DefaultValue = new ScatterSeriesIkhEvents();
			Marker = Marker_DefaultValue = new ScatterSeriesIkhMarker();
			Point = Point_DefaultValue = new ScatterSeriesIkhPoint();
			DataLabels = DataLabels_DefaultValue = new ScatterSeriesIkhDataLabels();
			CropThreshold = CropThreshold_DefaultValue = 300;
			SoftThreshold = SoftThreshold_DefaultValue = true;
			States = States_DefaultValue = new ScatterSeriesIkhStates();
			StickyTracking = StickyTracking_DefaultValue = null;
			TurboThreshold = TurboThreshold_DefaultValue = 1000;
			FindNearestPointBy = FindNearestPointBy_DefaultValue = ScatterSeriesIkhFindNearestPointBy.X;
			AnimationLimit = AnimationLimit_DefaultValue = null;
			ClassName = ClassName_DefaultValue = null;
			Color = Color_DefaultValue = null;
			ColorIndex = ColorIndex_DefaultValue = null;
			ConnectNulls = ConnectNulls_DefaultValue = false;
			Cursor = Cursor_DefaultValue = ScatterSeriesIkhCursor.Null;
			DashStyle = DashStyle_DefaultValue = ScatterSeriesIkhDashStyle.Solid;
			...
			Step = Step_DefaultValue = ScatterSeriesIkhStep.Null;
			Threshold = Threshold_DefaultValue = 0;
			Visible = Visible_DefaultValue = true;
			ZoneAxis = ZoneAxis_DefaultValue = "y";
			Zones = Zones_DefaultValue = new List<ScatterSeriesIkhZone>();
			...
			PointIntervalUnit = PointIntervalUnit_DefaultValue = ScatterSeriesIkhPointIntervalUnit.Null;
			PointPlacement = PointPlacement_DefaultValue = new PointPlacement();
			PointStart = PointStart_DefaultValue = 0;
			Stacking = Stacking_DefaultValue = ScatterSeriesIkhStacking.Null;
			Compare = Compare_DefaultValue = "undefined";
			CompareBase = CompareBase_DefaultValue = ScatterSeriesIkhCompareBase.Min;
		...
		/// </summary>
		public ScatterSeriesIkhTooltip Tooltip { get; set; }
		private ScatterSeriesIkhTooltip Tooltip_DefaultValue { get; set; }
		...
		/// 
		/// </summary>
		public ScatterSeriesIkhParams Params { get; set; }
		private ScatterSeriesIkhParams Params_DefaultValue { get; set; }
		...
		/// </summary>
		public ScatterSeriesIkhLinecap Linecap { get; set; }
		private ScatterSeriesIkhLinecap Linecap_DefaultValue { get; set; }
		...
		/// </summary>
		public ScatterSeriesIkhGapUnit GapUnit { get; set; }
		private ScatterSeriesIkhGapUnit GapUnit_DefaultValue { get; set; }
		...
		/// </summary>
		public ScatterSeriesIkhLabel Label { get; set; }
		private ScatterSeriesIkhLabel Label_DefaultValue { get; set; }
		...
		/// </summary>
		public ScatterSeriesIkhDataGrouping DataGrouping { get; set; }
		private ScatterSeriesIkhDataGrouping DataGrouping_DefaultValue { get; set; }
		...
		/// </summary>
		public ScatterSeriesIkhEvents Events { get; set; }
		private ScatterSeriesIkhEvents Events_DefaultValue { get; set; }
		...
		/// </summary>
		public ScatterSeriesIkhMarker Marker { get; set; }
		private ScatterSeriesIkhMarker Marker_DefaultValue { get; set; }
		 

		/// <summary>
		/// <p>Properties for each single point.</p>
		/// </summary>
		public ScatterSeriesIkhPoint Point { get; set; }
		private ScatterSeriesIkhPoint Point_DefaultValue { get; set; }
		...
		/// </summary>
		public ScatterSeriesIkhDataLabels DataLabels { get; set; }
		private ScatterSeriesIkhDataLabels DataLabels_DefaultValue { get; set; }
		...
		/// </summary>
		public ScatterSeriesIkhStates States { get; set; }
		private ScatterSeriesIkhStates States_DefaultValue { get; set; }
		...
		/// </summary>
		public ScatterSeriesIkhFindNearestPointBy FindNearestPointBy { get; set; }
		private ScatterSeriesIkhFindNearestPointBy FindNearestPointBy_DefaultValue { get; set; }
		...
		/// </summary>
		public ScatterSeriesIkhCursor Cursor { get; set; }
		private ScatterSeriesIkhCursor Cursor_DefaultValue { get; set; }
		...
		/// </summary>
		public ScatterSeriesIkhDashStyle DashStyle { get; set; }
		private ScatterSeriesIkhDashStyle DashStyle_DefaultValue { get; set; }
		...
		/// </summary>
		public ScatterSeriesIkhStep Step { get; set; }
		private ScatterSeriesIkhStep Step_DefaultValue { get; set; }
		...
		/// </summary>
		public List<ScatterSeriesIkhZone> Zones { get; set; }
		private List<ScatterSeriesIkhZone> Zones_DefaultValue { get; set; }
		...
		/// </summary>
		public ScatterSeriesIkhPointIntervalUnit PointIntervalUnit { get; set; }
		private ScatterSeriesIkhPointIntervalUnit PointIntervalUnit_DefaultValue { get; set; }
		...
		/// </summary>
		public ScatterSeriesIkhStacking Stacking { get; set; }
		private ScatterSeriesIkhStacking Stacking_DefaultValue { get; set; }
		...
		/// </summary>
		public ScatterSeriesIkhCompareBase CompareBase { get; set; }
		private ScatterSeriesIkhCompareBase CompareBase_DefaultValue { get; set; }
		...
		internal override Hashtable ToHashtable()
		{
			...
			if (PointDescriptionFormatter != PointDescriptionFormatter_DefaultValue) { h.Add("pointDescriptionFormatter",PointDescriptionFormatter); Highstock.AddFunction("ScatterSeriesIkhPointDescriptionFormatter.pointDescriptionFormatter", PointDescriptionFormatter); }  
