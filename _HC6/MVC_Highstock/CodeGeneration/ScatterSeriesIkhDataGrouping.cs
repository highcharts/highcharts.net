...
{
	public partial class ScatterSeriesIkhDataGrouping  : BaseObject
	{
		public ScatterSeriesIkhDataGrouping()
		{
			Approximation = Approximation_DefaultValue = ScatterSeriesIkhDataGroupingApproximation.Average;
		...
		/// </summary>
		public ScatterSeriesIkhDataGroupingApproximation Approximation { get; set; }
		private ScatterSeriesIkhDataGroupingApproximation Approximation_DefaultValue { get; set; }
