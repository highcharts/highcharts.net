...
{
	public partial class ScatterSeriesIkhDataLabels  : BaseObject
	{
		public ScatterSeriesIkhDataLabels()
		{
			Align = Align_DefaultValue = ScatterSeriesIkhDataLabelsAlign.Center;
			Formatter = Formatter_DefaultValue = "";
			Style = Style_DefaultValue = new ScatterSeriesIkhDataLabelsStyle();
			VerticalAlign = VerticalAlign_DefaultValue = ScatterSeriesIkhDataLabelsVerticalAlign.Bottom;
			X = X_DefaultValue = 0;
			Y = Y_DefaultValue = -6;
			...
			Overflow = Overflow_DefaultValue = ScatterSeriesIkhDataLabelsOverflow.Justify;
		...
		/// </summary>
		public ScatterSeriesIkhDataLabelsAlign Align { get; set; }
		private ScatterSeriesIkhDataLabelsAlign Align_DefaultValue { get; set; }
		...
		/// </summary>
		public ScatterSeriesIkhDataLabelsStyle Style { get; set; }
		private ScatterSeriesIkhDataLabelsStyle Style_DefaultValue { get; set; }
		...
		/// </summary>
		public ScatterSeriesIkhDataLabelsVerticalAlign VerticalAlign { get; set; }
		private ScatterSeriesIkhDataLabelsVerticalAlign VerticalAlign_DefaultValue { get; set; }
		...
		/// </summary>
		public ScatterSeriesIkhDataLabelsOverflow Overflow { get; set; }
		private ScatterSeriesIkhDataLabelsOverflow Overflow_DefaultValue { get; set; }
		...
		internal override Hashtable ToHashtable()
		{
			...
			if (Formatter != Formatter_DefaultValue) { h.Add("formatter",Formatter); Highstock.AddFunction("ScatterSeriesIkhDataLabelsFormatter.formatter", Formatter); }  
