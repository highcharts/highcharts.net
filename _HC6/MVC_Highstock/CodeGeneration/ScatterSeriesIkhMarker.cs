...
{
	public partial class ScatterSeriesIkhMarker  : BaseObject
	{
		public ScatterSeriesIkhMarker()
		{
			LineWidth = LineWidth_DefaultValue = 0;
			LineColor = LineColor_DefaultValue = "#ffffff";
			Radius = Radius_DefaultValue = 4;
			States = States_DefaultValue = new ScatterSeriesIkhMarkerStates();
		...
		/// </summary>
		public ScatterSeriesIkhMarkerStates States { get; set; }
		private ScatterSeriesIkhMarkerStates States_DefaultValue { get; set; }
