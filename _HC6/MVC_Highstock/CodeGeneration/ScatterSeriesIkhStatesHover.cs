...
{
	public partial class ScatterSeriesIkhStatesHover  : BaseObject
	{
		public ScatterSeriesIkhStatesHover()
		{
			LineWidthPlus = LineWidthPlus_DefaultValue = 1;
			Marker = Marker_DefaultValue = new ScatterSeriesIkhStatesHoverMarker();
			Halo = Halo_DefaultValue = new ScatterSeriesIkhStatesHoverHalo();
		...
		/// </summary>
		public ScatterSeriesIkhStatesHoverMarker Marker { get; set; }
		private ScatterSeriesIkhStatesHoverMarker Marker_DefaultValue { get; set; }
		...
		/// </summary>
		public ScatterSeriesIkhStatesHoverHalo Halo { get; set; }
		private ScatterSeriesIkhStatesHoverHalo Halo_DefaultValue { get; set; }
