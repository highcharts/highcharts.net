...
{
	public partial class ScatterSeriesIkhStatesHoverMarker  : BaseObject
	{
		public ScatterSeriesIkhStatesHoverMarker()
		{
			LineWidth = LineWidth_DefaultValue = 0;
			LineColor = LineColor_DefaultValue = "#ffffff";
			Radius = Radius_DefaultValue = 4;
			States = States_DefaultValue = new ScatterSeriesIkhStatesHoverMarkerStates();
		...
		/// </summary>
		public ScatterSeriesIkhStatesHoverMarkerStates States { get; set; }
		private ScatterSeriesIkhStatesHoverMarkerStates States_DefaultValue { get; set; }
