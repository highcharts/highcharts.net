...
{
	public partial class ScatterSeriesIkhStatesSelectMarker  : BaseObject
	{
		public ScatterSeriesIkhStatesSelectMarker()
		{
			LineWidth = LineWidth_DefaultValue = 0;
			LineColor = LineColor_DefaultValue = "#ffffff";
			Radius = Radius_DefaultValue = 4;
			States = States_DefaultValue = new ScatterSeriesIkhStatesSelectMarkerStates();
		...
		/// </summary>
		public ScatterSeriesIkhStatesSelectMarkerStates States { get; set; }
		private ScatterSeriesIkhStatesSelectMarkerStates States_DefaultValue { get; set; }
