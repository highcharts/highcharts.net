...
{
	public partial class ScatterSeriesIkhTooltip  : BaseObject
	{
		public ScatterSeriesIkhTooltip()
		{
			ValueDecimals = ValueDecimals_DefaultValue = null;
			DateTimeLabelFormats = DateTimeLabelFormats_DefaultValue = new ScatterSeriesIkhTooltipDateTimeLabelFormats();
		...
		/// </summary>
		public ScatterSeriesIkhTooltipDateTimeLabelFormats DateTimeLabelFormats { get; set; }
		private ScatterSeriesIkhTooltipDateTimeLabelFormats DateTimeLabelFormats_DefaultValue { get; set; }
		...
		internal override Hashtable ToHashtable()
		{
			...
			if (PointFormatter != PointFormatter_DefaultValue) { h.Add("pointFormatter",PointFormatter); Highstock.AddFunction("ScatterSeriesIkhTooltipPointFormatter.pointFormatter", PointFormatter); }  
