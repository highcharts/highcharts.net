...
namespace Highsoft.Web.Mvc.Stocks
{
	public partial class ScatterSeriesTooltip  : BaseObject
	{
		public ScatterSeriesTooltip()
		{
			...
			DateTimeLabelFormats = DateTimeLabelFormats_DefaultValue = new ScatterSeriesTooltipDateTimeLabelFormats();
		...
		/// </summary>
		public ScatterSeriesTooltipDateTimeLabelFormats DateTimeLabelFormats { get; set; }
		private ScatterSeriesTooltipDateTimeLabelFormats DateTimeLabelFormats_DefaultValue { get; set; }
