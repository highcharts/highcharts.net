...
namespace Highsoft.Web.Mvc.Stocks
{
	public partial class Scrollbar  : BaseObject
	{
		...
		/// <summary>
		/// <p>The height of the scrollbar. The height also applies to the widthof the scroll arrows so that they are always squares. Defaults to20 for touch devices and 14 for mouse devices.</p>
		/// </summary>
		...
		/// <summary>
		/// <p>Whether to redraw the main chart as the scrollbar or the navigatorzoomed window is moved. Defaults to <code>true</code> for modern browsers and<code>false</code> for legacy IE browsers as well as mobile devices.</p>
		/// </summary>
		...
		/// <summary>
		/// <p>The margin between the scrollbar and its axis when the scrollbar isapplied directly to an axis.</p>
		/// </summary>
		...
		/// <summary>
		/// <p>Whether to show or hide the scrollbar when the scrolled content iszoomed out to it full extent.</p>
		/// </summary>
