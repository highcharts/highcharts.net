...
namespace Highsoft.Web.Mvc.Stocks
{
	public partial class SmaSeries  : Series
	{
		public SmaSeries()
		{
			Ikh = Ikh_DefaultValue = new SmaSeriesIkh();
			...
			Zones = Zones_DefaultValue = new SmaSeriesZone();
			...
			PointIntervalUnit = PointIntervalUnit_DefaultValue = SmaSeriesPointIntervalUnit.Null;
			PointPlacement = PointPlacement_DefaultValue = new PointPlacement();
			PointStart = PointStart_DefaultValue = 0;
			Stacking = Stacking_DefaultValue = SmaSeriesStacking.Null;
		...
		/// </summary>
		public SmaSeriesIkh Ikh { get; set; }
		private SmaSeriesIkh Ikh_DefaultValue { get; set; }
		...
		/// </summary>
		public SmaSeriesZone Zones { get; set; }
		private SmaSeriesZone Zones_DefaultValue { get; set; }
		...
		/// </summary>
		public SmaSeriesPointIntervalUnit PointIntervalUnit { get; set; }
		private SmaSeriesPointIntervalUnit PointIntervalUnit_DefaultValue { get; set; }
		...
		/// </summary>
		public SmaSeriesStacking Stacking { get; set; }
		private SmaSeriesStacking Stacking_DefaultValue { get; set; }
