...
{
	public partial class SmaSeriesData  : BaseObject
	{
		public SmaSeriesData()
		{
			...
			DragDrop = DragDrop_DefaultValue = new SmaSeriesDataDragDrop();
			Drilldown = Drilldown_DefaultValue = "";
			Events = Events_DefaultValue = new SmaSeriesDataEvents();
			Id = Id_DefaultValue = "";
			Labelrank = Labelrank_DefaultValue = null;
			Marker = Marker_DefaultValue = new SmaSeriesDataMarker();
		...
		/// </summary>
		public SmaSeriesDataDragDrop DragDrop { get; set; }
		private SmaSeriesDataDragDrop DragDrop_DefaultValue { get; set; }
		...
		/// </summary>
		public SmaSeriesDataEvents Events { get; set; }
		private SmaSeriesDataEvents Events_DefaultValue { get; set; }
		...
		/// 
		/// </summary>
		public SmaSeriesDataMarker Marker { get; set; }
		private SmaSeriesDataMarker Marker_DefaultValue { get; set; }
