...
{
	public partial class SmaSeriesDataDragDropDragHandle  : BaseObject
	{
		public SmaSeriesDataDragDropDragHandle()
		{
		...
		internal override Hashtable ToHashtable()
		{
			...
			if (PathFormatter != PathFormatter_DefaultValue) { h.Add("pathFormatter",PathFormatter); Highstock.AddFunction("SmaSeriesDataDragDropDragHandlePathFormatter.pathFormatter", PathFormatter); }  
