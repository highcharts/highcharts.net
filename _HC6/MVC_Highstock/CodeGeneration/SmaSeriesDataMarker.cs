...
{
	public partial class SmaSeriesDataMarker  : BaseObject
	{
		public SmaSeriesDataMarker()
		{
			...
			States = States_DefaultValue = new SmaSeriesDataMarkerStates();
		...
		/// </summary>
		public SmaSeriesDataMarkerStates States { get; set; }
		private SmaSeriesDataMarkerStates States_DefaultValue { get; set; }
