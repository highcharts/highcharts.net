...
{
	public partial class SmaSeriesIkhDataGrouping  : BaseObject
	{
		public SmaSeriesIkhDataGrouping()
		{
			Approximation = Approximation_DefaultValue = SmaSeriesIkhDataGroupingApproximation.Average;
		...
		/// </summary>
		public SmaSeriesIkhDataGroupingApproximation Approximation { get; set; }
		private SmaSeriesIkhDataGroupingApproximation Approximation_DefaultValue { get; set; }
