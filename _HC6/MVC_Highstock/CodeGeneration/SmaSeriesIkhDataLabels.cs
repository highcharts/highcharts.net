...
{
	public partial class SmaSeriesIkhDataLabels  : BaseObject
	{
		public SmaSeriesIkhDataLabels()
		{
			Align = Align_DefaultValue = SmaSeriesIkhDataLabelsAlign.Center;
			Formatter = Formatter_DefaultValue = "";
			Style = Style_DefaultValue = new SmaSeriesIkhDataLabelsStyle();
			VerticalAlign = VerticalAlign_DefaultValue = SmaSeriesIkhDataLabelsVerticalAlign.Bottom;
			X = X_DefaultValue = 0;
			Y = Y_DefaultValue = -6;
			...
			Overflow = Overflow_DefaultValue = SmaSeriesIkhDataLabelsOverflow.Justify;
		...
		/// </summary>
		public SmaSeriesIkhDataLabelsAlign Align { get; set; }
		private SmaSeriesIkhDataLabelsAlign Align_DefaultValue { get; set; }
		...
		/// </summary>
		public SmaSeriesIkhDataLabelsStyle Style { get; set; }
		private SmaSeriesIkhDataLabelsStyle Style_DefaultValue { get; set; }
		...
		/// </summary>
		public SmaSeriesIkhDataLabelsVerticalAlign VerticalAlign { get; set; }
		private SmaSeriesIkhDataLabelsVerticalAlign VerticalAlign_DefaultValue { get; set; }
		...
		/// </summary>
		public SmaSeriesIkhDataLabelsOverflow Overflow { get; set; }
		private SmaSeriesIkhDataLabelsOverflow Overflow_DefaultValue { get; set; }
		...
		internal override Hashtable ToHashtable()
		{
			...
			if (Formatter != Formatter_DefaultValue) { h.Add("formatter",Formatter); Highstock.AddFunction("SmaSeriesIkhDataLabelsFormatter.formatter", Formatter); }  
