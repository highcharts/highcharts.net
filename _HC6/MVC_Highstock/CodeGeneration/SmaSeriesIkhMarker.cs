...
{
	public partial class SmaSeriesIkhMarker  : BaseObject
	{
		public SmaSeriesIkhMarker()
		{
			LineWidth = LineWidth_DefaultValue = 0;
			LineColor = LineColor_DefaultValue = "#ffffff";
			Radius = Radius_DefaultValue = 4;
			States = States_DefaultValue = new SmaSeriesIkhMarkerStates();
		...
		/// </summary>
		public SmaSeriesIkhMarkerStates States { get; set; }
		private SmaSeriesIkhMarkerStates States_DefaultValue { get; set; }
