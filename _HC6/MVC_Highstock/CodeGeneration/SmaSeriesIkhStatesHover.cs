...
{
	public partial class SmaSeriesIkhStatesHover  : BaseObject
	{
		public SmaSeriesIkhStatesHover()
		{
			LineWidthPlus = LineWidthPlus_DefaultValue = 1;
			Marker = Marker_DefaultValue = new SmaSeriesIkhStatesHoverMarker();
			Halo = Halo_DefaultValue = new SmaSeriesIkhStatesHoverHalo();
		...
		/// </summary>
		public SmaSeriesIkhStatesHoverMarker Marker { get; set; }
		private SmaSeriesIkhStatesHoverMarker Marker_DefaultValue { get; set; }
		...
		/// </summary>
		public SmaSeriesIkhStatesHoverHalo Halo { get; set; }
		private SmaSeriesIkhStatesHoverHalo Halo_DefaultValue { get; set; }
