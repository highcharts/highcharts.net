...
{
	public partial class SmaSeriesIkhStatesSelectMarker  : BaseObject
	{
		public SmaSeriesIkhStatesSelectMarker()
		{
			LineWidth = LineWidth_DefaultValue = 0;
			LineColor = LineColor_DefaultValue = "#ffffff";
			Radius = Radius_DefaultValue = 4;
			States = States_DefaultValue = new SmaSeriesIkhStatesSelectMarkerStates();
		...
		/// </summary>
		public SmaSeriesIkhStatesSelectMarkerStates States { get; set; }
		private SmaSeriesIkhStatesSelectMarkerStates States_DefaultValue { get; set; }
