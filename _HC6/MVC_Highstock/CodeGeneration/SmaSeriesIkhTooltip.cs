...
{
	public partial class SmaSeriesIkhTooltip  : BaseObject
	{
		public SmaSeriesIkhTooltip()
		{
			ValueDecimals = ValueDecimals_DefaultValue = null;
			DateTimeLabelFormats = DateTimeLabelFormats_DefaultValue = new SmaSeriesIkhTooltipDateTimeLabelFormats();
		...
		/// </summary>
		public SmaSeriesIkhTooltipDateTimeLabelFormats DateTimeLabelFormats { get; set; }
		private SmaSeriesIkhTooltipDateTimeLabelFormats DateTimeLabelFormats_DefaultValue { get; set; }
		...
		internal override Hashtable ToHashtable()
		{
			...
			if (PointFormatter != PointFormatter_DefaultValue) { h.Add("pointFormatter",PointFormatter); Highstock.AddFunction("SmaSeriesIkhTooltipPointFormatter.pointFormatter", PointFormatter); }  
