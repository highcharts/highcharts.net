...
namespace Highsoft.Web.Mvc.Stocks
{
	public partial class SmaSeriesTooltip  : BaseObject
	{
		public SmaSeriesTooltip()
		{
			...
			DateTimeLabelFormats = DateTimeLabelFormats_DefaultValue = new SmaSeriesTooltipDateTimeLabelFormats();
		...
		/// </summary>
		public SmaSeriesTooltipDateTimeLabelFormats DateTimeLabelFormats { get; set; }
		private SmaSeriesTooltipDateTimeLabelFormats DateTimeLabelFormats_DefaultValue { get; set; }
