...
{
	public partial class SolidgaugeSeriesDataGrouping  : BaseObject
	{
		public SolidgaugeSeriesDataGrouping()
		{
			Approximation = Approximation_DefaultValue = SolidgaugeSeriesDataGroupingApproximation.Average;
		...
		/// </summary>
		public SolidgaugeSeriesDataGroupingApproximation Approximation { get; set; }
		private SolidgaugeSeriesDataGroupingApproximation Approximation_DefaultValue { get; set; }
