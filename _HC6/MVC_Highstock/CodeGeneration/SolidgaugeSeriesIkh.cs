...
namespace Highsoft.Web.Mvc.Stocks
{
	public partial class SolidgaugeSeriesIkh  : BaseObject
	{
		public SolidgaugeSeriesIkh()
		{
			...
			Zones = Zones_DefaultValue = new SolidgaugeSeriesIkhZone();
		...
		/// </summary>
		public SolidgaugeSeriesIkhZone Zones { get; set; }
		private SolidgaugeSeriesIkhZone Zones_DefaultValue { get; set; }
