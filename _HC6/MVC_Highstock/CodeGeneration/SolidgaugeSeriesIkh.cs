...
{
	public partial class SolidgaugeSeriesIkh  : BaseObject
	{
		public SolidgaugeSeriesIkh()
		{
			Name = Name_DefaultValue = "SMA (14)";
			Tooltip = Tooltip_DefaultValue = new SolidgaugeSeriesIkhTooltip();
			LinkedTo = LinkedTo_DefaultValue = null;
			Params = Params_DefaultValue = new SolidgaugeSeriesIkhParams();
			Linecap = Linecap_DefaultValue = SolidgaugeSeriesIkhLinecap.Round;
			BoostThreshold = BoostThreshold_DefaultValue = 5000;
			GapSize = GapSize_DefaultValue = 0;
			GapUnit = GapUnit_DefaultValue = SolidgaugeSeriesIkhGapUnit.Relative;
			Label = Label_DefaultValue = new SolidgaugeSeriesIkhLabel();
			DataGrouping = DataGrouping_DefaultValue = new SolidgaugeSeriesIkhDataGrouping();
			LineWidth = LineWidth_DefaultValue = 2;
			AllowPointSelect = AllowPointSelect_DefaultValue = false;
			ShowCheckbox = ShowCheckbox_DefaultValue = false;
			Animation = Animation_DefaultValue = new Animation() { Enabled = true };
			Events = Events_DefaultValue = new SolidgaugeSeriesIkhEvents();
			Marker = Marker_DefaultValue = new SolidgaugeSeriesIkhMarker();
			Point = Point_DefaultValue = new SolidgaugeSeriesIkhPoint();
			DataLabels = DataLabels_DefaultValue = new SolidgaugeSeriesIkhDataLabels();
			CropThreshold = CropThreshold_DefaultValue = 300;
			SoftThreshold = SoftThreshold_DefaultValue = true;
			States = States_DefaultValue = new SolidgaugeSeriesIkhStates();
			StickyTracking = StickyTracking_DefaultValue = null;
			TurboThreshold = TurboThreshold_DefaultValue = 1000;
			FindNearestPointBy = FindNearestPointBy_DefaultValue = SolidgaugeSeriesIkhFindNearestPointBy.X;
			AnimationLimit = AnimationLimit_DefaultValue = null;
			ClassName = ClassName_DefaultValue = null;
			Color = Color_DefaultValue = null;
			ColorIndex = ColorIndex_DefaultValue = null;
			ConnectNulls = ConnectNulls_DefaultValue = false;
			Cursor = Cursor_DefaultValue = SolidgaugeSeriesIkhCursor.Null;
			DashStyle = DashStyle_DefaultValue = SolidgaugeSeriesIkhDashStyle.Solid;
			...
			Step = Step_DefaultValue = SolidgaugeSeriesIkhStep.Null;
			Threshold = Threshold_DefaultValue = 0;
			Visible = Visible_DefaultValue = true;
			ZoneAxis = ZoneAxis_DefaultValue = "y";
			Zones = Zones_DefaultValue = new List<SolidgaugeSeriesIkhZone>();
			...
			PointIntervalUnit = PointIntervalUnit_DefaultValue = SolidgaugeSeriesIkhPointIntervalUnit.Null;
			PointPlacement = PointPlacement_DefaultValue = new PointPlacement();
			PointStart = PointStart_DefaultValue = 0;
			Stacking = Stacking_DefaultValue = SolidgaugeSeriesIkhStacking.Null;
			Compare = Compare_DefaultValue = "undefined";
			CompareBase = CompareBase_DefaultValue = SolidgaugeSeriesIkhCompareBase.Min;
		...
		/// </summary>
		public SolidgaugeSeriesIkhTooltip Tooltip { get; set; }
		private SolidgaugeSeriesIkhTooltip Tooltip_DefaultValue { get; set; }
		...
		/// 
		/// </summary>
		public SolidgaugeSeriesIkhParams Params { get; set; }
		private SolidgaugeSeriesIkhParams Params_DefaultValue { get; set; }
		...
		/// </summary>
		public SolidgaugeSeriesIkhLinecap Linecap { get; set; }
		private SolidgaugeSeriesIkhLinecap Linecap_DefaultValue { get; set; }
		...
		/// </summary>
		public SolidgaugeSeriesIkhGapUnit GapUnit { get; set; }
		private SolidgaugeSeriesIkhGapUnit GapUnit_DefaultValue { get; set; }
		...
		/// </summary>
		public SolidgaugeSeriesIkhLabel Label { get; set; }
		private SolidgaugeSeriesIkhLabel Label_DefaultValue { get; set; }
		...
		/// </summary>
		public SolidgaugeSeriesIkhDataGrouping DataGrouping { get; set; }
		private SolidgaugeSeriesIkhDataGrouping DataGrouping_DefaultValue { get; set; }
		...
		/// </summary>
		public SolidgaugeSeriesIkhEvents Events { get; set; }
		private SolidgaugeSeriesIkhEvents Events_DefaultValue { get; set; }
		...
		/// </summary>
		public SolidgaugeSeriesIkhMarker Marker { get; set; }
		private SolidgaugeSeriesIkhMarker Marker_DefaultValue { get; set; }
		 

		/// <summary>
		/// <p>Properties for each single point.</p>
		/// </summary>
		public SolidgaugeSeriesIkhPoint Point { get; set; }
		private SolidgaugeSeriesIkhPoint Point_DefaultValue { get; set; }
		...
		/// </summary>
		public SolidgaugeSeriesIkhDataLabels DataLabels { get; set; }
		private SolidgaugeSeriesIkhDataLabels DataLabels_DefaultValue { get; set; }
		...
		/// </summary>
		public SolidgaugeSeriesIkhStates States { get; set; }
		private SolidgaugeSeriesIkhStates States_DefaultValue { get; set; }
		...
		/// </summary>
		public SolidgaugeSeriesIkhFindNearestPointBy FindNearestPointBy { get; set; }
		private SolidgaugeSeriesIkhFindNearestPointBy FindNearestPointBy_DefaultValue { get; set; }
		...
		/// </summary>
		public SolidgaugeSeriesIkhCursor Cursor { get; set; }
		private SolidgaugeSeriesIkhCursor Cursor_DefaultValue { get; set; }
		...
		/// </summary>
		public SolidgaugeSeriesIkhDashStyle DashStyle { get; set; }
		private SolidgaugeSeriesIkhDashStyle DashStyle_DefaultValue { get; set; }
		...
		/// </summary>
		public SolidgaugeSeriesIkhStep Step { get; set; }
		private SolidgaugeSeriesIkhStep Step_DefaultValue { get; set; }
		...
		/// </summary>
		public List<SolidgaugeSeriesIkhZone> Zones { get; set; }
		private List<SolidgaugeSeriesIkhZone> Zones_DefaultValue { get; set; }
		...
		/// </summary>
		public SolidgaugeSeriesIkhPointIntervalUnit PointIntervalUnit { get; set; }
		private SolidgaugeSeriesIkhPointIntervalUnit PointIntervalUnit_DefaultValue { get; set; }
		...
		/// </summary>
		public SolidgaugeSeriesIkhStacking Stacking { get; set; }
		private SolidgaugeSeriesIkhStacking Stacking_DefaultValue { get; set; }
		...
		/// </summary>
		public SolidgaugeSeriesIkhCompareBase CompareBase { get; set; }
		private SolidgaugeSeriesIkhCompareBase CompareBase_DefaultValue { get; set; }
		...
		internal override Hashtable ToHashtable()
		{
			...
			if (PointDescriptionFormatter != PointDescriptionFormatter_DefaultValue) { h.Add("pointDescriptionFormatter",PointDescriptionFormatter); Highstock.AddFunction("SolidgaugeSeriesIkhPointDescriptionFormatter.pointDescriptionFormatter", PointDescriptionFormatter); }  
