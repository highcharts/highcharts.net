...
{
	public partial class SolidgaugeSeriesIkhDataGrouping  : BaseObject
	{
		public SolidgaugeSeriesIkhDataGrouping()
		{
			Approximation = Approximation_DefaultValue = SolidgaugeSeriesIkhDataGroupingApproximation.Average;
		...
		/// </summary>
		public SolidgaugeSeriesIkhDataGroupingApproximation Approximation { get; set; }
		private SolidgaugeSeriesIkhDataGroupingApproximation Approximation_DefaultValue { get; set; }
