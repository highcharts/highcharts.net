...
{
	public partial class SolidgaugeSeriesIkhDataLabels  : BaseObject
	{
		public SolidgaugeSeriesIkhDataLabels()
		{
			Align = Align_DefaultValue = SolidgaugeSeriesIkhDataLabelsAlign.Center;
			Formatter = Formatter_DefaultValue = "";
			Style = Style_DefaultValue = new SolidgaugeSeriesIkhDataLabelsStyle();
			VerticalAlign = VerticalAlign_DefaultValue = SolidgaugeSeriesIkhDataLabelsVerticalAlign.Bottom;
			X = X_DefaultValue = 0;
			Y = Y_DefaultValue = -6;
			...
			Overflow = Overflow_DefaultValue = SolidgaugeSeriesIkhDataLabelsOverflow.Justify;
		...
		/// </summary>
		public SolidgaugeSeriesIkhDataLabelsAlign Align { get; set; }
		private SolidgaugeSeriesIkhDataLabelsAlign Align_DefaultValue { get; set; }
		...
		/// </summary>
		public SolidgaugeSeriesIkhDataLabelsStyle Style { get; set; }
		private SolidgaugeSeriesIkhDataLabelsStyle Style_DefaultValue { get; set; }
		...
		/// </summary>
		public SolidgaugeSeriesIkhDataLabelsVerticalAlign VerticalAlign { get; set; }
		private SolidgaugeSeriesIkhDataLabelsVerticalAlign VerticalAlign_DefaultValue { get; set; }
		...
		/// </summary>
		public SolidgaugeSeriesIkhDataLabelsOverflow Overflow { get; set; }
		private SolidgaugeSeriesIkhDataLabelsOverflow Overflow_DefaultValue { get; set; }
		...
		internal override Hashtable ToHashtable()
		{
			...
			if (Formatter != Formatter_DefaultValue) { h.Add("formatter",Formatter); Highstock.AddFunction("SolidgaugeSeriesIkhDataLabelsFormatter.formatter", Formatter); }  
