...
{
	public partial class SolidgaugeSeriesIkhStatesHover  : BaseObject
	{
		public SolidgaugeSeriesIkhStatesHover()
		{
			LineWidthPlus = LineWidthPlus_DefaultValue = 1;
			Marker = Marker_DefaultValue = new SolidgaugeSeriesIkhStatesHoverMarker();
			Halo = Halo_DefaultValue = new SolidgaugeSeriesIkhStatesHoverHalo();
		...
		/// </summary>
		public SolidgaugeSeriesIkhStatesHoverMarker Marker { get; set; }
		private SolidgaugeSeriesIkhStatesHoverMarker Marker_DefaultValue { get; set; }
		...
		/// </summary>
		public SolidgaugeSeriesIkhStatesHoverHalo Halo { get; set; }
		private SolidgaugeSeriesIkhStatesHoverHalo Halo_DefaultValue { get; set; }
