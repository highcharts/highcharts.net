...
{
	public partial class SolidgaugeSeriesIkhTooltip  : BaseObject
	{
		public SolidgaugeSeriesIkhTooltip()
		{
			ValueDecimals = ValueDecimals_DefaultValue = null;
			DateTimeLabelFormats = DateTimeLabelFormats_DefaultValue = new SolidgaugeSeriesIkhTooltipDateTimeLabelFormats();
		...
		/// </summary>
		public SolidgaugeSeriesIkhTooltipDateTimeLabelFormats DateTimeLabelFormats { get; set; }
		private SolidgaugeSeriesIkhTooltipDateTimeLabelFormats DateTimeLabelFormats_DefaultValue { get; set; }
		...
		internal override Hashtable ToHashtable()
		{
			...
			if (PointFormatter != PointFormatter_DefaultValue) { h.Add("pointFormatter",PointFormatter); Highstock.AddFunction("SolidgaugeSeriesIkhTooltipPointFormatter.pointFormatter", PointFormatter); }  
