...
namespace Highsoft.Web.Mvc.Stocks
{
	public partial class SolidgaugeSeriesStatesHoverMarker  : BaseObject
	{
		public SolidgaugeSeriesStatesHoverMarker()
		{
			...
			States = States_DefaultValue = new SolidgaugeSeriesStatesHoverMarkerStates();
		...
		/// </summary>
		public SolidgaugeSeriesStatesHoverMarkerStates States { get; set; }
		private SolidgaugeSeriesStatesHoverMarkerStates States_DefaultValue { get; set; }
