...
namespace Highsoft.Web.Mvc.Stocks
{
	public partial class SplineSeries  : Series
	{
		public SplineSeries()
		{
			...
			Ikh = Ikh_DefaultValue = new SplineSeriesIkh();
			...
			Zones = Zones_DefaultValue = new SplineSeriesZone();
		...
		/// </summary>
		public SplineSeriesIkh Ikh { get; set; }
		private SplineSeriesIkh Ikh_DefaultValue { get; set; }
		...
		/// </summary>
		public SplineSeriesZone Zones { get; set; }
		private SplineSeriesZone Zones_DefaultValue { get; set; }
