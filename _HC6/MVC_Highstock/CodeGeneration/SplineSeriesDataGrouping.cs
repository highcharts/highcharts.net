...
{
	public partial class SplineSeriesDataGrouping  : BaseObject
	{
		public SplineSeriesDataGrouping()
		{
			Approximation = Approximation_DefaultValue = SplineSeriesDataGroupingApproximation.Average;
		...
		/// </summary>
		public SplineSeriesDataGroupingApproximation Approximation { get; set; }
		private SplineSeriesDataGroupingApproximation Approximation_DefaultValue { get; set; }
		...
		/// </summary>
		public SplineSeriesDataGroupingUnits Units { get; set; }
		private SplineSeriesDataGroupingUnits Units_DefaultValue { get; set; }
