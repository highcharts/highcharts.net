...
{
	public partial class SplineSeriesIkh  : BaseObject
	{
		public SplineSeriesIkh()
		{
			Name = Name_DefaultValue = "SMA (14)";
			Tooltip = Tooltip_DefaultValue = new SplineSeriesIkhTooltip();
			LinkedTo = LinkedTo_DefaultValue = null;
			Params = Params_DefaultValue = new SplineSeriesIkhParams();
			Linecap = Linecap_DefaultValue = SplineSeriesIkhLinecap.Round;
			BoostThreshold = BoostThreshold_DefaultValue = 5000;
			GapSize = GapSize_DefaultValue = 0;
			GapUnit = GapUnit_DefaultValue = SplineSeriesIkhGapUnit.Relative;
			Label = Label_DefaultValue = new SplineSeriesIkhLabel();
			DataGrouping = DataGrouping_DefaultValue = new SplineSeriesIkhDataGrouping();
			LineWidth = LineWidth_DefaultValue = 2;
			AllowPointSelect = AllowPointSelect_DefaultValue = false;
			ShowCheckbox = ShowCheckbox_DefaultValue = false;
			Animation = Animation_DefaultValue = new Animation() { Enabled = true };
			Events = Events_DefaultValue = new SplineSeriesIkhEvents();
			Marker = Marker_DefaultValue = new SplineSeriesIkhMarker();
			Point = Point_DefaultValue = new SplineSeriesIkhPoint();
			DataLabels = DataLabels_DefaultValue = new SplineSeriesIkhDataLabels();
			CropThreshold = CropThreshold_DefaultValue = 300;
			SoftThreshold = SoftThreshold_DefaultValue = true;
			States = States_DefaultValue = new SplineSeriesIkhStates();
			StickyTracking = StickyTracking_DefaultValue = null;
			TurboThreshold = TurboThreshold_DefaultValue = 1000;
			FindNearestPointBy = FindNearestPointBy_DefaultValue = SplineSeriesIkhFindNearestPointBy.X;
			AnimationLimit = AnimationLimit_DefaultValue = null;
			ClassName = ClassName_DefaultValue = null;
			Color = Color_DefaultValue = null;
			ColorIndex = ColorIndex_DefaultValue = null;
			ConnectNulls = ConnectNulls_DefaultValue = false;
			Cursor = Cursor_DefaultValue = SplineSeriesIkhCursor.Null;
			DashStyle = DashStyle_DefaultValue = SplineSeriesIkhDashStyle.Solid;
			...
			Step = Step_DefaultValue = SplineSeriesIkhStep.Null;
			Threshold = Threshold_DefaultValue = 0;
			Visible = Visible_DefaultValue = true;
			ZoneAxis = ZoneAxis_DefaultValue = "y";
			Zones = Zones_DefaultValue = new List<SplineSeriesIkhZone>();
			...
			PointIntervalUnit = PointIntervalUnit_DefaultValue = SplineSeriesIkhPointIntervalUnit.Null;
			PointPlacement = PointPlacement_DefaultValue = new PointPlacement();
			PointStart = PointStart_DefaultValue = 0;
			Stacking = Stacking_DefaultValue = SplineSeriesIkhStacking.Null;
			Compare = Compare_DefaultValue = "undefined";
			CompareBase = CompareBase_DefaultValue = SplineSeriesIkhCompareBase.Min;
		...
		/// </summary>
		public SplineSeriesIkhTooltip Tooltip { get; set; }
		private SplineSeriesIkhTooltip Tooltip_DefaultValue { get; set; }
		...
		/// 
		/// </summary>
		public SplineSeriesIkhParams Params { get; set; }
		private SplineSeriesIkhParams Params_DefaultValue { get; set; }
		...
		/// </summary>
		public SplineSeriesIkhLinecap Linecap { get; set; }
		private SplineSeriesIkhLinecap Linecap_DefaultValue { get; set; }
		...
		/// </summary>
		public SplineSeriesIkhGapUnit GapUnit { get; set; }
		private SplineSeriesIkhGapUnit GapUnit_DefaultValue { get; set; }
		...
		/// </summary>
		public SplineSeriesIkhLabel Label { get; set; }
		private SplineSeriesIkhLabel Label_DefaultValue { get; set; }
		...
		/// </summary>
		public SplineSeriesIkhDataGrouping DataGrouping { get; set; }
		private SplineSeriesIkhDataGrouping DataGrouping_DefaultValue { get; set; }
		...
		/// </summary>
		public SplineSeriesIkhEvents Events { get; set; }
		private SplineSeriesIkhEvents Events_DefaultValue { get; set; }
		...
		/// </summary>
		public SplineSeriesIkhMarker Marker { get; set; }
		private SplineSeriesIkhMarker Marker_DefaultValue { get; set; }
		 

		/// <summary>
		/// <p>Properties for each single point.</p>
		/// </summary>
		public SplineSeriesIkhPoint Point { get; set; }
		private SplineSeriesIkhPoint Point_DefaultValue { get; set; }
		...
		/// </summary>
		public SplineSeriesIkhDataLabels DataLabels { get; set; }
		private SplineSeriesIkhDataLabels DataLabels_DefaultValue { get; set; }
		...
		/// </summary>
		public SplineSeriesIkhStates States { get; set; }
		private SplineSeriesIkhStates States_DefaultValue { get; set; }
		...
		/// </summary>
		public SplineSeriesIkhFindNearestPointBy FindNearestPointBy { get; set; }
		private SplineSeriesIkhFindNearestPointBy FindNearestPointBy_DefaultValue { get; set; }
		...
		/// </summary>
		public SplineSeriesIkhCursor Cursor { get; set; }
		private SplineSeriesIkhCursor Cursor_DefaultValue { get; set; }
		...
		/// </summary>
		public SplineSeriesIkhDashStyle DashStyle { get; set; }
		private SplineSeriesIkhDashStyle DashStyle_DefaultValue { get; set; }
		...
		/// </summary>
		public SplineSeriesIkhStep Step { get; set; }
		private SplineSeriesIkhStep Step_DefaultValue { get; set; }
		...
		/// </summary>
		public List<SplineSeriesIkhZone> Zones { get; set; }
		private List<SplineSeriesIkhZone> Zones_DefaultValue { get; set; }
		...
		/// </summary>
		public SplineSeriesIkhPointIntervalUnit PointIntervalUnit { get; set; }
		private SplineSeriesIkhPointIntervalUnit PointIntervalUnit_DefaultValue { get; set; }
		...
		/// </summary>
		public SplineSeriesIkhStacking Stacking { get; set; }
		private SplineSeriesIkhStacking Stacking_DefaultValue { get; set; }
		...
		/// </summary>
		public SplineSeriesIkhCompareBase CompareBase { get; set; }
		private SplineSeriesIkhCompareBase CompareBase_DefaultValue { get; set; }
		...
		internal override Hashtable ToHashtable()
		{
			...
			if (PointDescriptionFormatter != PointDescriptionFormatter_DefaultValue) { h.Add("pointDescriptionFormatter",PointDescriptionFormatter); Highstock.AddFunction("SplineSeriesIkhPointDescriptionFormatter.pointDescriptionFormatter", PointDescriptionFormatter); }  
