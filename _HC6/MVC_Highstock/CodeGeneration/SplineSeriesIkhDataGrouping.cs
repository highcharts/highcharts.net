...
{
	public partial class SplineSeriesIkhDataGrouping  : BaseObject
	{
		public SplineSeriesIkhDataGrouping()
		{
			Approximation = Approximation_DefaultValue = SplineSeriesIkhDataGroupingApproximation.Average;
		...
		/// </summary>
		public SplineSeriesIkhDataGroupingApproximation Approximation { get; set; }
		private SplineSeriesIkhDataGroupingApproximation Approximation_DefaultValue { get; set; }
