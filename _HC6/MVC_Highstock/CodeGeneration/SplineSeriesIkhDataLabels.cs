...
{
	public partial class SplineSeriesIkhDataLabels  : BaseObject
	{
		public SplineSeriesIkhDataLabels()
		{
			Align = Align_DefaultValue = SplineSeriesIkhDataLabelsAlign.Center;
			Formatter = Formatter_DefaultValue = "";
			Style = Style_DefaultValue = new SplineSeriesIkhDataLabelsStyle();
			VerticalAlign = VerticalAlign_DefaultValue = SplineSeriesIkhDataLabelsVerticalAlign.Bottom;
			X = X_DefaultValue = 0;
			Y = Y_DefaultValue = -6;
			...
			Overflow = Overflow_DefaultValue = SplineSeriesIkhDataLabelsOverflow.Justify;
		...
		/// </summary>
		public SplineSeriesIkhDataLabelsAlign Align { get; set; }
		private SplineSeriesIkhDataLabelsAlign Align_DefaultValue { get; set; }
		...
		/// </summary>
		public SplineSeriesIkhDataLabelsStyle Style { get; set; }
		private SplineSeriesIkhDataLabelsStyle Style_DefaultValue { get; set; }
		...
		/// </summary>
		public SplineSeriesIkhDataLabelsVerticalAlign VerticalAlign { get; set; }
		private SplineSeriesIkhDataLabelsVerticalAlign VerticalAlign_DefaultValue { get; set; }
		...
		/// </summary>
		public SplineSeriesIkhDataLabelsOverflow Overflow { get; set; }
		private SplineSeriesIkhDataLabelsOverflow Overflow_DefaultValue { get; set; }
		...
		internal override Hashtable ToHashtable()
		{
			...
			if (Formatter != Formatter_DefaultValue) { h.Add("formatter",Formatter); Highstock.AddFunction("SplineSeriesIkhDataLabelsFormatter.formatter", Formatter); }  
