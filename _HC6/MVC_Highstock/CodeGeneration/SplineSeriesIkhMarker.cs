...
{
	public partial class SplineSeriesIkhMarker  : BaseObject
	{
		public SplineSeriesIkhMarker()
		{
			LineWidth = LineWidth_DefaultValue = 0;
			LineColor = LineColor_DefaultValue = "#ffffff";
			Radius = Radius_DefaultValue = 4;
			States = States_DefaultValue = new SplineSeriesIkhMarkerStates();
		...
		/// </summary>
		public SplineSeriesIkhMarkerStates States { get; set; }
		private SplineSeriesIkhMarkerStates States_DefaultValue { get; set; }
