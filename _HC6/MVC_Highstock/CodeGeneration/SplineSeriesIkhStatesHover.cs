...
{
	public partial class SplineSeriesIkhStatesHover  : BaseObject
	{
		public SplineSeriesIkhStatesHover()
		{
			LineWidthPlus = LineWidthPlus_DefaultValue = 1;
			Marker = Marker_DefaultValue = new SplineSeriesIkhStatesHoverMarker();
			Halo = Halo_DefaultValue = new SplineSeriesIkhStatesHoverHalo();
		...
		/// </summary>
		public SplineSeriesIkhStatesHoverMarker Marker { get; set; }
		private SplineSeriesIkhStatesHoverMarker Marker_DefaultValue { get; set; }
		...
		/// </summary>
		public SplineSeriesIkhStatesHoverHalo Halo { get; set; }
		private SplineSeriesIkhStatesHoverHalo Halo_DefaultValue { get; set; }
