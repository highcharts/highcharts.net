...
{
	public partial class SplineSeriesIkhStatesSelectMarker  : BaseObject
	{
		public SplineSeriesIkhStatesSelectMarker()
		{
			LineWidth = LineWidth_DefaultValue = 0;
			LineColor = LineColor_DefaultValue = "#ffffff";
			Radius = Radius_DefaultValue = 4;
			States = States_DefaultValue = new SplineSeriesIkhStatesSelectMarkerStates();
		...
		/// </summary>
		public SplineSeriesIkhStatesSelectMarkerStates States { get; set; }
		private SplineSeriesIkhStatesSelectMarkerStates States_DefaultValue { get; set; }
