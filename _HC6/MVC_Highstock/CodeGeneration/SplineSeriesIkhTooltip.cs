...
{
	public partial class SplineSeriesIkhTooltip  : BaseObject
	{
		public SplineSeriesIkhTooltip()
		{
			ValueDecimals = ValueDecimals_DefaultValue = null;
			DateTimeLabelFormats = DateTimeLabelFormats_DefaultValue = new SplineSeriesIkhTooltipDateTimeLabelFormats();
		...
		/// </summary>
		public SplineSeriesIkhTooltipDateTimeLabelFormats DateTimeLabelFormats { get; set; }
		private SplineSeriesIkhTooltipDateTimeLabelFormats DateTimeLabelFormats_DefaultValue { get; set; }
		...
		internal override Hashtable ToHashtable()
		{
			...
			if (PointFormatter != PointFormatter_DefaultValue) { h.Add("pointFormatter",PointFormatter); Highstock.AddFunction("SplineSeriesIkhTooltipPointFormatter.pointFormatter", PointFormatter); }  
