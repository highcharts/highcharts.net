...
namespace Highsoft.Web.Mvc.Stocks
{
	public partial class StochasticSeries  : Series
	{
		...
		{
			Ikh = Ikh_DefaultValue = new StochasticSeriesIkh();
			...
			PointIntervalUnit = PointIntervalUnit_DefaultValue = StochasticSeriesPointIntervalUnit.Null;
			PointPlacement = PointPlacement_DefaultValue = new PointPlacement();
			PointStart = PointStart_DefaultValue = 0;
			Stacking = Stacking_DefaultValue = StochasticSeriesStacking.Null;
		...
		/// </summary>
		public StochasticSeriesIkh Ikh { get; set; }
		private StochasticSeriesIkh Ikh_DefaultValue { get; set; }
		...
		/// </summary>
		public StochasticSeriesPointIntervalUnit PointIntervalUnit { get; set; }
		private StochasticSeriesPointIntervalUnit PointIntervalUnit_DefaultValue { get; set; }
		...
		/// </summary>
		public StochasticSeriesStacking Stacking { get; set; }
		private StochasticSeriesStacking Stacking_DefaultValue { get; set; }
