...
{
	public partial class StochasticSeriesDataDragDropDragHandle  : BaseObject
	{
		public StochasticSeriesDataDragDropDragHandle()
		{
		...
		internal override Hashtable ToHashtable()
		{
			...
			if (PathFormatter != PathFormatter_DefaultValue) { h.Add("pathFormatter",PathFormatter); Highstock.AddFunction("StochasticSeriesDataDragDropDragHandlePathFormatter.pathFormatter", PathFormatter); }  
