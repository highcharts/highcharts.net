...
{
	public partial class StochasticSeriesIkh  : BaseObject
	{
		public StochasticSeriesIkh()
		{
			Name = Name_DefaultValue = "SMA (14)";
			Tooltip = Tooltip_DefaultValue = new StochasticSeriesIkhTooltip();
			LinkedTo = LinkedTo_DefaultValue = null;
			Params = Params_DefaultValue = new StochasticSeriesIkhParams();
			Linecap = Linecap_DefaultValue = StochasticSeriesIkhLinecap.Round;
			BoostThreshold = BoostThreshold_DefaultValue = 5000;
			GapSize = GapSize_DefaultValue = 0;
			GapUnit = GapUnit_DefaultValue = StochasticSeriesIkhGapUnit.Relative;
			Label = Label_DefaultValue = new StochasticSeriesIkhLabel();
			DataGrouping = DataGrouping_DefaultValue = new StochasticSeriesIkhDataGrouping();
			LineWidth = LineWidth_DefaultValue = 2;
			AllowPointSelect = AllowPointSelect_DefaultValue = false;
			ShowCheckbox = ShowCheckbox_DefaultValue = false;
			Animation = Animation_DefaultValue = new Animation() { Enabled = true };
			Events = Events_DefaultValue = new StochasticSeriesIkhEvents();
			Marker = Marker_DefaultValue = new StochasticSeriesIkhMarker();
			Point = Point_DefaultValue = new StochasticSeriesIkhPoint();
			DataLabels = DataLabels_DefaultValue = new StochasticSeriesIkhDataLabels();
			CropThreshold = CropThreshold_DefaultValue = 300;
			SoftThreshold = SoftThreshold_DefaultValue = true;
			States = States_DefaultValue = new StochasticSeriesIkhStates();
			StickyTracking = StickyTracking_DefaultValue = null;
			TurboThreshold = TurboThreshold_DefaultValue = 1000;
			FindNearestPointBy = FindNearestPointBy_DefaultValue = StochasticSeriesIkhFindNearestPointBy.X;
			AnimationLimit = AnimationLimit_DefaultValue = null;
			ClassName = ClassName_DefaultValue = null;
			Color = Color_DefaultValue = null;
			ColorIndex = ColorIndex_DefaultValue = null;
			ConnectNulls = ConnectNulls_DefaultValue = false;
			Cursor = Cursor_DefaultValue = StochasticSeriesIkhCursor.Null;
			DashStyle = DashStyle_DefaultValue = StochasticSeriesIkhDashStyle.Solid;
			...
			Step = Step_DefaultValue = StochasticSeriesIkhStep.Null;
			Threshold = Threshold_DefaultValue = 0;
			Visible = Visible_DefaultValue = true;
			ZoneAxis = ZoneAxis_DefaultValue = "y";
			Zones = Zones_DefaultValue = new List<StochasticSeriesIkhZone>();
			...
			PointIntervalUnit = PointIntervalUnit_DefaultValue = StochasticSeriesIkhPointIntervalUnit.Null;
			PointPlacement = PointPlacement_DefaultValue = new PointPlacement();
			PointStart = PointStart_DefaultValue = 0;
			Stacking = Stacking_DefaultValue = StochasticSeriesIkhStacking.Null;
			Compare = Compare_DefaultValue = "undefined";
			CompareBase = CompareBase_DefaultValue = StochasticSeriesIkhCompareBase.Min;
		...
		/// </summary>
		public StochasticSeriesIkhTooltip Tooltip { get; set; }
		private StochasticSeriesIkhTooltip Tooltip_DefaultValue { get; set; }
		...
		/// 
		/// </summary>
		public StochasticSeriesIkhParams Params { get; set; }
		private StochasticSeriesIkhParams Params_DefaultValue { get; set; }
		...
		/// </summary>
		public StochasticSeriesIkhLinecap Linecap { get; set; }
		private StochasticSeriesIkhLinecap Linecap_DefaultValue { get; set; }
		...
		/// </summary>
		public StochasticSeriesIkhGapUnit GapUnit { get; set; }
		private StochasticSeriesIkhGapUnit GapUnit_DefaultValue { get; set; }
		...
		/// </summary>
		public StochasticSeriesIkhLabel Label { get; set; }
		private StochasticSeriesIkhLabel Label_DefaultValue { get; set; }
		...
		/// </summary>
		public StochasticSeriesIkhDataGrouping DataGrouping { get; set; }
		private StochasticSeriesIkhDataGrouping DataGrouping_DefaultValue { get; set; }
		...
		/// </summary>
		public StochasticSeriesIkhEvents Events { get; set; }
		private StochasticSeriesIkhEvents Events_DefaultValue { get; set; }
		...
		/// </summary>
		public StochasticSeriesIkhMarker Marker { get; set; }
		private StochasticSeriesIkhMarker Marker_DefaultValue { get; set; }
		 

		/// <summary>
		/// <p>Properties for each single point.</p>
		/// </summary>
		public StochasticSeriesIkhPoint Point { get; set; }
		private StochasticSeriesIkhPoint Point_DefaultValue { get; set; }
		...
		/// </summary>
		public StochasticSeriesIkhDataLabels DataLabels { get; set; }
		private StochasticSeriesIkhDataLabels DataLabels_DefaultValue { get; set; }
		...
		/// </summary>
		public StochasticSeriesIkhStates States { get; set; }
		private StochasticSeriesIkhStates States_DefaultValue { get; set; }
		...
		/// </summary>
		public StochasticSeriesIkhFindNearestPointBy FindNearestPointBy { get; set; }
		private StochasticSeriesIkhFindNearestPointBy FindNearestPointBy_DefaultValue { get; set; }
		...
		/// </summary>
		public StochasticSeriesIkhCursor Cursor { get; set; }
		private StochasticSeriesIkhCursor Cursor_DefaultValue { get; set; }
		...
		/// </summary>
		public StochasticSeriesIkhDashStyle DashStyle { get; set; }
		private StochasticSeriesIkhDashStyle DashStyle_DefaultValue { get; set; }
		...
		/// </summary>
		public StochasticSeriesIkhStep Step { get; set; }
		private StochasticSeriesIkhStep Step_DefaultValue { get; set; }
		...
		/// </summary>
		public List<StochasticSeriesIkhZone> Zones { get; set; }
		private List<StochasticSeriesIkhZone> Zones_DefaultValue { get; set; }
		...
		/// </summary>
		public StochasticSeriesIkhPointIntervalUnit PointIntervalUnit { get; set; }
		private StochasticSeriesIkhPointIntervalUnit PointIntervalUnit_DefaultValue { get; set; }
		...
		/// </summary>
		public StochasticSeriesIkhStacking Stacking { get; set; }
		private StochasticSeriesIkhStacking Stacking_DefaultValue { get; set; }
		...
		/// </summary>
		public StochasticSeriesIkhCompareBase CompareBase { get; set; }
		private StochasticSeriesIkhCompareBase CompareBase_DefaultValue { get; set; }
		...
		internal override Hashtable ToHashtable()
		{
			...
			if (PointDescriptionFormatter != PointDescriptionFormatter_DefaultValue) { h.Add("pointDescriptionFormatter",PointDescriptionFormatter); Highstock.AddFunction("StochasticSeriesIkhPointDescriptionFormatter.pointDescriptionFormatter", PointDescriptionFormatter); }  
