...
namespace Highsoft.Web.Mvc.Stocks
{
	public partial class StochasticSeriesIkh  : BaseObject
	{
		public StochasticSeriesIkh()
		{
			...
			Zones = Zones_DefaultValue = new StochasticSeriesIkhZone();
		...
		/// </summary>
		public StochasticSeriesIkhZone Zones { get; set; }
		private StochasticSeriesIkhZone Zones_DefaultValue { get; set; }
