...
{
	public partial class StochasticSeriesIkhDataGrouping  : BaseObject
	{
		public StochasticSeriesIkhDataGrouping()
		{
			Approximation = Approximation_DefaultValue = StochasticSeriesIkhDataGroupingApproximation.Average;
		...
		/// </summary>
		public StochasticSeriesIkhDataGroupingApproximation Approximation { get; set; }
		private StochasticSeriesIkhDataGroupingApproximation Approximation_DefaultValue { get; set; }
