...
{
	public partial class StochasticSeriesIkhDataLabels  : BaseObject
	{
		public StochasticSeriesIkhDataLabels()
		{
			Align = Align_DefaultValue = StochasticSeriesIkhDataLabelsAlign.Center;
			Formatter = Formatter_DefaultValue = "";
			Style = Style_DefaultValue = new StochasticSeriesIkhDataLabelsStyle();
			VerticalAlign = VerticalAlign_DefaultValue = StochasticSeriesIkhDataLabelsVerticalAlign.Bottom;
			X = X_DefaultValue = 0;
			Y = Y_DefaultValue = -6;
			...
			Overflow = Overflow_DefaultValue = StochasticSeriesIkhDataLabelsOverflow.Justify;
		...
		/// </summary>
		public StochasticSeriesIkhDataLabelsAlign Align { get; set; }
		private StochasticSeriesIkhDataLabelsAlign Align_DefaultValue { get; set; }
		...
		/// </summary>
		public StochasticSeriesIkhDataLabelsStyle Style { get; set; }
		private StochasticSeriesIkhDataLabelsStyle Style_DefaultValue { get; set; }
		...
		/// </summary>
		public StochasticSeriesIkhDataLabelsVerticalAlign VerticalAlign { get; set; }
		private StochasticSeriesIkhDataLabelsVerticalAlign VerticalAlign_DefaultValue { get; set; }
		...
		/// </summary>
		public StochasticSeriesIkhDataLabelsOverflow Overflow { get; set; }
		private StochasticSeriesIkhDataLabelsOverflow Overflow_DefaultValue { get; set; }
		...
		internal override Hashtable ToHashtable()
		{
			...
			if (Formatter != Formatter_DefaultValue) { h.Add("formatter",Formatter); Highstock.AddFunction("StochasticSeriesIkhDataLabelsFormatter.formatter", Formatter); }  
