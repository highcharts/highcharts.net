...
{
	public partial class StochasticSeriesIkhStatesHover  : BaseObject
	{
		public StochasticSeriesIkhStatesHover()
		{
			LineWidthPlus = LineWidthPlus_DefaultValue = 1;
			Marker = Marker_DefaultValue = new StochasticSeriesIkhStatesHoverMarker();
			Halo = Halo_DefaultValue = new StochasticSeriesIkhStatesHoverHalo();
		...
		/// </summary>
		public StochasticSeriesIkhStatesHoverMarker Marker { get; set; }
		private StochasticSeriesIkhStatesHoverMarker Marker_DefaultValue { get; set; }
		...
		/// </summary>
		public StochasticSeriesIkhStatesHoverHalo Halo { get; set; }
		private StochasticSeriesIkhStatesHoverHalo Halo_DefaultValue { get; set; }
