...
{
	public partial class StochasticSeriesIkhStatesSelectMarker  : BaseObject
	{
		public StochasticSeriesIkhStatesSelectMarker()
		{
			LineWidth = LineWidth_DefaultValue = 0;
			LineColor = LineColor_DefaultValue = "#ffffff";
			Radius = Radius_DefaultValue = 4;
			States = States_DefaultValue = new StochasticSeriesIkhStatesSelectMarkerStates();
		...
		/// </summary>
		public StochasticSeriesIkhStatesSelectMarkerStates States { get; set; }
		private StochasticSeriesIkhStatesSelectMarkerStates States_DefaultValue { get; set; }
