...
{
	public partial class StochasticSeriesIkhTooltip  : BaseObject
	{
		public StochasticSeriesIkhTooltip()
		{
			ValueDecimals = ValueDecimals_DefaultValue = null;
			DateTimeLabelFormats = DateTimeLabelFormats_DefaultValue = new StochasticSeriesIkhTooltipDateTimeLabelFormats();
		...
		/// </summary>
		public StochasticSeriesIkhTooltipDateTimeLabelFormats DateTimeLabelFormats { get; set; }
		private StochasticSeriesIkhTooltipDateTimeLabelFormats DateTimeLabelFormats_DefaultValue { get; set; }
		...
		internal override Hashtable ToHashtable()
		{
			...
			if (PointFormatter != PointFormatter_DefaultValue) { h.Add("pointFormatter",PointFormatter); Highstock.AddFunction("StochasticSeriesIkhTooltipPointFormatter.pointFormatter", PointFormatter); }  
