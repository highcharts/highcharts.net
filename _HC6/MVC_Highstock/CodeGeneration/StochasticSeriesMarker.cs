...
{
	public partial class StochasticSeriesMarker  : BaseObject
	{
		public StochasticSeriesMarker()
		{
			...
			States = States_DefaultValue = new StochasticSeriesMarkerStates();
		...
		/// </summary>
		public StochasticSeriesMarkerStates States { get; set; }
		private StochasticSeriesMarkerStates States_DefaultValue { get; set; }
