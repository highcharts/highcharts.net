...
{
	public partial class StochasticSeriesTooltip  : BaseObject
	{
		public StochasticSeriesTooltip()
		{
			PointFormat = PointFormat_DefaultValue = "<span style='color:{point.color}'>\u25CF</span> <b> {series.name}</b><br/>%K: {point.y}<br/>%D: {point.smoothed}<br/>";
			ValueDecimals = ValueDecimals_DefaultValue = null;
			DateTimeLabelFormats = DateTimeLabelFormats_DefaultValue = new StochasticSeriesTooltipDateTimeLabelFormats();
		...
		/// </summary>
		public StochasticSeriesTooltipDateTimeLabelFormats DateTimeLabelFormats { get; set; }
		private StochasticSeriesTooltipDateTimeLabelFormats DateTimeLabelFormats_DefaultValue { get; set; }
		...
		internal override Hashtable ToHashtable()
		{
			...
			if (PointFormatter != PointFormatter_DefaultValue) { h.Add("pointFormatter",PointFormatter); Highstock.AddFunction("StochasticSeriesTooltipPointFormatter.pointFormatter", PointFormatter); }  
