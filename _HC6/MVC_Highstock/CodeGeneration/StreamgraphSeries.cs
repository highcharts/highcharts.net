...
namespace Highsoft.Web.Mvc.Stocks
{
	public partial class StreamgraphSeries  : Series
	{
		public StreamgraphSeries()
		{
			...
			Ikh = Ikh_DefaultValue = new StreamgraphSeriesIkh();
			...
			Stacking = Stacking_DefaultValue = StreamgraphSeriesStacking.Stream;
			...
			Zones = Zones_DefaultValue = new StreamgraphSeriesZone();
		...
		/// <summary>
		/// <p>An array of data points for the series. For the <code>streamgraph</code> series type,points can be given in the following ways:</p><ol><li><p>An array of numerical values. In this case, the numerical valueswill be interpreted as <code>y</code> options. The <code>x</code> values will be automaticallycalculated, either starting at 0 and incremented by 1, or from <code>pointStart</code>and <code>pointInterval</code> given in the series options. If the axis hascategories, these will be used. Example:</p><pre><code class="lang-js">data: [0, 5, 3, 5]</code></pre></li><li><p>An array of arrays with 2 values. In this case, the values correspondto <code>x,y</code>. If the first value is a string, it is applied as the nameof the point, and the <code>x</code> value is inferred.</p><pre><code class="lang-js">data: [    [0, 9],    [1, 7],    [2, 6]]</code></pre></li><li><p>An array of objects with named values. The objects are pointconfiguration objects as seen below. If the total number of datapoints exceeds the series&#39; <a href="#series.area.turboThreshold">turboThreshold</a>,this option is not available.</p><pre><code class="lang-js">data: [{    x: 1,    y: 9,    name: &quot;Point2&quot;,    color: &quot;#00FF00&quot;}, {    x: 1,    y: 6,    name: &quot;Point1&quot;,    color: &quot;#FF00FF&quot;}]</code></pre></li></ol>
		/// </summary>
		...
		/// </summary>
		public StreamgraphSeriesIkh Ikh { get; set; }
		private StreamgraphSeriesIkh Ikh_DefaultValue { get; set; }
		...
		/// </summary>
		public StreamgraphSeriesZone Zones { get; set; }
		private StreamgraphSeriesZone Zones_DefaultValue { get; set; }
