...
{
	public partial class StreamgraphSeriesDataGrouping  : BaseObject
	{
		...
		/// </summary>
		public StreamgraphSeriesDataGroupingApproximation Approximation { get; set; }
		private StreamgraphSeriesDataGroupingApproximation Approximation_DefaultValue { get; set; }
		...
		/// </summary>
		public StreamgraphSeriesDataGroupingUnits Units { get; set; }
		private StreamgraphSeriesDataGroupingUnits Units_DefaultValue { get; set; }
