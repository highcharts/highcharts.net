...
{
	public partial class StreamgraphSeriesDataMarker  : BaseObject
	{
		public StreamgraphSeriesDataMarker()
		{
			...
			States = States_DefaultValue = new StreamgraphSeriesDataMarkerStates();
		...
		/// </summary>
		public StreamgraphSeriesDataMarkerStates States { get; set; }
		private StreamgraphSeriesDataMarkerStates States_DefaultValue { get; set; }
