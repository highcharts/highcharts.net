...
{
	public partial class StreamgraphSeriesIkh  : BaseObject
	{
		public StreamgraphSeriesIkh()
		{
			Name = Name_DefaultValue = "SMA (14)";
			Tooltip = Tooltip_DefaultValue = new StreamgraphSeriesIkhTooltip();
			LinkedTo = LinkedTo_DefaultValue = null;
			Params = Params_DefaultValue = new StreamgraphSeriesIkhParams();
			Linecap = Linecap_DefaultValue = StreamgraphSeriesIkhLinecap.Round;
			BoostThreshold = BoostThreshold_DefaultValue = 5000;
			GapSize = GapSize_DefaultValue = 0;
			GapUnit = GapUnit_DefaultValue = StreamgraphSeriesIkhGapUnit.Relative;
			Label = Label_DefaultValue = new StreamgraphSeriesIkhLabel();
			DataGrouping = DataGrouping_DefaultValue = new StreamgraphSeriesIkhDataGrouping();
			LineWidth = LineWidth_DefaultValue = 2;
			AllowPointSelect = AllowPointSelect_DefaultValue = false;
			ShowCheckbox = ShowCheckbox_DefaultValue = false;
			Animation = Animation_DefaultValue = new Animation() { Enabled = true };
			Events = Events_DefaultValue = new StreamgraphSeriesIkhEvents();
			Marker = Marker_DefaultValue = new StreamgraphSeriesIkhMarker();
			Point = Point_DefaultValue = new StreamgraphSeriesIkhPoint();
			DataLabels = DataLabels_DefaultValue = new StreamgraphSeriesIkhDataLabels();
			CropThreshold = CropThreshold_DefaultValue = 300;
			SoftThreshold = SoftThreshold_DefaultValue = true;
			States = States_DefaultValue = new StreamgraphSeriesIkhStates();
			StickyTracking = StickyTracking_DefaultValue = null;
			TurboThreshold = TurboThreshold_DefaultValue = 1000;
			FindNearestPointBy = FindNearestPointBy_DefaultValue = StreamgraphSeriesIkhFindNearestPointBy.X;
			AnimationLimit = AnimationLimit_DefaultValue = null;
			ClassName = ClassName_DefaultValue = null;
			Color = Color_DefaultValue = null;
			ColorIndex = ColorIndex_DefaultValue = null;
			ConnectNulls = ConnectNulls_DefaultValue = false;
			Cursor = Cursor_DefaultValue = StreamgraphSeriesIkhCursor.Null;
			DashStyle = DashStyle_DefaultValue = StreamgraphSeriesIkhDashStyle.Solid;
			...
			Step = Step_DefaultValue = StreamgraphSeriesIkhStep.Null;
			Threshold = Threshold_DefaultValue = 0;
			Visible = Visible_DefaultValue = true;
			ZoneAxis = ZoneAxis_DefaultValue = "y";
			Zones = Zones_DefaultValue = new List<StreamgraphSeriesIkhZone>();
			...
			PointIntervalUnit = PointIntervalUnit_DefaultValue = StreamgraphSeriesIkhPointIntervalUnit.Null;
			PointPlacement = PointPlacement_DefaultValue = new PointPlacement();
			PointStart = PointStart_DefaultValue = 0;
			Stacking = Stacking_DefaultValue = StreamgraphSeriesIkhStacking.Null;
			Compare = Compare_DefaultValue = "undefined";
			CompareBase = CompareBase_DefaultValue = StreamgraphSeriesIkhCompareBase.Min;
		...
		/// </summary>
		public StreamgraphSeriesIkhTooltip Tooltip { get; set; }
		private StreamgraphSeriesIkhTooltip Tooltip_DefaultValue { get; set; }
		...
		/// 
		/// </summary>
		public StreamgraphSeriesIkhParams Params { get; set; }
		private StreamgraphSeriesIkhParams Params_DefaultValue { get; set; }
		...
		/// </summary>
		public StreamgraphSeriesIkhLinecap Linecap { get; set; }
		private StreamgraphSeriesIkhLinecap Linecap_DefaultValue { get; set; }
		...
		/// </summary>
		public StreamgraphSeriesIkhGapUnit GapUnit { get; set; }
		private StreamgraphSeriesIkhGapUnit GapUnit_DefaultValue { get; set; }
		...
		/// </summary>
		public StreamgraphSeriesIkhLabel Label { get; set; }
		private StreamgraphSeriesIkhLabel Label_DefaultValue { get; set; }
		...
		/// </summary>
		public StreamgraphSeriesIkhDataGrouping DataGrouping { get; set; }
		private StreamgraphSeriesIkhDataGrouping DataGrouping_DefaultValue { get; set; }
		...
		/// </summary>
		public StreamgraphSeriesIkhEvents Events { get; set; }
		private StreamgraphSeriesIkhEvents Events_DefaultValue { get; set; }
		...
		/// </summary>
		public StreamgraphSeriesIkhMarker Marker { get; set; }
		private StreamgraphSeriesIkhMarker Marker_DefaultValue { get; set; }
		 

		/// <summary>
		/// <p>Properties for each single point.</p>
		/// </summary>
		public StreamgraphSeriesIkhPoint Point { get; set; }
		private StreamgraphSeriesIkhPoint Point_DefaultValue { get; set; }
		...
		/// </summary>
		public StreamgraphSeriesIkhDataLabels DataLabels { get; set; }
		private StreamgraphSeriesIkhDataLabels DataLabels_DefaultValue { get; set; }
		...
		/// </summary>
		public StreamgraphSeriesIkhStates States { get; set; }
		private StreamgraphSeriesIkhStates States_DefaultValue { get; set; }
		...
		/// </summary>
		public StreamgraphSeriesIkhFindNearestPointBy FindNearestPointBy { get; set; }
		private StreamgraphSeriesIkhFindNearestPointBy FindNearestPointBy_DefaultValue { get; set; }
		...
		/// </summary>
		public StreamgraphSeriesIkhCursor Cursor { get; set; }
		private StreamgraphSeriesIkhCursor Cursor_DefaultValue { get; set; }
		...
		/// </summary>
		public StreamgraphSeriesIkhDashStyle DashStyle { get; set; }
		private StreamgraphSeriesIkhDashStyle DashStyle_DefaultValue { get; set; }
		...
		/// </summary>
		public StreamgraphSeriesIkhStep Step { get; set; }
		private StreamgraphSeriesIkhStep Step_DefaultValue { get; set; }
		...
		/// </summary>
		public List<StreamgraphSeriesIkhZone> Zones { get; set; }
		private List<StreamgraphSeriesIkhZone> Zones_DefaultValue { get; set; }
		...
		/// </summary>
		public StreamgraphSeriesIkhPointIntervalUnit PointIntervalUnit { get; set; }
		private StreamgraphSeriesIkhPointIntervalUnit PointIntervalUnit_DefaultValue { get; set; }
		...
		/// </summary>
		public StreamgraphSeriesIkhStacking Stacking { get; set; }
		private StreamgraphSeriesIkhStacking Stacking_DefaultValue { get; set; }
		...
		/// </summary>
		public StreamgraphSeriesIkhCompareBase CompareBase { get; set; }
		private StreamgraphSeriesIkhCompareBase CompareBase_DefaultValue { get; set; }
		...
		internal override Hashtable ToHashtable()
		{
			...
			if (PointDescriptionFormatter != PointDescriptionFormatter_DefaultValue) { h.Add("pointDescriptionFormatter",PointDescriptionFormatter); Highstock.AddFunction("StreamgraphSeriesIkhPointDescriptionFormatter.pointDescriptionFormatter", PointDescriptionFormatter); }  
