...
namespace Highsoft.Web.Mvc.Stocks
{
	public partial class StreamgraphSeriesIkh  : BaseObject
	{
		public StreamgraphSeriesIkh()
		{
			...
			Zones = Zones_DefaultValue = new StreamgraphSeriesIkhZone();
		...
		/// </summary>
		public StreamgraphSeriesIkhZone Zones { get; set; }
		private StreamgraphSeriesIkhZone Zones_DefaultValue { get; set; }
