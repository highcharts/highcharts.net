...
{
	public partial class StreamgraphSeriesIkhDataGrouping  : BaseObject
	{
		public StreamgraphSeriesIkhDataGrouping()
		{
			Approximation = Approximation_DefaultValue = StreamgraphSeriesIkhDataGroupingApproximation.Average;
		...
		/// </summary>
		public StreamgraphSeriesIkhDataGroupingApproximation Approximation { get; set; }
		private StreamgraphSeriesIkhDataGroupingApproximation Approximation_DefaultValue { get; set; }
