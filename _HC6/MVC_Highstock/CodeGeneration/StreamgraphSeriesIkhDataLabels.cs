...
{
	public partial class StreamgraphSeriesIkhDataLabels  : BaseObject
	{
		public StreamgraphSeriesIkhDataLabels()
		{
			Align = Align_DefaultValue = StreamgraphSeriesIkhDataLabelsAlign.Center;
			Formatter = Formatter_DefaultValue = "";
			Style = Style_DefaultValue = new StreamgraphSeriesIkhDataLabelsStyle();
			VerticalAlign = VerticalAlign_DefaultValue = StreamgraphSeriesIkhDataLabelsVerticalAlign.Bottom;
			X = X_DefaultValue = 0;
			Y = Y_DefaultValue = -6;
			...
			Overflow = Overflow_DefaultValue = StreamgraphSeriesIkhDataLabelsOverflow.Justify;
		...
		/// </summary>
		public StreamgraphSeriesIkhDataLabelsAlign Align { get; set; }
		private StreamgraphSeriesIkhDataLabelsAlign Align_DefaultValue { get; set; }
		...
		/// </summary>
		public StreamgraphSeriesIkhDataLabelsStyle Style { get; set; }
		private StreamgraphSeriesIkhDataLabelsStyle Style_DefaultValue { get; set; }
		...
		/// </summary>
		public StreamgraphSeriesIkhDataLabelsVerticalAlign VerticalAlign { get; set; }
		private StreamgraphSeriesIkhDataLabelsVerticalAlign VerticalAlign_DefaultValue { get; set; }
		...
		/// </summary>
		public StreamgraphSeriesIkhDataLabelsOverflow Overflow { get; set; }
		private StreamgraphSeriesIkhDataLabelsOverflow Overflow_DefaultValue { get; set; }
		...
		internal override Hashtable ToHashtable()
		{
			...
			if (Formatter != Formatter_DefaultValue) { h.Add("formatter",Formatter); Highstock.AddFunction("StreamgraphSeriesIkhDataLabelsFormatter.formatter", Formatter); }  
