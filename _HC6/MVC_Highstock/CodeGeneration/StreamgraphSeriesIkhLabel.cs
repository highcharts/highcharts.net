...
{
	public partial class StreamgraphSeriesIkhLabel  : BaseObject
	{
		public StreamgraphSeriesIkhLabel()
		{
			...
			Style = Style_DefaultValue = new StreamgraphSeriesIkhLabelStyle();
		...
		/// </summary>
		public StreamgraphSeriesIkhLabelStyle Style { get; set; }
		private StreamgraphSeriesIkhLabelStyle Style_DefaultValue { get; set; }
