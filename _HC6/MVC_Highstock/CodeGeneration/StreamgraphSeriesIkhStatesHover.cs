...
{
	public partial class StreamgraphSeriesIkhStatesHover  : BaseObject
	{
		public StreamgraphSeriesIkhStatesHover()
		{
			LineWidthPlus = LineWidthPlus_DefaultValue = 1;
			Marker = Marker_DefaultValue = new StreamgraphSeriesIkhStatesHoverMarker();
			Halo = Halo_DefaultValue = new StreamgraphSeriesIkhStatesHoverHalo();
		...
		/// </summary>
		public StreamgraphSeriesIkhStatesHoverMarker Marker { get; set; }
		private StreamgraphSeriesIkhStatesHoverMarker Marker_DefaultValue { get; set; }
		...
		/// </summary>
		public StreamgraphSeriesIkhStatesHoverHalo Halo { get; set; }
		private StreamgraphSeriesIkhStatesHoverHalo Halo_DefaultValue { get; set; }
