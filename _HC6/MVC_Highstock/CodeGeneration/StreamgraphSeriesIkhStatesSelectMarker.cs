...
{
	public partial class StreamgraphSeriesIkhStatesSelectMarker  : BaseObject
	{
		public StreamgraphSeriesIkhStatesSelectMarker()
		{
			LineWidth = LineWidth_DefaultValue = 0;
			LineColor = LineColor_DefaultValue = "#ffffff";
			Radius = Radius_DefaultValue = 4;
			States = States_DefaultValue = new StreamgraphSeriesIkhStatesSelectMarkerStates();
		...
		/// </summary>
		public StreamgraphSeriesIkhStatesSelectMarkerStates States { get; set; }
		private StreamgraphSeriesIkhStatesSelectMarkerStates States_DefaultValue { get; set; }
