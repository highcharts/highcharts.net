...
{
	public partial class StreamgraphSeriesIkhTooltip  : BaseObject
	{
		public StreamgraphSeriesIkhTooltip()
		{
			ValueDecimals = ValueDecimals_DefaultValue = null;
			DateTimeLabelFormats = DateTimeLabelFormats_DefaultValue = new StreamgraphSeriesIkhTooltipDateTimeLabelFormats();
		...
		/// </summary>
		public StreamgraphSeriesIkhTooltipDateTimeLabelFormats DateTimeLabelFormats { get; set; }
		private StreamgraphSeriesIkhTooltipDateTimeLabelFormats DateTimeLabelFormats_DefaultValue { get; set; }
		...
		internal override Hashtable ToHashtable()
		{
			...
			if (PointFormatter != PointFormatter_DefaultValue) { h.Add("pointFormatter",PointFormatter); Highstock.AddFunction("StreamgraphSeriesIkhTooltipPointFormatter.pointFormatter", PointFormatter); }  
