...
namespace Highsoft.Web.Mvc.Stocks
{
	public partial class StreamgraphSeriesTooltip  : BaseObject
	{
		...
		{
			DateTimeLabelFormats = DateTimeLabelFormats_DefaultValue = new StreamgraphSeriesTooltipDateTimeLabelFormats();
		...
		/// </summary>
		public StreamgraphSeriesTooltipDateTimeLabelFormats DateTimeLabelFormats { get; set; }
		private StreamgraphSeriesTooltipDateTimeLabelFormats DateTimeLabelFormats_DefaultValue { get; set; }
