...
{
	public partial class SunburstSeriesIkh  : BaseObject
	{
		public SunburstSeriesIkh()
		{
			Name = Name_DefaultValue = "SMA (14)";
			Tooltip = Tooltip_DefaultValue = new SunburstSeriesIkhTooltip();
			LinkedTo = LinkedTo_DefaultValue = null;
			Params = Params_DefaultValue = new SunburstSeriesIkhParams();
			Linecap = Linecap_DefaultValue = SunburstSeriesIkhLinecap.Round;
			BoostThreshold = BoostThreshold_DefaultValue = 5000;
			GapSize = GapSize_DefaultValue = 0;
			GapUnit = GapUnit_DefaultValue = SunburstSeriesIkhGapUnit.Relative;
			Label = Label_DefaultValue = new SunburstSeriesIkhLabel();
			DataGrouping = DataGrouping_DefaultValue = new SunburstSeriesIkhDataGrouping();
			LineWidth = LineWidth_DefaultValue = 2;
			AllowPointSelect = AllowPointSelect_DefaultValue = false;
			ShowCheckbox = ShowCheckbox_DefaultValue = false;
			Animation = Animation_DefaultValue = new Animation() { Enabled = true };
			Events = Events_DefaultValue = new SunburstSeriesIkhEvents();
			Marker = Marker_DefaultValue = new SunburstSeriesIkhMarker();
			Point = Point_DefaultValue = new SunburstSeriesIkhPoint();
			DataLabels = DataLabels_DefaultValue = new SunburstSeriesIkhDataLabels();
			CropThreshold = CropThreshold_DefaultValue = 300;
			SoftThreshold = SoftThreshold_DefaultValue = true;
			States = States_DefaultValue = new SunburstSeriesIkhStates();
			StickyTracking = StickyTracking_DefaultValue = null;
			TurboThreshold = TurboThreshold_DefaultValue = 1000;
			FindNearestPointBy = FindNearestPointBy_DefaultValue = SunburstSeriesIkhFindNearestPointBy.X;
			AnimationLimit = AnimationLimit_DefaultValue = null;
			ClassName = ClassName_DefaultValue = null;
			Color = Color_DefaultValue = null;
			ColorIndex = ColorIndex_DefaultValue = null;
			ConnectNulls = ConnectNulls_DefaultValue = false;
			Cursor = Cursor_DefaultValue = SunburstSeriesIkhCursor.Null;
			DashStyle = DashStyle_DefaultValue = SunburstSeriesIkhDashStyle.Solid;
			...
			Step = Step_DefaultValue = SunburstSeriesIkhStep.Null;
			Threshold = Threshold_DefaultValue = 0;
			Visible = Visible_DefaultValue = true;
			ZoneAxis = ZoneAxis_DefaultValue = "y";
			Zones = Zones_DefaultValue = new List<SunburstSeriesIkhZone>();
			...
			PointIntervalUnit = PointIntervalUnit_DefaultValue = SunburstSeriesIkhPointIntervalUnit.Null;
			PointPlacement = PointPlacement_DefaultValue = new PointPlacement();
			PointStart = PointStart_DefaultValue = 0;
			Stacking = Stacking_DefaultValue = SunburstSeriesIkhStacking.Null;
			Compare = Compare_DefaultValue = "undefined";
			CompareBase = CompareBase_DefaultValue = SunburstSeriesIkhCompareBase.Min;
		...
		/// </summary>
		public SunburstSeriesIkhTooltip Tooltip { get; set; }
		private SunburstSeriesIkhTooltip Tooltip_DefaultValue { get; set; }
		...
		/// 
		/// </summary>
		public SunburstSeriesIkhParams Params { get; set; }
		private SunburstSeriesIkhParams Params_DefaultValue { get; set; }
		...
		/// </summary>
		public SunburstSeriesIkhLinecap Linecap { get; set; }
		private SunburstSeriesIkhLinecap Linecap_DefaultValue { get; set; }
		...
		/// </summary>
		public SunburstSeriesIkhGapUnit GapUnit { get; set; }
		private SunburstSeriesIkhGapUnit GapUnit_DefaultValue { get; set; }
		...
		/// </summary>
		public SunburstSeriesIkhLabel Label { get; set; }
		private SunburstSeriesIkhLabel Label_DefaultValue { get; set; }
		...
		/// </summary>
		public SunburstSeriesIkhDataGrouping DataGrouping { get; set; }
		private SunburstSeriesIkhDataGrouping DataGrouping_DefaultValue { get; set; }
		...
		/// </summary>
		public SunburstSeriesIkhEvents Events { get; set; }
		private SunburstSeriesIkhEvents Events_DefaultValue { get; set; }
		...
		/// </summary>
		public SunburstSeriesIkhMarker Marker { get; set; }
		private SunburstSeriesIkhMarker Marker_DefaultValue { get; set; }
		 

		/// <summary>
		/// <p>Properties for each single point.</p>
		/// </summary>
		public SunburstSeriesIkhPoint Point { get; set; }
		private SunburstSeriesIkhPoint Point_DefaultValue { get; set; }
		...
		/// </summary>
		public SunburstSeriesIkhDataLabels DataLabels { get; set; }
		private SunburstSeriesIkhDataLabels DataLabels_DefaultValue { get; set; }
		...
		/// </summary>
		public SunburstSeriesIkhStates States { get; set; }
		private SunburstSeriesIkhStates States_DefaultValue { get; set; }
		...
		/// </summary>
		public SunburstSeriesIkhFindNearestPointBy FindNearestPointBy { get; set; }
		private SunburstSeriesIkhFindNearestPointBy FindNearestPointBy_DefaultValue { get; set; }
		...
		/// </summary>
		public SunburstSeriesIkhCursor Cursor { get; set; }
		private SunburstSeriesIkhCursor Cursor_DefaultValue { get; set; }
		...
		/// </summary>
		public SunburstSeriesIkhDashStyle DashStyle { get; set; }
		private SunburstSeriesIkhDashStyle DashStyle_DefaultValue { get; set; }
		...
		/// </summary>
		public SunburstSeriesIkhStep Step { get; set; }
		private SunburstSeriesIkhStep Step_DefaultValue { get; set; }
		...
		/// </summary>
		public List<SunburstSeriesIkhZone> Zones { get; set; }
		private List<SunburstSeriesIkhZone> Zones_DefaultValue { get; set; }
		...
		/// </summary>
		public SunburstSeriesIkhPointIntervalUnit PointIntervalUnit { get; set; }
		private SunburstSeriesIkhPointIntervalUnit PointIntervalUnit_DefaultValue { get; set; }
		...
		/// </summary>
		public SunburstSeriesIkhStacking Stacking { get; set; }
		private SunburstSeriesIkhStacking Stacking_DefaultValue { get; set; }
		...
		/// </summary>
		public SunburstSeriesIkhCompareBase CompareBase { get; set; }
		private SunburstSeriesIkhCompareBase CompareBase_DefaultValue { get; set; }
		...
		internal override Hashtable ToHashtable()
		{
			...
			if (PointDescriptionFormatter != PointDescriptionFormatter_DefaultValue) { h.Add("pointDescriptionFormatter",PointDescriptionFormatter); Highstock.AddFunction("SunburstSeriesIkhPointDescriptionFormatter.pointDescriptionFormatter", PointDescriptionFormatter); }  
