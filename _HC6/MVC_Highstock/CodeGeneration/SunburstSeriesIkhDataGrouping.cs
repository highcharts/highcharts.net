...
{
	public partial class SunburstSeriesIkhDataGrouping  : BaseObject
	{
		...
		/// </summary>
		public SunburstSeriesIkhDataGroupingApproximation Approximation { get; set; }
		private SunburstSeriesIkhDataGroupingApproximation Approximation_DefaultValue { get; set; }
