...
{
	public partial class SunburstSeriesIkhDataLabels  : BaseObject
	{
		public SunburstSeriesIkhDataLabels()
		{
			Align = Align_DefaultValue = SunburstSeriesIkhDataLabelsAlign.Center;
			Formatter = Formatter_DefaultValue = "";
			Style = Style_DefaultValue = new SunburstSeriesIkhDataLabelsStyle();
			VerticalAlign = VerticalAlign_DefaultValue = SunburstSeriesIkhDataLabelsVerticalAlign.Bottom;
			X = X_DefaultValue = 0;
			Y = Y_DefaultValue = -6;
			...
			Overflow = Overflow_DefaultValue = SunburstSeriesIkhDataLabelsOverflow.Justify;
		...
		/// </summary>
		public SunburstSeriesIkhDataLabelsAlign Align { get; set; }
		private SunburstSeriesIkhDataLabelsAlign Align_DefaultValue { get; set; }
		...
		/// </summary>
		public SunburstSeriesIkhDataLabelsStyle Style { get; set; }
		private SunburstSeriesIkhDataLabelsStyle Style_DefaultValue { get; set; }
		...
		/// </summary>
		public SunburstSeriesIkhDataLabelsVerticalAlign VerticalAlign { get; set; }
		private SunburstSeriesIkhDataLabelsVerticalAlign VerticalAlign_DefaultValue { get; set; }
		...
		/// </summary>
		public SunburstSeriesIkhDataLabelsOverflow Overflow { get; set; }
		private SunburstSeriesIkhDataLabelsOverflow Overflow_DefaultValue { get; set; }
		...
		internal override Hashtable ToHashtable()
		{
			...
			if (Formatter != Formatter_DefaultValue) { h.Add("formatter",Formatter); Highstock.AddFunction("SunburstSeriesIkhDataLabelsFormatter.formatter", Formatter); }  
