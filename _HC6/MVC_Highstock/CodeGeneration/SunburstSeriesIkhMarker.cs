...
{
	public partial class SunburstSeriesIkhMarker  : BaseObject
	{
		public SunburstSeriesIkhMarker()
		{
			LineWidth = LineWidth_DefaultValue = 0;
			LineColor = LineColor_DefaultValue = "#ffffff";
			Radius = Radius_DefaultValue = 4;
			States = States_DefaultValue = new SunburstSeriesIkhMarkerStates();
		...
		/// </summary>
		public SunburstSeriesIkhMarkerStates States { get; set; }
		private SunburstSeriesIkhMarkerStates States_DefaultValue { get; set; }
