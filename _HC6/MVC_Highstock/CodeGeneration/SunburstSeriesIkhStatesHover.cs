...
{
	public partial class SunburstSeriesIkhStatesHover  : BaseObject
	{
		public SunburstSeriesIkhStatesHover()
		{
			LineWidthPlus = LineWidthPlus_DefaultValue = 1;
			Marker = Marker_DefaultValue = new SunburstSeriesIkhStatesHoverMarker();
			Halo = Halo_DefaultValue = new SunburstSeriesIkhStatesHoverHalo();
		...
		/// </summary>
		public SunburstSeriesIkhStatesHoverMarker Marker { get; set; }
		private SunburstSeriesIkhStatesHoverMarker Marker_DefaultValue { get; set; }
		...
		/// </summary>
		public SunburstSeriesIkhStatesHoverHalo Halo { get; set; }
		private SunburstSeriesIkhStatesHoverHalo Halo_DefaultValue { get; set; }
