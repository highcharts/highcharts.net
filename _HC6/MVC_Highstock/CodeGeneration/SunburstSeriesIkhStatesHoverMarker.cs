...
{
	public partial class SunburstSeriesIkhStatesHoverMarker  : BaseObject
	{
		public SunburstSeriesIkhStatesHoverMarker()
		{
			LineWidth = LineWidth_DefaultValue = 0;
			LineColor = LineColor_DefaultValue = "#ffffff";
			Radius = Radius_DefaultValue = 4;
			States = States_DefaultValue = new SunburstSeriesIkhStatesHoverMarkerStates();
		...
		/// </summary>
		public SunburstSeriesIkhStatesHoverMarkerStates States { get; set; }
		private SunburstSeriesIkhStatesHoverMarkerStates States_DefaultValue { get; set; }
