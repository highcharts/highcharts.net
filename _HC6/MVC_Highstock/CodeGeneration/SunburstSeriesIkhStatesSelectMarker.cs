...
{
	public partial class SunburstSeriesIkhStatesSelectMarker  : BaseObject
	{
		public SunburstSeriesIkhStatesSelectMarker()
		{
			LineWidth = LineWidth_DefaultValue = 0;
			LineColor = LineColor_DefaultValue = "#ffffff";
			Radius = Radius_DefaultValue = 4;
			States = States_DefaultValue = new SunburstSeriesIkhStatesSelectMarkerStates();
		...
		/// </summary>
		public SunburstSeriesIkhStatesSelectMarkerStates States { get; set; }
		private SunburstSeriesIkhStatesSelectMarkerStates States_DefaultValue { get; set; }
