...
{
	public partial class SunburstSeriesIkhTooltip  : BaseObject
	{
		public SunburstSeriesIkhTooltip()
		{
			ValueDecimals = ValueDecimals_DefaultValue = null;
			DateTimeLabelFormats = DateTimeLabelFormats_DefaultValue = new SunburstSeriesIkhTooltipDateTimeLabelFormats();
		...
		/// </summary>
		public SunburstSeriesIkhTooltipDateTimeLabelFormats DateTimeLabelFormats { get; set; }
		private SunburstSeriesIkhTooltipDateTimeLabelFormats DateTimeLabelFormats_DefaultValue { get; set; }
		...
		internal override Hashtable ToHashtable()
		{
			...
			if (PointFormatter != PointFormatter_DefaultValue) { h.Add("pointFormatter",PointFormatter); Highstock.AddFunction("SunburstSeriesIkhTooltipPointFormatter.pointFormatter", PointFormatter); }  
