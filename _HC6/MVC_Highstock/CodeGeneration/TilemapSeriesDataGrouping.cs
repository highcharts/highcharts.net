...
{
	public partial class TilemapSeriesDataGrouping  : BaseObject
	{
		public TilemapSeriesDataGrouping()
		{
			Approximation = Approximation_DefaultValue = TilemapSeriesDataGroupingApproximation.Average;
		...
		/// </summary>
		public TilemapSeriesDataGroupingApproximation Approximation { get; set; }
		private TilemapSeriesDataGroupingApproximation Approximation_DefaultValue { get; set; }
