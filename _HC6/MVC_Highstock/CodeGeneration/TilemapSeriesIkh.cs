...
{
	public partial class TilemapSeriesIkh  : BaseObject
	{
		public TilemapSeriesIkh()
		{
			Name = Name_DefaultValue = "SMA (14)";
			Tooltip = Tooltip_DefaultValue = new TilemapSeriesIkhTooltip();
			LinkedTo = LinkedTo_DefaultValue = null;
			Params = Params_DefaultValue = new TilemapSeriesIkhParams();
			Linecap = Linecap_DefaultValue = TilemapSeriesIkhLinecap.Round;
			BoostThreshold = BoostThreshold_DefaultValue = 5000;
			GapSize = GapSize_DefaultValue = 0;
			GapUnit = GapUnit_DefaultValue = TilemapSeriesIkhGapUnit.Relative;
			Label = Label_DefaultValue = new TilemapSeriesIkhLabel();
			DataGrouping = DataGrouping_DefaultValue = new TilemapSeriesIkhDataGrouping();
			LineWidth = LineWidth_DefaultValue = 2;
			AllowPointSelect = AllowPointSelect_DefaultValue = false;
			ShowCheckbox = ShowCheckbox_DefaultValue = false;
			Animation = Animation_DefaultValue = new Animation() { Enabled = true };
			Events = Events_DefaultValue = new TilemapSeriesIkhEvents();
			Marker = Marker_DefaultValue = new TilemapSeriesIkhMarker();
			Point = Point_DefaultValue = new TilemapSeriesIkhPoint();
			DataLabels = DataLabels_DefaultValue = new TilemapSeriesIkhDataLabels();
			CropThreshold = CropThreshold_DefaultValue = 300;
			SoftThreshold = SoftThreshold_DefaultValue = true;
			States = States_DefaultValue = new TilemapSeriesIkhStates();
			StickyTracking = StickyTracking_DefaultValue = null;
			TurboThreshold = TurboThreshold_DefaultValue = 1000;
			FindNearestPointBy = FindNearestPointBy_DefaultValue = TilemapSeriesIkhFindNearestPointBy.X;
			AnimationLimit = AnimationLimit_DefaultValue = null;
			ClassName = ClassName_DefaultValue = null;
			Color = Color_DefaultValue = null;
			ColorIndex = ColorIndex_DefaultValue = null;
			ConnectNulls = ConnectNulls_DefaultValue = false;
			Cursor = Cursor_DefaultValue = TilemapSeriesIkhCursor.Null;
			DashStyle = DashStyle_DefaultValue = TilemapSeriesIkhDashStyle.Solid;
			...
			Step = Step_DefaultValue = TilemapSeriesIkhStep.Null;
			Threshold = Threshold_DefaultValue = 0;
			Visible = Visible_DefaultValue = true;
			ZoneAxis = ZoneAxis_DefaultValue = "y";
			Zones = Zones_DefaultValue = new List<TilemapSeriesIkhZone>();
			...
			PointIntervalUnit = PointIntervalUnit_DefaultValue = TilemapSeriesIkhPointIntervalUnit.Null;
			PointPlacement = PointPlacement_DefaultValue = new PointPlacement();
			PointStart = PointStart_DefaultValue = 0;
			Stacking = Stacking_DefaultValue = TilemapSeriesIkhStacking.Null;
			Compare = Compare_DefaultValue = "undefined";
			CompareBase = CompareBase_DefaultValue = TilemapSeriesIkhCompareBase.Min;
		...
		/// </summary>
		public TilemapSeriesIkhTooltip Tooltip { get; set; }
		private TilemapSeriesIkhTooltip Tooltip_DefaultValue { get; set; }
		...
		/// 
		/// </summary>
		public TilemapSeriesIkhParams Params { get; set; }
		private TilemapSeriesIkhParams Params_DefaultValue { get; set; }
		...
		/// </summary>
		public TilemapSeriesIkhLinecap Linecap { get; set; }
		private TilemapSeriesIkhLinecap Linecap_DefaultValue { get; set; }
		...
		/// </summary>
		public TilemapSeriesIkhGapUnit GapUnit { get; set; }
		private TilemapSeriesIkhGapUnit GapUnit_DefaultValue { get; set; }
		...
		/// </summary>
		public TilemapSeriesIkhLabel Label { get; set; }
		private TilemapSeriesIkhLabel Label_DefaultValue { get; set; }
		...
		/// </summary>
		public TilemapSeriesIkhDataGrouping DataGrouping { get; set; }
		private TilemapSeriesIkhDataGrouping DataGrouping_DefaultValue { get; set; }
		...
		/// </summary>
		public TilemapSeriesIkhEvents Events { get; set; }
		private TilemapSeriesIkhEvents Events_DefaultValue { get; set; }
		...
		/// </summary>
		public TilemapSeriesIkhMarker Marker { get; set; }
		private TilemapSeriesIkhMarker Marker_DefaultValue { get; set; }
		 

		/// <summary>
		/// <p>Properties for each single point.</p>
		/// </summary>
		public TilemapSeriesIkhPoint Point { get; set; }
		private TilemapSeriesIkhPoint Point_DefaultValue { get; set; }
		...
		/// </summary>
		public TilemapSeriesIkhDataLabels DataLabels { get; set; }
		private TilemapSeriesIkhDataLabels DataLabels_DefaultValue { get; set; }
		...
		/// </summary>
		public TilemapSeriesIkhStates States { get; set; }
		private TilemapSeriesIkhStates States_DefaultValue { get; set; }
		...
		/// </summary>
		public TilemapSeriesIkhFindNearestPointBy FindNearestPointBy { get; set; }
		private TilemapSeriesIkhFindNearestPointBy FindNearestPointBy_DefaultValue { get; set; }
		...
		/// </summary>
		public TilemapSeriesIkhCursor Cursor { get; set; }
		private TilemapSeriesIkhCursor Cursor_DefaultValue { get; set; }
		...
		/// </summary>
		public TilemapSeriesIkhDashStyle DashStyle { get; set; }
		private TilemapSeriesIkhDashStyle DashStyle_DefaultValue { get; set; }
		...
		/// </summary>
		public TilemapSeriesIkhStep Step { get; set; }
		private TilemapSeriesIkhStep Step_DefaultValue { get; set; }
		...
		/// </summary>
		public List<TilemapSeriesIkhZone> Zones { get; set; }
		private List<TilemapSeriesIkhZone> Zones_DefaultValue { get; set; }
		...
		/// </summary>
		public TilemapSeriesIkhPointIntervalUnit PointIntervalUnit { get; set; }
		private TilemapSeriesIkhPointIntervalUnit PointIntervalUnit_DefaultValue { get; set; }
		...
		/// </summary>
		public TilemapSeriesIkhStacking Stacking { get; set; }
		private TilemapSeriesIkhStacking Stacking_DefaultValue { get; set; }
		...
		/// </summary>
		public TilemapSeriesIkhCompareBase CompareBase { get; set; }
		private TilemapSeriesIkhCompareBase CompareBase_DefaultValue { get; set; }
		...
		internal override Hashtable ToHashtable()
		{
			...
			if (PointDescriptionFormatter != PointDescriptionFormatter_DefaultValue) { h.Add("pointDescriptionFormatter",PointDescriptionFormatter); Highstock.AddFunction("TilemapSeriesIkhPointDescriptionFormatter.pointDescriptionFormatter", PointDescriptionFormatter); }  
