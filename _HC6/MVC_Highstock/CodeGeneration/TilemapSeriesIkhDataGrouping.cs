...
{
	public partial class TilemapSeriesIkhDataGrouping  : BaseObject
	{
		public TilemapSeriesIkhDataGrouping()
		{
			Approximation = Approximation_DefaultValue = TilemapSeriesIkhDataGroupingApproximation.Average;
		...
		/// </summary>
		public TilemapSeriesIkhDataGroupingApproximation Approximation { get; set; }
		private TilemapSeriesIkhDataGroupingApproximation Approximation_DefaultValue { get; set; }
