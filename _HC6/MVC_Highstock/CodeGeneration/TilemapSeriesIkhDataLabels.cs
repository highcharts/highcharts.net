...
{
	public partial class TilemapSeriesIkhDataLabels  : BaseObject
	{
		public TilemapSeriesIkhDataLabels()
		{
			Align = Align_DefaultValue = TilemapSeriesIkhDataLabelsAlign.Center;
			Formatter = Formatter_DefaultValue = "";
			Style = Style_DefaultValue = new TilemapSeriesIkhDataLabelsStyle();
			VerticalAlign = VerticalAlign_DefaultValue = TilemapSeriesIkhDataLabelsVerticalAlign.Bottom;
			X = X_DefaultValue = 0;
			Y = Y_DefaultValue = -6;
			...
			Overflow = Overflow_DefaultValue = TilemapSeriesIkhDataLabelsOverflow.Justify;
		...
		/// </summary>
		public TilemapSeriesIkhDataLabelsAlign Align { get; set; }
		private TilemapSeriesIkhDataLabelsAlign Align_DefaultValue { get; set; }
		...
		/// </summary>
		public TilemapSeriesIkhDataLabelsStyle Style { get; set; }
		private TilemapSeriesIkhDataLabelsStyle Style_DefaultValue { get; set; }
		...
		/// </summary>
		public TilemapSeriesIkhDataLabelsVerticalAlign VerticalAlign { get; set; }
		private TilemapSeriesIkhDataLabelsVerticalAlign VerticalAlign_DefaultValue { get; set; }
		...
		/// </summary>
		public TilemapSeriesIkhDataLabelsOverflow Overflow { get; set; }
		private TilemapSeriesIkhDataLabelsOverflow Overflow_DefaultValue { get; set; }
		...
		internal override Hashtable ToHashtable()
		{
			...
			if (Formatter != Formatter_DefaultValue) { h.Add("formatter",Formatter); Highstock.AddFunction("TilemapSeriesIkhDataLabelsFormatter.formatter", Formatter); }  
