...
{
	public partial class TilemapSeriesIkhMarker  : BaseObject
	{
		public TilemapSeriesIkhMarker()
		{
			LineWidth = LineWidth_DefaultValue = 0;
			LineColor = LineColor_DefaultValue = "#ffffff";
			Radius = Radius_DefaultValue = 4;
			States = States_DefaultValue = new TilemapSeriesIkhMarkerStates();
		...
		/// </summary>
		public TilemapSeriesIkhMarkerStates States { get; set; }
		private TilemapSeriesIkhMarkerStates States_DefaultValue { get; set; }
