...
{
	public partial class TilemapSeriesIkhPointEvents  : BaseObject
	{
		public TilemapSeriesIkhPointEvents()
		{
		...
		internal override Hashtable ToHashtable()
		{
			...
			if (Click != Click_DefaultValue) { h.Add("click",Click); Highstock.AddFunction("TilemapSeriesIkhPointEventsClick.click", Click); }  
			if (MouseOut != MouseOut_DefaultValue) { h.Add("mouseOut",MouseOut); Highstock.AddFunction("TilemapSeriesIkhPointEventsMouseOut.mouseOut", MouseOut); }  
			if (MouseOver != MouseOver_DefaultValue) { h.Add("mouseOver",MouseOver); Highstock.AddFunction("TilemapSeriesIkhPointEventsMouseOver.mouseOver", MouseOver); }  
			if (Remove != Remove_DefaultValue) { h.Add("remove",Remove); Highstock.AddFunction("TilemapSeriesIkhPointEventsRemove.remove", Remove); }  
			if (Select != Select_DefaultValue) { h.Add("select",Select); Highstock.AddFunction("TilemapSeriesIkhPointEventsSelect.select", Select); }  
			if (Unselect != Unselect_DefaultValue) { h.Add("unselect",Unselect); Highstock.AddFunction("TilemapSeriesIkhPointEventsUnselect.unselect", Unselect); }  
			if (Update != Update_DefaultValue) { h.Add("update",Update); Highstock.AddFunction("TilemapSeriesIkhPointEventsUpdate.update", Update); }  
