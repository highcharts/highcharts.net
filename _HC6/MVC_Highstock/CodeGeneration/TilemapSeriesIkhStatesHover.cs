...
{
	public partial class TilemapSeriesIkhStatesHover  : BaseObject
	{
		public TilemapSeriesIkhStatesHover()
		{
			LineWidthPlus = LineWidthPlus_DefaultValue = 1;
			Marker = Marker_DefaultValue = new TilemapSeriesIkhStatesHoverMarker();
			Halo = Halo_DefaultValue = new TilemapSeriesIkhStatesHoverHalo();
		...
		/// </summary>
		public TilemapSeriesIkhStatesHoverMarker Marker { get; set; }
		private TilemapSeriesIkhStatesHoverMarker Marker_DefaultValue { get; set; }
		...
		/// </summary>
		public TilemapSeriesIkhStatesHoverHalo Halo { get; set; }
		private TilemapSeriesIkhStatesHoverHalo Halo_DefaultValue { get; set; }
