...
{
	public partial class TilemapSeriesIkhTooltip  : BaseObject
	{
		public TilemapSeriesIkhTooltip()
		{
			ValueDecimals = ValueDecimals_DefaultValue = null;
			DateTimeLabelFormats = DateTimeLabelFormats_DefaultValue = new TilemapSeriesIkhTooltipDateTimeLabelFormats();
		...
		/// </summary>
		public TilemapSeriesIkhTooltipDateTimeLabelFormats DateTimeLabelFormats { get; set; }
		private TilemapSeriesIkhTooltipDateTimeLabelFormats DateTimeLabelFormats_DefaultValue { get; set; }
		...
		internal override Hashtable ToHashtable()
		{
			...
			if (PointFormatter != PointFormatter_DefaultValue) { h.Add("pointFormatter",PointFormatter); Highstock.AddFunction("TilemapSeriesIkhTooltipPointFormatter.pointFormatter", PointFormatter); }  
