...
namespace Highsoft.Web.Mvc.Stocks
{
	public partial class TilemapSeriesTooltip  : BaseObject
	{
		public TilemapSeriesTooltip()
		{
			...
			DateTimeLabelFormats = DateTimeLabelFormats_DefaultValue = new TilemapSeriesTooltipDateTimeLabelFormats();
		...
		/// </summary>
		public TilemapSeriesTooltipDateTimeLabelFormats DateTimeLabelFormats { get; set; }
		private TilemapSeriesTooltipDateTimeLabelFormats DateTimeLabelFormats_DefaultValue { get; set; }
		...
		internal override Hashtable ToHashtable()
		{
			...
			if (PointFormatter != PointFormatter_DefaultValue) { h.Add("pointFormatter",PointFormatter); Highstock.AddFunction("TilemapSeriesTooltipPointFormatter.pointFormatter", PointFormatter); }  
