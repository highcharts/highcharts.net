...
{
	public partial class TreemapSeriesDataGrouping  : BaseObject
	{
		...
		/// </summary>
		public TreemapSeriesDataGroupingApproximation Approximation { get; set; }
		private TreemapSeriesDataGroupingApproximation Approximation_DefaultValue { get; set; }
