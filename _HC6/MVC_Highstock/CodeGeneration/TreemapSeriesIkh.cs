...
{
	public partial class TreemapSeriesIkh  : BaseObject
	{
		public TreemapSeriesIkh()
		{
			Name = Name_DefaultValue = "SMA (14)";
			Tooltip = Tooltip_DefaultValue = new TreemapSeriesIkhTooltip();
			LinkedTo = LinkedTo_DefaultValue = null;
			Params = Params_DefaultValue = new TreemapSeriesIkhParams();
			Linecap = Linecap_DefaultValue = TreemapSeriesIkhLinecap.Round;
			BoostThreshold = BoostThreshold_DefaultValue = 5000;
			GapSize = GapSize_DefaultValue = 0;
			GapUnit = GapUnit_DefaultValue = TreemapSeriesIkhGapUnit.Relative;
			Label = Label_DefaultValue = new TreemapSeriesIkhLabel();
			DataGrouping = DataGrouping_DefaultValue = new TreemapSeriesIkhDataGrouping();
			LineWidth = LineWidth_DefaultValue = 2;
			AllowPointSelect = AllowPointSelect_DefaultValue = false;
			ShowCheckbox = ShowCheckbox_DefaultValue = false;
			Animation = Animation_DefaultValue = new Animation() { Enabled = true };
			Events = Events_DefaultValue = new TreemapSeriesIkhEvents();
			Marker = Marker_DefaultValue = new TreemapSeriesIkhMarker();
			Point = Point_DefaultValue = new TreemapSeriesIkhPoint();
			DataLabels = DataLabels_DefaultValue = new TreemapSeriesIkhDataLabels();
			CropThreshold = CropThreshold_DefaultValue = 300;
			SoftThreshold = SoftThreshold_DefaultValue = true;
			States = States_DefaultValue = new TreemapSeriesIkhStates();
			StickyTracking = StickyTracking_DefaultValue = null;
			TurboThreshold = TurboThreshold_DefaultValue = 1000;
			FindNearestPointBy = FindNearestPointBy_DefaultValue = TreemapSeriesIkhFindNearestPointBy.X;
			AnimationLimit = AnimationLimit_DefaultValue = null;
			ClassName = ClassName_DefaultValue = null;
			Color = Color_DefaultValue = null;
			ColorIndex = ColorIndex_DefaultValue = null;
			ConnectNulls = ConnectNulls_DefaultValue = false;
			Cursor = Cursor_DefaultValue = TreemapSeriesIkhCursor.Null;
			DashStyle = DashStyle_DefaultValue = TreemapSeriesIkhDashStyle.Solid;
			...
			Step = Step_DefaultValue = TreemapSeriesIkhStep.Null;
			Threshold = Threshold_DefaultValue = 0;
			Visible = Visible_DefaultValue = true;
			ZoneAxis = ZoneAxis_DefaultValue = "y";
			Zones = Zones_DefaultValue = new List<TreemapSeriesIkhZone>();
			...
			PointIntervalUnit = PointIntervalUnit_DefaultValue = TreemapSeriesIkhPointIntervalUnit.Null;
			PointPlacement = PointPlacement_DefaultValue = new PointPlacement();
			PointStart = PointStart_DefaultValue = 0;
			Stacking = Stacking_DefaultValue = TreemapSeriesIkhStacking.Null;
			Compare = Compare_DefaultValue = "undefined";
			CompareBase = CompareBase_DefaultValue = TreemapSeriesIkhCompareBase.Min;
		...
		/// </summary>
		public TreemapSeriesIkhTooltip Tooltip { get; set; }
		private TreemapSeriesIkhTooltip Tooltip_DefaultValue { get; set; }
		...
		/// 
		/// </summary>
		public TreemapSeriesIkhParams Params { get; set; }
		private TreemapSeriesIkhParams Params_DefaultValue { get; set; }
		...
		/// </summary>
		public TreemapSeriesIkhLinecap Linecap { get; set; }
		private TreemapSeriesIkhLinecap Linecap_DefaultValue { get; set; }
		...
		/// </summary>
		public TreemapSeriesIkhGapUnit GapUnit { get; set; }
		private TreemapSeriesIkhGapUnit GapUnit_DefaultValue { get; set; }
		...
		/// </summary>
		public TreemapSeriesIkhLabel Label { get; set; }
		private TreemapSeriesIkhLabel Label_DefaultValue { get; set; }
		...
		/// </summary>
		public TreemapSeriesIkhDataGrouping DataGrouping { get; set; }
		private TreemapSeriesIkhDataGrouping DataGrouping_DefaultValue { get; set; }
		...
		/// </summary>
		public TreemapSeriesIkhEvents Events { get; set; }
		private TreemapSeriesIkhEvents Events_DefaultValue { get; set; }
		...
		/// </summary>
		public TreemapSeriesIkhMarker Marker { get; set; }
		private TreemapSeriesIkhMarker Marker_DefaultValue { get; set; }
		 

		/// <summary>
		/// <p>Properties for each single point.</p>
		/// </summary>
		public TreemapSeriesIkhPoint Point { get; set; }
		private TreemapSeriesIkhPoint Point_DefaultValue { get; set; }
		...
		/// </summary>
		public TreemapSeriesIkhDataLabels DataLabels { get; set; }
		private TreemapSeriesIkhDataLabels DataLabels_DefaultValue { get; set; }
		...
		/// </summary>
		public TreemapSeriesIkhStates States { get; set; }
		private TreemapSeriesIkhStates States_DefaultValue { get; set; }
		...
		/// </summary>
		public TreemapSeriesIkhFindNearestPointBy FindNearestPointBy { get; set; }
		private TreemapSeriesIkhFindNearestPointBy FindNearestPointBy_DefaultValue { get; set; }
		...
		/// </summary>
		public TreemapSeriesIkhCursor Cursor { get; set; }
		private TreemapSeriesIkhCursor Cursor_DefaultValue { get; set; }
		...
		/// </summary>
		public TreemapSeriesIkhDashStyle DashStyle { get; set; }
		private TreemapSeriesIkhDashStyle DashStyle_DefaultValue { get; set; }
		...
		/// </summary>
		public TreemapSeriesIkhStep Step { get; set; }
		private TreemapSeriesIkhStep Step_DefaultValue { get; set; }
		...
		/// </summary>
		public List<TreemapSeriesIkhZone> Zones { get; set; }
		private List<TreemapSeriesIkhZone> Zones_DefaultValue { get; set; }
		...
		/// </summary>
		public TreemapSeriesIkhPointIntervalUnit PointIntervalUnit { get; set; }
		private TreemapSeriesIkhPointIntervalUnit PointIntervalUnit_DefaultValue { get; set; }
		...
		/// </summary>
		public TreemapSeriesIkhStacking Stacking { get; set; }
		private TreemapSeriesIkhStacking Stacking_DefaultValue { get; set; }
		...
		/// </summary>
		public TreemapSeriesIkhCompareBase CompareBase { get; set; }
		private TreemapSeriesIkhCompareBase CompareBase_DefaultValue { get; set; }
		...
		internal override Hashtable ToHashtable()
		{
			...
			if (PointDescriptionFormatter != PointDescriptionFormatter_DefaultValue) { h.Add("pointDescriptionFormatter",PointDescriptionFormatter); Highstock.AddFunction("TreemapSeriesIkhPointDescriptionFormatter.pointDescriptionFormatter", PointDescriptionFormatter); }  
