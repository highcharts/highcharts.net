...
{
	public partial class TreemapSeriesIkhDataGrouping  : BaseObject
	{
		public TreemapSeriesIkhDataGrouping()
		{
			Approximation = Approximation_DefaultValue = TreemapSeriesIkhDataGroupingApproximation.Average;
		...
		/// </summary>
		public TreemapSeriesIkhDataGroupingApproximation Approximation { get; set; }
		private TreemapSeriesIkhDataGroupingApproximation Approximation_DefaultValue { get; set; }
