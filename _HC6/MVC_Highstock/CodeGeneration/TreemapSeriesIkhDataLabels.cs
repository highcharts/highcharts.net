...
{
	public partial class TreemapSeriesIkhDataLabels  : BaseObject
	{
		public TreemapSeriesIkhDataLabels()
		{
			Align = Align_DefaultValue = TreemapSeriesIkhDataLabelsAlign.Center;
			Formatter = Formatter_DefaultValue = "";
			Style = Style_DefaultValue = new TreemapSeriesIkhDataLabelsStyle();
			VerticalAlign = VerticalAlign_DefaultValue = TreemapSeriesIkhDataLabelsVerticalAlign.Bottom;
			X = X_DefaultValue = 0;
			Y = Y_DefaultValue = -6;
			...
			Overflow = Overflow_DefaultValue = TreemapSeriesIkhDataLabelsOverflow.Justify;
		...
		/// </summary>
		public TreemapSeriesIkhDataLabelsAlign Align { get; set; }
		private TreemapSeriesIkhDataLabelsAlign Align_DefaultValue { get; set; }
		...
		/// </summary>
		public TreemapSeriesIkhDataLabelsStyle Style { get; set; }
		private TreemapSeriesIkhDataLabelsStyle Style_DefaultValue { get; set; }
		...
		/// </summary>
		public TreemapSeriesIkhDataLabelsVerticalAlign VerticalAlign { get; set; }
		private TreemapSeriesIkhDataLabelsVerticalAlign VerticalAlign_DefaultValue { get; set; }
		...
		/// </summary>
		public TreemapSeriesIkhDataLabelsOverflow Overflow { get; set; }
		private TreemapSeriesIkhDataLabelsOverflow Overflow_DefaultValue { get; set; }
		...
		internal override Hashtable ToHashtable()
		{
			...
			if (Formatter != Formatter_DefaultValue) { h.Add("formatter",Formatter); Highstock.AddFunction("TreemapSeriesIkhDataLabelsFormatter.formatter", Formatter); }  
