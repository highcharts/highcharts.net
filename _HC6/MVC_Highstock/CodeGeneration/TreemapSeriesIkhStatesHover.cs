...
{
	public partial class TreemapSeriesIkhStatesHover  : BaseObject
	{
		public TreemapSeriesIkhStatesHover()
		{
			LineWidthPlus = LineWidthPlus_DefaultValue = 1;
			Marker = Marker_DefaultValue = new TreemapSeriesIkhStatesHoverMarker();
			Halo = Halo_DefaultValue = new TreemapSeriesIkhStatesHoverHalo();
		...
		/// </summary>
		public TreemapSeriesIkhStatesHoverMarker Marker { get; set; }
		private TreemapSeriesIkhStatesHoverMarker Marker_DefaultValue { get; set; }
		...
		/// </summary>
		public TreemapSeriesIkhStatesHoverHalo Halo { get; set; }
		private TreemapSeriesIkhStatesHoverHalo Halo_DefaultValue { get; set; }
