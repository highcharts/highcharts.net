...
{
	public partial class TreemapSeriesIkhTooltip  : BaseObject
	{
		public TreemapSeriesIkhTooltip()
		{
			ValueDecimals = ValueDecimals_DefaultValue = null;
			DateTimeLabelFormats = DateTimeLabelFormats_DefaultValue = new TreemapSeriesIkhTooltipDateTimeLabelFormats();
		...
		/// </summary>
		public TreemapSeriesIkhTooltipDateTimeLabelFormats DateTimeLabelFormats { get; set; }
		private TreemapSeriesIkhTooltipDateTimeLabelFormats DateTimeLabelFormats_DefaultValue { get; set; }
		...
		internal override Hashtable ToHashtable()
		{
			...
			if (PointFormatter != PointFormatter_DefaultValue) { h.Add("pointFormatter",PointFormatter); Highstock.AddFunction("TreemapSeriesIkhTooltipPointFormatter.pointFormatter", PointFormatter); }  
