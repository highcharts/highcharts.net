...
{
	public partial class TreemapSeriesTooltip  : BaseObject
	{
		public TreemapSeriesTooltip()
		{
			...
			DateTimeLabelFormats = DateTimeLabelFormats_DefaultValue = new TreemapSeriesTooltipDateTimeLabelFormats();
		...
		/// </summary>
		public TreemapSeriesTooltipDateTimeLabelFormats DateTimeLabelFormats { get; set; }
		private TreemapSeriesTooltipDateTimeLabelFormats DateTimeLabelFormats_DefaultValue { get; set; }
		...
		internal override Hashtable ToHashtable()
		{
			...
			if (PointFormatter != PointFormatter_DefaultValue) { h.Add("pointFormatter",PointFormatter); Highstock.AddFunction("TreemapSeriesTooltipPointFormatter.pointFormatter", PointFormatter); }  
