...
{
	public partial class VariablepieSeriesDataGrouping  : BaseObject
	{
		public VariablepieSeriesDataGrouping()
		{
			Approximation = Approximation_DefaultValue = VariablepieSeriesDataGroupingApproximation.Average;
		...
		/// </summary>
		public VariablepieSeriesDataGroupingApproximation Approximation { get; set; }
		private VariablepieSeriesDataGroupingApproximation Approximation_DefaultValue { get; set; }
