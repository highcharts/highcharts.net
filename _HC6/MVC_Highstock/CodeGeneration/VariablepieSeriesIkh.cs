...
namespace Highsoft.Web.Mvc.Stocks
{
	public partial class VariablepieSeriesIkh  : BaseObject
	{
		public VariablepieSeriesIkh()
		{
			...
			Zones = Zones_DefaultValue = new VariablepieSeriesIkhZone();
		...
		/// </summary>
		public VariablepieSeriesIkhZone Zones { get; set; }
		private VariablepieSeriesIkhZone Zones_DefaultValue { get; set; }
