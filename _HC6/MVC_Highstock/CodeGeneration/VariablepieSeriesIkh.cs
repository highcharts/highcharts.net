...
{
	public partial class VariablepieSeriesIkh  : BaseObject
	{
		public VariablepieSeriesIkh()
		{
			Name = Name_DefaultValue = "SMA (14)";
			Tooltip = Tooltip_DefaultValue = new VariablepieSeriesIkhTooltip();
			LinkedTo = LinkedTo_DefaultValue = null;
			Params = Params_DefaultValue = new VariablepieSeriesIkhParams();
			Linecap = Linecap_DefaultValue = VariablepieSeriesIkhLinecap.Round;
			BoostThreshold = BoostThreshold_DefaultValue = 5000;
			GapSize = GapSize_DefaultValue = 0;
			GapUnit = GapUnit_DefaultValue = VariablepieSeriesIkhGapUnit.Relative;
			Label = Label_DefaultValue = new VariablepieSeriesIkhLabel();
			DataGrouping = DataGrouping_DefaultValue = new VariablepieSeriesIkhDataGrouping();
			LineWidth = LineWidth_DefaultValue = 2;
			AllowPointSelect = AllowPointSelect_DefaultValue = false;
			ShowCheckbox = ShowCheckbox_DefaultValue = false;
			Animation = Animation_DefaultValue = new Animation() { Enabled = true };
			Events = Events_DefaultValue = new VariablepieSeriesIkhEvents();
			Marker = Marker_DefaultValue = new VariablepieSeriesIkhMarker();
			Point = Point_DefaultValue = new VariablepieSeriesIkhPoint();
			DataLabels = DataLabels_DefaultValue = new VariablepieSeriesIkhDataLabels();
			CropThreshold = CropThreshold_DefaultValue = 300;
			SoftThreshold = SoftThreshold_DefaultValue = true;
			States = States_DefaultValue = new VariablepieSeriesIkhStates();
			StickyTracking = StickyTracking_DefaultValue = null;
			TurboThreshold = TurboThreshold_DefaultValue = 1000;
			FindNearestPointBy = FindNearestPointBy_DefaultValue = VariablepieSeriesIkhFindNearestPointBy.X;
			AnimationLimit = AnimationLimit_DefaultValue = null;
			ClassName = ClassName_DefaultValue = null;
			Color = Color_DefaultValue = null;
			ColorIndex = ColorIndex_DefaultValue = null;
			ConnectNulls = ConnectNulls_DefaultValue = false;
			Cursor = Cursor_DefaultValue = VariablepieSeriesIkhCursor.Null;
			DashStyle = DashStyle_DefaultValue = VariablepieSeriesIkhDashStyle.Solid;
			...
			Step = Step_DefaultValue = VariablepieSeriesIkhStep.Null;
			Threshold = Threshold_DefaultValue = 0;
			Visible = Visible_DefaultValue = true;
			ZoneAxis = ZoneAxis_DefaultValue = "y";
			Zones = Zones_DefaultValue = new List<VariablepieSeriesIkhZone>();
			...
			PointIntervalUnit = PointIntervalUnit_DefaultValue = VariablepieSeriesIkhPointIntervalUnit.Null;
			PointPlacement = PointPlacement_DefaultValue = new PointPlacement();
			PointStart = PointStart_DefaultValue = 0;
			Stacking = Stacking_DefaultValue = VariablepieSeriesIkhStacking.Null;
			Compare = Compare_DefaultValue = "undefined";
			CompareBase = CompareBase_DefaultValue = VariablepieSeriesIkhCompareBase.Min;
		...
		/// </summary>
		public VariablepieSeriesIkhTooltip Tooltip { get; set; }
		private VariablepieSeriesIkhTooltip Tooltip_DefaultValue { get; set; }
		...
		/// 
		/// </summary>
		public VariablepieSeriesIkhParams Params { get; set; }
		private VariablepieSeriesIkhParams Params_DefaultValue { get; set; }
		...
		/// </summary>
		public VariablepieSeriesIkhLinecap Linecap { get; set; }
		private VariablepieSeriesIkhLinecap Linecap_DefaultValue { get; set; }
		...
		/// </summary>
		public VariablepieSeriesIkhGapUnit GapUnit { get; set; }
		private VariablepieSeriesIkhGapUnit GapUnit_DefaultValue { get; set; }
		...
		/// </summary>
		public VariablepieSeriesIkhLabel Label { get; set; }
		private VariablepieSeriesIkhLabel Label_DefaultValue { get; set; }
		...
		/// </summary>
		public VariablepieSeriesIkhDataGrouping DataGrouping { get; set; }
		private VariablepieSeriesIkhDataGrouping DataGrouping_DefaultValue { get; set; }
		...
		/// </summary>
		public VariablepieSeriesIkhEvents Events { get; set; }
		private VariablepieSeriesIkhEvents Events_DefaultValue { get; set; }
		...
		/// </summary>
		public VariablepieSeriesIkhMarker Marker { get; set; }
		private VariablepieSeriesIkhMarker Marker_DefaultValue { get; set; }
		 

		/// <summary>
		/// <p>Properties for each single point.</p>
		/// </summary>
		public VariablepieSeriesIkhPoint Point { get; set; }
		private VariablepieSeriesIkhPoint Point_DefaultValue { get; set; }
		...
		/// </summary>
		public VariablepieSeriesIkhDataLabels DataLabels { get; set; }
		private VariablepieSeriesIkhDataLabels DataLabels_DefaultValue { get; set; }
		...
		/// </summary>
		public VariablepieSeriesIkhStates States { get; set; }
		private VariablepieSeriesIkhStates States_DefaultValue { get; set; }
		...
		/// </summary>
		public VariablepieSeriesIkhFindNearestPointBy FindNearestPointBy { get; set; }
		private VariablepieSeriesIkhFindNearestPointBy FindNearestPointBy_DefaultValue { get; set; }
		...
		/// </summary>
		public VariablepieSeriesIkhCursor Cursor { get; set; }
		private VariablepieSeriesIkhCursor Cursor_DefaultValue { get; set; }
		...
		/// </summary>
		public VariablepieSeriesIkhDashStyle DashStyle { get; set; }
		private VariablepieSeriesIkhDashStyle DashStyle_DefaultValue { get; set; }
		...
		/// </summary>
		public VariablepieSeriesIkhStep Step { get; set; }
		private VariablepieSeriesIkhStep Step_DefaultValue { get; set; }
		...
		/// </summary>
		public List<VariablepieSeriesIkhZone> Zones { get; set; }
		private List<VariablepieSeriesIkhZone> Zones_DefaultValue { get; set; }
		...
		/// </summary>
		public VariablepieSeriesIkhPointIntervalUnit PointIntervalUnit { get; set; }
		private VariablepieSeriesIkhPointIntervalUnit PointIntervalUnit_DefaultValue { get; set; }
		...
		/// </summary>
		public VariablepieSeriesIkhStacking Stacking { get; set; }
		private VariablepieSeriesIkhStacking Stacking_DefaultValue { get; set; }
		...
		/// </summary>
		public VariablepieSeriesIkhCompareBase CompareBase { get; set; }
		private VariablepieSeriesIkhCompareBase CompareBase_DefaultValue { get; set; }
		...
		internal override Hashtable ToHashtable()
		{
			...
			if (PointDescriptionFormatter != PointDescriptionFormatter_DefaultValue) { h.Add("pointDescriptionFormatter",PointDescriptionFormatter); Highstock.AddFunction("VariablepieSeriesIkhPointDescriptionFormatter.pointDescriptionFormatter", PointDescriptionFormatter); }  
