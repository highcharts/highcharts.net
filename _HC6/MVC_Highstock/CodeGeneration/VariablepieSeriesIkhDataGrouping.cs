...
{
	public partial class VariablepieSeriesIkhDataGrouping  : BaseObject
	{
		...
		/// </summary>
		public VariablepieSeriesIkhDataGroupingApproximation Approximation { get; set; }
		private VariablepieSeriesIkhDataGroupingApproximation Approximation_DefaultValue { get; set; }
