...
{
	public partial class VariablepieSeriesIkhDataLabels  : BaseObject
	{
		public VariablepieSeriesIkhDataLabels()
		{
			Align = Align_DefaultValue = VariablepieSeriesIkhDataLabelsAlign.Center;
			Formatter = Formatter_DefaultValue = "";
			Style = Style_DefaultValue = new VariablepieSeriesIkhDataLabelsStyle();
			VerticalAlign = VerticalAlign_DefaultValue = VariablepieSeriesIkhDataLabelsVerticalAlign.Bottom;
			X = X_DefaultValue = 0;
			Y = Y_DefaultValue = -6;
			...
			Overflow = Overflow_DefaultValue = VariablepieSeriesIkhDataLabelsOverflow.Justify;
		...
		/// </summary>
		public VariablepieSeriesIkhDataLabelsAlign Align { get; set; }
		private VariablepieSeriesIkhDataLabelsAlign Align_DefaultValue { get; set; }
		...
		/// </summary>
		public VariablepieSeriesIkhDataLabelsStyle Style { get; set; }
		private VariablepieSeriesIkhDataLabelsStyle Style_DefaultValue { get; set; }
		...
		/// </summary>
		public VariablepieSeriesIkhDataLabelsVerticalAlign VerticalAlign { get; set; }
		private VariablepieSeriesIkhDataLabelsVerticalAlign VerticalAlign_DefaultValue { get; set; }
		...
		/// </summary>
		public VariablepieSeriesIkhDataLabelsOverflow Overflow { get; set; }
		private VariablepieSeriesIkhDataLabelsOverflow Overflow_DefaultValue { get; set; }
		...
		internal override Hashtable ToHashtable()
		{
			...
			if (Formatter != Formatter_DefaultValue) { h.Add("formatter",Formatter); Highstock.AddFunction("VariablepieSeriesIkhDataLabelsFormatter.formatter", Formatter); }  
