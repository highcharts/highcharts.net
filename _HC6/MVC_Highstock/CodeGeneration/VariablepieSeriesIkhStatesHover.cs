...
{
	public partial class VariablepieSeriesIkhStatesHover  : BaseObject
	{
		public VariablepieSeriesIkhStatesHover()
		{
			LineWidthPlus = LineWidthPlus_DefaultValue = 1;
			Marker = Marker_DefaultValue = new VariablepieSeriesIkhStatesHoverMarker();
			Halo = Halo_DefaultValue = new VariablepieSeriesIkhStatesHoverHalo();
		...
		/// </summary>
		public VariablepieSeriesIkhStatesHoverMarker Marker { get; set; }
		private VariablepieSeriesIkhStatesHoverMarker Marker_DefaultValue { get; set; }
		...
		/// </summary>
		public VariablepieSeriesIkhStatesHoverHalo Halo { get; set; }
		private VariablepieSeriesIkhStatesHoverHalo Halo_DefaultValue { get; set; }
