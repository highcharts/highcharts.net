...
{
	public partial class VariablepieSeriesIkhStatesHoverMarker  : BaseObject
	{
		public VariablepieSeriesIkhStatesHoverMarker()
		{
			LineWidth = LineWidth_DefaultValue = 0;
			LineColor = LineColor_DefaultValue = "#ffffff";
			Radius = Radius_DefaultValue = 4;
			States = States_DefaultValue = new VariablepieSeriesIkhStatesHoverMarkerStates();
		...
		/// </summary>
		public VariablepieSeriesIkhStatesHoverMarkerStates States { get; set; }
		private VariablepieSeriesIkhStatesHoverMarkerStates States_DefaultValue { get; set; }
