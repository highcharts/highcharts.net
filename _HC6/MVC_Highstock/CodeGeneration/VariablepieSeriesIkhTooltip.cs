...
{
	public partial class VariablepieSeriesIkhTooltip  : BaseObject
	{
		public VariablepieSeriesIkhTooltip()
		{
			ValueDecimals = ValueDecimals_DefaultValue = null;
			DateTimeLabelFormats = DateTimeLabelFormats_DefaultValue = new VariablepieSeriesIkhTooltipDateTimeLabelFormats();
		...
		/// </summary>
		public VariablepieSeriesIkhTooltipDateTimeLabelFormats DateTimeLabelFormats { get; set; }
		private VariablepieSeriesIkhTooltipDateTimeLabelFormats DateTimeLabelFormats_DefaultValue { get; set; }
		...
		internal override Hashtable ToHashtable()
		{
			...
			if (PointFormatter != PointFormatter_DefaultValue) { h.Add("pointFormatter",PointFormatter); Highstock.AddFunction("VariablepieSeriesIkhTooltipPointFormatter.pointFormatter", PointFormatter); }  
