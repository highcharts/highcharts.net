...
{
	public partial class VariablepieSeriesMarker  : BaseObject
	{
		public VariablepieSeriesMarker()
		{
			LineWidth = LineWidth_DefaultValue = 0;
			LineColor = LineColor_DefaultValue = "#ffffff";
			Radius = Radius_DefaultValue = 4;
			States = States_DefaultValue = new VariablepieSeriesMarkerStates();
		...
		/// </summary>
		public VariablepieSeriesMarkerStates States { get; set; }
		private VariablepieSeriesMarkerStates States_DefaultValue { get; set; }
