...
{
	public partial class VariablepieSeriesStatesSelectMarker  : BaseObject
	{
		public VariablepieSeriesStatesSelectMarker()
		{
			LineWidth = LineWidth_DefaultValue = 0;
			LineColor = LineColor_DefaultValue = "#ffffff";
			Radius = Radius_DefaultValue = 4;
			States = States_DefaultValue = new VariablepieSeriesStatesSelectMarkerStates();
		...
		/// </summary>
		public VariablepieSeriesStatesSelectMarkerStates States { get; set; }
		private VariablepieSeriesStatesSelectMarkerStates States_DefaultValue { get; set; }
