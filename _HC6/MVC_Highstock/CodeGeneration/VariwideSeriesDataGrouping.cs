...
{
	public partial class VariwideSeriesDataGrouping  : BaseObject
	{
		public VariwideSeriesDataGrouping()
		{
			GroupPixelWidth = GroupPixelWidth_DefaultValue = 10;
			Approximation = Approximation_DefaultValue = VariwideSeriesDataGroupingApproximation.Average;
		...
		/// </summary>
		public VariwideSeriesDataGroupingApproximation Approximation { get; set; }
		private VariwideSeriesDataGroupingApproximation Approximation_DefaultValue { get; set; }
