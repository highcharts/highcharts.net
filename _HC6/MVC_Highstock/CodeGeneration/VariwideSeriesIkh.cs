...
{
	public partial class VariwideSeriesIkh  : BaseObject
	{
		public VariwideSeriesIkh()
		{
			Name = Name_DefaultValue = "SMA (14)";
			Tooltip = Tooltip_DefaultValue = new VariwideSeriesIkhTooltip();
			LinkedTo = LinkedTo_DefaultValue = null;
			Params = Params_DefaultValue = new VariwideSeriesIkhParams();
			Linecap = Linecap_DefaultValue = VariwideSeriesIkhLinecap.Round;
			BoostThreshold = BoostThreshold_DefaultValue = 5000;
			GapSize = GapSize_DefaultValue = 0;
			GapUnit = GapUnit_DefaultValue = VariwideSeriesIkhGapUnit.Relative;
			Label = Label_DefaultValue = new VariwideSeriesIkhLabel();
			DataGrouping = DataGrouping_DefaultValue = new VariwideSeriesIkhDataGrouping();
			LineWidth = LineWidth_DefaultValue = 2;
			AllowPointSelect = AllowPointSelect_DefaultValue = false;
			ShowCheckbox = ShowCheckbox_DefaultValue = false;
			Animation = Animation_DefaultValue = new Animation() { Enabled = true };
			Events = Events_DefaultValue = new VariwideSeriesIkhEvents();
			Marker = Marker_DefaultValue = new VariwideSeriesIkhMarker();
			Point = Point_DefaultValue = new VariwideSeriesIkhPoint();
			DataLabels = DataLabels_DefaultValue = new VariwideSeriesIkhDataLabels();
			CropThreshold = CropThreshold_DefaultValue = 300;
			SoftThreshold = SoftThreshold_DefaultValue = true;
			States = States_DefaultValue = new VariwideSeriesIkhStates();
			StickyTracking = StickyTracking_DefaultValue = null;
			TurboThreshold = TurboThreshold_DefaultValue = 1000;
			FindNearestPointBy = FindNearestPointBy_DefaultValue = VariwideSeriesIkhFindNearestPointBy.X;
			AnimationLimit = AnimationLimit_DefaultValue = null;
			ClassName = ClassName_DefaultValue = null;
			Color = Color_DefaultValue = null;
			ColorIndex = ColorIndex_DefaultValue = null;
			ConnectNulls = ConnectNulls_DefaultValue = false;
			Cursor = Cursor_DefaultValue = VariwideSeriesIkhCursor.Null;
			DashStyle = DashStyle_DefaultValue = VariwideSeriesIkhDashStyle.Solid;
			...
			Step = Step_DefaultValue = VariwideSeriesIkhStep.Null;
			Threshold = Threshold_DefaultValue = 0;
			Visible = Visible_DefaultValue = true;
			ZoneAxis = ZoneAxis_DefaultValue = "y";
			Zones = Zones_DefaultValue = new List<VariwideSeriesIkhZone>();
			...
			PointIntervalUnit = PointIntervalUnit_DefaultValue = VariwideSeriesIkhPointIntervalUnit.Null;
			PointPlacement = PointPlacement_DefaultValue = new PointPlacement();
			PointStart = PointStart_DefaultValue = 0;
			Stacking = Stacking_DefaultValue = VariwideSeriesIkhStacking.Null;
			Compare = Compare_DefaultValue = "undefined";
			CompareBase = CompareBase_DefaultValue = VariwideSeriesIkhCompareBase.Min;
		...
		/// </summary>
		public VariwideSeriesIkhTooltip Tooltip { get; set; }
		private VariwideSeriesIkhTooltip Tooltip_DefaultValue { get; set; }
		...
		/// 
		/// </summary>
		public VariwideSeriesIkhParams Params { get; set; }
		private VariwideSeriesIkhParams Params_DefaultValue { get; set; }
		...
		/// </summary>
		public VariwideSeriesIkhLinecap Linecap { get; set; }
		private VariwideSeriesIkhLinecap Linecap_DefaultValue { get; set; }
		...
		/// </summary>
		public VariwideSeriesIkhGapUnit GapUnit { get; set; }
		private VariwideSeriesIkhGapUnit GapUnit_DefaultValue { get; set; }
		...
		/// </summary>
		public VariwideSeriesIkhLabel Label { get; set; }
		private VariwideSeriesIkhLabel Label_DefaultValue { get; set; }
		...
		/// </summary>
		public VariwideSeriesIkhDataGrouping DataGrouping { get; set; }
		private VariwideSeriesIkhDataGrouping DataGrouping_DefaultValue { get; set; }
		...
		/// </summary>
		public VariwideSeriesIkhEvents Events { get; set; }
		private VariwideSeriesIkhEvents Events_DefaultValue { get; set; }
		...
		/// </summary>
		public VariwideSeriesIkhMarker Marker { get; set; }
		private VariwideSeriesIkhMarker Marker_DefaultValue { get; set; }
		 

		/// <summary>
		/// <p>Properties for each single point.</p>
		/// </summary>
		public VariwideSeriesIkhPoint Point { get; set; }
		private VariwideSeriesIkhPoint Point_DefaultValue { get; set; }
		...
		/// </summary>
		public VariwideSeriesIkhDataLabels DataLabels { get; set; }
		private VariwideSeriesIkhDataLabels DataLabels_DefaultValue { get; set; }
		...
		/// </summary>
		public VariwideSeriesIkhStates States { get; set; }
		private VariwideSeriesIkhStates States_DefaultValue { get; set; }
		...
		/// </summary>
		public VariwideSeriesIkhFindNearestPointBy FindNearestPointBy { get; set; }
		private VariwideSeriesIkhFindNearestPointBy FindNearestPointBy_DefaultValue { get; set; }
		...
		/// </summary>
		public VariwideSeriesIkhCursor Cursor { get; set; }
		private VariwideSeriesIkhCursor Cursor_DefaultValue { get; set; }
		...
		/// </summary>
		public VariwideSeriesIkhDashStyle DashStyle { get; set; }
		private VariwideSeriesIkhDashStyle DashStyle_DefaultValue { get; set; }
		...
		/// </summary>
		public VariwideSeriesIkhStep Step { get; set; }
		private VariwideSeriesIkhStep Step_DefaultValue { get; set; }
		...
		/// </summary>
		public List<VariwideSeriesIkhZone> Zones { get; set; }
		private List<VariwideSeriesIkhZone> Zones_DefaultValue { get; set; }
		...
		/// </summary>
		public VariwideSeriesIkhPointIntervalUnit PointIntervalUnit { get; set; }
		private VariwideSeriesIkhPointIntervalUnit PointIntervalUnit_DefaultValue { get; set; }
		...
		/// </summary>
		public VariwideSeriesIkhStacking Stacking { get; set; }
		private VariwideSeriesIkhStacking Stacking_DefaultValue { get; set; }
		...
		/// </summary>
		public VariwideSeriesIkhCompareBase CompareBase { get; set; }
		private VariwideSeriesIkhCompareBase CompareBase_DefaultValue { get; set; }
		...
		internal override Hashtable ToHashtable()
		{
			...
			if (PointDescriptionFormatter != PointDescriptionFormatter_DefaultValue) { h.Add("pointDescriptionFormatter",PointDescriptionFormatter); Highstock.AddFunction("VariwideSeriesIkhPointDescriptionFormatter.pointDescriptionFormatter", PointDescriptionFormatter); }  
