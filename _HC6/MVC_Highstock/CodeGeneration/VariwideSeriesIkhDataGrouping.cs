...
{
	public partial class VariwideSeriesIkhDataGrouping  : BaseObject
	{
		...
		/// </summary>
		public VariwideSeriesIkhDataGroupingApproximation Approximation { get; set; }
		private VariwideSeriesIkhDataGroupingApproximation Approximation_DefaultValue { get; set; }
