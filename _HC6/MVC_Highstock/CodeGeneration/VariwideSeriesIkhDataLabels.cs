...
{
	public partial class VariwideSeriesIkhDataLabels  : BaseObject
	{
		public VariwideSeriesIkhDataLabels()
		{
			Align = Align_DefaultValue = VariwideSeriesIkhDataLabelsAlign.Center;
			Formatter = Formatter_DefaultValue = "";
			Style = Style_DefaultValue = new VariwideSeriesIkhDataLabelsStyle();
			VerticalAlign = VerticalAlign_DefaultValue = VariwideSeriesIkhDataLabelsVerticalAlign.Bottom;
			X = X_DefaultValue = 0;
			Y = Y_DefaultValue = -6;
			...
			Overflow = Overflow_DefaultValue = VariwideSeriesIkhDataLabelsOverflow.Justify;
		...
		/// </summary>
		public VariwideSeriesIkhDataLabelsAlign Align { get; set; }
		private VariwideSeriesIkhDataLabelsAlign Align_DefaultValue { get; set; }
		...
		/// </summary>
		public VariwideSeriesIkhDataLabelsStyle Style { get; set; }
		private VariwideSeriesIkhDataLabelsStyle Style_DefaultValue { get; set; }
		...
		/// </summary>
		public VariwideSeriesIkhDataLabelsVerticalAlign VerticalAlign { get; set; }
		private VariwideSeriesIkhDataLabelsVerticalAlign VerticalAlign_DefaultValue { get; set; }
		...
		/// </summary>
		public VariwideSeriesIkhDataLabelsOverflow Overflow { get; set; }
		private VariwideSeriesIkhDataLabelsOverflow Overflow_DefaultValue { get; set; }
		...
		internal override Hashtable ToHashtable()
		{
			...
			if (Formatter != Formatter_DefaultValue) { h.Add("formatter",Formatter); Highstock.AddFunction("VariwideSeriesIkhDataLabelsFormatter.formatter", Formatter); }  
