...
{
	public partial class VariwideSeriesIkhLabel  : BaseObject
	{
		public VariwideSeriesIkhLabel()
		{
			...
			Style = Style_DefaultValue = new VariwideSeriesIkhLabelStyle();
		...
		/// </summary>
		public VariwideSeriesIkhLabelStyle Style { get; set; }
		private VariwideSeriesIkhLabelStyle Style_DefaultValue { get; set; }
