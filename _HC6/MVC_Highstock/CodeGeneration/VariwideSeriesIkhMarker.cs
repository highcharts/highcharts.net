...
{
	public partial class VariwideSeriesIkhMarker  : BaseObject
	{
		public VariwideSeriesIkhMarker()
		{
			LineWidth = LineWidth_DefaultValue = 0;
			LineColor = LineColor_DefaultValue = "#ffffff";
			Radius = Radius_DefaultValue = 4;
			States = States_DefaultValue = new VariwideSeriesIkhMarkerStates();
		...
		/// </summary>
		public VariwideSeriesIkhMarkerStates States { get; set; }
		private VariwideSeriesIkhMarkerStates States_DefaultValue { get; set; }
