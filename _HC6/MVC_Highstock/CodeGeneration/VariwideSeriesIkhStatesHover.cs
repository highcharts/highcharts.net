...
{
	public partial class VariwideSeriesIkhStatesHover  : BaseObject
	{
		public VariwideSeriesIkhStatesHover()
		{
			LineWidthPlus = LineWidthPlus_DefaultValue = 1;
			Marker = Marker_DefaultValue = new VariwideSeriesIkhStatesHoverMarker();
			Halo = Halo_DefaultValue = new VariwideSeriesIkhStatesHoverHalo();
		...
		/// </summary>
		public VariwideSeriesIkhStatesHoverMarker Marker { get; set; }
		private VariwideSeriesIkhStatesHoverMarker Marker_DefaultValue { get; set; }
		...
		/// </summary>
		public VariwideSeriesIkhStatesHoverHalo Halo { get; set; }
		private VariwideSeriesIkhStatesHoverHalo Halo_DefaultValue { get; set; }
