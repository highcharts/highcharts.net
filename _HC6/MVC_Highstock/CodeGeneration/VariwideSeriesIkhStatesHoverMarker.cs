...
{
	public partial class VariwideSeriesIkhStatesHoverMarker  : BaseObject
	{
		public VariwideSeriesIkhStatesHoverMarker()
		{
			LineWidth = LineWidth_DefaultValue = 0;
			LineColor = LineColor_DefaultValue = "#ffffff";
			Radius = Radius_DefaultValue = 4;
			States = States_DefaultValue = new VariwideSeriesIkhStatesHoverMarkerStates();
		...
		/// </summary>
		public VariwideSeriesIkhStatesHoverMarkerStates States { get; set; }
		private VariwideSeriesIkhStatesHoverMarkerStates States_DefaultValue { get; set; }
