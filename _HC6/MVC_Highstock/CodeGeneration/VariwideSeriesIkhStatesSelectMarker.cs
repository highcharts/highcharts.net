...
{
	public partial class VariwideSeriesIkhStatesSelectMarker  : BaseObject
	{
		public VariwideSeriesIkhStatesSelectMarker()
		{
			LineWidth = LineWidth_DefaultValue = 0;
			LineColor = LineColor_DefaultValue = "#ffffff";
			Radius = Radius_DefaultValue = 4;
			States = States_DefaultValue = new VariwideSeriesIkhStatesSelectMarkerStates();
		...
		/// </summary>
		public VariwideSeriesIkhStatesSelectMarkerStates States { get; set; }
		private VariwideSeriesIkhStatesSelectMarkerStates States_DefaultValue { get; set; }
