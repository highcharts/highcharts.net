...
{
	public partial class VariwideSeriesIkhTooltip  : BaseObject
	{
		public VariwideSeriesIkhTooltip()
		{
			ValueDecimals = ValueDecimals_DefaultValue = null;
			DateTimeLabelFormats = DateTimeLabelFormats_DefaultValue = new VariwideSeriesIkhTooltipDateTimeLabelFormats();
		...
		/// </summary>
		public VariwideSeriesIkhTooltipDateTimeLabelFormats DateTimeLabelFormats { get; set; }
		private VariwideSeriesIkhTooltipDateTimeLabelFormats DateTimeLabelFormats_DefaultValue { get; set; }
		...
		internal override Hashtable ToHashtable()
		{
			...
			if (PointFormatter != PointFormatter_DefaultValue) { h.Add("pointFormatter",PointFormatter); Highstock.AddFunction("VariwideSeriesIkhTooltipPointFormatter.pointFormatter", PointFormatter); }  
