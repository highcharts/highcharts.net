...
{
	public partial class VbpSeriesData  : BaseObject
	{
		public VbpSeriesData()
		{
			...
			DragDrop = DragDrop_DefaultValue = new VbpSeriesDataDragDrop();
			Drilldown = Drilldown_DefaultValue = "";
			Events = Events_DefaultValue = new VbpSeriesDataEvents();
			Id = Id_DefaultValue = "";
			Labelrank = Labelrank_DefaultValue = null;
			Marker = Marker_DefaultValue = new VbpSeriesDataMarker();
		...
		/// </summary>
		public VbpSeriesDataDragDrop DragDrop { get; set; }
		private VbpSeriesDataDragDrop DragDrop_DefaultValue { get; set; }
		...
		/// </summary>
		public VbpSeriesDataEvents Events { get; set; }
		private VbpSeriesDataEvents Events_DefaultValue { get; set; }
		...
		/// 
		/// </summary>
		public VbpSeriesDataMarker Marker { get; set; }
		private VbpSeriesDataMarker Marker_DefaultValue { get; set; }
