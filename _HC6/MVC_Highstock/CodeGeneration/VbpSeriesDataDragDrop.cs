...
{
	public partial class VbpSeriesDataDragDrop  : BaseObject
	{
		public VbpSeriesDataDragDrop()
		{
			DraggableX = DraggableX_DefaultValue = null;
			DraggableY = DraggableY_DefaultValue = null;
			DragHandle = DragHandle_DefaultValue = new VbpSeriesDataDragDropDragHandle();
			...
			GuideBox = GuideBox_DefaultValue = new VbpSeriesDataDragDropGuideBox();
		...
		/// </summary>
		public VbpSeriesDataDragDropDragHandle DragHandle { get; set; }
		private VbpSeriesDataDragDropDragHandle DragHandle_DefaultValue { get; set; }
		...
		/// </summary>
		public VbpSeriesDataDragDropGuideBox GuideBox { get; set; }
		private VbpSeriesDataDragDropGuideBox GuideBox_DefaultValue { get; set; }
