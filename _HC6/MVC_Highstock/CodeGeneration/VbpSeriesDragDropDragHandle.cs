...
{
	public partial class VbpSeriesDragDropDragHandle  : BaseObject
	{
		public VbpSeriesDragDropDragHandle()
		{
		...
		internal override Hashtable ToHashtable()
		{
			...
			if (PathFormatter != PathFormatter_DefaultValue) { h.Add("pathFormatter",PathFormatter); Highstock.AddFunction("VbpSeriesDragDropDragHandlePathFormatter.pathFormatter", PathFormatter); }  
