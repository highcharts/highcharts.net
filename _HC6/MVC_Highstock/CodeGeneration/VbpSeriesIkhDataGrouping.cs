...
{
	public partial class VbpSeriesIkhDataGrouping  : BaseObject
	{
		public VbpSeriesIkhDataGrouping()
		{
			Approximation = Approximation_DefaultValue = VbpSeriesIkhDataGroupingApproximation.Average;
		...
		/// </summary>
		public VbpSeriesIkhDataGroupingApproximation Approximation { get; set; }
		private VbpSeriesIkhDataGroupingApproximation Approximation_DefaultValue { get; set; }
