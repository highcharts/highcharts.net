...
{
	public partial class VbpSeriesIkhDataLabels  : BaseObject
	{
		public VbpSeriesIkhDataLabels()
		{
			Align = Align_DefaultValue = VbpSeriesIkhDataLabelsAlign.Center;
			Formatter = Formatter_DefaultValue = "";
			Style = Style_DefaultValue = new VbpSeriesIkhDataLabelsStyle();
			VerticalAlign = VerticalAlign_DefaultValue = VbpSeriesIkhDataLabelsVerticalAlign.Bottom;
			X = X_DefaultValue = 0;
			Y = Y_DefaultValue = -6;
			...
			Overflow = Overflow_DefaultValue = VbpSeriesIkhDataLabelsOverflow.Justify;
		...
		/// </summary>
		public VbpSeriesIkhDataLabelsAlign Align { get; set; }
		private VbpSeriesIkhDataLabelsAlign Align_DefaultValue { get; set; }
		...
		/// </summary>
		public VbpSeriesIkhDataLabelsStyle Style { get; set; }
		private VbpSeriesIkhDataLabelsStyle Style_DefaultValue { get; set; }
		...
		/// </summary>
		public VbpSeriesIkhDataLabelsVerticalAlign VerticalAlign { get; set; }
		private VbpSeriesIkhDataLabelsVerticalAlign VerticalAlign_DefaultValue { get; set; }
		...
		/// </summary>
		public VbpSeriesIkhDataLabelsOverflow Overflow { get; set; }
		private VbpSeriesIkhDataLabelsOverflow Overflow_DefaultValue { get; set; }
		...
		internal override Hashtable ToHashtable()
		{
			...
			if (Formatter != Formatter_DefaultValue) { h.Add("formatter",Formatter); Highstock.AddFunction("VbpSeriesIkhDataLabelsFormatter.formatter", Formatter); }  
