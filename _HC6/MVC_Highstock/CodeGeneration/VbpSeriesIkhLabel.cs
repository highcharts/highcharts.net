...
{
	public partial class VbpSeriesIkhLabel  : BaseObject
	{
		public VbpSeriesIkhLabel()
		{
			...
			Style = Style_DefaultValue = new VbpSeriesIkhLabelStyle();
		...
		/// </summary>
		public VbpSeriesIkhLabelStyle Style { get; set; }
		private VbpSeriesIkhLabelStyle Style_DefaultValue { get; set; }
