...
{
	public partial class VbpSeriesIkhStatesHover  : BaseObject
	{
		public VbpSeriesIkhStatesHover()
		{
			LineWidthPlus = LineWidthPlus_DefaultValue = 1;
			Marker = Marker_DefaultValue = new VbpSeriesIkhStatesHoverMarker();
			Halo = Halo_DefaultValue = new VbpSeriesIkhStatesHoverHalo();
		...
		/// </summary>
		public VbpSeriesIkhStatesHoverMarker Marker { get; set; }
		private VbpSeriesIkhStatesHoverMarker Marker_DefaultValue { get; set; }
		...
		/// </summary>
		public VbpSeriesIkhStatesHoverHalo Halo { get; set; }
		private VbpSeriesIkhStatesHoverHalo Halo_DefaultValue { get; set; }
