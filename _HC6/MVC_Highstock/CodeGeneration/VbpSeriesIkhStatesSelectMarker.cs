...
{
	public partial class VbpSeriesIkhStatesSelectMarker  : BaseObject
	{
		public VbpSeriesIkhStatesSelectMarker()
		{
			LineWidth = LineWidth_DefaultValue = 0;
			LineColor = LineColor_DefaultValue = "#ffffff";
			Radius = Radius_DefaultValue = 4;
			States = States_DefaultValue = new VbpSeriesIkhStatesSelectMarkerStates();
		...
		/// </summary>
		public VbpSeriesIkhStatesSelectMarkerStates States { get; set; }
		private VbpSeriesIkhStatesSelectMarkerStates States_DefaultValue { get; set; }
