...
{
	public partial class VbpSeriesIkhTooltip  : BaseObject
	{
		public VbpSeriesIkhTooltip()
		{
			ValueDecimals = ValueDecimals_DefaultValue = null;
			DateTimeLabelFormats = DateTimeLabelFormats_DefaultValue = new VbpSeriesIkhTooltipDateTimeLabelFormats();
		...
		/// </summary>
		public VbpSeriesIkhTooltipDateTimeLabelFormats DateTimeLabelFormats { get; set; }
		private VbpSeriesIkhTooltipDateTimeLabelFormats DateTimeLabelFormats_DefaultValue { get; set; }
		...
		internal override Hashtable ToHashtable()
		{
			...
			if (PointFormatter != PointFormatter_DefaultValue) { h.Add("pointFormatter",PointFormatter); Highstock.AddFunction("VbpSeriesIkhTooltipPointFormatter.pointFormatter", PointFormatter); }  
