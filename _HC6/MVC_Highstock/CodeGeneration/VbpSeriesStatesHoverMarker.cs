...
{
	public partial class VbpSeriesStatesHoverMarker  : BaseObject
	{
		public VbpSeriesStatesHoverMarker()
		{
			...
			States = States_DefaultValue = new VbpSeriesStatesHoverMarkerStates();
		...
		/// </summary>
		public VbpSeriesStatesHoverMarkerStates States { get; set; }
		private VbpSeriesStatesHoverMarkerStates States_DefaultValue { get; set; }
