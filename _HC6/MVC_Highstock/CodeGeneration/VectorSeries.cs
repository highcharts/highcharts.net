...
namespace Highsoft.Web.Mvc.Stocks
{
	public partial class VectorSeries  : Series
	{
		public VectorSeries()
		{
			...
			Point = Point_DefaultValue = new VectorSeriesPoint();
			...
			Zones = Zones_DefaultValue = new VectorSeriesZone();
			...
			GapUnit = GapUnit_DefaultValue = VectorSeriesGapUnit.Relative;
			DataGrouping = DataGrouping_DefaultValue = new VectorSeriesDataGrouping();
			Marker = Marker_DefaultValue = new VectorSeriesMarker();
			CropThreshold = CropThreshold_DefaultValue = 300;
			ConnectNulls = ConnectNulls_DefaultValue = false;
			DashStyle = DashStyle_DefaultValue = VectorSeriesDashStyle.Solid;
			Linecap = Linecap_DefaultValue = VectorSeriesLinecap.Round;
			Shadow = Shadow_DefaultValue = new Shadow() { Enabled = false };
			Stacking = Stacking_DefaultValue = VectorSeriesStacking.Null;
			Step = Step_DefaultValue = VectorSeriesStep.Null;
		...
		/// <summary>
		/// <p>An array of data points for the series. For the <code>vector</code> series type,points can be given in the following ways:</p><ol><li><p>An array of arrays with 4 values. In this case, the values correspondto <code>x,y,length,direction</code>. If the first value is a string, it is applied asthe name of the point, and the <code>x</code> value is inferred.</p><pre><code class="lang-js">data: [    [0, 0, 10, 90],    [0, 1, 5, 180],    [1, 1, 2, 270]]</code></pre></li><li><p>An array of objects with named values. The objects are pointconfiguration objects as seen below. If the total number of datapoints exceeds the series&#39; <a href="#series.area.turboThreshold">turboThreshold</a>,this option is not available.</p><pre><code class="lang-js">data: [{    x: 0,    y: 0,    name: &quot;Point2&quot;,    length: 10,    direction: 90}, {    x: 1,    y: 1,    name: &quot;Point1&quot;,    direction: 270}]</code></pre></li></ol>
		/// </summary>
		...
		/// </summary>
		public VectorSeriesIkh Ikh { get; set; }
		private VectorSeriesIkh Ikh_DefaultValue { get; set; }
		...
		/// </summary>
		public VectorSeriesType Type { get; set; }
		private VectorSeriesType Type_DefaultValue { get; set; }
		...
		/// </summary>
		public VectorSeriesStates States { get; set; }
		private VectorSeriesStates States_DefaultValue { get; set; }
		...
		/// </summary>
		public VectorSeriesTooltip Tooltip { get; set; }
		private VectorSeriesTooltip Tooltip_DefaultValue { get; set; }
		...
		/// </summary>
		public VectorSeriesFindNearestPointBy FindNearestPointBy { get; set; }
		private VectorSeriesFindNearestPointBy FindNearestPointBy_DefaultValue { get; set; }
		...
		/// </summary>
		public VectorSeriesEvents Events { get; set; }
		private VectorSeriesEvents Events_DefaultValue { get; set; }
		 

		/// <summary>
		/// <p>Properties for each single point.</p>
		/// </summary>
		public VectorSeriesPoint Point { get; set; }
		private VectorSeriesPoint Point_DefaultValue { get; set; }
		...
		/// </summary>
		public VectorSeriesCursor Cursor { get; set; }
		private VectorSeriesCursor Cursor_DefaultValue { get; set; }
		...
		/// </summary>
		public VectorSeriesPointIntervalUnit PointIntervalUnit { get; set; }
		private VectorSeriesPointIntervalUnit PointIntervalUnit_DefaultValue { get; set; }
		...
		/// </summary>
		public VectorSeriesZone Zones { get; set; }
		private VectorSeriesZone Zones_DefaultValue { get; set; }
		...
		/// </summary>
		public VectorSeriesCompareBase CompareBase { get; set; }
		private VectorSeriesCompareBase CompareBase_DefaultValue { get; set; }
		...
		/// </summary>
		public VectorSeriesGapUnit GapUnit { get; set; }
		private VectorSeriesGapUnit GapUnit_DefaultValue { get; set; }
		...
		/// </summary>
		public VectorSeriesDataGrouping DataGrouping { get; set; }
		private VectorSeriesDataGrouping DataGrouping_DefaultValue { get; set; }
		...
		/// </summary>
		public VectorSeriesMarker Marker { get; set; }
		private VectorSeriesMarker Marker_DefaultValue { get; set; }
		...
		/// </summary>
		public VectorSeriesDashStyle DashStyle { get; set; }
		private VectorSeriesDashStyle DashStyle_DefaultValue { get; set; }
		 

		/// <summary>
		/// <p>The line cap used for line ends and line joins on the graph.</p>
		/// </summary>
		public VectorSeriesLinecap Linecap { get; set; }
		private VectorSeriesLinecap Linecap_DefaultValue { get; set; }
		...
		/// </summary>
		public VectorSeriesStacking Stacking { get; set; }
		private VectorSeriesStacking Stacking_DefaultValue { get; set; }
		 

		/// <summary>
		/// <p>Whether to apply steps to the line. Possible values are <code>left</code>, <code>center</code>and <code>right</code>.</p>
		/// </summary>
		public VectorSeriesStep Step { get; set; }
		private VectorSeriesStep Step_DefaultValue { get; set; }
		...
		internal override Hashtable ToHashtable()
		{
			...
			if (PointDescriptionFormatter != PointDescriptionFormatter_DefaultValue) { h.Add("pointDescriptionFormatter",PointDescriptionFormatter); Highstock.AddFunction("VectorSeriesPointDescriptionFormatter.pointDescriptionFormatter", PointDescriptionFormatter); }  
