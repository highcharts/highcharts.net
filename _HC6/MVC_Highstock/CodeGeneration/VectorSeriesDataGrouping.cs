...
{
	public partial class VectorSeriesDataGrouping  : BaseObject
	{
		public VectorSeriesDataGrouping()
		{
			Approximation = Approximation_DefaultValue = VectorSeriesDataGroupingApproximation.Average;
		...
		/// </summary>
		public VectorSeriesDataGroupingApproximation Approximation { get; set; }
		private VectorSeriesDataGroupingApproximation Approximation_DefaultValue { get; set; }
