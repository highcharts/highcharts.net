...
namespace Highsoft.Web.Mvc.Stocks
{
	public partial class VectorSeriesDragDropDragHandle  : BaseObject
	{
		...
		internal override Hashtable ToHashtable()
		{
			...
			if (PathFormatter != PathFormatter_DefaultValue) { h.Add("pathFormatter",PathFormatter); Highstock.AddFunction("VectorSeriesDragDropDragHandlePathFormatter.pathFormatter", PathFormatter); }  
