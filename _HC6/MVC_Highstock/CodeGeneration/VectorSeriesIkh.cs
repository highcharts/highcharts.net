...
{
	public partial class VectorSeriesIkh  : BaseObject
	{
		public VectorSeriesIkh()
		{
			Name = Name_DefaultValue = "SMA (14)";
			Tooltip = Tooltip_DefaultValue = new VectorSeriesIkhTooltip();
			LinkedTo = LinkedTo_DefaultValue = null;
			Params = Params_DefaultValue = new VectorSeriesIkhParams();
			Linecap = Linecap_DefaultValue = VectorSeriesIkhLinecap.Round;
			BoostThreshold = BoostThreshold_DefaultValue = 5000;
			GapSize = GapSize_DefaultValue = 0;
			GapUnit = GapUnit_DefaultValue = VectorSeriesIkhGapUnit.Relative;
			Label = Label_DefaultValue = new VectorSeriesIkhLabel();
			DataGrouping = DataGrouping_DefaultValue = new VectorSeriesIkhDataGrouping();
			LineWidth = LineWidth_DefaultValue = 2;
			AllowPointSelect = AllowPointSelect_DefaultValue = false;
			ShowCheckbox = ShowCheckbox_DefaultValue = false;
			Animation = Animation_DefaultValue = new Animation() { Enabled = true };
			Events = Events_DefaultValue = new VectorSeriesIkhEvents();
			Marker = Marker_DefaultValue = new VectorSeriesIkhMarker();
			Point = Point_DefaultValue = new VectorSeriesIkhPoint();
			DataLabels = DataLabels_DefaultValue = new VectorSeriesIkhDataLabels();
			CropThreshold = CropThreshold_DefaultValue = 300;
			SoftThreshold = SoftThreshold_DefaultValue = true;
			States = States_DefaultValue = new VectorSeriesIkhStates();
			StickyTracking = StickyTracking_DefaultValue = null;
			TurboThreshold = TurboThreshold_DefaultValue = 1000;
			FindNearestPointBy = FindNearestPointBy_DefaultValue = VectorSeriesIkhFindNearestPointBy.X;
			AnimationLimit = AnimationLimit_DefaultValue = null;
			ClassName = ClassName_DefaultValue = null;
			Color = Color_DefaultValue = null;
			ColorIndex = ColorIndex_DefaultValue = null;
			ConnectNulls = ConnectNulls_DefaultValue = false;
			Cursor = Cursor_DefaultValue = VectorSeriesIkhCursor.Null;
			DashStyle = DashStyle_DefaultValue = VectorSeriesIkhDashStyle.Solid;
			...
			Step = Step_DefaultValue = VectorSeriesIkhStep.Null;
			Threshold = Threshold_DefaultValue = 0;
			Visible = Visible_DefaultValue = true;
			ZoneAxis = ZoneAxis_DefaultValue = "y";
			Zones = Zones_DefaultValue = new List<VectorSeriesIkhZone>();
			...
			PointIntervalUnit = PointIntervalUnit_DefaultValue = VectorSeriesIkhPointIntervalUnit.Null;
			PointPlacement = PointPlacement_DefaultValue = new PointPlacement();
			PointStart = PointStart_DefaultValue = 0;
			Stacking = Stacking_DefaultValue = VectorSeriesIkhStacking.Null;
			Compare = Compare_DefaultValue = "undefined";
			CompareBase = CompareBase_DefaultValue = VectorSeriesIkhCompareBase.Min;
		...
		/// </summary>
		public VectorSeriesIkhTooltip Tooltip { get; set; }
		private VectorSeriesIkhTooltip Tooltip_DefaultValue { get; set; }
		...
		/// 
		/// </summary>
		public VectorSeriesIkhParams Params { get; set; }
		private VectorSeriesIkhParams Params_DefaultValue { get; set; }
		...
		/// </summary>
		public VectorSeriesIkhLinecap Linecap { get; set; }
		private VectorSeriesIkhLinecap Linecap_DefaultValue { get; set; }
		...
		/// </summary>
		public VectorSeriesIkhGapUnit GapUnit { get; set; }
		private VectorSeriesIkhGapUnit GapUnit_DefaultValue { get; set; }
		...
		/// </summary>
		public VectorSeriesIkhLabel Label { get; set; }
		private VectorSeriesIkhLabel Label_DefaultValue { get; set; }
		...
		/// </summary>
		public VectorSeriesIkhDataGrouping DataGrouping { get; set; }
		private VectorSeriesIkhDataGrouping DataGrouping_DefaultValue { get; set; }
		...
		/// </summary>
		public VectorSeriesIkhEvents Events { get; set; }
		private VectorSeriesIkhEvents Events_DefaultValue { get; set; }
		...
		/// </summary>
		public VectorSeriesIkhMarker Marker { get; set; }
		private VectorSeriesIkhMarker Marker_DefaultValue { get; set; }
		 

		/// <summary>
		/// <p>Properties for each single point.</p>
		/// </summary>
		public VectorSeriesIkhPoint Point { get; set; }
		private VectorSeriesIkhPoint Point_DefaultValue { get; set; }
		...
		/// </summary>
		public VectorSeriesIkhDataLabels DataLabels { get; set; }
		private VectorSeriesIkhDataLabels DataLabels_DefaultValue { get; set; }
		...
		/// </summary>
		public VectorSeriesIkhStates States { get; set; }
		private VectorSeriesIkhStates States_DefaultValue { get; set; }
		...
		/// </summary>
		public VectorSeriesIkhFindNearestPointBy FindNearestPointBy { get; set; }
		private VectorSeriesIkhFindNearestPointBy FindNearestPointBy_DefaultValue { get; set; }
		...
		/// </summary>
		public VectorSeriesIkhCursor Cursor { get; set; }
		private VectorSeriesIkhCursor Cursor_DefaultValue { get; set; }
		...
		/// </summary>
		public VectorSeriesIkhDashStyle DashStyle { get; set; }
		private VectorSeriesIkhDashStyle DashStyle_DefaultValue { get; set; }
		...
		/// </summary>
		public VectorSeriesIkhStep Step { get; set; }
		private VectorSeriesIkhStep Step_DefaultValue { get; set; }
		...
		/// </summary>
		public List<VectorSeriesIkhZone> Zones { get; set; }
		private List<VectorSeriesIkhZone> Zones_DefaultValue { get; set; }
		...
		/// </summary>
		public VectorSeriesIkhPointIntervalUnit PointIntervalUnit { get; set; }
		private VectorSeriesIkhPointIntervalUnit PointIntervalUnit_DefaultValue { get; set; }
		...
		/// </summary>
		public VectorSeriesIkhStacking Stacking { get; set; }
		private VectorSeriesIkhStacking Stacking_DefaultValue { get; set; }
		...
		/// </summary>
		public VectorSeriesIkhCompareBase CompareBase { get; set; }
		private VectorSeriesIkhCompareBase CompareBase_DefaultValue { get; set; }
		...
		internal override Hashtable ToHashtable()
		{
			...
			if (PointDescriptionFormatter != PointDescriptionFormatter_DefaultValue) { h.Add("pointDescriptionFormatter",PointDescriptionFormatter); Highstock.AddFunction("VectorSeriesIkhPointDescriptionFormatter.pointDescriptionFormatter", PointDescriptionFormatter); }  
