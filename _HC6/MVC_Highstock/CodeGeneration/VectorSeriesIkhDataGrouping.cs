...
{
	public partial class VectorSeriesIkhDataGrouping  : BaseObject
	{
		public VectorSeriesIkhDataGrouping()
		{
			Approximation = Approximation_DefaultValue = VectorSeriesIkhDataGroupingApproximation.Average;
		...
		/// </summary>
		public VectorSeriesIkhDataGroupingApproximation Approximation { get; set; }
		private VectorSeriesIkhDataGroupingApproximation Approximation_DefaultValue { get; set; }
