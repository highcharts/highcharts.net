...
{
	public partial class VectorSeriesIkhDataLabels  : BaseObject
	{
		public VectorSeriesIkhDataLabels()
		{
			Align = Align_DefaultValue = VectorSeriesIkhDataLabelsAlign.Center;
			Formatter = Formatter_DefaultValue = "";
			Style = Style_DefaultValue = new VectorSeriesIkhDataLabelsStyle();
			VerticalAlign = VerticalAlign_DefaultValue = VectorSeriesIkhDataLabelsVerticalAlign.Bottom;
			X = X_DefaultValue = 0;
			Y = Y_DefaultValue = -6;
			...
			Overflow = Overflow_DefaultValue = VectorSeriesIkhDataLabelsOverflow.Justify;
		...
		/// </summary>
		public VectorSeriesIkhDataLabelsAlign Align { get; set; }
		private VectorSeriesIkhDataLabelsAlign Align_DefaultValue { get; set; }
		...
		/// </summary>
		public VectorSeriesIkhDataLabelsStyle Style { get; set; }
		private VectorSeriesIkhDataLabelsStyle Style_DefaultValue { get; set; }
		...
		/// </summary>
		public VectorSeriesIkhDataLabelsVerticalAlign VerticalAlign { get; set; }
		private VectorSeriesIkhDataLabelsVerticalAlign VerticalAlign_DefaultValue { get; set; }
		...
		/// </summary>
		public VectorSeriesIkhDataLabelsOverflow Overflow { get; set; }
		private VectorSeriesIkhDataLabelsOverflow Overflow_DefaultValue { get; set; }
		...
		internal override Hashtable ToHashtable()
		{
			...
			if (Formatter != Formatter_DefaultValue) { h.Add("formatter",Formatter); Highstock.AddFunction("VectorSeriesIkhDataLabelsFormatter.formatter", Formatter); }  
