...
{
	public partial class VectorSeriesIkhStatesHover  : BaseObject
	{
		public VectorSeriesIkhStatesHover()
		{
			LineWidthPlus = LineWidthPlus_DefaultValue = 1;
			Marker = Marker_DefaultValue = new VectorSeriesIkhStatesHoverMarker();
			Halo = Halo_DefaultValue = new VectorSeriesIkhStatesHoverHalo();
		...
		/// </summary>
		public VectorSeriesIkhStatesHoverMarker Marker { get; set; }
		private VectorSeriesIkhStatesHoverMarker Marker_DefaultValue { get; set; }
		...
		/// </summary>
		public VectorSeriesIkhStatesHoverHalo Halo { get; set; }
		private VectorSeriesIkhStatesHoverHalo Halo_DefaultValue { get; set; }
