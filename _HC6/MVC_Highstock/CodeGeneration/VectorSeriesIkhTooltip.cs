...
{
	public partial class VectorSeriesIkhTooltip  : BaseObject
	{
		public VectorSeriesIkhTooltip()
		{
			ValueDecimals = ValueDecimals_DefaultValue = null;
			DateTimeLabelFormats = DateTimeLabelFormats_DefaultValue = new VectorSeriesIkhTooltipDateTimeLabelFormats();
		...
		/// </summary>
		public VectorSeriesIkhTooltipDateTimeLabelFormats DateTimeLabelFormats { get; set; }
		private VectorSeriesIkhTooltipDateTimeLabelFormats DateTimeLabelFormats_DefaultValue { get; set; }
		...
		internal override Hashtable ToHashtable()
		{
			...
			if (PointFormatter != PointFormatter_DefaultValue) { h.Add("pointFormatter",PointFormatter); Highstock.AddFunction("VectorSeriesIkhTooltipPointFormatter.pointFormatter", PointFormatter); }  
