...
{
	public partial class VectorSeriesStatesHoverMarker  : BaseObject
	{
		public VectorSeriesStatesHoverMarker()
		{
			...
			States = States_DefaultValue = new VectorSeriesStatesHoverMarkerStates();
		...
		/// </summary>
		public VectorSeriesStatesHoverMarkerStates States { get; set; }
		private VectorSeriesStatesHoverMarkerStates States_DefaultValue { get; set; }
