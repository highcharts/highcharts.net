...
{
	public partial class VectorSeriesStatesSelectMarker  : BaseObject
	{
		public VectorSeriesStatesSelectMarker()
		{
			LineWidth = LineWidth_DefaultValue = 0;
			LineColor = LineColor_DefaultValue = "#ffffff";
			Radius = Radius_DefaultValue = 4;
			States = States_DefaultValue = new VectorSeriesStatesSelectMarkerStates();
		...
		/// </summary>
		public VectorSeriesStatesSelectMarkerStates States { get; set; }
		private VectorSeriesStatesSelectMarkerStates States_DefaultValue { get; set; }
