...
namespace Highsoft.Web.Mvc.Stocks
{
	public partial class VectorSeriesTooltip  : BaseObject
	{
		public VectorSeriesTooltip()
		{
			...
			DateTimeLabelFormats = DateTimeLabelFormats_DefaultValue = new VectorSeriesTooltipDateTimeLabelFormats();
		...
		/// </summary>
		public VectorSeriesTooltipDateTimeLabelFormats DateTimeLabelFormats { get; set; }
		private VectorSeriesTooltipDateTimeLabelFormats DateTimeLabelFormats_DefaultValue { get; set; }
