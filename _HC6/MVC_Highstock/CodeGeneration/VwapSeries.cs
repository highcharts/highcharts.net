...
{
	public partial class VwapSeries  : BaseObject
	{
		public VwapSeries()
		{
			Ikh = Ikh_DefaultValue = new VwapSeriesIkh();
			...
			Zones = Zones_DefaultValue = new VwapSeriesZone();
			...
			PointIntervalUnit = PointIntervalUnit_DefaultValue = VwapSeriesPointIntervalUnit.Null;
			PointPlacement = PointPlacement_DefaultValue = new PointPlacement();
			PointStart = PointStart_DefaultValue = 0;
			Stacking = Stacking_DefaultValue = VwapSeriesStacking.Null;
		...
		/// </summary>
		public VwapSeriesIkh Ikh { get; set; }
		private VwapSeriesIkh Ikh_DefaultValue { get; set; }
		...
		/// </summary>
		public VwapSeriesZone Zones { get; set; }
		private VwapSeriesZone Zones_DefaultValue { get; set; }
		...
		/// </summary>
		public VwapSeriesPointIntervalUnit PointIntervalUnit { get; set; }
		private VwapSeriesPointIntervalUnit PointIntervalUnit_DefaultValue { get; set; }
		...
		/// </summary>
		public VwapSeriesStacking Stacking { get; set; }
		private VwapSeriesStacking Stacking_DefaultValue { get; set; }
