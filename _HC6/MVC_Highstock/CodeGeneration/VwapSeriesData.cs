...
{
	public partial class VwapSeriesData  : BaseObject
	{
		public VwapSeriesData()
		{
			...
			DragDrop = DragDrop_DefaultValue = new VwapSeriesDataDragDrop();
			Drilldown = Drilldown_DefaultValue = "";
			Events = Events_DefaultValue = new VwapSeriesDataEvents();
			Id = Id_DefaultValue = "";
			Labelrank = Labelrank_DefaultValue = null;
			Marker = Marker_DefaultValue = new VwapSeriesDataMarker();
		...
		/// </summary>
		public VwapSeriesDataDragDrop DragDrop { get; set; }
		private VwapSeriesDataDragDrop DragDrop_DefaultValue { get; set; }
		...
		/// </summary>
		public VwapSeriesDataEvents Events { get; set; }
		private VwapSeriesDataEvents Events_DefaultValue { get; set; }
		...
		/// 
		/// </summary>
		public VwapSeriesDataMarker Marker { get; set; }
		private VwapSeriesDataMarker Marker_DefaultValue { get; set; }
