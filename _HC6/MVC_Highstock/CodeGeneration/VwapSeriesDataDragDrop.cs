...
{
	public partial class VwapSeriesDataDragDrop  : BaseObject
	{
		public VwapSeriesDataDragDrop()
		{
			DraggableX = DraggableX_DefaultValue = null;
			DraggableY = DraggableY_DefaultValue = null;
			DragHandle = DragHandle_DefaultValue = new VwapSeriesDataDragDropDragHandle();
			...
			GuideBox = GuideBox_DefaultValue = new VwapSeriesDataDragDropGuideBox();
		...
		/// </summary>
		public VwapSeriesDataDragDropDragHandle DragHandle { get; set; }
		private VwapSeriesDataDragDropDragHandle DragHandle_DefaultValue { get; set; }
		...
		/// </summary>
		public VwapSeriesDataDragDropGuideBox GuideBox { get; set; }
		private VwapSeriesDataDragDropGuideBox GuideBox_DefaultValue { get; set; }
