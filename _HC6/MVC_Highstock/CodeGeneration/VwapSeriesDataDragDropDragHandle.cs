...
{
	public partial class VwapSeriesDataDragDropDragHandle  : BaseObject
	{
		public VwapSeriesDataDragDropDragHandle()
		{
		...
		internal override Hashtable ToHashtable()
		{
			...
			if (PathFormatter != PathFormatter_DefaultValue) { h.Add("pathFormatter",PathFormatter); Highstock.AddFunction("VwapSeriesDataDragDropDragHandlePathFormatter.pathFormatter", PathFormatter); }  
