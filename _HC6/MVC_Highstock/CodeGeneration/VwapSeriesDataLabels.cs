...
namespace Highsoft.Web.Mvc.Stocks
{
	public partial class VwapSeriesDataLabels  : BaseObject
	{
		public VwapSeriesDataLabels()
		{
			...
			Style = Style_DefaultValue = new VwapSeriesDataLabelsStyle();
		...
		/// </summary>
		public VwapSeriesDataLabelsStyle Style { get; set; }
		private VwapSeriesDataLabelsStyle Style_DefaultValue { get; set; }
