...
{
	public partial class VwapSeriesIkh  : BaseObject
	{
		public VwapSeriesIkh()
		{
			Name = Name_DefaultValue = "SMA (14)";
			Tooltip = Tooltip_DefaultValue = new VwapSeriesIkhTooltip();
			LinkedTo = LinkedTo_DefaultValue = null;
			Params = Params_DefaultValue = new VwapSeriesIkhParams();
			Linecap = Linecap_DefaultValue = VwapSeriesIkhLinecap.Round;
			BoostThreshold = BoostThreshold_DefaultValue = 5000;
			GapSize = GapSize_DefaultValue = 0;
			GapUnit = GapUnit_DefaultValue = VwapSeriesIkhGapUnit.Relative;
			Label = Label_DefaultValue = new VwapSeriesIkhLabel();
			DataGrouping = DataGrouping_DefaultValue = new VwapSeriesIkhDataGrouping();
			LineWidth = LineWidth_DefaultValue = 2;
			AllowPointSelect = AllowPointSelect_DefaultValue = false;
			ShowCheckbox = ShowCheckbox_DefaultValue = false;
			Animation = Animation_DefaultValue = new Animation() { Enabled = true };
			Events = Events_DefaultValue = new VwapSeriesIkhEvents();
			Marker = Marker_DefaultValue = new VwapSeriesIkhMarker();
			Point = Point_DefaultValue = new VwapSeriesIkhPoint();
			DataLabels = DataLabels_DefaultValue = new VwapSeriesIkhDataLabels();
			CropThreshold = CropThreshold_DefaultValue = 300;
			SoftThreshold = SoftThreshold_DefaultValue = true;
			States = States_DefaultValue = new VwapSeriesIkhStates();
			StickyTracking = StickyTracking_DefaultValue = null;
			TurboThreshold = TurboThreshold_DefaultValue = 1000;
			FindNearestPointBy = FindNearestPointBy_DefaultValue = VwapSeriesIkhFindNearestPointBy.X;
			AnimationLimit = AnimationLimit_DefaultValue = null;
			ClassName = ClassName_DefaultValue = null;
			Color = Color_DefaultValue = null;
			ColorIndex = ColorIndex_DefaultValue = null;
			ConnectNulls = ConnectNulls_DefaultValue = false;
			Cursor = Cursor_DefaultValue = VwapSeriesIkhCursor.Null;
			DashStyle = DashStyle_DefaultValue = VwapSeriesIkhDashStyle.Solid;
			...
			Step = Step_DefaultValue = VwapSeriesIkhStep.Null;
			Threshold = Threshold_DefaultValue = 0;
			Visible = Visible_DefaultValue = true;
			ZoneAxis = ZoneAxis_DefaultValue = "y";
			Zones = Zones_DefaultValue = new List<VwapSeriesIkhZone>();
			...
			PointIntervalUnit = PointIntervalUnit_DefaultValue = VwapSeriesIkhPointIntervalUnit.Null;
			PointPlacement = PointPlacement_DefaultValue = new PointPlacement();
			PointStart = PointStart_DefaultValue = 0;
			Stacking = Stacking_DefaultValue = VwapSeriesIkhStacking.Null;
			Compare = Compare_DefaultValue = "undefined";
			CompareBase = CompareBase_DefaultValue = VwapSeriesIkhCompareBase.Min;
		...
		/// </summary>
		public VwapSeriesIkhTooltip Tooltip { get; set; }
		private VwapSeriesIkhTooltip Tooltip_DefaultValue { get; set; }
		...
		/// 
		/// </summary>
		public VwapSeriesIkhParams Params { get; set; }
		private VwapSeriesIkhParams Params_DefaultValue { get; set; }
		...
		/// </summary>
		public VwapSeriesIkhLinecap Linecap { get; set; }
		private VwapSeriesIkhLinecap Linecap_DefaultValue { get; set; }
		...
		/// </summary>
		public VwapSeriesIkhGapUnit GapUnit { get; set; }
		private VwapSeriesIkhGapUnit GapUnit_DefaultValue { get; set; }
		...
		/// </summary>
		public VwapSeriesIkhLabel Label { get; set; }
		private VwapSeriesIkhLabel Label_DefaultValue { get; set; }
		...
		/// </summary>
		public VwapSeriesIkhDataGrouping DataGrouping { get; set; }
		private VwapSeriesIkhDataGrouping DataGrouping_DefaultValue { get; set; }
		...
		/// </summary>
		public VwapSeriesIkhEvents Events { get; set; }
		private VwapSeriesIkhEvents Events_DefaultValue { get; set; }
		...
		/// </summary>
		public VwapSeriesIkhMarker Marker { get; set; }
		private VwapSeriesIkhMarker Marker_DefaultValue { get; set; }
		 

		/// <summary>
		/// <p>Properties for each single point.</p>
		/// </summary>
		public VwapSeriesIkhPoint Point { get; set; }
		private VwapSeriesIkhPoint Point_DefaultValue { get; set; }
		...
		/// </summary>
		public VwapSeriesIkhDataLabels DataLabels { get; set; }
		private VwapSeriesIkhDataLabels DataLabels_DefaultValue { get; set; }
		...
		/// </summary>
		public VwapSeriesIkhStates States { get; set; }
		private VwapSeriesIkhStates States_DefaultValue { get; set; }
		...
		/// </summary>
		public VwapSeriesIkhFindNearestPointBy FindNearestPointBy { get; set; }
		private VwapSeriesIkhFindNearestPointBy FindNearestPointBy_DefaultValue { get; set; }
		...
		/// </summary>
		public VwapSeriesIkhCursor Cursor { get; set; }
		private VwapSeriesIkhCursor Cursor_DefaultValue { get; set; }
		...
		/// </summary>
		public VwapSeriesIkhDashStyle DashStyle { get; set; }
		private VwapSeriesIkhDashStyle DashStyle_DefaultValue { get; set; }
		...
		/// </summary>
		public VwapSeriesIkhStep Step { get; set; }
		private VwapSeriesIkhStep Step_DefaultValue { get; set; }
		...
		/// </summary>
		public List<VwapSeriesIkhZone> Zones { get; set; }
		private List<VwapSeriesIkhZone> Zones_DefaultValue { get; set; }
		...
		/// </summary>
		public VwapSeriesIkhPointIntervalUnit PointIntervalUnit { get; set; }
		private VwapSeriesIkhPointIntervalUnit PointIntervalUnit_DefaultValue { get; set; }
		...
		/// </summary>
		public VwapSeriesIkhStacking Stacking { get; set; }
		private VwapSeriesIkhStacking Stacking_DefaultValue { get; set; }
		...
		/// </summary>
		public VwapSeriesIkhCompareBase CompareBase { get; set; }
		private VwapSeriesIkhCompareBase CompareBase_DefaultValue { get; set; }
		...
		internal override Hashtable ToHashtable()
		{
			...
			if (PointDescriptionFormatter != PointDescriptionFormatter_DefaultValue) { h.Add("pointDescriptionFormatter",PointDescriptionFormatter); Highstock.AddFunction("VwapSeriesIkhPointDescriptionFormatter.pointDescriptionFormatter", PointDescriptionFormatter); }  
