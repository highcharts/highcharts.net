...
{
	public partial class VwapSeriesIkhDataGrouping  : BaseObject
	{
		public VwapSeriesIkhDataGrouping()
		{
			Approximation = Approximation_DefaultValue = VwapSeriesIkhDataGroupingApproximation.Average;
		...
		/// </summary>
		public VwapSeriesIkhDataGroupingApproximation Approximation { get; set; }
		private VwapSeriesIkhDataGroupingApproximation Approximation_DefaultValue { get; set; }
