...
{
	public partial class VwapSeriesIkhDataLabels  : BaseObject
	{
		public VwapSeriesIkhDataLabels()
		{
			Align = Align_DefaultValue = VwapSeriesIkhDataLabelsAlign.Center;
			Formatter = Formatter_DefaultValue = "";
			Style = Style_DefaultValue = new VwapSeriesIkhDataLabelsStyle();
			VerticalAlign = VerticalAlign_DefaultValue = VwapSeriesIkhDataLabelsVerticalAlign.Bottom;
			X = X_DefaultValue = 0;
			Y = Y_DefaultValue = -6;
			...
			Overflow = Overflow_DefaultValue = VwapSeriesIkhDataLabelsOverflow.Justify;
		...
		/// </summary>
		public VwapSeriesIkhDataLabelsAlign Align { get; set; }
		private VwapSeriesIkhDataLabelsAlign Align_DefaultValue { get; set; }
		...
		/// </summary>
		public VwapSeriesIkhDataLabelsStyle Style { get; set; }
		private VwapSeriesIkhDataLabelsStyle Style_DefaultValue { get; set; }
		...
		/// </summary>
		public VwapSeriesIkhDataLabelsVerticalAlign VerticalAlign { get; set; }
		private VwapSeriesIkhDataLabelsVerticalAlign VerticalAlign_DefaultValue { get; set; }
		...
		/// </summary>
		public VwapSeriesIkhDataLabelsOverflow Overflow { get; set; }
		private VwapSeriesIkhDataLabelsOverflow Overflow_DefaultValue { get; set; }
		...
		internal override Hashtable ToHashtable()
		{
			...
			if (Formatter != Formatter_DefaultValue) { h.Add("formatter",Formatter); Highstock.AddFunction("VwapSeriesIkhDataLabelsFormatter.formatter", Formatter); }  
