...
{
	public partial class VwapSeriesIkhStatesHover  : BaseObject
	{
		public VwapSeriesIkhStatesHover()
		{
			LineWidthPlus = LineWidthPlus_DefaultValue = 1;
			Marker = Marker_DefaultValue = new VwapSeriesIkhStatesHoverMarker();
			Halo = Halo_DefaultValue = new VwapSeriesIkhStatesHoverHalo();
		...
		/// </summary>
		public VwapSeriesIkhStatesHoverMarker Marker { get; set; }
		private VwapSeriesIkhStatesHoverMarker Marker_DefaultValue { get; set; }
		...
		/// </summary>
		public VwapSeriesIkhStatesHoverHalo Halo { get; set; }
		private VwapSeriesIkhStatesHoverHalo Halo_DefaultValue { get; set; }
