...
{
	public partial class VwapSeriesIkhTooltip  : BaseObject
	{
		public VwapSeriesIkhTooltip()
		{
			ValueDecimals = ValueDecimals_DefaultValue = null;
			DateTimeLabelFormats = DateTimeLabelFormats_DefaultValue = new VwapSeriesIkhTooltipDateTimeLabelFormats();
		...
		/// </summary>
		public VwapSeriesIkhTooltipDateTimeLabelFormats DateTimeLabelFormats { get; set; }
		private VwapSeriesIkhTooltipDateTimeLabelFormats DateTimeLabelFormats_DefaultValue { get; set; }
		...
		internal override Hashtable ToHashtable()
		{
			...
			if (PointFormatter != PointFormatter_DefaultValue) { h.Add("pointFormatter",PointFormatter); Highstock.AddFunction("VwapSeriesIkhTooltipPointFormatter.pointFormatter", PointFormatter); }  
