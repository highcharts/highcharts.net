...
{
	public partial class VwapSeriesStatesHover  : BaseObject
	{
		public VwapSeriesStatesHover()
		{
			LineWidthPlus = LineWidthPlus_DefaultValue = 1;
			Marker = Marker_DefaultValue = new VwapSeriesStatesHoverMarker();
			Halo = Halo_DefaultValue = new VwapSeriesStatesHoverHalo();
		...
		/// </summary>
		public VwapSeriesStatesHoverMarker Marker { get; set; }
		private VwapSeriesStatesHoverMarker Marker_DefaultValue { get; set; }
		...
		/// </summary>
		public VwapSeriesStatesHoverHalo Halo { get; set; }
		private VwapSeriesStatesHoverHalo Halo_DefaultValue { get; set; }
