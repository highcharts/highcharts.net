...
{
	public partial class VwapSeriesStatesHoverMarker  : BaseObject
	{
		public VwapSeriesStatesHoverMarker()
		{
			...
			States = States_DefaultValue = new VwapSeriesStatesHoverMarkerStates();
		...
		/// </summary>
		public VwapSeriesStatesHoverMarkerStates States { get; set; }
		private VwapSeriesStatesHoverMarkerStates States_DefaultValue { get; set; }
