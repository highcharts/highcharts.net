...
namespace Highsoft.Web.Mvc.Stocks
{
	public partial class VwapSeriesTooltip  : BaseObject
	{
		public VwapSeriesTooltip()
		{
			...
			DateTimeLabelFormats = DateTimeLabelFormats_DefaultValue = new VwapSeriesTooltipDateTimeLabelFormats();
		...
		/// </summary>
		public VwapSeriesTooltipDateTimeLabelFormats DateTimeLabelFormats { get; set; }
		private VwapSeriesTooltipDateTimeLabelFormats DateTimeLabelFormats_DefaultValue { get; set; }
