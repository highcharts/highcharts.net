...
{
	public partial class WaterfallSeriesDataGrouping  : BaseObject
	{
		...
		/// </summary>
		public WaterfallSeriesDataGroupingApproximation Approximation { get; set; }
		private WaterfallSeriesDataGroupingApproximation Approximation_DefaultValue { get; set; }
