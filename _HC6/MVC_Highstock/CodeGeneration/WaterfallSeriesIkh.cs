...
{
	public partial class WaterfallSeriesIkh  : BaseObject
	{
		public WaterfallSeriesIkh()
		{
			Name = Name_DefaultValue = "SMA (14)";
			Tooltip = Tooltip_DefaultValue = new WaterfallSeriesIkhTooltip();
			LinkedTo = LinkedTo_DefaultValue = null;
			Params = Params_DefaultValue = new WaterfallSeriesIkhParams();
			Linecap = Linecap_DefaultValue = WaterfallSeriesIkhLinecap.Round;
			BoostThreshold = BoostThreshold_DefaultValue = 5000;
			GapSize = GapSize_DefaultValue = 0;
			GapUnit = GapUnit_DefaultValue = WaterfallSeriesIkhGapUnit.Relative;
			Label = Label_DefaultValue = new WaterfallSeriesIkhLabel();
			DataGrouping = DataGrouping_DefaultValue = new WaterfallSeriesIkhDataGrouping();
			LineWidth = LineWidth_DefaultValue = 2;
			AllowPointSelect = AllowPointSelect_DefaultValue = false;
			ShowCheckbox = ShowCheckbox_DefaultValue = false;
			Animation = Animation_DefaultValue = new Animation() { Enabled = true };
			Events = Events_DefaultValue = new WaterfallSeriesIkhEvents();
			Marker = Marker_DefaultValue = new WaterfallSeriesIkhMarker();
			Point = Point_DefaultValue = new WaterfallSeriesIkhPoint();
			DataLabels = DataLabels_DefaultValue = new WaterfallSeriesIkhDataLabels();
			CropThreshold = CropThreshold_DefaultValue = 300;
			SoftThreshold = SoftThreshold_DefaultValue = true;
			States = States_DefaultValue = new WaterfallSeriesIkhStates();
			StickyTracking = StickyTracking_DefaultValue = null;
			TurboThreshold = TurboThreshold_DefaultValue = 1000;
			FindNearestPointBy = FindNearestPointBy_DefaultValue = WaterfallSeriesIkhFindNearestPointBy.X;
			AnimationLimit = AnimationLimit_DefaultValue = null;
			ClassName = ClassName_DefaultValue = null;
			Color = Color_DefaultValue = null;
			ColorIndex = ColorIndex_DefaultValue = null;
			ConnectNulls = ConnectNulls_DefaultValue = false;
			Cursor = Cursor_DefaultValue = WaterfallSeriesIkhCursor.Null;
			DashStyle = DashStyle_DefaultValue = WaterfallSeriesIkhDashStyle.Solid;
			...
			Step = Step_DefaultValue = WaterfallSeriesIkhStep.Null;
			Threshold = Threshold_DefaultValue = 0;
			Visible = Visible_DefaultValue = true;
			ZoneAxis = ZoneAxis_DefaultValue = "y";
			Zones = Zones_DefaultValue = new List<WaterfallSeriesIkhZone>();
			...
			PointIntervalUnit = PointIntervalUnit_DefaultValue = WaterfallSeriesIkhPointIntervalUnit.Null;
			PointPlacement = PointPlacement_DefaultValue = new PointPlacement();
			PointStart = PointStart_DefaultValue = 0;
			Stacking = Stacking_DefaultValue = WaterfallSeriesIkhStacking.Null;
			Compare = Compare_DefaultValue = "undefined";
			CompareBase = CompareBase_DefaultValue = WaterfallSeriesIkhCompareBase.Min;
		...
		/// </summary>
		public WaterfallSeriesIkhTooltip Tooltip { get; set; }
		private WaterfallSeriesIkhTooltip Tooltip_DefaultValue { get; set; }
		...
		/// 
		/// </summary>
		public WaterfallSeriesIkhParams Params { get; set; }
		private WaterfallSeriesIkhParams Params_DefaultValue { get; set; }
		...
		/// </summary>
		public WaterfallSeriesIkhLinecap Linecap { get; set; }
		private WaterfallSeriesIkhLinecap Linecap_DefaultValue { get; set; }
		...
		/// </summary>
		public WaterfallSeriesIkhGapUnit GapUnit { get; set; }
		private WaterfallSeriesIkhGapUnit GapUnit_DefaultValue { get; set; }
		...
		/// </summary>
		public WaterfallSeriesIkhLabel Label { get; set; }
		private WaterfallSeriesIkhLabel Label_DefaultValue { get; set; }
		...
		/// </summary>
		public WaterfallSeriesIkhDataGrouping DataGrouping { get; set; }
		private WaterfallSeriesIkhDataGrouping DataGrouping_DefaultValue { get; set; }
		...
		/// </summary>
		public WaterfallSeriesIkhEvents Events { get; set; }
		private WaterfallSeriesIkhEvents Events_DefaultValue { get; set; }
		...
		/// </summary>
		public WaterfallSeriesIkhMarker Marker { get; set; }
		private WaterfallSeriesIkhMarker Marker_DefaultValue { get; set; }
		 

		/// <summary>
		/// <p>Properties for each single point.</p>
		/// </summary>
		public WaterfallSeriesIkhPoint Point { get; set; }
		private WaterfallSeriesIkhPoint Point_DefaultValue { get; set; }
		...
		/// </summary>
		public WaterfallSeriesIkhDataLabels DataLabels { get; set; }
		private WaterfallSeriesIkhDataLabels DataLabels_DefaultValue { get; set; }
		...
		/// </summary>
		public WaterfallSeriesIkhStates States { get; set; }
		private WaterfallSeriesIkhStates States_DefaultValue { get; set; }
		...
		/// </summary>
		public WaterfallSeriesIkhFindNearestPointBy FindNearestPointBy { get; set; }
		private WaterfallSeriesIkhFindNearestPointBy FindNearestPointBy_DefaultValue { get; set; }
		...
		/// </summary>
		public WaterfallSeriesIkhCursor Cursor { get; set; }
		private WaterfallSeriesIkhCursor Cursor_DefaultValue { get; set; }
		...
		/// </summary>
		public WaterfallSeriesIkhDashStyle DashStyle { get; set; }
		private WaterfallSeriesIkhDashStyle DashStyle_DefaultValue { get; set; }
		...
		/// </summary>
		public WaterfallSeriesIkhStep Step { get; set; }
		private WaterfallSeriesIkhStep Step_DefaultValue { get; set; }
		...
		/// </summary>
		public List<WaterfallSeriesIkhZone> Zones { get; set; }
		private List<WaterfallSeriesIkhZone> Zones_DefaultValue { get; set; }
		...
		/// </summary>
		public WaterfallSeriesIkhPointIntervalUnit PointIntervalUnit { get; set; }
		private WaterfallSeriesIkhPointIntervalUnit PointIntervalUnit_DefaultValue { get; set; }
		...
		/// </summary>
		public WaterfallSeriesIkhStacking Stacking { get; set; }
		private WaterfallSeriesIkhStacking Stacking_DefaultValue { get; set; }
		...
		/// </summary>
		public WaterfallSeriesIkhCompareBase CompareBase { get; set; }
		private WaterfallSeriesIkhCompareBase CompareBase_DefaultValue { get; set; }
		...
		internal override Hashtable ToHashtable()
		{
			...
			if (PointDescriptionFormatter != PointDescriptionFormatter_DefaultValue) { h.Add("pointDescriptionFormatter",PointDescriptionFormatter); Highstock.AddFunction("WaterfallSeriesIkhPointDescriptionFormatter.pointDescriptionFormatter", PointDescriptionFormatter); }  
