...
namespace Highsoft.Web.Mvc.Stocks
{
	public partial class WaterfallSeriesIkh  : BaseObject
	{
		public WaterfallSeriesIkh()
		{
			...
			Zones = Zones_DefaultValue = new WaterfallSeriesIkhZone();
		...
		/// </summary>
		public WaterfallSeriesIkhZone Zones { get; set; }
		private WaterfallSeriesIkhZone Zones_DefaultValue { get; set; }
