...
{
	public partial class WaterfallSeriesIkhDataGrouping  : BaseObject
	{
		public WaterfallSeriesIkhDataGrouping()
		{
			Approximation = Approximation_DefaultValue = WaterfallSeriesIkhDataGroupingApproximation.Average;
		...
		/// </summary>
		public WaterfallSeriesIkhDataGroupingApproximation Approximation { get; set; }
		private WaterfallSeriesIkhDataGroupingApproximation Approximation_DefaultValue { get; set; }
