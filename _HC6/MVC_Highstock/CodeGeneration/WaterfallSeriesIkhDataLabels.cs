...
{
	public partial class WaterfallSeriesIkhDataLabels  : BaseObject
	{
		public WaterfallSeriesIkhDataLabels()
		{
			Align = Align_DefaultValue = WaterfallSeriesIkhDataLabelsAlign.Center;
			Formatter = Formatter_DefaultValue = "";
			Style = Style_DefaultValue = new WaterfallSeriesIkhDataLabelsStyle();
			VerticalAlign = VerticalAlign_DefaultValue = WaterfallSeriesIkhDataLabelsVerticalAlign.Bottom;
			X = X_DefaultValue = 0;
			Y = Y_DefaultValue = -6;
			...
			Overflow = Overflow_DefaultValue = WaterfallSeriesIkhDataLabelsOverflow.Justify;
		...
		/// </summary>
		public WaterfallSeriesIkhDataLabelsAlign Align { get; set; }
		private WaterfallSeriesIkhDataLabelsAlign Align_DefaultValue { get; set; }
		...
		/// </summary>
		public WaterfallSeriesIkhDataLabelsStyle Style { get; set; }
		private WaterfallSeriesIkhDataLabelsStyle Style_DefaultValue { get; set; }
		...
		/// </summary>
		public WaterfallSeriesIkhDataLabelsVerticalAlign VerticalAlign { get; set; }
		private WaterfallSeriesIkhDataLabelsVerticalAlign VerticalAlign_DefaultValue { get; set; }
		...
		/// </summary>
		public WaterfallSeriesIkhDataLabelsOverflow Overflow { get; set; }
		private WaterfallSeriesIkhDataLabelsOverflow Overflow_DefaultValue { get; set; }
		...
		internal override Hashtable ToHashtable()
		{
			...
			if (Formatter != Formatter_DefaultValue) { h.Add("formatter",Formatter); Highstock.AddFunction("WaterfallSeriesIkhDataLabelsFormatter.formatter", Formatter); }  
