...
{
	public partial class WaterfallSeriesIkhStatesHover  : BaseObject
	{
		public WaterfallSeriesIkhStatesHover()
		{
			LineWidthPlus = LineWidthPlus_DefaultValue = 1;
			Marker = Marker_DefaultValue = new WaterfallSeriesIkhStatesHoverMarker();
			Halo = Halo_DefaultValue = new WaterfallSeriesIkhStatesHoverHalo();
		...
		/// </summary>
		public WaterfallSeriesIkhStatesHoverMarker Marker { get; set; }
		private WaterfallSeriesIkhStatesHoverMarker Marker_DefaultValue { get; set; }
		...
		/// </summary>
		public WaterfallSeriesIkhStatesHoverHalo Halo { get; set; }
		private WaterfallSeriesIkhStatesHoverHalo Halo_DefaultValue { get; set; }
