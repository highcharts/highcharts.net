...
{
	public partial class WaterfallSeriesIkhTooltip  : BaseObject
	{
		public WaterfallSeriesIkhTooltip()
		{
			ValueDecimals = ValueDecimals_DefaultValue = null;
			DateTimeLabelFormats = DateTimeLabelFormats_DefaultValue = new WaterfallSeriesIkhTooltipDateTimeLabelFormats();
		...
		/// </summary>
		public WaterfallSeriesIkhTooltipDateTimeLabelFormats DateTimeLabelFormats { get; set; }
		private WaterfallSeriesIkhTooltipDateTimeLabelFormats DateTimeLabelFormats_DefaultValue { get; set; }
		...
		internal override Hashtable ToHashtable()
		{
			...
			if (PointFormatter != PointFormatter_DefaultValue) { h.Add("pointFormatter",PointFormatter); Highstock.AddFunction("WaterfallSeriesIkhTooltipPointFormatter.pointFormatter", PointFormatter); }  
