...
namespace Highsoft.Web.Mvc.Stocks
{
	public partial class WindbarbSeries  : Series
	{
		public WindbarbSeries()
		{
			...
			Tooltip = Tooltip_DefaultValue = new WindbarbSeriesTooltip();
			VectorLength = VectorLength_DefaultValue = null;
			YOffset = YOffset_DefaultValue = null;
			...
			Label = Label_DefaultValue = new WindbarbSeriesLabel();
			...
			Events = Events_DefaultValue = new WindbarbSeriesEvents();
			...
			Zones = Zones_DefaultValue = new List<WindbarbSeriesZone>();
			Compare = Compare_DefaultValue = "undefined";
			CompareStart = CompareStart_DefaultValue = null;
			CompareBase = CompareBase_DefaultValue = WindbarbSeriesCompareBase.Min;
			BoostThreshold = BoostThreshold_DefaultValue = 5000;
			GapSize = GapSize_DefaultValue = 0;
			GapUnit = GapUnit_DefaultValue = WindbarbSeriesGapUnit.Relative;
			DataGrouping = DataGrouping_DefaultValue = new WindbarbSeriesDataGrouping();
			Marker = Marker_DefaultValue = new WindbarbSeriesMarker();
			CropThreshold = CropThreshold_DefaultValue = 300;
			ConnectNulls = ConnectNulls_DefaultValue = false;
			DashStyle = DashStyle_DefaultValue = WindbarbSeriesDashStyle.Solid;
			Linecap = Linecap_DefaultValue = WindbarbSeriesLinecap.Round;
			Shadow = Shadow_DefaultValue = new Shadow() { Enabled = false };
			Stacking = Stacking_DefaultValue = WindbarbSeriesStacking.Null;
			Step = Step_DefaultValue = WindbarbSeriesStep.Null;
		...
		/// <summary>
		/// <p>An array of data points for the series. For the <code>windbarb</code> series type,points can be given in the following ways:</p><ol><li><p>An array of arrays with 3 values. In this case, the values correspondto <code>x,value,direction</code>. If the first value is a string, it is applied asthe name of the point, and the <code>x</code> value is inferred.</p><pre><code class="lang-js">data: [    [Date.UTC(2017, 0, 1, 0), 3.3, 90],    [Date.UTC(2017, 0, 1, 1), 12.1, 180],    [Date.UTC(2017, 0, 1, 2), 11.1, 270]]</code></pre></li><li><p>An array of objects with named values. The objects are pointconfiguration objects as seen below. If the total number of datapoints exceeds the series&#39; <a href="#series.area.turboThreshold">turboThreshold</a>,this option is not available.</p><pre><code class="lang-js">data: [{    x: Date.UTC(2017, 0, 1, 0),    value: 12.1,    direction: 90}, {    x: Date.UTC(2017, 0, 1, 1),    value: 11.1,    direction: 270}]</code></pre></li></ol>
		/// </summary>
		...
		/// </summary>
		public WindbarbSeriesIkh Ikh { get; set; }
		private WindbarbSeriesIkh Ikh_DefaultValue { get; set; }
		...
		/// <summary>
		/// <p>The id of another series in the chart that the wind barbs are projectedon. When <code>null</code>, the wind symbols are drawn on the X axis, but offsetup or down by the <code>yOffset</code> setting.</p>
		/// </summary>
		...
		/// </summary>
		public WindbarbSeriesStates States { get; set; }
		private WindbarbSeriesStates States_DefaultValue { get; set; }
		...
		/// </summary>
		public WindbarbSeriesTooltip Tooltip { get; set; }
		private WindbarbSeriesTooltip Tooltip_DefaultValue { get; set; }
		...
		/// <summary>
		/// <p>Vertical offset from the cartesian position, in pixels. The default valuemakes sure the symbols don&#39;t overlap the X axis when <code>onSeries</code> is<code>null</code>, and that they don&#39;t overlap the linked series when <code>onSeries</code> isgiven.</p>
		/// </summary>
		...
		/// </summary>
		public WindbarbSeriesLabel Label { get; set; }
		private WindbarbSeriesLabel Label_DefaultValue { get; set; }
		...
		/// </summary>
		public WindbarbSeriesEvents Events { get; set; }
		private WindbarbSeriesEvents Events_DefaultValue { get; set; }
		 

		/// <summary>
		/// <p>Properties for each single point.</p>
		/// </summary>
		public WindbarbSeriesPoint Point { get; set; }
		private WindbarbSeriesPoint Point_DefaultValue { get; set; }
		...
		/// </summary>
		public List<WindbarbSeriesZone> Zones { get; set; }
		private List<WindbarbSeriesZone> Zones_DefaultValue { get; set; }
		...
		/// </summary>
		public WindbarbSeriesCompareBase CompareBase { get; set; }
		private WindbarbSeriesCompareBase CompareBase_DefaultValue { get; set; }
		...
		/// </summary>
		public WindbarbSeriesGapUnit GapUnit { get; set; }
		private WindbarbSeriesGapUnit GapUnit_DefaultValue { get; set; }
		...
		/// </summary>
		public WindbarbSeriesMarker Marker { get; set; }
		private WindbarbSeriesMarker Marker_DefaultValue { get; set; }
		...
		/// </summary>
		public WindbarbSeriesDashStyle DashStyle { get; set; }
		private WindbarbSeriesDashStyle DashStyle_DefaultValue { get; set; }
		 

		/// <summary>
		/// <p>The line cap used for line ends and line joins on the graph.</p>
		/// </summary>
		public WindbarbSeriesLinecap Linecap { get; set; }
		private WindbarbSeriesLinecap Linecap_DefaultValue { get; set; }
		...
		/// </summary>
		public WindbarbSeriesStacking Stacking { get; set; }
		private WindbarbSeriesStacking Stacking_DefaultValue { get; set; }
		 

		/// <summary>
		/// <p>Whether to apply steps to the line. Possible values are <code>left</code>, <code>center</code>and <code>right</code>.</p>
		/// </summary>
		public WindbarbSeriesStep Step { get; set; }
		private WindbarbSeriesStep Step_DefaultValue { get; set; }
		...
		internal override Hashtable ToHashtable()
		{
			...
			if (PointDescriptionFormatter != PointDescriptionFormatter_DefaultValue) { h.Add("pointDescriptionFormatter",PointDescriptionFormatter); Highstock.AddFunction("WindbarbSeriesPointDescriptionFormatter.pointDescriptionFormatter", PointDescriptionFormatter); }  
