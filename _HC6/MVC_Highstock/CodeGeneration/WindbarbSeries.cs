...
namespace Highsoft.Web.Mvc.Stocks
{
	public partial class WindbarbSeries  : Series
	{
		public WindbarbSeries()
		{
			...
			NavigatorOptions = NavigatorOptions_DefaultValue = new WindbarbSeriesNavigatorOptions();
		...
		/// </summary>
		public WindbarbSeriesNavigatorOptions NavigatorOptions { get; set; }
		private WindbarbSeriesNavigatorOptions NavigatorOptions_DefaultValue { get; set; }
