...
namespace Highsoft.Web.Mvc.Stocks
{
	public partial class WindbarbSeriesDataGrouping  : BaseObject
	{
		...
		/// </summary>
		public WindbarbSeriesDataGroupingApproximation Approximation { get; set; }
		private WindbarbSeriesDataGroupingApproximation Approximation_DefaultValue { get; set; }
