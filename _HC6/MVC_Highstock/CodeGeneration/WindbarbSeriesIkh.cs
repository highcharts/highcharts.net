...
{
	public partial class WindbarbSeriesIkh  : BaseObject
	{
		public WindbarbSeriesIkh()
		{
			Name = Name_DefaultValue = "SMA (14)";
			Tooltip = Tooltip_DefaultValue = new WindbarbSeriesIkhTooltip();
			LinkedTo = LinkedTo_DefaultValue = null;
			Params = Params_DefaultValue = new WindbarbSeriesIkhParams();
			Linecap = Linecap_DefaultValue = WindbarbSeriesIkhLinecap.Round;
			BoostThreshold = BoostThreshold_DefaultValue = 5000;
			GapSize = GapSize_DefaultValue = 0;
			GapUnit = GapUnit_DefaultValue = WindbarbSeriesIkhGapUnit.Relative;
			Label = Label_DefaultValue = new WindbarbSeriesIkhLabel();
			DataGrouping = DataGrouping_DefaultValue = new WindbarbSeriesIkhDataGrouping();
			LineWidth = LineWidth_DefaultValue = 2;
			AllowPointSelect = AllowPointSelect_DefaultValue = false;
			ShowCheckbox = ShowCheckbox_DefaultValue = false;
			Animation = Animation_DefaultValue = new Animation() { Enabled = true };
			Events = Events_DefaultValue = new WindbarbSeriesIkhEvents();
			Marker = Marker_DefaultValue = new WindbarbSeriesIkhMarker();
			Point = Point_DefaultValue = new WindbarbSeriesIkhPoint();
			DataLabels = DataLabels_DefaultValue = new WindbarbSeriesIkhDataLabels();
			CropThreshold = CropThreshold_DefaultValue = 300;
			SoftThreshold = SoftThreshold_DefaultValue = true;
			States = States_DefaultValue = new WindbarbSeriesIkhStates();
			StickyTracking = StickyTracking_DefaultValue = null;
			TurboThreshold = TurboThreshold_DefaultValue = 1000;
			FindNearestPointBy = FindNearestPointBy_DefaultValue = WindbarbSeriesIkhFindNearestPointBy.X;
			AnimationLimit = AnimationLimit_DefaultValue = null;
			ClassName = ClassName_DefaultValue = null;
			Color = Color_DefaultValue = null;
			ColorIndex = ColorIndex_DefaultValue = null;
			ConnectNulls = ConnectNulls_DefaultValue = false;
			Cursor = Cursor_DefaultValue = WindbarbSeriesIkhCursor.Null;
			DashStyle = DashStyle_DefaultValue = WindbarbSeriesIkhDashStyle.Solid;
			...
			Step = Step_DefaultValue = WindbarbSeriesIkhStep.Null;
			Threshold = Threshold_DefaultValue = 0;
			Visible = Visible_DefaultValue = true;
			ZoneAxis = ZoneAxis_DefaultValue = "y";
			Zones = Zones_DefaultValue = new List<WindbarbSeriesIkhZone>();
			...
			PointIntervalUnit = PointIntervalUnit_DefaultValue = WindbarbSeriesIkhPointIntervalUnit.Null;
			PointPlacement = PointPlacement_DefaultValue = new PointPlacement();
			PointStart = PointStart_DefaultValue = 0;
			Stacking = Stacking_DefaultValue = WindbarbSeriesIkhStacking.Null;
			Compare = Compare_DefaultValue = "undefined";
			CompareBase = CompareBase_DefaultValue = WindbarbSeriesIkhCompareBase.Min;
		...
		/// </summary>
		public WindbarbSeriesIkhTooltip Tooltip { get; set; }
		private WindbarbSeriesIkhTooltip Tooltip_DefaultValue { get; set; }
		...
		/// 
		/// </summary>
		public WindbarbSeriesIkhParams Params { get; set; }
		private WindbarbSeriesIkhParams Params_DefaultValue { get; set; }
		...
		/// </summary>
		public WindbarbSeriesIkhLinecap Linecap { get; set; }
		private WindbarbSeriesIkhLinecap Linecap_DefaultValue { get; set; }
		...
		/// </summary>
		public WindbarbSeriesIkhGapUnit GapUnit { get; set; }
		private WindbarbSeriesIkhGapUnit GapUnit_DefaultValue { get; set; }
		...
		/// </summary>
		public WindbarbSeriesIkhLabel Label { get; set; }
		private WindbarbSeriesIkhLabel Label_DefaultValue { get; set; }
		...
		/// </summary>
		public WindbarbSeriesIkhDataGrouping DataGrouping { get; set; }
		private WindbarbSeriesIkhDataGrouping DataGrouping_DefaultValue { get; set; }
		...
		/// </summary>
		public WindbarbSeriesIkhEvents Events { get; set; }
		private WindbarbSeriesIkhEvents Events_DefaultValue { get; set; }
		...
		/// </summary>
		public WindbarbSeriesIkhMarker Marker { get; set; }
		private WindbarbSeriesIkhMarker Marker_DefaultValue { get; set; }
		 

		/// <summary>
		/// <p>Properties for each single point.</p>
		/// </summary>
		public WindbarbSeriesIkhPoint Point { get; set; }
		private WindbarbSeriesIkhPoint Point_DefaultValue { get; set; }
		...
		/// </summary>
		public WindbarbSeriesIkhDataLabels DataLabels { get; set; }
		private WindbarbSeriesIkhDataLabels DataLabels_DefaultValue { get; set; }
		...
		/// </summary>
		public WindbarbSeriesIkhStates States { get; set; }
		private WindbarbSeriesIkhStates States_DefaultValue { get; set; }
		...
		/// </summary>
		public WindbarbSeriesIkhFindNearestPointBy FindNearestPointBy { get; set; }
		private WindbarbSeriesIkhFindNearestPointBy FindNearestPointBy_DefaultValue { get; set; }
		...
		/// </summary>
		public WindbarbSeriesIkhCursor Cursor { get; set; }
		private WindbarbSeriesIkhCursor Cursor_DefaultValue { get; set; }
		...
		/// </summary>
		public WindbarbSeriesIkhDashStyle DashStyle { get; set; }
		private WindbarbSeriesIkhDashStyle DashStyle_DefaultValue { get; set; }
		...
		/// </summary>
		public WindbarbSeriesIkhStep Step { get; set; }
		private WindbarbSeriesIkhStep Step_DefaultValue { get; set; }
		...
		/// </summary>
		public List<WindbarbSeriesIkhZone> Zones { get; set; }
		private List<WindbarbSeriesIkhZone> Zones_DefaultValue { get; set; }
		...
		/// </summary>
		public WindbarbSeriesIkhPointIntervalUnit PointIntervalUnit { get; set; }
		private WindbarbSeriesIkhPointIntervalUnit PointIntervalUnit_DefaultValue { get; set; }
		...
		/// </summary>
		public WindbarbSeriesIkhStacking Stacking { get; set; }
		private WindbarbSeriesIkhStacking Stacking_DefaultValue { get; set; }
		...
		/// </summary>
		public WindbarbSeriesIkhCompareBase CompareBase { get; set; }
		private WindbarbSeriesIkhCompareBase CompareBase_DefaultValue { get; set; }
		...
		internal override Hashtable ToHashtable()
		{
			...
			if (PointDescriptionFormatter != PointDescriptionFormatter_DefaultValue) { h.Add("pointDescriptionFormatter",PointDescriptionFormatter); Highstock.AddFunction("WindbarbSeriesIkhPointDescriptionFormatter.pointDescriptionFormatter", PointDescriptionFormatter); }  
