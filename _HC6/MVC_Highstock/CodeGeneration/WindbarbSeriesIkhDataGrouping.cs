...
{
	public partial class WindbarbSeriesIkhDataGrouping  : BaseObject
	{
		public WindbarbSeriesIkhDataGrouping()
		{
			Approximation = Approximation_DefaultValue = WindbarbSeriesIkhDataGroupingApproximation.Average;
		...
		/// </summary>
		public WindbarbSeriesIkhDataGroupingApproximation Approximation { get; set; }
		private WindbarbSeriesIkhDataGroupingApproximation Approximation_DefaultValue { get; set; }
