...
{
	public partial class WindbarbSeriesIkhDataLabels  : BaseObject
	{
		public WindbarbSeriesIkhDataLabels()
		{
			Align = Align_DefaultValue = WindbarbSeriesIkhDataLabelsAlign.Center;
			Formatter = Formatter_DefaultValue = "";
			Style = Style_DefaultValue = new WindbarbSeriesIkhDataLabelsStyle();
			VerticalAlign = VerticalAlign_DefaultValue = WindbarbSeriesIkhDataLabelsVerticalAlign.Bottom;
			X = X_DefaultValue = 0;
			Y = Y_DefaultValue = -6;
			...
			Overflow = Overflow_DefaultValue = WindbarbSeriesIkhDataLabelsOverflow.Justify;
		...
		/// </summary>
		public WindbarbSeriesIkhDataLabelsAlign Align { get; set; }
		private WindbarbSeriesIkhDataLabelsAlign Align_DefaultValue { get; set; }
		...
		/// </summary>
		public WindbarbSeriesIkhDataLabelsStyle Style { get; set; }
		private WindbarbSeriesIkhDataLabelsStyle Style_DefaultValue { get; set; }
		...
		/// </summary>
		public WindbarbSeriesIkhDataLabelsVerticalAlign VerticalAlign { get; set; }
		private WindbarbSeriesIkhDataLabelsVerticalAlign VerticalAlign_DefaultValue { get; set; }
		...
		/// </summary>
		public WindbarbSeriesIkhDataLabelsOverflow Overflow { get; set; }
		private WindbarbSeriesIkhDataLabelsOverflow Overflow_DefaultValue { get; set; }
		...
		internal override Hashtable ToHashtable()
		{
			...
			if (Formatter != Formatter_DefaultValue) { h.Add("formatter",Formatter); Highstock.AddFunction("WindbarbSeriesIkhDataLabelsFormatter.formatter", Formatter); }  
