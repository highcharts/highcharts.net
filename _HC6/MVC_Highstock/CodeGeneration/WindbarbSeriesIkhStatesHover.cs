...
{
	public partial class WindbarbSeriesIkhStatesHover  : BaseObject
	{
		public WindbarbSeriesIkhStatesHover()
		{
			LineWidthPlus = LineWidthPlus_DefaultValue = 1;
			Marker = Marker_DefaultValue = new WindbarbSeriesIkhStatesHoverMarker();
			Halo = Halo_DefaultValue = new WindbarbSeriesIkhStatesHoverHalo();
		...
		/// </summary>
		public WindbarbSeriesIkhStatesHoverMarker Marker { get; set; }
		private WindbarbSeriesIkhStatesHoverMarker Marker_DefaultValue { get; set; }
		...
		/// </summary>
		public WindbarbSeriesIkhStatesHoverHalo Halo { get; set; }
		private WindbarbSeriesIkhStatesHoverHalo Halo_DefaultValue { get; set; }
