...
{
	public partial class WindbarbSeriesIkhStatesSelectMarker  : BaseObject
	{
		public WindbarbSeriesIkhStatesSelectMarker()
		{
			LineWidth = LineWidth_DefaultValue = 0;
			LineColor = LineColor_DefaultValue = "#ffffff";
			Radius = Radius_DefaultValue = 4;
			States = States_DefaultValue = new WindbarbSeriesIkhStatesSelectMarkerStates();
		...
		/// </summary>
		public WindbarbSeriesIkhStatesSelectMarkerStates States { get; set; }
		private WindbarbSeriesIkhStatesSelectMarkerStates States_DefaultValue { get; set; }
