...
{
	public partial class WindbarbSeriesIkhTooltip  : BaseObject
	{
		public WindbarbSeriesIkhTooltip()
		{
			ValueDecimals = ValueDecimals_DefaultValue = null;
			DateTimeLabelFormats = DateTimeLabelFormats_DefaultValue = new WindbarbSeriesIkhTooltipDateTimeLabelFormats();
		...
		/// </summary>
		public WindbarbSeriesIkhTooltipDateTimeLabelFormats DateTimeLabelFormats { get; set; }
		private WindbarbSeriesIkhTooltipDateTimeLabelFormats DateTimeLabelFormats_DefaultValue { get; set; }
		...
		internal override Hashtable ToHashtable()
		{
			...
			if (PointFormatter != PointFormatter_DefaultValue) { h.Add("pointFormatter",PointFormatter); Highstock.AddFunction("WindbarbSeriesIkhTooltipPointFormatter.pointFormatter", PointFormatter); }  
