...
{
	public partial class WindbarbSeriesStatesSelectMarker  : BaseObject
	{
		public WindbarbSeriesStatesSelectMarker()
		{
			LineWidth = LineWidth_DefaultValue = 0;
			LineColor = LineColor_DefaultValue = "#ffffff";
			Radius = Radius_DefaultValue = 4;
			States = States_DefaultValue = new WindbarbSeriesStatesSelectMarkerStates();
		...
		/// </summary>
		public WindbarbSeriesStatesSelectMarkerStates States { get; set; }
		private WindbarbSeriesStatesSelectMarkerStates States_DefaultValue { get; set; }
