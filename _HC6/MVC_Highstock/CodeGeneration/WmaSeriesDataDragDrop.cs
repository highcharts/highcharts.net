...
{
	public partial class WmaSeriesDataDragDrop  : BaseObject
	{
		public WmaSeriesDataDragDrop()
		{
			DraggableX = DraggableX_DefaultValue = null;
			DraggableY = DraggableY_DefaultValue = null;
			DragHandle = DragHandle_DefaultValue = new WmaSeriesDataDragDropDragHandle();
			...
			GuideBox = GuideBox_DefaultValue = new WmaSeriesDataDragDropGuideBox();
		...
		/// </summary>
		public WmaSeriesDataDragDropDragHandle DragHandle { get; set; }
		private WmaSeriesDataDragDropDragHandle DragHandle_DefaultValue { get; set; }
		...
		/// </summary>
		public WmaSeriesDataDragDropGuideBox GuideBox { get; set; }
		private WmaSeriesDataDragDropGuideBox GuideBox_DefaultValue { get; set; }
