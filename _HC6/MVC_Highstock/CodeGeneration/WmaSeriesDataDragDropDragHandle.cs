...
{
	public partial class WmaSeriesDataDragDropDragHandle  : BaseObject
	{
		public WmaSeriesDataDragDropDragHandle()
		{
		...
		internal override Hashtable ToHashtable()
		{
			...
			if (PathFormatter != PathFormatter_DefaultValue) { h.Add("pathFormatter",PathFormatter); Highstock.AddFunction("WmaSeriesDataDragDropDragHandlePathFormatter.pathFormatter", PathFormatter); }  
