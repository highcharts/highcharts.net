...
namespace Highsoft.Web.Mvc.Stocks
{
	public partial class WmaSeriesDataLabels  : BaseObject
	{
		public WmaSeriesDataLabels()
		{
			...
			Style = Style_DefaultValue = new WmaSeriesDataLabelsStyle();
		...
		/// </summary>
		public WmaSeriesDataLabelsStyle Style { get; set; }
		private WmaSeriesDataLabelsStyle Style_DefaultValue { get; set; }
