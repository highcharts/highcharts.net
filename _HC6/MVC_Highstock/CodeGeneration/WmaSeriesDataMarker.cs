...
{
	public partial class WmaSeriesDataMarker  : BaseObject
	{
		public WmaSeriesDataMarker()
		{
			...
			States = States_DefaultValue = new WmaSeriesDataMarkerStates();
		...
		/// </summary>
		public WmaSeriesDataMarkerStates States { get; set; }
		private WmaSeriesDataMarkerStates States_DefaultValue { get; set; }
