...
{
	public partial class WmaSeriesDragDropDragHandle  : BaseObject
	{
		public WmaSeriesDragDropDragHandle()
		{
		...
		internal override Hashtable ToHashtable()
		{
			...
			if (PathFormatter != PathFormatter_DefaultValue) { h.Add("pathFormatter",PathFormatter); Highstock.AddFunction("WmaSeriesDragDropDragHandlePathFormatter.pathFormatter", PathFormatter); }  
