...
{
	public partial class WmaSeriesIkhDataGrouping  : BaseObject
	{
		...
		/// </summary>
		public WmaSeriesIkhDataGroupingApproximation Approximation { get; set; }
		private WmaSeriesIkhDataGroupingApproximation Approximation_DefaultValue { get; set; }
