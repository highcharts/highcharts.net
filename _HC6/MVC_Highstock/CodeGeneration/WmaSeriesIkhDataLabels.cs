...
{
	public partial class WmaSeriesIkhDataLabels  : BaseObject
	{
		public WmaSeriesIkhDataLabels()
		{
			Align = Align_DefaultValue = WmaSeriesIkhDataLabelsAlign.Center;
			Formatter = Formatter_DefaultValue = "";
			Style = Style_DefaultValue = new WmaSeriesIkhDataLabelsStyle();
			VerticalAlign = VerticalAlign_DefaultValue = WmaSeriesIkhDataLabelsVerticalAlign.Bottom;
			X = X_DefaultValue = 0;
			Y = Y_DefaultValue = -6;
			...
			Overflow = Overflow_DefaultValue = WmaSeriesIkhDataLabelsOverflow.Justify;
		...
		/// </summary>
		public WmaSeriesIkhDataLabelsAlign Align { get; set; }
		private WmaSeriesIkhDataLabelsAlign Align_DefaultValue { get; set; }
		...
		/// </summary>
		public WmaSeriesIkhDataLabelsStyle Style { get; set; }
		private WmaSeriesIkhDataLabelsStyle Style_DefaultValue { get; set; }
		...
		/// </summary>
		public WmaSeriesIkhDataLabelsVerticalAlign VerticalAlign { get; set; }
		private WmaSeriesIkhDataLabelsVerticalAlign VerticalAlign_DefaultValue { get; set; }
		...
		/// </summary>
		public WmaSeriesIkhDataLabelsOverflow Overflow { get; set; }
		private WmaSeriesIkhDataLabelsOverflow Overflow_DefaultValue { get; set; }
		...
		internal override Hashtable ToHashtable()
		{
			...
			if (Formatter != Formatter_DefaultValue) { h.Add("formatter",Formatter); Highstock.AddFunction("WmaSeriesIkhDataLabelsFormatter.formatter", Formatter); }  
