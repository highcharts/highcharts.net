...
{
	public partial class WmaSeriesIkhMarker  : BaseObject
	{
		public WmaSeriesIkhMarker()
		{
			LineWidth = LineWidth_DefaultValue = 0;
			LineColor = LineColor_DefaultValue = "#ffffff";
			Radius = Radius_DefaultValue = 4;
			States = States_DefaultValue = new WmaSeriesIkhMarkerStates();
		...
		/// </summary>
		public WmaSeriesIkhMarkerStates States { get; set; }
		private WmaSeriesIkhMarkerStates States_DefaultValue { get; set; }
