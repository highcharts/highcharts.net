...
{
	public partial class WmaSeriesIkhStatesHover  : BaseObject
	{
		public WmaSeriesIkhStatesHover()
		{
			LineWidthPlus = LineWidthPlus_DefaultValue = 1;
			Marker = Marker_DefaultValue = new WmaSeriesIkhStatesHoverMarker();
			Halo = Halo_DefaultValue = new WmaSeriesIkhStatesHoverHalo();
		...
		/// </summary>
		public WmaSeriesIkhStatesHoverMarker Marker { get; set; }
		private WmaSeriesIkhStatesHoverMarker Marker_DefaultValue { get; set; }
		...
		/// </summary>
		public WmaSeriesIkhStatesHoverHalo Halo { get; set; }
		private WmaSeriesIkhStatesHoverHalo Halo_DefaultValue { get; set; }
