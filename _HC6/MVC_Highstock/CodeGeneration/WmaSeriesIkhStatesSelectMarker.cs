...
{
	public partial class WmaSeriesIkhStatesSelectMarker  : BaseObject
	{
		public WmaSeriesIkhStatesSelectMarker()
		{
			LineWidth = LineWidth_DefaultValue = 0;
			LineColor = LineColor_DefaultValue = "#ffffff";
			Radius = Radius_DefaultValue = 4;
			States = States_DefaultValue = new WmaSeriesIkhStatesSelectMarkerStates();
		...
		/// </summary>
		public WmaSeriesIkhStatesSelectMarkerStates States { get; set; }
		private WmaSeriesIkhStatesSelectMarkerStates States_DefaultValue { get; set; }
