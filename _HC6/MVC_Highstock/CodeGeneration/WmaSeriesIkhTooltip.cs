...
{
	public partial class WmaSeriesIkhTooltip  : BaseObject
	{
		public WmaSeriesIkhTooltip()
		{
			ValueDecimals = ValueDecimals_DefaultValue = null;
			DateTimeLabelFormats = DateTimeLabelFormats_DefaultValue = new WmaSeriesIkhTooltipDateTimeLabelFormats();
		...
		/// </summary>
		public WmaSeriesIkhTooltipDateTimeLabelFormats DateTimeLabelFormats { get; set; }
		private WmaSeriesIkhTooltipDateTimeLabelFormats DateTimeLabelFormats_DefaultValue { get; set; }
		...
		internal override Hashtable ToHashtable()
		{
			...
			if (PointFormatter != PointFormatter_DefaultValue) { h.Add("pointFormatter",PointFormatter); Highstock.AddFunction("WmaSeriesIkhTooltipPointFormatter.pointFormatter", PointFormatter); }  
