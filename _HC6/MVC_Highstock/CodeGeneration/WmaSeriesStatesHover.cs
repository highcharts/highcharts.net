...
{
	public partial class WmaSeriesStatesHover  : BaseObject
	{
		public WmaSeriesStatesHover()
		{
			LineWidthPlus = LineWidthPlus_DefaultValue = 1;
			Marker = Marker_DefaultValue = new WmaSeriesStatesHoverMarker();
			Halo = Halo_DefaultValue = new WmaSeriesStatesHoverHalo();
		...
		/// </summary>
		public WmaSeriesStatesHoverMarker Marker { get; set; }
		private WmaSeriesStatesHoverMarker Marker_DefaultValue { get; set; }
		...
		/// </summary>
		public WmaSeriesStatesHoverHalo Halo { get; set; }
		private WmaSeriesStatesHoverHalo Halo_DefaultValue { get; set; }
