...
{
	public partial class WmaSeriesStatesHoverMarker  : BaseObject
	{
		public WmaSeriesStatesHoverMarker()
		{
			...
			States = States_DefaultValue = new WmaSeriesStatesHoverMarkerStates();
		...
		/// </summary>
		public WmaSeriesStatesHoverMarkerStates States { get; set; }
		private WmaSeriesStatesHoverMarkerStates States_DefaultValue { get; set; }
