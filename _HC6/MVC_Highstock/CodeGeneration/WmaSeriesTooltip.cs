...
namespace Highsoft.Web.Mvc.Stocks
{
	public partial class WmaSeriesTooltip  : BaseObject
	{
		public WmaSeriesTooltip()
		{
			...
			DateTimeLabelFormats = DateTimeLabelFormats_DefaultValue = new WmaSeriesTooltipDateTimeLabelFormats();
		...
		/// </summary>
		public WmaSeriesTooltipDateTimeLabelFormats DateTimeLabelFormats { get; set; }
		private WmaSeriesTooltipDateTimeLabelFormats DateTimeLabelFormats_DefaultValue { get; set; }
