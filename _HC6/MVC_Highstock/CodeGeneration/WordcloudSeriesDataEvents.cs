...
namespace Highsoft.Web.Mvc.Stocks
{
	public partial class WordcloudSeriesDataEvents  : BaseObject
	{
		...
		internal override Hashtable ToHashtable()
		{
			...
			if (Click != Click_DefaultValue) { h.Add("click",Click); Highstock.AddFunction("WordcloudSeriesDataEventsClick.click", Click); }  
			if (MouseOut != MouseOut_DefaultValue) { h.Add("mouseOut",MouseOut); Highstock.AddFunction("WordcloudSeriesDataEventsMouseOut.mouseOut", MouseOut); }  
			if (MouseOver != MouseOver_DefaultValue) { h.Add("mouseOver",MouseOver); Highstock.AddFunction("WordcloudSeriesDataEventsMouseOver.mouseOver", MouseOver); }  
			if (Remove != Remove_DefaultValue) { h.Add("remove",Remove); Highstock.AddFunction("WordcloudSeriesDataEventsRemove.remove", Remove); }  
			if (Select != Select_DefaultValue) { h.Add("select",Select); Highstock.AddFunction("WordcloudSeriesDataEventsSelect.select", Select); }  
			if (Unselect != Unselect_DefaultValue) { h.Add("unselect",Unselect); Highstock.AddFunction("WordcloudSeriesDataEventsUnselect.unselect", Unselect); }  
			if (Update != Update_DefaultValue) { h.Add("update",Update); Highstock.AddFunction("WordcloudSeriesDataEventsUpdate.update", Update); }  
