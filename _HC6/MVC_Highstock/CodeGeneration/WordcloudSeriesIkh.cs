...
{
	public partial class WordcloudSeriesIkh  : BaseObject
	{
		public WordcloudSeriesIkh()
		{
			Name = Name_DefaultValue = "SMA (14)";
			Tooltip = Tooltip_DefaultValue = new WordcloudSeriesIkhTooltip();
			LinkedTo = LinkedTo_DefaultValue = null;
			Params = Params_DefaultValue = new WordcloudSeriesIkhParams();
			Linecap = Linecap_DefaultValue = WordcloudSeriesIkhLinecap.Round;
			BoostThreshold = BoostThreshold_DefaultValue = 5000;
			GapSize = GapSize_DefaultValue = 0;
			GapUnit = GapUnit_DefaultValue = WordcloudSeriesIkhGapUnit.Relative;
			Label = Label_DefaultValue = new WordcloudSeriesIkhLabel();
			DataGrouping = DataGrouping_DefaultValue = new WordcloudSeriesIkhDataGrouping();
			LineWidth = LineWidth_DefaultValue = 2;
			AllowPointSelect = AllowPointSelect_DefaultValue = false;
			ShowCheckbox = ShowCheckbox_DefaultValue = false;
			Animation = Animation_DefaultValue = new Animation() { Enabled = true };
			Events = Events_DefaultValue = new WordcloudSeriesIkhEvents();
			Marker = Marker_DefaultValue = new WordcloudSeriesIkhMarker();
			Point = Point_DefaultValue = new WordcloudSeriesIkhPoint();
			DataLabels = DataLabels_DefaultValue = new WordcloudSeriesIkhDataLabels();
			CropThreshold = CropThreshold_DefaultValue = 300;
			SoftThreshold = SoftThreshold_DefaultValue = true;
			States = States_DefaultValue = new WordcloudSeriesIkhStates();
			StickyTracking = StickyTracking_DefaultValue = null;
			TurboThreshold = TurboThreshold_DefaultValue = 1000;
			FindNearestPointBy = FindNearestPointBy_DefaultValue = WordcloudSeriesIkhFindNearestPointBy.X;
			AnimationLimit = AnimationLimit_DefaultValue = null;
			ClassName = ClassName_DefaultValue = null;
			Color = Color_DefaultValue = null;
			ColorIndex = ColorIndex_DefaultValue = null;
			ConnectNulls = ConnectNulls_DefaultValue = false;
			Cursor = Cursor_DefaultValue = WordcloudSeriesIkhCursor.Null;
			DashStyle = DashStyle_DefaultValue = WordcloudSeriesIkhDashStyle.Solid;
			...
			Step = Step_DefaultValue = WordcloudSeriesIkhStep.Null;
			Threshold = Threshold_DefaultValue = 0;
			Visible = Visible_DefaultValue = true;
			ZoneAxis = ZoneAxis_DefaultValue = "y";
			Zones = Zones_DefaultValue = new List<WordcloudSeriesIkhZone>();
			...
			PointIntervalUnit = PointIntervalUnit_DefaultValue = WordcloudSeriesIkhPointIntervalUnit.Null;
			PointPlacement = PointPlacement_DefaultValue = new PointPlacement();
			PointStart = PointStart_DefaultValue = 0;
			Stacking = Stacking_DefaultValue = WordcloudSeriesIkhStacking.Null;
			Compare = Compare_DefaultValue = "undefined";
			CompareBase = CompareBase_DefaultValue = WordcloudSeriesIkhCompareBase.Min;
		...
		/// </summary>
		public WordcloudSeriesIkhTooltip Tooltip { get; set; }
		private WordcloudSeriesIkhTooltip Tooltip_DefaultValue { get; set; }
		...
		/// 
		/// </summary>
		public WordcloudSeriesIkhParams Params { get; set; }
		private WordcloudSeriesIkhParams Params_DefaultValue { get; set; }
		...
		/// </summary>
		public WordcloudSeriesIkhLinecap Linecap { get; set; }
		private WordcloudSeriesIkhLinecap Linecap_DefaultValue { get; set; }
		...
		/// </summary>
		public WordcloudSeriesIkhGapUnit GapUnit { get; set; }
		private WordcloudSeriesIkhGapUnit GapUnit_DefaultValue { get; set; }
		...
		/// </summary>
		public WordcloudSeriesIkhLabel Label { get; set; }
		private WordcloudSeriesIkhLabel Label_DefaultValue { get; set; }
		...
		/// </summary>
		public WordcloudSeriesIkhDataGrouping DataGrouping { get; set; }
		private WordcloudSeriesIkhDataGrouping DataGrouping_DefaultValue { get; set; }
		...
		/// </summary>
		public WordcloudSeriesIkhEvents Events { get; set; }
		private WordcloudSeriesIkhEvents Events_DefaultValue { get; set; }
		...
		/// </summary>
		public WordcloudSeriesIkhMarker Marker { get; set; }
		private WordcloudSeriesIkhMarker Marker_DefaultValue { get; set; }
		 

		/// <summary>
		/// <p>Properties for each single point.</p>
		/// </summary>
		public WordcloudSeriesIkhPoint Point { get; set; }
		private WordcloudSeriesIkhPoint Point_DefaultValue { get; set; }
		...
		/// </summary>
		public WordcloudSeriesIkhDataLabels DataLabels { get; set; }
		private WordcloudSeriesIkhDataLabels DataLabels_DefaultValue { get; set; }
		...
		/// </summary>
		public WordcloudSeriesIkhStates States { get; set; }
		private WordcloudSeriesIkhStates States_DefaultValue { get; set; }
		...
		/// </summary>
		public WordcloudSeriesIkhFindNearestPointBy FindNearestPointBy { get; set; }
		private WordcloudSeriesIkhFindNearestPointBy FindNearestPointBy_DefaultValue { get; set; }
		...
		/// </summary>
		public WordcloudSeriesIkhCursor Cursor { get; set; }
		private WordcloudSeriesIkhCursor Cursor_DefaultValue { get; set; }
		...
		/// </summary>
		public WordcloudSeriesIkhDashStyle DashStyle { get; set; }
		private WordcloudSeriesIkhDashStyle DashStyle_DefaultValue { get; set; }
		...
		/// </summary>
		public WordcloudSeriesIkhStep Step { get; set; }
		private WordcloudSeriesIkhStep Step_DefaultValue { get; set; }
		...
		/// </summary>
		public List<WordcloudSeriesIkhZone> Zones { get; set; }
		private List<WordcloudSeriesIkhZone> Zones_DefaultValue { get; set; }
		...
		/// </summary>
		public WordcloudSeriesIkhPointIntervalUnit PointIntervalUnit { get; set; }
		private WordcloudSeriesIkhPointIntervalUnit PointIntervalUnit_DefaultValue { get; set; }
		...
		/// </summary>
		public WordcloudSeriesIkhStacking Stacking { get; set; }
		private WordcloudSeriesIkhStacking Stacking_DefaultValue { get; set; }
		...
		/// </summary>
		public WordcloudSeriesIkhCompareBase CompareBase { get; set; }
		private WordcloudSeriesIkhCompareBase CompareBase_DefaultValue { get; set; }
		...
		internal override Hashtable ToHashtable()
		{
			...
			if (PointDescriptionFormatter != PointDescriptionFormatter_DefaultValue) { h.Add("pointDescriptionFormatter",PointDescriptionFormatter); Highstock.AddFunction("WordcloudSeriesIkhPointDescriptionFormatter.pointDescriptionFormatter", PointDescriptionFormatter); }  
