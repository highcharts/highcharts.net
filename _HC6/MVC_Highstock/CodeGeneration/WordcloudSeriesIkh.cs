...
namespace Highsoft.Web.Mvc.Stocks
{
	public partial class WordcloudSeriesIkh  : BaseObject
	{
		public WordcloudSeriesIkh()
		{
			...
			Zones = Zones_DefaultValue = new WordcloudSeriesIkhZone();
		...
		/// </summary>
		public WordcloudSeriesIkhZone Zones { get; set; }
		private WordcloudSeriesIkhZone Zones_DefaultValue { get; set; }
