...
{
	public partial class WordcloudSeriesIkhDataGrouping  : BaseObject
	{
		public WordcloudSeriesIkhDataGrouping()
		{
			Approximation = Approximation_DefaultValue = WordcloudSeriesIkhDataGroupingApproximation.Average;
		...
		/// </summary>
		public WordcloudSeriesIkhDataGroupingApproximation Approximation { get; set; }
		private WordcloudSeriesIkhDataGroupingApproximation Approximation_DefaultValue { get; set; }
