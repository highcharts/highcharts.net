...
{
	public partial class WordcloudSeriesIkhDataLabels  : BaseObject
	{
		public WordcloudSeriesIkhDataLabels()
		{
			Align = Align_DefaultValue = WordcloudSeriesIkhDataLabelsAlign.Center;
			Formatter = Formatter_DefaultValue = "";
			Style = Style_DefaultValue = new WordcloudSeriesIkhDataLabelsStyle();
			VerticalAlign = VerticalAlign_DefaultValue = WordcloudSeriesIkhDataLabelsVerticalAlign.Bottom;
			X = X_DefaultValue = 0;
			Y = Y_DefaultValue = -6;
			...
			Overflow = Overflow_DefaultValue = WordcloudSeriesIkhDataLabelsOverflow.Justify;
		...
		/// </summary>
		public WordcloudSeriesIkhDataLabelsAlign Align { get; set; }
		private WordcloudSeriesIkhDataLabelsAlign Align_DefaultValue { get; set; }
		...
		/// </summary>
		public WordcloudSeriesIkhDataLabelsStyle Style { get; set; }
		private WordcloudSeriesIkhDataLabelsStyle Style_DefaultValue { get; set; }
		...
		/// </summary>
		public WordcloudSeriesIkhDataLabelsVerticalAlign VerticalAlign { get; set; }
		private WordcloudSeriesIkhDataLabelsVerticalAlign VerticalAlign_DefaultValue { get; set; }
		...
		/// </summary>
		public WordcloudSeriesIkhDataLabelsOverflow Overflow { get; set; }
		private WordcloudSeriesIkhDataLabelsOverflow Overflow_DefaultValue { get; set; }
		...
		internal override Hashtable ToHashtable()
		{
			...
			if (Formatter != Formatter_DefaultValue) { h.Add("formatter",Formatter); Highstock.AddFunction("WordcloudSeriesIkhDataLabelsFormatter.formatter", Formatter); }  
