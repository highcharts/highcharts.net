...
{
	public partial class WordcloudSeriesIkhEvents  : BaseObject
	{
		public WordcloudSeriesIkhEvents()
		{
		...
		internal override Hashtable ToHashtable()
		{
			...
			if (AfterAnimate != AfterAnimate_DefaultValue) { h.Add("afterAnimate",AfterAnimate); Highstock.AddFunction("WordcloudSeriesIkhEventsAfterAnimate.afterAnimate", AfterAnimate); }  
			if (CheckboxClick != CheckboxClick_DefaultValue) { h.Add("checkboxClick",CheckboxClick); Highstock.AddFunction("WordcloudSeriesIkhEventsCheckboxClick.checkboxClick", CheckboxClick); }  
			if (Click != Click_DefaultValue) { h.Add("click",Click); Highstock.AddFunction("WordcloudSeriesIkhEventsClick.click", Click); }  
			if (Hide != Hide_DefaultValue) { h.Add("hide",Hide); Highstock.AddFunction("WordcloudSeriesIkhEventsHide.hide", Hide); }  
			if (LegendItemClick != LegendItemClick_DefaultValue) { h.Add("legendItemClick",LegendItemClick); Highstock.AddFunction("WordcloudSeriesIkhEventsLegendItemClick.legendItemClick", LegendItemClick); }  
			if (MouseOut != MouseOut_DefaultValue) { h.Add("mouseOut",MouseOut); Highstock.AddFunction("WordcloudSeriesIkhEventsMouseOut.mouseOut", MouseOut); }  
			if (MouseOver != MouseOver_DefaultValue) { h.Add("mouseOver",MouseOver); Highstock.AddFunction("WordcloudSeriesIkhEventsMouseOver.mouseOver", MouseOver); }  
			if (Show != Show_DefaultValue) { h.Add("show",Show); Highstock.AddFunction("WordcloudSeriesIkhEventsShow.show", Show); }  
