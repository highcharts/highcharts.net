...
{
	public partial class WordcloudSeriesIkhStatesHover  : BaseObject
	{
		public WordcloudSeriesIkhStatesHover()
		{
			LineWidthPlus = LineWidthPlus_DefaultValue = 1;
			Marker = Marker_DefaultValue = new WordcloudSeriesIkhStatesHoverMarker();
			Halo = Halo_DefaultValue = new WordcloudSeriesIkhStatesHoverHalo();
		...
		/// </summary>
		public WordcloudSeriesIkhStatesHoverMarker Marker { get; set; }
		private WordcloudSeriesIkhStatesHoverMarker Marker_DefaultValue { get; set; }
		...
		/// </summary>
		public WordcloudSeriesIkhStatesHoverHalo Halo { get; set; }
		private WordcloudSeriesIkhStatesHoverHalo Halo_DefaultValue { get; set; }
