...
{
	public partial class WordcloudSeriesIkhStatesSelectMarker  : BaseObject
	{
		public WordcloudSeriesIkhStatesSelectMarker()
		{
			LineWidth = LineWidth_DefaultValue = 0;
			LineColor = LineColor_DefaultValue = "#ffffff";
			Radius = Radius_DefaultValue = 4;
			States = States_DefaultValue = new WordcloudSeriesIkhStatesSelectMarkerStates();
		...
		/// </summary>
		public WordcloudSeriesIkhStatesSelectMarkerStates States { get; set; }
		private WordcloudSeriesIkhStatesSelectMarkerStates States_DefaultValue { get; set; }
