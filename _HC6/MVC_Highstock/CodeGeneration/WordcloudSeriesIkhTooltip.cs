...
{
	public partial class WordcloudSeriesIkhTooltip  : BaseObject
	{
		public WordcloudSeriesIkhTooltip()
		{
			ValueDecimals = ValueDecimals_DefaultValue = null;
			DateTimeLabelFormats = DateTimeLabelFormats_DefaultValue = new WordcloudSeriesIkhTooltipDateTimeLabelFormats();
		...
		/// </summary>
		public WordcloudSeriesIkhTooltipDateTimeLabelFormats DateTimeLabelFormats { get; set; }
		private WordcloudSeriesIkhTooltipDateTimeLabelFormats DateTimeLabelFormats_DefaultValue { get; set; }
		...
		internal override Hashtable ToHashtable()
		{
			...
			if (PointFormatter != PointFormatter_DefaultValue) { h.Add("pointFormatter",PointFormatter); Highstock.AddFunction("WordcloudSeriesIkhTooltipPointFormatter.pointFormatter", PointFormatter); }  
