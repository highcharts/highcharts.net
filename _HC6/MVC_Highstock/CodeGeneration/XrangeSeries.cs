...
namespace Highsoft.Web.Mvc.Stocks
{
	public partial class XrangeSeries  : Series
	{
		public XrangeSeries()
		{
			...
			Ikh = Ikh_DefaultValue = new XrangeSeriesIkh();
			...
			Zones = Zones_DefaultValue = new XrangeSeriesZone();
			...
			GapUnit = GapUnit_DefaultValue = XrangeSeriesGapUnit.Relative;
			LineWidth = LineWidth_DefaultValue = 2;
			Marker = Marker_DefaultValue = new XrangeSeriesMarker();
			CropThreshold = CropThreshold_DefaultValue = 300;
			PointRange = PointRange_DefaultValue = 0;
			SoftThreshold = SoftThreshold_DefaultValue = true;
			FindNearestPointBy = FindNearestPointBy_DefaultValue = XrangeSeriesFindNearestPointBy.X;
			ConnectNulls = ConnectNulls_DefaultValue = false;
			DashStyle = DashStyle_DefaultValue = XrangeSeriesDashStyle.Solid;
			GetExtremesFromAll = GetExtremesFromAll_DefaultValue = false;
			Linecap = Linecap_DefaultValue = XrangeSeriesLinecap.Round;
			NegativeColor = NegativeColor_DefaultValue = "null";
			PointInterval = PointInterval_DefaultValue = 1;
			PointIntervalUnit = PointIntervalUnit_DefaultValue = XrangeSeriesPointIntervalUnit.Null;
			PointPlacement = PointPlacement_DefaultValue = new PointPlacement();
			PointStart = PointStart_DefaultValue = 0;
			Stacking = Stacking_DefaultValue = XrangeSeriesStacking.Null;
			Step = Step_DefaultValue = XrangeSeriesStep.Null;
		...
		/// <summary>
		/// <p>An array of data points for the series. For the <code>xrange</code> series type,points can be given in the following ways:</p><ol><li><p>An array of objects with named values. The objects are pointconfiguration objects as seen below.</p><pre><code class="lang-js">data: [{    x: Date.UTC(2017, 0, 1),    x2: Date.UTC(2017, 0, 3),    name: &quot;Test&quot;,    y: 0,    color: &quot;#00FF00&quot;}, {    x: Date.UTC(2017, 0, 4),    x2: Date.UTC(2017, 0, 5),    name: &quot;Deploy&quot;,    y: 1,    color: &quot;#FF0000&quot;}]</code></pre></li></ol>
		/// </summary>
		...
		/// </summary>
		public XrangeSeriesIkh Ikh { get; set; }
		private XrangeSeriesIkh Ikh_DefaultValue { get; set; }
		...
		/// </summary>
		public XrangeSeriesType Type { get; set; }
		private XrangeSeriesType Type_DefaultValue { get; set; }
		...
		/// </summary>
		public XrangeSeriesCursor Cursor { get; set; }
		private XrangeSeriesCursor Cursor_DefaultValue { get; set; }
		...
		/// </summary>
		public XrangeSeriesZone Zones { get; set; }
		private XrangeSeriesZone Zones_DefaultValue { get; set; }
		...
		/// </summary>
		public XrangeSeriesCompareBase CompareBase { get; set; }
		private XrangeSeriesCompareBase CompareBase_DefaultValue { get; set; }
		...
		/// </summary>
		public XrangeSeriesGapUnit GapUnit { get; set; }
		private XrangeSeriesGapUnit GapUnit_DefaultValue { get; set; }
		...
		/// </summary>
		public XrangeSeriesMarker Marker { get; set; }
		private XrangeSeriesMarker Marker_DefaultValue { get; set; }
		...
		/// </summary>
		public XrangeSeriesFindNearestPointBy FindNearestPointBy { get; set; }
		private XrangeSeriesFindNearestPointBy FindNearestPointBy_DefaultValue { get; set; }
		...
		/// </summary>
		public XrangeSeriesLinecap Linecap { get; set; }
		private XrangeSeriesLinecap Linecap_DefaultValue { get; set; }
		...
		/// </summary>
		public XrangeSeriesPointIntervalUnit PointIntervalUnit { get; set; }
		private XrangeSeriesPointIntervalUnit PointIntervalUnit_DefaultValue { get; set; }
		...
		/// </summary>
		public XrangeSeriesStacking Stacking { get; set; }
		private XrangeSeriesStacking Stacking_DefaultValue { get; set; }
		 

		/// <summary>
		/// <p>Whether to apply steps to the line. Possible values are <code>left</code>, <code>center</code>and <code>right</code>.</p>
		/// </summary>
		public XrangeSeriesStep Step { get; set; }
		private XrangeSeriesStep Step_DefaultValue { get; set; }
		...
		internal override Hashtable ToHashtable()
		{
			...
			if (PointDescriptionFormatter != PointDescriptionFormatter_DefaultValue) { h.Add("pointDescriptionFormatter",PointDescriptionFormatter); Highstock.AddFunction("XrangeSeriesPointDescriptionFormatter.pointDescriptionFormatter", PointDescriptionFormatter); }  
