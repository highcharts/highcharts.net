...
{
	public partial class XrangeSeriesDataGrouping  : BaseObject
	{
		public XrangeSeriesDataGrouping()
		{
			Approximation = Approximation_DefaultValue = XrangeSeriesDataGroupingApproximation.Average;
		...
		/// </summary>
		public XrangeSeriesDataGroupingApproximation Approximation { get; set; }
		private XrangeSeriesDataGroupingApproximation Approximation_DefaultValue { get; set; }
		...
		/// </summary>
		public XrangeSeriesDataGroupingUnits Units { get; set; }
		private XrangeSeriesDataGroupingUnits Units_DefaultValue { get; set; }
