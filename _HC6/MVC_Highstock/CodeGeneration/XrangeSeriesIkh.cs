...
{
	public partial class XrangeSeriesIkh  : BaseObject
	{
		public XrangeSeriesIkh()
		{
			Name = Name_DefaultValue = "SMA (14)";
			Tooltip = Tooltip_DefaultValue = new XrangeSeriesIkhTooltip();
			LinkedTo = LinkedTo_DefaultValue = null;
			Params = Params_DefaultValue = new XrangeSeriesIkhParams();
			Linecap = Linecap_DefaultValue = XrangeSeriesIkhLinecap.Round;
			BoostThreshold = BoostThreshold_DefaultValue = 5000;
			GapSize = GapSize_DefaultValue = 0;
			GapUnit = GapUnit_DefaultValue = XrangeSeriesIkhGapUnit.Relative;
			Label = Label_DefaultValue = new XrangeSeriesIkhLabel();
			DataGrouping = DataGrouping_DefaultValue = new XrangeSeriesIkhDataGrouping();
			LineWidth = LineWidth_DefaultValue = 2;
			AllowPointSelect = AllowPointSelect_DefaultValue = false;
			ShowCheckbox = ShowCheckbox_DefaultValue = false;
			Animation = Animation_DefaultValue = new Animation() { Enabled = true };
			Events = Events_DefaultValue = new XrangeSeriesIkhEvents();
			Marker = Marker_DefaultValue = new XrangeSeriesIkhMarker();
			Point = Point_DefaultValue = new XrangeSeriesIkhPoint();
			DataLabels = DataLabels_DefaultValue = new XrangeSeriesIkhDataLabels();
			CropThreshold = CropThreshold_DefaultValue = 300;
			SoftThreshold = SoftThreshold_DefaultValue = true;
			States = States_DefaultValue = new XrangeSeriesIkhStates();
			StickyTracking = StickyTracking_DefaultValue = null;
			TurboThreshold = TurboThreshold_DefaultValue = 1000;
			FindNearestPointBy = FindNearestPointBy_DefaultValue = XrangeSeriesIkhFindNearestPointBy.X;
			AnimationLimit = AnimationLimit_DefaultValue = null;
			ClassName = ClassName_DefaultValue = null;
			Color = Color_DefaultValue = null;
			ColorIndex = ColorIndex_DefaultValue = null;
			ConnectNulls = ConnectNulls_DefaultValue = false;
			Cursor = Cursor_DefaultValue = XrangeSeriesIkhCursor.Null;
			DashStyle = DashStyle_DefaultValue = XrangeSeriesIkhDashStyle.Solid;
			...
			Step = Step_DefaultValue = XrangeSeriesIkhStep.Null;
			Threshold = Threshold_DefaultValue = 0;
			Visible = Visible_DefaultValue = true;
			ZoneAxis = ZoneAxis_DefaultValue = "y";
			Zones = Zones_DefaultValue = new List<XrangeSeriesIkhZone>();
			...
			PointIntervalUnit = PointIntervalUnit_DefaultValue = XrangeSeriesIkhPointIntervalUnit.Null;
			PointPlacement = PointPlacement_DefaultValue = new PointPlacement();
			PointStart = PointStart_DefaultValue = 0;
			Stacking = Stacking_DefaultValue = XrangeSeriesIkhStacking.Null;
			Compare = Compare_DefaultValue = "undefined";
			CompareBase = CompareBase_DefaultValue = XrangeSeriesIkhCompareBase.Min;
		...
		/// </summary>
		public XrangeSeriesIkhTooltip Tooltip { get; set; }
		private XrangeSeriesIkhTooltip Tooltip_DefaultValue { get; set; }
		...
		/// 
		/// </summary>
		public XrangeSeriesIkhParams Params { get; set; }
		private XrangeSeriesIkhParams Params_DefaultValue { get; set; }
		...
		/// </summary>
		public XrangeSeriesIkhLinecap Linecap { get; set; }
		private XrangeSeriesIkhLinecap Linecap_DefaultValue { get; set; }
		...
		/// </summary>
		public XrangeSeriesIkhGapUnit GapUnit { get; set; }
		private XrangeSeriesIkhGapUnit GapUnit_DefaultValue { get; set; }
		...
		/// </summary>
		public XrangeSeriesIkhLabel Label { get; set; }
		private XrangeSeriesIkhLabel Label_DefaultValue { get; set; }
		...
		/// </summary>
		public XrangeSeriesIkhDataGrouping DataGrouping { get; set; }
		private XrangeSeriesIkhDataGrouping DataGrouping_DefaultValue { get; set; }
		...
		/// </summary>
		public XrangeSeriesIkhEvents Events { get; set; }
		private XrangeSeriesIkhEvents Events_DefaultValue { get; set; }
		...
		/// </summary>
		public XrangeSeriesIkhMarker Marker { get; set; }
		private XrangeSeriesIkhMarker Marker_DefaultValue { get; set; }
		 

		/// <summary>
		/// <p>Properties for each single point.</p>
		/// </summary>
		public XrangeSeriesIkhPoint Point { get; set; }
		private XrangeSeriesIkhPoint Point_DefaultValue { get; set; }
		...
		/// </summary>
		public XrangeSeriesIkhDataLabels DataLabels { get; set; }
		private XrangeSeriesIkhDataLabels DataLabels_DefaultValue { get; set; }
		...
		/// </summary>
		public XrangeSeriesIkhStates States { get; set; }
		private XrangeSeriesIkhStates States_DefaultValue { get; set; }
		...
		/// </summary>
		public XrangeSeriesIkhFindNearestPointBy FindNearestPointBy { get; set; }
		private XrangeSeriesIkhFindNearestPointBy FindNearestPointBy_DefaultValue { get; set; }
		...
		/// </summary>
		public XrangeSeriesIkhCursor Cursor { get; set; }
		private XrangeSeriesIkhCursor Cursor_DefaultValue { get; set; }
		...
		/// </summary>
		public XrangeSeriesIkhDashStyle DashStyle { get; set; }
		private XrangeSeriesIkhDashStyle DashStyle_DefaultValue { get; set; }
		...
		/// </summary>
		public XrangeSeriesIkhStep Step { get; set; }
		private XrangeSeriesIkhStep Step_DefaultValue { get; set; }
		...
		/// </summary>
		public List<XrangeSeriesIkhZone> Zones { get; set; }
		private List<XrangeSeriesIkhZone> Zones_DefaultValue { get; set; }
		...
		/// </summary>
		public XrangeSeriesIkhPointIntervalUnit PointIntervalUnit { get; set; }
		private XrangeSeriesIkhPointIntervalUnit PointIntervalUnit_DefaultValue { get; set; }
		...
		/// </summary>
		public XrangeSeriesIkhStacking Stacking { get; set; }
		private XrangeSeriesIkhStacking Stacking_DefaultValue { get; set; }
		...
		/// </summary>
		public XrangeSeriesIkhCompareBase CompareBase { get; set; }
		private XrangeSeriesIkhCompareBase CompareBase_DefaultValue { get; set; }
		...
		internal override Hashtable ToHashtable()
		{
			...
			if (PointDescriptionFormatter != PointDescriptionFormatter_DefaultValue) { h.Add("pointDescriptionFormatter",PointDescriptionFormatter); Highstock.AddFunction("XrangeSeriesIkhPointDescriptionFormatter.pointDescriptionFormatter", PointDescriptionFormatter); }  
