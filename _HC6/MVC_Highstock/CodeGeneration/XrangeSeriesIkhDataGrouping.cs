...
{
	public partial class XrangeSeriesIkhDataGrouping  : BaseObject
	{
		public XrangeSeriesIkhDataGrouping()
		{
			Approximation = Approximation_DefaultValue = XrangeSeriesIkhDataGroupingApproximation.Average;
		...
		/// </summary>
		public XrangeSeriesIkhDataGroupingApproximation Approximation { get; set; }
		private XrangeSeriesIkhDataGroupingApproximation Approximation_DefaultValue { get; set; }
