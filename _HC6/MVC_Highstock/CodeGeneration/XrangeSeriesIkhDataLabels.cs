...
{
	public partial class XrangeSeriesIkhDataLabels  : BaseObject
	{
		public XrangeSeriesIkhDataLabels()
		{
			Align = Align_DefaultValue = XrangeSeriesIkhDataLabelsAlign.Center;
			Formatter = Formatter_DefaultValue = "";
			Style = Style_DefaultValue = new XrangeSeriesIkhDataLabelsStyle();
			VerticalAlign = VerticalAlign_DefaultValue = XrangeSeriesIkhDataLabelsVerticalAlign.Bottom;
			X = X_DefaultValue = 0;
			Y = Y_DefaultValue = -6;
			...
			Overflow = Overflow_DefaultValue = XrangeSeriesIkhDataLabelsOverflow.Justify;
		...
		/// </summary>
		public XrangeSeriesIkhDataLabelsAlign Align { get; set; }
		private XrangeSeriesIkhDataLabelsAlign Align_DefaultValue { get; set; }
		...
		/// </summary>
		public XrangeSeriesIkhDataLabelsStyle Style { get; set; }
		private XrangeSeriesIkhDataLabelsStyle Style_DefaultValue { get; set; }
		...
		/// </summary>
		public XrangeSeriesIkhDataLabelsVerticalAlign VerticalAlign { get; set; }
		private XrangeSeriesIkhDataLabelsVerticalAlign VerticalAlign_DefaultValue { get; set; }
		...
		/// </summary>
		public XrangeSeriesIkhDataLabelsOverflow Overflow { get; set; }
		private XrangeSeriesIkhDataLabelsOverflow Overflow_DefaultValue { get; set; }
		...
		internal override Hashtable ToHashtable()
		{
			...
			if (Formatter != Formatter_DefaultValue) { h.Add("formatter",Formatter); Highstock.AddFunction("XrangeSeriesIkhDataLabelsFormatter.formatter", Formatter); }  
