...
{
	public partial class XrangeSeriesIkhLabel  : BaseObject
	{
		public XrangeSeriesIkhLabel()
		{
			...
			Style = Style_DefaultValue = new XrangeSeriesIkhLabelStyle();
		...
		/// </summary>
		public XrangeSeriesIkhLabelStyle Style { get; set; }
		private XrangeSeriesIkhLabelStyle Style_DefaultValue { get; set; }
