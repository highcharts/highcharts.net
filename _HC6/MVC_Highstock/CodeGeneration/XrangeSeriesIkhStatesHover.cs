...
{
	public partial class XrangeSeriesIkhStatesHover  : BaseObject
	{
		public XrangeSeriesIkhStatesHover()
		{
			LineWidthPlus = LineWidthPlus_DefaultValue = 1;
			Marker = Marker_DefaultValue = new XrangeSeriesIkhStatesHoverMarker();
			Halo = Halo_DefaultValue = new XrangeSeriesIkhStatesHoverHalo();
		...
		/// </summary>
		public XrangeSeriesIkhStatesHoverMarker Marker { get; set; }
		private XrangeSeriesIkhStatesHoverMarker Marker_DefaultValue { get; set; }
		...
		/// </summary>
		public XrangeSeriesIkhStatesHoverHalo Halo { get; set; }
		private XrangeSeriesIkhStatesHoverHalo Halo_DefaultValue { get; set; }
