...
{
	public partial class XrangeSeriesIkhTooltip  : BaseObject
	{
		public XrangeSeriesIkhTooltip()
		{
			ValueDecimals = ValueDecimals_DefaultValue = null;
			DateTimeLabelFormats = DateTimeLabelFormats_DefaultValue = new XrangeSeriesIkhTooltipDateTimeLabelFormats();
		...
		/// </summary>
		public XrangeSeriesIkhTooltipDateTimeLabelFormats DateTimeLabelFormats { get; set; }
		private XrangeSeriesIkhTooltipDateTimeLabelFormats DateTimeLabelFormats_DefaultValue { get; set; }
		...
		internal override Hashtable ToHashtable()
		{
			...
			if (PointFormatter != PointFormatter_DefaultValue) { h.Add("pointFormatter",PointFormatter); Highstock.AddFunction("XrangeSeriesIkhTooltipPointFormatter.pointFormatter", PointFormatter); }  
