...
{
	public partial class XrangeSeriesMarker  : BaseObject
	{
		public XrangeSeriesMarker()
		{
			LineWidth = LineWidth_DefaultValue = 0;
			LineColor = LineColor_DefaultValue = "#ffffff";
			Radius = Radius_DefaultValue = 4;
			States = States_DefaultValue = new XrangeSeriesMarkerStates();
		...
		/// </summary>
		public XrangeSeriesMarkerStates States { get; set; }
		private XrangeSeriesMarkerStates States_DefaultValue { get; set; }
