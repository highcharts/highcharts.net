...
namespace Highsoft.Web.Mvc.Stocks
{
	public partial class XrangeSeriesTooltip  : BaseObject
	{
		public XrangeSeriesTooltip()
		{
			...
			DateTimeLabelFormats = DateTimeLabelFormats_DefaultValue = new XrangeSeriesTooltipDateTimeLabelFormats();
		...
		/// </summary>
		public XrangeSeriesTooltipDateTimeLabelFormats DateTimeLabelFormats { get; set; }
		private XrangeSeriesTooltipDateTimeLabelFormats DateTimeLabelFormats_DefaultValue { get; set; }
