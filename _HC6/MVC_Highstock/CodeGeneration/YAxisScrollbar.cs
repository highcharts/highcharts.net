...
namespace Highsoft.Web.Mvc.Stocks
{
	public partial class YAxisScrollbar  : BaseObject
	{
		...
		/// <summary>
		/// <p>Whether to show the scrollbar when it is fully zoomed out at maxrange. Setting it to <code>false</code> on the Y axis makes the scrollbar stayhidden until the user zooms in, like common in browsers.</p>
		/// </summary>
		...
		/// <summary>
		/// <p>The width of a vertical scrollbar or height of a horizontal scrollbar. Defaults to 20 on touch devices.</p>
		/// </summary>
