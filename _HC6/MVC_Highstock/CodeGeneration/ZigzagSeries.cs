...
namespace Highsoft.Web.Mvc.Stocks
{
	public partial class ZigzagSeries  : Series
	{
		public ZigzagSeries()
		{
			Ikh = Ikh_DefaultValue = new ZigzagSeriesIkh();
			Id = Id_DefaultValue = null;
			Index = Index_DefaultValue = null;
			LegendIndex = LegendIndex_DefaultValue = null;
			Name = Name_DefaultValue = "Zig Zag (1%)";
			...
			PointIntervalUnit = PointIntervalUnit_DefaultValue = ZigzagSeriesPointIntervalUnit.Null;
			PointPlacement = PointPlacement_DefaultValue = new PointPlacement();
			PointStart = PointStart_DefaultValue = 0;
			Stacking = Stacking_DefaultValue = ZigzagSeriesStacking.Null;
		...
		/// </summary>
		public ZigzagSeriesIkh Ikh { get; set; }
		private ZigzagSeriesIkh Ikh_DefaultValue { get; set; }
		...
		/// </summary>
		public ZigzagSeriesPointIntervalUnit PointIntervalUnit { get; set; }
		private ZigzagSeriesPointIntervalUnit PointIntervalUnit_DefaultValue { get; set; }
		...
		/// </summary>
		public ZigzagSeriesStacking Stacking { get; set; }
		private ZigzagSeriesStacking Stacking_DefaultValue { get; set; }
