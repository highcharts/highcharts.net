...
{
	public partial class ZigzagSeriesDataDragDropDragHandle  : BaseObject
	{
		public ZigzagSeriesDataDragDropDragHandle()
		{
		...
		internal override Hashtable ToHashtable()
		{
			...
			if (PathFormatter != PathFormatter_DefaultValue) { h.Add("pathFormatter",PathFormatter); Highstock.AddFunction("ZigzagSeriesDataDragDropDragHandlePathFormatter.pathFormatter", PathFormatter); }  
