...
{
	public partial class ZigzagSeriesDataGrouping  : BaseObject
	{
		public ZigzagSeriesDataGrouping()
		{
			Approximation = Approximation_DefaultValue = ZigzagSeriesDataGroupingApproximation.Average;
		...
		/// </summary>
		public ZigzagSeriesDataGroupingApproximation Approximation { get; set; }
		private ZigzagSeriesDataGroupingApproximation Approximation_DefaultValue { get; set; }
		...
		/// </summary>
		public ZigzagSeriesDataGroupingUnits Units { get; set; }
		private ZigzagSeriesDataGroupingUnits Units_DefaultValue { get; set; }
