...
namespace Highsoft.Web.Mvc.Stocks
{
	public partial class ZigzagSeriesDataLabels  : BaseObject
	{
		public ZigzagSeriesDataLabels()
		{
			...
			Style = Style_DefaultValue = new ZigzagSeriesDataLabelsStyle();
		...
		/// </summary>
		public ZigzagSeriesDataLabelsStyle Style { get; set; }
		private ZigzagSeriesDataLabelsStyle Style_DefaultValue { get; set; }
