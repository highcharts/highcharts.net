...
{
	public partial class ZigzagSeriesIkh  : BaseObject
	{
		public ZigzagSeriesIkh()
		{
			Name = Name_DefaultValue = "SMA (14)";
			Tooltip = Tooltip_DefaultValue = new ZigzagSeriesIkhTooltip();
			LinkedTo = LinkedTo_DefaultValue = null;
			Params = Params_DefaultValue = new ZigzagSeriesIkhParams();
			Linecap = Linecap_DefaultValue = ZigzagSeriesIkhLinecap.Round;
			BoostThreshold = BoostThreshold_DefaultValue = 5000;
			GapSize = GapSize_DefaultValue = 0;
			GapUnit = GapUnit_DefaultValue = ZigzagSeriesIkhGapUnit.Relative;
			Label = Label_DefaultValue = new ZigzagSeriesIkhLabel();
			DataGrouping = DataGrouping_DefaultValue = new ZigzagSeriesIkhDataGrouping();
			LineWidth = LineWidth_DefaultValue = 2;
			AllowPointSelect = AllowPointSelect_DefaultValue = false;
			ShowCheckbox = ShowCheckbox_DefaultValue = false;
			Animation = Animation_DefaultValue = new Animation() { Enabled = true };
			Events = Events_DefaultValue = new ZigzagSeriesIkhEvents();
			Marker = Marker_DefaultValue = new ZigzagSeriesIkhMarker();
			Point = Point_DefaultValue = new ZigzagSeriesIkhPoint();
			DataLabels = DataLabels_DefaultValue = new ZigzagSeriesIkhDataLabels();
			CropThreshold = CropThreshold_DefaultValue = 300;
			SoftThreshold = SoftThreshold_DefaultValue = true;
			States = States_DefaultValue = new ZigzagSeriesIkhStates();
			StickyTracking = StickyTracking_DefaultValue = null;
			TurboThreshold = TurboThreshold_DefaultValue = 1000;
			FindNearestPointBy = FindNearestPointBy_DefaultValue = ZigzagSeriesIkhFindNearestPointBy.X;
			AnimationLimit = AnimationLimit_DefaultValue = null;
			ClassName = ClassName_DefaultValue = null;
			Color = Color_DefaultValue = null;
			ColorIndex = ColorIndex_DefaultValue = null;
			ConnectNulls = ConnectNulls_DefaultValue = false;
			Cursor = Cursor_DefaultValue = ZigzagSeriesIkhCursor.Null;
			DashStyle = DashStyle_DefaultValue = ZigzagSeriesIkhDashStyle.Solid;
			...
			Step = Step_DefaultValue = ZigzagSeriesIkhStep.Null;
			Threshold = Threshold_DefaultValue = 0;
			Visible = Visible_DefaultValue = true;
			ZoneAxis = ZoneAxis_DefaultValue = "y";
			Zones = Zones_DefaultValue = new List<ZigzagSeriesIkhZone>();
			...
			PointIntervalUnit = PointIntervalUnit_DefaultValue = ZigzagSeriesIkhPointIntervalUnit.Null;
			PointPlacement = PointPlacement_DefaultValue = new PointPlacement();
			PointStart = PointStart_DefaultValue = 0;
			Stacking = Stacking_DefaultValue = ZigzagSeriesIkhStacking.Null;
			Compare = Compare_DefaultValue = "undefined";
			CompareBase = CompareBase_DefaultValue = ZigzagSeriesIkhCompareBase.Min;
		...
		/// </summary>
		public ZigzagSeriesIkhTooltip Tooltip { get; set; }
		private ZigzagSeriesIkhTooltip Tooltip_DefaultValue { get; set; }
		...
		/// 
		/// </summary>
		public ZigzagSeriesIkhParams Params { get; set; }
		private ZigzagSeriesIkhParams Params_DefaultValue { get; set; }
		...
		/// </summary>
		public ZigzagSeriesIkhLinecap Linecap { get; set; }
		private ZigzagSeriesIkhLinecap Linecap_DefaultValue { get; set; }
		...
		/// </summary>
		public ZigzagSeriesIkhGapUnit GapUnit { get; set; }
		private ZigzagSeriesIkhGapUnit GapUnit_DefaultValue { get; set; }
		...
		/// </summary>
		public ZigzagSeriesIkhLabel Label { get; set; }
		private ZigzagSeriesIkhLabel Label_DefaultValue { get; set; }
		...
		/// </summary>
		public ZigzagSeriesIkhDataGrouping DataGrouping { get; set; }
		private ZigzagSeriesIkhDataGrouping DataGrouping_DefaultValue { get; set; }
		...
		/// </summary>
		public ZigzagSeriesIkhEvents Events { get; set; }
		private ZigzagSeriesIkhEvents Events_DefaultValue { get; set; }
		...
		/// </summary>
		public ZigzagSeriesIkhMarker Marker { get; set; }
		private ZigzagSeriesIkhMarker Marker_DefaultValue { get; set; }
		 

		/// <summary>
		/// <p>Properties for each single point.</p>
		/// </summary>
		public ZigzagSeriesIkhPoint Point { get; set; }
		private ZigzagSeriesIkhPoint Point_DefaultValue { get; set; }
		...
		/// </summary>
		public ZigzagSeriesIkhDataLabels DataLabels { get; set; }
		private ZigzagSeriesIkhDataLabels DataLabels_DefaultValue { get; set; }
		...
		/// </summary>
		public ZigzagSeriesIkhStates States { get; set; }
		private ZigzagSeriesIkhStates States_DefaultValue { get; set; }
		...
		/// </summary>
		public ZigzagSeriesIkhFindNearestPointBy FindNearestPointBy { get; set; }
		private ZigzagSeriesIkhFindNearestPointBy FindNearestPointBy_DefaultValue { get; set; }
		...
		/// </summary>
		public ZigzagSeriesIkhCursor Cursor { get; set; }
		private ZigzagSeriesIkhCursor Cursor_DefaultValue { get; set; }
		...
		/// </summary>
		public ZigzagSeriesIkhDashStyle DashStyle { get; set; }
		private ZigzagSeriesIkhDashStyle DashStyle_DefaultValue { get; set; }
		...
		/// </summary>
		public ZigzagSeriesIkhStep Step { get; set; }
		private ZigzagSeriesIkhStep Step_DefaultValue { get; set; }
		...
		/// </summary>
		public List<ZigzagSeriesIkhZone> Zones { get; set; }
		private List<ZigzagSeriesIkhZone> Zones_DefaultValue { get; set; }
		...
		/// </summary>
		public ZigzagSeriesIkhPointIntervalUnit PointIntervalUnit { get; set; }
		private ZigzagSeriesIkhPointIntervalUnit PointIntervalUnit_DefaultValue { get; set; }
		...
		/// </summary>
		public ZigzagSeriesIkhStacking Stacking { get; set; }
		private ZigzagSeriesIkhStacking Stacking_DefaultValue { get; set; }
		...
		/// </summary>
		public ZigzagSeriesIkhCompareBase CompareBase { get; set; }
		private ZigzagSeriesIkhCompareBase CompareBase_DefaultValue { get; set; }
		...
		internal override Hashtable ToHashtable()
		{
			...
			if (PointDescriptionFormatter != PointDescriptionFormatter_DefaultValue) { h.Add("pointDescriptionFormatter",PointDescriptionFormatter); Highstock.AddFunction("ZigzagSeriesIkhPointDescriptionFormatter.pointDescriptionFormatter", PointDescriptionFormatter); }  
