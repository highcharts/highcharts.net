...
{
	public partial class ZigzagSeriesIkhDataGrouping  : BaseObject
	{
		...
		/// </summary>
		public ZigzagSeriesIkhDataGroupingApproximation Approximation { get; set; }
		private ZigzagSeriesIkhDataGroupingApproximation Approximation_DefaultValue { get; set; }
