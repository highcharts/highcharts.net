...
{
	public partial class ZigzagSeriesIkhDataLabels  : BaseObject
	{
		public ZigzagSeriesIkhDataLabels()
		{
			Align = Align_DefaultValue = ZigzagSeriesIkhDataLabelsAlign.Center;
			Formatter = Formatter_DefaultValue = "";
			Style = Style_DefaultValue = new ZigzagSeriesIkhDataLabelsStyle();
			VerticalAlign = VerticalAlign_DefaultValue = ZigzagSeriesIkhDataLabelsVerticalAlign.Bottom;
			X = X_DefaultValue = 0;
			Y = Y_DefaultValue = -6;
			...
			Overflow = Overflow_DefaultValue = ZigzagSeriesIkhDataLabelsOverflow.Justify;
		...
		/// </summary>
		public ZigzagSeriesIkhDataLabelsAlign Align { get; set; }
		private ZigzagSeriesIkhDataLabelsAlign Align_DefaultValue { get; set; }
		...
		/// </summary>
		public ZigzagSeriesIkhDataLabelsStyle Style { get; set; }
		private ZigzagSeriesIkhDataLabelsStyle Style_DefaultValue { get; set; }
		...
		/// </summary>
		public ZigzagSeriesIkhDataLabelsVerticalAlign VerticalAlign { get; set; }
		private ZigzagSeriesIkhDataLabelsVerticalAlign VerticalAlign_DefaultValue { get; set; }
		...
		/// </summary>
		public ZigzagSeriesIkhDataLabelsOverflow Overflow { get; set; }
		private ZigzagSeriesIkhDataLabelsOverflow Overflow_DefaultValue { get; set; }
		...
		internal override Hashtable ToHashtable()
		{
			...
			if (Formatter != Formatter_DefaultValue) { h.Add("formatter",Formatter); Highstock.AddFunction("ZigzagSeriesIkhDataLabelsFormatter.formatter", Formatter); }  
