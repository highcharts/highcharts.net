...
{
	public partial class ZigzagSeriesIkhStatesHover  : BaseObject
	{
		public ZigzagSeriesIkhStatesHover()
		{
			LineWidthPlus = LineWidthPlus_DefaultValue = 1;
			Marker = Marker_DefaultValue = new ZigzagSeriesIkhStatesHoverMarker();
			Halo = Halo_DefaultValue = new ZigzagSeriesIkhStatesHoverHalo();
		...
		/// </summary>
		public ZigzagSeriesIkhStatesHoverMarker Marker { get; set; }
		private ZigzagSeriesIkhStatesHoverMarker Marker_DefaultValue { get; set; }
		...
		/// </summary>
		public ZigzagSeriesIkhStatesHoverHalo Halo { get; set; }
		private ZigzagSeriesIkhStatesHoverHalo Halo_DefaultValue { get; set; }
