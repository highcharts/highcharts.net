...
{
	public partial class ZigzagSeriesIkhStatesHoverMarker  : BaseObject
	{
		public ZigzagSeriesIkhStatesHoverMarker()
		{
			LineWidth = LineWidth_DefaultValue = 0;
			LineColor = LineColor_DefaultValue = "#ffffff";
			Radius = Radius_DefaultValue = 4;
			States = States_DefaultValue = new ZigzagSeriesIkhStatesHoverMarkerStates();
		...
		/// </summary>
		public ZigzagSeriesIkhStatesHoverMarkerStates States { get; set; }
		private ZigzagSeriesIkhStatesHoverMarkerStates States_DefaultValue { get; set; }
