...
{
	public partial class ZigzagSeriesIkhTooltip  : BaseObject
	{
		public ZigzagSeriesIkhTooltip()
		{
			ValueDecimals = ValueDecimals_DefaultValue = null;
			DateTimeLabelFormats = DateTimeLabelFormats_DefaultValue = new ZigzagSeriesIkhTooltipDateTimeLabelFormats();
		...
		/// </summary>
		public ZigzagSeriesIkhTooltipDateTimeLabelFormats DateTimeLabelFormats { get; set; }
		private ZigzagSeriesIkhTooltipDateTimeLabelFormats DateTimeLabelFormats_DefaultValue { get; set; }
		...
		internal override Hashtable ToHashtable()
		{
			...
			if (PointFormatter != PointFormatter_DefaultValue) { h.Add("pointFormatter",PointFormatter); Highstock.AddFunction("ZigzagSeriesIkhTooltipPointFormatter.pointFormatter", PointFormatter); }  
