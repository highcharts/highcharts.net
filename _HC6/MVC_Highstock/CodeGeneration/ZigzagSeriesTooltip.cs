...
namespace Highsoft.Web.Mvc.Stocks
{
	public partial class ZigzagSeriesTooltip  : BaseObject
	{
		public ZigzagSeriesTooltip()
		{
			...
			DateTimeLabelFormats = DateTimeLabelFormats_DefaultValue = new ZigzagSeriesTooltipDateTimeLabelFormats();
		...
		/// </summary>
		public ZigzagSeriesTooltipDateTimeLabelFormats DateTimeLabelFormats { get; set; }
		private ZigzagSeriesTooltipDateTimeLabelFormats DateTimeLabelFormats_DefaultValue { get; set; }
