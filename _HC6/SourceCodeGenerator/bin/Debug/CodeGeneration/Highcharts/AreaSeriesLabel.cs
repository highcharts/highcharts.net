...
{
	public partial class AreaSeriesLabel  : BaseObject
	{
		public AreaSeriesLabel()
		{
			...
			Style = Style_DefaultValue = new AreaSeriesLabelStyle();
		...
		/// </summary>
		public AreaSeriesLabelEnabled Enabled { get; set; }
		private AreaSeriesLabelEnabled Enabled_DefaultValue { get; set; }
		 

		/// <summary>
		/// Allow labels to be placed distant to the graph if necessary,and draw a connector line to the graph.
		/// </summary>
		public AreaSeriesLabelConnectorAllowed ConnectorAllowed { get; set; }
		private AreaSeriesLabelConnectorAllowed ConnectorAllowed_DefaultValue { get; set; }
		 

		/// <summary>
		/// If the label is closer than this to a neighbour graph, draw aconnector.
		/// </summary>
		public AreaSeriesLabelConnectorNeighbourDistance ConnectorNeighbourDistance { get; set; }
		private AreaSeriesLabelConnectorNeighbourDistance ConnectorNeighbourDistance_DefaultValue { get; set; }
		...
		/// </summary>
		public AreaSeriesLabelStyle Style { get; set; }
		private AreaSeriesLabelStyle Style_DefaultValue { get; set; }
