...
{
	public partial class AreaSeriesSunburst  : BaseObject
	{
		public AreaSeriesSunburst()
		{
			Data = Data_DefaultValue = new List<SeriesAreaSunburstData>();
		...
		/// 
		/// </summary>
		public List<SeriesAreaSunburstData> Data { get; set; }
		private List<SeriesAreaSunburstData> Data_DefaultValue { get; set; }
		 

		/// <summary>
		/// Series labels are placed as close to the series as possible in anatural way, seeking to avoid other series. The goal of thisfeature is to make the chart more easily readable, like if ahuman designer placed the labels in the optimal position.The series labels currently work with series types having a`graph` or an `area`.Requires the `series-label.js` module.
		/// </summary>
		public AreaSeriesSunburstLabel Label { get; set; }
		private AreaSeriesSunburstLabel Label_DefaultValue { get; set; }
		...
		/// </summary>
		public AreaSeriesSunburstStickyTracking StickyTracking { get; set; }
		private AreaSeriesSunburstStickyTracking StickyTracking_DefaultValue { get; set; }
		 

		/// <summary>
		/// 
		/// </summary>
		public AreaSeriesSunburstTooltip Tooltip { get; set; }
		private AreaSeriesSunburstTooltip Tooltip_DefaultValue { get; set; }
		...
		/// 
		/// </summary>
		public AreaSeriesSunburstStates States { get; set; }
		private AreaSeriesSunburstStates States_DefaultValue { get; set; }
		...
		/// 
		/// </summary>
		public AreaSeriesSunburstEvents Events { get; set; }
		private AreaSeriesSunburstEvents Events_DefaultValue { get; set; }
		 

		/// <summary>
		/// 
		/// </summary>
		public AreaSeriesSunburstPoint Point { get; set; }
		private AreaSeriesSunburstPoint Point_DefaultValue { get; set; }
		...
		/// 
		/// </summary>
		public AreaSeriesSunburstDataLabels DataLabels { get; set; }
		private AreaSeriesSunburstDataLabels DataLabels_DefaultValue { get; set; }
		...
		/// </summary>
		public AreaSeriesSunburstLevelIsConstant LevelIsConstant { get; set; }
		private AreaSeriesSunburstLevelIsConstant LevelIsConstant_DefaultValue { get; set; }
