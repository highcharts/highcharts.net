...
{
	public partial class AreaSeriesSunburstDataLabels  : BaseObject
	{
		public AreaSeriesSunburstDataLabels()
		{
		...
		/// 
		/// </summary>
		public AreaSeriesSunburstDataLabelsDefer Defer { get; set; }
		private AreaSeriesSunburstDataLabelsDefer Defer_DefaultValue { get; set; }
		 

		/// <summary>
		/// 
		/// </summary>
		public AreaSeriesSunburstDataLabelsStyle Style { get; set; }
		private AreaSeriesSunburstDataLabelsStyle Style_DefaultValue { get; set; }
		...
		/// </summary>
		public AreaSeriesSunburstDataLabelsRotationMode RotationMode { get; set; }
		private AreaSeriesSunburstDataLabelsRotationMode RotationMode_DefaultValue { get; set; }
