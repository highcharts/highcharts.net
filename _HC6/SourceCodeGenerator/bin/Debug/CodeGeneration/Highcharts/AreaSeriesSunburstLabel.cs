...
{
	public partial class AreaSeriesSunburstLabel  : BaseObject
	{
		public AreaSeriesSunburstLabel()
		{
		...
		/// </summary>
		public AreaSeriesSunburstLabelEnabled Enabled { get; set; }
		private AreaSeriesSunburstLabelEnabled Enabled_DefaultValue { get; set; }
		 

		/// <summary>
		/// Allow labels to be placed distant to the graph if necessary,and draw a connector line to the graph.
		/// </summary>
		public AreaSeriesSunburstLabelConnectorAllowed ConnectorAllowed { get; set; }
		private AreaSeriesSunburstLabelConnectorAllowed ConnectorAllowed_DefaultValue { get; set; }
		 

		/// <summary>
		/// If the label is closer than this to a neighbour graph, draw aconnector.
		/// </summary>
		public AreaSeriesSunburstLabelConnectorNeighbourDistance ConnectorNeighbourDistance { get; set; }
		private AreaSeriesSunburstLabelConnectorNeighbourDistance ConnectorNeighbourDistance_DefaultValue { get; set; }
		...
		/// </summary>
		public AreaSeriesSunburstLabelStyle Style { get; set; }
		private AreaSeriesSunburstLabelStyle Style_DefaultValue { get; set; }
