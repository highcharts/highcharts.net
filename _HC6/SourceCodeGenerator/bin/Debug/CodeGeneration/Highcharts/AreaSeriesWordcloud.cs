...
{
	public partial class AreaSeriesWordcloud  : BaseObject
	{
		public AreaSeriesWordcloud()
		{
			Data = Data_DefaultValue = new List<SeriesAreaWordcloudData>();
		...
		/// </summary>
		public List<SeriesAreaWordcloudData> Data { get; set; }
		private List<SeriesAreaWordcloudData> Data_DefaultValue { get; set; }
		 

		/// <summary>
		/// Series labels are placed as close to the series as possible in anatural way, seeking to avoid other series. The goal of thisfeature is to make the chart more easily readable, like if ahuman designer placed the labels in the optimal position.The series labels currently work with series types having a`graph` or an `area`.Requires the `series-label.js` module.
		/// </summary>
		public AreaSeriesWordcloudLabel Label { get; set; }
		private AreaSeriesWordcloudLabel Label_DefaultValue { get; set; }
		...
		/// </summary>
		public AreaSeriesWordcloudEvents Events { get; set; }
		private AreaSeriesWordcloudEvents Events_DefaultValue { get; set; }
		 

		/// <summary>
		/// Properties for each single point.
		/// </summary>
		public AreaSeriesWordcloudPoint Point { get; set; }
		private AreaSeriesWordcloudPoint Point_DefaultValue { get; set; }
		...
		/// 
		/// </summary>
		public AreaSeriesWordcloudStates States { get; set; }
		private AreaSeriesWordcloudStates States_DefaultValue { get; set; }
		 

		/// <summary>
		/// 
		/// </summary>
		public AreaSeriesWordcloudStickyTracking StickyTracking { get; set; }
		private AreaSeriesWordcloudStickyTracking StickyTracking_DefaultValue { get; set; }
		...
		/// 
		/// </summary>
		public AreaSeriesWordcloudBorderWidth BorderWidth { get; set; }
		private AreaSeriesWordcloudBorderWidth BorderWidth_DefaultValue { get; set; }
		 

		/// <summary>
		/// 
		/// </summary>
		public AreaSeriesWordcloudClip Clip { get; set; }
		private AreaSeriesWordcloudClip Clip_DefaultValue { get; set; }
		...
		/// </summary>
		public AreaSeriesWordcloudColorByPoint ColorByPoint { get; set; }
		private AreaSeriesWordcloudColorByPoint ColorByPoint_DefaultValue { get; set; }
		...
		/// </summary>
		public AreaSeriesWordcloudPlacementStrategy PlacementStrategy { get; set; }
		private AreaSeriesWordcloudPlacementStrategy PlacementStrategy_DefaultValue { get; set; }
		 

		/// <summary>
		/// Rotation options for the words in the wordcloud.
		/// </summary>
		public AreaSeriesWordcloudRotation Rotation { get; set; }
		private AreaSeriesWordcloudRotation Rotation_DefaultValue { get; set; }
		 

		/// <summary>
		/// 
		/// </summary>
		public AreaSeriesWordcloudShowInLegend ShowInLegend { get; set; }
		private AreaSeriesWordcloudShowInLegend ShowInLegend_DefaultValue { get; set; }
		...
		/// </summary>
		public AreaSeriesWordcloudSpiral Spiral { get; set; }
		private AreaSeriesWordcloudSpiral Spiral_DefaultValue { get; set; }
		...
		/// 
		/// </summary>
		public AreaSeriesWordcloudTooltip Tooltip { get; set; }
		private AreaSeriesWordcloudTooltip Tooltip_DefaultValue { get; set; }
