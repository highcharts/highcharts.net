...
{
	public partial class AreaSeriesWordcloudLabel  : BaseObject
	{
		public AreaSeriesWordcloudLabel()
		{
		...
		/// </summary>
		public AreaSeriesWordcloudLabelEnabled Enabled { get; set; }
		private AreaSeriesWordcloudLabelEnabled Enabled_DefaultValue { get; set; }
		 

		/// <summary>
		/// Allow labels to be placed distant to the graph if necessary,and draw a connector line to the graph.
		/// </summary>
		public AreaSeriesWordcloudLabelConnectorAllowed ConnectorAllowed { get; set; }
		private AreaSeriesWordcloudLabelConnectorAllowed ConnectorAllowed_DefaultValue { get; set; }
		 

		/// <summary>
		/// If the label is closer than this to a neighbour graph, draw aconnector.
		/// </summary>
		public AreaSeriesWordcloudLabelConnectorNeighbourDistance ConnectorNeighbourDistance { get; set; }
		private AreaSeriesWordcloudLabelConnectorNeighbourDistance ConnectorNeighbourDistance_DefaultValue { get; set; }
		...
		/// </summary>
		public AreaSeriesWordcloudLabelStyle Style { get; set; }
		private AreaSeriesWordcloudLabelStyle Style_DefaultValue { get; set; }
