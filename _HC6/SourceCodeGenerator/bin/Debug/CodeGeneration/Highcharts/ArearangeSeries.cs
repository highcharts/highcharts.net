...
namespace Highsoft.Web.Mvc.Charts
{
	public partial class ArearangeSeries  : Series
	{
		...
		/// </summary>
		public ArearangeSeriesSunburst Sunburst { get; set; }
		private ArearangeSeriesSunburst Sunburst_DefaultValue { get; set; }
		...
		/// </summary>
		public ArearangeSeriesWordcloud Wordcloud { get; set; }
		private ArearangeSeriesWordcloud Wordcloud_DefaultValue { get; set; }
		...
		/// 
		/// </summary>
		public ArearangeSeriesThreshold Threshold { get; set; }
		private ArearangeSeriesThreshold Threshold_DefaultValue { get; set; }
