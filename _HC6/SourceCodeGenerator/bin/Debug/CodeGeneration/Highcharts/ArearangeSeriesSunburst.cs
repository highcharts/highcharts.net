...
{
	public partial class ArearangeSeriesSunburst  : BaseObject
	{
		public ArearangeSeriesSunburst()
		{
			Data = Data_DefaultValue = new List<SeriesArearangeSunburstData>();
		...
		/// 
		/// </summary>
		public List<SeriesArearangeSunburstData> Data { get; set; }
		private List<SeriesArearangeSunburstData> Data_DefaultValue { get; set; }
		 

		/// <summary>
		/// Series labels are placed as close to the series as possible in anatural way, seeking to avoid other series. The goal of thisfeature is to make the chart more easily readable, like if ahuman designer placed the labels in the optimal position.The series labels currently work with series types having a`graph` or an `area`.Requires the `series-label.js` module.
		/// </summary>
		public ArearangeSeriesSunburstLabel Label { get; set; }
		private ArearangeSeriesSunburstLabel Label_DefaultValue { get; set; }
		...
		/// </summary>
		public ArearangeSeriesSunburstStickyTracking StickyTracking { get; set; }
		private ArearangeSeriesSunburstStickyTracking StickyTracking_DefaultValue { get; set; }
		 

		/// <summary>
		/// 
		/// </summary>
		public ArearangeSeriesSunburstTooltip Tooltip { get; set; }
		private ArearangeSeriesSunburstTooltip Tooltip_DefaultValue { get; set; }
		...
		/// 
		/// </summary>
		public ArearangeSeriesSunburstStates States { get; set; }
		private ArearangeSeriesSunburstStates States_DefaultValue { get; set; }
		...
		/// 
		/// </summary>
		public ArearangeSeriesSunburstEvents Events { get; set; }
		private ArearangeSeriesSunburstEvents Events_DefaultValue { get; set; }
		 

		/// <summary>
		/// 
		/// </summary>
		public ArearangeSeriesSunburstPoint Point { get; set; }
		private ArearangeSeriesSunburstPoint Point_DefaultValue { get; set; }
		...
		/// 
		/// </summary>
		public ArearangeSeriesSunburstDataLabels DataLabels { get; set; }
		private ArearangeSeriesSunburstDataLabels DataLabels_DefaultValue { get; set; }
		...
		/// </summary>
		public ArearangeSeriesSunburstLevelIsConstant LevelIsConstant { get; set; }
		private ArearangeSeriesSunburstLevelIsConstant LevelIsConstant_DefaultValue { get; set; }
