...
{
	public partial class ArearangeSeriesSunburstData  : BaseObject
	{
		public ArearangeSeriesSunburstData()
		{
		...
		/// </summary>
		public ArearangeSeriesSunburstDataEvents Events { get; set; }
		private ArearangeSeriesSunburstDataEvents Events_DefaultValue { get; set; }
