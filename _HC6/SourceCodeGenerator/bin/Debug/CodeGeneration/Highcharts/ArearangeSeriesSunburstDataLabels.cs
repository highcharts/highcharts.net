...
{
	public partial class ArearangeSeriesSunburstDataLabels  : BaseObject
	{
		public ArearangeSeriesSunburstDataLabels()
		{
		...
		/// 
		/// </summary>
		public ArearangeSeriesSunburstDataLabelsDefer Defer { get; set; }
		private ArearangeSeriesSunburstDataLabelsDefer Defer_DefaultValue { get; set; }
		 

		/// <summary>
		/// 
		/// </summary>
		public ArearangeSeriesSunburstDataLabelsStyle Style { get; set; }
		private ArearangeSeriesSunburstDataLabelsStyle Style_DefaultValue { get; set; }
		...
		/// </summary>
		public ArearangeSeriesSunburstDataLabelsRotationMode RotationMode { get; set; }
		private ArearangeSeriesSunburstDataLabelsRotationMode RotationMode_DefaultValue { get; set; }
