...
{
	public partial class ArearangeSeriesSunburstLabel  : BaseObject
	{
		public ArearangeSeriesSunburstLabel()
		{
		...
		/// </summary>
		public ArearangeSeriesSunburstLabelEnabled Enabled { get; set; }
		private ArearangeSeriesSunburstLabelEnabled Enabled_DefaultValue { get; set; }
		 

		/// <summary>
		/// Allow labels to be placed distant to the graph if necessary,and draw a connector line to the graph.
		/// </summary>
		public ArearangeSeriesSunburstLabelConnectorAllowed ConnectorAllowed { get; set; }
		private ArearangeSeriesSunburstLabelConnectorAllowed ConnectorAllowed_DefaultValue { get; set; }
		 

		/// <summary>
		/// If the label is closer than this to a neighbour graph, draw aconnector.
		/// </summary>
		public ArearangeSeriesSunburstLabelConnectorNeighbourDistance ConnectorNeighbourDistance { get; set; }
		private ArearangeSeriesSunburstLabelConnectorNeighbourDistance ConnectorNeighbourDistance_DefaultValue { get; set; }
		...
		/// </summary>
		public ArearangeSeriesSunburstLabelStyle Style { get; set; }
		private ArearangeSeriesSunburstLabelStyle Style_DefaultValue { get; set; }
