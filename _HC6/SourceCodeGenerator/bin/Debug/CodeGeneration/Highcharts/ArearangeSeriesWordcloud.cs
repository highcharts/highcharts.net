...
{
	public partial class ArearangeSeriesWordcloud  : BaseObject
	{
		public ArearangeSeriesWordcloud()
		{
			Data = Data_DefaultValue = new List<SeriesArearangeWordcloudData>();
		...
		/// </summary>
		public List<SeriesArearangeWordcloudData> Data { get; set; }
		private List<SeriesArearangeWordcloudData> Data_DefaultValue { get; set; }
		 

		/// <summary>
		/// Series labels are placed as close to the series as possible in anatural way, seeking to avoid other series. The goal of thisfeature is to make the chart more easily readable, like if ahuman designer placed the labels in the optimal position.The series labels currently work with series types having a`graph` or an `area`.Requires the `series-label.js` module.
		/// </summary>
		public ArearangeSeriesWordcloudLabel Label { get; set; }
		private ArearangeSeriesWordcloudLabel Label_DefaultValue { get; set; }
		...
		/// </summary>
		public ArearangeSeriesWordcloudEvents Events { get; set; }
		private ArearangeSeriesWordcloudEvents Events_DefaultValue { get; set; }
		 

		/// <summary>
		/// Properties for each single point.
		/// </summary>
		public ArearangeSeriesWordcloudPoint Point { get; set; }
		private ArearangeSeriesWordcloudPoint Point_DefaultValue { get; set; }
		...
		/// 
		/// </summary>
		public ArearangeSeriesWordcloudStates States { get; set; }
		private ArearangeSeriesWordcloudStates States_DefaultValue { get; set; }
		 

		/// <summary>
		/// 
		/// </summary>
		public ArearangeSeriesWordcloudStickyTracking StickyTracking { get; set; }
		private ArearangeSeriesWordcloudStickyTracking StickyTracking_DefaultValue { get; set; }
		...
		/// 
		/// </summary>
		public ArearangeSeriesWordcloudBorderWidth BorderWidth { get; set; }
		private ArearangeSeriesWordcloudBorderWidth BorderWidth_DefaultValue { get; set; }
		 

		/// <summary>
		/// 
		/// </summary>
		public ArearangeSeriesWordcloudClip Clip { get; set; }
		private ArearangeSeriesWordcloudClip Clip_DefaultValue { get; set; }
		...
		/// </summary>
		public ArearangeSeriesWordcloudColorByPoint ColorByPoint { get; set; }
		private ArearangeSeriesWordcloudColorByPoint ColorByPoint_DefaultValue { get; set; }
		...
		/// </summary>
		public ArearangeSeriesWordcloudPlacementStrategy PlacementStrategy { get; set; }
		private ArearangeSeriesWordcloudPlacementStrategy PlacementStrategy_DefaultValue { get; set; }
		 

		/// <summary>
		/// Rotation options for the words in the wordcloud.
		/// </summary>
		public ArearangeSeriesWordcloudRotation Rotation { get; set; }
		private ArearangeSeriesWordcloudRotation Rotation_DefaultValue { get; set; }
		 

		/// <summary>
		/// 
		/// </summary>
		public ArearangeSeriesWordcloudShowInLegend ShowInLegend { get; set; }
		private ArearangeSeriesWordcloudShowInLegend ShowInLegend_DefaultValue { get; set; }
		...
		/// </summary>
		public ArearangeSeriesWordcloudSpiral Spiral { get; set; }
		private ArearangeSeriesWordcloudSpiral Spiral_DefaultValue { get; set; }
		...
		/// 
		/// </summary>
		public ArearangeSeriesWordcloudTooltip Tooltip { get; set; }
		private ArearangeSeriesWordcloudTooltip Tooltip_DefaultValue { get; set; }
