...
{
	public partial class ArearangeSeriesWordcloudLabel  : BaseObject
	{
		public ArearangeSeriesWordcloudLabel()
		{
		...
		/// </summary>
		public ArearangeSeriesWordcloudLabelEnabled Enabled { get; set; }
		private ArearangeSeriesWordcloudLabelEnabled Enabled_DefaultValue { get; set; }
		 

		/// <summary>
		/// Allow labels to be placed distant to the graph if necessary,and draw a connector line to the graph.
		/// </summary>
		public ArearangeSeriesWordcloudLabelConnectorAllowed ConnectorAllowed { get; set; }
		private ArearangeSeriesWordcloudLabelConnectorAllowed ConnectorAllowed_DefaultValue { get; set; }
		 

		/// <summary>
		/// If the label is closer than this to a neighbour graph, draw aconnector.
		/// </summary>
		public ArearangeSeriesWordcloudLabelConnectorNeighbourDistance ConnectorNeighbourDistance { get; set; }
		private ArearangeSeriesWordcloudLabelConnectorNeighbourDistance ConnectorNeighbourDistance_DefaultValue { get; set; }
		...
		/// </summary>
		public ArearangeSeriesWordcloudLabelStyle Style { get; set; }
		private ArearangeSeriesWordcloudLabelStyle Style_DefaultValue { get; set; }
