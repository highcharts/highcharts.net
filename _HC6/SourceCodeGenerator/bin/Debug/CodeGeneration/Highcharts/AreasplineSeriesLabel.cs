...
{
	public partial class AreasplineSeriesLabel  : BaseObject
	{
		public AreasplineSeriesLabel()
		{
			...
			Style = Style_DefaultValue = new AreasplineSeriesLabelStyle();
		...
		/// </summary>
		public AreasplineSeriesLabelEnabled Enabled { get; set; }
		private AreasplineSeriesLabelEnabled Enabled_DefaultValue { get; set; }
		 

		/// <summary>
		/// Allow labels to be placed distant to the graph if necessary,and draw a connector line to the graph.
		/// </summary>
		public AreasplineSeriesLabelConnectorAllowed ConnectorAllowed { get; set; }
		private AreasplineSeriesLabelConnectorAllowed ConnectorAllowed_DefaultValue { get; set; }
		 

		/// <summary>
		/// If the label is closer than this to a neighbour graph, draw aconnector.
		/// </summary>
		public AreasplineSeriesLabelConnectorNeighbourDistance ConnectorNeighbourDistance { get; set; }
		private AreasplineSeriesLabelConnectorNeighbourDistance ConnectorNeighbourDistance_DefaultValue { get; set; }
		...
		/// </summary>
		public AreasplineSeriesLabelStyle Style { get; set; }
		private AreasplineSeriesLabelStyle Style_DefaultValue { get; set; }
