...
{
	public partial class AreasplineSeriesSunburst  : BaseObject
	{
		public AreasplineSeriesSunburst()
		{
			Data = Data_DefaultValue = new List<SeriesAreasplineSunburstData>();
		...
		/// 
		/// </summary>
		public List<SeriesAreasplineSunburstData> Data { get; set; }
		private List<SeriesAreasplineSunburstData> Data_DefaultValue { get; set; }
		 

		/// <summary>
		/// Series labels are placed as close to the series as possible in anatural way, seeking to avoid other series. The goal of thisfeature is to make the chart more easily readable, like if ahuman designer placed the labels in the optimal position.The series labels currently work with series types having a`graph` or an `area`.Requires the `series-label.js` module.
		/// </summary>
		public AreasplineSeriesSunburstLabel Label { get; set; }
		private AreasplineSeriesSunburstLabel Label_DefaultValue { get; set; }
		...
		/// </summary>
		public AreasplineSeriesSunburstStickyTracking StickyTracking { get; set; }
		private AreasplineSeriesSunburstStickyTracking StickyTracking_DefaultValue { get; set; }
		 

		/// <summary>
		/// 
		/// </summary>
		public AreasplineSeriesSunburstTooltip Tooltip { get; set; }
		private AreasplineSeriesSunburstTooltip Tooltip_DefaultValue { get; set; }
		...
		/// 
		/// </summary>
		public AreasplineSeriesSunburstStates States { get; set; }
		private AreasplineSeriesSunburstStates States_DefaultValue { get; set; }
		...
		/// 
		/// </summary>
		public AreasplineSeriesSunburstEvents Events { get; set; }
		private AreasplineSeriesSunburstEvents Events_DefaultValue { get; set; }
		 

		/// <summary>
		/// 
		/// </summary>
		public AreasplineSeriesSunburstPoint Point { get; set; }
		private AreasplineSeriesSunburstPoint Point_DefaultValue { get; set; }
		...
		/// 
		/// </summary>
		public AreasplineSeriesSunburstDataLabels DataLabels { get; set; }
		private AreasplineSeriesSunburstDataLabels DataLabels_DefaultValue { get; set; }
		...
		/// </summary>
		public AreasplineSeriesSunburstLevelIsConstant LevelIsConstant { get; set; }
		private AreasplineSeriesSunburstLevelIsConstant LevelIsConstant_DefaultValue { get; set; }
