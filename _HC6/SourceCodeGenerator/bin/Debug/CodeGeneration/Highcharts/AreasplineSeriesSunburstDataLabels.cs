...
{
	public partial class AreasplineSeriesSunburstDataLabels  : BaseObject
	{
		public AreasplineSeriesSunburstDataLabels()
		{
		...
		/// 
		/// </summary>
		public AreasplineSeriesSunburstDataLabelsDefer Defer { get; set; }
		private AreasplineSeriesSunburstDataLabelsDefer Defer_DefaultValue { get; set; }
		 

		/// <summary>
		/// 
		/// </summary>
		public AreasplineSeriesSunburstDataLabelsStyle Style { get; set; }
		private AreasplineSeriesSunburstDataLabelsStyle Style_DefaultValue { get; set; }
		...
		/// </summary>
		public AreasplineSeriesSunburstDataLabelsRotationMode RotationMode { get; set; }
		private AreasplineSeriesSunburstDataLabelsRotationMode RotationMode_DefaultValue { get; set; }
