...
{
	public partial class AreasplineSeriesSunburstLabel  : BaseObject
	{
		public AreasplineSeriesSunburstLabel()
		{
		...
		/// </summary>
		public AreasplineSeriesSunburstLabelEnabled Enabled { get; set; }
		private AreasplineSeriesSunburstLabelEnabled Enabled_DefaultValue { get; set; }
		 

		/// <summary>
		/// Allow labels to be placed distant to the graph if necessary,and draw a connector line to the graph.
		/// </summary>
		public AreasplineSeriesSunburstLabelConnectorAllowed ConnectorAllowed { get; set; }
		private AreasplineSeriesSunburstLabelConnectorAllowed ConnectorAllowed_DefaultValue { get; set; }
		 

		/// <summary>
		/// If the label is closer than this to a neighbour graph, draw aconnector.
		/// </summary>
		public AreasplineSeriesSunburstLabelConnectorNeighbourDistance ConnectorNeighbourDistance { get; set; }
		private AreasplineSeriesSunburstLabelConnectorNeighbourDistance ConnectorNeighbourDistance_DefaultValue { get; set; }
		...
		/// </summary>
		public AreasplineSeriesSunburstLabelStyle Style { get; set; }
		private AreasplineSeriesSunburstLabelStyle Style_DefaultValue { get; set; }
