...
{
	public partial class AreasplineSeriesWordcloud  : BaseObject
	{
		public AreasplineSeriesWordcloud()
		{
			Data = Data_DefaultValue = new List<SeriesAreasplineWordcloudData>();
		...
		/// </summary>
		public List<SeriesAreasplineWordcloudData> Data { get; set; }
		private List<SeriesAreasplineWordcloudData> Data_DefaultValue { get; set; }
		 

		/// <summary>
		/// Series labels are placed as close to the series as possible in anatural way, seeking to avoid other series. The goal of thisfeature is to make the chart more easily readable, like if ahuman designer placed the labels in the optimal position.The series labels currently work with series types having a`graph` or an `area`.Requires the `series-label.js` module.
		/// </summary>
		public AreasplineSeriesWordcloudLabel Label { get; set; }
		private AreasplineSeriesWordcloudLabel Label_DefaultValue { get; set; }
		...
		/// </summary>
		public AreasplineSeriesWordcloudEvents Events { get; set; }
		private AreasplineSeriesWordcloudEvents Events_DefaultValue { get; set; }
		 

		/// <summary>
		/// Properties for each single point.
		/// </summary>
		public AreasplineSeriesWordcloudPoint Point { get; set; }
		private AreasplineSeriesWordcloudPoint Point_DefaultValue { get; set; }
		...
		/// 
		/// </summary>
		public AreasplineSeriesWordcloudStates States { get; set; }
		private AreasplineSeriesWordcloudStates States_DefaultValue { get; set; }
		 

		/// <summary>
		/// 
		/// </summary>
		public AreasplineSeriesWordcloudStickyTracking StickyTracking { get; set; }
		private AreasplineSeriesWordcloudStickyTracking StickyTracking_DefaultValue { get; set; }
		...
		/// 
		/// </summary>
		public AreasplineSeriesWordcloudBorderWidth BorderWidth { get; set; }
		private AreasplineSeriesWordcloudBorderWidth BorderWidth_DefaultValue { get; set; }
		 

		/// <summary>
		/// 
		/// </summary>
		public AreasplineSeriesWordcloudClip Clip { get; set; }
		private AreasplineSeriesWordcloudClip Clip_DefaultValue { get; set; }
		...
		/// </summary>
		public AreasplineSeriesWordcloudColorByPoint ColorByPoint { get; set; }
		private AreasplineSeriesWordcloudColorByPoint ColorByPoint_DefaultValue { get; set; }
		...
		/// </summary>
		public AreasplineSeriesWordcloudPlacementStrategy PlacementStrategy { get; set; }
		private AreasplineSeriesWordcloudPlacementStrategy PlacementStrategy_DefaultValue { get; set; }
		 

		/// <summary>
		/// Rotation options for the words in the wordcloud.
		/// </summary>
		public AreasplineSeriesWordcloudRotation Rotation { get; set; }
		private AreasplineSeriesWordcloudRotation Rotation_DefaultValue { get; set; }
		 

		/// <summary>
		/// 
		/// </summary>
		public AreasplineSeriesWordcloudShowInLegend ShowInLegend { get; set; }
		private AreasplineSeriesWordcloudShowInLegend ShowInLegend_DefaultValue { get; set; }
		...
		/// </summary>
		public AreasplineSeriesWordcloudSpiral Spiral { get; set; }
		private AreasplineSeriesWordcloudSpiral Spiral_DefaultValue { get; set; }
		...
		/// 
		/// </summary>
		public AreasplineSeriesWordcloudTooltip Tooltip { get; set; }
		private AreasplineSeriesWordcloudTooltip Tooltip_DefaultValue { get; set; }
