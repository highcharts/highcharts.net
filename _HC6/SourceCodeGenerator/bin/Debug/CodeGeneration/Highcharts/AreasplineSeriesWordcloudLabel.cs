...
{
	public partial class AreasplineSeriesWordcloudLabel  : BaseObject
	{
		public AreasplineSeriesWordcloudLabel()
		{
		...
		/// </summary>
		public AreasplineSeriesWordcloudLabelEnabled Enabled { get; set; }
		private AreasplineSeriesWordcloudLabelEnabled Enabled_DefaultValue { get; set; }
		 

		/// <summary>
		/// Allow labels to be placed distant to the graph if necessary,and draw a connector line to the graph.
		/// </summary>
		public AreasplineSeriesWordcloudLabelConnectorAllowed ConnectorAllowed { get; set; }
		private AreasplineSeriesWordcloudLabelConnectorAllowed ConnectorAllowed_DefaultValue { get; set; }
		 

		/// <summary>
		/// If the label is closer than this to a neighbour graph, draw aconnector.
		/// </summary>
		public AreasplineSeriesWordcloudLabelConnectorNeighbourDistance ConnectorNeighbourDistance { get; set; }
		private AreasplineSeriesWordcloudLabelConnectorNeighbourDistance ConnectorNeighbourDistance_DefaultValue { get; set; }
		...
		/// </summary>
		public AreasplineSeriesWordcloudLabelStyle Style { get; set; }
		private AreasplineSeriesWordcloudLabelStyle Style_DefaultValue { get; set; }
