...
{
	public partial class AreasplinerangeSeriesSunburst  : BaseObject
	{
		public AreasplinerangeSeriesSunburst()
		{
			Data = Data_DefaultValue = new List<SeriesAreasplinerangeSunburstData>();
		...
		/// 
		/// </summary>
		public List<SeriesAreasplinerangeSunburstData> Data { get; set; }
		private List<SeriesAreasplinerangeSunburstData> Data_DefaultValue { get; set; }
		 

		/// <summary>
		/// Series labels are placed as close to the series as possible in anatural way, seeking to avoid other series. The goal of thisfeature is to make the chart more easily readable, like if ahuman designer placed the labels in the optimal position.The series labels currently work with series types having a`graph` or an `area`.Requires the `series-label.js` module.
		/// </summary>
		public AreasplinerangeSeriesSunburstLabel Label { get; set; }
		private AreasplinerangeSeriesSunburstLabel Label_DefaultValue { get; set; }
		...
		/// </summary>
		public AreasplinerangeSeriesSunburstStickyTracking StickyTracking { get; set; }
		private AreasplinerangeSeriesSunburstStickyTracking StickyTracking_DefaultValue { get; set; }
		 

		/// <summary>
		/// 
		/// </summary>
		public AreasplinerangeSeriesSunburstTooltip Tooltip { get; set; }
		private AreasplinerangeSeriesSunburstTooltip Tooltip_DefaultValue { get; set; }
		...
		/// 
		/// </summary>
		public AreasplinerangeSeriesSunburstStates States { get; set; }
		private AreasplinerangeSeriesSunburstStates States_DefaultValue { get; set; }
		...
		/// 
		/// </summary>
		public AreasplinerangeSeriesSunburstEvents Events { get; set; }
		private AreasplinerangeSeriesSunburstEvents Events_DefaultValue { get; set; }
		 

		/// <summary>
		/// 
		/// </summary>
		public AreasplinerangeSeriesSunburstPoint Point { get; set; }
		private AreasplinerangeSeriesSunburstPoint Point_DefaultValue { get; set; }
		...
		/// 
		/// </summary>
		public AreasplinerangeSeriesSunburstDataLabels DataLabels { get; set; }
		private AreasplinerangeSeriesSunburstDataLabels DataLabels_DefaultValue { get; set; }
		...
		/// </summary>
		public AreasplinerangeSeriesSunburstLevelIsConstant LevelIsConstant { get; set; }
		private AreasplinerangeSeriesSunburstLevelIsConstant LevelIsConstant_DefaultValue { get; set; }
