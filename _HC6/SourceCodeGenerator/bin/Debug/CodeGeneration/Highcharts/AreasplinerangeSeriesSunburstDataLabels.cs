...
{
	public partial class AreasplinerangeSeriesSunburstDataLabels  : BaseObject
	{
		public AreasplinerangeSeriesSunburstDataLabels()
		{
		...
		/// 
		/// </summary>
		public AreasplinerangeSeriesSunburstDataLabelsDefer Defer { get; set; }
		private AreasplinerangeSeriesSunburstDataLabelsDefer Defer_DefaultValue { get; set; }
		 

		/// <summary>
		/// 
		/// </summary>
		public AreasplinerangeSeriesSunburstDataLabelsStyle Style { get; set; }
		private AreasplinerangeSeriesSunburstDataLabelsStyle Style_DefaultValue { get; set; }
		...
		/// </summary>
		public AreasplinerangeSeriesSunburstDataLabelsRotationMode RotationMode { get; set; }
		private AreasplinerangeSeriesSunburstDataLabelsRotationMode RotationMode_DefaultValue { get; set; }
