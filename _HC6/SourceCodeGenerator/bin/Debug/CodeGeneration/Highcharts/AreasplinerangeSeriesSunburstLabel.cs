...
{
	public partial class AreasplinerangeSeriesSunburstLabel  : BaseObject
	{
		public AreasplinerangeSeriesSunburstLabel()
		{
		...
		/// </summary>
		public AreasplinerangeSeriesSunburstLabelEnabled Enabled { get; set; }
		private AreasplinerangeSeriesSunburstLabelEnabled Enabled_DefaultValue { get; set; }
		 

		/// <summary>
		/// Allow labels to be placed distant to the graph if necessary,and draw a connector line to the graph.
		/// </summary>
		public AreasplinerangeSeriesSunburstLabelConnectorAllowed ConnectorAllowed { get; set; }
		private AreasplinerangeSeriesSunburstLabelConnectorAllowed ConnectorAllowed_DefaultValue { get; set; }
		 

		/// <summary>
		/// If the label is closer than this to a neighbour graph, draw aconnector.
		/// </summary>
		public AreasplinerangeSeriesSunburstLabelConnectorNeighbourDistance ConnectorNeighbourDistance { get; set; }
		private AreasplinerangeSeriesSunburstLabelConnectorNeighbourDistance ConnectorNeighbourDistance_DefaultValue { get; set; }
		...
		/// </summary>
		public AreasplinerangeSeriesSunburstLabelStyle Style { get; set; }
		private AreasplinerangeSeriesSunburstLabelStyle Style_DefaultValue { get; set; }
