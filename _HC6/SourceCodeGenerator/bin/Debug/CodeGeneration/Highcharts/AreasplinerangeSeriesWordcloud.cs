...
{
	public partial class AreasplinerangeSeriesWordcloud  : BaseObject
	{
		public AreasplinerangeSeriesWordcloud()
		{
			Data = Data_DefaultValue = new List<SeriesAreasplinerangeWordcloudData>();
		...
		/// </summary>
		public List<SeriesAreasplinerangeWordcloudData> Data { get; set; }
		private List<SeriesAreasplinerangeWordcloudData> Data_DefaultValue { get; set; }
		 

		/// <summary>
		/// Series labels are placed as close to the series as possible in anatural way, seeking to avoid other series. The goal of thisfeature is to make the chart more easily readable, like if ahuman designer placed the labels in the optimal position.The series labels currently work with series types having a`graph` or an `area`.Requires the `series-label.js` module.
		/// </summary>
		public AreasplinerangeSeriesWordcloudLabel Label { get; set; }
		private AreasplinerangeSeriesWordcloudLabel Label_DefaultValue { get; set; }
		...
		/// </summary>
		public AreasplinerangeSeriesWordcloudEvents Events { get; set; }
		private AreasplinerangeSeriesWordcloudEvents Events_DefaultValue { get; set; }
		 

		/// <summary>
		/// Properties for each single point.
		/// </summary>
		public AreasplinerangeSeriesWordcloudPoint Point { get; set; }
		private AreasplinerangeSeriesWordcloudPoint Point_DefaultValue { get; set; }
		...
		/// 
		/// </summary>
		public AreasplinerangeSeriesWordcloudStates States { get; set; }
		private AreasplinerangeSeriesWordcloudStates States_DefaultValue { get; set; }
		 

		/// <summary>
		/// 
		/// </summary>
		public AreasplinerangeSeriesWordcloudStickyTracking StickyTracking { get; set; }
		private AreasplinerangeSeriesWordcloudStickyTracking StickyTracking_DefaultValue { get; set; }
		...
		/// 
		/// </summary>
		public AreasplinerangeSeriesWordcloudBorderWidth BorderWidth { get; set; }
		private AreasplinerangeSeriesWordcloudBorderWidth BorderWidth_DefaultValue { get; set; }
		 

		/// <summary>
		/// 
		/// </summary>
		public AreasplinerangeSeriesWordcloudClip Clip { get; set; }
		private AreasplinerangeSeriesWordcloudClip Clip_DefaultValue { get; set; }
		...
		/// </summary>
		public AreasplinerangeSeriesWordcloudColorByPoint ColorByPoint { get; set; }
		private AreasplinerangeSeriesWordcloudColorByPoint ColorByPoint_DefaultValue { get; set; }
		...
		/// </summary>
		public AreasplinerangeSeriesWordcloudPlacementStrategy PlacementStrategy { get; set; }
		private AreasplinerangeSeriesWordcloudPlacementStrategy PlacementStrategy_DefaultValue { get; set; }
		 

		/// <summary>
		/// Rotation options for the words in the wordcloud.
		/// </summary>
		public AreasplinerangeSeriesWordcloudRotation Rotation { get; set; }
		private AreasplinerangeSeriesWordcloudRotation Rotation_DefaultValue { get; set; }
		 

		/// <summary>
		/// 
		/// </summary>
		public AreasplinerangeSeriesWordcloudShowInLegend ShowInLegend { get; set; }
		private AreasplinerangeSeriesWordcloudShowInLegend ShowInLegend_DefaultValue { get; set; }
		...
		/// </summary>
		public AreasplinerangeSeriesWordcloudSpiral Spiral { get; set; }
		private AreasplinerangeSeriesWordcloudSpiral Spiral_DefaultValue { get; set; }
		...
		/// 
		/// </summary>
		public AreasplinerangeSeriesWordcloudTooltip Tooltip { get; set; }
		private AreasplinerangeSeriesWordcloudTooltip Tooltip_DefaultValue { get; set; }
