...
{
	public partial class AreasplinerangeSeriesWordcloudLabel  : BaseObject
	{
		public AreasplinerangeSeriesWordcloudLabel()
		{
		...
		/// </summary>
		public AreasplinerangeSeriesWordcloudLabelEnabled Enabled { get; set; }
		private AreasplinerangeSeriesWordcloudLabelEnabled Enabled_DefaultValue { get; set; }
		 

		/// <summary>
		/// Allow labels to be placed distant to the graph if necessary,and draw a connector line to the graph.
		/// </summary>
		public AreasplinerangeSeriesWordcloudLabelConnectorAllowed ConnectorAllowed { get; set; }
		private AreasplinerangeSeriesWordcloudLabelConnectorAllowed ConnectorAllowed_DefaultValue { get; set; }
		 

		/// <summary>
		/// If the label is closer than this to a neighbour graph, draw aconnector.
		/// </summary>
		public AreasplinerangeSeriesWordcloudLabelConnectorNeighbourDistance ConnectorNeighbourDistance { get; set; }
		private AreasplinerangeSeriesWordcloudLabelConnectorNeighbourDistance ConnectorNeighbourDistance_DefaultValue { get; set; }
		...
		/// </summary>
		public AreasplinerangeSeriesWordcloudLabelStyle Style { get; set; }
		private AreasplinerangeSeriesWordcloudLabelStyle Style_DefaultValue { get; set; }
