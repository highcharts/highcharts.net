...
{
	public partial class BarSeriesSunburstDataLabels  : BaseObject
	{
		public BarSeriesSunburstDataLabels()
		{
		...
		/// 
		/// </summary>
		public BarSeriesSunburstDataLabelsDefer Defer { get; set; }
		private BarSeriesSunburstDataLabelsDefer Defer_DefaultValue { get; set; }
		 

		/// <summary>
		/// 
		/// </summary>
		public BarSeriesSunburstDataLabelsStyle Style { get; set; }
		private BarSeriesSunburstDataLabelsStyle Style_DefaultValue { get; set; }
		...
		/// </summary>
		public BarSeriesSunburstDataLabelsRotationMode RotationMode { get; set; }
		private BarSeriesSunburstDataLabelsRotationMode RotationMode_DefaultValue { get; set; }
