...
{
	public partial class BarSeriesSunburstLabel  : BaseObject
	{
		public BarSeriesSunburstLabel()
		{
		...
		/// </summary>
		public BarSeriesSunburstLabelEnabled Enabled { get; set; }
		private BarSeriesSunburstLabelEnabled Enabled_DefaultValue { get; set; }
		 

		/// <summary>
		/// Allow labels to be placed distant to the graph if necessary,and draw a connector line to the graph.
		/// </summary>
		public BarSeriesSunburstLabelConnectorAllowed ConnectorAllowed { get; set; }
		private BarSeriesSunburstLabelConnectorAllowed ConnectorAllowed_DefaultValue { get; set; }
		 

		/// <summary>
		/// If the label is closer than this to a neighbour graph, draw aconnector.
		/// </summary>
		public BarSeriesSunburstLabelConnectorNeighbourDistance ConnectorNeighbourDistance { get; set; }
		private BarSeriesSunburstLabelConnectorNeighbourDistance ConnectorNeighbourDistance_DefaultValue { get; set; }
		...
		/// </summary>
		public BarSeriesSunburstLabelStyle Style { get; set; }
		private BarSeriesSunburstLabelStyle Style_DefaultValue { get; set; }
