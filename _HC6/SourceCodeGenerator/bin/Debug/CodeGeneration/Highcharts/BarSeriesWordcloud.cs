...
{
	public partial class BarSeriesWordcloud  : BaseObject
	{
		public BarSeriesWordcloud()
		{
			Data = Data_DefaultValue = new List<SeriesBarWordcloudData>();
		...
		/// </summary>
		public List<SeriesBarWordcloudData> Data { get; set; }
		private List<SeriesBarWordcloudData> Data_DefaultValue { get; set; }
		 

		/// <summary>
		/// Series labels are placed as close to the series as possible in anatural way, seeking to avoid other series. The goal of thisfeature is to make the chart more easily readable, like if ahuman designer placed the labels in the optimal position.The series labels currently work with series types having a`graph` or an `area`.Requires the `series-label.js` module.
		/// </summary>
		public BarSeriesWordcloudLabel Label { get; set; }
		private BarSeriesWordcloudLabel Label_DefaultValue { get; set; }
		...
		/// </summary>
		public BarSeriesWordcloudEvents Events { get; set; }
		private BarSeriesWordcloudEvents Events_DefaultValue { get; set; }
		 

		/// <summary>
		/// Properties for each single point.
		/// </summary>
		public BarSeriesWordcloudPoint Point { get; set; }
		private BarSeriesWordcloudPoint Point_DefaultValue { get; set; }
		...
		/// 
		/// </summary>
		public BarSeriesWordcloudStates States { get; set; }
		private BarSeriesWordcloudStates States_DefaultValue { get; set; }
		 

		/// <summary>
		/// 
		/// </summary>
		public BarSeriesWordcloudStickyTracking StickyTracking { get; set; }
		private BarSeriesWordcloudStickyTracking StickyTracking_DefaultValue { get; set; }
		...
		/// 
		/// </summary>
		public BarSeriesWordcloudBorderWidth BorderWidth { get; set; }
		private BarSeriesWordcloudBorderWidth BorderWidth_DefaultValue { get; set; }
		 

		/// <summary>
		/// 
		/// </summary>
		public BarSeriesWordcloudClip Clip { get; set; }
		private BarSeriesWordcloudClip Clip_DefaultValue { get; set; }
		...
		/// </summary>
		public BarSeriesWordcloudColorByPoint ColorByPoint { get; set; }
		private BarSeriesWordcloudColorByPoint ColorByPoint_DefaultValue { get; set; }
		...
		/// </summary>
		public BarSeriesWordcloudPlacementStrategy PlacementStrategy { get; set; }
		private BarSeriesWordcloudPlacementStrategy PlacementStrategy_DefaultValue { get; set; }
		 

		/// <summary>
		/// Rotation options for the words in the wordcloud.
		/// </summary>
		public BarSeriesWordcloudRotation Rotation { get; set; }
		private BarSeriesWordcloudRotation Rotation_DefaultValue { get; set; }
		 

		/// <summary>
		/// 
		/// </summary>
		public BarSeriesWordcloudShowInLegend ShowInLegend { get; set; }
		private BarSeriesWordcloudShowInLegend ShowInLegend_DefaultValue { get; set; }
		...
		/// </summary>
		public BarSeriesWordcloudSpiral Spiral { get; set; }
		private BarSeriesWordcloudSpiral Spiral_DefaultValue { get; set; }
		...
		/// 
		/// </summary>
		public BarSeriesWordcloudTooltip Tooltip { get; set; }
		private BarSeriesWordcloudTooltip Tooltip_DefaultValue { get; set; }
