...
{
	public partial class BarSeriesWordcloudLabel  : BaseObject
	{
		public BarSeriesWordcloudLabel()
		{
		...
		/// </summary>
		public BarSeriesWordcloudLabelEnabled Enabled { get; set; }
		private BarSeriesWordcloudLabelEnabled Enabled_DefaultValue { get; set; }
		 

		/// <summary>
		/// Allow labels to be placed distant to the graph if necessary,and draw a connector line to the graph.
		/// </summary>
		public BarSeriesWordcloudLabelConnectorAllowed ConnectorAllowed { get; set; }
		private BarSeriesWordcloudLabelConnectorAllowed ConnectorAllowed_DefaultValue { get; set; }
		 

		/// <summary>
		/// If the label is closer than this to a neighbour graph, draw aconnector.
		/// </summary>
		public BarSeriesWordcloudLabelConnectorNeighbourDistance ConnectorNeighbourDistance { get; set; }
		private BarSeriesWordcloudLabelConnectorNeighbourDistance ConnectorNeighbourDistance_DefaultValue { get; set; }
		...
		/// </summary>
		public BarSeriesWordcloudLabelStyle Style { get; set; }
		private BarSeriesWordcloudLabelStyle Style_DefaultValue { get; set; }
