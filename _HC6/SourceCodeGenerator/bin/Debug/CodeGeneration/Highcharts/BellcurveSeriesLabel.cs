...
{
	public partial class BellcurveSeriesLabel  : BaseObject
	{
		public BellcurveSeriesLabel()
		{
			...
			Style = Style_DefaultValue = new BellcurveSeriesLabelStyle();
		...
		/// </summary>
		public BellcurveSeriesLabelEnabled Enabled { get; set; }
		private BellcurveSeriesLabelEnabled Enabled_DefaultValue { get; set; }
		 

		/// <summary>
		/// Allow labels to be placed distant to the graph if necessary,and draw a connector line to the graph.
		/// </summary>
		public BellcurveSeriesLabelConnectorAllowed ConnectorAllowed { get; set; }
		private BellcurveSeriesLabelConnectorAllowed ConnectorAllowed_DefaultValue { get; set; }
		 

		/// <summary>
		/// If the label is closer than this to a neighbour graph, draw aconnector.
		/// </summary>
		public BellcurveSeriesLabelConnectorNeighbourDistance ConnectorNeighbourDistance { get; set; }
		private BellcurveSeriesLabelConnectorNeighbourDistance ConnectorNeighbourDistance_DefaultValue { get; set; }
		...
		/// </summary>
		public BellcurveSeriesLabelStyle Style { get; set; }
		private BellcurveSeriesLabelStyle Style_DefaultValue { get; set; }
