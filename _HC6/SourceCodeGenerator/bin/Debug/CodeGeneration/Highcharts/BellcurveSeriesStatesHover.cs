...
{
	public partial class BellcurveSeriesStatesHover  : BaseObject
	{
		public BellcurveSeriesStatesHover()
		{
			Animation = Animation_DefaultValue = new Animation() { Enabled = true };
			LineWidthPlus = LineWidthPlus_DefaultValue = 1;
			Marker = Marker_DefaultValue = new BellcurveSeriesStatesHoverMarker();
			Halo = Halo_DefaultValue = new BellcurveSeriesStatesHoverHalo();
		...
		/// </summary>
		public BellcurveSeriesStatesHoverMarker Marker { get; set; }
		private BellcurveSeriesStatesHoverMarker Marker_DefaultValue { get; set; }
		...
		/// </summary>
		public BellcurveSeriesStatesHoverHalo Halo { get; set; }
		private BellcurveSeriesStatesHoverHalo Halo_DefaultValue { get; set; }
