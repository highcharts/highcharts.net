...
{
	public partial class BellcurveSeriesSunburst  : BaseObject
	{
		public BellcurveSeriesSunburst()
		{
			Data = Data_DefaultValue = new List<SeriesBellcurveSunburstData>();
		...
		/// 
		/// </summary>
		public List<SeriesBellcurveSunburstData> Data { get; set; }
		private List<SeriesBellcurveSunburstData> Data_DefaultValue { get; set; }
		 

		/// <summary>
		/// Series labels are placed as close to the series as possible in anatural way, seeking to avoid other series. The goal of thisfeature is to make the chart more easily readable, like if ahuman designer placed the labels in the optimal position.The series labels currently work with series types having a`graph` or an `area`.Requires the `series-label.js` module.
		/// </summary>
		public BellcurveSeriesSunburstLabel Label { get; set; }
		private BellcurveSeriesSunburstLabel Label_DefaultValue { get; set; }
		...
		/// </summary>
		public BellcurveSeriesSunburstStickyTracking StickyTracking { get; set; }
		private BellcurveSeriesSunburstStickyTracking StickyTracking_DefaultValue { get; set; }
		 

		/// <summary>
		/// 
		/// </summary>
		public BellcurveSeriesSunburstTooltip Tooltip { get; set; }
		private BellcurveSeriesSunburstTooltip Tooltip_DefaultValue { get; set; }
		...
		/// 
		/// </summary>
		public BellcurveSeriesSunburstStates States { get; set; }
		private BellcurveSeriesSunburstStates States_DefaultValue { get; set; }
		...
		/// 
		/// </summary>
		public BellcurveSeriesSunburstEvents Events { get; set; }
		private BellcurveSeriesSunburstEvents Events_DefaultValue { get; set; }
		 

		/// <summary>
		/// 
		/// </summary>
		public BellcurveSeriesSunburstPoint Point { get; set; }
		private BellcurveSeriesSunburstPoint Point_DefaultValue { get; set; }
		...
		/// </summary>
		public BellcurveSeriesSunburstLevelIsConstant LevelIsConstant { get; set; }
		private BellcurveSeriesSunburstLevelIsConstant LevelIsConstant_DefaultValue { get; set; }
