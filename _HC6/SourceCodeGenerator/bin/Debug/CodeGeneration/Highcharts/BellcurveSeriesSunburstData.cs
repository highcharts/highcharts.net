...
{
	public partial class BellcurveSeriesSunburstData  : BaseObject
	{
		public BellcurveSeriesSunburstData()
		{
		...
		/// </summary>
		public BellcurveSeriesSunburstDataEvents Events { get; set; }
		private BellcurveSeriesSunburstDataEvents Events_DefaultValue { get; set; }
