...
{
	public partial class BellcurveSeriesSunburstDataLabels  : BaseObject
	{
		public BellcurveSeriesSunburstDataLabels()
		{
		...
		/// 
		/// </summary>
		public BellcurveSeriesSunburstDataLabelsDefer Defer { get; set; }
		private BellcurveSeriesSunburstDataLabelsDefer Defer_DefaultValue { get; set; }
		 

		/// <summary>
		/// 
		/// </summary>
		public BellcurveSeriesSunburstDataLabelsStyle Style { get; set; }
		private BellcurveSeriesSunburstDataLabelsStyle Style_DefaultValue { get; set; }
		...
		/// </summary>
		public BellcurveSeriesSunburstDataLabelsRotationMode RotationMode { get; set; }
		private BellcurveSeriesSunburstDataLabelsRotationMode RotationMode_DefaultValue { get; set; }
