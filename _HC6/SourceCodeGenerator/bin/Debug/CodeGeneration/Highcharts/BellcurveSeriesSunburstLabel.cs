...
{
	public partial class BellcurveSeriesSunburstLabel  : BaseObject
	{
		public BellcurveSeriesSunburstLabel()
		{
		...
		/// </summary>
		public BellcurveSeriesSunburstLabelEnabled Enabled { get; set; }
		private BellcurveSeriesSunburstLabelEnabled Enabled_DefaultValue { get; set; }
		 

		/// <summary>
		/// Allow labels to be placed distant to the graph if necessary,and draw a connector line to the graph.
		/// </summary>
		public BellcurveSeriesSunburstLabelConnectorAllowed ConnectorAllowed { get; set; }
		private BellcurveSeriesSunburstLabelConnectorAllowed ConnectorAllowed_DefaultValue { get; set; }
		 

		/// <summary>
		/// If the label is closer than this to a neighbour graph, draw aconnector.
		/// </summary>
		public BellcurveSeriesSunburstLabelConnectorNeighbourDistance ConnectorNeighbourDistance { get; set; }
		private BellcurveSeriesSunburstLabelConnectorNeighbourDistance ConnectorNeighbourDistance_DefaultValue { get; set; }
		...
		/// </summary>
		public BellcurveSeriesSunburstLabelStyle Style { get; set; }
		private BellcurveSeriesSunburstLabelStyle Style_DefaultValue { get; set; }
