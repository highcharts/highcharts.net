...
{
	public partial class BellcurveSeriesWordcloud  : BaseObject
	{
		public BellcurveSeriesWordcloud()
		{
			Data = Data_DefaultValue = new List<SeriesBellcurveWordcloudData>();
		...
		/// </summary>
		public List<SeriesBellcurveWordcloudData> Data { get; set; }
		private List<SeriesBellcurveWordcloudData> Data_DefaultValue { get; set; }
		 

		/// <summary>
		/// Series labels are placed as close to the series as possible in anatural way, seeking to avoid other series. The goal of thisfeature is to make the chart more easily readable, like if ahuman designer placed the labels in the optimal position.The series labels currently work with series types having a`graph` or an `area`.Requires the `series-label.js` module.
		/// </summary>
		public BellcurveSeriesWordcloudLabel Label { get; set; }
		private BellcurveSeriesWordcloudLabel Label_DefaultValue { get; set; }
		...
		/// </summary>
		public BellcurveSeriesWordcloudEvents Events { get; set; }
		private BellcurveSeriesWordcloudEvents Events_DefaultValue { get; set; }
		 

		/// <summary>
		/// Properties for each single point.
		/// </summary>
		public BellcurveSeriesWordcloudPoint Point { get; set; }
		private BellcurveSeriesWordcloudPoint Point_DefaultValue { get; set; }
		...
		/// 
		/// </summary>
		public BellcurveSeriesWordcloudStates States { get; set; }
		private BellcurveSeriesWordcloudStates States_DefaultValue { get; set; }
		 

		/// <summary>
		/// 
		/// </summary>
		public BellcurveSeriesWordcloudStickyTracking StickyTracking { get; set; }
		private BellcurveSeriesWordcloudStickyTracking StickyTracking_DefaultValue { get; set; }
		...
		/// 
		/// </summary>
		public BellcurveSeriesWordcloudBorderWidth BorderWidth { get; set; }
		private BellcurveSeriesWordcloudBorderWidth BorderWidth_DefaultValue { get; set; }
		 

		/// <summary>
		/// 
		/// </summary>
		public BellcurveSeriesWordcloudClip Clip { get; set; }
		private BellcurveSeriesWordcloudClip Clip_DefaultValue { get; set; }
		...
		/// </summary>
		public BellcurveSeriesWordcloudColorByPoint ColorByPoint { get; set; }
		private BellcurveSeriesWordcloudColorByPoint ColorByPoint_DefaultValue { get; set; }
		...
		/// </summary>
		public BellcurveSeriesWordcloudPlacementStrategy PlacementStrategy { get; set; }
		private BellcurveSeriesWordcloudPlacementStrategy PlacementStrategy_DefaultValue { get; set; }
		 

		/// <summary>
		/// Rotation options for the words in the wordcloud.
		/// </summary>
		public BellcurveSeriesWordcloudRotation Rotation { get; set; }
		private BellcurveSeriesWordcloudRotation Rotation_DefaultValue { get; set; }
		 

		/// <summary>
		/// 
		/// </summary>
		public BellcurveSeriesWordcloudShowInLegend ShowInLegend { get; set; }
		private BellcurveSeriesWordcloudShowInLegend ShowInLegend_DefaultValue { get; set; }
		...
		/// </summary>
		public BellcurveSeriesWordcloudSpiral Spiral { get; set; }
		private BellcurveSeriesWordcloudSpiral Spiral_DefaultValue { get; set; }
		...
		/// 
		/// </summary>
		public BellcurveSeriesWordcloudTooltip Tooltip { get; set; }
		private BellcurveSeriesWordcloudTooltip Tooltip_DefaultValue { get; set; }
