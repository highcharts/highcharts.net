...
{
	public partial class BellcurveSeriesWordcloudLabel  : BaseObject
	{
		public BellcurveSeriesWordcloudLabel()
		{
		...
		/// </summary>
		public BellcurveSeriesWordcloudLabelEnabled Enabled { get; set; }
		private BellcurveSeriesWordcloudLabelEnabled Enabled_DefaultValue { get; set; }
		 

		/// <summary>
		/// Allow labels to be placed distant to the graph if necessary,and draw a connector line to the graph.
		/// </summary>
		public BellcurveSeriesWordcloudLabelConnectorAllowed ConnectorAllowed { get; set; }
		private BellcurveSeriesWordcloudLabelConnectorAllowed ConnectorAllowed_DefaultValue { get; set; }
		 

		/// <summary>
		/// If the label is closer than this to a neighbour graph, draw aconnector.
		/// </summary>
		public BellcurveSeriesWordcloudLabelConnectorNeighbourDistance ConnectorNeighbourDistance { get; set; }
		private BellcurveSeriesWordcloudLabelConnectorNeighbourDistance ConnectorNeighbourDistance_DefaultValue { get; set; }
		...
		/// </summary>
		public BellcurveSeriesWordcloudLabelStyle Style { get; set; }
		private BellcurveSeriesWordcloudLabelStyle Style_DefaultValue { get; set; }
