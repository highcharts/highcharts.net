...
{
	public partial class BoxplotSeriesSunburstDataLabels  : BaseObject
	{
		public BoxplotSeriesSunburstDataLabels()
		{
		...
		/// 
		/// </summary>
		public BoxplotSeriesSunburstDataLabelsDefer Defer { get; set; }
		private BoxplotSeriesSunburstDataLabelsDefer Defer_DefaultValue { get; set; }
		 

		/// <summary>
		/// 
		/// </summary>
		public BoxplotSeriesSunburstDataLabelsStyle Style { get; set; }
		private BoxplotSeriesSunburstDataLabelsStyle Style_DefaultValue { get; set; }
		...
		/// </summary>
		public BoxplotSeriesSunburstDataLabelsRotationMode RotationMode { get; set; }
		private BoxplotSeriesSunburstDataLabelsRotationMode RotationMode_DefaultValue { get; set; }
