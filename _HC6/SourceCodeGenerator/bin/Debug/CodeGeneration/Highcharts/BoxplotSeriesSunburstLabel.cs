...
{
	public partial class BoxplotSeriesSunburstLabel  : BaseObject
	{
		public BoxplotSeriesSunburstLabel()
		{
		...
		/// </summary>
		public BoxplotSeriesSunburstLabelEnabled Enabled { get; set; }
		private BoxplotSeriesSunburstLabelEnabled Enabled_DefaultValue { get; set; }
		 

		/// <summary>
		/// Allow labels to be placed distant to the graph if necessary,and draw a connector line to the graph.
		/// </summary>
		public BoxplotSeriesSunburstLabelConnectorAllowed ConnectorAllowed { get; set; }
		private BoxplotSeriesSunburstLabelConnectorAllowed ConnectorAllowed_DefaultValue { get; set; }
		 

		/// <summary>
		/// If the label is closer than this to a neighbour graph, draw aconnector.
		/// </summary>
		public BoxplotSeriesSunburstLabelConnectorNeighbourDistance ConnectorNeighbourDistance { get; set; }
		private BoxplotSeriesSunburstLabelConnectorNeighbourDistance ConnectorNeighbourDistance_DefaultValue { get; set; }
		...
		/// </summary>
		public BoxplotSeriesSunburstLabelStyle Style { get; set; }
		private BoxplotSeriesSunburstLabelStyle Style_DefaultValue { get; set; }
