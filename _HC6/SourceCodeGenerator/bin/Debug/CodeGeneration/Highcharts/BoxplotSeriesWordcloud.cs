...
{
	public partial class BoxplotSeriesWordcloud  : BaseObject
	{
		public BoxplotSeriesWordcloud()
		{
			Data = Data_DefaultValue = new List<SeriesBoxplotWordcloudData>();
		...
		/// </summary>
		public List<SeriesBoxplotWordcloudData> Data { get; set; }
		private List<SeriesBoxplotWordcloudData> Data_DefaultValue { get; set; }
		 

		/// <summary>
		/// Series labels are placed as close to the series as possible in anatural way, seeking to avoid other series. The goal of thisfeature is to make the chart more easily readable, like if ahuman designer placed the labels in the optimal position.The series labels currently work with series types having a`graph` or an `area`.Requires the `series-label.js` module.
		/// </summary>
		public BoxplotSeriesWordcloudLabel Label { get; set; }
		private BoxplotSeriesWordcloudLabel Label_DefaultValue { get; set; }
		...
		/// </summary>
		public BoxplotSeriesWordcloudEvents Events { get; set; }
		private BoxplotSeriesWordcloudEvents Events_DefaultValue { get; set; }
		 

		/// <summary>
		/// Properties for each single point.
		/// </summary>
		public BoxplotSeriesWordcloudPoint Point { get; set; }
		private BoxplotSeriesWordcloudPoint Point_DefaultValue { get; set; }
		...
		/// 
		/// </summary>
		public BoxplotSeriesWordcloudStates States { get; set; }
		private BoxplotSeriesWordcloudStates States_DefaultValue { get; set; }
		 

		/// <summary>
		/// 
		/// </summary>
		public BoxplotSeriesWordcloudStickyTracking StickyTracking { get; set; }
		private BoxplotSeriesWordcloudStickyTracking StickyTracking_DefaultValue { get; set; }
		...
		/// 
		/// </summary>
		public BoxplotSeriesWordcloudBorderWidth BorderWidth { get; set; }
		private BoxplotSeriesWordcloudBorderWidth BorderWidth_DefaultValue { get; set; }
		 

		/// <summary>
		/// 
		/// </summary>
		public BoxplotSeriesWordcloudClip Clip { get; set; }
		private BoxplotSeriesWordcloudClip Clip_DefaultValue { get; set; }
		...
		/// </summary>
		public BoxplotSeriesWordcloudColorByPoint ColorByPoint { get; set; }
		private BoxplotSeriesWordcloudColorByPoint ColorByPoint_DefaultValue { get; set; }
		...
		/// </summary>
		public BoxplotSeriesWordcloudPlacementStrategy PlacementStrategy { get; set; }
		private BoxplotSeriesWordcloudPlacementStrategy PlacementStrategy_DefaultValue { get; set; }
		 

		/// <summary>
		/// Rotation options for the words in the wordcloud.
		/// </summary>
		public BoxplotSeriesWordcloudRotation Rotation { get; set; }
		private BoxplotSeriesWordcloudRotation Rotation_DefaultValue { get; set; }
		 

		/// <summary>
		/// 
		/// </summary>
		public BoxplotSeriesWordcloudShowInLegend ShowInLegend { get; set; }
		private BoxplotSeriesWordcloudShowInLegend ShowInLegend_DefaultValue { get; set; }
		...
		/// </summary>
		public BoxplotSeriesWordcloudSpiral Spiral { get; set; }
		private BoxplotSeriesWordcloudSpiral Spiral_DefaultValue { get; set; }
		...
		/// 
		/// </summary>
		public BoxplotSeriesWordcloudTooltip Tooltip { get; set; }
		private BoxplotSeriesWordcloudTooltip Tooltip_DefaultValue { get; set; }
