...
{
	public partial class BoxplotSeriesWordcloudLabel  : BaseObject
	{
		public BoxplotSeriesWordcloudLabel()
		{
		...
		/// </summary>
		public BoxplotSeriesWordcloudLabelEnabled Enabled { get; set; }
		private BoxplotSeriesWordcloudLabelEnabled Enabled_DefaultValue { get; set; }
		 

		/// <summary>
		/// Allow labels to be placed distant to the graph if necessary,and draw a connector line to the graph.
		/// </summary>
		public BoxplotSeriesWordcloudLabelConnectorAllowed ConnectorAllowed { get; set; }
		private BoxplotSeriesWordcloudLabelConnectorAllowed ConnectorAllowed_DefaultValue { get; set; }
		 

		/// <summary>
		/// If the label is closer than this to a neighbour graph, draw aconnector.
		/// </summary>
		public BoxplotSeriesWordcloudLabelConnectorNeighbourDistance ConnectorNeighbourDistance { get; set; }
		private BoxplotSeriesWordcloudLabelConnectorNeighbourDistance ConnectorNeighbourDistance_DefaultValue { get; set; }
		...
		/// </summary>
		public BoxplotSeriesWordcloudLabelStyle Style { get; set; }
		private BoxplotSeriesWordcloudLabelStyle Style_DefaultValue { get; set; }
