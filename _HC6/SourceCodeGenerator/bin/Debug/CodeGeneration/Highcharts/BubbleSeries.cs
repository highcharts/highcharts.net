...
namespace Highsoft.Web.Mvc.Charts
{
	public partial class BubbleSeries  : Series
	{
		...
		/// </summary>
		public List<SeriesBubbleData> Data { get; set; }
		private List<SeriesBubbleData> Data_DefaultValue { get; set; }
		...
		/// </summary>
		public BubbleSeriesSunburst Sunburst { get; set; }
		private BubbleSeriesSunburst Sunburst_DefaultValue { get; set; }
		...
		/// </summary>
		public BubbleSeriesWordcloud Wordcloud { get; set; }
		private BubbleSeriesWordcloud Wordcloud_DefaultValue { get; set; }
		...
		/// 
		/// </summary>
		public BubbleSeriesTurboThreshold TurboThreshold { get; set; }
		private BubbleSeriesTurboThreshold TurboThreshold_DefaultValue { get; set; }
		...
		/// 
		/// </summary>
		public BubbleSeriesZoneAxis ZoneAxis { get; set; }
		private BubbleSeriesZoneAxis ZoneAxis_DefaultValue { get; set; }
