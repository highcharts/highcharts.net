...
{
	public partial class BubbleSeriesLabel  : BaseObject
	{
		public BubbleSeriesLabel()
		{
			...
			Style = Style_DefaultValue = new BubbleSeriesLabelStyle();
		...
		/// </summary>
		public BubbleSeriesLabelEnabled Enabled { get; set; }
		private BubbleSeriesLabelEnabled Enabled_DefaultValue { get; set; }
		 

		/// <summary>
		/// Allow labels to be placed distant to the graph if necessary,and draw a connector line to the graph.
		/// </summary>
		public BubbleSeriesLabelConnectorAllowed ConnectorAllowed { get; set; }
		private BubbleSeriesLabelConnectorAllowed ConnectorAllowed_DefaultValue { get; set; }
		 

		/// <summary>
		/// If the label is closer than this to a neighbour graph, draw aconnector.
		/// </summary>
		public BubbleSeriesLabelConnectorNeighbourDistance ConnectorNeighbourDistance { get; set; }
		private BubbleSeriesLabelConnectorNeighbourDistance ConnectorNeighbourDistance_DefaultValue { get; set; }
		...
		/// </summary>
		public BubbleSeriesLabelStyle Style { get; set; }
		private BubbleSeriesLabelStyle Style_DefaultValue { get; set; }
