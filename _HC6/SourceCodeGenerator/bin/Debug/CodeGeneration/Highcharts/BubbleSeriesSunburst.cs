...
{
	public partial class BubbleSeriesSunburst  : BaseObject
	{
		public BubbleSeriesSunburst()
		{
			Data = Data_DefaultValue = new List<SeriesBubbleSunburstData>();
		...
		/// 
		/// </summary>
		public List<SeriesBubbleSunburstData> Data { get; set; }
		private List<SeriesBubbleSunburstData> Data_DefaultValue { get; set; }
		 

		/// <summary>
		/// Series labels are placed as close to the series as possible in anatural way, seeking to avoid other series. The goal of thisfeature is to make the chart more easily readable, like if ahuman designer placed the labels in the optimal position.The series labels currently work with series types having a`graph` or an `area`.Requires the `series-label.js` module.
		/// </summary>
		public BubbleSeriesSunburstLabel Label { get; set; }
		private BubbleSeriesSunburstLabel Label_DefaultValue { get; set; }
		...
		/// </summary>
		public BubbleSeriesSunburstStickyTracking StickyTracking { get; set; }
		private BubbleSeriesSunburstStickyTracking StickyTracking_DefaultValue { get; set; }
		 

		/// <summary>
		/// 
		/// </summary>
		public BubbleSeriesSunburstTooltip Tooltip { get; set; }
		private BubbleSeriesSunburstTooltip Tooltip_DefaultValue { get; set; }
		...
		/// 
		/// </summary>
		public BubbleSeriesSunburstStates States { get; set; }
		private BubbleSeriesSunburstStates States_DefaultValue { get; set; }
		...
		/// 
		/// </summary>
		public BubbleSeriesSunburstEvents Events { get; set; }
		private BubbleSeriesSunburstEvents Events_DefaultValue { get; set; }
		 

		/// <summary>
		/// 
		/// </summary>
		public BubbleSeriesSunburstPoint Point { get; set; }
		private BubbleSeriesSunburstPoint Point_DefaultValue { get; set; }
		...
		/// 
		/// </summary>
		public BubbleSeriesSunburstDataLabels DataLabels { get; set; }
		private BubbleSeriesSunburstDataLabels DataLabels_DefaultValue { get; set; }
		...
		/// </summary>
		public BubbleSeriesSunburstLevelIsConstant LevelIsConstant { get; set; }
		private BubbleSeriesSunburstLevelIsConstant LevelIsConstant_DefaultValue { get; set; }
