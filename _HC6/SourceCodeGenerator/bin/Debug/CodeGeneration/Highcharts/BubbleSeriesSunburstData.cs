...
{
	public partial class BubbleSeriesSunburstData  : BaseObject
	{
		public BubbleSeriesSunburstData()
		{
		...
		/// </summary>
		public BubbleSeriesSunburstDataEvents Events { get; set; }
		private BubbleSeriesSunburstDataEvents Events_DefaultValue { get; set; }
