...
{
	public partial class BubbleSeriesSunburstDataLabels  : BaseObject
	{
		public BubbleSeriesSunburstDataLabels()
		{
		...
		/// 
		/// </summary>
		public BubbleSeriesSunburstDataLabelsDefer Defer { get; set; }
		private BubbleSeriesSunburstDataLabelsDefer Defer_DefaultValue { get; set; }
		 

		/// <summary>
		/// 
		/// </summary>
		public BubbleSeriesSunburstDataLabelsStyle Style { get; set; }
		private BubbleSeriesSunburstDataLabelsStyle Style_DefaultValue { get; set; }
		...
		/// </summary>
		public BubbleSeriesSunburstDataLabelsRotationMode RotationMode { get; set; }
		private BubbleSeriesSunburstDataLabelsRotationMode RotationMode_DefaultValue { get; set; }
