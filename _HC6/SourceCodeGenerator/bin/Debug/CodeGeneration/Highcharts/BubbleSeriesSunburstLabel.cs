...
{
	public partial class BubbleSeriesSunburstLabel  : BaseObject
	{
		public BubbleSeriesSunburstLabel()
		{
		...
		/// </summary>
		public BubbleSeriesSunburstLabelEnabled Enabled { get; set; }
		private BubbleSeriesSunburstLabelEnabled Enabled_DefaultValue { get; set; }
		 

		/// <summary>
		/// Allow labels to be placed distant to the graph if necessary,and draw a connector line to the graph.
		/// </summary>
		public BubbleSeriesSunburstLabelConnectorAllowed ConnectorAllowed { get; set; }
		private BubbleSeriesSunburstLabelConnectorAllowed ConnectorAllowed_DefaultValue { get; set; }
		 

		/// <summary>
		/// If the label is closer than this to a neighbour graph, draw aconnector.
		/// </summary>
		public BubbleSeriesSunburstLabelConnectorNeighbourDistance ConnectorNeighbourDistance { get; set; }
		private BubbleSeriesSunburstLabelConnectorNeighbourDistance ConnectorNeighbourDistance_DefaultValue { get; set; }
		...
		/// </summary>
		public BubbleSeriesSunburstLabelStyle Style { get; set; }
		private BubbleSeriesSunburstLabelStyle Style_DefaultValue { get; set; }
