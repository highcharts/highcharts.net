...
{
	public partial class BubbleSeriesWordcloud  : BaseObject
	{
		public BubbleSeriesWordcloud()
		{
			Data = Data_DefaultValue = new List<SeriesBubbleWordcloudData>();
		...
		/// </summary>
		public List<SeriesBubbleWordcloudData> Data { get; set; }
		private List<SeriesBubbleWordcloudData> Data_DefaultValue { get; set; }
		 

		/// <summary>
		/// Series labels are placed as close to the series as possible in anatural way, seeking to avoid other series. The goal of thisfeature is to make the chart more easily readable, like if ahuman designer placed the labels in the optimal position.The series labels currently work with series types having a`graph` or an `area`.Requires the `series-label.js` module.
		/// </summary>
		public BubbleSeriesWordcloudLabel Label { get; set; }
		private BubbleSeriesWordcloudLabel Label_DefaultValue { get; set; }
		...
		/// </summary>
		public BubbleSeriesWordcloudEvents Events { get; set; }
		private BubbleSeriesWordcloudEvents Events_DefaultValue { get; set; }
		 

		/// <summary>
		/// Properties for each single point.
		/// </summary>
		public BubbleSeriesWordcloudPoint Point { get; set; }
		private BubbleSeriesWordcloudPoint Point_DefaultValue { get; set; }
		...
		/// 
		/// </summary>
		public BubbleSeriesWordcloudStates States { get; set; }
		private BubbleSeriesWordcloudStates States_DefaultValue { get; set; }
		 

		/// <summary>
		/// 
		/// </summary>
		public BubbleSeriesWordcloudStickyTracking StickyTracking { get; set; }
		private BubbleSeriesWordcloudStickyTracking StickyTracking_DefaultValue { get; set; }
		...
		/// 
		/// </summary>
		public BubbleSeriesWordcloudBorderWidth BorderWidth { get; set; }
		private BubbleSeriesWordcloudBorderWidth BorderWidth_DefaultValue { get; set; }
		 

		/// <summary>
		/// 
		/// </summary>
		public BubbleSeriesWordcloudClip Clip { get; set; }
		private BubbleSeriesWordcloudClip Clip_DefaultValue { get; set; }
		...
		/// </summary>
		public BubbleSeriesWordcloudColorByPoint ColorByPoint { get; set; }
		private BubbleSeriesWordcloudColorByPoint ColorByPoint_DefaultValue { get; set; }
		...
		/// </summary>
		public BubbleSeriesWordcloudPlacementStrategy PlacementStrategy { get; set; }
		private BubbleSeriesWordcloudPlacementStrategy PlacementStrategy_DefaultValue { get; set; }
		 

		/// <summary>
		/// Rotation options for the words in the wordcloud.
		/// </summary>
		public BubbleSeriesWordcloudRotation Rotation { get; set; }
		private BubbleSeriesWordcloudRotation Rotation_DefaultValue { get; set; }
		 

		/// <summary>
		/// 
		/// </summary>
		public BubbleSeriesWordcloudShowInLegend ShowInLegend { get; set; }
		private BubbleSeriesWordcloudShowInLegend ShowInLegend_DefaultValue { get; set; }
		...
		/// </summary>
		public BubbleSeriesWordcloudSpiral Spiral { get; set; }
		private BubbleSeriesWordcloudSpiral Spiral_DefaultValue { get; set; }
		...
		/// 
		/// </summary>
		public BubbleSeriesWordcloudTooltip Tooltip { get; set; }
		private BubbleSeriesWordcloudTooltip Tooltip_DefaultValue { get; set; }
