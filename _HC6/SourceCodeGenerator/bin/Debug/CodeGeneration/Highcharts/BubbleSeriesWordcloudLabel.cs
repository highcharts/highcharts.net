...
{
	public partial class BubbleSeriesWordcloudLabel  : BaseObject
	{
		public BubbleSeriesWordcloudLabel()
		{
		...
		/// </summary>
		public BubbleSeriesWordcloudLabelEnabled Enabled { get; set; }
		private BubbleSeriesWordcloudLabelEnabled Enabled_DefaultValue { get; set; }
		 

		/// <summary>
		/// Allow labels to be placed distant to the graph if necessary,and draw a connector line to the graph.
		/// </summary>
		public BubbleSeriesWordcloudLabelConnectorAllowed ConnectorAllowed { get; set; }
		private BubbleSeriesWordcloudLabelConnectorAllowed ConnectorAllowed_DefaultValue { get; set; }
		 

		/// <summary>
		/// If the label is closer than this to a neighbour graph, draw aconnector.
		/// </summary>
		public BubbleSeriesWordcloudLabelConnectorNeighbourDistance ConnectorNeighbourDistance { get; set; }
		private BubbleSeriesWordcloudLabelConnectorNeighbourDistance ConnectorNeighbourDistance_DefaultValue { get; set; }
		...
		/// </summary>
		public BubbleSeriesWordcloudLabelStyle Style { get; set; }
		private BubbleSeriesWordcloudLabelStyle Style_DefaultValue { get; set; }
