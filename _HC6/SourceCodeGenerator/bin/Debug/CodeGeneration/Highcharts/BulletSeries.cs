...
namespace Highsoft.Web.Mvc.Charts
{
	public partial class BulletSeries  : Series
	{
		...
		/// </summary>
		public BulletSeriesSunburst Sunburst { get; set; }
		private BulletSeriesSunburst Sunburst_DefaultValue { get; set; }
		...
		/// </summary>
		public BulletSeriesWordcloud Wordcloud { get; set; }
		private BulletSeriesWordcloud Wordcloud_DefaultValue { get; set; }
		...
		/// 
		/// </summary>
		public BulletSeriesStickyTracking StickyTracking { get; set; }
		private BulletSeriesStickyTracking StickyTracking_DefaultValue { get; set; }
		...
		/// 
		/// </summary>
		public BulletSeriesDataGrouping DataGrouping { get; set; }
		private BulletSeriesDataGrouping DataGrouping_DefaultValue { get; set; }
