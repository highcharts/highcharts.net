...
{
	public partial class BulletSeriesStatesHoverMarker  : BaseObject
	{
		public BulletSeriesStatesHoverMarker()
		{
			LineWidth = LineWidth_DefaultValue = 0;
			LineColor = LineColor_DefaultValue = "#ffffff";
			Radius = Radius_DefaultValue = 4;
			States = States_DefaultValue = new BulletSeriesStatesHoverMarkerStates();
		...
		/// </summary>
		public BulletSeriesStatesHoverMarkerStates States { get; set; }
		private BulletSeriesStatesHoverMarkerStates States_DefaultValue { get; set; }
