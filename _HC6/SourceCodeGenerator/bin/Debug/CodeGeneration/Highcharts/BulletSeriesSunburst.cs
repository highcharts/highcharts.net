...
{
	public partial class BulletSeriesSunburst  : BaseObject
	{
		public BulletSeriesSunburst()
		{
			Data = Data_DefaultValue = new List<SeriesBulletSunburstData>();
		...
		/// 
		/// </summary>
		public List<SeriesBulletSunburstData> Data { get; set; }
		private List<SeriesBulletSunburstData> Data_DefaultValue { get; set; }
		 

		/// <summary>
		/// Series labels are placed as close to the series as possible in anatural way, seeking to avoid other series. The goal of thisfeature is to make the chart more easily readable, like if ahuman designer placed the labels in the optimal position.The series labels currently work with series types having a`graph` or an `area`.Requires the `series-label.js` module.
		/// </summary>
		public BulletSeriesSunburstLabel Label { get; set; }
		private BulletSeriesSunburstLabel Label_DefaultValue { get; set; }
		...
		/// </summary>
		public BulletSeriesSunburstStickyTracking StickyTracking { get; set; }
		private BulletSeriesSunburstStickyTracking StickyTracking_DefaultValue { get; set; }
		 

		/// <summary>
		/// 
		/// </summary>
		public BulletSeriesSunburstTooltip Tooltip { get; set; }
		private BulletSeriesSunburstTooltip Tooltip_DefaultValue { get; set; }
		...
		/// 
		/// </summary>
		public BulletSeriesSunburstStates States { get; set; }
		private BulletSeriesSunburstStates States_DefaultValue { get; set; }
		...
		/// 
		/// </summary>
		public BulletSeriesSunburstEvents Events { get; set; }
		private BulletSeriesSunburstEvents Events_DefaultValue { get; set; }
		 

		/// <summary>
		/// 
		/// </summary>
		public BulletSeriesSunburstPoint Point { get; set; }
		private BulletSeriesSunburstPoint Point_DefaultValue { get; set; }
		...
		/// 
		/// </summary>
		public BulletSeriesSunburstDataLabels DataLabels { get; set; }
		private BulletSeriesSunburstDataLabels DataLabels_DefaultValue { get; set; }
		...
		/// </summary>
		public BulletSeriesSunburstLevelIsConstant LevelIsConstant { get; set; }
		private BulletSeriesSunburstLevelIsConstant LevelIsConstant_DefaultValue { get; set; }
