...
{
	public partial class BulletSeriesSunburstData  : BaseObject
	{
		public BulletSeriesSunburstData()
		{
		...
		/// </summary>
		public BulletSeriesSunburstDataEvents Events { get; set; }
		private BulletSeriesSunburstDataEvents Events_DefaultValue { get; set; }
