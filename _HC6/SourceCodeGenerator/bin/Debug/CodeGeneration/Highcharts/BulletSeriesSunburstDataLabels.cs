...
{
	public partial class BulletSeriesSunburstDataLabels  : BaseObject
	{
		public BulletSeriesSunburstDataLabels()
		{
		...
		/// 
		/// </summary>
		public BulletSeriesSunburstDataLabelsDefer Defer { get; set; }
		private BulletSeriesSunburstDataLabelsDefer Defer_DefaultValue { get; set; }
		 

		/// <summary>
		/// 
		/// </summary>
		public BulletSeriesSunburstDataLabelsStyle Style { get; set; }
		private BulletSeriesSunburstDataLabelsStyle Style_DefaultValue { get; set; }
		...
		/// </summary>
		public BulletSeriesSunburstDataLabelsRotationMode RotationMode { get; set; }
		private BulletSeriesSunburstDataLabelsRotationMode RotationMode_DefaultValue { get; set; }
