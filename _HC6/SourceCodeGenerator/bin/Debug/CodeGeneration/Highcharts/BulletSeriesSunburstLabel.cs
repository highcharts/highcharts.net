...
{
	public partial class BulletSeriesSunburstLabel  : BaseObject
	{
		public BulletSeriesSunburstLabel()
		{
		...
		/// </summary>
		public BulletSeriesSunburstLabelEnabled Enabled { get; set; }
		private BulletSeriesSunburstLabelEnabled Enabled_DefaultValue { get; set; }
		 

		/// <summary>
		/// Allow labels to be placed distant to the graph if necessary,and draw a connector line to the graph.
		/// </summary>
		public BulletSeriesSunburstLabelConnectorAllowed ConnectorAllowed { get; set; }
		private BulletSeriesSunburstLabelConnectorAllowed ConnectorAllowed_DefaultValue { get; set; }
		 

		/// <summary>
		/// If the label is closer than this to a neighbour graph, draw aconnector.
		/// </summary>
		public BulletSeriesSunburstLabelConnectorNeighbourDistance ConnectorNeighbourDistance { get; set; }
		private BulletSeriesSunburstLabelConnectorNeighbourDistance ConnectorNeighbourDistance_DefaultValue { get; set; }
		...
		/// </summary>
		public BulletSeriesSunburstLabelStyle Style { get; set; }
		private BulletSeriesSunburstLabelStyle Style_DefaultValue { get; set; }
