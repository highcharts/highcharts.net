...
{
	public partial class BulletSeriesWordcloud  : BaseObject
	{
		public BulletSeriesWordcloud()
		{
			Data = Data_DefaultValue = new List<SeriesBulletWordcloudData>();
		...
		/// </summary>
		public List<SeriesBulletWordcloudData> Data { get; set; }
		private List<SeriesBulletWordcloudData> Data_DefaultValue { get; set; }
		 

		/// <summary>
		/// Series labels are placed as close to the series as possible in anatural way, seeking to avoid other series. The goal of thisfeature is to make the chart more easily readable, like if ahuman designer placed the labels in the optimal position.The series labels currently work with series types having a`graph` or an `area`.Requires the `series-label.js` module.
		/// </summary>
		public BulletSeriesWordcloudLabel Label { get; set; }
		private BulletSeriesWordcloudLabel Label_DefaultValue { get; set; }
		...
		/// </summary>
		public BulletSeriesWordcloudEvents Events { get; set; }
		private BulletSeriesWordcloudEvents Events_DefaultValue { get; set; }
		 

		/// <summary>
		/// Properties for each single point.
		/// </summary>
		public BulletSeriesWordcloudPoint Point { get; set; }
		private BulletSeriesWordcloudPoint Point_DefaultValue { get; set; }
		...
		/// 
		/// </summary>
		public BulletSeriesWordcloudStates States { get; set; }
		private BulletSeriesWordcloudStates States_DefaultValue { get; set; }
		 

		/// <summary>
		/// 
		/// </summary>
		public BulletSeriesWordcloudStickyTracking StickyTracking { get; set; }
		private BulletSeriesWordcloudStickyTracking StickyTracking_DefaultValue { get; set; }
		...
		/// 
		/// </summary>
		public BulletSeriesWordcloudBorderWidth BorderWidth { get; set; }
		private BulletSeriesWordcloudBorderWidth BorderWidth_DefaultValue { get; set; }
		 

		/// <summary>
		/// 
		/// </summary>
		public BulletSeriesWordcloudClip Clip { get; set; }
		private BulletSeriesWordcloudClip Clip_DefaultValue { get; set; }
		...
		/// </summary>
		public BulletSeriesWordcloudColorByPoint ColorByPoint { get; set; }
		private BulletSeriesWordcloudColorByPoint ColorByPoint_DefaultValue { get; set; }
		...
		/// </summary>
		public BulletSeriesWordcloudPlacementStrategy PlacementStrategy { get; set; }
		private BulletSeriesWordcloudPlacementStrategy PlacementStrategy_DefaultValue { get; set; }
		 

		/// <summary>
		/// Rotation options for the words in the wordcloud.
		/// </summary>
		public BulletSeriesWordcloudRotation Rotation { get; set; }
		private BulletSeriesWordcloudRotation Rotation_DefaultValue { get; set; }
		 

		/// <summary>
		/// 
		/// </summary>
		public BulletSeriesWordcloudShowInLegend ShowInLegend { get; set; }
		private BulletSeriesWordcloudShowInLegend ShowInLegend_DefaultValue { get; set; }
		...
		/// </summary>
		public BulletSeriesWordcloudSpiral Spiral { get; set; }
		private BulletSeriesWordcloudSpiral Spiral_DefaultValue { get; set; }
		...
		/// 
		/// </summary>
		public BulletSeriesWordcloudTooltip Tooltip { get; set; }
		private BulletSeriesWordcloudTooltip Tooltip_DefaultValue { get; set; }
