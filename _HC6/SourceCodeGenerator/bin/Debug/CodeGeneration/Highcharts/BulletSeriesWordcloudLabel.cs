...
{
	public partial class BulletSeriesWordcloudLabel  : BaseObject
	{
		public BulletSeriesWordcloudLabel()
		{
		...
		/// </summary>
		public BulletSeriesWordcloudLabelEnabled Enabled { get; set; }
		private BulletSeriesWordcloudLabelEnabled Enabled_DefaultValue { get; set; }
		 

		/// <summary>
		/// Allow labels to be placed distant to the graph if necessary,and draw a connector line to the graph.
		/// </summary>
		public BulletSeriesWordcloudLabelConnectorAllowed ConnectorAllowed { get; set; }
		private BulletSeriesWordcloudLabelConnectorAllowed ConnectorAllowed_DefaultValue { get; set; }
		 

		/// <summary>
		/// If the label is closer than this to a neighbour graph, draw aconnector.
		/// </summary>
		public BulletSeriesWordcloudLabelConnectorNeighbourDistance ConnectorNeighbourDistance { get; set; }
		private BulletSeriesWordcloudLabelConnectorNeighbourDistance ConnectorNeighbourDistance_DefaultValue { get; set; }
		...
		/// </summary>
		public BulletSeriesWordcloudLabelStyle Style { get; set; }
		private BulletSeriesWordcloudLabelStyle Style_DefaultValue { get; set; }
