...
{
	public partial class ChartOptions3dFrameBack  : BaseObject
	{
		public ChartOptions3dFrameBack()
		{
			Color = Color_DefaultValue = "transparent";
			Size = Size_DefaultValue = 1;
			Visible = Visible_DefaultValue = ChartOptions3dFrameBackVisible.Default;
		...
		/// </summary>
		public ChartOptions3dFrameBackVisible Visible { get; set; }
		private ChartOptions3dFrameBackVisible Visible_DefaultValue { get; set; }
