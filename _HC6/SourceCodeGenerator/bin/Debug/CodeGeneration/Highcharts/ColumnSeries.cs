...
namespace Highsoft.Web.Mvc.Charts
{
	public partial class ColumnSeries  : Series
	{
		...
		/// </summary>
		public List<SeriesColumnData> Data { get; set; }
		private List<SeriesColumnData> Data_DefaultValue { get; set; }
		...
		/// </summary>
		public ColumnSeriesSunburst Sunburst { get; set; }
		private ColumnSeriesSunburst Sunburst_DefaultValue { get; set; }
		...
		/// </summary>
		public ColumnSeriesWordcloud Wordcloud { get; set; }
		private ColumnSeriesWordcloud Wordcloud_DefaultValue { get; set; }
		...
		/// 
		/// </summary>
		public ColumnSeriesStickyTracking StickyTracking { get; set; }
		private ColumnSeriesStickyTracking StickyTracking_DefaultValue { get; set; }
