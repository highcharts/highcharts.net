...
{
	public partial class ColumnSeriesSunburst  : BaseObject
	{
		public ColumnSeriesSunburst()
		{
			Data = Data_DefaultValue = new List<SeriesColumnSunburstData>();
		...
		/// 
		/// </summary>
		public List<SeriesColumnSunburstData> Data { get; set; }
		private List<SeriesColumnSunburstData> Data_DefaultValue { get; set; }
		 

		/// <summary>
		/// Series labels are placed as close to the series as possible in anatural way, seeking to avoid other series. The goal of thisfeature is to make the chart more easily readable, like if ahuman designer placed the labels in the optimal position.The series labels currently work with series types having a`graph` or an `area`.Requires the `series-label.js` module.
		/// </summary>
		public ColumnSeriesSunburstLabel Label { get; set; }
		private ColumnSeriesSunburstLabel Label_DefaultValue { get; set; }
		...
		/// </summary>
		public ColumnSeriesSunburstStickyTracking StickyTracking { get; set; }
		private ColumnSeriesSunburstStickyTracking StickyTracking_DefaultValue { get; set; }
		 

		/// <summary>
		/// 
		/// </summary>
		public ColumnSeriesSunburstTooltip Tooltip { get; set; }
		private ColumnSeriesSunburstTooltip Tooltip_DefaultValue { get; set; }
		...
		/// 
		/// </summary>
		public ColumnSeriesSunburstStates States { get; set; }
		private ColumnSeriesSunburstStates States_DefaultValue { get; set; }
		...
		/// 
		/// </summary>
		public ColumnSeriesSunburstEvents Events { get; set; }
		private ColumnSeriesSunburstEvents Events_DefaultValue { get; set; }
		 

		/// <summary>
		/// 
		/// </summary>
		public ColumnSeriesSunburstPoint Point { get; set; }
		private ColumnSeriesSunburstPoint Point_DefaultValue { get; set; }
		...
		/// 
		/// </summary>
		public ColumnSeriesSunburstDataLabels DataLabels { get; set; }
		private ColumnSeriesSunburstDataLabels DataLabels_DefaultValue { get; set; }
		...
		/// </summary>
		public ColumnSeriesSunburstLevelIsConstant LevelIsConstant { get; set; }
		private ColumnSeriesSunburstLevelIsConstant LevelIsConstant_DefaultValue { get; set; }
