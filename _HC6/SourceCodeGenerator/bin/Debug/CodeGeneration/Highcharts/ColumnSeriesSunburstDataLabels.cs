...
{
	public partial class ColumnSeriesSunburstDataLabels  : BaseObject
	{
		public ColumnSeriesSunburstDataLabels()
		{
		...
		/// 
		/// </summary>
		public ColumnSeriesSunburstDataLabelsDefer Defer { get; set; }
		private ColumnSeriesSunburstDataLabelsDefer Defer_DefaultValue { get; set; }
		 

		/// <summary>
		/// 
		/// </summary>
		public ColumnSeriesSunburstDataLabelsStyle Style { get; set; }
		private ColumnSeriesSunburstDataLabelsStyle Style_DefaultValue { get; set; }
		...
		/// </summary>
		public ColumnSeriesSunburstDataLabelsRotationMode RotationMode { get; set; }
		private ColumnSeriesSunburstDataLabelsRotationMode RotationMode_DefaultValue { get; set; }
