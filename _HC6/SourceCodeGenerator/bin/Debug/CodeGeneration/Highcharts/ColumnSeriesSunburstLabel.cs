...
{
	public partial class ColumnSeriesSunburstLabel  : BaseObject
	{
		public ColumnSeriesSunburstLabel()
		{
		...
		/// </summary>
		public ColumnSeriesSunburstLabelEnabled Enabled { get; set; }
		private ColumnSeriesSunburstLabelEnabled Enabled_DefaultValue { get; set; }
		 

		/// <summary>
		/// Allow labels to be placed distant to the graph if necessary,and draw a connector line to the graph.
		/// </summary>
		public ColumnSeriesSunburstLabelConnectorAllowed ConnectorAllowed { get; set; }
		private ColumnSeriesSunburstLabelConnectorAllowed ConnectorAllowed_DefaultValue { get; set; }
		 

		/// <summary>
		/// If the label is closer than this to a neighbour graph, draw aconnector.
		/// </summary>
		public ColumnSeriesSunburstLabelConnectorNeighbourDistance ConnectorNeighbourDistance { get; set; }
		private ColumnSeriesSunburstLabelConnectorNeighbourDistance ConnectorNeighbourDistance_DefaultValue { get; set; }
		...
		/// </summary>
		public ColumnSeriesSunburstLabelStyle Style { get; set; }
		private ColumnSeriesSunburstLabelStyle Style_DefaultValue { get; set; }
