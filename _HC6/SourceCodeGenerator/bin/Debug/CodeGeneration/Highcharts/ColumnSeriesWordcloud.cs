...
{
	public partial class ColumnSeriesWordcloud  : BaseObject
	{
		public ColumnSeriesWordcloud()
		{
			Data = Data_DefaultValue = new List<SeriesColumnWordcloudData>();
		...
		/// </summary>
		public List<SeriesColumnWordcloudData> Data { get; set; }
		private List<SeriesColumnWordcloudData> Data_DefaultValue { get; set; }
		 

		/// <summary>
		/// Series labels are placed as close to the series as possible in anatural way, seeking to avoid other series. The goal of thisfeature is to make the chart more easily readable, like if ahuman designer placed the labels in the optimal position.The series labels currently work with series types having a`graph` or an `area`.Requires the `series-label.js` module.
		/// </summary>
		public ColumnSeriesWordcloudLabel Label { get; set; }
		private ColumnSeriesWordcloudLabel Label_DefaultValue { get; set; }
		...
		/// </summary>
		public ColumnSeriesWordcloudEvents Events { get; set; }
		private ColumnSeriesWordcloudEvents Events_DefaultValue { get; set; }
		 

		/// <summary>
		/// Properties for each single point.
		/// </summary>
		public ColumnSeriesWordcloudPoint Point { get; set; }
		private ColumnSeriesWordcloudPoint Point_DefaultValue { get; set; }
		...
		/// 
		/// </summary>
		public ColumnSeriesWordcloudStates States { get; set; }
		private ColumnSeriesWordcloudStates States_DefaultValue { get; set; }
		 

		/// <summary>
		/// 
		/// </summary>
		public ColumnSeriesWordcloudStickyTracking StickyTracking { get; set; }
		private ColumnSeriesWordcloudStickyTracking StickyTracking_DefaultValue { get; set; }
		...
		/// 
		/// </summary>
		public ColumnSeriesWordcloudBorderWidth BorderWidth { get; set; }
		private ColumnSeriesWordcloudBorderWidth BorderWidth_DefaultValue { get; set; }
		 

		/// <summary>
		/// 
		/// </summary>
		public ColumnSeriesWordcloudClip Clip { get; set; }
		private ColumnSeriesWordcloudClip Clip_DefaultValue { get; set; }
		...
		/// </summary>
		public ColumnSeriesWordcloudColorByPoint ColorByPoint { get; set; }
		private ColumnSeriesWordcloudColorByPoint ColorByPoint_DefaultValue { get; set; }
		...
		/// </summary>
		public ColumnSeriesWordcloudPlacementStrategy PlacementStrategy { get; set; }
		private ColumnSeriesWordcloudPlacementStrategy PlacementStrategy_DefaultValue { get; set; }
		 

		/// <summary>
		/// Rotation options for the words in the wordcloud.
		/// </summary>
		public ColumnSeriesWordcloudRotation Rotation { get; set; }
		private ColumnSeriesWordcloudRotation Rotation_DefaultValue { get; set; }
		 

		/// <summary>
		/// 
		/// </summary>
		public ColumnSeriesWordcloudShowInLegend ShowInLegend { get; set; }
		private ColumnSeriesWordcloudShowInLegend ShowInLegend_DefaultValue { get; set; }
		...
		/// </summary>
		public ColumnSeriesWordcloudSpiral Spiral { get; set; }
		private ColumnSeriesWordcloudSpiral Spiral_DefaultValue { get; set; }
		...
		/// 
		/// </summary>
		public ColumnSeriesWordcloudTooltip Tooltip { get; set; }
		private ColumnSeriesWordcloudTooltip Tooltip_DefaultValue { get; set; }
