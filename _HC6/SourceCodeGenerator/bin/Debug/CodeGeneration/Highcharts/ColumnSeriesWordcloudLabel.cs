...
{
	public partial class ColumnSeriesWordcloudLabel  : BaseObject
	{
		public ColumnSeriesWordcloudLabel()
		{
		...
		/// </summary>
		public ColumnSeriesWordcloudLabelEnabled Enabled { get; set; }
		private ColumnSeriesWordcloudLabelEnabled Enabled_DefaultValue { get; set; }
		 

		/// <summary>
		/// Allow labels to be placed distant to the graph if necessary,and draw a connector line to the graph.
		/// </summary>
		public ColumnSeriesWordcloudLabelConnectorAllowed ConnectorAllowed { get; set; }
		private ColumnSeriesWordcloudLabelConnectorAllowed ConnectorAllowed_DefaultValue { get; set; }
		 

		/// <summary>
		/// If the label is closer than this to a neighbour graph, draw aconnector.
		/// </summary>
		public ColumnSeriesWordcloudLabelConnectorNeighbourDistance ConnectorNeighbourDistance { get; set; }
		private ColumnSeriesWordcloudLabelConnectorNeighbourDistance ConnectorNeighbourDistance_DefaultValue { get; set; }
		...
		/// </summary>
		public ColumnSeriesWordcloudLabelStyle Style { get; set; }
		private ColumnSeriesWordcloudLabelStyle Style_DefaultValue { get; set; }
