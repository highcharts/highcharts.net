...
{
	public partial class ColumnrangeSeriesDataLabelsFilter  : BaseObject
	{
		public ColumnrangeSeriesDataLabelsFilter()
		{
		...
		/// </summary>
		public ColumnrangeSeriesDataLabelsFilterValue Value { get; set; }
		private ColumnrangeSeriesDataLabelsFilterValue Value_DefaultValue { get; set; }
