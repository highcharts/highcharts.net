...
{
	public partial class ColumnrangeSeriesSunburst  : BaseObject
	{
		public ColumnrangeSeriesSunburst()
		{
			Data = Data_DefaultValue = new List<SeriesColumnrangeSunburstData>();
		...
		/// 
		/// </summary>
		public List<SeriesColumnrangeSunburstData> Data { get; set; }
		private List<SeriesColumnrangeSunburstData> Data_DefaultValue { get; set; }
		 

		/// <summary>
		/// Series labels are placed as close to the series as possible in anatural way, seeking to avoid other series. The goal of thisfeature is to make the chart more easily readable, like if ahuman designer placed the labels in the optimal position.The series labels currently work with series types having a`graph` or an `area`.Requires the `series-label.js` module.
		/// </summary>
		public ColumnrangeSeriesSunburstLabel Label { get; set; }
		private ColumnrangeSeriesSunburstLabel Label_DefaultValue { get; set; }
		...
		/// </summary>
		public ColumnrangeSeriesSunburstStickyTracking StickyTracking { get; set; }
		private ColumnrangeSeriesSunburstStickyTracking StickyTracking_DefaultValue { get; set; }
		 

		/// <summary>
		/// 
		/// </summary>
		public ColumnrangeSeriesSunburstTooltip Tooltip { get; set; }
		private ColumnrangeSeriesSunburstTooltip Tooltip_DefaultValue { get; set; }
		...
		/// 
		/// </summary>
		public ColumnrangeSeriesSunburstStates States { get; set; }
		private ColumnrangeSeriesSunburstStates States_DefaultValue { get; set; }
		...
		/// 
		/// </summary>
		public ColumnrangeSeriesSunburstEvents Events { get; set; }
		private ColumnrangeSeriesSunburstEvents Events_DefaultValue { get; set; }
		 

		/// <summary>
		/// 
		/// </summary>
		public ColumnrangeSeriesSunburstPoint Point { get; set; }
		private ColumnrangeSeriesSunburstPoint Point_DefaultValue { get; set; }
		...
		/// 
		/// </summary>
		public ColumnrangeSeriesSunburstDataLabels DataLabels { get; set; }
		private ColumnrangeSeriesSunburstDataLabels DataLabels_DefaultValue { get; set; }
		...
		/// </summary>
		public ColumnrangeSeriesSunburstLevelIsConstant LevelIsConstant { get; set; }
		private ColumnrangeSeriesSunburstLevelIsConstant LevelIsConstant_DefaultValue { get; set; }
