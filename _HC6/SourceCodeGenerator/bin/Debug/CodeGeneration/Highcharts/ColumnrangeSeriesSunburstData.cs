...
{
	public partial class ColumnrangeSeriesSunburstData  : BaseObject
	{
		public ColumnrangeSeriesSunburstData()
		{
		...
		/// </summary>
		public ColumnrangeSeriesSunburstDataEvents Events { get; set; }
		private ColumnrangeSeriesSunburstDataEvents Events_DefaultValue { get; set; }
