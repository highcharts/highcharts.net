...
{
	public partial class ColumnrangeSeriesSunburstDataLabels  : BaseObject
	{
		public ColumnrangeSeriesSunburstDataLabels()
		{
		...
		/// 
		/// </summary>
		public ColumnrangeSeriesSunburstDataLabelsDefer Defer { get; set; }
		private ColumnrangeSeriesSunburstDataLabelsDefer Defer_DefaultValue { get; set; }
		 

		/// <summary>
		/// 
		/// </summary>
		public ColumnrangeSeriesSunburstDataLabelsStyle Style { get; set; }
		private ColumnrangeSeriesSunburstDataLabelsStyle Style_DefaultValue { get; set; }
		...
		/// </summary>
		public ColumnrangeSeriesSunburstDataLabelsRotationMode RotationMode { get; set; }
		private ColumnrangeSeriesSunburstDataLabelsRotationMode RotationMode_DefaultValue { get; set; }
