...
{
	public partial class ColumnrangeSeriesSunburstLabel  : BaseObject
	{
		public ColumnrangeSeriesSunburstLabel()
		{
		...
		/// </summary>
		public ColumnrangeSeriesSunburstLabelEnabled Enabled { get; set; }
		private ColumnrangeSeriesSunburstLabelEnabled Enabled_DefaultValue { get; set; }
		 

		/// <summary>
		/// Allow labels to be placed distant to the graph if necessary,and draw a connector line to the graph.
		/// </summary>
		public ColumnrangeSeriesSunburstLabelConnectorAllowed ConnectorAllowed { get; set; }
		private ColumnrangeSeriesSunburstLabelConnectorAllowed ConnectorAllowed_DefaultValue { get; set; }
		 

		/// <summary>
		/// If the label is closer than this to a neighbour graph, draw aconnector.
		/// </summary>
		public ColumnrangeSeriesSunburstLabelConnectorNeighbourDistance ConnectorNeighbourDistance { get; set; }
		private ColumnrangeSeriesSunburstLabelConnectorNeighbourDistance ConnectorNeighbourDistance_DefaultValue { get; set; }
		...
		/// </summary>
		public ColumnrangeSeriesSunburstLabelStyle Style { get; set; }
		private ColumnrangeSeriesSunburstLabelStyle Style_DefaultValue { get; set; }
