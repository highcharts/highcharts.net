...
{
	public partial class ColumnrangeSeriesWordcloud  : BaseObject
	{
		public ColumnrangeSeriesWordcloud()
		{
			Data = Data_DefaultValue = new List<SeriesColumnrangeWordcloudData>();
		...
		/// </summary>
		public List<SeriesColumnrangeWordcloudData> Data { get; set; }
		private List<SeriesColumnrangeWordcloudData> Data_DefaultValue { get; set; }
		 

		/// <summary>
		/// Series labels are placed as close to the series as possible in anatural way, seeking to avoid other series. The goal of thisfeature is to make the chart more easily readable, like if ahuman designer placed the labels in the optimal position.The series labels currently work with series types having a`graph` or an `area`.Requires the `series-label.js` module.
		/// </summary>
		public ColumnrangeSeriesWordcloudLabel Label { get; set; }
		private ColumnrangeSeriesWordcloudLabel Label_DefaultValue { get; set; }
		...
		/// </summary>
		public ColumnrangeSeriesWordcloudEvents Events { get; set; }
		private ColumnrangeSeriesWordcloudEvents Events_DefaultValue { get; set; }
		 

		/// <summary>
		/// Properties for each single point.
		/// </summary>
		public ColumnrangeSeriesWordcloudPoint Point { get; set; }
		private ColumnrangeSeriesWordcloudPoint Point_DefaultValue { get; set; }
		...
		/// 
		/// </summary>
		public ColumnrangeSeriesWordcloudStates States { get; set; }
		private ColumnrangeSeriesWordcloudStates States_DefaultValue { get; set; }
		 

		/// <summary>
		/// 
		/// </summary>
		public ColumnrangeSeriesWordcloudStickyTracking StickyTracking { get; set; }
		private ColumnrangeSeriesWordcloudStickyTracking StickyTracking_DefaultValue { get; set; }
		...
		/// 
		/// </summary>
		public ColumnrangeSeriesWordcloudBorderWidth BorderWidth { get; set; }
		private ColumnrangeSeriesWordcloudBorderWidth BorderWidth_DefaultValue { get; set; }
		 

		/// <summary>
		/// 
		/// </summary>
		public ColumnrangeSeriesWordcloudClip Clip { get; set; }
		private ColumnrangeSeriesWordcloudClip Clip_DefaultValue { get; set; }
		...
		/// </summary>
		public ColumnrangeSeriesWordcloudColorByPoint ColorByPoint { get; set; }
		private ColumnrangeSeriesWordcloudColorByPoint ColorByPoint_DefaultValue { get; set; }
		...
		/// </summary>
		public ColumnrangeSeriesWordcloudPlacementStrategy PlacementStrategy { get; set; }
		private ColumnrangeSeriesWordcloudPlacementStrategy PlacementStrategy_DefaultValue { get; set; }
		 

		/// <summary>
		/// Rotation options for the words in the wordcloud.
		/// </summary>
		public ColumnrangeSeriesWordcloudRotation Rotation { get; set; }
		private ColumnrangeSeriesWordcloudRotation Rotation_DefaultValue { get; set; }
		 

		/// <summary>
		/// 
		/// </summary>
		public ColumnrangeSeriesWordcloudShowInLegend ShowInLegend { get; set; }
		private ColumnrangeSeriesWordcloudShowInLegend ShowInLegend_DefaultValue { get; set; }
		...
		/// </summary>
		public ColumnrangeSeriesWordcloudSpiral Spiral { get; set; }
		private ColumnrangeSeriesWordcloudSpiral Spiral_DefaultValue { get; set; }
		...
		/// 
		/// </summary>
		public ColumnrangeSeriesWordcloudTooltip Tooltip { get; set; }
		private ColumnrangeSeriesWordcloudTooltip Tooltip_DefaultValue { get; set; }
