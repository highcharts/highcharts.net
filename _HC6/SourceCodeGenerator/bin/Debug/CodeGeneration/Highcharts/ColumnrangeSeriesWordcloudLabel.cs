...
{
	public partial class ColumnrangeSeriesWordcloudLabel  : BaseObject
	{
		public ColumnrangeSeriesWordcloudLabel()
		{
		...
		/// </summary>
		public ColumnrangeSeriesWordcloudLabelEnabled Enabled { get; set; }
		private ColumnrangeSeriesWordcloudLabelEnabled Enabled_DefaultValue { get; set; }
		 

		/// <summary>
		/// Allow labels to be placed distant to the graph if necessary,and draw a connector line to the graph.
		/// </summary>
		public ColumnrangeSeriesWordcloudLabelConnectorAllowed ConnectorAllowed { get; set; }
		private ColumnrangeSeriesWordcloudLabelConnectorAllowed ConnectorAllowed_DefaultValue { get; set; }
		 

		/// <summary>
		/// If the label is closer than this to a neighbour graph, draw aconnector.
		/// </summary>
		public ColumnrangeSeriesWordcloudLabelConnectorNeighbourDistance ConnectorNeighbourDistance { get; set; }
		private ColumnrangeSeriesWordcloudLabelConnectorNeighbourDistance ConnectorNeighbourDistance_DefaultValue { get; set; }
		...
		/// </summary>
		public ColumnrangeSeriesWordcloudLabelStyle Style { get; set; }
		private ColumnrangeSeriesWordcloudLabelStyle Style_DefaultValue { get; set; }
