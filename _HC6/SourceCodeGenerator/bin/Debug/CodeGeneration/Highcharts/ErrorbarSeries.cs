...
namespace Highsoft.Web.Mvc.Charts
{
	public partial class ErrorbarSeries  : Series
	{
		...
		/// <summary>
		/// An array of data points for the series. For the `errorbar` seriestype, points can be given in the following ways:1.  An array of arrays with 3 or 2 values. In this case, the valuescorrespond to `x,low,high`. If the first value is a string, it isapplied as the name of the point, and the `x` value is inferred.The `x` value can also be omitted, in which case the inner arraysshould be of length 2\. Then the `x` value is automatically calculated,either starting at 0 and incremented by 1, or from `pointStart`and `pointInterval` given in the series options. ```js    data: [        [0, 10, 2],        [1, 1, 8],        [2, 4, 5]    ] ```2.  An array of objects with named values. The objects are pointconfiguration objects as seen below. If the total number of datapoints exceeds the series' [turboThreshold](#series.errorbar.turboThreshold),this option is not available. ```js    data: [{        x: 1,        low: 0,        high: 0,        name: "Point2",        color: "#00FF00"    }, {        x: 1,        low: 5,        high: 5,        name: "Point1",        color: "#FF00FF"    }] ```
		/// </summary>
		public List<SeriesErrorbarData> Data { get; set; }
		private List<SeriesErrorbarData> Data_DefaultValue { get; set; }
		...
		/// 
		/// </summary>
		public ErrorbarSeriesStickyTracking StickyTracking { get; set; }
		private ErrorbarSeriesStickyTracking StickyTracking_DefaultValue { get; set; }
		...
		/// 
		/// </summary>
		public ErrorbarSeriesDataGrouping DataGrouping { get; set; }
		private ErrorbarSeriesDataGrouping DataGrouping_DefaultValue { get; set; }
		...
		/// 
		/// </summary>
		public ErrorbarSeriesThreshold Threshold { get; set; }
		private ErrorbarSeriesThreshold Threshold_DefaultValue { get; set; }
		...
		/// 
		/// </summary>
		public ErrorbarSeriesGrouping Grouping { get; set; }
		private ErrorbarSeriesGrouping Grouping_DefaultValue { get; set; }
