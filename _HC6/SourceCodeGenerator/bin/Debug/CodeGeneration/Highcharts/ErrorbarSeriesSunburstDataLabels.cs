...
{
	public partial class ErrorbarSeriesSunburstDataLabels  : BaseObject
	{
		public ErrorbarSeriesSunburstDataLabels()
		{
		...
		/// 
		/// </summary>
		public ErrorbarSeriesSunburstDataLabelsDefer Defer { get; set; }
		private ErrorbarSeriesSunburstDataLabelsDefer Defer_DefaultValue { get; set; }
		 

		/// <summary>
		/// 
		/// </summary>
		public ErrorbarSeriesSunburstDataLabelsStyle Style { get; set; }
		private ErrorbarSeriesSunburstDataLabelsStyle Style_DefaultValue { get; set; }
		...
		/// </summary>
		public ErrorbarSeriesSunburstDataLabelsRotationMode RotationMode { get; set; }
		private ErrorbarSeriesSunburstDataLabelsRotationMode RotationMode_DefaultValue { get; set; }
