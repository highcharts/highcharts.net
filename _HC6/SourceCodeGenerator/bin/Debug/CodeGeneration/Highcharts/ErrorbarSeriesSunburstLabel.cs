...
{
	public partial class ErrorbarSeriesSunburstLabel  : BaseObject
	{
		public ErrorbarSeriesSunburstLabel()
		{
		...
		/// </summary>
		public ErrorbarSeriesSunburstLabelEnabled Enabled { get; set; }
		private ErrorbarSeriesSunburstLabelEnabled Enabled_DefaultValue { get; set; }
		 

		/// <summary>
		/// Allow labels to be placed distant to the graph if necessary,and draw a connector line to the graph.
		/// </summary>
		public ErrorbarSeriesSunburstLabelConnectorAllowed ConnectorAllowed { get; set; }
		private ErrorbarSeriesSunburstLabelConnectorAllowed ConnectorAllowed_DefaultValue { get; set; }
		 

		/// <summary>
		/// If the label is closer than this to a neighbour graph, draw aconnector.
		/// </summary>
		public ErrorbarSeriesSunburstLabelConnectorNeighbourDistance ConnectorNeighbourDistance { get; set; }
		private ErrorbarSeriesSunburstLabelConnectorNeighbourDistance ConnectorNeighbourDistance_DefaultValue { get; set; }
		...
		/// </summary>
		public ErrorbarSeriesSunburstLabelStyle Style { get; set; }
		private ErrorbarSeriesSunburstLabelStyle Style_DefaultValue { get; set; }
