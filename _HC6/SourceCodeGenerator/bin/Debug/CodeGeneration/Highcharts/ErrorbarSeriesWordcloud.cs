...
{
	public partial class ErrorbarSeriesWordcloud  : BaseObject
	{
		public ErrorbarSeriesWordcloud()
		{
			Data = Data_DefaultValue = new List<SeriesErrorbarWordcloudData>();
		...
		/// </summary>
		public List<SeriesErrorbarWordcloudData> Data { get; set; }
		private List<SeriesErrorbarWordcloudData> Data_DefaultValue { get; set; }
		 

		/// <summary>
		/// Series labels are placed as close to the series as possible in anatural way, seeking to avoid other series. The goal of thisfeature is to make the chart more easily readable, like if ahuman designer placed the labels in the optimal position.The series labels currently work with series types having a`graph` or an `area`.Requires the `series-label.js` module.
		/// </summary>
		public ErrorbarSeriesWordcloudLabel Label { get; set; }
		private ErrorbarSeriesWordcloudLabel Label_DefaultValue { get; set; }
		...
		/// </summary>
		public ErrorbarSeriesWordcloudEvents Events { get; set; }
		private ErrorbarSeriesWordcloudEvents Events_DefaultValue { get; set; }
		 

		/// <summary>
		/// Properties for each single point.
		/// </summary>
		public ErrorbarSeriesWordcloudPoint Point { get; set; }
		private ErrorbarSeriesWordcloudPoint Point_DefaultValue { get; set; }
		...
		/// 
		/// </summary>
		public ErrorbarSeriesWordcloudStates States { get; set; }
		private ErrorbarSeriesWordcloudStates States_DefaultValue { get; set; }
		 

		/// <summary>
		/// 
		/// </summary>
		public ErrorbarSeriesWordcloudStickyTracking StickyTracking { get; set; }
		private ErrorbarSeriesWordcloudStickyTracking StickyTracking_DefaultValue { get; set; }
		...
		/// 
		/// </summary>
		public ErrorbarSeriesWordcloudBorderWidth BorderWidth { get; set; }
		private ErrorbarSeriesWordcloudBorderWidth BorderWidth_DefaultValue { get; set; }
		 

		/// <summary>
		/// 
		/// </summary>
		public ErrorbarSeriesWordcloudClip Clip { get; set; }
		private ErrorbarSeriesWordcloudClip Clip_DefaultValue { get; set; }
		...
		/// </summary>
		public ErrorbarSeriesWordcloudColorByPoint ColorByPoint { get; set; }
		private ErrorbarSeriesWordcloudColorByPoint ColorByPoint_DefaultValue { get; set; }
		...
		/// </summary>
		public ErrorbarSeriesWordcloudPlacementStrategy PlacementStrategy { get; set; }
		private ErrorbarSeriesWordcloudPlacementStrategy PlacementStrategy_DefaultValue { get; set; }
		 

		/// <summary>
		/// Rotation options for the words in the wordcloud.
		/// </summary>
		public ErrorbarSeriesWordcloudRotation Rotation { get; set; }
		private ErrorbarSeriesWordcloudRotation Rotation_DefaultValue { get; set; }
		 

		/// <summary>
		/// 
		/// </summary>
		public ErrorbarSeriesWordcloudShowInLegend ShowInLegend { get; set; }
		private ErrorbarSeriesWordcloudShowInLegend ShowInLegend_DefaultValue { get; set; }
		...
		/// </summary>
		public ErrorbarSeriesWordcloudSpiral Spiral { get; set; }
		private ErrorbarSeriesWordcloudSpiral Spiral_DefaultValue { get; set; }
		...
		/// 
		/// </summary>
		public ErrorbarSeriesWordcloudTooltip Tooltip { get; set; }
		private ErrorbarSeriesWordcloudTooltip Tooltip_DefaultValue { get; set; }
