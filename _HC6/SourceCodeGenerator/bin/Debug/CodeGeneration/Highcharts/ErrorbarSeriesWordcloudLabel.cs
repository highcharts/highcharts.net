...
{
	public partial class ErrorbarSeriesWordcloudLabel  : BaseObject
	{
		public ErrorbarSeriesWordcloudLabel()
		{
		...
		/// </summary>
		public ErrorbarSeriesWordcloudLabelEnabled Enabled { get; set; }
		private ErrorbarSeriesWordcloudLabelEnabled Enabled_DefaultValue { get; set; }
		 

		/// <summary>
		/// Allow labels to be placed distant to the graph if necessary,and draw a connector line to the graph.
		/// </summary>
		public ErrorbarSeriesWordcloudLabelConnectorAllowed ConnectorAllowed { get; set; }
		private ErrorbarSeriesWordcloudLabelConnectorAllowed ConnectorAllowed_DefaultValue { get; set; }
		 

		/// <summary>
		/// If the label is closer than this to a neighbour graph, draw aconnector.
		/// </summary>
		public ErrorbarSeriesWordcloudLabelConnectorNeighbourDistance ConnectorNeighbourDistance { get; set; }
		private ErrorbarSeriesWordcloudLabelConnectorNeighbourDistance ConnectorNeighbourDistance_DefaultValue { get; set; }
		...
		/// </summary>
		public ErrorbarSeriesWordcloudLabelStyle Style { get; set; }
		private ErrorbarSeriesWordcloudLabelStyle Style_DefaultValue { get; set; }
