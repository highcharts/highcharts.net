...
{
	public partial class FunnelSeriesSunburst  : BaseObject
	{
		public FunnelSeriesSunburst()
		{
			Data = Data_DefaultValue = new List<SeriesFunnelSunburstData>();
		...
		/// 
		/// </summary>
		public List<SeriesFunnelSunburstData> Data { get; set; }
		private List<SeriesFunnelSunburstData> Data_DefaultValue { get; set; }
		 

		/// <summary>
		/// Series labels are placed as close to the series as possible in anatural way, seeking to avoid other series. The goal of thisfeature is to make the chart more easily readable, like if ahuman designer placed the labels in the optimal position.The series labels currently work with series types having a`graph` or an `area`.Requires the `series-label.js` module.
		/// </summary>
		public FunnelSeriesSunburstLabel Label { get; set; }
		private FunnelSeriesSunburstLabel Label_DefaultValue { get; set; }
		...
		/// </summary>
		public FunnelSeriesSunburstStickyTracking StickyTracking { get; set; }
		private FunnelSeriesSunburstStickyTracking StickyTracking_DefaultValue { get; set; }
		 

		/// <summary>
		/// 
		/// </summary>
		public FunnelSeriesSunburstTooltip Tooltip { get; set; }
		private FunnelSeriesSunburstTooltip Tooltip_DefaultValue { get; set; }
		...
		/// 
		/// </summary>
		public FunnelSeriesSunburstStates States { get; set; }
		private FunnelSeriesSunburstStates States_DefaultValue { get; set; }
		...
		/// 
		/// </summary>
		public FunnelSeriesSunburstEvents Events { get; set; }
		private FunnelSeriesSunburstEvents Events_DefaultValue { get; set; }
		 

		/// <summary>
		/// 
		/// </summary>
		public FunnelSeriesSunburstPoint Point { get; set; }
		private FunnelSeriesSunburstPoint Point_DefaultValue { get; set; }
		...
		/// 
		/// </summary>
		public FunnelSeriesSunburstDataLabels DataLabels { get; set; }
		private FunnelSeriesSunburstDataLabels DataLabels_DefaultValue { get; set; }
		...
		/// </summary>
		public FunnelSeriesSunburstLevelIsConstant LevelIsConstant { get; set; }
		private FunnelSeriesSunburstLevelIsConstant LevelIsConstant_DefaultValue { get; set; }
