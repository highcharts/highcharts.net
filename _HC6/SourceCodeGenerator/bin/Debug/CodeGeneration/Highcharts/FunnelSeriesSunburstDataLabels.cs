...
{
	public partial class FunnelSeriesSunburstDataLabels  : BaseObject
	{
		public FunnelSeriesSunburstDataLabels()
		{
		...
		/// 
		/// </summary>
		public FunnelSeriesSunburstDataLabelsDefer Defer { get; set; }
		private FunnelSeriesSunburstDataLabelsDefer Defer_DefaultValue { get; set; }
		 

		/// <summary>
		/// 
		/// </summary>
		public FunnelSeriesSunburstDataLabelsStyle Style { get; set; }
		private FunnelSeriesSunburstDataLabelsStyle Style_DefaultValue { get; set; }
		...
		/// </summary>
		public FunnelSeriesSunburstDataLabelsRotationMode RotationMode { get; set; }
		private FunnelSeriesSunburstDataLabelsRotationMode RotationMode_DefaultValue { get; set; }
