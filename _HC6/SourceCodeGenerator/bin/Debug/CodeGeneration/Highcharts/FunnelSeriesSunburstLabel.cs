...
{
	public partial class FunnelSeriesSunburstLabel  : BaseObject
	{
		public FunnelSeriesSunburstLabel()
		{
		...
		/// </summary>
		public FunnelSeriesSunburstLabelEnabled Enabled { get; set; }
		private FunnelSeriesSunburstLabelEnabled Enabled_DefaultValue { get; set; }
		 

		/// <summary>
		/// Allow labels to be placed distant to the graph if necessary,and draw a connector line to the graph.
		/// </summary>
		public FunnelSeriesSunburstLabelConnectorAllowed ConnectorAllowed { get; set; }
		private FunnelSeriesSunburstLabelConnectorAllowed ConnectorAllowed_DefaultValue { get; set; }
		 

		/// <summary>
		/// If the label is closer than this to a neighbour graph, draw aconnector.
		/// </summary>
		public FunnelSeriesSunburstLabelConnectorNeighbourDistance ConnectorNeighbourDistance { get; set; }
		private FunnelSeriesSunburstLabelConnectorNeighbourDistance ConnectorNeighbourDistance_DefaultValue { get; set; }
		...
		/// </summary>
		public FunnelSeriesSunburstLabelStyle Style { get; set; }
		private FunnelSeriesSunburstLabelStyle Style_DefaultValue { get; set; }
