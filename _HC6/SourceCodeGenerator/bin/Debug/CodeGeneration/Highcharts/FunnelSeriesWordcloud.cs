...
{
	public partial class FunnelSeriesWordcloud  : BaseObject
	{
		public FunnelSeriesWordcloud()
		{
			Data = Data_DefaultValue = new List<SeriesFunnelWordcloudData>();
		...
		/// </summary>
		public List<SeriesFunnelWordcloudData> Data { get; set; }
		private List<SeriesFunnelWordcloudData> Data_DefaultValue { get; set; }
		 

		/// <summary>
		/// Series labels are placed as close to the series as possible in anatural way, seeking to avoid other series. The goal of thisfeature is to make the chart more easily readable, like if ahuman designer placed the labels in the optimal position.The series labels currently work with series types having a`graph` or an `area`.Requires the `series-label.js` module.
		/// </summary>
		public FunnelSeriesWordcloudLabel Label { get; set; }
		private FunnelSeriesWordcloudLabel Label_DefaultValue { get; set; }
		...
		/// </summary>
		public FunnelSeriesWordcloudEvents Events { get; set; }
		private FunnelSeriesWordcloudEvents Events_DefaultValue { get; set; }
		 

		/// <summary>
		/// Properties for each single point.
		/// </summary>
		public FunnelSeriesWordcloudPoint Point { get; set; }
		private FunnelSeriesWordcloudPoint Point_DefaultValue { get; set; }
		...
		/// 
		/// </summary>
		public FunnelSeriesWordcloudStates States { get; set; }
		private FunnelSeriesWordcloudStates States_DefaultValue { get; set; }
		 

		/// <summary>
		/// 
		/// </summary>
		public FunnelSeriesWordcloudStickyTracking StickyTracking { get; set; }
		private FunnelSeriesWordcloudStickyTracking StickyTracking_DefaultValue { get; set; }
		...
		/// 
		/// </summary>
		public FunnelSeriesWordcloudBorderWidth BorderWidth { get; set; }
		private FunnelSeriesWordcloudBorderWidth BorderWidth_DefaultValue { get; set; }
		 

		/// <summary>
		/// 
		/// </summary>
		public FunnelSeriesWordcloudClip Clip { get; set; }
		private FunnelSeriesWordcloudClip Clip_DefaultValue { get; set; }
		...
		/// </summary>
		public FunnelSeriesWordcloudColorByPoint ColorByPoint { get; set; }
		private FunnelSeriesWordcloudColorByPoint ColorByPoint_DefaultValue { get; set; }
		...
		/// </summary>
		public FunnelSeriesWordcloudPlacementStrategy PlacementStrategy { get; set; }
		private FunnelSeriesWordcloudPlacementStrategy PlacementStrategy_DefaultValue { get; set; }
		 

		/// <summary>
		/// Rotation options for the words in the wordcloud.
		/// </summary>
		public FunnelSeriesWordcloudRotation Rotation { get; set; }
		private FunnelSeriesWordcloudRotation Rotation_DefaultValue { get; set; }
		 

		/// <summary>
		/// 
		/// </summary>
		public FunnelSeriesWordcloudShowInLegend ShowInLegend { get; set; }
		private FunnelSeriesWordcloudShowInLegend ShowInLegend_DefaultValue { get; set; }
		...
		/// </summary>
		public FunnelSeriesWordcloudSpiral Spiral { get; set; }
		private FunnelSeriesWordcloudSpiral Spiral_DefaultValue { get; set; }
		...
		/// 
		/// </summary>
		public FunnelSeriesWordcloudTooltip Tooltip { get; set; }
		private FunnelSeriesWordcloudTooltip Tooltip_DefaultValue { get; set; }
