...
{
	public partial class FunnelSeriesWordcloudLabel  : BaseObject
	{
		public FunnelSeriesWordcloudLabel()
		{
		...
		/// </summary>
		public FunnelSeriesWordcloudLabelEnabled Enabled { get; set; }
		private FunnelSeriesWordcloudLabelEnabled Enabled_DefaultValue { get; set; }
		 

		/// <summary>
		/// Allow labels to be placed distant to the graph if necessary,and draw a connector line to the graph.
		/// </summary>
		public FunnelSeriesWordcloudLabelConnectorAllowed ConnectorAllowed { get; set; }
		private FunnelSeriesWordcloudLabelConnectorAllowed ConnectorAllowed_DefaultValue { get; set; }
		 

		/// <summary>
		/// If the label is closer than this to a neighbour graph, draw aconnector.
		/// </summary>
		public FunnelSeriesWordcloudLabelConnectorNeighbourDistance ConnectorNeighbourDistance { get; set; }
		private FunnelSeriesWordcloudLabelConnectorNeighbourDistance ConnectorNeighbourDistance_DefaultValue { get; set; }
		...
		/// </summary>
		public FunnelSeriesWordcloudLabelStyle Style { get; set; }
		private FunnelSeriesWordcloudLabelStyle Style_DefaultValue { get; set; }
