...
{
	public partial class GaugeSeriesStatesHover  : BaseObject
	{
		public GaugeSeriesStatesHover()
		{
			Animation = Animation_DefaultValue = new Animation() { Enabled = true };
			LineWidthPlus = LineWidthPlus_DefaultValue = 1;
			Marker = Marker_DefaultValue = new GaugeSeriesStatesHoverMarker();
			Halo = Halo_DefaultValue = new GaugeSeriesStatesHoverHalo();
		...
		/// </summary>
		public GaugeSeriesStatesHoverMarker Marker { get; set; }
		private GaugeSeriesStatesHoverMarker Marker_DefaultValue { get; set; }
		...
		/// </summary>
		public GaugeSeriesStatesHoverHalo Halo { get; set; }
		private GaugeSeriesStatesHoverHalo Halo_DefaultValue { get; set; }
