...
{
	public partial class GaugeSeriesSunburst  : BaseObject
	{
		public GaugeSeriesSunburst()
		{
			Data = Data_DefaultValue = new List<SeriesGaugeSunburstData>();
		...
		/// 
		/// </summary>
		public List<SeriesGaugeSunburstData> Data { get; set; }
		private List<SeriesGaugeSunburstData> Data_DefaultValue { get; set; }
		 

		/// <summary>
		/// Series labels are placed as close to the series as possible in anatural way, seeking to avoid other series. The goal of thisfeature is to make the chart more easily readable, like if ahuman designer placed the labels in the optimal position.The series labels currently work with series types having a`graph` or an `area`.Requires the `series-label.js` module.
		/// </summary>
		public GaugeSeriesSunburstLabel Label { get; set; }
		private GaugeSeriesSunburstLabel Label_DefaultValue { get; set; }
		...
		/// </summary>
		public GaugeSeriesSunburstStickyTracking StickyTracking { get; set; }
		private GaugeSeriesSunburstStickyTracking StickyTracking_DefaultValue { get; set; }
		 

		/// <summary>
		/// 
		/// </summary>
		public GaugeSeriesSunburstTooltip Tooltip { get; set; }
		private GaugeSeriesSunburstTooltip Tooltip_DefaultValue { get; set; }
		...
		/// 
		/// </summary>
		public GaugeSeriesSunburstStates States { get; set; }
		private GaugeSeriesSunburstStates States_DefaultValue { get; set; }
		...
		/// 
		/// </summary>
		public GaugeSeriesSunburstEvents Events { get; set; }
		private GaugeSeriesSunburstEvents Events_DefaultValue { get; set; }
		 

		/// <summary>
		/// 
		/// </summary>
		public GaugeSeriesSunburstPoint Point { get; set; }
		private GaugeSeriesSunburstPoint Point_DefaultValue { get; set; }
		...
		/// 
		/// </summary>
		public GaugeSeriesSunburstDataLabels DataLabels { get; set; }
		private GaugeSeriesSunburstDataLabels DataLabels_DefaultValue { get; set; }
		...
		/// </summary>
		public GaugeSeriesSunburstLevelIsConstant LevelIsConstant { get; set; }
		private GaugeSeriesSunburstLevelIsConstant LevelIsConstant_DefaultValue { get; set; }
