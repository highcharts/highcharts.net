...
{
	public partial class GaugeSeriesSunburstData  : BaseObject
	{
		public GaugeSeriesSunburstData()
		{
		...
		/// </summary>
		public GaugeSeriesSunburstDataEvents Events { get; set; }
		private GaugeSeriesSunburstDataEvents Events_DefaultValue { get; set; }
