...
{
	public partial class GaugeSeriesSunburstDataLabels  : BaseObject
	{
		public GaugeSeriesSunburstDataLabels()
		{
		...
		/// 
		/// </summary>
		public GaugeSeriesSunburstDataLabelsDefer Defer { get; set; }
		private GaugeSeriesSunburstDataLabelsDefer Defer_DefaultValue { get; set; }
		 

		/// <summary>
		/// 
		/// </summary>
		public GaugeSeriesSunburstDataLabelsStyle Style { get; set; }
		private GaugeSeriesSunburstDataLabelsStyle Style_DefaultValue { get; set; }
		...
		/// </summary>
		public GaugeSeriesSunburstDataLabelsRotationMode RotationMode { get; set; }
		private GaugeSeriesSunburstDataLabelsRotationMode RotationMode_DefaultValue { get; set; }
