...
{
	public partial class GaugeSeriesSunburstLabel  : BaseObject
	{
		public GaugeSeriesSunburstLabel()
		{
		...
		/// </summary>
		public GaugeSeriesSunburstLabelEnabled Enabled { get; set; }
		private GaugeSeriesSunburstLabelEnabled Enabled_DefaultValue { get; set; }
		 

		/// <summary>
		/// Allow labels to be placed distant to the graph if necessary,and draw a connector line to the graph.
		/// </summary>
		public GaugeSeriesSunburstLabelConnectorAllowed ConnectorAllowed { get; set; }
		private GaugeSeriesSunburstLabelConnectorAllowed ConnectorAllowed_DefaultValue { get; set; }
		 

		/// <summary>
		/// If the label is closer than this to a neighbour graph, draw aconnector.
		/// </summary>
		public GaugeSeriesSunburstLabelConnectorNeighbourDistance ConnectorNeighbourDistance { get; set; }
		private GaugeSeriesSunburstLabelConnectorNeighbourDistance ConnectorNeighbourDistance_DefaultValue { get; set; }
		...
		/// </summary>
		public GaugeSeriesSunburstLabelStyle Style { get; set; }
		private GaugeSeriesSunburstLabelStyle Style_DefaultValue { get; set; }
