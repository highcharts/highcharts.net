...
{
	public partial class GaugeSeriesWordcloud  : BaseObject
	{
		public GaugeSeriesWordcloud()
		{
			Data = Data_DefaultValue = new List<SeriesGaugeWordcloudData>();
		...
		/// </summary>
		public List<SeriesGaugeWordcloudData> Data { get; set; }
		private List<SeriesGaugeWordcloudData> Data_DefaultValue { get; set; }
		 

		/// <summary>
		/// Series labels are placed as close to the series as possible in anatural way, seeking to avoid other series. The goal of thisfeature is to make the chart more easily readable, like if ahuman designer placed the labels in the optimal position.The series labels currently work with series types having a`graph` or an `area`.Requires the `series-label.js` module.
		/// </summary>
		public GaugeSeriesWordcloudLabel Label { get; set; }
		private GaugeSeriesWordcloudLabel Label_DefaultValue { get; set; }
		...
		/// </summary>
		public GaugeSeriesWordcloudEvents Events { get; set; }
		private GaugeSeriesWordcloudEvents Events_DefaultValue { get; set; }
		 

		/// <summary>
		/// Properties for each single point.
		/// </summary>
		public GaugeSeriesWordcloudPoint Point { get; set; }
		private GaugeSeriesWordcloudPoint Point_DefaultValue { get; set; }
		...
		/// 
		/// </summary>
		public GaugeSeriesWordcloudStates States { get; set; }
		private GaugeSeriesWordcloudStates States_DefaultValue { get; set; }
		 

		/// <summary>
		/// 
		/// </summary>
		public GaugeSeriesWordcloudStickyTracking StickyTracking { get; set; }
		private GaugeSeriesWordcloudStickyTracking StickyTracking_DefaultValue { get; set; }
		...
		/// 
		/// </summary>
		public GaugeSeriesWordcloudBorderWidth BorderWidth { get; set; }
		private GaugeSeriesWordcloudBorderWidth BorderWidth_DefaultValue { get; set; }
		 

		/// <summary>
		/// 
		/// </summary>
		public GaugeSeriesWordcloudClip Clip { get; set; }
		private GaugeSeriesWordcloudClip Clip_DefaultValue { get; set; }
		...
		/// </summary>
		public GaugeSeriesWordcloudColorByPoint ColorByPoint { get; set; }
		private GaugeSeriesWordcloudColorByPoint ColorByPoint_DefaultValue { get; set; }
		...
		/// </summary>
		public GaugeSeriesWordcloudPlacementStrategy PlacementStrategy { get; set; }
		private GaugeSeriesWordcloudPlacementStrategy PlacementStrategy_DefaultValue { get; set; }
		 

		/// <summary>
		/// Rotation options for the words in the wordcloud.
		/// </summary>
		public GaugeSeriesWordcloudRotation Rotation { get; set; }
		private GaugeSeriesWordcloudRotation Rotation_DefaultValue { get; set; }
		 

		/// <summary>
		/// 
		/// </summary>
		public GaugeSeriesWordcloudShowInLegend ShowInLegend { get; set; }
		private GaugeSeriesWordcloudShowInLegend ShowInLegend_DefaultValue { get; set; }
		...
		/// </summary>
		public GaugeSeriesWordcloudSpiral Spiral { get; set; }
		private GaugeSeriesWordcloudSpiral Spiral_DefaultValue { get; set; }
		...
		/// 
		/// </summary>
		public GaugeSeriesWordcloudTooltip Tooltip { get; set; }
		private GaugeSeriesWordcloudTooltip Tooltip_DefaultValue { get; set; }
