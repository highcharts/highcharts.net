...
{
	public partial class GaugeSeriesWordcloudLabel  : BaseObject
	{
		public GaugeSeriesWordcloudLabel()
		{
		...
		/// </summary>
		public GaugeSeriesWordcloudLabelEnabled Enabled { get; set; }
		private GaugeSeriesWordcloudLabelEnabled Enabled_DefaultValue { get; set; }
		 

		/// <summary>
		/// Allow labels to be placed distant to the graph if necessary,and draw a connector line to the graph.
		/// </summary>
		public GaugeSeriesWordcloudLabelConnectorAllowed ConnectorAllowed { get; set; }
		private GaugeSeriesWordcloudLabelConnectorAllowed ConnectorAllowed_DefaultValue { get; set; }
		 

		/// <summary>
		/// If the label is closer than this to a neighbour graph, draw aconnector.
		/// </summary>
		public GaugeSeriesWordcloudLabelConnectorNeighbourDistance ConnectorNeighbourDistance { get; set; }
		private GaugeSeriesWordcloudLabelConnectorNeighbourDistance ConnectorNeighbourDistance_DefaultValue { get; set; }
		...
		/// </summary>
		public GaugeSeriesWordcloudLabelStyle Style { get; set; }
		private GaugeSeriesWordcloudLabelStyle Style_DefaultValue { get; set; }
