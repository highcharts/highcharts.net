...
namespace Highsoft.Web.Mvc.Charts
{
	public partial class HeatmapSeries  : Series
	{
		...
		/// </summary>
		public HeatmapSeriesSunburst Sunburst { get; set; }
		private HeatmapSeriesSunburst Sunburst_DefaultValue { get; set; }
		...
		/// </summary>
		public HeatmapSeriesWordcloud Wordcloud { get; set; }
		private HeatmapSeriesWordcloud Wordcloud_DefaultValue { get; set; }
		...
		/// </summary>
		public HeatmapSeriesBorderWidth BorderWidth { get; set; }
		private HeatmapSeriesBorderWidth BorderWidth_DefaultValue { get; set; }
