...
{
	public partial class HeatmapSeriesSunburst  : BaseObject
	{
		public HeatmapSeriesSunburst()
		{
			Data = Data_DefaultValue = new List<SeriesHeatmapSunburstData>();
		...
		/// 
		/// </summary>
		public List<SeriesHeatmapSunburstData> Data { get; set; }
		private List<SeriesHeatmapSunburstData> Data_DefaultValue { get; set; }
		 

		/// <summary>
		/// Series labels are placed as close to the series as possible in anatural way, seeking to avoid other series. The goal of thisfeature is to make the chart more easily readable, like if ahuman designer placed the labels in the optimal position.The series labels currently work with series types having a`graph` or an `area`.Requires the `series-label.js` module.
		/// </summary>
		public HeatmapSeriesSunburstLabel Label { get; set; }
		private HeatmapSeriesSunburstLabel Label_DefaultValue { get; set; }
		...
		/// </summary>
		public HeatmapSeriesSunburstStickyTracking StickyTracking { get; set; }
		private HeatmapSeriesSunburstStickyTracking StickyTracking_DefaultValue { get; set; }
		 

		/// <summary>
		/// 
		/// </summary>
		public HeatmapSeriesSunburstTooltip Tooltip { get; set; }
		private HeatmapSeriesSunburstTooltip Tooltip_DefaultValue { get; set; }
		...
		/// 
		/// </summary>
		public HeatmapSeriesSunburstStates States { get; set; }
		private HeatmapSeriesSunburstStates States_DefaultValue { get; set; }
		...
		/// 
		/// </summary>
		public HeatmapSeriesSunburstEvents Events { get; set; }
		private HeatmapSeriesSunburstEvents Events_DefaultValue { get; set; }
		 

		/// <summary>
		/// 
		/// </summary>
		public HeatmapSeriesSunburstPoint Point { get; set; }
		private HeatmapSeriesSunburstPoint Point_DefaultValue { get; set; }
		...
		/// 
		/// </summary>
		public HeatmapSeriesSunburstDataLabels DataLabels { get; set; }
		private HeatmapSeriesSunburstDataLabels DataLabels_DefaultValue { get; set; }
		...
		/// </summary>
		public HeatmapSeriesSunburstLevelIsConstant LevelIsConstant { get; set; }
		private HeatmapSeriesSunburstLevelIsConstant LevelIsConstant_DefaultValue { get; set; }
