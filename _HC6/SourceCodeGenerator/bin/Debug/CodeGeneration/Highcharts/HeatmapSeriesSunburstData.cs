...
{
	public partial class HeatmapSeriesSunburstData  : BaseObject
	{
		public HeatmapSeriesSunburstData()
		{
		...
		/// </summary>
		public HeatmapSeriesSunburstDataEvents Events { get; set; }
		private HeatmapSeriesSunburstDataEvents Events_DefaultValue { get; set; }
