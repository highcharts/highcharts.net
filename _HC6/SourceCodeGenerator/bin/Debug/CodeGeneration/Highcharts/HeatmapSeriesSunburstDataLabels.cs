...
{
	public partial class HeatmapSeriesSunburstDataLabels  : BaseObject
	{
		public HeatmapSeriesSunburstDataLabels()
		{
		...
		/// 
		/// </summary>
		public HeatmapSeriesSunburstDataLabelsDefer Defer { get; set; }
		private HeatmapSeriesSunburstDataLabelsDefer Defer_DefaultValue { get; set; }
		 

		/// <summary>
		/// 
		/// </summary>
		public HeatmapSeriesSunburstDataLabelsStyle Style { get; set; }
		private HeatmapSeriesSunburstDataLabelsStyle Style_DefaultValue { get; set; }
		...
		/// </summary>
		public HeatmapSeriesSunburstDataLabelsRotationMode RotationMode { get; set; }
		private HeatmapSeriesSunburstDataLabelsRotationMode RotationMode_DefaultValue { get; set; }
