...
{
	public partial class HeatmapSeriesSunburstLabel  : BaseObject
	{
		public HeatmapSeriesSunburstLabel()
		{
		...
		/// </summary>
		public HeatmapSeriesSunburstLabelEnabled Enabled { get; set; }
		private HeatmapSeriesSunburstLabelEnabled Enabled_DefaultValue { get; set; }
		 

		/// <summary>
		/// Allow labels to be placed distant to the graph if necessary,and draw a connector line to the graph.
		/// </summary>
		public HeatmapSeriesSunburstLabelConnectorAllowed ConnectorAllowed { get; set; }
		private HeatmapSeriesSunburstLabelConnectorAllowed ConnectorAllowed_DefaultValue { get; set; }
		 

		/// <summary>
		/// If the label is closer than this to a neighbour graph, draw aconnector.
		/// </summary>
		public HeatmapSeriesSunburstLabelConnectorNeighbourDistance ConnectorNeighbourDistance { get; set; }
		private HeatmapSeriesSunburstLabelConnectorNeighbourDistance ConnectorNeighbourDistance_DefaultValue { get; set; }
		...
		/// </summary>
		public HeatmapSeriesSunburstLabelStyle Style { get; set; }
		private HeatmapSeriesSunburstLabelStyle Style_DefaultValue { get; set; }
