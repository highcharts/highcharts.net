...
{
	public partial class HeatmapSeriesWordcloud  : BaseObject
	{
		public HeatmapSeriesWordcloud()
		{
			Data = Data_DefaultValue = new List<SeriesHeatmapWordcloudData>();
		...
		/// </summary>
		public List<SeriesHeatmapWordcloudData> Data { get; set; }
		private List<SeriesHeatmapWordcloudData> Data_DefaultValue { get; set; }
		 

		/// <summary>
		/// Series labels are placed as close to the series as possible in anatural way, seeking to avoid other series. The goal of thisfeature is to make the chart more easily readable, like if ahuman designer placed the labels in the optimal position.The series labels currently work with series types having a`graph` or an `area`.Requires the `series-label.js` module.
		/// </summary>
		public HeatmapSeriesWordcloudLabel Label { get; set; }
		private HeatmapSeriesWordcloudLabel Label_DefaultValue { get; set; }
		...
		/// </summary>
		public HeatmapSeriesWordcloudEvents Events { get; set; }
		private HeatmapSeriesWordcloudEvents Events_DefaultValue { get; set; }
		 

		/// <summary>
		/// Properties for each single point.
		/// </summary>
		public HeatmapSeriesWordcloudPoint Point { get; set; }
		private HeatmapSeriesWordcloudPoint Point_DefaultValue { get; set; }
		...
		/// 
		/// </summary>
		public HeatmapSeriesWordcloudStates States { get; set; }
		private HeatmapSeriesWordcloudStates States_DefaultValue { get; set; }
		 

		/// <summary>
		/// 
		/// </summary>
		public HeatmapSeriesWordcloudStickyTracking StickyTracking { get; set; }
		private HeatmapSeriesWordcloudStickyTracking StickyTracking_DefaultValue { get; set; }
		...
		/// 
		/// </summary>
		public HeatmapSeriesWordcloudBorderWidth BorderWidth { get; set; }
		private HeatmapSeriesWordcloudBorderWidth BorderWidth_DefaultValue { get; set; }
		 

		/// <summary>
		/// 
		/// </summary>
		public HeatmapSeriesWordcloudClip Clip { get; set; }
		private HeatmapSeriesWordcloudClip Clip_DefaultValue { get; set; }
		...
		/// </summary>
		public HeatmapSeriesWordcloudColorByPoint ColorByPoint { get; set; }
		private HeatmapSeriesWordcloudColorByPoint ColorByPoint_DefaultValue { get; set; }
		...
		/// </summary>
		public HeatmapSeriesWordcloudPlacementStrategy PlacementStrategy { get; set; }
		private HeatmapSeriesWordcloudPlacementStrategy PlacementStrategy_DefaultValue { get; set; }
		 

		/// <summary>
		/// Rotation options for the words in the wordcloud.
		/// </summary>
		public HeatmapSeriesWordcloudRotation Rotation { get; set; }
		private HeatmapSeriesWordcloudRotation Rotation_DefaultValue { get; set; }
		 

		/// <summary>
		/// 
		/// </summary>
		public HeatmapSeriesWordcloudShowInLegend ShowInLegend { get; set; }
		private HeatmapSeriesWordcloudShowInLegend ShowInLegend_DefaultValue { get; set; }
		...
		/// </summary>
		public HeatmapSeriesWordcloudSpiral Spiral { get; set; }
		private HeatmapSeriesWordcloudSpiral Spiral_DefaultValue { get; set; }
		...
		/// 
		/// </summary>
		public HeatmapSeriesWordcloudTooltip Tooltip { get; set; }
		private HeatmapSeriesWordcloudTooltip Tooltip_DefaultValue { get; set; }
