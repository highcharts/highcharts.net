...
{
	public partial class HeatmapSeriesWordcloudLabel  : BaseObject
	{
		public HeatmapSeriesWordcloudLabel()
		{
		...
		/// </summary>
		public HeatmapSeriesWordcloudLabelEnabled Enabled { get; set; }
		private HeatmapSeriesWordcloudLabelEnabled Enabled_DefaultValue { get; set; }
		 

		/// <summary>
		/// Allow labels to be placed distant to the graph if necessary,and draw a connector line to the graph.
		/// </summary>
		public HeatmapSeriesWordcloudLabelConnectorAllowed ConnectorAllowed { get; set; }
		private HeatmapSeriesWordcloudLabelConnectorAllowed ConnectorAllowed_DefaultValue { get; set; }
		 

		/// <summary>
		/// If the label is closer than this to a neighbour graph, draw aconnector.
		/// </summary>
		public HeatmapSeriesWordcloudLabelConnectorNeighbourDistance ConnectorNeighbourDistance { get; set; }
		private HeatmapSeriesWordcloudLabelConnectorNeighbourDistance ConnectorNeighbourDistance_DefaultValue { get; set; }
		...
		/// </summary>
		public HeatmapSeriesWordcloudLabelStyle Style { get; set; }
		private HeatmapSeriesWordcloudLabelStyle Style_DefaultValue { get; set; }
