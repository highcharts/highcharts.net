...
namespace Highsoft.Web.Mvc.Charts
{
	public partial class Highcharts  : BaseObject
	{
		public Highcharts()
		{
			PlotOptions = PlotOptions_DefaultValue = null;
			Series = Series_DefaultValue = new List<Series>();
			Accessibility = Accessibility_DefaultValue = null;
			Chart = Chart_DefaultValue = null;
			Legend = Legend_DefaultValue = null;
			Defs = Defs_DefaultValue = null;
			Annotations = Annotations_DefaultValue = new List<Annotations>();
			Boost = Boost_DefaultValue = null;
			Data = Data_DefaultValue = new Data();
			YAxis = YAxis_DefaultValue = "";
			Lang = Lang_DefaultValue = null;
			Drilldown = Drilldown_DefaultValue = null;
			Exporting = Exporting_DefaultValue = null;
			Navigation = Navigation_DefaultValue = null;
			NoData = NoData_DefaultValue = null;
			Global = Global_DefaultValue = null;
			XAxis = XAxis_DefaultValue = "";
			Colors = Colors_DefaultValue = new List<string>();
			Title = Title_DefaultValue = null;
			Subtitle = Subtitle_DefaultValue = null;
			Labels = Labels_DefaultValue = null;
			Loading = Loading_DefaultValue = null;
			Tooltip = Tooltip_DefaultValue = null;
			Credits = Credits_DefaultValue = null;
			Responsive = Responsive_DefaultValue = null;
			Pane = Pane_DefaultValue = null;
			ColorAxis = ColorAxis_DefaultValue = null;
			ZAxis = ZAxis_DefaultValue = null;
