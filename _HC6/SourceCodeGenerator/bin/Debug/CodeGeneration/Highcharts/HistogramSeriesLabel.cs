...
{
	public partial class HistogramSeriesLabel  : BaseObject
	{
		public HistogramSeriesLabel()
		{
			...
			Style = Style_DefaultValue = new HistogramSeriesLabelStyle();
		...
		/// </summary>
		public HistogramSeriesLabelEnabled Enabled { get; set; }
		private HistogramSeriesLabelEnabled Enabled_DefaultValue { get; set; }
		 

		/// <summary>
		/// Allow labels to be placed distant to the graph if necessary,and draw a connector line to the graph.
		/// </summary>
		public HistogramSeriesLabelConnectorAllowed ConnectorAllowed { get; set; }
		private HistogramSeriesLabelConnectorAllowed ConnectorAllowed_DefaultValue { get; set; }
		 

		/// <summary>
		/// If the label is closer than this to a neighbour graph, draw aconnector.
		/// </summary>
		public HistogramSeriesLabelConnectorNeighbourDistance ConnectorNeighbourDistance { get; set; }
		private HistogramSeriesLabelConnectorNeighbourDistance ConnectorNeighbourDistance_DefaultValue { get; set; }
		...
		/// </summary>
		public HistogramSeriesLabelStyle Style { get; set; }
		private HistogramSeriesLabelStyle Style_DefaultValue { get; set; }
