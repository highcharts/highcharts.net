...
{
	public partial class HistogramSeriesSunburst  : BaseObject
	{
		public HistogramSeriesSunburst()
		{
			Data = Data_DefaultValue = new List<SeriesHistogramSunburstData>();
		...
		/// 
		/// </summary>
		public List<SeriesHistogramSunburstData> Data { get; set; }
		private List<SeriesHistogramSunburstData> Data_DefaultValue { get; set; }
		 

		/// <summary>
		/// Series labels are placed as close to the series as possible in anatural way, seeking to avoid other series. The goal of thisfeature is to make the chart more easily readable, like if ahuman designer placed the labels in the optimal position.The series labels currently work with series types having a`graph` or an `area`.Requires the `series-label.js` module.
		/// </summary>
		public HistogramSeriesSunburstLabel Label { get; set; }
		private HistogramSeriesSunburstLabel Label_DefaultValue { get; set; }
		...
		/// </summary>
		public HistogramSeriesSunburstStickyTracking StickyTracking { get; set; }
		private HistogramSeriesSunburstStickyTracking StickyTracking_DefaultValue { get; set; }
		 

		/// <summary>
		/// 
		/// </summary>
		public HistogramSeriesSunburstTooltip Tooltip { get; set; }
		private HistogramSeriesSunburstTooltip Tooltip_DefaultValue { get; set; }
		...
		/// 
		/// </summary>
		public HistogramSeriesSunburstStates States { get; set; }
		private HistogramSeriesSunburstStates States_DefaultValue { get; set; }
		...
		/// 
		/// </summary>
		public HistogramSeriesSunburstEvents Events { get; set; }
		private HistogramSeriesSunburstEvents Events_DefaultValue { get; set; }
		 

		/// <summary>
		/// 
		/// </summary>
		public HistogramSeriesSunburstPoint Point { get; set; }
		private HistogramSeriesSunburstPoint Point_DefaultValue { get; set; }
		...
		/// 
		/// </summary>
		public HistogramSeriesSunburstDataLabels DataLabels { get; set; }
		private HistogramSeriesSunburstDataLabels DataLabels_DefaultValue { get; set; }
		...
		/// </summary>
		public HistogramSeriesSunburstLevelIsConstant LevelIsConstant { get; set; }
		private HistogramSeriesSunburstLevelIsConstant LevelIsConstant_DefaultValue { get; set; }
