...
{
	public partial class HistogramSeriesSunburstData  : BaseObject
	{
		public HistogramSeriesSunburstData()
		{
		...
		/// </summary>
		public HistogramSeriesSunburstDataEvents Events { get; set; }
		private HistogramSeriesSunburstDataEvents Events_DefaultValue { get; set; }
