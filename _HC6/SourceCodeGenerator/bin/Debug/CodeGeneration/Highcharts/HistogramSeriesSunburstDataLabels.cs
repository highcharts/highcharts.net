...
{
	public partial class HistogramSeriesSunburstDataLabels  : BaseObject
	{
		public HistogramSeriesSunburstDataLabels()
		{
		...
		/// 
		/// </summary>
		public HistogramSeriesSunburstDataLabelsDefer Defer { get; set; }
		private HistogramSeriesSunburstDataLabelsDefer Defer_DefaultValue { get; set; }
		 

		/// <summary>
		/// 
		/// </summary>
		public HistogramSeriesSunburstDataLabelsStyle Style { get; set; }
		private HistogramSeriesSunburstDataLabelsStyle Style_DefaultValue { get; set; }
		...
		/// </summary>
		public HistogramSeriesSunburstDataLabelsRotationMode RotationMode { get; set; }
		private HistogramSeriesSunburstDataLabelsRotationMode RotationMode_DefaultValue { get; set; }
