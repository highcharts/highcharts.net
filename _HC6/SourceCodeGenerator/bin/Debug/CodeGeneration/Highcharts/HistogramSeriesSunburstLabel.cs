...
{
	public partial class HistogramSeriesSunburstLabel  : BaseObject
	{
		public HistogramSeriesSunburstLabel()
		{
		...
		/// </summary>
		public HistogramSeriesSunburstLabelEnabled Enabled { get; set; }
		private HistogramSeriesSunburstLabelEnabled Enabled_DefaultValue { get; set; }
		 

		/// <summary>
		/// Allow labels to be placed distant to the graph if necessary,and draw a connector line to the graph.
		/// </summary>
		public HistogramSeriesSunburstLabelConnectorAllowed ConnectorAllowed { get; set; }
		private HistogramSeriesSunburstLabelConnectorAllowed ConnectorAllowed_DefaultValue { get; set; }
		 

		/// <summary>
		/// If the label is closer than this to a neighbour graph, draw aconnector.
		/// </summary>
		public HistogramSeriesSunburstLabelConnectorNeighbourDistance ConnectorNeighbourDistance { get; set; }
		private HistogramSeriesSunburstLabelConnectorNeighbourDistance ConnectorNeighbourDistance_DefaultValue { get; set; }
		...
		/// </summary>
		public HistogramSeriesSunburstLabelStyle Style { get; set; }
		private HistogramSeriesSunburstLabelStyle Style_DefaultValue { get; set; }
