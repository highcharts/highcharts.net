...
{
	public partial class HistogramSeriesWordcloud  : BaseObject
	{
		public HistogramSeriesWordcloud()
		{
			Data = Data_DefaultValue = new List<SeriesHistogramWordcloudData>();
		...
		/// </summary>
		public List<SeriesHistogramWordcloudData> Data { get; set; }
		private List<SeriesHistogramWordcloudData> Data_DefaultValue { get; set; }
		 

		/// <summary>
		/// Series labels are placed as close to the series as possible in anatural way, seeking to avoid other series. The goal of thisfeature is to make the chart more easily readable, like if ahuman designer placed the labels in the optimal position.The series labels currently work with series types having a`graph` or an `area`.Requires the `series-label.js` module.
		/// </summary>
		public HistogramSeriesWordcloudLabel Label { get; set; }
		private HistogramSeriesWordcloudLabel Label_DefaultValue { get; set; }
		...
		/// </summary>
		public HistogramSeriesWordcloudEvents Events { get; set; }
		private HistogramSeriesWordcloudEvents Events_DefaultValue { get; set; }
		 

		/// <summary>
		/// Properties for each single point.
		/// </summary>
		public HistogramSeriesWordcloudPoint Point { get; set; }
		private HistogramSeriesWordcloudPoint Point_DefaultValue { get; set; }
		...
		/// 
		/// </summary>
		public HistogramSeriesWordcloudStates States { get; set; }
		private HistogramSeriesWordcloudStates States_DefaultValue { get; set; }
		 

		/// <summary>
		/// 
		/// </summary>
		public HistogramSeriesWordcloudStickyTracking StickyTracking { get; set; }
		private HistogramSeriesWordcloudStickyTracking StickyTracking_DefaultValue { get; set; }
		...
		/// 
		/// </summary>
		public HistogramSeriesWordcloudBorderWidth BorderWidth { get; set; }
		private HistogramSeriesWordcloudBorderWidth BorderWidth_DefaultValue { get; set; }
		 

		/// <summary>
		/// 
		/// </summary>
		public HistogramSeriesWordcloudClip Clip { get; set; }
		private HistogramSeriesWordcloudClip Clip_DefaultValue { get; set; }
		...
		/// </summary>
		public HistogramSeriesWordcloudColorByPoint ColorByPoint { get; set; }
		private HistogramSeriesWordcloudColorByPoint ColorByPoint_DefaultValue { get; set; }
		...
		/// </summary>
		public HistogramSeriesWordcloudPlacementStrategy PlacementStrategy { get; set; }
		private HistogramSeriesWordcloudPlacementStrategy PlacementStrategy_DefaultValue { get; set; }
		 

		/// <summary>
		/// Rotation options for the words in the wordcloud.
		/// </summary>
		public HistogramSeriesWordcloudRotation Rotation { get; set; }
		private HistogramSeriesWordcloudRotation Rotation_DefaultValue { get; set; }
		 

		/// <summary>
		/// 
		/// </summary>
		public HistogramSeriesWordcloudShowInLegend ShowInLegend { get; set; }
		private HistogramSeriesWordcloudShowInLegend ShowInLegend_DefaultValue { get; set; }
		...
		/// </summary>
		public HistogramSeriesWordcloudSpiral Spiral { get; set; }
		private HistogramSeriesWordcloudSpiral Spiral_DefaultValue { get; set; }
		...
		/// 
		/// </summary>
		public HistogramSeriesWordcloudTooltip Tooltip { get; set; }
		private HistogramSeriesWordcloudTooltip Tooltip_DefaultValue { get; set; }
