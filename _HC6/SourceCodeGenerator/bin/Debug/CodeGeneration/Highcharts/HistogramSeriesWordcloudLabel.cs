...
{
	public partial class HistogramSeriesWordcloudLabel  : BaseObject
	{
		public HistogramSeriesWordcloudLabel()
		{
		...
		/// </summary>
		public HistogramSeriesWordcloudLabelEnabled Enabled { get; set; }
		private HistogramSeriesWordcloudLabelEnabled Enabled_DefaultValue { get; set; }
		 

		/// <summary>
		/// Allow labels to be placed distant to the graph if necessary,and draw a connector line to the graph.
		/// </summary>
		public HistogramSeriesWordcloudLabelConnectorAllowed ConnectorAllowed { get; set; }
		private HistogramSeriesWordcloudLabelConnectorAllowed ConnectorAllowed_DefaultValue { get; set; }
		 

		/// <summary>
		/// If the label is closer than this to a neighbour graph, draw aconnector.
		/// </summary>
		public HistogramSeriesWordcloudLabelConnectorNeighbourDistance ConnectorNeighbourDistance { get; set; }
		private HistogramSeriesWordcloudLabelConnectorNeighbourDistance ConnectorNeighbourDistance_DefaultValue { get; set; }
		...
		/// </summary>
		public HistogramSeriesWordcloudLabelStyle Style { get; set; }
		private HistogramSeriesWordcloudLabelStyle Style_DefaultValue { get; set; }
