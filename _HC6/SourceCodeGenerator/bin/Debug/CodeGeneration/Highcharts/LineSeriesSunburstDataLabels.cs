...
{
	public partial class LineSeriesSunburstDataLabels  : BaseObject
	{
		public LineSeriesSunburstDataLabels()
		{
		...
		/// 
		/// </summary>
		public LineSeriesSunburstDataLabelsDefer Defer { get; set; }
		private LineSeriesSunburstDataLabelsDefer Defer_DefaultValue { get; set; }
		 

		/// <summary>
		/// 
		/// </summary>
		public LineSeriesSunburstDataLabelsStyle Style { get; set; }
		private LineSeriesSunburstDataLabelsStyle Style_DefaultValue { get; set; }
		...
		/// </summary>
		public LineSeriesSunburstDataLabelsRotationMode RotationMode { get; set; }
		private LineSeriesSunburstDataLabelsRotationMode RotationMode_DefaultValue { get; set; }
