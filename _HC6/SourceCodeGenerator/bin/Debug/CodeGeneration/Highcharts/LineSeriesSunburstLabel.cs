...
{
	public partial class LineSeriesSunburstLabel  : BaseObject
	{
		public LineSeriesSunburstLabel()
		{
		...
		/// </summary>
		public LineSeriesSunburstLabelEnabled Enabled { get; set; }
		private LineSeriesSunburstLabelEnabled Enabled_DefaultValue { get; set; }
		 

		/// <summary>
		/// Allow labels to be placed distant to the graph if necessary,and draw a connector line to the graph.
		/// </summary>
		public LineSeriesSunburstLabelConnectorAllowed ConnectorAllowed { get; set; }
		private LineSeriesSunburstLabelConnectorAllowed ConnectorAllowed_DefaultValue { get; set; }
		 

		/// <summary>
		/// If the label is closer than this to a neighbour graph, draw aconnector.
		/// </summary>
		public LineSeriesSunburstLabelConnectorNeighbourDistance ConnectorNeighbourDistance { get; set; }
		private LineSeriesSunburstLabelConnectorNeighbourDistance ConnectorNeighbourDistance_DefaultValue { get; set; }
		...
		/// </summary>
		public LineSeriesSunburstLabelStyle Style { get; set; }
		private LineSeriesSunburstLabelStyle Style_DefaultValue { get; set; }
