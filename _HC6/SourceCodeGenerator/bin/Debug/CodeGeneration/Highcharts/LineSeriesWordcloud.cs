...
{
	public partial class LineSeriesWordcloud  : BaseObject
	{
		public LineSeriesWordcloud()
		{
			Data = Data_DefaultValue = new List<SeriesLineWordcloudData>();
		...
		/// </summary>
		public List<SeriesLineWordcloudData> Data { get; set; }
		private List<SeriesLineWordcloudData> Data_DefaultValue { get; set; }
		 

		/// <summary>
		/// Series labels are placed as close to the series as possible in anatural way, seeking to avoid other series. The goal of thisfeature is to make the chart more easily readable, like if ahuman designer placed the labels in the optimal position.The series labels currently work with series types having a`graph` or an `area`.Requires the `series-label.js` module.
		/// </summary>
		public LineSeriesWordcloudLabel Label { get; set; }
		private LineSeriesWordcloudLabel Label_DefaultValue { get; set; }
		...
		/// </summary>
		public LineSeriesWordcloudEvents Events { get; set; }
		private LineSeriesWordcloudEvents Events_DefaultValue { get; set; }
		 

		/// <summary>
		/// Properties for each single point.
		/// </summary>
		public LineSeriesWordcloudPoint Point { get; set; }
		private LineSeriesWordcloudPoint Point_DefaultValue { get; set; }
		...
		/// 
		/// </summary>
		public LineSeriesWordcloudStates States { get; set; }
		private LineSeriesWordcloudStates States_DefaultValue { get; set; }
		 

		/// <summary>
		/// 
		/// </summary>
		public LineSeriesWordcloudStickyTracking StickyTracking { get; set; }
		private LineSeriesWordcloudStickyTracking StickyTracking_DefaultValue { get; set; }
		...
		/// 
		/// </summary>
		public LineSeriesWordcloudBorderWidth BorderWidth { get; set; }
		private LineSeriesWordcloudBorderWidth BorderWidth_DefaultValue { get; set; }
		 

		/// <summary>
		/// 
		/// </summary>
		public LineSeriesWordcloudClip Clip { get; set; }
		private LineSeriesWordcloudClip Clip_DefaultValue { get; set; }
		...
		/// </summary>
		public LineSeriesWordcloudColorByPoint ColorByPoint { get; set; }
		private LineSeriesWordcloudColorByPoint ColorByPoint_DefaultValue { get; set; }
		...
		/// </summary>
		public LineSeriesWordcloudPlacementStrategy PlacementStrategy { get; set; }
		private LineSeriesWordcloudPlacementStrategy PlacementStrategy_DefaultValue { get; set; }
		 

		/// <summary>
		/// Rotation options for the words in the wordcloud.
		/// </summary>
		public LineSeriesWordcloudRotation Rotation { get; set; }
		private LineSeriesWordcloudRotation Rotation_DefaultValue { get; set; }
		 

		/// <summary>
		/// 
		/// </summary>
		public LineSeriesWordcloudShowInLegend ShowInLegend { get; set; }
		private LineSeriesWordcloudShowInLegend ShowInLegend_DefaultValue { get; set; }
		...
		/// </summary>
		public LineSeriesWordcloudSpiral Spiral { get; set; }
		private LineSeriesWordcloudSpiral Spiral_DefaultValue { get; set; }
		...
		/// 
		/// </summary>
		public LineSeriesWordcloudTooltip Tooltip { get; set; }
		private LineSeriesWordcloudTooltip Tooltip_DefaultValue { get; set; }
