...
{
	public partial class LineSeriesWordcloudLabel  : BaseObject
	{
		public LineSeriesWordcloudLabel()
		{
		...
		/// </summary>
		public LineSeriesWordcloudLabelEnabled Enabled { get; set; }
		private LineSeriesWordcloudLabelEnabled Enabled_DefaultValue { get; set; }
		 

		/// <summary>
		/// Allow labels to be placed distant to the graph if necessary,and draw a connector line to the graph.
		/// </summary>
		public LineSeriesWordcloudLabelConnectorAllowed ConnectorAllowed { get; set; }
		private LineSeriesWordcloudLabelConnectorAllowed ConnectorAllowed_DefaultValue { get; set; }
		 

		/// <summary>
		/// If the label is closer than this to a neighbour graph, draw aconnector.
		/// </summary>
		public LineSeriesWordcloudLabelConnectorNeighbourDistance ConnectorNeighbourDistance { get; set; }
		private LineSeriesWordcloudLabelConnectorNeighbourDistance ConnectorNeighbourDistance_DefaultValue { get; set; }
		...
		/// </summary>
		public LineSeriesWordcloudLabelStyle Style { get; set; }
		private LineSeriesWordcloudLabelStyle Style_DefaultValue { get; set; }
