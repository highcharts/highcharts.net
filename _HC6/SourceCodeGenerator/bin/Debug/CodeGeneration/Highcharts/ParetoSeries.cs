...
namespace Highsoft.Web.Mvc.Charts
{
	public partial class ParetoSeries  : Series
	{
		public ParetoSeries()
		{
			Data = Data_DefaultValue = new List<SeriesParetoData>();
		...
		/// </summary>
		public ParetoSeriesSunburst Sunburst { get; set; }
		private ParetoSeriesSunburst Sunburst_DefaultValue { get; set; }
		...
		/// </summary>
		public ParetoSeriesWordcloud Wordcloud { get; set; }
		private ParetoSeriesWordcloud Wordcloud_DefaultValue { get; set; }
