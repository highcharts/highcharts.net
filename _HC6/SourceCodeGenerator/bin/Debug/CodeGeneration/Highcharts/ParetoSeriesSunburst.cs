...
{
	public partial class ParetoSeriesSunburst  : BaseObject
	{
		public ParetoSeriesSunburst()
		{
			Data = Data_DefaultValue = new List<SeriesParetoSunburstData>();
		...
		/// 
		/// </summary>
		public List<SeriesParetoSunburstData> Data { get; set; }
		private List<SeriesParetoSunburstData> Data_DefaultValue { get; set; }
		 

		/// <summary>
		/// Series labels are placed as close to the series as possible in anatural way, seeking to avoid other series. The goal of thisfeature is to make the chart more easily readable, like if ahuman designer placed the labels in the optimal position.The series labels currently work with series types having a`graph` or an `area`.Requires the `series-label.js` module.
		/// </summary>
		public ParetoSeriesSunburstLabel Label { get; set; }
		private ParetoSeriesSunburstLabel Label_DefaultValue { get; set; }
		...
		/// </summary>
		public ParetoSeriesSunburstStickyTracking StickyTracking { get; set; }
		private ParetoSeriesSunburstStickyTracking StickyTracking_DefaultValue { get; set; }
		 

		/// <summary>
		/// 
		/// </summary>
		public ParetoSeriesSunburstTooltip Tooltip { get; set; }
		private ParetoSeriesSunburstTooltip Tooltip_DefaultValue { get; set; }
		...
		/// 
		/// </summary>
		public ParetoSeriesSunburstStates States { get; set; }
		private ParetoSeriesSunburstStates States_DefaultValue { get; set; }
		...
		/// 
		/// </summary>
		public ParetoSeriesSunburstEvents Events { get; set; }
		private ParetoSeriesSunburstEvents Events_DefaultValue { get; set; }
		 

		/// <summary>
		/// 
		/// </summary>
		public ParetoSeriesSunburstPoint Point { get; set; }
		private ParetoSeriesSunburstPoint Point_DefaultValue { get; set; }
		...
		/// 
		/// </summary>
		public ParetoSeriesSunburstDataLabels DataLabels { get; set; }
		private ParetoSeriesSunburstDataLabels DataLabels_DefaultValue { get; set; }
		...
		/// </summary>
		public ParetoSeriesSunburstLevelIsConstant LevelIsConstant { get; set; }
		private ParetoSeriesSunburstLevelIsConstant LevelIsConstant_DefaultValue { get; set; }
