...
{
	public partial class ParetoSeriesSunburstDataLabels  : BaseObject
	{
		public ParetoSeriesSunburstDataLabels()
		{
		...
		/// 
		/// </summary>
		public ParetoSeriesSunburstDataLabelsDefer Defer { get; set; }
		private ParetoSeriesSunburstDataLabelsDefer Defer_DefaultValue { get; set; }
		 

		/// <summary>
		/// 
		/// </summary>
		public ParetoSeriesSunburstDataLabelsStyle Style { get; set; }
		private ParetoSeriesSunburstDataLabelsStyle Style_DefaultValue { get; set; }
		...
		/// </summary>
		public ParetoSeriesSunburstDataLabelsRotationMode RotationMode { get; set; }
		private ParetoSeriesSunburstDataLabelsRotationMode RotationMode_DefaultValue { get; set; }
