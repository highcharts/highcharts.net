...
{
	public partial class ParetoSeriesSunburstLabel  : BaseObject
	{
		public ParetoSeriesSunburstLabel()
		{
		...
		/// </summary>
		public ParetoSeriesSunburstLabelEnabled Enabled { get; set; }
		private ParetoSeriesSunburstLabelEnabled Enabled_DefaultValue { get; set; }
		 

		/// <summary>
		/// Allow labels to be placed distant to the graph if necessary,and draw a connector line to the graph.
		/// </summary>
		public ParetoSeriesSunburstLabelConnectorAllowed ConnectorAllowed { get; set; }
		private ParetoSeriesSunburstLabelConnectorAllowed ConnectorAllowed_DefaultValue { get; set; }
		 

		/// <summary>
		/// If the label is closer than this to a neighbour graph, draw aconnector.
		/// </summary>
		public ParetoSeriesSunburstLabelConnectorNeighbourDistance ConnectorNeighbourDistance { get; set; }
		private ParetoSeriesSunburstLabelConnectorNeighbourDistance ConnectorNeighbourDistance_DefaultValue { get; set; }
		...
		/// </summary>
		public ParetoSeriesSunburstLabelStyle Style { get; set; }
		private ParetoSeriesSunburstLabelStyle Style_DefaultValue { get; set; }
