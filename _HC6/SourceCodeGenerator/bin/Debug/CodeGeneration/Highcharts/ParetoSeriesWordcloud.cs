...
{
	public partial class ParetoSeriesWordcloud  : BaseObject
	{
		public ParetoSeriesWordcloud()
		{
			Data = Data_DefaultValue = new List<SeriesParetoWordcloudData>();
		...
		/// </summary>
		public List<SeriesParetoWordcloudData> Data { get; set; }
		private List<SeriesParetoWordcloudData> Data_DefaultValue { get; set; }
		 

		/// <summary>
		/// Series labels are placed as close to the series as possible in anatural way, seeking to avoid other series. The goal of thisfeature is to make the chart more easily readable, like if ahuman designer placed the labels in the optimal position.The series labels currently work with series types having a`graph` or an `area`.Requires the `series-label.js` module.
		/// </summary>
		public ParetoSeriesWordcloudLabel Label { get; set; }
		private ParetoSeriesWordcloudLabel Label_DefaultValue { get; set; }
		...
		/// </summary>
		public ParetoSeriesWordcloudEvents Events { get; set; }
		private ParetoSeriesWordcloudEvents Events_DefaultValue { get; set; }
		 

		/// <summary>
		/// Properties for each single point.
		/// </summary>
		public ParetoSeriesWordcloudPoint Point { get; set; }
		private ParetoSeriesWordcloudPoint Point_DefaultValue { get; set; }
		...
		/// 
		/// </summary>
		public ParetoSeriesWordcloudStates States { get; set; }
		private ParetoSeriesWordcloudStates States_DefaultValue { get; set; }
		 

		/// <summary>
		/// 
		/// </summary>
		public ParetoSeriesWordcloudStickyTracking StickyTracking { get; set; }
		private ParetoSeriesWordcloudStickyTracking StickyTracking_DefaultValue { get; set; }
		...
		/// 
		/// </summary>
		public ParetoSeriesWordcloudBorderWidth BorderWidth { get; set; }
		private ParetoSeriesWordcloudBorderWidth BorderWidth_DefaultValue { get; set; }
		 

		/// <summary>
		/// 
		/// </summary>
		public ParetoSeriesWordcloudClip Clip { get; set; }
		private ParetoSeriesWordcloudClip Clip_DefaultValue { get; set; }
		...
		/// </summary>
		public ParetoSeriesWordcloudColorByPoint ColorByPoint { get; set; }
		private ParetoSeriesWordcloudColorByPoint ColorByPoint_DefaultValue { get; set; }
		...
		/// </summary>
		public ParetoSeriesWordcloudPlacementStrategy PlacementStrategy { get; set; }
		private ParetoSeriesWordcloudPlacementStrategy PlacementStrategy_DefaultValue { get; set; }
		 

		/// <summary>
		/// Rotation options for the words in the wordcloud.
		/// </summary>
		public ParetoSeriesWordcloudRotation Rotation { get; set; }
		private ParetoSeriesWordcloudRotation Rotation_DefaultValue { get; set; }
		 

		/// <summary>
		/// 
		/// </summary>
		public ParetoSeriesWordcloudShowInLegend ShowInLegend { get; set; }
		private ParetoSeriesWordcloudShowInLegend ShowInLegend_DefaultValue { get; set; }
		...
		/// </summary>
		public ParetoSeriesWordcloudSpiral Spiral { get; set; }
		private ParetoSeriesWordcloudSpiral Spiral_DefaultValue { get; set; }
		...
		/// 
		/// </summary>
		public ParetoSeriesWordcloudTooltip Tooltip { get; set; }
		private ParetoSeriesWordcloudTooltip Tooltip_DefaultValue { get; set; }
