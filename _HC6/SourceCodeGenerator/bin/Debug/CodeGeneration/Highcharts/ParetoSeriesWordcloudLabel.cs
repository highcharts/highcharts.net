...
{
	public partial class ParetoSeriesWordcloudLabel  : BaseObject
	{
		public ParetoSeriesWordcloudLabel()
		{
		...
		/// </summary>
		public ParetoSeriesWordcloudLabelEnabled Enabled { get; set; }
		private ParetoSeriesWordcloudLabelEnabled Enabled_DefaultValue { get; set; }
		 

		/// <summary>
		/// Allow labels to be placed distant to the graph if necessary,and draw a connector line to the graph.
		/// </summary>
		public ParetoSeriesWordcloudLabelConnectorAllowed ConnectorAllowed { get; set; }
		private ParetoSeriesWordcloudLabelConnectorAllowed ConnectorAllowed_DefaultValue { get; set; }
		 

		/// <summary>
		/// If the label is closer than this to a neighbour graph, draw aconnector.
		/// </summary>
		public ParetoSeriesWordcloudLabelConnectorNeighbourDistance ConnectorNeighbourDistance { get; set; }
		private ParetoSeriesWordcloudLabelConnectorNeighbourDistance ConnectorNeighbourDistance_DefaultValue { get; set; }
		...
		/// </summary>
		public ParetoSeriesWordcloudLabelStyle Style { get; set; }
		private ParetoSeriesWordcloudLabelStyle Style_DefaultValue { get; set; }
