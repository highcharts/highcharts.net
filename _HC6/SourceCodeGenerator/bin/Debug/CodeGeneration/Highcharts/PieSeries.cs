...
namespace Highsoft.Web.Mvc.Charts
{
	public partial class PieSeries  : Series
	{
		...
		/// </summary>
		public PieSeriesSunburst Sunburst { get; set; }
		private PieSeriesSunburst Sunburst_DefaultValue { get; set; }
		...
		/// </summary>
		public PieSeriesWordcloud Wordcloud { get; set; }
		private PieSeriesWordcloud Wordcloud_DefaultValue { get; set; }
		...
		/// </summary>
		public PieSeriesStickyTracking StickyTracking { get; set; }
		private PieSeriesStickyTracking StickyTracking_DefaultValue { get; set; }
