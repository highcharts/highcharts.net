...
{
	public partial class PieSeriesStatesHoverHalo  : BaseObject
	{
		...
		/// </summary>
		public PieSeriesStatesHoverHaloAttributes Attributes { get; set; }
		private PieSeriesStatesHoverHaloAttributes Attributes_DefaultValue { get; set; }
