...
{
	public partial class PieSeriesSunburstDataLabels  : BaseObject
	{
		public PieSeriesSunburstDataLabels()
		{
		...
		/// 
		/// </summary>
		public PieSeriesSunburstDataLabelsDefer Defer { get; set; }
		private PieSeriesSunburstDataLabelsDefer Defer_DefaultValue { get; set; }
		 

		/// <summary>
		/// 
		/// </summary>
		public PieSeriesSunburstDataLabelsStyle Style { get; set; }
		private PieSeriesSunburstDataLabelsStyle Style_DefaultValue { get; set; }
		...
		/// </summary>
		public PieSeriesSunburstDataLabelsRotationMode RotationMode { get; set; }
		private PieSeriesSunburstDataLabelsRotationMode RotationMode_DefaultValue { get; set; }
