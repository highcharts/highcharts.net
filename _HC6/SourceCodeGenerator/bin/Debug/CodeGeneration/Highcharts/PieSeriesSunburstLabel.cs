...
{
	public partial class PieSeriesSunburstLabel  : BaseObject
	{
		public PieSeriesSunburstLabel()
		{
		...
		/// </summary>
		public PieSeriesSunburstLabelEnabled Enabled { get; set; }
		private PieSeriesSunburstLabelEnabled Enabled_DefaultValue { get; set; }
		 

		/// <summary>
		/// Allow labels to be placed distant to the graph if necessary,and draw a connector line to the graph.
		/// </summary>
		public PieSeriesSunburstLabelConnectorAllowed ConnectorAllowed { get; set; }
		private PieSeriesSunburstLabelConnectorAllowed ConnectorAllowed_DefaultValue { get; set; }
		 

		/// <summary>
		/// If the label is closer than this to a neighbour graph, draw aconnector.
		/// </summary>
		public PieSeriesSunburstLabelConnectorNeighbourDistance ConnectorNeighbourDistance { get; set; }
		private PieSeriesSunburstLabelConnectorNeighbourDistance ConnectorNeighbourDistance_DefaultValue { get; set; }
		...
		/// </summary>
		public PieSeriesSunburstLabelStyle Style { get; set; }
		private PieSeriesSunburstLabelStyle Style_DefaultValue { get; set; }
