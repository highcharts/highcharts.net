...
{
	public partial class PieSeriesWordcloud  : BaseObject
	{
		public PieSeriesWordcloud()
		{
			Data = Data_DefaultValue = new List<SeriesPieWordcloudData>();
		...
		/// </summary>
		public List<SeriesPieWordcloudData> Data { get; set; }
		private List<SeriesPieWordcloudData> Data_DefaultValue { get; set; }
		 

		/// <summary>
		/// Series labels are placed as close to the series as possible in anatural way, seeking to avoid other series. The goal of thisfeature is to make the chart more easily readable, like if ahuman designer placed the labels in the optimal position.The series labels currently work with series types having a`graph` or an `area`.Requires the `series-label.js` module.
		/// </summary>
		public PieSeriesWordcloudLabel Label { get; set; }
		private PieSeriesWordcloudLabel Label_DefaultValue { get; set; }
		...
		/// </summary>
		public PieSeriesWordcloudEvents Events { get; set; }
		private PieSeriesWordcloudEvents Events_DefaultValue { get; set; }
		 

		/// <summary>
		/// Properties for each single point.
		/// </summary>
		public PieSeriesWordcloudPoint Point { get; set; }
		private PieSeriesWordcloudPoint Point_DefaultValue { get; set; }
		...
		/// 
		/// </summary>
		public PieSeriesWordcloudStates States { get; set; }
		private PieSeriesWordcloudStates States_DefaultValue { get; set; }
		 

		/// <summary>
		/// 
		/// </summary>
		public PieSeriesWordcloudStickyTracking StickyTracking { get; set; }
		private PieSeriesWordcloudStickyTracking StickyTracking_DefaultValue { get; set; }
		...
		/// 
		/// </summary>
		public PieSeriesWordcloudBorderWidth BorderWidth { get; set; }
		private PieSeriesWordcloudBorderWidth BorderWidth_DefaultValue { get; set; }
		 

		/// <summary>
		/// 
		/// </summary>
		public PieSeriesWordcloudClip Clip { get; set; }
		private PieSeriesWordcloudClip Clip_DefaultValue { get; set; }
		...
		/// </summary>
		public PieSeriesWordcloudColorByPoint ColorByPoint { get; set; }
		private PieSeriesWordcloudColorByPoint ColorByPoint_DefaultValue { get; set; }
		...
		/// </summary>
		public PieSeriesWordcloudPlacementStrategy PlacementStrategy { get; set; }
		private PieSeriesWordcloudPlacementStrategy PlacementStrategy_DefaultValue { get; set; }
		 

		/// <summary>
		/// Rotation options for the words in the wordcloud.
		/// </summary>
		public PieSeriesWordcloudRotation Rotation { get; set; }
		private PieSeriesWordcloudRotation Rotation_DefaultValue { get; set; }
		 

		/// <summary>
		/// 
		/// </summary>
		public PieSeriesWordcloudShowInLegend ShowInLegend { get; set; }
		private PieSeriesWordcloudShowInLegend ShowInLegend_DefaultValue { get; set; }
		...
		/// </summary>
		public PieSeriesWordcloudSpiral Spiral { get; set; }
		private PieSeriesWordcloudSpiral Spiral_DefaultValue { get; set; }
		...
		/// 
		/// </summary>
		public PieSeriesWordcloudTooltip Tooltip { get; set; }
		private PieSeriesWordcloudTooltip Tooltip_DefaultValue { get; set; }
