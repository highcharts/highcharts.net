...
{
	public partial class PieSeriesWordcloudLabel  : BaseObject
	{
		public PieSeriesWordcloudLabel()
		{
		...
		/// </summary>
		public PieSeriesWordcloudLabelEnabled Enabled { get; set; }
		private PieSeriesWordcloudLabelEnabled Enabled_DefaultValue { get; set; }
		 

		/// <summary>
		/// Allow labels to be placed distant to the graph if necessary,and draw a connector line to the graph.
		/// </summary>
		public PieSeriesWordcloudLabelConnectorAllowed ConnectorAllowed { get; set; }
		private PieSeriesWordcloudLabelConnectorAllowed ConnectorAllowed_DefaultValue { get; set; }
		 

		/// <summary>
		/// If the label is closer than this to a neighbour graph, draw aconnector.
		/// </summary>
		public PieSeriesWordcloudLabelConnectorNeighbourDistance ConnectorNeighbourDistance { get; set; }
		private PieSeriesWordcloudLabelConnectorNeighbourDistance ConnectorNeighbourDistance_DefaultValue { get; set; }
		...
		/// </summary>
		public PieSeriesWordcloudLabelStyle Style { get; set; }
		private PieSeriesWordcloudLabelStyle Style_DefaultValue { get; set; }
