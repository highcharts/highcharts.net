...
{
	public partial class PlotOptionsAreasplineLabel  : BaseObject
	{
		public PlotOptionsAreasplineLabel()
		{
			...
			Style = Style_DefaultValue = new PlotOptionsAreasplineLabelStyle();
		...
		/// </summary>
		public PlotOptionsAreasplineLabelEnabled Enabled { get; set; }
		private PlotOptionsAreasplineLabelEnabled Enabled_DefaultValue { get; set; }
		 

		/// <summary>
		/// Allow labels to be placed distant to the graph if necessary,and draw a connector line to the graph.
		/// </summary>
		public PlotOptionsAreasplineLabelConnectorAllowed ConnectorAllowed { get; set; }
		private PlotOptionsAreasplineLabelConnectorAllowed ConnectorAllowed_DefaultValue { get; set; }
		 

		/// <summary>
		/// If the label is closer than this to a neighbour graph, draw aconnector.
		/// </summary>
		public PlotOptionsAreasplineLabelConnectorNeighbourDistance ConnectorNeighbourDistance { get; set; }
		private PlotOptionsAreasplineLabelConnectorNeighbourDistance ConnectorNeighbourDistance_DefaultValue { get; set; }
		...
		/// </summary>
		public PlotOptionsAreasplineLabelStyle Style { get; set; }
		private PlotOptionsAreasplineLabelStyle Style_DefaultValue { get; set; }
