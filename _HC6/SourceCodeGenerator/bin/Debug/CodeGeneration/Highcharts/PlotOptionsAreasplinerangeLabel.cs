...
{
	public partial class PlotOptionsAreasplinerangeLabel  : BaseObject
	{
		public PlotOptionsAreasplinerangeLabel()
		{
			...
			Style = Style_DefaultValue = new PlotOptionsAreasplinerangeLabelStyle();
		...
		/// </summary>
		public PlotOptionsAreasplinerangeLabelEnabled Enabled { get; set; }
		private PlotOptionsAreasplinerangeLabelEnabled Enabled_DefaultValue { get; set; }
		 

		/// <summary>
		/// Allow labels to be placed distant to the graph if necessary,and draw a connector line to the graph.
		/// </summary>
		public PlotOptionsAreasplinerangeLabelConnectorAllowed ConnectorAllowed { get; set; }
		private PlotOptionsAreasplinerangeLabelConnectorAllowed ConnectorAllowed_DefaultValue { get; set; }
		 

		/// <summary>
		/// If the label is closer than this to a neighbour graph, draw aconnector.
		/// </summary>
		public PlotOptionsAreasplinerangeLabelConnectorNeighbourDistance ConnectorNeighbourDistance { get; set; }
		private PlotOptionsAreasplinerangeLabelConnectorNeighbourDistance ConnectorNeighbourDistance_DefaultValue { get; set; }
		...
		/// </summary>
		public PlotOptionsAreasplinerangeLabelStyle Style { get; set; }
		private PlotOptionsAreasplinerangeLabelStyle Style_DefaultValue { get; set; }
