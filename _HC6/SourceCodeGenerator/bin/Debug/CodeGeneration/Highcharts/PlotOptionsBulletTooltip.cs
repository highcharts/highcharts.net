...
namespace Highsoft.Web.Mvc.Charts
{
	public partial class PlotOptionsBulletTooltip  : BaseObject
	{
		...
		internal override Hashtable ToHashtable()
		{
			...
			if (PointFormatter != PointFormatter_DefaultValue) { h.Add("pointFormatter",PointFormatter); Highcharts.AddFunction("PlotOptionsBulletTooltipPointFormatter.pointFormatter", PointFormatter); }  
