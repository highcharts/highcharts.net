...
namespace Highsoft.Web.Mvc.Charts
{
	public partial class PlotOptionsFunnelDataLabels  : BaseObject
	{
		...
		/// 
		/// </summary>
		public PlotOptionsFunnelDataLabelsConnectorWidth ConnectorWidth { get; set; }
		private PlotOptionsFunnelDataLabelsConnectorWidth ConnectorWidth_DefaultValue { get; set; }
