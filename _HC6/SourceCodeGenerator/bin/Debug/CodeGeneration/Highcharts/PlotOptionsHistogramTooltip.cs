...
namespace Highsoft.Web.Mvc.Charts
{
	public partial class PlotOptionsHistogramTooltip  : BaseObject
	{
		...
		internal override Hashtable ToHashtable()
		{
			...
			if (PointFormatter != PointFormatter_DefaultValue) { h.Add("pointFormatter",PointFormatter); Highcharts.AddFunction("PlotOptionsHistogramTooltipPointFormatter.pointFormatter", PointFormatter); }  
