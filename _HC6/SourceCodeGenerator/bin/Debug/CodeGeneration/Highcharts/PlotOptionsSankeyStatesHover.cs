...
{
	public partial class PlotOptionsSankeyStatesHover  : BaseObject
	{
		public PlotOptionsSankeyStatesHover()
		{
			Animation = Animation_DefaultValue = new Animation() { Enabled = true };
			LineWidthPlus = LineWidthPlus_DefaultValue = 1;
			Marker = Marker_DefaultValue = new PlotOptionsSankeyStatesHoverMarker();
			Halo = Halo_DefaultValue = new PlotOptionsSankeyStatesHoverHalo();
		...
		/// </summary>
		public PlotOptionsSankeyStatesHoverMarker Marker { get; set; }
		private PlotOptionsSankeyStatesHoverMarker Marker_DefaultValue { get; set; }
		...
		/// </summary>
		public PlotOptionsSankeyStatesHoverHalo Halo { get; set; }
		private PlotOptionsSankeyStatesHoverHalo Halo_DefaultValue { get; set; }
