...
namespace Highsoft.Web.Mvc.Charts
{
	public partial class PlotOptionsScatterTooltip  : BaseObject
	{
		...
		/// 
		/// </summary>
		public PlotOptionsScatterTooltipHeaderFormat HeaderFormat { get; set; }
		private PlotOptionsScatterTooltipHeaderFormat HeaderFormat_DefaultValue { get; set; }
		 

		/// <summary>
		/// 
		/// </summary>
		public PlotOptionsScatterTooltipPointFormat PointFormat { get; set; }
		private PlotOptionsScatterTooltipPointFormat PointFormat_DefaultValue { get; set; }
