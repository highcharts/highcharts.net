...
{
	public partial class PlotOptionsSeriesLabel  : BaseObject
	{
		public PlotOptionsSeriesLabel()
		{
			...
			Style = Style_DefaultValue = new PlotOptionsSeriesLabelStyle();
		...
		/// </summary>
		public PlotOptionsSeriesLabelEnabled Enabled { get; set; }
		private PlotOptionsSeriesLabelEnabled Enabled_DefaultValue { get; set; }
		 

		/// <summary>
		/// Allow labels to be placed distant to the graph if necessary,and draw a connector line to the graph.
		/// </summary>
		public PlotOptionsSeriesLabelConnectorAllowed ConnectorAllowed { get; set; }
		private PlotOptionsSeriesLabelConnectorAllowed ConnectorAllowed_DefaultValue { get; set; }
		 

		/// <summary>
		/// If the label is closer than this to a neighbour graph, draw aconnector.
		/// </summary>
		public PlotOptionsSeriesLabelConnectorNeighbourDistance ConnectorNeighbourDistance { get; set; }
		private PlotOptionsSeriesLabelConnectorNeighbourDistance ConnectorNeighbourDistance_DefaultValue { get; set; }
		...
		/// </summary>
		public PlotOptionsSeriesLabelStyle Style { get; set; }
		private PlotOptionsSeriesLabelStyle Style_DefaultValue { get; set; }
