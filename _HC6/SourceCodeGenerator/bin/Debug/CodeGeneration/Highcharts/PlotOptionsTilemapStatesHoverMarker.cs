...
{
	public partial class PlotOptionsTilemapStatesHoverMarker  : BaseObject
	{
		public PlotOptionsTilemapStatesHoverMarker()
		{
			LineWidth = LineWidth_DefaultValue = 0;
			LineColor = LineColor_DefaultValue = "#ffffff";
			Radius = Radius_DefaultValue = 4;
			States = States_DefaultValue = new PlotOptionsTilemapStatesHoverMarkerStates();
		...
		/// </summary>
		public PlotOptionsTilemapStatesHoverMarkerStates States { get; set; }
		private PlotOptionsTilemapStatesHoverMarkerStates States_DefaultValue { get; set; }
