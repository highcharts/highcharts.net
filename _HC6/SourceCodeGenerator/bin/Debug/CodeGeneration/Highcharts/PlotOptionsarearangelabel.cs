...
{
	public partial class PlotOptionsArearangeLabel  : BaseObject
	{
		public PlotOptionsArearangeLabel()
		{
			...
			Style = Style_DefaultValue = new PlotOptionsArearangeLabelStyle();
		...
		/// </summary>
		public PlotOptionsArearangeLabelEnabled Enabled { get; set; }
		private PlotOptionsArearangeLabelEnabled Enabled_DefaultValue { get; set; }
		 

		/// <summary>
		/// Allow labels to be placed distant to the graph if necessary,and draw a connector line to the graph.
		/// </summary>
		public PlotOptionsArearangeLabelConnectorAllowed ConnectorAllowed { get; set; }
		private PlotOptionsArearangeLabelConnectorAllowed ConnectorAllowed_DefaultValue { get; set; }
		 

		/// <summary>
		/// If the label is closer than this to a neighbour graph, draw aconnector.
		/// </summary>
		public PlotOptionsArearangeLabelConnectorNeighbourDistance ConnectorNeighbourDistance { get; set; }
		private PlotOptionsArearangeLabelConnectorNeighbourDistance ConnectorNeighbourDistance_DefaultValue { get; set; }
		...
		/// </summary>
		public PlotOptionsArearangeLabelStyle Style { get; set; }
		private PlotOptionsArearangeLabelStyle Style_DefaultValue { get; set; }
