...
{
	public partial class PlotOptionsBellcurveLabel  : BaseObject
	{
		public PlotOptionsBellcurveLabel()
		{
			...
			Style = Style_DefaultValue = new PlotOptionsBellcurveLabelStyle();
		...
		/// </summary>
		public PlotOptionsBellcurveLabelEnabled Enabled { get; set; }
		private PlotOptionsBellcurveLabelEnabled Enabled_DefaultValue { get; set; }
		 

		/// <summary>
		/// Allow labels to be placed distant to the graph if necessary,and draw a connector line to the graph.
		/// </summary>
		public PlotOptionsBellcurveLabelConnectorAllowed ConnectorAllowed { get; set; }
		private PlotOptionsBellcurveLabelConnectorAllowed ConnectorAllowed_DefaultValue { get; set; }
		 

		/// <summary>
		/// If the label is closer than this to a neighbour graph, draw aconnector.
		/// </summary>
		public PlotOptionsBellcurveLabelConnectorNeighbourDistance ConnectorNeighbourDistance { get; set; }
		private PlotOptionsBellcurveLabelConnectorNeighbourDistance ConnectorNeighbourDistance_DefaultValue { get; set; }
		...
		/// </summary>
		public PlotOptionsBellcurveLabelStyle Style { get; set; }
		private PlotOptionsBellcurveLabelStyle Style_DefaultValue { get; set; }
