...
{
	public partial class PlotOptionsBoxplotLabel  : BaseObject
	{
		public PlotOptionsBoxplotLabel()
		{
			...
			Style = Style_DefaultValue = new PlotOptionsBoxplotLabelStyle();
		...
		/// </summary>
		public PlotOptionsBoxplotLabelEnabled Enabled { get; set; }
		private PlotOptionsBoxplotLabelEnabled Enabled_DefaultValue { get; set; }
		 

		/// <summary>
		/// Allow labels to be placed distant to the graph if necessary,and draw a connector line to the graph.
		/// </summary>
		public PlotOptionsBoxplotLabelConnectorAllowed ConnectorAllowed { get; set; }
		private PlotOptionsBoxplotLabelConnectorAllowed ConnectorAllowed_DefaultValue { get; set; }
		 

		/// <summary>
		/// If the label is closer than this to a neighbour graph, draw aconnector.
		/// </summary>
		public PlotOptionsBoxplotLabelConnectorNeighbourDistance ConnectorNeighbourDistance { get; set; }
		private PlotOptionsBoxplotLabelConnectorNeighbourDistance ConnectorNeighbourDistance_DefaultValue { get; set; }
		...
		/// </summary>
		public PlotOptionsBoxplotLabelStyle Style { get; set; }
		private PlotOptionsBoxplotLabelStyle Style_DefaultValue { get; set; }
