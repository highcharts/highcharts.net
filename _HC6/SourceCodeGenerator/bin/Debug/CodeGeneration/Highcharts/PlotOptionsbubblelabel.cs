...
{
	public partial class PlotOptionsBubbleLabel  : BaseObject
	{
		public PlotOptionsBubbleLabel()
		{
			...
			Style = Style_DefaultValue = new PlotOptionsBubbleLabelStyle();
		...
		/// </summary>
		public PlotOptionsBubbleLabelEnabled Enabled { get; set; }
		private PlotOptionsBubbleLabelEnabled Enabled_DefaultValue { get; set; }
		 

		/// <summary>
		/// Allow labels to be placed distant to the graph if necessary,and draw a connector line to the graph.
		/// </summary>
		public PlotOptionsBubbleLabelConnectorAllowed ConnectorAllowed { get; set; }
		private PlotOptionsBubbleLabelConnectorAllowed ConnectorAllowed_DefaultValue { get; set; }
		 

		/// <summary>
		/// If the label is closer than this to a neighbour graph, draw aconnector.
		/// </summary>
		public PlotOptionsBubbleLabelConnectorNeighbourDistance ConnectorNeighbourDistance { get; set; }
		private PlotOptionsBubbleLabelConnectorNeighbourDistance ConnectorNeighbourDistance_DefaultValue { get; set; }
		...
		/// </summary>
		public PlotOptionsBubbleLabelStyle Style { get; set; }
		private PlotOptionsBubbleLabelStyle Style_DefaultValue { get; set; }
