...
{
	public partial class PlotOptionsColumnLabel  : BaseObject
	{
		public PlotOptionsColumnLabel()
		{
			...
			Style = Style_DefaultValue = new PlotOptionsColumnLabelStyle();
		...
		/// </summary>
		public PlotOptionsColumnLabelEnabled Enabled { get; set; }
		private PlotOptionsColumnLabelEnabled Enabled_DefaultValue { get; set; }
		 

		/// <summary>
		/// Allow labels to be placed distant to the graph if necessary,and draw a connector line to the graph.
		/// </summary>
		public PlotOptionsColumnLabelConnectorAllowed ConnectorAllowed { get; set; }
		private PlotOptionsColumnLabelConnectorAllowed ConnectorAllowed_DefaultValue { get; set; }
		 

		/// <summary>
		/// If the label is closer than this to a neighbour graph, draw aconnector.
		/// </summary>
		public PlotOptionsColumnLabelConnectorNeighbourDistance ConnectorNeighbourDistance { get; set; }
		private PlotOptionsColumnLabelConnectorNeighbourDistance ConnectorNeighbourDistance_DefaultValue { get; set; }
		...
		/// </summary>
		public PlotOptionsColumnLabelStyle Style { get; set; }
		private PlotOptionsColumnLabelStyle Style_DefaultValue { get; set; }
