...
{
	public partial class PlotOptionsColumnrangeLabel  : BaseObject
	{
		public PlotOptionsColumnrangeLabel()
		{
			...
			Style = Style_DefaultValue = new PlotOptionsColumnrangeLabelStyle();
		...
		/// </summary>
		public PlotOptionsColumnrangeLabelEnabled Enabled { get; set; }
		private PlotOptionsColumnrangeLabelEnabled Enabled_DefaultValue { get; set; }
		 

		/// <summary>
		/// Allow labels to be placed distant to the graph if necessary,and draw a connector line to the graph.
		/// </summary>
		public PlotOptionsColumnrangeLabelConnectorAllowed ConnectorAllowed { get; set; }
		private PlotOptionsColumnrangeLabelConnectorAllowed ConnectorAllowed_DefaultValue { get; set; }
		 

		/// <summary>
		/// If the label is closer than this to a neighbour graph, draw aconnector.
		/// </summary>
		public PlotOptionsColumnrangeLabelConnectorNeighbourDistance ConnectorNeighbourDistance { get; set; }
		private PlotOptionsColumnrangeLabelConnectorNeighbourDistance ConnectorNeighbourDistance_DefaultValue { get; set; }
		...
		/// </summary>
		public PlotOptionsColumnrangeLabelStyle Style { get; set; }
		private PlotOptionsColumnrangeLabelStyle Style_DefaultValue { get; set; }
