...
{
	public partial class PlotOptionsFunnelLabel  : BaseObject
	{
		public PlotOptionsFunnelLabel()
		{
			...
			Style = Style_DefaultValue = new PlotOptionsFunnelLabelStyle();
		...
		/// </summary>
		public PlotOptionsFunnelLabelEnabled Enabled { get; set; }
		private PlotOptionsFunnelLabelEnabled Enabled_DefaultValue { get; set; }
		 

		/// <summary>
		/// Allow labels to be placed distant to the graph if necessary,and draw a connector line to the graph.
		/// </summary>
		public PlotOptionsFunnelLabelConnectorAllowed ConnectorAllowed { get; set; }
		private PlotOptionsFunnelLabelConnectorAllowed ConnectorAllowed_DefaultValue { get; set; }
		 

		/// <summary>
		/// If the label is closer than this to a neighbour graph, draw aconnector.
		/// </summary>
		public PlotOptionsFunnelLabelConnectorNeighbourDistance ConnectorNeighbourDistance { get; set; }
		private PlotOptionsFunnelLabelConnectorNeighbourDistance ConnectorNeighbourDistance_DefaultValue { get; set; }
		...
		/// </summary>
		public PlotOptionsFunnelLabelStyle Style { get; set; }
		private PlotOptionsFunnelLabelStyle Style_DefaultValue { get; set; }
