...
namespace Highsoft.Web.Mvc.Charts
{
	public partial class PlotOptionsGaugeLabel  : BaseObject
	{
		public PlotOptionsGaugeLabel()
		{
			...
			Style = Style_DefaultValue = new PlotOptionsGaugeLabelStyle();
		...
		/// </summary>
		public PlotOptionsGaugeLabelEnabled Enabled { get; set; }
		private PlotOptionsGaugeLabelEnabled Enabled_DefaultValue { get; set; }
		 

		/// <summary>
		/// Allow labels to be placed distant to the graph if necessary,and draw a connector line to the graph.
		/// </summary>
		public PlotOptionsGaugeLabelConnectorAllowed ConnectorAllowed { get; set; }
		private PlotOptionsGaugeLabelConnectorAllowed ConnectorAllowed_DefaultValue { get; set; }
		 

		/// <summary>
		/// If the label is closer than this to a neighbour graph, draw aconnector.
		/// </summary>
		public PlotOptionsGaugeLabelConnectorNeighbourDistance ConnectorNeighbourDistance { get; set; }
		private PlotOptionsGaugeLabelConnectorNeighbourDistance ConnectorNeighbourDistance_DefaultValue { get; set; }
		...
		/// </summary>
		public PlotOptionsGaugeLabelStyle Style { get; set; }
		private PlotOptionsGaugeLabelStyle Style_DefaultValue { get; set; }
