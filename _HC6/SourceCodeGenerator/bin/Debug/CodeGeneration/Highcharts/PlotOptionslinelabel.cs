...
{
	public partial class PlotOptionsLineLabel  : BaseObject
	{
		public PlotOptionsLineLabel()
		{
			...
			Style = Style_DefaultValue = new PlotOptionsLineLabelStyle();
		...
		/// </summary>
		public PlotOptionsLineLabelEnabled Enabled { get; set; }
		private PlotOptionsLineLabelEnabled Enabled_DefaultValue { get; set; }
		 

		/// <summary>
		/// Allow labels to be placed distant to the graph if necessary,and draw a connector line to the graph.
		/// </summary>
		public PlotOptionsLineLabelConnectorAllowed ConnectorAllowed { get; set; }
		private PlotOptionsLineLabelConnectorAllowed ConnectorAllowed_DefaultValue { get; set; }
		 

		/// <summary>
		/// If the label is closer than this to a neighbour graph, draw aconnector.
		/// </summary>
		public PlotOptionsLineLabelConnectorNeighbourDistance ConnectorNeighbourDistance { get; set; }
		private PlotOptionsLineLabelConnectorNeighbourDistance ConnectorNeighbourDistance_DefaultValue { get; set; }
		...
		/// </summary>
		public PlotOptionsLineLabelStyle Style { get; set; }
		private PlotOptionsLineLabelStyle Style_DefaultValue { get; set; }
