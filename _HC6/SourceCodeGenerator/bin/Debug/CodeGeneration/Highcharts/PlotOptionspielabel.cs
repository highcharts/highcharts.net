...
{
	public partial class PlotOptionsPieLabel  : BaseObject
	{
		public PlotOptionsPieLabel()
		{
			...
			Style = Style_DefaultValue = new PlotOptionsPieLabelStyle();
		...
		/// </summary>
		public PlotOptionsPieLabelEnabled Enabled { get; set; }
		private PlotOptionsPieLabelEnabled Enabled_DefaultValue { get; set; }
		 

		/// <summary>
		/// Allow labels to be placed distant to the graph if necessary,and draw a connector line to the graph.
		/// </summary>
		public PlotOptionsPieLabelConnectorAllowed ConnectorAllowed { get; set; }
		private PlotOptionsPieLabelConnectorAllowed ConnectorAllowed_DefaultValue { get; set; }
		 

		/// <summary>
		/// If the label is closer than this to a neighbour graph, draw aconnector.
		/// </summary>
		public PlotOptionsPieLabelConnectorNeighbourDistance ConnectorNeighbourDistance { get; set; }
		private PlotOptionsPieLabelConnectorNeighbourDistance ConnectorNeighbourDistance_DefaultValue { get; set; }
		...
		/// </summary>
		public PlotOptionsPieLabelStyle Style { get; set; }
		private PlotOptionsPieLabelStyle Style_DefaultValue { get; set; }
