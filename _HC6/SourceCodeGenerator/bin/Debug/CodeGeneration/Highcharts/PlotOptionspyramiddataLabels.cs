...
namespace Highsoft.Web.Mvc.Charts
{
	public partial class PlotOptionsPyramidDataLabels  : BaseObject
	{
		public PlotOptionsPyramidDataLabels()
		{
			...
			Style = Style_DefaultValue = new PlotOptionsPyramidDataLabelsStyle();
		...
		/// </summary>
		public PlotOptionsPyramidDataLabelsStyle Style { get; set; }
		private PlotOptionsPyramidDataLabelsStyle Style_DefaultValue { get; set; }
		...
		internal override Hashtable ToHashtable()
		{
			...
			if (Formatter != Formatter_DefaultValue) { h.Add("formatter",Formatter); Highcharts.AddFunction("PlotOptionsPyramidDataLabelsFormatter.formatter", Formatter); }  
