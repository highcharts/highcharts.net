...
{
	public partial class PlotOptionsPyramidLabel  : BaseObject
	{
		public PlotOptionsPyramidLabel()
		{
			...
			Style = Style_DefaultValue = new PlotOptionsPyramidLabelStyle();
		...
		/// </summary>
		public PlotOptionsPyramidLabelEnabled Enabled { get; set; }
		private PlotOptionsPyramidLabelEnabled Enabled_DefaultValue { get; set; }
		 

		/// <summary>
		/// Allow labels to be placed distant to the graph if necessary,and draw a connector line to the graph.
		/// </summary>
		public PlotOptionsPyramidLabelConnectorAllowed ConnectorAllowed { get; set; }
		private PlotOptionsPyramidLabelConnectorAllowed ConnectorAllowed_DefaultValue { get; set; }
		 

		/// <summary>
		/// If the label is closer than this to a neighbour graph, draw aconnector.
		/// </summary>
		public PlotOptionsPyramidLabelConnectorNeighbourDistance ConnectorNeighbourDistance { get; set; }
		private PlotOptionsPyramidLabelConnectorNeighbourDistance ConnectorNeighbourDistance_DefaultValue { get; set; }
		...
		/// </summary>
		public PlotOptionsPyramidLabelStyle Style { get; set; }
		private PlotOptionsPyramidLabelStyle Style_DefaultValue { get; set; }
