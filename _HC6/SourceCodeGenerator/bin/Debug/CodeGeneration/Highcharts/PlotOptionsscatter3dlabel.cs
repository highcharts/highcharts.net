...
{
	public partial class PlotOptionsScatter3dLabel  : BaseObject
	{
		public PlotOptionsScatter3dLabel()
		{
		...
		/// </summary>
		public PlotOptionsScatter3dLabelEnabled Enabled { get; set; }
		private PlotOptionsScatter3dLabelEnabled Enabled_DefaultValue { get; set; }
		 

		/// <summary>
		/// Allow labels to be placed distant to the graph if necessary,and draw a connector line to the graph.
		/// </summary>
		public PlotOptionsScatter3dLabelConnectorAllowed ConnectorAllowed { get; set; }
		private PlotOptionsScatter3dLabelConnectorAllowed ConnectorAllowed_DefaultValue { get; set; }
		 

		/// <summary>
		/// If the label is closer than this to a neighbour graph, draw aconnector.
		/// </summary>
		public PlotOptionsScatter3dLabelConnectorNeighbourDistance ConnectorNeighbourDistance { get; set; }
		private PlotOptionsScatter3dLabelConnectorNeighbourDistance ConnectorNeighbourDistance_DefaultValue { get; set; }
