...
namespace Highsoft.Web.Mvc.Charts
{
	public partial class PlotOptionsSolidgaugeDataLabels  : BaseObject
	{
		...
		/// 
		/// </summary>
		public PlotOptionsSolidgaugeDataLabelsDefer Defer { get; set; }
		private PlotOptionsSolidgaugeDataLabelsDefer Defer_DefaultValue { get; set; }
		...
		/// 
		/// </summary>
		public PlotOptionsSolidgaugeDataLabelsCrop Crop { get; set; }
		private PlotOptionsSolidgaugeDataLabelsCrop Crop_DefaultValue { get; set; }
