...
{
	public partial class PlotOptionsStreamgraphLabel  : BaseObject
	{
		public PlotOptionsStreamgraphLabel()
		{
			...
			Style = Style_DefaultValue = new PlotOptionsStreamgraphLabelStyle();
		...
		/// </summary>
		public PlotOptionsStreamgraphLabelEnabled Enabled { get; set; }
		private PlotOptionsStreamgraphLabelEnabled Enabled_DefaultValue { get; set; }
		 

		/// <summary>
		/// Allow labels to be placed distant to the graph if necessary,and draw a connector line to the graph.
		/// </summary>
		public PlotOptionsStreamgraphLabelConnectorAllowed ConnectorAllowed { get; set; }
		private PlotOptionsStreamgraphLabelConnectorAllowed ConnectorAllowed_DefaultValue { get; set; }
		 

		/// <summary>
		/// If the label is closer than this to a neighbour graph, draw aconnector.
		/// </summary>
		public PlotOptionsStreamgraphLabelConnectorNeighbourDistance ConnectorNeighbourDistance { get; set; }
		private PlotOptionsStreamgraphLabelConnectorNeighbourDistance ConnectorNeighbourDistance_DefaultValue { get; set; }
		...
		/// </summary>
		public PlotOptionsStreamgraphLabelStyle Style { get; set; }
		private PlotOptionsStreamgraphLabelStyle Style_DefaultValue { get; set; }
