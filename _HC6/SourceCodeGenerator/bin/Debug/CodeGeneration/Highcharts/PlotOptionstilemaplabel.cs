...
{
	public partial class PlotOptionsTilemapLabel  : BaseObject
	{
		public PlotOptionsTilemapLabel()
		{
			...
			Style = Style_DefaultValue = new PlotOptionsTilemapLabelStyle();
		...
		/// </summary>
		public PlotOptionsTilemapLabelEnabled Enabled { get; set; }
		private PlotOptionsTilemapLabelEnabled Enabled_DefaultValue { get; set; }
		 

		/// <summary>
		/// Allow labels to be placed distant to the graph if necessary,and draw a connector line to the graph.
		/// </summary>
		public PlotOptionsTilemapLabelConnectorAllowed ConnectorAllowed { get; set; }
		private PlotOptionsTilemapLabelConnectorAllowed ConnectorAllowed_DefaultValue { get; set; }
		 

		/// <summary>
		/// If the label is closer than this to a neighbour graph, draw aconnector.
		/// </summary>
		public PlotOptionsTilemapLabelConnectorNeighbourDistance ConnectorNeighbourDistance { get; set; }
		private PlotOptionsTilemapLabelConnectorNeighbourDistance ConnectorNeighbourDistance_DefaultValue { get; set; }
		...
		/// </summary>
		public PlotOptionsTilemapLabelStyle Style { get; set; }
		private PlotOptionsTilemapLabelStyle Style_DefaultValue { get; set; }
