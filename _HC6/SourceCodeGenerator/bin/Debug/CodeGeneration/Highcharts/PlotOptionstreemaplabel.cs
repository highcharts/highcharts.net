...
{
	public partial class PlotOptionsTreemapLabel  : BaseObject
	{
		public PlotOptionsTreemapLabel()
		{
			...
			Style = Style_DefaultValue = new PlotOptionsTreemapLabelStyle();
		...
		/// </summary>
		public PlotOptionsTreemapLabelEnabled Enabled { get; set; }
		private PlotOptionsTreemapLabelEnabled Enabled_DefaultValue { get; set; }
		 

		/// <summary>
		/// Allow labels to be placed distant to the graph if necessary,and draw a connector line to the graph.
		/// </summary>
		public PlotOptionsTreemapLabelConnectorAllowed ConnectorAllowed { get; set; }
		private PlotOptionsTreemapLabelConnectorAllowed ConnectorAllowed_DefaultValue { get; set; }
		 

		/// <summary>
		/// If the label is closer than this to a neighbour graph, draw aconnector.
		/// </summary>
		public PlotOptionsTreemapLabelConnectorNeighbourDistance ConnectorNeighbourDistance { get; set; }
		private PlotOptionsTreemapLabelConnectorNeighbourDistance ConnectorNeighbourDistance_DefaultValue { get; set; }
		...
		/// </summary>
		public PlotOptionsTreemapLabelStyle Style { get; set; }
		private PlotOptionsTreemapLabelStyle Style_DefaultValue { get; set; }
