...
{
	public partial class PlotOptionsVariablepieLabel  : BaseObject
	{
		public PlotOptionsVariablepieLabel()
		{
			...
			Style = Style_DefaultValue = new PlotOptionsVariablepieLabelStyle();
		...
		/// </summary>
		public PlotOptionsVariablepieLabelEnabled Enabled { get; set; }
		private PlotOptionsVariablepieLabelEnabled Enabled_DefaultValue { get; set; }
		 

		/// <summary>
		/// Allow labels to be placed distant to the graph if necessary,and draw a connector line to the graph.
		/// </summary>
		public PlotOptionsVariablepieLabelConnectorAllowed ConnectorAllowed { get; set; }
		private PlotOptionsVariablepieLabelConnectorAllowed ConnectorAllowed_DefaultValue { get; set; }
		 

		/// <summary>
		/// If the label is closer than this to a neighbour graph, draw aconnector.
		/// </summary>
		public PlotOptionsVariablepieLabelConnectorNeighbourDistance ConnectorNeighbourDistance { get; set; }
		private PlotOptionsVariablepieLabelConnectorNeighbourDistance ConnectorNeighbourDistance_DefaultValue { get; set; }
		...
		/// </summary>
		public PlotOptionsVariablepieLabelStyle Style { get; set; }
		private PlotOptionsVariablepieLabelStyle Style_DefaultValue { get; set; }
