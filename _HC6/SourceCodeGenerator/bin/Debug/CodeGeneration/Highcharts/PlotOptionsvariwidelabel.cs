...
{
	public partial class PlotOptionsVariwideLabel  : BaseObject
	{
		public PlotOptionsVariwideLabel()
		{
			...
			Style = Style_DefaultValue = new PlotOptionsVariwideLabelStyle();
		...
		/// </summary>
		public PlotOptionsVariwideLabelEnabled Enabled { get; set; }
		private PlotOptionsVariwideLabelEnabled Enabled_DefaultValue { get; set; }
		 

		/// <summary>
		/// Allow labels to be placed distant to the graph if necessary,and draw a connector line to the graph.
		/// </summary>
		public PlotOptionsVariwideLabelConnectorAllowed ConnectorAllowed { get; set; }
		private PlotOptionsVariwideLabelConnectorAllowed ConnectorAllowed_DefaultValue { get; set; }
		 

		/// <summary>
		/// If the label is closer than this to a neighbour graph, draw aconnector.
		/// </summary>
		public PlotOptionsVariwideLabelConnectorNeighbourDistance ConnectorNeighbourDistance { get; set; }
		private PlotOptionsVariwideLabelConnectorNeighbourDistance ConnectorNeighbourDistance_DefaultValue { get; set; }
		...
		/// </summary>
		public PlotOptionsVariwideLabelStyle Style { get; set; }
		private PlotOptionsVariwideLabelStyle Style_DefaultValue { get; set; }
