...
namespace Highsoft.Web.Mvc.Charts
{
	public partial class PlotOptionsWaterfallLabel  : BaseObject
	{
		public PlotOptionsWaterfallLabel()
		{
			...
			Style = Style_DefaultValue = new PlotOptionsWaterfallLabelStyle();
		...
		/// </summary>
		public PlotOptionsWaterfallLabelEnabled Enabled { get; set; }
		private PlotOptionsWaterfallLabelEnabled Enabled_DefaultValue { get; set; }
		 

		/// <summary>
		/// Allow labels to be placed distant to the graph if necessary,and draw a connector line to the graph.
		/// </summary>
		public PlotOptionsWaterfallLabelConnectorAllowed ConnectorAllowed { get; set; }
		private PlotOptionsWaterfallLabelConnectorAllowed ConnectorAllowed_DefaultValue { get; set; }
		 

		/// <summary>
		/// If the label is closer than this to a neighbour graph, draw aconnector.
		/// </summary>
		public PlotOptionsWaterfallLabelConnectorNeighbourDistance ConnectorNeighbourDistance { get; set; }
		private PlotOptionsWaterfallLabelConnectorNeighbourDistance ConnectorNeighbourDistance_DefaultValue { get; set; }
		...
		/// </summary>
		public PlotOptionsWaterfallLabelStyle Style { get; set; }
		private PlotOptionsWaterfallLabelStyle Style_DefaultValue { get; set; }
