...
{
	public partial class PlotOptionsWindbarbLabel  : BaseObject
	{
		public PlotOptionsWindbarbLabel()
		{
		...
		/// </summary>
		public PlotOptionsWindbarbLabelEnabled Enabled { get; set; }
		private PlotOptionsWindbarbLabelEnabled Enabled_DefaultValue { get; set; }
		 

		/// <summary>
		/// Allow labels to be placed distant to the graph if necessary,and draw a connector line to the graph.
		/// </summary>
		public PlotOptionsWindbarbLabelConnectorAllowed ConnectorAllowed { get; set; }
		private PlotOptionsWindbarbLabelConnectorAllowed ConnectorAllowed_DefaultValue { get; set; }
		 

		/// <summary>
		/// If the label is closer than this to a neighbour graph, draw aconnector.
		/// </summary>
		public PlotOptionsWindbarbLabelConnectorNeighbourDistance ConnectorNeighbourDistance { get; set; }
		private PlotOptionsWindbarbLabelConnectorNeighbourDistance ConnectorNeighbourDistance_DefaultValue { get; set; }
		...
		/// </summary>
		public PlotOptionsWindbarbLabelStyle Style { get; set; }
		private PlotOptionsWindbarbLabelStyle Style_DefaultValue { get; set; }
