...
namespace Highsoft.Web.Mvc.Charts
{
	public partial class PlotOptionsWordcloudLabel  : BaseObject
	{
		public PlotOptionsWordcloudLabel()
		{
			...
			Style = Style_DefaultValue = new PlotOptionsWordcloudLabelStyle();
		...
		/// </summary>
		public PlotOptionsWordcloudLabelEnabled Enabled { get; set; }
		private PlotOptionsWordcloudLabelEnabled Enabled_DefaultValue { get; set; }
		 

		/// <summary>
		/// Allow labels to be placed distant to the graph if necessary,and draw a connector line to the graph.
		/// </summary>
		public PlotOptionsWordcloudLabelConnectorAllowed ConnectorAllowed { get; set; }
		private PlotOptionsWordcloudLabelConnectorAllowed ConnectorAllowed_DefaultValue { get; set; }
		 

		/// <summary>
		/// If the label is closer than this to a neighbour graph, draw aconnector.
		/// </summary>
		public PlotOptionsWordcloudLabelConnectorNeighbourDistance ConnectorNeighbourDistance { get; set; }
		private PlotOptionsWordcloudLabelConnectorNeighbourDistance ConnectorNeighbourDistance_DefaultValue { get; set; }
		...
		/// </summary>
		public PlotOptionsWordcloudLabelStyle Style { get; set; }
		private PlotOptionsWordcloudLabelStyle Style_DefaultValue { get; set; }
