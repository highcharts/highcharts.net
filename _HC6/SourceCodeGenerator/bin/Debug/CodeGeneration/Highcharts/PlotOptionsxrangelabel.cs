...
{
	public partial class PlotOptionsXrangeLabel  : BaseObject
	{
		public PlotOptionsXrangeLabel()
		{
			...
			Style = Style_DefaultValue = new PlotOptionsXrangeLabelStyle();
		...
		/// </summary>
		public PlotOptionsXrangeLabelEnabled Enabled { get; set; }
		private PlotOptionsXrangeLabelEnabled Enabled_DefaultValue { get; set; }
		 

		/// <summary>
		/// Allow labels to be placed distant to the graph if necessary,and draw a connector line to the graph.
		/// </summary>
		public PlotOptionsXrangeLabelConnectorAllowed ConnectorAllowed { get; set; }
		private PlotOptionsXrangeLabelConnectorAllowed ConnectorAllowed_DefaultValue { get; set; }
		 

		/// <summary>
		/// If the label is closer than this to a neighbour graph, draw aconnector.
		/// </summary>
		public PlotOptionsXrangeLabelConnectorNeighbourDistance ConnectorNeighbourDistance { get; set; }
		private PlotOptionsXrangeLabelConnectorNeighbourDistance ConnectorNeighbourDistance_DefaultValue { get; set; }
		...
		/// </summary>
		public PlotOptionsXrangeLabelStyle Style { get; set; }
		private PlotOptionsXrangeLabelStyle Style_DefaultValue { get; set; }
