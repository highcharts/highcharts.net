...
namespace Highsoft.Web.Mvc.Charts
{
	public partial class PolygonSeries  : Series
	{
		...
		/// </summary>
		public List<SeriesPolygonData> Data { get; set; }
		private List<SeriesPolygonData> Data_DefaultValue { get; set; }
		...
		/// </summary>
		public PolygonSeriesSunburst Sunburst { get; set; }
		private PolygonSeriesSunburst Sunburst_DefaultValue { get; set; }
		...
		/// </summary>
		public PolygonSeriesWordcloud Wordcloud { get; set; }
		private PolygonSeriesWordcloud Wordcloud_DefaultValue { get; set; }
		...
		/// 
		/// </summary>
		public PolygonSeriesStickyTracking StickyTracking { get; set; }
		private PolygonSeriesStickyTracking StickyTracking_DefaultValue { get; set; }
