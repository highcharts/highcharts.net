...
{
	public partial class PolygonSeriesSunburstData  : BaseObject
	{
		public PolygonSeriesSunburstData()
		{
		...
		/// </summary>
		public PolygonSeriesSunburstDataEvents Events { get; set; }
		private PolygonSeriesSunburstDataEvents Events_DefaultValue { get; set; }
