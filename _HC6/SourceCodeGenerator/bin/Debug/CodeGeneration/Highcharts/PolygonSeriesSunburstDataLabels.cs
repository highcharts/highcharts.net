...
{
	public partial class PolygonSeriesSunburstDataLabels  : BaseObject
	{
		public PolygonSeriesSunburstDataLabels()
		{
		...
		/// 
		/// </summary>
		public PolygonSeriesSunburstDataLabelsDefer Defer { get; set; }
		private PolygonSeriesSunburstDataLabelsDefer Defer_DefaultValue { get; set; }
		 

		/// <summary>
		/// 
		/// </summary>
		public PolygonSeriesSunburstDataLabelsStyle Style { get; set; }
		private PolygonSeriesSunburstDataLabelsStyle Style_DefaultValue { get; set; }
		...
		/// </summary>
		public PolygonSeriesSunburstDataLabelsRotationMode RotationMode { get; set; }
		private PolygonSeriesSunburstDataLabelsRotationMode RotationMode_DefaultValue { get; set; }
