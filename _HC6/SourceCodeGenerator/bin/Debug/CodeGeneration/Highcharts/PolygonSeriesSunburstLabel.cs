...
{
	public partial class PolygonSeriesSunburstLabel  : BaseObject
	{
		public PolygonSeriesSunburstLabel()
		{
		...
		/// </summary>
		public PolygonSeriesSunburstLabelEnabled Enabled { get; set; }
		private PolygonSeriesSunburstLabelEnabled Enabled_DefaultValue { get; set; }
		 

		/// <summary>
		/// Allow labels to be placed distant to the graph if necessary,and draw a connector line to the graph.
		/// </summary>
		public PolygonSeriesSunburstLabelConnectorAllowed ConnectorAllowed { get; set; }
		private PolygonSeriesSunburstLabelConnectorAllowed ConnectorAllowed_DefaultValue { get; set; }
		 

		/// <summary>
		/// If the label is closer than this to a neighbour graph, draw aconnector.
		/// </summary>
		public PolygonSeriesSunburstLabelConnectorNeighbourDistance ConnectorNeighbourDistance { get; set; }
		private PolygonSeriesSunburstLabelConnectorNeighbourDistance ConnectorNeighbourDistance_DefaultValue { get; set; }
		...
		/// </summary>
		public PolygonSeriesSunburstLabelStyle Style { get; set; }
		private PolygonSeriesSunburstLabelStyle Style_DefaultValue { get; set; }
