...
{
	public partial class PolygonSeriesWordcloudLabel  : BaseObject
	{
		public PolygonSeriesWordcloudLabel()
		{
		...
		/// </summary>
		public PolygonSeriesWordcloudLabelEnabled Enabled { get; set; }
		private PolygonSeriesWordcloudLabelEnabled Enabled_DefaultValue { get; set; }
		 

		/// <summary>
		/// Allow labels to be placed distant to the graph if necessary,and draw a connector line to the graph.
		/// </summary>
		public PolygonSeriesWordcloudLabelConnectorAllowed ConnectorAllowed { get; set; }
		private PolygonSeriesWordcloudLabelConnectorAllowed ConnectorAllowed_DefaultValue { get; set; }
		 

		/// <summary>
		/// If the label is closer than this to a neighbour graph, draw aconnector.
		/// </summary>
		public PolygonSeriesWordcloudLabelConnectorNeighbourDistance ConnectorNeighbourDistance { get; set; }
		private PolygonSeriesWordcloudLabelConnectorNeighbourDistance ConnectorNeighbourDistance_DefaultValue { get; set; }
		...
		/// </summary>
		public PolygonSeriesWordcloudLabelStyle Style { get; set; }
		private PolygonSeriesWordcloudLabelStyle Style_DefaultValue { get; set; }
