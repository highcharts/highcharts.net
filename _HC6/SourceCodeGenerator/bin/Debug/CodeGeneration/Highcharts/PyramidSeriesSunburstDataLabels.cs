...
{
	public partial class PyramidSeriesSunburstDataLabels  : BaseObject
	{
		public PyramidSeriesSunburstDataLabels()
		{
		...
		/// 
		/// </summary>
		public PyramidSeriesSunburstDataLabelsDefer Defer { get; set; }
		private PyramidSeriesSunburstDataLabelsDefer Defer_DefaultValue { get; set; }
		 

		/// <summary>
		/// 
		/// </summary>
		public PyramidSeriesSunburstDataLabelsStyle Style { get; set; }
		private PyramidSeriesSunburstDataLabelsStyle Style_DefaultValue { get; set; }
		...
		/// </summary>
		public PyramidSeriesSunburstDataLabelsRotationMode RotationMode { get; set; }
		private PyramidSeriesSunburstDataLabelsRotationMode RotationMode_DefaultValue { get; set; }
