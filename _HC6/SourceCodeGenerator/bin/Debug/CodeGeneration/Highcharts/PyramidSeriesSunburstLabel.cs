...
{
	public partial class PyramidSeriesSunburstLabel  : BaseObject
	{
		public PyramidSeriesSunburstLabel()
		{
		...
		/// </summary>
		public PyramidSeriesSunburstLabelEnabled Enabled { get; set; }
		private PyramidSeriesSunburstLabelEnabled Enabled_DefaultValue { get; set; }
		 

		/// <summary>
		/// Allow labels to be placed distant to the graph if necessary,and draw a connector line to the graph.
		/// </summary>
		public PyramidSeriesSunburstLabelConnectorAllowed ConnectorAllowed { get; set; }
		private PyramidSeriesSunburstLabelConnectorAllowed ConnectorAllowed_DefaultValue { get; set; }
		 

		/// <summary>
		/// If the label is closer than this to a neighbour graph, draw aconnector.
		/// </summary>
		public PyramidSeriesSunburstLabelConnectorNeighbourDistance ConnectorNeighbourDistance { get; set; }
		private PyramidSeriesSunburstLabelConnectorNeighbourDistance ConnectorNeighbourDistance_DefaultValue { get; set; }
		...
		/// </summary>
		public PyramidSeriesSunburstLabelStyle Style { get; set; }
		private PyramidSeriesSunburstLabelStyle Style_DefaultValue { get; set; }
