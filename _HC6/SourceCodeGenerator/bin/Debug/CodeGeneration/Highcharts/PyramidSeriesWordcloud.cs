...
{
	public partial class PyramidSeriesWordcloud  : BaseObject
	{
		public PyramidSeriesWordcloud()
		{
			Data = Data_DefaultValue = new List<SeriesPyramidWordcloudData>();
		...
		/// </summary>
		public List<SeriesPyramidWordcloudData> Data { get; set; }
		private List<SeriesPyramidWordcloudData> Data_DefaultValue { get; set; }
		 

		/// <summary>
		/// Series labels are placed as close to the series as possible in anatural way, seeking to avoid other series. The goal of thisfeature is to make the chart more easily readable, like if ahuman designer placed the labels in the optimal position.The series labels currently work with series types having a`graph` or an `area`.Requires the `series-label.js` module.
		/// </summary>
		public PyramidSeriesWordcloudLabel Label { get; set; }
		private PyramidSeriesWordcloudLabel Label_DefaultValue { get; set; }
		...
		/// </summary>
		public PyramidSeriesWordcloudEvents Events { get; set; }
		private PyramidSeriesWordcloudEvents Events_DefaultValue { get; set; }
		 

		/// <summary>
		/// Properties for each single point.
		/// </summary>
		public PyramidSeriesWordcloudPoint Point { get; set; }
		private PyramidSeriesWordcloudPoint Point_DefaultValue { get; set; }
		...
		/// 
		/// </summary>
		public PyramidSeriesWordcloudStates States { get; set; }
		private PyramidSeriesWordcloudStates States_DefaultValue { get; set; }
		 

		/// <summary>
		/// 
		/// </summary>
		public PyramidSeriesWordcloudStickyTracking StickyTracking { get; set; }
		private PyramidSeriesWordcloudStickyTracking StickyTracking_DefaultValue { get; set; }
		...
		/// 
		/// </summary>
		public PyramidSeriesWordcloudBorderWidth BorderWidth { get; set; }
		private PyramidSeriesWordcloudBorderWidth BorderWidth_DefaultValue { get; set; }
		 

		/// <summary>
		/// 
		/// </summary>
		public PyramidSeriesWordcloudClip Clip { get; set; }
		private PyramidSeriesWordcloudClip Clip_DefaultValue { get; set; }
		...
		/// </summary>
		public PyramidSeriesWordcloudColorByPoint ColorByPoint { get; set; }
		private PyramidSeriesWordcloudColorByPoint ColorByPoint_DefaultValue { get; set; }
		...
		/// </summary>
		public PyramidSeriesWordcloudPlacementStrategy PlacementStrategy { get; set; }
		private PyramidSeriesWordcloudPlacementStrategy PlacementStrategy_DefaultValue { get; set; }
		 

		/// <summary>
		/// Rotation options for the words in the wordcloud.
		/// </summary>
		public PyramidSeriesWordcloudRotation Rotation { get; set; }
		private PyramidSeriesWordcloudRotation Rotation_DefaultValue { get; set; }
		 

		/// <summary>
		/// 
		/// </summary>
		public PyramidSeriesWordcloudShowInLegend ShowInLegend { get; set; }
		private PyramidSeriesWordcloudShowInLegend ShowInLegend_DefaultValue { get; set; }
		...
		/// </summary>
		public PyramidSeriesWordcloudSpiral Spiral { get; set; }
		private PyramidSeriesWordcloudSpiral Spiral_DefaultValue { get; set; }
		...
		/// 
		/// </summary>
		public PyramidSeriesWordcloudTooltip Tooltip { get; set; }
		private PyramidSeriesWordcloudTooltip Tooltip_DefaultValue { get; set; }
