...
{
	public partial class PyramidSeriesWordcloudLabel  : BaseObject
	{
		public PyramidSeriesWordcloudLabel()
		{
		...
		/// </summary>
		public PyramidSeriesWordcloudLabelEnabled Enabled { get; set; }
		private PyramidSeriesWordcloudLabelEnabled Enabled_DefaultValue { get; set; }
		 

		/// <summary>
		/// Allow labels to be placed distant to the graph if necessary,and draw a connector line to the graph.
		/// </summary>
		public PyramidSeriesWordcloudLabelConnectorAllowed ConnectorAllowed { get; set; }
		private PyramidSeriesWordcloudLabelConnectorAllowed ConnectorAllowed_DefaultValue { get; set; }
		 

		/// <summary>
		/// If the label is closer than this to a neighbour graph, draw aconnector.
		/// </summary>
		public PyramidSeriesWordcloudLabelConnectorNeighbourDistance ConnectorNeighbourDistance { get; set; }
		private PyramidSeriesWordcloudLabelConnectorNeighbourDistance ConnectorNeighbourDistance_DefaultValue { get; set; }
		...
		/// </summary>
		public PyramidSeriesWordcloudLabelStyle Style { get; set; }
		private PyramidSeriesWordcloudLabelStyle Style_DefaultValue { get; set; }
