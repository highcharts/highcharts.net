...
{
	public partial class SankeySeriesLabel  : BaseObject
	{
		public SankeySeriesLabel()
		{
			...
			Style = Style_DefaultValue = new SankeySeriesLabelStyle();
		...
		/// </summary>
		public SankeySeriesLabelEnabled Enabled { get; set; }
		private SankeySeriesLabelEnabled Enabled_DefaultValue { get; set; }
		 

		/// <summary>
		/// Allow labels to be placed distant to the graph if necessary,and draw a connector line to the graph.
		/// </summary>
		public SankeySeriesLabelConnectorAllowed ConnectorAllowed { get; set; }
		private SankeySeriesLabelConnectorAllowed ConnectorAllowed_DefaultValue { get; set; }
		 

		/// <summary>
		/// If the label is closer than this to a neighbour graph, draw aconnector.
		/// </summary>
		public SankeySeriesLabelConnectorNeighbourDistance ConnectorNeighbourDistance { get; set; }
		private SankeySeriesLabelConnectorNeighbourDistance ConnectorNeighbourDistance_DefaultValue { get; set; }
		...
		/// </summary>
		public SankeySeriesLabelStyle Style { get; set; }
		private SankeySeriesLabelStyle Style_DefaultValue { get; set; }
