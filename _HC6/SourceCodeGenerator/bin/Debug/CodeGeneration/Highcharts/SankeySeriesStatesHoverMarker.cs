...
{
	public partial class SankeySeriesStatesHoverMarker  : BaseObject
	{
		public SankeySeriesStatesHoverMarker()
		{
			LineWidth = LineWidth_DefaultValue = 0;
			LineColor = LineColor_DefaultValue = "#ffffff";
			Radius = Radius_DefaultValue = 4;
			States = States_DefaultValue = new SankeySeriesStatesHoverMarkerStates();
		...
		/// </summary>
		public SankeySeriesStatesHoverMarkerStates States { get; set; }
		private SankeySeriesStatesHoverMarkerStates States_DefaultValue { get; set; }
