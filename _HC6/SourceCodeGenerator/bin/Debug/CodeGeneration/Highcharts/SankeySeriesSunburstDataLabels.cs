...
{
	public partial class SankeySeriesSunburstDataLabels  : BaseObject
	{
		public SankeySeriesSunburstDataLabels()
		{
		...
		/// 
		/// </summary>
		public SankeySeriesSunburstDataLabelsDefer Defer { get; set; }
		private SankeySeriesSunburstDataLabelsDefer Defer_DefaultValue { get; set; }
		 

		/// <summary>
		/// 
		/// </summary>
		public SankeySeriesSunburstDataLabelsStyle Style { get; set; }
		private SankeySeriesSunburstDataLabelsStyle Style_DefaultValue { get; set; }
		...
		/// </summary>
		public SankeySeriesSunburstDataLabelsRotationMode RotationMode { get; set; }
		private SankeySeriesSunburstDataLabelsRotationMode RotationMode_DefaultValue { get; set; }
