...
{
	public partial class SankeySeriesSunburstLabel  : BaseObject
	{
		public SankeySeriesSunburstLabel()
		{
		...
		/// </summary>
		public SankeySeriesSunburstLabelEnabled Enabled { get; set; }
		private SankeySeriesSunburstLabelEnabled Enabled_DefaultValue { get; set; }
		 

		/// <summary>
		/// Allow labels to be placed distant to the graph if necessary,and draw a connector line to the graph.
		/// </summary>
		public SankeySeriesSunburstLabelConnectorAllowed ConnectorAllowed { get; set; }
		private SankeySeriesSunburstLabelConnectorAllowed ConnectorAllowed_DefaultValue { get; set; }
		 

		/// <summary>
		/// If the label is closer than this to a neighbour graph, draw aconnector.
		/// </summary>
		public SankeySeriesSunburstLabelConnectorNeighbourDistance ConnectorNeighbourDistance { get; set; }
		private SankeySeriesSunburstLabelConnectorNeighbourDistance ConnectorNeighbourDistance_DefaultValue { get; set; }
		...
		/// </summary>
		public SankeySeriesSunburstLabelStyle Style { get; set; }
		private SankeySeriesSunburstLabelStyle Style_DefaultValue { get; set; }
