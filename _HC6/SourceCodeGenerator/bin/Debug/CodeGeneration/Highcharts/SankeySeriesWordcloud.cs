...
{
	public partial class SankeySeriesWordcloud  : BaseObject
	{
		public SankeySeriesWordcloud()
		{
			Data = Data_DefaultValue = new List<SeriesSankeyWordcloudData>();
		...
		/// </summary>
		public List<SeriesSankeyWordcloudData> Data { get; set; }
		private List<SeriesSankeyWordcloudData> Data_DefaultValue { get; set; }
		 

		/// <summary>
		/// Series labels are placed as close to the series as possible in anatural way, seeking to avoid other series. The goal of thisfeature is to make the chart more easily readable, like if ahuman designer placed the labels in the optimal position.The series labels currently work with series types having a`graph` or an `area`.Requires the `series-label.js` module.
		/// </summary>
		public SankeySeriesWordcloudLabel Label { get; set; }
		private SankeySeriesWordcloudLabel Label_DefaultValue { get; set; }
		...
		/// </summary>
		public SankeySeriesWordcloudEvents Events { get; set; }
		private SankeySeriesWordcloudEvents Events_DefaultValue { get; set; }
		 

		/// <summary>
		/// Properties for each single point.
		/// </summary>
		public SankeySeriesWordcloudPoint Point { get; set; }
		private SankeySeriesWordcloudPoint Point_DefaultValue { get; set; }
		...
		/// 
		/// </summary>
		public SankeySeriesWordcloudStates States { get; set; }
		private SankeySeriesWordcloudStates States_DefaultValue { get; set; }
		 

		/// <summary>
		/// 
		/// </summary>
		public SankeySeriesWordcloudStickyTracking StickyTracking { get; set; }
		private SankeySeriesWordcloudStickyTracking StickyTracking_DefaultValue { get; set; }
		...
		/// 
		/// </summary>
		public SankeySeriesWordcloudBorderWidth BorderWidth { get; set; }
		private SankeySeriesWordcloudBorderWidth BorderWidth_DefaultValue { get; set; }
		 

		/// <summary>
		/// 
		/// </summary>
		public SankeySeriesWordcloudClip Clip { get; set; }
		private SankeySeriesWordcloudClip Clip_DefaultValue { get; set; }
		...
		/// </summary>
		public SankeySeriesWordcloudColorByPoint ColorByPoint { get; set; }
		private SankeySeriesWordcloudColorByPoint ColorByPoint_DefaultValue { get; set; }
		...
		/// </summary>
		public SankeySeriesWordcloudPlacementStrategy PlacementStrategy { get; set; }
		private SankeySeriesWordcloudPlacementStrategy PlacementStrategy_DefaultValue { get; set; }
		 

		/// <summary>
		/// Rotation options for the words in the wordcloud.
		/// </summary>
		public SankeySeriesWordcloudRotation Rotation { get; set; }
		private SankeySeriesWordcloudRotation Rotation_DefaultValue { get; set; }
		 

		/// <summary>
		/// 
		/// </summary>
		public SankeySeriesWordcloudShowInLegend ShowInLegend { get; set; }
		private SankeySeriesWordcloudShowInLegend ShowInLegend_DefaultValue { get; set; }
		...
		/// </summary>
		public SankeySeriesWordcloudSpiral Spiral { get; set; }
		private SankeySeriesWordcloudSpiral Spiral_DefaultValue { get; set; }
		...
		/// 
		/// </summary>
		public SankeySeriesWordcloudTooltip Tooltip { get; set; }
		private SankeySeriesWordcloudTooltip Tooltip_DefaultValue { get; set; }
