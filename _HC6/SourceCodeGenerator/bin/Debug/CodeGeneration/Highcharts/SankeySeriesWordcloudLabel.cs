...
{
	public partial class SankeySeriesWordcloudLabel  : BaseObject
	{
		public SankeySeriesWordcloudLabel()
		{
		...
		/// </summary>
		public SankeySeriesWordcloudLabelEnabled Enabled { get; set; }
		private SankeySeriesWordcloudLabelEnabled Enabled_DefaultValue { get; set; }
		 

		/// <summary>
		/// Allow labels to be placed distant to the graph if necessary,and draw a connector line to the graph.
		/// </summary>
		public SankeySeriesWordcloudLabelConnectorAllowed ConnectorAllowed { get; set; }
		private SankeySeriesWordcloudLabelConnectorAllowed ConnectorAllowed_DefaultValue { get; set; }
		 

		/// <summary>
		/// If the label is closer than this to a neighbour graph, draw aconnector.
		/// </summary>
		public SankeySeriesWordcloudLabelConnectorNeighbourDistance ConnectorNeighbourDistance { get; set; }
		private SankeySeriesWordcloudLabelConnectorNeighbourDistance ConnectorNeighbourDistance_DefaultValue { get; set; }
		...
		/// </summary>
		public SankeySeriesWordcloudLabelStyle Style { get; set; }
		private SankeySeriesWordcloudLabelStyle Style_DefaultValue { get; set; }
