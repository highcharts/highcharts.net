...
{
	public partial class Scatter3dSeriesStatesHover  : BaseObject
	{
		public Scatter3dSeriesStatesHover()
		{
			Animation = Animation_DefaultValue = new Animation() { Enabled = true };
			LineWidthPlus = LineWidthPlus_DefaultValue = 1;
			Marker = Marker_DefaultValue = new Scatter3dSeriesStatesHoverMarker();
			Halo = Halo_DefaultValue = new Scatter3dSeriesStatesHoverHalo();
		...
		/// </summary>
		public Scatter3dSeriesStatesHoverMarker Marker { get; set; }
		private Scatter3dSeriesStatesHoverMarker Marker_DefaultValue { get; set; }
		...
		/// </summary>
		public Scatter3dSeriesStatesHoverHalo Halo { get; set; }
		private Scatter3dSeriesStatesHoverHalo Halo_DefaultValue { get; set; }
