...
{
	public partial class Scatter3dSeriesSunburst  : BaseObject
	{
		public Scatter3dSeriesSunburst()
		{
			Data = Data_DefaultValue = new List<SeriesScatter3dSunburstData>();
		...
		/// 
		/// </summary>
		public List<SeriesScatter3dSunburstData> Data { get; set; }
		private List<SeriesScatter3dSunburstData> Data_DefaultValue { get; set; }
		 

		/// <summary>
		/// Series labels are placed as close to the series as possible in anatural way, seeking to avoid other series. The goal of thisfeature is to make the chart more easily readable, like if ahuman designer placed the labels in the optimal position.The series labels currently work with series types having a`graph` or an `area`.Requires the `series-label.js` module.
		/// </summary>
		public Scatter3dSeriesSunburstLabel Label { get; set; }
		private Scatter3dSeriesSunburstLabel Label_DefaultValue { get; set; }
		...
		/// </summary>
		public Scatter3dSeriesSunburstStickyTracking StickyTracking { get; set; }
		private Scatter3dSeriesSunburstStickyTracking StickyTracking_DefaultValue { get; set; }
		 

		/// <summary>
		/// 
		/// </summary>
		public Scatter3dSeriesSunburstTooltip Tooltip { get; set; }
		private Scatter3dSeriesSunburstTooltip Tooltip_DefaultValue { get; set; }
		...
		/// 
		/// </summary>
		public Scatter3dSeriesSunburstStates States { get; set; }
		private Scatter3dSeriesSunburstStates States_DefaultValue { get; set; }
		...
		/// 
		/// </summary>
		public Scatter3dSeriesSunburstEvents Events { get; set; }
		private Scatter3dSeriesSunburstEvents Events_DefaultValue { get; set; }
		 

		/// <summary>
		/// 
		/// </summary>
		public Scatter3dSeriesSunburstPoint Point { get; set; }
		private Scatter3dSeriesSunburstPoint Point_DefaultValue { get; set; }
		...
		/// 
		/// </summary>
		public Scatter3dSeriesSunburstDataLabels DataLabels { get; set; }
		private Scatter3dSeriesSunburstDataLabels DataLabels_DefaultValue { get; set; }
		...
		/// </summary>
		public Scatter3dSeriesSunburstLevelIsConstant LevelIsConstant { get; set; }
		private Scatter3dSeriesSunburstLevelIsConstant LevelIsConstant_DefaultValue { get; set; }
