...
{
	public partial class Scatter3dSeriesSunburstDataLabels  : BaseObject
	{
		public Scatter3dSeriesSunburstDataLabels()
		{
		...
		/// 
		/// </summary>
		public Scatter3dSeriesSunburstDataLabelsDefer Defer { get; set; }
		private Scatter3dSeriesSunburstDataLabelsDefer Defer_DefaultValue { get; set; }
		 

		/// <summary>
		/// 
		/// </summary>
		public Scatter3dSeriesSunburstDataLabelsStyle Style { get; set; }
		private Scatter3dSeriesSunburstDataLabelsStyle Style_DefaultValue { get; set; }
		...
		/// </summary>
		public Scatter3dSeriesSunburstDataLabelsRotationMode RotationMode { get; set; }
		private Scatter3dSeriesSunburstDataLabelsRotationMode RotationMode_DefaultValue { get; set; }
