...
{
	public partial class Scatter3dSeriesSunburstLabel  : BaseObject
	{
		public Scatter3dSeriesSunburstLabel()
		{
		...
		/// </summary>
		public Scatter3dSeriesSunburstLabelEnabled Enabled { get; set; }
		private Scatter3dSeriesSunburstLabelEnabled Enabled_DefaultValue { get; set; }
		 

		/// <summary>
		/// Allow labels to be placed distant to the graph if necessary,and draw a connector line to the graph.
		/// </summary>
		public Scatter3dSeriesSunburstLabelConnectorAllowed ConnectorAllowed { get; set; }
		private Scatter3dSeriesSunburstLabelConnectorAllowed ConnectorAllowed_DefaultValue { get; set; }
		 

		/// <summary>
		/// If the label is closer than this to a neighbour graph, draw aconnector.
		/// </summary>
		public Scatter3dSeriesSunburstLabelConnectorNeighbourDistance ConnectorNeighbourDistance { get; set; }
		private Scatter3dSeriesSunburstLabelConnectorNeighbourDistance ConnectorNeighbourDistance_DefaultValue { get; set; }
		...
		/// </summary>
		public Scatter3dSeriesSunburstLabelStyle Style { get; set; }
		private Scatter3dSeriesSunburstLabelStyle Style_DefaultValue { get; set; }
