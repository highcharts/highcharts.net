...
{
	public partial class Scatter3dSeriesWordcloud  : BaseObject
	{
		public Scatter3dSeriesWordcloud()
		{
			Data = Data_DefaultValue = new List<SeriesScatter3dWordcloudData>();
		...
		/// </summary>
		public List<SeriesScatter3dWordcloudData> Data { get; set; }
		private List<SeriesScatter3dWordcloudData> Data_DefaultValue { get; set; }
		 

		/// <summary>
		/// Series labels are placed as close to the series as possible in anatural way, seeking to avoid other series. The goal of thisfeature is to make the chart more easily readable, like if ahuman designer placed the labels in the optimal position.The series labels currently work with series types having a`graph` or an `area`.Requires the `series-label.js` module.
		/// </summary>
		public Scatter3dSeriesWordcloudLabel Label { get; set; }
		private Scatter3dSeriesWordcloudLabel Label_DefaultValue { get; set; }
		...
		/// </summary>
		public Scatter3dSeriesWordcloudEvents Events { get; set; }
		private Scatter3dSeriesWordcloudEvents Events_DefaultValue { get; set; }
		 

		/// <summary>
		/// Properties for each single point.
		/// </summary>
		public Scatter3dSeriesWordcloudPoint Point { get; set; }
		private Scatter3dSeriesWordcloudPoint Point_DefaultValue { get; set; }
		...
		/// 
		/// </summary>
		public Scatter3dSeriesWordcloudStates States { get; set; }
		private Scatter3dSeriesWordcloudStates States_DefaultValue { get; set; }
		 

		/// <summary>
		/// 
		/// </summary>
		public Scatter3dSeriesWordcloudStickyTracking StickyTracking { get; set; }
		private Scatter3dSeriesWordcloudStickyTracking StickyTracking_DefaultValue { get; set; }
		...
		/// 
		/// </summary>
		public Scatter3dSeriesWordcloudBorderWidth BorderWidth { get; set; }
		private Scatter3dSeriesWordcloudBorderWidth BorderWidth_DefaultValue { get; set; }
		 

		/// <summary>
		/// 
		/// </summary>
		public Scatter3dSeriesWordcloudClip Clip { get; set; }
		private Scatter3dSeriesWordcloudClip Clip_DefaultValue { get; set; }
		...
		/// </summary>
		public Scatter3dSeriesWordcloudColorByPoint ColorByPoint { get; set; }
		private Scatter3dSeriesWordcloudColorByPoint ColorByPoint_DefaultValue { get; set; }
		...
		/// </summary>
		public Scatter3dSeriesWordcloudPlacementStrategy PlacementStrategy { get; set; }
		private Scatter3dSeriesWordcloudPlacementStrategy PlacementStrategy_DefaultValue { get; set; }
		 

		/// <summary>
		/// Rotation options for the words in the wordcloud.
		/// </summary>
		public Scatter3dSeriesWordcloudRotation Rotation { get; set; }
		private Scatter3dSeriesWordcloudRotation Rotation_DefaultValue { get; set; }
		 

		/// <summary>
		/// 
		/// </summary>
		public Scatter3dSeriesWordcloudShowInLegend ShowInLegend { get; set; }
		private Scatter3dSeriesWordcloudShowInLegend ShowInLegend_DefaultValue { get; set; }
		...
		/// </summary>
		public Scatter3dSeriesWordcloudSpiral Spiral { get; set; }
		private Scatter3dSeriesWordcloudSpiral Spiral_DefaultValue { get; set; }
		...
		/// 
		/// </summary>
		public Scatter3dSeriesWordcloudTooltip Tooltip { get; set; }
		private Scatter3dSeriesWordcloudTooltip Tooltip_DefaultValue { get; set; }
