...
{
	public partial class Scatter3dSeriesWordcloudLabel  : BaseObject
	{
		public Scatter3dSeriesWordcloudLabel()
		{
		...
		/// </summary>
		public Scatter3dSeriesWordcloudLabelEnabled Enabled { get; set; }
		private Scatter3dSeriesWordcloudLabelEnabled Enabled_DefaultValue { get; set; }
		 

		/// <summary>
		/// Allow labels to be placed distant to the graph if necessary,and draw a connector line to the graph.
		/// </summary>
		public Scatter3dSeriesWordcloudLabelConnectorAllowed ConnectorAllowed { get; set; }
		private Scatter3dSeriesWordcloudLabelConnectorAllowed ConnectorAllowed_DefaultValue { get; set; }
		 

		/// <summary>
		/// If the label is closer than this to a neighbour graph, draw aconnector.
		/// </summary>
		public Scatter3dSeriesWordcloudLabelConnectorNeighbourDistance ConnectorNeighbourDistance { get; set; }
		private Scatter3dSeriesWordcloudLabelConnectorNeighbourDistance ConnectorNeighbourDistance_DefaultValue { get; set; }
		...
		/// </summary>
		public Scatter3dSeriesWordcloudLabelStyle Style { get; set; }
		private Scatter3dSeriesWordcloudLabelStyle Style_DefaultValue { get; set; }
