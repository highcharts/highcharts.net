...
{
	public partial class ScatterSeriesSunburst  : BaseObject
	{
		public ScatterSeriesSunburst()
		{
			Data = Data_DefaultValue = new List<SeriesScatterSunburstData>();
		...
		/// 
		/// </summary>
		public List<SeriesScatterSunburstData> Data { get; set; }
		private List<SeriesScatterSunburstData> Data_DefaultValue { get; set; }
		 

		/// <summary>
		/// Series labels are placed as close to the series as possible in anatural way, seeking to avoid other series. The goal of thisfeature is to make the chart more easily readable, like if ahuman designer placed the labels in the optimal position.The series labels currently work with series types having a`graph` or an `area`.Requires the `series-label.js` module.
		/// </summary>
		public ScatterSeriesSunburstLabel Label { get; set; }
		private ScatterSeriesSunburstLabel Label_DefaultValue { get; set; }
		...
		/// </summary>
		public ScatterSeriesSunburstStickyTracking StickyTracking { get; set; }
		private ScatterSeriesSunburstStickyTracking StickyTracking_DefaultValue { get; set; }
		 

		/// <summary>
		/// 
		/// </summary>
		public ScatterSeriesSunburstTooltip Tooltip { get; set; }
		private ScatterSeriesSunburstTooltip Tooltip_DefaultValue { get; set; }
		...
		/// 
		/// </summary>
		public ScatterSeriesSunburstStates States { get; set; }
		private ScatterSeriesSunburstStates States_DefaultValue { get; set; }
		...
		/// 
		/// </summary>
		public ScatterSeriesSunburstEvents Events { get; set; }
		private ScatterSeriesSunburstEvents Events_DefaultValue { get; set; }
		 

		/// <summary>
		/// 
		/// </summary>
		public ScatterSeriesSunburstPoint Point { get; set; }
		private ScatterSeriesSunburstPoint Point_DefaultValue { get; set; }
		...
		/// 
		/// </summary>
		public ScatterSeriesSunburstDataLabels DataLabels { get; set; }
		private ScatterSeriesSunburstDataLabels DataLabels_DefaultValue { get; set; }
		...
		/// </summary>
		public ScatterSeriesSunburstLevelIsConstant LevelIsConstant { get; set; }
		private ScatterSeriesSunburstLevelIsConstant LevelIsConstant_DefaultValue { get; set; }
