...
{
	public partial class ScatterSeriesSunburstDataLabels  : BaseObject
	{
		public ScatterSeriesSunburstDataLabels()
		{
		...
		/// 
		/// </summary>
		public ScatterSeriesSunburstDataLabelsDefer Defer { get; set; }
		private ScatterSeriesSunburstDataLabelsDefer Defer_DefaultValue { get; set; }
		 

		/// <summary>
		/// 
		/// </summary>
		public ScatterSeriesSunburstDataLabelsStyle Style { get; set; }
		private ScatterSeriesSunburstDataLabelsStyle Style_DefaultValue { get; set; }
		...
		/// </summary>
		public ScatterSeriesSunburstDataLabelsRotationMode RotationMode { get; set; }
		private ScatterSeriesSunburstDataLabelsRotationMode RotationMode_DefaultValue { get; set; }
