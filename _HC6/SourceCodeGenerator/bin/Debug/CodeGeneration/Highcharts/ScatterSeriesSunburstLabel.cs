...
{
	public partial class ScatterSeriesSunburstLabel  : BaseObject
	{
		public ScatterSeriesSunburstLabel()
		{
		...
		/// </summary>
		public ScatterSeriesSunburstLabelEnabled Enabled { get; set; }
		private ScatterSeriesSunburstLabelEnabled Enabled_DefaultValue { get; set; }
		 

		/// <summary>
		/// Allow labels to be placed distant to the graph if necessary,and draw a connector line to the graph.
		/// </summary>
		public ScatterSeriesSunburstLabelConnectorAllowed ConnectorAllowed { get; set; }
		private ScatterSeriesSunburstLabelConnectorAllowed ConnectorAllowed_DefaultValue { get; set; }
		 

		/// <summary>
		/// If the label is closer than this to a neighbour graph, draw aconnector.
		/// </summary>
		public ScatterSeriesSunburstLabelConnectorNeighbourDistance ConnectorNeighbourDistance { get; set; }
		private ScatterSeriesSunburstLabelConnectorNeighbourDistance ConnectorNeighbourDistance_DefaultValue { get; set; }
		...
		/// </summary>
		public ScatterSeriesSunburstLabelStyle Style { get; set; }
		private ScatterSeriesSunburstLabelStyle Style_DefaultValue { get; set; }
