...
{
	public partial class ScatterSeriesWordcloud  : BaseObject
	{
		public ScatterSeriesWordcloud()
		{
			Data = Data_DefaultValue = new List<SeriesScatterWordcloudData>();
		...
		/// </summary>
		public List<SeriesScatterWordcloudData> Data { get; set; }
		private List<SeriesScatterWordcloudData> Data_DefaultValue { get; set; }
		 

		/// <summary>
		/// Series labels are placed as close to the series as possible in anatural way, seeking to avoid other series. The goal of thisfeature is to make the chart more easily readable, like if ahuman designer placed the labels in the optimal position.The series labels currently work with series types having a`graph` or an `area`.Requires the `series-label.js` module.
		/// </summary>
		public ScatterSeriesWordcloudLabel Label { get; set; }
		private ScatterSeriesWordcloudLabel Label_DefaultValue { get; set; }
		...
		/// </summary>
		public ScatterSeriesWordcloudEvents Events { get; set; }
		private ScatterSeriesWordcloudEvents Events_DefaultValue { get; set; }
		 

		/// <summary>
		/// Properties for each single point.
		/// </summary>
		public ScatterSeriesWordcloudPoint Point { get; set; }
		private ScatterSeriesWordcloudPoint Point_DefaultValue { get; set; }
		...
		/// 
		/// </summary>
		public ScatterSeriesWordcloudStates States { get; set; }
		private ScatterSeriesWordcloudStates States_DefaultValue { get; set; }
		 

		/// <summary>
		/// 
		/// </summary>
		public ScatterSeriesWordcloudStickyTracking StickyTracking { get; set; }
		private ScatterSeriesWordcloudStickyTracking StickyTracking_DefaultValue { get; set; }
		...
		/// 
		/// </summary>
		public ScatterSeriesWordcloudBorderWidth BorderWidth { get; set; }
		private ScatterSeriesWordcloudBorderWidth BorderWidth_DefaultValue { get; set; }
		 

		/// <summary>
		/// 
		/// </summary>
		public ScatterSeriesWordcloudClip Clip { get; set; }
		private ScatterSeriesWordcloudClip Clip_DefaultValue { get; set; }
		...
		/// </summary>
		public ScatterSeriesWordcloudColorByPoint ColorByPoint { get; set; }
		private ScatterSeriesWordcloudColorByPoint ColorByPoint_DefaultValue { get; set; }
		...
		/// </summary>
		public ScatterSeriesWordcloudPlacementStrategy PlacementStrategy { get; set; }
		private ScatterSeriesWordcloudPlacementStrategy PlacementStrategy_DefaultValue { get; set; }
		 

		/// <summary>
		/// Rotation options for the words in the wordcloud.
		/// </summary>
		public ScatterSeriesWordcloudRotation Rotation { get; set; }
		private ScatterSeriesWordcloudRotation Rotation_DefaultValue { get; set; }
		 

		/// <summary>
		/// 
		/// </summary>
		public ScatterSeriesWordcloudShowInLegend ShowInLegend { get; set; }
		private ScatterSeriesWordcloudShowInLegend ShowInLegend_DefaultValue { get; set; }
		...
		/// </summary>
		public ScatterSeriesWordcloudSpiral Spiral { get; set; }
		private ScatterSeriesWordcloudSpiral Spiral_DefaultValue { get; set; }
		...
		/// 
		/// </summary>
		public ScatterSeriesWordcloudTooltip Tooltip { get; set; }
		private ScatterSeriesWordcloudTooltip Tooltip_DefaultValue { get; set; }
