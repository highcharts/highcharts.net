...
{
	public partial class ScatterSeriesWordcloudLabel  : BaseObject
	{
		public ScatterSeriesWordcloudLabel()
		{
		...
		/// </summary>
		public ScatterSeriesWordcloudLabelEnabled Enabled { get; set; }
		private ScatterSeriesWordcloudLabelEnabled Enabled_DefaultValue { get; set; }
		 

		/// <summary>
		/// Allow labels to be placed distant to the graph if necessary,and draw a connector line to the graph.
		/// </summary>
		public ScatterSeriesWordcloudLabelConnectorAllowed ConnectorAllowed { get; set; }
		private ScatterSeriesWordcloudLabelConnectorAllowed ConnectorAllowed_DefaultValue { get; set; }
		 

		/// <summary>
		/// If the label is closer than this to a neighbour graph, draw aconnector.
		/// </summary>
		public ScatterSeriesWordcloudLabelConnectorNeighbourDistance ConnectorNeighbourDistance { get; set; }
		private ScatterSeriesWordcloudLabelConnectorNeighbourDistance ConnectorNeighbourDistance_DefaultValue { get; set; }
		...
		/// </summary>
		public ScatterSeriesWordcloudLabelStyle Style { get; set; }
		private ScatterSeriesWordcloudLabelStyle Style_DefaultValue { get; set; }
