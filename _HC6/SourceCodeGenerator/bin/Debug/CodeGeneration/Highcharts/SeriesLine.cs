...
namespace Highsoft.Web.Mvc.Charts
{
	public partial class Seriesline  : BaseObject
	{
		...
		/// </summary>
		public Serieslinesunburst Sunburst { get; set; }
		private Serieslinesunburst Sunburst_DefaultValue { get; set; }
		...
		/// </summary>
		public Serieslinewordcloud Wordcloud { get; set; }
		private Serieslinewordcloud Wordcloud_DefaultValue { get; set; }
		...
		/// </summary>
		public Serieslinelabel Label { get; set; }
		private Serieslinelabel Label_DefaultValue { get; set; }
		...
		/// </summary>
		public Serieslinepoint Point { get; set; }
		private Serieslinepoint Point_DefaultValue { get; set; }
		...
		/// </summary>
		public Serieslinestates States { get; set; }
		private Serieslinestates States_DefaultValue { get; set; }
		...
		/// </summary>
		public Serieslinetooltip Tooltip { get; set; }
		private Serieslinetooltip Tooltip_DefaultValue { get; set; }
		...
		/// </summary>
		public List<Serieslinezones> Zones { get; set; }
		private List<Serieslinezones> Zones_DefaultValue { get; set; }
