...
{
	public partial class SeriesLineData  : BaseObject
	{
		public SeriesLineData()
		{
		...
		/// </summary>
		public SeriesLineDataEvents Events { get; set; }
		private SeriesLineDataEvents Events_DefaultValue { get; set; }
		 

		/// <summary>
		/// 
		/// </summary>
		public SeriesLineDataMarker Marker { get; set; }
		private SeriesLineDataMarker Marker_DefaultValue { get; set; }
