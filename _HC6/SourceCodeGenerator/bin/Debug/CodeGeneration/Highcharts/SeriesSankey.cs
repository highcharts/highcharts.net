...
namespace Highsoft.Web.Mvc.Charts
{
	public partial class Seriessankey  : BaseObject
	{
		...
		/// </summary>
		public Seriessankeysunburst Sunburst { get; set; }
		private Seriessankeysunburst Sunburst_DefaultValue { get; set; }
		...
		/// </summary>
		public Seriessankeywordcloud Wordcloud { get; set; }
		private Seriessankeywordcloud Wordcloud_DefaultValue { get; set; }
		...
		/// </summary>
		public Seriessankeylabel Label { get; set; }
		private Seriessankeylabel Label_DefaultValue { get; set; }
		...
		/// </summary>
		public Seriessankeyevents Events { get; set; }
		private Seriessankeyevents Events_DefaultValue { get; set; }
		 

		/// <summary>
		/// Properties for each single point.
		/// </summary>
		public Seriessankeypoint Point { get; set; }
		private Seriessankeypoint Point_DefaultValue { get; set; }
		 

		/// <summary>
		/// Options for the series data labels, appearing next to each datapoint.In styled mode, the data labels can be styled wtih the `.highcharts-data-label-box` and `.highcharts-data-label` class names ([see example](http://jsfiddle.net/gh/get/library/pure/highcharts/highcharts/tree/master/samples/highcharts/css/series-datalabels)).
		/// </summary>
		public SeriessankeydataLabels DataLabels { get; set; }
		private SeriessankeydataLabels DataLabels_DefaultValue { get; set; }
		 

		/// <summary>
		/// A wrapper object for all the series options in specific states.
		/// </summary>
		public Seriessankeystates States { get; set; }
		private Seriessankeystates States_DefaultValue { get; set; }
		...
		/// </summary>
		public Seriessankeytooltip Tooltip { get; set; }
		private Seriessankeytooltip Tooltip_DefaultValue { get; set; }
		...
		/// 
		/// </summary>
		public SeriessankeystickyTracking StickyTracking { get; set; }
		private SeriessankeystickyTracking StickyTracking_DefaultValue { get; set; }
		...
		/// 
		/// </summary>
		public SeriessankeydataGrouping DataGrouping { get; set; }
		private SeriessankeydataGrouping DataGrouping_DefaultValue { get; set; }
		 

		/// <summary>
		/// 
		/// </summary>
		public SeriessankeycolorByPoint ColorByPoint { get; set; }
		private SeriessankeycolorByPoint ColorByPoint_DefaultValue { get; set; }
		 

		/// <summary>
		/// Higher numbers makes the links in a sankey diagram render more curved.A `curveFactor` of 0 makes the lines straight.
		/// </summary>
		public SeriessankeycurveFactor CurveFactor { get; set; }
		private SeriessankeycurveFactor CurveFactor_DefaultValue { get; set; }
		...
		/// </summary>
		public SeriessankeylinkOpacity LinkOpacity { get; set; }
		private SeriessankeylinkOpacity LinkOpacity_DefaultValue { get; set; }
		 

		/// <summary>
		/// The pixel width of each node in a sankey diagram, or the height in casethe chart is inverted.
		/// </summary>
		public SeriessankeynodeWidth NodeWidth { get; set; }
		private SeriessankeynodeWidth NodeWidth_DefaultValue { get; set; }
		 

		/// <summary>
		/// The padding between nodes in a sankey diagram, in pixels.
		/// </summary>
		public SeriessankeynodePadding NodePadding { get; set; }
		private SeriessankeynodePadding NodePadding_DefaultValue { get; set; }
		 

		/// <summary>
		/// 
		/// </summary>
		public SeriessankeyshowInLegend ShowInLegend { get; set; }
		private SeriessankeyshowInLegend ShowInLegend_DefaultValue { get; set; }
