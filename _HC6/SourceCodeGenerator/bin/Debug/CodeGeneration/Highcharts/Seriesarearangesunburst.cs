...
{
	public partial class Seriesarearangesunburst  : BaseObject
	{
		public Seriesarearangesunburst()
		{
		...
		/// </summary>
		public Seriesarearangesunburstlabel Label { get; set; }
		private Seriesarearangesunburstlabel Label_DefaultValue { get; set; }
		...
		/// </summary>
		public Seriesarearangesunburstevents Events { get; set; }
		private Seriesarearangesunburstevents Events_DefaultValue { get; set; }
		 

		/// <summary>
		/// Properties for each single point.
		/// </summary>
		public Seriesarearangesunburstpoint Point { get; set; }
		private Seriesarearangesunburstpoint Point_DefaultValue { get; set; }
		 

		/// <summary>
		/// Options for the series data labels, appearing next to each datapoint.In styled mode, the data labels can be styled wtih the `.highcharts-data-label-box` and `.highcharts-data-label` class names ([see example](http://jsfiddle.net/gh/get/library/pure/highcharts/highcharts/tree/master/samples/highcharts/css/series-datalabels)).
		/// </summary>
		public SeriesarearangesunburstdataLabels DataLabels { get; set; }
		private SeriesarearangesunburstdataLabels DataLabels_DefaultValue { get; set; }
		 

		/// <summary>
		/// A wrapper object for all the series options in specific states.
		/// </summary>
		public Seriesarearangesunburststates States { get; set; }
		private Seriesarearangesunburststates States_DefaultValue { get; set; }
		...
		/// </summary>
		public Seriesarearangesunbursttooltip Tooltip { get; set; }
		private Seriesarearangesunbursttooltip Tooltip_DefaultValue { get; set; }
		...
		/// </summary>
		public SeriesarearangesunburststickyTracking StickyTracking { get; set; }
		private SeriesarearangesunburststickyTracking StickyTracking_DefaultValue { get; set; }
		...
		/// </summary>
		public SeriesarearangesunburstlevelIsConstant LevelIsConstant { get; set; }
		private SeriesarearangesunburstlevelIsConstant LevelIsConstant_DefaultValue { get; set; }
