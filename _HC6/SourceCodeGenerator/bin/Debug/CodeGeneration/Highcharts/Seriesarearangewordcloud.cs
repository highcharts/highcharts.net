...
{
	public partial class Seriesarearangewordcloud  : BaseObject
	{
		public Seriesarearangewordcloud()
		{
		...
		/// </summary>
		public Seriesarearangewordcloudlabel Label { get; set; }
		private Seriesarearangewordcloudlabel Label_DefaultValue { get; set; }
		...
		/// </summary>
		public Seriesarearangewordcloudevents Events { get; set; }
		private Seriesarearangewordcloudevents Events_DefaultValue { get; set; }
		 

		/// <summary>
		/// Properties for each single point.
		/// </summary>
		public Seriesarearangewordcloudpoint Point { get; set; }
		private Seriesarearangewordcloudpoint Point_DefaultValue { get; set; }
		...
		/// </summary>
		public Seriesarearangewordcloudstates States { get; set; }
		private Seriesarearangewordcloudstates States_DefaultValue { get; set; }
		...
		/// </summary>
		public Seriesarearangewordcloudtooltip Tooltip { get; set; }
		private Seriesarearangewordcloudtooltip Tooltip_DefaultValue { get; set; }
		...
		/// 
		/// </summary>
		public SeriesarearangewordcloudstickyTracking StickyTracking { get; set; }
		private SeriesarearangewordcloudstickyTracking StickyTracking_DefaultValue { get; set; }
		...
		/// 
		/// </summary>
		public SeriesarearangewordcloudborderWidth BorderWidth { get; set; }
		private SeriesarearangewordcloudborderWidth BorderWidth_DefaultValue { get; set; }
		 

		/// <summary>
		/// 
		/// </summary>
		public Seriesarearangewordcloudclip Clip { get; set; }
		private Seriesarearangewordcloudclip Clip_DefaultValue { get; set; }
		 

		/// <summary>
		/// When using automatic point colors pulled from the `options.colors`collection, this option determines whether the chart should receiveone color per series or one color per point.
		/// </summary>
		public SeriesarearangewordcloudcolorByPoint ColorByPoint { get; set; }
		private SeriesarearangewordcloudcolorByPoint ColorByPoint_DefaultValue { get; set; }
		...
		/// </summary>
		public SeriesarearangewordcloudplacementStrategy PlacementStrategy { get; set; }
		private SeriesarearangewordcloudplacementStrategy PlacementStrategy_DefaultValue { get; set; }
		 

		/// <summary>
		/// Rotation options for the words in the wordcloud.
		/// </summary>
		public Seriesarearangewordcloudrotation Rotation { get; set; }
		private Seriesarearangewordcloudrotation Rotation_DefaultValue { get; set; }
		 

		/// <summary>
		/// 
		/// </summary>
		public SeriesarearangewordcloudshowInLegend ShowInLegend { get; set; }
		private SeriesarearangewordcloudshowInLegend ShowInLegend_DefaultValue { get; set; }
		...
		/// </summary>
		public Seriesarearangewordcloudspiral Spiral { get; set; }
		private Seriesarearangewordcloudspiral Spiral_DefaultValue { get; set; }
