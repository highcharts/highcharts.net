...
{
	public partial class Seriesareasplinerangewordcloud  : BaseObject
	{
		public Seriesareasplinerangewordcloud()
		{
		...
		/// </summary>
		public Seriesareasplinerangewordcloudlabel Label { get; set; }
		private Seriesareasplinerangewordcloudlabel Label_DefaultValue { get; set; }
		...
		/// </summary>
		public Seriesareasplinerangewordcloudevents Events { get; set; }
		private Seriesareasplinerangewordcloudevents Events_DefaultValue { get; set; }
		 

		/// <summary>
		/// Properties for each single point.
		/// </summary>
		public Seriesareasplinerangewordcloudpoint Point { get; set; }
		private Seriesareasplinerangewordcloudpoint Point_DefaultValue { get; set; }
		...
		/// </summary>
		public Seriesareasplinerangewordcloudstates States { get; set; }
		private Seriesareasplinerangewordcloudstates States_DefaultValue { get; set; }
		...
		/// </summary>
		public Seriesareasplinerangewordcloudtooltip Tooltip { get; set; }
		private Seriesareasplinerangewordcloudtooltip Tooltip_DefaultValue { get; set; }
		...
		/// 
		/// </summary>
		public SeriesareasplinerangewordcloudstickyTracking StickyTracking { get; set; }
		private SeriesareasplinerangewordcloudstickyTracking StickyTracking_DefaultValue { get; set; }
		...
		/// 
		/// </summary>
		public SeriesareasplinerangewordcloudborderWidth BorderWidth { get; set; }
		private SeriesareasplinerangewordcloudborderWidth BorderWidth_DefaultValue { get; set; }
		 

		/// <summary>
		/// 
		/// </summary>
		public Seriesareasplinerangewordcloudclip Clip { get; set; }
		private Seriesareasplinerangewordcloudclip Clip_DefaultValue { get; set; }
		 

		/// <summary>
		/// When using automatic point colors pulled from the `options.colors`collection, this option determines whether the chart should receiveone color per series or one color per point.
		/// </summary>
		public SeriesareasplinerangewordcloudcolorByPoint ColorByPoint { get; set; }
		private SeriesareasplinerangewordcloudcolorByPoint ColorByPoint_DefaultValue { get; set; }
		...
		/// </summary>
		public SeriesareasplinerangewordcloudplacementStrategy PlacementStrategy { get; set; }
		private SeriesareasplinerangewordcloudplacementStrategy PlacementStrategy_DefaultValue { get; set; }
		 

		/// <summary>
		/// Rotation options for the words in the wordcloud.
		/// </summary>
		public Seriesareasplinerangewordcloudrotation Rotation { get; set; }
		private Seriesareasplinerangewordcloudrotation Rotation_DefaultValue { get; set; }
		 

		/// <summary>
		/// 
		/// </summary>
		public SeriesareasplinerangewordcloudshowInLegend ShowInLegend { get; set; }
		private SeriesareasplinerangewordcloudshowInLegend ShowInLegend_DefaultValue { get; set; }
		...
		/// </summary>
		public Seriesareasplinerangewordcloudspiral Spiral { get; set; }
		private Seriesareasplinerangewordcloudspiral Spiral_DefaultValue { get; set; }
