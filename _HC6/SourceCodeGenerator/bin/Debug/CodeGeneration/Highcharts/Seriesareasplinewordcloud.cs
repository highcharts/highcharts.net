...
{
	public partial class Seriesareasplinewordcloud  : BaseObject
	{
		public Seriesareasplinewordcloud()
		{
		...
		/// </summary>
		public Seriesareasplinewordcloudlabel Label { get; set; }
		private Seriesareasplinewordcloudlabel Label_DefaultValue { get; set; }
		...
		/// </summary>
		public Seriesareasplinewordcloudevents Events { get; set; }
		private Seriesareasplinewordcloudevents Events_DefaultValue { get; set; }
		 

		/// <summary>
		/// Properties for each single point.
		/// </summary>
		public Seriesareasplinewordcloudpoint Point { get; set; }
		private Seriesareasplinewordcloudpoint Point_DefaultValue { get; set; }
		...
		/// </summary>
		public Seriesareasplinewordcloudstates States { get; set; }
		private Seriesareasplinewordcloudstates States_DefaultValue { get; set; }
		...
		/// </summary>
		public Seriesareasplinewordcloudtooltip Tooltip { get; set; }
		private Seriesareasplinewordcloudtooltip Tooltip_DefaultValue { get; set; }
		...
		/// 
		/// </summary>
		public SeriesareasplinewordcloudstickyTracking StickyTracking { get; set; }
		private SeriesareasplinewordcloudstickyTracking StickyTracking_DefaultValue { get; set; }
		...
		/// 
		/// </summary>
		public SeriesareasplinewordcloudborderWidth BorderWidth { get; set; }
		private SeriesareasplinewordcloudborderWidth BorderWidth_DefaultValue { get; set; }
		 

		/// <summary>
		/// 
		/// </summary>
		public Seriesareasplinewordcloudclip Clip { get; set; }
		private Seriesareasplinewordcloudclip Clip_DefaultValue { get; set; }
		 

		/// <summary>
		/// When using automatic point colors pulled from the `options.colors`collection, this option determines whether the chart should receiveone color per series or one color per point.
		/// </summary>
		public SeriesareasplinewordcloudcolorByPoint ColorByPoint { get; set; }
		private SeriesareasplinewordcloudcolorByPoint ColorByPoint_DefaultValue { get; set; }
		...
		/// </summary>
		public SeriesareasplinewordcloudplacementStrategy PlacementStrategy { get; set; }
		private SeriesareasplinewordcloudplacementStrategy PlacementStrategy_DefaultValue { get; set; }
		 

		/// <summary>
		/// Rotation options for the words in the wordcloud.
		/// </summary>
		public Seriesareasplinewordcloudrotation Rotation { get; set; }
		private Seriesareasplinewordcloudrotation Rotation_DefaultValue { get; set; }
		 

		/// <summary>
		/// 
		/// </summary>
		public SeriesareasplinewordcloudshowInLegend ShowInLegend { get; set; }
		private SeriesareasplinewordcloudshowInLegend ShowInLegend_DefaultValue { get; set; }
		...
		/// </summary>
		public Seriesareasplinewordcloudspiral Spiral { get; set; }
		private Seriesareasplinewordcloudspiral Spiral_DefaultValue { get; set; }
