...
{
	public partial class Seriesareawordcloud  : BaseObject
	{
		public Seriesareawordcloud()
		{
		...
		/// </summary>
		public Seriesareawordcloudlabel Label { get; set; }
		private Seriesareawordcloudlabel Label_DefaultValue { get; set; }
		...
		/// </summary>
		public Seriesareawordcloudevents Events { get; set; }
		private Seriesareawordcloudevents Events_DefaultValue { get; set; }
		 

		/// <summary>
		/// Properties for each single point.
		/// </summary>
		public Seriesareawordcloudpoint Point { get; set; }
		private Seriesareawordcloudpoint Point_DefaultValue { get; set; }
		...
		/// </summary>
		public Seriesareawordcloudstates States { get; set; }
		private Seriesareawordcloudstates States_DefaultValue { get; set; }
		...
		/// </summary>
		public Seriesareawordcloudtooltip Tooltip { get; set; }
		private Seriesareawordcloudtooltip Tooltip_DefaultValue { get; set; }
		...
		/// 
		/// </summary>
		public SeriesareawordcloudstickyTracking StickyTracking { get; set; }
		private SeriesareawordcloudstickyTracking StickyTracking_DefaultValue { get; set; }
		...
		/// 
		/// </summary>
		public SeriesareawordcloudborderWidth BorderWidth { get; set; }
		private SeriesareawordcloudborderWidth BorderWidth_DefaultValue { get; set; }
		 

		/// <summary>
		/// 
		/// </summary>
		public Seriesareawordcloudclip Clip { get; set; }
		private Seriesareawordcloudclip Clip_DefaultValue { get; set; }
		 

		/// <summary>
		/// When using automatic point colors pulled from the `options.colors`collection, this option determines whether the chart should receiveone color per series or one color per point.
		/// </summary>
		public SeriesareawordcloudcolorByPoint ColorByPoint { get; set; }
		private SeriesareawordcloudcolorByPoint ColorByPoint_DefaultValue { get; set; }
		...
		/// </summary>
		public SeriesareawordcloudplacementStrategy PlacementStrategy { get; set; }
		private SeriesareawordcloudplacementStrategy PlacementStrategy_DefaultValue { get; set; }
		 

		/// <summary>
		/// Rotation options for the words in the wordcloud.
		/// </summary>
		public Seriesareawordcloudrotation Rotation { get; set; }
		private Seriesareawordcloudrotation Rotation_DefaultValue { get; set; }
		 

		/// <summary>
		/// 
		/// </summary>
		public SeriesareawordcloudshowInLegend ShowInLegend { get; set; }
		private SeriesareawordcloudshowInLegend ShowInLegend_DefaultValue { get; set; }
		...
		/// </summary>
		public Seriesareawordcloudspiral Spiral { get; set; }
		private Seriesareawordcloudspiral Spiral_DefaultValue { get; set; }
