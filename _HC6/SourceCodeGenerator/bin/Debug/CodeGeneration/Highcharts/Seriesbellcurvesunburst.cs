...
{
	public partial class Seriesbellcurvesunburst  : BaseObject
	{
		public Seriesbellcurvesunburst()
		{
		...
		/// </summary>
		public Seriesbellcurvesunburstlabel Label { get; set; }
		private Seriesbellcurvesunburstlabel Label_DefaultValue { get; set; }
		...
		/// </summary>
		public Seriesbellcurvesunburstevents Events { get; set; }
		private Seriesbellcurvesunburstevents Events_DefaultValue { get; set; }
		 

		/// <summary>
		/// Properties for each single point.
		/// </summary>
		public Seriesbellcurvesunburstpoint Point { get; set; }
		private Seriesbellcurvesunburstpoint Point_DefaultValue { get; set; }
		 

		/// <summary>
		/// Options for the series data labels, appearing next to each datapoint.In styled mode, the data labels can be styled wtih the `.highcharts-data-label-box` and `.highcharts-data-label` class names ([see example](http://jsfiddle.net/gh/get/library/pure/highcharts/highcharts/tree/master/samples/highcharts/css/series-datalabels)).
		/// </summary>
		public SeriesbellcurvesunburstdataLabels DataLabels { get; set; }
		private SeriesbellcurvesunburstdataLabels DataLabels_DefaultValue { get; set; }
		 

		/// <summary>
		/// A wrapper object for all the series options in specific states.
		/// </summary>
		public Seriesbellcurvesunburststates States { get; set; }
		private Seriesbellcurvesunburststates States_DefaultValue { get; set; }
		...
		/// </summary>
		public Seriesbellcurvesunbursttooltip Tooltip { get; set; }
		private Seriesbellcurvesunbursttooltip Tooltip_DefaultValue { get; set; }
		...
		/// </summary>
		public SeriesbellcurvesunburststickyTracking StickyTracking { get; set; }
		private SeriesbellcurvesunburststickyTracking StickyTracking_DefaultValue { get; set; }
		...
		/// </summary>
		public SeriesbellcurvesunburstlevelIsConstant LevelIsConstant { get; set; }
		private SeriesbellcurvesunburstlevelIsConstant LevelIsConstant_DefaultValue { get; set; }
