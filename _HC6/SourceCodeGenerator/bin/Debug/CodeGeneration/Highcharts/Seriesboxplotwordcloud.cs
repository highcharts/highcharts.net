...
{
	public partial class Seriesboxplotwordcloud  : BaseObject
	{
		public Seriesboxplotwordcloud()
		{
		...
		/// </summary>
		public Seriesboxplotwordcloudlabel Label { get; set; }
		private Seriesboxplotwordcloudlabel Label_DefaultValue { get; set; }
		...
		/// </summary>
		public Seriesboxplotwordcloudevents Events { get; set; }
		private Seriesboxplotwordcloudevents Events_DefaultValue { get; set; }
		 

		/// <summary>
		/// Properties for each single point.
		/// </summary>
		public Seriesboxplotwordcloudpoint Point { get; set; }
		private Seriesboxplotwordcloudpoint Point_DefaultValue { get; set; }
		...
		/// </summary>
		public Seriesboxplotwordcloudstates States { get; set; }
		private Seriesboxplotwordcloudstates States_DefaultValue { get; set; }
		...
		/// </summary>
		public Seriesboxplotwordcloudtooltip Tooltip { get; set; }
		private Seriesboxplotwordcloudtooltip Tooltip_DefaultValue { get; set; }
		...
		/// 
		/// </summary>
		public SeriesboxplotwordcloudstickyTracking StickyTracking { get; set; }
		private SeriesboxplotwordcloudstickyTracking StickyTracking_DefaultValue { get; set; }
		...
		/// 
		/// </summary>
		public SeriesboxplotwordcloudborderWidth BorderWidth { get; set; }
		private SeriesboxplotwordcloudborderWidth BorderWidth_DefaultValue { get; set; }
		 

		/// <summary>
		/// 
		/// </summary>
		public Seriesboxplotwordcloudclip Clip { get; set; }
		private Seriesboxplotwordcloudclip Clip_DefaultValue { get; set; }
		 

		/// <summary>
		/// When using automatic point colors pulled from the `options.colors`collection, this option determines whether the chart should receiveone color per series or one color per point.
		/// </summary>
		public SeriesboxplotwordcloudcolorByPoint ColorByPoint { get; set; }
		private SeriesboxplotwordcloudcolorByPoint ColorByPoint_DefaultValue { get; set; }
		...
		/// </summary>
		public SeriesboxplotwordcloudplacementStrategy PlacementStrategy { get; set; }
		private SeriesboxplotwordcloudplacementStrategy PlacementStrategy_DefaultValue { get; set; }
		 

		/// <summary>
		/// Rotation options for the words in the wordcloud.
		/// </summary>
		public Seriesboxplotwordcloudrotation Rotation { get; set; }
		private Seriesboxplotwordcloudrotation Rotation_DefaultValue { get; set; }
		 

		/// <summary>
		/// 
		/// </summary>
		public SeriesboxplotwordcloudshowInLegend ShowInLegend { get; set; }
		private SeriesboxplotwordcloudshowInLegend ShowInLegend_DefaultValue { get; set; }
		...
		/// </summary>
		public Seriesboxplotwordcloudspiral Spiral { get; set; }
		private Seriesboxplotwordcloudspiral Spiral_DefaultValue { get; set; }
