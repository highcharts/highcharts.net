...
{
	public partial class Seriesbubblewordcloud  : BaseObject
	{
		public Seriesbubblewordcloud()
		{
		...
		/// </summary>
		public Seriesbubblewordcloudlabel Label { get; set; }
		private Seriesbubblewordcloudlabel Label_DefaultValue { get; set; }
		...
		/// </summary>
		public Seriesbubblewordcloudevents Events { get; set; }
		private Seriesbubblewordcloudevents Events_DefaultValue { get; set; }
		 

		/// <summary>
		/// Properties for each single point.
		/// </summary>
		public Seriesbubblewordcloudpoint Point { get; set; }
		private Seriesbubblewordcloudpoint Point_DefaultValue { get; set; }
		...
		/// </summary>
		public Seriesbubblewordcloudstates States { get; set; }
		private Seriesbubblewordcloudstates States_DefaultValue { get; set; }
		...
		/// </summary>
		public Seriesbubblewordcloudtooltip Tooltip { get; set; }
		private Seriesbubblewordcloudtooltip Tooltip_DefaultValue { get; set; }
		...
		/// 
		/// </summary>
		public SeriesbubblewordcloudstickyTracking StickyTracking { get; set; }
		private SeriesbubblewordcloudstickyTracking StickyTracking_DefaultValue { get; set; }
		...
		/// 
		/// </summary>
		public SeriesbubblewordcloudborderWidth BorderWidth { get; set; }
		private SeriesbubblewordcloudborderWidth BorderWidth_DefaultValue { get; set; }
		 

		/// <summary>
		/// 
		/// </summary>
		public Seriesbubblewordcloudclip Clip { get; set; }
		private Seriesbubblewordcloudclip Clip_DefaultValue { get; set; }
		 

		/// <summary>
		/// When using automatic point colors pulled from the `options.colors`collection, this option determines whether the chart should receiveone color per series or one color per point.
		/// </summary>
		public SeriesbubblewordcloudcolorByPoint ColorByPoint { get; set; }
		private SeriesbubblewordcloudcolorByPoint ColorByPoint_DefaultValue { get; set; }
		...
		/// </summary>
		public SeriesbubblewordcloudplacementStrategy PlacementStrategy { get; set; }
		private SeriesbubblewordcloudplacementStrategy PlacementStrategy_DefaultValue { get; set; }
		 

		/// <summary>
		/// Rotation options for the words in the wordcloud.
		/// </summary>
		public Seriesbubblewordcloudrotation Rotation { get; set; }
		private Seriesbubblewordcloudrotation Rotation_DefaultValue { get; set; }
		 

		/// <summary>
		/// 
		/// </summary>
		public SeriesbubblewordcloudshowInLegend ShowInLegend { get; set; }
		private SeriesbubblewordcloudshowInLegend ShowInLegend_DefaultValue { get; set; }
		...
		/// </summary>
		public Seriesbubblewordcloudspiral Spiral { get; set; }
		private Seriesbubblewordcloudspiral Spiral_DefaultValue { get; set; }
