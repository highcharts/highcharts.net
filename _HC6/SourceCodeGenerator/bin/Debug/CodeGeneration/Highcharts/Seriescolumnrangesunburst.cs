...
{
	public partial class Seriescolumnrangesunburst  : BaseObject
	{
		public Seriescolumnrangesunburst()
		{
		...
		/// </summary>
		public Seriescolumnrangesunburstlabel Label { get; set; }
		private Seriescolumnrangesunburstlabel Label_DefaultValue { get; set; }
		...
		/// </summary>
		public Seriescolumnrangesunburstevents Events { get; set; }
		private Seriescolumnrangesunburstevents Events_DefaultValue { get; set; }
		 

		/// <summary>
		/// Properties for each single point.
		/// </summary>
		public Seriescolumnrangesunburstpoint Point { get; set; }
		private Seriescolumnrangesunburstpoint Point_DefaultValue { get; set; }
		 

		/// <summary>
		/// Options for the series data labels, appearing next to each datapoint.In styled mode, the data labels can be styled wtih the `.highcharts-data-label-box` and `.highcharts-data-label` class names ([see example](http://jsfiddle.net/gh/get/library/pure/highcharts/highcharts/tree/master/samples/highcharts/css/series-datalabels)).
		/// </summary>
		public SeriescolumnrangesunburstdataLabels DataLabels { get; set; }
		private SeriescolumnrangesunburstdataLabels DataLabels_DefaultValue { get; set; }
		 

		/// <summary>
		/// A wrapper object for all the series options in specific states.
		/// </summary>
		public Seriescolumnrangesunburststates States { get; set; }
		private Seriescolumnrangesunburststates States_DefaultValue { get; set; }
		...
		/// </summary>
		public Seriescolumnrangesunbursttooltip Tooltip { get; set; }
		private Seriescolumnrangesunbursttooltip Tooltip_DefaultValue { get; set; }
		...
		/// </summary>
		public SeriescolumnrangesunburststickyTracking StickyTracking { get; set; }
		private SeriescolumnrangesunburststickyTracking StickyTracking_DefaultValue { get; set; }
		...
		/// </summary>
		public SeriescolumnrangesunburstlevelIsConstant LevelIsConstant { get; set; }
		private SeriescolumnrangesunburstlevelIsConstant LevelIsConstant_DefaultValue { get; set; }
