...
{
	public partial class Seriescolumnrangewordcloud  : BaseObject
	{
		public Seriescolumnrangewordcloud()
		{
		...
		/// </summary>
		public Seriescolumnrangewordcloudlabel Label { get; set; }
		private Seriescolumnrangewordcloudlabel Label_DefaultValue { get; set; }
		...
		/// </summary>
		public Seriescolumnrangewordcloudevents Events { get; set; }
		private Seriescolumnrangewordcloudevents Events_DefaultValue { get; set; }
		 

		/// <summary>
		/// Properties for each single point.
		/// </summary>
		public Seriescolumnrangewordcloudpoint Point { get; set; }
		private Seriescolumnrangewordcloudpoint Point_DefaultValue { get; set; }
		...
		/// </summary>
		public Seriescolumnrangewordcloudstates States { get; set; }
		private Seriescolumnrangewordcloudstates States_DefaultValue { get; set; }
		...
		/// </summary>
		public Seriescolumnrangewordcloudtooltip Tooltip { get; set; }
		private Seriescolumnrangewordcloudtooltip Tooltip_DefaultValue { get; set; }
		...
		/// 
		/// </summary>
		public SeriescolumnrangewordcloudstickyTracking StickyTracking { get; set; }
		private SeriescolumnrangewordcloudstickyTracking StickyTracking_DefaultValue { get; set; }
		...
		/// 
		/// </summary>
		public SeriescolumnrangewordcloudborderWidth BorderWidth { get; set; }
		private SeriescolumnrangewordcloudborderWidth BorderWidth_DefaultValue { get; set; }
		 

		/// <summary>
		/// 
		/// </summary>
		public Seriescolumnrangewordcloudclip Clip { get; set; }
		private Seriescolumnrangewordcloudclip Clip_DefaultValue { get; set; }
		 

		/// <summary>
		/// When using automatic point colors pulled from the `options.colors`collection, this option determines whether the chart should receiveone color per series or one color per point.
		/// </summary>
		public SeriescolumnrangewordcloudcolorByPoint ColorByPoint { get; set; }
		private SeriescolumnrangewordcloudcolorByPoint ColorByPoint_DefaultValue { get; set; }
		...
		/// </summary>
		public SeriescolumnrangewordcloudplacementStrategy PlacementStrategy { get; set; }
		private SeriescolumnrangewordcloudplacementStrategy PlacementStrategy_DefaultValue { get; set; }
		 

		/// <summary>
		/// Rotation options for the words in the wordcloud.
		/// </summary>
		public Seriescolumnrangewordcloudrotation Rotation { get; set; }
		private Seriescolumnrangewordcloudrotation Rotation_DefaultValue { get; set; }
		 

		/// <summary>
		/// 
		/// </summary>
		public SeriescolumnrangewordcloudshowInLegend ShowInLegend { get; set; }
		private SeriescolumnrangewordcloudshowInLegend ShowInLegend_DefaultValue { get; set; }
		...
		/// </summary>
		public Seriescolumnrangewordcloudspiral Spiral { get; set; }
		private Seriescolumnrangewordcloudspiral Spiral_DefaultValue { get; set; }
