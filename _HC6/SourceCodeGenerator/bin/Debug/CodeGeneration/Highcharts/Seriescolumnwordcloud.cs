...
{
	public partial class Seriescolumnwordcloud  : BaseObject
	{
		public Seriescolumnwordcloud()
		{
		...
		/// </summary>
		public Seriescolumnwordcloudlabel Label { get; set; }
		private Seriescolumnwordcloudlabel Label_DefaultValue { get; set; }
		...
		/// </summary>
		public Seriescolumnwordcloudevents Events { get; set; }
		private Seriescolumnwordcloudevents Events_DefaultValue { get; set; }
		 

		/// <summary>
		/// Properties for each single point.
		/// </summary>
		public Seriescolumnwordcloudpoint Point { get; set; }
		private Seriescolumnwordcloudpoint Point_DefaultValue { get; set; }
		...
		/// </summary>
		public Seriescolumnwordcloudstates States { get; set; }
		private Seriescolumnwordcloudstates States_DefaultValue { get; set; }
		...
		/// </summary>
		public Seriescolumnwordcloudtooltip Tooltip { get; set; }
		private Seriescolumnwordcloudtooltip Tooltip_DefaultValue { get; set; }
		...
		/// 
		/// </summary>
		public SeriescolumnwordcloudstickyTracking StickyTracking { get; set; }
		private SeriescolumnwordcloudstickyTracking StickyTracking_DefaultValue { get; set; }
		...
		/// 
		/// </summary>
		public SeriescolumnwordcloudborderWidth BorderWidth { get; set; }
		private SeriescolumnwordcloudborderWidth BorderWidth_DefaultValue { get; set; }
		 

		/// <summary>
		/// 
		/// </summary>
		public Seriescolumnwordcloudclip Clip { get; set; }
		private Seriescolumnwordcloudclip Clip_DefaultValue { get; set; }
		 

		/// <summary>
		/// When using automatic point colors pulled from the `options.colors`collection, this option determines whether the chart should receiveone color per series or one color per point.
		/// </summary>
		public SeriescolumnwordcloudcolorByPoint ColorByPoint { get; set; }
		private SeriescolumnwordcloudcolorByPoint ColorByPoint_DefaultValue { get; set; }
		...
		/// </summary>
		public SeriescolumnwordcloudplacementStrategy PlacementStrategy { get; set; }
		private SeriescolumnwordcloudplacementStrategy PlacementStrategy_DefaultValue { get; set; }
		 

		/// <summary>
		/// Rotation options for the words in the wordcloud.
		/// </summary>
		public Seriescolumnwordcloudrotation Rotation { get; set; }
		private Seriescolumnwordcloudrotation Rotation_DefaultValue { get; set; }
		 

		/// <summary>
		/// 
		/// </summary>
		public SeriescolumnwordcloudshowInLegend ShowInLegend { get; set; }
		private SeriescolumnwordcloudshowInLegend ShowInLegend_DefaultValue { get; set; }
		...
		/// </summary>
		public Seriescolumnwordcloudspiral Spiral { get; set; }
		private Seriescolumnwordcloudspiral Spiral_DefaultValue { get; set; }
