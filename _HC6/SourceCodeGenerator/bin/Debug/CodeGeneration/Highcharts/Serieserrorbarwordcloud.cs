...
{
	public partial class Serieserrorbarwordcloud  : BaseObject
	{
		public Serieserrorbarwordcloud()
		{
		...
		/// </summary>
		public Serieserrorbarwordcloudlabel Label { get; set; }
		private Serieserrorbarwordcloudlabel Label_DefaultValue { get; set; }
		...
		/// </summary>
		public Serieserrorbarwordcloudevents Events { get; set; }
		private Serieserrorbarwordcloudevents Events_DefaultValue { get; set; }
		 

		/// <summary>
		/// Properties for each single point.
		/// </summary>
		public Serieserrorbarwordcloudpoint Point { get; set; }
		private Serieserrorbarwordcloudpoint Point_DefaultValue { get; set; }
		...
		/// </summary>
		public Serieserrorbarwordcloudstates States { get; set; }
		private Serieserrorbarwordcloudstates States_DefaultValue { get; set; }
		...
		/// </summary>
		public Serieserrorbarwordcloudtooltip Tooltip { get; set; }
		private Serieserrorbarwordcloudtooltip Tooltip_DefaultValue { get; set; }
		...
		/// 
		/// </summary>
		public SerieserrorbarwordcloudstickyTracking StickyTracking { get; set; }
		private SerieserrorbarwordcloudstickyTracking StickyTracking_DefaultValue { get; set; }
		...
		/// 
		/// </summary>
		public SerieserrorbarwordcloudborderWidth BorderWidth { get; set; }
		private SerieserrorbarwordcloudborderWidth BorderWidth_DefaultValue { get; set; }
		 

		/// <summary>
		/// 
		/// </summary>
		public Serieserrorbarwordcloudclip Clip { get; set; }
		private Serieserrorbarwordcloudclip Clip_DefaultValue { get; set; }
		 

		/// <summary>
		/// When using automatic point colors pulled from the `options.colors`collection, this option determines whether the chart should receiveone color per series or one color per point.
		/// </summary>
		public SerieserrorbarwordcloudcolorByPoint ColorByPoint { get; set; }
		private SerieserrorbarwordcloudcolorByPoint ColorByPoint_DefaultValue { get; set; }
		...
		/// </summary>
		public SerieserrorbarwordcloudplacementStrategy PlacementStrategy { get; set; }
		private SerieserrorbarwordcloudplacementStrategy PlacementStrategy_DefaultValue { get; set; }
		 

		/// <summary>
		/// Rotation options for the words in the wordcloud.
		/// </summary>
		public Serieserrorbarwordcloudrotation Rotation { get; set; }
		private Serieserrorbarwordcloudrotation Rotation_DefaultValue { get; set; }
		 

		/// <summary>
		/// 
		/// </summary>
		public SerieserrorbarwordcloudshowInLegend ShowInLegend { get; set; }
		private SerieserrorbarwordcloudshowInLegend ShowInLegend_DefaultValue { get; set; }
		...
		/// </summary>
		public Serieserrorbarwordcloudspiral Spiral { get; set; }
		private Serieserrorbarwordcloudspiral Spiral_DefaultValue { get; set; }
