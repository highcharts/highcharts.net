...
{
	public partial class Seriesfunnelwordcloud  : BaseObject
	{
		public Seriesfunnelwordcloud()
		{
		...
		/// </summary>
		public Seriesfunnelwordcloudlabel Label { get; set; }
		private Seriesfunnelwordcloudlabel Label_DefaultValue { get; set; }
		...
		/// </summary>
		public Seriesfunnelwordcloudevents Events { get; set; }
		private Seriesfunnelwordcloudevents Events_DefaultValue { get; set; }
		 

		/// <summary>
		/// Properties for each single point.
		/// </summary>
		public Seriesfunnelwordcloudpoint Point { get; set; }
		private Seriesfunnelwordcloudpoint Point_DefaultValue { get; set; }
		...
		/// </summary>
		public Seriesfunnelwordcloudstates States { get; set; }
		private Seriesfunnelwordcloudstates States_DefaultValue { get; set; }
		...
		/// </summary>
		public Seriesfunnelwordcloudtooltip Tooltip { get; set; }
		private Seriesfunnelwordcloudtooltip Tooltip_DefaultValue { get; set; }
		...
		/// 
		/// </summary>
		public SeriesfunnelwordcloudstickyTracking StickyTracking { get; set; }
		private SeriesfunnelwordcloudstickyTracking StickyTracking_DefaultValue { get; set; }
		...
		/// 
		/// </summary>
		public SeriesfunnelwordcloudborderWidth BorderWidth { get; set; }
		private SeriesfunnelwordcloudborderWidth BorderWidth_DefaultValue { get; set; }
		 

		/// <summary>
		/// 
		/// </summary>
		public Seriesfunnelwordcloudclip Clip { get; set; }
		private Seriesfunnelwordcloudclip Clip_DefaultValue { get; set; }
		 

		/// <summary>
		/// When using automatic point colors pulled from the `options.colors`collection, this option determines whether the chart should receiveone color per series or one color per point.
		/// </summary>
		public SeriesfunnelwordcloudcolorByPoint ColorByPoint { get; set; }
		private SeriesfunnelwordcloudcolorByPoint ColorByPoint_DefaultValue { get; set; }
		...
		/// </summary>
		public SeriesfunnelwordcloudplacementStrategy PlacementStrategy { get; set; }
		private SeriesfunnelwordcloudplacementStrategy PlacementStrategy_DefaultValue { get; set; }
		 

		/// <summary>
		/// Rotation options for the words in the wordcloud.
		/// </summary>
		public Seriesfunnelwordcloudrotation Rotation { get; set; }
		private Seriesfunnelwordcloudrotation Rotation_DefaultValue { get; set; }
		 

		/// <summary>
		/// 
		/// </summary>
		public SeriesfunnelwordcloudshowInLegend ShowInLegend { get; set; }
		private SeriesfunnelwordcloudshowInLegend ShowInLegend_DefaultValue { get; set; }
		...
		/// </summary>
		public Seriesfunnelwordcloudspiral Spiral { get; set; }
		private Seriesfunnelwordcloudspiral Spiral_DefaultValue { get; set; }
