...
{
	public partial class Seriesgaugewordcloud  : BaseObject
	{
		public Seriesgaugewordcloud()
		{
		...
		/// </summary>
		public Seriesgaugewordcloudlabel Label { get; set; }
		private Seriesgaugewordcloudlabel Label_DefaultValue { get; set; }
		...
		/// </summary>
		public Seriesgaugewordcloudevents Events { get; set; }
		private Seriesgaugewordcloudevents Events_DefaultValue { get; set; }
		 

		/// <summary>
		/// Properties for each single point.
		/// </summary>
		public Seriesgaugewordcloudpoint Point { get; set; }
		private Seriesgaugewordcloudpoint Point_DefaultValue { get; set; }
		...
		/// </summary>
		public Seriesgaugewordcloudstates States { get; set; }
		private Seriesgaugewordcloudstates States_DefaultValue { get; set; }
		...
		/// </summary>
		public Seriesgaugewordcloudtooltip Tooltip { get; set; }
		private Seriesgaugewordcloudtooltip Tooltip_DefaultValue { get; set; }
		...
		/// 
		/// </summary>
		public SeriesgaugewordcloudstickyTracking StickyTracking { get; set; }
		private SeriesgaugewordcloudstickyTracking StickyTracking_DefaultValue { get; set; }
		...
		/// 
		/// </summary>
		public SeriesgaugewordcloudborderWidth BorderWidth { get; set; }
		private SeriesgaugewordcloudborderWidth BorderWidth_DefaultValue { get; set; }
		 

		/// <summary>
		/// 
		/// </summary>
		public Seriesgaugewordcloudclip Clip { get; set; }
		private Seriesgaugewordcloudclip Clip_DefaultValue { get; set; }
		 

		/// <summary>
		/// When using automatic point colors pulled from the `options.colors`collection, this option determines whether the chart should receiveone color per series or one color per point.
		/// </summary>
		public SeriesgaugewordcloudcolorByPoint ColorByPoint { get; set; }
		private SeriesgaugewordcloudcolorByPoint ColorByPoint_DefaultValue { get; set; }
		...
		/// </summary>
		public SeriesgaugewordcloudplacementStrategy PlacementStrategy { get; set; }
		private SeriesgaugewordcloudplacementStrategy PlacementStrategy_DefaultValue { get; set; }
		 

		/// <summary>
		/// Rotation options for the words in the wordcloud.
		/// </summary>
		public Seriesgaugewordcloudrotation Rotation { get; set; }
		private Seriesgaugewordcloudrotation Rotation_DefaultValue { get; set; }
		 

		/// <summary>
		/// 
		/// </summary>
		public SeriesgaugewordcloudshowInLegend ShowInLegend { get; set; }
		private SeriesgaugewordcloudshowInLegend ShowInLegend_DefaultValue { get; set; }
		...
		/// </summary>
		public Seriesgaugewordcloudspiral Spiral { get; set; }
		private Seriesgaugewordcloudspiral Spiral_DefaultValue { get; set; }
