...
{
	public partial class Serieshistogramwordcloud  : BaseObject
	{
		public Serieshistogramwordcloud()
		{
		...
		/// </summary>
		public Serieshistogramwordcloudlabel Label { get; set; }
		private Serieshistogramwordcloudlabel Label_DefaultValue { get; set; }
		...
		/// </summary>
		public Serieshistogramwordcloudevents Events { get; set; }
		private Serieshistogramwordcloudevents Events_DefaultValue { get; set; }
		 

		/// <summary>
		/// Properties for each single point.
		/// </summary>
		public Serieshistogramwordcloudpoint Point { get; set; }
		private Serieshistogramwordcloudpoint Point_DefaultValue { get; set; }
		...
		/// </summary>
		public Serieshistogramwordcloudstates States { get; set; }
		private Serieshistogramwordcloudstates States_DefaultValue { get; set; }
		...
		/// </summary>
		public Serieshistogramwordcloudtooltip Tooltip { get; set; }
		private Serieshistogramwordcloudtooltip Tooltip_DefaultValue { get; set; }
		...
		/// 
		/// </summary>
		public SerieshistogramwordcloudstickyTracking StickyTracking { get; set; }
		private SerieshistogramwordcloudstickyTracking StickyTracking_DefaultValue { get; set; }
		...
		/// 
		/// </summary>
		public SerieshistogramwordcloudborderWidth BorderWidth { get; set; }
		private SerieshistogramwordcloudborderWidth BorderWidth_DefaultValue { get; set; }
		 

		/// <summary>
		/// 
		/// </summary>
		public Serieshistogramwordcloudclip Clip { get; set; }
		private Serieshistogramwordcloudclip Clip_DefaultValue { get; set; }
		 

		/// <summary>
		/// When using automatic point colors pulled from the `options.colors`collection, this option determines whether the chart should receiveone color per series or one color per point.
		/// </summary>
		public SerieshistogramwordcloudcolorByPoint ColorByPoint { get; set; }
		private SerieshistogramwordcloudcolorByPoint ColorByPoint_DefaultValue { get; set; }
		...
		/// </summary>
		public SerieshistogramwordcloudplacementStrategy PlacementStrategy { get; set; }
		private SerieshistogramwordcloudplacementStrategy PlacementStrategy_DefaultValue { get; set; }
		 

		/// <summary>
		/// Rotation options for the words in the wordcloud.
		/// </summary>
		public Serieshistogramwordcloudrotation Rotation { get; set; }
		private Serieshistogramwordcloudrotation Rotation_DefaultValue { get; set; }
		 

		/// <summary>
		/// 
		/// </summary>
		public SerieshistogramwordcloudshowInLegend ShowInLegend { get; set; }
		private SerieshistogramwordcloudshowInLegend ShowInLegend_DefaultValue { get; set; }
		...
		/// </summary>
		public Serieshistogramwordcloudspiral Spiral { get; set; }
		private Serieshistogramwordcloudspiral Spiral_DefaultValue { get; set; }
