...
{
	public partial class Serieslinewordcloud  : BaseObject
	{
		public Serieslinewordcloud()
		{
		...
		/// </summary>
		public Serieslinewordcloudlabel Label { get; set; }
		private Serieslinewordcloudlabel Label_DefaultValue { get; set; }
		...
		/// </summary>
		public Serieslinewordcloudevents Events { get; set; }
		private Serieslinewordcloudevents Events_DefaultValue { get; set; }
		 

		/// <summary>
		/// Properties for each single point.
		/// </summary>
		public Serieslinewordcloudpoint Point { get; set; }
		private Serieslinewordcloudpoint Point_DefaultValue { get; set; }
		...
		/// </summary>
		public Serieslinewordcloudstates States { get; set; }
		private Serieslinewordcloudstates States_DefaultValue { get; set; }
		...
		/// </summary>
		public Serieslinewordcloudtooltip Tooltip { get; set; }
		private Serieslinewordcloudtooltip Tooltip_DefaultValue { get; set; }
		...
		/// 
		/// </summary>
		public SerieslinewordcloudstickyTracking StickyTracking { get; set; }
		private SerieslinewordcloudstickyTracking StickyTracking_DefaultValue { get; set; }
		...
		/// 
		/// </summary>
		public SerieslinewordcloudborderWidth BorderWidth { get; set; }
		private SerieslinewordcloudborderWidth BorderWidth_DefaultValue { get; set; }
		 

		/// <summary>
		/// 
		/// </summary>
		public Serieslinewordcloudclip Clip { get; set; }
		private Serieslinewordcloudclip Clip_DefaultValue { get; set; }
		 

		/// <summary>
		/// When using automatic point colors pulled from the `options.colors`collection, this option determines whether the chart should receiveone color per series or one color per point.
		/// </summary>
		public SerieslinewordcloudcolorByPoint ColorByPoint { get; set; }
		private SerieslinewordcloudcolorByPoint ColorByPoint_DefaultValue { get; set; }
		...
		/// </summary>
		public SerieslinewordcloudplacementStrategy PlacementStrategy { get; set; }
		private SerieslinewordcloudplacementStrategy PlacementStrategy_DefaultValue { get; set; }
		 

		/// <summary>
		/// Rotation options for the words in the wordcloud.
		/// </summary>
		public Serieslinewordcloudrotation Rotation { get; set; }
		private Serieslinewordcloudrotation Rotation_DefaultValue { get; set; }
		 

		/// <summary>
		/// 
		/// </summary>
		public SerieslinewordcloudshowInLegend ShowInLegend { get; set; }
		private SerieslinewordcloudshowInLegend ShowInLegend_DefaultValue { get; set; }
		...
		/// </summary>
		public Serieslinewordcloudspiral Spiral { get; set; }
		private Serieslinewordcloudspiral Spiral_DefaultValue { get; set; }
