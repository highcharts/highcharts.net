...
{
	public partial class Seriesparetowordcloud  : BaseObject
	{
		public Seriesparetowordcloud()
		{
		...
		/// </summary>
		public Seriesparetowordcloudlabel Label { get; set; }
		private Seriesparetowordcloudlabel Label_DefaultValue { get; set; }
		...
		/// </summary>
		public Seriesparetowordcloudevents Events { get; set; }
		private Seriesparetowordcloudevents Events_DefaultValue { get; set; }
		 

		/// <summary>
		/// Properties for each single point.
		/// </summary>
		public Seriesparetowordcloudpoint Point { get; set; }
		private Seriesparetowordcloudpoint Point_DefaultValue { get; set; }
		...
		/// </summary>
		public Seriesparetowordcloudstates States { get; set; }
		private Seriesparetowordcloudstates States_DefaultValue { get; set; }
		...
		/// </summary>
		public Seriesparetowordcloudtooltip Tooltip { get; set; }
		private Seriesparetowordcloudtooltip Tooltip_DefaultValue { get; set; }
		...
		/// 
		/// </summary>
		public SeriesparetowordcloudstickyTracking StickyTracking { get; set; }
		private SeriesparetowordcloudstickyTracking StickyTracking_DefaultValue { get; set; }
		...
		/// 
		/// </summary>
		public SeriesparetowordcloudborderWidth BorderWidth { get; set; }
		private SeriesparetowordcloudborderWidth BorderWidth_DefaultValue { get; set; }
		 

		/// <summary>
		/// 
		/// </summary>
		public Seriesparetowordcloudclip Clip { get; set; }
		private Seriesparetowordcloudclip Clip_DefaultValue { get; set; }
		 

		/// <summary>
		/// When using automatic point colors pulled from the `options.colors`collection, this option determines whether the chart should receiveone color per series or one color per point.
		/// </summary>
		public SeriesparetowordcloudcolorByPoint ColorByPoint { get; set; }
		private SeriesparetowordcloudcolorByPoint ColorByPoint_DefaultValue { get; set; }
		...
		/// </summary>
		public SeriesparetowordcloudplacementStrategy PlacementStrategy { get; set; }
		private SeriesparetowordcloudplacementStrategy PlacementStrategy_DefaultValue { get; set; }
		 

		/// <summary>
		/// Rotation options for the words in the wordcloud.
		/// </summary>
		public Seriesparetowordcloudrotation Rotation { get; set; }
		private Seriesparetowordcloudrotation Rotation_DefaultValue { get; set; }
		 

		/// <summary>
		/// 
		/// </summary>
		public SeriesparetowordcloudshowInLegend ShowInLegend { get; set; }
		private SeriesparetowordcloudshowInLegend ShowInLegend_DefaultValue { get; set; }
		...
		/// </summary>
		public Seriesparetowordcloudspiral Spiral { get; set; }
		private Seriesparetowordcloudspiral Spiral_DefaultValue { get; set; }
