...
{
	public partial class Seriespolygonwordcloud  : BaseObject
	{
		public Seriespolygonwordcloud()
		{
		...
		/// </summary>
		public Seriespolygonwordcloudlabel Label { get; set; }
		private Seriespolygonwordcloudlabel Label_DefaultValue { get; set; }
		...
		/// </summary>
		public Seriespolygonwordcloudevents Events { get; set; }
		private Seriespolygonwordcloudevents Events_DefaultValue { get; set; }
		 

		/// <summary>
		/// Properties for each single point.
		/// </summary>
		public Seriespolygonwordcloudpoint Point { get; set; }
		private Seriespolygonwordcloudpoint Point_DefaultValue { get; set; }
		...
		/// </summary>
		public Seriespolygonwordcloudstates States { get; set; }
		private Seriespolygonwordcloudstates States_DefaultValue { get; set; }
		...
		/// </summary>
		public Seriespolygonwordcloudtooltip Tooltip { get; set; }
		private Seriespolygonwordcloudtooltip Tooltip_DefaultValue { get; set; }
		...
		/// 
		/// </summary>
		public SeriespolygonwordcloudstickyTracking StickyTracking { get; set; }
		private SeriespolygonwordcloudstickyTracking StickyTracking_DefaultValue { get; set; }
		...
		/// 
		/// </summary>
		public SeriespolygonwordcloudborderWidth BorderWidth { get; set; }
		private SeriespolygonwordcloudborderWidth BorderWidth_DefaultValue { get; set; }
		 

		/// <summary>
		/// 
		/// </summary>
		public Seriespolygonwordcloudclip Clip { get; set; }
		private Seriespolygonwordcloudclip Clip_DefaultValue { get; set; }
		 

		/// <summary>
		/// When using automatic point colors pulled from the `options.colors`collection, this option determines whether the chart should receiveone color per series or one color per point.
		/// </summary>
		public SeriespolygonwordcloudcolorByPoint ColorByPoint { get; set; }
		private SeriespolygonwordcloudcolorByPoint ColorByPoint_DefaultValue { get; set; }
		...
		/// </summary>
		public SeriespolygonwordcloudplacementStrategy PlacementStrategy { get; set; }
		private SeriespolygonwordcloudplacementStrategy PlacementStrategy_DefaultValue { get; set; }
		 

		/// <summary>
		/// Rotation options for the words in the wordcloud.
		/// </summary>
		public Seriespolygonwordcloudrotation Rotation { get; set; }
		private Seriespolygonwordcloudrotation Rotation_DefaultValue { get; set; }
		 

		/// <summary>
		/// 
		/// </summary>
		public SeriespolygonwordcloudshowInLegend ShowInLegend { get; set; }
		private SeriespolygonwordcloudshowInLegend ShowInLegend_DefaultValue { get; set; }
		...
		/// </summary>
		public Seriespolygonwordcloudspiral Spiral { get; set; }
		private Seriespolygonwordcloudspiral Spiral_DefaultValue { get; set; }
