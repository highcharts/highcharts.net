...
{
	public partial class Seriespyramidwordcloud  : BaseObject
	{
		public Seriespyramidwordcloud()
		{
		...
		/// </summary>
		public Seriespyramidwordcloudlabel Label { get; set; }
		private Seriespyramidwordcloudlabel Label_DefaultValue { get; set; }
		...
		/// </summary>
		public Seriespyramidwordcloudevents Events { get; set; }
		private Seriespyramidwordcloudevents Events_DefaultValue { get; set; }
		 

		/// <summary>
		/// Properties for each single point.
		/// </summary>
		public Seriespyramidwordcloudpoint Point { get; set; }
		private Seriespyramidwordcloudpoint Point_DefaultValue { get; set; }
		...
		/// </summary>
		public Seriespyramidwordcloudstates States { get; set; }
		private Seriespyramidwordcloudstates States_DefaultValue { get; set; }
		...
		/// </summary>
		public Seriespyramidwordcloudtooltip Tooltip { get; set; }
		private Seriespyramidwordcloudtooltip Tooltip_DefaultValue { get; set; }
		...
		/// 
		/// </summary>
		public SeriespyramidwordcloudstickyTracking StickyTracking { get; set; }
		private SeriespyramidwordcloudstickyTracking StickyTracking_DefaultValue { get; set; }
		...
		/// 
		/// </summary>
		public SeriespyramidwordcloudborderWidth BorderWidth { get; set; }
		private SeriespyramidwordcloudborderWidth BorderWidth_DefaultValue { get; set; }
		 

		/// <summary>
		/// 
		/// </summary>
		public Seriespyramidwordcloudclip Clip { get; set; }
		private Seriespyramidwordcloudclip Clip_DefaultValue { get; set; }
		 

		/// <summary>
		/// When using automatic point colors pulled from the `options.colors`collection, this option determines whether the chart should receiveone color per series or one color per point.
		/// </summary>
		public SeriespyramidwordcloudcolorByPoint ColorByPoint { get; set; }
		private SeriespyramidwordcloudcolorByPoint ColorByPoint_DefaultValue { get; set; }
		...
		/// </summary>
		public SeriespyramidwordcloudplacementStrategy PlacementStrategy { get; set; }
		private SeriespyramidwordcloudplacementStrategy PlacementStrategy_DefaultValue { get; set; }
		 

		/// <summary>
		/// Rotation options for the words in the wordcloud.
		/// </summary>
		public Seriespyramidwordcloudrotation Rotation { get; set; }
		private Seriespyramidwordcloudrotation Rotation_DefaultValue { get; set; }
		 

		/// <summary>
		/// 
		/// </summary>
		public SeriespyramidwordcloudshowInLegend ShowInLegend { get; set; }
		private SeriespyramidwordcloudshowInLegend ShowInLegend_DefaultValue { get; set; }
		...
		/// </summary>
		public Seriespyramidwordcloudspiral Spiral { get; set; }
		private Seriespyramidwordcloudspiral Spiral_DefaultValue { get; set; }
