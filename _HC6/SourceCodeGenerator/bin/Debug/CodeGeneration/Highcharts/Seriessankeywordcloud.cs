...
{
	public partial class Seriessankeywordcloud  : BaseObject
	{
		public Seriessankeywordcloud()
		{
		...
		/// </summary>
		public Seriessankeywordcloudlabel Label { get; set; }
		private Seriessankeywordcloudlabel Label_DefaultValue { get; set; }
		...
		/// </summary>
		public Seriessankeywordcloudevents Events { get; set; }
		private Seriessankeywordcloudevents Events_DefaultValue { get; set; }
		 

		/// <summary>
		/// Properties for each single point.
		/// </summary>
		public Seriessankeywordcloudpoint Point { get; set; }
		private Seriessankeywordcloudpoint Point_DefaultValue { get; set; }
		...
		/// </summary>
		public Seriessankeywordcloudstates States { get; set; }
		private Seriessankeywordcloudstates States_DefaultValue { get; set; }
		...
		/// </summary>
		public Seriessankeywordcloudtooltip Tooltip { get; set; }
		private Seriessankeywordcloudtooltip Tooltip_DefaultValue { get; set; }
		...
		/// 
		/// </summary>
		public SeriessankeywordcloudstickyTracking StickyTracking { get; set; }
		private SeriessankeywordcloudstickyTracking StickyTracking_DefaultValue { get; set; }
		...
		/// 
		/// </summary>
		public SeriessankeywordcloudborderWidth BorderWidth { get; set; }
		private SeriessankeywordcloudborderWidth BorderWidth_DefaultValue { get; set; }
		 

		/// <summary>
		/// 
		/// </summary>
		public Seriessankeywordcloudclip Clip { get; set; }
		private Seriessankeywordcloudclip Clip_DefaultValue { get; set; }
		 

		/// <summary>
		/// When using automatic point colors pulled from the `options.colors`collection, this option determines whether the chart should receiveone color per series or one color per point.
		/// </summary>
		public SeriessankeywordcloudcolorByPoint ColorByPoint { get; set; }
		private SeriessankeywordcloudcolorByPoint ColorByPoint_DefaultValue { get; set; }
		...
		/// </summary>
		public SeriessankeywordcloudplacementStrategy PlacementStrategy { get; set; }
		private SeriessankeywordcloudplacementStrategy PlacementStrategy_DefaultValue { get; set; }
		 

		/// <summary>
		/// Rotation options for the words in the wordcloud.
		/// </summary>
		public Seriessankeywordcloudrotation Rotation { get; set; }
		private Seriessankeywordcloudrotation Rotation_DefaultValue { get; set; }
		 

		/// <summary>
		/// 
		/// </summary>
		public SeriessankeywordcloudshowInLegend ShowInLegend { get; set; }
		private SeriessankeywordcloudshowInLegend ShowInLegend_DefaultValue { get; set; }
		...
		/// </summary>
		public Seriessankeywordcloudspiral Spiral { get; set; }
		private Seriessankeywordcloudspiral Spiral_DefaultValue { get; set; }
