...
{
	public partial class Seriesscatter3dsunburst  : BaseObject
	{
		public Seriesscatter3dsunburst()
		{
		...
		/// </summary>
		public Seriesscatter3dsunburstlabel Label { get; set; }
		private Seriesscatter3dsunburstlabel Label_DefaultValue { get; set; }
		...
		/// </summary>
		public Seriesscatter3dsunburstevents Events { get; set; }
		private Seriesscatter3dsunburstevents Events_DefaultValue { get; set; }
		 

		/// <summary>
		/// Properties for each single point.
		/// </summary>
		public Seriesscatter3dsunburstpoint Point { get; set; }
		private Seriesscatter3dsunburstpoint Point_DefaultValue { get; set; }
		 

		/// <summary>
		/// Options for the series data labels, appearing next to each datapoint.In styled mode, the data labels can be styled wtih the `.highcharts-data-label-box` and `.highcharts-data-label` class names ([see example](http://jsfiddle.net/gh/get/library/pure/highcharts/highcharts/tree/master/samples/highcharts/css/series-datalabels)).
		/// </summary>
		public Seriesscatter3dsunburstdataLabels DataLabels { get; set; }
		private Seriesscatter3dsunburstdataLabels DataLabels_DefaultValue { get; set; }
		 

		/// <summary>
		/// A wrapper object for all the series options in specific states.
		/// </summary>
		public Seriesscatter3dsunburststates States { get; set; }
		private Seriesscatter3dsunburststates States_DefaultValue { get; set; }
		...
		/// </summary>
		public Seriesscatter3dsunbursttooltip Tooltip { get; set; }
		private Seriesscatter3dsunbursttooltip Tooltip_DefaultValue { get; set; }
		...
		/// </summary>
		public Seriesscatter3dsunburststickyTracking StickyTracking { get; set; }
		private Seriesscatter3dsunburststickyTracking StickyTracking_DefaultValue { get; set; }
		...
		/// </summary>
		public Seriesscatter3dsunburstlevelIsConstant LevelIsConstant { get; set; }
		private Seriesscatter3dsunburstlevelIsConstant LevelIsConstant_DefaultValue { get; set; }
