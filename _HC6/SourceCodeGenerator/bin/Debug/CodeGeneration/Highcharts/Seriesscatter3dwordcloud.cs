...
{
	public partial class Seriesscatter3dwordcloud  : BaseObject
	{
		public Seriesscatter3dwordcloud()
		{
		...
		/// </summary>
		public Seriesscatter3dwordcloudlabel Label { get; set; }
		private Seriesscatter3dwordcloudlabel Label_DefaultValue { get; set; }
		...
		/// </summary>
		public Seriesscatter3dwordcloudevents Events { get; set; }
		private Seriesscatter3dwordcloudevents Events_DefaultValue { get; set; }
		 

		/// <summary>
		/// Properties for each single point.
		/// </summary>
		public Seriesscatter3dwordcloudpoint Point { get; set; }
		private Seriesscatter3dwordcloudpoint Point_DefaultValue { get; set; }
		...
		/// </summary>
		public Seriesscatter3dwordcloudstates States { get; set; }
		private Seriesscatter3dwordcloudstates States_DefaultValue { get; set; }
		...
		/// </summary>
		public Seriesscatter3dwordcloudtooltip Tooltip { get; set; }
		private Seriesscatter3dwordcloudtooltip Tooltip_DefaultValue { get; set; }
		...
		/// 
		/// </summary>
		public Seriesscatter3dwordcloudstickyTracking StickyTracking { get; set; }
		private Seriesscatter3dwordcloudstickyTracking StickyTracking_DefaultValue { get; set; }
		...
		/// 
		/// </summary>
		public Seriesscatter3dwordcloudborderWidth BorderWidth { get; set; }
		private Seriesscatter3dwordcloudborderWidth BorderWidth_DefaultValue { get; set; }
		 

		/// <summary>
		/// 
		/// </summary>
		public Seriesscatter3dwordcloudclip Clip { get; set; }
		private Seriesscatter3dwordcloudclip Clip_DefaultValue { get; set; }
		 

		/// <summary>
		/// When using automatic point colors pulled from the `options.colors`collection, this option determines whether the chart should receiveone color per series or one color per point.
		/// </summary>
		public Seriesscatter3dwordcloudcolorByPoint ColorByPoint { get; set; }
		private Seriesscatter3dwordcloudcolorByPoint ColorByPoint_DefaultValue { get; set; }
		...
		/// </summary>
		public Seriesscatter3dwordcloudplacementStrategy PlacementStrategy { get; set; }
		private Seriesscatter3dwordcloudplacementStrategy PlacementStrategy_DefaultValue { get; set; }
		 

		/// <summary>
		/// Rotation options for the words in the wordcloud.
		/// </summary>
		public Seriesscatter3dwordcloudrotation Rotation { get; set; }
		private Seriesscatter3dwordcloudrotation Rotation_DefaultValue { get; set; }
		 

		/// <summary>
		/// 
		/// </summary>
		public Seriesscatter3dwordcloudshowInLegend ShowInLegend { get; set; }
		private Seriesscatter3dwordcloudshowInLegend ShowInLegend_DefaultValue { get; set; }
		...
		/// </summary>
		public Seriesscatter3dwordcloudspiral Spiral { get; set; }
		private Seriesscatter3dwordcloudspiral Spiral_DefaultValue { get; set; }
