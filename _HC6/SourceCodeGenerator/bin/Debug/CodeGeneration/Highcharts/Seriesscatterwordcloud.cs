...
{
	public partial class Seriesscatterwordcloud  : BaseObject
	{
		public Seriesscatterwordcloud()
		{
		...
		/// </summary>
		public Seriesscatterwordcloudlabel Label { get; set; }
		private Seriesscatterwordcloudlabel Label_DefaultValue { get; set; }
		...
		/// </summary>
		public Seriesscatterwordcloudevents Events { get; set; }
		private Seriesscatterwordcloudevents Events_DefaultValue { get; set; }
		 

		/// <summary>
		/// Properties for each single point.
		/// </summary>
		public Seriesscatterwordcloudpoint Point { get; set; }
		private Seriesscatterwordcloudpoint Point_DefaultValue { get; set; }
		...
		/// </summary>
		public Seriesscatterwordcloudstates States { get; set; }
		private Seriesscatterwordcloudstates States_DefaultValue { get; set; }
		...
		/// </summary>
		public Seriesscatterwordcloudtooltip Tooltip { get; set; }
		private Seriesscatterwordcloudtooltip Tooltip_DefaultValue { get; set; }
		...
		/// 
		/// </summary>
		public SeriesscatterwordcloudstickyTracking StickyTracking { get; set; }
		private SeriesscatterwordcloudstickyTracking StickyTracking_DefaultValue { get; set; }
		...
		/// 
		/// </summary>
		public SeriesscatterwordcloudborderWidth BorderWidth { get; set; }
		private SeriesscatterwordcloudborderWidth BorderWidth_DefaultValue { get; set; }
		 

		/// <summary>
		/// 
		/// </summary>
		public Seriesscatterwordcloudclip Clip { get; set; }
		private Seriesscatterwordcloudclip Clip_DefaultValue { get; set; }
		 

		/// <summary>
		/// When using automatic point colors pulled from the `options.colors`collection, this option determines whether the chart should receiveone color per series or one color per point.
		/// </summary>
		public SeriesscatterwordcloudcolorByPoint ColorByPoint { get; set; }
		private SeriesscatterwordcloudcolorByPoint ColorByPoint_DefaultValue { get; set; }
		...
		/// </summary>
		public SeriesscatterwordcloudplacementStrategy PlacementStrategy { get; set; }
		private SeriesscatterwordcloudplacementStrategy PlacementStrategy_DefaultValue { get; set; }
		 

		/// <summary>
		/// Rotation options for the words in the wordcloud.
		/// </summary>
		public Seriesscatterwordcloudrotation Rotation { get; set; }
		private Seriesscatterwordcloudrotation Rotation_DefaultValue { get; set; }
		 

		/// <summary>
		/// 
		/// </summary>
		public SeriesscatterwordcloudshowInLegend ShowInLegend { get; set; }
		private SeriesscatterwordcloudshowInLegend ShowInLegend_DefaultValue { get; set; }
		...
		/// </summary>
		public Seriesscatterwordcloudspiral Spiral { get; set; }
		private Seriesscatterwordcloudspiral Spiral_DefaultValue { get; set; }
