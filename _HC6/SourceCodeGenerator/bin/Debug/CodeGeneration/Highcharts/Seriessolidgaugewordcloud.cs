...
{
	public partial class Seriessolidgaugewordcloud  : BaseObject
	{
		public Seriessolidgaugewordcloud()
		{
		...
		/// </summary>
		public Seriessolidgaugewordcloudlabel Label { get; set; }
		private Seriessolidgaugewordcloudlabel Label_DefaultValue { get; set; }
		...
		/// </summary>
		public Seriessolidgaugewordcloudevents Events { get; set; }
		private Seriessolidgaugewordcloudevents Events_DefaultValue { get; set; }
		 

		/// <summary>
		/// Properties for each single point.
		/// </summary>
		public Seriessolidgaugewordcloudpoint Point { get; set; }
		private Seriessolidgaugewordcloudpoint Point_DefaultValue { get; set; }
		...
		/// </summary>
		public Seriessolidgaugewordcloudstates States { get; set; }
		private Seriessolidgaugewordcloudstates States_DefaultValue { get; set; }
		...
		/// </summary>
		public Seriessolidgaugewordcloudtooltip Tooltip { get; set; }
		private Seriessolidgaugewordcloudtooltip Tooltip_DefaultValue { get; set; }
		...
		/// 
		/// </summary>
		public SeriessolidgaugewordcloudstickyTracking StickyTracking { get; set; }
		private SeriessolidgaugewordcloudstickyTracking StickyTracking_DefaultValue { get; set; }
		...
		/// 
		/// </summary>
		public SeriessolidgaugewordcloudborderWidth BorderWidth { get; set; }
		private SeriessolidgaugewordcloudborderWidth BorderWidth_DefaultValue { get; set; }
		 

		/// <summary>
		/// 
		/// </summary>
		public Seriessolidgaugewordcloudclip Clip { get; set; }
		private Seriessolidgaugewordcloudclip Clip_DefaultValue { get; set; }
		 

		/// <summary>
		/// When using automatic point colors pulled from the `options.colors`collection, this option determines whether the chart should receiveone color per series or one color per point.
		/// </summary>
		public SeriessolidgaugewordcloudcolorByPoint ColorByPoint { get; set; }
		private SeriessolidgaugewordcloudcolorByPoint ColorByPoint_DefaultValue { get; set; }
		...
		/// </summary>
		public SeriessolidgaugewordcloudplacementStrategy PlacementStrategy { get; set; }
		private SeriessolidgaugewordcloudplacementStrategy PlacementStrategy_DefaultValue { get; set; }
		 

		/// <summary>
		/// Rotation options for the words in the wordcloud.
		/// </summary>
		public Seriessolidgaugewordcloudrotation Rotation { get; set; }
		private Seriessolidgaugewordcloudrotation Rotation_DefaultValue { get; set; }
		 

		/// <summary>
		/// 
		/// </summary>
		public SeriessolidgaugewordcloudshowInLegend ShowInLegend { get; set; }
		private SeriessolidgaugewordcloudshowInLegend ShowInLegend_DefaultValue { get; set; }
		...
		/// </summary>
		public Seriessolidgaugewordcloudspiral Spiral { get; set; }
		private Seriessolidgaugewordcloudspiral Spiral_DefaultValue { get; set; }
