...
{
	public partial class Seriessplinewordcloud  : BaseObject
	{
		public Seriessplinewordcloud()
		{
		...
		/// </summary>
		public Seriessplinewordcloudlabel Label { get; set; }
		private Seriessplinewordcloudlabel Label_DefaultValue { get; set; }
		...
		/// </summary>
		public Seriessplinewordcloudevents Events { get; set; }
		private Seriessplinewordcloudevents Events_DefaultValue { get; set; }
		 

		/// <summary>
		/// Properties for each single point.
		/// </summary>
		public Seriessplinewordcloudpoint Point { get; set; }
		private Seriessplinewordcloudpoint Point_DefaultValue { get; set; }
		...
		/// </summary>
		public Seriessplinewordcloudstates States { get; set; }
		private Seriessplinewordcloudstates States_DefaultValue { get; set; }
		...
		/// </summary>
		public Seriessplinewordcloudtooltip Tooltip { get; set; }
		private Seriessplinewordcloudtooltip Tooltip_DefaultValue { get; set; }
		...
		/// 
		/// </summary>
		public SeriessplinewordcloudstickyTracking StickyTracking { get; set; }
		private SeriessplinewordcloudstickyTracking StickyTracking_DefaultValue { get; set; }
		...
		/// 
		/// </summary>
		public SeriessplinewordcloudborderWidth BorderWidth { get; set; }
		private SeriessplinewordcloudborderWidth BorderWidth_DefaultValue { get; set; }
		 

		/// <summary>
		/// 
		/// </summary>
		public Seriessplinewordcloudclip Clip { get; set; }
		private Seriessplinewordcloudclip Clip_DefaultValue { get; set; }
		 

		/// <summary>
		/// When using automatic point colors pulled from the `options.colors`collection, this option determines whether the chart should receiveone color per series or one color per point.
		/// </summary>
		public SeriessplinewordcloudcolorByPoint ColorByPoint { get; set; }
		private SeriessplinewordcloudcolorByPoint ColorByPoint_DefaultValue { get; set; }
		...
		/// </summary>
		public SeriessplinewordcloudplacementStrategy PlacementStrategy { get; set; }
		private SeriessplinewordcloudplacementStrategy PlacementStrategy_DefaultValue { get; set; }
		 

		/// <summary>
		/// Rotation options for the words in the wordcloud.
		/// </summary>
		public Seriessplinewordcloudrotation Rotation { get; set; }
		private Seriessplinewordcloudrotation Rotation_DefaultValue { get; set; }
		 

		/// <summary>
		/// 
		/// </summary>
		public SeriessplinewordcloudshowInLegend ShowInLegend { get; set; }
		private SeriessplinewordcloudshowInLegend ShowInLegend_DefaultValue { get; set; }
		...
		/// </summary>
		public Seriessplinewordcloudspiral Spiral { get; set; }
		private Seriessplinewordcloudspiral Spiral_DefaultValue { get; set; }
