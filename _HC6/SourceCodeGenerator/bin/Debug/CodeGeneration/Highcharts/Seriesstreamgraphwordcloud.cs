...
{
	public partial class Seriesstreamgraphwordcloud  : BaseObject
	{
		public Seriesstreamgraphwordcloud()
		{
		...
		/// </summary>
		public Seriesstreamgraphwordcloudlabel Label { get; set; }
		private Seriesstreamgraphwordcloudlabel Label_DefaultValue { get; set; }
		...
		/// </summary>
		public Seriesstreamgraphwordcloudevents Events { get; set; }
		private Seriesstreamgraphwordcloudevents Events_DefaultValue { get; set; }
		 

		/// <summary>
		/// Properties for each single point.
		/// </summary>
		public Seriesstreamgraphwordcloudpoint Point { get; set; }
		private Seriesstreamgraphwordcloudpoint Point_DefaultValue { get; set; }
		...
		/// </summary>
		public Seriesstreamgraphwordcloudstates States { get; set; }
		private Seriesstreamgraphwordcloudstates States_DefaultValue { get; set; }
		...
		/// </summary>
		public Seriesstreamgraphwordcloudtooltip Tooltip { get; set; }
		private Seriesstreamgraphwordcloudtooltip Tooltip_DefaultValue { get; set; }
		...
		/// 
		/// </summary>
		public SeriesstreamgraphwordcloudstickyTracking StickyTracking { get; set; }
		private SeriesstreamgraphwordcloudstickyTracking StickyTracking_DefaultValue { get; set; }
		...
		/// 
		/// </summary>
		public SeriesstreamgraphwordcloudborderWidth BorderWidth { get; set; }
		private SeriesstreamgraphwordcloudborderWidth BorderWidth_DefaultValue { get; set; }
		 

		/// <summary>
		/// 
		/// </summary>
		public Seriesstreamgraphwordcloudclip Clip { get; set; }
		private Seriesstreamgraphwordcloudclip Clip_DefaultValue { get; set; }
		 

		/// <summary>
		/// When using automatic point colors pulled from the `options.colors`collection, this option determines whether the chart should receiveone color per series or one color per point.
		/// </summary>
		public SeriesstreamgraphwordcloudcolorByPoint ColorByPoint { get; set; }
		private SeriesstreamgraphwordcloudcolorByPoint ColorByPoint_DefaultValue { get; set; }
		...
		/// </summary>
		public SeriesstreamgraphwordcloudplacementStrategy PlacementStrategy { get; set; }
		private SeriesstreamgraphwordcloudplacementStrategy PlacementStrategy_DefaultValue { get; set; }
		 

		/// <summary>
		/// Rotation options for the words in the wordcloud.
		/// </summary>
		public Seriesstreamgraphwordcloudrotation Rotation { get; set; }
		private Seriesstreamgraphwordcloudrotation Rotation_DefaultValue { get; set; }
		 

		/// <summary>
		/// 
		/// </summary>
		public SeriesstreamgraphwordcloudshowInLegend ShowInLegend { get; set; }
		private SeriesstreamgraphwordcloudshowInLegend ShowInLegend_DefaultValue { get; set; }
		...
		/// </summary>
		public Seriesstreamgraphwordcloudspiral Spiral { get; set; }
		private Seriesstreamgraphwordcloudspiral Spiral_DefaultValue { get; set; }
