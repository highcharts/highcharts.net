...
{
	public partial class Seriestilemapwordcloud  : BaseObject
	{
		public Seriestilemapwordcloud()
		{
		...
		/// </summary>
		public Seriestilemapwordcloudlabel Label { get; set; }
		private Seriestilemapwordcloudlabel Label_DefaultValue { get; set; }
		...
		/// </summary>
		public Seriestilemapwordcloudevents Events { get; set; }
		private Seriestilemapwordcloudevents Events_DefaultValue { get; set; }
		 

		/// <summary>
		/// Properties for each single point.
		/// </summary>
		public Seriestilemapwordcloudpoint Point { get; set; }
		private Seriestilemapwordcloudpoint Point_DefaultValue { get; set; }
		...
		/// </summary>
		public Seriestilemapwordcloudstates States { get; set; }
		private Seriestilemapwordcloudstates States_DefaultValue { get; set; }
		...
		/// </summary>
		public Seriestilemapwordcloudtooltip Tooltip { get; set; }
		private Seriestilemapwordcloudtooltip Tooltip_DefaultValue { get; set; }
		...
		/// 
		/// </summary>
		public SeriestilemapwordcloudstickyTracking StickyTracking { get; set; }
		private SeriestilemapwordcloudstickyTracking StickyTracking_DefaultValue { get; set; }
		...
		/// 
		/// </summary>
		public SeriestilemapwordcloudborderWidth BorderWidth { get; set; }
		private SeriestilemapwordcloudborderWidth BorderWidth_DefaultValue { get; set; }
		 

		/// <summary>
		/// 
		/// </summary>
		public Seriestilemapwordcloudclip Clip { get; set; }
		private Seriestilemapwordcloudclip Clip_DefaultValue { get; set; }
		 

		/// <summary>
		/// When using automatic point colors pulled from the `options.colors`collection, this option determines whether the chart should receiveone color per series or one color per point.
		/// </summary>
		public SeriestilemapwordcloudcolorByPoint ColorByPoint { get; set; }
		private SeriestilemapwordcloudcolorByPoint ColorByPoint_DefaultValue { get; set; }
		...
		/// </summary>
		public SeriestilemapwordcloudplacementStrategy PlacementStrategy { get; set; }
		private SeriestilemapwordcloudplacementStrategy PlacementStrategy_DefaultValue { get; set; }
		 

		/// <summary>
		/// Rotation options for the words in the wordcloud.
		/// </summary>
		public Seriestilemapwordcloudrotation Rotation { get; set; }
		private Seriestilemapwordcloudrotation Rotation_DefaultValue { get; set; }
		 

		/// <summary>
		/// 
		/// </summary>
		public SeriestilemapwordcloudshowInLegend ShowInLegend { get; set; }
		private SeriestilemapwordcloudshowInLegend ShowInLegend_DefaultValue { get; set; }
		...
		/// </summary>
		public Seriestilemapwordcloudspiral Spiral { get; set; }
		private Seriestilemapwordcloudspiral Spiral_DefaultValue { get; set; }
