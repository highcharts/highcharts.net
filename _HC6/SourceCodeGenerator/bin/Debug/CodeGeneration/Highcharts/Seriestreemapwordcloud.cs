...
{
	public partial class Seriestreemapwordcloud  : BaseObject
	{
		public Seriestreemapwordcloud()
		{
		...
		/// </summary>
		public Seriestreemapwordcloudlabel Label { get; set; }
		private Seriestreemapwordcloudlabel Label_DefaultValue { get; set; }
		...
		/// </summary>
		public Seriestreemapwordcloudevents Events { get; set; }
		private Seriestreemapwordcloudevents Events_DefaultValue { get; set; }
		 

		/// <summary>
		/// Properties for each single point.
		/// </summary>
		public Seriestreemapwordcloudpoint Point { get; set; }
		private Seriestreemapwordcloudpoint Point_DefaultValue { get; set; }
		...
		/// </summary>
		public Seriestreemapwordcloudstates States { get; set; }
		private Seriestreemapwordcloudstates States_DefaultValue { get; set; }
		...
		/// </summary>
		public Seriestreemapwordcloudtooltip Tooltip { get; set; }
		private Seriestreemapwordcloudtooltip Tooltip_DefaultValue { get; set; }
		...
		/// 
		/// </summary>
		public SeriestreemapwordcloudstickyTracking StickyTracking { get; set; }
		private SeriestreemapwordcloudstickyTracking StickyTracking_DefaultValue { get; set; }
		...
		/// 
		/// </summary>
		public SeriestreemapwordcloudborderWidth BorderWidth { get; set; }
		private SeriestreemapwordcloudborderWidth BorderWidth_DefaultValue { get; set; }
		 

		/// <summary>
		/// 
		/// </summary>
		public Seriestreemapwordcloudclip Clip { get; set; }
		private Seriestreemapwordcloudclip Clip_DefaultValue { get; set; }
		 

		/// <summary>
		/// When using automatic point colors pulled from the `options.colors`collection, this option determines whether the chart should receiveone color per series or one color per point.
		/// </summary>
		public SeriestreemapwordcloudcolorByPoint ColorByPoint { get; set; }
		private SeriestreemapwordcloudcolorByPoint ColorByPoint_DefaultValue { get; set; }
		...
		/// </summary>
		public SeriestreemapwordcloudplacementStrategy PlacementStrategy { get; set; }
		private SeriestreemapwordcloudplacementStrategy PlacementStrategy_DefaultValue { get; set; }
		 

		/// <summary>
		/// Rotation options for the words in the wordcloud.
		/// </summary>
		public Seriestreemapwordcloudrotation Rotation { get; set; }
		private Seriestreemapwordcloudrotation Rotation_DefaultValue { get; set; }
		 

		/// <summary>
		/// 
		/// </summary>
		public SeriestreemapwordcloudshowInLegend ShowInLegend { get; set; }
		private SeriestreemapwordcloudshowInLegend ShowInLegend_DefaultValue { get; set; }
		...
		/// </summary>
		public Seriestreemapwordcloudspiral Spiral { get; set; }
		private Seriestreemapwordcloudspiral Spiral_DefaultValue { get; set; }
