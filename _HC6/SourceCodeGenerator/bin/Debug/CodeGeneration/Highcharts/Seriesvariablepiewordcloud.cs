...
{
	public partial class Seriesvariablepiewordcloud  : BaseObject
	{
		public Seriesvariablepiewordcloud()
		{
		...
		/// </summary>
		public Seriesvariablepiewordcloudlabel Label { get; set; }
		private Seriesvariablepiewordcloudlabel Label_DefaultValue { get; set; }
		...
		/// </summary>
		public Seriesvariablepiewordcloudevents Events { get; set; }
		private Seriesvariablepiewordcloudevents Events_DefaultValue { get; set; }
		 

		/// <summary>
		/// Properties for each single point.
		/// </summary>
		public Seriesvariablepiewordcloudpoint Point { get; set; }
		private Seriesvariablepiewordcloudpoint Point_DefaultValue { get; set; }
		...
		/// </summary>
		public Seriesvariablepiewordcloudstates States { get; set; }
		private Seriesvariablepiewordcloudstates States_DefaultValue { get; set; }
		...
		/// </summary>
		public Seriesvariablepiewordcloudtooltip Tooltip { get; set; }
		private Seriesvariablepiewordcloudtooltip Tooltip_DefaultValue { get; set; }
		...
		/// 
		/// </summary>
		public SeriesvariablepiewordcloudstickyTracking StickyTracking { get; set; }
		private SeriesvariablepiewordcloudstickyTracking StickyTracking_DefaultValue { get; set; }
		...
		/// 
		/// </summary>
		public SeriesvariablepiewordcloudborderWidth BorderWidth { get; set; }
		private SeriesvariablepiewordcloudborderWidth BorderWidth_DefaultValue { get; set; }
		 

		/// <summary>
		/// 
		/// </summary>
		public Seriesvariablepiewordcloudclip Clip { get; set; }
		private Seriesvariablepiewordcloudclip Clip_DefaultValue { get; set; }
		 

		/// <summary>
		/// When using automatic point colors pulled from the `options.colors`collection, this option determines whether the chart should receiveone color per series or one color per point.
		/// </summary>
		public SeriesvariablepiewordcloudcolorByPoint ColorByPoint { get; set; }
		private SeriesvariablepiewordcloudcolorByPoint ColorByPoint_DefaultValue { get; set; }
		...
		/// </summary>
		public SeriesvariablepiewordcloudplacementStrategy PlacementStrategy { get; set; }
		private SeriesvariablepiewordcloudplacementStrategy PlacementStrategy_DefaultValue { get; set; }
		 

		/// <summary>
		/// Rotation options for the words in the wordcloud.
		/// </summary>
		public Seriesvariablepiewordcloudrotation Rotation { get; set; }
		private Seriesvariablepiewordcloudrotation Rotation_DefaultValue { get; set; }
		 

		/// <summary>
		/// 
		/// </summary>
		public SeriesvariablepiewordcloudshowInLegend ShowInLegend { get; set; }
		private SeriesvariablepiewordcloudshowInLegend ShowInLegend_DefaultValue { get; set; }
		...
		/// </summary>
		public Seriesvariablepiewordcloudspiral Spiral { get; set; }
		private Seriesvariablepiewordcloudspiral Spiral_DefaultValue { get; set; }
