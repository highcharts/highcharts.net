...
{
	public partial class Seriesvariwidewordcloud  : BaseObject
	{
		public Seriesvariwidewordcloud()
		{
		...
		/// </summary>
		public Seriesvariwidewordcloudlabel Label { get; set; }
		private Seriesvariwidewordcloudlabel Label_DefaultValue { get; set; }
		...
		/// </summary>
		public Seriesvariwidewordcloudevents Events { get; set; }
		private Seriesvariwidewordcloudevents Events_DefaultValue { get; set; }
		 

		/// <summary>
		/// Properties for each single point.
		/// </summary>
		public Seriesvariwidewordcloudpoint Point { get; set; }
		private Seriesvariwidewordcloudpoint Point_DefaultValue { get; set; }
		...
		/// </summary>
		public Seriesvariwidewordcloudstates States { get; set; }
		private Seriesvariwidewordcloudstates States_DefaultValue { get; set; }
		...
		/// </summary>
		public Seriesvariwidewordcloudtooltip Tooltip { get; set; }
		private Seriesvariwidewordcloudtooltip Tooltip_DefaultValue { get; set; }
		...
		/// 
		/// </summary>
		public SeriesvariwidewordcloudstickyTracking StickyTracking { get; set; }
		private SeriesvariwidewordcloudstickyTracking StickyTracking_DefaultValue { get; set; }
		...
		/// 
		/// </summary>
		public SeriesvariwidewordcloudborderWidth BorderWidth { get; set; }
		private SeriesvariwidewordcloudborderWidth BorderWidth_DefaultValue { get; set; }
		 

		/// <summary>
		/// 
		/// </summary>
		public Seriesvariwidewordcloudclip Clip { get; set; }
		private Seriesvariwidewordcloudclip Clip_DefaultValue { get; set; }
		 

		/// <summary>
		/// When using automatic point colors pulled from the `options.colors`collection, this option determines whether the chart should receiveone color per series or one color per point.
		/// </summary>
		public SeriesvariwidewordcloudcolorByPoint ColorByPoint { get; set; }
		private SeriesvariwidewordcloudcolorByPoint ColorByPoint_DefaultValue { get; set; }
		...
		/// </summary>
		public SeriesvariwidewordcloudplacementStrategy PlacementStrategy { get; set; }
		private SeriesvariwidewordcloudplacementStrategy PlacementStrategy_DefaultValue { get; set; }
		 

		/// <summary>
		/// Rotation options for the words in the wordcloud.
		/// </summary>
		public Seriesvariwidewordcloudrotation Rotation { get; set; }
		private Seriesvariwidewordcloudrotation Rotation_DefaultValue { get; set; }
		 

		/// <summary>
		/// 
		/// </summary>
		public SeriesvariwidewordcloudshowInLegend ShowInLegend { get; set; }
		private SeriesvariwidewordcloudshowInLegend ShowInLegend_DefaultValue { get; set; }
		...
		/// </summary>
		public Seriesvariwidewordcloudspiral Spiral { get; set; }
		private Seriesvariwidewordcloudspiral Spiral_DefaultValue { get; set; }
