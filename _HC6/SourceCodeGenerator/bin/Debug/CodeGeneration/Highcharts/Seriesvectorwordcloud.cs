...
{
	public partial class Seriesvectorwordcloud  : BaseObject
	{
		public Seriesvectorwordcloud()
		{
		...
		/// </summary>
		public Seriesvectorwordcloudlabel Label { get; set; }
		private Seriesvectorwordcloudlabel Label_DefaultValue { get; set; }
		...
		/// </summary>
		public Seriesvectorwordcloudevents Events { get; set; }
		private Seriesvectorwordcloudevents Events_DefaultValue { get; set; }
		 

		/// <summary>
		/// Properties for each single point.
		/// </summary>
		public Seriesvectorwordcloudpoint Point { get; set; }
		private Seriesvectorwordcloudpoint Point_DefaultValue { get; set; }
		...
		/// </summary>
		public Seriesvectorwordcloudstates States { get; set; }
		private Seriesvectorwordcloudstates States_DefaultValue { get; set; }
		...
		/// </summary>
		public Seriesvectorwordcloudtooltip Tooltip { get; set; }
		private Seriesvectorwordcloudtooltip Tooltip_DefaultValue { get; set; }
		...
		/// 
		/// </summary>
		public SeriesvectorwordcloudstickyTracking StickyTracking { get; set; }
		private SeriesvectorwordcloudstickyTracking StickyTracking_DefaultValue { get; set; }
		...
		/// 
		/// </summary>
		public SeriesvectorwordcloudborderWidth BorderWidth { get; set; }
		private SeriesvectorwordcloudborderWidth BorderWidth_DefaultValue { get; set; }
		 

		/// <summary>
		/// 
		/// </summary>
		public Seriesvectorwordcloudclip Clip { get; set; }
		private Seriesvectorwordcloudclip Clip_DefaultValue { get; set; }
		 

		/// <summary>
		/// When using automatic point colors pulled from the `options.colors`collection, this option determines whether the chart should receiveone color per series or one color per point.
		/// </summary>
		public SeriesvectorwordcloudcolorByPoint ColorByPoint { get; set; }
		private SeriesvectorwordcloudcolorByPoint ColorByPoint_DefaultValue { get; set; }
		...
		/// </summary>
		public SeriesvectorwordcloudplacementStrategy PlacementStrategy { get; set; }
		private SeriesvectorwordcloudplacementStrategy PlacementStrategy_DefaultValue { get; set; }
		 

		/// <summary>
		/// Rotation options for the words in the wordcloud.
		/// </summary>
		public Seriesvectorwordcloudrotation Rotation { get; set; }
		private Seriesvectorwordcloudrotation Rotation_DefaultValue { get; set; }
		 

		/// <summary>
		/// 
		/// </summary>
		public SeriesvectorwordcloudshowInLegend ShowInLegend { get; set; }
		private SeriesvectorwordcloudshowInLegend ShowInLegend_DefaultValue { get; set; }
		...
		/// </summary>
		public Seriesvectorwordcloudspiral Spiral { get; set; }
		private Seriesvectorwordcloudspiral Spiral_DefaultValue { get; set; }
