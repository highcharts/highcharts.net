...
{
	public partial class Serieswaterfallwordcloud  : BaseObject
	{
		public Serieswaterfallwordcloud()
		{
		...
		/// </summary>
		public Serieswaterfallwordcloudlabel Label { get; set; }
		private Serieswaterfallwordcloudlabel Label_DefaultValue { get; set; }
		...
		/// </summary>
		public Serieswaterfallwordcloudevents Events { get; set; }
		private Serieswaterfallwordcloudevents Events_DefaultValue { get; set; }
		 

		/// <summary>
		/// Properties for each single point.
		/// </summary>
		public Serieswaterfallwordcloudpoint Point { get; set; }
		private Serieswaterfallwordcloudpoint Point_DefaultValue { get; set; }
		...
		/// </summary>
		public Serieswaterfallwordcloudstates States { get; set; }
		private Serieswaterfallwordcloudstates States_DefaultValue { get; set; }
		...
		/// </summary>
		public Serieswaterfallwordcloudtooltip Tooltip { get; set; }
		private Serieswaterfallwordcloudtooltip Tooltip_DefaultValue { get; set; }
		...
		/// 
		/// </summary>
		public SerieswaterfallwordcloudstickyTracking StickyTracking { get; set; }
		private SerieswaterfallwordcloudstickyTracking StickyTracking_DefaultValue { get; set; }
		...
		/// 
		/// </summary>
		public SerieswaterfallwordcloudborderWidth BorderWidth { get; set; }
		private SerieswaterfallwordcloudborderWidth BorderWidth_DefaultValue { get; set; }
		 

		/// <summary>
		/// 
		/// </summary>
		public Serieswaterfallwordcloudclip Clip { get; set; }
		private Serieswaterfallwordcloudclip Clip_DefaultValue { get; set; }
		 

		/// <summary>
		/// When using automatic point colors pulled from the `options.colors`collection, this option determines whether the chart should receiveone color per series or one color per point.
		/// </summary>
		public SerieswaterfallwordcloudcolorByPoint ColorByPoint { get; set; }
		private SerieswaterfallwordcloudcolorByPoint ColorByPoint_DefaultValue { get; set; }
		...
		/// </summary>
		public SerieswaterfallwordcloudplacementStrategy PlacementStrategy { get; set; }
		private SerieswaterfallwordcloudplacementStrategy PlacementStrategy_DefaultValue { get; set; }
		 

		/// <summary>
		/// Rotation options for the words in the wordcloud.
		/// </summary>
		public Serieswaterfallwordcloudrotation Rotation { get; set; }
		private Serieswaterfallwordcloudrotation Rotation_DefaultValue { get; set; }
		 

		/// <summary>
		/// 
		/// </summary>
		public SerieswaterfallwordcloudshowInLegend ShowInLegend { get; set; }
		private SerieswaterfallwordcloudshowInLegend ShowInLegend_DefaultValue { get; set; }
		...
		/// </summary>
		public Serieswaterfallwordcloudspiral Spiral { get; set; }
		private Serieswaterfallwordcloudspiral Spiral_DefaultValue { get; set; }
