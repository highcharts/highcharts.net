...
{
	public partial class Serieswindbarbwordcloud  : BaseObject
	{
		public Serieswindbarbwordcloud()
		{
		...
		/// </summary>
		public Serieswindbarbwordcloudlabel Label { get; set; }
		private Serieswindbarbwordcloudlabel Label_DefaultValue { get; set; }
		...
		/// </summary>
		public Serieswindbarbwordcloudevents Events { get; set; }
		private Serieswindbarbwordcloudevents Events_DefaultValue { get; set; }
		 

		/// <summary>
		/// Properties for each single point.
		/// </summary>
		public Serieswindbarbwordcloudpoint Point { get; set; }
		private Serieswindbarbwordcloudpoint Point_DefaultValue { get; set; }
		...
		/// </summary>
		public Serieswindbarbwordcloudstates States { get; set; }
		private Serieswindbarbwordcloudstates States_DefaultValue { get; set; }
		...
		/// </summary>
		public Serieswindbarbwordcloudtooltip Tooltip { get; set; }
		private Serieswindbarbwordcloudtooltip Tooltip_DefaultValue { get; set; }
		...
		/// 
		/// </summary>
		public SerieswindbarbwordcloudstickyTracking StickyTracking { get; set; }
		private SerieswindbarbwordcloudstickyTracking StickyTracking_DefaultValue { get; set; }
		...
		/// 
		/// </summary>
		public SerieswindbarbwordcloudborderWidth BorderWidth { get; set; }
		private SerieswindbarbwordcloudborderWidth BorderWidth_DefaultValue { get; set; }
		 

		/// <summary>
		/// 
		/// </summary>
		public Serieswindbarbwordcloudclip Clip { get; set; }
		private Serieswindbarbwordcloudclip Clip_DefaultValue { get; set; }
		 

		/// <summary>
		/// When using automatic point colors pulled from the `options.colors`collection, this option determines whether the chart should receiveone color per series or one color per point.
		/// </summary>
		public SerieswindbarbwordcloudcolorByPoint ColorByPoint { get; set; }
		private SerieswindbarbwordcloudcolorByPoint ColorByPoint_DefaultValue { get; set; }
		...
		/// </summary>
		public SerieswindbarbwordcloudplacementStrategy PlacementStrategy { get; set; }
		private SerieswindbarbwordcloudplacementStrategy PlacementStrategy_DefaultValue { get; set; }
		 

		/// <summary>
		/// Rotation options for the words in the wordcloud.
		/// </summary>
		public Serieswindbarbwordcloudrotation Rotation { get; set; }
		private Serieswindbarbwordcloudrotation Rotation_DefaultValue { get; set; }
		 

		/// <summary>
		/// 
		/// </summary>
		public SerieswindbarbwordcloudshowInLegend ShowInLegend { get; set; }
		private SerieswindbarbwordcloudshowInLegend ShowInLegend_DefaultValue { get; set; }
		...
		/// </summary>
		public Serieswindbarbwordcloudspiral Spiral { get; set; }
		private Serieswindbarbwordcloudspiral Spiral_DefaultValue { get; set; }
