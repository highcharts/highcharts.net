...
{
	public partial class Seriesxrangesunburst  : BaseObject
	{
		public Seriesxrangesunburst()
		{
		...
		/// </summary>
		public Seriesxrangesunburstlabel Label { get; set; }
		private Seriesxrangesunburstlabel Label_DefaultValue { get; set; }
		...
		/// </summary>
		public Seriesxrangesunburstevents Events { get; set; }
		private Seriesxrangesunburstevents Events_DefaultValue { get; set; }
		 

		/// <summary>
		/// Properties for each single point.
		/// </summary>
		public Seriesxrangesunburstpoint Point { get; set; }
		private Seriesxrangesunburstpoint Point_DefaultValue { get; set; }
		 

		/// <summary>
		/// Options for the series data labels, appearing next to each datapoint.In styled mode, the data labels can be styled wtih the `.highcharts-data-label-box` and `.highcharts-data-label` class names ([see example](http://jsfiddle.net/gh/get/library/pure/highcharts/highcharts/tree/master/samples/highcharts/css/series-datalabels)).
		/// </summary>
		public SeriesxrangesunburstdataLabels DataLabels { get; set; }
		private SeriesxrangesunburstdataLabels DataLabels_DefaultValue { get; set; }
		 

		/// <summary>
		/// A wrapper object for all the series options in specific states.
		/// </summary>
		public Seriesxrangesunburststates States { get; set; }
		private Seriesxrangesunburststates States_DefaultValue { get; set; }
		...
		/// </summary>
		public Seriesxrangesunbursttooltip Tooltip { get; set; }
		private Seriesxrangesunbursttooltip Tooltip_DefaultValue { get; set; }
		...
		/// </summary>
		public SeriesxrangesunburststickyTracking StickyTracking { get; set; }
		private SeriesxrangesunburststickyTracking StickyTracking_DefaultValue { get; set; }
		...
		/// </summary>
		public SeriesxrangesunburstlevelIsConstant LevelIsConstant { get; set; }
		private SeriesxrangesunburstlevelIsConstant LevelIsConstant_DefaultValue { get; set; }
