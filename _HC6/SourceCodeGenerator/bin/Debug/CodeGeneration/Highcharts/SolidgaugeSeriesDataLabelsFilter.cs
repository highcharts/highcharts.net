...
{
	public partial class SolidgaugeSeriesDataLabelsFilter  : BaseObject
	{
		public SolidgaugeSeriesDataLabelsFilter()
		{
		...
		/// </summary>
		public SolidgaugeSeriesDataLabelsFilterValue Value { get; set; }
		private SolidgaugeSeriesDataLabelsFilterValue Value_DefaultValue { get; set; }
