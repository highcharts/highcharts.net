...
{
	public partial class SolidgaugeSeriesSunburst  : BaseObject
	{
		public SolidgaugeSeriesSunburst()
		{
			Data = Data_DefaultValue = new List<SeriesSolidgaugeSunburstData>();
		...
		/// 
		/// </summary>
		public List<SeriesSolidgaugeSunburstData> Data { get; set; }
		private List<SeriesSolidgaugeSunburstData> Data_DefaultValue { get; set; }
		 

		/// <summary>
		/// Series labels are placed as close to the series as possible in anatural way, seeking to avoid other series. The goal of thisfeature is to make the chart more easily readable, like if ahuman designer placed the labels in the optimal position.The series labels currently work with series types having a`graph` or an `area`.Requires the `series-label.js` module.
		/// </summary>
		public SolidgaugeSeriesSunburstLabel Label { get; set; }
		private SolidgaugeSeriesSunburstLabel Label_DefaultValue { get; set; }
		...
		/// </summary>
		public SolidgaugeSeriesSunburstStickyTracking StickyTracking { get; set; }
		private SolidgaugeSeriesSunburstStickyTracking StickyTracking_DefaultValue { get; set; }
		 

		/// <summary>
		/// 
		/// </summary>
		public SolidgaugeSeriesSunburstTooltip Tooltip { get; set; }
		private SolidgaugeSeriesSunburstTooltip Tooltip_DefaultValue { get; set; }
		...
		/// 
		/// </summary>
		public SolidgaugeSeriesSunburstStates States { get; set; }
		private SolidgaugeSeriesSunburstStates States_DefaultValue { get; set; }
		...
		/// 
		/// </summary>
		public SolidgaugeSeriesSunburstEvents Events { get; set; }
		private SolidgaugeSeriesSunburstEvents Events_DefaultValue { get; set; }
		 

		/// <summary>
		/// 
		/// </summary>
		public SolidgaugeSeriesSunburstPoint Point { get; set; }
		private SolidgaugeSeriesSunburstPoint Point_DefaultValue { get; set; }
		...
		/// 
		/// </summary>
		public SolidgaugeSeriesSunburstDataLabels DataLabels { get; set; }
		private SolidgaugeSeriesSunburstDataLabels DataLabels_DefaultValue { get; set; }
		...
		/// </summary>
		public SolidgaugeSeriesSunburstLevelIsConstant LevelIsConstant { get; set; }
		private SolidgaugeSeriesSunburstLevelIsConstant LevelIsConstant_DefaultValue { get; set; }
