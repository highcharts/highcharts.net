...
{
	public partial class SolidgaugeSeriesSunburstData  : BaseObject
	{
		public SolidgaugeSeriesSunburstData()
		{
		...
		/// </summary>
		public SolidgaugeSeriesSunburstDataEvents Events { get; set; }
		private SolidgaugeSeriesSunburstDataEvents Events_DefaultValue { get; set; }
