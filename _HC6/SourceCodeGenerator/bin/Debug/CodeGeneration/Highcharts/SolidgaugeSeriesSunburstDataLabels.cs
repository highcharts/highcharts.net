...
{
	public partial class SolidgaugeSeriesSunburstDataLabels  : BaseObject
	{
		public SolidgaugeSeriesSunburstDataLabels()
		{
		...
		/// 
		/// </summary>
		public SolidgaugeSeriesSunburstDataLabelsDefer Defer { get; set; }
		private SolidgaugeSeriesSunburstDataLabelsDefer Defer_DefaultValue { get; set; }
		 

		/// <summary>
		/// 
		/// </summary>
		public SolidgaugeSeriesSunburstDataLabelsStyle Style { get; set; }
		private SolidgaugeSeriesSunburstDataLabelsStyle Style_DefaultValue { get; set; }
		...
		/// </summary>
		public SolidgaugeSeriesSunburstDataLabelsRotationMode RotationMode { get; set; }
		private SolidgaugeSeriesSunburstDataLabelsRotationMode RotationMode_DefaultValue { get; set; }
