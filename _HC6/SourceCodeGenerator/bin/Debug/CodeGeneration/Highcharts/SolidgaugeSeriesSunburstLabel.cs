...
{
	public partial class SolidgaugeSeriesSunburstLabel  : BaseObject
	{
		public SolidgaugeSeriesSunburstLabel()
		{
		...
		/// </summary>
		public SolidgaugeSeriesSunburstLabelEnabled Enabled { get; set; }
		private SolidgaugeSeriesSunburstLabelEnabled Enabled_DefaultValue { get; set; }
		 

		/// <summary>
		/// Allow labels to be placed distant to the graph if necessary,and draw a connector line to the graph.
		/// </summary>
		public SolidgaugeSeriesSunburstLabelConnectorAllowed ConnectorAllowed { get; set; }
		private SolidgaugeSeriesSunburstLabelConnectorAllowed ConnectorAllowed_DefaultValue { get; set; }
		 

		/// <summary>
		/// If the label is closer than this to a neighbour graph, draw aconnector.
		/// </summary>
		public SolidgaugeSeriesSunburstLabelConnectorNeighbourDistance ConnectorNeighbourDistance { get; set; }
		private SolidgaugeSeriesSunburstLabelConnectorNeighbourDistance ConnectorNeighbourDistance_DefaultValue { get; set; }
		...
		/// </summary>
		public SolidgaugeSeriesSunburstLabelStyle Style { get; set; }
		private SolidgaugeSeriesSunburstLabelStyle Style_DefaultValue { get; set; }
