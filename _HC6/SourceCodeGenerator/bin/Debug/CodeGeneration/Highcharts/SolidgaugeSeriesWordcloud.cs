...
{
	public partial class SolidgaugeSeriesWordcloud  : BaseObject
	{
		public SolidgaugeSeriesWordcloud()
		{
			Data = Data_DefaultValue = new List<SeriesSolidgaugeWordcloudData>();
		...
		/// </summary>
		public List<SeriesSolidgaugeWordcloudData> Data { get; set; }
		private List<SeriesSolidgaugeWordcloudData> Data_DefaultValue { get; set; }
		 

		/// <summary>
		/// Series labels are placed as close to the series as possible in anatural way, seeking to avoid other series. The goal of thisfeature is to make the chart more easily readable, like if ahuman designer placed the labels in the optimal position.The series labels currently work with series types having a`graph` or an `area`.Requires the `series-label.js` module.
		/// </summary>
		public SolidgaugeSeriesWordcloudLabel Label { get; set; }
		private SolidgaugeSeriesWordcloudLabel Label_DefaultValue { get; set; }
		...
		/// </summary>
		public SolidgaugeSeriesWordcloudEvents Events { get; set; }
		private SolidgaugeSeriesWordcloudEvents Events_DefaultValue { get; set; }
		 

		/// <summary>
		/// Properties for each single point.
		/// </summary>
		public SolidgaugeSeriesWordcloudPoint Point { get; set; }
		private SolidgaugeSeriesWordcloudPoint Point_DefaultValue { get; set; }
		...
		/// 
		/// </summary>
		public SolidgaugeSeriesWordcloudStates States { get; set; }
		private SolidgaugeSeriesWordcloudStates States_DefaultValue { get; set; }
		 

		/// <summary>
		/// 
		/// </summary>
		public SolidgaugeSeriesWordcloudStickyTracking StickyTracking { get; set; }
		private SolidgaugeSeriesWordcloudStickyTracking StickyTracking_DefaultValue { get; set; }
		...
		/// 
		/// </summary>
		public SolidgaugeSeriesWordcloudBorderWidth BorderWidth { get; set; }
		private SolidgaugeSeriesWordcloudBorderWidth BorderWidth_DefaultValue { get; set; }
		 

		/// <summary>
		/// 
		/// </summary>
		public SolidgaugeSeriesWordcloudClip Clip { get; set; }
		private SolidgaugeSeriesWordcloudClip Clip_DefaultValue { get; set; }
		...
		/// </summary>
		public SolidgaugeSeriesWordcloudColorByPoint ColorByPoint { get; set; }
		private SolidgaugeSeriesWordcloudColorByPoint ColorByPoint_DefaultValue { get; set; }
		...
		/// </summary>
		public SolidgaugeSeriesWordcloudPlacementStrategy PlacementStrategy { get; set; }
		private SolidgaugeSeriesWordcloudPlacementStrategy PlacementStrategy_DefaultValue { get; set; }
		 

		/// <summary>
		/// Rotation options for the words in the wordcloud.
		/// </summary>
		public SolidgaugeSeriesWordcloudRotation Rotation { get; set; }
		private SolidgaugeSeriesWordcloudRotation Rotation_DefaultValue { get; set; }
		 

		/// <summary>
		/// 
		/// </summary>
		public SolidgaugeSeriesWordcloudShowInLegend ShowInLegend { get; set; }
		private SolidgaugeSeriesWordcloudShowInLegend ShowInLegend_DefaultValue { get; set; }
		...
		/// </summary>
		public SolidgaugeSeriesWordcloudSpiral Spiral { get; set; }
		private SolidgaugeSeriesWordcloudSpiral Spiral_DefaultValue { get; set; }
		...
		/// 
		/// </summary>
		public SolidgaugeSeriesWordcloudTooltip Tooltip { get; set; }
		private SolidgaugeSeriesWordcloudTooltip Tooltip_DefaultValue { get; set; }
