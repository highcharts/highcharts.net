...
{
	public partial class SolidgaugeSeriesWordcloudLabel  : BaseObject
	{
		public SolidgaugeSeriesWordcloudLabel()
		{
		...
		/// </summary>
		public SolidgaugeSeriesWordcloudLabelEnabled Enabled { get; set; }
		private SolidgaugeSeriesWordcloudLabelEnabled Enabled_DefaultValue { get; set; }
		 

		/// <summary>
		/// Allow labels to be placed distant to the graph if necessary,and draw a connector line to the graph.
		/// </summary>
		public SolidgaugeSeriesWordcloudLabelConnectorAllowed ConnectorAllowed { get; set; }
		private SolidgaugeSeriesWordcloudLabelConnectorAllowed ConnectorAllowed_DefaultValue { get; set; }
		 

		/// <summary>
		/// If the label is closer than this to a neighbour graph, draw aconnector.
		/// </summary>
		public SolidgaugeSeriesWordcloudLabelConnectorNeighbourDistance ConnectorNeighbourDistance { get; set; }
		private SolidgaugeSeriesWordcloudLabelConnectorNeighbourDistance ConnectorNeighbourDistance_DefaultValue { get; set; }
		...
		/// </summary>
		public SolidgaugeSeriesWordcloudLabelStyle Style { get; set; }
		private SolidgaugeSeriesWordcloudLabelStyle Style_DefaultValue { get; set; }
