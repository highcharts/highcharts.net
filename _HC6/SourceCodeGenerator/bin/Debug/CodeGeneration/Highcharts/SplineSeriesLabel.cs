...
{
	public partial class SplineSeriesLabel  : BaseObject
	{
		public SplineSeriesLabel()
		{
			...
			Style = Style_DefaultValue = new SplineSeriesLabelStyle();
		...
		/// </summary>
		public SplineSeriesLabelEnabled Enabled { get; set; }
		private SplineSeriesLabelEnabled Enabled_DefaultValue { get; set; }
		 

		/// <summary>
		/// Allow labels to be placed distant to the graph if necessary,and draw a connector line to the graph.
		/// </summary>
		public SplineSeriesLabelConnectorAllowed ConnectorAllowed { get; set; }
		private SplineSeriesLabelConnectorAllowed ConnectorAllowed_DefaultValue { get; set; }
		 

		/// <summary>
		/// If the label is closer than this to a neighbour graph, draw aconnector.
		/// </summary>
		public SplineSeriesLabelConnectorNeighbourDistance ConnectorNeighbourDistance { get; set; }
		private SplineSeriesLabelConnectorNeighbourDistance ConnectorNeighbourDistance_DefaultValue { get; set; }
		...
		/// </summary>
		public SplineSeriesLabelStyle Style { get; set; }
		private SplineSeriesLabelStyle Style_DefaultValue { get; set; }
