...
{
	public partial class SplineSeriesSunburst  : BaseObject
	{
		public SplineSeriesSunburst()
		{
			Data = Data_DefaultValue = new List<SeriesSplineSunburstData>();
		...
		/// 
		/// </summary>
		public List<SeriesSplineSunburstData> Data { get; set; }
		private List<SeriesSplineSunburstData> Data_DefaultValue { get; set; }
		 

		/// <summary>
		/// Series labels are placed as close to the series as possible in anatural way, seeking to avoid other series. The goal of thisfeature is to make the chart more easily readable, like if ahuman designer placed the labels in the optimal position.The series labels currently work with series types having a`graph` or an `area`.Requires the `series-label.js` module.
		/// </summary>
		public SplineSeriesSunburstLabel Label { get; set; }
		private SplineSeriesSunburstLabel Label_DefaultValue { get; set; }
		...
		/// </summary>
		public SplineSeriesSunburstStickyTracking StickyTracking { get; set; }
		private SplineSeriesSunburstStickyTracking StickyTracking_DefaultValue { get; set; }
		 

		/// <summary>
		/// 
		/// </summary>
		public SplineSeriesSunburstTooltip Tooltip { get; set; }
		private SplineSeriesSunburstTooltip Tooltip_DefaultValue { get; set; }
		...
		/// 
		/// </summary>
		public SplineSeriesSunburstStates States { get; set; }
		private SplineSeriesSunburstStates States_DefaultValue { get; set; }
		...
		/// 
		/// </summary>
		public SplineSeriesSunburstEvents Events { get; set; }
		private SplineSeriesSunburstEvents Events_DefaultValue { get; set; }
		 

		/// <summary>
		/// 
		/// </summary>
		public SplineSeriesSunburstPoint Point { get; set; }
		private SplineSeriesSunburstPoint Point_DefaultValue { get; set; }
		...
		/// 
		/// </summary>
		public SplineSeriesSunburstDataLabels DataLabels { get; set; }
		private SplineSeriesSunburstDataLabels DataLabels_DefaultValue { get; set; }
		...
		/// </summary>
		public SplineSeriesSunburstLevelIsConstant LevelIsConstant { get; set; }
		private SplineSeriesSunburstLevelIsConstant LevelIsConstant_DefaultValue { get; set; }
