...
{
	public partial class SplineSeriesSunburstData  : BaseObject
	{
		public SplineSeriesSunburstData()
		{
		...
		/// </summary>
		public SplineSeriesSunburstDataEvents Events { get; set; }
		private SplineSeriesSunburstDataEvents Events_DefaultValue { get; set; }
