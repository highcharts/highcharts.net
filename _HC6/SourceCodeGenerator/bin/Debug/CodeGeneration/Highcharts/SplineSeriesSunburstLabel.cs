...
{
	public partial class SplineSeriesSunburstLabel  : BaseObject
	{
		public SplineSeriesSunburstLabel()
		{
		...
		/// </summary>
		public SplineSeriesSunburstLabelEnabled Enabled { get; set; }
		private SplineSeriesSunburstLabelEnabled Enabled_DefaultValue { get; set; }
		 

		/// <summary>
		/// Allow labels to be placed distant to the graph if necessary,and draw a connector line to the graph.
		/// </summary>
		public SplineSeriesSunburstLabelConnectorAllowed ConnectorAllowed { get; set; }
		private SplineSeriesSunburstLabelConnectorAllowed ConnectorAllowed_DefaultValue { get; set; }
		 

		/// <summary>
		/// If the label is closer than this to a neighbour graph, draw aconnector.
		/// </summary>
		public SplineSeriesSunburstLabelConnectorNeighbourDistance ConnectorNeighbourDistance { get; set; }
		private SplineSeriesSunburstLabelConnectorNeighbourDistance ConnectorNeighbourDistance_DefaultValue { get; set; }
		...
		/// </summary>
		public SplineSeriesSunburstLabelStyle Style { get; set; }
		private SplineSeriesSunburstLabelStyle Style_DefaultValue { get; set; }
