...
{
	public partial class SplineSeriesWordcloud  : BaseObject
	{
		public SplineSeriesWordcloud()
		{
			Data = Data_DefaultValue = new List<SeriesSplineWordcloudData>();
		...
		/// </summary>
		public List<SeriesSplineWordcloudData> Data { get; set; }
		private List<SeriesSplineWordcloudData> Data_DefaultValue { get; set; }
		 

		/// <summary>
		/// Series labels are placed as close to the series as possible in anatural way, seeking to avoid other series. The goal of thisfeature is to make the chart more easily readable, like if ahuman designer placed the labels in the optimal position.The series labels currently work with series types having a`graph` or an `area`.Requires the `series-label.js` module.
		/// </summary>
		public SplineSeriesWordcloudLabel Label { get; set; }
		private SplineSeriesWordcloudLabel Label_DefaultValue { get; set; }
		...
		/// </summary>
		public SplineSeriesWordcloudEvents Events { get; set; }
		private SplineSeriesWordcloudEvents Events_DefaultValue { get; set; }
		 

		/// <summary>
		/// Properties for each single point.
		/// </summary>
		public SplineSeriesWordcloudPoint Point { get; set; }
		private SplineSeriesWordcloudPoint Point_DefaultValue { get; set; }
		...
		/// 
		/// </summary>
		public SplineSeriesWordcloudStates States { get; set; }
		private SplineSeriesWordcloudStates States_DefaultValue { get; set; }
		 

		/// <summary>
		/// 
		/// </summary>
		public SplineSeriesWordcloudStickyTracking StickyTracking { get; set; }
		private SplineSeriesWordcloudStickyTracking StickyTracking_DefaultValue { get; set; }
		...
		/// 
		/// </summary>
		public SplineSeriesWordcloudBorderWidth BorderWidth { get; set; }
		private SplineSeriesWordcloudBorderWidth BorderWidth_DefaultValue { get; set; }
		 

		/// <summary>
		/// 
		/// </summary>
		public SplineSeriesWordcloudClip Clip { get; set; }
		private SplineSeriesWordcloudClip Clip_DefaultValue { get; set; }
		...
		/// </summary>
		public SplineSeriesWordcloudColorByPoint ColorByPoint { get; set; }
		private SplineSeriesWordcloudColorByPoint ColorByPoint_DefaultValue { get; set; }
		...
		/// </summary>
		public SplineSeriesWordcloudPlacementStrategy PlacementStrategy { get; set; }
		private SplineSeriesWordcloudPlacementStrategy PlacementStrategy_DefaultValue { get; set; }
		 

		/// <summary>
		/// Rotation options for the words in the wordcloud.
		/// </summary>
		public SplineSeriesWordcloudRotation Rotation { get; set; }
		private SplineSeriesWordcloudRotation Rotation_DefaultValue { get; set; }
		 

		/// <summary>
		/// 
		/// </summary>
		public SplineSeriesWordcloudShowInLegend ShowInLegend { get; set; }
		private SplineSeriesWordcloudShowInLegend ShowInLegend_DefaultValue { get; set; }
		...
		/// </summary>
		public SplineSeriesWordcloudSpiral Spiral { get; set; }
		private SplineSeriesWordcloudSpiral Spiral_DefaultValue { get; set; }
		...
		/// 
		/// </summary>
		public SplineSeriesWordcloudTooltip Tooltip { get; set; }
		private SplineSeriesWordcloudTooltip Tooltip_DefaultValue { get; set; }
