...
{
	public partial class SplineSeriesWordcloudLabel  : BaseObject
	{
		public SplineSeriesWordcloudLabel()
		{
		...
		/// </summary>
		public SplineSeriesWordcloudLabelEnabled Enabled { get; set; }
		private SplineSeriesWordcloudLabelEnabled Enabled_DefaultValue { get; set; }
		 

		/// <summary>
		/// Allow labels to be placed distant to the graph if necessary,and draw a connector line to the graph.
		/// </summary>
		public SplineSeriesWordcloudLabelConnectorAllowed ConnectorAllowed { get; set; }
		private SplineSeriesWordcloudLabelConnectorAllowed ConnectorAllowed_DefaultValue { get; set; }
		 

		/// <summary>
		/// If the label is closer than this to a neighbour graph, draw aconnector.
		/// </summary>
		public SplineSeriesWordcloudLabelConnectorNeighbourDistance ConnectorNeighbourDistance { get; set; }
		private SplineSeriesWordcloudLabelConnectorNeighbourDistance ConnectorNeighbourDistance_DefaultValue { get; set; }
		...
		/// </summary>
		public SplineSeriesWordcloudLabelStyle Style { get; set; }
		private SplineSeriesWordcloudLabelStyle Style_DefaultValue { get; set; }
