...
namespace Highsoft.Web.Mvc.Charts
{
	public partial class StreamgraphSeries  : Series
	{
		...
		{
			Data = Data_DefaultValue = new List<SeriesStreamgraphData>();
			Id = Id_DefaultValue = "";
		...
		/// </summary>
		public List<SeriesStreamgraphData> Data { get; set; }
		private List<SeriesStreamgraphData> Data_DefaultValue { get; set; }
		...
		/// 
		/// </summary>
		public StreamgraphSeriesFillOpacity FillOpacity { get; set; }
		private StreamgraphSeriesFillOpacity FillOpacity_DefaultValue { get; set; }
		 

		/// <summary>
		/// 
		/// </summary>
		public StreamgraphSeriesLineWidth LineWidth { get; set; }
		private StreamgraphSeriesLineWidth LineWidth_DefaultValue { get; set; }
