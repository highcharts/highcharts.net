...
{
	public partial class StreamgraphSeriesSunburst  : BaseObject
	{
		public StreamgraphSeriesSunburst()
		{
			Data = Data_DefaultValue = new List<SeriesStreamgraphSunburstData>();
		...
		/// 
		/// </summary>
		public List<SeriesStreamgraphSunburstData> Data { get; set; }
		private List<SeriesStreamgraphSunburstData> Data_DefaultValue { get; set; }
		 

		/// <summary>
		/// Series labels are placed as close to the series as possible in anatural way, seeking to avoid other series. The goal of thisfeature is to make the chart more easily readable, like if ahuman designer placed the labels in the optimal position.The series labels currently work with series types having a`graph` or an `area`.Requires the `series-label.js` module.
		/// </summary>
		public StreamgraphSeriesSunburstLabel Label { get; set; }
		private StreamgraphSeriesSunburstLabel Label_DefaultValue { get; set; }
		...
		/// </summary>
		public StreamgraphSeriesSunburstStickyTracking StickyTracking { get; set; }
		private StreamgraphSeriesSunburstStickyTracking StickyTracking_DefaultValue { get; set; }
		 

		/// <summary>
		/// 
		/// </summary>
		public StreamgraphSeriesSunburstTooltip Tooltip { get; set; }
		private StreamgraphSeriesSunburstTooltip Tooltip_DefaultValue { get; set; }
		...
		/// 
		/// </summary>
		public StreamgraphSeriesSunburstStates States { get; set; }
		private StreamgraphSeriesSunburstStates States_DefaultValue { get; set; }
		...
		/// 
		/// </summary>
		public StreamgraphSeriesSunburstEvents Events { get; set; }
		private StreamgraphSeriesSunburstEvents Events_DefaultValue { get; set; }
		 

		/// <summary>
		/// 
		/// </summary>
		public StreamgraphSeriesSunburstPoint Point { get; set; }
		private StreamgraphSeriesSunburstPoint Point_DefaultValue { get; set; }
		...
		/// 
		/// </summary>
		public StreamgraphSeriesSunburstDataLabels DataLabels { get; set; }
		private StreamgraphSeriesSunburstDataLabels DataLabels_DefaultValue { get; set; }
		...
		/// </summary>
		public StreamgraphSeriesSunburstLevelIsConstant LevelIsConstant { get; set; }
		private StreamgraphSeriesSunburstLevelIsConstant LevelIsConstant_DefaultValue { get; set; }
