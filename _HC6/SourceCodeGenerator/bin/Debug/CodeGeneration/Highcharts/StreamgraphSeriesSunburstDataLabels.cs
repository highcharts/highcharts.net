...
{
	public partial class StreamgraphSeriesSunburstDataLabels  : BaseObject
	{
		public StreamgraphSeriesSunburstDataLabels()
		{
		...
		/// 
		/// </summary>
		public StreamgraphSeriesSunburstDataLabelsDefer Defer { get; set; }
		private StreamgraphSeriesSunburstDataLabelsDefer Defer_DefaultValue { get; set; }
		 

		/// <summary>
		/// 
		/// </summary>
		public StreamgraphSeriesSunburstDataLabelsStyle Style { get; set; }
		private StreamgraphSeriesSunburstDataLabelsStyle Style_DefaultValue { get; set; }
		...
		/// </summary>
		public StreamgraphSeriesSunburstDataLabelsRotationMode RotationMode { get; set; }
		private StreamgraphSeriesSunburstDataLabelsRotationMode RotationMode_DefaultValue { get; set; }
