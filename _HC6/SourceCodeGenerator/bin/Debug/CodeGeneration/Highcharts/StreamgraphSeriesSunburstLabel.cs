...
{
	public partial class StreamgraphSeriesSunburstLabel  : BaseObject
	{
		public StreamgraphSeriesSunburstLabel()
		{
		...
		/// </summary>
		public StreamgraphSeriesSunburstLabelEnabled Enabled { get; set; }
		private StreamgraphSeriesSunburstLabelEnabled Enabled_DefaultValue { get; set; }
		 

		/// <summary>
		/// Allow labels to be placed distant to the graph if necessary,and draw a connector line to the graph.
		/// </summary>
		public StreamgraphSeriesSunburstLabelConnectorAllowed ConnectorAllowed { get; set; }
		private StreamgraphSeriesSunburstLabelConnectorAllowed ConnectorAllowed_DefaultValue { get; set; }
		 

		/// <summary>
		/// If the label is closer than this to a neighbour graph, draw aconnector.
		/// </summary>
		public StreamgraphSeriesSunburstLabelConnectorNeighbourDistance ConnectorNeighbourDistance { get; set; }
		private StreamgraphSeriesSunburstLabelConnectorNeighbourDistance ConnectorNeighbourDistance_DefaultValue { get; set; }
		...
		/// </summary>
		public StreamgraphSeriesSunburstLabelStyle Style { get; set; }
		private StreamgraphSeriesSunburstLabelStyle Style_DefaultValue { get; set; }
