...
{
	public partial class StreamgraphSeriesWordcloud  : BaseObject
	{
		public StreamgraphSeriesWordcloud()
		{
			Data = Data_DefaultValue = new List<SeriesStreamgraphWordcloudData>();
		...
		/// </summary>
		public List<SeriesStreamgraphWordcloudData> Data { get; set; }
		private List<SeriesStreamgraphWordcloudData> Data_DefaultValue { get; set; }
		 

		/// <summary>
		/// Series labels are placed as close to the series as possible in anatural way, seeking to avoid other series. The goal of thisfeature is to make the chart more easily readable, like if ahuman designer placed the labels in the optimal position.The series labels currently work with series types having a`graph` or an `area`.Requires the `series-label.js` module.
		/// </summary>
		public StreamgraphSeriesWordcloudLabel Label { get; set; }
		private StreamgraphSeriesWordcloudLabel Label_DefaultValue { get; set; }
		...
		/// </summary>
		public StreamgraphSeriesWordcloudEvents Events { get; set; }
		private StreamgraphSeriesWordcloudEvents Events_DefaultValue { get; set; }
		 

		/// <summary>
		/// Properties for each single point.
		/// </summary>
		public StreamgraphSeriesWordcloudPoint Point { get; set; }
		private StreamgraphSeriesWordcloudPoint Point_DefaultValue { get; set; }
		...
		/// 
		/// </summary>
		public StreamgraphSeriesWordcloudStates States { get; set; }
		private StreamgraphSeriesWordcloudStates States_DefaultValue { get; set; }
		 

		/// <summary>
		/// 
		/// </summary>
		public StreamgraphSeriesWordcloudStickyTracking StickyTracking { get; set; }
		private StreamgraphSeriesWordcloudStickyTracking StickyTracking_DefaultValue { get; set; }
		...
		/// 
		/// </summary>
		public StreamgraphSeriesWordcloudBorderWidth BorderWidth { get; set; }
		private StreamgraphSeriesWordcloudBorderWidth BorderWidth_DefaultValue { get; set; }
		 

		/// <summary>
		/// 
		/// </summary>
		public StreamgraphSeriesWordcloudClip Clip { get; set; }
		private StreamgraphSeriesWordcloudClip Clip_DefaultValue { get; set; }
		...
		/// </summary>
		public StreamgraphSeriesWordcloudColorByPoint ColorByPoint { get; set; }
		private StreamgraphSeriesWordcloudColorByPoint ColorByPoint_DefaultValue { get; set; }
		...
		/// </summary>
		public StreamgraphSeriesWordcloudPlacementStrategy PlacementStrategy { get; set; }
		private StreamgraphSeriesWordcloudPlacementStrategy PlacementStrategy_DefaultValue { get; set; }
		 

		/// <summary>
		/// Rotation options for the words in the wordcloud.
		/// </summary>
		public StreamgraphSeriesWordcloudRotation Rotation { get; set; }
		private StreamgraphSeriesWordcloudRotation Rotation_DefaultValue { get; set; }
		 

		/// <summary>
		/// 
		/// </summary>
		public StreamgraphSeriesWordcloudShowInLegend ShowInLegend { get; set; }
		private StreamgraphSeriesWordcloudShowInLegend ShowInLegend_DefaultValue { get; set; }
		...
		/// </summary>
		public StreamgraphSeriesWordcloudSpiral Spiral { get; set; }
		private StreamgraphSeriesWordcloudSpiral Spiral_DefaultValue { get; set; }
		...
		/// 
		/// </summary>
		public StreamgraphSeriesWordcloudTooltip Tooltip { get; set; }
		private StreamgraphSeriesWordcloudTooltip Tooltip_DefaultValue { get; set; }
