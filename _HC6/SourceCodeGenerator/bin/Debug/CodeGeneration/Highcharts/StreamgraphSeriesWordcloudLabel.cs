...
{
	public partial class StreamgraphSeriesWordcloudLabel  : BaseObject
	{
		public StreamgraphSeriesWordcloudLabel()
		{
		...
		/// </summary>
		public StreamgraphSeriesWordcloudLabelEnabled Enabled { get; set; }
		private StreamgraphSeriesWordcloudLabelEnabled Enabled_DefaultValue { get; set; }
		 

		/// <summary>
		/// Allow labels to be placed distant to the graph if necessary,and draw a connector line to the graph.
		/// </summary>
		public StreamgraphSeriesWordcloudLabelConnectorAllowed ConnectorAllowed { get; set; }
		private StreamgraphSeriesWordcloudLabelConnectorAllowed ConnectorAllowed_DefaultValue { get; set; }
		 

		/// <summary>
		/// If the label is closer than this to a neighbour graph, draw aconnector.
		/// </summary>
		public StreamgraphSeriesWordcloudLabelConnectorNeighbourDistance ConnectorNeighbourDistance { get; set; }
		private StreamgraphSeriesWordcloudLabelConnectorNeighbourDistance ConnectorNeighbourDistance_DefaultValue { get; set; }
		...
		/// </summary>
		public StreamgraphSeriesWordcloudLabelStyle Style { get; set; }
		private StreamgraphSeriesWordcloudLabelStyle Style_DefaultValue { get; set; }
