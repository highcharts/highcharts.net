...
{
	public partial class SunburstSeriesLabel  : BaseObject
	{
		public SunburstSeriesLabel()
		{
			...
			Style = Style_DefaultValue = new SunburstSeriesLabelStyle();
		...
		/// </summary>
		public SunburstSeriesLabelEnabled Enabled { get; set; }
		private SunburstSeriesLabelEnabled Enabled_DefaultValue { get; set; }
		 

		/// <summary>
		/// Allow labels to be placed distant to the graph if necessary,and draw a connector line to the graph.
		/// </summary>
		public SunburstSeriesLabelConnectorAllowed ConnectorAllowed { get; set; }
		private SunburstSeriesLabelConnectorAllowed ConnectorAllowed_DefaultValue { get; set; }
		 

		/// <summary>
		/// If the label is closer than this to a neighbour graph, draw aconnector.
		/// </summary>
		public SunburstSeriesLabelConnectorNeighbourDistance ConnectorNeighbourDistance { get; set; }
		private SunburstSeriesLabelConnectorNeighbourDistance ConnectorNeighbourDistance_DefaultValue { get; set; }
		...
		/// </summary>
		public SunburstSeriesLabelStyle Style { get; set; }
		private SunburstSeriesLabelStyle Style_DefaultValue { get; set; }
