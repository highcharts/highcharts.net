...
{
	public partial class TilemapSeriesStatesHoverMarker  : BaseObject
	{
		public TilemapSeriesStatesHoverMarker()
		{
			LineWidth = LineWidth_DefaultValue = 0;
			LineColor = LineColor_DefaultValue = "#ffffff";
			Radius = Radius_DefaultValue = 4;
			States = States_DefaultValue = new TilemapSeriesStatesHoverMarkerStates();
		...
		/// </summary>
		public TilemapSeriesStatesHoverMarkerStates States { get; set; }
		private TilemapSeriesStatesHoverMarkerStates States_DefaultValue { get; set; }
