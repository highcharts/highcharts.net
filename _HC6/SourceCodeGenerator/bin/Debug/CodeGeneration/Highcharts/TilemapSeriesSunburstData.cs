...
{
	public partial class TilemapSeriesSunburstData  : BaseObject
	{
		public TilemapSeriesSunburstData()
		{
		...
		/// </summary>
		public TilemapSeriesSunburstDataEvents Events { get; set; }
		private TilemapSeriesSunburstDataEvents Events_DefaultValue { get; set; }
