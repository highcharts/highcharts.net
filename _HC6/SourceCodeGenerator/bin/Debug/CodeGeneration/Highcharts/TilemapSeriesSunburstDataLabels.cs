...
{
	public partial class TilemapSeriesSunburstDataLabels  : BaseObject
	{
		public TilemapSeriesSunburstDataLabels()
		{
		...
		/// 
		/// </summary>
		public TilemapSeriesSunburstDataLabelsDefer Defer { get; set; }
		private TilemapSeriesSunburstDataLabelsDefer Defer_DefaultValue { get; set; }
		 

		/// <summary>
		/// 
		/// </summary>
		public TilemapSeriesSunburstDataLabelsStyle Style { get; set; }
		private TilemapSeriesSunburstDataLabelsStyle Style_DefaultValue { get; set; }
		...
		/// </summary>
		public TilemapSeriesSunburstDataLabelsRotationMode RotationMode { get; set; }
		private TilemapSeriesSunburstDataLabelsRotationMode RotationMode_DefaultValue { get; set; }
