...
{
	public partial class TilemapSeriesSunburstLabel  : BaseObject
	{
		public TilemapSeriesSunburstLabel()
		{
		...
		/// </summary>
		public TilemapSeriesSunburstLabelEnabled Enabled { get; set; }
		private TilemapSeriesSunburstLabelEnabled Enabled_DefaultValue { get; set; }
		 

		/// <summary>
		/// Allow labels to be placed distant to the graph if necessary,and draw a connector line to the graph.
		/// </summary>
		public TilemapSeriesSunburstLabelConnectorAllowed ConnectorAllowed { get; set; }
		private TilemapSeriesSunburstLabelConnectorAllowed ConnectorAllowed_DefaultValue { get; set; }
		 

		/// <summary>
		/// If the label is closer than this to a neighbour graph, draw aconnector.
		/// </summary>
		public TilemapSeriesSunburstLabelConnectorNeighbourDistance ConnectorNeighbourDistance { get; set; }
		private TilemapSeriesSunburstLabelConnectorNeighbourDistance ConnectorNeighbourDistance_DefaultValue { get; set; }
		...
		/// </summary>
		public TilemapSeriesSunburstLabelStyle Style { get; set; }
		private TilemapSeriesSunburstLabelStyle Style_DefaultValue { get; set; }
