...
{
	public partial class TilemapSeriesWordcloud  : BaseObject
	{
		public TilemapSeriesWordcloud()
		{
			Data = Data_DefaultValue = new List<SeriesTilemapWordcloudData>();
		...
		/// </summary>
		public List<SeriesTilemapWordcloudData> Data { get; set; }
		private List<SeriesTilemapWordcloudData> Data_DefaultValue { get; set; }
		 

		/// <summary>
		/// Series labels are placed as close to the series as possible in anatural way, seeking to avoid other series. The goal of thisfeature is to make the chart more easily readable, like if ahuman designer placed the labels in the optimal position.The series labels currently work with series types having a`graph` or an `area`.Requires the `series-label.js` module.
		/// </summary>
		public TilemapSeriesWordcloudLabel Label { get; set; }
		private TilemapSeriesWordcloudLabel Label_DefaultValue { get; set; }
		...
		/// </summary>
		public TilemapSeriesWordcloudEvents Events { get; set; }
		private TilemapSeriesWordcloudEvents Events_DefaultValue { get; set; }
		 

		/// <summary>
		/// Properties for each single point.
		/// </summary>
		public TilemapSeriesWordcloudPoint Point { get; set; }
		private TilemapSeriesWordcloudPoint Point_DefaultValue { get; set; }
		...
		/// 
		/// </summary>
		public TilemapSeriesWordcloudStates States { get; set; }
		private TilemapSeriesWordcloudStates States_DefaultValue { get; set; }
		 

		/// <summary>
		/// 
		/// </summary>
		public TilemapSeriesWordcloudStickyTracking StickyTracking { get; set; }
		private TilemapSeriesWordcloudStickyTracking StickyTracking_DefaultValue { get; set; }
		...
		/// 
		/// </summary>
		public TilemapSeriesWordcloudBorderWidth BorderWidth { get; set; }
		private TilemapSeriesWordcloudBorderWidth BorderWidth_DefaultValue { get; set; }
		 

		/// <summary>
		/// 
		/// </summary>
		public TilemapSeriesWordcloudClip Clip { get; set; }
		private TilemapSeriesWordcloudClip Clip_DefaultValue { get; set; }
		...
		/// </summary>
		public TilemapSeriesWordcloudColorByPoint ColorByPoint { get; set; }
		private TilemapSeriesWordcloudColorByPoint ColorByPoint_DefaultValue { get; set; }
		...
		/// </summary>
		public TilemapSeriesWordcloudPlacementStrategy PlacementStrategy { get; set; }
		private TilemapSeriesWordcloudPlacementStrategy PlacementStrategy_DefaultValue { get; set; }
		 

		/// <summary>
		/// Rotation options for the words in the wordcloud.
		/// </summary>
		public TilemapSeriesWordcloudRotation Rotation { get; set; }
		private TilemapSeriesWordcloudRotation Rotation_DefaultValue { get; set; }
		 

		/// <summary>
		/// 
		/// </summary>
		public TilemapSeriesWordcloudShowInLegend ShowInLegend { get; set; }
		private TilemapSeriesWordcloudShowInLegend ShowInLegend_DefaultValue { get; set; }
		...
		/// </summary>
		public TilemapSeriesWordcloudSpiral Spiral { get; set; }
		private TilemapSeriesWordcloudSpiral Spiral_DefaultValue { get; set; }
		...
		/// 
		/// </summary>
		public TilemapSeriesWordcloudTooltip Tooltip { get; set; }
		private TilemapSeriesWordcloudTooltip Tooltip_DefaultValue { get; set; }
