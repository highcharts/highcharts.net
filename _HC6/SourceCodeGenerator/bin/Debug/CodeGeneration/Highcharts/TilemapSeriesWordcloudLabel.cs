...
{
	public partial class TilemapSeriesWordcloudLabel  : BaseObject
	{
		public TilemapSeriesWordcloudLabel()
		{
		...
		/// </summary>
		public TilemapSeriesWordcloudLabelEnabled Enabled { get; set; }
		private TilemapSeriesWordcloudLabelEnabled Enabled_DefaultValue { get; set; }
		 

		/// <summary>
		/// Allow labels to be placed distant to the graph if necessary,and draw a connector line to the graph.
		/// </summary>
		public TilemapSeriesWordcloudLabelConnectorAllowed ConnectorAllowed { get; set; }
		private TilemapSeriesWordcloudLabelConnectorAllowed ConnectorAllowed_DefaultValue { get; set; }
		 

		/// <summary>
		/// If the label is closer than this to a neighbour graph, draw aconnector.
		/// </summary>
		public TilemapSeriesWordcloudLabelConnectorNeighbourDistance ConnectorNeighbourDistance { get; set; }
		private TilemapSeriesWordcloudLabelConnectorNeighbourDistance ConnectorNeighbourDistance_DefaultValue { get; set; }
		...
		/// </summary>
		public TilemapSeriesWordcloudLabelStyle Style { get; set; }
		private TilemapSeriesWordcloudLabelStyle Style_DefaultValue { get; set; }
