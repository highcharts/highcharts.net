...
{
	public partial class TreemapSeriesLabel  : BaseObject
	{
		public TreemapSeriesLabel()
		{
			...
			Style = Style_DefaultValue = new TreemapSeriesLabelStyle();
		...
		/// </summary>
		public TreemapSeriesLabelEnabled Enabled { get; set; }
		private TreemapSeriesLabelEnabled Enabled_DefaultValue { get; set; }
		 

		/// <summary>
		/// Allow labels to be placed distant to the graph if necessary,and draw a connector line to the graph.
		/// </summary>
		public TreemapSeriesLabelConnectorAllowed ConnectorAllowed { get; set; }
		private TreemapSeriesLabelConnectorAllowed ConnectorAllowed_DefaultValue { get; set; }
		 

		/// <summary>
		/// If the label is closer than this to a neighbour graph, draw aconnector.
		/// </summary>
		public TreemapSeriesLabelConnectorNeighbourDistance ConnectorNeighbourDistance { get; set; }
		private TreemapSeriesLabelConnectorNeighbourDistance ConnectorNeighbourDistance_DefaultValue { get; set; }
		...
		/// </summary>
		public TreemapSeriesLabelStyle Style { get; set; }
		private TreemapSeriesLabelStyle Style_DefaultValue { get; set; }
