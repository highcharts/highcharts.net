...
{
	public partial class TreemapSeriesSunburst  : BaseObject
	{
		public TreemapSeriesSunburst()
		{
			Data = Data_DefaultValue = new List<SeriesTreemapSunburstData>();
		...
		/// 
		/// </summary>
		public List<SeriesTreemapSunburstData> Data { get; set; }
		private List<SeriesTreemapSunburstData> Data_DefaultValue { get; set; }
		 

		/// <summary>
		/// Series labels are placed as close to the series as possible in anatural way, seeking to avoid other series. The goal of thisfeature is to make the chart more easily readable, like if ahuman designer placed the labels in the optimal position.The series labels currently work with series types having a`graph` or an `area`.Requires the `series-label.js` module.
		/// </summary>
		public TreemapSeriesSunburstLabel Label { get; set; }
		private TreemapSeriesSunburstLabel Label_DefaultValue { get; set; }
		...
		/// </summary>
		public TreemapSeriesSunburstStickyTracking StickyTracking { get; set; }
		private TreemapSeriesSunburstStickyTracking StickyTracking_DefaultValue { get; set; }
		 

		/// <summary>
		/// 
		/// </summary>
		public TreemapSeriesSunburstTooltip Tooltip { get; set; }
		private TreemapSeriesSunburstTooltip Tooltip_DefaultValue { get; set; }
		...
		/// 
		/// </summary>
		public TreemapSeriesSunburstStates States { get; set; }
		private TreemapSeriesSunburstStates States_DefaultValue { get; set; }
		...
		/// 
		/// </summary>
		public TreemapSeriesSunburstEvents Events { get; set; }
		private TreemapSeriesSunburstEvents Events_DefaultValue { get; set; }
		 

		/// <summary>
		/// 
		/// </summary>
		public TreemapSeriesSunburstPoint Point { get; set; }
		private TreemapSeriesSunburstPoint Point_DefaultValue { get; set; }
		...
		/// 
		/// </summary>
		public TreemapSeriesSunburstDataLabels DataLabels { get; set; }
		private TreemapSeriesSunburstDataLabels DataLabels_DefaultValue { get; set; }
		...
		/// </summary>
		public TreemapSeriesSunburstLevelIsConstant LevelIsConstant { get; set; }
		private TreemapSeriesSunburstLevelIsConstant LevelIsConstant_DefaultValue { get; set; }
