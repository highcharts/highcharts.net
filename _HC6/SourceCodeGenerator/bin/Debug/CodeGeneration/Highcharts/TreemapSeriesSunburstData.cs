...
{
	public partial class TreemapSeriesSunburstData  : BaseObject
	{
		public TreemapSeriesSunburstData()
		{
		...
		/// </summary>
		public TreemapSeriesSunburstDataEvents Events { get; set; }
		private TreemapSeriesSunburstDataEvents Events_DefaultValue { get; set; }
