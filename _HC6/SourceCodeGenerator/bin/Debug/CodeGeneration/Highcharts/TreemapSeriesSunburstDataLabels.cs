...
{
	public partial class TreemapSeriesSunburstDataLabels  : BaseObject
	{
		public TreemapSeriesSunburstDataLabels()
		{
		...
		/// 
		/// </summary>
		public TreemapSeriesSunburstDataLabelsDefer Defer { get; set; }
		private TreemapSeriesSunburstDataLabelsDefer Defer_DefaultValue { get; set; }
		 

		/// <summary>
		/// 
		/// </summary>
		public TreemapSeriesSunburstDataLabelsStyle Style { get; set; }
		private TreemapSeriesSunburstDataLabelsStyle Style_DefaultValue { get; set; }
		...
		/// </summary>
		public TreemapSeriesSunburstDataLabelsRotationMode RotationMode { get; set; }
		private TreemapSeriesSunburstDataLabelsRotationMode RotationMode_DefaultValue { get; set; }
