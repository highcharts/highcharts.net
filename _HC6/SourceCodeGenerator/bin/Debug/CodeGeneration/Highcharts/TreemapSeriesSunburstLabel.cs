...
{
	public partial class TreemapSeriesSunburstLabel  : BaseObject
	{
		public TreemapSeriesSunburstLabel()
		{
		...
		/// </summary>
		public TreemapSeriesSunburstLabelEnabled Enabled { get; set; }
		private TreemapSeriesSunburstLabelEnabled Enabled_DefaultValue { get; set; }
		 

		/// <summary>
		/// Allow labels to be placed distant to the graph if necessary,and draw a connector line to the graph.
		/// </summary>
		public TreemapSeriesSunburstLabelConnectorAllowed ConnectorAllowed { get; set; }
		private TreemapSeriesSunburstLabelConnectorAllowed ConnectorAllowed_DefaultValue { get; set; }
		 

		/// <summary>
		/// If the label is closer than this to a neighbour graph, draw aconnector.
		/// </summary>
		public TreemapSeriesSunburstLabelConnectorNeighbourDistance ConnectorNeighbourDistance { get; set; }
		private TreemapSeriesSunburstLabelConnectorNeighbourDistance ConnectorNeighbourDistance_DefaultValue { get; set; }
		...
		/// </summary>
		public TreemapSeriesSunburstLabelStyle Style { get; set; }
		private TreemapSeriesSunburstLabelStyle Style_DefaultValue { get; set; }
