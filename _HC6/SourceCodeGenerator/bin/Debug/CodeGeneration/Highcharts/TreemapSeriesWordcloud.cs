...
{
	public partial class TreemapSeriesWordcloud  : BaseObject
	{
		public TreemapSeriesWordcloud()
		{
			Data = Data_DefaultValue = new List<SeriesTreemapWordcloudData>();
		...
		/// </summary>
		public List<SeriesTreemapWordcloudData> Data { get; set; }
		private List<SeriesTreemapWordcloudData> Data_DefaultValue { get; set; }
		 

		/// <summary>
		/// Series labels are placed as close to the series as possible in anatural way, seeking to avoid other series. The goal of thisfeature is to make the chart more easily readable, like if ahuman designer placed the labels in the optimal position.The series labels currently work with series types having a`graph` or an `area`.Requires the `series-label.js` module.
		/// </summary>
		public TreemapSeriesWordcloudLabel Label { get; set; }
		private TreemapSeriesWordcloudLabel Label_DefaultValue { get; set; }
		...
		/// </summary>
		public TreemapSeriesWordcloudEvents Events { get; set; }
		private TreemapSeriesWordcloudEvents Events_DefaultValue { get; set; }
		 

		/// <summary>
		/// Properties for each single point.
		/// </summary>
		public TreemapSeriesWordcloudPoint Point { get; set; }
		private TreemapSeriesWordcloudPoint Point_DefaultValue { get; set; }
		...
		/// 
		/// </summary>
		public TreemapSeriesWordcloudStates States { get; set; }
		private TreemapSeriesWordcloudStates States_DefaultValue { get; set; }
		 

		/// <summary>
		/// 
		/// </summary>
		public TreemapSeriesWordcloudStickyTracking StickyTracking { get; set; }
		private TreemapSeriesWordcloudStickyTracking StickyTracking_DefaultValue { get; set; }
		...
		/// 
		/// </summary>
		public TreemapSeriesWordcloudBorderWidth BorderWidth { get; set; }
		private TreemapSeriesWordcloudBorderWidth BorderWidth_DefaultValue { get; set; }
		 

		/// <summary>
		/// 
		/// </summary>
		public TreemapSeriesWordcloudClip Clip { get; set; }
		private TreemapSeriesWordcloudClip Clip_DefaultValue { get; set; }
		...
		/// </summary>
		public TreemapSeriesWordcloudColorByPoint ColorByPoint { get; set; }
		private TreemapSeriesWordcloudColorByPoint ColorByPoint_DefaultValue { get; set; }
		...
		/// </summary>
		public TreemapSeriesWordcloudPlacementStrategy PlacementStrategy { get; set; }
		private TreemapSeriesWordcloudPlacementStrategy PlacementStrategy_DefaultValue { get; set; }
		 

		/// <summary>
		/// Rotation options for the words in the wordcloud.
		/// </summary>
		public TreemapSeriesWordcloudRotation Rotation { get; set; }
		private TreemapSeriesWordcloudRotation Rotation_DefaultValue { get; set; }
		 

		/// <summary>
		/// 
		/// </summary>
		public TreemapSeriesWordcloudShowInLegend ShowInLegend { get; set; }
		private TreemapSeriesWordcloudShowInLegend ShowInLegend_DefaultValue { get; set; }
		...
		/// </summary>
		public TreemapSeriesWordcloudSpiral Spiral { get; set; }
		private TreemapSeriesWordcloudSpiral Spiral_DefaultValue { get; set; }
		...
		/// 
		/// </summary>
		public TreemapSeriesWordcloudTooltip Tooltip { get; set; }
		private TreemapSeriesWordcloudTooltip Tooltip_DefaultValue { get; set; }
