...
{
	public partial class TreemapSeriesWordcloudLabel  : BaseObject
	{
		public TreemapSeriesWordcloudLabel()
		{
		...
		/// </summary>
		public TreemapSeriesWordcloudLabelEnabled Enabled { get; set; }
		private TreemapSeriesWordcloudLabelEnabled Enabled_DefaultValue { get; set; }
		 

		/// <summary>
		/// Allow labels to be placed distant to the graph if necessary,and draw a connector line to the graph.
		/// </summary>
		public TreemapSeriesWordcloudLabelConnectorAllowed ConnectorAllowed { get; set; }
		private TreemapSeriesWordcloudLabelConnectorAllowed ConnectorAllowed_DefaultValue { get; set; }
		 

		/// <summary>
		/// If the label is closer than this to a neighbour graph, draw aconnector.
		/// </summary>
		public TreemapSeriesWordcloudLabelConnectorNeighbourDistance ConnectorNeighbourDistance { get; set; }
		private TreemapSeriesWordcloudLabelConnectorNeighbourDistance ConnectorNeighbourDistance_DefaultValue { get; set; }
		...
		/// </summary>
		public TreemapSeriesWordcloudLabelStyle Style { get; set; }
		private TreemapSeriesWordcloudLabelStyle Style_DefaultValue { get; set; }
