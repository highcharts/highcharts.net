...
{
	public partial class VariablepieSeriesSunburst  : BaseObject
	{
		public VariablepieSeriesSunburst()
		{
			Data = Data_DefaultValue = new List<SeriesVariablepieSunburstData>();
		...
		/// 
		/// </summary>
		public List<SeriesVariablepieSunburstData> Data { get; set; }
		private List<SeriesVariablepieSunburstData> Data_DefaultValue { get; set; }
		 

		/// <summary>
		/// Series labels are placed as close to the series as possible in anatural way, seeking to avoid other series. The goal of thisfeature is to make the chart more easily readable, like if ahuman designer placed the labels in the optimal position.The series labels currently work with series types having a`graph` or an `area`.Requires the `series-label.js` module.
		/// </summary>
		public VariablepieSeriesSunburstLabel Label { get; set; }
		private VariablepieSeriesSunburstLabel Label_DefaultValue { get; set; }
		...
		/// </summary>
		public VariablepieSeriesSunburstStickyTracking StickyTracking { get; set; }
		private VariablepieSeriesSunburstStickyTracking StickyTracking_DefaultValue { get; set; }
		 

		/// <summary>
		/// 
		/// </summary>
		public VariablepieSeriesSunburstTooltip Tooltip { get; set; }
		private VariablepieSeriesSunburstTooltip Tooltip_DefaultValue { get; set; }
		...
		/// 
		/// </summary>
		public VariablepieSeriesSunburstStates States { get; set; }
		private VariablepieSeriesSunburstStates States_DefaultValue { get; set; }
		...
		/// 
		/// </summary>
		public VariablepieSeriesSunburstEvents Events { get; set; }
		private VariablepieSeriesSunburstEvents Events_DefaultValue { get; set; }
		 

		/// <summary>
		/// 
		/// </summary>
		public VariablepieSeriesSunburstPoint Point { get; set; }
		private VariablepieSeriesSunburstPoint Point_DefaultValue { get; set; }
		...
		/// 
		/// </summary>
		public VariablepieSeriesSunburstDataLabels DataLabels { get; set; }
		private VariablepieSeriesSunburstDataLabels DataLabels_DefaultValue { get; set; }
		...
		/// </summary>
		public VariablepieSeriesSunburstLevelIsConstant LevelIsConstant { get; set; }
		private VariablepieSeriesSunburstLevelIsConstant LevelIsConstant_DefaultValue { get; set; }
