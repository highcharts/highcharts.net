...
{
	public partial class VariablepieSeriesSunburstDataLabels  : BaseObject
	{
		public VariablepieSeriesSunburstDataLabels()
		{
		...
		/// 
		/// </summary>
		public VariablepieSeriesSunburstDataLabelsDefer Defer { get; set; }
		private VariablepieSeriesSunburstDataLabelsDefer Defer_DefaultValue { get; set; }
		 

		/// <summary>
		/// 
		/// </summary>
		public VariablepieSeriesSunburstDataLabelsStyle Style { get; set; }
		private VariablepieSeriesSunburstDataLabelsStyle Style_DefaultValue { get; set; }
		...
		/// </summary>
		public VariablepieSeriesSunburstDataLabelsRotationMode RotationMode { get; set; }
		private VariablepieSeriesSunburstDataLabelsRotationMode RotationMode_DefaultValue { get; set; }
