...
{
	public partial class VariablepieSeriesSunburstLabel  : BaseObject
	{
		public VariablepieSeriesSunburstLabel()
		{
		...
		/// </summary>
		public VariablepieSeriesSunburstLabelEnabled Enabled { get; set; }
		private VariablepieSeriesSunburstLabelEnabled Enabled_DefaultValue { get; set; }
		 

		/// <summary>
		/// Allow labels to be placed distant to the graph if necessary,and draw a connector line to the graph.
		/// </summary>
		public VariablepieSeriesSunburstLabelConnectorAllowed ConnectorAllowed { get; set; }
		private VariablepieSeriesSunburstLabelConnectorAllowed ConnectorAllowed_DefaultValue { get; set; }
		 

		/// <summary>
		/// If the label is closer than this to a neighbour graph, draw aconnector.
		/// </summary>
		public VariablepieSeriesSunburstLabelConnectorNeighbourDistance ConnectorNeighbourDistance { get; set; }
		private VariablepieSeriesSunburstLabelConnectorNeighbourDistance ConnectorNeighbourDistance_DefaultValue { get; set; }
		...
		/// </summary>
		public VariablepieSeriesSunburstLabelStyle Style { get; set; }
		private VariablepieSeriesSunburstLabelStyle Style_DefaultValue { get; set; }
