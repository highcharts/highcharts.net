...
{
	public partial class VariablepieSeriesWordcloud  : BaseObject
	{
		public VariablepieSeriesWordcloud()
		{
			Data = Data_DefaultValue = new List<SeriesVariablepieWordcloudData>();
		...
		/// </summary>
		public List<SeriesVariablepieWordcloudData> Data { get; set; }
		private List<SeriesVariablepieWordcloudData> Data_DefaultValue { get; set; }
		 

		/// <summary>
		/// Series labels are placed as close to the series as possible in anatural way, seeking to avoid other series. The goal of thisfeature is to make the chart more easily readable, like if ahuman designer placed the labels in the optimal position.The series labels currently work with series types having a`graph` or an `area`.Requires the `series-label.js` module.
		/// </summary>
		public VariablepieSeriesWordcloudLabel Label { get; set; }
		private VariablepieSeriesWordcloudLabel Label_DefaultValue { get; set; }
		...
		/// </summary>
		public VariablepieSeriesWordcloudEvents Events { get; set; }
		private VariablepieSeriesWordcloudEvents Events_DefaultValue { get; set; }
		 

		/// <summary>
		/// Properties for each single point.
		/// </summary>
		public VariablepieSeriesWordcloudPoint Point { get; set; }
		private VariablepieSeriesWordcloudPoint Point_DefaultValue { get; set; }
		...
		/// 
		/// </summary>
		public VariablepieSeriesWordcloudStates States { get; set; }
		private VariablepieSeriesWordcloudStates States_DefaultValue { get; set; }
		 

		/// <summary>
		/// 
		/// </summary>
		public VariablepieSeriesWordcloudStickyTracking StickyTracking { get; set; }
		private VariablepieSeriesWordcloudStickyTracking StickyTracking_DefaultValue { get; set; }
		...
		/// 
		/// </summary>
		public VariablepieSeriesWordcloudBorderWidth BorderWidth { get; set; }
		private VariablepieSeriesWordcloudBorderWidth BorderWidth_DefaultValue { get; set; }
		 

		/// <summary>
		/// 
		/// </summary>
		public VariablepieSeriesWordcloudClip Clip { get; set; }
		private VariablepieSeriesWordcloudClip Clip_DefaultValue { get; set; }
		...
		/// </summary>
		public VariablepieSeriesWordcloudColorByPoint ColorByPoint { get; set; }
		private VariablepieSeriesWordcloudColorByPoint ColorByPoint_DefaultValue { get; set; }
		...
		/// </summary>
		public VariablepieSeriesWordcloudPlacementStrategy PlacementStrategy { get; set; }
		private VariablepieSeriesWordcloudPlacementStrategy PlacementStrategy_DefaultValue { get; set; }
		 

		/// <summary>
		/// Rotation options for the words in the wordcloud.
		/// </summary>
		public VariablepieSeriesWordcloudRotation Rotation { get; set; }
		private VariablepieSeriesWordcloudRotation Rotation_DefaultValue { get; set; }
		 

		/// <summary>
		/// 
		/// </summary>
		public VariablepieSeriesWordcloudShowInLegend ShowInLegend { get; set; }
		private VariablepieSeriesWordcloudShowInLegend ShowInLegend_DefaultValue { get; set; }
		...
		/// </summary>
		public VariablepieSeriesWordcloudSpiral Spiral { get; set; }
		private VariablepieSeriesWordcloudSpiral Spiral_DefaultValue { get; set; }
		...
		/// 
		/// </summary>
		public VariablepieSeriesWordcloudTooltip Tooltip { get; set; }
		private VariablepieSeriesWordcloudTooltip Tooltip_DefaultValue { get; set; }
