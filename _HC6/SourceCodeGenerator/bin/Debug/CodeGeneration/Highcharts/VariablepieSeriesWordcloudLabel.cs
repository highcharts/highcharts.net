...
{
	public partial class VariablepieSeriesWordcloudLabel  : BaseObject
	{
		public VariablepieSeriesWordcloudLabel()
		{
		...
		/// </summary>
		public VariablepieSeriesWordcloudLabelEnabled Enabled { get; set; }
		private VariablepieSeriesWordcloudLabelEnabled Enabled_DefaultValue { get; set; }
		 

		/// <summary>
		/// Allow labels to be placed distant to the graph if necessary,and draw a connector line to the graph.
		/// </summary>
		public VariablepieSeriesWordcloudLabelConnectorAllowed ConnectorAllowed { get; set; }
		private VariablepieSeriesWordcloudLabelConnectorAllowed ConnectorAllowed_DefaultValue { get; set; }
		 

		/// <summary>
		/// If the label is closer than this to a neighbour graph, draw aconnector.
		/// </summary>
		public VariablepieSeriesWordcloudLabelConnectorNeighbourDistance ConnectorNeighbourDistance { get; set; }
		private VariablepieSeriesWordcloudLabelConnectorNeighbourDistance ConnectorNeighbourDistance_DefaultValue { get; set; }
		...
		/// </summary>
		public VariablepieSeriesWordcloudLabelStyle Style { get; set; }
		private VariablepieSeriesWordcloudLabelStyle Style_DefaultValue { get; set; }
