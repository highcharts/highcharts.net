...
namespace Highsoft.Web.Mvc.Charts
{
	public partial class VariwideSeries  : Series
	{
		...
		/// </summary>
		public VariwideSeriesSunburst Sunburst { get; set; }
		private VariwideSeriesSunburst Sunburst_DefaultValue { get; set; }
		...
		/// </summary>
		public VariwideSeriesWordcloud Wordcloud { get; set; }
		private VariwideSeriesWordcloud Wordcloud_DefaultValue { get; set; }
		...
		/// 
		/// </summary>
		public VariwideSeriesStickyTracking StickyTracking { get; set; }
		private VariwideSeriesStickyTracking StickyTracking_DefaultValue { get; set; }
		...
		/// </summary>
		public VariwideSeriesPointPadding PointPadding { get; set; }
		private VariwideSeriesPointPadding PointPadding_DefaultValue { get; set; }
		 

		/// <summary>
		/// In a variwide chart, the group padding is 0 in order to express the horizontal stacking of items.
		/// </summary>
		public VariwideSeriesGroupPadding GroupPadding { get; set; }
		private VariwideSeriesGroupPadding GroupPadding_DefaultValue { get; set; }
