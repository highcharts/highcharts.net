...
{
	public partial class VariwideSeriesLabel  : BaseObject
	{
		public VariwideSeriesLabel()
		{
		...
		/// </summary>
		public VariwideSeriesLabelEnabled Enabled { get; set; }
		private VariwideSeriesLabelEnabled Enabled_DefaultValue { get; set; }
		 

		/// <summary>
		/// Allow labels to be placed distant to the graph if necessary,and draw a connector line to the graph.
		/// </summary>
		public VariwideSeriesLabelConnectorAllowed ConnectorAllowed { get; set; }
		private VariwideSeriesLabelConnectorAllowed ConnectorAllowed_DefaultValue { get; set; }
		 

		/// <summary>
		/// If the label is closer than this to a neighbour graph, draw aconnector.
		/// </summary>
		public VariwideSeriesLabelConnectorNeighbourDistance ConnectorNeighbourDistance { get; set; }
		private VariwideSeriesLabelConnectorNeighbourDistance ConnectorNeighbourDistance_DefaultValue { get; set; }
		...
		/// </summary>
		public VariwideSeriesLabelStyle Style { get; set; }
		private VariwideSeriesLabelStyle Style_DefaultValue { get; set; }
