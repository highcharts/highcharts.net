...
{
	public partial class VariwideSeriesSunburst  : BaseObject
	{
		public VariwideSeriesSunburst()
		{
			Data = Data_DefaultValue = new List<SeriesVariwideSunburstData>();
		...
		/// 
		/// </summary>
		public List<SeriesVariwideSunburstData> Data { get; set; }
		private List<SeriesVariwideSunburstData> Data_DefaultValue { get; set; }
		 

		/// <summary>
		/// Series labels are placed as close to the series as possible in anatural way, seeking to avoid other series. The goal of thisfeature is to make the chart more easily readable, like if ahuman designer placed the labels in the optimal position.The series labels currently work with series types having a`graph` or an `area`.Requires the `series-label.js` module.
		/// </summary>
		public VariwideSeriesSunburstLabel Label { get; set; }
		private VariwideSeriesSunburstLabel Label_DefaultValue { get; set; }
		...
		/// </summary>
		public VariwideSeriesSunburstStickyTracking StickyTracking { get; set; }
		private VariwideSeriesSunburstStickyTracking StickyTracking_DefaultValue { get; set; }
		 

		/// <summary>
		/// 
		/// </summary>
		public VariwideSeriesSunburstTooltip Tooltip { get; set; }
		private VariwideSeriesSunburstTooltip Tooltip_DefaultValue { get; set; }
		...
		/// 
		/// </summary>
		public VariwideSeriesSunburstStates States { get; set; }
		private VariwideSeriesSunburstStates States_DefaultValue { get; set; }
		...
		/// 
		/// </summary>
		public VariwideSeriesSunburstEvents Events { get; set; }
		private VariwideSeriesSunburstEvents Events_DefaultValue { get; set; }
		 

		/// <summary>
		/// 
		/// </summary>
		public VariwideSeriesSunburstPoint Point { get; set; }
		private VariwideSeriesSunburstPoint Point_DefaultValue { get; set; }
		...
		/// 
		/// </summary>
		public VariwideSeriesSunburstDataLabels DataLabels { get; set; }
		private VariwideSeriesSunburstDataLabels DataLabels_DefaultValue { get; set; }
		...
		/// </summary>
		public VariwideSeriesSunburstLevelIsConstant LevelIsConstant { get; set; }
		private VariwideSeriesSunburstLevelIsConstant LevelIsConstant_DefaultValue { get; set; }
