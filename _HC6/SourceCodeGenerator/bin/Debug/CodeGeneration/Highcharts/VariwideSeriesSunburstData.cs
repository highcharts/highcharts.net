...
{
	public partial class VariwideSeriesSunburstData  : BaseObject
	{
		public VariwideSeriesSunburstData()
		{
		...
		/// </summary>
		public VariwideSeriesSunburstDataEvents Events { get; set; }
		private VariwideSeriesSunburstDataEvents Events_DefaultValue { get; set; }
