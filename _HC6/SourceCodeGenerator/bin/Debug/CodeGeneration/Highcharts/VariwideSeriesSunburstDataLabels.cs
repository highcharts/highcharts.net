...
{
	public partial class VariwideSeriesSunburstDataLabels  : BaseObject
	{
		public VariwideSeriesSunburstDataLabels()
		{
		...
		/// 
		/// </summary>
		public VariwideSeriesSunburstDataLabelsDefer Defer { get; set; }
		private VariwideSeriesSunburstDataLabelsDefer Defer_DefaultValue { get; set; }
		 

		/// <summary>
		/// 
		/// </summary>
		public VariwideSeriesSunburstDataLabelsStyle Style { get; set; }
		private VariwideSeriesSunburstDataLabelsStyle Style_DefaultValue { get; set; }
		...
		/// </summary>
		public VariwideSeriesSunburstDataLabelsRotationMode RotationMode { get; set; }
		private VariwideSeriesSunburstDataLabelsRotationMode RotationMode_DefaultValue { get; set; }
