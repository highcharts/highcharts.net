...
{
	public partial class VariwideSeriesSunburstLabel  : BaseObject
	{
		public VariwideSeriesSunburstLabel()
		{
		...
		/// </summary>
		public VariwideSeriesSunburstLabelEnabled Enabled { get; set; }
		private VariwideSeriesSunburstLabelEnabled Enabled_DefaultValue { get; set; }
		 

		/// <summary>
		/// Allow labels to be placed distant to the graph if necessary,and draw a connector line to the graph.
		/// </summary>
		public VariwideSeriesSunburstLabelConnectorAllowed ConnectorAllowed { get; set; }
		private VariwideSeriesSunburstLabelConnectorAllowed ConnectorAllowed_DefaultValue { get; set; }
		 

		/// <summary>
		/// If the label is closer than this to a neighbour graph, draw aconnector.
		/// </summary>
		public VariwideSeriesSunburstLabelConnectorNeighbourDistance ConnectorNeighbourDistance { get; set; }
		private VariwideSeriesSunburstLabelConnectorNeighbourDistance ConnectorNeighbourDistance_DefaultValue { get; set; }
		...
		/// </summary>
		public VariwideSeriesSunburstLabelStyle Style { get; set; }
		private VariwideSeriesSunburstLabelStyle Style_DefaultValue { get; set; }
