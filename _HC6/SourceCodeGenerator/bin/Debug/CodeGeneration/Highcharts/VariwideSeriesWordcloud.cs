...
{
	public partial class VariwideSeriesWordcloud  : BaseObject
	{
		public VariwideSeriesWordcloud()
		{
			Data = Data_DefaultValue = new List<SeriesVariwideWordcloudData>();
		...
		/// </summary>
		public List<SeriesVariwideWordcloudData> Data { get; set; }
		private List<SeriesVariwideWordcloudData> Data_DefaultValue { get; set; }
		 

		/// <summary>
		/// Series labels are placed as close to the series as possible in anatural way, seeking to avoid other series. The goal of thisfeature is to make the chart more easily readable, like if ahuman designer placed the labels in the optimal position.The series labels currently work with series types having a`graph` or an `area`.Requires the `series-label.js` module.
		/// </summary>
		public VariwideSeriesWordcloudLabel Label { get; set; }
		private VariwideSeriesWordcloudLabel Label_DefaultValue { get; set; }
		...
		/// </summary>
		public VariwideSeriesWordcloudEvents Events { get; set; }
		private VariwideSeriesWordcloudEvents Events_DefaultValue { get; set; }
		 

		/// <summary>
		/// Properties for each single point.
		/// </summary>
		public VariwideSeriesWordcloudPoint Point { get; set; }
		private VariwideSeriesWordcloudPoint Point_DefaultValue { get; set; }
		...
		/// 
		/// </summary>
		public VariwideSeriesWordcloudStates States { get; set; }
		private VariwideSeriesWordcloudStates States_DefaultValue { get; set; }
		 

		/// <summary>
		/// 
		/// </summary>
		public VariwideSeriesWordcloudStickyTracking StickyTracking { get; set; }
		private VariwideSeriesWordcloudStickyTracking StickyTracking_DefaultValue { get; set; }
		...
		/// 
		/// </summary>
		public VariwideSeriesWordcloudBorderWidth BorderWidth { get; set; }
		private VariwideSeriesWordcloudBorderWidth BorderWidth_DefaultValue { get; set; }
		 

		/// <summary>
		/// 
		/// </summary>
		public VariwideSeriesWordcloudClip Clip { get; set; }
		private VariwideSeriesWordcloudClip Clip_DefaultValue { get; set; }
		...
		/// </summary>
		public VariwideSeriesWordcloudColorByPoint ColorByPoint { get; set; }
		private VariwideSeriesWordcloudColorByPoint ColorByPoint_DefaultValue { get; set; }
		...
		/// </summary>
		public VariwideSeriesWordcloudPlacementStrategy PlacementStrategy { get; set; }
		private VariwideSeriesWordcloudPlacementStrategy PlacementStrategy_DefaultValue { get; set; }
		 

		/// <summary>
		/// Rotation options for the words in the wordcloud.
		/// </summary>
		public VariwideSeriesWordcloudRotation Rotation { get; set; }
		private VariwideSeriesWordcloudRotation Rotation_DefaultValue { get; set; }
		 

		/// <summary>
		/// 
		/// </summary>
		public VariwideSeriesWordcloudShowInLegend ShowInLegend { get; set; }
		private VariwideSeriesWordcloudShowInLegend ShowInLegend_DefaultValue { get; set; }
		...
		/// </summary>
		public VariwideSeriesWordcloudSpiral Spiral { get; set; }
		private VariwideSeriesWordcloudSpiral Spiral_DefaultValue { get; set; }
		...
		/// 
		/// </summary>
		public VariwideSeriesWordcloudTooltip Tooltip { get; set; }
		private VariwideSeriesWordcloudTooltip Tooltip_DefaultValue { get; set; }
