...
{
	public partial class VariwideSeriesWordcloudLabel  : BaseObject
	{
		public VariwideSeriesWordcloudLabel()
		{
		...
		/// </summary>
		public VariwideSeriesWordcloudLabelEnabled Enabled { get; set; }
		private VariwideSeriesWordcloudLabelEnabled Enabled_DefaultValue { get; set; }
		 

		/// <summary>
		/// Allow labels to be placed distant to the graph if necessary,and draw a connector line to the graph.
		/// </summary>
		public VariwideSeriesWordcloudLabelConnectorAllowed ConnectorAllowed { get; set; }
		private VariwideSeriesWordcloudLabelConnectorAllowed ConnectorAllowed_DefaultValue { get; set; }
		 

		/// <summary>
		/// If the label is closer than this to a neighbour graph, draw aconnector.
		/// </summary>
		public VariwideSeriesWordcloudLabelConnectorNeighbourDistance ConnectorNeighbourDistance { get; set; }
		private VariwideSeriesWordcloudLabelConnectorNeighbourDistance ConnectorNeighbourDistance_DefaultValue { get; set; }
		...
		/// </summary>
		public VariwideSeriesWordcloudLabelStyle Style { get; set; }
		private VariwideSeriesWordcloudLabelStyle Style_DefaultValue { get; set; }
