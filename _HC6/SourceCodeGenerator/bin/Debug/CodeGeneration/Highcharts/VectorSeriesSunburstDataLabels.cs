...
{
	public partial class VectorSeriesSunburstDataLabels  : BaseObject
	{
		public VectorSeriesSunburstDataLabels()
		{
		...
		/// 
		/// </summary>
		public VectorSeriesSunburstDataLabelsDefer Defer { get; set; }
		private VectorSeriesSunburstDataLabelsDefer Defer_DefaultValue { get; set; }
		 

		/// <summary>
		/// 
		/// </summary>
		public VectorSeriesSunburstDataLabelsStyle Style { get; set; }
		private VectorSeriesSunburstDataLabelsStyle Style_DefaultValue { get; set; }
		...
		/// </summary>
		public VectorSeriesSunburstDataLabelsRotationMode RotationMode { get; set; }
		private VectorSeriesSunburstDataLabelsRotationMode RotationMode_DefaultValue { get; set; }
