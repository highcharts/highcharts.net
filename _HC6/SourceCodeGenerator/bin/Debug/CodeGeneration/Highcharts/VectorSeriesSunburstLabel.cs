...
{
	public partial class VectorSeriesSunburstLabel  : BaseObject
	{
		public VectorSeriesSunburstLabel()
		{
		...
		/// </summary>
		public VectorSeriesSunburstLabelEnabled Enabled { get; set; }
		private VectorSeriesSunburstLabelEnabled Enabled_DefaultValue { get; set; }
		 

		/// <summary>
		/// Allow labels to be placed distant to the graph if necessary,and draw a connector line to the graph.
		/// </summary>
		public VectorSeriesSunburstLabelConnectorAllowed ConnectorAllowed { get; set; }
		private VectorSeriesSunburstLabelConnectorAllowed ConnectorAllowed_DefaultValue { get; set; }
		 

		/// <summary>
		/// If the label is closer than this to a neighbour graph, draw aconnector.
		/// </summary>
		public VectorSeriesSunburstLabelConnectorNeighbourDistance ConnectorNeighbourDistance { get; set; }
		private VectorSeriesSunburstLabelConnectorNeighbourDistance ConnectorNeighbourDistance_DefaultValue { get; set; }
		...
		/// </summary>
		public VectorSeriesSunburstLabelStyle Style { get; set; }
		private VectorSeriesSunburstLabelStyle Style_DefaultValue { get; set; }
