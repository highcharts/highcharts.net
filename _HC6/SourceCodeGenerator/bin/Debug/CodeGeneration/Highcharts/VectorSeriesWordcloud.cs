...
{
	public partial class VectorSeriesWordcloud  : BaseObject
	{
		public VectorSeriesWordcloud()
		{
			Data = Data_DefaultValue = new List<SeriesVectorWordcloudData>();
		...
		/// </summary>
		public List<SeriesVectorWordcloudData> Data { get; set; }
		private List<SeriesVectorWordcloudData> Data_DefaultValue { get; set; }
		 

		/// <summary>
		/// Series labels are placed as close to the series as possible in anatural way, seeking to avoid other series. The goal of thisfeature is to make the chart more easily readable, like if ahuman designer placed the labels in the optimal position.The series labels currently work with series types having a`graph` or an `area`.Requires the `series-label.js` module.
		/// </summary>
		public VectorSeriesWordcloudLabel Label { get; set; }
		private VectorSeriesWordcloudLabel Label_DefaultValue { get; set; }
		...
		/// </summary>
		public VectorSeriesWordcloudEvents Events { get; set; }
		private VectorSeriesWordcloudEvents Events_DefaultValue { get; set; }
		 

		/// <summary>
		/// Properties for each single point.
		/// </summary>
		public VectorSeriesWordcloudPoint Point { get; set; }
		private VectorSeriesWordcloudPoint Point_DefaultValue { get; set; }
		...
		/// 
		/// </summary>
		public VectorSeriesWordcloudStates States { get; set; }
		private VectorSeriesWordcloudStates States_DefaultValue { get; set; }
		 

		/// <summary>
		/// 
		/// </summary>
		public VectorSeriesWordcloudStickyTracking StickyTracking { get; set; }
		private VectorSeriesWordcloudStickyTracking StickyTracking_DefaultValue { get; set; }
		...
		/// 
		/// </summary>
		public VectorSeriesWordcloudBorderWidth BorderWidth { get; set; }
		private VectorSeriesWordcloudBorderWidth BorderWidth_DefaultValue { get; set; }
		 

		/// <summary>
		/// 
		/// </summary>
		public VectorSeriesWordcloudClip Clip { get; set; }
		private VectorSeriesWordcloudClip Clip_DefaultValue { get; set; }
		...
		/// </summary>
		public VectorSeriesWordcloudColorByPoint ColorByPoint { get; set; }
		private VectorSeriesWordcloudColorByPoint ColorByPoint_DefaultValue { get; set; }
		...
		/// </summary>
		public VectorSeriesWordcloudPlacementStrategy PlacementStrategy { get; set; }
		private VectorSeriesWordcloudPlacementStrategy PlacementStrategy_DefaultValue { get; set; }
		 

		/// <summary>
		/// Rotation options for the words in the wordcloud.
		/// </summary>
		public VectorSeriesWordcloudRotation Rotation { get; set; }
		private VectorSeriesWordcloudRotation Rotation_DefaultValue { get; set; }
		 

		/// <summary>
		/// 
		/// </summary>
		public VectorSeriesWordcloudShowInLegend ShowInLegend { get; set; }
		private VectorSeriesWordcloudShowInLegend ShowInLegend_DefaultValue { get; set; }
		...
		/// </summary>
		public VectorSeriesWordcloudSpiral Spiral { get; set; }
		private VectorSeriesWordcloudSpiral Spiral_DefaultValue { get; set; }
		...
		/// 
		/// </summary>
		public VectorSeriesWordcloudTooltip Tooltip { get; set; }
		private VectorSeriesWordcloudTooltip Tooltip_DefaultValue { get; set; }
