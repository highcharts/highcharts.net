...
{
	public partial class VectorSeriesWordcloudLabel  : BaseObject
	{
		public VectorSeriesWordcloudLabel()
		{
		...
		/// </summary>
		public VectorSeriesWordcloudLabelEnabled Enabled { get; set; }
		private VectorSeriesWordcloudLabelEnabled Enabled_DefaultValue { get; set; }
		 

		/// <summary>
		/// Allow labels to be placed distant to the graph if necessary,and draw a connector line to the graph.
		/// </summary>
		public VectorSeriesWordcloudLabelConnectorAllowed ConnectorAllowed { get; set; }
		private VectorSeriesWordcloudLabelConnectorAllowed ConnectorAllowed_DefaultValue { get; set; }
		 

		/// <summary>
		/// If the label is closer than this to a neighbour graph, draw aconnector.
		/// </summary>
		public VectorSeriesWordcloudLabelConnectorNeighbourDistance ConnectorNeighbourDistance { get; set; }
		private VectorSeriesWordcloudLabelConnectorNeighbourDistance ConnectorNeighbourDistance_DefaultValue { get; set; }
		...
		/// </summary>
		public VectorSeriesWordcloudLabelStyle Style { get; set; }
		private VectorSeriesWordcloudLabelStyle Style_DefaultValue { get; set; }
