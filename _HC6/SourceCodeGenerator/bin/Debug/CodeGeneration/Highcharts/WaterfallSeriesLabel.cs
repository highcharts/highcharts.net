...
namespace Highsoft.Web.Mvc.Charts
{
	public partial class WaterfallSeriesLabel  : BaseObject
	{
		...
		/// </summary>
		public WaterfallSeriesLabelEnabled Enabled { get; set; }
		private WaterfallSeriesLabelEnabled Enabled_DefaultValue { get; set; }
		 

		/// <summary>
		/// Allow labels to be placed distant to the graph if necessary,and draw a connector line to the graph.
		/// </summary>
		public WaterfallSeriesLabelConnectorAllowed ConnectorAllowed { get; set; }
		private WaterfallSeriesLabelConnectorAllowed ConnectorAllowed_DefaultValue { get; set; }
		 

		/// <summary>
		/// If the label is closer than this to a neighbour graph, draw aconnector.
		/// </summary>
		public WaterfallSeriesLabelConnectorNeighbourDistance ConnectorNeighbourDistance { get; set; }
		private WaterfallSeriesLabelConnectorNeighbourDistance ConnectorNeighbourDistance_DefaultValue { get; set; }
		...
		/// </summary>
		public WaterfallSeriesLabelStyle Style { get; set; }
		private WaterfallSeriesLabelStyle Style_DefaultValue { get; set; }
