...
{
	public partial class WaterfallSeriesSunburst  : BaseObject
	{
		public WaterfallSeriesSunburst()
		{
			Data = Data_DefaultValue = new List<SeriesWaterfallSunburstData>();
		...
		/// 
		/// </summary>
		public List<SeriesWaterfallSunburstData> Data { get; set; }
		private List<SeriesWaterfallSunburstData> Data_DefaultValue { get; set; }
		 

		/// <summary>
		/// Series labels are placed as close to the series as possible in anatural way, seeking to avoid other series. The goal of thisfeature is to make the chart more easily readable, like if ahuman designer placed the labels in the optimal position.The series labels currently work with series types having a`graph` or an `area`.Requires the `series-label.js` module.
		/// </summary>
		public WaterfallSeriesSunburstLabel Label { get; set; }
		private WaterfallSeriesSunburstLabel Label_DefaultValue { get; set; }
		...
		/// </summary>
		public WaterfallSeriesSunburstStickyTracking StickyTracking { get; set; }
		private WaterfallSeriesSunburstStickyTracking StickyTracking_DefaultValue { get; set; }
		 

		/// <summary>
		/// 
		/// </summary>
		public WaterfallSeriesSunburstTooltip Tooltip { get; set; }
		private WaterfallSeriesSunburstTooltip Tooltip_DefaultValue { get; set; }
		...
		/// 
		/// </summary>
		public WaterfallSeriesSunburstStates States { get; set; }
		private WaterfallSeriesSunburstStates States_DefaultValue { get; set; }
		...
		/// 
		/// </summary>
		public WaterfallSeriesSunburstEvents Events { get; set; }
		private WaterfallSeriesSunburstEvents Events_DefaultValue { get; set; }
		 

		/// <summary>
		/// 
		/// </summary>
		public WaterfallSeriesSunburstPoint Point { get; set; }
		private WaterfallSeriesSunburstPoint Point_DefaultValue { get; set; }
		...
		/// 
		/// </summary>
		public WaterfallSeriesSunburstDataLabels DataLabels { get; set; }
		private WaterfallSeriesSunburstDataLabels DataLabels_DefaultValue { get; set; }
		...
		/// </summary>
		public WaterfallSeriesSunburstLevelIsConstant LevelIsConstant { get; set; }
		private WaterfallSeriesSunburstLevelIsConstant LevelIsConstant_DefaultValue { get; set; }
