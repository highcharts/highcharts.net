...
{
	public partial class WaterfallSeriesSunburstData  : BaseObject
	{
		public WaterfallSeriesSunburstData()
		{
		...
		/// </summary>
		public WaterfallSeriesSunburstDataEvents Events { get; set; }
		private WaterfallSeriesSunburstDataEvents Events_DefaultValue { get; set; }
