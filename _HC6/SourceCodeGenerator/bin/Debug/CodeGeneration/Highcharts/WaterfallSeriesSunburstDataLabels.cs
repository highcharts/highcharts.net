...
{
	public partial class WaterfallSeriesSunburstDataLabels  : BaseObject
	{
		public WaterfallSeriesSunburstDataLabels()
		{
		...
		/// 
		/// </summary>
		public WaterfallSeriesSunburstDataLabelsDefer Defer { get; set; }
		private WaterfallSeriesSunburstDataLabelsDefer Defer_DefaultValue { get; set; }
		 

		/// <summary>
		/// 
		/// </summary>
		public WaterfallSeriesSunburstDataLabelsStyle Style { get; set; }
		private WaterfallSeriesSunburstDataLabelsStyle Style_DefaultValue { get; set; }
		...
		/// </summary>
		public WaterfallSeriesSunburstDataLabelsRotationMode RotationMode { get; set; }
		private WaterfallSeriesSunburstDataLabelsRotationMode RotationMode_DefaultValue { get; set; }
