...
{
	public partial class WaterfallSeriesSunburstLabel  : BaseObject
	{
		public WaterfallSeriesSunburstLabel()
		{
		...
		/// </summary>
		public WaterfallSeriesSunburstLabelEnabled Enabled { get; set; }
		private WaterfallSeriesSunburstLabelEnabled Enabled_DefaultValue { get; set; }
		 

		/// <summary>
		/// Allow labels to be placed distant to the graph if necessary,and draw a connector line to the graph.
		/// </summary>
		public WaterfallSeriesSunburstLabelConnectorAllowed ConnectorAllowed { get; set; }
		private WaterfallSeriesSunburstLabelConnectorAllowed ConnectorAllowed_DefaultValue { get; set; }
		 

		/// <summary>
		/// If the label is closer than this to a neighbour graph, draw aconnector.
		/// </summary>
		public WaterfallSeriesSunburstLabelConnectorNeighbourDistance ConnectorNeighbourDistance { get; set; }
		private WaterfallSeriesSunburstLabelConnectorNeighbourDistance ConnectorNeighbourDistance_DefaultValue { get; set; }
		...
		/// </summary>
		public WaterfallSeriesSunburstLabelStyle Style { get; set; }
		private WaterfallSeriesSunburstLabelStyle Style_DefaultValue { get; set; }
