...
{
	public partial class WaterfallSeriesWordcloud  : BaseObject
	{
		public WaterfallSeriesWordcloud()
		{
			Data = Data_DefaultValue = new List<SeriesWaterfallWordcloudData>();
		...
		/// </summary>
		public List<SeriesWaterfallWordcloudData> Data { get; set; }
		private List<SeriesWaterfallWordcloudData> Data_DefaultValue { get; set; }
		 

		/// <summary>
		/// Series labels are placed as close to the series as possible in anatural way, seeking to avoid other series. The goal of thisfeature is to make the chart more easily readable, like if ahuman designer placed the labels in the optimal position.The series labels currently work with series types having a`graph` or an `area`.Requires the `series-label.js` module.
		/// </summary>
		public WaterfallSeriesWordcloudLabel Label { get; set; }
		private WaterfallSeriesWordcloudLabel Label_DefaultValue { get; set; }
		...
		/// </summary>
		public WaterfallSeriesWordcloudEvents Events { get; set; }
		private WaterfallSeriesWordcloudEvents Events_DefaultValue { get; set; }
		 

		/// <summary>
		/// Properties for each single point.
		/// </summary>
		public WaterfallSeriesWordcloudPoint Point { get; set; }
		private WaterfallSeriesWordcloudPoint Point_DefaultValue { get; set; }
		...
		/// 
		/// </summary>
		public WaterfallSeriesWordcloudStates States { get; set; }
		private WaterfallSeriesWordcloudStates States_DefaultValue { get; set; }
		 

		/// <summary>
		/// 
		/// </summary>
		public WaterfallSeriesWordcloudStickyTracking StickyTracking { get; set; }
		private WaterfallSeriesWordcloudStickyTracking StickyTracking_DefaultValue { get; set; }
		...
		/// 
		/// </summary>
		public WaterfallSeriesWordcloudBorderWidth BorderWidth { get; set; }
		private WaterfallSeriesWordcloudBorderWidth BorderWidth_DefaultValue { get; set; }
		 

		/// <summary>
		/// 
		/// </summary>
		public WaterfallSeriesWordcloudClip Clip { get; set; }
		private WaterfallSeriesWordcloudClip Clip_DefaultValue { get; set; }
		...
		/// </summary>
		public WaterfallSeriesWordcloudColorByPoint ColorByPoint { get; set; }
		private WaterfallSeriesWordcloudColorByPoint ColorByPoint_DefaultValue { get; set; }
		...
		/// </summary>
		public WaterfallSeriesWordcloudPlacementStrategy PlacementStrategy { get; set; }
		private WaterfallSeriesWordcloudPlacementStrategy PlacementStrategy_DefaultValue { get; set; }
		 

		/// <summary>
		/// Rotation options for the words in the wordcloud.
		/// </summary>
		public WaterfallSeriesWordcloudRotation Rotation { get; set; }
		private WaterfallSeriesWordcloudRotation Rotation_DefaultValue { get; set; }
		 

		/// <summary>
		/// 
		/// </summary>
		public WaterfallSeriesWordcloudShowInLegend ShowInLegend { get; set; }
		private WaterfallSeriesWordcloudShowInLegend ShowInLegend_DefaultValue { get; set; }
		...
		/// </summary>
		public WaterfallSeriesWordcloudSpiral Spiral { get; set; }
		private WaterfallSeriesWordcloudSpiral Spiral_DefaultValue { get; set; }
		...
		/// 
		/// </summary>
		public WaterfallSeriesWordcloudTooltip Tooltip { get; set; }
		private WaterfallSeriesWordcloudTooltip Tooltip_DefaultValue { get; set; }
