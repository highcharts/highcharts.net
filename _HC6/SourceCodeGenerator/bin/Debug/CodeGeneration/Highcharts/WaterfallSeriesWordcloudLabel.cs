...
{
	public partial class WaterfallSeriesWordcloudLabel  : BaseObject
	{
		public WaterfallSeriesWordcloudLabel()
		{
		...
		/// </summary>
		public WaterfallSeriesWordcloudLabelEnabled Enabled { get; set; }
		private WaterfallSeriesWordcloudLabelEnabled Enabled_DefaultValue { get; set; }
		 

		/// <summary>
		/// Allow labels to be placed distant to the graph if necessary,and draw a connector line to the graph.
		/// </summary>
		public WaterfallSeriesWordcloudLabelConnectorAllowed ConnectorAllowed { get; set; }
		private WaterfallSeriesWordcloudLabelConnectorAllowed ConnectorAllowed_DefaultValue { get; set; }
		 

		/// <summary>
		/// If the label is closer than this to a neighbour graph, draw aconnector.
		/// </summary>
		public WaterfallSeriesWordcloudLabelConnectorNeighbourDistance ConnectorNeighbourDistance { get; set; }
		private WaterfallSeriesWordcloudLabelConnectorNeighbourDistance ConnectorNeighbourDistance_DefaultValue { get; set; }
		...
		/// </summary>
		public WaterfallSeriesWordcloudLabelStyle Style { get; set; }
		private WaterfallSeriesWordcloudLabelStyle Style_DefaultValue { get; set; }
