...
namespace Highsoft.Web.Mvc.Charts
{
	public partial class WindbarbSeries  : Series
	{
		...
		/// </summary>
		public WindbarbSeriesSunburst Sunburst { get; set; }
		private WindbarbSeriesSunburst Sunburst_DefaultValue { get; set; }
		...
		/// </summary>
		public WindbarbSeriesWordcloud Wordcloud { get; set; }
		private WindbarbSeriesWordcloud Wordcloud_DefaultValue { get; set; }
		...
		/// 
		/// </summary>
		public WindbarbSeriesStickyTracking StickyTracking { get; set; }
		private WindbarbSeriesStickyTracking StickyTracking_DefaultValue { get; set; }
