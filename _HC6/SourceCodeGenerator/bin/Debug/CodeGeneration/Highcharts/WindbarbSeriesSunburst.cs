...
{
	public partial class WindbarbSeriesSunburst  : BaseObject
	{
		public WindbarbSeriesSunburst()
		{
			Data = Data_DefaultValue = new List<SeriesWindbarbSunburstData>();
		...
		/// 
		/// </summary>
		public List<SeriesWindbarbSunburstData> Data { get; set; }
		private List<SeriesWindbarbSunburstData> Data_DefaultValue { get; set; }
		 

		/// <summary>
		/// Series labels are placed as close to the series as possible in anatural way, seeking to avoid other series. The goal of thisfeature is to make the chart more easily readable, like if ahuman designer placed the labels in the optimal position.The series labels currently work with series types having a`graph` or an `area`.Requires the `series-label.js` module.
		/// </summary>
		public WindbarbSeriesSunburstLabel Label { get; set; }
		private WindbarbSeriesSunburstLabel Label_DefaultValue { get; set; }
		...
		/// </summary>
		public WindbarbSeriesSunburstStickyTracking StickyTracking { get; set; }
		private WindbarbSeriesSunburstStickyTracking StickyTracking_DefaultValue { get; set; }
		 

		/// <summary>
		/// 
		/// </summary>
		public WindbarbSeriesSunburstTooltip Tooltip { get; set; }
		private WindbarbSeriesSunburstTooltip Tooltip_DefaultValue { get; set; }
		...
		/// 
		/// </summary>
		public WindbarbSeriesSunburstStates States { get; set; }
		private WindbarbSeriesSunburstStates States_DefaultValue { get; set; }
		...
		/// 
		/// </summary>
		public WindbarbSeriesSunburstEvents Events { get; set; }
		private WindbarbSeriesSunburstEvents Events_DefaultValue { get; set; }
		 

		/// <summary>
		/// 
		/// </summary>
		public WindbarbSeriesSunburstPoint Point { get; set; }
		private WindbarbSeriesSunburstPoint Point_DefaultValue { get; set; }
		...
		/// 
		/// </summary>
		public WindbarbSeriesSunburstDataLabels DataLabels { get; set; }
		private WindbarbSeriesSunburstDataLabels DataLabels_DefaultValue { get; set; }
		...
		/// </summary>
		public WindbarbSeriesSunburstLevelIsConstant LevelIsConstant { get; set; }
		private WindbarbSeriesSunburstLevelIsConstant LevelIsConstant_DefaultValue { get; set; }
