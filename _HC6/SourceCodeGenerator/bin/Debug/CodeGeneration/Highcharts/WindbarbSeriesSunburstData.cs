...
{
	public partial class WindbarbSeriesSunburstData  : BaseObject
	{
		public WindbarbSeriesSunburstData()
		{
		...
		/// </summary>
		public WindbarbSeriesSunburstDataEvents Events { get; set; }
		private WindbarbSeriesSunburstDataEvents Events_DefaultValue { get; set; }
