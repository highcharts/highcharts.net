...
{
	public partial class WindbarbSeriesSunburstDataLabels  : BaseObject
	{
		public WindbarbSeriesSunburstDataLabels()
		{
		...
		/// 
		/// </summary>
		public WindbarbSeriesSunburstDataLabelsDefer Defer { get; set; }
		private WindbarbSeriesSunburstDataLabelsDefer Defer_DefaultValue { get; set; }
		 

		/// <summary>
		/// 
		/// </summary>
		public WindbarbSeriesSunburstDataLabelsStyle Style { get; set; }
		private WindbarbSeriesSunburstDataLabelsStyle Style_DefaultValue { get; set; }
		...
		/// </summary>
		public WindbarbSeriesSunburstDataLabelsRotationMode RotationMode { get; set; }
		private WindbarbSeriesSunburstDataLabelsRotationMode RotationMode_DefaultValue { get; set; }
