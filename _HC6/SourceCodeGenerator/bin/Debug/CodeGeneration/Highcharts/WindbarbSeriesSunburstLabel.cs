...
{
	public partial class WindbarbSeriesSunburstLabel  : BaseObject
	{
		public WindbarbSeriesSunburstLabel()
		{
		...
		/// </summary>
		public WindbarbSeriesSunburstLabelEnabled Enabled { get; set; }
		private WindbarbSeriesSunburstLabelEnabled Enabled_DefaultValue { get; set; }
		 

		/// <summary>
		/// Allow labels to be placed distant to the graph if necessary,and draw a connector line to the graph.
		/// </summary>
		public WindbarbSeriesSunburstLabelConnectorAllowed ConnectorAllowed { get; set; }
		private WindbarbSeriesSunburstLabelConnectorAllowed ConnectorAllowed_DefaultValue { get; set; }
		 

		/// <summary>
		/// If the label is closer than this to a neighbour graph, draw aconnector.
		/// </summary>
		public WindbarbSeriesSunburstLabelConnectorNeighbourDistance ConnectorNeighbourDistance { get; set; }
		private WindbarbSeriesSunburstLabelConnectorNeighbourDistance ConnectorNeighbourDistance_DefaultValue { get; set; }
		...
		/// </summary>
		public WindbarbSeriesSunburstLabelStyle Style { get; set; }
		private WindbarbSeriesSunburstLabelStyle Style_DefaultValue { get; set; }
