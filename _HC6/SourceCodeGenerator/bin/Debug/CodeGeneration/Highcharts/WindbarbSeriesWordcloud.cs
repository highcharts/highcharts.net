...
{
	public partial class WindbarbSeriesWordcloud  : BaseObject
	{
		public WindbarbSeriesWordcloud()
		{
			Data = Data_DefaultValue = new List<SeriesWindbarbWordcloudData>();
		...
		/// </summary>
		public List<SeriesWindbarbWordcloudData> Data { get; set; }
		private List<SeriesWindbarbWordcloudData> Data_DefaultValue { get; set; }
		 

		/// <summary>
		/// Series labels are placed as close to the series as possible in anatural way, seeking to avoid other series. The goal of thisfeature is to make the chart more easily readable, like if ahuman designer placed the labels in the optimal position.The series labels currently work with series types having a`graph` or an `area`.Requires the `series-label.js` module.
		/// </summary>
		public WindbarbSeriesWordcloudLabel Label { get; set; }
		private WindbarbSeriesWordcloudLabel Label_DefaultValue { get; set; }
		...
		/// </summary>
		public WindbarbSeriesWordcloudEvents Events { get; set; }
		private WindbarbSeriesWordcloudEvents Events_DefaultValue { get; set; }
		 

		/// <summary>
		/// Properties for each single point.
		/// </summary>
		public WindbarbSeriesWordcloudPoint Point { get; set; }
		private WindbarbSeriesWordcloudPoint Point_DefaultValue { get; set; }
		...
		/// 
		/// </summary>
		public WindbarbSeriesWordcloudStates States { get; set; }
		private WindbarbSeriesWordcloudStates States_DefaultValue { get; set; }
		 

		/// <summary>
		/// 
		/// </summary>
		public WindbarbSeriesWordcloudStickyTracking StickyTracking { get; set; }
		private WindbarbSeriesWordcloudStickyTracking StickyTracking_DefaultValue { get; set; }
		...
		/// 
		/// </summary>
		public WindbarbSeriesWordcloudBorderWidth BorderWidth { get; set; }
		private WindbarbSeriesWordcloudBorderWidth BorderWidth_DefaultValue { get; set; }
		 

		/// <summary>
		/// 
		/// </summary>
		public WindbarbSeriesWordcloudClip Clip { get; set; }
		private WindbarbSeriesWordcloudClip Clip_DefaultValue { get; set; }
		...
		/// </summary>
		public WindbarbSeriesWordcloudColorByPoint ColorByPoint { get; set; }
		private WindbarbSeriesWordcloudColorByPoint ColorByPoint_DefaultValue { get; set; }
		...
		/// </summary>
		public WindbarbSeriesWordcloudPlacementStrategy PlacementStrategy { get; set; }
		private WindbarbSeriesWordcloudPlacementStrategy PlacementStrategy_DefaultValue { get; set; }
		 

		/// <summary>
		/// Rotation options for the words in the wordcloud.
		/// </summary>
		public WindbarbSeriesWordcloudRotation Rotation { get; set; }
		private WindbarbSeriesWordcloudRotation Rotation_DefaultValue { get; set; }
		 

		/// <summary>
		/// 
		/// </summary>
		public WindbarbSeriesWordcloudShowInLegend ShowInLegend { get; set; }
		private WindbarbSeriesWordcloudShowInLegend ShowInLegend_DefaultValue { get; set; }
		...
		/// </summary>
		public WindbarbSeriesWordcloudSpiral Spiral { get; set; }
		private WindbarbSeriesWordcloudSpiral Spiral_DefaultValue { get; set; }
		...
		/// 
		/// </summary>
		public WindbarbSeriesWordcloudTooltip Tooltip { get; set; }
		private WindbarbSeriesWordcloudTooltip Tooltip_DefaultValue { get; set; }
