...
{
	public partial class WindbarbSeriesWordcloudLabel  : BaseObject
	{
		public WindbarbSeriesWordcloudLabel()
		{
		...
		/// </summary>
		public WindbarbSeriesWordcloudLabelEnabled Enabled { get; set; }
		private WindbarbSeriesWordcloudLabelEnabled Enabled_DefaultValue { get; set; }
		 

		/// <summary>
		/// Allow labels to be placed distant to the graph if necessary,and draw a connector line to the graph.
		/// </summary>
		public WindbarbSeriesWordcloudLabelConnectorAllowed ConnectorAllowed { get; set; }
		private WindbarbSeriesWordcloudLabelConnectorAllowed ConnectorAllowed_DefaultValue { get; set; }
		 

		/// <summary>
		/// If the label is closer than this to a neighbour graph, draw aconnector.
		/// </summary>
		public WindbarbSeriesWordcloudLabelConnectorNeighbourDistance ConnectorNeighbourDistance { get; set; }
		private WindbarbSeriesWordcloudLabelConnectorNeighbourDistance ConnectorNeighbourDistance_DefaultValue { get; set; }
		...
		/// </summary>
		public WindbarbSeriesWordcloudLabelStyle Style { get; set; }
		private WindbarbSeriesWordcloudLabelStyle Style_DefaultValue { get; set; }
