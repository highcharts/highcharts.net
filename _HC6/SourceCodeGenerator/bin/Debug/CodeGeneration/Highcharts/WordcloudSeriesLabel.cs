...
{
	public partial class WordcloudSeriesLabel  : BaseObject
	{
		public WordcloudSeriesLabel()
		{
		...
		/// </summary>
		public WordcloudSeriesLabelEnabled Enabled { get; set; }
		private WordcloudSeriesLabelEnabled Enabled_DefaultValue { get; set; }
		 

		/// <summary>
		/// Allow labels to be placed distant to the graph if necessary,and draw a connector line to the graph.
		/// </summary>
		public WordcloudSeriesLabelConnectorAllowed ConnectorAllowed { get; set; }
		private WordcloudSeriesLabelConnectorAllowed ConnectorAllowed_DefaultValue { get; set; }
		 

		/// <summary>
		/// If the label is closer than this to a neighbour graph, draw aconnector.
		/// </summary>
		public WordcloudSeriesLabelConnectorNeighbourDistance ConnectorNeighbourDistance { get; set; }
		private WordcloudSeriesLabelConnectorNeighbourDistance ConnectorNeighbourDistance_DefaultValue { get; set; }
