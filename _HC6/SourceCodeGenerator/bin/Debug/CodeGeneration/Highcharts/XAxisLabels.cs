...
namespace Highsoft.Web.Mvc.Charts
{
	public partial class XAxisLabels  : BaseObject
	{
		...
		/// </summary>
		public XAxisLabelsEnabled Enabled { get; set; }
		private XAxisLabelsEnabled Enabled_DefaultValue { get; set; }
		...
		/// </summary>
		public XAxisLabelsX X { get; set; }
		private XAxisLabelsX X_DefaultValue { get; set; }
		...
		/// </summary>
		public XAxisLabelsPosition3d Position3d { get; set; }
		private XAxisLabelsPosition3d Position3d_DefaultValue { get; set; }
		...
		/// </summary>
		public XAxisLabelsSkew3d Skew3d { get; set; }
		private XAxisLabelsSkew3d Skew3d_DefaultValue { get; set; }
