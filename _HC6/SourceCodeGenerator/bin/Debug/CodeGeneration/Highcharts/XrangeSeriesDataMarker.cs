...
{
	public partial class XrangeSeriesDataMarker  : BaseObject
	{
		public XrangeSeriesDataMarker()
		{
			...
			States = States_DefaultValue = new XrangeSeriesDataMarkerStates();
		...
		/// </summary>
		public XrangeSeriesDataMarkerStates States { get; set; }
		private XrangeSeriesDataMarkerStates States_DefaultValue { get; set; }
