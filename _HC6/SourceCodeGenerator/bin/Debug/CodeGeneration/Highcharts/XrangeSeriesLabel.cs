...
{
	public partial class XrangeSeriesLabel  : BaseObject
	{
		public XrangeSeriesLabel()
		{
			...
			Style = Style_DefaultValue = new XrangeSeriesLabelStyle();
		...
		/// </summary>
		public XrangeSeriesLabelEnabled Enabled { get; set; }
		private XrangeSeriesLabelEnabled Enabled_DefaultValue { get; set; }
		 

		/// <summary>
		/// Allow labels to be placed distant to the graph if necessary,and draw a connector line to the graph.
		/// </summary>
		public XrangeSeriesLabelConnectorAllowed ConnectorAllowed { get; set; }
		private XrangeSeriesLabelConnectorAllowed ConnectorAllowed_DefaultValue { get; set; }
		 

		/// <summary>
		/// If the label is closer than this to a neighbour graph, draw aconnector.
		/// </summary>
		public XrangeSeriesLabelConnectorNeighbourDistance ConnectorNeighbourDistance { get; set; }
		private XrangeSeriesLabelConnectorNeighbourDistance ConnectorNeighbourDistance_DefaultValue { get; set; }
		...
		/// </summary>
		public XrangeSeriesLabelStyle Style { get; set; }
		private XrangeSeriesLabelStyle Style_DefaultValue { get; set; }
