...
{
	public partial class XrangeSeriesSunburst  : BaseObject
	{
		public XrangeSeriesSunburst()
		{
			Data = Data_DefaultValue = new List<SeriesXrangeSunburstData>();
		...
		/// 
		/// </summary>
		public List<SeriesXrangeSunburstData> Data { get; set; }
		private List<SeriesXrangeSunburstData> Data_DefaultValue { get; set; }
		 

		/// <summary>
		/// Series labels are placed as close to the series as possible in anatural way, seeking to avoid other series. The goal of thisfeature is to make the chart more easily readable, like if ahuman designer placed the labels in the optimal position.The series labels currently work with series types having a`graph` or an `area`.Requires the `series-label.js` module.
		/// </summary>
		public XrangeSeriesSunburstLabel Label { get; set; }
		private XrangeSeriesSunburstLabel Label_DefaultValue { get; set; }
		...
		/// </summary>
		public XrangeSeriesSunburstStickyTracking StickyTracking { get; set; }
		private XrangeSeriesSunburstStickyTracking StickyTracking_DefaultValue { get; set; }
		 

		/// <summary>
		/// 
		/// </summary>
		public XrangeSeriesSunburstTooltip Tooltip { get; set; }
		private XrangeSeriesSunburstTooltip Tooltip_DefaultValue { get; set; }
		...
		/// 
		/// </summary>
		public XrangeSeriesSunburstStates States { get; set; }
		private XrangeSeriesSunburstStates States_DefaultValue { get; set; }
		...
		/// 
		/// </summary>
		public XrangeSeriesSunburstEvents Events { get; set; }
		private XrangeSeriesSunburstEvents Events_DefaultValue { get; set; }
		 

		/// <summary>
		/// 
		/// </summary>
		public XrangeSeriesSunburstPoint Point { get; set; }
		private XrangeSeriesSunburstPoint Point_DefaultValue { get; set; }
		...
		/// </summary>
		public XrangeSeriesSunburstLevelIsConstant LevelIsConstant { get; set; }
		private XrangeSeriesSunburstLevelIsConstant LevelIsConstant_DefaultValue { get; set; }
