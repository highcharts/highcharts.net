...
{
	public partial class XrangeSeriesSunburstData  : BaseObject
	{
		public XrangeSeriesSunburstData()
		{
		...
		/// </summary>
		public XrangeSeriesSunburstDataEvents Events { get; set; }
		private XrangeSeriesSunburstDataEvents Events_DefaultValue { get; set; }
