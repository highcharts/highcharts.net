...
{
	public partial class XrangeSeriesSunburstDataLabels  : BaseObject
	{
		public XrangeSeriesSunburstDataLabels()
		{
		...
		/// 
		/// </summary>
		public XrangeSeriesSunburstDataLabelsDefer Defer { get; set; }
		private XrangeSeriesSunburstDataLabelsDefer Defer_DefaultValue { get; set; }
		 

		/// <summary>
		/// 
		/// </summary>
		public XrangeSeriesSunburstDataLabelsStyle Style { get; set; }
		private XrangeSeriesSunburstDataLabelsStyle Style_DefaultValue { get; set; }
		...
		/// </summary>
		public XrangeSeriesSunburstDataLabelsRotationMode RotationMode { get; set; }
		private XrangeSeriesSunburstDataLabelsRotationMode RotationMode_DefaultValue { get; set; }
