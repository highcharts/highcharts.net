...
{
	public partial class XrangeSeriesSunburstLabel  : BaseObject
	{
		public XrangeSeriesSunburstLabel()
		{
		...
		/// </summary>
		public XrangeSeriesSunburstLabelEnabled Enabled { get; set; }
		private XrangeSeriesSunburstLabelEnabled Enabled_DefaultValue { get; set; }
		 

		/// <summary>
		/// Allow labels to be placed distant to the graph if necessary,and draw a connector line to the graph.
		/// </summary>
		public XrangeSeriesSunburstLabelConnectorAllowed ConnectorAllowed { get; set; }
		private XrangeSeriesSunburstLabelConnectorAllowed ConnectorAllowed_DefaultValue { get; set; }
		 

		/// <summary>
		/// If the label is closer than this to a neighbour graph, draw aconnector.
		/// </summary>
		public XrangeSeriesSunburstLabelConnectorNeighbourDistance ConnectorNeighbourDistance { get; set; }
		private XrangeSeriesSunburstLabelConnectorNeighbourDistance ConnectorNeighbourDistance_DefaultValue { get; set; }
		...
		/// </summary>
		public XrangeSeriesSunburstLabelStyle Style { get; set; }
		private XrangeSeriesSunburstLabelStyle Style_DefaultValue { get; set; }
