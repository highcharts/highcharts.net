...
{
	public partial class XrangeSeriesWordcloud  : BaseObject
	{
		public XrangeSeriesWordcloud()
		{
			Data = Data_DefaultValue = new List<SeriesXrangeWordcloudData>();
		...
		/// </summary>
		public List<SeriesXrangeWordcloudData> Data { get; set; }
		private List<SeriesXrangeWordcloudData> Data_DefaultValue { get; set; }
		 

		/// <summary>
		/// Series labels are placed as close to the series as possible in anatural way, seeking to avoid other series. The goal of thisfeature is to make the chart more easily readable, like if ahuman designer placed the labels in the optimal position.The series labels currently work with series types having a`graph` or an `area`.Requires the `series-label.js` module.
		/// </summary>
		public XrangeSeriesWordcloudLabel Label { get; set; }
		private XrangeSeriesWordcloudLabel Label_DefaultValue { get; set; }
		...
		/// </summary>
		public XrangeSeriesWordcloudEvents Events { get; set; }
		private XrangeSeriesWordcloudEvents Events_DefaultValue { get; set; }
		 

		/// <summary>
		/// Properties for each single point.
		/// </summary>
		public XrangeSeriesWordcloudPoint Point { get; set; }
		private XrangeSeriesWordcloudPoint Point_DefaultValue { get; set; }
		...
		/// 
		/// </summary>
		public XrangeSeriesWordcloudStates States { get; set; }
		private XrangeSeriesWordcloudStates States_DefaultValue { get; set; }
		 

		/// <summary>
		/// 
		/// </summary>
		public XrangeSeriesWordcloudStickyTracking StickyTracking { get; set; }
		private XrangeSeriesWordcloudStickyTracking StickyTracking_DefaultValue { get; set; }
		...
		/// 
		/// </summary>
		public XrangeSeriesWordcloudBorderWidth BorderWidth { get; set; }
		private XrangeSeriesWordcloudBorderWidth BorderWidth_DefaultValue { get; set; }
		 

		/// <summary>
		/// 
		/// </summary>
		public XrangeSeriesWordcloudClip Clip { get; set; }
		private XrangeSeriesWordcloudClip Clip_DefaultValue { get; set; }
		...
		/// </summary>
		public XrangeSeriesWordcloudColorByPoint ColorByPoint { get; set; }
		private XrangeSeriesWordcloudColorByPoint ColorByPoint_DefaultValue { get; set; }
		...
		/// </summary>
		public XrangeSeriesWordcloudPlacementStrategy PlacementStrategy { get; set; }
		private XrangeSeriesWordcloudPlacementStrategy PlacementStrategy_DefaultValue { get; set; }
		 

		/// <summary>
		/// Rotation options for the words in the wordcloud.
		/// </summary>
		public XrangeSeriesWordcloudRotation Rotation { get; set; }
		private XrangeSeriesWordcloudRotation Rotation_DefaultValue { get; set; }
		 

		/// <summary>
		/// 
		/// </summary>
		public XrangeSeriesWordcloudShowInLegend ShowInLegend { get; set; }
		private XrangeSeriesWordcloudShowInLegend ShowInLegend_DefaultValue { get; set; }
		...
		/// </summary>
		public XrangeSeriesWordcloudSpiral Spiral { get; set; }
		private XrangeSeriesWordcloudSpiral Spiral_DefaultValue { get; set; }
		...
		/// 
		/// </summary>
		public XrangeSeriesWordcloudTooltip Tooltip { get; set; }
		private XrangeSeriesWordcloudTooltip Tooltip_DefaultValue { get; set; }
