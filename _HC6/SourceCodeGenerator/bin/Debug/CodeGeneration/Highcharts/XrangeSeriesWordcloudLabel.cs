...
{
	public partial class XrangeSeriesWordcloudLabel  : BaseObject
	{
		public XrangeSeriesWordcloudLabel()
		{
		...
		/// </summary>
		public XrangeSeriesWordcloudLabelEnabled Enabled { get; set; }
		private XrangeSeriesWordcloudLabelEnabled Enabled_DefaultValue { get; set; }
		 

		/// <summary>
		/// Allow labels to be placed distant to the graph if necessary,and draw a connector line to the graph.
		/// </summary>
		public XrangeSeriesWordcloudLabelConnectorAllowed ConnectorAllowed { get; set; }
		private XrangeSeriesWordcloudLabelConnectorAllowed ConnectorAllowed_DefaultValue { get; set; }
		 

		/// <summary>
		/// If the label is closer than this to a neighbour graph, draw aconnector.
		/// </summary>
		public XrangeSeriesWordcloudLabelConnectorNeighbourDistance ConnectorNeighbourDistance { get; set; }
		private XrangeSeriesWordcloudLabelConnectorNeighbourDistance ConnectorNeighbourDistance_DefaultValue { get; set; }
		...
		/// </summary>
		public XrangeSeriesWordcloudLabelStyle Style { get; set; }
		private XrangeSeriesWordcloudLabelStyle Style_DefaultValue { get; set; }
