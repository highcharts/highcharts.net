...
namespace Highsoft.Web.Mvc.Charts
{
	public partial class ZAxisPlotBandsLabel  : BaseObject
	{
		...
		/// </summary>
		public ZAxisPlotBandsLabelStyle Style { get; set; }
		private ZAxisPlotBandsLabelStyle Style_DefaultValue { get; set; }
		...
		/// <summary>
		/// Vertical alignment of the label relative to the plot band. Can beone of "top", "middle" or "bottom".
		/// </summary>
