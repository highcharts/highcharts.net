...
namespace Highsoft.Web.Mvc.Stocks
{
	public partial class AdSeriesDataLabels  : BaseObject
	{
		public AdSeriesDataLabels()
		{
			...
			Style = Style_DefaultValue = new AdSeriesDataLabelsStyle();
		...
		/// </summary>
		public AdSeriesDataLabelsStyle Style { get; set; }
		private AdSeriesDataLabelsStyle Style_DefaultValue { get; set; }
