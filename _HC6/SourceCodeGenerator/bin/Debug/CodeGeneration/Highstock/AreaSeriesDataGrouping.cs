...
{
	public partial class AreaSeriesDataGrouping  : BaseObject
	{
		public AreaSeriesDataGrouping()
		{
			Approximation = Approximation_DefaultValue = AreaSeriesDataGroupingApproximation.Average;
		...
		/// </summary>
		public AreaSeriesDataGroupingApproximation Approximation { get; set; }
		private AreaSeriesDataGroupingApproximation Approximation_DefaultValue { get; set; }
		...
		/// </summary>
		public AreaSeriesDataGroupingUnits Units { get; set; }
		private AreaSeriesDataGroupingUnits Units_DefaultValue { get; set; }
