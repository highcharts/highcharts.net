...
{
	public partial class ArearangeSeriesDataGrouping  : BaseObject
	{
		public ArearangeSeriesDataGrouping()
		{
			Approximation = Approximation_DefaultValue = ArearangeSeriesDataGroupingApproximation.Average;
		...
		/// </summary>
		public ArearangeSeriesDataGroupingApproximation Approximation { get; set; }
		private ArearangeSeriesDataGroupingApproximation Approximation_DefaultValue { get; set; }
		...
		/// </summary>
		public ArearangeSeriesDataGroupingUnits Units { get; set; }
		private ArearangeSeriesDataGroupingUnits Units_DefaultValue { get; set; }
