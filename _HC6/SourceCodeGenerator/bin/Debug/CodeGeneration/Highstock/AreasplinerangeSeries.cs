...
namespace Highsoft.Web.Mvc.Stocks
{
	public partial class AreasplinerangeSeries  : Series
	{
		public AreasplinerangeSeries()
		{
			...
			NavigatorOptions = NavigatorOptions_DefaultValue = new AreasplinerangeSeriesNavigatorOptions();
			...
			CompareBase = CompareBase_DefaultValue = AreasplinerangeSeriesCompareBase.0;
		...
		/// </summary>
		public AreasplinerangeSeriesNavigatorOptions NavigatorOptions { get; set; }
		private AreasplinerangeSeriesNavigatorOptions NavigatorOptions_DefaultValue { get; set; }
