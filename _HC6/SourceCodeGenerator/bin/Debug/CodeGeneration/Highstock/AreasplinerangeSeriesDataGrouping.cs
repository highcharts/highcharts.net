...
{
	public partial class AreasplinerangeSeriesDataGrouping  : BaseObject
	{
		public AreasplinerangeSeriesDataGrouping()
		{
			Approximation = Approximation_DefaultValue = AreasplinerangeSeriesDataGroupingApproximation.Average;
		...
		/// </summary>
		public AreasplinerangeSeriesDataGroupingApproximation Approximation { get; set; }
		private AreasplinerangeSeriesDataGroupingApproximation Approximation_DefaultValue { get; set; }
		...
		/// </summary>
		public AreasplinerangeSeriesDataGroupingUnits Units { get; set; }
		private AreasplinerangeSeriesDataGroupingUnits Units_DefaultValue { get; set; }
