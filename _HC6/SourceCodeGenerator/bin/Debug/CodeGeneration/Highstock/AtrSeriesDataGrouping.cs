...
{
	public partial class AtrSeriesDataGrouping  : BaseObject
	{
		public AtrSeriesDataGrouping()
		{
			Approximation = Approximation_DefaultValue = AtrSeriesDataGroupingApproximation.Average;
		...
		/// </summary>
		public AtrSeriesDataGroupingApproximation Approximation { get; set; }
		private AtrSeriesDataGroupingApproximation Approximation_DefaultValue { get; set; }
		...
		/// </summary>
		public AtrSeriesDataGroupingUnits Units { get; set; }
		private AtrSeriesDataGroupingUnits Units_DefaultValue { get; set; }
