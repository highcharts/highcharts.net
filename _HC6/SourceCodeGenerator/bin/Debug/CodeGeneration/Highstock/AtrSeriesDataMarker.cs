...
{
	public partial class AtrSeriesDataMarker  : BaseObject
	{
		public AtrSeriesDataMarker()
		{
			LineWidth = LineWidth_DefaultValue = 0;
			LineColor = LineColor_DefaultValue = "#ffffff";
			Radius = Radius_DefaultValue = 4;
			States = States_DefaultValue = new AtrSeriesDataMarkerStates();
		...
		/// </summary>
		public AtrSeriesDataMarkerStates States { get; set; }
		private AtrSeriesDataMarkerStates States_DefaultValue { get; set; }
