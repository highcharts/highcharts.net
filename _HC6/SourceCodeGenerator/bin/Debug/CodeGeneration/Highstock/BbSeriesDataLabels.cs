...
namespace Highsoft.Web.Mvc.Stocks
{
	public partial class BbSeriesDataLabels  : BaseObject
	{
		public BbSeriesDataLabels()
		{
			...
			Style = Style_DefaultValue = new BbSeriesDataLabelsStyle();
		...
		/// </summary>
		public BbSeriesDataLabelsStyle Style { get; set; }
		private BbSeriesDataLabelsStyle Style_DefaultValue { get; set; }
