...
{
	public partial class BubbleSeriesStatesHover  : BaseObject
	{
		public BubbleSeriesStatesHover()
		{
			LineWidthPlus = LineWidthPlus_DefaultValue = 1;
			Marker = Marker_DefaultValue = new BubbleSeriesStatesHoverMarker();
		...
		/// </summary>
		public BubbleSeriesStatesHoverMarker Marker { get; set; }
		private BubbleSeriesStatesHoverMarker Marker_DefaultValue { get; set; }
		...
		/// </summary>
		public BubbleSeriesStatesHoverHalo Halo { get; set; }
		private BubbleSeriesStatesHoverHalo Halo_DefaultValue { get; set; }
