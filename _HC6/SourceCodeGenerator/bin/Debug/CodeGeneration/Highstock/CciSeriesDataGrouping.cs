...
{
	public partial class CciSeriesDataGrouping  : BaseObject
	{
		public CciSeriesDataGrouping()
		{
			Approximation = Approximation_DefaultValue = CciSeriesDataGroupingApproximation.Average;
		...
		/// </summary>
		public CciSeriesDataGroupingApproximation Approximation { get; set; }
		private CciSeriesDataGroupingApproximation Approximation_DefaultValue { get; set; }
		...
		/// </summary>
		public CciSeriesDataGroupingUnits Units { get; set; }
		private CciSeriesDataGroupingUnits Units_DefaultValue { get; set; }
