...
{
	public partial class CmfSeriesDataMarker  : BaseObject
	{
		public CmfSeriesDataMarker()
		{
			...
			States = States_DefaultValue = new CmfSeriesDataMarkerStates();
		...
		/// </summary>
		public CmfSeriesDataMarkerStates States { get; set; }
		private CmfSeriesDataMarkerStates States_DefaultValue { get; set; }
