...
{
	public partial class CmfSeriesLabel  : BaseObject
	{
		public CmfSeriesLabel()
		{
			...
			Style = Style_DefaultValue = new CmfSeriesLabelStyle();
		...
		/// </summary>
		public CmfSeriesLabelStyle Style { get; set; }
		private CmfSeriesLabelStyle Style_DefaultValue { get; set; }
