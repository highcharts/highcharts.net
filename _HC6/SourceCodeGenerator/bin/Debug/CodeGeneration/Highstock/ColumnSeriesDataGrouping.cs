...
namespace Highsoft.Web.Mvc.Stocks
{
	public partial class ColumnSeriesDataGrouping  : BaseObject
	{
		...
		{
			Approximation = Approximation_DefaultValue = ColumnSeriesDataGroupingApproximation.Average;
		...
		/// </summary>
		public ColumnSeriesDataGroupingApproximation Approximation { get; set; }
		private ColumnSeriesDataGroupingApproximation Approximation_DefaultValue { get; set; }
		...
		/// </summary>
		public ColumnSeriesDataGroupingUnits Units { get; set; }
		private ColumnSeriesDataGroupingUnits Units_DefaultValue { get; set; }
