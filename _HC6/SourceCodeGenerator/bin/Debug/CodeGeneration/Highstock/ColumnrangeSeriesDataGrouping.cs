...
{
	public partial class ColumnrangeSeriesDataGrouping  : BaseObject
	{
		public ColumnrangeSeriesDataGrouping()
		{
			Approximation = Approximation_DefaultValue = ColumnrangeSeriesDataGroupingApproximation.Average;
		...
		/// </summary>
		public ColumnrangeSeriesDataGroupingApproximation Approximation { get; set; }
		private ColumnrangeSeriesDataGroupingApproximation Approximation_DefaultValue { get; set; }
		...
		/// </summary>
		public ColumnrangeSeriesDataGroupingUnits Units { get; set; }
		private ColumnrangeSeriesDataGroupingUnits Units_DefaultValue { get; set; }
