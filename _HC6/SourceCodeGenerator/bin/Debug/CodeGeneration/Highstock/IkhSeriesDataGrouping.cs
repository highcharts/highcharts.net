...
{
	public partial class IkhSeriesDataGrouping  : BaseObject
	{
		public IkhSeriesDataGrouping()
		{
			Approximation = Approximation_DefaultValue = IkhSeriesDataGroupingApproximation.Average;
		...
		/// </summary>
		public IkhSeriesDataGroupingApproximation Approximation { get; set; }
		private IkhSeriesDataGroupingApproximation Approximation_DefaultValue { get; set; }
		...
		/// </summary>
		public IkhSeriesDataGroupingUnits Units { get; set; }
		private IkhSeriesDataGroupingUnits Units_DefaultValue { get; set; }
