...
{
	public partial class MacdSeriesDataGrouping  : BaseObject
	{
		public MacdSeriesDataGrouping()
		{
			Approximation = Approximation_DefaultValue = MacdSeriesDataGroupingApproximation.Average;
		...
		/// </summary>
		public MacdSeriesDataGroupingApproximation Approximation { get; set; }
		private MacdSeriesDataGroupingApproximation Approximation_DefaultValue { get; set; }
		...
		/// </summary>
		public MacdSeriesDataGroupingUnits Units { get; set; }
		private MacdSeriesDataGroupingUnits Units_DefaultValue { get; set; }
