...
{
	public partial class NavigatorSeriesDataLabels  : BaseObject
	{
		public NavigatorSeriesDataLabels()
		{
			Align = Align_DefaultValue = NavigatorSeriesDataLabelsAlign.Center;
			Formatter = Formatter_DefaultValue = "";
			Style = Style_DefaultValue = new NavigatorSeriesDataLabelsStyle();
			VerticalAlign = VerticalAlign_DefaultValue = NavigatorSeriesDataLabelsVerticalAlign.Bottom;
			X = X_DefaultValue = 0;
			Y = Y_DefaultValue = -6;
			...
			Overflow = Overflow_DefaultValue = NavigatorSeriesDataLabelsOverflow.Justify;
			Rotation = Rotation_DefaultValue = 0;
			UseHTML = UseHTML_DefaultValue = false;
			Shape = Shape_DefaultValue = "square";
			ZIndex = ZIndex_DefaultValue = 6;
			Filter = Filter_DefaultValue = new NavigatorSeriesDataLabelsFilter();
		...
		/// </summary>
		public NavigatorSeriesDataLabelsAlign Align { get; set; }
		private NavigatorSeriesDataLabelsAlign Align_DefaultValue { get; set; }
		...
		/// </summary>
		public NavigatorSeriesDataLabelsStyle Style { get; set; }
		private NavigatorSeriesDataLabelsStyle Style_DefaultValue { get; set; }
		...
		/// </summary>
		public NavigatorSeriesDataLabelsVerticalAlign VerticalAlign { get; set; }
		private NavigatorSeriesDataLabelsVerticalAlign VerticalAlign_DefaultValue { get; set; }
		...
		/// </summary>
		public NavigatorSeriesDataLabelsOverflow Overflow { get; set; }
		private NavigatorSeriesDataLabelsOverflow Overflow_DefaultValue { get; set; }
		...
		/// </summary>
		public NavigatorSeriesDataLabelsFilter Filter { get; set; }
		private NavigatorSeriesDataLabelsFilter Filter_DefaultValue { get; set; }
		...
		internal override Hashtable ToHashtable()
		{
			...
			if (Formatter != Formatter_DefaultValue) { h.Add("formatter",Formatter); Highstock.AddFunction("NavigatorSeriesDataLabelsFormatter.formatter", Formatter); }  
