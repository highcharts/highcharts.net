...
namespace Highsoft.Web.Mvc.Stocks
{
	public partial class NavigatorXAxisCrosshair  : BaseObject
	{
		public NavigatorXAxisCrosshair()
		{
			...
			DashStyle = DashStyle_DefaultValue = NavigatorXAxisCrosshairDashStyle.Solid;
			Snap = Snap_DefaultValue = true;
			Width = Width_DefaultValue = 1;
			ZIndex = ZIndex_DefaultValue = 2;
			Label = Label_DefaultValue = new NavigatorXAxisCrosshairLabel();
		...
		private NavigatorXAxisCrosshairDashStyle DashStyle_DefaultValue { get; set; }
		...
		private NavigatorXAxisCrosshairLabel Label_DefaultValue { get; set; }
