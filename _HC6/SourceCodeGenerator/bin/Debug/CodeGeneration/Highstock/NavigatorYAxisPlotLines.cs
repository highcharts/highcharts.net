...
namespace Highsoft.Web.Mvc.Stocks
{
	public partial class NavigatorYAxisPlotLines  : BaseObject
	{
		public NavigatorYAxisPlotLines()
		{
			...
			Events = Events_DefaultValue = new NavigatorYAxisPlotLinesEvents();
		...
		/// </summary>
		public NavigatorYAxisPlotLinesEvents Events { get; set; }
		private NavigatorYAxisPlotLinesEvents Events_DefaultValue { get; set; }
