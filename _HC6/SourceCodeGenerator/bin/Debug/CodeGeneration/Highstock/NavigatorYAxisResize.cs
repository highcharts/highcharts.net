...
{
	public partial class NavigatorYAxisResize  : BaseObject
	{
		public NavigatorYAxisResize()
		{
			ControlledAxis = ControlledAxis_DefaultValue = new NavigatorYAxisResizeControlledAxis();
		...
		/// </summary>
		public NavigatorYAxisResizeControlledAxis ControlledAxis { get; set; }
		private NavigatorYAxisResizeControlledAxis ControlledAxis_DefaultValue { get; set; }
