...
{
	public partial class OhlcSeriesStatesHoverMarker  : BaseObject
	{
		public OhlcSeriesStatesHoverMarker()
		{
			...
			States = States_DefaultValue = new OhlcSeriesStatesHoverMarkerStates();
		...
		/// </summary>
		public OhlcSeriesStatesHoverMarkerStates States { get; set; }
		private OhlcSeriesStatesHoverMarkerStates States_DefaultValue { get; set; }
