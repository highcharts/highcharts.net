...
{
	public partial class PlotOptionsAdDataGrouping  : BaseObject
	{
		public PlotOptionsAdDataGrouping()
		{
			Approximation = Approximation_DefaultValue = PlotOptionsAdDataGroupingApproximation.Average;
		...
		/// </summary>
		public PlotOptionsAdDataGroupingApproximation Approximation { get; set; }
		private PlotOptionsAdDataGroupingApproximation Approximation_DefaultValue { get; set; }
		...
		/// </summary>
		public PlotOptionsAdDataGroupingUnits Units { get; set; }
		private PlotOptionsAdDataGroupingUnits Units_DefaultValue { get; set; }
