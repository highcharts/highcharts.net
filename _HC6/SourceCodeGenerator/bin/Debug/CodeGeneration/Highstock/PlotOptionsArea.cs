...
namespace Highsoft.Web.Mvc.Stocks
{
	public partial class PlotOptionsArea  : BaseObject
	{
		public PlotOptionsArea()
		{
			...
			NavigatorOptions = NavigatorOptions_DefaultValue = new PlotOptionsAreaNavigatorOptions();
			...
			CompareBase = CompareBase_DefaultValue = PlotOptionsAreaCompareBase.0;
		...
		/// </summary>
		public PlotOptionsAreaNavigatorOptions NavigatorOptions { get; set; }
		private PlotOptionsAreaNavigatorOptions NavigatorOptions_DefaultValue { get; set; }
