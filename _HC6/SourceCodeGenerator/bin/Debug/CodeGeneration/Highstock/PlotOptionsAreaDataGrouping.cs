...
{
	public partial class PlotOptionsAreaDataGrouping  : BaseObject
	{
		public PlotOptionsAreaDataGrouping()
		{
			Approximation = Approximation_DefaultValue = PlotOptionsAreaDataGroupingApproximation.Average;
		...
		/// </summary>
		public PlotOptionsAreaDataGroupingApproximation Approximation { get; set; }
		private PlotOptionsAreaDataGroupingApproximation Approximation_DefaultValue { get; set; }
		...
		/// </summary>
		public PlotOptionsAreaDataGroupingUnits Units { get; set; }
		private PlotOptionsAreaDataGroupingUnits Units_DefaultValue { get; set; }
