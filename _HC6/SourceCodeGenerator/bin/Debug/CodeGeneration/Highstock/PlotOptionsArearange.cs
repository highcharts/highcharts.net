...
namespace Highsoft.Web.Mvc.Stocks
{
	public partial class PlotOptionsArearange  : BaseObject
	{
		public PlotOptionsArearange()
		{
			...
			NavigatorOptions = NavigatorOptions_DefaultValue = new PlotOptionsArearangeNavigatorOptions();
			...
			Stacking = Stacking_DefaultValue = PlotOptionsArearangeStacking.Null;
		...
		/// </summary>
		public PlotOptionsArearangeNavigatorOptions NavigatorOptions { get; set; }
		private PlotOptionsArearangeNavigatorOptions NavigatorOptions_DefaultValue { get; set; }
		...
		/// </summary>
		public PlotOptionsArearangeStacking Stacking { get; set; }
		private PlotOptionsArearangeStacking Stacking_DefaultValue { get; set; }
