...
{
	public partial class PlotOptionsAreasplineDataGrouping  : BaseObject
	{
		public PlotOptionsAreasplineDataGrouping()
		{
			Approximation = Approximation_DefaultValue = PlotOptionsAreasplineDataGroupingApproximation.Average;
		...
		/// </summary>
		public PlotOptionsAreasplineDataGroupingApproximation Approximation { get; set; }
		private PlotOptionsAreasplineDataGroupingApproximation Approximation_DefaultValue { get; set; }
		...
		/// </summary>
		public PlotOptionsAreasplineDataGroupingUnits Units { get; set; }
		private PlotOptionsAreasplineDataGroupingUnits Units_DefaultValue { get; set; }
