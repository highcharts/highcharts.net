...
{
	public partial class PlotOptionsAreasplinerangeDataGrouping  : BaseObject
	{
		public PlotOptionsAreasplinerangeDataGrouping()
		{
			Approximation = Approximation_DefaultValue = PlotOptionsAreasplinerangeDataGroupingApproximation.Average;
		...
		/// </summary>
		public PlotOptionsAreasplinerangeDataGroupingApproximation Approximation { get; set; }
		private PlotOptionsAreasplinerangeDataGroupingApproximation Approximation_DefaultValue { get; set; }
		...
		/// </summary>
		public PlotOptionsAreasplinerangeDataGroupingUnits Units { get; set; }
		private PlotOptionsAreasplinerangeDataGroupingUnits Units_DefaultValue { get; set; }
