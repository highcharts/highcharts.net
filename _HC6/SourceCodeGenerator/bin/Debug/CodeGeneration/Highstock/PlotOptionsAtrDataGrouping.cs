...
{
	public partial class PlotOptionsAtrDataGrouping  : BaseObject
	{
		public PlotOptionsAtrDataGrouping()
		{
			Approximation = Approximation_DefaultValue = PlotOptionsAtrDataGroupingApproximation.Average;
		...
		/// </summary>
		public PlotOptionsAtrDataGroupingApproximation Approximation { get; set; }
		private PlotOptionsAtrDataGroupingApproximation Approximation_DefaultValue { get; set; }
		...
		/// </summary>
		public PlotOptionsAtrDataGroupingUnits Units { get; set; }
		private PlotOptionsAtrDataGroupingUnits Units_DefaultValue { get; set; }
