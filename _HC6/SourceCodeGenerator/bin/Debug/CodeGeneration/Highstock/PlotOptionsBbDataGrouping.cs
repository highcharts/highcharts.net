...
{
	public partial class PlotOptionsBbDataGrouping  : BaseObject
	{
		public PlotOptionsBbDataGrouping()
		{
			Approximation = Approximation_DefaultValue = PlotOptionsBbDataGroupingApproximation.Average;
		...
		/// </summary>
		public PlotOptionsBbDataGroupingApproximation Approximation { get; set; }
		private PlotOptionsBbDataGroupingApproximation Approximation_DefaultValue { get; set; }
		...
		/// </summary>
		public PlotOptionsBbDataGroupingUnits Units { get; set; }
		private PlotOptionsBbDataGroupingUnits Units_DefaultValue { get; set; }
