...
namespace Highsoft.Web.Mvc.Stocks
{
	public partial class PlotOptionsBbLabel  : BaseObject
	{
		public PlotOptionsBbLabel()
		{
			...
			Style = Style_DefaultValue = new PlotOptionsBbLabelStyle();
		...
		/// </summary>
		public PlotOptionsBbLabelStyle Style { get; set; }
		private PlotOptionsBbLabelStyle Style_DefaultValue { get; set; }
