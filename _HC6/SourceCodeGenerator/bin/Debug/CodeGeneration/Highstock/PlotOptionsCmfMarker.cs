...
{
	public partial class PlotOptionsCmfMarker  : BaseObject
	{
		public PlotOptionsCmfMarker()
		{
			LineWidth = LineWidth_DefaultValue = 0;
			LineColor = LineColor_DefaultValue = "#ffffff";
			Radius = Radius_DefaultValue = 4;
			States = States_DefaultValue = new PlotOptionsCmfMarkerStates();
		...
		/// </summary>
		public PlotOptionsCmfMarkerStates States { get; set; }
		private PlotOptionsCmfMarkerStates States_DefaultValue { get; set; }
