...
namespace Highsoft.Web.Mvc.Stocks
{
	public partial class PlotOptionsColumnrange  : BaseObject
	{
		public PlotOptionsColumnrange()
		{
			...
			NavigatorOptions = NavigatorOptions_DefaultValue = new PlotOptionsColumnrangeNavigatorOptions();
			...
			CompareBase = CompareBase_DefaultValue = PlotOptionsColumnrangeCompareBase.0;
		...
		/// </summary>
		public PlotOptionsColumnrangeNavigatorOptions NavigatorOptions { get; set; }
		private PlotOptionsColumnrangeNavigatorOptions NavigatorOptions_DefaultValue { get; set; }
