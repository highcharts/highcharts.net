...
namespace Highsoft.Web.Mvc.Stocks
{
	public partial class PlotOptionsColumnrangeDataGrouping  : BaseObject
	{
		...
		{
			Approximation = Approximation_DefaultValue = PlotOptionsColumnrangeDataGroupingApproximation.Average;
		...
		/// </summary>
		public PlotOptionsColumnrangeDataGroupingApproximation Approximation { get; set; }
		private PlotOptionsColumnrangeDataGroupingApproximation Approximation_DefaultValue { get; set; }
		...
		/// </summary>
		public PlotOptionsColumnrangeDataGroupingUnits Units { get; set; }
		private PlotOptionsColumnrangeDataGroupingUnits Units_DefaultValue { get; set; }
