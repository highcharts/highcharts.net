...
{
	public partial class PlotOptionsEmaDataGrouping  : BaseObject
	{
		public PlotOptionsEmaDataGrouping()
		{
			Approximation = Approximation_DefaultValue = PlotOptionsEmaDataGroupingApproximation.Average;
		...
		/// </summary>
		public PlotOptionsEmaDataGroupingApproximation Approximation { get; set; }
		private PlotOptionsEmaDataGroupingApproximation Approximation_DefaultValue { get; set; }
		...
		/// </summary>
		public PlotOptionsEmaDataGroupingUnits Units { get; set; }
		private PlotOptionsEmaDataGroupingUnits Units_DefaultValue { get; set; }
