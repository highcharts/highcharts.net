...
{
	public partial class PlotOptionsFlagsLabel  : BaseObject
	{
		public PlotOptionsFlagsLabel()
		{
			...
			Style = Style_DefaultValue = new PlotOptionsFlagsLabelStyle();
		...
		/// </summary>
		public PlotOptionsFlagsLabelStyle Style { get; set; }
		private PlotOptionsFlagsLabelStyle Style_DefaultValue { get; set; }
