...
{
	public partial class PlotOptionsIkhDataGrouping  : BaseObject
	{
		public PlotOptionsIkhDataGrouping()
		{
			Approximation = Approximation_DefaultValue = PlotOptionsIkhDataGroupingApproximation.Average;
		...
		/// </summary>
		public PlotOptionsIkhDataGroupingApproximation Approximation { get; set; }
		private PlotOptionsIkhDataGroupingApproximation Approximation_DefaultValue { get; set; }
		...
		/// </summary>
		public PlotOptionsIkhDataGroupingUnits Units { get; set; }
		private PlotOptionsIkhDataGroupingUnits Units_DefaultValue { get; set; }
