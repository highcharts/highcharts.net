...
{
	public partial class PlotOptionsIkhLabel  : BaseObject
	{
		public PlotOptionsIkhLabel()
		{
			...
			Style = Style_DefaultValue = new PlotOptionsIkhLabelStyle();
		...
		/// </summary>
		public PlotOptionsIkhLabelStyle Style { get; set; }
		private PlotOptionsIkhLabelStyle Style_DefaultValue { get; set; }
