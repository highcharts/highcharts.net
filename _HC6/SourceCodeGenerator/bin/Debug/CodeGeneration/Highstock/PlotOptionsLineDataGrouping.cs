...
namespace Highsoft.Web.Mvc.Stocks
{
	public partial class PlotOptionsLineDataGrouping  : BaseObject
	{
		...
		{
			Approximation = Approximation_DefaultValue = PlotOptionsLineDataGroupingApproximation.Average;
		...
		/// </summary>
		public PlotOptionsLineDataGroupingApproximation Approximation { get; set; }
		private PlotOptionsLineDataGroupingApproximation Approximation_DefaultValue { get; set; }
		...
		/// </summary>
		public PlotOptionsLineDataGroupingUnits Units { get; set; }
		private PlotOptionsLineDataGroupingUnits Units_DefaultValue { get; set; }
