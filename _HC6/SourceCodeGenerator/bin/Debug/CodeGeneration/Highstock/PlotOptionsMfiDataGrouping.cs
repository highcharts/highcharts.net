...
{
	public partial class PlotOptionsMfiDataGrouping  : BaseObject
	{
		public PlotOptionsMfiDataGrouping()
		{
			Approximation = Approximation_DefaultValue = PlotOptionsMfiDataGroupingApproximation.Average;
		...
		/// </summary>
		public PlotOptionsMfiDataGroupingApproximation Approximation { get; set; }
		private PlotOptionsMfiDataGroupingApproximation Approximation_DefaultValue { get; set; }
		...
		/// </summary>
		public PlotOptionsMfiDataGroupingUnits Units { get; set; }
		private PlotOptionsMfiDataGroupingUnits Units_DefaultValue { get; set; }
