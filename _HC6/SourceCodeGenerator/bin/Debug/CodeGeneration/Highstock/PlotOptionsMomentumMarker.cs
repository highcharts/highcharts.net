...
{
	public partial class PlotOptionsMomentumMarker  : BaseObject
	{
		public PlotOptionsMomentumMarker()
		{
			...
			States = States_DefaultValue = new PlotOptionsMomentumMarkerStates();
		...
		/// </summary>
		public PlotOptionsMomentumMarkerStates States { get; set; }
		private PlotOptionsMomentumMarkerStates States_DefaultValue { get; set; }
