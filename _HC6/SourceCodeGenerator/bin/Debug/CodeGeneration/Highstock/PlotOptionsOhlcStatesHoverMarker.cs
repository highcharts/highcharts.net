...
{
	public partial class PlotOptionsOhlcStatesHoverMarker  : BaseObject
	{
		public PlotOptionsOhlcStatesHoverMarker()
		{
			LineWidth = LineWidth_DefaultValue = 0;
			LineColor = LineColor_DefaultValue = "#ffffff";
			Radius = Radius_DefaultValue = 4;
			States = States_DefaultValue = new PlotOptionsOhlcStatesHoverMarkerStates();
		...
		/// </summary>
		public PlotOptionsOhlcStatesHoverMarkerStates States { get; set; }
		private PlotOptionsOhlcStatesHoverMarkerStates States_DefaultValue { get; set; }
