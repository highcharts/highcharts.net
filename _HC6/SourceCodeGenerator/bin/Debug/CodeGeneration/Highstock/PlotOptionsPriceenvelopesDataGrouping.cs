...
{
	public partial class PlotOptionsPriceenvelopesDataGrouping  : BaseObject
	{
		public PlotOptionsPriceenvelopesDataGrouping()
		{
			Approximation = Approximation_DefaultValue = PlotOptionsPriceenvelopesDataGroupingApproximation.Average;
		...
		/// </summary>
		public PlotOptionsPriceenvelopesDataGroupingApproximation Approximation { get; set; }
		private PlotOptionsPriceenvelopesDataGroupingApproximation Approximation_DefaultValue { get; set; }
		...
		/// </summary>
		public PlotOptionsPriceenvelopesDataGroupingUnits Units { get; set; }
		private PlotOptionsPriceenvelopesDataGroupingUnits Units_DefaultValue { get; set; }
