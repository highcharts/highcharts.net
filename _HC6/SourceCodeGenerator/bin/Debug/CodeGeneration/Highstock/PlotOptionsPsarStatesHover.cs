...
namespace Highsoft.Web.Mvc.Stocks
{
	public partial class PlotOptionsPsarStatesHover  : BaseObject
	{
		public PlotOptionsPsarStatesHover()
		{
			...
			Marker = Marker_DefaultValue = new PlotOptionsPsarStatesHoverMarker();
			Halo = Halo_DefaultValue = new PlotOptionsPsarStatesHoverHalo();
		...
		/// </summary>
		public PlotOptionsPsarStatesHoverMarker Marker { get; set; }
		private PlotOptionsPsarStatesHoverMarker Marker_DefaultValue { get; set; }
		...
		/// </summary>
		public PlotOptionsPsarStatesHoverHalo Halo { get; set; }
		private PlotOptionsPsarStatesHoverHalo Halo_DefaultValue { get; set; }
