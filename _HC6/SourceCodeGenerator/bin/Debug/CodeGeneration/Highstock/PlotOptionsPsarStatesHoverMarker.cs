...
{
	public partial class PlotOptionsPsarStatesHoverMarker  : BaseObject
	{
		public PlotOptionsPsarStatesHoverMarker()
		{
			...
			States = States_DefaultValue = new PlotOptionsPsarStatesHoverMarkerStates();
		...
		/// </summary>
		public PlotOptionsPsarStatesHoverMarkerStates States { get; set; }
		private PlotOptionsPsarStatesHoverMarkerStates States_DefaultValue { get; set; }
