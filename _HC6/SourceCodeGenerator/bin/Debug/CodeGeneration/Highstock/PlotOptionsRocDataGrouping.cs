...
{
	public partial class PlotOptionsRocDataGrouping  : BaseObject
	{
		...
		/// </summary>
		public PlotOptionsRocDataGroupingApproximation Approximation { get; set; }
		private PlotOptionsRocDataGroupingApproximation Approximation_DefaultValue { get; set; }
		...
		/// </summary>
		public PlotOptionsRocDataGroupingUnits Units { get; set; }
		private PlotOptionsRocDataGroupingUnits Units_DefaultValue { get; set; }
