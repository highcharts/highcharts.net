...
{
	public partial class PlotOptionsSeriesDataGrouping  : BaseObject
	{
		public PlotOptionsSeriesDataGrouping()
		{
			Approximation = Approximation_DefaultValue = PlotOptionsSeriesDataGroupingApproximation.Average;
		...
		/// </summary>
		public PlotOptionsSeriesDataGroupingApproximation Approximation { get; set; }
		private PlotOptionsSeriesDataGroupingApproximation Approximation_DefaultValue { get; set; }
		...
		/// </summary>
		public PlotOptionsSeriesDataGroupingUnits Units { get; set; }
		private PlotOptionsSeriesDataGroupingUnits Units_DefaultValue { get; set; }
