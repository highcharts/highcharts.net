...
{
	public partial class PlotOptionsSmaMarker  : BaseObject
	{
		public PlotOptionsSmaMarker()
		{
			LineWidth = LineWidth_DefaultValue = 0;
			LineColor = LineColor_DefaultValue = "#ffffff";
			Radius = Radius_DefaultValue = 4;
			States = States_DefaultValue = new PlotOptionsSmaMarkerStates();
		...
		/// </summary>
		public PlotOptionsSmaMarkerStates States { get; set; }
		private PlotOptionsSmaMarkerStates States_DefaultValue { get; set; }
