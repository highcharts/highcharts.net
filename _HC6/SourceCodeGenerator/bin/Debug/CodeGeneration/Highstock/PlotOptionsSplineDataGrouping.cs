...
namespace Highsoft.Web.Mvc.Stocks
{
	public partial class PlotOptionsSplineDataGrouping  : BaseObject
	{
		...
		{
			Approximation = Approximation_DefaultValue = PlotOptionsSplineDataGroupingApproximation.Average;
		...
		/// </summary>
		public PlotOptionsSplineDataGroupingApproximation Approximation { get; set; }
		private PlotOptionsSplineDataGroupingApproximation Approximation_DefaultValue { get; set; }
		...
		/// </summary>
		public PlotOptionsSplineDataGroupingUnits Units { get; set; }
		private PlotOptionsSplineDataGroupingUnits Units_DefaultValue { get; set; }
