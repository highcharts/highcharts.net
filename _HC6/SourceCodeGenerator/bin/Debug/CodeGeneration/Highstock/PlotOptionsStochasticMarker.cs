...
{
	public partial class PlotOptionsStochasticMarker  : BaseObject
	{
		public PlotOptionsStochasticMarker()
		{
			LineWidth = LineWidth_DefaultValue = 0;
			LineColor = LineColor_DefaultValue = "#ffffff";
			Radius = Radius_DefaultValue = 4;
			States = States_DefaultValue = new PlotOptionsStochasticMarkerStates();
		...
		/// </summary>
		public PlotOptionsStochasticMarkerStates States { get; set; }
		private PlotOptionsStochasticMarkerStates States_DefaultValue { get; set; }
