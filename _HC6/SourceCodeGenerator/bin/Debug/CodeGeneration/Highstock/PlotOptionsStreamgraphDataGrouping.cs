...
{
	public partial class PlotOptionsStreamgraphDataGrouping  : BaseObject
	{
		public PlotOptionsStreamgraphDataGrouping()
		{
			Approximation = Approximation_DefaultValue = PlotOptionsStreamgraphDataGroupingApproximation.Average;
		...
		/// </summary>
		public PlotOptionsStreamgraphDataGroupingApproximation Approximation { get; set; }
		private PlotOptionsStreamgraphDataGroupingApproximation Approximation_DefaultValue { get; set; }
		...
		/// </summary>
		public PlotOptionsStreamgraphDataGroupingUnits Units { get; set; }
		private PlotOptionsStreamgraphDataGroupingUnits Units_DefaultValue { get; set; }
