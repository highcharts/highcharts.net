...
{
	public partial class PlotOptionsVbpDataGrouping  : BaseObject
	{
		public PlotOptionsVbpDataGrouping()
		{
			Approximation = Approximation_DefaultValue = PlotOptionsVbpDataGroupingApproximation.Average;
		...
		/// </summary>
		public PlotOptionsVbpDataGroupingApproximation Approximation { get; set; }
		private PlotOptionsVbpDataGroupingApproximation Approximation_DefaultValue { get; set; }
		...
		/// </summary>
		public PlotOptionsVbpDataGroupingUnits Units { get; set; }
		private PlotOptionsVbpDataGroupingUnits Units_DefaultValue { get; set; }
