...
{
	public partial class PlotOptionsVbpLabel  : BaseObject
	{
		public PlotOptionsVbpLabel()
		{
			...
			Style = Style_DefaultValue = new PlotOptionsVbpLabelStyle();
		...
		/// </summary>
		public PlotOptionsVbpLabelStyle Style { get; set; }
		private PlotOptionsVbpLabelStyle Style_DefaultValue { get; set; }
