...
{
	public partial class PlotOptionsVwapDataGrouping  : BaseObject
	{
		public PlotOptionsVwapDataGrouping()
		{
			Approximation = Approximation_DefaultValue = PlotOptionsVwapDataGroupingApproximation.Average;
		...
		/// </summary>
		public PlotOptionsVwapDataGroupingApproximation Approximation { get; set; }
		private PlotOptionsVwapDataGroupingApproximation Approximation_DefaultValue { get; set; }
		...
		/// </summary>
		public PlotOptionsVwapDataGroupingUnits Units { get; set; }
		private PlotOptionsVwapDataGroupingUnits Units_DefaultValue { get; set; }
