...
{
	public partial class PlotOptionsWmaMarker  : BaseObject
	{
		public PlotOptionsWmaMarker()
		{
			LineWidth = LineWidth_DefaultValue = 0;
			LineColor = LineColor_DefaultValue = "#ffffff";
			Radius = Radius_DefaultValue = 4;
			States = States_DefaultValue = new PlotOptionsWmaMarkerStates();
		...
		/// </summary>
		public PlotOptionsWmaMarkerStates States { get; set; }
		private PlotOptionsWmaMarkerStates States_DefaultValue { get; set; }
