...
{
	public partial class PolygonSeriesDataGrouping  : BaseObject
	{
		public PolygonSeriesDataGrouping()
		{
			Approximation = Approximation_DefaultValue = PolygonSeriesDataGroupingApproximation.Average;
		...
		/// </summary>
		public PolygonSeriesDataGroupingApproximation Approximation { get; set; }
		private PolygonSeriesDataGroupingApproximation Approximation_DefaultValue { get; set; }
		...
		/// </summary>
		public PolygonSeriesDataGroupingUnits Units { get; set; }
		private PolygonSeriesDataGroupingUnits Units_DefaultValue { get; set; }
