...
{
	public partial class PsarSeriesDataGrouping  : BaseObject
	{
		public PsarSeriesDataGrouping()
		{
			Approximation = Approximation_DefaultValue = PsarSeriesDataGroupingApproximation.Average;
		...
		/// </summary>
		public PsarSeriesDataGroupingApproximation Approximation { get; set; }
		private PsarSeriesDataGroupingApproximation Approximation_DefaultValue { get; set; }
		...
		/// </summary>
		public PsarSeriesDataGroupingUnits Units { get; set; }
		private PsarSeriesDataGroupingUnits Units_DefaultValue { get; set; }
