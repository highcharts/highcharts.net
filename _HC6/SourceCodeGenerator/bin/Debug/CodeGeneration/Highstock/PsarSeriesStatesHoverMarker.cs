...
{
	public partial class PsarSeriesStatesHoverMarker  : BaseObject
	{
		public PsarSeriesStatesHoverMarker()
		{
			LineWidth = LineWidth_DefaultValue = 0;
			LineColor = LineColor_DefaultValue = "#ffffff";
			Radius = Radius_DefaultValue = 4;
			States = States_DefaultValue = new PsarSeriesStatesHoverMarkerStates();
		...
		/// </summary>
		public PsarSeriesStatesHoverMarkerStates States { get; set; }
		private PsarSeriesStatesHoverMarkerStates States_DefaultValue { get; set; }
