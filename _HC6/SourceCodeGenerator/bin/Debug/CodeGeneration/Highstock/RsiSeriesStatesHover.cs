...
{
	public partial class RsiSeriesStatesHover  : BaseObject
	{
		public RsiSeriesStatesHover()
		{
			LineWidthPlus = LineWidthPlus_DefaultValue = 1;
			Marker = Marker_DefaultValue = new RsiSeriesStatesHoverMarker();
			Halo = Halo_DefaultValue = new RsiSeriesStatesHoverHalo();
		...
		/// </summary>
		public RsiSeriesStatesHoverMarker Marker { get; set; }
		private RsiSeriesStatesHoverMarker Marker_DefaultValue { get; set; }
		...
		/// </summary>
		public RsiSeriesStatesHoverHalo Halo { get; set; }
		private RsiSeriesStatesHoverHalo Halo_DefaultValue { get; set; }
