...
{
	public partial class ScatterSeriesDataGrouping  : BaseObject
	{
		public ScatterSeriesDataGrouping()
		{
			Approximation = Approximation_DefaultValue = ScatterSeriesDataGroupingApproximation.Average;
		...
		/// </summary>
		public ScatterSeriesDataGroupingApproximation Approximation { get; set; }
		private ScatterSeriesDataGroupingApproximation Approximation_DefaultValue { get; set; }
		...
		/// </summary>
		public ScatterSeriesDataGroupingUnits Units { get; set; }
		private ScatterSeriesDataGroupingUnits Units_DefaultValue { get; set; }
