...
{
	public partial class SmaSeriesDataGrouping  : BaseObject
	{
		public SmaSeriesDataGrouping()
		{
			Approximation = Approximation_DefaultValue = SmaSeriesDataGroupingApproximation.Average;
		...
		/// </summary>
		public SmaSeriesDataGroupingApproximation Approximation { get; set; }
		private SmaSeriesDataGroupingApproximation Approximation_DefaultValue { get; set; }
		...
		/// </summary>
		public SmaSeriesDataGroupingUnits Units { get; set; }
		private SmaSeriesDataGroupingUnits Units_DefaultValue { get; set; }
