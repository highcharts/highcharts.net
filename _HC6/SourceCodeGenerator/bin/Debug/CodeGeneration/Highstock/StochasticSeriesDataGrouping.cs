...
{
	public partial class StochasticSeriesDataGrouping  : BaseObject
	{
		public StochasticSeriesDataGrouping()
		{
			Approximation = Approximation_DefaultValue = StochasticSeriesDataGroupingApproximation.Average;
		...
		/// </summary>
		public StochasticSeriesDataGroupingApproximation Approximation { get; set; }
		private StochasticSeriesDataGroupingApproximation Approximation_DefaultValue { get; set; }
		...
		/// </summary>
		public StochasticSeriesDataGroupingUnits Units { get; set; }
		private StochasticSeriesDataGroupingUnits Units_DefaultValue { get; set; }
