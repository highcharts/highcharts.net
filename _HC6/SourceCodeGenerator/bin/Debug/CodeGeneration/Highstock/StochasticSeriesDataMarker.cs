...
{
	public partial class StochasticSeriesDataMarker  : BaseObject
	{
		public StochasticSeriesDataMarker()
		{
			LineWidth = LineWidth_DefaultValue = 0;
			LineColor = LineColor_DefaultValue = "#ffffff";
			Radius = Radius_DefaultValue = 4;
			States = States_DefaultValue = new StochasticSeriesDataMarkerStates();
		...
		/// </summary>
		public StochasticSeriesDataMarkerStates States { get; set; }
		private StochasticSeriesDataMarkerStates States_DefaultValue { get; set; }
