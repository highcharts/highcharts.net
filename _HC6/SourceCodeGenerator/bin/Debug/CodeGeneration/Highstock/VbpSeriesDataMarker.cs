...
{
	public partial class VbpSeriesDataMarker  : BaseObject
	{
		public VbpSeriesDataMarker()
		{
			...
			States = States_DefaultValue = new VbpSeriesDataMarkerStates();
		...
		/// </summary>
		public VbpSeriesDataMarkerStates States { get; set; }
		private VbpSeriesDataMarkerStates States_DefaultValue { get; set; }
