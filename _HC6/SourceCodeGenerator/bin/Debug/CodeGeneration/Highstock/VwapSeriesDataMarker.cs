...
{
	public partial class VwapSeriesDataMarker  : BaseObject
	{
		public VwapSeriesDataMarker()
		{
			...
			States = States_DefaultValue = new VwapSeriesDataMarkerStates();
		...
		/// </summary>
		public VwapSeriesDataMarkerStates States { get; set; }
		private VwapSeriesDataMarkerStates States_DefaultValue { get; set; }
