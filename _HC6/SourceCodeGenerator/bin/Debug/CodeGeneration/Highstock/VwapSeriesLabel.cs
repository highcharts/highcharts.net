...
{
	public partial class VwapSeriesLabel  : BaseObject
	{
		public VwapSeriesLabel()
		{
			...
			Style = Style_DefaultValue = new VwapSeriesLabelStyle();
		...
		/// </summary>
		public VwapSeriesLabelStyle Style { get; set; }
		private VwapSeriesLabelStyle Style_DefaultValue { get; set; }
