...
{
	public partial class WindbarbSeriesDataMarker  : BaseObject
	{
		public WindbarbSeriesDataMarker()
		{
			LineWidth = LineWidth_DefaultValue = 0;
			LineColor = LineColor_DefaultValue = "#ffffff";
			Radius = Radius_DefaultValue = 4;
			States = States_DefaultValue = new WindbarbSeriesDataMarkerStates();
		...
		/// </summary>
		public WindbarbSeriesDataMarkerStates States { get; set; }
		private WindbarbSeriesDataMarkerStates States_DefaultValue { get; set; }
