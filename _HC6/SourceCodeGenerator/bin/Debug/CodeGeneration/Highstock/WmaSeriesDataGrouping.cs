...
{
	public partial class WmaSeriesDataGrouping  : BaseObject
	{
		public WmaSeriesDataGrouping()
		{
			Approximation = Approximation_DefaultValue = WmaSeriesDataGroupingApproximation.Average;
		...
		/// </summary>
		public WmaSeriesDataGroupingApproximation Approximation { get; set; }
		private WmaSeriesDataGroupingApproximation Approximation_DefaultValue { get; set; }
		...
		/// </summary>
		public WmaSeriesDataGroupingUnits Units { get; set; }
		private WmaSeriesDataGroupingUnits Units_DefaultValue { get; set; }
