...
{
	public partial class ZigzagSeriesDataMarker  : BaseObject
	{
		public ZigzagSeriesDataMarker()
		{
		...
		/// </summary>
		public ZigzagSeriesDataMarkerStates States { get; set; }
		private ZigzagSeriesDataMarkerStates States_DefaultValue { get; set; }
