...
namespace Highsoft.Web.Mvc.Charts
{
	public partial class ArcdiagramSeries  : Series
	{
		...
		public ArcdiagramSeries()
		{
			...
			Dumbell = Dumbell_DefaultValue = new ArcdiagramSeriesDumbell();
			...
			Sonification = Sonification_DefaultValue = new ArcdiagramSeriesSonification();
		...
		/// 
		/// </summary>
		public ArcdiagramSeriesDumbell Dumbell { get; set; }
		private ArcdiagramSeriesDumbell Dumbell_DefaultValue { get; set; }
		...
		private ArcdiagramSeriesSonification Sonification_DefaultValue { get; set; }
