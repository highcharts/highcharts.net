...
{
	public partial class ArcdiagramSeriesDataLabels  : BaseObject
	{
		Hashtable h = new Hashtable();

		public ArcdiagramSeriesDataLabels()
		{
		...
		/// </summary>
		public ArcdiagramSeriesDataLabelsAlign Align { get; set; }
		private ArcdiagramSeriesDataLabelsAlign Align_DefaultValue { get; set; }
		...
		/// </summary>
		public ArcdiagramSeriesDataLabelsFilter Filter { get; set; }
		private ArcdiagramSeriesDataLabelsFilter Filter_DefaultValue { get; set; }
		...
		/// </summary>
		public ArcdiagramSeriesDataLabelsOverflow Overflow { get; set; }
		private ArcdiagramSeriesDataLabelsOverflow Overflow_DefaultValue { get; set; }
		...
		/// </summary>
		public ArcdiagramSeriesDataLabelsPosition Position { get; set; }
		private ArcdiagramSeriesDataLabelsPosition Position_DefaultValue { get; set; }
		...
		/// </summary>
		public ArcdiagramSeriesDataLabelsTextPath TextPath { get; set; }
		private ArcdiagramSeriesDataLabelsTextPath TextPath_DefaultValue { get; set; }
		...
		/// </summary>
		public ArcdiagramSeriesDataLabelsVerticalAlign VerticalAlign { get; set; }
		private ArcdiagramSeriesDataLabelsVerticalAlign VerticalAlign_DefaultValue { get; set; }
		...
		internal override Hashtable ToHashtable(Highcharts highcharts)
		{
			...
			if (Align != ArcdiagramSeriesDataLabelsAlign.Null) h.Add("align", highcharts.FirstCharacterToLower(Align.ToString()));
			...
			if (Overflow != ArcdiagramSeriesDataLabelsOverflow.Null) h.Add("overflow", highcharts.FirstCharacterToLower(Overflow.ToString()));
			if (Padding != null) h.Add("padding",Padding);
			if (Position != ArcdiagramSeriesDataLabelsPosition.Null) h.Add("position", highcharts.FirstCharacterToLower(Position.ToString()));
			...
			if (VerticalAlign != ArcdiagramSeriesDataLabelsVerticalAlign.Null) h.Add("verticalAlign", highcharts.FirstCharacterToLower(VerticalAlign.ToString()));
			if (X != null) h.Add("x",X);
			if (Y != null) h.Add("y",Y);
