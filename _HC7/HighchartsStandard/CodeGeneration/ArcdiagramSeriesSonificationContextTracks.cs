...
{
	public partial class ArcdiagramSeriesSonificationContextTracks  : BaseObject
	{
		Hashtable h = new Hashtable();

		public ArcdiagramSeriesSonificationContextTracks()
		{
			ActiveWhen = ActiveWhen_DefaultValue = new ArcdiagramSeriesSonificationContextTracksActiveWhen();
			Instrument = Instrument_DefaultValue = null;
			InstrumentString = InstrumentString_DefaultValue = "null";
			Mapping = Mapping_DefaultValue = new ArcdiagramSeriesSonificationContextTracksMapping();
			MidiName = MidiName_DefaultValue = "";
			PointGrouping = PointGrouping_DefaultValue = new ArcdiagramSeriesSonificationContextTracksPointGrouping();
			...
			Type = Type_DefaultValue = ArcdiagramSeriesSonificationContextTracksType.Instrument;
			ValueInterval = ValueInterval_DefaultValue = null;
			ValueMapFunction = ValueMapFunction_DefaultValue = ArcdiagramSeriesSonificationContextTracksValueMapFunction.Linear;
		...
		/// </summary>
		public ArcdiagramSeriesSonificationContextTracksActiveWhen ActiveWhen { get; set; }
		private ArcdiagramSeriesSonificationContextTracksActiveWhen ActiveWhen_DefaultValue { get; set; }
		...
		/// </summary>
		public ArcdiagramSeriesSonificationContextTracksMapping Mapping { get; set; }
		private ArcdiagramSeriesSonificationContextTracksMapping Mapping_DefaultValue { get; set; }
		...
		/// </summary>
		public ArcdiagramSeriesSonificationContextTracksPointGrouping PointGrouping { get; set; }
		private ArcdiagramSeriesSonificationContextTracksPointGrouping PointGrouping_DefaultValue { get; set; }
		...
		/// </summary>
		public ArcdiagramSeriesSonificationContextTracksType Type { get; set; }
		private ArcdiagramSeriesSonificationContextTracksType Type_DefaultValue { get; set; }
		...
		/// </summary>
		public ArcdiagramSeriesSonificationContextTracksValueMapFunction ValueMapFunction { get; set; }
		private ArcdiagramSeriesSonificationContextTracksValueMapFunction ValueMapFunction_DefaultValue { get; set; }
