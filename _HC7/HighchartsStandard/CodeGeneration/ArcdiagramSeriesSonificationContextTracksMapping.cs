...
{
	public partial class ArcdiagramSeriesSonificationContextTracksMapping  : BaseObject
	{
		Hashtable h = new Hashtable();

		public ArcdiagramSeriesSonificationContextTracksMapping()
		{
			Frequency = Frequency_DefaultValue = new ArcdiagramSeriesSonificationContextTracksMappingFrequency();
			GapBetweenNotes = GapBetweenNotes_DefaultValue = new ArcdiagramSeriesSonificationContextTracksMappingGapBetweenNotes();
			Highpass = Highpass_DefaultValue = new ArcdiagramSeriesSonificationContextTracksMappingHighpass();
			Lowpass = Lowpass_DefaultValue = new ArcdiagramSeriesSonificationContextTracksMappingLowpass();
			NoteDuration = NoteDuration_DefaultValue = new ArcdiagramSeriesSonificationContextTracksMappingNoteDuration();
			Pan = Pan_DefaultValue = new ArcdiagramSeriesSonificationContextTracksMappingPan();
			Pitch = Pitch_DefaultValue = new ArcdiagramSeriesSonificationContextTracksMappingPitch();
			PitchString = PitchString_DefaultValue = "null";
			PitchNumber = PitchNumber_DefaultValue = null;
			PlayDelay = PlayDelay_DefaultValue = new ArcdiagramSeriesSonificationContextTracksMappingPlayDelay();
			Time = Time_DefaultValue = new ArcdiagramSeriesSonificationContextTracksMappingTime();
			TimeString = TimeString_DefaultValue = "null";
			TimeNumber = TimeNumber_DefaultValue = null;
			Tremolo = Tremolo_DefaultValue = new ArcdiagramSeriesSonificationContextTracksMappingTremolo();
			Volume = Volume_DefaultValue = new ArcdiagramSeriesSonificationContextTracksMappingVolume();
		...
		/// </summary>
		public ArcdiagramSeriesSonificationContextTracksMappingFrequency Frequency { get; set; }
		private ArcdiagramSeriesSonificationContextTracksMappingFrequency Frequency_DefaultValue { get; set; }
		...
		/// </summary>
		public ArcdiagramSeriesSonificationContextTracksMappingGapBetweenNotes GapBetweenNotes { get; set; }
		private ArcdiagramSeriesSonificationContextTracksMappingGapBetweenNotes GapBetweenNotes_DefaultValue { get; set; }
		...
		/// </summary>
		public ArcdiagramSeriesSonificationContextTracksMappingHighpass Highpass { get; set; }
		private ArcdiagramSeriesSonificationContextTracksMappingHighpass Highpass_DefaultValue { get; set; }
		...
		/// </summary>
		public ArcdiagramSeriesSonificationContextTracksMappingLowpass Lowpass { get; set; }
		private ArcdiagramSeriesSonificationContextTracksMappingLowpass Lowpass_DefaultValue { get; set; }
		...
		/// </summary>
		public ArcdiagramSeriesSonificationContextTracksMappingNoteDuration NoteDuration { get; set; }
		private ArcdiagramSeriesSonificationContextTracksMappingNoteDuration NoteDuration_DefaultValue { get; set; }
		...
		/// </summary>
		public ArcdiagramSeriesSonificationContextTracksMappingPan Pan { get; set; }
		private ArcdiagramSeriesSonificationContextTracksMappingPan Pan_DefaultValue { get; set; }
		...
		/// </summary>
		public ArcdiagramSeriesSonificationContextTracksMappingPitch Pitch { get; set; }
		private ArcdiagramSeriesSonificationContextTracksMappingPitch Pitch_DefaultValue { get; set; }
		...
		/// </summary>
		public ArcdiagramSeriesSonificationContextTracksMappingPlayDelay PlayDelay { get; set; }
		private ArcdiagramSeriesSonificationContextTracksMappingPlayDelay PlayDelay_DefaultValue { get; set; }
		...
		/// </summary>
		public ArcdiagramSeriesSonificationContextTracksMappingTime Time { get; set; }
		private ArcdiagramSeriesSonificationContextTracksMappingTime Time_DefaultValue { get; set; }
		...
		/// </summary>
		public ArcdiagramSeriesSonificationContextTracksMappingTremolo Tremolo { get; set; }
		private ArcdiagramSeriesSonificationContextTracksMappingTremolo Tremolo_DefaultValue { get; set; }
		 

		/// <summary>
		/// The volume of notes, from 0 to 1.
		/// </summary>
		public ArcdiagramSeriesSonificationContextTracksMappingVolume Volume { get; set; }
		private ArcdiagramSeriesSonificationContextTracksMappingVolume Volume_DefaultValue { get; set; }
