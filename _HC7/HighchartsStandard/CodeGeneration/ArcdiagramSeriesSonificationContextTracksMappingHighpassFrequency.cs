...
{
	public partial class ArcdiagramSeriesSonificationContextTracksMappingHighpassFrequency  : BaseObject
	{
		Hashtable h = new Hashtable();

		public ArcdiagramSeriesSonificationContextTracksMappingHighpassFrequency()
		{
			MapFunction = MapFunction_DefaultValue = ArcdiagramSeriesSonificationContextTracksMappingHighpassFrequencyMapFunction.Linear;
			MapTo = MapTo_DefaultValue = "";
			Max = Max_DefaultValue = null;
			Min = Min_DefaultValue = null;
			Value = Value_DefaultValue = null;
			Within = Within_DefaultValue = ArcdiagramSeriesSonificationContextTracksMappingHighpassFrequencyWithin.Chart;
		...
		/// </summary>
		public ArcdiagramSeriesSonificationContextTracksMappingHighpassFrequencyMapFunction MapFunction { get; set; }
		private ArcdiagramSeriesSonificationContextTracksMappingHighpassFrequencyMapFunction MapFunction_DefaultValue { get; set; }
		...
		/// </summary>
		public ArcdiagramSeriesSonificationContextTracksMappingHighpassFrequencyWithin Within { get; set; }
		private ArcdiagramSeriesSonificationContextTracksMappingHighpassFrequencyWithin Within_DefaultValue { get; set; }
