...
{
	public partial class ArcdiagramSeriesSonificationContextTracksMappingPan  : BaseObject
	{
		Hashtable h = new Hashtable();

		public ArcdiagramSeriesSonificationContextTracksMappingPan()
		{
			MapFunction = MapFunction_DefaultValue = ArcdiagramSeriesSonificationContextTracksMappingPanMapFunction.Linear;
			MapTo = MapTo_DefaultValue = "";
			Max = Max_DefaultValue = null;
			Min = Min_DefaultValue = null;
			Value = Value_DefaultValue = null;
			Within = Within_DefaultValue = ArcdiagramSeriesSonificationContextTracksMappingPanWithin.Chart;
		...
		/// </summary>
		public ArcdiagramSeriesSonificationContextTracksMappingPanMapFunction MapFunction { get; set; }
		private ArcdiagramSeriesSonificationContextTracksMappingPanMapFunction MapFunction_DefaultValue { get; set; }
		...
		/// </summary>
		public ArcdiagramSeriesSonificationContextTracksMappingPanWithin Within { get; set; }
		private ArcdiagramSeriesSonificationContextTracksMappingPanWithin Within_DefaultValue { get; set; }
