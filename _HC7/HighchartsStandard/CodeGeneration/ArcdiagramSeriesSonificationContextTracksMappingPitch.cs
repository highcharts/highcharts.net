...
{
	public partial class ArcdiagramSeriesSonificationContextTracksMappingPitch  : BaseObject
	{
		Hashtable h = new Hashtable();

		public ArcdiagramSeriesSonificationContextTracksMappingPitch()
		{
			MapFunction = MapFunction_DefaultValue = ArcdiagramSeriesSonificationContextTracksMappingPitchMapFunction.Linear;
		...
		/// </summary>
		public ArcdiagramSeriesSonificationContextTracksMappingPitchMapFunction MapFunction { get; set; }
		private ArcdiagramSeriesSonificationContextTracksMappingPitchMapFunction MapFunction_DefaultValue { get; set; }
