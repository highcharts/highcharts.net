...
{
	public partial class ArcdiagramSeriesSonificationContextTracksPointGrouping  : BaseObject
	{
		Hashtable h = new Hashtable();

		public ArcdiagramSeriesSonificationContextTracksPointGrouping()
		{
		...
		/// </summary>
		public ArcdiagramSeriesSonificationContextTracksPointGroupingAlgorithm Algorithm { get; set; }
		private ArcdiagramSeriesSonificationContextTracksPointGroupingAlgorithm Algorithm_DefaultValue { get; set; }
		...
		internal override Hashtable ToHashtable(Highcharts highcharts)
		{
			...
			if (Algorithm != ArcdiagramSeriesSonificationContextTracksPointGroupingAlgorithm.Null) h.Add("algorithm", highcharts.FirstCharacterToLower(Algorithm.ToString()));
