...
{
	public partial class ArcdiagramSeriesSonificationDefaultInstrumentOptions  : BaseObject
	{
		Hashtable h = new Hashtable();

		public ArcdiagramSeriesSonificationDefaultInstrumentOptions()
		{
			ActiveWhen = ActiveWhen_DefaultValue = new ArcdiagramSeriesSonificationDefaultInstrumentOptionsActiveWhen();
			Instrument = Instrument_DefaultValue = null;
			InstrumentString = InstrumentString_DefaultValue = "null";
			Mapping = Mapping_DefaultValue = new ArcdiagramSeriesSonificationDefaultInstrumentOptionsMapping();
			MidiName = MidiName_DefaultValue = "";
			PointGrouping = PointGrouping_DefaultValue = new ArcdiagramSeriesSonificationDefaultInstrumentOptionsPointGrouping();
			RoundToMusicalNotes = RoundToMusicalNotes_DefaultValue = true;
			ShowPlayMarker = ShowPlayMarker_DefaultValue = true;
			Type = Type_DefaultValue = ArcdiagramSeriesSonificationDefaultInstrumentOptionsType.Instrument;
		...
		/// </summary>
		public ArcdiagramSeriesSonificationDefaultInstrumentOptionsActiveWhen ActiveWhen { get; set; }
		private ArcdiagramSeriesSonificationDefaultInstrumentOptionsActiveWhen ActiveWhen_DefaultValue { get; set; }
		...
		/// </summary>
		public ArcdiagramSeriesSonificationDefaultInstrumentOptionsMapping Mapping { get; set; }
		private ArcdiagramSeriesSonificationDefaultInstrumentOptionsMapping Mapping_DefaultValue { get; set; }
		...
		/// </summary>
		public ArcdiagramSeriesSonificationDefaultInstrumentOptionsPointGrouping PointGrouping { get; set; }
		private ArcdiagramSeriesSonificationDefaultInstrumentOptionsPointGrouping PointGrouping_DefaultValue { get; set; }
		...
		/// </summary>
		public ArcdiagramSeriesSonificationDefaultInstrumentOptionsType Type { get; set; }
		private ArcdiagramSeriesSonificationDefaultInstrumentOptionsType Type_DefaultValue { get; set; }
