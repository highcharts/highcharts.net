...
{
	public partial class ArcdiagramSeriesSonificationDefaultInstrumentOptionsMapping  : BaseObject
	{
		Hashtable h = new Hashtable();

		public ArcdiagramSeriesSonificationDefaultInstrumentOptionsMapping()
		{
			Frequency = Frequency_DefaultValue = new ArcdiagramSeriesSonificationDefaultInstrumentOptionsMappingFrequency();
			GapBetweenNotes = GapBetweenNotes_DefaultValue = new ArcdiagramSeriesSonificationDefaultInstrumentOptionsMappingGapBetweenNotes();
			Highpass = Highpass_DefaultValue = new ArcdiagramSeriesSonificationDefaultInstrumentOptionsMappingHighpass();
			Lowpass = Lowpass_DefaultValue = new ArcdiagramSeriesSonificationDefaultInstrumentOptionsMappingLowpass();
			NoteDuration = NoteDuration_DefaultValue = new ArcdiagramSeriesSonificationDefaultInstrumentOptionsMappingNoteDuration();
			Pan = Pan_DefaultValue = new ArcdiagramSeriesSonificationDefaultInstrumentOptionsMappingPan();
			Pitch = Pitch_DefaultValue = new ArcdiagramSeriesSonificationDefaultInstrumentOptionsMappingPitch();
			PitchString = PitchString_DefaultValue = "null";
			PitchNumber = PitchNumber_DefaultValue = null;
			PlayDelay = PlayDelay_DefaultValue = new ArcdiagramSeriesSonificationDefaultInstrumentOptionsMappingPlayDelay();
			Time = Time_DefaultValue = new ArcdiagramSeriesSonificationDefaultInstrumentOptionsMappingTime();
			TimeString = TimeString_DefaultValue = "null";
			TimeNumber = TimeNumber_DefaultValue = null;
			Tremolo = Tremolo_DefaultValue = new ArcdiagramSeriesSonificationDefaultInstrumentOptionsMappingTremolo();
			Volume = Volume_DefaultValue = new ArcdiagramSeriesSonificationDefaultInstrumentOptionsMappingVolume();
		...
		/// </summary>
		public ArcdiagramSeriesSonificationDefaultInstrumentOptionsMappingFrequency Frequency { get; set; }
		private ArcdiagramSeriesSonificationDefaultInstrumentOptionsMappingFrequency Frequency_DefaultValue { get; set; }
		...
		/// </summary>
		public ArcdiagramSeriesSonificationDefaultInstrumentOptionsMappingGapBetweenNotes GapBetweenNotes { get; set; }
		private ArcdiagramSeriesSonificationDefaultInstrumentOptionsMappingGapBetweenNotes GapBetweenNotes_DefaultValue { get; set; }
		...
		/// </summary>
		public ArcdiagramSeriesSonificationDefaultInstrumentOptionsMappingHighpass Highpass { get; set; }
		private ArcdiagramSeriesSonificationDefaultInstrumentOptionsMappingHighpass Highpass_DefaultValue { get; set; }
		...
		/// </summary>
		public ArcdiagramSeriesSonificationDefaultInstrumentOptionsMappingLowpass Lowpass { get; set; }
		private ArcdiagramSeriesSonificationDefaultInstrumentOptionsMappingLowpass Lowpass_DefaultValue { get; set; }
		...
		/// </summary>
		public ArcdiagramSeriesSonificationDefaultInstrumentOptionsMappingNoteDuration NoteDuration { get; set; }
		private ArcdiagramSeriesSonificationDefaultInstrumentOptionsMappingNoteDuration NoteDuration_DefaultValue { get; set; }
		...
		/// </summary>
		public ArcdiagramSeriesSonificationDefaultInstrumentOptionsMappingPan Pan { get; set; }
		private ArcdiagramSeriesSonificationDefaultInstrumentOptionsMappingPan Pan_DefaultValue { get; set; }
		...
		/// </summary>
		public ArcdiagramSeriesSonificationDefaultInstrumentOptionsMappingPitch Pitch { get; set; }
		private ArcdiagramSeriesSonificationDefaultInstrumentOptionsMappingPitch Pitch_DefaultValue { get; set; }
		...
		/// </summary>
		public ArcdiagramSeriesSonificationDefaultInstrumentOptionsMappingPlayDelay PlayDelay { get; set; }
		private ArcdiagramSeriesSonificationDefaultInstrumentOptionsMappingPlayDelay PlayDelay_DefaultValue { get; set; }
		...
		/// </summary>
		public ArcdiagramSeriesSonificationDefaultInstrumentOptionsMappingTime Time { get; set; }
		private ArcdiagramSeriesSonificationDefaultInstrumentOptionsMappingTime Time_DefaultValue { get; set; }
		...
		/// </summary>
		public ArcdiagramSeriesSonificationDefaultInstrumentOptionsMappingTremolo Tremolo { get; set; }
		private ArcdiagramSeriesSonificationDefaultInstrumentOptionsMappingTremolo Tremolo_DefaultValue { get; set; }
		 

		/// <summary>
		/// The volume of notes, from 0 to 1.
		/// </summary>
		public ArcdiagramSeriesSonificationDefaultInstrumentOptionsMappingVolume Volume { get; set; }
		private ArcdiagramSeriesSonificationDefaultInstrumentOptionsMappingVolume Volume_DefaultValue { get; set; }
