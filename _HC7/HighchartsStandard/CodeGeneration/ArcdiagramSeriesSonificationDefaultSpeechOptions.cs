...
{
	public partial class ArcdiagramSeriesSonificationDefaultSpeechOptions  : BaseObject
	{
		Hashtable h = new Hashtable();

		public ArcdiagramSeriesSonificationDefaultSpeechOptions()
		{
			ActiveWhen = ActiveWhen_DefaultValue = new ArcdiagramSeriesSonificationDefaultSpeechOptionsActiveWhen();
			Language = Language_DefaultValue = "en-US";
			Mapping = Mapping_DefaultValue = new ArcdiagramSeriesSonificationDefaultSpeechOptionsMapping();
			PointGrouping = PointGrouping_DefaultValue = new ArcdiagramSeriesSonificationDefaultSpeechOptionsPointGrouping();
			PreferredVoice = PreferredVoice_DefaultValue = "";
			ShowPlayMarker = ShowPlayMarker_DefaultValue = true;
			Type = Type_DefaultValue = ArcdiagramSeriesSonificationDefaultSpeechOptionsType.Instrument;
		...
		/// </summary>
		public ArcdiagramSeriesSonificationDefaultSpeechOptionsActiveWhen ActiveWhen { get; set; }
		private ArcdiagramSeriesSonificationDefaultSpeechOptionsActiveWhen ActiveWhen_DefaultValue { get; set; }
		...
		/// </summary>
		public ArcdiagramSeriesSonificationDefaultSpeechOptionsMapping Mapping { get; set; }
		private ArcdiagramSeriesSonificationDefaultSpeechOptionsMapping Mapping_DefaultValue { get; set; }
		 

		/// <summary>
		/// Options for point grouping, specifically for instrument tracks.
		/// </summary>
		public ArcdiagramSeriesSonificationDefaultSpeechOptionsPointGrouping PointGrouping { get; set; }
		private ArcdiagramSeriesSonificationDefaultSpeechOptionsPointGrouping PointGrouping_DefaultValue { get; set; }
		...
		/// </summary>
		public ArcdiagramSeriesSonificationDefaultSpeechOptionsType Type { get; set; }
		private ArcdiagramSeriesSonificationDefaultSpeechOptionsType Type_DefaultValue { get; set; }
