...
{
	public partial class ArcdiagramSeriesSonificationDefaultSpeechOptionsMapping  : BaseObject
	{
		Hashtable h = new Hashtable();

		public ArcdiagramSeriesSonificationDefaultSpeechOptionsMapping()
		{
			Frequency = Frequency_DefaultValue = new ArcdiagramSeriesSonificationDefaultSpeechOptionsMappingFrequency();
			GapBetweenNotes = GapBetweenNotes_DefaultValue = new ArcdiagramSeriesSonificationDefaultSpeechOptionsMappingGapBetweenNotes();
			Highpass = Highpass_DefaultValue = new ArcdiagramSeriesSonificationDefaultSpeechOptionsMappingHighpass();
			Lowpass = Lowpass_DefaultValue = new ArcdiagramSeriesSonificationDefaultSpeechOptionsMappingLowpass();
			NoteDuration = NoteDuration_DefaultValue = new ArcdiagramSeriesSonificationDefaultSpeechOptionsMappingNoteDuration();
			Pan = Pan_DefaultValue = new ArcdiagramSeriesSonificationDefaultSpeechOptionsMappingPan();
			Pitch = Pitch_DefaultValue = new ArcdiagramSeriesSonificationDefaultSpeechOptionsMappingPitch();
			PitchString = PitchString_DefaultValue = "null";
			PitchNumber = PitchNumber_DefaultValue = null;
			PlayDelay = PlayDelay_DefaultValue = new ArcdiagramSeriesSonificationDefaultSpeechOptionsMappingPlayDelay();
			Time = Time_DefaultValue = new ArcdiagramSeriesSonificationDefaultSpeechOptionsMappingTime();
			TimeString = TimeString_DefaultValue = "null";
			TimeNumber = TimeNumber_DefaultValue = null;
			Tremolo = Tremolo_DefaultValue = new ArcdiagramSeriesSonificationDefaultSpeechOptionsMappingTremolo();
			Volume = Volume_DefaultValue = new ArcdiagramSeriesSonificationDefaultSpeechOptionsMappingVolume();
		...
		/// </summary>
		public ArcdiagramSeriesSonificationDefaultSpeechOptionsMappingFrequency Frequency { get; set; }
		private ArcdiagramSeriesSonificationDefaultSpeechOptionsMappingFrequency Frequency_DefaultValue { get; set; }
		...
		/// </summary>
		public ArcdiagramSeriesSonificationDefaultSpeechOptionsMappingGapBetweenNotes GapBetweenNotes { get; set; }
		private ArcdiagramSeriesSonificationDefaultSpeechOptionsMappingGapBetweenNotes GapBetweenNotes_DefaultValue { get; set; }
		...
		/// </summary>
		public ArcdiagramSeriesSonificationDefaultSpeechOptionsMappingHighpass Highpass { get; set; }
		private ArcdiagramSeriesSonificationDefaultSpeechOptionsMappingHighpass Highpass_DefaultValue { get; set; }
		...
		/// </summary>
		public ArcdiagramSeriesSonificationDefaultSpeechOptionsMappingLowpass Lowpass { get; set; }
		private ArcdiagramSeriesSonificationDefaultSpeechOptionsMappingLowpass Lowpass_DefaultValue { get; set; }
		...
		/// </summary>
		public ArcdiagramSeriesSonificationDefaultSpeechOptionsMappingNoteDuration NoteDuration { get; set; }
		private ArcdiagramSeriesSonificationDefaultSpeechOptionsMappingNoteDuration NoteDuration_DefaultValue { get; set; }
		...
		/// </summary>
		public ArcdiagramSeriesSonificationDefaultSpeechOptionsMappingPan Pan { get; set; }
		private ArcdiagramSeriesSonificationDefaultSpeechOptionsMappingPan Pan_DefaultValue { get; set; }
		...
		/// </summary>
		public ArcdiagramSeriesSonificationDefaultSpeechOptionsMappingPitch Pitch { get; set; }
		private ArcdiagramSeriesSonificationDefaultSpeechOptionsMappingPitch Pitch_DefaultValue { get; set; }
		...
		/// </summary>
		public ArcdiagramSeriesSonificationDefaultSpeechOptionsMappingPlayDelay PlayDelay { get; set; }
		private ArcdiagramSeriesSonificationDefaultSpeechOptionsMappingPlayDelay PlayDelay_DefaultValue { get; set; }
		...
		/// </summary>
		public ArcdiagramSeriesSonificationDefaultSpeechOptionsMappingTime Time { get; set; }
		private ArcdiagramSeriesSonificationDefaultSpeechOptionsMappingTime Time_DefaultValue { get; set; }
		...
		/// </summary>
		public ArcdiagramSeriesSonificationDefaultSpeechOptionsMappingTremolo Tremolo { get; set; }
		private ArcdiagramSeriesSonificationDefaultSpeechOptionsMappingTremolo Tremolo_DefaultValue { get; set; }
		 

		/// <summary>
		/// The volume of notes, from 0 to 1.
		/// </summary>
		public ArcdiagramSeriesSonificationDefaultSpeechOptionsMappingVolume Volume { get; set; }
		private ArcdiagramSeriesSonificationDefaultSpeechOptionsMappingVolume Volume_DefaultValue { get; set; }
