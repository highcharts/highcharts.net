...
{
	public partial class ArcdiagramSeriesSonificationDefaultSpeechOptionsMappingFrequency  : BaseObject
	{
		Hashtable h = new Hashtable();

		public ArcdiagramSeriesSonificationDefaultSpeechOptionsMappingFrequency()
		{
			MapFunction = MapFunction_DefaultValue = ArcdiagramSeriesSonificationDefaultSpeechOptionsMappingFrequencyMapFunction.Linear;
			MapTo = MapTo_DefaultValue = "";
			Max = Max_DefaultValue = null;
			Min = Min_DefaultValue = null;
			Value = Value_DefaultValue = null;
			Within = Within_DefaultValue = ArcdiagramSeriesSonificationDefaultSpeechOptionsMappingFrequencyWithin.Chart;
		...
		/// </summary>
		public ArcdiagramSeriesSonificationDefaultSpeechOptionsMappingFrequencyMapFunction MapFunction { get; set; }
		private ArcdiagramSeriesSonificationDefaultSpeechOptionsMappingFrequencyMapFunction MapFunction_DefaultValue { get; set; }
		...
		/// </summary>
		public ArcdiagramSeriesSonificationDefaultSpeechOptionsMappingFrequencyWithin Within { get; set; }
		private ArcdiagramSeriesSonificationDefaultSpeechOptionsMappingFrequencyWithin Within_DefaultValue { get; set; }
