...
{
	public partial class ArcdiagramSeriesSonificationPointGrouping  : BaseObject
	{
		Hashtable h = new Hashtable();

		public ArcdiagramSeriesSonificationPointGrouping()
		{
		...
		/// </summary>
		public ArcdiagramSeriesSonificationPointGroupingAlgorithm Algorithm { get; set; }
		private ArcdiagramSeriesSonificationPointGroupingAlgorithm Algorithm_DefaultValue { get; set; }
		...
		internal override Hashtable ToHashtable(Highcharts highcharts)
		{
			...
			if (Algorithm != ArcdiagramSeriesSonificationPointGroupingAlgorithm.Null) h.Add("algorithm", highcharts.FirstCharacterToLower(Algorithm.ToString()));
