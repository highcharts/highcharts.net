...
{
	public partial class ArcdiagramSeriesSonificationTracks  : BaseObject
	{
		Hashtable h = new Hashtable();

		public ArcdiagramSeriesSonificationTracks()
		{
			ActiveWhen = ActiveWhen_DefaultValue = new ArcdiagramSeriesSonificationTracksActiveWhen();
			Instrument = Instrument_DefaultValue = null;
			InstrumentString = InstrumentString_DefaultValue = "null";
			Mapping = Mapping_DefaultValue = new ArcdiagramSeriesSonificationTracksMapping();
			MidiName = MidiName_DefaultValue = "";
			PointGrouping = PointGrouping_DefaultValue = new ArcdiagramSeriesSonificationTracksPointGrouping();
			RoundToMusicalNotes = RoundToMusicalNotes_DefaultValue = true;
			ShowPlayMarker = ShowPlayMarker_DefaultValue = true;
			Type = Type_DefaultValue = ArcdiagramSeriesSonificationTracksType.Instrument;
		...
		/// </summary>
		public ArcdiagramSeriesSonificationTracksActiveWhen ActiveWhen { get; set; }
		private ArcdiagramSeriesSonificationTracksActiveWhen ActiveWhen_DefaultValue { get; set; }
		...
		/// </summary>
		public ArcdiagramSeriesSonificationTracksMapping Mapping { get; set; }
		private ArcdiagramSeriesSonificationTracksMapping Mapping_DefaultValue { get; set; }
		...
		/// </summary>
		public ArcdiagramSeriesSonificationTracksPointGrouping PointGrouping { get; set; }
		private ArcdiagramSeriesSonificationTracksPointGrouping PointGrouping_DefaultValue { get; set; }
		...
		/// </summary>
		public ArcdiagramSeriesSonificationTracksType Type { get; set; }
		private ArcdiagramSeriesSonificationTracksType Type_DefaultValue { get; set; }
