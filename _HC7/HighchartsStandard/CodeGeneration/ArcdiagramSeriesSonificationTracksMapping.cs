...
{
	public partial class ArcdiagramSeriesSonificationTracksMapping  : BaseObject
	{
		Hashtable h = new Hashtable();

		public ArcdiagramSeriesSonificationTracksMapping()
		{
			Frequency = Frequency_DefaultValue = new ArcdiagramSeriesSonificationTracksMappingFrequency();
			GapBetweenNotes = GapBetweenNotes_DefaultValue = new ArcdiagramSeriesSonificationTracksMappingGapBetweenNotes();
			Highpass = Highpass_DefaultValue = new ArcdiagramSeriesSonificationTracksMappingHighpass();
			Lowpass = Lowpass_DefaultValue = new ArcdiagramSeriesSonificationTracksMappingLowpass();
			NoteDuration = NoteDuration_DefaultValue = new ArcdiagramSeriesSonificationTracksMappingNoteDuration();
			Pan = Pan_DefaultValue = new ArcdiagramSeriesSonificationTracksMappingPan();
			Pitch = Pitch_DefaultValue = new ArcdiagramSeriesSonificationTracksMappingPitch();
			PitchString = PitchString_DefaultValue = "null";
			PitchNumber = PitchNumber_DefaultValue = null;
			PlayDelay = PlayDelay_DefaultValue = new ArcdiagramSeriesSonificationTracksMappingPlayDelay();
			Time = Time_DefaultValue = new ArcdiagramSeriesSonificationTracksMappingTime();
			TimeString = TimeString_DefaultValue = "null";
			TimeNumber = TimeNumber_DefaultValue = null;
			Tremolo = Tremolo_DefaultValue = new ArcdiagramSeriesSonificationTracksMappingTremolo();
			Volume = Volume_DefaultValue = new ArcdiagramSeriesSonificationTracksMappingVolume();
		...
		/// </summary>
		public ArcdiagramSeriesSonificationTracksMappingFrequency Frequency { get; set; }
		private ArcdiagramSeriesSonificationTracksMappingFrequency Frequency_DefaultValue { get; set; }
		...
		/// </summary>
		public ArcdiagramSeriesSonificationTracksMappingGapBetweenNotes GapBetweenNotes { get; set; }
		private ArcdiagramSeriesSonificationTracksMappingGapBetweenNotes GapBetweenNotes_DefaultValue { get; set; }
		...
		/// </summary>
		public ArcdiagramSeriesSonificationTracksMappingHighpass Highpass { get; set; }
		private ArcdiagramSeriesSonificationTracksMappingHighpass Highpass_DefaultValue { get; set; }
		...
		/// </summary>
		public ArcdiagramSeriesSonificationTracksMappingLowpass Lowpass { get; set; }
		private ArcdiagramSeriesSonificationTracksMappingLowpass Lowpass_DefaultValue { get; set; }
		...
		/// </summary>
		public ArcdiagramSeriesSonificationTracksMappingNoteDuration NoteDuration { get; set; }
		private ArcdiagramSeriesSonificationTracksMappingNoteDuration NoteDuration_DefaultValue { get; set; }
		...
		/// </summary>
		public ArcdiagramSeriesSonificationTracksMappingPan Pan { get; set; }
		private ArcdiagramSeriesSonificationTracksMappingPan Pan_DefaultValue { get; set; }
		...
		/// </summary>
		public ArcdiagramSeriesSonificationTracksMappingPitch Pitch { get; set; }
		private ArcdiagramSeriesSonificationTracksMappingPitch Pitch_DefaultValue { get; set; }
		...
		/// </summary>
		public ArcdiagramSeriesSonificationTracksMappingPlayDelay PlayDelay { get; set; }
		private ArcdiagramSeriesSonificationTracksMappingPlayDelay PlayDelay_DefaultValue { get; set; }
		...
		/// </summary>
		public ArcdiagramSeriesSonificationTracksMappingTime Time { get; set; }
		private ArcdiagramSeriesSonificationTracksMappingTime Time_DefaultValue { get; set; }
		...
		/// </summary>
		public ArcdiagramSeriesSonificationTracksMappingTremolo Tremolo { get; set; }
		private ArcdiagramSeriesSonificationTracksMappingTremolo Tremolo_DefaultValue { get; set; }
		 

		/// <summary>
		/// The volume of notes, from 0 to 1.
		/// </summary>
		public ArcdiagramSeriesSonificationTracksMappingVolume Volume { get; set; }
		private ArcdiagramSeriesSonificationTracksMappingVolume Volume_DefaultValue { get; set; }
