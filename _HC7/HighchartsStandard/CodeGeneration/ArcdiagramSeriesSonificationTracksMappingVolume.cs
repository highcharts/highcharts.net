...
{
	public partial class ArcdiagramSeriesSonificationTracksMappingVolume  : BaseObject
	{
		Hashtable h = new Hashtable();

		public ArcdiagramSeriesSonificationTracksMappingVolume()
		{
			MapFunction = MapFunction_DefaultValue = ArcdiagramSeriesSonificationTracksMappingVolumeMapFunction.Linear;
			MapTo = MapTo_DefaultValue = "";
			Max = Max_DefaultValue = null;
			Min = Min_DefaultValue = null;
			Value = Value_DefaultValue = null;
			Within = Within_DefaultValue = ArcdiagramSeriesSonificationTracksMappingVolumeWithin.Chart;
		...
		/// </summary>
		public ArcdiagramSeriesSonificationTracksMappingVolumeMapFunction MapFunction { get; set; }
		private ArcdiagramSeriesSonificationTracksMappingVolumeMapFunction MapFunction_DefaultValue { get; set; }
		...
		/// </summary>
		public ArcdiagramSeriesSonificationTracksMappingVolumeWithin Within { get; set; }
		private ArcdiagramSeriesSonificationTracksMappingVolumeWithin Within_DefaultValue { get; set; }
