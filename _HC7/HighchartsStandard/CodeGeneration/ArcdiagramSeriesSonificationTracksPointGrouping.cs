...
{
	public partial class ArcdiagramSeriesSonificationTracksPointGrouping  : BaseObject
	{
		Hashtable h = new Hashtable();

		public ArcdiagramSeriesSonificationTracksPointGrouping()
		{
		...
		/// </summary>
		public ArcdiagramSeriesSonificationTracksPointGroupingAlgorithm Algorithm { get; set; }
		private ArcdiagramSeriesSonificationTracksPointGroupingAlgorithm Algorithm_DefaultValue { get; set; }
		...
		internal override Hashtable ToHashtable(Highcharts highcharts)
		{
			...
			if (Algorithm != ArcdiagramSeriesSonificationTracksPointGroupingAlgorithm.Null) h.Add("algorithm", highcharts.FirstCharacterToLower(Algorithm.ToString()));
