...
{
	public partial class ArcdiagramSeriesStatesSelect  : BaseObject
	{
		Hashtable h = new Hashtable();

		public ArcdiagramSeriesStatesSelect()
		{
			Animation = Animation_DefaultValue = new Animation();
			AnimationBool = AnimationBool_DefaultValue = null;
			Enabled = Enabled_DefaultValue = true;
			Halo = Halo_DefaultValue = new ArcdiagramSeriesStatesSelectHalo();
			LineWidth = LineWidth_DefaultValue = null;
			LineWidthPlus = LineWidthPlus_DefaultValue = 1;
			Marker = Marker_DefaultValue = new ArcdiagramSeriesStatesSelectMarker();
		...
		/// </summary>
		public ArcdiagramSeriesStatesSelectHalo Halo { get; set; }
		private ArcdiagramSeriesStatesSelectHalo Halo_DefaultValue { get; set; }
		...
		/// </summary>
		public ArcdiagramSeriesStatesSelectMarker Marker { get; set; }
		private ArcdiagramSeriesStatesSelectMarker Marker_DefaultValue { get; set; }
