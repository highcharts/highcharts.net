...
{
	public partial class AreaSeriesDataDataLabels  : BaseObject
	{
		Hashtable h = new Hashtable();

		public AreaSeriesDataDataLabels()
		{
		...
		/// </summary>
		public AreaSeriesDataDataLabelsAlign Align { get; set; }
		private AreaSeriesDataDataLabelsAlign Align_DefaultValue { get; set; }
		...
		/// </summary>
		public AreaSeriesDataDataLabelsFilter Filter { get; set; }
		private AreaSeriesDataDataLabelsFilter Filter_DefaultValue { get; set; }
		...
		/// </summary>
		public AreaSeriesDataDataLabelsOverflow Overflow { get; set; }
		private AreaSeriesDataDataLabelsOverflow Overflow_DefaultValue { get; set; }
		...
		/// </summary>
		public AreaSeriesDataDataLabelsPosition Position { get; set; }
		private AreaSeriesDataDataLabelsPosition Position_DefaultValue { get; set; }
		...
		/// </summary>
		public AreaSeriesDataDataLabelsTextPath TextPath { get; set; }
		private AreaSeriesDataDataLabelsTextPath TextPath_DefaultValue { get; set; }
		...
		/// </summary>
		public AreaSeriesDataDataLabelsVerticalAlign VerticalAlign { get; set; }
		private AreaSeriesDataDataLabelsVerticalAlign VerticalAlign_DefaultValue { get; set; }
		...
		internal override Hashtable ToHashtable(Highcharts highcharts)
		{
			...
			if (Align != AreaSeriesDataDataLabelsAlign.Null) h.Add("align", highcharts.FirstCharacterToLower(Align.ToString()));
			...
			if (Overflow != AreaSeriesDataDataLabelsOverflow.Null) h.Add("overflow", highcharts.FirstCharacterToLower(Overflow.ToString()));
			if (Padding != null) h.Add("padding",Padding);
			if (Position != AreaSeriesDataDataLabelsPosition.Null) h.Add("position", highcharts.FirstCharacterToLower(Position.ToString()));
			...
			if (VerticalAlign != AreaSeriesDataDataLabelsVerticalAlign.Null) h.Add("verticalAlign", highcharts.FirstCharacterToLower(VerticalAlign.ToString()));
			if (X != null) h.Add("x",X);
			if (Y != null) h.Add("y",Y);
