...
namespace Highsoft.Web.Mvc.Charts
{
	public partial class AreaSeriesDataDragDropDragHandle  : BaseObject
	{
		...
		internal override Hashtable ToHashtable()
		{
			...
			if (PathFormatter != PathFormatter_DefaultValue) { h.Add("pathFormatter",PathFormatter); Highcharts.AddFunction("f9f67e3e-7565-4dc9-a349-82fec0aec208.pathFormatter", PathFormatter); }  
