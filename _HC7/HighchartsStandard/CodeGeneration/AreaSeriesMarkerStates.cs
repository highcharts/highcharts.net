...
namespace Highsoft.Web.Mvc.Charts
{
	public partial class AreaSeriesMarkerStates  : BaseObject
	{
		public AreaSeriesMarkerStates()
		{
			...
			Inactive = Inactive_DefaultValue = new AreaSeriesMarkerStatesInactive();
			Normal = Normal_DefaultValue = new AreaSeriesMarkerStatesNormal();
		...
		/// 
		/// </summary>
		public AreaSeriesMarkerStatesInactive Inactive { get; set; }
		private AreaSeriesMarkerStatesInactive Inactive_DefaultValue { get; set; }
		 

		/// <summary>
		/// The normal state of a single point marker. Currently onlyused for setting animation when returning to normal statefrom hover.
		/// </summary>
		public AreaSeriesMarkerStatesNormal Normal { get; set; }
		private AreaSeriesMarkerStatesNormal Normal_DefaultValue { get; set; }
