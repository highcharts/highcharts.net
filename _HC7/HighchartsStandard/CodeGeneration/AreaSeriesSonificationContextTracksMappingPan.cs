...
{
	public partial class AreaSeriesSonificationContextTracksMappingPan  : BaseObject
	{
		Hashtable h = new Hashtable();

		public AreaSeriesSonificationContextTracksMappingPan()
		{
			MapFunction = MapFunction_DefaultValue = AreaSeriesSonificationContextTracksMappingPanMapFunction.Linear;
			MapTo = MapTo_DefaultValue = "";
			Max = Max_DefaultValue = null;
			Min = Min_DefaultValue = null;
			Value = Value_DefaultValue = null;
			Within = Within_DefaultValue = AreaSeriesSonificationContextTracksMappingPanWithin.Chart;
		...
		/// </summary>
		public AreaSeriesSonificationContextTracksMappingPanMapFunction MapFunction { get; set; }
		private AreaSeriesSonificationContextTracksMappingPanMapFunction MapFunction_DefaultValue { get; set; }
		...
		/// </summary>
		public AreaSeriesSonificationContextTracksMappingPanWithin Within { get; set; }
		private AreaSeriesSonificationContextTracksMappingPanWithin Within_DefaultValue { get; set; }
