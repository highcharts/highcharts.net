...
{
	public partial class AreaSeriesSonificationContextTracksMappingPitch  : BaseObject
	{
		Hashtable h = new Hashtable();

		public AreaSeriesSonificationContextTracksMappingPitch()
		{
			MapFunction = MapFunction_DefaultValue = AreaSeriesSonificationContextTracksMappingPitchMapFunction.Linear;
		...
		/// </summary>
		public AreaSeriesSonificationContextTracksMappingPitchMapFunction MapFunction { get; set; }
		private AreaSeriesSonificationContextTracksMappingPitchMapFunction MapFunction_DefaultValue { get; set; }
