...
{
	public partial class AreaSeriesSonificationContextTracksMappingPlayDelay  : BaseObject
	{
		Hashtable h = new Hashtable();

		public AreaSeriesSonificationContextTracksMappingPlayDelay()
		{
			MapFunction = MapFunction_DefaultValue = AreaSeriesSonificationContextTracksMappingPlayDelayMapFunction.Linear;
			MapTo = MapTo_DefaultValue = "";
			Max = Max_DefaultValue = null;
			Min = Min_DefaultValue = null;
			Value = Value_DefaultValue = null;
			Within = Within_DefaultValue = AreaSeriesSonificationContextTracksMappingPlayDelayWithin.Chart;
		...
		/// </summary>
		public AreaSeriesSonificationContextTracksMappingPlayDelayMapFunction MapFunction { get; set; }
		private AreaSeriesSonificationContextTracksMappingPlayDelayMapFunction MapFunction_DefaultValue { get; set; }
		...
		/// </summary>
		public AreaSeriesSonificationContextTracksMappingPlayDelayWithin Within { get; set; }
		private AreaSeriesSonificationContextTracksMappingPlayDelayWithin Within_DefaultValue { get; set; }
