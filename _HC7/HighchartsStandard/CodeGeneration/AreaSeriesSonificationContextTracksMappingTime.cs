...
{
	public partial class AreaSeriesSonificationContextTracksMappingTime  : BaseObject
	{
		Hashtable h = new Hashtable();

		public AreaSeriesSonificationContextTracksMappingTime()
		{
			MapFunction = MapFunction_DefaultValue = AreaSeriesSonificationContextTracksMappingTimeMapFunction.Linear;
			MapTo = MapTo_DefaultValue = "";
			Max = Max_DefaultValue = null;
			Min = Min_DefaultValue = null;
			Value = Value_DefaultValue = null;
			Within = Within_DefaultValue = AreaSeriesSonificationContextTracksMappingTimeWithin.Chart;
		...
		/// </summary>
		public AreaSeriesSonificationContextTracksMappingTimeMapFunction MapFunction { get; set; }
		private AreaSeriesSonificationContextTracksMappingTimeMapFunction MapFunction_DefaultValue { get; set; }
		...
		/// </summary>
		public AreaSeriesSonificationContextTracksMappingTimeWithin Within { get; set; }
		private AreaSeriesSonificationContextTracksMappingTimeWithin Within_DefaultValue { get; set; }
