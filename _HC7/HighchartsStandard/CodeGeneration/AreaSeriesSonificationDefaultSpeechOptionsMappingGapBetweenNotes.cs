...
{
	public partial class AreaSeriesSonificationDefaultSpeechOptionsMappingGapBetweenNotes  : BaseObject
	{
		Hashtable h = new Hashtable();

		public AreaSeriesSonificationDefaultSpeechOptionsMappingGapBetweenNotes()
		{
			MapFunction = MapFunction_DefaultValue = AreaSeriesSonificationDefaultSpeechOptionsMappingGapBetweenNotesMapFunction.Linear;
			MapTo = MapTo_DefaultValue = "";
			Max = Max_DefaultValue = null;
			Min = Min_DefaultValue = null;
			Value = Value_DefaultValue = null;
			Within = Within_DefaultValue = AreaSeriesSonificationDefaultSpeechOptionsMappingGapBetweenNotesWithin.Chart;
		...
		/// </summary>
		public AreaSeriesSonificationDefaultSpeechOptionsMappingGapBetweenNotesMapFunction MapFunction { get; set; }
		private AreaSeriesSonificationDefaultSpeechOptionsMappingGapBetweenNotesMapFunction MapFunction_DefaultValue { get; set; }
		...
		/// </summary>
		public AreaSeriesSonificationDefaultSpeechOptionsMappingGapBetweenNotesWithin Within { get; set; }
		private AreaSeriesSonificationDefaultSpeechOptionsMappingGapBetweenNotesWithin Within_DefaultValue { get; set; }
