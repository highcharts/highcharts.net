...
{
	public partial class AreaSeriesSonificationPointGrouping  : BaseObject
	{
		Hashtable h = new Hashtable();

		public AreaSeriesSonificationPointGrouping()
		{
		...
		/// </summary>
		public AreaSeriesSonificationPointGroupingAlgorithm Algorithm { get; set; }
		private AreaSeriesSonificationPointGroupingAlgorithm Algorithm_DefaultValue { get; set; }
		...
		internal override Hashtable ToHashtable(Highcharts highcharts)
		{
			...
			if (Algorithm != AreaSeriesSonificationPointGroupingAlgorithm.Null) h.Add("algorithm", highcharts.FirstCharacterToLower(Algorithm.ToString()));
