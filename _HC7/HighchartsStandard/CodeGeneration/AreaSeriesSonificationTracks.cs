...
{
	public partial class AreaSeriesSonificationTracks  : BaseObject
	{
		Hashtable h = new Hashtable();

		public AreaSeriesSonificationTracks()
		{
			ActiveWhen = ActiveWhen_DefaultValue = new AreaSeriesSonificationTracksActiveWhen();
			Instrument = Instrument_DefaultValue = null;
			InstrumentString = InstrumentString_DefaultValue = "null";
			Mapping = Mapping_DefaultValue = new AreaSeriesSonificationTracksMapping();
			MidiName = MidiName_DefaultValue = "";
			PointGrouping = PointGrouping_DefaultValue = new AreaSeriesSonificationTracksPointGrouping();
			RoundToMusicalNotes = RoundToMusicalNotes_DefaultValue = true;
			ShowPlayMarker = ShowPlayMarker_DefaultValue = true;
			Type = Type_DefaultValue = AreaSeriesSonificationTracksType.Instrument;
		...
		/// </summary>
		public AreaSeriesSonificationTracksActiveWhen ActiveWhen { get; set; }
		private AreaSeriesSonificationTracksActiveWhen ActiveWhen_DefaultValue { get; set; }
		...
		/// </summary>
		public AreaSeriesSonificationTracksMapping Mapping { get; set; }
		private AreaSeriesSonificationTracksMapping Mapping_DefaultValue { get; set; }
		...
		/// </summary>
		public AreaSeriesSonificationTracksPointGrouping PointGrouping { get; set; }
		private AreaSeriesSonificationTracksPointGrouping PointGrouping_DefaultValue { get; set; }
		...
		/// </summary>
		public AreaSeriesSonificationTracksType Type { get; set; }
		private AreaSeriesSonificationTracksType Type_DefaultValue { get; set; }
