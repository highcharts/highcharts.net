...
{
	public partial class AreaSeriesSonificationTracksMappingFrequency  : BaseObject
	{
		Hashtable h = new Hashtable();

		public AreaSeriesSonificationTracksMappingFrequency()
		{
			MapFunction = MapFunction_DefaultValue = AreaSeriesSonificationTracksMappingFrequencyMapFunction.Linear;
			MapTo = MapTo_DefaultValue = "";
			Max = Max_DefaultValue = null;
			Min = Min_DefaultValue = null;
			Value = Value_DefaultValue = null;
			Within = Within_DefaultValue = AreaSeriesSonificationTracksMappingFrequencyWithin.Chart;
		...
		/// </summary>
		public AreaSeriesSonificationTracksMappingFrequencyMapFunction MapFunction { get; set; }
		private AreaSeriesSonificationTracksMappingFrequencyMapFunction MapFunction_DefaultValue { get; set; }
		...
		/// </summary>
		public AreaSeriesSonificationTracksMappingFrequencyWithin Within { get; set; }
		private AreaSeriesSonificationTracksMappingFrequencyWithin Within_DefaultValue { get; set; }
