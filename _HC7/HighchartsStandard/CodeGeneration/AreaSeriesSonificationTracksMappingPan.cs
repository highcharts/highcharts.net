...
{
	public partial class AreaSeriesSonificationTracksMappingPan  : BaseObject
	{
		Hashtable h = new Hashtable();

		public AreaSeriesSonificationTracksMappingPan()
		{
			MapFunction = MapFunction_DefaultValue = AreaSeriesSonificationTracksMappingPanMapFunction.Linear;
			MapTo = MapTo_DefaultValue = "";
			Max = Max_DefaultValue = null;
			Min = Min_DefaultValue = null;
			Value = Value_DefaultValue = null;
			Within = Within_DefaultValue = AreaSeriesSonificationTracksMappingPanWithin.Chart;
		...
		/// </summary>
		public AreaSeriesSonificationTracksMappingPanMapFunction MapFunction { get; set; }
		private AreaSeriesSonificationTracksMappingPanMapFunction MapFunction_DefaultValue { get; set; }
		...
		/// </summary>
		public AreaSeriesSonificationTracksMappingPanWithin Within { get; set; }
		private AreaSeriesSonificationTracksMappingPanWithin Within_DefaultValue { get; set; }
