...
{
	public partial class AreaSeriesSonificationTracksMappingPitch  : BaseObject
	{
		Hashtable h = new Hashtable();

		public AreaSeriesSonificationTracksMappingPitch()
		{
			MapFunction = MapFunction_DefaultValue = AreaSeriesSonificationTracksMappingPitchMapFunction.Linear;
		...
		/// </summary>
		public AreaSeriesSonificationTracksMappingPitchMapFunction MapFunction { get; set; }
		private AreaSeriesSonificationTracksMappingPitchMapFunction MapFunction_DefaultValue { get; set; }
