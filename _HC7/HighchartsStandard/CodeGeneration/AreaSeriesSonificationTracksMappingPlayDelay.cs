...
{
	public partial class AreaSeriesSonificationTracksMappingPlayDelay  : BaseObject
	{
		Hashtable h = new Hashtable();

		public AreaSeriesSonificationTracksMappingPlayDelay()
		{
			MapFunction = MapFunction_DefaultValue = AreaSeriesSonificationTracksMappingPlayDelayMapFunction.Linear;
			MapTo = MapTo_DefaultValue = "";
			Max = Max_DefaultValue = null;
			Min = Min_DefaultValue = null;
			Value = Value_DefaultValue = null;
			Within = Within_DefaultValue = AreaSeriesSonificationTracksMappingPlayDelayWithin.Chart;
		...
		/// </summary>
		public AreaSeriesSonificationTracksMappingPlayDelayMapFunction MapFunction { get; set; }
		private AreaSeriesSonificationTracksMappingPlayDelayMapFunction MapFunction_DefaultValue { get; set; }
		...
		/// </summary>
		public AreaSeriesSonificationTracksMappingPlayDelayWithin Within { get; set; }
		private AreaSeriesSonificationTracksMappingPlayDelayWithin Within_DefaultValue { get; set; }
