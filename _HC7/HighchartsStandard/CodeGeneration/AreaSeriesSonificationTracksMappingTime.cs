...
{
	public partial class AreaSeriesSonificationTracksMappingTime  : BaseObject
	{
		Hashtable h = new Hashtable();

		public AreaSeriesSonificationTracksMappingTime()
		{
			MapFunction = MapFunction_DefaultValue = AreaSeriesSonificationTracksMappingTimeMapFunction.Linear;
			MapTo = MapTo_DefaultValue = "";
			Max = Max_DefaultValue = null;
			Min = Min_DefaultValue = null;
			Value = Value_DefaultValue = null;
			Within = Within_DefaultValue = AreaSeriesSonificationTracksMappingTimeWithin.Chart;
		...
		/// </summary>
		public AreaSeriesSonificationTracksMappingTimeMapFunction MapFunction { get; set; }
		private AreaSeriesSonificationTracksMappingTimeMapFunction MapFunction_DefaultValue { get; set; }
		...
		/// </summary>
		public AreaSeriesSonificationTracksMappingTimeWithin Within { get; set; }
		private AreaSeriesSonificationTracksMappingTimeWithin Within_DefaultValue { get; set; }
