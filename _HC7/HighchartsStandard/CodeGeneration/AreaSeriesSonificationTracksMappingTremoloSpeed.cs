...
{
	public partial class AreaSeriesSonificationTracksMappingTremoloSpeed  : BaseObject
	{
		Hashtable h = new Hashtable();

		public AreaSeriesSonificationTracksMappingTremoloSpeed()
		{
			MapFunction = MapFunction_DefaultValue = AreaSeriesSonificationTracksMappingTremoloSpeedMapFunction.Linear;
			MapTo = MapTo_DefaultValue = "";
			Max = Max_DefaultValue = null;
			Min = Min_DefaultValue = null;
			Value = Value_DefaultValue = null;
			Within = Within_DefaultValue = AreaSeriesSonificationTracksMappingTremoloSpeedWithin.Chart;
		...
		/// </summary>
		public AreaSeriesSonificationTracksMappingTremoloSpeedMapFunction MapFunction { get; set; }
		private AreaSeriesSonificationTracksMappingTremoloSpeedMapFunction MapFunction_DefaultValue { get; set; }
		...
		/// </summary>
		public AreaSeriesSonificationTracksMappingTremoloSpeedWithin Within { get; set; }
		private AreaSeriesSonificationTracksMappingTremoloSpeedWithin Within_DefaultValue { get; set; }
