...
{
	public partial class AreaSeriesSonificationTracksMappingVolume  : BaseObject
	{
		Hashtable h = new Hashtable();

		public AreaSeriesSonificationTracksMappingVolume()
		{
			MapFunction = MapFunction_DefaultValue = AreaSeriesSonificationTracksMappingVolumeMapFunction.Linear;
			MapTo = MapTo_DefaultValue = "";
			Max = Max_DefaultValue = null;
			Min = Min_DefaultValue = null;
			Value = Value_DefaultValue = null;
			Within = Within_DefaultValue = AreaSeriesSonificationTracksMappingVolumeWithin.Chart;
		...
		/// </summary>
		public AreaSeriesSonificationTracksMappingVolumeMapFunction MapFunction { get; set; }
		private AreaSeriesSonificationTracksMappingVolumeMapFunction MapFunction_DefaultValue { get; set; }
		...
		/// </summary>
		public AreaSeriesSonificationTracksMappingVolumeWithin Within { get; set; }
		private AreaSeriesSonificationTracksMappingVolumeWithin Within_DefaultValue { get; set; }
