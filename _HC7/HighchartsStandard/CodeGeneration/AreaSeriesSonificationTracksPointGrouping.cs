...
{
	public partial class AreaSeriesSonificationTracksPointGrouping  : BaseObject
	{
		Hashtable h = new Hashtable();

		public AreaSeriesSonificationTracksPointGrouping()
		{
		...
		/// </summary>
		public AreaSeriesSonificationTracksPointGroupingAlgorithm Algorithm { get; set; }
		private AreaSeriesSonificationTracksPointGroupingAlgorithm Algorithm_DefaultValue { get; set; }
		...
		internal override Hashtable ToHashtable(Highcharts highcharts)
		{
			...
			if (Algorithm != AreaSeriesSonificationTracksPointGroupingAlgorithm.Null) h.Add("algorithm", highcharts.FirstCharacterToLower(Algorithm.ToString()));
