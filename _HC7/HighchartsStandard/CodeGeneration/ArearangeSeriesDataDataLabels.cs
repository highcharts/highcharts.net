...
{
	public partial class ArearangeSeriesDataDataLabels  : BaseObject
	{
		Hashtable h = new Hashtable();

		public ArearangeSeriesDataDataLabels()
		{
		...
		/// </summary>
		public ArearangeSeriesDataDataLabelsAlign Align { get; set; }
		private ArearangeSeriesDataDataLabelsAlign Align_DefaultValue { get; set; }
		...
		/// </summary>
		public ArearangeSeriesDataDataLabelsFilter Filter { get; set; }
		private ArearangeSeriesDataDataLabelsFilter Filter_DefaultValue { get; set; }
		...
		/// </summary>
		public ArearangeSeriesDataDataLabelsOverflow Overflow { get; set; }
		private ArearangeSeriesDataDataLabelsOverflow Overflow_DefaultValue { get; set; }
		...
		/// </summary>
		public ArearangeSeriesDataDataLabelsPosition Position { get; set; }
		private ArearangeSeriesDataDataLabelsPosition Position_DefaultValue { get; set; }
		...
		/// </summary>
		public ArearangeSeriesDataDataLabelsTextPath TextPath { get; set; }
		private ArearangeSeriesDataDataLabelsTextPath TextPath_DefaultValue { get; set; }
		...
		/// </summary>
		public ArearangeSeriesDataDataLabelsVerticalAlign VerticalAlign { get; set; }
		private ArearangeSeriesDataDataLabelsVerticalAlign VerticalAlign_DefaultValue { get; set; }
		...
		internal override Hashtable ToHashtable(Highcharts highcharts)
		{
			...
			if (Align != ArearangeSeriesDataDataLabelsAlign.Null) h.Add("align", highcharts.FirstCharacterToLower(Align.ToString()));
			...
			if (Overflow != ArearangeSeriesDataDataLabelsOverflow.Null) h.Add("overflow", highcharts.FirstCharacterToLower(Overflow.ToString()));
			if (Padding != null) h.Add("padding",Padding);
			if (Position != ArearangeSeriesDataDataLabelsPosition.Null) h.Add("position", highcharts.FirstCharacterToLower(Position.ToString()));
			...
			if (VerticalAlign != ArearangeSeriesDataDataLabelsVerticalAlign.Null) h.Add("verticalAlign", highcharts.FirstCharacterToLower(VerticalAlign.ToString()));
			if (X != null) h.Add("x",X);
			if (Y != null) h.Add("y",Y);
