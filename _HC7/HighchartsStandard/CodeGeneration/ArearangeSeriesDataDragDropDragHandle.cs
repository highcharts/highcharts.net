...
{
	public partial class ArearangeSeriesDataDragDropDragHandle  : BaseObject
	{
		public ArearangeSeriesDataDragDropDragHandle()
		{
		...
		internal override Hashtable ToHashtable()
		{
			...
			if (PathFormatter != PathFormatter_DefaultValue) { h.Add("pathFormatter",PathFormatter); Highcharts.AddFunction("ArearangeSeriesDataDragDropDragHandlePathFormatter.pathFormatter", PathFormatter); }  
