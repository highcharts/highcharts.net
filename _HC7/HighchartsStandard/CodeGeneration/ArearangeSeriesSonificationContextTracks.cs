...
namespace Highsoft.Web.Mvc.Charts
{
	public partial class ArearangeSeriesSonificationContextTracks  : BaseObject
	{
		...
		internal override Hashtable ToHashtable(Highcharts highcharts)
		{
			...
			if (Type != ArearangeSeriesSonificationContextTracksType.Null) h.Add("type", highcharts.FirstCharacterToLower(Type.ToString()));
			if (ValueInterval != null) h.Add("valueInterval",ValueInterval);
			if (ValueMapFunction != ArearangeSeriesSonificationContextTracksValueMapFunction.Null) h.Add("valueMapFunction", highcharts.FirstCharacterToLower(ValueMapFunction.ToString()));
