...
{
	public partial class ArearangeSeriesSonificationContextTracksMappingPitch  : BaseObject
	{
		Hashtable h = new Hashtable();

		public ArearangeSeriesSonificationContextTracksMappingPitch()
		{
			MapFunction = MapFunction_DefaultValue = ArearangeSeriesSonificationContextTracksMappingPitchMapFunction.Linear;
		...
		/// </summary>
		public ArearangeSeriesSonificationContextTracksMappingPitchMapFunction MapFunction { get; set; }
		private ArearangeSeriesSonificationContextTracksMappingPitchMapFunction MapFunction_DefaultValue { get; set; }
