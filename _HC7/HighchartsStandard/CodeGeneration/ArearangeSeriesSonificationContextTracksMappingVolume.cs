...
{
	public partial class ArearangeSeriesSonificationContextTracksMappingVolume  : BaseObject
	{
		Hashtable h = new Hashtable();

		public ArearangeSeriesSonificationContextTracksMappingVolume()
		{
			MapFunction = MapFunction_DefaultValue = ArearangeSeriesSonificationContextTracksMappingVolumeMapFunction.Linear;
			MapTo = MapTo_DefaultValue = "";
			Max = Max_DefaultValue = null;
			Min = Min_DefaultValue = null;
			Value = Value_DefaultValue = null;
			Within = Within_DefaultValue = ArearangeSeriesSonificationContextTracksMappingVolumeWithin.Chart;
		...
		/// </summary>
		public ArearangeSeriesSonificationContextTracksMappingVolumeMapFunction MapFunction { get; set; }
		private ArearangeSeriesSonificationContextTracksMappingVolumeMapFunction MapFunction_DefaultValue { get; set; }
		...
		/// </summary>
		public ArearangeSeriesSonificationContextTracksMappingVolumeWithin Within { get; set; }
		private ArearangeSeriesSonificationContextTracksMappingVolumeWithin Within_DefaultValue { get; set; }
