...
{
	public partial class ArearangeSeriesSonificationDefaultInstrumentOptionsActiveWhen  : BaseObject
	{
		Hashtable h = new Hashtable();

		public ArearangeSeriesSonificationDefaultInstrumentOptionsActiveWhen()
		{
