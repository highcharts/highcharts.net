...
{
	public partial class ArearangeSeriesSonificationPointGrouping  : BaseObject
	{
		Hashtable h = new Hashtable();

		public ArearangeSeriesSonificationPointGrouping()
		{
		...
		/// </summary>
		public ArearangeSeriesSonificationPointGroupingAlgorithm Algorithm { get; set; }
		private ArearangeSeriesSonificationPointGroupingAlgorithm Algorithm_DefaultValue { get; set; }
		...
		internal override Hashtable ToHashtable(Highcharts highcharts)
		{
			...
			if (Algorithm != ArearangeSeriesSonificationPointGroupingAlgorithm.Null) h.Add("algorithm", highcharts.FirstCharacterToLower(Algorithm.ToString()));
