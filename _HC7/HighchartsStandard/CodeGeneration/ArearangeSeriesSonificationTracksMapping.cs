...
{
	public partial class ArearangeSeriesSonificationTracksMapping  : BaseObject
	{
		Hashtable h = new Hashtable();

		public ArearangeSeriesSonificationTracksMapping()
		{
			Frequency = Frequency_DefaultValue = new ArearangeSeriesSonificationTracksMappingFrequency();
			GapBetweenNotes = GapBetweenNotes_DefaultValue = new ArearangeSeriesSonificationTracksMappingGapBetweenNotes();
			Highpass = Highpass_DefaultValue = new ArearangeSeriesSonificationTracksMappingHighpass();
			Lowpass = Lowpass_DefaultValue = new ArearangeSeriesSonificationTracksMappingLowpass();
			NoteDuration = NoteDuration_DefaultValue = new ArearangeSeriesSonificationTracksMappingNoteDuration();
			Pan = Pan_DefaultValue = new ArearangeSeriesSonificationTracksMappingPan();
			Pitch = Pitch_DefaultValue = new ArearangeSeriesSonificationTracksMappingPitch();
			PitchString = PitchString_DefaultValue = "null";
			PitchNumber = PitchNumber_DefaultValue = null;
			PlayDelay = PlayDelay_DefaultValue = new ArearangeSeriesSonificationTracksMappingPlayDelay();
			Time = Time_DefaultValue = new ArearangeSeriesSonificationTracksMappingTime();
			TimeString = TimeString_DefaultValue = "null";
			TimeNumber = TimeNumber_DefaultValue = null;
			Tremolo = Tremolo_DefaultValue = new ArearangeSeriesSonificationTracksMappingTremolo();
			Volume = Volume_DefaultValue = new ArearangeSeriesSonificationTracksMappingVolume();
		...
		/// </summary>
		public ArearangeSeriesSonificationTracksMappingFrequency Frequency { get; set; }
		private ArearangeSeriesSonificationTracksMappingFrequency Frequency_DefaultValue { get; set; }
		...
		/// </summary>
		public ArearangeSeriesSonificationTracksMappingGapBetweenNotes GapBetweenNotes { get; set; }
		private ArearangeSeriesSonificationTracksMappingGapBetweenNotes GapBetweenNotes_DefaultValue { get; set; }
		...
		/// </summary>
		public ArearangeSeriesSonificationTracksMappingHighpass Highpass { get; set; }
		private ArearangeSeriesSonificationTracksMappingHighpass Highpass_DefaultValue { get; set; }
		...
		/// </summary>
		public ArearangeSeriesSonificationTracksMappingLowpass Lowpass { get; set; }
		private ArearangeSeriesSonificationTracksMappingLowpass Lowpass_DefaultValue { get; set; }
		...
		/// </summary>
		public ArearangeSeriesSonificationTracksMappingNoteDuration NoteDuration { get; set; }
		private ArearangeSeriesSonificationTracksMappingNoteDuration NoteDuration_DefaultValue { get; set; }
		...
		/// </summary>
		public ArearangeSeriesSonificationTracksMappingPan Pan { get; set; }
		private ArearangeSeriesSonificationTracksMappingPan Pan_DefaultValue { get; set; }
		...
		/// </summary>
		public ArearangeSeriesSonificationTracksMappingPitch Pitch { get; set; }
		private ArearangeSeriesSonificationTracksMappingPitch Pitch_DefaultValue { get; set; }
		...
		/// </summary>
		public ArearangeSeriesSonificationTracksMappingPlayDelay PlayDelay { get; set; }
		private ArearangeSeriesSonificationTracksMappingPlayDelay PlayDelay_DefaultValue { get; set; }
		...
		/// </summary>
		public ArearangeSeriesSonificationTracksMappingTime Time { get; set; }
		private ArearangeSeriesSonificationTracksMappingTime Time_DefaultValue { get; set; }
		...
		/// </summary>
		public ArearangeSeriesSonificationTracksMappingTremolo Tremolo { get; set; }
		private ArearangeSeriesSonificationTracksMappingTremolo Tremolo_DefaultValue { get; set; }
		 

		/// <summary>
		/// The volume of notes, from 0 to 1.
		/// </summary>
		public ArearangeSeriesSonificationTracksMappingVolume Volume { get; set; }
		private ArearangeSeriesSonificationTracksMappingVolume Volume_DefaultValue { get; set; }
