...
{
	public partial class ArearangeSeriesSonificationTracksMappingFrequency  : BaseObject
	{
		Hashtable h = new Hashtable();

		public ArearangeSeriesSonificationTracksMappingFrequency()
		{
			MapFunction = MapFunction_DefaultValue = ArearangeSeriesSonificationTracksMappingFrequencyMapFunction.Linear;
			MapTo = MapTo_DefaultValue = "";
			Max = Max_DefaultValue = null;
			Min = Min_DefaultValue = null;
			Value = Value_DefaultValue = null;
			Within = Within_DefaultValue = ArearangeSeriesSonificationTracksMappingFrequencyWithin.Chart;
		...
		/// </summary>
		public ArearangeSeriesSonificationTracksMappingFrequencyMapFunction MapFunction { get; set; }
		private ArearangeSeriesSonificationTracksMappingFrequencyMapFunction MapFunction_DefaultValue { get; set; }
		...
		/// </summary>
		public ArearangeSeriesSonificationTracksMappingFrequencyWithin Within { get; set; }
		private ArearangeSeriesSonificationTracksMappingFrequencyWithin Within_DefaultValue { get; set; }
