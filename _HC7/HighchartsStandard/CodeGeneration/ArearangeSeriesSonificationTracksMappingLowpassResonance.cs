...
{
	public partial class ArearangeSeriesSonificationTracksMappingLowpassResonance  : BaseObject
	{
		Hashtable h = new Hashtable();

		public ArearangeSeriesSonificationTracksMappingLowpassResonance()
		{
			MapFunction = MapFunction_DefaultValue = ArearangeSeriesSonificationTracksMappingLowpassResonanceMapFunction.Linear;
			MapTo = MapTo_DefaultValue = "";
			Max = Max_DefaultValue = null;
			Min = Min_DefaultValue = null;
			Value = Value_DefaultValue = null;
			Within = Within_DefaultValue = ArearangeSeriesSonificationTracksMappingLowpassResonanceWithin.Chart;
		...
		/// </summary>
		public ArearangeSeriesSonificationTracksMappingLowpassResonanceMapFunction MapFunction { get; set; }
		private ArearangeSeriesSonificationTracksMappingLowpassResonanceMapFunction MapFunction_DefaultValue { get; set; }
		...
		/// </summary>
		public ArearangeSeriesSonificationTracksMappingLowpassResonanceWithin Within { get; set; }
		private ArearangeSeriesSonificationTracksMappingLowpassResonanceWithin Within_DefaultValue { get; set; }
