...
{
	public partial class ArearangeSeriesSonificationTracksMappingNoteDuration  : BaseObject
	{
		Hashtable h = new Hashtable();

		public ArearangeSeriesSonificationTracksMappingNoteDuration()
		{
			MapFunction = MapFunction_DefaultValue = ArearangeSeriesSonificationTracksMappingNoteDurationMapFunction.Linear;
			MapTo = MapTo_DefaultValue = "";
			Max = Max_DefaultValue = null;
			Min = Min_DefaultValue = null;
			Value = Value_DefaultValue = null;
			Within = Within_DefaultValue = ArearangeSeriesSonificationTracksMappingNoteDurationWithin.Chart;
		...
		/// </summary>
		public ArearangeSeriesSonificationTracksMappingNoteDurationMapFunction MapFunction { get; set; }
		private ArearangeSeriesSonificationTracksMappingNoteDurationMapFunction MapFunction_DefaultValue { get; set; }
		...
		/// </summary>
		public ArearangeSeriesSonificationTracksMappingNoteDurationWithin Within { get; set; }
		private ArearangeSeriesSonificationTracksMappingNoteDurationWithin Within_DefaultValue { get; set; }
