...
{
	public partial class ArearangeSeriesSonificationTracksMappingPan  : BaseObject
	{
		Hashtable h = new Hashtable();

		public ArearangeSeriesSonificationTracksMappingPan()
		{
			MapFunction = MapFunction_DefaultValue = ArearangeSeriesSonificationTracksMappingPanMapFunction.Linear;
			MapTo = MapTo_DefaultValue = "";
			Max = Max_DefaultValue = null;
			Min = Min_DefaultValue = null;
			Value = Value_DefaultValue = null;
			Within = Within_DefaultValue = ArearangeSeriesSonificationTracksMappingPanWithin.Chart;
		...
		/// </summary>
		public ArearangeSeriesSonificationTracksMappingPanMapFunction MapFunction { get; set; }
		private ArearangeSeriesSonificationTracksMappingPanMapFunction MapFunction_DefaultValue { get; set; }
		...
		/// </summary>
		public ArearangeSeriesSonificationTracksMappingPanWithin Within { get; set; }
		private ArearangeSeriesSonificationTracksMappingPanWithin Within_DefaultValue { get; set; }
