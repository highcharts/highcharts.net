...
{
	public partial class ArearangeSeriesSonificationTracksMappingPitch  : BaseObject
	{
		Hashtable h = new Hashtable();

		public ArearangeSeriesSonificationTracksMappingPitch()
		{
			MapFunction = MapFunction_DefaultValue = ArearangeSeriesSonificationTracksMappingPitchMapFunction.Linear;
		...
		/// </summary>
		public ArearangeSeriesSonificationTracksMappingPitchMapFunction MapFunction { get; set; }
		private ArearangeSeriesSonificationTracksMappingPitchMapFunction MapFunction_DefaultValue { get; set; }
