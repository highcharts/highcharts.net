...
{
	public partial class ArearangeSeriesSonificationTracksMappingTime  : BaseObject
	{
		Hashtable h = new Hashtable();

		public ArearangeSeriesSonificationTracksMappingTime()
		{
			MapFunction = MapFunction_DefaultValue = ArearangeSeriesSonificationTracksMappingTimeMapFunction.Linear;
			MapTo = MapTo_DefaultValue = "";
			Max = Max_DefaultValue = null;
			Min = Min_DefaultValue = null;
			Value = Value_DefaultValue = null;
			Within = Within_DefaultValue = ArearangeSeriesSonificationTracksMappingTimeWithin.Chart;
		...
		/// </summary>
		public ArearangeSeriesSonificationTracksMappingTimeMapFunction MapFunction { get; set; }
		private ArearangeSeriesSonificationTracksMappingTimeMapFunction MapFunction_DefaultValue { get; set; }
		...
		/// </summary>
		public ArearangeSeriesSonificationTracksMappingTimeWithin Within { get; set; }
		private ArearangeSeriesSonificationTracksMappingTimeWithin Within_DefaultValue { get; set; }
