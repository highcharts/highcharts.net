...
{
	public partial class ArearangeSeriesSonificationTracksMappingVolume  : BaseObject
	{
		Hashtable h = new Hashtable();

		public ArearangeSeriesSonificationTracksMappingVolume()
		{
			MapFunction = MapFunction_DefaultValue = ArearangeSeriesSonificationTracksMappingVolumeMapFunction.Linear;
			MapTo = MapTo_DefaultValue = "";
			Max = Max_DefaultValue = null;
			Min = Min_DefaultValue = null;
			Value = Value_DefaultValue = null;
			Within = Within_DefaultValue = ArearangeSeriesSonificationTracksMappingVolumeWithin.Chart;
		...
		/// </summary>
		public ArearangeSeriesSonificationTracksMappingVolumeMapFunction MapFunction { get; set; }
		private ArearangeSeriesSonificationTracksMappingVolumeMapFunction MapFunction_DefaultValue { get; set; }
		...
		/// </summary>
		public ArearangeSeriesSonificationTracksMappingVolumeWithin Within { get; set; }
		private ArearangeSeriesSonificationTracksMappingVolumeWithin Within_DefaultValue { get; set; }
