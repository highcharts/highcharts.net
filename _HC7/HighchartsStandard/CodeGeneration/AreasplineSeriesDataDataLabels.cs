...
{
	public partial class AreasplineSeriesDataDataLabels  : BaseObject
	{
		Hashtable h = new Hashtable();

		public AreasplineSeriesDataDataLabels()
		{
		...
		/// </summary>
		public AreasplineSeriesDataDataLabelsAlign Align { get; set; }
		private AreasplineSeriesDataDataLabelsAlign Align_DefaultValue { get; set; }
		...
		/// </summary>
		public AreasplineSeriesDataDataLabelsFilter Filter { get; set; }
		private AreasplineSeriesDataDataLabelsFilter Filter_DefaultValue { get; set; }
		...
		/// </summary>
		public AreasplineSeriesDataDataLabelsOverflow Overflow { get; set; }
		private AreasplineSeriesDataDataLabelsOverflow Overflow_DefaultValue { get; set; }
		...
		/// </summary>
		public AreasplineSeriesDataDataLabelsPosition Position { get; set; }
		private AreasplineSeriesDataDataLabelsPosition Position_DefaultValue { get; set; }
		...
		/// </summary>
		public AreasplineSeriesDataDataLabelsTextPath TextPath { get; set; }
		private AreasplineSeriesDataDataLabelsTextPath TextPath_DefaultValue { get; set; }
		...
		/// </summary>
		public AreasplineSeriesDataDataLabelsVerticalAlign VerticalAlign { get; set; }
		private AreasplineSeriesDataDataLabelsVerticalAlign VerticalAlign_DefaultValue { get; set; }
		...
		internal override Hashtable ToHashtable(Highcharts highcharts)
		{
			...
			if (Align != AreasplineSeriesDataDataLabelsAlign.Null) h.Add("align", highcharts.FirstCharacterToLower(Align.ToString()));
			...
			if (Overflow != AreasplineSeriesDataDataLabelsOverflow.Null) h.Add("overflow", highcharts.FirstCharacterToLower(Overflow.ToString()));
			if (Padding != null) h.Add("padding",Padding);
			if (Position != AreasplineSeriesDataDataLabelsPosition.Null) h.Add("position", highcharts.FirstCharacterToLower(Position.ToString()));
			...
			if (VerticalAlign != AreasplineSeriesDataDataLabelsVerticalAlign.Null) h.Add("verticalAlign", highcharts.FirstCharacterToLower(VerticalAlign.ToString()));
			if (X != null) h.Add("x",X);
			if (Y != null) h.Add("y",Y);
