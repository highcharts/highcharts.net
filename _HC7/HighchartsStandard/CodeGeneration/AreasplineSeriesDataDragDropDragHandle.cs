...
namespace Highsoft.Web.Mvc.Charts
{
	public partial class AreasplineSeriesDataDragDropDragHandle  : BaseObject
	{
		...
		internal override Hashtable ToHashtable()
		{
			...
			if (PathFormatter != PathFormatter_DefaultValue) { h.Add("pathFormatter",PathFormatter); Highcharts.AddFunction("25160594-1bbe-46cd-8676-76942ccf73b5.pathFormatter", PathFormatter); }  
