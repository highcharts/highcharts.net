...
namespace Highsoft.Web.Mvc.Charts
{
	public partial class AreasplineSeriesDragDropDragHandle  : BaseObject
	{
		...
		internal override Hashtable ToHashtable()
		{
			...
			if (PathFormatter != PathFormatter_DefaultValue) { h.Add("pathFormatter",PathFormatter); Highcharts.AddFunction("47726eee-ef54-4afe-a9a3-10784c099e2f.pathFormatter", PathFormatter); }  
