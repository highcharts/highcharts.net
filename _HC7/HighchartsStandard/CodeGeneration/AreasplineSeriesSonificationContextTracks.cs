...
{
	public partial class AreasplineSeriesSonificationContextTracks  : BaseObject
	{
		Hashtable h = new Hashtable();

		public AreasplineSeriesSonificationContextTracks()
		{
		...
		/// </summary>
		public AreasplineSeriesSonificationContextTracksActiveWhen ActiveWhen { get; set; }
		private AreasplineSeriesSonificationContextTracksActiveWhen ActiveWhen_DefaultValue { get; set; }
		...
		/// </summary>
		public AreasplineSeriesSonificationContextTracksMapping Mapping { get; set; }
		private AreasplineSeriesSonificationContextTracksMapping Mapping_DefaultValue { get; set; }
		...
		/// </summary>
		public AreasplineSeriesSonificationContextTracksPointGrouping PointGrouping { get; set; }
		private AreasplineSeriesSonificationContextTracksPointGrouping PointGrouping_DefaultValue { get; set; }
		...
		/// </summary>
		public AreasplineSeriesSonificationContextTracksValueMapFunction ValueMapFunction { get; set; }
		private AreasplineSeriesSonificationContextTracksValueMapFunction ValueMapFunction_DefaultValue { get; set; }
		...
		internal override Hashtable ToHashtable(Highcharts highcharts)
		{
			...
			if (Type != AreasplineSeriesSonificationContextTracksType.Null) h.Add("type", highcharts.FirstCharacterToLower(Type.ToString()));
			if (ValueInterval != null) h.Add("valueInterval",ValueInterval);
			if (ValueMapFunction != AreasplineSeriesSonificationContextTracksValueMapFunction.Null) h.Add("valueMapFunction", highcharts.FirstCharacterToLower(ValueMapFunction.ToString()));
