...
{
	public partial class AreasplineSeriesSonificationContextTracksMapping  : BaseObject
	{
		Hashtable h = new Hashtable();

		public AreasplineSeriesSonificationContextTracksMapping()
		{
			Frequency = Frequency_DefaultValue = new AreasplineSeriesSonificationContextTracksMappingFrequency();
			GapBetweenNotes = GapBetweenNotes_DefaultValue = new AreasplineSeriesSonificationContextTracksMappingGapBetweenNotes();
			Highpass = Highpass_DefaultValue = new AreasplineSeriesSonificationContextTracksMappingHighpass();
			Lowpass = Lowpass_DefaultValue = new AreasplineSeriesSonificationContextTracksMappingLowpass();
			NoteDuration = NoteDuration_DefaultValue = new AreasplineSeriesSonificationContextTracksMappingNoteDuration();
			Pan = Pan_DefaultValue = new AreasplineSeriesSonificationContextTracksMappingPan();
			Pitch = Pitch_DefaultValue = new AreasplineSeriesSonificationContextTracksMappingPitch();
			PitchString = PitchString_DefaultValue = "null";
			PitchNumber = PitchNumber_DefaultValue = null;
			PlayDelay = PlayDelay_DefaultValue = new AreasplineSeriesSonificationContextTracksMappingPlayDelay();
			Time = Time_DefaultValue = new AreasplineSeriesSonificationContextTracksMappingTime();
			TimeString = TimeString_DefaultValue = "null";
			TimeNumber = TimeNumber_DefaultValue = null;
			Tremolo = Tremolo_DefaultValue = new AreasplineSeriesSonificationContextTracksMappingTremolo();
			Volume = Volume_DefaultValue = new AreasplineSeriesSonificationContextTracksMappingVolume();
		...
		/// </summary>
		public AreasplineSeriesSonificationContextTracksMappingFrequency Frequency { get; set; }
		private AreasplineSeriesSonificationContextTracksMappingFrequency Frequency_DefaultValue { get; set; }
		...
		/// </summary>
		public AreasplineSeriesSonificationContextTracksMappingGapBetweenNotes GapBetweenNotes { get; set; }
		private AreasplineSeriesSonificationContextTracksMappingGapBetweenNotes GapBetweenNotes_DefaultValue { get; set; }
		...
		/// </summary>
		public AreasplineSeriesSonificationContextTracksMappingHighpass Highpass { get; set; }
		private AreasplineSeriesSonificationContextTracksMappingHighpass Highpass_DefaultValue { get; set; }
		...
		/// </summary>
		public AreasplineSeriesSonificationContextTracksMappingLowpass Lowpass { get; set; }
		private AreasplineSeriesSonificationContextTracksMappingLowpass Lowpass_DefaultValue { get; set; }
		...
		/// </summary>
		public AreasplineSeriesSonificationContextTracksMappingNoteDuration NoteDuration { get; set; }
		private AreasplineSeriesSonificationContextTracksMappingNoteDuration NoteDuration_DefaultValue { get; set; }
		...
		/// </summary>
		public AreasplineSeriesSonificationContextTracksMappingPan Pan { get; set; }
		private AreasplineSeriesSonificationContextTracksMappingPan Pan_DefaultValue { get; set; }
		...
		/// </summary>
		public AreasplineSeriesSonificationContextTracksMappingPitch Pitch { get; set; }
		private AreasplineSeriesSonificationContextTracksMappingPitch Pitch_DefaultValue { get; set; }
		...
		/// </summary>
		public AreasplineSeriesSonificationContextTracksMappingPlayDelay PlayDelay { get; set; }
		private AreasplineSeriesSonificationContextTracksMappingPlayDelay PlayDelay_DefaultValue { get; set; }
		...
		/// </summary>
		public AreasplineSeriesSonificationContextTracksMappingTime Time { get; set; }
		private AreasplineSeriesSonificationContextTracksMappingTime Time_DefaultValue { get; set; }
		...
		/// </summary>
		public AreasplineSeriesSonificationContextTracksMappingTremolo Tremolo { get; set; }
		private AreasplineSeriesSonificationContextTracksMappingTremolo Tremolo_DefaultValue { get; set; }
		 

		/// <summary>
		/// The volume of notes, from 0 to 1.
		/// </summary>
		public AreasplineSeriesSonificationContextTracksMappingVolume Volume { get; set; }
		private AreasplineSeriesSonificationContextTracksMappingVolume Volume_DefaultValue { get; set; }
