...
{
	public partial class AreasplineSeriesSonificationContextTracksMappingFrequency  : BaseObject
	{
		Hashtable h = new Hashtable();

		public AreasplineSeriesSonificationContextTracksMappingFrequency()
		{
			MapFunction = MapFunction_DefaultValue = AreasplineSeriesSonificationContextTracksMappingFrequencyMapFunction.Linear;
			MapTo = MapTo_DefaultValue = "";
			Max = Max_DefaultValue = null;
			Min = Min_DefaultValue = null;
			Value = Value_DefaultValue = null;
			Within = Within_DefaultValue = AreasplineSeriesSonificationContextTracksMappingFrequencyWithin.Chart;
		...
		/// </summary>
		public AreasplineSeriesSonificationContextTracksMappingFrequencyMapFunction MapFunction { get; set; }
		private AreasplineSeriesSonificationContextTracksMappingFrequencyMapFunction MapFunction_DefaultValue { get; set; }
		...
		/// </summary>
		public AreasplineSeriesSonificationContextTracksMappingFrequencyWithin Within { get; set; }
		private AreasplineSeriesSonificationContextTracksMappingFrequencyWithin Within_DefaultValue { get; set; }
