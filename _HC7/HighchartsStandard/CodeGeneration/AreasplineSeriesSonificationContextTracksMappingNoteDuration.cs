...
{
	public partial class AreasplineSeriesSonificationContextTracksMappingNoteDuration  : BaseObject
	{
		Hashtable h = new Hashtable();

		public AreasplineSeriesSonificationContextTracksMappingNoteDuration()
		{
			MapFunction = MapFunction_DefaultValue = AreasplineSeriesSonificationContextTracksMappingNoteDurationMapFunction.Linear;
			MapTo = MapTo_DefaultValue = "";
			Max = Max_DefaultValue = null;
			Min = Min_DefaultValue = null;
			Value = Value_DefaultValue = null;
			Within = Within_DefaultValue = AreasplineSeriesSonificationContextTracksMappingNoteDurationWithin.Chart;
		...
		/// </summary>
		public AreasplineSeriesSonificationContextTracksMappingNoteDurationMapFunction MapFunction { get; set; }
		private AreasplineSeriesSonificationContextTracksMappingNoteDurationMapFunction MapFunction_DefaultValue { get; set; }
		...
		/// </summary>
		public AreasplineSeriesSonificationContextTracksMappingNoteDurationWithin Within { get; set; }
		private AreasplineSeriesSonificationContextTracksMappingNoteDurationWithin Within_DefaultValue { get; set; }
