...
{
	public partial class AreasplineSeriesSonificationContextTracksMappingPan  : BaseObject
	{
		Hashtable h = new Hashtable();

		public AreasplineSeriesSonificationContextTracksMappingPan()
		{
			MapFunction = MapFunction_DefaultValue = AreasplineSeriesSonificationContextTracksMappingPanMapFunction.Linear;
			MapTo = MapTo_DefaultValue = "";
			Max = Max_DefaultValue = null;
			Min = Min_DefaultValue = null;
			Value = Value_DefaultValue = null;
			Within = Within_DefaultValue = AreasplineSeriesSonificationContextTracksMappingPanWithin.Chart;
		...
		/// </summary>
		public AreasplineSeriesSonificationContextTracksMappingPanMapFunction MapFunction { get; set; }
		private AreasplineSeriesSonificationContextTracksMappingPanMapFunction MapFunction_DefaultValue { get; set; }
		...
		/// </summary>
		public AreasplineSeriesSonificationContextTracksMappingPanWithin Within { get; set; }
		private AreasplineSeriesSonificationContextTracksMappingPanWithin Within_DefaultValue { get; set; }
