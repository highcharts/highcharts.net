...
{
	public partial class AreasplineSeriesSonificationContextTracksMappingPitch  : BaseObject
	{
		Hashtable h = new Hashtable();

		public AreasplineSeriesSonificationContextTracksMappingPitch()
		{
			MapFunction = MapFunction_DefaultValue = AreasplineSeriesSonificationContextTracksMappingPitchMapFunction.Linear;
		...
		/// </summary>
		public AreasplineSeriesSonificationContextTracksMappingPitchMapFunction MapFunction { get; set; }
		private AreasplineSeriesSonificationContextTracksMappingPitchMapFunction MapFunction_DefaultValue { get; set; }
