...
{
	public partial class AreasplineSeriesSonificationContextTracksMappingPlayDelay  : BaseObject
	{
		Hashtable h = new Hashtable();

		public AreasplineSeriesSonificationContextTracksMappingPlayDelay()
		{
			MapFunction = MapFunction_DefaultValue = AreasplineSeriesSonificationContextTracksMappingPlayDelayMapFunction.Linear;
			MapTo = MapTo_DefaultValue = "";
			Max = Max_DefaultValue = null;
			Min = Min_DefaultValue = null;
			Value = Value_DefaultValue = null;
			Within = Within_DefaultValue = AreasplineSeriesSonificationContextTracksMappingPlayDelayWithin.Chart;
		...
		/// </summary>
		public AreasplineSeriesSonificationContextTracksMappingPlayDelayMapFunction MapFunction { get; set; }
		private AreasplineSeriesSonificationContextTracksMappingPlayDelayMapFunction MapFunction_DefaultValue { get; set; }
		...
		/// </summary>
		public AreasplineSeriesSonificationContextTracksMappingPlayDelayWithin Within { get; set; }
		private AreasplineSeriesSonificationContextTracksMappingPlayDelayWithin Within_DefaultValue { get; set; }
