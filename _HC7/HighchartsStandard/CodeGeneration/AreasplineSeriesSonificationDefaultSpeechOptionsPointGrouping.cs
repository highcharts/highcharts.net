...
{
	public partial class AreasplineSeriesSonificationDefaultSpeechOptionsPointGrouping  : BaseObject
	{
		Hashtable h = new Hashtable();

		public AreasplineSeriesSonificationDefaultSpeechOptionsPointGrouping()
		{
		...
		/// </summary>
		public AreasplineSeriesSonificationDefaultSpeechOptionsPointGroupingAlgorithm Algorithm { get; set; }
		private AreasplineSeriesSonificationDefaultSpeechOptionsPointGroupingAlgorithm Algorithm_DefaultValue { get; set; }
		...
		internal override Hashtable ToHashtable(Highcharts highcharts)
		{
			...
			if (Algorithm != AreasplineSeriesSonificationDefaultSpeechOptionsPointGroupingAlgorithm.Null) h.Add("algorithm", highcharts.FirstCharacterToLower(Algorithm.ToString()));
