...
{
	public partial class AreasplineSeriesSonificationPointGrouping  : BaseObject
	{
		Hashtable h = new Hashtable();

		public AreasplineSeriesSonificationPointGrouping()
		{
		...
		/// </summary>
		public AreasplineSeriesSonificationPointGroupingAlgorithm Algorithm { get; set; }
		private AreasplineSeriesSonificationPointGroupingAlgorithm Algorithm_DefaultValue { get; set; }
		...
		internal override Hashtable ToHashtable(Highcharts highcharts)
		{
			...
			if (Algorithm != AreasplineSeriesSonificationPointGroupingAlgorithm.Null) h.Add("algorithm", highcharts.FirstCharacterToLower(Algorithm.ToString()));
