...
{
	public partial class AreasplineSeriesSonificationTracksMappingFrequency  : BaseObject
	{
		Hashtable h = new Hashtable();

		public AreasplineSeriesSonificationTracksMappingFrequency()
		{
			MapFunction = MapFunction_DefaultValue = AreasplineSeriesSonificationTracksMappingFrequencyMapFunction.Linear;
			MapTo = MapTo_DefaultValue = "";
			Max = Max_DefaultValue = null;
			Min = Min_DefaultValue = null;
			Value = Value_DefaultValue = null;
			Within = Within_DefaultValue = AreasplineSeriesSonificationTracksMappingFrequencyWithin.Chart;
		...
		/// </summary>
		public AreasplineSeriesSonificationTracksMappingFrequencyMapFunction MapFunction { get; set; }
		private AreasplineSeriesSonificationTracksMappingFrequencyMapFunction MapFunction_DefaultValue { get; set; }
		...
		/// </summary>
		public AreasplineSeriesSonificationTracksMappingFrequencyWithin Within { get; set; }
		private AreasplineSeriesSonificationTracksMappingFrequencyWithin Within_DefaultValue { get; set; }
