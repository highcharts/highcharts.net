...
{
	public partial class AreasplineSeriesSonificationTracksMappingLowpassResonance  : BaseObject
	{
		Hashtable h = new Hashtable();

		public AreasplineSeriesSonificationTracksMappingLowpassResonance()
		{
			MapFunction = MapFunction_DefaultValue = AreasplineSeriesSonificationTracksMappingLowpassResonanceMapFunction.Linear;
			MapTo = MapTo_DefaultValue = "";
			Max = Max_DefaultValue = null;
			Min = Min_DefaultValue = null;
			Value = Value_DefaultValue = null;
			Within = Within_DefaultValue = AreasplineSeriesSonificationTracksMappingLowpassResonanceWithin.Chart;
		...
		/// </summary>
		public AreasplineSeriesSonificationTracksMappingLowpassResonanceMapFunction MapFunction { get; set; }
		private AreasplineSeriesSonificationTracksMappingLowpassResonanceMapFunction MapFunction_DefaultValue { get; set; }
		...
		/// </summary>
		public AreasplineSeriesSonificationTracksMappingLowpassResonanceWithin Within { get; set; }
		private AreasplineSeriesSonificationTracksMappingLowpassResonanceWithin Within_DefaultValue { get; set; }
