...
{
	public partial class AreasplineSeriesSonificationTracksMappingNoteDuration  : BaseObject
	{
		Hashtable h = new Hashtable();

		public AreasplineSeriesSonificationTracksMappingNoteDuration()
		{
			MapFunction = MapFunction_DefaultValue = AreasplineSeriesSonificationTracksMappingNoteDurationMapFunction.Linear;
			MapTo = MapTo_DefaultValue = "";
			Max = Max_DefaultValue = null;
			Min = Min_DefaultValue = null;
			Value = Value_DefaultValue = null;
			Within = Within_DefaultValue = AreasplineSeriesSonificationTracksMappingNoteDurationWithin.Chart;
		...
		/// </summary>
		public AreasplineSeriesSonificationTracksMappingNoteDurationMapFunction MapFunction { get; set; }
		private AreasplineSeriesSonificationTracksMappingNoteDurationMapFunction MapFunction_DefaultValue { get; set; }
		...
		/// </summary>
		public AreasplineSeriesSonificationTracksMappingNoteDurationWithin Within { get; set; }
		private AreasplineSeriesSonificationTracksMappingNoteDurationWithin Within_DefaultValue { get; set; }
