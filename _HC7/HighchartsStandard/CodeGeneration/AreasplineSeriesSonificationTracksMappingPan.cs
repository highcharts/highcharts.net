...
{
	public partial class AreasplineSeriesSonificationTracksMappingPan  : BaseObject
	{
		Hashtable h = new Hashtable();

		public AreasplineSeriesSonificationTracksMappingPan()
		{
			MapFunction = MapFunction_DefaultValue = AreasplineSeriesSonificationTracksMappingPanMapFunction.Linear;
			MapTo = MapTo_DefaultValue = "";
			Max = Max_DefaultValue = null;
			Min = Min_DefaultValue = null;
			Value = Value_DefaultValue = null;
			Within = Within_DefaultValue = AreasplineSeriesSonificationTracksMappingPanWithin.Chart;
		...
		/// </summary>
		public AreasplineSeriesSonificationTracksMappingPanMapFunction MapFunction { get; set; }
		private AreasplineSeriesSonificationTracksMappingPanMapFunction MapFunction_DefaultValue { get; set; }
		...
		/// </summary>
		public AreasplineSeriesSonificationTracksMappingPanWithin Within { get; set; }
		private AreasplineSeriesSonificationTracksMappingPanWithin Within_DefaultValue { get; set; }
