...
{
	public partial class AreasplineSeriesSonificationTracksMappingPitch  : BaseObject
	{
		Hashtable h = new Hashtable();

		public AreasplineSeriesSonificationTracksMappingPitch()
		{
			MapFunction = MapFunction_DefaultValue = AreasplineSeriesSonificationTracksMappingPitchMapFunction.Linear;
		...
		/// </summary>
		public AreasplineSeriesSonificationTracksMappingPitchMapFunction MapFunction { get; set; }
		private AreasplineSeriesSonificationTracksMappingPitchMapFunction MapFunction_DefaultValue { get; set; }
