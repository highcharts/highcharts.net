...
{
	public partial class AreasplineSeriesSonificationTracksMappingPlayDelay  : BaseObject
	{
		Hashtable h = new Hashtable();

		public AreasplineSeriesSonificationTracksMappingPlayDelay()
		{
			MapFunction = MapFunction_DefaultValue = AreasplineSeriesSonificationTracksMappingPlayDelayMapFunction.Linear;
			MapTo = MapTo_DefaultValue = "";
			Max = Max_DefaultValue = null;
			Min = Min_DefaultValue = null;
			Value = Value_DefaultValue = null;
			Within = Within_DefaultValue = AreasplineSeriesSonificationTracksMappingPlayDelayWithin.Chart;
		...
		/// </summary>
		public AreasplineSeriesSonificationTracksMappingPlayDelayMapFunction MapFunction { get; set; }
		private AreasplineSeriesSonificationTracksMappingPlayDelayMapFunction MapFunction_DefaultValue { get; set; }
		...
		/// </summary>
		public AreasplineSeriesSonificationTracksMappingPlayDelayWithin Within { get; set; }
		private AreasplineSeriesSonificationTracksMappingPlayDelayWithin Within_DefaultValue { get; set; }
