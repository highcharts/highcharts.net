...
{
	public partial class AreasplineSeriesSonificationTracksMappingTime  : BaseObject
	{
		Hashtable h = new Hashtable();

		public AreasplineSeriesSonificationTracksMappingTime()
		{
			MapFunction = MapFunction_DefaultValue = AreasplineSeriesSonificationTracksMappingTimeMapFunction.Linear;
			MapTo = MapTo_DefaultValue = "";
			Max = Max_DefaultValue = null;
			Min = Min_DefaultValue = null;
			Value = Value_DefaultValue = null;
			Within = Within_DefaultValue = AreasplineSeriesSonificationTracksMappingTimeWithin.Chart;
		...
		/// </summary>
		public AreasplineSeriesSonificationTracksMappingTimeMapFunction MapFunction { get; set; }
		private AreasplineSeriesSonificationTracksMappingTimeMapFunction MapFunction_DefaultValue { get; set; }
		...
		/// </summary>
		public AreasplineSeriesSonificationTracksMappingTimeWithin Within { get; set; }
		private AreasplineSeriesSonificationTracksMappingTimeWithin Within_DefaultValue { get; set; }
