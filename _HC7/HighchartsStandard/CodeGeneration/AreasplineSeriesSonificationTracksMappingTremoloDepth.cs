...
{
	public partial class AreasplineSeriesSonificationTracksMappingTremoloDepth  : BaseObject
	{
		Hashtable h = new Hashtable();

		public AreasplineSeriesSonificationTracksMappingTremoloDepth()
		{
			MapFunction = MapFunction_DefaultValue = AreasplineSeriesSonificationTracksMappingTremoloDepthMapFunction.Linear;
			MapTo = MapTo_DefaultValue = "";
			Max = Max_DefaultValue = null;
			Min = Min_DefaultValue = null;
			Value = Value_DefaultValue = null;
			Within = Within_DefaultValue = AreasplineSeriesSonificationTracksMappingTremoloDepthWithin.Chart;
		...
		/// </summary>
		public AreasplineSeriesSonificationTracksMappingTremoloDepthMapFunction MapFunction { get; set; }
		private AreasplineSeriesSonificationTracksMappingTremoloDepthMapFunction MapFunction_DefaultValue { get; set; }
		...
		/// </summary>
		public AreasplineSeriesSonificationTracksMappingTremoloDepthWithin Within { get; set; }
		private AreasplineSeriesSonificationTracksMappingTremoloDepthWithin Within_DefaultValue { get; set; }
