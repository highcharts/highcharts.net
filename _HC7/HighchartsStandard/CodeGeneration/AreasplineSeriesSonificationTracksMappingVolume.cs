...
{
	public partial class AreasplineSeriesSonificationTracksMappingVolume  : BaseObject
	{
		Hashtable h = new Hashtable();

		public AreasplineSeriesSonificationTracksMappingVolume()
		{
			MapFunction = MapFunction_DefaultValue = AreasplineSeriesSonificationTracksMappingVolumeMapFunction.Linear;
			MapTo = MapTo_DefaultValue = "";
			Max = Max_DefaultValue = null;
			Min = Min_DefaultValue = null;
			Value = Value_DefaultValue = null;
			Within = Within_DefaultValue = AreasplineSeriesSonificationTracksMappingVolumeWithin.Chart;
		...
		/// </summary>
		public AreasplineSeriesSonificationTracksMappingVolumeMapFunction MapFunction { get; set; }
		private AreasplineSeriesSonificationTracksMappingVolumeMapFunction MapFunction_DefaultValue { get; set; }
		...
		/// </summary>
		public AreasplineSeriesSonificationTracksMappingVolumeWithin Within { get; set; }
		private AreasplineSeriesSonificationTracksMappingVolumeWithin Within_DefaultValue { get; set; }
