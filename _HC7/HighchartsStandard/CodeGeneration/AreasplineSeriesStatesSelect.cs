...
{
	public partial class AreasplineSeriesStatesSelect  : BaseObject
	{
		Hashtable h = new Hashtable();

		public AreasplineSeriesStatesSelect()
		{
			Animation = Animation_DefaultValue = new Animation();
			Enabled = Enabled_DefaultValue = null;
			Halo = Halo_DefaultValue = new AreasplineSeriesStatesSelectHalo();
			LineWidth = LineWidth_DefaultValue = null;
			LineWidthPlus = LineWidthPlus_DefaultValue = null;
			Marker = Marker_DefaultValue = new AreasplineSeriesStatesSelectMarker();
		...
		/// </summary>
		public AreasplineSeriesStatesSelectHalo Halo { get; set; }
		private AreasplineSeriesStatesSelectHalo Halo_DefaultValue { get; set; }
		...
		/// </summary>
		public AreasplineSeriesStatesSelectMarker Marker { get; set; }
		private AreasplineSeriesStatesSelectMarker Marker_DefaultValue { get; set; }
