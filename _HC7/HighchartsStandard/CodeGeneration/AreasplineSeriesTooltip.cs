...
{
	public partial class AreasplineSeriesTooltip  : BaseObject
	{
		public AreasplineSeriesTooltip()
		{
			...
			HeaderShape = HeaderShape_DefaultValue = AreasplineSeriesTooltipHeaderShape.Callout;
		...
		/// </summary>
		public AreasplineSeriesTooltipHeaderShape HeaderShape { get; set; }
		private AreasplineSeriesTooltipHeaderShape HeaderShape_DefaultValue { get; set; }
		...
		internal override Hashtable ToHashtable()
		{
			...
			if (NullFormatter != NullFormatter_DefaultValue) { h.Add("nullFormatter",NullFormatter); Highcharts.AddFunction("AreasplineSeriesTooltipNullFormatter.nullFormatter", NullFormatter); }  
			if (Outside != Outside_DefaultValue) h.Add("outside",Outside);
			if (Padding != Padding_DefaultValue) h.Add("padding",Padding);
			if (PointFormat != PointFormat_DefaultValue) h.Add("pointFormat",PointFormat);
			if (PointFormatter != PointFormatter_DefaultValue) { h.Add("pointFormatter",PointFormatter); Highcharts.AddFunction("AreasplineSeriesTooltipPointFormatter.pointFormatter", PointFormatter); }  
