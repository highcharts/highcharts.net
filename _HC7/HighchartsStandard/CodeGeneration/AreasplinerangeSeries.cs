...
namespace Highsoft.Web.Mvc.Charts
{
	public partial class AreasplinerangeSeries  : Series
	{
		...
		internal override Hashtable ToHashtable()
		{
			...
			if (PointDescriptionFormatter != PointDescriptionFormatter_DefaultValue) { h.Add("pointDescriptionFormatter",PointDescriptionFormatter); Highcharts.AddFunction("89b93945-3f66-49d0-aa4e-e159c30ecd3d.pointDescriptionFormatter", PointDescriptionFormatter); }  
