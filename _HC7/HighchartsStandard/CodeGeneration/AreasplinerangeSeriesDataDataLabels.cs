...
{
	public partial class AreasplinerangeSeriesDataDataLabels  : BaseObject
	{
		Hashtable h = new Hashtable();

		public AreasplinerangeSeriesDataDataLabels()
		{
		...
		/// </summary>
		public AreasplinerangeSeriesDataDataLabelsAlign Align { get; set; }
		private AreasplinerangeSeriesDataDataLabelsAlign Align_DefaultValue { get; set; }
		...
		/// </summary>
		public AreasplinerangeSeriesDataDataLabelsFilter Filter { get; set; }
		private AreasplinerangeSeriesDataDataLabelsFilter Filter_DefaultValue { get; set; }
		...
		/// </summary>
		public AreasplinerangeSeriesDataDataLabelsOverflow Overflow { get; set; }
		private AreasplinerangeSeriesDataDataLabelsOverflow Overflow_DefaultValue { get; set; }
		...
		/// </summary>
		public AreasplinerangeSeriesDataDataLabelsPosition Position { get; set; }
		private AreasplinerangeSeriesDataDataLabelsPosition Position_DefaultValue { get; set; }
		...
		/// </summary>
		public AreasplinerangeSeriesDataDataLabelsTextPath TextPath { get; set; }
		private AreasplinerangeSeriesDataDataLabelsTextPath TextPath_DefaultValue { get; set; }
		...
		/// </summary>
		public AreasplinerangeSeriesDataDataLabelsVerticalAlign VerticalAlign { get; set; }
		private AreasplinerangeSeriesDataDataLabelsVerticalAlign VerticalAlign_DefaultValue { get; set; }
		...
		internal override Hashtable ToHashtable(Highcharts highcharts)
		{
			...
			if (Align != AreasplinerangeSeriesDataDataLabelsAlign.Null) h.Add("align", highcharts.FirstCharacterToLower(Align.ToString()));
			...
			if (Overflow != AreasplinerangeSeriesDataDataLabelsOverflow.Null) h.Add("overflow", highcharts.FirstCharacterToLower(Overflow.ToString()));
			if (Padding != null) h.Add("padding",Padding);
			if (Position != AreasplinerangeSeriesDataDataLabelsPosition.Null) h.Add("position", highcharts.FirstCharacterToLower(Position.ToString()));
			...
			if (VerticalAlign != AreasplinerangeSeriesDataDataLabelsVerticalAlign.Null) h.Add("verticalAlign", highcharts.FirstCharacterToLower(VerticalAlign.ToString()));
			if (X != null) h.Add("x",X);
			if (Y != null) h.Add("y",Y);
