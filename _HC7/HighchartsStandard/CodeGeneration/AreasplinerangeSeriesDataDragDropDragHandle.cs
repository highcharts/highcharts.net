...
{
	public partial class AreasplinerangeSeriesDataDragDropDragHandle  : BaseObject
	{
		public AreasplinerangeSeriesDataDragDropDragHandle()
		{
		...
		internal override Hashtable ToHashtable()
		{
			...
			if (PathFormatter != PathFormatter_DefaultValue) { h.Add("pathFormatter",PathFormatter); Highcharts.AddFunction("AreasplinerangeSeriesDataDragDropDragHandlePathFormatter.pathFormatter", PathFormatter); }  
