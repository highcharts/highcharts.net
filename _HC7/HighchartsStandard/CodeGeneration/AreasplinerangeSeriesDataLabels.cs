...
{
	public partial class AreasplinerangeSeriesDataLabels  : BaseObject
	{
		...
		/// </summary>
		public AreasplinerangeSeriesDataLabelsFilter Filter { get; set; }
		private AreasplinerangeSeriesDataLabelsFilter Filter_DefaultValue { get; set; }
		...
		/// </summary>
		public AreasplinerangeSeriesDataLabelsOverflow Overflow { get; set; }
		private AreasplinerangeSeriesDataLabelsOverflow Overflow_DefaultValue { get; set; }
		...
		/// </summary>
		public AreasplinerangeSeriesDataLabelsPosition Position { get; set; }
		private AreasplinerangeSeriesDataLabelsPosition Position_DefaultValue { get; set; }
		...
		/// </summary>
		public AreasplinerangeSeriesDataLabelsTextPath TextPath { get; set; }
		private AreasplinerangeSeriesDataLabelsTextPath TextPath_DefaultValue { get; set; }
		...
		internal override Hashtable ToHashtable(Highcharts highcharts)
		{
			...
			if (Align != AreasplinerangeSeriesDataLabelsAlign.Null) h.Add("align", highcharts.FirstCharacterToLower(Align.ToString()));
			...
			if (Overflow != AreasplinerangeSeriesDataLabelsOverflow.Null) h.Add("overflow", highcharts.FirstCharacterToLower(Overflow.ToString()));
			if (Padding != null) h.Add("padding",Padding);
			if (Position != AreasplinerangeSeriesDataLabelsPosition.Null) h.Add("position", highcharts.FirstCharacterToLower(Position.ToString()));
			...
			if (VerticalAlign != AreasplinerangeSeriesDataLabelsVerticalAlign.Null) h.Add("verticalAlign", highcharts.FirstCharacterToLower(VerticalAlign.ToString()));
			if (X != null) h.Add("x",X);
			if (Y != null) h.Add("y",Y);
