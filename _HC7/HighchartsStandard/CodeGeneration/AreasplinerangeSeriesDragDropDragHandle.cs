...
{
	public partial class AreasplinerangeSeriesDragDropDragHandle  : BaseObject
	{
		public AreasplinerangeSeriesDragDropDragHandle()
		{
		...
		internal override Hashtable ToHashtable()
		{
			...
			if (PathFormatter != PathFormatter_DefaultValue) { h.Add("pathFormatter",PathFormatter); Highcharts.AddFunction("AreasplinerangeSeriesDragDropDragHandlePathFormatter.pathFormatter", PathFormatter); }  
