...
{
	public partial class AreasplinerangeSeriesLowMarker  : BaseObject
	{
		Hashtable h = new Hashtable();

		public AreasplinerangeSeriesLowMarker()
		{
			...
			States = States_DefaultValue = new AreasplinerangeSeriesLowMarkerStates();
		...
		/// </summary>
		public AreasplinerangeSeriesLowMarkerStates States { get; set; }
		private AreasplinerangeSeriesLowMarkerStates States_DefaultValue { get; set; }
