...
{
	public partial class AreasplinerangeSeriesSonificationContextTracksActiveWhen  : BaseObject
	{
		Hashtable h = new Hashtable();

		public AreasplinerangeSeriesSonificationContextTracksActiveWhen()
		{
