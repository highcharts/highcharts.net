...
{
	public partial class AreasplinerangeSeriesSonificationContextTracksMappingTime  : BaseObject
	{
		Hashtable h = new Hashtable();

		public AreasplinerangeSeriesSonificationContextTracksMappingTime()
		{
			MapFunction = MapFunction_DefaultValue = AreasplinerangeSeriesSonificationContextTracksMappingTimeMapFunction.Linear;
			MapTo = MapTo_DefaultValue = "";
			Max = Max_DefaultValue = null;
			Min = Min_DefaultValue = null;
			Value = Value_DefaultValue = null;
			Within = Within_DefaultValue = AreasplinerangeSeriesSonificationContextTracksMappingTimeWithin.Chart;
		...
		/// </summary>
		public AreasplinerangeSeriesSonificationContextTracksMappingTimeMapFunction MapFunction { get; set; }
		private AreasplinerangeSeriesSonificationContextTracksMappingTimeMapFunction MapFunction_DefaultValue { get; set; }
		...
		/// </summary>
		public AreasplinerangeSeriesSonificationContextTracksMappingTimeWithin Within { get; set; }
		private AreasplinerangeSeriesSonificationContextTracksMappingTimeWithin Within_DefaultValue { get; set; }
