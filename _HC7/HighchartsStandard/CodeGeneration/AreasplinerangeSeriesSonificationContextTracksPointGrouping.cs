...
{
	public partial class AreasplinerangeSeriesSonificationContextTracksPointGrouping  : BaseObject
	{
		Hashtable h = new Hashtable();

		public AreasplinerangeSeriesSonificationContextTracksPointGrouping()
		{
		...
		/// </summary>
		public AreasplinerangeSeriesSonificationContextTracksPointGroupingAlgorithm Algorithm { get; set; }
		private AreasplinerangeSeriesSonificationContextTracksPointGroupingAlgorithm Algorithm_DefaultValue { get; set; }
		...
		internal override Hashtable ToHashtable(Highcharts highcharts)
		{
			...
			if (Algorithm != AreasplinerangeSeriesSonificationContextTracksPointGroupingAlgorithm.Null) h.Add("algorithm", highcharts.FirstCharacterToLower(Algorithm.ToString()));
