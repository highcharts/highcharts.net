...
{
	public partial class AreasplinerangeSeriesSonificationDefaultSpeechOptionsMappingFrequency  : BaseObject
	{
		Hashtable h = new Hashtable();

		public AreasplinerangeSeriesSonificationDefaultSpeechOptionsMappingFrequency()
		{
			MapFunction = MapFunction_DefaultValue = AreasplinerangeSeriesSonificationDefaultSpeechOptionsMappingFrequencyMapFunction.Linear;
			MapTo = MapTo_DefaultValue = "";
			Max = Max_DefaultValue = null;
			Min = Min_DefaultValue = null;
			Value = Value_DefaultValue = null;
			Within = Within_DefaultValue = AreasplinerangeSeriesSonificationDefaultSpeechOptionsMappingFrequencyWithin.Chart;
		...
		/// </summary>
		public AreasplinerangeSeriesSonificationDefaultSpeechOptionsMappingFrequencyMapFunction MapFunction { get; set; }
		private AreasplinerangeSeriesSonificationDefaultSpeechOptionsMappingFrequencyMapFunction MapFunction_DefaultValue { get; set; }
		...
		/// </summary>
		public AreasplinerangeSeriesSonificationDefaultSpeechOptionsMappingFrequencyWithin Within { get; set; }
		private AreasplinerangeSeriesSonificationDefaultSpeechOptionsMappingFrequencyWithin Within_DefaultValue { get; set; }
