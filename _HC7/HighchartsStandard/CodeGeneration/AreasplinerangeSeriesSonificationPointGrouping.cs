...
{
	public partial class AreasplinerangeSeriesSonificationPointGrouping  : BaseObject
	{
		Hashtable h = new Hashtable();

		public AreasplinerangeSeriesSonificationPointGrouping()
		{
		...
		/// </summary>
		public AreasplinerangeSeriesSonificationPointGroupingAlgorithm Algorithm { get; set; }
		private AreasplinerangeSeriesSonificationPointGroupingAlgorithm Algorithm_DefaultValue { get; set; }
		...
		internal override Hashtable ToHashtable(Highcharts highcharts)
		{
			...
			if (Algorithm != AreasplinerangeSeriesSonificationPointGroupingAlgorithm.Null) h.Add("algorithm", highcharts.FirstCharacterToLower(Algorithm.ToString()));
