...
{
	public partial class AreasplinerangeSeriesSonificationTracksPointGrouping  : BaseObject
	{
		Hashtable h = new Hashtable();

		public AreasplinerangeSeriesSonificationTracksPointGrouping()
		{
		...
		/// </summary>
		public AreasplinerangeSeriesSonificationTracksPointGroupingAlgorithm Algorithm { get; set; }
		private AreasplinerangeSeriesSonificationTracksPointGroupingAlgorithm Algorithm_DefaultValue { get; set; }
		...
		internal override Hashtable ToHashtable(Highcharts highcharts)
		{
			...
			if (Algorithm != AreasplinerangeSeriesSonificationTracksPointGroupingAlgorithm.Null) h.Add("algorithm", highcharts.FirstCharacterToLower(Algorithm.ToString()));
