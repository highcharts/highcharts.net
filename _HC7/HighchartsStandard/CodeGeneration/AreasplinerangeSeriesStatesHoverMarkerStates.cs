...
namespace Highsoft.Web.Mvc.Charts
{
	public partial class AreasplinerangeSeriesStatesHoverMarkerStates  : BaseObject
	{
		public AreasplinerangeSeriesStatesHoverMarkerStates()
		{
			...
			Inactive = Inactive_DefaultValue = new AreasplinerangeSeriesStatesHoverMarkerStatesInactive();
		...
		/// 
		/// </summary>
		public AreasplinerangeSeriesStatesHoverMarkerStatesInactive Inactive { get; set; }
		private AreasplinerangeSeriesStatesHoverMarkerStatesInactive Inactive_DefaultValue { get; set; }
