...
{
	public partial class AreasplinerangeSeriesStatesSelect  : BaseObject
	{
		public AreasplinerangeSeriesStatesSelect()
		{
			Animation = Animation_DefaultValue = new Animation() { Enabled = true };
			Enabled = Enabled_DefaultValue = true;
			Halo = Halo_DefaultValue = new AreasplinerangeSeriesStatesSelectHalo();
			LineWidth = LineWidth_DefaultValue = null;
			LineWidthPlus = LineWidthPlus_DefaultValue = 1;
			Marker = Marker_DefaultValue = new AreasplinerangeSeriesStatesSelectMarker();
		...
		/// </summary>
		public AreasplinerangeSeriesStatesSelectHalo Halo { get; set; }
		private AreasplinerangeSeriesStatesSelectHalo Halo_DefaultValue { get; set; }
		...
		/// </summary>
		public AreasplinerangeSeriesStatesSelectMarker Marker { get; set; }
		private AreasplinerangeSeriesStatesSelectMarker Marker_DefaultValue { get; set; }
