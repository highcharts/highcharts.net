...
namespace Highsoft.Web.Mvc.Charts
{
	public partial class AreasplinerangeSeriesZone  : BaseObject
	{
		...
		/// </summary>
		public AreasplinerangeSeriesZonesDashStyle DashStyle { get; set; }
		private AreasplinerangeSeriesZonesDashStyle DashStyle_DefaultValue { get; set; }
		...
		internal override Hashtable ToHashtable(Highcharts highcharts)
		{
			...
			if (DashStyle != AreasplinerangeSeriesZonesDashStyle.Null) h.Add("dashStyle", highcharts.FirstCharacterToLower(DashStyle.ToString()));
