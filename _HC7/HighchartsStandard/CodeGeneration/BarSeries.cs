...
namespace Highsoft.Web.Mvc.Charts
{
	public partial class BarSeries  : Series
	{
		...
		internal override Hashtable ToHashtable()
		{
			...
			if (PointDescriptionFormatter != PointDescriptionFormatter_DefaultValue) { h.Add("pointDescriptionFormatter",PointDescriptionFormatter); Highcharts.AddFunction("d6341df4-c0b7-4f08-a079-894ddfbf6137.pointDescriptionFormatter", PointDescriptionFormatter); }  
