...
{
	public partial class BarSeriesDataDataLabels  : BaseObject
	{
		Hashtable h = new Hashtable();

		public BarSeriesDataDataLabels()
		{
		...
		/// </summary>
		public BarSeriesDataDataLabelsAlign Align { get; set; }
		private BarSeriesDataDataLabelsAlign Align_DefaultValue { get; set; }
		...
		/// </summary>
		public BarSeriesDataDataLabelsFilter Filter { get; set; }
		private BarSeriesDataDataLabelsFilter Filter_DefaultValue { get; set; }
		...
		/// </summary>
		public BarSeriesDataDataLabelsOverflow Overflow { get; set; }
		private BarSeriesDataDataLabelsOverflow Overflow_DefaultValue { get; set; }
		...
		/// </summary>
		public BarSeriesDataDataLabelsPosition Position { get; set; }
		private BarSeriesDataDataLabelsPosition Position_DefaultValue { get; set; }
		...
		/// </summary>
		public BarSeriesDataDataLabelsTextPath TextPath { get; set; }
		private BarSeriesDataDataLabelsTextPath TextPath_DefaultValue { get; set; }
		...
		/// </summary>
		public BarSeriesDataDataLabelsVerticalAlign VerticalAlign { get; set; }
		private BarSeriesDataDataLabelsVerticalAlign VerticalAlign_DefaultValue { get; set; }
		...
		internal override Hashtable ToHashtable(Highcharts highcharts)
		{
			...
			if (Align != BarSeriesDataDataLabelsAlign.Null) h.Add("align", highcharts.FirstCharacterToLower(Align.ToString()));
			...
			if (Overflow != BarSeriesDataDataLabelsOverflow.Null) h.Add("overflow", highcharts.FirstCharacterToLower(Overflow.ToString()));
			if (Padding != null) h.Add("padding",Padding);
			if (Position != BarSeriesDataDataLabelsPosition.Null) h.Add("position", highcharts.FirstCharacterToLower(Position.ToString()));
			...
			if (VerticalAlign != BarSeriesDataDataLabelsVerticalAlign.Null) h.Add("verticalAlign", highcharts.FirstCharacterToLower(VerticalAlign.ToString()));
			if (X != null) h.Add("x",X);
			if (Y != null) h.Add("y",Y);
