...
{
	public partial class BarSeriesSonificationContextTracksMappingFrequency  : BaseObject
	{
		Hashtable h = new Hashtable();

		public BarSeriesSonificationContextTracksMappingFrequency()
		{
			MapFunction = MapFunction_DefaultValue = BarSeriesSonificationContextTracksMappingFrequencyMapFunction.Linear;
			MapTo = MapTo_DefaultValue = "";
			Max = Max_DefaultValue = null;
			Min = Min_DefaultValue = null;
			Value = Value_DefaultValue = null;
			Within = Within_DefaultValue = BarSeriesSonificationContextTracksMappingFrequencyWithin.Chart;
		...
		/// </summary>
		public BarSeriesSonificationContextTracksMappingFrequencyMapFunction MapFunction { get; set; }
		private BarSeriesSonificationContextTracksMappingFrequencyMapFunction MapFunction_DefaultValue { get; set; }
		...
		/// </summary>
		public BarSeriesSonificationContextTracksMappingFrequencyWithin Within { get; set; }
		private BarSeriesSonificationContextTracksMappingFrequencyWithin Within_DefaultValue { get; set; }
