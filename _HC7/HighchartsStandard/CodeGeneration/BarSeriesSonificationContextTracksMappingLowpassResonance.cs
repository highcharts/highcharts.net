...
{
	public partial class BarSeriesSonificationContextTracksMappingLowpassResonance  : BaseObject
	{
		Hashtable h = new Hashtable();

		public BarSeriesSonificationContextTracksMappingLowpassResonance()
		{
			MapFunction = MapFunction_DefaultValue = BarSeriesSonificationContextTracksMappingLowpassResonanceMapFunction.Linear;
			MapTo = MapTo_DefaultValue = "";
			Max = Max_DefaultValue = null;
			Min = Min_DefaultValue = null;
			Value = Value_DefaultValue = null;
			Within = Within_DefaultValue = BarSeriesSonificationContextTracksMappingLowpassResonanceWithin.Chart;
		...
		/// </summary>
		public BarSeriesSonificationContextTracksMappingLowpassResonanceMapFunction MapFunction { get; set; }
		private BarSeriesSonificationContextTracksMappingLowpassResonanceMapFunction MapFunction_DefaultValue { get; set; }
		...
		/// </summary>
		public BarSeriesSonificationContextTracksMappingLowpassResonanceWithin Within { get; set; }
		private BarSeriesSonificationContextTracksMappingLowpassResonanceWithin Within_DefaultValue { get; set; }
