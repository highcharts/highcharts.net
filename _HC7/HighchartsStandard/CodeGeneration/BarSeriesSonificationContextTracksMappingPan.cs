...
{
	public partial class BarSeriesSonificationContextTracksMappingPan  : BaseObject
	{
		Hashtable h = new Hashtable();

		public BarSeriesSonificationContextTracksMappingPan()
		{
			MapFunction = MapFunction_DefaultValue = BarSeriesSonificationContextTracksMappingPanMapFunction.Linear;
			MapTo = MapTo_DefaultValue = "";
			Max = Max_DefaultValue = null;
			Min = Min_DefaultValue = null;
			Value = Value_DefaultValue = null;
			Within = Within_DefaultValue = BarSeriesSonificationContextTracksMappingPanWithin.Chart;
		...
		/// </summary>
		public BarSeriesSonificationContextTracksMappingPanMapFunction MapFunction { get; set; }
		private BarSeriesSonificationContextTracksMappingPanMapFunction MapFunction_DefaultValue { get; set; }
		...
		/// </summary>
		public BarSeriesSonificationContextTracksMappingPanWithin Within { get; set; }
		private BarSeriesSonificationContextTracksMappingPanWithin Within_DefaultValue { get; set; }
