...
{
	public partial class BarSeriesSonificationContextTracksMappingPitch  : BaseObject
	{
		Hashtable h = new Hashtable();

		public BarSeriesSonificationContextTracksMappingPitch()
		{
			MapFunction = MapFunction_DefaultValue = BarSeriesSonificationContextTracksMappingPitchMapFunction.Linear;
		...
		/// </summary>
		public BarSeriesSonificationContextTracksMappingPitchMapFunction MapFunction { get; set; }
		private BarSeriesSonificationContextTracksMappingPitchMapFunction MapFunction_DefaultValue { get; set; }
