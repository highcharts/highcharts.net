...
{
	public partial class BarSeriesSonificationContextTracksMappingTime  : BaseObject
	{
		Hashtable h = new Hashtable();

		public BarSeriesSonificationContextTracksMappingTime()
		{
			MapFunction = MapFunction_DefaultValue = BarSeriesSonificationContextTracksMappingTimeMapFunction.Linear;
			MapTo = MapTo_DefaultValue = "";
			Max = Max_DefaultValue = null;
			Min = Min_DefaultValue = null;
			Value = Value_DefaultValue = null;
			Within = Within_DefaultValue = BarSeriesSonificationContextTracksMappingTimeWithin.Chart;
		...
		/// </summary>
		public BarSeriesSonificationContextTracksMappingTimeMapFunction MapFunction { get; set; }
		private BarSeriesSonificationContextTracksMappingTimeMapFunction MapFunction_DefaultValue { get; set; }
		...
		/// </summary>
		public BarSeriesSonificationContextTracksMappingTimeWithin Within { get; set; }
		private BarSeriesSonificationContextTracksMappingTimeWithin Within_DefaultValue { get; set; }
