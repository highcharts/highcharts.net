...
{
	public partial class BarSeriesSonificationPointGrouping  : BaseObject
	{
		Hashtable h = new Hashtable();

		public BarSeriesSonificationPointGrouping()
		{
		...
		/// </summary>
		public BarSeriesSonificationPointGroupingAlgorithm Algorithm { get; set; }
		private BarSeriesSonificationPointGroupingAlgorithm Algorithm_DefaultValue { get; set; }
		...
		internal override Hashtable ToHashtable(Highcharts highcharts)
		{
			...
			if (Algorithm != BarSeriesSonificationPointGroupingAlgorithm.Null) h.Add("algorithm", highcharts.FirstCharacterToLower(Algorithm.ToString()));
