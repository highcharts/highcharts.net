...
{
	public partial class BarSeriesSonificationTracksMapping  : BaseObject
	{
		Hashtable h = new Hashtable();

		public BarSeriesSonificationTracksMapping()
		{
			Frequency = Frequency_DefaultValue = new BarSeriesSonificationTracksMappingFrequency();
			GapBetweenNotes = GapBetweenNotes_DefaultValue = new BarSeriesSonificationTracksMappingGapBetweenNotes();
			Highpass = Highpass_DefaultValue = new BarSeriesSonificationTracksMappingHighpass();
			Lowpass = Lowpass_DefaultValue = new BarSeriesSonificationTracksMappingLowpass();
			NoteDuration = NoteDuration_DefaultValue = new BarSeriesSonificationTracksMappingNoteDuration();
			Pan = Pan_DefaultValue = new BarSeriesSonificationTracksMappingPan();
			Pitch = Pitch_DefaultValue = new BarSeriesSonificationTracksMappingPitch();
			PitchString = PitchString_DefaultValue = "null";
			PitchNumber = PitchNumber_DefaultValue = null;
			PlayDelay = PlayDelay_DefaultValue = new BarSeriesSonificationTracksMappingPlayDelay();
			Time = Time_DefaultValue = new BarSeriesSonificationTracksMappingTime();
			TimeString = TimeString_DefaultValue = "null";
			TimeNumber = TimeNumber_DefaultValue = null;
			Tremolo = Tremolo_DefaultValue = new BarSeriesSonificationTracksMappingTremolo();
			Volume = Volume_DefaultValue = new BarSeriesSonificationTracksMappingVolume();
		...
		/// </summary>
		public BarSeriesSonificationTracksMappingFrequency Frequency { get; set; }
		private BarSeriesSonificationTracksMappingFrequency Frequency_DefaultValue { get; set; }
		...
		/// </summary>
		public BarSeriesSonificationTracksMappingGapBetweenNotes GapBetweenNotes { get; set; }
		private BarSeriesSonificationTracksMappingGapBetweenNotes GapBetweenNotes_DefaultValue { get; set; }
		...
		/// </summary>
		public BarSeriesSonificationTracksMappingHighpass Highpass { get; set; }
		private BarSeriesSonificationTracksMappingHighpass Highpass_DefaultValue { get; set; }
		...
		/// </summary>
		public BarSeriesSonificationTracksMappingLowpass Lowpass { get; set; }
		private BarSeriesSonificationTracksMappingLowpass Lowpass_DefaultValue { get; set; }
		...
		/// </summary>
		public BarSeriesSonificationTracksMappingNoteDuration NoteDuration { get; set; }
		private BarSeriesSonificationTracksMappingNoteDuration NoteDuration_DefaultValue { get; set; }
		...
		/// </summary>
		public BarSeriesSonificationTracksMappingPan Pan { get; set; }
		private BarSeriesSonificationTracksMappingPan Pan_DefaultValue { get; set; }
		...
		/// </summary>
		public BarSeriesSonificationTracksMappingPitch Pitch { get; set; }
		private BarSeriesSonificationTracksMappingPitch Pitch_DefaultValue { get; set; }
		...
		/// </summary>
		public BarSeriesSonificationTracksMappingPlayDelay PlayDelay { get; set; }
		private BarSeriesSonificationTracksMappingPlayDelay PlayDelay_DefaultValue { get; set; }
		...
		/// </summary>
		public BarSeriesSonificationTracksMappingTime Time { get; set; }
		private BarSeriesSonificationTracksMappingTime Time_DefaultValue { get; set; }
		...
		/// </summary>
		public BarSeriesSonificationTracksMappingTremolo Tremolo { get; set; }
		private BarSeriesSonificationTracksMappingTremolo Tremolo_DefaultValue { get; set; }
		 

		/// <summary>
		/// The volume of notes, from 0 to 1.
		/// </summary>
		public BarSeriesSonificationTracksMappingVolume Volume { get; set; }
		private BarSeriesSonificationTracksMappingVolume Volume_DefaultValue { get; set; }
