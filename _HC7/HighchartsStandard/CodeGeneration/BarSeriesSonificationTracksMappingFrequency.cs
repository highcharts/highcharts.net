...
{
	public partial class BarSeriesSonificationTracksMappingFrequency  : BaseObject
	{
		Hashtable h = new Hashtable();

		public BarSeriesSonificationTracksMappingFrequency()
		{
			MapFunction = MapFunction_DefaultValue = BarSeriesSonificationTracksMappingFrequencyMapFunction.Linear;
			MapTo = MapTo_DefaultValue = "";
			Max = Max_DefaultValue = null;
			Min = Min_DefaultValue = null;
			Value = Value_DefaultValue = null;
			Within = Within_DefaultValue = BarSeriesSonificationTracksMappingFrequencyWithin.Chart;
		...
		/// </summary>
		public BarSeriesSonificationTracksMappingFrequencyMapFunction MapFunction { get; set; }
		private BarSeriesSonificationTracksMappingFrequencyMapFunction MapFunction_DefaultValue { get; set; }
		...
		/// </summary>
		public BarSeriesSonificationTracksMappingFrequencyWithin Within { get; set; }
		private BarSeriesSonificationTracksMappingFrequencyWithin Within_DefaultValue { get; set; }
