...
{
	public partial class BarSeriesSonificationTracksMappingLowpassResonance  : BaseObject
	{
		Hashtable h = new Hashtable();

		public BarSeriesSonificationTracksMappingLowpassResonance()
		{
			MapFunction = MapFunction_DefaultValue = BarSeriesSonificationTracksMappingLowpassResonanceMapFunction.Linear;
			MapTo = MapTo_DefaultValue = "";
			Max = Max_DefaultValue = null;
			Min = Min_DefaultValue = null;
			Value = Value_DefaultValue = null;
			Within = Within_DefaultValue = BarSeriesSonificationTracksMappingLowpassResonanceWithin.Chart;
		...
		/// </summary>
		public BarSeriesSonificationTracksMappingLowpassResonanceMapFunction MapFunction { get; set; }
		private BarSeriesSonificationTracksMappingLowpassResonanceMapFunction MapFunction_DefaultValue { get; set; }
		...
		/// </summary>
		public BarSeriesSonificationTracksMappingLowpassResonanceWithin Within { get; set; }
		private BarSeriesSonificationTracksMappingLowpassResonanceWithin Within_DefaultValue { get; set; }
