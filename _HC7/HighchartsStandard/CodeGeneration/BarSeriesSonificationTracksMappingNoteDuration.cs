...
{
	public partial class BarSeriesSonificationTracksMappingNoteDuration  : BaseObject
	{
		Hashtable h = new Hashtable();

		public BarSeriesSonificationTracksMappingNoteDuration()
		{
			MapFunction = MapFunction_DefaultValue = BarSeriesSonificationTracksMappingNoteDurationMapFunction.Linear;
			MapTo = MapTo_DefaultValue = "";
			Max = Max_DefaultValue = null;
			Min = Min_DefaultValue = null;
			Value = Value_DefaultValue = null;
			Within = Within_DefaultValue = BarSeriesSonificationTracksMappingNoteDurationWithin.Chart;
		...
		/// </summary>
		public BarSeriesSonificationTracksMappingNoteDurationMapFunction MapFunction { get; set; }
		private BarSeriesSonificationTracksMappingNoteDurationMapFunction MapFunction_DefaultValue { get; set; }
		...
		/// </summary>
		public BarSeriesSonificationTracksMappingNoteDurationWithin Within { get; set; }
		private BarSeriesSonificationTracksMappingNoteDurationWithin Within_DefaultValue { get; set; }
