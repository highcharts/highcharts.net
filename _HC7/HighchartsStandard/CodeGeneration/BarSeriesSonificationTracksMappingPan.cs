...
{
	public partial class BarSeriesSonificationTracksMappingPan  : BaseObject
	{
		Hashtable h = new Hashtable();

		public BarSeriesSonificationTracksMappingPan()
		{
			MapFunction = MapFunction_DefaultValue = BarSeriesSonificationTracksMappingPanMapFunction.Linear;
			MapTo = MapTo_DefaultValue = "";
			Max = Max_DefaultValue = null;
			Min = Min_DefaultValue = null;
			Value = Value_DefaultValue = null;
			Within = Within_DefaultValue = BarSeriesSonificationTracksMappingPanWithin.Chart;
		...
		/// </summary>
		public BarSeriesSonificationTracksMappingPanMapFunction MapFunction { get; set; }
		private BarSeriesSonificationTracksMappingPanMapFunction MapFunction_DefaultValue { get; set; }
		...
		/// </summary>
		public BarSeriesSonificationTracksMappingPanWithin Within { get; set; }
		private BarSeriesSonificationTracksMappingPanWithin Within_DefaultValue { get; set; }
