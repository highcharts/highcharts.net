...
{
	public partial class BarSeriesSonificationTracksMappingPitch  : BaseObject
	{
		Hashtable h = new Hashtable();

		public BarSeriesSonificationTracksMappingPitch()
		{
			MapFunction = MapFunction_DefaultValue = BarSeriesSonificationTracksMappingPitchMapFunction.Linear;
		...
		/// </summary>
		public BarSeriesSonificationTracksMappingPitchMapFunction MapFunction { get; set; }
		private BarSeriesSonificationTracksMappingPitchMapFunction MapFunction_DefaultValue { get; set; }
