...
{
	public partial class BarSeriesSonificationTracksMappingPlayDelay  : BaseObject
	{
		Hashtable h = new Hashtable();

		public BarSeriesSonificationTracksMappingPlayDelay()
		{
			MapFunction = MapFunction_DefaultValue = BarSeriesSonificationTracksMappingPlayDelayMapFunction.Linear;
			MapTo = MapTo_DefaultValue = "";
			Max = Max_DefaultValue = null;
			Min = Min_DefaultValue = null;
			Value = Value_DefaultValue = null;
			Within = Within_DefaultValue = BarSeriesSonificationTracksMappingPlayDelayWithin.Chart;
		...
		/// </summary>
		public BarSeriesSonificationTracksMappingPlayDelayMapFunction MapFunction { get; set; }
		private BarSeriesSonificationTracksMappingPlayDelayMapFunction MapFunction_DefaultValue { get; set; }
		...
		/// </summary>
		public BarSeriesSonificationTracksMappingPlayDelayWithin Within { get; set; }
		private BarSeriesSonificationTracksMappingPlayDelayWithin Within_DefaultValue { get; set; }
