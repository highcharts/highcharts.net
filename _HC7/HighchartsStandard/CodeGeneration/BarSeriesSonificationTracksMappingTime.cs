...
{
	public partial class BarSeriesSonificationTracksMappingTime  : BaseObject
	{
		Hashtable h = new Hashtable();

		public BarSeriesSonificationTracksMappingTime()
		{
			MapFunction = MapFunction_DefaultValue = BarSeriesSonificationTracksMappingTimeMapFunction.Linear;
			MapTo = MapTo_DefaultValue = "";
			Max = Max_DefaultValue = null;
			Min = Min_DefaultValue = null;
			Value = Value_DefaultValue = null;
			Within = Within_DefaultValue = BarSeriesSonificationTracksMappingTimeWithin.Chart;
		...
		/// </summary>
		public BarSeriesSonificationTracksMappingTimeMapFunction MapFunction { get; set; }
		private BarSeriesSonificationTracksMappingTimeMapFunction MapFunction_DefaultValue { get; set; }
		...
		/// </summary>
		public BarSeriesSonificationTracksMappingTimeWithin Within { get; set; }
		private BarSeriesSonificationTracksMappingTimeWithin Within_DefaultValue { get; set; }
