...
{
	public partial class BarSeriesSonificationTracksMappingVolume  : BaseObject
	{
		Hashtable h = new Hashtable();

		public BarSeriesSonificationTracksMappingVolume()
		{
			MapFunction = MapFunction_DefaultValue = BarSeriesSonificationTracksMappingVolumeMapFunction.Linear;
			MapTo = MapTo_DefaultValue = "";
			Max = Max_DefaultValue = null;
			Min = Min_DefaultValue = null;
			Value = Value_DefaultValue = null;
			Within = Within_DefaultValue = BarSeriesSonificationTracksMappingVolumeWithin.Chart;
		...
		/// </summary>
		public BarSeriesSonificationTracksMappingVolumeMapFunction MapFunction { get; set; }
		private BarSeriesSonificationTracksMappingVolumeMapFunction MapFunction_DefaultValue { get; set; }
		...
		/// </summary>
		public BarSeriesSonificationTracksMappingVolumeWithin Within { get; set; }
		private BarSeriesSonificationTracksMappingVolumeWithin Within_DefaultValue { get; set; }
