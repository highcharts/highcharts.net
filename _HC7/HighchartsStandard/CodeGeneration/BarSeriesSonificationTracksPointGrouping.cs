...
{
	public partial class BarSeriesSonificationTracksPointGrouping  : BaseObject
	{
		Hashtable h = new Hashtable();

		public BarSeriesSonificationTracksPointGrouping()
		{
		...
		/// </summary>
		public BarSeriesSonificationTracksPointGroupingAlgorithm Algorithm { get; set; }
		private BarSeriesSonificationTracksPointGroupingAlgorithm Algorithm_DefaultValue { get; set; }
		...
		internal override Hashtable ToHashtable(Highcharts highcharts)
		{
			...
			if (Algorithm != BarSeriesSonificationTracksPointGroupingAlgorithm.Null) h.Add("algorithm", highcharts.FirstCharacterToLower(Algorithm.ToString()));
