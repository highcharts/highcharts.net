...
namespace Highsoft.Web.Mvc.Charts
{
	public partial class BellcurveSeries  : Series
	{
		...
		public BellcurveSeries()
		{
			...
			Dumbell = Dumbell_DefaultValue = new BellcurveSeriesDumbell();
			...
			OnPoint = OnPoint_DefaultValue = new BellcurveSeriesOnPoint();
			...
			Sonification = Sonification_DefaultValue = new BellcurveSeriesSonification();
		...
		/// 
		/// </summary>
		public BellcurveSeriesDumbell Dumbell { get; set; }
		private BellcurveSeriesDumbell Dumbell_DefaultValue { get; set; }
