...
namespace Highsoft.Web.Mvc.Charts
{
	public partial class BellcurveSeries  : Series
	{
		...
		/// </summary>
		public BellcurveSeriesLegendSymbol LegendSymbol { get; set; }
		private BellcurveSeriesLegendSymbol LegendSymbol_DefaultValue { get; set; }
		...
		/// </summary>
		public BellcurveSeriesOnPoint OnPoint { get; set; }
		private BellcurveSeriesOnPoint OnPoint_DefaultValue { get; set; }
		...
		/// </summary>
		public BellcurveSeriesPointPlacement PointPlacement { get; set; }
		private BellcurveSeriesPointPlacement PointPlacement_DefaultValue { get; set; }
		...
		/// </summary>
		public BellcurveSeriesSonification Sonification { get; set; }
		private BellcurveSeriesSonification Sonification_DefaultValue { get; set; }
		...
		internal override Hashtable ToHashtable(Highcharts highcharts)
		{
			...
			if (Cursor != BellcurveSeriesCursor.Null) h.Add("cursor", highcharts.FirstCharacterToLower(Cursor.ToString()));
			if (Custom != null) h.Add("custom",Custom);
			if (DashStyle != BellcurveSeriesDashStyle.Null) h.Add("dashStyle", highcharts.FirstCharacterToLower(DashStyle.ToString()));
			...
			if (FindNearestPointBy != BellcurveSeriesFindNearestPointBy.Null) h.Add("findNearestPointBy", highcharts.FirstCharacterToLower(FindNearestPointBy.ToString()));
			...
			if (LegendSymbol != BellcurveSeriesLegendSymbol.Null) h.Add("legendSymbol", highcharts.FirstCharacterToLower(LegendSymbol.ToString()));
			if (Linecap != BellcurveSeriesLinecap.Null) h.Add("linecap", highcharts.FirstCharacterToLower(Linecap.ToString()));
			...
			if (PointPlacement != BellcurveSeriesPointPlacement.Null) h.Add("pointPlacement", highcharts.FirstCharacterToLower(PointPlacement.ToString()));
