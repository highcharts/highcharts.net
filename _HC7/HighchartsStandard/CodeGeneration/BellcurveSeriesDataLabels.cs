...
namespace Highsoft.Web.Mvc.Charts
{
	public partial class BellcurveSeriesDataLabels  : BaseObject
	{
		...
		/// </summary>
		public BellcurveSeriesDataLabelsOverflow Overflow { get; set; }
		private BellcurveSeriesDataLabelsOverflow Overflow_DefaultValue { get; set; }
		...
		/// </summary>
		public BellcurveSeriesDataLabelsPosition Position { get; set; }
		private BellcurveSeriesDataLabelsPosition Position_DefaultValue { get; set; }
		...
		internal override Hashtable ToHashtable(Highcharts highcharts)
		{
			...
			if (Align != BellcurveSeriesDataLabelsAlign.Null) h.Add("align", highcharts.FirstCharacterToLower(Align.ToString()));
			...
			if (Overflow != BellcurveSeriesDataLabelsOverflow.Null) h.Add("overflow", highcharts.FirstCharacterToLower(Overflow.ToString()));
			if (Padding != null) h.Add("padding",Padding);
			if (Position != BellcurveSeriesDataLabelsPosition.Null) h.Add("position", highcharts.FirstCharacterToLower(Position.ToString()));
			...
			if (VerticalAlign != BellcurveSeriesDataLabelsVerticalAlign.Null) h.Add("verticalAlign", highcharts.FirstCharacterToLower(VerticalAlign.ToString()));
			if (X != null) h.Add("x",X);
			if (Y != null) h.Add("y",Y);
