...
{
	public partial class BellcurveSeriesDragDrop  : BaseObject
	{
		public BellcurveSeriesDragDrop()
		{
			DraggableX = DraggableX_DefaultValue = null;
			DraggableY = DraggableY_DefaultValue = null;
			DragHandle = DragHandle_DefaultValue = new BellcurveSeriesDragDropDragHandle();
			...
			GuideBox = GuideBox_DefaultValue = new BellcurveSeriesDragDropGuideBox();
		...
		/// </summary>
		public BellcurveSeriesDragDropDragHandle DragHandle { get; set; }
		private BellcurveSeriesDragDropDragHandle DragHandle_DefaultValue { get; set; }
		...
		/// </summary>
		public BellcurveSeriesDragDropGuideBox GuideBox { get; set; }
		private BellcurveSeriesDragDropGuideBox GuideBox_DefaultValue { get; set; }
