...
{
	public partial class BellcurveSeriesSonificationContextTracksMapping  : BaseObject
	{
		Hashtable h = new Hashtable();

		public BellcurveSeriesSonificationContextTracksMapping()
		{
			Frequency = Frequency_DefaultValue = new BellcurveSeriesSonificationContextTracksMappingFrequency();
			GapBetweenNotes = GapBetweenNotes_DefaultValue = new BellcurveSeriesSonificationContextTracksMappingGapBetweenNotes();
			Highpass = Highpass_DefaultValue = new BellcurveSeriesSonificationContextTracksMappingHighpass();
			Lowpass = Lowpass_DefaultValue = new BellcurveSeriesSonificationContextTracksMappingLowpass();
			NoteDuration = NoteDuration_DefaultValue = new BellcurveSeriesSonificationContextTracksMappingNoteDuration();
			Pan = Pan_DefaultValue = new BellcurveSeriesSonificationContextTracksMappingPan();
			Pitch = Pitch_DefaultValue = new BellcurveSeriesSonificationContextTracksMappingPitch();
			PitchString = PitchString_DefaultValue = "null";
			PitchNumber = PitchNumber_DefaultValue = null;
			PlayDelay = PlayDelay_DefaultValue = new BellcurveSeriesSonificationContextTracksMappingPlayDelay();
			Time = Time_DefaultValue = new BellcurveSeriesSonificationContextTracksMappingTime();
			TimeString = TimeString_DefaultValue = "null";
			TimeNumber = TimeNumber_DefaultValue = null;
			Tremolo = Tremolo_DefaultValue = new BellcurveSeriesSonificationContextTracksMappingTremolo();
			Volume = Volume_DefaultValue = new BellcurveSeriesSonificationContextTracksMappingVolume();
		...
		/// </summary>
		public BellcurveSeriesSonificationContextTracksMappingFrequency Frequency { get; set; }
		private BellcurveSeriesSonificationContextTracksMappingFrequency Frequency_DefaultValue { get; set; }
		...
		/// </summary>
		public BellcurveSeriesSonificationContextTracksMappingGapBetweenNotes GapBetweenNotes { get; set; }
		private BellcurveSeriesSonificationContextTracksMappingGapBetweenNotes GapBetweenNotes_DefaultValue { get; set; }
		...
		/// </summary>
		public BellcurveSeriesSonificationContextTracksMappingHighpass Highpass { get; set; }
		private BellcurveSeriesSonificationContextTracksMappingHighpass Highpass_DefaultValue { get; set; }
		...
		/// </summary>
		public BellcurveSeriesSonificationContextTracksMappingLowpass Lowpass { get; set; }
		private BellcurveSeriesSonificationContextTracksMappingLowpass Lowpass_DefaultValue { get; set; }
		...
		/// </summary>
		public BellcurveSeriesSonificationContextTracksMappingNoteDuration NoteDuration { get; set; }
		private BellcurveSeriesSonificationContextTracksMappingNoteDuration NoteDuration_DefaultValue { get; set; }
		...
		/// </summary>
		public BellcurveSeriesSonificationContextTracksMappingPan Pan { get; set; }
		private BellcurveSeriesSonificationContextTracksMappingPan Pan_DefaultValue { get; set; }
		...
		/// </summary>
		public BellcurveSeriesSonificationContextTracksMappingPitch Pitch { get; set; }
		private BellcurveSeriesSonificationContextTracksMappingPitch Pitch_DefaultValue { get; set; }
		...
		/// </summary>
		public BellcurveSeriesSonificationContextTracksMappingPlayDelay PlayDelay { get; set; }
		private BellcurveSeriesSonificationContextTracksMappingPlayDelay PlayDelay_DefaultValue { get; set; }
		...
		/// </summary>
		public BellcurveSeriesSonificationContextTracksMappingTime Time { get; set; }
		private BellcurveSeriesSonificationContextTracksMappingTime Time_DefaultValue { get; set; }
		...
		/// </summary>
		public BellcurveSeriesSonificationContextTracksMappingTremolo Tremolo { get; set; }
		private BellcurveSeriesSonificationContextTracksMappingTremolo Tremolo_DefaultValue { get; set; }
		 

		/// <summary>
		/// The volume of notes, from 0 to 1.
		/// </summary>
		public BellcurveSeriesSonificationContextTracksMappingVolume Volume { get; set; }
		private BellcurveSeriesSonificationContextTracksMappingVolume Volume_DefaultValue { get; set; }
