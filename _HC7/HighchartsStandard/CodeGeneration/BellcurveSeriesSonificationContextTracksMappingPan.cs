...
{
	public partial class BellcurveSeriesSonificationContextTracksMappingPan  : BaseObject
	{
		Hashtable h = new Hashtable();

		public BellcurveSeriesSonificationContextTracksMappingPan()
		{
			MapFunction = MapFunction_DefaultValue = BellcurveSeriesSonificationContextTracksMappingPanMapFunction.Linear;
			MapTo = MapTo_DefaultValue = "";
			Max = Max_DefaultValue = null;
			Min = Min_DefaultValue = null;
			Value = Value_DefaultValue = null;
			Within = Within_DefaultValue = BellcurveSeriesSonificationContextTracksMappingPanWithin.Chart;
		...
		/// </summary>
		public BellcurveSeriesSonificationContextTracksMappingPanMapFunction MapFunction { get; set; }
		private BellcurveSeriesSonificationContextTracksMappingPanMapFunction MapFunction_DefaultValue { get; set; }
		...
		/// </summary>
		public BellcurveSeriesSonificationContextTracksMappingPanWithin Within { get; set; }
		private BellcurveSeriesSonificationContextTracksMappingPanWithin Within_DefaultValue { get; set; }
