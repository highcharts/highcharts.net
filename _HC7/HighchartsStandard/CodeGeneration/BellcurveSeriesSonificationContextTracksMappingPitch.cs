...
{
	public partial class BellcurveSeriesSonificationContextTracksMappingPitch  : BaseObject
	{
		Hashtable h = new Hashtable();

		public BellcurveSeriesSonificationContextTracksMappingPitch()
		{
			MapFunction = MapFunction_DefaultValue = BellcurveSeriesSonificationContextTracksMappingPitchMapFunction.Linear;
		...
		/// </summary>
		public BellcurveSeriesSonificationContextTracksMappingPitchMapFunction MapFunction { get; set; }
		private BellcurveSeriesSonificationContextTracksMappingPitchMapFunction MapFunction_DefaultValue { get; set; }
