...
{
	public partial class BellcurveSeriesSonificationContextTracksMappingVolume  : BaseObject
	{
		Hashtable h = new Hashtable();

		public BellcurveSeriesSonificationContextTracksMappingVolume()
		{
			MapFunction = MapFunction_DefaultValue = BellcurveSeriesSonificationContextTracksMappingVolumeMapFunction.Linear;
			MapTo = MapTo_DefaultValue = "";
			Max = Max_DefaultValue = null;
			Min = Min_DefaultValue = null;
			Value = Value_DefaultValue = null;
			Within = Within_DefaultValue = BellcurveSeriesSonificationContextTracksMappingVolumeWithin.Chart;
		...
		/// </summary>
		public BellcurveSeriesSonificationContextTracksMappingVolumeMapFunction MapFunction { get; set; }
		private BellcurveSeriesSonificationContextTracksMappingVolumeMapFunction MapFunction_DefaultValue { get; set; }
		...
		/// </summary>
		public BellcurveSeriesSonificationContextTracksMappingVolumeWithin Within { get; set; }
		private BellcurveSeriesSonificationContextTracksMappingVolumeWithin Within_DefaultValue { get; set; }
