...
{
	public partial class BellcurveSeriesSonificationDefaultInstrumentOptionsMappingPitch  : BaseObject
	{
		Hashtable h = new Hashtable();

		public BellcurveSeriesSonificationDefaultInstrumentOptionsMappingPitch()
		{
			MapFunction = MapFunction_DefaultValue = BellcurveSeriesSonificationDefaultInstrumentOptionsMappingPitchMapFunction.Linear;
		...
		/// </summary>
		public BellcurveSeriesSonificationDefaultInstrumentOptionsMappingPitchMapFunction MapFunction { get; set; }
		private BellcurveSeriesSonificationDefaultInstrumentOptionsMappingPitchMapFunction MapFunction_DefaultValue { get; set; }
