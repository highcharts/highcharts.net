...
{
	public partial class BellcurveSeriesSonificationDefaultSpeechOptions  : BaseObject
	{
		Hashtable h = new Hashtable();

		public BellcurveSeriesSonificationDefaultSpeechOptions()
		{
			ActiveWhen = ActiveWhen_DefaultValue = new BellcurveSeriesSonificationDefaultSpeechOptionsActiveWhen();
			Language = Language_DefaultValue = "en-US";
			Mapping = Mapping_DefaultValue = new BellcurveSeriesSonificationDefaultSpeechOptionsMapping();
			PointGrouping = PointGrouping_DefaultValue = new BellcurveSeriesSonificationDefaultSpeechOptionsPointGrouping();
			PreferredVoice = PreferredVoice_DefaultValue = "";
			ShowPlayMarker = ShowPlayMarker_DefaultValue = true;
			Type = Type_DefaultValue = BellcurveSeriesSonificationDefaultSpeechOptionsType.Instrument;
		...
		/// </summary>
		public BellcurveSeriesSonificationDefaultSpeechOptionsActiveWhen ActiveWhen { get; set; }
		private BellcurveSeriesSonificationDefaultSpeechOptionsActiveWhen ActiveWhen_DefaultValue { get; set; }
		...
		/// </summary>
		public BellcurveSeriesSonificationDefaultSpeechOptionsMapping Mapping { get; set; }
		private BellcurveSeriesSonificationDefaultSpeechOptionsMapping Mapping_DefaultValue { get; set; }
		 

		/// <summary>
		/// Options for point grouping, specifically for instrument tracks.
		/// </summary>
		public BellcurveSeriesSonificationDefaultSpeechOptionsPointGrouping PointGrouping { get; set; }
		private BellcurveSeriesSonificationDefaultSpeechOptionsPointGrouping PointGrouping_DefaultValue { get; set; }
		...
		/// </summary>
		public BellcurveSeriesSonificationDefaultSpeechOptionsType Type { get; set; }
		private BellcurveSeriesSonificationDefaultSpeechOptionsType Type_DefaultValue { get; set; }
