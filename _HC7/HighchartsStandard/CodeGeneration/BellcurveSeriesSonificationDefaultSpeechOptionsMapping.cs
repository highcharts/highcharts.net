...
{
	public partial class BellcurveSeriesSonificationDefaultSpeechOptionsMapping  : BaseObject
	{
		Hashtable h = new Hashtable();

		public BellcurveSeriesSonificationDefaultSpeechOptionsMapping()
		{
			Frequency = Frequency_DefaultValue = new BellcurveSeriesSonificationDefaultSpeechOptionsMappingFrequency();
			GapBetweenNotes = GapBetweenNotes_DefaultValue = new BellcurveSeriesSonificationDefaultSpeechOptionsMappingGapBetweenNotes();
			Highpass = Highpass_DefaultValue = new BellcurveSeriesSonificationDefaultSpeechOptionsMappingHighpass();
			Lowpass = Lowpass_DefaultValue = new BellcurveSeriesSonificationDefaultSpeechOptionsMappingLowpass();
			NoteDuration = NoteDuration_DefaultValue = new BellcurveSeriesSonificationDefaultSpeechOptionsMappingNoteDuration();
			Pan = Pan_DefaultValue = new BellcurveSeriesSonificationDefaultSpeechOptionsMappingPan();
			Pitch = Pitch_DefaultValue = new BellcurveSeriesSonificationDefaultSpeechOptionsMappingPitch();
			PitchString = PitchString_DefaultValue = "null";
			PitchNumber = PitchNumber_DefaultValue = null;
			PlayDelay = PlayDelay_DefaultValue = new BellcurveSeriesSonificationDefaultSpeechOptionsMappingPlayDelay();
			Time = Time_DefaultValue = new BellcurveSeriesSonificationDefaultSpeechOptionsMappingTime();
			TimeString = TimeString_DefaultValue = "null";
			TimeNumber = TimeNumber_DefaultValue = null;
			Tremolo = Tremolo_DefaultValue = new BellcurveSeriesSonificationDefaultSpeechOptionsMappingTremolo();
			Volume = Volume_DefaultValue = new BellcurveSeriesSonificationDefaultSpeechOptionsMappingVolume();
		...
		/// </summary>
		public BellcurveSeriesSonificationDefaultSpeechOptionsMappingFrequency Frequency { get; set; }
		private BellcurveSeriesSonificationDefaultSpeechOptionsMappingFrequency Frequency_DefaultValue { get; set; }
		...
		/// </summary>
		public BellcurveSeriesSonificationDefaultSpeechOptionsMappingGapBetweenNotes GapBetweenNotes { get; set; }
		private BellcurveSeriesSonificationDefaultSpeechOptionsMappingGapBetweenNotes GapBetweenNotes_DefaultValue { get; set; }
		...
		/// </summary>
		public BellcurveSeriesSonificationDefaultSpeechOptionsMappingHighpass Highpass { get; set; }
		private BellcurveSeriesSonificationDefaultSpeechOptionsMappingHighpass Highpass_DefaultValue { get; set; }
		...
		/// </summary>
		public BellcurveSeriesSonificationDefaultSpeechOptionsMappingLowpass Lowpass { get; set; }
		private BellcurveSeriesSonificationDefaultSpeechOptionsMappingLowpass Lowpass_DefaultValue { get; set; }
		...
		/// </summary>
		public BellcurveSeriesSonificationDefaultSpeechOptionsMappingNoteDuration NoteDuration { get; set; }
		private BellcurveSeriesSonificationDefaultSpeechOptionsMappingNoteDuration NoteDuration_DefaultValue { get; set; }
		...
		/// </summary>
		public BellcurveSeriesSonificationDefaultSpeechOptionsMappingPan Pan { get; set; }
		private BellcurveSeriesSonificationDefaultSpeechOptionsMappingPan Pan_DefaultValue { get; set; }
		...
		/// </summary>
		public BellcurveSeriesSonificationDefaultSpeechOptionsMappingPitch Pitch { get; set; }
		private BellcurveSeriesSonificationDefaultSpeechOptionsMappingPitch Pitch_DefaultValue { get; set; }
		...
		/// </summary>
		public BellcurveSeriesSonificationDefaultSpeechOptionsMappingPlayDelay PlayDelay { get; set; }
		private BellcurveSeriesSonificationDefaultSpeechOptionsMappingPlayDelay PlayDelay_DefaultValue { get; set; }
		...
		/// </summary>
		public BellcurveSeriesSonificationDefaultSpeechOptionsMappingTime Time { get; set; }
		private BellcurveSeriesSonificationDefaultSpeechOptionsMappingTime Time_DefaultValue { get; set; }
		...
		/// </summary>
		public BellcurveSeriesSonificationDefaultSpeechOptionsMappingTremolo Tremolo { get; set; }
		private BellcurveSeriesSonificationDefaultSpeechOptionsMappingTremolo Tremolo_DefaultValue { get; set; }
		 

		/// <summary>
		/// The volume of notes, from 0 to 1.
		/// </summary>
		public BellcurveSeriesSonificationDefaultSpeechOptionsMappingVolume Volume { get; set; }
		private BellcurveSeriesSonificationDefaultSpeechOptionsMappingVolume Volume_DefaultValue { get; set; }
