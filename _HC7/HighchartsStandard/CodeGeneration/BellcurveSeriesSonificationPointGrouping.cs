...
{
	public partial class BellcurveSeriesSonificationPointGrouping  : BaseObject
	{
		Hashtable h = new Hashtable();

		public BellcurveSeriesSonificationPointGrouping()
		{
		...
		/// </summary>
		public BellcurveSeriesSonificationPointGroupingAlgorithm Algorithm { get; set; }
		private BellcurveSeriesSonificationPointGroupingAlgorithm Algorithm_DefaultValue { get; set; }
		...
		internal override Hashtable ToHashtable(Highcharts highcharts)
		{
			...
			if (Algorithm != BellcurveSeriesSonificationPointGroupingAlgorithm.Null) h.Add("algorithm", highcharts.FirstCharacterToLower(Algorithm.ToString()));
