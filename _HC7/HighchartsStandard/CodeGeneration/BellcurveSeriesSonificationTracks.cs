...
{
	public partial class BellcurveSeriesSonificationTracks  : BaseObject
	{
		Hashtable h = new Hashtable();

		public BellcurveSeriesSonificationTracks()
		{
			ActiveWhen = ActiveWhen_DefaultValue = new BellcurveSeriesSonificationTracksActiveWhen();
			Instrument = Instrument_DefaultValue = null;
			InstrumentString = InstrumentString_DefaultValue = "null";
			Mapping = Mapping_DefaultValue = new BellcurveSeriesSonificationTracksMapping();
			MidiName = MidiName_DefaultValue = "";
			PointGrouping = PointGrouping_DefaultValue = new BellcurveSeriesSonificationTracksPointGrouping();
			RoundToMusicalNotes = RoundToMusicalNotes_DefaultValue = true;
			ShowPlayMarker = ShowPlayMarker_DefaultValue = true;
			Type = Type_DefaultValue = BellcurveSeriesSonificationTracksType.Instrument;
		...
		/// </summary>
		public BellcurveSeriesSonificationTracksActiveWhen ActiveWhen { get; set; }
		private BellcurveSeriesSonificationTracksActiveWhen ActiveWhen_DefaultValue { get; set; }
		...
		/// </summary>
		public BellcurveSeriesSonificationTracksMapping Mapping { get; set; }
		private BellcurveSeriesSonificationTracksMapping Mapping_DefaultValue { get; set; }
		...
		/// </summary>
		public BellcurveSeriesSonificationTracksPointGrouping PointGrouping { get; set; }
		private BellcurveSeriesSonificationTracksPointGrouping PointGrouping_DefaultValue { get; set; }
		...
		/// </summary>
		public BellcurveSeriesSonificationTracksType Type { get; set; }
		private BellcurveSeriesSonificationTracksType Type_DefaultValue { get; set; }
