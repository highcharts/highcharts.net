...
{
	public partial class BellcurveSeriesSonificationTracksMapping  : BaseObject
	{
		Hashtable h = new Hashtable();

		public BellcurveSeriesSonificationTracksMapping()
		{
			Frequency = Frequency_DefaultValue = new BellcurveSeriesSonificationTracksMappingFrequency();
			GapBetweenNotes = GapBetweenNotes_DefaultValue = new BellcurveSeriesSonificationTracksMappingGapBetweenNotes();
			Highpass = Highpass_DefaultValue = new BellcurveSeriesSonificationTracksMappingHighpass();
			Lowpass = Lowpass_DefaultValue = new BellcurveSeriesSonificationTracksMappingLowpass();
			NoteDuration = NoteDuration_DefaultValue = new BellcurveSeriesSonificationTracksMappingNoteDuration();
			Pan = Pan_DefaultValue = new BellcurveSeriesSonificationTracksMappingPan();
			Pitch = Pitch_DefaultValue = new BellcurveSeriesSonificationTracksMappingPitch();
			PitchString = PitchString_DefaultValue = "null";
			PitchNumber = PitchNumber_DefaultValue = null;
			PlayDelay = PlayDelay_DefaultValue = new BellcurveSeriesSonificationTracksMappingPlayDelay();
			Time = Time_DefaultValue = new BellcurveSeriesSonificationTracksMappingTime();
			TimeString = TimeString_DefaultValue = "null";
			TimeNumber = TimeNumber_DefaultValue = null;
			Tremolo = Tremolo_DefaultValue = new BellcurveSeriesSonificationTracksMappingTremolo();
			Volume = Volume_DefaultValue = new BellcurveSeriesSonificationTracksMappingVolume();
		...
		/// </summary>
		public BellcurveSeriesSonificationTracksMappingFrequency Frequency { get; set; }
		private BellcurveSeriesSonificationTracksMappingFrequency Frequency_DefaultValue { get; set; }
		...
		/// </summary>
		public BellcurveSeriesSonificationTracksMappingGapBetweenNotes GapBetweenNotes { get; set; }
		private BellcurveSeriesSonificationTracksMappingGapBetweenNotes GapBetweenNotes_DefaultValue { get; set; }
		...
		/// </summary>
		public BellcurveSeriesSonificationTracksMappingHighpass Highpass { get; set; }
		private BellcurveSeriesSonificationTracksMappingHighpass Highpass_DefaultValue { get; set; }
		...
		/// </summary>
		public BellcurveSeriesSonificationTracksMappingLowpass Lowpass { get; set; }
		private BellcurveSeriesSonificationTracksMappingLowpass Lowpass_DefaultValue { get; set; }
		...
		/// </summary>
		public BellcurveSeriesSonificationTracksMappingNoteDuration NoteDuration { get; set; }
		private BellcurveSeriesSonificationTracksMappingNoteDuration NoteDuration_DefaultValue { get; set; }
		...
		/// </summary>
		public BellcurveSeriesSonificationTracksMappingPan Pan { get; set; }
		private BellcurveSeriesSonificationTracksMappingPan Pan_DefaultValue { get; set; }
		...
		/// </summary>
		public BellcurveSeriesSonificationTracksMappingPitch Pitch { get; set; }
		private BellcurveSeriesSonificationTracksMappingPitch Pitch_DefaultValue { get; set; }
		...
		/// </summary>
		public BellcurveSeriesSonificationTracksMappingPlayDelay PlayDelay { get; set; }
		private BellcurveSeriesSonificationTracksMappingPlayDelay PlayDelay_DefaultValue { get; set; }
		...
		/// </summary>
		public BellcurveSeriesSonificationTracksMappingTime Time { get; set; }
		private BellcurveSeriesSonificationTracksMappingTime Time_DefaultValue { get; set; }
		...
		/// </summary>
		public BellcurveSeriesSonificationTracksMappingTremolo Tremolo { get; set; }
		private BellcurveSeriesSonificationTracksMappingTremolo Tremolo_DefaultValue { get; set; }
		 

		/// <summary>
		/// The volume of notes, from 0 to 1.
		/// </summary>
		public BellcurveSeriesSonificationTracksMappingVolume Volume { get; set; }
		private BellcurveSeriesSonificationTracksMappingVolume Volume_DefaultValue { get; set; }
