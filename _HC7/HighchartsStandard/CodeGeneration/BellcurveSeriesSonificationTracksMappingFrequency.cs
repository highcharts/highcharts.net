...
{
	public partial class BellcurveSeriesSonificationTracksMappingFrequency  : BaseObject
	{
		Hashtable h = new Hashtable();

		public BellcurveSeriesSonificationTracksMappingFrequency()
		{
			MapFunction = MapFunction_DefaultValue = BellcurveSeriesSonificationTracksMappingFrequencyMapFunction.Linear;
			MapTo = MapTo_DefaultValue = "";
			Max = Max_DefaultValue = null;
			Min = Min_DefaultValue = null;
			Value = Value_DefaultValue = null;
			Within = Within_DefaultValue = BellcurveSeriesSonificationTracksMappingFrequencyWithin.Chart;
		...
		/// </summary>
		public BellcurveSeriesSonificationTracksMappingFrequencyMapFunction MapFunction { get; set; }
		private BellcurveSeriesSonificationTracksMappingFrequencyMapFunction MapFunction_DefaultValue { get; set; }
		...
		/// </summary>
		public BellcurveSeriesSonificationTracksMappingFrequencyWithin Within { get; set; }
		private BellcurveSeriesSonificationTracksMappingFrequencyWithin Within_DefaultValue { get; set; }
