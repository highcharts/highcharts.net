...
{
	public partial class BellcurveSeriesSonificationTracksMappingHighpassResonance  : BaseObject
	{
		Hashtable h = new Hashtable();

		public BellcurveSeriesSonificationTracksMappingHighpassResonance()
		{
			MapFunction = MapFunction_DefaultValue = BellcurveSeriesSonificationTracksMappingHighpassResonanceMapFunction.Linear;
			MapTo = MapTo_DefaultValue = "";
			Max = Max_DefaultValue = null;
			Min = Min_DefaultValue = null;
			Value = Value_DefaultValue = null;
			Within = Within_DefaultValue = BellcurveSeriesSonificationTracksMappingHighpassResonanceWithin.Chart;
		...
		/// </summary>
		public BellcurveSeriesSonificationTracksMappingHighpassResonanceMapFunction MapFunction { get; set; }
		private BellcurveSeriesSonificationTracksMappingHighpassResonanceMapFunction MapFunction_DefaultValue { get; set; }
		...
		/// </summary>
		public BellcurveSeriesSonificationTracksMappingHighpassResonanceWithin Within { get; set; }
		private BellcurveSeriesSonificationTracksMappingHighpassResonanceWithin Within_DefaultValue { get; set; }
