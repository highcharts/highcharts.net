...
{
	public partial class BellcurveSeriesSonificationTracksMappingLowpassResonance  : BaseObject
	{
		Hashtable h = new Hashtable();

		public BellcurveSeriesSonificationTracksMappingLowpassResonance()
		{
			MapFunction = MapFunction_DefaultValue = BellcurveSeriesSonificationTracksMappingLowpassResonanceMapFunction.Linear;
			MapTo = MapTo_DefaultValue = "";
			Max = Max_DefaultValue = null;
			Min = Min_DefaultValue = null;
			Value = Value_DefaultValue = null;
			Within = Within_DefaultValue = BellcurveSeriesSonificationTracksMappingLowpassResonanceWithin.Chart;
		...
		/// </summary>
		public BellcurveSeriesSonificationTracksMappingLowpassResonanceMapFunction MapFunction { get; set; }
		private BellcurveSeriesSonificationTracksMappingLowpassResonanceMapFunction MapFunction_DefaultValue { get; set; }
		...
		/// </summary>
		public BellcurveSeriesSonificationTracksMappingLowpassResonanceWithin Within { get; set; }
		private BellcurveSeriesSonificationTracksMappingLowpassResonanceWithin Within_DefaultValue { get; set; }
