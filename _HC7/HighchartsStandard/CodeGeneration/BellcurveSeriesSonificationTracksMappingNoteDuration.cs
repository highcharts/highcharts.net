...
{
	public partial class BellcurveSeriesSonificationTracksMappingNoteDuration  : BaseObject
	{
		Hashtable h = new Hashtable();

		public BellcurveSeriesSonificationTracksMappingNoteDuration()
		{
			MapFunction = MapFunction_DefaultValue = BellcurveSeriesSonificationTracksMappingNoteDurationMapFunction.Linear;
			MapTo = MapTo_DefaultValue = "";
			Max = Max_DefaultValue = null;
			Min = Min_DefaultValue = null;
			Value = Value_DefaultValue = null;
			Within = Within_DefaultValue = BellcurveSeriesSonificationTracksMappingNoteDurationWithin.Chart;
		...
		/// </summary>
		public BellcurveSeriesSonificationTracksMappingNoteDurationMapFunction MapFunction { get; set; }
		private BellcurveSeriesSonificationTracksMappingNoteDurationMapFunction MapFunction_DefaultValue { get; set; }
		...
		/// </summary>
		public BellcurveSeriesSonificationTracksMappingNoteDurationWithin Within { get; set; }
		private BellcurveSeriesSonificationTracksMappingNoteDurationWithin Within_DefaultValue { get; set; }
