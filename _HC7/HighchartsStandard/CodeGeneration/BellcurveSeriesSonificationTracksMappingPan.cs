...
{
	public partial class BellcurveSeriesSonificationTracksMappingPan  : BaseObject
	{
		Hashtable h = new Hashtable();

		public BellcurveSeriesSonificationTracksMappingPan()
		{
			MapFunction = MapFunction_DefaultValue = BellcurveSeriesSonificationTracksMappingPanMapFunction.Linear;
			MapTo = MapTo_DefaultValue = "";
			Max = Max_DefaultValue = null;
			Min = Min_DefaultValue = null;
			Value = Value_DefaultValue = null;
			Within = Within_DefaultValue = BellcurveSeriesSonificationTracksMappingPanWithin.Chart;
		...
		/// </summary>
		public BellcurveSeriesSonificationTracksMappingPanMapFunction MapFunction { get; set; }
		private BellcurveSeriesSonificationTracksMappingPanMapFunction MapFunction_DefaultValue { get; set; }
		...
		/// </summary>
		public BellcurveSeriesSonificationTracksMappingPanWithin Within { get; set; }
		private BellcurveSeriesSonificationTracksMappingPanWithin Within_DefaultValue { get; set; }
