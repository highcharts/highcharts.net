...
{
	public partial class BellcurveSeriesSonificationTracksMappingPitch  : BaseObject
	{
		Hashtable h = new Hashtable();

		public BellcurveSeriesSonificationTracksMappingPitch()
		{
			MapFunction = MapFunction_DefaultValue = BellcurveSeriesSonificationTracksMappingPitchMapFunction.Linear;
		...
		/// </summary>
		public BellcurveSeriesSonificationTracksMappingPitchMapFunction MapFunction { get; set; }
		private BellcurveSeriesSonificationTracksMappingPitchMapFunction MapFunction_DefaultValue { get; set; }
