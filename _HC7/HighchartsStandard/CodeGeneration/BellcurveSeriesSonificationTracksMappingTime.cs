...
{
	public partial class BellcurveSeriesSonificationTracksMappingTime  : BaseObject
	{
		Hashtable h = new Hashtable();

		public BellcurveSeriesSonificationTracksMappingTime()
		{
			MapFunction = MapFunction_DefaultValue = BellcurveSeriesSonificationTracksMappingTimeMapFunction.Linear;
			MapTo = MapTo_DefaultValue = "";
			Max = Max_DefaultValue = null;
			Min = Min_DefaultValue = null;
			Value = Value_DefaultValue = null;
			Within = Within_DefaultValue = BellcurveSeriesSonificationTracksMappingTimeWithin.Chart;
		...
		/// </summary>
		public BellcurveSeriesSonificationTracksMappingTimeMapFunction MapFunction { get; set; }
		private BellcurveSeriesSonificationTracksMappingTimeMapFunction MapFunction_DefaultValue { get; set; }
		...
		/// </summary>
		public BellcurveSeriesSonificationTracksMappingTimeWithin Within { get; set; }
		private BellcurveSeriesSonificationTracksMappingTimeWithin Within_DefaultValue { get; set; }
