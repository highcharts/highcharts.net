...
{
	public partial class BellcurveSeriesSonificationTracksMappingTremoloSpeed  : BaseObject
	{
		Hashtable h = new Hashtable();

		public BellcurveSeriesSonificationTracksMappingTremoloSpeed()
		{
			MapFunction = MapFunction_DefaultValue = BellcurveSeriesSonificationTracksMappingTremoloSpeedMapFunction.Linear;
			MapTo = MapTo_DefaultValue = "";
			Max = Max_DefaultValue = null;
			Min = Min_DefaultValue = null;
			Value = Value_DefaultValue = null;
			Within = Within_DefaultValue = BellcurveSeriesSonificationTracksMappingTremoloSpeedWithin.Chart;
		...
		/// </summary>
		public BellcurveSeriesSonificationTracksMappingTremoloSpeedMapFunction MapFunction { get; set; }
		private BellcurveSeriesSonificationTracksMappingTremoloSpeedMapFunction MapFunction_DefaultValue { get; set; }
		...
		/// </summary>
		public BellcurveSeriesSonificationTracksMappingTremoloSpeedWithin Within { get; set; }
		private BellcurveSeriesSonificationTracksMappingTremoloSpeedWithin Within_DefaultValue { get; set; }
