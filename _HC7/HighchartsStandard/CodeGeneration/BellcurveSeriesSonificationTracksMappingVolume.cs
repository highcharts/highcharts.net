...
{
	public partial class BellcurveSeriesSonificationTracksMappingVolume  : BaseObject
	{
		Hashtable h = new Hashtable();

		public BellcurveSeriesSonificationTracksMappingVolume()
		{
			MapFunction = MapFunction_DefaultValue = BellcurveSeriesSonificationTracksMappingVolumeMapFunction.Linear;
			MapTo = MapTo_DefaultValue = "";
			Max = Max_DefaultValue = null;
			Min = Min_DefaultValue = null;
			Value = Value_DefaultValue = null;
			Within = Within_DefaultValue = BellcurveSeriesSonificationTracksMappingVolumeWithin.Chart;
		...
		/// </summary>
		public BellcurveSeriesSonificationTracksMappingVolumeMapFunction MapFunction { get; set; }
		private BellcurveSeriesSonificationTracksMappingVolumeMapFunction MapFunction_DefaultValue { get; set; }
		...
		/// </summary>
		public BellcurveSeriesSonificationTracksMappingVolumeWithin Within { get; set; }
		private BellcurveSeriesSonificationTracksMappingVolumeWithin Within_DefaultValue { get; set; }
