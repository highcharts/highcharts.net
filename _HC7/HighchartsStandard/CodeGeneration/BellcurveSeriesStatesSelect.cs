...
{
	public partial class BellcurveSeriesStatesSelect  : BaseObject
	{
		public BellcurveSeriesStatesSelect()
		{
			Animation = Animation_DefaultValue = new Animation() { Enabled = true };
			Enabled = Enabled_DefaultValue = true;
			Halo = Halo_DefaultValue = new BellcurveSeriesStatesSelectHalo();
			LineWidth = LineWidth_DefaultValue = null;
			LineWidthPlus = LineWidthPlus_DefaultValue = 1;
			Marker = Marker_DefaultValue = new BellcurveSeriesStatesSelectMarker();
		...
		/// </summary>
		public BellcurveSeriesStatesSelectHalo Halo { get; set; }
		private BellcurveSeriesStatesSelectHalo Halo_DefaultValue { get; set; }
		...
		/// </summary>
		public BellcurveSeriesStatesSelectMarker Marker { get; set; }
		private BellcurveSeriesStatesSelectMarker Marker_DefaultValue { get; set; }
