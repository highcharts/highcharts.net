...
namespace Highsoft.Web.Mvc.Charts
{
	public partial class BoxplotSeries  : Series
	{
		...
		/// </summary>
		public BoxplotSeriesAccessibility Accessibility { get; set; }
		private BoxplotSeriesAccessibility Accessibility_DefaultValue { get; set; }
		...
		/// </summary>
		public BoxplotSeriesDataSorting DataSorting { get; set; }
		private BoxplotSeriesDataSorting DataSorting_DefaultValue { get; set; }
		...
		/// </summary>
		public BoxplotSeriesLegendSymbol LegendSymbol { get; set; }
		private BoxplotSeriesLegendSymbol LegendSymbol_DefaultValue { get; set; }
		...
		/// </summary>
		public BoxplotSeriesOnPoint OnPoint { get; set; }
		private BoxplotSeriesOnPoint OnPoint_DefaultValue { get; set; }
		...
		/// </summary>
		public BoxplotSeriesSonification Sonification { get; set; }
		private BoxplotSeriesSonification Sonification_DefaultValue { get; set; }
		...
		internal override Hashtable ToHashtable(Highcharts highcharts)
		{
			...
			if (Cursor != BoxplotSeriesCursor.Null) h.Add("cursor", highcharts.FirstCharacterToLower(Cursor.ToString()));
			if (Custom != null) h.Add("custom",Custom);
			if (DashStyle != BoxplotSeriesDashStyle.Null) h.Add("dashStyle", highcharts.FirstCharacterToLower(DashStyle.ToString()));
			...
			if (FindNearestPointBy != BoxplotSeriesFindNearestPointBy.Null) h.Add("findNearestPointBy", highcharts.FirstCharacterToLower(FindNearestPointBy.ToString()));
			...
			if (LegendSymbol != BoxplotSeriesLegendSymbol.Null) h.Add("legendSymbol", highcharts.FirstCharacterToLower(LegendSymbol.ToString()));
			...
			if (PointIntervalUnit != BoxplotSeriesPointIntervalUnit.Null) h.Add("pointIntervalUnit", highcharts.FirstCharacterToLower(PointIntervalUnit.ToString()));
			if (PointPadding != null) h.Add("pointPadding",PointPadding);
			if (PointPlacement != BoxplotSeriesPointPlacement.Null) h.Add("pointPlacement", highcharts.FirstCharacterToLower(PointPlacement.ToString()));
