...
namespace Highsoft.Web.Mvc.Charts
{
	public partial class BoxplotSeries  : Series
	{
		...
		{
			Accessibility = Accessibility_DefaultValue = new BoxplotSeriesAccessibility();
			...
			LegendSymbol = LegendSymbol_DefaultValue = BoxplotSeriesLegendSymbol.Rectangle;
			...
			OnPoint = OnPoint_DefaultValue = new BoxplotSeriesOnPoint();
			...
			Sonification = Sonification_DefaultValue = new BoxplotSeriesSonification();
		...
		/// 
		/// </summary>
		public BoxplotSeriesDumbell Dumbell { get; set; }
		private BoxplotSeriesDumbell Dumbell_DefaultValue { get; set; }
