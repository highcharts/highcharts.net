...
{
	public partial class BoxplotSeriesDataDataLabels  : BaseObject
	{
		Hashtable h = new Hashtable();

		public BoxplotSeriesDataDataLabels()
		{
		...
		/// </summary>
		public BoxplotSeriesDataDataLabelsAlign Align { get; set; }
		private BoxplotSeriesDataDataLabelsAlign Align_DefaultValue { get; set; }
		...
		/// </summary>
		public BoxplotSeriesDataDataLabelsFilter Filter { get; set; }
		private BoxplotSeriesDataDataLabelsFilter Filter_DefaultValue { get; set; }
		...
		/// </summary>
		public BoxplotSeriesDataDataLabelsOverflow Overflow { get; set; }
		private BoxplotSeriesDataDataLabelsOverflow Overflow_DefaultValue { get; set; }
		...
		/// </summary>
		public BoxplotSeriesDataDataLabelsPosition Position { get; set; }
		private BoxplotSeriesDataDataLabelsPosition Position_DefaultValue { get; set; }
		...
		/// </summary>
		public BoxplotSeriesDataDataLabelsTextPath TextPath { get; set; }
		private BoxplotSeriesDataDataLabelsTextPath TextPath_DefaultValue { get; set; }
		...
		/// </summary>
		public BoxplotSeriesDataDataLabelsVerticalAlign VerticalAlign { get; set; }
		private BoxplotSeriesDataDataLabelsVerticalAlign VerticalAlign_DefaultValue { get; set; }
		...
		internal override Hashtable ToHashtable(Highcharts highcharts)
		{
			...
			if (Align != BoxplotSeriesDataDataLabelsAlign.Null) h.Add("align", highcharts.FirstCharacterToLower(Align.ToString()));
			...
			if (Overflow != BoxplotSeriesDataDataLabelsOverflow.Null) h.Add("overflow", highcharts.FirstCharacterToLower(Overflow.ToString()));
			if (Padding != null) h.Add("padding",Padding);
			if (Position != BoxplotSeriesDataDataLabelsPosition.Null) h.Add("position", highcharts.FirstCharacterToLower(Position.ToString()));
			...
			if (VerticalAlign != BoxplotSeriesDataDataLabelsVerticalAlign.Null) h.Add("verticalAlign", highcharts.FirstCharacterToLower(VerticalAlign.ToString()));
			if (X != null) h.Add("x",X);
			if (Y != null) h.Add("y",Y);
