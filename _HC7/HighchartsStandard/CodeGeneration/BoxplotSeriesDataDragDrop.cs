...
{
	public partial class BoxplotSeriesDataDragDrop  : BaseObject
	{
		public BoxplotSeriesDataDragDrop()
		{
			DraggableX = DraggableX_DefaultValue = null;
			DraggableY = DraggableY_DefaultValue = null;
			DragHandle = DragHandle_DefaultValue = new BoxplotSeriesDataDragDropDragHandle();
			...
			GuideBox = GuideBox_DefaultValue = new BoxplotSeriesDataDragDropGuideBox();
		...
		/// </summary>
		public BoxplotSeriesDataDragDropDragHandle DragHandle { get; set; }
		private BoxplotSeriesDataDragDropDragHandle DragHandle_DefaultValue { get; set; }
		...
		/// </summary>
		public BoxplotSeriesDataDragDropGuideBox GuideBox { get; set; }
		private BoxplotSeriesDataDragDropGuideBox GuideBox_DefaultValue { get; set; }
