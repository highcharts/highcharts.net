...
{
	public partial class BoxplotSeriesDragDropDragHandle  : BaseObject
	{
		public BoxplotSeriesDragDropDragHandle()
		{
		...
		internal override Hashtable ToHashtable()
		{
			...
			if (PathFormatter != PathFormatter_DefaultValue) { h.Add("pathFormatter",PathFormatter); Highcharts.AddFunction("BoxplotSeriesDragDropDragHandlePathFormatter.pathFormatter", PathFormatter); }  
