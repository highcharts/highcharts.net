...
{
	public partial class BoxplotSeriesSonificationContextTracksMapping  : BaseObject
	{
		Hashtable h = new Hashtable();

		public BoxplotSeriesSonificationContextTracksMapping()
		{
			Frequency = Frequency_DefaultValue = new BoxplotSeriesSonificationContextTracksMappingFrequency();
			GapBetweenNotes = GapBetweenNotes_DefaultValue = new BoxplotSeriesSonificationContextTracksMappingGapBetweenNotes();
			Highpass = Highpass_DefaultValue = new BoxplotSeriesSonificationContextTracksMappingHighpass();
			Lowpass = Lowpass_DefaultValue = new BoxplotSeriesSonificationContextTracksMappingLowpass();
			NoteDuration = NoteDuration_DefaultValue = new BoxplotSeriesSonificationContextTracksMappingNoteDuration();
			Pan = Pan_DefaultValue = new BoxplotSeriesSonificationContextTracksMappingPan();
			Pitch = Pitch_DefaultValue = new BoxplotSeriesSonificationContextTracksMappingPitch();
			PitchString = PitchString_DefaultValue = "null";
			PitchNumber = PitchNumber_DefaultValue = null;
			PlayDelay = PlayDelay_DefaultValue = new BoxplotSeriesSonificationContextTracksMappingPlayDelay();
			Time = Time_DefaultValue = new BoxplotSeriesSonificationContextTracksMappingTime();
			TimeString = TimeString_DefaultValue = "null";
			TimeNumber = TimeNumber_DefaultValue = null;
			Tremolo = Tremolo_DefaultValue = new BoxplotSeriesSonificationContextTracksMappingTremolo();
			Volume = Volume_DefaultValue = new BoxplotSeriesSonificationContextTracksMappingVolume();
		...
		/// </summary>
		public BoxplotSeriesSonificationContextTracksMappingFrequency Frequency { get; set; }
		private BoxplotSeriesSonificationContextTracksMappingFrequency Frequency_DefaultValue { get; set; }
		...
		/// </summary>
		public BoxplotSeriesSonificationContextTracksMappingGapBetweenNotes GapBetweenNotes { get; set; }
		private BoxplotSeriesSonificationContextTracksMappingGapBetweenNotes GapBetweenNotes_DefaultValue { get; set; }
		...
		/// </summary>
		public BoxplotSeriesSonificationContextTracksMappingHighpass Highpass { get; set; }
		private BoxplotSeriesSonificationContextTracksMappingHighpass Highpass_DefaultValue { get; set; }
		...
		/// </summary>
		public BoxplotSeriesSonificationContextTracksMappingLowpass Lowpass { get; set; }
		private BoxplotSeriesSonificationContextTracksMappingLowpass Lowpass_DefaultValue { get; set; }
		...
		/// </summary>
		public BoxplotSeriesSonificationContextTracksMappingNoteDuration NoteDuration { get; set; }
		private BoxplotSeriesSonificationContextTracksMappingNoteDuration NoteDuration_DefaultValue { get; set; }
		...
		/// </summary>
		public BoxplotSeriesSonificationContextTracksMappingPan Pan { get; set; }
		private BoxplotSeriesSonificationContextTracksMappingPan Pan_DefaultValue { get; set; }
		...
		/// </summary>
		public BoxplotSeriesSonificationContextTracksMappingPitch Pitch { get; set; }
		private BoxplotSeriesSonificationContextTracksMappingPitch Pitch_DefaultValue { get; set; }
		...
		/// </summary>
		public BoxplotSeriesSonificationContextTracksMappingPlayDelay PlayDelay { get; set; }
		private BoxplotSeriesSonificationContextTracksMappingPlayDelay PlayDelay_DefaultValue { get; set; }
		...
		/// </summary>
		public BoxplotSeriesSonificationContextTracksMappingTime Time { get; set; }
		private BoxplotSeriesSonificationContextTracksMappingTime Time_DefaultValue { get; set; }
		...
		/// </summary>
		public BoxplotSeriesSonificationContextTracksMappingTremolo Tremolo { get; set; }
		private BoxplotSeriesSonificationContextTracksMappingTremolo Tremolo_DefaultValue { get; set; }
		 

		/// <summary>
		/// The volume of notes, from 0 to 1.
		/// </summary>
		public BoxplotSeriesSonificationContextTracksMappingVolume Volume { get; set; }
		private BoxplotSeriesSonificationContextTracksMappingVolume Volume_DefaultValue { get; set; }
