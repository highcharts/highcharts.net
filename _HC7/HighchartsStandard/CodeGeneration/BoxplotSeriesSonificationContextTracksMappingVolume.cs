...
{
	public partial class BoxplotSeriesSonificationContextTracksMappingVolume  : BaseObject
	{
		Hashtable h = new Hashtable();

		public BoxplotSeriesSonificationContextTracksMappingVolume()
		{
			MapFunction = MapFunction_DefaultValue = BoxplotSeriesSonificationContextTracksMappingVolumeMapFunction.Linear;
			MapTo = MapTo_DefaultValue = "";
			Max = Max_DefaultValue = null;
			Min = Min_DefaultValue = null;
			Value = Value_DefaultValue = null;
			Within = Within_DefaultValue = BoxplotSeriesSonificationContextTracksMappingVolumeWithin.Chart;
		...
		/// </summary>
		public BoxplotSeriesSonificationContextTracksMappingVolumeMapFunction MapFunction { get; set; }
		private BoxplotSeriesSonificationContextTracksMappingVolumeMapFunction MapFunction_DefaultValue { get; set; }
		...
		/// </summary>
		public BoxplotSeriesSonificationContextTracksMappingVolumeWithin Within { get; set; }
		private BoxplotSeriesSonificationContextTracksMappingVolumeWithin Within_DefaultValue { get; set; }
