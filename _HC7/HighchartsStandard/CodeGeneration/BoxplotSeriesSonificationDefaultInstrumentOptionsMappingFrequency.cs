...
{
	public partial class BoxplotSeriesSonificationDefaultInstrumentOptionsMappingFrequency  : BaseObject
	{
		Hashtable h = new Hashtable();

		public BoxplotSeriesSonificationDefaultInstrumentOptionsMappingFrequency()
		{
			MapFunction = MapFunction_DefaultValue = BoxplotSeriesSonificationDefaultInstrumentOptionsMappingFrequencyMapFunction.Linear;
			MapTo = MapTo_DefaultValue = "";
			Max = Max_DefaultValue = null;
			Min = Min_DefaultValue = null;
			Value = Value_DefaultValue = null;
			Within = Within_DefaultValue = BoxplotSeriesSonificationDefaultInstrumentOptionsMappingFrequencyWithin.Chart;
		...
		/// </summary>
		public BoxplotSeriesSonificationDefaultInstrumentOptionsMappingFrequencyMapFunction MapFunction { get; set; }
		private BoxplotSeriesSonificationDefaultInstrumentOptionsMappingFrequencyMapFunction MapFunction_DefaultValue { get; set; }
		...
		/// </summary>
		public BoxplotSeriesSonificationDefaultInstrumentOptionsMappingFrequencyWithin Within { get; set; }
		private BoxplotSeriesSonificationDefaultInstrumentOptionsMappingFrequencyWithin Within_DefaultValue { get; set; }
