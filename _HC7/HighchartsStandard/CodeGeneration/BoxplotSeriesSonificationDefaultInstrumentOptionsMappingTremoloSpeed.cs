...
{
	public partial class BoxplotSeriesSonificationDefaultInstrumentOptionsMappingTremoloSpeed  : BaseObject
	{
		Hashtable h = new Hashtable();

		public BoxplotSeriesSonificationDefaultInstrumentOptionsMappingTremoloSpeed()
		{
			MapFunction = MapFunction_DefaultValue = BoxplotSeriesSonificationDefaultInstrumentOptionsMappingTremoloSpeedMapFunction.Linear;
			MapTo = MapTo_DefaultValue = "";
			Max = Max_DefaultValue = null;
			Min = Min_DefaultValue = null;
			Value = Value_DefaultValue = null;
			Within = Within_DefaultValue = BoxplotSeriesSonificationDefaultInstrumentOptionsMappingTremoloSpeedWithin.Chart;
		...
		/// </summary>
		public BoxplotSeriesSonificationDefaultInstrumentOptionsMappingTremoloSpeedMapFunction MapFunction { get; set; }
		private BoxplotSeriesSonificationDefaultInstrumentOptionsMappingTremoloSpeedMapFunction MapFunction_DefaultValue { get; set; }
		...
		/// </summary>
		public BoxplotSeriesSonificationDefaultInstrumentOptionsMappingTremoloSpeedWithin Within { get; set; }
		private BoxplotSeriesSonificationDefaultInstrumentOptionsMappingTremoloSpeedWithin Within_DefaultValue { get; set; }
