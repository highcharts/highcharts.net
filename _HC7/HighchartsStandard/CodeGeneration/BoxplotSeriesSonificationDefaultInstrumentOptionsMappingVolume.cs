...
{
	public partial class BoxplotSeriesSonificationDefaultInstrumentOptionsMappingVolume  : BaseObject
	{
		Hashtable h = new Hashtable();

		public BoxplotSeriesSonificationDefaultInstrumentOptionsMappingVolume()
		{
			MapFunction = MapFunction_DefaultValue = BoxplotSeriesSonificationDefaultInstrumentOptionsMappingVolumeMapFunction.Linear;
			MapTo = MapTo_DefaultValue = "";
			Max = Max_DefaultValue = null;
			Min = Min_DefaultValue = null;
			Value = Value_DefaultValue = null;
			Within = Within_DefaultValue = BoxplotSeriesSonificationDefaultInstrumentOptionsMappingVolumeWithin.Chart;
		...
		/// </summary>
		public BoxplotSeriesSonificationDefaultInstrumentOptionsMappingVolumeMapFunction MapFunction { get; set; }
		private BoxplotSeriesSonificationDefaultInstrumentOptionsMappingVolumeMapFunction MapFunction_DefaultValue { get; set; }
		...
		/// </summary>
		public BoxplotSeriesSonificationDefaultInstrumentOptionsMappingVolumeWithin Within { get; set; }
		private BoxplotSeriesSonificationDefaultInstrumentOptionsMappingVolumeWithin Within_DefaultValue { get; set; }
