...
{
	public partial class BoxplotSeriesSonificationDefaultSpeechOptionsMapping  : BaseObject
	{
		Hashtable h = new Hashtable();

		public BoxplotSeriesSonificationDefaultSpeechOptionsMapping()
		{
			Frequency = Frequency_DefaultValue = new BoxplotSeriesSonificationDefaultSpeechOptionsMappingFrequency();
			GapBetweenNotes = GapBetweenNotes_DefaultValue = new BoxplotSeriesSonificationDefaultSpeechOptionsMappingGapBetweenNotes();
			Highpass = Highpass_DefaultValue = new BoxplotSeriesSonificationDefaultSpeechOptionsMappingHighpass();
			Lowpass = Lowpass_DefaultValue = new BoxplotSeriesSonificationDefaultSpeechOptionsMappingLowpass();
			NoteDuration = NoteDuration_DefaultValue = new BoxplotSeriesSonificationDefaultSpeechOptionsMappingNoteDuration();
			Pan = Pan_DefaultValue = new BoxplotSeriesSonificationDefaultSpeechOptionsMappingPan();
			Pitch = Pitch_DefaultValue = new BoxplotSeriesSonificationDefaultSpeechOptionsMappingPitch();
			PitchString = PitchString_DefaultValue = "null";
			PitchNumber = PitchNumber_DefaultValue = null;
			PlayDelay = PlayDelay_DefaultValue = new BoxplotSeriesSonificationDefaultSpeechOptionsMappingPlayDelay();
			Time = Time_DefaultValue = new BoxplotSeriesSonificationDefaultSpeechOptionsMappingTime();
			TimeString = TimeString_DefaultValue = "null";
			TimeNumber = TimeNumber_DefaultValue = null;
			Tremolo = Tremolo_DefaultValue = new BoxplotSeriesSonificationDefaultSpeechOptionsMappingTremolo();
			Volume = Volume_DefaultValue = new BoxplotSeriesSonificationDefaultSpeechOptionsMappingVolume();
		...
		/// </summary>
		public BoxplotSeriesSonificationDefaultSpeechOptionsMappingFrequency Frequency { get; set; }
		private BoxplotSeriesSonificationDefaultSpeechOptionsMappingFrequency Frequency_DefaultValue { get; set; }
		...
		/// </summary>
		public BoxplotSeriesSonificationDefaultSpeechOptionsMappingGapBetweenNotes GapBetweenNotes { get; set; }
		private BoxplotSeriesSonificationDefaultSpeechOptionsMappingGapBetweenNotes GapBetweenNotes_DefaultValue { get; set; }
		...
		/// </summary>
		public BoxplotSeriesSonificationDefaultSpeechOptionsMappingHighpass Highpass { get; set; }
		private BoxplotSeriesSonificationDefaultSpeechOptionsMappingHighpass Highpass_DefaultValue { get; set; }
		...
		/// </summary>
		public BoxplotSeriesSonificationDefaultSpeechOptionsMappingLowpass Lowpass { get; set; }
		private BoxplotSeriesSonificationDefaultSpeechOptionsMappingLowpass Lowpass_DefaultValue { get; set; }
		...
		/// </summary>
		public BoxplotSeriesSonificationDefaultSpeechOptionsMappingNoteDuration NoteDuration { get; set; }
		private BoxplotSeriesSonificationDefaultSpeechOptionsMappingNoteDuration NoteDuration_DefaultValue { get; set; }
		...
		/// </summary>
		public BoxplotSeriesSonificationDefaultSpeechOptionsMappingPan Pan { get; set; }
		private BoxplotSeriesSonificationDefaultSpeechOptionsMappingPan Pan_DefaultValue { get; set; }
		...
		/// </summary>
		public BoxplotSeriesSonificationDefaultSpeechOptionsMappingPitch Pitch { get; set; }
		private BoxplotSeriesSonificationDefaultSpeechOptionsMappingPitch Pitch_DefaultValue { get; set; }
		...
		/// </summary>
		public BoxplotSeriesSonificationDefaultSpeechOptionsMappingPlayDelay PlayDelay { get; set; }
		private BoxplotSeriesSonificationDefaultSpeechOptionsMappingPlayDelay PlayDelay_DefaultValue { get; set; }
		...
		/// </summary>
		public BoxplotSeriesSonificationDefaultSpeechOptionsMappingTime Time { get; set; }
		private BoxplotSeriesSonificationDefaultSpeechOptionsMappingTime Time_DefaultValue { get; set; }
		...
		/// </summary>
		public BoxplotSeriesSonificationDefaultSpeechOptionsMappingTremolo Tremolo { get; set; }
		private BoxplotSeriesSonificationDefaultSpeechOptionsMappingTremolo Tremolo_DefaultValue { get; set; }
		 

		/// <summary>
		/// The volume of notes, from 0 to 1.
		/// </summary>
		public BoxplotSeriesSonificationDefaultSpeechOptionsMappingVolume Volume { get; set; }
		private BoxplotSeriesSonificationDefaultSpeechOptionsMappingVolume Volume_DefaultValue { get; set; }
