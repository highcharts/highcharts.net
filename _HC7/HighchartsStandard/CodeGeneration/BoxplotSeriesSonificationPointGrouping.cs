...
{
	public partial class BoxplotSeriesSonificationPointGrouping  : BaseObject
	{
		Hashtable h = new Hashtable();

		public BoxplotSeriesSonificationPointGrouping()
		{
		...
		/// </summary>
		public BoxplotSeriesSonificationPointGroupingAlgorithm Algorithm { get; set; }
		private BoxplotSeriesSonificationPointGroupingAlgorithm Algorithm_DefaultValue { get; set; }
		...
		internal override Hashtable ToHashtable(Highcharts highcharts)
		{
			...
			if (Algorithm != BoxplotSeriesSonificationPointGroupingAlgorithm.Null) h.Add("algorithm", highcharts.FirstCharacterToLower(Algorithm.ToString()));
