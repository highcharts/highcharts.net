...
{
	public partial class BoxplotSeriesSonificationTracks  : BaseObject
	{
		Hashtable h = new Hashtable();

		public BoxplotSeriesSonificationTracks()
		{
			ActiveWhen = ActiveWhen_DefaultValue = new BoxplotSeriesSonificationTracksActiveWhen();
			Instrument = Instrument_DefaultValue = null;
			InstrumentString = InstrumentString_DefaultValue = "null";
			Mapping = Mapping_DefaultValue = new BoxplotSeriesSonificationTracksMapping();
			MidiName = MidiName_DefaultValue = "";
			PointGrouping = PointGrouping_DefaultValue = new BoxplotSeriesSonificationTracksPointGrouping();
			RoundToMusicalNotes = RoundToMusicalNotes_DefaultValue = true;
			ShowPlayMarker = ShowPlayMarker_DefaultValue = true;
			Type = Type_DefaultValue = BoxplotSeriesSonificationTracksType.Instrument;
		...
		/// </summary>
		public BoxplotSeriesSonificationTracksActiveWhen ActiveWhen { get; set; }
		private BoxplotSeriesSonificationTracksActiveWhen ActiveWhen_DefaultValue { get; set; }
		...
		/// </summary>
		public BoxplotSeriesSonificationTracksMapping Mapping { get; set; }
		private BoxplotSeriesSonificationTracksMapping Mapping_DefaultValue { get; set; }
		...
		/// </summary>
		public BoxplotSeriesSonificationTracksPointGrouping PointGrouping { get; set; }
		private BoxplotSeriesSonificationTracksPointGrouping PointGrouping_DefaultValue { get; set; }
		...
		/// </summary>
		public BoxplotSeriesSonificationTracksType Type { get; set; }
		private BoxplotSeriesSonificationTracksType Type_DefaultValue { get; set; }
