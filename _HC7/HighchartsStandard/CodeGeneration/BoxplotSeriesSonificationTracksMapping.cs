...
{
	public partial class BoxplotSeriesSonificationTracksMapping  : BaseObject
	{
		Hashtable h = new Hashtable();

		public BoxplotSeriesSonificationTracksMapping()
		{
			Frequency = Frequency_DefaultValue = new BoxplotSeriesSonificationTracksMappingFrequency();
			GapBetweenNotes = GapBetweenNotes_DefaultValue = new BoxplotSeriesSonificationTracksMappingGapBetweenNotes();
			Highpass = Highpass_DefaultValue = new BoxplotSeriesSonificationTracksMappingHighpass();
			Lowpass = Lowpass_DefaultValue = new BoxplotSeriesSonificationTracksMappingLowpass();
			NoteDuration = NoteDuration_DefaultValue = new BoxplotSeriesSonificationTracksMappingNoteDuration();
			Pan = Pan_DefaultValue = new BoxplotSeriesSonificationTracksMappingPan();
			Pitch = Pitch_DefaultValue = new BoxplotSeriesSonificationTracksMappingPitch();
			PitchString = PitchString_DefaultValue = "null";
			PitchNumber = PitchNumber_DefaultValue = null;
			PlayDelay = PlayDelay_DefaultValue = new BoxplotSeriesSonificationTracksMappingPlayDelay();
			Time = Time_DefaultValue = new BoxplotSeriesSonificationTracksMappingTime();
			TimeString = TimeString_DefaultValue = "null";
			TimeNumber = TimeNumber_DefaultValue = null;
			Tremolo = Tremolo_DefaultValue = new BoxplotSeriesSonificationTracksMappingTremolo();
			Volume = Volume_DefaultValue = new BoxplotSeriesSonificationTracksMappingVolume();
		...
		/// </summary>
		public BoxplotSeriesSonificationTracksMappingFrequency Frequency { get; set; }
		private BoxplotSeriesSonificationTracksMappingFrequency Frequency_DefaultValue { get; set; }
		...
		/// </summary>
		public BoxplotSeriesSonificationTracksMappingGapBetweenNotes GapBetweenNotes { get; set; }
		private BoxplotSeriesSonificationTracksMappingGapBetweenNotes GapBetweenNotes_DefaultValue { get; set; }
		...
		/// </summary>
		public BoxplotSeriesSonificationTracksMappingHighpass Highpass { get; set; }
		private BoxplotSeriesSonificationTracksMappingHighpass Highpass_DefaultValue { get; set; }
		...
		/// </summary>
		public BoxplotSeriesSonificationTracksMappingLowpass Lowpass { get; set; }
		private BoxplotSeriesSonificationTracksMappingLowpass Lowpass_DefaultValue { get; set; }
		...
		/// </summary>
		public BoxplotSeriesSonificationTracksMappingNoteDuration NoteDuration { get; set; }
		private BoxplotSeriesSonificationTracksMappingNoteDuration NoteDuration_DefaultValue { get; set; }
		...
		/// </summary>
		public BoxplotSeriesSonificationTracksMappingPan Pan { get; set; }
		private BoxplotSeriesSonificationTracksMappingPan Pan_DefaultValue { get; set; }
		...
		/// </summary>
		public BoxplotSeriesSonificationTracksMappingPitch Pitch { get; set; }
		private BoxplotSeriesSonificationTracksMappingPitch Pitch_DefaultValue { get; set; }
		...
		/// </summary>
		public BoxplotSeriesSonificationTracksMappingPlayDelay PlayDelay { get; set; }
		private BoxplotSeriesSonificationTracksMappingPlayDelay PlayDelay_DefaultValue { get; set; }
		...
		/// </summary>
		public BoxplotSeriesSonificationTracksMappingTime Time { get; set; }
		private BoxplotSeriesSonificationTracksMappingTime Time_DefaultValue { get; set; }
		...
		/// </summary>
		public BoxplotSeriesSonificationTracksMappingTremolo Tremolo { get; set; }
		private BoxplotSeriesSonificationTracksMappingTremolo Tremolo_DefaultValue { get; set; }
		 

		/// <summary>
		/// The volume of notes, from 0 to 1.
		/// </summary>
		public BoxplotSeriesSonificationTracksMappingVolume Volume { get; set; }
		private BoxplotSeriesSonificationTracksMappingVolume Volume_DefaultValue { get; set; }
