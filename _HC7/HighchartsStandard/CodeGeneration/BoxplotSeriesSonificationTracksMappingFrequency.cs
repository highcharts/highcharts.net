...
{
	public partial class BoxplotSeriesSonificationTracksMappingFrequency  : BaseObject
	{
		Hashtable h = new Hashtable();

		public BoxplotSeriesSonificationTracksMappingFrequency()
		{
			MapFunction = MapFunction_DefaultValue = BoxplotSeriesSonificationTracksMappingFrequencyMapFunction.Linear;
			MapTo = MapTo_DefaultValue = "";
			Max = Max_DefaultValue = null;
			Min = Min_DefaultValue = null;
			Value = Value_DefaultValue = null;
			Within = Within_DefaultValue = BoxplotSeriesSonificationTracksMappingFrequencyWithin.Chart;
		...
		/// </summary>
		public BoxplotSeriesSonificationTracksMappingFrequencyMapFunction MapFunction { get; set; }
		private BoxplotSeriesSonificationTracksMappingFrequencyMapFunction MapFunction_DefaultValue { get; set; }
		...
		/// </summary>
		public BoxplotSeriesSonificationTracksMappingFrequencyWithin Within { get; set; }
		private BoxplotSeriesSonificationTracksMappingFrequencyWithin Within_DefaultValue { get; set; }
