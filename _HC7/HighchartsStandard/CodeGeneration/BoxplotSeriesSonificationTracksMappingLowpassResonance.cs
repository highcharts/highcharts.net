...
{
	public partial class BoxplotSeriesSonificationTracksMappingLowpassResonance  : BaseObject
	{
		Hashtable h = new Hashtable();

		public BoxplotSeriesSonificationTracksMappingLowpassResonance()
		{
			MapFunction = MapFunction_DefaultValue = BoxplotSeriesSonificationTracksMappingLowpassResonanceMapFunction.Linear;
			MapTo = MapTo_DefaultValue = "";
			Max = Max_DefaultValue = null;
			Min = Min_DefaultValue = null;
			Value = Value_DefaultValue = null;
			Within = Within_DefaultValue = BoxplotSeriesSonificationTracksMappingLowpassResonanceWithin.Chart;
		...
		/// </summary>
		public BoxplotSeriesSonificationTracksMappingLowpassResonanceMapFunction MapFunction { get; set; }
		private BoxplotSeriesSonificationTracksMappingLowpassResonanceMapFunction MapFunction_DefaultValue { get; set; }
		...
		/// </summary>
		public BoxplotSeriesSonificationTracksMappingLowpassResonanceWithin Within { get; set; }
		private BoxplotSeriesSonificationTracksMappingLowpassResonanceWithin Within_DefaultValue { get; set; }
