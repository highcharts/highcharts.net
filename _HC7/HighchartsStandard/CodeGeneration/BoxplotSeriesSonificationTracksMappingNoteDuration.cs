...
{
	public partial class BoxplotSeriesSonificationTracksMappingNoteDuration  : BaseObject
	{
		Hashtable h = new Hashtable();

		public BoxplotSeriesSonificationTracksMappingNoteDuration()
		{
			MapFunction = MapFunction_DefaultValue = BoxplotSeriesSonificationTracksMappingNoteDurationMapFunction.Linear;
			MapTo = MapTo_DefaultValue = "";
			Max = Max_DefaultValue = null;
			Min = Min_DefaultValue = null;
			Value = Value_DefaultValue = null;
			Within = Within_DefaultValue = BoxplotSeriesSonificationTracksMappingNoteDurationWithin.Chart;
		...
		/// </summary>
		public BoxplotSeriesSonificationTracksMappingNoteDurationMapFunction MapFunction { get; set; }
		private BoxplotSeriesSonificationTracksMappingNoteDurationMapFunction MapFunction_DefaultValue { get; set; }
		...
		/// </summary>
		public BoxplotSeriesSonificationTracksMappingNoteDurationWithin Within { get; set; }
		private BoxplotSeriesSonificationTracksMappingNoteDurationWithin Within_DefaultValue { get; set; }
