...
{
	public partial class BoxplotSeriesSonificationTracksMappingPan  : BaseObject
	{
		Hashtable h = new Hashtable();

		public BoxplotSeriesSonificationTracksMappingPan()
		{
			MapFunction = MapFunction_DefaultValue = BoxplotSeriesSonificationTracksMappingPanMapFunction.Linear;
			MapTo = MapTo_DefaultValue = "";
			Max = Max_DefaultValue = null;
			Min = Min_DefaultValue = null;
			Value = Value_DefaultValue = null;
			Within = Within_DefaultValue = BoxplotSeriesSonificationTracksMappingPanWithin.Chart;
		...
		/// </summary>
		public BoxplotSeriesSonificationTracksMappingPanMapFunction MapFunction { get; set; }
		private BoxplotSeriesSonificationTracksMappingPanMapFunction MapFunction_DefaultValue { get; set; }
		...
		/// </summary>
		public BoxplotSeriesSonificationTracksMappingPanWithin Within { get; set; }
		private BoxplotSeriesSonificationTracksMappingPanWithin Within_DefaultValue { get; set; }
