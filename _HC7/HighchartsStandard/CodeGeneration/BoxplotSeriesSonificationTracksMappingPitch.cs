...
{
	public partial class BoxplotSeriesSonificationTracksMappingPitch  : BaseObject
	{
		Hashtable h = new Hashtable();

		public BoxplotSeriesSonificationTracksMappingPitch()
		{
			MapFunction = MapFunction_DefaultValue = BoxplotSeriesSonificationTracksMappingPitchMapFunction.Linear;
		...
		/// </summary>
		public BoxplotSeriesSonificationTracksMappingPitchMapFunction MapFunction { get; set; }
		private BoxplotSeriesSonificationTracksMappingPitchMapFunction MapFunction_DefaultValue { get; set; }
