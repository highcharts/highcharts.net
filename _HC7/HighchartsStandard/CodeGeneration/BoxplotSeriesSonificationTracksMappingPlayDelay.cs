...
{
	public partial class BoxplotSeriesSonificationTracksMappingPlayDelay  : BaseObject
	{
		Hashtable h = new Hashtable();

		public BoxplotSeriesSonificationTracksMappingPlayDelay()
		{
			MapFunction = MapFunction_DefaultValue = BoxplotSeriesSonificationTracksMappingPlayDelayMapFunction.Linear;
			MapTo = MapTo_DefaultValue = "";
			Max = Max_DefaultValue = null;
			Min = Min_DefaultValue = null;
			Value = Value_DefaultValue = null;
			Within = Within_DefaultValue = BoxplotSeriesSonificationTracksMappingPlayDelayWithin.Chart;
		...
		/// </summary>
		public BoxplotSeriesSonificationTracksMappingPlayDelayMapFunction MapFunction { get; set; }
		private BoxplotSeriesSonificationTracksMappingPlayDelayMapFunction MapFunction_DefaultValue { get; set; }
		...
		/// </summary>
		public BoxplotSeriesSonificationTracksMappingPlayDelayWithin Within { get; set; }
		private BoxplotSeriesSonificationTracksMappingPlayDelayWithin Within_DefaultValue { get; set; }
