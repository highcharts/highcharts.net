...
{
	public partial class BoxplotSeriesSonificationTracksMappingTime  : BaseObject
	{
		Hashtable h = new Hashtable();

		public BoxplotSeriesSonificationTracksMappingTime()
		{
			MapFunction = MapFunction_DefaultValue = BoxplotSeriesSonificationTracksMappingTimeMapFunction.Linear;
			MapTo = MapTo_DefaultValue = "";
			Max = Max_DefaultValue = null;
			Min = Min_DefaultValue = null;
			Value = Value_DefaultValue = null;
			Within = Within_DefaultValue = BoxplotSeriesSonificationTracksMappingTimeWithin.Chart;
		...
		/// </summary>
		public BoxplotSeriesSonificationTracksMappingTimeMapFunction MapFunction { get; set; }
		private BoxplotSeriesSonificationTracksMappingTimeMapFunction MapFunction_DefaultValue { get; set; }
		...
		/// </summary>
		public BoxplotSeriesSonificationTracksMappingTimeWithin Within { get; set; }
		private BoxplotSeriesSonificationTracksMappingTimeWithin Within_DefaultValue { get; set; }
