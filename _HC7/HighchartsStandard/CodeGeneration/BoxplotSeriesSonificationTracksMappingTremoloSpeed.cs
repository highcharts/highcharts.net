...
{
	public partial class BoxplotSeriesSonificationTracksMappingTremoloSpeed  : BaseObject
	{
		Hashtable h = new Hashtable();

		public BoxplotSeriesSonificationTracksMappingTremoloSpeed()
		{
			MapFunction = MapFunction_DefaultValue = BoxplotSeriesSonificationTracksMappingTremoloSpeedMapFunction.Linear;
			MapTo = MapTo_DefaultValue = "";
			Max = Max_DefaultValue = null;
			Min = Min_DefaultValue = null;
			Value = Value_DefaultValue = null;
			Within = Within_DefaultValue = BoxplotSeriesSonificationTracksMappingTremoloSpeedWithin.Chart;
		...
		/// </summary>
		public BoxplotSeriesSonificationTracksMappingTremoloSpeedMapFunction MapFunction { get; set; }
		private BoxplotSeriesSonificationTracksMappingTremoloSpeedMapFunction MapFunction_DefaultValue { get; set; }
		...
		/// </summary>
		public BoxplotSeriesSonificationTracksMappingTremoloSpeedWithin Within { get; set; }
		private BoxplotSeriesSonificationTracksMappingTremoloSpeedWithin Within_DefaultValue { get; set; }
