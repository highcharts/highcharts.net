...
{
	public partial class BoxplotSeriesSonificationTracksMappingVolume  : BaseObject
	{
		Hashtable h = new Hashtable();

		public BoxplotSeriesSonificationTracksMappingVolume()
		{
			MapFunction = MapFunction_DefaultValue = BoxplotSeriesSonificationTracksMappingVolumeMapFunction.Linear;
			MapTo = MapTo_DefaultValue = "";
			Max = Max_DefaultValue = null;
			Min = Min_DefaultValue = null;
			Value = Value_DefaultValue = null;
			Within = Within_DefaultValue = BoxplotSeriesSonificationTracksMappingVolumeWithin.Chart;
		...
		/// </summary>
		public BoxplotSeriesSonificationTracksMappingVolumeMapFunction MapFunction { get; set; }
		private BoxplotSeriesSonificationTracksMappingVolumeMapFunction MapFunction_DefaultValue { get; set; }
		...
		/// </summary>
		public BoxplotSeriesSonificationTracksMappingVolumeWithin Within { get; set; }
		private BoxplotSeriesSonificationTracksMappingVolumeWithin Within_DefaultValue { get; set; }
