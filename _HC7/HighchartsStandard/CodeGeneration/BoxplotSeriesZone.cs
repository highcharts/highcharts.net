...
{
	public partial class BoxplotSeriesZone  : BaseObject
	{
		Hashtable h = new Hashtable();

		public BoxplotSeriesZone()
		{
		...
		internal override Hashtable ToHashtable(Highcharts highcharts)
		{
			...
			if (DashStyle != BoxplotSeriesZonesDashStyle.Null) h.Add("dashStyle", highcharts.FirstCharacterToLower(DashStyle.ToString()));
