...
{
	public partial class BubbleSeriesDataDataLabels  : BaseObject
	{
		Hashtable h = new Hashtable();

		public BubbleSeriesDataDataLabels()
		{
		...
		/// </summary>
		public BubbleSeriesDataDataLabelsAlign Align { get; set; }
		private BubbleSeriesDataDataLabelsAlign Align_DefaultValue { get; set; }
		...
		/// </summary>
		public BubbleSeriesDataDataLabelsFilter Filter { get; set; }
		private BubbleSeriesDataDataLabelsFilter Filter_DefaultValue { get; set; }
		...
		/// </summary>
		public BubbleSeriesDataDataLabelsOverflow Overflow { get; set; }
		private BubbleSeriesDataDataLabelsOverflow Overflow_DefaultValue { get; set; }
		...
		/// </summary>
		public BubbleSeriesDataDataLabelsPosition Position { get; set; }
		private BubbleSeriesDataDataLabelsPosition Position_DefaultValue { get; set; }
		...
		/// </summary>
		public BubbleSeriesDataDataLabelsTextPath TextPath { get; set; }
		private BubbleSeriesDataDataLabelsTextPath TextPath_DefaultValue { get; set; }
		...
		/// </summary>
		public BubbleSeriesDataDataLabelsVerticalAlign VerticalAlign { get; set; }
		private BubbleSeriesDataDataLabelsVerticalAlign VerticalAlign_DefaultValue { get; set; }
		...
		internal override Hashtable ToHashtable(Highcharts highcharts)
		{
			...
			if (Align != BubbleSeriesDataDataLabelsAlign.Null) h.Add("align", highcharts.FirstCharacterToLower(Align.ToString()));
			...
			if (Overflow != BubbleSeriesDataDataLabelsOverflow.Null) h.Add("overflow", highcharts.FirstCharacterToLower(Overflow.ToString()));
			if (Padding != null) h.Add("padding",Padding);
			if (Position != BubbleSeriesDataDataLabelsPosition.Null) h.Add("position", highcharts.FirstCharacterToLower(Position.ToString()));
			...
			if (VerticalAlign != BubbleSeriesDataDataLabelsVerticalAlign.Null) h.Add("verticalAlign", highcharts.FirstCharacterToLower(VerticalAlign.ToString()));
			if (X != null) h.Add("x",X);
			if (Y != null) h.Add("y",Y);
