...
{
	public partial class BubbleSeriesDataDragDrop  : BaseObject
	{
		public BubbleSeriesDataDragDrop()
		{
			DraggableX = DraggableX_DefaultValue = null;
			DraggableY = DraggableY_DefaultValue = null;
			DragHandle = DragHandle_DefaultValue = new BubbleSeriesDataDragDropDragHandle();
			...
			GuideBox = GuideBox_DefaultValue = new BubbleSeriesDataDragDropGuideBox();
		...
		/// </summary>
		public BubbleSeriesDataDragDropDragHandle DragHandle { get; set; }
		private BubbleSeriesDataDragDropDragHandle DragHandle_DefaultValue { get; set; }
		...
		/// </summary>
		public BubbleSeriesDataDragDropGuideBox GuideBox { get; set; }
		private BubbleSeriesDataDragDropGuideBox GuideBox_DefaultValue { get; set; }
