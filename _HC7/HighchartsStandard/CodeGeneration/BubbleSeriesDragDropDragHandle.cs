...
namespace Highsoft.Web.Mvc.Charts
{
	public partial class BubbleSeriesDragDropDragHandle  : BaseObject
	{
		...
		internal override Hashtable ToHashtable()
		{
			...
			if (PathFormatter != PathFormatter_DefaultValue) { h.Add("pathFormatter",PathFormatter); Highcharts.AddFunction("a87ff80d-c186-4d62-b8d4-ca59b79b35f6.pathFormatter", PathFormatter); }  
