...
namespace Highsoft.Web.Mvc.Charts
{
	public partial class BubbleSeriesDragDropDragHandle  : BaseObject
	{
		...
		internal override Hashtable ToHashtable()
		{
			...
			if (PathFormatter != PathFormatter_DefaultValue) { h.Add("pathFormatter",PathFormatter); Highcharts.AddFunction("723816ff-3a82-45ec-b6c6-3c7cce64a407.pathFormatter", PathFormatter); }  
