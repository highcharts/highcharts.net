...
{
	public partial class BubbleSeriesSonificationContextTracksMappingHighpassResonance  : BaseObject
	{
		Hashtable h = new Hashtable();

		public BubbleSeriesSonificationContextTracksMappingHighpassResonance()
		{
			MapFunction = MapFunction_DefaultValue = BubbleSeriesSonificationContextTracksMappingHighpassResonanceMapFunction.Linear;
			MapTo = MapTo_DefaultValue = "";
			Max = Max_DefaultValue = null;
			Min = Min_DefaultValue = null;
			Value = Value_DefaultValue = null;
			Within = Within_DefaultValue = BubbleSeriesSonificationContextTracksMappingHighpassResonanceWithin.Chart;
		...
		/// </summary>
		public BubbleSeriesSonificationContextTracksMappingHighpassResonanceMapFunction MapFunction { get; set; }
		private BubbleSeriesSonificationContextTracksMappingHighpassResonanceMapFunction MapFunction_DefaultValue { get; set; }
		...
		/// </summary>
		public BubbleSeriesSonificationContextTracksMappingHighpassResonanceWithin Within { get; set; }
		private BubbleSeriesSonificationContextTracksMappingHighpassResonanceWithin Within_DefaultValue { get; set; }
