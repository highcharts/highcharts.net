...
{
	public partial class BubbleSeriesSonificationContextTracksMappingLowpassFrequency  : BaseObject
	{
		Hashtable h = new Hashtable();

		public BubbleSeriesSonificationContextTracksMappingLowpassFrequency()
		{
			MapFunction = MapFunction_DefaultValue = BubbleSeriesSonificationContextTracksMappingLowpassFrequencyMapFunction.Linear;
			MapTo = MapTo_DefaultValue = "";
			Max = Max_DefaultValue = null;
			Min = Min_DefaultValue = null;
			Value = Value_DefaultValue = null;
			Within = Within_DefaultValue = BubbleSeriesSonificationContextTracksMappingLowpassFrequencyWithin.Chart;
		...
		/// </summary>
		public BubbleSeriesSonificationContextTracksMappingLowpassFrequencyMapFunction MapFunction { get; set; }
		private BubbleSeriesSonificationContextTracksMappingLowpassFrequencyMapFunction MapFunction_DefaultValue { get; set; }
		...
		/// </summary>
		public BubbleSeriesSonificationContextTracksMappingLowpassFrequencyWithin Within { get; set; }
		private BubbleSeriesSonificationContextTracksMappingLowpassFrequencyWithin Within_DefaultValue { get; set; }
