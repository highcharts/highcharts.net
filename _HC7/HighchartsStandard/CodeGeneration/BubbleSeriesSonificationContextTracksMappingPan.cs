...
{
	public partial class BubbleSeriesSonificationContextTracksMappingPan  : BaseObject
	{
		Hashtable h = new Hashtable();

		public BubbleSeriesSonificationContextTracksMappingPan()
		{
			MapFunction = MapFunction_DefaultValue = BubbleSeriesSonificationContextTracksMappingPanMapFunction.Linear;
			MapTo = MapTo_DefaultValue = "";
			Max = Max_DefaultValue = null;
			Min = Min_DefaultValue = null;
			Value = Value_DefaultValue = null;
			Within = Within_DefaultValue = BubbleSeriesSonificationContextTracksMappingPanWithin.Chart;
		...
		/// </summary>
		public BubbleSeriesSonificationContextTracksMappingPanMapFunction MapFunction { get; set; }
		private BubbleSeriesSonificationContextTracksMappingPanMapFunction MapFunction_DefaultValue { get; set; }
		...
		/// </summary>
		public BubbleSeriesSonificationContextTracksMappingPanWithin Within { get; set; }
		private BubbleSeriesSonificationContextTracksMappingPanWithin Within_DefaultValue { get; set; }
