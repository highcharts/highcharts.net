...
{
	public partial class BubbleSeriesSonificationContextTracksMappingPitch  : BaseObject
	{
		Hashtable h = new Hashtable();

		public BubbleSeriesSonificationContextTracksMappingPitch()
		{
			MapFunction = MapFunction_DefaultValue = BubbleSeriesSonificationContextTracksMappingPitchMapFunction.Linear;
		...
		/// </summary>
		public BubbleSeriesSonificationContextTracksMappingPitchMapFunction MapFunction { get; set; }
		private BubbleSeriesSonificationContextTracksMappingPitchMapFunction MapFunction_DefaultValue { get; set; }
