...
{
	public partial class BubbleSeriesSonificationContextTracksMappingTime  : BaseObject
	{
		Hashtable h = new Hashtable();

		public BubbleSeriesSonificationContextTracksMappingTime()
		{
			MapFunction = MapFunction_DefaultValue = BubbleSeriesSonificationContextTracksMappingTimeMapFunction.Linear;
			MapTo = MapTo_DefaultValue = "";
			Max = Max_DefaultValue = null;
			Min = Min_DefaultValue = null;
			Value = Value_DefaultValue = null;
			Within = Within_DefaultValue = BubbleSeriesSonificationContextTracksMappingTimeWithin.Chart;
		...
		/// </summary>
		public BubbleSeriesSonificationContextTracksMappingTimeMapFunction MapFunction { get; set; }
		private BubbleSeriesSonificationContextTracksMappingTimeMapFunction MapFunction_DefaultValue { get; set; }
		...
		/// </summary>
		public BubbleSeriesSonificationContextTracksMappingTimeWithin Within { get; set; }
		private BubbleSeriesSonificationContextTracksMappingTimeWithin Within_DefaultValue { get; set; }
