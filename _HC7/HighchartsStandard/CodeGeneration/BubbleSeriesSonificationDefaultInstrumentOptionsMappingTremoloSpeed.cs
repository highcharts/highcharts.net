...
{
	public partial class BubbleSeriesSonificationDefaultInstrumentOptionsMappingTremoloSpeed  : BaseObject
	{
		Hashtable h = new Hashtable();

		public BubbleSeriesSonificationDefaultInstrumentOptionsMappingTremoloSpeed()
		{
			MapFunction = MapFunction_DefaultValue = BubbleSeriesSonificationDefaultInstrumentOptionsMappingTremoloSpeedMapFunction.Linear;
			MapTo = MapTo_DefaultValue = "";
			Max = Max_DefaultValue = null;
			Min = Min_DefaultValue = null;
			Value = Value_DefaultValue = null;
			Within = Within_DefaultValue = BubbleSeriesSonificationDefaultInstrumentOptionsMappingTremoloSpeedWithin.Chart;
		...
		/// </summary>
		public BubbleSeriesSonificationDefaultInstrumentOptionsMappingTremoloSpeedMapFunction MapFunction { get; set; }
		private BubbleSeriesSonificationDefaultInstrumentOptionsMappingTremoloSpeedMapFunction MapFunction_DefaultValue { get; set; }
		...
		/// </summary>
		public BubbleSeriesSonificationDefaultInstrumentOptionsMappingTremoloSpeedWithin Within { get; set; }
		private BubbleSeriesSonificationDefaultInstrumentOptionsMappingTremoloSpeedWithin Within_DefaultValue { get; set; }
