...
{
	public partial class BubbleSeriesSonificationPointGrouping  : BaseObject
	{
		Hashtable h = new Hashtable();

		public BubbleSeriesSonificationPointGrouping()
		{
		...
		/// </summary>
		public BubbleSeriesSonificationPointGroupingAlgorithm Algorithm { get; set; }
		private BubbleSeriesSonificationPointGroupingAlgorithm Algorithm_DefaultValue { get; set; }
		...
		internal override Hashtable ToHashtable(Highcharts highcharts)
		{
			...
			if (Algorithm != BubbleSeriesSonificationPointGroupingAlgorithm.Null) h.Add("algorithm", highcharts.FirstCharacterToLower(Algorithm.ToString()));
