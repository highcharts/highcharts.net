...
{
	public partial class BubbleSeriesSonificationTracksMapping  : BaseObject
	{
		Hashtable h = new Hashtable();

		public BubbleSeriesSonificationTracksMapping()
		{
			Frequency = Frequency_DefaultValue = new BubbleSeriesSonificationTracksMappingFrequency();
			GapBetweenNotes = GapBetweenNotes_DefaultValue = new BubbleSeriesSonificationTracksMappingGapBetweenNotes();
			Highpass = Highpass_DefaultValue = new BubbleSeriesSonificationTracksMappingHighpass();
			Lowpass = Lowpass_DefaultValue = new BubbleSeriesSonificationTracksMappingLowpass();
			NoteDuration = NoteDuration_DefaultValue = new BubbleSeriesSonificationTracksMappingNoteDuration();
			Pan = Pan_DefaultValue = new BubbleSeriesSonificationTracksMappingPan();
			Pitch = Pitch_DefaultValue = new BubbleSeriesSonificationTracksMappingPitch();
			PitchString = PitchString_DefaultValue = "null";
			PitchNumber = PitchNumber_DefaultValue = null;
			PlayDelay = PlayDelay_DefaultValue = new BubbleSeriesSonificationTracksMappingPlayDelay();
			Time = Time_DefaultValue = new BubbleSeriesSonificationTracksMappingTime();
			TimeString = TimeString_DefaultValue = "null";
			TimeNumber = TimeNumber_DefaultValue = null;
			Tremolo = Tremolo_DefaultValue = new BubbleSeriesSonificationTracksMappingTremolo();
			Volume = Volume_DefaultValue = new BubbleSeriesSonificationTracksMappingVolume();
		...
		/// </summary>
		public BubbleSeriesSonificationTracksMappingFrequency Frequency { get; set; }
		private BubbleSeriesSonificationTracksMappingFrequency Frequency_DefaultValue { get; set; }
		...
		/// </summary>
		public BubbleSeriesSonificationTracksMappingGapBetweenNotes GapBetweenNotes { get; set; }
		private BubbleSeriesSonificationTracksMappingGapBetweenNotes GapBetweenNotes_DefaultValue { get; set; }
		...
		/// </summary>
		public BubbleSeriesSonificationTracksMappingHighpass Highpass { get; set; }
		private BubbleSeriesSonificationTracksMappingHighpass Highpass_DefaultValue { get; set; }
		...
		/// </summary>
		public BubbleSeriesSonificationTracksMappingLowpass Lowpass { get; set; }
		private BubbleSeriesSonificationTracksMappingLowpass Lowpass_DefaultValue { get; set; }
		...
		/// </summary>
		public BubbleSeriesSonificationTracksMappingNoteDuration NoteDuration { get; set; }
		private BubbleSeriesSonificationTracksMappingNoteDuration NoteDuration_DefaultValue { get; set; }
		...
		/// </summary>
		public BubbleSeriesSonificationTracksMappingPan Pan { get; set; }
		private BubbleSeriesSonificationTracksMappingPan Pan_DefaultValue { get; set; }
		...
		/// </summary>
		public BubbleSeriesSonificationTracksMappingPitch Pitch { get; set; }
		private BubbleSeriesSonificationTracksMappingPitch Pitch_DefaultValue { get; set; }
		...
		/// </summary>
		public BubbleSeriesSonificationTracksMappingPlayDelay PlayDelay { get; set; }
		private BubbleSeriesSonificationTracksMappingPlayDelay PlayDelay_DefaultValue { get; set; }
		...
		/// </summary>
		public BubbleSeriesSonificationTracksMappingTime Time { get; set; }
		private BubbleSeriesSonificationTracksMappingTime Time_DefaultValue { get; set; }
		...
		/// </summary>
		public BubbleSeriesSonificationTracksMappingTremolo Tremolo { get; set; }
		private BubbleSeriesSonificationTracksMappingTremolo Tremolo_DefaultValue { get; set; }
		 

		/// <summary>
		/// The volume of notes, from 0 to 1.
		/// </summary>
		public BubbleSeriesSonificationTracksMappingVolume Volume { get; set; }
		private BubbleSeriesSonificationTracksMappingVolume Volume_DefaultValue { get; set; }
