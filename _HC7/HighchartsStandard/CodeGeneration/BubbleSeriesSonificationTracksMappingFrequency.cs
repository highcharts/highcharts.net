...
{
	public partial class BubbleSeriesSonificationTracksMappingFrequency  : BaseObject
	{
		Hashtable h = new Hashtable();

		public BubbleSeriesSonificationTracksMappingFrequency()
		{
			MapFunction = MapFunction_DefaultValue = BubbleSeriesSonificationTracksMappingFrequencyMapFunction.Linear;
			MapTo = MapTo_DefaultValue = "";
			Max = Max_DefaultValue = null;
			Min = Min_DefaultValue = null;
			Value = Value_DefaultValue = null;
			Within = Within_DefaultValue = BubbleSeriesSonificationTracksMappingFrequencyWithin.Chart;
		...
		/// </summary>
		public BubbleSeriesSonificationTracksMappingFrequencyMapFunction MapFunction { get; set; }
		private BubbleSeriesSonificationTracksMappingFrequencyMapFunction MapFunction_DefaultValue { get; set; }
		...
		/// </summary>
		public BubbleSeriesSonificationTracksMappingFrequencyWithin Within { get; set; }
		private BubbleSeriesSonificationTracksMappingFrequencyWithin Within_DefaultValue { get; set; }
