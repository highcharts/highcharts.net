...
{
	public partial class BubbleSeriesSonificationTracksMappingLowpassResonance  : BaseObject
	{
		Hashtable h = new Hashtable();

		public BubbleSeriesSonificationTracksMappingLowpassResonance()
		{
			MapFunction = MapFunction_DefaultValue = BubbleSeriesSonificationTracksMappingLowpassResonanceMapFunction.Linear;
			MapTo = MapTo_DefaultValue = "";
			Max = Max_DefaultValue = null;
			Min = Min_DefaultValue = null;
			Value = Value_DefaultValue = null;
			Within = Within_DefaultValue = BubbleSeriesSonificationTracksMappingLowpassResonanceWithin.Chart;
		...
		/// </summary>
		public BubbleSeriesSonificationTracksMappingLowpassResonanceMapFunction MapFunction { get; set; }
		private BubbleSeriesSonificationTracksMappingLowpassResonanceMapFunction MapFunction_DefaultValue { get; set; }
		...
		/// </summary>
		public BubbleSeriesSonificationTracksMappingLowpassResonanceWithin Within { get; set; }
		private BubbleSeriesSonificationTracksMappingLowpassResonanceWithin Within_DefaultValue { get; set; }
