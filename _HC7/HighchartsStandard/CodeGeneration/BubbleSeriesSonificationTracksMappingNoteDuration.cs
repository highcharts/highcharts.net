...
{
	public partial class BubbleSeriesSonificationTracksMappingNoteDuration  : BaseObject
	{
		Hashtable h = new Hashtable();

		public BubbleSeriesSonificationTracksMappingNoteDuration()
		{
			MapFunction = MapFunction_DefaultValue = BubbleSeriesSonificationTracksMappingNoteDurationMapFunction.Linear;
			MapTo = MapTo_DefaultValue = "";
			Max = Max_DefaultValue = null;
			Min = Min_DefaultValue = null;
			Value = Value_DefaultValue = null;
			Within = Within_DefaultValue = BubbleSeriesSonificationTracksMappingNoteDurationWithin.Chart;
		...
		/// </summary>
		public BubbleSeriesSonificationTracksMappingNoteDurationMapFunction MapFunction { get; set; }
		private BubbleSeriesSonificationTracksMappingNoteDurationMapFunction MapFunction_DefaultValue { get; set; }
		...
		/// </summary>
		public BubbleSeriesSonificationTracksMappingNoteDurationWithin Within { get; set; }
		private BubbleSeriesSonificationTracksMappingNoteDurationWithin Within_DefaultValue { get; set; }
