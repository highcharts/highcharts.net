...
{
	public partial class BubbleSeriesSonificationTracksMappingPan  : BaseObject
	{
		Hashtable h = new Hashtable();

		public BubbleSeriesSonificationTracksMappingPan()
		{
			MapFunction = MapFunction_DefaultValue = BubbleSeriesSonificationTracksMappingPanMapFunction.Linear;
			MapTo = MapTo_DefaultValue = "";
			Max = Max_DefaultValue = null;
			Min = Min_DefaultValue = null;
			Value = Value_DefaultValue = null;
			Within = Within_DefaultValue = BubbleSeriesSonificationTracksMappingPanWithin.Chart;
		...
		/// </summary>
		public BubbleSeriesSonificationTracksMappingPanMapFunction MapFunction { get; set; }
		private BubbleSeriesSonificationTracksMappingPanMapFunction MapFunction_DefaultValue { get; set; }
		...
		/// </summary>
		public BubbleSeriesSonificationTracksMappingPanWithin Within { get; set; }
		private BubbleSeriesSonificationTracksMappingPanWithin Within_DefaultValue { get; set; }
