...
{
	public partial class BubbleSeriesSonificationTracksMappingPitch  : BaseObject
	{
		Hashtable h = new Hashtable();

		public BubbleSeriesSonificationTracksMappingPitch()
		{
			MapFunction = MapFunction_DefaultValue = BubbleSeriesSonificationTracksMappingPitchMapFunction.Linear;
		...
		/// </summary>
		public BubbleSeriesSonificationTracksMappingPitchMapFunction MapFunction { get; set; }
		private BubbleSeriesSonificationTracksMappingPitchMapFunction MapFunction_DefaultValue { get; set; }
