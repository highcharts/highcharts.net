...
{
	public partial class BubbleSeriesSonificationTracksMappingTime  : BaseObject
	{
		Hashtable h = new Hashtable();

		public BubbleSeriesSonificationTracksMappingTime()
		{
			MapFunction = MapFunction_DefaultValue = BubbleSeriesSonificationTracksMappingTimeMapFunction.Linear;
			MapTo = MapTo_DefaultValue = "";
			Max = Max_DefaultValue = null;
			Min = Min_DefaultValue = null;
			Value = Value_DefaultValue = null;
			Within = Within_DefaultValue = BubbleSeriesSonificationTracksMappingTimeWithin.Chart;
		...
		/// </summary>
		public BubbleSeriesSonificationTracksMappingTimeMapFunction MapFunction { get; set; }
		private BubbleSeriesSonificationTracksMappingTimeMapFunction MapFunction_DefaultValue { get; set; }
		...
		/// </summary>
		public BubbleSeriesSonificationTracksMappingTimeWithin Within { get; set; }
		private BubbleSeriesSonificationTracksMappingTimeWithin Within_DefaultValue { get; set; }
