...
{
	public partial class BubbleSeriesSonificationTracksMappingTremoloDepth  : BaseObject
	{
		Hashtable h = new Hashtable();

		public BubbleSeriesSonificationTracksMappingTremoloDepth()
		{
			MapFunction = MapFunction_DefaultValue = BubbleSeriesSonificationTracksMappingTremoloDepthMapFunction.Linear;
			MapTo = MapTo_DefaultValue = "";
			Max = Max_DefaultValue = null;
			Min = Min_DefaultValue = null;
			Value = Value_DefaultValue = null;
			Within = Within_DefaultValue = BubbleSeriesSonificationTracksMappingTremoloDepthWithin.Chart;
		...
		/// </summary>
		public BubbleSeriesSonificationTracksMappingTremoloDepthMapFunction MapFunction { get; set; }
		private BubbleSeriesSonificationTracksMappingTremoloDepthMapFunction MapFunction_DefaultValue { get; set; }
		...
		/// </summary>
		public BubbleSeriesSonificationTracksMappingTremoloDepthWithin Within { get; set; }
		private BubbleSeriesSonificationTracksMappingTremoloDepthWithin Within_DefaultValue { get; set; }
