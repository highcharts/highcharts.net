...
{
	public partial class BubbleSeriesSonificationTracksMappingTremoloSpeed  : BaseObject
	{
		Hashtable h = new Hashtable();

		public BubbleSeriesSonificationTracksMappingTremoloSpeed()
		{
			MapFunction = MapFunction_DefaultValue = BubbleSeriesSonificationTracksMappingTremoloSpeedMapFunction.Linear;
			MapTo = MapTo_DefaultValue = "";
			Max = Max_DefaultValue = null;
			Min = Min_DefaultValue = null;
			Value = Value_DefaultValue = null;
			Within = Within_DefaultValue = BubbleSeriesSonificationTracksMappingTremoloSpeedWithin.Chart;
		...
		/// </summary>
		public BubbleSeriesSonificationTracksMappingTremoloSpeedMapFunction MapFunction { get; set; }
		private BubbleSeriesSonificationTracksMappingTremoloSpeedMapFunction MapFunction_DefaultValue { get; set; }
		...
		/// </summary>
		public BubbleSeriesSonificationTracksMappingTremoloSpeedWithin Within { get; set; }
		private BubbleSeriesSonificationTracksMappingTremoloSpeedWithin Within_DefaultValue { get; set; }
