...
{
	public partial class BubbleSeriesSonificationTracksMappingVolume  : BaseObject
	{
		Hashtable h = new Hashtable();

		public BubbleSeriesSonificationTracksMappingVolume()
		{
			MapFunction = MapFunction_DefaultValue = BubbleSeriesSonificationTracksMappingVolumeMapFunction.Linear;
			MapTo = MapTo_DefaultValue = "";
			Max = Max_DefaultValue = null;
			Min = Min_DefaultValue = null;
			Value = Value_DefaultValue = null;
			Within = Within_DefaultValue = BubbleSeriesSonificationTracksMappingVolumeWithin.Chart;
		...
		/// </summary>
		public BubbleSeriesSonificationTracksMappingVolumeMapFunction MapFunction { get; set; }
		private BubbleSeriesSonificationTracksMappingVolumeMapFunction MapFunction_DefaultValue { get; set; }
		...
		/// </summary>
		public BubbleSeriesSonificationTracksMappingVolumeWithin Within { get; set; }
		private BubbleSeriesSonificationTracksMappingVolumeWithin Within_DefaultValue { get; set; }
