...
{
	public partial class BubbleSeriesSonificationTracksPointGrouping  : BaseObject
	{
		Hashtable h = new Hashtable();

		public BubbleSeriesSonificationTracksPointGrouping()
		{
		...
		/// </summary>
		public BubbleSeriesSonificationTracksPointGroupingAlgorithm Algorithm { get; set; }
		private BubbleSeriesSonificationTracksPointGroupingAlgorithm Algorithm_DefaultValue { get; set; }
		...
		internal override Hashtable ToHashtable(Highcharts highcharts)
		{
			...
			if (Algorithm != BubbleSeriesSonificationTracksPointGroupingAlgorithm.Null) h.Add("algorithm", highcharts.FirstCharacterToLower(Algorithm.ToString()));
