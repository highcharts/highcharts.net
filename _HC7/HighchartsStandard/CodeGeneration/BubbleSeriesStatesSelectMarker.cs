...
{
	public partial class BubbleSeriesStatesSelectMarker  : BaseObject
	{
		public BubbleSeriesStatesSelectMarker()
		{
			...
			States = States_DefaultValue = new BubbleSeriesStatesSelectMarkerStates();
		...
		/// </summary>
		public BubbleSeriesStatesSelectMarkerStates States { get; set; }
		private BubbleSeriesStatesSelectMarkerStates States_DefaultValue { get; set; }
