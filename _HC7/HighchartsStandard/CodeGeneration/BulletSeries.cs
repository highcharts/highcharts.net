...
namespace Highsoft.Web.Mvc.Charts
{
	public partial class BulletSeries  : Series
	{
		...
		public BulletSeries()
		{
			...
			Dumbell = Dumbell_DefaultValue = new BulletSeriesDumbell();
			...
			LegendSymbol = LegendSymbol_DefaultValue = BulletSeriesLegendSymbol.Rectangle;
			...
			Sonification = Sonification_DefaultValue = new BulletSeriesSonification();
		...
		/// 
		/// </summary>
		public BulletSeriesDumbell Dumbell { get; set; }
		private BulletSeriesDumbell Dumbell_DefaultValue { get; set; }
