...
{
	public partial class BulletSeriesDataDataLabels  : BaseObject
	{
		Hashtable h = new Hashtable();

		public BulletSeriesDataDataLabels()
		{
		...
		/// </summary>
		public BulletSeriesDataDataLabelsAlign Align { get; set; }
		private BulletSeriesDataDataLabelsAlign Align_DefaultValue { get; set; }
		...
		/// </summary>
		public BulletSeriesDataDataLabelsFilter Filter { get; set; }
		private BulletSeriesDataDataLabelsFilter Filter_DefaultValue { get; set; }
		...
		/// </summary>
		public BulletSeriesDataDataLabelsOverflow Overflow { get; set; }
		private BulletSeriesDataDataLabelsOverflow Overflow_DefaultValue { get; set; }
		...
		/// </summary>
		public BulletSeriesDataDataLabelsPosition Position { get; set; }
		private BulletSeriesDataDataLabelsPosition Position_DefaultValue { get; set; }
		...
		/// </summary>
		public BulletSeriesDataDataLabelsTextPath TextPath { get; set; }
		private BulletSeriesDataDataLabelsTextPath TextPath_DefaultValue { get; set; }
		...
		/// </summary>
		public BulletSeriesDataDataLabelsVerticalAlign VerticalAlign { get; set; }
		private BulletSeriesDataDataLabelsVerticalAlign VerticalAlign_DefaultValue { get; set; }
		...
		internal override Hashtable ToHashtable(Highcharts highcharts)
		{
			...
			if (Align != BulletSeriesDataDataLabelsAlign.Null) h.Add("align", highcharts.FirstCharacterToLower(Align.ToString()));
			...
			if (Overflow != BulletSeriesDataDataLabelsOverflow.Null) h.Add("overflow", highcharts.FirstCharacterToLower(Overflow.ToString()));
			if (Padding != null) h.Add("padding",Padding);
			if (Position != BulletSeriesDataDataLabelsPosition.Null) h.Add("position", highcharts.FirstCharacterToLower(Position.ToString()));
			...
			if (VerticalAlign != BulletSeriesDataDataLabelsVerticalAlign.Null) h.Add("verticalAlign", highcharts.FirstCharacterToLower(VerticalAlign.ToString()));
			if (X != null) h.Add("x",X);
			if (Y != null) h.Add("y",Y);
