...
{
	public partial class BulletSeriesDragDrop  : BaseObject
	{
		public BulletSeriesDragDrop()
		{
			DraggableX = DraggableX_DefaultValue = null;
			DraggableY = DraggableY_DefaultValue = null;
			DragHandle = DragHandle_DefaultValue = new BulletSeriesDragDropDragHandle();
			...
			GuideBox = GuideBox_DefaultValue = new BulletSeriesDragDropGuideBox();
		...
		/// </summary>
		public BulletSeriesDragDropDragHandle DragHandle { get; set; }
		private BulletSeriesDragDropDragHandle DragHandle_DefaultValue { get; set; }
		...
		/// </summary>
		public BulletSeriesDragDropGuideBox GuideBox { get; set; }
		private BulletSeriesDragDropGuideBox GuideBox_DefaultValue { get; set; }
