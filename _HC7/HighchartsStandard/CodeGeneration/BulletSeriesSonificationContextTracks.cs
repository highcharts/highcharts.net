...
{
	public partial class BulletSeriesSonificationContextTracks  : BaseObject
	{
		Hashtable h = new Hashtable();

		public BulletSeriesSonificationContextTracks()
		{
			ActiveWhen = ActiveWhen_DefaultValue = new BulletSeriesSonificationContextTracksActiveWhen();
			Instrument = Instrument_DefaultValue = null;
			InstrumentString = InstrumentString_DefaultValue = "null";
			Mapping = Mapping_DefaultValue = new BulletSeriesSonificationContextTracksMapping();
			MidiName = MidiName_DefaultValue = "";
			PointGrouping = PointGrouping_DefaultValue = new BulletSeriesSonificationContextTracksPointGrouping();
			...
			Type = Type_DefaultValue = BulletSeriesSonificationContextTracksType.Instrument;
			ValueInterval = ValueInterval_DefaultValue = null;
			ValueMapFunction = ValueMapFunction_DefaultValue = BulletSeriesSonificationContextTracksValueMapFunction.Linear;
		...
		/// </summary>
		public BulletSeriesSonificationContextTracksActiveWhen ActiveWhen { get; set; }
		private BulletSeriesSonificationContextTracksActiveWhen ActiveWhen_DefaultValue { get; set; }
		...
		/// </summary>
		public BulletSeriesSonificationContextTracksMapping Mapping { get; set; }
		private BulletSeriesSonificationContextTracksMapping Mapping_DefaultValue { get; set; }
		...
		/// </summary>
		public BulletSeriesSonificationContextTracksPointGrouping PointGrouping { get; set; }
		private BulletSeriesSonificationContextTracksPointGrouping PointGrouping_DefaultValue { get; set; }
		...
		/// </summary>
		public BulletSeriesSonificationContextTracksType Type { get; set; }
		private BulletSeriesSonificationContextTracksType Type_DefaultValue { get; set; }
		...
		/// </summary>
		public BulletSeriesSonificationContextTracksValueMapFunction ValueMapFunction { get; set; }
		private BulletSeriesSonificationContextTracksValueMapFunction ValueMapFunction_DefaultValue { get; set; }
