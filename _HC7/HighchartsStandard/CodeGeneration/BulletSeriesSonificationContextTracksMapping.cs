...
{
	public partial class BulletSeriesSonificationContextTracksMapping  : BaseObject
	{
		Hashtable h = new Hashtable();

		public BulletSeriesSonificationContextTracksMapping()
		{
			Frequency = Frequency_DefaultValue = new BulletSeriesSonificationContextTracksMappingFrequency();
			GapBetweenNotes = GapBetweenNotes_DefaultValue = new BulletSeriesSonificationContextTracksMappingGapBetweenNotes();
			Highpass = Highpass_DefaultValue = new BulletSeriesSonificationContextTracksMappingHighpass();
			Lowpass = Lowpass_DefaultValue = new BulletSeriesSonificationContextTracksMappingLowpass();
			NoteDuration = NoteDuration_DefaultValue = new BulletSeriesSonificationContextTracksMappingNoteDuration();
			Pan = Pan_DefaultValue = new BulletSeriesSonificationContextTracksMappingPan();
			Pitch = Pitch_DefaultValue = new BulletSeriesSonificationContextTracksMappingPitch();
			PitchString = PitchString_DefaultValue = "null";
			PitchNumber = PitchNumber_DefaultValue = null;
			PlayDelay = PlayDelay_DefaultValue = new BulletSeriesSonificationContextTracksMappingPlayDelay();
			Time = Time_DefaultValue = new BulletSeriesSonificationContextTracksMappingTime();
			TimeString = TimeString_DefaultValue = "null";
			TimeNumber = TimeNumber_DefaultValue = null;
			Tremolo = Tremolo_DefaultValue = new BulletSeriesSonificationContextTracksMappingTremolo();
			Volume = Volume_DefaultValue = new BulletSeriesSonificationContextTracksMappingVolume();
		...
		/// </summary>
		public BulletSeriesSonificationContextTracksMappingFrequency Frequency { get; set; }
		private BulletSeriesSonificationContextTracksMappingFrequency Frequency_DefaultValue { get; set; }
		...
		/// </summary>
		public BulletSeriesSonificationContextTracksMappingGapBetweenNotes GapBetweenNotes { get; set; }
		private BulletSeriesSonificationContextTracksMappingGapBetweenNotes GapBetweenNotes_DefaultValue { get; set; }
		...
		/// </summary>
		public BulletSeriesSonificationContextTracksMappingHighpass Highpass { get; set; }
		private BulletSeriesSonificationContextTracksMappingHighpass Highpass_DefaultValue { get; set; }
		...
		/// </summary>
		public BulletSeriesSonificationContextTracksMappingLowpass Lowpass { get; set; }
		private BulletSeriesSonificationContextTracksMappingLowpass Lowpass_DefaultValue { get; set; }
		...
		/// </summary>
		public BulletSeriesSonificationContextTracksMappingNoteDuration NoteDuration { get; set; }
		private BulletSeriesSonificationContextTracksMappingNoteDuration NoteDuration_DefaultValue { get; set; }
		...
		/// </summary>
		public BulletSeriesSonificationContextTracksMappingPan Pan { get; set; }
		private BulletSeriesSonificationContextTracksMappingPan Pan_DefaultValue { get; set; }
		...
		/// </summary>
		public BulletSeriesSonificationContextTracksMappingPitch Pitch { get; set; }
		private BulletSeriesSonificationContextTracksMappingPitch Pitch_DefaultValue { get; set; }
		...
		/// </summary>
		public BulletSeriesSonificationContextTracksMappingPlayDelay PlayDelay { get; set; }
		private BulletSeriesSonificationContextTracksMappingPlayDelay PlayDelay_DefaultValue { get; set; }
		...
		/// </summary>
		public BulletSeriesSonificationContextTracksMappingTime Time { get; set; }
		private BulletSeriesSonificationContextTracksMappingTime Time_DefaultValue { get; set; }
		...
		/// </summary>
		public BulletSeriesSonificationContextTracksMappingTremolo Tremolo { get; set; }
		private BulletSeriesSonificationContextTracksMappingTremolo Tremolo_DefaultValue { get; set; }
		 

		/// <summary>
		/// The volume of notes, from 0 to 1.
		/// </summary>
		public BulletSeriesSonificationContextTracksMappingVolume Volume { get; set; }
		private BulletSeriesSonificationContextTracksMappingVolume Volume_DefaultValue { get; set; }
