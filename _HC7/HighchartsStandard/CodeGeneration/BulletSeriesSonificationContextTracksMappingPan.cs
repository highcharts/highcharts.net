...
{
	public partial class BulletSeriesSonificationContextTracksMappingPan  : BaseObject
	{
		Hashtable h = new Hashtable();

		public BulletSeriesSonificationContextTracksMappingPan()
		{
			MapFunction = MapFunction_DefaultValue = BulletSeriesSonificationContextTracksMappingPanMapFunction.Linear;
			MapTo = MapTo_DefaultValue = "";
			Max = Max_DefaultValue = null;
			Min = Min_DefaultValue = null;
			Value = Value_DefaultValue = null;
			Within = Within_DefaultValue = BulletSeriesSonificationContextTracksMappingPanWithin.Chart;
		...
		/// </summary>
		public BulletSeriesSonificationContextTracksMappingPanMapFunction MapFunction { get; set; }
		private BulletSeriesSonificationContextTracksMappingPanMapFunction MapFunction_DefaultValue { get; set; }
		...
		/// </summary>
		public BulletSeriesSonificationContextTracksMappingPanWithin Within { get; set; }
		private BulletSeriesSonificationContextTracksMappingPanWithin Within_DefaultValue { get; set; }
