...
{
	public partial class BulletSeriesSonificationContextTracksMappingVolume  : BaseObject
	{
		Hashtable h = new Hashtable();

		public BulletSeriesSonificationContextTracksMappingVolume()
		{
			MapFunction = MapFunction_DefaultValue = BulletSeriesSonificationContextTracksMappingVolumeMapFunction.Linear;
			MapTo = MapTo_DefaultValue = "";
			Max = Max_DefaultValue = null;
			Min = Min_DefaultValue = null;
			Value = Value_DefaultValue = null;
			Within = Within_DefaultValue = BulletSeriesSonificationContextTracksMappingVolumeWithin.Chart;
		...
		/// </summary>
		public BulletSeriesSonificationContextTracksMappingVolumeMapFunction MapFunction { get; set; }
		private BulletSeriesSonificationContextTracksMappingVolumeMapFunction MapFunction_DefaultValue { get; set; }
		...
		/// </summary>
		public BulletSeriesSonificationContextTracksMappingVolumeWithin Within { get; set; }
		private BulletSeriesSonificationContextTracksMappingVolumeWithin Within_DefaultValue { get; set; }
