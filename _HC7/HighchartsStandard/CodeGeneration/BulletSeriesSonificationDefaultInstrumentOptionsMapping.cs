...
namespace Highsoft.Web.Mvc.Charts
{
	public partial class BulletSeriesSonificationDefaultInstrumentOptionsMapping  : BaseObject
	{
		...
		public BulletSeriesSonificationDefaultInstrumentOptionsMapping()
		{
			...
			Time = Time_DefaultValue = new BulletSeriesSonificationDefaultInstrumentOptionsMappingTime();
		...
		/// </summary>
		public BulletSeriesSonificationDefaultInstrumentOptionsMappingTime Time { get; set; }
		private BulletSeriesSonificationDefaultInstrumentOptionsMappingTime Time_DefaultValue { get; set; }
