...
{
	public partial class BulletSeriesSonificationDefaultSpeechOptionsMapping  : BaseObject
	{
		Hashtable h = new Hashtable();

		public BulletSeriesSonificationDefaultSpeechOptionsMapping()
		{
			Frequency = Frequency_DefaultValue = new BulletSeriesSonificationDefaultSpeechOptionsMappingFrequency();
			GapBetweenNotes = GapBetweenNotes_DefaultValue = new BulletSeriesSonificationDefaultSpeechOptionsMappingGapBetweenNotes();
			Highpass = Highpass_DefaultValue = new BulletSeriesSonificationDefaultSpeechOptionsMappingHighpass();
			Lowpass = Lowpass_DefaultValue = new BulletSeriesSonificationDefaultSpeechOptionsMappingLowpass();
			NoteDuration = NoteDuration_DefaultValue = new BulletSeriesSonificationDefaultSpeechOptionsMappingNoteDuration();
			Pan = Pan_DefaultValue = new BulletSeriesSonificationDefaultSpeechOptionsMappingPan();
			Pitch = Pitch_DefaultValue = new BulletSeriesSonificationDefaultSpeechOptionsMappingPitch();
			PitchString = PitchString_DefaultValue = "null";
			PitchNumber = PitchNumber_DefaultValue = null;
			PlayDelay = PlayDelay_DefaultValue = new BulletSeriesSonificationDefaultSpeechOptionsMappingPlayDelay();
			Time = Time_DefaultValue = new BulletSeriesSonificationDefaultSpeechOptionsMappingTime();
			TimeString = TimeString_DefaultValue = "null";
			TimeNumber = TimeNumber_DefaultValue = null;
			Tremolo = Tremolo_DefaultValue = new BulletSeriesSonificationDefaultSpeechOptionsMappingTremolo();
			Volume = Volume_DefaultValue = new BulletSeriesSonificationDefaultSpeechOptionsMappingVolume();
		...
		/// </summary>
		public BulletSeriesSonificationDefaultSpeechOptionsMappingFrequency Frequency { get; set; }
		private BulletSeriesSonificationDefaultSpeechOptionsMappingFrequency Frequency_DefaultValue { get; set; }
		...
		/// </summary>
		public BulletSeriesSonificationDefaultSpeechOptionsMappingGapBetweenNotes GapBetweenNotes { get; set; }
		private BulletSeriesSonificationDefaultSpeechOptionsMappingGapBetweenNotes GapBetweenNotes_DefaultValue { get; set; }
		...
		/// </summary>
		public BulletSeriesSonificationDefaultSpeechOptionsMappingHighpass Highpass { get; set; }
		private BulletSeriesSonificationDefaultSpeechOptionsMappingHighpass Highpass_DefaultValue { get; set; }
		...
		/// </summary>
		public BulletSeriesSonificationDefaultSpeechOptionsMappingLowpass Lowpass { get; set; }
		private BulletSeriesSonificationDefaultSpeechOptionsMappingLowpass Lowpass_DefaultValue { get; set; }
		...
		/// </summary>
		public BulletSeriesSonificationDefaultSpeechOptionsMappingNoteDuration NoteDuration { get; set; }
		private BulletSeriesSonificationDefaultSpeechOptionsMappingNoteDuration NoteDuration_DefaultValue { get; set; }
		...
		/// </summary>
		public BulletSeriesSonificationDefaultSpeechOptionsMappingPan Pan { get; set; }
		private BulletSeriesSonificationDefaultSpeechOptionsMappingPan Pan_DefaultValue { get; set; }
		...
		/// </summary>
		public BulletSeriesSonificationDefaultSpeechOptionsMappingPitch Pitch { get; set; }
		private BulletSeriesSonificationDefaultSpeechOptionsMappingPitch Pitch_DefaultValue { get; set; }
		...
		/// </summary>
		public BulletSeriesSonificationDefaultSpeechOptionsMappingPlayDelay PlayDelay { get; set; }
		private BulletSeriesSonificationDefaultSpeechOptionsMappingPlayDelay PlayDelay_DefaultValue { get; set; }
		...
		/// </summary>
		public BulletSeriesSonificationDefaultSpeechOptionsMappingTime Time { get; set; }
		private BulletSeriesSonificationDefaultSpeechOptionsMappingTime Time_DefaultValue { get; set; }
		...
		/// </summary>
		public BulletSeriesSonificationDefaultSpeechOptionsMappingTremolo Tremolo { get; set; }
		private BulletSeriesSonificationDefaultSpeechOptionsMappingTremolo Tremolo_DefaultValue { get; set; }
		 

		/// <summary>
		/// The volume of notes, from 0 to 1.
		/// </summary>
		public BulletSeriesSonificationDefaultSpeechOptionsMappingVolume Volume { get; set; }
		private BulletSeriesSonificationDefaultSpeechOptionsMappingVolume Volume_DefaultValue { get; set; }
