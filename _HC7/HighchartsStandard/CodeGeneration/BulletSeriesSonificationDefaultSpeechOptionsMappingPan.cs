...
{
	public partial class BulletSeriesSonificationDefaultSpeechOptionsMappingPan  : BaseObject
	{
		Hashtable h = new Hashtable();

		public BulletSeriesSonificationDefaultSpeechOptionsMappingPan()
		{
			MapFunction = MapFunction_DefaultValue = BulletSeriesSonificationDefaultSpeechOptionsMappingPanMapFunction.Linear;
			MapTo = MapTo_DefaultValue = "";
			Max = Max_DefaultValue = null;
			Min = Min_DefaultValue = null;
			Value = Value_DefaultValue = null;
			Within = Within_DefaultValue = BulletSeriesSonificationDefaultSpeechOptionsMappingPanWithin.Chart;
		...
		/// </summary>
		public BulletSeriesSonificationDefaultSpeechOptionsMappingPanMapFunction MapFunction { get; set; }
		private BulletSeriesSonificationDefaultSpeechOptionsMappingPanMapFunction MapFunction_DefaultValue { get; set; }
		...
		/// </summary>
		public BulletSeriesSonificationDefaultSpeechOptionsMappingPanWithin Within { get; set; }
		private BulletSeriesSonificationDefaultSpeechOptionsMappingPanWithin Within_DefaultValue { get; set; }
