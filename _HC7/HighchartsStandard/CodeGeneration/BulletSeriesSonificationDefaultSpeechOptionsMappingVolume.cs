...
{
	public partial class BulletSeriesSonificationDefaultSpeechOptionsMappingVolume  : BaseObject
	{
		Hashtable h = new Hashtable();

		public BulletSeriesSonificationDefaultSpeechOptionsMappingVolume()
		{
			MapFunction = MapFunction_DefaultValue = BulletSeriesSonificationDefaultSpeechOptionsMappingVolumeMapFunction.Linear;
			MapTo = MapTo_DefaultValue = "";
			Max = Max_DefaultValue = null;
			Min = Min_DefaultValue = null;
			Value = Value_DefaultValue = null;
			Within = Within_DefaultValue = BulletSeriesSonificationDefaultSpeechOptionsMappingVolumeWithin.Chart;
		...
		/// </summary>
		public BulletSeriesSonificationDefaultSpeechOptionsMappingVolumeMapFunction MapFunction { get; set; }
		private BulletSeriesSonificationDefaultSpeechOptionsMappingVolumeMapFunction MapFunction_DefaultValue { get; set; }
		...
		/// </summary>
		public BulletSeriesSonificationDefaultSpeechOptionsMappingVolumeWithin Within { get; set; }
		private BulletSeriesSonificationDefaultSpeechOptionsMappingVolumeWithin Within_DefaultValue { get; set; }
