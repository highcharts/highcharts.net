...
{
	public partial class BulletSeriesSonificationPointGrouping  : BaseObject
	{
		Hashtable h = new Hashtable();

		public BulletSeriesSonificationPointGrouping()
		{
		...
		/// </summary>
		public BulletSeriesSonificationPointGroupingAlgorithm Algorithm { get; set; }
		private BulletSeriesSonificationPointGroupingAlgorithm Algorithm_DefaultValue { get; set; }
		...
		internal override Hashtable ToHashtable(Highcharts highcharts)
		{
			...
			if (Algorithm != BulletSeriesSonificationPointGroupingAlgorithm.Null) h.Add("algorithm", highcharts.FirstCharacterToLower(Algorithm.ToString()));
