...
{
	public partial class BulletSeriesSonificationTracks  : BaseObject
	{
		Hashtable h = new Hashtable();

		public BulletSeriesSonificationTracks()
		{
			ActiveWhen = ActiveWhen_DefaultValue = new BulletSeriesSonificationTracksActiveWhen();
			Instrument = Instrument_DefaultValue = null;
			InstrumentString = InstrumentString_DefaultValue = "null";
			Mapping = Mapping_DefaultValue = new BulletSeriesSonificationTracksMapping();
			MidiName = MidiName_DefaultValue = "";
			PointGrouping = PointGrouping_DefaultValue = new BulletSeriesSonificationTracksPointGrouping();
			RoundToMusicalNotes = RoundToMusicalNotes_DefaultValue = true;
			ShowPlayMarker = ShowPlayMarker_DefaultValue = true;
			Type = Type_DefaultValue = BulletSeriesSonificationTracksType.Instrument;
		...
		/// </summary>
		public BulletSeriesSonificationTracksActiveWhen ActiveWhen { get; set; }
		private BulletSeriesSonificationTracksActiveWhen ActiveWhen_DefaultValue { get; set; }
		...
		/// </summary>
		public BulletSeriesSonificationTracksMapping Mapping { get; set; }
		private BulletSeriesSonificationTracksMapping Mapping_DefaultValue { get; set; }
		...
		/// </summary>
		public BulletSeriesSonificationTracksPointGrouping PointGrouping { get; set; }
		private BulletSeriesSonificationTracksPointGrouping PointGrouping_DefaultValue { get; set; }
		...
		/// </summary>
		public BulletSeriesSonificationTracksType Type { get; set; }
		private BulletSeriesSonificationTracksType Type_DefaultValue { get; set; }
