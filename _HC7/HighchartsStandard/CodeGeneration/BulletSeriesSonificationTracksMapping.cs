...
{
	public partial class BulletSeriesSonificationTracksMapping  : BaseObject
	{
		Hashtable h = new Hashtable();

		public BulletSeriesSonificationTracksMapping()
		{
			Frequency = Frequency_DefaultValue = new BulletSeriesSonificationTracksMappingFrequency();
			GapBetweenNotes = GapBetweenNotes_DefaultValue = new BulletSeriesSonificationTracksMappingGapBetweenNotes();
			Highpass = Highpass_DefaultValue = new BulletSeriesSonificationTracksMappingHighpass();
			Lowpass = Lowpass_DefaultValue = new BulletSeriesSonificationTracksMappingLowpass();
			NoteDuration = NoteDuration_DefaultValue = new BulletSeriesSonificationTracksMappingNoteDuration();
			Pan = Pan_DefaultValue = new BulletSeriesSonificationTracksMappingPan();
			Pitch = Pitch_DefaultValue = new BulletSeriesSonificationTracksMappingPitch();
			PitchString = PitchString_DefaultValue = "null";
			PitchNumber = PitchNumber_DefaultValue = null;
			PlayDelay = PlayDelay_DefaultValue = new BulletSeriesSonificationTracksMappingPlayDelay();
			Time = Time_DefaultValue = new BulletSeriesSonificationTracksMappingTime();
			TimeString = TimeString_DefaultValue = "null";
			TimeNumber = TimeNumber_DefaultValue = null;
			Tremolo = Tremolo_DefaultValue = new BulletSeriesSonificationTracksMappingTremolo();
			Volume = Volume_DefaultValue = new BulletSeriesSonificationTracksMappingVolume();
		...
		/// </summary>
		public BulletSeriesSonificationTracksMappingFrequency Frequency { get; set; }
		private BulletSeriesSonificationTracksMappingFrequency Frequency_DefaultValue { get; set; }
		...
		/// </summary>
		public BulletSeriesSonificationTracksMappingGapBetweenNotes GapBetweenNotes { get; set; }
		private BulletSeriesSonificationTracksMappingGapBetweenNotes GapBetweenNotes_DefaultValue { get; set; }
		...
		/// </summary>
		public BulletSeriesSonificationTracksMappingHighpass Highpass { get; set; }
		private BulletSeriesSonificationTracksMappingHighpass Highpass_DefaultValue { get; set; }
		...
		/// </summary>
		public BulletSeriesSonificationTracksMappingLowpass Lowpass { get; set; }
		private BulletSeriesSonificationTracksMappingLowpass Lowpass_DefaultValue { get; set; }
		...
		/// </summary>
		public BulletSeriesSonificationTracksMappingNoteDuration NoteDuration { get; set; }
		private BulletSeriesSonificationTracksMappingNoteDuration NoteDuration_DefaultValue { get; set; }
		...
		/// </summary>
		public BulletSeriesSonificationTracksMappingPan Pan { get; set; }
		private BulletSeriesSonificationTracksMappingPan Pan_DefaultValue { get; set; }
		...
		/// </summary>
		public BulletSeriesSonificationTracksMappingPitch Pitch { get; set; }
		private BulletSeriesSonificationTracksMappingPitch Pitch_DefaultValue { get; set; }
		...
		/// </summary>
		public BulletSeriesSonificationTracksMappingPlayDelay PlayDelay { get; set; }
		private BulletSeriesSonificationTracksMappingPlayDelay PlayDelay_DefaultValue { get; set; }
		...
		/// </summary>
		public BulletSeriesSonificationTracksMappingTime Time { get; set; }
		private BulletSeriesSonificationTracksMappingTime Time_DefaultValue { get; set; }
		...
		/// </summary>
		public BulletSeriesSonificationTracksMappingTremolo Tremolo { get; set; }
		private BulletSeriesSonificationTracksMappingTremolo Tremolo_DefaultValue { get; set; }
		 

		/// <summary>
		/// The volume of notes, from 0 to 1.
		/// </summary>
		public BulletSeriesSonificationTracksMappingVolume Volume { get; set; }
		private BulletSeriesSonificationTracksMappingVolume Volume_DefaultValue { get; set; }
