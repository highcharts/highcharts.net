...
{
	public partial class BulletSeriesSonificationTracksMappingFrequency  : BaseObject
	{
		Hashtable h = new Hashtable();

		public BulletSeriesSonificationTracksMappingFrequency()
		{
			MapFunction = MapFunction_DefaultValue = BulletSeriesSonificationTracksMappingFrequencyMapFunction.Linear;
			MapTo = MapTo_DefaultValue = "";
			Max = Max_DefaultValue = null;
			Min = Min_DefaultValue = null;
			Value = Value_DefaultValue = null;
			Within = Within_DefaultValue = BulletSeriesSonificationTracksMappingFrequencyWithin.Chart;
		...
		/// </summary>
		public BulletSeriesSonificationTracksMappingFrequencyMapFunction MapFunction { get; set; }
		private BulletSeriesSonificationTracksMappingFrequencyMapFunction MapFunction_DefaultValue { get; set; }
		...
		/// </summary>
		public BulletSeriesSonificationTracksMappingFrequencyWithin Within { get; set; }
		private BulletSeriesSonificationTracksMappingFrequencyWithin Within_DefaultValue { get; set; }
