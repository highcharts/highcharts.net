...
{
	public partial class BulletSeriesSonificationTracksMappingLowpassResonance  : BaseObject
	{
		Hashtable h = new Hashtable();

		public BulletSeriesSonificationTracksMappingLowpassResonance()
		{
			MapFunction = MapFunction_DefaultValue = BulletSeriesSonificationTracksMappingLowpassResonanceMapFunction.Linear;
			MapTo = MapTo_DefaultValue = "";
			Max = Max_DefaultValue = null;
			Min = Min_DefaultValue = null;
			Value = Value_DefaultValue = null;
			Within = Within_DefaultValue = BulletSeriesSonificationTracksMappingLowpassResonanceWithin.Chart;
		...
		/// </summary>
		public BulletSeriesSonificationTracksMappingLowpassResonanceMapFunction MapFunction { get; set; }
		private BulletSeriesSonificationTracksMappingLowpassResonanceMapFunction MapFunction_DefaultValue { get; set; }
		...
		/// </summary>
		public BulletSeriesSonificationTracksMappingLowpassResonanceWithin Within { get; set; }
		private BulletSeriesSonificationTracksMappingLowpassResonanceWithin Within_DefaultValue { get; set; }
