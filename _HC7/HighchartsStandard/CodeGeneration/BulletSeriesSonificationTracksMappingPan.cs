...
{
	public partial class BulletSeriesSonificationTracksMappingPan  : BaseObject
	{
		Hashtable h = new Hashtable();

		public BulletSeriesSonificationTracksMappingPan()
		{
			MapFunction = MapFunction_DefaultValue = BulletSeriesSonificationTracksMappingPanMapFunction.Linear;
			MapTo = MapTo_DefaultValue = "";
			Max = Max_DefaultValue = null;
			Min = Min_DefaultValue = null;
			Value = Value_DefaultValue = null;
			Within = Within_DefaultValue = BulletSeriesSonificationTracksMappingPanWithin.Chart;
		...
		/// </summary>
		public BulletSeriesSonificationTracksMappingPanMapFunction MapFunction { get; set; }
		private BulletSeriesSonificationTracksMappingPanMapFunction MapFunction_DefaultValue { get; set; }
		...
		/// </summary>
		public BulletSeriesSonificationTracksMappingPanWithin Within { get; set; }
		private BulletSeriesSonificationTracksMappingPanWithin Within_DefaultValue { get; set; }
