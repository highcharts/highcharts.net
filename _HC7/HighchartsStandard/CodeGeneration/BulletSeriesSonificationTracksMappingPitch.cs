...
{
	public partial class BulletSeriesSonificationTracksMappingPitch  : BaseObject
	{
		Hashtable h = new Hashtable();

		public BulletSeriesSonificationTracksMappingPitch()
		{
			MapFunction = MapFunction_DefaultValue = BulletSeriesSonificationTracksMappingPitchMapFunction.Linear;
		...
		/// </summary>
		public BulletSeriesSonificationTracksMappingPitchMapFunction MapFunction { get; set; }
		private BulletSeriesSonificationTracksMappingPitchMapFunction MapFunction_DefaultValue { get; set; }
