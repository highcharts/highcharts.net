...
{
	public partial class BulletSeriesSonificationTracksMappingPlayDelay  : BaseObject
	{
		Hashtable h = new Hashtable();

		public BulletSeriesSonificationTracksMappingPlayDelay()
		{
			MapFunction = MapFunction_DefaultValue = BulletSeriesSonificationTracksMappingPlayDelayMapFunction.Linear;
			MapTo = MapTo_DefaultValue = "";
			Max = Max_DefaultValue = null;
			Min = Min_DefaultValue = null;
			Value = Value_DefaultValue = null;
			Within = Within_DefaultValue = BulletSeriesSonificationTracksMappingPlayDelayWithin.Chart;
		...
		/// </summary>
		public BulletSeriesSonificationTracksMappingPlayDelayMapFunction MapFunction { get; set; }
		private BulletSeriesSonificationTracksMappingPlayDelayMapFunction MapFunction_DefaultValue { get; set; }
		...
		/// </summary>
		public BulletSeriesSonificationTracksMappingPlayDelayWithin Within { get; set; }
		private BulletSeriesSonificationTracksMappingPlayDelayWithin Within_DefaultValue { get; set; }
