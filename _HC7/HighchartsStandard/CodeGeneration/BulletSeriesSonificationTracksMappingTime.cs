...
{
	public partial class BulletSeriesSonificationTracksMappingTime  : BaseObject
	{
		Hashtable h = new Hashtable();

		public BulletSeriesSonificationTracksMappingTime()
		{
			MapFunction = MapFunction_DefaultValue = BulletSeriesSonificationTracksMappingTimeMapFunction.Linear;
			MapTo = MapTo_DefaultValue = "";
			Max = Max_DefaultValue = null;
			Min = Min_DefaultValue = null;
			Value = Value_DefaultValue = null;
			Within = Within_DefaultValue = BulletSeriesSonificationTracksMappingTimeWithin.Chart;
		...
		/// </summary>
		public BulletSeriesSonificationTracksMappingTimeMapFunction MapFunction { get; set; }
		private BulletSeriesSonificationTracksMappingTimeMapFunction MapFunction_DefaultValue { get; set; }
		...
		/// </summary>
		public BulletSeriesSonificationTracksMappingTimeWithin Within { get; set; }
		private BulletSeriesSonificationTracksMappingTimeWithin Within_DefaultValue { get; set; }
