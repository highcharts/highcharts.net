...
{
	public partial class BulletSeriesSonificationTracksMappingTremoloSpeed  : BaseObject
	{
		Hashtable h = new Hashtable();

		public BulletSeriesSonificationTracksMappingTremoloSpeed()
		{
			MapFunction = MapFunction_DefaultValue = BulletSeriesSonificationTracksMappingTremoloSpeedMapFunction.Linear;
			MapTo = MapTo_DefaultValue = "";
			Max = Max_DefaultValue = null;
			Min = Min_DefaultValue = null;
			Value = Value_DefaultValue = null;
			Within = Within_DefaultValue = BulletSeriesSonificationTracksMappingTremoloSpeedWithin.Chart;
		...
		/// </summary>
		public BulletSeriesSonificationTracksMappingTremoloSpeedMapFunction MapFunction { get; set; }
		private BulletSeriesSonificationTracksMappingTremoloSpeedMapFunction MapFunction_DefaultValue { get; set; }
		...
		/// </summary>
		public BulletSeriesSonificationTracksMappingTremoloSpeedWithin Within { get; set; }
		private BulletSeriesSonificationTracksMappingTremoloSpeedWithin Within_DefaultValue { get; set; }
