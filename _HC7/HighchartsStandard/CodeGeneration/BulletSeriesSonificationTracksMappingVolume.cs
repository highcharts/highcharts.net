...
{
	public partial class BulletSeriesSonificationTracksMappingVolume  : BaseObject
	{
		Hashtable h = new Hashtable();

		public BulletSeriesSonificationTracksMappingVolume()
		{
			MapFunction = MapFunction_DefaultValue = BulletSeriesSonificationTracksMappingVolumeMapFunction.Linear;
			MapTo = MapTo_DefaultValue = "";
			Max = Max_DefaultValue = null;
			Min = Min_DefaultValue = null;
			Value = Value_DefaultValue = null;
			Within = Within_DefaultValue = BulletSeriesSonificationTracksMappingVolumeWithin.Chart;
		...
		/// </summary>
		public BulletSeriesSonificationTracksMappingVolumeMapFunction MapFunction { get; set; }
		private BulletSeriesSonificationTracksMappingVolumeMapFunction MapFunction_DefaultValue { get; set; }
		...
		/// </summary>
		public BulletSeriesSonificationTracksMappingVolumeWithin Within { get; set; }
		private BulletSeriesSonificationTracksMappingVolumeWithin Within_DefaultValue { get; set; }
