...
{
	public partial class BulletSeriesSonificationTracksPointGrouping  : BaseObject
	{
		Hashtable h = new Hashtable();

		public BulletSeriesSonificationTracksPointGrouping()
		{
		...
		/// </summary>
		public BulletSeriesSonificationTracksPointGroupingAlgorithm Algorithm { get; set; }
		private BulletSeriesSonificationTracksPointGroupingAlgorithm Algorithm_DefaultValue { get; set; }
		...
		internal override Hashtable ToHashtable(Highcharts highcharts)
		{
			...
			if (Algorithm != BulletSeriesSonificationTracksPointGroupingAlgorithm.Null) h.Add("algorithm", highcharts.FirstCharacterToLower(Algorithm.ToString()));
