...
namespace Highsoft.Web.Mvc.Charts
{
	public partial class ChartParallelAxes  : BaseObject
	{
		...
		/// </summary>
		public ChartParallelAxesStackShadow StackShadow { get; set; }
		private ChartParallelAxesStackShadow StackShadow_DefaultValue { get; set; }
		...
		internal override Hashtable ToHashtable(Highcharts highcharts)
		{
			...
			if (MinorTickPosition != ChartParallelAxesMinorTickPosition.Null) h.Add("minorTickPosition", highcharts.FirstCharacterToLower(MinorTickPosition.ToString()));
			...
			if (TickmarkPlacement != ChartParallelAxesTickmarkPlacement.Null) h.Add("tickmarkPlacement", highcharts.FirstCharacterToLower(TickmarkPlacement.ToString()));
			if (TickPixelInterval != null) h.Add("tickPixelInterval",TickPixelInterval);
			if (TickPosition != ChartParallelAxesTickPosition.Null) h.Add("tickPosition", highcharts.FirstCharacterToLower(TickPosition.ToString()));
