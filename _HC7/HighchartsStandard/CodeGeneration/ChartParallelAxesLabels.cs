...
namespace Highsoft.Web.Mvc.Charts
{
	public partial class ChartParallelAxesLabels  : BaseObject
	{
		...
		internal override Hashtable ToHashtable(Highcharts highcharts)
		{
			...
			if (Align != ChartParallelAxesLabelsAlign.Null) h.Add("align", highcharts.FirstCharacterToLower(Align.ToString()));
			...
			if (Overflow != ChartParallelAxesLabelsOverflow.Null) h.Add("overflow", highcharts.FirstCharacterToLower(Overflow.ToString()));
			if (Padding != null) h.Add("padding",Padding);
			if (Position3d != ChartParallelAxesLabelsPosition3d.Null) h.Add("position3d", highcharts.FirstCharacterToLower(Position3d.ToString()));
