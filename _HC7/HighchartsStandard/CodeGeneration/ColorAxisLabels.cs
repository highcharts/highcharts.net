...
namespace Highsoft.Web.Mvc.Charts
{
	public partial class ColorAxisLabels  : BaseObject
	{
		...
		{
			if (Align != ColorAxisLabelsAlign.Null) h.Add("align", highcharts.FirstCharacterToLower(Align.ToString()));
			...
			if (Overflow != ColorAxisLabelsOverflow.Null) h.Add("overflow", highcharts.FirstCharacterToLower(Overflow.ToString()));
			if (Padding != null) h.Add("padding",Padding);
			if (Position3d != ColorAxisLabelsPosition3d.Null) h.Add("position3d", highcharts.FirstCharacterToLower(Position3d.ToString()));
