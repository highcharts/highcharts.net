...
namespace Highsoft.Web.Mvc.Charts
{
	public partial class ColumnSeries  : Series
	{
		...
		internal override Hashtable ToHashtable()
		{
			...
			if (PointDescriptionFormatter != PointDescriptionFormatter_DefaultValue) { h.Add("pointDescriptionFormatter",PointDescriptionFormatter); Highcharts.AddFunction("bd4bf956-182f-40c3-9dfe-c4e8440f58a6.pointDescriptionFormatter", PointDescriptionFormatter); }  
