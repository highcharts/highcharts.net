...
{
	public partial class ColumnSeriesDataDataLabels  : BaseObject
	{
		Hashtable h = new Hashtable();

		public ColumnSeriesDataDataLabels()
		{
		...
		/// </summary>
		public ColumnSeriesDataDataLabelsAlign Align { get; set; }
		private ColumnSeriesDataDataLabelsAlign Align_DefaultValue { get; set; }
		...
		/// </summary>
		public ColumnSeriesDataDataLabelsFilter Filter { get; set; }
		private ColumnSeriesDataDataLabelsFilter Filter_DefaultValue { get; set; }
		...
		/// </summary>
		public ColumnSeriesDataDataLabelsOverflow Overflow { get; set; }
		private ColumnSeriesDataDataLabelsOverflow Overflow_DefaultValue { get; set; }
		...
		/// </summary>
		public ColumnSeriesDataDataLabelsPosition Position { get; set; }
		private ColumnSeriesDataDataLabelsPosition Position_DefaultValue { get; set; }
		...
		/// </summary>
		public ColumnSeriesDataDataLabelsTextPath TextPath { get; set; }
		private ColumnSeriesDataDataLabelsTextPath TextPath_DefaultValue { get; set; }
		...
		/// </summary>
		public ColumnSeriesDataDataLabelsVerticalAlign VerticalAlign { get; set; }
		private ColumnSeriesDataDataLabelsVerticalAlign VerticalAlign_DefaultValue { get; set; }
		...
		internal override Hashtable ToHashtable(Highcharts highcharts)
		{
			...
			if (Align != ColumnSeriesDataDataLabelsAlign.Null) h.Add("align", highcharts.FirstCharacterToLower(Align.ToString()));
			...
			if (Overflow != ColumnSeriesDataDataLabelsOverflow.Null) h.Add("overflow", highcharts.FirstCharacterToLower(Overflow.ToString()));
			if (Padding != null) h.Add("padding",Padding);
			if (Position != ColumnSeriesDataDataLabelsPosition.Null) h.Add("position", highcharts.FirstCharacterToLower(Position.ToString()));
			...
			if (VerticalAlign != ColumnSeriesDataDataLabelsVerticalAlign.Null) h.Add("verticalAlign", highcharts.FirstCharacterToLower(VerticalAlign.ToString()));
			if (X != null) h.Add("x",X);
			if (Y != null) h.Add("y",Y);
