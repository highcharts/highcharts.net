...
{
	public partial class ColumnSeriesDataDragDrop  : BaseObject
	{
		public ColumnSeriesDataDragDrop()
		{
			DraggableX = DraggableX_DefaultValue = null;
			DraggableY = DraggableY_DefaultValue = null;
			DragHandle = DragHandle_DefaultValue = new ColumnSeriesDataDragDropDragHandle();
			...
			GuideBox = GuideBox_DefaultValue = new ColumnSeriesDataDragDropGuideBox();
		...
		/// </summary>
		public ColumnSeriesDataDragDropDragHandle DragHandle { get; set; }
		private ColumnSeriesDataDragDropDragHandle DragHandle_DefaultValue { get; set; }
		...
		/// </summary>
		public ColumnSeriesDataDragDropGuideBox GuideBox { get; set; }
		private ColumnSeriesDataDragDropGuideBox GuideBox_DefaultValue { get; set; }
