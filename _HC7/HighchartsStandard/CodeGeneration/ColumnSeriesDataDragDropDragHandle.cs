...
{
	public partial class ColumnSeriesDataDragDropDragHandle  : BaseObject
	{
		public ColumnSeriesDataDragDropDragHandle()
		{
		...
		internal override Hashtable ToHashtable()
		{
			...
			if (PathFormatter != PathFormatter_DefaultValue) { h.Add("pathFormatter",PathFormatter); Highcharts.AddFunction("ColumnSeriesDataDragDropDragHandlePathFormatter.pathFormatter", PathFormatter); }  
