...
{
	public partial class ColumnSeriesSonification  : BaseObject
	{
		...
		/// </summary>
		public ColumnSeriesSonificationContextTracks ContextTracks { get; set; }
		private ColumnSeriesSonificationContextTracks ContextTracks_DefaultValue { get; set; }
		 

		/// <summary>
		/// Default options for all this series' instrument tracks.
		/// </summary>
		public ColumnSeriesSonificationDefaultInstrumentOptions DefaultInstrumentOptions { get; set; }
		private ColumnSeriesSonificationDefaultInstrumentOptions DefaultInstrumentOptions_DefaultValue { get; set; }
		 

		/// <summary>
		/// Default options for all this series' speech tracks.
		/// </summary>
		public ColumnSeriesSonificationDefaultSpeechOptions DefaultSpeechOptions { get; set; }
		private ColumnSeriesSonificationDefaultSpeechOptions DefaultSpeechOptions_DefaultValue { get; set; }
		...
		/// </summary>
		public ColumnSeriesSonificationPointGrouping PointGrouping { get; set; }
		private ColumnSeriesSonificationPointGrouping PointGrouping_DefaultValue { get; set; }
		 

		/// <summary>
		/// Tracks for this series.Given as an array of instrument tracks, speech tracks, or a mix of both.
		/// </summary>
		public ColumnSeriesSonificationTracks Tracks { get; set; }
		private ColumnSeriesSonificationTracks Tracks_DefaultValue { get; set; }
