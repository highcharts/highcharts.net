...
{
	public partial class ColumnSeriesSonificationContextTracks  : BaseObject
	{
		Hashtable h = new Hashtable();

		public ColumnSeriesSonificationContextTracks()
		{
			ActiveWhen = ActiveWhen_DefaultValue = new ColumnSeriesSonificationContextTracksActiveWhen();
			Instrument = Instrument_DefaultValue = null;
			InstrumentString = InstrumentString_DefaultValue = "null";
			Mapping = Mapping_DefaultValue = new ColumnSeriesSonificationContextTracksMapping();
			MidiName = MidiName_DefaultValue = "";
			PointGrouping = PointGrouping_DefaultValue = new ColumnSeriesSonificationContextTracksPointGrouping();
			...
			Type = Type_DefaultValue = ColumnSeriesSonificationContextTracksType.Instrument;
			ValueInterval = ValueInterval_DefaultValue = null;
			ValueMapFunction = ValueMapFunction_DefaultValue = ColumnSeriesSonificationContextTracksValueMapFunction.Linear;
		...
		/// </summary>
		public ColumnSeriesSonificationContextTracksActiveWhen ActiveWhen { get; set; }
		private ColumnSeriesSonificationContextTracksActiveWhen ActiveWhen_DefaultValue { get; set; }
		...
		/// </summary>
		public ColumnSeriesSonificationContextTracksMapping Mapping { get; set; }
		private ColumnSeriesSonificationContextTracksMapping Mapping_DefaultValue { get; set; }
		...
		/// </summary>
		public ColumnSeriesSonificationContextTracksPointGrouping PointGrouping { get; set; }
		private ColumnSeriesSonificationContextTracksPointGrouping PointGrouping_DefaultValue { get; set; }
		...
		/// </summary>
		public ColumnSeriesSonificationContextTracksType Type { get; set; }
		private ColumnSeriesSonificationContextTracksType Type_DefaultValue { get; set; }
		...
		/// </summary>
		public ColumnSeriesSonificationContextTracksValueMapFunction ValueMapFunction { get; set; }
		private ColumnSeriesSonificationContextTracksValueMapFunction ValueMapFunction_DefaultValue { get; set; }
