...
{
	public partial class ColumnSeriesSonificationContextTracksMapping  : BaseObject
	{
		Hashtable h = new Hashtable();

		public ColumnSeriesSonificationContextTracksMapping()
		{
			Frequency = Frequency_DefaultValue = new ColumnSeriesSonificationContextTracksMappingFrequency();
			GapBetweenNotes = GapBetweenNotes_DefaultValue = new ColumnSeriesSonificationContextTracksMappingGapBetweenNotes();
			Highpass = Highpass_DefaultValue = new ColumnSeriesSonificationContextTracksMappingHighpass();
			Lowpass = Lowpass_DefaultValue = new ColumnSeriesSonificationContextTracksMappingLowpass();
			NoteDuration = NoteDuration_DefaultValue = new ColumnSeriesSonificationContextTracksMappingNoteDuration();
			Pan = Pan_DefaultValue = new ColumnSeriesSonificationContextTracksMappingPan();
			Pitch = Pitch_DefaultValue = new ColumnSeriesSonificationContextTracksMappingPitch();
			PitchString = PitchString_DefaultValue = "null";
			PitchNumber = PitchNumber_DefaultValue = null;
			PlayDelay = PlayDelay_DefaultValue = new ColumnSeriesSonificationContextTracksMappingPlayDelay();
			Time = Time_DefaultValue = new ColumnSeriesSonificationContextTracksMappingTime();
			TimeString = TimeString_DefaultValue = "null";
			TimeNumber = TimeNumber_DefaultValue = null;
			Tremolo = Tremolo_DefaultValue = new ColumnSeriesSonificationContextTracksMappingTremolo();
			Volume = Volume_DefaultValue = new ColumnSeriesSonificationContextTracksMappingVolume();
		...
		/// </summary>
		public ColumnSeriesSonificationContextTracksMappingFrequency Frequency { get; set; }
		private ColumnSeriesSonificationContextTracksMappingFrequency Frequency_DefaultValue { get; set; }
		...
		/// </summary>
		public ColumnSeriesSonificationContextTracksMappingGapBetweenNotes GapBetweenNotes { get; set; }
		private ColumnSeriesSonificationContextTracksMappingGapBetweenNotes GapBetweenNotes_DefaultValue { get; set; }
		...
		/// </summary>
		public ColumnSeriesSonificationContextTracksMappingHighpass Highpass { get; set; }
		private ColumnSeriesSonificationContextTracksMappingHighpass Highpass_DefaultValue { get; set; }
		...
		/// </summary>
		public ColumnSeriesSonificationContextTracksMappingLowpass Lowpass { get; set; }
		private ColumnSeriesSonificationContextTracksMappingLowpass Lowpass_DefaultValue { get; set; }
		...
		/// </summary>
		public ColumnSeriesSonificationContextTracksMappingNoteDuration NoteDuration { get; set; }
		private ColumnSeriesSonificationContextTracksMappingNoteDuration NoteDuration_DefaultValue { get; set; }
		...
		/// </summary>
		public ColumnSeriesSonificationContextTracksMappingPan Pan { get; set; }
		private ColumnSeriesSonificationContextTracksMappingPan Pan_DefaultValue { get; set; }
		...
		/// </summary>
		public ColumnSeriesSonificationContextTracksMappingPitch Pitch { get; set; }
		private ColumnSeriesSonificationContextTracksMappingPitch Pitch_DefaultValue { get; set; }
		...
		/// </summary>
		public ColumnSeriesSonificationContextTracksMappingPlayDelay PlayDelay { get; set; }
		private ColumnSeriesSonificationContextTracksMappingPlayDelay PlayDelay_DefaultValue { get; set; }
		...
		/// </summary>
		public ColumnSeriesSonificationContextTracksMappingTime Time { get; set; }
		private ColumnSeriesSonificationContextTracksMappingTime Time_DefaultValue { get; set; }
		...
		/// </summary>
		public ColumnSeriesSonificationContextTracksMappingTremolo Tremolo { get; set; }
		private ColumnSeriesSonificationContextTracksMappingTremolo Tremolo_DefaultValue { get; set; }
		 

		/// <summary>
		/// The volume of notes, from 0 to 1.
		/// </summary>
		public ColumnSeriesSonificationContextTracksMappingVolume Volume { get; set; }
		private ColumnSeriesSonificationContextTracksMappingVolume Volume_DefaultValue { get; set; }
