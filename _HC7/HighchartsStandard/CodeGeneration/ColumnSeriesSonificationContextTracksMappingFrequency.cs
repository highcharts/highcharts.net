...
{
	public partial class ColumnSeriesSonificationContextTracksMappingFrequency  : BaseObject
	{
		Hashtable h = new Hashtable();

		public ColumnSeriesSonificationContextTracksMappingFrequency()
		{
			MapFunction = MapFunction_DefaultValue = ColumnSeriesSonificationContextTracksMappingFrequencyMapFunction.Linear;
			MapTo = MapTo_DefaultValue = "";
			Max = Max_DefaultValue = null;
			Min = Min_DefaultValue = null;
			Value = Value_DefaultValue = null;
			Within = Within_DefaultValue = ColumnSeriesSonificationContextTracksMappingFrequencyWithin.Chart;
		...
		/// </summary>
		public ColumnSeriesSonificationContextTracksMappingFrequencyMapFunction MapFunction { get; set; }
		private ColumnSeriesSonificationContextTracksMappingFrequencyMapFunction MapFunction_DefaultValue { get; set; }
		...
		/// </summary>
		public ColumnSeriesSonificationContextTracksMappingFrequencyWithin Within { get; set; }
		private ColumnSeriesSonificationContextTracksMappingFrequencyWithin Within_DefaultValue { get; set; }
