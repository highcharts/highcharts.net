...
{
	public partial class ColumnSeriesSonificationContextTracksMappingPan  : BaseObject
	{
		Hashtable h = new Hashtable();

		public ColumnSeriesSonificationContextTracksMappingPan()
		{
			MapFunction = MapFunction_DefaultValue = ColumnSeriesSonificationContextTracksMappingPanMapFunction.Linear;
			MapTo = MapTo_DefaultValue = "";
			Max = Max_DefaultValue = null;
			Min = Min_DefaultValue = null;
			Value = Value_DefaultValue = null;
			Within = Within_DefaultValue = ColumnSeriesSonificationContextTracksMappingPanWithin.Chart;
		...
		/// </summary>
		public ColumnSeriesSonificationContextTracksMappingPanMapFunction MapFunction { get; set; }
		private ColumnSeriesSonificationContextTracksMappingPanMapFunction MapFunction_DefaultValue { get; set; }
		...
		/// </summary>
		public ColumnSeriesSonificationContextTracksMappingPanWithin Within { get; set; }
		private ColumnSeriesSonificationContextTracksMappingPanWithin Within_DefaultValue { get; set; }
