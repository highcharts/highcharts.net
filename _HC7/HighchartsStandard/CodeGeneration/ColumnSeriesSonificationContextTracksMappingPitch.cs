...
{
	public partial class ColumnSeriesSonificationContextTracksMappingPitch  : BaseObject
	{
		Hashtable h = new Hashtable();

		public ColumnSeriesSonificationContextTracksMappingPitch()
		{
			MapFunction = MapFunction_DefaultValue = ColumnSeriesSonificationContextTracksMappingPitchMapFunction.Linear;
		...
		/// </summary>
		public ColumnSeriesSonificationContextTracksMappingPitchMapFunction MapFunction { get; set; }
		private ColumnSeriesSonificationContextTracksMappingPitchMapFunction MapFunction_DefaultValue { get; set; }
