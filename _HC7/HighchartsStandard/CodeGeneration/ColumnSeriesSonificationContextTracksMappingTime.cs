...
{
	public partial class ColumnSeriesSonificationContextTracksMappingTime  : BaseObject
	{
		Hashtable h = new Hashtable();

		public ColumnSeriesSonificationContextTracksMappingTime()
		{
			MapFunction = MapFunction_DefaultValue = ColumnSeriesSonificationContextTracksMappingTimeMapFunction.Linear;
			MapTo = MapTo_DefaultValue = "";
			Max = Max_DefaultValue = null;
			Min = Min_DefaultValue = null;
			Value = Value_DefaultValue = null;
			Within = Within_DefaultValue = ColumnSeriesSonificationContextTracksMappingTimeWithin.Chart;
		...
		/// </summary>
		public ColumnSeriesSonificationContextTracksMappingTimeMapFunction MapFunction { get; set; }
		private ColumnSeriesSonificationContextTracksMappingTimeMapFunction MapFunction_DefaultValue { get; set; }
		...
		/// </summary>
		public ColumnSeriesSonificationContextTracksMappingTimeWithin Within { get; set; }
		private ColumnSeriesSonificationContextTracksMappingTimeWithin Within_DefaultValue { get; set; }
