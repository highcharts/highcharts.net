...
{
	public partial class ColumnSeriesSonificationContextTracksMappingTremoloSpeed  : BaseObject
	{
		Hashtable h = new Hashtable();

		public ColumnSeriesSonificationContextTracksMappingTremoloSpeed()
		{
			MapFunction = MapFunction_DefaultValue = ColumnSeriesSonificationContextTracksMappingTremoloSpeedMapFunction.Linear;
			MapTo = MapTo_DefaultValue = "";
			Max = Max_DefaultValue = null;
			Min = Min_DefaultValue = null;
			Value = Value_DefaultValue = null;
			Within = Within_DefaultValue = ColumnSeriesSonificationContextTracksMappingTremoloSpeedWithin.Chart;
		...
		/// </summary>
		public ColumnSeriesSonificationContextTracksMappingTremoloSpeedMapFunction MapFunction { get; set; }
		private ColumnSeriesSonificationContextTracksMappingTremoloSpeedMapFunction MapFunction_DefaultValue { get; set; }
		...
		/// </summary>
		public ColumnSeriesSonificationContextTracksMappingTremoloSpeedWithin Within { get; set; }
		private ColumnSeriesSonificationContextTracksMappingTremoloSpeedWithin Within_DefaultValue { get; set; }
