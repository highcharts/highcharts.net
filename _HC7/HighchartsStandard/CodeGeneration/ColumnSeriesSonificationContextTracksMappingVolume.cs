...
{
	public partial class ColumnSeriesSonificationContextTracksMappingVolume  : BaseObject
	{
		Hashtable h = new Hashtable();

		public ColumnSeriesSonificationContextTracksMappingVolume()
		{
			MapFunction = MapFunction_DefaultValue = ColumnSeriesSonificationContextTracksMappingVolumeMapFunction.Linear;
			MapTo = MapTo_DefaultValue = "";
			Max = Max_DefaultValue = null;
			Min = Min_DefaultValue = null;
			Value = Value_DefaultValue = null;
			Within = Within_DefaultValue = ColumnSeriesSonificationContextTracksMappingVolumeWithin.Chart;
		...
		/// </summary>
		public ColumnSeriesSonificationContextTracksMappingVolumeMapFunction MapFunction { get; set; }
		private ColumnSeriesSonificationContextTracksMappingVolumeMapFunction MapFunction_DefaultValue { get; set; }
		...
		/// </summary>
		public ColumnSeriesSonificationContextTracksMappingVolumeWithin Within { get; set; }
		private ColumnSeriesSonificationContextTracksMappingVolumeWithin Within_DefaultValue { get; set; }
