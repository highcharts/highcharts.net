...
{
	public partial class ColumnSeriesSonificationDefaultInstrumentOptionsMappingLowpassFrequency  : BaseObject
	{
		Hashtable h = new Hashtable();

		public ColumnSeriesSonificationDefaultInstrumentOptionsMappingLowpassFrequency()
		{
			MapFunction = MapFunction_DefaultValue = ColumnSeriesSonificationDefaultInstrumentOptionsMappingLowpassFrequencyMapFunction.Linear;
			MapTo = MapTo_DefaultValue = "";
			Max = Max_DefaultValue = null;
			Min = Min_DefaultValue = null;
			Value = Value_DefaultValue = null;
			Within = Within_DefaultValue = ColumnSeriesSonificationDefaultInstrumentOptionsMappingLowpassFrequencyWithin.Chart;
		...
		/// </summary>
		public ColumnSeriesSonificationDefaultInstrumentOptionsMappingLowpassFrequencyMapFunction MapFunction { get; set; }
		private ColumnSeriesSonificationDefaultInstrumentOptionsMappingLowpassFrequencyMapFunction MapFunction_DefaultValue { get; set; }
		...
		/// </summary>
		public ColumnSeriesSonificationDefaultInstrumentOptionsMappingLowpassFrequencyWithin Within { get; set; }
		private ColumnSeriesSonificationDefaultInstrumentOptionsMappingLowpassFrequencyWithin Within_DefaultValue { get; set; }
