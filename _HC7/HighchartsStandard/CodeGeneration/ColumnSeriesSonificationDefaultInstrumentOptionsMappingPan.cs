...
{
	public partial class ColumnSeriesSonificationDefaultInstrumentOptionsMappingPan  : BaseObject
	{
		Hashtable h = new Hashtable();

		public ColumnSeriesSonificationDefaultInstrumentOptionsMappingPan()
		{
			MapFunction = MapFunction_DefaultValue = ColumnSeriesSonificationDefaultInstrumentOptionsMappingPanMapFunction.Linear;
			MapTo = MapTo_DefaultValue = "";
			Max = Max_DefaultValue = null;
			Min = Min_DefaultValue = null;
			Value = Value_DefaultValue = null;
			Within = Within_DefaultValue = ColumnSeriesSonificationDefaultInstrumentOptionsMappingPanWithin.Chart;
		...
		/// </summary>
		public ColumnSeriesSonificationDefaultInstrumentOptionsMappingPanMapFunction MapFunction { get; set; }
		private ColumnSeriesSonificationDefaultInstrumentOptionsMappingPanMapFunction MapFunction_DefaultValue { get; set; }
		...
		/// </summary>
		public ColumnSeriesSonificationDefaultInstrumentOptionsMappingPanWithin Within { get; set; }
		private ColumnSeriesSonificationDefaultInstrumentOptionsMappingPanWithin Within_DefaultValue { get; set; }
