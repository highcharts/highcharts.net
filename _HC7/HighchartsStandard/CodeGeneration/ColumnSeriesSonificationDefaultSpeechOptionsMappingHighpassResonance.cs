...
{
	public partial class ColumnSeriesSonificationDefaultSpeechOptionsMappingHighpassResonance  : BaseObject
	{
		Hashtable h = new Hashtable();

		public ColumnSeriesSonificationDefaultSpeechOptionsMappingHighpassResonance()
		{
			MapFunction = MapFunction_DefaultValue = ColumnSeriesSonificationDefaultSpeechOptionsMappingHighpassResonanceMapFunction.Linear;
			MapTo = MapTo_DefaultValue = "";
			Max = Max_DefaultValue = null;
			Min = Min_DefaultValue = null;
			Value = Value_DefaultValue = null;
			Within = Within_DefaultValue = ColumnSeriesSonificationDefaultSpeechOptionsMappingHighpassResonanceWithin.Chart;
		...
		/// </summary>
		public ColumnSeriesSonificationDefaultSpeechOptionsMappingHighpassResonanceMapFunction MapFunction { get; set; }
		private ColumnSeriesSonificationDefaultSpeechOptionsMappingHighpassResonanceMapFunction MapFunction_DefaultValue { get; set; }
		...
		/// </summary>
		public ColumnSeriesSonificationDefaultSpeechOptionsMappingHighpassResonanceWithin Within { get; set; }
		private ColumnSeriesSonificationDefaultSpeechOptionsMappingHighpassResonanceWithin Within_DefaultValue { get; set; }
