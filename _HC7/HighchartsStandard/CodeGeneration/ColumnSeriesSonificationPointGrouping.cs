...
{
	public partial class ColumnSeriesSonificationPointGrouping  : BaseObject
	{
		Hashtable h = new Hashtable();

		public ColumnSeriesSonificationPointGrouping()
		{
		...
		/// </summary>
		public ColumnSeriesSonificationPointGroupingAlgorithm Algorithm { get; set; }
		private ColumnSeriesSonificationPointGroupingAlgorithm Algorithm_DefaultValue { get; set; }
		...
		internal override Hashtable ToHashtable(Highcharts highcharts)
		{
			...
			if (Algorithm != ColumnSeriesSonificationPointGroupingAlgorithm.Null) h.Add("algorithm", highcharts.FirstCharacterToLower(Algorithm.ToString()));
