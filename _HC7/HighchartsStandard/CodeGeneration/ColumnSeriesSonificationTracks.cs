...
{
	public partial class ColumnSeriesSonificationTracks  : BaseObject
	{
		Hashtable h = new Hashtable();

		public ColumnSeriesSonificationTracks()
		{
			ActiveWhen = ActiveWhen_DefaultValue = new ColumnSeriesSonificationTracksActiveWhen();
			Instrument = Instrument_DefaultValue = null;
			InstrumentString = InstrumentString_DefaultValue = "null";
			Mapping = Mapping_DefaultValue = new ColumnSeriesSonificationTracksMapping();
			MidiName = MidiName_DefaultValue = "";
			PointGrouping = PointGrouping_DefaultValue = new ColumnSeriesSonificationTracksPointGrouping();
			RoundToMusicalNotes = RoundToMusicalNotes_DefaultValue = true;
			ShowPlayMarker = ShowPlayMarker_DefaultValue = true;
			Type = Type_DefaultValue = ColumnSeriesSonificationTracksType.Instrument;
		...
		/// </summary>
		public ColumnSeriesSonificationTracksActiveWhen ActiveWhen { get; set; }
		private ColumnSeriesSonificationTracksActiveWhen ActiveWhen_DefaultValue { get; set; }
		...
		/// </summary>
		public ColumnSeriesSonificationTracksMapping Mapping { get; set; }
		private ColumnSeriesSonificationTracksMapping Mapping_DefaultValue { get; set; }
		...
		/// </summary>
		public ColumnSeriesSonificationTracksPointGrouping PointGrouping { get; set; }
		private ColumnSeriesSonificationTracksPointGrouping PointGrouping_DefaultValue { get; set; }
		...
		/// </summary>
		public ColumnSeriesSonificationTracksType Type { get; set; }
		private ColumnSeriesSonificationTracksType Type_DefaultValue { get; set; }
