...
{
	public partial class ColumnSeriesSonificationTracksMappingNoteDuration  : BaseObject
	{
		Hashtable h = new Hashtable();

		public ColumnSeriesSonificationTracksMappingNoteDuration()
		{
			MapFunction = MapFunction_DefaultValue = ColumnSeriesSonificationTracksMappingNoteDurationMapFunction.Linear;
			MapTo = MapTo_DefaultValue = "";
			Max = Max_DefaultValue = null;
			Min = Min_DefaultValue = null;
			Value = Value_DefaultValue = null;
			Within = Within_DefaultValue = ColumnSeriesSonificationTracksMappingNoteDurationWithin.Chart;
		...
		/// </summary>
		public ColumnSeriesSonificationTracksMappingNoteDurationMapFunction MapFunction { get; set; }
		private ColumnSeriesSonificationTracksMappingNoteDurationMapFunction MapFunction_DefaultValue { get; set; }
		...
		/// </summary>
		public ColumnSeriesSonificationTracksMappingNoteDurationWithin Within { get; set; }
		private ColumnSeriesSonificationTracksMappingNoteDurationWithin Within_DefaultValue { get; set; }
