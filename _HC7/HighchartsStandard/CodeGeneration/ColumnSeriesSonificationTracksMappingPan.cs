...
{
	public partial class ColumnSeriesSonificationTracksMappingPan  : BaseObject
	{
		Hashtable h = new Hashtable();

		public ColumnSeriesSonificationTracksMappingPan()
		{
			MapFunction = MapFunction_DefaultValue = ColumnSeriesSonificationTracksMappingPanMapFunction.Linear;
			MapTo = MapTo_DefaultValue = "";
			Max = Max_DefaultValue = null;
			Min = Min_DefaultValue = null;
			Value = Value_DefaultValue = null;
			Within = Within_DefaultValue = ColumnSeriesSonificationTracksMappingPanWithin.Chart;
		...
		/// </summary>
		public ColumnSeriesSonificationTracksMappingPanMapFunction MapFunction { get; set; }
		private ColumnSeriesSonificationTracksMappingPanMapFunction MapFunction_DefaultValue { get; set; }
		...
		/// </summary>
		public ColumnSeriesSonificationTracksMappingPanWithin Within { get; set; }
		private ColumnSeriesSonificationTracksMappingPanWithin Within_DefaultValue { get; set; }
