...
{
	public partial class ColumnSeriesSonificationTracksMappingPitch  : BaseObject
	{
		Hashtable h = new Hashtable();

		public ColumnSeriesSonificationTracksMappingPitch()
		{
			MapFunction = MapFunction_DefaultValue = ColumnSeriesSonificationTracksMappingPitchMapFunction.Linear;
		...
		/// </summary>
		public ColumnSeriesSonificationTracksMappingPitchMapFunction MapFunction { get; set; }
		private ColumnSeriesSonificationTracksMappingPitchMapFunction MapFunction_DefaultValue { get; set; }
