...
{
	public partial class ColumnSeriesSonificationTracksMappingPlayDelay  : BaseObject
	{
		Hashtable h = new Hashtable();

		public ColumnSeriesSonificationTracksMappingPlayDelay()
		{
			MapFunction = MapFunction_DefaultValue = ColumnSeriesSonificationTracksMappingPlayDelayMapFunction.Linear;
			MapTo = MapTo_DefaultValue = "";
			Max = Max_DefaultValue = null;
			Min = Min_DefaultValue = null;
			Value = Value_DefaultValue = null;
			Within = Within_DefaultValue = ColumnSeriesSonificationTracksMappingPlayDelayWithin.Chart;
		...
		/// </summary>
		public ColumnSeriesSonificationTracksMappingPlayDelayMapFunction MapFunction { get; set; }
		private ColumnSeriesSonificationTracksMappingPlayDelayMapFunction MapFunction_DefaultValue { get; set; }
		...
		/// </summary>
		public ColumnSeriesSonificationTracksMappingPlayDelayWithin Within { get; set; }
		private ColumnSeriesSonificationTracksMappingPlayDelayWithin Within_DefaultValue { get; set; }
