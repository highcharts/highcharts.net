...
{
	public partial class ColumnSeriesSonificationTracksMappingTime  : BaseObject
	{
		Hashtable h = new Hashtable();

		public ColumnSeriesSonificationTracksMappingTime()
		{
			MapFunction = MapFunction_DefaultValue = ColumnSeriesSonificationTracksMappingTimeMapFunction.Linear;
			MapTo = MapTo_DefaultValue = "";
			Max = Max_DefaultValue = null;
			Min = Min_DefaultValue = null;
			Value = Value_DefaultValue = null;
			Within = Within_DefaultValue = ColumnSeriesSonificationTracksMappingTimeWithin.Chart;
		...
		/// </summary>
		public ColumnSeriesSonificationTracksMappingTimeMapFunction MapFunction { get; set; }
		private ColumnSeriesSonificationTracksMappingTimeMapFunction MapFunction_DefaultValue { get; set; }
		...
		/// </summary>
		public ColumnSeriesSonificationTracksMappingTimeWithin Within { get; set; }
		private ColumnSeriesSonificationTracksMappingTimeWithin Within_DefaultValue { get; set; }
