...
{
	public partial class ColumnSeriesSonificationTracksMappingTremoloDepth  : BaseObject
	{
		Hashtable h = new Hashtable();

		public ColumnSeriesSonificationTracksMappingTremoloDepth()
		{
			MapFunction = MapFunction_DefaultValue = ColumnSeriesSonificationTracksMappingTremoloDepthMapFunction.Linear;
			MapTo = MapTo_DefaultValue = "";
			Max = Max_DefaultValue = null;
			Min = Min_DefaultValue = null;
			Value = Value_DefaultValue = null;
			Within = Within_DefaultValue = ColumnSeriesSonificationTracksMappingTremoloDepthWithin.Chart;
		...
		/// </summary>
		public ColumnSeriesSonificationTracksMappingTremoloDepthMapFunction MapFunction { get; set; }
		private ColumnSeriesSonificationTracksMappingTremoloDepthMapFunction MapFunction_DefaultValue { get; set; }
		...
		/// </summary>
		public ColumnSeriesSonificationTracksMappingTremoloDepthWithin Within { get; set; }
		private ColumnSeriesSonificationTracksMappingTremoloDepthWithin Within_DefaultValue { get; set; }
