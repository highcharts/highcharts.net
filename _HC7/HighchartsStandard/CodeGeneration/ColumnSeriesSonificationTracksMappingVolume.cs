...
{
	public partial class ColumnSeriesSonificationTracksMappingVolume  : BaseObject
	{
		Hashtable h = new Hashtable();

		public ColumnSeriesSonificationTracksMappingVolume()
		{
			MapFunction = MapFunction_DefaultValue = ColumnSeriesSonificationTracksMappingVolumeMapFunction.Linear;
			MapTo = MapTo_DefaultValue = "";
			Max = Max_DefaultValue = null;
			Min = Min_DefaultValue = null;
			Value = Value_DefaultValue = null;
			Within = Within_DefaultValue = ColumnSeriesSonificationTracksMappingVolumeWithin.Chart;
		...
		/// </summary>
		public ColumnSeriesSonificationTracksMappingVolumeMapFunction MapFunction { get; set; }
		private ColumnSeriesSonificationTracksMappingVolumeMapFunction MapFunction_DefaultValue { get; set; }
		...
		/// </summary>
		public ColumnSeriesSonificationTracksMappingVolumeWithin Within { get; set; }
		private ColumnSeriesSonificationTracksMappingVolumeWithin Within_DefaultValue { get; set; }
