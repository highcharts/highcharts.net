...
{
	public partial class ColumnSeriesSonificationTracksPointGrouping  : BaseObject
	{
		Hashtable h = new Hashtable();

		public ColumnSeriesSonificationTracksPointGrouping()
		{
		...
		/// </summary>
		public ColumnSeriesSonificationTracksPointGroupingAlgorithm Algorithm { get; set; }
		private ColumnSeriesSonificationTracksPointGroupingAlgorithm Algorithm_DefaultValue { get; set; }
		...
		internal override Hashtable ToHashtable(Highcharts highcharts)
		{
			...
			if (Algorithm != ColumnSeriesSonificationTracksPointGroupingAlgorithm.Null) h.Add("algorithm", highcharts.FirstCharacterToLower(Algorithm.ToString()));
