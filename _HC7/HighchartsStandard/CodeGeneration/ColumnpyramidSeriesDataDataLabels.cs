...
{
	public partial class ColumnpyramidSeriesDataDataLabels  : BaseObject
	{
		Hashtable h = new Hashtable();

		public ColumnpyramidSeriesDataDataLabels()
		{
		...
		/// </summary>
		public ColumnpyramidSeriesDataDataLabelsAlign Align { get; set; }
		private ColumnpyramidSeriesDataDataLabelsAlign Align_DefaultValue { get; set; }
		...
		/// </summary>
		public ColumnpyramidSeriesDataDataLabelsFilter Filter { get; set; }
		private ColumnpyramidSeriesDataDataLabelsFilter Filter_DefaultValue { get; set; }
		...
		/// </summary>
		public ColumnpyramidSeriesDataDataLabelsOverflow Overflow { get; set; }
		private ColumnpyramidSeriesDataDataLabelsOverflow Overflow_DefaultValue { get; set; }
		...
		/// </summary>
		public ColumnpyramidSeriesDataDataLabelsPosition Position { get; set; }
		private ColumnpyramidSeriesDataDataLabelsPosition Position_DefaultValue { get; set; }
		...
		/// </summary>
		public ColumnpyramidSeriesDataDataLabelsTextPath TextPath { get; set; }
		private ColumnpyramidSeriesDataDataLabelsTextPath TextPath_DefaultValue { get; set; }
		...
		/// </summary>
		public ColumnpyramidSeriesDataDataLabelsVerticalAlign VerticalAlign { get; set; }
		private ColumnpyramidSeriesDataDataLabelsVerticalAlign VerticalAlign_DefaultValue { get; set; }
		...
		internal override Hashtable ToHashtable(Highcharts highcharts)
		{
			...
			if (Align != ColumnpyramidSeriesDataDataLabelsAlign.Null) h.Add("align", highcharts.FirstCharacterToLower(Align.ToString()));
			...
			if (Overflow != ColumnpyramidSeriesDataDataLabelsOverflow.Null) h.Add("overflow", highcharts.FirstCharacterToLower(Overflow.ToString()));
			if (Padding != null) h.Add("padding",Padding);
			if (Position != ColumnpyramidSeriesDataDataLabelsPosition.Null) h.Add("position", highcharts.FirstCharacterToLower(Position.ToString()));
			...
			if (VerticalAlign != ColumnpyramidSeriesDataDataLabelsVerticalAlign.Null) h.Add("verticalAlign", highcharts.FirstCharacterToLower(VerticalAlign.ToString()));
			if (X != null) h.Add("x",X);
			if (Y != null) h.Add("y",Y);
