...
namespace Highsoft.Web.Mvc.Charts
{
	public partial class ColumnpyramidSeriesDataDragDropDragHandle  : BaseObject
	{
		...
		internal override Hashtable ToHashtable()
		{
			...
			if (PathFormatter != PathFormatter_DefaultValue) { h.Add("pathFormatter",PathFormatter); Highcharts.AddFunction("f0a0b0e3-c9d0-4324-9824-795557243934.pathFormatter", PathFormatter); }  
