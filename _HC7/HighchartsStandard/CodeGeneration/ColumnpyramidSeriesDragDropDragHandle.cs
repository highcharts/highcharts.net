...
{
	public partial class ColumnpyramidSeriesDragDropDragHandle  : BaseObject
	{
		public ColumnpyramidSeriesDragDropDragHandle()
		{
		...
		internal override Hashtable ToHashtable()
		{
			...
			if (PathFormatter != PathFormatter_DefaultValue) { h.Add("pathFormatter",PathFormatter); Highcharts.AddFunction("ColumnpyramidSeriesDragDropDragHandlePathFormatter.pathFormatter", PathFormatter); }  
