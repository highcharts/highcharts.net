...
{
	public partial class ColumnpyramidSeriesSonificationContextTracks  : BaseObject
	{
		Hashtable h = new Hashtable();

		public ColumnpyramidSeriesSonificationContextTracks()
		{
			ActiveWhen = ActiveWhen_DefaultValue = new ColumnpyramidSeriesSonificationContextTracksActiveWhen();
			Instrument = Instrument_DefaultValue = null;
			InstrumentString = InstrumentString_DefaultValue = "null";
			Mapping = Mapping_DefaultValue = new ColumnpyramidSeriesSonificationContextTracksMapping();
			MidiName = MidiName_DefaultValue = "";
			PointGrouping = PointGrouping_DefaultValue = new ColumnpyramidSeriesSonificationContextTracksPointGrouping();
			...
			Type = Type_DefaultValue = ColumnpyramidSeriesSonificationContextTracksType.Instrument;
			ValueInterval = ValueInterval_DefaultValue = null;
			ValueMapFunction = ValueMapFunction_DefaultValue = ColumnpyramidSeriesSonificationContextTracksValueMapFunction.Linear;
		...
		/// </summary>
		public ColumnpyramidSeriesSonificationContextTracksActiveWhen ActiveWhen { get; set; }
		private ColumnpyramidSeriesSonificationContextTracksActiveWhen ActiveWhen_DefaultValue { get; set; }
		...
		/// </summary>
		public ColumnpyramidSeriesSonificationContextTracksMapping Mapping { get; set; }
		private ColumnpyramidSeriesSonificationContextTracksMapping Mapping_DefaultValue { get; set; }
		...
		/// </summary>
		public ColumnpyramidSeriesSonificationContextTracksPointGrouping PointGrouping { get; set; }
		private ColumnpyramidSeriesSonificationContextTracksPointGrouping PointGrouping_DefaultValue { get; set; }
		...
		/// </summary>
		public ColumnpyramidSeriesSonificationContextTracksType Type { get; set; }
		private ColumnpyramidSeriesSonificationContextTracksType Type_DefaultValue { get; set; }
		...
		/// </summary>
		public ColumnpyramidSeriesSonificationContextTracksValueMapFunction ValueMapFunction { get; set; }
		private ColumnpyramidSeriesSonificationContextTracksValueMapFunction ValueMapFunction_DefaultValue { get; set; }
