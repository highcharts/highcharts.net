...
{
	public partial class ColumnpyramidSeriesSonificationDefaultSpeechOptionsActiveWhen  : BaseObject
	{
		Hashtable h = new Hashtable();

		public ColumnpyramidSeriesSonificationDefaultSpeechOptionsActiveWhen()
		{
