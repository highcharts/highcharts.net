...
{
	public partial class ColumnpyramidSeriesSonificationDefaultSpeechOptionsMappingFrequency  : BaseObject
	{
		Hashtable h = new Hashtable();

		public ColumnpyramidSeriesSonificationDefaultSpeechOptionsMappingFrequency()
		{
			MapFunction = MapFunction_DefaultValue = ColumnpyramidSeriesSonificationDefaultSpeechOptionsMappingFrequencyMapFunction.Linear;
			MapTo = MapTo_DefaultValue = "";
			Max = Max_DefaultValue = null;
			Min = Min_DefaultValue = null;
			Value = Value_DefaultValue = null;
			Within = Within_DefaultValue = ColumnpyramidSeriesSonificationDefaultSpeechOptionsMappingFrequencyWithin.Chart;
		...
		/// </summary>
		public ColumnpyramidSeriesSonificationDefaultSpeechOptionsMappingFrequencyMapFunction MapFunction { get; set; }
		private ColumnpyramidSeriesSonificationDefaultSpeechOptionsMappingFrequencyMapFunction MapFunction_DefaultValue { get; set; }
		...
		/// </summary>
		public ColumnpyramidSeriesSonificationDefaultSpeechOptionsMappingFrequencyWithin Within { get; set; }
		private ColumnpyramidSeriesSonificationDefaultSpeechOptionsMappingFrequencyWithin Within_DefaultValue { get; set; }
