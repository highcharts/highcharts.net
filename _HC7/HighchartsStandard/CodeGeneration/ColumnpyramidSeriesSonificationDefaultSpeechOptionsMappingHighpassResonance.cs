...
{
	public partial class ColumnpyramidSeriesSonificationDefaultSpeechOptionsMappingHighpassResonance  : BaseObject
	{
		Hashtable h = new Hashtable();

		public ColumnpyramidSeriesSonificationDefaultSpeechOptionsMappingHighpassResonance()
		{
			MapFunction = MapFunction_DefaultValue = ColumnpyramidSeriesSonificationDefaultSpeechOptionsMappingHighpassResonanceMapFunction.Linear;
			MapTo = MapTo_DefaultValue = "";
			Max = Max_DefaultValue = null;
			Min = Min_DefaultValue = null;
			Value = Value_DefaultValue = null;
			Within = Within_DefaultValue = ColumnpyramidSeriesSonificationDefaultSpeechOptionsMappingHighpassResonanceWithin.Chart;
		...
		/// </summary>
		public ColumnpyramidSeriesSonificationDefaultSpeechOptionsMappingHighpassResonanceMapFunction MapFunction { get; set; }
		private ColumnpyramidSeriesSonificationDefaultSpeechOptionsMappingHighpassResonanceMapFunction MapFunction_DefaultValue { get; set; }
		...
		/// </summary>
		public ColumnpyramidSeriesSonificationDefaultSpeechOptionsMappingHighpassResonanceWithin Within { get; set; }
		private ColumnpyramidSeriesSonificationDefaultSpeechOptionsMappingHighpassResonanceWithin Within_DefaultValue { get; set; }
