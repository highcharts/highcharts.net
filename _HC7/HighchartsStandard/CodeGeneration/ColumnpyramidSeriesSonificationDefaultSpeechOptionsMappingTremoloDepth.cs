...
{
	public partial class ColumnpyramidSeriesSonificationDefaultSpeechOptionsMappingTremoloDepth  : BaseObject
	{
		Hashtable h = new Hashtable();

		public ColumnpyramidSeriesSonificationDefaultSpeechOptionsMappingTremoloDepth()
		{
			MapFunction = MapFunction_DefaultValue = ColumnpyramidSeriesSonificationDefaultSpeechOptionsMappingTremoloDepthMapFunction.Linear;
			MapTo = MapTo_DefaultValue = "";
			Max = Max_DefaultValue = null;
			Min = Min_DefaultValue = null;
			Value = Value_DefaultValue = null;
			Within = Within_DefaultValue = ColumnpyramidSeriesSonificationDefaultSpeechOptionsMappingTremoloDepthWithin.Chart;
		...
		/// </summary>
		public ColumnpyramidSeriesSonificationDefaultSpeechOptionsMappingTremoloDepthMapFunction MapFunction { get; set; }
		private ColumnpyramidSeriesSonificationDefaultSpeechOptionsMappingTremoloDepthMapFunction MapFunction_DefaultValue { get; set; }
		...
		/// </summary>
		public ColumnpyramidSeriesSonificationDefaultSpeechOptionsMappingTremoloDepthWithin Within { get; set; }
		private ColumnpyramidSeriesSonificationDefaultSpeechOptionsMappingTremoloDepthWithin Within_DefaultValue { get; set; }
