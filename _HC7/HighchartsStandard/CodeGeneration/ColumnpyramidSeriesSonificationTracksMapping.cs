...
{
	public partial class ColumnpyramidSeriesSonificationTracksMapping  : BaseObject
	{
		Hashtable h = new Hashtable();

		public ColumnpyramidSeriesSonificationTracksMapping()
		{
			Frequency = Frequency_DefaultValue = new ColumnpyramidSeriesSonificationTracksMappingFrequency();
			GapBetweenNotes = GapBetweenNotes_DefaultValue = new ColumnpyramidSeriesSonificationTracksMappingGapBetweenNotes();
			Highpass = Highpass_DefaultValue = new ColumnpyramidSeriesSonificationTracksMappingHighpass();
			Lowpass = Lowpass_DefaultValue = new ColumnpyramidSeriesSonificationTracksMappingLowpass();
			NoteDuration = NoteDuration_DefaultValue = new ColumnpyramidSeriesSonificationTracksMappingNoteDuration();
			Pan = Pan_DefaultValue = new ColumnpyramidSeriesSonificationTracksMappingPan();
			Pitch = Pitch_DefaultValue = new ColumnpyramidSeriesSonificationTracksMappingPitch();
			PitchString = PitchString_DefaultValue = "null";
			PitchNumber = PitchNumber_DefaultValue = null;
			PlayDelay = PlayDelay_DefaultValue = new ColumnpyramidSeriesSonificationTracksMappingPlayDelay();
			Time = Time_DefaultValue = new ColumnpyramidSeriesSonificationTracksMappingTime();
			TimeString = TimeString_DefaultValue = "null";
			TimeNumber = TimeNumber_DefaultValue = null;
			Tremolo = Tremolo_DefaultValue = new ColumnpyramidSeriesSonificationTracksMappingTremolo();
			Volume = Volume_DefaultValue = new ColumnpyramidSeriesSonificationTracksMappingVolume();
		...
		/// </summary>
		public ColumnpyramidSeriesSonificationTracksMappingFrequency Frequency { get; set; }
		private ColumnpyramidSeriesSonificationTracksMappingFrequency Frequency_DefaultValue { get; set; }
		...
		/// </summary>
		public ColumnpyramidSeriesSonificationTracksMappingGapBetweenNotes GapBetweenNotes { get; set; }
		private ColumnpyramidSeriesSonificationTracksMappingGapBetweenNotes GapBetweenNotes_DefaultValue { get; set; }
		...
		/// </summary>
		public ColumnpyramidSeriesSonificationTracksMappingHighpass Highpass { get; set; }
		private ColumnpyramidSeriesSonificationTracksMappingHighpass Highpass_DefaultValue { get; set; }
		...
		/// </summary>
		public ColumnpyramidSeriesSonificationTracksMappingLowpass Lowpass { get; set; }
		private ColumnpyramidSeriesSonificationTracksMappingLowpass Lowpass_DefaultValue { get; set; }
		...
		/// </summary>
		public ColumnpyramidSeriesSonificationTracksMappingNoteDuration NoteDuration { get; set; }
		private ColumnpyramidSeriesSonificationTracksMappingNoteDuration NoteDuration_DefaultValue { get; set; }
		...
		/// </summary>
		public ColumnpyramidSeriesSonificationTracksMappingPan Pan { get; set; }
		private ColumnpyramidSeriesSonificationTracksMappingPan Pan_DefaultValue { get; set; }
		...
		/// </summary>
		public ColumnpyramidSeriesSonificationTracksMappingPitch Pitch { get; set; }
		private ColumnpyramidSeriesSonificationTracksMappingPitch Pitch_DefaultValue { get; set; }
		...
		/// </summary>
		public ColumnpyramidSeriesSonificationTracksMappingPlayDelay PlayDelay { get; set; }
		private ColumnpyramidSeriesSonificationTracksMappingPlayDelay PlayDelay_DefaultValue { get; set; }
		...
		/// </summary>
		public ColumnpyramidSeriesSonificationTracksMappingTime Time { get; set; }
		private ColumnpyramidSeriesSonificationTracksMappingTime Time_DefaultValue { get; set; }
		...
		/// </summary>
		public ColumnpyramidSeriesSonificationTracksMappingTremolo Tremolo { get; set; }
		private ColumnpyramidSeriesSonificationTracksMappingTremolo Tremolo_DefaultValue { get; set; }
		 

		/// <summary>
		/// The volume of notes, from 0 to 1.
		/// </summary>
		public ColumnpyramidSeriesSonificationTracksMappingVolume Volume { get; set; }
		private ColumnpyramidSeriesSonificationTracksMappingVolume Volume_DefaultValue { get; set; }
