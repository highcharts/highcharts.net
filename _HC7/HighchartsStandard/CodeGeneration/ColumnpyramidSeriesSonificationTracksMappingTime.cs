...
{
	public partial class ColumnpyramidSeriesSonificationTracksMappingTime  : BaseObject
	{
		Hashtable h = new Hashtable();

		public ColumnpyramidSeriesSonificationTracksMappingTime()
		{
			MapFunction = MapFunction_DefaultValue = ColumnpyramidSeriesSonificationTracksMappingTimeMapFunction.Linear;
			MapTo = MapTo_DefaultValue = "";
			Max = Max_DefaultValue = null;
			Min = Min_DefaultValue = null;
			Value = Value_DefaultValue = null;
			Within = Within_DefaultValue = ColumnpyramidSeriesSonificationTracksMappingTimeWithin.Chart;
		...
		/// </summary>
		public ColumnpyramidSeriesSonificationTracksMappingTimeMapFunction MapFunction { get; set; }
		private ColumnpyramidSeriesSonificationTracksMappingTimeMapFunction MapFunction_DefaultValue { get; set; }
		...
		/// </summary>
		public ColumnpyramidSeriesSonificationTracksMappingTimeWithin Within { get; set; }
		private ColumnpyramidSeriesSonificationTracksMappingTimeWithin Within_DefaultValue { get; set; }
