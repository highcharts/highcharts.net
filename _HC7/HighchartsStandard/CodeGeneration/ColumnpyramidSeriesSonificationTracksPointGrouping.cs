...
{
	public partial class ColumnpyramidSeriesSonificationTracksPointGrouping  : BaseObject
	{
		Hashtable h = new Hashtable();

		public ColumnpyramidSeriesSonificationTracksPointGrouping()
		{
		...
		/// </summary>
		public ColumnpyramidSeriesSonificationTracksPointGroupingAlgorithm Algorithm { get; set; }
		private ColumnpyramidSeriesSonificationTracksPointGroupingAlgorithm Algorithm_DefaultValue { get; set; }
		...
		internal override Hashtable ToHashtable(Highcharts highcharts)
		{
			...
			if (Algorithm != ColumnpyramidSeriesSonificationTracksPointGroupingAlgorithm.Null) h.Add("algorithm", highcharts.FirstCharacterToLower(Algorithm.ToString()));
