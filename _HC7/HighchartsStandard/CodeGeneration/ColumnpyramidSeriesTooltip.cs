...
{
	public partial class ColumnpyramidSeriesTooltip  : BaseObject
	{
		public ColumnpyramidSeriesTooltip()
		{
			...
			HeaderShape = HeaderShape_DefaultValue = ColumnpyramidSeriesTooltipHeaderShape.Callout;
		...
		/// </summary>
		public ColumnpyramidSeriesTooltipHeaderShape HeaderShape { get; set; }
		private ColumnpyramidSeriesTooltipHeaderShape HeaderShape_DefaultValue { get; set; }
		...
		internal override Hashtable ToHashtable()
		{
			...
			if (NullFormatter != NullFormatter_DefaultValue) { h.Add("nullFormatter",NullFormatter); Highcharts.AddFunction("ColumnpyramidSeriesTooltipNullFormatter.nullFormatter", NullFormatter); }  
			if (Outside != Outside_DefaultValue) h.Add("outside",Outside);
			if (Padding != Padding_DefaultValue) h.Add("padding",Padding);
			if (PointFormat != PointFormat_DefaultValue) h.Add("pointFormat",PointFormat);
			if (PointFormatter != PointFormatter_DefaultValue) { h.Add("pointFormatter",PointFormatter); Highcharts.AddFunction("ColumnpyramidSeriesTooltipPointFormatter.pointFormatter", PointFormatter); }  
