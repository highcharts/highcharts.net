...
{
	public partial class ColumnrangeSeriesDataDataLabels  : BaseObject
	{
		Hashtable h = new Hashtable();

		public ColumnrangeSeriesDataDataLabels()
		{
		...
		/// </summary>
		public ColumnrangeSeriesDataDataLabelsAlign Align { get; set; }
		private ColumnrangeSeriesDataDataLabelsAlign Align_DefaultValue { get; set; }
		...
		/// </summary>
		public ColumnrangeSeriesDataDataLabelsFilter Filter { get; set; }
		private ColumnrangeSeriesDataDataLabelsFilter Filter_DefaultValue { get; set; }
		...
		/// </summary>
		public ColumnrangeSeriesDataDataLabelsOverflow Overflow { get; set; }
		private ColumnrangeSeriesDataDataLabelsOverflow Overflow_DefaultValue { get; set; }
		...
		/// </summary>
		public ColumnrangeSeriesDataDataLabelsPosition Position { get; set; }
		private ColumnrangeSeriesDataDataLabelsPosition Position_DefaultValue { get; set; }
		...
		/// </summary>
		public ColumnrangeSeriesDataDataLabelsTextPath TextPath { get; set; }
		private ColumnrangeSeriesDataDataLabelsTextPath TextPath_DefaultValue { get; set; }
		...
		/// </summary>
		public ColumnrangeSeriesDataDataLabelsVerticalAlign VerticalAlign { get; set; }
		private ColumnrangeSeriesDataDataLabelsVerticalAlign VerticalAlign_DefaultValue { get; set; }
		...
		internal override Hashtable ToHashtable(Highcharts highcharts)
		{
			...
			if (Align != ColumnrangeSeriesDataDataLabelsAlign.Null) h.Add("align", highcharts.FirstCharacterToLower(Align.ToString()));
			...
			if (Overflow != ColumnrangeSeriesDataDataLabelsOverflow.Null) h.Add("overflow", highcharts.FirstCharacterToLower(Overflow.ToString()));
			if (Padding != null) h.Add("padding",Padding);
			if (Position != ColumnrangeSeriesDataDataLabelsPosition.Null) h.Add("position", highcharts.FirstCharacterToLower(Position.ToString()));
			...
			if (VerticalAlign != ColumnrangeSeriesDataDataLabelsVerticalAlign.Null) h.Add("verticalAlign", highcharts.FirstCharacterToLower(VerticalAlign.ToString()));
			if (X != null) h.Add("x",X);
			if (Y != null) h.Add("y",Y);
