...
namespace Highsoft.Web.Mvc.Charts
{
	public partial class ColumnrangeSeriesDataLabels  : BaseObject
	{
		...
		{
			Align = Align_DefaultValue = ColumnrangeSeriesDataLabelsAlign.Left;
			...
			VerticalAlign = VerticalAlign_DefaultValue = ColumnrangeSeriesDataLabelsVerticalAlign.Top;
		...
		internal override Hashtable ToHashtable()
		{
			...
			if (Formatter != Formatter_DefaultValue) { h.Add("formatter",Formatter); Highcharts.AddFunction("11e28882-7b47-4db0-ac7e-39bb13cd05ff.formatter", Formatter); }  
