...
{
	public partial class ColumnrangeSeriesSonificationContextTracksMappingVolume  : BaseObject
	{
		Hashtable h = new Hashtable();

		public ColumnrangeSeriesSonificationContextTracksMappingVolume()
		{
			MapFunction = MapFunction_DefaultValue = ColumnrangeSeriesSonificationContextTracksMappingVolumeMapFunction.Linear;
			MapTo = MapTo_DefaultValue = "";
			Max = Max_DefaultValue = null;
			Min = Min_DefaultValue = null;
			Value = Value_DefaultValue = null;
			Within = Within_DefaultValue = ColumnrangeSeriesSonificationContextTracksMappingVolumeWithin.Chart;
		...
		/// </summary>
		public ColumnrangeSeriesSonificationContextTracksMappingVolumeMapFunction MapFunction { get; set; }
		private ColumnrangeSeriesSonificationContextTracksMappingVolumeMapFunction MapFunction_DefaultValue { get; set; }
		...
		/// </summary>
		public ColumnrangeSeriesSonificationContextTracksMappingVolumeWithin Within { get; set; }
		private ColumnrangeSeriesSonificationContextTracksMappingVolumeWithin Within_DefaultValue { get; set; }
