...
{
	public partial class ColumnrangeSeriesSonificationDefaultSpeechOptions  : BaseObject
	{
		...
		internal override Hashtable ToHashtable(Highcharts highcharts)
		{
			...
			if (Type != ColumnrangeSeriesSonificationDefaultSpeechOptionsType.Null) h.Add("type", highcharts.FirstCharacterToLower(Type.ToString()));
