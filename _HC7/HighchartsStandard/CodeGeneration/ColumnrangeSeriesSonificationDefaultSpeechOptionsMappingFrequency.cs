...
{
	public partial class ColumnrangeSeriesSonificationDefaultSpeechOptionsMappingFrequency  : BaseObject
	{
		Hashtable h = new Hashtable();

		public ColumnrangeSeriesSonificationDefaultSpeechOptionsMappingFrequency()
		{
			MapFunction = MapFunction_DefaultValue = ColumnrangeSeriesSonificationDefaultSpeechOptionsMappingFrequencyMapFunction.Linear;
			MapTo = MapTo_DefaultValue = "";
			Max = Max_DefaultValue = null;
			Min = Min_DefaultValue = null;
			Value = Value_DefaultValue = null;
			Within = Within_DefaultValue = ColumnrangeSeriesSonificationDefaultSpeechOptionsMappingFrequencyWithin.Chart;
		...
		/// </summary>
		public ColumnrangeSeriesSonificationDefaultSpeechOptionsMappingFrequencyMapFunction MapFunction { get; set; }
		private ColumnrangeSeriesSonificationDefaultSpeechOptionsMappingFrequencyMapFunction MapFunction_DefaultValue { get; set; }
		...
		/// </summary>
		public ColumnrangeSeriesSonificationDefaultSpeechOptionsMappingFrequencyWithin Within { get; set; }
		private ColumnrangeSeriesSonificationDefaultSpeechOptionsMappingFrequencyWithin Within_DefaultValue { get; set; }
