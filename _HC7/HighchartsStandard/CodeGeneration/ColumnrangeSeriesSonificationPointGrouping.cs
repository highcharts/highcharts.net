...
{
	public partial class ColumnrangeSeriesSonificationPointGrouping  : BaseObject
	{
		Hashtable h = new Hashtable();

		public ColumnrangeSeriesSonificationPointGrouping()
		{
		...
		/// </summary>
		public ColumnrangeSeriesSonificationPointGroupingAlgorithm Algorithm { get; set; }
		private ColumnrangeSeriesSonificationPointGroupingAlgorithm Algorithm_DefaultValue { get; set; }
		...
		internal override Hashtable ToHashtable(Highcharts highcharts)
		{
			...
			if (Algorithm != ColumnrangeSeriesSonificationPointGroupingAlgorithm.Null) h.Add("algorithm", highcharts.FirstCharacterToLower(Algorithm.ToString()));
