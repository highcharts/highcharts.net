...
{
	public partial class ColumnrangeSeriesSonificationTracksMappingVolume  : BaseObject
	{
		Hashtable h = new Hashtable();

		public ColumnrangeSeriesSonificationTracksMappingVolume()
		{
			MapFunction = MapFunction_DefaultValue = ColumnrangeSeriesSonificationTracksMappingVolumeMapFunction.Linear;
			MapTo = MapTo_DefaultValue = "";
			Max = Max_DefaultValue = null;
			Min = Min_DefaultValue = null;
			Value = Value_DefaultValue = null;
			Within = Within_DefaultValue = ColumnrangeSeriesSonificationTracksMappingVolumeWithin.Chart;
		...
		/// </summary>
		public ColumnrangeSeriesSonificationTracksMappingVolumeMapFunction MapFunction { get; set; }
		private ColumnrangeSeriesSonificationTracksMappingVolumeMapFunction MapFunction_DefaultValue { get; set; }
		...
		/// </summary>
		public ColumnrangeSeriesSonificationTracksMappingVolumeWithin Within { get; set; }
		private ColumnrangeSeriesSonificationTracksMappingVolumeWithin Within_DefaultValue { get; set; }
