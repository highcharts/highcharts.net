...
namespace Highsoft.Web.Mvc.Charts
{
	public partial class ColumnrangeSeriesTooltip  : BaseObject
	{
		...
		internal override Hashtable ToHashtable()
		{
			...
			if (NullFormatter != NullFormatter_DefaultValue) { h.Add("nullFormatter",NullFormatter); Highcharts.AddFunction("ColumnrangeSeriesTooltipNullFormatter.nullFormatter", NullFormatter); }  
