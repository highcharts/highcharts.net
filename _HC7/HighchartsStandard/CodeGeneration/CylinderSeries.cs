...
namespace Highsoft.Web.Mvc.Charts
{
	public partial class CylinderSeries  : Series
	{
		public CylinderSeries()
		{
			...
			Type = Type_DefaultValue = CylinderSeriesType.Null;
		...
		/// </summary>
		public CylinderSeriesType Type { get; set; }
		private CylinderSeriesType Type_DefaultValue { get; set; }
		...
		internal override Hashtable ToHashtable()
		{
			...
			if (PointDescriptionFormatter != PointDescriptionFormatter_DefaultValue) { h.Add("pointDescriptionFormatter",PointDescriptionFormatter); Highcharts.AddFunction("CylinderSeriesPointDescriptionFormatter.pointDescriptionFormatter", PointDescriptionFormatter); }  
