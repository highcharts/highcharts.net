...
namespace Highsoft.Web.Mvc.Charts
{
	public partial class CylinderSeries  : Series
	{
		...
		internal override Hashtable ToHashtable()
		{
			...
			if (PointDescriptionFormatter != PointDescriptionFormatter_DefaultValue) { h.Add("pointDescriptionFormatter",PointDescriptionFormatter); Highcharts.AddFunction("dfcb2984-0963-418c-ac2e-c777ddbc07e3.pointDescriptionFormatter", PointDescriptionFormatter); }  
