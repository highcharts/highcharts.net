...
namespace Highsoft.Web.Mvc.Charts
{
	public partial class CylinderSeries  : Series
	{
		...
		public CylinderSeries()
		{
			...
			LegendSymbol = LegendSymbol_DefaultValue = CylinderSeriesLegendSymbol.Rectangle;
			LinkedTo = LinkedTo_DefaultValue = "";
			MaxPointWidth = MaxPointWidth_DefaultValue = null;
			MinPointLength = MinPointLength_DefaultValue = 0;
			Name = Name_DefaultValue = "";
			NegativeColor = NegativeColor_DefaultValue = "";
			OnPoint = OnPoint_DefaultValue = new CylinderSeriesOnPoint();
			...
			Sonification = Sonification_DefaultValue = new CylinderSeriesSonification();
