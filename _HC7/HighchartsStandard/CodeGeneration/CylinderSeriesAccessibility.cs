...
namespace Highsoft.Web.Mvc.Charts
{
	public partial class CylinderSeriesAccessibility  : BaseObject
	{
		...
		public CylinderSeriesAccessibility()
		{
			...
			Point = Point_DefaultValue = new CylinderSeriesAccessibilityPoint();
		...
		/// </summary>
		public CylinderSeriesAccessibilityPoint Point { get; set; }
		private CylinderSeriesAccessibilityPoint Point_DefaultValue { get; set; }
