...
{
	public partial class CylinderSeriesDataDataLabels  : BaseObject
	{
		Hashtable h = new Hashtable();

		public CylinderSeriesDataDataLabels()
		{
		...
		/// </summary>
		public CylinderSeriesDataDataLabelsAlign Align { get; set; }
		private CylinderSeriesDataDataLabelsAlign Align_DefaultValue { get; set; }
		...
		/// </summary>
		public CylinderSeriesDataDataLabelsFilter Filter { get; set; }
		private CylinderSeriesDataDataLabelsFilter Filter_DefaultValue { get; set; }
		...
		/// </summary>
		public CylinderSeriesDataDataLabelsOverflow Overflow { get; set; }
		private CylinderSeriesDataDataLabelsOverflow Overflow_DefaultValue { get; set; }
		...
		/// </summary>
		public CylinderSeriesDataDataLabelsPosition Position { get; set; }
		private CylinderSeriesDataDataLabelsPosition Position_DefaultValue { get; set; }
		...
		/// </summary>
		public CylinderSeriesDataDataLabelsTextPath TextPath { get; set; }
		private CylinderSeriesDataDataLabelsTextPath TextPath_DefaultValue { get; set; }
		...
		/// </summary>
		public CylinderSeriesDataDataLabelsVerticalAlign VerticalAlign { get; set; }
		private CylinderSeriesDataDataLabelsVerticalAlign VerticalAlign_DefaultValue { get; set; }
		...
		internal override Hashtable ToHashtable(Highcharts highcharts)
		{
			...
			if (Align != CylinderSeriesDataDataLabelsAlign.Null) h.Add("align", highcharts.FirstCharacterToLower(Align.ToString()));
			...
			if (Overflow != CylinderSeriesDataDataLabelsOverflow.Null) h.Add("overflow", highcharts.FirstCharacterToLower(Overflow.ToString()));
			if (Padding != null) h.Add("padding",Padding);
			if (Position != CylinderSeriesDataDataLabelsPosition.Null) h.Add("position", highcharts.FirstCharacterToLower(Position.ToString()));
			...
			if (VerticalAlign != CylinderSeriesDataDataLabelsVerticalAlign.Null) h.Add("verticalAlign", highcharts.FirstCharacterToLower(VerticalAlign.ToString()));
			if (X != null) h.Add("x",X);
			if (Y != null) h.Add("y",Y);
