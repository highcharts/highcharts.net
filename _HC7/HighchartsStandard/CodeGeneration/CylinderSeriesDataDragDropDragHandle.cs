...
namespace Highsoft.Web.Mvc.Charts
{
	public partial class CylinderSeriesDataDragDropDragHandle  : BaseObject
	{
		...
		internal override Hashtable ToHashtable()
		{
			...
			if (PathFormatter != PathFormatter_DefaultValue) { h.Add("pathFormatter",PathFormatter); Highcharts.AddFunction("fcccfcba-3c5c-468e-a480-ab71f87806f2.pathFormatter", PathFormatter); }  
