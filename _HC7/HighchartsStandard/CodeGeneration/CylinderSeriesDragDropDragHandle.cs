...
namespace Highsoft.Web.Mvc.Charts
{
	public partial class CylinderSeriesDragDropDragHandle  : BaseObject
	{
		...
		internal override Hashtable ToHashtable()
		{
			...
			if (PathFormatter != PathFormatter_DefaultValue) { h.Add("pathFormatter",PathFormatter); Highcharts.AddFunction("cc7b5e93-79e8-491f-a549-426995e920fa.pathFormatter", PathFormatter); }  
