...
namespace Highsoft.Web.Mvc.Charts
{
	public partial class CylinderSeriesDragDropDragHandle  : BaseObject
	{
		...
		internal override Hashtable ToHashtable()
		{
			...
			if (PathFormatter != PathFormatter_DefaultValue) { h.Add("pathFormatter",PathFormatter); Highcharts.AddFunction("5c2d87bb-6760-4caf-9cdb-820392bf2dca.pathFormatter", PathFormatter); }  
