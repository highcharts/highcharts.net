...
{
	public partial class CylinderSeriesSonificationContextTracks  : BaseObject
	{
		Hashtable h = new Hashtable();

		public CylinderSeriesSonificationContextTracks()
		{
			ActiveWhen = ActiveWhen_DefaultValue = new CylinderSeriesSonificationContextTracksActiveWhen();
			Instrument = Instrument_DefaultValue = null;
			InstrumentString = InstrumentString_DefaultValue = "null";
			Mapping = Mapping_DefaultValue = new CylinderSeriesSonificationContextTracksMapping();
			MidiName = MidiName_DefaultValue = "";
			PointGrouping = PointGrouping_DefaultValue = new CylinderSeriesSonificationContextTracksPointGrouping();
			...
			Type = Type_DefaultValue = CylinderSeriesSonificationContextTracksType.Instrument;
			ValueInterval = ValueInterval_DefaultValue = null;
			ValueMapFunction = ValueMapFunction_DefaultValue = CylinderSeriesSonificationContextTracksValueMapFunction.Linear;
		...
		/// </summary>
		public CylinderSeriesSonificationContextTracksActiveWhen ActiveWhen { get; set; }
		private CylinderSeriesSonificationContextTracksActiveWhen ActiveWhen_DefaultValue { get; set; }
		...
		/// </summary>
		public CylinderSeriesSonificationContextTracksMapping Mapping { get; set; }
		private CylinderSeriesSonificationContextTracksMapping Mapping_DefaultValue { get; set; }
		...
		/// </summary>
		public CylinderSeriesSonificationContextTracksPointGrouping PointGrouping { get; set; }
		private CylinderSeriesSonificationContextTracksPointGrouping PointGrouping_DefaultValue { get; set; }
		...
		/// </summary>
		public CylinderSeriesSonificationContextTracksType Type { get; set; }
		private CylinderSeriesSonificationContextTracksType Type_DefaultValue { get; set; }
		...
		/// </summary>
		public CylinderSeriesSonificationContextTracksValueMapFunction ValueMapFunction { get; set; }
		private CylinderSeriesSonificationContextTracksValueMapFunction ValueMapFunction_DefaultValue { get; set; }
