...
{
	public partial class CylinderSeriesSonificationContextTracksMappingPan  : BaseObject
	{
		Hashtable h = new Hashtable();

		public CylinderSeriesSonificationContextTracksMappingPan()
		{
			MapFunction = MapFunction_DefaultValue = CylinderSeriesSonificationContextTracksMappingPanMapFunction.Linear;
			MapTo = MapTo_DefaultValue = "";
			Max = Max_DefaultValue = null;
			Min = Min_DefaultValue = null;
			Value = Value_DefaultValue = null;
			Within = Within_DefaultValue = CylinderSeriesSonificationContextTracksMappingPanWithin.Chart;
		...
		/// </summary>
		public CylinderSeriesSonificationContextTracksMappingPanMapFunction MapFunction { get; set; }
		private CylinderSeriesSonificationContextTracksMappingPanMapFunction MapFunction_DefaultValue { get; set; }
		...
		/// </summary>
		public CylinderSeriesSonificationContextTracksMappingPanWithin Within { get; set; }
		private CylinderSeriesSonificationContextTracksMappingPanWithin Within_DefaultValue { get; set; }
