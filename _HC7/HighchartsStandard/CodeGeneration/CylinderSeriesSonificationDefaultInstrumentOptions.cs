...
{
	public partial class CylinderSeriesSonificationDefaultInstrumentOptions  : BaseObject
	{
		Hashtable h = new Hashtable();

		public CylinderSeriesSonificationDefaultInstrumentOptions()
		{
			ActiveWhen = ActiveWhen_DefaultValue = new CylinderSeriesSonificationDefaultInstrumentOptionsActiveWhen();
			Instrument = Instrument_DefaultValue = null;
			InstrumentString = InstrumentString_DefaultValue = "null";
			Mapping = Mapping_DefaultValue = new CylinderSeriesSonificationDefaultInstrumentOptionsMapping();
			MidiName = MidiName_DefaultValue = "";
			PointGrouping = PointGrouping_DefaultValue = new CylinderSeriesSonificationDefaultInstrumentOptionsPointGrouping();
			RoundToMusicalNotes = RoundToMusicalNotes_DefaultValue = true;
			ShowPlayMarker = ShowPlayMarker_DefaultValue = true;
			Type = Type_DefaultValue = CylinderSeriesSonificationDefaultInstrumentOptionsType.Instrument;
		...
		/// </summary>
		public CylinderSeriesSonificationDefaultInstrumentOptionsActiveWhen ActiveWhen { get; set; }
		private CylinderSeriesSonificationDefaultInstrumentOptionsActiveWhen ActiveWhen_DefaultValue { get; set; }
		...
		/// </summary>
		public CylinderSeriesSonificationDefaultInstrumentOptionsMapping Mapping { get; set; }
		private CylinderSeriesSonificationDefaultInstrumentOptionsMapping Mapping_DefaultValue { get; set; }
		...
		/// </summary>
		public CylinderSeriesSonificationDefaultInstrumentOptionsPointGrouping PointGrouping { get; set; }
		private CylinderSeriesSonificationDefaultInstrumentOptionsPointGrouping PointGrouping_DefaultValue { get; set; }
		...
		/// </summary>
		public CylinderSeriesSonificationDefaultInstrumentOptionsType Type { get; set; }
		private CylinderSeriesSonificationDefaultInstrumentOptionsType Type_DefaultValue { get; set; }
