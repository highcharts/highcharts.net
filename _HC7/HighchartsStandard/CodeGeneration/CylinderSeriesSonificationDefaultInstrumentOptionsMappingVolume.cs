...
{
	public partial class CylinderSeriesSonificationDefaultInstrumentOptionsMappingVolume  : BaseObject
	{
		Hashtable h = new Hashtable();

		public CylinderSeriesSonificationDefaultInstrumentOptionsMappingVolume()
		{
			MapFunction = MapFunction_DefaultValue = CylinderSeriesSonificationDefaultInstrumentOptionsMappingVolumeMapFunction.Linear;
			MapTo = MapTo_DefaultValue = "";
			Max = Max_DefaultValue = null;
			Min = Min_DefaultValue = null;
			Value = Value_DefaultValue = null;
			Within = Within_DefaultValue = CylinderSeriesSonificationDefaultInstrumentOptionsMappingVolumeWithin.Chart;
		...
		/// </summary>
		public CylinderSeriesSonificationDefaultInstrumentOptionsMappingVolumeMapFunction MapFunction { get; set; }
		private CylinderSeriesSonificationDefaultInstrumentOptionsMappingVolumeMapFunction MapFunction_DefaultValue { get; set; }
		...
		/// </summary>
		public CylinderSeriesSonificationDefaultInstrumentOptionsMappingVolumeWithin Within { get; set; }
		private CylinderSeriesSonificationDefaultInstrumentOptionsMappingVolumeWithin Within_DefaultValue { get; set; }
