...
{
	public partial class CylinderSeriesSonificationPointGrouping  : BaseObject
	{
		Hashtable h = new Hashtable();

		public CylinderSeriesSonificationPointGrouping()
		{
		...
		/// </summary>
		public CylinderSeriesSonificationPointGroupingAlgorithm Algorithm { get; set; }
		private CylinderSeriesSonificationPointGroupingAlgorithm Algorithm_DefaultValue { get; set; }
		...
		internal override Hashtable ToHashtable(Highcharts highcharts)
		{
			...
			if (Algorithm != CylinderSeriesSonificationPointGroupingAlgorithm.Null) h.Add("algorithm", highcharts.FirstCharacterToLower(Algorithm.ToString()));
