...
{
	public partial class CylinderSeriesSonificationTracks  : BaseObject
	{
		Hashtable h = new Hashtable();

		public CylinderSeriesSonificationTracks()
		{
			ActiveWhen = ActiveWhen_DefaultValue = new CylinderSeriesSonificationTracksActiveWhen();
			Instrument = Instrument_DefaultValue = null;
			InstrumentString = InstrumentString_DefaultValue = "null";
			Mapping = Mapping_DefaultValue = new CylinderSeriesSonificationTracksMapping();
			MidiName = MidiName_DefaultValue = "";
			PointGrouping = PointGrouping_DefaultValue = new CylinderSeriesSonificationTracksPointGrouping();
			RoundToMusicalNotes = RoundToMusicalNotes_DefaultValue = true;
			ShowPlayMarker = ShowPlayMarker_DefaultValue = true;
			Type = Type_DefaultValue = CylinderSeriesSonificationTracksType.Instrument;
		...
		/// </summary>
		public CylinderSeriesSonificationTracksActiveWhen ActiveWhen { get; set; }
		private CylinderSeriesSonificationTracksActiveWhen ActiveWhen_DefaultValue { get; set; }
		...
		/// </summary>
		public CylinderSeriesSonificationTracksMapping Mapping { get; set; }
		private CylinderSeriesSonificationTracksMapping Mapping_DefaultValue { get; set; }
		...
		/// </summary>
		public CylinderSeriesSonificationTracksPointGrouping PointGrouping { get; set; }
		private CylinderSeriesSonificationTracksPointGrouping PointGrouping_DefaultValue { get; set; }
		...
		/// </summary>
		public CylinderSeriesSonificationTracksType Type { get; set; }
		private CylinderSeriesSonificationTracksType Type_DefaultValue { get; set; }
