...
{
	public partial class CylinderSeriesSonificationTracksMapping  : BaseObject
	{
		Hashtable h = new Hashtable();

		public CylinderSeriesSonificationTracksMapping()
		{
			Frequency = Frequency_DefaultValue = new CylinderSeriesSonificationTracksMappingFrequency();
			GapBetweenNotes = GapBetweenNotes_DefaultValue = new CylinderSeriesSonificationTracksMappingGapBetweenNotes();
			Highpass = Highpass_DefaultValue = new CylinderSeriesSonificationTracksMappingHighpass();
			Lowpass = Lowpass_DefaultValue = new CylinderSeriesSonificationTracksMappingLowpass();
			NoteDuration = NoteDuration_DefaultValue = new CylinderSeriesSonificationTracksMappingNoteDuration();
			Pan = Pan_DefaultValue = new CylinderSeriesSonificationTracksMappingPan();
			Pitch = Pitch_DefaultValue = new CylinderSeriesSonificationTracksMappingPitch();
			PitchString = PitchString_DefaultValue = "null";
			PitchNumber = PitchNumber_DefaultValue = null;
			PlayDelay = PlayDelay_DefaultValue = new CylinderSeriesSonificationTracksMappingPlayDelay();
			Time = Time_DefaultValue = new CylinderSeriesSonificationTracksMappingTime();
			TimeString = TimeString_DefaultValue = "null";
			TimeNumber = TimeNumber_DefaultValue = null;
			Tremolo = Tremolo_DefaultValue = new CylinderSeriesSonificationTracksMappingTremolo();
			Volume = Volume_DefaultValue = new CylinderSeriesSonificationTracksMappingVolume();
		...
		/// </summary>
		public CylinderSeriesSonificationTracksMappingFrequency Frequency { get; set; }
		private CylinderSeriesSonificationTracksMappingFrequency Frequency_DefaultValue { get; set; }
		...
		/// </summary>
		public CylinderSeriesSonificationTracksMappingGapBetweenNotes GapBetweenNotes { get; set; }
		private CylinderSeriesSonificationTracksMappingGapBetweenNotes GapBetweenNotes_DefaultValue { get; set; }
		...
		/// </summary>
		public CylinderSeriesSonificationTracksMappingHighpass Highpass { get; set; }
		private CylinderSeriesSonificationTracksMappingHighpass Highpass_DefaultValue { get; set; }
		...
		/// </summary>
		public CylinderSeriesSonificationTracksMappingLowpass Lowpass { get; set; }
		private CylinderSeriesSonificationTracksMappingLowpass Lowpass_DefaultValue { get; set; }
		...
		/// </summary>
		public CylinderSeriesSonificationTracksMappingNoteDuration NoteDuration { get; set; }
		private CylinderSeriesSonificationTracksMappingNoteDuration NoteDuration_DefaultValue { get; set; }
		...
		/// </summary>
		public CylinderSeriesSonificationTracksMappingPan Pan { get; set; }
		private CylinderSeriesSonificationTracksMappingPan Pan_DefaultValue { get; set; }
		...
		/// </summary>
		public CylinderSeriesSonificationTracksMappingPitch Pitch { get; set; }
		private CylinderSeriesSonificationTracksMappingPitch Pitch_DefaultValue { get; set; }
		...
		/// </summary>
		public CylinderSeriesSonificationTracksMappingPlayDelay PlayDelay { get; set; }
		private CylinderSeriesSonificationTracksMappingPlayDelay PlayDelay_DefaultValue { get; set; }
		...
		/// </summary>
		public CylinderSeriesSonificationTracksMappingTime Time { get; set; }
		private CylinderSeriesSonificationTracksMappingTime Time_DefaultValue { get; set; }
		...
		/// </summary>
		public CylinderSeriesSonificationTracksMappingTremolo Tremolo { get; set; }
		private CylinderSeriesSonificationTracksMappingTremolo Tremolo_DefaultValue { get; set; }
		 

		/// <summary>
		/// The volume of notes, from 0 to 1.
		/// </summary>
		public CylinderSeriesSonificationTracksMappingVolume Volume { get; set; }
		private CylinderSeriesSonificationTracksMappingVolume Volume_DefaultValue { get; set; }
