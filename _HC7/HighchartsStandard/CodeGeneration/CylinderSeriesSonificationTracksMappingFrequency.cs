...
{
	public partial class CylinderSeriesSonificationTracksMappingFrequency  : BaseObject
	{
		Hashtable h = new Hashtable();

		public CylinderSeriesSonificationTracksMappingFrequency()
		{
			MapFunction = MapFunction_DefaultValue = CylinderSeriesSonificationTracksMappingFrequencyMapFunction.Linear;
			MapTo = MapTo_DefaultValue = "";
			Max = Max_DefaultValue = null;
			Min = Min_DefaultValue = null;
			Value = Value_DefaultValue = null;
			Within = Within_DefaultValue = CylinderSeriesSonificationTracksMappingFrequencyWithin.Chart;
		...
		/// </summary>
		public CylinderSeriesSonificationTracksMappingFrequencyMapFunction MapFunction { get; set; }
		private CylinderSeriesSonificationTracksMappingFrequencyMapFunction MapFunction_DefaultValue { get; set; }
		...
		/// </summary>
		public CylinderSeriesSonificationTracksMappingFrequencyWithin Within { get; set; }
		private CylinderSeriesSonificationTracksMappingFrequencyWithin Within_DefaultValue { get; set; }
