...
{
	public partial class CylinderSeriesSonificationTracksMappingLowpassResonance  : BaseObject
	{
		Hashtable h = new Hashtable();

		public CylinderSeriesSonificationTracksMappingLowpassResonance()
		{
			MapFunction = MapFunction_DefaultValue = CylinderSeriesSonificationTracksMappingLowpassResonanceMapFunction.Linear;
			MapTo = MapTo_DefaultValue = "";
			Max = Max_DefaultValue = null;
			Min = Min_DefaultValue = null;
			Value = Value_DefaultValue = null;
			Within = Within_DefaultValue = CylinderSeriesSonificationTracksMappingLowpassResonanceWithin.Chart;
		...
		/// </summary>
		public CylinderSeriesSonificationTracksMappingLowpassResonanceMapFunction MapFunction { get; set; }
		private CylinderSeriesSonificationTracksMappingLowpassResonanceMapFunction MapFunction_DefaultValue { get; set; }
		...
		/// </summary>
		public CylinderSeriesSonificationTracksMappingLowpassResonanceWithin Within { get; set; }
		private CylinderSeriesSonificationTracksMappingLowpassResonanceWithin Within_DefaultValue { get; set; }
