...
{
	public partial class CylinderSeriesSonificationTracksMappingPan  : BaseObject
	{
		Hashtable h = new Hashtable();

		public CylinderSeriesSonificationTracksMappingPan()
		{
			MapFunction = MapFunction_DefaultValue = CylinderSeriesSonificationTracksMappingPanMapFunction.Linear;
			MapTo = MapTo_DefaultValue = "";
			Max = Max_DefaultValue = null;
			Min = Min_DefaultValue = null;
			Value = Value_DefaultValue = null;
			Within = Within_DefaultValue = CylinderSeriesSonificationTracksMappingPanWithin.Chart;
		...
		/// </summary>
		public CylinderSeriesSonificationTracksMappingPanMapFunction MapFunction { get; set; }
		private CylinderSeriesSonificationTracksMappingPanMapFunction MapFunction_DefaultValue { get; set; }
		...
		/// </summary>
		public CylinderSeriesSonificationTracksMappingPanWithin Within { get; set; }
		private CylinderSeriesSonificationTracksMappingPanWithin Within_DefaultValue { get; set; }
