...
{
	public partial class CylinderSeriesSonificationTracksMappingPitch  : BaseObject
	{
		Hashtable h = new Hashtable();

		public CylinderSeriesSonificationTracksMappingPitch()
		{
			MapFunction = MapFunction_DefaultValue = CylinderSeriesSonificationTracksMappingPitchMapFunction.Linear;
		...
		/// </summary>
		public CylinderSeriesSonificationTracksMappingPitchMapFunction MapFunction { get; set; }
		private CylinderSeriesSonificationTracksMappingPitchMapFunction MapFunction_DefaultValue { get; set; }
