...
{
	public partial class CylinderSeriesSonificationTracksMappingPlayDelay  : BaseObject
	{
		Hashtable h = new Hashtable();

		public CylinderSeriesSonificationTracksMappingPlayDelay()
		{
			MapFunction = MapFunction_DefaultValue = CylinderSeriesSonificationTracksMappingPlayDelayMapFunction.Linear;
			MapTo = MapTo_DefaultValue = "";
			Max = Max_DefaultValue = null;
			Min = Min_DefaultValue = null;
			Value = Value_DefaultValue = null;
			Within = Within_DefaultValue = CylinderSeriesSonificationTracksMappingPlayDelayWithin.Chart;
		...
		/// </summary>
		public CylinderSeriesSonificationTracksMappingPlayDelayMapFunction MapFunction { get; set; }
		private CylinderSeriesSonificationTracksMappingPlayDelayMapFunction MapFunction_DefaultValue { get; set; }
		...
		/// </summary>
		public CylinderSeriesSonificationTracksMappingPlayDelayWithin Within { get; set; }
		private CylinderSeriesSonificationTracksMappingPlayDelayWithin Within_DefaultValue { get; set; }
