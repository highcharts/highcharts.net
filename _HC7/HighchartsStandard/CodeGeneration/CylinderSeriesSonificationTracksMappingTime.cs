...
{
	public partial class CylinderSeriesSonificationTracksMappingTime  : BaseObject
	{
		Hashtable h = new Hashtable();

		public CylinderSeriesSonificationTracksMappingTime()
		{
			MapFunction = MapFunction_DefaultValue = CylinderSeriesSonificationTracksMappingTimeMapFunction.Linear;
			MapTo = MapTo_DefaultValue = "";
			Max = Max_DefaultValue = null;
			Min = Min_DefaultValue = null;
			Value = Value_DefaultValue = null;
			Within = Within_DefaultValue = CylinderSeriesSonificationTracksMappingTimeWithin.Chart;
		...
		/// </summary>
		public CylinderSeriesSonificationTracksMappingTimeMapFunction MapFunction { get; set; }
		private CylinderSeriesSonificationTracksMappingTimeMapFunction MapFunction_DefaultValue { get; set; }
		...
		/// </summary>
		public CylinderSeriesSonificationTracksMappingTimeWithin Within { get; set; }
		private CylinderSeriesSonificationTracksMappingTimeWithin Within_DefaultValue { get; set; }
