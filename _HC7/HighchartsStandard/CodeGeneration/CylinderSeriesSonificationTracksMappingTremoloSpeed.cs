...
{
	public partial class CylinderSeriesSonificationTracksMappingTremoloSpeed  : BaseObject
	{
		Hashtable h = new Hashtable();

		public CylinderSeriesSonificationTracksMappingTremoloSpeed()
		{
			MapFunction = MapFunction_DefaultValue = CylinderSeriesSonificationTracksMappingTremoloSpeedMapFunction.Linear;
			MapTo = MapTo_DefaultValue = "";
			Max = Max_DefaultValue = null;
			Min = Min_DefaultValue = null;
			Value = Value_DefaultValue = null;
			Within = Within_DefaultValue = CylinderSeriesSonificationTracksMappingTremoloSpeedWithin.Chart;
		...
		/// </summary>
		public CylinderSeriesSonificationTracksMappingTremoloSpeedMapFunction MapFunction { get; set; }
		private CylinderSeriesSonificationTracksMappingTremoloSpeedMapFunction MapFunction_DefaultValue { get; set; }
		...
		/// </summary>
		public CylinderSeriesSonificationTracksMappingTremoloSpeedWithin Within { get; set; }
		private CylinderSeriesSonificationTracksMappingTremoloSpeedWithin Within_DefaultValue { get; set; }
