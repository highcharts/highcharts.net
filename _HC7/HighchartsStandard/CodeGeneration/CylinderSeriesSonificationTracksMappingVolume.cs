...
{
	public partial class CylinderSeriesSonificationTracksMappingVolume  : BaseObject
	{
		Hashtable h = new Hashtable();

		public CylinderSeriesSonificationTracksMappingVolume()
		{
			MapFunction = MapFunction_DefaultValue = CylinderSeriesSonificationTracksMappingVolumeMapFunction.Linear;
			MapTo = MapTo_DefaultValue = "";
			Max = Max_DefaultValue = null;
			Min = Min_DefaultValue = null;
			Value = Value_DefaultValue = null;
			Within = Within_DefaultValue = CylinderSeriesSonificationTracksMappingVolumeWithin.Chart;
		...
		/// </summary>
		public CylinderSeriesSonificationTracksMappingVolumeMapFunction MapFunction { get; set; }
		private CylinderSeriesSonificationTracksMappingVolumeMapFunction MapFunction_DefaultValue { get; set; }
		...
		/// </summary>
		public CylinderSeriesSonificationTracksMappingVolumeWithin Within { get; set; }
		private CylinderSeriesSonificationTracksMappingVolumeWithin Within_DefaultValue { get; set; }
