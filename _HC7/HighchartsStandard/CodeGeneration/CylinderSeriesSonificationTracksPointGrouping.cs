...
{
	public partial class CylinderSeriesSonificationTracksPointGrouping  : BaseObject
	{
		Hashtable h = new Hashtable();

		public CylinderSeriesSonificationTracksPointGrouping()
		{
		...
		/// </summary>
		public CylinderSeriesSonificationTracksPointGroupingAlgorithm Algorithm { get; set; }
		private CylinderSeriesSonificationTracksPointGroupingAlgorithm Algorithm_DefaultValue { get; set; }
		...
		internal override Hashtable ToHashtable(Highcharts highcharts)
		{
			...
			if (Algorithm != CylinderSeriesSonificationTracksPointGroupingAlgorithm.Null) h.Add("algorithm", highcharts.FirstCharacterToLower(Algorithm.ToString()));
