...
{
	public partial class CylinderSeriesStatesSelectMarker  : BaseObject
	{
		public CylinderSeriesStatesSelectMarker()
		{
			...
			States = States_DefaultValue = new CylinderSeriesStatesSelectMarkerStates();
		...
		/// </summary>
		public CylinderSeriesStatesSelectMarkerStates States { get; set; }
		private CylinderSeriesStatesSelectMarkerStates States_DefaultValue { get; set; }
