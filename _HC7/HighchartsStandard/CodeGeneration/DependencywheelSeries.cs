...
namespace Highsoft.Web.Mvc.Charts
{
	public partial class DependencywheelSeries  : Series
	{
		...
		public DependencywheelSeries()
		{
			...
			LegendSymbol = LegendSymbol_DefaultValue = DependencywheelSeriesLegendSymbol.Rectangle;
			Levels = Levels_DefaultValue = new DependencywheelSeriesLevels();
			LinkColorMode = LinkColorMode_DefaultValue = DependencywheelSeriesLinkColorMode.From;
			...
			Sonification = Sonification_DefaultValue = new DependencywheelSeriesSonification();
		...
		/// </summary>
		public DependencywheelSeriesLinkColorMode LinkColorMode { get; set; }
		private DependencywheelSeriesLinkColorMode LinkColorMode_DefaultValue { get; set; }
		...
		/// </summary>
		public DependencywheelSeriesOnPoint OnPoint { get; set; }
		private DependencywheelSeriesOnPoint OnPoint_DefaultValue { get; set; }
		...
		/// </summary>
		public DependencywheelSeriesSonification Sonification { get; set; }
		private DependencywheelSeriesSonification Sonification_DefaultValue { get; set; }
