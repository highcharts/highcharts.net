...
{
	public partial class DependencywheelSeriesDataDragDrop  : BaseObject
	{
		public DependencywheelSeriesDataDragDrop()
		{
			DraggableX = DraggableX_DefaultValue = null;
			DraggableY = DraggableY_DefaultValue = null;
			DragHandle = DragHandle_DefaultValue = new DependencywheelSeriesDataDragDropDragHandle();
			...
			GuideBox = GuideBox_DefaultValue = new DependencywheelSeriesDataDragDropGuideBox();
		...
		/// </summary>
		public DependencywheelSeriesDataDragDropDragHandle DragHandle { get; set; }
		private DependencywheelSeriesDataDragDropDragHandle DragHandle_DefaultValue { get; set; }
		...
		/// </summary>
		public DependencywheelSeriesDataDragDropGuideBox GuideBox { get; set; }
		private DependencywheelSeriesDataDragDropGuideBox GuideBox_DefaultValue { get; set; }
