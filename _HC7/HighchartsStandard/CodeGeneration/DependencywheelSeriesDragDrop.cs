...
{
	public partial class DependencywheelSeriesDragDrop  : BaseObject
	{
		public DependencywheelSeriesDragDrop()
		{
			DraggableX = DraggableX_DefaultValue = null;
			DraggableY = DraggableY_DefaultValue = null;
			DragHandle = DragHandle_DefaultValue = new DependencywheelSeriesDragDropDragHandle();
			...
			GuideBox = GuideBox_DefaultValue = new DependencywheelSeriesDragDropGuideBox();
		...
		/// </summary>
		public DependencywheelSeriesDragDropDragHandle DragHandle { get; set; }
		private DependencywheelSeriesDragDropDragHandle DragHandle_DefaultValue { get; set; }
		...
		/// </summary>
		public DependencywheelSeriesDragDropGuideBox GuideBox { get; set; }
		private DependencywheelSeriesDragDropGuideBox GuideBox_DefaultValue { get; set; }
