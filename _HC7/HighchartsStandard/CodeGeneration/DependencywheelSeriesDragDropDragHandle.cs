...
{
	public partial class DependencywheelSeriesDragDropDragHandle  : BaseObject
	{
		public DependencywheelSeriesDragDropDragHandle()
		{
		...
		internal override Hashtable ToHashtable()
		{
			...
			if (PathFormatter != PathFormatter_DefaultValue) { h.Add("pathFormatter",PathFormatter); Highcharts.AddFunction("DependencywheelSeriesDragDropDragHandlePathFormatter.pathFormatter", PathFormatter); }  
