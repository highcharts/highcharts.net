...
{
	public partial class DependencywheelSeriesSonificationContextTracks  : BaseObject
	{
		Hashtable h = new Hashtable();

		public DependencywheelSeriesSonificationContextTracks()
		{
			ActiveWhen = ActiveWhen_DefaultValue = new DependencywheelSeriesSonificationContextTracksActiveWhen();
			Instrument = Instrument_DefaultValue = null;
			InstrumentString = InstrumentString_DefaultValue = "null";
			Mapping = Mapping_DefaultValue = new DependencywheelSeriesSonificationContextTracksMapping();
			MidiName = MidiName_DefaultValue = "";
			PointGrouping = PointGrouping_DefaultValue = new DependencywheelSeriesSonificationContextTracksPointGrouping();
			...
			Type = Type_DefaultValue = DependencywheelSeriesSonificationContextTracksType.Instrument;
			ValueInterval = ValueInterval_DefaultValue = null;
			ValueMapFunction = ValueMapFunction_DefaultValue = DependencywheelSeriesSonificationContextTracksValueMapFunction.Linear;
		...
		/// </summary>
		public DependencywheelSeriesSonificationContextTracksActiveWhen ActiveWhen { get; set; }
		private DependencywheelSeriesSonificationContextTracksActiveWhen ActiveWhen_DefaultValue { get; set; }
		...
		/// </summary>
		public DependencywheelSeriesSonificationContextTracksMapping Mapping { get; set; }
		private DependencywheelSeriesSonificationContextTracksMapping Mapping_DefaultValue { get; set; }
		...
		/// </summary>
		public DependencywheelSeriesSonificationContextTracksPointGrouping PointGrouping { get; set; }
		private DependencywheelSeriesSonificationContextTracksPointGrouping PointGrouping_DefaultValue { get; set; }
		...
		/// </summary>
		public DependencywheelSeriesSonificationContextTracksType Type { get; set; }
		private DependencywheelSeriesSonificationContextTracksType Type_DefaultValue { get; set; }
		...
		/// </summary>
		public DependencywheelSeriesSonificationContextTracksValueMapFunction ValueMapFunction { get; set; }
		private DependencywheelSeriesSonificationContextTracksValueMapFunction ValueMapFunction_DefaultValue { get; set; }
