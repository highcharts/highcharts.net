...
{
	public partial class DependencywheelSeriesSonificationContextTracksActiveWhen  : BaseObject
	{
		Hashtable h = new Hashtable();

		public DependencywheelSeriesSonificationContextTracksActiveWhen()
		{
