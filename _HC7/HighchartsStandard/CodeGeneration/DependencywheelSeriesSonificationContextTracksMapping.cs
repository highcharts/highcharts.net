...
{
	public partial class DependencywheelSeriesSonificationContextTracksMapping  : BaseObject
	{
		Hashtable h = new Hashtable();

		public DependencywheelSeriesSonificationContextTracksMapping()
		{
			Frequency = Frequency_DefaultValue = new DependencywheelSeriesSonificationContextTracksMappingFrequency();
			GapBetweenNotes = GapBetweenNotes_DefaultValue = new DependencywheelSeriesSonificationContextTracksMappingGapBetweenNotes();
			Highpass = Highpass_DefaultValue = new DependencywheelSeriesSonificationContextTracksMappingHighpass();
			Lowpass = Lowpass_DefaultValue = new DependencywheelSeriesSonificationContextTracksMappingLowpass();
			NoteDuration = NoteDuration_DefaultValue = new DependencywheelSeriesSonificationContextTracksMappingNoteDuration();
			Pan = Pan_DefaultValue = new DependencywheelSeriesSonificationContextTracksMappingPan();
			Pitch = Pitch_DefaultValue = new DependencywheelSeriesSonificationContextTracksMappingPitch();
			PitchString = PitchString_DefaultValue = "null";
			PitchNumber = PitchNumber_DefaultValue = null;
			PlayDelay = PlayDelay_DefaultValue = new DependencywheelSeriesSonificationContextTracksMappingPlayDelay();
			Time = Time_DefaultValue = new DependencywheelSeriesSonificationContextTracksMappingTime();
			TimeString = TimeString_DefaultValue = "null";
			TimeNumber = TimeNumber_DefaultValue = null;
			Tremolo = Tremolo_DefaultValue = new DependencywheelSeriesSonificationContextTracksMappingTremolo();
			Volume = Volume_DefaultValue = new DependencywheelSeriesSonificationContextTracksMappingVolume();
		...
		/// </summary>
		public DependencywheelSeriesSonificationContextTracksMappingFrequency Frequency { get; set; }
		private DependencywheelSeriesSonificationContextTracksMappingFrequency Frequency_DefaultValue { get; set; }
		...
		/// </summary>
		public DependencywheelSeriesSonificationContextTracksMappingGapBetweenNotes GapBetweenNotes { get; set; }
		private DependencywheelSeriesSonificationContextTracksMappingGapBetweenNotes GapBetweenNotes_DefaultValue { get; set; }
		...
		/// </summary>
		public DependencywheelSeriesSonificationContextTracksMappingHighpass Highpass { get; set; }
		private DependencywheelSeriesSonificationContextTracksMappingHighpass Highpass_DefaultValue { get; set; }
		...
		/// </summary>
		public DependencywheelSeriesSonificationContextTracksMappingLowpass Lowpass { get; set; }
		private DependencywheelSeriesSonificationContextTracksMappingLowpass Lowpass_DefaultValue { get; set; }
		...
		/// </summary>
		public DependencywheelSeriesSonificationContextTracksMappingNoteDuration NoteDuration { get; set; }
		private DependencywheelSeriesSonificationContextTracksMappingNoteDuration NoteDuration_DefaultValue { get; set; }
		...
		/// </summary>
		public DependencywheelSeriesSonificationContextTracksMappingPan Pan { get; set; }
		private DependencywheelSeriesSonificationContextTracksMappingPan Pan_DefaultValue { get; set; }
		...
		/// </summary>
		public DependencywheelSeriesSonificationContextTracksMappingPitch Pitch { get; set; }
		private DependencywheelSeriesSonificationContextTracksMappingPitch Pitch_DefaultValue { get; set; }
		...
		/// </summary>
		public DependencywheelSeriesSonificationContextTracksMappingPlayDelay PlayDelay { get; set; }
		private DependencywheelSeriesSonificationContextTracksMappingPlayDelay PlayDelay_DefaultValue { get; set; }
		...
		/// </summary>
		public DependencywheelSeriesSonificationContextTracksMappingTime Time { get; set; }
		private DependencywheelSeriesSonificationContextTracksMappingTime Time_DefaultValue { get; set; }
		...
		/// </summary>
		public DependencywheelSeriesSonificationContextTracksMappingTremolo Tremolo { get; set; }
		private DependencywheelSeriesSonificationContextTracksMappingTremolo Tremolo_DefaultValue { get; set; }
		 

		/// <summary>
		/// The volume of notes, from 0 to 1.
		/// </summary>
		public DependencywheelSeriesSonificationContextTracksMappingVolume Volume { get; set; }
		private DependencywheelSeriesSonificationContextTracksMappingVolume Volume_DefaultValue { get; set; }
