...
{
	public partial class DependencywheelSeriesSonificationContextTracksMappingPan  : BaseObject
	{
		Hashtable h = new Hashtable();

		public DependencywheelSeriesSonificationContextTracksMappingPan()
		{
			MapFunction = MapFunction_DefaultValue = DependencywheelSeriesSonificationContextTracksMappingPanMapFunction.Linear;
			MapTo = MapTo_DefaultValue = "";
			Max = Max_DefaultValue = null;
			Min = Min_DefaultValue = null;
			Value = Value_DefaultValue = null;
			Within = Within_DefaultValue = DependencywheelSeriesSonificationContextTracksMappingPanWithin.Chart;
		...
		/// </summary>
		public DependencywheelSeriesSonificationContextTracksMappingPanMapFunction MapFunction { get; set; }
		private DependencywheelSeriesSonificationContextTracksMappingPanMapFunction MapFunction_DefaultValue { get; set; }
		...
		/// </summary>
		public DependencywheelSeriesSonificationContextTracksMappingPanWithin Within { get; set; }
		private DependencywheelSeriesSonificationContextTracksMappingPanWithin Within_DefaultValue { get; set; }
