...
{
	public partial class DependencywheelSeriesSonificationContextTracksPointGrouping  : BaseObject
	{
		Hashtable h = new Hashtable();

		public DependencywheelSeriesSonificationContextTracksPointGrouping()
		{
		...
		/// </summary>
		public DependencywheelSeriesSonificationContextTracksPointGroupingAlgorithm Algorithm { get; set; }
		private DependencywheelSeriesSonificationContextTracksPointGroupingAlgorithm Algorithm_DefaultValue { get; set; }
		...
		internal override Hashtable ToHashtable(Highcharts highcharts)
		{
			...
			if (Algorithm != DependencywheelSeriesSonificationContextTracksPointGroupingAlgorithm.Null) h.Add("algorithm", highcharts.FirstCharacterToLower(Algorithm.ToString()));
