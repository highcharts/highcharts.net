...
{
	public partial class DependencywheelSeriesSonificationPointGrouping  : BaseObject
	{
		Hashtable h = new Hashtable();

		public DependencywheelSeriesSonificationPointGrouping()
		{
		...
		/// </summary>
		public DependencywheelSeriesSonificationPointGroupingAlgorithm Algorithm { get; set; }
		private DependencywheelSeriesSonificationPointGroupingAlgorithm Algorithm_DefaultValue { get; set; }
		...
		internal override Hashtable ToHashtable(Highcharts highcharts)
		{
			...
			if (Algorithm != DependencywheelSeriesSonificationPointGroupingAlgorithm.Null) h.Add("algorithm", highcharts.FirstCharacterToLower(Algorithm.ToString()));
