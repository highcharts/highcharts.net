...
{
	public partial class DependencywheelSeriesSonificationTracksMapping  : BaseObject
	{
		Hashtable h = new Hashtable();

		public DependencywheelSeriesSonificationTracksMapping()
		{
			Frequency = Frequency_DefaultValue = new DependencywheelSeriesSonificationTracksMappingFrequency();
			GapBetweenNotes = GapBetweenNotes_DefaultValue = new DependencywheelSeriesSonificationTracksMappingGapBetweenNotes();
			Highpass = Highpass_DefaultValue = new DependencywheelSeriesSonificationTracksMappingHighpass();
			Lowpass = Lowpass_DefaultValue = new DependencywheelSeriesSonificationTracksMappingLowpass();
			NoteDuration = NoteDuration_DefaultValue = new DependencywheelSeriesSonificationTracksMappingNoteDuration();
			Pan = Pan_DefaultValue = new DependencywheelSeriesSonificationTracksMappingPan();
			Pitch = Pitch_DefaultValue = new DependencywheelSeriesSonificationTracksMappingPitch();
			PitchString = PitchString_DefaultValue = "null";
			PitchNumber = PitchNumber_DefaultValue = null;
			PlayDelay = PlayDelay_DefaultValue = new DependencywheelSeriesSonificationTracksMappingPlayDelay();
			Time = Time_DefaultValue = new DependencywheelSeriesSonificationTracksMappingTime();
			TimeString = TimeString_DefaultValue = "null";
			TimeNumber = TimeNumber_DefaultValue = null;
			Tremolo = Tremolo_DefaultValue = new DependencywheelSeriesSonificationTracksMappingTremolo();
			Volume = Volume_DefaultValue = new DependencywheelSeriesSonificationTracksMappingVolume();
		...
		/// </summary>
		public DependencywheelSeriesSonificationTracksMappingFrequency Frequency { get; set; }
		private DependencywheelSeriesSonificationTracksMappingFrequency Frequency_DefaultValue { get; set; }
		...
		/// </summary>
		public DependencywheelSeriesSonificationTracksMappingGapBetweenNotes GapBetweenNotes { get; set; }
		private DependencywheelSeriesSonificationTracksMappingGapBetweenNotes GapBetweenNotes_DefaultValue { get; set; }
		...
		/// </summary>
		public DependencywheelSeriesSonificationTracksMappingHighpass Highpass { get; set; }
		private DependencywheelSeriesSonificationTracksMappingHighpass Highpass_DefaultValue { get; set; }
		...
		/// </summary>
		public DependencywheelSeriesSonificationTracksMappingLowpass Lowpass { get; set; }
		private DependencywheelSeriesSonificationTracksMappingLowpass Lowpass_DefaultValue { get; set; }
		...
		/// </summary>
		public DependencywheelSeriesSonificationTracksMappingNoteDuration NoteDuration { get; set; }
		private DependencywheelSeriesSonificationTracksMappingNoteDuration NoteDuration_DefaultValue { get; set; }
		...
		/// </summary>
		public DependencywheelSeriesSonificationTracksMappingPan Pan { get; set; }
		private DependencywheelSeriesSonificationTracksMappingPan Pan_DefaultValue { get; set; }
		...
		/// </summary>
		public DependencywheelSeriesSonificationTracksMappingPitch Pitch { get; set; }
		private DependencywheelSeriesSonificationTracksMappingPitch Pitch_DefaultValue { get; set; }
		...
		/// </summary>
		public DependencywheelSeriesSonificationTracksMappingPlayDelay PlayDelay { get; set; }
		private DependencywheelSeriesSonificationTracksMappingPlayDelay PlayDelay_DefaultValue { get; set; }
		...
		/// </summary>
		public DependencywheelSeriesSonificationTracksMappingTime Time { get; set; }
		private DependencywheelSeriesSonificationTracksMappingTime Time_DefaultValue { get; set; }
		...
		/// </summary>
		public DependencywheelSeriesSonificationTracksMappingTremolo Tremolo { get; set; }
		private DependencywheelSeriesSonificationTracksMappingTremolo Tremolo_DefaultValue { get; set; }
		 

		/// <summary>
		/// The volume of notes, from 0 to 1.
		/// </summary>
		public DependencywheelSeriesSonificationTracksMappingVolume Volume { get; set; }
		private DependencywheelSeriesSonificationTracksMappingVolume Volume_DefaultValue { get; set; }
