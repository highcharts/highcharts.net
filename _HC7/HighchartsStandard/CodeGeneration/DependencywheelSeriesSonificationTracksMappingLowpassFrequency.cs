...
{
	public partial class DependencywheelSeriesSonificationTracksMappingLowpassFrequency  : BaseObject
	{
		Hashtable h = new Hashtable();

		public DependencywheelSeriesSonificationTracksMappingLowpassFrequency()
		{
			MapFunction = MapFunction_DefaultValue = DependencywheelSeriesSonificationTracksMappingLowpassFrequencyMapFunction.Linear;
			MapTo = MapTo_DefaultValue = "";
			Max = Max_DefaultValue = null;
			Min = Min_DefaultValue = null;
			Value = Value_DefaultValue = null;
			Within = Within_DefaultValue = DependencywheelSeriesSonificationTracksMappingLowpassFrequencyWithin.Chart;
		...
		/// </summary>
		public DependencywheelSeriesSonificationTracksMappingLowpassFrequencyMapFunction MapFunction { get; set; }
		private DependencywheelSeriesSonificationTracksMappingLowpassFrequencyMapFunction MapFunction_DefaultValue { get; set; }
		...
		/// </summary>
		public DependencywheelSeriesSonificationTracksMappingLowpassFrequencyWithin Within { get; set; }
		private DependencywheelSeriesSonificationTracksMappingLowpassFrequencyWithin Within_DefaultValue { get; set; }
