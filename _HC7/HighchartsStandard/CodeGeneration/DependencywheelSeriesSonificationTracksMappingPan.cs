...
{
	public partial class DependencywheelSeriesSonificationTracksMappingPan  : BaseObject
	{
		Hashtable h = new Hashtable();

		public DependencywheelSeriesSonificationTracksMappingPan()
		{
			MapFunction = MapFunction_DefaultValue = DependencywheelSeriesSonificationTracksMappingPanMapFunction.Linear;
			MapTo = MapTo_DefaultValue = "";
			Max = Max_DefaultValue = null;
			Min = Min_DefaultValue = null;
			Value = Value_DefaultValue = null;
			Within = Within_DefaultValue = DependencywheelSeriesSonificationTracksMappingPanWithin.Chart;
		...
		/// </summary>
		public DependencywheelSeriesSonificationTracksMappingPanMapFunction MapFunction { get; set; }
		private DependencywheelSeriesSonificationTracksMappingPanMapFunction MapFunction_DefaultValue { get; set; }
		...
		/// </summary>
		public DependencywheelSeriesSonificationTracksMappingPanWithin Within { get; set; }
		private DependencywheelSeriesSonificationTracksMappingPanWithin Within_DefaultValue { get; set; }
