...
{
	public partial class DependencywheelSeriesSonificationTracksMappingPitch  : BaseObject
	{
		Hashtable h = new Hashtable();

		public DependencywheelSeriesSonificationTracksMappingPitch()
		{
			MapFunction = MapFunction_DefaultValue = DependencywheelSeriesSonificationTracksMappingPitchMapFunction.Linear;
		...
		/// </summary>
		public DependencywheelSeriesSonificationTracksMappingPitchMapFunction MapFunction { get; set; }
		private DependencywheelSeriesSonificationTracksMappingPitchMapFunction MapFunction_DefaultValue { get; set; }
