...
{
	public partial class DependencywheelSeriesSonificationTracksMappingTime  : BaseObject
	{
		Hashtable h = new Hashtable();

		public DependencywheelSeriesSonificationTracksMappingTime()
		{
			MapFunction = MapFunction_DefaultValue = DependencywheelSeriesSonificationTracksMappingTimeMapFunction.Linear;
			MapTo = MapTo_DefaultValue = "";
			Max = Max_DefaultValue = null;
			Min = Min_DefaultValue = null;
			Value = Value_DefaultValue = null;
			Within = Within_DefaultValue = DependencywheelSeriesSonificationTracksMappingTimeWithin.Chart;
		...
		/// </summary>
		public DependencywheelSeriesSonificationTracksMappingTimeMapFunction MapFunction { get; set; }
		private DependencywheelSeriesSonificationTracksMappingTimeMapFunction MapFunction_DefaultValue { get; set; }
		...
		/// </summary>
		public DependencywheelSeriesSonificationTracksMappingTimeWithin Within { get; set; }
		private DependencywheelSeriesSonificationTracksMappingTimeWithin Within_DefaultValue { get; set; }
