...
{
	public partial class DependencywheelSeriesSonificationTracksMappingVolume  : BaseObject
	{
		Hashtable h = new Hashtable();

		public DependencywheelSeriesSonificationTracksMappingVolume()
		{
			MapFunction = MapFunction_DefaultValue = DependencywheelSeriesSonificationTracksMappingVolumeMapFunction.Linear;
			MapTo = MapTo_DefaultValue = "";
			Max = Max_DefaultValue = null;
			Min = Min_DefaultValue = null;
			Value = Value_DefaultValue = null;
			Within = Within_DefaultValue = DependencywheelSeriesSonificationTracksMappingVolumeWithin.Chart;
		...
		/// </summary>
		public DependencywheelSeriesSonificationTracksMappingVolumeMapFunction MapFunction { get; set; }
		private DependencywheelSeriesSonificationTracksMappingVolumeMapFunction MapFunction_DefaultValue { get; set; }
		...
		/// </summary>
		public DependencywheelSeriesSonificationTracksMappingVolumeWithin Within { get; set; }
		private DependencywheelSeriesSonificationTracksMappingVolumeWithin Within_DefaultValue { get; set; }
