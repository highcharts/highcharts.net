...
{
	public partial class DependencywheelSeriesSonificationTracksPointGrouping  : BaseObject
	{
		Hashtable h = new Hashtable();

		public DependencywheelSeriesSonificationTracksPointGrouping()
		{
		...
		/// </summary>
		public DependencywheelSeriesSonificationTracksPointGroupingAlgorithm Algorithm { get; set; }
		private DependencywheelSeriesSonificationTracksPointGroupingAlgorithm Algorithm_DefaultValue { get; set; }
		...
		internal override Hashtable ToHashtable(Highcharts highcharts)
		{
			...
			if (Algorithm != DependencywheelSeriesSonificationTracksPointGroupingAlgorithm.Null) h.Add("algorithm", highcharts.FirstCharacterToLower(Algorithm.ToString()));
