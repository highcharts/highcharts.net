...
{
	public partial class DependencywheelSeriesStatesHoverMarker  : BaseObject
	{
		public DependencywheelSeriesStatesHoverMarker()
		{
			...
			States = States_DefaultValue = new DependencywheelSeriesStatesHoverMarkerStates();
		...
		/// </summary>
		public DependencywheelSeriesStatesHoverMarkerStates States { get; set; }
		private DependencywheelSeriesStatesHoverMarkerStates States_DefaultValue { get; set; }
