...
{
	public partial class DependencywheelSeriesStatesSelectMarker  : BaseObject
	{
		public DependencywheelSeriesStatesSelectMarker()
		{
			...
			States = States_DefaultValue = new DependencywheelSeriesStatesSelectMarkerStates();
		...
		/// </summary>
		public DependencywheelSeriesStatesSelectMarkerStates States { get; set; }
		private DependencywheelSeriesStatesSelectMarkerStates States_DefaultValue { get; set; }
