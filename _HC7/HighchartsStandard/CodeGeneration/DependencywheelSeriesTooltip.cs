...
{
	public partial class DependencywheelSeriesTooltip  : BaseObject
	{
		public DependencywheelSeriesTooltip()
		{
			...
			HeaderShape = HeaderShape_DefaultValue = DependencywheelSeriesTooltipHeaderShape.Callout;
		...
		/// </summary>
		public DependencywheelSeriesTooltipHeaderShape HeaderShape { get; set; }
		private DependencywheelSeriesTooltipHeaderShape HeaderShape_DefaultValue { get; set; }
		...
		internal override Hashtable ToHashtable()
		{
			...
			if (NullFormatter != NullFormatter_DefaultValue) { h.Add("nullFormatter",NullFormatter); Highcharts.AddFunction("DependencywheelSeriesTooltipNullFormatter.nullFormatter", NullFormatter); }  
			if (Outside != Outside_DefaultValue) h.Add("outside",Outside);
			if (Padding != Padding_DefaultValue) h.Add("padding",Padding);
			if (PointFormat != PointFormat_DefaultValue) h.Add("pointFormat",PointFormat);
			if (PointFormatter != PointFormatter_DefaultValue) { h.Add("pointFormatter",PointFormatter); Highcharts.AddFunction("DependencywheelSeriesTooltipPointFormatter.pointFormatter", PointFormatter); }  
