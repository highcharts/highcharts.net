...
{
	public partial class DumbbellSeriesDataDataLabels  : BaseObject
	{
		Hashtable h = new Hashtable();

		public DumbbellSeriesDataDataLabels()
		{
		...
		/// </summary>
		public DumbbellSeriesDataDataLabelsAlign Align { get; set; }
		private DumbbellSeriesDataDataLabelsAlign Align_DefaultValue { get; set; }
		...
		/// </summary>
		public DumbbellSeriesDataDataLabelsFilter Filter { get; set; }
		private DumbbellSeriesDataDataLabelsFilter Filter_DefaultValue { get; set; }
		...
		/// </summary>
		public DumbbellSeriesDataDataLabelsOverflow Overflow { get; set; }
		private DumbbellSeriesDataDataLabelsOverflow Overflow_DefaultValue { get; set; }
		...
		/// </summary>
		public DumbbellSeriesDataDataLabelsPosition Position { get; set; }
		private DumbbellSeriesDataDataLabelsPosition Position_DefaultValue { get; set; }
		...
		/// </summary>
		public DumbbellSeriesDataDataLabelsTextPath TextPath { get; set; }
		private DumbbellSeriesDataDataLabelsTextPath TextPath_DefaultValue { get; set; }
		...
		/// </summary>
		public DumbbellSeriesDataDataLabelsVerticalAlign VerticalAlign { get; set; }
		private DumbbellSeriesDataDataLabelsVerticalAlign VerticalAlign_DefaultValue { get; set; }
		...
		internal override Hashtable ToHashtable(Highcharts highcharts)
		{
			...
			if (Align != DumbbellSeriesDataDataLabelsAlign.Null) h.Add("align", highcharts.FirstCharacterToLower(Align.ToString()));
			...
			if (Overflow != DumbbellSeriesDataDataLabelsOverflow.Null) h.Add("overflow", highcharts.FirstCharacterToLower(Overflow.ToString()));
			if (Padding != null) h.Add("padding",Padding);
			if (Position != DumbbellSeriesDataDataLabelsPosition.Null) h.Add("position", highcharts.FirstCharacterToLower(Position.ToString()));
			...
			if (VerticalAlign != DumbbellSeriesDataDataLabelsVerticalAlign.Null) h.Add("verticalAlign", highcharts.FirstCharacterToLower(VerticalAlign.ToString()));
			if (X != null) h.Add("x",X);
			if (Y != null) h.Add("y",Y);
