...
{
	public partial class DumbbellSeriesLowMarker  : BaseObject
	{
		Hashtable h = new Hashtable();

		public DumbbellSeriesLowMarker()
		{
			...
			States = States_DefaultValue = new DumbbellSeriesLowMarkerStates();
		...
		/// </summary>
		public DumbbellSeriesLowMarkerStates States { get; set; }
		private DumbbellSeriesLowMarkerStates States_DefaultValue { get; set; }
