...
{
	public partial class DumbbellSeriesSonificationContextTracksMapping  : BaseObject
	{
		Hashtable h = new Hashtable();

		public DumbbellSeriesSonificationContextTracksMapping()
		{
			Frequency = Frequency_DefaultValue = new DumbbellSeriesSonificationContextTracksMappingFrequency();
			GapBetweenNotes = GapBetweenNotes_DefaultValue = new DumbbellSeriesSonificationContextTracksMappingGapBetweenNotes();
			Highpass = Highpass_DefaultValue = new DumbbellSeriesSonificationContextTracksMappingHighpass();
			Lowpass = Lowpass_DefaultValue = new DumbbellSeriesSonificationContextTracksMappingLowpass();
			NoteDuration = NoteDuration_DefaultValue = new DumbbellSeriesSonificationContextTracksMappingNoteDuration();
			Pan = Pan_DefaultValue = new DumbbellSeriesSonificationContextTracksMappingPan();
			Pitch = Pitch_DefaultValue = new DumbbellSeriesSonificationContextTracksMappingPitch();
			PitchString = PitchString_DefaultValue = "null";
			PitchNumber = PitchNumber_DefaultValue = null;
			PlayDelay = PlayDelay_DefaultValue = new DumbbellSeriesSonificationContextTracksMappingPlayDelay();
			Time = Time_DefaultValue = new DumbbellSeriesSonificationContextTracksMappingTime();
			TimeString = TimeString_DefaultValue = "null";
			TimeNumber = TimeNumber_DefaultValue = null;
			Tremolo = Tremolo_DefaultValue = new DumbbellSeriesSonificationContextTracksMappingTremolo();
			Volume = Volume_DefaultValue = new DumbbellSeriesSonificationContextTracksMappingVolume();
		...
		/// </summary>
		public DumbbellSeriesSonificationContextTracksMappingFrequency Frequency { get; set; }
		private DumbbellSeriesSonificationContextTracksMappingFrequency Frequency_DefaultValue { get; set; }
		...
		/// </summary>
		public DumbbellSeriesSonificationContextTracksMappingGapBetweenNotes GapBetweenNotes { get; set; }
		private DumbbellSeriesSonificationContextTracksMappingGapBetweenNotes GapBetweenNotes_DefaultValue { get; set; }
		...
		/// </summary>
		public DumbbellSeriesSonificationContextTracksMappingHighpass Highpass { get; set; }
		private DumbbellSeriesSonificationContextTracksMappingHighpass Highpass_DefaultValue { get; set; }
		...
		/// </summary>
		public DumbbellSeriesSonificationContextTracksMappingLowpass Lowpass { get; set; }
		private DumbbellSeriesSonificationContextTracksMappingLowpass Lowpass_DefaultValue { get; set; }
		...
		/// </summary>
		public DumbbellSeriesSonificationContextTracksMappingNoteDuration NoteDuration { get; set; }
		private DumbbellSeriesSonificationContextTracksMappingNoteDuration NoteDuration_DefaultValue { get; set; }
		...
		/// </summary>
		public DumbbellSeriesSonificationContextTracksMappingPan Pan { get; set; }
		private DumbbellSeriesSonificationContextTracksMappingPan Pan_DefaultValue { get; set; }
		...
		/// </summary>
		public DumbbellSeriesSonificationContextTracksMappingPitch Pitch { get; set; }
		private DumbbellSeriesSonificationContextTracksMappingPitch Pitch_DefaultValue { get; set; }
		...
		/// </summary>
		public DumbbellSeriesSonificationContextTracksMappingPlayDelay PlayDelay { get; set; }
		private DumbbellSeriesSonificationContextTracksMappingPlayDelay PlayDelay_DefaultValue { get; set; }
		...
		/// </summary>
		public DumbbellSeriesSonificationContextTracksMappingTime Time { get; set; }
		private DumbbellSeriesSonificationContextTracksMappingTime Time_DefaultValue { get; set; }
		...
		/// </summary>
		public DumbbellSeriesSonificationContextTracksMappingTremolo Tremolo { get; set; }
		private DumbbellSeriesSonificationContextTracksMappingTremolo Tremolo_DefaultValue { get; set; }
		 

		/// <summary>
		/// The volume of notes, from 0 to 1.
		/// </summary>
		public DumbbellSeriesSonificationContextTracksMappingVolume Volume { get; set; }
		private DumbbellSeriesSonificationContextTracksMappingVolume Volume_DefaultValue { get; set; }
