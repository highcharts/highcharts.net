...
{
	public partial class DumbbellSeriesSonificationContextTracksMappingFrequency  : BaseObject
	{
		Hashtable h = new Hashtable();

		public DumbbellSeriesSonificationContextTracksMappingFrequency()
		{
			MapFunction = MapFunction_DefaultValue = DumbbellSeriesSonificationContextTracksMappingFrequencyMapFunction.Linear;
			MapTo = MapTo_DefaultValue = "";
			Max = Max_DefaultValue = null;
			Min = Min_DefaultValue = null;
			Value = Value_DefaultValue = null;
			Within = Within_DefaultValue = DumbbellSeriesSonificationContextTracksMappingFrequencyWithin.Chart;
		...
		/// </summary>
		public DumbbellSeriesSonificationContextTracksMappingFrequencyMapFunction MapFunction { get; set; }
		private DumbbellSeriesSonificationContextTracksMappingFrequencyMapFunction MapFunction_DefaultValue { get; set; }
		...
		/// </summary>
		public DumbbellSeriesSonificationContextTracksMappingFrequencyWithin Within { get; set; }
		private DumbbellSeriesSonificationContextTracksMappingFrequencyWithin Within_DefaultValue { get; set; }
