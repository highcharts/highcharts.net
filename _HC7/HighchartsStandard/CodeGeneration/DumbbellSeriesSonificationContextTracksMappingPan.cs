...
{
	public partial class DumbbellSeriesSonificationContextTracksMappingPan  : BaseObject
	{
		Hashtable h = new Hashtable();

		public DumbbellSeriesSonificationContextTracksMappingPan()
		{
			MapFunction = MapFunction_DefaultValue = DumbbellSeriesSonificationContextTracksMappingPanMapFunction.Linear;
			MapTo = MapTo_DefaultValue = "";
			Max = Max_DefaultValue = null;
			Min = Min_DefaultValue = null;
			Value = Value_DefaultValue = null;
			Within = Within_DefaultValue = DumbbellSeriesSonificationContextTracksMappingPanWithin.Chart;
		...
		/// </summary>
		public DumbbellSeriesSonificationContextTracksMappingPanMapFunction MapFunction { get; set; }
		private DumbbellSeriesSonificationContextTracksMappingPanMapFunction MapFunction_DefaultValue { get; set; }
		...
		/// </summary>
		public DumbbellSeriesSonificationContextTracksMappingPanWithin Within { get; set; }
		private DumbbellSeriesSonificationContextTracksMappingPanWithin Within_DefaultValue { get; set; }
