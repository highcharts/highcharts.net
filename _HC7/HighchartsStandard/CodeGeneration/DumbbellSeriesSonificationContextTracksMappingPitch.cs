...
{
	public partial class DumbbellSeriesSonificationContextTracksMappingPitch  : BaseObject
	{
		Hashtable h = new Hashtable();

		public DumbbellSeriesSonificationContextTracksMappingPitch()
		{
			MapFunction = MapFunction_DefaultValue = DumbbellSeriesSonificationContextTracksMappingPitchMapFunction.Linear;
		...
		/// </summary>
		public DumbbellSeriesSonificationContextTracksMappingPitchMapFunction MapFunction { get; set; }
		private DumbbellSeriesSonificationContextTracksMappingPitchMapFunction MapFunction_DefaultValue { get; set; }
