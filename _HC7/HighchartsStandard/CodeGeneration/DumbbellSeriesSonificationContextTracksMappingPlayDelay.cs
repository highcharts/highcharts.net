...
{
	public partial class DumbbellSeriesSonificationContextTracksMappingPlayDelay  : BaseObject
	{
		Hashtable h = new Hashtable();

		public DumbbellSeriesSonificationContextTracksMappingPlayDelay()
		{
			MapFunction = MapFunction_DefaultValue = DumbbellSeriesSonificationContextTracksMappingPlayDelayMapFunction.Linear;
			MapTo = MapTo_DefaultValue = "";
			Max = Max_DefaultValue = null;
			Min = Min_DefaultValue = null;
			Value = Value_DefaultValue = null;
			Within = Within_DefaultValue = DumbbellSeriesSonificationContextTracksMappingPlayDelayWithin.Chart;
		...
		/// </summary>
		public DumbbellSeriesSonificationContextTracksMappingPlayDelayMapFunction MapFunction { get; set; }
		private DumbbellSeriesSonificationContextTracksMappingPlayDelayMapFunction MapFunction_DefaultValue { get; set; }
		...
		/// </summary>
		public DumbbellSeriesSonificationContextTracksMappingPlayDelayWithin Within { get; set; }
		private DumbbellSeriesSonificationContextTracksMappingPlayDelayWithin Within_DefaultValue { get; set; }
