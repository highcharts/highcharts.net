...
{
	public partial class DumbbellSeriesSonificationContextTracksMappingTime  : BaseObject
	{
		Hashtable h = new Hashtable();

		public DumbbellSeriesSonificationContextTracksMappingTime()
		{
			MapFunction = MapFunction_DefaultValue = DumbbellSeriesSonificationContextTracksMappingTimeMapFunction.Linear;
			MapTo = MapTo_DefaultValue = "";
			Max = Max_DefaultValue = null;
			Min = Min_DefaultValue = null;
			Value = Value_DefaultValue = null;
			Within = Within_DefaultValue = DumbbellSeriesSonificationContextTracksMappingTimeWithin.Chart;
		...
		/// </summary>
		public DumbbellSeriesSonificationContextTracksMappingTimeMapFunction MapFunction { get; set; }
		private DumbbellSeriesSonificationContextTracksMappingTimeMapFunction MapFunction_DefaultValue { get; set; }
		...
		/// </summary>
		public DumbbellSeriesSonificationContextTracksMappingTimeWithin Within { get; set; }
		private DumbbellSeriesSonificationContextTracksMappingTimeWithin Within_DefaultValue { get; set; }
