...
{
	public partial class DumbbellSeriesSonificationContextTracksPointGrouping  : BaseObject
	{
		Hashtable h = new Hashtable();

		public DumbbellSeriesSonificationContextTracksPointGrouping()
		{
		...
		/// </summary>
		public DumbbellSeriesSonificationContextTracksPointGroupingAlgorithm Algorithm { get; set; }
		private DumbbellSeriesSonificationContextTracksPointGroupingAlgorithm Algorithm_DefaultValue { get; set; }
		...
		internal override Hashtable ToHashtable(Highcharts highcharts)
		{
			...
			if (Algorithm != DumbbellSeriesSonificationContextTracksPointGroupingAlgorithm.Null) h.Add("algorithm", highcharts.FirstCharacterToLower(Algorithm.ToString()));
