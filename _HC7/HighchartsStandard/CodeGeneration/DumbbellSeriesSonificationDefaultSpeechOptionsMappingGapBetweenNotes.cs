...
{
	public partial class DumbbellSeriesSonificationDefaultSpeechOptionsMappingGapBetweenNotes  : BaseObject
	{
		Hashtable h = new Hashtable();

		public DumbbellSeriesSonificationDefaultSpeechOptionsMappingGapBetweenNotes()
		{
			MapFunction = MapFunction_DefaultValue = DumbbellSeriesSonificationDefaultSpeechOptionsMappingGapBetweenNotesMapFunction.Linear;
			MapTo = MapTo_DefaultValue = "";
			Max = Max_DefaultValue = null;
			Min = Min_DefaultValue = null;
			Value = Value_DefaultValue = null;
			Within = Within_DefaultValue = DumbbellSeriesSonificationDefaultSpeechOptionsMappingGapBetweenNotesWithin.Chart;
		...
		/// </summary>
		public DumbbellSeriesSonificationDefaultSpeechOptionsMappingGapBetweenNotesMapFunction MapFunction { get; set; }
		private DumbbellSeriesSonificationDefaultSpeechOptionsMappingGapBetweenNotesMapFunction MapFunction_DefaultValue { get; set; }
		...
		/// </summary>
		public DumbbellSeriesSonificationDefaultSpeechOptionsMappingGapBetweenNotesWithin Within { get; set; }
		private DumbbellSeriesSonificationDefaultSpeechOptionsMappingGapBetweenNotesWithin Within_DefaultValue { get; set; }
