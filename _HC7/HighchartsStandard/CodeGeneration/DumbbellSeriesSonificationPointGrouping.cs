...
{
	public partial class DumbbellSeriesSonificationPointGrouping  : BaseObject
	{
		Hashtable h = new Hashtable();

		public DumbbellSeriesSonificationPointGrouping()
		{
		...
		/// </summary>
		public DumbbellSeriesSonificationPointGroupingAlgorithm Algorithm { get; set; }
		private DumbbellSeriesSonificationPointGroupingAlgorithm Algorithm_DefaultValue { get; set; }
		...
		internal override Hashtable ToHashtable(Highcharts highcharts)
		{
			...
			if (Algorithm != DumbbellSeriesSonificationPointGroupingAlgorithm.Null) h.Add("algorithm", highcharts.FirstCharacterToLower(Algorithm.ToString()));
