...
{
	public partial class DumbbellSeriesSonificationTracksMappingFrequency  : BaseObject
	{
		Hashtable h = new Hashtable();

		public DumbbellSeriesSonificationTracksMappingFrequency()
		{
			MapFunction = MapFunction_DefaultValue = DumbbellSeriesSonificationTracksMappingFrequencyMapFunction.Linear;
			MapTo = MapTo_DefaultValue = "";
			Max = Max_DefaultValue = null;
			Min = Min_DefaultValue = null;
			Value = Value_DefaultValue = null;
			Within = Within_DefaultValue = DumbbellSeriesSonificationTracksMappingFrequencyWithin.Chart;
		...
		/// </summary>
		public DumbbellSeriesSonificationTracksMappingFrequencyMapFunction MapFunction { get; set; }
		private DumbbellSeriesSonificationTracksMappingFrequencyMapFunction MapFunction_DefaultValue { get; set; }
		...
		/// </summary>
		public DumbbellSeriesSonificationTracksMappingFrequencyWithin Within { get; set; }
		private DumbbellSeriesSonificationTracksMappingFrequencyWithin Within_DefaultValue { get; set; }
