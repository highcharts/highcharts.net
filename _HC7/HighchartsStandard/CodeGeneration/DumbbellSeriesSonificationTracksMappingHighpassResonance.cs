...
{
	public partial class DumbbellSeriesSonificationTracksMappingHighpassResonance  : BaseObject
	{
		Hashtable h = new Hashtable();

		public DumbbellSeriesSonificationTracksMappingHighpassResonance()
		{
			MapFunction = MapFunction_DefaultValue = DumbbellSeriesSonificationTracksMappingHighpassResonanceMapFunction.Linear;
			MapTo = MapTo_DefaultValue = "";
			Max = Max_DefaultValue = null;
			Min = Min_DefaultValue = null;
			Value = Value_DefaultValue = null;
			Within = Within_DefaultValue = DumbbellSeriesSonificationTracksMappingHighpassResonanceWithin.Chart;
		...
		/// </summary>
		public DumbbellSeriesSonificationTracksMappingHighpassResonanceMapFunction MapFunction { get; set; }
		private DumbbellSeriesSonificationTracksMappingHighpassResonanceMapFunction MapFunction_DefaultValue { get; set; }
		...
		/// </summary>
		public DumbbellSeriesSonificationTracksMappingHighpassResonanceWithin Within { get; set; }
		private DumbbellSeriesSonificationTracksMappingHighpassResonanceWithin Within_DefaultValue { get; set; }
