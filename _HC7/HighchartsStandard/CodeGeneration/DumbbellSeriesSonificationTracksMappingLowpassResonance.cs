...
{
	public partial class DumbbellSeriesSonificationTracksMappingLowpassResonance  : BaseObject
	{
		Hashtable h = new Hashtable();

		public DumbbellSeriesSonificationTracksMappingLowpassResonance()
		{
			MapFunction = MapFunction_DefaultValue = DumbbellSeriesSonificationTracksMappingLowpassResonanceMapFunction.Linear;
			MapTo = MapTo_DefaultValue = "";
			Max = Max_DefaultValue = null;
			Min = Min_DefaultValue = null;
			Value = Value_DefaultValue = null;
			Within = Within_DefaultValue = DumbbellSeriesSonificationTracksMappingLowpassResonanceWithin.Chart;
		...
		/// </summary>
		public DumbbellSeriesSonificationTracksMappingLowpassResonanceMapFunction MapFunction { get; set; }
		private DumbbellSeriesSonificationTracksMappingLowpassResonanceMapFunction MapFunction_DefaultValue { get; set; }
		...
		/// </summary>
		public DumbbellSeriesSonificationTracksMappingLowpassResonanceWithin Within { get; set; }
		private DumbbellSeriesSonificationTracksMappingLowpassResonanceWithin Within_DefaultValue { get; set; }
