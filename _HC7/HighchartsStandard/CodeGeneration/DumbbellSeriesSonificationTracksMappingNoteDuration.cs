...
{
	public partial class DumbbellSeriesSonificationTracksMappingNoteDuration  : BaseObject
	{
		Hashtable h = new Hashtable();

		public DumbbellSeriesSonificationTracksMappingNoteDuration()
		{
			MapFunction = MapFunction_DefaultValue = DumbbellSeriesSonificationTracksMappingNoteDurationMapFunction.Linear;
			MapTo = MapTo_DefaultValue = "";
			Max = Max_DefaultValue = null;
			Min = Min_DefaultValue = null;
			Value = Value_DefaultValue = null;
			Within = Within_DefaultValue = DumbbellSeriesSonificationTracksMappingNoteDurationWithin.Chart;
		...
		/// </summary>
		public DumbbellSeriesSonificationTracksMappingNoteDurationMapFunction MapFunction { get; set; }
		private DumbbellSeriesSonificationTracksMappingNoteDurationMapFunction MapFunction_DefaultValue { get; set; }
		...
		/// </summary>
		public DumbbellSeriesSonificationTracksMappingNoteDurationWithin Within { get; set; }
		private DumbbellSeriesSonificationTracksMappingNoteDurationWithin Within_DefaultValue { get; set; }
