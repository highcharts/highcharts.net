...
{
	public partial class DumbbellSeriesSonificationTracksMappingPan  : BaseObject
	{
		Hashtable h = new Hashtable();

		public DumbbellSeriesSonificationTracksMappingPan()
		{
			MapFunction = MapFunction_DefaultValue = DumbbellSeriesSonificationTracksMappingPanMapFunction.Linear;
			MapTo = MapTo_DefaultValue = "";
			Max = Max_DefaultValue = null;
			Min = Min_DefaultValue = null;
			Value = Value_DefaultValue = null;
			Within = Within_DefaultValue = DumbbellSeriesSonificationTracksMappingPanWithin.Chart;
		...
		/// </summary>
		public DumbbellSeriesSonificationTracksMappingPanMapFunction MapFunction { get; set; }
		private DumbbellSeriesSonificationTracksMappingPanMapFunction MapFunction_DefaultValue { get; set; }
		...
		/// </summary>
		public DumbbellSeriesSonificationTracksMappingPanWithin Within { get; set; }
		private DumbbellSeriesSonificationTracksMappingPanWithin Within_DefaultValue { get; set; }
