...
{
	public partial class DumbbellSeriesSonificationTracksMappingPitch  : BaseObject
	{
		Hashtable h = new Hashtable();

		public DumbbellSeriesSonificationTracksMappingPitch()
		{
			MapFunction = MapFunction_DefaultValue = DumbbellSeriesSonificationTracksMappingPitchMapFunction.Linear;
		...
		/// </summary>
		public DumbbellSeriesSonificationTracksMappingPitchMapFunction MapFunction { get; set; }
		private DumbbellSeriesSonificationTracksMappingPitchMapFunction MapFunction_DefaultValue { get; set; }
