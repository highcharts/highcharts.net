...
{
	public partial class DumbbellSeriesSonificationTracksMappingPlayDelay  : BaseObject
	{
		Hashtable h = new Hashtable();

		public DumbbellSeriesSonificationTracksMappingPlayDelay()
		{
			MapFunction = MapFunction_DefaultValue = DumbbellSeriesSonificationTracksMappingPlayDelayMapFunction.Linear;
			MapTo = MapTo_DefaultValue = "";
			Max = Max_DefaultValue = null;
			Min = Min_DefaultValue = null;
			Value = Value_DefaultValue = null;
			Within = Within_DefaultValue = DumbbellSeriesSonificationTracksMappingPlayDelayWithin.Chart;
		...
		/// </summary>
		public DumbbellSeriesSonificationTracksMappingPlayDelayMapFunction MapFunction { get; set; }
		private DumbbellSeriesSonificationTracksMappingPlayDelayMapFunction MapFunction_DefaultValue { get; set; }
		...
		/// </summary>
		public DumbbellSeriesSonificationTracksMappingPlayDelayWithin Within { get; set; }
		private DumbbellSeriesSonificationTracksMappingPlayDelayWithin Within_DefaultValue { get; set; }
