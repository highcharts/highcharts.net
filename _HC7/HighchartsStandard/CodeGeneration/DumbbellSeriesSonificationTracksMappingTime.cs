...
{
	public partial class DumbbellSeriesSonificationTracksMappingTime  : BaseObject
	{
		Hashtable h = new Hashtable();

		public DumbbellSeriesSonificationTracksMappingTime()
		{
			MapFunction = MapFunction_DefaultValue = DumbbellSeriesSonificationTracksMappingTimeMapFunction.Linear;
			MapTo = MapTo_DefaultValue = "";
			Max = Max_DefaultValue = null;
			Min = Min_DefaultValue = null;
			Value = Value_DefaultValue = null;
			Within = Within_DefaultValue = DumbbellSeriesSonificationTracksMappingTimeWithin.Chart;
		...
		/// </summary>
		public DumbbellSeriesSonificationTracksMappingTimeMapFunction MapFunction { get; set; }
		private DumbbellSeriesSonificationTracksMappingTimeMapFunction MapFunction_DefaultValue { get; set; }
		...
		/// </summary>
		public DumbbellSeriesSonificationTracksMappingTimeWithin Within { get; set; }
		private DumbbellSeriesSonificationTracksMappingTimeWithin Within_DefaultValue { get; set; }
