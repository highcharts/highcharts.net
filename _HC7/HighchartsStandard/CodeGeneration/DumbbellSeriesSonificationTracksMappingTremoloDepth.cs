...
{
	public partial class DumbbellSeriesSonificationTracksMappingTremoloDepth  : BaseObject
	{
		Hashtable h = new Hashtable();

		public DumbbellSeriesSonificationTracksMappingTremoloDepth()
		{
			MapFunction = MapFunction_DefaultValue = DumbbellSeriesSonificationTracksMappingTremoloDepthMapFunction.Linear;
			MapTo = MapTo_DefaultValue = "";
			Max = Max_DefaultValue = null;
			Min = Min_DefaultValue = null;
			Value = Value_DefaultValue = null;
			Within = Within_DefaultValue = DumbbellSeriesSonificationTracksMappingTremoloDepthWithin.Chart;
		...
		/// </summary>
		public DumbbellSeriesSonificationTracksMappingTremoloDepthMapFunction MapFunction { get; set; }
		private DumbbellSeriesSonificationTracksMappingTremoloDepthMapFunction MapFunction_DefaultValue { get; set; }
		...
		/// </summary>
		public DumbbellSeriesSonificationTracksMappingTremoloDepthWithin Within { get; set; }
		private DumbbellSeriesSonificationTracksMappingTremoloDepthWithin Within_DefaultValue { get; set; }
