...
{
	public partial class DumbbellSeriesSonificationTracksMappingTremoloSpeed  : BaseObject
	{
		Hashtable h = new Hashtable();

		public DumbbellSeriesSonificationTracksMappingTremoloSpeed()
		{
			MapFunction = MapFunction_DefaultValue = DumbbellSeriesSonificationTracksMappingTremoloSpeedMapFunction.Linear;
			MapTo = MapTo_DefaultValue = "";
			Max = Max_DefaultValue = null;
			Min = Min_DefaultValue = null;
			Value = Value_DefaultValue = null;
			Within = Within_DefaultValue = DumbbellSeriesSonificationTracksMappingTremoloSpeedWithin.Chart;
		...
		/// </summary>
		public DumbbellSeriesSonificationTracksMappingTremoloSpeedMapFunction MapFunction { get; set; }
		private DumbbellSeriesSonificationTracksMappingTremoloSpeedMapFunction MapFunction_DefaultValue { get; set; }
		...
		/// </summary>
		public DumbbellSeriesSonificationTracksMappingTremoloSpeedWithin Within { get; set; }
		private DumbbellSeriesSonificationTracksMappingTremoloSpeedWithin Within_DefaultValue { get; set; }
