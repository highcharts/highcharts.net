...
{
	public partial class DumbbellSeriesSonificationTracksMappingVolume  : BaseObject
	{
		Hashtable h = new Hashtable();

		public DumbbellSeriesSonificationTracksMappingVolume()
		{
			MapFunction = MapFunction_DefaultValue = DumbbellSeriesSonificationTracksMappingVolumeMapFunction.Linear;
			MapTo = MapTo_DefaultValue = "";
			Max = Max_DefaultValue = null;
			Min = Min_DefaultValue = null;
			Value = Value_DefaultValue = null;
			Within = Within_DefaultValue = DumbbellSeriesSonificationTracksMappingVolumeWithin.Chart;
		...
		/// </summary>
		public DumbbellSeriesSonificationTracksMappingVolumeMapFunction MapFunction { get; set; }
		private DumbbellSeriesSonificationTracksMappingVolumeMapFunction MapFunction_DefaultValue { get; set; }
		...
		/// </summary>
		public DumbbellSeriesSonificationTracksMappingVolumeWithin Within { get; set; }
		private DumbbellSeriesSonificationTracksMappingVolumeWithin Within_DefaultValue { get; set; }
