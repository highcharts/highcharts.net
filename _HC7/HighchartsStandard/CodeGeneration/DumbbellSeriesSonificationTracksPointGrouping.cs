...
{
	public partial class DumbbellSeriesSonificationTracksPointGrouping  : BaseObject
	{
		Hashtable h = new Hashtable();

		public DumbbellSeriesSonificationTracksPointGrouping()
		{
		...
		/// </summary>
		public DumbbellSeriesSonificationTracksPointGroupingAlgorithm Algorithm { get; set; }
		private DumbbellSeriesSonificationTracksPointGroupingAlgorithm Algorithm_DefaultValue { get; set; }
		...
		internal override Hashtable ToHashtable(Highcharts highcharts)
		{
			...
			if (Algorithm != DumbbellSeriesSonificationTracksPointGroupingAlgorithm.Null) h.Add("algorithm", highcharts.FirstCharacterToLower(Algorithm.ToString()));
