...
{
	public partial class DumbbellSeriesStatesSelect  : BaseObject
	{
		Hashtable h = new Hashtable();

		public DumbbellSeriesStatesSelect()
		{
			Animation = Animation_DefaultValue = new Animation();
			Enabled = Enabled_DefaultValue = null;
			Halo = Halo_DefaultValue = new DumbbellSeriesStatesSelectHalo();
			LineWidth = LineWidth_DefaultValue = null;
			LineWidthPlus = LineWidthPlus_DefaultValue = null;
			Marker = Marker_DefaultValue = new DumbbellSeriesStatesSelectMarker();
		...
		/// </summary>
		public DumbbellSeriesStatesSelectHalo Halo { get; set; }
		private DumbbellSeriesStatesSelectHalo Halo_DefaultValue { get; set; }
		...
		/// </summary>
		public DumbbellSeriesStatesSelectMarker Marker { get; set; }
		private DumbbellSeriesStatesSelectMarker Marker_DefaultValue { get; set; }
