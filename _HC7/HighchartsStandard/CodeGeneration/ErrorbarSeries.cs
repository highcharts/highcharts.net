...
namespace Highsoft.Web.Mvc.Charts
{
	public partial class ErrorbarSeries  : Series
	{
		...
		/// </summary>
		public ErrorbarSeriesAccessibility Accessibility { get; set; }
		private ErrorbarSeriesAccessibility Accessibility_DefaultValue { get; set; }
		...
		/// </summary>
		public ErrorbarSeriesDataSorting DataSorting { get; set; }
		private ErrorbarSeriesDataSorting DataSorting_DefaultValue { get; set; }
		...
		/// </summary>
		public ErrorbarSeriesLegendSymbol LegendSymbol { get; set; }
		private ErrorbarSeriesLegendSymbol LegendSymbol_DefaultValue { get; set; }
		...
		/// </summary>
		public ErrorbarSeriesOnPoint OnPoint { get; set; }
		private ErrorbarSeriesOnPoint OnPoint_DefaultValue { get; set; }
		...
		/// </summary>
		public ErrorbarSeriesPointPlacement PointPlacement { get; set; }
		private ErrorbarSeriesPointPlacement PointPlacement_DefaultValue { get; set; }
		...
		/// </summary>
		public ErrorbarSeriesSonification Sonification { get; set; }
		private ErrorbarSeriesSonification Sonification_DefaultValue { get; set; }
		...
		internal override Hashtable ToHashtable(Highcharts highcharts)
		{
			...
			if (Cursor != ErrorbarSeriesCursor.Null) h.Add("cursor", highcharts.FirstCharacterToLower(Cursor.ToString()));
			if (Custom != null) h.Add("custom",Custom);
			if (DashStyle != ErrorbarSeriesDashStyle.Null) h.Add("dashStyle", highcharts.FirstCharacterToLower(DashStyle.ToString()));
			...
			if (FindNearestPointBy != ErrorbarSeriesFindNearestPointBy.Null) h.Add("findNearestPointBy", highcharts.FirstCharacterToLower(FindNearestPointBy.ToString()));
			...
			if (LegendSymbol != ErrorbarSeriesLegendSymbol.Null) h.Add("legendSymbol", highcharts.FirstCharacterToLower(LegendSymbol.ToString()));
			...
			if (PointIntervalUnit != ErrorbarSeriesPointIntervalUnit.Null) h.Add("pointIntervalUnit", highcharts.FirstCharacterToLower(PointIntervalUnit.ToString()));
			if (PointPadding != null) h.Add("pointPadding",PointPadding);
			if (PointPlacement != ErrorbarSeriesPointPlacement.Null) h.Add("pointPlacement", highcharts.FirstCharacterToLower(PointPlacement.ToString()));
