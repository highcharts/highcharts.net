...
namespace Highsoft.Web.Mvc.Charts
{
	public partial class ErrorbarSeries  : Series
	{
		...
		{
			Accessibility = Accessibility_DefaultValue = new ErrorbarSeriesAccessibility();
			...
			DashStyle = DashStyle_DefaultValue = ErrorbarSeriesDashStyle.Null;
			Data = Data_DefaultValue = new List<ErrorbarSeriesData>();
			DataLabels = DataLabels_DefaultValue = new ErrorbarSeriesDataLabels();
			DataSorting = DataSorting_DefaultValue = new ErrorbarSeriesDataSorting();
			Depth = Depth_DefaultValue = 25;
			Description = Description_DefaultValue = "";
			DragDrop = DragDrop_DefaultValue = new ErrorbarSeriesDragDrop();
			Dumbell = Dumbell_DefaultValue = new ErrorbarSeriesDumbell();
			...
			LegendSymbol = LegendSymbol_DefaultValue = ErrorbarSeriesLegendSymbol.Rectangle;
			...
			OnPoint = OnPoint_DefaultValue = new ErrorbarSeriesOnPoint();
			...
			Sonification = Sonification_DefaultValue = new ErrorbarSeriesSonification();
		...
		/// 
		/// </summary>
		public ErrorbarSeriesDumbell Dumbell { get; set; }
		private ErrorbarSeriesDumbell Dumbell_DefaultValue { get; set; }
