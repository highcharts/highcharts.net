...
namespace Highsoft.Web.Mvc.Charts
{
	public partial class ErrorbarSeries  : Series
	{
		...
		internal override Hashtable ToHashtable()
		{
			...
			if (PointDescriptionFormatter != PointDescriptionFormatter_DefaultValue) { h.Add("pointDescriptionFormatter",PointDescriptionFormatter); Highcharts.AddFunction("0292abd7-765f-4b6e-b5d3-6358353a8b31.pointDescriptionFormatter", PointDescriptionFormatter); }  
