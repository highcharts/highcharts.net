...
{
	public partial class ErrorbarSeriesDataDragDropDragHandle  : BaseObject
	{
		public ErrorbarSeriesDataDragDropDragHandle()
		{
		...
		internal override Hashtable ToHashtable()
		{
			...
			if (PathFormatter != PathFormatter_DefaultValue) { h.Add("pathFormatter",PathFormatter); Highcharts.AddFunction("ErrorbarSeriesDataDragDropDragHandlePathFormatter.pathFormatter", PathFormatter); }  
