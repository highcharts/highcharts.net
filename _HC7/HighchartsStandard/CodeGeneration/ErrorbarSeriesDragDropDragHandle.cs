...
{
	public partial class ErrorbarSeriesDragDropDragHandle  : BaseObject
	{
		public ErrorbarSeriesDragDropDragHandle()
		{
		...
		internal override Hashtable ToHashtable()
		{
			...
			if (PathFormatter != PathFormatter_DefaultValue) { h.Add("pathFormatter",PathFormatter); Highcharts.AddFunction("ErrorbarSeriesDragDropDragHandlePathFormatter.pathFormatter", PathFormatter); }  
