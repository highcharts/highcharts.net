...
{
	public partial class ErrorbarSeriesSonificationContextTracksMapping  : BaseObject
	{
		Hashtable h = new Hashtable();

		public ErrorbarSeriesSonificationContextTracksMapping()
		{
			Frequency = Frequency_DefaultValue = new ErrorbarSeriesSonificationContextTracksMappingFrequency();
			GapBetweenNotes = GapBetweenNotes_DefaultValue = new ErrorbarSeriesSonificationContextTracksMappingGapBetweenNotes();
			Highpass = Highpass_DefaultValue = new ErrorbarSeriesSonificationContextTracksMappingHighpass();
			Lowpass = Lowpass_DefaultValue = new ErrorbarSeriesSonificationContextTracksMappingLowpass();
			NoteDuration = NoteDuration_DefaultValue = new ErrorbarSeriesSonificationContextTracksMappingNoteDuration();
			Pan = Pan_DefaultValue = new ErrorbarSeriesSonificationContextTracksMappingPan();
			Pitch = Pitch_DefaultValue = new ErrorbarSeriesSonificationContextTracksMappingPitch();
			PitchString = PitchString_DefaultValue = "null";
			PitchNumber = PitchNumber_DefaultValue = null;
			PlayDelay = PlayDelay_DefaultValue = new ErrorbarSeriesSonificationContextTracksMappingPlayDelay();
			Time = Time_DefaultValue = new ErrorbarSeriesSonificationContextTracksMappingTime();
			TimeString = TimeString_DefaultValue = "null";
			TimeNumber = TimeNumber_DefaultValue = null;
			Tremolo = Tremolo_DefaultValue = new ErrorbarSeriesSonificationContextTracksMappingTremolo();
			Volume = Volume_DefaultValue = new ErrorbarSeriesSonificationContextTracksMappingVolume();
		...
		/// </summary>
		public ErrorbarSeriesSonificationContextTracksMappingFrequency Frequency { get; set; }
		private ErrorbarSeriesSonificationContextTracksMappingFrequency Frequency_DefaultValue { get; set; }
		...
		/// </summary>
		public ErrorbarSeriesSonificationContextTracksMappingGapBetweenNotes GapBetweenNotes { get; set; }
		private ErrorbarSeriesSonificationContextTracksMappingGapBetweenNotes GapBetweenNotes_DefaultValue { get; set; }
		...
		/// </summary>
		public ErrorbarSeriesSonificationContextTracksMappingHighpass Highpass { get; set; }
		private ErrorbarSeriesSonificationContextTracksMappingHighpass Highpass_DefaultValue { get; set; }
		...
		/// </summary>
		public ErrorbarSeriesSonificationContextTracksMappingLowpass Lowpass { get; set; }
		private ErrorbarSeriesSonificationContextTracksMappingLowpass Lowpass_DefaultValue { get; set; }
		...
		/// </summary>
		public ErrorbarSeriesSonificationContextTracksMappingNoteDuration NoteDuration { get; set; }
		private ErrorbarSeriesSonificationContextTracksMappingNoteDuration NoteDuration_DefaultValue { get; set; }
		...
		/// </summary>
		public ErrorbarSeriesSonificationContextTracksMappingPan Pan { get; set; }
		private ErrorbarSeriesSonificationContextTracksMappingPan Pan_DefaultValue { get; set; }
		...
		/// </summary>
		public ErrorbarSeriesSonificationContextTracksMappingPitch Pitch { get; set; }
		private ErrorbarSeriesSonificationContextTracksMappingPitch Pitch_DefaultValue { get; set; }
		...
		/// </summary>
		public ErrorbarSeriesSonificationContextTracksMappingPlayDelay PlayDelay { get; set; }
		private ErrorbarSeriesSonificationContextTracksMappingPlayDelay PlayDelay_DefaultValue { get; set; }
		...
		/// </summary>
		public ErrorbarSeriesSonificationContextTracksMappingTime Time { get; set; }
		private ErrorbarSeriesSonificationContextTracksMappingTime Time_DefaultValue { get; set; }
		...
		/// </summary>
		public ErrorbarSeriesSonificationContextTracksMappingTremolo Tremolo { get; set; }
		private ErrorbarSeriesSonificationContextTracksMappingTremolo Tremolo_DefaultValue { get; set; }
		 

		/// <summary>
		/// The volume of notes, from 0 to 1.
		/// </summary>
		public ErrorbarSeriesSonificationContextTracksMappingVolume Volume { get; set; }
		private ErrorbarSeriesSonificationContextTracksMappingVolume Volume_DefaultValue { get; set; }
