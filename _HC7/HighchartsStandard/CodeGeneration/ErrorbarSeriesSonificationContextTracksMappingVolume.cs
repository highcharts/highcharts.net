...
{
	public partial class ErrorbarSeriesSonificationContextTracksMappingVolume  : BaseObject
	{
		Hashtable h = new Hashtable();

		public ErrorbarSeriesSonificationContextTracksMappingVolume()
		{
			MapFunction = MapFunction_DefaultValue = ErrorbarSeriesSonificationContextTracksMappingVolumeMapFunction.Linear;
			MapTo = MapTo_DefaultValue = "";
			Max = Max_DefaultValue = null;
			Min = Min_DefaultValue = null;
			Value = Value_DefaultValue = null;
			Within = Within_DefaultValue = ErrorbarSeriesSonificationContextTracksMappingVolumeWithin.Chart;
		...
		/// </summary>
		public ErrorbarSeriesSonificationContextTracksMappingVolumeMapFunction MapFunction { get; set; }
		private ErrorbarSeriesSonificationContextTracksMappingVolumeMapFunction MapFunction_DefaultValue { get; set; }
		...
		/// </summary>
		public ErrorbarSeriesSonificationContextTracksMappingVolumeWithin Within { get; set; }
		private ErrorbarSeriesSonificationContextTracksMappingVolumeWithin Within_DefaultValue { get; set; }
