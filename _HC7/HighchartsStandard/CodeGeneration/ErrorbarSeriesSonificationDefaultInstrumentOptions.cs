...
{
	public partial class ErrorbarSeriesSonificationDefaultInstrumentOptions  : BaseObject
	{
		Hashtable h = new Hashtable();

		public ErrorbarSeriesSonificationDefaultInstrumentOptions()
		{
			ActiveWhen = ActiveWhen_DefaultValue = new ErrorbarSeriesSonificationDefaultInstrumentOptionsActiveWhen();
			Instrument = Instrument_DefaultValue = null;
			InstrumentString = InstrumentString_DefaultValue = "null";
			Mapping = Mapping_DefaultValue = new ErrorbarSeriesSonificationDefaultInstrumentOptionsMapping();
			MidiName = MidiName_DefaultValue = "";
			PointGrouping = PointGrouping_DefaultValue = new ErrorbarSeriesSonificationDefaultInstrumentOptionsPointGrouping();
			RoundToMusicalNotes = RoundToMusicalNotes_DefaultValue = true;
			ShowPlayMarker = ShowPlayMarker_DefaultValue = true;
			Type = Type_DefaultValue = ErrorbarSeriesSonificationDefaultInstrumentOptionsType.Instrument;
		...
		/// </summary>
		public ErrorbarSeriesSonificationDefaultInstrumentOptionsActiveWhen ActiveWhen { get; set; }
		private ErrorbarSeriesSonificationDefaultInstrumentOptionsActiveWhen ActiveWhen_DefaultValue { get; set; }
		...
		/// </summary>
		public ErrorbarSeriesSonificationDefaultInstrumentOptionsMapping Mapping { get; set; }
		private ErrorbarSeriesSonificationDefaultInstrumentOptionsMapping Mapping_DefaultValue { get; set; }
		...
		/// </summary>
		public ErrorbarSeriesSonificationDefaultInstrumentOptionsPointGrouping PointGrouping { get; set; }
		private ErrorbarSeriesSonificationDefaultInstrumentOptionsPointGrouping PointGrouping_DefaultValue { get; set; }
		...
		/// </summary>
		public ErrorbarSeriesSonificationDefaultInstrumentOptionsType Type { get; set; }
		private ErrorbarSeriesSonificationDefaultInstrumentOptionsType Type_DefaultValue { get; set; }
