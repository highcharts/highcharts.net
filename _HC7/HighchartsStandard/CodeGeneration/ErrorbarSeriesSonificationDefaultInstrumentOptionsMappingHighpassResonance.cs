...
{
	public partial class ErrorbarSeriesSonificationDefaultInstrumentOptionsMappingHighpassResonance  : BaseObject
	{
		Hashtable h = new Hashtable();

		public ErrorbarSeriesSonificationDefaultInstrumentOptionsMappingHighpassResonance()
		{
			MapFunction = MapFunction_DefaultValue = ErrorbarSeriesSonificationDefaultInstrumentOptionsMappingHighpassResonanceMapFunction.Linear;
			MapTo = MapTo_DefaultValue = "";
			Max = Max_DefaultValue = null;
			Min = Min_DefaultValue = null;
			Value = Value_DefaultValue = null;
			Within = Within_DefaultValue = ErrorbarSeriesSonificationDefaultInstrumentOptionsMappingHighpassResonanceWithin.Chart;
		...
		/// </summary>
		public ErrorbarSeriesSonificationDefaultInstrumentOptionsMappingHighpassResonanceMapFunction MapFunction { get; set; }
		private ErrorbarSeriesSonificationDefaultInstrumentOptionsMappingHighpassResonanceMapFunction MapFunction_DefaultValue { get; set; }
		...
		/// </summary>
		public ErrorbarSeriesSonificationDefaultInstrumentOptionsMappingHighpassResonanceWithin Within { get; set; }
		private ErrorbarSeriesSonificationDefaultInstrumentOptionsMappingHighpassResonanceWithin Within_DefaultValue { get; set; }
