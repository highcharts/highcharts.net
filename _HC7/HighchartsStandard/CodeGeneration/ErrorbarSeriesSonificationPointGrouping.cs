...
{
	public partial class ErrorbarSeriesSonificationPointGrouping  : BaseObject
	{
		Hashtable h = new Hashtable();

		public ErrorbarSeriesSonificationPointGrouping()
		{
		...
		/// </summary>
		public ErrorbarSeriesSonificationPointGroupingAlgorithm Algorithm { get; set; }
		private ErrorbarSeriesSonificationPointGroupingAlgorithm Algorithm_DefaultValue { get; set; }
		...
		internal override Hashtable ToHashtable(Highcharts highcharts)
		{
			...
			if (Algorithm != ErrorbarSeriesSonificationPointGroupingAlgorithm.Null) h.Add("algorithm", highcharts.FirstCharacterToLower(Algorithm.ToString()));
