...
{
	public partial class ErrorbarSeriesSonificationTracksMapping  : BaseObject
	{
		Hashtable h = new Hashtable();

		public ErrorbarSeriesSonificationTracksMapping()
		{
			Frequency = Frequency_DefaultValue = new ErrorbarSeriesSonificationTracksMappingFrequency();
			GapBetweenNotes = GapBetweenNotes_DefaultValue = new ErrorbarSeriesSonificationTracksMappingGapBetweenNotes();
			Highpass = Highpass_DefaultValue = new ErrorbarSeriesSonificationTracksMappingHighpass();
			Lowpass = Lowpass_DefaultValue = new ErrorbarSeriesSonificationTracksMappingLowpass();
			NoteDuration = NoteDuration_DefaultValue = new ErrorbarSeriesSonificationTracksMappingNoteDuration();
			Pan = Pan_DefaultValue = new ErrorbarSeriesSonificationTracksMappingPan();
			Pitch = Pitch_DefaultValue = new ErrorbarSeriesSonificationTracksMappingPitch();
			PitchString = PitchString_DefaultValue = "null";
			PitchNumber = PitchNumber_DefaultValue = null;
			PlayDelay = PlayDelay_DefaultValue = new ErrorbarSeriesSonificationTracksMappingPlayDelay();
			Time = Time_DefaultValue = new ErrorbarSeriesSonificationTracksMappingTime();
			TimeString = TimeString_DefaultValue = "null";
			TimeNumber = TimeNumber_DefaultValue = null;
			Tremolo = Tremolo_DefaultValue = new ErrorbarSeriesSonificationTracksMappingTremolo();
			Volume = Volume_DefaultValue = new ErrorbarSeriesSonificationTracksMappingVolume();
		...
		/// </summary>
		public ErrorbarSeriesSonificationTracksMappingFrequency Frequency { get; set; }
		private ErrorbarSeriesSonificationTracksMappingFrequency Frequency_DefaultValue { get; set; }
		...
		/// </summary>
		public ErrorbarSeriesSonificationTracksMappingGapBetweenNotes GapBetweenNotes { get; set; }
		private ErrorbarSeriesSonificationTracksMappingGapBetweenNotes GapBetweenNotes_DefaultValue { get; set; }
		...
		/// </summary>
		public ErrorbarSeriesSonificationTracksMappingHighpass Highpass { get; set; }
		private ErrorbarSeriesSonificationTracksMappingHighpass Highpass_DefaultValue { get; set; }
		...
		/// </summary>
		public ErrorbarSeriesSonificationTracksMappingLowpass Lowpass { get; set; }
		private ErrorbarSeriesSonificationTracksMappingLowpass Lowpass_DefaultValue { get; set; }
		...
		/// </summary>
		public ErrorbarSeriesSonificationTracksMappingNoteDuration NoteDuration { get; set; }
		private ErrorbarSeriesSonificationTracksMappingNoteDuration NoteDuration_DefaultValue { get; set; }
		...
		/// </summary>
		public ErrorbarSeriesSonificationTracksMappingPan Pan { get; set; }
		private ErrorbarSeriesSonificationTracksMappingPan Pan_DefaultValue { get; set; }
		...
		/// </summary>
		public ErrorbarSeriesSonificationTracksMappingPitch Pitch { get; set; }
		private ErrorbarSeriesSonificationTracksMappingPitch Pitch_DefaultValue { get; set; }
		...
		/// </summary>
		public ErrorbarSeriesSonificationTracksMappingPlayDelay PlayDelay { get; set; }
		private ErrorbarSeriesSonificationTracksMappingPlayDelay PlayDelay_DefaultValue { get; set; }
		...
		/// </summary>
		public ErrorbarSeriesSonificationTracksMappingTime Time { get; set; }
		private ErrorbarSeriesSonificationTracksMappingTime Time_DefaultValue { get; set; }
		...
		/// </summary>
		public ErrorbarSeriesSonificationTracksMappingTremolo Tremolo { get; set; }
		private ErrorbarSeriesSonificationTracksMappingTremolo Tremolo_DefaultValue { get; set; }
		 

		/// <summary>
		/// The volume of notes, from 0 to 1.
		/// </summary>
		public ErrorbarSeriesSonificationTracksMappingVolume Volume { get; set; }
		private ErrorbarSeriesSonificationTracksMappingVolume Volume_DefaultValue { get; set; }
