...
{
	public partial class ErrorbarSeriesSonificationTracksMappingFrequency  : BaseObject
	{
		Hashtable h = new Hashtable();

		public ErrorbarSeriesSonificationTracksMappingFrequency()
		{
			MapFunction = MapFunction_DefaultValue = ErrorbarSeriesSonificationTracksMappingFrequencyMapFunction.Linear;
			MapTo = MapTo_DefaultValue = "";
			Max = Max_DefaultValue = null;
			Min = Min_DefaultValue = null;
			Value = Value_DefaultValue = null;
			Within = Within_DefaultValue = ErrorbarSeriesSonificationTracksMappingFrequencyWithin.Chart;
		...
		/// </summary>
		public ErrorbarSeriesSonificationTracksMappingFrequencyMapFunction MapFunction { get; set; }
		private ErrorbarSeriesSonificationTracksMappingFrequencyMapFunction MapFunction_DefaultValue { get; set; }
		...
		/// </summary>
		public ErrorbarSeriesSonificationTracksMappingFrequencyWithin Within { get; set; }
		private ErrorbarSeriesSonificationTracksMappingFrequencyWithin Within_DefaultValue { get; set; }
