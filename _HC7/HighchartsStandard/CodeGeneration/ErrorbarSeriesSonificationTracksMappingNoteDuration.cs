...
{
	public partial class ErrorbarSeriesSonificationTracksMappingNoteDuration  : BaseObject
	{
		Hashtable h = new Hashtable();

		public ErrorbarSeriesSonificationTracksMappingNoteDuration()
		{
			MapFunction = MapFunction_DefaultValue = ErrorbarSeriesSonificationTracksMappingNoteDurationMapFunction.Linear;
			MapTo = MapTo_DefaultValue = "";
			Max = Max_DefaultValue = null;
			Min = Min_DefaultValue = null;
			Value = Value_DefaultValue = null;
			Within = Within_DefaultValue = ErrorbarSeriesSonificationTracksMappingNoteDurationWithin.Chart;
		...
		/// </summary>
		public ErrorbarSeriesSonificationTracksMappingNoteDurationMapFunction MapFunction { get; set; }
		private ErrorbarSeriesSonificationTracksMappingNoteDurationMapFunction MapFunction_DefaultValue { get; set; }
		...
		/// </summary>
		public ErrorbarSeriesSonificationTracksMappingNoteDurationWithin Within { get; set; }
		private ErrorbarSeriesSonificationTracksMappingNoteDurationWithin Within_DefaultValue { get; set; }
