...
{
	public partial class ErrorbarSeriesSonificationTracksMappingPan  : BaseObject
	{
		Hashtable h = new Hashtable();

		public ErrorbarSeriesSonificationTracksMappingPan()
		{
			MapFunction = MapFunction_DefaultValue = ErrorbarSeriesSonificationTracksMappingPanMapFunction.Linear;
			MapTo = MapTo_DefaultValue = "";
			Max = Max_DefaultValue = null;
			Min = Min_DefaultValue = null;
			Value = Value_DefaultValue = null;
			Within = Within_DefaultValue = ErrorbarSeriesSonificationTracksMappingPanWithin.Chart;
		...
		/// </summary>
		public ErrorbarSeriesSonificationTracksMappingPanMapFunction MapFunction { get; set; }
		private ErrorbarSeriesSonificationTracksMappingPanMapFunction MapFunction_DefaultValue { get; set; }
		...
		/// </summary>
		public ErrorbarSeriesSonificationTracksMappingPanWithin Within { get; set; }
		private ErrorbarSeriesSonificationTracksMappingPanWithin Within_DefaultValue { get; set; }
