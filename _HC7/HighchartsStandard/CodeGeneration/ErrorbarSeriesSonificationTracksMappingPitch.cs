...
{
	public partial class ErrorbarSeriesSonificationTracksMappingPitch  : BaseObject
	{
		Hashtable h = new Hashtable();

		public ErrorbarSeriesSonificationTracksMappingPitch()
		{
			MapFunction = MapFunction_DefaultValue = ErrorbarSeriesSonificationTracksMappingPitchMapFunction.Linear;
		...
		/// </summary>
		public ErrorbarSeriesSonificationTracksMappingPitchMapFunction MapFunction { get; set; }
		private ErrorbarSeriesSonificationTracksMappingPitchMapFunction MapFunction_DefaultValue { get; set; }
