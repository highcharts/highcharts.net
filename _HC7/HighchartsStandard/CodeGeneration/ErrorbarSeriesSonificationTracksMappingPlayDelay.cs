...
{
	public partial class ErrorbarSeriesSonificationTracksMappingPlayDelay  : BaseObject
	{
		Hashtable h = new Hashtable();

		public ErrorbarSeriesSonificationTracksMappingPlayDelay()
		{
			MapFunction = MapFunction_DefaultValue = ErrorbarSeriesSonificationTracksMappingPlayDelayMapFunction.Linear;
			MapTo = MapTo_DefaultValue = "";
			Max = Max_DefaultValue = null;
			Min = Min_DefaultValue = null;
			Value = Value_DefaultValue = null;
			Within = Within_DefaultValue = ErrorbarSeriesSonificationTracksMappingPlayDelayWithin.Chart;
		...
		/// </summary>
		public ErrorbarSeriesSonificationTracksMappingPlayDelayMapFunction MapFunction { get; set; }
		private ErrorbarSeriesSonificationTracksMappingPlayDelayMapFunction MapFunction_DefaultValue { get; set; }
		...
		/// </summary>
		public ErrorbarSeriesSonificationTracksMappingPlayDelayWithin Within { get; set; }
		private ErrorbarSeriesSonificationTracksMappingPlayDelayWithin Within_DefaultValue { get; set; }
