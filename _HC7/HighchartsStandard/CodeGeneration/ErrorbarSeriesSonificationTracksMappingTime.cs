...
{
	public partial class ErrorbarSeriesSonificationTracksMappingTime  : BaseObject
	{
		Hashtable h = new Hashtable();

		public ErrorbarSeriesSonificationTracksMappingTime()
		{
			MapFunction = MapFunction_DefaultValue = ErrorbarSeriesSonificationTracksMappingTimeMapFunction.Linear;
			MapTo = MapTo_DefaultValue = "";
			Max = Max_DefaultValue = null;
			Min = Min_DefaultValue = null;
			Value = Value_DefaultValue = null;
			Within = Within_DefaultValue = ErrorbarSeriesSonificationTracksMappingTimeWithin.Chart;
		...
		/// </summary>
		public ErrorbarSeriesSonificationTracksMappingTimeMapFunction MapFunction { get; set; }
		private ErrorbarSeriesSonificationTracksMappingTimeMapFunction MapFunction_DefaultValue { get; set; }
		...
		/// </summary>
		public ErrorbarSeriesSonificationTracksMappingTimeWithin Within { get; set; }
		private ErrorbarSeriesSonificationTracksMappingTimeWithin Within_DefaultValue { get; set; }
