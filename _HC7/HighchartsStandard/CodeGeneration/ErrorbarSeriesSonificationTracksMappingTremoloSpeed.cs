...
{
	public partial class ErrorbarSeriesSonificationTracksMappingTremoloSpeed  : BaseObject
	{
		Hashtable h = new Hashtable();

		public ErrorbarSeriesSonificationTracksMappingTremoloSpeed()
		{
			MapFunction = MapFunction_DefaultValue = ErrorbarSeriesSonificationTracksMappingTremoloSpeedMapFunction.Linear;
			MapTo = MapTo_DefaultValue = "";
			Max = Max_DefaultValue = null;
			Min = Min_DefaultValue = null;
			Value = Value_DefaultValue = null;
			Within = Within_DefaultValue = ErrorbarSeriesSonificationTracksMappingTremoloSpeedWithin.Chart;
		...
		/// </summary>
		public ErrorbarSeriesSonificationTracksMappingTremoloSpeedMapFunction MapFunction { get; set; }
		private ErrorbarSeriesSonificationTracksMappingTremoloSpeedMapFunction MapFunction_DefaultValue { get; set; }
		...
		/// </summary>
		public ErrorbarSeriesSonificationTracksMappingTremoloSpeedWithin Within { get; set; }
		private ErrorbarSeriesSonificationTracksMappingTremoloSpeedWithin Within_DefaultValue { get; set; }
