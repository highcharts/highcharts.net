...
{
	public partial class ErrorbarSeriesSonificationTracksMappingVolume  : BaseObject
	{
		Hashtable h = new Hashtable();

		public ErrorbarSeriesSonificationTracksMappingVolume()
		{
			MapFunction = MapFunction_DefaultValue = ErrorbarSeriesSonificationTracksMappingVolumeMapFunction.Linear;
			MapTo = MapTo_DefaultValue = "";
			Max = Max_DefaultValue = null;
			Min = Min_DefaultValue = null;
			Value = Value_DefaultValue = null;
			Within = Within_DefaultValue = ErrorbarSeriesSonificationTracksMappingVolumeWithin.Chart;
		...
		/// </summary>
		public ErrorbarSeriesSonificationTracksMappingVolumeMapFunction MapFunction { get; set; }
		private ErrorbarSeriesSonificationTracksMappingVolumeMapFunction MapFunction_DefaultValue { get; set; }
		...
		/// </summary>
		public ErrorbarSeriesSonificationTracksMappingVolumeWithin Within { get; set; }
		private ErrorbarSeriesSonificationTracksMappingVolumeWithin Within_DefaultValue { get; set; }
