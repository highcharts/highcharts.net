...
{
	public partial class ErrorbarSeriesSonificationTracksPointGrouping  : BaseObject
	{
		Hashtable h = new Hashtable();

		public ErrorbarSeriesSonificationTracksPointGrouping()
		{
		...
		/// </summary>
		public ErrorbarSeriesSonificationTracksPointGroupingAlgorithm Algorithm { get; set; }
		private ErrorbarSeriesSonificationTracksPointGroupingAlgorithm Algorithm_DefaultValue { get; set; }
		...
		internal override Hashtable ToHashtable(Highcharts highcharts)
		{
			...
			if (Algorithm != ErrorbarSeriesSonificationTracksPointGroupingAlgorithm.Null) h.Add("algorithm", highcharts.FirstCharacterToLower(Algorithm.ToString()));
