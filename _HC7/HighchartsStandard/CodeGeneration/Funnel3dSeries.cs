...
namespace Highsoft.Web.Mvc.Charts
{
	public partial class Funnel3dSeries  : Series
	{
		...
		public Funnel3dSeries()
		{
			...
			Cursor = Cursor_DefaultValue = Funnel3dSeriesCursor.Null;
			...
			Dumbell = Dumbell_DefaultValue = new Funnel3dSeriesDumbell();
			...
			LegendSymbol = LegendSymbol_DefaultValue = Funnel3dSeriesLegendSymbol.Rectangle;
			...
			OnPoint = OnPoint_DefaultValue = new Funnel3dSeriesOnPoint();
			Opacity = Opacity_DefaultValue = 1;
			Point = Point_DefaultValue = new Funnel3dSeriesPoint();
			...
			Sonification = Sonification_DefaultValue = new Funnel3dSeriesSonification();
			...
			Zones = Zones_DefaultValue = new List<Funnel3dSeriesZone>();
		...
		/// 
		/// </summary>
		public Funnel3dSeriesDumbell Dumbell { get; set; }
		private Funnel3dSeriesDumbell Dumbell_DefaultValue { get; set; }
