...
namespace Highsoft.Web.Mvc.Charts
{
	public partial class Funnel3dSeries  : Series
	{
		public Funnel3dSeries()
		{
			...
			Type = Type_DefaultValue = Funnel3dSeriesType.Null;
		...
		internal override Hashtable ToHashtable()
		{
			...
			if (PointDescriptionFormatter != PointDescriptionFormatter_DefaultValue) { h.Add("pointDescriptionFormatter",PointDescriptionFormatter); Highcharts.AddFunction("Funnel3dSeriesPointDescriptionFormatter.pointDescriptionFormatter", PointDescriptionFormatter); }  
