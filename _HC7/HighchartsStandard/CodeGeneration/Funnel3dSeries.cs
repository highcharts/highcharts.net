...
{
	public partial class Funnel3dSeries  : Series
	{
		Hashtable h = new Hashtable();

		public Funnel3dSeries()
		{
		...
		/// </summary>
		public Funnel3dSeriesAccessibility Accessibility { get; set; }
		private Funnel3dSeriesAccessibility Accessibility_DefaultValue { get; set; }
		...
		/// </summary>
		public Funnel3dSeriesCursor Cursor { get; set; }
		private Funnel3dSeriesCursor Cursor_DefaultValue { get; set; }
		...
		/// </summary>
		public Funnel3dSeriesDashStyle DashStyle { get; set; }
		private Funnel3dSeriesDashStyle DashStyle_DefaultValue { get; set; }
		 

		/// <summary>
		/// An array of data points for the series. For the `funnel3d` seriestype, points can be given in the following ways:1.  An array of numerical values. In this case, the numerical valueswill be interpreted as `y` options. The `x` values will be automaticallycalculated, either starting at 0 and incremented by 1, or from `pointStart`and `pointInterval` given in the series options. If the axis hascategories, these will be used. Example: ```js data: [0, 5, 3, 5] ```2.  An array of objects with named values. The following snippet shows only afew settings, see the complete options set below. If the total number of datapoints exceeds the series' [turboThreshold](#series.funnel3d.turboThreshold),this option is not available. ```js    data: [{        y: 2,        name: "Point2",        color: "#00FF00"    }, {        y: 4,        name: "Point1",        color: "#FF00FF"    }] ```
		/// </summary>
		public List<Funnel3dSeriesData> Data { get; set; }
		private List<Funnel3dSeriesData> Data_DefaultValue { get; set; }
		...
		/// </summary>
		public Funnel3dSeriesDragDrop DragDrop { get; set; }
		private Funnel3dSeriesDragDrop DragDrop_DefaultValue { get; set; }
		...
		/// </summary>
		public Funnel3dSeriesFindNearestPointBy FindNearestPointBy { get; set; }
		private Funnel3dSeriesFindNearestPointBy FindNearestPointBy_DefaultValue { get; set; }
		...
		/// </summary>
		public Funnel3dSeriesLabel Label { get; set; }
		private Funnel3dSeriesLabel Label_DefaultValue { get; set; }
		...
		/// </summary>
		public Funnel3dSeriesLegendSymbol LegendSymbol { get; set; }
		private Funnel3dSeriesLegendSymbol LegendSymbol_DefaultValue { get; set; }
		...
		/// </summary>
		public Funnel3dSeriesOnPoint OnPoint { get; set; }
		private Funnel3dSeriesOnPoint OnPoint_DefaultValue { get; set; }
		...
		/// </summary>
		public Funnel3dSeriesPoint Point { get; set; }
		private Funnel3dSeriesPoint Point_DefaultValue { get; set; }
		...
		/// </summary>
		public Funnel3dSeriesPointIntervalUnit PointIntervalUnit { get; set; }
		private Funnel3dSeriesPointIntervalUnit PointIntervalUnit_DefaultValue { get; set; }
		...
		/// </summary>
		public Funnel3dSeriesPointPlacement PointPlacement { get; set; }
		private Funnel3dSeriesPointPlacement PointPlacement_DefaultValue { get; set; }
		...
		/// </summary>
		public Funnel3dSeriesSonification Sonification { get; set; }
		private Funnel3dSeriesSonification Sonification_DefaultValue { get; set; }
		...
		/// 
		/// </summary>
		public Funnel3dSeriesStates States { get; set; }
		private Funnel3dSeriesStates States_DefaultValue { get; set; }
		...
		/// </summary>
		public Funnel3dSeriesTooltip Tooltip { get; set; }
		private Funnel3dSeriesTooltip Tooltip_DefaultValue { get; set; }
		...
		/// </summary>
		public List<Funnel3dSeriesZone> Zones { get; set; }
		private List<Funnel3dSeriesZone> Zones_DefaultValue { get; set; }
		...
		internal override Hashtable ToHashtable(Highcharts highcharts)
		{
			...
			if (Cursor != Funnel3dSeriesCursor.Null) h.Add("cursor", highcharts.FirstCharacterToLower(Cursor.ToString()));
			if (Custom != null) h.Add("custom",Custom);
			if (DashStyle != Funnel3dSeriesDashStyle.Null) h.Add("dashStyle", highcharts.FirstCharacterToLower(DashStyle.ToString()));
			...
			if (FindNearestPointBy != Funnel3dSeriesFindNearestPointBy.Null) h.Add("findNearestPointBy", highcharts.FirstCharacterToLower(FindNearestPointBy.ToString()));
			...
			if (LegendSymbol != Funnel3dSeriesLegendSymbol.Null) h.Add("legendSymbol", highcharts.FirstCharacterToLower(LegendSymbol.ToString()));
			...
			if (PointIntervalUnit != Funnel3dSeriesPointIntervalUnit.Null) h.Add("pointIntervalUnit", highcharts.FirstCharacterToLower(PointIntervalUnit.ToString()));
			if (PointPadding != null) h.Add("pointPadding",PointPadding);
			if (PointPlacement != Funnel3dSeriesPointPlacement.Null) h.Add("pointPlacement", highcharts.FirstCharacterToLower(PointPlacement.ToString()));
			...
			if (Stacking != Funnel3dSeriesStacking.Null) h.Add("stacking", highcharts.FirstCharacterToLower(Stacking.ToString()));
