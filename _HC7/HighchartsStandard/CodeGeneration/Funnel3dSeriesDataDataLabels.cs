...
{
	public partial class Funnel3dSeriesDataDataLabels  : BaseObject
	{
		Hashtable h = new Hashtable();

		public Funnel3dSeriesDataDataLabels()
		{
		...
		/// </summary>
		public Funnel3dSeriesDataDataLabelsAlign Align { get; set; }
		private Funnel3dSeriesDataDataLabelsAlign Align_DefaultValue { get; set; }
		...
		/// </summary>
		public Funnel3dSeriesDataDataLabelsFilter Filter { get; set; }
		private Funnel3dSeriesDataDataLabelsFilter Filter_DefaultValue { get; set; }
		...
		/// </summary>
		public Funnel3dSeriesDataDataLabelsOverflow Overflow { get; set; }
		private Funnel3dSeriesDataDataLabelsOverflow Overflow_DefaultValue { get; set; }
		...
		/// </summary>
		public Funnel3dSeriesDataDataLabelsPosition Position { get; set; }
		private Funnel3dSeriesDataDataLabelsPosition Position_DefaultValue { get; set; }
		...
		/// </summary>
		public Funnel3dSeriesDataDataLabelsTextPath TextPath { get; set; }
		private Funnel3dSeriesDataDataLabelsTextPath TextPath_DefaultValue { get; set; }
		...
		/// </summary>
		public Funnel3dSeriesDataDataLabelsVerticalAlign VerticalAlign { get; set; }
		private Funnel3dSeriesDataDataLabelsVerticalAlign VerticalAlign_DefaultValue { get; set; }
		...
		internal override Hashtable ToHashtable(Highcharts highcharts)
		{
			...
			if (Align != Funnel3dSeriesDataDataLabelsAlign.Null) h.Add("align", highcharts.FirstCharacterToLower(Align.ToString()));
			...
			if (Overflow != Funnel3dSeriesDataDataLabelsOverflow.Null) h.Add("overflow", highcharts.FirstCharacterToLower(Overflow.ToString()));
			if (Padding != null) h.Add("padding",Padding);
			if (Position != Funnel3dSeriesDataDataLabelsPosition.Null) h.Add("position", highcharts.FirstCharacterToLower(Position.ToString()));
			...
			if (VerticalAlign != Funnel3dSeriesDataDataLabelsVerticalAlign.Null) h.Add("verticalAlign", highcharts.FirstCharacterToLower(VerticalAlign.ToString()));
			if (X != null) h.Add("x",X);
			if (Y != null) h.Add("y",Y);
