...
{
	public partial class Funnel3dSeriesDragDropDragHandle  : BaseObject
	{
		public Funnel3dSeriesDragDropDragHandle()
		{
		...
		internal override Hashtable ToHashtable()
		{
			...
			if (PathFormatter != PathFormatter_DefaultValue) { h.Add("pathFormatter",PathFormatter); Highcharts.AddFunction("Funnel3dSeriesDragDropDragHandlePathFormatter.pathFormatter", PathFormatter); }  
