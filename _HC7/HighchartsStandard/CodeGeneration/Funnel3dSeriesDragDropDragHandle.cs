...
namespace Highsoft.Web.Mvc.Charts
{
	public partial class Funnel3dSeriesDragDropDragHandle  : BaseObject
	{
		...
		internal override Hashtable ToHashtable()
		{
			...
			if (PathFormatter != PathFormatter_DefaultValue) { h.Add("pathFormatter",PathFormatter); Highcharts.AddFunction("9c462d61-1f0f-4e35-9842-6207f634f415.pathFormatter", PathFormatter); }  
