...
{
	public partial class Funnel3dSeriesSonificationContextTracks  : BaseObject
	{
		Hashtable h = new Hashtable();

		public Funnel3dSeriesSonificationContextTracks()
		{
			ActiveWhen = ActiveWhen_DefaultValue = new Funnel3dSeriesSonificationContextTracksActiveWhen();
			Instrument = Instrument_DefaultValue = null;
			InstrumentString = InstrumentString_DefaultValue = "null";
			Mapping = Mapping_DefaultValue = new Funnel3dSeriesSonificationContextTracksMapping();
			MidiName = MidiName_DefaultValue = "";
			PointGrouping = PointGrouping_DefaultValue = new Funnel3dSeriesSonificationContextTracksPointGrouping();
			...
			Type = Type_DefaultValue = Funnel3dSeriesSonificationContextTracksType.Instrument;
			ValueInterval = ValueInterval_DefaultValue = null;
			ValueMapFunction = ValueMapFunction_DefaultValue = Funnel3dSeriesSonificationContextTracksValueMapFunction.Linear;
		...
		/// </summary>
		public Funnel3dSeriesSonificationContextTracksActiveWhen ActiveWhen { get; set; }
		private Funnel3dSeriesSonificationContextTracksActiveWhen ActiveWhen_DefaultValue { get; set; }
		...
		/// </summary>
		public Funnel3dSeriesSonificationContextTracksMapping Mapping { get; set; }
		private Funnel3dSeriesSonificationContextTracksMapping Mapping_DefaultValue { get; set; }
		...
		/// </summary>
		public Funnel3dSeriesSonificationContextTracksPointGrouping PointGrouping { get; set; }
		private Funnel3dSeriesSonificationContextTracksPointGrouping PointGrouping_DefaultValue { get; set; }
		...
		/// </summary>
		public Funnel3dSeriesSonificationContextTracksType Type { get; set; }
		private Funnel3dSeriesSonificationContextTracksType Type_DefaultValue { get; set; }
		...
		/// </summary>
		public Funnel3dSeriesSonificationContextTracksValueMapFunction ValueMapFunction { get; set; }
		private Funnel3dSeriesSonificationContextTracksValueMapFunction ValueMapFunction_DefaultValue { get; set; }
