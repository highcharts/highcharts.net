...
{
	public partial class Funnel3dSeriesSonificationContextTracksMapping  : BaseObject
	{
		Hashtable h = new Hashtable();

		public Funnel3dSeriesSonificationContextTracksMapping()
		{
			Frequency = Frequency_DefaultValue = new Funnel3dSeriesSonificationContextTracksMappingFrequency();
			GapBetweenNotes = GapBetweenNotes_DefaultValue = new Funnel3dSeriesSonificationContextTracksMappingGapBetweenNotes();
			Highpass = Highpass_DefaultValue = new Funnel3dSeriesSonificationContextTracksMappingHighpass();
			Lowpass = Lowpass_DefaultValue = new Funnel3dSeriesSonificationContextTracksMappingLowpass();
			NoteDuration = NoteDuration_DefaultValue = new Funnel3dSeriesSonificationContextTracksMappingNoteDuration();
			Pan = Pan_DefaultValue = new Funnel3dSeriesSonificationContextTracksMappingPan();
			Pitch = Pitch_DefaultValue = new Funnel3dSeriesSonificationContextTracksMappingPitch();
			PitchString = PitchString_DefaultValue = "null";
			PitchNumber = PitchNumber_DefaultValue = null;
			PlayDelay = PlayDelay_DefaultValue = new Funnel3dSeriesSonificationContextTracksMappingPlayDelay();
			Time = Time_DefaultValue = new Funnel3dSeriesSonificationContextTracksMappingTime();
			TimeString = TimeString_DefaultValue = "null";
			TimeNumber = TimeNumber_DefaultValue = null;
			Tremolo = Tremolo_DefaultValue = new Funnel3dSeriesSonificationContextTracksMappingTremolo();
			Volume = Volume_DefaultValue = new Funnel3dSeriesSonificationContextTracksMappingVolume();
		...
		/// </summary>
		public Funnel3dSeriesSonificationContextTracksMappingFrequency Frequency { get; set; }
		private Funnel3dSeriesSonificationContextTracksMappingFrequency Frequency_DefaultValue { get; set; }
		...
		/// </summary>
		public Funnel3dSeriesSonificationContextTracksMappingGapBetweenNotes GapBetweenNotes { get; set; }
		private Funnel3dSeriesSonificationContextTracksMappingGapBetweenNotes GapBetweenNotes_DefaultValue { get; set; }
		...
		/// </summary>
		public Funnel3dSeriesSonificationContextTracksMappingHighpass Highpass { get; set; }
		private Funnel3dSeriesSonificationContextTracksMappingHighpass Highpass_DefaultValue { get; set; }
		...
		/// </summary>
		public Funnel3dSeriesSonificationContextTracksMappingLowpass Lowpass { get; set; }
		private Funnel3dSeriesSonificationContextTracksMappingLowpass Lowpass_DefaultValue { get; set; }
		...
		/// </summary>
		public Funnel3dSeriesSonificationContextTracksMappingNoteDuration NoteDuration { get; set; }
		private Funnel3dSeriesSonificationContextTracksMappingNoteDuration NoteDuration_DefaultValue { get; set; }
		...
		/// </summary>
		public Funnel3dSeriesSonificationContextTracksMappingPan Pan { get; set; }
		private Funnel3dSeriesSonificationContextTracksMappingPan Pan_DefaultValue { get; set; }
		...
		/// </summary>
		public Funnel3dSeriesSonificationContextTracksMappingPitch Pitch { get; set; }
		private Funnel3dSeriesSonificationContextTracksMappingPitch Pitch_DefaultValue { get; set; }
		...
		/// </summary>
		public Funnel3dSeriesSonificationContextTracksMappingPlayDelay PlayDelay { get; set; }
		private Funnel3dSeriesSonificationContextTracksMappingPlayDelay PlayDelay_DefaultValue { get; set; }
		...
		/// </summary>
		public Funnel3dSeriesSonificationContextTracksMappingTime Time { get; set; }
		private Funnel3dSeriesSonificationContextTracksMappingTime Time_DefaultValue { get; set; }
		...
		/// </summary>
		public Funnel3dSeriesSonificationContextTracksMappingTremolo Tremolo { get; set; }
		private Funnel3dSeriesSonificationContextTracksMappingTremolo Tremolo_DefaultValue { get; set; }
		 

		/// <summary>
		/// The volume of notes, from 0 to 1.
		/// </summary>
		public Funnel3dSeriesSonificationContextTracksMappingVolume Volume { get; set; }
		private Funnel3dSeriesSonificationContextTracksMappingVolume Volume_DefaultValue { get; set; }
