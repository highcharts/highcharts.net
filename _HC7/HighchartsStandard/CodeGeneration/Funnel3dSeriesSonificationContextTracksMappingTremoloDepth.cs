...
{
	public partial class Funnel3dSeriesSonificationContextTracksMappingTremoloDepth  : BaseObject
	{
		Hashtable h = new Hashtable();

		public Funnel3dSeriesSonificationContextTracksMappingTremoloDepth()
		{
			MapFunction = MapFunction_DefaultValue = Funnel3dSeriesSonificationContextTracksMappingTremoloDepthMapFunction.Linear;
			MapTo = MapTo_DefaultValue = "";
			Max = Max_DefaultValue = null;
			Min = Min_DefaultValue = null;
			Value = Value_DefaultValue = null;
			Within = Within_DefaultValue = Funnel3dSeriesSonificationContextTracksMappingTremoloDepthWithin.Chart;
		...
		/// </summary>
		public Funnel3dSeriesSonificationContextTracksMappingTremoloDepthMapFunction MapFunction { get; set; }
		private Funnel3dSeriesSonificationContextTracksMappingTremoloDepthMapFunction MapFunction_DefaultValue { get; set; }
		...
		/// </summary>
		public Funnel3dSeriesSonificationContextTracksMappingTremoloDepthWithin Within { get; set; }
		private Funnel3dSeriesSonificationContextTracksMappingTremoloDepthWithin Within_DefaultValue { get; set; }
