...
{
	public partial class Funnel3dSeriesSonificationContextTracksMappingVolume  : BaseObject
	{
		Hashtable h = new Hashtable();

		public Funnel3dSeriesSonificationContextTracksMappingVolume()
		{
			MapFunction = MapFunction_DefaultValue = Funnel3dSeriesSonificationContextTracksMappingVolumeMapFunction.Linear;
			MapTo = MapTo_DefaultValue = "";
			Max = Max_DefaultValue = null;
			Min = Min_DefaultValue = null;
			Value = Value_DefaultValue = null;
			Within = Within_DefaultValue = Funnel3dSeriesSonificationContextTracksMappingVolumeWithin.Chart;
		...
		/// </summary>
		public Funnel3dSeriesSonificationContextTracksMappingVolumeMapFunction MapFunction { get; set; }
		private Funnel3dSeriesSonificationContextTracksMappingVolumeMapFunction MapFunction_DefaultValue { get; set; }
		...
		/// </summary>
		public Funnel3dSeriesSonificationContextTracksMappingVolumeWithin Within { get; set; }
		private Funnel3dSeriesSonificationContextTracksMappingVolumeWithin Within_DefaultValue { get; set; }
