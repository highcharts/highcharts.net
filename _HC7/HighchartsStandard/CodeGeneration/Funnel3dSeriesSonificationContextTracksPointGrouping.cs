...
{
	public partial class Funnel3dSeriesSonificationContextTracksPointGrouping  : BaseObject
	{
		Hashtable h = new Hashtable();

		public Funnel3dSeriesSonificationContextTracksPointGrouping()
		{
		...
		/// </summary>
		public Funnel3dSeriesSonificationContextTracksPointGroupingAlgorithm Algorithm { get; set; }
		private Funnel3dSeriesSonificationContextTracksPointGroupingAlgorithm Algorithm_DefaultValue { get; set; }
		...
		internal override Hashtable ToHashtable(Highcharts highcharts)
		{
			...
			if (Algorithm != Funnel3dSeriesSonificationContextTracksPointGroupingAlgorithm.Null) h.Add("algorithm", highcharts.FirstCharacterToLower(Algorithm.ToString()));
