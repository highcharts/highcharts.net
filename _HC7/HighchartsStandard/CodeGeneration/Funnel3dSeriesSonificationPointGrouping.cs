...
{
	public partial class Funnel3dSeriesSonificationPointGrouping  : BaseObject
	{
		Hashtable h = new Hashtable();

		public Funnel3dSeriesSonificationPointGrouping()
		{
		...
		/// </summary>
		public Funnel3dSeriesSonificationPointGroupingAlgorithm Algorithm { get; set; }
		private Funnel3dSeriesSonificationPointGroupingAlgorithm Algorithm_DefaultValue { get; set; }
		...
		internal override Hashtable ToHashtable(Highcharts highcharts)
		{
			...
			if (Algorithm != Funnel3dSeriesSonificationPointGroupingAlgorithm.Null) h.Add("algorithm", highcharts.FirstCharacterToLower(Algorithm.ToString()));
