...
{
	public partial class Funnel3dSeriesSonificationTracksMapping  : BaseObject
	{
		Hashtable h = new Hashtable();

		public Funnel3dSeriesSonificationTracksMapping()
		{
			Frequency = Frequency_DefaultValue = new Funnel3dSeriesSonificationTracksMappingFrequency();
			GapBetweenNotes = GapBetweenNotes_DefaultValue = new Funnel3dSeriesSonificationTracksMappingGapBetweenNotes();
			Highpass = Highpass_DefaultValue = new Funnel3dSeriesSonificationTracksMappingHighpass();
			Lowpass = Lowpass_DefaultValue = new Funnel3dSeriesSonificationTracksMappingLowpass();
			NoteDuration = NoteDuration_DefaultValue = new Funnel3dSeriesSonificationTracksMappingNoteDuration();
			Pan = Pan_DefaultValue = new Funnel3dSeriesSonificationTracksMappingPan();
			Pitch = Pitch_DefaultValue = new Funnel3dSeriesSonificationTracksMappingPitch();
			PitchString = PitchString_DefaultValue = "null";
			PitchNumber = PitchNumber_DefaultValue = null;
			PlayDelay = PlayDelay_DefaultValue = new Funnel3dSeriesSonificationTracksMappingPlayDelay();
			Time = Time_DefaultValue = new Funnel3dSeriesSonificationTracksMappingTime();
			TimeString = TimeString_DefaultValue = "null";
			TimeNumber = TimeNumber_DefaultValue = null;
			Tremolo = Tremolo_DefaultValue = new Funnel3dSeriesSonificationTracksMappingTremolo();
			Volume = Volume_DefaultValue = new Funnel3dSeriesSonificationTracksMappingVolume();
		...
		/// </summary>
		public Funnel3dSeriesSonificationTracksMappingFrequency Frequency { get; set; }
		private Funnel3dSeriesSonificationTracksMappingFrequency Frequency_DefaultValue { get; set; }
		...
		/// </summary>
		public Funnel3dSeriesSonificationTracksMappingGapBetweenNotes GapBetweenNotes { get; set; }
		private Funnel3dSeriesSonificationTracksMappingGapBetweenNotes GapBetweenNotes_DefaultValue { get; set; }
		...
		/// </summary>
		public Funnel3dSeriesSonificationTracksMappingHighpass Highpass { get; set; }
		private Funnel3dSeriesSonificationTracksMappingHighpass Highpass_DefaultValue { get; set; }
		...
		/// </summary>
		public Funnel3dSeriesSonificationTracksMappingLowpass Lowpass { get; set; }
		private Funnel3dSeriesSonificationTracksMappingLowpass Lowpass_DefaultValue { get; set; }
		...
		/// </summary>
		public Funnel3dSeriesSonificationTracksMappingNoteDuration NoteDuration { get; set; }
		private Funnel3dSeriesSonificationTracksMappingNoteDuration NoteDuration_DefaultValue { get; set; }
		...
		/// </summary>
		public Funnel3dSeriesSonificationTracksMappingPan Pan { get; set; }
		private Funnel3dSeriesSonificationTracksMappingPan Pan_DefaultValue { get; set; }
		...
		/// </summary>
		public Funnel3dSeriesSonificationTracksMappingPitch Pitch { get; set; }
		private Funnel3dSeriesSonificationTracksMappingPitch Pitch_DefaultValue { get; set; }
		...
		/// </summary>
		public Funnel3dSeriesSonificationTracksMappingPlayDelay PlayDelay { get; set; }
		private Funnel3dSeriesSonificationTracksMappingPlayDelay PlayDelay_DefaultValue { get; set; }
		...
		/// </summary>
		public Funnel3dSeriesSonificationTracksMappingTime Time { get; set; }
		private Funnel3dSeriesSonificationTracksMappingTime Time_DefaultValue { get; set; }
		...
		/// </summary>
		public Funnel3dSeriesSonificationTracksMappingTremolo Tremolo { get; set; }
		private Funnel3dSeriesSonificationTracksMappingTremolo Tremolo_DefaultValue { get; set; }
		 

		/// <summary>
		/// The volume of notes, from 0 to 1.
		/// </summary>
		public Funnel3dSeriesSonificationTracksMappingVolume Volume { get; set; }
		private Funnel3dSeriesSonificationTracksMappingVolume Volume_DefaultValue { get; set; }
