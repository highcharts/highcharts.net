...
{
	public partial class Funnel3dSeriesSonificationTracksMappingFrequency  : BaseObject
	{
		Hashtable h = new Hashtable();

		public Funnel3dSeriesSonificationTracksMappingFrequency()
		{
			MapFunction = MapFunction_DefaultValue = Funnel3dSeriesSonificationTracksMappingFrequencyMapFunction.Linear;
			MapTo = MapTo_DefaultValue = "";
			Max = Max_DefaultValue = null;
			Min = Min_DefaultValue = null;
			Value = Value_DefaultValue = null;
			Within = Within_DefaultValue = Funnel3dSeriesSonificationTracksMappingFrequencyWithin.Chart;
		...
		/// </summary>
		public Funnel3dSeriesSonificationTracksMappingFrequencyMapFunction MapFunction { get; set; }
		private Funnel3dSeriesSonificationTracksMappingFrequencyMapFunction MapFunction_DefaultValue { get; set; }
		...
		/// </summary>
		public Funnel3dSeriesSonificationTracksMappingFrequencyWithin Within { get; set; }
		private Funnel3dSeriesSonificationTracksMappingFrequencyWithin Within_DefaultValue { get; set; }
