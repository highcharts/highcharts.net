...
{
	public partial class Funnel3dSeriesSonificationTracksMappingTime  : BaseObject
	{
		Hashtable h = new Hashtable();

		public Funnel3dSeriesSonificationTracksMappingTime()
		{
			MapFunction = MapFunction_DefaultValue = Funnel3dSeriesSonificationTracksMappingTimeMapFunction.Linear;
			MapTo = MapTo_DefaultValue = "";
			Max = Max_DefaultValue = null;
			Min = Min_DefaultValue = null;
			Value = Value_DefaultValue = null;
			Within = Within_DefaultValue = Funnel3dSeriesSonificationTracksMappingTimeWithin.Chart;
		...
		/// </summary>
		public Funnel3dSeriesSonificationTracksMappingTimeMapFunction MapFunction { get; set; }
		private Funnel3dSeriesSonificationTracksMappingTimeMapFunction MapFunction_DefaultValue { get; set; }
		...
		/// </summary>
		public Funnel3dSeriesSonificationTracksMappingTimeWithin Within { get; set; }
		private Funnel3dSeriesSonificationTracksMappingTimeWithin Within_DefaultValue { get; set; }
