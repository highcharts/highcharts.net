...
{
	public partial class Funnel3dSeriesSonificationTracksMappingTremoloDepth  : BaseObject
	{
		Hashtable h = new Hashtable();

		public Funnel3dSeriesSonificationTracksMappingTremoloDepth()
		{
			MapFunction = MapFunction_DefaultValue = Funnel3dSeriesSonificationTracksMappingTremoloDepthMapFunction.Linear;
			MapTo = MapTo_DefaultValue = "";
			Max = Max_DefaultValue = null;
			Min = Min_DefaultValue = null;
			Value = Value_DefaultValue = null;
			Within = Within_DefaultValue = Funnel3dSeriesSonificationTracksMappingTremoloDepthWithin.Chart;
		...
		/// </summary>
		public Funnel3dSeriesSonificationTracksMappingTremoloDepthMapFunction MapFunction { get; set; }
		private Funnel3dSeriesSonificationTracksMappingTremoloDepthMapFunction MapFunction_DefaultValue { get; set; }
		...
		/// </summary>
		public Funnel3dSeriesSonificationTracksMappingTremoloDepthWithin Within { get; set; }
		private Funnel3dSeriesSonificationTracksMappingTremoloDepthWithin Within_DefaultValue { get; set; }
