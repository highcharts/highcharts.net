...
{
	public partial class Funnel3dSeriesSonificationTracksMappingVolume  : BaseObject
	{
		Hashtable h = new Hashtable();

		public Funnel3dSeriesSonificationTracksMappingVolume()
		{
			MapFunction = MapFunction_DefaultValue = Funnel3dSeriesSonificationTracksMappingVolumeMapFunction.Linear;
			MapTo = MapTo_DefaultValue = "";
			Max = Max_DefaultValue = null;
			Min = Min_DefaultValue = null;
			Value = Value_DefaultValue = null;
			Within = Within_DefaultValue = Funnel3dSeriesSonificationTracksMappingVolumeWithin.Chart;
		...
		/// </summary>
		public Funnel3dSeriesSonificationTracksMappingVolumeMapFunction MapFunction { get; set; }
		private Funnel3dSeriesSonificationTracksMappingVolumeMapFunction MapFunction_DefaultValue { get; set; }
		...
		/// </summary>
		public Funnel3dSeriesSonificationTracksMappingVolumeWithin Within { get; set; }
		private Funnel3dSeriesSonificationTracksMappingVolumeWithin Within_DefaultValue { get; set; }
