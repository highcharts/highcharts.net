...
{
	public partial class Funnel3dSeriesSonificationTracksPointGrouping  : BaseObject
	{
		Hashtable h = new Hashtable();

		public Funnel3dSeriesSonificationTracksPointGrouping()
		{
		...
		/// </summary>
		public Funnel3dSeriesSonificationTracksPointGroupingAlgorithm Algorithm { get; set; }
		private Funnel3dSeriesSonificationTracksPointGroupingAlgorithm Algorithm_DefaultValue { get; set; }
		...
		internal override Hashtable ToHashtable(Highcharts highcharts)
		{
			...
			if (Algorithm != Funnel3dSeriesSonificationTracksPointGroupingAlgorithm.Null) h.Add("algorithm", highcharts.FirstCharacterToLower(Algorithm.ToString()));
