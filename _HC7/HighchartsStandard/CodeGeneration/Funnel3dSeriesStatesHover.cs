...
{
	public partial class Funnel3dSeriesStatesHover  : BaseObject
	{
		public Funnel3dSeriesStatesHover()
		{
			Animation = Animation_DefaultValue = new Animation() { Enabled = true };
			Enabled = Enabled_DefaultValue = true;
			Halo = Halo_DefaultValue = new Funnel3dSeriesStatesHoverHalo();
			LineWidth = LineWidth_DefaultValue = null;
			LineWidthPlus = LineWidthPlus_DefaultValue = 1;
			Marker = Marker_DefaultValue = new Funnel3dSeriesStatesHoverMarker();
		...
		/// </summary>
		public Funnel3dSeriesStatesHoverHalo Halo { get; set; }
		private Funnel3dSeriesStatesHoverHalo Halo_DefaultValue { get; set; }
		...
		/// </summary>
		public Funnel3dSeriesStatesHoverMarker Marker { get; set; }
		private Funnel3dSeriesStatesHoverMarker Marker_DefaultValue { get; set; }
