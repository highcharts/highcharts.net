...
namespace Highsoft.Web.Mvc.Charts
{
	public partial class FunnelSeries  : Series
	{
		...
		public FunnelSeries()
		{
			...
			Dumbell = Dumbell_DefaultValue = new FunnelSeriesDumbell();
			...
			LegendSymbol = LegendSymbol_DefaultValue = FunnelSeriesLegendSymbol.Rectangle;
			...
			Sonification = Sonification_DefaultValue = new FunnelSeriesSonification();
		...
		/// 
		/// </summary>
		public FunnelSeriesDumbell Dumbell { get; set; }
		private FunnelSeriesDumbell Dumbell_DefaultValue { get; set; }
		...
		/// </summary>
		public FunnelSeriesLegendSymbol LegendSymbol { get; set; }
		private FunnelSeriesLegendSymbol LegendSymbol_DefaultValue { get; set; }
		...
		/// </summary>
		public FunnelSeriesSonification Sonification { get; set; }
		private FunnelSeriesSonification Sonification_DefaultValue { get; set; }
