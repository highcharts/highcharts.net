...
{
	public partial class FunnelSeriesDataDataLabels  : BaseObject
	{
		Hashtable h = new Hashtable();

		public FunnelSeriesDataDataLabels()
		{
		...
		/// </summary>
		public FunnelSeriesDataDataLabelsAlign Align { get; set; }
		private FunnelSeriesDataDataLabelsAlign Align_DefaultValue { get; set; }
		...
		/// </summary>
		public FunnelSeriesDataDataLabelsFilter Filter { get; set; }
		private FunnelSeriesDataDataLabelsFilter Filter_DefaultValue { get; set; }
		...
		/// </summary>
		public FunnelSeriesDataDataLabelsOverflow Overflow { get; set; }
		private FunnelSeriesDataDataLabelsOverflow Overflow_DefaultValue { get; set; }
		...
		/// </summary>
		public FunnelSeriesDataDataLabelsPosition Position { get; set; }
		private FunnelSeriesDataDataLabelsPosition Position_DefaultValue { get; set; }
		...
		/// </summary>
		public FunnelSeriesDataDataLabelsTextPath TextPath { get; set; }
		private FunnelSeriesDataDataLabelsTextPath TextPath_DefaultValue { get; set; }
		...
		/// </summary>
		public FunnelSeriesDataDataLabelsVerticalAlign VerticalAlign { get; set; }
		private FunnelSeriesDataDataLabelsVerticalAlign VerticalAlign_DefaultValue { get; set; }
		...
		internal override Hashtable ToHashtable(Highcharts highcharts)
		{
			...
			if (Align != FunnelSeriesDataDataLabelsAlign.Null) h.Add("align", highcharts.FirstCharacterToLower(Align.ToString()));
			...
			if (Overflow != FunnelSeriesDataDataLabelsOverflow.Null) h.Add("overflow", highcharts.FirstCharacterToLower(Overflow.ToString()));
			if (Padding != null) h.Add("padding",Padding);
			if (Position != FunnelSeriesDataDataLabelsPosition.Null) h.Add("position", highcharts.FirstCharacterToLower(Position.ToString()));
			...
			if (VerticalAlign != FunnelSeriesDataDataLabelsVerticalAlign.Null) h.Add("verticalAlign", highcharts.FirstCharacterToLower(VerticalAlign.ToString()));
			if (X != null) h.Add("x",X);
			if (Y != null) h.Add("y",Y);
