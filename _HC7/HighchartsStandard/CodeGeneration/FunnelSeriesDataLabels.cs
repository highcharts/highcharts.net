...
namespace Highsoft.Web.Mvc.Charts
{
	public partial class FunnelSeriesDataLabels  : BaseObject
	{
		...
		{
			Align = Align_DefaultValue = FunnelSeriesDataLabelsAlign.Center;
			...
			Position = Position_DefaultValue = FunnelSeriesDataLabelsPosition.Center;
			...
			TextPath = TextPath_DefaultValue = new FunnelSeriesDataLabelsTextPath();
