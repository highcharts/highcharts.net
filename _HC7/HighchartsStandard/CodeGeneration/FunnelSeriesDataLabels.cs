...
namespace Highsoft.Web.Mvc.Charts
{
	public partial class FunnelSeriesDataLabels  : BaseObject
	{
		...
		/// </summary>
		public FunnelSeriesDataLabelsAlign Align { get; set; }
		private FunnelSeriesDataLabelsAlign Align_DefaultValue { get; set; }
		...
		/// </summary>
		public FunnelSeriesDataLabelsPosition Position { get; set; }
		private FunnelSeriesDataLabelsPosition Position_DefaultValue { get; set; }
		...
		/// </summary>
		public FunnelSeriesDataLabelsTextPath TextPath { get; set; }
		private FunnelSeriesDataLabelsTextPath TextPath_DefaultValue { get; set; }
		...
		internal override Hashtable ToHashtable(Highcharts highcharts)
		{
			...
			if (Align != FunnelSeriesDataLabelsAlign.Null) h.Add("align", highcharts.FirstCharacterToLower(Align.ToString()));
			...
			if (Overflow != FunnelSeriesDataLabelsOverflow.Null) h.Add("overflow", highcharts.FirstCharacterToLower(Overflow.ToString()));
			if (Padding != null) h.Add("padding",Padding);
			if (Position != FunnelSeriesDataLabelsPosition.Null) h.Add("position", highcharts.FirstCharacterToLower(Position.ToString()));
			...
			if (VerticalAlign != FunnelSeriesDataLabelsVerticalAlign.Null) h.Add("verticalAlign", highcharts.FirstCharacterToLower(VerticalAlign.ToString()));
			if (X != null) h.Add("x",X);
			if (Y != null) h.Add("y",Y);
