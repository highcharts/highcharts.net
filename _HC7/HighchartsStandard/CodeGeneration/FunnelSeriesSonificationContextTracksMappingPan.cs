...
{
	public partial class FunnelSeriesSonificationContextTracksMappingPan  : BaseObject
	{
		Hashtable h = new Hashtable();

		public FunnelSeriesSonificationContextTracksMappingPan()
		{
			MapFunction = MapFunction_DefaultValue = FunnelSeriesSonificationContextTracksMappingPanMapFunction.Linear;
			MapTo = MapTo_DefaultValue = "";
			Max = Max_DefaultValue = null;
			Min = Min_DefaultValue = null;
			Value = Value_DefaultValue = null;
			Within = Within_DefaultValue = FunnelSeriesSonificationContextTracksMappingPanWithin.Chart;
		...
		/// </summary>
		public FunnelSeriesSonificationContextTracksMappingPanMapFunction MapFunction { get; set; }
		private FunnelSeriesSonificationContextTracksMappingPanMapFunction MapFunction_DefaultValue { get; set; }
		...
		/// </summary>
		public FunnelSeriesSonificationContextTracksMappingPanWithin Within { get; set; }
		private FunnelSeriesSonificationContextTracksMappingPanWithin Within_DefaultValue { get; set; }
