...
{
	public partial class FunnelSeriesSonificationContextTracksMappingTime  : BaseObject
	{
		Hashtable h = new Hashtable();

		public FunnelSeriesSonificationContextTracksMappingTime()
		{
			MapFunction = MapFunction_DefaultValue = FunnelSeriesSonificationContextTracksMappingTimeMapFunction.Linear;
			MapTo = MapTo_DefaultValue = "";
			Max = Max_DefaultValue = null;
			Min = Min_DefaultValue = null;
			Value = Value_DefaultValue = null;
			Within = Within_DefaultValue = FunnelSeriesSonificationContextTracksMappingTimeWithin.Chart;
		...
		/// </summary>
		public FunnelSeriesSonificationContextTracksMappingTimeMapFunction MapFunction { get; set; }
		private FunnelSeriesSonificationContextTracksMappingTimeMapFunction MapFunction_DefaultValue { get; set; }
		...
		/// </summary>
		public FunnelSeriesSonificationContextTracksMappingTimeWithin Within { get; set; }
		private FunnelSeriesSonificationContextTracksMappingTimeWithin Within_DefaultValue { get; set; }
