...
{
	public partial class FunnelSeriesSonificationContextTracksMappingVolume  : BaseObject
	{
		Hashtable h = new Hashtable();

		public FunnelSeriesSonificationContextTracksMappingVolume()
		{
			MapFunction = MapFunction_DefaultValue = FunnelSeriesSonificationContextTracksMappingVolumeMapFunction.Linear;
			MapTo = MapTo_DefaultValue = "";
			Max = Max_DefaultValue = null;
			Min = Min_DefaultValue = null;
			Value = Value_DefaultValue = null;
			Within = Within_DefaultValue = FunnelSeriesSonificationContextTracksMappingVolumeWithin.Chart;
		...
		/// </summary>
		public FunnelSeriesSonificationContextTracksMappingVolumeMapFunction MapFunction { get; set; }
		private FunnelSeriesSonificationContextTracksMappingVolumeMapFunction MapFunction_DefaultValue { get; set; }
		...
		/// </summary>
		public FunnelSeriesSonificationContextTracksMappingVolumeWithin Within { get; set; }
		private FunnelSeriesSonificationContextTracksMappingVolumeWithin Within_DefaultValue { get; set; }
