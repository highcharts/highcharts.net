...
{
	public partial class FunnelSeriesSonificationPointGrouping  : BaseObject
	{
		Hashtable h = new Hashtable();

		public FunnelSeriesSonificationPointGrouping()
		{
		...
		/// </summary>
		public FunnelSeriesSonificationPointGroupingAlgorithm Algorithm { get; set; }
		private FunnelSeriesSonificationPointGroupingAlgorithm Algorithm_DefaultValue { get; set; }
		...
		internal override Hashtable ToHashtable(Highcharts highcharts)
		{
			...
			if (Algorithm != FunnelSeriesSonificationPointGroupingAlgorithm.Null) h.Add("algorithm", highcharts.FirstCharacterToLower(Algorithm.ToString()));
