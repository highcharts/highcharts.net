...
{
	public partial class FunnelSeriesSonificationTracks  : BaseObject
	{
		Hashtable h = new Hashtable();

		public FunnelSeriesSonificationTracks()
		{
			ActiveWhen = ActiveWhen_DefaultValue = new FunnelSeriesSonificationTracksActiveWhen();
			Instrument = Instrument_DefaultValue = null;
			InstrumentString = InstrumentString_DefaultValue = "null";
			Mapping = Mapping_DefaultValue = new FunnelSeriesSonificationTracksMapping();
			MidiName = MidiName_DefaultValue = "";
			PointGrouping = PointGrouping_DefaultValue = new FunnelSeriesSonificationTracksPointGrouping();
			RoundToMusicalNotes = RoundToMusicalNotes_DefaultValue = true;
			ShowPlayMarker = ShowPlayMarker_DefaultValue = true;
			Type = Type_DefaultValue = FunnelSeriesSonificationTracksType.Instrument;
		...
		/// </summary>
		public FunnelSeriesSonificationTracksActiveWhen ActiveWhen { get; set; }
		private FunnelSeriesSonificationTracksActiveWhen ActiveWhen_DefaultValue { get; set; }
		...
		/// </summary>
		public FunnelSeriesSonificationTracksMapping Mapping { get; set; }
		private FunnelSeriesSonificationTracksMapping Mapping_DefaultValue { get; set; }
		...
		/// </summary>
		public FunnelSeriesSonificationTracksPointGrouping PointGrouping { get; set; }
		private FunnelSeriesSonificationTracksPointGrouping PointGrouping_DefaultValue { get; set; }
		...
		/// </summary>
		public FunnelSeriesSonificationTracksType Type { get; set; }
		private FunnelSeriesSonificationTracksType Type_DefaultValue { get; set; }
