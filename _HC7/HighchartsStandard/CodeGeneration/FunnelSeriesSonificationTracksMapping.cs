...
{
	public partial class FunnelSeriesSonificationTracksMapping  : BaseObject
	{
		Hashtable h = new Hashtable();

		public FunnelSeriesSonificationTracksMapping()
		{
			Frequency = Frequency_DefaultValue = new FunnelSeriesSonificationTracksMappingFrequency();
			GapBetweenNotes = GapBetweenNotes_DefaultValue = new FunnelSeriesSonificationTracksMappingGapBetweenNotes();
			Highpass = Highpass_DefaultValue = new FunnelSeriesSonificationTracksMappingHighpass();
			Lowpass = Lowpass_DefaultValue = new FunnelSeriesSonificationTracksMappingLowpass();
			NoteDuration = NoteDuration_DefaultValue = new FunnelSeriesSonificationTracksMappingNoteDuration();
			Pan = Pan_DefaultValue = new FunnelSeriesSonificationTracksMappingPan();
			Pitch = Pitch_DefaultValue = new FunnelSeriesSonificationTracksMappingPitch();
			PitchString = PitchString_DefaultValue = "null";
			PitchNumber = PitchNumber_DefaultValue = null;
			PlayDelay = PlayDelay_DefaultValue = new FunnelSeriesSonificationTracksMappingPlayDelay();
			Time = Time_DefaultValue = new FunnelSeriesSonificationTracksMappingTime();
			TimeString = TimeString_DefaultValue = "null";
			TimeNumber = TimeNumber_DefaultValue = null;
			Tremolo = Tremolo_DefaultValue = new FunnelSeriesSonificationTracksMappingTremolo();
			Volume = Volume_DefaultValue = new FunnelSeriesSonificationTracksMappingVolume();
		...
		/// </summary>
		public FunnelSeriesSonificationTracksMappingFrequency Frequency { get; set; }
		private FunnelSeriesSonificationTracksMappingFrequency Frequency_DefaultValue { get; set; }
		...
		/// </summary>
		public FunnelSeriesSonificationTracksMappingGapBetweenNotes GapBetweenNotes { get; set; }
		private FunnelSeriesSonificationTracksMappingGapBetweenNotes GapBetweenNotes_DefaultValue { get; set; }
		...
		/// </summary>
		public FunnelSeriesSonificationTracksMappingHighpass Highpass { get; set; }
		private FunnelSeriesSonificationTracksMappingHighpass Highpass_DefaultValue { get; set; }
		...
		/// </summary>
		public FunnelSeriesSonificationTracksMappingLowpass Lowpass { get; set; }
		private FunnelSeriesSonificationTracksMappingLowpass Lowpass_DefaultValue { get; set; }
		...
		/// </summary>
		public FunnelSeriesSonificationTracksMappingNoteDuration NoteDuration { get; set; }
		private FunnelSeriesSonificationTracksMappingNoteDuration NoteDuration_DefaultValue { get; set; }
		...
		/// </summary>
		public FunnelSeriesSonificationTracksMappingPan Pan { get; set; }
		private FunnelSeriesSonificationTracksMappingPan Pan_DefaultValue { get; set; }
		...
		/// </summary>
		public FunnelSeriesSonificationTracksMappingPitch Pitch { get; set; }
		private FunnelSeriesSonificationTracksMappingPitch Pitch_DefaultValue { get; set; }
		...
		/// </summary>
		public FunnelSeriesSonificationTracksMappingPlayDelay PlayDelay { get; set; }
		private FunnelSeriesSonificationTracksMappingPlayDelay PlayDelay_DefaultValue { get; set; }
		...
		/// </summary>
		public FunnelSeriesSonificationTracksMappingTime Time { get; set; }
		private FunnelSeriesSonificationTracksMappingTime Time_DefaultValue { get; set; }
		...
		/// </summary>
		public FunnelSeriesSonificationTracksMappingTremolo Tremolo { get; set; }
		private FunnelSeriesSonificationTracksMappingTremolo Tremolo_DefaultValue { get; set; }
		 

		/// <summary>
		/// The volume of notes, from 0 to 1.
		/// </summary>
		public FunnelSeriesSonificationTracksMappingVolume Volume { get; set; }
		private FunnelSeriesSonificationTracksMappingVolume Volume_DefaultValue { get; set; }
