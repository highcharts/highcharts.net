...
{
	public partial class FunnelSeriesSonificationTracksMappingFrequency  : BaseObject
	{
		Hashtable h = new Hashtable();

		public FunnelSeriesSonificationTracksMappingFrequency()
		{
			MapFunction = MapFunction_DefaultValue = FunnelSeriesSonificationTracksMappingFrequencyMapFunction.Linear;
			MapTo = MapTo_DefaultValue = "";
			Max = Max_DefaultValue = null;
			Min = Min_DefaultValue = null;
			Value = Value_DefaultValue = null;
			Within = Within_DefaultValue = FunnelSeriesSonificationTracksMappingFrequencyWithin.Chart;
		...
		/// </summary>
		public FunnelSeriesSonificationTracksMappingFrequencyMapFunction MapFunction { get; set; }
		private FunnelSeriesSonificationTracksMappingFrequencyMapFunction MapFunction_DefaultValue { get; set; }
		...
		/// </summary>
		public FunnelSeriesSonificationTracksMappingFrequencyWithin Within { get; set; }
		private FunnelSeriesSonificationTracksMappingFrequencyWithin Within_DefaultValue { get; set; }
