...
{
	public partial class FunnelSeriesSonificationTracksMappingLowpassResonance  : BaseObject
	{
		Hashtable h = new Hashtable();

		public FunnelSeriesSonificationTracksMappingLowpassResonance()
		{
			MapFunction = MapFunction_DefaultValue = FunnelSeriesSonificationTracksMappingLowpassResonanceMapFunction.Linear;
			MapTo = MapTo_DefaultValue = "";
			Max = Max_DefaultValue = null;
			Min = Min_DefaultValue = null;
			Value = Value_DefaultValue = null;
			Within = Within_DefaultValue = FunnelSeriesSonificationTracksMappingLowpassResonanceWithin.Chart;
		...
		/// </summary>
		public FunnelSeriesSonificationTracksMappingLowpassResonanceMapFunction MapFunction { get; set; }
		private FunnelSeriesSonificationTracksMappingLowpassResonanceMapFunction MapFunction_DefaultValue { get; set; }
		...
		/// </summary>
		public FunnelSeriesSonificationTracksMappingLowpassResonanceWithin Within { get; set; }
		private FunnelSeriesSonificationTracksMappingLowpassResonanceWithin Within_DefaultValue { get; set; }
