...
{
	public partial class FunnelSeriesSonificationTracksMappingPan  : BaseObject
	{
		Hashtable h = new Hashtable();

		public FunnelSeriesSonificationTracksMappingPan()
		{
			MapFunction = MapFunction_DefaultValue = FunnelSeriesSonificationTracksMappingPanMapFunction.Linear;
			MapTo = MapTo_DefaultValue = "";
			Max = Max_DefaultValue = null;
			Min = Min_DefaultValue = null;
			Value = Value_DefaultValue = null;
			Within = Within_DefaultValue = FunnelSeriesSonificationTracksMappingPanWithin.Chart;
		...
		/// </summary>
		public FunnelSeriesSonificationTracksMappingPanMapFunction MapFunction { get; set; }
		private FunnelSeriesSonificationTracksMappingPanMapFunction MapFunction_DefaultValue { get; set; }
		...
		/// </summary>
		public FunnelSeriesSonificationTracksMappingPanWithin Within { get; set; }
		private FunnelSeriesSonificationTracksMappingPanWithin Within_DefaultValue { get; set; }
