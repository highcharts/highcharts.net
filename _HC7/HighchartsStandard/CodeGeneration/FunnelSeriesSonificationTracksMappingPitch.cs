...
{
	public partial class FunnelSeriesSonificationTracksMappingPitch  : BaseObject
	{
		Hashtable h = new Hashtable();

		public FunnelSeriesSonificationTracksMappingPitch()
		{
			MapFunction = MapFunction_DefaultValue = FunnelSeriesSonificationTracksMappingPitchMapFunction.Linear;
		...
		/// </summary>
		public FunnelSeriesSonificationTracksMappingPitchMapFunction MapFunction { get; set; }
		private FunnelSeriesSonificationTracksMappingPitchMapFunction MapFunction_DefaultValue { get; set; }
