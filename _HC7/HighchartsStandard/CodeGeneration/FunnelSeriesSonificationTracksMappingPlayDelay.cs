...
{
	public partial class FunnelSeriesSonificationTracksMappingPlayDelay  : BaseObject
	{
		Hashtable h = new Hashtable();

		public FunnelSeriesSonificationTracksMappingPlayDelay()
		{
			MapFunction = MapFunction_DefaultValue = FunnelSeriesSonificationTracksMappingPlayDelayMapFunction.Linear;
			MapTo = MapTo_DefaultValue = "";
			Max = Max_DefaultValue = null;
			Min = Min_DefaultValue = null;
			Value = Value_DefaultValue = null;
			Within = Within_DefaultValue = FunnelSeriesSonificationTracksMappingPlayDelayWithin.Chart;
		...
		/// </summary>
		public FunnelSeriesSonificationTracksMappingPlayDelayMapFunction MapFunction { get; set; }
		private FunnelSeriesSonificationTracksMappingPlayDelayMapFunction MapFunction_DefaultValue { get; set; }
		...
		/// </summary>
		public FunnelSeriesSonificationTracksMappingPlayDelayWithin Within { get; set; }
		private FunnelSeriesSonificationTracksMappingPlayDelayWithin Within_DefaultValue { get; set; }
