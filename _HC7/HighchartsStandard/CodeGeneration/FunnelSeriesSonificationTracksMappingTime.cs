...
{
	public partial class FunnelSeriesSonificationTracksMappingTime  : BaseObject
	{
		Hashtable h = new Hashtable();

		public FunnelSeriesSonificationTracksMappingTime()
		{
			MapFunction = MapFunction_DefaultValue = FunnelSeriesSonificationTracksMappingTimeMapFunction.Linear;
			MapTo = MapTo_DefaultValue = "";
			Max = Max_DefaultValue = null;
			Min = Min_DefaultValue = null;
			Value = Value_DefaultValue = null;
			Within = Within_DefaultValue = FunnelSeriesSonificationTracksMappingTimeWithin.Chart;
		...
		/// </summary>
		public FunnelSeriesSonificationTracksMappingTimeMapFunction MapFunction { get; set; }
		private FunnelSeriesSonificationTracksMappingTimeMapFunction MapFunction_DefaultValue { get; set; }
		...
		/// </summary>
		public FunnelSeriesSonificationTracksMappingTimeWithin Within { get; set; }
		private FunnelSeriesSonificationTracksMappingTimeWithin Within_DefaultValue { get; set; }
