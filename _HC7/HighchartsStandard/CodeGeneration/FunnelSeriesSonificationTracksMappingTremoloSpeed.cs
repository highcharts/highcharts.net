...
{
	public partial class FunnelSeriesSonificationTracksMappingTremoloSpeed  : BaseObject
	{
		Hashtable h = new Hashtable();

		public FunnelSeriesSonificationTracksMappingTremoloSpeed()
		{
			MapFunction = MapFunction_DefaultValue = FunnelSeriesSonificationTracksMappingTremoloSpeedMapFunction.Linear;
			MapTo = MapTo_DefaultValue = "";
			Max = Max_DefaultValue = null;
			Min = Min_DefaultValue = null;
			Value = Value_DefaultValue = null;
			Within = Within_DefaultValue = FunnelSeriesSonificationTracksMappingTremoloSpeedWithin.Chart;
		...
		/// </summary>
		public FunnelSeriesSonificationTracksMappingTremoloSpeedMapFunction MapFunction { get; set; }
		private FunnelSeriesSonificationTracksMappingTremoloSpeedMapFunction MapFunction_DefaultValue { get; set; }
		...
		/// </summary>
		public FunnelSeriesSonificationTracksMappingTremoloSpeedWithin Within { get; set; }
		private FunnelSeriesSonificationTracksMappingTremoloSpeedWithin Within_DefaultValue { get; set; }
