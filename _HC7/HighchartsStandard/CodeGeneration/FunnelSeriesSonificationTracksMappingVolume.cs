...
{
	public partial class FunnelSeriesSonificationTracksMappingVolume  : BaseObject
	{
		Hashtable h = new Hashtable();

		public FunnelSeriesSonificationTracksMappingVolume()
		{
			MapFunction = MapFunction_DefaultValue = FunnelSeriesSonificationTracksMappingVolumeMapFunction.Linear;
			MapTo = MapTo_DefaultValue = "";
			Max = Max_DefaultValue = null;
			Min = Min_DefaultValue = null;
			Value = Value_DefaultValue = null;
			Within = Within_DefaultValue = FunnelSeriesSonificationTracksMappingVolumeWithin.Chart;
		...
		/// </summary>
		public FunnelSeriesSonificationTracksMappingVolumeMapFunction MapFunction { get; set; }
		private FunnelSeriesSonificationTracksMappingVolumeMapFunction MapFunction_DefaultValue { get; set; }
		...
		/// </summary>
		public FunnelSeriesSonificationTracksMappingVolumeWithin Within { get; set; }
		private FunnelSeriesSonificationTracksMappingVolumeWithin Within_DefaultValue { get; set; }
