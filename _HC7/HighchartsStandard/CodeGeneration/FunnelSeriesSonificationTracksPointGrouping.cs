...
{
	public partial class FunnelSeriesSonificationTracksPointGrouping  : BaseObject
	{
		Hashtable h = new Hashtable();

		public FunnelSeriesSonificationTracksPointGrouping()
		{
		...
		/// </summary>
		public FunnelSeriesSonificationTracksPointGroupingAlgorithm Algorithm { get; set; }
		private FunnelSeriesSonificationTracksPointGroupingAlgorithm Algorithm_DefaultValue { get; set; }
		...
		internal override Hashtable ToHashtable(Highcharts highcharts)
		{
			...
			if (Algorithm != FunnelSeriesSonificationTracksPointGroupingAlgorithm.Null) h.Add("algorithm", highcharts.FirstCharacterToLower(Algorithm.ToString()));
