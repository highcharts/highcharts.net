...
{
	public partial class FunnelSeriesTooltip  : BaseObject
	{
		public FunnelSeriesTooltip()
		{
			...
			HeaderShape = HeaderShape_DefaultValue = FunnelSeriesTooltipHeaderShape.Callout;
		...
		/// </summary>
		public FunnelSeriesTooltipHeaderShape HeaderShape { get; set; }
		private FunnelSeriesTooltipHeaderShape HeaderShape_DefaultValue { get; set; }
		...
		internal override Hashtable ToHashtable()
		{
			...
			if (NullFormatter != NullFormatter_DefaultValue) { h.Add("nullFormatter",NullFormatter); Highcharts.AddFunction("a619839a-21e8-4504-824f-f765d8ffa8f6.nullFormatter", NullFormatter); }  
			if (Outside != Outside_DefaultValue) h.Add("outside",Outside);
			if (Padding != Padding_DefaultValue) h.Add("padding",Padding);
			if (PointFormat != PointFormat_DefaultValue) h.Add("pointFormat",PointFormat);
			if (PointFormatter != PointFormatter_DefaultValue) { h.Add("pointFormatter",PointFormatter); Highcharts.AddFunction("a5cfd80f-27cc-4232-aeff-72a9b39f86bc.pointFormatter", PointFormatter); }  
