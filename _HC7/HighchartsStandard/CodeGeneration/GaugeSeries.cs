...
namespace Highsoft.Web.Mvc.Charts
{
	public partial class GaugeSeries  : Series
	{
		...
		internal override Hashtable ToHashtable()
		{
			...
			if (PointDescriptionFormatter != PointDescriptionFormatter_DefaultValue) { h.Add("pointDescriptionFormatter",PointDescriptionFormatter); Highcharts.AddFunction("308ddd75-1641-4948-9471-65fb06656e25.pointDescriptionFormatter", PointDescriptionFormatter); }  
