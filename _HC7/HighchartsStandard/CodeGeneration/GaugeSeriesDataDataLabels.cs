...
{
	public partial class GaugeSeriesDataDataLabels  : BaseObject
	{
		Hashtable h = new Hashtable();

		public GaugeSeriesDataDataLabels()
		{
		...
		/// </summary>
		public GaugeSeriesDataDataLabelsAlign Align { get; set; }
		private GaugeSeriesDataDataLabelsAlign Align_DefaultValue { get; set; }
		...
		/// </summary>
		public GaugeSeriesDataDataLabelsFilter Filter { get; set; }
		private GaugeSeriesDataDataLabelsFilter Filter_DefaultValue { get; set; }
		...
		/// </summary>
		public GaugeSeriesDataDataLabelsOverflow Overflow { get; set; }
		private GaugeSeriesDataDataLabelsOverflow Overflow_DefaultValue { get; set; }
		...
		/// </summary>
		public GaugeSeriesDataDataLabelsPosition Position { get; set; }
		private GaugeSeriesDataDataLabelsPosition Position_DefaultValue { get; set; }
		...
		/// </summary>
		public GaugeSeriesDataDataLabelsTextPath TextPath { get; set; }
		private GaugeSeriesDataDataLabelsTextPath TextPath_DefaultValue { get; set; }
		...
		/// </summary>
		public GaugeSeriesDataDataLabelsVerticalAlign VerticalAlign { get; set; }
		private GaugeSeriesDataDataLabelsVerticalAlign VerticalAlign_DefaultValue { get; set; }
		...
		internal override Hashtable ToHashtable(Highcharts highcharts)
		{
			...
			if (Align != GaugeSeriesDataDataLabelsAlign.Null) h.Add("align", highcharts.FirstCharacterToLower(Align.ToString()));
			...
			if (Overflow != GaugeSeriesDataDataLabelsOverflow.Null) h.Add("overflow", highcharts.FirstCharacterToLower(Overflow.ToString()));
			if (Padding != null) h.Add("padding",Padding);
			if (Position != GaugeSeriesDataDataLabelsPosition.Null) h.Add("position", highcharts.FirstCharacterToLower(Position.ToString()));
			...
			if (VerticalAlign != GaugeSeriesDataDataLabelsVerticalAlign.Null) h.Add("verticalAlign", highcharts.FirstCharacterToLower(VerticalAlign.ToString()));
			if (X != null) h.Add("x",X);
			if (Y != null) h.Add("y",Y);
