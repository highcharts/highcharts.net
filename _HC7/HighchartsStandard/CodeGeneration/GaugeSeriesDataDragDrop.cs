...
{
	public partial class GaugeSeriesDataDragDrop  : BaseObject
	{
		public GaugeSeriesDataDragDrop()
		{
			DraggableX = DraggableX_DefaultValue = null;
			DraggableY = DraggableY_DefaultValue = null;
			DragHandle = DragHandle_DefaultValue = new GaugeSeriesDataDragDropDragHandle();
			...
			GuideBox = GuideBox_DefaultValue = new GaugeSeriesDataDragDropGuideBox();
		...
		/// </summary>
		public GaugeSeriesDataDragDropDragHandle DragHandle { get; set; }
		private GaugeSeriesDataDragDropDragHandle DragHandle_DefaultValue { get; set; }
		...
		/// </summary>
		public GaugeSeriesDataDragDropGuideBox GuideBox { get; set; }
		private GaugeSeriesDataDragDropGuideBox GuideBox_DefaultValue { get; set; }
