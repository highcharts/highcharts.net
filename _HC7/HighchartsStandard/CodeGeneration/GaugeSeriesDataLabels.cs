...
namespace Highsoft.Web.Mvc.Charts
{
	public partial class GaugeSeriesDataLabels  : BaseObject
	{
		...
		{
			Align = Align_DefaultValue = GaugeSeriesDataLabelsAlign.Left;
		...
		internal override Hashtable ToHashtable()
		{
			...
			if (Formatter != Formatter_DefaultValue) { h.Add("formatter",Formatter); Highcharts.AddFunction("a0662c79-6369-450a-8230-4f8f6d2d262a.formatter", Formatter); }  
