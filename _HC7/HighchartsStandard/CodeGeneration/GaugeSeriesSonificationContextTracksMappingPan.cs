...
{
	public partial class GaugeSeriesSonificationContextTracksMappingPan  : BaseObject
	{
		Hashtable h = new Hashtable();

		public GaugeSeriesSonificationContextTracksMappingPan()
		{
			MapFunction = MapFunction_DefaultValue = GaugeSeriesSonificationContextTracksMappingPanMapFunction.Linear;
			MapTo = MapTo_DefaultValue = "";
			Max = Max_DefaultValue = null;
			Min = Min_DefaultValue = null;
			Value = Value_DefaultValue = null;
			Within = Within_DefaultValue = GaugeSeriesSonificationContextTracksMappingPanWithin.Chart;
		...
		/// </summary>
		public GaugeSeriesSonificationContextTracksMappingPanMapFunction MapFunction { get; set; }
		private GaugeSeriesSonificationContextTracksMappingPanMapFunction MapFunction_DefaultValue { get; set; }
		...
		/// </summary>
		public GaugeSeriesSonificationContextTracksMappingPanWithin Within { get; set; }
		private GaugeSeriesSonificationContextTracksMappingPanWithin Within_DefaultValue { get; set; }
