...
{
	public partial class GaugeSeriesSonificationContextTracksMappingVolume  : BaseObject
	{
		Hashtable h = new Hashtable();

		public GaugeSeriesSonificationContextTracksMappingVolume()
		{
			MapFunction = MapFunction_DefaultValue = GaugeSeriesSonificationContextTracksMappingVolumeMapFunction.Linear;
			MapTo = MapTo_DefaultValue = "";
			Max = Max_DefaultValue = null;
			Min = Min_DefaultValue = null;
			Value = Value_DefaultValue = null;
			Within = Within_DefaultValue = GaugeSeriesSonificationContextTracksMappingVolumeWithin.Chart;
		...
		/// </summary>
		public GaugeSeriesSonificationContextTracksMappingVolumeMapFunction MapFunction { get; set; }
		private GaugeSeriesSonificationContextTracksMappingVolumeMapFunction MapFunction_DefaultValue { get; set; }
		...
		/// </summary>
		public GaugeSeriesSonificationContextTracksMappingVolumeWithin Within { get; set; }
		private GaugeSeriesSonificationContextTracksMappingVolumeWithin Within_DefaultValue { get; set; }
