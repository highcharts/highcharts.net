...
{
	public partial class GaugeSeriesSonificationDefaultSpeechOptionsMappingLowpassFrequency  : BaseObject
	{
		Hashtable h = new Hashtable();

		public GaugeSeriesSonificationDefaultSpeechOptionsMappingLowpassFrequency()
		{
			MapFunction = MapFunction_DefaultValue = GaugeSeriesSonificationDefaultSpeechOptionsMappingLowpassFrequencyMapFunction.Linear;
			MapTo = MapTo_DefaultValue = "";
			Max = Max_DefaultValue = null;
			Min = Min_DefaultValue = null;
			Value = Value_DefaultValue = null;
			Within = Within_DefaultValue = GaugeSeriesSonificationDefaultSpeechOptionsMappingLowpassFrequencyWithin.Chart;
		...
		/// </summary>
		public GaugeSeriesSonificationDefaultSpeechOptionsMappingLowpassFrequencyMapFunction MapFunction { get; set; }
		private GaugeSeriesSonificationDefaultSpeechOptionsMappingLowpassFrequencyMapFunction MapFunction_DefaultValue { get; set; }
		...
		/// </summary>
		public GaugeSeriesSonificationDefaultSpeechOptionsMappingLowpassFrequencyWithin Within { get; set; }
		private GaugeSeriesSonificationDefaultSpeechOptionsMappingLowpassFrequencyWithin Within_DefaultValue { get; set; }
