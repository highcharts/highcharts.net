...
{
	public partial class GaugeSeriesSonificationPointGrouping  : BaseObject
	{
		Hashtable h = new Hashtable();

		public GaugeSeriesSonificationPointGrouping()
		{
		...
		/// </summary>
		public GaugeSeriesSonificationPointGroupingAlgorithm Algorithm { get; set; }
		private GaugeSeriesSonificationPointGroupingAlgorithm Algorithm_DefaultValue { get; set; }
		...
		internal override Hashtable ToHashtable(Highcharts highcharts)
		{
			...
			if (Algorithm != GaugeSeriesSonificationPointGroupingAlgorithm.Null) h.Add("algorithm", highcharts.FirstCharacterToLower(Algorithm.ToString()));
