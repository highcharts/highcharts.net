...
{
	public partial class GaugeSeriesSonificationTracksMappingFrequency  : BaseObject
	{
		Hashtable h = new Hashtable();

		public GaugeSeriesSonificationTracksMappingFrequency()
		{
			MapFunction = MapFunction_DefaultValue = GaugeSeriesSonificationTracksMappingFrequencyMapFunction.Linear;
			MapTo = MapTo_DefaultValue = "";
			Max = Max_DefaultValue = null;
			Min = Min_DefaultValue = null;
			Value = Value_DefaultValue = null;
			Within = Within_DefaultValue = GaugeSeriesSonificationTracksMappingFrequencyWithin.Chart;
		...
		/// </summary>
		public GaugeSeriesSonificationTracksMappingFrequencyMapFunction MapFunction { get; set; }
		private GaugeSeriesSonificationTracksMappingFrequencyMapFunction MapFunction_DefaultValue { get; set; }
		...
		/// </summary>
		public GaugeSeriesSonificationTracksMappingFrequencyWithin Within { get; set; }
		private GaugeSeriesSonificationTracksMappingFrequencyWithin Within_DefaultValue { get; set; }
