...
{
	public partial class GaugeSeriesSonificationTracksMappingHighpassFrequency  : BaseObject
	{
		Hashtable h = new Hashtable();

		public GaugeSeriesSonificationTracksMappingHighpassFrequency()
		{
			MapFunction = MapFunction_DefaultValue = GaugeSeriesSonificationTracksMappingHighpassFrequencyMapFunction.Linear;
			MapTo = MapTo_DefaultValue = "";
			Max = Max_DefaultValue = null;
			Min = Min_DefaultValue = null;
			Value = Value_DefaultValue = null;
			Within = Within_DefaultValue = GaugeSeriesSonificationTracksMappingHighpassFrequencyWithin.Chart;
		...
		/// </summary>
		public GaugeSeriesSonificationTracksMappingHighpassFrequencyMapFunction MapFunction { get; set; }
		private GaugeSeriesSonificationTracksMappingHighpassFrequencyMapFunction MapFunction_DefaultValue { get; set; }
		...
		/// </summary>
		public GaugeSeriesSonificationTracksMappingHighpassFrequencyWithin Within { get; set; }
		private GaugeSeriesSonificationTracksMappingHighpassFrequencyWithin Within_DefaultValue { get; set; }
