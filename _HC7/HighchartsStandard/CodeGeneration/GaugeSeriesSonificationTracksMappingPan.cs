...
{
	public partial class GaugeSeriesSonificationTracksMappingPan  : BaseObject
	{
		Hashtable h = new Hashtable();

		public GaugeSeriesSonificationTracksMappingPan()
		{
			MapFunction = MapFunction_DefaultValue = GaugeSeriesSonificationTracksMappingPanMapFunction.Linear;
			MapTo = MapTo_DefaultValue = "";
			Max = Max_DefaultValue = null;
			Min = Min_DefaultValue = null;
			Value = Value_DefaultValue = null;
			Within = Within_DefaultValue = GaugeSeriesSonificationTracksMappingPanWithin.Chart;
		...
		/// </summary>
		public GaugeSeriesSonificationTracksMappingPanMapFunction MapFunction { get; set; }
		private GaugeSeriesSonificationTracksMappingPanMapFunction MapFunction_DefaultValue { get; set; }
		...
		/// </summary>
		public GaugeSeriesSonificationTracksMappingPanWithin Within { get; set; }
		private GaugeSeriesSonificationTracksMappingPanWithin Within_DefaultValue { get; set; }
