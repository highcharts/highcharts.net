...
{
	public partial class GaugeSeriesSonificationTracksMappingPitch  : BaseObject
	{
		Hashtable h = new Hashtable();

		public GaugeSeriesSonificationTracksMappingPitch()
		{
			MapFunction = MapFunction_DefaultValue = GaugeSeriesSonificationTracksMappingPitchMapFunction.Linear;
		...
		/// </summary>
		public GaugeSeriesSonificationTracksMappingPitchMapFunction MapFunction { get; set; }
		private GaugeSeriesSonificationTracksMappingPitchMapFunction MapFunction_DefaultValue { get; set; }
