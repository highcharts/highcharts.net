...
{
	public partial class GaugeSeriesSonificationTracksMappingPlayDelay  : BaseObject
	{
		Hashtable h = new Hashtable();

		public GaugeSeriesSonificationTracksMappingPlayDelay()
		{
			MapFunction = MapFunction_DefaultValue = GaugeSeriesSonificationTracksMappingPlayDelayMapFunction.Linear;
			MapTo = MapTo_DefaultValue = "";
			Max = Max_DefaultValue = null;
			Min = Min_DefaultValue = null;
			Value = Value_DefaultValue = null;
			Within = Within_DefaultValue = GaugeSeriesSonificationTracksMappingPlayDelayWithin.Chart;
		...
		/// </summary>
		public GaugeSeriesSonificationTracksMappingPlayDelayMapFunction MapFunction { get; set; }
		private GaugeSeriesSonificationTracksMappingPlayDelayMapFunction MapFunction_DefaultValue { get; set; }
		...
		/// </summary>
		public GaugeSeriesSonificationTracksMappingPlayDelayWithin Within { get; set; }
		private GaugeSeriesSonificationTracksMappingPlayDelayWithin Within_DefaultValue { get; set; }
