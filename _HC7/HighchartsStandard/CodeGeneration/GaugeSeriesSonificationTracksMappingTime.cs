...
{
	public partial class GaugeSeriesSonificationTracksMappingTime  : BaseObject
	{
		Hashtable h = new Hashtable();

		public GaugeSeriesSonificationTracksMappingTime()
		{
			MapFunction = MapFunction_DefaultValue = GaugeSeriesSonificationTracksMappingTimeMapFunction.Linear;
			MapTo = MapTo_DefaultValue = "";
			Max = Max_DefaultValue = null;
			Min = Min_DefaultValue = null;
			Value = Value_DefaultValue = null;
			Within = Within_DefaultValue = GaugeSeriesSonificationTracksMappingTimeWithin.Chart;
		...
		/// </summary>
		public GaugeSeriesSonificationTracksMappingTimeMapFunction MapFunction { get; set; }
		private GaugeSeriesSonificationTracksMappingTimeMapFunction MapFunction_DefaultValue { get; set; }
		...
		/// </summary>
		public GaugeSeriesSonificationTracksMappingTimeWithin Within { get; set; }
		private GaugeSeriesSonificationTracksMappingTimeWithin Within_DefaultValue { get; set; }
