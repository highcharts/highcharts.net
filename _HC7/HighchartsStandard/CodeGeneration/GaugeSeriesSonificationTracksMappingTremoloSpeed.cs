...
{
	public partial class GaugeSeriesSonificationTracksMappingTremoloSpeed  : BaseObject
	{
		Hashtable h = new Hashtable();

		public GaugeSeriesSonificationTracksMappingTremoloSpeed()
		{
			MapFunction = MapFunction_DefaultValue = GaugeSeriesSonificationTracksMappingTremoloSpeedMapFunction.Linear;
			MapTo = MapTo_DefaultValue = "";
			Max = Max_DefaultValue = null;
			Min = Min_DefaultValue = null;
			Value = Value_DefaultValue = null;
			Within = Within_DefaultValue = GaugeSeriesSonificationTracksMappingTremoloSpeedWithin.Chart;
		...
		/// </summary>
		public GaugeSeriesSonificationTracksMappingTremoloSpeedMapFunction MapFunction { get; set; }
		private GaugeSeriesSonificationTracksMappingTremoloSpeedMapFunction MapFunction_DefaultValue { get; set; }
		...
		/// </summary>
		public GaugeSeriesSonificationTracksMappingTremoloSpeedWithin Within { get; set; }
		private GaugeSeriesSonificationTracksMappingTremoloSpeedWithin Within_DefaultValue { get; set; }
