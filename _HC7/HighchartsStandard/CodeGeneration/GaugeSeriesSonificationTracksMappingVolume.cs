...
{
	public partial class GaugeSeriesSonificationTracksMappingVolume  : BaseObject
	{
		Hashtable h = new Hashtable();

		public GaugeSeriesSonificationTracksMappingVolume()
		{
			MapFunction = MapFunction_DefaultValue = GaugeSeriesSonificationTracksMappingVolumeMapFunction.Linear;
			MapTo = MapTo_DefaultValue = "";
			Max = Max_DefaultValue = null;
			Min = Min_DefaultValue = null;
			Value = Value_DefaultValue = null;
			Within = Within_DefaultValue = GaugeSeriesSonificationTracksMappingVolumeWithin.Chart;
		...
		/// </summary>
		public GaugeSeriesSonificationTracksMappingVolumeMapFunction MapFunction { get; set; }
		private GaugeSeriesSonificationTracksMappingVolumeMapFunction MapFunction_DefaultValue { get; set; }
		...
		/// </summary>
		public GaugeSeriesSonificationTracksMappingVolumeWithin Within { get; set; }
		private GaugeSeriesSonificationTracksMappingVolumeWithin Within_DefaultValue { get; set; }
