...
{
	public partial class GaugeSeriesSonificationTracksPointGrouping  : BaseObject
	{
		Hashtable h = new Hashtable();

		public GaugeSeriesSonificationTracksPointGrouping()
		{
		...
		/// </summary>
		public GaugeSeriesSonificationTracksPointGroupingAlgorithm Algorithm { get; set; }
		private GaugeSeriesSonificationTracksPointGroupingAlgorithm Algorithm_DefaultValue { get; set; }
		...
		internal override Hashtable ToHashtable(Highcharts highcharts)
		{
			...
			if (Algorithm != GaugeSeriesSonificationTracksPointGroupingAlgorithm.Null) h.Add("algorithm", highcharts.FirstCharacterToLower(Algorithm.ToString()));
