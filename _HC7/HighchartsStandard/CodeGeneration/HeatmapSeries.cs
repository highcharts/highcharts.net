...
namespace Highsoft.Web.Mvc.Charts
{
	public partial class HeatmapSeries  : Series
	{
		...
		internal override Hashtable ToHashtable()
		{
			...
			if (PointDescriptionFormatter != PointDescriptionFormatter_DefaultValue) { h.Add("pointDescriptionFormatter",PointDescriptionFormatter); Highcharts.AddFunction("2db3e965-8200-458d-884b-882b9f5bfa5f.pointDescriptionFormatter", PointDescriptionFormatter); }  
