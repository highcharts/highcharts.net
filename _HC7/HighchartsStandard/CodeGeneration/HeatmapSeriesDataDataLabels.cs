...
{
	public partial class HeatmapSeriesDataDataLabels  : BaseObject
	{
		Hashtable h = new Hashtable();

		public HeatmapSeriesDataDataLabels()
		{
		...
		/// </summary>
		public HeatmapSeriesDataDataLabelsAlign Align { get; set; }
		private HeatmapSeriesDataDataLabelsAlign Align_DefaultValue { get; set; }
		...
		/// </summary>
		public HeatmapSeriesDataDataLabelsFilter Filter { get; set; }
		private HeatmapSeriesDataDataLabelsFilter Filter_DefaultValue { get; set; }
		...
		/// </summary>
		public HeatmapSeriesDataDataLabelsOverflow Overflow { get; set; }
		private HeatmapSeriesDataDataLabelsOverflow Overflow_DefaultValue { get; set; }
		...
		/// </summary>
		public HeatmapSeriesDataDataLabelsPosition Position { get; set; }
		private HeatmapSeriesDataDataLabelsPosition Position_DefaultValue { get; set; }
		...
		/// </summary>
		public HeatmapSeriesDataDataLabelsTextPath TextPath { get; set; }
		private HeatmapSeriesDataDataLabelsTextPath TextPath_DefaultValue { get; set; }
		...
		/// </summary>
		public HeatmapSeriesDataDataLabelsVerticalAlign VerticalAlign { get; set; }
		private HeatmapSeriesDataDataLabelsVerticalAlign VerticalAlign_DefaultValue { get; set; }
		...
		internal override Hashtable ToHashtable(Highcharts highcharts)
		{
			...
			if (Align != HeatmapSeriesDataDataLabelsAlign.Null) h.Add("align", highcharts.FirstCharacterToLower(Align.ToString()));
			...
			if (Overflow != HeatmapSeriesDataDataLabelsOverflow.Null) h.Add("overflow", highcharts.FirstCharacterToLower(Overflow.ToString()));
			if (Padding != null) h.Add("padding",Padding);
			if (Position != HeatmapSeriesDataDataLabelsPosition.Null) h.Add("position", highcharts.FirstCharacterToLower(Position.ToString()));
			...
			if (VerticalAlign != HeatmapSeriesDataDataLabelsVerticalAlign.Null) h.Add("verticalAlign", highcharts.FirstCharacterToLower(VerticalAlign.ToString()));
			if (X != null) h.Add("x",X);
			if (Y != null) h.Add("y",Y);
