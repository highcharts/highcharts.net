...
namespace Highsoft.Web.Mvc.Charts
{
	public partial class HeatmapSeriesDataLabels  : BaseObject
	{
		...
		/// </summary>
		public HeatmapSeriesDataLabelsAlign Align { get; set; }
		private HeatmapSeriesDataLabelsAlign Align_DefaultValue { get; set; }
		...
		/// </summary>
		public HeatmapSeriesDataLabelsPosition Position { get; set; }
		private HeatmapSeriesDataLabelsPosition Position_DefaultValue { get; set; }
		...
		/// </summary>
		public HeatmapSeriesDataLabelsTextPath TextPath { get; set; }
		private HeatmapSeriesDataLabelsTextPath TextPath_DefaultValue { get; set; }
		...
		internal override Hashtable ToHashtable(Highcharts highcharts)
		{
			...
			if (Align != HeatmapSeriesDataLabelsAlign.Null) h.Add("align", highcharts.FirstCharacterToLower(Align.ToString()));
			...
			if (Overflow != HeatmapSeriesDataLabelsOverflow.Null) h.Add("overflow", highcharts.FirstCharacterToLower(Overflow.ToString()));
			if (Padding != null) h.Add("padding",Padding);
			if (Position != HeatmapSeriesDataLabelsPosition.Null) h.Add("position", highcharts.FirstCharacterToLower(Position.ToString()));
			...
			if (VerticalAlign != HeatmapSeriesDataLabelsVerticalAlign.Null) h.Add("verticalAlign", highcharts.FirstCharacterToLower(VerticalAlign.ToString()));
			if (X != null) h.Add("x",X);
			if (Y != null) h.Add("y",Y);
