...
namespace Highsoft.Web.Mvc.Charts
{
	public partial class HeatmapSeriesDataLabels  : BaseObject
	{
		...
		{
			Align = Align_DefaultValue = HeatmapSeriesDataLabelsAlign.Left;
			...
			VerticalAlign = VerticalAlign_DefaultValue = HeatmapSeriesDataLabelsVerticalAlign.Top;
		...
		internal override Hashtable ToHashtable()
		{
			...
			if (Formatter != Formatter_DefaultValue) { h.Add("formatter",Formatter); Highcharts.AddFunction("c0edfcab-ffc0-4264-8d39-3097ae03f886.formatter", Formatter); }  
