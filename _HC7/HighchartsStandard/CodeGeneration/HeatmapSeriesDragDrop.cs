...
{
	public partial class HeatmapSeriesDragDrop  : BaseObject
	{
		public HeatmapSeriesDragDrop()
		{
			DraggableX = DraggableX_DefaultValue = null;
			DraggableY = DraggableY_DefaultValue = null;
			DragHandle = DragHandle_DefaultValue = new HeatmapSeriesDragDropDragHandle();
			...
			GuideBox = GuideBox_DefaultValue = new HeatmapSeriesDragDropGuideBox();
		...
		/// </summary>
		public HeatmapSeriesDragDropDragHandle DragHandle { get; set; }
		private HeatmapSeriesDragDropDragHandle DragHandle_DefaultValue { get; set; }
		...
		/// </summary>
		public HeatmapSeriesDragDropGuideBox GuideBox { get; set; }
		private HeatmapSeriesDragDropGuideBox GuideBox_DefaultValue { get; set; }
