...
{
	public partial class HeatmapSeriesSonificationContextTracks  : BaseObject
	{
		Hashtable h = new Hashtable();

		public HeatmapSeriesSonificationContextTracks()
		{
			ActiveWhen = ActiveWhen_DefaultValue = new HeatmapSeriesSonificationContextTracksActiveWhen();
			Instrument = Instrument_DefaultValue = null;
			InstrumentString = InstrumentString_DefaultValue = "null";
			Mapping = Mapping_DefaultValue = new HeatmapSeriesSonificationContextTracksMapping();
			MidiName = MidiName_DefaultValue = "";
			PointGrouping = PointGrouping_DefaultValue = new HeatmapSeriesSonificationContextTracksPointGrouping();
			...
			Type = Type_DefaultValue = HeatmapSeriesSonificationContextTracksType.Instrument;
			ValueInterval = ValueInterval_DefaultValue = null;
			ValueMapFunction = ValueMapFunction_DefaultValue = HeatmapSeriesSonificationContextTracksValueMapFunction.Linear;
		...
		/// </summary>
		public HeatmapSeriesSonificationContextTracksActiveWhen ActiveWhen { get; set; }
		private HeatmapSeriesSonificationContextTracksActiveWhen ActiveWhen_DefaultValue { get; set; }
		...
		/// </summary>
		public HeatmapSeriesSonificationContextTracksMapping Mapping { get; set; }
		private HeatmapSeriesSonificationContextTracksMapping Mapping_DefaultValue { get; set; }
		...
		/// </summary>
		public HeatmapSeriesSonificationContextTracksPointGrouping PointGrouping { get; set; }
		private HeatmapSeriesSonificationContextTracksPointGrouping PointGrouping_DefaultValue { get; set; }
		...
		/// </summary>
		public HeatmapSeriesSonificationContextTracksType Type { get; set; }
		private HeatmapSeriesSonificationContextTracksType Type_DefaultValue { get; set; }
		...
		/// </summary>
		public HeatmapSeriesSonificationContextTracksValueMapFunction ValueMapFunction { get; set; }
		private HeatmapSeriesSonificationContextTracksValueMapFunction ValueMapFunction_DefaultValue { get; set; }
