...
{
	public partial class HeatmapSeriesSonificationContextTracksMapping  : BaseObject
	{
		Hashtable h = new Hashtable();

		public HeatmapSeriesSonificationContextTracksMapping()
		{
			Frequency = Frequency_DefaultValue = new HeatmapSeriesSonificationContextTracksMappingFrequency();
			GapBetweenNotes = GapBetweenNotes_DefaultValue = new HeatmapSeriesSonificationContextTracksMappingGapBetweenNotes();
			Highpass = Highpass_DefaultValue = new HeatmapSeriesSonificationContextTracksMappingHighpass();
			Lowpass = Lowpass_DefaultValue = new HeatmapSeriesSonificationContextTracksMappingLowpass();
			NoteDuration = NoteDuration_DefaultValue = new HeatmapSeriesSonificationContextTracksMappingNoteDuration();
			Pan = Pan_DefaultValue = new HeatmapSeriesSonificationContextTracksMappingPan();
			Pitch = Pitch_DefaultValue = new HeatmapSeriesSonificationContextTracksMappingPitch();
			PitchString = PitchString_DefaultValue = "null";
			PitchNumber = PitchNumber_DefaultValue = null;
			PlayDelay = PlayDelay_DefaultValue = new HeatmapSeriesSonificationContextTracksMappingPlayDelay();
			Time = Time_DefaultValue = new HeatmapSeriesSonificationContextTracksMappingTime();
			TimeString = TimeString_DefaultValue = "null";
			TimeNumber = TimeNumber_DefaultValue = null;
			Tremolo = Tremolo_DefaultValue = new HeatmapSeriesSonificationContextTracksMappingTremolo();
			Volume = Volume_DefaultValue = new HeatmapSeriesSonificationContextTracksMappingVolume();
		...
		/// </summary>
		public HeatmapSeriesSonificationContextTracksMappingFrequency Frequency { get; set; }
		private HeatmapSeriesSonificationContextTracksMappingFrequency Frequency_DefaultValue { get; set; }
		...
		/// </summary>
		public HeatmapSeriesSonificationContextTracksMappingGapBetweenNotes GapBetweenNotes { get; set; }
		private HeatmapSeriesSonificationContextTracksMappingGapBetweenNotes GapBetweenNotes_DefaultValue { get; set; }
		...
		/// </summary>
		public HeatmapSeriesSonificationContextTracksMappingHighpass Highpass { get; set; }
		private HeatmapSeriesSonificationContextTracksMappingHighpass Highpass_DefaultValue { get; set; }
		...
		/// </summary>
		public HeatmapSeriesSonificationContextTracksMappingLowpass Lowpass { get; set; }
		private HeatmapSeriesSonificationContextTracksMappingLowpass Lowpass_DefaultValue { get; set; }
		...
		/// </summary>
		public HeatmapSeriesSonificationContextTracksMappingNoteDuration NoteDuration { get; set; }
		private HeatmapSeriesSonificationContextTracksMappingNoteDuration NoteDuration_DefaultValue { get; set; }
		...
		/// </summary>
		public HeatmapSeriesSonificationContextTracksMappingPan Pan { get; set; }
		private HeatmapSeriesSonificationContextTracksMappingPan Pan_DefaultValue { get; set; }
		...
		/// </summary>
		public HeatmapSeriesSonificationContextTracksMappingPitch Pitch { get; set; }
		private HeatmapSeriesSonificationContextTracksMappingPitch Pitch_DefaultValue { get; set; }
		...
		/// </summary>
		public HeatmapSeriesSonificationContextTracksMappingPlayDelay PlayDelay { get; set; }
		private HeatmapSeriesSonificationContextTracksMappingPlayDelay PlayDelay_DefaultValue { get; set; }
		...
		/// </summary>
		public HeatmapSeriesSonificationContextTracksMappingTime Time { get; set; }
		private HeatmapSeriesSonificationContextTracksMappingTime Time_DefaultValue { get; set; }
		...
		/// </summary>
		public HeatmapSeriesSonificationContextTracksMappingTremolo Tremolo { get; set; }
		private HeatmapSeriesSonificationContextTracksMappingTremolo Tremolo_DefaultValue { get; set; }
		 

		/// <summary>
		/// The volume of notes, from 0 to 1.
		/// </summary>
		public HeatmapSeriesSonificationContextTracksMappingVolume Volume { get; set; }
		private HeatmapSeriesSonificationContextTracksMappingVolume Volume_DefaultValue { get; set; }
