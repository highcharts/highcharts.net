...
{
	public partial class HeatmapSeriesSonificationContextTracksMappingLowpassResonance  : BaseObject
	{
		Hashtable h = new Hashtable();

		public HeatmapSeriesSonificationContextTracksMappingLowpassResonance()
		{
			MapFunction = MapFunction_DefaultValue = HeatmapSeriesSonificationContextTracksMappingLowpassResonanceMapFunction.Linear;
			MapTo = MapTo_DefaultValue = "";
			Max = Max_DefaultValue = null;
			Min = Min_DefaultValue = null;
			Value = Value_DefaultValue = null;
			Within = Within_DefaultValue = HeatmapSeriesSonificationContextTracksMappingLowpassResonanceWithin.Chart;
		...
		/// </summary>
		public HeatmapSeriesSonificationContextTracksMappingLowpassResonanceMapFunction MapFunction { get; set; }
		private HeatmapSeriesSonificationContextTracksMappingLowpassResonanceMapFunction MapFunction_DefaultValue { get; set; }
		...
		/// </summary>
		public HeatmapSeriesSonificationContextTracksMappingLowpassResonanceWithin Within { get; set; }
		private HeatmapSeriesSonificationContextTracksMappingLowpassResonanceWithin Within_DefaultValue { get; set; }
