...
{
	public partial class HeatmapSeriesSonificationContextTracksMappingPan  : BaseObject
	{
		Hashtable h = new Hashtable();

		public HeatmapSeriesSonificationContextTracksMappingPan()
		{
			MapFunction = MapFunction_DefaultValue = HeatmapSeriesSonificationContextTracksMappingPanMapFunction.Linear;
			MapTo = MapTo_DefaultValue = "";
			Max = Max_DefaultValue = null;
			Min = Min_DefaultValue = null;
			Value = Value_DefaultValue = null;
			Within = Within_DefaultValue = HeatmapSeriesSonificationContextTracksMappingPanWithin.Chart;
		...
		/// </summary>
		public HeatmapSeriesSonificationContextTracksMappingPanMapFunction MapFunction { get; set; }
		private HeatmapSeriesSonificationContextTracksMappingPanMapFunction MapFunction_DefaultValue { get; set; }
		...
		/// </summary>
		public HeatmapSeriesSonificationContextTracksMappingPanWithin Within { get; set; }
		private HeatmapSeriesSonificationContextTracksMappingPanWithin Within_DefaultValue { get; set; }
