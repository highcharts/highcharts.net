...
{
	public partial class HeatmapSeriesSonificationContextTracksMappingPitch  : BaseObject
	{
		Hashtable h = new Hashtable();

		public HeatmapSeriesSonificationContextTracksMappingPitch()
		{
			MapFunction = MapFunction_DefaultValue = HeatmapSeriesSonificationContextTracksMappingPitchMapFunction.Linear;
		...
		/// </summary>
		public HeatmapSeriesSonificationContextTracksMappingPitchMapFunction MapFunction { get; set; }
		private HeatmapSeriesSonificationContextTracksMappingPitchMapFunction MapFunction_DefaultValue { get; set; }
