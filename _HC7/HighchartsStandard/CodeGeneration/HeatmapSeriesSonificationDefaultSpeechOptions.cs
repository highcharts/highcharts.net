...
{
	public partial class HeatmapSeriesSonificationDefaultSpeechOptions  : BaseObject
	{
		Hashtable h = new Hashtable();

		public HeatmapSeriesSonificationDefaultSpeechOptions()
		{
			ActiveWhen = ActiveWhen_DefaultValue = new HeatmapSeriesSonificationDefaultSpeechOptionsActiveWhen();
			Language = Language_DefaultValue = "en-US";
			Mapping = Mapping_DefaultValue = new HeatmapSeriesSonificationDefaultSpeechOptionsMapping();
			PointGrouping = PointGrouping_DefaultValue = new HeatmapSeriesSonificationDefaultSpeechOptionsPointGrouping();
			PreferredVoice = PreferredVoice_DefaultValue = "";
			ShowPlayMarker = ShowPlayMarker_DefaultValue = true;
			Type = Type_DefaultValue = HeatmapSeriesSonificationDefaultSpeechOptionsType.Instrument;
		...
		/// </summary>
		public HeatmapSeriesSonificationDefaultSpeechOptionsActiveWhen ActiveWhen { get; set; }
		private HeatmapSeriesSonificationDefaultSpeechOptionsActiveWhen ActiveWhen_DefaultValue { get; set; }
		...
		/// </summary>
		public HeatmapSeriesSonificationDefaultSpeechOptionsMapping Mapping { get; set; }
		private HeatmapSeriesSonificationDefaultSpeechOptionsMapping Mapping_DefaultValue { get; set; }
		 

		/// <summary>
		/// Options for point grouping, specifically for instrument tracks.
		/// </summary>
		public HeatmapSeriesSonificationDefaultSpeechOptionsPointGrouping PointGrouping { get; set; }
		private HeatmapSeriesSonificationDefaultSpeechOptionsPointGrouping PointGrouping_DefaultValue { get; set; }
		...
		/// </summary>
		public HeatmapSeriesSonificationDefaultSpeechOptionsType Type { get; set; }
		private HeatmapSeriesSonificationDefaultSpeechOptionsType Type_DefaultValue { get; set; }
