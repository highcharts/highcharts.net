...
{
	public partial class HeatmapSeriesSonificationDefaultSpeechOptionsMapping  : BaseObject
	{
		Hashtable h = new Hashtable();

		public HeatmapSeriesSonificationDefaultSpeechOptionsMapping()
		{
			Frequency = Frequency_DefaultValue = new HeatmapSeriesSonificationDefaultSpeechOptionsMappingFrequency();
			GapBetweenNotes = GapBetweenNotes_DefaultValue = new HeatmapSeriesSonificationDefaultSpeechOptionsMappingGapBetweenNotes();
			Highpass = Highpass_DefaultValue = new HeatmapSeriesSonificationDefaultSpeechOptionsMappingHighpass();
			Lowpass = Lowpass_DefaultValue = new HeatmapSeriesSonificationDefaultSpeechOptionsMappingLowpass();
			NoteDuration = NoteDuration_DefaultValue = new HeatmapSeriesSonificationDefaultSpeechOptionsMappingNoteDuration();
			Pan = Pan_DefaultValue = new HeatmapSeriesSonificationDefaultSpeechOptionsMappingPan();
			Pitch = Pitch_DefaultValue = new HeatmapSeriesSonificationDefaultSpeechOptionsMappingPitch();
			PitchString = PitchString_DefaultValue = "null";
			PitchNumber = PitchNumber_DefaultValue = null;
			PlayDelay = PlayDelay_DefaultValue = new HeatmapSeriesSonificationDefaultSpeechOptionsMappingPlayDelay();
			Time = Time_DefaultValue = new HeatmapSeriesSonificationDefaultSpeechOptionsMappingTime();
			TimeString = TimeString_DefaultValue = "null";
			TimeNumber = TimeNumber_DefaultValue = null;
			Tremolo = Tremolo_DefaultValue = new HeatmapSeriesSonificationDefaultSpeechOptionsMappingTremolo();
			Volume = Volume_DefaultValue = new HeatmapSeriesSonificationDefaultSpeechOptionsMappingVolume();
		...
		/// </summary>
		public HeatmapSeriesSonificationDefaultSpeechOptionsMappingFrequency Frequency { get; set; }
		private HeatmapSeriesSonificationDefaultSpeechOptionsMappingFrequency Frequency_DefaultValue { get; set; }
		...
		/// </summary>
		public HeatmapSeriesSonificationDefaultSpeechOptionsMappingGapBetweenNotes GapBetweenNotes { get; set; }
		private HeatmapSeriesSonificationDefaultSpeechOptionsMappingGapBetweenNotes GapBetweenNotes_DefaultValue { get; set; }
		...
		/// </summary>
		public HeatmapSeriesSonificationDefaultSpeechOptionsMappingHighpass Highpass { get; set; }
		private HeatmapSeriesSonificationDefaultSpeechOptionsMappingHighpass Highpass_DefaultValue { get; set; }
		...
		/// </summary>
		public HeatmapSeriesSonificationDefaultSpeechOptionsMappingLowpass Lowpass { get; set; }
		private HeatmapSeriesSonificationDefaultSpeechOptionsMappingLowpass Lowpass_DefaultValue { get; set; }
		...
		/// </summary>
		public HeatmapSeriesSonificationDefaultSpeechOptionsMappingNoteDuration NoteDuration { get; set; }
		private HeatmapSeriesSonificationDefaultSpeechOptionsMappingNoteDuration NoteDuration_DefaultValue { get; set; }
		...
		/// </summary>
		public HeatmapSeriesSonificationDefaultSpeechOptionsMappingPan Pan { get; set; }
		private HeatmapSeriesSonificationDefaultSpeechOptionsMappingPan Pan_DefaultValue { get; set; }
		...
		/// </summary>
		public HeatmapSeriesSonificationDefaultSpeechOptionsMappingPitch Pitch { get; set; }
		private HeatmapSeriesSonificationDefaultSpeechOptionsMappingPitch Pitch_DefaultValue { get; set; }
		...
		/// </summary>
		public HeatmapSeriesSonificationDefaultSpeechOptionsMappingPlayDelay PlayDelay { get; set; }
		private HeatmapSeriesSonificationDefaultSpeechOptionsMappingPlayDelay PlayDelay_DefaultValue { get; set; }
		...
		/// </summary>
		public HeatmapSeriesSonificationDefaultSpeechOptionsMappingTime Time { get; set; }
		private HeatmapSeriesSonificationDefaultSpeechOptionsMappingTime Time_DefaultValue { get; set; }
		...
		/// </summary>
		public HeatmapSeriesSonificationDefaultSpeechOptionsMappingTremolo Tremolo { get; set; }
		private HeatmapSeriesSonificationDefaultSpeechOptionsMappingTremolo Tremolo_DefaultValue { get; set; }
		 

		/// <summary>
		/// The volume of notes, from 0 to 1.
		/// </summary>
		public HeatmapSeriesSonificationDefaultSpeechOptionsMappingVolume Volume { get; set; }
		private HeatmapSeriesSonificationDefaultSpeechOptionsMappingVolume Volume_DefaultValue { get; set; }
