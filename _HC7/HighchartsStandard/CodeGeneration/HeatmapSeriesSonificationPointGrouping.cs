...
{
	public partial class HeatmapSeriesSonificationPointGrouping  : BaseObject
	{
		Hashtable h = new Hashtable();

		public HeatmapSeriesSonificationPointGrouping()
		{
		...
		/// </summary>
		public HeatmapSeriesSonificationPointGroupingAlgorithm Algorithm { get; set; }
		private HeatmapSeriesSonificationPointGroupingAlgorithm Algorithm_DefaultValue { get; set; }
		...
		internal override Hashtable ToHashtable(Highcharts highcharts)
		{
			...
			if (Algorithm != HeatmapSeriesSonificationPointGroupingAlgorithm.Null) h.Add("algorithm", highcharts.FirstCharacterToLower(Algorithm.ToString()));
