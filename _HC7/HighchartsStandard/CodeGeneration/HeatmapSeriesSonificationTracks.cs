...
{
	public partial class HeatmapSeriesSonificationTracks  : BaseObject
	{
		Hashtable h = new Hashtable();

		public HeatmapSeriesSonificationTracks()
		{
			ActiveWhen = ActiveWhen_DefaultValue = new HeatmapSeriesSonificationTracksActiveWhen();
			Instrument = Instrument_DefaultValue = null;
			InstrumentString = InstrumentString_DefaultValue = "null";
			Mapping = Mapping_DefaultValue = new HeatmapSeriesSonificationTracksMapping();
			MidiName = MidiName_DefaultValue = "";
			PointGrouping = PointGrouping_DefaultValue = new HeatmapSeriesSonificationTracksPointGrouping();
			RoundToMusicalNotes = RoundToMusicalNotes_DefaultValue = true;
			ShowPlayMarker = ShowPlayMarker_DefaultValue = true;
			Type = Type_DefaultValue = HeatmapSeriesSonificationTracksType.Instrument;
		...
		/// </summary>
		public HeatmapSeriesSonificationTracksActiveWhen ActiveWhen { get; set; }
		private HeatmapSeriesSonificationTracksActiveWhen ActiveWhen_DefaultValue { get; set; }
		...
		/// </summary>
		public HeatmapSeriesSonificationTracksMapping Mapping { get; set; }
		private HeatmapSeriesSonificationTracksMapping Mapping_DefaultValue { get; set; }
		...
		/// </summary>
		public HeatmapSeriesSonificationTracksPointGrouping PointGrouping { get; set; }
		private HeatmapSeriesSonificationTracksPointGrouping PointGrouping_DefaultValue { get; set; }
		...
		/// </summary>
		public HeatmapSeriesSonificationTracksType Type { get; set; }
		private HeatmapSeriesSonificationTracksType Type_DefaultValue { get; set; }
