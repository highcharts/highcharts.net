...
{
	public partial class HeatmapSeriesSonificationTracksMapping  : BaseObject
	{
		Hashtable h = new Hashtable();

		public HeatmapSeriesSonificationTracksMapping()
		{
			Frequency = Frequency_DefaultValue = new HeatmapSeriesSonificationTracksMappingFrequency();
			GapBetweenNotes = GapBetweenNotes_DefaultValue = new HeatmapSeriesSonificationTracksMappingGapBetweenNotes();
			Highpass = Highpass_DefaultValue = new HeatmapSeriesSonificationTracksMappingHighpass();
			Lowpass = Lowpass_DefaultValue = new HeatmapSeriesSonificationTracksMappingLowpass();
			NoteDuration = NoteDuration_DefaultValue = new HeatmapSeriesSonificationTracksMappingNoteDuration();
			Pan = Pan_DefaultValue = new HeatmapSeriesSonificationTracksMappingPan();
			Pitch = Pitch_DefaultValue = new HeatmapSeriesSonificationTracksMappingPitch();
			PitchString = PitchString_DefaultValue = "null";
			PitchNumber = PitchNumber_DefaultValue = null;
			PlayDelay = PlayDelay_DefaultValue = new HeatmapSeriesSonificationTracksMappingPlayDelay();
			Time = Time_DefaultValue = new HeatmapSeriesSonificationTracksMappingTime();
			TimeString = TimeString_DefaultValue = "null";
			TimeNumber = TimeNumber_DefaultValue = null;
			Tremolo = Tremolo_DefaultValue = new HeatmapSeriesSonificationTracksMappingTremolo();
			Volume = Volume_DefaultValue = new HeatmapSeriesSonificationTracksMappingVolume();
		...
		/// </summary>
		public HeatmapSeriesSonificationTracksMappingFrequency Frequency { get; set; }
		private HeatmapSeriesSonificationTracksMappingFrequency Frequency_DefaultValue { get; set; }
		...
		/// </summary>
		public HeatmapSeriesSonificationTracksMappingGapBetweenNotes GapBetweenNotes { get; set; }
		private HeatmapSeriesSonificationTracksMappingGapBetweenNotes GapBetweenNotes_DefaultValue { get; set; }
		...
		/// </summary>
		public HeatmapSeriesSonificationTracksMappingHighpass Highpass { get; set; }
		private HeatmapSeriesSonificationTracksMappingHighpass Highpass_DefaultValue { get; set; }
		...
		/// </summary>
		public HeatmapSeriesSonificationTracksMappingLowpass Lowpass { get; set; }
		private HeatmapSeriesSonificationTracksMappingLowpass Lowpass_DefaultValue { get; set; }
		...
		/// </summary>
		public HeatmapSeriesSonificationTracksMappingNoteDuration NoteDuration { get; set; }
		private HeatmapSeriesSonificationTracksMappingNoteDuration NoteDuration_DefaultValue { get; set; }
		...
		/// </summary>
		public HeatmapSeriesSonificationTracksMappingPan Pan { get; set; }
		private HeatmapSeriesSonificationTracksMappingPan Pan_DefaultValue { get; set; }
		...
		/// </summary>
		public HeatmapSeriesSonificationTracksMappingPitch Pitch { get; set; }
		private HeatmapSeriesSonificationTracksMappingPitch Pitch_DefaultValue { get; set; }
		...
		/// </summary>
		public HeatmapSeriesSonificationTracksMappingPlayDelay PlayDelay { get; set; }
		private HeatmapSeriesSonificationTracksMappingPlayDelay PlayDelay_DefaultValue { get; set; }
		...
		/// </summary>
		public HeatmapSeriesSonificationTracksMappingTime Time { get; set; }
		private HeatmapSeriesSonificationTracksMappingTime Time_DefaultValue { get; set; }
		...
		/// </summary>
		public HeatmapSeriesSonificationTracksMappingTremolo Tremolo { get; set; }
		private HeatmapSeriesSonificationTracksMappingTremolo Tremolo_DefaultValue { get; set; }
		 

		/// <summary>
		/// The volume of notes, from 0 to 1.
		/// </summary>
		public HeatmapSeriesSonificationTracksMappingVolume Volume { get; set; }
		private HeatmapSeriesSonificationTracksMappingVolume Volume_DefaultValue { get; set; }
