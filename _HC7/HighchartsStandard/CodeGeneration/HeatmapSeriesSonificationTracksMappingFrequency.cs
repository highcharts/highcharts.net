...
{
	public partial class HeatmapSeriesSonificationTracksMappingFrequency  : BaseObject
	{
		Hashtable h = new Hashtable();

		public HeatmapSeriesSonificationTracksMappingFrequency()
		{
			MapFunction = MapFunction_DefaultValue = HeatmapSeriesSonificationTracksMappingFrequencyMapFunction.Linear;
			MapTo = MapTo_DefaultValue = "";
			Max = Max_DefaultValue = null;
			Min = Min_DefaultValue = null;
			Value = Value_DefaultValue = null;
			Within = Within_DefaultValue = HeatmapSeriesSonificationTracksMappingFrequencyWithin.Chart;
		...
		/// </summary>
		public HeatmapSeriesSonificationTracksMappingFrequencyMapFunction MapFunction { get; set; }
		private HeatmapSeriesSonificationTracksMappingFrequencyMapFunction MapFunction_DefaultValue { get; set; }
		...
		/// </summary>
		public HeatmapSeriesSonificationTracksMappingFrequencyWithin Within { get; set; }
		private HeatmapSeriesSonificationTracksMappingFrequencyWithin Within_DefaultValue { get; set; }
