...
{
	public partial class HeatmapSeriesSonificationTracksMappingLowpassResonance  : BaseObject
	{
		Hashtable h = new Hashtable();

		public HeatmapSeriesSonificationTracksMappingLowpassResonance()
		{
			MapFunction = MapFunction_DefaultValue = HeatmapSeriesSonificationTracksMappingLowpassResonanceMapFunction.Linear;
			MapTo = MapTo_DefaultValue = "";
			Max = Max_DefaultValue = null;
			Min = Min_DefaultValue = null;
			Value = Value_DefaultValue = null;
			Within = Within_DefaultValue = HeatmapSeriesSonificationTracksMappingLowpassResonanceWithin.Chart;
		...
		/// </summary>
		public HeatmapSeriesSonificationTracksMappingLowpassResonanceMapFunction MapFunction { get; set; }
		private HeatmapSeriesSonificationTracksMappingLowpassResonanceMapFunction MapFunction_DefaultValue { get; set; }
		...
		/// </summary>
		public HeatmapSeriesSonificationTracksMappingLowpassResonanceWithin Within { get; set; }
		private HeatmapSeriesSonificationTracksMappingLowpassResonanceWithin Within_DefaultValue { get; set; }
