...
{
	public partial class HeatmapSeriesSonificationTracksMappingNoteDuration  : BaseObject
	{
		Hashtable h = new Hashtable();

		public HeatmapSeriesSonificationTracksMappingNoteDuration()
		{
			MapFunction = MapFunction_DefaultValue = HeatmapSeriesSonificationTracksMappingNoteDurationMapFunction.Linear;
			MapTo = MapTo_DefaultValue = "";
			Max = Max_DefaultValue = null;
			Min = Min_DefaultValue = null;
			Value = Value_DefaultValue = null;
			Within = Within_DefaultValue = HeatmapSeriesSonificationTracksMappingNoteDurationWithin.Chart;
		...
		/// </summary>
		public HeatmapSeriesSonificationTracksMappingNoteDurationMapFunction MapFunction { get; set; }
		private HeatmapSeriesSonificationTracksMappingNoteDurationMapFunction MapFunction_DefaultValue { get; set; }
		...
		/// </summary>
		public HeatmapSeriesSonificationTracksMappingNoteDurationWithin Within { get; set; }
		private HeatmapSeriesSonificationTracksMappingNoteDurationWithin Within_DefaultValue { get; set; }
