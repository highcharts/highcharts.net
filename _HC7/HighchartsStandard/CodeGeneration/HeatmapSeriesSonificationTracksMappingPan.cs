...
{
	public partial class HeatmapSeriesSonificationTracksMappingPan  : BaseObject
	{
		Hashtable h = new Hashtable();

		public HeatmapSeriesSonificationTracksMappingPan()
		{
			MapFunction = MapFunction_DefaultValue = HeatmapSeriesSonificationTracksMappingPanMapFunction.Linear;
			MapTo = MapTo_DefaultValue = "";
			Max = Max_DefaultValue = null;
			Min = Min_DefaultValue = null;
			Value = Value_DefaultValue = null;
			Within = Within_DefaultValue = HeatmapSeriesSonificationTracksMappingPanWithin.Chart;
		...
		/// </summary>
		public HeatmapSeriesSonificationTracksMappingPanMapFunction MapFunction { get; set; }
		private HeatmapSeriesSonificationTracksMappingPanMapFunction MapFunction_DefaultValue { get; set; }
		...
		/// </summary>
		public HeatmapSeriesSonificationTracksMappingPanWithin Within { get; set; }
		private HeatmapSeriesSonificationTracksMappingPanWithin Within_DefaultValue { get; set; }
