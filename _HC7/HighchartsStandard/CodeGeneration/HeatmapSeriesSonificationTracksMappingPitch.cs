...
{
	public partial class HeatmapSeriesSonificationTracksMappingPitch  : BaseObject
	{
		Hashtable h = new Hashtable();

		public HeatmapSeriesSonificationTracksMappingPitch()
		{
			MapFunction = MapFunction_DefaultValue = HeatmapSeriesSonificationTracksMappingPitchMapFunction.Linear;
		...
		/// </summary>
		public HeatmapSeriesSonificationTracksMappingPitchMapFunction MapFunction { get; set; }
		private HeatmapSeriesSonificationTracksMappingPitchMapFunction MapFunction_DefaultValue { get; set; }
