...
{
	public partial class HeatmapSeriesSonificationTracksMappingPlayDelay  : BaseObject
	{
		Hashtable h = new Hashtable();

		public HeatmapSeriesSonificationTracksMappingPlayDelay()
		{
			MapFunction = MapFunction_DefaultValue = HeatmapSeriesSonificationTracksMappingPlayDelayMapFunction.Linear;
			MapTo = MapTo_DefaultValue = "";
			Max = Max_DefaultValue = null;
			Min = Min_DefaultValue = null;
			Value = Value_DefaultValue = null;
			Within = Within_DefaultValue = HeatmapSeriesSonificationTracksMappingPlayDelayWithin.Chart;
		...
		/// </summary>
		public HeatmapSeriesSonificationTracksMappingPlayDelayMapFunction MapFunction { get; set; }
		private HeatmapSeriesSonificationTracksMappingPlayDelayMapFunction MapFunction_DefaultValue { get; set; }
		...
		/// </summary>
		public HeatmapSeriesSonificationTracksMappingPlayDelayWithin Within { get; set; }
		private HeatmapSeriesSonificationTracksMappingPlayDelayWithin Within_DefaultValue { get; set; }
