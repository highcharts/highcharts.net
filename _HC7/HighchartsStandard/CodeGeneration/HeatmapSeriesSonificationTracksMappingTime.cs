...
{
	public partial class HeatmapSeriesSonificationTracksMappingTime  : BaseObject
	{
		Hashtable h = new Hashtable();

		public HeatmapSeriesSonificationTracksMappingTime()
		{
			MapFunction = MapFunction_DefaultValue = HeatmapSeriesSonificationTracksMappingTimeMapFunction.Linear;
			MapTo = MapTo_DefaultValue = "";
			Max = Max_DefaultValue = null;
			Min = Min_DefaultValue = null;
			Value = Value_DefaultValue = null;
			Within = Within_DefaultValue = HeatmapSeriesSonificationTracksMappingTimeWithin.Chart;
		...
		/// </summary>
		public HeatmapSeriesSonificationTracksMappingTimeMapFunction MapFunction { get; set; }
		private HeatmapSeriesSonificationTracksMappingTimeMapFunction MapFunction_DefaultValue { get; set; }
		...
		/// </summary>
		public HeatmapSeriesSonificationTracksMappingTimeWithin Within { get; set; }
		private HeatmapSeriesSonificationTracksMappingTimeWithin Within_DefaultValue { get; set; }
