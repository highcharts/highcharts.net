...
{
	public partial class HeatmapSeriesSonificationTracksMappingTremoloSpeed  : BaseObject
	{
		Hashtable h = new Hashtable();

		public HeatmapSeriesSonificationTracksMappingTremoloSpeed()
		{
			MapFunction = MapFunction_DefaultValue = HeatmapSeriesSonificationTracksMappingTremoloSpeedMapFunction.Linear;
			MapTo = MapTo_DefaultValue = "";
			Max = Max_DefaultValue = null;
			Min = Min_DefaultValue = null;
			Value = Value_DefaultValue = null;
			Within = Within_DefaultValue = HeatmapSeriesSonificationTracksMappingTremoloSpeedWithin.Chart;
		...
		/// </summary>
		public HeatmapSeriesSonificationTracksMappingTremoloSpeedMapFunction MapFunction { get; set; }
		private HeatmapSeriesSonificationTracksMappingTremoloSpeedMapFunction MapFunction_DefaultValue { get; set; }
		...
		/// </summary>
		public HeatmapSeriesSonificationTracksMappingTremoloSpeedWithin Within { get; set; }
		private HeatmapSeriesSonificationTracksMappingTremoloSpeedWithin Within_DefaultValue { get; set; }
