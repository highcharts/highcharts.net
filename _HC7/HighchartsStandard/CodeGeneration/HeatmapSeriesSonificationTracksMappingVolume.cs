...
{
	public partial class HeatmapSeriesSonificationTracksMappingVolume  : BaseObject
	{
		Hashtable h = new Hashtable();

		public HeatmapSeriesSonificationTracksMappingVolume()
		{
			MapFunction = MapFunction_DefaultValue = HeatmapSeriesSonificationTracksMappingVolumeMapFunction.Linear;
			MapTo = MapTo_DefaultValue = "";
			Max = Max_DefaultValue = null;
			Min = Min_DefaultValue = null;
			Value = Value_DefaultValue = null;
			Within = Within_DefaultValue = HeatmapSeriesSonificationTracksMappingVolumeWithin.Chart;
		...
		/// </summary>
		public HeatmapSeriesSonificationTracksMappingVolumeMapFunction MapFunction { get; set; }
		private HeatmapSeriesSonificationTracksMappingVolumeMapFunction MapFunction_DefaultValue { get; set; }
		...
		/// </summary>
		public HeatmapSeriesSonificationTracksMappingVolumeWithin Within { get; set; }
		private HeatmapSeriesSonificationTracksMappingVolumeWithin Within_DefaultValue { get; set; }
