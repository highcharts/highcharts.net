...
namespace Highsoft.Web.Mvc.Charts
{
	public partial class HeatmapSeriesStatesHoverMarker  : BaseObject
	{
		public HeatmapSeriesStatesHoverMarker()
		{
			...
			States = States_DefaultValue = new HeatmapSeriesStatesHoverMarkerStates();
		...
		/// </summary>
		public HeatmapSeriesStatesHoverMarkerStates States { get; set; }
		private HeatmapSeriesStatesHoverMarkerStates States_DefaultValue { get; set; }
