...
namespace Highsoft.Web.Mvc.Charts
{
	public partial class HistogramSeries  : Series
	{
		...
		public HistogramSeries()
		{
			...
			DashStyle = DashStyle_DefaultValue = HistogramSeriesDashStyle.Null;
			DataLabels = DataLabels_DefaultValue = new HistogramSeriesDataLabels();
			DataSorting = DataSorting_DefaultValue = new HistogramSeriesDataSorting();
			Depth = Depth_DefaultValue = 25;
			Description = Description_DefaultValue = "";
			Dumbell = Dumbell_DefaultValue = new HistogramSeriesDumbell();
			...
			LegendSymbol = LegendSymbol_DefaultValue = HistogramSeriesLegendSymbol.Rectangle;
			LinkedTo = LinkedTo_DefaultValue = "";
			MaxPointWidth = MaxPointWidth_DefaultValue = null;
			MinPointLength = MinPointLength_DefaultValue = 0;
			Name = Name_DefaultValue = "";
			NegativeColor = NegativeColor_DefaultValue = "";
			OnPoint = OnPoint_DefaultValue = new HistogramSeriesOnPoint();
			...
			Sonification = Sonification_DefaultValue = new HistogramSeriesSonification();
		...
		/// 
		/// </summary>
		public HistogramSeriesDumbell Dumbell { get; set; }
		private HistogramSeriesDumbell Dumbell_DefaultValue { get; set; }
