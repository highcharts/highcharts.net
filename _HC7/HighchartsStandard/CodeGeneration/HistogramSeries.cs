...
namespace Highsoft.Web.Mvc.Charts
{
	public partial class HistogramSeries  : Series
	{
		...
		/// </summary>
		public HistogramSeriesDataSorting DataSorting { get; set; }
		private HistogramSeriesDataSorting DataSorting_DefaultValue { get; set; }
		...
		/// </summary>
		public HistogramSeriesLegendSymbol LegendSymbol { get; set; }
		private HistogramSeriesLegendSymbol LegendSymbol_DefaultValue { get; set; }
		...
		/// </summary>
		public HistogramSeriesOnPoint OnPoint { get; set; }
		private HistogramSeriesOnPoint OnPoint_DefaultValue { get; set; }
		...
		/// </summary>
		public HistogramSeriesPointPlacement PointPlacement { get; set; }
		private HistogramSeriesPointPlacement PointPlacement_DefaultValue { get; set; }
		...
		/// </summary>
		public HistogramSeriesSonification Sonification { get; set; }
		private HistogramSeriesSonification Sonification_DefaultValue { get; set; }
		...
		internal override Hashtable ToHashtable(Highcharts highcharts)
		{
			...
			if (BinsNumber != HistogramSeriesBinsNumber.Null) h.Add("binsNumber", highcharts.FirstCharacterToLower(BinsNumber.ToString()));
			...
			if (Cursor != HistogramSeriesCursor.Null) h.Add("cursor", highcharts.FirstCharacterToLower(Cursor.ToString()));
			if (Custom != null) h.Add("custom",Custom);
			if (DashStyle != HistogramSeriesDashStyle.Null) h.Add("dashStyle", highcharts.FirstCharacterToLower(DashStyle.ToString()));
			...
			if (FindNearestPointBy != HistogramSeriesFindNearestPointBy.Null) h.Add("findNearestPointBy", highcharts.FirstCharacterToLower(FindNearestPointBy.ToString()));
			...
			if (LegendSymbol != HistogramSeriesLegendSymbol.Null) h.Add("legendSymbol", highcharts.FirstCharacterToLower(LegendSymbol.ToString()));
			...
			if (PointPlacement != HistogramSeriesPointPlacement.Null) h.Add("pointPlacement", highcharts.FirstCharacterToLower(PointPlacement.ToString()));
