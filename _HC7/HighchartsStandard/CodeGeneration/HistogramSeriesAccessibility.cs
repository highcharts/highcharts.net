...
namespace Highsoft.Web.Mvc.Charts
{
	public partial class HistogramSeriesAccessibility  : BaseObject
	{
		...
		public HistogramSeriesAccessibility()
		{
			...
			Point = Point_DefaultValue = new HistogramSeriesAccessibilityPoint();
		...
		/// </summary>
		public HistogramSeriesAccessibilityPoint Point { get; set; }
		private HistogramSeriesAccessibilityPoint Point_DefaultValue { get; set; }
