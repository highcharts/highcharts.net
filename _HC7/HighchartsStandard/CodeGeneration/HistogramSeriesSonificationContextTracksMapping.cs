...
{
	public partial class HistogramSeriesSonificationContextTracksMapping  : BaseObject
	{
		Hashtable h = new Hashtable();

		public HistogramSeriesSonificationContextTracksMapping()
		{
			Frequency = Frequency_DefaultValue = new HistogramSeriesSonificationContextTracksMappingFrequency();
			GapBetweenNotes = GapBetweenNotes_DefaultValue = new HistogramSeriesSonificationContextTracksMappingGapBetweenNotes();
			Highpass = Highpass_DefaultValue = new HistogramSeriesSonificationContextTracksMappingHighpass();
			Lowpass = Lowpass_DefaultValue = new HistogramSeriesSonificationContextTracksMappingLowpass();
			NoteDuration = NoteDuration_DefaultValue = new HistogramSeriesSonificationContextTracksMappingNoteDuration();
			Pan = Pan_DefaultValue = new HistogramSeriesSonificationContextTracksMappingPan();
			Pitch = Pitch_DefaultValue = new HistogramSeriesSonificationContextTracksMappingPitch();
			PitchString = PitchString_DefaultValue = "null";
			PitchNumber = PitchNumber_DefaultValue = null;
			PlayDelay = PlayDelay_DefaultValue = new HistogramSeriesSonificationContextTracksMappingPlayDelay();
			Time = Time_DefaultValue = new HistogramSeriesSonificationContextTracksMappingTime();
			TimeString = TimeString_DefaultValue = "null";
			TimeNumber = TimeNumber_DefaultValue = null;
			Tremolo = Tremolo_DefaultValue = new HistogramSeriesSonificationContextTracksMappingTremolo();
			Volume = Volume_DefaultValue = new HistogramSeriesSonificationContextTracksMappingVolume();
		...
		/// </summary>
		public HistogramSeriesSonificationContextTracksMappingFrequency Frequency { get; set; }
		private HistogramSeriesSonificationContextTracksMappingFrequency Frequency_DefaultValue { get; set; }
		...
		/// </summary>
		public HistogramSeriesSonificationContextTracksMappingGapBetweenNotes GapBetweenNotes { get; set; }
		private HistogramSeriesSonificationContextTracksMappingGapBetweenNotes GapBetweenNotes_DefaultValue { get; set; }
		...
		/// </summary>
		public HistogramSeriesSonificationContextTracksMappingHighpass Highpass { get; set; }
		private HistogramSeriesSonificationContextTracksMappingHighpass Highpass_DefaultValue { get; set; }
		...
		/// </summary>
		public HistogramSeriesSonificationContextTracksMappingLowpass Lowpass { get; set; }
		private HistogramSeriesSonificationContextTracksMappingLowpass Lowpass_DefaultValue { get; set; }
		...
		/// </summary>
		public HistogramSeriesSonificationContextTracksMappingNoteDuration NoteDuration { get; set; }
		private HistogramSeriesSonificationContextTracksMappingNoteDuration NoteDuration_DefaultValue { get; set; }
		...
		/// </summary>
		public HistogramSeriesSonificationContextTracksMappingPan Pan { get; set; }
		private HistogramSeriesSonificationContextTracksMappingPan Pan_DefaultValue { get; set; }
		...
		/// </summary>
		public HistogramSeriesSonificationContextTracksMappingPitch Pitch { get; set; }
		private HistogramSeriesSonificationContextTracksMappingPitch Pitch_DefaultValue { get; set; }
		...
		/// </summary>
		public HistogramSeriesSonificationContextTracksMappingPlayDelay PlayDelay { get; set; }
		private HistogramSeriesSonificationContextTracksMappingPlayDelay PlayDelay_DefaultValue { get; set; }
		...
		/// </summary>
		public HistogramSeriesSonificationContextTracksMappingTime Time { get; set; }
		private HistogramSeriesSonificationContextTracksMappingTime Time_DefaultValue { get; set; }
		...
		/// </summary>
		public HistogramSeriesSonificationContextTracksMappingTremolo Tremolo { get; set; }
		private HistogramSeriesSonificationContextTracksMappingTremolo Tremolo_DefaultValue { get; set; }
		 

		/// <summary>
		/// The volume of notes, from 0 to 1.
		/// </summary>
		public HistogramSeriesSonificationContextTracksMappingVolume Volume { get; set; }
		private HistogramSeriesSonificationContextTracksMappingVolume Volume_DefaultValue { get; set; }
