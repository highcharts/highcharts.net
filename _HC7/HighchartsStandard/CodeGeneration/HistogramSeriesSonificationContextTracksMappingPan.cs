...
{
	public partial class HistogramSeriesSonificationContextTracksMappingPan  : BaseObject
	{
		Hashtable h = new Hashtable();

		public HistogramSeriesSonificationContextTracksMappingPan()
		{
			MapFunction = MapFunction_DefaultValue = HistogramSeriesSonificationContextTracksMappingPanMapFunction.Linear;
			MapTo = MapTo_DefaultValue = "";
			Max = Max_DefaultValue = null;
			Min = Min_DefaultValue = null;
			Value = Value_DefaultValue = null;
			Within = Within_DefaultValue = HistogramSeriesSonificationContextTracksMappingPanWithin.Chart;
		...
		/// </summary>
		public HistogramSeriesSonificationContextTracksMappingPanMapFunction MapFunction { get; set; }
		private HistogramSeriesSonificationContextTracksMappingPanMapFunction MapFunction_DefaultValue { get; set; }
		...
		/// </summary>
		public HistogramSeriesSonificationContextTracksMappingPanWithin Within { get; set; }
		private HistogramSeriesSonificationContextTracksMappingPanWithin Within_DefaultValue { get; set; }
