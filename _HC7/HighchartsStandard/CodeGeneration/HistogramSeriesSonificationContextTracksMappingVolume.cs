...
{
	public partial class HistogramSeriesSonificationContextTracksMappingVolume  : BaseObject
	{
		Hashtable h = new Hashtable();

		public HistogramSeriesSonificationContextTracksMappingVolume()
		{
			MapFunction = MapFunction_DefaultValue = HistogramSeriesSonificationContextTracksMappingVolumeMapFunction.Linear;
			MapTo = MapTo_DefaultValue = "";
			Max = Max_DefaultValue = null;
			Min = Min_DefaultValue = null;
			Value = Value_DefaultValue = null;
			Within = Within_DefaultValue = HistogramSeriesSonificationContextTracksMappingVolumeWithin.Chart;
		...
		/// </summary>
		public HistogramSeriesSonificationContextTracksMappingVolumeMapFunction MapFunction { get; set; }
		private HistogramSeriesSonificationContextTracksMappingVolumeMapFunction MapFunction_DefaultValue { get; set; }
		...
		/// </summary>
		public HistogramSeriesSonificationContextTracksMappingVolumeWithin Within { get; set; }
		private HistogramSeriesSonificationContextTracksMappingVolumeWithin Within_DefaultValue { get; set; }
