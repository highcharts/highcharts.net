...
{
	public partial class HistogramSeriesSonificationDefaultInstrumentOptionsMappingPitch  : BaseObject
	{
		Hashtable h = new Hashtable();

		public HistogramSeriesSonificationDefaultInstrumentOptionsMappingPitch()
		{
			MapFunction = MapFunction_DefaultValue = HistogramSeriesSonificationDefaultInstrumentOptionsMappingPitchMapFunction.Linear;
		...
		/// </summary>
		public HistogramSeriesSonificationDefaultInstrumentOptionsMappingPitchMapFunction MapFunction { get; set; }
		private HistogramSeriesSonificationDefaultInstrumentOptionsMappingPitchMapFunction MapFunction_DefaultValue { get; set; }
