...
{
	public partial class HistogramSeriesSonificationDefaultSpeechOptions  : BaseObject
	{
		Hashtable h = new Hashtable();

		public HistogramSeriesSonificationDefaultSpeechOptions()
		{
			ActiveWhen = ActiveWhen_DefaultValue = new HistogramSeriesSonificationDefaultSpeechOptionsActiveWhen();
			Language = Language_DefaultValue = "en-US";
			Mapping = Mapping_DefaultValue = new HistogramSeriesSonificationDefaultSpeechOptionsMapping();
			PointGrouping = PointGrouping_DefaultValue = new HistogramSeriesSonificationDefaultSpeechOptionsPointGrouping();
			PreferredVoice = PreferredVoice_DefaultValue = "";
			ShowPlayMarker = ShowPlayMarker_DefaultValue = true;
			Type = Type_DefaultValue = HistogramSeriesSonificationDefaultSpeechOptionsType.Instrument;
		...
		/// </summary>
		public HistogramSeriesSonificationDefaultSpeechOptionsActiveWhen ActiveWhen { get; set; }
		private HistogramSeriesSonificationDefaultSpeechOptionsActiveWhen ActiveWhen_DefaultValue { get; set; }
		...
		/// </summary>
		public HistogramSeriesSonificationDefaultSpeechOptionsMapping Mapping { get; set; }
		private HistogramSeriesSonificationDefaultSpeechOptionsMapping Mapping_DefaultValue { get; set; }
		 

		/// <summary>
		/// Options for point grouping, specifically for instrument tracks.
		/// </summary>
		public HistogramSeriesSonificationDefaultSpeechOptionsPointGrouping PointGrouping { get; set; }
		private HistogramSeriesSonificationDefaultSpeechOptionsPointGrouping PointGrouping_DefaultValue { get; set; }
		...
		/// </summary>
		public HistogramSeriesSonificationDefaultSpeechOptionsType Type { get; set; }
		private HistogramSeriesSonificationDefaultSpeechOptionsType Type_DefaultValue { get; set; }
