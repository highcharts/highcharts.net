...
{
	public partial class HistogramSeriesSonificationDefaultSpeechOptionsMappingVolume  : BaseObject
	{
		Hashtable h = new Hashtable();

		public HistogramSeriesSonificationDefaultSpeechOptionsMappingVolume()
		{
			MapFunction = MapFunction_DefaultValue = HistogramSeriesSonificationDefaultSpeechOptionsMappingVolumeMapFunction.Linear;
			MapTo = MapTo_DefaultValue = "";
			Max = Max_DefaultValue = null;
			Min = Min_DefaultValue = null;
			Value = Value_DefaultValue = null;
			Within = Within_DefaultValue = HistogramSeriesSonificationDefaultSpeechOptionsMappingVolumeWithin.Chart;
		...
		/// </summary>
		public HistogramSeriesSonificationDefaultSpeechOptionsMappingVolumeMapFunction MapFunction { get; set; }
		private HistogramSeriesSonificationDefaultSpeechOptionsMappingVolumeMapFunction MapFunction_DefaultValue { get; set; }
		...
		/// </summary>
		public HistogramSeriesSonificationDefaultSpeechOptionsMappingVolumeWithin Within { get; set; }
		private HistogramSeriesSonificationDefaultSpeechOptionsMappingVolumeWithin Within_DefaultValue { get; set; }
