...
{
	public partial class HistogramSeriesSonificationPointGrouping  : BaseObject
	{
		Hashtable h = new Hashtable();

		public HistogramSeriesSonificationPointGrouping()
		{
		...
		/// </summary>
		public HistogramSeriesSonificationPointGroupingAlgorithm Algorithm { get; set; }
		private HistogramSeriesSonificationPointGroupingAlgorithm Algorithm_DefaultValue { get; set; }
		...
		internal override Hashtable ToHashtable(Highcharts highcharts)
		{
			...
			if (Algorithm != HistogramSeriesSonificationPointGroupingAlgorithm.Null) h.Add("algorithm", highcharts.FirstCharacterToLower(Algorithm.ToString()));
