...
{
	public partial class HistogramSeriesSonificationTracks  : BaseObject
	{
		Hashtable h = new Hashtable();

		public HistogramSeriesSonificationTracks()
		{
			ActiveWhen = ActiveWhen_DefaultValue = new HistogramSeriesSonificationTracksActiveWhen();
			Instrument = Instrument_DefaultValue = null;
			InstrumentString = InstrumentString_DefaultValue = "null";
			Mapping = Mapping_DefaultValue = new HistogramSeriesSonificationTracksMapping();
			MidiName = MidiName_DefaultValue = "";
			PointGrouping = PointGrouping_DefaultValue = new HistogramSeriesSonificationTracksPointGrouping();
			RoundToMusicalNotes = RoundToMusicalNotes_DefaultValue = true;
			ShowPlayMarker = ShowPlayMarker_DefaultValue = true;
			Type = Type_DefaultValue = HistogramSeriesSonificationTracksType.Instrument;
		...
		/// </summary>
		public HistogramSeriesSonificationTracksActiveWhen ActiveWhen { get; set; }
		private HistogramSeriesSonificationTracksActiveWhen ActiveWhen_DefaultValue { get; set; }
		...
		/// </summary>
		public HistogramSeriesSonificationTracksMapping Mapping { get; set; }
		private HistogramSeriesSonificationTracksMapping Mapping_DefaultValue { get; set; }
		...
		/// </summary>
		public HistogramSeriesSonificationTracksPointGrouping PointGrouping { get; set; }
		private HistogramSeriesSonificationTracksPointGrouping PointGrouping_DefaultValue { get; set; }
		...
		/// </summary>
		public HistogramSeriesSonificationTracksType Type { get; set; }
		private HistogramSeriesSonificationTracksType Type_DefaultValue { get; set; }
