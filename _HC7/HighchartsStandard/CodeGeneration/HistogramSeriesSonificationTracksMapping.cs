...
{
	public partial class HistogramSeriesSonificationTracksMapping  : BaseObject
	{
		Hashtable h = new Hashtable();

		public HistogramSeriesSonificationTracksMapping()
		{
			Frequency = Frequency_DefaultValue = new HistogramSeriesSonificationTracksMappingFrequency();
			GapBetweenNotes = GapBetweenNotes_DefaultValue = new HistogramSeriesSonificationTracksMappingGapBetweenNotes();
			Highpass = Highpass_DefaultValue = new HistogramSeriesSonificationTracksMappingHighpass();
			Lowpass = Lowpass_DefaultValue = new HistogramSeriesSonificationTracksMappingLowpass();
			NoteDuration = NoteDuration_DefaultValue = new HistogramSeriesSonificationTracksMappingNoteDuration();
			Pan = Pan_DefaultValue = new HistogramSeriesSonificationTracksMappingPan();
			Pitch = Pitch_DefaultValue = new HistogramSeriesSonificationTracksMappingPitch();
			PitchString = PitchString_DefaultValue = "null";
			PitchNumber = PitchNumber_DefaultValue = null;
			PlayDelay = PlayDelay_DefaultValue = new HistogramSeriesSonificationTracksMappingPlayDelay();
			Time = Time_DefaultValue = new HistogramSeriesSonificationTracksMappingTime();
			TimeString = TimeString_DefaultValue = "null";
			TimeNumber = TimeNumber_DefaultValue = null;
			Tremolo = Tremolo_DefaultValue = new HistogramSeriesSonificationTracksMappingTremolo();
			Volume = Volume_DefaultValue = new HistogramSeriesSonificationTracksMappingVolume();
		...
		/// </summary>
		public HistogramSeriesSonificationTracksMappingFrequency Frequency { get; set; }
		private HistogramSeriesSonificationTracksMappingFrequency Frequency_DefaultValue { get; set; }
		...
		/// </summary>
		public HistogramSeriesSonificationTracksMappingGapBetweenNotes GapBetweenNotes { get; set; }
		private HistogramSeriesSonificationTracksMappingGapBetweenNotes GapBetweenNotes_DefaultValue { get; set; }
		...
		/// </summary>
		public HistogramSeriesSonificationTracksMappingHighpass Highpass { get; set; }
		private HistogramSeriesSonificationTracksMappingHighpass Highpass_DefaultValue { get; set; }
		...
		/// </summary>
		public HistogramSeriesSonificationTracksMappingLowpass Lowpass { get; set; }
		private HistogramSeriesSonificationTracksMappingLowpass Lowpass_DefaultValue { get; set; }
		...
		/// </summary>
		public HistogramSeriesSonificationTracksMappingNoteDuration NoteDuration { get; set; }
		private HistogramSeriesSonificationTracksMappingNoteDuration NoteDuration_DefaultValue { get; set; }
		...
		/// </summary>
		public HistogramSeriesSonificationTracksMappingPan Pan { get; set; }
		private HistogramSeriesSonificationTracksMappingPan Pan_DefaultValue { get; set; }
		...
		/// </summary>
		public HistogramSeriesSonificationTracksMappingPitch Pitch { get; set; }
		private HistogramSeriesSonificationTracksMappingPitch Pitch_DefaultValue { get; set; }
		...
		/// </summary>
		public HistogramSeriesSonificationTracksMappingPlayDelay PlayDelay { get; set; }
		private HistogramSeriesSonificationTracksMappingPlayDelay PlayDelay_DefaultValue { get; set; }
		...
		/// </summary>
		public HistogramSeriesSonificationTracksMappingTime Time { get; set; }
		private HistogramSeriesSonificationTracksMappingTime Time_DefaultValue { get; set; }
		...
		/// </summary>
		public HistogramSeriesSonificationTracksMappingTremolo Tremolo { get; set; }
		private HistogramSeriesSonificationTracksMappingTremolo Tremolo_DefaultValue { get; set; }
		 

		/// <summary>
		/// The volume of notes, from 0 to 1.
		/// </summary>
		public HistogramSeriesSonificationTracksMappingVolume Volume { get; set; }
		private HistogramSeriesSonificationTracksMappingVolume Volume_DefaultValue { get; set; }
