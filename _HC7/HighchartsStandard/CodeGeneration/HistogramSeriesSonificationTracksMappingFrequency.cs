...
{
	public partial class HistogramSeriesSonificationTracksMappingFrequency  : BaseObject
	{
		Hashtable h = new Hashtable();

		public HistogramSeriesSonificationTracksMappingFrequency()
		{
			MapFunction = MapFunction_DefaultValue = HistogramSeriesSonificationTracksMappingFrequencyMapFunction.Linear;
			MapTo = MapTo_DefaultValue = "";
			Max = Max_DefaultValue = null;
			Min = Min_DefaultValue = null;
			Value = Value_DefaultValue = null;
			Within = Within_DefaultValue = HistogramSeriesSonificationTracksMappingFrequencyWithin.Chart;
		...
		/// </summary>
		public HistogramSeriesSonificationTracksMappingFrequencyMapFunction MapFunction { get; set; }
		private HistogramSeriesSonificationTracksMappingFrequencyMapFunction MapFunction_DefaultValue { get; set; }
		...
		/// </summary>
		public HistogramSeriesSonificationTracksMappingFrequencyWithin Within { get; set; }
		private HistogramSeriesSonificationTracksMappingFrequencyWithin Within_DefaultValue { get; set; }
