...
{
	public partial class HistogramSeriesSonificationTracksMappingLowpassResonance  : BaseObject
	{
		Hashtable h = new Hashtable();

		public HistogramSeriesSonificationTracksMappingLowpassResonance()
		{
			MapFunction = MapFunction_DefaultValue = HistogramSeriesSonificationTracksMappingLowpassResonanceMapFunction.Linear;
			MapTo = MapTo_DefaultValue = "";
			Max = Max_DefaultValue = null;
			Min = Min_DefaultValue = null;
			Value = Value_DefaultValue = null;
			Within = Within_DefaultValue = HistogramSeriesSonificationTracksMappingLowpassResonanceWithin.Chart;
		...
		/// </summary>
		public HistogramSeriesSonificationTracksMappingLowpassResonanceMapFunction MapFunction { get; set; }
		private HistogramSeriesSonificationTracksMappingLowpassResonanceMapFunction MapFunction_DefaultValue { get; set; }
		...
		/// </summary>
		public HistogramSeriesSonificationTracksMappingLowpassResonanceWithin Within { get; set; }
		private HistogramSeriesSonificationTracksMappingLowpassResonanceWithin Within_DefaultValue { get; set; }
