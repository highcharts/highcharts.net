...
{
	public partial class HistogramSeriesSonificationTracksMappingNoteDuration  : BaseObject
	{
		Hashtable h = new Hashtable();

		public HistogramSeriesSonificationTracksMappingNoteDuration()
		{
			MapFunction = MapFunction_DefaultValue = HistogramSeriesSonificationTracksMappingNoteDurationMapFunction.Linear;
			MapTo = MapTo_DefaultValue = "";
			Max = Max_DefaultValue = null;
			Min = Min_DefaultValue = null;
			Value = Value_DefaultValue = null;
			Within = Within_DefaultValue = HistogramSeriesSonificationTracksMappingNoteDurationWithin.Chart;
		...
		/// </summary>
		public HistogramSeriesSonificationTracksMappingNoteDurationMapFunction MapFunction { get; set; }
		private HistogramSeriesSonificationTracksMappingNoteDurationMapFunction MapFunction_DefaultValue { get; set; }
		...
		/// </summary>
		public HistogramSeriesSonificationTracksMappingNoteDurationWithin Within { get; set; }
		private HistogramSeriesSonificationTracksMappingNoteDurationWithin Within_DefaultValue { get; set; }
