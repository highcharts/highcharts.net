...
{
	public partial class HistogramSeriesSonificationTracksMappingPan  : BaseObject
	{
		Hashtable h = new Hashtable();

		public HistogramSeriesSonificationTracksMappingPan()
		{
			MapFunction = MapFunction_DefaultValue = HistogramSeriesSonificationTracksMappingPanMapFunction.Linear;
			MapTo = MapTo_DefaultValue = "";
			Max = Max_DefaultValue = null;
			Min = Min_DefaultValue = null;
			Value = Value_DefaultValue = null;
			Within = Within_DefaultValue = HistogramSeriesSonificationTracksMappingPanWithin.Chart;
		...
		/// </summary>
		public HistogramSeriesSonificationTracksMappingPanMapFunction MapFunction { get; set; }
		private HistogramSeriesSonificationTracksMappingPanMapFunction MapFunction_DefaultValue { get; set; }
		...
		/// </summary>
		public HistogramSeriesSonificationTracksMappingPanWithin Within { get; set; }
		private HistogramSeriesSonificationTracksMappingPanWithin Within_DefaultValue { get; set; }
