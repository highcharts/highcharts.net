...
{
	public partial class HistogramSeriesSonificationTracksMappingPitch  : BaseObject
	{
		Hashtable h = new Hashtable();

		public HistogramSeriesSonificationTracksMappingPitch()
		{
			MapFunction = MapFunction_DefaultValue = HistogramSeriesSonificationTracksMappingPitchMapFunction.Linear;
		...
		/// </summary>
		public HistogramSeriesSonificationTracksMappingPitchMapFunction MapFunction { get; set; }
		private HistogramSeriesSonificationTracksMappingPitchMapFunction MapFunction_DefaultValue { get; set; }
