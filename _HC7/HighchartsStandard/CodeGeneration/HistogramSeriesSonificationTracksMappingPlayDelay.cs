...
{
	public partial class HistogramSeriesSonificationTracksMappingPlayDelay  : BaseObject
	{
		Hashtable h = new Hashtable();

		public HistogramSeriesSonificationTracksMappingPlayDelay()
		{
			MapFunction = MapFunction_DefaultValue = HistogramSeriesSonificationTracksMappingPlayDelayMapFunction.Linear;
			MapTo = MapTo_DefaultValue = "";
			Max = Max_DefaultValue = null;
			Min = Min_DefaultValue = null;
			Value = Value_DefaultValue = null;
			Within = Within_DefaultValue = HistogramSeriesSonificationTracksMappingPlayDelayWithin.Chart;
		...
		/// </summary>
		public HistogramSeriesSonificationTracksMappingPlayDelayMapFunction MapFunction { get; set; }
		private HistogramSeriesSonificationTracksMappingPlayDelayMapFunction MapFunction_DefaultValue { get; set; }
		...
		/// </summary>
		public HistogramSeriesSonificationTracksMappingPlayDelayWithin Within { get; set; }
		private HistogramSeriesSonificationTracksMappingPlayDelayWithin Within_DefaultValue { get; set; }
