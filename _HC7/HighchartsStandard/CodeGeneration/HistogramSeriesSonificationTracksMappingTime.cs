...
{
	public partial class HistogramSeriesSonificationTracksMappingTime  : BaseObject
	{
		Hashtable h = new Hashtable();

		public HistogramSeriesSonificationTracksMappingTime()
		{
			MapFunction = MapFunction_DefaultValue = HistogramSeriesSonificationTracksMappingTimeMapFunction.Linear;
			MapTo = MapTo_DefaultValue = "";
			Max = Max_DefaultValue = null;
			Min = Min_DefaultValue = null;
			Value = Value_DefaultValue = null;
			Within = Within_DefaultValue = HistogramSeriesSonificationTracksMappingTimeWithin.Chart;
		...
		/// </summary>
		public HistogramSeriesSonificationTracksMappingTimeMapFunction MapFunction { get; set; }
		private HistogramSeriesSonificationTracksMappingTimeMapFunction MapFunction_DefaultValue { get; set; }
		...
		/// </summary>
		public HistogramSeriesSonificationTracksMappingTimeWithin Within { get; set; }
		private HistogramSeriesSonificationTracksMappingTimeWithin Within_DefaultValue { get; set; }
