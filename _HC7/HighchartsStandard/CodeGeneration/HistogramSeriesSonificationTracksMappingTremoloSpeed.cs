...
{
	public partial class HistogramSeriesSonificationTracksMappingTremoloSpeed  : BaseObject
	{
		Hashtable h = new Hashtable();

		public HistogramSeriesSonificationTracksMappingTremoloSpeed()
		{
			MapFunction = MapFunction_DefaultValue = HistogramSeriesSonificationTracksMappingTremoloSpeedMapFunction.Linear;
			MapTo = MapTo_DefaultValue = "";
			Max = Max_DefaultValue = null;
			Min = Min_DefaultValue = null;
			Value = Value_DefaultValue = null;
			Within = Within_DefaultValue = HistogramSeriesSonificationTracksMappingTremoloSpeedWithin.Chart;
		...
		/// </summary>
		public HistogramSeriesSonificationTracksMappingTremoloSpeedMapFunction MapFunction { get; set; }
		private HistogramSeriesSonificationTracksMappingTremoloSpeedMapFunction MapFunction_DefaultValue { get; set; }
		...
		/// </summary>
		public HistogramSeriesSonificationTracksMappingTremoloSpeedWithin Within { get; set; }
		private HistogramSeriesSonificationTracksMappingTremoloSpeedWithin Within_DefaultValue { get; set; }
