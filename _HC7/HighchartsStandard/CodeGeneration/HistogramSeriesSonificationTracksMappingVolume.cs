...
{
	public partial class HistogramSeriesSonificationTracksMappingVolume  : BaseObject
	{
		Hashtable h = new Hashtable();

		public HistogramSeriesSonificationTracksMappingVolume()
		{
			MapFunction = MapFunction_DefaultValue = HistogramSeriesSonificationTracksMappingVolumeMapFunction.Linear;
			MapTo = MapTo_DefaultValue = "";
			Max = Max_DefaultValue = null;
			Min = Min_DefaultValue = null;
			Value = Value_DefaultValue = null;
			Within = Within_DefaultValue = HistogramSeriesSonificationTracksMappingVolumeWithin.Chart;
		...
		/// </summary>
		public HistogramSeriesSonificationTracksMappingVolumeMapFunction MapFunction { get; set; }
		private HistogramSeriesSonificationTracksMappingVolumeMapFunction MapFunction_DefaultValue { get; set; }
		...
		/// </summary>
		public HistogramSeriesSonificationTracksMappingVolumeWithin Within { get; set; }
		private HistogramSeriesSonificationTracksMappingVolumeWithin Within_DefaultValue { get; set; }
