...
{
	public partial class HistogramSeriesSonificationTracksPointGrouping  : BaseObject
	{
		Hashtable h = new Hashtable();

		public HistogramSeriesSonificationTracksPointGrouping()
		{
		...
		/// </summary>
		public HistogramSeriesSonificationTracksPointGroupingAlgorithm Algorithm { get; set; }
		private HistogramSeriesSonificationTracksPointGroupingAlgorithm Algorithm_DefaultValue { get; set; }
		...
		internal override Hashtable ToHashtable(Highcharts highcharts)
		{
			...
			if (Algorithm != HistogramSeriesSonificationTracksPointGroupingAlgorithm.Null) h.Add("algorithm", highcharts.FirstCharacterToLower(Algorithm.ToString()));
