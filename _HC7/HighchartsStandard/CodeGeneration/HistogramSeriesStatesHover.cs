...
namespace Highsoft.Web.Mvc.Charts
{
	public partial class HistogramSeriesStatesHover  : BaseObject
	{
		public HistogramSeriesStatesHover()
		{
			...
			Halo = Halo_DefaultValue = new HistogramSeriesStatesHoverHalo();
			LineWidth = LineWidth_DefaultValue = null;
			LineWidthPlus = LineWidthPlus_DefaultValue = 1;
			Marker = Marker_DefaultValue = new HistogramSeriesStatesHoverMarker();
		...
		/// </summary>
		public HistogramSeriesStatesHoverHalo Halo { get; set; }
		private HistogramSeriesStatesHoverHalo Halo_DefaultValue { get; set; }
		...
		/// </summary>
		public HistogramSeriesStatesHoverMarker Marker { get; set; }
		private HistogramSeriesStatesHoverMarker Marker_DefaultValue { get; set; }
