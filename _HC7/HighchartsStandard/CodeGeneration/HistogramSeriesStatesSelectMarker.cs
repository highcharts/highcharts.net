...
{
	public partial class HistogramSeriesStatesSelectMarker  : BaseObject
	{
		public HistogramSeriesStatesSelectMarker()
		{
			...
			States = States_DefaultValue = new HistogramSeriesStatesSelectMarkerStates();
		...
		/// </summary>
		public HistogramSeriesStatesSelectMarkerStates States { get; set; }
		private HistogramSeriesStatesSelectMarkerStates States_DefaultValue { get; set; }
