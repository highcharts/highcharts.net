...
namespace Highsoft.Web.Mvc.Charts
{
	public partial class ItemSeriesAccessibility  : BaseObject
	{
		...
		public ItemSeriesAccessibility()
		{
			...
			Point = Point_DefaultValue = new ItemSeriesAccessibilityPoint();
		...
		/// </summary>
		public ItemSeriesAccessibilityPoint Point { get; set; }
		private ItemSeriesAccessibilityPoint Point_DefaultValue { get; set; }
