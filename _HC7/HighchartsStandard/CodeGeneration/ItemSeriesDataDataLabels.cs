...
{
	public partial class ItemSeriesDataDataLabels  : BaseObject
	{
		Hashtable h = new Hashtable();

		public ItemSeriesDataDataLabels()
		{
		...
		/// </summary>
		public ItemSeriesDataDataLabelsAlign Align { get; set; }
		private ItemSeriesDataDataLabelsAlign Align_DefaultValue { get; set; }
		...
		/// </summary>
		public ItemSeriesDataDataLabelsFilter Filter { get; set; }
		private ItemSeriesDataDataLabelsFilter Filter_DefaultValue { get; set; }
		...
		/// </summary>
		public ItemSeriesDataDataLabelsOverflow Overflow { get; set; }
		private ItemSeriesDataDataLabelsOverflow Overflow_DefaultValue { get; set; }
		...
		/// </summary>
		public ItemSeriesDataDataLabelsPosition Position { get; set; }
		private ItemSeriesDataDataLabelsPosition Position_DefaultValue { get; set; }
		...
		/// </summary>
		public ItemSeriesDataDataLabelsTextPath TextPath { get; set; }
		private ItemSeriesDataDataLabelsTextPath TextPath_DefaultValue { get; set; }
		...
		/// </summary>
		public ItemSeriesDataDataLabelsVerticalAlign VerticalAlign { get; set; }
		private ItemSeriesDataDataLabelsVerticalAlign VerticalAlign_DefaultValue { get; set; }
		...
		internal override Hashtable ToHashtable(Highcharts highcharts)
		{
			...
			if (Align != ItemSeriesDataDataLabelsAlign.Null) h.Add("align", highcharts.FirstCharacterToLower(Align.ToString()));
			...
			if (Overflow != ItemSeriesDataDataLabelsOverflow.Null) h.Add("overflow", highcharts.FirstCharacterToLower(Overflow.ToString()));
			if (Padding != null) h.Add("padding",Padding);
			if (Position != ItemSeriesDataDataLabelsPosition.Null) h.Add("position", highcharts.FirstCharacterToLower(Position.ToString()));
			...
			if (VerticalAlign != ItemSeriesDataDataLabelsVerticalAlign.Null) h.Add("verticalAlign", highcharts.FirstCharacterToLower(VerticalAlign.ToString()));
			if (X != null) h.Add("x",X);
			if (Y != null) h.Add("y",Y);
