...
{
	public partial class ItemSeriesSonificationContextTracks  : BaseObject
	{
		Hashtable h = new Hashtable();

		public ItemSeriesSonificationContextTracks()
		{
			ActiveWhen = ActiveWhen_DefaultValue = new ItemSeriesSonificationContextTracksActiveWhen();
			Instrument = Instrument_DefaultValue = null;
			InstrumentString = InstrumentString_DefaultValue = "null";
			Mapping = Mapping_DefaultValue = new ItemSeriesSonificationContextTracksMapping();
			MidiName = MidiName_DefaultValue = "";
			PointGrouping = PointGrouping_DefaultValue = new ItemSeriesSonificationContextTracksPointGrouping();
			...
			Type = Type_DefaultValue = ItemSeriesSonificationContextTracksType.Instrument;
			ValueInterval = ValueInterval_DefaultValue = null;
			ValueMapFunction = ValueMapFunction_DefaultValue = ItemSeriesSonificationContextTracksValueMapFunction.Linear;
		...
		/// </summary>
		public ItemSeriesSonificationContextTracksActiveWhen ActiveWhen { get; set; }
		private ItemSeriesSonificationContextTracksActiveWhen ActiveWhen_DefaultValue { get; set; }
		...
		/// </summary>
		public ItemSeriesSonificationContextTracksMapping Mapping { get; set; }
		private ItemSeriesSonificationContextTracksMapping Mapping_DefaultValue { get; set; }
		...
		/// </summary>
		public ItemSeriesSonificationContextTracksPointGrouping PointGrouping { get; set; }
		private ItemSeriesSonificationContextTracksPointGrouping PointGrouping_DefaultValue { get; set; }
		...
		/// </summary>
		public ItemSeriesSonificationContextTracksType Type { get; set; }
		private ItemSeriesSonificationContextTracksType Type_DefaultValue { get; set; }
		...
		/// </summary>
		public ItemSeriesSonificationContextTracksValueMapFunction ValueMapFunction { get; set; }
		private ItemSeriesSonificationContextTracksValueMapFunction ValueMapFunction_DefaultValue { get; set; }
