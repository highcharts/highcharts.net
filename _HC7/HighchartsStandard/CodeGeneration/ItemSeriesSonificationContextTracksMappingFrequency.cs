...
{
	public partial class ItemSeriesSonificationContextTracksMappingFrequency  : BaseObject
	{
		Hashtable h = new Hashtable();

		public ItemSeriesSonificationContextTracksMappingFrequency()
		{
			MapFunction = MapFunction_DefaultValue = ItemSeriesSonificationContextTracksMappingFrequencyMapFunction.Linear;
			MapTo = MapTo_DefaultValue = "";
			Max = Max_DefaultValue = null;
			Min = Min_DefaultValue = null;
			Value = Value_DefaultValue = null;
			Within = Within_DefaultValue = ItemSeriesSonificationContextTracksMappingFrequencyWithin.Chart;
		...
		/// </summary>
		public ItemSeriesSonificationContextTracksMappingFrequencyMapFunction MapFunction { get; set; }
		private ItemSeriesSonificationContextTracksMappingFrequencyMapFunction MapFunction_DefaultValue { get; set; }
		...
		/// </summary>
		public ItemSeriesSonificationContextTracksMappingFrequencyWithin Within { get; set; }
		private ItemSeriesSonificationContextTracksMappingFrequencyWithin Within_DefaultValue { get; set; }
