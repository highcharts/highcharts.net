...
{
	public partial class ItemSeriesSonificationContextTracksMappingPan  : BaseObject
	{
		Hashtable h = new Hashtable();

		public ItemSeriesSonificationContextTracksMappingPan()
		{
			MapFunction = MapFunction_DefaultValue = ItemSeriesSonificationContextTracksMappingPanMapFunction.Linear;
			MapTo = MapTo_DefaultValue = "";
			Max = Max_DefaultValue = null;
			Min = Min_DefaultValue = null;
			Value = Value_DefaultValue = null;
			Within = Within_DefaultValue = ItemSeriesSonificationContextTracksMappingPanWithin.Chart;
		...
		/// </summary>
		public ItemSeriesSonificationContextTracksMappingPanMapFunction MapFunction { get; set; }
		private ItemSeriesSonificationContextTracksMappingPanMapFunction MapFunction_DefaultValue { get; set; }
		...
		/// </summary>
		public ItemSeriesSonificationContextTracksMappingPanWithin Within { get; set; }
		private ItemSeriesSonificationContextTracksMappingPanWithin Within_DefaultValue { get; set; }
