...
{
	public partial class ItemSeriesSonificationContextTracksMappingPitch  : BaseObject
	{
		Hashtable h = new Hashtable();

		public ItemSeriesSonificationContextTracksMappingPitch()
		{
			MapFunction = MapFunction_DefaultValue = ItemSeriesSonificationContextTracksMappingPitchMapFunction.Linear;
		...
		/// </summary>
		public ItemSeriesSonificationContextTracksMappingPitchMapFunction MapFunction { get; set; }
		private ItemSeriesSonificationContextTracksMappingPitchMapFunction MapFunction_DefaultValue { get; set; }
