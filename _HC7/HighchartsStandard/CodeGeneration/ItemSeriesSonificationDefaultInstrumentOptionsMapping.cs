...
{
	public partial class ItemSeriesSonificationDefaultInstrumentOptionsMapping  : BaseObject
	{
		Hashtable h = new Hashtable();

		public ItemSeriesSonificationDefaultInstrumentOptionsMapping()
		{
			Frequency = Frequency_DefaultValue = new ItemSeriesSonificationDefaultInstrumentOptionsMappingFrequency();
			GapBetweenNotes = GapBetweenNotes_DefaultValue = new ItemSeriesSonificationDefaultInstrumentOptionsMappingGapBetweenNotes();
			Highpass = Highpass_DefaultValue = new ItemSeriesSonificationDefaultInstrumentOptionsMappingHighpass();
			Lowpass = Lowpass_DefaultValue = new ItemSeriesSonificationDefaultInstrumentOptionsMappingLowpass();
			NoteDuration = NoteDuration_DefaultValue = new ItemSeriesSonificationDefaultInstrumentOptionsMappingNoteDuration();
			Pan = Pan_DefaultValue = new ItemSeriesSonificationDefaultInstrumentOptionsMappingPan();
			Pitch = Pitch_DefaultValue = new ItemSeriesSonificationDefaultInstrumentOptionsMappingPitch();
			PitchString = PitchString_DefaultValue = "null";
			PitchNumber = PitchNumber_DefaultValue = null;
			PlayDelay = PlayDelay_DefaultValue = new ItemSeriesSonificationDefaultInstrumentOptionsMappingPlayDelay();
			Time = Time_DefaultValue = new ItemSeriesSonificationDefaultInstrumentOptionsMappingTime();
			TimeString = TimeString_DefaultValue = "null";
			TimeNumber = TimeNumber_DefaultValue = null;
			Tremolo = Tremolo_DefaultValue = new ItemSeriesSonificationDefaultInstrumentOptionsMappingTremolo();
			Volume = Volume_DefaultValue = new ItemSeriesSonificationDefaultInstrumentOptionsMappingVolume();
		...
		/// </summary>
		public ItemSeriesSonificationDefaultInstrumentOptionsMappingFrequency Frequency { get; set; }
		private ItemSeriesSonificationDefaultInstrumentOptionsMappingFrequency Frequency_DefaultValue { get; set; }
		...
		/// </summary>
		public ItemSeriesSonificationDefaultInstrumentOptionsMappingGapBetweenNotes GapBetweenNotes { get; set; }
		private ItemSeriesSonificationDefaultInstrumentOptionsMappingGapBetweenNotes GapBetweenNotes_DefaultValue { get; set; }
		...
		/// </summary>
		public ItemSeriesSonificationDefaultInstrumentOptionsMappingHighpass Highpass { get; set; }
		private ItemSeriesSonificationDefaultInstrumentOptionsMappingHighpass Highpass_DefaultValue { get; set; }
		...
		/// </summary>
		public ItemSeriesSonificationDefaultInstrumentOptionsMappingLowpass Lowpass { get; set; }
		private ItemSeriesSonificationDefaultInstrumentOptionsMappingLowpass Lowpass_DefaultValue { get; set; }
		...
		/// </summary>
		public ItemSeriesSonificationDefaultInstrumentOptionsMappingNoteDuration NoteDuration { get; set; }
		private ItemSeriesSonificationDefaultInstrumentOptionsMappingNoteDuration NoteDuration_DefaultValue { get; set; }
		...
		/// </summary>
		public ItemSeriesSonificationDefaultInstrumentOptionsMappingPan Pan { get; set; }
		private ItemSeriesSonificationDefaultInstrumentOptionsMappingPan Pan_DefaultValue { get; set; }
		...
		/// </summary>
		public ItemSeriesSonificationDefaultInstrumentOptionsMappingPitch Pitch { get; set; }
		private ItemSeriesSonificationDefaultInstrumentOptionsMappingPitch Pitch_DefaultValue { get; set; }
		...
		/// </summary>
		public ItemSeriesSonificationDefaultInstrumentOptionsMappingPlayDelay PlayDelay { get; set; }
		private ItemSeriesSonificationDefaultInstrumentOptionsMappingPlayDelay PlayDelay_DefaultValue { get; set; }
		...
		/// </summary>
		public ItemSeriesSonificationDefaultInstrumentOptionsMappingTime Time { get; set; }
		private ItemSeriesSonificationDefaultInstrumentOptionsMappingTime Time_DefaultValue { get; set; }
		...
		/// </summary>
		public ItemSeriesSonificationDefaultInstrumentOptionsMappingTremolo Tremolo { get; set; }
		private ItemSeriesSonificationDefaultInstrumentOptionsMappingTremolo Tremolo_DefaultValue { get; set; }
		 

		/// <summary>
		/// The volume of notes, from 0 to 1.
		/// </summary>
		public ItemSeriesSonificationDefaultInstrumentOptionsMappingVolume Volume { get; set; }
		private ItemSeriesSonificationDefaultInstrumentOptionsMappingVolume Volume_DefaultValue { get; set; }
