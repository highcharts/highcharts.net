...
{
	public partial class ItemSeriesSonificationDefaultSpeechOptions  : BaseObject
	{
		Hashtable h = new Hashtable();

		public ItemSeriesSonificationDefaultSpeechOptions()
		{
			ActiveWhen = ActiveWhen_DefaultValue = new ItemSeriesSonificationDefaultSpeechOptionsActiveWhen();
			Language = Language_DefaultValue = "en-US";
			Mapping = Mapping_DefaultValue = new ItemSeriesSonificationDefaultSpeechOptionsMapping();
			PointGrouping = PointGrouping_DefaultValue = new ItemSeriesSonificationDefaultSpeechOptionsPointGrouping();
			PreferredVoice = PreferredVoice_DefaultValue = "";
			ShowPlayMarker = ShowPlayMarker_DefaultValue = true;
			Type = Type_DefaultValue = ItemSeriesSonificationDefaultSpeechOptionsType.Instrument;
		...
		/// </summary>
		public ItemSeriesSonificationDefaultSpeechOptionsActiveWhen ActiveWhen { get; set; }
		private ItemSeriesSonificationDefaultSpeechOptionsActiveWhen ActiveWhen_DefaultValue { get; set; }
		...
		/// </summary>
		public ItemSeriesSonificationDefaultSpeechOptionsMapping Mapping { get; set; }
		private ItemSeriesSonificationDefaultSpeechOptionsMapping Mapping_DefaultValue { get; set; }
		 

		/// <summary>
		/// Options for point grouping, specifically for instrument tracks.
		/// </summary>
		public ItemSeriesSonificationDefaultSpeechOptionsPointGrouping PointGrouping { get; set; }
		private ItemSeriesSonificationDefaultSpeechOptionsPointGrouping PointGrouping_DefaultValue { get; set; }
		...
		/// </summary>
		public ItemSeriesSonificationDefaultSpeechOptionsType Type { get; set; }
		private ItemSeriesSonificationDefaultSpeechOptionsType Type_DefaultValue { get; set; }
