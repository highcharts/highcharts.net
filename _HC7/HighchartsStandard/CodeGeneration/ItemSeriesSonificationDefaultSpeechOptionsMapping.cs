...
{
	public partial class ItemSeriesSonificationDefaultSpeechOptionsMapping  : BaseObject
	{
		Hashtable h = new Hashtable();

		public ItemSeriesSonificationDefaultSpeechOptionsMapping()
		{
			Frequency = Frequency_DefaultValue = new ItemSeriesSonificationDefaultSpeechOptionsMappingFrequency();
			GapBetweenNotes = GapBetweenNotes_DefaultValue = new ItemSeriesSonificationDefaultSpeechOptionsMappingGapBetweenNotes();
			Highpass = Highpass_DefaultValue = new ItemSeriesSonificationDefaultSpeechOptionsMappingHighpass();
			Lowpass = Lowpass_DefaultValue = new ItemSeriesSonificationDefaultSpeechOptionsMappingLowpass();
			NoteDuration = NoteDuration_DefaultValue = new ItemSeriesSonificationDefaultSpeechOptionsMappingNoteDuration();
			Pan = Pan_DefaultValue = new ItemSeriesSonificationDefaultSpeechOptionsMappingPan();
			Pitch = Pitch_DefaultValue = new ItemSeriesSonificationDefaultSpeechOptionsMappingPitch();
			PitchString = PitchString_DefaultValue = "null";
			PitchNumber = PitchNumber_DefaultValue = null;
			PlayDelay = PlayDelay_DefaultValue = new ItemSeriesSonificationDefaultSpeechOptionsMappingPlayDelay();
			Time = Time_DefaultValue = new ItemSeriesSonificationDefaultSpeechOptionsMappingTime();
			TimeString = TimeString_DefaultValue = "null";
			TimeNumber = TimeNumber_DefaultValue = null;
			Tremolo = Tremolo_DefaultValue = new ItemSeriesSonificationDefaultSpeechOptionsMappingTremolo();
			Volume = Volume_DefaultValue = new ItemSeriesSonificationDefaultSpeechOptionsMappingVolume();
		...
		/// </summary>
		public ItemSeriesSonificationDefaultSpeechOptionsMappingFrequency Frequency { get; set; }
		private ItemSeriesSonificationDefaultSpeechOptionsMappingFrequency Frequency_DefaultValue { get; set; }
		...
		/// </summary>
		public ItemSeriesSonificationDefaultSpeechOptionsMappingGapBetweenNotes GapBetweenNotes { get; set; }
		private ItemSeriesSonificationDefaultSpeechOptionsMappingGapBetweenNotes GapBetweenNotes_DefaultValue { get; set; }
		...
		/// </summary>
		public ItemSeriesSonificationDefaultSpeechOptionsMappingHighpass Highpass { get; set; }
		private ItemSeriesSonificationDefaultSpeechOptionsMappingHighpass Highpass_DefaultValue { get; set; }
		...
		/// </summary>
		public ItemSeriesSonificationDefaultSpeechOptionsMappingLowpass Lowpass { get; set; }
		private ItemSeriesSonificationDefaultSpeechOptionsMappingLowpass Lowpass_DefaultValue { get; set; }
		...
		/// </summary>
		public ItemSeriesSonificationDefaultSpeechOptionsMappingNoteDuration NoteDuration { get; set; }
		private ItemSeriesSonificationDefaultSpeechOptionsMappingNoteDuration NoteDuration_DefaultValue { get; set; }
		...
		/// </summary>
		public ItemSeriesSonificationDefaultSpeechOptionsMappingPan Pan { get; set; }
		private ItemSeriesSonificationDefaultSpeechOptionsMappingPan Pan_DefaultValue { get; set; }
		...
		/// </summary>
		public ItemSeriesSonificationDefaultSpeechOptionsMappingPitch Pitch { get; set; }
		private ItemSeriesSonificationDefaultSpeechOptionsMappingPitch Pitch_DefaultValue { get; set; }
		...
		/// </summary>
		public ItemSeriesSonificationDefaultSpeechOptionsMappingPlayDelay PlayDelay { get; set; }
		private ItemSeriesSonificationDefaultSpeechOptionsMappingPlayDelay PlayDelay_DefaultValue { get; set; }
		...
		/// </summary>
		public ItemSeriesSonificationDefaultSpeechOptionsMappingTime Time { get; set; }
		private ItemSeriesSonificationDefaultSpeechOptionsMappingTime Time_DefaultValue { get; set; }
		...
		/// </summary>
		public ItemSeriesSonificationDefaultSpeechOptionsMappingTremolo Tremolo { get; set; }
		private ItemSeriesSonificationDefaultSpeechOptionsMappingTremolo Tremolo_DefaultValue { get; set; }
		 

		/// <summary>
		/// The volume of notes, from 0 to 1.
		/// </summary>
		public ItemSeriesSonificationDefaultSpeechOptionsMappingVolume Volume { get; set; }
		private ItemSeriesSonificationDefaultSpeechOptionsMappingVolume Volume_DefaultValue { get; set; }
