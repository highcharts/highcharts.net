...
{
	public partial class ItemSeriesSonificationPointGrouping  : BaseObject
	{
		Hashtable h = new Hashtable();

		public ItemSeriesSonificationPointGrouping()
		{
		...
		/// </summary>
		public ItemSeriesSonificationPointGroupingAlgorithm Algorithm { get; set; }
		private ItemSeriesSonificationPointGroupingAlgorithm Algorithm_DefaultValue { get; set; }
		...
		internal override Hashtable ToHashtable(Highcharts highcharts)
		{
			...
			if (Algorithm != ItemSeriesSonificationPointGroupingAlgorithm.Null) h.Add("algorithm", highcharts.FirstCharacterToLower(Algorithm.ToString()));
