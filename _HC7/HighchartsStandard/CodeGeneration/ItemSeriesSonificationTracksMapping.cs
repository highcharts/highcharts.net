...
{
	public partial class ItemSeriesSonificationTracksMapping  : BaseObject
	{
		Hashtable h = new Hashtable();

		public ItemSeriesSonificationTracksMapping()
		{
			Frequency = Frequency_DefaultValue = new ItemSeriesSonificationTracksMappingFrequency();
			GapBetweenNotes = GapBetweenNotes_DefaultValue = new ItemSeriesSonificationTracksMappingGapBetweenNotes();
			Highpass = Highpass_DefaultValue = new ItemSeriesSonificationTracksMappingHighpass();
			Lowpass = Lowpass_DefaultValue = new ItemSeriesSonificationTracksMappingLowpass();
			NoteDuration = NoteDuration_DefaultValue = new ItemSeriesSonificationTracksMappingNoteDuration();
			Pan = Pan_DefaultValue = new ItemSeriesSonificationTracksMappingPan();
			Pitch = Pitch_DefaultValue = new ItemSeriesSonificationTracksMappingPitch();
			PitchString = PitchString_DefaultValue = "null";
			PitchNumber = PitchNumber_DefaultValue = null;
			PlayDelay = PlayDelay_DefaultValue = new ItemSeriesSonificationTracksMappingPlayDelay();
			Time = Time_DefaultValue = new ItemSeriesSonificationTracksMappingTime();
			TimeString = TimeString_DefaultValue = "null";
			TimeNumber = TimeNumber_DefaultValue = null;
			Tremolo = Tremolo_DefaultValue = new ItemSeriesSonificationTracksMappingTremolo();
			Volume = Volume_DefaultValue = new ItemSeriesSonificationTracksMappingVolume();
		...
		/// </summary>
		public ItemSeriesSonificationTracksMappingFrequency Frequency { get; set; }
		private ItemSeriesSonificationTracksMappingFrequency Frequency_DefaultValue { get; set; }
		...
		/// </summary>
		public ItemSeriesSonificationTracksMappingGapBetweenNotes GapBetweenNotes { get; set; }
		private ItemSeriesSonificationTracksMappingGapBetweenNotes GapBetweenNotes_DefaultValue { get; set; }
		...
		/// </summary>
		public ItemSeriesSonificationTracksMappingHighpass Highpass { get; set; }
		private ItemSeriesSonificationTracksMappingHighpass Highpass_DefaultValue { get; set; }
		...
		/// </summary>
		public ItemSeriesSonificationTracksMappingLowpass Lowpass { get; set; }
		private ItemSeriesSonificationTracksMappingLowpass Lowpass_DefaultValue { get; set; }
		...
		/// </summary>
		public ItemSeriesSonificationTracksMappingNoteDuration NoteDuration { get; set; }
		private ItemSeriesSonificationTracksMappingNoteDuration NoteDuration_DefaultValue { get; set; }
		...
		/// </summary>
		public ItemSeriesSonificationTracksMappingPan Pan { get; set; }
		private ItemSeriesSonificationTracksMappingPan Pan_DefaultValue { get; set; }
		...
		/// </summary>
		public ItemSeriesSonificationTracksMappingPitch Pitch { get; set; }
		private ItemSeriesSonificationTracksMappingPitch Pitch_DefaultValue { get; set; }
		...
		/// </summary>
		public ItemSeriesSonificationTracksMappingPlayDelay PlayDelay { get; set; }
		private ItemSeriesSonificationTracksMappingPlayDelay PlayDelay_DefaultValue { get; set; }
		...
		/// </summary>
		public ItemSeriesSonificationTracksMappingTime Time { get; set; }
		private ItemSeriesSonificationTracksMappingTime Time_DefaultValue { get; set; }
		...
		/// </summary>
		public ItemSeriesSonificationTracksMappingTremolo Tremolo { get; set; }
		private ItemSeriesSonificationTracksMappingTremolo Tremolo_DefaultValue { get; set; }
		 

		/// <summary>
		/// The volume of notes, from 0 to 1.
		/// </summary>
		public ItemSeriesSonificationTracksMappingVolume Volume { get; set; }
		private ItemSeriesSonificationTracksMappingVolume Volume_DefaultValue { get; set; }
