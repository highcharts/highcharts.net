...
{
	public partial class ItemSeriesSonificationTracksMappingFrequency  : BaseObject
	{
		Hashtable h = new Hashtable();

		public ItemSeriesSonificationTracksMappingFrequency()
		{
			MapFunction = MapFunction_DefaultValue = ItemSeriesSonificationTracksMappingFrequencyMapFunction.Linear;
			MapTo = MapTo_DefaultValue = "";
			Max = Max_DefaultValue = null;
			Min = Min_DefaultValue = null;
			Value = Value_DefaultValue = null;
			Within = Within_DefaultValue = ItemSeriesSonificationTracksMappingFrequencyWithin.Chart;
		...
		/// </summary>
		public ItemSeriesSonificationTracksMappingFrequencyMapFunction MapFunction { get; set; }
		private ItemSeriesSonificationTracksMappingFrequencyMapFunction MapFunction_DefaultValue { get; set; }
		...
		/// </summary>
		public ItemSeriesSonificationTracksMappingFrequencyWithin Within { get; set; }
		private ItemSeriesSonificationTracksMappingFrequencyWithin Within_DefaultValue { get; set; }
