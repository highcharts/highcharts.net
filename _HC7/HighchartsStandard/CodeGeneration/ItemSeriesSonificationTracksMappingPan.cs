...
{
	public partial class ItemSeriesSonificationTracksMappingPan  : BaseObject
	{
		Hashtable h = new Hashtable();

		public ItemSeriesSonificationTracksMappingPan()
		{
			MapFunction = MapFunction_DefaultValue = ItemSeriesSonificationTracksMappingPanMapFunction.Linear;
			MapTo = MapTo_DefaultValue = "";
			Max = Max_DefaultValue = null;
			Min = Min_DefaultValue = null;
			Value = Value_DefaultValue = null;
			Within = Within_DefaultValue = ItemSeriesSonificationTracksMappingPanWithin.Chart;
		...
		/// </summary>
		public ItemSeriesSonificationTracksMappingPanMapFunction MapFunction { get; set; }
		private ItemSeriesSonificationTracksMappingPanMapFunction MapFunction_DefaultValue { get; set; }
		...
		/// </summary>
		public ItemSeriesSonificationTracksMappingPanWithin Within { get; set; }
		private ItemSeriesSonificationTracksMappingPanWithin Within_DefaultValue { get; set; }
