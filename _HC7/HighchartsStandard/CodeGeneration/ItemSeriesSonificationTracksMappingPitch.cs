...
{
	public partial class ItemSeriesSonificationTracksMappingPitch  : BaseObject
	{
		Hashtable h = new Hashtable();

		public ItemSeriesSonificationTracksMappingPitch()
		{
			MapFunction = MapFunction_DefaultValue = ItemSeriesSonificationTracksMappingPitchMapFunction.Linear;
		...
		/// </summary>
		public ItemSeriesSonificationTracksMappingPitchMapFunction MapFunction { get; set; }
		private ItemSeriesSonificationTracksMappingPitchMapFunction MapFunction_DefaultValue { get; set; }
