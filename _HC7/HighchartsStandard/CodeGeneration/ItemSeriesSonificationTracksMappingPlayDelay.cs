...
{
	public partial class ItemSeriesSonificationTracksMappingPlayDelay  : BaseObject
	{
		Hashtable h = new Hashtable();

		public ItemSeriesSonificationTracksMappingPlayDelay()
		{
			MapFunction = MapFunction_DefaultValue = ItemSeriesSonificationTracksMappingPlayDelayMapFunction.Linear;
			MapTo = MapTo_DefaultValue = "";
			Max = Max_DefaultValue = null;
			Min = Min_DefaultValue = null;
			Value = Value_DefaultValue = null;
			Within = Within_DefaultValue = ItemSeriesSonificationTracksMappingPlayDelayWithin.Chart;
		...
		/// </summary>
		public ItemSeriesSonificationTracksMappingPlayDelayMapFunction MapFunction { get; set; }
		private ItemSeriesSonificationTracksMappingPlayDelayMapFunction MapFunction_DefaultValue { get; set; }
		...
		/// </summary>
		public ItemSeriesSonificationTracksMappingPlayDelayWithin Within { get; set; }
		private ItemSeriesSonificationTracksMappingPlayDelayWithin Within_DefaultValue { get; set; }
