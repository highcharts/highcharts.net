...
{
	public partial class ItemSeriesSonificationTracksMappingTime  : BaseObject
	{
		Hashtable h = new Hashtable();

		public ItemSeriesSonificationTracksMappingTime()
		{
			MapFunction = MapFunction_DefaultValue = ItemSeriesSonificationTracksMappingTimeMapFunction.Linear;
			MapTo = MapTo_DefaultValue = "";
			Max = Max_DefaultValue = null;
			Min = Min_DefaultValue = null;
			Value = Value_DefaultValue = null;
			Within = Within_DefaultValue = ItemSeriesSonificationTracksMappingTimeWithin.Chart;
		...
		/// </summary>
		public ItemSeriesSonificationTracksMappingTimeMapFunction MapFunction { get; set; }
		private ItemSeriesSonificationTracksMappingTimeMapFunction MapFunction_DefaultValue { get; set; }
		...
		/// </summary>
		public ItemSeriesSonificationTracksMappingTimeWithin Within { get; set; }
		private ItemSeriesSonificationTracksMappingTimeWithin Within_DefaultValue { get; set; }
