...
{
	public partial class ItemSeriesSonificationTracksMappingTremoloSpeed  : BaseObject
	{
		Hashtable h = new Hashtable();

		public ItemSeriesSonificationTracksMappingTremoloSpeed()
		{
			MapFunction = MapFunction_DefaultValue = ItemSeriesSonificationTracksMappingTremoloSpeedMapFunction.Linear;
			MapTo = MapTo_DefaultValue = "";
			Max = Max_DefaultValue = null;
			Min = Min_DefaultValue = null;
			Value = Value_DefaultValue = null;
			Within = Within_DefaultValue = ItemSeriesSonificationTracksMappingTremoloSpeedWithin.Chart;
		...
		/// </summary>
		public ItemSeriesSonificationTracksMappingTremoloSpeedMapFunction MapFunction { get; set; }
		private ItemSeriesSonificationTracksMappingTremoloSpeedMapFunction MapFunction_DefaultValue { get; set; }
		...
		/// </summary>
		public ItemSeriesSonificationTracksMappingTremoloSpeedWithin Within { get; set; }
		private ItemSeriesSonificationTracksMappingTremoloSpeedWithin Within_DefaultValue { get; set; }
