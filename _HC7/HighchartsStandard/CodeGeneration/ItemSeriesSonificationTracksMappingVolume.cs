...
{
	public partial class ItemSeriesSonificationTracksMappingVolume  : BaseObject
	{
		Hashtable h = new Hashtable();

		public ItemSeriesSonificationTracksMappingVolume()
		{
			MapFunction = MapFunction_DefaultValue = ItemSeriesSonificationTracksMappingVolumeMapFunction.Linear;
			MapTo = MapTo_DefaultValue = "";
			Max = Max_DefaultValue = null;
			Min = Min_DefaultValue = null;
			Value = Value_DefaultValue = null;
			Within = Within_DefaultValue = ItemSeriesSonificationTracksMappingVolumeWithin.Chart;
		...
		/// </summary>
		public ItemSeriesSonificationTracksMappingVolumeMapFunction MapFunction { get; set; }
		private ItemSeriesSonificationTracksMappingVolumeMapFunction MapFunction_DefaultValue { get; set; }
		...
		/// </summary>
		public ItemSeriesSonificationTracksMappingVolumeWithin Within { get; set; }
		private ItemSeriesSonificationTracksMappingVolumeWithin Within_DefaultValue { get; set; }
