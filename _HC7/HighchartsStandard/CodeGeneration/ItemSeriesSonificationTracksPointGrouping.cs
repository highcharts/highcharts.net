...
{
	public partial class ItemSeriesSonificationTracksPointGrouping  : BaseObject
	{
		Hashtable h = new Hashtable();

		public ItemSeriesSonificationTracksPointGrouping()
		{
		...
		/// </summary>
		public ItemSeriesSonificationTracksPointGroupingAlgorithm Algorithm { get; set; }
		private ItemSeriesSonificationTracksPointGroupingAlgorithm Algorithm_DefaultValue { get; set; }
		...
		internal override Hashtable ToHashtable(Highcharts highcharts)
		{
			...
			if (Algorithm != ItemSeriesSonificationTracksPointGroupingAlgorithm.Null) h.Add("algorithm", highcharts.FirstCharacterToLower(Algorithm.ToString()));
