...
{
	public partial class ItemSeriesStatesHover  : BaseObject
	{
		public ItemSeriesStatesHover()
		{
			Animation = Animation_DefaultValue = new Animation() { Enabled = true };
			Enabled = Enabled_DefaultValue = true;
			Halo = Halo_DefaultValue = new ItemSeriesStatesHoverHalo();
			LineWidth = LineWidth_DefaultValue = null;
			LineWidthPlus = LineWidthPlus_DefaultValue = 1;
			Marker = Marker_DefaultValue = new ItemSeriesStatesHoverMarker();
		...
		/// </summary>
		public ItemSeriesStatesHoverHalo Halo { get; set; }
		private ItemSeriesStatesHoverHalo Halo_DefaultValue { get; set; }
		...
		/// </summary>
		public ItemSeriesStatesHoverMarker Marker { get; set; }
		private ItemSeriesStatesHoverMarker Marker_DefaultValue { get; set; }
