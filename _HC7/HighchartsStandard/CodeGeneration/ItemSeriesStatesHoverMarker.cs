...
{
	public partial class ItemSeriesStatesHoverMarker  : BaseObject
	{
		public ItemSeriesStatesHoverMarker()
		{
			...
			States = States_DefaultValue = new ItemSeriesStatesHoverMarkerStates();
		...
		/// </summary>
		public ItemSeriesStatesHoverMarkerStates States { get; set; }
		private ItemSeriesStatesHoverMarkerStates States_DefaultValue { get; set; }
