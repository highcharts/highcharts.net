...
{
	public partial class ItemSeriesStatesSelect  : BaseObject
	{
		Hashtable h = new Hashtable();

		public ItemSeriesStatesSelect()
		{
			Animation = Animation_DefaultValue = new Animation();
			AnimationBool = AnimationBool_DefaultValue = null;
			Enabled = Enabled_DefaultValue = true;
			Halo = Halo_DefaultValue = new ItemSeriesStatesSelectHalo();
			LineWidth = LineWidth_DefaultValue = null;
			LineWidthPlus = LineWidthPlus_DefaultValue = 1;
			Marker = Marker_DefaultValue = new ItemSeriesStatesSelectMarker();
		...
		/// </summary>
		public ItemSeriesStatesSelectHalo Halo { get; set; }
		private ItemSeriesStatesSelectHalo Halo_DefaultValue { get; set; }
		...
		/// </summary>
		public ItemSeriesStatesSelectMarker Marker { get; set; }
		private ItemSeriesStatesSelectMarker Marker_DefaultValue { get; set; }
