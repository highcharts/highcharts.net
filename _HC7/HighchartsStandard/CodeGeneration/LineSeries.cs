...
namespace Highsoft.Web.Mvc.Charts
{
	public partial class LineSeries  : Series
	{
		...
		private LineSeriesAccessibility Accessibility_DefaultValue { get; set; }
		...
		private LineSeriesBoostBlending BoostBlending_DefaultValue { get; set; }
		...
		private LineSeriesDataSorting DataSorting_DefaultValue { get; set; }
		...
		private LineSeriesFindNearestPointBy FindNearestPointBy_DefaultValue { get; set; }
		...
		private LineSeriesLegendSymbol LegendSymbol_DefaultValue { get; set; }
		...
		private LineSeriesOnPoint OnPoint_DefaultValue { get; set; }
		...
		private LineSeriesPointPlacement PointPlacement_DefaultValue { get; set; }
		...
		private LineSeriesSonification Sonification_DefaultValue { get; set; }
		...
		/// </summary>
		public List<LineSeriesZone> Zones { get; set; }
		private List<LineSeriesZone> Zones_DefaultValue { get; set; }
		...
		internal override Hashtable ToHashtable(Highcharts highcharts)
		{
			...
			if (BoostBlending != LineSeriesBoostBlending.Null) h.Add("boostBlending", highcharts.FirstCharacterToLower(BoostBlending.ToString()));
			...
			if (Cursor != LineSeriesCursor.Null) h.Add("cursor", highcharts.FirstCharacterToLower(Cursor.ToString()));
			if (Custom != null) h.Add("custom",Custom);
			if (DashStyle != LineSeriesDashStyle.Null) h.Add("dashStyle", highcharts.FirstCharacterToLower(DashStyle.ToString()));
			...
			if (FindNearestPointBy != LineSeriesFindNearestPointBy.Null) h.Add("findNearestPointBy", highcharts.FirstCharacterToLower(FindNearestPointBy.ToString()));
			...
			if (LegendSymbol != LineSeriesLegendSymbol.Null) h.Add("legendSymbol", highcharts.FirstCharacterToLower(LegendSymbol.ToString()));
			if (Linecap != LineSeriesLinecap.Null) h.Add("linecap", highcharts.FirstCharacterToLower(Linecap.ToString()));
			...
			if (PointIntervalUnit != LineSeriesPointIntervalUnit.Null) h.Add("pointIntervalUnit", highcharts.FirstCharacterToLower(PointIntervalUnit.ToString()));
			if (PointPlacement != LineSeriesPointPlacement.Null) h.Add("pointPlacement", highcharts.FirstCharacterToLower(PointPlacement.ToString()));
			...
			if (Stacking != LineSeriesStacking.Null) h.Add("stacking", highcharts.FirstCharacterToLower(Stacking.ToString()));
			if (States != null) h.Add("states",States.ToHashtable(highcharts));
			if (Step != LineSeriesStep.Null) h.Add("step", highcharts.FirstCharacterToLower(Step.ToString()));
