...
namespace Highsoft.Web.Mvc.Charts
{
	public partial class LineSeries  : Series
	{
		...
		internal override Hashtable ToHashtable()
		{
			...
			if (PointDescriptionFormatter != PointDescriptionFormatter_DefaultValue) { h.Add("pointDescriptionFormatter",PointDescriptionFormatter); Highcharts.AddFunction("b87266aa-9bc6-4b1b-b311-98f3539cb470.pointDescriptionFormatter", PointDescriptionFormatter); }  
