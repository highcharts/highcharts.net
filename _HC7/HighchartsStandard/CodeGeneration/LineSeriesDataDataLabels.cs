...
{
	public partial class LineSeriesDataDataLabels  : BaseObject
	{
		Hashtable h = new Hashtable();

		public LineSeriesDataDataLabels()
		{
		...
		/// </summary>
		public LineSeriesDataDataLabelsAlign Align { get; set; }
		private LineSeriesDataDataLabelsAlign Align_DefaultValue { get; set; }
		...
		/// </summary>
		public LineSeriesDataDataLabelsFilter Filter { get; set; }
		private LineSeriesDataDataLabelsFilter Filter_DefaultValue { get; set; }
		...
		/// </summary>
		public LineSeriesDataDataLabelsOverflow Overflow { get; set; }
		private LineSeriesDataDataLabelsOverflow Overflow_DefaultValue { get; set; }
		...
		/// </summary>
		public LineSeriesDataDataLabelsPosition Position { get; set; }
		private LineSeriesDataDataLabelsPosition Position_DefaultValue { get; set; }
		...
		/// </summary>
		public LineSeriesDataDataLabelsTextPath TextPath { get; set; }
		private LineSeriesDataDataLabelsTextPath TextPath_DefaultValue { get; set; }
		...
		/// </summary>
		public LineSeriesDataDataLabelsVerticalAlign VerticalAlign { get; set; }
		private LineSeriesDataDataLabelsVerticalAlign VerticalAlign_DefaultValue { get; set; }
		...
		internal override Hashtable ToHashtable(Highcharts highcharts)
		{
			...
			if (Align != LineSeriesDataDataLabelsAlign.Null) h.Add("align", highcharts.FirstCharacterToLower(Align.ToString()));
			...
			if (Overflow != LineSeriesDataDataLabelsOverflow.Null) h.Add("overflow", highcharts.FirstCharacterToLower(Overflow.ToString()));
			if (Padding != null) h.Add("padding",Padding);
			if (Position != LineSeriesDataDataLabelsPosition.Null) h.Add("position", highcharts.FirstCharacterToLower(Position.ToString()));
			...
			if (VerticalAlign != LineSeriesDataDataLabelsVerticalAlign.Null) h.Add("verticalAlign", highcharts.FirstCharacterToLower(VerticalAlign.ToString()));
			if (X != null) h.Add("x",X);
			if (Y != null) h.Add("y",Y);
