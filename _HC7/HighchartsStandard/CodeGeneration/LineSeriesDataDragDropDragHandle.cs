...
{
	public partial class LineSeriesDataDragDropDragHandle  : BaseObject
	{
		public LineSeriesDataDragDropDragHandle()
		{
		...
		internal override Hashtable ToHashtable()
		{
			...
			if (PathFormatter != PathFormatter_DefaultValue) { h.Add("pathFormatter",PathFormatter); Highcharts.AddFunction("LineSeriesDataDragDropDragHandlePathFormatter.pathFormatter", PathFormatter); }  
