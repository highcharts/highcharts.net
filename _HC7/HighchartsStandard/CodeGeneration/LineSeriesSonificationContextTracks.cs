...
{
	public partial class LineSeriesSonificationContextTracks  : BaseObject
	{
		Hashtable h = new Hashtable();

		public LineSeriesSonificationContextTracks()
		{
			ActiveWhen = ActiveWhen_DefaultValue = new LineSeriesSonificationContextTracksActiveWhen();
			Instrument = Instrument_DefaultValue = null;
			InstrumentString = InstrumentString_DefaultValue = "null";
			Mapping = Mapping_DefaultValue = new LineSeriesSonificationContextTracksMapping();
			MidiName = MidiName_DefaultValue = "";
			PointGrouping = PointGrouping_DefaultValue = new LineSeriesSonificationContextTracksPointGrouping();
			...
			Type = Type_DefaultValue = LineSeriesSonificationContextTracksType.Instrument;
			ValueInterval = ValueInterval_DefaultValue = null;
			ValueMapFunction = ValueMapFunction_DefaultValue = LineSeriesSonificationContextTracksValueMapFunction.Linear;
		...
		/// </summary>
		public LineSeriesSonificationContextTracksActiveWhen ActiveWhen { get; set; }
		private LineSeriesSonificationContextTracksActiveWhen ActiveWhen_DefaultValue { get; set; }
		...
		/// </summary>
		public LineSeriesSonificationContextTracksMapping Mapping { get; set; }
		private LineSeriesSonificationContextTracksMapping Mapping_DefaultValue { get; set; }
		...
		/// </summary>
		public LineSeriesSonificationContextTracksPointGrouping PointGrouping { get; set; }
		private LineSeriesSonificationContextTracksPointGrouping PointGrouping_DefaultValue { get; set; }
		...
		/// </summary>
		public LineSeriesSonificationContextTracksType Type { get; set; }
		private LineSeriesSonificationContextTracksType Type_DefaultValue { get; set; }
		...
		/// </summary>
		public LineSeriesSonificationContextTracksValueMapFunction ValueMapFunction { get; set; }
		private LineSeriesSonificationContextTracksValueMapFunction ValueMapFunction_DefaultValue { get; set; }
