...
{
	public partial class LineSeriesSonificationContextTracksMappingPan  : BaseObject
	{
		Hashtable h = new Hashtable();

		public LineSeriesSonificationContextTracksMappingPan()
		{
			MapFunction = MapFunction_DefaultValue = LineSeriesSonificationContextTracksMappingPanMapFunction.Linear;
			MapTo = MapTo_DefaultValue = "";
			Max = Max_DefaultValue = null;
			Min = Min_DefaultValue = null;
			Value = Value_DefaultValue = null;
			Within = Within_DefaultValue = LineSeriesSonificationContextTracksMappingPanWithin.Chart;
		...
		/// </summary>
		public LineSeriesSonificationContextTracksMappingPanMapFunction MapFunction { get; set; }
		private LineSeriesSonificationContextTracksMappingPanMapFunction MapFunction_DefaultValue { get; set; }
		...
		/// </summary>
		public LineSeriesSonificationContextTracksMappingPanWithin Within { get; set; }
		private LineSeriesSonificationContextTracksMappingPanWithin Within_DefaultValue { get; set; }
