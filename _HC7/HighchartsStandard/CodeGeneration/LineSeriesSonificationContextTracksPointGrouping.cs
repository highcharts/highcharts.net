...
{
	public partial class LineSeriesSonificationContextTracksPointGrouping  : BaseObject
	{
		Hashtable h = new Hashtable();

		public LineSeriesSonificationContextTracksPointGrouping()
		{
		...
		/// </summary>
		public LineSeriesSonificationContextTracksPointGroupingAlgorithm Algorithm { get; set; }
		private LineSeriesSonificationContextTracksPointGroupingAlgorithm Algorithm_DefaultValue { get; set; }
		...
		internal override Hashtable ToHashtable(Highcharts highcharts)
		{
			...
			if (Algorithm != LineSeriesSonificationContextTracksPointGroupingAlgorithm.Null) h.Add("algorithm", highcharts.FirstCharacterToLower(Algorithm.ToString()));
