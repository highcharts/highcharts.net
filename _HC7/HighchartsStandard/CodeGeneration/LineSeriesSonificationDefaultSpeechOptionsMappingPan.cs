...
{
	public partial class LineSeriesSonificationDefaultSpeechOptionsMappingPan  : BaseObject
	{
		Hashtable h = new Hashtable();

		public LineSeriesSonificationDefaultSpeechOptionsMappingPan()
		{
			MapFunction = MapFunction_DefaultValue = LineSeriesSonificationDefaultSpeechOptionsMappingPanMapFunction.Linear;
			MapTo = MapTo_DefaultValue = "";
			Max = Max_DefaultValue = null;
			Min = Min_DefaultValue = null;
			Value = Value_DefaultValue = null;
			Within = Within_DefaultValue = LineSeriesSonificationDefaultSpeechOptionsMappingPanWithin.Chart;
		...
		/// </summary>
		public LineSeriesSonificationDefaultSpeechOptionsMappingPanMapFunction MapFunction { get; set; }
		private LineSeriesSonificationDefaultSpeechOptionsMappingPanMapFunction MapFunction_DefaultValue { get; set; }
		...
		/// </summary>
		public LineSeriesSonificationDefaultSpeechOptionsMappingPanWithin Within { get; set; }
		private LineSeriesSonificationDefaultSpeechOptionsMappingPanWithin Within_DefaultValue { get; set; }
