...
{
	public partial class LineSeriesSonificationPointGrouping  : BaseObject
	{
		Hashtable h = new Hashtable();

		public LineSeriesSonificationPointGrouping()
		{
		...
		/// </summary>
		public LineSeriesSonificationPointGroupingAlgorithm Algorithm { get; set; }
		private LineSeriesSonificationPointGroupingAlgorithm Algorithm_DefaultValue { get; set; }
		...
		internal override Hashtable ToHashtable(Highcharts highcharts)
		{
			...
			if (Algorithm != LineSeriesSonificationPointGroupingAlgorithm.Null) h.Add("algorithm", highcharts.FirstCharacterToLower(Algorithm.ToString()));
