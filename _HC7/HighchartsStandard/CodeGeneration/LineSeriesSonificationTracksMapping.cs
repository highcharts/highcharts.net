...
{
	public partial class LineSeriesSonificationTracksMapping  : BaseObject
	{
		Hashtable h = new Hashtable();

		public LineSeriesSonificationTracksMapping()
		{
			Frequency = Frequency_DefaultValue = new LineSeriesSonificationTracksMappingFrequency();
			GapBetweenNotes = GapBetweenNotes_DefaultValue = new LineSeriesSonificationTracksMappingGapBetweenNotes();
			Highpass = Highpass_DefaultValue = new LineSeriesSonificationTracksMappingHighpass();
			Lowpass = Lowpass_DefaultValue = new LineSeriesSonificationTracksMappingLowpass();
			NoteDuration = NoteDuration_DefaultValue = new LineSeriesSonificationTracksMappingNoteDuration();
			Pan = Pan_DefaultValue = new LineSeriesSonificationTracksMappingPan();
			Pitch = Pitch_DefaultValue = new LineSeriesSonificationTracksMappingPitch();
			PitchString = PitchString_DefaultValue = "null";
			PitchNumber = PitchNumber_DefaultValue = null;
			PlayDelay = PlayDelay_DefaultValue = new LineSeriesSonificationTracksMappingPlayDelay();
			Time = Time_DefaultValue = new LineSeriesSonificationTracksMappingTime();
			TimeString = TimeString_DefaultValue = "null";
			TimeNumber = TimeNumber_DefaultValue = null;
			Tremolo = Tremolo_DefaultValue = new LineSeriesSonificationTracksMappingTremolo();
			Volume = Volume_DefaultValue = new LineSeriesSonificationTracksMappingVolume();
		...
		/// </summary>
		public LineSeriesSonificationTracksMappingFrequency Frequency { get; set; }
		private LineSeriesSonificationTracksMappingFrequency Frequency_DefaultValue { get; set; }
		...
		/// </summary>
		public LineSeriesSonificationTracksMappingGapBetweenNotes GapBetweenNotes { get; set; }
		private LineSeriesSonificationTracksMappingGapBetweenNotes GapBetweenNotes_DefaultValue { get; set; }
		...
		/// </summary>
		public LineSeriesSonificationTracksMappingHighpass Highpass { get; set; }
		private LineSeriesSonificationTracksMappingHighpass Highpass_DefaultValue { get; set; }
		...
		/// </summary>
		public LineSeriesSonificationTracksMappingLowpass Lowpass { get; set; }
		private LineSeriesSonificationTracksMappingLowpass Lowpass_DefaultValue { get; set; }
		...
		/// </summary>
		public LineSeriesSonificationTracksMappingNoteDuration NoteDuration { get; set; }
		private LineSeriesSonificationTracksMappingNoteDuration NoteDuration_DefaultValue { get; set; }
		...
		/// </summary>
		public LineSeriesSonificationTracksMappingPan Pan { get; set; }
		private LineSeriesSonificationTracksMappingPan Pan_DefaultValue { get; set; }
		...
		/// </summary>
		public LineSeriesSonificationTracksMappingPitch Pitch { get; set; }
		private LineSeriesSonificationTracksMappingPitch Pitch_DefaultValue { get; set; }
		...
		/// </summary>
		public LineSeriesSonificationTracksMappingPlayDelay PlayDelay { get; set; }
		private LineSeriesSonificationTracksMappingPlayDelay PlayDelay_DefaultValue { get; set; }
		...
		/// </summary>
		public LineSeriesSonificationTracksMappingTime Time { get; set; }
		private LineSeriesSonificationTracksMappingTime Time_DefaultValue { get; set; }
		...
		/// </summary>
		public LineSeriesSonificationTracksMappingTremolo Tremolo { get; set; }
		private LineSeriesSonificationTracksMappingTremolo Tremolo_DefaultValue { get; set; }
		 

		/// <summary>
		/// The volume of notes, from 0 to 1.
		/// </summary>
		public LineSeriesSonificationTracksMappingVolume Volume { get; set; }
		private LineSeriesSonificationTracksMappingVolume Volume_DefaultValue { get; set; }
