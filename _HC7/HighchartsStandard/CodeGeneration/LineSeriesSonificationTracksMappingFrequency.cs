...
{
	public partial class LineSeriesSonificationTracksMappingFrequency  : BaseObject
	{
		Hashtable h = new Hashtable();

		public LineSeriesSonificationTracksMappingFrequency()
		{
			MapFunction = MapFunction_DefaultValue = LineSeriesSonificationTracksMappingFrequencyMapFunction.Linear;
			MapTo = MapTo_DefaultValue = "";
			Max = Max_DefaultValue = null;
			Min = Min_DefaultValue = null;
			Value = Value_DefaultValue = null;
			Within = Within_DefaultValue = LineSeriesSonificationTracksMappingFrequencyWithin.Chart;
		...
		/// </summary>
		public LineSeriesSonificationTracksMappingFrequencyMapFunction MapFunction { get; set; }
		private LineSeriesSonificationTracksMappingFrequencyMapFunction MapFunction_DefaultValue { get; set; }
		...
		/// </summary>
		public LineSeriesSonificationTracksMappingFrequencyWithin Within { get; set; }
		private LineSeriesSonificationTracksMappingFrequencyWithin Within_DefaultValue { get; set; }
