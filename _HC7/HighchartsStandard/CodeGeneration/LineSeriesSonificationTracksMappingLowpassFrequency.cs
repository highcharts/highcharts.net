...
{
	public partial class LineSeriesSonificationTracksMappingLowpassFrequency  : BaseObject
	{
		Hashtable h = new Hashtable();

		public LineSeriesSonificationTracksMappingLowpassFrequency()
		{
			MapFunction = MapFunction_DefaultValue = LineSeriesSonificationTracksMappingLowpassFrequencyMapFunction.Linear;
			MapTo = MapTo_DefaultValue = "";
			Max = Max_DefaultValue = null;
			Min = Min_DefaultValue = null;
			Value = Value_DefaultValue = null;
			Within = Within_DefaultValue = LineSeriesSonificationTracksMappingLowpassFrequencyWithin.Chart;
		...
		/// </summary>
		public LineSeriesSonificationTracksMappingLowpassFrequencyMapFunction MapFunction { get; set; }
		private LineSeriesSonificationTracksMappingLowpassFrequencyMapFunction MapFunction_DefaultValue { get; set; }
		...
		/// </summary>
		public LineSeriesSonificationTracksMappingLowpassFrequencyWithin Within { get; set; }
		private LineSeriesSonificationTracksMappingLowpassFrequencyWithin Within_DefaultValue { get; set; }
