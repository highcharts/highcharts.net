...
{
	public partial class LineSeriesSonificationTracksMappingLowpassResonance  : BaseObject
	{
		Hashtable h = new Hashtable();

		public LineSeriesSonificationTracksMappingLowpassResonance()
		{
			MapFunction = MapFunction_DefaultValue = LineSeriesSonificationTracksMappingLowpassResonanceMapFunction.Linear;
			MapTo = MapTo_DefaultValue = "";
			Max = Max_DefaultValue = null;
			Min = Min_DefaultValue = null;
			Value = Value_DefaultValue = null;
			Within = Within_DefaultValue = LineSeriesSonificationTracksMappingLowpassResonanceWithin.Chart;
		...
		/// </summary>
		public LineSeriesSonificationTracksMappingLowpassResonanceMapFunction MapFunction { get; set; }
		private LineSeriesSonificationTracksMappingLowpassResonanceMapFunction MapFunction_DefaultValue { get; set; }
		...
		/// </summary>
		public LineSeriesSonificationTracksMappingLowpassResonanceWithin Within { get; set; }
		private LineSeriesSonificationTracksMappingLowpassResonanceWithin Within_DefaultValue { get; set; }
