...
{
	public partial class LineSeriesSonificationTracksMappingNoteDuration  : BaseObject
	{
		Hashtable h = new Hashtable();

		public LineSeriesSonificationTracksMappingNoteDuration()
		{
			MapFunction = MapFunction_DefaultValue = LineSeriesSonificationTracksMappingNoteDurationMapFunction.Linear;
			MapTo = MapTo_DefaultValue = "";
			Max = Max_DefaultValue = null;
			Min = Min_DefaultValue = null;
			Value = Value_DefaultValue = null;
			Within = Within_DefaultValue = LineSeriesSonificationTracksMappingNoteDurationWithin.Chart;
		...
		/// </summary>
		public LineSeriesSonificationTracksMappingNoteDurationMapFunction MapFunction { get; set; }
		private LineSeriesSonificationTracksMappingNoteDurationMapFunction MapFunction_DefaultValue { get; set; }
		...
		/// </summary>
		public LineSeriesSonificationTracksMappingNoteDurationWithin Within { get; set; }
		private LineSeriesSonificationTracksMappingNoteDurationWithin Within_DefaultValue { get; set; }
