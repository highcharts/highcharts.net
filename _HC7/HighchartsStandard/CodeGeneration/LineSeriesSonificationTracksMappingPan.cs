...
{
	public partial class LineSeriesSonificationTracksMappingPan  : BaseObject
	{
		Hashtable h = new Hashtable();

		public LineSeriesSonificationTracksMappingPan()
		{
			MapFunction = MapFunction_DefaultValue = LineSeriesSonificationTracksMappingPanMapFunction.Linear;
			MapTo = MapTo_DefaultValue = "";
			Max = Max_DefaultValue = null;
			Min = Min_DefaultValue = null;
			Value = Value_DefaultValue = null;
			Within = Within_DefaultValue = LineSeriesSonificationTracksMappingPanWithin.Chart;
		...
		/// </summary>
		public LineSeriesSonificationTracksMappingPanMapFunction MapFunction { get; set; }
		private LineSeriesSonificationTracksMappingPanMapFunction MapFunction_DefaultValue { get; set; }
		...
		/// </summary>
		public LineSeriesSonificationTracksMappingPanWithin Within { get; set; }
		private LineSeriesSonificationTracksMappingPanWithin Within_DefaultValue { get; set; }
