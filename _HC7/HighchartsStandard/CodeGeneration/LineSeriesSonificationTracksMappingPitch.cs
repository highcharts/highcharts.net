...
{
	public partial class LineSeriesSonificationTracksMappingPitch  : BaseObject
	{
		Hashtable h = new Hashtable();

		public LineSeriesSonificationTracksMappingPitch()
		{
			MapFunction = MapFunction_DefaultValue = LineSeriesSonificationTracksMappingPitchMapFunction.Linear;
		...
		/// </summary>
		public LineSeriesSonificationTracksMappingPitchMapFunction MapFunction { get; set; }
		private LineSeriesSonificationTracksMappingPitchMapFunction MapFunction_DefaultValue { get; set; }
