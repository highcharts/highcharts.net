...
{
	public partial class LineSeriesSonificationTracksMappingTime  : BaseObject
	{
		Hashtable h = new Hashtable();

		public LineSeriesSonificationTracksMappingTime()
		{
			MapFunction = MapFunction_DefaultValue = LineSeriesSonificationTracksMappingTimeMapFunction.Linear;
			MapTo = MapTo_DefaultValue = "";
			Max = Max_DefaultValue = null;
			Min = Min_DefaultValue = null;
			Value = Value_DefaultValue = null;
			Within = Within_DefaultValue = LineSeriesSonificationTracksMappingTimeWithin.Chart;
		...
		/// </summary>
		public LineSeriesSonificationTracksMappingTimeMapFunction MapFunction { get; set; }
		private LineSeriesSonificationTracksMappingTimeMapFunction MapFunction_DefaultValue { get; set; }
		...
		/// </summary>
		public LineSeriesSonificationTracksMappingTimeWithin Within { get; set; }
		private LineSeriesSonificationTracksMappingTimeWithin Within_DefaultValue { get; set; }
