...
{
	public partial class LineSeriesSonificationTracksMappingTremoloSpeed  : BaseObject
	{
		Hashtable h = new Hashtable();

		public LineSeriesSonificationTracksMappingTremoloSpeed()
		{
			MapFunction = MapFunction_DefaultValue = LineSeriesSonificationTracksMappingTremoloSpeedMapFunction.Linear;
			MapTo = MapTo_DefaultValue = "";
			Max = Max_DefaultValue = null;
			Min = Min_DefaultValue = null;
			Value = Value_DefaultValue = null;
			Within = Within_DefaultValue = LineSeriesSonificationTracksMappingTremoloSpeedWithin.Chart;
		...
		/// </summary>
		public LineSeriesSonificationTracksMappingTremoloSpeedMapFunction MapFunction { get; set; }
		private LineSeriesSonificationTracksMappingTremoloSpeedMapFunction MapFunction_DefaultValue { get; set; }
		...
		/// </summary>
		public LineSeriesSonificationTracksMappingTremoloSpeedWithin Within { get; set; }
		private LineSeriesSonificationTracksMappingTremoloSpeedWithin Within_DefaultValue { get; set; }
