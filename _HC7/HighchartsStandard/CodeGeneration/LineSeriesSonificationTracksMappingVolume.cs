...
{
	public partial class LineSeriesSonificationTracksMappingVolume  : BaseObject
	{
		Hashtable h = new Hashtable();

		public LineSeriesSonificationTracksMappingVolume()
		{
			MapFunction = MapFunction_DefaultValue = LineSeriesSonificationTracksMappingVolumeMapFunction.Linear;
			MapTo = MapTo_DefaultValue = "";
			Max = Max_DefaultValue = null;
			Min = Min_DefaultValue = null;
			Value = Value_DefaultValue = null;
			Within = Within_DefaultValue = LineSeriesSonificationTracksMappingVolumeWithin.Chart;
		...
		/// </summary>
		public LineSeriesSonificationTracksMappingVolumeMapFunction MapFunction { get; set; }
		private LineSeriesSonificationTracksMappingVolumeMapFunction MapFunction_DefaultValue { get; set; }
		...
		/// </summary>
		public LineSeriesSonificationTracksMappingVolumeWithin Within { get; set; }
		private LineSeriesSonificationTracksMappingVolumeWithin Within_DefaultValue { get; set; }
