...
{
	public partial class LineSeriesSonificationTracksPointGrouping  : BaseObject
	{
		Hashtable h = new Hashtable();

		public LineSeriesSonificationTracksPointGrouping()
		{
		...
		/// </summary>
		public LineSeriesSonificationTracksPointGroupingAlgorithm Algorithm { get; set; }
		private LineSeriesSonificationTracksPointGroupingAlgorithm Algorithm_DefaultValue { get; set; }
		...
		internal override Hashtable ToHashtable(Highcharts highcharts)
		{
			...
			if (Algorithm != LineSeriesSonificationTracksPointGroupingAlgorithm.Null) h.Add("algorithm", highcharts.FirstCharacterToLower(Algorithm.ToString()));
