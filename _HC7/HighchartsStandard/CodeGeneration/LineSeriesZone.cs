...
namespace Highsoft.Web.Mvc.Charts
{
	public partial class LineSeriesZone  : BaseObject
	{
		...
		/// </summary>
		public LineSeriesZonesDashStyle DashStyle { get; set; }
		private LineSeriesZonesDashStyle DashStyle_DefaultValue { get; set; }
		...
		internal override Hashtable ToHashtable(Highcharts highcharts)
		{
			...
			if (DashStyle != LineSeriesZonesDashStyle.Null) h.Add("dashStyle", highcharts.FirstCharacterToLower(DashStyle.ToString()));
