...
{
	public partial class LollipopSeriesDataDataLabels  : BaseObject
	{
		Hashtable h = new Hashtable();

		public LollipopSeriesDataDataLabels()
		{
		...
		/// </summary>
		public LollipopSeriesDataDataLabelsAlign Align { get; set; }
		private LollipopSeriesDataDataLabelsAlign Align_DefaultValue { get; set; }
		...
		/// </summary>
		public LollipopSeriesDataDataLabelsFilter Filter { get; set; }
		private LollipopSeriesDataDataLabelsFilter Filter_DefaultValue { get; set; }
		...
		/// </summary>
		public LollipopSeriesDataDataLabelsOverflow Overflow { get; set; }
		private LollipopSeriesDataDataLabelsOverflow Overflow_DefaultValue { get; set; }
		...
		/// </summary>
		public LollipopSeriesDataDataLabelsPosition Position { get; set; }
		private LollipopSeriesDataDataLabelsPosition Position_DefaultValue { get; set; }
		...
		/// </summary>
		public LollipopSeriesDataDataLabelsTextPath TextPath { get; set; }
		private LollipopSeriesDataDataLabelsTextPath TextPath_DefaultValue { get; set; }
		...
		/// </summary>
		public LollipopSeriesDataDataLabelsVerticalAlign VerticalAlign { get; set; }
		private LollipopSeriesDataDataLabelsVerticalAlign VerticalAlign_DefaultValue { get; set; }
		...
		internal override Hashtable ToHashtable(Highcharts highcharts)
		{
			...
			if (Align != LollipopSeriesDataDataLabelsAlign.Null) h.Add("align", highcharts.FirstCharacterToLower(Align.ToString()));
			...
			if (Overflow != LollipopSeriesDataDataLabelsOverflow.Null) h.Add("overflow", highcharts.FirstCharacterToLower(Overflow.ToString()));
			if (Padding != null) h.Add("padding",Padding);
			if (Position != LollipopSeriesDataDataLabelsPosition.Null) h.Add("position", highcharts.FirstCharacterToLower(Position.ToString()));
			...
			if (VerticalAlign != LollipopSeriesDataDataLabelsVerticalAlign.Null) h.Add("verticalAlign", highcharts.FirstCharacterToLower(VerticalAlign.ToString()));
			if (X != null) h.Add("x",X);
			if (Y != null) h.Add("y",Y);
