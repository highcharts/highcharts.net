...
{
	public partial class LollipopSeriesSonificationContextTracksMappingTremoloSpeed  : BaseObject
	{
		Hashtable h = new Hashtable();

		public LollipopSeriesSonificationContextTracksMappingTremoloSpeed()
		{
			MapFunction = MapFunction_DefaultValue = LollipopSeriesSonificationContextTracksMappingTremoloSpeedMapFunction.Linear;
			MapTo = MapTo_DefaultValue = "";
			Max = Max_DefaultValue = null;
			Min = Min_DefaultValue = null;
			Value = Value_DefaultValue = null;
			Within = Within_DefaultValue = LollipopSeriesSonificationContextTracksMappingTremoloSpeedWithin.Chart;
		...
		/// </summary>
		public LollipopSeriesSonificationContextTracksMappingTremoloSpeedMapFunction MapFunction { get; set; }
		private LollipopSeriesSonificationContextTracksMappingTremoloSpeedMapFunction MapFunction_DefaultValue { get; set; }
		...
		/// </summary>
		public LollipopSeriesSonificationContextTracksMappingTremoloSpeedWithin Within { get; set; }
		private LollipopSeriesSonificationContextTracksMappingTremoloSpeedWithin Within_DefaultValue { get; set; }
