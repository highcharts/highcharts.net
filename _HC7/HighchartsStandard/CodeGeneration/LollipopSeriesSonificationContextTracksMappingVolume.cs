...
{
	public partial class LollipopSeriesSonificationContextTracksMappingVolume  : BaseObject
	{
		Hashtable h = new Hashtable();

		public LollipopSeriesSonificationContextTracksMappingVolume()
		{
			MapFunction = MapFunction_DefaultValue = LollipopSeriesSonificationContextTracksMappingVolumeMapFunction.Linear;
			MapTo = MapTo_DefaultValue = "";
			Max = Max_DefaultValue = null;
			Min = Min_DefaultValue = null;
			Value = Value_DefaultValue = null;
			Within = Within_DefaultValue = LollipopSeriesSonificationContextTracksMappingVolumeWithin.Chart;
		...
		/// </summary>
		public LollipopSeriesSonificationContextTracksMappingVolumeMapFunction MapFunction { get; set; }
		private LollipopSeriesSonificationContextTracksMappingVolumeMapFunction MapFunction_DefaultValue { get; set; }
		...
		/// </summary>
		public LollipopSeriesSonificationContextTracksMappingVolumeWithin Within { get; set; }
		private LollipopSeriesSonificationContextTracksMappingVolumeWithin Within_DefaultValue { get; set; }
