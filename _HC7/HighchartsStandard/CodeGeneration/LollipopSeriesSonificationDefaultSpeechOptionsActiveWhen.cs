...
{
	public partial class LollipopSeriesSonificationDefaultSpeechOptionsActiveWhen  : BaseObject
	{
		Hashtable h = new Hashtable();

		public LollipopSeriesSonificationDefaultSpeechOptionsActiveWhen()
		{
