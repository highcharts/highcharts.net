...
{
	public partial class LollipopSeriesSonificationPointGrouping  : BaseObject
	{
		Hashtable h = new Hashtable();

		public LollipopSeriesSonificationPointGrouping()
		{
		...
		/// </summary>
		public LollipopSeriesSonificationPointGroupingAlgorithm Algorithm { get; set; }
		private LollipopSeriesSonificationPointGroupingAlgorithm Algorithm_DefaultValue { get; set; }
		...
		internal override Hashtable ToHashtable(Highcharts highcharts)
		{
			...
			if (Algorithm != LollipopSeriesSonificationPointGroupingAlgorithm.Null) h.Add("algorithm", highcharts.FirstCharacterToLower(Algorithm.ToString()));
