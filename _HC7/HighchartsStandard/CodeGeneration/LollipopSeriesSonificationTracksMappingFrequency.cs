...
{
	public partial class LollipopSeriesSonificationTracksMappingFrequency  : BaseObject
	{
		Hashtable h = new Hashtable();

		public LollipopSeriesSonificationTracksMappingFrequency()
		{
			MapFunction = MapFunction_DefaultValue = LollipopSeriesSonificationTracksMappingFrequencyMapFunction.Linear;
			MapTo = MapTo_DefaultValue = "";
			Max = Max_DefaultValue = null;
			Min = Min_DefaultValue = null;
			Value = Value_DefaultValue = null;
			Within = Within_DefaultValue = LollipopSeriesSonificationTracksMappingFrequencyWithin.Chart;
		...
		/// </summary>
		public LollipopSeriesSonificationTracksMappingFrequencyMapFunction MapFunction { get; set; }
		private LollipopSeriesSonificationTracksMappingFrequencyMapFunction MapFunction_DefaultValue { get; set; }
		...
		/// </summary>
		public LollipopSeriesSonificationTracksMappingFrequencyWithin Within { get; set; }
		private LollipopSeriesSonificationTracksMappingFrequencyWithin Within_DefaultValue { get; set; }
