...
{
	public partial class LollipopSeriesSonificationTracksMappingNoteDuration  : BaseObject
	{
		Hashtable h = new Hashtable();

		public LollipopSeriesSonificationTracksMappingNoteDuration()
		{
			MapFunction = MapFunction_DefaultValue = LollipopSeriesSonificationTracksMappingNoteDurationMapFunction.Linear;
			MapTo = MapTo_DefaultValue = "";
			Max = Max_DefaultValue = null;
			Min = Min_DefaultValue = null;
			Value = Value_DefaultValue = null;
			Within = Within_DefaultValue = LollipopSeriesSonificationTracksMappingNoteDurationWithin.Chart;
		...
		/// </summary>
		public LollipopSeriesSonificationTracksMappingNoteDurationMapFunction MapFunction { get; set; }
		private LollipopSeriesSonificationTracksMappingNoteDurationMapFunction MapFunction_DefaultValue { get; set; }
		...
		/// </summary>
		public LollipopSeriesSonificationTracksMappingNoteDurationWithin Within { get; set; }
		private LollipopSeriesSonificationTracksMappingNoteDurationWithin Within_DefaultValue { get; set; }
