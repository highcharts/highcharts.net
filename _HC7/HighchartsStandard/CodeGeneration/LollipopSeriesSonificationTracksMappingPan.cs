...
{
	public partial class LollipopSeriesSonificationTracksMappingPan  : BaseObject
	{
		Hashtable h = new Hashtable();

		public LollipopSeriesSonificationTracksMappingPan()
		{
			MapFunction = MapFunction_DefaultValue = LollipopSeriesSonificationTracksMappingPanMapFunction.Linear;
			MapTo = MapTo_DefaultValue = "";
			Max = Max_DefaultValue = null;
			Min = Min_DefaultValue = null;
			Value = Value_DefaultValue = null;
			Within = Within_DefaultValue = LollipopSeriesSonificationTracksMappingPanWithin.Chart;
		...
		/// </summary>
		public LollipopSeriesSonificationTracksMappingPanMapFunction MapFunction { get; set; }
		private LollipopSeriesSonificationTracksMappingPanMapFunction MapFunction_DefaultValue { get; set; }
		...
		/// </summary>
		public LollipopSeriesSonificationTracksMappingPanWithin Within { get; set; }
		private LollipopSeriesSonificationTracksMappingPanWithin Within_DefaultValue { get; set; }
