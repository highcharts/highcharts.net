...
{
	public partial class LollipopSeriesSonificationTracksMappingPitch  : BaseObject
	{
		Hashtable h = new Hashtable();

		public LollipopSeriesSonificationTracksMappingPitch()
		{
			MapFunction = MapFunction_DefaultValue = LollipopSeriesSonificationTracksMappingPitchMapFunction.Linear;
		...
		/// </summary>
		public LollipopSeriesSonificationTracksMappingPitchMapFunction MapFunction { get; set; }
		private LollipopSeriesSonificationTracksMappingPitchMapFunction MapFunction_DefaultValue { get; set; }
