...
{
	public partial class LollipopSeriesSonificationTracksMappingPlayDelay  : BaseObject
	{
		Hashtable h = new Hashtable();

		public LollipopSeriesSonificationTracksMappingPlayDelay()
		{
			MapFunction = MapFunction_DefaultValue = LollipopSeriesSonificationTracksMappingPlayDelayMapFunction.Linear;
			MapTo = MapTo_DefaultValue = "";
			Max = Max_DefaultValue = null;
			Min = Min_DefaultValue = null;
			Value = Value_DefaultValue = null;
			Within = Within_DefaultValue = LollipopSeriesSonificationTracksMappingPlayDelayWithin.Chart;
		...
		/// </summary>
		public LollipopSeriesSonificationTracksMappingPlayDelayMapFunction MapFunction { get; set; }
		private LollipopSeriesSonificationTracksMappingPlayDelayMapFunction MapFunction_DefaultValue { get; set; }
		...
		/// </summary>
		public LollipopSeriesSonificationTracksMappingPlayDelayWithin Within { get; set; }
		private LollipopSeriesSonificationTracksMappingPlayDelayWithin Within_DefaultValue { get; set; }
