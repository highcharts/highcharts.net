...
{
	public partial class LollipopSeriesSonificationTracksMappingTime  : BaseObject
	{
		Hashtable h = new Hashtable();

		public LollipopSeriesSonificationTracksMappingTime()
		{
			MapFunction = MapFunction_DefaultValue = LollipopSeriesSonificationTracksMappingTimeMapFunction.Linear;
			MapTo = MapTo_DefaultValue = "";
			Max = Max_DefaultValue = null;
			Min = Min_DefaultValue = null;
			Value = Value_DefaultValue = null;
			Within = Within_DefaultValue = LollipopSeriesSonificationTracksMappingTimeWithin.Chart;
		...
		/// </summary>
		public LollipopSeriesSonificationTracksMappingTimeMapFunction MapFunction { get; set; }
		private LollipopSeriesSonificationTracksMappingTimeMapFunction MapFunction_DefaultValue { get; set; }
		...
		/// </summary>
		public LollipopSeriesSonificationTracksMappingTimeWithin Within { get; set; }
		private LollipopSeriesSonificationTracksMappingTimeWithin Within_DefaultValue { get; set; }
