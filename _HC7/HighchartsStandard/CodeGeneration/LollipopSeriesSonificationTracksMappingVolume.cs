...
{
	public partial class LollipopSeriesSonificationTracksMappingVolume  : BaseObject
	{
		Hashtable h = new Hashtable();

		public LollipopSeriesSonificationTracksMappingVolume()
		{
			MapFunction = MapFunction_DefaultValue = LollipopSeriesSonificationTracksMappingVolumeMapFunction.Linear;
			MapTo = MapTo_DefaultValue = "";
			Max = Max_DefaultValue = null;
			Min = Min_DefaultValue = null;
			Value = Value_DefaultValue = null;
			Within = Within_DefaultValue = LollipopSeriesSonificationTracksMappingVolumeWithin.Chart;
		...
		/// </summary>
		public LollipopSeriesSonificationTracksMappingVolumeMapFunction MapFunction { get; set; }
		private LollipopSeriesSonificationTracksMappingVolumeMapFunction MapFunction_DefaultValue { get; set; }
		...
		/// </summary>
		public LollipopSeriesSonificationTracksMappingVolumeWithin Within { get; set; }
		private LollipopSeriesSonificationTracksMappingVolumeWithin Within_DefaultValue { get; set; }
