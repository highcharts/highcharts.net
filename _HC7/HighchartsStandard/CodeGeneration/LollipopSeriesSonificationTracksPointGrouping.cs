...
{
	public partial class LollipopSeriesSonificationTracksPointGrouping  : BaseObject
	{
		Hashtable h = new Hashtable();

		public LollipopSeriesSonificationTracksPointGrouping()
		{
		...
		/// </summary>
		public LollipopSeriesSonificationTracksPointGroupingAlgorithm Algorithm { get; set; }
		private LollipopSeriesSonificationTracksPointGroupingAlgorithm Algorithm_DefaultValue { get; set; }
		...
		internal override Hashtable ToHashtable(Highcharts highcharts)
		{
			...
			if (Algorithm != LollipopSeriesSonificationTracksPointGroupingAlgorithm.Null) h.Add("algorithm", highcharts.FirstCharacterToLower(Algorithm.ToString()));
