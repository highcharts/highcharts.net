...
{
	public partial class LollipopSeriesStatesSelect  : BaseObject
	{
		Hashtable h = new Hashtable();

		public LollipopSeriesStatesSelect()
		{
			Animation = Animation_DefaultValue = new Animation();
			AnimationBool = AnimationBool_DefaultValue = null;
			Enabled = Enabled_DefaultValue = true;
			Halo = Halo_DefaultValue = new LollipopSeriesStatesSelectHalo();
			LineWidth = LineWidth_DefaultValue = null;
			LineWidthPlus = LineWidthPlus_DefaultValue = 1;
			Marker = Marker_DefaultValue = new LollipopSeriesStatesSelectMarker();
		...
		/// </summary>
		public LollipopSeriesStatesSelectHalo Halo { get; set; }
		private LollipopSeriesStatesSelectHalo Halo_DefaultValue { get; set; }
		...
		/// </summary>
		public LollipopSeriesStatesSelectMarker Marker { get; set; }
		private LollipopSeriesStatesSelectMarker Marker_DefaultValue { get; set; }
