...
namespace Highsoft.Web.Mvc.Charts
{
	public partial class NavigationAnnotationsOptionsLabelOptions  : BaseObject
	{
		public NavigationAnnotationsOptionsLabelOptions()
		{
			...
			VerticalAlign = VerticalAlign_DefaultValue = NavigationAnnotationsOptionsLabelOptionsVerticalAlign.Bottom;
			X = X_DefaultValue = 0;
			Y = Y_DefaultValue = -16;
		...
		internal override Hashtable ToHashtable()
		{
			...
			if (Formatter != Formatter_DefaultValue) { h.Add("formatter",Formatter); Highcharts.AddFunction("NavigationAnnotationsOptionsLabelOptionsFormatter.formatter", Formatter); }  
