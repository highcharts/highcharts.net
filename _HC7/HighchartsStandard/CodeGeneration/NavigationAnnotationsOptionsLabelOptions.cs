...
{
	public partial class NavigationAnnotationsOptionsLabelOptions  : BaseObject
	{
		...
		/// </summary>
		public NavigationAnnotationsOptionsLabelOptionsAlign Align { get; set; }
		private NavigationAnnotationsOptionsLabelOptionsAlign Align_DefaultValue { get; set; }
		...
		/// </summary>
		public NavigationAnnotationsOptionsLabelOptionsVerticalAlign VerticalAlign { get; set; }
		private NavigationAnnotationsOptionsLabelOptionsVerticalAlign VerticalAlign_DefaultValue { get; set; }
		...
		internal override Hashtable ToHashtable(Highcharts highcharts)
		{
			...
			if (Align != NavigationAnnotationsOptionsLabelOptionsAlign.Null) h.Add("align", highcharts.FirstCharacterToLower(Align.ToString()));
			...
			if (Overflow != NavigationAnnotationsOptionsLabelOptionsOverflow.Null) h.Add("overflow", highcharts.FirstCharacterToLower(Overflow.ToString()));
			...
			if (VerticalAlign != NavigationAnnotationsOptionsLabelOptionsVerticalAlign.Null) h.Add("verticalAlign", highcharts.FirstCharacterToLower(VerticalAlign.ToString()));
			if (X != null) h.Add("x",X);
			if (Y != null) h.Add("y",Y);
