...
namespace Highsoft.Web.Mvc.Charts
{
	public partial class NavigationEvents  : BaseObject
	{
		...
		internal override Hashtable ToHashtable()
		{
			...
			if (DeselectButton != DeselectButton_DefaultValue) { h.Add("deselectButton",DeselectButton); Highcharts.AddFunction("13732d1b-f10d-46ca-97a1-f05ca5e99cf8.deselectButton", DeselectButton); }  
			if (HidePopup != HidePopup_DefaultValue) { h.Add("hidePopup",HidePopup); Highcharts.AddFunction("5ea9f272-67e7-45c5-add9-8429e8a688d0.hidePopup", HidePopup); }  
			if (SelectButton != SelectButton_DefaultValue) { h.Add("selectButton",SelectButton); Highcharts.AddFunction("2a0ec480-52d2-460b-8960-183719ac8d62.selectButton", SelectButton); }  
			if (ShowPopup != ShowPopup_DefaultValue) { h.Add("showPopup",ShowPopup); Highcharts.AddFunction("c76379fd-7c56-48c1-a7f3-bb712482805c.showPopup", ShowPopup); }  
