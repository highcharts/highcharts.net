...
namespace Highsoft.Web.Mvc.Charts
{
	public partial class NetworkgraphSeries  : Series
	{
		...
		public NetworkgraphSeries()
		{
			...
			Dumbell = Dumbell_DefaultValue = new NetworkgraphSeriesDumbell();
			...
			LegendSymbol = LegendSymbol_DefaultValue = NetworkgraphSeriesLegendSymbol.Rectangle;
			...
			OnPoint = OnPoint_DefaultValue = new NetworkgraphSeriesOnPoint();
			...
			Sonification = Sonification_DefaultValue = new NetworkgraphSeriesSonification();
		...
		/// 
		/// </summary>
		public NetworkgraphSeriesDumbell Dumbell { get; set; }
		private NetworkgraphSeriesDumbell Dumbell_DefaultValue { get; set; }
		...
		private NetworkgraphSeriesLegendSymbol LegendSymbol_DefaultValue { get; set; }
		...
		private NetworkgraphSeriesOnPoint OnPoint_DefaultValue { get; set; }
		...
		private NetworkgraphSeriesSonification Sonification_DefaultValue { get; set; }
