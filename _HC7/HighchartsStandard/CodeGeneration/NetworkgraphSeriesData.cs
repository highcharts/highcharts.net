...
{
	public partial class NetworkgraphSeriesData  : BaseObject
	{
		public NetworkgraphSeriesData()
		{
			Accessibility = Accessibility_DefaultValue = new NetworkgraphSeriesDataAccessibility();
		...
		/// 
		/// </summary>
		public NetworkgraphSeriesDataAccessibility Accessibility { get; set; }
		private NetworkgraphSeriesDataAccessibility Accessibility_DefaultValue { get; set; }
		...
		/// </summary>
		public NetworkgraphSeriesDataEvents Events { get; set; }
		private NetworkgraphSeriesDataEvents Events_DefaultValue { get; set; }
