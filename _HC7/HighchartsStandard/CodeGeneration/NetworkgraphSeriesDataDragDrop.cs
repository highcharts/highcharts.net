...
{
	public partial class NetworkgraphSeriesDataDragDrop  : BaseObject
	{
		public NetworkgraphSeriesDataDragDrop()
		{
			DraggableX = DraggableX_DefaultValue = null;
			DraggableY = DraggableY_DefaultValue = null;
			DragHandle = DragHandle_DefaultValue = new NetworkgraphSeriesDataDragDropDragHandle();
			...
			GuideBox = GuideBox_DefaultValue = new NetworkgraphSeriesDataDragDropGuideBox();
		...
		/// </summary>
		public NetworkgraphSeriesDataDragDropDragHandle DragHandle { get; set; }
		private NetworkgraphSeriesDataDragDropDragHandle DragHandle_DefaultValue { get; set; }
		...
		/// </summary>
		public NetworkgraphSeriesDataDragDropGuideBox GuideBox { get; set; }
		private NetworkgraphSeriesDataDragDropGuideBox GuideBox_DefaultValue { get; set; }
