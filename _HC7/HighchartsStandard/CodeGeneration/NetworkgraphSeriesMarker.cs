...
{
	public partial class NetworkgraphSeriesMarker  : BaseObject
	{
		Hashtable h = new Hashtable();

		public NetworkgraphSeriesMarker()
		{
			...
			States = States_DefaultValue = new NetworkgraphSeriesMarkerStates();
		...
		/// </summary>
		public NetworkgraphSeriesMarkerStates States { get; set; }
		private NetworkgraphSeriesMarkerStates States_DefaultValue { get; set; }
