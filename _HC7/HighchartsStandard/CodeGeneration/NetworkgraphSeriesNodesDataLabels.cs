...
namespace Highsoft.Web.Mvc.Charts
{
	public partial class NetworkgraphSeriesNodesDataLabels  : BaseObject
	{
		...
		/// </summary>
		public NetworkgraphSeriesNodesDataLabelsOverflow Overflow { get; set; }
		private NetworkgraphSeriesNodesDataLabelsOverflow Overflow_DefaultValue { get; set; }
		...
		/// </summary>
		public NetworkgraphSeriesNodesDataLabelsPosition Position { get; set; }
		private NetworkgraphSeriesNodesDataLabelsPosition Position_DefaultValue { get; set; }
		...
		internal override Hashtable ToHashtable(Highcharts highcharts)
		{
			...
			if (Align != NetworkgraphSeriesNodesDataLabelsAlign.Null) h.Add("align", highcharts.FirstCharacterToLower(Align.ToString()));
			...
			if (Overflow != NetworkgraphSeriesNodesDataLabelsOverflow.Null) h.Add("overflow", highcharts.FirstCharacterToLower(Overflow.ToString()));
			if (Padding != null) h.Add("padding",Padding);
			if (Position != NetworkgraphSeriesNodesDataLabelsPosition.Null) h.Add("position", highcharts.FirstCharacterToLower(Position.ToString()));
			...
			if (VerticalAlign != NetworkgraphSeriesNodesDataLabelsVerticalAlign.Null) h.Add("verticalAlign", highcharts.FirstCharacterToLower(VerticalAlign.ToString()));
			if (X != null) h.Add("x",X);
			if (Y != null) h.Add("y",Y);
