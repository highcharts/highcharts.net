...
namespace Highsoft.Web.Mvc.Charts
{
	public partial class NetworkgraphSeriesNodesMarkerStates  : BaseObject
	{
		...
		{
			Inactive = Inactive_DefaultValue = new NetworkgraphSeriesNodesMarkerStatesInactive();
		...
		private NetworkgraphSeriesNodesMarkerStatesInactive Inactive_DefaultValue { get; set; }
