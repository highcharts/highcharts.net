...
{
	public partial class NetworkgraphSeriesSonificationContextTracksMapping  : BaseObject
	{
		Hashtable h = new Hashtable();

		public NetworkgraphSeriesSonificationContextTracksMapping()
		{
			Frequency = Frequency_DefaultValue = new NetworkgraphSeriesSonificationContextTracksMappingFrequency();
			GapBetweenNotes = GapBetweenNotes_DefaultValue = new NetworkgraphSeriesSonificationContextTracksMappingGapBetweenNotes();
			Highpass = Highpass_DefaultValue = new NetworkgraphSeriesSonificationContextTracksMappingHighpass();
			Lowpass = Lowpass_DefaultValue = new NetworkgraphSeriesSonificationContextTracksMappingLowpass();
			NoteDuration = NoteDuration_DefaultValue = new NetworkgraphSeriesSonificationContextTracksMappingNoteDuration();
			Pan = Pan_DefaultValue = new NetworkgraphSeriesSonificationContextTracksMappingPan();
			Pitch = Pitch_DefaultValue = new NetworkgraphSeriesSonificationContextTracksMappingPitch();
			PitchString = PitchString_DefaultValue = "null";
			PitchNumber = PitchNumber_DefaultValue = null;
			PlayDelay = PlayDelay_DefaultValue = new NetworkgraphSeriesSonificationContextTracksMappingPlayDelay();
			Time = Time_DefaultValue = new NetworkgraphSeriesSonificationContextTracksMappingTime();
			TimeString = TimeString_DefaultValue = "null";
			TimeNumber = TimeNumber_DefaultValue = null;
			Tremolo = Tremolo_DefaultValue = new NetworkgraphSeriesSonificationContextTracksMappingTremolo();
			Volume = Volume_DefaultValue = new NetworkgraphSeriesSonificationContextTracksMappingVolume();
		...
		/// </summary>
		public NetworkgraphSeriesSonificationContextTracksMappingFrequency Frequency { get; set; }
		private NetworkgraphSeriesSonificationContextTracksMappingFrequency Frequency_DefaultValue { get; set; }
		...
		/// </summary>
		public NetworkgraphSeriesSonificationContextTracksMappingGapBetweenNotes GapBetweenNotes { get; set; }
		private NetworkgraphSeriesSonificationContextTracksMappingGapBetweenNotes GapBetweenNotes_DefaultValue { get; set; }
		...
		/// </summary>
		public NetworkgraphSeriesSonificationContextTracksMappingHighpass Highpass { get; set; }
		private NetworkgraphSeriesSonificationContextTracksMappingHighpass Highpass_DefaultValue { get; set; }
		...
		/// </summary>
		public NetworkgraphSeriesSonificationContextTracksMappingLowpass Lowpass { get; set; }
		private NetworkgraphSeriesSonificationContextTracksMappingLowpass Lowpass_DefaultValue { get; set; }
		...
		/// </summary>
		public NetworkgraphSeriesSonificationContextTracksMappingNoteDuration NoteDuration { get; set; }
		private NetworkgraphSeriesSonificationContextTracksMappingNoteDuration NoteDuration_DefaultValue { get; set; }
		...
		/// </summary>
		public NetworkgraphSeriesSonificationContextTracksMappingPan Pan { get; set; }
		private NetworkgraphSeriesSonificationContextTracksMappingPan Pan_DefaultValue { get; set; }
		...
		/// </summary>
		public NetworkgraphSeriesSonificationContextTracksMappingPitch Pitch { get; set; }
		private NetworkgraphSeriesSonificationContextTracksMappingPitch Pitch_DefaultValue { get; set; }
		...
		/// </summary>
		public NetworkgraphSeriesSonificationContextTracksMappingPlayDelay PlayDelay { get; set; }
		private NetworkgraphSeriesSonificationContextTracksMappingPlayDelay PlayDelay_DefaultValue { get; set; }
		...
		/// </summary>
		public NetworkgraphSeriesSonificationContextTracksMappingTime Time { get; set; }
		private NetworkgraphSeriesSonificationContextTracksMappingTime Time_DefaultValue { get; set; }
		...
		/// </summary>
		public NetworkgraphSeriesSonificationContextTracksMappingTremolo Tremolo { get; set; }
		private NetworkgraphSeriesSonificationContextTracksMappingTremolo Tremolo_DefaultValue { get; set; }
		 

		/// <summary>
		/// The volume of notes, from 0 to 1.
		/// </summary>
		public NetworkgraphSeriesSonificationContextTracksMappingVolume Volume { get; set; }
		private NetworkgraphSeriesSonificationContextTracksMappingVolume Volume_DefaultValue { get; set; }
