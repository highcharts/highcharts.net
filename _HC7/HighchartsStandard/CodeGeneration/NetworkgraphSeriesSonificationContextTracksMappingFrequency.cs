...
{
	public partial class NetworkgraphSeriesSonificationContextTracksMappingFrequency  : BaseObject
	{
		Hashtable h = new Hashtable();

		public NetworkgraphSeriesSonificationContextTracksMappingFrequency()
		{
			MapFunction = MapFunction_DefaultValue = NetworkgraphSeriesSonificationContextTracksMappingFrequencyMapFunction.Linear;
			MapTo = MapTo_DefaultValue = "";
			Max = Max_DefaultValue = null;
			Min = Min_DefaultValue = null;
			Value = Value_DefaultValue = null;
			Within = Within_DefaultValue = NetworkgraphSeriesSonificationContextTracksMappingFrequencyWithin.Chart;
		...
		/// </summary>
		public NetworkgraphSeriesSonificationContextTracksMappingFrequencyMapFunction MapFunction { get; set; }
		private NetworkgraphSeriesSonificationContextTracksMappingFrequencyMapFunction MapFunction_DefaultValue { get; set; }
		...
		/// </summary>
		public NetworkgraphSeriesSonificationContextTracksMappingFrequencyWithin Within { get; set; }
		private NetworkgraphSeriesSonificationContextTracksMappingFrequencyWithin Within_DefaultValue { get; set; }
