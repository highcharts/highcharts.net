...
{
	public partial class NetworkgraphSeriesSonificationContextTracksMappingPan  : BaseObject
	{
		Hashtable h = new Hashtable();

		public NetworkgraphSeriesSonificationContextTracksMappingPan()
		{
			MapFunction = MapFunction_DefaultValue = NetworkgraphSeriesSonificationContextTracksMappingPanMapFunction.Linear;
			MapTo = MapTo_DefaultValue = "";
			Max = Max_DefaultValue = null;
			Min = Min_DefaultValue = null;
			Value = Value_DefaultValue = null;
			Within = Within_DefaultValue = NetworkgraphSeriesSonificationContextTracksMappingPanWithin.Chart;
		...
		/// </summary>
		public NetworkgraphSeriesSonificationContextTracksMappingPanMapFunction MapFunction { get; set; }
		private NetworkgraphSeriesSonificationContextTracksMappingPanMapFunction MapFunction_DefaultValue { get; set; }
		...
		/// </summary>
		public NetworkgraphSeriesSonificationContextTracksMappingPanWithin Within { get; set; }
		private NetworkgraphSeriesSonificationContextTracksMappingPanWithin Within_DefaultValue { get; set; }
