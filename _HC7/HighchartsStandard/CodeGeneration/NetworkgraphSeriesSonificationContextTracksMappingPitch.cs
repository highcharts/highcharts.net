...
{
	public partial class NetworkgraphSeriesSonificationContextTracksMappingPitch  : BaseObject
	{
		Hashtable h = new Hashtable();

		public NetworkgraphSeriesSonificationContextTracksMappingPitch()
		{
			MapFunction = MapFunction_DefaultValue = NetworkgraphSeriesSonificationContextTracksMappingPitchMapFunction.Linear;
		...
		/// </summary>
		public NetworkgraphSeriesSonificationContextTracksMappingPitchMapFunction MapFunction { get; set; }
		private NetworkgraphSeriesSonificationContextTracksMappingPitchMapFunction MapFunction_DefaultValue { get; set; }
