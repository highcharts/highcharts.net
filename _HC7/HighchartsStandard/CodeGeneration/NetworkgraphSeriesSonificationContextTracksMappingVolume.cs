...
{
	public partial class NetworkgraphSeriesSonificationContextTracksMappingVolume  : BaseObject
	{
		Hashtable h = new Hashtable();

		public NetworkgraphSeriesSonificationContextTracksMappingVolume()
		{
			MapFunction = MapFunction_DefaultValue = NetworkgraphSeriesSonificationContextTracksMappingVolumeMapFunction.Linear;
			MapTo = MapTo_DefaultValue = "";
			Max = Max_DefaultValue = null;
			Min = Min_DefaultValue = null;
			Value = Value_DefaultValue = null;
			Within = Within_DefaultValue = NetworkgraphSeriesSonificationContextTracksMappingVolumeWithin.Chart;
		...
		/// </summary>
		public NetworkgraphSeriesSonificationContextTracksMappingVolumeMapFunction MapFunction { get; set; }
		private NetworkgraphSeriesSonificationContextTracksMappingVolumeMapFunction MapFunction_DefaultValue { get; set; }
		...
		/// </summary>
		public NetworkgraphSeriesSonificationContextTracksMappingVolumeWithin Within { get; set; }
		private NetworkgraphSeriesSonificationContextTracksMappingVolumeWithin Within_DefaultValue { get; set; }
