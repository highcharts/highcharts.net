...
{
	public partial class NetworkgraphSeriesSonificationContextTracksPointGrouping  : BaseObject
	{
		Hashtable h = new Hashtable();

		public NetworkgraphSeriesSonificationContextTracksPointGrouping()
		{
		...
		/// </summary>
		public NetworkgraphSeriesSonificationContextTracksPointGroupingAlgorithm Algorithm { get; set; }
		private NetworkgraphSeriesSonificationContextTracksPointGroupingAlgorithm Algorithm_DefaultValue { get; set; }
		...
		internal override Hashtable ToHashtable(Highcharts highcharts)
		{
			...
			if (Algorithm != NetworkgraphSeriesSonificationContextTracksPointGroupingAlgorithm.Null) h.Add("algorithm", highcharts.FirstCharacterToLower(Algorithm.ToString()));
