...
{
	public partial class NetworkgraphSeriesSonificationDefaultSpeechOptionsMapping  : BaseObject
	{
		Hashtable h = new Hashtable();

		public NetworkgraphSeriesSonificationDefaultSpeechOptionsMapping()
		{
			Frequency = Frequency_DefaultValue = new NetworkgraphSeriesSonificationDefaultSpeechOptionsMappingFrequency();
			GapBetweenNotes = GapBetweenNotes_DefaultValue = new NetworkgraphSeriesSonificationDefaultSpeechOptionsMappingGapBetweenNotes();
			Highpass = Highpass_DefaultValue = new NetworkgraphSeriesSonificationDefaultSpeechOptionsMappingHighpass();
			Lowpass = Lowpass_DefaultValue = new NetworkgraphSeriesSonificationDefaultSpeechOptionsMappingLowpass();
			NoteDuration = NoteDuration_DefaultValue = new NetworkgraphSeriesSonificationDefaultSpeechOptionsMappingNoteDuration();
			Pan = Pan_DefaultValue = new NetworkgraphSeriesSonificationDefaultSpeechOptionsMappingPan();
			Pitch = Pitch_DefaultValue = new NetworkgraphSeriesSonificationDefaultSpeechOptionsMappingPitch();
			PitchString = PitchString_DefaultValue = "null";
			PitchNumber = PitchNumber_DefaultValue = null;
			PlayDelay = PlayDelay_DefaultValue = new NetworkgraphSeriesSonificationDefaultSpeechOptionsMappingPlayDelay();
			Time = Time_DefaultValue = new NetworkgraphSeriesSonificationDefaultSpeechOptionsMappingTime();
			TimeString = TimeString_DefaultValue = "null";
			TimeNumber = TimeNumber_DefaultValue = null;
			Tremolo = Tremolo_DefaultValue = new NetworkgraphSeriesSonificationDefaultSpeechOptionsMappingTremolo();
			Volume = Volume_DefaultValue = new NetworkgraphSeriesSonificationDefaultSpeechOptionsMappingVolume();
		...
		/// </summary>
		public NetworkgraphSeriesSonificationDefaultSpeechOptionsMappingFrequency Frequency { get; set; }
		private NetworkgraphSeriesSonificationDefaultSpeechOptionsMappingFrequency Frequency_DefaultValue { get; set; }
		...
		/// </summary>
		public NetworkgraphSeriesSonificationDefaultSpeechOptionsMappingGapBetweenNotes GapBetweenNotes { get; set; }
		private NetworkgraphSeriesSonificationDefaultSpeechOptionsMappingGapBetweenNotes GapBetweenNotes_DefaultValue { get; set; }
		...
		/// </summary>
		public NetworkgraphSeriesSonificationDefaultSpeechOptionsMappingHighpass Highpass { get; set; }
		private NetworkgraphSeriesSonificationDefaultSpeechOptionsMappingHighpass Highpass_DefaultValue { get; set; }
		...
		/// </summary>
		public NetworkgraphSeriesSonificationDefaultSpeechOptionsMappingLowpass Lowpass { get; set; }
		private NetworkgraphSeriesSonificationDefaultSpeechOptionsMappingLowpass Lowpass_DefaultValue { get; set; }
		...
		/// </summary>
		public NetworkgraphSeriesSonificationDefaultSpeechOptionsMappingNoteDuration NoteDuration { get; set; }
		private NetworkgraphSeriesSonificationDefaultSpeechOptionsMappingNoteDuration NoteDuration_DefaultValue { get; set; }
		...
		/// </summary>
		public NetworkgraphSeriesSonificationDefaultSpeechOptionsMappingPan Pan { get; set; }
		private NetworkgraphSeriesSonificationDefaultSpeechOptionsMappingPan Pan_DefaultValue { get; set; }
		...
		/// </summary>
		public NetworkgraphSeriesSonificationDefaultSpeechOptionsMappingPitch Pitch { get; set; }
		private NetworkgraphSeriesSonificationDefaultSpeechOptionsMappingPitch Pitch_DefaultValue { get; set; }
		...
		/// </summary>
		public NetworkgraphSeriesSonificationDefaultSpeechOptionsMappingPlayDelay PlayDelay { get; set; }
		private NetworkgraphSeriesSonificationDefaultSpeechOptionsMappingPlayDelay PlayDelay_DefaultValue { get; set; }
		...
		/// </summary>
		public NetworkgraphSeriesSonificationDefaultSpeechOptionsMappingTime Time { get; set; }
		private NetworkgraphSeriesSonificationDefaultSpeechOptionsMappingTime Time_DefaultValue { get; set; }
		...
		/// </summary>
		public NetworkgraphSeriesSonificationDefaultSpeechOptionsMappingTremolo Tremolo { get; set; }
		private NetworkgraphSeriesSonificationDefaultSpeechOptionsMappingTremolo Tremolo_DefaultValue { get; set; }
		 

		/// <summary>
		/// The volume of notes, from 0 to 1.
		/// </summary>
		public NetworkgraphSeriesSonificationDefaultSpeechOptionsMappingVolume Volume { get; set; }
		private NetworkgraphSeriesSonificationDefaultSpeechOptionsMappingVolume Volume_DefaultValue { get; set; }
