...
{
	public partial class NetworkgraphSeriesSonificationPointGrouping  : BaseObject
	{
		Hashtable h = new Hashtable();

		public NetworkgraphSeriesSonificationPointGrouping()
		{
		...
		/// </summary>
		public NetworkgraphSeriesSonificationPointGroupingAlgorithm Algorithm { get; set; }
		private NetworkgraphSeriesSonificationPointGroupingAlgorithm Algorithm_DefaultValue { get; set; }
		...
		internal override Hashtable ToHashtable(Highcharts highcharts)
		{
			...
			if (Algorithm != NetworkgraphSeriesSonificationPointGroupingAlgorithm.Null) h.Add("algorithm", highcharts.FirstCharacterToLower(Algorithm.ToString()));
