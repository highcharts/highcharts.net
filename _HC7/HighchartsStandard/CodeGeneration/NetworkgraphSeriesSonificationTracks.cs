...
{
	public partial class NetworkgraphSeriesSonificationTracks  : BaseObject
	{
		Hashtable h = new Hashtable();

		public NetworkgraphSeriesSonificationTracks()
		{
			ActiveWhen = ActiveWhen_DefaultValue = new NetworkgraphSeriesSonificationTracksActiveWhen();
			Instrument = Instrument_DefaultValue = null;
			InstrumentString = InstrumentString_DefaultValue = "null";
			Mapping = Mapping_DefaultValue = new NetworkgraphSeriesSonificationTracksMapping();
			MidiName = MidiName_DefaultValue = "";
			PointGrouping = PointGrouping_DefaultValue = new NetworkgraphSeriesSonificationTracksPointGrouping();
			RoundToMusicalNotes = RoundToMusicalNotes_DefaultValue = true;
			ShowPlayMarker = ShowPlayMarker_DefaultValue = true;
			Type = Type_DefaultValue = NetworkgraphSeriesSonificationTracksType.Instrument;
		...
		/// </summary>
		public NetworkgraphSeriesSonificationTracksActiveWhen ActiveWhen { get; set; }
		private NetworkgraphSeriesSonificationTracksActiveWhen ActiveWhen_DefaultValue { get; set; }
		...
		/// </summary>
		public NetworkgraphSeriesSonificationTracksMapping Mapping { get; set; }
		private NetworkgraphSeriesSonificationTracksMapping Mapping_DefaultValue { get; set; }
		...
		/// </summary>
		public NetworkgraphSeriesSonificationTracksPointGrouping PointGrouping { get; set; }
		private NetworkgraphSeriesSonificationTracksPointGrouping PointGrouping_DefaultValue { get; set; }
		...
		/// </summary>
		public NetworkgraphSeriesSonificationTracksType Type { get; set; }
		private NetworkgraphSeriesSonificationTracksType Type_DefaultValue { get; set; }
