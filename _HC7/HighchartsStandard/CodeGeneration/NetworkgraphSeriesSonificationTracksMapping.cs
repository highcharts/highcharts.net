...
{
	public partial class NetworkgraphSeriesSonificationTracksMapping  : BaseObject
	{
		Hashtable h = new Hashtable();

		public NetworkgraphSeriesSonificationTracksMapping()
		{
			Frequency = Frequency_DefaultValue = new NetworkgraphSeriesSonificationTracksMappingFrequency();
			GapBetweenNotes = GapBetweenNotes_DefaultValue = new NetworkgraphSeriesSonificationTracksMappingGapBetweenNotes();
			Highpass = Highpass_DefaultValue = new NetworkgraphSeriesSonificationTracksMappingHighpass();
			Lowpass = Lowpass_DefaultValue = new NetworkgraphSeriesSonificationTracksMappingLowpass();
			NoteDuration = NoteDuration_DefaultValue = new NetworkgraphSeriesSonificationTracksMappingNoteDuration();
			Pan = Pan_DefaultValue = new NetworkgraphSeriesSonificationTracksMappingPan();
			Pitch = Pitch_DefaultValue = new NetworkgraphSeriesSonificationTracksMappingPitch();
			PitchString = PitchString_DefaultValue = "null";
			PitchNumber = PitchNumber_DefaultValue = null;
			PlayDelay = PlayDelay_DefaultValue = new NetworkgraphSeriesSonificationTracksMappingPlayDelay();
			Time = Time_DefaultValue = new NetworkgraphSeriesSonificationTracksMappingTime();
			TimeString = TimeString_DefaultValue = "null";
			TimeNumber = TimeNumber_DefaultValue = null;
			Tremolo = Tremolo_DefaultValue = new NetworkgraphSeriesSonificationTracksMappingTremolo();
			Volume = Volume_DefaultValue = new NetworkgraphSeriesSonificationTracksMappingVolume();
		...
		/// </summary>
		public NetworkgraphSeriesSonificationTracksMappingFrequency Frequency { get; set; }
		private NetworkgraphSeriesSonificationTracksMappingFrequency Frequency_DefaultValue { get; set; }
		...
		/// </summary>
		public NetworkgraphSeriesSonificationTracksMappingGapBetweenNotes GapBetweenNotes { get; set; }
		private NetworkgraphSeriesSonificationTracksMappingGapBetweenNotes GapBetweenNotes_DefaultValue { get; set; }
		...
		/// </summary>
		public NetworkgraphSeriesSonificationTracksMappingHighpass Highpass { get; set; }
		private NetworkgraphSeriesSonificationTracksMappingHighpass Highpass_DefaultValue { get; set; }
		...
		/// </summary>
		public NetworkgraphSeriesSonificationTracksMappingLowpass Lowpass { get; set; }
		private NetworkgraphSeriesSonificationTracksMappingLowpass Lowpass_DefaultValue { get; set; }
		...
		/// </summary>
		public NetworkgraphSeriesSonificationTracksMappingNoteDuration NoteDuration { get; set; }
		private NetworkgraphSeriesSonificationTracksMappingNoteDuration NoteDuration_DefaultValue { get; set; }
		...
		/// </summary>
		public NetworkgraphSeriesSonificationTracksMappingPan Pan { get; set; }
		private NetworkgraphSeriesSonificationTracksMappingPan Pan_DefaultValue { get; set; }
		...
		/// </summary>
		public NetworkgraphSeriesSonificationTracksMappingPitch Pitch { get; set; }
		private NetworkgraphSeriesSonificationTracksMappingPitch Pitch_DefaultValue { get; set; }
		...
		/// </summary>
		public NetworkgraphSeriesSonificationTracksMappingPlayDelay PlayDelay { get; set; }
		private NetworkgraphSeriesSonificationTracksMappingPlayDelay PlayDelay_DefaultValue { get; set; }
		...
		/// </summary>
		public NetworkgraphSeriesSonificationTracksMappingTime Time { get; set; }
		private NetworkgraphSeriesSonificationTracksMappingTime Time_DefaultValue { get; set; }
		...
		/// </summary>
		public NetworkgraphSeriesSonificationTracksMappingTremolo Tremolo { get; set; }
		private NetworkgraphSeriesSonificationTracksMappingTremolo Tremolo_DefaultValue { get; set; }
		 

		/// <summary>
		/// The volume of notes, from 0 to 1.
		/// </summary>
		public NetworkgraphSeriesSonificationTracksMappingVolume Volume { get; set; }
		private NetworkgraphSeriesSonificationTracksMappingVolume Volume_DefaultValue { get; set; }
