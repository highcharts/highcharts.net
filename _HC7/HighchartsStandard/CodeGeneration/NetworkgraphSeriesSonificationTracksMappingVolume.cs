...
{
	public partial class NetworkgraphSeriesSonificationTracksMappingVolume  : BaseObject
	{
		Hashtable h = new Hashtable();

		public NetworkgraphSeriesSonificationTracksMappingVolume()
		{
			MapFunction = MapFunction_DefaultValue = NetworkgraphSeriesSonificationTracksMappingVolumeMapFunction.Linear;
			MapTo = MapTo_DefaultValue = "";
			Max = Max_DefaultValue = null;
			Min = Min_DefaultValue = null;
			Value = Value_DefaultValue = null;
			Within = Within_DefaultValue = NetworkgraphSeriesSonificationTracksMappingVolumeWithin.Chart;
		...
		/// </summary>
		public NetworkgraphSeriesSonificationTracksMappingVolumeMapFunction MapFunction { get; set; }
		private NetworkgraphSeriesSonificationTracksMappingVolumeMapFunction MapFunction_DefaultValue { get; set; }
		...
		/// </summary>
		public NetworkgraphSeriesSonificationTracksMappingVolumeWithin Within { get; set; }
		private NetworkgraphSeriesSonificationTracksMappingVolumeWithin Within_DefaultValue { get; set; }
