...
{
	public partial class NetworkgraphSeriesSonificationTracksPointGrouping  : BaseObject
	{
		Hashtable h = new Hashtable();

		public NetworkgraphSeriesSonificationTracksPointGrouping()
		{
		...
		/// </summary>
		public NetworkgraphSeriesSonificationTracksPointGroupingAlgorithm Algorithm { get; set; }
		private NetworkgraphSeriesSonificationTracksPointGroupingAlgorithm Algorithm_DefaultValue { get; set; }
		...
		internal override Hashtable ToHashtable(Highcharts highcharts)
		{
			...
			if (Algorithm != NetworkgraphSeriesSonificationTracksPointGroupingAlgorithm.Null) h.Add("algorithm", highcharts.FirstCharacterToLower(Algorithm.ToString()));
