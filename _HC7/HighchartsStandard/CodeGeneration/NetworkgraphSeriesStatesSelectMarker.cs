...
{
	public partial class NetworkgraphSeriesStatesSelectMarker  : BaseObject
	{
		public NetworkgraphSeriesStatesSelectMarker()
		{
			...
			States = States_DefaultValue = new NetworkgraphSeriesStatesSelectMarkerStates();
		...
		/// </summary>
		public NetworkgraphSeriesStatesSelectMarkerStates States { get; set; }
		private NetworkgraphSeriesStatesSelectMarkerStates States_DefaultValue { get; set; }
