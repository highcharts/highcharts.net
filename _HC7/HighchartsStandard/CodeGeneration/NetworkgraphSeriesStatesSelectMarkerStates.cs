...
namespace Highsoft.Web.Mvc.Charts
{
	public partial class NetworkgraphSeriesStatesSelectMarkerStates  : BaseObject
	{
		public NetworkgraphSeriesStatesSelectMarkerStates()
		{
			...
			Inactive = Inactive_DefaultValue = new NetworkgraphSeriesStatesSelectMarkerStatesInactive();
		...
		/// 
		/// </summary>
		public NetworkgraphSeriesStatesSelectMarkerStatesInactive Inactive { get; set; }
		private NetworkgraphSeriesStatesSelectMarkerStatesInactive Inactive_DefaultValue { get; set; }
