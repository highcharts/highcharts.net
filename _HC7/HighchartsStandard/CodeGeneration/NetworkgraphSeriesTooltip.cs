...
{
	public partial class NetworkgraphSeriesTooltip  : BaseObject
	{
		public NetworkgraphSeriesTooltip()
		{
			...
			HeaderShape = HeaderShape_DefaultValue = NetworkgraphSeriesTooltipHeaderShape.Callout;
		...
		/// </summary>
		public NetworkgraphSeriesTooltipHeaderShape HeaderShape { get; set; }
		private NetworkgraphSeriesTooltipHeaderShape HeaderShape_DefaultValue { get; set; }
		...
		internal override Hashtable ToHashtable()
		{
			...
			if (NullFormatter != NullFormatter_DefaultValue) { h.Add("nullFormatter",NullFormatter); Highcharts.AddFunction("NetworkgraphSeriesTooltipNullFormatter.nullFormatter", NullFormatter); }  
			if (Outside != Outside_DefaultValue) h.Add("outside",Outside);
			if (Padding != Padding_DefaultValue) h.Add("padding",Padding);
			if (PointFormat != PointFormat_DefaultValue) h.Add("pointFormat",PointFormat);
			if (PointFormatter != PointFormatter_DefaultValue) { h.Add("pointFormatter",PointFormatter); Highcharts.AddFunction("NetworkgraphSeriesTooltipPointFormatter.pointFormatter", PointFormatter); }  
