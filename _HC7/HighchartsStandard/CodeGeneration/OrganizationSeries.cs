...
namespace Highsoft.Web.Mvc.Charts
{
	public partial class OrganizationSeries  : Series
	{
		public OrganizationSeries()
		{
			...
			Type = Type_DefaultValue = OrganizationSeriesType.Null;
		...
		/// </summary>
		public OrganizationSeriesDragDrop DragDrop { get; set; }
		private OrganizationSeriesDragDrop DragDrop_DefaultValue { get; set; }
		...
		internal override Hashtable ToHashtable()
		{
			...
			if (PointDescriptionFormatter != PointDescriptionFormatter_DefaultValue) { h.Add("pointDescriptionFormatter",PointDescriptionFormatter); Highcharts.AddFunction("659a61e3-469e-4730-bfb6-91d77cc3691d.pointDescriptionFormatter", PointDescriptionFormatter); }  
