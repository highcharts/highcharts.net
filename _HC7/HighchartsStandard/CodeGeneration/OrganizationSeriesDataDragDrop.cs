...
{
	public partial class OrganizationSeriesDataDragDrop  : BaseObject
	{
		public OrganizationSeriesDataDragDrop()
		{
			DraggableX = DraggableX_DefaultValue = null;
			DraggableY = DraggableY_DefaultValue = null;
			DragHandle = DragHandle_DefaultValue = new OrganizationSeriesDataDragDropDragHandle();
			...
			GuideBox = GuideBox_DefaultValue = new OrganizationSeriesDataDragDropGuideBox();
		...
		/// </summary>
		public OrganizationSeriesDataDragDropDragHandle DragHandle { get; set; }
		private OrganizationSeriesDataDragDropDragHandle DragHandle_DefaultValue { get; set; }
		...
		/// </summary>
		public OrganizationSeriesDataDragDropGuideBox GuideBox { get; set; }
		private OrganizationSeriesDataDragDropGuideBox GuideBox_DefaultValue { get; set; }
