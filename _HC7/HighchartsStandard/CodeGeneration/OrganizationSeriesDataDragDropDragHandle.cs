...
namespace Highsoft.Web.Mvc.Charts
{
	public partial class OrganizationSeriesDataDragDropDragHandle  : BaseObject
	{
		...
		internal override Hashtable ToHashtable()
		{
			...
			if (PathFormatter != PathFormatter_DefaultValue) { h.Add("pathFormatter",PathFormatter); Highcharts.AddFunction("d04385b8-22a4-4a89-81dc-ffe10111abe8.pathFormatter", PathFormatter); }  
