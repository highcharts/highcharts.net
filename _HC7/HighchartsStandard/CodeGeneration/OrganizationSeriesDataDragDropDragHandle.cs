...
{
	public partial class OrganizationSeriesDataDragDropDragHandle  : BaseObject
	{
		public OrganizationSeriesDataDragDropDragHandle()
		{
		...
		internal override Hashtable ToHashtable()
		{
			...
			if (PathFormatter != PathFormatter_DefaultValue) { h.Add("pathFormatter",PathFormatter); Highcharts.AddFunction("OrganizationSeriesDataDragDropDragHandlePathFormatter.pathFormatter", PathFormatter); }  
