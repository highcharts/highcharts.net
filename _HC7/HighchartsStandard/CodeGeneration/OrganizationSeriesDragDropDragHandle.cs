...
namespace Highsoft.Web.Mvc.Charts
{
	public partial class OrganizationSeriesDragDropDragHandle  : BaseObject
	{
		...
		internal override Hashtable ToHashtable()
		{
			...
			if (PathFormatter != PathFormatter_DefaultValue) { h.Add("pathFormatter",PathFormatter); Highcharts.AddFunction("54aab586-a70c-463f-819a-749df4ad758e.pathFormatter", PathFormatter); }  
