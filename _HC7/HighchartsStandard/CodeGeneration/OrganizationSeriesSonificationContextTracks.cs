...
{
	public partial class OrganizationSeriesSonificationContextTracks  : BaseObject
	{
		Hashtable h = new Hashtable();

		public OrganizationSeriesSonificationContextTracks()
		{
			ActiveWhen = ActiveWhen_DefaultValue = new OrganizationSeriesSonificationContextTracksActiveWhen();
			Instrument = Instrument_DefaultValue = null;
			InstrumentString = InstrumentString_DefaultValue = "null";
			Mapping = Mapping_DefaultValue = new OrganizationSeriesSonificationContextTracksMapping();
			MidiName = MidiName_DefaultValue = "";
			PointGrouping = PointGrouping_DefaultValue = new OrganizationSeriesSonificationContextTracksPointGrouping();
			...
			Type = Type_DefaultValue = OrganizationSeriesSonificationContextTracksType.Instrument;
			ValueInterval = ValueInterval_DefaultValue = null;
			ValueMapFunction = ValueMapFunction_DefaultValue = OrganizationSeriesSonificationContextTracksValueMapFunction.Linear;
		...
		/// </summary>
		public OrganizationSeriesSonificationContextTracksActiveWhen ActiveWhen { get; set; }
		private OrganizationSeriesSonificationContextTracksActiveWhen ActiveWhen_DefaultValue { get; set; }
		...
		/// </summary>
		public OrganizationSeriesSonificationContextTracksMapping Mapping { get; set; }
		private OrganizationSeriesSonificationContextTracksMapping Mapping_DefaultValue { get; set; }
		...
		/// </summary>
		public OrganizationSeriesSonificationContextTracksPointGrouping PointGrouping { get; set; }
		private OrganizationSeriesSonificationContextTracksPointGrouping PointGrouping_DefaultValue { get; set; }
		...
		/// </summary>
		public OrganizationSeriesSonificationContextTracksType Type { get; set; }
		private OrganizationSeriesSonificationContextTracksType Type_DefaultValue { get; set; }
		...
		/// </summary>
		public OrganizationSeriesSonificationContextTracksValueMapFunction ValueMapFunction { get; set; }
		private OrganizationSeriesSonificationContextTracksValueMapFunction ValueMapFunction_DefaultValue { get; set; }
