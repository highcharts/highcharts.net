...
{
	public partial class OrganizationSeriesSonificationContextTracksMapping  : BaseObject
	{
		Hashtable h = new Hashtable();

		public OrganizationSeriesSonificationContextTracksMapping()
		{
			Frequency = Frequency_DefaultValue = new OrganizationSeriesSonificationContextTracksMappingFrequency();
			GapBetweenNotes = GapBetweenNotes_DefaultValue = new OrganizationSeriesSonificationContextTracksMappingGapBetweenNotes();
			Highpass = Highpass_DefaultValue = new OrganizationSeriesSonificationContextTracksMappingHighpass();
			Lowpass = Lowpass_DefaultValue = new OrganizationSeriesSonificationContextTracksMappingLowpass();
			NoteDuration = NoteDuration_DefaultValue = new OrganizationSeriesSonificationContextTracksMappingNoteDuration();
			Pan = Pan_DefaultValue = new OrganizationSeriesSonificationContextTracksMappingPan();
			Pitch = Pitch_DefaultValue = new OrganizationSeriesSonificationContextTracksMappingPitch();
			PitchString = PitchString_DefaultValue = "null";
			PitchNumber = PitchNumber_DefaultValue = null;
			PlayDelay = PlayDelay_DefaultValue = new OrganizationSeriesSonificationContextTracksMappingPlayDelay();
			Time = Time_DefaultValue = new OrganizationSeriesSonificationContextTracksMappingTime();
			TimeString = TimeString_DefaultValue = "null";
			TimeNumber = TimeNumber_DefaultValue = null;
			Tremolo = Tremolo_DefaultValue = new OrganizationSeriesSonificationContextTracksMappingTremolo();
			Volume = Volume_DefaultValue = new OrganizationSeriesSonificationContextTracksMappingVolume();
		...
		/// </summary>
		public OrganizationSeriesSonificationContextTracksMappingFrequency Frequency { get; set; }
		private OrganizationSeriesSonificationContextTracksMappingFrequency Frequency_DefaultValue { get; set; }
		...
		/// </summary>
		public OrganizationSeriesSonificationContextTracksMappingGapBetweenNotes GapBetweenNotes { get; set; }
		private OrganizationSeriesSonificationContextTracksMappingGapBetweenNotes GapBetweenNotes_DefaultValue { get; set; }
		...
		/// </summary>
		public OrganizationSeriesSonificationContextTracksMappingHighpass Highpass { get; set; }
		private OrganizationSeriesSonificationContextTracksMappingHighpass Highpass_DefaultValue { get; set; }
		...
		/// </summary>
		public OrganizationSeriesSonificationContextTracksMappingLowpass Lowpass { get; set; }
		private OrganizationSeriesSonificationContextTracksMappingLowpass Lowpass_DefaultValue { get; set; }
		...
		/// </summary>
		public OrganizationSeriesSonificationContextTracksMappingNoteDuration NoteDuration { get; set; }
		private OrganizationSeriesSonificationContextTracksMappingNoteDuration NoteDuration_DefaultValue { get; set; }
		...
		/// </summary>
		public OrganizationSeriesSonificationContextTracksMappingPan Pan { get; set; }
		private OrganizationSeriesSonificationContextTracksMappingPan Pan_DefaultValue { get; set; }
		...
		/// </summary>
		public OrganizationSeriesSonificationContextTracksMappingPitch Pitch { get; set; }
		private OrganizationSeriesSonificationContextTracksMappingPitch Pitch_DefaultValue { get; set; }
		...
		/// </summary>
		public OrganizationSeriesSonificationContextTracksMappingPlayDelay PlayDelay { get; set; }
		private OrganizationSeriesSonificationContextTracksMappingPlayDelay PlayDelay_DefaultValue { get; set; }
		...
		/// </summary>
		public OrganizationSeriesSonificationContextTracksMappingTime Time { get; set; }
		private OrganizationSeriesSonificationContextTracksMappingTime Time_DefaultValue { get; set; }
		...
		/// </summary>
		public OrganizationSeriesSonificationContextTracksMappingTremolo Tremolo { get; set; }
		private OrganizationSeriesSonificationContextTracksMappingTremolo Tremolo_DefaultValue { get; set; }
		 

		/// <summary>
		/// The volume of notes, from 0 to 1.
		/// </summary>
		public OrganizationSeriesSonificationContextTracksMappingVolume Volume { get; set; }
		private OrganizationSeriesSonificationContextTracksMappingVolume Volume_DefaultValue { get; set; }
