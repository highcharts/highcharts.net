...
{
	public partial class OrganizationSeriesSonificationContextTracksMappingPitch  : BaseObject
	{
		Hashtable h = new Hashtable();

		public OrganizationSeriesSonificationContextTracksMappingPitch()
		{
			MapFunction = MapFunction_DefaultValue = OrganizationSeriesSonificationContextTracksMappingPitchMapFunction.Linear;
		...
		/// </summary>
		public OrganizationSeriesSonificationContextTracksMappingPitchMapFunction MapFunction { get; set; }
		private OrganizationSeriesSonificationContextTracksMappingPitchMapFunction MapFunction_DefaultValue { get; set; }
