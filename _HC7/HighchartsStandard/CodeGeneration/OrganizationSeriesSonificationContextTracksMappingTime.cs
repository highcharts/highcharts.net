...
{
	public partial class OrganizationSeriesSonificationContextTracksMappingTime  : BaseObject
	{
		Hashtable h = new Hashtable();

		public OrganizationSeriesSonificationContextTracksMappingTime()
		{
			MapFunction = MapFunction_DefaultValue = OrganizationSeriesSonificationContextTracksMappingTimeMapFunction.Linear;
			MapTo = MapTo_DefaultValue = "";
			Max = Max_DefaultValue = null;
			Min = Min_DefaultValue = null;
			Value = Value_DefaultValue = null;
			Within = Within_DefaultValue = OrganizationSeriesSonificationContextTracksMappingTimeWithin.Chart;
		...
		/// </summary>
		public OrganizationSeriesSonificationContextTracksMappingTimeMapFunction MapFunction { get; set; }
		private OrganizationSeriesSonificationContextTracksMappingTimeMapFunction MapFunction_DefaultValue { get; set; }
		...
		/// </summary>
		public OrganizationSeriesSonificationContextTracksMappingTimeWithin Within { get; set; }
		private OrganizationSeriesSonificationContextTracksMappingTimeWithin Within_DefaultValue { get; set; }
