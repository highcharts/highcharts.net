...
{
	public partial class OrganizationSeriesSonificationContextTracksMappingTremoloDepth  : BaseObject
	{
		Hashtable h = new Hashtable();

		public OrganizationSeriesSonificationContextTracksMappingTremoloDepth()
		{
			MapFunction = MapFunction_DefaultValue = OrganizationSeriesSonificationContextTracksMappingTremoloDepthMapFunction.Linear;
			MapTo = MapTo_DefaultValue = "";
			Max = Max_DefaultValue = null;
			Min = Min_DefaultValue = null;
			Value = Value_DefaultValue = null;
			Within = Within_DefaultValue = OrganizationSeriesSonificationContextTracksMappingTremoloDepthWithin.Chart;
		...
		/// </summary>
		public OrganizationSeriesSonificationContextTracksMappingTremoloDepthMapFunction MapFunction { get; set; }
		private OrganizationSeriesSonificationContextTracksMappingTremoloDepthMapFunction MapFunction_DefaultValue { get; set; }
		...
		/// </summary>
		public OrganizationSeriesSonificationContextTracksMappingTremoloDepthWithin Within { get; set; }
		private OrganizationSeriesSonificationContextTracksMappingTremoloDepthWithin Within_DefaultValue { get; set; }
