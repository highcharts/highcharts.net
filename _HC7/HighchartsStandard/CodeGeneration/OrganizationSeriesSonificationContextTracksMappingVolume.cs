...
{
	public partial class OrganizationSeriesSonificationContextTracksMappingVolume  : BaseObject
	{
		Hashtable h = new Hashtable();

		public OrganizationSeriesSonificationContextTracksMappingVolume()
		{
			MapFunction = MapFunction_DefaultValue = OrganizationSeriesSonificationContextTracksMappingVolumeMapFunction.Linear;
			MapTo = MapTo_DefaultValue = "";
			Max = Max_DefaultValue = null;
			Min = Min_DefaultValue = null;
			Value = Value_DefaultValue = null;
			Within = Within_DefaultValue = OrganizationSeriesSonificationContextTracksMappingVolumeWithin.Chart;
		...
		/// </summary>
		public OrganizationSeriesSonificationContextTracksMappingVolumeMapFunction MapFunction { get; set; }
		private OrganizationSeriesSonificationContextTracksMappingVolumeMapFunction MapFunction_DefaultValue { get; set; }
		...
		/// </summary>
		public OrganizationSeriesSonificationContextTracksMappingVolumeWithin Within { get; set; }
		private OrganizationSeriesSonificationContextTracksMappingVolumeWithin Within_DefaultValue { get; set; }
