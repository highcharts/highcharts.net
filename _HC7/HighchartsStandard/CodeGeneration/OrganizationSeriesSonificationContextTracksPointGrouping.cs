...
{
	public partial class OrganizationSeriesSonificationContextTracksPointGrouping  : BaseObject
	{
		Hashtable h = new Hashtable();

		public OrganizationSeriesSonificationContextTracksPointGrouping()
		{
		...
		/// </summary>
		public OrganizationSeriesSonificationContextTracksPointGroupingAlgorithm Algorithm { get; set; }
		private OrganizationSeriesSonificationContextTracksPointGroupingAlgorithm Algorithm_DefaultValue { get; set; }
		...
		internal override Hashtable ToHashtable(Highcharts highcharts)
		{
			...
			if (Algorithm != OrganizationSeriesSonificationContextTracksPointGroupingAlgorithm.Null) h.Add("algorithm", highcharts.FirstCharacterToLower(Algorithm.ToString()));
