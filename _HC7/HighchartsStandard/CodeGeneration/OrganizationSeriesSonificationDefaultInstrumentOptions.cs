...
{
	public partial class OrganizationSeriesSonificationDefaultInstrumentOptions  : BaseObject
	{
		Hashtable h = new Hashtable();

		public OrganizationSeriesSonificationDefaultInstrumentOptions()
		{
			ActiveWhen = ActiveWhen_DefaultValue = new OrganizationSeriesSonificationDefaultInstrumentOptionsActiveWhen();
			Instrument = Instrument_DefaultValue = null;
			InstrumentString = InstrumentString_DefaultValue = "null";
			Mapping = Mapping_DefaultValue = new OrganizationSeriesSonificationDefaultInstrumentOptionsMapping();
			MidiName = MidiName_DefaultValue = "";
			PointGrouping = PointGrouping_DefaultValue = new OrganizationSeriesSonificationDefaultInstrumentOptionsPointGrouping();
			RoundToMusicalNotes = RoundToMusicalNotes_DefaultValue = true;
			ShowPlayMarker = ShowPlayMarker_DefaultValue = true;
			Type = Type_DefaultValue = OrganizationSeriesSonificationDefaultInstrumentOptionsType.Instrument;
		...
		/// </summary>
		public OrganizationSeriesSonificationDefaultInstrumentOptionsActiveWhen ActiveWhen { get; set; }
		private OrganizationSeriesSonificationDefaultInstrumentOptionsActiveWhen ActiveWhen_DefaultValue { get; set; }
		...
		/// </summary>
		public OrganizationSeriesSonificationDefaultInstrumentOptionsMapping Mapping { get; set; }
		private OrganizationSeriesSonificationDefaultInstrumentOptionsMapping Mapping_DefaultValue { get; set; }
		...
		/// </summary>
		public OrganizationSeriesSonificationDefaultInstrumentOptionsPointGrouping PointGrouping { get; set; }
		private OrganizationSeriesSonificationDefaultInstrumentOptionsPointGrouping PointGrouping_DefaultValue { get; set; }
		...
		/// </summary>
		public OrganizationSeriesSonificationDefaultInstrumentOptionsType Type { get; set; }
		private OrganizationSeriesSonificationDefaultInstrumentOptionsType Type_DefaultValue { get; set; }
