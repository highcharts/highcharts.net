...
{
	public partial class OrganizationSeriesSonificationDefaultInstrumentOptionsActiveWhen  : BaseObject
	{
		Hashtable h = new Hashtable();

		public OrganizationSeriesSonificationDefaultInstrumentOptionsActiveWhen()
		{
