...
{
	public partial class OrganizationSeriesSonificationDefaultSpeechOptions  : BaseObject
	{
		Hashtable h = new Hashtable();

		public OrganizationSeriesSonificationDefaultSpeechOptions()
		{
			ActiveWhen = ActiveWhen_DefaultValue = new OrganizationSeriesSonificationDefaultSpeechOptionsActiveWhen();
			Language = Language_DefaultValue = "en-US";
			Mapping = Mapping_DefaultValue = new OrganizationSeriesSonificationDefaultSpeechOptionsMapping();
			PointGrouping = PointGrouping_DefaultValue = new OrganizationSeriesSonificationDefaultSpeechOptionsPointGrouping();
			PreferredVoice = PreferredVoice_DefaultValue = "";
			ShowPlayMarker = ShowPlayMarker_DefaultValue = true;
			Type = Type_DefaultValue = OrganizationSeriesSonificationDefaultSpeechOptionsType.Instrument;
		...
		/// </summary>
		public OrganizationSeriesSonificationDefaultSpeechOptionsActiveWhen ActiveWhen { get; set; }
		private OrganizationSeriesSonificationDefaultSpeechOptionsActiveWhen ActiveWhen_DefaultValue { get; set; }
		...
		/// </summary>
		public OrganizationSeriesSonificationDefaultSpeechOptionsMapping Mapping { get; set; }
		private OrganizationSeriesSonificationDefaultSpeechOptionsMapping Mapping_DefaultValue { get; set; }
		 

		/// <summary>
		/// Options for point grouping, specifically for instrument tracks.
		/// </summary>
		public OrganizationSeriesSonificationDefaultSpeechOptionsPointGrouping PointGrouping { get; set; }
		private OrganizationSeriesSonificationDefaultSpeechOptionsPointGrouping PointGrouping_DefaultValue { get; set; }
		...
		/// </summary>
		public OrganizationSeriesSonificationDefaultSpeechOptionsType Type { get; set; }
		private OrganizationSeriesSonificationDefaultSpeechOptionsType Type_DefaultValue { get; set; }
