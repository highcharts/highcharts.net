...
{
	public partial class OrganizationSeriesSonificationDefaultSpeechOptionsMapping  : BaseObject
	{
		Hashtable h = new Hashtable();

		public OrganizationSeriesSonificationDefaultSpeechOptionsMapping()
		{
			Frequency = Frequency_DefaultValue = new OrganizationSeriesSonificationDefaultSpeechOptionsMappingFrequency();
			GapBetweenNotes = GapBetweenNotes_DefaultValue = new OrganizationSeriesSonificationDefaultSpeechOptionsMappingGapBetweenNotes();
			Highpass = Highpass_DefaultValue = new OrganizationSeriesSonificationDefaultSpeechOptionsMappingHighpass();
			Lowpass = Lowpass_DefaultValue = new OrganizationSeriesSonificationDefaultSpeechOptionsMappingLowpass();
			NoteDuration = NoteDuration_DefaultValue = new OrganizationSeriesSonificationDefaultSpeechOptionsMappingNoteDuration();
			Pan = Pan_DefaultValue = new OrganizationSeriesSonificationDefaultSpeechOptionsMappingPan();
			Pitch = Pitch_DefaultValue = new OrganizationSeriesSonificationDefaultSpeechOptionsMappingPitch();
			PitchString = PitchString_DefaultValue = "null";
			PitchNumber = PitchNumber_DefaultValue = null;
			PlayDelay = PlayDelay_DefaultValue = new OrganizationSeriesSonificationDefaultSpeechOptionsMappingPlayDelay();
			Time = Time_DefaultValue = new OrganizationSeriesSonificationDefaultSpeechOptionsMappingTime();
			TimeString = TimeString_DefaultValue = "null";
			TimeNumber = TimeNumber_DefaultValue = null;
			Tremolo = Tremolo_DefaultValue = new OrganizationSeriesSonificationDefaultSpeechOptionsMappingTremolo();
			Volume = Volume_DefaultValue = new OrganizationSeriesSonificationDefaultSpeechOptionsMappingVolume();
		...
		/// </summary>
		public OrganizationSeriesSonificationDefaultSpeechOptionsMappingFrequency Frequency { get; set; }
		private OrganizationSeriesSonificationDefaultSpeechOptionsMappingFrequency Frequency_DefaultValue { get; set; }
		...
		/// </summary>
		public OrganizationSeriesSonificationDefaultSpeechOptionsMappingGapBetweenNotes GapBetweenNotes { get; set; }
		private OrganizationSeriesSonificationDefaultSpeechOptionsMappingGapBetweenNotes GapBetweenNotes_DefaultValue { get; set; }
		...
		/// </summary>
		public OrganizationSeriesSonificationDefaultSpeechOptionsMappingHighpass Highpass { get; set; }
		private OrganizationSeriesSonificationDefaultSpeechOptionsMappingHighpass Highpass_DefaultValue { get; set; }
		...
		/// </summary>
		public OrganizationSeriesSonificationDefaultSpeechOptionsMappingLowpass Lowpass { get; set; }
		private OrganizationSeriesSonificationDefaultSpeechOptionsMappingLowpass Lowpass_DefaultValue { get; set; }
		...
		/// </summary>
		public OrganizationSeriesSonificationDefaultSpeechOptionsMappingNoteDuration NoteDuration { get; set; }
		private OrganizationSeriesSonificationDefaultSpeechOptionsMappingNoteDuration NoteDuration_DefaultValue { get; set; }
		...
		/// </summary>
		public OrganizationSeriesSonificationDefaultSpeechOptionsMappingPan Pan { get; set; }
		private OrganizationSeriesSonificationDefaultSpeechOptionsMappingPan Pan_DefaultValue { get; set; }
		...
		/// </summary>
		public OrganizationSeriesSonificationDefaultSpeechOptionsMappingPitch Pitch { get; set; }
		private OrganizationSeriesSonificationDefaultSpeechOptionsMappingPitch Pitch_DefaultValue { get; set; }
		...
		/// </summary>
		public OrganizationSeriesSonificationDefaultSpeechOptionsMappingPlayDelay PlayDelay { get; set; }
		private OrganizationSeriesSonificationDefaultSpeechOptionsMappingPlayDelay PlayDelay_DefaultValue { get; set; }
		...
		/// </summary>
		public OrganizationSeriesSonificationDefaultSpeechOptionsMappingTime Time { get; set; }
		private OrganizationSeriesSonificationDefaultSpeechOptionsMappingTime Time_DefaultValue { get; set; }
		...
		/// </summary>
		public OrganizationSeriesSonificationDefaultSpeechOptionsMappingTremolo Tremolo { get; set; }
		private OrganizationSeriesSonificationDefaultSpeechOptionsMappingTremolo Tremolo_DefaultValue { get; set; }
		 

		/// <summary>
		/// The volume of notes, from 0 to 1.
		/// </summary>
		public OrganizationSeriesSonificationDefaultSpeechOptionsMappingVolume Volume { get; set; }
		private OrganizationSeriesSonificationDefaultSpeechOptionsMappingVolume Volume_DefaultValue { get; set; }
