...
{
	public partial class OrganizationSeriesSonificationDefaultSpeechOptionsMappingPan  : BaseObject
	{
		Hashtable h = new Hashtable();

		public OrganizationSeriesSonificationDefaultSpeechOptionsMappingPan()
		{
			MapFunction = MapFunction_DefaultValue = OrganizationSeriesSonificationDefaultSpeechOptionsMappingPanMapFunction.Linear;
			MapTo = MapTo_DefaultValue = "";
			Max = Max_DefaultValue = null;
			Min = Min_DefaultValue = null;
			Value = Value_DefaultValue = null;
			Within = Within_DefaultValue = OrganizationSeriesSonificationDefaultSpeechOptionsMappingPanWithin.Chart;
		...
		/// </summary>
		public OrganizationSeriesSonificationDefaultSpeechOptionsMappingPanMapFunction MapFunction { get; set; }
		private OrganizationSeriesSonificationDefaultSpeechOptionsMappingPanMapFunction MapFunction_DefaultValue { get; set; }
		...
		/// </summary>
		public OrganizationSeriesSonificationDefaultSpeechOptionsMappingPanWithin Within { get; set; }
		private OrganizationSeriesSonificationDefaultSpeechOptionsMappingPanWithin Within_DefaultValue { get; set; }
