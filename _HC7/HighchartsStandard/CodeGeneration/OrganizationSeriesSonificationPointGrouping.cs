...
{
	public partial class OrganizationSeriesSonificationPointGrouping  : BaseObject
	{
		Hashtable h = new Hashtable();

		public OrganizationSeriesSonificationPointGrouping()
		{
		...
		/// </summary>
		public OrganizationSeriesSonificationPointGroupingAlgorithm Algorithm { get; set; }
		private OrganizationSeriesSonificationPointGroupingAlgorithm Algorithm_DefaultValue { get; set; }
		...
		internal override Hashtable ToHashtable(Highcharts highcharts)
		{
			...
			if (Algorithm != OrganizationSeriesSonificationPointGroupingAlgorithm.Null) h.Add("algorithm", highcharts.FirstCharacterToLower(Algorithm.ToString()));
