...
{
	public partial class OrganizationSeriesSonificationTracks  : BaseObject
	{
		Hashtable h = new Hashtable();

		public OrganizationSeriesSonificationTracks()
		{
			ActiveWhen = ActiveWhen_DefaultValue = new OrganizationSeriesSonificationTracksActiveWhen();
			Instrument = Instrument_DefaultValue = null;
			InstrumentString = InstrumentString_DefaultValue = "null";
			Mapping = Mapping_DefaultValue = new OrganizationSeriesSonificationTracksMapping();
			MidiName = MidiName_DefaultValue = "";
			PointGrouping = PointGrouping_DefaultValue = new OrganizationSeriesSonificationTracksPointGrouping();
			RoundToMusicalNotes = RoundToMusicalNotes_DefaultValue = true;
			ShowPlayMarker = ShowPlayMarker_DefaultValue = true;
			Type = Type_DefaultValue = OrganizationSeriesSonificationTracksType.Instrument;
		...
		/// </summary>
		public OrganizationSeriesSonificationTracksActiveWhen ActiveWhen { get; set; }
		private OrganizationSeriesSonificationTracksActiveWhen ActiveWhen_DefaultValue { get; set; }
		...
		/// </summary>
		public OrganizationSeriesSonificationTracksMapping Mapping { get; set; }
		private OrganizationSeriesSonificationTracksMapping Mapping_DefaultValue { get; set; }
		...
		/// </summary>
		public OrganizationSeriesSonificationTracksPointGrouping PointGrouping { get; set; }
		private OrganizationSeriesSonificationTracksPointGrouping PointGrouping_DefaultValue { get; set; }
		...
		/// </summary>
		public OrganizationSeriesSonificationTracksType Type { get; set; }
		private OrganizationSeriesSonificationTracksType Type_DefaultValue { get; set; }
