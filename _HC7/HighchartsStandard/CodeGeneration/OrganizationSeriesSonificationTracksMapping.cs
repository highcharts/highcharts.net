...
{
	public partial class OrganizationSeriesSonificationTracksMapping  : BaseObject
	{
		Hashtable h = new Hashtable();

		public OrganizationSeriesSonificationTracksMapping()
		{
			Frequency = Frequency_DefaultValue = new OrganizationSeriesSonificationTracksMappingFrequency();
			GapBetweenNotes = GapBetweenNotes_DefaultValue = new OrganizationSeriesSonificationTracksMappingGapBetweenNotes();
			Highpass = Highpass_DefaultValue = new OrganizationSeriesSonificationTracksMappingHighpass();
			Lowpass = Lowpass_DefaultValue = new OrganizationSeriesSonificationTracksMappingLowpass();
			NoteDuration = NoteDuration_DefaultValue = new OrganizationSeriesSonificationTracksMappingNoteDuration();
			Pan = Pan_DefaultValue = new OrganizationSeriesSonificationTracksMappingPan();
			Pitch = Pitch_DefaultValue = new OrganizationSeriesSonificationTracksMappingPitch();
			PitchString = PitchString_DefaultValue = "null";
			PitchNumber = PitchNumber_DefaultValue = null;
			PlayDelay = PlayDelay_DefaultValue = new OrganizationSeriesSonificationTracksMappingPlayDelay();
			Time = Time_DefaultValue = new OrganizationSeriesSonificationTracksMappingTime();
			TimeString = TimeString_DefaultValue = "null";
			TimeNumber = TimeNumber_DefaultValue = null;
			Tremolo = Tremolo_DefaultValue = new OrganizationSeriesSonificationTracksMappingTremolo();
			Volume = Volume_DefaultValue = new OrganizationSeriesSonificationTracksMappingVolume();
		...
		/// </summary>
		public OrganizationSeriesSonificationTracksMappingFrequency Frequency { get; set; }
		private OrganizationSeriesSonificationTracksMappingFrequency Frequency_DefaultValue { get; set; }
		...
		/// </summary>
		public OrganizationSeriesSonificationTracksMappingGapBetweenNotes GapBetweenNotes { get; set; }
		private OrganizationSeriesSonificationTracksMappingGapBetweenNotes GapBetweenNotes_DefaultValue { get; set; }
		...
		/// </summary>
		public OrganizationSeriesSonificationTracksMappingHighpass Highpass { get; set; }
		private OrganizationSeriesSonificationTracksMappingHighpass Highpass_DefaultValue { get; set; }
		...
		/// </summary>
		public OrganizationSeriesSonificationTracksMappingLowpass Lowpass { get; set; }
		private OrganizationSeriesSonificationTracksMappingLowpass Lowpass_DefaultValue { get; set; }
		...
		/// </summary>
		public OrganizationSeriesSonificationTracksMappingNoteDuration NoteDuration { get; set; }
		private OrganizationSeriesSonificationTracksMappingNoteDuration NoteDuration_DefaultValue { get; set; }
		...
		/// </summary>
		public OrganizationSeriesSonificationTracksMappingPan Pan { get; set; }
		private OrganizationSeriesSonificationTracksMappingPan Pan_DefaultValue { get; set; }
		...
		/// </summary>
		public OrganizationSeriesSonificationTracksMappingPitch Pitch { get; set; }
		private OrganizationSeriesSonificationTracksMappingPitch Pitch_DefaultValue { get; set; }
		...
		/// </summary>
		public OrganizationSeriesSonificationTracksMappingPlayDelay PlayDelay { get; set; }
		private OrganizationSeriesSonificationTracksMappingPlayDelay PlayDelay_DefaultValue { get; set; }
		...
		/// </summary>
		public OrganizationSeriesSonificationTracksMappingTime Time { get; set; }
		private OrganizationSeriesSonificationTracksMappingTime Time_DefaultValue { get; set; }
		...
		/// </summary>
		public OrganizationSeriesSonificationTracksMappingTremolo Tremolo { get; set; }
		private OrganizationSeriesSonificationTracksMappingTremolo Tremolo_DefaultValue { get; set; }
		 

		/// <summary>
		/// The volume of notes, from 0 to 1.
		/// </summary>
		public OrganizationSeriesSonificationTracksMappingVolume Volume { get; set; }
		private OrganizationSeriesSonificationTracksMappingVolume Volume_DefaultValue { get; set; }
