...
{
	public partial class OrganizationSeriesSonificationTracksMappingFrequency  : BaseObject
	{
		Hashtable h = new Hashtable();

		public OrganizationSeriesSonificationTracksMappingFrequency()
		{
			MapFunction = MapFunction_DefaultValue = OrganizationSeriesSonificationTracksMappingFrequencyMapFunction.Linear;
			MapTo = MapTo_DefaultValue = "";
			Max = Max_DefaultValue = null;
			Min = Min_DefaultValue = null;
			Value = Value_DefaultValue = null;
			Within = Within_DefaultValue = OrganizationSeriesSonificationTracksMappingFrequencyWithin.Chart;
		...
		/// </summary>
		public OrganizationSeriesSonificationTracksMappingFrequencyMapFunction MapFunction { get; set; }
		private OrganizationSeriesSonificationTracksMappingFrequencyMapFunction MapFunction_DefaultValue { get; set; }
		...
		/// </summary>
		public OrganizationSeriesSonificationTracksMappingFrequencyWithin Within { get; set; }
		private OrganizationSeriesSonificationTracksMappingFrequencyWithin Within_DefaultValue { get; set; }
