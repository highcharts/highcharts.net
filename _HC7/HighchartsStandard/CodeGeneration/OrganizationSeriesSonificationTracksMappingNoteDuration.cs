...
{
	public partial class OrganizationSeriesSonificationTracksMappingNoteDuration  : BaseObject
	{
		Hashtable h = new Hashtable();

		public OrganizationSeriesSonificationTracksMappingNoteDuration()
		{
			MapFunction = MapFunction_DefaultValue = OrganizationSeriesSonificationTracksMappingNoteDurationMapFunction.Linear;
			MapTo = MapTo_DefaultValue = "";
			Max = Max_DefaultValue = null;
			Min = Min_DefaultValue = null;
			Value = Value_DefaultValue = null;
			Within = Within_DefaultValue = OrganizationSeriesSonificationTracksMappingNoteDurationWithin.Chart;
		...
		/// </summary>
		public OrganizationSeriesSonificationTracksMappingNoteDurationMapFunction MapFunction { get; set; }
		private OrganizationSeriesSonificationTracksMappingNoteDurationMapFunction MapFunction_DefaultValue { get; set; }
		...
		/// </summary>
		public OrganizationSeriesSonificationTracksMappingNoteDurationWithin Within { get; set; }
		private OrganizationSeriesSonificationTracksMappingNoteDurationWithin Within_DefaultValue { get; set; }
