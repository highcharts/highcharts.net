...
{
	public partial class OrganizationSeriesSonificationTracksMappingPan  : BaseObject
	{
		Hashtable h = new Hashtable();

		public OrganizationSeriesSonificationTracksMappingPan()
		{
			MapFunction = MapFunction_DefaultValue = OrganizationSeriesSonificationTracksMappingPanMapFunction.Linear;
			MapTo = MapTo_DefaultValue = "";
			Max = Max_DefaultValue = null;
			Min = Min_DefaultValue = null;
			Value = Value_DefaultValue = null;
			Within = Within_DefaultValue = OrganizationSeriesSonificationTracksMappingPanWithin.Chart;
		...
		/// </summary>
		public OrganizationSeriesSonificationTracksMappingPanMapFunction MapFunction { get; set; }
		private OrganizationSeriesSonificationTracksMappingPanMapFunction MapFunction_DefaultValue { get; set; }
		...
		/// </summary>
		public OrganizationSeriesSonificationTracksMappingPanWithin Within { get; set; }
		private OrganizationSeriesSonificationTracksMappingPanWithin Within_DefaultValue { get; set; }
