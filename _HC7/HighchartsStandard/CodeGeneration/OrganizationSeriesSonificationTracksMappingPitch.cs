...
{
	public partial class OrganizationSeriesSonificationTracksMappingPitch  : BaseObject
	{
		Hashtable h = new Hashtable();

		public OrganizationSeriesSonificationTracksMappingPitch()
		{
			MapFunction = MapFunction_DefaultValue = OrganizationSeriesSonificationTracksMappingPitchMapFunction.Linear;
		...
		/// </summary>
		public OrganizationSeriesSonificationTracksMappingPitchMapFunction MapFunction { get; set; }
		private OrganizationSeriesSonificationTracksMappingPitchMapFunction MapFunction_DefaultValue { get; set; }
