...
{
	public partial class OrganizationSeriesSonificationTracksMappingPlayDelay  : BaseObject
	{
		Hashtable h = new Hashtable();

		public OrganizationSeriesSonificationTracksMappingPlayDelay()
		{
			MapFunction = MapFunction_DefaultValue = OrganizationSeriesSonificationTracksMappingPlayDelayMapFunction.Linear;
			MapTo = MapTo_DefaultValue = "";
			Max = Max_DefaultValue = null;
			Min = Min_DefaultValue = null;
			Value = Value_DefaultValue = null;
			Within = Within_DefaultValue = OrganizationSeriesSonificationTracksMappingPlayDelayWithin.Chart;
		...
		/// </summary>
		public OrganizationSeriesSonificationTracksMappingPlayDelayMapFunction MapFunction { get; set; }
		private OrganizationSeriesSonificationTracksMappingPlayDelayMapFunction MapFunction_DefaultValue { get; set; }
		...
		/// </summary>
		public OrganizationSeriesSonificationTracksMappingPlayDelayWithin Within { get; set; }
		private OrganizationSeriesSonificationTracksMappingPlayDelayWithin Within_DefaultValue { get; set; }
