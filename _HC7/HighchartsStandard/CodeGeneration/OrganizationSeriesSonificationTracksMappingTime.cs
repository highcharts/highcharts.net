...
{
	public partial class OrganizationSeriesSonificationTracksMappingTime  : BaseObject
	{
		Hashtable h = new Hashtable();

		public OrganizationSeriesSonificationTracksMappingTime()
		{
			MapFunction = MapFunction_DefaultValue = OrganizationSeriesSonificationTracksMappingTimeMapFunction.Linear;
			MapTo = MapTo_DefaultValue = "";
			Max = Max_DefaultValue = null;
			Min = Min_DefaultValue = null;
			Value = Value_DefaultValue = null;
			Within = Within_DefaultValue = OrganizationSeriesSonificationTracksMappingTimeWithin.Chart;
		...
		/// </summary>
		public OrganizationSeriesSonificationTracksMappingTimeMapFunction MapFunction { get; set; }
		private OrganizationSeriesSonificationTracksMappingTimeMapFunction MapFunction_DefaultValue { get; set; }
		...
		/// </summary>
		public OrganizationSeriesSonificationTracksMappingTimeWithin Within { get; set; }
		private OrganizationSeriesSonificationTracksMappingTimeWithin Within_DefaultValue { get; set; }
