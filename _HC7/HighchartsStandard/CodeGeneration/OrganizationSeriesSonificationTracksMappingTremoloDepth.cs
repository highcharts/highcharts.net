...
{
	public partial class OrganizationSeriesSonificationTracksMappingTremoloDepth  : BaseObject
	{
		Hashtable h = new Hashtable();

		public OrganizationSeriesSonificationTracksMappingTremoloDepth()
		{
			MapFunction = MapFunction_DefaultValue = OrganizationSeriesSonificationTracksMappingTremoloDepthMapFunction.Linear;
			MapTo = MapTo_DefaultValue = "";
			Max = Max_DefaultValue = null;
			Min = Min_DefaultValue = null;
			Value = Value_DefaultValue = null;
			Within = Within_DefaultValue = OrganizationSeriesSonificationTracksMappingTremoloDepthWithin.Chart;
		...
		/// </summary>
		public OrganizationSeriesSonificationTracksMappingTremoloDepthMapFunction MapFunction { get; set; }
		private OrganizationSeriesSonificationTracksMappingTremoloDepthMapFunction MapFunction_DefaultValue { get; set; }
		...
		/// </summary>
		public OrganizationSeriesSonificationTracksMappingTremoloDepthWithin Within { get; set; }
		private OrganizationSeriesSonificationTracksMappingTremoloDepthWithin Within_DefaultValue { get; set; }
