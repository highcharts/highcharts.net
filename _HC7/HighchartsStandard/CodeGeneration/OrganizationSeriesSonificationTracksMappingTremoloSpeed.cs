...
{
	public partial class OrganizationSeriesSonificationTracksMappingTremoloSpeed  : BaseObject
	{
		Hashtable h = new Hashtable();

		public OrganizationSeriesSonificationTracksMappingTremoloSpeed()
		{
			MapFunction = MapFunction_DefaultValue = OrganizationSeriesSonificationTracksMappingTremoloSpeedMapFunction.Linear;
			MapTo = MapTo_DefaultValue = "";
			Max = Max_DefaultValue = null;
			Min = Min_DefaultValue = null;
			Value = Value_DefaultValue = null;
			Within = Within_DefaultValue = OrganizationSeriesSonificationTracksMappingTremoloSpeedWithin.Chart;
		...
		/// </summary>
		public OrganizationSeriesSonificationTracksMappingTremoloSpeedMapFunction MapFunction { get; set; }
		private OrganizationSeriesSonificationTracksMappingTremoloSpeedMapFunction MapFunction_DefaultValue { get; set; }
		...
		/// </summary>
		public OrganizationSeriesSonificationTracksMappingTremoloSpeedWithin Within { get; set; }
		private OrganizationSeriesSonificationTracksMappingTremoloSpeedWithin Within_DefaultValue { get; set; }
