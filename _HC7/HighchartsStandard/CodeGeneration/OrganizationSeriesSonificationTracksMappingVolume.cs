...
{
	public partial class OrganizationSeriesSonificationTracksMappingVolume  : BaseObject
	{
		Hashtable h = new Hashtable();

		public OrganizationSeriesSonificationTracksMappingVolume()
		{
			MapFunction = MapFunction_DefaultValue = OrganizationSeriesSonificationTracksMappingVolumeMapFunction.Linear;
			MapTo = MapTo_DefaultValue = "";
			Max = Max_DefaultValue = null;
			Min = Min_DefaultValue = null;
			Value = Value_DefaultValue = null;
			Within = Within_DefaultValue = OrganizationSeriesSonificationTracksMappingVolumeWithin.Chart;
		...
		/// </summary>
		public OrganizationSeriesSonificationTracksMappingVolumeMapFunction MapFunction { get; set; }
		private OrganizationSeriesSonificationTracksMappingVolumeMapFunction MapFunction_DefaultValue { get; set; }
		...
		/// </summary>
		public OrganizationSeriesSonificationTracksMappingVolumeWithin Within { get; set; }
		private OrganizationSeriesSonificationTracksMappingVolumeWithin Within_DefaultValue { get; set; }
