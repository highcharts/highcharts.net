...
{
	public partial class OrganizationSeriesSonificationTracksPointGrouping  : BaseObject
	{
		Hashtable h = new Hashtable();

		public OrganizationSeriesSonificationTracksPointGrouping()
		{
		...
		/// </summary>
		public OrganizationSeriesSonificationTracksPointGroupingAlgorithm Algorithm { get; set; }
		private OrganizationSeriesSonificationTracksPointGroupingAlgorithm Algorithm_DefaultValue { get; set; }
		...
		internal override Hashtable ToHashtable(Highcharts highcharts)
		{
			...
			if (Algorithm != OrganizationSeriesSonificationTracksPointGroupingAlgorithm.Null) h.Add("algorithm", highcharts.FirstCharacterToLower(Algorithm.ToString()));
