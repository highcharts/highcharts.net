...
{
	public partial class OrganizationSeriesStatesHover  : BaseObject
	{
		Hashtable h = new Hashtable();

		public OrganizationSeriesStatesHover()
		{
			Animation = Animation_DefaultValue = new Animation();
			Enabled = Enabled_DefaultValue = null;
			Halo = Halo_DefaultValue = new OrganizationSeriesStatesHoverHalo();
			LineWidth = LineWidth_DefaultValue = null;
			LineWidthPlus = LineWidthPlus_DefaultValue = null;
			Marker = Marker_DefaultValue = new OrganizationSeriesStatesHoverMarker();
		...
		/// </summary>
		public OrganizationSeriesStatesHoverHalo Halo { get; set; }
		private OrganizationSeriesStatesHoverHalo Halo_DefaultValue { get; set; }
		...
		/// </summary>
		public OrganizationSeriesStatesHoverMarker Marker { get; set; }
		private OrganizationSeriesStatesHoverMarker Marker_DefaultValue { get; set; }
