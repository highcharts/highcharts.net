...
{
	public partial class OrganizationSeriesStatesHoverMarker  : BaseObject
	{
		public OrganizationSeriesStatesHoverMarker()
		{
			...
			States = States_DefaultValue = new OrganizationSeriesStatesHoverMarkerStates();
		...
		/// </summary>
		public OrganizationSeriesStatesHoverMarkerStates States { get; set; }
		private OrganizationSeriesStatesHoverMarkerStates States_DefaultValue { get; set; }
