...
{
	public partial class OrganizationSeriesTooltip  : BaseObject
	{
		public OrganizationSeriesTooltip()
		{
			...
			HeaderShape = HeaderShape_DefaultValue = OrganizationSeriesTooltipHeaderShape.Callout;
		...
		/// </summary>
		public OrganizationSeriesTooltipHeaderShape HeaderShape { get; set; }
		private OrganizationSeriesTooltipHeaderShape HeaderShape_DefaultValue { get; set; }
		...
		internal override Hashtable ToHashtable()
		{
			...
			if (NullFormatter != NullFormatter_DefaultValue) { h.Add("nullFormatter",NullFormatter); Highcharts.AddFunction("OrganizationSeriesTooltipNullFormatter.nullFormatter", NullFormatter); }  
			if (Outside != Outside_DefaultValue) h.Add("outside",Outside);
			if (Padding != Padding_DefaultValue) h.Add("padding",Padding);
			if (PointFormat != PointFormat_DefaultValue) h.Add("pointFormat",PointFormat);
			if (PointFormatter != PointFormatter_DefaultValue) { h.Add("pointFormatter",PointFormatter); Highcharts.AddFunction("OrganizationSeriesTooltipPointFormatter.pointFormatter", PointFormatter); }  
