...
namespace Highsoft.Web.Mvc.Charts
{
	public partial class PackedbubbleSeries  : Series
	{
		...
		internal override Hashtable ToHashtable()
		{
			...
			if (PointDescriptionFormatter != PointDescriptionFormatter_DefaultValue) { h.Add("pointDescriptionFormatter",PointDescriptionFormatter); Highcharts.AddFunction("a5ffbeea-a04f-449b-890d-65c071cfb544.pointDescriptionFormatter", PointDescriptionFormatter); }  
