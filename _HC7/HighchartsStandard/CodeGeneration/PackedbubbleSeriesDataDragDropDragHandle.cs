...
namespace Highsoft.Web.Mvc.Charts
{
	public partial class PackedbubbleSeriesDataDragDropDragHandle  : BaseObject
	{
		...
		internal override Hashtable ToHashtable()
		{
			...
			if (PathFormatter != PathFormatter_DefaultValue) { h.Add("pathFormatter",PathFormatter); Highcharts.AddFunction("056c5665-ca66-49bc-a9d3-52a4ced7901b.pathFormatter", PathFormatter); }  
