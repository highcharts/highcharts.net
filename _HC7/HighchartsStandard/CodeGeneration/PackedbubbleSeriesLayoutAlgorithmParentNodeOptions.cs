...
{
	public partial class PackedbubbleSeriesLayoutAlgorithmParentNodeOptions  : BaseObject
	{
		public PackedbubbleSeriesLayoutAlgorithmParentNodeOptions()
		{
			...
			InitialPositionRadius = InitialPositionRadius_DefaultValue = 100;
		...
		/// </summary>
		public PackedbubbleSeriesLayoutAlgorithmParentNodeOptionsMarker Marker { get; set; }
		private PackedbubbleSeriesLayoutAlgorithmParentNodeOptionsMarker Marker_DefaultValue { get; set; }
		...
		/// </summary>
		public PackedbubbleSeriesLayoutAlgorithmParentNodeOptionsType Type { get; set; }
		private PackedbubbleSeriesLayoutAlgorithmParentNodeOptionsType Type_DefaultValue { get; set; }
