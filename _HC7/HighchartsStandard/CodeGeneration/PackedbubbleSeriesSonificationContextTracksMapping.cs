...
{
	public partial class PackedbubbleSeriesSonificationContextTracksMapping  : BaseObject
	{
		Hashtable h = new Hashtable();

		public PackedbubbleSeriesSonificationContextTracksMapping()
		{
			Frequency = Frequency_DefaultValue = new PackedbubbleSeriesSonificationContextTracksMappingFrequency();
			GapBetweenNotes = GapBetweenNotes_DefaultValue = new PackedbubbleSeriesSonificationContextTracksMappingGapBetweenNotes();
			Highpass = Highpass_DefaultValue = new PackedbubbleSeriesSonificationContextTracksMappingHighpass();
			Lowpass = Lowpass_DefaultValue = new PackedbubbleSeriesSonificationContextTracksMappingLowpass();
			NoteDuration = NoteDuration_DefaultValue = new PackedbubbleSeriesSonificationContextTracksMappingNoteDuration();
			Pan = Pan_DefaultValue = new PackedbubbleSeriesSonificationContextTracksMappingPan();
			Pitch = Pitch_DefaultValue = new PackedbubbleSeriesSonificationContextTracksMappingPitch();
			PitchString = PitchString_DefaultValue = "null";
			PitchNumber = PitchNumber_DefaultValue = null;
			PlayDelay = PlayDelay_DefaultValue = new PackedbubbleSeriesSonificationContextTracksMappingPlayDelay();
			Time = Time_DefaultValue = new PackedbubbleSeriesSonificationContextTracksMappingTime();
			TimeString = TimeString_DefaultValue = "null";
			TimeNumber = TimeNumber_DefaultValue = null;
			Tremolo = Tremolo_DefaultValue = new PackedbubbleSeriesSonificationContextTracksMappingTremolo();
			Volume = Volume_DefaultValue = new PackedbubbleSeriesSonificationContextTracksMappingVolume();
		...
		/// </summary>
		public PackedbubbleSeriesSonificationContextTracksMappingFrequency Frequency { get; set; }
		private PackedbubbleSeriesSonificationContextTracksMappingFrequency Frequency_DefaultValue { get; set; }
		...
		/// </summary>
		public PackedbubbleSeriesSonificationContextTracksMappingGapBetweenNotes GapBetweenNotes { get; set; }
		private PackedbubbleSeriesSonificationContextTracksMappingGapBetweenNotes GapBetweenNotes_DefaultValue { get; set; }
		...
		/// </summary>
		public PackedbubbleSeriesSonificationContextTracksMappingHighpass Highpass { get; set; }
		private PackedbubbleSeriesSonificationContextTracksMappingHighpass Highpass_DefaultValue { get; set; }
		...
		/// </summary>
		public PackedbubbleSeriesSonificationContextTracksMappingLowpass Lowpass { get; set; }
		private PackedbubbleSeriesSonificationContextTracksMappingLowpass Lowpass_DefaultValue { get; set; }
		...
		/// </summary>
		public PackedbubbleSeriesSonificationContextTracksMappingNoteDuration NoteDuration { get; set; }
		private PackedbubbleSeriesSonificationContextTracksMappingNoteDuration NoteDuration_DefaultValue { get; set; }
		...
		/// </summary>
		public PackedbubbleSeriesSonificationContextTracksMappingPan Pan { get; set; }
		private PackedbubbleSeriesSonificationContextTracksMappingPan Pan_DefaultValue { get; set; }
		...
		/// </summary>
		public PackedbubbleSeriesSonificationContextTracksMappingPitch Pitch { get; set; }
		private PackedbubbleSeriesSonificationContextTracksMappingPitch Pitch_DefaultValue { get; set; }
		...
		/// </summary>
		public PackedbubbleSeriesSonificationContextTracksMappingPlayDelay PlayDelay { get; set; }
		private PackedbubbleSeriesSonificationContextTracksMappingPlayDelay PlayDelay_DefaultValue { get; set; }
		...
		/// </summary>
		public PackedbubbleSeriesSonificationContextTracksMappingTime Time { get; set; }
		private PackedbubbleSeriesSonificationContextTracksMappingTime Time_DefaultValue { get; set; }
		...
		/// </summary>
		public PackedbubbleSeriesSonificationContextTracksMappingTremolo Tremolo { get; set; }
		private PackedbubbleSeriesSonificationContextTracksMappingTremolo Tremolo_DefaultValue { get; set; }
		 

		/// <summary>
		/// The volume of notes, from 0 to 1.
		/// </summary>
		public PackedbubbleSeriesSonificationContextTracksMappingVolume Volume { get; set; }
		private PackedbubbleSeriesSonificationContextTracksMappingVolume Volume_DefaultValue { get; set; }
