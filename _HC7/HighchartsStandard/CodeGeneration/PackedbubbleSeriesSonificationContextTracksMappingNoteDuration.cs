...
{
	public partial class PackedbubbleSeriesSonificationContextTracksMappingNoteDuration  : BaseObject
	{
		Hashtable h = new Hashtable();

		public PackedbubbleSeriesSonificationContextTracksMappingNoteDuration()
		{
			MapFunction = MapFunction_DefaultValue = PackedbubbleSeriesSonificationContextTracksMappingNoteDurationMapFunction.Linear;
			MapTo = MapTo_DefaultValue = "";
			Max = Max_DefaultValue = null;
			Min = Min_DefaultValue = null;
			Value = Value_DefaultValue = null;
			Within = Within_DefaultValue = PackedbubbleSeriesSonificationContextTracksMappingNoteDurationWithin.Chart;
		...
		/// </summary>
		public PackedbubbleSeriesSonificationContextTracksMappingNoteDurationMapFunction MapFunction { get; set; }
		private PackedbubbleSeriesSonificationContextTracksMappingNoteDurationMapFunction MapFunction_DefaultValue { get; set; }
		...
		/// </summary>
		public PackedbubbleSeriesSonificationContextTracksMappingNoteDurationWithin Within { get; set; }
		private PackedbubbleSeriesSonificationContextTracksMappingNoteDurationWithin Within_DefaultValue { get; set; }
