...
{
	public partial class PackedbubbleSeriesSonificationTracks  : BaseObject
	{
		Hashtable h = new Hashtable();

		public PackedbubbleSeriesSonificationTracks()
		{
			ActiveWhen = ActiveWhen_DefaultValue = new PackedbubbleSeriesSonificationTracksActiveWhen();
			Instrument = Instrument_DefaultValue = null;
			InstrumentString = InstrumentString_DefaultValue = "null";
			Mapping = Mapping_DefaultValue = new PackedbubbleSeriesSonificationTracksMapping();
			MidiName = MidiName_DefaultValue = "";
			PointGrouping = PointGrouping_DefaultValue = new PackedbubbleSeriesSonificationTracksPointGrouping();
			RoundToMusicalNotes = RoundToMusicalNotes_DefaultValue = true;
			ShowPlayMarker = ShowPlayMarker_DefaultValue = true;
			Type = Type_DefaultValue = PackedbubbleSeriesSonificationTracksType.Instrument;
		...
		/// </summary>
		public PackedbubbleSeriesSonificationTracksActiveWhen ActiveWhen { get; set; }
		private PackedbubbleSeriesSonificationTracksActiveWhen ActiveWhen_DefaultValue { get; set; }
		...
		/// </summary>
		public PackedbubbleSeriesSonificationTracksMapping Mapping { get; set; }
		private PackedbubbleSeriesSonificationTracksMapping Mapping_DefaultValue { get; set; }
		...
		/// </summary>
		public PackedbubbleSeriesSonificationTracksPointGrouping PointGrouping { get; set; }
		private PackedbubbleSeriesSonificationTracksPointGrouping PointGrouping_DefaultValue { get; set; }
		...
		/// </summary>
		public PackedbubbleSeriesSonificationTracksType Type { get; set; }
		private PackedbubbleSeriesSonificationTracksType Type_DefaultValue { get; set; }
