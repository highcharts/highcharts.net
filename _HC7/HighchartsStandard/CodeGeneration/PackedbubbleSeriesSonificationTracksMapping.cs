...
{
	public partial class PackedbubbleSeriesSonificationTracksMapping  : BaseObject
	{
		Hashtable h = new Hashtable();

		public PackedbubbleSeriesSonificationTracksMapping()
		{
			Frequency = Frequency_DefaultValue = new PackedbubbleSeriesSonificationTracksMappingFrequency();
			GapBetweenNotes = GapBetweenNotes_DefaultValue = new PackedbubbleSeriesSonificationTracksMappingGapBetweenNotes();
			Highpass = Highpass_DefaultValue = new PackedbubbleSeriesSonificationTracksMappingHighpass();
			Lowpass = Lowpass_DefaultValue = new PackedbubbleSeriesSonificationTracksMappingLowpass();
			NoteDuration = NoteDuration_DefaultValue = new PackedbubbleSeriesSonificationTracksMappingNoteDuration();
			Pan = Pan_DefaultValue = new PackedbubbleSeriesSonificationTracksMappingPan();
			Pitch = Pitch_DefaultValue = new PackedbubbleSeriesSonificationTracksMappingPitch();
			PitchString = PitchString_DefaultValue = "null";
			PitchNumber = PitchNumber_DefaultValue = null;
			PlayDelay = PlayDelay_DefaultValue = new PackedbubbleSeriesSonificationTracksMappingPlayDelay();
			Time = Time_DefaultValue = new PackedbubbleSeriesSonificationTracksMappingTime();
			TimeString = TimeString_DefaultValue = "null";
			TimeNumber = TimeNumber_DefaultValue = null;
			Tremolo = Tremolo_DefaultValue = new PackedbubbleSeriesSonificationTracksMappingTremolo();
			Volume = Volume_DefaultValue = new PackedbubbleSeriesSonificationTracksMappingVolume();
		...
		/// </summary>
		public PackedbubbleSeriesSonificationTracksMappingFrequency Frequency { get; set; }
		private PackedbubbleSeriesSonificationTracksMappingFrequency Frequency_DefaultValue { get; set; }
		...
		/// </summary>
		public PackedbubbleSeriesSonificationTracksMappingGapBetweenNotes GapBetweenNotes { get; set; }
		private PackedbubbleSeriesSonificationTracksMappingGapBetweenNotes GapBetweenNotes_DefaultValue { get; set; }
		...
		/// </summary>
		public PackedbubbleSeriesSonificationTracksMappingHighpass Highpass { get; set; }
		private PackedbubbleSeriesSonificationTracksMappingHighpass Highpass_DefaultValue { get; set; }
		...
		/// </summary>
		public PackedbubbleSeriesSonificationTracksMappingLowpass Lowpass { get; set; }
		private PackedbubbleSeriesSonificationTracksMappingLowpass Lowpass_DefaultValue { get; set; }
		...
		/// </summary>
		public PackedbubbleSeriesSonificationTracksMappingNoteDuration NoteDuration { get; set; }
		private PackedbubbleSeriesSonificationTracksMappingNoteDuration NoteDuration_DefaultValue { get; set; }
		...
		/// </summary>
		public PackedbubbleSeriesSonificationTracksMappingPan Pan { get; set; }
		private PackedbubbleSeriesSonificationTracksMappingPan Pan_DefaultValue { get; set; }
		...
		/// </summary>
		public PackedbubbleSeriesSonificationTracksMappingPitch Pitch { get; set; }
		private PackedbubbleSeriesSonificationTracksMappingPitch Pitch_DefaultValue { get; set; }
		...
		/// </summary>
		public PackedbubbleSeriesSonificationTracksMappingPlayDelay PlayDelay { get; set; }
		private PackedbubbleSeriesSonificationTracksMappingPlayDelay PlayDelay_DefaultValue { get; set; }
		...
		/// </summary>
		public PackedbubbleSeriesSonificationTracksMappingTime Time { get; set; }
		private PackedbubbleSeriesSonificationTracksMappingTime Time_DefaultValue { get; set; }
		...
		/// </summary>
		public PackedbubbleSeriesSonificationTracksMappingTremolo Tremolo { get; set; }
		private PackedbubbleSeriesSonificationTracksMappingTremolo Tremolo_DefaultValue { get; set; }
		 

		/// <summary>
		/// The volume of notes, from 0 to 1.
		/// </summary>
		public PackedbubbleSeriesSonificationTracksMappingVolume Volume { get; set; }
		private PackedbubbleSeriesSonificationTracksMappingVolume Volume_DefaultValue { get; set; }
