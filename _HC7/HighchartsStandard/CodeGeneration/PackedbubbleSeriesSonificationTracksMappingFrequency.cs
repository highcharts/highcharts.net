...
{
	public partial class PackedbubbleSeriesSonificationTracksMappingFrequency  : BaseObject
	{
		Hashtable h = new Hashtable();

		public PackedbubbleSeriesSonificationTracksMappingFrequency()
		{
			MapFunction = MapFunction_DefaultValue = PackedbubbleSeriesSonificationTracksMappingFrequencyMapFunction.Linear;
			MapTo = MapTo_DefaultValue = "";
			Max = Max_DefaultValue = null;
			Min = Min_DefaultValue = null;
			Value = Value_DefaultValue = null;
			Within = Within_DefaultValue = PackedbubbleSeriesSonificationTracksMappingFrequencyWithin.Chart;
		...
		/// </summary>
		public PackedbubbleSeriesSonificationTracksMappingFrequencyMapFunction MapFunction { get; set; }
		private PackedbubbleSeriesSonificationTracksMappingFrequencyMapFunction MapFunction_DefaultValue { get; set; }
		...
		/// </summary>
		public PackedbubbleSeriesSonificationTracksMappingFrequencyWithin Within { get; set; }
		private PackedbubbleSeriesSonificationTracksMappingFrequencyWithin Within_DefaultValue { get; set; }
