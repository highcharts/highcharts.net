...
{
	public partial class PackedbubbleSeriesSonificationTracksMappingLowpassResonance  : BaseObject
	{
		Hashtable h = new Hashtable();

		public PackedbubbleSeriesSonificationTracksMappingLowpassResonance()
		{
			MapFunction = MapFunction_DefaultValue = PackedbubbleSeriesSonificationTracksMappingLowpassResonanceMapFunction.Linear;
			MapTo = MapTo_DefaultValue = "";
			Max = Max_DefaultValue = null;
			Min = Min_DefaultValue = null;
			Value = Value_DefaultValue = null;
			Within = Within_DefaultValue = PackedbubbleSeriesSonificationTracksMappingLowpassResonanceWithin.Chart;
		...
		/// </summary>
		public PackedbubbleSeriesSonificationTracksMappingLowpassResonanceMapFunction MapFunction { get; set; }
		private PackedbubbleSeriesSonificationTracksMappingLowpassResonanceMapFunction MapFunction_DefaultValue { get; set; }
		...
		/// </summary>
		public PackedbubbleSeriesSonificationTracksMappingLowpassResonanceWithin Within { get; set; }
		private PackedbubbleSeriesSonificationTracksMappingLowpassResonanceWithin Within_DefaultValue { get; set; }
