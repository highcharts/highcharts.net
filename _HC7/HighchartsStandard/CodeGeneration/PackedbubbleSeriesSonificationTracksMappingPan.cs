...
{
	public partial class PackedbubbleSeriesSonificationTracksMappingPan  : BaseObject
	{
		Hashtable h = new Hashtable();

		public PackedbubbleSeriesSonificationTracksMappingPan()
		{
			MapFunction = MapFunction_DefaultValue = PackedbubbleSeriesSonificationTracksMappingPanMapFunction.Linear;
			MapTo = MapTo_DefaultValue = "";
			Max = Max_DefaultValue = null;
			Min = Min_DefaultValue = null;
			Value = Value_DefaultValue = null;
			Within = Within_DefaultValue = PackedbubbleSeriesSonificationTracksMappingPanWithin.Chart;
		...
		/// </summary>
		public PackedbubbleSeriesSonificationTracksMappingPanMapFunction MapFunction { get; set; }
		private PackedbubbleSeriesSonificationTracksMappingPanMapFunction MapFunction_DefaultValue { get; set; }
		...
		/// </summary>
		public PackedbubbleSeriesSonificationTracksMappingPanWithin Within { get; set; }
		private PackedbubbleSeriesSonificationTracksMappingPanWithin Within_DefaultValue { get; set; }
