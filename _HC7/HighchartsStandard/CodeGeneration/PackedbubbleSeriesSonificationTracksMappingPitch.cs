...
{
	public partial class PackedbubbleSeriesSonificationTracksMappingPitch  : BaseObject
	{
		Hashtable h = new Hashtable();

		public PackedbubbleSeriesSonificationTracksMappingPitch()
		{
			MapFunction = MapFunction_DefaultValue = PackedbubbleSeriesSonificationTracksMappingPitchMapFunction.Linear;
		...
		/// </summary>
		public PackedbubbleSeriesSonificationTracksMappingPitchMapFunction MapFunction { get; set; }
		private PackedbubbleSeriesSonificationTracksMappingPitchMapFunction MapFunction_DefaultValue { get; set; }
