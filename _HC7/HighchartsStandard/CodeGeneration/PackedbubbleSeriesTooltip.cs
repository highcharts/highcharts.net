...
{
	public partial class PackedbubbleSeriesTooltip  : BaseObject
	{
		public PackedbubbleSeriesTooltip()
		{
			...
			HeaderShape = HeaderShape_DefaultValue = PackedbubbleSeriesTooltipHeaderShape.Callout;
		...
		/// </summary>
		public PackedbubbleSeriesTooltipHeaderShape HeaderShape { get; set; }
		private PackedbubbleSeriesTooltipHeaderShape HeaderShape_DefaultValue { get; set; }
		...
		internal override Hashtable ToHashtable()
		{
			...
			if (NullFormatter != NullFormatter_DefaultValue) { h.Add("nullFormatter",NullFormatter); Highcharts.AddFunction("PackedbubbleSeriesTooltipNullFormatter.nullFormatter", NullFormatter); }  
			if (Outside != Outside_DefaultValue) h.Add("outside",Outside);
			if (Padding != Padding_DefaultValue) h.Add("padding",Padding);
			if (PointFormat != PointFormat_DefaultValue) h.Add("pointFormat",PointFormat);
			if (PointFormatter != PointFormatter_DefaultValue) { h.Add("pointFormatter",PointFormatter); Highcharts.AddFunction("PackedbubbleSeriesTooltipPointFormatter.pointFormatter", PointFormatter); }  
