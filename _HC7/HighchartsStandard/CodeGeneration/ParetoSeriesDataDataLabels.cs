...
{
	public partial class ParetoSeriesDataDataLabels  : BaseObject
	{
		Hashtable h = new Hashtable();

		public ParetoSeriesDataDataLabels()
		{
		...
		/// </summary>
		public ParetoSeriesDataDataLabelsAlign Align { get; set; }
		private ParetoSeriesDataDataLabelsAlign Align_DefaultValue { get; set; }
		...
		/// </summary>
		public ParetoSeriesDataDataLabelsFilter Filter { get; set; }
		private ParetoSeriesDataDataLabelsFilter Filter_DefaultValue { get; set; }
		...
		/// </summary>
		public ParetoSeriesDataDataLabelsOverflow Overflow { get; set; }
		private ParetoSeriesDataDataLabelsOverflow Overflow_DefaultValue { get; set; }
		...
		/// </summary>
		public ParetoSeriesDataDataLabelsPosition Position { get; set; }
		private ParetoSeriesDataDataLabelsPosition Position_DefaultValue { get; set; }
		...
		/// </summary>
		public ParetoSeriesDataDataLabelsTextPath TextPath { get; set; }
		private ParetoSeriesDataDataLabelsTextPath TextPath_DefaultValue { get; set; }
		...
		/// </summary>
		public ParetoSeriesDataDataLabelsVerticalAlign VerticalAlign { get; set; }
		private ParetoSeriesDataDataLabelsVerticalAlign VerticalAlign_DefaultValue { get; set; }
		...
		internal override Hashtable ToHashtable(Highcharts highcharts)
		{
			...
			if (Align != ParetoSeriesDataDataLabelsAlign.Null) h.Add("align", highcharts.FirstCharacterToLower(Align.ToString()));
			...
			if (Overflow != ParetoSeriesDataDataLabelsOverflow.Null) h.Add("overflow", highcharts.FirstCharacterToLower(Overflow.ToString()));
			if (Padding != null) h.Add("padding",Padding);
			if (Position != ParetoSeriesDataDataLabelsPosition.Null) h.Add("position", highcharts.FirstCharacterToLower(Position.ToString()));
			...
			if (VerticalAlign != ParetoSeriesDataDataLabelsVerticalAlign.Null) h.Add("verticalAlign", highcharts.FirstCharacterToLower(VerticalAlign.ToString()));
			if (X != null) h.Add("x",X);
			if (Y != null) h.Add("y",Y);
