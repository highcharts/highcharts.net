...
{
	public partial class ParetoSeriesDataDragDropDragHandle  : BaseObject
	{
		public ParetoSeriesDataDragDropDragHandle()
		{
		...
		internal override Hashtable ToHashtable()
		{
			...
			if (PathFormatter != PathFormatter_DefaultValue) { h.Add("pathFormatter",PathFormatter); Highcharts.AddFunction("ParetoSeriesDataDragDropDragHandlePathFormatter.pathFormatter", PathFormatter); }  
