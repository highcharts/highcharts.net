...
{
	public partial class ParetoSeriesMarker  : BaseObject
	{
		public ParetoSeriesMarker()
		{
			...
			States = States_DefaultValue = new ParetoSeriesMarkerStates();
		...
		/// </summary>
		public ParetoSeriesMarkerStates States { get; set; }
		private ParetoSeriesMarkerStates States_DefaultValue { get; set; }
