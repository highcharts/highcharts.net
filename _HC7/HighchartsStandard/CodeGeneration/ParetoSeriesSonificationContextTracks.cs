...
{
	public partial class ParetoSeriesSonificationContextTracks  : BaseObject
	{
		Hashtable h = new Hashtable();

		public ParetoSeriesSonificationContextTracks()
		{
			ActiveWhen = ActiveWhen_DefaultValue = new ParetoSeriesSonificationContextTracksActiveWhen();
			Instrument = Instrument_DefaultValue = null;
			InstrumentString = InstrumentString_DefaultValue = "null";
			Mapping = Mapping_DefaultValue = new ParetoSeriesSonificationContextTracksMapping();
			MidiName = MidiName_DefaultValue = "";
			PointGrouping = PointGrouping_DefaultValue = new ParetoSeriesSonificationContextTracksPointGrouping();
			...
			Type = Type_DefaultValue = ParetoSeriesSonificationContextTracksType.Instrument;
			ValueInterval = ValueInterval_DefaultValue = null;
			ValueMapFunction = ValueMapFunction_DefaultValue = ParetoSeriesSonificationContextTracksValueMapFunction.Linear;
		...
		/// </summary>
		public ParetoSeriesSonificationContextTracksActiveWhen ActiveWhen { get; set; }
		private ParetoSeriesSonificationContextTracksActiveWhen ActiveWhen_DefaultValue { get; set; }
		...
		/// </summary>
		public ParetoSeriesSonificationContextTracksMapping Mapping { get; set; }
		private ParetoSeriesSonificationContextTracksMapping Mapping_DefaultValue { get; set; }
		...
		/// </summary>
		public ParetoSeriesSonificationContextTracksPointGrouping PointGrouping { get; set; }
		private ParetoSeriesSonificationContextTracksPointGrouping PointGrouping_DefaultValue { get; set; }
		...
		/// </summary>
		public ParetoSeriesSonificationContextTracksType Type { get; set; }
		private ParetoSeriesSonificationContextTracksType Type_DefaultValue { get; set; }
		...
		/// </summary>
		public ParetoSeriesSonificationContextTracksValueMapFunction ValueMapFunction { get; set; }
		private ParetoSeriesSonificationContextTracksValueMapFunction ValueMapFunction_DefaultValue { get; set; }
