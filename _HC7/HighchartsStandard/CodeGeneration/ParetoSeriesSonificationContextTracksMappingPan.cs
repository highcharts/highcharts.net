...
{
	public partial class ParetoSeriesSonificationContextTracksMappingPan  : BaseObject
	{
		Hashtable h = new Hashtable();

		public ParetoSeriesSonificationContextTracksMappingPan()
		{
			MapFunction = MapFunction_DefaultValue = ParetoSeriesSonificationContextTracksMappingPanMapFunction.Linear;
			MapTo = MapTo_DefaultValue = "";
			Max = Max_DefaultValue = null;
			Min = Min_DefaultValue = null;
			Value = Value_DefaultValue = null;
			Within = Within_DefaultValue = ParetoSeriesSonificationContextTracksMappingPanWithin.Chart;
		...
		/// </summary>
		public ParetoSeriesSonificationContextTracksMappingPanMapFunction MapFunction { get; set; }
		private ParetoSeriesSonificationContextTracksMappingPanMapFunction MapFunction_DefaultValue { get; set; }
		...
		/// </summary>
		public ParetoSeriesSonificationContextTracksMappingPanWithin Within { get; set; }
		private ParetoSeriesSonificationContextTracksMappingPanWithin Within_DefaultValue { get; set; }
