...
{
	public partial class ParetoSeriesSonificationContextTracksMappingPitch  : BaseObject
	{
		Hashtable h = new Hashtable();

		public ParetoSeriesSonificationContextTracksMappingPitch()
		{
			MapFunction = MapFunction_DefaultValue = ParetoSeriesSonificationContextTracksMappingPitchMapFunction.Linear;
		...
		/// </summary>
		public ParetoSeriesSonificationContextTracksMappingPitchMapFunction MapFunction { get; set; }
		private ParetoSeriesSonificationContextTracksMappingPitchMapFunction MapFunction_DefaultValue { get; set; }
