...
{
	public partial class ParetoSeriesSonificationContextTracksMappingTime  : BaseObject
	{
		Hashtable h = new Hashtable();

		public ParetoSeriesSonificationContextTracksMappingTime()
		{
			MapFunction = MapFunction_DefaultValue = ParetoSeriesSonificationContextTracksMappingTimeMapFunction.Linear;
			MapTo = MapTo_DefaultValue = "";
			Max = Max_DefaultValue = null;
			Min = Min_DefaultValue = null;
			Value = Value_DefaultValue = null;
			Within = Within_DefaultValue = ParetoSeriesSonificationContextTracksMappingTimeWithin.Chart;
		...
		/// </summary>
		public ParetoSeriesSonificationContextTracksMappingTimeMapFunction MapFunction { get; set; }
		private ParetoSeriesSonificationContextTracksMappingTimeMapFunction MapFunction_DefaultValue { get; set; }
		...
		/// </summary>
		public ParetoSeriesSonificationContextTracksMappingTimeWithin Within { get; set; }
		private ParetoSeriesSonificationContextTracksMappingTimeWithin Within_DefaultValue { get; set; }
