...
namespace Highsoft.Web.Mvc.Charts
{
	public partial class ParetoSeriesSonificationDefaultSpeechOptions  : BaseObject
	{
		...
		{
			ActiveWhen = ActiveWhen_DefaultValue = new ParetoSeriesSonificationDefaultSpeechOptionsActiveWhen();
			Language = Language_DefaultValue = "en-US";
			Mapping = Mapping_DefaultValue = new ParetoSeriesSonificationDefaultSpeechOptionsMapping();
			PointGrouping = PointGrouping_DefaultValue = new ParetoSeriesSonificationDefaultSpeechOptionsPointGrouping();
			PreferredVoice = PreferredVoice_DefaultValue = "";
			ShowPlayMarker = ShowPlayMarker_DefaultValue = true;
			Type = Type_DefaultValue = ParetoSeriesSonificationDefaultSpeechOptionsType.Instrument;
		...
		private ParetoSeriesSonificationDefaultSpeechOptionsActiveWhen ActiveWhen_DefaultValue { get; set; }
		...
		private ParetoSeriesSonificationDefaultSpeechOptionsMapping Mapping_DefaultValue { get; set; }
		...
		private ParetoSeriesSonificationDefaultSpeechOptionsPointGrouping PointGrouping_DefaultValue { get; set; }
		...
		private ParetoSeriesSonificationDefaultSpeechOptionsType Type_DefaultValue { get; set; }
