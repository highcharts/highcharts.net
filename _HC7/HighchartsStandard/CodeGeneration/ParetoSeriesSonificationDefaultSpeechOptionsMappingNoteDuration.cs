...
{
	public partial class ParetoSeriesSonificationDefaultSpeechOptionsMappingNoteDuration  : BaseObject
	{
		Hashtable h = new Hashtable();

		public ParetoSeriesSonificationDefaultSpeechOptionsMappingNoteDuration()
		{
			MapFunction = MapFunction_DefaultValue = ParetoSeriesSonificationDefaultSpeechOptionsMappingNoteDurationMapFunction.Linear;
			MapTo = MapTo_DefaultValue = "";
			Max = Max_DefaultValue = null;
			Min = Min_DefaultValue = null;
			Value = Value_DefaultValue = null;
			Within = Within_DefaultValue = ParetoSeriesSonificationDefaultSpeechOptionsMappingNoteDurationWithin.Chart;
		...
		/// </summary>
		public ParetoSeriesSonificationDefaultSpeechOptionsMappingNoteDurationMapFunction MapFunction { get; set; }
		private ParetoSeriesSonificationDefaultSpeechOptionsMappingNoteDurationMapFunction MapFunction_DefaultValue { get; set; }
		...
		/// </summary>
		public ParetoSeriesSonificationDefaultSpeechOptionsMappingNoteDurationWithin Within { get; set; }
		private ParetoSeriesSonificationDefaultSpeechOptionsMappingNoteDurationWithin Within_DefaultValue { get; set; }
