...
{
	public partial class ParetoSeriesSonificationPointGrouping  : BaseObject
	{
		Hashtable h = new Hashtable();

		public ParetoSeriesSonificationPointGrouping()
		{
		...
		/// </summary>
		public ParetoSeriesSonificationPointGroupingAlgorithm Algorithm { get; set; }
		private ParetoSeriesSonificationPointGroupingAlgorithm Algorithm_DefaultValue { get; set; }
		...
		internal override Hashtable ToHashtable(Highcharts highcharts)
		{
			...
			if (Algorithm != ParetoSeriesSonificationPointGroupingAlgorithm.Null) h.Add("algorithm", highcharts.FirstCharacterToLower(Algorithm.ToString()));
