...
{
	public partial class ParetoSeriesSonificationTracksMapping  : BaseObject
	{
		Hashtable h = new Hashtable();

		public ParetoSeriesSonificationTracksMapping()
		{
			Frequency = Frequency_DefaultValue = new ParetoSeriesSonificationTracksMappingFrequency();
			GapBetweenNotes = GapBetweenNotes_DefaultValue = new ParetoSeriesSonificationTracksMappingGapBetweenNotes();
			Highpass = Highpass_DefaultValue = new ParetoSeriesSonificationTracksMappingHighpass();
			Lowpass = Lowpass_DefaultValue = new ParetoSeriesSonificationTracksMappingLowpass();
			NoteDuration = NoteDuration_DefaultValue = new ParetoSeriesSonificationTracksMappingNoteDuration();
			Pan = Pan_DefaultValue = new ParetoSeriesSonificationTracksMappingPan();
			Pitch = Pitch_DefaultValue = new ParetoSeriesSonificationTracksMappingPitch();
			PitchString = PitchString_DefaultValue = "null";
			PitchNumber = PitchNumber_DefaultValue = null;
			PlayDelay = PlayDelay_DefaultValue = new ParetoSeriesSonificationTracksMappingPlayDelay();
			Time = Time_DefaultValue = new ParetoSeriesSonificationTracksMappingTime();
			TimeString = TimeString_DefaultValue = "null";
			TimeNumber = TimeNumber_DefaultValue = null;
			Tremolo = Tremolo_DefaultValue = new ParetoSeriesSonificationTracksMappingTremolo();
			Volume = Volume_DefaultValue = new ParetoSeriesSonificationTracksMappingVolume();
		...
		/// </summary>
		public ParetoSeriesSonificationTracksMappingFrequency Frequency { get; set; }
		private ParetoSeriesSonificationTracksMappingFrequency Frequency_DefaultValue { get; set; }
		...
		/// </summary>
		public ParetoSeriesSonificationTracksMappingGapBetweenNotes GapBetweenNotes { get; set; }
		private ParetoSeriesSonificationTracksMappingGapBetweenNotes GapBetweenNotes_DefaultValue { get; set; }
		...
		/// </summary>
		public ParetoSeriesSonificationTracksMappingHighpass Highpass { get; set; }
		private ParetoSeriesSonificationTracksMappingHighpass Highpass_DefaultValue { get; set; }
		...
		/// </summary>
		public ParetoSeriesSonificationTracksMappingLowpass Lowpass { get; set; }
		private ParetoSeriesSonificationTracksMappingLowpass Lowpass_DefaultValue { get; set; }
		...
		/// </summary>
		public ParetoSeriesSonificationTracksMappingNoteDuration NoteDuration { get; set; }
		private ParetoSeriesSonificationTracksMappingNoteDuration NoteDuration_DefaultValue { get; set; }
		...
		/// </summary>
		public ParetoSeriesSonificationTracksMappingPan Pan { get; set; }
		private ParetoSeriesSonificationTracksMappingPan Pan_DefaultValue { get; set; }
		...
		/// </summary>
		public ParetoSeriesSonificationTracksMappingPitch Pitch { get; set; }
		private ParetoSeriesSonificationTracksMappingPitch Pitch_DefaultValue { get; set; }
		...
		/// </summary>
		public ParetoSeriesSonificationTracksMappingPlayDelay PlayDelay { get; set; }
		private ParetoSeriesSonificationTracksMappingPlayDelay PlayDelay_DefaultValue { get; set; }
		...
		/// </summary>
		public ParetoSeriesSonificationTracksMappingTime Time { get; set; }
		private ParetoSeriesSonificationTracksMappingTime Time_DefaultValue { get; set; }
		...
		/// </summary>
		public ParetoSeriesSonificationTracksMappingTremolo Tremolo { get; set; }
		private ParetoSeriesSonificationTracksMappingTremolo Tremolo_DefaultValue { get; set; }
		 

		/// <summary>
		/// The volume of notes, from 0 to 1.
		/// </summary>
		public ParetoSeriesSonificationTracksMappingVolume Volume { get; set; }
		private ParetoSeriesSonificationTracksMappingVolume Volume_DefaultValue { get; set; }
