...
{
	public partial class ParetoSeriesSonificationTracksMappingFrequency  : BaseObject
	{
		Hashtable h = new Hashtable();

		public ParetoSeriesSonificationTracksMappingFrequency()
		{
			MapFunction = MapFunction_DefaultValue = ParetoSeriesSonificationTracksMappingFrequencyMapFunction.Linear;
			MapTo = MapTo_DefaultValue = "";
			Max = Max_DefaultValue = null;
			Min = Min_DefaultValue = null;
			Value = Value_DefaultValue = null;
			Within = Within_DefaultValue = ParetoSeriesSonificationTracksMappingFrequencyWithin.Chart;
		...
		/// </summary>
		public ParetoSeriesSonificationTracksMappingFrequencyMapFunction MapFunction { get; set; }
		private ParetoSeriesSonificationTracksMappingFrequencyMapFunction MapFunction_DefaultValue { get; set; }
		...
		/// </summary>
		public ParetoSeriesSonificationTracksMappingFrequencyWithin Within { get; set; }
		private ParetoSeriesSonificationTracksMappingFrequencyWithin Within_DefaultValue { get; set; }
