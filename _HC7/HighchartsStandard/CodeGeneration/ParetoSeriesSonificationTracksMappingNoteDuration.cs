...
{
	public partial class ParetoSeriesSonificationTracksMappingNoteDuration  : BaseObject
	{
		Hashtable h = new Hashtable();

		public ParetoSeriesSonificationTracksMappingNoteDuration()
		{
			MapFunction = MapFunction_DefaultValue = ParetoSeriesSonificationTracksMappingNoteDurationMapFunction.Linear;
			MapTo = MapTo_DefaultValue = "";
			Max = Max_DefaultValue = null;
			Min = Min_DefaultValue = null;
			Value = Value_DefaultValue = null;
			Within = Within_DefaultValue = ParetoSeriesSonificationTracksMappingNoteDurationWithin.Chart;
		...
		/// </summary>
		public ParetoSeriesSonificationTracksMappingNoteDurationMapFunction MapFunction { get; set; }
		private ParetoSeriesSonificationTracksMappingNoteDurationMapFunction MapFunction_DefaultValue { get; set; }
		...
		/// </summary>
		public ParetoSeriesSonificationTracksMappingNoteDurationWithin Within { get; set; }
		private ParetoSeriesSonificationTracksMappingNoteDurationWithin Within_DefaultValue { get; set; }
