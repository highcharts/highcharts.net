...
{
	public partial class ParetoSeriesSonificationTracksMappingPan  : BaseObject
	{
		Hashtable h = new Hashtable();

		public ParetoSeriesSonificationTracksMappingPan()
		{
			MapFunction = MapFunction_DefaultValue = ParetoSeriesSonificationTracksMappingPanMapFunction.Linear;
			MapTo = MapTo_DefaultValue = "";
			Max = Max_DefaultValue = null;
			Min = Min_DefaultValue = null;
			Value = Value_DefaultValue = null;
			Within = Within_DefaultValue = ParetoSeriesSonificationTracksMappingPanWithin.Chart;
		...
		/// </summary>
		public ParetoSeriesSonificationTracksMappingPanMapFunction MapFunction { get; set; }
		private ParetoSeriesSonificationTracksMappingPanMapFunction MapFunction_DefaultValue { get; set; }
		...
		/// </summary>
		public ParetoSeriesSonificationTracksMappingPanWithin Within { get; set; }
		private ParetoSeriesSonificationTracksMappingPanWithin Within_DefaultValue { get; set; }
