...
{
	public partial class ParetoSeriesSonificationTracksMappingPitch  : BaseObject
	{
		Hashtable h = new Hashtable();

		public ParetoSeriesSonificationTracksMappingPitch()
		{
			MapFunction = MapFunction_DefaultValue = ParetoSeriesSonificationTracksMappingPitchMapFunction.Linear;
		...
		/// </summary>
		public ParetoSeriesSonificationTracksMappingPitchMapFunction MapFunction { get; set; }
		private ParetoSeriesSonificationTracksMappingPitchMapFunction MapFunction_DefaultValue { get; set; }
