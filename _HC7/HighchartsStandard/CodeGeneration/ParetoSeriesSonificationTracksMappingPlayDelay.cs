...
{
	public partial class ParetoSeriesSonificationTracksMappingPlayDelay  : BaseObject
	{
		Hashtable h = new Hashtable();

		public ParetoSeriesSonificationTracksMappingPlayDelay()
		{
			MapFunction = MapFunction_DefaultValue = ParetoSeriesSonificationTracksMappingPlayDelayMapFunction.Linear;
			MapTo = MapTo_DefaultValue = "";
			Max = Max_DefaultValue = null;
			Min = Min_DefaultValue = null;
			Value = Value_DefaultValue = null;
			Within = Within_DefaultValue = ParetoSeriesSonificationTracksMappingPlayDelayWithin.Chart;
		...
		/// </summary>
		public ParetoSeriesSonificationTracksMappingPlayDelayMapFunction MapFunction { get; set; }
		private ParetoSeriesSonificationTracksMappingPlayDelayMapFunction MapFunction_DefaultValue { get; set; }
		...
		/// </summary>
		public ParetoSeriesSonificationTracksMappingPlayDelayWithin Within { get; set; }
		private ParetoSeriesSonificationTracksMappingPlayDelayWithin Within_DefaultValue { get; set; }
