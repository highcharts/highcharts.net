...
{
	public partial class ParetoSeriesSonificationTracksMappingTime  : BaseObject
	{
		Hashtable h = new Hashtable();

		public ParetoSeriesSonificationTracksMappingTime()
		{
			MapFunction = MapFunction_DefaultValue = ParetoSeriesSonificationTracksMappingTimeMapFunction.Linear;
			MapTo = MapTo_DefaultValue = "";
			Max = Max_DefaultValue = null;
			Min = Min_DefaultValue = null;
			Value = Value_DefaultValue = null;
			Within = Within_DefaultValue = ParetoSeriesSonificationTracksMappingTimeWithin.Chart;
		...
		/// </summary>
		public ParetoSeriesSonificationTracksMappingTimeMapFunction MapFunction { get; set; }
		private ParetoSeriesSonificationTracksMappingTimeMapFunction MapFunction_DefaultValue { get; set; }
		...
		/// </summary>
		public ParetoSeriesSonificationTracksMappingTimeWithin Within { get; set; }
		private ParetoSeriesSonificationTracksMappingTimeWithin Within_DefaultValue { get; set; }
