...
{
	public partial class ParetoSeriesSonificationTracksMappingTremoloDepth  : BaseObject
	{
		Hashtable h = new Hashtable();

		public ParetoSeriesSonificationTracksMappingTremoloDepth()
		{
			MapFunction = MapFunction_DefaultValue = ParetoSeriesSonificationTracksMappingTremoloDepthMapFunction.Linear;
			MapTo = MapTo_DefaultValue = "";
			Max = Max_DefaultValue = null;
			Min = Min_DefaultValue = null;
			Value = Value_DefaultValue = null;
			Within = Within_DefaultValue = ParetoSeriesSonificationTracksMappingTremoloDepthWithin.Chart;
		...
		/// </summary>
		public ParetoSeriesSonificationTracksMappingTremoloDepthMapFunction MapFunction { get; set; }
		private ParetoSeriesSonificationTracksMappingTremoloDepthMapFunction MapFunction_DefaultValue { get; set; }
		...
		/// </summary>
		public ParetoSeriesSonificationTracksMappingTremoloDepthWithin Within { get; set; }
		private ParetoSeriesSonificationTracksMappingTremoloDepthWithin Within_DefaultValue { get; set; }
