...
{
	public partial class ParetoSeriesSonificationTracksMappingVolume  : BaseObject
	{
		Hashtable h = new Hashtable();

		public ParetoSeriesSonificationTracksMappingVolume()
		{
			MapFunction = MapFunction_DefaultValue = ParetoSeriesSonificationTracksMappingVolumeMapFunction.Linear;
			MapTo = MapTo_DefaultValue = "";
			Max = Max_DefaultValue = null;
			Min = Min_DefaultValue = null;
			Value = Value_DefaultValue = null;
			Within = Within_DefaultValue = ParetoSeriesSonificationTracksMappingVolumeWithin.Chart;
		...
		/// </summary>
		public ParetoSeriesSonificationTracksMappingVolumeMapFunction MapFunction { get; set; }
		private ParetoSeriesSonificationTracksMappingVolumeMapFunction MapFunction_DefaultValue { get; set; }
		...
		/// </summary>
		public ParetoSeriesSonificationTracksMappingVolumeWithin Within { get; set; }
		private ParetoSeriesSonificationTracksMappingVolumeWithin Within_DefaultValue { get; set; }
