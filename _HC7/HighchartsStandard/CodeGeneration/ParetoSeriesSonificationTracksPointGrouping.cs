...
{
	public partial class ParetoSeriesSonificationTracksPointGrouping  : BaseObject
	{
		Hashtable h = new Hashtable();

		public ParetoSeriesSonificationTracksPointGrouping()
		{
		...
		/// </summary>
		public ParetoSeriesSonificationTracksPointGroupingAlgorithm Algorithm { get; set; }
		private ParetoSeriesSonificationTracksPointGroupingAlgorithm Algorithm_DefaultValue { get; set; }
		...
		internal override Hashtable ToHashtable(Highcharts highcharts)
		{
			...
			if (Algorithm != ParetoSeriesSonificationTracksPointGroupingAlgorithm.Null) h.Add("algorithm", highcharts.FirstCharacterToLower(Algorithm.ToString()));
