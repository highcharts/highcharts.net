...
{
	public partial class ParetoSeriesStatesSelect  : BaseObject
	{
		Hashtable h = new Hashtable();

		public ParetoSeriesStatesSelect()
		{
			Animation = Animation_DefaultValue = new Animation();
			AnimationBool = AnimationBool_DefaultValue = null;
			Enabled = Enabled_DefaultValue = true;
			Halo = Halo_DefaultValue = new ParetoSeriesStatesSelectHalo();
			LineWidth = LineWidth_DefaultValue = null;
			LineWidthPlus = LineWidthPlus_DefaultValue = 1;
			Marker = Marker_DefaultValue = new ParetoSeriesStatesSelectMarker();
		...
		/// </summary>
		public ParetoSeriesStatesSelectHalo Halo { get; set; }
		private ParetoSeriesStatesSelectHalo Halo_DefaultValue { get; set; }
		...
		/// </summary>
		public ParetoSeriesStatesSelectMarker Marker { get; set; }
		private ParetoSeriesStatesSelectMarker Marker_DefaultValue { get; set; }
