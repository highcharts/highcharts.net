...
namespace Highsoft.Web.Mvc.Charts
{
	public partial class PictorialSeries  : Series
	{
		...
		{
			Accessibility = Accessibility_DefaultValue = new PictorialSeriesAccessibility();
			...
			Cursor = Cursor_DefaultValue = PictorialSeriesCursor.Null;
			...
			Label = Label_DefaultValue = new PictorialSeriesLabel();
			LegendIndex = LegendIndex_DefaultValue = null;
			LegendSymbol = LegendSymbol_DefaultValue = PictorialSeriesLegendSymbol.Rectangle;
			...
			Paths = Paths_DefaultValue = new PictorialSeriesPaths();
			Point = Point_DefaultValue = new PictorialSeriesPoint();
			PointDescriptionFormat = PointDescriptionFormat_DefaultValue = "";
			PointDescriptionFormatter = PointDescriptionFormatter_DefaultValue = "";
			PointInterval = PointInterval_DefaultValue = 1;
			PointIntervalUnit = PointIntervalUnit_DefaultValue = PictorialSeriesPointIntervalUnit.Null;
			...
			Sonification = Sonification_DefaultValue = new PictorialSeriesSonification();
			Stack = Stack_DefaultValue = "";
			StackNumber = StackNumber_DefaultValue = null;
			Stacking = Stacking_DefaultValue = PictorialSeriesStacking.Null;
			States = States_DefaultValue = new PictorialSeriesStates();
			StickyTracking = StickyTracking_DefaultValue = true;
			Threshold = Threshold_DefaultValue = 0;
			Tooltip = Tooltip_DefaultValue = new PictorialSeriesTooltip();
		...
		internal override Hashtable ToHashtable(Highcharts highcharts)
		{
			...
			if (Paths.IsDirty(highcharts)) h.Add("paths",Paths.ToHashtable(highcharts));
