...
{
	public partial class PictorialSeries  : Series
	{
		...
		/// </summary>
		public PictorialSeriesAccessibility Accessibility { get; set; }
		private PictorialSeriesAccessibility Accessibility_DefaultValue { get; set; }
		...
		/// </summary>
		public PictorialSeriesCursor Cursor { get; set; }
		private PictorialSeriesCursor Cursor_DefaultValue { get; set; }
		...
		/// <summary>
		/// An array of data points for the series. For the `pictorial` series type,points can be given in the following ways:1. An array of arrays with 2 values. In this case, the values correspond   to `x,y`. If the first value is a string, it is applied as the name   of the point, and the `x` value is inferred. The `x` value can also be   omitted, in which case the inner arrays should be of length 2. Then the   `x` value is automatically calculated, either starting at 0 and   incremented by 1, or from `pointStart` and `pointInterval` given in the   series options.   ```js   data: [       [0, 40],       [1, 50],       [2, 60]   ]   ```2. An array of objects with named values. The following snippet shows only a   few settings, see the complete options set below. If the total number of   data points exceeds the series'   [turboThreshold](#series.pictorial.turboThreshold), this option is not   available.   ```js   data: [{       x: 0,       y: 40,       name: "Point1",       color: "#00FF00"   }, {       x: 1,       y: 60,       name: "Point2",       color: "#FF00FF"   }]   ```
		/// </summary>
		public List<PictorialSeriesData> Data { get; set; }
		private List<PictorialSeriesData> Data_DefaultValue { get; set; }
		...
		/// </summary>
		public PictorialSeriesDataLabels DataLabels { get; set; }
		private PictorialSeriesDataLabels DataLabels_DefaultValue { get; set; }
		...
		/// </summary>
		public PictorialSeriesEvents Events { get; set; }
		private PictorialSeriesEvents Events_DefaultValue { get; set; }
		...
		/// </summary>
		public PictorialSeriesFindNearestPointBy FindNearestPointBy { get; set; }
		private PictorialSeriesFindNearestPointBy FindNearestPointBy_DefaultValue { get; set; }
		...
		/// </summary>
		public PictorialSeriesLabel Label { get; set; }
		private PictorialSeriesLabel Label_DefaultValue { get; set; }
		...
		/// </summary>
		public PictorialSeriesPoint Point { get; set; }
		private PictorialSeriesPoint Point_DefaultValue { get; set; }
		...
		/// </summary>
		public PictorialSeriesPointIntervalUnit PointIntervalUnit { get; set; }
		private PictorialSeriesPointIntervalUnit PointIntervalUnit_DefaultValue { get; set; }
		...
		/// </summary>
		public PictorialSeriesPointPlacement PointPlacement { get; set; }
		private PictorialSeriesPointPlacement PointPlacement_DefaultValue { get; set; }
		...
		/// </summary>
		public PictorialSeriesSonification Sonification { get; set; }
		private PictorialSeriesSonification Sonification_DefaultValue { get; set; }
		...
		/// </summary>
		public PictorialSeriesStacking Stacking { get; set; }
		private PictorialSeriesStacking Stacking_DefaultValue { get; set; }
		 

		/// <summary>
		/// 
		/// </summary>
		public PictorialSeriesStates States { get; set; }
		private PictorialSeriesStates States_DefaultValue { get; set; }
		...
		/// </summary>
		public PictorialSeriesTooltip Tooltip { get; set; }
		private PictorialSeriesTooltip Tooltip_DefaultValue { get; set; }
		...
		internal override Hashtable ToHashtable(Highcharts highcharts)
		{
			...
			if (Cursor != PictorialSeriesCursor.Null) h.Add("cursor", highcharts.FirstCharacterToLower(Cursor.ToString()));
			...
			if (FindNearestPointBy != PictorialSeriesFindNearestPointBy.Null) h.Add("findNearestPointBy", highcharts.FirstCharacterToLower(FindNearestPointBy.ToString()));
			...
			if (LegendSymbol != PictorialSeriesLegendSymbol.Null) h.Add("legendSymbol", highcharts.FirstCharacterToLower(LegendSymbol.ToString()));
			...
			if (Paths != null) h.Add("paths",Paths.ToHashtable(highcharts));
			...
			if (PointIntervalUnit != PictorialSeriesPointIntervalUnit.Null) h.Add("pointIntervalUnit", highcharts.FirstCharacterToLower(PointIntervalUnit.ToString()));
			if (PointPadding != null) h.Add("pointPadding",PointPadding);
			if (PointPlacement != PictorialSeriesPointPlacement.Null) h.Add("pointPlacement", highcharts.FirstCharacterToLower(PointPlacement.ToString()));
			...
			if (Stacking != PictorialSeriesStacking.Null) h.Add("stacking", highcharts.FirstCharacterToLower(Stacking.ToString()));
