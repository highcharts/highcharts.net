...
{
	public partial class PictorialSeriesAccessibility  : BaseObject
	{
		Hashtable h = new Hashtable();

		public PictorialSeriesAccessibility()
		{
			Description = Description_DefaultValue = "";
			DescriptionFormat = DescriptionFormat_DefaultValue = "";
			Enabled = Enabled_DefaultValue = null;
			ExposeAsGroupOnly = ExposeAsGroupOnly_DefaultValue = null;
			KeyboardNavigation = KeyboardNavigation_DefaultValue = new PictorialSeriesAccessibilityKeyboardNavigation();
			Point = Point_DefaultValue = new PictorialSeriesAccessibilityPoint();
		...
		/// </summary>
		public PictorialSeriesAccessibilityKeyboardNavigation KeyboardNavigation { get; set; }
		private PictorialSeriesAccessibilityKeyboardNavigation KeyboardNavigation_DefaultValue { get; set; }
		 

		/// <summary>
		/// Point accessibility options for a series.
		/// </summary>
		public PictorialSeriesAccessibilityPoint Point { get; set; }
		private PictorialSeriesAccessibilityPoint Point_DefaultValue { get; set; }
