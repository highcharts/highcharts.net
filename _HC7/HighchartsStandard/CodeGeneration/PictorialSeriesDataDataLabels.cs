...
{
	public partial class PictorialSeriesDataDataLabels  : BaseObject
	{
		Hashtable h = new Hashtable();

		public PictorialSeriesDataDataLabels()
		{
		...
		/// </summary>
		public PictorialSeriesDataDataLabelsAlign Align { get; set; }
		private PictorialSeriesDataDataLabelsAlign Align_DefaultValue { get; set; }
		...
		/// </summary>
		public PictorialSeriesDataDataLabelsFilter Filter { get; set; }
		private PictorialSeriesDataDataLabelsFilter Filter_DefaultValue { get; set; }
		...
		/// </summary>
		public PictorialSeriesDataDataLabelsOverflow Overflow { get; set; }
		private PictorialSeriesDataDataLabelsOverflow Overflow_DefaultValue { get; set; }
		...
		/// </summary>
		public PictorialSeriesDataDataLabelsPosition Position { get; set; }
		private PictorialSeriesDataDataLabelsPosition Position_DefaultValue { get; set; }
		...
		/// </summary>
		public PictorialSeriesDataDataLabelsTextPath TextPath { get; set; }
		private PictorialSeriesDataDataLabelsTextPath TextPath_DefaultValue { get; set; }
		...
		/// </summary>
		public PictorialSeriesDataDataLabelsVerticalAlign VerticalAlign { get; set; }
		private PictorialSeriesDataDataLabelsVerticalAlign VerticalAlign_DefaultValue { get; set; }
		...
		internal override Hashtable ToHashtable(Highcharts highcharts)
		{
			...
			if (Align != PictorialSeriesDataDataLabelsAlign.Null) h.Add("align", highcharts.FirstCharacterToLower(Align.ToString()));
			...
			if (Overflow != PictorialSeriesDataDataLabelsOverflow.Null) h.Add("overflow", highcharts.FirstCharacterToLower(Overflow.ToString()));
			if (Padding != null) h.Add("padding",Padding);
			if (Position != PictorialSeriesDataDataLabelsPosition.Null) h.Add("position", highcharts.FirstCharacterToLower(Position.ToString()));
			...
			if (VerticalAlign != PictorialSeriesDataDataLabelsVerticalAlign.Null) h.Add("verticalAlign", highcharts.FirstCharacterToLower(VerticalAlign.ToString()));
			if (X != null) h.Add("x",X);
			if (Y != null) h.Add("y",Y);
