...
{
	public partial class PictorialSeriesDataLabels  : BaseObject
	{
		Hashtable h = new Hashtable();

		public PictorialSeriesDataLabels()
		{
		...
		/// </summary>
		public PictorialSeriesDataLabelsAlign Align { get; set; }
		private PictorialSeriesDataLabelsAlign Align_DefaultValue { get; set; }
		...
		/// </summary>
		public PictorialSeriesDataLabelsFilter Filter { get; set; }
		private PictorialSeriesDataLabelsFilter Filter_DefaultValue { get; set; }
		...
		/// </summary>
		public PictorialSeriesDataLabelsOverflow Overflow { get; set; }
		private PictorialSeriesDataLabelsOverflow Overflow_DefaultValue { get; set; }
		...
		/// </summary>
		public PictorialSeriesDataLabelsPosition Position { get; set; }
		private PictorialSeriesDataLabelsPosition Position_DefaultValue { get; set; }
		...
		/// </summary>
		public PictorialSeriesDataLabelsTextPath TextPath { get; set; }
		private PictorialSeriesDataLabelsTextPath TextPath_DefaultValue { get; set; }
		...
		/// </summary>
		public PictorialSeriesDataLabelsVerticalAlign VerticalAlign { get; set; }
		private PictorialSeriesDataLabelsVerticalAlign VerticalAlign_DefaultValue { get; set; }
		...
		internal override Hashtable ToHashtable(Highcharts highcharts)
		{
			...
			if (Align != PictorialSeriesDataLabelsAlign.Null) h.Add("align", highcharts.FirstCharacterToLower(Align.ToString()));
			...
			if (Overflow != PictorialSeriesDataLabelsOverflow.Null) h.Add("overflow", highcharts.FirstCharacterToLower(Overflow.ToString()));
			if (Padding != null) h.Add("padding",Padding);
			if (Position != PictorialSeriesDataLabelsPosition.Null) h.Add("position", highcharts.FirstCharacterToLower(Position.ToString()));
			...
			if (VerticalAlign != PictorialSeriesDataLabelsVerticalAlign.Null) h.Add("verticalAlign", highcharts.FirstCharacterToLower(VerticalAlign.ToString()));
			if (X != null) h.Add("x",X);
			if (Y != null) h.Add("y",Y);
