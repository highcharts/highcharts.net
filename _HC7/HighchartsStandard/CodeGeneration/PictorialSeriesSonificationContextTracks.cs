...
{
	public partial class PictorialSeriesSonificationContextTracks  : BaseObject
	{
		Hashtable h = new Hashtable();

		public PictorialSeriesSonificationContextTracks()
		{
			ActiveWhen = ActiveWhen_DefaultValue = new PictorialSeriesSonificationContextTracksActiveWhen();
			Instrument = Instrument_DefaultValue = null;
			InstrumentString = InstrumentString_DefaultValue = "null";
			Mapping = Mapping_DefaultValue = new PictorialSeriesSonificationContextTracksMapping();
			MidiName = MidiName_DefaultValue = "";
			PointGrouping = PointGrouping_DefaultValue = new PictorialSeriesSonificationContextTracksPointGrouping();
			...
			Type = Type_DefaultValue = PictorialSeriesSonificationContextTracksType.Instrument;
			ValueInterval = ValueInterval_DefaultValue = null;
			ValueMapFunction = ValueMapFunction_DefaultValue = PictorialSeriesSonificationContextTracksValueMapFunction.Linear;
		...
		/// </summary>
		public PictorialSeriesSonificationContextTracksActiveWhen ActiveWhen { get; set; }
		private PictorialSeriesSonificationContextTracksActiveWhen ActiveWhen_DefaultValue { get; set; }
		...
		/// </summary>
		public PictorialSeriesSonificationContextTracksMapping Mapping { get; set; }
		private PictorialSeriesSonificationContextTracksMapping Mapping_DefaultValue { get; set; }
		...
		/// </summary>
		public PictorialSeriesSonificationContextTracksPointGrouping PointGrouping { get; set; }
		private PictorialSeriesSonificationContextTracksPointGrouping PointGrouping_DefaultValue { get; set; }
		...
		/// </summary>
		public PictorialSeriesSonificationContextTracksType Type { get; set; }
		private PictorialSeriesSonificationContextTracksType Type_DefaultValue { get; set; }
		...
		/// </summary>
		public PictorialSeriesSonificationContextTracksValueMapFunction ValueMapFunction { get; set; }
		private PictorialSeriesSonificationContextTracksValueMapFunction ValueMapFunction_DefaultValue { get; set; }
