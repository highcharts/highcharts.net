...
{
	public partial class PictorialSeriesSonificationContextTracksMappingPan  : BaseObject
	{
		Hashtable h = new Hashtable();

		public PictorialSeriesSonificationContextTracksMappingPan()
		{
			MapFunction = MapFunction_DefaultValue = PictorialSeriesSonificationContextTracksMappingPanMapFunction.Linear;
			MapTo = MapTo_DefaultValue = "";
			Max = Max_DefaultValue = null;
			Min = Min_DefaultValue = null;
			Value = Value_DefaultValue = null;
			Within = Within_DefaultValue = PictorialSeriesSonificationContextTracksMappingPanWithin.Chart;
		...
		/// </summary>
		public PictorialSeriesSonificationContextTracksMappingPanMapFunction MapFunction { get; set; }
		private PictorialSeriesSonificationContextTracksMappingPanMapFunction MapFunction_DefaultValue { get; set; }
		...
		/// </summary>
		public PictorialSeriesSonificationContextTracksMappingPanWithin Within { get; set; }
		private PictorialSeriesSonificationContextTracksMappingPanWithin Within_DefaultValue { get; set; }
