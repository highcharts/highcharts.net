...
{
	public partial class PictorialSeriesSonificationDefaultInstrumentOptionsMappingPlayDelay  : BaseObject
	{
		Hashtable h = new Hashtable();

		public PictorialSeriesSonificationDefaultInstrumentOptionsMappingPlayDelay()
		{
			MapFunction = MapFunction_DefaultValue = PictorialSeriesSonificationDefaultInstrumentOptionsMappingPlayDelayMapFunction.Linear;
			MapTo = MapTo_DefaultValue = "";
			Max = Max_DefaultValue = null;
			Min = Min_DefaultValue = null;
			Value = Value_DefaultValue = null;
			Within = Within_DefaultValue = PictorialSeriesSonificationDefaultInstrumentOptionsMappingPlayDelayWithin.Chart;
		...
		/// </summary>
		public PictorialSeriesSonificationDefaultInstrumentOptionsMappingPlayDelayMapFunction MapFunction { get; set; }
		private PictorialSeriesSonificationDefaultInstrumentOptionsMappingPlayDelayMapFunction MapFunction_DefaultValue { get; set; }
		...
		/// </summary>
		public PictorialSeriesSonificationDefaultInstrumentOptionsMappingPlayDelayWithin Within { get; set; }
		private PictorialSeriesSonificationDefaultInstrumentOptionsMappingPlayDelayWithin Within_DefaultValue { get; set; }
