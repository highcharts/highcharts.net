...
{
	public partial class PictorialSeriesSonificationDefaultSpeechOptionsActiveWhen  : BaseObject
	{
		Hashtable h = new Hashtable();

		public PictorialSeriesSonificationDefaultSpeechOptionsActiveWhen()
		{
		}	
