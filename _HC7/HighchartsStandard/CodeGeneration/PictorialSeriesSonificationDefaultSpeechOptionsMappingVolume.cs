...
{
	public partial class PictorialSeriesSonificationDefaultSpeechOptionsMappingVolume  : BaseObject
	{
		Hashtable h = new Hashtable();

		public PictorialSeriesSonificationDefaultSpeechOptionsMappingVolume()
		{
			MapFunction = MapFunction_DefaultValue = PictorialSeriesSonificationDefaultSpeechOptionsMappingVolumeMapFunction.Linear;
			MapTo = MapTo_DefaultValue = "";
			Max = Max_DefaultValue = null;
			Min = Min_DefaultValue = null;
			Value = Value_DefaultValue = null;
			Within = Within_DefaultValue = PictorialSeriesSonificationDefaultSpeechOptionsMappingVolumeWithin.Chart;
		...
		/// </summary>
		public PictorialSeriesSonificationDefaultSpeechOptionsMappingVolumeMapFunction MapFunction { get; set; }
		private PictorialSeriesSonificationDefaultSpeechOptionsMappingVolumeMapFunction MapFunction_DefaultValue { get; set; }
		...
		/// </summary>
		public PictorialSeriesSonificationDefaultSpeechOptionsMappingVolumeWithin Within { get; set; }
		private PictorialSeriesSonificationDefaultSpeechOptionsMappingVolumeWithin Within_DefaultValue { get; set; }
