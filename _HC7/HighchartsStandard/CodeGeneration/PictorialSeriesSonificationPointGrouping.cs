...
{
	public partial class PictorialSeriesSonificationPointGrouping  : BaseObject
	{
		Hashtable h = new Hashtable();

		public PictorialSeriesSonificationPointGrouping()
		{
		...
		/// </summary>
		public PictorialSeriesSonificationPointGroupingAlgorithm Algorithm { get; set; }
		private PictorialSeriesSonificationPointGroupingAlgorithm Algorithm_DefaultValue { get; set; }
		...
		internal override Hashtable ToHashtable(Highcharts highcharts)
		{
			...
			if (Algorithm != PictorialSeriesSonificationPointGroupingAlgorithm.Null) h.Add("algorithm", highcharts.FirstCharacterToLower(Algorithm.ToString()));
