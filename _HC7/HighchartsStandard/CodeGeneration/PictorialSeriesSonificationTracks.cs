...
{
	public partial class PictorialSeriesSonificationTracks  : BaseObject
	{
		Hashtable h = new Hashtable();

		public PictorialSeriesSonificationTracks()
		{
			ActiveWhen = ActiveWhen_DefaultValue = new PictorialSeriesSonificationTracksActiveWhen();
			Instrument = Instrument_DefaultValue = null;
			InstrumentString = InstrumentString_DefaultValue = "null";
			Mapping = Mapping_DefaultValue = new PictorialSeriesSonificationTracksMapping();
			MidiName = MidiName_DefaultValue = "";
			PointGrouping = PointGrouping_DefaultValue = new PictorialSeriesSonificationTracksPointGrouping();
			RoundToMusicalNotes = RoundToMusicalNotes_DefaultValue = true;
			ShowPlayMarker = ShowPlayMarker_DefaultValue = true;
			Type = Type_DefaultValue = PictorialSeriesSonificationTracksType.Instrument;
		...
		/// </summary>
		public PictorialSeriesSonificationTracksActiveWhen ActiveWhen { get; set; }
		private PictorialSeriesSonificationTracksActiveWhen ActiveWhen_DefaultValue { get; set; }
		...
		/// </summary>
		public PictorialSeriesSonificationTracksMapping Mapping { get; set; }
		private PictorialSeriesSonificationTracksMapping Mapping_DefaultValue { get; set; }
		...
		/// </summary>
		public PictorialSeriesSonificationTracksPointGrouping PointGrouping { get; set; }
		private PictorialSeriesSonificationTracksPointGrouping PointGrouping_DefaultValue { get; set; }
		...
		/// </summary>
		public PictorialSeriesSonificationTracksType Type { get; set; }
		private PictorialSeriesSonificationTracksType Type_DefaultValue { get; set; }
