...
{
	public partial class PictorialSeriesSonificationTracksMapping  : BaseObject
	{
		Hashtable h = new Hashtable();

		public PictorialSeriesSonificationTracksMapping()
		{
			Frequency = Frequency_DefaultValue = new PictorialSeriesSonificationTracksMappingFrequency();
			GapBetweenNotes = GapBetweenNotes_DefaultValue = new PictorialSeriesSonificationTracksMappingGapBetweenNotes();
			Highpass = Highpass_DefaultValue = new PictorialSeriesSonificationTracksMappingHighpass();
			Lowpass = Lowpass_DefaultValue = new PictorialSeriesSonificationTracksMappingLowpass();
			NoteDuration = NoteDuration_DefaultValue = new PictorialSeriesSonificationTracksMappingNoteDuration();
			Pan = Pan_DefaultValue = new PictorialSeriesSonificationTracksMappingPan();
			Pitch = Pitch_DefaultValue = new PictorialSeriesSonificationTracksMappingPitch();
			PitchString = PitchString_DefaultValue = "null";
			PitchNumber = PitchNumber_DefaultValue = null;
			PlayDelay = PlayDelay_DefaultValue = new PictorialSeriesSonificationTracksMappingPlayDelay();
			Time = Time_DefaultValue = new PictorialSeriesSonificationTracksMappingTime();
			TimeString = TimeString_DefaultValue = "null";
			TimeNumber = TimeNumber_DefaultValue = null;
			Tremolo = Tremolo_DefaultValue = new PictorialSeriesSonificationTracksMappingTremolo();
			Volume = Volume_DefaultValue = new PictorialSeriesSonificationTracksMappingVolume();
		...
		/// </summary>
		public PictorialSeriesSonificationTracksMappingFrequency Frequency { get; set; }
		private PictorialSeriesSonificationTracksMappingFrequency Frequency_DefaultValue { get; set; }
		...
		/// </summary>
		public PictorialSeriesSonificationTracksMappingGapBetweenNotes GapBetweenNotes { get; set; }
		private PictorialSeriesSonificationTracksMappingGapBetweenNotes GapBetweenNotes_DefaultValue { get; set; }
		...
		/// </summary>
		public PictorialSeriesSonificationTracksMappingHighpass Highpass { get; set; }
		private PictorialSeriesSonificationTracksMappingHighpass Highpass_DefaultValue { get; set; }
		...
		/// </summary>
		public PictorialSeriesSonificationTracksMappingLowpass Lowpass { get; set; }
		private PictorialSeriesSonificationTracksMappingLowpass Lowpass_DefaultValue { get; set; }
		...
		/// </summary>
		public PictorialSeriesSonificationTracksMappingNoteDuration NoteDuration { get; set; }
		private PictorialSeriesSonificationTracksMappingNoteDuration NoteDuration_DefaultValue { get; set; }
		...
		/// </summary>
		public PictorialSeriesSonificationTracksMappingPan Pan { get; set; }
		private PictorialSeriesSonificationTracksMappingPan Pan_DefaultValue { get; set; }
		...
		/// </summary>
		public PictorialSeriesSonificationTracksMappingPitch Pitch { get; set; }
		private PictorialSeriesSonificationTracksMappingPitch Pitch_DefaultValue { get; set; }
		...
		/// </summary>
		public PictorialSeriesSonificationTracksMappingPlayDelay PlayDelay { get; set; }
		private PictorialSeriesSonificationTracksMappingPlayDelay PlayDelay_DefaultValue { get; set; }
		...
		/// </summary>
		public PictorialSeriesSonificationTracksMappingTime Time { get; set; }
		private PictorialSeriesSonificationTracksMappingTime Time_DefaultValue { get; set; }
		...
		/// </summary>
		public PictorialSeriesSonificationTracksMappingTremolo Tremolo { get; set; }
		private PictorialSeriesSonificationTracksMappingTremolo Tremolo_DefaultValue { get; set; }
		 

		/// <summary>
		/// The volume of notes, from 0 to 1.
		/// </summary>
		public PictorialSeriesSonificationTracksMappingVolume Volume { get; set; }
		private PictorialSeriesSonificationTracksMappingVolume Volume_DefaultValue { get; set; }
