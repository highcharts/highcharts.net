...
{
	public partial class PictorialSeriesSonificationTracksMappingFrequency  : BaseObject
	{
		Hashtable h = new Hashtable();

		public PictorialSeriesSonificationTracksMappingFrequency()
		{
			MapFunction = MapFunction_DefaultValue = PictorialSeriesSonificationTracksMappingFrequencyMapFunction.Linear;
			MapTo = MapTo_DefaultValue = "";
			Max = Max_DefaultValue = null;
			Min = Min_DefaultValue = null;
			Value = Value_DefaultValue = null;
			Within = Within_DefaultValue = PictorialSeriesSonificationTracksMappingFrequencyWithin.Chart;
		...
		/// </summary>
		public PictorialSeriesSonificationTracksMappingFrequencyMapFunction MapFunction { get; set; }
		private PictorialSeriesSonificationTracksMappingFrequencyMapFunction MapFunction_DefaultValue { get; set; }
		...
		/// </summary>
		public PictorialSeriesSonificationTracksMappingFrequencyWithin Within { get; set; }
		private PictorialSeriesSonificationTracksMappingFrequencyWithin Within_DefaultValue { get; set; }
