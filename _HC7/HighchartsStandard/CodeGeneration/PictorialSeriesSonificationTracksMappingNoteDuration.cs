...
{
	public partial class PictorialSeriesSonificationTracksMappingNoteDuration  : BaseObject
	{
		Hashtable h = new Hashtable();

		public PictorialSeriesSonificationTracksMappingNoteDuration()
		{
			MapFunction = MapFunction_DefaultValue = PictorialSeriesSonificationTracksMappingNoteDurationMapFunction.Linear;
			MapTo = MapTo_DefaultValue = "";
			Max = Max_DefaultValue = null;
			Min = Min_DefaultValue = null;
			Value = Value_DefaultValue = null;
			Within = Within_DefaultValue = PictorialSeriesSonificationTracksMappingNoteDurationWithin.Chart;
		...
		/// </summary>
		public PictorialSeriesSonificationTracksMappingNoteDurationMapFunction MapFunction { get; set; }
		private PictorialSeriesSonificationTracksMappingNoteDurationMapFunction MapFunction_DefaultValue { get; set; }
		...
		/// </summary>
		public PictorialSeriesSonificationTracksMappingNoteDurationWithin Within { get; set; }
		private PictorialSeriesSonificationTracksMappingNoteDurationWithin Within_DefaultValue { get; set; }
