...
{
	public partial class PictorialSeriesSonificationTracksMappingPan  : BaseObject
	{
		Hashtable h = new Hashtable();

		public PictorialSeriesSonificationTracksMappingPan()
		{
			MapFunction = MapFunction_DefaultValue = PictorialSeriesSonificationTracksMappingPanMapFunction.Linear;
			MapTo = MapTo_DefaultValue = "";
			Max = Max_DefaultValue = null;
			Min = Min_DefaultValue = null;
			Value = Value_DefaultValue = null;
			Within = Within_DefaultValue = PictorialSeriesSonificationTracksMappingPanWithin.Chart;
		...
		/// </summary>
		public PictorialSeriesSonificationTracksMappingPanMapFunction MapFunction { get; set; }
		private PictorialSeriesSonificationTracksMappingPanMapFunction MapFunction_DefaultValue { get; set; }
		...
		/// </summary>
		public PictorialSeriesSonificationTracksMappingPanWithin Within { get; set; }
		private PictorialSeriesSonificationTracksMappingPanWithin Within_DefaultValue { get; set; }
