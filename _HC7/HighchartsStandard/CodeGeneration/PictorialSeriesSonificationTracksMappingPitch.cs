...
{
	public partial class PictorialSeriesSonificationTracksMappingPitch  : BaseObject
	{
		Hashtable h = new Hashtable();

		public PictorialSeriesSonificationTracksMappingPitch()
		{
			MapFunction = MapFunction_DefaultValue = PictorialSeriesSonificationTracksMappingPitchMapFunction.Linear;
		...
		/// </summary>
		public PictorialSeriesSonificationTracksMappingPitchMapFunction MapFunction { get; set; }
		private PictorialSeriesSonificationTracksMappingPitchMapFunction MapFunction_DefaultValue { get; set; }
