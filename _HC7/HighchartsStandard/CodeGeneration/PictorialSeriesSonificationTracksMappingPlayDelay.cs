...
{
	public partial class PictorialSeriesSonificationTracksMappingPlayDelay  : BaseObject
	{
		Hashtable h = new Hashtable();

		public PictorialSeriesSonificationTracksMappingPlayDelay()
		{
			MapFunction = MapFunction_DefaultValue = PictorialSeriesSonificationTracksMappingPlayDelayMapFunction.Linear;
			MapTo = MapTo_DefaultValue = "";
			Max = Max_DefaultValue = null;
			Min = Min_DefaultValue = null;
			Value = Value_DefaultValue = null;
			Within = Within_DefaultValue = PictorialSeriesSonificationTracksMappingPlayDelayWithin.Chart;
		...
		/// </summary>
		public PictorialSeriesSonificationTracksMappingPlayDelayMapFunction MapFunction { get; set; }
		private PictorialSeriesSonificationTracksMappingPlayDelayMapFunction MapFunction_DefaultValue { get; set; }
		...
		/// </summary>
		public PictorialSeriesSonificationTracksMappingPlayDelayWithin Within { get; set; }
		private PictorialSeriesSonificationTracksMappingPlayDelayWithin Within_DefaultValue { get; set; }
