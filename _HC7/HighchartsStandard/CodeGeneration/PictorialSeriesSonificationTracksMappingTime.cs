...
{
	public partial class PictorialSeriesSonificationTracksMappingTime  : BaseObject
	{
		Hashtable h = new Hashtable();

		public PictorialSeriesSonificationTracksMappingTime()
		{
			MapFunction = MapFunction_DefaultValue = PictorialSeriesSonificationTracksMappingTimeMapFunction.Linear;
			MapTo = MapTo_DefaultValue = "";
			Max = Max_DefaultValue = null;
			Min = Min_DefaultValue = null;
			Value = Value_DefaultValue = null;
			Within = Within_DefaultValue = PictorialSeriesSonificationTracksMappingTimeWithin.Chart;
		...
		/// </summary>
		public PictorialSeriesSonificationTracksMappingTimeMapFunction MapFunction { get; set; }
		private PictorialSeriesSonificationTracksMappingTimeMapFunction MapFunction_DefaultValue { get; set; }
		...
		/// </summary>
		public PictorialSeriesSonificationTracksMappingTimeWithin Within { get; set; }
		private PictorialSeriesSonificationTracksMappingTimeWithin Within_DefaultValue { get; set; }
