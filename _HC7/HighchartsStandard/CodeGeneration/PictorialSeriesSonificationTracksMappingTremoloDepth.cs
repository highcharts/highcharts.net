...
{
	public partial class PictorialSeriesSonificationTracksMappingTremoloDepth  : BaseObject
	{
		Hashtable h = new Hashtable();

		public PictorialSeriesSonificationTracksMappingTremoloDepth()
		{
			MapFunction = MapFunction_DefaultValue = PictorialSeriesSonificationTracksMappingTremoloDepthMapFunction.Linear;
			MapTo = MapTo_DefaultValue = "";
			Max = Max_DefaultValue = null;
			Min = Min_DefaultValue = null;
			Value = Value_DefaultValue = null;
			Within = Within_DefaultValue = PictorialSeriesSonificationTracksMappingTremoloDepthWithin.Chart;
		...
		/// </summary>
		public PictorialSeriesSonificationTracksMappingTremoloDepthMapFunction MapFunction { get; set; }
		private PictorialSeriesSonificationTracksMappingTremoloDepthMapFunction MapFunction_DefaultValue { get; set; }
		...
		/// </summary>
		public PictorialSeriesSonificationTracksMappingTremoloDepthWithin Within { get; set; }
		private PictorialSeriesSonificationTracksMappingTremoloDepthWithin Within_DefaultValue { get; set; }
