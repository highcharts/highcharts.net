...
{
	public partial class PictorialSeriesSonificationTracksMappingTremoloSpeed  : BaseObject
	{
		Hashtable h = new Hashtable();

		public PictorialSeriesSonificationTracksMappingTremoloSpeed()
		{
			MapFunction = MapFunction_DefaultValue = PictorialSeriesSonificationTracksMappingTremoloSpeedMapFunction.Linear;
			MapTo = MapTo_DefaultValue = "";
			Max = Max_DefaultValue = null;
			Min = Min_DefaultValue = null;
			Value = Value_DefaultValue = null;
			Within = Within_DefaultValue = PictorialSeriesSonificationTracksMappingTremoloSpeedWithin.Chart;
		...
		/// </summary>
		public PictorialSeriesSonificationTracksMappingTremoloSpeedMapFunction MapFunction { get; set; }
		private PictorialSeriesSonificationTracksMappingTremoloSpeedMapFunction MapFunction_DefaultValue { get; set; }
		...
		/// </summary>
		public PictorialSeriesSonificationTracksMappingTremoloSpeedWithin Within { get; set; }
		private PictorialSeriesSonificationTracksMappingTremoloSpeedWithin Within_DefaultValue { get; set; }
