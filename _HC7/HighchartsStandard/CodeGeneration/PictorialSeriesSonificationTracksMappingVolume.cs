...
{
	public partial class PictorialSeriesSonificationTracksMappingVolume  : BaseObject
	{
		Hashtable h = new Hashtable();

		public PictorialSeriesSonificationTracksMappingVolume()
		{
			MapFunction = MapFunction_DefaultValue = PictorialSeriesSonificationTracksMappingVolumeMapFunction.Linear;
			MapTo = MapTo_DefaultValue = "";
			Max = Max_DefaultValue = null;
			Min = Min_DefaultValue = null;
			Value = Value_DefaultValue = null;
			Within = Within_DefaultValue = PictorialSeriesSonificationTracksMappingVolumeWithin.Chart;
		...
		/// </summary>
		public PictorialSeriesSonificationTracksMappingVolumeMapFunction MapFunction { get; set; }
		private PictorialSeriesSonificationTracksMappingVolumeMapFunction MapFunction_DefaultValue { get; set; }
		...
		/// </summary>
		public PictorialSeriesSonificationTracksMappingVolumeWithin Within { get; set; }
		private PictorialSeriesSonificationTracksMappingVolumeWithin Within_DefaultValue { get; set; }
