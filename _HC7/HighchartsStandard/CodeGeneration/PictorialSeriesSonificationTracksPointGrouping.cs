...
{
	public partial class PictorialSeriesSonificationTracksPointGrouping  : BaseObject
	{
		Hashtable h = new Hashtable();

		public PictorialSeriesSonificationTracksPointGrouping()
		{
		...
		/// </summary>
		public PictorialSeriesSonificationTracksPointGroupingAlgorithm Algorithm { get; set; }
		private PictorialSeriesSonificationTracksPointGroupingAlgorithm Algorithm_DefaultValue { get; set; }
		...
		internal override Hashtable ToHashtable(Highcharts highcharts)
		{
			...
			if (Algorithm != PictorialSeriesSonificationTracksPointGroupingAlgorithm.Null) h.Add("algorithm", highcharts.FirstCharacterToLower(Algorithm.ToString()));
