...
namespace Highsoft.Web.Mvc.Charts
{
	public partial class PieSeries  : Series
	{
		...
		internal override Hashtable ToHashtable()
		{
			...
			if (PointDescriptionFormatter != PointDescriptionFormatter_DefaultValue) { h.Add("pointDescriptionFormatter",PointDescriptionFormatter); Highcharts.AddFunction("f331da17-fd8f-4d65-bd82-a59adedc6d2d.pointDescriptionFormatter", PointDescriptionFormatter); }  
