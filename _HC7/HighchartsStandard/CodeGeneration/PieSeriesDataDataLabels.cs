...
{
	public partial class PieSeriesDataDataLabels  : BaseObject
	{
		Hashtable h = new Hashtable();

		public PieSeriesDataDataLabels()
		{
		...
		/// </summary>
		public PieSeriesDataDataLabelsAlign Align { get; set; }
		private PieSeriesDataDataLabelsAlign Align_DefaultValue { get; set; }
		...
		/// </summary>
		public PieSeriesDataDataLabelsFilter Filter { get; set; }
		private PieSeriesDataDataLabelsFilter Filter_DefaultValue { get; set; }
		...
		/// </summary>
		public PieSeriesDataDataLabelsOverflow Overflow { get; set; }
		private PieSeriesDataDataLabelsOverflow Overflow_DefaultValue { get; set; }
		...
		/// </summary>
		public PieSeriesDataDataLabelsPosition Position { get; set; }
		private PieSeriesDataDataLabelsPosition Position_DefaultValue { get; set; }
		...
		/// </summary>
		public PieSeriesDataDataLabelsTextPath TextPath { get; set; }
		private PieSeriesDataDataLabelsTextPath TextPath_DefaultValue { get; set; }
		...
		/// </summary>
		public PieSeriesDataDataLabelsVerticalAlign VerticalAlign { get; set; }
		private PieSeriesDataDataLabelsVerticalAlign VerticalAlign_DefaultValue { get; set; }
		...
		internal override Hashtable ToHashtable(Highcharts highcharts)
		{
			...
			if (Align != PieSeriesDataDataLabelsAlign.Null) h.Add("align", highcharts.FirstCharacterToLower(Align.ToString()));
			...
			if (Overflow != PieSeriesDataDataLabelsOverflow.Null) h.Add("overflow", highcharts.FirstCharacterToLower(Overflow.ToString()));
			if (Padding != null) h.Add("padding",Padding);
			if (Position != PieSeriesDataDataLabelsPosition.Null) h.Add("position", highcharts.FirstCharacterToLower(Position.ToString()));
			...
			if (VerticalAlign != PieSeriesDataDataLabelsVerticalAlign.Null) h.Add("verticalAlign", highcharts.FirstCharacterToLower(VerticalAlign.ToString()));
			if (X != null) h.Add("x",X);
			if (Y != null) h.Add("y",Y);
