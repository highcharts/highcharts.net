...
{
	public partial class PieSeriesSonificationContextTracks  : BaseObject
	{
		Hashtable h = new Hashtable();

		public PieSeriesSonificationContextTracks()
		{
			ActiveWhen = ActiveWhen_DefaultValue = new PieSeriesSonificationContextTracksActiveWhen();
			Instrument = Instrument_DefaultValue = null;
			InstrumentString = InstrumentString_DefaultValue = "null";
			Mapping = Mapping_DefaultValue = new PieSeriesSonificationContextTracksMapping();
			MidiName = MidiName_DefaultValue = "";
			PointGrouping = PointGrouping_DefaultValue = new PieSeriesSonificationContextTracksPointGrouping();
			...
			Type = Type_DefaultValue = PieSeriesSonificationContextTracksType.Instrument;
			ValueInterval = ValueInterval_DefaultValue = null;
			ValueMapFunction = ValueMapFunction_DefaultValue = PieSeriesSonificationContextTracksValueMapFunction.Linear;
		...
		/// </summary>
		public PieSeriesSonificationContextTracksActiveWhen ActiveWhen { get; set; }
		private PieSeriesSonificationContextTracksActiveWhen ActiveWhen_DefaultValue { get; set; }
		...
		/// </summary>
		public PieSeriesSonificationContextTracksMapping Mapping { get; set; }
		private PieSeriesSonificationContextTracksMapping Mapping_DefaultValue { get; set; }
		...
		/// </summary>
		public PieSeriesSonificationContextTracksPointGrouping PointGrouping { get; set; }
		private PieSeriesSonificationContextTracksPointGrouping PointGrouping_DefaultValue { get; set; }
		...
		/// </summary>
		public PieSeriesSonificationContextTracksType Type { get; set; }
		private PieSeriesSonificationContextTracksType Type_DefaultValue { get; set; }
		...
		/// </summary>
		public PieSeriesSonificationContextTracksValueMapFunction ValueMapFunction { get; set; }
		private PieSeriesSonificationContextTracksValueMapFunction ValueMapFunction_DefaultValue { get; set; }
