...
{
	public partial class PieSeriesSonificationContextTracksMappingPitch  : BaseObject
	{
		Hashtable h = new Hashtable();

		public PieSeriesSonificationContextTracksMappingPitch()
		{
			MapFunction = MapFunction_DefaultValue = PieSeriesSonificationContextTracksMappingPitchMapFunction.Linear;
		...
		/// </summary>
		public PieSeriesSonificationContextTracksMappingPitchMapFunction MapFunction { get; set; }
		private PieSeriesSonificationContextTracksMappingPitchMapFunction MapFunction_DefaultValue { get; set; }
