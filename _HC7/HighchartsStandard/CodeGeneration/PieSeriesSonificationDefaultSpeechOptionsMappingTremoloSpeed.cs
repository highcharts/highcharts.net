...
{
	public partial class PieSeriesSonificationDefaultSpeechOptionsMappingTremoloSpeed  : BaseObject
	{
		Hashtable h = new Hashtable();

		public PieSeriesSonificationDefaultSpeechOptionsMappingTremoloSpeed()
		{
			MapFunction = MapFunction_DefaultValue = PieSeriesSonificationDefaultSpeechOptionsMappingTremoloSpeedMapFunction.Linear;
			MapTo = MapTo_DefaultValue = "";
			Max = Max_DefaultValue = null;
			Min = Min_DefaultValue = null;
			Value = Value_DefaultValue = null;
			Within = Within_DefaultValue = PieSeriesSonificationDefaultSpeechOptionsMappingTremoloSpeedWithin.Chart;
		...
		/// </summary>
		public PieSeriesSonificationDefaultSpeechOptionsMappingTremoloSpeedMapFunction MapFunction { get; set; }
		private PieSeriesSonificationDefaultSpeechOptionsMappingTremoloSpeedMapFunction MapFunction_DefaultValue { get; set; }
		...
		/// </summary>
		public PieSeriesSonificationDefaultSpeechOptionsMappingTremoloSpeedWithin Within { get; set; }
		private PieSeriesSonificationDefaultSpeechOptionsMappingTremoloSpeedWithin Within_DefaultValue { get; set; }
