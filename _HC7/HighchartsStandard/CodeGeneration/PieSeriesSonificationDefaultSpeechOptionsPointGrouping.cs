...
{
	public partial class PieSeriesSonificationDefaultSpeechOptionsPointGrouping  : BaseObject
	{
		Hashtable h = new Hashtable();

		public PieSeriesSonificationDefaultSpeechOptionsPointGrouping()
		{
		...
		/// </summary>
		public PieSeriesSonificationDefaultSpeechOptionsPointGroupingAlgorithm Algorithm { get; set; }
		private PieSeriesSonificationDefaultSpeechOptionsPointGroupingAlgorithm Algorithm_DefaultValue { get; set; }
		...
		internal override Hashtable ToHashtable(Highcharts highcharts)
		{
			...
			if (Algorithm != PieSeriesSonificationDefaultSpeechOptionsPointGroupingAlgorithm.Null) h.Add("algorithm", highcharts.FirstCharacterToLower(Algorithm.ToString()));
