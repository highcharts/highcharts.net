...
{
	public partial class PieSeriesSonificationTracks  : BaseObject
	{
		Hashtable h = new Hashtable();

		public PieSeriesSonificationTracks()
		{
			ActiveWhen = ActiveWhen_DefaultValue = new PieSeriesSonificationTracksActiveWhen();
			Instrument = Instrument_DefaultValue = null;
			InstrumentString = InstrumentString_DefaultValue = "null";
			Mapping = Mapping_DefaultValue = new PieSeriesSonificationTracksMapping();
			MidiName = MidiName_DefaultValue = "";
			PointGrouping = PointGrouping_DefaultValue = new PieSeriesSonificationTracksPointGrouping();
			RoundToMusicalNotes = RoundToMusicalNotes_DefaultValue = true;
			ShowPlayMarker = ShowPlayMarker_DefaultValue = true;
			Type = Type_DefaultValue = PieSeriesSonificationTracksType.Instrument;
		...
		/// </summary>
		public PieSeriesSonificationTracksActiveWhen ActiveWhen { get; set; }
		private PieSeriesSonificationTracksActiveWhen ActiveWhen_DefaultValue { get; set; }
		...
		/// </summary>
		public PieSeriesSonificationTracksMapping Mapping { get; set; }
		private PieSeriesSonificationTracksMapping Mapping_DefaultValue { get; set; }
		...
		/// </summary>
		public PieSeriesSonificationTracksPointGrouping PointGrouping { get; set; }
		private PieSeriesSonificationTracksPointGrouping PointGrouping_DefaultValue { get; set; }
		...
		/// </summary>
		public PieSeriesSonificationTracksType Type { get; set; }
		private PieSeriesSonificationTracksType Type_DefaultValue { get; set; }
