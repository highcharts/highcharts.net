...
namespace Highsoft.Web.Mvc.Charts
{
	public partial class PlotOptions  : BaseObject
	{
		...
		{
			if (Arcdiagram != null) h.Add("arcdiagram",Arcdiagram.ToHashtable(highcharts));
			if (Area != null) h.Add("area",Area.ToHashtable(highcharts));
			if (Arearange != null) h.Add("arearange",Arearange.ToHashtable(highcharts));
			if (Areaspline != null) h.Add("areaspline",Areaspline.ToHashtable(highcharts));
			if (Areasplinerange != null) h.Add("areasplinerange",Areasplinerange.ToHashtable(highcharts));
			if (Bar != null) h.Add("bar",Bar.ToHashtable(highcharts));
			if (Bellcurve != null) h.Add("bellcurve",Bellcurve.ToHashtable(highcharts));
			if (Boxplot != null) h.Add("boxplot",Boxplot.ToHashtable(highcharts));
			if (Bubble != null) h.Add("bubble",Bubble.ToHashtable(highcharts));
			if (Bullet != null) h.Add("bullet",Bullet.ToHashtable(highcharts));
			if (Column != null) h.Add("column",Column.ToHashtable(highcharts));
			if (Columnpyramid != null) h.Add("columnpyramid",Columnpyramid.ToHashtable(highcharts));
			if (Columnrange != null) h.Add("columnrange",Columnrange.ToHashtable(highcharts));
			if (Cylinder != null) h.Add("cylinder",Cylinder.ToHashtable(highcharts));
			if (Dependencywheel != null) h.Add("dependencywheel",Dependencywheel.ToHashtable(highcharts));
			if (Dumbbell != null) h.Add("dumbbell",Dumbbell.ToHashtable(highcharts));
			if (Errorbar != null) h.Add("errorbar",Errorbar.ToHashtable(highcharts));
			if (Funnel != null) h.Add("funnel",Funnel.ToHashtable(highcharts));
			if (Funnel3d != null) h.Add("funnel3d",Funnel3d.ToHashtable(highcharts));
			if (Gauge != null) h.Add("gauge",Gauge.ToHashtable(highcharts));
			if (Heatmap != null) h.Add("heatmap",Heatmap.ToHashtable(highcharts));
			if (Histogram != null) h.Add("histogram",Histogram.ToHashtable(highcharts));
			if (Item != null) h.Add("item",Item.ToHashtable(highcharts));
			if (Line != null) h.Add("line",Line.ToHashtable(highcharts));
			if (Lollipop != null) h.Add("lollipop",Lollipop.ToHashtable(highcharts));
			if (Networkgraph != null) h.Add("networkgraph",Networkgraph.ToHashtable(highcharts));
			if (Organization != null) h.Add("organization",Organization.ToHashtable(highcharts));
			if (Packedbubble != null) h.Add("packedbubble",Packedbubble.ToHashtable(highcharts));
			if (Pareto != null) h.Add("pareto",Pareto.ToHashtable(highcharts));
			if (Pictorial != null) h.Add("pictorial",Pictorial.ToHashtable(highcharts));
			if (Pie != null) h.Add("pie",Pie.ToHashtable(highcharts));
			if (Polygon != null) h.Add("polygon",Polygon.ToHashtable(highcharts));
			if (Pyramid != null) h.Add("pyramid",Pyramid.ToHashtable(highcharts));
			if (Pyramid3d != null) h.Add("pyramid3d",Pyramid3d.ToHashtable(highcharts));
			if (Sankey != null) h.Add("sankey",Sankey.ToHashtable(highcharts));
			if (Scatter != null) h.Add("scatter",Scatter.ToHashtable(highcharts));
			if (Scatter3d != null) h.Add("scatter3d",Scatter3d.ToHashtable(highcharts));
			if (Series != null) h.Add("series",Series.ToHashtable(highcharts));
			if (Solidgauge != null) h.Add("solidgauge",Solidgauge.ToHashtable(highcharts));
			if (Spline != null) h.Add("spline",Spline.ToHashtable(highcharts));
			if (Streamgraph != null) h.Add("streamgraph",Streamgraph.ToHashtable(highcharts));
			if (Sunburst != null) h.Add("sunburst",Sunburst.ToHashtable(highcharts));
			if (Tilemap != null) h.Add("tilemap",Tilemap.ToHashtable(highcharts));
			if (Timeline != null) h.Add("timeline",Timeline.ToHashtable(highcharts));
			if (Treegraph != null) h.Add("treegraph",Treegraph.ToHashtable(highcharts));
			if (Treemap != null) h.Add("treemap",Treemap.ToHashtable(highcharts));
			if (Variablepie != null) h.Add("variablepie",Variablepie.ToHashtable(highcharts));
			if (Variwide != null) h.Add("variwide",Variwide.ToHashtable(highcharts));
			if (Vector != null) h.Add("vector",Vector.ToHashtable(highcharts));
			if (Venn != null) h.Add("venn",Venn.ToHashtable(highcharts));
			if (Waterfall != null) h.Add("waterfall",Waterfall.ToHashtable(highcharts));
