...
{
	public partial class PlotOptionsArcdiagram  : BaseObject
	{
		Hashtable h = new Hashtable();

		public PlotOptionsArcdiagram()
		{
			Accessibility = Accessibility_DefaultValue = new PlotOptionsArcdiagramAccessibility();
			...
			Label = Label_DefaultValue = new PlotOptionsArcdiagramLabel();
			LegendSymbol = LegendSymbol_DefaultValue = PlotOptionsArcdiagramLegendSymbol.Rectangle;
			Levels = Levels_DefaultValue = new PlotOptionsArcdiagramLevels();
			LinkColorMode = LinkColorMode_DefaultValue = PlotOptionsArcdiagramLinkColorMode.From;
			...
			Sonification = Sonification_DefaultValue = new PlotOptionsArcdiagramSonification();
			States = States_DefaultValue = new PlotOptionsArcdiagramStates();
			StickyTracking = StickyTracking_DefaultValue = true;
			Tooltip = Tooltip_DefaultValue = new PlotOptionsArcdiagramTooltip();
		...
		/// </summary>
		public PlotOptionsArcdiagramAccessibility Accessibility { get; set; }
		private PlotOptionsArcdiagramAccessibility Accessibility_DefaultValue { get; set; }
		...
		/// </summary>
		public PlotOptionsArcdiagramDashStyle DashStyle { get; set; }
		private PlotOptionsArcdiagramDashStyle DashStyle_DefaultValue { get; set; }
		 

		/// <summary>
		/// Options for the data labels appearing on top of the nodes and links.For arc diagram charts, data labels are visible for the nodes bydefault, but hidden for links. This is controlled by modifying the`nodeFormat`, and the `format` that applies to links and is an emptystring by default.
		/// </summary>
		...
		/// </summary>
		public PlotOptionsArcdiagramEvents Events { get; set; }
		private PlotOptionsArcdiagramEvents Events_DefaultValue { get; set; }
		...
		/// </summary>
		public PlotOptionsArcdiagramLabel Label { get; set; }
		private PlotOptionsArcdiagramLabel Label_DefaultValue { get; set; }
		...
		/// </summary>
		public PlotOptionsArcdiagramLevels Levels { get; set; }
		private PlotOptionsArcdiagramLevels Levels_DefaultValue { get; set; }
		...
		/// </summary>
		public PlotOptionsArcdiagramLinkColorMode LinkColorMode { get; set; }
		private PlotOptionsArcdiagramLinkColorMode LinkColorMode_DefaultValue { get; set; }
		...
		/// 
		/// </summary>
		public PlotOptionsArcdiagramMarker Marker { get; set; }
		private PlotOptionsArcdiagramMarker Marker_DefaultValue { get; set; }
		...
		/// </summary>
		public PlotOptionsArcdiagramOnPoint OnPoint { get; set; }
		private PlotOptionsArcdiagramOnPoint OnPoint_DefaultValue { get; set; }
		...
		/// </summary>
		public PlotOptionsArcdiagramPoint Point { get; set; }
		private PlotOptionsArcdiagramPoint Point_DefaultValue { get; set; }
		...
		/// </summary>
		public PlotOptionsArcdiagramSonification Sonification { get; set; }
		private PlotOptionsArcdiagramSonification Sonification_DefaultValue { get; set; }
		 

		/// <summary>
		/// 
		/// </summary>
		public PlotOptionsArcdiagramStates States { get; set; }
		private PlotOptionsArcdiagramStates States_DefaultValue { get; set; }
		...
		/// </summary>
		public PlotOptionsArcdiagramTooltip Tooltip { get; set; }
		private PlotOptionsArcdiagramTooltip Tooltip_DefaultValue { get; set; }
