...
{
	public partial class PlotOptionsArcdiagramSonificationContextTracksActiveWhen  : BaseObject
	{
		Hashtable h = new Hashtable();

		public PlotOptionsArcdiagramSonificationContextTracksActiveWhen()
		{
