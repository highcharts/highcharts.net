...
{
	public partial class PlotOptionsArcdiagramSonificationContextTracksMapping  : BaseObject
	{
		Hashtable h = new Hashtable();

		public PlotOptionsArcdiagramSonificationContextTracksMapping()
		{
			Frequency = Frequency_DefaultValue = new PlotOptionsArcdiagramSonificationContextTracksMappingFrequency();
			GapBetweenNotes = GapBetweenNotes_DefaultValue = new PlotOptionsArcdiagramSonificationContextTracksMappingGapBetweenNotes();
			Highpass = Highpass_DefaultValue = new PlotOptionsArcdiagramSonificationContextTracksMappingHighpass();
			Lowpass = Lowpass_DefaultValue = new PlotOptionsArcdiagramSonificationContextTracksMappingLowpass();
			NoteDuration = NoteDuration_DefaultValue = new PlotOptionsArcdiagramSonificationContextTracksMappingNoteDuration();
			Pan = Pan_DefaultValue = new PlotOptionsArcdiagramSonificationContextTracksMappingPan();
			Pitch = Pitch_DefaultValue = new PlotOptionsArcdiagramSonificationContextTracksMappingPitch();
			PitchString = PitchString_DefaultValue = "null";
			PitchNumber = PitchNumber_DefaultValue = null;
			PlayDelay = PlayDelay_DefaultValue = new PlotOptionsArcdiagramSonificationContextTracksMappingPlayDelay();
			Time = Time_DefaultValue = new PlotOptionsArcdiagramSonificationContextTracksMappingTime();
			TimeString = TimeString_DefaultValue = "null";
			TimeNumber = TimeNumber_DefaultValue = null;
			Tremolo = Tremolo_DefaultValue = new PlotOptionsArcdiagramSonificationContextTracksMappingTremolo();
			Volume = Volume_DefaultValue = new PlotOptionsArcdiagramSonificationContextTracksMappingVolume();
		...
		/// </summary>
		public PlotOptionsArcdiagramSonificationContextTracksMappingFrequency Frequency { get; set; }
		private PlotOptionsArcdiagramSonificationContextTracksMappingFrequency Frequency_DefaultValue { get; set; }
		...
		/// </summary>
		public PlotOptionsArcdiagramSonificationContextTracksMappingGapBetweenNotes GapBetweenNotes { get; set; }
		private PlotOptionsArcdiagramSonificationContextTracksMappingGapBetweenNotes GapBetweenNotes_DefaultValue { get; set; }
		...
		/// </summary>
		public PlotOptionsArcdiagramSonificationContextTracksMappingHighpass Highpass { get; set; }
		private PlotOptionsArcdiagramSonificationContextTracksMappingHighpass Highpass_DefaultValue { get; set; }
		...
		/// </summary>
		public PlotOptionsArcdiagramSonificationContextTracksMappingLowpass Lowpass { get; set; }
		private PlotOptionsArcdiagramSonificationContextTracksMappingLowpass Lowpass_DefaultValue { get; set; }
		...
		/// </summary>
		public PlotOptionsArcdiagramSonificationContextTracksMappingNoteDuration NoteDuration { get; set; }
		private PlotOptionsArcdiagramSonificationContextTracksMappingNoteDuration NoteDuration_DefaultValue { get; set; }
		...
		/// </summary>
		public PlotOptionsArcdiagramSonificationContextTracksMappingPan Pan { get; set; }
		private PlotOptionsArcdiagramSonificationContextTracksMappingPan Pan_DefaultValue { get; set; }
		...
		/// </summary>
		public PlotOptionsArcdiagramSonificationContextTracksMappingPitch Pitch { get; set; }
		private PlotOptionsArcdiagramSonificationContextTracksMappingPitch Pitch_DefaultValue { get; set; }
		...
		/// </summary>
		public PlotOptionsArcdiagramSonificationContextTracksMappingPlayDelay PlayDelay { get; set; }
		private PlotOptionsArcdiagramSonificationContextTracksMappingPlayDelay PlayDelay_DefaultValue { get; set; }
		...
		/// </summary>
		public PlotOptionsArcdiagramSonificationContextTracksMappingTime Time { get; set; }
		private PlotOptionsArcdiagramSonificationContextTracksMappingTime Time_DefaultValue { get; set; }
		...
		/// </summary>
		public PlotOptionsArcdiagramSonificationContextTracksMappingTremolo Tremolo { get; set; }
		private PlotOptionsArcdiagramSonificationContextTracksMappingTremolo Tremolo_DefaultValue { get; set; }
		 

		/// <summary>
		/// The volume of notes, from 0 to 1.
		/// </summary>
		public PlotOptionsArcdiagramSonificationContextTracksMappingVolume Volume { get; set; }
		private PlotOptionsArcdiagramSonificationContextTracksMappingVolume Volume_DefaultValue { get; set; }
