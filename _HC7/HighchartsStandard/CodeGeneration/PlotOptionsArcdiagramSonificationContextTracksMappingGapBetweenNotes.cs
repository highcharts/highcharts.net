...
{
	public partial class PlotOptionsArcdiagramSonificationContextTracksMappingGapBetweenNotes  : BaseObject
	{
		Hashtable h = new Hashtable();

		public PlotOptionsArcdiagramSonificationContextTracksMappingGapBetweenNotes()
		{
			MapFunction = MapFunction_DefaultValue = PlotOptionsArcdiagramSonificationContextTracksMappingGapBetweenNotesMapFunction.Linear;
			MapTo = MapTo_DefaultValue = "";
			Max = Max_DefaultValue = null;
			Min = Min_DefaultValue = null;
			Value = Value_DefaultValue = null;
			Within = Within_DefaultValue = PlotOptionsArcdiagramSonificationContextTracksMappingGapBetweenNotesWithin.Chart;
		...
		/// </summary>
		public PlotOptionsArcdiagramSonificationContextTracksMappingGapBetweenNotesMapFunction MapFunction { get; set; }
		private PlotOptionsArcdiagramSonificationContextTracksMappingGapBetweenNotesMapFunction MapFunction_DefaultValue { get; set; }
		...
		/// </summary>
		public PlotOptionsArcdiagramSonificationContextTracksMappingGapBetweenNotesWithin Within { get; set; }
		private PlotOptionsArcdiagramSonificationContextTracksMappingGapBetweenNotesWithin Within_DefaultValue { get; set; }
