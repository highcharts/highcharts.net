...
{
	public partial class PlotOptionsArcdiagramSonificationContextTracksMappingPitch  : BaseObject
	{
		Hashtable h = new Hashtable();

		public PlotOptionsArcdiagramSonificationContextTracksMappingPitch()
		{
			MapFunction = MapFunction_DefaultValue = PlotOptionsArcdiagramSonificationContextTracksMappingPitchMapFunction.Linear;
		...
		/// </summary>
		public PlotOptionsArcdiagramSonificationContextTracksMappingPitchMapFunction MapFunction { get; set; }
		private PlotOptionsArcdiagramSonificationContextTracksMappingPitchMapFunction MapFunction_DefaultValue { get; set; }
