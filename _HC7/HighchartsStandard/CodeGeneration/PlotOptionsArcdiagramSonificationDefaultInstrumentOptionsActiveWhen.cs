...
{
	public partial class PlotOptionsArcdiagramSonificationDefaultInstrumentOptionsActiveWhen  : BaseObject
	{
		Hashtable h = new Hashtable();

		public PlotOptionsArcdiagramSonificationDefaultInstrumentOptionsActiveWhen()
		{
