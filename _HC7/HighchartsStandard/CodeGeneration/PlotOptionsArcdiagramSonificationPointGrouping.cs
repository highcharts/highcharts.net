...
{
	public partial class PlotOptionsArcdiagramSonificationPointGrouping  : BaseObject
	{
		Hashtable h = new Hashtable();

		public PlotOptionsArcdiagramSonificationPointGrouping()
		{
		...
		/// </summary>
		public PlotOptionsArcdiagramSonificationPointGroupingAlgorithm Algorithm { get; set; }
		private PlotOptionsArcdiagramSonificationPointGroupingAlgorithm Algorithm_DefaultValue { get; set; }
		...
		internal override Hashtable ToHashtable(Highcharts highcharts)
		{
			...
			if (Algorithm != PlotOptionsArcdiagramSonificationPointGroupingAlgorithm.Null) h.Add("algorithm", highcharts.FirstCharacterToLower(Algorithm.ToString()));
