...
{
	public partial class PlotOptionsArcdiagramSonificationTracksMappingVolume  : BaseObject
	{
		Hashtable h = new Hashtable();

		public PlotOptionsArcdiagramSonificationTracksMappingVolume()
		{
			MapFunction = MapFunction_DefaultValue = PlotOptionsArcdiagramSonificationTracksMappingVolumeMapFunction.Linear;
			MapTo = MapTo_DefaultValue = "";
			Max = Max_DefaultValue = null;
			Min = Min_DefaultValue = null;
			Value = Value_DefaultValue = null;
			Within = Within_DefaultValue = PlotOptionsArcdiagramSonificationTracksMappingVolumeWithin.Chart;
		...
		/// </summary>
		public PlotOptionsArcdiagramSonificationTracksMappingVolumeMapFunction MapFunction { get; set; }
		private PlotOptionsArcdiagramSonificationTracksMappingVolumeMapFunction MapFunction_DefaultValue { get; set; }
		...
		/// </summary>
		public PlotOptionsArcdiagramSonificationTracksMappingVolumeWithin Within { get; set; }
		private PlotOptionsArcdiagramSonificationTracksMappingVolumeWithin Within_DefaultValue { get; set; }
