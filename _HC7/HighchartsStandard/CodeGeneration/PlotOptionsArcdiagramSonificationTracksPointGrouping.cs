...
{
	public partial class PlotOptionsArcdiagramSonificationTracksPointGrouping  : BaseObject
	{
		Hashtable h = new Hashtable();

		public PlotOptionsArcdiagramSonificationTracksPointGrouping()
		{
		...
		/// </summary>
		public PlotOptionsArcdiagramSonificationTracksPointGroupingAlgorithm Algorithm { get; set; }
		private PlotOptionsArcdiagramSonificationTracksPointGroupingAlgorithm Algorithm_DefaultValue { get; set; }
		...
		internal override Hashtable ToHashtable(Highcharts highcharts)
		{
			...
			if (Algorithm != PlotOptionsArcdiagramSonificationTracksPointGroupingAlgorithm.Null) h.Add("algorithm", highcharts.FirstCharacterToLower(Algorithm.ToString()));
