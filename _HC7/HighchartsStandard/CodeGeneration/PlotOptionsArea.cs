...
namespace Highsoft.Web.Mvc.Charts
{
	public partial class PlotOptionsArea  : BaseObject
	{
		...
		internal override Hashtable ToHashtable()
		{
			...
			if (PointDescriptionFormatter != PointDescriptionFormatter_DefaultValue) { h.Add("pointDescriptionFormatter",PointDescriptionFormatter); Highcharts.AddFunction("66aafc2d-fd3c-4246-8875-1dedc2a6b404.pointDescriptionFormatter", PointDescriptionFormatter); }  
