...
namespace Highsoft.Web.Mvc.Charts
{
	public partial class PlotOptionsAreaMarkerStates  : BaseObject
	{
		public PlotOptionsAreaMarkerStates()
		{
			...
			Inactive = Inactive_DefaultValue = new PlotOptionsAreaMarkerStatesInactive();
			Normal = Normal_DefaultValue = new PlotOptionsAreaMarkerStatesNormal();
		...
		/// 
		/// </summary>
		public PlotOptionsAreaMarkerStatesInactive Inactive { get; set; }
		private PlotOptionsAreaMarkerStatesInactive Inactive_DefaultValue { get; set; }
