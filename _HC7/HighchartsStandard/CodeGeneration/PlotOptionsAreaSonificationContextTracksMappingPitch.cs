...
{
	public partial class PlotOptionsAreaSonificationContextTracksMappingPitch  : BaseObject
	{
		Hashtable h = new Hashtable();

		public PlotOptionsAreaSonificationContextTracksMappingPitch()
		{
			MapFunction = MapFunction_DefaultValue = PlotOptionsAreaSonificationContextTracksMappingPitchMapFunction.Linear;
		...
		/// </summary>
		public PlotOptionsAreaSonificationContextTracksMappingPitchMapFunction MapFunction { get; set; }
		private PlotOptionsAreaSonificationContextTracksMappingPitchMapFunction MapFunction_DefaultValue { get; set; }
