...
{
	public partial class PlotOptionsAreaSonificationContextTracksMappingTime  : BaseObject
	{
		Hashtable h = new Hashtable();

		public PlotOptionsAreaSonificationContextTracksMappingTime()
		{
			MapFunction = MapFunction_DefaultValue = PlotOptionsAreaSonificationContextTracksMappingTimeMapFunction.Linear;
			MapTo = MapTo_DefaultValue = "";
			Max = Max_DefaultValue = null;
			Min = Min_DefaultValue = null;
			Value = Value_DefaultValue = null;
			Within = Within_DefaultValue = PlotOptionsAreaSonificationContextTracksMappingTimeWithin.Chart;
		...
		/// </summary>
		public PlotOptionsAreaSonificationContextTracksMappingTimeMapFunction MapFunction { get; set; }
		private PlotOptionsAreaSonificationContextTracksMappingTimeMapFunction MapFunction_DefaultValue { get; set; }
		...
		/// </summary>
		public PlotOptionsAreaSonificationContextTracksMappingTimeWithin Within { get; set; }
		private PlotOptionsAreaSonificationContextTracksMappingTimeWithin Within_DefaultValue { get; set; }
