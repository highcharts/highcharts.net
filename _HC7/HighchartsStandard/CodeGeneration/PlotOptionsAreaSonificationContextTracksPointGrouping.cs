...
{
	public partial class PlotOptionsAreaSonificationContextTracksPointGrouping  : BaseObject
	{
		Hashtable h = new Hashtable();

		public PlotOptionsAreaSonificationContextTracksPointGrouping()
		{
		...
		/// </summary>
		public PlotOptionsAreaSonificationContextTracksPointGroupingAlgorithm Algorithm { get; set; }
		private PlotOptionsAreaSonificationContextTracksPointGroupingAlgorithm Algorithm_DefaultValue { get; set; }
		...
		internal override Hashtable ToHashtable(Highcharts highcharts)
		{
			...
			if (Algorithm != PlotOptionsAreaSonificationContextTracksPointGroupingAlgorithm.Null) h.Add("algorithm", highcharts.FirstCharacterToLower(Algorithm.ToString()));
