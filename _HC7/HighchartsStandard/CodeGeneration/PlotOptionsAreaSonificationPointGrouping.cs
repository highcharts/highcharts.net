...
{
	public partial class PlotOptionsAreaSonificationPointGrouping  : BaseObject
	{
		Hashtable h = new Hashtable();

		public PlotOptionsAreaSonificationPointGrouping()
		{
		...
		/// </summary>
		public PlotOptionsAreaSonificationPointGroupingAlgorithm Algorithm { get; set; }
		private PlotOptionsAreaSonificationPointGroupingAlgorithm Algorithm_DefaultValue { get; set; }
		...
		internal override Hashtable ToHashtable(Highcharts highcharts)
		{
			...
			if (Algorithm != PlotOptionsAreaSonificationPointGroupingAlgorithm.Null) h.Add("algorithm", highcharts.FirstCharacterToLower(Algorithm.ToString()));
