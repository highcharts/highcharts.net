...
{
	public partial class PlotOptionsAreaSonificationTracksMappingFrequency  : BaseObject
	{
		Hashtable h = new Hashtable();

		public PlotOptionsAreaSonificationTracksMappingFrequency()
		{
			MapFunction = MapFunction_DefaultValue = PlotOptionsAreaSonificationTracksMappingFrequencyMapFunction.Linear;
			MapTo = MapTo_DefaultValue = "";
			Max = Max_DefaultValue = null;
			Min = Min_DefaultValue = null;
			Value = Value_DefaultValue = null;
			Within = Within_DefaultValue = PlotOptionsAreaSonificationTracksMappingFrequencyWithin.Chart;
		...
		/// </summary>
		public PlotOptionsAreaSonificationTracksMappingFrequencyMapFunction MapFunction { get; set; }
		private PlotOptionsAreaSonificationTracksMappingFrequencyMapFunction MapFunction_DefaultValue { get; set; }
		...
		/// </summary>
		public PlotOptionsAreaSonificationTracksMappingFrequencyWithin Within { get; set; }
		private PlotOptionsAreaSonificationTracksMappingFrequencyWithin Within_DefaultValue { get; set; }
