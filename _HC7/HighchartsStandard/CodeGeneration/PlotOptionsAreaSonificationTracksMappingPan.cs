...
{
	public partial class PlotOptionsAreaSonificationTracksMappingPan  : BaseObject
	{
		Hashtable h = new Hashtable();

		public PlotOptionsAreaSonificationTracksMappingPan()
		{
			MapFunction = MapFunction_DefaultValue = PlotOptionsAreaSonificationTracksMappingPanMapFunction.Linear;
			MapTo = MapTo_DefaultValue = "";
			Max = Max_DefaultValue = null;
			Min = Min_DefaultValue = null;
			Value = Value_DefaultValue = null;
			Within = Within_DefaultValue = PlotOptionsAreaSonificationTracksMappingPanWithin.Chart;
		...
		/// </summary>
		public PlotOptionsAreaSonificationTracksMappingPanMapFunction MapFunction { get; set; }
		private PlotOptionsAreaSonificationTracksMappingPanMapFunction MapFunction_DefaultValue { get; set; }
		...
		/// </summary>
		public PlotOptionsAreaSonificationTracksMappingPanWithin Within { get; set; }
		private PlotOptionsAreaSonificationTracksMappingPanWithin Within_DefaultValue { get; set; }
