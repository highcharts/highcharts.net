...
{
	public partial class PlotOptionsAreaSonificationTracksMappingPitch  : BaseObject
	{
		Hashtable h = new Hashtable();

		public PlotOptionsAreaSonificationTracksMappingPitch()
		{
			MapFunction = MapFunction_DefaultValue = PlotOptionsAreaSonificationTracksMappingPitchMapFunction.Linear;
		...
		/// </summary>
		public PlotOptionsAreaSonificationTracksMappingPitchMapFunction MapFunction { get; set; }
		private PlotOptionsAreaSonificationTracksMappingPitchMapFunction MapFunction_DefaultValue { get; set; }
