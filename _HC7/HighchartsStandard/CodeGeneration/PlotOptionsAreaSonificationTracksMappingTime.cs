...
{
	public partial class PlotOptionsAreaSonificationTracksMappingTime  : BaseObject
	{
		Hashtable h = new Hashtable();

		public PlotOptionsAreaSonificationTracksMappingTime()
		{
			MapFunction = MapFunction_DefaultValue = PlotOptionsAreaSonificationTracksMappingTimeMapFunction.Linear;
			MapTo = MapTo_DefaultValue = "";
			Max = Max_DefaultValue = null;
			Min = Min_DefaultValue = null;
			Value = Value_DefaultValue = null;
			Within = Within_DefaultValue = PlotOptionsAreaSonificationTracksMappingTimeWithin.Chart;
		...
		/// </summary>
		public PlotOptionsAreaSonificationTracksMappingTimeMapFunction MapFunction { get; set; }
		private PlotOptionsAreaSonificationTracksMappingTimeMapFunction MapFunction_DefaultValue { get; set; }
		...
		/// </summary>
		public PlotOptionsAreaSonificationTracksMappingTimeWithin Within { get; set; }
		private PlotOptionsAreaSonificationTracksMappingTimeWithin Within_DefaultValue { get; set; }
