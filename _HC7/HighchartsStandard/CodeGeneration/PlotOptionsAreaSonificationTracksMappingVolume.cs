...
{
	public partial class PlotOptionsAreaSonificationTracksMappingVolume  : BaseObject
	{
		Hashtable h = new Hashtable();

		public PlotOptionsAreaSonificationTracksMappingVolume()
		{
			MapFunction = MapFunction_DefaultValue = PlotOptionsAreaSonificationTracksMappingVolumeMapFunction.Linear;
			MapTo = MapTo_DefaultValue = "";
			Max = Max_DefaultValue = null;
			Min = Min_DefaultValue = null;
			Value = Value_DefaultValue = null;
			Within = Within_DefaultValue = PlotOptionsAreaSonificationTracksMappingVolumeWithin.Chart;
		...
		/// </summary>
		public PlotOptionsAreaSonificationTracksMappingVolumeMapFunction MapFunction { get; set; }
		private PlotOptionsAreaSonificationTracksMappingVolumeMapFunction MapFunction_DefaultValue { get; set; }
		...
		/// </summary>
		public PlotOptionsAreaSonificationTracksMappingVolumeWithin Within { get; set; }
		private PlotOptionsAreaSonificationTracksMappingVolumeWithin Within_DefaultValue { get; set; }
