...
{
	public partial class PlotOptionsAreaSonificationTracksPointGrouping  : BaseObject
	{
		Hashtable h = new Hashtable();

		public PlotOptionsAreaSonificationTracksPointGrouping()
		{
		...
		/// </summary>
		public PlotOptionsAreaSonificationTracksPointGroupingAlgorithm Algorithm { get; set; }
		private PlotOptionsAreaSonificationTracksPointGroupingAlgorithm Algorithm_DefaultValue { get; set; }
		...
		internal override Hashtable ToHashtable(Highcharts highcharts)
		{
			...
			if (Algorithm != PlotOptionsAreaSonificationTracksPointGroupingAlgorithm.Null) h.Add("algorithm", highcharts.FirstCharacterToLower(Algorithm.ToString()));
