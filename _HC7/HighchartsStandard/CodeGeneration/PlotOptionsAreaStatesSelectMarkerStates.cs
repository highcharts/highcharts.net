...
namespace Highsoft.Web.Mvc.Charts
{
	public partial class PlotOptionsAreaStatesSelectMarkerStates  : BaseObject
	{
		public PlotOptionsAreaStatesSelectMarkerStates()
		{
			...
			Inactive = Inactive_DefaultValue = new PlotOptionsAreaStatesSelectMarkerStatesInactive();
			Normal = Normal_DefaultValue = new PlotOptionsAreaStatesSelectMarkerStatesNormal();
		...
		/// 
		/// </summary>
		public PlotOptionsAreaStatesSelectMarkerStatesInactive Inactive { get; set; }
		private PlotOptionsAreaStatesSelectMarkerStatesInactive Inactive_DefaultValue { get; set; }
		 

		/// <summary>
		/// The normal state of a single point marker. Currently onlyused for setting animation when returning to normal statefrom hover.
		/// </summary>
		public PlotOptionsAreaStatesSelectMarkerStatesNormal Normal { get; set; }
		private PlotOptionsAreaStatesSelectMarkerStatesNormal Normal_DefaultValue { get; set; }
