...
namespace Highsoft.Web.Mvc.Charts
{
	public partial class PlotOptionsAreaTooltip  : BaseObject
	{
		...
		internal override Hashtable ToHashtable()
		{
			...
			if (NullFormatter != NullFormatter_DefaultValue) { h.Add("nullFormatter",NullFormatter); Highcharts.AddFunction("PlotOptionsAreaTooltipNullFormatter.nullFormatter", NullFormatter); }  
