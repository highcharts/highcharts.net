...
namespace Highsoft.Web.Mvc.Charts
{
	public partial class PlotOptionsArearangeAccessibility  : BaseObject
	{
		...
		internal override Hashtable ToHashtable()
		{
			...
			if (PointDescriptionFormatter != PointDescriptionFormatter_DefaultValue) { h.Add("pointDescriptionFormatter",PointDescriptionFormatter); Highcharts.AddFunction("ae5e3032-6e19-4e57-aa59-1421e6e68b7b.pointDescriptionFormatter", PointDescriptionFormatter); }  
