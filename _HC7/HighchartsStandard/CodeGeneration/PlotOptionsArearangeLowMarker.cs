...
{
	public partial class PlotOptionsArearangeLowMarker  : BaseObject
	{
		Hashtable h = new Hashtable();

		public PlotOptionsArearangeLowMarker()
		{
			...
			States = States_DefaultValue = new PlotOptionsArearangeLowMarkerStates();
		...
		/// </summary>
		public PlotOptionsArearangeLowMarkerStates States { get; set; }
		private PlotOptionsArearangeLowMarkerStates States_DefaultValue { get; set; }
