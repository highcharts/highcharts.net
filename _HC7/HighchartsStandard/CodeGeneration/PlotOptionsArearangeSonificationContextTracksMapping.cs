...
{
	public partial class PlotOptionsArearangeSonificationContextTracksMapping  : BaseObject
	{
		Hashtable h = new Hashtable();

		public PlotOptionsArearangeSonificationContextTracksMapping()
		{
			Frequency = Frequency_DefaultValue = new PlotOptionsArearangeSonificationContextTracksMappingFrequency();
			GapBetweenNotes = GapBetweenNotes_DefaultValue = new PlotOptionsArearangeSonificationContextTracksMappingGapBetweenNotes();
			Highpass = Highpass_DefaultValue = new PlotOptionsArearangeSonificationContextTracksMappingHighpass();
			Lowpass = Lowpass_DefaultValue = new PlotOptionsArearangeSonificationContextTracksMappingLowpass();
			NoteDuration = NoteDuration_DefaultValue = new PlotOptionsArearangeSonificationContextTracksMappingNoteDuration();
			Pan = Pan_DefaultValue = new PlotOptionsArearangeSonificationContextTracksMappingPan();
			Pitch = Pitch_DefaultValue = new PlotOptionsArearangeSonificationContextTracksMappingPitch();
			PitchString = PitchString_DefaultValue = "null";
			PitchNumber = PitchNumber_DefaultValue = null;
			PlayDelay = PlayDelay_DefaultValue = new PlotOptionsArearangeSonificationContextTracksMappingPlayDelay();
			Time = Time_DefaultValue = new PlotOptionsArearangeSonificationContextTracksMappingTime();
			TimeString = TimeString_DefaultValue = "null";
			TimeNumber = TimeNumber_DefaultValue = null;
			Tremolo = Tremolo_DefaultValue = new PlotOptionsArearangeSonificationContextTracksMappingTremolo();
			Volume = Volume_DefaultValue = new PlotOptionsArearangeSonificationContextTracksMappingVolume();
		...
		/// </summary>
		public PlotOptionsArearangeSonificationContextTracksMappingFrequency Frequency { get; set; }
		private PlotOptionsArearangeSonificationContextTracksMappingFrequency Frequency_DefaultValue { get; set; }
		...
		/// </summary>
		public PlotOptionsArearangeSonificationContextTracksMappingGapBetweenNotes GapBetweenNotes { get; set; }
		private PlotOptionsArearangeSonificationContextTracksMappingGapBetweenNotes GapBetweenNotes_DefaultValue { get; set; }
		...
		/// </summary>
		public PlotOptionsArearangeSonificationContextTracksMappingHighpass Highpass { get; set; }
		private PlotOptionsArearangeSonificationContextTracksMappingHighpass Highpass_DefaultValue { get; set; }
		...
		/// </summary>
		public PlotOptionsArearangeSonificationContextTracksMappingLowpass Lowpass { get; set; }
		private PlotOptionsArearangeSonificationContextTracksMappingLowpass Lowpass_DefaultValue { get; set; }
		...
		/// </summary>
		public PlotOptionsArearangeSonificationContextTracksMappingNoteDuration NoteDuration { get; set; }
		private PlotOptionsArearangeSonificationContextTracksMappingNoteDuration NoteDuration_DefaultValue { get; set; }
		...
		/// </summary>
		public PlotOptionsArearangeSonificationContextTracksMappingPan Pan { get; set; }
		private PlotOptionsArearangeSonificationContextTracksMappingPan Pan_DefaultValue { get; set; }
		...
		/// </summary>
		public PlotOptionsArearangeSonificationContextTracksMappingPitch Pitch { get; set; }
		private PlotOptionsArearangeSonificationContextTracksMappingPitch Pitch_DefaultValue { get; set; }
		...
		/// </summary>
		public PlotOptionsArearangeSonificationContextTracksMappingPlayDelay PlayDelay { get; set; }
		private PlotOptionsArearangeSonificationContextTracksMappingPlayDelay PlayDelay_DefaultValue { get; set; }
		...
		/// </summary>
		public PlotOptionsArearangeSonificationContextTracksMappingTime Time { get; set; }
		private PlotOptionsArearangeSonificationContextTracksMappingTime Time_DefaultValue { get; set; }
		...
		/// </summary>
		public PlotOptionsArearangeSonificationContextTracksMappingTremolo Tremolo { get; set; }
		private PlotOptionsArearangeSonificationContextTracksMappingTremolo Tremolo_DefaultValue { get; set; }
		 

		/// <summary>
		/// The volume of notes, from 0 to 1.
		/// </summary>
		public PlotOptionsArearangeSonificationContextTracksMappingVolume Volume { get; set; }
		private PlotOptionsArearangeSonificationContextTracksMappingVolume Volume_DefaultValue { get; set; }
