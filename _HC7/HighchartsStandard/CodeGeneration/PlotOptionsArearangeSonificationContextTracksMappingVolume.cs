...
{
	public partial class PlotOptionsArearangeSonificationContextTracksMappingVolume  : BaseObject
	{
		Hashtable h = new Hashtable();

		public PlotOptionsArearangeSonificationContextTracksMappingVolume()
		{
			MapFunction = MapFunction_DefaultValue = PlotOptionsArearangeSonificationContextTracksMappingVolumeMapFunction.Linear;
			MapTo = MapTo_DefaultValue = "";
			Max = Max_DefaultValue = null;
			Min = Min_DefaultValue = null;
			Value = Value_DefaultValue = null;
			Within = Within_DefaultValue = PlotOptionsArearangeSonificationContextTracksMappingVolumeWithin.Chart;
		...
		/// </summary>
		public PlotOptionsArearangeSonificationContextTracksMappingVolumeMapFunction MapFunction { get; set; }
		private PlotOptionsArearangeSonificationContextTracksMappingVolumeMapFunction MapFunction_DefaultValue { get; set; }
		...
		/// </summary>
		public PlotOptionsArearangeSonificationContextTracksMappingVolumeWithin Within { get; set; }
		private PlotOptionsArearangeSonificationContextTracksMappingVolumeWithin Within_DefaultValue { get; set; }
