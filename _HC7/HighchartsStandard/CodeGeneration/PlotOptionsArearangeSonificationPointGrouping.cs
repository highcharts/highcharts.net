...
{
	public partial class PlotOptionsArearangeSonificationPointGrouping  : BaseObject
	{
		Hashtable h = new Hashtable();

		public PlotOptionsArearangeSonificationPointGrouping()
		{
		...
		/// </summary>
		public PlotOptionsArearangeSonificationPointGroupingAlgorithm Algorithm { get; set; }
		private PlotOptionsArearangeSonificationPointGroupingAlgorithm Algorithm_DefaultValue { get; set; }
		...
		internal override Hashtable ToHashtable(Highcharts highcharts)
		{
			...
			if (Algorithm != PlotOptionsArearangeSonificationPointGroupingAlgorithm.Null) h.Add("algorithm", highcharts.FirstCharacterToLower(Algorithm.ToString()));
