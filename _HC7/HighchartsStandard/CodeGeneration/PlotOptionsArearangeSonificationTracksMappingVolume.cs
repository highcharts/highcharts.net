...
{
	public partial class PlotOptionsArearangeSonificationTracksMappingVolume  : BaseObject
	{
		Hashtable h = new Hashtable();

		public PlotOptionsArearangeSonificationTracksMappingVolume()
		{
			MapFunction = MapFunction_DefaultValue = PlotOptionsArearangeSonificationTracksMappingVolumeMapFunction.Linear;
			MapTo = MapTo_DefaultValue = "";
			Max = Max_DefaultValue = null;
			Min = Min_DefaultValue = null;
			Value = Value_DefaultValue = null;
			Within = Within_DefaultValue = PlotOptionsArearangeSonificationTracksMappingVolumeWithin.Chart;
		...
		/// </summary>
		public PlotOptionsArearangeSonificationTracksMappingVolumeMapFunction MapFunction { get; set; }
		private PlotOptionsArearangeSonificationTracksMappingVolumeMapFunction MapFunction_DefaultValue { get; set; }
		...
		/// </summary>
		public PlotOptionsArearangeSonificationTracksMappingVolumeWithin Within { get; set; }
		private PlotOptionsArearangeSonificationTracksMappingVolumeWithin Within_DefaultValue { get; set; }
