...
{
	public partial class PlotOptionsArearangeSonificationTracksPointGrouping  : BaseObject
	{
		Hashtable h = new Hashtable();

		public PlotOptionsArearangeSonificationTracksPointGrouping()
		{
		...
		/// </summary>
		public PlotOptionsArearangeSonificationTracksPointGroupingAlgorithm Algorithm { get; set; }
		private PlotOptionsArearangeSonificationTracksPointGroupingAlgorithm Algorithm_DefaultValue { get; set; }
		...
		internal override Hashtable ToHashtable(Highcharts highcharts)
		{
			...
			if (Algorithm != PlotOptionsArearangeSonificationTracksPointGroupingAlgorithm.Null) h.Add("algorithm", highcharts.FirstCharacterToLower(Algorithm.ToString()));
