...
{
	public partial class PlotOptionsAreasplineSonificationDefaultInstrumentOptionsMappingPan  : BaseObject
	{
		Hashtable h = new Hashtable();

		public PlotOptionsAreasplineSonificationDefaultInstrumentOptionsMappingPan()
		{
			MapFunction = MapFunction_DefaultValue = PlotOptionsAreasplineSonificationDefaultInstrumentOptionsMappingPanMapFunction.Linear;
			MapTo = MapTo_DefaultValue = "";
			Max = Max_DefaultValue = null;
			Min = Min_DefaultValue = null;
			Value = Value_DefaultValue = null;
			Within = Within_DefaultValue = PlotOptionsAreasplineSonificationDefaultInstrumentOptionsMappingPanWithin.Chart;
		...
		/// </summary>
		public PlotOptionsAreasplineSonificationDefaultInstrumentOptionsMappingPanMapFunction MapFunction { get; set; }
		private PlotOptionsAreasplineSonificationDefaultInstrumentOptionsMappingPanMapFunction MapFunction_DefaultValue { get; set; }
		...
		/// </summary>
		public PlotOptionsAreasplineSonificationDefaultInstrumentOptionsMappingPanWithin Within { get; set; }
		private PlotOptionsAreasplineSonificationDefaultInstrumentOptionsMappingPanWithin Within_DefaultValue { get; set; }
