...
{
	public partial class PlotOptionsAreasplineSonificationDefaultSpeechOptionsMappingVolume  : BaseObject
	{
		Hashtable h = new Hashtable();

		public PlotOptionsAreasplineSonificationDefaultSpeechOptionsMappingVolume()
		{
			MapFunction = MapFunction_DefaultValue = PlotOptionsAreasplineSonificationDefaultSpeechOptionsMappingVolumeMapFunction.Linear;
			MapTo = MapTo_DefaultValue = "";
			Max = Max_DefaultValue = null;
			Min = Min_DefaultValue = null;
			Value = Value_DefaultValue = null;
			Within = Within_DefaultValue = PlotOptionsAreasplineSonificationDefaultSpeechOptionsMappingVolumeWithin.Chart;
		...
		/// </summary>
		public PlotOptionsAreasplineSonificationDefaultSpeechOptionsMappingVolumeMapFunction MapFunction { get; set; }
		private PlotOptionsAreasplineSonificationDefaultSpeechOptionsMappingVolumeMapFunction MapFunction_DefaultValue { get; set; }
		...
		/// </summary>
		public PlotOptionsAreasplineSonificationDefaultSpeechOptionsMappingVolumeWithin Within { get; set; }
		private PlotOptionsAreasplineSonificationDefaultSpeechOptionsMappingVolumeWithin Within_DefaultValue { get; set; }
