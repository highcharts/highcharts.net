...
{
	public partial class PlotOptionsAreasplineSonificationPointGrouping  : BaseObject
	{
		Hashtable h = new Hashtable();

		public PlotOptionsAreasplineSonificationPointGrouping()
		{
		...
		/// </summary>
		public PlotOptionsAreasplineSonificationPointGroupingAlgorithm Algorithm { get; set; }
		private PlotOptionsAreasplineSonificationPointGroupingAlgorithm Algorithm_DefaultValue { get; set; }
		...
		internal override Hashtable ToHashtable(Highcharts highcharts)
		{
			...
			if (Algorithm != PlotOptionsAreasplineSonificationPointGroupingAlgorithm.Null) h.Add("algorithm", highcharts.FirstCharacterToLower(Algorithm.ToString()));
