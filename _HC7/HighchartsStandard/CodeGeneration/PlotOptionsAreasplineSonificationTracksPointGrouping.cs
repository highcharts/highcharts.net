...
{
	public partial class PlotOptionsAreasplineSonificationTracksPointGrouping  : BaseObject
	{
		Hashtable h = new Hashtable();

		public PlotOptionsAreasplineSonificationTracksPointGrouping()
		{
		...
		/// </summary>
		public PlotOptionsAreasplineSonificationTracksPointGroupingAlgorithm Algorithm { get; set; }
		private PlotOptionsAreasplineSonificationTracksPointGroupingAlgorithm Algorithm_DefaultValue { get; set; }
		...
		internal override Hashtable ToHashtable(Highcharts highcharts)
		{
			...
			if (Algorithm != PlotOptionsAreasplineSonificationTracksPointGroupingAlgorithm.Null) h.Add("algorithm", highcharts.FirstCharacterToLower(Algorithm.ToString()));
