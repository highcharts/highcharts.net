...
{
	public partial class PlotOptionsAreasplineTooltip  : BaseObject
	{
		public PlotOptionsAreasplineTooltip()
		{
			...
			HeaderShape = HeaderShape_DefaultValue = PlotOptionsAreasplineTooltipHeaderShape.Callout;
		...
		/// </summary>
		public PlotOptionsAreasplineTooltipHeaderShape HeaderShape { get; set; }
		private PlotOptionsAreasplineTooltipHeaderShape HeaderShape_DefaultValue { get; set; }
		...
		internal override Hashtable ToHashtable()
		{
			...
			if (NullFormatter != NullFormatter_DefaultValue) { h.Add("nullFormatter",NullFormatter); Highcharts.AddFunction("PlotOptionsAreasplineTooltipNullFormatter.nullFormatter", NullFormatter); }  
			if (Outside != Outside_DefaultValue) h.Add("outside",Outside);
			if (Padding != Padding_DefaultValue) h.Add("padding",Padding);
			if (PointFormat != PointFormat_DefaultValue) h.Add("pointFormat",PointFormat);
			if (PointFormatter != PointFormatter_DefaultValue) { h.Add("pointFormatter",PointFormatter); Highcharts.AddFunction("PlotOptionsAreasplineTooltipPointFormatter.pointFormatter", PointFormatter); }  
