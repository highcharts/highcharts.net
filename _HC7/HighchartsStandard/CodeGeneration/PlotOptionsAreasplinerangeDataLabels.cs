...
{
	public partial class PlotOptionsAreasplinerangeDataLabels  : BaseObject
	{
		...
		/// </summary>
		public PlotOptionsAreasplinerangeDataLabelsAlign Align { get; set; }
		private PlotOptionsAreasplinerangeDataLabelsAlign Align_DefaultValue { get; set; }
		...
		/// </summary>
		public PlotOptionsAreasplinerangeDataLabelsFilter Filter { get; set; }
		private PlotOptionsAreasplinerangeDataLabelsFilter Filter_DefaultValue { get; set; }
		...
		/// </summary>
		public PlotOptionsAreasplinerangeDataLabelsOverflow Overflow { get; set; }
		private PlotOptionsAreasplinerangeDataLabelsOverflow Overflow_DefaultValue { get; set; }
		...
		/// </summary>
		public PlotOptionsAreasplinerangeDataLabelsPosition Position { get; set; }
		private PlotOptionsAreasplinerangeDataLabelsPosition Position_DefaultValue { get; set; }
		...
		/// </summary>
		public PlotOptionsAreasplinerangeDataLabelsTextPath TextPath { get; set; }
		private PlotOptionsAreasplinerangeDataLabelsTextPath TextPath_DefaultValue { get; set; }
		...
		/// </summary>
		public PlotOptionsAreasplinerangeDataLabelsVerticalAlign VerticalAlign { get; set; }
		private PlotOptionsAreasplinerangeDataLabelsVerticalAlign VerticalAlign_DefaultValue { get; set; }
		...
		internal override Hashtable ToHashtable(Highcharts highcharts)
		{
			...
			if (Align != PlotOptionsAreasplinerangeDataLabelsAlign.Null) h.Add("align", highcharts.FirstCharacterToLower(Align.ToString()));
			...
			if (Overflow != PlotOptionsAreasplinerangeDataLabelsOverflow.Null) h.Add("overflow", highcharts.FirstCharacterToLower(Overflow.ToString()));
			if (Padding != null) h.Add("padding",Padding);
			if (Position != PlotOptionsAreasplinerangeDataLabelsPosition.Null) h.Add("position", highcharts.FirstCharacterToLower(Position.ToString()));
			...
			if (VerticalAlign != PlotOptionsAreasplinerangeDataLabelsVerticalAlign.Null) h.Add("verticalAlign", highcharts.FirstCharacterToLower(VerticalAlign.ToString()));
			if (X != null) h.Add("x",X);
			if (Y != null) h.Add("y",Y);
