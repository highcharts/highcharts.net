...
{
	public partial class PlotOptionsAreasplinerangeLowMarker  : BaseObject
	{
		Hashtable h = new Hashtable();

		public PlotOptionsAreasplinerangeLowMarker()
		{
			...
			States = States_DefaultValue = new PlotOptionsAreasplinerangeLowMarkerStates();
		...
		/// </summary>
		public PlotOptionsAreasplinerangeLowMarkerStates States { get; set; }
		private PlotOptionsAreasplinerangeLowMarkerStates States_DefaultValue { get; set; }
