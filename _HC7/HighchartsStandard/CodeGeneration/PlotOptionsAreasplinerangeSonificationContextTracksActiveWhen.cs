...
{
	public partial class PlotOptionsAreasplinerangeSonificationContextTracksActiveWhen  : BaseObject
	{
		Hashtable h = new Hashtable();

		public PlotOptionsAreasplinerangeSonificationContextTracksActiveWhen()
		{
		}	
