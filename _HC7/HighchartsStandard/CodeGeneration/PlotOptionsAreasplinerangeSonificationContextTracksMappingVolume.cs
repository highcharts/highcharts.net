...
{
	public partial class PlotOptionsAreasplinerangeSonificationContextTracksMappingVolume  : BaseObject
	{
		Hashtable h = new Hashtable();

		public PlotOptionsAreasplinerangeSonificationContextTracksMappingVolume()
		{
			MapFunction = MapFunction_DefaultValue = PlotOptionsAreasplinerangeSonificationContextTracksMappingVolumeMapFunction.Linear;
			MapTo = MapTo_DefaultValue = "";
			Max = Max_DefaultValue = null;
			Min = Min_DefaultValue = null;
			Value = Value_DefaultValue = null;
			Within = Within_DefaultValue = PlotOptionsAreasplinerangeSonificationContextTracksMappingVolumeWithin.Chart;
		...
		/// </summary>
		public PlotOptionsAreasplinerangeSonificationContextTracksMappingVolumeMapFunction MapFunction { get; set; }
		private PlotOptionsAreasplinerangeSonificationContextTracksMappingVolumeMapFunction MapFunction_DefaultValue { get; set; }
		...
		/// </summary>
		public PlotOptionsAreasplinerangeSonificationContextTracksMappingVolumeWithin Within { get; set; }
		private PlotOptionsAreasplinerangeSonificationContextTracksMappingVolumeWithin Within_DefaultValue { get; set; }
