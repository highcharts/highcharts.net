...
{
	public partial class PlotOptionsAreasplinerangeSonificationDefaultSpeechOptionsMappingPitch  : BaseObject
	{
		Hashtable h = new Hashtable();

		public PlotOptionsAreasplinerangeSonificationDefaultSpeechOptionsMappingPitch()
		{
			MapFunction = MapFunction_DefaultValue = PlotOptionsAreasplinerangeSonificationDefaultSpeechOptionsMappingPitchMapFunction.Linear;
		...
		/// </summary>
		public PlotOptionsAreasplinerangeSonificationDefaultSpeechOptionsMappingPitchMapFunction MapFunction { get; set; }
		private PlotOptionsAreasplinerangeSonificationDefaultSpeechOptionsMappingPitchMapFunction MapFunction_DefaultValue { get; set; }
