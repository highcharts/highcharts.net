...
{
	public partial class PlotOptionsAreasplinerangeSonificationPointGrouping  : BaseObject
	{
		Hashtable h = new Hashtable();

		public PlotOptionsAreasplinerangeSonificationPointGrouping()
		{
		...
		/// </summary>
		public PlotOptionsAreasplinerangeSonificationPointGroupingAlgorithm Algorithm { get; set; }
		private PlotOptionsAreasplinerangeSonificationPointGroupingAlgorithm Algorithm_DefaultValue { get; set; }
		...
		internal override Hashtable ToHashtable(Highcharts highcharts)
		{
			...
			if (Algorithm != PlotOptionsAreasplinerangeSonificationPointGroupingAlgorithm.Null) h.Add("algorithm", highcharts.FirstCharacterToLower(Algorithm.ToString()));
