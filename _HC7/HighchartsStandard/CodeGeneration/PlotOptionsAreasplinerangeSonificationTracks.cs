...
{
	public partial class PlotOptionsAreasplinerangeSonificationTracks  : BaseObject
	{
		Hashtable h = new Hashtable();

		public PlotOptionsAreasplinerangeSonificationTracks()
		{
			ActiveWhen = ActiveWhen_DefaultValue = new PlotOptionsAreasplinerangeSonificationTracksActiveWhen();
			Instrument = Instrument_DefaultValue = null;
			InstrumentString = InstrumentString_DefaultValue = "null";
			Mapping = Mapping_DefaultValue = new PlotOptionsAreasplinerangeSonificationTracksMapping();
			MidiName = MidiName_DefaultValue = "";
			PointGrouping = PointGrouping_DefaultValue = new PlotOptionsAreasplinerangeSonificationTracksPointGrouping();
			RoundToMusicalNotes = RoundToMusicalNotes_DefaultValue = true;
			ShowPlayMarker = ShowPlayMarker_DefaultValue = true;
			Type = Type_DefaultValue = PlotOptionsAreasplinerangeSonificationTracksType.Instrument;
		...
		/// </summary>
		public PlotOptionsAreasplinerangeSonificationTracksActiveWhen ActiveWhen { get; set; }
		private PlotOptionsAreasplinerangeSonificationTracksActiveWhen ActiveWhen_DefaultValue { get; set; }
		...
		/// </summary>
		public PlotOptionsAreasplinerangeSonificationTracksMapping Mapping { get; set; }
		private PlotOptionsAreasplinerangeSonificationTracksMapping Mapping_DefaultValue { get; set; }
		...
		/// </summary>
		public PlotOptionsAreasplinerangeSonificationTracksPointGrouping PointGrouping { get; set; }
		private PlotOptionsAreasplinerangeSonificationTracksPointGrouping PointGrouping_DefaultValue { get; set; }
		...
		/// </summary>
		public PlotOptionsAreasplinerangeSonificationTracksType Type { get; set; }
		private PlotOptionsAreasplinerangeSonificationTracksType Type_DefaultValue { get; set; }
