...
{
	public partial class PlotOptionsAreasplinerangeSonificationTracksPointGrouping  : BaseObject
	{
		Hashtable h = new Hashtable();

		public PlotOptionsAreasplinerangeSonificationTracksPointGrouping()
		{
		...
		/// </summary>
		public PlotOptionsAreasplinerangeSonificationTracksPointGroupingAlgorithm Algorithm { get; set; }
		private PlotOptionsAreasplinerangeSonificationTracksPointGroupingAlgorithm Algorithm_DefaultValue { get; set; }
		...
		internal override Hashtable ToHashtable(Highcharts highcharts)
		{
			...
			if (Algorithm != PlotOptionsAreasplinerangeSonificationTracksPointGroupingAlgorithm.Null) h.Add("algorithm", highcharts.FirstCharacterToLower(Algorithm.ToString()));
