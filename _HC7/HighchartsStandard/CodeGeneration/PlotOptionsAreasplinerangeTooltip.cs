...
{
	public partial class PlotOptionsAreasplinerangeTooltip  : BaseObject
	{
		public PlotOptionsAreasplinerangeTooltip()
		{
			...
			HeaderShape = HeaderShape_DefaultValue = PlotOptionsAreasplinerangeTooltipHeaderShape.Callout;
		...
		/// </summary>
		public PlotOptionsAreasplinerangeTooltipHeaderShape HeaderShape { get; set; }
		private PlotOptionsAreasplinerangeTooltipHeaderShape HeaderShape_DefaultValue { get; set; }
		...
		internal override Hashtable ToHashtable()
		{
			...
			if (NullFormatter != NullFormatter_DefaultValue) { h.Add("nullFormatter",NullFormatter); Highcharts.AddFunction("PlotOptionsAreasplinerangeTooltipNullFormatter.nullFormatter", NullFormatter); }  
			if (Outside != Outside_DefaultValue) h.Add("outside",Outside);
			if (Padding != Padding_DefaultValue) h.Add("padding",Padding);
			if (PointFormat != PointFormat_DefaultValue) h.Add("pointFormat",PointFormat);
			if (PointFormatter != PointFormatter_DefaultValue) { h.Add("pointFormatter",PointFormatter); Highcharts.AddFunction("PlotOptionsAreasplinerangeTooltipPointFormatter.pointFormatter", PointFormatter); }  
