...
namespace Highsoft.Web.Mvc.Charts
{
	public partial class PlotOptionsBar  : BaseObject
	{
		...
		/// </summary>
		public PlotOptionsBarAccessibility Accessibility { get; set; }
		private PlotOptionsBarAccessibility Accessibility_DefaultValue { get; set; }
		...
		/// </summary>
		public PlotOptionsBarBoostBlending BoostBlending { get; set; }
		private PlotOptionsBarBoostBlending BoostBlending_DefaultValue { get; set; }
		...
		/// </summary>
		public PlotOptionsBarDashStyle DashStyle { get; set; }
		private PlotOptionsBarDashStyle DashStyle_DefaultValue { get; set; }
		...
		/// </summary>
		public PlotOptionsBarDataSorting DataSorting { get; set; }
		private PlotOptionsBarDataSorting DataSorting_DefaultValue { get; set; }
		...
		/// </summary>
		public PlotOptionsBarDragDrop DragDrop { get; set; }
		private PlotOptionsBarDragDrop DragDrop_DefaultValue { get; set; }
		...
		/// </summary>
		public PlotOptionsBarFindNearestPointBy FindNearestPointBy { get; set; }
		private PlotOptionsBarFindNearestPointBy FindNearestPointBy_DefaultValue { get; set; }
		...
		/// </summary>
		public PlotOptionsBarLegendSymbol LegendSymbol { get; set; }
		private PlotOptionsBarLegendSymbol LegendSymbol_DefaultValue { get; set; }
		...
		/// </summary>
		public PlotOptionsBarOnPoint OnPoint { get; set; }
		private PlotOptionsBarOnPoint OnPoint_DefaultValue { get; set; }
		...
		/// </summary>
		public PlotOptionsBarSonification Sonification { get; set; }
		private PlotOptionsBarSonification Sonification_DefaultValue { get; set; }
		...
		internal override Hashtable ToHashtable(Highcharts highcharts)
		{
			...
			if (BoostBlending != PlotOptionsBarBoostBlending.Null) h.Add("boostBlending", highcharts.FirstCharacterToLower(BoostBlending.ToString()));
			...
			if (Cursor != PlotOptionsBarCursor.Null) h.Add("cursor", highcharts.FirstCharacterToLower(Cursor.ToString()));
			if (Custom != null) h.Add("custom",Custom);
			if (DashStyle != PlotOptionsBarDashStyle.Null) h.Add("dashStyle", highcharts.FirstCharacterToLower(DashStyle.ToString()));
			...
			if (FindNearestPointBy != PlotOptionsBarFindNearestPointBy.Null) h.Add("findNearestPointBy", highcharts.FirstCharacterToLower(FindNearestPointBy.ToString()));
			...
			if (LegendSymbol != PlotOptionsBarLegendSymbol.Null) h.Add("legendSymbol", highcharts.FirstCharacterToLower(LegendSymbol.ToString()));
			...
			if (PointIntervalUnit != PlotOptionsBarPointIntervalUnit.Null) h.Add("pointIntervalUnit", highcharts.FirstCharacterToLower(PointIntervalUnit.ToString()));
			if (PointPadding != null) h.Add("pointPadding",PointPadding);
			if (PointPlacement != PlotOptionsBarPointPlacement.Null) h.Add("pointPlacement", highcharts.FirstCharacterToLower(PointPlacement.ToString()));
			...
			if (Stacking != PlotOptionsBarStacking.Null) h.Add("stacking", highcharts.FirstCharacterToLower(Stacking.ToString()));
