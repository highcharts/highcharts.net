...
{
	public partial class PlotOptionsBarDragDrop  : BaseObject
	{
		public PlotOptionsBarDragDrop()
		{
			DraggableX = DraggableX_DefaultValue = null;
			DraggableY = DraggableY_DefaultValue = null;
			DragHandle = DragHandle_DefaultValue = new PlotOptionsBarDragDropDragHandle();
			...
			GuideBox = GuideBox_DefaultValue = new PlotOptionsBarDragDropGuideBox();
		...
		/// </summary>
		public PlotOptionsBarDragDropDragHandle DragHandle { get; set; }
		private PlotOptionsBarDragDropDragHandle DragHandle_DefaultValue { get; set; }
		...
		/// </summary>
		public PlotOptionsBarDragDropGuideBox GuideBox { get; set; }
		private PlotOptionsBarDragDropGuideBox GuideBox_DefaultValue { get; set; }
