...
{
	public partial class PlotOptionsBarSonificationContextTracksMapping  : BaseObject
	{
		Hashtable h = new Hashtable();

		public PlotOptionsBarSonificationContextTracksMapping()
		{
			Frequency = Frequency_DefaultValue = new PlotOptionsBarSonificationContextTracksMappingFrequency();
			GapBetweenNotes = GapBetweenNotes_DefaultValue = new PlotOptionsBarSonificationContextTracksMappingGapBetweenNotes();
			Highpass = Highpass_DefaultValue = new PlotOptionsBarSonificationContextTracksMappingHighpass();
			Lowpass = Lowpass_DefaultValue = new PlotOptionsBarSonificationContextTracksMappingLowpass();
			NoteDuration = NoteDuration_DefaultValue = new PlotOptionsBarSonificationContextTracksMappingNoteDuration();
			Pan = Pan_DefaultValue = new PlotOptionsBarSonificationContextTracksMappingPan();
			Pitch = Pitch_DefaultValue = new PlotOptionsBarSonificationContextTracksMappingPitch();
			PitchString = PitchString_DefaultValue = "null";
			PitchNumber = PitchNumber_DefaultValue = null;
			PlayDelay = PlayDelay_DefaultValue = new PlotOptionsBarSonificationContextTracksMappingPlayDelay();
			Time = Time_DefaultValue = new PlotOptionsBarSonificationContextTracksMappingTime();
			TimeString = TimeString_DefaultValue = "null";
			TimeNumber = TimeNumber_DefaultValue = null;
			Tremolo = Tremolo_DefaultValue = new PlotOptionsBarSonificationContextTracksMappingTremolo();
			Volume = Volume_DefaultValue = new PlotOptionsBarSonificationContextTracksMappingVolume();
		...
		/// </summary>
		public PlotOptionsBarSonificationContextTracksMappingFrequency Frequency { get; set; }
		private PlotOptionsBarSonificationContextTracksMappingFrequency Frequency_DefaultValue { get; set; }
		...
		/// </summary>
		public PlotOptionsBarSonificationContextTracksMappingGapBetweenNotes GapBetweenNotes { get; set; }
		private PlotOptionsBarSonificationContextTracksMappingGapBetweenNotes GapBetweenNotes_DefaultValue { get; set; }
		...
		/// </summary>
		public PlotOptionsBarSonificationContextTracksMappingHighpass Highpass { get; set; }
		private PlotOptionsBarSonificationContextTracksMappingHighpass Highpass_DefaultValue { get; set; }
		...
		/// </summary>
		public PlotOptionsBarSonificationContextTracksMappingLowpass Lowpass { get; set; }
		private PlotOptionsBarSonificationContextTracksMappingLowpass Lowpass_DefaultValue { get; set; }
		...
		/// </summary>
		public PlotOptionsBarSonificationContextTracksMappingNoteDuration NoteDuration { get; set; }
		private PlotOptionsBarSonificationContextTracksMappingNoteDuration NoteDuration_DefaultValue { get; set; }
		...
		/// </summary>
		public PlotOptionsBarSonificationContextTracksMappingPan Pan { get; set; }
		private PlotOptionsBarSonificationContextTracksMappingPan Pan_DefaultValue { get; set; }
		...
		/// </summary>
		public PlotOptionsBarSonificationContextTracksMappingPitch Pitch { get; set; }
		private PlotOptionsBarSonificationContextTracksMappingPitch Pitch_DefaultValue { get; set; }
		...
		/// </summary>
		public PlotOptionsBarSonificationContextTracksMappingPlayDelay PlayDelay { get; set; }
		private PlotOptionsBarSonificationContextTracksMappingPlayDelay PlayDelay_DefaultValue { get; set; }
		...
		/// </summary>
		public PlotOptionsBarSonificationContextTracksMappingTime Time { get; set; }
		private PlotOptionsBarSonificationContextTracksMappingTime Time_DefaultValue { get; set; }
		...
		/// </summary>
		public PlotOptionsBarSonificationContextTracksMappingTremolo Tremolo { get; set; }
		private PlotOptionsBarSonificationContextTracksMappingTremolo Tremolo_DefaultValue { get; set; }
		 

		/// <summary>
		/// The volume of notes, from 0 to 1.
		/// </summary>
		public PlotOptionsBarSonificationContextTracksMappingVolume Volume { get; set; }
		private PlotOptionsBarSonificationContextTracksMappingVolume Volume_DefaultValue { get; set; }
