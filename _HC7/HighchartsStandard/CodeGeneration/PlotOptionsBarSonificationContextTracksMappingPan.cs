...
{
	public partial class PlotOptionsBarSonificationContextTracksMappingPan  : BaseObject
	{
		Hashtable h = new Hashtable();

		public PlotOptionsBarSonificationContextTracksMappingPan()
		{
			MapFunction = MapFunction_DefaultValue = PlotOptionsBarSonificationContextTracksMappingPanMapFunction.Linear;
			MapTo = MapTo_DefaultValue = "";
			Max = Max_DefaultValue = null;
			Min = Min_DefaultValue = null;
			Value = Value_DefaultValue = null;
			Within = Within_DefaultValue = PlotOptionsBarSonificationContextTracksMappingPanWithin.Chart;
		...
		/// </summary>
		public PlotOptionsBarSonificationContextTracksMappingPanMapFunction MapFunction { get; set; }
		private PlotOptionsBarSonificationContextTracksMappingPanMapFunction MapFunction_DefaultValue { get; set; }
		...
		/// </summary>
		public PlotOptionsBarSonificationContextTracksMappingPanWithin Within { get; set; }
		private PlotOptionsBarSonificationContextTracksMappingPanWithin Within_DefaultValue { get; set; }
