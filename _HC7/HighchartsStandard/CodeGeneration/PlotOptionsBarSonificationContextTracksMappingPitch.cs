...
{
	public partial class PlotOptionsBarSonificationContextTracksMappingPitch  : BaseObject
	{
		Hashtable h = new Hashtable();

		public PlotOptionsBarSonificationContextTracksMappingPitch()
		{
			MapFunction = MapFunction_DefaultValue = PlotOptionsBarSonificationContextTracksMappingPitchMapFunction.Linear;
		...
		/// </summary>
		public PlotOptionsBarSonificationContextTracksMappingPitchMapFunction MapFunction { get; set; }
		private PlotOptionsBarSonificationContextTracksMappingPitchMapFunction MapFunction_DefaultValue { get; set; }
