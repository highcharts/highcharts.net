...
namespace Highsoft.Web.Mvc.Charts
{
	public partial class PlotOptionsBarSonificationDefaultSpeechOptionsMapping  : BaseObject
	{
		...
		public PlotOptionsBarSonificationDefaultSpeechOptionsMapping()
		{
			...
			Time = Time_DefaultValue = new PlotOptionsBarSonificationDefaultSpeechOptionsMappingTime();
		...
		/// </summary>
		public PlotOptionsBarSonificationDefaultSpeechOptionsMappingTime Time { get; set; }
		private PlotOptionsBarSonificationDefaultSpeechOptionsMappingTime Time_DefaultValue { get; set; }
