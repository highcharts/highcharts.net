...
{
	public partial class PlotOptionsBarSonificationPointGrouping  : BaseObject
	{
		Hashtable h = new Hashtable();

		public PlotOptionsBarSonificationPointGrouping()
		{
		...
		/// </summary>
		public PlotOptionsBarSonificationPointGroupingAlgorithm Algorithm { get; set; }
		private PlotOptionsBarSonificationPointGroupingAlgorithm Algorithm_DefaultValue { get; set; }
		...
		internal override Hashtable ToHashtable(Highcharts highcharts)
		{
			...
			if (Algorithm != PlotOptionsBarSonificationPointGroupingAlgorithm.Null) h.Add("algorithm", highcharts.FirstCharacterToLower(Algorithm.ToString()));
