...
{
	public partial class PlotOptionsBarSonificationTracks  : BaseObject
	{
		Hashtable h = new Hashtable();

		public PlotOptionsBarSonificationTracks()
		{
			ActiveWhen = ActiveWhen_DefaultValue = new PlotOptionsBarSonificationTracksActiveWhen();
			Instrument = Instrument_DefaultValue = null;
			InstrumentString = InstrumentString_DefaultValue = "null";
			Mapping = Mapping_DefaultValue = new PlotOptionsBarSonificationTracksMapping();
			MidiName = MidiName_DefaultValue = "";
			PointGrouping = PointGrouping_DefaultValue = new PlotOptionsBarSonificationTracksPointGrouping();
			RoundToMusicalNotes = RoundToMusicalNotes_DefaultValue = true;
			ShowPlayMarker = ShowPlayMarker_DefaultValue = true;
			Type = Type_DefaultValue = PlotOptionsBarSonificationTracksType.Instrument;
		...
		/// </summary>
		public PlotOptionsBarSonificationTracksActiveWhen ActiveWhen { get; set; }
		private PlotOptionsBarSonificationTracksActiveWhen ActiveWhen_DefaultValue { get; set; }
		...
		/// </summary>
		public PlotOptionsBarSonificationTracksMapping Mapping { get; set; }
		private PlotOptionsBarSonificationTracksMapping Mapping_DefaultValue { get; set; }
		...
		/// </summary>
		public PlotOptionsBarSonificationTracksPointGrouping PointGrouping { get; set; }
		private PlotOptionsBarSonificationTracksPointGrouping PointGrouping_DefaultValue { get; set; }
		...
		/// </summary>
		public PlotOptionsBarSonificationTracksType Type { get; set; }
		private PlotOptionsBarSonificationTracksType Type_DefaultValue { get; set; }
