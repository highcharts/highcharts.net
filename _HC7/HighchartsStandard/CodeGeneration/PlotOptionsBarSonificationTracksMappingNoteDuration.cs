...
{
	public partial class PlotOptionsBarSonificationTracksMappingNoteDuration  : BaseObject
	{
		Hashtable h = new Hashtable();

		public PlotOptionsBarSonificationTracksMappingNoteDuration()
		{
			MapFunction = MapFunction_DefaultValue = PlotOptionsBarSonificationTracksMappingNoteDurationMapFunction.Linear;
			MapTo = MapTo_DefaultValue = "";
			Max = Max_DefaultValue = null;
			Min = Min_DefaultValue = null;
			Value = Value_DefaultValue = null;
			Within = Within_DefaultValue = PlotOptionsBarSonificationTracksMappingNoteDurationWithin.Chart;
		...
		/// </summary>
		public PlotOptionsBarSonificationTracksMappingNoteDurationMapFunction MapFunction { get; set; }
		private PlotOptionsBarSonificationTracksMappingNoteDurationMapFunction MapFunction_DefaultValue { get; set; }
		...
		/// </summary>
		public PlotOptionsBarSonificationTracksMappingNoteDurationWithin Within { get; set; }
		private PlotOptionsBarSonificationTracksMappingNoteDurationWithin Within_DefaultValue { get; set; }
