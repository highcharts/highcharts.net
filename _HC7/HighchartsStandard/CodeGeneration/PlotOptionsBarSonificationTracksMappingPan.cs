...
{
	public partial class PlotOptionsBarSonificationTracksMappingPan  : BaseObject
	{
		Hashtable h = new Hashtable();

		public PlotOptionsBarSonificationTracksMappingPan()
		{
			MapFunction = MapFunction_DefaultValue = PlotOptionsBarSonificationTracksMappingPanMapFunction.Linear;
			MapTo = MapTo_DefaultValue = "";
			Max = Max_DefaultValue = null;
			Min = Min_DefaultValue = null;
			Value = Value_DefaultValue = null;
			Within = Within_DefaultValue = PlotOptionsBarSonificationTracksMappingPanWithin.Chart;
		...
		/// </summary>
		public PlotOptionsBarSonificationTracksMappingPanMapFunction MapFunction { get; set; }
		private PlotOptionsBarSonificationTracksMappingPanMapFunction MapFunction_DefaultValue { get; set; }
		...
		/// </summary>
		public PlotOptionsBarSonificationTracksMappingPanWithin Within { get; set; }
		private PlotOptionsBarSonificationTracksMappingPanWithin Within_DefaultValue { get; set; }
