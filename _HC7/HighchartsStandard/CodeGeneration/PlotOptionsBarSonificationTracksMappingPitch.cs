...
{
	public partial class PlotOptionsBarSonificationTracksMappingPitch  : BaseObject
	{
		Hashtable h = new Hashtable();

		public PlotOptionsBarSonificationTracksMappingPitch()
		{
			MapFunction = MapFunction_DefaultValue = PlotOptionsBarSonificationTracksMappingPitchMapFunction.Linear;
		...
		/// </summary>
		public PlotOptionsBarSonificationTracksMappingPitchMapFunction MapFunction { get; set; }
		private PlotOptionsBarSonificationTracksMappingPitchMapFunction MapFunction_DefaultValue { get; set; }
