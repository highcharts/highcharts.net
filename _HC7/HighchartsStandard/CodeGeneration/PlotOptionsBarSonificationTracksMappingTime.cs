...
{
	public partial class PlotOptionsBarSonificationTracksMappingTime  : BaseObject
	{
		Hashtable h = new Hashtable();

		public PlotOptionsBarSonificationTracksMappingTime()
		{
			MapFunction = MapFunction_DefaultValue = PlotOptionsBarSonificationTracksMappingTimeMapFunction.Linear;
			MapTo = MapTo_DefaultValue = "";
			Max = Max_DefaultValue = null;
			Min = Min_DefaultValue = null;
			Value = Value_DefaultValue = null;
			Within = Within_DefaultValue = PlotOptionsBarSonificationTracksMappingTimeWithin.Chart;
		...
		/// </summary>
		public PlotOptionsBarSonificationTracksMappingTimeMapFunction MapFunction { get; set; }
		private PlotOptionsBarSonificationTracksMappingTimeMapFunction MapFunction_DefaultValue { get; set; }
		...
		/// </summary>
		public PlotOptionsBarSonificationTracksMappingTimeWithin Within { get; set; }
		private PlotOptionsBarSonificationTracksMappingTimeWithin Within_DefaultValue { get; set; }
