...
{
	public partial class PlotOptionsBarSonificationTracksMappingVolume  : BaseObject
	{
		Hashtable h = new Hashtable();

		public PlotOptionsBarSonificationTracksMappingVolume()
		{
			MapFunction = MapFunction_DefaultValue = PlotOptionsBarSonificationTracksMappingVolumeMapFunction.Linear;
			MapTo = MapTo_DefaultValue = "";
			Max = Max_DefaultValue = null;
			Min = Min_DefaultValue = null;
			Value = Value_DefaultValue = null;
			Within = Within_DefaultValue = PlotOptionsBarSonificationTracksMappingVolumeWithin.Chart;
		...
		/// </summary>
		public PlotOptionsBarSonificationTracksMappingVolumeMapFunction MapFunction { get; set; }
		private PlotOptionsBarSonificationTracksMappingVolumeMapFunction MapFunction_DefaultValue { get; set; }
		...
		/// </summary>
		public PlotOptionsBarSonificationTracksMappingVolumeWithin Within { get; set; }
		private PlotOptionsBarSonificationTracksMappingVolumeWithin Within_DefaultValue { get; set; }
