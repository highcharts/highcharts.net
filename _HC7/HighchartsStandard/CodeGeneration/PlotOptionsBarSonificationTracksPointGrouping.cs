...
{
	public partial class PlotOptionsBarSonificationTracksPointGrouping  : BaseObject
	{
		Hashtable h = new Hashtable();

		public PlotOptionsBarSonificationTracksPointGrouping()
		{
		...
		/// </summary>
		public PlotOptionsBarSonificationTracksPointGroupingAlgorithm Algorithm { get; set; }
		private PlotOptionsBarSonificationTracksPointGroupingAlgorithm Algorithm_DefaultValue { get; set; }
		...
		internal override Hashtable ToHashtable(Highcharts highcharts)
		{
			...
			if (Algorithm != PlotOptionsBarSonificationTracksPointGroupingAlgorithm.Null) h.Add("algorithm", highcharts.FirstCharacterToLower(Algorithm.ToString()));
