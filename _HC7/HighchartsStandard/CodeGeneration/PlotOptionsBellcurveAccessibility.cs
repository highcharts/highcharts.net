...
namespace Highsoft.Web.Mvc.Charts
{
	public partial class PlotOptionsBellcurveAccessibility  : BaseObject
	{
		...
		internal override Hashtable ToHashtable()
		{
			...
			if (PointDescriptionFormatter != PointDescriptionFormatter_DefaultValue) { h.Add("pointDescriptionFormatter",PointDescriptionFormatter); Highcharts.AddFunction("25f84aa2-1f98-4c2a-bd0c-47955154df36.pointDescriptionFormatter", PointDescriptionFormatter); }  
