...
namespace Highsoft.Web.Mvc.Charts
{
	public partial class PlotOptionsBellcurveAccessibility  : BaseObject
	{
		public PlotOptionsBellcurveAccessibility()
		{
			...
			KeyboardNavigation = KeyboardNavigation_DefaultValue = new PlotOptionsBellcurveAccessibilityKeyboardNavigation();
		...
		private PlotOptionsBellcurveAccessibilityKeyboardNavigation KeyboardNavigation_DefaultValue { get; set; }
		...
		internal override Hashtable ToHashtable()
		{
			...
			if (PointDescriptionFormatter != PointDescriptionFormatter_DefaultValue) { h.Add("pointDescriptionFormatter",PointDescriptionFormatter); Highcharts.AddFunction("PlotOptionsBellcurveAccessibilityPointDescriptionFormatter.pointDescriptionFormatter", PointDescriptionFormatter); }  
