...
{
	public partial class PlotOptionsBellcurveDragDrop  : BaseObject
	{
		public PlotOptionsBellcurveDragDrop()
		{
			DraggableX = DraggableX_DefaultValue = null;
			DraggableY = DraggableY_DefaultValue = null;
			DragHandle = DragHandle_DefaultValue = new PlotOptionsBellcurveDragDropDragHandle();
			...
			GuideBox = GuideBox_DefaultValue = new PlotOptionsBellcurveDragDropGuideBox();
		...
		/// </summary>
		public PlotOptionsBellcurveDragDropDragHandle DragHandle { get; set; }
		private PlotOptionsBellcurveDragDropDragHandle DragHandle_DefaultValue { get; set; }
		...
		/// </summary>
		public PlotOptionsBellcurveDragDropGuideBox GuideBox { get; set; }
		private PlotOptionsBellcurveDragDropGuideBox GuideBox_DefaultValue { get; set; }
