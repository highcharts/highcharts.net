...
namespace Highsoft.Web.Mvc.Charts
{
	public partial class PlotOptionsBellcurveDragDropDragHandle  : BaseObject
	{
		...
		internal override Hashtable ToHashtable()
		{
			...
			if (PathFormatter != PathFormatter_DefaultValue) { h.Add("pathFormatter",PathFormatter); Highcharts.AddFunction("f7df0502-037e-4265-9f1c-2ad010a567ff.pathFormatter", PathFormatter); }  
