...
{
	public partial class PlotOptionsBellcurveMarkerStates  : BaseObject
	{
		public PlotOptionsBellcurveMarkerStates()
		{
			Hover = Hover_DefaultValue = new PlotOptionsBellcurveMarkerStatesHover();
			Inactive = Inactive_DefaultValue = new PlotOptionsBellcurveMarkerStatesInactive();
		...
		/// 
		/// </summary>
		public PlotOptionsBellcurveMarkerStatesInactive Inactive { get; set; }
		private PlotOptionsBellcurveMarkerStatesInactive Inactive_DefaultValue { get; set; }
		...
		/// </summary>
		public PlotOptionsBellcurveMarkerStatesSelect Select { get; set; }
		private PlotOptionsBellcurveMarkerStatesSelect Select_DefaultValue { get; set; }
