...
{
	public partial class PlotOptionsBellcurveSonificationContextTracksMapping  : BaseObject
	{
		Hashtable h = new Hashtable();

		public PlotOptionsBellcurveSonificationContextTracksMapping()
		{
			Frequency = Frequency_DefaultValue = new PlotOptionsBellcurveSonificationContextTracksMappingFrequency();
			GapBetweenNotes = GapBetweenNotes_DefaultValue = new PlotOptionsBellcurveSonificationContextTracksMappingGapBetweenNotes();
			Highpass = Highpass_DefaultValue = new PlotOptionsBellcurveSonificationContextTracksMappingHighpass();
			Lowpass = Lowpass_DefaultValue = new PlotOptionsBellcurveSonificationContextTracksMappingLowpass();
			NoteDuration = NoteDuration_DefaultValue = new PlotOptionsBellcurveSonificationContextTracksMappingNoteDuration();
			Pan = Pan_DefaultValue = new PlotOptionsBellcurveSonificationContextTracksMappingPan();
			Pitch = Pitch_DefaultValue = new PlotOptionsBellcurveSonificationContextTracksMappingPitch();
			PitchString = PitchString_DefaultValue = "null";
			PitchNumber = PitchNumber_DefaultValue = null;
			PlayDelay = PlayDelay_DefaultValue = new PlotOptionsBellcurveSonificationContextTracksMappingPlayDelay();
			Time = Time_DefaultValue = new PlotOptionsBellcurveSonificationContextTracksMappingTime();
			TimeString = TimeString_DefaultValue = "null";
			TimeNumber = TimeNumber_DefaultValue = null;
			Tremolo = Tremolo_DefaultValue = new PlotOptionsBellcurveSonificationContextTracksMappingTremolo();
			Volume = Volume_DefaultValue = new PlotOptionsBellcurveSonificationContextTracksMappingVolume();
		...
		/// </summary>
		public PlotOptionsBellcurveSonificationContextTracksMappingFrequency Frequency { get; set; }
		private PlotOptionsBellcurveSonificationContextTracksMappingFrequency Frequency_DefaultValue { get; set; }
		...
		/// </summary>
		public PlotOptionsBellcurveSonificationContextTracksMappingGapBetweenNotes GapBetweenNotes { get; set; }
		private PlotOptionsBellcurveSonificationContextTracksMappingGapBetweenNotes GapBetweenNotes_DefaultValue { get; set; }
		...
		/// </summary>
		public PlotOptionsBellcurveSonificationContextTracksMappingHighpass Highpass { get; set; }
		private PlotOptionsBellcurveSonificationContextTracksMappingHighpass Highpass_DefaultValue { get; set; }
		...
		/// </summary>
		public PlotOptionsBellcurveSonificationContextTracksMappingLowpass Lowpass { get; set; }
		private PlotOptionsBellcurveSonificationContextTracksMappingLowpass Lowpass_DefaultValue { get; set; }
		...
		/// </summary>
		public PlotOptionsBellcurveSonificationContextTracksMappingNoteDuration NoteDuration { get; set; }
		private PlotOptionsBellcurveSonificationContextTracksMappingNoteDuration NoteDuration_DefaultValue { get; set; }
		...
		/// </summary>
		public PlotOptionsBellcurveSonificationContextTracksMappingPan Pan { get; set; }
		private PlotOptionsBellcurveSonificationContextTracksMappingPan Pan_DefaultValue { get; set; }
		...
		/// </summary>
		public PlotOptionsBellcurveSonificationContextTracksMappingPitch Pitch { get; set; }
		private PlotOptionsBellcurveSonificationContextTracksMappingPitch Pitch_DefaultValue { get; set; }
		...
		/// </summary>
		public PlotOptionsBellcurveSonificationContextTracksMappingPlayDelay PlayDelay { get; set; }
		private PlotOptionsBellcurveSonificationContextTracksMappingPlayDelay PlayDelay_DefaultValue { get; set; }
		...
		/// </summary>
		public PlotOptionsBellcurveSonificationContextTracksMappingTime Time { get; set; }
		private PlotOptionsBellcurveSonificationContextTracksMappingTime Time_DefaultValue { get; set; }
		...
		/// </summary>
		public PlotOptionsBellcurveSonificationContextTracksMappingTremolo Tremolo { get; set; }
		private PlotOptionsBellcurveSonificationContextTracksMappingTremolo Tremolo_DefaultValue { get; set; }
		 

		/// <summary>
		/// The volume of notes, from 0 to 1.
		/// </summary>
		public PlotOptionsBellcurveSonificationContextTracksMappingVolume Volume { get; set; }
		private PlotOptionsBellcurveSonificationContextTracksMappingVolume Volume_DefaultValue { get; set; }
