...
{
	public partial class PlotOptionsBellcurveSonificationContextTracksMappingFrequency  : BaseObject
	{
		Hashtable h = new Hashtable();

		public PlotOptionsBellcurveSonificationContextTracksMappingFrequency()
		{
			MapFunction = MapFunction_DefaultValue = PlotOptionsBellcurveSonificationContextTracksMappingFrequencyMapFunction.Linear;
			MapTo = MapTo_DefaultValue = "";
			Max = Max_DefaultValue = null;
			Min = Min_DefaultValue = null;
			Value = Value_DefaultValue = null;
			Within = Within_DefaultValue = PlotOptionsBellcurveSonificationContextTracksMappingFrequencyWithin.Chart;
		...
		/// </summary>
		public PlotOptionsBellcurveSonificationContextTracksMappingFrequencyMapFunction MapFunction { get; set; }
		private PlotOptionsBellcurveSonificationContextTracksMappingFrequencyMapFunction MapFunction_DefaultValue { get; set; }
		...
		/// </summary>
		public PlotOptionsBellcurveSonificationContextTracksMappingFrequencyWithin Within { get; set; }
		private PlotOptionsBellcurveSonificationContextTracksMappingFrequencyWithin Within_DefaultValue { get; set; }
