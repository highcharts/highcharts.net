...
{
	public partial class PlotOptionsBellcurveSonificationContextTracksMappingPitch  : BaseObject
	{
		Hashtable h = new Hashtable();

		public PlotOptionsBellcurveSonificationContextTracksMappingPitch()
		{
			MapFunction = MapFunction_DefaultValue = PlotOptionsBellcurveSonificationContextTracksMappingPitchMapFunction.Linear;
		...
		/// </summary>
		public PlotOptionsBellcurveSonificationContextTracksMappingPitchMapFunction MapFunction { get; set; }
		private PlotOptionsBellcurveSonificationContextTracksMappingPitchMapFunction MapFunction_DefaultValue { get; set; }
