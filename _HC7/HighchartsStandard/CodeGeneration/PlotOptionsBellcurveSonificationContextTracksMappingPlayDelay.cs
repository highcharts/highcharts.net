...
{
	public partial class PlotOptionsBellcurveSonificationContextTracksMappingPlayDelay  : BaseObject
	{
		Hashtable h = new Hashtable();

		public PlotOptionsBellcurveSonificationContextTracksMappingPlayDelay()
		{
			MapFunction = MapFunction_DefaultValue = PlotOptionsBellcurveSonificationContextTracksMappingPlayDelayMapFunction.Linear;
			MapTo = MapTo_DefaultValue = "";
			Max = Max_DefaultValue = null;
			Min = Min_DefaultValue = null;
			Value = Value_DefaultValue = null;
			Within = Within_DefaultValue = PlotOptionsBellcurveSonificationContextTracksMappingPlayDelayWithin.Chart;
		...
		/// </summary>
		public PlotOptionsBellcurveSonificationContextTracksMappingPlayDelayMapFunction MapFunction { get; set; }
		private PlotOptionsBellcurveSonificationContextTracksMappingPlayDelayMapFunction MapFunction_DefaultValue { get; set; }
		...
		/// </summary>
		public PlotOptionsBellcurveSonificationContextTracksMappingPlayDelayWithin Within { get; set; }
		private PlotOptionsBellcurveSonificationContextTracksMappingPlayDelayWithin Within_DefaultValue { get; set; }
