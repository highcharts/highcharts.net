...
{
	public partial class PlotOptionsBellcurveSonificationDefaultInstrumentOptionsMapping  : BaseObject
	{
		Hashtable h = new Hashtable();

		public PlotOptionsBellcurveSonificationDefaultInstrumentOptionsMapping()
		{
			Frequency = Frequency_DefaultValue = new PlotOptionsBellcurveSonificationDefaultInstrumentOptionsMappingFrequency();
			GapBetweenNotes = GapBetweenNotes_DefaultValue = new PlotOptionsBellcurveSonificationDefaultInstrumentOptionsMappingGapBetweenNotes();
			Highpass = Highpass_DefaultValue = new PlotOptionsBellcurveSonificationDefaultInstrumentOptionsMappingHighpass();
			Lowpass = Lowpass_DefaultValue = new PlotOptionsBellcurveSonificationDefaultInstrumentOptionsMappingLowpass();
			NoteDuration = NoteDuration_DefaultValue = new PlotOptionsBellcurveSonificationDefaultInstrumentOptionsMappingNoteDuration();
			Pan = Pan_DefaultValue = new PlotOptionsBellcurveSonificationDefaultInstrumentOptionsMappingPan();
			Pitch = Pitch_DefaultValue = new PlotOptionsBellcurveSonificationDefaultInstrumentOptionsMappingPitch();
			PitchString = PitchString_DefaultValue = "null";
			PitchNumber = PitchNumber_DefaultValue = null;
			PlayDelay = PlayDelay_DefaultValue = new PlotOptionsBellcurveSonificationDefaultInstrumentOptionsMappingPlayDelay();
			Time = Time_DefaultValue = new PlotOptionsBellcurveSonificationDefaultInstrumentOptionsMappingTime();
			TimeString = TimeString_DefaultValue = "null";
			TimeNumber = TimeNumber_DefaultValue = null;
			Tremolo = Tremolo_DefaultValue = new PlotOptionsBellcurveSonificationDefaultInstrumentOptionsMappingTremolo();
			Volume = Volume_DefaultValue = new PlotOptionsBellcurveSonificationDefaultInstrumentOptionsMappingVolume();
		...
		/// </summary>
		public PlotOptionsBellcurveSonificationDefaultInstrumentOptionsMappingFrequency Frequency { get; set; }
		private PlotOptionsBellcurveSonificationDefaultInstrumentOptionsMappingFrequency Frequency_DefaultValue { get; set; }
		...
		/// </summary>
		public PlotOptionsBellcurveSonificationDefaultInstrumentOptionsMappingGapBetweenNotes GapBetweenNotes { get; set; }
		private PlotOptionsBellcurveSonificationDefaultInstrumentOptionsMappingGapBetweenNotes GapBetweenNotes_DefaultValue { get; set; }
		...
		/// </summary>
		public PlotOptionsBellcurveSonificationDefaultInstrumentOptionsMappingHighpass Highpass { get; set; }
		private PlotOptionsBellcurveSonificationDefaultInstrumentOptionsMappingHighpass Highpass_DefaultValue { get; set; }
		...
		/// </summary>
		public PlotOptionsBellcurveSonificationDefaultInstrumentOptionsMappingLowpass Lowpass { get; set; }
		private PlotOptionsBellcurveSonificationDefaultInstrumentOptionsMappingLowpass Lowpass_DefaultValue { get; set; }
		...
		/// </summary>
		public PlotOptionsBellcurveSonificationDefaultInstrumentOptionsMappingNoteDuration NoteDuration { get; set; }
		private PlotOptionsBellcurveSonificationDefaultInstrumentOptionsMappingNoteDuration NoteDuration_DefaultValue { get; set; }
		...
		/// </summary>
		public PlotOptionsBellcurveSonificationDefaultInstrumentOptionsMappingPan Pan { get; set; }
		private PlotOptionsBellcurveSonificationDefaultInstrumentOptionsMappingPan Pan_DefaultValue { get; set; }
		...
		/// </summary>
		public PlotOptionsBellcurveSonificationDefaultInstrumentOptionsMappingPitch Pitch { get; set; }
		private PlotOptionsBellcurveSonificationDefaultInstrumentOptionsMappingPitch Pitch_DefaultValue { get; set; }
		...
		/// </summary>
		public PlotOptionsBellcurveSonificationDefaultInstrumentOptionsMappingPlayDelay PlayDelay { get; set; }
		private PlotOptionsBellcurveSonificationDefaultInstrumentOptionsMappingPlayDelay PlayDelay_DefaultValue { get; set; }
		...
		/// </summary>
		public PlotOptionsBellcurveSonificationDefaultInstrumentOptionsMappingTime Time { get; set; }
		private PlotOptionsBellcurveSonificationDefaultInstrumentOptionsMappingTime Time_DefaultValue { get; set; }
		...
		/// </summary>
		public PlotOptionsBellcurveSonificationDefaultInstrumentOptionsMappingTremolo Tremolo { get; set; }
		private PlotOptionsBellcurveSonificationDefaultInstrumentOptionsMappingTremolo Tremolo_DefaultValue { get; set; }
		 

		/// <summary>
		/// The volume of notes, from 0 to 1.
		/// </summary>
		public PlotOptionsBellcurveSonificationDefaultInstrumentOptionsMappingVolume Volume { get; set; }
		private PlotOptionsBellcurveSonificationDefaultInstrumentOptionsMappingVolume Volume_DefaultValue { get; set; }
