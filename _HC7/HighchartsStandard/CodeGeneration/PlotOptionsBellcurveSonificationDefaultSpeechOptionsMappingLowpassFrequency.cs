...
{
	public partial class PlotOptionsBellcurveSonificationDefaultSpeechOptionsMappingLowpassFrequency  : BaseObject
	{
		Hashtable h = new Hashtable();

		public PlotOptionsBellcurveSonificationDefaultSpeechOptionsMappingLowpassFrequency()
		{
			MapFunction = MapFunction_DefaultValue = PlotOptionsBellcurveSonificationDefaultSpeechOptionsMappingLowpassFrequencyMapFunction.Linear;
			MapTo = MapTo_DefaultValue = "";
			Max = Max_DefaultValue = null;
			Min = Min_DefaultValue = null;
			Value = Value_DefaultValue = null;
			Within = Within_DefaultValue = PlotOptionsBellcurveSonificationDefaultSpeechOptionsMappingLowpassFrequencyWithin.Chart;
		...
		/// </summary>
		public PlotOptionsBellcurveSonificationDefaultSpeechOptionsMappingLowpassFrequencyMapFunction MapFunction { get; set; }
		private PlotOptionsBellcurveSonificationDefaultSpeechOptionsMappingLowpassFrequencyMapFunction MapFunction_DefaultValue { get; set; }
		...
		/// </summary>
		public PlotOptionsBellcurveSonificationDefaultSpeechOptionsMappingLowpassFrequencyWithin Within { get; set; }
		private PlotOptionsBellcurveSonificationDefaultSpeechOptionsMappingLowpassFrequencyWithin Within_DefaultValue { get; set; }
