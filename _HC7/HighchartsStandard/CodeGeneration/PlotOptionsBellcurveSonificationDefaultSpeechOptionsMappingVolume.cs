...
{
	public partial class PlotOptionsBellcurveSonificationDefaultSpeechOptionsMappingVolume  : BaseObject
	{
		Hashtable h = new Hashtable();

		public PlotOptionsBellcurveSonificationDefaultSpeechOptionsMappingVolume()
		{
			MapFunction = MapFunction_DefaultValue = PlotOptionsBellcurveSonificationDefaultSpeechOptionsMappingVolumeMapFunction.Linear;
			MapTo = MapTo_DefaultValue = "";
			Max = Max_DefaultValue = null;
			Min = Min_DefaultValue = null;
			Value = Value_DefaultValue = null;
			Within = Within_DefaultValue = PlotOptionsBellcurveSonificationDefaultSpeechOptionsMappingVolumeWithin.Chart;
		...
		/// </summary>
		public PlotOptionsBellcurveSonificationDefaultSpeechOptionsMappingVolumeMapFunction MapFunction { get; set; }
		private PlotOptionsBellcurveSonificationDefaultSpeechOptionsMappingVolumeMapFunction MapFunction_DefaultValue { get; set; }
		...
		/// </summary>
		public PlotOptionsBellcurveSonificationDefaultSpeechOptionsMappingVolumeWithin Within { get; set; }
		private PlotOptionsBellcurveSonificationDefaultSpeechOptionsMappingVolumeWithin Within_DefaultValue { get; set; }
