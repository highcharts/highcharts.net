...
{
	public partial class PlotOptionsBellcurveSonificationPointGrouping  : BaseObject
	{
		Hashtable h = new Hashtable();

		public PlotOptionsBellcurveSonificationPointGrouping()
		{
		...
		/// </summary>
		public PlotOptionsBellcurveSonificationPointGroupingAlgorithm Algorithm { get; set; }
		private PlotOptionsBellcurveSonificationPointGroupingAlgorithm Algorithm_DefaultValue { get; set; }
		...
		internal override Hashtable ToHashtable(Highcharts highcharts)
		{
			...
			if (Algorithm != PlotOptionsBellcurveSonificationPointGroupingAlgorithm.Null) h.Add("algorithm", highcharts.FirstCharacterToLower(Algorithm.ToString()));
