...
{
	public partial class PlotOptionsBellcurveSonificationTracks  : BaseObject
	{
		Hashtable h = new Hashtable();

		public PlotOptionsBellcurveSonificationTracks()
		{
			ActiveWhen = ActiveWhen_DefaultValue = new PlotOptionsBellcurveSonificationTracksActiveWhen();
			Instrument = Instrument_DefaultValue = null;
			InstrumentString = InstrumentString_DefaultValue = "null";
			Mapping = Mapping_DefaultValue = new PlotOptionsBellcurveSonificationTracksMapping();
			MidiName = MidiName_DefaultValue = "";
			PointGrouping = PointGrouping_DefaultValue = new PlotOptionsBellcurveSonificationTracksPointGrouping();
			RoundToMusicalNotes = RoundToMusicalNotes_DefaultValue = true;
			ShowPlayMarker = ShowPlayMarker_DefaultValue = true;
			Type = Type_DefaultValue = PlotOptionsBellcurveSonificationTracksType.Instrument;
		...
		/// </summary>
		public PlotOptionsBellcurveSonificationTracksActiveWhen ActiveWhen { get; set; }
		private PlotOptionsBellcurveSonificationTracksActiveWhen ActiveWhen_DefaultValue { get; set; }
		...
		/// </summary>
		public PlotOptionsBellcurveSonificationTracksMapping Mapping { get; set; }
		private PlotOptionsBellcurveSonificationTracksMapping Mapping_DefaultValue { get; set; }
		...
		/// </summary>
		public PlotOptionsBellcurveSonificationTracksPointGrouping PointGrouping { get; set; }
		private PlotOptionsBellcurveSonificationTracksPointGrouping PointGrouping_DefaultValue { get; set; }
		...
		/// </summary>
		public PlotOptionsBellcurveSonificationTracksType Type { get; set; }
		private PlotOptionsBellcurveSonificationTracksType Type_DefaultValue { get; set; }
