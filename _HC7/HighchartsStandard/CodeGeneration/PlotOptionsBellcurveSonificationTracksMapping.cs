...
{
	public partial class PlotOptionsBellcurveSonificationTracksMapping  : BaseObject
	{
		Hashtable h = new Hashtable();

		public PlotOptionsBellcurveSonificationTracksMapping()
		{
			Frequency = Frequency_DefaultValue = new PlotOptionsBellcurveSonificationTracksMappingFrequency();
			GapBetweenNotes = GapBetweenNotes_DefaultValue = new PlotOptionsBellcurveSonificationTracksMappingGapBetweenNotes();
			Highpass = Highpass_DefaultValue = new PlotOptionsBellcurveSonificationTracksMappingHighpass();
			Lowpass = Lowpass_DefaultValue = new PlotOptionsBellcurveSonificationTracksMappingLowpass();
			NoteDuration = NoteDuration_DefaultValue = new PlotOptionsBellcurveSonificationTracksMappingNoteDuration();
			Pan = Pan_DefaultValue = new PlotOptionsBellcurveSonificationTracksMappingPan();
			Pitch = Pitch_DefaultValue = new PlotOptionsBellcurveSonificationTracksMappingPitch();
			PitchString = PitchString_DefaultValue = "null";
			PitchNumber = PitchNumber_DefaultValue = null;
			PlayDelay = PlayDelay_DefaultValue = new PlotOptionsBellcurveSonificationTracksMappingPlayDelay();
			Time = Time_DefaultValue = new PlotOptionsBellcurveSonificationTracksMappingTime();
			TimeString = TimeString_DefaultValue = "null";
			TimeNumber = TimeNumber_DefaultValue = null;
			Tremolo = Tremolo_DefaultValue = new PlotOptionsBellcurveSonificationTracksMappingTremolo();
			Volume = Volume_DefaultValue = new PlotOptionsBellcurveSonificationTracksMappingVolume();
		...
		/// </summary>
		public PlotOptionsBellcurveSonificationTracksMappingFrequency Frequency { get; set; }
		private PlotOptionsBellcurveSonificationTracksMappingFrequency Frequency_DefaultValue { get; set; }
		...
		/// </summary>
		public PlotOptionsBellcurveSonificationTracksMappingGapBetweenNotes GapBetweenNotes { get; set; }
		private PlotOptionsBellcurveSonificationTracksMappingGapBetweenNotes GapBetweenNotes_DefaultValue { get; set; }
		...
		/// </summary>
		public PlotOptionsBellcurveSonificationTracksMappingHighpass Highpass { get; set; }
		private PlotOptionsBellcurveSonificationTracksMappingHighpass Highpass_DefaultValue { get; set; }
		...
		/// </summary>
		public PlotOptionsBellcurveSonificationTracksMappingLowpass Lowpass { get; set; }
		private PlotOptionsBellcurveSonificationTracksMappingLowpass Lowpass_DefaultValue { get; set; }
		...
		/// </summary>
		public PlotOptionsBellcurveSonificationTracksMappingNoteDuration NoteDuration { get; set; }
		private PlotOptionsBellcurveSonificationTracksMappingNoteDuration NoteDuration_DefaultValue { get; set; }
		...
		/// </summary>
		public PlotOptionsBellcurveSonificationTracksMappingPan Pan { get; set; }
		private PlotOptionsBellcurveSonificationTracksMappingPan Pan_DefaultValue { get; set; }
		...
		/// </summary>
		public PlotOptionsBellcurveSonificationTracksMappingPitch Pitch { get; set; }
		private PlotOptionsBellcurveSonificationTracksMappingPitch Pitch_DefaultValue { get; set; }
		...
		/// </summary>
		public PlotOptionsBellcurveSonificationTracksMappingPlayDelay PlayDelay { get; set; }
		private PlotOptionsBellcurveSonificationTracksMappingPlayDelay PlayDelay_DefaultValue { get; set; }
		...
		/// </summary>
		public PlotOptionsBellcurveSonificationTracksMappingTime Time { get; set; }
		private PlotOptionsBellcurveSonificationTracksMappingTime Time_DefaultValue { get; set; }
		...
		/// </summary>
		public PlotOptionsBellcurveSonificationTracksMappingTremolo Tremolo { get; set; }
		private PlotOptionsBellcurveSonificationTracksMappingTremolo Tremolo_DefaultValue { get; set; }
		 

		/// <summary>
		/// The volume of notes, from 0 to 1.
		/// </summary>
		public PlotOptionsBellcurveSonificationTracksMappingVolume Volume { get; set; }
		private PlotOptionsBellcurveSonificationTracksMappingVolume Volume_DefaultValue { get; set; }
