...
{
	public partial class PlotOptionsBellcurveSonificationTracksMappingPan  : BaseObject
	{
		Hashtable h = new Hashtable();

		public PlotOptionsBellcurveSonificationTracksMappingPan()
		{
			MapFunction = MapFunction_DefaultValue = PlotOptionsBellcurveSonificationTracksMappingPanMapFunction.Linear;
			MapTo = MapTo_DefaultValue = "";
			Max = Max_DefaultValue = null;
			Min = Min_DefaultValue = null;
			Value = Value_DefaultValue = null;
			Within = Within_DefaultValue = PlotOptionsBellcurveSonificationTracksMappingPanWithin.Chart;
		...
		/// </summary>
		public PlotOptionsBellcurveSonificationTracksMappingPanMapFunction MapFunction { get; set; }
		private PlotOptionsBellcurveSonificationTracksMappingPanMapFunction MapFunction_DefaultValue { get; set; }
		...
		/// </summary>
		public PlotOptionsBellcurveSonificationTracksMappingPanWithin Within { get; set; }
		private PlotOptionsBellcurveSonificationTracksMappingPanWithin Within_DefaultValue { get; set; }
