...
{
	public partial class PlotOptionsBellcurveSonificationTracksMappingPitch  : BaseObject
	{
		Hashtable h = new Hashtable();

		public PlotOptionsBellcurveSonificationTracksMappingPitch()
		{
			MapFunction = MapFunction_DefaultValue = PlotOptionsBellcurveSonificationTracksMappingPitchMapFunction.Linear;
		...
		/// </summary>
		public PlotOptionsBellcurveSonificationTracksMappingPitchMapFunction MapFunction { get; set; }
		private PlotOptionsBellcurveSonificationTracksMappingPitchMapFunction MapFunction_DefaultValue { get; set; }
