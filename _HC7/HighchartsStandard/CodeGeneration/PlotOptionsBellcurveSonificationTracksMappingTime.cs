...
{
	public partial class PlotOptionsBellcurveSonificationTracksMappingTime  : BaseObject
	{
		Hashtable h = new Hashtable();

		public PlotOptionsBellcurveSonificationTracksMappingTime()
		{
			MapFunction = MapFunction_DefaultValue = PlotOptionsBellcurveSonificationTracksMappingTimeMapFunction.Linear;
			MapTo = MapTo_DefaultValue = "";
			Max = Max_DefaultValue = null;
			Min = Min_DefaultValue = null;
			Value = Value_DefaultValue = null;
			Within = Within_DefaultValue = PlotOptionsBellcurveSonificationTracksMappingTimeWithin.Chart;
		...
		/// </summary>
		public PlotOptionsBellcurveSonificationTracksMappingTimeMapFunction MapFunction { get; set; }
		private PlotOptionsBellcurveSonificationTracksMappingTimeMapFunction MapFunction_DefaultValue { get; set; }
		...
		/// </summary>
		public PlotOptionsBellcurveSonificationTracksMappingTimeWithin Within { get; set; }
		private PlotOptionsBellcurveSonificationTracksMappingTimeWithin Within_DefaultValue { get; set; }
