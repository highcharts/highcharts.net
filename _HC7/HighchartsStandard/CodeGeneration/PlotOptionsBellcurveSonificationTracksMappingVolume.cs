...
{
	public partial class PlotOptionsBellcurveSonificationTracksMappingVolume  : BaseObject
	{
		Hashtable h = new Hashtable();

		public PlotOptionsBellcurveSonificationTracksMappingVolume()
		{
			MapFunction = MapFunction_DefaultValue = PlotOptionsBellcurveSonificationTracksMappingVolumeMapFunction.Linear;
			MapTo = MapTo_DefaultValue = "";
			Max = Max_DefaultValue = null;
			Min = Min_DefaultValue = null;
			Value = Value_DefaultValue = null;
			Within = Within_DefaultValue = PlotOptionsBellcurveSonificationTracksMappingVolumeWithin.Chart;
		...
		/// </summary>
		public PlotOptionsBellcurveSonificationTracksMappingVolumeMapFunction MapFunction { get; set; }
		private PlotOptionsBellcurveSonificationTracksMappingVolumeMapFunction MapFunction_DefaultValue { get; set; }
		...
		/// </summary>
		public PlotOptionsBellcurveSonificationTracksMappingVolumeWithin Within { get; set; }
		private PlotOptionsBellcurveSonificationTracksMappingVolumeWithin Within_DefaultValue { get; set; }
