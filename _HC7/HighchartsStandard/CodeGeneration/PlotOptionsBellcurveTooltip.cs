...
{
	public partial class PlotOptionsBellcurveTooltip  : BaseObject
	{
		public PlotOptionsBellcurveTooltip()
		{
			...
			HeaderShape = HeaderShape_DefaultValue = PlotOptionsBellcurveTooltipHeaderShape.Callout;
		...
		/// </summary>
		public PlotOptionsBellcurveTooltipHeaderShape HeaderShape { get; set; }
		private PlotOptionsBellcurveTooltipHeaderShape HeaderShape_DefaultValue { get; set; }
		...
		internal override Hashtable ToHashtable()
		{
			...
			if (NullFormatter != NullFormatter_DefaultValue) { h.Add("nullFormatter",NullFormatter); Highcharts.AddFunction("PlotOptionsBellcurveTooltipNullFormatter.nullFormatter", NullFormatter); }  
			if (Outside != Outside_DefaultValue) h.Add("outside",Outside);
			if (Padding != Padding_DefaultValue) h.Add("padding",Padding);
			if (PointFormat != PointFormat_DefaultValue) h.Add("pointFormat",PointFormat);
			if (PointFormatter != PointFormatter_DefaultValue) { h.Add("pointFormatter",PointFormatter); Highcharts.AddFunction("PlotOptionsBellcurveTooltipPointFormatter.pointFormatter", PointFormatter); }  
