...
namespace Highsoft.Web.Mvc.Charts
{
	public partial class PlotOptionsBoxplot  : BaseObject
	{
		...
		internal override Hashtable ToHashtable()
		{
			...
			if (PointDescriptionFormatter != PointDescriptionFormatter_DefaultValue) { h.Add("pointDescriptionFormatter",PointDescriptionFormatter); Highcharts.AddFunction("64688a41-ff10-4a3d-b005-07ee34bbd45d.pointDescriptionFormatter", PointDescriptionFormatter); }  
