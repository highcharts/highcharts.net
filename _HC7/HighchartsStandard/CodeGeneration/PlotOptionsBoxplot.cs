...
namespace Highsoft.Web.Mvc.Charts
{
	public partial class PlotOptionsBoxplot  : BaseObject
	{
		...
		/// </summary>
		public PlotOptionsBoxplotAccessibility Accessibility { get; set; }
		private PlotOptionsBoxplotAccessibility Accessibility_DefaultValue { get; set; }
		...
		/// </summary>
		public PlotOptionsBoxplotDashStyle DashStyle { get; set; }
		private PlotOptionsBoxplotDashStyle DashStyle_DefaultValue { get; set; }
		...
		/// </summary>
		public PlotOptionsBoxplotDataLabels DataLabels { get; set; }
		private PlotOptionsBoxplotDataLabels DataLabels_DefaultValue { get; set; }
		 

		/// <summary>
		/// Options for the series data sorting.
		/// </summary>
		public PlotOptionsBoxplotDataSorting DataSorting { get; set; }
		private PlotOptionsBoxplotDataSorting DataSorting_DefaultValue { get; set; }
		...
		/// 
		/// </summary>
		public PlotOptionsBoxplotDragDrop DragDrop { get; set; }
		private PlotOptionsBoxplotDragDrop DragDrop_DefaultValue { get; set; }
		...
		/// </summary>
		public PlotOptionsBoxplotFindNearestPointBy FindNearestPointBy { get; set; }
		private PlotOptionsBoxplotFindNearestPointBy FindNearestPointBy_DefaultValue { get; set; }
		...
		/// </summary>
		public PlotOptionsBoxplotLabel Label { get; set; }
		private PlotOptionsBoxplotLabel Label_DefaultValue { get; set; }
		 

		/// <summary>
		/// What type of legend symbol to render for this series. Can be one of`areaMarker`, `lineMarker` or `rectangle`.
		/// </summary>
		public PlotOptionsBoxplotLegendSymbol LegendSymbol { get; set; }
		private PlotOptionsBoxplotLegendSymbol LegendSymbol_DefaultValue { get; set; }
		...
		/// <summary>
		/// The color of the median line. If `undefined`, the general seriescolor applies.In styled mode, the median stroke width can be set with the`.highcharts-boxplot-median` class.
		/// </summary>
		...
		/// </summary>
		public PlotOptionsBoxplotOnPoint OnPoint { get; set; }
		private PlotOptionsBoxplotOnPoint OnPoint_DefaultValue { get; set; }
		...
		/// </summary>
		public PlotOptionsBoxplotSonification Sonification { get; set; }
		private PlotOptionsBoxplotSonification Sonification_DefaultValue { get; set; }
		...
		/// </summary>
		public PlotOptionsBoxplotStacking Stacking { get; set; }
		private PlotOptionsBoxplotStacking Stacking_DefaultValue { get; set; }
		...
		internal override Hashtable ToHashtable(Highcharts highcharts)
		{
			...
			if (Cursor != PlotOptionsBoxplotCursor.Null) h.Add("cursor", highcharts.FirstCharacterToLower(Cursor.ToString()));
			if (Custom != null) h.Add("custom",Custom);
			if (DashStyle != PlotOptionsBoxplotDashStyle.Null) h.Add("dashStyle", highcharts.FirstCharacterToLower(DashStyle.ToString()));
			...
			if (FindNearestPointBy != PlotOptionsBoxplotFindNearestPointBy.Null) h.Add("findNearestPointBy", highcharts.FirstCharacterToLower(FindNearestPointBy.ToString()));
			...
			if (LegendSymbol != PlotOptionsBoxplotLegendSymbol.Null) h.Add("legendSymbol", highcharts.FirstCharacterToLower(LegendSymbol.ToString()));
			...
			if (MedianColor != null) h.Add("medianColor",MedianColor);
			if (MedianDashStyle != null) h.Add("medianDashStyle",MedianDashStyle);
			if (MedianWidth != null) h.Add("medianWidth",MedianWidth);
			...
			if (PointIntervalUnit != PlotOptionsBoxplotPointIntervalUnit.Null) h.Add("pointIntervalUnit", highcharts.FirstCharacterToLower(PointIntervalUnit.ToString()));
			if (PointPadding != null) h.Add("pointPadding",PointPadding);
			if (PointPlacement != PlotOptionsBoxplotPointPlacement.Null) h.Add("pointPlacement", highcharts.FirstCharacterToLower(PointPlacement.ToString()));
			...
			if (Stacking != PlotOptionsBoxplotStacking.Null) h.Add("stacking", highcharts.FirstCharacterToLower(Stacking.ToString()));
			if (States != null) h.Add("states",States.ToHashtable(highcharts));
			if (StemColor != null) h.Add("stemColor",StemColor);
			if (StemDashStyle != null) h.Add("stemDashStyle",StemDashStyle);
			if (StemWidth != null) h.Add("stemWidth",StemWidth);
			...
			if (WhiskerColor != null) h.Add("whiskerColor",WhiskerColor);
			if (WhiskerDashStyle != null) h.Add("whiskerDashStyle",WhiskerDashStyle);
			if (WhiskerLength != null) h.Add("whiskerLength",WhiskerLength);
			if (WhiskerLengthNumber != null) h.Add("whiskerLength",WhiskerLengthNumber);
