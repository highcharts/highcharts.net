...
namespace Highsoft.Web.Mvc.Charts
{
	public partial class PlotOptionsBoxplot  : BaseObject
	{
		...
		{
			Accessibility = Accessibility_DefaultValue = new PlotOptionsBoxplotAccessibility();
			...
			ColorKey = ColorKey_DefaultValue = "high";
			Colors = Colors_DefaultValue = new List<string>();
			Crisp = Crisp_DefaultValue = true;
			CropThreshold = CropThreshold_DefaultValue = 300;
			Cursor = Cursor_DefaultValue = PlotOptionsBoxplotCursor.Null;
			Custom = Custom_DefaultValue = new Hashtable();
			DashStyle = DashStyle_DefaultValue = PlotOptionsBoxplotDashStyle.Null;
			DataLabels = DataLabels_DefaultValue = new PlotOptionsBoxplotDataLabels();
			DataSorting = DataSorting_DefaultValue = new PlotOptionsBoxplotDataSorting();
			Depth = Depth_DefaultValue = 25;
			Description = Description_DefaultValue = "";
			DragDrop = DragDrop_DefaultValue = new PlotOptionsBoxplotDragDrop();
			...
			LegendSymbol = LegendSymbol_DefaultValue = PlotOptionsBoxplotLegendSymbol.Rectangle;
			...
			OnPoint = OnPoint_DefaultValue = new PlotOptionsBoxplotOnPoint();
			...
			Sonification = Sonification_DefaultValue = new PlotOptionsBoxplotSonification();
