...
{
	public partial class PlotOptionsBoxplotDragDropDragHandle  : BaseObject
	{
		public PlotOptionsBoxplotDragDropDragHandle()
		{
		...
		internal override Hashtable ToHashtable()
		{
			...
			if (PathFormatter != PathFormatter_DefaultValue) { h.Add("pathFormatter",PathFormatter); Highcharts.AddFunction("PlotOptionsBoxplotDragDropDragHandlePathFormatter.pathFormatter", PathFormatter); }  
