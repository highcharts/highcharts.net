...
{
	public partial class PlotOptionsBoxplotSonificationContextTracksMapping  : BaseObject
	{
		Hashtable h = new Hashtable();

		public PlotOptionsBoxplotSonificationContextTracksMapping()
		{
			Frequency = Frequency_DefaultValue = new PlotOptionsBoxplotSonificationContextTracksMappingFrequency();
			GapBetweenNotes = GapBetweenNotes_DefaultValue = new PlotOptionsBoxplotSonificationContextTracksMappingGapBetweenNotes();
			Highpass = Highpass_DefaultValue = new PlotOptionsBoxplotSonificationContextTracksMappingHighpass();
			Lowpass = Lowpass_DefaultValue = new PlotOptionsBoxplotSonificationContextTracksMappingLowpass();
			NoteDuration = NoteDuration_DefaultValue = new PlotOptionsBoxplotSonificationContextTracksMappingNoteDuration();
			Pan = Pan_DefaultValue = new PlotOptionsBoxplotSonificationContextTracksMappingPan();
			Pitch = Pitch_DefaultValue = new PlotOptionsBoxplotSonificationContextTracksMappingPitch();
			PitchString = PitchString_DefaultValue = "null";
			PitchNumber = PitchNumber_DefaultValue = null;
			PlayDelay = PlayDelay_DefaultValue = new PlotOptionsBoxplotSonificationContextTracksMappingPlayDelay();
			Time = Time_DefaultValue = new PlotOptionsBoxplotSonificationContextTracksMappingTime();
			TimeString = TimeString_DefaultValue = "null";
			TimeNumber = TimeNumber_DefaultValue = null;
			Tremolo = Tremolo_DefaultValue = new PlotOptionsBoxplotSonificationContextTracksMappingTremolo();
			Volume = Volume_DefaultValue = new PlotOptionsBoxplotSonificationContextTracksMappingVolume();
		...
		/// </summary>
		public PlotOptionsBoxplotSonificationContextTracksMappingFrequency Frequency { get; set; }
		private PlotOptionsBoxplotSonificationContextTracksMappingFrequency Frequency_DefaultValue { get; set; }
		...
		/// </summary>
		public PlotOptionsBoxplotSonificationContextTracksMappingGapBetweenNotes GapBetweenNotes { get; set; }
		private PlotOptionsBoxplotSonificationContextTracksMappingGapBetweenNotes GapBetweenNotes_DefaultValue { get; set; }
		...
		/// </summary>
		public PlotOptionsBoxplotSonificationContextTracksMappingHighpass Highpass { get; set; }
		private PlotOptionsBoxplotSonificationContextTracksMappingHighpass Highpass_DefaultValue { get; set; }
		...
		/// </summary>
		public PlotOptionsBoxplotSonificationContextTracksMappingLowpass Lowpass { get; set; }
		private PlotOptionsBoxplotSonificationContextTracksMappingLowpass Lowpass_DefaultValue { get; set; }
		...
		/// </summary>
		public PlotOptionsBoxplotSonificationContextTracksMappingNoteDuration NoteDuration { get; set; }
		private PlotOptionsBoxplotSonificationContextTracksMappingNoteDuration NoteDuration_DefaultValue { get; set; }
		...
		/// </summary>
		public PlotOptionsBoxplotSonificationContextTracksMappingPan Pan { get; set; }
		private PlotOptionsBoxplotSonificationContextTracksMappingPan Pan_DefaultValue { get; set; }
		...
		/// </summary>
		public PlotOptionsBoxplotSonificationContextTracksMappingPitch Pitch { get; set; }
		private PlotOptionsBoxplotSonificationContextTracksMappingPitch Pitch_DefaultValue { get; set; }
		...
		/// </summary>
		public PlotOptionsBoxplotSonificationContextTracksMappingPlayDelay PlayDelay { get; set; }
		private PlotOptionsBoxplotSonificationContextTracksMappingPlayDelay PlayDelay_DefaultValue { get; set; }
		...
		/// </summary>
		public PlotOptionsBoxplotSonificationContextTracksMappingTime Time { get; set; }
		private PlotOptionsBoxplotSonificationContextTracksMappingTime Time_DefaultValue { get; set; }
		...
		/// </summary>
		public PlotOptionsBoxplotSonificationContextTracksMappingTremolo Tremolo { get; set; }
		private PlotOptionsBoxplotSonificationContextTracksMappingTremolo Tremolo_DefaultValue { get; set; }
		 

		/// <summary>
		/// The volume of notes, from 0 to 1.
		/// </summary>
		public PlotOptionsBoxplotSonificationContextTracksMappingVolume Volume { get; set; }
		private PlotOptionsBoxplotSonificationContextTracksMappingVolume Volume_DefaultValue { get; set; }
