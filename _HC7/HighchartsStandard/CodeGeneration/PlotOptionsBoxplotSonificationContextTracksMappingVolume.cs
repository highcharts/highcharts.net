...
{
	public partial class PlotOptionsBoxplotSonificationContextTracksMappingVolume  : BaseObject
	{
		Hashtable h = new Hashtable();

		public PlotOptionsBoxplotSonificationContextTracksMappingVolume()
		{
			MapFunction = MapFunction_DefaultValue = PlotOptionsBoxplotSonificationContextTracksMappingVolumeMapFunction.Linear;
			MapTo = MapTo_DefaultValue = "";
			Max = Max_DefaultValue = null;
			Min = Min_DefaultValue = null;
			Value = Value_DefaultValue = null;
			Within = Within_DefaultValue = PlotOptionsBoxplotSonificationContextTracksMappingVolumeWithin.Chart;
		...
		/// </summary>
		public PlotOptionsBoxplotSonificationContextTracksMappingVolumeMapFunction MapFunction { get; set; }
		private PlotOptionsBoxplotSonificationContextTracksMappingVolumeMapFunction MapFunction_DefaultValue { get; set; }
		...
		/// </summary>
		public PlotOptionsBoxplotSonificationContextTracksMappingVolumeWithin Within { get; set; }
		private PlotOptionsBoxplotSonificationContextTracksMappingVolumeWithin Within_DefaultValue { get; set; }
