...
{
	public partial class PlotOptionsBoxplotSonificationPointGrouping  : BaseObject
	{
		Hashtable h = new Hashtable();

		public PlotOptionsBoxplotSonificationPointGrouping()
		{
		...
		/// </summary>
		public PlotOptionsBoxplotSonificationPointGroupingAlgorithm Algorithm { get; set; }
		private PlotOptionsBoxplotSonificationPointGroupingAlgorithm Algorithm_DefaultValue { get; set; }
		...
		internal override Hashtable ToHashtable(Highcharts highcharts)
		{
			...
			if (Algorithm != PlotOptionsBoxplotSonificationPointGroupingAlgorithm.Null) h.Add("algorithm", highcharts.FirstCharacterToLower(Algorithm.ToString()));
