...
{
	public partial class PlotOptionsBoxplotSonificationTracksMapping  : BaseObject
	{
		Hashtable h = new Hashtable();

		public PlotOptionsBoxplotSonificationTracksMapping()
		{
			Frequency = Frequency_DefaultValue = new PlotOptionsBoxplotSonificationTracksMappingFrequency();
			GapBetweenNotes = GapBetweenNotes_DefaultValue = new PlotOptionsBoxplotSonificationTracksMappingGapBetweenNotes();
			Highpass = Highpass_DefaultValue = new PlotOptionsBoxplotSonificationTracksMappingHighpass();
			Lowpass = Lowpass_DefaultValue = new PlotOptionsBoxplotSonificationTracksMappingLowpass();
			NoteDuration = NoteDuration_DefaultValue = new PlotOptionsBoxplotSonificationTracksMappingNoteDuration();
			Pan = Pan_DefaultValue = new PlotOptionsBoxplotSonificationTracksMappingPan();
			Pitch = Pitch_DefaultValue = new PlotOptionsBoxplotSonificationTracksMappingPitch();
			PitchString = PitchString_DefaultValue = "null";
			PitchNumber = PitchNumber_DefaultValue = null;
			PlayDelay = PlayDelay_DefaultValue = new PlotOptionsBoxplotSonificationTracksMappingPlayDelay();
			Time = Time_DefaultValue = new PlotOptionsBoxplotSonificationTracksMappingTime();
			TimeString = TimeString_DefaultValue = "null";
			TimeNumber = TimeNumber_DefaultValue = null;
			Tremolo = Tremolo_DefaultValue = new PlotOptionsBoxplotSonificationTracksMappingTremolo();
			Volume = Volume_DefaultValue = new PlotOptionsBoxplotSonificationTracksMappingVolume();
		...
		/// </summary>
		public PlotOptionsBoxplotSonificationTracksMappingFrequency Frequency { get; set; }
		private PlotOptionsBoxplotSonificationTracksMappingFrequency Frequency_DefaultValue { get; set; }
		...
		/// </summary>
		public PlotOptionsBoxplotSonificationTracksMappingGapBetweenNotes GapBetweenNotes { get; set; }
		private PlotOptionsBoxplotSonificationTracksMappingGapBetweenNotes GapBetweenNotes_DefaultValue { get; set; }
		...
		/// </summary>
		public PlotOptionsBoxplotSonificationTracksMappingHighpass Highpass { get; set; }
		private PlotOptionsBoxplotSonificationTracksMappingHighpass Highpass_DefaultValue { get; set; }
		...
		/// </summary>
		public PlotOptionsBoxplotSonificationTracksMappingLowpass Lowpass { get; set; }
		private PlotOptionsBoxplotSonificationTracksMappingLowpass Lowpass_DefaultValue { get; set; }
		...
		/// </summary>
		public PlotOptionsBoxplotSonificationTracksMappingNoteDuration NoteDuration { get; set; }
		private PlotOptionsBoxplotSonificationTracksMappingNoteDuration NoteDuration_DefaultValue { get; set; }
		...
		/// </summary>
		public PlotOptionsBoxplotSonificationTracksMappingPan Pan { get; set; }
		private PlotOptionsBoxplotSonificationTracksMappingPan Pan_DefaultValue { get; set; }
		...
		/// </summary>
		public PlotOptionsBoxplotSonificationTracksMappingPitch Pitch { get; set; }
		private PlotOptionsBoxplotSonificationTracksMappingPitch Pitch_DefaultValue { get; set; }
		...
		/// </summary>
		public PlotOptionsBoxplotSonificationTracksMappingPlayDelay PlayDelay { get; set; }
		private PlotOptionsBoxplotSonificationTracksMappingPlayDelay PlayDelay_DefaultValue { get; set; }
		...
		/// </summary>
		public PlotOptionsBoxplotSonificationTracksMappingTime Time { get; set; }
		private PlotOptionsBoxplotSonificationTracksMappingTime Time_DefaultValue { get; set; }
		...
		/// </summary>
		public PlotOptionsBoxplotSonificationTracksMappingTremolo Tremolo { get; set; }
		private PlotOptionsBoxplotSonificationTracksMappingTremolo Tremolo_DefaultValue { get; set; }
		 

		/// <summary>
		/// The volume of notes, from 0 to 1.
		/// </summary>
		public PlotOptionsBoxplotSonificationTracksMappingVolume Volume { get; set; }
		private PlotOptionsBoxplotSonificationTracksMappingVolume Volume_DefaultValue { get; set; }
