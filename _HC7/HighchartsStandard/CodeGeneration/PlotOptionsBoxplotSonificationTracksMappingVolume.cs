...
{
	public partial class PlotOptionsBoxplotSonificationTracksMappingVolume  : BaseObject
	{
		Hashtable h = new Hashtable();

		public PlotOptionsBoxplotSonificationTracksMappingVolume()
		{
			MapFunction = MapFunction_DefaultValue = PlotOptionsBoxplotSonificationTracksMappingVolumeMapFunction.Linear;
			MapTo = MapTo_DefaultValue = "";
			Max = Max_DefaultValue = null;
			Min = Min_DefaultValue = null;
			Value = Value_DefaultValue = null;
			Within = Within_DefaultValue = PlotOptionsBoxplotSonificationTracksMappingVolumeWithin.Chart;
		...
		/// </summary>
		public PlotOptionsBoxplotSonificationTracksMappingVolumeMapFunction MapFunction { get; set; }
		private PlotOptionsBoxplotSonificationTracksMappingVolumeMapFunction MapFunction_DefaultValue { get; set; }
		...
		/// </summary>
		public PlotOptionsBoxplotSonificationTracksMappingVolumeWithin Within { get; set; }
		private PlotOptionsBoxplotSonificationTracksMappingVolumeWithin Within_DefaultValue { get; set; }
