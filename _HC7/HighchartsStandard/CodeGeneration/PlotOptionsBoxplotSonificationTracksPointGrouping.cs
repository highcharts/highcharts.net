...
{
	public partial class PlotOptionsBoxplotSonificationTracksPointGrouping  : BaseObject
	{
		Hashtable h = new Hashtable();

		public PlotOptionsBoxplotSonificationTracksPointGrouping()
		{
		...
		/// </summary>
		public PlotOptionsBoxplotSonificationTracksPointGroupingAlgorithm Algorithm { get; set; }
		private PlotOptionsBoxplotSonificationTracksPointGroupingAlgorithm Algorithm_DefaultValue { get; set; }
		...
		internal override Hashtable ToHashtable(Highcharts highcharts)
		{
			...
			if (Algorithm != PlotOptionsBoxplotSonificationTracksPointGroupingAlgorithm.Null) h.Add("algorithm", highcharts.FirstCharacterToLower(Algorithm.ToString()));
