...
{
	public partial class PlotOptionsBubbleSonificationContextTracksMappingGapBetweenNotes  : BaseObject
	{
		Hashtable h = new Hashtable();

		public PlotOptionsBubbleSonificationContextTracksMappingGapBetweenNotes()
		{
			MapFunction = MapFunction_DefaultValue = PlotOptionsBubbleSonificationContextTracksMappingGapBetweenNotesMapFunction.Linear;
			MapTo = MapTo_DefaultValue = "";
			Max = Max_DefaultValue = null;
			Min = Min_DefaultValue = null;
			Value = Value_DefaultValue = null;
			Within = Within_DefaultValue = PlotOptionsBubbleSonificationContextTracksMappingGapBetweenNotesWithin.Chart;
		...
		/// </summary>
		public PlotOptionsBubbleSonificationContextTracksMappingGapBetweenNotesMapFunction MapFunction { get; set; }
		private PlotOptionsBubbleSonificationContextTracksMappingGapBetweenNotesMapFunction MapFunction_DefaultValue { get; set; }
		...
		/// </summary>
		public PlotOptionsBubbleSonificationContextTracksMappingGapBetweenNotesWithin Within { get; set; }
		private PlotOptionsBubbleSonificationContextTracksMappingGapBetweenNotesWithin Within_DefaultValue { get; set; }
