...
{
	public partial class PlotOptionsBubbleSonificationContextTracksMappingPitch  : BaseObject
	{
		Hashtable h = new Hashtable();

		public PlotOptionsBubbleSonificationContextTracksMappingPitch()
		{
			MapFunction = MapFunction_DefaultValue = PlotOptionsBubbleSonificationContextTracksMappingPitchMapFunction.Linear;
		...
		/// </summary>
		public PlotOptionsBubbleSonificationContextTracksMappingPitchMapFunction MapFunction { get; set; }
		private PlotOptionsBubbleSonificationContextTracksMappingPitchMapFunction MapFunction_DefaultValue { get; set; }
