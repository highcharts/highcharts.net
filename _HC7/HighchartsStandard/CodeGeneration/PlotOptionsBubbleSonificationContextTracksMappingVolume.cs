...
{
	public partial class PlotOptionsBubbleSonificationContextTracksMappingVolume  : BaseObject
	{
		Hashtable h = new Hashtable();

		public PlotOptionsBubbleSonificationContextTracksMappingVolume()
		{
			MapFunction = MapFunction_DefaultValue = PlotOptionsBubbleSonificationContextTracksMappingVolumeMapFunction.Linear;
			MapTo = MapTo_DefaultValue = "";
			Max = Max_DefaultValue = null;
			Min = Min_DefaultValue = null;
			Value = Value_DefaultValue = null;
			Within = Within_DefaultValue = PlotOptionsBubbleSonificationContextTracksMappingVolumeWithin.Chart;
		...
		/// </summary>
		public PlotOptionsBubbleSonificationContextTracksMappingVolumeMapFunction MapFunction { get; set; }
		private PlotOptionsBubbleSonificationContextTracksMappingVolumeMapFunction MapFunction_DefaultValue { get; set; }
		...
		/// </summary>
		public PlotOptionsBubbleSonificationContextTracksMappingVolumeWithin Within { get; set; }
		private PlotOptionsBubbleSonificationContextTracksMappingVolumeWithin Within_DefaultValue { get; set; }
