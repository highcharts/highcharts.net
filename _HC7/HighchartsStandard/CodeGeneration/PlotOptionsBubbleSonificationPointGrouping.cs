...
{
	public partial class PlotOptionsBubbleSonificationPointGrouping  : BaseObject
	{
		Hashtable h = new Hashtable();

		public PlotOptionsBubbleSonificationPointGrouping()
		{
		...
		/// </summary>
		public PlotOptionsBubbleSonificationPointGroupingAlgorithm Algorithm { get; set; }
		private PlotOptionsBubbleSonificationPointGroupingAlgorithm Algorithm_DefaultValue { get; set; }
		...
		internal override Hashtable ToHashtable(Highcharts highcharts)
		{
			...
			if (Algorithm != PlotOptionsBubbleSonificationPointGroupingAlgorithm.Null) h.Add("algorithm", highcharts.FirstCharacterToLower(Algorithm.ToString()));
