...
{
	public partial class PlotOptionsBubbleSonificationTracksMapping  : BaseObject
	{
		Hashtable h = new Hashtable();

		public PlotOptionsBubbleSonificationTracksMapping()
		{
			Frequency = Frequency_DefaultValue = new PlotOptionsBubbleSonificationTracksMappingFrequency();
			GapBetweenNotes = GapBetweenNotes_DefaultValue = new PlotOptionsBubbleSonificationTracksMappingGapBetweenNotes();
			Highpass = Highpass_DefaultValue = new PlotOptionsBubbleSonificationTracksMappingHighpass();
			Lowpass = Lowpass_DefaultValue = new PlotOptionsBubbleSonificationTracksMappingLowpass();
			NoteDuration = NoteDuration_DefaultValue = new PlotOptionsBubbleSonificationTracksMappingNoteDuration();
			Pan = Pan_DefaultValue = new PlotOptionsBubbleSonificationTracksMappingPan();
			Pitch = Pitch_DefaultValue = new PlotOptionsBubbleSonificationTracksMappingPitch();
			PitchString = PitchString_DefaultValue = "null";
			PitchNumber = PitchNumber_DefaultValue = null;
			PlayDelay = PlayDelay_DefaultValue = new PlotOptionsBubbleSonificationTracksMappingPlayDelay();
			Time = Time_DefaultValue = new PlotOptionsBubbleSonificationTracksMappingTime();
			TimeString = TimeString_DefaultValue = "null";
			TimeNumber = TimeNumber_DefaultValue = null;
			Tremolo = Tremolo_DefaultValue = new PlotOptionsBubbleSonificationTracksMappingTremolo();
			Volume = Volume_DefaultValue = new PlotOptionsBubbleSonificationTracksMappingVolume();
		...
		/// </summary>
		public PlotOptionsBubbleSonificationTracksMappingFrequency Frequency { get; set; }
		private PlotOptionsBubbleSonificationTracksMappingFrequency Frequency_DefaultValue { get; set; }
		...
		/// </summary>
		public PlotOptionsBubbleSonificationTracksMappingGapBetweenNotes GapBetweenNotes { get; set; }
		private PlotOptionsBubbleSonificationTracksMappingGapBetweenNotes GapBetweenNotes_DefaultValue { get; set; }
		...
		/// </summary>
		public PlotOptionsBubbleSonificationTracksMappingHighpass Highpass { get; set; }
		private PlotOptionsBubbleSonificationTracksMappingHighpass Highpass_DefaultValue { get; set; }
		...
		/// </summary>
		public PlotOptionsBubbleSonificationTracksMappingLowpass Lowpass { get; set; }
		private PlotOptionsBubbleSonificationTracksMappingLowpass Lowpass_DefaultValue { get; set; }
		...
		/// </summary>
		public PlotOptionsBubbleSonificationTracksMappingNoteDuration NoteDuration { get; set; }
		private PlotOptionsBubbleSonificationTracksMappingNoteDuration NoteDuration_DefaultValue { get; set; }
		...
		/// </summary>
		public PlotOptionsBubbleSonificationTracksMappingPan Pan { get; set; }
		private PlotOptionsBubbleSonificationTracksMappingPan Pan_DefaultValue { get; set; }
		...
		/// </summary>
		public PlotOptionsBubbleSonificationTracksMappingPitch Pitch { get; set; }
		private PlotOptionsBubbleSonificationTracksMappingPitch Pitch_DefaultValue { get; set; }
		...
		/// </summary>
		public PlotOptionsBubbleSonificationTracksMappingPlayDelay PlayDelay { get; set; }
		private PlotOptionsBubbleSonificationTracksMappingPlayDelay PlayDelay_DefaultValue { get; set; }
		...
		/// </summary>
		public PlotOptionsBubbleSonificationTracksMappingTime Time { get; set; }
		private PlotOptionsBubbleSonificationTracksMappingTime Time_DefaultValue { get; set; }
		...
		/// </summary>
		public PlotOptionsBubbleSonificationTracksMappingTremolo Tremolo { get; set; }
		private PlotOptionsBubbleSonificationTracksMappingTremolo Tremolo_DefaultValue { get; set; }
		 

		/// <summary>
		/// The volume of notes, from 0 to 1.
		/// </summary>
		public PlotOptionsBubbleSonificationTracksMappingVolume Volume { get; set; }
		private PlotOptionsBubbleSonificationTracksMappingVolume Volume_DefaultValue { get; set; }
