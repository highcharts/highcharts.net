...
{
	public partial class PlotOptionsBubbleSonificationTracksMappingFrequency  : BaseObject
	{
		Hashtable h = new Hashtable();

		public PlotOptionsBubbleSonificationTracksMappingFrequency()
		{
			MapFunction = MapFunction_DefaultValue = PlotOptionsBubbleSonificationTracksMappingFrequencyMapFunction.Linear;
			MapTo = MapTo_DefaultValue = "";
			Max = Max_DefaultValue = null;
			Min = Min_DefaultValue = null;
			Value = Value_DefaultValue = null;
			Within = Within_DefaultValue = PlotOptionsBubbleSonificationTracksMappingFrequencyWithin.Chart;
		...
		/// </summary>
		public PlotOptionsBubbleSonificationTracksMappingFrequencyMapFunction MapFunction { get; set; }
		private PlotOptionsBubbleSonificationTracksMappingFrequencyMapFunction MapFunction_DefaultValue { get; set; }
		...
		/// </summary>
		public PlotOptionsBubbleSonificationTracksMappingFrequencyWithin Within { get; set; }
		private PlotOptionsBubbleSonificationTracksMappingFrequencyWithin Within_DefaultValue { get; set; }
