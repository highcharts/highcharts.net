...
{
	public partial class PlotOptionsBubbleSonificationTracksMappingNoteDuration  : BaseObject
	{
		Hashtable h = new Hashtable();

		public PlotOptionsBubbleSonificationTracksMappingNoteDuration()
		{
			MapFunction = MapFunction_DefaultValue = PlotOptionsBubbleSonificationTracksMappingNoteDurationMapFunction.Linear;
			MapTo = MapTo_DefaultValue = "";
			Max = Max_DefaultValue = null;
			Min = Min_DefaultValue = null;
			Value = Value_DefaultValue = null;
			Within = Within_DefaultValue = PlotOptionsBubbleSonificationTracksMappingNoteDurationWithin.Chart;
		...
		/// </summary>
		public PlotOptionsBubbleSonificationTracksMappingNoteDurationMapFunction MapFunction { get; set; }
		private PlotOptionsBubbleSonificationTracksMappingNoteDurationMapFunction MapFunction_DefaultValue { get; set; }
		...
		/// </summary>
		public PlotOptionsBubbleSonificationTracksMappingNoteDurationWithin Within { get; set; }
		private PlotOptionsBubbleSonificationTracksMappingNoteDurationWithin Within_DefaultValue { get; set; }
