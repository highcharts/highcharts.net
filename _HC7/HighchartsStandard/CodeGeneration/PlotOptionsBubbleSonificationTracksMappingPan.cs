...
{
	public partial class PlotOptionsBubbleSonificationTracksMappingPan  : BaseObject
	{
		Hashtable h = new Hashtable();

		public PlotOptionsBubbleSonificationTracksMappingPan()
		{
			MapFunction = MapFunction_DefaultValue = PlotOptionsBubbleSonificationTracksMappingPanMapFunction.Linear;
			MapTo = MapTo_DefaultValue = "";
			Max = Max_DefaultValue = null;
			Min = Min_DefaultValue = null;
			Value = Value_DefaultValue = null;
			Within = Within_DefaultValue = PlotOptionsBubbleSonificationTracksMappingPanWithin.Chart;
		...
		/// </summary>
		public PlotOptionsBubbleSonificationTracksMappingPanMapFunction MapFunction { get; set; }
		private PlotOptionsBubbleSonificationTracksMappingPanMapFunction MapFunction_DefaultValue { get; set; }
		...
		/// </summary>
		public PlotOptionsBubbleSonificationTracksMappingPanWithin Within { get; set; }
		private PlotOptionsBubbleSonificationTracksMappingPanWithin Within_DefaultValue { get; set; }
