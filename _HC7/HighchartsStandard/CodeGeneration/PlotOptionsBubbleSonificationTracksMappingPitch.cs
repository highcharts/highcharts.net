...
{
	public partial class PlotOptionsBubbleSonificationTracksMappingPitch  : BaseObject
	{
		Hashtable h = new Hashtable();

		public PlotOptionsBubbleSonificationTracksMappingPitch()
		{
			MapFunction = MapFunction_DefaultValue = PlotOptionsBubbleSonificationTracksMappingPitchMapFunction.Linear;
		...
		/// </summary>
		public PlotOptionsBubbleSonificationTracksMappingPitchMapFunction MapFunction { get; set; }
		private PlotOptionsBubbleSonificationTracksMappingPitchMapFunction MapFunction_DefaultValue { get; set; }
