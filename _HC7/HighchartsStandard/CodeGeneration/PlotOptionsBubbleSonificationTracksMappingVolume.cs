...
{
	public partial class PlotOptionsBubbleSonificationTracksMappingVolume  : BaseObject
	{
		Hashtable h = new Hashtable();

		public PlotOptionsBubbleSonificationTracksMappingVolume()
		{
			MapFunction = MapFunction_DefaultValue = PlotOptionsBubbleSonificationTracksMappingVolumeMapFunction.Linear;
			MapTo = MapTo_DefaultValue = "";
			Max = Max_DefaultValue = null;
			Min = Min_DefaultValue = null;
			Value = Value_DefaultValue = null;
			Within = Within_DefaultValue = PlotOptionsBubbleSonificationTracksMappingVolumeWithin.Chart;
		...
		/// </summary>
		public PlotOptionsBubbleSonificationTracksMappingVolumeMapFunction MapFunction { get; set; }
		private PlotOptionsBubbleSonificationTracksMappingVolumeMapFunction MapFunction_DefaultValue { get; set; }
		...
		/// </summary>
		public PlotOptionsBubbleSonificationTracksMappingVolumeWithin Within { get; set; }
		private PlotOptionsBubbleSonificationTracksMappingVolumeWithin Within_DefaultValue { get; set; }
