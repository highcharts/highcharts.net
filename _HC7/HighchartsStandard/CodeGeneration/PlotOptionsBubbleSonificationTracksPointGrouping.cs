...
{
	public partial class PlotOptionsBubbleSonificationTracksPointGrouping  : BaseObject
	{
		Hashtable h = new Hashtable();

		public PlotOptionsBubbleSonificationTracksPointGrouping()
		{
		...
		/// </summary>
		public PlotOptionsBubbleSonificationTracksPointGroupingAlgorithm Algorithm { get; set; }
		private PlotOptionsBubbleSonificationTracksPointGroupingAlgorithm Algorithm_DefaultValue { get; set; }
		...
		internal override Hashtable ToHashtable(Highcharts highcharts)
		{
			...
			if (Algorithm != PlotOptionsBubbleSonificationTracksPointGroupingAlgorithm.Null) h.Add("algorithm", highcharts.FirstCharacterToLower(Algorithm.ToString()));
