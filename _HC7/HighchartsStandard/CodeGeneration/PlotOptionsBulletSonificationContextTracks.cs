...
{
	public partial class PlotOptionsBulletSonificationContextTracks  : BaseObject
	{
		Hashtable h = new Hashtable();

		public PlotOptionsBulletSonificationContextTracks()
		{
			ActiveWhen = ActiveWhen_DefaultValue = new PlotOptionsBulletSonificationContextTracksActiveWhen();
			Instrument = Instrument_DefaultValue = null;
			InstrumentString = InstrumentString_DefaultValue = "null";
			Mapping = Mapping_DefaultValue = new PlotOptionsBulletSonificationContextTracksMapping();
			MidiName = MidiName_DefaultValue = "";
			PointGrouping = PointGrouping_DefaultValue = new PlotOptionsBulletSonificationContextTracksPointGrouping();
			...
			Type = Type_DefaultValue = PlotOptionsBulletSonificationContextTracksType.Instrument;
			ValueInterval = ValueInterval_DefaultValue = null;
			ValueMapFunction = ValueMapFunction_DefaultValue = PlotOptionsBulletSonificationContextTracksValueMapFunction.Linear;
		...
		/// </summary>
		public PlotOptionsBulletSonificationContextTracksActiveWhen ActiveWhen { get; set; }
		private PlotOptionsBulletSonificationContextTracksActiveWhen ActiveWhen_DefaultValue { get; set; }
		...
		/// </summary>
		public PlotOptionsBulletSonificationContextTracksMapping Mapping { get; set; }
		private PlotOptionsBulletSonificationContextTracksMapping Mapping_DefaultValue { get; set; }
		...
		/// </summary>
		public PlotOptionsBulletSonificationContextTracksPointGrouping PointGrouping { get; set; }
		private PlotOptionsBulletSonificationContextTracksPointGrouping PointGrouping_DefaultValue { get; set; }
		...
		/// </summary>
		public PlotOptionsBulletSonificationContextTracksType Type { get; set; }
		private PlotOptionsBulletSonificationContextTracksType Type_DefaultValue { get; set; }
		...
		/// </summary>
		public PlotOptionsBulletSonificationContextTracksValueMapFunction ValueMapFunction { get; set; }
		private PlotOptionsBulletSonificationContextTracksValueMapFunction ValueMapFunction_DefaultValue { get; set; }
