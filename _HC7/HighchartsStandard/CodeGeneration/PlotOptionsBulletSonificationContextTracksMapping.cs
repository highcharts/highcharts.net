...
{
	public partial class PlotOptionsBulletSonificationContextTracksMapping  : BaseObject
	{
		Hashtable h = new Hashtable();

		public PlotOptionsBulletSonificationContextTracksMapping()
		{
			Frequency = Frequency_DefaultValue = new PlotOptionsBulletSonificationContextTracksMappingFrequency();
			GapBetweenNotes = GapBetweenNotes_DefaultValue = new PlotOptionsBulletSonificationContextTracksMappingGapBetweenNotes();
			Highpass = Highpass_DefaultValue = new PlotOptionsBulletSonificationContextTracksMappingHighpass();
			Lowpass = Lowpass_DefaultValue = new PlotOptionsBulletSonificationContextTracksMappingLowpass();
			NoteDuration = NoteDuration_DefaultValue = new PlotOptionsBulletSonificationContextTracksMappingNoteDuration();
			Pan = Pan_DefaultValue = new PlotOptionsBulletSonificationContextTracksMappingPan();
			Pitch = Pitch_DefaultValue = new PlotOptionsBulletSonificationContextTracksMappingPitch();
			PitchString = PitchString_DefaultValue = "null";
			PitchNumber = PitchNumber_DefaultValue = null;
			PlayDelay = PlayDelay_DefaultValue = new PlotOptionsBulletSonificationContextTracksMappingPlayDelay();
			Time = Time_DefaultValue = new PlotOptionsBulletSonificationContextTracksMappingTime();
			TimeString = TimeString_DefaultValue = "null";
			TimeNumber = TimeNumber_DefaultValue = null;
			Tremolo = Tremolo_DefaultValue = new PlotOptionsBulletSonificationContextTracksMappingTremolo();
			Volume = Volume_DefaultValue = new PlotOptionsBulletSonificationContextTracksMappingVolume();
		...
		/// </summary>
		public PlotOptionsBulletSonificationContextTracksMappingFrequency Frequency { get; set; }
		private PlotOptionsBulletSonificationContextTracksMappingFrequency Frequency_DefaultValue { get; set; }
		...
		/// </summary>
		public PlotOptionsBulletSonificationContextTracksMappingGapBetweenNotes GapBetweenNotes { get; set; }
		private PlotOptionsBulletSonificationContextTracksMappingGapBetweenNotes GapBetweenNotes_DefaultValue { get; set; }
		...
		/// </summary>
		public PlotOptionsBulletSonificationContextTracksMappingHighpass Highpass { get; set; }
		private PlotOptionsBulletSonificationContextTracksMappingHighpass Highpass_DefaultValue { get; set; }
		...
		/// </summary>
		public PlotOptionsBulletSonificationContextTracksMappingLowpass Lowpass { get; set; }
		private PlotOptionsBulletSonificationContextTracksMappingLowpass Lowpass_DefaultValue { get; set; }
		...
		/// </summary>
		public PlotOptionsBulletSonificationContextTracksMappingNoteDuration NoteDuration { get; set; }
		private PlotOptionsBulletSonificationContextTracksMappingNoteDuration NoteDuration_DefaultValue { get; set; }
		...
		/// </summary>
		public PlotOptionsBulletSonificationContextTracksMappingPan Pan { get; set; }
		private PlotOptionsBulletSonificationContextTracksMappingPan Pan_DefaultValue { get; set; }
		...
		/// </summary>
		public PlotOptionsBulletSonificationContextTracksMappingPitch Pitch { get; set; }
		private PlotOptionsBulletSonificationContextTracksMappingPitch Pitch_DefaultValue { get; set; }
		...
		/// </summary>
		public PlotOptionsBulletSonificationContextTracksMappingPlayDelay PlayDelay { get; set; }
		private PlotOptionsBulletSonificationContextTracksMappingPlayDelay PlayDelay_DefaultValue { get; set; }
		...
		/// </summary>
		public PlotOptionsBulletSonificationContextTracksMappingTime Time { get; set; }
		private PlotOptionsBulletSonificationContextTracksMappingTime Time_DefaultValue { get; set; }
		...
		/// </summary>
		public PlotOptionsBulletSonificationContextTracksMappingTremolo Tremolo { get; set; }
		private PlotOptionsBulletSonificationContextTracksMappingTremolo Tremolo_DefaultValue { get; set; }
		 

		/// <summary>
		/// The volume of notes, from 0 to 1.
		/// </summary>
		public PlotOptionsBulletSonificationContextTracksMappingVolume Volume { get; set; }
		private PlotOptionsBulletSonificationContextTracksMappingVolume Volume_DefaultValue { get; set; }
