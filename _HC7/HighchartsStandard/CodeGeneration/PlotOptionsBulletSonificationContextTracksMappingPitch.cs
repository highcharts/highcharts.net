...
{
	public partial class PlotOptionsBulletSonificationContextTracksMappingPitch  : BaseObject
	{
		Hashtable h = new Hashtable();

		public PlotOptionsBulletSonificationContextTracksMappingPitch()
		{
			MapFunction = MapFunction_DefaultValue = PlotOptionsBulletSonificationContextTracksMappingPitchMapFunction.Linear;
		...
		/// </summary>
		public PlotOptionsBulletSonificationContextTracksMappingPitchMapFunction MapFunction { get; set; }
		private PlotOptionsBulletSonificationContextTracksMappingPitchMapFunction MapFunction_DefaultValue { get; set; }
