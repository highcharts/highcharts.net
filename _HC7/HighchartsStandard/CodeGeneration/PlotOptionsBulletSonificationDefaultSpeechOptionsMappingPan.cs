...
{
	public partial class PlotOptionsBulletSonificationDefaultSpeechOptionsMappingPan  : BaseObject
	{
		Hashtable h = new Hashtable();

		public PlotOptionsBulletSonificationDefaultSpeechOptionsMappingPan()
		{
			MapFunction = MapFunction_DefaultValue = PlotOptionsBulletSonificationDefaultSpeechOptionsMappingPanMapFunction.Linear;
			MapTo = MapTo_DefaultValue = "";
			Max = Max_DefaultValue = null;
			Min = Min_DefaultValue = null;
			Value = Value_DefaultValue = null;
			Within = Within_DefaultValue = PlotOptionsBulletSonificationDefaultSpeechOptionsMappingPanWithin.Chart;
		...
		/// </summary>
		public PlotOptionsBulletSonificationDefaultSpeechOptionsMappingPanMapFunction MapFunction { get; set; }
		private PlotOptionsBulletSonificationDefaultSpeechOptionsMappingPanMapFunction MapFunction_DefaultValue { get; set; }
		...
		/// </summary>
		public PlotOptionsBulletSonificationDefaultSpeechOptionsMappingPanWithin Within { get; set; }
		private PlotOptionsBulletSonificationDefaultSpeechOptionsMappingPanWithin Within_DefaultValue { get; set; }
