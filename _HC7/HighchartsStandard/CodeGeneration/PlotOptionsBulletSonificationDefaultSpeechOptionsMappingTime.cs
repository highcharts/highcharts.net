...
{
	public partial class PlotOptionsBulletSonificationDefaultSpeechOptionsMappingTime  : BaseObject
	{
		Hashtable h = new Hashtable();

		public PlotOptionsBulletSonificationDefaultSpeechOptionsMappingTime()
		{
			MapFunction = MapFunction_DefaultValue = PlotOptionsBulletSonificationDefaultSpeechOptionsMappingTimeMapFunction.Linear;
			MapTo = MapTo_DefaultValue = "";
			Max = Max_DefaultValue = null;
			Min = Min_DefaultValue = null;
			Value = Value_DefaultValue = null;
			Within = Within_DefaultValue = PlotOptionsBulletSonificationDefaultSpeechOptionsMappingTimeWithin.Chart;
		...
		/// </summary>
		public PlotOptionsBulletSonificationDefaultSpeechOptionsMappingTimeMapFunction MapFunction { get; set; }
		private PlotOptionsBulletSonificationDefaultSpeechOptionsMappingTimeMapFunction MapFunction_DefaultValue { get; set; }
		...
		/// </summary>
		public PlotOptionsBulletSonificationDefaultSpeechOptionsMappingTimeWithin Within { get; set; }
		private PlotOptionsBulletSonificationDefaultSpeechOptionsMappingTimeWithin Within_DefaultValue { get; set; }
