...
{
	public partial class PlotOptionsBulletSonificationDefaultSpeechOptionsMappingTremoloSpeed  : BaseObject
	{
		Hashtable h = new Hashtable();

		public PlotOptionsBulletSonificationDefaultSpeechOptionsMappingTremoloSpeed()
		{
			MapFunction = MapFunction_DefaultValue = PlotOptionsBulletSonificationDefaultSpeechOptionsMappingTremoloSpeedMapFunction.Linear;
			MapTo = MapTo_DefaultValue = "";
			Max = Max_DefaultValue = null;
			Min = Min_DefaultValue = null;
			Value = Value_DefaultValue = null;
			Within = Within_DefaultValue = PlotOptionsBulletSonificationDefaultSpeechOptionsMappingTremoloSpeedWithin.Chart;
		...
		/// </summary>
		public PlotOptionsBulletSonificationDefaultSpeechOptionsMappingTremoloSpeedMapFunction MapFunction { get; set; }
		private PlotOptionsBulletSonificationDefaultSpeechOptionsMappingTremoloSpeedMapFunction MapFunction_DefaultValue { get; set; }
		...
		/// </summary>
		public PlotOptionsBulletSonificationDefaultSpeechOptionsMappingTremoloSpeedWithin Within { get; set; }
		private PlotOptionsBulletSonificationDefaultSpeechOptionsMappingTremoloSpeedWithin Within_DefaultValue { get; set; }
