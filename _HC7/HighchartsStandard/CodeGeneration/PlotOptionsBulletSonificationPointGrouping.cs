...
{
	public partial class PlotOptionsBulletSonificationPointGrouping  : BaseObject
	{
		Hashtable h = new Hashtable();

		public PlotOptionsBulletSonificationPointGrouping()
		{
		...
		/// </summary>
		public PlotOptionsBulletSonificationPointGroupingAlgorithm Algorithm { get; set; }
		private PlotOptionsBulletSonificationPointGroupingAlgorithm Algorithm_DefaultValue { get; set; }
		...
		internal override Hashtable ToHashtable(Highcharts highcharts)
		{
			...
			if (Algorithm != PlotOptionsBulletSonificationPointGroupingAlgorithm.Null) h.Add("algorithm", highcharts.FirstCharacterToLower(Algorithm.ToString()));
