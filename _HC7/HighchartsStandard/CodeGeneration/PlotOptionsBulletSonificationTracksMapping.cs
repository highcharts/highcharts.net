...
{
	public partial class PlotOptionsBulletSonificationTracksMapping  : BaseObject
	{
		Hashtable h = new Hashtable();

		public PlotOptionsBulletSonificationTracksMapping()
		{
			Frequency = Frequency_DefaultValue = new PlotOptionsBulletSonificationTracksMappingFrequency();
			GapBetweenNotes = GapBetweenNotes_DefaultValue = new PlotOptionsBulletSonificationTracksMappingGapBetweenNotes();
			Highpass = Highpass_DefaultValue = new PlotOptionsBulletSonificationTracksMappingHighpass();
			Lowpass = Lowpass_DefaultValue = new PlotOptionsBulletSonificationTracksMappingLowpass();
			NoteDuration = NoteDuration_DefaultValue = new PlotOptionsBulletSonificationTracksMappingNoteDuration();
			Pan = Pan_DefaultValue = new PlotOptionsBulletSonificationTracksMappingPan();
			Pitch = Pitch_DefaultValue = new PlotOptionsBulletSonificationTracksMappingPitch();
			PitchString = PitchString_DefaultValue = "null";
			PitchNumber = PitchNumber_DefaultValue = null;
			PlayDelay = PlayDelay_DefaultValue = new PlotOptionsBulletSonificationTracksMappingPlayDelay();
			Time = Time_DefaultValue = new PlotOptionsBulletSonificationTracksMappingTime();
			TimeString = TimeString_DefaultValue = "null";
			TimeNumber = TimeNumber_DefaultValue = null;
			Tremolo = Tremolo_DefaultValue = new PlotOptionsBulletSonificationTracksMappingTremolo();
			Volume = Volume_DefaultValue = new PlotOptionsBulletSonificationTracksMappingVolume();
		...
		/// </summary>
		public PlotOptionsBulletSonificationTracksMappingFrequency Frequency { get; set; }
		private PlotOptionsBulletSonificationTracksMappingFrequency Frequency_DefaultValue { get; set; }
		...
		/// </summary>
		public PlotOptionsBulletSonificationTracksMappingGapBetweenNotes GapBetweenNotes { get; set; }
		private PlotOptionsBulletSonificationTracksMappingGapBetweenNotes GapBetweenNotes_DefaultValue { get; set; }
		...
		/// </summary>
		public PlotOptionsBulletSonificationTracksMappingHighpass Highpass { get; set; }
		private PlotOptionsBulletSonificationTracksMappingHighpass Highpass_DefaultValue { get; set; }
		...
		/// </summary>
		public PlotOptionsBulletSonificationTracksMappingLowpass Lowpass { get; set; }
		private PlotOptionsBulletSonificationTracksMappingLowpass Lowpass_DefaultValue { get; set; }
		...
		/// </summary>
		public PlotOptionsBulletSonificationTracksMappingNoteDuration NoteDuration { get; set; }
		private PlotOptionsBulletSonificationTracksMappingNoteDuration NoteDuration_DefaultValue { get; set; }
		...
		/// </summary>
		public PlotOptionsBulletSonificationTracksMappingPan Pan { get; set; }
		private PlotOptionsBulletSonificationTracksMappingPan Pan_DefaultValue { get; set; }
		...
		/// </summary>
		public PlotOptionsBulletSonificationTracksMappingPitch Pitch { get; set; }
		private PlotOptionsBulletSonificationTracksMappingPitch Pitch_DefaultValue { get; set; }
		...
		/// </summary>
		public PlotOptionsBulletSonificationTracksMappingPlayDelay PlayDelay { get; set; }
		private PlotOptionsBulletSonificationTracksMappingPlayDelay PlayDelay_DefaultValue { get; set; }
		...
		/// </summary>
		public PlotOptionsBulletSonificationTracksMappingTime Time { get; set; }
		private PlotOptionsBulletSonificationTracksMappingTime Time_DefaultValue { get; set; }
		...
		/// </summary>
		public PlotOptionsBulletSonificationTracksMappingTremolo Tremolo { get; set; }
		private PlotOptionsBulletSonificationTracksMappingTremolo Tremolo_DefaultValue { get; set; }
		 

		/// <summary>
		/// The volume of notes, from 0 to 1.
		/// </summary>
		public PlotOptionsBulletSonificationTracksMappingVolume Volume { get; set; }
		private PlotOptionsBulletSonificationTracksMappingVolume Volume_DefaultValue { get; set; }
