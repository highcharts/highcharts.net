...
{
	public partial class PlotOptionsBulletSonificationTracksMappingNoteDuration  : BaseObject
	{
		Hashtable h = new Hashtable();

		public PlotOptionsBulletSonificationTracksMappingNoteDuration()
		{
			MapFunction = MapFunction_DefaultValue = PlotOptionsBulletSonificationTracksMappingNoteDurationMapFunction.Linear;
			MapTo = MapTo_DefaultValue = "";
			Max = Max_DefaultValue = null;
			Min = Min_DefaultValue = null;
			Value = Value_DefaultValue = null;
			Within = Within_DefaultValue = PlotOptionsBulletSonificationTracksMappingNoteDurationWithin.Chart;
		...
		/// </summary>
		public PlotOptionsBulletSonificationTracksMappingNoteDurationMapFunction MapFunction { get; set; }
		private PlotOptionsBulletSonificationTracksMappingNoteDurationMapFunction MapFunction_DefaultValue { get; set; }
		...
		/// </summary>
		public PlotOptionsBulletSonificationTracksMappingNoteDurationWithin Within { get; set; }
		private PlotOptionsBulletSonificationTracksMappingNoteDurationWithin Within_DefaultValue { get; set; }
