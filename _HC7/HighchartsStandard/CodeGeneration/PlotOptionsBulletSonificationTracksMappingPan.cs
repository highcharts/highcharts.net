...
{
	public partial class PlotOptionsBulletSonificationTracksMappingPan  : BaseObject
	{
		Hashtable h = new Hashtable();

		public PlotOptionsBulletSonificationTracksMappingPan()
		{
			MapFunction = MapFunction_DefaultValue = PlotOptionsBulletSonificationTracksMappingPanMapFunction.Linear;
			MapTo = MapTo_DefaultValue = "";
			Max = Max_DefaultValue = null;
			Min = Min_DefaultValue = null;
			Value = Value_DefaultValue = null;
			Within = Within_DefaultValue = PlotOptionsBulletSonificationTracksMappingPanWithin.Chart;
		...
		/// </summary>
		public PlotOptionsBulletSonificationTracksMappingPanMapFunction MapFunction { get; set; }
		private PlotOptionsBulletSonificationTracksMappingPanMapFunction MapFunction_DefaultValue { get; set; }
		...
		/// </summary>
		public PlotOptionsBulletSonificationTracksMappingPanWithin Within { get; set; }
		private PlotOptionsBulletSonificationTracksMappingPanWithin Within_DefaultValue { get; set; }
