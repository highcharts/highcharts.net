...
{
	public partial class PlotOptionsBulletSonificationTracksMappingPitch  : BaseObject
	{
		Hashtable h = new Hashtable();

		public PlotOptionsBulletSonificationTracksMappingPitch()
		{
			MapFunction = MapFunction_DefaultValue = PlotOptionsBulletSonificationTracksMappingPitchMapFunction.Linear;
		...
		/// </summary>
		public PlotOptionsBulletSonificationTracksMappingPitchMapFunction MapFunction { get; set; }
		private PlotOptionsBulletSonificationTracksMappingPitchMapFunction MapFunction_DefaultValue { get; set; }
