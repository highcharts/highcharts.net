...
{
	public partial class PlotOptionsBulletSonificationTracksMappingTime  : BaseObject
	{
		Hashtable h = new Hashtable();

		public PlotOptionsBulletSonificationTracksMappingTime()
		{
			MapFunction = MapFunction_DefaultValue = PlotOptionsBulletSonificationTracksMappingTimeMapFunction.Linear;
			MapTo = MapTo_DefaultValue = "";
			Max = Max_DefaultValue = null;
			Min = Min_DefaultValue = null;
			Value = Value_DefaultValue = null;
			Within = Within_DefaultValue = PlotOptionsBulletSonificationTracksMappingTimeWithin.Chart;
		...
		/// </summary>
		public PlotOptionsBulletSonificationTracksMappingTimeMapFunction MapFunction { get; set; }
		private PlotOptionsBulletSonificationTracksMappingTimeMapFunction MapFunction_DefaultValue { get; set; }
		...
		/// </summary>
		public PlotOptionsBulletSonificationTracksMappingTimeWithin Within { get; set; }
		private PlotOptionsBulletSonificationTracksMappingTimeWithin Within_DefaultValue { get; set; }
