...
{
	public partial class PlotOptionsBulletSonificationTracksPointGrouping  : BaseObject
	{
		Hashtable h = new Hashtable();

		public PlotOptionsBulletSonificationTracksPointGrouping()
		{
		...
		/// </summary>
		public PlotOptionsBulletSonificationTracksPointGroupingAlgorithm Algorithm { get; set; }
		private PlotOptionsBulletSonificationTracksPointGroupingAlgorithm Algorithm_DefaultValue { get; set; }
		...
		internal override Hashtable ToHashtable(Highcharts highcharts)
		{
			...
			if (Algorithm != PlotOptionsBulletSonificationTracksPointGroupingAlgorithm.Null) h.Add("algorithm", highcharts.FirstCharacterToLower(Algorithm.ToString()));
