...
namespace Highsoft.Web.Mvc.Charts
{
	public partial class PlotOptionsColumn  : BaseObject
	{
		...
		internal override Hashtable ToHashtable()
		{
			...
			if (PointDescriptionFormatter != PointDescriptionFormatter_DefaultValue) { h.Add("pointDescriptionFormatter",PointDescriptionFormatter); Highcharts.AddFunction("1732f879-6a1d-4743-aa35-9a4bd3cdd97a.pointDescriptionFormatter", PointDescriptionFormatter); }  
