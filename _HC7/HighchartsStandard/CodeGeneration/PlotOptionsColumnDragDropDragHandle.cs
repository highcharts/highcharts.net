...
namespace Highsoft.Web.Mvc.Charts
{
	public partial class PlotOptionsColumnDragDropDragHandle  : BaseObject
	{
		...
		internal override Hashtable ToHashtable()
		{
			...
			if (PathFormatter != PathFormatter_DefaultValue) { h.Add("pathFormatter",PathFormatter); Highcharts.AddFunction("8c813982-6218-4b4f-887a-1c0fa3efcbef.pathFormatter", PathFormatter); }  
