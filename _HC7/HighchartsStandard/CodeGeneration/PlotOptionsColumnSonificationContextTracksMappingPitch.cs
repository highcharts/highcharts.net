...
{
	public partial class PlotOptionsColumnSonificationContextTracksMappingPitch  : BaseObject
	{
		Hashtable h = new Hashtable();

		public PlotOptionsColumnSonificationContextTracksMappingPitch()
		{
			MapFunction = MapFunction_DefaultValue = PlotOptionsColumnSonificationContextTracksMappingPitchMapFunction.Linear;
		...
		/// </summary>
		public PlotOptionsColumnSonificationContextTracksMappingPitchMapFunction MapFunction { get; set; }
		private PlotOptionsColumnSonificationContextTracksMappingPitchMapFunction MapFunction_DefaultValue { get; set; }
