...
{
	public partial class PlotOptionsColumnSonificationContextTracksMappingVolume  : BaseObject
	{
		Hashtable h = new Hashtable();

		public PlotOptionsColumnSonificationContextTracksMappingVolume()
		{
			MapFunction = MapFunction_DefaultValue = PlotOptionsColumnSonificationContextTracksMappingVolumeMapFunction.Linear;
			MapTo = MapTo_DefaultValue = "";
			Max = Max_DefaultValue = null;
			Min = Min_DefaultValue = null;
			Value = Value_DefaultValue = null;
			Within = Within_DefaultValue = PlotOptionsColumnSonificationContextTracksMappingVolumeWithin.Chart;
		...
		/// </summary>
		public PlotOptionsColumnSonificationContextTracksMappingVolumeMapFunction MapFunction { get; set; }
		private PlotOptionsColumnSonificationContextTracksMappingVolumeMapFunction MapFunction_DefaultValue { get; set; }
		...
		/// </summary>
		public PlotOptionsColumnSonificationContextTracksMappingVolumeWithin Within { get; set; }
		private PlotOptionsColumnSonificationContextTracksMappingVolumeWithin Within_DefaultValue { get; set; }
