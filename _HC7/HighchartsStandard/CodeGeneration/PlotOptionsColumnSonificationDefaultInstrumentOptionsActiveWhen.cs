...
{
	public partial class PlotOptionsColumnSonificationDefaultInstrumentOptionsActiveWhen  : BaseObject
	{
		Hashtable h = new Hashtable();

		public PlotOptionsColumnSonificationDefaultInstrumentOptionsActiveWhen()
		{
		}	
