...
{
	public partial class PlotOptionsColumnSonificationDefaultInstrumentOptionsMappingNoteDuration  : BaseObject
	{
		Hashtable h = new Hashtable();

		public PlotOptionsColumnSonificationDefaultInstrumentOptionsMappingNoteDuration()
		{
			MapFunction = MapFunction_DefaultValue = PlotOptionsColumnSonificationDefaultInstrumentOptionsMappingNoteDurationMapFunction.Linear;
			MapTo = MapTo_DefaultValue = "";
			Max = Max_DefaultValue = null;
			Min = Min_DefaultValue = null;
			Value = Value_DefaultValue = null;
			Within = Within_DefaultValue = PlotOptionsColumnSonificationDefaultInstrumentOptionsMappingNoteDurationWithin.Chart;
		...
		/// </summary>
		public PlotOptionsColumnSonificationDefaultInstrumentOptionsMappingNoteDurationMapFunction MapFunction { get; set; }
		private PlotOptionsColumnSonificationDefaultInstrumentOptionsMappingNoteDurationMapFunction MapFunction_DefaultValue { get; set; }
		...
		/// </summary>
		public PlotOptionsColumnSonificationDefaultInstrumentOptionsMappingNoteDurationWithin Within { get; set; }
		private PlotOptionsColumnSonificationDefaultInstrumentOptionsMappingNoteDurationWithin Within_DefaultValue { get; set; }
