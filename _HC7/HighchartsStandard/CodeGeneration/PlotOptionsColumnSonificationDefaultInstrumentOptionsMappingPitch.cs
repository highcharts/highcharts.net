...
{
	public partial class PlotOptionsColumnSonificationDefaultInstrumentOptionsMappingPitch  : BaseObject
	{
		Hashtable h = new Hashtable();

		public PlotOptionsColumnSonificationDefaultInstrumentOptionsMappingPitch()
		{
			MapFunction = MapFunction_DefaultValue = PlotOptionsColumnSonificationDefaultInstrumentOptionsMappingPitchMapFunction.Linear;
		...
		/// </summary>
		public PlotOptionsColumnSonificationDefaultInstrumentOptionsMappingPitchMapFunction MapFunction { get; set; }
		private PlotOptionsColumnSonificationDefaultInstrumentOptionsMappingPitchMapFunction MapFunction_DefaultValue { get; set; }
