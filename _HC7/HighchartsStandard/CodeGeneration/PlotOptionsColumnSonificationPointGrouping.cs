...
{
	public partial class PlotOptionsColumnSonificationPointGrouping  : BaseObject
	{
		Hashtable h = new Hashtable();

		public PlotOptionsColumnSonificationPointGrouping()
		{
		...
		/// </summary>
		public PlotOptionsColumnSonificationPointGroupingAlgorithm Algorithm { get; set; }
		private PlotOptionsColumnSonificationPointGroupingAlgorithm Algorithm_DefaultValue { get; set; }
		...
		internal override Hashtable ToHashtable(Highcharts highcharts)
		{
			...
			if (Algorithm != PlotOptionsColumnSonificationPointGroupingAlgorithm.Null) h.Add("algorithm", highcharts.FirstCharacterToLower(Algorithm.ToString()));
