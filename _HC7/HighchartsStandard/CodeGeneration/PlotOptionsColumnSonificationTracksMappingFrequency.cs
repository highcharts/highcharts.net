...
{
	public partial class PlotOptionsColumnSonificationTracksMappingFrequency  : BaseObject
	{
		Hashtable h = new Hashtable();

		public PlotOptionsColumnSonificationTracksMappingFrequency()
		{
			MapFunction = MapFunction_DefaultValue = PlotOptionsColumnSonificationTracksMappingFrequencyMapFunction.Linear;
			MapTo = MapTo_DefaultValue = "";
			Max = Max_DefaultValue = null;
			Min = Min_DefaultValue = null;
			Value = Value_DefaultValue = null;
			Within = Within_DefaultValue = PlotOptionsColumnSonificationTracksMappingFrequencyWithin.Chart;
		...
		/// </summary>
		public PlotOptionsColumnSonificationTracksMappingFrequencyMapFunction MapFunction { get; set; }
		private PlotOptionsColumnSonificationTracksMappingFrequencyMapFunction MapFunction_DefaultValue { get; set; }
		...
		/// </summary>
		public PlotOptionsColumnSonificationTracksMappingFrequencyWithin Within { get; set; }
		private PlotOptionsColumnSonificationTracksMappingFrequencyWithin Within_DefaultValue { get; set; }
