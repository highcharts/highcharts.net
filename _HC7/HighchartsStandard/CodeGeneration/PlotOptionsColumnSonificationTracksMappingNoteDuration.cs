...
{
	public partial class PlotOptionsColumnSonificationTracksMappingNoteDuration  : BaseObject
	{
		Hashtable h = new Hashtable();

		public PlotOptionsColumnSonificationTracksMappingNoteDuration()
		{
			MapFunction = MapFunction_DefaultValue = PlotOptionsColumnSonificationTracksMappingNoteDurationMapFunction.Linear;
			MapTo = MapTo_DefaultValue = "";
			Max = Max_DefaultValue = null;
			Min = Min_DefaultValue = null;
			Value = Value_DefaultValue = null;
			Within = Within_DefaultValue = PlotOptionsColumnSonificationTracksMappingNoteDurationWithin.Chart;
		...
		/// </summary>
		public PlotOptionsColumnSonificationTracksMappingNoteDurationMapFunction MapFunction { get; set; }
		private PlotOptionsColumnSonificationTracksMappingNoteDurationMapFunction MapFunction_DefaultValue { get; set; }
		...
		/// </summary>
		public PlotOptionsColumnSonificationTracksMappingNoteDurationWithin Within { get; set; }
		private PlotOptionsColumnSonificationTracksMappingNoteDurationWithin Within_DefaultValue { get; set; }
