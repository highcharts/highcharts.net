...
{
	public partial class PlotOptionsColumnSonificationTracksMappingPan  : BaseObject
	{
		Hashtable h = new Hashtable();

		public PlotOptionsColumnSonificationTracksMappingPan()
		{
			MapFunction = MapFunction_DefaultValue = PlotOptionsColumnSonificationTracksMappingPanMapFunction.Linear;
			MapTo = MapTo_DefaultValue = "";
			Max = Max_DefaultValue = null;
			Min = Min_DefaultValue = null;
			Value = Value_DefaultValue = null;
			Within = Within_DefaultValue = PlotOptionsColumnSonificationTracksMappingPanWithin.Chart;
		...
		/// </summary>
		public PlotOptionsColumnSonificationTracksMappingPanMapFunction MapFunction { get; set; }
		private PlotOptionsColumnSonificationTracksMappingPanMapFunction MapFunction_DefaultValue { get; set; }
		...
		/// </summary>
		public PlotOptionsColumnSonificationTracksMappingPanWithin Within { get; set; }
		private PlotOptionsColumnSonificationTracksMappingPanWithin Within_DefaultValue { get; set; }
