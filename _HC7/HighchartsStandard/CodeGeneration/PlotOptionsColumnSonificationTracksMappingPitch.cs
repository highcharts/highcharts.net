...
{
	public partial class PlotOptionsColumnSonificationTracksMappingPitch  : BaseObject
	{
		Hashtable h = new Hashtable();

		public PlotOptionsColumnSonificationTracksMappingPitch()
		{
			MapFunction = MapFunction_DefaultValue = PlotOptionsColumnSonificationTracksMappingPitchMapFunction.Linear;
		...
		/// </summary>
		public PlotOptionsColumnSonificationTracksMappingPitchMapFunction MapFunction { get; set; }
		private PlotOptionsColumnSonificationTracksMappingPitchMapFunction MapFunction_DefaultValue { get; set; }
