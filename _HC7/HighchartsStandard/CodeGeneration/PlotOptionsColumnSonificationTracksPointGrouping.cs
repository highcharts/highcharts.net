...
{
	public partial class PlotOptionsColumnSonificationTracksPointGrouping  : BaseObject
	{
		Hashtable h = new Hashtable();

		public PlotOptionsColumnSonificationTracksPointGrouping()
		{
		...
		/// </summary>
		public PlotOptionsColumnSonificationTracksPointGroupingAlgorithm Algorithm { get; set; }
		private PlotOptionsColumnSonificationTracksPointGroupingAlgorithm Algorithm_DefaultValue { get; set; }
		...
		internal override Hashtable ToHashtable(Highcharts highcharts)
		{
			...
			if (Algorithm != PlotOptionsColumnSonificationTracksPointGroupingAlgorithm.Null) h.Add("algorithm", highcharts.FirstCharacterToLower(Algorithm.ToString()));
