...
{
	public partial class PlotOptionsColumnpyramidSonificationContextTracksMappingPitch  : BaseObject
	{
		Hashtable h = new Hashtable();

		public PlotOptionsColumnpyramidSonificationContextTracksMappingPitch()
		{
			MapFunction = MapFunction_DefaultValue = PlotOptionsColumnpyramidSonificationContextTracksMappingPitchMapFunction.Linear;
		...
		/// </summary>
		public PlotOptionsColumnpyramidSonificationContextTracksMappingPitchMapFunction MapFunction { get; set; }
		private PlotOptionsColumnpyramidSonificationContextTracksMappingPitchMapFunction MapFunction_DefaultValue { get; set; }
