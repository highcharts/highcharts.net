...
{
	public partial class PlotOptionsColumnpyramidSonificationDefaultInstrumentOptionsActiveWhen  : BaseObject
	{
		Hashtable h = new Hashtable();

		public PlotOptionsColumnpyramidSonificationDefaultInstrumentOptionsActiveWhen()
		{
