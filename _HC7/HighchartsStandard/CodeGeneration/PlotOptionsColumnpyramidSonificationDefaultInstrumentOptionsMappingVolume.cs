...
{
	public partial class PlotOptionsColumnpyramidSonificationDefaultInstrumentOptionsMappingVolume  : BaseObject
	{
		Hashtable h = new Hashtable();

		public PlotOptionsColumnpyramidSonificationDefaultInstrumentOptionsMappingVolume()
		{
			MapFunction = MapFunction_DefaultValue = PlotOptionsColumnpyramidSonificationDefaultInstrumentOptionsMappingVolumeMapFunction.Linear;
			MapTo = MapTo_DefaultValue = "";
			Max = Max_DefaultValue = null;
			Min = Min_DefaultValue = null;
			Value = Value_DefaultValue = null;
			Within = Within_DefaultValue = PlotOptionsColumnpyramidSonificationDefaultInstrumentOptionsMappingVolumeWithin.Chart;
		...
		/// </summary>
		public PlotOptionsColumnpyramidSonificationDefaultInstrumentOptionsMappingVolumeMapFunction MapFunction { get; set; }
		private PlotOptionsColumnpyramidSonificationDefaultInstrumentOptionsMappingVolumeMapFunction MapFunction_DefaultValue { get; set; }
		...
		/// </summary>
		public PlotOptionsColumnpyramidSonificationDefaultInstrumentOptionsMappingVolumeWithin Within { get; set; }
		private PlotOptionsColumnpyramidSonificationDefaultInstrumentOptionsMappingVolumeWithin Within_DefaultValue { get; set; }
