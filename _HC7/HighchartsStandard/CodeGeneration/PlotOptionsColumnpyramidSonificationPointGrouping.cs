...
{
	public partial class PlotOptionsColumnpyramidSonificationPointGrouping  : BaseObject
	{
		Hashtable h = new Hashtable();

		public PlotOptionsColumnpyramidSonificationPointGrouping()
		{
		...
		/// </summary>
		public PlotOptionsColumnpyramidSonificationPointGroupingAlgorithm Algorithm { get; set; }
		private PlotOptionsColumnpyramidSonificationPointGroupingAlgorithm Algorithm_DefaultValue { get; set; }
		...
		internal override Hashtable ToHashtable(Highcharts highcharts)
		{
			...
			if (Algorithm != PlotOptionsColumnpyramidSonificationPointGroupingAlgorithm.Null) h.Add("algorithm", highcharts.FirstCharacterToLower(Algorithm.ToString()));
