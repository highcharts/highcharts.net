...
{
	public partial class PlotOptionsColumnpyramidSonificationTracks  : BaseObject
	{
		Hashtable h = new Hashtable();

		public PlotOptionsColumnpyramidSonificationTracks()
		{
			ActiveWhen = ActiveWhen_DefaultValue = new PlotOptionsColumnpyramidSonificationTracksActiveWhen();
			Instrument = Instrument_DefaultValue = null;
			InstrumentString = InstrumentString_DefaultValue = "null";
			Mapping = Mapping_DefaultValue = new PlotOptionsColumnpyramidSonificationTracksMapping();
			MidiName = MidiName_DefaultValue = "";
			PointGrouping = PointGrouping_DefaultValue = new PlotOptionsColumnpyramidSonificationTracksPointGrouping();
			RoundToMusicalNotes = RoundToMusicalNotes_DefaultValue = true;
			ShowPlayMarker = ShowPlayMarker_DefaultValue = true;
			Type = Type_DefaultValue = PlotOptionsColumnpyramidSonificationTracksType.Instrument;
		...
		/// </summary>
		public PlotOptionsColumnpyramidSonificationTracksActiveWhen ActiveWhen { get; set; }
		private PlotOptionsColumnpyramidSonificationTracksActiveWhen ActiveWhen_DefaultValue { get; set; }
		...
		/// </summary>
		public PlotOptionsColumnpyramidSonificationTracksMapping Mapping { get; set; }
		private PlotOptionsColumnpyramidSonificationTracksMapping Mapping_DefaultValue { get; set; }
		...
		/// </summary>
		public PlotOptionsColumnpyramidSonificationTracksPointGrouping PointGrouping { get; set; }
		private PlotOptionsColumnpyramidSonificationTracksPointGrouping PointGrouping_DefaultValue { get; set; }
		...
		/// </summary>
		public PlotOptionsColumnpyramidSonificationTracksType Type { get; set; }
		private PlotOptionsColumnpyramidSonificationTracksType Type_DefaultValue { get; set; }
