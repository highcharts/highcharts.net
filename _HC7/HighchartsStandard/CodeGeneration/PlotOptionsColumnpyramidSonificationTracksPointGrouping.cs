...
{
	public partial class PlotOptionsColumnpyramidSonificationTracksPointGrouping  : BaseObject
	{
		Hashtable h = new Hashtable();

		public PlotOptionsColumnpyramidSonificationTracksPointGrouping()
		{
		...
		/// </summary>
		public PlotOptionsColumnpyramidSonificationTracksPointGroupingAlgorithm Algorithm { get; set; }
		private PlotOptionsColumnpyramidSonificationTracksPointGroupingAlgorithm Algorithm_DefaultValue { get; set; }
		...
		internal override Hashtable ToHashtable(Highcharts highcharts)
		{
			...
			if (Algorithm != PlotOptionsColumnpyramidSonificationTracksPointGroupingAlgorithm.Null) h.Add("algorithm", highcharts.FirstCharacterToLower(Algorithm.ToString()));
