...
{
	public partial class PlotOptionsColumnpyramidTooltip  : BaseObject
	{
		public PlotOptionsColumnpyramidTooltip()
		{
			...
			HeaderShape = HeaderShape_DefaultValue = PlotOptionsColumnpyramidTooltipHeaderShape.Callout;
		...
		/// </summary>
		public PlotOptionsColumnpyramidTooltipHeaderShape HeaderShape { get; set; }
		private PlotOptionsColumnpyramidTooltipHeaderShape HeaderShape_DefaultValue { get; set; }
		...
		internal override Hashtable ToHashtable()
		{
			...
			if (NullFormatter != NullFormatter_DefaultValue) { h.Add("nullFormatter",NullFormatter); Highcharts.AddFunction("PlotOptionsColumnpyramidTooltipNullFormatter.nullFormatter", NullFormatter); }  
			if (Outside != Outside_DefaultValue) h.Add("outside",Outside);
			if (Padding != Padding_DefaultValue) h.Add("padding",Padding);
			if (PointFormat != PointFormat_DefaultValue) h.Add("pointFormat",PointFormat);
			if (PointFormatter != PointFormatter_DefaultValue) { h.Add("pointFormatter",PointFormatter); Highcharts.AddFunction("PlotOptionsColumnpyramidTooltipPointFormatter.pointFormatter", PointFormatter); }  
