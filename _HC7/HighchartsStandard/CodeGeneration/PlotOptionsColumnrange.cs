...
namespace Highsoft.Web.Mvc.Charts
{
	public partial class PlotOptionsColumnrange  : BaseObject
	{
		...
		/// </summary>
		public PlotOptionsColumnrangePointPlacement PointPlacement { get; set; }
		private PlotOptionsColumnrangePointPlacement PointPlacement_DefaultValue { get; set; }
		...
		internal override Hashtable ToHashtable(Highcharts highcharts)
		{
			...
			if (BoostBlending != PlotOptionsColumnrangeBoostBlending.Null) h.Add("boostBlending", highcharts.FirstCharacterToLower(BoostBlending.ToString()));
			if (BoostThreshold != null) h.Add("boostThreshold",BoostThreshold);
			if (BorderColor != null) h.Add("borderColor",BorderColor);
			if (BorderRadius != null) h.Add("borderRadius",BorderRadius.ToHashtable(highcharts));
			...
			if (Cursor != PlotOptionsColumnrangeCursor.Null) h.Add("cursor", highcharts.FirstCharacterToLower(Cursor.ToString()));
			if (Custom != null) h.Add("custom",Custom);
			if (DashStyle != PlotOptionsColumnrangeDashStyle.Null) h.Add("dashStyle", highcharts.FirstCharacterToLower(DashStyle.ToString()));
			...
			if (FindNearestPointBy != PlotOptionsColumnrangeFindNearestPointBy.Null) h.Add("findNearestPointBy", highcharts.FirstCharacterToLower(FindNearestPointBy.ToString()));
			...
			if (PointIntervalUnit != PlotOptionsColumnrangePointIntervalUnit.Null) h.Add("pointIntervalUnit", highcharts.FirstCharacterToLower(PointIntervalUnit.ToString()));
			if (PointPadding != null) h.Add("pointPadding",PointPadding);
			if (PointPlacement != PlotOptionsColumnrangePointPlacement.Null) h.Add("pointPlacement", highcharts.FirstCharacterToLower(PointPlacement.ToString()));
