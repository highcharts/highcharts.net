...
{
	public partial class PlotOptionsColumnrangeSonificationContextTracks  : BaseObject
	{
		Hashtable h = new Hashtable();

		public PlotOptionsColumnrangeSonificationContextTracks()
		{
			ActiveWhen = ActiveWhen_DefaultValue = new PlotOptionsColumnrangeSonificationContextTracksActiveWhen();
			Instrument = Instrument_DefaultValue = null;
			InstrumentString = InstrumentString_DefaultValue = "null";
			Mapping = Mapping_DefaultValue = new PlotOptionsColumnrangeSonificationContextTracksMapping();
			MidiName = MidiName_DefaultValue = "";
			PointGrouping = PointGrouping_DefaultValue = new PlotOptionsColumnrangeSonificationContextTracksPointGrouping();
			...
			Type = Type_DefaultValue = PlotOptionsColumnrangeSonificationContextTracksType.Instrument;
			ValueInterval = ValueInterval_DefaultValue = null;
			ValueMapFunction = ValueMapFunction_DefaultValue = PlotOptionsColumnrangeSonificationContextTracksValueMapFunction.Linear;
		...
		/// </summary>
		public PlotOptionsColumnrangeSonificationContextTracksActiveWhen ActiveWhen { get; set; }
		private PlotOptionsColumnrangeSonificationContextTracksActiveWhen ActiveWhen_DefaultValue { get; set; }
		...
		/// </summary>
		public PlotOptionsColumnrangeSonificationContextTracksMapping Mapping { get; set; }
		private PlotOptionsColumnrangeSonificationContextTracksMapping Mapping_DefaultValue { get; set; }
		...
		/// </summary>
		public PlotOptionsColumnrangeSonificationContextTracksPointGrouping PointGrouping { get; set; }
		private PlotOptionsColumnrangeSonificationContextTracksPointGrouping PointGrouping_DefaultValue { get; set; }
		...
		/// </summary>
		public PlotOptionsColumnrangeSonificationContextTracksType Type { get; set; }
		private PlotOptionsColumnrangeSonificationContextTracksType Type_DefaultValue { get; set; }
		...
		/// </summary>
		public PlotOptionsColumnrangeSonificationContextTracksValueMapFunction ValueMapFunction { get; set; }
		private PlotOptionsColumnrangeSonificationContextTracksValueMapFunction ValueMapFunction_DefaultValue { get; set; }
