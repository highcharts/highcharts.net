...
{
	public partial class PlotOptionsColumnrangeSonificationContextTracksMapping  : BaseObject
	{
		Hashtable h = new Hashtable();

		public PlotOptionsColumnrangeSonificationContextTracksMapping()
		{
			Frequency = Frequency_DefaultValue = new PlotOptionsColumnrangeSonificationContextTracksMappingFrequency();
			GapBetweenNotes = GapBetweenNotes_DefaultValue = new PlotOptionsColumnrangeSonificationContextTracksMappingGapBetweenNotes();
			Highpass = Highpass_DefaultValue = new PlotOptionsColumnrangeSonificationContextTracksMappingHighpass();
			Lowpass = Lowpass_DefaultValue = new PlotOptionsColumnrangeSonificationContextTracksMappingLowpass();
			NoteDuration = NoteDuration_DefaultValue = new PlotOptionsColumnrangeSonificationContextTracksMappingNoteDuration();
			Pan = Pan_DefaultValue = new PlotOptionsColumnrangeSonificationContextTracksMappingPan();
			Pitch = Pitch_DefaultValue = new PlotOptionsColumnrangeSonificationContextTracksMappingPitch();
			PitchString = PitchString_DefaultValue = "null";
			PitchNumber = PitchNumber_DefaultValue = null;
			PlayDelay = PlayDelay_DefaultValue = new PlotOptionsColumnrangeSonificationContextTracksMappingPlayDelay();
			Time = Time_DefaultValue = new PlotOptionsColumnrangeSonificationContextTracksMappingTime();
			TimeString = TimeString_DefaultValue = "null";
			TimeNumber = TimeNumber_DefaultValue = null;
			Tremolo = Tremolo_DefaultValue = new PlotOptionsColumnrangeSonificationContextTracksMappingTremolo();
			Volume = Volume_DefaultValue = new PlotOptionsColumnrangeSonificationContextTracksMappingVolume();
		...
		/// </summary>
		public PlotOptionsColumnrangeSonificationContextTracksMappingFrequency Frequency { get; set; }
		private PlotOptionsColumnrangeSonificationContextTracksMappingFrequency Frequency_DefaultValue { get; set; }
		...
		/// </summary>
		public PlotOptionsColumnrangeSonificationContextTracksMappingGapBetweenNotes GapBetweenNotes { get; set; }
		private PlotOptionsColumnrangeSonificationContextTracksMappingGapBetweenNotes GapBetweenNotes_DefaultValue { get; set; }
		...
		/// </summary>
		public PlotOptionsColumnrangeSonificationContextTracksMappingHighpass Highpass { get; set; }
		private PlotOptionsColumnrangeSonificationContextTracksMappingHighpass Highpass_DefaultValue { get; set; }
		...
		/// </summary>
		public PlotOptionsColumnrangeSonificationContextTracksMappingLowpass Lowpass { get; set; }
		private PlotOptionsColumnrangeSonificationContextTracksMappingLowpass Lowpass_DefaultValue { get; set; }
		...
		/// </summary>
		public PlotOptionsColumnrangeSonificationContextTracksMappingNoteDuration NoteDuration { get; set; }
		private PlotOptionsColumnrangeSonificationContextTracksMappingNoteDuration NoteDuration_DefaultValue { get; set; }
		...
		/// </summary>
		public PlotOptionsColumnrangeSonificationContextTracksMappingPan Pan { get; set; }
		private PlotOptionsColumnrangeSonificationContextTracksMappingPan Pan_DefaultValue { get; set; }
		...
		/// </summary>
		public PlotOptionsColumnrangeSonificationContextTracksMappingPitch Pitch { get; set; }
		private PlotOptionsColumnrangeSonificationContextTracksMappingPitch Pitch_DefaultValue { get; set; }
		...
		/// </summary>
		public PlotOptionsColumnrangeSonificationContextTracksMappingPlayDelay PlayDelay { get; set; }
		private PlotOptionsColumnrangeSonificationContextTracksMappingPlayDelay PlayDelay_DefaultValue { get; set; }
		...
		/// </summary>
		public PlotOptionsColumnrangeSonificationContextTracksMappingTime Time { get; set; }
		private PlotOptionsColumnrangeSonificationContextTracksMappingTime Time_DefaultValue { get; set; }
		...
		/// </summary>
		public PlotOptionsColumnrangeSonificationContextTracksMappingTremolo Tremolo { get; set; }
		private PlotOptionsColumnrangeSonificationContextTracksMappingTremolo Tremolo_DefaultValue { get; set; }
		 

		/// <summary>
		/// The volume of notes, from 0 to 1.
		/// </summary>
		public PlotOptionsColumnrangeSonificationContextTracksMappingVolume Volume { get; set; }
		private PlotOptionsColumnrangeSonificationContextTracksMappingVolume Volume_DefaultValue { get; set; }
