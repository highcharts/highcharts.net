...
{
	public partial class PlotOptionsColumnrangeSonificationContextTracksMappingPitch  : BaseObject
	{
		Hashtable h = new Hashtable();

		public PlotOptionsColumnrangeSonificationContextTracksMappingPitch()
		{
			MapFunction = MapFunction_DefaultValue = PlotOptionsColumnrangeSonificationContextTracksMappingPitchMapFunction.Linear;
		...
		/// </summary>
		public PlotOptionsColumnrangeSonificationContextTracksMappingPitchMapFunction MapFunction { get; set; }
		private PlotOptionsColumnrangeSonificationContextTracksMappingPitchMapFunction MapFunction_DefaultValue { get; set; }
