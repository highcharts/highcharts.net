...
{
	public partial class PlotOptionsColumnrangeSonificationPointGrouping  : BaseObject
	{
		Hashtable h = new Hashtable();

		public PlotOptionsColumnrangeSonificationPointGrouping()
		{
		...
		/// </summary>
		public PlotOptionsColumnrangeSonificationPointGroupingAlgorithm Algorithm { get; set; }
		private PlotOptionsColumnrangeSonificationPointGroupingAlgorithm Algorithm_DefaultValue { get; set; }
		...
		internal override Hashtable ToHashtable(Highcharts highcharts)
		{
			...
			if (Algorithm != PlotOptionsColumnrangeSonificationPointGroupingAlgorithm.Null) h.Add("algorithm", highcharts.FirstCharacterToLower(Algorithm.ToString()));
