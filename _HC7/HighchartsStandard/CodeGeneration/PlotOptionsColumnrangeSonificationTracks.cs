...
{
	public partial class PlotOptionsColumnrangeSonificationTracks  : BaseObject
	{
		Hashtable h = new Hashtable();

		public PlotOptionsColumnrangeSonificationTracks()
		{
			ActiveWhen = ActiveWhen_DefaultValue = new PlotOptionsColumnrangeSonificationTracksActiveWhen();
			Instrument = Instrument_DefaultValue = null;
			InstrumentString = InstrumentString_DefaultValue = "null";
			Mapping = Mapping_DefaultValue = new PlotOptionsColumnrangeSonificationTracksMapping();
			MidiName = MidiName_DefaultValue = "";
			PointGrouping = PointGrouping_DefaultValue = new PlotOptionsColumnrangeSonificationTracksPointGrouping();
			RoundToMusicalNotes = RoundToMusicalNotes_DefaultValue = true;
			ShowPlayMarker = ShowPlayMarker_DefaultValue = true;
			Type = Type_DefaultValue = PlotOptionsColumnrangeSonificationTracksType.Instrument;
		...
		/// </summary>
		public PlotOptionsColumnrangeSonificationTracksActiveWhen ActiveWhen { get; set; }
		private PlotOptionsColumnrangeSonificationTracksActiveWhen ActiveWhen_DefaultValue { get; set; }
		...
		/// </summary>
		public PlotOptionsColumnrangeSonificationTracksMapping Mapping { get; set; }
		private PlotOptionsColumnrangeSonificationTracksMapping Mapping_DefaultValue { get; set; }
		...
		/// </summary>
		public PlotOptionsColumnrangeSonificationTracksPointGrouping PointGrouping { get; set; }
		private PlotOptionsColumnrangeSonificationTracksPointGrouping PointGrouping_DefaultValue { get; set; }
		...
		/// </summary>
		public PlotOptionsColumnrangeSonificationTracksType Type { get; set; }
		private PlotOptionsColumnrangeSonificationTracksType Type_DefaultValue { get; set; }
