...
{
	public partial class PlotOptionsColumnrangeSonificationTracksMappingLowpassResonance  : BaseObject
	{
		Hashtable h = new Hashtable();

		public PlotOptionsColumnrangeSonificationTracksMappingLowpassResonance()
		{
			MapFunction = MapFunction_DefaultValue = PlotOptionsColumnrangeSonificationTracksMappingLowpassResonanceMapFunction.Linear;
			MapTo = MapTo_DefaultValue = "";
			Max = Max_DefaultValue = null;
			Min = Min_DefaultValue = null;
			Value = Value_DefaultValue = null;
			Within = Within_DefaultValue = PlotOptionsColumnrangeSonificationTracksMappingLowpassResonanceWithin.Chart;
		...
		/// </summary>
		public PlotOptionsColumnrangeSonificationTracksMappingLowpassResonanceMapFunction MapFunction { get; set; }
		private PlotOptionsColumnrangeSonificationTracksMappingLowpassResonanceMapFunction MapFunction_DefaultValue { get; set; }
		...
		/// </summary>
		public PlotOptionsColumnrangeSonificationTracksMappingLowpassResonanceWithin Within { get; set; }
		private PlotOptionsColumnrangeSonificationTracksMappingLowpassResonanceWithin Within_DefaultValue { get; set; }
