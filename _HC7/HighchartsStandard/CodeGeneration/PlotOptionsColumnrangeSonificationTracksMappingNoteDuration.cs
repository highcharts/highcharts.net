...
{
	public partial class PlotOptionsColumnrangeSonificationTracksMappingNoteDuration  : BaseObject
	{
		Hashtable h = new Hashtable();

		public PlotOptionsColumnrangeSonificationTracksMappingNoteDuration()
		{
			MapFunction = MapFunction_DefaultValue = PlotOptionsColumnrangeSonificationTracksMappingNoteDurationMapFunction.Linear;
			MapTo = MapTo_DefaultValue = "";
			Max = Max_DefaultValue = null;
			Min = Min_DefaultValue = null;
			Value = Value_DefaultValue = null;
			Within = Within_DefaultValue = PlotOptionsColumnrangeSonificationTracksMappingNoteDurationWithin.Chart;
		...
		/// </summary>
		public PlotOptionsColumnrangeSonificationTracksMappingNoteDurationMapFunction MapFunction { get; set; }
		private PlotOptionsColumnrangeSonificationTracksMappingNoteDurationMapFunction MapFunction_DefaultValue { get; set; }
		...
		/// </summary>
		public PlotOptionsColumnrangeSonificationTracksMappingNoteDurationWithin Within { get; set; }
		private PlotOptionsColumnrangeSonificationTracksMappingNoteDurationWithin Within_DefaultValue { get; set; }
