...
{
	public partial class PlotOptionsColumnrangeSonificationTracksMappingPan  : BaseObject
	{
		Hashtable h = new Hashtable();

		public PlotOptionsColumnrangeSonificationTracksMappingPan()
		{
			MapFunction = MapFunction_DefaultValue = PlotOptionsColumnrangeSonificationTracksMappingPanMapFunction.Linear;
			MapTo = MapTo_DefaultValue = "";
			Max = Max_DefaultValue = null;
			Min = Min_DefaultValue = null;
			Value = Value_DefaultValue = null;
			Within = Within_DefaultValue = PlotOptionsColumnrangeSonificationTracksMappingPanWithin.Chart;
		...
		/// </summary>
		public PlotOptionsColumnrangeSonificationTracksMappingPanMapFunction MapFunction { get; set; }
		private PlotOptionsColumnrangeSonificationTracksMappingPanMapFunction MapFunction_DefaultValue { get; set; }
		...
		/// </summary>
		public PlotOptionsColumnrangeSonificationTracksMappingPanWithin Within { get; set; }
		private PlotOptionsColumnrangeSonificationTracksMappingPanWithin Within_DefaultValue { get; set; }
