...
{
	public partial class PlotOptionsColumnrangeSonificationTracksPointGrouping  : BaseObject
	{
		Hashtable h = new Hashtable();

		public PlotOptionsColumnrangeSonificationTracksPointGrouping()
		{
		...
		/// </summary>
		public PlotOptionsColumnrangeSonificationTracksPointGroupingAlgorithm Algorithm { get; set; }
		private PlotOptionsColumnrangeSonificationTracksPointGroupingAlgorithm Algorithm_DefaultValue { get; set; }
		...
		internal override Hashtable ToHashtable(Highcharts highcharts)
		{
			...
			if (Algorithm != PlotOptionsColumnrangeSonificationTracksPointGroupingAlgorithm.Null) h.Add("algorithm", highcharts.FirstCharacterToLower(Algorithm.ToString()));
