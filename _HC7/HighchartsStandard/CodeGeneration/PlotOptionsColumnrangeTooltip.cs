...
{
	public partial class PlotOptionsColumnrangeTooltip  : BaseObject
	{
		public PlotOptionsColumnrangeTooltip()
		{
			...
			HeaderShape = HeaderShape_DefaultValue = PlotOptionsColumnrangeTooltipHeaderShape.Callout;
		...
		/// </summary>
		public PlotOptionsColumnrangeTooltipHeaderShape HeaderShape { get; set; }
		private PlotOptionsColumnrangeTooltipHeaderShape HeaderShape_DefaultValue { get; set; }
		...
		internal override Hashtable ToHashtable()
		{
			...
			if (NullFormatter != NullFormatter_DefaultValue) { h.Add("nullFormatter",NullFormatter); Highcharts.AddFunction("PlotOptionsColumnrangeTooltipNullFormatter.nullFormatter", NullFormatter); }  
			if (Outside != Outside_DefaultValue) h.Add("outside",Outside);
			if (Padding != Padding_DefaultValue) h.Add("padding",Padding);
			if (PointFormat != PointFormat_DefaultValue) h.Add("pointFormat",PointFormat);
			if (PointFormatter != PointFormatter_DefaultValue) { h.Add("pointFormatter",PointFormatter); Highcharts.AddFunction("PlotOptionsColumnrangeTooltipPointFormatter.pointFormatter", PointFormatter); }  
