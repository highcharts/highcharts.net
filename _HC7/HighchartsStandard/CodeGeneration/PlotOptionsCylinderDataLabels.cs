...
namespace Highsoft.Web.Mvc.Charts
{
	public partial class PlotOptionsCylinderDataLabels  : BaseObject
	{
		...
		public PlotOptionsCylinderDataLabels()
		{
			...
			Overflow = Overflow_DefaultValue = PlotOptionsCylinderDataLabelsOverflow.Justify;
			Padding = Padding_DefaultValue = 5;
			Position = Position_DefaultValue = PlotOptionsCylinderDataLabelsPosition.Center;
