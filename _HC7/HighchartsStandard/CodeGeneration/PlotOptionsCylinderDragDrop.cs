...
{
	public partial class PlotOptionsCylinderDragDrop  : BaseObject
	{
		public PlotOptionsCylinderDragDrop()
		{
			DraggableX = DraggableX_DefaultValue = null;
			DraggableY = DraggableY_DefaultValue = null;
			DragHandle = DragHandle_DefaultValue = new PlotOptionsCylinderDragDropDragHandle();
			...
			GuideBox = GuideBox_DefaultValue = new PlotOptionsCylinderDragDropGuideBox();
		...
		/// </summary>
		public PlotOptionsCylinderDragDropDragHandle DragHandle { get; set; }
		private PlotOptionsCylinderDragDropDragHandle DragHandle_DefaultValue { get; set; }
		...
		/// </summary>
		public PlotOptionsCylinderDragDropGuideBox GuideBox { get; set; }
		private PlotOptionsCylinderDragDropGuideBox GuideBox_DefaultValue { get; set; }
