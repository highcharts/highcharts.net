...
{
	public partial class PlotOptionsCylinderDragDropDragHandle  : BaseObject
	{
		public PlotOptionsCylinderDragDropDragHandle()
		{
		...
		internal override Hashtable ToHashtable()
		{
			...
			if (PathFormatter != PathFormatter_DefaultValue) { h.Add("pathFormatter",PathFormatter); Highcharts.AddFunction("PlotOptionsCylinderDragDropDragHandlePathFormatter.pathFormatter", PathFormatter); }  
