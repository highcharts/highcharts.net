...
{
	public partial class PlotOptionsCylinderSonificationContextTracksMapping  : BaseObject
	{
		Hashtable h = new Hashtable();

		public PlotOptionsCylinderSonificationContextTracksMapping()
		{
			Frequency = Frequency_DefaultValue = new PlotOptionsCylinderSonificationContextTracksMappingFrequency();
			GapBetweenNotes = GapBetweenNotes_DefaultValue = new PlotOptionsCylinderSonificationContextTracksMappingGapBetweenNotes();
			Highpass = Highpass_DefaultValue = new PlotOptionsCylinderSonificationContextTracksMappingHighpass();
			Lowpass = Lowpass_DefaultValue = new PlotOptionsCylinderSonificationContextTracksMappingLowpass();
			NoteDuration = NoteDuration_DefaultValue = new PlotOptionsCylinderSonificationContextTracksMappingNoteDuration();
			Pan = Pan_DefaultValue = new PlotOptionsCylinderSonificationContextTracksMappingPan();
			Pitch = Pitch_DefaultValue = new PlotOptionsCylinderSonificationContextTracksMappingPitch();
			PitchString = PitchString_DefaultValue = "null";
			PitchNumber = PitchNumber_DefaultValue = null;
			PlayDelay = PlayDelay_DefaultValue = new PlotOptionsCylinderSonificationContextTracksMappingPlayDelay();
			Time = Time_DefaultValue = new PlotOptionsCylinderSonificationContextTracksMappingTime();
			TimeString = TimeString_DefaultValue = "null";
			TimeNumber = TimeNumber_DefaultValue = null;
			Tremolo = Tremolo_DefaultValue = new PlotOptionsCylinderSonificationContextTracksMappingTremolo();
			Volume = Volume_DefaultValue = new PlotOptionsCylinderSonificationContextTracksMappingVolume();
		...
		/// </summary>
		public PlotOptionsCylinderSonificationContextTracksMappingFrequency Frequency { get; set; }
		private PlotOptionsCylinderSonificationContextTracksMappingFrequency Frequency_DefaultValue { get; set; }
		...
		/// </summary>
		public PlotOptionsCylinderSonificationContextTracksMappingGapBetweenNotes GapBetweenNotes { get; set; }
		private PlotOptionsCylinderSonificationContextTracksMappingGapBetweenNotes GapBetweenNotes_DefaultValue { get; set; }
		...
		/// </summary>
		public PlotOptionsCylinderSonificationContextTracksMappingHighpass Highpass { get; set; }
		private PlotOptionsCylinderSonificationContextTracksMappingHighpass Highpass_DefaultValue { get; set; }
		...
		/// </summary>
		public PlotOptionsCylinderSonificationContextTracksMappingLowpass Lowpass { get; set; }
		private PlotOptionsCylinderSonificationContextTracksMappingLowpass Lowpass_DefaultValue { get; set; }
		...
		/// </summary>
		public PlotOptionsCylinderSonificationContextTracksMappingNoteDuration NoteDuration { get; set; }
		private PlotOptionsCylinderSonificationContextTracksMappingNoteDuration NoteDuration_DefaultValue { get; set; }
		...
		/// </summary>
		public PlotOptionsCylinderSonificationContextTracksMappingPan Pan { get; set; }
		private PlotOptionsCylinderSonificationContextTracksMappingPan Pan_DefaultValue { get; set; }
		...
		/// </summary>
		public PlotOptionsCylinderSonificationContextTracksMappingPitch Pitch { get; set; }
		private PlotOptionsCylinderSonificationContextTracksMappingPitch Pitch_DefaultValue { get; set; }
		...
		/// </summary>
		public PlotOptionsCylinderSonificationContextTracksMappingPlayDelay PlayDelay { get; set; }
		private PlotOptionsCylinderSonificationContextTracksMappingPlayDelay PlayDelay_DefaultValue { get; set; }
		...
		/// </summary>
		public PlotOptionsCylinderSonificationContextTracksMappingTime Time { get; set; }
		private PlotOptionsCylinderSonificationContextTracksMappingTime Time_DefaultValue { get; set; }
		...
		/// </summary>
		public PlotOptionsCylinderSonificationContextTracksMappingTremolo Tremolo { get; set; }
		private PlotOptionsCylinderSonificationContextTracksMappingTremolo Tremolo_DefaultValue { get; set; }
		 

		/// <summary>
		/// The volume of notes, from 0 to 1.
		/// </summary>
		public PlotOptionsCylinderSonificationContextTracksMappingVolume Volume { get; set; }
		private PlotOptionsCylinderSonificationContextTracksMappingVolume Volume_DefaultValue { get; set; }
