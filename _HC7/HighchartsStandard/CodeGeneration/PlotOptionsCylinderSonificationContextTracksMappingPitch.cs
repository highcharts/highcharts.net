...
{
	public partial class PlotOptionsCylinderSonificationContextTracksMappingPitch  : BaseObject
	{
		Hashtable h = new Hashtable();

		public PlotOptionsCylinderSonificationContextTracksMappingPitch()
		{
			MapFunction = MapFunction_DefaultValue = PlotOptionsCylinderSonificationContextTracksMappingPitchMapFunction.Linear;
		...
		/// </summary>
		public PlotOptionsCylinderSonificationContextTracksMappingPitchMapFunction MapFunction { get; set; }
		private PlotOptionsCylinderSonificationContextTracksMappingPitchMapFunction MapFunction_DefaultValue { get; set; }
