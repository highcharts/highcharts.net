...
{
	public partial class PlotOptionsCylinderSonificationPointGrouping  : BaseObject
	{
		Hashtable h = new Hashtable();

		public PlotOptionsCylinderSonificationPointGrouping()
		{
		...
		/// </summary>
		public PlotOptionsCylinderSonificationPointGroupingAlgorithm Algorithm { get; set; }
		private PlotOptionsCylinderSonificationPointGroupingAlgorithm Algorithm_DefaultValue { get; set; }
		...
		internal override Hashtable ToHashtable(Highcharts highcharts)
		{
			...
			if (Algorithm != PlotOptionsCylinderSonificationPointGroupingAlgorithm.Null) h.Add("algorithm", highcharts.FirstCharacterToLower(Algorithm.ToString()));
