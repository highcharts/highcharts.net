...
{
	public partial class PlotOptionsCylinderSonificationTracks  : BaseObject
	{
		Hashtable h = new Hashtable();

		public PlotOptionsCylinderSonificationTracks()
		{
			ActiveWhen = ActiveWhen_DefaultValue = new PlotOptionsCylinderSonificationTracksActiveWhen();
			Instrument = Instrument_DefaultValue = null;
			InstrumentString = InstrumentString_DefaultValue = "null";
			Mapping = Mapping_DefaultValue = new PlotOptionsCylinderSonificationTracksMapping();
			MidiName = MidiName_DefaultValue = "";
			PointGrouping = PointGrouping_DefaultValue = new PlotOptionsCylinderSonificationTracksPointGrouping();
			RoundToMusicalNotes = RoundToMusicalNotes_DefaultValue = true;
			ShowPlayMarker = ShowPlayMarker_DefaultValue = true;
			Type = Type_DefaultValue = PlotOptionsCylinderSonificationTracksType.Instrument;
		...
		/// </summary>
		public PlotOptionsCylinderSonificationTracksActiveWhen ActiveWhen { get; set; }
		private PlotOptionsCylinderSonificationTracksActiveWhen ActiveWhen_DefaultValue { get; set; }
		...
		/// </summary>
		public PlotOptionsCylinderSonificationTracksMapping Mapping { get; set; }
		private PlotOptionsCylinderSonificationTracksMapping Mapping_DefaultValue { get; set; }
		...
		/// </summary>
		public PlotOptionsCylinderSonificationTracksPointGrouping PointGrouping { get; set; }
		private PlotOptionsCylinderSonificationTracksPointGrouping PointGrouping_DefaultValue { get; set; }
		...
		/// </summary>
		public PlotOptionsCylinderSonificationTracksType Type { get; set; }
		private PlotOptionsCylinderSonificationTracksType Type_DefaultValue { get; set; }
