...
{
	public partial class PlotOptionsCylinderSonificationTracksMapping  : BaseObject
	{
		Hashtable h = new Hashtable();

		public PlotOptionsCylinderSonificationTracksMapping()
		{
			Frequency = Frequency_DefaultValue = new PlotOptionsCylinderSonificationTracksMappingFrequency();
			GapBetweenNotes = GapBetweenNotes_DefaultValue = new PlotOptionsCylinderSonificationTracksMappingGapBetweenNotes();
			Highpass = Highpass_DefaultValue = new PlotOptionsCylinderSonificationTracksMappingHighpass();
			Lowpass = Lowpass_DefaultValue = new PlotOptionsCylinderSonificationTracksMappingLowpass();
			NoteDuration = NoteDuration_DefaultValue = new PlotOptionsCylinderSonificationTracksMappingNoteDuration();
			Pan = Pan_DefaultValue = new PlotOptionsCylinderSonificationTracksMappingPan();
			Pitch = Pitch_DefaultValue = new PlotOptionsCylinderSonificationTracksMappingPitch();
			PitchString = PitchString_DefaultValue = "null";
			PitchNumber = PitchNumber_DefaultValue = null;
			PlayDelay = PlayDelay_DefaultValue = new PlotOptionsCylinderSonificationTracksMappingPlayDelay();
			Time = Time_DefaultValue = new PlotOptionsCylinderSonificationTracksMappingTime();
			TimeString = TimeString_DefaultValue = "null";
			TimeNumber = TimeNumber_DefaultValue = null;
			Tremolo = Tremolo_DefaultValue = new PlotOptionsCylinderSonificationTracksMappingTremolo();
			Volume = Volume_DefaultValue = new PlotOptionsCylinderSonificationTracksMappingVolume();
		...
		/// </summary>
		public PlotOptionsCylinderSonificationTracksMappingFrequency Frequency { get; set; }
		private PlotOptionsCylinderSonificationTracksMappingFrequency Frequency_DefaultValue { get; set; }
		...
		/// </summary>
		public PlotOptionsCylinderSonificationTracksMappingGapBetweenNotes GapBetweenNotes { get; set; }
		private PlotOptionsCylinderSonificationTracksMappingGapBetweenNotes GapBetweenNotes_DefaultValue { get; set; }
		...
		/// </summary>
		public PlotOptionsCylinderSonificationTracksMappingHighpass Highpass { get; set; }
		private PlotOptionsCylinderSonificationTracksMappingHighpass Highpass_DefaultValue { get; set; }
		...
		/// </summary>
		public PlotOptionsCylinderSonificationTracksMappingLowpass Lowpass { get; set; }
		private PlotOptionsCylinderSonificationTracksMappingLowpass Lowpass_DefaultValue { get; set; }
		...
		/// </summary>
		public PlotOptionsCylinderSonificationTracksMappingNoteDuration NoteDuration { get; set; }
		private PlotOptionsCylinderSonificationTracksMappingNoteDuration NoteDuration_DefaultValue { get; set; }
		...
		/// </summary>
		public PlotOptionsCylinderSonificationTracksMappingPan Pan { get; set; }
		private PlotOptionsCylinderSonificationTracksMappingPan Pan_DefaultValue { get; set; }
		...
		/// </summary>
		public PlotOptionsCylinderSonificationTracksMappingPitch Pitch { get; set; }
		private PlotOptionsCylinderSonificationTracksMappingPitch Pitch_DefaultValue { get; set; }
		...
		/// </summary>
		public PlotOptionsCylinderSonificationTracksMappingPlayDelay PlayDelay { get; set; }
		private PlotOptionsCylinderSonificationTracksMappingPlayDelay PlayDelay_DefaultValue { get; set; }
		...
		/// </summary>
		public PlotOptionsCylinderSonificationTracksMappingTime Time { get; set; }
		private PlotOptionsCylinderSonificationTracksMappingTime Time_DefaultValue { get; set; }
		...
		/// </summary>
		public PlotOptionsCylinderSonificationTracksMappingTremolo Tremolo { get; set; }
		private PlotOptionsCylinderSonificationTracksMappingTremolo Tremolo_DefaultValue { get; set; }
		 

		/// <summary>
		/// The volume of notes, from 0 to 1.
		/// </summary>
		public PlotOptionsCylinderSonificationTracksMappingVolume Volume { get; set; }
		private PlotOptionsCylinderSonificationTracksMappingVolume Volume_DefaultValue { get; set; }
