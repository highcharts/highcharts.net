...
{
	public partial class PlotOptionsCylinderSonificationTracksMappingVolume  : BaseObject
	{
		Hashtable h = new Hashtable();

		public PlotOptionsCylinderSonificationTracksMappingVolume()
		{
			MapFunction = MapFunction_DefaultValue = PlotOptionsCylinderSonificationTracksMappingVolumeMapFunction.Linear;
			MapTo = MapTo_DefaultValue = "";
			Max = Max_DefaultValue = null;
			Min = Min_DefaultValue = null;
			Value = Value_DefaultValue = null;
			Within = Within_DefaultValue = PlotOptionsCylinderSonificationTracksMappingVolumeWithin.Chart;
		...
		/// </summary>
		public PlotOptionsCylinderSonificationTracksMappingVolumeMapFunction MapFunction { get; set; }
		private PlotOptionsCylinderSonificationTracksMappingVolumeMapFunction MapFunction_DefaultValue { get; set; }
		...
		/// </summary>
		public PlotOptionsCylinderSonificationTracksMappingVolumeWithin Within { get; set; }
		private PlotOptionsCylinderSonificationTracksMappingVolumeWithin Within_DefaultValue { get; set; }
