...
{
	public partial class PlotOptionsCylinderSonificationTracksPointGrouping  : BaseObject
	{
		Hashtable h = new Hashtable();

		public PlotOptionsCylinderSonificationTracksPointGrouping()
		{
		...
		/// </summary>
		public PlotOptionsCylinderSonificationTracksPointGroupingAlgorithm Algorithm { get; set; }
		private PlotOptionsCylinderSonificationTracksPointGroupingAlgorithm Algorithm_DefaultValue { get; set; }
		...
		internal override Hashtable ToHashtable(Highcharts highcharts)
		{
			...
			if (Algorithm != PlotOptionsCylinderSonificationTracksPointGroupingAlgorithm.Null) h.Add("algorithm", highcharts.FirstCharacterToLower(Algorithm.ToString()));
