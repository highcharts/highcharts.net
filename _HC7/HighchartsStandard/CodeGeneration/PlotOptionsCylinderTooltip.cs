...
{
	public partial class PlotOptionsCylinderTooltip  : BaseObject
	{
		public PlotOptionsCylinderTooltip()
		{
			...
			HeaderShape = HeaderShape_DefaultValue = PlotOptionsCylinderTooltipHeaderShape.Callout;
		...
		/// </summary>
		public PlotOptionsCylinderTooltipHeaderShape HeaderShape { get; set; }
		private PlotOptionsCylinderTooltipHeaderShape HeaderShape_DefaultValue { get; set; }
		...
		internal override Hashtable ToHashtable()
		{
			...
			if (NullFormatter != NullFormatter_DefaultValue) { h.Add("nullFormatter",NullFormatter); Highcharts.AddFunction("PlotOptionsCylinderTooltipNullFormatter.nullFormatter", NullFormatter); }  
			if (Outside != Outside_DefaultValue) h.Add("outside",Outside);
			if (Padding != Padding_DefaultValue) h.Add("padding",Padding);
			if (PointFormat != PointFormat_DefaultValue) h.Add("pointFormat",PointFormat);
			if (PointFormatter != PointFormatter_DefaultValue) { h.Add("pointFormatter",PointFormatter); Highcharts.AddFunction("PlotOptionsCylinderTooltipPointFormatter.pointFormatter", PointFormatter); }  
