...
namespace Highsoft.Web.Mvc.Charts
{
	public partial class PlotOptionsDependencywheel  : BaseObject
	{
		...
		/// </summary>
		public PlotOptionsDependencywheelLinkColorMode LinkColorMode { get; set; }
		private PlotOptionsDependencywheelLinkColorMode LinkColorMode_DefaultValue { get; set; }
		...
		/// </summary>
		public PlotOptionsDependencywheelSonification Sonification { get; set; }
		private PlotOptionsDependencywheelSonification Sonification_DefaultValue { get; set; }
		...
		internal override Hashtable ToHashtable(Highcharts highcharts)
		{
			...
			if (Cursor != PlotOptionsDependencywheelCursor.Null) h.Add("cursor", highcharts.FirstCharacterToLower(Cursor.ToString()));
			if (CurveFactor != null) h.Add("curveFactor",CurveFactor);
			if (Custom != null) h.Add("custom",Custom);
			if (DashStyle != PlotOptionsDependencywheelDashStyle.Null) h.Add("dashStyle", highcharts.FirstCharacterToLower(DashStyle.ToString()));
			...
			if (LegendSymbol != PlotOptionsDependencywheelLegendSymbol.Null) h.Add("legendSymbol", highcharts.FirstCharacterToLower(LegendSymbol.ToString()));
			if (Levels != null) h.Add("levels",Levels.ToHashtable(highcharts));
			if (LinkColorMode != PlotOptionsDependencywheelLinkColorMode.Null) h.Add("linkColorMode", highcharts.FirstCharacterToLower(LinkColorMode.ToString()));
			...
			if (NodeAlignment != PlotOptionsDependencywheelNodeAlignment.Null) h.Add("nodeAlignment", highcharts.FirstCharacterToLower(NodeAlignment.ToString()));
