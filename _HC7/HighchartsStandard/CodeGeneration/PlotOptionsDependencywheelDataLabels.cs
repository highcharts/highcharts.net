...
{
	public partial class PlotOptionsDependencywheelDataLabels  : BaseObject
	{
		Hashtable h = new Hashtable();

		public PlotOptionsDependencywheelDataLabels()
		{
		...
		/// </summary>
		public PlotOptionsDependencywheelDataLabelsAlign Align { get; set; }
		private PlotOptionsDependencywheelDataLabelsAlign Align_DefaultValue { get; set; }
		...
		/// </summary>
		public PlotOptionsDependencywheelDataLabelsFilter Filter { get; set; }
		private PlotOptionsDependencywheelDataLabelsFilter Filter_DefaultValue { get; set; }
		...
		/// </summary>
		public PlotOptionsDependencywheelDataLabelsOverflow Overflow { get; set; }
		private PlotOptionsDependencywheelDataLabelsOverflow Overflow_DefaultValue { get; set; }
		...
		/// </summary>
		public PlotOptionsDependencywheelDataLabelsPosition Position { get; set; }
		private PlotOptionsDependencywheelDataLabelsPosition Position_DefaultValue { get; set; }
		...
		/// </summary>
		public PlotOptionsDependencywheelDataLabelsVerticalAlign VerticalAlign { get; set; }
		private PlotOptionsDependencywheelDataLabelsVerticalAlign VerticalAlign_DefaultValue { get; set; }
		...
		internal override Hashtable ToHashtable(Highcharts highcharts)
		{
			...
			if (Align != PlotOptionsDependencywheelDataLabelsAlign.Null) h.Add("align", highcharts.FirstCharacterToLower(Align.ToString()));
			...
			if (NodeFormatter != null) h.Add("nodeFormatter",NodeFormatter);
			...
			if (Overflow != PlotOptionsDependencywheelDataLabelsOverflow.Null) h.Add("overflow", highcharts.FirstCharacterToLower(Overflow.ToString()));
			if (Padding != null) h.Add("padding",Padding);
			if (Position != PlotOptionsDependencywheelDataLabelsPosition.Null) h.Add("position", highcharts.FirstCharacterToLower(Position.ToString()));
			...
			if (VerticalAlign != PlotOptionsDependencywheelDataLabelsVerticalAlign.Null) h.Add("verticalAlign", highcharts.FirstCharacterToLower(VerticalAlign.ToString()));
			if (X != null) h.Add("x",X);
			if (Y != null) h.Add("y",Y);
