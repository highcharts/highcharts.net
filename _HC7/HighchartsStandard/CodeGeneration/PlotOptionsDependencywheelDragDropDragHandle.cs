...
{
	public partial class PlotOptionsDependencywheelDragDropDragHandle  : BaseObject
	{
		public PlotOptionsDependencywheelDragDropDragHandle()
		{
		...
		internal override Hashtable ToHashtable()
		{
			...
			if (PathFormatter != PathFormatter_DefaultValue) { h.Add("pathFormatter",PathFormatter); Highcharts.AddFunction("PlotOptionsDependencywheelDragDropDragHandlePathFormatter.pathFormatter", PathFormatter); }  
