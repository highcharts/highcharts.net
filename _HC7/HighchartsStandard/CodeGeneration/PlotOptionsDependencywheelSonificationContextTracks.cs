...
{
	public partial class PlotOptionsDependencywheelSonificationContextTracks  : BaseObject
	{
		Hashtable h = new Hashtable();

		public PlotOptionsDependencywheelSonificationContextTracks()
		{
			ActiveWhen = ActiveWhen_DefaultValue = new PlotOptionsDependencywheelSonificationContextTracksActiveWhen();
			Instrument = Instrument_DefaultValue = null;
			InstrumentString = InstrumentString_DefaultValue = "null";
			Mapping = Mapping_DefaultValue = new PlotOptionsDependencywheelSonificationContextTracksMapping();
			MidiName = MidiName_DefaultValue = "";
			PointGrouping = PointGrouping_DefaultValue = new PlotOptionsDependencywheelSonificationContextTracksPointGrouping();
			...
			Type = Type_DefaultValue = PlotOptionsDependencywheelSonificationContextTracksType.Instrument;
			ValueInterval = ValueInterval_DefaultValue = null;
			ValueMapFunction = ValueMapFunction_DefaultValue = PlotOptionsDependencywheelSonificationContextTracksValueMapFunction.Linear;
		...
		/// </summary>
		public PlotOptionsDependencywheelSonificationContextTracksActiveWhen ActiveWhen { get; set; }
		private PlotOptionsDependencywheelSonificationContextTracksActiveWhen ActiveWhen_DefaultValue { get; set; }
		...
		/// </summary>
		public PlotOptionsDependencywheelSonificationContextTracksMapping Mapping { get; set; }
		private PlotOptionsDependencywheelSonificationContextTracksMapping Mapping_DefaultValue { get; set; }
		...
		/// </summary>
		public PlotOptionsDependencywheelSonificationContextTracksPointGrouping PointGrouping { get; set; }
		private PlotOptionsDependencywheelSonificationContextTracksPointGrouping PointGrouping_DefaultValue { get; set; }
		...
		/// </summary>
		public PlotOptionsDependencywheelSonificationContextTracksType Type { get; set; }
		private PlotOptionsDependencywheelSonificationContextTracksType Type_DefaultValue { get; set; }
		...
		/// </summary>
		public PlotOptionsDependencywheelSonificationContextTracksValueMapFunction ValueMapFunction { get; set; }
		private PlotOptionsDependencywheelSonificationContextTracksValueMapFunction ValueMapFunction_DefaultValue { get; set; }
