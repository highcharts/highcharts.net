...
{
	public partial class PlotOptionsDependencywheelSonificationContextTracksMappingPitch  : BaseObject
	{
		Hashtable h = new Hashtable();

		public PlotOptionsDependencywheelSonificationContextTracksMappingPitch()
		{
			MapFunction = MapFunction_DefaultValue = PlotOptionsDependencywheelSonificationContextTracksMappingPitchMapFunction.Linear;
		...
		/// </summary>
		public PlotOptionsDependencywheelSonificationContextTracksMappingPitchMapFunction MapFunction { get; set; }
		private PlotOptionsDependencywheelSonificationContextTracksMappingPitchMapFunction MapFunction_DefaultValue { get; set; }
