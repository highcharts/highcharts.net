...
{
	public partial class PlotOptionsDependencywheelSonificationContextTracksMappingVolume  : BaseObject
	{
		Hashtable h = new Hashtable();

		public PlotOptionsDependencywheelSonificationContextTracksMappingVolume()
		{
			MapFunction = MapFunction_DefaultValue = PlotOptionsDependencywheelSonificationContextTracksMappingVolumeMapFunction.Linear;
			MapTo = MapTo_DefaultValue = "";
			Max = Max_DefaultValue = null;
			Min = Min_DefaultValue = null;
			Value = Value_DefaultValue = null;
			Within = Within_DefaultValue = PlotOptionsDependencywheelSonificationContextTracksMappingVolumeWithin.Chart;
		...
		/// </summary>
		public PlotOptionsDependencywheelSonificationContextTracksMappingVolumeMapFunction MapFunction { get; set; }
		private PlotOptionsDependencywheelSonificationContextTracksMappingVolumeMapFunction MapFunction_DefaultValue { get; set; }
		...
		/// </summary>
		public PlotOptionsDependencywheelSonificationContextTracksMappingVolumeWithin Within { get; set; }
		private PlotOptionsDependencywheelSonificationContextTracksMappingVolumeWithin Within_DefaultValue { get; set; }
