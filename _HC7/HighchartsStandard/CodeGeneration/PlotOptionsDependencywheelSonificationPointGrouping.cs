...
{
	public partial class PlotOptionsDependencywheelSonificationPointGrouping  : BaseObject
	{
		Hashtable h = new Hashtable();

		public PlotOptionsDependencywheelSonificationPointGrouping()
		{
		...
		/// </summary>
		public PlotOptionsDependencywheelSonificationPointGroupingAlgorithm Algorithm { get; set; }
		private PlotOptionsDependencywheelSonificationPointGroupingAlgorithm Algorithm_DefaultValue { get; set; }
		...
		internal override Hashtable ToHashtable(Highcharts highcharts)
		{
			...
			if (Algorithm != PlotOptionsDependencywheelSonificationPointGroupingAlgorithm.Null) h.Add("algorithm", highcharts.FirstCharacterToLower(Algorithm.ToString()));
