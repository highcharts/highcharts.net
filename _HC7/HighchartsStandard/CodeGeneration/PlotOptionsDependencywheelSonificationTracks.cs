...
{
	public partial class PlotOptionsDependencywheelSonificationTracks  : BaseObject
	{
		Hashtable h = new Hashtable();

		public PlotOptionsDependencywheelSonificationTracks()
		{
			ActiveWhen = ActiveWhen_DefaultValue = new PlotOptionsDependencywheelSonificationTracksActiveWhen();
			Instrument = Instrument_DefaultValue = null;
			InstrumentString = InstrumentString_DefaultValue = "null";
			Mapping = Mapping_DefaultValue = new PlotOptionsDependencywheelSonificationTracksMapping();
			MidiName = MidiName_DefaultValue = "";
			PointGrouping = PointGrouping_DefaultValue = new PlotOptionsDependencywheelSonificationTracksPointGrouping();
			RoundToMusicalNotes = RoundToMusicalNotes_DefaultValue = true;
			ShowPlayMarker = ShowPlayMarker_DefaultValue = true;
			Type = Type_DefaultValue = PlotOptionsDependencywheelSonificationTracksType.Instrument;
		...
		/// </summary>
		public PlotOptionsDependencywheelSonificationTracksActiveWhen ActiveWhen { get; set; }
		private PlotOptionsDependencywheelSonificationTracksActiveWhen ActiveWhen_DefaultValue { get; set; }
		...
		/// </summary>
		public PlotOptionsDependencywheelSonificationTracksMapping Mapping { get; set; }
		private PlotOptionsDependencywheelSonificationTracksMapping Mapping_DefaultValue { get; set; }
		...
		/// </summary>
		public PlotOptionsDependencywheelSonificationTracksPointGrouping PointGrouping { get; set; }
		private PlotOptionsDependencywheelSonificationTracksPointGrouping PointGrouping_DefaultValue { get; set; }
		...
		/// </summary>
		public PlotOptionsDependencywheelSonificationTracksType Type { get; set; }
		private PlotOptionsDependencywheelSonificationTracksType Type_DefaultValue { get; set; }
