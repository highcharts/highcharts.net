...
{
	public partial class PlotOptionsDependencywheelSonificationTracksMapping  : BaseObject
	{
		Hashtable h = new Hashtable();

		public PlotOptionsDependencywheelSonificationTracksMapping()
		{
			Frequency = Frequency_DefaultValue = new PlotOptionsDependencywheelSonificationTracksMappingFrequency();
			GapBetweenNotes = GapBetweenNotes_DefaultValue = new PlotOptionsDependencywheelSonificationTracksMappingGapBetweenNotes();
			Highpass = Highpass_DefaultValue = new PlotOptionsDependencywheelSonificationTracksMappingHighpass();
			Lowpass = Lowpass_DefaultValue = new PlotOptionsDependencywheelSonificationTracksMappingLowpass();
			NoteDuration = NoteDuration_DefaultValue = new PlotOptionsDependencywheelSonificationTracksMappingNoteDuration();
			Pan = Pan_DefaultValue = new PlotOptionsDependencywheelSonificationTracksMappingPan();
			Pitch = Pitch_DefaultValue = new PlotOptionsDependencywheelSonificationTracksMappingPitch();
			PitchString = PitchString_DefaultValue = "null";
			PitchNumber = PitchNumber_DefaultValue = null;
			PlayDelay = PlayDelay_DefaultValue = new PlotOptionsDependencywheelSonificationTracksMappingPlayDelay();
			Time = Time_DefaultValue = new PlotOptionsDependencywheelSonificationTracksMappingTime();
			TimeString = TimeString_DefaultValue = "null";
			TimeNumber = TimeNumber_DefaultValue = null;
			Tremolo = Tremolo_DefaultValue = new PlotOptionsDependencywheelSonificationTracksMappingTremolo();
			Volume = Volume_DefaultValue = new PlotOptionsDependencywheelSonificationTracksMappingVolume();
		...
		/// </summary>
		public PlotOptionsDependencywheelSonificationTracksMappingFrequency Frequency { get; set; }
		private PlotOptionsDependencywheelSonificationTracksMappingFrequency Frequency_DefaultValue { get; set; }
		...
		/// </summary>
		public PlotOptionsDependencywheelSonificationTracksMappingGapBetweenNotes GapBetweenNotes { get; set; }
		private PlotOptionsDependencywheelSonificationTracksMappingGapBetweenNotes GapBetweenNotes_DefaultValue { get; set; }
		...
		/// </summary>
		public PlotOptionsDependencywheelSonificationTracksMappingHighpass Highpass { get; set; }
		private PlotOptionsDependencywheelSonificationTracksMappingHighpass Highpass_DefaultValue { get; set; }
		...
		/// </summary>
		public PlotOptionsDependencywheelSonificationTracksMappingLowpass Lowpass { get; set; }
		private PlotOptionsDependencywheelSonificationTracksMappingLowpass Lowpass_DefaultValue { get; set; }
		...
		/// </summary>
		public PlotOptionsDependencywheelSonificationTracksMappingNoteDuration NoteDuration { get; set; }
		private PlotOptionsDependencywheelSonificationTracksMappingNoteDuration NoteDuration_DefaultValue { get; set; }
		...
		/// </summary>
		public PlotOptionsDependencywheelSonificationTracksMappingPan Pan { get; set; }
		private PlotOptionsDependencywheelSonificationTracksMappingPan Pan_DefaultValue { get; set; }
		...
		/// </summary>
		public PlotOptionsDependencywheelSonificationTracksMappingPitch Pitch { get; set; }
		private PlotOptionsDependencywheelSonificationTracksMappingPitch Pitch_DefaultValue { get; set; }
		...
		/// </summary>
		public PlotOptionsDependencywheelSonificationTracksMappingPlayDelay PlayDelay { get; set; }
		private PlotOptionsDependencywheelSonificationTracksMappingPlayDelay PlayDelay_DefaultValue { get; set; }
		...
		/// </summary>
		public PlotOptionsDependencywheelSonificationTracksMappingTime Time { get; set; }
		private PlotOptionsDependencywheelSonificationTracksMappingTime Time_DefaultValue { get; set; }
		...
		/// </summary>
		public PlotOptionsDependencywheelSonificationTracksMappingTremolo Tremolo { get; set; }
		private PlotOptionsDependencywheelSonificationTracksMappingTremolo Tremolo_DefaultValue { get; set; }
		 

		/// <summary>
		/// The volume of notes, from 0 to 1.
		/// </summary>
		public PlotOptionsDependencywheelSonificationTracksMappingVolume Volume { get; set; }
		private PlotOptionsDependencywheelSonificationTracksMappingVolume Volume_DefaultValue { get; set; }
