...
namespace Highsoft.Web.Mvc.Charts
{
	public partial class PlotOptionsDependencywheelSonificationTracksMappingPitch  : BaseObject
	{
		...
		{
			if (MapFunction != PlotOptionsDependencywheelSonificationTracksMappingPitchMapFunction.Null) h.Add("mapFunction", highcharts.FirstCharacterToLower(MapFunction.ToString()));
