...
{
	public partial class PlotOptionsDependencywheelSonificationTracksMappingVolume  : BaseObject
	{
		Hashtable h = new Hashtable();

		public PlotOptionsDependencywheelSonificationTracksMappingVolume()
		{
			MapFunction = MapFunction_DefaultValue = PlotOptionsDependencywheelSonificationTracksMappingVolumeMapFunction.Linear;
			MapTo = MapTo_DefaultValue = "";
			Max = Max_DefaultValue = null;
			Min = Min_DefaultValue = null;
			Value = Value_DefaultValue = null;
			Within = Within_DefaultValue = PlotOptionsDependencywheelSonificationTracksMappingVolumeWithin.Chart;
		...
		/// </summary>
		public PlotOptionsDependencywheelSonificationTracksMappingVolumeMapFunction MapFunction { get; set; }
		private PlotOptionsDependencywheelSonificationTracksMappingVolumeMapFunction MapFunction_DefaultValue { get; set; }
		...
		/// </summary>
		public PlotOptionsDependencywheelSonificationTracksMappingVolumeWithin Within { get; set; }
		private PlotOptionsDependencywheelSonificationTracksMappingVolumeWithin Within_DefaultValue { get; set; }
