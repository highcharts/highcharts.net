...
{
	public partial class PlotOptionsDependencywheelSonificationTracksPointGrouping  : BaseObject
	{
		Hashtable h = new Hashtable();

		public PlotOptionsDependencywheelSonificationTracksPointGrouping()
		{
		...
		/// </summary>
		public PlotOptionsDependencywheelSonificationTracksPointGroupingAlgorithm Algorithm { get; set; }
		private PlotOptionsDependencywheelSonificationTracksPointGroupingAlgorithm Algorithm_DefaultValue { get; set; }
		...
		internal override Hashtable ToHashtable(Highcharts highcharts)
		{
			...
			if (Algorithm != PlotOptionsDependencywheelSonificationTracksPointGroupingAlgorithm.Null) h.Add("algorithm", highcharts.FirstCharacterToLower(Algorithm.ToString()));
