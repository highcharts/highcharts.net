...
{
	public partial class PlotOptionsDependencywheelStatesHoverMarkerStates  : BaseObject
	{
		public PlotOptionsDependencywheelStatesHoverMarkerStates()
		{
			...
			Inactive = Inactive_DefaultValue = new PlotOptionsDependencywheelStatesHoverMarkerStatesInactive();
		...
		/// 
		/// </summary>
		public PlotOptionsDependencywheelStatesHoverMarkerStatesInactive Inactive { get; set; }
		private PlotOptionsDependencywheelStatesHoverMarkerStatesInactive Inactive_DefaultValue { get; set; }
