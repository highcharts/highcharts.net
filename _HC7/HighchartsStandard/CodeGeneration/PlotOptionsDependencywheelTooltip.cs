...
{
	public partial class PlotOptionsDependencywheelTooltip  : BaseObject
	{
		public PlotOptionsDependencywheelTooltip()
		{
			...
			HeaderShape = HeaderShape_DefaultValue = PlotOptionsDependencywheelTooltipHeaderShape.Callout;
		...
		/// </summary>
		public PlotOptionsDependencywheelTooltipHeaderShape HeaderShape { get; set; }
		private PlotOptionsDependencywheelTooltipHeaderShape HeaderShape_DefaultValue { get; set; }
		...
		internal override Hashtable ToHashtable()
		{
			...
			if (NullFormatter != NullFormatter_DefaultValue) { h.Add("nullFormatter",NullFormatter); Highcharts.AddFunction("PlotOptionsDependencywheelTooltipNullFormatter.nullFormatter", NullFormatter); }  
			if (Outside != Outside_DefaultValue) h.Add("outside",Outside);
			if (Padding != Padding_DefaultValue) h.Add("padding",Padding);
			if (PointFormat != PointFormat_DefaultValue) h.Add("pointFormat",PointFormat);
			if (PointFormatter != PointFormatter_DefaultValue) { h.Add("pointFormatter",PointFormatter); Highcharts.AddFunction("PlotOptionsDependencywheelTooltipPointFormatter.pointFormatter", PointFormatter); }  
