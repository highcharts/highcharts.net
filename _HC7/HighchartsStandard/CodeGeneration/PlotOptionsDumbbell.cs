...
namespace Highsoft.Web.Mvc.Charts
{
	public partial class PlotOptionsDumbbell  : BaseObject
	{
		...
		/// </summary>
		public PlotOptionsDumbbellPointPlacement PointPlacement { get; set; }
		private PlotOptionsDumbbellPointPlacement PointPlacement_DefaultValue { get; set; }
		...
		internal override Hashtable ToHashtable(Highcharts highcharts)
		{
			...
			if (Cursor != PlotOptionsDumbbellCursor.Null) h.Add("cursor", highcharts.FirstCharacterToLower(Cursor.ToString()));
			if (Custom != null) h.Add("custom",Custom);
			if (DashStyle != PlotOptionsDumbbellDashStyle.Null) h.Add("dashStyle", highcharts.FirstCharacterToLower(DashStyle.ToString()));
			...
			if (FindNearestPointBy != PlotOptionsDumbbellFindNearestPointBy.Null) h.Add("findNearestPointBy", highcharts.FirstCharacterToLower(FindNearestPointBy.ToString()));
			...
			if (LegendSymbol != PlotOptionsDumbbellLegendSymbol.Null) h.Add("legendSymbol", highcharts.FirstCharacterToLower(LegendSymbol.ToString()));
			if (Linecap != PlotOptionsDumbbellLinecap.Null) h.Add("linecap", highcharts.FirstCharacterToLower(Linecap.ToString()));
			if (LineColor != null) h.Add("lineColor",LineColor);
			if (LinkedTo != null) h.Add("linkedTo",LinkedTo);
			if (LowMarker != null) h.Add("lowMarker",LowMarker.ToHashtable(highcharts));
			...
			if (PointIntervalUnit != PlotOptionsDumbbellPointIntervalUnit.Null) h.Add("pointIntervalUnit", highcharts.FirstCharacterToLower(PointIntervalUnit.ToString()));
			if (PointPlacement != PlotOptionsDumbbellPointPlacement.Null) h.Add("pointPlacement", highcharts.FirstCharacterToLower(PointPlacement.ToString()));
			...
			if (Step != PlotOptionsDumbbellStep.Null) h.Add("step", highcharts.FirstCharacterToLower(Step.ToString()));
