...
{
	public partial class PlotOptionsDumbbellLowMarker  : BaseObject
	{
		Hashtable h = new Hashtable();

		public PlotOptionsDumbbellLowMarker()
		{
			...
			States = States_DefaultValue = new PlotOptionsDumbbellLowMarkerStates();
		...
		/// </summary>
		public PlotOptionsDumbbellLowMarkerStates States { get; set; }
		private PlotOptionsDumbbellLowMarkerStates States_DefaultValue { get; set; }
