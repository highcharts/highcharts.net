...
{
	public partial class PlotOptionsDumbbellSonificationContextTracksMappingGapBetweenNotes  : BaseObject
	{
		Hashtable h = new Hashtable();

		public PlotOptionsDumbbellSonificationContextTracksMappingGapBetweenNotes()
		{
			MapFunction = MapFunction_DefaultValue = PlotOptionsDumbbellSonificationContextTracksMappingGapBetweenNotesMapFunction.Linear;
			MapTo = MapTo_DefaultValue = "";
			Max = Max_DefaultValue = null;
			Min = Min_DefaultValue = null;
			Value = Value_DefaultValue = null;
			Within = Within_DefaultValue = PlotOptionsDumbbellSonificationContextTracksMappingGapBetweenNotesWithin.Chart;
		...
		/// </summary>
		public PlotOptionsDumbbellSonificationContextTracksMappingGapBetweenNotesMapFunction MapFunction { get; set; }
		private PlotOptionsDumbbellSonificationContextTracksMappingGapBetweenNotesMapFunction MapFunction_DefaultValue { get; set; }
		...
		/// </summary>
		public PlotOptionsDumbbellSonificationContextTracksMappingGapBetweenNotesWithin Within { get; set; }
		private PlotOptionsDumbbellSonificationContextTracksMappingGapBetweenNotesWithin Within_DefaultValue { get; set; }
