...
{
	public partial class PlotOptionsDumbbellSonificationDefaultInstrumentOptionsMappingPan  : BaseObject
	{
		Hashtable h = new Hashtable();

		public PlotOptionsDumbbellSonificationDefaultInstrumentOptionsMappingPan()
		{
			MapFunction = MapFunction_DefaultValue = PlotOptionsDumbbellSonificationDefaultInstrumentOptionsMappingPanMapFunction.Linear;
			MapTo = MapTo_DefaultValue = "";
			Max = Max_DefaultValue = null;
			Min = Min_DefaultValue = null;
			Value = Value_DefaultValue = null;
			Within = Within_DefaultValue = PlotOptionsDumbbellSonificationDefaultInstrumentOptionsMappingPanWithin.Chart;
		...
		/// </summary>
		public PlotOptionsDumbbellSonificationDefaultInstrumentOptionsMappingPanMapFunction MapFunction { get; set; }
		private PlotOptionsDumbbellSonificationDefaultInstrumentOptionsMappingPanMapFunction MapFunction_DefaultValue { get; set; }
		...
		/// </summary>
		public PlotOptionsDumbbellSonificationDefaultInstrumentOptionsMappingPanWithin Within { get; set; }
		private PlotOptionsDumbbellSonificationDefaultInstrumentOptionsMappingPanWithin Within_DefaultValue { get; set; }
