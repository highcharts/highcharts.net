...
{
	public partial class PlotOptionsDumbbellSonificationPointGrouping  : BaseObject
	{
		Hashtable h = new Hashtable();

		public PlotOptionsDumbbellSonificationPointGrouping()
		{
		...
		/// </summary>
		public PlotOptionsDumbbellSonificationPointGroupingAlgorithm Algorithm { get; set; }
		private PlotOptionsDumbbellSonificationPointGroupingAlgorithm Algorithm_DefaultValue { get; set; }
		...
		internal override Hashtable ToHashtable(Highcharts highcharts)
		{
			...
			if (Algorithm != PlotOptionsDumbbellSonificationPointGroupingAlgorithm.Null) h.Add("algorithm", highcharts.FirstCharacterToLower(Algorithm.ToString()));
