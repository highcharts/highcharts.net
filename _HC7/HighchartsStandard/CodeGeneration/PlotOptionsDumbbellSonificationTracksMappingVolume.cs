...
{
	public partial class PlotOptionsDumbbellSonificationTracksMappingVolume  : BaseObject
	{
		Hashtable h = new Hashtable();

		public PlotOptionsDumbbellSonificationTracksMappingVolume()
		{
			MapFunction = MapFunction_DefaultValue = PlotOptionsDumbbellSonificationTracksMappingVolumeMapFunction.Linear;
			MapTo = MapTo_DefaultValue = "";
			Max = Max_DefaultValue = null;
			Min = Min_DefaultValue = null;
			Value = Value_DefaultValue = null;
			Within = Within_DefaultValue = PlotOptionsDumbbellSonificationTracksMappingVolumeWithin.Chart;
		...
		/// </summary>
		public PlotOptionsDumbbellSonificationTracksMappingVolumeMapFunction MapFunction { get; set; }
		private PlotOptionsDumbbellSonificationTracksMappingVolumeMapFunction MapFunction_DefaultValue { get; set; }
		...
		/// </summary>
		public PlotOptionsDumbbellSonificationTracksMappingVolumeWithin Within { get; set; }
		private PlotOptionsDumbbellSonificationTracksMappingVolumeWithin Within_DefaultValue { get; set; }
