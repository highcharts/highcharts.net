...
{
	public partial class PlotOptionsDumbbellSonificationTracksPointGrouping  : BaseObject
	{
		Hashtable h = new Hashtable();

		public PlotOptionsDumbbellSonificationTracksPointGrouping()
		{
		...
		/// </summary>
		public PlotOptionsDumbbellSonificationTracksPointGroupingAlgorithm Algorithm { get; set; }
		private PlotOptionsDumbbellSonificationTracksPointGroupingAlgorithm Algorithm_DefaultValue { get; set; }
		...
		internal override Hashtable ToHashtable(Highcharts highcharts)
		{
			...
			if (Algorithm != PlotOptionsDumbbellSonificationTracksPointGroupingAlgorithm.Null) h.Add("algorithm", highcharts.FirstCharacterToLower(Algorithm.ToString()));
