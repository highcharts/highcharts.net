...
namespace Highsoft.Web.Mvc.Charts
{
	public partial class PlotOptionsErrorbar  : BaseObject
	{
		...
		/// </summary>
		public PlotOptionsErrorbarAccessibility Accessibility { get; set; }
		private PlotOptionsErrorbarAccessibility Accessibility_DefaultValue { get; set; }
		...
		/// </summary>
		public PlotOptionsErrorbarDashStyle DashStyle { get; set; }
		private PlotOptionsErrorbarDashStyle DashStyle_DefaultValue { get; set; }
		...
		/// </summary>
		public PlotOptionsErrorbarDataSorting DataSorting { get; set; }
		private PlotOptionsErrorbarDataSorting DataSorting_DefaultValue { get; set; }
		...
		/// </summary>
		public PlotOptionsErrorbarFindNearestPointBy FindNearestPointBy { get; set; }
		private PlotOptionsErrorbarFindNearestPointBy FindNearestPointBy_DefaultValue { get; set; }
		...
		/// </summary>
		public PlotOptionsErrorbarLegendSymbol LegendSymbol { get; set; }
		private PlotOptionsErrorbarLegendSymbol LegendSymbol_DefaultValue { get; set; }
		...
		/// </summary>
		public PlotOptionsErrorbarOnPoint OnPoint { get; set; }
		private PlotOptionsErrorbarOnPoint OnPoint_DefaultValue { get; set; }
		...
		/// </summary>
		public PlotOptionsErrorbarPointPlacement PointPlacement { get; set; }
		private PlotOptionsErrorbarPointPlacement PointPlacement_DefaultValue { get; set; }
		...
		/// </summary>
		public PlotOptionsErrorbarSonification Sonification { get; set; }
		private PlotOptionsErrorbarSonification Sonification_DefaultValue { get; set; }
		...
		/// </summary>
		public PlotOptionsErrorbarStacking Stacking { get; set; }
		private PlotOptionsErrorbarStacking Stacking_DefaultValue { get; set; }
		...
		internal override Hashtable ToHashtable(Highcharts highcharts)
		{
			...
			if (Cursor != PlotOptionsErrorbarCursor.Null) h.Add("cursor", highcharts.FirstCharacterToLower(Cursor.ToString()));
			if (Custom != null) h.Add("custom",Custom);
			if (DashStyle != PlotOptionsErrorbarDashStyle.Null) h.Add("dashStyle", highcharts.FirstCharacterToLower(DashStyle.ToString()));
			...
			if (FindNearestPointBy != PlotOptionsErrorbarFindNearestPointBy.Null) h.Add("findNearestPointBy", highcharts.FirstCharacterToLower(FindNearestPointBy.ToString()));
			...
			if (LegendSymbol != PlotOptionsErrorbarLegendSymbol.Null) h.Add("legendSymbol", highcharts.FirstCharacterToLower(LegendSymbol.ToString()));
			...
			if (PointIntervalUnit != PlotOptionsErrorbarPointIntervalUnit.Null) h.Add("pointIntervalUnit", highcharts.FirstCharacterToLower(PointIntervalUnit.ToString()));
			if (PointPadding != null) h.Add("pointPadding",PointPadding);
			if (PointPlacement != PlotOptionsErrorbarPointPlacement.Null) h.Add("pointPlacement", highcharts.FirstCharacterToLower(PointPlacement.ToString()));
			...
			if (Stacking != PlotOptionsErrorbarStacking.Null) h.Add("stacking", highcharts.FirstCharacterToLower(Stacking.ToString()));
