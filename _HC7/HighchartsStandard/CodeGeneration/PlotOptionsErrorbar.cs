...
namespace Highsoft.Web.Mvc.Charts
{
	public partial class PlotOptionsErrorbar  : BaseObject
	{
		...
		{
			Accessibility = Accessibility_DefaultValue = new PlotOptionsErrorbarAccessibility();
			...
			DashStyle = DashStyle_DefaultValue = PlotOptionsErrorbarDashStyle.Null;
			DataLabels = DataLabels_DefaultValue = new PlotOptionsErrorbarDataLabels();
			DataSorting = DataSorting_DefaultValue = new PlotOptionsErrorbarDataSorting();
			Depth = Depth_DefaultValue = 25;
			Description = Description_DefaultValue = "";
			DragDrop = DragDrop_DefaultValue = new PlotOptionsErrorbarDragDrop();
			...
			LegendSymbol = LegendSymbol_DefaultValue = PlotOptionsErrorbarLegendSymbol.Rectangle;
			...
			OnPoint = OnPoint_DefaultValue = new PlotOptionsErrorbarOnPoint();
			...
			Sonification = Sonification_DefaultValue = new PlotOptionsErrorbarSonification();
			...
			WhiskerWidth = WhiskerWidth_DefaultValue = 0;
