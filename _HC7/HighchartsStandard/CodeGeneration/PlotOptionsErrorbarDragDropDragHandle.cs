...
{
	public partial class PlotOptionsErrorbarDragDropDragHandle  : BaseObject
	{
		public PlotOptionsErrorbarDragDropDragHandle()
		{
		...
		internal override Hashtable ToHashtable()
		{
			...
			if (PathFormatter != PathFormatter_DefaultValue) { h.Add("pathFormatter",PathFormatter); Highcharts.AddFunction("PlotOptionsErrorbarDragDropDragHandlePathFormatter.pathFormatter", PathFormatter); }  
