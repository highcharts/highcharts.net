...
{
	public partial class PlotOptionsErrorbarSonificationContextTracksMapping  : BaseObject
	{
		Hashtable h = new Hashtable();

		public PlotOptionsErrorbarSonificationContextTracksMapping()
		{
			Frequency = Frequency_DefaultValue = new PlotOptionsErrorbarSonificationContextTracksMappingFrequency();
			GapBetweenNotes = GapBetweenNotes_DefaultValue = new PlotOptionsErrorbarSonificationContextTracksMappingGapBetweenNotes();
			Highpass = Highpass_DefaultValue = new PlotOptionsErrorbarSonificationContextTracksMappingHighpass();
			Lowpass = Lowpass_DefaultValue = new PlotOptionsErrorbarSonificationContextTracksMappingLowpass();
			NoteDuration = NoteDuration_DefaultValue = new PlotOptionsErrorbarSonificationContextTracksMappingNoteDuration();
			Pan = Pan_DefaultValue = new PlotOptionsErrorbarSonificationContextTracksMappingPan();
			Pitch = Pitch_DefaultValue = new PlotOptionsErrorbarSonificationContextTracksMappingPitch();
			PitchString = PitchString_DefaultValue = "null";
			PitchNumber = PitchNumber_DefaultValue = null;
			PlayDelay = PlayDelay_DefaultValue = new PlotOptionsErrorbarSonificationContextTracksMappingPlayDelay();
			Time = Time_DefaultValue = new PlotOptionsErrorbarSonificationContextTracksMappingTime();
			TimeString = TimeString_DefaultValue = "null";
			TimeNumber = TimeNumber_DefaultValue = null;
			Tremolo = Tremolo_DefaultValue = new PlotOptionsErrorbarSonificationContextTracksMappingTremolo();
			Volume = Volume_DefaultValue = new PlotOptionsErrorbarSonificationContextTracksMappingVolume();
		...
		/// </summary>
		public PlotOptionsErrorbarSonificationContextTracksMappingFrequency Frequency { get; set; }
		private PlotOptionsErrorbarSonificationContextTracksMappingFrequency Frequency_DefaultValue { get; set; }
		...
		/// </summary>
		public PlotOptionsErrorbarSonificationContextTracksMappingGapBetweenNotes GapBetweenNotes { get; set; }
		private PlotOptionsErrorbarSonificationContextTracksMappingGapBetweenNotes GapBetweenNotes_DefaultValue { get; set; }
		...
		/// </summary>
		public PlotOptionsErrorbarSonificationContextTracksMappingHighpass Highpass { get; set; }
		private PlotOptionsErrorbarSonificationContextTracksMappingHighpass Highpass_DefaultValue { get; set; }
		...
		/// </summary>
		public PlotOptionsErrorbarSonificationContextTracksMappingLowpass Lowpass { get; set; }
		private PlotOptionsErrorbarSonificationContextTracksMappingLowpass Lowpass_DefaultValue { get; set; }
		...
		/// </summary>
		public PlotOptionsErrorbarSonificationContextTracksMappingNoteDuration NoteDuration { get; set; }
		private PlotOptionsErrorbarSonificationContextTracksMappingNoteDuration NoteDuration_DefaultValue { get; set; }
		...
		/// </summary>
		public PlotOptionsErrorbarSonificationContextTracksMappingPan Pan { get; set; }
		private PlotOptionsErrorbarSonificationContextTracksMappingPan Pan_DefaultValue { get; set; }
		...
		/// </summary>
		public PlotOptionsErrorbarSonificationContextTracksMappingPitch Pitch { get; set; }
		private PlotOptionsErrorbarSonificationContextTracksMappingPitch Pitch_DefaultValue { get; set; }
		...
		/// </summary>
		public PlotOptionsErrorbarSonificationContextTracksMappingPlayDelay PlayDelay { get; set; }
		private PlotOptionsErrorbarSonificationContextTracksMappingPlayDelay PlayDelay_DefaultValue { get; set; }
		...
		/// </summary>
		public PlotOptionsErrorbarSonificationContextTracksMappingTime Time { get; set; }
		private PlotOptionsErrorbarSonificationContextTracksMappingTime Time_DefaultValue { get; set; }
		...
		/// </summary>
		public PlotOptionsErrorbarSonificationContextTracksMappingTremolo Tremolo { get; set; }
		private PlotOptionsErrorbarSonificationContextTracksMappingTremolo Tremolo_DefaultValue { get; set; }
		 

		/// <summary>
		/// The volume of notes, from 0 to 1.
		/// </summary>
		public PlotOptionsErrorbarSonificationContextTracksMappingVolume Volume { get; set; }
		private PlotOptionsErrorbarSonificationContextTracksMappingVolume Volume_DefaultValue { get; set; }
