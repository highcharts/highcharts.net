...
{
	public partial class PlotOptionsErrorbarSonificationContextTracksMappingNoteDuration  : BaseObject
	{
		Hashtable h = new Hashtable();

		public PlotOptionsErrorbarSonificationContextTracksMappingNoteDuration()
		{
			MapFunction = MapFunction_DefaultValue = PlotOptionsErrorbarSonificationContextTracksMappingNoteDurationMapFunction.Linear;
			MapTo = MapTo_DefaultValue = "";
			Max = Max_DefaultValue = null;
			Min = Min_DefaultValue = null;
			Value = Value_DefaultValue = null;
			Within = Within_DefaultValue = PlotOptionsErrorbarSonificationContextTracksMappingNoteDurationWithin.Chart;
		...
		/// </summary>
		public PlotOptionsErrorbarSonificationContextTracksMappingNoteDurationMapFunction MapFunction { get; set; }
		private PlotOptionsErrorbarSonificationContextTracksMappingNoteDurationMapFunction MapFunction_DefaultValue { get; set; }
		...
		/// </summary>
		public PlotOptionsErrorbarSonificationContextTracksMappingNoteDurationWithin Within { get; set; }
		private PlotOptionsErrorbarSonificationContextTracksMappingNoteDurationWithin Within_DefaultValue { get; set; }
