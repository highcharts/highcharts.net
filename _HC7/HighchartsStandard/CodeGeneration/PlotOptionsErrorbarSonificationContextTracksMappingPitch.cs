...
{
	public partial class PlotOptionsErrorbarSonificationContextTracksMappingPitch  : BaseObject
	{
		Hashtable h = new Hashtable();

		public PlotOptionsErrorbarSonificationContextTracksMappingPitch()
		{
			MapFunction = MapFunction_DefaultValue = PlotOptionsErrorbarSonificationContextTracksMappingPitchMapFunction.Linear;
		...
		/// </summary>
		public PlotOptionsErrorbarSonificationContextTracksMappingPitchMapFunction MapFunction { get; set; }
		private PlotOptionsErrorbarSonificationContextTracksMappingPitchMapFunction MapFunction_DefaultValue { get; set; }
