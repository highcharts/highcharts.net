...
{
	public partial class PlotOptionsErrorbarSonificationDefaultInstrumentOptionsMappingTime  : BaseObject
	{
		Hashtable h = new Hashtable();

		public PlotOptionsErrorbarSonificationDefaultInstrumentOptionsMappingTime()
		{
			MapFunction = MapFunction_DefaultValue = PlotOptionsErrorbarSonificationDefaultInstrumentOptionsMappingTimeMapFunction.Linear;
			MapTo = MapTo_DefaultValue = "";
			Max = Max_DefaultValue = null;
			Min = Min_DefaultValue = null;
			Value = Value_DefaultValue = null;
			Within = Within_DefaultValue = PlotOptionsErrorbarSonificationDefaultInstrumentOptionsMappingTimeWithin.Chart;
		...
		/// </summary>
		public PlotOptionsErrorbarSonificationDefaultInstrumentOptionsMappingTimeMapFunction MapFunction { get; set; }
		private PlotOptionsErrorbarSonificationDefaultInstrumentOptionsMappingTimeMapFunction MapFunction_DefaultValue { get; set; }
		...
		/// </summary>
		public PlotOptionsErrorbarSonificationDefaultInstrumentOptionsMappingTimeWithin Within { get; set; }
		private PlotOptionsErrorbarSonificationDefaultInstrumentOptionsMappingTimeWithin Within_DefaultValue { get; set; }
