...
{
	public partial class PlotOptionsErrorbarSonificationDefaultSpeechOptionsMappingPlayDelay  : BaseObject
	{
		Hashtable h = new Hashtable();

		public PlotOptionsErrorbarSonificationDefaultSpeechOptionsMappingPlayDelay()
		{
			MapFunction = MapFunction_DefaultValue = PlotOptionsErrorbarSonificationDefaultSpeechOptionsMappingPlayDelayMapFunction.Linear;
			MapTo = MapTo_DefaultValue = "";
			Max = Max_DefaultValue = null;
			Min = Min_DefaultValue = null;
			Value = Value_DefaultValue = null;
			Within = Within_DefaultValue = PlotOptionsErrorbarSonificationDefaultSpeechOptionsMappingPlayDelayWithin.Chart;
		...
		/// </summary>
		public PlotOptionsErrorbarSonificationDefaultSpeechOptionsMappingPlayDelayMapFunction MapFunction { get; set; }
		private PlotOptionsErrorbarSonificationDefaultSpeechOptionsMappingPlayDelayMapFunction MapFunction_DefaultValue { get; set; }
		...
		/// </summary>
		public PlotOptionsErrorbarSonificationDefaultSpeechOptionsMappingPlayDelayWithin Within { get; set; }
		private PlotOptionsErrorbarSonificationDefaultSpeechOptionsMappingPlayDelayWithin Within_DefaultValue { get; set; }
