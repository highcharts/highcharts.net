...
{
	public partial class PlotOptionsErrorbarSonificationPointGrouping  : BaseObject
	{
		Hashtable h = new Hashtable();

		public PlotOptionsErrorbarSonificationPointGrouping()
		{
		...
		/// </summary>
		public PlotOptionsErrorbarSonificationPointGroupingAlgorithm Algorithm { get; set; }
		private PlotOptionsErrorbarSonificationPointGroupingAlgorithm Algorithm_DefaultValue { get; set; }
		...
		internal override Hashtable ToHashtable(Highcharts highcharts)
		{
			...
			if (Algorithm != PlotOptionsErrorbarSonificationPointGroupingAlgorithm.Null) h.Add("algorithm", highcharts.FirstCharacterToLower(Algorithm.ToString()));
