...
{
	public partial class PlotOptionsErrorbarSonificationTracks  : BaseObject
	{
		Hashtable h = new Hashtable();

		public PlotOptionsErrorbarSonificationTracks()
		{
			ActiveWhen = ActiveWhen_DefaultValue = new PlotOptionsErrorbarSonificationTracksActiveWhen();
			Instrument = Instrument_DefaultValue = null;
			InstrumentString = InstrumentString_DefaultValue = "null";
			Mapping = Mapping_DefaultValue = new PlotOptionsErrorbarSonificationTracksMapping();
			MidiName = MidiName_DefaultValue = "";
			PointGrouping = PointGrouping_DefaultValue = new PlotOptionsErrorbarSonificationTracksPointGrouping();
			RoundToMusicalNotes = RoundToMusicalNotes_DefaultValue = true;
			ShowPlayMarker = ShowPlayMarker_DefaultValue = true;
			Type = Type_DefaultValue = PlotOptionsErrorbarSonificationTracksType.Instrument;
		...
		/// </summary>
		public PlotOptionsErrorbarSonificationTracksActiveWhen ActiveWhen { get; set; }
		private PlotOptionsErrorbarSonificationTracksActiveWhen ActiveWhen_DefaultValue { get; set; }
		...
		/// </summary>
		public PlotOptionsErrorbarSonificationTracksMapping Mapping { get; set; }
		private PlotOptionsErrorbarSonificationTracksMapping Mapping_DefaultValue { get; set; }
		...
		/// </summary>
		public PlotOptionsErrorbarSonificationTracksPointGrouping PointGrouping { get; set; }
		private PlotOptionsErrorbarSonificationTracksPointGrouping PointGrouping_DefaultValue { get; set; }
		...
		/// </summary>
		public PlotOptionsErrorbarSonificationTracksType Type { get; set; }
		private PlotOptionsErrorbarSonificationTracksType Type_DefaultValue { get; set; }
