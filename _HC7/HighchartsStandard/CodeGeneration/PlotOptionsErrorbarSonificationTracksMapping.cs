...
{
	public partial class PlotOptionsErrorbarSonificationTracksMapping  : BaseObject
	{
		Hashtable h = new Hashtable();

		public PlotOptionsErrorbarSonificationTracksMapping()
		{
			Frequency = Frequency_DefaultValue = new PlotOptionsErrorbarSonificationTracksMappingFrequency();
			GapBetweenNotes = GapBetweenNotes_DefaultValue = new PlotOptionsErrorbarSonificationTracksMappingGapBetweenNotes();
			Highpass = Highpass_DefaultValue = new PlotOptionsErrorbarSonificationTracksMappingHighpass();
			Lowpass = Lowpass_DefaultValue = new PlotOptionsErrorbarSonificationTracksMappingLowpass();
			NoteDuration = NoteDuration_DefaultValue = new PlotOptionsErrorbarSonificationTracksMappingNoteDuration();
			Pan = Pan_DefaultValue = new PlotOptionsErrorbarSonificationTracksMappingPan();
			Pitch = Pitch_DefaultValue = new PlotOptionsErrorbarSonificationTracksMappingPitch();
			PitchString = PitchString_DefaultValue = "null";
			PitchNumber = PitchNumber_DefaultValue = null;
			PlayDelay = PlayDelay_DefaultValue = new PlotOptionsErrorbarSonificationTracksMappingPlayDelay();
			Time = Time_DefaultValue = new PlotOptionsErrorbarSonificationTracksMappingTime();
			TimeString = TimeString_DefaultValue = "null";
			TimeNumber = TimeNumber_DefaultValue = null;
			Tremolo = Tremolo_DefaultValue = new PlotOptionsErrorbarSonificationTracksMappingTremolo();
			Volume = Volume_DefaultValue = new PlotOptionsErrorbarSonificationTracksMappingVolume();
		...
		/// </summary>
		public PlotOptionsErrorbarSonificationTracksMappingFrequency Frequency { get; set; }
		private PlotOptionsErrorbarSonificationTracksMappingFrequency Frequency_DefaultValue { get; set; }
		...
		/// </summary>
		public PlotOptionsErrorbarSonificationTracksMappingGapBetweenNotes GapBetweenNotes { get; set; }
		private PlotOptionsErrorbarSonificationTracksMappingGapBetweenNotes GapBetweenNotes_DefaultValue { get; set; }
		...
		/// </summary>
		public PlotOptionsErrorbarSonificationTracksMappingHighpass Highpass { get; set; }
		private PlotOptionsErrorbarSonificationTracksMappingHighpass Highpass_DefaultValue { get; set; }
		...
		/// </summary>
		public PlotOptionsErrorbarSonificationTracksMappingLowpass Lowpass { get; set; }
		private PlotOptionsErrorbarSonificationTracksMappingLowpass Lowpass_DefaultValue { get; set; }
		...
		/// </summary>
		public PlotOptionsErrorbarSonificationTracksMappingNoteDuration NoteDuration { get; set; }
		private PlotOptionsErrorbarSonificationTracksMappingNoteDuration NoteDuration_DefaultValue { get; set; }
		...
		/// </summary>
		public PlotOptionsErrorbarSonificationTracksMappingPan Pan { get; set; }
		private PlotOptionsErrorbarSonificationTracksMappingPan Pan_DefaultValue { get; set; }
		...
		/// </summary>
		public PlotOptionsErrorbarSonificationTracksMappingPitch Pitch { get; set; }
		private PlotOptionsErrorbarSonificationTracksMappingPitch Pitch_DefaultValue { get; set; }
		...
		/// </summary>
		public PlotOptionsErrorbarSonificationTracksMappingPlayDelay PlayDelay { get; set; }
		private PlotOptionsErrorbarSonificationTracksMappingPlayDelay PlayDelay_DefaultValue { get; set; }
		...
		/// </summary>
		public PlotOptionsErrorbarSonificationTracksMappingTime Time { get; set; }
		private PlotOptionsErrorbarSonificationTracksMappingTime Time_DefaultValue { get; set; }
		...
		/// </summary>
		public PlotOptionsErrorbarSonificationTracksMappingTremolo Tremolo { get; set; }
		private PlotOptionsErrorbarSonificationTracksMappingTremolo Tremolo_DefaultValue { get; set; }
		 

		/// <summary>
		/// The volume of notes, from 0 to 1.
		/// </summary>
		public PlotOptionsErrorbarSonificationTracksMappingVolume Volume { get; set; }
		private PlotOptionsErrorbarSonificationTracksMappingVolume Volume_DefaultValue { get; set; }
