...
{
	public partial class PlotOptionsErrorbarSonificationTracksMappingGapBetweenNotes  : BaseObject
	{
		Hashtable h = new Hashtable();

		public PlotOptionsErrorbarSonificationTracksMappingGapBetweenNotes()
		{
			MapFunction = MapFunction_DefaultValue = PlotOptionsErrorbarSonificationTracksMappingGapBetweenNotesMapFunction.Linear;
			MapTo = MapTo_DefaultValue = "";
			Max = Max_DefaultValue = null;
			Min = Min_DefaultValue = null;
			Value = Value_DefaultValue = null;
			Within = Within_DefaultValue = PlotOptionsErrorbarSonificationTracksMappingGapBetweenNotesWithin.Chart;
		...
		/// </summary>
		public PlotOptionsErrorbarSonificationTracksMappingGapBetweenNotesMapFunction MapFunction { get; set; }
		private PlotOptionsErrorbarSonificationTracksMappingGapBetweenNotesMapFunction MapFunction_DefaultValue { get; set; }
		...
		/// </summary>
		public PlotOptionsErrorbarSonificationTracksMappingGapBetweenNotesWithin Within { get; set; }
		private PlotOptionsErrorbarSonificationTracksMappingGapBetweenNotesWithin Within_DefaultValue { get; set; }
