...
{
	public partial class PlotOptionsErrorbarSonificationTracksMappingPan  : BaseObject
	{
		Hashtable h = new Hashtable();

		public PlotOptionsErrorbarSonificationTracksMappingPan()
		{
			MapFunction = MapFunction_DefaultValue = PlotOptionsErrorbarSonificationTracksMappingPanMapFunction.Linear;
			MapTo = MapTo_DefaultValue = "";
			Max = Max_DefaultValue = null;
			Min = Min_DefaultValue = null;
			Value = Value_DefaultValue = null;
			Within = Within_DefaultValue = PlotOptionsErrorbarSonificationTracksMappingPanWithin.Chart;
		...
		/// </summary>
		public PlotOptionsErrorbarSonificationTracksMappingPanMapFunction MapFunction { get; set; }
		private PlotOptionsErrorbarSonificationTracksMappingPanMapFunction MapFunction_DefaultValue { get; set; }
		...
		/// </summary>
		public PlotOptionsErrorbarSonificationTracksMappingPanWithin Within { get; set; }
		private PlotOptionsErrorbarSonificationTracksMappingPanWithin Within_DefaultValue { get; set; }
