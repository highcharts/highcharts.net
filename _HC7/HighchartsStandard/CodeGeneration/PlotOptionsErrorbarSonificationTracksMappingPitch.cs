...
{
	public partial class PlotOptionsErrorbarSonificationTracksMappingPitch  : BaseObject
	{
		Hashtable h = new Hashtable();

		public PlotOptionsErrorbarSonificationTracksMappingPitch()
		{
			MapFunction = MapFunction_DefaultValue = PlotOptionsErrorbarSonificationTracksMappingPitchMapFunction.Linear;
		...
		/// </summary>
		public PlotOptionsErrorbarSonificationTracksMappingPitchMapFunction MapFunction { get; set; }
		private PlotOptionsErrorbarSonificationTracksMappingPitchMapFunction MapFunction_DefaultValue { get; set; }
