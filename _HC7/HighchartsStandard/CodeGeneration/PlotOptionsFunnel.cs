...
namespace Highsoft.Web.Mvc.Charts
{
	public partial class PlotOptionsFunnel  : BaseObject
	{
		...
		/// <summary>
		/// The corner radius of the border surrounding all points or series. Anumber signifies pixels. A percentage string, like for example `50%`,signifies a size relative to the series width.
		/// </summary>
		...
		/// </summary>
		public PlotOptionsFunnelLegendSymbol LegendSymbol { get; set; }
		private PlotOptionsFunnelLegendSymbol LegendSymbol_DefaultValue { get; set; }
		...
		/// </summary>
		public PlotOptionsFunnelOnPoint OnPoint { get; set; }
		private PlotOptionsFunnelOnPoint OnPoint_DefaultValue { get; set; }
		...
		/// </summary>
		public PlotOptionsFunnelSonification Sonification { get; set; }
		private PlotOptionsFunnelSonification Sonification_DefaultValue { get; set; }
		...
		internal override Hashtable ToHashtable(Highcharts highcharts)
		{
			...
			if (Cursor != PlotOptionsFunnelCursor.Null) h.Add("cursor", highcharts.FirstCharacterToLower(Cursor.ToString()));
			...
			if (LegendSymbol != PlotOptionsFunnelLegendSymbol.Null) h.Add("legendSymbol", highcharts.FirstCharacterToLower(LegendSymbol.ToString()));
			if (Linecap != PlotOptionsFunnelLinecap.Null) h.Add("linecap", highcharts.FirstCharacterToLower(Linecap.ToString()));
