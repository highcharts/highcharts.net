...
namespace Highsoft.Web.Mvc.Charts
{
	public partial class PlotOptionsFunnel  : BaseObject
	{
		...
		public PlotOptionsFunnel()
		{
			...
			LegendSymbol = LegendSymbol_DefaultValue = PlotOptionsFunnelLegendSymbol.Rectangle;
			...
			OnPoint = OnPoint_DefaultValue = new PlotOptionsFunnelOnPoint();
			...
			Sonification = Sonification_DefaultValue = new PlotOptionsFunnelSonification();
