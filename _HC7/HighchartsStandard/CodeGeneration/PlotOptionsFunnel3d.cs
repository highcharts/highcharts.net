...
{
	public partial class PlotOptionsFunnel3d  : BaseObject
	{
		...
		/// </summary>
		public PlotOptionsFunnel3dAccessibility Accessibility { get; set; }
		private PlotOptionsFunnel3dAccessibility Accessibility_DefaultValue { get; set; }
		...
		/// </summary>
		public PlotOptionsFunnel3dCursor Cursor { get; set; }
		private PlotOptionsFunnel3dCursor Cursor_DefaultValue { get; set; }
		...
		/// </summary>
		public PlotOptionsFunnel3dDashStyle DashStyle { get; set; }
		private PlotOptionsFunnel3dDashStyle DashStyle_DefaultValue { get; set; }
		...
		/// </summary>
		public PlotOptionsFunnel3dDragDrop DragDrop { get; set; }
		private PlotOptionsFunnel3dDragDrop DragDrop_DefaultValue { get; set; }
		...
		/// </summary>
		public PlotOptionsFunnel3dEvents Events { get; set; }
		private PlotOptionsFunnel3dEvents Events_DefaultValue { get; set; }
		...
		/// </summary>
		public PlotOptionsFunnel3dFindNearestPointBy FindNearestPointBy { get; set; }
		private PlotOptionsFunnel3dFindNearestPointBy FindNearestPointBy_DefaultValue { get; set; }
		...
		/// </summary>
		public PlotOptionsFunnel3dLabel Label { get; set; }
		private PlotOptionsFunnel3dLabel Label_DefaultValue { get; set; }
		 

		/// <summary>
		/// What type of legend symbol to render for this series. Can be one of`areaMarker`, `lineMarker` or `rectangle`.
		/// </summary>
		public PlotOptionsFunnel3dLegendSymbol LegendSymbol { get; set; }
		private PlotOptionsFunnel3dLegendSymbol LegendSymbol_DefaultValue { get; set; }
		...
		/// </summary>
		public PlotOptionsFunnel3dOnPoint OnPoint { get; set; }
		private PlotOptionsFunnel3dOnPoint OnPoint_DefaultValue { get; set; }
		...
		/// </summary>
		public PlotOptionsFunnel3dPoint Point { get; set; }
		private PlotOptionsFunnel3dPoint Point_DefaultValue { get; set; }
		...
		/// </summary>
		public PlotOptionsFunnel3dPointIntervalUnit PointIntervalUnit { get; set; }
		private PlotOptionsFunnel3dPointIntervalUnit PointIntervalUnit_DefaultValue { get; set; }
		...
		/// </summary>
		public PlotOptionsFunnel3dPointPlacement PointPlacement { get; set; }
		private PlotOptionsFunnel3dPointPlacement PointPlacement_DefaultValue { get; set; }
		...
		/// </summary>
		public PlotOptionsFunnel3dSonification Sonification { get; set; }
		private PlotOptionsFunnel3dSonification Sonification_DefaultValue { get; set; }
		...
		/// </summary>
		public PlotOptionsFunnel3dStacking Stacking { get; set; }
		private PlotOptionsFunnel3dStacking Stacking_DefaultValue { get; set; }
		 

		/// <summary>
		/// 
		/// </summary>
		public PlotOptionsFunnel3dStates States { get; set; }
		private PlotOptionsFunnel3dStates States_DefaultValue { get; set; }
		...
		/// </summary>
		public PlotOptionsFunnel3dTooltip Tooltip { get; set; }
		private PlotOptionsFunnel3dTooltip Tooltip_DefaultValue { get; set; }
		...
		/// </summary>
		public List<PlotOptionsFunnel3dZone> Zones { get; set; }
		private List<PlotOptionsFunnel3dZone> Zones_DefaultValue { get; set; }
		...
		internal override Hashtable ToHashtable(Highcharts highcharts)
		{
			...
			if (Cursor != PlotOptionsFunnel3dCursor.Null) h.Add("cursor", highcharts.FirstCharacterToLower(Cursor.ToString()));
			if (Custom != null) h.Add("custom",Custom);
			if (DashStyle != PlotOptionsFunnel3dDashStyle.Null) h.Add("dashStyle", highcharts.FirstCharacterToLower(DashStyle.ToString()));
			...
			if (FindNearestPointBy != PlotOptionsFunnel3dFindNearestPointBy.Null) h.Add("findNearestPointBy", highcharts.FirstCharacterToLower(FindNearestPointBy.ToString()));
			...
			if (LegendSymbol != PlotOptionsFunnel3dLegendSymbol.Null) h.Add("legendSymbol", highcharts.FirstCharacterToLower(LegendSymbol.ToString()));
			...
			if (PointIntervalUnit != PlotOptionsFunnel3dPointIntervalUnit.Null) h.Add("pointIntervalUnit", highcharts.FirstCharacterToLower(PointIntervalUnit.ToString()));
			if (PointPadding != null) h.Add("pointPadding",PointPadding);
			if (PointPlacement != PlotOptionsFunnel3dPointPlacement.Null) h.Add("pointPlacement", highcharts.FirstCharacterToLower(PointPlacement.ToString()));
			...
			if (Stacking != PlotOptionsFunnel3dStacking.Null) h.Add("stacking", highcharts.FirstCharacterToLower(Stacking.ToString()));
