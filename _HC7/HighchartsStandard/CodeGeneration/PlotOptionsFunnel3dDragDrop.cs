...
{
	public partial class PlotOptionsFunnel3dDragDrop  : BaseObject
	{
		public PlotOptionsFunnel3dDragDrop()
		{
			DraggableX = DraggableX_DefaultValue = null;
			DraggableY = DraggableY_DefaultValue = null;
			DragHandle = DragHandle_DefaultValue = new PlotOptionsFunnel3dDragDropDragHandle();
			...
			GuideBox = GuideBox_DefaultValue = new PlotOptionsFunnel3dDragDropGuideBox();
		...
		/// </summary>
		public PlotOptionsFunnel3dDragDropDragHandle DragHandle { get; set; }
		private PlotOptionsFunnel3dDragDropDragHandle DragHandle_DefaultValue { get; set; }
		...
		/// </summary>
		public PlotOptionsFunnel3dDragDropGuideBox GuideBox { get; set; }
		private PlotOptionsFunnel3dDragDropGuideBox GuideBox_DefaultValue { get; set; }
