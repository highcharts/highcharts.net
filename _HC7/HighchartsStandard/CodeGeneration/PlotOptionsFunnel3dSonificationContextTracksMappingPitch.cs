...
{
	public partial class PlotOptionsFunnel3dSonificationContextTracksMappingPitch  : BaseObject
	{
		Hashtable h = new Hashtable();

		public PlotOptionsFunnel3dSonificationContextTracksMappingPitch()
		{
			MapFunction = MapFunction_DefaultValue = PlotOptionsFunnel3dSonificationContextTracksMappingPitchMapFunction.Linear;
		...
		/// </summary>
		public PlotOptionsFunnel3dSonificationContextTracksMappingPitchMapFunction MapFunction { get; set; }
		private PlotOptionsFunnel3dSonificationContextTracksMappingPitchMapFunction MapFunction_DefaultValue { get; set; }
