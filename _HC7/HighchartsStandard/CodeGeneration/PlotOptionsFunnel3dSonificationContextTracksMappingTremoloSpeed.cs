...
{
	public partial class PlotOptionsFunnel3dSonificationContextTracksMappingTremoloSpeed  : BaseObject
	{
		Hashtable h = new Hashtable();

		public PlotOptionsFunnel3dSonificationContextTracksMappingTremoloSpeed()
		{
			MapFunction = MapFunction_DefaultValue = PlotOptionsFunnel3dSonificationContextTracksMappingTremoloSpeedMapFunction.Linear;
			MapTo = MapTo_DefaultValue = "";
			Max = Max_DefaultValue = null;
			Min = Min_DefaultValue = null;
			Value = Value_DefaultValue = null;
			Within = Within_DefaultValue = PlotOptionsFunnel3dSonificationContextTracksMappingTremoloSpeedWithin.Chart;
		...
		/// </summary>
		public PlotOptionsFunnel3dSonificationContextTracksMappingTremoloSpeedMapFunction MapFunction { get; set; }
		private PlotOptionsFunnel3dSonificationContextTracksMappingTremoloSpeedMapFunction MapFunction_DefaultValue { get; set; }
		...
		/// </summary>
		public PlotOptionsFunnel3dSonificationContextTracksMappingTremoloSpeedWithin Within { get; set; }
		private PlotOptionsFunnel3dSonificationContextTracksMappingTremoloSpeedWithin Within_DefaultValue { get; set; }
