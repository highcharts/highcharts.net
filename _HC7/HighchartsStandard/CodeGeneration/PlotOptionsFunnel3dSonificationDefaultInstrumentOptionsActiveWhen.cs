...
{
	public partial class PlotOptionsFunnel3dSonificationDefaultInstrumentOptionsActiveWhen  : BaseObject
	{
		Hashtable h = new Hashtable();

		public PlotOptionsFunnel3dSonificationDefaultInstrumentOptionsActiveWhen()
		{
