...
{
	public partial class PlotOptionsFunnel3dSonificationPointGrouping  : BaseObject
	{
		Hashtable h = new Hashtable();

		public PlotOptionsFunnel3dSonificationPointGrouping()
		{
		...
		/// </summary>
		public PlotOptionsFunnel3dSonificationPointGroupingAlgorithm Algorithm { get; set; }
		private PlotOptionsFunnel3dSonificationPointGroupingAlgorithm Algorithm_DefaultValue { get; set; }
		...
		internal override Hashtable ToHashtable(Highcharts highcharts)
		{
			...
			if (Algorithm != PlotOptionsFunnel3dSonificationPointGroupingAlgorithm.Null) h.Add("algorithm", highcharts.FirstCharacterToLower(Algorithm.ToString()));
