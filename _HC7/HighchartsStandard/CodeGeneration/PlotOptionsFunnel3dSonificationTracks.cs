...
{
	public partial class PlotOptionsFunnel3dSonificationTracks  : BaseObject
	{
		Hashtable h = new Hashtable();

		public PlotOptionsFunnel3dSonificationTracks()
		{
			ActiveWhen = ActiveWhen_DefaultValue = new PlotOptionsFunnel3dSonificationTracksActiveWhen();
			Instrument = Instrument_DefaultValue = null;
			InstrumentString = InstrumentString_DefaultValue = "null";
			Mapping = Mapping_DefaultValue = new PlotOptionsFunnel3dSonificationTracksMapping();
			MidiName = MidiName_DefaultValue = "";
			PointGrouping = PointGrouping_DefaultValue = new PlotOptionsFunnel3dSonificationTracksPointGrouping();
			RoundToMusicalNotes = RoundToMusicalNotes_DefaultValue = true;
			ShowPlayMarker = ShowPlayMarker_DefaultValue = true;
			Type = Type_DefaultValue = PlotOptionsFunnel3dSonificationTracksType.Instrument;
		...
		/// </summary>
		public PlotOptionsFunnel3dSonificationTracksActiveWhen ActiveWhen { get; set; }
		private PlotOptionsFunnel3dSonificationTracksActiveWhen ActiveWhen_DefaultValue { get; set; }
		...
		/// </summary>
		public PlotOptionsFunnel3dSonificationTracksMapping Mapping { get; set; }
		private PlotOptionsFunnel3dSonificationTracksMapping Mapping_DefaultValue { get; set; }
		...
		/// </summary>
		public PlotOptionsFunnel3dSonificationTracksPointGrouping PointGrouping { get; set; }
		private PlotOptionsFunnel3dSonificationTracksPointGrouping PointGrouping_DefaultValue { get; set; }
		...
		/// </summary>
		public PlotOptionsFunnel3dSonificationTracksType Type { get; set; }
		private PlotOptionsFunnel3dSonificationTracksType Type_DefaultValue { get; set; }
