...
{
	public partial class PlotOptionsFunnel3dSonificationTracksMapping  : BaseObject
	{
		Hashtable h = new Hashtable();

		public PlotOptionsFunnel3dSonificationTracksMapping()
		{
			Frequency = Frequency_DefaultValue = new PlotOptionsFunnel3dSonificationTracksMappingFrequency();
			GapBetweenNotes = GapBetweenNotes_DefaultValue = new PlotOptionsFunnel3dSonificationTracksMappingGapBetweenNotes();
			Highpass = Highpass_DefaultValue = new PlotOptionsFunnel3dSonificationTracksMappingHighpass();
			Lowpass = Lowpass_DefaultValue = new PlotOptionsFunnel3dSonificationTracksMappingLowpass();
			NoteDuration = NoteDuration_DefaultValue = new PlotOptionsFunnel3dSonificationTracksMappingNoteDuration();
			Pan = Pan_DefaultValue = new PlotOptionsFunnel3dSonificationTracksMappingPan();
			Pitch = Pitch_DefaultValue = new PlotOptionsFunnel3dSonificationTracksMappingPitch();
			PitchString = PitchString_DefaultValue = "null";
			PitchNumber = PitchNumber_DefaultValue = null;
			PlayDelay = PlayDelay_DefaultValue = new PlotOptionsFunnel3dSonificationTracksMappingPlayDelay();
			Time = Time_DefaultValue = new PlotOptionsFunnel3dSonificationTracksMappingTime();
			TimeString = TimeString_DefaultValue = "null";
			TimeNumber = TimeNumber_DefaultValue = null;
			Tremolo = Tremolo_DefaultValue = new PlotOptionsFunnel3dSonificationTracksMappingTremolo();
			Volume = Volume_DefaultValue = new PlotOptionsFunnel3dSonificationTracksMappingVolume();
		...
		/// </summary>
		public PlotOptionsFunnel3dSonificationTracksMappingFrequency Frequency { get; set; }
		private PlotOptionsFunnel3dSonificationTracksMappingFrequency Frequency_DefaultValue { get; set; }
		...
		/// </summary>
		public PlotOptionsFunnel3dSonificationTracksMappingGapBetweenNotes GapBetweenNotes { get; set; }
		private PlotOptionsFunnel3dSonificationTracksMappingGapBetweenNotes GapBetweenNotes_DefaultValue { get; set; }
		...
		/// </summary>
		public PlotOptionsFunnel3dSonificationTracksMappingHighpass Highpass { get; set; }
		private PlotOptionsFunnel3dSonificationTracksMappingHighpass Highpass_DefaultValue { get; set; }
		...
		/// </summary>
		public PlotOptionsFunnel3dSonificationTracksMappingLowpass Lowpass { get; set; }
		private PlotOptionsFunnel3dSonificationTracksMappingLowpass Lowpass_DefaultValue { get; set; }
		...
		/// </summary>
		public PlotOptionsFunnel3dSonificationTracksMappingNoteDuration NoteDuration { get; set; }
		private PlotOptionsFunnel3dSonificationTracksMappingNoteDuration NoteDuration_DefaultValue { get; set; }
		...
		/// </summary>
		public PlotOptionsFunnel3dSonificationTracksMappingPan Pan { get; set; }
		private PlotOptionsFunnel3dSonificationTracksMappingPan Pan_DefaultValue { get; set; }
		...
		/// </summary>
		public PlotOptionsFunnel3dSonificationTracksMappingPitch Pitch { get; set; }
		private PlotOptionsFunnel3dSonificationTracksMappingPitch Pitch_DefaultValue { get; set; }
		...
		/// </summary>
		public PlotOptionsFunnel3dSonificationTracksMappingPlayDelay PlayDelay { get; set; }
		private PlotOptionsFunnel3dSonificationTracksMappingPlayDelay PlayDelay_DefaultValue { get; set; }
		...
		/// </summary>
		public PlotOptionsFunnel3dSonificationTracksMappingTime Time { get; set; }
		private PlotOptionsFunnel3dSonificationTracksMappingTime Time_DefaultValue { get; set; }
		...
		/// </summary>
		public PlotOptionsFunnel3dSonificationTracksMappingTremolo Tremolo { get; set; }
		private PlotOptionsFunnel3dSonificationTracksMappingTremolo Tremolo_DefaultValue { get; set; }
		 

		/// <summary>
		/// The volume of notes, from 0 to 1.
		/// </summary>
		public PlotOptionsFunnel3dSonificationTracksMappingVolume Volume { get; set; }
		private PlotOptionsFunnel3dSonificationTracksMappingVolume Volume_DefaultValue { get; set; }
