...
{
	public partial class PlotOptionsFunnel3dSonificationTracksMappingFrequency  : BaseObject
	{
		Hashtable h = new Hashtable();

		public PlotOptionsFunnel3dSonificationTracksMappingFrequency()
		{
			MapFunction = MapFunction_DefaultValue = PlotOptionsFunnel3dSonificationTracksMappingFrequencyMapFunction.Linear;
			MapTo = MapTo_DefaultValue = "";
			Max = Max_DefaultValue = null;
			Min = Min_DefaultValue = null;
			Value = Value_DefaultValue = null;
			Within = Within_DefaultValue = PlotOptionsFunnel3dSonificationTracksMappingFrequencyWithin.Chart;
		...
		/// </summary>
		public PlotOptionsFunnel3dSonificationTracksMappingFrequencyMapFunction MapFunction { get; set; }
		private PlotOptionsFunnel3dSonificationTracksMappingFrequencyMapFunction MapFunction_DefaultValue { get; set; }
		...
		/// </summary>
		public PlotOptionsFunnel3dSonificationTracksMappingFrequencyWithin Within { get; set; }
		private PlotOptionsFunnel3dSonificationTracksMappingFrequencyWithin Within_DefaultValue { get; set; }
