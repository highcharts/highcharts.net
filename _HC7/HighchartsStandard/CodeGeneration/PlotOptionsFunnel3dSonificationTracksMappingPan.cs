...
{
	public partial class PlotOptionsFunnel3dSonificationTracksMappingPan  : BaseObject
	{
		Hashtable h = new Hashtable();

		public PlotOptionsFunnel3dSonificationTracksMappingPan()
		{
			MapFunction = MapFunction_DefaultValue = PlotOptionsFunnel3dSonificationTracksMappingPanMapFunction.Linear;
			MapTo = MapTo_DefaultValue = "";
			Max = Max_DefaultValue = null;
			Min = Min_DefaultValue = null;
			Value = Value_DefaultValue = null;
			Within = Within_DefaultValue = PlotOptionsFunnel3dSonificationTracksMappingPanWithin.Chart;
		...
		/// </summary>
		public PlotOptionsFunnel3dSonificationTracksMappingPanMapFunction MapFunction { get; set; }
		private PlotOptionsFunnel3dSonificationTracksMappingPanMapFunction MapFunction_DefaultValue { get; set; }
		...
		/// </summary>
		public PlotOptionsFunnel3dSonificationTracksMappingPanWithin Within { get; set; }
		private PlotOptionsFunnel3dSonificationTracksMappingPanWithin Within_DefaultValue { get; set; }
