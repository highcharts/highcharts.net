...
{
	public partial class PlotOptionsFunnel3dSonificationTracksMappingPitch  : BaseObject
	{
		Hashtable h = new Hashtable();

		public PlotOptionsFunnel3dSonificationTracksMappingPitch()
		{
			MapFunction = MapFunction_DefaultValue = PlotOptionsFunnel3dSonificationTracksMappingPitchMapFunction.Linear;
		...
		/// </summary>
		public PlotOptionsFunnel3dSonificationTracksMappingPitchMapFunction MapFunction { get; set; }
		private PlotOptionsFunnel3dSonificationTracksMappingPitchMapFunction MapFunction_DefaultValue { get; set; }
