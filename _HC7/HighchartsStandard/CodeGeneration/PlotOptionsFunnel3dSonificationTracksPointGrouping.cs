...
{
	public partial class PlotOptionsFunnel3dSonificationTracksPointGrouping  : BaseObject
	{
		Hashtable h = new Hashtable();

		public PlotOptionsFunnel3dSonificationTracksPointGrouping()
		{
		...
		/// </summary>
		public PlotOptionsFunnel3dSonificationTracksPointGroupingAlgorithm Algorithm { get; set; }
		private PlotOptionsFunnel3dSonificationTracksPointGroupingAlgorithm Algorithm_DefaultValue { get; set; }
		...
		internal override Hashtable ToHashtable(Highcharts highcharts)
		{
			...
			if (Algorithm != PlotOptionsFunnel3dSonificationTracksPointGroupingAlgorithm.Null) h.Add("algorithm", highcharts.FirstCharacterToLower(Algorithm.ToString()));
