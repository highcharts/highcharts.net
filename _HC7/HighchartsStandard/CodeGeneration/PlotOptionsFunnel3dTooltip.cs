...
{
	public partial class PlotOptionsFunnel3dTooltip  : BaseObject
	{
		public PlotOptionsFunnel3dTooltip()
		{
			...
			HeaderShape = HeaderShape_DefaultValue = PlotOptionsFunnel3dTooltipHeaderShape.Callout;
		...
		/// </summary>
		public PlotOptionsFunnel3dTooltipHeaderShape HeaderShape { get; set; }
		private PlotOptionsFunnel3dTooltipHeaderShape HeaderShape_DefaultValue { get; set; }
		...
		internal override Hashtable ToHashtable()
		{
			...
			if (NullFormatter != NullFormatter_DefaultValue) { h.Add("nullFormatter",NullFormatter); Highcharts.AddFunction("PlotOptionsFunnel3dTooltipNullFormatter.nullFormatter", NullFormatter); }  
			if (Outside != Outside_DefaultValue) h.Add("outside",Outside);
			if (Padding != Padding_DefaultValue) h.Add("padding",Padding);
			if (PointFormat != PointFormat_DefaultValue) h.Add("pointFormat",PointFormat);
			if (PointFormatter != PointFormatter_DefaultValue) { h.Add("pointFormatter",PointFormatter); Highcharts.AddFunction("PlotOptionsFunnel3dTooltipPointFormatter.pointFormatter", PointFormatter); }  
