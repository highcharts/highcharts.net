...
namespace Highsoft.Web.Mvc.Charts
{
	public partial class PlotOptionsFunnelDataLabels  : BaseObject
	{
		...
		{
			Align = Align_DefaultValue = PlotOptionsFunnelDataLabelsAlign.Center;
			...
			Filter = Filter_DefaultValue = new PlotOptionsFunnelDataLabelsFilter();
			...
			Position = Position_DefaultValue = PlotOptionsFunnelDataLabelsPosition.Center;
			...
			TextPath = TextPath_DefaultValue = new PlotOptionsFunnelDataLabelsTextPath();
			UseHTML = UseHTML_DefaultValue = false;
			VerticalAlign = VerticalAlign_DefaultValue = PlotOptionsFunnelDataLabelsVerticalAlign.Middle;
			X = X_DefaultValue = 0;
			Y = Y_DefaultValue = 0;
		...
		private PlotOptionsFunnelDataLabelsAlign Align_DefaultValue { get; set; }
		...
		private PlotOptionsFunnelDataLabelsFilter Filter_DefaultValue { get; set; }
		...
		private PlotOptionsFunnelDataLabelsPosition Position_DefaultValue { get; set; }
		...
		private PlotOptionsFunnelDataLabelsTextPath TextPath_DefaultValue { get; set; }
