...
namespace Highsoft.Web.Mvc.Charts
{
	public partial class PlotOptionsFunnelSonificationContextTracks  : BaseObject
	{
		...
		{
			ActiveWhen = ActiveWhen_DefaultValue = new PlotOptionsFunnelSonificationContextTracksActiveWhen();
			Instrument = Instrument_DefaultValue = null;
			InstrumentString = InstrumentString_DefaultValue = "null";
			Mapping = Mapping_DefaultValue = new PlotOptionsFunnelSonificationContextTracksMapping();
			MidiName = MidiName_DefaultValue = "";
			PointGrouping = PointGrouping_DefaultValue = new PlotOptionsFunnelSonificationContextTracksPointGrouping();
			...
			Type = Type_DefaultValue = PlotOptionsFunnelSonificationContextTracksType.Instrument;
			ValueInterval = ValueInterval_DefaultValue = null;
			ValueMapFunction = ValueMapFunction_DefaultValue = PlotOptionsFunnelSonificationContextTracksValueMapFunction.Linear;
		...
		private PlotOptionsFunnelSonificationContextTracksActiveWhen ActiveWhen_DefaultValue { get; set; }
		...
		private PlotOptionsFunnelSonificationContextTracksMapping Mapping_DefaultValue { get; set; }
		...
		private PlotOptionsFunnelSonificationContextTracksPointGrouping PointGrouping_DefaultValue { get; set; }
		...
		private PlotOptionsFunnelSonificationContextTracksType Type_DefaultValue { get; set; }
		...
		private PlotOptionsFunnelSonificationContextTracksValueMapFunction ValueMapFunction_DefaultValue { get; set; }
