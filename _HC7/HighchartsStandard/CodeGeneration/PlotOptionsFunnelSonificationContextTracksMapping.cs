...
{
	public partial class PlotOptionsFunnelSonificationContextTracksMapping  : BaseObject
	{
		Hashtable h = new Hashtable();

		public PlotOptionsFunnelSonificationContextTracksMapping()
		{
			Frequency = Frequency_DefaultValue = new PlotOptionsFunnelSonificationContextTracksMappingFrequency();
			GapBetweenNotes = GapBetweenNotes_DefaultValue = new PlotOptionsFunnelSonificationContextTracksMappingGapBetweenNotes();
			Highpass = Highpass_DefaultValue = new PlotOptionsFunnelSonificationContextTracksMappingHighpass();
			Lowpass = Lowpass_DefaultValue = new PlotOptionsFunnelSonificationContextTracksMappingLowpass();
			NoteDuration = NoteDuration_DefaultValue = new PlotOptionsFunnelSonificationContextTracksMappingNoteDuration();
			Pan = Pan_DefaultValue = new PlotOptionsFunnelSonificationContextTracksMappingPan();
			Pitch = Pitch_DefaultValue = new PlotOptionsFunnelSonificationContextTracksMappingPitch();
			PitchString = PitchString_DefaultValue = "null";
			PitchNumber = PitchNumber_DefaultValue = null;
			PlayDelay = PlayDelay_DefaultValue = new PlotOptionsFunnelSonificationContextTracksMappingPlayDelay();
			Time = Time_DefaultValue = new PlotOptionsFunnelSonificationContextTracksMappingTime();
			TimeString = TimeString_DefaultValue = "null";
			TimeNumber = TimeNumber_DefaultValue = null;
			Tremolo = Tremolo_DefaultValue = new PlotOptionsFunnelSonificationContextTracksMappingTremolo();
			Volume = Volume_DefaultValue = new PlotOptionsFunnelSonificationContextTracksMappingVolume();
		...
		/// </summary>
		public PlotOptionsFunnelSonificationContextTracksMappingFrequency Frequency { get; set; }
		private PlotOptionsFunnelSonificationContextTracksMappingFrequency Frequency_DefaultValue { get; set; }
		...
		/// </summary>
		public PlotOptionsFunnelSonificationContextTracksMappingGapBetweenNotes GapBetweenNotes { get; set; }
		private PlotOptionsFunnelSonificationContextTracksMappingGapBetweenNotes GapBetweenNotes_DefaultValue { get; set; }
		...
		/// </summary>
		public PlotOptionsFunnelSonificationContextTracksMappingHighpass Highpass { get; set; }
		private PlotOptionsFunnelSonificationContextTracksMappingHighpass Highpass_DefaultValue { get; set; }
		...
		/// </summary>
		public PlotOptionsFunnelSonificationContextTracksMappingLowpass Lowpass { get; set; }
		private PlotOptionsFunnelSonificationContextTracksMappingLowpass Lowpass_DefaultValue { get; set; }
		...
		/// </summary>
		public PlotOptionsFunnelSonificationContextTracksMappingNoteDuration NoteDuration { get; set; }
		private PlotOptionsFunnelSonificationContextTracksMappingNoteDuration NoteDuration_DefaultValue { get; set; }
		...
		/// </summary>
		public PlotOptionsFunnelSonificationContextTracksMappingPan Pan { get; set; }
		private PlotOptionsFunnelSonificationContextTracksMappingPan Pan_DefaultValue { get; set; }
		...
		/// </summary>
		public PlotOptionsFunnelSonificationContextTracksMappingPitch Pitch { get; set; }
		private PlotOptionsFunnelSonificationContextTracksMappingPitch Pitch_DefaultValue { get; set; }
		...
		/// </summary>
		public PlotOptionsFunnelSonificationContextTracksMappingPlayDelay PlayDelay { get; set; }
		private PlotOptionsFunnelSonificationContextTracksMappingPlayDelay PlayDelay_DefaultValue { get; set; }
		...
		/// </summary>
		public PlotOptionsFunnelSonificationContextTracksMappingTime Time { get; set; }
		private PlotOptionsFunnelSonificationContextTracksMappingTime Time_DefaultValue { get; set; }
		...
		/// </summary>
		public PlotOptionsFunnelSonificationContextTracksMappingTremolo Tremolo { get; set; }
		private PlotOptionsFunnelSonificationContextTracksMappingTremolo Tremolo_DefaultValue { get; set; }
		 

		/// <summary>
		/// The volume of notes, from 0 to 1.
		/// </summary>
		public PlotOptionsFunnelSonificationContextTracksMappingVolume Volume { get; set; }
		private PlotOptionsFunnelSonificationContextTracksMappingVolume Volume_DefaultValue { get; set; }
