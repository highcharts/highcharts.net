...
{
	public partial class PlotOptionsFunnelSonificationContextTracksMappingPan  : BaseObject
	{
		Hashtable h = new Hashtable();

		public PlotOptionsFunnelSonificationContextTracksMappingPan()
		{
			MapFunction = MapFunction_DefaultValue = PlotOptionsFunnelSonificationContextTracksMappingPanMapFunction.Linear;
			MapTo = MapTo_DefaultValue = "";
			Max = Max_DefaultValue = null;
			Min = Min_DefaultValue = null;
			Value = Value_DefaultValue = null;
			Within = Within_DefaultValue = PlotOptionsFunnelSonificationContextTracksMappingPanWithin.Chart;
		...
		/// </summary>
		public PlotOptionsFunnelSonificationContextTracksMappingPanMapFunction MapFunction { get; set; }
		private PlotOptionsFunnelSonificationContextTracksMappingPanMapFunction MapFunction_DefaultValue { get; set; }
		...
		/// </summary>
		public PlotOptionsFunnelSonificationContextTracksMappingPanWithin Within { get; set; }
		private PlotOptionsFunnelSonificationContextTracksMappingPanWithin Within_DefaultValue { get; set; }
