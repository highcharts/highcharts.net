...
{
	public partial class PlotOptionsFunnelSonificationContextTracksMappingPitch  : BaseObject
	{
		Hashtable h = new Hashtable();

		public PlotOptionsFunnelSonificationContextTracksMappingPitch()
		{
			MapFunction = MapFunction_DefaultValue = PlotOptionsFunnelSonificationContextTracksMappingPitchMapFunction.Linear;
		...
		/// </summary>
		public PlotOptionsFunnelSonificationContextTracksMappingPitchMapFunction MapFunction { get; set; }
		private PlotOptionsFunnelSonificationContextTracksMappingPitchMapFunction MapFunction_DefaultValue { get; set; }
