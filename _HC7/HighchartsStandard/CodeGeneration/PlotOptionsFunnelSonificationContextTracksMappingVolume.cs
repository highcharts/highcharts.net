...
{
	public partial class PlotOptionsFunnelSonificationContextTracksMappingVolume  : BaseObject
	{
		Hashtable h = new Hashtable();

		public PlotOptionsFunnelSonificationContextTracksMappingVolume()
		{
			MapFunction = MapFunction_DefaultValue = PlotOptionsFunnelSonificationContextTracksMappingVolumeMapFunction.Linear;
			MapTo = MapTo_DefaultValue = "";
			Max = Max_DefaultValue = null;
			Min = Min_DefaultValue = null;
			Value = Value_DefaultValue = null;
			Within = Within_DefaultValue = PlotOptionsFunnelSonificationContextTracksMappingVolumeWithin.Chart;
		...
		/// </summary>
		public PlotOptionsFunnelSonificationContextTracksMappingVolumeMapFunction MapFunction { get; set; }
		private PlotOptionsFunnelSonificationContextTracksMappingVolumeMapFunction MapFunction_DefaultValue { get; set; }
		...
		/// </summary>
		public PlotOptionsFunnelSonificationContextTracksMappingVolumeWithin Within { get; set; }
		private PlotOptionsFunnelSonificationContextTracksMappingVolumeWithin Within_DefaultValue { get; set; }
