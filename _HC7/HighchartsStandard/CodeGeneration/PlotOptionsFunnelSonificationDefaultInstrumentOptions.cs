...
{
	public partial class PlotOptionsFunnelSonificationDefaultInstrumentOptions  : BaseObject
	{
		Hashtable h = new Hashtable();

		public PlotOptionsFunnelSonificationDefaultInstrumentOptions()
		{
			ActiveWhen = ActiveWhen_DefaultValue = new PlotOptionsFunnelSonificationDefaultInstrumentOptionsActiveWhen();
			Instrument = Instrument_DefaultValue = null;
			InstrumentString = InstrumentString_DefaultValue = "null";
			Mapping = Mapping_DefaultValue = new PlotOptionsFunnelSonificationDefaultInstrumentOptionsMapping();
			MidiName = MidiName_DefaultValue = "";
			PointGrouping = PointGrouping_DefaultValue = new PlotOptionsFunnelSonificationDefaultInstrumentOptionsPointGrouping();
			RoundToMusicalNotes = RoundToMusicalNotes_DefaultValue = true;
			ShowPlayMarker = ShowPlayMarker_DefaultValue = true;
			Type = Type_DefaultValue = PlotOptionsFunnelSonificationDefaultInstrumentOptionsType.Instrument;
		...
		/// </summary>
		public PlotOptionsFunnelSonificationDefaultInstrumentOptionsActiveWhen ActiveWhen { get; set; }
		private PlotOptionsFunnelSonificationDefaultInstrumentOptionsActiveWhen ActiveWhen_DefaultValue { get; set; }
		...
		/// </summary>
		public PlotOptionsFunnelSonificationDefaultInstrumentOptionsMapping Mapping { get; set; }
		private PlotOptionsFunnelSonificationDefaultInstrumentOptionsMapping Mapping_DefaultValue { get; set; }
		...
		/// </summary>
		public PlotOptionsFunnelSonificationDefaultInstrumentOptionsPointGrouping PointGrouping { get; set; }
		private PlotOptionsFunnelSonificationDefaultInstrumentOptionsPointGrouping PointGrouping_DefaultValue { get; set; }
		...
		/// </summary>
		public PlotOptionsFunnelSonificationDefaultInstrumentOptionsType Type { get; set; }
		private PlotOptionsFunnelSonificationDefaultInstrumentOptionsType Type_DefaultValue { get; set; }
