...
{
	public partial class PlotOptionsFunnelSonificationDefaultInstrumentOptionsMappingTremoloDepth  : BaseObject
	{
		Hashtable h = new Hashtable();

		public PlotOptionsFunnelSonificationDefaultInstrumentOptionsMappingTremoloDepth()
		{
			MapFunction = MapFunction_DefaultValue = PlotOptionsFunnelSonificationDefaultInstrumentOptionsMappingTremoloDepthMapFunction.Linear;
			MapTo = MapTo_DefaultValue = "";
			Max = Max_DefaultValue = null;
			Min = Min_DefaultValue = null;
			Value = Value_DefaultValue = null;
			Within = Within_DefaultValue = PlotOptionsFunnelSonificationDefaultInstrumentOptionsMappingTremoloDepthWithin.Chart;
		...
		/// </summary>
		public PlotOptionsFunnelSonificationDefaultInstrumentOptionsMappingTremoloDepthMapFunction MapFunction { get; set; }
		private PlotOptionsFunnelSonificationDefaultInstrumentOptionsMappingTremoloDepthMapFunction MapFunction_DefaultValue { get; set; }
		...
		/// </summary>
		public PlotOptionsFunnelSonificationDefaultInstrumentOptionsMappingTremoloDepthWithin Within { get; set; }
		private PlotOptionsFunnelSonificationDefaultInstrumentOptionsMappingTremoloDepthWithin Within_DefaultValue { get; set; }
