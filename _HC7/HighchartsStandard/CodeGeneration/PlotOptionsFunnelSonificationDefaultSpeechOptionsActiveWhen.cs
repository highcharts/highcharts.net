...
{
	public partial class PlotOptionsFunnelSonificationDefaultSpeechOptionsActiveWhen  : BaseObject
	{
		Hashtable h = new Hashtable();

		public PlotOptionsFunnelSonificationDefaultSpeechOptionsActiveWhen()
		{
