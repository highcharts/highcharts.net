...
{
	public partial class PlotOptionsFunnelSonificationPointGrouping  : BaseObject
	{
		Hashtable h = new Hashtable();

		public PlotOptionsFunnelSonificationPointGrouping()
		{
		...
		/// </summary>
		public PlotOptionsFunnelSonificationPointGroupingAlgorithm Algorithm { get; set; }
		private PlotOptionsFunnelSonificationPointGroupingAlgorithm Algorithm_DefaultValue { get; set; }
		...
		internal override Hashtable ToHashtable(Highcharts highcharts)
		{
			...
			if (Algorithm != PlotOptionsFunnelSonificationPointGroupingAlgorithm.Null) h.Add("algorithm", highcharts.FirstCharacterToLower(Algorithm.ToString()));
