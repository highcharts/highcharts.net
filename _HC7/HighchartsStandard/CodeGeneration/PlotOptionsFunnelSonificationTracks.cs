...
{
	public partial class PlotOptionsFunnelSonificationTracks  : BaseObject
	{
		Hashtable h = new Hashtable();

		public PlotOptionsFunnelSonificationTracks()
		{
			ActiveWhen = ActiveWhen_DefaultValue = new PlotOptionsFunnelSonificationTracksActiveWhen();
			Instrument = Instrument_DefaultValue = null;
			InstrumentString = InstrumentString_DefaultValue = "null";
			Mapping = Mapping_DefaultValue = new PlotOptionsFunnelSonificationTracksMapping();
			MidiName = MidiName_DefaultValue = "";
			PointGrouping = PointGrouping_DefaultValue = new PlotOptionsFunnelSonificationTracksPointGrouping();
			RoundToMusicalNotes = RoundToMusicalNotes_DefaultValue = true;
			ShowPlayMarker = ShowPlayMarker_DefaultValue = true;
			Type = Type_DefaultValue = PlotOptionsFunnelSonificationTracksType.Instrument;
		...
		/// </summary>
		public PlotOptionsFunnelSonificationTracksActiveWhen ActiveWhen { get; set; }
		private PlotOptionsFunnelSonificationTracksActiveWhen ActiveWhen_DefaultValue { get; set; }
		...
		/// </summary>
		public PlotOptionsFunnelSonificationTracksMapping Mapping { get; set; }
		private PlotOptionsFunnelSonificationTracksMapping Mapping_DefaultValue { get; set; }
		...
		/// </summary>
		public PlotOptionsFunnelSonificationTracksPointGrouping PointGrouping { get; set; }
		private PlotOptionsFunnelSonificationTracksPointGrouping PointGrouping_DefaultValue { get; set; }
		...
		/// </summary>
		public PlotOptionsFunnelSonificationTracksType Type { get; set; }
		private PlotOptionsFunnelSonificationTracksType Type_DefaultValue { get; set; }
