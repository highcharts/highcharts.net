...
{
	public partial class PlotOptionsFunnelSonificationTracksMapping  : BaseObject
	{
		Hashtable h = new Hashtable();

		public PlotOptionsFunnelSonificationTracksMapping()
		{
			Frequency = Frequency_DefaultValue = new PlotOptionsFunnelSonificationTracksMappingFrequency();
			GapBetweenNotes = GapBetweenNotes_DefaultValue = new PlotOptionsFunnelSonificationTracksMappingGapBetweenNotes();
			Highpass = Highpass_DefaultValue = new PlotOptionsFunnelSonificationTracksMappingHighpass();
			Lowpass = Lowpass_DefaultValue = new PlotOptionsFunnelSonificationTracksMappingLowpass();
			NoteDuration = NoteDuration_DefaultValue = new PlotOptionsFunnelSonificationTracksMappingNoteDuration();
			Pan = Pan_DefaultValue = new PlotOptionsFunnelSonificationTracksMappingPan();
			Pitch = Pitch_DefaultValue = new PlotOptionsFunnelSonificationTracksMappingPitch();
			PitchString = PitchString_DefaultValue = "null";
			PitchNumber = PitchNumber_DefaultValue = null;
			PlayDelay = PlayDelay_DefaultValue = new PlotOptionsFunnelSonificationTracksMappingPlayDelay();
			Time = Time_DefaultValue = new PlotOptionsFunnelSonificationTracksMappingTime();
			TimeString = TimeString_DefaultValue = "null";
			TimeNumber = TimeNumber_DefaultValue = null;
			Tremolo = Tremolo_DefaultValue = new PlotOptionsFunnelSonificationTracksMappingTremolo();
			Volume = Volume_DefaultValue = new PlotOptionsFunnelSonificationTracksMappingVolume();
		...
		/// </summary>
		public PlotOptionsFunnelSonificationTracksMappingFrequency Frequency { get; set; }
		private PlotOptionsFunnelSonificationTracksMappingFrequency Frequency_DefaultValue { get; set; }
		...
		/// </summary>
		public PlotOptionsFunnelSonificationTracksMappingGapBetweenNotes GapBetweenNotes { get; set; }
		private PlotOptionsFunnelSonificationTracksMappingGapBetweenNotes GapBetweenNotes_DefaultValue { get; set; }
		...
		/// </summary>
		public PlotOptionsFunnelSonificationTracksMappingHighpass Highpass { get; set; }
		private PlotOptionsFunnelSonificationTracksMappingHighpass Highpass_DefaultValue { get; set; }
		...
		/// </summary>
		public PlotOptionsFunnelSonificationTracksMappingLowpass Lowpass { get; set; }
		private PlotOptionsFunnelSonificationTracksMappingLowpass Lowpass_DefaultValue { get; set; }
		...
		/// </summary>
		public PlotOptionsFunnelSonificationTracksMappingNoteDuration NoteDuration { get; set; }
		private PlotOptionsFunnelSonificationTracksMappingNoteDuration NoteDuration_DefaultValue { get; set; }
		...
		/// </summary>
		public PlotOptionsFunnelSonificationTracksMappingPan Pan { get; set; }
		private PlotOptionsFunnelSonificationTracksMappingPan Pan_DefaultValue { get; set; }
		...
		/// </summary>
		public PlotOptionsFunnelSonificationTracksMappingPitch Pitch { get; set; }
		private PlotOptionsFunnelSonificationTracksMappingPitch Pitch_DefaultValue { get; set; }
		...
		/// </summary>
		public PlotOptionsFunnelSonificationTracksMappingPlayDelay PlayDelay { get; set; }
		private PlotOptionsFunnelSonificationTracksMappingPlayDelay PlayDelay_DefaultValue { get; set; }
		...
		/// </summary>
		public PlotOptionsFunnelSonificationTracksMappingTime Time { get; set; }
		private PlotOptionsFunnelSonificationTracksMappingTime Time_DefaultValue { get; set; }
		...
		/// </summary>
		public PlotOptionsFunnelSonificationTracksMappingTremolo Tremolo { get; set; }
		private PlotOptionsFunnelSonificationTracksMappingTremolo Tremolo_DefaultValue { get; set; }
		 

		/// <summary>
		/// The volume of notes, from 0 to 1.
		/// </summary>
		public PlotOptionsFunnelSonificationTracksMappingVolume Volume { get; set; }
		private PlotOptionsFunnelSonificationTracksMappingVolume Volume_DefaultValue { get; set; }
