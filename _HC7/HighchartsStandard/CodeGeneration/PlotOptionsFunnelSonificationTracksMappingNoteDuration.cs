...
{
	public partial class PlotOptionsFunnelSonificationTracksMappingNoteDuration  : BaseObject
	{
		Hashtable h = new Hashtable();

		public PlotOptionsFunnelSonificationTracksMappingNoteDuration()
		{
			MapFunction = MapFunction_DefaultValue = PlotOptionsFunnelSonificationTracksMappingNoteDurationMapFunction.Linear;
			MapTo = MapTo_DefaultValue = "";
			Max = Max_DefaultValue = null;
			Min = Min_DefaultValue = null;
			Value = Value_DefaultValue = null;
			Within = Within_DefaultValue = PlotOptionsFunnelSonificationTracksMappingNoteDurationWithin.Chart;
		...
		/// </summary>
		public PlotOptionsFunnelSonificationTracksMappingNoteDurationMapFunction MapFunction { get; set; }
		private PlotOptionsFunnelSonificationTracksMappingNoteDurationMapFunction MapFunction_DefaultValue { get; set; }
		...
		/// </summary>
		public PlotOptionsFunnelSonificationTracksMappingNoteDurationWithin Within { get; set; }
		private PlotOptionsFunnelSonificationTracksMappingNoteDurationWithin Within_DefaultValue { get; set; }
