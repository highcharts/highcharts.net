...
{
	public partial class PlotOptionsFunnelSonificationTracksMappingPan  : BaseObject
	{
		Hashtable h = new Hashtable();

		public PlotOptionsFunnelSonificationTracksMappingPan()
		{
			MapFunction = MapFunction_DefaultValue = PlotOptionsFunnelSonificationTracksMappingPanMapFunction.Linear;
			MapTo = MapTo_DefaultValue = "";
			Max = Max_DefaultValue = null;
			Min = Min_DefaultValue = null;
			Value = Value_DefaultValue = null;
			Within = Within_DefaultValue = PlotOptionsFunnelSonificationTracksMappingPanWithin.Chart;
		...
		/// </summary>
		public PlotOptionsFunnelSonificationTracksMappingPanMapFunction MapFunction { get; set; }
		private PlotOptionsFunnelSonificationTracksMappingPanMapFunction MapFunction_DefaultValue { get; set; }
		...
		/// </summary>
		public PlotOptionsFunnelSonificationTracksMappingPanWithin Within { get; set; }
		private PlotOptionsFunnelSonificationTracksMappingPanWithin Within_DefaultValue { get; set; }
