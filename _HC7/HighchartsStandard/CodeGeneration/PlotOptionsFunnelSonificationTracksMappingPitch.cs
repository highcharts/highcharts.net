...
{
	public partial class PlotOptionsFunnelSonificationTracksMappingPitch  : BaseObject
	{
		Hashtable h = new Hashtable();

		public PlotOptionsFunnelSonificationTracksMappingPitch()
		{
			MapFunction = MapFunction_DefaultValue = PlotOptionsFunnelSonificationTracksMappingPitchMapFunction.Linear;
		...
		/// </summary>
		public PlotOptionsFunnelSonificationTracksMappingPitchMapFunction MapFunction { get; set; }
		private PlotOptionsFunnelSonificationTracksMappingPitchMapFunction MapFunction_DefaultValue { get; set; }
