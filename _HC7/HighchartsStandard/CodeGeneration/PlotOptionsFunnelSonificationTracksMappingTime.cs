...
{
	public partial class PlotOptionsFunnelSonificationTracksMappingTime  : BaseObject
	{
		Hashtable h = new Hashtable();

		public PlotOptionsFunnelSonificationTracksMappingTime()
		{
			MapFunction = MapFunction_DefaultValue = PlotOptionsFunnelSonificationTracksMappingTimeMapFunction.Linear;
			MapTo = MapTo_DefaultValue = "";
			Max = Max_DefaultValue = null;
			Min = Min_DefaultValue = null;
			Value = Value_DefaultValue = null;
			Within = Within_DefaultValue = PlotOptionsFunnelSonificationTracksMappingTimeWithin.Chart;
		...
		/// </summary>
		public PlotOptionsFunnelSonificationTracksMappingTimeMapFunction MapFunction { get; set; }
		private PlotOptionsFunnelSonificationTracksMappingTimeMapFunction MapFunction_DefaultValue { get; set; }
		...
		/// </summary>
		public PlotOptionsFunnelSonificationTracksMappingTimeWithin Within { get; set; }
		private PlotOptionsFunnelSonificationTracksMappingTimeWithin Within_DefaultValue { get; set; }
