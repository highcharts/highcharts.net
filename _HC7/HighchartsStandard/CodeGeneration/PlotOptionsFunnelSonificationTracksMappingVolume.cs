...
{
	public partial class PlotOptionsFunnelSonificationTracksMappingVolume  : BaseObject
	{
		Hashtable h = new Hashtable();

		public PlotOptionsFunnelSonificationTracksMappingVolume()
		{
			MapFunction = MapFunction_DefaultValue = PlotOptionsFunnelSonificationTracksMappingVolumeMapFunction.Linear;
			MapTo = MapTo_DefaultValue = "";
			Max = Max_DefaultValue = null;
			Min = Min_DefaultValue = null;
			Value = Value_DefaultValue = null;
			Within = Within_DefaultValue = PlotOptionsFunnelSonificationTracksMappingVolumeWithin.Chart;
		...
		/// </summary>
		public PlotOptionsFunnelSonificationTracksMappingVolumeMapFunction MapFunction { get; set; }
		private PlotOptionsFunnelSonificationTracksMappingVolumeMapFunction MapFunction_DefaultValue { get; set; }
		...
		/// </summary>
		public PlotOptionsFunnelSonificationTracksMappingVolumeWithin Within { get; set; }
		private PlotOptionsFunnelSonificationTracksMappingVolumeWithin Within_DefaultValue { get; set; }
