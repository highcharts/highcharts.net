...
{
	public partial class PlotOptionsFunnelSonificationTracksPointGrouping  : BaseObject
	{
		Hashtable h = new Hashtable();

		public PlotOptionsFunnelSonificationTracksPointGrouping()
		{
		...
		/// </summary>
		public PlotOptionsFunnelSonificationTracksPointGroupingAlgorithm Algorithm { get; set; }
		private PlotOptionsFunnelSonificationTracksPointGroupingAlgorithm Algorithm_DefaultValue { get; set; }
		...
		internal override Hashtable ToHashtable(Highcharts highcharts)
		{
			...
			if (Algorithm != PlotOptionsFunnelSonificationTracksPointGroupingAlgorithm.Null) h.Add("algorithm", highcharts.FirstCharacterToLower(Algorithm.ToString()));
