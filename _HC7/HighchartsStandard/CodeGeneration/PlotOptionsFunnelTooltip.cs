...
{
	public partial class PlotOptionsFunnelTooltip  : BaseObject
	{
		public PlotOptionsFunnelTooltip()
		{
			...
			HeaderShape = HeaderShape_DefaultValue = PlotOptionsFunnelTooltipHeaderShape.Callout;
		...
		/// </summary>
		public PlotOptionsFunnelTooltipHeaderShape HeaderShape { get; set; }
		private PlotOptionsFunnelTooltipHeaderShape HeaderShape_DefaultValue { get; set; }
		...
		internal override Hashtable ToHashtable()
		{
			...
			if (NullFormatter != NullFormatter_DefaultValue) { h.Add("nullFormatter",NullFormatter); Highcharts.AddFunction("PlotOptionsFunnelTooltipNullFormatter.nullFormatter", NullFormatter); }  
			if (Outside != Outside_DefaultValue) h.Add("outside",Outside);
			if (Padding != Padding_DefaultValue) h.Add("padding",Padding);
			if (PointFormat != PointFormat_DefaultValue) h.Add("pointFormat",PointFormat);
			if (PointFormatter != PointFormatter_DefaultValue) { h.Add("pointFormatter",PointFormatter); Highcharts.AddFunction("PlotOptionsFunnelTooltipPointFormatter.pointFormatter", PointFormatter); }  
