...
namespace Highsoft.Web.Mvc.Charts
{
	public partial class PlotOptionsGauge  : BaseObject
	{
		...
		public PlotOptionsGauge()
		{
			...
			LegendSymbol = LegendSymbol_DefaultValue = PlotOptionsGaugeLegendSymbol.Rectangle;
			...
			Sonification = Sonification_DefaultValue = new PlotOptionsGaugeSonification();
		...
		private PlotOptionsGaugeLegendSymbol LegendSymbol_DefaultValue { get; set; }
		...
		private PlotOptionsGaugeSonification Sonification_DefaultValue { get; set; }
