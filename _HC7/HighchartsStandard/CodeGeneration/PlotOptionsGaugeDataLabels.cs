...
namespace Highsoft.Web.Mvc.Charts
{
	public partial class PlotOptionsGaugeDataLabels  : BaseObject
	{
		...
		/// </summary>
		public PlotOptionsGaugeDataLabelsFilter Filter { get; set; }
		private PlotOptionsGaugeDataLabelsFilter Filter_DefaultValue { get; set; }
		...
		/// </summary>
		public PlotOptionsGaugeDataLabelsOverflow Overflow { get; set; }
		private PlotOptionsGaugeDataLabelsOverflow Overflow_DefaultValue { get; set; }
		...
		/// </summary>
		public PlotOptionsGaugeDataLabelsTextPath TextPath { get; set; }
		private PlotOptionsGaugeDataLabelsTextPath TextPath_DefaultValue { get; set; }
		...
		internal override Hashtable ToHashtable(Highcharts highcharts)
		{
			...
			if (Align != PlotOptionsGaugeDataLabelsAlign.Null) h.Add("align", highcharts.FirstCharacterToLower(Align.ToString()));
			...
			if (Overflow != PlotOptionsGaugeDataLabelsOverflow.Null) h.Add("overflow", highcharts.FirstCharacterToLower(Overflow.ToString()));
			if (Padding != null) h.Add("padding",Padding);
			if (Position != PlotOptionsGaugeDataLabelsPosition.Null) h.Add("position", highcharts.FirstCharacterToLower(Position.ToString()));
			...
			if (VerticalAlign != PlotOptionsGaugeDataLabelsVerticalAlign.Null) h.Add("verticalAlign", highcharts.FirstCharacterToLower(VerticalAlign.ToString()));
			if (X != null) h.Add("x",X);
			if (Y != null) h.Add("y",Y);
