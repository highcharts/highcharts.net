...
{
	public partial class PlotOptionsGaugeDragDrop  : BaseObject
	{
		public PlotOptionsGaugeDragDrop()
		{
			DraggableX = DraggableX_DefaultValue = null;
			DraggableY = DraggableY_DefaultValue = null;
			DragHandle = DragHandle_DefaultValue = new PlotOptionsGaugeDragDropDragHandle();
			...
			GuideBox = GuideBox_DefaultValue = new PlotOptionsGaugeDragDropGuideBox();
		...
		/// </summary>
		public PlotOptionsGaugeDragDropDragHandle DragHandle { get; set; }
		private PlotOptionsGaugeDragDropDragHandle DragHandle_DefaultValue { get; set; }
		...
		/// </summary>
		public PlotOptionsGaugeDragDropGuideBox GuideBox { get; set; }
		private PlotOptionsGaugeDragDropGuideBox GuideBox_DefaultValue { get; set; }
