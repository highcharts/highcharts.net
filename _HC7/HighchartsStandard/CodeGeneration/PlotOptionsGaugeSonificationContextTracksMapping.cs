...
{
	public partial class PlotOptionsGaugeSonificationContextTracksMapping  : BaseObject
	{
		Hashtable h = new Hashtable();

		public PlotOptionsGaugeSonificationContextTracksMapping()
		{
			Frequency = Frequency_DefaultValue = new PlotOptionsGaugeSonificationContextTracksMappingFrequency();
			GapBetweenNotes = GapBetweenNotes_DefaultValue = new PlotOptionsGaugeSonificationContextTracksMappingGapBetweenNotes();
			Highpass = Highpass_DefaultValue = new PlotOptionsGaugeSonificationContextTracksMappingHighpass();
			Lowpass = Lowpass_DefaultValue = new PlotOptionsGaugeSonificationContextTracksMappingLowpass();
			NoteDuration = NoteDuration_DefaultValue = new PlotOptionsGaugeSonificationContextTracksMappingNoteDuration();
			Pan = Pan_DefaultValue = new PlotOptionsGaugeSonificationContextTracksMappingPan();
			Pitch = Pitch_DefaultValue = new PlotOptionsGaugeSonificationContextTracksMappingPitch();
			PitchString = PitchString_DefaultValue = "null";
			PitchNumber = PitchNumber_DefaultValue = null;
			PlayDelay = PlayDelay_DefaultValue = new PlotOptionsGaugeSonificationContextTracksMappingPlayDelay();
			Time = Time_DefaultValue = new PlotOptionsGaugeSonificationContextTracksMappingTime();
			TimeString = TimeString_DefaultValue = "null";
			TimeNumber = TimeNumber_DefaultValue = null;
			Tremolo = Tremolo_DefaultValue = new PlotOptionsGaugeSonificationContextTracksMappingTremolo();
			Volume = Volume_DefaultValue = new PlotOptionsGaugeSonificationContextTracksMappingVolume();
		...
		/// </summary>
		public PlotOptionsGaugeSonificationContextTracksMappingFrequency Frequency { get; set; }
		private PlotOptionsGaugeSonificationContextTracksMappingFrequency Frequency_DefaultValue { get; set; }
		...
		/// </summary>
		public PlotOptionsGaugeSonificationContextTracksMappingGapBetweenNotes GapBetweenNotes { get; set; }
		private PlotOptionsGaugeSonificationContextTracksMappingGapBetweenNotes GapBetweenNotes_DefaultValue { get; set; }
		...
		/// </summary>
		public PlotOptionsGaugeSonificationContextTracksMappingHighpass Highpass { get; set; }
		private PlotOptionsGaugeSonificationContextTracksMappingHighpass Highpass_DefaultValue { get; set; }
		...
		/// </summary>
		public PlotOptionsGaugeSonificationContextTracksMappingLowpass Lowpass { get; set; }
		private PlotOptionsGaugeSonificationContextTracksMappingLowpass Lowpass_DefaultValue { get; set; }
		...
		/// </summary>
		public PlotOptionsGaugeSonificationContextTracksMappingNoteDuration NoteDuration { get; set; }
		private PlotOptionsGaugeSonificationContextTracksMappingNoteDuration NoteDuration_DefaultValue { get; set; }
		...
		/// </summary>
		public PlotOptionsGaugeSonificationContextTracksMappingPan Pan { get; set; }
		private PlotOptionsGaugeSonificationContextTracksMappingPan Pan_DefaultValue { get; set; }
		...
		/// </summary>
		public PlotOptionsGaugeSonificationContextTracksMappingPitch Pitch { get; set; }
		private PlotOptionsGaugeSonificationContextTracksMappingPitch Pitch_DefaultValue { get; set; }
		...
		/// </summary>
		public PlotOptionsGaugeSonificationContextTracksMappingPlayDelay PlayDelay { get; set; }
		private PlotOptionsGaugeSonificationContextTracksMappingPlayDelay PlayDelay_DefaultValue { get; set; }
		...
		/// </summary>
		public PlotOptionsGaugeSonificationContextTracksMappingTime Time { get; set; }
		private PlotOptionsGaugeSonificationContextTracksMappingTime Time_DefaultValue { get; set; }
		...
		/// </summary>
		public PlotOptionsGaugeSonificationContextTracksMappingTremolo Tremolo { get; set; }
		private PlotOptionsGaugeSonificationContextTracksMappingTremolo Tremolo_DefaultValue { get; set; }
		 

		/// <summary>
		/// The volume of notes, from 0 to 1.
		/// </summary>
		public PlotOptionsGaugeSonificationContextTracksMappingVolume Volume { get; set; }
		private PlotOptionsGaugeSonificationContextTracksMappingVolume Volume_DefaultValue { get; set; }
