...
{
	public partial class PlotOptionsGaugeSonificationContextTracksMappingPitch  : BaseObject
	{
		Hashtable h = new Hashtable();

		public PlotOptionsGaugeSonificationContextTracksMappingPitch()
		{
			MapFunction = MapFunction_DefaultValue = PlotOptionsGaugeSonificationContextTracksMappingPitchMapFunction.Linear;
		...
		/// </summary>
		public PlotOptionsGaugeSonificationContextTracksMappingPitchMapFunction MapFunction { get; set; }
		private PlotOptionsGaugeSonificationContextTracksMappingPitchMapFunction MapFunction_DefaultValue { get; set; }
