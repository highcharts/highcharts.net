...
{
	public partial class PlotOptionsGaugeSonificationDefaultInstrumentOptionsMappingTime  : BaseObject
	{
		Hashtable h = new Hashtable();

		public PlotOptionsGaugeSonificationDefaultInstrumentOptionsMappingTime()
		{
			MapFunction = MapFunction_DefaultValue = PlotOptionsGaugeSonificationDefaultInstrumentOptionsMappingTimeMapFunction.Linear;
			MapTo = MapTo_DefaultValue = "";
			Max = Max_DefaultValue = null;
			Min = Min_DefaultValue = null;
			Value = Value_DefaultValue = null;
			Within = Within_DefaultValue = PlotOptionsGaugeSonificationDefaultInstrumentOptionsMappingTimeWithin.Chart;
		...
		/// </summary>
		public PlotOptionsGaugeSonificationDefaultInstrumentOptionsMappingTimeMapFunction MapFunction { get; set; }
		private PlotOptionsGaugeSonificationDefaultInstrumentOptionsMappingTimeMapFunction MapFunction_DefaultValue { get; set; }
		...
		/// </summary>
		public PlotOptionsGaugeSonificationDefaultInstrumentOptionsMappingTimeWithin Within { get; set; }
		private PlotOptionsGaugeSonificationDefaultInstrumentOptionsMappingTimeWithin Within_DefaultValue { get; set; }
