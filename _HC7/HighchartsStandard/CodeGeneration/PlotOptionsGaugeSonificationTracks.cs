...
{
	public partial class PlotOptionsGaugeSonificationTracks  : BaseObject
	{
		Hashtable h = new Hashtable();

		public PlotOptionsGaugeSonificationTracks()
		{
			ActiveWhen = ActiveWhen_DefaultValue = new PlotOptionsGaugeSonificationTracksActiveWhen();
			Instrument = Instrument_DefaultValue = null;
			InstrumentString = InstrumentString_DefaultValue = "null";
			Mapping = Mapping_DefaultValue = new PlotOptionsGaugeSonificationTracksMapping();
			MidiName = MidiName_DefaultValue = "";
			PointGrouping = PointGrouping_DefaultValue = new PlotOptionsGaugeSonificationTracksPointGrouping();
			RoundToMusicalNotes = RoundToMusicalNotes_DefaultValue = true;
			ShowPlayMarker = ShowPlayMarker_DefaultValue = true;
			Type = Type_DefaultValue = PlotOptionsGaugeSonificationTracksType.Instrument;
		...
		/// </summary>
		public PlotOptionsGaugeSonificationTracksActiveWhen ActiveWhen { get; set; }
		private PlotOptionsGaugeSonificationTracksActiveWhen ActiveWhen_DefaultValue { get; set; }
		...
		/// </summary>
		public PlotOptionsGaugeSonificationTracksMapping Mapping { get; set; }
		private PlotOptionsGaugeSonificationTracksMapping Mapping_DefaultValue { get; set; }
		...
		/// </summary>
		public PlotOptionsGaugeSonificationTracksPointGrouping PointGrouping { get; set; }
		private PlotOptionsGaugeSonificationTracksPointGrouping PointGrouping_DefaultValue { get; set; }
		...
		/// </summary>
		public PlotOptionsGaugeSonificationTracksType Type { get; set; }
		private PlotOptionsGaugeSonificationTracksType Type_DefaultValue { get; set; }
