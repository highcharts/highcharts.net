...
{
	public partial class PlotOptionsGaugeSonificationTracksMapping  : BaseObject
	{
		Hashtable h = new Hashtable();

		public PlotOptionsGaugeSonificationTracksMapping()
		{
			Frequency = Frequency_DefaultValue = new PlotOptionsGaugeSonificationTracksMappingFrequency();
			GapBetweenNotes = GapBetweenNotes_DefaultValue = new PlotOptionsGaugeSonificationTracksMappingGapBetweenNotes();
			Highpass = Highpass_DefaultValue = new PlotOptionsGaugeSonificationTracksMappingHighpass();
			Lowpass = Lowpass_DefaultValue = new PlotOptionsGaugeSonificationTracksMappingLowpass();
			NoteDuration = NoteDuration_DefaultValue = new PlotOptionsGaugeSonificationTracksMappingNoteDuration();
			Pan = Pan_DefaultValue = new PlotOptionsGaugeSonificationTracksMappingPan();
			Pitch = Pitch_DefaultValue = new PlotOptionsGaugeSonificationTracksMappingPitch();
			PitchString = PitchString_DefaultValue = "null";
			PitchNumber = PitchNumber_DefaultValue = null;
			PlayDelay = PlayDelay_DefaultValue = new PlotOptionsGaugeSonificationTracksMappingPlayDelay();
			Time = Time_DefaultValue = new PlotOptionsGaugeSonificationTracksMappingTime();
			TimeString = TimeString_DefaultValue = "null";
			TimeNumber = TimeNumber_DefaultValue = null;
			Tremolo = Tremolo_DefaultValue = new PlotOptionsGaugeSonificationTracksMappingTremolo();
			Volume = Volume_DefaultValue = new PlotOptionsGaugeSonificationTracksMappingVolume();
		...
		/// </summary>
		public PlotOptionsGaugeSonificationTracksMappingFrequency Frequency { get; set; }
		private PlotOptionsGaugeSonificationTracksMappingFrequency Frequency_DefaultValue { get; set; }
		...
		/// </summary>
		public PlotOptionsGaugeSonificationTracksMappingGapBetweenNotes GapBetweenNotes { get; set; }
		private PlotOptionsGaugeSonificationTracksMappingGapBetweenNotes GapBetweenNotes_DefaultValue { get; set; }
		...
		/// </summary>
		public PlotOptionsGaugeSonificationTracksMappingHighpass Highpass { get; set; }
		private PlotOptionsGaugeSonificationTracksMappingHighpass Highpass_DefaultValue { get; set; }
		...
		/// </summary>
		public PlotOptionsGaugeSonificationTracksMappingLowpass Lowpass { get; set; }
		private PlotOptionsGaugeSonificationTracksMappingLowpass Lowpass_DefaultValue { get; set; }
		...
		/// </summary>
		public PlotOptionsGaugeSonificationTracksMappingNoteDuration NoteDuration { get; set; }
		private PlotOptionsGaugeSonificationTracksMappingNoteDuration NoteDuration_DefaultValue { get; set; }
		...
		/// </summary>
		public PlotOptionsGaugeSonificationTracksMappingPan Pan { get; set; }
		private PlotOptionsGaugeSonificationTracksMappingPan Pan_DefaultValue { get; set; }
		...
		/// </summary>
		public PlotOptionsGaugeSonificationTracksMappingPitch Pitch { get; set; }
		private PlotOptionsGaugeSonificationTracksMappingPitch Pitch_DefaultValue { get; set; }
		...
		/// </summary>
		public PlotOptionsGaugeSonificationTracksMappingPlayDelay PlayDelay { get; set; }
		private PlotOptionsGaugeSonificationTracksMappingPlayDelay PlayDelay_DefaultValue { get; set; }
		...
		/// </summary>
		public PlotOptionsGaugeSonificationTracksMappingTime Time { get; set; }
		private PlotOptionsGaugeSonificationTracksMappingTime Time_DefaultValue { get; set; }
		...
		/// </summary>
		public PlotOptionsGaugeSonificationTracksMappingTremolo Tremolo { get; set; }
		private PlotOptionsGaugeSonificationTracksMappingTremolo Tremolo_DefaultValue { get; set; }
		 

		/// <summary>
		/// The volume of notes, from 0 to 1.
		/// </summary>
		public PlotOptionsGaugeSonificationTracksMappingVolume Volume { get; set; }
		private PlotOptionsGaugeSonificationTracksMappingVolume Volume_DefaultValue { get; set; }
