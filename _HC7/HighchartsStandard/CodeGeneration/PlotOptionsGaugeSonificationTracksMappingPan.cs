...
{
	public partial class PlotOptionsGaugeSonificationTracksMappingPan  : BaseObject
	{
		Hashtable h = new Hashtable();

		public PlotOptionsGaugeSonificationTracksMappingPan()
		{
			MapFunction = MapFunction_DefaultValue = PlotOptionsGaugeSonificationTracksMappingPanMapFunction.Linear;
			MapTo = MapTo_DefaultValue = "";
			Max = Max_DefaultValue = null;
			Min = Min_DefaultValue = null;
			Value = Value_DefaultValue = null;
			Within = Within_DefaultValue = PlotOptionsGaugeSonificationTracksMappingPanWithin.Chart;
		...
		/// </summary>
		public PlotOptionsGaugeSonificationTracksMappingPanMapFunction MapFunction { get; set; }
		private PlotOptionsGaugeSonificationTracksMappingPanMapFunction MapFunction_DefaultValue { get; set; }
		...
		/// </summary>
		public PlotOptionsGaugeSonificationTracksMappingPanWithin Within { get; set; }
		private PlotOptionsGaugeSonificationTracksMappingPanWithin Within_DefaultValue { get; set; }
