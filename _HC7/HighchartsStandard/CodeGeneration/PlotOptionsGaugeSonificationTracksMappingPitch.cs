...
{
	public partial class PlotOptionsGaugeSonificationTracksMappingPitch  : BaseObject
	{
		Hashtable h = new Hashtable();

		public PlotOptionsGaugeSonificationTracksMappingPitch()
		{
			MapFunction = MapFunction_DefaultValue = PlotOptionsGaugeSonificationTracksMappingPitchMapFunction.Linear;
		...
		/// </summary>
		public PlotOptionsGaugeSonificationTracksMappingPitchMapFunction MapFunction { get; set; }
		private PlotOptionsGaugeSonificationTracksMappingPitchMapFunction MapFunction_DefaultValue { get; set; }
