...
{
	public partial class PlotOptionsGaugeSonificationTracksMappingTime  : BaseObject
	{
		Hashtable h = new Hashtable();

		public PlotOptionsGaugeSonificationTracksMappingTime()
		{
			MapFunction = MapFunction_DefaultValue = PlotOptionsGaugeSonificationTracksMappingTimeMapFunction.Linear;
			MapTo = MapTo_DefaultValue = "";
			Max = Max_DefaultValue = null;
			Min = Min_DefaultValue = null;
			Value = Value_DefaultValue = null;
			Within = Within_DefaultValue = PlotOptionsGaugeSonificationTracksMappingTimeWithin.Chart;
		...
		/// </summary>
		public PlotOptionsGaugeSonificationTracksMappingTimeMapFunction MapFunction { get; set; }
		private PlotOptionsGaugeSonificationTracksMappingTimeMapFunction MapFunction_DefaultValue { get; set; }
		...
		/// </summary>
		public PlotOptionsGaugeSonificationTracksMappingTimeWithin Within { get; set; }
		private PlotOptionsGaugeSonificationTracksMappingTimeWithin Within_DefaultValue { get; set; }
