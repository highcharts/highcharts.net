...
{
	public partial class PlotOptionsGaugeSonificationTracksMappingVolume  : BaseObject
	{
		Hashtable h = new Hashtable();

		public PlotOptionsGaugeSonificationTracksMappingVolume()
		{
			MapFunction = MapFunction_DefaultValue = PlotOptionsGaugeSonificationTracksMappingVolumeMapFunction.Linear;
			MapTo = MapTo_DefaultValue = "";
			Max = Max_DefaultValue = null;
			Min = Min_DefaultValue = null;
			Value = Value_DefaultValue = null;
			Within = Within_DefaultValue = PlotOptionsGaugeSonificationTracksMappingVolumeWithin.Chart;
		...
		/// </summary>
		public PlotOptionsGaugeSonificationTracksMappingVolumeMapFunction MapFunction { get; set; }
		private PlotOptionsGaugeSonificationTracksMappingVolumeMapFunction MapFunction_DefaultValue { get; set; }
		...
		/// </summary>
		public PlotOptionsGaugeSonificationTracksMappingVolumeWithin Within { get; set; }
		private PlotOptionsGaugeSonificationTracksMappingVolumeWithin Within_DefaultValue { get; set; }
