...
namespace Highsoft.Web.Mvc.Charts
{
	public partial class PlotOptionsHeatmapDataLabels  : BaseObject
	{
		...
		{
			Align = Align_DefaultValue = PlotOptionsHeatmapDataLabelsAlign.Left;
			...
			VerticalAlign = VerticalAlign_DefaultValue = PlotOptionsHeatmapDataLabelsVerticalAlign.Top;
		...
		internal override Hashtable ToHashtable()
		{
			...
			if (Formatter != Formatter_DefaultValue) { h.Add("formatter",Formatter); Highcharts.AddFunction("9f3266d4-b27e-4883-8c28-ff9ea4eb9262.formatter", Formatter); }  
