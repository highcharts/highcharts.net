...
{
	public partial class PlotOptionsHeatmapSonificationContextTracks  : BaseObject
	{
		Hashtable h = new Hashtable();

		public PlotOptionsHeatmapSonificationContextTracks()
		{
			ActiveWhen = ActiveWhen_DefaultValue = new PlotOptionsHeatmapSonificationContextTracksActiveWhen();
			Instrument = Instrument_DefaultValue = null;
			InstrumentString = InstrumentString_DefaultValue = "null";
			Mapping = Mapping_DefaultValue = new PlotOptionsHeatmapSonificationContextTracksMapping();
			MidiName = MidiName_DefaultValue = "";
			PointGrouping = PointGrouping_DefaultValue = new PlotOptionsHeatmapSonificationContextTracksPointGrouping();
			...
			Type = Type_DefaultValue = PlotOptionsHeatmapSonificationContextTracksType.Instrument;
			ValueInterval = ValueInterval_DefaultValue = null;
			ValueMapFunction = ValueMapFunction_DefaultValue = PlotOptionsHeatmapSonificationContextTracksValueMapFunction.Linear;
		...
		/// </summary>
		public PlotOptionsHeatmapSonificationContextTracksActiveWhen ActiveWhen { get; set; }
		private PlotOptionsHeatmapSonificationContextTracksActiveWhen ActiveWhen_DefaultValue { get; set; }
		...
		/// </summary>
		public PlotOptionsHeatmapSonificationContextTracksMapping Mapping { get; set; }
		private PlotOptionsHeatmapSonificationContextTracksMapping Mapping_DefaultValue { get; set; }
		...
		/// </summary>
		public PlotOptionsHeatmapSonificationContextTracksPointGrouping PointGrouping { get; set; }
		private PlotOptionsHeatmapSonificationContextTracksPointGrouping PointGrouping_DefaultValue { get; set; }
		...
		/// </summary>
		public PlotOptionsHeatmapSonificationContextTracksType Type { get; set; }
		private PlotOptionsHeatmapSonificationContextTracksType Type_DefaultValue { get; set; }
		...
		/// </summary>
		public PlotOptionsHeatmapSonificationContextTracksValueMapFunction ValueMapFunction { get; set; }
		private PlotOptionsHeatmapSonificationContextTracksValueMapFunction ValueMapFunction_DefaultValue { get; set; }
