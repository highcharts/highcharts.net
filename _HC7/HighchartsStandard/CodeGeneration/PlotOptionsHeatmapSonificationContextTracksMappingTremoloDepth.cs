...
{
	public partial class PlotOptionsHeatmapSonificationContextTracksMappingTremoloDepth  : BaseObject
	{
		Hashtable h = new Hashtable();

		public PlotOptionsHeatmapSonificationContextTracksMappingTremoloDepth()
		{
			MapFunction = MapFunction_DefaultValue = PlotOptionsHeatmapSonificationContextTracksMappingTremoloDepthMapFunction.Linear;
			MapTo = MapTo_DefaultValue = "";
			Max = Max_DefaultValue = null;
			Min = Min_DefaultValue = null;
			Value = Value_DefaultValue = null;
			Within = Within_DefaultValue = PlotOptionsHeatmapSonificationContextTracksMappingTremoloDepthWithin.Chart;
		...
		/// </summary>
		public PlotOptionsHeatmapSonificationContextTracksMappingTremoloDepthMapFunction MapFunction { get; set; }
		private PlotOptionsHeatmapSonificationContextTracksMappingTremoloDepthMapFunction MapFunction_DefaultValue { get; set; }
		...
		/// </summary>
		public PlotOptionsHeatmapSonificationContextTracksMappingTremoloDepthWithin Within { get; set; }
		private PlotOptionsHeatmapSonificationContextTracksMappingTremoloDepthWithin Within_DefaultValue { get; set; }
