...
{
	public partial class PlotOptionsHeatmapSonificationDefaultInstrumentOptionsMapping  : BaseObject
	{
		Hashtable h = new Hashtable();

		public PlotOptionsHeatmapSonificationDefaultInstrumentOptionsMapping()
		{
			Frequency = Frequency_DefaultValue = new PlotOptionsHeatmapSonificationDefaultInstrumentOptionsMappingFrequency();
			GapBetweenNotes = GapBetweenNotes_DefaultValue = new PlotOptionsHeatmapSonificationDefaultInstrumentOptionsMappingGapBetweenNotes();
			Highpass = Highpass_DefaultValue = new PlotOptionsHeatmapSonificationDefaultInstrumentOptionsMappingHighpass();
			Lowpass = Lowpass_DefaultValue = new PlotOptionsHeatmapSonificationDefaultInstrumentOptionsMappingLowpass();
			NoteDuration = NoteDuration_DefaultValue = new PlotOptionsHeatmapSonificationDefaultInstrumentOptionsMappingNoteDuration();
			Pan = Pan_DefaultValue = new PlotOptionsHeatmapSonificationDefaultInstrumentOptionsMappingPan();
			Pitch = Pitch_DefaultValue = new PlotOptionsHeatmapSonificationDefaultInstrumentOptionsMappingPitch();
			PitchString = PitchString_DefaultValue = "null";
			PitchNumber = PitchNumber_DefaultValue = null;
			PlayDelay = PlayDelay_DefaultValue = new PlotOptionsHeatmapSonificationDefaultInstrumentOptionsMappingPlayDelay();
			Time = Time_DefaultValue = new PlotOptionsHeatmapSonificationDefaultInstrumentOptionsMappingTime();
			TimeString = TimeString_DefaultValue = "null";
			TimeNumber = TimeNumber_DefaultValue = null;
			Tremolo = Tremolo_DefaultValue = new PlotOptionsHeatmapSonificationDefaultInstrumentOptionsMappingTremolo();
			Volume = Volume_DefaultValue = new PlotOptionsHeatmapSonificationDefaultInstrumentOptionsMappingVolume();
		...
		/// </summary>
		public PlotOptionsHeatmapSonificationDefaultInstrumentOptionsMappingFrequency Frequency { get; set; }
		private PlotOptionsHeatmapSonificationDefaultInstrumentOptionsMappingFrequency Frequency_DefaultValue { get; set; }
		...
		/// </summary>
		public PlotOptionsHeatmapSonificationDefaultInstrumentOptionsMappingGapBetweenNotes GapBetweenNotes { get; set; }
		private PlotOptionsHeatmapSonificationDefaultInstrumentOptionsMappingGapBetweenNotes GapBetweenNotes_DefaultValue { get; set; }
		...
		/// </summary>
		public PlotOptionsHeatmapSonificationDefaultInstrumentOptionsMappingHighpass Highpass { get; set; }
		private PlotOptionsHeatmapSonificationDefaultInstrumentOptionsMappingHighpass Highpass_DefaultValue { get; set; }
		...
		/// </summary>
		public PlotOptionsHeatmapSonificationDefaultInstrumentOptionsMappingLowpass Lowpass { get; set; }
		private PlotOptionsHeatmapSonificationDefaultInstrumentOptionsMappingLowpass Lowpass_DefaultValue { get; set; }
		...
		/// </summary>
		public PlotOptionsHeatmapSonificationDefaultInstrumentOptionsMappingNoteDuration NoteDuration { get; set; }
		private PlotOptionsHeatmapSonificationDefaultInstrumentOptionsMappingNoteDuration NoteDuration_DefaultValue { get; set; }
		...
		/// </summary>
		public PlotOptionsHeatmapSonificationDefaultInstrumentOptionsMappingPan Pan { get; set; }
		private PlotOptionsHeatmapSonificationDefaultInstrumentOptionsMappingPan Pan_DefaultValue { get; set; }
		...
		/// </summary>
		public PlotOptionsHeatmapSonificationDefaultInstrumentOptionsMappingPitch Pitch { get; set; }
		private PlotOptionsHeatmapSonificationDefaultInstrumentOptionsMappingPitch Pitch_DefaultValue { get; set; }
		...
		/// </summary>
		public PlotOptionsHeatmapSonificationDefaultInstrumentOptionsMappingPlayDelay PlayDelay { get; set; }
		private PlotOptionsHeatmapSonificationDefaultInstrumentOptionsMappingPlayDelay PlayDelay_DefaultValue { get; set; }
		...
		/// </summary>
		public PlotOptionsHeatmapSonificationDefaultInstrumentOptionsMappingTime Time { get; set; }
		private PlotOptionsHeatmapSonificationDefaultInstrumentOptionsMappingTime Time_DefaultValue { get; set; }
		...
		/// </summary>
		public PlotOptionsHeatmapSonificationDefaultInstrumentOptionsMappingTremolo Tremolo { get; set; }
		private PlotOptionsHeatmapSonificationDefaultInstrumentOptionsMappingTremolo Tremolo_DefaultValue { get; set; }
		 

		/// <summary>
		/// The volume of notes, from 0 to 1.
		/// </summary>
		public PlotOptionsHeatmapSonificationDefaultInstrumentOptionsMappingVolume Volume { get; set; }
		private PlotOptionsHeatmapSonificationDefaultInstrumentOptionsMappingVolume Volume_DefaultValue { get; set; }
