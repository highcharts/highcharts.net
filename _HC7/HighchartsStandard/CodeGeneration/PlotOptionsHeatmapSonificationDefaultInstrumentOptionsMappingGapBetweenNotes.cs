...
{
	public partial class PlotOptionsHeatmapSonificationDefaultInstrumentOptionsMappingGapBetweenNotes  : BaseObject
	{
		Hashtable h = new Hashtable();

		public PlotOptionsHeatmapSonificationDefaultInstrumentOptionsMappingGapBetweenNotes()
		{
			MapFunction = MapFunction_DefaultValue = PlotOptionsHeatmapSonificationDefaultInstrumentOptionsMappingGapBetweenNotesMapFunction.Linear;
			MapTo = MapTo_DefaultValue = "";
			Max = Max_DefaultValue = null;
			Min = Min_DefaultValue = null;
			Value = Value_DefaultValue = null;
			Within = Within_DefaultValue = PlotOptionsHeatmapSonificationDefaultInstrumentOptionsMappingGapBetweenNotesWithin.Chart;
		...
		/// </summary>
		public PlotOptionsHeatmapSonificationDefaultInstrumentOptionsMappingGapBetweenNotesMapFunction MapFunction { get; set; }
		private PlotOptionsHeatmapSonificationDefaultInstrumentOptionsMappingGapBetweenNotesMapFunction MapFunction_DefaultValue { get; set; }
		...
		/// </summary>
		public PlotOptionsHeatmapSonificationDefaultInstrumentOptionsMappingGapBetweenNotesWithin Within { get; set; }
		private PlotOptionsHeatmapSonificationDefaultInstrumentOptionsMappingGapBetweenNotesWithin Within_DefaultValue { get; set; }
