...
{
	public partial class PlotOptionsHeatmapSonificationDefaultInstrumentOptionsMappingPitch  : BaseObject
	{
		Hashtable h = new Hashtable();

		public PlotOptionsHeatmapSonificationDefaultInstrumentOptionsMappingPitch()
		{
			MapFunction = MapFunction_DefaultValue = PlotOptionsHeatmapSonificationDefaultInstrumentOptionsMappingPitchMapFunction.Linear;
		...
		/// </summary>
		public PlotOptionsHeatmapSonificationDefaultInstrumentOptionsMappingPitchMapFunction MapFunction { get; set; }
		private PlotOptionsHeatmapSonificationDefaultInstrumentOptionsMappingPitchMapFunction MapFunction_DefaultValue { get; set; }
