...
{
	public partial class PlotOptionsHeatmapSonificationDefaultSpeechOptionsMappingTime  : BaseObject
	{
		Hashtable h = new Hashtable();

		public PlotOptionsHeatmapSonificationDefaultSpeechOptionsMappingTime()
		{
			MapFunction = MapFunction_DefaultValue = PlotOptionsHeatmapSonificationDefaultSpeechOptionsMappingTimeMapFunction.Linear;
			MapTo = MapTo_DefaultValue = "";
			Max = Max_DefaultValue = null;
			Min = Min_DefaultValue = null;
			Value = Value_DefaultValue = null;
			Within = Within_DefaultValue = PlotOptionsHeatmapSonificationDefaultSpeechOptionsMappingTimeWithin.Chart;
		...
		/// </summary>
		public PlotOptionsHeatmapSonificationDefaultSpeechOptionsMappingTimeMapFunction MapFunction { get; set; }
		private PlotOptionsHeatmapSonificationDefaultSpeechOptionsMappingTimeMapFunction MapFunction_DefaultValue { get; set; }
		...
		/// </summary>
		public PlotOptionsHeatmapSonificationDefaultSpeechOptionsMappingTimeWithin Within { get; set; }
		private PlotOptionsHeatmapSonificationDefaultSpeechOptionsMappingTimeWithin Within_DefaultValue { get; set; }
