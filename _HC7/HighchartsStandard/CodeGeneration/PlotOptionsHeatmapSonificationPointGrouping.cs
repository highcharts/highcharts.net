...
{
	public partial class PlotOptionsHeatmapSonificationPointGrouping  : BaseObject
	{
		Hashtable h = new Hashtable();

		public PlotOptionsHeatmapSonificationPointGrouping()
		{
		...
		/// </summary>
		public PlotOptionsHeatmapSonificationPointGroupingAlgorithm Algorithm { get; set; }
		private PlotOptionsHeatmapSonificationPointGroupingAlgorithm Algorithm_DefaultValue { get; set; }
		...
		internal override Hashtable ToHashtable(Highcharts highcharts)
		{
			...
			if (Algorithm != PlotOptionsHeatmapSonificationPointGroupingAlgorithm.Null) h.Add("algorithm", highcharts.FirstCharacterToLower(Algorithm.ToString()));
