...
{
	public partial class PlotOptionsHeatmapSonificationTracks  : BaseObject
	{
		Hashtable h = new Hashtable();

		public PlotOptionsHeatmapSonificationTracks()
		{
			ActiveWhen = ActiveWhen_DefaultValue = new PlotOptionsHeatmapSonificationTracksActiveWhen();
			Instrument = Instrument_DefaultValue = null;
			InstrumentString = InstrumentString_DefaultValue = "null";
			Mapping = Mapping_DefaultValue = new PlotOptionsHeatmapSonificationTracksMapping();
			MidiName = MidiName_DefaultValue = "";
			PointGrouping = PointGrouping_DefaultValue = new PlotOptionsHeatmapSonificationTracksPointGrouping();
			RoundToMusicalNotes = RoundToMusicalNotes_DefaultValue = true;
			ShowPlayMarker = ShowPlayMarker_DefaultValue = true;
			Type = Type_DefaultValue = PlotOptionsHeatmapSonificationTracksType.Instrument;
		...
		/// </summary>
		public PlotOptionsHeatmapSonificationTracksActiveWhen ActiveWhen { get; set; }
		private PlotOptionsHeatmapSonificationTracksActiveWhen ActiveWhen_DefaultValue { get; set; }
		...
		/// </summary>
		public PlotOptionsHeatmapSonificationTracksMapping Mapping { get; set; }
		private PlotOptionsHeatmapSonificationTracksMapping Mapping_DefaultValue { get; set; }
		...
		/// </summary>
		public PlotOptionsHeatmapSonificationTracksPointGrouping PointGrouping { get; set; }
		private PlotOptionsHeatmapSonificationTracksPointGrouping PointGrouping_DefaultValue { get; set; }
		...
		/// </summary>
		public PlotOptionsHeatmapSonificationTracksType Type { get; set; }
		private PlotOptionsHeatmapSonificationTracksType Type_DefaultValue { get; set; }
