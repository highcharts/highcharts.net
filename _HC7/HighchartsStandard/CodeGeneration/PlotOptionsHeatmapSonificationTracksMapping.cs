...
{
	public partial class PlotOptionsHeatmapSonificationTracksMapping  : BaseObject
	{
		Hashtable h = new Hashtable();

		public PlotOptionsHeatmapSonificationTracksMapping()
		{
			Frequency = Frequency_DefaultValue = new PlotOptionsHeatmapSonificationTracksMappingFrequency();
			GapBetweenNotes = GapBetweenNotes_DefaultValue = new PlotOptionsHeatmapSonificationTracksMappingGapBetweenNotes();
			Highpass = Highpass_DefaultValue = new PlotOptionsHeatmapSonificationTracksMappingHighpass();
			Lowpass = Lowpass_DefaultValue = new PlotOptionsHeatmapSonificationTracksMappingLowpass();
			NoteDuration = NoteDuration_DefaultValue = new PlotOptionsHeatmapSonificationTracksMappingNoteDuration();
			Pan = Pan_DefaultValue = new PlotOptionsHeatmapSonificationTracksMappingPan();
			Pitch = Pitch_DefaultValue = new PlotOptionsHeatmapSonificationTracksMappingPitch();
			PitchString = PitchString_DefaultValue = "null";
			PitchNumber = PitchNumber_DefaultValue = null;
			PlayDelay = PlayDelay_DefaultValue = new PlotOptionsHeatmapSonificationTracksMappingPlayDelay();
			Time = Time_DefaultValue = new PlotOptionsHeatmapSonificationTracksMappingTime();
			TimeString = TimeString_DefaultValue = "null";
			TimeNumber = TimeNumber_DefaultValue = null;
			Tremolo = Tremolo_DefaultValue = new PlotOptionsHeatmapSonificationTracksMappingTremolo();
			Volume = Volume_DefaultValue = new PlotOptionsHeatmapSonificationTracksMappingVolume();
		...
		/// </summary>
		public PlotOptionsHeatmapSonificationTracksMappingFrequency Frequency { get; set; }
		private PlotOptionsHeatmapSonificationTracksMappingFrequency Frequency_DefaultValue { get; set; }
		...
		/// </summary>
		public PlotOptionsHeatmapSonificationTracksMappingGapBetweenNotes GapBetweenNotes { get; set; }
		private PlotOptionsHeatmapSonificationTracksMappingGapBetweenNotes GapBetweenNotes_DefaultValue { get; set; }
		...
		/// </summary>
		public PlotOptionsHeatmapSonificationTracksMappingHighpass Highpass { get; set; }
		private PlotOptionsHeatmapSonificationTracksMappingHighpass Highpass_DefaultValue { get; set; }
		...
		/// </summary>
		public PlotOptionsHeatmapSonificationTracksMappingLowpass Lowpass { get; set; }
		private PlotOptionsHeatmapSonificationTracksMappingLowpass Lowpass_DefaultValue { get; set; }
		...
		/// </summary>
		public PlotOptionsHeatmapSonificationTracksMappingNoteDuration NoteDuration { get; set; }
		private PlotOptionsHeatmapSonificationTracksMappingNoteDuration NoteDuration_DefaultValue { get; set; }
		...
		/// </summary>
		public PlotOptionsHeatmapSonificationTracksMappingPan Pan { get; set; }
		private PlotOptionsHeatmapSonificationTracksMappingPan Pan_DefaultValue { get; set; }
		...
		/// </summary>
		public PlotOptionsHeatmapSonificationTracksMappingPitch Pitch { get; set; }
		private PlotOptionsHeatmapSonificationTracksMappingPitch Pitch_DefaultValue { get; set; }
		...
		/// </summary>
		public PlotOptionsHeatmapSonificationTracksMappingPlayDelay PlayDelay { get; set; }
		private PlotOptionsHeatmapSonificationTracksMappingPlayDelay PlayDelay_DefaultValue { get; set; }
		...
		/// </summary>
		public PlotOptionsHeatmapSonificationTracksMappingTime Time { get; set; }
		private PlotOptionsHeatmapSonificationTracksMappingTime Time_DefaultValue { get; set; }
		...
		/// </summary>
		public PlotOptionsHeatmapSonificationTracksMappingTremolo Tremolo { get; set; }
		private PlotOptionsHeatmapSonificationTracksMappingTremolo Tremolo_DefaultValue { get; set; }
		 

		/// <summary>
		/// The volume of notes, from 0 to 1.
		/// </summary>
		public PlotOptionsHeatmapSonificationTracksMappingVolume Volume { get; set; }
		private PlotOptionsHeatmapSonificationTracksMappingVolume Volume_DefaultValue { get; set; }
