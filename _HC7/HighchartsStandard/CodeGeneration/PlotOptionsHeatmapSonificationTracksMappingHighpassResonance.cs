...
{
	public partial class PlotOptionsHeatmapSonificationTracksMappingHighpassResonance  : BaseObject
	{
		Hashtable h = new Hashtable();

		public PlotOptionsHeatmapSonificationTracksMappingHighpassResonance()
		{
			MapFunction = MapFunction_DefaultValue = PlotOptionsHeatmapSonificationTracksMappingHighpassResonanceMapFunction.Linear;
			MapTo = MapTo_DefaultValue = "";
			Max = Max_DefaultValue = null;
			Min = Min_DefaultValue = null;
			Value = Value_DefaultValue = null;
			Within = Within_DefaultValue = PlotOptionsHeatmapSonificationTracksMappingHighpassResonanceWithin.Chart;
		...
		/// </summary>
		public PlotOptionsHeatmapSonificationTracksMappingHighpassResonanceMapFunction MapFunction { get; set; }
		private PlotOptionsHeatmapSonificationTracksMappingHighpassResonanceMapFunction MapFunction_DefaultValue { get; set; }
		...
		/// </summary>
		public PlotOptionsHeatmapSonificationTracksMappingHighpassResonanceWithin Within { get; set; }
		private PlotOptionsHeatmapSonificationTracksMappingHighpassResonanceWithin Within_DefaultValue { get; set; }
