...
{
	public partial class PlotOptionsHeatmapSonificationTracksMappingPan  : BaseObject
	{
		Hashtable h = new Hashtable();

		public PlotOptionsHeatmapSonificationTracksMappingPan()
		{
			MapFunction = MapFunction_DefaultValue = PlotOptionsHeatmapSonificationTracksMappingPanMapFunction.Linear;
			MapTo = MapTo_DefaultValue = "";
			Max = Max_DefaultValue = null;
			Min = Min_DefaultValue = null;
			Value = Value_DefaultValue = null;
			Within = Within_DefaultValue = PlotOptionsHeatmapSonificationTracksMappingPanWithin.Chart;
		...
		/// </summary>
		public PlotOptionsHeatmapSonificationTracksMappingPanMapFunction MapFunction { get; set; }
		private PlotOptionsHeatmapSonificationTracksMappingPanMapFunction MapFunction_DefaultValue { get; set; }
		...
		/// </summary>
		public PlotOptionsHeatmapSonificationTracksMappingPanWithin Within { get; set; }
		private PlotOptionsHeatmapSonificationTracksMappingPanWithin Within_DefaultValue { get; set; }
