...
{
	public partial class PlotOptionsHeatmapSonificationTracksMappingPitch  : BaseObject
	{
		Hashtable h = new Hashtable();

		public PlotOptionsHeatmapSonificationTracksMappingPitch()
		{
			MapFunction = MapFunction_DefaultValue = PlotOptionsHeatmapSonificationTracksMappingPitchMapFunction.Linear;
		...
		/// </summary>
		public PlotOptionsHeatmapSonificationTracksMappingPitchMapFunction MapFunction { get; set; }
		private PlotOptionsHeatmapSonificationTracksMappingPitchMapFunction MapFunction_DefaultValue { get; set; }
