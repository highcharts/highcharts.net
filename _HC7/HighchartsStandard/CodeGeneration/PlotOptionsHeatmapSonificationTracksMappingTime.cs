...
{
	public partial class PlotOptionsHeatmapSonificationTracksMappingTime  : BaseObject
	{
		Hashtable h = new Hashtable();

		public PlotOptionsHeatmapSonificationTracksMappingTime()
		{
			MapFunction = MapFunction_DefaultValue = PlotOptionsHeatmapSonificationTracksMappingTimeMapFunction.Linear;
			MapTo = MapTo_DefaultValue = "";
			Max = Max_DefaultValue = null;
			Min = Min_DefaultValue = null;
			Value = Value_DefaultValue = null;
			Within = Within_DefaultValue = PlotOptionsHeatmapSonificationTracksMappingTimeWithin.Chart;
		...
		/// </summary>
		public PlotOptionsHeatmapSonificationTracksMappingTimeMapFunction MapFunction { get; set; }
		private PlotOptionsHeatmapSonificationTracksMappingTimeMapFunction MapFunction_DefaultValue { get; set; }
		...
		/// </summary>
		public PlotOptionsHeatmapSonificationTracksMappingTimeWithin Within { get; set; }
		private PlotOptionsHeatmapSonificationTracksMappingTimeWithin Within_DefaultValue { get; set; }
