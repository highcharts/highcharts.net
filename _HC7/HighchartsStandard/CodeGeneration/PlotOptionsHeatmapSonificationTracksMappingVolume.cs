...
{
	public partial class PlotOptionsHeatmapSonificationTracksMappingVolume  : BaseObject
	{
		Hashtable h = new Hashtable();

		public PlotOptionsHeatmapSonificationTracksMappingVolume()
		{
			MapFunction = MapFunction_DefaultValue = PlotOptionsHeatmapSonificationTracksMappingVolumeMapFunction.Linear;
			MapTo = MapTo_DefaultValue = "";
			Max = Max_DefaultValue = null;
			Min = Min_DefaultValue = null;
			Value = Value_DefaultValue = null;
			Within = Within_DefaultValue = PlotOptionsHeatmapSonificationTracksMappingVolumeWithin.Chart;
		...
		/// </summary>
		public PlotOptionsHeatmapSonificationTracksMappingVolumeMapFunction MapFunction { get; set; }
		private PlotOptionsHeatmapSonificationTracksMappingVolumeMapFunction MapFunction_DefaultValue { get; set; }
		...
		/// </summary>
		public PlotOptionsHeatmapSonificationTracksMappingVolumeWithin Within { get; set; }
		private PlotOptionsHeatmapSonificationTracksMappingVolumeWithin Within_DefaultValue { get; set; }
