...
{
	public partial class PlotOptionsHeatmapSonificationTracksPointGrouping  : BaseObject
	{
		Hashtable h = new Hashtable();

		public PlotOptionsHeatmapSonificationTracksPointGrouping()
		{
		...
		/// </summary>
		public PlotOptionsHeatmapSonificationTracksPointGroupingAlgorithm Algorithm { get; set; }
		private PlotOptionsHeatmapSonificationTracksPointGroupingAlgorithm Algorithm_DefaultValue { get; set; }
		...
		internal override Hashtable ToHashtable(Highcharts highcharts)
		{
			...
			if (Algorithm != PlotOptionsHeatmapSonificationTracksPointGroupingAlgorithm.Null) h.Add("algorithm", highcharts.FirstCharacterToLower(Algorithm.ToString()));
