...
{
	public partial class PlotOptionsHistogramDragDropDragHandle  : BaseObject
	{
		public PlotOptionsHistogramDragDropDragHandle()
		{
		...
		internal override Hashtable ToHashtable()
		{
			...
			if (PathFormatter != PathFormatter_DefaultValue) { h.Add("pathFormatter",PathFormatter); Highcharts.AddFunction("PlotOptionsHistogramDragDropDragHandlePathFormatter.pathFormatter", PathFormatter); }  
