...
{
	public partial class PlotOptionsHistogramSonificationContextTracksMapping  : BaseObject
	{
		Hashtable h = new Hashtable();

		public PlotOptionsHistogramSonificationContextTracksMapping()
		{
			Frequency = Frequency_DefaultValue = new PlotOptionsHistogramSonificationContextTracksMappingFrequency();
			GapBetweenNotes = GapBetweenNotes_DefaultValue = new PlotOptionsHistogramSonificationContextTracksMappingGapBetweenNotes();
			Highpass = Highpass_DefaultValue = new PlotOptionsHistogramSonificationContextTracksMappingHighpass();
			Lowpass = Lowpass_DefaultValue = new PlotOptionsHistogramSonificationContextTracksMappingLowpass();
			NoteDuration = NoteDuration_DefaultValue = new PlotOptionsHistogramSonificationContextTracksMappingNoteDuration();
			Pan = Pan_DefaultValue = new PlotOptionsHistogramSonificationContextTracksMappingPan();
			Pitch = Pitch_DefaultValue = new PlotOptionsHistogramSonificationContextTracksMappingPitch();
			PitchString = PitchString_DefaultValue = "null";
			PitchNumber = PitchNumber_DefaultValue = null;
			PlayDelay = PlayDelay_DefaultValue = new PlotOptionsHistogramSonificationContextTracksMappingPlayDelay();
			Time = Time_DefaultValue = new PlotOptionsHistogramSonificationContextTracksMappingTime();
			TimeString = TimeString_DefaultValue = "null";
			TimeNumber = TimeNumber_DefaultValue = null;
			Tremolo = Tremolo_DefaultValue = new PlotOptionsHistogramSonificationContextTracksMappingTremolo();
			Volume = Volume_DefaultValue = new PlotOptionsHistogramSonificationContextTracksMappingVolume();
		...
		/// </summary>
		public PlotOptionsHistogramSonificationContextTracksMappingFrequency Frequency { get; set; }
		private PlotOptionsHistogramSonificationContextTracksMappingFrequency Frequency_DefaultValue { get; set; }
		...
		/// </summary>
		public PlotOptionsHistogramSonificationContextTracksMappingGapBetweenNotes GapBetweenNotes { get; set; }
		private PlotOptionsHistogramSonificationContextTracksMappingGapBetweenNotes GapBetweenNotes_DefaultValue { get; set; }
		...
		/// </summary>
		public PlotOptionsHistogramSonificationContextTracksMappingHighpass Highpass { get; set; }
		private PlotOptionsHistogramSonificationContextTracksMappingHighpass Highpass_DefaultValue { get; set; }
		...
		/// </summary>
		public PlotOptionsHistogramSonificationContextTracksMappingLowpass Lowpass { get; set; }
		private PlotOptionsHistogramSonificationContextTracksMappingLowpass Lowpass_DefaultValue { get; set; }
		...
		/// </summary>
		public PlotOptionsHistogramSonificationContextTracksMappingNoteDuration NoteDuration { get; set; }
		private PlotOptionsHistogramSonificationContextTracksMappingNoteDuration NoteDuration_DefaultValue { get; set; }
		...
		/// </summary>
		public PlotOptionsHistogramSonificationContextTracksMappingPan Pan { get; set; }
		private PlotOptionsHistogramSonificationContextTracksMappingPan Pan_DefaultValue { get; set; }
		...
		/// </summary>
		public PlotOptionsHistogramSonificationContextTracksMappingPitch Pitch { get; set; }
		private PlotOptionsHistogramSonificationContextTracksMappingPitch Pitch_DefaultValue { get; set; }
		...
		/// </summary>
		public PlotOptionsHistogramSonificationContextTracksMappingPlayDelay PlayDelay { get; set; }
		private PlotOptionsHistogramSonificationContextTracksMappingPlayDelay PlayDelay_DefaultValue { get; set; }
		...
		/// </summary>
		public PlotOptionsHistogramSonificationContextTracksMappingTime Time { get; set; }
		private PlotOptionsHistogramSonificationContextTracksMappingTime Time_DefaultValue { get; set; }
		...
		/// </summary>
		public PlotOptionsHistogramSonificationContextTracksMappingTremolo Tremolo { get; set; }
		private PlotOptionsHistogramSonificationContextTracksMappingTremolo Tremolo_DefaultValue { get; set; }
		 

		/// <summary>
		/// The volume of notes, from 0 to 1.
		/// </summary>
		public PlotOptionsHistogramSonificationContextTracksMappingVolume Volume { get; set; }
		private PlotOptionsHistogramSonificationContextTracksMappingVolume Volume_DefaultValue { get; set; }
