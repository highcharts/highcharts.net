...
{
	public partial class PlotOptionsHistogramSonificationContextTracksMappingPitch  : BaseObject
	{
		Hashtable h = new Hashtable();

		public PlotOptionsHistogramSonificationContextTracksMappingPitch()
		{
			MapFunction = MapFunction_DefaultValue = PlotOptionsHistogramSonificationContextTracksMappingPitchMapFunction.Linear;
		...
		/// </summary>
		public PlotOptionsHistogramSonificationContextTracksMappingPitchMapFunction MapFunction { get; set; }
		private PlotOptionsHistogramSonificationContextTracksMappingPitchMapFunction MapFunction_DefaultValue { get; set; }
