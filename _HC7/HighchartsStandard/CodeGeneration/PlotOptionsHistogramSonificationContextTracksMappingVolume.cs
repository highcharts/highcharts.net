...
{
	public partial class PlotOptionsHistogramSonificationContextTracksMappingVolume  : BaseObject
	{
		Hashtable h = new Hashtable();

		public PlotOptionsHistogramSonificationContextTracksMappingVolume()
		{
			MapFunction = MapFunction_DefaultValue = PlotOptionsHistogramSonificationContextTracksMappingVolumeMapFunction.Linear;
			MapTo = MapTo_DefaultValue = "";
			Max = Max_DefaultValue = null;
			Min = Min_DefaultValue = null;
			Value = Value_DefaultValue = null;
			Within = Within_DefaultValue = PlotOptionsHistogramSonificationContextTracksMappingVolumeWithin.Chart;
		...
		/// </summary>
		public PlotOptionsHistogramSonificationContextTracksMappingVolumeMapFunction MapFunction { get; set; }
		private PlotOptionsHistogramSonificationContextTracksMappingVolumeMapFunction MapFunction_DefaultValue { get; set; }
		...
		/// </summary>
		public PlotOptionsHistogramSonificationContextTracksMappingVolumeWithin Within { get; set; }
		private PlotOptionsHistogramSonificationContextTracksMappingVolumeWithin Within_DefaultValue { get; set; }
