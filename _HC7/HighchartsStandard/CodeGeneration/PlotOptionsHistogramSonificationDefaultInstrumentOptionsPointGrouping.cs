...
{
	public partial class PlotOptionsHistogramSonificationDefaultInstrumentOptionsPointGrouping  : BaseObject
	{
		Hashtable h = new Hashtable();

		public PlotOptionsHistogramSonificationDefaultInstrumentOptionsPointGrouping()
		{
		...
		/// </summary>
		public PlotOptionsHistogramSonificationDefaultInstrumentOptionsPointGroupingAlgorithm Algorithm { get; set; }
		private PlotOptionsHistogramSonificationDefaultInstrumentOptionsPointGroupingAlgorithm Algorithm_DefaultValue { get; set; }
		...
		internal override Hashtable ToHashtable(Highcharts highcharts)
		{
			...
			if (Algorithm != PlotOptionsHistogramSonificationDefaultInstrumentOptionsPointGroupingAlgorithm.Null) h.Add("algorithm", highcharts.FirstCharacterToLower(Algorithm.ToString()));
