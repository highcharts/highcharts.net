...
{
	public partial class PlotOptionsHistogramSonificationPointGrouping  : BaseObject
	{
		Hashtable h = new Hashtable();

		public PlotOptionsHistogramSonificationPointGrouping()
		{
		...
		/// </summary>
		public PlotOptionsHistogramSonificationPointGroupingAlgorithm Algorithm { get; set; }
		private PlotOptionsHistogramSonificationPointGroupingAlgorithm Algorithm_DefaultValue { get; set; }
		...
		internal override Hashtable ToHashtable(Highcharts highcharts)
		{
			...
			if (Algorithm != PlotOptionsHistogramSonificationPointGroupingAlgorithm.Null) h.Add("algorithm", highcharts.FirstCharacterToLower(Algorithm.ToString()));
