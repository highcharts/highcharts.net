...
{
	public partial class PlotOptionsHistogramSonificationTracksMapping  : BaseObject
	{
		Hashtable h = new Hashtable();

		public PlotOptionsHistogramSonificationTracksMapping()
		{
			Frequency = Frequency_DefaultValue = new PlotOptionsHistogramSonificationTracksMappingFrequency();
			GapBetweenNotes = GapBetweenNotes_DefaultValue = new PlotOptionsHistogramSonificationTracksMappingGapBetweenNotes();
			Highpass = Highpass_DefaultValue = new PlotOptionsHistogramSonificationTracksMappingHighpass();
			Lowpass = Lowpass_DefaultValue = new PlotOptionsHistogramSonificationTracksMappingLowpass();
			NoteDuration = NoteDuration_DefaultValue = new PlotOptionsHistogramSonificationTracksMappingNoteDuration();
			Pan = Pan_DefaultValue = new PlotOptionsHistogramSonificationTracksMappingPan();
			Pitch = Pitch_DefaultValue = new PlotOptionsHistogramSonificationTracksMappingPitch();
			PitchString = PitchString_DefaultValue = "null";
			PitchNumber = PitchNumber_DefaultValue = null;
			PlayDelay = PlayDelay_DefaultValue = new PlotOptionsHistogramSonificationTracksMappingPlayDelay();
			Time = Time_DefaultValue = new PlotOptionsHistogramSonificationTracksMappingTime();
			TimeString = TimeString_DefaultValue = "null";
			TimeNumber = TimeNumber_DefaultValue = null;
			Tremolo = Tremolo_DefaultValue = new PlotOptionsHistogramSonificationTracksMappingTremolo();
			Volume = Volume_DefaultValue = new PlotOptionsHistogramSonificationTracksMappingVolume();
		...
		/// </summary>
		public PlotOptionsHistogramSonificationTracksMappingFrequency Frequency { get; set; }
		private PlotOptionsHistogramSonificationTracksMappingFrequency Frequency_DefaultValue { get; set; }
		...
		/// </summary>
		public PlotOptionsHistogramSonificationTracksMappingGapBetweenNotes GapBetweenNotes { get; set; }
		private PlotOptionsHistogramSonificationTracksMappingGapBetweenNotes GapBetweenNotes_DefaultValue { get; set; }
		...
		/// </summary>
		public PlotOptionsHistogramSonificationTracksMappingHighpass Highpass { get; set; }
		private PlotOptionsHistogramSonificationTracksMappingHighpass Highpass_DefaultValue { get; set; }
		...
		/// </summary>
		public PlotOptionsHistogramSonificationTracksMappingLowpass Lowpass { get; set; }
		private PlotOptionsHistogramSonificationTracksMappingLowpass Lowpass_DefaultValue { get; set; }
		...
		/// </summary>
		public PlotOptionsHistogramSonificationTracksMappingNoteDuration NoteDuration { get; set; }
		private PlotOptionsHistogramSonificationTracksMappingNoteDuration NoteDuration_DefaultValue { get; set; }
		...
		/// </summary>
		public PlotOptionsHistogramSonificationTracksMappingPan Pan { get; set; }
		private PlotOptionsHistogramSonificationTracksMappingPan Pan_DefaultValue { get; set; }
		...
		/// </summary>
		public PlotOptionsHistogramSonificationTracksMappingPitch Pitch { get; set; }
		private PlotOptionsHistogramSonificationTracksMappingPitch Pitch_DefaultValue { get; set; }
		...
		/// </summary>
		public PlotOptionsHistogramSonificationTracksMappingPlayDelay PlayDelay { get; set; }
		private PlotOptionsHistogramSonificationTracksMappingPlayDelay PlayDelay_DefaultValue { get; set; }
		...
		/// </summary>
		public PlotOptionsHistogramSonificationTracksMappingTime Time { get; set; }
		private PlotOptionsHistogramSonificationTracksMappingTime Time_DefaultValue { get; set; }
		...
		/// </summary>
		public PlotOptionsHistogramSonificationTracksMappingTremolo Tremolo { get; set; }
		private PlotOptionsHistogramSonificationTracksMappingTremolo Tremolo_DefaultValue { get; set; }
		 

		/// <summary>
		/// The volume of notes, from 0 to 1.
		/// </summary>
		public PlotOptionsHistogramSonificationTracksMappingVolume Volume { get; set; }
		private PlotOptionsHistogramSonificationTracksMappingVolume Volume_DefaultValue { get; set; }
