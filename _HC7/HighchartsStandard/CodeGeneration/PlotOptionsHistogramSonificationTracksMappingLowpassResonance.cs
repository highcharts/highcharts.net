...
{
	public partial class PlotOptionsHistogramSonificationTracksMappingLowpassResonance  : BaseObject
	{
		Hashtable h = new Hashtable();

		public PlotOptionsHistogramSonificationTracksMappingLowpassResonance()
		{
			MapFunction = MapFunction_DefaultValue = PlotOptionsHistogramSonificationTracksMappingLowpassResonanceMapFunction.Linear;
			MapTo = MapTo_DefaultValue = "";
			Max = Max_DefaultValue = null;
			Min = Min_DefaultValue = null;
			Value = Value_DefaultValue = null;
			Within = Within_DefaultValue = PlotOptionsHistogramSonificationTracksMappingLowpassResonanceWithin.Chart;
		...
		/// </summary>
		public PlotOptionsHistogramSonificationTracksMappingLowpassResonanceMapFunction MapFunction { get; set; }
		private PlotOptionsHistogramSonificationTracksMappingLowpassResonanceMapFunction MapFunction_DefaultValue { get; set; }
		...
		/// </summary>
		public PlotOptionsHistogramSonificationTracksMappingLowpassResonanceWithin Within { get; set; }
		private PlotOptionsHistogramSonificationTracksMappingLowpassResonanceWithin Within_DefaultValue { get; set; }
