...
{
	public partial class PlotOptionsHistogramSonificationTracksMappingNoteDuration  : BaseObject
	{
		Hashtable h = new Hashtable();

		public PlotOptionsHistogramSonificationTracksMappingNoteDuration()
		{
			MapFunction = MapFunction_DefaultValue = PlotOptionsHistogramSonificationTracksMappingNoteDurationMapFunction.Linear;
			MapTo = MapTo_DefaultValue = "";
			Max = Max_DefaultValue = null;
			Min = Min_DefaultValue = null;
			Value = Value_DefaultValue = null;
			Within = Within_DefaultValue = PlotOptionsHistogramSonificationTracksMappingNoteDurationWithin.Chart;
		...
		/// </summary>
		public PlotOptionsHistogramSonificationTracksMappingNoteDurationMapFunction MapFunction { get; set; }
		private PlotOptionsHistogramSonificationTracksMappingNoteDurationMapFunction MapFunction_DefaultValue { get; set; }
		...
		/// </summary>
		public PlotOptionsHistogramSonificationTracksMappingNoteDurationWithin Within { get; set; }
		private PlotOptionsHistogramSonificationTracksMappingNoteDurationWithin Within_DefaultValue { get; set; }
