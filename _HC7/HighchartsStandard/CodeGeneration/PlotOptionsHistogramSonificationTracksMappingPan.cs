...
{
	public partial class PlotOptionsHistogramSonificationTracksMappingPan  : BaseObject
	{
		Hashtable h = new Hashtable();

		public PlotOptionsHistogramSonificationTracksMappingPan()
		{
			MapFunction = MapFunction_DefaultValue = PlotOptionsHistogramSonificationTracksMappingPanMapFunction.Linear;
			MapTo = MapTo_DefaultValue = "";
			Max = Max_DefaultValue = null;
			Min = Min_DefaultValue = null;
			Value = Value_DefaultValue = null;
			Within = Within_DefaultValue = PlotOptionsHistogramSonificationTracksMappingPanWithin.Chart;
		...
		/// </summary>
		public PlotOptionsHistogramSonificationTracksMappingPanMapFunction MapFunction { get; set; }
		private PlotOptionsHistogramSonificationTracksMappingPanMapFunction MapFunction_DefaultValue { get; set; }
		...
		/// </summary>
		public PlotOptionsHistogramSonificationTracksMappingPanWithin Within { get; set; }
		private PlotOptionsHistogramSonificationTracksMappingPanWithin Within_DefaultValue { get; set; }
