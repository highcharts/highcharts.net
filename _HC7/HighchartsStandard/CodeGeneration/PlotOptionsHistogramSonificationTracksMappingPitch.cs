...
{
	public partial class PlotOptionsHistogramSonificationTracksMappingPitch  : BaseObject
	{
		Hashtable h = new Hashtable();

		public PlotOptionsHistogramSonificationTracksMappingPitch()
		{
			MapFunction = MapFunction_DefaultValue = PlotOptionsHistogramSonificationTracksMappingPitchMapFunction.Linear;
		...
		/// </summary>
		public PlotOptionsHistogramSonificationTracksMappingPitchMapFunction MapFunction { get; set; }
		private PlotOptionsHistogramSonificationTracksMappingPitchMapFunction MapFunction_DefaultValue { get; set; }
