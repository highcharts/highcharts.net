...
{
	public partial class PlotOptionsHistogramSonificationTracksMappingTime  : BaseObject
	{
		Hashtable h = new Hashtable();

		public PlotOptionsHistogramSonificationTracksMappingTime()
		{
			MapFunction = MapFunction_DefaultValue = PlotOptionsHistogramSonificationTracksMappingTimeMapFunction.Linear;
			MapTo = MapTo_DefaultValue = "";
			Max = Max_DefaultValue = null;
			Min = Min_DefaultValue = null;
			Value = Value_DefaultValue = null;
			Within = Within_DefaultValue = PlotOptionsHistogramSonificationTracksMappingTimeWithin.Chart;
		...
		/// </summary>
		public PlotOptionsHistogramSonificationTracksMappingTimeMapFunction MapFunction { get; set; }
		private PlotOptionsHistogramSonificationTracksMappingTimeMapFunction MapFunction_DefaultValue { get; set; }
		...
		/// </summary>
		public PlotOptionsHistogramSonificationTracksMappingTimeWithin Within { get; set; }
		private PlotOptionsHistogramSonificationTracksMappingTimeWithin Within_DefaultValue { get; set; }
