...
{
	public partial class PlotOptionsHistogramSonificationTracksPointGrouping  : BaseObject
	{
		Hashtable h = new Hashtable();

		public PlotOptionsHistogramSonificationTracksPointGrouping()
		{
		...
		/// </summary>
		public PlotOptionsHistogramSonificationTracksPointGroupingAlgorithm Algorithm { get; set; }
		private PlotOptionsHistogramSonificationTracksPointGroupingAlgorithm Algorithm_DefaultValue { get; set; }
		...
		internal override Hashtable ToHashtable(Highcharts highcharts)
		{
			...
			if (Algorithm != PlotOptionsHistogramSonificationTracksPointGroupingAlgorithm.Null) h.Add("algorithm", highcharts.FirstCharacterToLower(Algorithm.ToString()));
