...
{
	public partial class PlotOptionsItemDataLabels  : BaseObject
	{
		Hashtable h = new Hashtable();

		public PlotOptionsItemDataLabels()
		{
		...
		/// </summary>
		public PlotOptionsItemDataLabelsAlign Align { get; set; }
		private PlotOptionsItemDataLabelsAlign Align_DefaultValue { get; set; }
		...
		/// </summary>
		public PlotOptionsItemDataLabelsFilter Filter { get; set; }
		private PlotOptionsItemDataLabelsFilter Filter_DefaultValue { get; set; }
		...
		/// </summary>
		public PlotOptionsItemDataLabelsOverflow Overflow { get; set; }
		private PlotOptionsItemDataLabelsOverflow Overflow_DefaultValue { get; set; }
		...
		/// </summary>
		public PlotOptionsItemDataLabelsPosition Position { get; set; }
		private PlotOptionsItemDataLabelsPosition Position_DefaultValue { get; set; }
		...
		/// </summary>
		public PlotOptionsItemDataLabelsTextPath TextPath { get; set; }
		private PlotOptionsItemDataLabelsTextPath TextPath_DefaultValue { get; set; }
		...
		/// </summary>
		public PlotOptionsItemDataLabelsVerticalAlign VerticalAlign { get; set; }
		private PlotOptionsItemDataLabelsVerticalAlign VerticalAlign_DefaultValue { get; set; }
		...
		internal override Hashtable ToHashtable(Highcharts highcharts)
		{
			...
			if (Align != PlotOptionsItemDataLabelsAlign.Null) h.Add("align", highcharts.FirstCharacterToLower(Align.ToString()));
			...
			if (Overflow != PlotOptionsItemDataLabelsOverflow.Null) h.Add("overflow", highcharts.FirstCharacterToLower(Overflow.ToString()));
			if (Padding != null) h.Add("padding",Padding);
			if (Position != PlotOptionsItemDataLabelsPosition.Null) h.Add("position", highcharts.FirstCharacterToLower(Position.ToString()));
			...
			if (VerticalAlign != PlotOptionsItemDataLabelsVerticalAlign.Null) h.Add("verticalAlign", highcharts.FirstCharacterToLower(VerticalAlign.ToString()));
			if (X != null) h.Add("x",X);
			if (Y != null) h.Add("y",Y);
