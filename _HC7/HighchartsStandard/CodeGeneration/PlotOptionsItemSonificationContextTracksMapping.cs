...
{
	public partial class PlotOptionsItemSonificationContextTracksMapping  : BaseObject
	{
		Hashtable h = new Hashtable();

		public PlotOptionsItemSonificationContextTracksMapping()
		{
			Frequency = Frequency_DefaultValue = new PlotOptionsItemSonificationContextTracksMappingFrequency();
			GapBetweenNotes = GapBetweenNotes_DefaultValue = new PlotOptionsItemSonificationContextTracksMappingGapBetweenNotes();
			Highpass = Highpass_DefaultValue = new PlotOptionsItemSonificationContextTracksMappingHighpass();
			Lowpass = Lowpass_DefaultValue = new PlotOptionsItemSonificationContextTracksMappingLowpass();
			NoteDuration = NoteDuration_DefaultValue = new PlotOptionsItemSonificationContextTracksMappingNoteDuration();
			Pan = Pan_DefaultValue = new PlotOptionsItemSonificationContextTracksMappingPan();
			Pitch = Pitch_DefaultValue = new PlotOptionsItemSonificationContextTracksMappingPitch();
			PitchString = PitchString_DefaultValue = "null";
			PitchNumber = PitchNumber_DefaultValue = null;
			PlayDelay = PlayDelay_DefaultValue = new PlotOptionsItemSonificationContextTracksMappingPlayDelay();
			Time = Time_DefaultValue = new PlotOptionsItemSonificationContextTracksMappingTime();
			TimeString = TimeString_DefaultValue = "null";
			TimeNumber = TimeNumber_DefaultValue = null;
			Tremolo = Tremolo_DefaultValue = new PlotOptionsItemSonificationContextTracksMappingTremolo();
			Volume = Volume_DefaultValue = new PlotOptionsItemSonificationContextTracksMappingVolume();
		...
		/// </summary>
		public PlotOptionsItemSonificationContextTracksMappingFrequency Frequency { get; set; }
		private PlotOptionsItemSonificationContextTracksMappingFrequency Frequency_DefaultValue { get; set; }
		...
		/// </summary>
		public PlotOptionsItemSonificationContextTracksMappingGapBetweenNotes GapBetweenNotes { get; set; }
		private PlotOptionsItemSonificationContextTracksMappingGapBetweenNotes GapBetweenNotes_DefaultValue { get; set; }
		...
		/// </summary>
		public PlotOptionsItemSonificationContextTracksMappingHighpass Highpass { get; set; }
		private PlotOptionsItemSonificationContextTracksMappingHighpass Highpass_DefaultValue { get; set; }
		...
		/// </summary>
		public PlotOptionsItemSonificationContextTracksMappingLowpass Lowpass { get; set; }
		private PlotOptionsItemSonificationContextTracksMappingLowpass Lowpass_DefaultValue { get; set; }
		...
		/// </summary>
		public PlotOptionsItemSonificationContextTracksMappingNoteDuration NoteDuration { get; set; }
		private PlotOptionsItemSonificationContextTracksMappingNoteDuration NoteDuration_DefaultValue { get; set; }
		...
		/// </summary>
		public PlotOptionsItemSonificationContextTracksMappingPan Pan { get; set; }
		private PlotOptionsItemSonificationContextTracksMappingPan Pan_DefaultValue { get; set; }
		...
		/// </summary>
		public PlotOptionsItemSonificationContextTracksMappingPitch Pitch { get; set; }
		private PlotOptionsItemSonificationContextTracksMappingPitch Pitch_DefaultValue { get; set; }
		...
		/// </summary>
		public PlotOptionsItemSonificationContextTracksMappingPlayDelay PlayDelay { get; set; }
		private PlotOptionsItemSonificationContextTracksMappingPlayDelay PlayDelay_DefaultValue { get; set; }
		...
		/// </summary>
		public PlotOptionsItemSonificationContextTracksMappingTime Time { get; set; }
		private PlotOptionsItemSonificationContextTracksMappingTime Time_DefaultValue { get; set; }
		...
		/// </summary>
		public PlotOptionsItemSonificationContextTracksMappingTremolo Tremolo { get; set; }
		private PlotOptionsItemSonificationContextTracksMappingTremolo Tremolo_DefaultValue { get; set; }
		 

		/// <summary>
		/// The volume of notes, from 0 to 1.
		/// </summary>
		public PlotOptionsItemSonificationContextTracksMappingVolume Volume { get; set; }
		private PlotOptionsItemSonificationContextTracksMappingVolume Volume_DefaultValue { get; set; }
