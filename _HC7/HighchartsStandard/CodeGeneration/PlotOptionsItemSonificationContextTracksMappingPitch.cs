...
{
	public partial class PlotOptionsItemSonificationContextTracksMappingPitch  : BaseObject
	{
		Hashtable h = new Hashtable();

		public PlotOptionsItemSonificationContextTracksMappingPitch()
		{
			MapFunction = MapFunction_DefaultValue = PlotOptionsItemSonificationContextTracksMappingPitchMapFunction.Linear;
		...
		/// </summary>
		public PlotOptionsItemSonificationContextTracksMappingPitchMapFunction MapFunction { get; set; }
		private PlotOptionsItemSonificationContextTracksMappingPitchMapFunction MapFunction_DefaultValue { get; set; }
