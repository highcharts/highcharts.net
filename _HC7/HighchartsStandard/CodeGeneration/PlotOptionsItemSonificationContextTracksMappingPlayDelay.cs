...
{
	public partial class PlotOptionsItemSonificationContextTracksMappingPlayDelay  : BaseObject
	{
		Hashtable h = new Hashtable();

		public PlotOptionsItemSonificationContextTracksMappingPlayDelay()
		{
			MapFunction = MapFunction_DefaultValue = PlotOptionsItemSonificationContextTracksMappingPlayDelayMapFunction.Linear;
			MapTo = MapTo_DefaultValue = "";
			Max = Max_DefaultValue = null;
			Min = Min_DefaultValue = null;
			Value = Value_DefaultValue = null;
			Within = Within_DefaultValue = PlotOptionsItemSonificationContextTracksMappingPlayDelayWithin.Chart;
		...
		/// </summary>
		public PlotOptionsItemSonificationContextTracksMappingPlayDelayMapFunction MapFunction { get; set; }
		private PlotOptionsItemSonificationContextTracksMappingPlayDelayMapFunction MapFunction_DefaultValue { get; set; }
		...
		/// </summary>
		public PlotOptionsItemSonificationContextTracksMappingPlayDelayWithin Within { get; set; }
		private PlotOptionsItemSonificationContextTracksMappingPlayDelayWithin Within_DefaultValue { get; set; }
