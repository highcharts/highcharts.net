...
{
	public partial class PlotOptionsItemSonificationDefaultInstrumentOptionsMappingHighpassResonance  : BaseObject
	{
		Hashtable h = new Hashtable();

		public PlotOptionsItemSonificationDefaultInstrumentOptionsMappingHighpassResonance()
		{
			MapFunction = MapFunction_DefaultValue = PlotOptionsItemSonificationDefaultInstrumentOptionsMappingHighpassResonanceMapFunction.Linear;
			MapTo = MapTo_DefaultValue = "";
			Max = Max_DefaultValue = null;
			Min = Min_DefaultValue = null;
			Value = Value_DefaultValue = null;
			Within = Within_DefaultValue = PlotOptionsItemSonificationDefaultInstrumentOptionsMappingHighpassResonanceWithin.Chart;
		...
		/// </summary>
		public PlotOptionsItemSonificationDefaultInstrumentOptionsMappingHighpassResonanceMapFunction MapFunction { get; set; }
		private PlotOptionsItemSonificationDefaultInstrumentOptionsMappingHighpassResonanceMapFunction MapFunction_DefaultValue { get; set; }
		...
		/// </summary>
		public PlotOptionsItemSonificationDefaultInstrumentOptionsMappingHighpassResonanceWithin Within { get; set; }
		private PlotOptionsItemSonificationDefaultInstrumentOptionsMappingHighpassResonanceWithin Within_DefaultValue { get; set; }
