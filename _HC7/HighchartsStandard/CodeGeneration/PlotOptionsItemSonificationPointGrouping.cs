...
{
	public partial class PlotOptionsItemSonificationPointGrouping  : BaseObject
	{
		Hashtable h = new Hashtable();

		public PlotOptionsItemSonificationPointGrouping()
		{
		...
		/// </summary>
		public PlotOptionsItemSonificationPointGroupingAlgorithm Algorithm { get; set; }
		private PlotOptionsItemSonificationPointGroupingAlgorithm Algorithm_DefaultValue { get; set; }
		...
		internal override Hashtable ToHashtable(Highcharts highcharts)
		{
			...
			if (Algorithm != PlotOptionsItemSonificationPointGroupingAlgorithm.Null) h.Add("algorithm", highcharts.FirstCharacterToLower(Algorithm.ToString()));
