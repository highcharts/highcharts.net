...
{
	public partial class PlotOptionsItemSonificationTracks  : BaseObject
	{
		Hashtable h = new Hashtable();

		public PlotOptionsItemSonificationTracks()
		{
			ActiveWhen = ActiveWhen_DefaultValue = new PlotOptionsItemSonificationTracksActiveWhen();
			Instrument = Instrument_DefaultValue = null;
			InstrumentString = InstrumentString_DefaultValue = "null";
			Mapping = Mapping_DefaultValue = new PlotOptionsItemSonificationTracksMapping();
			MidiName = MidiName_DefaultValue = "";
			PointGrouping = PointGrouping_DefaultValue = new PlotOptionsItemSonificationTracksPointGrouping();
			RoundToMusicalNotes = RoundToMusicalNotes_DefaultValue = true;
			ShowPlayMarker = ShowPlayMarker_DefaultValue = true;
			Type = Type_DefaultValue = PlotOptionsItemSonificationTracksType.Instrument;
		...
		/// </summary>
		public PlotOptionsItemSonificationTracksActiveWhen ActiveWhen { get; set; }
		private PlotOptionsItemSonificationTracksActiveWhen ActiveWhen_DefaultValue { get; set; }
		...
		/// </summary>
		public PlotOptionsItemSonificationTracksMapping Mapping { get; set; }
		private PlotOptionsItemSonificationTracksMapping Mapping_DefaultValue { get; set; }
		...
		/// </summary>
		public PlotOptionsItemSonificationTracksPointGrouping PointGrouping { get; set; }
		private PlotOptionsItemSonificationTracksPointGrouping PointGrouping_DefaultValue { get; set; }
		...
		/// </summary>
		public PlotOptionsItemSonificationTracksType Type { get; set; }
		private PlotOptionsItemSonificationTracksType Type_DefaultValue { get; set; }
