...
{
	public partial class PlotOptionsItemSonificationTracksMappingFrequency  : BaseObject
	{
		Hashtable h = new Hashtable();

		public PlotOptionsItemSonificationTracksMappingFrequency()
		{
			MapFunction = MapFunction_DefaultValue = PlotOptionsItemSonificationTracksMappingFrequencyMapFunction.Linear;
			MapTo = MapTo_DefaultValue = "";
			Max = Max_DefaultValue = null;
			Min = Min_DefaultValue = null;
			Value = Value_DefaultValue = null;
			Within = Within_DefaultValue = PlotOptionsItemSonificationTracksMappingFrequencyWithin.Chart;
		...
		/// </summary>
		public PlotOptionsItemSonificationTracksMappingFrequencyMapFunction MapFunction { get; set; }
		private PlotOptionsItemSonificationTracksMappingFrequencyMapFunction MapFunction_DefaultValue { get; set; }
		...
		/// </summary>
		public PlotOptionsItemSonificationTracksMappingFrequencyWithin Within { get; set; }
		private PlotOptionsItemSonificationTracksMappingFrequencyWithin Within_DefaultValue { get; set; }
