...
{
	public partial class PlotOptionsItemSonificationTracksMappingNoteDuration  : BaseObject
	{
		Hashtable h = new Hashtable();

		public PlotOptionsItemSonificationTracksMappingNoteDuration()
		{
			MapFunction = MapFunction_DefaultValue = PlotOptionsItemSonificationTracksMappingNoteDurationMapFunction.Linear;
			MapTo = MapTo_DefaultValue = "";
			Max = Max_DefaultValue = null;
			Min = Min_DefaultValue = null;
			Value = Value_DefaultValue = null;
			Within = Within_DefaultValue = PlotOptionsItemSonificationTracksMappingNoteDurationWithin.Chart;
		...
		/// </summary>
		public PlotOptionsItemSonificationTracksMappingNoteDurationMapFunction MapFunction { get; set; }
		private PlotOptionsItemSonificationTracksMappingNoteDurationMapFunction MapFunction_DefaultValue { get; set; }
		...
		/// </summary>
		public PlotOptionsItemSonificationTracksMappingNoteDurationWithin Within { get; set; }
		private PlotOptionsItemSonificationTracksMappingNoteDurationWithin Within_DefaultValue { get; set; }
