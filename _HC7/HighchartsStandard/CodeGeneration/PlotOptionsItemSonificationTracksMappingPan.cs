...
{
	public partial class PlotOptionsItemSonificationTracksMappingPan  : BaseObject
	{
		Hashtable h = new Hashtable();

		public PlotOptionsItemSonificationTracksMappingPan()
		{
			MapFunction = MapFunction_DefaultValue = PlotOptionsItemSonificationTracksMappingPanMapFunction.Linear;
			MapTo = MapTo_DefaultValue = "";
			Max = Max_DefaultValue = null;
			Min = Min_DefaultValue = null;
			Value = Value_DefaultValue = null;
			Within = Within_DefaultValue = PlotOptionsItemSonificationTracksMappingPanWithin.Chart;
		...
		/// </summary>
		public PlotOptionsItemSonificationTracksMappingPanMapFunction MapFunction { get; set; }
		private PlotOptionsItemSonificationTracksMappingPanMapFunction MapFunction_DefaultValue { get; set; }
		...
		/// </summary>
		public PlotOptionsItemSonificationTracksMappingPanWithin Within { get; set; }
		private PlotOptionsItemSonificationTracksMappingPanWithin Within_DefaultValue { get; set; }
