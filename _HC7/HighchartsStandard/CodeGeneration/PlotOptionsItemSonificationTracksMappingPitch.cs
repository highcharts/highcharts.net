...
{
	public partial class PlotOptionsItemSonificationTracksMappingPitch  : BaseObject
	{
		Hashtable h = new Hashtable();

		public PlotOptionsItemSonificationTracksMappingPitch()
		{
			MapFunction = MapFunction_DefaultValue = PlotOptionsItemSonificationTracksMappingPitchMapFunction.Linear;
		...
		/// </summary>
		public PlotOptionsItemSonificationTracksMappingPitchMapFunction MapFunction { get; set; }
		private PlotOptionsItemSonificationTracksMappingPitchMapFunction MapFunction_DefaultValue { get; set; }
