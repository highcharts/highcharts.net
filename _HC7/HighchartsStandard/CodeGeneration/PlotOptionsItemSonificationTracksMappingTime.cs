...
{
	public partial class PlotOptionsItemSonificationTracksMappingTime  : BaseObject
	{
		Hashtable h = new Hashtable();

		public PlotOptionsItemSonificationTracksMappingTime()
		{
			MapFunction = MapFunction_DefaultValue = PlotOptionsItemSonificationTracksMappingTimeMapFunction.Linear;
			MapTo = MapTo_DefaultValue = "";
			Max = Max_DefaultValue = null;
			Min = Min_DefaultValue = null;
			Value = Value_DefaultValue = null;
			Within = Within_DefaultValue = PlotOptionsItemSonificationTracksMappingTimeWithin.Chart;
		...
		/// </summary>
		public PlotOptionsItemSonificationTracksMappingTimeMapFunction MapFunction { get; set; }
		private PlotOptionsItemSonificationTracksMappingTimeMapFunction MapFunction_DefaultValue { get; set; }
		...
		/// </summary>
		public PlotOptionsItemSonificationTracksMappingTimeWithin Within { get; set; }
		private PlotOptionsItemSonificationTracksMappingTimeWithin Within_DefaultValue { get; set; }
