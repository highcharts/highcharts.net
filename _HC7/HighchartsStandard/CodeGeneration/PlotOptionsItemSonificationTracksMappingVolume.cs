...
{
	public partial class PlotOptionsItemSonificationTracksMappingVolume  : BaseObject
	{
		Hashtable h = new Hashtable();

		public PlotOptionsItemSonificationTracksMappingVolume()
		{
			MapFunction = MapFunction_DefaultValue = PlotOptionsItemSonificationTracksMappingVolumeMapFunction.Linear;
			MapTo = MapTo_DefaultValue = "";
			Max = Max_DefaultValue = null;
			Min = Min_DefaultValue = null;
			Value = Value_DefaultValue = null;
			Within = Within_DefaultValue = PlotOptionsItemSonificationTracksMappingVolumeWithin.Chart;
		...
		/// </summary>
		public PlotOptionsItemSonificationTracksMappingVolumeMapFunction MapFunction { get; set; }
		private PlotOptionsItemSonificationTracksMappingVolumeMapFunction MapFunction_DefaultValue { get; set; }
		...
		/// </summary>
		public PlotOptionsItemSonificationTracksMappingVolumeWithin Within { get; set; }
		private PlotOptionsItemSonificationTracksMappingVolumeWithin Within_DefaultValue { get; set; }
