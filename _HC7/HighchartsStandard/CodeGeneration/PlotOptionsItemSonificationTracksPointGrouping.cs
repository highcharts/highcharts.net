...
{
	public partial class PlotOptionsItemSonificationTracksPointGrouping  : BaseObject
	{
		Hashtable h = new Hashtable();

		public PlotOptionsItemSonificationTracksPointGrouping()
		{
		...
		/// </summary>
		public PlotOptionsItemSonificationTracksPointGroupingAlgorithm Algorithm { get; set; }
		private PlotOptionsItemSonificationTracksPointGroupingAlgorithm Algorithm_DefaultValue { get; set; }
		...
		internal override Hashtable ToHashtable(Highcharts highcharts)
		{
			...
			if (Algorithm != PlotOptionsItemSonificationTracksPointGroupingAlgorithm.Null) h.Add("algorithm", highcharts.FirstCharacterToLower(Algorithm.ToString()));
