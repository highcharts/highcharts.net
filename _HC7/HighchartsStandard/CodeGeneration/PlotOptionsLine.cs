...
namespace Highsoft.Web.Mvc.Charts
{
	public partial class PlotOptionsLine  : BaseObject
	{
		...
		private PlotOptionsLinePointPlacement PointPlacement_DefaultValue { get; set; }
		...
		internal override Hashtable ToHashtable(Highcharts highcharts)
		{
			...
			if (BoostBlending != PlotOptionsLineBoostBlending.Null) h.Add("boostBlending", highcharts.FirstCharacterToLower(BoostBlending.ToString()));
			...
			if (Cursor != PlotOptionsLineCursor.Null) h.Add("cursor", highcharts.FirstCharacterToLower(Cursor.ToString()));
			if (Custom != null) h.Add("custom",Custom);
			if (DashStyle != PlotOptionsLineDashStyle.Null) h.Add("dashStyle", highcharts.FirstCharacterToLower(DashStyle.ToString()));
			...
			if (FindNearestPointBy != PlotOptionsLineFindNearestPointBy.Null) h.Add("findNearestPointBy", highcharts.FirstCharacterToLower(FindNearestPointBy.ToString()));
			...
			if (LegendSymbol != PlotOptionsLineLegendSymbol.Null) h.Add("legendSymbol", highcharts.FirstCharacterToLower(LegendSymbol.ToString()));
			...
			if (PointIntervalUnit != PlotOptionsLinePointIntervalUnit.Null) h.Add("pointIntervalUnit", highcharts.FirstCharacterToLower(PointIntervalUnit.ToString()));
			if (PointPlacement != PlotOptionsLinePointPlacement.Null) h.Add("pointPlacement", highcharts.FirstCharacterToLower(PointPlacement.ToString()));
			...
			if (Stacking != PlotOptionsLineStacking.Null) h.Add("stacking", highcharts.FirstCharacterToLower(Stacking.ToString()));
			if (States != null) h.Add("states",States.ToHashtable(highcharts));
			if (Step != PlotOptionsLineStep.Null) h.Add("step", highcharts.FirstCharacterToLower(Step.ToString()));
