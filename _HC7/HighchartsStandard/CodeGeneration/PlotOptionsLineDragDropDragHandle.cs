...
namespace Highsoft.Web.Mvc.Charts
{
	public partial class PlotOptionsLineDragDropDragHandle  : BaseObject
	{
		...
		internal override Hashtable ToHashtable()
		{
			...
			if (PathFormatter != PathFormatter_DefaultValue) { h.Add("pathFormatter",PathFormatter); Highcharts.AddFunction("18926f83-3602-46db-a0ce-21e9b165ae69.pathFormatter", PathFormatter); }  
