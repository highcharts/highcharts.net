...
{
	public partial class PlotOptionsLineSonificationContextTracksMappingHighpassResonance  : BaseObject
	{
		Hashtable h = new Hashtable();

		public PlotOptionsLineSonificationContextTracksMappingHighpassResonance()
		{
			MapFunction = MapFunction_DefaultValue = PlotOptionsLineSonificationContextTracksMappingHighpassResonanceMapFunction.Linear;
			MapTo = MapTo_DefaultValue = "";
			Max = Max_DefaultValue = null;
			Min = Min_DefaultValue = null;
			Value = Value_DefaultValue = null;
			Within = Within_DefaultValue = PlotOptionsLineSonificationContextTracksMappingHighpassResonanceWithin.Chart;
		...
		/// </summary>
		public PlotOptionsLineSonificationContextTracksMappingHighpassResonanceMapFunction MapFunction { get; set; }
		private PlotOptionsLineSonificationContextTracksMappingHighpassResonanceMapFunction MapFunction_DefaultValue { get; set; }
		...
		/// </summary>
		public PlotOptionsLineSonificationContextTracksMappingHighpassResonanceWithin Within { get; set; }
		private PlotOptionsLineSonificationContextTracksMappingHighpassResonanceWithin Within_DefaultValue { get; set; }
