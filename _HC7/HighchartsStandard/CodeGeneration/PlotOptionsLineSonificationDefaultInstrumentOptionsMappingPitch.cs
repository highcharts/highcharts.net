...
{
	public partial class PlotOptionsLineSonificationDefaultInstrumentOptionsMappingPitch  : BaseObject
	{
		Hashtable h = new Hashtable();

		public PlotOptionsLineSonificationDefaultInstrumentOptionsMappingPitch()
		{
			MapFunction = MapFunction_DefaultValue = PlotOptionsLineSonificationDefaultInstrumentOptionsMappingPitchMapFunction.Linear;
		...
		/// </summary>
		public PlotOptionsLineSonificationDefaultInstrumentOptionsMappingPitchMapFunction MapFunction { get; set; }
		private PlotOptionsLineSonificationDefaultInstrumentOptionsMappingPitchMapFunction MapFunction_DefaultValue { get; set; }
