...
{
	public partial class PlotOptionsLineSonificationPointGrouping  : BaseObject
	{
		Hashtable h = new Hashtable();

		public PlotOptionsLineSonificationPointGrouping()
		{
		...
		/// </summary>
		public PlotOptionsLineSonificationPointGroupingAlgorithm Algorithm { get; set; }
		private PlotOptionsLineSonificationPointGroupingAlgorithm Algorithm_DefaultValue { get; set; }
		...
		internal override Hashtable ToHashtable(Highcharts highcharts)
		{
			...
			if (Algorithm != PlotOptionsLineSonificationPointGroupingAlgorithm.Null) h.Add("algorithm", highcharts.FirstCharacterToLower(Algorithm.ToString()));
