...
{
	public partial class PlotOptionsLineSonificationTracksMapping  : BaseObject
	{
		Hashtable h = new Hashtable();

		public PlotOptionsLineSonificationTracksMapping()
		{
			Frequency = Frequency_DefaultValue = new PlotOptionsLineSonificationTracksMappingFrequency();
			GapBetweenNotes = GapBetweenNotes_DefaultValue = new PlotOptionsLineSonificationTracksMappingGapBetweenNotes();
			Highpass = Highpass_DefaultValue = new PlotOptionsLineSonificationTracksMappingHighpass();
			Lowpass = Lowpass_DefaultValue = new PlotOptionsLineSonificationTracksMappingLowpass();
			NoteDuration = NoteDuration_DefaultValue = new PlotOptionsLineSonificationTracksMappingNoteDuration();
			Pan = Pan_DefaultValue = new PlotOptionsLineSonificationTracksMappingPan();
			Pitch = Pitch_DefaultValue = new PlotOptionsLineSonificationTracksMappingPitch();
			PitchString = PitchString_DefaultValue = "null";
			PitchNumber = PitchNumber_DefaultValue = null;
			PlayDelay = PlayDelay_DefaultValue = new PlotOptionsLineSonificationTracksMappingPlayDelay();
			Time = Time_DefaultValue = new PlotOptionsLineSonificationTracksMappingTime();
			TimeString = TimeString_DefaultValue = "null";
			TimeNumber = TimeNumber_DefaultValue = null;
			Tremolo = Tremolo_DefaultValue = new PlotOptionsLineSonificationTracksMappingTremolo();
			Volume = Volume_DefaultValue = new PlotOptionsLineSonificationTracksMappingVolume();
		...
		/// </summary>
		public PlotOptionsLineSonificationTracksMappingFrequency Frequency { get; set; }
		private PlotOptionsLineSonificationTracksMappingFrequency Frequency_DefaultValue { get; set; }
		...
		/// </summary>
		public PlotOptionsLineSonificationTracksMappingGapBetweenNotes GapBetweenNotes { get; set; }
		private PlotOptionsLineSonificationTracksMappingGapBetweenNotes GapBetweenNotes_DefaultValue { get; set; }
		...
		/// </summary>
		public PlotOptionsLineSonificationTracksMappingHighpass Highpass { get; set; }
		private PlotOptionsLineSonificationTracksMappingHighpass Highpass_DefaultValue { get; set; }
		...
		/// </summary>
		public PlotOptionsLineSonificationTracksMappingLowpass Lowpass { get; set; }
		private PlotOptionsLineSonificationTracksMappingLowpass Lowpass_DefaultValue { get; set; }
		...
		/// </summary>
		public PlotOptionsLineSonificationTracksMappingNoteDuration NoteDuration { get; set; }
		private PlotOptionsLineSonificationTracksMappingNoteDuration NoteDuration_DefaultValue { get; set; }
		...
		/// </summary>
		public PlotOptionsLineSonificationTracksMappingPan Pan { get; set; }
		private PlotOptionsLineSonificationTracksMappingPan Pan_DefaultValue { get; set; }
		...
		/// </summary>
		public PlotOptionsLineSonificationTracksMappingPitch Pitch { get; set; }
		private PlotOptionsLineSonificationTracksMappingPitch Pitch_DefaultValue { get; set; }
		...
		/// </summary>
		public PlotOptionsLineSonificationTracksMappingPlayDelay PlayDelay { get; set; }
		private PlotOptionsLineSonificationTracksMappingPlayDelay PlayDelay_DefaultValue { get; set; }
		...
		/// </summary>
		public PlotOptionsLineSonificationTracksMappingTime Time { get; set; }
		private PlotOptionsLineSonificationTracksMappingTime Time_DefaultValue { get; set; }
		...
		/// </summary>
		public PlotOptionsLineSonificationTracksMappingTremolo Tremolo { get; set; }
		private PlotOptionsLineSonificationTracksMappingTremolo Tremolo_DefaultValue { get; set; }
		 

		/// <summary>
		/// The volume of notes, from 0 to 1.
		/// </summary>
		public PlotOptionsLineSonificationTracksMappingVolume Volume { get; set; }
		private PlotOptionsLineSonificationTracksMappingVolume Volume_DefaultValue { get; set; }
