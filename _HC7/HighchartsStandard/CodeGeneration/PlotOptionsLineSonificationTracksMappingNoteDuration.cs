...
{
	public partial class PlotOptionsLineSonificationTracksMappingNoteDuration  : BaseObject
	{
		Hashtable h = new Hashtable();

		public PlotOptionsLineSonificationTracksMappingNoteDuration()
		{
			MapFunction = MapFunction_DefaultValue = PlotOptionsLineSonificationTracksMappingNoteDurationMapFunction.Linear;
			MapTo = MapTo_DefaultValue = "";
			Max = Max_DefaultValue = null;
			Min = Min_DefaultValue = null;
			Value = Value_DefaultValue = null;
			Within = Within_DefaultValue = PlotOptionsLineSonificationTracksMappingNoteDurationWithin.Chart;
		...
		/// </summary>
		public PlotOptionsLineSonificationTracksMappingNoteDurationMapFunction MapFunction { get; set; }
		private PlotOptionsLineSonificationTracksMappingNoteDurationMapFunction MapFunction_DefaultValue { get; set; }
		...
		/// </summary>
		public PlotOptionsLineSonificationTracksMappingNoteDurationWithin Within { get; set; }
		private PlotOptionsLineSonificationTracksMappingNoteDurationWithin Within_DefaultValue { get; set; }
