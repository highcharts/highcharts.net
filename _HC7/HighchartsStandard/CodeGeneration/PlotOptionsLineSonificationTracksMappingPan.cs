...
{
	public partial class PlotOptionsLineSonificationTracksMappingPan  : BaseObject
	{
		Hashtable h = new Hashtable();

		public PlotOptionsLineSonificationTracksMappingPan()
		{
			MapFunction = MapFunction_DefaultValue = PlotOptionsLineSonificationTracksMappingPanMapFunction.Linear;
			MapTo = MapTo_DefaultValue = "";
			Max = Max_DefaultValue = null;
			Min = Min_DefaultValue = null;
			Value = Value_DefaultValue = null;
			Within = Within_DefaultValue = PlotOptionsLineSonificationTracksMappingPanWithin.Chart;
		...
		/// </summary>
		public PlotOptionsLineSonificationTracksMappingPanMapFunction MapFunction { get; set; }
		private PlotOptionsLineSonificationTracksMappingPanMapFunction MapFunction_DefaultValue { get; set; }
		...
		/// </summary>
		public PlotOptionsLineSonificationTracksMappingPanWithin Within { get; set; }
		private PlotOptionsLineSonificationTracksMappingPanWithin Within_DefaultValue { get; set; }
