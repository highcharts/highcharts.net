...
{
	public partial class PlotOptionsLineSonificationTracksMappingPitch  : BaseObject
	{
		Hashtable h = new Hashtable();

		public PlotOptionsLineSonificationTracksMappingPitch()
		{
			MapFunction = MapFunction_DefaultValue = PlotOptionsLineSonificationTracksMappingPitchMapFunction.Linear;
		...
		/// </summary>
		public PlotOptionsLineSonificationTracksMappingPitchMapFunction MapFunction { get; set; }
		private PlotOptionsLineSonificationTracksMappingPitchMapFunction MapFunction_DefaultValue { get; set; }
