...
{
	public partial class PlotOptionsLineSonificationTracksMappingVolume  : BaseObject
	{
		Hashtable h = new Hashtable();

		public PlotOptionsLineSonificationTracksMappingVolume()
		{
			MapFunction = MapFunction_DefaultValue = PlotOptionsLineSonificationTracksMappingVolumeMapFunction.Linear;
			MapTo = MapTo_DefaultValue = "";
			Max = Max_DefaultValue = null;
			Min = Min_DefaultValue = null;
			Value = Value_DefaultValue = null;
			Within = Within_DefaultValue = PlotOptionsLineSonificationTracksMappingVolumeWithin.Chart;
		...
		/// </summary>
		public PlotOptionsLineSonificationTracksMappingVolumeMapFunction MapFunction { get; set; }
		private PlotOptionsLineSonificationTracksMappingVolumeMapFunction MapFunction_DefaultValue { get; set; }
		...
		/// </summary>
		public PlotOptionsLineSonificationTracksMappingVolumeWithin Within { get; set; }
		private PlotOptionsLineSonificationTracksMappingVolumeWithin Within_DefaultValue { get; set; }
