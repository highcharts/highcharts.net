...
{
	public partial class PlotOptionsLineSonificationTracksPointGrouping  : BaseObject
	{
		Hashtable h = new Hashtable();

		public PlotOptionsLineSonificationTracksPointGrouping()
		{
		...
		/// </summary>
		public PlotOptionsLineSonificationTracksPointGroupingAlgorithm Algorithm { get; set; }
		private PlotOptionsLineSonificationTracksPointGroupingAlgorithm Algorithm_DefaultValue { get; set; }
		...
		internal override Hashtable ToHashtable(Highcharts highcharts)
		{
			...
			if (Algorithm != PlotOptionsLineSonificationTracksPointGroupingAlgorithm.Null) h.Add("algorithm", highcharts.FirstCharacterToLower(Algorithm.ToString()));
