...
{
	public partial class PlotOptionsLollipopLowMarker  : BaseObject
	{
		Hashtable h = new Hashtable();

		public PlotOptionsLollipopLowMarker()
		{
			...
			States = States_DefaultValue = new PlotOptionsLollipopLowMarkerStates();
		...
		/// </summary>
		public PlotOptionsLollipopLowMarkerStates States { get; set; }
		private PlotOptionsLollipopLowMarkerStates States_DefaultValue { get; set; }
