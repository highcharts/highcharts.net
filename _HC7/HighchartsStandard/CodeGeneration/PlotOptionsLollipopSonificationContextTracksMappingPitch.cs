...
{
	public partial class PlotOptionsLollipopSonificationContextTracksMappingPitch  : BaseObject
	{
		Hashtable h = new Hashtable();

		public PlotOptionsLollipopSonificationContextTracksMappingPitch()
		{
			MapFunction = MapFunction_DefaultValue = PlotOptionsLollipopSonificationContextTracksMappingPitchMapFunction.Linear;
		...
		/// </summary>
		public PlotOptionsLollipopSonificationContextTracksMappingPitchMapFunction MapFunction { get; set; }
		private PlotOptionsLollipopSonificationContextTracksMappingPitchMapFunction MapFunction_DefaultValue { get; set; }
