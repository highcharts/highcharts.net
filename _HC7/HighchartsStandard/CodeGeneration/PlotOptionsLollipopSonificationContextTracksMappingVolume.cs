...
{
	public partial class PlotOptionsLollipopSonificationContextTracksMappingVolume  : BaseObject
	{
		Hashtable h = new Hashtable();

		public PlotOptionsLollipopSonificationContextTracksMappingVolume()
		{
			MapFunction = MapFunction_DefaultValue = PlotOptionsLollipopSonificationContextTracksMappingVolumeMapFunction.Linear;
			MapTo = MapTo_DefaultValue = "";
			Max = Max_DefaultValue = null;
			Min = Min_DefaultValue = null;
			Value = Value_DefaultValue = null;
			Within = Within_DefaultValue = PlotOptionsLollipopSonificationContextTracksMappingVolumeWithin.Chart;
		...
		/// </summary>
		public PlotOptionsLollipopSonificationContextTracksMappingVolumeMapFunction MapFunction { get; set; }
		private PlotOptionsLollipopSonificationContextTracksMappingVolumeMapFunction MapFunction_DefaultValue { get; set; }
		...
		/// </summary>
		public PlotOptionsLollipopSonificationContextTracksMappingVolumeWithin Within { get; set; }
		private PlotOptionsLollipopSonificationContextTracksMappingVolumeWithin Within_DefaultValue { get; set; }
