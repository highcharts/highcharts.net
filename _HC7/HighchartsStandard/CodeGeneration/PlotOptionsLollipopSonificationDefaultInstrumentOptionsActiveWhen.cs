...
{
	public partial class PlotOptionsLollipopSonificationDefaultInstrumentOptionsActiveWhen  : BaseObject
	{
		Hashtable h = new Hashtable();

		public PlotOptionsLollipopSonificationDefaultInstrumentOptionsActiveWhen()
		{
