...
{
	public partial class PlotOptionsLollipopSonificationDefaultSpeechOptionsMappingNoteDuration  : BaseObject
	{
		Hashtable h = new Hashtable();

		public PlotOptionsLollipopSonificationDefaultSpeechOptionsMappingNoteDuration()
		{
			MapFunction = MapFunction_DefaultValue = PlotOptionsLollipopSonificationDefaultSpeechOptionsMappingNoteDurationMapFunction.Linear;
			MapTo = MapTo_DefaultValue = "";
			Max = Max_DefaultValue = null;
			Min = Min_DefaultValue = null;
			Value = Value_DefaultValue = null;
			Within = Within_DefaultValue = PlotOptionsLollipopSonificationDefaultSpeechOptionsMappingNoteDurationWithin.Chart;
		...
		/// </summary>
		public PlotOptionsLollipopSonificationDefaultSpeechOptionsMappingNoteDurationMapFunction MapFunction { get; set; }
		private PlotOptionsLollipopSonificationDefaultSpeechOptionsMappingNoteDurationMapFunction MapFunction_DefaultValue { get; set; }
		...
		/// </summary>
		public PlotOptionsLollipopSonificationDefaultSpeechOptionsMappingNoteDurationWithin Within { get; set; }
		private PlotOptionsLollipopSonificationDefaultSpeechOptionsMappingNoteDurationWithin Within_DefaultValue { get; set; }
