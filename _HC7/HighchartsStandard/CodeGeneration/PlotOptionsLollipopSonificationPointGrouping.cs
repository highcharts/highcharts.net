...
{
	public partial class PlotOptionsLollipopSonificationPointGrouping  : BaseObject
	{
		Hashtable h = new Hashtable();

		public PlotOptionsLollipopSonificationPointGrouping()
		{
		...
		/// </summary>
		public PlotOptionsLollipopSonificationPointGroupingAlgorithm Algorithm { get; set; }
		private PlotOptionsLollipopSonificationPointGroupingAlgorithm Algorithm_DefaultValue { get; set; }
		...
		internal override Hashtable ToHashtable(Highcharts highcharts)
		{
			...
			if (Algorithm != PlotOptionsLollipopSonificationPointGroupingAlgorithm.Null) h.Add("algorithm", highcharts.FirstCharacterToLower(Algorithm.ToString()));
