...
{
	public partial class PlotOptionsLollipopSonificationTracksMappingFrequency  : BaseObject
	{
		Hashtable h = new Hashtable();

		public PlotOptionsLollipopSonificationTracksMappingFrequency()
		{
			MapFunction = MapFunction_DefaultValue = PlotOptionsLollipopSonificationTracksMappingFrequencyMapFunction.Linear;
			MapTo = MapTo_DefaultValue = "";
			Max = Max_DefaultValue = null;
			Min = Min_DefaultValue = null;
			Value = Value_DefaultValue = null;
			Within = Within_DefaultValue = PlotOptionsLollipopSonificationTracksMappingFrequencyWithin.Chart;
		...
		/// </summary>
		public PlotOptionsLollipopSonificationTracksMappingFrequencyMapFunction MapFunction { get; set; }
		private PlotOptionsLollipopSonificationTracksMappingFrequencyMapFunction MapFunction_DefaultValue { get; set; }
		...
		/// </summary>
		public PlotOptionsLollipopSonificationTracksMappingFrequencyWithin Within { get; set; }
		private PlotOptionsLollipopSonificationTracksMappingFrequencyWithin Within_DefaultValue { get; set; }
