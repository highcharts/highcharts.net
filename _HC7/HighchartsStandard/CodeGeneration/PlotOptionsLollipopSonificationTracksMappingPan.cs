...
{
	public partial class PlotOptionsLollipopSonificationTracksMappingPan  : BaseObject
	{
		Hashtable h = new Hashtable();

		public PlotOptionsLollipopSonificationTracksMappingPan()
		{
			MapFunction = MapFunction_DefaultValue = PlotOptionsLollipopSonificationTracksMappingPanMapFunction.Linear;
			MapTo = MapTo_DefaultValue = "";
			Max = Max_DefaultValue = null;
			Min = Min_DefaultValue = null;
			Value = Value_DefaultValue = null;
			Within = Within_DefaultValue = PlotOptionsLollipopSonificationTracksMappingPanWithin.Chart;
		...
		/// </summary>
		public PlotOptionsLollipopSonificationTracksMappingPanMapFunction MapFunction { get; set; }
		private PlotOptionsLollipopSonificationTracksMappingPanMapFunction MapFunction_DefaultValue { get; set; }
		...
		/// </summary>
		public PlotOptionsLollipopSonificationTracksMappingPanWithin Within { get; set; }
		private PlotOptionsLollipopSonificationTracksMappingPanWithin Within_DefaultValue { get; set; }
