...
{
	public partial class PlotOptionsLollipopSonificationTracksMappingPitch  : BaseObject
	{
		Hashtable h = new Hashtable();

		public PlotOptionsLollipopSonificationTracksMappingPitch()
		{
			MapFunction = MapFunction_DefaultValue = PlotOptionsLollipopSonificationTracksMappingPitchMapFunction.Linear;
		...
		/// </summary>
		public PlotOptionsLollipopSonificationTracksMappingPitchMapFunction MapFunction { get; set; }
		private PlotOptionsLollipopSonificationTracksMappingPitchMapFunction MapFunction_DefaultValue { get; set; }
