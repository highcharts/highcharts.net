...
{
	public partial class PlotOptionsLollipopSonificationTracksMappingTime  : BaseObject
	{
		Hashtable h = new Hashtable();

		public PlotOptionsLollipopSonificationTracksMappingTime()
		{
			MapFunction = MapFunction_DefaultValue = PlotOptionsLollipopSonificationTracksMappingTimeMapFunction.Linear;
			MapTo = MapTo_DefaultValue = "";
			Max = Max_DefaultValue = null;
			Min = Min_DefaultValue = null;
			Value = Value_DefaultValue = null;
			Within = Within_DefaultValue = PlotOptionsLollipopSonificationTracksMappingTimeWithin.Chart;
		...
		/// </summary>
		public PlotOptionsLollipopSonificationTracksMappingTimeMapFunction MapFunction { get; set; }
		private PlotOptionsLollipopSonificationTracksMappingTimeMapFunction MapFunction_DefaultValue { get; set; }
		...
		/// </summary>
		public PlotOptionsLollipopSonificationTracksMappingTimeWithin Within { get; set; }
		private PlotOptionsLollipopSonificationTracksMappingTimeWithin Within_DefaultValue { get; set; }
