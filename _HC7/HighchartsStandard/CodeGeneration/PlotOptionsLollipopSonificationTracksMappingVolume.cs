...
{
	public partial class PlotOptionsLollipopSonificationTracksMappingVolume  : BaseObject
	{
		Hashtable h = new Hashtable();

		public PlotOptionsLollipopSonificationTracksMappingVolume()
		{
			MapFunction = MapFunction_DefaultValue = PlotOptionsLollipopSonificationTracksMappingVolumeMapFunction.Linear;
			MapTo = MapTo_DefaultValue = "";
			Max = Max_DefaultValue = null;
			Min = Min_DefaultValue = null;
			Value = Value_DefaultValue = null;
			Within = Within_DefaultValue = PlotOptionsLollipopSonificationTracksMappingVolumeWithin.Chart;
		...
		/// </summary>
		public PlotOptionsLollipopSonificationTracksMappingVolumeMapFunction MapFunction { get; set; }
		private PlotOptionsLollipopSonificationTracksMappingVolumeMapFunction MapFunction_DefaultValue { get; set; }
		...
		/// </summary>
		public PlotOptionsLollipopSonificationTracksMappingVolumeWithin Within { get; set; }
		private PlotOptionsLollipopSonificationTracksMappingVolumeWithin Within_DefaultValue { get; set; }
