...
{
	public partial class PlotOptionsLollipopSonificationTracksPointGrouping  : BaseObject
	{
		Hashtable h = new Hashtable();

		public PlotOptionsLollipopSonificationTracksPointGrouping()
		{
		...
		/// </summary>
		public PlotOptionsLollipopSonificationTracksPointGroupingAlgorithm Algorithm { get; set; }
		private PlotOptionsLollipopSonificationTracksPointGroupingAlgorithm Algorithm_DefaultValue { get; set; }
		...
		internal override Hashtable ToHashtable(Highcharts highcharts)
		{
			...
			if (Algorithm != PlotOptionsLollipopSonificationTracksPointGroupingAlgorithm.Null) h.Add("algorithm", highcharts.FirstCharacterToLower(Algorithm.ToString()));
