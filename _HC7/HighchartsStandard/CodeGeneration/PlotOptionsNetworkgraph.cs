...
namespace Highsoft.Web.Mvc.Charts
{
	public partial class PlotOptionsNetworkgraph  : BaseObject
	{
		...
		public PlotOptionsNetworkgraph()
		{
			...
			Sonification = Sonification_DefaultValue = new PlotOptionsNetworkgraphSonification();
		...
		private PlotOptionsNetworkgraphLegendSymbol LegendSymbol_DefaultValue { get; set; }
		...
		private PlotOptionsNetworkgraphSonification Sonification_DefaultValue { get; set; }
