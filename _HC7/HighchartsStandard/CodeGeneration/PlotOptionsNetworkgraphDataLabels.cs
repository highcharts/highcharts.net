...
namespace Highsoft.Web.Mvc.Charts
{
	public partial class PlotOptionsNetworkgraphDataLabels  : BaseObject
	{
		...
		{
			Align = Align_DefaultValue = PlotOptionsNetworkgraphDataLabelsAlign.Left;
			...
			Overflow = Overflow_DefaultValue = PlotOptionsNetworkgraphDataLabelsOverflow.Justify;
			...
			VerticalAlign = VerticalAlign_DefaultValue = PlotOptionsNetworkgraphDataLabelsVerticalAlign.Top;
		...
		internal override Hashtable ToHashtable()
		{
			...
			if (Formatter != Formatter_DefaultValue) { h.Add("formatter",Formatter); Highcharts.AddFunction("PlotOptionsNetworkgraphDataLabelsFormatter.formatter", Formatter); }  
