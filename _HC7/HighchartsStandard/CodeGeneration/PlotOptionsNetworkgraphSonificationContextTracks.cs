...
{
	public partial class PlotOptionsNetworkgraphSonificationContextTracks  : BaseObject
	{
		Hashtable h = new Hashtable();

		public PlotOptionsNetworkgraphSonificationContextTracks()
		{
			ActiveWhen = ActiveWhen_DefaultValue = new PlotOptionsNetworkgraphSonificationContextTracksActiveWhen();
			Instrument = Instrument_DefaultValue = null;
			InstrumentString = InstrumentString_DefaultValue = "null";
			Mapping = Mapping_DefaultValue = new PlotOptionsNetworkgraphSonificationContextTracksMapping();
			MidiName = MidiName_DefaultValue = "";
			PointGrouping = PointGrouping_DefaultValue = new PlotOptionsNetworkgraphSonificationContextTracksPointGrouping();
			...
			Type = Type_DefaultValue = PlotOptionsNetworkgraphSonificationContextTracksType.Instrument;
			ValueInterval = ValueInterval_DefaultValue = null;
			ValueMapFunction = ValueMapFunction_DefaultValue = PlotOptionsNetworkgraphSonificationContextTracksValueMapFunction.Linear;
		...
		/// </summary>
		public PlotOptionsNetworkgraphSonificationContextTracksActiveWhen ActiveWhen { get; set; }
		private PlotOptionsNetworkgraphSonificationContextTracksActiveWhen ActiveWhen_DefaultValue { get; set; }
		...
		/// </summary>
		public PlotOptionsNetworkgraphSonificationContextTracksMapping Mapping { get; set; }
		private PlotOptionsNetworkgraphSonificationContextTracksMapping Mapping_DefaultValue { get; set; }
		...
		/// </summary>
		public PlotOptionsNetworkgraphSonificationContextTracksPointGrouping PointGrouping { get; set; }
		private PlotOptionsNetworkgraphSonificationContextTracksPointGrouping PointGrouping_DefaultValue { get; set; }
		...
		/// </summary>
		public PlotOptionsNetworkgraphSonificationContextTracksType Type { get; set; }
		private PlotOptionsNetworkgraphSonificationContextTracksType Type_DefaultValue { get; set; }
		...
		/// </summary>
		public PlotOptionsNetworkgraphSonificationContextTracksValueMapFunction ValueMapFunction { get; set; }
		private PlotOptionsNetworkgraphSonificationContextTracksValueMapFunction ValueMapFunction_DefaultValue { get; set; }
