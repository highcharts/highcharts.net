...
{
	public partial class PlotOptionsNetworkgraphSonificationContextTracksActiveWhen  : BaseObject
	{
		Hashtable h = new Hashtable();

		public PlotOptionsNetworkgraphSonificationContextTracksActiveWhen()
		{
