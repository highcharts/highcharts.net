...
{
	public partial class PlotOptionsNetworkgraphSonificationPointGrouping  : BaseObject
	{
		Hashtable h = new Hashtable();

		public PlotOptionsNetworkgraphSonificationPointGrouping()
		{
		...
		/// </summary>
		public PlotOptionsNetworkgraphSonificationPointGroupingAlgorithm Algorithm { get; set; }
		private PlotOptionsNetworkgraphSonificationPointGroupingAlgorithm Algorithm_DefaultValue { get; set; }
		...
		internal override Hashtable ToHashtable(Highcharts highcharts)
		{
			...
			if (Algorithm != PlotOptionsNetworkgraphSonificationPointGroupingAlgorithm.Null) h.Add("algorithm", highcharts.FirstCharacterToLower(Algorithm.ToString()));
