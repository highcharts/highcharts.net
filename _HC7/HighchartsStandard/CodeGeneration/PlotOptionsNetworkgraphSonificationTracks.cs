...
{
	public partial class PlotOptionsNetworkgraphSonificationTracks  : BaseObject
	{
		Hashtable h = new Hashtable();

		public PlotOptionsNetworkgraphSonificationTracks()
		{
			ActiveWhen = ActiveWhen_DefaultValue = new PlotOptionsNetworkgraphSonificationTracksActiveWhen();
			Instrument = Instrument_DefaultValue = null;
			InstrumentString = InstrumentString_DefaultValue = "null";
			Mapping = Mapping_DefaultValue = new PlotOptionsNetworkgraphSonificationTracksMapping();
			MidiName = MidiName_DefaultValue = "";
			PointGrouping = PointGrouping_DefaultValue = new PlotOptionsNetworkgraphSonificationTracksPointGrouping();
			RoundToMusicalNotes = RoundToMusicalNotes_DefaultValue = true;
			ShowPlayMarker = ShowPlayMarker_DefaultValue = true;
			Type = Type_DefaultValue = PlotOptionsNetworkgraphSonificationTracksType.Instrument;
		...
		/// </summary>
		public PlotOptionsNetworkgraphSonificationTracksActiveWhen ActiveWhen { get; set; }
		private PlotOptionsNetworkgraphSonificationTracksActiveWhen ActiveWhen_DefaultValue { get; set; }
		...
		/// </summary>
		public PlotOptionsNetworkgraphSonificationTracksMapping Mapping { get; set; }
		private PlotOptionsNetworkgraphSonificationTracksMapping Mapping_DefaultValue { get; set; }
		...
		/// </summary>
		public PlotOptionsNetworkgraphSonificationTracksPointGrouping PointGrouping { get; set; }
		private PlotOptionsNetworkgraphSonificationTracksPointGrouping PointGrouping_DefaultValue { get; set; }
		...
		/// </summary>
		public PlotOptionsNetworkgraphSonificationTracksType Type { get; set; }
		private PlotOptionsNetworkgraphSonificationTracksType Type_DefaultValue { get; set; }
