...
{
	public partial class PlotOptionsNetworkgraphSonificationTracksPointGrouping  : BaseObject
	{
		Hashtable h = new Hashtable();

		public PlotOptionsNetworkgraphSonificationTracksPointGrouping()
		{
		...
		/// </summary>
		public PlotOptionsNetworkgraphSonificationTracksPointGroupingAlgorithm Algorithm { get; set; }
		private PlotOptionsNetworkgraphSonificationTracksPointGroupingAlgorithm Algorithm_DefaultValue { get; set; }
		...
		internal override Hashtable ToHashtable(Highcharts highcharts)
		{
			...
			if (Algorithm != PlotOptionsNetworkgraphSonificationTracksPointGroupingAlgorithm.Null) h.Add("algorithm", highcharts.FirstCharacterToLower(Algorithm.ToString()));
