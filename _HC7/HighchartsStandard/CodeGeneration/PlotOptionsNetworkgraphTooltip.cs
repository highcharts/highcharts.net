...
{
	public partial class PlotOptionsNetworkgraphTooltip  : BaseObject
	{
		public PlotOptionsNetworkgraphTooltip()
		{
			...
			HeaderShape = HeaderShape_DefaultValue = PlotOptionsNetworkgraphTooltipHeaderShape.Callout;
		...
		/// </summary>
		public PlotOptionsNetworkgraphTooltipHeaderShape HeaderShape { get; set; }
		private PlotOptionsNetworkgraphTooltipHeaderShape HeaderShape_DefaultValue { get; set; }
		...
		internal override Hashtable ToHashtable()
		{
			...
			if (NullFormatter != NullFormatter_DefaultValue) { h.Add("nullFormatter",NullFormatter); Highcharts.AddFunction("PlotOptionsNetworkgraphTooltipNullFormatter.nullFormatter", NullFormatter); }  
			if (Outside != Outside_DefaultValue) h.Add("outside",Outside);
			if (Padding != Padding_DefaultValue) h.Add("padding",Padding);
			if (PointFormat != PointFormat_DefaultValue) h.Add("pointFormat",PointFormat);
			if (PointFormatter != PointFormatter_DefaultValue) { h.Add("pointFormatter",PointFormatter); Highcharts.AddFunction("PlotOptionsNetworkgraphTooltipPointFormatter.pointFormatter", PointFormatter); }  
