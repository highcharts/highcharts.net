...
namespace Highsoft.Web.Mvc.Charts
{
	public partial class PlotOptionsOrganization  : BaseObject
	{
		...
		/// </summary>
		public PlotOptionsOrganizationDragDrop DragDrop { get; set; }
		private PlotOptionsOrganizationDragDrop DragDrop_DefaultValue { get; set; }
		...
		internal override Hashtable ToHashtable()
		{
			...
			if (PointDescriptionFormatter != PointDescriptionFormatter_DefaultValue) { h.Add("pointDescriptionFormatter",PointDescriptionFormatter); Highcharts.AddFunction("6d2f3456-dcba-416b-85bf-efaf9da9ce2e.pointDescriptionFormatter", PointDescriptionFormatter); }  
