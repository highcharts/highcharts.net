...
namespace Highsoft.Web.Mvc.Charts
{
	public partial class PlotOptionsOrganization  : BaseObject
	{
		...
		/// </summary>
		public PlotOptionsOrganizationLegendSymbol LegendSymbol { get; set; }
		private PlotOptionsOrganizationLegendSymbol LegendSymbol_DefaultValue { get; set; }
		...
		/// </summary>
		public PlotOptionsOrganizationLink Link { get; set; }
		private PlotOptionsOrganizationLink Link_DefaultValue { get; set; }
		...
		/// </summary>
		public PlotOptionsOrganizationLinkColorMode LinkColorMode { get; set; }
		private PlotOptionsOrganizationLinkColorMode LinkColorMode_DefaultValue { get; set; }
		...
		/// </summary>
		public PlotOptionsOrganizationNodeAlignment NodeAlignment { get; set; }
		private PlotOptionsOrganizationNodeAlignment NodeAlignment_DefaultValue { get; set; }
		...
		/// </summary>
		public PlotOptionsOrganizationSonification Sonification { get; set; }
		private PlotOptionsOrganizationSonification Sonification_DefaultValue { get; set; }
		...
		internal override Hashtable ToHashtable(Highcharts highcharts)
		{
			...
			if (Cursor != PlotOptionsOrganizationCursor.Null) h.Add("cursor", highcharts.FirstCharacterToLower(Cursor.ToString()));
			if (Custom != null) h.Add("custom",Custom);
			if (DashStyle != PlotOptionsOrganizationDashStyle.Null) h.Add("dashStyle", highcharts.FirstCharacterToLower(DashStyle.ToString()));
			...
			if (HangingSide != PlotOptionsOrganizationHangingSide.Null) h.Add("hangingSide", highcharts.FirstCharacterToLower(HangingSide.ToString()));
			...
			if (LegendSymbol != PlotOptionsOrganizationLegendSymbol.Null) h.Add("legendSymbol", highcharts.FirstCharacterToLower(LegendSymbol.ToString()));
			if (Levels != null) h.Add("levels",Levels.ToHashtable(highcharts));
			if (Link != null) h.Add("link",Link.ToHashtable(highcharts));
			if (LinkColorMode != PlotOptionsOrganizationLinkColorMode.Null) h.Add("linkColorMode", highcharts.FirstCharacterToLower(LinkColorMode.ToString()));
			...
			if (NodeAlignment != PlotOptionsOrganizationNodeAlignment.Null) h.Add("nodeAlignment", highcharts.FirstCharacterToLower(NodeAlignment.ToString()));
