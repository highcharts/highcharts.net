...
{
	public partial class PlotOptionsOrganizationDragDropDragHandle  : BaseObject
	{
		public PlotOptionsOrganizationDragDropDragHandle()
		{
		...
		internal override Hashtable ToHashtable()
		{
			...
			if (PathFormatter != PathFormatter_DefaultValue) { h.Add("pathFormatter",PathFormatter); Highcharts.AddFunction("PlotOptionsOrganizationDragDropDragHandlePathFormatter.pathFormatter", PathFormatter); }  
