...
{
	public partial class PlotOptionsOrganizationSonificationContextTracksActiveWhen  : BaseObject
	{
		Hashtable h = new Hashtable();

		public PlotOptionsOrganizationSonificationContextTracksActiveWhen()
		{
