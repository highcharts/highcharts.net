...
{
	public partial class PlotOptionsOrganizationSonificationContextTracksMapping  : BaseObject
	{
		Hashtable h = new Hashtable();

		public PlotOptionsOrganizationSonificationContextTracksMapping()
		{
			Frequency = Frequency_DefaultValue = new PlotOptionsOrganizationSonificationContextTracksMappingFrequency();
			GapBetweenNotes = GapBetweenNotes_DefaultValue = new PlotOptionsOrganizationSonificationContextTracksMappingGapBetweenNotes();
			Highpass = Highpass_DefaultValue = new PlotOptionsOrganizationSonificationContextTracksMappingHighpass();
			Lowpass = Lowpass_DefaultValue = new PlotOptionsOrganizationSonificationContextTracksMappingLowpass();
			NoteDuration = NoteDuration_DefaultValue = new PlotOptionsOrganizationSonificationContextTracksMappingNoteDuration();
			Pan = Pan_DefaultValue = new PlotOptionsOrganizationSonificationContextTracksMappingPan();
			Pitch = Pitch_DefaultValue = new PlotOptionsOrganizationSonificationContextTracksMappingPitch();
			PitchString = PitchString_DefaultValue = "null";
			PitchNumber = PitchNumber_DefaultValue = null;
			PlayDelay = PlayDelay_DefaultValue = new PlotOptionsOrganizationSonificationContextTracksMappingPlayDelay();
			Time = Time_DefaultValue = new PlotOptionsOrganizationSonificationContextTracksMappingTime();
			TimeString = TimeString_DefaultValue = "null";
			TimeNumber = TimeNumber_DefaultValue = null;
			Tremolo = Tremolo_DefaultValue = new PlotOptionsOrganizationSonificationContextTracksMappingTremolo();
			Volume = Volume_DefaultValue = new PlotOptionsOrganizationSonificationContextTracksMappingVolume();
		...
		/// </summary>
		public PlotOptionsOrganizationSonificationContextTracksMappingFrequency Frequency { get; set; }
		private PlotOptionsOrganizationSonificationContextTracksMappingFrequency Frequency_DefaultValue { get; set; }
		...
		/// </summary>
		public PlotOptionsOrganizationSonificationContextTracksMappingGapBetweenNotes GapBetweenNotes { get; set; }
		private PlotOptionsOrganizationSonificationContextTracksMappingGapBetweenNotes GapBetweenNotes_DefaultValue { get; set; }
		...
		/// </summary>
		public PlotOptionsOrganizationSonificationContextTracksMappingHighpass Highpass { get; set; }
		private PlotOptionsOrganizationSonificationContextTracksMappingHighpass Highpass_DefaultValue { get; set; }
		...
		/// </summary>
		public PlotOptionsOrganizationSonificationContextTracksMappingLowpass Lowpass { get; set; }
		private PlotOptionsOrganizationSonificationContextTracksMappingLowpass Lowpass_DefaultValue { get; set; }
		...
		/// </summary>
		public PlotOptionsOrganizationSonificationContextTracksMappingNoteDuration NoteDuration { get; set; }
		private PlotOptionsOrganizationSonificationContextTracksMappingNoteDuration NoteDuration_DefaultValue { get; set; }
		...
		/// </summary>
		public PlotOptionsOrganizationSonificationContextTracksMappingPan Pan { get; set; }
		private PlotOptionsOrganizationSonificationContextTracksMappingPan Pan_DefaultValue { get; set; }
		...
		/// </summary>
		public PlotOptionsOrganizationSonificationContextTracksMappingPitch Pitch { get; set; }
		private PlotOptionsOrganizationSonificationContextTracksMappingPitch Pitch_DefaultValue { get; set; }
		...
		/// </summary>
		public PlotOptionsOrganizationSonificationContextTracksMappingPlayDelay PlayDelay { get; set; }
		private PlotOptionsOrganizationSonificationContextTracksMappingPlayDelay PlayDelay_DefaultValue { get; set; }
		...
		/// </summary>
		public PlotOptionsOrganizationSonificationContextTracksMappingTime Time { get; set; }
		private PlotOptionsOrganizationSonificationContextTracksMappingTime Time_DefaultValue { get; set; }
		...
		/// </summary>
		public PlotOptionsOrganizationSonificationContextTracksMappingTremolo Tremolo { get; set; }
		private PlotOptionsOrganizationSonificationContextTracksMappingTremolo Tremolo_DefaultValue { get; set; }
		 

		/// <summary>
		/// The volume of notes, from 0 to 1.
		/// </summary>
		public PlotOptionsOrganizationSonificationContextTracksMappingVolume Volume { get; set; }
		private PlotOptionsOrganizationSonificationContextTracksMappingVolume Volume_DefaultValue { get; set; }
