...
{
	public partial class PlotOptionsOrganizationSonificationDefaultInstrumentOptionsMappingFrequency  : BaseObject
	{
		Hashtable h = new Hashtable();

		public PlotOptionsOrganizationSonificationDefaultInstrumentOptionsMappingFrequency()
		{
			MapFunction = MapFunction_DefaultValue = PlotOptionsOrganizationSonificationDefaultInstrumentOptionsMappingFrequencyMapFunction.Linear;
			MapTo = MapTo_DefaultValue = "";
			Max = Max_DefaultValue = null;
			Min = Min_DefaultValue = null;
			Value = Value_DefaultValue = null;
			Within = Within_DefaultValue = PlotOptionsOrganizationSonificationDefaultInstrumentOptionsMappingFrequencyWithin.Chart;
		...
		/// </summary>
		public PlotOptionsOrganizationSonificationDefaultInstrumentOptionsMappingFrequencyMapFunction MapFunction { get; set; }
		private PlotOptionsOrganizationSonificationDefaultInstrumentOptionsMappingFrequencyMapFunction MapFunction_DefaultValue { get; set; }
		...
		/// </summary>
		public PlotOptionsOrganizationSonificationDefaultInstrumentOptionsMappingFrequencyWithin Within { get; set; }
		private PlotOptionsOrganizationSonificationDefaultInstrumentOptionsMappingFrequencyWithin Within_DefaultValue { get; set; }
