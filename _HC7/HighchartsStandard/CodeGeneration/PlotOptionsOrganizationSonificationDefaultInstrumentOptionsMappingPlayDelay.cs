...
{
	public partial class PlotOptionsOrganizationSonificationDefaultInstrumentOptionsMappingPlayDelay  : BaseObject
	{
		Hashtable h = new Hashtable();

		public PlotOptionsOrganizationSonificationDefaultInstrumentOptionsMappingPlayDelay()
		{
			MapFunction = MapFunction_DefaultValue = PlotOptionsOrganizationSonificationDefaultInstrumentOptionsMappingPlayDelayMapFunction.Linear;
			MapTo = MapTo_DefaultValue = "";
			Max = Max_DefaultValue = null;
			Min = Min_DefaultValue = null;
			Value = Value_DefaultValue = null;
			Within = Within_DefaultValue = PlotOptionsOrganizationSonificationDefaultInstrumentOptionsMappingPlayDelayWithin.Chart;
		...
		/// </summary>
		public PlotOptionsOrganizationSonificationDefaultInstrumentOptionsMappingPlayDelayMapFunction MapFunction { get; set; }
		private PlotOptionsOrganizationSonificationDefaultInstrumentOptionsMappingPlayDelayMapFunction MapFunction_DefaultValue { get; set; }
		...
		/// </summary>
		public PlotOptionsOrganizationSonificationDefaultInstrumentOptionsMappingPlayDelayWithin Within { get; set; }
		private PlotOptionsOrganizationSonificationDefaultInstrumentOptionsMappingPlayDelayWithin Within_DefaultValue { get; set; }
