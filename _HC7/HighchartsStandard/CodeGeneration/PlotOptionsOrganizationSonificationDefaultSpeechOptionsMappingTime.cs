...
{
	public partial class PlotOptionsOrganizationSonificationDefaultSpeechOptionsMappingTime  : BaseObject
	{
		Hashtable h = new Hashtable();

		public PlotOptionsOrganizationSonificationDefaultSpeechOptionsMappingTime()
		{
			MapFunction = MapFunction_DefaultValue = PlotOptionsOrganizationSonificationDefaultSpeechOptionsMappingTimeMapFunction.Linear;
			MapTo = MapTo_DefaultValue = "";
			Max = Max_DefaultValue = null;
			Min = Min_DefaultValue = null;
			Value = Value_DefaultValue = null;
			Within = Within_DefaultValue = PlotOptionsOrganizationSonificationDefaultSpeechOptionsMappingTimeWithin.Chart;
		...
		/// </summary>
		public PlotOptionsOrganizationSonificationDefaultSpeechOptionsMappingTimeMapFunction MapFunction { get; set; }
		private PlotOptionsOrganizationSonificationDefaultSpeechOptionsMappingTimeMapFunction MapFunction_DefaultValue { get; set; }
		...
		/// </summary>
		public PlotOptionsOrganizationSonificationDefaultSpeechOptionsMappingTimeWithin Within { get; set; }
		private PlotOptionsOrganizationSonificationDefaultSpeechOptionsMappingTimeWithin Within_DefaultValue { get; set; }
