...
{
	public partial class PlotOptionsOrganizationSonificationPointGrouping  : BaseObject
	{
		Hashtable h = new Hashtable();

		public PlotOptionsOrganizationSonificationPointGrouping()
		{
		...
		/// </summary>
		public PlotOptionsOrganizationSonificationPointGroupingAlgorithm Algorithm { get; set; }
		private PlotOptionsOrganizationSonificationPointGroupingAlgorithm Algorithm_DefaultValue { get; set; }
		...
		internal override Hashtable ToHashtable(Highcharts highcharts)
		{
			...
			if (Algorithm != PlotOptionsOrganizationSonificationPointGroupingAlgorithm.Null) h.Add("algorithm", highcharts.FirstCharacterToLower(Algorithm.ToString()));
