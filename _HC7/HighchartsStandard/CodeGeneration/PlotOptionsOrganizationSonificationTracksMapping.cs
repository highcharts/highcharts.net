...
{
	public partial class PlotOptionsOrganizationSonificationTracksMapping  : BaseObject
	{
		Hashtable h = new Hashtable();

		public PlotOptionsOrganizationSonificationTracksMapping()
		{
			Frequency = Frequency_DefaultValue = new PlotOptionsOrganizationSonificationTracksMappingFrequency();
			GapBetweenNotes = GapBetweenNotes_DefaultValue = new PlotOptionsOrganizationSonificationTracksMappingGapBetweenNotes();
			Highpass = Highpass_DefaultValue = new PlotOptionsOrganizationSonificationTracksMappingHighpass();
			Lowpass = Lowpass_DefaultValue = new PlotOptionsOrganizationSonificationTracksMappingLowpass();
			NoteDuration = NoteDuration_DefaultValue = new PlotOptionsOrganizationSonificationTracksMappingNoteDuration();
			Pan = Pan_DefaultValue = new PlotOptionsOrganizationSonificationTracksMappingPan();
			Pitch = Pitch_DefaultValue = new PlotOptionsOrganizationSonificationTracksMappingPitch();
			PitchString = PitchString_DefaultValue = "null";
			PitchNumber = PitchNumber_DefaultValue = null;
			PlayDelay = PlayDelay_DefaultValue = new PlotOptionsOrganizationSonificationTracksMappingPlayDelay();
			Time = Time_DefaultValue = new PlotOptionsOrganizationSonificationTracksMappingTime();
			TimeString = TimeString_DefaultValue = "null";
			TimeNumber = TimeNumber_DefaultValue = null;
			Tremolo = Tremolo_DefaultValue = new PlotOptionsOrganizationSonificationTracksMappingTremolo();
			Volume = Volume_DefaultValue = new PlotOptionsOrganizationSonificationTracksMappingVolume();
		...
		/// </summary>
		public PlotOptionsOrganizationSonificationTracksMappingFrequency Frequency { get; set; }
		private PlotOptionsOrganizationSonificationTracksMappingFrequency Frequency_DefaultValue { get; set; }
		...
		/// </summary>
		public PlotOptionsOrganizationSonificationTracksMappingGapBetweenNotes GapBetweenNotes { get; set; }
		private PlotOptionsOrganizationSonificationTracksMappingGapBetweenNotes GapBetweenNotes_DefaultValue { get; set; }
		...
		/// </summary>
		public PlotOptionsOrganizationSonificationTracksMappingHighpass Highpass { get; set; }
		private PlotOptionsOrganizationSonificationTracksMappingHighpass Highpass_DefaultValue { get; set; }
		...
		/// </summary>
		public PlotOptionsOrganizationSonificationTracksMappingLowpass Lowpass { get; set; }
		private PlotOptionsOrganizationSonificationTracksMappingLowpass Lowpass_DefaultValue { get; set; }
		...
		/// </summary>
		public PlotOptionsOrganizationSonificationTracksMappingNoteDuration NoteDuration { get; set; }
		private PlotOptionsOrganizationSonificationTracksMappingNoteDuration NoteDuration_DefaultValue { get; set; }
		...
		/// </summary>
		public PlotOptionsOrganizationSonificationTracksMappingPan Pan { get; set; }
		private PlotOptionsOrganizationSonificationTracksMappingPan Pan_DefaultValue { get; set; }
		...
		/// </summary>
		public PlotOptionsOrganizationSonificationTracksMappingPitch Pitch { get; set; }
		private PlotOptionsOrganizationSonificationTracksMappingPitch Pitch_DefaultValue { get; set; }
		...
		/// </summary>
		public PlotOptionsOrganizationSonificationTracksMappingPlayDelay PlayDelay { get; set; }
		private PlotOptionsOrganizationSonificationTracksMappingPlayDelay PlayDelay_DefaultValue { get; set; }
		...
		/// </summary>
		public PlotOptionsOrganizationSonificationTracksMappingTime Time { get; set; }
		private PlotOptionsOrganizationSonificationTracksMappingTime Time_DefaultValue { get; set; }
		...
		/// </summary>
		public PlotOptionsOrganizationSonificationTracksMappingTremolo Tremolo { get; set; }
		private PlotOptionsOrganizationSonificationTracksMappingTremolo Tremolo_DefaultValue { get; set; }
		 

		/// <summary>
		/// The volume of notes, from 0 to 1.
		/// </summary>
		public PlotOptionsOrganizationSonificationTracksMappingVolume Volume { get; set; }
		private PlotOptionsOrganizationSonificationTracksMappingVolume Volume_DefaultValue { get; set; }
