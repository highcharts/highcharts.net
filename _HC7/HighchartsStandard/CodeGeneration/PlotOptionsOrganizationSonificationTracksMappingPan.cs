...
{
	public partial class PlotOptionsOrganizationSonificationTracksMappingPan  : BaseObject
	{
		Hashtable h = new Hashtable();

		public PlotOptionsOrganizationSonificationTracksMappingPan()
		{
			MapFunction = MapFunction_DefaultValue = PlotOptionsOrganizationSonificationTracksMappingPanMapFunction.Linear;
			MapTo = MapTo_DefaultValue = "";
			Max = Max_DefaultValue = null;
			Min = Min_DefaultValue = null;
			Value = Value_DefaultValue = null;
			Within = Within_DefaultValue = PlotOptionsOrganizationSonificationTracksMappingPanWithin.Chart;
		...
		/// </summary>
		public PlotOptionsOrganizationSonificationTracksMappingPanMapFunction MapFunction { get; set; }
		private PlotOptionsOrganizationSonificationTracksMappingPanMapFunction MapFunction_DefaultValue { get; set; }
		...
		/// </summary>
		public PlotOptionsOrganizationSonificationTracksMappingPanWithin Within { get; set; }
		private PlotOptionsOrganizationSonificationTracksMappingPanWithin Within_DefaultValue { get; set; }
