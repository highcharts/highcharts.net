...
{
	public partial class PlotOptionsOrganizationSonificationTracksMappingPitch  : BaseObject
	{
		Hashtable h = new Hashtable();

		public PlotOptionsOrganizationSonificationTracksMappingPitch()
		{
			MapFunction = MapFunction_DefaultValue = PlotOptionsOrganizationSonificationTracksMappingPitchMapFunction.Linear;
		...
		/// </summary>
		public PlotOptionsOrganizationSonificationTracksMappingPitchMapFunction MapFunction { get; set; }
		private PlotOptionsOrganizationSonificationTracksMappingPitchMapFunction MapFunction_DefaultValue { get; set; }
