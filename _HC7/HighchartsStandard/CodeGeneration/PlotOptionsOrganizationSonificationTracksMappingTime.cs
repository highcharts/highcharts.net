...
{
	public partial class PlotOptionsOrganizationSonificationTracksMappingTime  : BaseObject
	{
		Hashtable h = new Hashtable();

		public PlotOptionsOrganizationSonificationTracksMappingTime()
		{
			MapFunction = MapFunction_DefaultValue = PlotOptionsOrganizationSonificationTracksMappingTimeMapFunction.Linear;
			MapTo = MapTo_DefaultValue = "";
			Max = Max_DefaultValue = null;
			Min = Min_DefaultValue = null;
			Value = Value_DefaultValue = null;
			Within = Within_DefaultValue = PlotOptionsOrganizationSonificationTracksMappingTimeWithin.Chart;
		...
		/// </summary>
		public PlotOptionsOrganizationSonificationTracksMappingTimeMapFunction MapFunction { get; set; }
		private PlotOptionsOrganizationSonificationTracksMappingTimeMapFunction MapFunction_DefaultValue { get; set; }
		...
		/// </summary>
		public PlotOptionsOrganizationSonificationTracksMappingTimeWithin Within { get; set; }
		private PlotOptionsOrganizationSonificationTracksMappingTimeWithin Within_DefaultValue { get; set; }
