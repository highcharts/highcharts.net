...
namespace Highsoft.Web.Mvc.Charts
{
	public partial class PlotOptionsPackedbubbleDataLabels  : BaseObject
	{
		...
		internal override Hashtable ToHashtable(Highcharts highcharts)
		{
			...
			if (Align != PlotOptionsPackedbubbleDataLabelsAlign.Null) h.Add("align", highcharts.FirstCharacterToLower(Align.ToString()));
			...
			if (Overflow != PlotOptionsPackedbubbleDataLabelsOverflow.Null) h.Add("overflow", highcharts.FirstCharacterToLower(Overflow.ToString()));
			if (Padding != null) h.Add("padding",Padding);
			if (ParentNodeFormat != null) h.Add("parentNodeFormat",ParentNodeFormat);
			if (ParentNodeFormatter != null) { h.Add("parentNodeFormatter",ParentNodeFormatter); highcharts.AddFunction("parentNodeFormatter", ParentNodeFormatter); }  
			if (ParentNodeTextPath != null) h.Add("parentNodeTextPath",ParentNodeTextPath.ToHashtable(highcharts));
			if (Position != PlotOptionsPackedbubbleDataLabelsPosition.Null) h.Add("position", highcharts.FirstCharacterToLower(Position.ToString()));
			...
			if (VerticalAlign != PlotOptionsPackedbubbleDataLabelsVerticalAlign.Null) h.Add("verticalAlign", highcharts.FirstCharacterToLower(VerticalAlign.ToString()));
			if (X != null) h.Add("x",X);
			if (Y != null) h.Add("y",Y);
