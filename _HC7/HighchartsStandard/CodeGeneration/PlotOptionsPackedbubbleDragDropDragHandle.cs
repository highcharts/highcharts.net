...
{
	public partial class PlotOptionsPackedbubbleDragDropDragHandle  : BaseObject
	{
		public PlotOptionsPackedbubbleDragDropDragHandle()
		{
		...
		internal override Hashtable ToHashtable()
		{
			...
			if (PathFormatter != PathFormatter_DefaultValue) { h.Add("pathFormatter",PathFormatter); Highcharts.AddFunction("PlotOptionsPackedbubbleDragDropDragHandlePathFormatter.pathFormatter", PathFormatter); }  
