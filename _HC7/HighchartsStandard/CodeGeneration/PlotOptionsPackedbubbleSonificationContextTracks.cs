...
{
	public partial class PlotOptionsPackedbubbleSonificationContextTracks  : BaseObject
	{
		Hashtable h = new Hashtable();

		public PlotOptionsPackedbubbleSonificationContextTracks()
		{
			ActiveWhen = ActiveWhen_DefaultValue = new PlotOptionsPackedbubbleSonificationContextTracksActiveWhen();
			Instrument = Instrument_DefaultValue = null;
			InstrumentString = InstrumentString_DefaultValue = "null";
			Mapping = Mapping_DefaultValue = new PlotOptionsPackedbubbleSonificationContextTracksMapping();
			MidiName = MidiName_DefaultValue = "";
			PointGrouping = PointGrouping_DefaultValue = new PlotOptionsPackedbubbleSonificationContextTracksPointGrouping();
			...
			Type = Type_DefaultValue = PlotOptionsPackedbubbleSonificationContextTracksType.Instrument;
			ValueInterval = ValueInterval_DefaultValue = null;
			ValueMapFunction = ValueMapFunction_DefaultValue = PlotOptionsPackedbubbleSonificationContextTracksValueMapFunction.Linear;
		...
		/// </summary>
		public PlotOptionsPackedbubbleSonificationContextTracksActiveWhen ActiveWhen { get; set; }
		private PlotOptionsPackedbubbleSonificationContextTracksActiveWhen ActiveWhen_DefaultValue { get; set; }
		...
		/// </summary>
		public PlotOptionsPackedbubbleSonificationContextTracksMapping Mapping { get; set; }
		private PlotOptionsPackedbubbleSonificationContextTracksMapping Mapping_DefaultValue { get; set; }
		...
		/// </summary>
		public PlotOptionsPackedbubbleSonificationContextTracksPointGrouping PointGrouping { get; set; }
		private PlotOptionsPackedbubbleSonificationContextTracksPointGrouping PointGrouping_DefaultValue { get; set; }
		...
		/// </summary>
		public PlotOptionsPackedbubbleSonificationContextTracksType Type { get; set; }
		private PlotOptionsPackedbubbleSonificationContextTracksType Type_DefaultValue { get; set; }
		...
		/// </summary>
		public PlotOptionsPackedbubbleSonificationContextTracksValueMapFunction ValueMapFunction { get; set; }
		private PlotOptionsPackedbubbleSonificationContextTracksValueMapFunction ValueMapFunction_DefaultValue { get; set; }
