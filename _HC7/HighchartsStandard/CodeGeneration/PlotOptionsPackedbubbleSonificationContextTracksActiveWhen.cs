...
{
	public partial class PlotOptionsPackedbubbleSonificationContextTracksActiveWhen  : BaseObject
	{
		Hashtable h = new Hashtable();

		public PlotOptionsPackedbubbleSonificationContextTracksActiveWhen()
		{
