...
{
	public partial class PlotOptionsPackedbubbleSonificationContextTracksMapping  : BaseObject
	{
		Hashtable h = new Hashtable();

		public PlotOptionsPackedbubbleSonificationContextTracksMapping()
		{
			Frequency = Frequency_DefaultValue = new PlotOptionsPackedbubbleSonificationContextTracksMappingFrequency();
			GapBetweenNotes = GapBetweenNotes_DefaultValue = new PlotOptionsPackedbubbleSonificationContextTracksMappingGapBetweenNotes();
			Highpass = Highpass_DefaultValue = new PlotOptionsPackedbubbleSonificationContextTracksMappingHighpass();
			Lowpass = Lowpass_DefaultValue = new PlotOptionsPackedbubbleSonificationContextTracksMappingLowpass();
			NoteDuration = NoteDuration_DefaultValue = new PlotOptionsPackedbubbleSonificationContextTracksMappingNoteDuration();
			Pan = Pan_DefaultValue = new PlotOptionsPackedbubbleSonificationContextTracksMappingPan();
			Pitch = Pitch_DefaultValue = new PlotOptionsPackedbubbleSonificationContextTracksMappingPitch();
			PitchString = PitchString_DefaultValue = "null";
			PitchNumber = PitchNumber_DefaultValue = null;
			PlayDelay = PlayDelay_DefaultValue = new PlotOptionsPackedbubbleSonificationContextTracksMappingPlayDelay();
			Time = Time_DefaultValue = new PlotOptionsPackedbubbleSonificationContextTracksMappingTime();
			TimeString = TimeString_DefaultValue = "null";
			TimeNumber = TimeNumber_DefaultValue = null;
			Tremolo = Tremolo_DefaultValue = new PlotOptionsPackedbubbleSonificationContextTracksMappingTremolo();
			Volume = Volume_DefaultValue = new PlotOptionsPackedbubbleSonificationContextTracksMappingVolume();
		...
		/// </summary>
		public PlotOptionsPackedbubbleSonificationContextTracksMappingFrequency Frequency { get; set; }
		private PlotOptionsPackedbubbleSonificationContextTracksMappingFrequency Frequency_DefaultValue { get; set; }
		...
		/// </summary>
		public PlotOptionsPackedbubbleSonificationContextTracksMappingGapBetweenNotes GapBetweenNotes { get; set; }
		private PlotOptionsPackedbubbleSonificationContextTracksMappingGapBetweenNotes GapBetweenNotes_DefaultValue { get; set; }
		...
		/// </summary>
		public PlotOptionsPackedbubbleSonificationContextTracksMappingHighpass Highpass { get; set; }
		private PlotOptionsPackedbubbleSonificationContextTracksMappingHighpass Highpass_DefaultValue { get; set; }
		...
		/// </summary>
		public PlotOptionsPackedbubbleSonificationContextTracksMappingLowpass Lowpass { get; set; }
		private PlotOptionsPackedbubbleSonificationContextTracksMappingLowpass Lowpass_DefaultValue { get; set; }
		...
		/// </summary>
		public PlotOptionsPackedbubbleSonificationContextTracksMappingNoteDuration NoteDuration { get; set; }
		private PlotOptionsPackedbubbleSonificationContextTracksMappingNoteDuration NoteDuration_DefaultValue { get; set; }
		...
		/// </summary>
		public PlotOptionsPackedbubbleSonificationContextTracksMappingPan Pan { get; set; }
		private PlotOptionsPackedbubbleSonificationContextTracksMappingPan Pan_DefaultValue { get; set; }
		...
		/// </summary>
		public PlotOptionsPackedbubbleSonificationContextTracksMappingPitch Pitch { get; set; }
		private PlotOptionsPackedbubbleSonificationContextTracksMappingPitch Pitch_DefaultValue { get; set; }
		...
		/// </summary>
		public PlotOptionsPackedbubbleSonificationContextTracksMappingPlayDelay PlayDelay { get; set; }
		private PlotOptionsPackedbubbleSonificationContextTracksMappingPlayDelay PlayDelay_DefaultValue { get; set; }
		...
		/// </summary>
		public PlotOptionsPackedbubbleSonificationContextTracksMappingTime Time { get; set; }
		private PlotOptionsPackedbubbleSonificationContextTracksMappingTime Time_DefaultValue { get; set; }
		...
		/// </summary>
		public PlotOptionsPackedbubbleSonificationContextTracksMappingTremolo Tremolo { get; set; }
		private PlotOptionsPackedbubbleSonificationContextTracksMappingTremolo Tremolo_DefaultValue { get; set; }
		 

		/// <summary>
		/// The volume of notes, from 0 to 1.
		/// </summary>
		public PlotOptionsPackedbubbleSonificationContextTracksMappingVolume Volume { get; set; }
		private PlotOptionsPackedbubbleSonificationContextTracksMappingVolume Volume_DefaultValue { get; set; }
