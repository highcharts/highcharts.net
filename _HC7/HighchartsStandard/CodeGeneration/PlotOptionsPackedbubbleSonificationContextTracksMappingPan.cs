...
{
	public partial class PlotOptionsPackedbubbleSonificationContextTracksMappingPan  : BaseObject
	{
		Hashtable h = new Hashtable();

		public PlotOptionsPackedbubbleSonificationContextTracksMappingPan()
		{
			MapFunction = MapFunction_DefaultValue = PlotOptionsPackedbubbleSonificationContextTracksMappingPanMapFunction.Linear;
			MapTo = MapTo_DefaultValue = "";
			Max = Max_DefaultValue = null;
			Min = Min_DefaultValue = null;
			Value = Value_DefaultValue = null;
			Within = Within_DefaultValue = PlotOptionsPackedbubbleSonificationContextTracksMappingPanWithin.Chart;
		...
		/// </summary>
		public PlotOptionsPackedbubbleSonificationContextTracksMappingPanMapFunction MapFunction { get; set; }
		private PlotOptionsPackedbubbleSonificationContextTracksMappingPanMapFunction MapFunction_DefaultValue { get; set; }
		...
		/// </summary>
		public PlotOptionsPackedbubbleSonificationContextTracksMappingPanWithin Within { get; set; }
		private PlotOptionsPackedbubbleSonificationContextTracksMappingPanWithin Within_DefaultValue { get; set; }
