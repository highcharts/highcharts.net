...
{
	public partial class PlotOptionsPackedbubbleSonificationContextTracksMappingVolume  : BaseObject
	{
		Hashtable h = new Hashtable();

		public PlotOptionsPackedbubbleSonificationContextTracksMappingVolume()
		{
			MapFunction = MapFunction_DefaultValue = PlotOptionsPackedbubbleSonificationContextTracksMappingVolumeMapFunction.Linear;
			MapTo = MapTo_DefaultValue = "";
			Max = Max_DefaultValue = null;
			Min = Min_DefaultValue = null;
			Value = Value_DefaultValue = null;
			Within = Within_DefaultValue = PlotOptionsPackedbubbleSonificationContextTracksMappingVolumeWithin.Chart;
		...
		/// </summary>
		public PlotOptionsPackedbubbleSonificationContextTracksMappingVolumeMapFunction MapFunction { get; set; }
		private PlotOptionsPackedbubbleSonificationContextTracksMappingVolumeMapFunction MapFunction_DefaultValue { get; set; }
		...
		/// </summary>
		public PlotOptionsPackedbubbleSonificationContextTracksMappingVolumeWithin Within { get; set; }
		private PlotOptionsPackedbubbleSonificationContextTracksMappingVolumeWithin Within_DefaultValue { get; set; }
