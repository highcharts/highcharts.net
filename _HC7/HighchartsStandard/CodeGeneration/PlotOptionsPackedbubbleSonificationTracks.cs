...
{
	public partial class PlotOptionsPackedbubbleSonificationTracks  : BaseObject
	{
		Hashtable h = new Hashtable();

		public PlotOptionsPackedbubbleSonificationTracks()
		{
			ActiveWhen = ActiveWhen_DefaultValue = new PlotOptionsPackedbubbleSonificationTracksActiveWhen();
			Instrument = Instrument_DefaultValue = null;
			InstrumentString = InstrumentString_DefaultValue = "null";
			Mapping = Mapping_DefaultValue = new PlotOptionsPackedbubbleSonificationTracksMapping();
			MidiName = MidiName_DefaultValue = "";
			PointGrouping = PointGrouping_DefaultValue = new PlotOptionsPackedbubbleSonificationTracksPointGrouping();
			RoundToMusicalNotes = RoundToMusicalNotes_DefaultValue = true;
			ShowPlayMarker = ShowPlayMarker_DefaultValue = true;
			Type = Type_DefaultValue = PlotOptionsPackedbubbleSonificationTracksType.Instrument;
		...
		/// </summary>
		public PlotOptionsPackedbubbleSonificationTracksActiveWhen ActiveWhen { get; set; }
		private PlotOptionsPackedbubbleSonificationTracksActiveWhen ActiveWhen_DefaultValue { get; set; }
		...
		/// </summary>
		public PlotOptionsPackedbubbleSonificationTracksMapping Mapping { get; set; }
		private PlotOptionsPackedbubbleSonificationTracksMapping Mapping_DefaultValue { get; set; }
		...
		/// </summary>
		public PlotOptionsPackedbubbleSonificationTracksPointGrouping PointGrouping { get; set; }
		private PlotOptionsPackedbubbleSonificationTracksPointGrouping PointGrouping_DefaultValue { get; set; }
		...
		/// </summary>
		public PlotOptionsPackedbubbleSonificationTracksType Type { get; set; }
		private PlotOptionsPackedbubbleSonificationTracksType Type_DefaultValue { get; set; }
