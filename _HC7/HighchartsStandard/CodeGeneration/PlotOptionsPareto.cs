...
namespace Highsoft.Web.Mvc.Charts
{
	public partial class PlotOptionsPareto  : BaseObject
	{
		...
		public PlotOptionsPareto()
		{
			...
			LegendSymbol = LegendSymbol_DefaultValue = PlotOptionsParetoLegendSymbol.Rectangle;
			...
			OnPoint = OnPoint_DefaultValue = new PlotOptionsParetoOnPoint();
			...
			Sonification = Sonification_DefaultValue = new PlotOptionsParetoSonification();
