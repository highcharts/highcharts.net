...
{
	public partial class PlotOptionsParetoDragDrop  : BaseObject
	{
		public PlotOptionsParetoDragDrop()
		{
			DraggableX = DraggableX_DefaultValue = null;
			DraggableY = DraggableY_DefaultValue = null;
			DragHandle = DragHandle_DefaultValue = new PlotOptionsParetoDragDropDragHandle();
			...
			GuideBox = GuideBox_DefaultValue = new PlotOptionsParetoDragDropGuideBox();
		...
		/// </summary>
		public PlotOptionsParetoDragDropDragHandle DragHandle { get; set; }
		private PlotOptionsParetoDragDropDragHandle DragHandle_DefaultValue { get; set; }
		...
		/// </summary>
		public PlotOptionsParetoDragDropGuideBox GuideBox { get; set; }
		private PlotOptionsParetoDragDropGuideBox GuideBox_DefaultValue { get; set; }
