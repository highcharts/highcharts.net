...
{
	public partial class PlotOptionsParetoDragDropDragHandle  : BaseObject
	{
		public PlotOptionsParetoDragDropDragHandle()
		{
		...
		internal override Hashtable ToHashtable()
		{
			...
			if (PathFormatter != PathFormatter_DefaultValue) { h.Add("pathFormatter",PathFormatter); Highcharts.AddFunction("PlotOptionsParetoDragDropDragHandlePathFormatter.pathFormatter", PathFormatter); }  
