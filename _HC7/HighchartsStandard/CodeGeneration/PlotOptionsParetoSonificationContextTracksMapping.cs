...
{
	public partial class PlotOptionsParetoSonificationContextTracksMapping  : BaseObject
	{
		Hashtable h = new Hashtable();

		public PlotOptionsParetoSonificationContextTracksMapping()
		{
			Frequency = Frequency_DefaultValue = new PlotOptionsParetoSonificationContextTracksMappingFrequency();
			GapBetweenNotes = GapBetweenNotes_DefaultValue = new PlotOptionsParetoSonificationContextTracksMappingGapBetweenNotes();
			Highpass = Highpass_DefaultValue = new PlotOptionsParetoSonificationContextTracksMappingHighpass();
			Lowpass = Lowpass_DefaultValue = new PlotOptionsParetoSonificationContextTracksMappingLowpass();
			NoteDuration = NoteDuration_DefaultValue = new PlotOptionsParetoSonificationContextTracksMappingNoteDuration();
			Pan = Pan_DefaultValue = new PlotOptionsParetoSonificationContextTracksMappingPan();
			Pitch = Pitch_DefaultValue = new PlotOptionsParetoSonificationContextTracksMappingPitch();
			PitchString = PitchString_DefaultValue = "null";
			PitchNumber = PitchNumber_DefaultValue = null;
			PlayDelay = PlayDelay_DefaultValue = new PlotOptionsParetoSonificationContextTracksMappingPlayDelay();
			Time = Time_DefaultValue = new PlotOptionsParetoSonificationContextTracksMappingTime();
			TimeString = TimeString_DefaultValue = "null";
			TimeNumber = TimeNumber_DefaultValue = null;
			Tremolo = Tremolo_DefaultValue = new PlotOptionsParetoSonificationContextTracksMappingTremolo();
			Volume = Volume_DefaultValue = new PlotOptionsParetoSonificationContextTracksMappingVolume();
		...
		/// </summary>
		public PlotOptionsParetoSonificationContextTracksMappingFrequency Frequency { get; set; }
		private PlotOptionsParetoSonificationContextTracksMappingFrequency Frequency_DefaultValue { get; set; }
		...
		/// </summary>
		public PlotOptionsParetoSonificationContextTracksMappingGapBetweenNotes GapBetweenNotes { get; set; }
		private PlotOptionsParetoSonificationContextTracksMappingGapBetweenNotes GapBetweenNotes_DefaultValue { get; set; }
		...
		/// </summary>
		public PlotOptionsParetoSonificationContextTracksMappingHighpass Highpass { get; set; }
		private PlotOptionsParetoSonificationContextTracksMappingHighpass Highpass_DefaultValue { get; set; }
		...
		/// </summary>
		public PlotOptionsParetoSonificationContextTracksMappingLowpass Lowpass { get; set; }
		private PlotOptionsParetoSonificationContextTracksMappingLowpass Lowpass_DefaultValue { get; set; }
		...
		/// </summary>
		public PlotOptionsParetoSonificationContextTracksMappingNoteDuration NoteDuration { get; set; }
		private PlotOptionsParetoSonificationContextTracksMappingNoteDuration NoteDuration_DefaultValue { get; set; }
		...
		/// </summary>
		public PlotOptionsParetoSonificationContextTracksMappingPan Pan { get; set; }
		private PlotOptionsParetoSonificationContextTracksMappingPan Pan_DefaultValue { get; set; }
		...
		/// </summary>
		public PlotOptionsParetoSonificationContextTracksMappingPitch Pitch { get; set; }
		private PlotOptionsParetoSonificationContextTracksMappingPitch Pitch_DefaultValue { get; set; }
		...
		/// </summary>
		public PlotOptionsParetoSonificationContextTracksMappingPlayDelay PlayDelay { get; set; }
		private PlotOptionsParetoSonificationContextTracksMappingPlayDelay PlayDelay_DefaultValue { get; set; }
		...
		/// </summary>
		public PlotOptionsParetoSonificationContextTracksMappingTime Time { get; set; }
		private PlotOptionsParetoSonificationContextTracksMappingTime Time_DefaultValue { get; set; }
		...
		/// </summary>
		public PlotOptionsParetoSonificationContextTracksMappingTremolo Tremolo { get; set; }
		private PlotOptionsParetoSonificationContextTracksMappingTremolo Tremolo_DefaultValue { get; set; }
		 

		/// <summary>
		/// The volume of notes, from 0 to 1.
		/// </summary>
		public PlotOptionsParetoSonificationContextTracksMappingVolume Volume { get; set; }
		private PlotOptionsParetoSonificationContextTracksMappingVolume Volume_DefaultValue { get; set; }
