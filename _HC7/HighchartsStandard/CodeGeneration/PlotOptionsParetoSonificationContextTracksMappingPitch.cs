...
{
	public partial class PlotOptionsParetoSonificationContextTracksMappingPitch  : BaseObject
	{
		Hashtable h = new Hashtable();

		public PlotOptionsParetoSonificationContextTracksMappingPitch()
		{
			MapFunction = MapFunction_DefaultValue = PlotOptionsParetoSonificationContextTracksMappingPitchMapFunction.Linear;
		...
		/// </summary>
		public PlotOptionsParetoSonificationContextTracksMappingPitchMapFunction MapFunction { get; set; }
		private PlotOptionsParetoSonificationContextTracksMappingPitchMapFunction MapFunction_DefaultValue { get; set; }
