...
{
	public partial class PlotOptionsParetoSonificationContextTracksMappingPlayDelay  : BaseObject
	{
		Hashtable h = new Hashtable();

		public PlotOptionsParetoSonificationContextTracksMappingPlayDelay()
		{
			MapFunction = MapFunction_DefaultValue = PlotOptionsParetoSonificationContextTracksMappingPlayDelayMapFunction.Linear;
			MapTo = MapTo_DefaultValue = "";
			Max = Max_DefaultValue = null;
			Min = Min_DefaultValue = null;
			Value = Value_DefaultValue = null;
			Within = Within_DefaultValue = PlotOptionsParetoSonificationContextTracksMappingPlayDelayWithin.Chart;
		...
		/// </summary>
		public PlotOptionsParetoSonificationContextTracksMappingPlayDelayMapFunction MapFunction { get; set; }
		private PlotOptionsParetoSonificationContextTracksMappingPlayDelayMapFunction MapFunction_DefaultValue { get; set; }
		...
		/// </summary>
		public PlotOptionsParetoSonificationContextTracksMappingPlayDelayWithin Within { get; set; }
		private PlotOptionsParetoSonificationContextTracksMappingPlayDelayWithin Within_DefaultValue { get; set; }
