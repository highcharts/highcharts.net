...
{
	public partial class PlotOptionsParetoSonificationDefaultInstrumentOptionsMappingTremoloSpeed  : BaseObject
	{
		Hashtable h = new Hashtable();

		public PlotOptionsParetoSonificationDefaultInstrumentOptionsMappingTremoloSpeed()
		{
			MapFunction = MapFunction_DefaultValue = PlotOptionsParetoSonificationDefaultInstrumentOptionsMappingTremoloSpeedMapFunction.Linear;
			MapTo = MapTo_DefaultValue = "";
			Max = Max_DefaultValue = null;
			Min = Min_DefaultValue = null;
			Value = Value_DefaultValue = null;
			Within = Within_DefaultValue = PlotOptionsParetoSonificationDefaultInstrumentOptionsMappingTremoloSpeedWithin.Chart;
		...
		/// </summary>
		public PlotOptionsParetoSonificationDefaultInstrumentOptionsMappingTremoloSpeedMapFunction MapFunction { get; set; }
		private PlotOptionsParetoSonificationDefaultInstrumentOptionsMappingTremoloSpeedMapFunction MapFunction_DefaultValue { get; set; }
		...
		/// </summary>
		public PlotOptionsParetoSonificationDefaultInstrumentOptionsMappingTremoloSpeedWithin Within { get; set; }
		private PlotOptionsParetoSonificationDefaultInstrumentOptionsMappingTremoloSpeedWithin Within_DefaultValue { get; set; }
