...
{
	public partial class PlotOptionsParetoSonificationDefaultSpeechOptionsMappingNoteDuration  : BaseObject
	{
		Hashtable h = new Hashtable();

		public PlotOptionsParetoSonificationDefaultSpeechOptionsMappingNoteDuration()
		{
			MapFunction = MapFunction_DefaultValue = PlotOptionsParetoSonificationDefaultSpeechOptionsMappingNoteDurationMapFunction.Linear;
			MapTo = MapTo_DefaultValue = "";
			Max = Max_DefaultValue = null;
			Min = Min_DefaultValue = null;
			Value = Value_DefaultValue = null;
			Within = Within_DefaultValue = PlotOptionsParetoSonificationDefaultSpeechOptionsMappingNoteDurationWithin.Chart;
		...
		/// </summary>
		public PlotOptionsParetoSonificationDefaultSpeechOptionsMappingNoteDurationMapFunction MapFunction { get; set; }
		private PlotOptionsParetoSonificationDefaultSpeechOptionsMappingNoteDurationMapFunction MapFunction_DefaultValue { get; set; }
		...
		/// </summary>
		public PlotOptionsParetoSonificationDefaultSpeechOptionsMappingNoteDurationWithin Within { get; set; }
		private PlotOptionsParetoSonificationDefaultSpeechOptionsMappingNoteDurationWithin Within_DefaultValue { get; set; }
