...
{
	public partial class PlotOptionsParetoSonificationDefaultSpeechOptionsMappingPitch  : BaseObject
	{
		Hashtable h = new Hashtable();

		public PlotOptionsParetoSonificationDefaultSpeechOptionsMappingPitch()
		{
			MapFunction = MapFunction_DefaultValue = PlotOptionsParetoSonificationDefaultSpeechOptionsMappingPitchMapFunction.Linear;
		...
		/// </summary>
		public PlotOptionsParetoSonificationDefaultSpeechOptionsMappingPitchMapFunction MapFunction { get; set; }
		private PlotOptionsParetoSonificationDefaultSpeechOptionsMappingPitchMapFunction MapFunction_DefaultValue { get; set; }
