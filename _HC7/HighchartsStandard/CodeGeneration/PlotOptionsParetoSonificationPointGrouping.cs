...
{
	public partial class PlotOptionsParetoSonificationPointGrouping  : BaseObject
	{
		Hashtable h = new Hashtable();

		public PlotOptionsParetoSonificationPointGrouping()
		{
		...
		/// </summary>
		public PlotOptionsParetoSonificationPointGroupingAlgorithm Algorithm { get; set; }
		private PlotOptionsParetoSonificationPointGroupingAlgorithm Algorithm_DefaultValue { get; set; }
		...
		internal override Hashtable ToHashtable(Highcharts highcharts)
		{
			...
			if (Algorithm != PlotOptionsParetoSonificationPointGroupingAlgorithm.Null) h.Add("algorithm", highcharts.FirstCharacterToLower(Algorithm.ToString()));
