...
{
	public partial class PlotOptionsParetoSonificationTracksMapping  : BaseObject
	{
		Hashtable h = new Hashtable();

		public PlotOptionsParetoSonificationTracksMapping()
		{
			Frequency = Frequency_DefaultValue = new PlotOptionsParetoSonificationTracksMappingFrequency();
			GapBetweenNotes = GapBetweenNotes_DefaultValue = new PlotOptionsParetoSonificationTracksMappingGapBetweenNotes();
			Highpass = Highpass_DefaultValue = new PlotOptionsParetoSonificationTracksMappingHighpass();
			Lowpass = Lowpass_DefaultValue = new PlotOptionsParetoSonificationTracksMappingLowpass();
			NoteDuration = NoteDuration_DefaultValue = new PlotOptionsParetoSonificationTracksMappingNoteDuration();
			Pan = Pan_DefaultValue = new PlotOptionsParetoSonificationTracksMappingPan();
			Pitch = Pitch_DefaultValue = new PlotOptionsParetoSonificationTracksMappingPitch();
			PitchString = PitchString_DefaultValue = "null";
			PitchNumber = PitchNumber_DefaultValue = null;
			PlayDelay = PlayDelay_DefaultValue = new PlotOptionsParetoSonificationTracksMappingPlayDelay();
			Time = Time_DefaultValue = new PlotOptionsParetoSonificationTracksMappingTime();
			TimeString = TimeString_DefaultValue = "null";
			TimeNumber = TimeNumber_DefaultValue = null;
			Tremolo = Tremolo_DefaultValue = new PlotOptionsParetoSonificationTracksMappingTremolo();
			Volume = Volume_DefaultValue = new PlotOptionsParetoSonificationTracksMappingVolume();
		...
		/// </summary>
		public PlotOptionsParetoSonificationTracksMappingFrequency Frequency { get; set; }
		private PlotOptionsParetoSonificationTracksMappingFrequency Frequency_DefaultValue { get; set; }
		...
		/// </summary>
		public PlotOptionsParetoSonificationTracksMappingGapBetweenNotes GapBetweenNotes { get; set; }
		private PlotOptionsParetoSonificationTracksMappingGapBetweenNotes GapBetweenNotes_DefaultValue { get; set; }
		...
		/// </summary>
		public PlotOptionsParetoSonificationTracksMappingHighpass Highpass { get; set; }
		private PlotOptionsParetoSonificationTracksMappingHighpass Highpass_DefaultValue { get; set; }
		...
		/// </summary>
		public PlotOptionsParetoSonificationTracksMappingLowpass Lowpass { get; set; }
		private PlotOptionsParetoSonificationTracksMappingLowpass Lowpass_DefaultValue { get; set; }
		...
		/// </summary>
		public PlotOptionsParetoSonificationTracksMappingNoteDuration NoteDuration { get; set; }
		private PlotOptionsParetoSonificationTracksMappingNoteDuration NoteDuration_DefaultValue { get; set; }
		...
		/// </summary>
		public PlotOptionsParetoSonificationTracksMappingPan Pan { get; set; }
		private PlotOptionsParetoSonificationTracksMappingPan Pan_DefaultValue { get; set; }
		...
		/// </summary>
		public PlotOptionsParetoSonificationTracksMappingPitch Pitch { get; set; }
		private PlotOptionsParetoSonificationTracksMappingPitch Pitch_DefaultValue { get; set; }
		...
		/// </summary>
		public PlotOptionsParetoSonificationTracksMappingPlayDelay PlayDelay { get; set; }
		private PlotOptionsParetoSonificationTracksMappingPlayDelay PlayDelay_DefaultValue { get; set; }
		...
		/// </summary>
		public PlotOptionsParetoSonificationTracksMappingTime Time { get; set; }
		private PlotOptionsParetoSonificationTracksMappingTime Time_DefaultValue { get; set; }
		...
		/// </summary>
		public PlotOptionsParetoSonificationTracksMappingTremolo Tremolo { get; set; }
		private PlotOptionsParetoSonificationTracksMappingTremolo Tremolo_DefaultValue { get; set; }
		 

		/// <summary>
		/// The volume of notes, from 0 to 1.
		/// </summary>
		public PlotOptionsParetoSonificationTracksMappingVolume Volume { get; set; }
		private PlotOptionsParetoSonificationTracksMappingVolume Volume_DefaultValue { get; set; }
