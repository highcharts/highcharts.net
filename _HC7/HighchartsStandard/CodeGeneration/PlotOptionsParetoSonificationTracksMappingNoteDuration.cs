...
{
	public partial class PlotOptionsParetoSonificationTracksMappingNoteDuration  : BaseObject
	{
		Hashtable h = new Hashtable();

		public PlotOptionsParetoSonificationTracksMappingNoteDuration()
		{
			MapFunction = MapFunction_DefaultValue = PlotOptionsParetoSonificationTracksMappingNoteDurationMapFunction.Linear;
			MapTo = MapTo_DefaultValue = "";
			Max = Max_DefaultValue = null;
			Min = Min_DefaultValue = null;
			Value = Value_DefaultValue = null;
			Within = Within_DefaultValue = PlotOptionsParetoSonificationTracksMappingNoteDurationWithin.Chart;
		...
		/// </summary>
		public PlotOptionsParetoSonificationTracksMappingNoteDurationMapFunction MapFunction { get; set; }
		private PlotOptionsParetoSonificationTracksMappingNoteDurationMapFunction MapFunction_DefaultValue { get; set; }
		...
		/// </summary>
		public PlotOptionsParetoSonificationTracksMappingNoteDurationWithin Within { get; set; }
		private PlotOptionsParetoSonificationTracksMappingNoteDurationWithin Within_DefaultValue { get; set; }
