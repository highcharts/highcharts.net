...
{
	public partial class PlotOptionsParetoSonificationTracksMappingPan  : BaseObject
	{
		Hashtable h = new Hashtable();

		public PlotOptionsParetoSonificationTracksMappingPan()
		{
			MapFunction = MapFunction_DefaultValue = PlotOptionsParetoSonificationTracksMappingPanMapFunction.Linear;
			MapTo = MapTo_DefaultValue = "";
			Max = Max_DefaultValue = null;
			Min = Min_DefaultValue = null;
			Value = Value_DefaultValue = null;
			Within = Within_DefaultValue = PlotOptionsParetoSonificationTracksMappingPanWithin.Chart;
		...
		/// </summary>
		public PlotOptionsParetoSonificationTracksMappingPanMapFunction MapFunction { get; set; }
		private PlotOptionsParetoSonificationTracksMappingPanMapFunction MapFunction_DefaultValue { get; set; }
		...
		/// </summary>
		public PlotOptionsParetoSonificationTracksMappingPanWithin Within { get; set; }
		private PlotOptionsParetoSonificationTracksMappingPanWithin Within_DefaultValue { get; set; }
