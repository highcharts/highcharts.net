...
{
	public partial class PlotOptionsParetoSonificationTracksMappingPitch  : BaseObject
	{
		Hashtable h = new Hashtable();

		public PlotOptionsParetoSonificationTracksMappingPitch()
		{
			MapFunction = MapFunction_DefaultValue = PlotOptionsParetoSonificationTracksMappingPitchMapFunction.Linear;
		...
		/// </summary>
		public PlotOptionsParetoSonificationTracksMappingPitchMapFunction MapFunction { get; set; }
		private PlotOptionsParetoSonificationTracksMappingPitchMapFunction MapFunction_DefaultValue { get; set; }
