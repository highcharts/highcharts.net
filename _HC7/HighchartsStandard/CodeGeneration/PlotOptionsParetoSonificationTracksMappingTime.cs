...
{
	public partial class PlotOptionsParetoSonificationTracksMappingTime  : BaseObject
	{
		Hashtable h = new Hashtable();

		public PlotOptionsParetoSonificationTracksMappingTime()
		{
			MapFunction = MapFunction_DefaultValue = PlotOptionsParetoSonificationTracksMappingTimeMapFunction.Linear;
			MapTo = MapTo_DefaultValue = "";
			Max = Max_DefaultValue = null;
			Min = Min_DefaultValue = null;
			Value = Value_DefaultValue = null;
			Within = Within_DefaultValue = PlotOptionsParetoSonificationTracksMappingTimeWithin.Chart;
		...
		/// </summary>
		public PlotOptionsParetoSonificationTracksMappingTimeMapFunction MapFunction { get; set; }
		private PlotOptionsParetoSonificationTracksMappingTimeMapFunction MapFunction_DefaultValue { get; set; }
		...
		/// </summary>
		public PlotOptionsParetoSonificationTracksMappingTimeWithin Within { get; set; }
		private PlotOptionsParetoSonificationTracksMappingTimeWithin Within_DefaultValue { get; set; }
