...
{
	public partial class PlotOptionsParetoSonificationTracksPointGrouping  : BaseObject
	{
		Hashtable h = new Hashtable();

		public PlotOptionsParetoSonificationTracksPointGrouping()
		{
		...
		/// </summary>
		public PlotOptionsParetoSonificationTracksPointGroupingAlgorithm Algorithm { get; set; }
		private PlotOptionsParetoSonificationTracksPointGroupingAlgorithm Algorithm_DefaultValue { get; set; }
		...
		internal override Hashtable ToHashtable(Highcharts highcharts)
		{
			...
			if (Algorithm != PlotOptionsParetoSonificationTracksPointGroupingAlgorithm.Null) h.Add("algorithm", highcharts.FirstCharacterToLower(Algorithm.ToString()));
