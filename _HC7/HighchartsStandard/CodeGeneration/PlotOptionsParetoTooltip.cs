...
{
	public partial class PlotOptionsParetoTooltip  : BaseObject
	{
		public PlotOptionsParetoTooltip()
		{
			...
			HeaderShape = HeaderShape_DefaultValue = PlotOptionsParetoTooltipHeaderShape.Callout;
		...
		/// </summary>
		public PlotOptionsParetoTooltipHeaderShape HeaderShape { get; set; }
		private PlotOptionsParetoTooltipHeaderShape HeaderShape_DefaultValue { get; set; }
		...
		internal override Hashtable ToHashtable()
		{
			...
			if (NullFormatter != NullFormatter_DefaultValue) { h.Add("nullFormatter",NullFormatter); Highcharts.AddFunction("PlotOptionsParetoTooltipNullFormatter.nullFormatter", NullFormatter); }  
			if (Outside != Outside_DefaultValue) h.Add("outside",Outside);
			if (Padding != Padding_DefaultValue) h.Add("padding",Padding);
			if (PointFormat != PointFormat_DefaultValue) h.Add("pointFormat",PointFormat);
			if (PointFormatter != PointFormatter_DefaultValue) { h.Add("pointFormatter",PointFormatter); Highcharts.AddFunction("PlotOptionsParetoTooltipPointFormatter.pointFormatter", PointFormatter); }  
