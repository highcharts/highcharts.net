...
{
	public partial class PlotOptionsPictorial  : BaseObject
	{
		Hashtable h = new Hashtable();

		public PlotOptionsPictorial()
		{
			Accessibility = Accessibility_DefaultValue = new PlotOptionsPictorialAccessibility();
			AllowPointSelect = AllowPointSelect_DefaultValue = false;
			Animation = Animation_DefaultValue = new Animation();
			AnimationBool = AnimationBool_DefaultValue = true;
			AnimationLimit = AnimationLimit_DefaultValue = null;
			BoostBlending = BoostBlending_DefaultValue = PlotOptionsPictorialBoostBlending.Undefined;
			...
			Cursor = Cursor_DefaultValue = PlotOptionsPictorialCursor.Null;
			Custom = Custom_DefaultValue = new Hashtable();
			DataLabels = DataLabels_DefaultValue = new PlotOptionsPictorialDataLabels();
			Depth = Depth_DefaultValue = 25;
			Description = Description_DefaultValue = "";
			DragDrop = DragDrop_DefaultValue = new PlotOptionsPictorialDragDrop();
			EdgeColor = EdgeColor_DefaultValue = "";
			EdgeWidth = EdgeWidth_DefaultValue = 1;
			EnableMouseTracking = EnableMouseTracking_DefaultValue = true;
			Events = Events_DefaultValue = new PlotOptionsPictorialEvents();
			FindNearestPointBy = FindNearestPointBy_DefaultValue = PlotOptionsPictorialFindNearestPointBy.X;
			...
			Label = Label_DefaultValue = new PlotOptionsPictorialLabel();
			LegendSymbol = LegendSymbol_DefaultValue = PlotOptionsPictorialLegendSymbol.Rectangle;
			LinkedTo = LinkedTo_DefaultValue = "";
			MaxPointWidth = MaxPointWidth_DefaultValue = null;
			MinPointLength = MinPointLength_DefaultValue = 0;
			NegativeColor = NegativeColor_DefaultValue = "";
			Opacity = Opacity_DefaultValue = 1;
			Point = Point_DefaultValue = new PlotOptionsPictorialPoint();
			PointDescriptionFormat = PointDescriptionFormat_DefaultValue = "";
			PointDescriptionFormatter = PointDescriptionFormatter_DefaultValue = "";
			PointInterval = PointInterval_DefaultValue = 1;
			PointIntervalUnit = PointIntervalUnit_DefaultValue = PlotOptionsPictorialPointIntervalUnit.Null;
			...
			Sonification = Sonification_DefaultValue = new PlotOptionsPictorialSonification();
			Stacking = Stacking_DefaultValue = PlotOptionsPictorialStacking.Null;
			States = States_DefaultValue = new PlotOptionsPictorialStates();
			StickyTracking = StickyTracking_DefaultValue = true;
			Threshold = Threshold_DefaultValue = 0;
			Tooltip = Tooltip_DefaultValue = new PlotOptionsPictorialTooltip();
			TurboThreshold = TurboThreshold_DefaultValue = 1000;
			Visible = Visible_DefaultValue = true;
			ZoneAxis = ZoneAxis_DefaultValue = "y";
			Zones = Zones_DefaultValue = new List<PlotOptionsPictorialZone>();
		...
		/// </summary>
		public PlotOptionsPictorialAccessibility Accessibility { get; set; }
		private PlotOptionsPictorialAccessibility Accessibility_DefaultValue { get; set; }
		...
		/// </summary>
		public PlotOptionsPictorialBoostBlending BoostBlending { get; set; }
		private PlotOptionsPictorialBoostBlending BoostBlending_DefaultValue { get; set; }
		...
		/// </summary>
		public PlotOptionsPictorialCursor Cursor { get; set; }
		private PlotOptionsPictorialCursor Cursor_DefaultValue { get; set; }
		...
		/// </summary>
		public PlotOptionsPictorialDataLabels DataLabels { get; set; }
		private PlotOptionsPictorialDataLabels DataLabels_DefaultValue { get; set; }
		...
		/// </summary>
		public PlotOptionsPictorialDragDrop DragDrop { get; set; }
		private PlotOptionsPictorialDragDrop DragDrop_DefaultValue { get; set; }
		...
		/// </summary>
		public PlotOptionsPictorialEvents Events { get; set; }
		private PlotOptionsPictorialEvents Events_DefaultValue { get; set; }
		...
		/// </summary>
		public PlotOptionsPictorialFindNearestPointBy FindNearestPointBy { get; set; }
		private PlotOptionsPictorialFindNearestPointBy FindNearestPointBy_DefaultValue { get; set; }
		...
		/// </summary>
		public PlotOptionsPictorialLabel Label { get; set; }
		private PlotOptionsPictorialLabel Label_DefaultValue { get; set; }
		 

		/// <summary>
		/// What type of legend symbol to render for this series. Can be one of`lineMarker` or `rectangle`.
		/// </summary>
		public PlotOptionsPictorialLegendSymbol LegendSymbol { get; set; }
		private PlotOptionsPictorialLegendSymbol LegendSymbol_DefaultValue { get; set; }
		...
		/// </summary>
		public PlotOptionsPictorialPoint Point { get; set; }
		private PlotOptionsPictorialPoint Point_DefaultValue { get; set; }
		...
		/// </summary>
		public PlotOptionsPictorialPointIntervalUnit PointIntervalUnit { get; set; }
		private PlotOptionsPictorialPointIntervalUnit PointIntervalUnit_DefaultValue { get; set; }
		...
		/// </summary>
		public PlotOptionsPictorialSonification Sonification { get; set; }
		private PlotOptionsPictorialSonification Sonification_DefaultValue { get; set; }
		...
		/// </summary>
		public PlotOptionsPictorialStacking Stacking { get; set; }
		private PlotOptionsPictorialStacking Stacking_DefaultValue { get; set; }
		 

		/// <summary>
		/// 
		/// </summary>
		public PlotOptionsPictorialStates States { get; set; }
		private PlotOptionsPictorialStates States_DefaultValue { get; set; }
		...
		/// </summary>
		public PlotOptionsPictorialTooltip Tooltip { get; set; }
		private PlotOptionsPictorialTooltip Tooltip_DefaultValue { get; set; }
		...
		/// </summary>
		public List<PlotOptionsPictorialZone> Zones { get; set; }
		private List<PlotOptionsPictorialZone> Zones_DefaultValue { get; set; }
