...
{
	public partial class PlotOptionsPictorialAccessibility  : BaseObject
	{
		Hashtable h = new Hashtable();

		public PlotOptionsPictorialAccessibility()
		{
			Description = Description_DefaultValue = "";
			DescriptionFormat = DescriptionFormat_DefaultValue = "";
			Enabled = Enabled_DefaultValue = null;
			ExposeAsGroupOnly = ExposeAsGroupOnly_DefaultValue = null;
			KeyboardNavigation = KeyboardNavigation_DefaultValue = new PlotOptionsPictorialAccessibilityKeyboardNavigation();
			Point = Point_DefaultValue = new PlotOptionsPictorialAccessibilityPoint();
		...
		/// </summary>
		public PlotOptionsPictorialAccessibilityKeyboardNavigation KeyboardNavigation { get; set; }
		private PlotOptionsPictorialAccessibilityKeyboardNavigation KeyboardNavigation_DefaultValue { get; set; }
		 

		/// <summary>
		/// Point accessibility options for a series.
		/// </summary>
		public PlotOptionsPictorialAccessibilityPoint Point { get; set; }
		private PlotOptionsPictorialAccessibilityPoint Point_DefaultValue { get; set; }
