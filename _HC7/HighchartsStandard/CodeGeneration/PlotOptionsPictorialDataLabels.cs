...
{
	public partial class PlotOptionsPictorialDataLabels  : BaseObject
	{
		Hashtable h = new Hashtable();

		public PlotOptionsPictorialDataLabels()
		{
		...
		/// </summary>
		public PlotOptionsPictorialDataLabelsAlign Align { get; set; }
		private PlotOptionsPictorialDataLabelsAlign Align_DefaultValue { get; set; }
		...
		/// </summary>
		public PlotOptionsPictorialDataLabelsFilter Filter { get; set; }
		private PlotOptionsPictorialDataLabelsFilter Filter_DefaultValue { get; set; }
		...
		/// </summary>
		public PlotOptionsPictorialDataLabelsOverflow Overflow { get; set; }
		private PlotOptionsPictorialDataLabelsOverflow Overflow_DefaultValue { get; set; }
		...
		/// </summary>
		public PlotOptionsPictorialDataLabelsPosition Position { get; set; }
		private PlotOptionsPictorialDataLabelsPosition Position_DefaultValue { get; set; }
		...
		/// </summary>
		public PlotOptionsPictorialDataLabelsTextPath TextPath { get; set; }
		private PlotOptionsPictorialDataLabelsTextPath TextPath_DefaultValue { get; set; }
		...
		/// </summary>
		public PlotOptionsPictorialDataLabelsVerticalAlign VerticalAlign { get; set; }
		private PlotOptionsPictorialDataLabelsVerticalAlign VerticalAlign_DefaultValue { get; set; }
		...
		internal override Hashtable ToHashtable(Highcharts highcharts)
		{
			...
			if (Align != PlotOptionsPictorialDataLabelsAlign.Null) h.Add("align", highcharts.FirstCharacterToLower(Align.ToString()));
			...
			if (Overflow != PlotOptionsPictorialDataLabelsOverflow.Null) h.Add("overflow", highcharts.FirstCharacterToLower(Overflow.ToString()));
			if (Padding != null) h.Add("padding",Padding);
			if (Position != PlotOptionsPictorialDataLabelsPosition.Null) h.Add("position", highcharts.FirstCharacterToLower(Position.ToString()));
			...
			if (VerticalAlign != PlotOptionsPictorialDataLabelsVerticalAlign.Null) h.Add("verticalAlign", highcharts.FirstCharacterToLower(VerticalAlign.ToString()));
			if (X != null) h.Add("x",X);
			if (Y != null) h.Add("y",Y);
