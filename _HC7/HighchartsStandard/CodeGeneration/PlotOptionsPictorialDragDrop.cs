...
{
	public partial class PlotOptionsPictorialDragDrop  : BaseObject
	{
		Hashtable h = new Hashtable();

		public PlotOptionsPictorialDragDrop()
		{
			DraggableX = DraggableX_DefaultValue = null;
			DraggableY = DraggableY_DefaultValue = null;
			DragHandle = DragHandle_DefaultValue = new PlotOptionsPictorialDragDropDragHandle();
			...
			GuideBox = GuideBox_DefaultValue = new PlotOptionsPictorialDragDropGuideBox();
		...
		/// </summary>
		public PlotOptionsPictorialDragDropDragHandle DragHandle { get; set; }
		private PlotOptionsPictorialDragDropDragHandle DragHandle_DefaultValue { get; set; }
		...
		/// </summary>
		public PlotOptionsPictorialDragDropGuideBox GuideBox { get; set; }
		private PlotOptionsPictorialDragDropGuideBox GuideBox_DefaultValue { get; set; }
