...
{
	public partial class PlotOptionsPictorialSonificationContextTracksMapping  : BaseObject
	{
		Hashtable h = new Hashtable();

		public PlotOptionsPictorialSonificationContextTracksMapping()
		{
			Frequency = Frequency_DefaultValue = new PlotOptionsPictorialSonificationContextTracksMappingFrequency();
			GapBetweenNotes = GapBetweenNotes_DefaultValue = new PlotOptionsPictorialSonificationContextTracksMappingGapBetweenNotes();
			Highpass = Highpass_DefaultValue = new PlotOptionsPictorialSonificationContextTracksMappingHighpass();
			Lowpass = Lowpass_DefaultValue = new PlotOptionsPictorialSonificationContextTracksMappingLowpass();
			NoteDuration = NoteDuration_DefaultValue = new PlotOptionsPictorialSonificationContextTracksMappingNoteDuration();
			Pan = Pan_DefaultValue = new PlotOptionsPictorialSonificationContextTracksMappingPan();
			Pitch = Pitch_DefaultValue = new PlotOptionsPictorialSonificationContextTracksMappingPitch();
			PitchString = PitchString_DefaultValue = "null";
			PitchNumber = PitchNumber_DefaultValue = null;
			PlayDelay = PlayDelay_DefaultValue = new PlotOptionsPictorialSonificationContextTracksMappingPlayDelay();
			Time = Time_DefaultValue = new PlotOptionsPictorialSonificationContextTracksMappingTime();
			TimeString = TimeString_DefaultValue = "null";
			TimeNumber = TimeNumber_DefaultValue = null;
			Tremolo = Tremolo_DefaultValue = new PlotOptionsPictorialSonificationContextTracksMappingTremolo();
			Volume = Volume_DefaultValue = new PlotOptionsPictorialSonificationContextTracksMappingVolume();
		...
		/// </summary>
		public PlotOptionsPictorialSonificationContextTracksMappingFrequency Frequency { get; set; }
		private PlotOptionsPictorialSonificationContextTracksMappingFrequency Frequency_DefaultValue { get; set; }
		...
		/// </summary>
		public PlotOptionsPictorialSonificationContextTracksMappingGapBetweenNotes GapBetweenNotes { get; set; }
		private PlotOptionsPictorialSonificationContextTracksMappingGapBetweenNotes GapBetweenNotes_DefaultValue { get; set; }
		...
		/// </summary>
		public PlotOptionsPictorialSonificationContextTracksMappingHighpass Highpass { get; set; }
		private PlotOptionsPictorialSonificationContextTracksMappingHighpass Highpass_DefaultValue { get; set; }
		...
		/// </summary>
		public PlotOptionsPictorialSonificationContextTracksMappingLowpass Lowpass { get; set; }
		private PlotOptionsPictorialSonificationContextTracksMappingLowpass Lowpass_DefaultValue { get; set; }
		...
		/// </summary>
		public PlotOptionsPictorialSonificationContextTracksMappingNoteDuration NoteDuration { get; set; }
		private PlotOptionsPictorialSonificationContextTracksMappingNoteDuration NoteDuration_DefaultValue { get; set; }
		...
		/// </summary>
		public PlotOptionsPictorialSonificationContextTracksMappingPan Pan { get; set; }
		private PlotOptionsPictorialSonificationContextTracksMappingPan Pan_DefaultValue { get; set; }
		...
		/// </summary>
		public PlotOptionsPictorialSonificationContextTracksMappingPitch Pitch { get; set; }
		private PlotOptionsPictorialSonificationContextTracksMappingPitch Pitch_DefaultValue { get; set; }
		...
		/// </summary>
		public PlotOptionsPictorialSonificationContextTracksMappingPlayDelay PlayDelay { get; set; }
		private PlotOptionsPictorialSonificationContextTracksMappingPlayDelay PlayDelay_DefaultValue { get; set; }
		...
		/// </summary>
		public PlotOptionsPictorialSonificationContextTracksMappingTime Time { get; set; }
		private PlotOptionsPictorialSonificationContextTracksMappingTime Time_DefaultValue { get; set; }
		...
		/// </summary>
		public PlotOptionsPictorialSonificationContextTracksMappingTremolo Tremolo { get; set; }
		private PlotOptionsPictorialSonificationContextTracksMappingTremolo Tremolo_DefaultValue { get; set; }
		 

		/// <summary>
		/// The volume of notes, from 0 to 1.
		/// </summary>
		public PlotOptionsPictorialSonificationContextTracksMappingVolume Volume { get; set; }
		private PlotOptionsPictorialSonificationContextTracksMappingVolume Volume_DefaultValue { get; set; }
