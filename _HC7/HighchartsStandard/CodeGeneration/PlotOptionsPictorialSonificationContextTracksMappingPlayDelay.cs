...
{
	public partial class PlotOptionsPictorialSonificationContextTracksMappingPlayDelay  : BaseObject
	{
		Hashtable h = new Hashtable();

		public PlotOptionsPictorialSonificationContextTracksMappingPlayDelay()
		{
			MapFunction = MapFunction_DefaultValue = PlotOptionsPictorialSonificationContextTracksMappingPlayDelayMapFunction.Linear;
			MapTo = MapTo_DefaultValue = "";
			Max = Max_DefaultValue = null;
			Min = Min_DefaultValue = null;
			Value = Value_DefaultValue = null;
			Within = Within_DefaultValue = PlotOptionsPictorialSonificationContextTracksMappingPlayDelayWithin.Chart;
		...
		/// </summary>
		public PlotOptionsPictorialSonificationContextTracksMappingPlayDelayMapFunction MapFunction { get; set; }
		private PlotOptionsPictorialSonificationContextTracksMappingPlayDelayMapFunction MapFunction_DefaultValue { get; set; }
		...
		/// </summary>
		public PlotOptionsPictorialSonificationContextTracksMappingPlayDelayWithin Within { get; set; }
		private PlotOptionsPictorialSonificationContextTracksMappingPlayDelayWithin Within_DefaultValue { get; set; }
