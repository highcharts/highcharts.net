...
{
	public partial class PlotOptionsPictorialSonificationContextTracksMappingVolume  : BaseObject
	{
		Hashtable h = new Hashtable();

		public PlotOptionsPictorialSonificationContextTracksMappingVolume()
		{
			MapFunction = MapFunction_DefaultValue = PlotOptionsPictorialSonificationContextTracksMappingVolumeMapFunction.Linear;
			MapTo = MapTo_DefaultValue = "";
			Max = Max_DefaultValue = null;
			Min = Min_DefaultValue = null;
			Value = Value_DefaultValue = null;
			Within = Within_DefaultValue = PlotOptionsPictorialSonificationContextTracksMappingVolumeWithin.Chart;
		...
		/// </summary>
		public PlotOptionsPictorialSonificationContextTracksMappingVolumeMapFunction MapFunction { get; set; }
		private PlotOptionsPictorialSonificationContextTracksMappingVolumeMapFunction MapFunction_DefaultValue { get; set; }
		...
		/// </summary>
		public PlotOptionsPictorialSonificationContextTracksMappingVolumeWithin Within { get; set; }
		private PlotOptionsPictorialSonificationContextTracksMappingVolumeWithin Within_DefaultValue { get; set; }
