...
{
	public partial class PlotOptionsPictorialSonificationDefaultSpeechOptionsMappingNoteDuration  : BaseObject
	{
		Hashtable h = new Hashtable();

		public PlotOptionsPictorialSonificationDefaultSpeechOptionsMappingNoteDuration()
		{
			MapFunction = MapFunction_DefaultValue = PlotOptionsPictorialSonificationDefaultSpeechOptionsMappingNoteDurationMapFunction.Linear;
			MapTo = MapTo_DefaultValue = "";
			Max = Max_DefaultValue = null;
			Min = Min_DefaultValue = null;
			Value = Value_DefaultValue = null;
			Within = Within_DefaultValue = PlotOptionsPictorialSonificationDefaultSpeechOptionsMappingNoteDurationWithin.Chart;
		...
		/// </summary>
		public PlotOptionsPictorialSonificationDefaultSpeechOptionsMappingNoteDurationMapFunction MapFunction { get; set; }
		private PlotOptionsPictorialSonificationDefaultSpeechOptionsMappingNoteDurationMapFunction MapFunction_DefaultValue { get; set; }
		...
		/// </summary>
		public PlotOptionsPictorialSonificationDefaultSpeechOptionsMappingNoteDurationWithin Within { get; set; }
		private PlotOptionsPictorialSonificationDefaultSpeechOptionsMappingNoteDurationWithin Within_DefaultValue { get; set; }
