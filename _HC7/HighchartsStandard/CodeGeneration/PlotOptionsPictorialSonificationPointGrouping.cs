...
{
	public partial class PlotOptionsPictorialSonificationPointGrouping  : BaseObject
	{
		Hashtable h = new Hashtable();

		public PlotOptionsPictorialSonificationPointGrouping()
		{
		...
		/// </summary>
		public PlotOptionsPictorialSonificationPointGroupingAlgorithm Algorithm { get; set; }
		private PlotOptionsPictorialSonificationPointGroupingAlgorithm Algorithm_DefaultValue { get; set; }
		...
		internal override Hashtable ToHashtable(Highcharts highcharts)
		{
			...
			if (Algorithm != PlotOptionsPictorialSonificationPointGroupingAlgorithm.Null) h.Add("algorithm", highcharts.FirstCharacterToLower(Algorithm.ToString()));
