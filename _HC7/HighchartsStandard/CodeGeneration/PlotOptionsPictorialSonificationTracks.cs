...
{
	public partial class PlotOptionsPictorialSonificationTracks  : BaseObject
	{
		Hashtable h = new Hashtable();

		public PlotOptionsPictorialSonificationTracks()
		{
			ActiveWhen = ActiveWhen_DefaultValue = new PlotOptionsPictorialSonificationTracksActiveWhen();
			Instrument = Instrument_DefaultValue = null;
			InstrumentString = InstrumentString_DefaultValue = "null";
			Mapping = Mapping_DefaultValue = new PlotOptionsPictorialSonificationTracksMapping();
			MidiName = MidiName_DefaultValue = "";
			PointGrouping = PointGrouping_DefaultValue = new PlotOptionsPictorialSonificationTracksPointGrouping();
			RoundToMusicalNotes = RoundToMusicalNotes_DefaultValue = true;
			ShowPlayMarker = ShowPlayMarker_DefaultValue = true;
			Type = Type_DefaultValue = PlotOptionsPictorialSonificationTracksType.Instrument;
		...
		/// </summary>
		public PlotOptionsPictorialSonificationTracksActiveWhen ActiveWhen { get; set; }
		private PlotOptionsPictorialSonificationTracksActiveWhen ActiveWhen_DefaultValue { get; set; }
		...
		/// </summary>
		public PlotOptionsPictorialSonificationTracksMapping Mapping { get; set; }
		private PlotOptionsPictorialSonificationTracksMapping Mapping_DefaultValue { get; set; }
		...
		/// </summary>
		public PlotOptionsPictorialSonificationTracksPointGrouping PointGrouping { get; set; }
		private PlotOptionsPictorialSonificationTracksPointGrouping PointGrouping_DefaultValue { get; set; }
		...
		/// </summary>
		public PlotOptionsPictorialSonificationTracksType Type { get; set; }
		private PlotOptionsPictorialSonificationTracksType Type_DefaultValue { get; set; }
