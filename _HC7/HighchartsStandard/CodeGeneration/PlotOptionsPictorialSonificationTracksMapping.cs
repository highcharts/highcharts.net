...
{
	public partial class PlotOptionsPictorialSonificationTracksMapping  : BaseObject
	{
		Hashtable h = new Hashtable();

		public PlotOptionsPictorialSonificationTracksMapping()
		{
			Frequency = Frequency_DefaultValue = new PlotOptionsPictorialSonificationTracksMappingFrequency();
			GapBetweenNotes = GapBetweenNotes_DefaultValue = new PlotOptionsPictorialSonificationTracksMappingGapBetweenNotes();
			Highpass = Highpass_DefaultValue = new PlotOptionsPictorialSonificationTracksMappingHighpass();
			Lowpass = Lowpass_DefaultValue = new PlotOptionsPictorialSonificationTracksMappingLowpass();
			NoteDuration = NoteDuration_DefaultValue = new PlotOptionsPictorialSonificationTracksMappingNoteDuration();
			Pan = Pan_DefaultValue = new PlotOptionsPictorialSonificationTracksMappingPan();
			Pitch = Pitch_DefaultValue = new PlotOptionsPictorialSonificationTracksMappingPitch();
			PitchString = PitchString_DefaultValue = "null";
			PitchNumber = PitchNumber_DefaultValue = null;
			PlayDelay = PlayDelay_DefaultValue = new PlotOptionsPictorialSonificationTracksMappingPlayDelay();
			Time = Time_DefaultValue = new PlotOptionsPictorialSonificationTracksMappingTime();
			TimeString = TimeString_DefaultValue = "null";
			TimeNumber = TimeNumber_DefaultValue = null;
			Tremolo = Tremolo_DefaultValue = new PlotOptionsPictorialSonificationTracksMappingTremolo();
			Volume = Volume_DefaultValue = new PlotOptionsPictorialSonificationTracksMappingVolume();
		...
		/// </summary>
		public PlotOptionsPictorialSonificationTracksMappingFrequency Frequency { get; set; }
		private PlotOptionsPictorialSonificationTracksMappingFrequency Frequency_DefaultValue { get; set; }
		...
		/// </summary>
		public PlotOptionsPictorialSonificationTracksMappingGapBetweenNotes GapBetweenNotes { get; set; }
		private PlotOptionsPictorialSonificationTracksMappingGapBetweenNotes GapBetweenNotes_DefaultValue { get; set; }
		...
		/// </summary>
		public PlotOptionsPictorialSonificationTracksMappingHighpass Highpass { get; set; }
		private PlotOptionsPictorialSonificationTracksMappingHighpass Highpass_DefaultValue { get; set; }
		...
		/// </summary>
		public PlotOptionsPictorialSonificationTracksMappingLowpass Lowpass { get; set; }
		private PlotOptionsPictorialSonificationTracksMappingLowpass Lowpass_DefaultValue { get; set; }
		...
		/// </summary>
		public PlotOptionsPictorialSonificationTracksMappingNoteDuration NoteDuration { get; set; }
		private PlotOptionsPictorialSonificationTracksMappingNoteDuration NoteDuration_DefaultValue { get; set; }
		...
		/// </summary>
		public PlotOptionsPictorialSonificationTracksMappingPan Pan { get; set; }
		private PlotOptionsPictorialSonificationTracksMappingPan Pan_DefaultValue { get; set; }
		...
		/// </summary>
		public PlotOptionsPictorialSonificationTracksMappingPitch Pitch { get; set; }
		private PlotOptionsPictorialSonificationTracksMappingPitch Pitch_DefaultValue { get; set; }
		...
		/// </summary>
		public PlotOptionsPictorialSonificationTracksMappingPlayDelay PlayDelay { get; set; }
		private PlotOptionsPictorialSonificationTracksMappingPlayDelay PlayDelay_DefaultValue { get; set; }
		...
		/// </summary>
		public PlotOptionsPictorialSonificationTracksMappingTime Time { get; set; }
		private PlotOptionsPictorialSonificationTracksMappingTime Time_DefaultValue { get; set; }
		...
		/// </summary>
		public PlotOptionsPictorialSonificationTracksMappingTremolo Tremolo { get; set; }
		private PlotOptionsPictorialSonificationTracksMappingTremolo Tremolo_DefaultValue { get; set; }
		 

		/// <summary>
		/// The volume of notes, from 0 to 1.
		/// </summary>
		public PlotOptionsPictorialSonificationTracksMappingVolume Volume { get; set; }
		private PlotOptionsPictorialSonificationTracksMappingVolume Volume_DefaultValue { get; set; }
