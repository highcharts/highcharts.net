...
{
	public partial class PlotOptionsPictorialSonificationTracksMappingPan  : BaseObject
	{
		Hashtable h = new Hashtable();

		public PlotOptionsPictorialSonificationTracksMappingPan()
		{
			MapFunction = MapFunction_DefaultValue = PlotOptionsPictorialSonificationTracksMappingPanMapFunction.Linear;
			MapTo = MapTo_DefaultValue = "";
			Max = Max_DefaultValue = null;
			Min = Min_DefaultValue = null;
			Value = Value_DefaultValue = null;
			Within = Within_DefaultValue = PlotOptionsPictorialSonificationTracksMappingPanWithin.Chart;
		...
		/// </summary>
		public PlotOptionsPictorialSonificationTracksMappingPanMapFunction MapFunction { get; set; }
		private PlotOptionsPictorialSonificationTracksMappingPanMapFunction MapFunction_DefaultValue { get; set; }
		...
		/// </summary>
		public PlotOptionsPictorialSonificationTracksMappingPanWithin Within { get; set; }
		private PlotOptionsPictorialSonificationTracksMappingPanWithin Within_DefaultValue { get; set; }
