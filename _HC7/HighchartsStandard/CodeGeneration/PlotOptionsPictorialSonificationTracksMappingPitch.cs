...
{
	public partial class PlotOptionsPictorialSonificationTracksMappingPitch  : BaseObject
	{
		Hashtable h = new Hashtable();

		public PlotOptionsPictorialSonificationTracksMappingPitch()
		{
			MapFunction = MapFunction_DefaultValue = PlotOptionsPictorialSonificationTracksMappingPitchMapFunction.Linear;
		...
		/// </summary>
		public PlotOptionsPictorialSonificationTracksMappingPitchMapFunction MapFunction { get; set; }
		private PlotOptionsPictorialSonificationTracksMappingPitchMapFunction MapFunction_DefaultValue { get; set; }
