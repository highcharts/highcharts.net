...
{
	public partial class PlotOptionsPictorialSonificationTracksMappingVolume  : BaseObject
	{
		Hashtable h = new Hashtable();

		public PlotOptionsPictorialSonificationTracksMappingVolume()
		{
			MapFunction = MapFunction_DefaultValue = PlotOptionsPictorialSonificationTracksMappingVolumeMapFunction.Linear;
			MapTo = MapTo_DefaultValue = "";
			Max = Max_DefaultValue = null;
			Min = Min_DefaultValue = null;
			Value = Value_DefaultValue = null;
			Within = Within_DefaultValue = PlotOptionsPictorialSonificationTracksMappingVolumeWithin.Chart;
		...
		/// </summary>
		public PlotOptionsPictorialSonificationTracksMappingVolumeMapFunction MapFunction { get; set; }
		private PlotOptionsPictorialSonificationTracksMappingVolumeMapFunction MapFunction_DefaultValue { get; set; }
		...
		/// </summary>
		public PlotOptionsPictorialSonificationTracksMappingVolumeWithin Within { get; set; }
		private PlotOptionsPictorialSonificationTracksMappingVolumeWithin Within_DefaultValue { get; set; }
