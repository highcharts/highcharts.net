...
{
	public partial class PlotOptionsPictorialSonificationTracksPointGrouping  : BaseObject
	{
		Hashtable h = new Hashtable();

		public PlotOptionsPictorialSonificationTracksPointGrouping()
		{
		...
		/// </summary>
		public PlotOptionsPictorialSonificationTracksPointGroupingAlgorithm Algorithm { get; set; }
		private PlotOptionsPictorialSonificationTracksPointGroupingAlgorithm Algorithm_DefaultValue { get; set; }
		...
		internal override Hashtable ToHashtable(Highcharts highcharts)
		{
			...
			if (Algorithm != PlotOptionsPictorialSonificationTracksPointGroupingAlgorithm.Null) h.Add("algorithm", highcharts.FirstCharacterToLower(Algorithm.ToString()));
