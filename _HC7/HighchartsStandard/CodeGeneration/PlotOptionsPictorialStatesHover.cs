...
{
	public partial class PlotOptionsPictorialStatesHover  : BaseObject
	{
		Hashtable h = new Hashtable();

		public PlotOptionsPictorialStatesHover()
		{
			Animation = Animation_DefaultValue = new Animation();
			AnimationBool = AnimationBool_DefaultValue = null;
			Enabled = Enabled_DefaultValue = true;
			Halo = Halo_DefaultValue = new PlotOptionsPictorialStatesHoverHalo();
			LineWidth = LineWidth_DefaultValue = null;
			LineWidthPlus = LineWidthPlus_DefaultValue = 1;
			Marker = Marker_DefaultValue = new PlotOptionsPictorialStatesHoverMarker();
		...
		/// </summary>
		public PlotOptionsPictorialStatesHoverHalo Halo { get; set; }
		private PlotOptionsPictorialStatesHoverHalo Halo_DefaultValue { get; set; }
		...
		/// </summary>
		public PlotOptionsPictorialStatesHoverMarker Marker { get; set; }
		private PlotOptionsPictorialStatesHoverMarker Marker_DefaultValue { get; set; }
