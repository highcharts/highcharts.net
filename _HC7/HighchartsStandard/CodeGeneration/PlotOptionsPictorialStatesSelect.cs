...
{
	public partial class PlotOptionsPictorialStatesSelect  : BaseObject
	{
		Hashtable h = new Hashtable();

		public PlotOptionsPictorialStatesSelect()
		{
			Animation = Animation_DefaultValue = new Animation();
			AnimationBool = AnimationBool_DefaultValue = null;
			Enabled = Enabled_DefaultValue = true;
			Halo = Halo_DefaultValue = new PlotOptionsPictorialStatesSelectHalo();
			LineWidth = LineWidth_DefaultValue = null;
			LineWidthPlus = LineWidthPlus_DefaultValue = 1;
			Marker = Marker_DefaultValue = new PlotOptionsPictorialStatesSelectMarker();
		...
		/// </summary>
		public PlotOptionsPictorialStatesSelectHalo Halo { get; set; }
		private PlotOptionsPictorialStatesSelectHalo Halo_DefaultValue { get; set; }
		...
		/// </summary>
		public PlotOptionsPictorialStatesSelectMarker Marker { get; set; }
		private PlotOptionsPictorialStatesSelectMarker Marker_DefaultValue { get; set; }
