...
namespace Highsoft.Web.Mvc.Charts
{
	public partial class PlotOptionsPieDataLabels  : BaseObject
	{
		...
		/// </summary>
		public PlotOptionsPieDataLabelsAlign Align { get; set; }
		private PlotOptionsPieDataLabelsAlign Align_DefaultValue { get; set; }
		...
		/// </summary>
		public PlotOptionsPieDataLabelsFilter Filter { get; set; }
		private PlotOptionsPieDataLabelsFilter Filter_DefaultValue { get; set; }
		...
		/// </summary>
		public PlotOptionsPieDataLabelsOverflow Overflow { get; set; }
		private PlotOptionsPieDataLabelsOverflow Overflow_DefaultValue { get; set; }
		...
		/// </summary>
		public PlotOptionsPieDataLabelsPosition Position { get; set; }
		private PlotOptionsPieDataLabelsPosition Position_DefaultValue { get; set; }
		...
		/// </summary>
		public PlotOptionsPieDataLabelsTextPath TextPath { get; set; }
		private PlotOptionsPieDataLabelsTextPath TextPath_DefaultValue { get; set; }
		...
		/// </summary>
		public PlotOptionsPieDataLabelsVerticalAlign VerticalAlign { get; set; }
		private PlotOptionsPieDataLabelsVerticalAlign VerticalAlign_DefaultValue { get; set; }
		...
		internal override Hashtable ToHashtable(Highcharts highcharts)
		{
			...
			if (Align != PlotOptionsPieDataLabelsAlign.Null) h.Add("align", highcharts.FirstCharacterToLower(Align.ToString()));
			...
			if (Overflow != PlotOptionsPieDataLabelsOverflow.Null) h.Add("overflow", highcharts.FirstCharacterToLower(Overflow.ToString()));
			if (Padding != null) h.Add("padding",Padding);
			if (Position != PlotOptionsPieDataLabelsPosition.Null) h.Add("position", highcharts.FirstCharacterToLower(Position.ToString()));
			...
			if (VerticalAlign != PlotOptionsPieDataLabelsVerticalAlign.Null) h.Add("verticalAlign", highcharts.FirstCharacterToLower(VerticalAlign.ToString()));
			if (X != null) h.Add("x",X);
			if (Y != null) h.Add("y",Y);
