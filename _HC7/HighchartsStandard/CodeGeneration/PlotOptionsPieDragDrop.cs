...
{
	public partial class PlotOptionsPieDragDrop  : BaseObject
	{
		public PlotOptionsPieDragDrop()
		{
			DraggableX = DraggableX_DefaultValue = null;
			DraggableY = DraggableY_DefaultValue = null;
			DragHandle = DragHandle_DefaultValue = new PlotOptionsPieDragDropDragHandle();
			...
			GuideBox = GuideBox_DefaultValue = new PlotOptionsPieDragDropGuideBox();
		...
		/// </summary>
		public PlotOptionsPieDragDropDragHandle DragHandle { get; set; }
		private PlotOptionsPieDragDropDragHandle DragHandle_DefaultValue { get; set; }
		...
		/// </summary>
		public PlotOptionsPieDragDropGuideBox GuideBox { get; set; }
		private PlotOptionsPieDragDropGuideBox GuideBox_DefaultValue { get; set; }
