...
namespace Highsoft.Web.Mvc.Charts
{
	public partial class PlotOptionsPieDragDropDragHandle  : BaseObject
	{
		...
		internal override Hashtable ToHashtable()
		{
			...
			if (PathFormatter != PathFormatter_DefaultValue) { h.Add("pathFormatter",PathFormatter); Highcharts.AddFunction("7b6938ca-d918-478b-8740-703725a3940d.pathFormatter", PathFormatter); }  
