...
{
	public partial class PlotOptionsPieSonificationContextTracksMapping  : BaseObject
	{
		Hashtable h = new Hashtable();

		public PlotOptionsPieSonificationContextTracksMapping()
		{
			Frequency = Frequency_DefaultValue = new PlotOptionsPieSonificationContextTracksMappingFrequency();
			GapBetweenNotes = GapBetweenNotes_DefaultValue = new PlotOptionsPieSonificationContextTracksMappingGapBetweenNotes();
			Highpass = Highpass_DefaultValue = new PlotOptionsPieSonificationContextTracksMappingHighpass();
			Lowpass = Lowpass_DefaultValue = new PlotOptionsPieSonificationContextTracksMappingLowpass();
			NoteDuration = NoteDuration_DefaultValue = new PlotOptionsPieSonificationContextTracksMappingNoteDuration();
			Pan = Pan_DefaultValue = new PlotOptionsPieSonificationContextTracksMappingPan();
			Pitch = Pitch_DefaultValue = new PlotOptionsPieSonificationContextTracksMappingPitch();
			PitchString = PitchString_DefaultValue = "null";
			PitchNumber = PitchNumber_DefaultValue = null;
			PlayDelay = PlayDelay_DefaultValue = new PlotOptionsPieSonificationContextTracksMappingPlayDelay();
			Time = Time_DefaultValue = new PlotOptionsPieSonificationContextTracksMappingTime();
			TimeString = TimeString_DefaultValue = "null";
			TimeNumber = TimeNumber_DefaultValue = null;
			Tremolo = Tremolo_DefaultValue = new PlotOptionsPieSonificationContextTracksMappingTremolo();
			Volume = Volume_DefaultValue = new PlotOptionsPieSonificationContextTracksMappingVolume();
		...
		/// </summary>
		public PlotOptionsPieSonificationContextTracksMappingFrequency Frequency { get; set; }
		private PlotOptionsPieSonificationContextTracksMappingFrequency Frequency_DefaultValue { get; set; }
		...
		/// </summary>
		public PlotOptionsPieSonificationContextTracksMappingGapBetweenNotes GapBetweenNotes { get; set; }
		private PlotOptionsPieSonificationContextTracksMappingGapBetweenNotes GapBetweenNotes_DefaultValue { get; set; }
		...
		/// </summary>
		public PlotOptionsPieSonificationContextTracksMappingHighpass Highpass { get; set; }
		private PlotOptionsPieSonificationContextTracksMappingHighpass Highpass_DefaultValue { get; set; }
		...
		/// </summary>
		public PlotOptionsPieSonificationContextTracksMappingLowpass Lowpass { get; set; }
		private PlotOptionsPieSonificationContextTracksMappingLowpass Lowpass_DefaultValue { get; set; }
		...
		/// </summary>
		public PlotOptionsPieSonificationContextTracksMappingNoteDuration NoteDuration { get; set; }
		private PlotOptionsPieSonificationContextTracksMappingNoteDuration NoteDuration_DefaultValue { get; set; }
		...
		/// </summary>
		public PlotOptionsPieSonificationContextTracksMappingPan Pan { get; set; }
		private PlotOptionsPieSonificationContextTracksMappingPan Pan_DefaultValue { get; set; }
		...
		/// </summary>
		public PlotOptionsPieSonificationContextTracksMappingPitch Pitch { get; set; }
		private PlotOptionsPieSonificationContextTracksMappingPitch Pitch_DefaultValue { get; set; }
		...
		/// </summary>
		public PlotOptionsPieSonificationContextTracksMappingPlayDelay PlayDelay { get; set; }
		private PlotOptionsPieSonificationContextTracksMappingPlayDelay PlayDelay_DefaultValue { get; set; }
		...
		/// </summary>
		public PlotOptionsPieSonificationContextTracksMappingTime Time { get; set; }
		private PlotOptionsPieSonificationContextTracksMappingTime Time_DefaultValue { get; set; }
		...
		/// </summary>
		public PlotOptionsPieSonificationContextTracksMappingTremolo Tremolo { get; set; }
		private PlotOptionsPieSonificationContextTracksMappingTremolo Tremolo_DefaultValue { get; set; }
		 

		/// <summary>
		/// The volume of notes, from 0 to 1.
		/// </summary>
		public PlotOptionsPieSonificationContextTracksMappingVolume Volume { get; set; }
		private PlotOptionsPieSonificationContextTracksMappingVolume Volume_DefaultValue { get; set; }
