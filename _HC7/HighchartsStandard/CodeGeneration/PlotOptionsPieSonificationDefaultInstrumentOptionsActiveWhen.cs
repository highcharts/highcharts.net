...
{
	public partial class PlotOptionsPieSonificationDefaultInstrumentOptionsActiveWhen  : BaseObject
	{
		Hashtable h = new Hashtable();

		public PlotOptionsPieSonificationDefaultInstrumentOptionsActiveWhen()
		{
