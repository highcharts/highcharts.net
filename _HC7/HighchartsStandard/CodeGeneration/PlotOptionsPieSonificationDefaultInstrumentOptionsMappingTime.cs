...
{
	public partial class PlotOptionsPieSonificationDefaultInstrumentOptionsMappingTime  : BaseObject
	{
		Hashtable h = new Hashtable();

		public PlotOptionsPieSonificationDefaultInstrumentOptionsMappingTime()
		{
			MapFunction = MapFunction_DefaultValue = PlotOptionsPieSonificationDefaultInstrumentOptionsMappingTimeMapFunction.Linear;
			MapTo = MapTo_DefaultValue = "";
			Max = Max_DefaultValue = null;
			Min = Min_DefaultValue = null;
			Value = Value_DefaultValue = null;
			Within = Within_DefaultValue = PlotOptionsPieSonificationDefaultInstrumentOptionsMappingTimeWithin.Chart;
		...
		/// </summary>
		public PlotOptionsPieSonificationDefaultInstrumentOptionsMappingTimeMapFunction MapFunction { get; set; }
		private PlotOptionsPieSonificationDefaultInstrumentOptionsMappingTimeMapFunction MapFunction_DefaultValue { get; set; }
		...
		/// </summary>
		public PlotOptionsPieSonificationDefaultInstrumentOptionsMappingTimeWithin Within { get; set; }
		private PlotOptionsPieSonificationDefaultInstrumentOptionsMappingTimeWithin Within_DefaultValue { get; set; }
