...
{
	public partial class PlotOptionsPieSonificationDefaultSpeechOptionsMappingPitch  : BaseObject
	{
		Hashtable h = new Hashtable();

		public PlotOptionsPieSonificationDefaultSpeechOptionsMappingPitch()
		{
			MapFunction = MapFunction_DefaultValue = PlotOptionsPieSonificationDefaultSpeechOptionsMappingPitchMapFunction.Linear;
		...
		/// </summary>
		public PlotOptionsPieSonificationDefaultSpeechOptionsMappingPitchMapFunction MapFunction { get; set; }
		private PlotOptionsPieSonificationDefaultSpeechOptionsMappingPitchMapFunction MapFunction_DefaultValue { get; set; }
