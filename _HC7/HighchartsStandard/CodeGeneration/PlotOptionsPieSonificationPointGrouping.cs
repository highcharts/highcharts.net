...
{
	public partial class PlotOptionsPieSonificationPointGrouping  : BaseObject
	{
		Hashtable h = new Hashtable();

		public PlotOptionsPieSonificationPointGrouping()
		{
		...
		/// </summary>
		public PlotOptionsPieSonificationPointGroupingAlgorithm Algorithm { get; set; }
		private PlotOptionsPieSonificationPointGroupingAlgorithm Algorithm_DefaultValue { get; set; }
		...
		internal override Hashtable ToHashtable(Highcharts highcharts)
		{
			...
			if (Algorithm != PlotOptionsPieSonificationPointGroupingAlgorithm.Null) h.Add("algorithm", highcharts.FirstCharacterToLower(Algorithm.ToString()));
