...
{
	public partial class PlotOptionsPieSonificationTracksMappingPan  : BaseObject
	{
		Hashtable h = new Hashtable();

		public PlotOptionsPieSonificationTracksMappingPan()
		{
			MapFunction = MapFunction_DefaultValue = PlotOptionsPieSonificationTracksMappingPanMapFunction.Linear;
			MapTo = MapTo_DefaultValue = "";
			Max = Max_DefaultValue = null;
			Min = Min_DefaultValue = null;
			Value = Value_DefaultValue = null;
			Within = Within_DefaultValue = PlotOptionsPieSonificationTracksMappingPanWithin.Chart;
		...
		/// </summary>
		public PlotOptionsPieSonificationTracksMappingPanMapFunction MapFunction { get; set; }
		private PlotOptionsPieSonificationTracksMappingPanMapFunction MapFunction_DefaultValue { get; set; }
		...
		/// </summary>
		public PlotOptionsPieSonificationTracksMappingPanWithin Within { get; set; }
		private PlotOptionsPieSonificationTracksMappingPanWithin Within_DefaultValue { get; set; }
