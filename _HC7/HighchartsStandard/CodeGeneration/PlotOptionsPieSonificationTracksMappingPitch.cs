...
{
	public partial class PlotOptionsPieSonificationTracksMappingPitch  : BaseObject
	{
		Hashtable h = new Hashtable();

		public PlotOptionsPieSonificationTracksMappingPitch()
		{
			MapFunction = MapFunction_DefaultValue = PlotOptionsPieSonificationTracksMappingPitchMapFunction.Linear;
		...
		/// </summary>
		public PlotOptionsPieSonificationTracksMappingPitchMapFunction MapFunction { get; set; }
		private PlotOptionsPieSonificationTracksMappingPitchMapFunction MapFunction_DefaultValue { get; set; }
