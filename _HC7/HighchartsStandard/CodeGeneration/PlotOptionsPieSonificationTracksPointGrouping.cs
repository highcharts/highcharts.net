...
{
	public partial class PlotOptionsPieSonificationTracksPointGrouping  : BaseObject
	{
		Hashtable h = new Hashtable();

		public PlotOptionsPieSonificationTracksPointGrouping()
		{
		...
		/// </summary>
		public PlotOptionsPieSonificationTracksPointGroupingAlgorithm Algorithm { get; set; }
		private PlotOptionsPieSonificationTracksPointGroupingAlgorithm Algorithm_DefaultValue { get; set; }
		...
		internal override Hashtable ToHashtable(Highcharts highcharts)
		{
			...
			if (Algorithm != PlotOptionsPieSonificationTracksPointGroupingAlgorithm.Null) h.Add("algorithm", highcharts.FirstCharacterToLower(Algorithm.ToString()));
