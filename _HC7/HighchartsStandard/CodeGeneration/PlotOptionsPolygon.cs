...
namespace Highsoft.Web.Mvc.Charts
{
	public partial class PlotOptionsPolygon  : BaseObject
	{
		...
		internal override Hashtable ToHashtable(Highcharts highcharts)
		{
			...
			if (Cursor != PlotOptionsPolygonCursor.Null) h.Add("cursor", highcharts.FirstCharacterToLower(Cursor.ToString()));
			if (Custom != null) h.Add("custom",Custom);
			if (DashStyle != PlotOptionsPolygonDashStyle.Null) h.Add("dashStyle", highcharts.FirstCharacterToLower(DashStyle.ToString()));
			...
			if (FindNearestPointBy != PlotOptionsPolygonFindNearestPointBy.Null) h.Add("findNearestPointBy", highcharts.FirstCharacterToLower(FindNearestPointBy.ToString()));
			...
			if (Linecap != PlotOptionsPolygonLinecap.Null) h.Add("linecap", highcharts.FirstCharacterToLower(Linecap.ToString()));
			...
			if (PointIntervalUnit != PlotOptionsPolygonPointIntervalUnit.Null) h.Add("pointIntervalUnit", highcharts.FirstCharacterToLower(PointIntervalUnit.ToString()));
			...
			if (Stacking != PlotOptionsPolygonStacking.Null) h.Add("stacking", highcharts.FirstCharacterToLower(Stacking.ToString()));
			if (States != null) h.Add("states",States.ToHashtable(highcharts));
			if (Step != PlotOptionsPolygonStep.Null) h.Add("step", highcharts.FirstCharacterToLower(Step.ToString()));
