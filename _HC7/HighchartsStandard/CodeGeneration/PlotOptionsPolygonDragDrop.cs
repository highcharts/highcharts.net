...
{
	public partial class PlotOptionsPolygonDragDrop  : BaseObject
	{
		public PlotOptionsPolygonDragDrop()
		{
			DraggableX = DraggableX_DefaultValue = null;
			DraggableY = DraggableY_DefaultValue = null;
			DragHandle = DragHandle_DefaultValue = new PlotOptionsPolygonDragDropDragHandle();
			...
			GuideBox = GuideBox_DefaultValue = new PlotOptionsPolygonDragDropGuideBox();
		...
		/// </summary>
		public PlotOptionsPolygonDragDropDragHandle DragHandle { get; set; }
		private PlotOptionsPolygonDragDropDragHandle DragHandle_DefaultValue { get; set; }
		...
		/// </summary>
		public PlotOptionsPolygonDragDropGuideBox GuideBox { get; set; }
		private PlotOptionsPolygonDragDropGuideBox GuideBox_DefaultValue { get; set; }
