...
{
	public partial class PlotOptionsPolygonSonificationContextTracksMapping  : BaseObject
	{
		Hashtable h = new Hashtable();

		public PlotOptionsPolygonSonificationContextTracksMapping()
		{
			Frequency = Frequency_DefaultValue = new PlotOptionsPolygonSonificationContextTracksMappingFrequency();
			GapBetweenNotes = GapBetweenNotes_DefaultValue = new PlotOptionsPolygonSonificationContextTracksMappingGapBetweenNotes();
			Highpass = Highpass_DefaultValue = new PlotOptionsPolygonSonificationContextTracksMappingHighpass();
			Lowpass = Lowpass_DefaultValue = new PlotOptionsPolygonSonificationContextTracksMappingLowpass();
			NoteDuration = NoteDuration_DefaultValue = new PlotOptionsPolygonSonificationContextTracksMappingNoteDuration();
			Pan = Pan_DefaultValue = new PlotOptionsPolygonSonificationContextTracksMappingPan();
			Pitch = Pitch_DefaultValue = new PlotOptionsPolygonSonificationContextTracksMappingPitch();
			PitchString = PitchString_DefaultValue = "null";
			PitchNumber = PitchNumber_DefaultValue = null;
			PlayDelay = PlayDelay_DefaultValue = new PlotOptionsPolygonSonificationContextTracksMappingPlayDelay();
			Time = Time_DefaultValue = new PlotOptionsPolygonSonificationContextTracksMappingTime();
			TimeString = TimeString_DefaultValue = "null";
			TimeNumber = TimeNumber_DefaultValue = null;
			Tremolo = Tremolo_DefaultValue = new PlotOptionsPolygonSonificationContextTracksMappingTremolo();
			Volume = Volume_DefaultValue = new PlotOptionsPolygonSonificationContextTracksMappingVolume();
		...
		/// </summary>
		public PlotOptionsPolygonSonificationContextTracksMappingFrequency Frequency { get; set; }
		private PlotOptionsPolygonSonificationContextTracksMappingFrequency Frequency_DefaultValue { get; set; }
		...
		/// </summary>
		public PlotOptionsPolygonSonificationContextTracksMappingGapBetweenNotes GapBetweenNotes { get; set; }
		private PlotOptionsPolygonSonificationContextTracksMappingGapBetweenNotes GapBetweenNotes_DefaultValue { get; set; }
		...
		/// </summary>
		public PlotOptionsPolygonSonificationContextTracksMappingHighpass Highpass { get; set; }
		private PlotOptionsPolygonSonificationContextTracksMappingHighpass Highpass_DefaultValue { get; set; }
		...
		/// </summary>
		public PlotOptionsPolygonSonificationContextTracksMappingLowpass Lowpass { get; set; }
		private PlotOptionsPolygonSonificationContextTracksMappingLowpass Lowpass_DefaultValue { get; set; }
		...
		/// </summary>
		public PlotOptionsPolygonSonificationContextTracksMappingNoteDuration NoteDuration { get; set; }
		private PlotOptionsPolygonSonificationContextTracksMappingNoteDuration NoteDuration_DefaultValue { get; set; }
		...
		/// </summary>
		public PlotOptionsPolygonSonificationContextTracksMappingPan Pan { get; set; }
		private PlotOptionsPolygonSonificationContextTracksMappingPan Pan_DefaultValue { get; set; }
		...
		/// </summary>
		public PlotOptionsPolygonSonificationContextTracksMappingPitch Pitch { get; set; }
		private PlotOptionsPolygonSonificationContextTracksMappingPitch Pitch_DefaultValue { get; set; }
		...
		/// </summary>
		public PlotOptionsPolygonSonificationContextTracksMappingPlayDelay PlayDelay { get; set; }
		private PlotOptionsPolygonSonificationContextTracksMappingPlayDelay PlayDelay_DefaultValue { get; set; }
		...
		/// </summary>
		public PlotOptionsPolygonSonificationContextTracksMappingTime Time { get; set; }
		private PlotOptionsPolygonSonificationContextTracksMappingTime Time_DefaultValue { get; set; }
		...
		/// </summary>
		public PlotOptionsPolygonSonificationContextTracksMappingTremolo Tremolo { get; set; }
		private PlotOptionsPolygonSonificationContextTracksMappingTremolo Tremolo_DefaultValue { get; set; }
		 

		/// <summary>
		/// The volume of notes, from 0 to 1.
		/// </summary>
		public PlotOptionsPolygonSonificationContextTracksMappingVolume Volume { get; set; }
		private PlotOptionsPolygonSonificationContextTracksMappingVolume Volume_DefaultValue { get; set; }
