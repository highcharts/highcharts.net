...
{
	public partial class PlotOptionsPolygonSonificationContextTracksMappingHighpassFrequency  : BaseObject
	{
		Hashtable h = new Hashtable();

		public PlotOptionsPolygonSonificationContextTracksMappingHighpassFrequency()
		{
			MapFunction = MapFunction_DefaultValue = PlotOptionsPolygonSonificationContextTracksMappingHighpassFrequencyMapFunction.Linear;
			MapTo = MapTo_DefaultValue = "";
			Max = Max_DefaultValue = null;
			Min = Min_DefaultValue = null;
			Value = Value_DefaultValue = null;
			Within = Within_DefaultValue = PlotOptionsPolygonSonificationContextTracksMappingHighpassFrequencyWithin.Chart;
		...
		/// </summary>
		public PlotOptionsPolygonSonificationContextTracksMappingHighpassFrequencyMapFunction MapFunction { get; set; }
		private PlotOptionsPolygonSonificationContextTracksMappingHighpassFrequencyMapFunction MapFunction_DefaultValue { get; set; }
		...
		/// </summary>
		public PlotOptionsPolygonSonificationContextTracksMappingHighpassFrequencyWithin Within { get; set; }
		private PlotOptionsPolygonSonificationContextTracksMappingHighpassFrequencyWithin Within_DefaultValue { get; set; }
