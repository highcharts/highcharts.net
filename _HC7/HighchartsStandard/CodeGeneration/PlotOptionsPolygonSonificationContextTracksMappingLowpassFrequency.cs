...
{
	public partial class PlotOptionsPolygonSonificationContextTracksMappingLowpassFrequency  : BaseObject
	{
		Hashtable h = new Hashtable();

		public PlotOptionsPolygonSonificationContextTracksMappingLowpassFrequency()
		{
			MapFunction = MapFunction_DefaultValue = PlotOptionsPolygonSonificationContextTracksMappingLowpassFrequencyMapFunction.Linear;
			MapTo = MapTo_DefaultValue = "";
			Max = Max_DefaultValue = null;
			Min = Min_DefaultValue = null;
			Value = Value_DefaultValue = null;
			Within = Within_DefaultValue = PlotOptionsPolygonSonificationContextTracksMappingLowpassFrequencyWithin.Chart;
		...
		/// </summary>
		public PlotOptionsPolygonSonificationContextTracksMappingLowpassFrequencyMapFunction MapFunction { get; set; }
		private PlotOptionsPolygonSonificationContextTracksMappingLowpassFrequencyMapFunction MapFunction_DefaultValue { get; set; }
		...
		/// </summary>
		public PlotOptionsPolygonSonificationContextTracksMappingLowpassFrequencyWithin Within { get; set; }
		private PlotOptionsPolygonSonificationContextTracksMappingLowpassFrequencyWithin Within_DefaultValue { get; set; }
