...
{
	public partial class PlotOptionsPolygonSonificationContextTracksMappingPan  : BaseObject
	{
		Hashtable h = new Hashtable();

		public PlotOptionsPolygonSonificationContextTracksMappingPan()
		{
			MapFunction = MapFunction_DefaultValue = PlotOptionsPolygonSonificationContextTracksMappingPanMapFunction.Linear;
			MapTo = MapTo_DefaultValue = "";
			Max = Max_DefaultValue = null;
			Min = Min_DefaultValue = null;
			Value = Value_DefaultValue = null;
			Within = Within_DefaultValue = PlotOptionsPolygonSonificationContextTracksMappingPanWithin.Chart;
		...
		/// </summary>
		public PlotOptionsPolygonSonificationContextTracksMappingPanMapFunction MapFunction { get; set; }
		private PlotOptionsPolygonSonificationContextTracksMappingPanMapFunction MapFunction_DefaultValue { get; set; }
		...
		/// </summary>
		public PlotOptionsPolygonSonificationContextTracksMappingPanWithin Within { get; set; }
		private PlotOptionsPolygonSonificationContextTracksMappingPanWithin Within_DefaultValue { get; set; }
