...
{
	public partial class PlotOptionsPolygonSonificationContextTracksMappingPlayDelay  : BaseObject
	{
		Hashtable h = new Hashtable();

		public PlotOptionsPolygonSonificationContextTracksMappingPlayDelay()
		{
			MapFunction = MapFunction_DefaultValue = PlotOptionsPolygonSonificationContextTracksMappingPlayDelayMapFunction.Linear;
			MapTo = MapTo_DefaultValue = "";
			Max = Max_DefaultValue = null;
			Min = Min_DefaultValue = null;
			Value = Value_DefaultValue = null;
			Within = Within_DefaultValue = PlotOptionsPolygonSonificationContextTracksMappingPlayDelayWithin.Chart;
		...
		/// </summary>
		public PlotOptionsPolygonSonificationContextTracksMappingPlayDelayMapFunction MapFunction { get; set; }
		private PlotOptionsPolygonSonificationContextTracksMappingPlayDelayMapFunction MapFunction_DefaultValue { get; set; }
		...
		/// </summary>
		public PlotOptionsPolygonSonificationContextTracksMappingPlayDelayWithin Within { get; set; }
		private PlotOptionsPolygonSonificationContextTracksMappingPlayDelayWithin Within_DefaultValue { get; set; }
