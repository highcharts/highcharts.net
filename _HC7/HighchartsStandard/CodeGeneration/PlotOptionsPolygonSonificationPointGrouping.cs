...
{
	public partial class PlotOptionsPolygonSonificationPointGrouping  : BaseObject
	{
		Hashtable h = new Hashtable();

		public PlotOptionsPolygonSonificationPointGrouping()
		{
		...
		/// </summary>
		public PlotOptionsPolygonSonificationPointGroupingAlgorithm Algorithm { get; set; }
		private PlotOptionsPolygonSonificationPointGroupingAlgorithm Algorithm_DefaultValue { get; set; }
		...
		internal override Hashtable ToHashtable(Highcharts highcharts)
		{
			...
			if (Algorithm != PlotOptionsPolygonSonificationPointGroupingAlgorithm.Null) h.Add("algorithm", highcharts.FirstCharacterToLower(Algorithm.ToString()));
