...
{
	public partial class PlotOptionsPolygonSonificationTracksMapping  : BaseObject
	{
		Hashtable h = new Hashtable();

		public PlotOptionsPolygonSonificationTracksMapping()
		{
			Frequency = Frequency_DefaultValue = new PlotOptionsPolygonSonificationTracksMappingFrequency();
			GapBetweenNotes = GapBetweenNotes_DefaultValue = new PlotOptionsPolygonSonificationTracksMappingGapBetweenNotes();
			Highpass = Highpass_DefaultValue = new PlotOptionsPolygonSonificationTracksMappingHighpass();
			Lowpass = Lowpass_DefaultValue = new PlotOptionsPolygonSonificationTracksMappingLowpass();
			NoteDuration = NoteDuration_DefaultValue = new PlotOptionsPolygonSonificationTracksMappingNoteDuration();
			Pan = Pan_DefaultValue = new PlotOptionsPolygonSonificationTracksMappingPan();
			Pitch = Pitch_DefaultValue = new PlotOptionsPolygonSonificationTracksMappingPitch();
			PitchString = PitchString_DefaultValue = "null";
			PitchNumber = PitchNumber_DefaultValue = null;
			PlayDelay = PlayDelay_DefaultValue = new PlotOptionsPolygonSonificationTracksMappingPlayDelay();
			Time = Time_DefaultValue = new PlotOptionsPolygonSonificationTracksMappingTime();
			TimeString = TimeString_DefaultValue = "null";
			TimeNumber = TimeNumber_DefaultValue = null;
			Tremolo = Tremolo_DefaultValue = new PlotOptionsPolygonSonificationTracksMappingTremolo();
			Volume = Volume_DefaultValue = new PlotOptionsPolygonSonificationTracksMappingVolume();
		...
		/// </summary>
		public PlotOptionsPolygonSonificationTracksMappingFrequency Frequency { get; set; }
		private PlotOptionsPolygonSonificationTracksMappingFrequency Frequency_DefaultValue { get; set; }
		...
		/// </summary>
		public PlotOptionsPolygonSonificationTracksMappingGapBetweenNotes GapBetweenNotes { get; set; }
		private PlotOptionsPolygonSonificationTracksMappingGapBetweenNotes GapBetweenNotes_DefaultValue { get; set; }
		...
		/// </summary>
		public PlotOptionsPolygonSonificationTracksMappingHighpass Highpass { get; set; }
		private PlotOptionsPolygonSonificationTracksMappingHighpass Highpass_DefaultValue { get; set; }
		...
		/// </summary>
		public PlotOptionsPolygonSonificationTracksMappingLowpass Lowpass { get; set; }
		private PlotOptionsPolygonSonificationTracksMappingLowpass Lowpass_DefaultValue { get; set; }
		...
		/// </summary>
		public PlotOptionsPolygonSonificationTracksMappingNoteDuration NoteDuration { get; set; }
		private PlotOptionsPolygonSonificationTracksMappingNoteDuration NoteDuration_DefaultValue { get; set; }
		...
		/// </summary>
		public PlotOptionsPolygonSonificationTracksMappingPan Pan { get; set; }
		private PlotOptionsPolygonSonificationTracksMappingPan Pan_DefaultValue { get; set; }
		...
		/// </summary>
		public PlotOptionsPolygonSonificationTracksMappingPitch Pitch { get; set; }
		private PlotOptionsPolygonSonificationTracksMappingPitch Pitch_DefaultValue { get; set; }
		...
		/// </summary>
		public PlotOptionsPolygonSonificationTracksMappingPlayDelay PlayDelay { get; set; }
		private PlotOptionsPolygonSonificationTracksMappingPlayDelay PlayDelay_DefaultValue { get; set; }
		...
		/// </summary>
		public PlotOptionsPolygonSonificationTracksMappingTime Time { get; set; }
		private PlotOptionsPolygonSonificationTracksMappingTime Time_DefaultValue { get; set; }
		...
		/// </summary>
		public PlotOptionsPolygonSonificationTracksMappingTremolo Tremolo { get; set; }
		private PlotOptionsPolygonSonificationTracksMappingTremolo Tremolo_DefaultValue { get; set; }
		 

		/// <summary>
		/// The volume of notes, from 0 to 1.
		/// </summary>
		public PlotOptionsPolygonSonificationTracksMappingVolume Volume { get; set; }
		private PlotOptionsPolygonSonificationTracksMappingVolume Volume_DefaultValue { get; set; }
