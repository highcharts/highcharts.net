...
{
	public partial class PlotOptionsPolygonSonificationTracksMappingNoteDuration  : BaseObject
	{
		Hashtable h = new Hashtable();

		public PlotOptionsPolygonSonificationTracksMappingNoteDuration()
		{
			MapFunction = MapFunction_DefaultValue = PlotOptionsPolygonSonificationTracksMappingNoteDurationMapFunction.Linear;
			MapTo = MapTo_DefaultValue = "";
			Max = Max_DefaultValue = null;
			Min = Min_DefaultValue = null;
			Value = Value_DefaultValue = null;
			Within = Within_DefaultValue = PlotOptionsPolygonSonificationTracksMappingNoteDurationWithin.Chart;
		...
		/// </summary>
		public PlotOptionsPolygonSonificationTracksMappingNoteDurationMapFunction MapFunction { get; set; }
		private PlotOptionsPolygonSonificationTracksMappingNoteDurationMapFunction MapFunction_DefaultValue { get; set; }
		...
		/// </summary>
		public PlotOptionsPolygonSonificationTracksMappingNoteDurationWithin Within { get; set; }
		private PlotOptionsPolygonSonificationTracksMappingNoteDurationWithin Within_DefaultValue { get; set; }
