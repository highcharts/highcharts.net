...
{
	public partial class PlotOptionsPolygonSonificationTracksMappingPan  : BaseObject
	{
		Hashtable h = new Hashtable();

		public PlotOptionsPolygonSonificationTracksMappingPan()
		{
			MapFunction = MapFunction_DefaultValue = PlotOptionsPolygonSonificationTracksMappingPanMapFunction.Linear;
			MapTo = MapTo_DefaultValue = "";
			Max = Max_DefaultValue = null;
			Min = Min_DefaultValue = null;
			Value = Value_DefaultValue = null;
			Within = Within_DefaultValue = PlotOptionsPolygonSonificationTracksMappingPanWithin.Chart;
		...
		/// </summary>
		public PlotOptionsPolygonSonificationTracksMappingPanMapFunction MapFunction { get; set; }
		private PlotOptionsPolygonSonificationTracksMappingPanMapFunction MapFunction_DefaultValue { get; set; }
		...
		/// </summary>
		public PlotOptionsPolygonSonificationTracksMappingPanWithin Within { get; set; }
		private PlotOptionsPolygonSonificationTracksMappingPanWithin Within_DefaultValue { get; set; }
