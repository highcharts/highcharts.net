...
{
	public partial class PlotOptionsPolygonSonificationTracksMappingPitch  : BaseObject
	{
		Hashtable h = new Hashtable();

		public PlotOptionsPolygonSonificationTracksMappingPitch()
		{
			MapFunction = MapFunction_DefaultValue = PlotOptionsPolygonSonificationTracksMappingPitchMapFunction.Linear;
		...
		/// </summary>
		public PlotOptionsPolygonSonificationTracksMappingPitchMapFunction MapFunction { get; set; }
		private PlotOptionsPolygonSonificationTracksMappingPitchMapFunction MapFunction_DefaultValue { get; set; }
