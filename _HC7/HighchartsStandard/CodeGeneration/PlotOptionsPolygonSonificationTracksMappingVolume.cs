...
{
	public partial class PlotOptionsPolygonSonificationTracksMappingVolume  : BaseObject
	{
		Hashtable h = new Hashtable();

		public PlotOptionsPolygonSonificationTracksMappingVolume()
		{
			MapFunction = MapFunction_DefaultValue = PlotOptionsPolygonSonificationTracksMappingVolumeMapFunction.Linear;
			MapTo = MapTo_DefaultValue = "";
			Max = Max_DefaultValue = null;
			Min = Min_DefaultValue = null;
			Value = Value_DefaultValue = null;
			Within = Within_DefaultValue = PlotOptionsPolygonSonificationTracksMappingVolumeWithin.Chart;
		...
		/// </summary>
		public PlotOptionsPolygonSonificationTracksMappingVolumeMapFunction MapFunction { get; set; }
		private PlotOptionsPolygonSonificationTracksMappingVolumeMapFunction MapFunction_DefaultValue { get; set; }
		...
		/// </summary>
		public PlotOptionsPolygonSonificationTracksMappingVolumeWithin Within { get; set; }
		private PlotOptionsPolygonSonificationTracksMappingVolumeWithin Within_DefaultValue { get; set; }
