...
{
	public partial class PlotOptionsPolygonSonificationTracksPointGrouping  : BaseObject
	{
		Hashtable h = new Hashtable();

		public PlotOptionsPolygonSonificationTracksPointGrouping()
		{
		...
		/// </summary>
		public PlotOptionsPolygonSonificationTracksPointGroupingAlgorithm Algorithm { get; set; }
		private PlotOptionsPolygonSonificationTracksPointGroupingAlgorithm Algorithm_DefaultValue { get; set; }
		...
		internal override Hashtable ToHashtable(Highcharts highcharts)
		{
			...
			if (Algorithm != PlotOptionsPolygonSonificationTracksPointGroupingAlgorithm.Null) h.Add("algorithm", highcharts.FirstCharacterToLower(Algorithm.ToString()));
