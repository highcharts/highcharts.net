...
namespace Highsoft.Web.Mvc.Charts
{
	public partial class PlotOptionsPyramid3d  : BaseObject
	{
		...
		internal override Hashtable ToHashtable()
		{
			...
			if (PointDescriptionFormatter != PointDescriptionFormatter_DefaultValue) { h.Add("pointDescriptionFormatter",PointDescriptionFormatter); Highcharts.AddFunction("650ce4aa-c067-4531-8056-69342b44c391.pointDescriptionFormatter", PointDescriptionFormatter); }  
