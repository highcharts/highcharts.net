...
{
	public partial class PlotOptionsPyramid3dDataLabels  : BaseObject
	{
		Hashtable h = new Hashtable();

		public PlotOptionsPyramid3dDataLabels()
		{
		...
		/// </summary>
		public PlotOptionsPyramid3dDataLabelsAlign Align { get; set; }
		private PlotOptionsPyramid3dDataLabelsAlign Align_DefaultValue { get; set; }
		...
		/// </summary>
		public PlotOptionsPyramid3dDataLabelsFilter Filter { get; set; }
		private PlotOptionsPyramid3dDataLabelsFilter Filter_DefaultValue { get; set; }
		...
		/// </summary>
		public PlotOptionsPyramid3dDataLabelsOverflow Overflow { get; set; }
		private PlotOptionsPyramid3dDataLabelsOverflow Overflow_DefaultValue { get; set; }
		...
		/// </summary>
		public PlotOptionsPyramid3dDataLabelsPosition Position { get; set; }
		private PlotOptionsPyramid3dDataLabelsPosition Position_DefaultValue { get; set; }
		...
		/// </summary>
		public PlotOptionsPyramid3dDataLabelsTextPath TextPath { get; set; }
		private PlotOptionsPyramid3dDataLabelsTextPath TextPath_DefaultValue { get; set; }
		...
		internal override Hashtable ToHashtable(Highcharts highcharts)
		{
			...
			if (Align != PlotOptionsPyramid3dDataLabelsAlign.Null) h.Add("align", highcharts.FirstCharacterToLower(Align.ToString()));
			...
			if (Overflow != PlotOptionsPyramid3dDataLabelsOverflow.Null) h.Add("overflow", highcharts.FirstCharacterToLower(Overflow.ToString()));
			if (Padding != null) h.Add("padding",Padding);
			if (Position != PlotOptionsPyramid3dDataLabelsPosition.Null) h.Add("position", highcharts.FirstCharacterToLower(Position.ToString()));
			...
			if (VerticalAlign != PlotOptionsPyramid3dDataLabelsVerticalAlign.Null) h.Add("verticalAlign", highcharts.FirstCharacterToLower(VerticalAlign.ToString()));
			if (X != null) h.Add("x",X);
			if (Y != null) h.Add("y",Y);
