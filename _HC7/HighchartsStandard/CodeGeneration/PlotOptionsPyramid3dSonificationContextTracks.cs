...
{
	public partial class PlotOptionsPyramid3dSonificationContextTracks  : BaseObject
	{
		Hashtable h = new Hashtable();

		public PlotOptionsPyramid3dSonificationContextTracks()
		{
			ActiveWhen = ActiveWhen_DefaultValue = new PlotOptionsPyramid3dSonificationContextTracksActiveWhen();
			Instrument = Instrument_DefaultValue = null;
			InstrumentString = InstrumentString_DefaultValue = "null";
			Mapping = Mapping_DefaultValue = new PlotOptionsPyramid3dSonificationContextTracksMapping();
			MidiName = MidiName_DefaultValue = "";
			PointGrouping = PointGrouping_DefaultValue = new PlotOptionsPyramid3dSonificationContextTracksPointGrouping();
			...
			Type = Type_DefaultValue = PlotOptionsPyramid3dSonificationContextTracksType.Instrument;
			ValueInterval = ValueInterval_DefaultValue = null;
			ValueMapFunction = ValueMapFunction_DefaultValue = PlotOptionsPyramid3dSonificationContextTracksValueMapFunction.Linear;
		...
		/// </summary>
		public PlotOptionsPyramid3dSonificationContextTracksActiveWhen ActiveWhen { get; set; }
		private PlotOptionsPyramid3dSonificationContextTracksActiveWhen ActiveWhen_DefaultValue { get; set; }
		...
		/// </summary>
		public PlotOptionsPyramid3dSonificationContextTracksMapping Mapping { get; set; }
		private PlotOptionsPyramid3dSonificationContextTracksMapping Mapping_DefaultValue { get; set; }
		...
		/// </summary>
		public PlotOptionsPyramid3dSonificationContextTracksPointGrouping PointGrouping { get; set; }
		private PlotOptionsPyramid3dSonificationContextTracksPointGrouping PointGrouping_DefaultValue { get; set; }
		...
		/// </summary>
		public PlotOptionsPyramid3dSonificationContextTracksType Type { get; set; }
		private PlotOptionsPyramid3dSonificationContextTracksType Type_DefaultValue { get; set; }
		...
		/// </summary>
		public PlotOptionsPyramid3dSonificationContextTracksValueMapFunction ValueMapFunction { get; set; }
		private PlotOptionsPyramid3dSonificationContextTracksValueMapFunction ValueMapFunction_DefaultValue { get; set; }
