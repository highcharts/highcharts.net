...
{
	public partial class PlotOptionsPyramid3dSonificationContextTracksMappingLowpassResonance  : BaseObject
	{
		Hashtable h = new Hashtable();

		public PlotOptionsPyramid3dSonificationContextTracksMappingLowpassResonance()
		{
			MapFunction = MapFunction_DefaultValue = PlotOptionsPyramid3dSonificationContextTracksMappingLowpassResonanceMapFunction.Linear;
			MapTo = MapTo_DefaultValue = "";
			Max = Max_DefaultValue = null;
			Min = Min_DefaultValue = null;
			Value = Value_DefaultValue = null;
			Within = Within_DefaultValue = PlotOptionsPyramid3dSonificationContextTracksMappingLowpassResonanceWithin.Chart;
		...
		/// </summary>
		public PlotOptionsPyramid3dSonificationContextTracksMappingLowpassResonanceMapFunction MapFunction { get; set; }
		private PlotOptionsPyramid3dSonificationContextTracksMappingLowpassResonanceMapFunction MapFunction_DefaultValue { get; set; }
		...
		/// </summary>
		public PlotOptionsPyramid3dSonificationContextTracksMappingLowpassResonanceWithin Within { get; set; }
		private PlotOptionsPyramid3dSonificationContextTracksMappingLowpassResonanceWithin Within_DefaultValue { get; set; }
