...
{
	public partial class PlotOptionsPyramid3dSonificationContextTracksMappingPlayDelay  : BaseObject
	{
		Hashtable h = new Hashtable();

		public PlotOptionsPyramid3dSonificationContextTracksMappingPlayDelay()
		{
			MapFunction = MapFunction_DefaultValue = PlotOptionsPyramid3dSonificationContextTracksMappingPlayDelayMapFunction.Linear;
			MapTo = MapTo_DefaultValue = "";
			Max = Max_DefaultValue = null;
			Min = Min_DefaultValue = null;
			Value = Value_DefaultValue = null;
			Within = Within_DefaultValue = PlotOptionsPyramid3dSonificationContextTracksMappingPlayDelayWithin.Chart;
		...
		/// </summary>
		public PlotOptionsPyramid3dSonificationContextTracksMappingPlayDelayMapFunction MapFunction { get; set; }
		private PlotOptionsPyramid3dSonificationContextTracksMappingPlayDelayMapFunction MapFunction_DefaultValue { get; set; }
		...
		/// </summary>
		public PlotOptionsPyramid3dSonificationContextTracksMappingPlayDelayWithin Within { get; set; }
		private PlotOptionsPyramid3dSonificationContextTracksMappingPlayDelayWithin Within_DefaultValue { get; set; }
