...
{
	public partial class PlotOptionsPyramid3dSonificationContextTracksPointGrouping  : BaseObject
	{
		Hashtable h = new Hashtable();

		public PlotOptionsPyramid3dSonificationContextTracksPointGrouping()
		{
		...
		/// </summary>
		public PlotOptionsPyramid3dSonificationContextTracksPointGroupingAlgorithm Algorithm { get; set; }
		private PlotOptionsPyramid3dSonificationContextTracksPointGroupingAlgorithm Algorithm_DefaultValue { get; set; }
		...
		internal override Hashtable ToHashtable(Highcharts highcharts)
		{
			...
			if (Algorithm != PlotOptionsPyramid3dSonificationContextTracksPointGroupingAlgorithm.Null) h.Add("algorithm", highcharts.FirstCharacterToLower(Algorithm.ToString()));
