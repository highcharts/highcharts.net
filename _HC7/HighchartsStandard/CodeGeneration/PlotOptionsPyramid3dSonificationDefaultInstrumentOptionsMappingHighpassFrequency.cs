...
namespace Highsoft.Web.Mvc.Charts
{
	public partial class PlotOptionsPyramid3dSonificationDefaultInstrumentOptionsMappingHighpassFrequency  : BaseObject
	{
		...
		{
			if (MapFunction != PlotOptionsPyramid3dSonificationDefaultInstrumentOptionsMappingHighpassFrequencyMapFunction.Null) h.Add("mapFunction", highcharts.FirstCharacterToLower(MapFunction.ToString()));
			if (MapTo != null) h.Add("mapTo",MapTo);
			if (Max != null) h.Add("max",Max);
			if (Min != null) h.Add("min",Min);
			if (Value != null) h.Add("value",Value);
			if (Within != PlotOptionsPyramid3dSonificationDefaultInstrumentOptionsMappingHighpassFrequencyWithin.Null) h.Add("within", highcharts.FirstCharacterToLower(Within.ToString()));
