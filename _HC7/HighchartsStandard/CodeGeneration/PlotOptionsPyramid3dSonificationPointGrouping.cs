...
{
	public partial class PlotOptionsPyramid3dSonificationPointGrouping  : BaseObject
	{
		Hashtable h = new Hashtable();

		public PlotOptionsPyramid3dSonificationPointGrouping()
		{
		...
		/// </summary>
		public PlotOptionsPyramid3dSonificationPointGroupingAlgorithm Algorithm { get; set; }
		private PlotOptionsPyramid3dSonificationPointGroupingAlgorithm Algorithm_DefaultValue { get; set; }
		...
		internal override Hashtable ToHashtable(Highcharts highcharts)
		{
			...
			if (Algorithm != PlotOptionsPyramid3dSonificationPointGroupingAlgorithm.Null) h.Add("algorithm", highcharts.FirstCharacterToLower(Algorithm.ToString()));
