...
{
	public partial class PlotOptionsPyramid3dSonificationTracksMapping  : BaseObject
	{
		Hashtable h = new Hashtable();

		public PlotOptionsPyramid3dSonificationTracksMapping()
		{
			Frequency = Frequency_DefaultValue = new PlotOptionsPyramid3dSonificationTracksMappingFrequency();
			GapBetweenNotes = GapBetweenNotes_DefaultValue = new PlotOptionsPyramid3dSonificationTracksMappingGapBetweenNotes();
			Highpass = Highpass_DefaultValue = new PlotOptionsPyramid3dSonificationTracksMappingHighpass();
			Lowpass = Lowpass_DefaultValue = new PlotOptionsPyramid3dSonificationTracksMappingLowpass();
			NoteDuration = NoteDuration_DefaultValue = new PlotOptionsPyramid3dSonificationTracksMappingNoteDuration();
			Pan = Pan_DefaultValue = new PlotOptionsPyramid3dSonificationTracksMappingPan();
			Pitch = Pitch_DefaultValue = new PlotOptionsPyramid3dSonificationTracksMappingPitch();
			PitchString = PitchString_DefaultValue = "null";
			PitchNumber = PitchNumber_DefaultValue = null;
			PlayDelay = PlayDelay_DefaultValue = new PlotOptionsPyramid3dSonificationTracksMappingPlayDelay();
			Time = Time_DefaultValue = new PlotOptionsPyramid3dSonificationTracksMappingTime();
			TimeString = TimeString_DefaultValue = "null";
			TimeNumber = TimeNumber_DefaultValue = null;
			Tremolo = Tremolo_DefaultValue = new PlotOptionsPyramid3dSonificationTracksMappingTremolo();
			Volume = Volume_DefaultValue = new PlotOptionsPyramid3dSonificationTracksMappingVolume();
		...
		/// </summary>
		public PlotOptionsPyramid3dSonificationTracksMappingFrequency Frequency { get; set; }
		private PlotOptionsPyramid3dSonificationTracksMappingFrequency Frequency_DefaultValue { get; set; }
		...
		/// </summary>
		public PlotOptionsPyramid3dSonificationTracksMappingGapBetweenNotes GapBetweenNotes { get; set; }
		private PlotOptionsPyramid3dSonificationTracksMappingGapBetweenNotes GapBetweenNotes_DefaultValue { get; set; }
		...
		/// </summary>
		public PlotOptionsPyramid3dSonificationTracksMappingHighpass Highpass { get; set; }
		private PlotOptionsPyramid3dSonificationTracksMappingHighpass Highpass_DefaultValue { get; set; }
		...
		/// </summary>
		public PlotOptionsPyramid3dSonificationTracksMappingLowpass Lowpass { get; set; }
		private PlotOptionsPyramid3dSonificationTracksMappingLowpass Lowpass_DefaultValue { get; set; }
		...
		/// </summary>
		public PlotOptionsPyramid3dSonificationTracksMappingNoteDuration NoteDuration { get; set; }
		private PlotOptionsPyramid3dSonificationTracksMappingNoteDuration NoteDuration_DefaultValue { get; set; }
		...
		/// </summary>
		public PlotOptionsPyramid3dSonificationTracksMappingPan Pan { get; set; }
		private PlotOptionsPyramid3dSonificationTracksMappingPan Pan_DefaultValue { get; set; }
		...
		/// </summary>
		public PlotOptionsPyramid3dSonificationTracksMappingPitch Pitch { get; set; }
		private PlotOptionsPyramid3dSonificationTracksMappingPitch Pitch_DefaultValue { get; set; }
		...
		/// </summary>
		public PlotOptionsPyramid3dSonificationTracksMappingPlayDelay PlayDelay { get; set; }
		private PlotOptionsPyramid3dSonificationTracksMappingPlayDelay PlayDelay_DefaultValue { get; set; }
		...
		/// </summary>
		public PlotOptionsPyramid3dSonificationTracksMappingTime Time { get; set; }
		private PlotOptionsPyramid3dSonificationTracksMappingTime Time_DefaultValue { get; set; }
		...
		/// </summary>
		public PlotOptionsPyramid3dSonificationTracksMappingTremolo Tremolo { get; set; }
		private PlotOptionsPyramid3dSonificationTracksMappingTremolo Tremolo_DefaultValue { get; set; }
		 

		/// <summary>
		/// The volume of notes, from 0 to 1.
		/// </summary>
		public PlotOptionsPyramid3dSonificationTracksMappingVolume Volume { get; set; }
		private PlotOptionsPyramid3dSonificationTracksMappingVolume Volume_DefaultValue { get; set; }
