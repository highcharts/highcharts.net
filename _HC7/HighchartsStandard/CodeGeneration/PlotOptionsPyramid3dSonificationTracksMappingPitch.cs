...
{
	public partial class PlotOptionsPyramid3dSonificationTracksMappingPitch  : BaseObject
	{
		Hashtable h = new Hashtable();

		public PlotOptionsPyramid3dSonificationTracksMappingPitch()
		{
			MapFunction = MapFunction_DefaultValue = PlotOptionsPyramid3dSonificationTracksMappingPitchMapFunction.Linear;
		...
		/// </summary>
		public PlotOptionsPyramid3dSonificationTracksMappingPitchMapFunction MapFunction { get; set; }
		private PlotOptionsPyramid3dSonificationTracksMappingPitchMapFunction MapFunction_DefaultValue { get; set; }
