...
{
	public partial class PlotOptionsPyramid3dSonificationTracksMappingTime  : BaseObject
	{
		Hashtable h = new Hashtable();

		public PlotOptionsPyramid3dSonificationTracksMappingTime()
		{
			MapFunction = MapFunction_DefaultValue = PlotOptionsPyramid3dSonificationTracksMappingTimeMapFunction.Linear;
			MapTo = MapTo_DefaultValue = "";
			Max = Max_DefaultValue = null;
			Min = Min_DefaultValue = null;
			Value = Value_DefaultValue = null;
			Within = Within_DefaultValue = PlotOptionsPyramid3dSonificationTracksMappingTimeWithin.Chart;
		...
		/// </summary>
		public PlotOptionsPyramid3dSonificationTracksMappingTimeMapFunction MapFunction { get; set; }
		private PlotOptionsPyramid3dSonificationTracksMappingTimeMapFunction MapFunction_DefaultValue { get; set; }
		...
		/// </summary>
		public PlotOptionsPyramid3dSonificationTracksMappingTimeWithin Within { get; set; }
		private PlotOptionsPyramid3dSonificationTracksMappingTimeWithin Within_DefaultValue { get; set; }
