...
{
	public partial class PlotOptionsPyramid3dSonificationTracksPointGrouping  : BaseObject
	{
		Hashtable h = new Hashtable();

		public PlotOptionsPyramid3dSonificationTracksPointGrouping()
		{
		...
		/// </summary>
		public PlotOptionsPyramid3dSonificationTracksPointGroupingAlgorithm Algorithm { get; set; }
		private PlotOptionsPyramid3dSonificationTracksPointGroupingAlgorithm Algorithm_DefaultValue { get; set; }
		...
		internal override Hashtable ToHashtable(Highcharts highcharts)
		{
			...
			if (Algorithm != PlotOptionsPyramid3dSonificationTracksPointGroupingAlgorithm.Null) h.Add("algorithm", highcharts.FirstCharacterToLower(Algorithm.ToString()));
