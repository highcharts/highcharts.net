...
{
	public partial class PlotOptionsPyramid3dTooltip  : BaseObject
	{
		public PlotOptionsPyramid3dTooltip()
		{
			...
			HeaderShape = HeaderShape_DefaultValue = PlotOptionsPyramid3dTooltipHeaderShape.Callout;
		...
		/// </summary>
		public PlotOptionsPyramid3dTooltipHeaderShape HeaderShape { get; set; }
		private PlotOptionsPyramid3dTooltipHeaderShape HeaderShape_DefaultValue { get; set; }
		...
		internal override Hashtable ToHashtable()
		{
			...
			if (NullFormatter != NullFormatter_DefaultValue) { h.Add("nullFormatter",NullFormatter); Highcharts.AddFunction("PlotOptionsPyramid3dTooltipNullFormatter.nullFormatter", NullFormatter); }  
			if (Outside != Outside_DefaultValue) h.Add("outside",Outside);
			if (Padding != Padding_DefaultValue) h.Add("padding",Padding);
			if (PointFormat != PointFormat_DefaultValue) h.Add("pointFormat",PointFormat);
			if (PointFormatter != PointFormatter_DefaultValue) { h.Add("pointFormatter",PointFormatter); Highcharts.AddFunction("PlotOptionsPyramid3dTooltipPointFormatter.pointFormatter", PointFormatter); }  
