...
namespace Highsoft.Web.Mvc.Charts
{
	public partial class PlotOptionsPyramidDataLabels  : BaseObject
	{
		...
		/// </summary>
		public PlotOptionsPyramidDataLabelsAlign Align { get; set; }
		private PlotOptionsPyramidDataLabelsAlign Align_DefaultValue { get; set; }
		...
		/// </summary>
		public PlotOptionsPyramidDataLabelsFilter Filter { get; set; }
		private PlotOptionsPyramidDataLabelsFilter Filter_DefaultValue { get; set; }
		...
		/// </summary>
		public PlotOptionsPyramidDataLabelsPosition Position { get; set; }
		private PlotOptionsPyramidDataLabelsPosition Position_DefaultValue { get; set; }
		...
		/// </summary>
		public PlotOptionsPyramidDataLabelsTextPath TextPath { get; set; }
		private PlotOptionsPyramidDataLabelsTextPath TextPath_DefaultValue { get; set; }
		...
		internal override Hashtable ToHashtable(Highcharts highcharts)
		{
			...
			if (Align != PlotOptionsPyramidDataLabelsAlign.Null) h.Add("align", highcharts.FirstCharacterToLower(Align.ToString()));
			...
			if (Overflow != PlotOptionsPyramidDataLabelsOverflow.Null) h.Add("overflow", highcharts.FirstCharacterToLower(Overflow.ToString()));
			if (Padding != null) h.Add("padding",Padding);
			if (Position != PlotOptionsPyramidDataLabelsPosition.Null) h.Add("position", highcharts.FirstCharacterToLower(Position.ToString()));
			...
			if (VerticalAlign != PlotOptionsPyramidDataLabelsVerticalAlign.Null) h.Add("verticalAlign", highcharts.FirstCharacterToLower(VerticalAlign.ToString()));
			if (X != null) h.Add("x",X);
			if (Y != null) h.Add("y",Y);
