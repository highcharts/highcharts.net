...
namespace Highsoft.Web.Mvc.Charts
{
	public partial class PlotOptionsPyramidDataLabels  : BaseObject
	{
		...
		{
			Align = Align_DefaultValue = PlotOptionsPyramidDataLabelsAlign.Center;
			...
			Filter = Filter_DefaultValue = new PlotOptionsPyramidDataLabelsFilter();
			...
			Overflow = Overflow_DefaultValue = PlotOptionsPyramidDataLabelsOverflow.Justify;
			Padding = Padding_DefaultValue = 5;
			Position = Position_DefaultValue = PlotOptionsPyramidDataLabelsPosition.Center;
			...
			TextPath = TextPath_DefaultValue = new PlotOptionsPyramidDataLabelsTextPath();
			UseHTML = UseHTML_DefaultValue = false;
			VerticalAlign = VerticalAlign_DefaultValue = PlotOptionsPyramidDataLabelsVerticalAlign.Bottom;
			X = X_DefaultValue = 0;
			Y = Y_DefaultValue = 0;
