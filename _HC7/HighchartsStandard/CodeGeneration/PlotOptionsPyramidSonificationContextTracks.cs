...
{
	public partial class PlotOptionsPyramidSonificationContextTracks  : BaseObject
	{
		Hashtable h = new Hashtable();

		public PlotOptionsPyramidSonificationContextTracks()
		{
			ActiveWhen = ActiveWhen_DefaultValue = new PlotOptionsPyramidSonificationContextTracksActiveWhen();
			Instrument = Instrument_DefaultValue = null;
			InstrumentString = InstrumentString_DefaultValue = "null";
			Mapping = Mapping_DefaultValue = new PlotOptionsPyramidSonificationContextTracksMapping();
			MidiName = MidiName_DefaultValue = "";
			PointGrouping = PointGrouping_DefaultValue = new PlotOptionsPyramidSonificationContextTracksPointGrouping();
			...
			Type = Type_DefaultValue = PlotOptionsPyramidSonificationContextTracksType.Instrument;
			ValueInterval = ValueInterval_DefaultValue = null;
			ValueMapFunction = ValueMapFunction_DefaultValue = PlotOptionsPyramidSonificationContextTracksValueMapFunction.Linear;
		...
		/// </summary>
		public PlotOptionsPyramidSonificationContextTracksActiveWhen ActiveWhen { get; set; }
		private PlotOptionsPyramidSonificationContextTracksActiveWhen ActiveWhen_DefaultValue { get; set; }
		...
		/// </summary>
		public PlotOptionsPyramidSonificationContextTracksMapping Mapping { get; set; }
		private PlotOptionsPyramidSonificationContextTracksMapping Mapping_DefaultValue { get; set; }
		...
		/// </summary>
		public PlotOptionsPyramidSonificationContextTracksPointGrouping PointGrouping { get; set; }
		private PlotOptionsPyramidSonificationContextTracksPointGrouping PointGrouping_DefaultValue { get; set; }
		...
		/// </summary>
		public PlotOptionsPyramidSonificationContextTracksType Type { get; set; }
		private PlotOptionsPyramidSonificationContextTracksType Type_DefaultValue { get; set; }
		...
		/// </summary>
		public PlotOptionsPyramidSonificationContextTracksValueMapFunction ValueMapFunction { get; set; }
		private PlotOptionsPyramidSonificationContextTracksValueMapFunction ValueMapFunction_DefaultValue { get; set; }
