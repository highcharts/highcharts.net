...
{
	public partial class PlotOptionsPyramidSonificationContextTracksMapping  : BaseObject
	{
		Hashtable h = new Hashtable();

		public PlotOptionsPyramidSonificationContextTracksMapping()
		{
			Frequency = Frequency_DefaultValue = new PlotOptionsPyramidSonificationContextTracksMappingFrequency();
			GapBetweenNotes = GapBetweenNotes_DefaultValue = new PlotOptionsPyramidSonificationContextTracksMappingGapBetweenNotes();
			Highpass = Highpass_DefaultValue = new PlotOptionsPyramidSonificationContextTracksMappingHighpass();
			Lowpass = Lowpass_DefaultValue = new PlotOptionsPyramidSonificationContextTracksMappingLowpass();
			NoteDuration = NoteDuration_DefaultValue = new PlotOptionsPyramidSonificationContextTracksMappingNoteDuration();
			Pan = Pan_DefaultValue = new PlotOptionsPyramidSonificationContextTracksMappingPan();
			Pitch = Pitch_DefaultValue = new PlotOptionsPyramidSonificationContextTracksMappingPitch();
			PitchString = PitchString_DefaultValue = "null";
			PitchNumber = PitchNumber_DefaultValue = null;
			PlayDelay = PlayDelay_DefaultValue = new PlotOptionsPyramidSonificationContextTracksMappingPlayDelay();
			Time = Time_DefaultValue = new PlotOptionsPyramidSonificationContextTracksMappingTime();
			TimeString = TimeString_DefaultValue = "null";
			TimeNumber = TimeNumber_DefaultValue = null;
			Tremolo = Tremolo_DefaultValue = new PlotOptionsPyramidSonificationContextTracksMappingTremolo();
			Volume = Volume_DefaultValue = new PlotOptionsPyramidSonificationContextTracksMappingVolume();
		...
		/// </summary>
		public PlotOptionsPyramidSonificationContextTracksMappingFrequency Frequency { get; set; }
		private PlotOptionsPyramidSonificationContextTracksMappingFrequency Frequency_DefaultValue { get; set; }
		...
		/// </summary>
		public PlotOptionsPyramidSonificationContextTracksMappingGapBetweenNotes GapBetweenNotes { get; set; }
		private PlotOptionsPyramidSonificationContextTracksMappingGapBetweenNotes GapBetweenNotes_DefaultValue { get; set; }
		...
		/// </summary>
		public PlotOptionsPyramidSonificationContextTracksMappingHighpass Highpass { get; set; }
		private PlotOptionsPyramidSonificationContextTracksMappingHighpass Highpass_DefaultValue { get; set; }
		...
		/// </summary>
		public PlotOptionsPyramidSonificationContextTracksMappingLowpass Lowpass { get; set; }
		private PlotOptionsPyramidSonificationContextTracksMappingLowpass Lowpass_DefaultValue { get; set; }
		...
		/// </summary>
		public PlotOptionsPyramidSonificationContextTracksMappingNoteDuration NoteDuration { get; set; }
		private PlotOptionsPyramidSonificationContextTracksMappingNoteDuration NoteDuration_DefaultValue { get; set; }
		...
		/// </summary>
		public PlotOptionsPyramidSonificationContextTracksMappingPan Pan { get; set; }
		private PlotOptionsPyramidSonificationContextTracksMappingPan Pan_DefaultValue { get; set; }
		...
		/// </summary>
		public PlotOptionsPyramidSonificationContextTracksMappingPitch Pitch { get; set; }
		private PlotOptionsPyramidSonificationContextTracksMappingPitch Pitch_DefaultValue { get; set; }
		...
		/// </summary>
		public PlotOptionsPyramidSonificationContextTracksMappingPlayDelay PlayDelay { get; set; }
		private PlotOptionsPyramidSonificationContextTracksMappingPlayDelay PlayDelay_DefaultValue { get; set; }
		...
		/// </summary>
		public PlotOptionsPyramidSonificationContextTracksMappingTime Time { get; set; }
		private PlotOptionsPyramidSonificationContextTracksMappingTime Time_DefaultValue { get; set; }
		...
		/// </summary>
		public PlotOptionsPyramidSonificationContextTracksMappingTremolo Tremolo { get; set; }
		private PlotOptionsPyramidSonificationContextTracksMappingTremolo Tremolo_DefaultValue { get; set; }
		 

		/// <summary>
		/// The volume of notes, from 0 to 1.
		/// </summary>
		public PlotOptionsPyramidSonificationContextTracksMappingVolume Volume { get; set; }
		private PlotOptionsPyramidSonificationContextTracksMappingVolume Volume_DefaultValue { get; set; }
