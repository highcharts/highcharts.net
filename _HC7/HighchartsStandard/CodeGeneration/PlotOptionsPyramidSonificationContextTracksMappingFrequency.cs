...
{
	public partial class PlotOptionsPyramidSonificationContextTracksMappingFrequency  : BaseObject
	{
		Hashtable h = new Hashtable();

		public PlotOptionsPyramidSonificationContextTracksMappingFrequency()
		{
			MapFunction = MapFunction_DefaultValue = PlotOptionsPyramidSonificationContextTracksMappingFrequencyMapFunction.Linear;
			MapTo = MapTo_DefaultValue = "";
			Max = Max_DefaultValue = null;
			Min = Min_DefaultValue = null;
			Value = Value_DefaultValue = null;
			Within = Within_DefaultValue = PlotOptionsPyramidSonificationContextTracksMappingFrequencyWithin.Chart;
		...
		/// </summary>
		public PlotOptionsPyramidSonificationContextTracksMappingFrequencyMapFunction MapFunction { get; set; }
		private PlotOptionsPyramidSonificationContextTracksMappingFrequencyMapFunction MapFunction_DefaultValue { get; set; }
		...
		/// </summary>
		public PlotOptionsPyramidSonificationContextTracksMappingFrequencyWithin Within { get; set; }
		private PlotOptionsPyramidSonificationContextTracksMappingFrequencyWithin Within_DefaultValue { get; set; }
