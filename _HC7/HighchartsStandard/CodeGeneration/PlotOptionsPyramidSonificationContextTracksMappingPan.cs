...
{
	public partial class PlotOptionsPyramidSonificationContextTracksMappingPan  : BaseObject
	{
		Hashtable h = new Hashtable();

		public PlotOptionsPyramidSonificationContextTracksMappingPan()
		{
			MapFunction = MapFunction_DefaultValue = PlotOptionsPyramidSonificationContextTracksMappingPanMapFunction.Linear;
			MapTo = MapTo_DefaultValue = "";
			Max = Max_DefaultValue = null;
			Min = Min_DefaultValue = null;
			Value = Value_DefaultValue = null;
			Within = Within_DefaultValue = PlotOptionsPyramidSonificationContextTracksMappingPanWithin.Chart;
		...
		/// </summary>
		public PlotOptionsPyramidSonificationContextTracksMappingPanMapFunction MapFunction { get; set; }
		private PlotOptionsPyramidSonificationContextTracksMappingPanMapFunction MapFunction_DefaultValue { get; set; }
		...
		/// </summary>
		public PlotOptionsPyramidSonificationContextTracksMappingPanWithin Within { get; set; }
		private PlotOptionsPyramidSonificationContextTracksMappingPanWithin Within_DefaultValue { get; set; }
