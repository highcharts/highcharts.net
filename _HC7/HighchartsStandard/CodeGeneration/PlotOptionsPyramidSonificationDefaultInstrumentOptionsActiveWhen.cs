...
{
	public partial class PlotOptionsPyramidSonificationDefaultInstrumentOptionsActiveWhen  : BaseObject
	{
		Hashtable h = new Hashtable();

		public PlotOptionsPyramidSonificationDefaultInstrumentOptionsActiveWhen()
		{
