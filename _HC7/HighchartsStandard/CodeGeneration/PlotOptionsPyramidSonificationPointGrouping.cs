...
{
	public partial class PlotOptionsPyramidSonificationPointGrouping  : BaseObject
	{
		Hashtable h = new Hashtable();

		public PlotOptionsPyramidSonificationPointGrouping()
		{
		...
		/// </summary>
		public PlotOptionsPyramidSonificationPointGroupingAlgorithm Algorithm { get; set; }
		private PlotOptionsPyramidSonificationPointGroupingAlgorithm Algorithm_DefaultValue { get; set; }
		...
		internal override Hashtable ToHashtable(Highcharts highcharts)
		{
			...
			if (Algorithm != PlotOptionsPyramidSonificationPointGroupingAlgorithm.Null) h.Add("algorithm", highcharts.FirstCharacterToLower(Algorithm.ToString()));
