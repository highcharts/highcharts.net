...
{
	public partial class PlotOptionsPyramidSonificationTracksMapping  : BaseObject
	{
		Hashtable h = new Hashtable();

		public PlotOptionsPyramidSonificationTracksMapping()
		{
			Frequency = Frequency_DefaultValue = new PlotOptionsPyramidSonificationTracksMappingFrequency();
			GapBetweenNotes = GapBetweenNotes_DefaultValue = new PlotOptionsPyramidSonificationTracksMappingGapBetweenNotes();
			Highpass = Highpass_DefaultValue = new PlotOptionsPyramidSonificationTracksMappingHighpass();
			Lowpass = Lowpass_DefaultValue = new PlotOptionsPyramidSonificationTracksMappingLowpass();
			NoteDuration = NoteDuration_DefaultValue = new PlotOptionsPyramidSonificationTracksMappingNoteDuration();
			Pan = Pan_DefaultValue = new PlotOptionsPyramidSonificationTracksMappingPan();
			Pitch = Pitch_DefaultValue = new PlotOptionsPyramidSonificationTracksMappingPitch();
			PitchString = PitchString_DefaultValue = "null";
			PitchNumber = PitchNumber_DefaultValue = null;
			PlayDelay = PlayDelay_DefaultValue = new PlotOptionsPyramidSonificationTracksMappingPlayDelay();
			Time = Time_DefaultValue = new PlotOptionsPyramidSonificationTracksMappingTime();
			TimeString = TimeString_DefaultValue = "null";
			TimeNumber = TimeNumber_DefaultValue = null;
			Tremolo = Tremolo_DefaultValue = new PlotOptionsPyramidSonificationTracksMappingTremolo();
			Volume = Volume_DefaultValue = new PlotOptionsPyramidSonificationTracksMappingVolume();
		...
		/// </summary>
		public PlotOptionsPyramidSonificationTracksMappingFrequency Frequency { get; set; }
		private PlotOptionsPyramidSonificationTracksMappingFrequency Frequency_DefaultValue { get; set; }
		...
		/// </summary>
		public PlotOptionsPyramidSonificationTracksMappingGapBetweenNotes GapBetweenNotes { get; set; }
		private PlotOptionsPyramidSonificationTracksMappingGapBetweenNotes GapBetweenNotes_DefaultValue { get; set; }
		...
		/// </summary>
		public PlotOptionsPyramidSonificationTracksMappingHighpass Highpass { get; set; }
		private PlotOptionsPyramidSonificationTracksMappingHighpass Highpass_DefaultValue { get; set; }
		...
		/// </summary>
		public PlotOptionsPyramidSonificationTracksMappingLowpass Lowpass { get; set; }
		private PlotOptionsPyramidSonificationTracksMappingLowpass Lowpass_DefaultValue { get; set; }
		...
		/// </summary>
		public PlotOptionsPyramidSonificationTracksMappingNoteDuration NoteDuration { get; set; }
		private PlotOptionsPyramidSonificationTracksMappingNoteDuration NoteDuration_DefaultValue { get; set; }
		...
		/// </summary>
		public PlotOptionsPyramidSonificationTracksMappingPan Pan { get; set; }
		private PlotOptionsPyramidSonificationTracksMappingPan Pan_DefaultValue { get; set; }
		...
		/// </summary>
		public PlotOptionsPyramidSonificationTracksMappingPitch Pitch { get; set; }
		private PlotOptionsPyramidSonificationTracksMappingPitch Pitch_DefaultValue { get; set; }
		...
		/// </summary>
		public PlotOptionsPyramidSonificationTracksMappingPlayDelay PlayDelay { get; set; }
		private PlotOptionsPyramidSonificationTracksMappingPlayDelay PlayDelay_DefaultValue { get; set; }
		...
		/// </summary>
		public PlotOptionsPyramidSonificationTracksMappingTime Time { get; set; }
		private PlotOptionsPyramidSonificationTracksMappingTime Time_DefaultValue { get; set; }
		...
		/// </summary>
		public PlotOptionsPyramidSonificationTracksMappingTremolo Tremolo { get; set; }
		private PlotOptionsPyramidSonificationTracksMappingTremolo Tremolo_DefaultValue { get; set; }
		 

		/// <summary>
		/// The volume of notes, from 0 to 1.
		/// </summary>
		public PlotOptionsPyramidSonificationTracksMappingVolume Volume { get; set; }
		private PlotOptionsPyramidSonificationTracksMappingVolume Volume_DefaultValue { get; set; }
