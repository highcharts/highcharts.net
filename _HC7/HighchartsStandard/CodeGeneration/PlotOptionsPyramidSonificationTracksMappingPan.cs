...
{
	public partial class PlotOptionsPyramidSonificationTracksMappingPan  : BaseObject
	{
		Hashtable h = new Hashtable();

		public PlotOptionsPyramidSonificationTracksMappingPan()
		{
			MapFunction = MapFunction_DefaultValue = PlotOptionsPyramidSonificationTracksMappingPanMapFunction.Linear;
			MapTo = MapTo_DefaultValue = "";
			Max = Max_DefaultValue = null;
			Min = Min_DefaultValue = null;
			Value = Value_DefaultValue = null;
			Within = Within_DefaultValue = PlotOptionsPyramidSonificationTracksMappingPanWithin.Chart;
		...
		/// </summary>
		public PlotOptionsPyramidSonificationTracksMappingPanMapFunction MapFunction { get; set; }
		private PlotOptionsPyramidSonificationTracksMappingPanMapFunction MapFunction_DefaultValue { get; set; }
		...
		/// </summary>
		public PlotOptionsPyramidSonificationTracksMappingPanWithin Within { get; set; }
		private PlotOptionsPyramidSonificationTracksMappingPanWithin Within_DefaultValue { get; set; }
