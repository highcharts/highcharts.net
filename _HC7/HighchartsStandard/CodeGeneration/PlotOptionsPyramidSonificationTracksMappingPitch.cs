...
{
	public partial class PlotOptionsPyramidSonificationTracksMappingPitch  : BaseObject
	{
		Hashtable h = new Hashtable();

		public PlotOptionsPyramidSonificationTracksMappingPitch()
		{
			MapFunction = MapFunction_DefaultValue = PlotOptionsPyramidSonificationTracksMappingPitchMapFunction.Linear;
		...
		/// </summary>
		public PlotOptionsPyramidSonificationTracksMappingPitchMapFunction MapFunction { get; set; }
		private PlotOptionsPyramidSonificationTracksMappingPitchMapFunction MapFunction_DefaultValue { get; set; }
