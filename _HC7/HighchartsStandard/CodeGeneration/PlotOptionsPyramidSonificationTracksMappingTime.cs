...
{
	public partial class PlotOptionsPyramidSonificationTracksMappingTime  : BaseObject
	{
		Hashtable h = new Hashtable();

		public PlotOptionsPyramidSonificationTracksMappingTime()
		{
			MapFunction = MapFunction_DefaultValue = PlotOptionsPyramidSonificationTracksMappingTimeMapFunction.Linear;
			MapTo = MapTo_DefaultValue = "";
			Max = Max_DefaultValue = null;
			Min = Min_DefaultValue = null;
			Value = Value_DefaultValue = null;
			Within = Within_DefaultValue = PlotOptionsPyramidSonificationTracksMappingTimeWithin.Chart;
		...
		/// </summary>
		public PlotOptionsPyramidSonificationTracksMappingTimeMapFunction MapFunction { get; set; }
		private PlotOptionsPyramidSonificationTracksMappingTimeMapFunction MapFunction_DefaultValue { get; set; }
		...
		/// </summary>
		public PlotOptionsPyramidSonificationTracksMappingTimeWithin Within { get; set; }
		private PlotOptionsPyramidSonificationTracksMappingTimeWithin Within_DefaultValue { get; set; }
