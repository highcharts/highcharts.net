...
{
	public partial class PlotOptionsPyramidSonificationTracksMappingVolume  : BaseObject
	{
		Hashtable h = new Hashtable();

		public PlotOptionsPyramidSonificationTracksMappingVolume()
		{
			MapFunction = MapFunction_DefaultValue = PlotOptionsPyramidSonificationTracksMappingVolumeMapFunction.Linear;
			MapTo = MapTo_DefaultValue = "";
			Max = Max_DefaultValue = null;
			Min = Min_DefaultValue = null;
			Value = Value_DefaultValue = null;
			Within = Within_DefaultValue = PlotOptionsPyramidSonificationTracksMappingVolumeWithin.Chart;
		...
		/// </summary>
		public PlotOptionsPyramidSonificationTracksMappingVolumeMapFunction MapFunction { get; set; }
		private PlotOptionsPyramidSonificationTracksMappingVolumeMapFunction MapFunction_DefaultValue { get; set; }
		...
		/// </summary>
		public PlotOptionsPyramidSonificationTracksMappingVolumeWithin Within { get; set; }
		private PlotOptionsPyramidSonificationTracksMappingVolumeWithin Within_DefaultValue { get; set; }
