...
{
	public partial class PlotOptionsPyramidSonificationTracksPointGrouping  : BaseObject
	{
		Hashtable h = new Hashtable();

		public PlotOptionsPyramidSonificationTracksPointGrouping()
		{
		...
		/// </summary>
		public PlotOptionsPyramidSonificationTracksPointGroupingAlgorithm Algorithm { get; set; }
		private PlotOptionsPyramidSonificationTracksPointGroupingAlgorithm Algorithm_DefaultValue { get; set; }
		...
		internal override Hashtable ToHashtable(Highcharts highcharts)
		{
			...
			if (Algorithm != PlotOptionsPyramidSonificationTracksPointGroupingAlgorithm.Null) h.Add("algorithm", highcharts.FirstCharacterToLower(Algorithm.ToString()));
