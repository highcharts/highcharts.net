...
namespace Highsoft.Web.Mvc.Charts
{
	public partial class PlotOptionsPyramidTooltip  : BaseObject
	{
		public PlotOptionsPyramidTooltip()
		{
			...
			HeaderShape = HeaderShape_DefaultValue = PlotOptionsPyramidTooltipHeaderShape.Callout;
		...
		/// </summary>
		public PlotOptionsPyramidTooltipHeaderShape HeaderShape { get; set; }
		private PlotOptionsPyramidTooltipHeaderShape HeaderShape_DefaultValue { get; set; }
		...
		internal override Hashtable ToHashtable()
		{
			...
			if (NullFormatter != NullFormatter_DefaultValue) { h.Add("nullFormatter",NullFormatter); Highcharts.AddFunction("PlotOptionsPyramidTooltipNullFormatter.nullFormatter", NullFormatter); }  
			if (Outside != Outside_DefaultValue) h.Add("outside",Outside);
			if (Padding != Padding_DefaultValue) h.Add("padding",Padding);
			if (PointFormat != PointFormat_DefaultValue) h.Add("pointFormat",PointFormat);
			if (PointFormatter != PointFormatter_DefaultValue) { h.Add("pointFormatter",PointFormatter); Highcharts.AddFunction("PlotOptionsPyramidTooltipPointFormatter.pointFormatter", PointFormatter); }  
