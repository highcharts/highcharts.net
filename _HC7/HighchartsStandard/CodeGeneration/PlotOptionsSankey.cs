...
namespace Highsoft.Web.Mvc.Charts
{
	public partial class PlotOptionsSankey  : BaseObject
	{
		...
		public PlotOptionsSankey()
		{
			...
			Sonification = Sonification_DefaultValue = new PlotOptionsSankeySonification();
		...
		private PlotOptionsSankeyLegendSymbol LegendSymbol_DefaultValue { get; set; }
		...
		private PlotOptionsSankeySonification Sonification_DefaultValue { get; set; }
