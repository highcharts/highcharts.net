...
namespace Highsoft.Web.Mvc.Charts
{
	public partial class PlotOptionsSankeyDataLabels  : BaseObject
	{
		...
		/// </summary>
		public PlotOptionsSankeyDataLabelsFilter Filter { get; set; }
		private PlotOptionsSankeyDataLabelsFilter Filter_DefaultValue { get; set; }
		...
		/// </summary>
		public PlotOptionsSankeyDataLabelsOverflow Overflow { get; set; }
		private PlotOptionsSankeyDataLabelsOverflow Overflow_DefaultValue { get; set; }
		...
		/// </summary>
		public PlotOptionsSankeyDataLabelsPosition Position { get; set; }
		private PlotOptionsSankeyDataLabelsPosition Position_DefaultValue { get; set; }
		...
		/// </summary>
		public PlotOptionsSankeyDataLabelsTextPath TextPath { get; set; }
		private PlotOptionsSankeyDataLabelsTextPath TextPath_DefaultValue { get; set; }
		...
		internal override Hashtable ToHashtable(Highcharts highcharts)
		{
			...
			if (Align != PlotOptionsSankeyDataLabelsAlign.Null) h.Add("align", highcharts.FirstCharacterToLower(Align.ToString()));
			...
			if (Overflow != PlotOptionsSankeyDataLabelsOverflow.Null) h.Add("overflow", highcharts.FirstCharacterToLower(Overflow.ToString()));
			if (Padding != null) h.Add("padding",Padding);
			if (Position != PlotOptionsSankeyDataLabelsPosition.Null) h.Add("position", highcharts.FirstCharacterToLower(Position.ToString()));
			...
			if (VerticalAlign != PlotOptionsSankeyDataLabelsVerticalAlign.Null) h.Add("verticalAlign", highcharts.FirstCharacterToLower(VerticalAlign.ToString()));
			if (X != null) h.Add("x",X);
			if (Y != null) h.Add("y",Y);
