...
{
	public partial class PlotOptionsSankeyDragDropDragHandle  : BaseObject
	{
		public PlotOptionsSankeyDragDropDragHandle()
		{
		...
		internal override Hashtable ToHashtable()
		{
			...
			if (PathFormatter != PathFormatter_DefaultValue) { h.Add("pathFormatter",PathFormatter); Highcharts.AddFunction("PlotOptionsSankeyDragDropDragHandlePathFormatter.pathFormatter", PathFormatter); }  
