...
{
	public partial class PlotOptionsSankeySonificationContextTracksMapping  : BaseObject
	{
		Hashtable h = new Hashtable();

		public PlotOptionsSankeySonificationContextTracksMapping()
		{
			Frequency = Frequency_DefaultValue = new PlotOptionsSankeySonificationContextTracksMappingFrequency();
			GapBetweenNotes = GapBetweenNotes_DefaultValue = new PlotOptionsSankeySonificationContextTracksMappingGapBetweenNotes();
			Highpass = Highpass_DefaultValue = new PlotOptionsSankeySonificationContextTracksMappingHighpass();
			Lowpass = Lowpass_DefaultValue = new PlotOptionsSankeySonificationContextTracksMappingLowpass();
			NoteDuration = NoteDuration_DefaultValue = new PlotOptionsSankeySonificationContextTracksMappingNoteDuration();
			Pan = Pan_DefaultValue = new PlotOptionsSankeySonificationContextTracksMappingPan();
			Pitch = Pitch_DefaultValue = new PlotOptionsSankeySonificationContextTracksMappingPitch();
			PitchString = PitchString_DefaultValue = "null";
			PitchNumber = PitchNumber_DefaultValue = null;
			PlayDelay = PlayDelay_DefaultValue = new PlotOptionsSankeySonificationContextTracksMappingPlayDelay();
			Time = Time_DefaultValue = new PlotOptionsSankeySonificationContextTracksMappingTime();
			TimeString = TimeString_DefaultValue = "null";
			TimeNumber = TimeNumber_DefaultValue = null;
			Tremolo = Tremolo_DefaultValue = new PlotOptionsSankeySonificationContextTracksMappingTremolo();
			Volume = Volume_DefaultValue = new PlotOptionsSankeySonificationContextTracksMappingVolume();
		...
		/// </summary>
		public PlotOptionsSankeySonificationContextTracksMappingFrequency Frequency { get; set; }
		private PlotOptionsSankeySonificationContextTracksMappingFrequency Frequency_DefaultValue { get; set; }
		...
		/// </summary>
		public PlotOptionsSankeySonificationContextTracksMappingGapBetweenNotes GapBetweenNotes { get; set; }
		private PlotOptionsSankeySonificationContextTracksMappingGapBetweenNotes GapBetweenNotes_DefaultValue { get; set; }
		...
		/// </summary>
		public PlotOptionsSankeySonificationContextTracksMappingHighpass Highpass { get; set; }
		private PlotOptionsSankeySonificationContextTracksMappingHighpass Highpass_DefaultValue { get; set; }
		...
		/// </summary>
		public PlotOptionsSankeySonificationContextTracksMappingLowpass Lowpass { get; set; }
		private PlotOptionsSankeySonificationContextTracksMappingLowpass Lowpass_DefaultValue { get; set; }
		...
		/// </summary>
		public PlotOptionsSankeySonificationContextTracksMappingNoteDuration NoteDuration { get; set; }
		private PlotOptionsSankeySonificationContextTracksMappingNoteDuration NoteDuration_DefaultValue { get; set; }
		...
		/// </summary>
		public PlotOptionsSankeySonificationContextTracksMappingPan Pan { get; set; }
		private PlotOptionsSankeySonificationContextTracksMappingPan Pan_DefaultValue { get; set; }
		...
		/// </summary>
		public PlotOptionsSankeySonificationContextTracksMappingPitch Pitch { get; set; }
		private PlotOptionsSankeySonificationContextTracksMappingPitch Pitch_DefaultValue { get; set; }
		...
		/// </summary>
		public PlotOptionsSankeySonificationContextTracksMappingPlayDelay PlayDelay { get; set; }
		private PlotOptionsSankeySonificationContextTracksMappingPlayDelay PlayDelay_DefaultValue { get; set; }
		...
		/// </summary>
		public PlotOptionsSankeySonificationContextTracksMappingTime Time { get; set; }
		private PlotOptionsSankeySonificationContextTracksMappingTime Time_DefaultValue { get; set; }
		...
		/// </summary>
		public PlotOptionsSankeySonificationContextTracksMappingTremolo Tremolo { get; set; }
		private PlotOptionsSankeySonificationContextTracksMappingTremolo Tremolo_DefaultValue { get; set; }
		 

		/// <summary>
		/// The volume of notes, from 0 to 1.
		/// </summary>
		public PlotOptionsSankeySonificationContextTracksMappingVolume Volume { get; set; }
		private PlotOptionsSankeySonificationContextTracksMappingVolume Volume_DefaultValue { get; set; }
