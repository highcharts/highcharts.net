...
{
	public partial class PlotOptionsSankeySonificationContextTracksMappingPitch  : BaseObject
	{
		Hashtable h = new Hashtable();

		public PlotOptionsSankeySonificationContextTracksMappingPitch()
		{
			MapFunction = MapFunction_DefaultValue = PlotOptionsSankeySonificationContextTracksMappingPitchMapFunction.Linear;
		...
		/// </summary>
		public PlotOptionsSankeySonificationContextTracksMappingPitchMapFunction MapFunction { get; set; }
		private PlotOptionsSankeySonificationContextTracksMappingPitchMapFunction MapFunction_DefaultValue { get; set; }
