...
{
	public partial class PlotOptionsSankeySonificationContextTracksMappingVolume  : BaseObject
	{
		Hashtable h = new Hashtable();

		public PlotOptionsSankeySonificationContextTracksMappingVolume()
		{
			MapFunction = MapFunction_DefaultValue = PlotOptionsSankeySonificationContextTracksMappingVolumeMapFunction.Linear;
			MapTo = MapTo_DefaultValue = "";
			Max = Max_DefaultValue = null;
			Min = Min_DefaultValue = null;
			Value = Value_DefaultValue = null;
			Within = Within_DefaultValue = PlotOptionsSankeySonificationContextTracksMappingVolumeWithin.Chart;
		...
		/// </summary>
		public PlotOptionsSankeySonificationContextTracksMappingVolumeMapFunction MapFunction { get; set; }
		private PlotOptionsSankeySonificationContextTracksMappingVolumeMapFunction MapFunction_DefaultValue { get; set; }
		...
		/// </summary>
		public PlotOptionsSankeySonificationContextTracksMappingVolumeWithin Within { get; set; }
		private PlotOptionsSankeySonificationContextTracksMappingVolumeWithin Within_DefaultValue { get; set; }
