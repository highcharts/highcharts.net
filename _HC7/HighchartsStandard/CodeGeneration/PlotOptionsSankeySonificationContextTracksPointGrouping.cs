...
{
	public partial class PlotOptionsSankeySonificationContextTracksPointGrouping  : BaseObject
	{
		Hashtable h = new Hashtable();

		public PlotOptionsSankeySonificationContextTracksPointGrouping()
		{
		...
		/// </summary>
		public PlotOptionsSankeySonificationContextTracksPointGroupingAlgorithm Algorithm { get; set; }
		private PlotOptionsSankeySonificationContextTracksPointGroupingAlgorithm Algorithm_DefaultValue { get; set; }
		...
		internal override Hashtable ToHashtable(Highcharts highcharts)
		{
			...
			if (Algorithm != PlotOptionsSankeySonificationContextTracksPointGroupingAlgorithm.Null) h.Add("algorithm", highcharts.FirstCharacterToLower(Algorithm.ToString()));
