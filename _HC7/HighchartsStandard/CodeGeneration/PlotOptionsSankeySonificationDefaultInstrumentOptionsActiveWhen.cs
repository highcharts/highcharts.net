...
{
	public partial class PlotOptionsSankeySonificationDefaultInstrumentOptionsActiveWhen  : BaseObject
	{
		Hashtable h = new Hashtable();

		public PlotOptionsSankeySonificationDefaultInstrumentOptionsActiveWhen()
		{
