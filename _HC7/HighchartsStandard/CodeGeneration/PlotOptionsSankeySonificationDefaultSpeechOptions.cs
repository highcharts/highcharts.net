...
{
	public partial class PlotOptionsSankeySonificationDefaultSpeechOptions  : BaseObject
	{
		Hashtable h = new Hashtable();

		public PlotOptionsSankeySonificationDefaultSpeechOptions()
		{
			ActiveWhen = ActiveWhen_DefaultValue = new PlotOptionsSankeySonificationDefaultSpeechOptionsActiveWhen();
			Language = Language_DefaultValue = "en-US";
			Mapping = Mapping_DefaultValue = new PlotOptionsSankeySonificationDefaultSpeechOptionsMapping();
			PointGrouping = PointGrouping_DefaultValue = new PlotOptionsSankeySonificationDefaultSpeechOptionsPointGrouping();
			PreferredVoice = PreferredVoice_DefaultValue = "";
			ShowPlayMarker = ShowPlayMarker_DefaultValue = true;
			Type = Type_DefaultValue = PlotOptionsSankeySonificationDefaultSpeechOptionsType.Instrument;
		...
		/// </summary>
		public PlotOptionsSankeySonificationDefaultSpeechOptionsActiveWhen ActiveWhen { get; set; }
		private PlotOptionsSankeySonificationDefaultSpeechOptionsActiveWhen ActiveWhen_DefaultValue { get; set; }
		...
		/// </summary>
		public PlotOptionsSankeySonificationDefaultSpeechOptionsMapping Mapping { get; set; }
		private PlotOptionsSankeySonificationDefaultSpeechOptionsMapping Mapping_DefaultValue { get; set; }
		 

		/// <summary>
		/// Options for point grouping, specifically for instrument tracks.
		/// </summary>
		public PlotOptionsSankeySonificationDefaultSpeechOptionsPointGrouping PointGrouping { get; set; }
		private PlotOptionsSankeySonificationDefaultSpeechOptionsPointGrouping PointGrouping_DefaultValue { get; set; }
		...
		/// </summary>
		public PlotOptionsSankeySonificationDefaultSpeechOptionsType Type { get; set; }
		private PlotOptionsSankeySonificationDefaultSpeechOptionsType Type_DefaultValue { get; set; }
