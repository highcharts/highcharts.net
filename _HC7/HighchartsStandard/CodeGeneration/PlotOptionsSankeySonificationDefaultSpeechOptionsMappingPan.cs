...
{
	public partial class PlotOptionsSankeySonificationDefaultSpeechOptionsMappingPan  : BaseObject
	{
		Hashtable h = new Hashtable();

		public PlotOptionsSankeySonificationDefaultSpeechOptionsMappingPan()
		{
			MapFunction = MapFunction_DefaultValue = PlotOptionsSankeySonificationDefaultSpeechOptionsMappingPanMapFunction.Linear;
			MapTo = MapTo_DefaultValue = "";
			Max = Max_DefaultValue = null;
			Min = Min_DefaultValue = null;
			Value = Value_DefaultValue = null;
			Within = Within_DefaultValue = PlotOptionsSankeySonificationDefaultSpeechOptionsMappingPanWithin.Chart;
		...
		/// </summary>
		public PlotOptionsSankeySonificationDefaultSpeechOptionsMappingPanMapFunction MapFunction { get; set; }
		private PlotOptionsSankeySonificationDefaultSpeechOptionsMappingPanMapFunction MapFunction_DefaultValue { get; set; }
		...
		/// </summary>
		public PlotOptionsSankeySonificationDefaultSpeechOptionsMappingPanWithin Within { get; set; }
		private PlotOptionsSankeySonificationDefaultSpeechOptionsMappingPanWithin Within_DefaultValue { get; set; }
