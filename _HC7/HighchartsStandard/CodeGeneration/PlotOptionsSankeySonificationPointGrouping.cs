...
{
	public partial class PlotOptionsSankeySonificationPointGrouping  : BaseObject
	{
		Hashtable h = new Hashtable();

		public PlotOptionsSankeySonificationPointGrouping()
		{
		...
		/// </summary>
		public PlotOptionsSankeySonificationPointGroupingAlgorithm Algorithm { get; set; }
		private PlotOptionsSankeySonificationPointGroupingAlgorithm Algorithm_DefaultValue { get; set; }
		...
		internal override Hashtable ToHashtable(Highcharts highcharts)
		{
			...
			if (Algorithm != PlotOptionsSankeySonificationPointGroupingAlgorithm.Null) h.Add("algorithm", highcharts.FirstCharacterToLower(Algorithm.ToString()));
