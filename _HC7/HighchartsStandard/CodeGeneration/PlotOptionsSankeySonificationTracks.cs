...
{
	public partial class PlotOptionsSankeySonificationTracks  : BaseObject
	{
		Hashtable h = new Hashtable();

		public PlotOptionsSankeySonificationTracks()
		{
			ActiveWhen = ActiveWhen_DefaultValue = new PlotOptionsSankeySonificationTracksActiveWhen();
			Instrument = Instrument_DefaultValue = null;
			InstrumentString = InstrumentString_DefaultValue = "null";
			Mapping = Mapping_DefaultValue = new PlotOptionsSankeySonificationTracksMapping();
			MidiName = MidiName_DefaultValue = "";
			PointGrouping = PointGrouping_DefaultValue = new PlotOptionsSankeySonificationTracksPointGrouping();
			RoundToMusicalNotes = RoundToMusicalNotes_DefaultValue = true;
			ShowPlayMarker = ShowPlayMarker_DefaultValue = true;
			Type = Type_DefaultValue = PlotOptionsSankeySonificationTracksType.Instrument;
		...
		/// </summary>
		public PlotOptionsSankeySonificationTracksActiveWhen ActiveWhen { get; set; }
		private PlotOptionsSankeySonificationTracksActiveWhen ActiveWhen_DefaultValue { get; set; }
		...
		/// </summary>
		public PlotOptionsSankeySonificationTracksMapping Mapping { get; set; }
		private PlotOptionsSankeySonificationTracksMapping Mapping_DefaultValue { get; set; }
		...
		/// </summary>
		public PlotOptionsSankeySonificationTracksPointGrouping PointGrouping { get; set; }
		private PlotOptionsSankeySonificationTracksPointGrouping PointGrouping_DefaultValue { get; set; }
		...
		/// </summary>
		public PlotOptionsSankeySonificationTracksType Type { get; set; }
		private PlotOptionsSankeySonificationTracksType Type_DefaultValue { get; set; }
