...
{
	public partial class PlotOptionsSankeySonificationTracksMappingLowpassResonance  : BaseObject
	{
		Hashtable h = new Hashtable();

		public PlotOptionsSankeySonificationTracksMappingLowpassResonance()
		{
			MapFunction = MapFunction_DefaultValue = PlotOptionsSankeySonificationTracksMappingLowpassResonanceMapFunction.Linear;
			MapTo = MapTo_DefaultValue = "";
			Max = Max_DefaultValue = null;
			Min = Min_DefaultValue = null;
			Value = Value_DefaultValue = null;
			Within = Within_DefaultValue = PlotOptionsSankeySonificationTracksMappingLowpassResonanceWithin.Chart;
		...
		/// </summary>
		public PlotOptionsSankeySonificationTracksMappingLowpassResonanceMapFunction MapFunction { get; set; }
		private PlotOptionsSankeySonificationTracksMappingLowpassResonanceMapFunction MapFunction_DefaultValue { get; set; }
		...
		/// </summary>
		public PlotOptionsSankeySonificationTracksMappingLowpassResonanceWithin Within { get; set; }
		private PlotOptionsSankeySonificationTracksMappingLowpassResonanceWithin Within_DefaultValue { get; set; }
