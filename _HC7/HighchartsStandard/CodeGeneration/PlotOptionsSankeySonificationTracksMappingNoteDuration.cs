...
{
	public partial class PlotOptionsSankeySonificationTracksMappingNoteDuration  : BaseObject
	{
		Hashtable h = new Hashtable();

		public PlotOptionsSankeySonificationTracksMappingNoteDuration()
		{
			MapFunction = MapFunction_DefaultValue = PlotOptionsSankeySonificationTracksMappingNoteDurationMapFunction.Linear;
			MapTo = MapTo_DefaultValue = "";
			Max = Max_DefaultValue = null;
			Min = Min_DefaultValue = null;
			Value = Value_DefaultValue = null;
			Within = Within_DefaultValue = PlotOptionsSankeySonificationTracksMappingNoteDurationWithin.Chart;
		...
		/// </summary>
		public PlotOptionsSankeySonificationTracksMappingNoteDurationMapFunction MapFunction { get; set; }
		private PlotOptionsSankeySonificationTracksMappingNoteDurationMapFunction MapFunction_DefaultValue { get; set; }
		...
		/// </summary>
		public PlotOptionsSankeySonificationTracksMappingNoteDurationWithin Within { get; set; }
		private PlotOptionsSankeySonificationTracksMappingNoteDurationWithin Within_DefaultValue { get; set; }
