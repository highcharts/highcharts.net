...
{
	public partial class PlotOptionsSankeySonificationTracksMappingPan  : BaseObject
	{
		Hashtable h = new Hashtable();

		public PlotOptionsSankeySonificationTracksMappingPan()
		{
			MapFunction = MapFunction_DefaultValue = PlotOptionsSankeySonificationTracksMappingPanMapFunction.Linear;
			MapTo = MapTo_DefaultValue = "";
			Max = Max_DefaultValue = null;
			Min = Min_DefaultValue = null;
			Value = Value_DefaultValue = null;
			Within = Within_DefaultValue = PlotOptionsSankeySonificationTracksMappingPanWithin.Chart;
		...
		/// </summary>
		public PlotOptionsSankeySonificationTracksMappingPanMapFunction MapFunction { get; set; }
		private PlotOptionsSankeySonificationTracksMappingPanMapFunction MapFunction_DefaultValue { get; set; }
		...
		/// </summary>
		public PlotOptionsSankeySonificationTracksMappingPanWithin Within { get; set; }
		private PlotOptionsSankeySonificationTracksMappingPanWithin Within_DefaultValue { get; set; }
