...
{
	public partial class PlotOptionsSankeySonificationTracksMappingPitch  : BaseObject
	{
		Hashtable h = new Hashtable();

		public PlotOptionsSankeySonificationTracksMappingPitch()
		{
			MapFunction = MapFunction_DefaultValue = PlotOptionsSankeySonificationTracksMappingPitchMapFunction.Linear;
		...
		/// </summary>
		public PlotOptionsSankeySonificationTracksMappingPitchMapFunction MapFunction { get; set; }
		private PlotOptionsSankeySonificationTracksMappingPitchMapFunction MapFunction_DefaultValue { get; set; }
