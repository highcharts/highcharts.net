...
{
	public partial class PlotOptionsSankeySonificationTracksMappingTime  : BaseObject
	{
		Hashtable h = new Hashtable();

		public PlotOptionsSankeySonificationTracksMappingTime()
		{
			MapFunction = MapFunction_DefaultValue = PlotOptionsSankeySonificationTracksMappingTimeMapFunction.Linear;
			MapTo = MapTo_DefaultValue = "";
			Max = Max_DefaultValue = null;
			Min = Min_DefaultValue = null;
			Value = Value_DefaultValue = null;
			Within = Within_DefaultValue = PlotOptionsSankeySonificationTracksMappingTimeWithin.Chart;
		...
		/// </summary>
		public PlotOptionsSankeySonificationTracksMappingTimeMapFunction MapFunction { get; set; }
		private PlotOptionsSankeySonificationTracksMappingTimeMapFunction MapFunction_DefaultValue { get; set; }
		...
		/// </summary>
		public PlotOptionsSankeySonificationTracksMappingTimeWithin Within { get; set; }
		private PlotOptionsSankeySonificationTracksMappingTimeWithin Within_DefaultValue { get; set; }
