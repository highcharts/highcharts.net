...
{
	public partial class PlotOptionsSankeySonificationTracksPointGrouping  : BaseObject
	{
		Hashtable h = new Hashtable();

		public PlotOptionsSankeySonificationTracksPointGrouping()
		{
		...
		/// </summary>
		public PlotOptionsSankeySonificationTracksPointGroupingAlgorithm Algorithm { get; set; }
		private PlotOptionsSankeySonificationTracksPointGroupingAlgorithm Algorithm_DefaultValue { get; set; }
		...
		internal override Hashtable ToHashtable(Highcharts highcharts)
		{
			...
			if (Algorithm != PlotOptionsSankeySonificationTracksPointGroupingAlgorithm.Null) h.Add("algorithm", highcharts.FirstCharacterToLower(Algorithm.ToString()));
