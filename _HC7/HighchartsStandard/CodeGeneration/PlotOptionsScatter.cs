...
namespace Highsoft.Web.Mvc.Charts
{
	public partial class PlotOptionsScatter  : BaseObject
	{
		...
		internal override Hashtable ToHashtable()
		{
			...
			if (PointDescriptionFormatter != PointDescriptionFormatter_DefaultValue) { h.Add("pointDescriptionFormatter",PointDescriptionFormatter); Highcharts.AddFunction("79bec3e3-3d80-408c-b520-d1b73c1e496e.pointDescriptionFormatter", PointDescriptionFormatter); }  
