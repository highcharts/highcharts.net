...
namespace Highsoft.Web.Mvc.Charts
{
	public partial class PlotOptionsScatter3d  : BaseObject
	{
		...
		internal override Hashtable ToHashtable()
		{
			...
			if (PointDescriptionFormatter != PointDescriptionFormatter_DefaultValue) { h.Add("pointDescriptionFormatter",PointDescriptionFormatter); Highcharts.AddFunction("48836926-16b0-4ce1-9a83-431a7d89eab8.pointDescriptionFormatter", PointDescriptionFormatter); }  
