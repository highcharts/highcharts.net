...
namespace Highsoft.Web.Mvc.Charts
{
	public partial class PlotOptionsScatter3dDragDropDragHandle  : BaseObject
	{
		...
		internal override Hashtable ToHashtable()
		{
			...
			if (PathFormatter != PathFormatter_DefaultValue) { h.Add("pathFormatter",PathFormatter); Highcharts.AddFunction("07c8ec80-5208-4fd3-b559-b92b1d0dc826.pathFormatter", PathFormatter); }  
