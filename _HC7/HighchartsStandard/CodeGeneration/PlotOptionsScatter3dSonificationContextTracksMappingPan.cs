...
{
	public partial class PlotOptionsScatter3dSonificationContextTracksMappingPan  : BaseObject
	{
		Hashtable h = new Hashtable();

		public PlotOptionsScatter3dSonificationContextTracksMappingPan()
		{
			MapFunction = MapFunction_DefaultValue = PlotOptionsScatter3dSonificationContextTracksMappingPanMapFunction.Linear;
			MapTo = MapTo_DefaultValue = "";
			Max = Max_DefaultValue = null;
			Min = Min_DefaultValue = null;
			Value = Value_DefaultValue = null;
			Within = Within_DefaultValue = PlotOptionsScatter3dSonificationContextTracksMappingPanWithin.Chart;
		...
		/// </summary>
		public PlotOptionsScatter3dSonificationContextTracksMappingPanMapFunction MapFunction { get; set; }
		private PlotOptionsScatter3dSonificationContextTracksMappingPanMapFunction MapFunction_DefaultValue { get; set; }
		...
		/// </summary>
		public PlotOptionsScatter3dSonificationContextTracksMappingPanWithin Within { get; set; }
		private PlotOptionsScatter3dSonificationContextTracksMappingPanWithin Within_DefaultValue { get; set; }
