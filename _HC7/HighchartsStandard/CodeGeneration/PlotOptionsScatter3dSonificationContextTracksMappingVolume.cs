...
{
	public partial class PlotOptionsScatter3dSonificationContextTracksMappingVolume  : BaseObject
	{
		Hashtable h = new Hashtable();

		public PlotOptionsScatter3dSonificationContextTracksMappingVolume()
		{
			MapFunction = MapFunction_DefaultValue = PlotOptionsScatter3dSonificationContextTracksMappingVolumeMapFunction.Linear;
			MapTo = MapTo_DefaultValue = "";
			Max = Max_DefaultValue = null;
			Min = Min_DefaultValue = null;
			Value = Value_DefaultValue = null;
			Within = Within_DefaultValue = PlotOptionsScatter3dSonificationContextTracksMappingVolumeWithin.Chart;
		...
		/// </summary>
		public PlotOptionsScatter3dSonificationContextTracksMappingVolumeMapFunction MapFunction { get; set; }
		private PlotOptionsScatter3dSonificationContextTracksMappingVolumeMapFunction MapFunction_DefaultValue { get; set; }
		...
		/// </summary>
		public PlotOptionsScatter3dSonificationContextTracksMappingVolumeWithin Within { get; set; }
		private PlotOptionsScatter3dSonificationContextTracksMappingVolumeWithin Within_DefaultValue { get; set; }
