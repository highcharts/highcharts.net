...
{
	public partial class PlotOptionsScatter3dSonificationDefaultInstrumentOptionsMappingPitch  : BaseObject
	{
		Hashtable h = new Hashtable();

		public PlotOptionsScatter3dSonificationDefaultInstrumentOptionsMappingPitch()
		{
			MapFunction = MapFunction_DefaultValue = PlotOptionsScatter3dSonificationDefaultInstrumentOptionsMappingPitchMapFunction.Linear;
		...
		/// </summary>
		public PlotOptionsScatter3dSonificationDefaultInstrumentOptionsMappingPitchMapFunction MapFunction { get; set; }
		private PlotOptionsScatter3dSonificationDefaultInstrumentOptionsMappingPitchMapFunction MapFunction_DefaultValue { get; set; }
