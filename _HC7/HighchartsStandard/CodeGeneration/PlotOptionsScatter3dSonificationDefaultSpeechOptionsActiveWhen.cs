...
{
	public partial class PlotOptionsScatter3dSonificationDefaultSpeechOptionsActiveWhen  : BaseObject
	{
		Hashtable h = new Hashtable();

		public PlotOptionsScatter3dSonificationDefaultSpeechOptionsActiveWhen()
		{
