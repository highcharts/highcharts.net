...
{
	public partial class PlotOptionsScatter3dSonificationDefaultSpeechOptionsPointGrouping  : BaseObject
	{
		Hashtable h = new Hashtable();

		public PlotOptionsScatter3dSonificationDefaultSpeechOptionsPointGrouping()
		{
		...
		/// </summary>
		public PlotOptionsScatter3dSonificationDefaultSpeechOptionsPointGroupingAlgorithm Algorithm { get; set; }
		private PlotOptionsScatter3dSonificationDefaultSpeechOptionsPointGroupingAlgorithm Algorithm_DefaultValue { get; set; }
		...
		internal override Hashtable ToHashtable(Highcharts highcharts)
		{
			...
			if (Algorithm != PlotOptionsScatter3dSonificationDefaultSpeechOptionsPointGroupingAlgorithm.Null) h.Add("algorithm", highcharts.FirstCharacterToLower(Algorithm.ToString()));
