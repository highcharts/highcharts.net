...
{
	public partial class PlotOptionsScatter3dSonificationPointGrouping  : BaseObject
	{
		Hashtable h = new Hashtable();

		public PlotOptionsScatter3dSonificationPointGrouping()
		{
		...
		/// </summary>
		public PlotOptionsScatter3dSonificationPointGroupingAlgorithm Algorithm { get; set; }
		private PlotOptionsScatter3dSonificationPointGroupingAlgorithm Algorithm_DefaultValue { get; set; }
		...
		internal override Hashtable ToHashtable(Highcharts highcharts)
		{
			...
			if (Algorithm != PlotOptionsScatter3dSonificationPointGroupingAlgorithm.Null) h.Add("algorithm", highcharts.FirstCharacterToLower(Algorithm.ToString()));
