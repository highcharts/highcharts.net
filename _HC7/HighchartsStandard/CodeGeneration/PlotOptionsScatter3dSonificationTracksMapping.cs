...
{
	public partial class PlotOptionsScatter3dSonificationTracksMapping  : BaseObject
	{
		Hashtable h = new Hashtable();

		public PlotOptionsScatter3dSonificationTracksMapping()
		{
			Frequency = Frequency_DefaultValue = new PlotOptionsScatter3dSonificationTracksMappingFrequency();
			GapBetweenNotes = GapBetweenNotes_DefaultValue = new PlotOptionsScatter3dSonificationTracksMappingGapBetweenNotes();
			Highpass = Highpass_DefaultValue = new PlotOptionsScatter3dSonificationTracksMappingHighpass();
			Lowpass = Lowpass_DefaultValue = new PlotOptionsScatter3dSonificationTracksMappingLowpass();
			NoteDuration = NoteDuration_DefaultValue = new PlotOptionsScatter3dSonificationTracksMappingNoteDuration();
			Pan = Pan_DefaultValue = new PlotOptionsScatter3dSonificationTracksMappingPan();
			Pitch = Pitch_DefaultValue = new PlotOptionsScatter3dSonificationTracksMappingPitch();
			PitchString = PitchString_DefaultValue = "null";
			PitchNumber = PitchNumber_DefaultValue = null;
			PlayDelay = PlayDelay_DefaultValue = new PlotOptionsScatter3dSonificationTracksMappingPlayDelay();
			Time = Time_DefaultValue = new PlotOptionsScatter3dSonificationTracksMappingTime();
			TimeString = TimeString_DefaultValue = "null";
			TimeNumber = TimeNumber_DefaultValue = null;
			Tremolo = Tremolo_DefaultValue = new PlotOptionsScatter3dSonificationTracksMappingTremolo();
			Volume = Volume_DefaultValue = new PlotOptionsScatter3dSonificationTracksMappingVolume();
		...
		/// </summary>
		public PlotOptionsScatter3dSonificationTracksMappingFrequency Frequency { get; set; }
		private PlotOptionsScatter3dSonificationTracksMappingFrequency Frequency_DefaultValue { get; set; }
		...
		/// </summary>
		public PlotOptionsScatter3dSonificationTracksMappingGapBetweenNotes GapBetweenNotes { get; set; }
		private PlotOptionsScatter3dSonificationTracksMappingGapBetweenNotes GapBetweenNotes_DefaultValue { get; set; }
		...
		/// </summary>
		public PlotOptionsScatter3dSonificationTracksMappingHighpass Highpass { get; set; }
		private PlotOptionsScatter3dSonificationTracksMappingHighpass Highpass_DefaultValue { get; set; }
		...
		/// </summary>
		public PlotOptionsScatter3dSonificationTracksMappingLowpass Lowpass { get; set; }
		private PlotOptionsScatter3dSonificationTracksMappingLowpass Lowpass_DefaultValue { get; set; }
		...
		/// </summary>
		public PlotOptionsScatter3dSonificationTracksMappingNoteDuration NoteDuration { get; set; }
		private PlotOptionsScatter3dSonificationTracksMappingNoteDuration NoteDuration_DefaultValue { get; set; }
		...
		/// </summary>
		public PlotOptionsScatter3dSonificationTracksMappingPan Pan { get; set; }
		private PlotOptionsScatter3dSonificationTracksMappingPan Pan_DefaultValue { get; set; }
		...
		/// </summary>
		public PlotOptionsScatter3dSonificationTracksMappingPitch Pitch { get; set; }
		private PlotOptionsScatter3dSonificationTracksMappingPitch Pitch_DefaultValue { get; set; }
		...
		/// </summary>
		public PlotOptionsScatter3dSonificationTracksMappingPlayDelay PlayDelay { get; set; }
		private PlotOptionsScatter3dSonificationTracksMappingPlayDelay PlayDelay_DefaultValue { get; set; }
		...
		/// </summary>
		public PlotOptionsScatter3dSonificationTracksMappingTime Time { get; set; }
		private PlotOptionsScatter3dSonificationTracksMappingTime Time_DefaultValue { get; set; }
		...
		/// </summary>
		public PlotOptionsScatter3dSonificationTracksMappingTremolo Tremolo { get; set; }
		private PlotOptionsScatter3dSonificationTracksMappingTremolo Tremolo_DefaultValue { get; set; }
		 

		/// <summary>
		/// The volume of notes, from 0 to 1.
		/// </summary>
		public PlotOptionsScatter3dSonificationTracksMappingVolume Volume { get; set; }
		private PlotOptionsScatter3dSonificationTracksMappingVolume Volume_DefaultValue { get; set; }
