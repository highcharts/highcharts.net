...
{
	public partial class PlotOptionsScatter3dSonificationTracksMappingLowpassResonance  : BaseObject
	{
		Hashtable h = new Hashtable();

		public PlotOptionsScatter3dSonificationTracksMappingLowpassResonance()
		{
			MapFunction = MapFunction_DefaultValue = PlotOptionsScatter3dSonificationTracksMappingLowpassResonanceMapFunction.Linear;
			MapTo = MapTo_DefaultValue = "";
			Max = Max_DefaultValue = null;
			Min = Min_DefaultValue = null;
			Value = Value_DefaultValue = null;
			Within = Within_DefaultValue = PlotOptionsScatter3dSonificationTracksMappingLowpassResonanceWithin.Chart;
		...
		/// </summary>
		public PlotOptionsScatter3dSonificationTracksMappingLowpassResonanceMapFunction MapFunction { get; set; }
		private PlotOptionsScatter3dSonificationTracksMappingLowpassResonanceMapFunction MapFunction_DefaultValue { get; set; }
		...
		/// </summary>
		public PlotOptionsScatter3dSonificationTracksMappingLowpassResonanceWithin Within { get; set; }
		private PlotOptionsScatter3dSonificationTracksMappingLowpassResonanceWithin Within_DefaultValue { get; set; }
