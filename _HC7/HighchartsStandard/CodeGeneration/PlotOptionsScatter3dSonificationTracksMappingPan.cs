...
{
	public partial class PlotOptionsScatter3dSonificationTracksMappingPan  : BaseObject
	{
		Hashtable h = new Hashtable();

		public PlotOptionsScatter3dSonificationTracksMappingPan()
		{
			MapFunction = MapFunction_DefaultValue = PlotOptionsScatter3dSonificationTracksMappingPanMapFunction.Linear;
			MapTo = MapTo_DefaultValue = "";
			Max = Max_DefaultValue = null;
			Min = Min_DefaultValue = null;
			Value = Value_DefaultValue = null;
			Within = Within_DefaultValue = PlotOptionsScatter3dSonificationTracksMappingPanWithin.Chart;
		...
		/// </summary>
		public PlotOptionsScatter3dSonificationTracksMappingPanMapFunction MapFunction { get; set; }
		private PlotOptionsScatter3dSonificationTracksMappingPanMapFunction MapFunction_DefaultValue { get; set; }
		...
		/// </summary>
		public PlotOptionsScatter3dSonificationTracksMappingPanWithin Within { get; set; }
		private PlotOptionsScatter3dSonificationTracksMappingPanWithin Within_DefaultValue { get; set; }
