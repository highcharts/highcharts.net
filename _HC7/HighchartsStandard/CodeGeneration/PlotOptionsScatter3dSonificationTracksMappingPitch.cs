...
{
	public partial class PlotOptionsScatter3dSonificationTracksMappingPitch  : BaseObject
	{
		Hashtable h = new Hashtable();

		public PlotOptionsScatter3dSonificationTracksMappingPitch()
		{
			MapFunction = MapFunction_DefaultValue = PlotOptionsScatter3dSonificationTracksMappingPitchMapFunction.Linear;
		...
		/// </summary>
		public PlotOptionsScatter3dSonificationTracksMappingPitchMapFunction MapFunction { get; set; }
		private PlotOptionsScatter3dSonificationTracksMappingPitchMapFunction MapFunction_DefaultValue { get; set; }
