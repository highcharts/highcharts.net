...
{
	public partial class PlotOptionsScatter3dSonificationTracksMappingTremoloSpeed  : BaseObject
	{
		Hashtable h = new Hashtable();

		public PlotOptionsScatter3dSonificationTracksMappingTremoloSpeed()
		{
			MapFunction = MapFunction_DefaultValue = PlotOptionsScatter3dSonificationTracksMappingTremoloSpeedMapFunction.Linear;
			MapTo = MapTo_DefaultValue = "";
			Max = Max_DefaultValue = null;
			Min = Min_DefaultValue = null;
			Value = Value_DefaultValue = null;
			Within = Within_DefaultValue = PlotOptionsScatter3dSonificationTracksMappingTremoloSpeedWithin.Chart;
		...
		/// </summary>
		public PlotOptionsScatter3dSonificationTracksMappingTremoloSpeedMapFunction MapFunction { get; set; }
		private PlotOptionsScatter3dSonificationTracksMappingTremoloSpeedMapFunction MapFunction_DefaultValue { get; set; }
		...
		/// </summary>
		public PlotOptionsScatter3dSonificationTracksMappingTremoloSpeedWithin Within { get; set; }
		private PlotOptionsScatter3dSonificationTracksMappingTremoloSpeedWithin Within_DefaultValue { get; set; }
