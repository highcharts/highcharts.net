...
{
	public partial class PlotOptionsScatter3dSonificationTracksMappingVolume  : BaseObject
	{
		Hashtable h = new Hashtable();

		public PlotOptionsScatter3dSonificationTracksMappingVolume()
		{
			MapFunction = MapFunction_DefaultValue = PlotOptionsScatter3dSonificationTracksMappingVolumeMapFunction.Linear;
			MapTo = MapTo_DefaultValue = "";
			Max = Max_DefaultValue = null;
			Min = Min_DefaultValue = null;
			Value = Value_DefaultValue = null;
			Within = Within_DefaultValue = PlotOptionsScatter3dSonificationTracksMappingVolumeWithin.Chart;
		...
		/// </summary>
		public PlotOptionsScatter3dSonificationTracksMappingVolumeMapFunction MapFunction { get; set; }
		private PlotOptionsScatter3dSonificationTracksMappingVolumeMapFunction MapFunction_DefaultValue { get; set; }
		...
		/// </summary>
		public PlotOptionsScatter3dSonificationTracksMappingVolumeWithin Within { get; set; }
		private PlotOptionsScatter3dSonificationTracksMappingVolumeWithin Within_DefaultValue { get; set; }
