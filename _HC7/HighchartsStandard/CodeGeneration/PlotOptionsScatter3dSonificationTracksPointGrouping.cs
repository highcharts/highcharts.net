...
{
	public partial class PlotOptionsScatter3dSonificationTracksPointGrouping  : BaseObject
	{
		Hashtable h = new Hashtable();

		public PlotOptionsScatter3dSonificationTracksPointGrouping()
		{
		...
		/// </summary>
		public PlotOptionsScatter3dSonificationTracksPointGroupingAlgorithm Algorithm { get; set; }
		private PlotOptionsScatter3dSonificationTracksPointGroupingAlgorithm Algorithm_DefaultValue { get; set; }
		...
		internal override Hashtable ToHashtable(Highcharts highcharts)
		{
			...
			if (Algorithm != PlotOptionsScatter3dSonificationTracksPointGroupingAlgorithm.Null) h.Add("algorithm", highcharts.FirstCharacterToLower(Algorithm.ToString()));
