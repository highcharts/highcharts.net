...
{
	public partial class PlotOptionsScatterSonificationContextTracksMappingHighpassFrequency  : BaseObject
	{
		Hashtable h = new Hashtable();

		public PlotOptionsScatterSonificationContextTracksMappingHighpassFrequency()
		{
			MapFunction = MapFunction_DefaultValue = PlotOptionsScatterSonificationContextTracksMappingHighpassFrequencyMapFunction.Linear;
			MapTo = MapTo_DefaultValue = "";
			Max = Max_DefaultValue = null;
			Min = Min_DefaultValue = null;
			Value = Value_DefaultValue = null;
			Within = Within_DefaultValue = PlotOptionsScatterSonificationContextTracksMappingHighpassFrequencyWithin.Chart;
		...
		/// </summary>
		public PlotOptionsScatterSonificationContextTracksMappingHighpassFrequencyMapFunction MapFunction { get; set; }
		private PlotOptionsScatterSonificationContextTracksMappingHighpassFrequencyMapFunction MapFunction_DefaultValue { get; set; }
		...
		/// </summary>
		public PlotOptionsScatterSonificationContextTracksMappingHighpassFrequencyWithin Within { get; set; }
		private PlotOptionsScatterSonificationContextTracksMappingHighpassFrequencyWithin Within_DefaultValue { get; set; }
