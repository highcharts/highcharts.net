...
{
	public partial class PlotOptionsScatterSonificationContextTracksMappingHighpassResonance  : BaseObject
	{
		Hashtable h = new Hashtable();

		public PlotOptionsScatterSonificationContextTracksMappingHighpassResonance()
		{
			MapFunction = MapFunction_DefaultValue = PlotOptionsScatterSonificationContextTracksMappingHighpassResonanceMapFunction.Linear;
			MapTo = MapTo_DefaultValue = "";
			Max = Max_DefaultValue = null;
			Min = Min_DefaultValue = null;
			Value = Value_DefaultValue = null;
			Within = Within_DefaultValue = PlotOptionsScatterSonificationContextTracksMappingHighpassResonanceWithin.Chart;
		...
		/// </summary>
		public PlotOptionsScatterSonificationContextTracksMappingHighpassResonanceMapFunction MapFunction { get; set; }
		private PlotOptionsScatterSonificationContextTracksMappingHighpassResonanceMapFunction MapFunction_DefaultValue { get; set; }
		...
		/// </summary>
		public PlotOptionsScatterSonificationContextTracksMappingHighpassResonanceWithin Within { get; set; }
		private PlotOptionsScatterSonificationContextTracksMappingHighpassResonanceWithin Within_DefaultValue { get; set; }
