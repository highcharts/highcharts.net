...
{
	public partial class PlotOptionsScatterSonificationContextTracksMappingPitch  : BaseObject
	{
		Hashtable h = new Hashtable();

		public PlotOptionsScatterSonificationContextTracksMappingPitch()
		{
			MapFunction = MapFunction_DefaultValue = PlotOptionsScatterSonificationContextTracksMappingPitchMapFunction.Linear;
		...
		/// </summary>
		public PlotOptionsScatterSonificationContextTracksMappingPitchMapFunction MapFunction { get; set; }
		private PlotOptionsScatterSonificationContextTracksMappingPitchMapFunction MapFunction_DefaultValue { get; set; }
