...
{
	public partial class PlotOptionsScatterSonificationDefaultSpeechOptionsMapping  : BaseObject
	{
		Hashtable h = new Hashtable();

		public PlotOptionsScatterSonificationDefaultSpeechOptionsMapping()
		{
			Frequency = Frequency_DefaultValue = new PlotOptionsScatterSonificationDefaultSpeechOptionsMappingFrequency();
			GapBetweenNotes = GapBetweenNotes_DefaultValue = new PlotOptionsScatterSonificationDefaultSpeechOptionsMappingGapBetweenNotes();
			Highpass = Highpass_DefaultValue = new PlotOptionsScatterSonificationDefaultSpeechOptionsMappingHighpass();
			Lowpass = Lowpass_DefaultValue = new PlotOptionsScatterSonificationDefaultSpeechOptionsMappingLowpass();
			NoteDuration = NoteDuration_DefaultValue = new PlotOptionsScatterSonificationDefaultSpeechOptionsMappingNoteDuration();
			Pan = Pan_DefaultValue = new PlotOptionsScatterSonificationDefaultSpeechOptionsMappingPan();
			Pitch = Pitch_DefaultValue = new PlotOptionsScatterSonificationDefaultSpeechOptionsMappingPitch();
			PitchString = PitchString_DefaultValue = "null";
			PitchNumber = PitchNumber_DefaultValue = null;
			PlayDelay = PlayDelay_DefaultValue = new PlotOptionsScatterSonificationDefaultSpeechOptionsMappingPlayDelay();
			Time = Time_DefaultValue = new PlotOptionsScatterSonificationDefaultSpeechOptionsMappingTime();
			TimeString = TimeString_DefaultValue = "null";
			TimeNumber = TimeNumber_DefaultValue = null;
			Tremolo = Tremolo_DefaultValue = new PlotOptionsScatterSonificationDefaultSpeechOptionsMappingTremolo();
			Volume = Volume_DefaultValue = new PlotOptionsScatterSonificationDefaultSpeechOptionsMappingVolume();
		...
		/// </summary>
		public PlotOptionsScatterSonificationDefaultSpeechOptionsMappingFrequency Frequency { get; set; }
		private PlotOptionsScatterSonificationDefaultSpeechOptionsMappingFrequency Frequency_DefaultValue { get; set; }
		...
		/// </summary>
		public PlotOptionsScatterSonificationDefaultSpeechOptionsMappingGapBetweenNotes GapBetweenNotes { get; set; }
		private PlotOptionsScatterSonificationDefaultSpeechOptionsMappingGapBetweenNotes GapBetweenNotes_DefaultValue { get; set; }
		...
		/// </summary>
		public PlotOptionsScatterSonificationDefaultSpeechOptionsMappingHighpass Highpass { get; set; }
		private PlotOptionsScatterSonificationDefaultSpeechOptionsMappingHighpass Highpass_DefaultValue { get; set; }
		...
		/// </summary>
		public PlotOptionsScatterSonificationDefaultSpeechOptionsMappingLowpass Lowpass { get; set; }
		private PlotOptionsScatterSonificationDefaultSpeechOptionsMappingLowpass Lowpass_DefaultValue { get; set; }
		...
		/// </summary>
		public PlotOptionsScatterSonificationDefaultSpeechOptionsMappingNoteDuration NoteDuration { get; set; }
		private PlotOptionsScatterSonificationDefaultSpeechOptionsMappingNoteDuration NoteDuration_DefaultValue { get; set; }
		...
		/// </summary>
		public PlotOptionsScatterSonificationDefaultSpeechOptionsMappingPan Pan { get; set; }
		private PlotOptionsScatterSonificationDefaultSpeechOptionsMappingPan Pan_DefaultValue { get; set; }
		...
		/// </summary>
		public PlotOptionsScatterSonificationDefaultSpeechOptionsMappingPitch Pitch { get; set; }
		private PlotOptionsScatterSonificationDefaultSpeechOptionsMappingPitch Pitch_DefaultValue { get; set; }
		...
		/// </summary>
		public PlotOptionsScatterSonificationDefaultSpeechOptionsMappingPlayDelay PlayDelay { get; set; }
		private PlotOptionsScatterSonificationDefaultSpeechOptionsMappingPlayDelay PlayDelay_DefaultValue { get; set; }
		...
		/// </summary>
		public PlotOptionsScatterSonificationDefaultSpeechOptionsMappingTime Time { get; set; }
		private PlotOptionsScatterSonificationDefaultSpeechOptionsMappingTime Time_DefaultValue { get; set; }
		...
		/// </summary>
		public PlotOptionsScatterSonificationDefaultSpeechOptionsMappingTremolo Tremolo { get; set; }
		private PlotOptionsScatterSonificationDefaultSpeechOptionsMappingTremolo Tremolo_DefaultValue { get; set; }
		 

		/// <summary>
		/// The volume of notes, from 0 to 1.
		/// </summary>
		public PlotOptionsScatterSonificationDefaultSpeechOptionsMappingVolume Volume { get; set; }
		private PlotOptionsScatterSonificationDefaultSpeechOptionsMappingVolume Volume_DefaultValue { get; set; }
