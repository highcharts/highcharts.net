...
{
	public partial class PlotOptionsScatterSonificationPointGrouping  : BaseObject
	{
		Hashtable h = new Hashtable();

		public PlotOptionsScatterSonificationPointGrouping()
		{
		...
		/// </summary>
		public PlotOptionsScatterSonificationPointGroupingAlgorithm Algorithm { get; set; }
		private PlotOptionsScatterSonificationPointGroupingAlgorithm Algorithm_DefaultValue { get; set; }
		...
		internal override Hashtable ToHashtable(Highcharts highcharts)
		{
			...
			if (Algorithm != PlotOptionsScatterSonificationPointGroupingAlgorithm.Null) h.Add("algorithm", highcharts.FirstCharacterToLower(Algorithm.ToString()));
