...
{
	public partial class PlotOptionsScatterSonificationTracksMappingPan  : BaseObject
	{
		Hashtable h = new Hashtable();

		public PlotOptionsScatterSonificationTracksMappingPan()
		{
			MapFunction = MapFunction_DefaultValue = PlotOptionsScatterSonificationTracksMappingPanMapFunction.Linear;
			MapTo = MapTo_DefaultValue = "";
			Max = Max_DefaultValue = null;
			Min = Min_DefaultValue = null;
			Value = Value_DefaultValue = null;
			Within = Within_DefaultValue = PlotOptionsScatterSonificationTracksMappingPanWithin.Chart;
		...
		/// </summary>
		public PlotOptionsScatterSonificationTracksMappingPanMapFunction MapFunction { get; set; }
		private PlotOptionsScatterSonificationTracksMappingPanMapFunction MapFunction_DefaultValue { get; set; }
		...
		/// </summary>
		public PlotOptionsScatterSonificationTracksMappingPanWithin Within { get; set; }
		private PlotOptionsScatterSonificationTracksMappingPanWithin Within_DefaultValue { get; set; }
