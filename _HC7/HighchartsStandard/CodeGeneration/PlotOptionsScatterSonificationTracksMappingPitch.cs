...
{
	public partial class PlotOptionsScatterSonificationTracksMappingPitch  : BaseObject
	{
		Hashtable h = new Hashtable();

		public PlotOptionsScatterSonificationTracksMappingPitch()
		{
			MapFunction = MapFunction_DefaultValue = PlotOptionsScatterSonificationTracksMappingPitchMapFunction.Linear;
		...
		/// </summary>
		public PlotOptionsScatterSonificationTracksMappingPitchMapFunction MapFunction { get; set; }
		private PlotOptionsScatterSonificationTracksMappingPitchMapFunction MapFunction_DefaultValue { get; set; }
