...
{
	public partial class PlotOptionsScatterSonificationTracksMappingTime  : BaseObject
	{
		Hashtable h = new Hashtable();

		public PlotOptionsScatterSonificationTracksMappingTime()
		{
			MapFunction = MapFunction_DefaultValue = PlotOptionsScatterSonificationTracksMappingTimeMapFunction.Linear;
			MapTo = MapTo_DefaultValue = "";
			Max = Max_DefaultValue = null;
			Min = Min_DefaultValue = null;
			Value = Value_DefaultValue = null;
			Within = Within_DefaultValue = PlotOptionsScatterSonificationTracksMappingTimeWithin.Chart;
		...
		/// </summary>
		public PlotOptionsScatterSonificationTracksMappingTimeMapFunction MapFunction { get; set; }
		private PlotOptionsScatterSonificationTracksMappingTimeMapFunction MapFunction_DefaultValue { get; set; }
		...
		/// </summary>
		public PlotOptionsScatterSonificationTracksMappingTimeWithin Within { get; set; }
		private PlotOptionsScatterSonificationTracksMappingTimeWithin Within_DefaultValue { get; set; }
