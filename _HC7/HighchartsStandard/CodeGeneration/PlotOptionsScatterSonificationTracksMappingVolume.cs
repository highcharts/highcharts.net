...
{
	public partial class PlotOptionsScatterSonificationTracksMappingVolume  : BaseObject
	{
		Hashtable h = new Hashtable();

		public PlotOptionsScatterSonificationTracksMappingVolume()
		{
			MapFunction = MapFunction_DefaultValue = PlotOptionsScatterSonificationTracksMappingVolumeMapFunction.Linear;
			MapTo = MapTo_DefaultValue = "";
			Max = Max_DefaultValue = null;
			Min = Min_DefaultValue = null;
			Value = Value_DefaultValue = null;
			Within = Within_DefaultValue = PlotOptionsScatterSonificationTracksMappingVolumeWithin.Chart;
		...
		/// </summary>
		public PlotOptionsScatterSonificationTracksMappingVolumeMapFunction MapFunction { get; set; }
		private PlotOptionsScatterSonificationTracksMappingVolumeMapFunction MapFunction_DefaultValue { get; set; }
		...
		/// </summary>
		public PlotOptionsScatterSonificationTracksMappingVolumeWithin Within { get; set; }
		private PlotOptionsScatterSonificationTracksMappingVolumeWithin Within_DefaultValue { get; set; }
