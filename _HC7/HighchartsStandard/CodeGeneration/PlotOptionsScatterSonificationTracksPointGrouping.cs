...
{
	public partial class PlotOptionsScatterSonificationTracksPointGrouping  : BaseObject
	{
		Hashtable h = new Hashtable();

		public PlotOptionsScatterSonificationTracksPointGrouping()
		{
		...
		/// </summary>
		public PlotOptionsScatterSonificationTracksPointGroupingAlgorithm Algorithm { get; set; }
		private PlotOptionsScatterSonificationTracksPointGroupingAlgorithm Algorithm_DefaultValue { get; set; }
		...
		internal override Hashtable ToHashtable(Highcharts highcharts)
		{
			...
			if (Algorithm != PlotOptionsScatterSonificationTracksPointGroupingAlgorithm.Null) h.Add("algorithm", highcharts.FirstCharacterToLower(Algorithm.ToString()));
