...
{
	public partial class PlotOptionsSeriesSonificationContextTracksMapping  : BaseObject
	{
		Hashtable h = new Hashtable();

		public PlotOptionsSeriesSonificationContextTracksMapping()
		{
			Frequency = Frequency_DefaultValue = new PlotOptionsSeriesSonificationContextTracksMappingFrequency();
			GapBetweenNotes = GapBetweenNotes_DefaultValue = new PlotOptionsSeriesSonificationContextTracksMappingGapBetweenNotes();
			Highpass = Highpass_DefaultValue = new PlotOptionsSeriesSonificationContextTracksMappingHighpass();
			Lowpass = Lowpass_DefaultValue = new PlotOptionsSeriesSonificationContextTracksMappingLowpass();
			NoteDuration = NoteDuration_DefaultValue = new PlotOptionsSeriesSonificationContextTracksMappingNoteDuration();
			Pan = Pan_DefaultValue = new PlotOptionsSeriesSonificationContextTracksMappingPan();
			Pitch = Pitch_DefaultValue = new PlotOptionsSeriesSonificationContextTracksMappingPitch();
			PitchString = PitchString_DefaultValue = "null";
			PitchNumber = PitchNumber_DefaultValue = null;
			PlayDelay = PlayDelay_DefaultValue = new PlotOptionsSeriesSonificationContextTracksMappingPlayDelay();
			Time = Time_DefaultValue = new PlotOptionsSeriesSonificationContextTracksMappingTime();
			TimeString = TimeString_DefaultValue = "null";
			TimeNumber = TimeNumber_DefaultValue = null;
			Tremolo = Tremolo_DefaultValue = new PlotOptionsSeriesSonificationContextTracksMappingTremolo();
			Volume = Volume_DefaultValue = new PlotOptionsSeriesSonificationContextTracksMappingVolume();
		...
		/// </summary>
		public PlotOptionsSeriesSonificationContextTracksMappingFrequency Frequency { get; set; }
		private PlotOptionsSeriesSonificationContextTracksMappingFrequency Frequency_DefaultValue { get; set; }
		...
		/// </summary>
		public PlotOptionsSeriesSonificationContextTracksMappingGapBetweenNotes GapBetweenNotes { get; set; }
		private PlotOptionsSeriesSonificationContextTracksMappingGapBetweenNotes GapBetweenNotes_DefaultValue { get; set; }
		...
		/// </summary>
		public PlotOptionsSeriesSonificationContextTracksMappingHighpass Highpass { get; set; }
		private PlotOptionsSeriesSonificationContextTracksMappingHighpass Highpass_DefaultValue { get; set; }
		...
		/// </summary>
		public PlotOptionsSeriesSonificationContextTracksMappingLowpass Lowpass { get; set; }
		private PlotOptionsSeriesSonificationContextTracksMappingLowpass Lowpass_DefaultValue { get; set; }
		...
		/// </summary>
		public PlotOptionsSeriesSonificationContextTracksMappingNoteDuration NoteDuration { get; set; }
		private PlotOptionsSeriesSonificationContextTracksMappingNoteDuration NoteDuration_DefaultValue { get; set; }
		...
		/// </summary>
		public PlotOptionsSeriesSonificationContextTracksMappingPan Pan { get; set; }
		private PlotOptionsSeriesSonificationContextTracksMappingPan Pan_DefaultValue { get; set; }
		...
		/// </summary>
		public PlotOptionsSeriesSonificationContextTracksMappingPitch Pitch { get; set; }
		private PlotOptionsSeriesSonificationContextTracksMappingPitch Pitch_DefaultValue { get; set; }
		...
		/// </summary>
		public PlotOptionsSeriesSonificationContextTracksMappingPlayDelay PlayDelay { get; set; }
		private PlotOptionsSeriesSonificationContextTracksMappingPlayDelay PlayDelay_DefaultValue { get; set; }
		...
		/// </summary>
		public PlotOptionsSeriesSonificationContextTracksMappingTime Time { get; set; }
		private PlotOptionsSeriesSonificationContextTracksMappingTime Time_DefaultValue { get; set; }
		...
		/// </summary>
		public PlotOptionsSeriesSonificationContextTracksMappingTremolo Tremolo { get; set; }
		private PlotOptionsSeriesSonificationContextTracksMappingTremolo Tremolo_DefaultValue { get; set; }
		 

		/// <summary>
		/// The volume of notes, from 0 to 1.
		/// </summary>
		public PlotOptionsSeriesSonificationContextTracksMappingVolume Volume { get; set; }
		private PlotOptionsSeriesSonificationContextTracksMappingVolume Volume_DefaultValue { get; set; }
