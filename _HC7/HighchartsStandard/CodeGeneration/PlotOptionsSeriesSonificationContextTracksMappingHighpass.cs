...
namespace Highsoft.Web.Mvc.Charts
{
	public partial class PlotOptionsSeriesSonificationContextTracksMappingHighpass  : BaseObject
	{
		...
		{
			Frequency = Frequency_DefaultValue = new PlotOptionsSeriesSonificationContextTracksMappingHighpassFrequency();
			Resonance = Resonance_DefaultValue = new PlotOptionsSeriesSonificationContextTracksMappingHighpassResonance();
		...
		private PlotOptionsSeriesSonificationContextTracksMappingHighpassFrequency Frequency_DefaultValue { get; set; }
		...
		private PlotOptionsSeriesSonificationContextTracksMappingHighpassResonance Resonance_DefaultValue { get; set; }
