...
{
	public partial class PlotOptionsSeriesSonificationDefaultInstrumentOptionsMappingLowpassResonance  : BaseObject
	{
		Hashtable h = new Hashtable();

		public PlotOptionsSeriesSonificationDefaultInstrumentOptionsMappingLowpassResonance()
		{
			MapFunction = MapFunction_DefaultValue = PlotOptionsSeriesSonificationDefaultInstrumentOptionsMappingLowpassResonanceMapFunction.Linear;
			MapTo = MapTo_DefaultValue = "";
			Max = Max_DefaultValue = null;
			Min = Min_DefaultValue = null;
			Value = Value_DefaultValue = null;
			Within = Within_DefaultValue = PlotOptionsSeriesSonificationDefaultInstrumentOptionsMappingLowpassResonanceWithin.Chart;
		...
		/// </summary>
		public PlotOptionsSeriesSonificationDefaultInstrumentOptionsMappingLowpassResonanceMapFunction MapFunction { get; set; }
		private PlotOptionsSeriesSonificationDefaultInstrumentOptionsMappingLowpassResonanceMapFunction MapFunction_DefaultValue { get; set; }
		...
		/// </summary>
		public PlotOptionsSeriesSonificationDefaultInstrumentOptionsMappingLowpassResonanceWithin Within { get; set; }
		private PlotOptionsSeriesSonificationDefaultInstrumentOptionsMappingLowpassResonanceWithin Within_DefaultValue { get; set; }
