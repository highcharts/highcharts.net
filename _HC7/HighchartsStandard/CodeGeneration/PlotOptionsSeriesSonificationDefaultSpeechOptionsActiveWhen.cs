...
{
	public partial class PlotOptionsSeriesSonificationDefaultSpeechOptionsActiveWhen  : BaseObject
	{
		Hashtable h = new Hashtable();

		public PlotOptionsSeriesSonificationDefaultSpeechOptionsActiveWhen()
		{
