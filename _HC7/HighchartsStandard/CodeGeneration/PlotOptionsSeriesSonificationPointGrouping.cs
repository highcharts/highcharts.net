...
{
	public partial class PlotOptionsSeriesSonificationPointGrouping  : BaseObject
	{
		Hashtable h = new Hashtable();

		public PlotOptionsSeriesSonificationPointGrouping()
		{
		...
		/// </summary>
		public PlotOptionsSeriesSonificationPointGroupingAlgorithm Algorithm { get; set; }
		private PlotOptionsSeriesSonificationPointGroupingAlgorithm Algorithm_DefaultValue { get; set; }
		...
		internal override Hashtable ToHashtable(Highcharts highcharts)
		{
			...
			if (Algorithm != PlotOptionsSeriesSonificationPointGroupingAlgorithm.Null) h.Add("algorithm", highcharts.FirstCharacterToLower(Algorithm.ToString()));
