...
{
	public partial class PlotOptionsSeriesSonificationTracksMapping  : BaseObject
	{
		Hashtable h = new Hashtable();

		public PlotOptionsSeriesSonificationTracksMapping()
		{
			Frequency = Frequency_DefaultValue = new PlotOptionsSeriesSonificationTracksMappingFrequency();
			GapBetweenNotes = GapBetweenNotes_DefaultValue = new PlotOptionsSeriesSonificationTracksMappingGapBetweenNotes();
			Highpass = Highpass_DefaultValue = new PlotOptionsSeriesSonificationTracksMappingHighpass();
			Lowpass = Lowpass_DefaultValue = new PlotOptionsSeriesSonificationTracksMappingLowpass();
			NoteDuration = NoteDuration_DefaultValue = new PlotOptionsSeriesSonificationTracksMappingNoteDuration();
			Pan = Pan_DefaultValue = new PlotOptionsSeriesSonificationTracksMappingPan();
			Pitch = Pitch_DefaultValue = new PlotOptionsSeriesSonificationTracksMappingPitch();
			PitchString = PitchString_DefaultValue = "null";
			PitchNumber = PitchNumber_DefaultValue = null;
			PlayDelay = PlayDelay_DefaultValue = new PlotOptionsSeriesSonificationTracksMappingPlayDelay();
			Time = Time_DefaultValue = new PlotOptionsSeriesSonificationTracksMappingTime();
			TimeString = TimeString_DefaultValue = "null";
			TimeNumber = TimeNumber_DefaultValue = null;
			Tremolo = Tremolo_DefaultValue = new PlotOptionsSeriesSonificationTracksMappingTremolo();
			Volume = Volume_DefaultValue = new PlotOptionsSeriesSonificationTracksMappingVolume();
		...
		/// </summary>
		public PlotOptionsSeriesSonificationTracksMappingFrequency Frequency { get; set; }
		private PlotOptionsSeriesSonificationTracksMappingFrequency Frequency_DefaultValue { get; set; }
		...
		/// </summary>
		public PlotOptionsSeriesSonificationTracksMappingGapBetweenNotes GapBetweenNotes { get; set; }
		private PlotOptionsSeriesSonificationTracksMappingGapBetweenNotes GapBetweenNotes_DefaultValue { get; set; }
		...
		/// </summary>
		public PlotOptionsSeriesSonificationTracksMappingHighpass Highpass { get; set; }
		private PlotOptionsSeriesSonificationTracksMappingHighpass Highpass_DefaultValue { get; set; }
		...
		/// </summary>
		public PlotOptionsSeriesSonificationTracksMappingLowpass Lowpass { get; set; }
		private PlotOptionsSeriesSonificationTracksMappingLowpass Lowpass_DefaultValue { get; set; }
		...
		/// </summary>
		public PlotOptionsSeriesSonificationTracksMappingNoteDuration NoteDuration { get; set; }
		private PlotOptionsSeriesSonificationTracksMappingNoteDuration NoteDuration_DefaultValue { get; set; }
		...
		/// </summary>
		public PlotOptionsSeriesSonificationTracksMappingPan Pan { get; set; }
		private PlotOptionsSeriesSonificationTracksMappingPan Pan_DefaultValue { get; set; }
		...
		/// </summary>
		public PlotOptionsSeriesSonificationTracksMappingPitch Pitch { get; set; }
		private PlotOptionsSeriesSonificationTracksMappingPitch Pitch_DefaultValue { get; set; }
		...
		/// </summary>
		public PlotOptionsSeriesSonificationTracksMappingPlayDelay PlayDelay { get; set; }
		private PlotOptionsSeriesSonificationTracksMappingPlayDelay PlayDelay_DefaultValue { get; set; }
		...
		/// </summary>
		public PlotOptionsSeriesSonificationTracksMappingTime Time { get; set; }
		private PlotOptionsSeriesSonificationTracksMappingTime Time_DefaultValue { get; set; }
		...
		/// </summary>
		public PlotOptionsSeriesSonificationTracksMappingTremolo Tremolo { get; set; }
		private PlotOptionsSeriesSonificationTracksMappingTremolo Tremolo_DefaultValue { get; set; }
		 

		/// <summary>
		/// The volume of notes, from 0 to 1.
		/// </summary>
		public PlotOptionsSeriesSonificationTracksMappingVolume Volume { get; set; }
		private PlotOptionsSeriesSonificationTracksMappingVolume Volume_DefaultValue { get; set; }
