...
{
	public partial class PlotOptionsSeriesSonificationTracksMappingFrequency  : BaseObject
	{
		Hashtable h = new Hashtable();

		public PlotOptionsSeriesSonificationTracksMappingFrequency()
		{
			MapFunction = MapFunction_DefaultValue = PlotOptionsSeriesSonificationTracksMappingFrequencyMapFunction.Linear;
			MapTo = MapTo_DefaultValue = "";
			Max = Max_DefaultValue = null;
			Min = Min_DefaultValue = null;
			Value = Value_DefaultValue = null;
			Within = Within_DefaultValue = PlotOptionsSeriesSonificationTracksMappingFrequencyWithin.Chart;
		...
		/// </summary>
		public PlotOptionsSeriesSonificationTracksMappingFrequencyMapFunction MapFunction { get; set; }
		private PlotOptionsSeriesSonificationTracksMappingFrequencyMapFunction MapFunction_DefaultValue { get; set; }
		...
		/// </summary>
		public PlotOptionsSeriesSonificationTracksMappingFrequencyWithin Within { get; set; }
		private PlotOptionsSeriesSonificationTracksMappingFrequencyWithin Within_DefaultValue { get; set; }
