...
{
	public partial class PlotOptionsSeriesSonificationTracksMappingPan  : BaseObject
	{
		Hashtable h = new Hashtable();

		public PlotOptionsSeriesSonificationTracksMappingPan()
		{
			MapFunction = MapFunction_DefaultValue = PlotOptionsSeriesSonificationTracksMappingPanMapFunction.Linear;
			MapTo = MapTo_DefaultValue = "";
			Max = Max_DefaultValue = null;
			Min = Min_DefaultValue = null;
			Value = Value_DefaultValue = null;
			Within = Within_DefaultValue = PlotOptionsSeriesSonificationTracksMappingPanWithin.Chart;
		...
		/// </summary>
		public PlotOptionsSeriesSonificationTracksMappingPanMapFunction MapFunction { get; set; }
		private PlotOptionsSeriesSonificationTracksMappingPanMapFunction MapFunction_DefaultValue { get; set; }
		...
		/// </summary>
		public PlotOptionsSeriesSonificationTracksMappingPanWithin Within { get; set; }
		private PlotOptionsSeriesSonificationTracksMappingPanWithin Within_DefaultValue { get; set; }
