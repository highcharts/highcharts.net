...
{
	public partial class PlotOptionsSeriesSonificationTracksMappingPitch  : BaseObject
	{
		Hashtable h = new Hashtable();

		public PlotOptionsSeriesSonificationTracksMappingPitch()
		{
			MapFunction = MapFunction_DefaultValue = PlotOptionsSeriesSonificationTracksMappingPitchMapFunction.Linear;
		...
		/// </summary>
		public PlotOptionsSeriesSonificationTracksMappingPitchMapFunction MapFunction { get; set; }
		private PlotOptionsSeriesSonificationTracksMappingPitchMapFunction MapFunction_DefaultValue { get; set; }
