...
{
	public partial class PlotOptionsSeriesSonificationTracksMappingTime  : BaseObject
	{
		Hashtable h = new Hashtable();

		public PlotOptionsSeriesSonificationTracksMappingTime()
		{
			MapFunction = MapFunction_DefaultValue = PlotOptionsSeriesSonificationTracksMappingTimeMapFunction.Linear;
			MapTo = MapTo_DefaultValue = "";
			Max = Max_DefaultValue = null;
			Min = Min_DefaultValue = null;
			Value = Value_DefaultValue = null;
			Within = Within_DefaultValue = PlotOptionsSeriesSonificationTracksMappingTimeWithin.Chart;
		...
		/// </summary>
		public PlotOptionsSeriesSonificationTracksMappingTimeMapFunction MapFunction { get; set; }
		private PlotOptionsSeriesSonificationTracksMappingTimeMapFunction MapFunction_DefaultValue { get; set; }
		...
		/// </summary>
		public PlotOptionsSeriesSonificationTracksMappingTimeWithin Within { get; set; }
		private PlotOptionsSeriesSonificationTracksMappingTimeWithin Within_DefaultValue { get; set; }
