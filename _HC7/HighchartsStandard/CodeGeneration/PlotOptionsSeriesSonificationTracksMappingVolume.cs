...
{
	public partial class PlotOptionsSeriesSonificationTracksMappingVolume  : BaseObject
	{
		Hashtable h = new Hashtable();

		public PlotOptionsSeriesSonificationTracksMappingVolume()
		{
			MapFunction = MapFunction_DefaultValue = PlotOptionsSeriesSonificationTracksMappingVolumeMapFunction.Linear;
			MapTo = MapTo_DefaultValue = "";
			Max = Max_DefaultValue = null;
			Min = Min_DefaultValue = null;
			Value = Value_DefaultValue = null;
			Within = Within_DefaultValue = PlotOptionsSeriesSonificationTracksMappingVolumeWithin.Chart;
		...
		/// </summary>
		public PlotOptionsSeriesSonificationTracksMappingVolumeMapFunction MapFunction { get; set; }
		private PlotOptionsSeriesSonificationTracksMappingVolumeMapFunction MapFunction_DefaultValue { get; set; }
		...
		/// </summary>
		public PlotOptionsSeriesSonificationTracksMappingVolumeWithin Within { get; set; }
		private PlotOptionsSeriesSonificationTracksMappingVolumeWithin Within_DefaultValue { get; set; }
