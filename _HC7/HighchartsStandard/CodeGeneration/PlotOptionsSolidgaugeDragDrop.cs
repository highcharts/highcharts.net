...
{
	public partial class PlotOptionsSolidgaugeDragDrop  : BaseObject
	{
		public PlotOptionsSolidgaugeDragDrop()
		{
			DraggableX = DraggableX_DefaultValue = null;
			DraggableY = DraggableY_DefaultValue = null;
			DragHandle = DragHandle_DefaultValue = new PlotOptionsSolidgaugeDragDropDragHandle();
			...
			GuideBox = GuideBox_DefaultValue = new PlotOptionsSolidgaugeDragDropGuideBox();
		...
		/// </summary>
		public PlotOptionsSolidgaugeDragDropDragHandle DragHandle { get; set; }
		private PlotOptionsSolidgaugeDragDropDragHandle DragHandle_DefaultValue { get; set; }
		...
		/// </summary>
		public PlotOptionsSolidgaugeDragDropGuideBox GuideBox { get; set; }
		private PlotOptionsSolidgaugeDragDropGuideBox GuideBox_DefaultValue { get; set; }
