...
{
	public partial class PlotOptionsSolidgaugeSonificationContextTracksActiveWhen  : BaseObject
	{
		Hashtable h = new Hashtable();

		public PlotOptionsSolidgaugeSonificationContextTracksActiveWhen()
		{
