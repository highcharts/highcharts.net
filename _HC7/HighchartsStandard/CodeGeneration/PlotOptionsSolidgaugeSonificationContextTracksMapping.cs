...
{
	public partial class PlotOptionsSolidgaugeSonificationContextTracksMapping  : BaseObject
	{
		Hashtable h = new Hashtable();

		public PlotOptionsSolidgaugeSonificationContextTracksMapping()
		{
			Frequency = Frequency_DefaultValue = new PlotOptionsSolidgaugeSonificationContextTracksMappingFrequency();
			GapBetweenNotes = GapBetweenNotes_DefaultValue = new PlotOptionsSolidgaugeSonificationContextTracksMappingGapBetweenNotes();
			Highpass = Highpass_DefaultValue = new PlotOptionsSolidgaugeSonificationContextTracksMappingHighpass();
			Lowpass = Lowpass_DefaultValue = new PlotOptionsSolidgaugeSonificationContextTracksMappingLowpass();
			NoteDuration = NoteDuration_DefaultValue = new PlotOptionsSolidgaugeSonificationContextTracksMappingNoteDuration();
			Pan = Pan_DefaultValue = new PlotOptionsSolidgaugeSonificationContextTracksMappingPan();
			Pitch = Pitch_DefaultValue = new PlotOptionsSolidgaugeSonificationContextTracksMappingPitch();
			PitchString = PitchString_DefaultValue = "null";
			PitchNumber = PitchNumber_DefaultValue = null;
			PlayDelay = PlayDelay_DefaultValue = new PlotOptionsSolidgaugeSonificationContextTracksMappingPlayDelay();
			Time = Time_DefaultValue = new PlotOptionsSolidgaugeSonificationContextTracksMappingTime();
			TimeString = TimeString_DefaultValue = "null";
			TimeNumber = TimeNumber_DefaultValue = null;
			Tremolo = Tremolo_DefaultValue = new PlotOptionsSolidgaugeSonificationContextTracksMappingTremolo();
			Volume = Volume_DefaultValue = new PlotOptionsSolidgaugeSonificationContextTracksMappingVolume();
		...
		/// </summary>
		public PlotOptionsSolidgaugeSonificationContextTracksMappingFrequency Frequency { get; set; }
		private PlotOptionsSolidgaugeSonificationContextTracksMappingFrequency Frequency_DefaultValue { get; set; }
		...
		/// </summary>
		public PlotOptionsSolidgaugeSonificationContextTracksMappingGapBetweenNotes GapBetweenNotes { get; set; }
		private PlotOptionsSolidgaugeSonificationContextTracksMappingGapBetweenNotes GapBetweenNotes_DefaultValue { get; set; }
		...
		/// </summary>
		public PlotOptionsSolidgaugeSonificationContextTracksMappingHighpass Highpass { get; set; }
		private PlotOptionsSolidgaugeSonificationContextTracksMappingHighpass Highpass_DefaultValue { get; set; }
		...
		/// </summary>
		public PlotOptionsSolidgaugeSonificationContextTracksMappingLowpass Lowpass { get; set; }
		private PlotOptionsSolidgaugeSonificationContextTracksMappingLowpass Lowpass_DefaultValue { get; set; }
		...
		/// </summary>
		public PlotOptionsSolidgaugeSonificationContextTracksMappingNoteDuration NoteDuration { get; set; }
		private PlotOptionsSolidgaugeSonificationContextTracksMappingNoteDuration NoteDuration_DefaultValue { get; set; }
		...
		/// </summary>
		public PlotOptionsSolidgaugeSonificationContextTracksMappingPan Pan { get; set; }
		private PlotOptionsSolidgaugeSonificationContextTracksMappingPan Pan_DefaultValue { get; set; }
		...
		/// </summary>
		public PlotOptionsSolidgaugeSonificationContextTracksMappingPitch Pitch { get; set; }
		private PlotOptionsSolidgaugeSonificationContextTracksMappingPitch Pitch_DefaultValue { get; set; }
		...
		/// </summary>
		public PlotOptionsSolidgaugeSonificationContextTracksMappingPlayDelay PlayDelay { get; set; }
		private PlotOptionsSolidgaugeSonificationContextTracksMappingPlayDelay PlayDelay_DefaultValue { get; set; }
		...
		/// </summary>
		public PlotOptionsSolidgaugeSonificationContextTracksMappingTime Time { get; set; }
		private PlotOptionsSolidgaugeSonificationContextTracksMappingTime Time_DefaultValue { get; set; }
		...
		/// </summary>
		public PlotOptionsSolidgaugeSonificationContextTracksMappingTremolo Tremolo { get; set; }
		private PlotOptionsSolidgaugeSonificationContextTracksMappingTremolo Tremolo_DefaultValue { get; set; }
		 

		/// <summary>
		/// The volume of notes, from 0 to 1.
		/// </summary>
		public PlotOptionsSolidgaugeSonificationContextTracksMappingVolume Volume { get; set; }
		private PlotOptionsSolidgaugeSonificationContextTracksMappingVolume Volume_DefaultValue { get; set; }
