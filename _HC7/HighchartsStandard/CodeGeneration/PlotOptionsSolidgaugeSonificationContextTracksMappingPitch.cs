...
{
	public partial class PlotOptionsSolidgaugeSonificationContextTracksMappingPitch  : BaseObject
	{
		Hashtable h = new Hashtable();

		public PlotOptionsSolidgaugeSonificationContextTracksMappingPitch()
		{
			MapFunction = MapFunction_DefaultValue = PlotOptionsSolidgaugeSonificationContextTracksMappingPitchMapFunction.Linear;
		...
		/// </summary>
		public PlotOptionsSolidgaugeSonificationContextTracksMappingPitchMapFunction MapFunction { get; set; }
		private PlotOptionsSolidgaugeSonificationContextTracksMappingPitchMapFunction MapFunction_DefaultValue { get; set; }
