...
{
	public partial class PlotOptionsSolidgaugeSonificationContextTracksMappingVolume  : BaseObject
	{
		Hashtable h = new Hashtable();

		public PlotOptionsSolidgaugeSonificationContextTracksMappingVolume()
		{
			MapFunction = MapFunction_DefaultValue = PlotOptionsSolidgaugeSonificationContextTracksMappingVolumeMapFunction.Linear;
			MapTo = MapTo_DefaultValue = "";
			Max = Max_DefaultValue = null;
			Min = Min_DefaultValue = null;
			Value = Value_DefaultValue = null;
			Within = Within_DefaultValue = PlotOptionsSolidgaugeSonificationContextTracksMappingVolumeWithin.Chart;
		...
		/// </summary>
		public PlotOptionsSolidgaugeSonificationContextTracksMappingVolumeMapFunction MapFunction { get; set; }
		private PlotOptionsSolidgaugeSonificationContextTracksMappingVolumeMapFunction MapFunction_DefaultValue { get; set; }
		...
		/// </summary>
		public PlotOptionsSolidgaugeSonificationContextTracksMappingVolumeWithin Within { get; set; }
		private PlotOptionsSolidgaugeSonificationContextTracksMappingVolumeWithin Within_DefaultValue { get; set; }
