...
{
	public partial class PlotOptionsSolidgaugeSonificationPointGrouping  : BaseObject
	{
		Hashtable h = new Hashtable();

		public PlotOptionsSolidgaugeSonificationPointGrouping()
		{
		...
		/// </summary>
		public PlotOptionsSolidgaugeSonificationPointGroupingAlgorithm Algorithm { get; set; }
		private PlotOptionsSolidgaugeSonificationPointGroupingAlgorithm Algorithm_DefaultValue { get; set; }
		...
		internal override Hashtable ToHashtable(Highcharts highcharts)
		{
			...
			if (Algorithm != PlotOptionsSolidgaugeSonificationPointGroupingAlgorithm.Null) h.Add("algorithm", highcharts.FirstCharacterToLower(Algorithm.ToString()));
