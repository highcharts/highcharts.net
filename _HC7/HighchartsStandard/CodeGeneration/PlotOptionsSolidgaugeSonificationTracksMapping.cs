...
{
	public partial class PlotOptionsSolidgaugeSonificationTracksMapping  : BaseObject
	{
		Hashtable h = new Hashtable();

		public PlotOptionsSolidgaugeSonificationTracksMapping()
		{
			Frequency = Frequency_DefaultValue = new PlotOptionsSolidgaugeSonificationTracksMappingFrequency();
			GapBetweenNotes = GapBetweenNotes_DefaultValue = new PlotOptionsSolidgaugeSonificationTracksMappingGapBetweenNotes();
			Highpass = Highpass_DefaultValue = new PlotOptionsSolidgaugeSonificationTracksMappingHighpass();
			Lowpass = Lowpass_DefaultValue = new PlotOptionsSolidgaugeSonificationTracksMappingLowpass();
			NoteDuration = NoteDuration_DefaultValue = new PlotOptionsSolidgaugeSonificationTracksMappingNoteDuration();
			Pan = Pan_DefaultValue = new PlotOptionsSolidgaugeSonificationTracksMappingPan();
			Pitch = Pitch_DefaultValue = new PlotOptionsSolidgaugeSonificationTracksMappingPitch();
			PitchString = PitchString_DefaultValue = "null";
			PitchNumber = PitchNumber_DefaultValue = null;
			PlayDelay = PlayDelay_DefaultValue = new PlotOptionsSolidgaugeSonificationTracksMappingPlayDelay();
			Time = Time_DefaultValue = new PlotOptionsSolidgaugeSonificationTracksMappingTime();
			TimeString = TimeString_DefaultValue = "null";
			TimeNumber = TimeNumber_DefaultValue = null;
			Tremolo = Tremolo_DefaultValue = new PlotOptionsSolidgaugeSonificationTracksMappingTremolo();
			Volume = Volume_DefaultValue = new PlotOptionsSolidgaugeSonificationTracksMappingVolume();
		...
		/// </summary>
		public PlotOptionsSolidgaugeSonificationTracksMappingFrequency Frequency { get; set; }
		private PlotOptionsSolidgaugeSonificationTracksMappingFrequency Frequency_DefaultValue { get; set; }
		...
		/// </summary>
		public PlotOptionsSolidgaugeSonificationTracksMappingGapBetweenNotes GapBetweenNotes { get; set; }
		private PlotOptionsSolidgaugeSonificationTracksMappingGapBetweenNotes GapBetweenNotes_DefaultValue { get; set; }
		...
		/// </summary>
		public PlotOptionsSolidgaugeSonificationTracksMappingHighpass Highpass { get; set; }
		private PlotOptionsSolidgaugeSonificationTracksMappingHighpass Highpass_DefaultValue { get; set; }
		...
		/// </summary>
		public PlotOptionsSolidgaugeSonificationTracksMappingLowpass Lowpass { get; set; }
		private PlotOptionsSolidgaugeSonificationTracksMappingLowpass Lowpass_DefaultValue { get; set; }
		...
		/// </summary>
		public PlotOptionsSolidgaugeSonificationTracksMappingNoteDuration NoteDuration { get; set; }
		private PlotOptionsSolidgaugeSonificationTracksMappingNoteDuration NoteDuration_DefaultValue { get; set; }
		...
		/// </summary>
		public PlotOptionsSolidgaugeSonificationTracksMappingPan Pan { get; set; }
		private PlotOptionsSolidgaugeSonificationTracksMappingPan Pan_DefaultValue { get; set; }
		...
		/// </summary>
		public PlotOptionsSolidgaugeSonificationTracksMappingPitch Pitch { get; set; }
		private PlotOptionsSolidgaugeSonificationTracksMappingPitch Pitch_DefaultValue { get; set; }
		...
		/// </summary>
		public PlotOptionsSolidgaugeSonificationTracksMappingPlayDelay PlayDelay { get; set; }
		private PlotOptionsSolidgaugeSonificationTracksMappingPlayDelay PlayDelay_DefaultValue { get; set; }
		...
		/// </summary>
		public PlotOptionsSolidgaugeSonificationTracksMappingTime Time { get; set; }
		private PlotOptionsSolidgaugeSonificationTracksMappingTime Time_DefaultValue { get; set; }
		...
		/// </summary>
		public PlotOptionsSolidgaugeSonificationTracksMappingTremolo Tremolo { get; set; }
		private PlotOptionsSolidgaugeSonificationTracksMappingTremolo Tremolo_DefaultValue { get; set; }
		 

		/// <summary>
		/// The volume of notes, from 0 to 1.
		/// </summary>
		public PlotOptionsSolidgaugeSonificationTracksMappingVolume Volume { get; set; }
		private PlotOptionsSolidgaugeSonificationTracksMappingVolume Volume_DefaultValue { get; set; }
