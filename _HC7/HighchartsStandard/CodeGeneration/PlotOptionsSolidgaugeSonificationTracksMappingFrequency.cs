...
{
	public partial class PlotOptionsSolidgaugeSonificationTracksMappingFrequency  : BaseObject
	{
		Hashtable h = new Hashtable();

		public PlotOptionsSolidgaugeSonificationTracksMappingFrequency()
		{
			MapFunction = MapFunction_DefaultValue = PlotOptionsSolidgaugeSonificationTracksMappingFrequencyMapFunction.Linear;
			MapTo = MapTo_DefaultValue = "";
			Max = Max_DefaultValue = null;
			Min = Min_DefaultValue = null;
			Value = Value_DefaultValue = null;
			Within = Within_DefaultValue = PlotOptionsSolidgaugeSonificationTracksMappingFrequencyWithin.Chart;
		...
		/// </summary>
		public PlotOptionsSolidgaugeSonificationTracksMappingFrequencyMapFunction MapFunction { get; set; }
		private PlotOptionsSolidgaugeSonificationTracksMappingFrequencyMapFunction MapFunction_DefaultValue { get; set; }
		...
		/// </summary>
		public PlotOptionsSolidgaugeSonificationTracksMappingFrequencyWithin Within { get; set; }
		private PlotOptionsSolidgaugeSonificationTracksMappingFrequencyWithin Within_DefaultValue { get; set; }
