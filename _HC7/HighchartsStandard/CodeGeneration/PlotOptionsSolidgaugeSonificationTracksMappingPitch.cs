...
{
	public partial class PlotOptionsSolidgaugeSonificationTracksMappingPitch  : BaseObject
	{
		Hashtable h = new Hashtable();

		public PlotOptionsSolidgaugeSonificationTracksMappingPitch()
		{
			MapFunction = MapFunction_DefaultValue = PlotOptionsSolidgaugeSonificationTracksMappingPitchMapFunction.Linear;
		...
		/// </summary>
		public PlotOptionsSolidgaugeSonificationTracksMappingPitchMapFunction MapFunction { get; set; }
		private PlotOptionsSolidgaugeSonificationTracksMappingPitchMapFunction MapFunction_DefaultValue { get; set; }
