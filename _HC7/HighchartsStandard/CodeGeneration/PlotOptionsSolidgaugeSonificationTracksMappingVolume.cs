...
{
	public partial class PlotOptionsSolidgaugeSonificationTracksMappingVolume  : BaseObject
	{
		Hashtable h = new Hashtable();

		public PlotOptionsSolidgaugeSonificationTracksMappingVolume()
		{
			MapFunction = MapFunction_DefaultValue = PlotOptionsSolidgaugeSonificationTracksMappingVolumeMapFunction.Linear;
			MapTo = MapTo_DefaultValue = "";
			Max = Max_DefaultValue = null;
			Min = Min_DefaultValue = null;
			Value = Value_DefaultValue = null;
			Within = Within_DefaultValue = PlotOptionsSolidgaugeSonificationTracksMappingVolumeWithin.Chart;
		...
		/// </summary>
		public PlotOptionsSolidgaugeSonificationTracksMappingVolumeMapFunction MapFunction { get; set; }
		private PlotOptionsSolidgaugeSonificationTracksMappingVolumeMapFunction MapFunction_DefaultValue { get; set; }
		...
		/// </summary>
		public PlotOptionsSolidgaugeSonificationTracksMappingVolumeWithin Within { get; set; }
		private PlotOptionsSolidgaugeSonificationTracksMappingVolumeWithin Within_DefaultValue { get; set; }
