...
namespace Highsoft.Web.Mvc.Charts
{
	public partial class PlotOptionsSolidgaugeTooltip  : BaseObject
	{
		public PlotOptionsSolidgaugeTooltip()
		{
			...
			HeaderShape = HeaderShape_DefaultValue = PlotOptionsSolidgaugeTooltipHeaderShape.Callout;
		...
		/// </summary>
		public PlotOptionsSolidgaugeTooltipHeaderShape HeaderShape { get; set; }
		private PlotOptionsSolidgaugeTooltipHeaderShape HeaderShape_DefaultValue { get; set; }
		...
		internal override Hashtable ToHashtable()
		{
			...
			if (NullFormatter != NullFormatter_DefaultValue) { h.Add("nullFormatter",NullFormatter); Highcharts.AddFunction("PlotOptionsSolidgaugeTooltipNullFormatter.nullFormatter", NullFormatter); }  
			if (Outside != Outside_DefaultValue) h.Add("outside",Outside);
			if (Padding != Padding_DefaultValue) h.Add("padding",Padding);
			if (PointFormat != PointFormat_DefaultValue) h.Add("pointFormat",PointFormat);
			if (PointFormatter != PointFormatter_DefaultValue) { h.Add("pointFormatter",PointFormatter); Highcharts.AddFunction("PlotOptionsSolidgaugeTooltipPointFormatter.pointFormatter", PointFormatter); }  
