...
namespace Highsoft.Web.Mvc.Charts
{
	public partial class PlotOptionsSplineMarkerStates  : BaseObject
	{
		public PlotOptionsSplineMarkerStates()
		{
			...
			Inactive = Inactive_DefaultValue = new PlotOptionsSplineMarkerStatesInactive();
		...
		/// 
		/// </summary>
		public PlotOptionsSplineMarkerStatesInactive Inactive { get; set; }
		private PlotOptionsSplineMarkerStatesInactive Inactive_DefaultValue { get; set; }
