...
{
	public partial class PlotOptionsSplineSonificationContextTracks  : BaseObject
	{
		Hashtable h = new Hashtable();

		public PlotOptionsSplineSonificationContextTracks()
		{
			ActiveWhen = ActiveWhen_DefaultValue = new PlotOptionsSplineSonificationContextTracksActiveWhen();
			Instrument = Instrument_DefaultValue = null;
			InstrumentString = InstrumentString_DefaultValue = "null";
			Mapping = Mapping_DefaultValue = new PlotOptionsSplineSonificationContextTracksMapping();
			MidiName = MidiName_DefaultValue = "";
			PointGrouping = PointGrouping_DefaultValue = new PlotOptionsSplineSonificationContextTracksPointGrouping();
			...
			Type = Type_DefaultValue = PlotOptionsSplineSonificationContextTracksType.Instrument;
			ValueInterval = ValueInterval_DefaultValue = null;
			ValueMapFunction = ValueMapFunction_DefaultValue = PlotOptionsSplineSonificationContextTracksValueMapFunction.Linear;
		...
		/// </summary>
		public PlotOptionsSplineSonificationContextTracksActiveWhen ActiveWhen { get; set; }
		private PlotOptionsSplineSonificationContextTracksActiveWhen ActiveWhen_DefaultValue { get; set; }
		...
		/// </summary>
		public PlotOptionsSplineSonificationContextTracksMapping Mapping { get; set; }
		private PlotOptionsSplineSonificationContextTracksMapping Mapping_DefaultValue { get; set; }
		...
		/// </summary>
		public PlotOptionsSplineSonificationContextTracksPointGrouping PointGrouping { get; set; }
		private PlotOptionsSplineSonificationContextTracksPointGrouping PointGrouping_DefaultValue { get; set; }
		...
		/// </summary>
		public PlotOptionsSplineSonificationContextTracksType Type { get; set; }
		private PlotOptionsSplineSonificationContextTracksType Type_DefaultValue { get; set; }
		...
		/// </summary>
		public PlotOptionsSplineSonificationContextTracksValueMapFunction ValueMapFunction { get; set; }
		private PlotOptionsSplineSonificationContextTracksValueMapFunction ValueMapFunction_DefaultValue { get; set; }
