...
{
	public partial class PlotOptionsSplineSonificationPointGrouping  : BaseObject
	{
		Hashtable h = new Hashtable();

		public PlotOptionsSplineSonificationPointGrouping()
		{
		...
		/// </summary>
		public PlotOptionsSplineSonificationPointGroupingAlgorithm Algorithm { get; set; }
		private PlotOptionsSplineSonificationPointGroupingAlgorithm Algorithm_DefaultValue { get; set; }
		...
		internal override Hashtable ToHashtable(Highcharts highcharts)
		{
			...
			if (Algorithm != PlotOptionsSplineSonificationPointGroupingAlgorithm.Null) h.Add("algorithm", highcharts.FirstCharacterToLower(Algorithm.ToString()));
