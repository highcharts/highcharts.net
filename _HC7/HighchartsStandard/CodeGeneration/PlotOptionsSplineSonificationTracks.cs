...
{
	public partial class PlotOptionsSplineSonificationTracks  : BaseObject
	{
		Hashtable h = new Hashtable();

		public PlotOptionsSplineSonificationTracks()
		{
			ActiveWhen = ActiveWhen_DefaultValue = new PlotOptionsSplineSonificationTracksActiveWhen();
			Instrument = Instrument_DefaultValue = null;
			InstrumentString = InstrumentString_DefaultValue = "null";
			Mapping = Mapping_DefaultValue = new PlotOptionsSplineSonificationTracksMapping();
			MidiName = MidiName_DefaultValue = "";
			PointGrouping = PointGrouping_DefaultValue = new PlotOptionsSplineSonificationTracksPointGrouping();
			RoundToMusicalNotes = RoundToMusicalNotes_DefaultValue = true;
			ShowPlayMarker = ShowPlayMarker_DefaultValue = true;
			Type = Type_DefaultValue = PlotOptionsSplineSonificationTracksType.Instrument;
		...
		/// </summary>
		public PlotOptionsSplineSonificationTracksActiveWhen ActiveWhen { get; set; }
		private PlotOptionsSplineSonificationTracksActiveWhen ActiveWhen_DefaultValue { get; set; }
		...
		/// </summary>
		public PlotOptionsSplineSonificationTracksMapping Mapping { get; set; }
		private PlotOptionsSplineSonificationTracksMapping Mapping_DefaultValue { get; set; }
		...
		/// </summary>
		public PlotOptionsSplineSonificationTracksPointGrouping PointGrouping { get; set; }
		private PlotOptionsSplineSonificationTracksPointGrouping PointGrouping_DefaultValue { get; set; }
		...
		/// </summary>
		public PlotOptionsSplineSonificationTracksType Type { get; set; }
		private PlotOptionsSplineSonificationTracksType Type_DefaultValue { get; set; }
