...
{
	public partial class PlotOptionsSplineSonificationTracksMappingLowpassFrequency  : BaseObject
	{
		Hashtable h = new Hashtable();

		public PlotOptionsSplineSonificationTracksMappingLowpassFrequency()
		{
			MapFunction = MapFunction_DefaultValue = PlotOptionsSplineSonificationTracksMappingLowpassFrequencyMapFunction.Linear;
			MapTo = MapTo_DefaultValue = "";
			Max = Max_DefaultValue = null;
			Min = Min_DefaultValue = null;
			Value = Value_DefaultValue = null;
			Within = Within_DefaultValue = PlotOptionsSplineSonificationTracksMappingLowpassFrequencyWithin.Chart;
		...
		/// </summary>
		public PlotOptionsSplineSonificationTracksMappingLowpassFrequencyMapFunction MapFunction { get; set; }
		private PlotOptionsSplineSonificationTracksMappingLowpassFrequencyMapFunction MapFunction_DefaultValue { get; set; }
		...
		/// </summary>
		public PlotOptionsSplineSonificationTracksMappingLowpassFrequencyWithin Within { get; set; }
		private PlotOptionsSplineSonificationTracksMappingLowpassFrequencyWithin Within_DefaultValue { get; set; }
