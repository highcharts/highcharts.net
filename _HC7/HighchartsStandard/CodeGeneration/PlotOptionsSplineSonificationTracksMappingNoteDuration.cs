...
{
	public partial class PlotOptionsSplineSonificationTracksMappingNoteDuration  : BaseObject
	{
		Hashtable h = new Hashtable();

		public PlotOptionsSplineSonificationTracksMappingNoteDuration()
		{
			MapFunction = MapFunction_DefaultValue = PlotOptionsSplineSonificationTracksMappingNoteDurationMapFunction.Linear;
			MapTo = MapTo_DefaultValue = "";
			Max = Max_DefaultValue = null;
			Min = Min_DefaultValue = null;
			Value = Value_DefaultValue = null;
			Within = Within_DefaultValue = PlotOptionsSplineSonificationTracksMappingNoteDurationWithin.Chart;
		...
		/// </summary>
		public PlotOptionsSplineSonificationTracksMappingNoteDurationMapFunction MapFunction { get; set; }
		private PlotOptionsSplineSonificationTracksMappingNoteDurationMapFunction MapFunction_DefaultValue { get; set; }
		...
		/// </summary>
		public PlotOptionsSplineSonificationTracksMappingNoteDurationWithin Within { get; set; }
		private PlotOptionsSplineSonificationTracksMappingNoteDurationWithin Within_DefaultValue { get; set; }
