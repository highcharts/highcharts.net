...
{
	public partial class PlotOptionsSplineSonificationTracksMappingPan  : BaseObject
	{
		Hashtable h = new Hashtable();

		public PlotOptionsSplineSonificationTracksMappingPan()
		{
			MapFunction = MapFunction_DefaultValue = PlotOptionsSplineSonificationTracksMappingPanMapFunction.Linear;
			MapTo = MapTo_DefaultValue = "";
			Max = Max_DefaultValue = null;
			Min = Min_DefaultValue = null;
			Value = Value_DefaultValue = null;
			Within = Within_DefaultValue = PlotOptionsSplineSonificationTracksMappingPanWithin.Chart;
		...
		/// </summary>
		public PlotOptionsSplineSonificationTracksMappingPanMapFunction MapFunction { get; set; }
		private PlotOptionsSplineSonificationTracksMappingPanMapFunction MapFunction_DefaultValue { get; set; }
		...
		/// </summary>
		public PlotOptionsSplineSonificationTracksMappingPanWithin Within { get; set; }
		private PlotOptionsSplineSonificationTracksMappingPanWithin Within_DefaultValue { get; set; }
