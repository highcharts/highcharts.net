...
{
	public partial class PlotOptionsSplineSonificationTracksMappingPitch  : BaseObject
	{
		Hashtable h = new Hashtable();

		public PlotOptionsSplineSonificationTracksMappingPitch()
		{
			MapFunction = MapFunction_DefaultValue = PlotOptionsSplineSonificationTracksMappingPitchMapFunction.Linear;
		...
		/// </summary>
		public PlotOptionsSplineSonificationTracksMappingPitchMapFunction MapFunction { get; set; }
		private PlotOptionsSplineSonificationTracksMappingPitchMapFunction MapFunction_DefaultValue { get; set; }
