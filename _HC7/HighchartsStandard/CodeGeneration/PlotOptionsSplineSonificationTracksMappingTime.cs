...
{
	public partial class PlotOptionsSplineSonificationTracksMappingTime  : BaseObject
	{
		Hashtable h = new Hashtable();

		public PlotOptionsSplineSonificationTracksMappingTime()
		{
			MapFunction = MapFunction_DefaultValue = PlotOptionsSplineSonificationTracksMappingTimeMapFunction.Linear;
			MapTo = MapTo_DefaultValue = "";
			Max = Max_DefaultValue = null;
			Min = Min_DefaultValue = null;
			Value = Value_DefaultValue = null;
			Within = Within_DefaultValue = PlotOptionsSplineSonificationTracksMappingTimeWithin.Chart;
		...
		/// </summary>
		public PlotOptionsSplineSonificationTracksMappingTimeMapFunction MapFunction { get; set; }
		private PlotOptionsSplineSonificationTracksMappingTimeMapFunction MapFunction_DefaultValue { get; set; }
		...
		/// </summary>
		public PlotOptionsSplineSonificationTracksMappingTimeWithin Within { get; set; }
		private PlotOptionsSplineSonificationTracksMappingTimeWithin Within_DefaultValue { get; set; }
