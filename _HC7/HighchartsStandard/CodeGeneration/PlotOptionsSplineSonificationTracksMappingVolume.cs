...
{
	public partial class PlotOptionsSplineSonificationTracksMappingVolume  : BaseObject
	{
		Hashtable h = new Hashtable();

		public PlotOptionsSplineSonificationTracksMappingVolume()
		{
			MapFunction = MapFunction_DefaultValue = PlotOptionsSplineSonificationTracksMappingVolumeMapFunction.Linear;
			MapTo = MapTo_DefaultValue = "";
			Max = Max_DefaultValue = null;
			Min = Min_DefaultValue = null;
			Value = Value_DefaultValue = null;
			Within = Within_DefaultValue = PlotOptionsSplineSonificationTracksMappingVolumeWithin.Chart;
		...
		/// </summary>
		public PlotOptionsSplineSonificationTracksMappingVolumeMapFunction MapFunction { get; set; }
		private PlotOptionsSplineSonificationTracksMappingVolumeMapFunction MapFunction_DefaultValue { get; set; }
		...
		/// </summary>
		public PlotOptionsSplineSonificationTracksMappingVolumeWithin Within { get; set; }
		private PlotOptionsSplineSonificationTracksMappingVolumeWithin Within_DefaultValue { get; set; }
