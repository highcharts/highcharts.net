...
{
	public partial class PlotOptionsSplineSonificationTracksPointGrouping  : BaseObject
	{
		Hashtable h = new Hashtable();

		public PlotOptionsSplineSonificationTracksPointGrouping()
		{
		...
		/// </summary>
		public PlotOptionsSplineSonificationTracksPointGroupingAlgorithm Algorithm { get; set; }
		private PlotOptionsSplineSonificationTracksPointGroupingAlgorithm Algorithm_DefaultValue { get; set; }
		...
		internal override Hashtable ToHashtable(Highcharts highcharts)
		{
			...
			if (Algorithm != PlotOptionsSplineSonificationTracksPointGroupingAlgorithm.Null) h.Add("algorithm", highcharts.FirstCharacterToLower(Algorithm.ToString()));
