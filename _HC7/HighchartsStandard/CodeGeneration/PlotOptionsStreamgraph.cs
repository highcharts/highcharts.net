...
namespace Highsoft.Web.Mvc.Charts
{
	public partial class PlotOptionsStreamgraph  : BaseObject
	{
		...
		internal override Hashtable ToHashtable()
		{
			...
			if (PointDescriptionFormatter != PointDescriptionFormatter_DefaultValue) { h.Add("pointDescriptionFormatter",PointDescriptionFormatter); Highcharts.AddFunction("1485fc4a-0543-46b5-af59-a0d318d88e6a.pointDescriptionFormatter", PointDescriptionFormatter); }  
