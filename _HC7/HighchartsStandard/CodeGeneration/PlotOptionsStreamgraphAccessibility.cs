...
namespace Highsoft.Web.Mvc.Charts
{
	public partial class PlotOptionsStreamgraphAccessibility  : BaseObject
	{
		...
		internal override Hashtable ToHashtable()
		{
			...
			if (PointDescriptionFormatter != PointDescriptionFormatter_DefaultValue) { h.Add("pointDescriptionFormatter",PointDescriptionFormatter); Highcharts.AddFunction("6c2de3cd-0780-4b1d-b704-ebac9f7c1124.pointDescriptionFormatter", PointDescriptionFormatter); }  
