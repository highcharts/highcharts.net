...
{
	public partial class PlotOptionsStreamgraphAccessibility  : BaseObject
	{
		public PlotOptionsStreamgraphAccessibility()
		{
			Description = Description_DefaultValue = "undefined";
			Enabled = Enabled_DefaultValue = null;
			ExposeAsGroupOnly = ExposeAsGroupOnly_DefaultValue = null;
			KeyboardNavigation = KeyboardNavigation_DefaultValue = new PlotOptionsStreamgraphAccessibilityKeyboardNavigation();
		...
		internal override Hashtable ToHashtable()
		{
			...
			if (PointDescriptionFormatter != PointDescriptionFormatter_DefaultValue) { h.Add("pointDescriptionFormatter",PointDescriptionFormatter); Highcharts.AddFunction("PlotOptionsStreamgraphAccessibilityPointDescriptionFormatter.pointDescriptionFormatter", PointDescriptionFormatter); }  
