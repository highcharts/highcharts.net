...
{
	public partial class PlotOptionsStreamgraphSonificationContextTracks  : BaseObject
	{
		Hashtable h = new Hashtable();

		public PlotOptionsStreamgraphSonificationContextTracks()
		{
			ActiveWhen = ActiveWhen_DefaultValue = new PlotOptionsStreamgraphSonificationContextTracksActiveWhen();
			Instrument = Instrument_DefaultValue = null;
			InstrumentString = InstrumentString_DefaultValue = "null";
			Mapping = Mapping_DefaultValue = new PlotOptionsStreamgraphSonificationContextTracksMapping();
			MidiName = MidiName_DefaultValue = "";
			PointGrouping = PointGrouping_DefaultValue = new PlotOptionsStreamgraphSonificationContextTracksPointGrouping();
			...
			Type = Type_DefaultValue = PlotOptionsStreamgraphSonificationContextTracksType.Instrument;
			ValueInterval = ValueInterval_DefaultValue = null;
			ValueMapFunction = ValueMapFunction_DefaultValue = PlotOptionsStreamgraphSonificationContextTracksValueMapFunction.Linear;
		...
		/// </summary>
		public PlotOptionsStreamgraphSonificationContextTracksActiveWhen ActiveWhen { get; set; }
		private PlotOptionsStreamgraphSonificationContextTracksActiveWhen ActiveWhen_DefaultValue { get; set; }
		...
		/// </summary>
		public PlotOptionsStreamgraphSonificationContextTracksMapping Mapping { get; set; }
		private PlotOptionsStreamgraphSonificationContextTracksMapping Mapping_DefaultValue { get; set; }
		...
		/// </summary>
		public PlotOptionsStreamgraphSonificationContextTracksPointGrouping PointGrouping { get; set; }
		private PlotOptionsStreamgraphSonificationContextTracksPointGrouping PointGrouping_DefaultValue { get; set; }
		...
		/// </summary>
		public PlotOptionsStreamgraphSonificationContextTracksType Type { get; set; }
		private PlotOptionsStreamgraphSonificationContextTracksType Type_DefaultValue { get; set; }
		...
		/// </summary>
		public PlotOptionsStreamgraphSonificationContextTracksValueMapFunction ValueMapFunction { get; set; }
		private PlotOptionsStreamgraphSonificationContextTracksValueMapFunction ValueMapFunction_DefaultValue { get; set; }
