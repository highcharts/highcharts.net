...
{
	public partial class PlotOptionsStreamgraphSonificationContextTracksActiveWhen  : BaseObject
	{
		Hashtable h = new Hashtable();

		public PlotOptionsStreamgraphSonificationContextTracksActiveWhen()
		{
		}	
