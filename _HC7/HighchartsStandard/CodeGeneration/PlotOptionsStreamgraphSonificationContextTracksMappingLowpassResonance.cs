...
{
	public partial class PlotOptionsStreamgraphSonificationContextTracksMappingLowpassResonance  : BaseObject
	{
		Hashtable h = new Hashtable();

		public PlotOptionsStreamgraphSonificationContextTracksMappingLowpassResonance()
		{
			MapFunction = MapFunction_DefaultValue = PlotOptionsStreamgraphSonificationContextTracksMappingLowpassResonanceMapFunction.Linear;
			MapTo = MapTo_DefaultValue = "";
			Max = Max_DefaultValue = null;
			Min = Min_DefaultValue = null;
			Value = Value_DefaultValue = null;
			Within = Within_DefaultValue = PlotOptionsStreamgraphSonificationContextTracksMappingLowpassResonanceWithin.Chart;
		...
		/// </summary>
		public PlotOptionsStreamgraphSonificationContextTracksMappingLowpassResonanceMapFunction MapFunction { get; set; }
		private PlotOptionsStreamgraphSonificationContextTracksMappingLowpassResonanceMapFunction MapFunction_DefaultValue { get; set; }
		...
		/// </summary>
		public PlotOptionsStreamgraphSonificationContextTracksMappingLowpassResonanceWithin Within { get; set; }
		private PlotOptionsStreamgraphSonificationContextTracksMappingLowpassResonanceWithin Within_DefaultValue { get; set; }
