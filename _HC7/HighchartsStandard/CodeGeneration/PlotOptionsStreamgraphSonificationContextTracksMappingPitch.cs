...
{
	public partial class PlotOptionsStreamgraphSonificationContextTracksMappingPitch  : BaseObject
	{
		Hashtable h = new Hashtable();

		public PlotOptionsStreamgraphSonificationContextTracksMappingPitch()
		{
			MapFunction = MapFunction_DefaultValue = PlotOptionsStreamgraphSonificationContextTracksMappingPitchMapFunction.Linear;
		...
		/// </summary>
		public PlotOptionsStreamgraphSonificationContextTracksMappingPitchMapFunction MapFunction { get; set; }
		private PlotOptionsStreamgraphSonificationContextTracksMappingPitchMapFunction MapFunction_DefaultValue { get; set; }
