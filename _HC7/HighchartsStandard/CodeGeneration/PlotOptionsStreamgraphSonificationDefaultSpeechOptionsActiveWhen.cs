...
{
	public partial class PlotOptionsStreamgraphSonificationDefaultSpeechOptionsActiveWhen  : BaseObject
	{
		Hashtable h = new Hashtable();

		public PlotOptionsStreamgraphSonificationDefaultSpeechOptionsActiveWhen()
		{
