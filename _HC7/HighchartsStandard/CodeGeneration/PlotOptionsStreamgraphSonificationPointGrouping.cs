...
{
	public partial class PlotOptionsStreamgraphSonificationPointGrouping  : BaseObject
	{
		Hashtable h = new Hashtable();

		public PlotOptionsStreamgraphSonificationPointGrouping()
		{
		...
		/// </summary>
		public PlotOptionsStreamgraphSonificationPointGroupingAlgorithm Algorithm { get; set; }
		private PlotOptionsStreamgraphSonificationPointGroupingAlgorithm Algorithm_DefaultValue { get; set; }
		...
		internal override Hashtable ToHashtable(Highcharts highcharts)
		{
			...
			if (Algorithm != PlotOptionsStreamgraphSonificationPointGroupingAlgorithm.Null) h.Add("algorithm", highcharts.FirstCharacterToLower(Algorithm.ToString()));
