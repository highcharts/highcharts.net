...
{
	public partial class PlotOptionsStreamgraphSonificationTracksMappingFrequency  : BaseObject
	{
		Hashtable h = new Hashtable();

		public PlotOptionsStreamgraphSonificationTracksMappingFrequency()
		{
			MapFunction = MapFunction_DefaultValue = PlotOptionsStreamgraphSonificationTracksMappingFrequencyMapFunction.Linear;
			MapTo = MapTo_DefaultValue = "";
			Max = Max_DefaultValue = null;
			Min = Min_DefaultValue = null;
			Value = Value_DefaultValue = null;
			Within = Within_DefaultValue = PlotOptionsStreamgraphSonificationTracksMappingFrequencyWithin.Chart;
		...
		/// </summary>
		public PlotOptionsStreamgraphSonificationTracksMappingFrequencyMapFunction MapFunction { get; set; }
		private PlotOptionsStreamgraphSonificationTracksMappingFrequencyMapFunction MapFunction_DefaultValue { get; set; }
		...
		/// </summary>
		public PlotOptionsStreamgraphSonificationTracksMappingFrequencyWithin Within { get; set; }
		private PlotOptionsStreamgraphSonificationTracksMappingFrequencyWithin Within_DefaultValue { get; set; }
