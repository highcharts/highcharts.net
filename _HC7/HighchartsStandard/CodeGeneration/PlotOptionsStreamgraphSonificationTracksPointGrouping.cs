...
{
	public partial class PlotOptionsStreamgraphSonificationTracksPointGrouping  : BaseObject
	{
		Hashtable h = new Hashtable();

		public PlotOptionsStreamgraphSonificationTracksPointGrouping()
		{
		...
		/// </summary>
		public PlotOptionsStreamgraphSonificationTracksPointGroupingAlgorithm Algorithm { get; set; }
		private PlotOptionsStreamgraphSonificationTracksPointGroupingAlgorithm Algorithm_DefaultValue { get; set; }
		...
		internal override Hashtable ToHashtable(Highcharts highcharts)
		{
			...
			if (Algorithm != PlotOptionsStreamgraphSonificationTracksPointGroupingAlgorithm.Null) h.Add("algorithm", highcharts.FirstCharacterToLower(Algorithm.ToString()));
