...
{
	public partial class PlotOptionsStreamgraphTooltip  : BaseObject
	{
		public PlotOptionsStreamgraphTooltip()
		{
			...
			HeaderShape = HeaderShape_DefaultValue = PlotOptionsStreamgraphTooltipHeaderShape.Callout;
		...
		/// </summary>
		public PlotOptionsStreamgraphTooltipHeaderShape HeaderShape { get; set; }
		private PlotOptionsStreamgraphTooltipHeaderShape HeaderShape_DefaultValue { get; set; }
		...
		internal override Hashtable ToHashtable()
		{
			...
			if (NullFormatter != NullFormatter_DefaultValue) { h.Add("nullFormatter",NullFormatter); Highcharts.AddFunction("PlotOptionsStreamgraphTooltipNullFormatter.nullFormatter", NullFormatter); }  
			if (Outside != Outside_DefaultValue) h.Add("outside",Outside);
			if (Padding != Padding_DefaultValue) h.Add("padding",Padding);
			if (PointFormat != PointFormat_DefaultValue) h.Add("pointFormat",PointFormat);
			if (PointFormatter != PointFormatter_DefaultValue) { h.Add("pointFormatter",PointFormatter); Highcharts.AddFunction("PlotOptionsStreamgraphTooltipPointFormatter.pointFormatter", PointFormatter); }  
