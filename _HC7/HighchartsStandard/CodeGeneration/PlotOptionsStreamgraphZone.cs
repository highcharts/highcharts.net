...
{
	public partial class PlotOptionsStreamgraphZone  : BaseObject
	{
		...
		internal override Hashtable ToHashtable(Highcharts highcharts)
		{
			...
			if (DashStyle != PlotOptionsStreamgraphZonesDashStyle.Null) h.Add("dashStyle", highcharts.FirstCharacterToLower(DashStyle.ToString()));
