...
namespace Highsoft.Web.Mvc.Charts
{
	public partial class PlotOptionsSunburst  : BaseObject
	{
		...
		public PlotOptionsSunburst()
		{
			...
			LegendSymbol = LegendSymbol_DefaultValue = PlotOptionsSunburstLegendSymbol.Rectangle;
			...
			Sonification = Sonification_DefaultValue = new PlotOptionsSunburstSonification();
		...
		private PlotOptionsSunburstLegendSymbol LegendSymbol_DefaultValue { get; set; }
		...
		private PlotOptionsSunburstSonification Sonification_DefaultValue { get; set; }
