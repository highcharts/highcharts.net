...
{
	public partial class PlotOptionsSunburstBreadcrumbs  : BaseObject
	{
		...
		/// </summary>
		public PlotOptionsSunburstBreadcrumbsButtonTheme ButtonTheme { get; set; }
		private PlotOptionsSunburstBreadcrumbsButtonTheme ButtonTheme_DefaultValue { get; set; }
		 

		/// <summary>
		/// 
		/// </summary>
		public PlotOptionsSunburstBreadcrumbsEvents Events { get; set; }
		private PlotOptionsSunburstBreadcrumbsEvents Events_DefaultValue { get; set; }
		...
		/// </summary>
		public PlotOptionsSunburstBreadcrumbsPosition Position { get; set; }
		private PlotOptionsSunburstBreadcrumbsPosition Position_DefaultValue { get; set; }
		...
		/// </summary>
		public PlotOptionsSunburstBreadcrumbsSeparator Separator { get; set; }
		private PlotOptionsSunburstBreadcrumbsSeparator Separator_DefaultValue { get; set; }
