...
namespace Highsoft.Web.Mvc.Charts
{
	public partial class PlotOptionsSunburstDataLabels  : BaseObject
	{
		...
		{
			Align = Align_DefaultValue = PlotOptionsSunburstDataLabelsAlign.Center;
			...
			Position = Position_DefaultValue = PlotOptionsSunburstDataLabelsPosition.Center;
			...
			TextPath = TextPath_DefaultValue = new PlotOptionsSunburstDataLabelsTextPath();
