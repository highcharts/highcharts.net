...
namespace Highsoft.Web.Mvc.Charts
{
	public partial class PlotOptionsSunburstDataLabels  : BaseObject
	{
		...
		/// </summary>
		public PlotOptionsSunburstDataLabelsAlign Align { get; set; }
		private PlotOptionsSunburstDataLabelsAlign Align_DefaultValue { get; set; }
		...
		/// </summary>
		public PlotOptionsSunburstDataLabelsOverflow Overflow { get; set; }
		private PlotOptionsSunburstDataLabelsOverflow Overflow_DefaultValue { get; set; }
		...
		/// </summary>
		public PlotOptionsSunburstDataLabelsPosition Position { get; set; }
		private PlotOptionsSunburstDataLabelsPosition Position_DefaultValue { get; set; }
		...
		/// </summary>
		public PlotOptionsSunburstDataLabelsTextPath TextPath { get; set; }
		private PlotOptionsSunburstDataLabelsTextPath TextPath_DefaultValue { get; set; }
		...
		internal override Hashtable ToHashtable(Highcharts highcharts)
		{
			...
			if (Align != PlotOptionsSunburstDataLabelsAlign.Null) h.Add("align", highcharts.FirstCharacterToLower(Align.ToString()));
			...
			if (Overflow != PlotOptionsSunburstDataLabelsOverflow.Null) h.Add("overflow", highcharts.FirstCharacterToLower(Overflow.ToString()));
			if (Padding != null) h.Add("padding",Padding);
			if (Position != PlotOptionsSunburstDataLabelsPosition.Null) h.Add("position", highcharts.FirstCharacterToLower(Position.ToString()));
			if (Rotation != null) h.Add("rotation",Rotation);
			if (RotationMode != PlotOptionsSunburstDataLabelsRotationMode.Null) h.Add("rotationMode", highcharts.FirstCharacterToLower(RotationMode.ToString()));
			...
			if (VerticalAlign != PlotOptionsSunburstDataLabelsVerticalAlign.Null) h.Add("verticalAlign", highcharts.FirstCharacterToLower(VerticalAlign.ToString()));
			if (X != null) h.Add("x",X);
			if (Y != null) h.Add("y",Y);
