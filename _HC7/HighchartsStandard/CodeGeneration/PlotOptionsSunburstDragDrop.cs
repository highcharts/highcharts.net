...
{
	public partial class PlotOptionsSunburstDragDrop  : BaseObject
	{
		public PlotOptionsSunburstDragDrop()
		{
			DraggableX = DraggableX_DefaultValue = null;
			DraggableY = DraggableY_DefaultValue = null;
			DragHandle = DragHandle_DefaultValue = new PlotOptionsSunburstDragDropDragHandle();
			...
			GuideBox = GuideBox_DefaultValue = new PlotOptionsSunburstDragDropGuideBox();
		...
		/// </summary>
		public PlotOptionsSunburstDragDropDragHandle DragHandle { get; set; }
		private PlotOptionsSunburstDragDropDragHandle DragHandle_DefaultValue { get; set; }
		...
		/// </summary>
		public PlotOptionsSunburstDragDropGuideBox GuideBox { get; set; }
		private PlotOptionsSunburstDragDropGuideBox GuideBox_DefaultValue { get; set; }
