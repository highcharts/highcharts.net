...
{
	public partial class PlotOptionsSunburstSonificationContextTracksMapping  : BaseObject
	{
		Hashtable h = new Hashtable();

		public PlotOptionsSunburstSonificationContextTracksMapping()
		{
			Frequency = Frequency_DefaultValue = new PlotOptionsSunburstSonificationContextTracksMappingFrequency();
			GapBetweenNotes = GapBetweenNotes_DefaultValue = new PlotOptionsSunburstSonificationContextTracksMappingGapBetweenNotes();
			Highpass = Highpass_DefaultValue = new PlotOptionsSunburstSonificationContextTracksMappingHighpass();
			Lowpass = Lowpass_DefaultValue = new PlotOptionsSunburstSonificationContextTracksMappingLowpass();
			NoteDuration = NoteDuration_DefaultValue = new PlotOptionsSunburstSonificationContextTracksMappingNoteDuration();
			Pan = Pan_DefaultValue = new PlotOptionsSunburstSonificationContextTracksMappingPan();
			Pitch = Pitch_DefaultValue = new PlotOptionsSunburstSonificationContextTracksMappingPitch();
			PitchString = PitchString_DefaultValue = "null";
			PitchNumber = PitchNumber_DefaultValue = null;
			PlayDelay = PlayDelay_DefaultValue = new PlotOptionsSunburstSonificationContextTracksMappingPlayDelay();
			Time = Time_DefaultValue = new PlotOptionsSunburstSonificationContextTracksMappingTime();
			TimeString = TimeString_DefaultValue = "null";
			TimeNumber = TimeNumber_DefaultValue = null;
			Tremolo = Tremolo_DefaultValue = new PlotOptionsSunburstSonificationContextTracksMappingTremolo();
			Volume = Volume_DefaultValue = new PlotOptionsSunburstSonificationContextTracksMappingVolume();
		...
		/// </summary>
		public PlotOptionsSunburstSonificationContextTracksMappingFrequency Frequency { get; set; }
		private PlotOptionsSunburstSonificationContextTracksMappingFrequency Frequency_DefaultValue { get; set; }
		...
		/// </summary>
		public PlotOptionsSunburstSonificationContextTracksMappingGapBetweenNotes GapBetweenNotes { get; set; }
		private PlotOptionsSunburstSonificationContextTracksMappingGapBetweenNotes GapBetweenNotes_DefaultValue { get; set; }
		...
		/// </summary>
		public PlotOptionsSunburstSonificationContextTracksMappingHighpass Highpass { get; set; }
		private PlotOptionsSunburstSonificationContextTracksMappingHighpass Highpass_DefaultValue { get; set; }
		...
		/// </summary>
		public PlotOptionsSunburstSonificationContextTracksMappingLowpass Lowpass { get; set; }
		private PlotOptionsSunburstSonificationContextTracksMappingLowpass Lowpass_DefaultValue { get; set; }
		...
		/// </summary>
		public PlotOptionsSunburstSonificationContextTracksMappingNoteDuration NoteDuration { get; set; }
		private PlotOptionsSunburstSonificationContextTracksMappingNoteDuration NoteDuration_DefaultValue { get; set; }
		...
		/// </summary>
		public PlotOptionsSunburstSonificationContextTracksMappingPan Pan { get; set; }
		private PlotOptionsSunburstSonificationContextTracksMappingPan Pan_DefaultValue { get; set; }
		...
		/// </summary>
		public PlotOptionsSunburstSonificationContextTracksMappingPitch Pitch { get; set; }
		private PlotOptionsSunburstSonificationContextTracksMappingPitch Pitch_DefaultValue { get; set; }
		...
		/// </summary>
		public PlotOptionsSunburstSonificationContextTracksMappingPlayDelay PlayDelay { get; set; }
		private PlotOptionsSunburstSonificationContextTracksMappingPlayDelay PlayDelay_DefaultValue { get; set; }
		...
		/// </summary>
		public PlotOptionsSunburstSonificationContextTracksMappingTime Time { get; set; }
		private PlotOptionsSunburstSonificationContextTracksMappingTime Time_DefaultValue { get; set; }
		...
		/// </summary>
		public PlotOptionsSunburstSonificationContextTracksMappingTremolo Tremolo { get; set; }
		private PlotOptionsSunburstSonificationContextTracksMappingTremolo Tremolo_DefaultValue { get; set; }
		 

		/// <summary>
		/// The volume of notes, from 0 to 1.
		/// </summary>
		public PlotOptionsSunburstSonificationContextTracksMappingVolume Volume { get; set; }
		private PlotOptionsSunburstSonificationContextTracksMappingVolume Volume_DefaultValue { get; set; }
