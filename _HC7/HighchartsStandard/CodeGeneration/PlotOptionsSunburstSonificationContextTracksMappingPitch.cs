...
{
	public partial class PlotOptionsSunburstSonificationContextTracksMappingPitch  : BaseObject
	{
		Hashtable h = new Hashtable();

		public PlotOptionsSunburstSonificationContextTracksMappingPitch()
		{
			MapFunction = MapFunction_DefaultValue = PlotOptionsSunburstSonificationContextTracksMappingPitchMapFunction.Linear;
		...
		/// </summary>
		public PlotOptionsSunburstSonificationContextTracksMappingPitchMapFunction MapFunction { get; set; }
		private PlotOptionsSunburstSonificationContextTracksMappingPitchMapFunction MapFunction_DefaultValue { get; set; }
