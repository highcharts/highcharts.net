...
{
	public partial class PlotOptionsSunburstSonificationPointGrouping  : BaseObject
	{
		Hashtable h = new Hashtable();

		public PlotOptionsSunburstSonificationPointGrouping()
		{
		...
		/// </summary>
		public PlotOptionsSunburstSonificationPointGroupingAlgorithm Algorithm { get; set; }
		private PlotOptionsSunburstSonificationPointGroupingAlgorithm Algorithm_DefaultValue { get; set; }
		...
		internal override Hashtable ToHashtable(Highcharts highcharts)
		{
			...
			if (Algorithm != PlotOptionsSunburstSonificationPointGroupingAlgorithm.Null) h.Add("algorithm", highcharts.FirstCharacterToLower(Algorithm.ToString()));
