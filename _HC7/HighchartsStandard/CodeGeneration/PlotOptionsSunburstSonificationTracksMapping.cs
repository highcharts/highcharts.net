...
{
	public partial class PlotOptionsSunburstSonificationTracksMapping  : BaseObject
	{
		Hashtable h = new Hashtable();

		public PlotOptionsSunburstSonificationTracksMapping()
		{
			Frequency = Frequency_DefaultValue = new PlotOptionsSunburstSonificationTracksMappingFrequency();
			GapBetweenNotes = GapBetweenNotes_DefaultValue = new PlotOptionsSunburstSonificationTracksMappingGapBetweenNotes();
			Highpass = Highpass_DefaultValue = new PlotOptionsSunburstSonificationTracksMappingHighpass();
			Lowpass = Lowpass_DefaultValue = new PlotOptionsSunburstSonificationTracksMappingLowpass();
			NoteDuration = NoteDuration_DefaultValue = new PlotOptionsSunburstSonificationTracksMappingNoteDuration();
			Pan = Pan_DefaultValue = new PlotOptionsSunburstSonificationTracksMappingPan();
			Pitch = Pitch_DefaultValue = new PlotOptionsSunburstSonificationTracksMappingPitch();
			PitchString = PitchString_DefaultValue = "null";
			PitchNumber = PitchNumber_DefaultValue = null;
			PlayDelay = PlayDelay_DefaultValue = new PlotOptionsSunburstSonificationTracksMappingPlayDelay();
			Time = Time_DefaultValue = new PlotOptionsSunburstSonificationTracksMappingTime();
			TimeString = TimeString_DefaultValue = "null";
			TimeNumber = TimeNumber_DefaultValue = null;
			Tremolo = Tremolo_DefaultValue = new PlotOptionsSunburstSonificationTracksMappingTremolo();
			Volume = Volume_DefaultValue = new PlotOptionsSunburstSonificationTracksMappingVolume();
		...
		/// </summary>
		public PlotOptionsSunburstSonificationTracksMappingFrequency Frequency { get; set; }
		private PlotOptionsSunburstSonificationTracksMappingFrequency Frequency_DefaultValue { get; set; }
		...
		/// </summary>
		public PlotOptionsSunburstSonificationTracksMappingGapBetweenNotes GapBetweenNotes { get; set; }
		private PlotOptionsSunburstSonificationTracksMappingGapBetweenNotes GapBetweenNotes_DefaultValue { get; set; }
		...
		/// </summary>
		public PlotOptionsSunburstSonificationTracksMappingHighpass Highpass { get; set; }
		private PlotOptionsSunburstSonificationTracksMappingHighpass Highpass_DefaultValue { get; set; }
		...
		/// </summary>
		public PlotOptionsSunburstSonificationTracksMappingLowpass Lowpass { get; set; }
		private PlotOptionsSunburstSonificationTracksMappingLowpass Lowpass_DefaultValue { get; set; }
		...
		/// </summary>
		public PlotOptionsSunburstSonificationTracksMappingNoteDuration NoteDuration { get; set; }
		private PlotOptionsSunburstSonificationTracksMappingNoteDuration NoteDuration_DefaultValue { get; set; }
		...
		/// </summary>
		public PlotOptionsSunburstSonificationTracksMappingPan Pan { get; set; }
		private PlotOptionsSunburstSonificationTracksMappingPan Pan_DefaultValue { get; set; }
		...
		/// </summary>
		public PlotOptionsSunburstSonificationTracksMappingPitch Pitch { get; set; }
		private PlotOptionsSunburstSonificationTracksMappingPitch Pitch_DefaultValue { get; set; }
		...
		/// </summary>
		public PlotOptionsSunburstSonificationTracksMappingPlayDelay PlayDelay { get; set; }
		private PlotOptionsSunburstSonificationTracksMappingPlayDelay PlayDelay_DefaultValue { get; set; }
		...
		/// </summary>
		public PlotOptionsSunburstSonificationTracksMappingTime Time { get; set; }
		private PlotOptionsSunburstSonificationTracksMappingTime Time_DefaultValue { get; set; }
		...
		/// </summary>
		public PlotOptionsSunburstSonificationTracksMappingTremolo Tremolo { get; set; }
		private PlotOptionsSunburstSonificationTracksMappingTremolo Tremolo_DefaultValue { get; set; }
		 

		/// <summary>
		/// The volume of notes, from 0 to 1.
		/// </summary>
		public PlotOptionsSunburstSonificationTracksMappingVolume Volume { get; set; }
		private PlotOptionsSunburstSonificationTracksMappingVolume Volume_DefaultValue { get; set; }
