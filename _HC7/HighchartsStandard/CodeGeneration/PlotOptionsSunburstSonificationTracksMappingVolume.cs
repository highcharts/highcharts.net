...
{
	public partial class PlotOptionsSunburstSonificationTracksMappingVolume  : BaseObject
	{
		Hashtable h = new Hashtable();

		public PlotOptionsSunburstSonificationTracksMappingVolume()
		{
			MapFunction = MapFunction_DefaultValue = PlotOptionsSunburstSonificationTracksMappingVolumeMapFunction.Linear;
			MapTo = MapTo_DefaultValue = "";
			Max = Max_DefaultValue = null;
			Min = Min_DefaultValue = null;
			Value = Value_DefaultValue = null;
			Within = Within_DefaultValue = PlotOptionsSunburstSonificationTracksMappingVolumeWithin.Chart;
		...
		/// </summary>
		public PlotOptionsSunburstSonificationTracksMappingVolumeMapFunction MapFunction { get; set; }
		private PlotOptionsSunburstSonificationTracksMappingVolumeMapFunction MapFunction_DefaultValue { get; set; }
		...
		/// </summary>
		public PlotOptionsSunburstSonificationTracksMappingVolumeWithin Within { get; set; }
		private PlotOptionsSunburstSonificationTracksMappingVolumeWithin Within_DefaultValue { get; set; }
