...
{
	public partial class PlotOptionsSunburstSonificationTracksPointGrouping  : BaseObject
	{
		Hashtable h = new Hashtable();

		public PlotOptionsSunburstSonificationTracksPointGrouping()
		{
		...
		/// </summary>
		public PlotOptionsSunburstSonificationTracksPointGroupingAlgorithm Algorithm { get; set; }
		private PlotOptionsSunburstSonificationTracksPointGroupingAlgorithm Algorithm_DefaultValue { get; set; }
		...
		internal override Hashtable ToHashtable(Highcharts highcharts)
		{
			...
			if (Algorithm != PlotOptionsSunburstSonificationTracksPointGroupingAlgorithm.Null) h.Add("algorithm", highcharts.FirstCharacterToLower(Algorithm.ToString()));
