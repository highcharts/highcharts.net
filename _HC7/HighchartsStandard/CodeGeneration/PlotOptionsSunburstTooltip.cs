...
{
	public partial class PlotOptionsSunburstTooltip  : BaseObject
	{
		public PlotOptionsSunburstTooltip()
		{
			...
			HeaderShape = HeaderShape_DefaultValue = PlotOptionsSunburstTooltipHeaderShape.Callout;
		...
		/// </summary>
		public PlotOptionsSunburstTooltipHeaderShape HeaderShape { get; set; }
		private PlotOptionsSunburstTooltipHeaderShape HeaderShape_DefaultValue { get; set; }
		...
		internal override Hashtable ToHashtable()
		{
			...
			if (NullFormatter != NullFormatter_DefaultValue) { h.Add("nullFormatter",NullFormatter); Highcharts.AddFunction("PlotOptionsSunburstTooltipNullFormatter.nullFormatter", NullFormatter); }  
			if (Outside != Outside_DefaultValue) h.Add("outside",Outside);
			if (Padding != Padding_DefaultValue) h.Add("padding",Padding);
			if (PointFormat != PointFormat_DefaultValue) h.Add("pointFormat",PointFormat);
			if (PointFormatter != PointFormatter_DefaultValue) { h.Add("pointFormatter",PointFormatter); Highcharts.AddFunction("PlotOptionsSunburstTooltipPointFormatter.pointFormatter", PointFormatter); }  
