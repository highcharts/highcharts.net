...
{
	public partial class PlotOptionsTilemapSonificationContextTracksMapping  : BaseObject
	{
		Hashtable h = new Hashtable();

		public PlotOptionsTilemapSonificationContextTracksMapping()
		{
			Frequency = Frequency_DefaultValue = new PlotOptionsTilemapSonificationContextTracksMappingFrequency();
			GapBetweenNotes = GapBetweenNotes_DefaultValue = new PlotOptionsTilemapSonificationContextTracksMappingGapBetweenNotes();
			Highpass = Highpass_DefaultValue = new PlotOptionsTilemapSonificationContextTracksMappingHighpass();
			Lowpass = Lowpass_DefaultValue = new PlotOptionsTilemapSonificationContextTracksMappingLowpass();
			NoteDuration = NoteDuration_DefaultValue = new PlotOptionsTilemapSonificationContextTracksMappingNoteDuration();
			Pan = Pan_DefaultValue = new PlotOptionsTilemapSonificationContextTracksMappingPan();
			Pitch = Pitch_DefaultValue = new PlotOptionsTilemapSonificationContextTracksMappingPitch();
			PitchString = PitchString_DefaultValue = "null";
			PitchNumber = PitchNumber_DefaultValue = null;
			PlayDelay = PlayDelay_DefaultValue = new PlotOptionsTilemapSonificationContextTracksMappingPlayDelay();
			Time = Time_DefaultValue = new PlotOptionsTilemapSonificationContextTracksMappingTime();
			TimeString = TimeString_DefaultValue = "null";
			TimeNumber = TimeNumber_DefaultValue = null;
			Tremolo = Tremolo_DefaultValue = new PlotOptionsTilemapSonificationContextTracksMappingTremolo();
			Volume = Volume_DefaultValue = new PlotOptionsTilemapSonificationContextTracksMappingVolume();
		...
		/// </summary>
		public PlotOptionsTilemapSonificationContextTracksMappingFrequency Frequency { get; set; }
		private PlotOptionsTilemapSonificationContextTracksMappingFrequency Frequency_DefaultValue { get; set; }
		...
		/// </summary>
		public PlotOptionsTilemapSonificationContextTracksMappingGapBetweenNotes GapBetweenNotes { get; set; }
		private PlotOptionsTilemapSonificationContextTracksMappingGapBetweenNotes GapBetweenNotes_DefaultValue { get; set; }
		...
		/// </summary>
		public PlotOptionsTilemapSonificationContextTracksMappingHighpass Highpass { get; set; }
		private PlotOptionsTilemapSonificationContextTracksMappingHighpass Highpass_DefaultValue { get; set; }
		...
		/// </summary>
		public PlotOptionsTilemapSonificationContextTracksMappingLowpass Lowpass { get; set; }
		private PlotOptionsTilemapSonificationContextTracksMappingLowpass Lowpass_DefaultValue { get; set; }
		...
		/// </summary>
		public PlotOptionsTilemapSonificationContextTracksMappingNoteDuration NoteDuration { get; set; }
		private PlotOptionsTilemapSonificationContextTracksMappingNoteDuration NoteDuration_DefaultValue { get; set; }
		...
		/// </summary>
		public PlotOptionsTilemapSonificationContextTracksMappingPan Pan { get; set; }
		private PlotOptionsTilemapSonificationContextTracksMappingPan Pan_DefaultValue { get; set; }
		...
		/// </summary>
		public PlotOptionsTilemapSonificationContextTracksMappingPitch Pitch { get; set; }
		private PlotOptionsTilemapSonificationContextTracksMappingPitch Pitch_DefaultValue { get; set; }
		...
		/// </summary>
		public PlotOptionsTilemapSonificationContextTracksMappingPlayDelay PlayDelay { get; set; }
		private PlotOptionsTilemapSonificationContextTracksMappingPlayDelay PlayDelay_DefaultValue { get; set; }
		...
		/// </summary>
		public PlotOptionsTilemapSonificationContextTracksMappingTime Time { get; set; }
		private PlotOptionsTilemapSonificationContextTracksMappingTime Time_DefaultValue { get; set; }
		...
		/// </summary>
		public PlotOptionsTilemapSonificationContextTracksMappingTremolo Tremolo { get; set; }
		private PlotOptionsTilemapSonificationContextTracksMappingTremolo Tremolo_DefaultValue { get; set; }
		 

		/// <summary>
		/// The volume of notes, from 0 to 1.
		/// </summary>
		public PlotOptionsTilemapSonificationContextTracksMappingVolume Volume { get; set; }
		private PlotOptionsTilemapSonificationContextTracksMappingVolume Volume_DefaultValue { get; set; }
