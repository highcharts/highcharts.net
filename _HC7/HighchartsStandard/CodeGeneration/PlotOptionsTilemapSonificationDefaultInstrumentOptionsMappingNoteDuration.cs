...
{
	public partial class PlotOptionsTilemapSonificationDefaultInstrumentOptionsMappingNoteDuration  : BaseObject
	{
		Hashtable h = new Hashtable();

		public PlotOptionsTilemapSonificationDefaultInstrumentOptionsMappingNoteDuration()
		{
			MapFunction = MapFunction_DefaultValue = PlotOptionsTilemapSonificationDefaultInstrumentOptionsMappingNoteDurationMapFunction.Linear;
			MapTo = MapTo_DefaultValue = "";
			Max = Max_DefaultValue = null;
			Min = Min_DefaultValue = null;
			Value = Value_DefaultValue = null;
			Within = Within_DefaultValue = PlotOptionsTilemapSonificationDefaultInstrumentOptionsMappingNoteDurationWithin.Chart;
		...
		/// </summary>
		public PlotOptionsTilemapSonificationDefaultInstrumentOptionsMappingNoteDurationMapFunction MapFunction { get; set; }
		private PlotOptionsTilemapSonificationDefaultInstrumentOptionsMappingNoteDurationMapFunction MapFunction_DefaultValue { get; set; }
		...
		/// </summary>
		public PlotOptionsTilemapSonificationDefaultInstrumentOptionsMappingNoteDurationWithin Within { get; set; }
		private PlotOptionsTilemapSonificationDefaultInstrumentOptionsMappingNoteDurationWithin Within_DefaultValue { get; set; }
