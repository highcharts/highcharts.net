...
{
	public partial class PlotOptionsTilemapSonificationDefaultSpeechOptions  : BaseObject
	{
		Hashtable h = new Hashtable();

		public PlotOptionsTilemapSonificationDefaultSpeechOptions()
		{
			ActiveWhen = ActiveWhen_DefaultValue = new PlotOptionsTilemapSonificationDefaultSpeechOptionsActiveWhen();
			Language = Language_DefaultValue = "en-US";
			Mapping = Mapping_DefaultValue = new PlotOptionsTilemapSonificationDefaultSpeechOptionsMapping();
			PointGrouping = PointGrouping_DefaultValue = new PlotOptionsTilemapSonificationDefaultSpeechOptionsPointGrouping();
			PreferredVoice = PreferredVoice_DefaultValue = "";
			ShowPlayMarker = ShowPlayMarker_DefaultValue = true;
			Type = Type_DefaultValue = PlotOptionsTilemapSonificationDefaultSpeechOptionsType.Instrument;
		...
		/// </summary>
		public PlotOptionsTilemapSonificationDefaultSpeechOptionsActiveWhen ActiveWhen { get; set; }
		private PlotOptionsTilemapSonificationDefaultSpeechOptionsActiveWhen ActiveWhen_DefaultValue { get; set; }
		...
		/// </summary>
		public PlotOptionsTilemapSonificationDefaultSpeechOptionsMapping Mapping { get; set; }
		private PlotOptionsTilemapSonificationDefaultSpeechOptionsMapping Mapping_DefaultValue { get; set; }
		 

		/// <summary>
		/// Options for point grouping, specifically for instrument tracks.
		/// </summary>
		public PlotOptionsTilemapSonificationDefaultSpeechOptionsPointGrouping PointGrouping { get; set; }
		private PlotOptionsTilemapSonificationDefaultSpeechOptionsPointGrouping PointGrouping_DefaultValue { get; set; }
		...
		/// </summary>
		public PlotOptionsTilemapSonificationDefaultSpeechOptionsType Type { get; set; }
		private PlotOptionsTilemapSonificationDefaultSpeechOptionsType Type_DefaultValue { get; set; }
