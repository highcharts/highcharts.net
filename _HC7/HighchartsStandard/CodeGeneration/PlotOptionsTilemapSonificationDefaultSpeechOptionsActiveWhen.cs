...
{
	public partial class PlotOptionsTilemapSonificationDefaultSpeechOptionsActiveWhen  : BaseObject
	{
		Hashtable h = new Hashtable();

		public PlotOptionsTilemapSonificationDefaultSpeechOptionsActiveWhen()
		{
