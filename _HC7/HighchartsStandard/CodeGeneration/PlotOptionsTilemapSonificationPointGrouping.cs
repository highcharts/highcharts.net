...
{
	public partial class PlotOptionsTilemapSonificationPointGrouping  : BaseObject
	{
		Hashtable h = new Hashtable();

		public PlotOptionsTilemapSonificationPointGrouping()
		{
		...
		/// </summary>
		public PlotOptionsTilemapSonificationPointGroupingAlgorithm Algorithm { get; set; }
		private PlotOptionsTilemapSonificationPointGroupingAlgorithm Algorithm_DefaultValue { get; set; }
		...
		internal override Hashtable ToHashtable(Highcharts highcharts)
		{
			...
			if (Algorithm != PlotOptionsTilemapSonificationPointGroupingAlgorithm.Null) h.Add("algorithm", highcharts.FirstCharacterToLower(Algorithm.ToString()));
