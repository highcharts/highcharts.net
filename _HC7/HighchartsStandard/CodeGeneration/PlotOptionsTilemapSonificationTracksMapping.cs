...
{
	public partial class PlotOptionsTilemapSonificationTracksMapping  : BaseObject
	{
		Hashtable h = new Hashtable();

		public PlotOptionsTilemapSonificationTracksMapping()
		{
			Frequency = Frequency_DefaultValue = new PlotOptionsTilemapSonificationTracksMappingFrequency();
			GapBetweenNotes = GapBetweenNotes_DefaultValue = new PlotOptionsTilemapSonificationTracksMappingGapBetweenNotes();
			Highpass = Highpass_DefaultValue = new PlotOptionsTilemapSonificationTracksMappingHighpass();
			Lowpass = Lowpass_DefaultValue = new PlotOptionsTilemapSonificationTracksMappingLowpass();
			NoteDuration = NoteDuration_DefaultValue = new PlotOptionsTilemapSonificationTracksMappingNoteDuration();
			Pan = Pan_DefaultValue = new PlotOptionsTilemapSonificationTracksMappingPan();
			Pitch = Pitch_DefaultValue = new PlotOptionsTilemapSonificationTracksMappingPitch();
			PitchString = PitchString_DefaultValue = "null";
			PitchNumber = PitchNumber_DefaultValue = null;
			PlayDelay = PlayDelay_DefaultValue = new PlotOptionsTilemapSonificationTracksMappingPlayDelay();
			Time = Time_DefaultValue = new PlotOptionsTilemapSonificationTracksMappingTime();
			TimeString = TimeString_DefaultValue = "null";
			TimeNumber = TimeNumber_DefaultValue = null;
			Tremolo = Tremolo_DefaultValue = new PlotOptionsTilemapSonificationTracksMappingTremolo();
			Volume = Volume_DefaultValue = new PlotOptionsTilemapSonificationTracksMappingVolume();
		...
		/// </summary>
		public PlotOptionsTilemapSonificationTracksMappingFrequency Frequency { get; set; }
		private PlotOptionsTilemapSonificationTracksMappingFrequency Frequency_DefaultValue { get; set; }
		...
		/// </summary>
		public PlotOptionsTilemapSonificationTracksMappingGapBetweenNotes GapBetweenNotes { get; set; }
		private PlotOptionsTilemapSonificationTracksMappingGapBetweenNotes GapBetweenNotes_DefaultValue { get; set; }
		...
		/// </summary>
		public PlotOptionsTilemapSonificationTracksMappingHighpass Highpass { get; set; }
		private PlotOptionsTilemapSonificationTracksMappingHighpass Highpass_DefaultValue { get; set; }
		...
		/// </summary>
		public PlotOptionsTilemapSonificationTracksMappingLowpass Lowpass { get; set; }
		private PlotOptionsTilemapSonificationTracksMappingLowpass Lowpass_DefaultValue { get; set; }
		...
		/// </summary>
		public PlotOptionsTilemapSonificationTracksMappingNoteDuration NoteDuration { get; set; }
		private PlotOptionsTilemapSonificationTracksMappingNoteDuration NoteDuration_DefaultValue { get; set; }
		...
		/// </summary>
		public PlotOptionsTilemapSonificationTracksMappingPan Pan { get; set; }
		private PlotOptionsTilemapSonificationTracksMappingPan Pan_DefaultValue { get; set; }
		...
		/// </summary>
		public PlotOptionsTilemapSonificationTracksMappingPitch Pitch { get; set; }
		private PlotOptionsTilemapSonificationTracksMappingPitch Pitch_DefaultValue { get; set; }
		...
		/// </summary>
		public PlotOptionsTilemapSonificationTracksMappingPlayDelay PlayDelay { get; set; }
		private PlotOptionsTilemapSonificationTracksMappingPlayDelay PlayDelay_DefaultValue { get; set; }
		...
		/// </summary>
		public PlotOptionsTilemapSonificationTracksMappingTime Time { get; set; }
		private PlotOptionsTilemapSonificationTracksMappingTime Time_DefaultValue { get; set; }
		...
		/// </summary>
		public PlotOptionsTilemapSonificationTracksMappingTremolo Tremolo { get; set; }
		private PlotOptionsTilemapSonificationTracksMappingTremolo Tremolo_DefaultValue { get; set; }
		 

		/// <summary>
		/// The volume of notes, from 0 to 1.
		/// </summary>
		public PlotOptionsTilemapSonificationTracksMappingVolume Volume { get; set; }
		private PlotOptionsTilemapSonificationTracksMappingVolume Volume_DefaultValue { get; set; }
