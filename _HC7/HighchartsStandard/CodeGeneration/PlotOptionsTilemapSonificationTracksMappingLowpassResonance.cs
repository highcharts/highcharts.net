...
{
	public partial class PlotOptionsTilemapSonificationTracksMappingLowpassResonance  : BaseObject
	{
		Hashtable h = new Hashtable();

		public PlotOptionsTilemapSonificationTracksMappingLowpassResonance()
		{
			MapFunction = MapFunction_DefaultValue = PlotOptionsTilemapSonificationTracksMappingLowpassResonanceMapFunction.Linear;
			MapTo = MapTo_DefaultValue = "";
			Max = Max_DefaultValue = null;
			Min = Min_DefaultValue = null;
			Value = Value_DefaultValue = null;
			Within = Within_DefaultValue = PlotOptionsTilemapSonificationTracksMappingLowpassResonanceWithin.Chart;
		...
		/// </summary>
		public PlotOptionsTilemapSonificationTracksMappingLowpassResonanceMapFunction MapFunction { get; set; }
		private PlotOptionsTilemapSonificationTracksMappingLowpassResonanceMapFunction MapFunction_DefaultValue { get; set; }
		...
		/// </summary>
		public PlotOptionsTilemapSonificationTracksMappingLowpassResonanceWithin Within { get; set; }
		private PlotOptionsTilemapSonificationTracksMappingLowpassResonanceWithin Within_DefaultValue { get; set; }
