...
{
	public partial class PlotOptionsTilemapSonificationTracksMappingPan  : BaseObject
	{
		Hashtable h = new Hashtable();

		public PlotOptionsTilemapSonificationTracksMappingPan()
		{
			MapFunction = MapFunction_DefaultValue = PlotOptionsTilemapSonificationTracksMappingPanMapFunction.Linear;
			MapTo = MapTo_DefaultValue = "";
			Max = Max_DefaultValue = null;
			Min = Min_DefaultValue = null;
			Value = Value_DefaultValue = null;
			Within = Within_DefaultValue = PlotOptionsTilemapSonificationTracksMappingPanWithin.Chart;
		...
		/// </summary>
		public PlotOptionsTilemapSonificationTracksMappingPanMapFunction MapFunction { get; set; }
		private PlotOptionsTilemapSonificationTracksMappingPanMapFunction MapFunction_DefaultValue { get; set; }
		...
		/// </summary>
		public PlotOptionsTilemapSonificationTracksMappingPanWithin Within { get; set; }
		private PlotOptionsTilemapSonificationTracksMappingPanWithin Within_DefaultValue { get; set; }
