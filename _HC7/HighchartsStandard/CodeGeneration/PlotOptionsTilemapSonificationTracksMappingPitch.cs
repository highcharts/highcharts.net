...
{
	public partial class PlotOptionsTilemapSonificationTracksMappingPitch  : BaseObject
	{
		Hashtable h = new Hashtable();

		public PlotOptionsTilemapSonificationTracksMappingPitch()
		{
			MapFunction = MapFunction_DefaultValue = PlotOptionsTilemapSonificationTracksMappingPitchMapFunction.Linear;
		...
		/// </summary>
		public PlotOptionsTilemapSonificationTracksMappingPitchMapFunction MapFunction { get; set; }
		private PlotOptionsTilemapSonificationTracksMappingPitchMapFunction MapFunction_DefaultValue { get; set; }
