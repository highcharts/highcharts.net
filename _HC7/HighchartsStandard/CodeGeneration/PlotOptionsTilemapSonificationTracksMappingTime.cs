...
{
	public partial class PlotOptionsTilemapSonificationTracksMappingTime  : BaseObject
	{
		Hashtable h = new Hashtable();

		public PlotOptionsTilemapSonificationTracksMappingTime()
		{
			MapFunction = MapFunction_DefaultValue = PlotOptionsTilemapSonificationTracksMappingTimeMapFunction.Linear;
			MapTo = MapTo_DefaultValue = "";
			Max = Max_DefaultValue = null;
			Min = Min_DefaultValue = null;
			Value = Value_DefaultValue = null;
			Within = Within_DefaultValue = PlotOptionsTilemapSonificationTracksMappingTimeWithin.Chart;
		...
		/// </summary>
		public PlotOptionsTilemapSonificationTracksMappingTimeMapFunction MapFunction { get; set; }
		private PlotOptionsTilemapSonificationTracksMappingTimeMapFunction MapFunction_DefaultValue { get; set; }
		...
		/// </summary>
		public PlotOptionsTilemapSonificationTracksMappingTimeWithin Within { get; set; }
		private PlotOptionsTilemapSonificationTracksMappingTimeWithin Within_DefaultValue { get; set; }
