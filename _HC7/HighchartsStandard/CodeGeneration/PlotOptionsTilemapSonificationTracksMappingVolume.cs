...
{
	public partial class PlotOptionsTilemapSonificationTracksMappingVolume  : BaseObject
	{
		Hashtable h = new Hashtable();

		public PlotOptionsTilemapSonificationTracksMappingVolume()
		{
			MapFunction = MapFunction_DefaultValue = PlotOptionsTilemapSonificationTracksMappingVolumeMapFunction.Linear;
			MapTo = MapTo_DefaultValue = "";
			Max = Max_DefaultValue = null;
			Min = Min_DefaultValue = null;
			Value = Value_DefaultValue = null;
			Within = Within_DefaultValue = PlotOptionsTilemapSonificationTracksMappingVolumeWithin.Chart;
		...
		/// </summary>
		public PlotOptionsTilemapSonificationTracksMappingVolumeMapFunction MapFunction { get; set; }
		private PlotOptionsTilemapSonificationTracksMappingVolumeMapFunction MapFunction_DefaultValue { get; set; }
		...
		/// </summary>
		public PlotOptionsTilemapSonificationTracksMappingVolumeWithin Within { get; set; }
		private PlotOptionsTilemapSonificationTracksMappingVolumeWithin Within_DefaultValue { get; set; }
