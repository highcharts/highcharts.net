...
{
	public partial class PlotOptionsTilemapSonificationTracksPointGrouping  : BaseObject
	{
		Hashtable h = new Hashtable();

		public PlotOptionsTilemapSonificationTracksPointGrouping()
		{
		...
		/// </summary>
		public PlotOptionsTilemapSonificationTracksPointGroupingAlgorithm Algorithm { get; set; }
		private PlotOptionsTilemapSonificationTracksPointGroupingAlgorithm Algorithm_DefaultValue { get; set; }
		...
		internal override Hashtable ToHashtable(Highcharts highcharts)
		{
			...
			if (Algorithm != PlotOptionsTilemapSonificationTracksPointGroupingAlgorithm.Null) h.Add("algorithm", highcharts.FirstCharacterToLower(Algorithm.ToString()));
