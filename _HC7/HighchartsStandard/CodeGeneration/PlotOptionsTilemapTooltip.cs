...
{
	public partial class PlotOptionsTilemapTooltip  : BaseObject
	{
		public PlotOptionsTilemapTooltip()
		{
			...
			HeaderShape = HeaderShape_DefaultValue = PlotOptionsTilemapTooltipHeaderShape.Callout;
		...
		/// </summary>
		public PlotOptionsTilemapTooltipHeaderShape HeaderShape { get; set; }
		private PlotOptionsTilemapTooltipHeaderShape HeaderShape_DefaultValue { get; set; }
		...
		internal override Hashtable ToHashtable()
		{
			...
			if (NullFormatter != NullFormatter_DefaultValue) { h.Add("nullFormatter",NullFormatter); Highcharts.AddFunction("PlotOptionsTilemapTooltipNullFormatter.nullFormatter", NullFormatter); }  
			if (Outside != Outside_DefaultValue) h.Add("outside",Outside);
			if (Padding != Padding_DefaultValue) h.Add("padding",Padding);
			if (PointFormat != PointFormat_DefaultValue) h.Add("pointFormat",PointFormat);
			if (PointFormatter != PointFormatter_DefaultValue) { h.Add("pointFormatter",PointFormatter); Highcharts.AddFunction("PlotOptionsTilemapTooltipPointFormatter.pointFormatter", PointFormatter); }  
