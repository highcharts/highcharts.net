...
{
	public partial class PlotOptionsTimelineDragDropDragHandle  : BaseObject
	{
		public PlotOptionsTimelineDragDropDragHandle()
		{
		...
		internal override Hashtable ToHashtable()
		{
			...
			if (PathFormatter != PathFormatter_DefaultValue) { h.Add("pathFormatter",PathFormatter); Highcharts.AddFunction("PlotOptionsTimelineDragDropDragHandlePathFormatter.pathFormatter", PathFormatter); }  
