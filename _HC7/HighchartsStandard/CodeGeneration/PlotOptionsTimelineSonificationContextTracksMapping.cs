...
{
	public partial class PlotOptionsTimelineSonificationContextTracksMapping  : BaseObject
	{
		Hashtable h = new Hashtable();

		public PlotOptionsTimelineSonificationContextTracksMapping()
		{
			Frequency = Frequency_DefaultValue = new PlotOptionsTimelineSonificationContextTracksMappingFrequency();
			GapBetweenNotes = GapBetweenNotes_DefaultValue = new PlotOptionsTimelineSonificationContextTracksMappingGapBetweenNotes();
			Highpass = Highpass_DefaultValue = new PlotOptionsTimelineSonificationContextTracksMappingHighpass();
			Lowpass = Lowpass_DefaultValue = new PlotOptionsTimelineSonificationContextTracksMappingLowpass();
			NoteDuration = NoteDuration_DefaultValue = new PlotOptionsTimelineSonificationContextTracksMappingNoteDuration();
			Pan = Pan_DefaultValue = new PlotOptionsTimelineSonificationContextTracksMappingPan();
			Pitch = Pitch_DefaultValue = new PlotOptionsTimelineSonificationContextTracksMappingPitch();
			PitchString = PitchString_DefaultValue = "null";
			PitchNumber = PitchNumber_DefaultValue = null;
			PlayDelay = PlayDelay_DefaultValue = new PlotOptionsTimelineSonificationContextTracksMappingPlayDelay();
			Time = Time_DefaultValue = new PlotOptionsTimelineSonificationContextTracksMappingTime();
			TimeString = TimeString_DefaultValue = "null";
			TimeNumber = TimeNumber_DefaultValue = null;
			Tremolo = Tremolo_DefaultValue = new PlotOptionsTimelineSonificationContextTracksMappingTremolo();
			Volume = Volume_DefaultValue = new PlotOptionsTimelineSonificationContextTracksMappingVolume();
		...
		/// </summary>
		public PlotOptionsTimelineSonificationContextTracksMappingFrequency Frequency { get; set; }
		private PlotOptionsTimelineSonificationContextTracksMappingFrequency Frequency_DefaultValue { get; set; }
		...
		/// </summary>
		public PlotOptionsTimelineSonificationContextTracksMappingGapBetweenNotes GapBetweenNotes { get; set; }
		private PlotOptionsTimelineSonificationContextTracksMappingGapBetweenNotes GapBetweenNotes_DefaultValue { get; set; }
		...
		/// </summary>
		public PlotOptionsTimelineSonificationContextTracksMappingHighpass Highpass { get; set; }
		private PlotOptionsTimelineSonificationContextTracksMappingHighpass Highpass_DefaultValue { get; set; }
		...
		/// </summary>
		public PlotOptionsTimelineSonificationContextTracksMappingLowpass Lowpass { get; set; }
		private PlotOptionsTimelineSonificationContextTracksMappingLowpass Lowpass_DefaultValue { get; set; }
		...
		/// </summary>
		public PlotOptionsTimelineSonificationContextTracksMappingNoteDuration NoteDuration { get; set; }
		private PlotOptionsTimelineSonificationContextTracksMappingNoteDuration NoteDuration_DefaultValue { get; set; }
		...
		/// </summary>
		public PlotOptionsTimelineSonificationContextTracksMappingPan Pan { get; set; }
		private PlotOptionsTimelineSonificationContextTracksMappingPan Pan_DefaultValue { get; set; }
		...
		/// </summary>
		public PlotOptionsTimelineSonificationContextTracksMappingPitch Pitch { get; set; }
		private PlotOptionsTimelineSonificationContextTracksMappingPitch Pitch_DefaultValue { get; set; }
		...
		/// </summary>
		public PlotOptionsTimelineSonificationContextTracksMappingPlayDelay PlayDelay { get; set; }
		private PlotOptionsTimelineSonificationContextTracksMappingPlayDelay PlayDelay_DefaultValue { get; set; }
		...
		/// </summary>
		public PlotOptionsTimelineSonificationContextTracksMappingTime Time { get; set; }
		private PlotOptionsTimelineSonificationContextTracksMappingTime Time_DefaultValue { get; set; }
		...
		/// </summary>
		public PlotOptionsTimelineSonificationContextTracksMappingTremolo Tremolo { get; set; }
		private PlotOptionsTimelineSonificationContextTracksMappingTremolo Tremolo_DefaultValue { get; set; }
		 

		/// <summary>
		/// The volume of notes, from 0 to 1.
		/// </summary>
		public PlotOptionsTimelineSonificationContextTracksMappingVolume Volume { get; set; }
		private PlotOptionsTimelineSonificationContextTracksMappingVolume Volume_DefaultValue { get; set; }
