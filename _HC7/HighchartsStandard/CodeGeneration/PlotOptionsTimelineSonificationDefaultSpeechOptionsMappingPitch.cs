...
{
	public partial class PlotOptionsTimelineSonificationDefaultSpeechOptionsMappingPitch  : BaseObject
	{
		Hashtable h = new Hashtable();

		public PlotOptionsTimelineSonificationDefaultSpeechOptionsMappingPitch()
		{
			MapFunction = MapFunction_DefaultValue = PlotOptionsTimelineSonificationDefaultSpeechOptionsMappingPitchMapFunction.Linear;
		...
		/// </summary>
		public PlotOptionsTimelineSonificationDefaultSpeechOptionsMappingPitchMapFunction MapFunction { get; set; }
		private PlotOptionsTimelineSonificationDefaultSpeechOptionsMappingPitchMapFunction MapFunction_DefaultValue { get; set; }
