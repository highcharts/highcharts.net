...
{
	public partial class PlotOptionsTimelineSonificationPointGrouping  : BaseObject
	{
		Hashtable h = new Hashtable();

		public PlotOptionsTimelineSonificationPointGrouping()
		{
		...
		/// </summary>
		public PlotOptionsTimelineSonificationPointGroupingAlgorithm Algorithm { get; set; }
		private PlotOptionsTimelineSonificationPointGroupingAlgorithm Algorithm_DefaultValue { get; set; }
		...
		internal override Hashtable ToHashtable(Highcharts highcharts)
		{
			...
			if (Algorithm != PlotOptionsTimelineSonificationPointGroupingAlgorithm.Null) h.Add("algorithm", highcharts.FirstCharacterToLower(Algorithm.ToString()));
