...
{
	public partial class PlotOptionsTimelineSonificationTracksMapping  : BaseObject
	{
		Hashtable h = new Hashtable();

		public PlotOptionsTimelineSonificationTracksMapping()
		{
			Frequency = Frequency_DefaultValue = new PlotOptionsTimelineSonificationTracksMappingFrequency();
			GapBetweenNotes = GapBetweenNotes_DefaultValue = new PlotOptionsTimelineSonificationTracksMappingGapBetweenNotes();
			Highpass = Highpass_DefaultValue = new PlotOptionsTimelineSonificationTracksMappingHighpass();
			Lowpass = Lowpass_DefaultValue = new PlotOptionsTimelineSonificationTracksMappingLowpass();
			NoteDuration = NoteDuration_DefaultValue = new PlotOptionsTimelineSonificationTracksMappingNoteDuration();
			Pan = Pan_DefaultValue = new PlotOptionsTimelineSonificationTracksMappingPan();
			Pitch = Pitch_DefaultValue = new PlotOptionsTimelineSonificationTracksMappingPitch();
			PitchString = PitchString_DefaultValue = "null";
			PitchNumber = PitchNumber_DefaultValue = null;
			PlayDelay = PlayDelay_DefaultValue = new PlotOptionsTimelineSonificationTracksMappingPlayDelay();
			Time = Time_DefaultValue = new PlotOptionsTimelineSonificationTracksMappingTime();
			TimeString = TimeString_DefaultValue = "null";
			TimeNumber = TimeNumber_DefaultValue = null;
			Tremolo = Tremolo_DefaultValue = new PlotOptionsTimelineSonificationTracksMappingTremolo();
			Volume = Volume_DefaultValue = new PlotOptionsTimelineSonificationTracksMappingVolume();
		...
		/// </summary>
		public PlotOptionsTimelineSonificationTracksMappingFrequency Frequency { get; set; }
		private PlotOptionsTimelineSonificationTracksMappingFrequency Frequency_DefaultValue { get; set; }
		...
		/// </summary>
		public PlotOptionsTimelineSonificationTracksMappingGapBetweenNotes GapBetweenNotes { get; set; }
		private PlotOptionsTimelineSonificationTracksMappingGapBetweenNotes GapBetweenNotes_DefaultValue { get; set; }
		...
		/// </summary>
		public PlotOptionsTimelineSonificationTracksMappingHighpass Highpass { get; set; }
		private PlotOptionsTimelineSonificationTracksMappingHighpass Highpass_DefaultValue { get; set; }
		...
		/// </summary>
		public PlotOptionsTimelineSonificationTracksMappingLowpass Lowpass { get; set; }
		private PlotOptionsTimelineSonificationTracksMappingLowpass Lowpass_DefaultValue { get; set; }
		...
		/// </summary>
		public PlotOptionsTimelineSonificationTracksMappingNoteDuration NoteDuration { get; set; }
		private PlotOptionsTimelineSonificationTracksMappingNoteDuration NoteDuration_DefaultValue { get; set; }
		...
		/// </summary>
		public PlotOptionsTimelineSonificationTracksMappingPan Pan { get; set; }
		private PlotOptionsTimelineSonificationTracksMappingPan Pan_DefaultValue { get; set; }
		...
		/// </summary>
		public PlotOptionsTimelineSonificationTracksMappingPitch Pitch { get; set; }
		private PlotOptionsTimelineSonificationTracksMappingPitch Pitch_DefaultValue { get; set; }
		...
		/// </summary>
		public PlotOptionsTimelineSonificationTracksMappingPlayDelay PlayDelay { get; set; }
		private PlotOptionsTimelineSonificationTracksMappingPlayDelay PlayDelay_DefaultValue { get; set; }
		...
		/// </summary>
		public PlotOptionsTimelineSonificationTracksMappingTime Time { get; set; }
		private PlotOptionsTimelineSonificationTracksMappingTime Time_DefaultValue { get; set; }
		...
		/// </summary>
		public PlotOptionsTimelineSonificationTracksMappingTremolo Tremolo { get; set; }
		private PlotOptionsTimelineSonificationTracksMappingTremolo Tremolo_DefaultValue { get; set; }
		 

		/// <summary>
		/// The volume of notes, from 0 to 1.
		/// </summary>
		public PlotOptionsTimelineSonificationTracksMappingVolume Volume { get; set; }
		private PlotOptionsTimelineSonificationTracksMappingVolume Volume_DefaultValue { get; set; }
