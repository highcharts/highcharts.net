...
{
	public partial class PlotOptionsTimelineSonificationTracksMappingPan  : BaseObject
	{
		Hashtable h = new Hashtable();

		public PlotOptionsTimelineSonificationTracksMappingPan()
		{
			MapFunction = MapFunction_DefaultValue = PlotOptionsTimelineSonificationTracksMappingPanMapFunction.Linear;
			MapTo = MapTo_DefaultValue = "";
			Max = Max_DefaultValue = null;
			Min = Min_DefaultValue = null;
			Value = Value_DefaultValue = null;
			Within = Within_DefaultValue = PlotOptionsTimelineSonificationTracksMappingPanWithin.Chart;
		...
		/// </summary>
		public PlotOptionsTimelineSonificationTracksMappingPanMapFunction MapFunction { get; set; }
		private PlotOptionsTimelineSonificationTracksMappingPanMapFunction MapFunction_DefaultValue { get; set; }
		...
		/// </summary>
		public PlotOptionsTimelineSonificationTracksMappingPanWithin Within { get; set; }
		private PlotOptionsTimelineSonificationTracksMappingPanWithin Within_DefaultValue { get; set; }
