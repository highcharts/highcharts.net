...
{
	public partial class PlotOptionsTimelineSonificationTracksMappingPitch  : BaseObject
	{
		Hashtable h = new Hashtable();

		public PlotOptionsTimelineSonificationTracksMappingPitch()
		{
			MapFunction = MapFunction_DefaultValue = PlotOptionsTimelineSonificationTracksMappingPitchMapFunction.Linear;
		...
		/// </summary>
		public PlotOptionsTimelineSonificationTracksMappingPitchMapFunction MapFunction { get; set; }
		private PlotOptionsTimelineSonificationTracksMappingPitchMapFunction MapFunction_DefaultValue { get; set; }
