...
{
	public partial class PlotOptionsTimelineSonificationTracksMappingTime  : BaseObject
	{
		Hashtable h = new Hashtable();

		public PlotOptionsTimelineSonificationTracksMappingTime()
		{
			MapFunction = MapFunction_DefaultValue = PlotOptionsTimelineSonificationTracksMappingTimeMapFunction.Linear;
			MapTo = MapTo_DefaultValue = "";
			Max = Max_DefaultValue = null;
			Min = Min_DefaultValue = null;
			Value = Value_DefaultValue = null;
			Within = Within_DefaultValue = PlotOptionsTimelineSonificationTracksMappingTimeWithin.Chart;
		...
		/// </summary>
		public PlotOptionsTimelineSonificationTracksMappingTimeMapFunction MapFunction { get; set; }
		private PlotOptionsTimelineSonificationTracksMappingTimeMapFunction MapFunction_DefaultValue { get; set; }
		...
		/// </summary>
		public PlotOptionsTimelineSonificationTracksMappingTimeWithin Within { get; set; }
		private PlotOptionsTimelineSonificationTracksMappingTimeWithin Within_DefaultValue { get; set; }
