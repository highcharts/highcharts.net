...
{
	public partial class PlotOptionsTimelineSonificationTracksMappingVolume  : BaseObject
	{
		Hashtable h = new Hashtable();

		public PlotOptionsTimelineSonificationTracksMappingVolume()
		{
			MapFunction = MapFunction_DefaultValue = PlotOptionsTimelineSonificationTracksMappingVolumeMapFunction.Linear;
			MapTo = MapTo_DefaultValue = "";
			Max = Max_DefaultValue = null;
			Min = Min_DefaultValue = null;
			Value = Value_DefaultValue = null;
			Within = Within_DefaultValue = PlotOptionsTimelineSonificationTracksMappingVolumeWithin.Chart;
		...
		/// </summary>
		public PlotOptionsTimelineSonificationTracksMappingVolumeMapFunction MapFunction { get; set; }
		private PlotOptionsTimelineSonificationTracksMappingVolumeMapFunction MapFunction_DefaultValue { get; set; }
		...
		/// </summary>
		public PlotOptionsTimelineSonificationTracksMappingVolumeWithin Within { get; set; }
		private PlotOptionsTimelineSonificationTracksMappingVolumeWithin Within_DefaultValue { get; set; }
