...
{
	public partial class PlotOptionsTimelineSonificationTracksPointGrouping  : BaseObject
	{
		Hashtable h = new Hashtable();

		public PlotOptionsTimelineSonificationTracksPointGrouping()
		{
		...
		/// </summary>
		public PlotOptionsTimelineSonificationTracksPointGroupingAlgorithm Algorithm { get; set; }
		private PlotOptionsTimelineSonificationTracksPointGroupingAlgorithm Algorithm_DefaultValue { get; set; }
		...
		internal override Hashtable ToHashtable(Highcharts highcharts)
		{
			...
			if (Algorithm != PlotOptionsTimelineSonificationTracksPointGroupingAlgorithm.Null) h.Add("algorithm", highcharts.FirstCharacterToLower(Algorithm.ToString()));
