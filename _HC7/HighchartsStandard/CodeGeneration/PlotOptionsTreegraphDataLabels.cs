...
namespace Highsoft.Web.Mvc.Charts
{
	public partial class PlotOptionsTreegraphDataLabels  : BaseObject
	{
		...
		{
			Align = Align_DefaultValue = PlotOptionsTreegraphDataLabelsAlign.Center;
			...
			Overflow = Overflow_DefaultValue = PlotOptionsTreegraphDataLabelsOverflow.Justify;
			Padding = Padding_DefaultValue = 5;
			Position = Position_DefaultValue = PlotOptionsTreegraphDataLabelsPosition.Center;
			...
			TextPath = TextPath_DefaultValue = new PlotOptionsTreegraphDataLabelsTextPath();
			UseHTML = UseHTML_DefaultValue = false;
			VerticalAlign = VerticalAlign_DefaultValue = PlotOptionsTreegraphDataLabelsVerticalAlign.Bottom;
			X = X_DefaultValue = 0;
			Y = Y_DefaultValue = 0;
