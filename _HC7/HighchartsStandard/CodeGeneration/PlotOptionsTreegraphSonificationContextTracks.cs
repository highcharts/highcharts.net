...
{
	public partial class PlotOptionsTreegraphSonificationContextTracks  : BaseObject
	{
		Hashtable h = new Hashtable();

		public PlotOptionsTreegraphSonificationContextTracks()
		{
			ActiveWhen = ActiveWhen_DefaultValue = new PlotOptionsTreegraphSonificationContextTracksActiveWhen();
			Instrument = Instrument_DefaultValue = null;
			InstrumentString = InstrumentString_DefaultValue = "null";
			Mapping = Mapping_DefaultValue = new PlotOptionsTreegraphSonificationContextTracksMapping();
			MidiName = MidiName_DefaultValue = "";
			PointGrouping = PointGrouping_DefaultValue = new PlotOptionsTreegraphSonificationContextTracksPointGrouping();
			...
			Type = Type_DefaultValue = PlotOptionsTreegraphSonificationContextTracksType.Instrument;
			ValueInterval = ValueInterval_DefaultValue = null;
			ValueMapFunction = ValueMapFunction_DefaultValue = PlotOptionsTreegraphSonificationContextTracksValueMapFunction.Linear;
		...
		/// </summary>
		public PlotOptionsTreegraphSonificationContextTracksActiveWhen ActiveWhen { get; set; }
		private PlotOptionsTreegraphSonificationContextTracksActiveWhen ActiveWhen_DefaultValue { get; set; }
		...
		/// </summary>
		public PlotOptionsTreegraphSonificationContextTracksMapping Mapping { get; set; }
		private PlotOptionsTreegraphSonificationContextTracksMapping Mapping_DefaultValue { get; set; }
		...
		/// </summary>
		public PlotOptionsTreegraphSonificationContextTracksPointGrouping PointGrouping { get; set; }
		private PlotOptionsTreegraphSonificationContextTracksPointGrouping PointGrouping_DefaultValue { get; set; }
		...
		/// </summary>
		public PlotOptionsTreegraphSonificationContextTracksType Type { get; set; }
		private PlotOptionsTreegraphSonificationContextTracksType Type_DefaultValue { get; set; }
		...
		/// </summary>
		public PlotOptionsTreegraphSonificationContextTracksValueMapFunction ValueMapFunction { get; set; }
		private PlotOptionsTreegraphSonificationContextTracksValueMapFunction ValueMapFunction_DefaultValue { get; set; }
