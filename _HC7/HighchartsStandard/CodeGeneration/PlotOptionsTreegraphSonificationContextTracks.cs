...
namespace Highsoft.Web.Mvc.Charts
{
	public partial class PlotOptionsTreegraphSonificationContextTracks  : BaseObject
	{
		...
		internal override Hashtable ToHashtable(Highcharts highcharts)
		{
			...
			if (Type != PlotOptionsTreegraphSonificationContextTracksType.Null) h.Add("type", highcharts.FirstCharacterToLower(Type.ToString()));
			if (ValueInterval != null) h.Add("valueInterval",ValueInterval);
			if (ValueMapFunction != PlotOptionsTreegraphSonificationContextTracksValueMapFunction.Null) h.Add("valueMapFunction", highcharts.FirstCharacterToLower(ValueMapFunction.ToString()));
