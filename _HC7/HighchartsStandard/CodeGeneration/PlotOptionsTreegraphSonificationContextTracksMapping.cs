...
{
	public partial class PlotOptionsTreegraphSonificationContextTracksMapping  : BaseObject
	{
		Hashtable h = new Hashtable();

		public PlotOptionsTreegraphSonificationContextTracksMapping()
		{
			Frequency = Frequency_DefaultValue = new PlotOptionsTreegraphSonificationContextTracksMappingFrequency();
			GapBetweenNotes = GapBetweenNotes_DefaultValue = new PlotOptionsTreegraphSonificationContextTracksMappingGapBetweenNotes();
			Highpass = Highpass_DefaultValue = new PlotOptionsTreegraphSonificationContextTracksMappingHighpass();
			Lowpass = Lowpass_DefaultValue = new PlotOptionsTreegraphSonificationContextTracksMappingLowpass();
			NoteDuration = NoteDuration_DefaultValue = new PlotOptionsTreegraphSonificationContextTracksMappingNoteDuration();
			Pan = Pan_DefaultValue = new PlotOptionsTreegraphSonificationContextTracksMappingPan();
			Pitch = Pitch_DefaultValue = new PlotOptionsTreegraphSonificationContextTracksMappingPitch();
			PitchString = PitchString_DefaultValue = "null";
			PitchNumber = PitchNumber_DefaultValue = null;
			PlayDelay = PlayDelay_DefaultValue = new PlotOptionsTreegraphSonificationContextTracksMappingPlayDelay();
			Time = Time_DefaultValue = new PlotOptionsTreegraphSonificationContextTracksMappingTime();
			TimeString = TimeString_DefaultValue = "null";
			TimeNumber = TimeNumber_DefaultValue = null;
			Tremolo = Tremolo_DefaultValue = new PlotOptionsTreegraphSonificationContextTracksMappingTremolo();
			Volume = Volume_DefaultValue = new PlotOptionsTreegraphSonificationContextTracksMappingVolume();
		...
		/// </summary>
		public PlotOptionsTreegraphSonificationContextTracksMappingFrequency Frequency { get; set; }
		private PlotOptionsTreegraphSonificationContextTracksMappingFrequency Frequency_DefaultValue { get; set; }
		...
		/// </summary>
		public PlotOptionsTreegraphSonificationContextTracksMappingGapBetweenNotes GapBetweenNotes { get; set; }
		private PlotOptionsTreegraphSonificationContextTracksMappingGapBetweenNotes GapBetweenNotes_DefaultValue { get; set; }
		...
		/// </summary>
		public PlotOptionsTreegraphSonificationContextTracksMappingHighpass Highpass { get; set; }
		private PlotOptionsTreegraphSonificationContextTracksMappingHighpass Highpass_DefaultValue { get; set; }
		...
		/// </summary>
		public PlotOptionsTreegraphSonificationContextTracksMappingLowpass Lowpass { get; set; }
		private PlotOptionsTreegraphSonificationContextTracksMappingLowpass Lowpass_DefaultValue { get; set; }
		...
		/// </summary>
		public PlotOptionsTreegraphSonificationContextTracksMappingNoteDuration NoteDuration { get; set; }
		private PlotOptionsTreegraphSonificationContextTracksMappingNoteDuration NoteDuration_DefaultValue { get; set; }
		...
		/// </summary>
		public PlotOptionsTreegraphSonificationContextTracksMappingPan Pan { get; set; }
		private PlotOptionsTreegraphSonificationContextTracksMappingPan Pan_DefaultValue { get; set; }
		...
		/// </summary>
		public PlotOptionsTreegraphSonificationContextTracksMappingPitch Pitch { get; set; }
		private PlotOptionsTreegraphSonificationContextTracksMappingPitch Pitch_DefaultValue { get; set; }
		...
		/// </summary>
		public PlotOptionsTreegraphSonificationContextTracksMappingPlayDelay PlayDelay { get; set; }
		private PlotOptionsTreegraphSonificationContextTracksMappingPlayDelay PlayDelay_DefaultValue { get; set; }
		...
		/// </summary>
		public PlotOptionsTreegraphSonificationContextTracksMappingTime Time { get; set; }
		private PlotOptionsTreegraphSonificationContextTracksMappingTime Time_DefaultValue { get; set; }
		...
		/// </summary>
		public PlotOptionsTreegraphSonificationContextTracksMappingTremolo Tremolo { get; set; }
		private PlotOptionsTreegraphSonificationContextTracksMappingTremolo Tremolo_DefaultValue { get; set; }
		 

		/// <summary>
		/// The volume of notes, from 0 to 1.
		/// </summary>
		public PlotOptionsTreegraphSonificationContextTracksMappingVolume Volume { get; set; }
		private PlotOptionsTreegraphSonificationContextTracksMappingVolume Volume_DefaultValue { get; set; }
