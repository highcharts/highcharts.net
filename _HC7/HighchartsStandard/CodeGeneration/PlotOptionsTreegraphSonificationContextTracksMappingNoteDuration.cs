...
{
	public partial class PlotOptionsTreegraphSonificationContextTracksMappingNoteDuration  : BaseObject
	{
		Hashtable h = new Hashtable();

		public PlotOptionsTreegraphSonificationContextTracksMappingNoteDuration()
		{
			MapFunction = MapFunction_DefaultValue = PlotOptionsTreegraphSonificationContextTracksMappingNoteDurationMapFunction.Linear;
			MapTo = MapTo_DefaultValue = "";
			Max = Max_DefaultValue = null;
			Min = Min_DefaultValue = null;
			Value = Value_DefaultValue = null;
			Within = Within_DefaultValue = PlotOptionsTreegraphSonificationContextTracksMappingNoteDurationWithin.Chart;
		...
		/// </summary>
		public PlotOptionsTreegraphSonificationContextTracksMappingNoteDurationMapFunction MapFunction { get; set; }
		private PlotOptionsTreegraphSonificationContextTracksMappingNoteDurationMapFunction MapFunction_DefaultValue { get; set; }
		...
		/// </summary>
		public PlotOptionsTreegraphSonificationContextTracksMappingNoteDurationWithin Within { get; set; }
		private PlotOptionsTreegraphSonificationContextTracksMappingNoteDurationWithin Within_DefaultValue { get; set; }
