...
{
	public partial class PlotOptionsTreegraphSonificationContextTracksMappingPlayDelay  : BaseObject
	{
		Hashtable h = new Hashtable();

		public PlotOptionsTreegraphSonificationContextTracksMappingPlayDelay()
		{
			MapFunction = MapFunction_DefaultValue = PlotOptionsTreegraphSonificationContextTracksMappingPlayDelayMapFunction.Linear;
			MapTo = MapTo_DefaultValue = "";
			Max = Max_DefaultValue = null;
			Min = Min_DefaultValue = null;
			Value = Value_DefaultValue = null;
			Within = Within_DefaultValue = PlotOptionsTreegraphSonificationContextTracksMappingPlayDelayWithin.Chart;
		...
		/// </summary>
		public PlotOptionsTreegraphSonificationContextTracksMappingPlayDelayMapFunction MapFunction { get; set; }
		private PlotOptionsTreegraphSonificationContextTracksMappingPlayDelayMapFunction MapFunction_DefaultValue { get; set; }
		...
		/// </summary>
		public PlotOptionsTreegraphSonificationContextTracksMappingPlayDelayWithin Within { get; set; }
		private PlotOptionsTreegraphSonificationContextTracksMappingPlayDelayWithin Within_DefaultValue { get; set; }
