...
{
	public partial class PlotOptionsTreegraphSonificationContextTracksMappingTremoloDepth  : BaseObject
	{
		Hashtable h = new Hashtable();

		public PlotOptionsTreegraphSonificationContextTracksMappingTremoloDepth()
		{
			MapFunction = MapFunction_DefaultValue = PlotOptionsTreegraphSonificationContextTracksMappingTremoloDepthMapFunction.Linear;
			MapTo = MapTo_DefaultValue = "";
			Max = Max_DefaultValue = null;
			Min = Min_DefaultValue = null;
			Value = Value_DefaultValue = null;
			Within = Within_DefaultValue = PlotOptionsTreegraphSonificationContextTracksMappingTremoloDepthWithin.Chart;
		...
		/// </summary>
		public PlotOptionsTreegraphSonificationContextTracksMappingTremoloDepthMapFunction MapFunction { get; set; }
		private PlotOptionsTreegraphSonificationContextTracksMappingTremoloDepthMapFunction MapFunction_DefaultValue { get; set; }
		...
		/// </summary>
		public PlotOptionsTreegraphSonificationContextTracksMappingTremoloDepthWithin Within { get; set; }
		private PlotOptionsTreegraphSonificationContextTracksMappingTremoloDepthWithin Within_DefaultValue { get; set; }
