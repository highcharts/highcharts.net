...
{
	public partial class PlotOptionsTreegraphSonificationDefaultSpeechOptionsMappingPan  : BaseObject
	{
		Hashtable h = new Hashtable();

		public PlotOptionsTreegraphSonificationDefaultSpeechOptionsMappingPan()
		{
			MapFunction = MapFunction_DefaultValue = PlotOptionsTreegraphSonificationDefaultSpeechOptionsMappingPanMapFunction.Linear;
			MapTo = MapTo_DefaultValue = "";
			Max = Max_DefaultValue = null;
			Min = Min_DefaultValue = null;
			Value = Value_DefaultValue = null;
			Within = Within_DefaultValue = PlotOptionsTreegraphSonificationDefaultSpeechOptionsMappingPanWithin.Chart;
		...
		/// </summary>
		public PlotOptionsTreegraphSonificationDefaultSpeechOptionsMappingPanMapFunction MapFunction { get; set; }
		private PlotOptionsTreegraphSonificationDefaultSpeechOptionsMappingPanMapFunction MapFunction_DefaultValue { get; set; }
		...
		/// </summary>
		public PlotOptionsTreegraphSonificationDefaultSpeechOptionsMappingPanWithin Within { get; set; }
		private PlotOptionsTreegraphSonificationDefaultSpeechOptionsMappingPanWithin Within_DefaultValue { get; set; }
