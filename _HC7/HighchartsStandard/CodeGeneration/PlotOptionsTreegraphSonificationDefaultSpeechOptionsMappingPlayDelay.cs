...
{
	public partial class PlotOptionsTreegraphSonificationDefaultSpeechOptionsMappingPlayDelay  : BaseObject
	{
		Hashtable h = new Hashtable();

		public PlotOptionsTreegraphSonificationDefaultSpeechOptionsMappingPlayDelay()
		{
			MapFunction = MapFunction_DefaultValue = PlotOptionsTreegraphSonificationDefaultSpeechOptionsMappingPlayDelayMapFunction.Linear;
			MapTo = MapTo_DefaultValue = "";
			Max = Max_DefaultValue = null;
			Min = Min_DefaultValue = null;
			Value = Value_DefaultValue = null;
			Within = Within_DefaultValue = PlotOptionsTreegraphSonificationDefaultSpeechOptionsMappingPlayDelayWithin.Chart;
		...
		/// </summary>
		public PlotOptionsTreegraphSonificationDefaultSpeechOptionsMappingPlayDelayMapFunction MapFunction { get; set; }
		private PlotOptionsTreegraphSonificationDefaultSpeechOptionsMappingPlayDelayMapFunction MapFunction_DefaultValue { get; set; }
		...
		/// </summary>
		public PlotOptionsTreegraphSonificationDefaultSpeechOptionsMappingPlayDelayWithin Within { get; set; }
		private PlotOptionsTreegraphSonificationDefaultSpeechOptionsMappingPlayDelayWithin Within_DefaultValue { get; set; }
