...
{
	public partial class PlotOptionsTreegraphSonificationPointGrouping  : BaseObject
	{
		Hashtable h = new Hashtable();

		public PlotOptionsTreegraphSonificationPointGrouping()
		{
		...
		/// </summary>
		public PlotOptionsTreegraphSonificationPointGroupingAlgorithm Algorithm { get; set; }
		private PlotOptionsTreegraphSonificationPointGroupingAlgorithm Algorithm_DefaultValue { get; set; }
		...
		internal override Hashtable ToHashtable(Highcharts highcharts)
		{
			...
			if (Algorithm != PlotOptionsTreegraphSonificationPointGroupingAlgorithm.Null) h.Add("algorithm", highcharts.FirstCharacterToLower(Algorithm.ToString()));
