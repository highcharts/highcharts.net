...
{
	public partial class PlotOptionsTreegraphSonificationTracksMapping  : BaseObject
	{
		Hashtable h = new Hashtable();

		public PlotOptionsTreegraphSonificationTracksMapping()
		{
			Frequency = Frequency_DefaultValue = new PlotOptionsTreegraphSonificationTracksMappingFrequency();
			GapBetweenNotes = GapBetweenNotes_DefaultValue = new PlotOptionsTreegraphSonificationTracksMappingGapBetweenNotes();
			Highpass = Highpass_DefaultValue = new PlotOptionsTreegraphSonificationTracksMappingHighpass();
			Lowpass = Lowpass_DefaultValue = new PlotOptionsTreegraphSonificationTracksMappingLowpass();
			NoteDuration = NoteDuration_DefaultValue = new PlotOptionsTreegraphSonificationTracksMappingNoteDuration();
			Pan = Pan_DefaultValue = new PlotOptionsTreegraphSonificationTracksMappingPan();
			Pitch = Pitch_DefaultValue = new PlotOptionsTreegraphSonificationTracksMappingPitch();
			PitchString = PitchString_DefaultValue = "null";
			PitchNumber = PitchNumber_DefaultValue = null;
			PlayDelay = PlayDelay_DefaultValue = new PlotOptionsTreegraphSonificationTracksMappingPlayDelay();
			Time = Time_DefaultValue = new PlotOptionsTreegraphSonificationTracksMappingTime();
			TimeString = TimeString_DefaultValue = "null";
			TimeNumber = TimeNumber_DefaultValue = null;
			Tremolo = Tremolo_DefaultValue = new PlotOptionsTreegraphSonificationTracksMappingTremolo();
			Volume = Volume_DefaultValue = new PlotOptionsTreegraphSonificationTracksMappingVolume();
		...
		/// </summary>
		public PlotOptionsTreegraphSonificationTracksMappingFrequency Frequency { get; set; }
		private PlotOptionsTreegraphSonificationTracksMappingFrequency Frequency_DefaultValue { get; set; }
		...
		/// </summary>
		public PlotOptionsTreegraphSonificationTracksMappingGapBetweenNotes GapBetweenNotes { get; set; }
		private PlotOptionsTreegraphSonificationTracksMappingGapBetweenNotes GapBetweenNotes_DefaultValue { get; set; }
		...
		/// </summary>
		public PlotOptionsTreegraphSonificationTracksMappingHighpass Highpass { get; set; }
		private PlotOptionsTreegraphSonificationTracksMappingHighpass Highpass_DefaultValue { get; set; }
		...
		/// </summary>
		public PlotOptionsTreegraphSonificationTracksMappingLowpass Lowpass { get; set; }
		private PlotOptionsTreegraphSonificationTracksMappingLowpass Lowpass_DefaultValue { get; set; }
		...
		/// </summary>
		public PlotOptionsTreegraphSonificationTracksMappingNoteDuration NoteDuration { get; set; }
		private PlotOptionsTreegraphSonificationTracksMappingNoteDuration NoteDuration_DefaultValue { get; set; }
		...
		/// </summary>
		public PlotOptionsTreegraphSonificationTracksMappingPan Pan { get; set; }
		private PlotOptionsTreegraphSonificationTracksMappingPan Pan_DefaultValue { get; set; }
		...
		/// </summary>
		public PlotOptionsTreegraphSonificationTracksMappingPitch Pitch { get; set; }
		private PlotOptionsTreegraphSonificationTracksMappingPitch Pitch_DefaultValue { get; set; }
		...
		/// </summary>
		public PlotOptionsTreegraphSonificationTracksMappingPlayDelay PlayDelay { get; set; }
		private PlotOptionsTreegraphSonificationTracksMappingPlayDelay PlayDelay_DefaultValue { get; set; }
		...
		/// </summary>
		public PlotOptionsTreegraphSonificationTracksMappingTime Time { get; set; }
		private PlotOptionsTreegraphSonificationTracksMappingTime Time_DefaultValue { get; set; }
		...
		/// </summary>
		public PlotOptionsTreegraphSonificationTracksMappingTremolo Tremolo { get; set; }
		private PlotOptionsTreegraphSonificationTracksMappingTremolo Tremolo_DefaultValue { get; set; }
		 

		/// <summary>
		/// The volume of notes, from 0 to 1.
		/// </summary>
		public PlotOptionsTreegraphSonificationTracksMappingVolume Volume { get; set; }
		private PlotOptionsTreegraphSonificationTracksMappingVolume Volume_DefaultValue { get; set; }
