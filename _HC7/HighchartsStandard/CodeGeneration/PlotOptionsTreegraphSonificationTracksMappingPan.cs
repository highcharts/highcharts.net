...
{
	public partial class PlotOptionsTreegraphSonificationTracksMappingPan  : BaseObject
	{
		Hashtable h = new Hashtable();

		public PlotOptionsTreegraphSonificationTracksMappingPan()
		{
			MapFunction = MapFunction_DefaultValue = PlotOptionsTreegraphSonificationTracksMappingPanMapFunction.Linear;
			MapTo = MapTo_DefaultValue = "";
			Max = Max_DefaultValue = null;
			Min = Min_DefaultValue = null;
			Value = Value_DefaultValue = null;
			Within = Within_DefaultValue = PlotOptionsTreegraphSonificationTracksMappingPanWithin.Chart;
		...
		/// </summary>
		public PlotOptionsTreegraphSonificationTracksMappingPanMapFunction MapFunction { get; set; }
		private PlotOptionsTreegraphSonificationTracksMappingPanMapFunction MapFunction_DefaultValue { get; set; }
		...
		/// </summary>
		public PlotOptionsTreegraphSonificationTracksMappingPanWithin Within { get; set; }
		private PlotOptionsTreegraphSonificationTracksMappingPanWithin Within_DefaultValue { get; set; }
