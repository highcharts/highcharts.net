...
{
	public partial class PlotOptionsTreegraphSonificationTracksMappingPitch  : BaseObject
	{
		Hashtable h = new Hashtable();

		public PlotOptionsTreegraphSonificationTracksMappingPitch()
		{
			MapFunction = MapFunction_DefaultValue = PlotOptionsTreegraphSonificationTracksMappingPitchMapFunction.Linear;
		...
		/// </summary>
		public PlotOptionsTreegraphSonificationTracksMappingPitchMapFunction MapFunction { get; set; }
		private PlotOptionsTreegraphSonificationTracksMappingPitchMapFunction MapFunction_DefaultValue { get; set; }
