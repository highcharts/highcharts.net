...
{
	public partial class PlotOptionsTreegraphSonificationTracksMappingTime  : BaseObject
	{
		Hashtable h = new Hashtable();

		public PlotOptionsTreegraphSonificationTracksMappingTime()
		{
			MapFunction = MapFunction_DefaultValue = PlotOptionsTreegraphSonificationTracksMappingTimeMapFunction.Linear;
			MapTo = MapTo_DefaultValue = "";
			Max = Max_DefaultValue = null;
			Min = Min_DefaultValue = null;
			Value = Value_DefaultValue = null;
			Within = Within_DefaultValue = PlotOptionsTreegraphSonificationTracksMappingTimeWithin.Chart;
		...
		/// </summary>
		public PlotOptionsTreegraphSonificationTracksMappingTimeMapFunction MapFunction { get; set; }
		private PlotOptionsTreegraphSonificationTracksMappingTimeMapFunction MapFunction_DefaultValue { get; set; }
		...
		/// </summary>
		public PlotOptionsTreegraphSonificationTracksMappingTimeWithin Within { get; set; }
		private PlotOptionsTreegraphSonificationTracksMappingTimeWithin Within_DefaultValue { get; set; }
