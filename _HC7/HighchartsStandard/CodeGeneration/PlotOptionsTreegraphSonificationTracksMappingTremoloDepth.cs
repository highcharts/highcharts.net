...
{
	public partial class PlotOptionsTreegraphSonificationTracksMappingTremoloDepth  : BaseObject
	{
		Hashtable h = new Hashtable();

		public PlotOptionsTreegraphSonificationTracksMappingTremoloDepth()
		{
			MapFunction = MapFunction_DefaultValue = PlotOptionsTreegraphSonificationTracksMappingTremoloDepthMapFunction.Linear;
			MapTo = MapTo_DefaultValue = "";
			Max = Max_DefaultValue = null;
			Min = Min_DefaultValue = null;
			Value = Value_DefaultValue = null;
			Within = Within_DefaultValue = PlotOptionsTreegraphSonificationTracksMappingTremoloDepthWithin.Chart;
		...
		/// </summary>
		public PlotOptionsTreegraphSonificationTracksMappingTremoloDepthMapFunction MapFunction { get; set; }
		private PlotOptionsTreegraphSonificationTracksMappingTremoloDepthMapFunction MapFunction_DefaultValue { get; set; }
		...
		/// </summary>
		public PlotOptionsTreegraphSonificationTracksMappingTremoloDepthWithin Within { get; set; }
		private PlotOptionsTreegraphSonificationTracksMappingTremoloDepthWithin Within_DefaultValue { get; set; }
