...
{
	public partial class PlotOptionsTreegraphSonificationTracksMappingVolume  : BaseObject
	{
		Hashtable h = new Hashtable();

		public PlotOptionsTreegraphSonificationTracksMappingVolume()
		{
			MapFunction = MapFunction_DefaultValue = PlotOptionsTreegraphSonificationTracksMappingVolumeMapFunction.Linear;
			MapTo = MapTo_DefaultValue = "";
			Max = Max_DefaultValue = null;
			Min = Min_DefaultValue = null;
			Value = Value_DefaultValue = null;
			Within = Within_DefaultValue = PlotOptionsTreegraphSonificationTracksMappingVolumeWithin.Chart;
		...
		/// </summary>
		public PlotOptionsTreegraphSonificationTracksMappingVolumeMapFunction MapFunction { get; set; }
		private PlotOptionsTreegraphSonificationTracksMappingVolumeMapFunction MapFunction_DefaultValue { get; set; }
		...
		/// </summary>
		public PlotOptionsTreegraphSonificationTracksMappingVolumeWithin Within { get; set; }
		private PlotOptionsTreegraphSonificationTracksMappingVolumeWithin Within_DefaultValue { get; set; }
