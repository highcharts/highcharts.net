...
{
	public partial class PlotOptionsTreegraphSonificationTracksPointGrouping  : BaseObject
	{
		Hashtable h = new Hashtable();

		public PlotOptionsTreegraphSonificationTracksPointGrouping()
		{
		...
		/// </summary>
		public PlotOptionsTreegraphSonificationTracksPointGroupingAlgorithm Algorithm { get; set; }
		private PlotOptionsTreegraphSonificationTracksPointGroupingAlgorithm Algorithm_DefaultValue { get; set; }
		...
		internal override Hashtable ToHashtable(Highcharts highcharts)
		{
			...
			if (Algorithm != PlotOptionsTreegraphSonificationTracksPointGroupingAlgorithm.Null) h.Add("algorithm", highcharts.FirstCharacterToLower(Algorithm.ToString()));
