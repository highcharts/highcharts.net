...
{
	public partial class PlotOptionsTreegraphStatesHover  : BaseObject
	{
		Hashtable h = new Hashtable();

		public PlotOptionsTreegraphStatesHover()
		{
			Animation = Animation_DefaultValue = new Animation();
			AnimationBool = AnimationBool_DefaultValue = null;
			Enabled = Enabled_DefaultValue = true;
			Halo = Halo_DefaultValue = new PlotOptionsTreegraphStatesHoverHalo();
			LineWidth = LineWidth_DefaultValue = null;
			LineWidthPlus = LineWidthPlus_DefaultValue = 1;
			Marker = Marker_DefaultValue = new PlotOptionsTreegraphStatesHoverMarker();
		...
		/// </summary>
		public PlotOptionsTreegraphStatesHoverHalo Halo { get; set; }
		private PlotOptionsTreegraphStatesHoverHalo Halo_DefaultValue { get; set; }
		...
		/// </summary>
		public PlotOptionsTreegraphStatesHoverMarker Marker { get; set; }
		private PlotOptionsTreegraphStatesHoverMarker Marker_DefaultValue { get; set; }
