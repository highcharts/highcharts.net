...
{
	public partial class PlotOptionsTreegraphStatesSelect  : BaseObject
	{
		Hashtable h = new Hashtable();

		public PlotOptionsTreegraphStatesSelect()
		{
			Animation = Animation_DefaultValue = new Animation();
			AnimationBool = AnimationBool_DefaultValue = null;
			Enabled = Enabled_DefaultValue = true;
			Halo = Halo_DefaultValue = new PlotOptionsTreegraphStatesSelectHalo();
			LineWidth = LineWidth_DefaultValue = null;
			LineWidthPlus = LineWidthPlus_DefaultValue = 1;
			Marker = Marker_DefaultValue = new PlotOptionsTreegraphStatesSelectMarker();
		...
		/// </summary>
		public PlotOptionsTreegraphStatesSelectHalo Halo { get; set; }
		private PlotOptionsTreegraphStatesSelectHalo Halo_DefaultValue { get; set; }
		...
		/// </summary>
		public PlotOptionsTreegraphStatesSelectMarker Marker { get; set; }
		private PlotOptionsTreegraphStatesSelectMarker Marker_DefaultValue { get; set; }
