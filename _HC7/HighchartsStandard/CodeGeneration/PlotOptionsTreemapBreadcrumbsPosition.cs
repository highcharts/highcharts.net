...
namespace Highsoft.Web.Mvc.Charts
{
	public partial class PlotOptionsTreemapBreadcrumbsPosition  : BaseObject
	{
		...
		{
			if (Align != PlotOptionsTreemapBreadcrumbsPositionAlign.Null) h.Add("align", highcharts.FirstCharacterToLower(Align.ToString()));
			if (VerticalAlign != PlotOptionsTreemapBreadcrumbsPositionVerticalAlign.Null) h.Add("verticalAlign", highcharts.FirstCharacterToLower(VerticalAlign.ToString()));
			if (X != null) h.Add("x",X);
			if (Y != null) h.Add("y",Y);
