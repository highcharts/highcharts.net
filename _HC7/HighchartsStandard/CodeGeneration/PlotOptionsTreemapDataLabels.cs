...
namespace Highsoft.Web.Mvc.Charts
{
	public partial class PlotOptionsTreemapDataLabels  : BaseObject
	{
		...
		/// </summary>
		public PlotOptionsTreemapDataLabelsAlign Align { get; set; }
		private PlotOptionsTreemapDataLabelsAlign Align_DefaultValue { get; set; }
		...
		/// </summary>
		public PlotOptionsTreemapDataLabelsFilter Filter { get; set; }
		private PlotOptionsTreemapDataLabelsFilter Filter_DefaultValue { get; set; }
		...
		/// </summary>
		public PlotOptionsTreemapDataLabelsPosition Position { get; set; }
		private PlotOptionsTreemapDataLabelsPosition Position_DefaultValue { get; set; }
		...
		/// </summary>
		public PlotOptionsTreemapDataLabelsTextPath TextPath { get; set; }
		private PlotOptionsTreemapDataLabelsTextPath TextPath_DefaultValue { get; set; }
		...
		internal override Hashtable ToHashtable(Highcharts highcharts)
		{
			...
			if (Align != PlotOptionsTreemapDataLabelsAlign.Null) h.Add("align", highcharts.FirstCharacterToLower(Align.ToString()));
			...
			if (Overflow != PlotOptionsTreemapDataLabelsOverflow.Null) h.Add("overflow", highcharts.FirstCharacterToLower(Overflow.ToString()));
			if (Padding != null) h.Add("padding",Padding);
			if (Position != PlotOptionsTreemapDataLabelsPosition.Null) h.Add("position", highcharts.FirstCharacterToLower(Position.ToString()));
			...
			if (VerticalAlign != PlotOptionsTreemapDataLabelsVerticalAlign.Null) h.Add("verticalAlign", highcharts.FirstCharacterToLower(VerticalAlign.ToString()));
			if (X != null) h.Add("x",X);
			if (Y != null) h.Add("y",Y);
