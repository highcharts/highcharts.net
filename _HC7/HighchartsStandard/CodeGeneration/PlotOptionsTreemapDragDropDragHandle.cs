...
{
	public partial class PlotOptionsTreemapDragDropDragHandle  : BaseObject
	{
		public PlotOptionsTreemapDragDropDragHandle()
		{
		...
		internal override Hashtable ToHashtable()
		{
			...
			if (PathFormatter != PathFormatter_DefaultValue) { h.Add("pathFormatter",PathFormatter); Highcharts.AddFunction("PlotOptionsTreemapDragDropDragHandlePathFormatter.pathFormatter", PathFormatter); }  
