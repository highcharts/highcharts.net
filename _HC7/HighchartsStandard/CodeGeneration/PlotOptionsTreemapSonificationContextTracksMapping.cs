...
{
	public partial class PlotOptionsTreemapSonificationContextTracksMapping  : BaseObject
	{
		Hashtable h = new Hashtable();

		public PlotOptionsTreemapSonificationContextTracksMapping()
		{
			Frequency = Frequency_DefaultValue = new PlotOptionsTreemapSonificationContextTracksMappingFrequency();
			GapBetweenNotes = GapBetweenNotes_DefaultValue = new PlotOptionsTreemapSonificationContextTracksMappingGapBetweenNotes();
			Highpass = Highpass_DefaultValue = new PlotOptionsTreemapSonificationContextTracksMappingHighpass();
			Lowpass = Lowpass_DefaultValue = new PlotOptionsTreemapSonificationContextTracksMappingLowpass();
			NoteDuration = NoteDuration_DefaultValue = new PlotOptionsTreemapSonificationContextTracksMappingNoteDuration();
			Pan = Pan_DefaultValue = new PlotOptionsTreemapSonificationContextTracksMappingPan();
			Pitch = Pitch_DefaultValue = new PlotOptionsTreemapSonificationContextTracksMappingPitch();
			PitchString = PitchString_DefaultValue = "null";
			PitchNumber = PitchNumber_DefaultValue = null;
			PlayDelay = PlayDelay_DefaultValue = new PlotOptionsTreemapSonificationContextTracksMappingPlayDelay();
			Time = Time_DefaultValue = new PlotOptionsTreemapSonificationContextTracksMappingTime();
			TimeString = TimeString_DefaultValue = "null";
			TimeNumber = TimeNumber_DefaultValue = null;
			Tremolo = Tremolo_DefaultValue = new PlotOptionsTreemapSonificationContextTracksMappingTremolo();
			Volume = Volume_DefaultValue = new PlotOptionsTreemapSonificationContextTracksMappingVolume();
		...
		/// </summary>
		public PlotOptionsTreemapSonificationContextTracksMappingFrequency Frequency { get; set; }
		private PlotOptionsTreemapSonificationContextTracksMappingFrequency Frequency_DefaultValue { get; set; }
		...
		/// </summary>
		public PlotOptionsTreemapSonificationContextTracksMappingGapBetweenNotes GapBetweenNotes { get; set; }
		private PlotOptionsTreemapSonificationContextTracksMappingGapBetweenNotes GapBetweenNotes_DefaultValue { get; set; }
		...
		/// </summary>
		public PlotOptionsTreemapSonificationContextTracksMappingHighpass Highpass { get; set; }
		private PlotOptionsTreemapSonificationContextTracksMappingHighpass Highpass_DefaultValue { get; set; }
		...
		/// </summary>
		public PlotOptionsTreemapSonificationContextTracksMappingLowpass Lowpass { get; set; }
		private PlotOptionsTreemapSonificationContextTracksMappingLowpass Lowpass_DefaultValue { get; set; }
		...
		/// </summary>
		public PlotOptionsTreemapSonificationContextTracksMappingNoteDuration NoteDuration { get; set; }
		private PlotOptionsTreemapSonificationContextTracksMappingNoteDuration NoteDuration_DefaultValue { get; set; }
		...
		/// </summary>
		public PlotOptionsTreemapSonificationContextTracksMappingPan Pan { get; set; }
		private PlotOptionsTreemapSonificationContextTracksMappingPan Pan_DefaultValue { get; set; }
		...
		/// </summary>
		public PlotOptionsTreemapSonificationContextTracksMappingPitch Pitch { get; set; }
		private PlotOptionsTreemapSonificationContextTracksMappingPitch Pitch_DefaultValue { get; set; }
		...
		/// </summary>
		public PlotOptionsTreemapSonificationContextTracksMappingPlayDelay PlayDelay { get; set; }
		private PlotOptionsTreemapSonificationContextTracksMappingPlayDelay PlayDelay_DefaultValue { get; set; }
		...
		/// </summary>
		public PlotOptionsTreemapSonificationContextTracksMappingTime Time { get; set; }
		private PlotOptionsTreemapSonificationContextTracksMappingTime Time_DefaultValue { get; set; }
		...
		/// </summary>
		public PlotOptionsTreemapSonificationContextTracksMappingTremolo Tremolo { get; set; }
		private PlotOptionsTreemapSonificationContextTracksMappingTremolo Tremolo_DefaultValue { get; set; }
		 

		/// <summary>
		/// The volume of notes, from 0 to 1.
		/// </summary>
		public PlotOptionsTreemapSonificationContextTracksMappingVolume Volume { get; set; }
		private PlotOptionsTreemapSonificationContextTracksMappingVolume Volume_DefaultValue { get; set; }
