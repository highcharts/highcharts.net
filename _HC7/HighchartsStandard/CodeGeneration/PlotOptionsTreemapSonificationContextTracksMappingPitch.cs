...
{
	public partial class PlotOptionsTreemapSonificationContextTracksMappingPitch  : BaseObject
	{
		Hashtable h = new Hashtable();

		public PlotOptionsTreemapSonificationContextTracksMappingPitch()
		{
			MapFunction = MapFunction_DefaultValue = PlotOptionsTreemapSonificationContextTracksMappingPitchMapFunction.Linear;
		...
		/// </summary>
		public PlotOptionsTreemapSonificationContextTracksMappingPitchMapFunction MapFunction { get; set; }
		private PlotOptionsTreemapSonificationContextTracksMappingPitchMapFunction MapFunction_DefaultValue { get; set; }
