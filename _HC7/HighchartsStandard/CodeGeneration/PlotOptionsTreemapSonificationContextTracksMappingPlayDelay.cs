...
{
	public partial class PlotOptionsTreemapSonificationContextTracksMappingPlayDelay  : BaseObject
	{
		Hashtable h = new Hashtable();

		public PlotOptionsTreemapSonificationContextTracksMappingPlayDelay()
		{
			MapFunction = MapFunction_DefaultValue = PlotOptionsTreemapSonificationContextTracksMappingPlayDelayMapFunction.Linear;
			MapTo = MapTo_DefaultValue = "";
			Max = Max_DefaultValue = null;
			Min = Min_DefaultValue = null;
			Value = Value_DefaultValue = null;
			Within = Within_DefaultValue = PlotOptionsTreemapSonificationContextTracksMappingPlayDelayWithin.Chart;
		...
		/// </summary>
		public PlotOptionsTreemapSonificationContextTracksMappingPlayDelayMapFunction MapFunction { get; set; }
		private PlotOptionsTreemapSonificationContextTracksMappingPlayDelayMapFunction MapFunction_DefaultValue { get; set; }
		...
		/// </summary>
		public PlotOptionsTreemapSonificationContextTracksMappingPlayDelayWithin Within { get; set; }
		private PlotOptionsTreemapSonificationContextTracksMappingPlayDelayWithin Within_DefaultValue { get; set; }
