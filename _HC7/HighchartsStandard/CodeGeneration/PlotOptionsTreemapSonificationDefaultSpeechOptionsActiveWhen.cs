...
{
	public partial class PlotOptionsTreemapSonificationDefaultSpeechOptionsActiveWhen  : BaseObject
	{
		Hashtable h = new Hashtable();

		public PlotOptionsTreemapSonificationDefaultSpeechOptionsActiveWhen()
		{
