...
{
	public partial class PlotOptionsTreemapSonificationDefaultSpeechOptionsMappingHighpassResonance  : BaseObject
	{
		Hashtable h = new Hashtable();

		public PlotOptionsTreemapSonificationDefaultSpeechOptionsMappingHighpassResonance()
		{
			MapFunction = MapFunction_DefaultValue = PlotOptionsTreemapSonificationDefaultSpeechOptionsMappingHighpassResonanceMapFunction.Linear;
			MapTo = MapTo_DefaultValue = "";
			Max = Max_DefaultValue = null;
			Min = Min_DefaultValue = null;
			Value = Value_DefaultValue = null;
			Within = Within_DefaultValue = PlotOptionsTreemapSonificationDefaultSpeechOptionsMappingHighpassResonanceWithin.Chart;
		...
		/// </summary>
		public PlotOptionsTreemapSonificationDefaultSpeechOptionsMappingHighpassResonanceMapFunction MapFunction { get; set; }
		private PlotOptionsTreemapSonificationDefaultSpeechOptionsMappingHighpassResonanceMapFunction MapFunction_DefaultValue { get; set; }
		...
		/// </summary>
		public PlotOptionsTreemapSonificationDefaultSpeechOptionsMappingHighpassResonanceWithin Within { get; set; }
		private PlotOptionsTreemapSonificationDefaultSpeechOptionsMappingHighpassResonanceWithin Within_DefaultValue { get; set; }
