...
{
	public partial class PlotOptionsTreemapSonificationPointGrouping  : BaseObject
	{
		Hashtable h = new Hashtable();

		public PlotOptionsTreemapSonificationPointGrouping()
		{
		...
		/// </summary>
		public PlotOptionsTreemapSonificationPointGroupingAlgorithm Algorithm { get; set; }
		private PlotOptionsTreemapSonificationPointGroupingAlgorithm Algorithm_DefaultValue { get; set; }
		...
		internal override Hashtable ToHashtable(Highcharts highcharts)
		{
			...
			if (Algorithm != PlotOptionsTreemapSonificationPointGroupingAlgorithm.Null) h.Add("algorithm", highcharts.FirstCharacterToLower(Algorithm.ToString()));
