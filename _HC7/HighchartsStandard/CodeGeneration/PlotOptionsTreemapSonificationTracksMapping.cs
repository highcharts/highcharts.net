...
{
	public partial class PlotOptionsTreemapSonificationTracksMapping  : BaseObject
	{
		Hashtable h = new Hashtable();

		public PlotOptionsTreemapSonificationTracksMapping()
		{
			Frequency = Frequency_DefaultValue = new PlotOptionsTreemapSonificationTracksMappingFrequency();
			GapBetweenNotes = GapBetweenNotes_DefaultValue = new PlotOptionsTreemapSonificationTracksMappingGapBetweenNotes();
			Highpass = Highpass_DefaultValue = new PlotOptionsTreemapSonificationTracksMappingHighpass();
			Lowpass = Lowpass_DefaultValue = new PlotOptionsTreemapSonificationTracksMappingLowpass();
			NoteDuration = NoteDuration_DefaultValue = new PlotOptionsTreemapSonificationTracksMappingNoteDuration();
			Pan = Pan_DefaultValue = new PlotOptionsTreemapSonificationTracksMappingPan();
			Pitch = Pitch_DefaultValue = new PlotOptionsTreemapSonificationTracksMappingPitch();
			PitchString = PitchString_DefaultValue = "null";
			PitchNumber = PitchNumber_DefaultValue = null;
			PlayDelay = PlayDelay_DefaultValue = new PlotOptionsTreemapSonificationTracksMappingPlayDelay();
			Time = Time_DefaultValue = new PlotOptionsTreemapSonificationTracksMappingTime();
			TimeString = TimeString_DefaultValue = "null";
			TimeNumber = TimeNumber_DefaultValue = null;
			Tremolo = Tremolo_DefaultValue = new PlotOptionsTreemapSonificationTracksMappingTremolo();
			Volume = Volume_DefaultValue = new PlotOptionsTreemapSonificationTracksMappingVolume();
		...
		/// </summary>
		public PlotOptionsTreemapSonificationTracksMappingFrequency Frequency { get; set; }
		private PlotOptionsTreemapSonificationTracksMappingFrequency Frequency_DefaultValue { get; set; }
		...
		/// </summary>
		public PlotOptionsTreemapSonificationTracksMappingGapBetweenNotes GapBetweenNotes { get; set; }
		private PlotOptionsTreemapSonificationTracksMappingGapBetweenNotes GapBetweenNotes_DefaultValue { get; set; }
		...
		/// </summary>
		public PlotOptionsTreemapSonificationTracksMappingHighpass Highpass { get; set; }
		private PlotOptionsTreemapSonificationTracksMappingHighpass Highpass_DefaultValue { get; set; }
		...
		/// </summary>
		public PlotOptionsTreemapSonificationTracksMappingLowpass Lowpass { get; set; }
		private PlotOptionsTreemapSonificationTracksMappingLowpass Lowpass_DefaultValue { get; set; }
		...
		/// </summary>
		public PlotOptionsTreemapSonificationTracksMappingNoteDuration NoteDuration { get; set; }
		private PlotOptionsTreemapSonificationTracksMappingNoteDuration NoteDuration_DefaultValue { get; set; }
		...
		/// </summary>
		public PlotOptionsTreemapSonificationTracksMappingPan Pan { get; set; }
		private PlotOptionsTreemapSonificationTracksMappingPan Pan_DefaultValue { get; set; }
		...
		/// </summary>
		public PlotOptionsTreemapSonificationTracksMappingPitch Pitch { get; set; }
		private PlotOptionsTreemapSonificationTracksMappingPitch Pitch_DefaultValue { get; set; }
		...
		/// </summary>
		public PlotOptionsTreemapSonificationTracksMappingPlayDelay PlayDelay { get; set; }
		private PlotOptionsTreemapSonificationTracksMappingPlayDelay PlayDelay_DefaultValue { get; set; }
		...
		/// </summary>
		public PlotOptionsTreemapSonificationTracksMappingTime Time { get; set; }
		private PlotOptionsTreemapSonificationTracksMappingTime Time_DefaultValue { get; set; }
		...
		/// </summary>
		public PlotOptionsTreemapSonificationTracksMappingTremolo Tremolo { get; set; }
		private PlotOptionsTreemapSonificationTracksMappingTremolo Tremolo_DefaultValue { get; set; }
		 

		/// <summary>
		/// The volume of notes, from 0 to 1.
		/// </summary>
		public PlotOptionsTreemapSonificationTracksMappingVolume Volume { get; set; }
		private PlotOptionsTreemapSonificationTracksMappingVolume Volume_DefaultValue { get; set; }
