...
{
	public partial class PlotOptionsTreemapSonificationTracksMappingNoteDuration  : BaseObject
	{
		Hashtable h = new Hashtable();

		public PlotOptionsTreemapSonificationTracksMappingNoteDuration()
		{
			MapFunction = MapFunction_DefaultValue = PlotOptionsTreemapSonificationTracksMappingNoteDurationMapFunction.Linear;
			MapTo = MapTo_DefaultValue = "";
			Max = Max_DefaultValue = null;
			Min = Min_DefaultValue = null;
			Value = Value_DefaultValue = null;
			Within = Within_DefaultValue = PlotOptionsTreemapSonificationTracksMappingNoteDurationWithin.Chart;
		...
		/// </summary>
		public PlotOptionsTreemapSonificationTracksMappingNoteDurationMapFunction MapFunction { get; set; }
		private PlotOptionsTreemapSonificationTracksMappingNoteDurationMapFunction MapFunction_DefaultValue { get; set; }
		...
		/// </summary>
		public PlotOptionsTreemapSonificationTracksMappingNoteDurationWithin Within { get; set; }
		private PlotOptionsTreemapSonificationTracksMappingNoteDurationWithin Within_DefaultValue { get; set; }
