...
{
	public partial class PlotOptionsTreemapSonificationTracksMappingPan  : BaseObject
	{
		Hashtable h = new Hashtable();

		public PlotOptionsTreemapSonificationTracksMappingPan()
		{
			MapFunction = MapFunction_DefaultValue = PlotOptionsTreemapSonificationTracksMappingPanMapFunction.Linear;
			MapTo = MapTo_DefaultValue = "";
			Max = Max_DefaultValue = null;
			Min = Min_DefaultValue = null;
			Value = Value_DefaultValue = null;
			Within = Within_DefaultValue = PlotOptionsTreemapSonificationTracksMappingPanWithin.Chart;
		...
		/// </summary>
		public PlotOptionsTreemapSonificationTracksMappingPanMapFunction MapFunction { get; set; }
		private PlotOptionsTreemapSonificationTracksMappingPanMapFunction MapFunction_DefaultValue { get; set; }
		...
		/// </summary>
		public PlotOptionsTreemapSonificationTracksMappingPanWithin Within { get; set; }
		private PlotOptionsTreemapSonificationTracksMappingPanWithin Within_DefaultValue { get; set; }
