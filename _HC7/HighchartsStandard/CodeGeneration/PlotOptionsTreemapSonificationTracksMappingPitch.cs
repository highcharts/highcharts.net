...
{
	public partial class PlotOptionsTreemapSonificationTracksMappingPitch  : BaseObject
	{
		Hashtable h = new Hashtable();

		public PlotOptionsTreemapSonificationTracksMappingPitch()
		{
			MapFunction = MapFunction_DefaultValue = PlotOptionsTreemapSonificationTracksMappingPitchMapFunction.Linear;
		...
		/// </summary>
		public PlotOptionsTreemapSonificationTracksMappingPitchMapFunction MapFunction { get; set; }
		private PlotOptionsTreemapSonificationTracksMappingPitchMapFunction MapFunction_DefaultValue { get; set; }
