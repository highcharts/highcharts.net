...
{
	public partial class PlotOptionsTreemapSonificationTracksMappingTime  : BaseObject
	{
		Hashtable h = new Hashtable();

		public PlotOptionsTreemapSonificationTracksMappingTime()
		{
			MapFunction = MapFunction_DefaultValue = PlotOptionsTreemapSonificationTracksMappingTimeMapFunction.Linear;
			MapTo = MapTo_DefaultValue = "";
			Max = Max_DefaultValue = null;
			Min = Min_DefaultValue = null;
			Value = Value_DefaultValue = null;
			Within = Within_DefaultValue = PlotOptionsTreemapSonificationTracksMappingTimeWithin.Chart;
		...
		/// </summary>
		public PlotOptionsTreemapSonificationTracksMappingTimeMapFunction MapFunction { get; set; }
		private PlotOptionsTreemapSonificationTracksMappingTimeMapFunction MapFunction_DefaultValue { get; set; }
		...
		/// </summary>
		public PlotOptionsTreemapSonificationTracksMappingTimeWithin Within { get; set; }
		private PlotOptionsTreemapSonificationTracksMappingTimeWithin Within_DefaultValue { get; set; }
