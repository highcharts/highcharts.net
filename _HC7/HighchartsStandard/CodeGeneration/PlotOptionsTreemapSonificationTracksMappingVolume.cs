...
{
	public partial class PlotOptionsTreemapSonificationTracksMappingVolume  : BaseObject
	{
		Hashtable h = new Hashtable();

		public PlotOptionsTreemapSonificationTracksMappingVolume()
		{
			MapFunction = MapFunction_DefaultValue = PlotOptionsTreemapSonificationTracksMappingVolumeMapFunction.Linear;
			MapTo = MapTo_DefaultValue = "";
			Max = Max_DefaultValue = null;
			Min = Min_DefaultValue = null;
			Value = Value_DefaultValue = null;
			Within = Within_DefaultValue = PlotOptionsTreemapSonificationTracksMappingVolumeWithin.Chart;
		...
		/// </summary>
		public PlotOptionsTreemapSonificationTracksMappingVolumeMapFunction MapFunction { get; set; }
		private PlotOptionsTreemapSonificationTracksMappingVolumeMapFunction MapFunction_DefaultValue { get; set; }
		...
		/// </summary>
		public PlotOptionsTreemapSonificationTracksMappingVolumeWithin Within { get; set; }
		private PlotOptionsTreemapSonificationTracksMappingVolumeWithin Within_DefaultValue { get; set; }
