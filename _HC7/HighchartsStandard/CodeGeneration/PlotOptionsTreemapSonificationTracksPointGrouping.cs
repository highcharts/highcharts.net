...
{
	public partial class PlotOptionsTreemapSonificationTracksPointGrouping  : BaseObject
	{
		Hashtable h = new Hashtable();

		public PlotOptionsTreemapSonificationTracksPointGrouping()
		{
		...
		/// </summary>
		public PlotOptionsTreemapSonificationTracksPointGroupingAlgorithm Algorithm { get; set; }
		private PlotOptionsTreemapSonificationTracksPointGroupingAlgorithm Algorithm_DefaultValue { get; set; }
		...
		internal override Hashtable ToHashtable(Highcharts highcharts)
		{
			...
			if (Algorithm != PlotOptionsTreemapSonificationTracksPointGroupingAlgorithm.Null) h.Add("algorithm", highcharts.FirstCharacterToLower(Algorithm.ToString()));
