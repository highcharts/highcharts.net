...
namespace Highsoft.Web.Mvc.Charts
{
	public partial class PlotOptionsVariablepie  : BaseObject
	{
		...
		public PlotOptionsVariablepie()
		{
			...
			LegendSymbol = LegendSymbol_DefaultValue = PlotOptionsVariablepieLegendSymbol.Rectangle;
			...
			Sonification = Sonification_DefaultValue = new PlotOptionsVariablepieSonification();
