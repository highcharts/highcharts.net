...
namespace Highsoft.Web.Mvc.Charts
{
	public partial class PlotOptionsVariablepie  : BaseObject
	{
		...
		/// </summary>
		public PlotOptionsVariablepieAccessibility Accessibility { get; set; }
		private PlotOptionsVariablepieAccessibility Accessibility_DefaultValue { get; set; }
		...
		/// </summary>
		public PlotOptionsVariablepieLegendSymbol LegendSymbol { get; set; }
		private PlotOptionsVariablepieLegendSymbol LegendSymbol_DefaultValue { get; set; }
		...
		/// </summary>
		public PlotOptionsVariablepieOnPoint OnPoint { get; set; }
		private PlotOptionsVariablepieOnPoint OnPoint_DefaultValue { get; set; }
		...
		/// </summary>
		public PlotOptionsVariablepieSonification Sonification { get; set; }
		private PlotOptionsVariablepieSonification Sonification_DefaultValue { get; set; }
		...
		internal override Hashtable ToHashtable(Highcharts highcharts)
		{
			...
			if (Cursor != PlotOptionsVariablepieCursor.Null) h.Add("cursor", highcharts.FirstCharacterToLower(Cursor.ToString()));
			...
			if (LegendSymbol != PlotOptionsVariablepieLegendSymbol.Null) h.Add("legendSymbol", highcharts.FirstCharacterToLower(LegendSymbol.ToString()));
			if (Linecap != PlotOptionsVariablepieLinecap.Null) h.Add("linecap", highcharts.FirstCharacterToLower(Linecap.ToString()));
			if (MaxPointSize != null) h.Add("maxPointSize",MaxPointSize);
			if (MaxPointSizeNumber != null) h.Add("maxPointSize",MaxPointSizeNumber);
			if (MinPointSize != null) h.Add("minPointSize",MinPointSize);
			if (MinPointSizeNumber != null) h.Add("minPointSize",MinPointSizeNumber);
