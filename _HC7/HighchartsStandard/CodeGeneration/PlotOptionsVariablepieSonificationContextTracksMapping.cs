...
{
	public partial class PlotOptionsVariablepieSonificationContextTracksMapping  : BaseObject
	{
		Hashtable h = new Hashtable();

		public PlotOptionsVariablepieSonificationContextTracksMapping()
		{
			Frequency = Frequency_DefaultValue = new PlotOptionsVariablepieSonificationContextTracksMappingFrequency();
			GapBetweenNotes = GapBetweenNotes_DefaultValue = new PlotOptionsVariablepieSonificationContextTracksMappingGapBetweenNotes();
			Highpass = Highpass_DefaultValue = new PlotOptionsVariablepieSonificationContextTracksMappingHighpass();
			Lowpass = Lowpass_DefaultValue = new PlotOptionsVariablepieSonificationContextTracksMappingLowpass();
			NoteDuration = NoteDuration_DefaultValue = new PlotOptionsVariablepieSonificationContextTracksMappingNoteDuration();
			Pan = Pan_DefaultValue = new PlotOptionsVariablepieSonificationContextTracksMappingPan();
			Pitch = Pitch_DefaultValue = new PlotOptionsVariablepieSonificationContextTracksMappingPitch();
			PitchString = PitchString_DefaultValue = "null";
			PitchNumber = PitchNumber_DefaultValue = null;
			PlayDelay = PlayDelay_DefaultValue = new PlotOptionsVariablepieSonificationContextTracksMappingPlayDelay();
			Time = Time_DefaultValue = new PlotOptionsVariablepieSonificationContextTracksMappingTime();
			TimeString = TimeString_DefaultValue = "null";
			TimeNumber = TimeNumber_DefaultValue = null;
			Tremolo = Tremolo_DefaultValue = new PlotOptionsVariablepieSonificationContextTracksMappingTremolo();
			Volume = Volume_DefaultValue = new PlotOptionsVariablepieSonificationContextTracksMappingVolume();
		...
		/// </summary>
		public PlotOptionsVariablepieSonificationContextTracksMappingFrequency Frequency { get; set; }
		private PlotOptionsVariablepieSonificationContextTracksMappingFrequency Frequency_DefaultValue { get; set; }
		...
		/// </summary>
		public PlotOptionsVariablepieSonificationContextTracksMappingGapBetweenNotes GapBetweenNotes { get; set; }
		private PlotOptionsVariablepieSonificationContextTracksMappingGapBetweenNotes GapBetweenNotes_DefaultValue { get; set; }
		...
		/// </summary>
		public PlotOptionsVariablepieSonificationContextTracksMappingHighpass Highpass { get; set; }
		private PlotOptionsVariablepieSonificationContextTracksMappingHighpass Highpass_DefaultValue { get; set; }
		...
		/// </summary>
		public PlotOptionsVariablepieSonificationContextTracksMappingLowpass Lowpass { get; set; }
		private PlotOptionsVariablepieSonificationContextTracksMappingLowpass Lowpass_DefaultValue { get; set; }
		...
		/// </summary>
		public PlotOptionsVariablepieSonificationContextTracksMappingNoteDuration NoteDuration { get; set; }
		private PlotOptionsVariablepieSonificationContextTracksMappingNoteDuration NoteDuration_DefaultValue { get; set; }
		...
		/// </summary>
		public PlotOptionsVariablepieSonificationContextTracksMappingPan Pan { get; set; }
		private PlotOptionsVariablepieSonificationContextTracksMappingPan Pan_DefaultValue { get; set; }
		...
		/// </summary>
		public PlotOptionsVariablepieSonificationContextTracksMappingPitch Pitch { get; set; }
		private PlotOptionsVariablepieSonificationContextTracksMappingPitch Pitch_DefaultValue { get; set; }
		...
		/// </summary>
		public PlotOptionsVariablepieSonificationContextTracksMappingPlayDelay PlayDelay { get; set; }
		private PlotOptionsVariablepieSonificationContextTracksMappingPlayDelay PlayDelay_DefaultValue { get; set; }
		...
		/// </summary>
		public PlotOptionsVariablepieSonificationContextTracksMappingTime Time { get; set; }
		private PlotOptionsVariablepieSonificationContextTracksMappingTime Time_DefaultValue { get; set; }
		...
		/// </summary>
		public PlotOptionsVariablepieSonificationContextTracksMappingTremolo Tremolo { get; set; }
		private PlotOptionsVariablepieSonificationContextTracksMappingTremolo Tremolo_DefaultValue { get; set; }
		 

		/// <summary>
		/// The volume of notes, from 0 to 1.
		/// </summary>
		public PlotOptionsVariablepieSonificationContextTracksMappingVolume Volume { get; set; }
		private PlotOptionsVariablepieSonificationContextTracksMappingVolume Volume_DefaultValue { get; set; }
