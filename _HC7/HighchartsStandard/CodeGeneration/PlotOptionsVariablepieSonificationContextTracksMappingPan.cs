...
{
	public partial class PlotOptionsVariablepieSonificationContextTracksMappingPan  : BaseObject
	{
		Hashtable h = new Hashtable();

		public PlotOptionsVariablepieSonificationContextTracksMappingPan()
		{
			MapFunction = MapFunction_DefaultValue = PlotOptionsVariablepieSonificationContextTracksMappingPanMapFunction.Linear;
			MapTo = MapTo_DefaultValue = "";
			Max = Max_DefaultValue = null;
			Min = Min_DefaultValue = null;
			Value = Value_DefaultValue = null;
			Within = Within_DefaultValue = PlotOptionsVariablepieSonificationContextTracksMappingPanWithin.Chart;
		...
		/// </summary>
		public PlotOptionsVariablepieSonificationContextTracksMappingPanMapFunction MapFunction { get; set; }
		private PlotOptionsVariablepieSonificationContextTracksMappingPanMapFunction MapFunction_DefaultValue { get; set; }
		...
		/// </summary>
		public PlotOptionsVariablepieSonificationContextTracksMappingPanWithin Within { get; set; }
		private PlotOptionsVariablepieSonificationContextTracksMappingPanWithin Within_DefaultValue { get; set; }
