...
{
	public partial class PlotOptionsVariablepieSonificationContextTracksMappingTime  : BaseObject
	{
		Hashtable h = new Hashtable();

		public PlotOptionsVariablepieSonificationContextTracksMappingTime()
		{
			MapFunction = MapFunction_DefaultValue = PlotOptionsVariablepieSonificationContextTracksMappingTimeMapFunction.Linear;
			MapTo = MapTo_DefaultValue = "";
			Max = Max_DefaultValue = null;
			Min = Min_DefaultValue = null;
			Value = Value_DefaultValue = null;
			Within = Within_DefaultValue = PlotOptionsVariablepieSonificationContextTracksMappingTimeWithin.Chart;
		...
		/// </summary>
		public PlotOptionsVariablepieSonificationContextTracksMappingTimeMapFunction MapFunction { get; set; }
		private PlotOptionsVariablepieSonificationContextTracksMappingTimeMapFunction MapFunction_DefaultValue { get; set; }
		...
		/// </summary>
		public PlotOptionsVariablepieSonificationContextTracksMappingTimeWithin Within { get; set; }
		private PlotOptionsVariablepieSonificationContextTracksMappingTimeWithin Within_DefaultValue { get; set; }
