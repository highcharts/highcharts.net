...
{
	public partial class PlotOptionsVariablepieSonificationDefaultSpeechOptions  : BaseObject
	{
		Hashtable h = new Hashtable();

		public PlotOptionsVariablepieSonificationDefaultSpeechOptions()
		{
			ActiveWhen = ActiveWhen_DefaultValue = new PlotOptionsVariablepieSonificationDefaultSpeechOptionsActiveWhen();
			Language = Language_DefaultValue = "en-US";
			Mapping = Mapping_DefaultValue = new PlotOptionsVariablepieSonificationDefaultSpeechOptionsMapping();
			PointGrouping = PointGrouping_DefaultValue = new PlotOptionsVariablepieSonificationDefaultSpeechOptionsPointGrouping();
			PreferredVoice = PreferredVoice_DefaultValue = "";
			ShowPlayMarker = ShowPlayMarker_DefaultValue = true;
			Type = Type_DefaultValue = PlotOptionsVariablepieSonificationDefaultSpeechOptionsType.Instrument;
		...
		/// </summary>
		public PlotOptionsVariablepieSonificationDefaultSpeechOptionsActiveWhen ActiveWhen { get; set; }
		private PlotOptionsVariablepieSonificationDefaultSpeechOptionsActiveWhen ActiveWhen_DefaultValue { get; set; }
		...
		/// </summary>
		public PlotOptionsVariablepieSonificationDefaultSpeechOptionsMapping Mapping { get; set; }
		private PlotOptionsVariablepieSonificationDefaultSpeechOptionsMapping Mapping_DefaultValue { get; set; }
		 

		/// <summary>
		/// Options for point grouping, specifically for instrument tracks.
		/// </summary>
		public PlotOptionsVariablepieSonificationDefaultSpeechOptionsPointGrouping PointGrouping { get; set; }
		private PlotOptionsVariablepieSonificationDefaultSpeechOptionsPointGrouping PointGrouping_DefaultValue { get; set; }
		...
		/// </summary>
		public PlotOptionsVariablepieSonificationDefaultSpeechOptionsType Type { get; set; }
		private PlotOptionsVariablepieSonificationDefaultSpeechOptionsType Type_DefaultValue { get; set; }
