...
{
	public partial class PlotOptionsVariablepieSonificationPointGrouping  : BaseObject
	{
		Hashtable h = new Hashtable();

		public PlotOptionsVariablepieSonificationPointGrouping()
		{
		...
		/// </summary>
		public PlotOptionsVariablepieSonificationPointGroupingAlgorithm Algorithm { get; set; }
		private PlotOptionsVariablepieSonificationPointGroupingAlgorithm Algorithm_DefaultValue { get; set; }
		...
		internal override Hashtable ToHashtable(Highcharts highcharts)
		{
			...
			if (Algorithm != PlotOptionsVariablepieSonificationPointGroupingAlgorithm.Null) h.Add("algorithm", highcharts.FirstCharacterToLower(Algorithm.ToString()));
