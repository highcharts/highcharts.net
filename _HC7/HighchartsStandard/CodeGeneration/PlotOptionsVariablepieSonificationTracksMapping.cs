...
{
	public partial class PlotOptionsVariablepieSonificationTracksMapping  : BaseObject
	{
		Hashtable h = new Hashtable();

		public PlotOptionsVariablepieSonificationTracksMapping()
		{
			Frequency = Frequency_DefaultValue = new PlotOptionsVariablepieSonificationTracksMappingFrequency();
			GapBetweenNotes = GapBetweenNotes_DefaultValue = new PlotOptionsVariablepieSonificationTracksMappingGapBetweenNotes();
			Highpass = Highpass_DefaultValue = new PlotOptionsVariablepieSonificationTracksMappingHighpass();
			Lowpass = Lowpass_DefaultValue = new PlotOptionsVariablepieSonificationTracksMappingLowpass();
			NoteDuration = NoteDuration_DefaultValue = new PlotOptionsVariablepieSonificationTracksMappingNoteDuration();
			Pan = Pan_DefaultValue = new PlotOptionsVariablepieSonificationTracksMappingPan();
			Pitch = Pitch_DefaultValue = new PlotOptionsVariablepieSonificationTracksMappingPitch();
			PitchString = PitchString_DefaultValue = "null";
			PitchNumber = PitchNumber_DefaultValue = null;
			PlayDelay = PlayDelay_DefaultValue = new PlotOptionsVariablepieSonificationTracksMappingPlayDelay();
			Time = Time_DefaultValue = new PlotOptionsVariablepieSonificationTracksMappingTime();
			TimeString = TimeString_DefaultValue = "null";
			TimeNumber = TimeNumber_DefaultValue = null;
			Tremolo = Tremolo_DefaultValue = new PlotOptionsVariablepieSonificationTracksMappingTremolo();
			Volume = Volume_DefaultValue = new PlotOptionsVariablepieSonificationTracksMappingVolume();
		...
		/// </summary>
		public PlotOptionsVariablepieSonificationTracksMappingFrequency Frequency { get; set; }
		private PlotOptionsVariablepieSonificationTracksMappingFrequency Frequency_DefaultValue { get; set; }
		...
		/// </summary>
		public PlotOptionsVariablepieSonificationTracksMappingGapBetweenNotes GapBetweenNotes { get; set; }
		private PlotOptionsVariablepieSonificationTracksMappingGapBetweenNotes GapBetweenNotes_DefaultValue { get; set; }
		...
		/// </summary>
		public PlotOptionsVariablepieSonificationTracksMappingHighpass Highpass { get; set; }
		private PlotOptionsVariablepieSonificationTracksMappingHighpass Highpass_DefaultValue { get; set; }
		...
		/// </summary>
		public PlotOptionsVariablepieSonificationTracksMappingLowpass Lowpass { get; set; }
		private PlotOptionsVariablepieSonificationTracksMappingLowpass Lowpass_DefaultValue { get; set; }
		...
		/// </summary>
		public PlotOptionsVariablepieSonificationTracksMappingNoteDuration NoteDuration { get; set; }
		private PlotOptionsVariablepieSonificationTracksMappingNoteDuration NoteDuration_DefaultValue { get; set; }
		...
		/// </summary>
		public PlotOptionsVariablepieSonificationTracksMappingPan Pan { get; set; }
		private PlotOptionsVariablepieSonificationTracksMappingPan Pan_DefaultValue { get; set; }
		...
		/// </summary>
		public PlotOptionsVariablepieSonificationTracksMappingPitch Pitch { get; set; }
		private PlotOptionsVariablepieSonificationTracksMappingPitch Pitch_DefaultValue { get; set; }
		...
		/// </summary>
		public PlotOptionsVariablepieSonificationTracksMappingPlayDelay PlayDelay { get; set; }
		private PlotOptionsVariablepieSonificationTracksMappingPlayDelay PlayDelay_DefaultValue { get; set; }
		...
		/// </summary>
		public PlotOptionsVariablepieSonificationTracksMappingTime Time { get; set; }
		private PlotOptionsVariablepieSonificationTracksMappingTime Time_DefaultValue { get; set; }
		...
		/// </summary>
		public PlotOptionsVariablepieSonificationTracksMappingTremolo Tremolo { get; set; }
		private PlotOptionsVariablepieSonificationTracksMappingTremolo Tremolo_DefaultValue { get; set; }
		 

		/// <summary>
		/// The volume of notes, from 0 to 1.
		/// </summary>
		public PlotOptionsVariablepieSonificationTracksMappingVolume Volume { get; set; }
		private PlotOptionsVariablepieSonificationTracksMappingVolume Volume_DefaultValue { get; set; }
