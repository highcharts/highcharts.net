...
{
	public partial class PlotOptionsVariablepieSonificationTracksMappingFrequency  : BaseObject
	{
		Hashtable h = new Hashtable();

		public PlotOptionsVariablepieSonificationTracksMappingFrequency()
		{
			MapFunction = MapFunction_DefaultValue = PlotOptionsVariablepieSonificationTracksMappingFrequencyMapFunction.Linear;
			MapTo = MapTo_DefaultValue = "";
			Max = Max_DefaultValue = null;
			Min = Min_DefaultValue = null;
			Value = Value_DefaultValue = null;
			Within = Within_DefaultValue = PlotOptionsVariablepieSonificationTracksMappingFrequencyWithin.Chart;
		...
		/// </summary>
		public PlotOptionsVariablepieSonificationTracksMappingFrequencyMapFunction MapFunction { get; set; }
		private PlotOptionsVariablepieSonificationTracksMappingFrequencyMapFunction MapFunction_DefaultValue { get; set; }
		...
		/// </summary>
		public PlotOptionsVariablepieSonificationTracksMappingFrequencyWithin Within { get; set; }
		private PlotOptionsVariablepieSonificationTracksMappingFrequencyWithin Within_DefaultValue { get; set; }
