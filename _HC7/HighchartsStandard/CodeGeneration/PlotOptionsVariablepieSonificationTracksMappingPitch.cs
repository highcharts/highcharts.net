...
{
	public partial class PlotOptionsVariablepieSonificationTracksMappingPitch  : BaseObject
	{
		Hashtable h = new Hashtable();

		public PlotOptionsVariablepieSonificationTracksMappingPitch()
		{
			MapFunction = MapFunction_DefaultValue = PlotOptionsVariablepieSonificationTracksMappingPitchMapFunction.Linear;
		...
		/// </summary>
		public PlotOptionsVariablepieSonificationTracksMappingPitchMapFunction MapFunction { get; set; }
		private PlotOptionsVariablepieSonificationTracksMappingPitchMapFunction MapFunction_DefaultValue { get; set; }
