...
{
	public partial class PlotOptionsVariablepieSonificationTracksMappingPlayDelay  : BaseObject
	{
		Hashtable h = new Hashtable();

		public PlotOptionsVariablepieSonificationTracksMappingPlayDelay()
		{
			MapFunction = MapFunction_DefaultValue = PlotOptionsVariablepieSonificationTracksMappingPlayDelayMapFunction.Linear;
			MapTo = MapTo_DefaultValue = "";
			Max = Max_DefaultValue = null;
			Min = Min_DefaultValue = null;
			Value = Value_DefaultValue = null;
			Within = Within_DefaultValue = PlotOptionsVariablepieSonificationTracksMappingPlayDelayWithin.Chart;
		...
		/// </summary>
		public PlotOptionsVariablepieSonificationTracksMappingPlayDelayMapFunction MapFunction { get; set; }
		private PlotOptionsVariablepieSonificationTracksMappingPlayDelayMapFunction MapFunction_DefaultValue { get; set; }
		...
		/// </summary>
		public PlotOptionsVariablepieSonificationTracksMappingPlayDelayWithin Within { get; set; }
		private PlotOptionsVariablepieSonificationTracksMappingPlayDelayWithin Within_DefaultValue { get; set; }
