...
{
	public partial class PlotOptionsVariablepieSonificationTracksMappingTime  : BaseObject
	{
		Hashtable h = new Hashtable();

		public PlotOptionsVariablepieSonificationTracksMappingTime()
		{
			MapFunction = MapFunction_DefaultValue = PlotOptionsVariablepieSonificationTracksMappingTimeMapFunction.Linear;
			MapTo = MapTo_DefaultValue = "";
			Max = Max_DefaultValue = null;
			Min = Min_DefaultValue = null;
			Value = Value_DefaultValue = null;
			Within = Within_DefaultValue = PlotOptionsVariablepieSonificationTracksMappingTimeWithin.Chart;
		...
		/// </summary>
		public PlotOptionsVariablepieSonificationTracksMappingTimeMapFunction MapFunction { get; set; }
		private PlotOptionsVariablepieSonificationTracksMappingTimeMapFunction MapFunction_DefaultValue { get; set; }
		...
		/// </summary>
		public PlotOptionsVariablepieSonificationTracksMappingTimeWithin Within { get; set; }
		private PlotOptionsVariablepieSonificationTracksMappingTimeWithin Within_DefaultValue { get; set; }
