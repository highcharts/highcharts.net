...
{
	public partial class PlotOptionsVariablepieSonificationTracksPointGrouping  : BaseObject
	{
		Hashtable h = new Hashtable();

		public PlotOptionsVariablepieSonificationTracksPointGrouping()
		{
		...
		/// </summary>
		public PlotOptionsVariablepieSonificationTracksPointGroupingAlgorithm Algorithm { get; set; }
		private PlotOptionsVariablepieSonificationTracksPointGroupingAlgorithm Algorithm_DefaultValue { get; set; }
		...
		internal override Hashtable ToHashtable(Highcharts highcharts)
		{
			...
			if (Algorithm != PlotOptionsVariablepieSonificationTracksPointGroupingAlgorithm.Null) h.Add("algorithm", highcharts.FirstCharacterToLower(Algorithm.ToString()));
