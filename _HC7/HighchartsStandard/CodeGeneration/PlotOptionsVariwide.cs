...
namespace Highsoft.Web.Mvc.Charts
{
	public partial class PlotOptionsVariwide  : BaseObject
	{
		...
		{
			Accessibility = Accessibility_DefaultValue = new PlotOptionsVariwideAccessibility();
			...
			Cursor = Cursor_DefaultValue = PlotOptionsVariwideCursor.Null;
			Custom = Custom_DefaultValue = new Hashtable();
			DashStyle = DashStyle_DefaultValue = PlotOptionsVariwideDashStyle.Null;
			DataLabels = DataLabels_DefaultValue = new PlotOptionsVariwideDataLabels();
			DataSorting = DataSorting_DefaultValue = new PlotOptionsVariwideDataSorting();
			Description = Description_DefaultValue = "";
			DragDrop = DragDrop_DefaultValue = new PlotOptionsVariwideDragDrop();
			EnableMouseTracking = EnableMouseTracking_DefaultValue = true;
			Events = Events_DefaultValue = new PlotOptionsVariwideEvents();
			FindNearestPointBy = FindNearestPointBy_DefaultValue = PlotOptionsVariwideFindNearestPointBy.X;
			...
			LegendSymbol = LegendSymbol_DefaultValue = PlotOptionsVariwideLegendSymbol.Rectangle;
			LinkedTo = LinkedTo_DefaultValue = "";
			MaxPointWidth = MaxPointWidth_DefaultValue = null;
			MinPointLength = MinPointLength_DefaultValue = 0;
			NegativeColor = NegativeColor_DefaultValue = "";
			OnPoint = OnPoint_DefaultValue = new PlotOptionsVariwideOnPoint();
			Opacity = Opacity_DefaultValue = 1;
			Point = Point_DefaultValue = new PlotOptionsVariwidePoint();
			PointDescriptionFormat = PointDescriptionFormat_DefaultValue = "";
			PointDescriptionFormatter = PointDescriptionFormatter_DefaultValue = "";
			PointInterval = PointInterval_DefaultValue = 1;
			PointIntervalUnit = PointIntervalUnit_DefaultValue = PlotOptionsVariwidePointIntervalUnit.Null;
			...
			Sonification = Sonification_DefaultValue = new PlotOptionsVariwideSonification();
			Stacking = Stacking_DefaultValue = PlotOptionsVariwideStacking.Null;
			States = States_DefaultValue = new PlotOptionsVariwideStates();
			StickyTracking = StickyTracking_DefaultValue = true;
			Threshold = Threshold_DefaultValue = 0;
			Tooltip = Tooltip_DefaultValue = new PlotOptionsVariwideTooltip();
			TurboThreshold = TurboThreshold_DefaultValue = 1000;
			Visible = Visible_DefaultValue = true;
			ZoneAxis = ZoneAxis_DefaultValue = "y";
			Zones = Zones_DefaultValue = new List<PlotOptionsVariwideZone>();
		...
		/// </summary>
		public PlotOptionsVariwideAccessibility Accessibility { get; set; }
		private PlotOptionsVariwideAccessibility Accessibility_DefaultValue { get; set; }
		...
		/// </summary>
		public PlotOptionsVariwideCursor Cursor { get; set; }
		private PlotOptionsVariwideCursor Cursor_DefaultValue { get; set; }
		...
		/// </summary>
		public PlotOptionsVariwideDashStyle DashStyle { get; set; }
		private PlotOptionsVariwideDashStyle DashStyle_DefaultValue { get; set; }
		...
		/// </summary>
		public PlotOptionsVariwideDataSorting DataSorting { get; set; }
		private PlotOptionsVariwideDataSorting DataSorting_DefaultValue { get; set; }
		...
		/// </summary>
		public PlotOptionsVariwideDragDrop DragDrop { get; set; }
		private PlotOptionsVariwideDragDrop DragDrop_DefaultValue { get; set; }
		...
		/// </summary>
		public PlotOptionsVariwideFindNearestPointBy FindNearestPointBy { get; set; }
		private PlotOptionsVariwideFindNearestPointBy FindNearestPointBy_DefaultValue { get; set; }
		...
		/// <summary>
		/// In a variwide chart, the group padding is 0 in order to express thehorizontal stacking of items.
		/// </summary>
		...
		/// </summary>
		public PlotOptionsVariwideLegendSymbol LegendSymbol { get; set; }
		private PlotOptionsVariwideLegendSymbol LegendSymbol_DefaultValue { get; set; }
		...
		/// </summary>
		public PlotOptionsVariwideOnPoint OnPoint { get; set; }
		private PlotOptionsVariwideOnPoint OnPoint_DefaultValue { get; set; }
		...
		/// </summary>
		public PlotOptionsVariwidePointIntervalUnit PointIntervalUnit { get; set; }
		private PlotOptionsVariwidePointIntervalUnit PointIntervalUnit_DefaultValue { get; set; }
		 

		/// <summary>
		/// In a variwide chart, the point padding is 0 in order to express thehorizontal stacking of items.
		/// </summary>
		...
		/// </summary>
		public PlotOptionsVariwideSonification Sonification { get; set; }
		private PlotOptionsVariwideSonification Sonification_DefaultValue { get; set; }
		...
		/// </summary>
		public PlotOptionsVariwideStacking Stacking { get; set; }
		private PlotOptionsVariwideStacking Stacking_DefaultValue { get; set; }
