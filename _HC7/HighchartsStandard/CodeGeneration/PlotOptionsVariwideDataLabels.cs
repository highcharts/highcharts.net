...
namespace Highsoft.Web.Mvc.Charts
{
	public partial class PlotOptionsVariwideDataLabels  : BaseObject
	{
		...
		public PlotOptionsVariwideDataLabels()
		{
			...
			Overflow = Overflow_DefaultValue = PlotOptionsVariwideDataLabelsOverflow.Justify;
			Padding = Padding_DefaultValue = 5;
			Position = Position_DefaultValue = PlotOptionsVariwideDataLabelsPosition.Center;
