...
{
	public partial class PlotOptionsVariwideDragDrop  : BaseObject
	{
		public PlotOptionsVariwideDragDrop()
		{
			DraggableX = DraggableX_DefaultValue = null;
			DraggableY = DraggableY_DefaultValue = null;
			DragHandle = DragHandle_DefaultValue = new PlotOptionsVariwideDragDropDragHandle();
			...
			GuideBox = GuideBox_DefaultValue = new PlotOptionsVariwideDragDropGuideBox();
		...
		/// </summary>
		public PlotOptionsVariwideDragDropDragHandle DragHandle { get; set; }
		private PlotOptionsVariwideDragDropDragHandle DragHandle_DefaultValue { get; set; }
		...
		/// </summary>
		public PlotOptionsVariwideDragDropGuideBox GuideBox { get; set; }
		private PlotOptionsVariwideDragDropGuideBox GuideBox_DefaultValue { get; set; }
