...
{
	public partial class PlotOptionsVariwideDragDropDragHandle  : BaseObject
	{
		public PlotOptionsVariwideDragDropDragHandle()
		{
		...
		internal override Hashtable ToHashtable()
		{
			...
			if (PathFormatter != PathFormatter_DefaultValue) { h.Add("pathFormatter",PathFormatter); Highcharts.AddFunction("PlotOptionsVariwideDragDropDragHandlePathFormatter.pathFormatter", PathFormatter); }  
