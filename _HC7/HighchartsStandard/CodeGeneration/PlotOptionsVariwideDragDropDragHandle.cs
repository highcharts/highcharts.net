...
namespace Highsoft.Web.Mvc.Charts
{
	public partial class PlotOptionsVariwideDragDropDragHandle  : BaseObject
	{
		...
		internal override Hashtable ToHashtable()
		{
			...
			if (PathFormatter != PathFormatter_DefaultValue) { h.Add("pathFormatter",PathFormatter); Highcharts.AddFunction("daea6d5c-70d0-47c9-a77a-e12e1b5bcb81.pathFormatter", PathFormatter); }  
