...
namespace Highsoft.Web.Mvc.Charts
{
	public partial class PlotOptionsVariwideSonification  : BaseObject
	{
		...
		{
			ContextTracks = ContextTracks_DefaultValue = new PlotOptionsVariwideSonificationContextTracks();
			DefaultInstrumentOptions = DefaultInstrumentOptions_DefaultValue = new PlotOptionsVariwideSonificationDefaultInstrumentOptions();
			DefaultSpeechOptions = DefaultSpeechOptions_DefaultValue = new PlotOptionsVariwideSonificationDefaultSpeechOptions();
			Enabled = Enabled_DefaultValue = true;
			PointGrouping = PointGrouping_DefaultValue = new PlotOptionsVariwideSonificationPointGrouping();
			Tracks = Tracks_DefaultValue = new PlotOptionsVariwideSonificationTracks();
		...
		private PlotOptionsVariwideSonificationContextTracks ContextTracks_DefaultValue { get; set; }
		...
		private PlotOptionsVariwideSonificationDefaultInstrumentOptions DefaultInstrumentOptions_DefaultValue { get; set; }
		...
		private PlotOptionsVariwideSonificationDefaultSpeechOptions DefaultSpeechOptions_DefaultValue { get; set; }
		...
		private PlotOptionsVariwideSonificationPointGrouping PointGrouping_DefaultValue { get; set; }
		...
		private PlotOptionsVariwideSonificationTracks Tracks_DefaultValue { get; set; }
