...
{
	public partial class PlotOptionsVariwideSonificationContextTracks  : BaseObject
	{
		Hashtable h = new Hashtable();

		public PlotOptionsVariwideSonificationContextTracks()
		{
			ActiveWhen = ActiveWhen_DefaultValue = new PlotOptionsVariwideSonificationContextTracksActiveWhen();
			Instrument = Instrument_DefaultValue = null;
			InstrumentString = InstrumentString_DefaultValue = "null";
			Mapping = Mapping_DefaultValue = new PlotOptionsVariwideSonificationContextTracksMapping();
			MidiName = MidiName_DefaultValue = "";
			PointGrouping = PointGrouping_DefaultValue = new PlotOptionsVariwideSonificationContextTracksPointGrouping();
			...
			Type = Type_DefaultValue = PlotOptionsVariwideSonificationContextTracksType.Instrument;
			ValueInterval = ValueInterval_DefaultValue = null;
			ValueMapFunction = ValueMapFunction_DefaultValue = PlotOptionsVariwideSonificationContextTracksValueMapFunction.Linear;
		...
		/// </summary>
		public PlotOptionsVariwideSonificationContextTracksActiveWhen ActiveWhen { get; set; }
		private PlotOptionsVariwideSonificationContextTracksActiveWhen ActiveWhen_DefaultValue { get; set; }
		...
		/// </summary>
		public PlotOptionsVariwideSonificationContextTracksMapping Mapping { get; set; }
		private PlotOptionsVariwideSonificationContextTracksMapping Mapping_DefaultValue { get; set; }
		...
		/// </summary>
		public PlotOptionsVariwideSonificationContextTracksPointGrouping PointGrouping { get; set; }
		private PlotOptionsVariwideSonificationContextTracksPointGrouping PointGrouping_DefaultValue { get; set; }
		...
		/// </summary>
		public PlotOptionsVariwideSonificationContextTracksType Type { get; set; }
		private PlotOptionsVariwideSonificationContextTracksType Type_DefaultValue { get; set; }
		...
		/// </summary>
		public PlotOptionsVariwideSonificationContextTracksValueMapFunction ValueMapFunction { get; set; }
		private PlotOptionsVariwideSonificationContextTracksValueMapFunction ValueMapFunction_DefaultValue { get; set; }
