...
{
	public partial class PlotOptionsVariwideSonificationContextTracksMapping  : BaseObject
	{
		Hashtable h = new Hashtable();

		public PlotOptionsVariwideSonificationContextTracksMapping()
		{
			Frequency = Frequency_DefaultValue = new PlotOptionsVariwideSonificationContextTracksMappingFrequency();
			GapBetweenNotes = GapBetweenNotes_DefaultValue = new PlotOptionsVariwideSonificationContextTracksMappingGapBetweenNotes();
			Highpass = Highpass_DefaultValue = new PlotOptionsVariwideSonificationContextTracksMappingHighpass();
			Lowpass = Lowpass_DefaultValue = new PlotOptionsVariwideSonificationContextTracksMappingLowpass();
			NoteDuration = NoteDuration_DefaultValue = new PlotOptionsVariwideSonificationContextTracksMappingNoteDuration();
			Pan = Pan_DefaultValue = new PlotOptionsVariwideSonificationContextTracksMappingPan();
			Pitch = Pitch_DefaultValue = new PlotOptionsVariwideSonificationContextTracksMappingPitch();
			PitchString = PitchString_DefaultValue = "null";
			PitchNumber = PitchNumber_DefaultValue = null;
			PlayDelay = PlayDelay_DefaultValue = new PlotOptionsVariwideSonificationContextTracksMappingPlayDelay();
			Time = Time_DefaultValue = new PlotOptionsVariwideSonificationContextTracksMappingTime();
			TimeString = TimeString_DefaultValue = "null";
			TimeNumber = TimeNumber_DefaultValue = null;
			Tremolo = Tremolo_DefaultValue = new PlotOptionsVariwideSonificationContextTracksMappingTremolo();
			Volume = Volume_DefaultValue = new PlotOptionsVariwideSonificationContextTracksMappingVolume();
		...
		/// </summary>
		public PlotOptionsVariwideSonificationContextTracksMappingFrequency Frequency { get; set; }
		private PlotOptionsVariwideSonificationContextTracksMappingFrequency Frequency_DefaultValue { get; set; }
		...
		/// </summary>
		public PlotOptionsVariwideSonificationContextTracksMappingGapBetweenNotes GapBetweenNotes { get; set; }
		private PlotOptionsVariwideSonificationContextTracksMappingGapBetweenNotes GapBetweenNotes_DefaultValue { get; set; }
		...
		/// </summary>
		public PlotOptionsVariwideSonificationContextTracksMappingHighpass Highpass { get; set; }
		private PlotOptionsVariwideSonificationContextTracksMappingHighpass Highpass_DefaultValue { get; set; }
		...
		/// </summary>
		public PlotOptionsVariwideSonificationContextTracksMappingLowpass Lowpass { get; set; }
		private PlotOptionsVariwideSonificationContextTracksMappingLowpass Lowpass_DefaultValue { get; set; }
		...
		/// </summary>
		public PlotOptionsVariwideSonificationContextTracksMappingNoteDuration NoteDuration { get; set; }
		private PlotOptionsVariwideSonificationContextTracksMappingNoteDuration NoteDuration_DefaultValue { get; set; }
		...
		/// </summary>
		public PlotOptionsVariwideSonificationContextTracksMappingPan Pan { get; set; }
		private PlotOptionsVariwideSonificationContextTracksMappingPan Pan_DefaultValue { get; set; }
		...
		/// </summary>
		public PlotOptionsVariwideSonificationContextTracksMappingPitch Pitch { get; set; }
		private PlotOptionsVariwideSonificationContextTracksMappingPitch Pitch_DefaultValue { get; set; }
		...
		/// </summary>
		public PlotOptionsVariwideSonificationContextTracksMappingPlayDelay PlayDelay { get; set; }
		private PlotOptionsVariwideSonificationContextTracksMappingPlayDelay PlayDelay_DefaultValue { get; set; }
		...
		/// </summary>
		public PlotOptionsVariwideSonificationContextTracksMappingTime Time { get; set; }
		private PlotOptionsVariwideSonificationContextTracksMappingTime Time_DefaultValue { get; set; }
		...
		/// </summary>
		public PlotOptionsVariwideSonificationContextTracksMappingTremolo Tremolo { get; set; }
		private PlotOptionsVariwideSonificationContextTracksMappingTremolo Tremolo_DefaultValue { get; set; }
		 

		/// <summary>
		/// The volume of notes, from 0 to 1.
		/// </summary>
		public PlotOptionsVariwideSonificationContextTracksMappingVolume Volume { get; set; }
		private PlotOptionsVariwideSonificationContextTracksMappingVolume Volume_DefaultValue { get; set; }
