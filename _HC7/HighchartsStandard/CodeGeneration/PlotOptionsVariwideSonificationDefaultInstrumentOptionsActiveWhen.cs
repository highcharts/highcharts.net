...
{
	public partial class PlotOptionsVariwideSonificationDefaultInstrumentOptionsActiveWhen  : BaseObject
	{
		Hashtable h = new Hashtable();

		public PlotOptionsVariwideSonificationDefaultInstrumentOptionsActiveWhen()
		{
