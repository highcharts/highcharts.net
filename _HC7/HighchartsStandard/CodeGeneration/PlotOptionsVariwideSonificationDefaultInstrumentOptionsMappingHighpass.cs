...
{
	public partial class PlotOptionsVariwideSonificationDefaultInstrumentOptionsMappingHighpass  : BaseObject
	{
		Hashtable h = new Hashtable();

		public PlotOptionsVariwideSonificationDefaultInstrumentOptionsMappingHighpass()
		{
			Frequency = Frequency_DefaultValue = new PlotOptionsVariwideSonificationDefaultInstrumentOptionsMappingHighpassFrequency();
			Resonance = Resonance_DefaultValue = new PlotOptionsVariwideSonificationDefaultInstrumentOptionsMappingHighpassResonance();
