...
namespace Highsoft.Web.Mvc.Charts
{
	public partial class PlotOptionsVariwideSonificationDefaultSpeechOptionsMappingTremoloDepth  : BaseObject
	{
		...
		{
			if (MapFunction != PlotOptionsVariwideSonificationDefaultSpeechOptionsMappingTremoloDepthMapFunction.Null) h.Add("mapFunction", highcharts.FirstCharacterToLower(MapFunction.ToString()));
			if (MapTo != null) h.Add("mapTo",MapTo);
			if (Max != null) h.Add("max",Max);
			if (Min != null) h.Add("min",Min);
			if (Value != null) h.Add("value",Value);
			if (Within != PlotOptionsVariwideSonificationDefaultSpeechOptionsMappingTremoloDepthWithin.Null) h.Add("within", highcharts.FirstCharacterToLower(Within.ToString()));
