...
{
	public partial class PlotOptionsVariwideSonificationPointGrouping  : BaseObject
	{
		Hashtable h = new Hashtable();

		public PlotOptionsVariwideSonificationPointGrouping()
		{
		...
		/// </summary>
		public PlotOptionsVariwideSonificationPointGroupingAlgorithm Algorithm { get; set; }
		private PlotOptionsVariwideSonificationPointGroupingAlgorithm Algorithm_DefaultValue { get; set; }
		...
		internal override Hashtable ToHashtable(Highcharts highcharts)
		{
			...
			if (Algorithm != PlotOptionsVariwideSonificationPointGroupingAlgorithm.Null) h.Add("algorithm", highcharts.FirstCharacterToLower(Algorithm.ToString()));
