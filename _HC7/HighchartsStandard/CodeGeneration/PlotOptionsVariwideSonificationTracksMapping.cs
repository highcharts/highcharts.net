...
{
	public partial class PlotOptionsVariwideSonificationTracksMapping  : BaseObject
	{
		Hashtable h = new Hashtable();

		public PlotOptionsVariwideSonificationTracksMapping()
		{
			Frequency = Frequency_DefaultValue = new PlotOptionsVariwideSonificationTracksMappingFrequency();
			GapBetweenNotes = GapBetweenNotes_DefaultValue = new PlotOptionsVariwideSonificationTracksMappingGapBetweenNotes();
			Highpass = Highpass_DefaultValue = new PlotOptionsVariwideSonificationTracksMappingHighpass();
			Lowpass = Lowpass_DefaultValue = new PlotOptionsVariwideSonificationTracksMappingLowpass();
			NoteDuration = NoteDuration_DefaultValue = new PlotOptionsVariwideSonificationTracksMappingNoteDuration();
			Pan = Pan_DefaultValue = new PlotOptionsVariwideSonificationTracksMappingPan();
			Pitch = Pitch_DefaultValue = new PlotOptionsVariwideSonificationTracksMappingPitch();
			PitchString = PitchString_DefaultValue = "null";
			PitchNumber = PitchNumber_DefaultValue = null;
			PlayDelay = PlayDelay_DefaultValue = new PlotOptionsVariwideSonificationTracksMappingPlayDelay();
			Time = Time_DefaultValue = new PlotOptionsVariwideSonificationTracksMappingTime();
			TimeString = TimeString_DefaultValue = "null";
			TimeNumber = TimeNumber_DefaultValue = null;
			Tremolo = Tremolo_DefaultValue = new PlotOptionsVariwideSonificationTracksMappingTremolo();
			Volume = Volume_DefaultValue = new PlotOptionsVariwideSonificationTracksMappingVolume();
		...
		/// </summary>
		public PlotOptionsVariwideSonificationTracksMappingFrequency Frequency { get; set; }
		private PlotOptionsVariwideSonificationTracksMappingFrequency Frequency_DefaultValue { get; set; }
		...
		/// </summary>
		public PlotOptionsVariwideSonificationTracksMappingGapBetweenNotes GapBetweenNotes { get; set; }
		private PlotOptionsVariwideSonificationTracksMappingGapBetweenNotes GapBetweenNotes_DefaultValue { get; set; }
		...
		/// </summary>
		public PlotOptionsVariwideSonificationTracksMappingHighpass Highpass { get; set; }
		private PlotOptionsVariwideSonificationTracksMappingHighpass Highpass_DefaultValue { get; set; }
		...
		/// </summary>
		public PlotOptionsVariwideSonificationTracksMappingLowpass Lowpass { get; set; }
		private PlotOptionsVariwideSonificationTracksMappingLowpass Lowpass_DefaultValue { get; set; }
		...
		/// </summary>
		public PlotOptionsVariwideSonificationTracksMappingNoteDuration NoteDuration { get; set; }
		private PlotOptionsVariwideSonificationTracksMappingNoteDuration NoteDuration_DefaultValue { get; set; }
		...
		/// </summary>
		public PlotOptionsVariwideSonificationTracksMappingPan Pan { get; set; }
		private PlotOptionsVariwideSonificationTracksMappingPan Pan_DefaultValue { get; set; }
		...
		/// </summary>
		public PlotOptionsVariwideSonificationTracksMappingPitch Pitch { get; set; }
		private PlotOptionsVariwideSonificationTracksMappingPitch Pitch_DefaultValue { get; set; }
		...
		/// </summary>
		public PlotOptionsVariwideSonificationTracksMappingPlayDelay PlayDelay { get; set; }
		private PlotOptionsVariwideSonificationTracksMappingPlayDelay PlayDelay_DefaultValue { get; set; }
		...
		/// </summary>
		public PlotOptionsVariwideSonificationTracksMappingTime Time { get; set; }
		private PlotOptionsVariwideSonificationTracksMappingTime Time_DefaultValue { get; set; }
		...
		/// </summary>
		public PlotOptionsVariwideSonificationTracksMappingTremolo Tremolo { get; set; }
		private PlotOptionsVariwideSonificationTracksMappingTremolo Tremolo_DefaultValue { get; set; }
		 

		/// <summary>
		/// The volume of notes, from 0 to 1.
		/// </summary>
		public PlotOptionsVariwideSonificationTracksMappingVolume Volume { get; set; }
		private PlotOptionsVariwideSonificationTracksMappingVolume Volume_DefaultValue { get; set; }
