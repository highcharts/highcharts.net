...
{
	public partial class PlotOptionsVariwideSonificationTracksMappingNoteDuration  : BaseObject
	{
		Hashtable h = new Hashtable();

		public PlotOptionsVariwideSonificationTracksMappingNoteDuration()
		{
			MapFunction = MapFunction_DefaultValue = PlotOptionsVariwideSonificationTracksMappingNoteDurationMapFunction.Linear;
			MapTo = MapTo_DefaultValue = "";
			Max = Max_DefaultValue = null;
			Min = Min_DefaultValue = null;
			Value = Value_DefaultValue = null;
			Within = Within_DefaultValue = PlotOptionsVariwideSonificationTracksMappingNoteDurationWithin.Chart;
		...
		/// </summary>
		public PlotOptionsVariwideSonificationTracksMappingNoteDurationMapFunction MapFunction { get; set; }
		private PlotOptionsVariwideSonificationTracksMappingNoteDurationMapFunction MapFunction_DefaultValue { get; set; }
		...
		/// </summary>
		public PlotOptionsVariwideSonificationTracksMappingNoteDurationWithin Within { get; set; }
		private PlotOptionsVariwideSonificationTracksMappingNoteDurationWithin Within_DefaultValue { get; set; }
