...
{
	public partial class PlotOptionsVariwideSonificationTracksMappingTime  : BaseObject
	{
		Hashtable h = new Hashtable();

		public PlotOptionsVariwideSonificationTracksMappingTime()
		{
			MapFunction = MapFunction_DefaultValue = PlotOptionsVariwideSonificationTracksMappingTimeMapFunction.Linear;
			MapTo = MapTo_DefaultValue = "";
			Max = Max_DefaultValue = null;
			Min = Min_DefaultValue = null;
			Value = Value_DefaultValue = null;
			Within = Within_DefaultValue = PlotOptionsVariwideSonificationTracksMappingTimeWithin.Chart;
		...
		/// </summary>
		public PlotOptionsVariwideSonificationTracksMappingTimeMapFunction MapFunction { get; set; }
		private PlotOptionsVariwideSonificationTracksMappingTimeMapFunction MapFunction_DefaultValue { get; set; }
		...
		/// </summary>
		public PlotOptionsVariwideSonificationTracksMappingTimeWithin Within { get; set; }
		private PlotOptionsVariwideSonificationTracksMappingTimeWithin Within_DefaultValue { get; set; }
