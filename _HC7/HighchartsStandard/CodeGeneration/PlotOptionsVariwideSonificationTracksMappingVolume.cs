...
{
	public partial class PlotOptionsVariwideSonificationTracksMappingVolume  : BaseObject
	{
		Hashtable h = new Hashtable();

		public PlotOptionsVariwideSonificationTracksMappingVolume()
		{
			MapFunction = MapFunction_DefaultValue = PlotOptionsVariwideSonificationTracksMappingVolumeMapFunction.Linear;
			MapTo = MapTo_DefaultValue = "";
			Max = Max_DefaultValue = null;
			Min = Min_DefaultValue = null;
			Value = Value_DefaultValue = null;
			Within = Within_DefaultValue = PlotOptionsVariwideSonificationTracksMappingVolumeWithin.Chart;
		...
		/// </summary>
		public PlotOptionsVariwideSonificationTracksMappingVolumeMapFunction MapFunction { get; set; }
		private PlotOptionsVariwideSonificationTracksMappingVolumeMapFunction MapFunction_DefaultValue { get; set; }
		...
		/// </summary>
		public PlotOptionsVariwideSonificationTracksMappingVolumeWithin Within { get; set; }
		private PlotOptionsVariwideSonificationTracksMappingVolumeWithin Within_DefaultValue { get; set; }
