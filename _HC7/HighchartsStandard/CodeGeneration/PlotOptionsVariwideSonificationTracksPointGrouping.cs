...
{
	public partial class PlotOptionsVariwideSonificationTracksPointGrouping  : BaseObject
	{
		Hashtable h = new Hashtable();

		public PlotOptionsVariwideSonificationTracksPointGrouping()
		{
		...
		/// </summary>
		public PlotOptionsVariwideSonificationTracksPointGroupingAlgorithm Algorithm { get; set; }
		private PlotOptionsVariwideSonificationTracksPointGroupingAlgorithm Algorithm_DefaultValue { get; set; }
		...
		internal override Hashtable ToHashtable(Highcharts highcharts)
		{
			...
			if (Algorithm != PlotOptionsVariwideSonificationTracksPointGroupingAlgorithm.Null) h.Add("algorithm", highcharts.FirstCharacterToLower(Algorithm.ToString()));
