...
{
	public partial class PlotOptionsVariwideTooltip  : BaseObject
	{
		public PlotOptionsVariwideTooltip()
		{
			...
			HeaderShape = HeaderShape_DefaultValue = PlotOptionsVariwideTooltipHeaderShape.Callout;
		...
		/// </summary>
		public PlotOptionsVariwideTooltipHeaderShape HeaderShape { get; set; }
		private PlotOptionsVariwideTooltipHeaderShape HeaderShape_DefaultValue { get; set; }
		...
		internal override Hashtable ToHashtable()
		{
			...
			if (NullFormatter != NullFormatter_DefaultValue) { h.Add("nullFormatter",NullFormatter); Highcharts.AddFunction("PlotOptionsVariwideTooltipNullFormatter.nullFormatter", NullFormatter); }  
			if (Outside != Outside_DefaultValue) h.Add("outside",Outside);
			if (Padding != Padding_DefaultValue) h.Add("padding",Padding);
			if (PointFormat != PointFormat_DefaultValue) h.Add("pointFormat",PointFormat);
			if (PointFormatter != PointFormatter_DefaultValue) { h.Add("pointFormatter",PointFormatter); Highcharts.AddFunction("PlotOptionsVariwideTooltipPointFormatter.pointFormatter", PointFormatter); }  
