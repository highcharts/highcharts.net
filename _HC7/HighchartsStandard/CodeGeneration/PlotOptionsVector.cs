...
namespace Highsoft.Web.Mvc.Charts
{
	public partial class PlotOptionsVector  : BaseObject
	{
		...
		private PlotOptionsVectorAccessibility Accessibility_DefaultValue { get; set; }
		...
		private PlotOptionsVectorCluster Cluster_DefaultValue { get; set; }
		...
		private PlotOptionsVectorDataSorting DataSorting_DefaultValue { get; set; }
		...
		private PlotOptionsVectorLegendSymbol LegendSymbol_DefaultValue { get; set; }
		...
		private PlotOptionsVectorOnPoint OnPoint_DefaultValue { get; set; }
		...
		private PlotOptionsVectorSonification Sonification_DefaultValue { get; set; }
		...
		internal override Hashtable ToHashtable(Highcharts highcharts)
		{
			...
			if (Cursor != PlotOptionsVectorCursor.Null) h.Add("cursor", highcharts.FirstCharacterToLower(Cursor.ToString()));
			...
			if (FindNearestPointBy != PlotOptionsVectorFindNearestPointBy.Null) h.Add("findNearestPointBy", highcharts.FirstCharacterToLower(FindNearestPointBy.ToString()));
			...
			if (LegendSymbol != PlotOptionsVectorLegendSymbol.Null) h.Add("legendSymbol", highcharts.FirstCharacterToLower(LegendSymbol.ToString()));
			...
			if (PointIntervalUnit != PlotOptionsVectorPointIntervalUnit.Null) h.Add("pointIntervalUnit", highcharts.FirstCharacterToLower(PointIntervalUnit.ToString()));
			if (PointStart != null) h.Add("pointStart",PointStart);
			if (RelativeXValue != null) h.Add("relativeXValue",RelativeXValue);
			if (RotationOrigin != PlotOptionsVectorRotationOrigin.Null) h.Add("rotationOrigin", highcharts.FirstCharacterToLower(RotationOrigin.ToString()));
