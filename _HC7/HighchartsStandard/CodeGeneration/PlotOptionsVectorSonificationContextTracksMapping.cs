...
{
	public partial class PlotOptionsVectorSonificationContextTracksMapping  : BaseObject
	{
		Hashtable h = new Hashtable();

		public PlotOptionsVectorSonificationContextTracksMapping()
		{
			Frequency = Frequency_DefaultValue = new PlotOptionsVectorSonificationContextTracksMappingFrequency();
			GapBetweenNotes = GapBetweenNotes_DefaultValue = new PlotOptionsVectorSonificationContextTracksMappingGapBetweenNotes();
			Highpass = Highpass_DefaultValue = new PlotOptionsVectorSonificationContextTracksMappingHighpass();
			Lowpass = Lowpass_DefaultValue = new PlotOptionsVectorSonificationContextTracksMappingLowpass();
			NoteDuration = NoteDuration_DefaultValue = new PlotOptionsVectorSonificationContextTracksMappingNoteDuration();
			Pan = Pan_DefaultValue = new PlotOptionsVectorSonificationContextTracksMappingPan();
			Pitch = Pitch_DefaultValue = new PlotOptionsVectorSonificationContextTracksMappingPitch();
			PitchString = PitchString_DefaultValue = "null";
			PitchNumber = PitchNumber_DefaultValue = null;
			PlayDelay = PlayDelay_DefaultValue = new PlotOptionsVectorSonificationContextTracksMappingPlayDelay();
			Time = Time_DefaultValue = new PlotOptionsVectorSonificationContextTracksMappingTime();
			TimeString = TimeString_DefaultValue = "null";
			TimeNumber = TimeNumber_DefaultValue = null;
			Tremolo = Tremolo_DefaultValue = new PlotOptionsVectorSonificationContextTracksMappingTremolo();
			Volume = Volume_DefaultValue = new PlotOptionsVectorSonificationContextTracksMappingVolume();
		...
		/// </summary>
		public PlotOptionsVectorSonificationContextTracksMappingFrequency Frequency { get; set; }
		private PlotOptionsVectorSonificationContextTracksMappingFrequency Frequency_DefaultValue { get; set; }
		...
		/// </summary>
		public PlotOptionsVectorSonificationContextTracksMappingGapBetweenNotes GapBetweenNotes { get; set; }
		private PlotOptionsVectorSonificationContextTracksMappingGapBetweenNotes GapBetweenNotes_DefaultValue { get; set; }
		...
		/// </summary>
		public PlotOptionsVectorSonificationContextTracksMappingHighpass Highpass { get; set; }
		private PlotOptionsVectorSonificationContextTracksMappingHighpass Highpass_DefaultValue { get; set; }
		...
		/// </summary>
		public PlotOptionsVectorSonificationContextTracksMappingLowpass Lowpass { get; set; }
		private PlotOptionsVectorSonificationContextTracksMappingLowpass Lowpass_DefaultValue { get; set; }
		...
		/// </summary>
		public PlotOptionsVectorSonificationContextTracksMappingNoteDuration NoteDuration { get; set; }
		private PlotOptionsVectorSonificationContextTracksMappingNoteDuration NoteDuration_DefaultValue { get; set; }
		...
		/// </summary>
		public PlotOptionsVectorSonificationContextTracksMappingPan Pan { get; set; }
		private PlotOptionsVectorSonificationContextTracksMappingPan Pan_DefaultValue { get; set; }
		...
		/// </summary>
		public PlotOptionsVectorSonificationContextTracksMappingPitch Pitch { get; set; }
		private PlotOptionsVectorSonificationContextTracksMappingPitch Pitch_DefaultValue { get; set; }
		...
		/// </summary>
		public PlotOptionsVectorSonificationContextTracksMappingPlayDelay PlayDelay { get; set; }
		private PlotOptionsVectorSonificationContextTracksMappingPlayDelay PlayDelay_DefaultValue { get; set; }
		...
		/// </summary>
		public PlotOptionsVectorSonificationContextTracksMappingTime Time { get; set; }
		private PlotOptionsVectorSonificationContextTracksMappingTime Time_DefaultValue { get; set; }
		...
		/// </summary>
		public PlotOptionsVectorSonificationContextTracksMappingTremolo Tremolo { get; set; }
		private PlotOptionsVectorSonificationContextTracksMappingTremolo Tremolo_DefaultValue { get; set; }
		 

		/// <summary>
		/// The volume of notes, from 0 to 1.
		/// </summary>
		public PlotOptionsVectorSonificationContextTracksMappingVolume Volume { get; set; }
		private PlotOptionsVectorSonificationContextTracksMappingVolume Volume_DefaultValue { get; set; }
