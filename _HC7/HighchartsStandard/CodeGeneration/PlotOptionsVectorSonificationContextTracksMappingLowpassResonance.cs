...
{
	public partial class PlotOptionsVectorSonificationContextTracksMappingLowpassResonance  : BaseObject
	{
		Hashtable h = new Hashtable();

		public PlotOptionsVectorSonificationContextTracksMappingLowpassResonance()
		{
			MapFunction = MapFunction_DefaultValue = PlotOptionsVectorSonificationContextTracksMappingLowpassResonanceMapFunction.Linear;
			MapTo = MapTo_DefaultValue = "";
			Max = Max_DefaultValue = null;
			Min = Min_DefaultValue = null;
			Value = Value_DefaultValue = null;
			Within = Within_DefaultValue = PlotOptionsVectorSonificationContextTracksMappingLowpassResonanceWithin.Chart;
		...
		/// </summary>
		public PlotOptionsVectorSonificationContextTracksMappingLowpassResonanceMapFunction MapFunction { get; set; }
		private PlotOptionsVectorSonificationContextTracksMappingLowpassResonanceMapFunction MapFunction_DefaultValue { get; set; }
		...
		/// </summary>
		public PlotOptionsVectorSonificationContextTracksMappingLowpassResonanceWithin Within { get; set; }
		private PlotOptionsVectorSonificationContextTracksMappingLowpassResonanceWithin Within_DefaultValue { get; set; }
