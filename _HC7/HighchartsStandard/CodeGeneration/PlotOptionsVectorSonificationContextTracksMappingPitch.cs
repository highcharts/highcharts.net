...
{
	public partial class PlotOptionsVectorSonificationContextTracksMappingPitch  : BaseObject
	{
		Hashtable h = new Hashtable();

		public PlotOptionsVectorSonificationContextTracksMappingPitch()
		{
			MapFunction = MapFunction_DefaultValue = PlotOptionsVectorSonificationContextTracksMappingPitchMapFunction.Linear;
		...
		/// </summary>
		public PlotOptionsVectorSonificationContextTracksMappingPitchMapFunction MapFunction { get; set; }
		private PlotOptionsVectorSonificationContextTracksMappingPitchMapFunction MapFunction_DefaultValue { get; set; }
