...
{
	public partial class PlotOptionsVectorSonificationDefaultInstrumentOptionsActiveWhen  : BaseObject
	{
		Hashtable h = new Hashtable();

		public PlotOptionsVectorSonificationDefaultInstrumentOptionsActiveWhen()
		{
