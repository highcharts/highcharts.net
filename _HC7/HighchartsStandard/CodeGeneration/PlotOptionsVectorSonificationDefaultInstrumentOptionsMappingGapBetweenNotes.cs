...
{
	public partial class PlotOptionsVectorSonificationDefaultInstrumentOptionsMappingGapBetweenNotes  : BaseObject
	{
		Hashtable h = new Hashtable();

		public PlotOptionsVectorSonificationDefaultInstrumentOptionsMappingGapBetweenNotes()
		{
			MapFunction = MapFunction_DefaultValue = PlotOptionsVectorSonificationDefaultInstrumentOptionsMappingGapBetweenNotesMapFunction.Linear;
			MapTo = MapTo_DefaultValue = "";
			Max = Max_DefaultValue = null;
			Min = Min_DefaultValue = null;
			Value = Value_DefaultValue = null;
			Within = Within_DefaultValue = PlotOptionsVectorSonificationDefaultInstrumentOptionsMappingGapBetweenNotesWithin.Chart;
		...
		/// </summary>
		public PlotOptionsVectorSonificationDefaultInstrumentOptionsMappingGapBetweenNotesMapFunction MapFunction { get; set; }
		private PlotOptionsVectorSonificationDefaultInstrumentOptionsMappingGapBetweenNotesMapFunction MapFunction_DefaultValue { get; set; }
		...
		/// </summary>
		public PlotOptionsVectorSonificationDefaultInstrumentOptionsMappingGapBetweenNotesWithin Within { get; set; }
		private PlotOptionsVectorSonificationDefaultInstrumentOptionsMappingGapBetweenNotesWithin Within_DefaultValue { get; set; }
