...
{
	public partial class PlotOptionsVectorSonificationDefaultSpeechOptionsActiveWhen  : BaseObject
	{
		Hashtable h = new Hashtable();

		public PlotOptionsVectorSonificationDefaultSpeechOptionsActiveWhen()
		{
		}	
