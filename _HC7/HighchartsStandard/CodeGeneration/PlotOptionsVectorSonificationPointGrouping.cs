...
{
	public partial class PlotOptionsVectorSonificationPointGrouping  : BaseObject
	{
		Hashtable h = new Hashtable();

		public PlotOptionsVectorSonificationPointGrouping()
		{
		...
		/// </summary>
		public PlotOptionsVectorSonificationPointGroupingAlgorithm Algorithm { get; set; }
		private PlotOptionsVectorSonificationPointGroupingAlgorithm Algorithm_DefaultValue { get; set; }
		...
		internal override Hashtable ToHashtable(Highcharts highcharts)
		{
			...
			if (Algorithm != PlotOptionsVectorSonificationPointGroupingAlgorithm.Null) h.Add("algorithm", highcharts.FirstCharacterToLower(Algorithm.ToString()));
