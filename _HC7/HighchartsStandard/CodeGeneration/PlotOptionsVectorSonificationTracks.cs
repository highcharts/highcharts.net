...
{
	public partial class PlotOptionsVectorSonificationTracks  : BaseObject
	{
		Hashtable h = new Hashtable();

		public PlotOptionsVectorSonificationTracks()
		{
			ActiveWhen = ActiveWhen_DefaultValue = new PlotOptionsVectorSonificationTracksActiveWhen();
			Instrument = Instrument_DefaultValue = null;
			InstrumentString = InstrumentString_DefaultValue = "null";
			Mapping = Mapping_DefaultValue = new PlotOptionsVectorSonificationTracksMapping();
			MidiName = MidiName_DefaultValue = "";
			PointGrouping = PointGrouping_DefaultValue = new PlotOptionsVectorSonificationTracksPointGrouping();
			RoundToMusicalNotes = RoundToMusicalNotes_DefaultValue = true;
			ShowPlayMarker = ShowPlayMarker_DefaultValue = true;
			Type = Type_DefaultValue = PlotOptionsVectorSonificationTracksType.Instrument;
		...
		/// </summary>
		public PlotOptionsVectorSonificationTracksActiveWhen ActiveWhen { get; set; }
		private PlotOptionsVectorSonificationTracksActiveWhen ActiveWhen_DefaultValue { get; set; }
		...
		/// </summary>
		public PlotOptionsVectorSonificationTracksMapping Mapping { get; set; }
		private PlotOptionsVectorSonificationTracksMapping Mapping_DefaultValue { get; set; }
		...
		/// </summary>
		public PlotOptionsVectorSonificationTracksPointGrouping PointGrouping { get; set; }
		private PlotOptionsVectorSonificationTracksPointGrouping PointGrouping_DefaultValue { get; set; }
		...
		/// </summary>
		public PlotOptionsVectorSonificationTracksType Type { get; set; }
		private PlotOptionsVectorSonificationTracksType Type_DefaultValue { get; set; }
