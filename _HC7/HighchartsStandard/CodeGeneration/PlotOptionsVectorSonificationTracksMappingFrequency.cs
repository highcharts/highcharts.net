...
{
	public partial class PlotOptionsVectorSonificationTracksMappingFrequency  : BaseObject
	{
		Hashtable h = new Hashtable();

		public PlotOptionsVectorSonificationTracksMappingFrequency()
		{
			MapFunction = MapFunction_DefaultValue = PlotOptionsVectorSonificationTracksMappingFrequencyMapFunction.Linear;
			MapTo = MapTo_DefaultValue = "";
			Max = Max_DefaultValue = null;
			Min = Min_DefaultValue = null;
			Value = Value_DefaultValue = null;
			Within = Within_DefaultValue = PlotOptionsVectorSonificationTracksMappingFrequencyWithin.Chart;
		...
		/// </summary>
		public PlotOptionsVectorSonificationTracksMappingFrequencyMapFunction MapFunction { get; set; }
		private PlotOptionsVectorSonificationTracksMappingFrequencyMapFunction MapFunction_DefaultValue { get; set; }
		...
		/// </summary>
		public PlotOptionsVectorSonificationTracksMappingFrequencyWithin Within { get; set; }
		private PlotOptionsVectorSonificationTracksMappingFrequencyWithin Within_DefaultValue { get; set; }
