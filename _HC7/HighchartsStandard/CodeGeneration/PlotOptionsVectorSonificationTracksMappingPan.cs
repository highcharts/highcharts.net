...
{
	public partial class PlotOptionsVectorSonificationTracksMappingPan  : BaseObject
	{
		Hashtable h = new Hashtable();

		public PlotOptionsVectorSonificationTracksMappingPan()
		{
			MapFunction = MapFunction_DefaultValue = PlotOptionsVectorSonificationTracksMappingPanMapFunction.Linear;
			MapTo = MapTo_DefaultValue = "";
			Max = Max_DefaultValue = null;
			Min = Min_DefaultValue = null;
			Value = Value_DefaultValue = null;
			Within = Within_DefaultValue = PlotOptionsVectorSonificationTracksMappingPanWithin.Chart;
		...
		/// </summary>
		public PlotOptionsVectorSonificationTracksMappingPanMapFunction MapFunction { get; set; }
		private PlotOptionsVectorSonificationTracksMappingPanMapFunction MapFunction_DefaultValue { get; set; }
		...
		/// </summary>
		public PlotOptionsVectorSonificationTracksMappingPanWithin Within { get; set; }
		private PlotOptionsVectorSonificationTracksMappingPanWithin Within_DefaultValue { get; set; }
