...
{
	public partial class PlotOptionsVectorSonificationTracksMappingPitch  : BaseObject
	{
		Hashtable h = new Hashtable();

		public PlotOptionsVectorSonificationTracksMappingPitch()
		{
			MapFunction = MapFunction_DefaultValue = PlotOptionsVectorSonificationTracksMappingPitchMapFunction.Linear;
		...
		/// </summary>
		public PlotOptionsVectorSonificationTracksMappingPitchMapFunction MapFunction { get; set; }
		private PlotOptionsVectorSonificationTracksMappingPitchMapFunction MapFunction_DefaultValue { get; set; }
