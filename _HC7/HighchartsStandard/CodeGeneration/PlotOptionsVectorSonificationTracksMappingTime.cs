...
{
	public partial class PlotOptionsVectorSonificationTracksMappingTime  : BaseObject
	{
		Hashtable h = new Hashtable();

		public PlotOptionsVectorSonificationTracksMappingTime()
		{
			MapFunction = MapFunction_DefaultValue = PlotOptionsVectorSonificationTracksMappingTimeMapFunction.Linear;
			MapTo = MapTo_DefaultValue = "";
			Max = Max_DefaultValue = null;
			Min = Min_DefaultValue = null;
			Value = Value_DefaultValue = null;
			Within = Within_DefaultValue = PlotOptionsVectorSonificationTracksMappingTimeWithin.Chart;
		...
		/// </summary>
		public PlotOptionsVectorSonificationTracksMappingTimeMapFunction MapFunction { get; set; }
		private PlotOptionsVectorSonificationTracksMappingTimeMapFunction MapFunction_DefaultValue { get; set; }
		...
		/// </summary>
		public PlotOptionsVectorSonificationTracksMappingTimeWithin Within { get; set; }
		private PlotOptionsVectorSonificationTracksMappingTimeWithin Within_DefaultValue { get; set; }
