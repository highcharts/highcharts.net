...
{
	public partial class PlotOptionsVectorSonificationTracksMappingVolume  : BaseObject
	{
		Hashtable h = new Hashtable();

		public PlotOptionsVectorSonificationTracksMappingVolume()
		{
			MapFunction = MapFunction_DefaultValue = PlotOptionsVectorSonificationTracksMappingVolumeMapFunction.Linear;
			MapTo = MapTo_DefaultValue = "";
			Max = Max_DefaultValue = null;
			Min = Min_DefaultValue = null;
			Value = Value_DefaultValue = null;
			Within = Within_DefaultValue = PlotOptionsVectorSonificationTracksMappingVolumeWithin.Chart;
		...
		/// </summary>
		public PlotOptionsVectorSonificationTracksMappingVolumeMapFunction MapFunction { get; set; }
		private PlotOptionsVectorSonificationTracksMappingVolumeMapFunction MapFunction_DefaultValue { get; set; }
		...
		/// </summary>
		public PlotOptionsVectorSonificationTracksMappingVolumeWithin Within { get; set; }
		private PlotOptionsVectorSonificationTracksMappingVolumeWithin Within_DefaultValue { get; set; }
