...
{
	public partial class PlotOptionsVectorSonificationTracksPointGrouping  : BaseObject
	{
		Hashtable h = new Hashtable();

		public PlotOptionsVectorSonificationTracksPointGrouping()
		{
		...
		/// </summary>
		public PlotOptionsVectorSonificationTracksPointGroupingAlgorithm Algorithm { get; set; }
		private PlotOptionsVectorSonificationTracksPointGroupingAlgorithm Algorithm_DefaultValue { get; set; }
		...
		internal override Hashtable ToHashtable(Highcharts highcharts)
		{
			...
			if (Algorithm != PlotOptionsVectorSonificationTracksPointGroupingAlgorithm.Null) h.Add("algorithm", highcharts.FirstCharacterToLower(Algorithm.ToString()));
