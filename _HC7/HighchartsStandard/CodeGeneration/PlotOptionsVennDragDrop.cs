...
{
	public partial class PlotOptionsVennDragDrop  : BaseObject
	{
		public PlotOptionsVennDragDrop()
		{
			DraggableX = DraggableX_DefaultValue = null;
			DraggableY = DraggableY_DefaultValue = null;
			DragHandle = DragHandle_DefaultValue = new PlotOptionsVennDragDropDragHandle();
			...
			GuideBox = GuideBox_DefaultValue = new PlotOptionsVennDragDropGuideBox();
		...
		/// </summary>
		public PlotOptionsVennDragDropDragHandle DragHandle { get; set; }
		private PlotOptionsVennDragDropDragHandle DragHandle_DefaultValue { get; set; }
		...
		/// </summary>
		public PlotOptionsVennDragDropGuideBox GuideBox { get; set; }
		private PlotOptionsVennDragDropGuideBox GuideBox_DefaultValue { get; set; }
