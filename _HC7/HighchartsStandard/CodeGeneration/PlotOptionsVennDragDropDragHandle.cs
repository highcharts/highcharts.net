...
{
	public partial class PlotOptionsVennDragDropDragHandle  : BaseObject
	{
		public PlotOptionsVennDragDropDragHandle()
		{
		...
		internal override Hashtable ToHashtable()
		{
			...
			if (PathFormatter != PathFormatter_DefaultValue) { h.Add("pathFormatter",PathFormatter); Highcharts.AddFunction("PlotOptionsVennDragDropDragHandlePathFormatter.pathFormatter", PathFormatter); }  
