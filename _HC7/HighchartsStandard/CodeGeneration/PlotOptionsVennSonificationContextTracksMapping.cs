...
{
	public partial class PlotOptionsVennSonificationContextTracksMapping  : BaseObject
	{
		Hashtable h = new Hashtable();

		public PlotOptionsVennSonificationContextTracksMapping()
		{
			Frequency = Frequency_DefaultValue = new PlotOptionsVennSonificationContextTracksMappingFrequency();
			GapBetweenNotes = GapBetweenNotes_DefaultValue = new PlotOptionsVennSonificationContextTracksMappingGapBetweenNotes();
			Highpass = Highpass_DefaultValue = new PlotOptionsVennSonificationContextTracksMappingHighpass();
			Lowpass = Lowpass_DefaultValue = new PlotOptionsVennSonificationContextTracksMappingLowpass();
			NoteDuration = NoteDuration_DefaultValue = new PlotOptionsVennSonificationContextTracksMappingNoteDuration();
			Pan = Pan_DefaultValue = new PlotOptionsVennSonificationContextTracksMappingPan();
			Pitch = Pitch_DefaultValue = new PlotOptionsVennSonificationContextTracksMappingPitch();
			PitchString = PitchString_DefaultValue = "null";
			PitchNumber = PitchNumber_DefaultValue = null;
			PlayDelay = PlayDelay_DefaultValue = new PlotOptionsVennSonificationContextTracksMappingPlayDelay();
			Time = Time_DefaultValue = new PlotOptionsVennSonificationContextTracksMappingTime();
			TimeString = TimeString_DefaultValue = "null";
			TimeNumber = TimeNumber_DefaultValue = null;
			Tremolo = Tremolo_DefaultValue = new PlotOptionsVennSonificationContextTracksMappingTremolo();
			Volume = Volume_DefaultValue = new PlotOptionsVennSonificationContextTracksMappingVolume();
		...
		/// </summary>
		public PlotOptionsVennSonificationContextTracksMappingFrequency Frequency { get; set; }
		private PlotOptionsVennSonificationContextTracksMappingFrequency Frequency_DefaultValue { get; set; }
		...
		/// </summary>
		public PlotOptionsVennSonificationContextTracksMappingGapBetweenNotes GapBetweenNotes { get; set; }
		private PlotOptionsVennSonificationContextTracksMappingGapBetweenNotes GapBetweenNotes_DefaultValue { get; set; }
		...
		/// </summary>
		public PlotOptionsVennSonificationContextTracksMappingHighpass Highpass { get; set; }
		private PlotOptionsVennSonificationContextTracksMappingHighpass Highpass_DefaultValue { get; set; }
		...
		/// </summary>
		public PlotOptionsVennSonificationContextTracksMappingLowpass Lowpass { get; set; }
		private PlotOptionsVennSonificationContextTracksMappingLowpass Lowpass_DefaultValue { get; set; }
		...
		/// </summary>
		public PlotOptionsVennSonificationContextTracksMappingNoteDuration NoteDuration { get; set; }
		private PlotOptionsVennSonificationContextTracksMappingNoteDuration NoteDuration_DefaultValue { get; set; }
		...
		/// </summary>
		public PlotOptionsVennSonificationContextTracksMappingPan Pan { get; set; }
		private PlotOptionsVennSonificationContextTracksMappingPan Pan_DefaultValue { get; set; }
		...
		/// </summary>
		public PlotOptionsVennSonificationContextTracksMappingPitch Pitch { get; set; }
		private PlotOptionsVennSonificationContextTracksMappingPitch Pitch_DefaultValue { get; set; }
		...
		/// </summary>
		public PlotOptionsVennSonificationContextTracksMappingPlayDelay PlayDelay { get; set; }
		private PlotOptionsVennSonificationContextTracksMappingPlayDelay PlayDelay_DefaultValue { get; set; }
		...
		/// </summary>
		public PlotOptionsVennSonificationContextTracksMappingTime Time { get; set; }
		private PlotOptionsVennSonificationContextTracksMappingTime Time_DefaultValue { get; set; }
		...
		/// </summary>
		public PlotOptionsVennSonificationContextTracksMappingTremolo Tremolo { get; set; }
		private PlotOptionsVennSonificationContextTracksMappingTremolo Tremolo_DefaultValue { get; set; }
		 

		/// <summary>
		/// The volume of notes, from 0 to 1.
		/// </summary>
		public PlotOptionsVennSonificationContextTracksMappingVolume Volume { get; set; }
		private PlotOptionsVennSonificationContextTracksMappingVolume Volume_DefaultValue { get; set; }
