...
{
	public partial class PlotOptionsVennSonificationContextTracksMappingFrequency  : BaseObject
	{
		Hashtable h = new Hashtable();

		public PlotOptionsVennSonificationContextTracksMappingFrequency()
		{
			MapFunction = MapFunction_DefaultValue = PlotOptionsVennSonificationContextTracksMappingFrequencyMapFunction.Linear;
			MapTo = MapTo_DefaultValue = "";
			Max = Max_DefaultValue = null;
			Min = Min_DefaultValue = null;
			Value = Value_DefaultValue = null;
			Within = Within_DefaultValue = PlotOptionsVennSonificationContextTracksMappingFrequencyWithin.Chart;
		...
		/// </summary>
		public PlotOptionsVennSonificationContextTracksMappingFrequencyMapFunction MapFunction { get; set; }
		private PlotOptionsVennSonificationContextTracksMappingFrequencyMapFunction MapFunction_DefaultValue { get; set; }
		...
		/// </summary>
		public PlotOptionsVennSonificationContextTracksMappingFrequencyWithin Within { get; set; }
		private PlotOptionsVennSonificationContextTracksMappingFrequencyWithin Within_DefaultValue { get; set; }
