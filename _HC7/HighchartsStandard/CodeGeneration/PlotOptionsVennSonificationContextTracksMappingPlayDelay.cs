...
{
	public partial class PlotOptionsVennSonificationContextTracksMappingPlayDelay  : BaseObject
	{
		Hashtable h = new Hashtable();

		public PlotOptionsVennSonificationContextTracksMappingPlayDelay()
		{
			MapFunction = MapFunction_DefaultValue = PlotOptionsVennSonificationContextTracksMappingPlayDelayMapFunction.Linear;
			MapTo = MapTo_DefaultValue = "";
			Max = Max_DefaultValue = null;
			Min = Min_DefaultValue = null;
			Value = Value_DefaultValue = null;
			Within = Within_DefaultValue = PlotOptionsVennSonificationContextTracksMappingPlayDelayWithin.Chart;
		...
		/// </summary>
		public PlotOptionsVennSonificationContextTracksMappingPlayDelayMapFunction MapFunction { get; set; }
		private PlotOptionsVennSonificationContextTracksMappingPlayDelayMapFunction MapFunction_DefaultValue { get; set; }
		...
		/// </summary>
		public PlotOptionsVennSonificationContextTracksMappingPlayDelayWithin Within { get; set; }
		private PlotOptionsVennSonificationContextTracksMappingPlayDelayWithin Within_DefaultValue { get; set; }
