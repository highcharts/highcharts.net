...
{
	public partial class PlotOptionsVennSonificationDefaultInstrumentOptionsActiveWhen  : BaseObject
	{
		Hashtable h = new Hashtable();

		public PlotOptionsVennSonificationDefaultInstrumentOptionsActiveWhen()
		{
