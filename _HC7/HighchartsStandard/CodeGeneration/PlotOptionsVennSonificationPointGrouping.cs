...
{
	public partial class PlotOptionsVennSonificationPointGrouping  : BaseObject
	{
		Hashtable h = new Hashtable();

		public PlotOptionsVennSonificationPointGrouping()
		{
		...
		/// </summary>
		public PlotOptionsVennSonificationPointGroupingAlgorithm Algorithm { get; set; }
		private PlotOptionsVennSonificationPointGroupingAlgorithm Algorithm_DefaultValue { get; set; }
		...
		internal override Hashtable ToHashtable(Highcharts highcharts)
		{
			...
			if (Algorithm != PlotOptionsVennSonificationPointGroupingAlgorithm.Null) h.Add("algorithm", highcharts.FirstCharacterToLower(Algorithm.ToString()));
