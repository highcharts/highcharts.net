...
{
	public partial class PlotOptionsVennSonificationTracks  : BaseObject
	{
		Hashtable h = new Hashtable();

		public PlotOptionsVennSonificationTracks()
		{
			ActiveWhen = ActiveWhen_DefaultValue = new PlotOptionsVennSonificationTracksActiveWhen();
			Instrument = Instrument_DefaultValue = null;
			InstrumentString = InstrumentString_DefaultValue = "null";
			Mapping = Mapping_DefaultValue = new PlotOptionsVennSonificationTracksMapping();
			MidiName = MidiName_DefaultValue = "";
			PointGrouping = PointGrouping_DefaultValue = new PlotOptionsVennSonificationTracksPointGrouping();
			RoundToMusicalNotes = RoundToMusicalNotes_DefaultValue = true;
			ShowPlayMarker = ShowPlayMarker_DefaultValue = true;
			Type = Type_DefaultValue = PlotOptionsVennSonificationTracksType.Instrument;
		...
		/// </summary>
		public PlotOptionsVennSonificationTracksActiveWhen ActiveWhen { get; set; }
		private PlotOptionsVennSonificationTracksActiveWhen ActiveWhen_DefaultValue { get; set; }
		...
		/// </summary>
		public PlotOptionsVennSonificationTracksMapping Mapping { get; set; }
		private PlotOptionsVennSonificationTracksMapping Mapping_DefaultValue { get; set; }
		...
		/// </summary>
		public PlotOptionsVennSonificationTracksPointGrouping PointGrouping { get; set; }
		private PlotOptionsVennSonificationTracksPointGrouping PointGrouping_DefaultValue { get; set; }
		...
		/// </summary>
		public PlotOptionsVennSonificationTracksType Type { get; set; }
		private PlotOptionsVennSonificationTracksType Type_DefaultValue { get; set; }
