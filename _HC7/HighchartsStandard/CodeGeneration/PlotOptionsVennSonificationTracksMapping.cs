...
namespace Highsoft.Web.Mvc.Charts
{
	public partial class PlotOptionsVennSonificationTracksMapping  : BaseObject
	{
		...
		{
			Frequency = Frequency_DefaultValue = new PlotOptionsVennSonificationTracksMappingFrequency();
			GapBetweenNotes = GapBetweenNotes_DefaultValue = new PlotOptionsVennSonificationTracksMappingGapBetweenNotes();
			Highpass = Highpass_DefaultValue = new PlotOptionsVennSonificationTracksMappingHighpass();
			Lowpass = Lowpass_DefaultValue = new PlotOptionsVennSonificationTracksMappingLowpass();
			NoteDuration = NoteDuration_DefaultValue = new PlotOptionsVennSonificationTracksMappingNoteDuration();
			Pan = Pan_DefaultValue = new PlotOptionsVennSonificationTracksMappingPan();
			Pitch = Pitch_DefaultValue = new PlotOptionsVennSonificationTracksMappingPitch();
			PitchString = PitchString_DefaultValue = "null";
			PitchNumber = PitchNumber_DefaultValue = null;
			PlayDelay = PlayDelay_DefaultValue = new PlotOptionsVennSonificationTracksMappingPlayDelay();
			Time = Time_DefaultValue = new PlotOptionsVennSonificationTracksMappingTime();
			TimeString = TimeString_DefaultValue = "null";
			TimeNumber = TimeNumber_DefaultValue = null;
			Tremolo = Tremolo_DefaultValue = new PlotOptionsVennSonificationTracksMappingTremolo();
			Volume = Volume_DefaultValue = new PlotOptionsVennSonificationTracksMappingVolume();
		...
		private PlotOptionsVennSonificationTracksMappingFrequency Frequency_DefaultValue { get; set; }
		...
		private PlotOptionsVennSonificationTracksMappingGapBetweenNotes GapBetweenNotes_DefaultValue { get; set; }
		...
		private PlotOptionsVennSonificationTracksMappingHighpass Highpass_DefaultValue { get; set; }
		...
		private PlotOptionsVennSonificationTracksMappingLowpass Lowpass_DefaultValue { get; set; }
		...
		private PlotOptionsVennSonificationTracksMappingNoteDuration NoteDuration_DefaultValue { get; set; }
		...
		private PlotOptionsVennSonificationTracksMappingPan Pan_DefaultValue { get; set; }
		...
		private PlotOptionsVennSonificationTracksMappingPitch Pitch_DefaultValue { get; set; }
		...
		private PlotOptionsVennSonificationTracksMappingPlayDelay PlayDelay_DefaultValue { get; set; }
		...
		private PlotOptionsVennSonificationTracksMappingTime Time_DefaultValue { get; set; }
		...
		private PlotOptionsVennSonificationTracksMappingTremolo Tremolo_DefaultValue { get; set; }
		...
		private PlotOptionsVennSonificationTracksMappingVolume Volume_DefaultValue { get; set; }
