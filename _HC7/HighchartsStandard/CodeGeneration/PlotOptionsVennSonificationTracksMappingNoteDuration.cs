...
{
	public partial class PlotOptionsVennSonificationTracksMappingNoteDuration  : BaseObject
	{
		Hashtable h = new Hashtable();

		public PlotOptionsVennSonificationTracksMappingNoteDuration()
		{
			MapFunction = MapFunction_DefaultValue = PlotOptionsVennSonificationTracksMappingNoteDurationMapFunction.Linear;
			MapTo = MapTo_DefaultValue = "";
			Max = Max_DefaultValue = null;
			Min = Min_DefaultValue = null;
			Value = Value_DefaultValue = null;
			Within = Within_DefaultValue = PlotOptionsVennSonificationTracksMappingNoteDurationWithin.Chart;
		...
		/// </summary>
		public PlotOptionsVennSonificationTracksMappingNoteDurationMapFunction MapFunction { get; set; }
		private PlotOptionsVennSonificationTracksMappingNoteDurationMapFunction MapFunction_DefaultValue { get; set; }
		...
		/// </summary>
		public PlotOptionsVennSonificationTracksMappingNoteDurationWithin Within { get; set; }
		private PlotOptionsVennSonificationTracksMappingNoteDurationWithin Within_DefaultValue { get; set; }
