...
{
	public partial class PlotOptionsVennSonificationTracksMappingPan  : BaseObject
	{
		Hashtable h = new Hashtable();

		public PlotOptionsVennSonificationTracksMappingPan()
		{
			MapFunction = MapFunction_DefaultValue = PlotOptionsVennSonificationTracksMappingPanMapFunction.Linear;
			MapTo = MapTo_DefaultValue = "";
			Max = Max_DefaultValue = null;
			Min = Min_DefaultValue = null;
			Value = Value_DefaultValue = null;
			Within = Within_DefaultValue = PlotOptionsVennSonificationTracksMappingPanWithin.Chart;
		...
		/// </summary>
		public PlotOptionsVennSonificationTracksMappingPanMapFunction MapFunction { get; set; }
		private PlotOptionsVennSonificationTracksMappingPanMapFunction MapFunction_DefaultValue { get; set; }
		...
		/// </summary>
		public PlotOptionsVennSonificationTracksMappingPanWithin Within { get; set; }
		private PlotOptionsVennSonificationTracksMappingPanWithin Within_DefaultValue { get; set; }
