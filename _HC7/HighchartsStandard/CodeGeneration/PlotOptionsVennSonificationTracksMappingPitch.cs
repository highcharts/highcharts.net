...
{
	public partial class PlotOptionsVennSonificationTracksMappingPitch  : BaseObject
	{
		Hashtable h = new Hashtable();

		public PlotOptionsVennSonificationTracksMappingPitch()
		{
			MapFunction = MapFunction_DefaultValue = PlotOptionsVennSonificationTracksMappingPitchMapFunction.Linear;
		...
		/// </summary>
		public PlotOptionsVennSonificationTracksMappingPitchMapFunction MapFunction { get; set; }
		private PlotOptionsVennSonificationTracksMappingPitchMapFunction MapFunction_DefaultValue { get; set; }
