...
{
	public partial class PlotOptionsVennSonificationTracksMappingTime  : BaseObject
	{
		Hashtable h = new Hashtable();

		public PlotOptionsVennSonificationTracksMappingTime()
		{
			MapFunction = MapFunction_DefaultValue = PlotOptionsVennSonificationTracksMappingTimeMapFunction.Linear;
			MapTo = MapTo_DefaultValue = "";
			Max = Max_DefaultValue = null;
			Min = Min_DefaultValue = null;
			Value = Value_DefaultValue = null;
			Within = Within_DefaultValue = PlotOptionsVennSonificationTracksMappingTimeWithin.Chart;
		...
		/// </summary>
		public PlotOptionsVennSonificationTracksMappingTimeMapFunction MapFunction { get; set; }
		private PlotOptionsVennSonificationTracksMappingTimeMapFunction MapFunction_DefaultValue { get; set; }
		...
		/// </summary>
		public PlotOptionsVennSonificationTracksMappingTimeWithin Within { get; set; }
		private PlotOptionsVennSonificationTracksMappingTimeWithin Within_DefaultValue { get; set; }
