...
{
	public partial class PlotOptionsVennSonificationTracksMappingVolume  : BaseObject
	{
		Hashtable h = new Hashtable();

		public PlotOptionsVennSonificationTracksMappingVolume()
		{
			MapFunction = MapFunction_DefaultValue = PlotOptionsVennSonificationTracksMappingVolumeMapFunction.Linear;
			MapTo = MapTo_DefaultValue = "";
			Max = Max_DefaultValue = null;
			Min = Min_DefaultValue = null;
			Value = Value_DefaultValue = null;
			Within = Within_DefaultValue = PlotOptionsVennSonificationTracksMappingVolumeWithin.Chart;
		...
		/// </summary>
		public PlotOptionsVennSonificationTracksMappingVolumeMapFunction MapFunction { get; set; }
		private PlotOptionsVennSonificationTracksMappingVolumeMapFunction MapFunction_DefaultValue { get; set; }
		...
		/// </summary>
		public PlotOptionsVennSonificationTracksMappingVolumeWithin Within { get; set; }
		private PlotOptionsVennSonificationTracksMappingVolumeWithin Within_DefaultValue { get; set; }
