...
{
	public partial class PlotOptionsVennSonificationTracksPointGrouping  : BaseObject
	{
		Hashtable h = new Hashtable();

		public PlotOptionsVennSonificationTracksPointGrouping()
		{
		...
		/// </summary>
		public PlotOptionsVennSonificationTracksPointGroupingAlgorithm Algorithm { get; set; }
		private PlotOptionsVennSonificationTracksPointGroupingAlgorithm Algorithm_DefaultValue { get; set; }
		...
		internal override Hashtable ToHashtable(Highcharts highcharts)
		{
			...
			if (Algorithm != PlotOptionsVennSonificationTracksPointGroupingAlgorithm.Null) h.Add("algorithm", highcharts.FirstCharacterToLower(Algorithm.ToString()));
