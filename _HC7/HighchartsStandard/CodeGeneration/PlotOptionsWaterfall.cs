...
namespace Highsoft.Web.Mvc.Charts
{
	public partial class PlotOptionsWaterfall  : BaseObject
	{
		...
		internal override Hashtable ToHashtable()
		{
			...
			if (PointDescriptionFormatter != PointDescriptionFormatter_DefaultValue) { h.Add("pointDescriptionFormatter",PointDescriptionFormatter); Highcharts.AddFunction("0e9d93f3-8f98-4fe0-80f7-6a87623c17c0.pointDescriptionFormatter", PointDescriptionFormatter); }  
