...
namespace Highsoft.Web.Mvc.Charts
{
	public partial class PlotOptionsWaterfall  : BaseObject
	{
		...
		/// </summary>
		public PlotOptionsWaterfallAccessibility Accessibility { get; set; }
		private PlotOptionsWaterfallAccessibility Accessibility_DefaultValue { get; set; }
		...
		/// </summary>
		public PlotOptionsWaterfallDataSorting DataSorting { get; set; }
		private PlotOptionsWaterfallDataSorting DataSorting_DefaultValue { get; set; }
		...
		/// </summary>
		public PlotOptionsWaterfallDragDrop DragDrop { get; set; }
		private PlotOptionsWaterfallDragDrop DragDrop_DefaultValue { get; set; }
		...
		/// </summary>
		public PlotOptionsWaterfallFindNearestPointBy FindNearestPointBy { get; set; }
		private PlotOptionsWaterfallFindNearestPointBy FindNearestPointBy_DefaultValue { get; set; }
		...
		/// </summary>
		public PlotOptionsWaterfallLabel Label { get; set; }
		private PlotOptionsWaterfallLabel Label_DefaultValue { get; set; }
		 

		/// <summary>
		/// What type of legend symbol to render for this series. Can be one of`areaMarker`, `lineMarker` or `rectangle`.
		/// </summary>
		public PlotOptionsWaterfallLegendSymbol LegendSymbol { get; set; }
		private PlotOptionsWaterfallLegendSymbol LegendSymbol_DefaultValue { get; set; }
		...
		/// </summary>
		public PlotOptionsWaterfallOnPoint OnPoint { get; set; }
		private PlotOptionsWaterfallOnPoint OnPoint_DefaultValue { get; set; }
		...
		/// </summary>
		public PlotOptionsWaterfallSonification Sonification { get; set; }
		private PlotOptionsWaterfallSonification Sonification_DefaultValue { get; set; }
		...
		/// </summary>
		public PlotOptionsWaterfallStacking Stacking { get; set; }
		private PlotOptionsWaterfallStacking Stacking_DefaultValue { get; set; }
		...
		internal override Hashtable ToHashtable(Highcharts highcharts)
		{
			...
			if (Cursor != PlotOptionsWaterfallCursor.Null) h.Add("cursor", highcharts.FirstCharacterToLower(Cursor.ToString()));
			if (Custom != null) h.Add("custom",Custom);
			if (DashStyle != PlotOptionsWaterfallDashStyle.Null) h.Add("dashStyle", highcharts.FirstCharacterToLower(DashStyle.ToString()));
			...
			if (FindNearestPointBy != PlotOptionsWaterfallFindNearestPointBy.Null) h.Add("findNearestPointBy", highcharts.FirstCharacterToLower(FindNearestPointBy.ToString()));
			...
			if (LegendSymbol != PlotOptionsWaterfallLegendSymbol.Null) h.Add("legendSymbol", highcharts.FirstCharacterToLower(LegendSymbol.ToString()));
			...
			if (PointIntervalUnit != PlotOptionsWaterfallPointIntervalUnit.Null) h.Add("pointIntervalUnit", highcharts.FirstCharacterToLower(PointIntervalUnit.ToString()));
			if (PointPadding != null) h.Add("pointPadding",PointPadding);
			if (PointPlacement != PlotOptionsWaterfallPointPlacement.Null) h.Add("pointPlacement", highcharts.FirstCharacterToLower(PointPlacement.ToString()));
			...
			if (Stacking != PlotOptionsWaterfallStacking.Null) h.Add("stacking", highcharts.FirstCharacterToLower(Stacking.ToString()));
