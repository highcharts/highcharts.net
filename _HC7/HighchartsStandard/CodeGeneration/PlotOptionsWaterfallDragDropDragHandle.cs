...
{
	public partial class PlotOptionsWaterfallDragDropDragHandle  : BaseObject
	{
		public PlotOptionsWaterfallDragDropDragHandle()
		{
		...
		internal override Hashtable ToHashtable()
		{
			...
			if (PathFormatter != PathFormatter_DefaultValue) { h.Add("pathFormatter",PathFormatter); Highcharts.AddFunction("PlotOptionsWaterfallDragDropDragHandlePathFormatter.pathFormatter", PathFormatter); }  
