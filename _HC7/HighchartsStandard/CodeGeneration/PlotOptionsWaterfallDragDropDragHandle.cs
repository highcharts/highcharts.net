...
namespace Highsoft.Web.Mvc.Charts
{
	public partial class PlotOptionsWaterfallDragDropDragHandle  : BaseObject
	{
		...
		internal override Hashtable ToHashtable()
		{
			...
			if (PathFormatter != PathFormatter_DefaultValue) { h.Add("pathFormatter",PathFormatter); Highcharts.AddFunction("86ceb7ff-6ff9-490e-8e99-21dc52479d8e.pathFormatter", PathFormatter); }  
