...
namespace Highsoft.Web.Mvc.Charts
{
	public partial class PlotOptionsWaterfallSonification  : BaseObject
	{
		...
		{
			ContextTracks = ContextTracks_DefaultValue = new PlotOptionsWaterfallSonificationContextTracks();
			DefaultInstrumentOptions = DefaultInstrumentOptions_DefaultValue = new PlotOptionsWaterfallSonificationDefaultInstrumentOptions();
			DefaultSpeechOptions = DefaultSpeechOptions_DefaultValue = new PlotOptionsWaterfallSonificationDefaultSpeechOptions();
			Enabled = Enabled_DefaultValue = true;
			PointGrouping = PointGrouping_DefaultValue = new PlotOptionsWaterfallSonificationPointGrouping();
			Tracks = Tracks_DefaultValue = new PlotOptionsWaterfallSonificationTracks();
		...
		private PlotOptionsWaterfallSonificationContextTracks ContextTracks_DefaultValue { get; set; }
		...
		private PlotOptionsWaterfallSonificationDefaultInstrumentOptions DefaultInstrumentOptions_DefaultValue { get; set; }
		...
		private PlotOptionsWaterfallSonificationDefaultSpeechOptions DefaultSpeechOptions_DefaultValue { get; set; }
		...
		private PlotOptionsWaterfallSonificationPointGrouping PointGrouping_DefaultValue { get; set; }
		...
		private PlotOptionsWaterfallSonificationTracks Tracks_DefaultValue { get; set; }
