...
{
	public partial class PlotOptionsWaterfallSonificationContextTracks  : BaseObject
	{
		Hashtable h = new Hashtable();

		public PlotOptionsWaterfallSonificationContextTracks()
		{
			ActiveWhen = ActiveWhen_DefaultValue = new PlotOptionsWaterfallSonificationContextTracksActiveWhen();
			Instrument = Instrument_DefaultValue = null;
			InstrumentString = InstrumentString_DefaultValue = "null";
			Mapping = Mapping_DefaultValue = new PlotOptionsWaterfallSonificationContextTracksMapping();
			MidiName = MidiName_DefaultValue = "";
			PointGrouping = PointGrouping_DefaultValue = new PlotOptionsWaterfallSonificationContextTracksPointGrouping();
			...
			Type = Type_DefaultValue = PlotOptionsWaterfallSonificationContextTracksType.Instrument;
			ValueInterval = ValueInterval_DefaultValue = null;
			ValueMapFunction = ValueMapFunction_DefaultValue = PlotOptionsWaterfallSonificationContextTracksValueMapFunction.Linear;
		...
		/// </summary>
		public PlotOptionsWaterfallSonificationContextTracksActiveWhen ActiveWhen { get; set; }
		private PlotOptionsWaterfallSonificationContextTracksActiveWhen ActiveWhen_DefaultValue { get; set; }
		...
		/// </summary>
		public PlotOptionsWaterfallSonificationContextTracksMapping Mapping { get; set; }
		private PlotOptionsWaterfallSonificationContextTracksMapping Mapping_DefaultValue { get; set; }
		...
		/// </summary>
		public PlotOptionsWaterfallSonificationContextTracksPointGrouping PointGrouping { get; set; }
		private PlotOptionsWaterfallSonificationContextTracksPointGrouping PointGrouping_DefaultValue { get; set; }
		...
		/// </summary>
		public PlotOptionsWaterfallSonificationContextTracksType Type { get; set; }
		private PlotOptionsWaterfallSonificationContextTracksType Type_DefaultValue { get; set; }
		...
		/// </summary>
		public PlotOptionsWaterfallSonificationContextTracksValueMapFunction ValueMapFunction { get; set; }
		private PlotOptionsWaterfallSonificationContextTracksValueMapFunction ValueMapFunction_DefaultValue { get; set; }
