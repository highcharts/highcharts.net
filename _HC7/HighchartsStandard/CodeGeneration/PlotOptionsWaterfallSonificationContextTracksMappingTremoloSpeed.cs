...
{
	public partial class PlotOptionsWaterfallSonificationContextTracksMappingTremoloSpeed  : BaseObject
	{
		Hashtable h = new Hashtable();

		public PlotOptionsWaterfallSonificationContextTracksMappingTremoloSpeed()
		{
			MapFunction = MapFunction_DefaultValue = PlotOptionsWaterfallSonificationContextTracksMappingTremoloSpeedMapFunction.Linear;
			MapTo = MapTo_DefaultValue = "";
			Max = Max_DefaultValue = null;
			Min = Min_DefaultValue = null;
			Value = Value_DefaultValue = null;
			Within = Within_DefaultValue = PlotOptionsWaterfallSonificationContextTracksMappingTremoloSpeedWithin.Chart;
		...
		/// </summary>
		public PlotOptionsWaterfallSonificationContextTracksMappingTremoloSpeedMapFunction MapFunction { get; set; }
		private PlotOptionsWaterfallSonificationContextTracksMappingTremoloSpeedMapFunction MapFunction_DefaultValue { get; set; }
		...
		/// </summary>
		public PlotOptionsWaterfallSonificationContextTracksMappingTremoloSpeedWithin Within { get; set; }
		private PlotOptionsWaterfallSonificationContextTracksMappingTremoloSpeedWithin Within_DefaultValue { get; set; }
