...
{
	public partial class PlotOptionsWaterfallSonificationContextTracksMappingVolume  : BaseObject
	{
		Hashtable h = new Hashtable();

		public PlotOptionsWaterfallSonificationContextTracksMappingVolume()
		{
			MapFunction = MapFunction_DefaultValue = PlotOptionsWaterfallSonificationContextTracksMappingVolumeMapFunction.Linear;
			MapTo = MapTo_DefaultValue = "";
			Max = Max_DefaultValue = null;
			Min = Min_DefaultValue = null;
			Value = Value_DefaultValue = null;
			Within = Within_DefaultValue = PlotOptionsWaterfallSonificationContextTracksMappingVolumeWithin.Chart;
		...
		/// </summary>
		public PlotOptionsWaterfallSonificationContextTracksMappingVolumeMapFunction MapFunction { get; set; }
		private PlotOptionsWaterfallSonificationContextTracksMappingVolumeMapFunction MapFunction_DefaultValue { get; set; }
		...
		/// </summary>
		public PlotOptionsWaterfallSonificationContextTracksMappingVolumeWithin Within { get; set; }
		private PlotOptionsWaterfallSonificationContextTracksMappingVolumeWithin Within_DefaultValue { get; set; }
