...
{
	public partial class PlotOptionsWaterfallSonificationDefaultInstrumentOptionsMappingNoteDuration  : BaseObject
	{
		Hashtable h = new Hashtable();

		public PlotOptionsWaterfallSonificationDefaultInstrumentOptionsMappingNoteDuration()
		{
			MapFunction = MapFunction_DefaultValue = PlotOptionsWaterfallSonificationDefaultInstrumentOptionsMappingNoteDurationMapFunction.Linear;
			MapTo = MapTo_DefaultValue = "";
			Max = Max_DefaultValue = null;
			Min = Min_DefaultValue = null;
			Value = Value_DefaultValue = null;
			Within = Within_DefaultValue = PlotOptionsWaterfallSonificationDefaultInstrumentOptionsMappingNoteDurationWithin.Chart;
		...
		/// </summary>
		public PlotOptionsWaterfallSonificationDefaultInstrumentOptionsMappingNoteDurationMapFunction MapFunction { get; set; }
		private PlotOptionsWaterfallSonificationDefaultInstrumentOptionsMappingNoteDurationMapFunction MapFunction_DefaultValue { get; set; }
		...
		/// </summary>
		public PlotOptionsWaterfallSonificationDefaultInstrumentOptionsMappingNoteDurationWithin Within { get; set; }
		private PlotOptionsWaterfallSonificationDefaultInstrumentOptionsMappingNoteDurationWithin Within_DefaultValue { get; set; }
