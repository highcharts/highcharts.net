...
{
	public partial class PlotOptionsWaterfallSonificationPointGrouping  : BaseObject
	{
		Hashtable h = new Hashtable();

		public PlotOptionsWaterfallSonificationPointGrouping()
		{
		...
		/// </summary>
		public PlotOptionsWaterfallSonificationPointGroupingAlgorithm Algorithm { get; set; }
		private PlotOptionsWaterfallSonificationPointGroupingAlgorithm Algorithm_DefaultValue { get; set; }
		...
		internal override Hashtable ToHashtable(Highcharts highcharts)
		{
			...
			if (Algorithm != PlotOptionsWaterfallSonificationPointGroupingAlgorithm.Null) h.Add("algorithm", highcharts.FirstCharacterToLower(Algorithm.ToString()));
