...
{
	public partial class PlotOptionsWaterfallSonificationTracksMapping  : BaseObject
	{
		Hashtable h = new Hashtable();

		public PlotOptionsWaterfallSonificationTracksMapping()
		{
			Frequency = Frequency_DefaultValue = new PlotOptionsWaterfallSonificationTracksMappingFrequency();
			GapBetweenNotes = GapBetweenNotes_DefaultValue = new PlotOptionsWaterfallSonificationTracksMappingGapBetweenNotes();
			Highpass = Highpass_DefaultValue = new PlotOptionsWaterfallSonificationTracksMappingHighpass();
			Lowpass = Lowpass_DefaultValue = new PlotOptionsWaterfallSonificationTracksMappingLowpass();
			NoteDuration = NoteDuration_DefaultValue = new PlotOptionsWaterfallSonificationTracksMappingNoteDuration();
			Pan = Pan_DefaultValue = new PlotOptionsWaterfallSonificationTracksMappingPan();
			Pitch = Pitch_DefaultValue = new PlotOptionsWaterfallSonificationTracksMappingPitch();
			PitchString = PitchString_DefaultValue = "null";
			PitchNumber = PitchNumber_DefaultValue = null;
			PlayDelay = PlayDelay_DefaultValue = new PlotOptionsWaterfallSonificationTracksMappingPlayDelay();
			Time = Time_DefaultValue = new PlotOptionsWaterfallSonificationTracksMappingTime();
			TimeString = TimeString_DefaultValue = "null";
			TimeNumber = TimeNumber_DefaultValue = null;
			Tremolo = Tremolo_DefaultValue = new PlotOptionsWaterfallSonificationTracksMappingTremolo();
			Volume = Volume_DefaultValue = new PlotOptionsWaterfallSonificationTracksMappingVolume();
		...
		/// </summary>
		public PlotOptionsWaterfallSonificationTracksMappingFrequency Frequency { get; set; }
		private PlotOptionsWaterfallSonificationTracksMappingFrequency Frequency_DefaultValue { get; set; }
		...
		/// </summary>
		public PlotOptionsWaterfallSonificationTracksMappingGapBetweenNotes GapBetweenNotes { get; set; }
		private PlotOptionsWaterfallSonificationTracksMappingGapBetweenNotes GapBetweenNotes_DefaultValue { get; set; }
		...
		/// </summary>
		public PlotOptionsWaterfallSonificationTracksMappingHighpass Highpass { get; set; }
		private PlotOptionsWaterfallSonificationTracksMappingHighpass Highpass_DefaultValue { get; set; }
		...
		/// </summary>
		public PlotOptionsWaterfallSonificationTracksMappingLowpass Lowpass { get; set; }
		private PlotOptionsWaterfallSonificationTracksMappingLowpass Lowpass_DefaultValue { get; set; }
		...
		/// </summary>
		public PlotOptionsWaterfallSonificationTracksMappingNoteDuration NoteDuration { get; set; }
		private PlotOptionsWaterfallSonificationTracksMappingNoteDuration NoteDuration_DefaultValue { get; set; }
		...
		/// </summary>
		public PlotOptionsWaterfallSonificationTracksMappingPan Pan { get; set; }
		private PlotOptionsWaterfallSonificationTracksMappingPan Pan_DefaultValue { get; set; }
		...
		/// </summary>
		public PlotOptionsWaterfallSonificationTracksMappingPitch Pitch { get; set; }
		private PlotOptionsWaterfallSonificationTracksMappingPitch Pitch_DefaultValue { get; set; }
		...
		/// </summary>
		public PlotOptionsWaterfallSonificationTracksMappingPlayDelay PlayDelay { get; set; }
		private PlotOptionsWaterfallSonificationTracksMappingPlayDelay PlayDelay_DefaultValue { get; set; }
		...
		/// </summary>
		public PlotOptionsWaterfallSonificationTracksMappingTime Time { get; set; }
		private PlotOptionsWaterfallSonificationTracksMappingTime Time_DefaultValue { get; set; }
		...
		/// </summary>
		public PlotOptionsWaterfallSonificationTracksMappingTremolo Tremolo { get; set; }
		private PlotOptionsWaterfallSonificationTracksMappingTremolo Tremolo_DefaultValue { get; set; }
		 

		/// <summary>
		/// The volume of notes, from 0 to 1.
		/// </summary>
		public PlotOptionsWaterfallSonificationTracksMappingVolume Volume { get; set; }
		private PlotOptionsWaterfallSonificationTracksMappingVolume Volume_DefaultValue { get; set; }
