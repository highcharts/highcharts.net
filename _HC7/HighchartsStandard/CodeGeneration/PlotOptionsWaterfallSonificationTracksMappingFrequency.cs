...
{
	public partial class PlotOptionsWaterfallSonificationTracksMappingFrequency  : BaseObject
	{
		Hashtable h = new Hashtable();

		public PlotOptionsWaterfallSonificationTracksMappingFrequency()
		{
			MapFunction = MapFunction_DefaultValue = PlotOptionsWaterfallSonificationTracksMappingFrequencyMapFunction.Linear;
			MapTo = MapTo_DefaultValue = "";
			Max = Max_DefaultValue = null;
			Min = Min_DefaultValue = null;
			Value = Value_DefaultValue = null;
			Within = Within_DefaultValue = PlotOptionsWaterfallSonificationTracksMappingFrequencyWithin.Chart;
		...
		/// </summary>
		public PlotOptionsWaterfallSonificationTracksMappingFrequencyMapFunction MapFunction { get; set; }
		private PlotOptionsWaterfallSonificationTracksMappingFrequencyMapFunction MapFunction_DefaultValue { get; set; }
		...
		/// </summary>
		public PlotOptionsWaterfallSonificationTracksMappingFrequencyWithin Within { get; set; }
		private PlotOptionsWaterfallSonificationTracksMappingFrequencyWithin Within_DefaultValue { get; set; }
