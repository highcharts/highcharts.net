...
{
	public partial class PlotOptionsWaterfallSonificationTracksMappingPan  : BaseObject
	{
		Hashtable h = new Hashtable();

		public PlotOptionsWaterfallSonificationTracksMappingPan()
		{
			MapFunction = MapFunction_DefaultValue = PlotOptionsWaterfallSonificationTracksMappingPanMapFunction.Linear;
			MapTo = MapTo_DefaultValue = "";
			Max = Max_DefaultValue = null;
			Min = Min_DefaultValue = null;
			Value = Value_DefaultValue = null;
			Within = Within_DefaultValue = PlotOptionsWaterfallSonificationTracksMappingPanWithin.Chart;
		...
		/// </summary>
		public PlotOptionsWaterfallSonificationTracksMappingPanMapFunction MapFunction { get; set; }
		private PlotOptionsWaterfallSonificationTracksMappingPanMapFunction MapFunction_DefaultValue { get; set; }
		...
		/// </summary>
		public PlotOptionsWaterfallSonificationTracksMappingPanWithin Within { get; set; }
		private PlotOptionsWaterfallSonificationTracksMappingPanWithin Within_DefaultValue { get; set; }
