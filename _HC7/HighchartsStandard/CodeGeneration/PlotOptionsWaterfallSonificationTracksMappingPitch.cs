...
{
	public partial class PlotOptionsWaterfallSonificationTracksMappingPitch  : BaseObject
	{
		Hashtable h = new Hashtable();

		public PlotOptionsWaterfallSonificationTracksMappingPitch()
		{
			MapFunction = MapFunction_DefaultValue = PlotOptionsWaterfallSonificationTracksMappingPitchMapFunction.Linear;
		...
		/// </summary>
		public PlotOptionsWaterfallSonificationTracksMappingPitchMapFunction MapFunction { get; set; }
		private PlotOptionsWaterfallSonificationTracksMappingPitchMapFunction MapFunction_DefaultValue { get; set; }
