...
{
	public partial class PlotOptionsWaterfallSonificationTracksMappingTime  : BaseObject
	{
		Hashtable h = new Hashtable();

		public PlotOptionsWaterfallSonificationTracksMappingTime()
		{
			MapFunction = MapFunction_DefaultValue = PlotOptionsWaterfallSonificationTracksMappingTimeMapFunction.Linear;
			MapTo = MapTo_DefaultValue = "";
			Max = Max_DefaultValue = null;
			Min = Min_DefaultValue = null;
			Value = Value_DefaultValue = null;
			Within = Within_DefaultValue = PlotOptionsWaterfallSonificationTracksMappingTimeWithin.Chart;
		...
		/// </summary>
		public PlotOptionsWaterfallSonificationTracksMappingTimeMapFunction MapFunction { get; set; }
		private PlotOptionsWaterfallSonificationTracksMappingTimeMapFunction MapFunction_DefaultValue { get; set; }
		...
		/// </summary>
		public PlotOptionsWaterfallSonificationTracksMappingTimeWithin Within { get; set; }
		private PlotOptionsWaterfallSonificationTracksMappingTimeWithin Within_DefaultValue { get; set; }
