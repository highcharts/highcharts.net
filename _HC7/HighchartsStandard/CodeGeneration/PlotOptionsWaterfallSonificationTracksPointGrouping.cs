...
{
	public partial class PlotOptionsWaterfallSonificationTracksPointGrouping  : BaseObject
	{
		Hashtable h = new Hashtable();

		public PlotOptionsWaterfallSonificationTracksPointGrouping()
		{
		...
		/// </summary>
		public PlotOptionsWaterfallSonificationTracksPointGroupingAlgorithm Algorithm { get; set; }
		private PlotOptionsWaterfallSonificationTracksPointGroupingAlgorithm Algorithm_DefaultValue { get; set; }
		...
		internal override Hashtable ToHashtable(Highcharts highcharts)
		{
			...
			if (Algorithm != PlotOptionsWaterfallSonificationTracksPointGroupingAlgorithm.Null) h.Add("algorithm", highcharts.FirstCharacterToLower(Algorithm.ToString()));
