...
namespace Highsoft.Web.Mvc.Charts
{
	public partial class PlotOptionsWindbarbAccessibility  : BaseObject
	{
		...
		internal override Hashtable ToHashtable()
		{
			...
			if (PointDescriptionFormatter != PointDescriptionFormatter_DefaultValue) { h.Add("pointDescriptionFormatter",PointDescriptionFormatter); Highcharts.AddFunction("f6f10e48-092d-4124-b69d-d5ef6f102d7d.pointDescriptionFormatter", PointDescriptionFormatter); }  
