...
{
	public partial class PlotOptionsWindbarbSonificationContextTracks  : BaseObject
	{
		Hashtable h = new Hashtable();

		public PlotOptionsWindbarbSonificationContextTracks()
		{
			ActiveWhen = ActiveWhen_DefaultValue = new PlotOptionsWindbarbSonificationContextTracksActiveWhen();
			Instrument = Instrument_DefaultValue = null;
			InstrumentString = InstrumentString_DefaultValue = "null";
			Mapping = Mapping_DefaultValue = new PlotOptionsWindbarbSonificationContextTracksMapping();
			MidiName = MidiName_DefaultValue = "";
			PointGrouping = PointGrouping_DefaultValue = new PlotOptionsWindbarbSonificationContextTracksPointGrouping();
			...
			Type = Type_DefaultValue = PlotOptionsWindbarbSonificationContextTracksType.Instrument;
			ValueInterval = ValueInterval_DefaultValue = null;
			ValueMapFunction = ValueMapFunction_DefaultValue = PlotOptionsWindbarbSonificationContextTracksValueMapFunction.Linear;
		...
		/// </summary>
		public PlotOptionsWindbarbSonificationContextTracksActiveWhen ActiveWhen { get; set; }
		private PlotOptionsWindbarbSonificationContextTracksActiveWhen ActiveWhen_DefaultValue { get; set; }
		...
		/// </summary>
		public PlotOptionsWindbarbSonificationContextTracksMapping Mapping { get; set; }
		private PlotOptionsWindbarbSonificationContextTracksMapping Mapping_DefaultValue { get; set; }
		...
		/// </summary>
		public PlotOptionsWindbarbSonificationContextTracksPointGrouping PointGrouping { get; set; }
		private PlotOptionsWindbarbSonificationContextTracksPointGrouping PointGrouping_DefaultValue { get; set; }
		...
		/// </summary>
		public PlotOptionsWindbarbSonificationContextTracksType Type { get; set; }
		private PlotOptionsWindbarbSonificationContextTracksType Type_DefaultValue { get; set; }
		...
		/// </summary>
		public PlotOptionsWindbarbSonificationContextTracksValueMapFunction ValueMapFunction { get; set; }
		private PlotOptionsWindbarbSonificationContextTracksValueMapFunction ValueMapFunction_DefaultValue { get; set; }
