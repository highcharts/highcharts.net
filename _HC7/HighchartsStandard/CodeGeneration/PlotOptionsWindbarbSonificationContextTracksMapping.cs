...
{
	public partial class PlotOptionsWindbarbSonificationContextTracksMapping  : BaseObject
	{
		Hashtable h = new Hashtable();

		public PlotOptionsWindbarbSonificationContextTracksMapping()
		{
			Frequency = Frequency_DefaultValue = new PlotOptionsWindbarbSonificationContextTracksMappingFrequency();
			GapBetweenNotes = GapBetweenNotes_DefaultValue = new PlotOptionsWindbarbSonificationContextTracksMappingGapBetweenNotes();
			Highpass = Highpass_DefaultValue = new PlotOptionsWindbarbSonificationContextTracksMappingHighpass();
			Lowpass = Lowpass_DefaultValue = new PlotOptionsWindbarbSonificationContextTracksMappingLowpass();
			NoteDuration = NoteDuration_DefaultValue = new PlotOptionsWindbarbSonificationContextTracksMappingNoteDuration();
			Pan = Pan_DefaultValue = new PlotOptionsWindbarbSonificationContextTracksMappingPan();
			Pitch = Pitch_DefaultValue = new PlotOptionsWindbarbSonificationContextTracksMappingPitch();
			PitchString = PitchString_DefaultValue = "null";
			PitchNumber = PitchNumber_DefaultValue = null;
			PlayDelay = PlayDelay_DefaultValue = new PlotOptionsWindbarbSonificationContextTracksMappingPlayDelay();
			Time = Time_DefaultValue = new PlotOptionsWindbarbSonificationContextTracksMappingTime();
			TimeString = TimeString_DefaultValue = "null";
			TimeNumber = TimeNumber_DefaultValue = null;
			Tremolo = Tremolo_DefaultValue = new PlotOptionsWindbarbSonificationContextTracksMappingTremolo();
			Volume = Volume_DefaultValue = new PlotOptionsWindbarbSonificationContextTracksMappingVolume();
		...
		/// </summary>
		public PlotOptionsWindbarbSonificationContextTracksMappingFrequency Frequency { get; set; }
		private PlotOptionsWindbarbSonificationContextTracksMappingFrequency Frequency_DefaultValue { get; set; }
		...
		/// </summary>
		public PlotOptionsWindbarbSonificationContextTracksMappingGapBetweenNotes GapBetweenNotes { get; set; }
		private PlotOptionsWindbarbSonificationContextTracksMappingGapBetweenNotes GapBetweenNotes_DefaultValue { get; set; }
		...
		/// </summary>
		public PlotOptionsWindbarbSonificationContextTracksMappingHighpass Highpass { get; set; }
		private PlotOptionsWindbarbSonificationContextTracksMappingHighpass Highpass_DefaultValue { get; set; }
		...
		/// </summary>
		public PlotOptionsWindbarbSonificationContextTracksMappingLowpass Lowpass { get; set; }
		private PlotOptionsWindbarbSonificationContextTracksMappingLowpass Lowpass_DefaultValue { get; set; }
		...
		/// </summary>
		public PlotOptionsWindbarbSonificationContextTracksMappingNoteDuration NoteDuration { get; set; }
		private PlotOptionsWindbarbSonificationContextTracksMappingNoteDuration NoteDuration_DefaultValue { get; set; }
		...
		/// </summary>
		public PlotOptionsWindbarbSonificationContextTracksMappingPan Pan { get; set; }
		private PlotOptionsWindbarbSonificationContextTracksMappingPan Pan_DefaultValue { get; set; }
		...
		/// </summary>
		public PlotOptionsWindbarbSonificationContextTracksMappingPitch Pitch { get; set; }
		private PlotOptionsWindbarbSonificationContextTracksMappingPitch Pitch_DefaultValue { get; set; }
		...
		/// </summary>
		public PlotOptionsWindbarbSonificationContextTracksMappingPlayDelay PlayDelay { get; set; }
		private PlotOptionsWindbarbSonificationContextTracksMappingPlayDelay PlayDelay_DefaultValue { get; set; }
		...
		/// </summary>
		public PlotOptionsWindbarbSonificationContextTracksMappingTime Time { get; set; }
		private PlotOptionsWindbarbSonificationContextTracksMappingTime Time_DefaultValue { get; set; }
		...
		/// </summary>
		public PlotOptionsWindbarbSonificationContextTracksMappingTremolo Tremolo { get; set; }
		private PlotOptionsWindbarbSonificationContextTracksMappingTremolo Tremolo_DefaultValue { get; set; }
		 

		/// <summary>
		/// The volume of notes, from 0 to 1.
		/// </summary>
		public PlotOptionsWindbarbSonificationContextTracksMappingVolume Volume { get; set; }
		private PlotOptionsWindbarbSonificationContextTracksMappingVolume Volume_DefaultValue { get; set; }
