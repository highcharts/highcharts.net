...
{
	public partial class PlotOptionsWindbarbSonificationContextTracksMappingPitch  : BaseObject
	{
		Hashtable h = new Hashtable();

		public PlotOptionsWindbarbSonificationContextTracksMappingPitch()
		{
			MapFunction = MapFunction_DefaultValue = PlotOptionsWindbarbSonificationContextTracksMappingPitchMapFunction.Linear;
		...
		/// </summary>
		public PlotOptionsWindbarbSonificationContextTracksMappingPitchMapFunction MapFunction { get; set; }
		private PlotOptionsWindbarbSonificationContextTracksMappingPitchMapFunction MapFunction_DefaultValue { get; set; }
