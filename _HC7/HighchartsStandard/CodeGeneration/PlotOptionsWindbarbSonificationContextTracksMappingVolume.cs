...
{
	public partial class PlotOptionsWindbarbSonificationContextTracksMappingVolume  : BaseObject
	{
		Hashtable h = new Hashtable();

		public PlotOptionsWindbarbSonificationContextTracksMappingVolume()
		{
			MapFunction = MapFunction_DefaultValue = PlotOptionsWindbarbSonificationContextTracksMappingVolumeMapFunction.Linear;
			MapTo = MapTo_DefaultValue = "";
			Max = Max_DefaultValue = null;
			Min = Min_DefaultValue = null;
			Value = Value_DefaultValue = null;
			Within = Within_DefaultValue = PlotOptionsWindbarbSonificationContextTracksMappingVolumeWithin.Chart;
		...
		/// </summary>
		public PlotOptionsWindbarbSonificationContextTracksMappingVolumeMapFunction MapFunction { get; set; }
		private PlotOptionsWindbarbSonificationContextTracksMappingVolumeMapFunction MapFunction_DefaultValue { get; set; }
		...
		/// </summary>
		public PlotOptionsWindbarbSonificationContextTracksMappingVolumeWithin Within { get; set; }
		private PlotOptionsWindbarbSonificationContextTracksMappingVolumeWithin Within_DefaultValue { get; set; }
