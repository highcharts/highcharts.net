...
{
	public partial class PlotOptionsWindbarbSonificationDefaultSpeechOptionsMappingPan  : BaseObject
	{
		Hashtable h = new Hashtable();

		public PlotOptionsWindbarbSonificationDefaultSpeechOptionsMappingPan()
		{
			MapFunction = MapFunction_DefaultValue = PlotOptionsWindbarbSonificationDefaultSpeechOptionsMappingPanMapFunction.Linear;
			MapTo = MapTo_DefaultValue = "";
			Max = Max_DefaultValue = null;
			Min = Min_DefaultValue = null;
			Value = Value_DefaultValue = null;
			Within = Within_DefaultValue = PlotOptionsWindbarbSonificationDefaultSpeechOptionsMappingPanWithin.Chart;
		...
		/// </summary>
		public PlotOptionsWindbarbSonificationDefaultSpeechOptionsMappingPanMapFunction MapFunction { get; set; }
		private PlotOptionsWindbarbSonificationDefaultSpeechOptionsMappingPanMapFunction MapFunction_DefaultValue { get; set; }
		...
		/// </summary>
		public PlotOptionsWindbarbSonificationDefaultSpeechOptionsMappingPanWithin Within { get; set; }
		private PlotOptionsWindbarbSonificationDefaultSpeechOptionsMappingPanWithin Within_DefaultValue { get; set; }
