...
{
	public partial class PlotOptionsWindbarbSonificationPointGrouping  : BaseObject
	{
		Hashtable h = new Hashtable();

		public PlotOptionsWindbarbSonificationPointGrouping()
		{
		...
		/// </summary>
		public PlotOptionsWindbarbSonificationPointGroupingAlgorithm Algorithm { get; set; }
		private PlotOptionsWindbarbSonificationPointGroupingAlgorithm Algorithm_DefaultValue { get; set; }
		...
		internal override Hashtable ToHashtable(Highcharts highcharts)
		{
			...
			if (Algorithm != PlotOptionsWindbarbSonificationPointGroupingAlgorithm.Null) h.Add("algorithm", highcharts.FirstCharacterToLower(Algorithm.ToString()));
