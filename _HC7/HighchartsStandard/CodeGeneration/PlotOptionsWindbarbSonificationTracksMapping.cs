...
{
	public partial class PlotOptionsWindbarbSonificationTracksMapping  : BaseObject
	{
		Hashtable h = new Hashtable();

		public PlotOptionsWindbarbSonificationTracksMapping()
		{
			Frequency = Frequency_DefaultValue = new PlotOptionsWindbarbSonificationTracksMappingFrequency();
			GapBetweenNotes = GapBetweenNotes_DefaultValue = new PlotOptionsWindbarbSonificationTracksMappingGapBetweenNotes();
			Highpass = Highpass_DefaultValue = new PlotOptionsWindbarbSonificationTracksMappingHighpass();
			Lowpass = Lowpass_DefaultValue = new PlotOptionsWindbarbSonificationTracksMappingLowpass();
			NoteDuration = NoteDuration_DefaultValue = new PlotOptionsWindbarbSonificationTracksMappingNoteDuration();
			Pan = Pan_DefaultValue = new PlotOptionsWindbarbSonificationTracksMappingPan();
			Pitch = Pitch_DefaultValue = new PlotOptionsWindbarbSonificationTracksMappingPitch();
			PitchString = PitchString_DefaultValue = "null";
			PitchNumber = PitchNumber_DefaultValue = null;
			PlayDelay = PlayDelay_DefaultValue = new PlotOptionsWindbarbSonificationTracksMappingPlayDelay();
			Time = Time_DefaultValue = new PlotOptionsWindbarbSonificationTracksMappingTime();
			TimeString = TimeString_DefaultValue = "null";
			TimeNumber = TimeNumber_DefaultValue = null;
			Tremolo = Tremolo_DefaultValue = new PlotOptionsWindbarbSonificationTracksMappingTremolo();
			Volume = Volume_DefaultValue = new PlotOptionsWindbarbSonificationTracksMappingVolume();
		...
		/// </summary>
		public PlotOptionsWindbarbSonificationTracksMappingFrequency Frequency { get; set; }
		private PlotOptionsWindbarbSonificationTracksMappingFrequency Frequency_DefaultValue { get; set; }
		...
		/// </summary>
		public PlotOptionsWindbarbSonificationTracksMappingGapBetweenNotes GapBetweenNotes { get; set; }
		private PlotOptionsWindbarbSonificationTracksMappingGapBetweenNotes GapBetweenNotes_DefaultValue { get; set; }
		...
		/// </summary>
		public PlotOptionsWindbarbSonificationTracksMappingHighpass Highpass { get; set; }
		private PlotOptionsWindbarbSonificationTracksMappingHighpass Highpass_DefaultValue { get; set; }
		...
		/// </summary>
		public PlotOptionsWindbarbSonificationTracksMappingLowpass Lowpass { get; set; }
		private PlotOptionsWindbarbSonificationTracksMappingLowpass Lowpass_DefaultValue { get; set; }
		...
		/// </summary>
		public PlotOptionsWindbarbSonificationTracksMappingNoteDuration NoteDuration { get; set; }
		private PlotOptionsWindbarbSonificationTracksMappingNoteDuration NoteDuration_DefaultValue { get; set; }
		...
		/// </summary>
		public PlotOptionsWindbarbSonificationTracksMappingPan Pan { get; set; }
		private PlotOptionsWindbarbSonificationTracksMappingPan Pan_DefaultValue { get; set; }
		...
		/// </summary>
		public PlotOptionsWindbarbSonificationTracksMappingPitch Pitch { get; set; }
		private PlotOptionsWindbarbSonificationTracksMappingPitch Pitch_DefaultValue { get; set; }
		...
		/// </summary>
		public PlotOptionsWindbarbSonificationTracksMappingPlayDelay PlayDelay { get; set; }
		private PlotOptionsWindbarbSonificationTracksMappingPlayDelay PlayDelay_DefaultValue { get; set; }
		...
		/// </summary>
		public PlotOptionsWindbarbSonificationTracksMappingTime Time { get; set; }
		private PlotOptionsWindbarbSonificationTracksMappingTime Time_DefaultValue { get; set; }
		...
		/// </summary>
		public PlotOptionsWindbarbSonificationTracksMappingTremolo Tremolo { get; set; }
		private PlotOptionsWindbarbSonificationTracksMappingTremolo Tremolo_DefaultValue { get; set; }
		 

		/// <summary>
		/// The volume of notes, from 0 to 1.
		/// </summary>
		public PlotOptionsWindbarbSonificationTracksMappingVolume Volume { get; set; }
		private PlotOptionsWindbarbSonificationTracksMappingVolume Volume_DefaultValue { get; set; }
