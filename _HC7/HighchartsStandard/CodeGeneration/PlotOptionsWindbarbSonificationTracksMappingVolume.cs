...
{
	public partial class PlotOptionsWindbarbSonificationTracksMappingVolume  : BaseObject
	{
		Hashtable h = new Hashtable();

		public PlotOptionsWindbarbSonificationTracksMappingVolume()
		{
			MapFunction = MapFunction_DefaultValue = PlotOptionsWindbarbSonificationTracksMappingVolumeMapFunction.Linear;
			MapTo = MapTo_DefaultValue = "";
			Max = Max_DefaultValue = null;
			Min = Min_DefaultValue = null;
			Value = Value_DefaultValue = null;
			Within = Within_DefaultValue = PlotOptionsWindbarbSonificationTracksMappingVolumeWithin.Chart;
		...
		/// </summary>
		public PlotOptionsWindbarbSonificationTracksMappingVolumeMapFunction MapFunction { get; set; }
		private PlotOptionsWindbarbSonificationTracksMappingVolumeMapFunction MapFunction_DefaultValue { get; set; }
		...
		/// </summary>
		public PlotOptionsWindbarbSonificationTracksMappingVolumeWithin Within { get; set; }
		private PlotOptionsWindbarbSonificationTracksMappingVolumeWithin Within_DefaultValue { get; set; }
