...
{
	public partial class PlotOptionsWindbarbSonificationTracksPointGrouping  : BaseObject
	{
		Hashtable h = new Hashtable();

		public PlotOptionsWindbarbSonificationTracksPointGrouping()
		{
		...
		/// </summary>
		public PlotOptionsWindbarbSonificationTracksPointGroupingAlgorithm Algorithm { get; set; }
		private PlotOptionsWindbarbSonificationTracksPointGroupingAlgorithm Algorithm_DefaultValue { get; set; }
		...
		internal override Hashtable ToHashtable(Highcharts highcharts)
		{
			...
			if (Algorithm != PlotOptionsWindbarbSonificationTracksPointGroupingAlgorithm.Null) h.Add("algorithm", highcharts.FirstCharacterToLower(Algorithm.ToString()));
