...
{
	public partial class PlotOptionsWordcloudSonificationContextTracksMapping  : BaseObject
	{
		Hashtable h = new Hashtable();

		public PlotOptionsWordcloudSonificationContextTracksMapping()
		{
			Frequency = Frequency_DefaultValue = new PlotOptionsWordcloudSonificationContextTracksMappingFrequency();
			GapBetweenNotes = GapBetweenNotes_DefaultValue = new PlotOptionsWordcloudSonificationContextTracksMappingGapBetweenNotes();
			Highpass = Highpass_DefaultValue = new PlotOptionsWordcloudSonificationContextTracksMappingHighpass();
			Lowpass = Lowpass_DefaultValue = new PlotOptionsWordcloudSonificationContextTracksMappingLowpass();
			NoteDuration = NoteDuration_DefaultValue = new PlotOptionsWordcloudSonificationContextTracksMappingNoteDuration();
			Pan = Pan_DefaultValue = new PlotOptionsWordcloudSonificationContextTracksMappingPan();
			Pitch = Pitch_DefaultValue = new PlotOptionsWordcloudSonificationContextTracksMappingPitch();
			PitchString = PitchString_DefaultValue = "null";
			PitchNumber = PitchNumber_DefaultValue = null;
			PlayDelay = PlayDelay_DefaultValue = new PlotOptionsWordcloudSonificationContextTracksMappingPlayDelay();
			Time = Time_DefaultValue = new PlotOptionsWordcloudSonificationContextTracksMappingTime();
			TimeString = TimeString_DefaultValue = "null";
			TimeNumber = TimeNumber_DefaultValue = null;
			Tremolo = Tremolo_DefaultValue = new PlotOptionsWordcloudSonificationContextTracksMappingTremolo();
			Volume = Volume_DefaultValue = new PlotOptionsWordcloudSonificationContextTracksMappingVolume();
		...
		/// </summary>
		public PlotOptionsWordcloudSonificationContextTracksMappingFrequency Frequency { get; set; }
		private PlotOptionsWordcloudSonificationContextTracksMappingFrequency Frequency_DefaultValue { get; set; }
		...
		/// </summary>
		public PlotOptionsWordcloudSonificationContextTracksMappingGapBetweenNotes GapBetweenNotes { get; set; }
		private PlotOptionsWordcloudSonificationContextTracksMappingGapBetweenNotes GapBetweenNotes_DefaultValue { get; set; }
		...
		/// </summary>
		public PlotOptionsWordcloudSonificationContextTracksMappingHighpass Highpass { get; set; }
		private PlotOptionsWordcloudSonificationContextTracksMappingHighpass Highpass_DefaultValue { get; set; }
		...
		/// </summary>
		public PlotOptionsWordcloudSonificationContextTracksMappingLowpass Lowpass { get; set; }
		private PlotOptionsWordcloudSonificationContextTracksMappingLowpass Lowpass_DefaultValue { get; set; }
		...
		/// </summary>
		public PlotOptionsWordcloudSonificationContextTracksMappingNoteDuration NoteDuration { get; set; }
		private PlotOptionsWordcloudSonificationContextTracksMappingNoteDuration NoteDuration_DefaultValue { get; set; }
		...
		/// </summary>
		public PlotOptionsWordcloudSonificationContextTracksMappingPan Pan { get; set; }
		private PlotOptionsWordcloudSonificationContextTracksMappingPan Pan_DefaultValue { get; set; }
		...
		/// </summary>
		public PlotOptionsWordcloudSonificationContextTracksMappingPitch Pitch { get; set; }
		private PlotOptionsWordcloudSonificationContextTracksMappingPitch Pitch_DefaultValue { get; set; }
		...
		/// </summary>
		public PlotOptionsWordcloudSonificationContextTracksMappingPlayDelay PlayDelay { get; set; }
		private PlotOptionsWordcloudSonificationContextTracksMappingPlayDelay PlayDelay_DefaultValue { get; set; }
		...
		/// </summary>
		public PlotOptionsWordcloudSonificationContextTracksMappingTime Time { get; set; }
		private PlotOptionsWordcloudSonificationContextTracksMappingTime Time_DefaultValue { get; set; }
		...
		/// </summary>
		public PlotOptionsWordcloudSonificationContextTracksMappingTremolo Tremolo { get; set; }
		private PlotOptionsWordcloudSonificationContextTracksMappingTremolo Tremolo_DefaultValue { get; set; }
		 

		/// <summary>
		/// The volume of notes, from 0 to 1.
		/// </summary>
		public PlotOptionsWordcloudSonificationContextTracksMappingVolume Volume { get; set; }
		private PlotOptionsWordcloudSonificationContextTracksMappingVolume Volume_DefaultValue { get; set; }
