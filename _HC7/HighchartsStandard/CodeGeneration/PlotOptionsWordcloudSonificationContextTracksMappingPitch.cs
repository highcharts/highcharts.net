...
{
	public partial class PlotOptionsWordcloudSonificationContextTracksMappingPitch  : BaseObject
	{
		Hashtable h = new Hashtable();

		public PlotOptionsWordcloudSonificationContextTracksMappingPitch()
		{
			MapFunction = MapFunction_DefaultValue = PlotOptionsWordcloudSonificationContextTracksMappingPitchMapFunction.Linear;
		...
		/// </summary>
		public PlotOptionsWordcloudSonificationContextTracksMappingPitchMapFunction MapFunction { get; set; }
		private PlotOptionsWordcloudSonificationContextTracksMappingPitchMapFunction MapFunction_DefaultValue { get; set; }
