...
{
	public partial class PlotOptionsWordcloudSonificationPointGrouping  : BaseObject
	{
		Hashtable h = new Hashtable();

		public PlotOptionsWordcloudSonificationPointGrouping()
		{
		...
		/// </summary>
		public PlotOptionsWordcloudSonificationPointGroupingAlgorithm Algorithm { get; set; }
		private PlotOptionsWordcloudSonificationPointGroupingAlgorithm Algorithm_DefaultValue { get; set; }
		...
		internal override Hashtable ToHashtable(Highcharts highcharts)
		{
			...
			if (Algorithm != PlotOptionsWordcloudSonificationPointGroupingAlgorithm.Null) h.Add("algorithm", highcharts.FirstCharacterToLower(Algorithm.ToString()));
