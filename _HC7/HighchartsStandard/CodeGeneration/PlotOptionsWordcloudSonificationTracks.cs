...
{
	public partial class PlotOptionsWordcloudSonificationTracks  : BaseObject
	{
		Hashtable h = new Hashtable();

		public PlotOptionsWordcloudSonificationTracks()
		{
			ActiveWhen = ActiveWhen_DefaultValue = new PlotOptionsWordcloudSonificationTracksActiveWhen();
			Instrument = Instrument_DefaultValue = null;
			InstrumentString = InstrumentString_DefaultValue = "null";
			Mapping = Mapping_DefaultValue = new PlotOptionsWordcloudSonificationTracksMapping();
			MidiName = MidiName_DefaultValue = "";
			PointGrouping = PointGrouping_DefaultValue = new PlotOptionsWordcloudSonificationTracksPointGrouping();
			RoundToMusicalNotes = RoundToMusicalNotes_DefaultValue = true;
			ShowPlayMarker = ShowPlayMarker_DefaultValue = true;
			Type = Type_DefaultValue = PlotOptionsWordcloudSonificationTracksType.Instrument;
		...
		/// </summary>
		public PlotOptionsWordcloudSonificationTracksActiveWhen ActiveWhen { get; set; }
		private PlotOptionsWordcloudSonificationTracksActiveWhen ActiveWhen_DefaultValue { get; set; }
		...
		/// </summary>
		public PlotOptionsWordcloudSonificationTracksMapping Mapping { get; set; }
		private PlotOptionsWordcloudSonificationTracksMapping Mapping_DefaultValue { get; set; }
		...
		/// </summary>
		public PlotOptionsWordcloudSonificationTracksPointGrouping PointGrouping { get; set; }
		private PlotOptionsWordcloudSonificationTracksPointGrouping PointGrouping_DefaultValue { get; set; }
		...
		/// </summary>
		public PlotOptionsWordcloudSonificationTracksType Type { get; set; }
		private PlotOptionsWordcloudSonificationTracksType Type_DefaultValue { get; set; }
