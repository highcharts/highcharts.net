...
{
	public partial class PlotOptionsWordcloudSonificationTracksMapping  : BaseObject
	{
		Hashtable h = new Hashtable();

		public PlotOptionsWordcloudSonificationTracksMapping()
		{
			Frequency = Frequency_DefaultValue = new PlotOptionsWordcloudSonificationTracksMappingFrequency();
			GapBetweenNotes = GapBetweenNotes_DefaultValue = new PlotOptionsWordcloudSonificationTracksMappingGapBetweenNotes();
			Highpass = Highpass_DefaultValue = new PlotOptionsWordcloudSonificationTracksMappingHighpass();
			Lowpass = Lowpass_DefaultValue = new PlotOptionsWordcloudSonificationTracksMappingLowpass();
			NoteDuration = NoteDuration_DefaultValue = new PlotOptionsWordcloudSonificationTracksMappingNoteDuration();
			Pan = Pan_DefaultValue = new PlotOptionsWordcloudSonificationTracksMappingPan();
			Pitch = Pitch_DefaultValue = new PlotOptionsWordcloudSonificationTracksMappingPitch();
			PitchString = PitchString_DefaultValue = "null";
			PitchNumber = PitchNumber_DefaultValue = null;
			PlayDelay = PlayDelay_DefaultValue = new PlotOptionsWordcloudSonificationTracksMappingPlayDelay();
			Time = Time_DefaultValue = new PlotOptionsWordcloudSonificationTracksMappingTime();
			TimeString = TimeString_DefaultValue = "null";
			TimeNumber = TimeNumber_DefaultValue = null;
			Tremolo = Tremolo_DefaultValue = new PlotOptionsWordcloudSonificationTracksMappingTremolo();
			Volume = Volume_DefaultValue = new PlotOptionsWordcloudSonificationTracksMappingVolume();
		...
		/// </summary>
		public PlotOptionsWordcloudSonificationTracksMappingFrequency Frequency { get; set; }
		private PlotOptionsWordcloudSonificationTracksMappingFrequency Frequency_DefaultValue { get; set; }
		...
		/// </summary>
		public PlotOptionsWordcloudSonificationTracksMappingGapBetweenNotes GapBetweenNotes { get; set; }
		private PlotOptionsWordcloudSonificationTracksMappingGapBetweenNotes GapBetweenNotes_DefaultValue { get; set; }
		...
		/// </summary>
		public PlotOptionsWordcloudSonificationTracksMappingHighpass Highpass { get; set; }
		private PlotOptionsWordcloudSonificationTracksMappingHighpass Highpass_DefaultValue { get; set; }
		...
		/// </summary>
		public PlotOptionsWordcloudSonificationTracksMappingLowpass Lowpass { get; set; }
		private PlotOptionsWordcloudSonificationTracksMappingLowpass Lowpass_DefaultValue { get; set; }
		...
		/// </summary>
		public PlotOptionsWordcloudSonificationTracksMappingNoteDuration NoteDuration { get; set; }
		private PlotOptionsWordcloudSonificationTracksMappingNoteDuration NoteDuration_DefaultValue { get; set; }
		...
		/// </summary>
		public PlotOptionsWordcloudSonificationTracksMappingPan Pan { get; set; }
		private PlotOptionsWordcloudSonificationTracksMappingPan Pan_DefaultValue { get; set; }
		...
		/// </summary>
		public PlotOptionsWordcloudSonificationTracksMappingPitch Pitch { get; set; }
		private PlotOptionsWordcloudSonificationTracksMappingPitch Pitch_DefaultValue { get; set; }
		...
		/// </summary>
		public PlotOptionsWordcloudSonificationTracksMappingPlayDelay PlayDelay { get; set; }
		private PlotOptionsWordcloudSonificationTracksMappingPlayDelay PlayDelay_DefaultValue { get; set; }
		...
		/// </summary>
		public PlotOptionsWordcloudSonificationTracksMappingTime Time { get; set; }
		private PlotOptionsWordcloudSonificationTracksMappingTime Time_DefaultValue { get; set; }
		...
		/// </summary>
		public PlotOptionsWordcloudSonificationTracksMappingTremolo Tremolo { get; set; }
		private PlotOptionsWordcloudSonificationTracksMappingTremolo Tremolo_DefaultValue { get; set; }
		 

		/// <summary>
		/// The volume of notes, from 0 to 1.
		/// </summary>
		public PlotOptionsWordcloudSonificationTracksMappingVolume Volume { get; set; }
		private PlotOptionsWordcloudSonificationTracksMappingVolume Volume_DefaultValue { get; set; }
