...
{
	public partial class PlotOptionsWordcloudSonificationTracksMappingFrequency  : BaseObject
	{
		Hashtable h = new Hashtable();

		public PlotOptionsWordcloudSonificationTracksMappingFrequency()
		{
			MapFunction = MapFunction_DefaultValue = PlotOptionsWordcloudSonificationTracksMappingFrequencyMapFunction.Linear;
			MapTo = MapTo_DefaultValue = "";
			Max = Max_DefaultValue = null;
			Min = Min_DefaultValue = null;
			Value = Value_DefaultValue = null;
			Within = Within_DefaultValue = PlotOptionsWordcloudSonificationTracksMappingFrequencyWithin.Chart;
		...
		/// </summary>
		public PlotOptionsWordcloudSonificationTracksMappingFrequencyMapFunction MapFunction { get; set; }
		private PlotOptionsWordcloudSonificationTracksMappingFrequencyMapFunction MapFunction_DefaultValue { get; set; }
		...
		/// </summary>
		public PlotOptionsWordcloudSonificationTracksMappingFrequencyWithin Within { get; set; }
		private PlotOptionsWordcloudSonificationTracksMappingFrequencyWithin Within_DefaultValue { get; set; }
