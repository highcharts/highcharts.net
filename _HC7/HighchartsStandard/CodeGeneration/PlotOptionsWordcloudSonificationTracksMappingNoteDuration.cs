...
{
	public partial class PlotOptionsWordcloudSonificationTracksMappingNoteDuration  : BaseObject
	{
		Hashtable h = new Hashtable();

		public PlotOptionsWordcloudSonificationTracksMappingNoteDuration()
		{
			MapFunction = MapFunction_DefaultValue = PlotOptionsWordcloudSonificationTracksMappingNoteDurationMapFunction.Linear;
			MapTo = MapTo_DefaultValue = "";
			Max = Max_DefaultValue = null;
			Min = Min_DefaultValue = null;
			Value = Value_DefaultValue = null;
			Within = Within_DefaultValue = PlotOptionsWordcloudSonificationTracksMappingNoteDurationWithin.Chart;
		...
		/// </summary>
		public PlotOptionsWordcloudSonificationTracksMappingNoteDurationMapFunction MapFunction { get; set; }
		private PlotOptionsWordcloudSonificationTracksMappingNoteDurationMapFunction MapFunction_DefaultValue { get; set; }
		...
		/// </summary>
		public PlotOptionsWordcloudSonificationTracksMappingNoteDurationWithin Within { get; set; }
		private PlotOptionsWordcloudSonificationTracksMappingNoteDurationWithin Within_DefaultValue { get; set; }
