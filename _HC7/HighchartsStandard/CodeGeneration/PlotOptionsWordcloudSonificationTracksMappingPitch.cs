...
{
	public partial class PlotOptionsWordcloudSonificationTracksMappingPitch  : BaseObject
	{
		Hashtable h = new Hashtable();

		public PlotOptionsWordcloudSonificationTracksMappingPitch()
		{
			MapFunction = MapFunction_DefaultValue = PlotOptionsWordcloudSonificationTracksMappingPitchMapFunction.Linear;
		...
		/// </summary>
		public PlotOptionsWordcloudSonificationTracksMappingPitchMapFunction MapFunction { get; set; }
		private PlotOptionsWordcloudSonificationTracksMappingPitchMapFunction MapFunction_DefaultValue { get; set; }
