...
{
	public partial class PlotOptionsWordcloudSonificationTracksPointGrouping  : BaseObject
	{
		Hashtable h = new Hashtable();

		public PlotOptionsWordcloudSonificationTracksPointGrouping()
		{
		...
		/// </summary>
		public PlotOptionsWordcloudSonificationTracksPointGroupingAlgorithm Algorithm { get; set; }
		private PlotOptionsWordcloudSonificationTracksPointGroupingAlgorithm Algorithm_DefaultValue { get; set; }
		...
		internal override Hashtable ToHashtable(Highcharts highcharts)
		{
			...
			if (Algorithm != PlotOptionsWordcloudSonificationTracksPointGroupingAlgorithm.Null) h.Add("algorithm", highcharts.FirstCharacterToLower(Algorithm.ToString()));
