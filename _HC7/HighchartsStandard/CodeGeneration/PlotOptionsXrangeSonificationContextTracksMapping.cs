...
{
	public partial class PlotOptionsXrangeSonificationContextTracksMapping  : BaseObject
	{
		Hashtable h = new Hashtable();

		public PlotOptionsXrangeSonificationContextTracksMapping()
		{
			Frequency = Frequency_DefaultValue = new PlotOptionsXrangeSonificationContextTracksMappingFrequency();
			GapBetweenNotes = GapBetweenNotes_DefaultValue = new PlotOptionsXrangeSonificationContextTracksMappingGapBetweenNotes();
			Highpass = Highpass_DefaultValue = new PlotOptionsXrangeSonificationContextTracksMappingHighpass();
			Lowpass = Lowpass_DefaultValue = new PlotOptionsXrangeSonificationContextTracksMappingLowpass();
			NoteDuration = NoteDuration_DefaultValue = new PlotOptionsXrangeSonificationContextTracksMappingNoteDuration();
			Pan = Pan_DefaultValue = new PlotOptionsXrangeSonificationContextTracksMappingPan();
			Pitch = Pitch_DefaultValue = new PlotOptionsXrangeSonificationContextTracksMappingPitch();
			PitchString = PitchString_DefaultValue = "null";
			PitchNumber = PitchNumber_DefaultValue = null;
			PlayDelay = PlayDelay_DefaultValue = new PlotOptionsXrangeSonificationContextTracksMappingPlayDelay();
			Time = Time_DefaultValue = new PlotOptionsXrangeSonificationContextTracksMappingTime();
			TimeString = TimeString_DefaultValue = "null";
			TimeNumber = TimeNumber_DefaultValue = null;
			Tremolo = Tremolo_DefaultValue = new PlotOptionsXrangeSonificationContextTracksMappingTremolo();
			Volume = Volume_DefaultValue = new PlotOptionsXrangeSonificationContextTracksMappingVolume();
		...
		/// </summary>
		public PlotOptionsXrangeSonificationContextTracksMappingFrequency Frequency { get; set; }
		private PlotOptionsXrangeSonificationContextTracksMappingFrequency Frequency_DefaultValue { get; set; }
		...
		/// </summary>
		public PlotOptionsXrangeSonificationContextTracksMappingGapBetweenNotes GapBetweenNotes { get; set; }
		private PlotOptionsXrangeSonificationContextTracksMappingGapBetweenNotes GapBetweenNotes_DefaultValue { get; set; }
		...
		/// </summary>
		public PlotOptionsXrangeSonificationContextTracksMappingHighpass Highpass { get; set; }
		private PlotOptionsXrangeSonificationContextTracksMappingHighpass Highpass_DefaultValue { get; set; }
		...
		/// </summary>
		public PlotOptionsXrangeSonificationContextTracksMappingLowpass Lowpass { get; set; }
		private PlotOptionsXrangeSonificationContextTracksMappingLowpass Lowpass_DefaultValue { get; set; }
		...
		/// </summary>
		public PlotOptionsXrangeSonificationContextTracksMappingNoteDuration NoteDuration { get; set; }
		private PlotOptionsXrangeSonificationContextTracksMappingNoteDuration NoteDuration_DefaultValue { get; set; }
		...
		/// </summary>
		public PlotOptionsXrangeSonificationContextTracksMappingPan Pan { get; set; }
		private PlotOptionsXrangeSonificationContextTracksMappingPan Pan_DefaultValue { get; set; }
		...
		/// </summary>
		public PlotOptionsXrangeSonificationContextTracksMappingPitch Pitch { get; set; }
		private PlotOptionsXrangeSonificationContextTracksMappingPitch Pitch_DefaultValue { get; set; }
		...
		/// </summary>
		public PlotOptionsXrangeSonificationContextTracksMappingPlayDelay PlayDelay { get; set; }
		private PlotOptionsXrangeSonificationContextTracksMappingPlayDelay PlayDelay_DefaultValue { get; set; }
		...
		/// </summary>
		public PlotOptionsXrangeSonificationContextTracksMappingTime Time { get; set; }
		private PlotOptionsXrangeSonificationContextTracksMappingTime Time_DefaultValue { get; set; }
		...
		/// </summary>
		public PlotOptionsXrangeSonificationContextTracksMappingTremolo Tremolo { get; set; }
		private PlotOptionsXrangeSonificationContextTracksMappingTremolo Tremolo_DefaultValue { get; set; }
		 

		/// <summary>
		/// The volume of notes, from 0 to 1.
		/// </summary>
		public PlotOptionsXrangeSonificationContextTracksMappingVolume Volume { get; set; }
		private PlotOptionsXrangeSonificationContextTracksMappingVolume Volume_DefaultValue { get; set; }
