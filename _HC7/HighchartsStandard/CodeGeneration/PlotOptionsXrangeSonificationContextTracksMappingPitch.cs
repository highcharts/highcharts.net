...
{
	public partial class PlotOptionsXrangeSonificationContextTracksMappingPitch  : BaseObject
	{
		Hashtable h = new Hashtable();

		public PlotOptionsXrangeSonificationContextTracksMappingPitch()
		{
			MapFunction = MapFunction_DefaultValue = PlotOptionsXrangeSonificationContextTracksMappingPitchMapFunction.Linear;
		...
		/// </summary>
		public PlotOptionsXrangeSonificationContextTracksMappingPitchMapFunction MapFunction { get; set; }
		private PlotOptionsXrangeSonificationContextTracksMappingPitchMapFunction MapFunction_DefaultValue { get; set; }
