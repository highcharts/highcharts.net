...
{
	public partial class PlotOptionsXrangeSonificationTracksMappingGapBetweenNotes  : BaseObject
	{
		Hashtable h = new Hashtable();

		public PlotOptionsXrangeSonificationTracksMappingGapBetweenNotes()
		{
			MapFunction = MapFunction_DefaultValue = PlotOptionsXrangeSonificationTracksMappingGapBetweenNotesMapFunction.Linear;
			MapTo = MapTo_DefaultValue = "";
			Max = Max_DefaultValue = null;
			Min = Min_DefaultValue = null;
			Value = Value_DefaultValue = null;
			Within = Within_DefaultValue = PlotOptionsXrangeSonificationTracksMappingGapBetweenNotesWithin.Chart;
		...
		/// </summary>
		public PlotOptionsXrangeSonificationTracksMappingGapBetweenNotesMapFunction MapFunction { get; set; }
		private PlotOptionsXrangeSonificationTracksMappingGapBetweenNotesMapFunction MapFunction_DefaultValue { get; set; }
		...
		/// </summary>
		public PlotOptionsXrangeSonificationTracksMappingGapBetweenNotesWithin Within { get; set; }
		private PlotOptionsXrangeSonificationTracksMappingGapBetweenNotesWithin Within_DefaultValue { get; set; }
