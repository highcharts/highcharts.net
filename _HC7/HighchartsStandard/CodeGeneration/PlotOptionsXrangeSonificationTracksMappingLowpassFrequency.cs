...
{
	public partial class PlotOptionsXrangeSonificationTracksMappingLowpassFrequency  : BaseObject
	{
		Hashtable h = new Hashtable();

		public PlotOptionsXrangeSonificationTracksMappingLowpassFrequency()
		{
			MapFunction = MapFunction_DefaultValue = PlotOptionsXrangeSonificationTracksMappingLowpassFrequencyMapFunction.Linear;
			MapTo = MapTo_DefaultValue = "";
			Max = Max_DefaultValue = null;
			Min = Min_DefaultValue = null;
			Value = Value_DefaultValue = null;
			Within = Within_DefaultValue = PlotOptionsXrangeSonificationTracksMappingLowpassFrequencyWithin.Chart;
		...
		/// </summary>
		public PlotOptionsXrangeSonificationTracksMappingLowpassFrequencyMapFunction MapFunction { get; set; }
		private PlotOptionsXrangeSonificationTracksMappingLowpassFrequencyMapFunction MapFunction_DefaultValue { get; set; }
		...
		/// </summary>
		public PlotOptionsXrangeSonificationTracksMappingLowpassFrequencyWithin Within { get; set; }
		private PlotOptionsXrangeSonificationTracksMappingLowpassFrequencyWithin Within_DefaultValue { get; set; }
