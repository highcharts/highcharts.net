...
{
	public partial class PlotOptionsXrangeSonificationTracksMappingVolume  : BaseObject
	{
		Hashtable h = new Hashtable();

		public PlotOptionsXrangeSonificationTracksMappingVolume()
		{
			MapFunction = MapFunction_DefaultValue = PlotOptionsXrangeSonificationTracksMappingVolumeMapFunction.Linear;
			MapTo = MapTo_DefaultValue = "";
			Max = Max_DefaultValue = null;
			Min = Min_DefaultValue = null;
			Value = Value_DefaultValue = null;
			Within = Within_DefaultValue = PlotOptionsXrangeSonificationTracksMappingVolumeWithin.Chart;
		...
		/// </summary>
		public PlotOptionsXrangeSonificationTracksMappingVolumeMapFunction MapFunction { get; set; }
		private PlotOptionsXrangeSonificationTracksMappingVolumeMapFunction MapFunction_DefaultValue { get; set; }
		...
		/// </summary>
		public PlotOptionsXrangeSonificationTracksMappingVolumeWithin Within { get; set; }
		private PlotOptionsXrangeSonificationTracksMappingVolumeWithin Within_DefaultValue { get; set; }
