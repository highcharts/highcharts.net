...
{
	public partial class PlotOptionsXrangeSonificationTracksPointGrouping  : BaseObject
	{
		Hashtable h = new Hashtable();

		public PlotOptionsXrangeSonificationTracksPointGrouping()
		{
		...
		/// </summary>
		public PlotOptionsXrangeSonificationTracksPointGroupingAlgorithm Algorithm { get; set; }
		private PlotOptionsXrangeSonificationTracksPointGroupingAlgorithm Algorithm_DefaultValue { get; set; }
		...
		internal override Hashtable ToHashtable(Highcharts highcharts)
		{
			...
			if (Algorithm != PlotOptionsXrangeSonificationTracksPointGroupingAlgorithm.Null) h.Add("algorithm", highcharts.FirstCharacterToLower(Algorithm.ToString()));
