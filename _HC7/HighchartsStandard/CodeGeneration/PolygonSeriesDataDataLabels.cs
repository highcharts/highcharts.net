...
{
	public partial class PolygonSeriesDataDataLabels  : BaseObject
	{
		Hashtable h = new Hashtable();

		public PolygonSeriesDataDataLabels()
		{
		...
		/// </summary>
		public PolygonSeriesDataDataLabelsAlign Align { get; set; }
		private PolygonSeriesDataDataLabelsAlign Align_DefaultValue { get; set; }
		...
		/// </summary>
		public PolygonSeriesDataDataLabelsFilter Filter { get; set; }
		private PolygonSeriesDataDataLabelsFilter Filter_DefaultValue { get; set; }
		...
		/// </summary>
		public PolygonSeriesDataDataLabelsOverflow Overflow { get; set; }
		private PolygonSeriesDataDataLabelsOverflow Overflow_DefaultValue { get; set; }
		...
		/// </summary>
		public PolygonSeriesDataDataLabelsPosition Position { get; set; }
		private PolygonSeriesDataDataLabelsPosition Position_DefaultValue { get; set; }
		...
		/// </summary>
		public PolygonSeriesDataDataLabelsTextPath TextPath { get; set; }
		private PolygonSeriesDataDataLabelsTextPath TextPath_DefaultValue { get; set; }
		...
		/// </summary>
		public PolygonSeriesDataDataLabelsVerticalAlign VerticalAlign { get; set; }
		private PolygonSeriesDataDataLabelsVerticalAlign VerticalAlign_DefaultValue { get; set; }
		...
		internal override Hashtable ToHashtable(Highcharts highcharts)
		{
			...
			if (Align != PolygonSeriesDataDataLabelsAlign.Null) h.Add("align", highcharts.FirstCharacterToLower(Align.ToString()));
			...
			if (Overflow != PolygonSeriesDataDataLabelsOverflow.Null) h.Add("overflow", highcharts.FirstCharacterToLower(Overflow.ToString()));
			if (Padding != null) h.Add("padding",Padding);
			if (Position != PolygonSeriesDataDataLabelsPosition.Null) h.Add("position", highcharts.FirstCharacterToLower(Position.ToString()));
			...
			if (VerticalAlign != PolygonSeriesDataDataLabelsVerticalAlign.Null) h.Add("verticalAlign", highcharts.FirstCharacterToLower(VerticalAlign.ToString()));
			if (X != null) h.Add("x",X);
			if (Y != null) h.Add("y",Y);
