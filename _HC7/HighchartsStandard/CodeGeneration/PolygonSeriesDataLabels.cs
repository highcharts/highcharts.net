...
namespace Highsoft.Web.Mvc.Charts
{
	public partial class PolygonSeriesDataLabels  : BaseObject
	{
		...
		/// </summary>
		public PolygonSeriesDataLabelsFilter Filter { get; set; }
		private PolygonSeriesDataLabelsFilter Filter_DefaultValue { get; set; }
		...
		/// </summary>
		public PolygonSeriesDataLabelsPosition Position { get; set; }
		private PolygonSeriesDataLabelsPosition Position_DefaultValue { get; set; }
		...
		/// </summary>
		public PolygonSeriesDataLabelsTextPath TextPath { get; set; }
		private PolygonSeriesDataLabelsTextPath TextPath_DefaultValue { get; set; }
		...
		internal override Hashtable ToHashtable(Highcharts highcharts)
		{
			...
			if (Align != PolygonSeriesDataLabelsAlign.Null) h.Add("align", highcharts.FirstCharacterToLower(Align.ToString()));
			...
			if (Overflow != PolygonSeriesDataLabelsOverflow.Null) h.Add("overflow", highcharts.FirstCharacterToLower(Overflow.ToString()));
			if (Padding != null) h.Add("padding",Padding);
			if (Position != PolygonSeriesDataLabelsPosition.Null) h.Add("position", highcharts.FirstCharacterToLower(Position.ToString()));
			...
			if (VerticalAlign != PolygonSeriesDataLabelsVerticalAlign.Null) h.Add("verticalAlign", highcharts.FirstCharacterToLower(VerticalAlign.ToString()));
			if (X != null) h.Add("x",X);
			if (Y != null) h.Add("y",Y);
