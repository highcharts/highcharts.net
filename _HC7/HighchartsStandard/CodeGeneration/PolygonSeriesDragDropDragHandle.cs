...
namespace Highsoft.Web.Mvc.Charts
{
	public partial class PolygonSeriesDragDropDragHandle  : BaseObject
	{
		...
		internal override Hashtable ToHashtable()
		{
			...
			if (PathFormatter != PathFormatter_DefaultValue) { h.Add("pathFormatter",PathFormatter); Highcharts.AddFunction("1deca497-0faf-4fd2-92eb-103a87076d60.pathFormatter", PathFormatter); }  
