...
namespace Highsoft.Web.Mvc.Charts
{
	public partial class PolygonSeriesDragDropDragHandle  : BaseObject
	{
		...
		internal override Hashtable ToHashtable()
		{
			...
			if (PathFormatter != PathFormatter_DefaultValue) { h.Add("pathFormatter",PathFormatter); Highcharts.AddFunction("aee593ce-7f79-45c2-96a1-ffeece3b8c31.pathFormatter", PathFormatter); }  
