...
{
	public partial class PolygonSeriesDragDropDragHandle  : BaseObject
	{
		public PolygonSeriesDragDropDragHandle()
		{
		...
		internal override Hashtable ToHashtable()
		{
			...
			if (PathFormatter != PathFormatter_DefaultValue) { h.Add("pathFormatter",PathFormatter); Highcharts.AddFunction("PolygonSeriesDragDropDragHandlePathFormatter.pathFormatter", PathFormatter); }  
