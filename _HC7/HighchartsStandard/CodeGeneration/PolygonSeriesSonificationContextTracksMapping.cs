...
{
	public partial class PolygonSeriesSonificationContextTracksMapping  : BaseObject
	{
		Hashtable h = new Hashtable();

		public PolygonSeriesSonificationContextTracksMapping()
		{
			Frequency = Frequency_DefaultValue = new PolygonSeriesSonificationContextTracksMappingFrequency();
			GapBetweenNotes = GapBetweenNotes_DefaultValue = new PolygonSeriesSonificationContextTracksMappingGapBetweenNotes();
			Highpass = Highpass_DefaultValue = new PolygonSeriesSonificationContextTracksMappingHighpass();
			Lowpass = Lowpass_DefaultValue = new PolygonSeriesSonificationContextTracksMappingLowpass();
			NoteDuration = NoteDuration_DefaultValue = new PolygonSeriesSonificationContextTracksMappingNoteDuration();
			Pan = Pan_DefaultValue = new PolygonSeriesSonificationContextTracksMappingPan();
			Pitch = Pitch_DefaultValue = new PolygonSeriesSonificationContextTracksMappingPitch();
			PitchString = PitchString_DefaultValue = "null";
			PitchNumber = PitchNumber_DefaultValue = null;
			PlayDelay = PlayDelay_DefaultValue = new PolygonSeriesSonificationContextTracksMappingPlayDelay();
			Time = Time_DefaultValue = new PolygonSeriesSonificationContextTracksMappingTime();
			TimeString = TimeString_DefaultValue = "null";
			TimeNumber = TimeNumber_DefaultValue = null;
			Tremolo = Tremolo_DefaultValue = new PolygonSeriesSonificationContextTracksMappingTremolo();
			Volume = Volume_DefaultValue = new PolygonSeriesSonificationContextTracksMappingVolume();
		...
		/// </summary>
		public PolygonSeriesSonificationContextTracksMappingFrequency Frequency { get; set; }
		private PolygonSeriesSonificationContextTracksMappingFrequency Frequency_DefaultValue { get; set; }
		...
		/// </summary>
		public PolygonSeriesSonificationContextTracksMappingGapBetweenNotes GapBetweenNotes { get; set; }
		private PolygonSeriesSonificationContextTracksMappingGapBetweenNotes GapBetweenNotes_DefaultValue { get; set; }
		...
		/// </summary>
		public PolygonSeriesSonificationContextTracksMappingHighpass Highpass { get; set; }
		private PolygonSeriesSonificationContextTracksMappingHighpass Highpass_DefaultValue { get; set; }
		...
		/// </summary>
		public PolygonSeriesSonificationContextTracksMappingLowpass Lowpass { get; set; }
		private PolygonSeriesSonificationContextTracksMappingLowpass Lowpass_DefaultValue { get; set; }
		...
		/// </summary>
		public PolygonSeriesSonificationContextTracksMappingNoteDuration NoteDuration { get; set; }
		private PolygonSeriesSonificationContextTracksMappingNoteDuration NoteDuration_DefaultValue { get; set; }
		...
		/// </summary>
		public PolygonSeriesSonificationContextTracksMappingPan Pan { get; set; }
		private PolygonSeriesSonificationContextTracksMappingPan Pan_DefaultValue { get; set; }
		...
		/// </summary>
		public PolygonSeriesSonificationContextTracksMappingPitch Pitch { get; set; }
		private PolygonSeriesSonificationContextTracksMappingPitch Pitch_DefaultValue { get; set; }
		...
		/// </summary>
		public PolygonSeriesSonificationContextTracksMappingPlayDelay PlayDelay { get; set; }
		private PolygonSeriesSonificationContextTracksMappingPlayDelay PlayDelay_DefaultValue { get; set; }
		...
		/// </summary>
		public PolygonSeriesSonificationContextTracksMappingTime Time { get; set; }
		private PolygonSeriesSonificationContextTracksMappingTime Time_DefaultValue { get; set; }
		...
		/// </summary>
		public PolygonSeriesSonificationContextTracksMappingTremolo Tremolo { get; set; }
		private PolygonSeriesSonificationContextTracksMappingTremolo Tremolo_DefaultValue { get; set; }
		 

		/// <summary>
		/// The volume of notes, from 0 to 1.
		/// </summary>
		public PolygonSeriesSonificationContextTracksMappingVolume Volume { get; set; }
		private PolygonSeriesSonificationContextTracksMappingVolume Volume_DefaultValue { get; set; }
