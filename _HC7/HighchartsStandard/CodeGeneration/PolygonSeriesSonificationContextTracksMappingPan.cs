...
{
	public partial class PolygonSeriesSonificationContextTracksMappingPan  : BaseObject
	{
		Hashtable h = new Hashtable();

		public PolygonSeriesSonificationContextTracksMappingPan()
		{
			MapFunction = MapFunction_DefaultValue = PolygonSeriesSonificationContextTracksMappingPanMapFunction.Linear;
			MapTo = MapTo_DefaultValue = "";
			Max = Max_DefaultValue = null;
			Min = Min_DefaultValue = null;
			Value = Value_DefaultValue = null;
			Within = Within_DefaultValue = PolygonSeriesSonificationContextTracksMappingPanWithin.Chart;
		...
		/// </summary>
		public PolygonSeriesSonificationContextTracksMappingPanMapFunction MapFunction { get; set; }
		private PolygonSeriesSonificationContextTracksMappingPanMapFunction MapFunction_DefaultValue { get; set; }
		...
		/// </summary>
		public PolygonSeriesSonificationContextTracksMappingPanWithin Within { get; set; }
		private PolygonSeriesSonificationContextTracksMappingPanWithin Within_DefaultValue { get; set; }
