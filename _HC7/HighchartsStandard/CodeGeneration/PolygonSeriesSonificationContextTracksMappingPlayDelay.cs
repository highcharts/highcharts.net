...
{
	public partial class PolygonSeriesSonificationContextTracksMappingPlayDelay  : BaseObject
	{
		Hashtable h = new Hashtable();

		public PolygonSeriesSonificationContextTracksMappingPlayDelay()
		{
			MapFunction = MapFunction_DefaultValue = PolygonSeriesSonificationContextTracksMappingPlayDelayMapFunction.Linear;
			MapTo = MapTo_DefaultValue = "";
			Max = Max_DefaultValue = null;
			Min = Min_DefaultValue = null;
			Value = Value_DefaultValue = null;
			Within = Within_DefaultValue = PolygonSeriesSonificationContextTracksMappingPlayDelayWithin.Chart;
		...
		/// </summary>
		public PolygonSeriesSonificationContextTracksMappingPlayDelayMapFunction MapFunction { get; set; }
		private PolygonSeriesSonificationContextTracksMappingPlayDelayMapFunction MapFunction_DefaultValue { get; set; }
		...
		/// </summary>
		public PolygonSeriesSonificationContextTracksMappingPlayDelayWithin Within { get; set; }
		private PolygonSeriesSonificationContextTracksMappingPlayDelayWithin Within_DefaultValue { get; set; }
