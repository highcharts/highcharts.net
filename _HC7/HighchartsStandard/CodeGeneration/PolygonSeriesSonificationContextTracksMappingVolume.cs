...
{
	public partial class PolygonSeriesSonificationContextTracksMappingVolume  : BaseObject
	{
		Hashtable h = new Hashtable();

		public PolygonSeriesSonificationContextTracksMappingVolume()
		{
			MapFunction = MapFunction_DefaultValue = PolygonSeriesSonificationContextTracksMappingVolumeMapFunction.Linear;
			MapTo = MapTo_DefaultValue = "";
			Max = Max_DefaultValue = null;
			Min = Min_DefaultValue = null;
			Value = Value_DefaultValue = null;
			Within = Within_DefaultValue = PolygonSeriesSonificationContextTracksMappingVolumeWithin.Chart;
		...
		/// </summary>
		public PolygonSeriesSonificationContextTracksMappingVolumeMapFunction MapFunction { get; set; }
		private PolygonSeriesSonificationContextTracksMappingVolumeMapFunction MapFunction_DefaultValue { get; set; }
		...
		/// </summary>
		public PolygonSeriesSonificationContextTracksMappingVolumeWithin Within { get; set; }
		private PolygonSeriesSonificationContextTracksMappingVolumeWithin Within_DefaultValue { get; set; }
