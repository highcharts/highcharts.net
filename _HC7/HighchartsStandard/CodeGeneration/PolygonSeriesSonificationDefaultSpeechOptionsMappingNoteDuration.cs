...
{
	public partial class PolygonSeriesSonificationDefaultSpeechOptionsMappingNoteDuration  : BaseObject
	{
		Hashtable h = new Hashtable();

		public PolygonSeriesSonificationDefaultSpeechOptionsMappingNoteDuration()
		{
			MapFunction = MapFunction_DefaultValue = PolygonSeriesSonificationDefaultSpeechOptionsMappingNoteDurationMapFunction.Linear;
			MapTo = MapTo_DefaultValue = "";
			Max = Max_DefaultValue = null;
			Min = Min_DefaultValue = null;
			Value = Value_DefaultValue = null;
			Within = Within_DefaultValue = PolygonSeriesSonificationDefaultSpeechOptionsMappingNoteDurationWithin.Chart;
		...
		/// </summary>
		public PolygonSeriesSonificationDefaultSpeechOptionsMappingNoteDurationMapFunction MapFunction { get; set; }
		private PolygonSeriesSonificationDefaultSpeechOptionsMappingNoteDurationMapFunction MapFunction_DefaultValue { get; set; }
		...
		/// </summary>
		public PolygonSeriesSonificationDefaultSpeechOptionsMappingNoteDurationWithin Within { get; set; }
		private PolygonSeriesSonificationDefaultSpeechOptionsMappingNoteDurationWithin Within_DefaultValue { get; set; }
