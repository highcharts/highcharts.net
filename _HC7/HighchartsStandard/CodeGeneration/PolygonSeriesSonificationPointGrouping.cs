...
{
	public partial class PolygonSeriesSonificationPointGrouping  : BaseObject
	{
		Hashtable h = new Hashtable();

		public PolygonSeriesSonificationPointGrouping()
		{
		...
		/// </summary>
		public PolygonSeriesSonificationPointGroupingAlgorithm Algorithm { get; set; }
		private PolygonSeriesSonificationPointGroupingAlgorithm Algorithm_DefaultValue { get; set; }
		...
		internal override Hashtable ToHashtable(Highcharts highcharts)
		{
			...
			if (Algorithm != PolygonSeriesSonificationPointGroupingAlgorithm.Null) h.Add("algorithm", highcharts.FirstCharacterToLower(Algorithm.ToString()));
