...
{
	public partial class PolygonSeriesSonificationTracksMapping  : BaseObject
	{
		Hashtable h = new Hashtable();

		public PolygonSeriesSonificationTracksMapping()
		{
			Frequency = Frequency_DefaultValue = new PolygonSeriesSonificationTracksMappingFrequency();
			GapBetweenNotes = GapBetweenNotes_DefaultValue = new PolygonSeriesSonificationTracksMappingGapBetweenNotes();
			Highpass = Highpass_DefaultValue = new PolygonSeriesSonificationTracksMappingHighpass();
			Lowpass = Lowpass_DefaultValue = new PolygonSeriesSonificationTracksMappingLowpass();
			NoteDuration = NoteDuration_DefaultValue = new PolygonSeriesSonificationTracksMappingNoteDuration();
			Pan = Pan_DefaultValue = new PolygonSeriesSonificationTracksMappingPan();
			Pitch = Pitch_DefaultValue = new PolygonSeriesSonificationTracksMappingPitch();
			PitchString = PitchString_DefaultValue = "null";
			PitchNumber = PitchNumber_DefaultValue = null;
			PlayDelay = PlayDelay_DefaultValue = new PolygonSeriesSonificationTracksMappingPlayDelay();
			Time = Time_DefaultValue = new PolygonSeriesSonificationTracksMappingTime();
			TimeString = TimeString_DefaultValue = "null";
			TimeNumber = TimeNumber_DefaultValue = null;
			Tremolo = Tremolo_DefaultValue = new PolygonSeriesSonificationTracksMappingTremolo();
			Volume = Volume_DefaultValue = new PolygonSeriesSonificationTracksMappingVolume();
		...
		/// </summary>
		public PolygonSeriesSonificationTracksMappingFrequency Frequency { get; set; }
		private PolygonSeriesSonificationTracksMappingFrequency Frequency_DefaultValue { get; set; }
		...
		/// </summary>
		public PolygonSeriesSonificationTracksMappingGapBetweenNotes GapBetweenNotes { get; set; }
		private PolygonSeriesSonificationTracksMappingGapBetweenNotes GapBetweenNotes_DefaultValue { get; set; }
		...
		/// </summary>
		public PolygonSeriesSonificationTracksMappingHighpass Highpass { get; set; }
		private PolygonSeriesSonificationTracksMappingHighpass Highpass_DefaultValue { get; set; }
		...
		/// </summary>
		public PolygonSeriesSonificationTracksMappingLowpass Lowpass { get; set; }
		private PolygonSeriesSonificationTracksMappingLowpass Lowpass_DefaultValue { get; set; }
		...
		/// </summary>
		public PolygonSeriesSonificationTracksMappingNoteDuration NoteDuration { get; set; }
		private PolygonSeriesSonificationTracksMappingNoteDuration NoteDuration_DefaultValue { get; set; }
		...
		/// </summary>
		public PolygonSeriesSonificationTracksMappingPan Pan { get; set; }
		private PolygonSeriesSonificationTracksMappingPan Pan_DefaultValue { get; set; }
		...
		/// </summary>
		public PolygonSeriesSonificationTracksMappingPitch Pitch { get; set; }
		private PolygonSeriesSonificationTracksMappingPitch Pitch_DefaultValue { get; set; }
		...
		/// </summary>
		public PolygonSeriesSonificationTracksMappingPlayDelay PlayDelay { get; set; }
		private PolygonSeriesSonificationTracksMappingPlayDelay PlayDelay_DefaultValue { get; set; }
		...
		/// </summary>
		public PolygonSeriesSonificationTracksMappingTime Time { get; set; }
		private PolygonSeriesSonificationTracksMappingTime Time_DefaultValue { get; set; }
		...
		/// </summary>
		public PolygonSeriesSonificationTracksMappingTremolo Tremolo { get; set; }
		private PolygonSeriesSonificationTracksMappingTremolo Tremolo_DefaultValue { get; set; }
		 

		/// <summary>
		/// The volume of notes, from 0 to 1.
		/// </summary>
		public PolygonSeriesSonificationTracksMappingVolume Volume { get; set; }
		private PolygonSeriesSonificationTracksMappingVolume Volume_DefaultValue { get; set; }
