...
{
	public partial class PolygonSeriesSonificationTracksMappingFrequency  : BaseObject
	{
		Hashtable h = new Hashtable();

		public PolygonSeriesSonificationTracksMappingFrequency()
		{
			MapFunction = MapFunction_DefaultValue = PolygonSeriesSonificationTracksMappingFrequencyMapFunction.Linear;
			MapTo = MapTo_DefaultValue = "";
			Max = Max_DefaultValue = null;
			Min = Min_DefaultValue = null;
			Value = Value_DefaultValue = null;
			Within = Within_DefaultValue = PolygonSeriesSonificationTracksMappingFrequencyWithin.Chart;
		...
		/// </summary>
		public PolygonSeriesSonificationTracksMappingFrequencyMapFunction MapFunction { get; set; }
		private PolygonSeriesSonificationTracksMappingFrequencyMapFunction MapFunction_DefaultValue { get; set; }
		...
		/// </summary>
		public PolygonSeriesSonificationTracksMappingFrequencyWithin Within { get; set; }
		private PolygonSeriesSonificationTracksMappingFrequencyWithin Within_DefaultValue { get; set; }
