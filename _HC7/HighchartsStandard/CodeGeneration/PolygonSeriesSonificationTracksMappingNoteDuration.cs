...
{
	public partial class PolygonSeriesSonificationTracksMappingNoteDuration  : BaseObject
	{
		Hashtable h = new Hashtable();

		public PolygonSeriesSonificationTracksMappingNoteDuration()
		{
			MapFunction = MapFunction_DefaultValue = PolygonSeriesSonificationTracksMappingNoteDurationMapFunction.Linear;
			MapTo = MapTo_DefaultValue = "";
			Max = Max_DefaultValue = null;
			Min = Min_DefaultValue = null;
			Value = Value_DefaultValue = null;
			Within = Within_DefaultValue = PolygonSeriesSonificationTracksMappingNoteDurationWithin.Chart;
		...
		/// </summary>
		public PolygonSeriesSonificationTracksMappingNoteDurationMapFunction MapFunction { get; set; }
		private PolygonSeriesSonificationTracksMappingNoteDurationMapFunction MapFunction_DefaultValue { get; set; }
		...
		/// </summary>
		public PolygonSeriesSonificationTracksMappingNoteDurationWithin Within { get; set; }
		private PolygonSeriesSonificationTracksMappingNoteDurationWithin Within_DefaultValue { get; set; }
