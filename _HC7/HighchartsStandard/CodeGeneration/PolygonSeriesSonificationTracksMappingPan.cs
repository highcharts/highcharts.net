...
{
	public partial class PolygonSeriesSonificationTracksMappingPan  : BaseObject
	{
		Hashtable h = new Hashtable();

		public PolygonSeriesSonificationTracksMappingPan()
		{
			MapFunction = MapFunction_DefaultValue = PolygonSeriesSonificationTracksMappingPanMapFunction.Linear;
			MapTo = MapTo_DefaultValue = "";
			Max = Max_DefaultValue = null;
			Min = Min_DefaultValue = null;
			Value = Value_DefaultValue = null;
			Within = Within_DefaultValue = PolygonSeriesSonificationTracksMappingPanWithin.Chart;
		...
		/// </summary>
		public PolygonSeriesSonificationTracksMappingPanMapFunction MapFunction { get; set; }
		private PolygonSeriesSonificationTracksMappingPanMapFunction MapFunction_DefaultValue { get; set; }
		...
		/// </summary>
		public PolygonSeriesSonificationTracksMappingPanWithin Within { get; set; }
		private PolygonSeriesSonificationTracksMappingPanWithin Within_DefaultValue { get; set; }
