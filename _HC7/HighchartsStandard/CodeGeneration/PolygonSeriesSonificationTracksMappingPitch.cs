...
{
	public partial class PolygonSeriesSonificationTracksMappingPitch  : BaseObject
	{
		Hashtable h = new Hashtable();

		public PolygonSeriesSonificationTracksMappingPitch()
		{
			MapFunction = MapFunction_DefaultValue = PolygonSeriesSonificationTracksMappingPitchMapFunction.Linear;
		...
		/// </summary>
		public PolygonSeriesSonificationTracksMappingPitchMapFunction MapFunction { get; set; }
		private PolygonSeriesSonificationTracksMappingPitchMapFunction MapFunction_DefaultValue { get; set; }
