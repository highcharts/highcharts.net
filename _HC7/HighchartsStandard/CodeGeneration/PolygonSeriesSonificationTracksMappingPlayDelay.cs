...
{
	public partial class PolygonSeriesSonificationTracksMappingPlayDelay  : BaseObject
	{
		Hashtable h = new Hashtable();

		public PolygonSeriesSonificationTracksMappingPlayDelay()
		{
			MapFunction = MapFunction_DefaultValue = PolygonSeriesSonificationTracksMappingPlayDelayMapFunction.Linear;
			MapTo = MapTo_DefaultValue = "";
			Max = Max_DefaultValue = null;
			Min = Min_DefaultValue = null;
			Value = Value_DefaultValue = null;
			Within = Within_DefaultValue = PolygonSeriesSonificationTracksMappingPlayDelayWithin.Chart;
		...
		/// </summary>
		public PolygonSeriesSonificationTracksMappingPlayDelayMapFunction MapFunction { get; set; }
		private PolygonSeriesSonificationTracksMappingPlayDelayMapFunction MapFunction_DefaultValue { get; set; }
		...
		/// </summary>
		public PolygonSeriesSonificationTracksMappingPlayDelayWithin Within { get; set; }
		private PolygonSeriesSonificationTracksMappingPlayDelayWithin Within_DefaultValue { get; set; }
