...
{
	public partial class PolygonSeriesSonificationTracksMappingTime  : BaseObject
	{
		Hashtable h = new Hashtable();

		public PolygonSeriesSonificationTracksMappingTime()
		{
			MapFunction = MapFunction_DefaultValue = PolygonSeriesSonificationTracksMappingTimeMapFunction.Linear;
			MapTo = MapTo_DefaultValue = "";
			Max = Max_DefaultValue = null;
			Min = Min_DefaultValue = null;
			Value = Value_DefaultValue = null;
			Within = Within_DefaultValue = PolygonSeriesSonificationTracksMappingTimeWithin.Chart;
		...
		/// </summary>
		public PolygonSeriesSonificationTracksMappingTimeMapFunction MapFunction { get; set; }
		private PolygonSeriesSonificationTracksMappingTimeMapFunction MapFunction_DefaultValue { get; set; }
		...
		/// </summary>
		public PolygonSeriesSonificationTracksMappingTimeWithin Within { get; set; }
		private PolygonSeriesSonificationTracksMappingTimeWithin Within_DefaultValue { get; set; }
