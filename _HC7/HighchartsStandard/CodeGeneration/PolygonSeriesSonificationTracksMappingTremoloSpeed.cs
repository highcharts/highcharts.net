...
{
	public partial class PolygonSeriesSonificationTracksMappingTremoloSpeed  : BaseObject
	{
		Hashtable h = new Hashtable();

		public PolygonSeriesSonificationTracksMappingTremoloSpeed()
		{
			MapFunction = MapFunction_DefaultValue = PolygonSeriesSonificationTracksMappingTremoloSpeedMapFunction.Linear;
			MapTo = MapTo_DefaultValue = "";
			Max = Max_DefaultValue = null;
			Min = Min_DefaultValue = null;
			Value = Value_DefaultValue = null;
			Within = Within_DefaultValue = PolygonSeriesSonificationTracksMappingTremoloSpeedWithin.Chart;
		...
		/// </summary>
		public PolygonSeriesSonificationTracksMappingTremoloSpeedMapFunction MapFunction { get; set; }
		private PolygonSeriesSonificationTracksMappingTremoloSpeedMapFunction MapFunction_DefaultValue { get; set; }
		...
		/// </summary>
		public PolygonSeriesSonificationTracksMappingTremoloSpeedWithin Within { get; set; }
		private PolygonSeriesSonificationTracksMappingTremoloSpeedWithin Within_DefaultValue { get; set; }
