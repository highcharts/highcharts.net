...
{
	public partial class PolygonSeriesSonificationTracksMappingVolume  : BaseObject
	{
		Hashtable h = new Hashtable();

		public PolygonSeriesSonificationTracksMappingVolume()
		{
			MapFunction = MapFunction_DefaultValue = PolygonSeriesSonificationTracksMappingVolumeMapFunction.Linear;
			MapTo = MapTo_DefaultValue = "";
			Max = Max_DefaultValue = null;
			Min = Min_DefaultValue = null;
			Value = Value_DefaultValue = null;
			Within = Within_DefaultValue = PolygonSeriesSonificationTracksMappingVolumeWithin.Chart;
		...
		/// </summary>
		public PolygonSeriesSonificationTracksMappingVolumeMapFunction MapFunction { get; set; }
		private PolygonSeriesSonificationTracksMappingVolumeMapFunction MapFunction_DefaultValue { get; set; }
		...
		/// </summary>
		public PolygonSeriesSonificationTracksMappingVolumeWithin Within { get; set; }
		private PolygonSeriesSonificationTracksMappingVolumeWithin Within_DefaultValue { get; set; }
