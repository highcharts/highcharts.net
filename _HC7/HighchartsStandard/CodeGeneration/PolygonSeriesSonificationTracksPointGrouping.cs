...
{
	public partial class PolygonSeriesSonificationTracksPointGrouping  : BaseObject
	{
		Hashtable h = new Hashtable();

		public PolygonSeriesSonificationTracksPointGrouping()
		{
		...
		/// </summary>
		public PolygonSeriesSonificationTracksPointGroupingAlgorithm Algorithm { get; set; }
		private PolygonSeriesSonificationTracksPointGroupingAlgorithm Algorithm_DefaultValue { get; set; }
		...
		internal override Hashtable ToHashtable(Highcharts highcharts)
		{
			...
			if (Algorithm != PolygonSeriesSonificationTracksPointGroupingAlgorithm.Null) h.Add("algorithm", highcharts.FirstCharacterToLower(Algorithm.ToString()));
