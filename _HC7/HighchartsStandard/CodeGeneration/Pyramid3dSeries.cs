...
namespace Highsoft.Web.Mvc.Charts
{
	public partial class Pyramid3dSeries  : Series
	{
		...
		/// </summary>
		public Pyramid3dSeriesDashStyle DashStyle { get; set; }
		private Pyramid3dSeriesDashStyle DashStyle_DefaultValue { get; set; }
		...
		/// </summary>
		public Pyramid3dSeriesLegendSymbol LegendSymbol { get; set; }
		private Pyramid3dSeriesLegendSymbol LegendSymbol_DefaultValue { get; set; }
		...
		/// </summary>
		public Pyramid3dSeriesPointPlacement PointPlacement { get; set; }
		private Pyramid3dSeriesPointPlacement PointPlacement_DefaultValue { get; set; }
		...
		/// </summary>
		public Pyramid3dSeriesSonification Sonification { get; set; }
		private Pyramid3dSeriesSonification Sonification_DefaultValue { get; set; }
		...
		internal override Hashtable ToHashtable(Highcharts highcharts)
		{
			...
			if (Cursor != Pyramid3dSeriesCursor.Null) h.Add("cursor", highcharts.FirstCharacterToLower(Cursor.ToString()));
			if (Custom != null) h.Add("custom",Custom);
			if (DashStyle != Pyramid3dSeriesDashStyle.Null) h.Add("dashStyle", highcharts.FirstCharacterToLower(DashStyle.ToString()));
			...
			if (FindNearestPointBy != Pyramid3dSeriesFindNearestPointBy.Null) h.Add("findNearestPointBy", highcharts.FirstCharacterToLower(FindNearestPointBy.ToString()));
			...
			if (LegendSymbol != Pyramid3dSeriesLegendSymbol.Null) h.Add("legendSymbol", highcharts.FirstCharacterToLower(LegendSymbol.ToString()));
			...
			if (PointIntervalUnit != Pyramid3dSeriesPointIntervalUnit.Null) h.Add("pointIntervalUnit", highcharts.FirstCharacterToLower(PointIntervalUnit.ToString()));
			if (PointPadding != null) h.Add("pointPadding",PointPadding);
			if (PointPlacement != Pyramid3dSeriesPointPlacement.Null) h.Add("pointPlacement", highcharts.FirstCharacterToLower(PointPlacement.ToString()));
			...
			if (Stacking != Pyramid3dSeriesStacking.Null) h.Add("stacking", highcharts.FirstCharacterToLower(Stacking.ToString()));
