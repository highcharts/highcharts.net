...
namespace Highsoft.Web.Mvc.Charts
{
	public partial class Pyramid3dSeries  : Series
	{
		...
		public Pyramid3dSeries()
		{
			...
			DashStyle = DashStyle_DefaultValue = Pyramid3dSeriesDashStyle.Null;
			...
			Dumbell = Dumbell_DefaultValue = new Pyramid3dSeriesDumbell();
			...
			LegendSymbol = LegendSymbol_DefaultValue = Pyramid3dSeriesLegendSymbol.Rectangle;
			...
			Sonification = Sonification_DefaultValue = new Pyramid3dSeriesSonification();
		...
		/// 
		/// </summary>
		public Pyramid3dSeriesDumbell Dumbell { get; set; }
		private Pyramid3dSeriesDumbell Dumbell_DefaultValue { get; set; }
