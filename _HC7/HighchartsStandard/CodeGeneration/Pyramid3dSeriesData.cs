...
{
	public partial class Pyramid3dSeriesData  : BaseObject
	{
		...
		/// </summary>
		public Pyramid3dSeriesDataAccessibility Accessibility { get; set; }
		private Pyramid3dSeriesDataAccessibility Accessibility_DefaultValue { get; set; }
		...
		/// </summary>
		public Pyramid3dSeriesDataDragDrop DragDrop { get; set; }
		private Pyramid3dSeriesDataDragDrop DragDrop_DefaultValue { get; set; }
		...
		/// </summary>
		public Pyramid3dSeriesDataEvents Events { get; set; }
		private Pyramid3dSeriesDataEvents Events_DefaultValue { get; set; }
		...
		internal override Hashtable ToHashtable(Highcharts highcharts)
		{
			...
			if (DashStyle != Pyramid3dSeriesDataDashStyle.Null) h.Add("dashStyle", highcharts.FirstCharacterToLower(DashStyle.ToString()));
