...
{
	public partial class Pyramid3dSeriesDataDataLabels  : BaseObject
	{
		Hashtable h = new Hashtable();

		public Pyramid3dSeriesDataDataLabels()
		{
		...
		/// </summary>
		public Pyramid3dSeriesDataDataLabelsAlign Align { get; set; }
		private Pyramid3dSeriesDataDataLabelsAlign Align_DefaultValue { get; set; }
		...
		/// </summary>
		public Pyramid3dSeriesDataDataLabelsFilter Filter { get; set; }
		private Pyramid3dSeriesDataDataLabelsFilter Filter_DefaultValue { get; set; }
		...
		/// </summary>
		public Pyramid3dSeriesDataDataLabelsOverflow Overflow { get; set; }
		private Pyramid3dSeriesDataDataLabelsOverflow Overflow_DefaultValue { get; set; }
		...
		/// </summary>
		public Pyramid3dSeriesDataDataLabelsPosition Position { get; set; }
		private Pyramid3dSeriesDataDataLabelsPosition Position_DefaultValue { get; set; }
		...
		/// </summary>
		public Pyramid3dSeriesDataDataLabelsTextPath TextPath { get; set; }
		private Pyramid3dSeriesDataDataLabelsTextPath TextPath_DefaultValue { get; set; }
		...
		/// </summary>
		public Pyramid3dSeriesDataDataLabelsVerticalAlign VerticalAlign { get; set; }
		private Pyramid3dSeriesDataDataLabelsVerticalAlign VerticalAlign_DefaultValue { get; set; }
		...
		internal override Hashtable ToHashtable(Highcharts highcharts)
		{
			...
			if (Align != Pyramid3dSeriesDataDataLabelsAlign.Null) h.Add("align", highcharts.FirstCharacterToLower(Align.ToString()));
			...
			if (Overflow != Pyramid3dSeriesDataDataLabelsOverflow.Null) h.Add("overflow", highcharts.FirstCharacterToLower(Overflow.ToString()));
			if (Padding != null) h.Add("padding",Padding);
			if (Position != Pyramid3dSeriesDataDataLabelsPosition.Null) h.Add("position", highcharts.FirstCharacterToLower(Position.ToString()));
			...
			if (VerticalAlign != Pyramid3dSeriesDataDataLabelsVerticalAlign.Null) h.Add("verticalAlign", highcharts.FirstCharacterToLower(VerticalAlign.ToString()));
			if (X != null) h.Add("x",X);
			if (Y != null) h.Add("y",Y);
