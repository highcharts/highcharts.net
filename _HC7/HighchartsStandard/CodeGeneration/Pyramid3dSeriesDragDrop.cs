...
{
	public partial class Pyramid3dSeriesDragDrop  : BaseObject
	{
		public Pyramid3dSeriesDragDrop()
		{
			DraggableX = DraggableX_DefaultValue = null;
			DraggableY = DraggableY_DefaultValue = null;
			DragHandle = DragHandle_DefaultValue = new Pyramid3dSeriesDragDropDragHandle();
			...
			GuideBox = GuideBox_DefaultValue = new Pyramid3dSeriesDragDropGuideBox();
		...
		/// </summary>
		public Pyramid3dSeriesDragDropDragHandle DragHandle { get; set; }
		private Pyramid3dSeriesDragDropDragHandle DragHandle_DefaultValue { get; set; }
		...
		/// </summary>
		public Pyramid3dSeriesDragDropGuideBox GuideBox { get; set; }
		private Pyramid3dSeriesDragDropGuideBox GuideBox_DefaultValue { get; set; }
