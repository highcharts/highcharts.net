...
{
	public partial class Pyramid3dSeriesDragDropDragHandle  : BaseObject
	{
		public Pyramid3dSeriesDragDropDragHandle()
		{
		...
		internal override Hashtable ToHashtable()
		{
			...
			if (PathFormatter != PathFormatter_DefaultValue) { h.Add("pathFormatter",PathFormatter); Highcharts.AddFunction("Pyramid3dSeriesDragDropDragHandlePathFormatter.pathFormatter", PathFormatter); }  
