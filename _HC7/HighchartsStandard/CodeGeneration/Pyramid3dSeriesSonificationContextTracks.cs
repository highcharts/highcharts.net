...
{
	public partial class Pyramid3dSeriesSonificationContextTracks  : BaseObject
	{
		Hashtable h = new Hashtable();

		public Pyramid3dSeriesSonificationContextTracks()
		{
			ActiveWhen = ActiveWhen_DefaultValue = new Pyramid3dSeriesSonificationContextTracksActiveWhen();
			Instrument = Instrument_DefaultValue = null;
			InstrumentString = InstrumentString_DefaultValue = "null";
			Mapping = Mapping_DefaultValue = new Pyramid3dSeriesSonificationContextTracksMapping();
			MidiName = MidiName_DefaultValue = "";
			PointGrouping = PointGrouping_DefaultValue = new Pyramid3dSeriesSonificationContextTracksPointGrouping();
			...
			Type = Type_DefaultValue = Pyramid3dSeriesSonificationContextTracksType.Instrument;
			ValueInterval = ValueInterval_DefaultValue = null;
			ValueMapFunction = ValueMapFunction_DefaultValue = Pyramid3dSeriesSonificationContextTracksValueMapFunction.Linear;
		...
		/// </summary>
		public Pyramid3dSeriesSonificationContextTracksActiveWhen ActiveWhen { get; set; }
		private Pyramid3dSeriesSonificationContextTracksActiveWhen ActiveWhen_DefaultValue { get; set; }
		...
		/// </summary>
		public Pyramid3dSeriesSonificationContextTracksMapping Mapping { get; set; }
		private Pyramid3dSeriesSonificationContextTracksMapping Mapping_DefaultValue { get; set; }
		...
		/// </summary>
		public Pyramid3dSeriesSonificationContextTracksPointGrouping PointGrouping { get; set; }
		private Pyramid3dSeriesSonificationContextTracksPointGrouping PointGrouping_DefaultValue { get; set; }
		...
		/// </summary>
		public Pyramid3dSeriesSonificationContextTracksType Type { get; set; }
		private Pyramid3dSeriesSonificationContextTracksType Type_DefaultValue { get; set; }
		...
		/// </summary>
		public Pyramid3dSeriesSonificationContextTracksValueMapFunction ValueMapFunction { get; set; }
		private Pyramid3dSeriesSonificationContextTracksValueMapFunction ValueMapFunction_DefaultValue { get; set; }
