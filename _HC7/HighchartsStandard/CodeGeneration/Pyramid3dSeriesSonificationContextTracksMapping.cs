...
{
	public partial class Pyramid3dSeriesSonificationContextTracksMapping  : BaseObject
	{
		Hashtable h = new Hashtable();

		public Pyramid3dSeriesSonificationContextTracksMapping()
		{
			Frequency = Frequency_DefaultValue = new Pyramid3dSeriesSonificationContextTracksMappingFrequency();
			GapBetweenNotes = GapBetweenNotes_DefaultValue = new Pyramid3dSeriesSonificationContextTracksMappingGapBetweenNotes();
			Highpass = Highpass_DefaultValue = new Pyramid3dSeriesSonificationContextTracksMappingHighpass();
			Lowpass = Lowpass_DefaultValue = new Pyramid3dSeriesSonificationContextTracksMappingLowpass();
			NoteDuration = NoteDuration_DefaultValue = new Pyramid3dSeriesSonificationContextTracksMappingNoteDuration();
			Pan = Pan_DefaultValue = new Pyramid3dSeriesSonificationContextTracksMappingPan();
			Pitch = Pitch_DefaultValue = new Pyramid3dSeriesSonificationContextTracksMappingPitch();
			PitchString = PitchString_DefaultValue = "null";
			PitchNumber = PitchNumber_DefaultValue = null;
			PlayDelay = PlayDelay_DefaultValue = new Pyramid3dSeriesSonificationContextTracksMappingPlayDelay();
			Time = Time_DefaultValue = new Pyramid3dSeriesSonificationContextTracksMappingTime();
			TimeString = TimeString_DefaultValue = "null";
			TimeNumber = TimeNumber_DefaultValue = null;
			Tremolo = Tremolo_DefaultValue = new Pyramid3dSeriesSonificationContextTracksMappingTremolo();
			Volume = Volume_DefaultValue = new Pyramid3dSeriesSonificationContextTracksMappingVolume();
		...
		/// </summary>
		public Pyramid3dSeriesSonificationContextTracksMappingFrequency Frequency { get; set; }
		private Pyramid3dSeriesSonificationContextTracksMappingFrequency Frequency_DefaultValue { get; set; }
		...
		/// </summary>
		public Pyramid3dSeriesSonificationContextTracksMappingGapBetweenNotes GapBetweenNotes { get; set; }
		private Pyramid3dSeriesSonificationContextTracksMappingGapBetweenNotes GapBetweenNotes_DefaultValue { get; set; }
		...
		/// </summary>
		public Pyramid3dSeriesSonificationContextTracksMappingHighpass Highpass { get; set; }
		private Pyramid3dSeriesSonificationContextTracksMappingHighpass Highpass_DefaultValue { get; set; }
		...
		/// </summary>
		public Pyramid3dSeriesSonificationContextTracksMappingLowpass Lowpass { get; set; }
		private Pyramid3dSeriesSonificationContextTracksMappingLowpass Lowpass_DefaultValue { get; set; }
		...
		/// </summary>
		public Pyramid3dSeriesSonificationContextTracksMappingNoteDuration NoteDuration { get; set; }
		private Pyramid3dSeriesSonificationContextTracksMappingNoteDuration NoteDuration_DefaultValue { get; set; }
		...
		/// </summary>
		public Pyramid3dSeriesSonificationContextTracksMappingPan Pan { get; set; }
		private Pyramid3dSeriesSonificationContextTracksMappingPan Pan_DefaultValue { get; set; }
		...
		/// </summary>
		public Pyramid3dSeriesSonificationContextTracksMappingPitch Pitch { get; set; }
		private Pyramid3dSeriesSonificationContextTracksMappingPitch Pitch_DefaultValue { get; set; }
		...
		/// </summary>
		public Pyramid3dSeriesSonificationContextTracksMappingPlayDelay PlayDelay { get; set; }
		private Pyramid3dSeriesSonificationContextTracksMappingPlayDelay PlayDelay_DefaultValue { get; set; }
		...
		/// </summary>
		public Pyramid3dSeriesSonificationContextTracksMappingTime Time { get; set; }
		private Pyramid3dSeriesSonificationContextTracksMappingTime Time_DefaultValue { get; set; }
		...
		/// </summary>
		public Pyramid3dSeriesSonificationContextTracksMappingTremolo Tremolo { get; set; }
		private Pyramid3dSeriesSonificationContextTracksMappingTremolo Tremolo_DefaultValue { get; set; }
		 

		/// <summary>
		/// The volume of notes, from 0 to 1.
		/// </summary>
		public Pyramid3dSeriesSonificationContextTracksMappingVolume Volume { get; set; }
		private Pyramid3dSeriesSonificationContextTracksMappingVolume Volume_DefaultValue { get; set; }
