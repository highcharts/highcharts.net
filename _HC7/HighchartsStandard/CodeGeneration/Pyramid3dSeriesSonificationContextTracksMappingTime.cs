...
{
	public partial class Pyramid3dSeriesSonificationContextTracksMappingTime  : BaseObject
	{
		Hashtable h = new Hashtable();

		public Pyramid3dSeriesSonificationContextTracksMappingTime()
		{
			MapFunction = MapFunction_DefaultValue = Pyramid3dSeriesSonificationContextTracksMappingTimeMapFunction.Linear;
			MapTo = MapTo_DefaultValue = "";
			Max = Max_DefaultValue = null;
			Min = Min_DefaultValue = null;
			Value = Value_DefaultValue = null;
			Within = Within_DefaultValue = Pyramid3dSeriesSonificationContextTracksMappingTimeWithin.Chart;
		...
		/// </summary>
		public Pyramid3dSeriesSonificationContextTracksMappingTimeMapFunction MapFunction { get; set; }
		private Pyramid3dSeriesSonificationContextTracksMappingTimeMapFunction MapFunction_DefaultValue { get; set; }
		...
		/// </summary>
		public Pyramid3dSeriesSonificationContextTracksMappingTimeWithin Within { get; set; }
		private Pyramid3dSeriesSonificationContextTracksMappingTimeWithin Within_DefaultValue { get; set; }
