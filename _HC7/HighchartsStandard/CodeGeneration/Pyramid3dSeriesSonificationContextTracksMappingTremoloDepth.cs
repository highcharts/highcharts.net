...
{
	public partial class Pyramid3dSeriesSonificationContextTracksMappingTremoloDepth  : BaseObject
	{
		Hashtable h = new Hashtable();

		public Pyramid3dSeriesSonificationContextTracksMappingTremoloDepth()
		{
			MapFunction = MapFunction_DefaultValue = Pyramid3dSeriesSonificationContextTracksMappingTremoloDepthMapFunction.Linear;
			MapTo = MapTo_DefaultValue = "";
			Max = Max_DefaultValue = null;
			Min = Min_DefaultValue = null;
			Value = Value_DefaultValue = null;
			Within = Within_DefaultValue = Pyramid3dSeriesSonificationContextTracksMappingTremoloDepthWithin.Chart;
		...
		/// </summary>
		public Pyramid3dSeriesSonificationContextTracksMappingTremoloDepthMapFunction MapFunction { get; set; }
		private Pyramid3dSeriesSonificationContextTracksMappingTremoloDepthMapFunction MapFunction_DefaultValue { get; set; }
		...
		/// </summary>
		public Pyramid3dSeriesSonificationContextTracksMappingTremoloDepthWithin Within { get; set; }
		private Pyramid3dSeriesSonificationContextTracksMappingTremoloDepthWithin Within_DefaultValue { get; set; }
