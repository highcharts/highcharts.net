...
{
	public partial class Pyramid3dSeriesSonificationPointGrouping  : BaseObject
	{
		Hashtable h = new Hashtable();

		public Pyramid3dSeriesSonificationPointGrouping()
		{
		...
		/// </summary>
		public Pyramid3dSeriesSonificationPointGroupingAlgorithm Algorithm { get; set; }
		private Pyramid3dSeriesSonificationPointGroupingAlgorithm Algorithm_DefaultValue { get; set; }
		...
		internal override Hashtable ToHashtable(Highcharts highcharts)
		{
			...
			if (Algorithm != Pyramid3dSeriesSonificationPointGroupingAlgorithm.Null) h.Add("algorithm", highcharts.FirstCharacterToLower(Algorithm.ToString()));
