...
{
	public partial class Pyramid3dSeriesSonificationTracks  : BaseObject
	{
		Hashtable h = new Hashtable();

		public Pyramid3dSeriesSonificationTracks()
		{
			ActiveWhen = ActiveWhen_DefaultValue = new Pyramid3dSeriesSonificationTracksActiveWhen();
			Instrument = Instrument_DefaultValue = null;
			InstrumentString = InstrumentString_DefaultValue = "null";
			Mapping = Mapping_DefaultValue = new Pyramid3dSeriesSonificationTracksMapping();
			MidiName = MidiName_DefaultValue = "";
			PointGrouping = PointGrouping_DefaultValue = new Pyramid3dSeriesSonificationTracksPointGrouping();
			RoundToMusicalNotes = RoundToMusicalNotes_DefaultValue = true;
			ShowPlayMarker = ShowPlayMarker_DefaultValue = true;
			Type = Type_DefaultValue = Pyramid3dSeriesSonificationTracksType.Instrument;
		...
		/// </summary>
		public Pyramid3dSeriesSonificationTracksActiveWhen ActiveWhen { get; set; }
		private Pyramid3dSeriesSonificationTracksActiveWhen ActiveWhen_DefaultValue { get; set; }
		...
		/// </summary>
		public Pyramid3dSeriesSonificationTracksMapping Mapping { get; set; }
		private Pyramid3dSeriesSonificationTracksMapping Mapping_DefaultValue { get; set; }
		...
		/// </summary>
		public Pyramid3dSeriesSonificationTracksPointGrouping PointGrouping { get; set; }
		private Pyramid3dSeriesSonificationTracksPointGrouping PointGrouping_DefaultValue { get; set; }
		...
		/// </summary>
		public Pyramid3dSeriesSonificationTracksType Type { get; set; }
		private Pyramid3dSeriesSonificationTracksType Type_DefaultValue { get; set; }
