...
{
	public partial class Pyramid3dSeriesSonificationTracksMapping  : BaseObject
	{
		Hashtable h = new Hashtable();

		public Pyramid3dSeriesSonificationTracksMapping()
		{
			Frequency = Frequency_DefaultValue = new Pyramid3dSeriesSonificationTracksMappingFrequency();
			GapBetweenNotes = GapBetweenNotes_DefaultValue = new Pyramid3dSeriesSonificationTracksMappingGapBetweenNotes();
			Highpass = Highpass_DefaultValue = new Pyramid3dSeriesSonificationTracksMappingHighpass();
			Lowpass = Lowpass_DefaultValue = new Pyramid3dSeriesSonificationTracksMappingLowpass();
			NoteDuration = NoteDuration_DefaultValue = new Pyramid3dSeriesSonificationTracksMappingNoteDuration();
			Pan = Pan_DefaultValue = new Pyramid3dSeriesSonificationTracksMappingPan();
			Pitch = Pitch_DefaultValue = new Pyramid3dSeriesSonificationTracksMappingPitch();
			PitchString = PitchString_DefaultValue = "null";
			PitchNumber = PitchNumber_DefaultValue = null;
			PlayDelay = PlayDelay_DefaultValue = new Pyramid3dSeriesSonificationTracksMappingPlayDelay();
			Time = Time_DefaultValue = new Pyramid3dSeriesSonificationTracksMappingTime();
			TimeString = TimeString_DefaultValue = "null";
			TimeNumber = TimeNumber_DefaultValue = null;
			Tremolo = Tremolo_DefaultValue = new Pyramid3dSeriesSonificationTracksMappingTremolo();
			Volume = Volume_DefaultValue = new Pyramid3dSeriesSonificationTracksMappingVolume();
		...
		/// </summary>
		public Pyramid3dSeriesSonificationTracksMappingFrequency Frequency { get; set; }
		private Pyramid3dSeriesSonificationTracksMappingFrequency Frequency_DefaultValue { get; set; }
		...
		/// </summary>
		public Pyramid3dSeriesSonificationTracksMappingGapBetweenNotes GapBetweenNotes { get; set; }
		private Pyramid3dSeriesSonificationTracksMappingGapBetweenNotes GapBetweenNotes_DefaultValue { get; set; }
		...
		/// </summary>
		public Pyramid3dSeriesSonificationTracksMappingHighpass Highpass { get; set; }
		private Pyramid3dSeriesSonificationTracksMappingHighpass Highpass_DefaultValue { get; set; }
		...
		/// </summary>
		public Pyramid3dSeriesSonificationTracksMappingLowpass Lowpass { get; set; }
		private Pyramid3dSeriesSonificationTracksMappingLowpass Lowpass_DefaultValue { get; set; }
		...
		/// </summary>
		public Pyramid3dSeriesSonificationTracksMappingNoteDuration NoteDuration { get; set; }
		private Pyramid3dSeriesSonificationTracksMappingNoteDuration NoteDuration_DefaultValue { get; set; }
		...
		/// </summary>
		public Pyramid3dSeriesSonificationTracksMappingPan Pan { get; set; }
		private Pyramid3dSeriesSonificationTracksMappingPan Pan_DefaultValue { get; set; }
		...
		/// </summary>
		public Pyramid3dSeriesSonificationTracksMappingPitch Pitch { get; set; }
		private Pyramid3dSeriesSonificationTracksMappingPitch Pitch_DefaultValue { get; set; }
		...
		/// </summary>
		public Pyramid3dSeriesSonificationTracksMappingPlayDelay PlayDelay { get; set; }
		private Pyramid3dSeriesSonificationTracksMappingPlayDelay PlayDelay_DefaultValue { get; set; }
		...
		/// </summary>
		public Pyramid3dSeriesSonificationTracksMappingTime Time { get; set; }
		private Pyramid3dSeriesSonificationTracksMappingTime Time_DefaultValue { get; set; }
		...
		/// </summary>
		public Pyramid3dSeriesSonificationTracksMappingTremolo Tremolo { get; set; }
		private Pyramid3dSeriesSonificationTracksMappingTremolo Tremolo_DefaultValue { get; set; }
		 

		/// <summary>
		/// The volume of notes, from 0 to 1.
		/// </summary>
		public Pyramid3dSeriesSonificationTracksMappingVolume Volume { get; set; }
		private Pyramid3dSeriesSonificationTracksMappingVolume Volume_DefaultValue { get; set; }
