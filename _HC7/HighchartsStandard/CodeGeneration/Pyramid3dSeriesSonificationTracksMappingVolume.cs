...
{
	public partial class Pyramid3dSeriesSonificationTracksMappingVolume  : BaseObject
	{
		Hashtable h = new Hashtable();

		public Pyramid3dSeriesSonificationTracksMappingVolume()
		{
			MapFunction = MapFunction_DefaultValue = Pyramid3dSeriesSonificationTracksMappingVolumeMapFunction.Linear;
			MapTo = MapTo_DefaultValue = "";
			Max = Max_DefaultValue = null;
			Min = Min_DefaultValue = null;
			Value = Value_DefaultValue = null;
			Within = Within_DefaultValue = Pyramid3dSeriesSonificationTracksMappingVolumeWithin.Chart;
		...
		/// </summary>
		public Pyramid3dSeriesSonificationTracksMappingVolumeMapFunction MapFunction { get; set; }
		private Pyramid3dSeriesSonificationTracksMappingVolumeMapFunction MapFunction_DefaultValue { get; set; }
		...
		/// </summary>
		public Pyramid3dSeriesSonificationTracksMappingVolumeWithin Within { get; set; }
		private Pyramid3dSeriesSonificationTracksMappingVolumeWithin Within_DefaultValue { get; set; }
