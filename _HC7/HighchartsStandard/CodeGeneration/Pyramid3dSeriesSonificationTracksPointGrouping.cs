...
{
	public partial class Pyramid3dSeriesSonificationTracksPointGrouping  : BaseObject
	{
		Hashtable h = new Hashtable();

		public Pyramid3dSeriesSonificationTracksPointGrouping()
		{
		...
		/// </summary>
		public Pyramid3dSeriesSonificationTracksPointGroupingAlgorithm Algorithm { get; set; }
		private Pyramid3dSeriesSonificationTracksPointGroupingAlgorithm Algorithm_DefaultValue { get; set; }
		...
		internal override Hashtable ToHashtable(Highcharts highcharts)
		{
			...
			if (Algorithm != Pyramid3dSeriesSonificationTracksPointGroupingAlgorithm.Null) h.Add("algorithm", highcharts.FirstCharacterToLower(Algorithm.ToString()));
