...
{
	public partial class Pyramid3dSeriesTooltip  : BaseObject
	{
		public Pyramid3dSeriesTooltip()
		{
			...
			HeaderShape = HeaderShape_DefaultValue = Pyramid3dSeriesTooltipHeaderShape.Callout;
		...
		/// </summary>
		public Pyramid3dSeriesTooltipHeaderShape HeaderShape { get; set; }
		private Pyramid3dSeriesTooltipHeaderShape HeaderShape_DefaultValue { get; set; }
		...
		internal override Hashtable ToHashtable()
		{
			...
			if (NullFormatter != NullFormatter_DefaultValue) { h.Add("nullFormatter",NullFormatter); Highcharts.AddFunction("b572f92b-2125-4788-ba8d-3b380cc981b4.nullFormatter", NullFormatter); }  
			if (Outside != Outside_DefaultValue) h.Add("outside",Outside);
			if (Padding != Padding_DefaultValue) h.Add("padding",Padding);
			if (PointFormat != PointFormat_DefaultValue) h.Add("pointFormat",PointFormat);
			if (PointFormatter != PointFormatter_DefaultValue) { h.Add("pointFormatter",PointFormatter); Highcharts.AddFunction("589c76dd-c9a1-46b1-91fb-71a0b7b927ea.pointFormatter", PointFormatter); }  
