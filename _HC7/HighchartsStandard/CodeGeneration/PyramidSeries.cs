...
namespace Highsoft.Web.Mvc.Charts
{
	public partial class PyramidSeries  : Series
	{
		...
		public PyramidSeries()
		{
			...
			Dumbell = Dumbell_DefaultValue = new PyramidSeriesDumbell();
			...
			LegendSymbol = LegendSymbol_DefaultValue = PyramidSeriesLegendSymbol.Rectangle;
			...
			OnPoint = OnPoint_DefaultValue = new PyramidSeriesOnPoint();
			...
			Sonification = Sonification_DefaultValue = new PyramidSeriesSonification();
		...
		/// </summary>
		public PyramidSeriesAccessibility Accessibility { get; set; }
		private PyramidSeriesAccessibility Accessibility_DefaultValue { get; set; }
		...
		/// 
		/// </summary>
		public PyramidSeriesDumbell Dumbell { get; set; }
		private PyramidSeriesDumbell Dumbell_DefaultValue { get; set; }
		...
		/// </summary>
		public PyramidSeriesLegendSymbol LegendSymbol { get; set; }
		private PyramidSeriesLegendSymbol LegendSymbol_DefaultValue { get; set; }
		...
		/// </summary>
		public PyramidSeriesOnPoint OnPoint { get; set; }
		private PyramidSeriesOnPoint OnPoint_DefaultValue { get; set; }
		...
		/// </summary>
		public PyramidSeriesSonification Sonification { get; set; }
		private PyramidSeriesSonification Sonification_DefaultValue { get; set; }
