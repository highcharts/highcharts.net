...
{
	public partial class PyramidSeriesAccessibility  : BaseObject
	{
		public PyramidSeriesAccessibility()
		{
		...
		/// </summary>
		public PyramidSeriesAccessibilityKeyboardNavigation KeyboardNavigation { get; set; }
		private PyramidSeriesAccessibilityKeyboardNavigation KeyboardNavigation_DefaultValue { get; set; }
		...
		internal override Hashtable ToHashtable()
		{
			...
			if (PointDescriptionFormatter != PointDescriptionFormatter_DefaultValue) { h.Add("pointDescriptionFormatter",PointDescriptionFormatter); Highcharts.AddFunction("PyramidSeriesAccessibilityPointDescriptionFormatter.pointDescriptionFormatter", PointDescriptionFormatter); }  
