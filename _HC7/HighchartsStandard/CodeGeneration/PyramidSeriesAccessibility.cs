...
namespace Highsoft.Web.Mvc.Charts
{
	public partial class PyramidSeriesAccessibility  : BaseObject
	{
		...
		internal override Hashtable ToHashtable()
		{
			...
			if (PointDescriptionFormatter != PointDescriptionFormatter_DefaultValue) { h.Add("pointDescriptionFormatter",PointDescriptionFormatter); Highcharts.AddFunction("37c79d32-7482-46a1-b611-572456798302.pointDescriptionFormatter", PointDescriptionFormatter); }  
