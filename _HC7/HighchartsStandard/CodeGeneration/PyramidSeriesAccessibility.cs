...
namespace Highsoft.Web.Mvc.Charts
{
	public partial class PyramidSeriesAccessibility  : BaseObject
	{
		...
		internal override Hashtable ToHashtable()
		{
			...
			if (PointDescriptionFormatter != PointDescriptionFormatter_DefaultValue) { h.Add("pointDescriptionFormatter",PointDescriptionFormatter); Highcharts.AddFunction("b58cd722-f5a4-4cd6-961e-0b54502e8e39.pointDescriptionFormatter", PointDescriptionFormatter); }  
