...
{
	public partial class PyramidSeriesDataDataLabels  : BaseObject
	{
		Hashtable h = new Hashtable();

		public PyramidSeriesDataDataLabels()
		{
		...
		/// </summary>
		public PyramidSeriesDataDataLabelsAlign Align { get; set; }
		private PyramidSeriesDataDataLabelsAlign Align_DefaultValue { get; set; }
		...
		/// </summary>
		public PyramidSeriesDataDataLabelsFilter Filter { get; set; }
		private PyramidSeriesDataDataLabelsFilter Filter_DefaultValue { get; set; }
		...
		/// </summary>
		public PyramidSeriesDataDataLabelsOverflow Overflow { get; set; }
		private PyramidSeriesDataDataLabelsOverflow Overflow_DefaultValue { get; set; }
		...
		/// </summary>
		public PyramidSeriesDataDataLabelsPosition Position { get; set; }
		private PyramidSeriesDataDataLabelsPosition Position_DefaultValue { get; set; }
		...
		/// </summary>
		public PyramidSeriesDataDataLabelsTextPath TextPath { get; set; }
		private PyramidSeriesDataDataLabelsTextPath TextPath_DefaultValue { get; set; }
		...
		/// </summary>
		public PyramidSeriesDataDataLabelsVerticalAlign VerticalAlign { get; set; }
		private PyramidSeriesDataDataLabelsVerticalAlign VerticalAlign_DefaultValue { get; set; }
		...
		internal override Hashtable ToHashtable(Highcharts highcharts)
		{
			...
			if (Align != PyramidSeriesDataDataLabelsAlign.Null) h.Add("align", highcharts.FirstCharacterToLower(Align.ToString()));
			...
			if (Overflow != PyramidSeriesDataDataLabelsOverflow.Null) h.Add("overflow", highcharts.FirstCharacterToLower(Overflow.ToString()));
			if (Padding != null) h.Add("padding",Padding);
			if (Position != PyramidSeriesDataDataLabelsPosition.Null) h.Add("position", highcharts.FirstCharacterToLower(Position.ToString()));
			...
			if (VerticalAlign != PyramidSeriesDataDataLabelsVerticalAlign.Null) h.Add("verticalAlign", highcharts.FirstCharacterToLower(VerticalAlign.ToString()));
			if (X != null) h.Add("x",X);
			if (Y != null) h.Add("y",Y);
