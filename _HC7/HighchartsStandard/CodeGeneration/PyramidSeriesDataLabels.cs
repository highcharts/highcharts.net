...
namespace Highsoft.Web.Mvc.Charts
{
	public partial class PyramidSeriesDataLabels  : BaseObject
	{
		...
		{
			Align = Align_DefaultValue = PyramidSeriesDataLabelsAlign.Left;
			...
			Style = Style_DefaultValue = new PyramidSeriesDataLabelsStyle();
			UseHTML = UseHTML_DefaultValue = false;
			VerticalAlign = VerticalAlign_DefaultValue = PyramidSeriesDataLabelsVerticalAlign.Top;
		...
		/// 
		/// </summary>
		public PyramidSeriesDataLabelsStyle Style { get; set; }
		private PyramidSeriesDataLabelsStyle Style_DefaultValue { get; set; }
		...
		internal override Hashtable ToHashtable()
		{
			...
			if (Formatter != Formatter_DefaultValue) { h.Add("formatter",Formatter); Highcharts.AddFunction("f7b57709-f48f-452e-9d21-67c733bf04eb.formatter", Formatter); }  
