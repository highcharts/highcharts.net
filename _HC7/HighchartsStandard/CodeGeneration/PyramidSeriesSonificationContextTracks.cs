...
{
	public partial class PyramidSeriesSonificationContextTracks  : BaseObject
	{
		Hashtable h = new Hashtable();

		public PyramidSeriesSonificationContextTracks()
		{
			ActiveWhen = ActiveWhen_DefaultValue = new PyramidSeriesSonificationContextTracksActiveWhen();
			Instrument = Instrument_DefaultValue = null;
			InstrumentString = InstrumentString_DefaultValue = "null";
			Mapping = Mapping_DefaultValue = new PyramidSeriesSonificationContextTracksMapping();
			MidiName = MidiName_DefaultValue = "";
			PointGrouping = PointGrouping_DefaultValue = new PyramidSeriesSonificationContextTracksPointGrouping();
			...
			Type = Type_DefaultValue = PyramidSeriesSonificationContextTracksType.Instrument;
			ValueInterval = ValueInterval_DefaultValue = null;
			ValueMapFunction = ValueMapFunction_DefaultValue = PyramidSeriesSonificationContextTracksValueMapFunction.Linear;
		...
		/// </summary>
		public PyramidSeriesSonificationContextTracksActiveWhen ActiveWhen { get; set; }
		private PyramidSeriesSonificationContextTracksActiveWhen ActiveWhen_DefaultValue { get; set; }
		...
		/// </summary>
		public PyramidSeriesSonificationContextTracksMapping Mapping { get; set; }
		private PyramidSeriesSonificationContextTracksMapping Mapping_DefaultValue { get; set; }
		...
		/// </summary>
		public PyramidSeriesSonificationContextTracksPointGrouping PointGrouping { get; set; }
		private PyramidSeriesSonificationContextTracksPointGrouping PointGrouping_DefaultValue { get; set; }
		...
		/// </summary>
		public PyramidSeriesSonificationContextTracksType Type { get; set; }
		private PyramidSeriesSonificationContextTracksType Type_DefaultValue { get; set; }
		...
		/// </summary>
		public PyramidSeriesSonificationContextTracksValueMapFunction ValueMapFunction { get; set; }
		private PyramidSeriesSonificationContextTracksValueMapFunction ValueMapFunction_DefaultValue { get; set; }
