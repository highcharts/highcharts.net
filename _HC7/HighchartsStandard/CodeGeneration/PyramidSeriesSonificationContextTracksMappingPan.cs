...
{
	public partial class PyramidSeriesSonificationContextTracksMappingPan  : BaseObject
	{
		Hashtable h = new Hashtable();

		public PyramidSeriesSonificationContextTracksMappingPan()
		{
			MapFunction = MapFunction_DefaultValue = PyramidSeriesSonificationContextTracksMappingPanMapFunction.Linear;
			MapTo = MapTo_DefaultValue = "";
			Max = Max_DefaultValue = null;
			Min = Min_DefaultValue = null;
			Value = Value_DefaultValue = null;
			Within = Within_DefaultValue = PyramidSeriesSonificationContextTracksMappingPanWithin.Chart;
		...
		/// </summary>
		public PyramidSeriesSonificationContextTracksMappingPanMapFunction MapFunction { get; set; }
		private PyramidSeriesSonificationContextTracksMappingPanMapFunction MapFunction_DefaultValue { get; set; }
		...
		/// </summary>
		public PyramidSeriesSonificationContextTracksMappingPanWithin Within { get; set; }
		private PyramidSeriesSonificationContextTracksMappingPanWithin Within_DefaultValue { get; set; }
