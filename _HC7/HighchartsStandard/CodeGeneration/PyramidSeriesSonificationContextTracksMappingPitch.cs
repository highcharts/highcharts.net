...
{
	public partial class PyramidSeriesSonificationContextTracksMappingPitch  : BaseObject
	{
		Hashtable h = new Hashtable();

		public PyramidSeriesSonificationContextTracksMappingPitch()
		{
			MapFunction = MapFunction_DefaultValue = PyramidSeriesSonificationContextTracksMappingPitchMapFunction.Linear;
		...
		/// </summary>
		public PyramidSeriesSonificationContextTracksMappingPitchMapFunction MapFunction { get; set; }
		private PyramidSeriesSonificationContextTracksMappingPitchMapFunction MapFunction_DefaultValue { get; set; }
