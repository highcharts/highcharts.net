...
{
	public partial class PyramidSeriesSonificationContextTracksMappingPlayDelay  : BaseObject
	{
		Hashtable h = new Hashtable();

		public PyramidSeriesSonificationContextTracksMappingPlayDelay()
		{
			MapFunction = MapFunction_DefaultValue = PyramidSeriesSonificationContextTracksMappingPlayDelayMapFunction.Linear;
			MapTo = MapTo_DefaultValue = "";
			Max = Max_DefaultValue = null;
			Min = Min_DefaultValue = null;
			Value = Value_DefaultValue = null;
			Within = Within_DefaultValue = PyramidSeriesSonificationContextTracksMappingPlayDelayWithin.Chart;
		...
		/// </summary>
		public PyramidSeriesSonificationContextTracksMappingPlayDelayMapFunction MapFunction { get; set; }
		private PyramidSeriesSonificationContextTracksMappingPlayDelayMapFunction MapFunction_DefaultValue { get; set; }
		...
		/// </summary>
		public PyramidSeriesSonificationContextTracksMappingPlayDelayWithin Within { get; set; }
		private PyramidSeriesSonificationContextTracksMappingPlayDelayWithin Within_DefaultValue { get; set; }
