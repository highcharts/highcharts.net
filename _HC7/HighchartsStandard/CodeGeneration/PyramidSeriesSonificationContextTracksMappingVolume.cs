...
{
	public partial class PyramidSeriesSonificationContextTracksMappingVolume  : BaseObject
	{
		Hashtable h = new Hashtable();

		public PyramidSeriesSonificationContextTracksMappingVolume()
		{
			MapFunction = MapFunction_DefaultValue = PyramidSeriesSonificationContextTracksMappingVolumeMapFunction.Linear;
			MapTo = MapTo_DefaultValue = "";
			Max = Max_DefaultValue = null;
			Min = Min_DefaultValue = null;
			Value = Value_DefaultValue = null;
			Within = Within_DefaultValue = PyramidSeriesSonificationContextTracksMappingVolumeWithin.Chart;
		...
		/// </summary>
		public PyramidSeriesSonificationContextTracksMappingVolumeMapFunction MapFunction { get; set; }
		private PyramidSeriesSonificationContextTracksMappingVolumeMapFunction MapFunction_DefaultValue { get; set; }
		...
		/// </summary>
		public PyramidSeriesSonificationContextTracksMappingVolumeWithin Within { get; set; }
		private PyramidSeriesSonificationContextTracksMappingVolumeWithin Within_DefaultValue { get; set; }
