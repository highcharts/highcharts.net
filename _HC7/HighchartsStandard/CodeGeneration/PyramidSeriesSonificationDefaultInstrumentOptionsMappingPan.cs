...
{
	public partial class PyramidSeriesSonificationDefaultInstrumentOptionsMappingPan  : BaseObject
	{
		Hashtable h = new Hashtable();

		public PyramidSeriesSonificationDefaultInstrumentOptionsMappingPan()
		{
			MapFunction = MapFunction_DefaultValue = PyramidSeriesSonificationDefaultInstrumentOptionsMappingPanMapFunction.Linear;
			MapTo = MapTo_DefaultValue = "";
			Max = Max_DefaultValue = null;
			Min = Min_DefaultValue = null;
			Value = Value_DefaultValue = null;
			Within = Within_DefaultValue = PyramidSeriesSonificationDefaultInstrumentOptionsMappingPanWithin.Chart;
		...
		/// </summary>
		public PyramidSeriesSonificationDefaultInstrumentOptionsMappingPanMapFunction MapFunction { get; set; }
		private PyramidSeriesSonificationDefaultInstrumentOptionsMappingPanMapFunction MapFunction_DefaultValue { get; set; }
		...
		/// </summary>
		public PyramidSeriesSonificationDefaultInstrumentOptionsMappingPanWithin Within { get; set; }
		private PyramidSeriesSonificationDefaultInstrumentOptionsMappingPanWithin Within_DefaultValue { get; set; }
