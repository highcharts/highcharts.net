...
{
	public partial class PyramidSeriesSonificationDefaultSpeechOptions  : BaseObject
	{
		...
		/// </summary>
		public PyramidSeriesSonificationDefaultSpeechOptionsActiveWhen ActiveWhen { get; set; }
		private PyramidSeriesSonificationDefaultSpeechOptionsActiveWhen ActiveWhen_DefaultValue { get; set; }
		...
		/// </summary>
		public PyramidSeriesSonificationDefaultSpeechOptionsMapping Mapping { get; set; }
		private PyramidSeriesSonificationDefaultSpeechOptionsMapping Mapping_DefaultValue { get; set; }
		 

		/// <summary>
		/// Options for point grouping, specifically for instrument tracks.
		/// </summary>
		public PyramidSeriesSonificationDefaultSpeechOptionsPointGrouping PointGrouping { get; set; }
		private PyramidSeriesSonificationDefaultSpeechOptionsPointGrouping PointGrouping_DefaultValue { get; set; }
		...
		/// </summary>
		public PyramidSeriesSonificationDefaultSpeechOptionsType Type { get; set; }
		private PyramidSeriesSonificationDefaultSpeechOptionsType Type_DefaultValue { get; set; }
