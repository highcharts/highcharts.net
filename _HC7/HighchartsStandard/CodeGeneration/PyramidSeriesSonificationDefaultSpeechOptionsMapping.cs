...
{
	public partial class PyramidSeriesSonificationDefaultSpeechOptionsMapping  : BaseObject
	{
		Hashtable h = new Hashtable();

		public PyramidSeriesSonificationDefaultSpeechOptionsMapping()
		{
			Frequency = Frequency_DefaultValue = new PyramidSeriesSonificationDefaultSpeechOptionsMappingFrequency();
			GapBetweenNotes = GapBetweenNotes_DefaultValue = new PyramidSeriesSonificationDefaultSpeechOptionsMappingGapBetweenNotes();
			Highpass = Highpass_DefaultValue = new PyramidSeriesSonificationDefaultSpeechOptionsMappingHighpass();
			Lowpass = Lowpass_DefaultValue = new PyramidSeriesSonificationDefaultSpeechOptionsMappingLowpass();
			NoteDuration = NoteDuration_DefaultValue = new PyramidSeriesSonificationDefaultSpeechOptionsMappingNoteDuration();
			Pan = Pan_DefaultValue = new PyramidSeriesSonificationDefaultSpeechOptionsMappingPan();
			Pitch = Pitch_DefaultValue = new PyramidSeriesSonificationDefaultSpeechOptionsMappingPitch();
			PitchString = PitchString_DefaultValue = "null";
			PitchNumber = PitchNumber_DefaultValue = null;
			PlayDelay = PlayDelay_DefaultValue = new PyramidSeriesSonificationDefaultSpeechOptionsMappingPlayDelay();
			Time = Time_DefaultValue = new PyramidSeriesSonificationDefaultSpeechOptionsMappingTime();
			TimeString = TimeString_DefaultValue = "null";
			TimeNumber = TimeNumber_DefaultValue = null;
			Tremolo = Tremolo_DefaultValue = new PyramidSeriesSonificationDefaultSpeechOptionsMappingTremolo();
			Volume = Volume_DefaultValue = new PyramidSeriesSonificationDefaultSpeechOptionsMappingVolume();
		...
		/// </summary>
		public PyramidSeriesSonificationDefaultSpeechOptionsMappingFrequency Frequency { get; set; }
		private PyramidSeriesSonificationDefaultSpeechOptionsMappingFrequency Frequency_DefaultValue { get; set; }
		...
		/// </summary>
		public PyramidSeriesSonificationDefaultSpeechOptionsMappingGapBetweenNotes GapBetweenNotes { get; set; }
		private PyramidSeriesSonificationDefaultSpeechOptionsMappingGapBetweenNotes GapBetweenNotes_DefaultValue { get; set; }
		...
		/// </summary>
		public PyramidSeriesSonificationDefaultSpeechOptionsMappingHighpass Highpass { get; set; }
		private PyramidSeriesSonificationDefaultSpeechOptionsMappingHighpass Highpass_DefaultValue { get; set; }
		...
		/// </summary>
		public PyramidSeriesSonificationDefaultSpeechOptionsMappingLowpass Lowpass { get; set; }
		private PyramidSeriesSonificationDefaultSpeechOptionsMappingLowpass Lowpass_DefaultValue { get; set; }
		...
		/// </summary>
		public PyramidSeriesSonificationDefaultSpeechOptionsMappingNoteDuration NoteDuration { get; set; }
		private PyramidSeriesSonificationDefaultSpeechOptionsMappingNoteDuration NoteDuration_DefaultValue { get; set; }
		...
		/// </summary>
		public PyramidSeriesSonificationDefaultSpeechOptionsMappingPan Pan { get; set; }
		private PyramidSeriesSonificationDefaultSpeechOptionsMappingPan Pan_DefaultValue { get; set; }
		...
		/// </summary>
		public PyramidSeriesSonificationDefaultSpeechOptionsMappingPitch Pitch { get; set; }
		private PyramidSeriesSonificationDefaultSpeechOptionsMappingPitch Pitch_DefaultValue { get; set; }
		...
		/// </summary>
		public PyramidSeriesSonificationDefaultSpeechOptionsMappingPlayDelay PlayDelay { get; set; }
		private PyramidSeriesSonificationDefaultSpeechOptionsMappingPlayDelay PlayDelay_DefaultValue { get; set; }
		...
		/// </summary>
		public PyramidSeriesSonificationDefaultSpeechOptionsMappingTime Time { get; set; }
		private PyramidSeriesSonificationDefaultSpeechOptionsMappingTime Time_DefaultValue { get; set; }
		...
		/// </summary>
		public PyramidSeriesSonificationDefaultSpeechOptionsMappingTremolo Tremolo { get; set; }
		private PyramidSeriesSonificationDefaultSpeechOptionsMappingTremolo Tremolo_DefaultValue { get; set; }
		 

		/// <summary>
		/// The volume of notes, from 0 to 1.
		/// </summary>
		public PyramidSeriesSonificationDefaultSpeechOptionsMappingVolume Volume { get; set; }
		private PyramidSeriesSonificationDefaultSpeechOptionsMappingVolume Volume_DefaultValue { get; set; }
