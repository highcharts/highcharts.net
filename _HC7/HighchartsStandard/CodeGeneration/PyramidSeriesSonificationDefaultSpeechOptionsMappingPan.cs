...
{
	public partial class PyramidSeriesSonificationDefaultSpeechOptionsMappingPan  : BaseObject
	{
		Hashtable h = new Hashtable();

		public PyramidSeriesSonificationDefaultSpeechOptionsMappingPan()
		{
			MapFunction = MapFunction_DefaultValue = PyramidSeriesSonificationDefaultSpeechOptionsMappingPanMapFunction.Linear;
			MapTo = MapTo_DefaultValue = "";
			Max = Max_DefaultValue = null;
			Min = Min_DefaultValue = null;
			Value = Value_DefaultValue = null;
			Within = Within_DefaultValue = PyramidSeriesSonificationDefaultSpeechOptionsMappingPanWithin.Chart;
		...
		/// </summary>
		public PyramidSeriesSonificationDefaultSpeechOptionsMappingPanMapFunction MapFunction { get; set; }
		private PyramidSeriesSonificationDefaultSpeechOptionsMappingPanMapFunction MapFunction_DefaultValue { get; set; }
		...
		/// </summary>
		public PyramidSeriesSonificationDefaultSpeechOptionsMappingPanWithin Within { get; set; }
		private PyramidSeriesSonificationDefaultSpeechOptionsMappingPanWithin Within_DefaultValue { get; set; }
