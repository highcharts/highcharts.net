...
{
	public partial class PyramidSeriesSonificationDefaultSpeechOptionsMappingPlayDelay  : BaseObject
	{
		Hashtable h = new Hashtable();

		public PyramidSeriesSonificationDefaultSpeechOptionsMappingPlayDelay()
		{
			MapFunction = MapFunction_DefaultValue = PyramidSeriesSonificationDefaultSpeechOptionsMappingPlayDelayMapFunction.Linear;
			MapTo = MapTo_DefaultValue = "";
			Max = Max_DefaultValue = null;
			Min = Min_DefaultValue = null;
			Value = Value_DefaultValue = null;
			Within = Within_DefaultValue = PyramidSeriesSonificationDefaultSpeechOptionsMappingPlayDelayWithin.Chart;
		...
		/// </summary>
		public PyramidSeriesSonificationDefaultSpeechOptionsMappingPlayDelayMapFunction MapFunction { get; set; }
		private PyramidSeriesSonificationDefaultSpeechOptionsMappingPlayDelayMapFunction MapFunction_DefaultValue { get; set; }
		...
		/// </summary>
		public PyramidSeriesSonificationDefaultSpeechOptionsMappingPlayDelayWithin Within { get; set; }
		private PyramidSeriesSonificationDefaultSpeechOptionsMappingPlayDelayWithin Within_DefaultValue { get; set; }
