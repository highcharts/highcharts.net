...
{
	public partial class PyramidSeriesSonificationPointGrouping  : BaseObject
	{
		Hashtable h = new Hashtable();

		public PyramidSeriesSonificationPointGrouping()
		{
		...
		/// </summary>
		public PyramidSeriesSonificationPointGroupingAlgorithm Algorithm { get; set; }
		private PyramidSeriesSonificationPointGroupingAlgorithm Algorithm_DefaultValue { get; set; }
		...
		internal override Hashtable ToHashtable(Highcharts highcharts)
		{
			...
			if (Algorithm != PyramidSeriesSonificationPointGroupingAlgorithm.Null) h.Add("algorithm", highcharts.FirstCharacterToLower(Algorithm.ToString()));
