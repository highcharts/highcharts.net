...
{
	public partial class PyramidSeriesSonificationTracks  : BaseObject
	{
		Hashtable h = new Hashtable();

		public PyramidSeriesSonificationTracks()
		{
			ActiveWhen = ActiveWhen_DefaultValue = new PyramidSeriesSonificationTracksActiveWhen();
			Instrument = Instrument_DefaultValue = null;
			InstrumentString = InstrumentString_DefaultValue = "null";
			Mapping = Mapping_DefaultValue = new PyramidSeriesSonificationTracksMapping();
			MidiName = MidiName_DefaultValue = "";
			PointGrouping = PointGrouping_DefaultValue = new PyramidSeriesSonificationTracksPointGrouping();
			RoundToMusicalNotes = RoundToMusicalNotes_DefaultValue = true;
			ShowPlayMarker = ShowPlayMarker_DefaultValue = true;
			Type = Type_DefaultValue = PyramidSeriesSonificationTracksType.Instrument;
		...
		/// </summary>
		public PyramidSeriesSonificationTracksActiveWhen ActiveWhen { get; set; }
		private PyramidSeriesSonificationTracksActiveWhen ActiveWhen_DefaultValue { get; set; }
		...
		/// </summary>
		public PyramidSeriesSonificationTracksMapping Mapping { get; set; }
		private PyramidSeriesSonificationTracksMapping Mapping_DefaultValue { get; set; }
		...
		/// </summary>
		public PyramidSeriesSonificationTracksPointGrouping PointGrouping { get; set; }
		private PyramidSeriesSonificationTracksPointGrouping PointGrouping_DefaultValue { get; set; }
		...
		/// </summary>
		public PyramidSeriesSonificationTracksType Type { get; set; }
		private PyramidSeriesSonificationTracksType Type_DefaultValue { get; set; }
