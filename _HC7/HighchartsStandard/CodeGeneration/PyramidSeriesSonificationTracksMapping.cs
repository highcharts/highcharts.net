...
{
	public partial class PyramidSeriesSonificationTracksMapping  : BaseObject
	{
		Hashtable h = new Hashtable();

		public PyramidSeriesSonificationTracksMapping()
		{
			Frequency = Frequency_DefaultValue = new PyramidSeriesSonificationTracksMappingFrequency();
			GapBetweenNotes = GapBetweenNotes_DefaultValue = new PyramidSeriesSonificationTracksMappingGapBetweenNotes();
			Highpass = Highpass_DefaultValue = new PyramidSeriesSonificationTracksMappingHighpass();
			Lowpass = Lowpass_DefaultValue = new PyramidSeriesSonificationTracksMappingLowpass();
			NoteDuration = NoteDuration_DefaultValue = new PyramidSeriesSonificationTracksMappingNoteDuration();
			Pan = Pan_DefaultValue = new PyramidSeriesSonificationTracksMappingPan();
			Pitch = Pitch_DefaultValue = new PyramidSeriesSonificationTracksMappingPitch();
			PitchString = PitchString_DefaultValue = "null";
			PitchNumber = PitchNumber_DefaultValue = null;
			PlayDelay = PlayDelay_DefaultValue = new PyramidSeriesSonificationTracksMappingPlayDelay();
			Time = Time_DefaultValue = new PyramidSeriesSonificationTracksMappingTime();
			TimeString = TimeString_DefaultValue = "null";
			TimeNumber = TimeNumber_DefaultValue = null;
			Tremolo = Tremolo_DefaultValue = new PyramidSeriesSonificationTracksMappingTremolo();
			Volume = Volume_DefaultValue = new PyramidSeriesSonificationTracksMappingVolume();
		...
		/// </summary>
		public PyramidSeriesSonificationTracksMappingFrequency Frequency { get; set; }
		private PyramidSeriesSonificationTracksMappingFrequency Frequency_DefaultValue { get; set; }
		...
		/// </summary>
		public PyramidSeriesSonificationTracksMappingGapBetweenNotes GapBetweenNotes { get; set; }
		private PyramidSeriesSonificationTracksMappingGapBetweenNotes GapBetweenNotes_DefaultValue { get; set; }
		...
		/// </summary>
		public PyramidSeriesSonificationTracksMappingHighpass Highpass { get; set; }
		private PyramidSeriesSonificationTracksMappingHighpass Highpass_DefaultValue { get; set; }
		...
		/// </summary>
		public PyramidSeriesSonificationTracksMappingLowpass Lowpass { get; set; }
		private PyramidSeriesSonificationTracksMappingLowpass Lowpass_DefaultValue { get; set; }
		...
		/// </summary>
		public PyramidSeriesSonificationTracksMappingNoteDuration NoteDuration { get; set; }
		private PyramidSeriesSonificationTracksMappingNoteDuration NoteDuration_DefaultValue { get; set; }
		...
		/// </summary>
		public PyramidSeriesSonificationTracksMappingPan Pan { get; set; }
		private PyramidSeriesSonificationTracksMappingPan Pan_DefaultValue { get; set; }
		...
		/// </summary>
		public PyramidSeriesSonificationTracksMappingPitch Pitch { get; set; }
		private PyramidSeriesSonificationTracksMappingPitch Pitch_DefaultValue { get; set; }
		...
		/// </summary>
		public PyramidSeriesSonificationTracksMappingPlayDelay PlayDelay { get; set; }
		private PyramidSeriesSonificationTracksMappingPlayDelay PlayDelay_DefaultValue { get; set; }
		...
		/// </summary>
		public PyramidSeriesSonificationTracksMappingTime Time { get; set; }
		private PyramidSeriesSonificationTracksMappingTime Time_DefaultValue { get; set; }
		...
		/// </summary>
		public PyramidSeriesSonificationTracksMappingTremolo Tremolo { get; set; }
		private PyramidSeriesSonificationTracksMappingTremolo Tremolo_DefaultValue { get; set; }
		 

		/// <summary>
		/// The volume of notes, from 0 to 1.
		/// </summary>
		public PyramidSeriesSonificationTracksMappingVolume Volume { get; set; }
		private PyramidSeriesSonificationTracksMappingVolume Volume_DefaultValue { get; set; }
