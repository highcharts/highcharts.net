...
{
	public partial class PyramidSeriesSonificationTracksMappingFrequency  : BaseObject
	{
		Hashtable h = new Hashtable();

		public PyramidSeriesSonificationTracksMappingFrequency()
		{
			MapFunction = MapFunction_DefaultValue = PyramidSeriesSonificationTracksMappingFrequencyMapFunction.Linear;
			MapTo = MapTo_DefaultValue = "";
			Max = Max_DefaultValue = null;
			Min = Min_DefaultValue = null;
			Value = Value_DefaultValue = null;
			Within = Within_DefaultValue = PyramidSeriesSonificationTracksMappingFrequencyWithin.Chart;
		...
		/// </summary>
		public PyramidSeriesSonificationTracksMappingFrequencyMapFunction MapFunction { get; set; }
		private PyramidSeriesSonificationTracksMappingFrequencyMapFunction MapFunction_DefaultValue { get; set; }
		...
		/// </summary>
		public PyramidSeriesSonificationTracksMappingFrequencyWithin Within { get; set; }
		private PyramidSeriesSonificationTracksMappingFrequencyWithin Within_DefaultValue { get; set; }
