...
{
	public partial class PyramidSeriesSonificationTracksMappingLowpassResonance  : BaseObject
	{
		Hashtable h = new Hashtable();

		public PyramidSeriesSonificationTracksMappingLowpassResonance()
		{
			MapFunction = MapFunction_DefaultValue = PyramidSeriesSonificationTracksMappingLowpassResonanceMapFunction.Linear;
			MapTo = MapTo_DefaultValue = "";
			Max = Max_DefaultValue = null;
			Min = Min_DefaultValue = null;
			Value = Value_DefaultValue = null;
			Within = Within_DefaultValue = PyramidSeriesSonificationTracksMappingLowpassResonanceWithin.Chart;
		...
		/// </summary>
		public PyramidSeriesSonificationTracksMappingLowpassResonanceMapFunction MapFunction { get; set; }
		private PyramidSeriesSonificationTracksMappingLowpassResonanceMapFunction MapFunction_DefaultValue { get; set; }
		...
		/// </summary>
		public PyramidSeriesSonificationTracksMappingLowpassResonanceWithin Within { get; set; }
		private PyramidSeriesSonificationTracksMappingLowpassResonanceWithin Within_DefaultValue { get; set; }
