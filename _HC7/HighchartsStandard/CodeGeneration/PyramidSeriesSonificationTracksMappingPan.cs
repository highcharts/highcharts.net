...
{
	public partial class PyramidSeriesSonificationTracksMappingPan  : BaseObject
	{
		Hashtable h = new Hashtable();

		public PyramidSeriesSonificationTracksMappingPan()
		{
			MapFunction = MapFunction_DefaultValue = PyramidSeriesSonificationTracksMappingPanMapFunction.Linear;
			MapTo = MapTo_DefaultValue = "";
			Max = Max_DefaultValue = null;
			Min = Min_DefaultValue = null;
			Value = Value_DefaultValue = null;
			Within = Within_DefaultValue = PyramidSeriesSonificationTracksMappingPanWithin.Chart;
		...
		/// </summary>
		public PyramidSeriesSonificationTracksMappingPanMapFunction MapFunction { get; set; }
		private PyramidSeriesSonificationTracksMappingPanMapFunction MapFunction_DefaultValue { get; set; }
		...
		/// </summary>
		public PyramidSeriesSonificationTracksMappingPanWithin Within { get; set; }
		private PyramidSeriesSonificationTracksMappingPanWithin Within_DefaultValue { get; set; }
