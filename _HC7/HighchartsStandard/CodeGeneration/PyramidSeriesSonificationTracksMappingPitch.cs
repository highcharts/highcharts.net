...
{
	public partial class PyramidSeriesSonificationTracksMappingPitch  : BaseObject
	{
		Hashtable h = new Hashtable();

		public PyramidSeriesSonificationTracksMappingPitch()
		{
			MapFunction = MapFunction_DefaultValue = PyramidSeriesSonificationTracksMappingPitchMapFunction.Linear;
		...
		/// </summary>
		public PyramidSeriesSonificationTracksMappingPitchMapFunction MapFunction { get; set; }
		private PyramidSeriesSonificationTracksMappingPitchMapFunction MapFunction_DefaultValue { get; set; }
