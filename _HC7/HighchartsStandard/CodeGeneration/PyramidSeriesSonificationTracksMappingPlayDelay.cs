...
{
	public partial class PyramidSeriesSonificationTracksMappingPlayDelay  : BaseObject
	{
		Hashtable h = new Hashtable();

		public PyramidSeriesSonificationTracksMappingPlayDelay()
		{
			MapFunction = MapFunction_DefaultValue = PyramidSeriesSonificationTracksMappingPlayDelayMapFunction.Linear;
			MapTo = MapTo_DefaultValue = "";
			Max = Max_DefaultValue = null;
			Min = Min_DefaultValue = null;
			Value = Value_DefaultValue = null;
			Within = Within_DefaultValue = PyramidSeriesSonificationTracksMappingPlayDelayWithin.Chart;
		...
		/// </summary>
		public PyramidSeriesSonificationTracksMappingPlayDelayMapFunction MapFunction { get; set; }
		private PyramidSeriesSonificationTracksMappingPlayDelayMapFunction MapFunction_DefaultValue { get; set; }
		...
		/// </summary>
		public PyramidSeriesSonificationTracksMappingPlayDelayWithin Within { get; set; }
		private PyramidSeriesSonificationTracksMappingPlayDelayWithin Within_DefaultValue { get; set; }
