...
{
	public partial class PyramidSeriesSonificationTracksMappingTime  : BaseObject
	{
		Hashtable h = new Hashtable();

		public PyramidSeriesSonificationTracksMappingTime()
		{
			MapFunction = MapFunction_DefaultValue = PyramidSeriesSonificationTracksMappingTimeMapFunction.Linear;
			MapTo = MapTo_DefaultValue = "";
			Max = Max_DefaultValue = null;
			Min = Min_DefaultValue = null;
			Value = Value_DefaultValue = null;
			Within = Within_DefaultValue = PyramidSeriesSonificationTracksMappingTimeWithin.Chart;
		...
		/// </summary>
		public PyramidSeriesSonificationTracksMappingTimeMapFunction MapFunction { get; set; }
		private PyramidSeriesSonificationTracksMappingTimeMapFunction MapFunction_DefaultValue { get; set; }
		...
		/// </summary>
		public PyramidSeriesSonificationTracksMappingTimeWithin Within { get; set; }
		private PyramidSeriesSonificationTracksMappingTimeWithin Within_DefaultValue { get; set; }
