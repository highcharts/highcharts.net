...
{
	public partial class PyramidSeriesSonificationTracksMappingTremoloSpeed  : BaseObject
	{
		Hashtable h = new Hashtable();

		public PyramidSeriesSonificationTracksMappingTremoloSpeed()
		{
			MapFunction = MapFunction_DefaultValue = PyramidSeriesSonificationTracksMappingTremoloSpeedMapFunction.Linear;
			MapTo = MapTo_DefaultValue = "";
			Max = Max_DefaultValue = null;
			Min = Min_DefaultValue = null;
			Value = Value_DefaultValue = null;
			Within = Within_DefaultValue = PyramidSeriesSonificationTracksMappingTremoloSpeedWithin.Chart;
		...
		/// </summary>
		public PyramidSeriesSonificationTracksMappingTremoloSpeedMapFunction MapFunction { get; set; }
		private PyramidSeriesSonificationTracksMappingTremoloSpeedMapFunction MapFunction_DefaultValue { get; set; }
		...
		/// </summary>
		public PyramidSeriesSonificationTracksMappingTremoloSpeedWithin Within { get; set; }
		private PyramidSeriesSonificationTracksMappingTremoloSpeedWithin Within_DefaultValue { get; set; }
