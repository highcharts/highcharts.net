...
{
	public partial class PyramidSeriesSonificationTracksMappingVolume  : BaseObject
	{
		Hashtable h = new Hashtable();

		public PyramidSeriesSonificationTracksMappingVolume()
		{
			MapFunction = MapFunction_DefaultValue = PyramidSeriesSonificationTracksMappingVolumeMapFunction.Linear;
			MapTo = MapTo_DefaultValue = "";
			Max = Max_DefaultValue = null;
			Min = Min_DefaultValue = null;
			Value = Value_DefaultValue = null;
			Within = Within_DefaultValue = PyramidSeriesSonificationTracksMappingVolumeWithin.Chart;
		...
		/// </summary>
		public PyramidSeriesSonificationTracksMappingVolumeMapFunction MapFunction { get; set; }
		private PyramidSeriesSonificationTracksMappingVolumeMapFunction MapFunction_DefaultValue { get; set; }
		...
		/// </summary>
		public PyramidSeriesSonificationTracksMappingVolumeWithin Within { get; set; }
		private PyramidSeriesSonificationTracksMappingVolumeWithin Within_DefaultValue { get; set; }
