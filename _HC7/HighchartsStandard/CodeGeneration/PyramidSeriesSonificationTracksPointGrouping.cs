...
{
	public partial class PyramidSeriesSonificationTracksPointGrouping  : BaseObject
	{
		Hashtable h = new Hashtable();

		public PyramidSeriesSonificationTracksPointGrouping()
		{
		...
		/// </summary>
		public PyramidSeriesSonificationTracksPointGroupingAlgorithm Algorithm { get; set; }
		private PyramidSeriesSonificationTracksPointGroupingAlgorithm Algorithm_DefaultValue { get; set; }
		...
		internal override Hashtable ToHashtable(Highcharts highcharts)
		{
			...
			if (Algorithm != PyramidSeriesSonificationTracksPointGroupingAlgorithm.Null) h.Add("algorithm", highcharts.FirstCharacterToLower(Algorithm.ToString()));
