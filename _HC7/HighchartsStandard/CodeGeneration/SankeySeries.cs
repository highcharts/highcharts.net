...
namespace Highsoft.Web.Mvc.Charts
{
	public partial class SankeySeries  : Series
	{
		...
		public SankeySeries()
		{
			...
			Dumbell = Dumbell_DefaultValue = new SankeySeriesDumbell();
			...
			LegendSymbol = LegendSymbol_DefaultValue = SankeySeriesLegendSymbol.Rectangle;
			Levels = Levels_DefaultValue = new SankeySeriesLevels();
			LinkColorMode = LinkColorMode_DefaultValue = SankeySeriesLinkColorMode.From;
			LinkedTo = LinkedTo_DefaultValue = "";
			LinkOpacity = LinkOpacity_DefaultValue = null;
			MinLinkWidth = MinLinkWidth_DefaultValue = 0;
			Name = Name_DefaultValue = "";
			NodeAlignment = NodeAlignment_DefaultValue = SankeySeriesNodeAlignment.Top;
			...
			OnPoint = OnPoint_DefaultValue = new SankeySeriesOnPoint();
			...
			Sonification = Sonification_DefaultValue = new SankeySeriesSonification();
		...
		/// 
		/// </summary>
		public SankeySeriesDumbell Dumbell { get; set; }
		private SankeySeriesDumbell Dumbell_DefaultValue { get; set; }
