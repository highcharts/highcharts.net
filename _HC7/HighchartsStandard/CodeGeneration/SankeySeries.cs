...
namespace Highsoft.Web.Mvc.Charts
{
	public partial class SankeySeries  : Series
	{
		...
		/// </summary>
		public SankeySeriesLinkColorMode LinkColorMode { get; set; }
		private SankeySeriesLinkColorMode LinkColorMode_DefaultValue { get; set; }
		...
		/// </summary>
		public SankeySeriesNodeAlignment NodeAlignment { get; set; }
		private SankeySeriesNodeAlignment NodeAlignment_DefaultValue { get; set; }
		...
		/// </summary>
		public SankeySeriesOnPoint OnPoint { get; set; }
		private SankeySeriesOnPoint OnPoint_DefaultValue { get; set; }
		...
		/// </summary>
		public SankeySeriesSonification Sonification { get; set; }
		private SankeySeriesSonification Sonification_DefaultValue { get; set; }
		...
		internal override Hashtable ToHashtable(Highcharts highcharts)
		{
			...
			if (Cursor != SankeySeriesCursor.Null) h.Add("cursor", highcharts.FirstCharacterToLower(Cursor.ToString()));
			if (CurveFactor != null) h.Add("curveFactor",CurveFactor);
			if (Custom != null) h.Add("custom",Custom);
			if (DashStyle != SankeySeriesDashStyle.Null) h.Add("dashStyle", highcharts.FirstCharacterToLower(DashStyle.ToString()));
			...
			if (LegendSymbol != SankeySeriesLegendSymbol.Null) h.Add("legendSymbol", highcharts.FirstCharacterToLower(LegendSymbol.ToString()));
			if (Levels != null) h.Add("levels",Levels.ToHashtable(highcharts));
			if (LinkColorMode != SankeySeriesLinkColorMode.Null) h.Add("linkColorMode", highcharts.FirstCharacterToLower(LinkColorMode.ToString()));
			...
			if (NodeAlignment != SankeySeriesNodeAlignment.Null) h.Add("nodeAlignment", highcharts.FirstCharacterToLower(NodeAlignment.ToString()));
