...
namespace Highsoft.Web.Mvc.Charts
{
	public partial class SankeySeriesAccessibility  : BaseObject
	{
		...
		public SankeySeriesAccessibility()
		{
			...
			Point = Point_DefaultValue = new SankeySeriesAccessibilityPoint();
		...
		/// </summary>
		public SankeySeriesAccessibilityPoint Point { get; set; }
		private SankeySeriesAccessibilityPoint Point_DefaultValue { get; set; }
