...
{
	public partial class SankeySeriesDragDropDragHandle  : BaseObject
	{
		public SankeySeriesDragDropDragHandle()
		{
		...
		internal override Hashtable ToHashtable()
		{
			...
			if (PathFormatter != PathFormatter_DefaultValue) { h.Add("pathFormatter",PathFormatter); Highcharts.AddFunction("SankeySeriesDragDropDragHandlePathFormatter.pathFormatter", PathFormatter); }  
