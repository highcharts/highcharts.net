...
{
	public partial class SankeySeriesSonificationContextTracksMappingFrequency  : BaseObject
	{
		Hashtable h = new Hashtable();

		public SankeySeriesSonificationContextTracksMappingFrequency()
		{
			MapFunction = MapFunction_DefaultValue = SankeySeriesSonificationContextTracksMappingFrequencyMapFunction.Linear;
			MapTo = MapTo_DefaultValue = "";
			Max = Max_DefaultValue = null;
			Min = Min_DefaultValue = null;
			Value = Value_DefaultValue = null;
			Within = Within_DefaultValue = SankeySeriesSonificationContextTracksMappingFrequencyWithin.Chart;
		...
		/// </summary>
		public SankeySeriesSonificationContextTracksMappingFrequencyMapFunction MapFunction { get; set; }
		private SankeySeriesSonificationContextTracksMappingFrequencyMapFunction MapFunction_DefaultValue { get; set; }
		...
		/// </summary>
		public SankeySeriesSonificationContextTracksMappingFrequencyWithin Within { get; set; }
		private SankeySeriesSonificationContextTracksMappingFrequencyWithin Within_DefaultValue { get; set; }
