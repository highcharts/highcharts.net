...
{
	public partial class SankeySeriesSonificationContextTracksMappingHighpassFrequency  : BaseObject
	{
		Hashtable h = new Hashtable();

		public SankeySeriesSonificationContextTracksMappingHighpassFrequency()
		{
			MapFunction = MapFunction_DefaultValue = SankeySeriesSonificationContextTracksMappingHighpassFrequencyMapFunction.Linear;
			MapTo = MapTo_DefaultValue = "";
			Max = Max_DefaultValue = null;
			Min = Min_DefaultValue = null;
			Value = Value_DefaultValue = null;
			Within = Within_DefaultValue = SankeySeriesSonificationContextTracksMappingHighpassFrequencyWithin.Chart;
		...
		/// </summary>
		public SankeySeriesSonificationContextTracksMappingHighpassFrequencyMapFunction MapFunction { get; set; }
		private SankeySeriesSonificationContextTracksMappingHighpassFrequencyMapFunction MapFunction_DefaultValue { get; set; }
		...
		/// </summary>
		public SankeySeriesSonificationContextTracksMappingHighpassFrequencyWithin Within { get; set; }
		private SankeySeriesSonificationContextTracksMappingHighpassFrequencyWithin Within_DefaultValue { get; set; }
