...
{
	public partial class SankeySeriesSonificationContextTracksMappingPitch  : BaseObject
	{
		Hashtable h = new Hashtable();

		public SankeySeriesSonificationContextTracksMappingPitch()
		{
			MapFunction = MapFunction_DefaultValue = SankeySeriesSonificationContextTracksMappingPitchMapFunction.Linear;
		...
		/// </summary>
		public SankeySeriesSonificationContextTracksMappingPitchMapFunction MapFunction { get; set; }
		private SankeySeriesSonificationContextTracksMappingPitchMapFunction MapFunction_DefaultValue { get; set; }
