...
{
	public partial class SankeySeriesSonificationDefaultSpeechOptionsMapping  : BaseObject
	{
		Hashtable h = new Hashtable();

		public SankeySeriesSonificationDefaultSpeechOptionsMapping()
		{
			Frequency = Frequency_DefaultValue = new SankeySeriesSonificationDefaultSpeechOptionsMappingFrequency();
			GapBetweenNotes = GapBetweenNotes_DefaultValue = new SankeySeriesSonificationDefaultSpeechOptionsMappingGapBetweenNotes();
			Highpass = Highpass_DefaultValue = new SankeySeriesSonificationDefaultSpeechOptionsMappingHighpass();
			Lowpass = Lowpass_DefaultValue = new SankeySeriesSonificationDefaultSpeechOptionsMappingLowpass();
			NoteDuration = NoteDuration_DefaultValue = new SankeySeriesSonificationDefaultSpeechOptionsMappingNoteDuration();
			Pan = Pan_DefaultValue = new SankeySeriesSonificationDefaultSpeechOptionsMappingPan();
			Pitch = Pitch_DefaultValue = new SankeySeriesSonificationDefaultSpeechOptionsMappingPitch();
			PitchString = PitchString_DefaultValue = "null";
			PitchNumber = PitchNumber_DefaultValue = null;
			PlayDelay = PlayDelay_DefaultValue = new SankeySeriesSonificationDefaultSpeechOptionsMappingPlayDelay();
			Time = Time_DefaultValue = new SankeySeriesSonificationDefaultSpeechOptionsMappingTime();
			TimeString = TimeString_DefaultValue = "null";
			TimeNumber = TimeNumber_DefaultValue = null;
			Tremolo = Tremolo_DefaultValue = new SankeySeriesSonificationDefaultSpeechOptionsMappingTremolo();
			Volume = Volume_DefaultValue = new SankeySeriesSonificationDefaultSpeechOptionsMappingVolume();
		...
		/// </summary>
		public SankeySeriesSonificationDefaultSpeechOptionsMappingFrequency Frequency { get; set; }
		private SankeySeriesSonificationDefaultSpeechOptionsMappingFrequency Frequency_DefaultValue { get; set; }
		...
		/// </summary>
		public SankeySeriesSonificationDefaultSpeechOptionsMappingGapBetweenNotes GapBetweenNotes { get; set; }
		private SankeySeriesSonificationDefaultSpeechOptionsMappingGapBetweenNotes GapBetweenNotes_DefaultValue { get; set; }
		...
		/// </summary>
		public SankeySeriesSonificationDefaultSpeechOptionsMappingHighpass Highpass { get; set; }
		private SankeySeriesSonificationDefaultSpeechOptionsMappingHighpass Highpass_DefaultValue { get; set; }
		...
		/// </summary>
		public SankeySeriesSonificationDefaultSpeechOptionsMappingLowpass Lowpass { get; set; }
		private SankeySeriesSonificationDefaultSpeechOptionsMappingLowpass Lowpass_DefaultValue { get; set; }
		...
		/// </summary>
		public SankeySeriesSonificationDefaultSpeechOptionsMappingNoteDuration NoteDuration { get; set; }
		private SankeySeriesSonificationDefaultSpeechOptionsMappingNoteDuration NoteDuration_DefaultValue { get; set; }
		...
		/// </summary>
		public SankeySeriesSonificationDefaultSpeechOptionsMappingPan Pan { get; set; }
		private SankeySeriesSonificationDefaultSpeechOptionsMappingPan Pan_DefaultValue { get; set; }
		...
		/// </summary>
		public SankeySeriesSonificationDefaultSpeechOptionsMappingPitch Pitch { get; set; }
		private SankeySeriesSonificationDefaultSpeechOptionsMappingPitch Pitch_DefaultValue { get; set; }
		...
		/// </summary>
		public SankeySeriesSonificationDefaultSpeechOptionsMappingPlayDelay PlayDelay { get; set; }
		private SankeySeriesSonificationDefaultSpeechOptionsMappingPlayDelay PlayDelay_DefaultValue { get; set; }
		...
		/// </summary>
		public SankeySeriesSonificationDefaultSpeechOptionsMappingTime Time { get; set; }
		private SankeySeriesSonificationDefaultSpeechOptionsMappingTime Time_DefaultValue { get; set; }
		...
		/// </summary>
		public SankeySeriesSonificationDefaultSpeechOptionsMappingTremolo Tremolo { get; set; }
		private SankeySeriesSonificationDefaultSpeechOptionsMappingTremolo Tremolo_DefaultValue { get; set; }
		 

		/// <summary>
		/// The volume of notes, from 0 to 1.
		/// </summary>
		public SankeySeriesSonificationDefaultSpeechOptionsMappingVolume Volume { get; set; }
		private SankeySeriesSonificationDefaultSpeechOptionsMappingVolume Volume_DefaultValue { get; set; }
