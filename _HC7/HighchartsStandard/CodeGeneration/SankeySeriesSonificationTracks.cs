...
{
	public partial class SankeySeriesSonificationTracks  : BaseObject
	{
		Hashtable h = new Hashtable();

		public SankeySeriesSonificationTracks()
		{
			ActiveWhen = ActiveWhen_DefaultValue = new SankeySeriesSonificationTracksActiveWhen();
			Instrument = Instrument_DefaultValue = null;
			InstrumentString = InstrumentString_DefaultValue = "null";
			Mapping = Mapping_DefaultValue = new SankeySeriesSonificationTracksMapping();
			MidiName = MidiName_DefaultValue = "";
			PointGrouping = PointGrouping_DefaultValue = new SankeySeriesSonificationTracksPointGrouping();
			RoundToMusicalNotes = RoundToMusicalNotes_DefaultValue = true;
			ShowPlayMarker = ShowPlayMarker_DefaultValue = true;
			Type = Type_DefaultValue = SankeySeriesSonificationTracksType.Instrument;
		...
		/// </summary>
		public SankeySeriesSonificationTracksActiveWhen ActiveWhen { get; set; }
		private SankeySeriesSonificationTracksActiveWhen ActiveWhen_DefaultValue { get; set; }
		...
		/// </summary>
		public SankeySeriesSonificationTracksMapping Mapping { get; set; }
		private SankeySeriesSonificationTracksMapping Mapping_DefaultValue { get; set; }
		...
		/// </summary>
		public SankeySeriesSonificationTracksPointGrouping PointGrouping { get; set; }
		private SankeySeriesSonificationTracksPointGrouping PointGrouping_DefaultValue { get; set; }
		...
		/// </summary>
		public SankeySeriesSonificationTracksType Type { get; set; }
		private SankeySeriesSonificationTracksType Type_DefaultValue { get; set; }
