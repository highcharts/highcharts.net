...
namespace Highsoft.Web.Mvc.Charts
{
	public partial class SankeySeriesSonificationTracksMapping  : BaseObject
	{
		...
		public SankeySeriesSonificationTracksMapping()
		{
			...
			Time = Time_DefaultValue = new SankeySeriesSonificationTracksMappingTime();
		...
		/// </summary>
		public SankeySeriesSonificationTracksMappingTime Time { get; set; }
		private SankeySeriesSonificationTracksMappingTime Time_DefaultValue { get; set; }
