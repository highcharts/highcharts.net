...
{
	public partial class SankeySeriesSonificationTracksMappingTime  : BaseObject
	{
		Hashtable h = new Hashtable();

		public SankeySeriesSonificationTracksMappingTime()
		{
			MapFunction = MapFunction_DefaultValue = SankeySeriesSonificationTracksMappingTimeMapFunction.Linear;
			MapTo = MapTo_DefaultValue = "";
			Max = Max_DefaultValue = null;
			Min = Min_DefaultValue = null;
			Value = Value_DefaultValue = null;
			Within = Within_DefaultValue = SankeySeriesSonificationTracksMappingTimeWithin.Chart;
		...
		/// </summary>
		public SankeySeriesSonificationTracksMappingTimeMapFunction MapFunction { get; set; }
		private SankeySeriesSonificationTracksMappingTimeMapFunction MapFunction_DefaultValue { get; set; }
		...
		/// </summary>
		public SankeySeriesSonificationTracksMappingTimeWithin Within { get; set; }
		private SankeySeriesSonificationTracksMappingTimeWithin Within_DefaultValue { get; set; }
