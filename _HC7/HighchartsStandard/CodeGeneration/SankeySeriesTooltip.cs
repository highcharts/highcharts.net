...
namespace Highsoft.Web.Mvc.Charts
{
	public partial class SankeySeriesTooltip  : BaseObject
	{
		public SankeySeriesTooltip()
		{
			...
			HeaderShape = HeaderShape_DefaultValue = SankeySeriesTooltipHeaderShape.Callout;
		...
		/// </summary>
		public SankeySeriesTooltipHeaderShape HeaderShape { get; set; }
		private SankeySeriesTooltipHeaderShape HeaderShape_DefaultValue { get; set; }
		...
		internal override Hashtable ToHashtable()
		{
			...
			if (NullFormatter != NullFormatter_DefaultValue) { h.Add("nullFormatter",NullFormatter); Highcharts.AddFunction("2e0b0bec-ae88-4e81-b265-a23ce4831459.nullFormatter", NullFormatter); }  
			if (Outside != Outside_DefaultValue) h.Add("outside",Outside);
			if (Padding != Padding_DefaultValue) h.Add("padding",Padding);
			if (PointFormat != PointFormat_DefaultValue) h.Add("pointFormat",PointFormat);
			if (PointFormatter != PointFormatter_DefaultValue) { h.Add("pointFormatter",PointFormatter); Highcharts.AddFunction("16baf0ca-80d5-4bed-a34e-9d9ee5c0a610.pointFormatter", PointFormatter); }  
