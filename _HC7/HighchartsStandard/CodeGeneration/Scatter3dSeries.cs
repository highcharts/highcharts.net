...
namespace Highsoft.Web.Mvc.Charts
{
	public partial class Scatter3dSeries  : Series
	{
		public Scatter3dSeries()
		{
			...
			Type = Type_DefaultValue = Scatter3dSeriesType.Null;
		...
		internal override Hashtable ToHashtable()
		{
			...
			if (PointDescriptionFormatter != PointDescriptionFormatter_DefaultValue) { h.Add("pointDescriptionFormatter",PointDescriptionFormatter); Highcharts.AddFunction("Scatter3dSeriesPointDescriptionFormatter.pointDescriptionFormatter", PointDescriptionFormatter); }  
