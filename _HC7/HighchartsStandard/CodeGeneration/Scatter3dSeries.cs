...
namespace Highsoft.Web.Mvc.Charts
{
	public partial class Scatter3dSeries  : Series
	{
		...
		internal override Hashtable ToHashtable()
		{
			...
			if (PointDescriptionFormatter != PointDescriptionFormatter_DefaultValue) { h.Add("pointDescriptionFormatter",PointDescriptionFormatter); Highcharts.AddFunction("2af0e49e-20f0-4b05-b1a7-d3a3f164d711.pointDescriptionFormatter", PointDescriptionFormatter); }  
