...
namespace Highsoft.Web.Mvc.Charts
{
	public partial class Scatter3dSeries  : Series
	{
		...
		public Scatter3dSeries()
		{
			...
			Dumbell = Dumbell_DefaultValue = new Scatter3dSeriesDumbell();
			...
			LegendSymbol = LegendSymbol_DefaultValue = Scatter3dSeriesLegendSymbol.Rectangle;
			...
			OnPoint = OnPoint_DefaultValue = new Scatter3dSeriesOnPoint();
			...
			Sonification = Sonification_DefaultValue = new Scatter3dSeriesSonification();
		...
		/// 
		/// </summary>
		public Scatter3dSeriesDumbell Dumbell { get; set; }
		private Scatter3dSeriesDumbell Dumbell_DefaultValue { get; set; }
		...
		/// </summary>
		public Scatter3dSeriesLegendSymbol LegendSymbol { get; set; }
		private Scatter3dSeriesLegendSymbol LegendSymbol_DefaultValue { get; set; }
		...
		/// </summary>
		public Scatter3dSeriesOnPoint OnPoint { get; set; }
		private Scatter3dSeriesOnPoint OnPoint_DefaultValue { get; set; }
		...
		/// </summary>
		public Scatter3dSeriesSonification Sonification { get; set; }
		private Scatter3dSeriesSonification Sonification_DefaultValue { get; set; }
