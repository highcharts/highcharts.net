...
namespace Highsoft.Web.Mvc.Charts
{
	public partial class Scatter3dSeriesData  : BaseObject
	{
		...
		{
			Accessibility = Accessibility_DefaultValue = new Scatter3dSeriesDataAccessibility();
			ClassName = ClassName_DefaultValue = "";
			Color = Color_DefaultValue = "";
			ColorIndex = ColorIndex_DefaultValue = null;
			DataLabels = DataLabels_DefaultValue = new Scatter3dSeriesDataLabels();
			Description = Description_DefaultValue = "";
			DragDrop = DragDrop_DefaultValue = new Scatter3dSeriesDataDragDrop();
		...
		/// 
		/// </summary>
		public Scatter3dSeriesDataAccessibility Accessibility { get; set; }
		private Scatter3dSeriesDataAccessibility Accessibility_DefaultValue { get; set; }
		...
		/// </summary>
		public Scatter3dSeriesDataDragDrop DragDrop { get; set; }
		private Scatter3dSeriesDataDragDrop DragDrop_DefaultValue { get; set; }
