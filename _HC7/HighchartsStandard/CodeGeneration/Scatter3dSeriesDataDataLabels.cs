...
{
	public partial class Scatter3dSeriesDataDataLabels  : BaseObject
	{
		Hashtable h = new Hashtable();

		public Scatter3dSeriesDataDataLabels()
		{
		...
		/// </summary>
		public Scatter3dSeriesDataDataLabelsAlign Align { get; set; }
		private Scatter3dSeriesDataDataLabelsAlign Align_DefaultValue { get; set; }
		...
		/// </summary>
		public Scatter3dSeriesDataDataLabelsFilter Filter { get; set; }
		private Scatter3dSeriesDataDataLabelsFilter Filter_DefaultValue { get; set; }
		...
		/// </summary>
		public Scatter3dSeriesDataDataLabelsOverflow Overflow { get; set; }
		private Scatter3dSeriesDataDataLabelsOverflow Overflow_DefaultValue { get; set; }
		...
		/// </summary>
		public Scatter3dSeriesDataDataLabelsPosition Position { get; set; }
		private Scatter3dSeriesDataDataLabelsPosition Position_DefaultValue { get; set; }
		...
		/// </summary>
		public Scatter3dSeriesDataDataLabelsTextPath TextPath { get; set; }
		private Scatter3dSeriesDataDataLabelsTextPath TextPath_DefaultValue { get; set; }
		...
		/// </summary>
		public Scatter3dSeriesDataDataLabelsVerticalAlign VerticalAlign { get; set; }
		private Scatter3dSeriesDataDataLabelsVerticalAlign VerticalAlign_DefaultValue { get; set; }
		...
		internal override Hashtable ToHashtable(Highcharts highcharts)
		{
			...
			if (Align != Scatter3dSeriesDataDataLabelsAlign.Null) h.Add("align", highcharts.FirstCharacterToLower(Align.ToString()));
			...
			if (Overflow != Scatter3dSeriesDataDataLabelsOverflow.Null) h.Add("overflow", highcharts.FirstCharacterToLower(Overflow.ToString()));
			if (Padding != null) h.Add("padding",Padding);
			if (Position != Scatter3dSeriesDataDataLabelsPosition.Null) h.Add("position", highcharts.FirstCharacterToLower(Position.ToString()));
			...
			if (VerticalAlign != Scatter3dSeriesDataDataLabelsVerticalAlign.Null) h.Add("verticalAlign", highcharts.FirstCharacterToLower(VerticalAlign.ToString()));
			if (X != null) h.Add("x",X);
			if (Y != null) h.Add("y",Y);
