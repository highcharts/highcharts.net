...
{
	public partial class Scatter3dSeriesMarker  : BaseObject
	{
		public Scatter3dSeriesMarker()
		{
			...
			States = States_DefaultValue = new Scatter3dSeriesMarkerStates();
		...
		/// </summary>
		public Scatter3dSeriesMarkerStates States { get; set; }
		private Scatter3dSeriesMarkerStates States_DefaultValue { get; set; }
