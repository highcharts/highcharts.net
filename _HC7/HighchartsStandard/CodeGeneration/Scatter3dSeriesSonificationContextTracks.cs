...
namespace Highsoft.Web.Mvc.Charts
{
	public partial class Scatter3dSeriesSonificationContextTracks  : BaseObject
	{
		...
		internal override Hashtable ToHashtable(Highcharts highcharts)
		{
			...
			if (Type != Scatter3dSeriesSonificationContextTracksType.Null) h.Add("type", highcharts.FirstCharacterToLower(Type.ToString()));
			if (ValueInterval != null) h.Add("valueInterval",ValueInterval);
			if (ValueMapFunction != Scatter3dSeriesSonificationContextTracksValueMapFunction.Null) h.Add("valueMapFunction", highcharts.FirstCharacterToLower(ValueMapFunction.ToString()));
