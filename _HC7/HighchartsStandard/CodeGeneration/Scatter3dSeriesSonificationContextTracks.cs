...
{
	public partial class Scatter3dSeriesSonificationContextTracks  : BaseObject
	{
		Hashtable h = new Hashtable();

		public Scatter3dSeriesSonificationContextTracks()
		{
			ActiveWhen = ActiveWhen_DefaultValue = new Scatter3dSeriesSonificationContextTracksActiveWhen();
			Instrument = Instrument_DefaultValue = null;
			InstrumentString = InstrumentString_DefaultValue = "null";
			Mapping = Mapping_DefaultValue = new Scatter3dSeriesSonificationContextTracksMapping();
			MidiName = MidiName_DefaultValue = "";
			PointGrouping = PointGrouping_DefaultValue = new Scatter3dSeriesSonificationContextTracksPointGrouping();
			...
			Type = Type_DefaultValue = Scatter3dSeriesSonificationContextTracksType.Instrument;
			ValueInterval = ValueInterval_DefaultValue = null;
			ValueMapFunction = ValueMapFunction_DefaultValue = Scatter3dSeriesSonificationContextTracksValueMapFunction.Linear;
		...
		/// </summary>
		public Scatter3dSeriesSonificationContextTracksActiveWhen ActiveWhen { get; set; }
		private Scatter3dSeriesSonificationContextTracksActiveWhen ActiveWhen_DefaultValue { get; set; }
		...
		/// </summary>
		public Scatter3dSeriesSonificationContextTracksMapping Mapping { get; set; }
		private Scatter3dSeriesSonificationContextTracksMapping Mapping_DefaultValue { get; set; }
		...
		/// </summary>
		public Scatter3dSeriesSonificationContextTracksPointGrouping PointGrouping { get; set; }
		private Scatter3dSeriesSonificationContextTracksPointGrouping PointGrouping_DefaultValue { get; set; }
		...
		/// </summary>
		public Scatter3dSeriesSonificationContextTracksType Type { get; set; }
		private Scatter3dSeriesSonificationContextTracksType Type_DefaultValue { get; set; }
		...
		/// </summary>
		public Scatter3dSeriesSonificationContextTracksValueMapFunction ValueMapFunction { get; set; }
		private Scatter3dSeriesSonificationContextTracksValueMapFunction ValueMapFunction_DefaultValue { get; set; }
