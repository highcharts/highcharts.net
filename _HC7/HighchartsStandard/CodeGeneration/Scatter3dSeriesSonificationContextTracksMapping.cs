...
{
	public partial class Scatter3dSeriesSonificationContextTracksMapping  : BaseObject
	{
		Hashtable h = new Hashtable();

		public Scatter3dSeriesSonificationContextTracksMapping()
		{
			Frequency = Frequency_DefaultValue = new Scatter3dSeriesSonificationContextTracksMappingFrequency();
			GapBetweenNotes = GapBetweenNotes_DefaultValue = new Scatter3dSeriesSonificationContextTracksMappingGapBetweenNotes();
			Highpass = Highpass_DefaultValue = new Scatter3dSeriesSonificationContextTracksMappingHighpass();
			Lowpass = Lowpass_DefaultValue = new Scatter3dSeriesSonificationContextTracksMappingLowpass();
			NoteDuration = NoteDuration_DefaultValue = new Scatter3dSeriesSonificationContextTracksMappingNoteDuration();
			Pan = Pan_DefaultValue = new Scatter3dSeriesSonificationContextTracksMappingPan();
			Pitch = Pitch_DefaultValue = new Scatter3dSeriesSonificationContextTracksMappingPitch();
			PitchString = PitchString_DefaultValue = "null";
			PitchNumber = PitchNumber_DefaultValue = null;
			PlayDelay = PlayDelay_DefaultValue = new Scatter3dSeriesSonificationContextTracksMappingPlayDelay();
			Time = Time_DefaultValue = new Scatter3dSeriesSonificationContextTracksMappingTime();
			TimeString = TimeString_DefaultValue = "null";
			TimeNumber = TimeNumber_DefaultValue = null;
			Tremolo = Tremolo_DefaultValue = new Scatter3dSeriesSonificationContextTracksMappingTremolo();
			Volume = Volume_DefaultValue = new Scatter3dSeriesSonificationContextTracksMappingVolume();
		...
		/// </summary>
		public Scatter3dSeriesSonificationContextTracksMappingFrequency Frequency { get; set; }
		private Scatter3dSeriesSonificationContextTracksMappingFrequency Frequency_DefaultValue { get; set; }
		...
		/// </summary>
		public Scatter3dSeriesSonificationContextTracksMappingGapBetweenNotes GapBetweenNotes { get; set; }
		private Scatter3dSeriesSonificationContextTracksMappingGapBetweenNotes GapBetweenNotes_DefaultValue { get; set; }
		...
		/// </summary>
		public Scatter3dSeriesSonificationContextTracksMappingHighpass Highpass { get; set; }
		private Scatter3dSeriesSonificationContextTracksMappingHighpass Highpass_DefaultValue { get; set; }
		...
		/// </summary>
		public Scatter3dSeriesSonificationContextTracksMappingLowpass Lowpass { get; set; }
		private Scatter3dSeriesSonificationContextTracksMappingLowpass Lowpass_DefaultValue { get; set; }
		...
		/// </summary>
		public Scatter3dSeriesSonificationContextTracksMappingNoteDuration NoteDuration { get; set; }
		private Scatter3dSeriesSonificationContextTracksMappingNoteDuration NoteDuration_DefaultValue { get; set; }
		...
		/// </summary>
		public Scatter3dSeriesSonificationContextTracksMappingPan Pan { get; set; }
		private Scatter3dSeriesSonificationContextTracksMappingPan Pan_DefaultValue { get; set; }
		...
		/// </summary>
		public Scatter3dSeriesSonificationContextTracksMappingPitch Pitch { get; set; }
		private Scatter3dSeriesSonificationContextTracksMappingPitch Pitch_DefaultValue { get; set; }
		...
		/// </summary>
		public Scatter3dSeriesSonificationContextTracksMappingPlayDelay PlayDelay { get; set; }
		private Scatter3dSeriesSonificationContextTracksMappingPlayDelay PlayDelay_DefaultValue { get; set; }
		...
		/// </summary>
		public Scatter3dSeriesSonificationContextTracksMappingTime Time { get; set; }
		private Scatter3dSeriesSonificationContextTracksMappingTime Time_DefaultValue { get; set; }
		...
		/// </summary>
		public Scatter3dSeriesSonificationContextTracksMappingTremolo Tremolo { get; set; }
		private Scatter3dSeriesSonificationContextTracksMappingTremolo Tremolo_DefaultValue { get; set; }
		 

		/// <summary>
		/// The volume of notes, from 0 to 1.
		/// </summary>
		public Scatter3dSeriesSonificationContextTracksMappingVolume Volume { get; set; }
		private Scatter3dSeriesSonificationContextTracksMappingVolume Volume_DefaultValue { get; set; }
