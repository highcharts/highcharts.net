...
{
	public partial class Scatter3dSeriesSonificationContextTracksMappingFrequency  : BaseObject
	{
		Hashtable h = new Hashtable();

		public Scatter3dSeriesSonificationContextTracksMappingFrequency()
		{
			MapFunction = MapFunction_DefaultValue = Scatter3dSeriesSonificationContextTracksMappingFrequencyMapFunction.Linear;
			MapTo = MapTo_DefaultValue = "";
			Max = Max_DefaultValue = null;
			Min = Min_DefaultValue = null;
			Value = Value_DefaultValue = null;
			Within = Within_DefaultValue = Scatter3dSeriesSonificationContextTracksMappingFrequencyWithin.Chart;
		...
		/// </summary>
		public Scatter3dSeriesSonificationContextTracksMappingFrequencyMapFunction MapFunction { get; set; }
		private Scatter3dSeriesSonificationContextTracksMappingFrequencyMapFunction MapFunction_DefaultValue { get; set; }
		...
		/// </summary>
		public Scatter3dSeriesSonificationContextTracksMappingFrequencyWithin Within { get; set; }
		private Scatter3dSeriesSonificationContextTracksMappingFrequencyWithin Within_DefaultValue { get; set; }
