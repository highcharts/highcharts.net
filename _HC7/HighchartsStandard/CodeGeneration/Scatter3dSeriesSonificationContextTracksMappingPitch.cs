...
{
	public partial class Scatter3dSeriesSonificationContextTracksMappingPitch  : BaseObject
	{
		Hashtable h = new Hashtable();

		public Scatter3dSeriesSonificationContextTracksMappingPitch()
		{
			MapFunction = MapFunction_DefaultValue = Scatter3dSeriesSonificationContextTracksMappingPitchMapFunction.Linear;
		...
		/// </summary>
		public Scatter3dSeriesSonificationContextTracksMappingPitchMapFunction MapFunction { get; set; }
		private Scatter3dSeriesSonificationContextTracksMappingPitchMapFunction MapFunction_DefaultValue { get; set; }
