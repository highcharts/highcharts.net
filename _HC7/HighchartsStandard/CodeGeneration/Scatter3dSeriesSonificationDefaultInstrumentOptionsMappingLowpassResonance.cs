...
{
	public partial class Scatter3dSeriesSonificationDefaultInstrumentOptionsMappingLowpassResonance  : BaseObject
	{
		Hashtable h = new Hashtable();

		public Scatter3dSeriesSonificationDefaultInstrumentOptionsMappingLowpassResonance()
		{
			MapFunction = MapFunction_DefaultValue = Scatter3dSeriesSonificationDefaultInstrumentOptionsMappingLowpassResonanceMapFunction.Linear;
			MapTo = MapTo_DefaultValue = "";
			Max = Max_DefaultValue = null;
			Min = Min_DefaultValue = null;
			Value = Value_DefaultValue = null;
			Within = Within_DefaultValue = Scatter3dSeriesSonificationDefaultInstrumentOptionsMappingLowpassResonanceWithin.Chart;
		...
		/// </summary>
		public Scatter3dSeriesSonificationDefaultInstrumentOptionsMappingLowpassResonanceMapFunction MapFunction { get; set; }
		private Scatter3dSeriesSonificationDefaultInstrumentOptionsMappingLowpassResonanceMapFunction MapFunction_DefaultValue { get; set; }
		...
		/// </summary>
		public Scatter3dSeriesSonificationDefaultInstrumentOptionsMappingLowpassResonanceWithin Within { get; set; }
		private Scatter3dSeriesSonificationDefaultInstrumentOptionsMappingLowpassResonanceWithin Within_DefaultValue { get; set; }
