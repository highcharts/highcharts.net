...
{
	public partial class Scatter3dSeriesSonificationPointGrouping  : BaseObject
	{
		Hashtable h = new Hashtable();

		public Scatter3dSeriesSonificationPointGrouping()
		{
		...
		/// </summary>
		public Scatter3dSeriesSonificationPointGroupingAlgorithm Algorithm { get; set; }
		private Scatter3dSeriesSonificationPointGroupingAlgorithm Algorithm_DefaultValue { get; set; }
		...
		internal override Hashtable ToHashtable(Highcharts highcharts)
		{
			...
			if (Algorithm != Scatter3dSeriesSonificationPointGroupingAlgorithm.Null) h.Add("algorithm", highcharts.FirstCharacterToLower(Algorithm.ToString()));
