...
{
	public partial class Scatter3dSeriesSonificationTracks  : BaseObject
	{
		Hashtable h = new Hashtable();

		public Scatter3dSeriesSonificationTracks()
		{
			ActiveWhen = ActiveWhen_DefaultValue = new Scatter3dSeriesSonificationTracksActiveWhen();
			Instrument = Instrument_DefaultValue = null;
			InstrumentString = InstrumentString_DefaultValue = "null";
			Mapping = Mapping_DefaultValue = new Scatter3dSeriesSonificationTracksMapping();
			MidiName = MidiName_DefaultValue = "";
			PointGrouping = PointGrouping_DefaultValue = new Scatter3dSeriesSonificationTracksPointGrouping();
			RoundToMusicalNotes = RoundToMusicalNotes_DefaultValue = true;
			ShowPlayMarker = ShowPlayMarker_DefaultValue = true;
			Type = Type_DefaultValue = Scatter3dSeriesSonificationTracksType.Instrument;
		...
		/// </summary>
		public Scatter3dSeriesSonificationTracksActiveWhen ActiveWhen { get; set; }
		private Scatter3dSeriesSonificationTracksActiveWhen ActiveWhen_DefaultValue { get; set; }
		...
		/// </summary>
		public Scatter3dSeriesSonificationTracksMapping Mapping { get; set; }
		private Scatter3dSeriesSonificationTracksMapping Mapping_DefaultValue { get; set; }
		...
		/// </summary>
		public Scatter3dSeriesSonificationTracksPointGrouping PointGrouping { get; set; }
		private Scatter3dSeriesSonificationTracksPointGrouping PointGrouping_DefaultValue { get; set; }
		...
		/// </summary>
		public Scatter3dSeriesSonificationTracksType Type { get; set; }
		private Scatter3dSeriesSonificationTracksType Type_DefaultValue { get; set; }
