...
{
	public partial class Scatter3dSeriesSonificationTracksMapping  : BaseObject
	{
		Hashtable h = new Hashtable();

		public Scatter3dSeriesSonificationTracksMapping()
		{
			Frequency = Frequency_DefaultValue = new Scatter3dSeriesSonificationTracksMappingFrequency();
			GapBetweenNotes = GapBetweenNotes_DefaultValue = new Scatter3dSeriesSonificationTracksMappingGapBetweenNotes();
			Highpass = Highpass_DefaultValue = new Scatter3dSeriesSonificationTracksMappingHighpass();
			Lowpass = Lowpass_DefaultValue = new Scatter3dSeriesSonificationTracksMappingLowpass();
			NoteDuration = NoteDuration_DefaultValue = new Scatter3dSeriesSonificationTracksMappingNoteDuration();
			Pan = Pan_DefaultValue = new Scatter3dSeriesSonificationTracksMappingPan();
			Pitch = Pitch_DefaultValue = new Scatter3dSeriesSonificationTracksMappingPitch();
			PitchString = PitchString_DefaultValue = "null";
			PitchNumber = PitchNumber_DefaultValue = null;
			PlayDelay = PlayDelay_DefaultValue = new Scatter3dSeriesSonificationTracksMappingPlayDelay();
			Time = Time_DefaultValue = new Scatter3dSeriesSonificationTracksMappingTime();
			TimeString = TimeString_DefaultValue = "null";
			TimeNumber = TimeNumber_DefaultValue = null;
			Tremolo = Tremolo_DefaultValue = new Scatter3dSeriesSonificationTracksMappingTremolo();
			Volume = Volume_DefaultValue = new Scatter3dSeriesSonificationTracksMappingVolume();
		...
		/// </summary>
		public Scatter3dSeriesSonificationTracksMappingFrequency Frequency { get; set; }
		private Scatter3dSeriesSonificationTracksMappingFrequency Frequency_DefaultValue { get; set; }
		...
		/// </summary>
		public Scatter3dSeriesSonificationTracksMappingGapBetweenNotes GapBetweenNotes { get; set; }
		private Scatter3dSeriesSonificationTracksMappingGapBetweenNotes GapBetweenNotes_DefaultValue { get; set; }
		...
		/// </summary>
		public Scatter3dSeriesSonificationTracksMappingHighpass Highpass { get; set; }
		private Scatter3dSeriesSonificationTracksMappingHighpass Highpass_DefaultValue { get; set; }
		...
		/// </summary>
		public Scatter3dSeriesSonificationTracksMappingLowpass Lowpass { get; set; }
		private Scatter3dSeriesSonificationTracksMappingLowpass Lowpass_DefaultValue { get; set; }
		...
		/// </summary>
		public Scatter3dSeriesSonificationTracksMappingNoteDuration NoteDuration { get; set; }
		private Scatter3dSeriesSonificationTracksMappingNoteDuration NoteDuration_DefaultValue { get; set; }
		...
		/// </summary>
		public Scatter3dSeriesSonificationTracksMappingPan Pan { get; set; }
		private Scatter3dSeriesSonificationTracksMappingPan Pan_DefaultValue { get; set; }
		...
		/// </summary>
		public Scatter3dSeriesSonificationTracksMappingPitch Pitch { get; set; }
		private Scatter3dSeriesSonificationTracksMappingPitch Pitch_DefaultValue { get; set; }
		...
		/// </summary>
		public Scatter3dSeriesSonificationTracksMappingPlayDelay PlayDelay { get; set; }
		private Scatter3dSeriesSonificationTracksMappingPlayDelay PlayDelay_DefaultValue { get; set; }
		...
		/// </summary>
		public Scatter3dSeriesSonificationTracksMappingTime Time { get; set; }
		private Scatter3dSeriesSonificationTracksMappingTime Time_DefaultValue { get; set; }
		...
		/// </summary>
		public Scatter3dSeriesSonificationTracksMappingTremolo Tremolo { get; set; }
		private Scatter3dSeriesSonificationTracksMappingTremolo Tremolo_DefaultValue { get; set; }
		 

		/// <summary>
		/// The volume of notes, from 0 to 1.
		/// </summary>
		public Scatter3dSeriesSonificationTracksMappingVolume Volume { get; set; }
		private Scatter3dSeriesSonificationTracksMappingVolume Volume_DefaultValue { get; set; }
