...
{
	public partial class Scatter3dSeriesSonificationTracksMappingFrequency  : BaseObject
	{
		Hashtable h = new Hashtable();

		public Scatter3dSeriesSonificationTracksMappingFrequency()
		{
			MapFunction = MapFunction_DefaultValue = Scatter3dSeriesSonificationTracksMappingFrequencyMapFunction.Linear;
			MapTo = MapTo_DefaultValue = "";
			Max = Max_DefaultValue = null;
			Min = Min_DefaultValue = null;
			Value = Value_DefaultValue = null;
			Within = Within_DefaultValue = Scatter3dSeriesSonificationTracksMappingFrequencyWithin.Chart;
		...
		/// </summary>
		public Scatter3dSeriesSonificationTracksMappingFrequencyMapFunction MapFunction { get; set; }
		private Scatter3dSeriesSonificationTracksMappingFrequencyMapFunction MapFunction_DefaultValue { get; set; }
		...
		/// </summary>
		public Scatter3dSeriesSonificationTracksMappingFrequencyWithin Within { get; set; }
		private Scatter3dSeriesSonificationTracksMappingFrequencyWithin Within_DefaultValue { get; set; }
