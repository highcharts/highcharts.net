...
{
	public partial class Scatter3dSeriesSonificationTracksMappingPan  : BaseObject
	{
		Hashtable h = new Hashtable();

		public Scatter3dSeriesSonificationTracksMappingPan()
		{
			MapFunction = MapFunction_DefaultValue = Scatter3dSeriesSonificationTracksMappingPanMapFunction.Linear;
			MapTo = MapTo_DefaultValue = "";
			Max = Max_DefaultValue = null;
			Min = Min_DefaultValue = null;
			Value = Value_DefaultValue = null;
			Within = Within_DefaultValue = Scatter3dSeriesSonificationTracksMappingPanWithin.Chart;
		...
		/// </summary>
		public Scatter3dSeriesSonificationTracksMappingPanMapFunction MapFunction { get; set; }
		private Scatter3dSeriesSonificationTracksMappingPanMapFunction MapFunction_DefaultValue { get; set; }
		...
		/// </summary>
		public Scatter3dSeriesSonificationTracksMappingPanWithin Within { get; set; }
		private Scatter3dSeriesSonificationTracksMappingPanWithin Within_DefaultValue { get; set; }
