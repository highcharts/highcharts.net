...
{
	public partial class Scatter3dSeriesSonificationTracksMappingPitch  : BaseObject
	{
		Hashtable h = new Hashtable();

		public Scatter3dSeriesSonificationTracksMappingPitch()
		{
			MapFunction = MapFunction_DefaultValue = Scatter3dSeriesSonificationTracksMappingPitchMapFunction.Linear;
		...
		/// </summary>
		public Scatter3dSeriesSonificationTracksMappingPitchMapFunction MapFunction { get; set; }
		private Scatter3dSeriesSonificationTracksMappingPitchMapFunction MapFunction_DefaultValue { get; set; }
