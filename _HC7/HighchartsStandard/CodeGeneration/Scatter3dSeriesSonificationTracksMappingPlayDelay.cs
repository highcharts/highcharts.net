...
{
	public partial class Scatter3dSeriesSonificationTracksMappingPlayDelay  : BaseObject
	{
		Hashtable h = new Hashtable();

		public Scatter3dSeriesSonificationTracksMappingPlayDelay()
		{
			MapFunction = MapFunction_DefaultValue = Scatter3dSeriesSonificationTracksMappingPlayDelayMapFunction.Linear;
			MapTo = MapTo_DefaultValue = "";
			Max = Max_DefaultValue = null;
			Min = Min_DefaultValue = null;
			Value = Value_DefaultValue = null;
			Within = Within_DefaultValue = Scatter3dSeriesSonificationTracksMappingPlayDelayWithin.Chart;
		...
		/// </summary>
		public Scatter3dSeriesSonificationTracksMappingPlayDelayMapFunction MapFunction { get; set; }
		private Scatter3dSeriesSonificationTracksMappingPlayDelayMapFunction MapFunction_DefaultValue { get; set; }
		...
		/// </summary>
		public Scatter3dSeriesSonificationTracksMappingPlayDelayWithin Within { get; set; }
		private Scatter3dSeriesSonificationTracksMappingPlayDelayWithin Within_DefaultValue { get; set; }
