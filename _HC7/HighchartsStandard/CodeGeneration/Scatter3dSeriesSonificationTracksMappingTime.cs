...
{
	public partial class Scatter3dSeriesSonificationTracksMappingTime  : BaseObject
	{
		Hashtable h = new Hashtable();

		public Scatter3dSeriesSonificationTracksMappingTime()
		{
			MapFunction = MapFunction_DefaultValue = Scatter3dSeriesSonificationTracksMappingTimeMapFunction.Linear;
			MapTo = MapTo_DefaultValue = "";
			Max = Max_DefaultValue = null;
			Min = Min_DefaultValue = null;
			Value = Value_DefaultValue = null;
			Within = Within_DefaultValue = Scatter3dSeriesSonificationTracksMappingTimeWithin.Chart;
		...
		/// </summary>
		public Scatter3dSeriesSonificationTracksMappingTimeMapFunction MapFunction { get; set; }
		private Scatter3dSeriesSonificationTracksMappingTimeMapFunction MapFunction_DefaultValue { get; set; }
		...
		/// </summary>
		public Scatter3dSeriesSonificationTracksMappingTimeWithin Within { get; set; }
		private Scatter3dSeriesSonificationTracksMappingTimeWithin Within_DefaultValue { get; set; }
