...
{
	public partial class Scatter3dSeriesSonificationTracksMappingTremoloDepth  : BaseObject
	{
		Hashtable h = new Hashtable();

		public Scatter3dSeriesSonificationTracksMappingTremoloDepth()
		{
			MapFunction = MapFunction_DefaultValue = Scatter3dSeriesSonificationTracksMappingTremoloDepthMapFunction.Linear;
			MapTo = MapTo_DefaultValue = "";
			Max = Max_DefaultValue = null;
			Min = Min_DefaultValue = null;
			Value = Value_DefaultValue = null;
			Within = Within_DefaultValue = Scatter3dSeriesSonificationTracksMappingTremoloDepthWithin.Chart;
		...
		/// </summary>
		public Scatter3dSeriesSonificationTracksMappingTremoloDepthMapFunction MapFunction { get; set; }
		private Scatter3dSeriesSonificationTracksMappingTremoloDepthMapFunction MapFunction_DefaultValue { get; set; }
		...
		/// </summary>
		public Scatter3dSeriesSonificationTracksMappingTremoloDepthWithin Within { get; set; }
		private Scatter3dSeriesSonificationTracksMappingTremoloDepthWithin Within_DefaultValue { get; set; }
