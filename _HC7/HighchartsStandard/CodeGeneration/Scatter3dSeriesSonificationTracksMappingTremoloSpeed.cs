...
{
	public partial class Scatter3dSeriesSonificationTracksMappingTremoloSpeed  : BaseObject
	{
		Hashtable h = new Hashtable();

		public Scatter3dSeriesSonificationTracksMappingTremoloSpeed()
		{
			MapFunction = MapFunction_DefaultValue = Scatter3dSeriesSonificationTracksMappingTremoloSpeedMapFunction.Linear;
			MapTo = MapTo_DefaultValue = "";
			Max = Max_DefaultValue = null;
			Min = Min_DefaultValue = null;
			Value = Value_DefaultValue = null;
			Within = Within_DefaultValue = Scatter3dSeriesSonificationTracksMappingTremoloSpeedWithin.Chart;
		...
		/// </summary>
		public Scatter3dSeriesSonificationTracksMappingTremoloSpeedMapFunction MapFunction { get; set; }
		private Scatter3dSeriesSonificationTracksMappingTremoloSpeedMapFunction MapFunction_DefaultValue { get; set; }
		...
		/// </summary>
		public Scatter3dSeriesSonificationTracksMappingTremoloSpeedWithin Within { get; set; }
		private Scatter3dSeriesSonificationTracksMappingTremoloSpeedWithin Within_DefaultValue { get; set; }
