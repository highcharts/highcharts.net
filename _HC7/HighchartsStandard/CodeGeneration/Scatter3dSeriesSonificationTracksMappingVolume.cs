...
{
	public partial class Scatter3dSeriesSonificationTracksMappingVolume  : BaseObject
	{
		Hashtable h = new Hashtable();

		public Scatter3dSeriesSonificationTracksMappingVolume()
		{
			MapFunction = MapFunction_DefaultValue = Scatter3dSeriesSonificationTracksMappingVolumeMapFunction.Linear;
			MapTo = MapTo_DefaultValue = "";
			Max = Max_DefaultValue = null;
			Min = Min_DefaultValue = null;
			Value = Value_DefaultValue = null;
			Within = Within_DefaultValue = Scatter3dSeriesSonificationTracksMappingVolumeWithin.Chart;
		...
		/// </summary>
		public Scatter3dSeriesSonificationTracksMappingVolumeMapFunction MapFunction { get; set; }
		private Scatter3dSeriesSonificationTracksMappingVolumeMapFunction MapFunction_DefaultValue { get; set; }
		...
		/// </summary>
		public Scatter3dSeriesSonificationTracksMappingVolumeWithin Within { get; set; }
		private Scatter3dSeriesSonificationTracksMappingVolumeWithin Within_DefaultValue { get; set; }
