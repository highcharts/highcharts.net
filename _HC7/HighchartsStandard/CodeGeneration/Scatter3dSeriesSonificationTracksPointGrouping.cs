...
{
	public partial class Scatter3dSeriesSonificationTracksPointGrouping  : BaseObject
	{
		Hashtable h = new Hashtable();

		public Scatter3dSeriesSonificationTracksPointGrouping()
		{
		...
		/// </summary>
		public Scatter3dSeriesSonificationTracksPointGroupingAlgorithm Algorithm { get; set; }
		private Scatter3dSeriesSonificationTracksPointGroupingAlgorithm Algorithm_DefaultValue { get; set; }
		...
		internal override Hashtable ToHashtable(Highcharts highcharts)
		{
			...
			if (Algorithm != Scatter3dSeriesSonificationTracksPointGroupingAlgorithm.Null) h.Add("algorithm", highcharts.FirstCharacterToLower(Algorithm.ToString()));
