...
{
	public partial class Scatter3dSeriesStatesSelectMarker  : BaseObject
	{
		public Scatter3dSeriesStatesSelectMarker()
		{
			...
			States = States_DefaultValue = new Scatter3dSeriesStatesSelectMarkerStates();
		...
		/// </summary>
		public Scatter3dSeriesStatesSelectMarkerStates States { get; set; }
		private Scatter3dSeriesStatesSelectMarkerStates States_DefaultValue { get; set; }
