...
{
	public partial class ScatterSeriesDataDataLabels  : BaseObject
	{
		Hashtable h = new Hashtable();

		public ScatterSeriesDataDataLabels()
		{
		...
		/// </summary>
		public ScatterSeriesDataDataLabelsAlign Align { get; set; }
		private ScatterSeriesDataDataLabelsAlign Align_DefaultValue { get; set; }
		...
		/// </summary>
		public ScatterSeriesDataDataLabelsFilter Filter { get; set; }
		private ScatterSeriesDataDataLabelsFilter Filter_DefaultValue { get; set; }
		...
		/// </summary>
		public ScatterSeriesDataDataLabelsOverflow Overflow { get; set; }
		private ScatterSeriesDataDataLabelsOverflow Overflow_DefaultValue { get; set; }
		...
		/// </summary>
		public ScatterSeriesDataDataLabelsPosition Position { get; set; }
		private ScatterSeriesDataDataLabelsPosition Position_DefaultValue { get; set; }
		...
		/// </summary>
		public ScatterSeriesDataDataLabelsTextPath TextPath { get; set; }
		private ScatterSeriesDataDataLabelsTextPath TextPath_DefaultValue { get; set; }
		...
		/// </summary>
		public ScatterSeriesDataDataLabelsVerticalAlign VerticalAlign { get; set; }
		private ScatterSeriesDataDataLabelsVerticalAlign VerticalAlign_DefaultValue { get; set; }
		...
		internal override Hashtable ToHashtable(Highcharts highcharts)
		{
			...
			if (Align != ScatterSeriesDataDataLabelsAlign.Null) h.Add("align", highcharts.FirstCharacterToLower(Align.ToString()));
			...
			if (Overflow != ScatterSeriesDataDataLabelsOverflow.Null) h.Add("overflow", highcharts.FirstCharacterToLower(Overflow.ToString()));
			if (Padding != null) h.Add("padding",Padding);
			if (Position != ScatterSeriesDataDataLabelsPosition.Null) h.Add("position", highcharts.FirstCharacterToLower(Position.ToString()));
			...
			if (VerticalAlign != ScatterSeriesDataDataLabelsVerticalAlign.Null) h.Add("verticalAlign", highcharts.FirstCharacterToLower(VerticalAlign.ToString()));
			if (X != null) h.Add("x",X);
			if (Y != null) h.Add("y",Y);
