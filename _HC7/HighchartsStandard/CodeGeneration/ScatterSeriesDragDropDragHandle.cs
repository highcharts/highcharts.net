...
namespace Highsoft.Web.Mvc.Charts
{
	public partial class ScatterSeriesDragDropDragHandle  : BaseObject
	{
		...
		internal override Hashtable ToHashtable()
		{
			...
			if (PathFormatter != PathFormatter_DefaultValue) { h.Add("pathFormatter",PathFormatter); Highcharts.AddFunction("5014de94-89ef-4ec8-a16e-ef4dcc100424.pathFormatter", PathFormatter); }  
