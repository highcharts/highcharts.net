...
namespace Highsoft.Web.Mvc.Charts
{
	public partial class ScatterSeriesMarkerStates  : BaseObject
	{
		public ScatterSeriesMarkerStates()
		{
			...
			Inactive = Inactive_DefaultValue = new ScatterSeriesMarkerStatesInactive();
			Normal = Normal_DefaultValue = new ScatterSeriesMarkerStatesNormal();
		...
		/// 
		/// </summary>
		public ScatterSeriesMarkerStatesInactive Inactive { get; set; }
		private ScatterSeriesMarkerStatesInactive Inactive_DefaultValue { get; set; }
		 

		/// <summary>
		/// The normal state of a single point marker. Currently onlyused for setting animation when returning to normal statefrom hover.
		/// </summary>
		public ScatterSeriesMarkerStatesNormal Normal { get; set; }
		private ScatterSeriesMarkerStatesNormal Normal_DefaultValue { get; set; }
