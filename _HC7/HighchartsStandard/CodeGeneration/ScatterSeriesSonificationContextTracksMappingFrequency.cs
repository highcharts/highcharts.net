...
{
	public partial class ScatterSeriesSonificationContextTracksMappingFrequency  : BaseObject
	{
		Hashtable h = new Hashtable();

		public ScatterSeriesSonificationContextTracksMappingFrequency()
		{
			MapFunction = MapFunction_DefaultValue = ScatterSeriesSonificationContextTracksMappingFrequencyMapFunction.Linear;
			MapTo = MapTo_DefaultValue = "";
			Max = Max_DefaultValue = null;
			Min = Min_DefaultValue = null;
			Value = Value_DefaultValue = null;
			Within = Within_DefaultValue = ScatterSeriesSonificationContextTracksMappingFrequencyWithin.Chart;
		...
		/// </summary>
		public ScatterSeriesSonificationContextTracksMappingFrequencyMapFunction MapFunction { get; set; }
		private ScatterSeriesSonificationContextTracksMappingFrequencyMapFunction MapFunction_DefaultValue { get; set; }
		...
		/// </summary>
		public ScatterSeriesSonificationContextTracksMappingFrequencyWithin Within { get; set; }
		private ScatterSeriesSonificationContextTracksMappingFrequencyWithin Within_DefaultValue { get; set; }
