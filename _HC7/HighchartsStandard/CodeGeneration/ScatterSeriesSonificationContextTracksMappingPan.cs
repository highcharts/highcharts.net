...
{
	public partial class ScatterSeriesSonificationContextTracksMappingPan  : BaseObject
	{
		Hashtable h = new Hashtable();

		public ScatterSeriesSonificationContextTracksMappingPan()
		{
			MapFunction = MapFunction_DefaultValue = ScatterSeriesSonificationContextTracksMappingPanMapFunction.Linear;
			MapTo = MapTo_DefaultValue = "";
			Max = Max_DefaultValue = null;
			Min = Min_DefaultValue = null;
			Value = Value_DefaultValue = null;
			Within = Within_DefaultValue = ScatterSeriesSonificationContextTracksMappingPanWithin.Chart;
		...
		/// </summary>
		public ScatterSeriesSonificationContextTracksMappingPanMapFunction MapFunction { get; set; }
		private ScatterSeriesSonificationContextTracksMappingPanMapFunction MapFunction_DefaultValue { get; set; }
		...
		/// </summary>
		public ScatterSeriesSonificationContextTracksMappingPanWithin Within { get; set; }
		private ScatterSeriesSonificationContextTracksMappingPanWithin Within_DefaultValue { get; set; }
