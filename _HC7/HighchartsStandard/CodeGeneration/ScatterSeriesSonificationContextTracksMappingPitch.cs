...
{
	public partial class ScatterSeriesSonificationContextTracksMappingPitch  : BaseObject
	{
		Hashtable h = new Hashtable();

		public ScatterSeriesSonificationContextTracksMappingPitch()
		{
			MapFunction = MapFunction_DefaultValue = ScatterSeriesSonificationContextTracksMappingPitchMapFunction.Linear;
		...
		/// </summary>
		public ScatterSeriesSonificationContextTracksMappingPitchMapFunction MapFunction { get; set; }
		private ScatterSeriesSonificationContextTracksMappingPitchMapFunction MapFunction_DefaultValue { get; set; }
