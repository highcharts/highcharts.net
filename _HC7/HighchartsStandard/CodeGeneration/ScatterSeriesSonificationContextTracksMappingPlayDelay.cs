...
{
	public partial class ScatterSeriesSonificationContextTracksMappingPlayDelay  : BaseObject
	{
		Hashtable h = new Hashtable();

		public ScatterSeriesSonificationContextTracksMappingPlayDelay()
		{
			MapFunction = MapFunction_DefaultValue = ScatterSeriesSonificationContextTracksMappingPlayDelayMapFunction.Linear;
			MapTo = MapTo_DefaultValue = "";
			Max = Max_DefaultValue = null;
			Min = Min_DefaultValue = null;
			Value = Value_DefaultValue = null;
			Within = Within_DefaultValue = ScatterSeriesSonificationContextTracksMappingPlayDelayWithin.Chart;
		...
		/// </summary>
		public ScatterSeriesSonificationContextTracksMappingPlayDelayMapFunction MapFunction { get; set; }
		private ScatterSeriesSonificationContextTracksMappingPlayDelayMapFunction MapFunction_DefaultValue { get; set; }
		...
		/// </summary>
		public ScatterSeriesSonificationContextTracksMappingPlayDelayWithin Within { get; set; }
		private ScatterSeriesSonificationContextTracksMappingPlayDelayWithin Within_DefaultValue { get; set; }
