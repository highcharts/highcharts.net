...
{
	public partial class ScatterSeriesSonificationContextTracksMappingTime  : BaseObject
	{
		Hashtable h = new Hashtable();

		public ScatterSeriesSonificationContextTracksMappingTime()
		{
			MapFunction = MapFunction_DefaultValue = ScatterSeriesSonificationContextTracksMappingTimeMapFunction.Linear;
			MapTo = MapTo_DefaultValue = "";
			Max = Max_DefaultValue = null;
			Min = Min_DefaultValue = null;
			Value = Value_DefaultValue = null;
			Within = Within_DefaultValue = ScatterSeriesSonificationContextTracksMappingTimeWithin.Chart;
		...
		/// </summary>
		public ScatterSeriesSonificationContextTracksMappingTimeMapFunction MapFunction { get; set; }
		private ScatterSeriesSonificationContextTracksMappingTimeMapFunction MapFunction_DefaultValue { get; set; }
		...
		/// </summary>
		public ScatterSeriesSonificationContextTracksMappingTimeWithin Within { get; set; }
		private ScatterSeriesSonificationContextTracksMappingTimeWithin Within_DefaultValue { get; set; }
