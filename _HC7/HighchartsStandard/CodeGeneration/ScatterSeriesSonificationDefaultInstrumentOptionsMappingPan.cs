...
{
	public partial class ScatterSeriesSonificationDefaultInstrumentOptionsMappingPan  : BaseObject
	{
		Hashtable h = new Hashtable();

		public ScatterSeriesSonificationDefaultInstrumentOptionsMappingPan()
		{
			MapFunction = MapFunction_DefaultValue = ScatterSeriesSonificationDefaultInstrumentOptionsMappingPanMapFunction.Linear;
			MapTo = MapTo_DefaultValue = "";
			Max = Max_DefaultValue = null;
			Min = Min_DefaultValue = null;
			Value = Value_DefaultValue = null;
			Within = Within_DefaultValue = ScatterSeriesSonificationDefaultInstrumentOptionsMappingPanWithin.Chart;
		...
		/// </summary>
		public ScatterSeriesSonificationDefaultInstrumentOptionsMappingPanMapFunction MapFunction { get; set; }
		private ScatterSeriesSonificationDefaultInstrumentOptionsMappingPanMapFunction MapFunction_DefaultValue { get; set; }
		...
		/// </summary>
		public ScatterSeriesSonificationDefaultInstrumentOptionsMappingPanWithin Within { get; set; }
		private ScatterSeriesSonificationDefaultInstrumentOptionsMappingPanWithin Within_DefaultValue { get; set; }
