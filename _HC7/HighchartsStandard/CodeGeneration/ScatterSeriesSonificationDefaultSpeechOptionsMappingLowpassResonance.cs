...
{
	public partial class ScatterSeriesSonificationDefaultSpeechOptionsMappingLowpassResonance  : BaseObject
	{
		Hashtable h = new Hashtable();

		public ScatterSeriesSonificationDefaultSpeechOptionsMappingLowpassResonance()
		{
			MapFunction = MapFunction_DefaultValue = ScatterSeriesSonificationDefaultSpeechOptionsMappingLowpassResonanceMapFunction.Linear;
			MapTo = MapTo_DefaultValue = "";
			Max = Max_DefaultValue = null;
			Min = Min_DefaultValue = null;
			Value = Value_DefaultValue = null;
			Within = Within_DefaultValue = ScatterSeriesSonificationDefaultSpeechOptionsMappingLowpassResonanceWithin.Chart;
		...
		/// </summary>
		public ScatterSeriesSonificationDefaultSpeechOptionsMappingLowpassResonanceMapFunction MapFunction { get; set; }
		private ScatterSeriesSonificationDefaultSpeechOptionsMappingLowpassResonanceMapFunction MapFunction_DefaultValue { get; set; }
		...
		/// </summary>
		public ScatterSeriesSonificationDefaultSpeechOptionsMappingLowpassResonanceWithin Within { get; set; }
		private ScatterSeriesSonificationDefaultSpeechOptionsMappingLowpassResonanceWithin Within_DefaultValue { get; set; }
