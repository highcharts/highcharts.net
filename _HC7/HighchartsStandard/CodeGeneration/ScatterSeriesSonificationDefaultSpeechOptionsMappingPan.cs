...
{
	public partial class ScatterSeriesSonificationDefaultSpeechOptionsMappingPan  : BaseObject
	{
		Hashtable h = new Hashtable();

		public ScatterSeriesSonificationDefaultSpeechOptionsMappingPan()
		{
			MapFunction = MapFunction_DefaultValue = ScatterSeriesSonificationDefaultSpeechOptionsMappingPanMapFunction.Linear;
			MapTo = MapTo_DefaultValue = "";
			Max = Max_DefaultValue = null;
			Min = Min_DefaultValue = null;
			Value = Value_DefaultValue = null;
			Within = Within_DefaultValue = ScatterSeriesSonificationDefaultSpeechOptionsMappingPanWithin.Chart;
		...
		/// </summary>
		public ScatterSeriesSonificationDefaultSpeechOptionsMappingPanMapFunction MapFunction { get; set; }
		private ScatterSeriesSonificationDefaultSpeechOptionsMappingPanMapFunction MapFunction_DefaultValue { get; set; }
		...
		/// </summary>
		public ScatterSeriesSonificationDefaultSpeechOptionsMappingPanWithin Within { get; set; }
		private ScatterSeriesSonificationDefaultSpeechOptionsMappingPanWithin Within_DefaultValue { get; set; }
