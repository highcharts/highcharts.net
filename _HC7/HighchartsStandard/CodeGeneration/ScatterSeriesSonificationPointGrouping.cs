...
{
	public partial class ScatterSeriesSonificationPointGrouping  : BaseObject
	{
		Hashtable h = new Hashtable();

		public ScatterSeriesSonificationPointGrouping()
		{
		...
		/// </summary>
		public ScatterSeriesSonificationPointGroupingAlgorithm Algorithm { get; set; }
		private ScatterSeriesSonificationPointGroupingAlgorithm Algorithm_DefaultValue { get; set; }
		...
		internal override Hashtable ToHashtable(Highcharts highcharts)
		{
			...
			if (Algorithm != ScatterSeriesSonificationPointGroupingAlgorithm.Null) h.Add("algorithm", highcharts.FirstCharacterToLower(Algorithm.ToString()));
