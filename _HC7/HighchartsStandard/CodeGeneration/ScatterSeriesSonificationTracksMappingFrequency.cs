...
{
	public partial class ScatterSeriesSonificationTracksMappingFrequency  : BaseObject
	{
		Hashtable h = new Hashtable();

		public ScatterSeriesSonificationTracksMappingFrequency()
		{
			MapFunction = MapFunction_DefaultValue = ScatterSeriesSonificationTracksMappingFrequencyMapFunction.Linear;
			MapTo = MapTo_DefaultValue = "";
			Max = Max_DefaultValue = null;
			Min = Min_DefaultValue = null;
			Value = Value_DefaultValue = null;
			Within = Within_DefaultValue = ScatterSeriesSonificationTracksMappingFrequencyWithin.Chart;
		...
		/// </summary>
		public ScatterSeriesSonificationTracksMappingFrequencyMapFunction MapFunction { get; set; }
		private ScatterSeriesSonificationTracksMappingFrequencyMapFunction MapFunction_DefaultValue { get; set; }
		...
		/// </summary>
		public ScatterSeriesSonificationTracksMappingFrequencyWithin Within { get; set; }
		private ScatterSeriesSonificationTracksMappingFrequencyWithin Within_DefaultValue { get; set; }
