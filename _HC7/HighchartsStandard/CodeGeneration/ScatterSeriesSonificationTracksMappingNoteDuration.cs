...
{
	public partial class ScatterSeriesSonificationTracksMappingNoteDuration  : BaseObject
	{
		Hashtable h = new Hashtable();

		public ScatterSeriesSonificationTracksMappingNoteDuration()
		{
			MapFunction = MapFunction_DefaultValue = ScatterSeriesSonificationTracksMappingNoteDurationMapFunction.Linear;
			MapTo = MapTo_DefaultValue = "";
			Max = Max_DefaultValue = null;
			Min = Min_DefaultValue = null;
			Value = Value_DefaultValue = null;
			Within = Within_DefaultValue = ScatterSeriesSonificationTracksMappingNoteDurationWithin.Chart;
		...
		/// </summary>
		public ScatterSeriesSonificationTracksMappingNoteDurationMapFunction MapFunction { get; set; }
		private ScatterSeriesSonificationTracksMappingNoteDurationMapFunction MapFunction_DefaultValue { get; set; }
		...
		/// </summary>
		public ScatterSeriesSonificationTracksMappingNoteDurationWithin Within { get; set; }
		private ScatterSeriesSonificationTracksMappingNoteDurationWithin Within_DefaultValue { get; set; }
