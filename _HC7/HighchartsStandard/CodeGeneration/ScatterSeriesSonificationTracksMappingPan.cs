...
{
	public partial class ScatterSeriesSonificationTracksMappingPan  : BaseObject
	{
		Hashtable h = new Hashtable();

		public ScatterSeriesSonificationTracksMappingPan()
		{
			MapFunction = MapFunction_DefaultValue = ScatterSeriesSonificationTracksMappingPanMapFunction.Linear;
			MapTo = MapTo_DefaultValue = "";
			Max = Max_DefaultValue = null;
			Min = Min_DefaultValue = null;
			Value = Value_DefaultValue = null;
			Within = Within_DefaultValue = ScatterSeriesSonificationTracksMappingPanWithin.Chart;
		...
		/// </summary>
		public ScatterSeriesSonificationTracksMappingPanMapFunction MapFunction { get; set; }
		private ScatterSeriesSonificationTracksMappingPanMapFunction MapFunction_DefaultValue { get; set; }
		...
		/// </summary>
		public ScatterSeriesSonificationTracksMappingPanWithin Within { get; set; }
		private ScatterSeriesSonificationTracksMappingPanWithin Within_DefaultValue { get; set; }
