...
{
	public partial class ScatterSeriesSonificationTracksMappingPitch  : BaseObject
	{
		Hashtable h = new Hashtable();

		public ScatterSeriesSonificationTracksMappingPitch()
		{
			MapFunction = MapFunction_DefaultValue = ScatterSeriesSonificationTracksMappingPitchMapFunction.Linear;
		...
		/// </summary>
		public ScatterSeriesSonificationTracksMappingPitchMapFunction MapFunction { get; set; }
		private ScatterSeriesSonificationTracksMappingPitchMapFunction MapFunction_DefaultValue { get; set; }
