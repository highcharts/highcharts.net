...
{
	public partial class ScatterSeriesSonificationTracksMappingPlayDelay  : BaseObject
	{
		Hashtable h = new Hashtable();

		public ScatterSeriesSonificationTracksMappingPlayDelay()
		{
			MapFunction = MapFunction_DefaultValue = ScatterSeriesSonificationTracksMappingPlayDelayMapFunction.Linear;
			MapTo = MapTo_DefaultValue = "";
			Max = Max_DefaultValue = null;
			Min = Min_DefaultValue = null;
			Value = Value_DefaultValue = null;
			Within = Within_DefaultValue = ScatterSeriesSonificationTracksMappingPlayDelayWithin.Chart;
		...
		/// </summary>
		public ScatterSeriesSonificationTracksMappingPlayDelayMapFunction MapFunction { get; set; }
		private ScatterSeriesSonificationTracksMappingPlayDelayMapFunction MapFunction_DefaultValue { get; set; }
		...
		/// </summary>
		public ScatterSeriesSonificationTracksMappingPlayDelayWithin Within { get; set; }
		private ScatterSeriesSonificationTracksMappingPlayDelayWithin Within_DefaultValue { get; set; }
