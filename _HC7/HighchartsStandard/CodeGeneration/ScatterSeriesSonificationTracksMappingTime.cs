...
{
	public partial class ScatterSeriesSonificationTracksMappingTime  : BaseObject
	{
		Hashtable h = new Hashtable();

		public ScatterSeriesSonificationTracksMappingTime()
		{
			MapFunction = MapFunction_DefaultValue = ScatterSeriesSonificationTracksMappingTimeMapFunction.Linear;
			MapTo = MapTo_DefaultValue = "";
			Max = Max_DefaultValue = null;
			Min = Min_DefaultValue = null;
			Value = Value_DefaultValue = null;
			Within = Within_DefaultValue = ScatterSeriesSonificationTracksMappingTimeWithin.Chart;
		...
		/// </summary>
		public ScatterSeriesSonificationTracksMappingTimeMapFunction MapFunction { get; set; }
		private ScatterSeriesSonificationTracksMappingTimeMapFunction MapFunction_DefaultValue { get; set; }
		...
		/// </summary>
		public ScatterSeriesSonificationTracksMappingTimeWithin Within { get; set; }
		private ScatterSeriesSonificationTracksMappingTimeWithin Within_DefaultValue { get; set; }
