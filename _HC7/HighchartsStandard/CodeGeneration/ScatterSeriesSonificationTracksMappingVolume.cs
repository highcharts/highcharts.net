...
{
	public partial class ScatterSeriesSonificationTracksMappingVolume  : BaseObject
	{
		Hashtable h = new Hashtable();

		public ScatterSeriesSonificationTracksMappingVolume()
		{
			MapFunction = MapFunction_DefaultValue = ScatterSeriesSonificationTracksMappingVolumeMapFunction.Linear;
			MapTo = MapTo_DefaultValue = "";
			Max = Max_DefaultValue = null;
			Min = Min_DefaultValue = null;
			Value = Value_DefaultValue = null;
			Within = Within_DefaultValue = ScatterSeriesSonificationTracksMappingVolumeWithin.Chart;
		...
		/// </summary>
		public ScatterSeriesSonificationTracksMappingVolumeMapFunction MapFunction { get; set; }
		private ScatterSeriesSonificationTracksMappingVolumeMapFunction MapFunction_DefaultValue { get; set; }
		...
		/// </summary>
		public ScatterSeriesSonificationTracksMappingVolumeWithin Within { get; set; }
		private ScatterSeriesSonificationTracksMappingVolumeWithin Within_DefaultValue { get; set; }
