...
{
	public partial class ScatterSeriesSonificationTracksPointGrouping  : BaseObject
	{
		Hashtable h = new Hashtable();

		public ScatterSeriesSonificationTracksPointGrouping()
		{
		...
		/// </summary>
		public ScatterSeriesSonificationTracksPointGroupingAlgorithm Algorithm { get; set; }
		private ScatterSeriesSonificationTracksPointGroupingAlgorithm Algorithm_DefaultValue { get; set; }
		...
		internal override Hashtable ToHashtable(Highcharts highcharts)
		{
			...
			if (Algorithm != ScatterSeriesSonificationTracksPointGroupingAlgorithm.Null) h.Add("algorithm", highcharts.FirstCharacterToLower(Algorithm.ToString()));
