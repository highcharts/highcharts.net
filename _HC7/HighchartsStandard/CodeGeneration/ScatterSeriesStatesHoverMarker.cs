...
namespace Highsoft.Web.Mvc.Charts
{
	public partial class ScatterSeriesStatesHoverMarker  : BaseObject
	{
		public ScatterSeriesStatesHoverMarker()
		{
			...
			States = States_DefaultValue = new ScatterSeriesStatesHoverMarkerStates();
		...
		/// </summary>
		public ScatterSeriesStatesHoverMarkerStates States { get; set; }
		private ScatterSeriesStatesHoverMarkerStates States_DefaultValue { get; set; }
