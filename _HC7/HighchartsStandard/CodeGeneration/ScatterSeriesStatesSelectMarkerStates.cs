...
namespace Highsoft.Web.Mvc.Charts
{
	public partial class ScatterSeriesStatesSelectMarkerStates  : BaseObject
	{
		public ScatterSeriesStatesSelectMarkerStates()
		{
			...
			Inactive = Inactive_DefaultValue = new ScatterSeriesStatesSelectMarkerStatesInactive();
			Normal = Normal_DefaultValue = new ScatterSeriesStatesSelectMarkerStatesNormal();
		...
		/// 
		/// </summary>
		public ScatterSeriesStatesSelectMarkerStatesInactive Inactive { get; set; }
		private ScatterSeriesStatesSelectMarkerStatesInactive Inactive_DefaultValue { get; set; }
		 

		/// <summary>
		/// The normal state of a single point marker. Currently onlyused for setting animation when returning to normal statefrom hover.
		/// </summary>
		public ScatterSeriesStatesSelectMarkerStatesNormal Normal { get; set; }
		private ScatterSeriesStatesSelectMarkerStatesNormal Normal_DefaultValue { get; set; }
