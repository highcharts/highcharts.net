...
namespace Highsoft.Web.Mvc.Charts
{
	public partial class SolidgaugeSeries  : Series
	{
		...
		public SolidgaugeSeries()
		{
			...
			LegendSymbol = LegendSymbol_DefaultValue = SolidgaugeSeriesLegendSymbol.Rectangle;
			Linecap = Linecap_DefaultValue = SolidgaugeSeriesLinecap.Round;
			LineWidth = LineWidth_DefaultValue = 1;
			LinkedTo = LinkedTo_DefaultValue = "";
			Name = Name_DefaultValue = "";
			OnPoint = OnPoint_DefaultValue = new SolidgaugeSeriesOnPoint();
			...
			Sonification = Sonification_DefaultValue = new SolidgaugeSeriesSonification();
