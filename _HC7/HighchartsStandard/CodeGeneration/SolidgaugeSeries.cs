...
namespace Highsoft.Web.Mvc.Charts
{
	public partial class SolidgaugeSeries  : Series
	{
		...
		internal override Hashtable ToHashtable()
		{
			...
			if (PointDescriptionFormatter != PointDescriptionFormatter_DefaultValue) { h.Add("pointDescriptionFormatter",PointDescriptionFormatter); Highcharts.AddFunction("c517771c-669a-4358-9c99-4c43718900e4.pointDescriptionFormatter", PointDescriptionFormatter); }  
