...
{
	public partial class SolidgaugeSeriesDataDataLabels  : BaseObject
	{
		Hashtable h = new Hashtable();

		public SolidgaugeSeriesDataDataLabels()
		{
		...
		/// </summary>
		public SolidgaugeSeriesDataDataLabelsAlign Align { get; set; }
		private SolidgaugeSeriesDataDataLabelsAlign Align_DefaultValue { get; set; }
		...
		/// </summary>
		public SolidgaugeSeriesDataDataLabelsFilter Filter { get; set; }
		private SolidgaugeSeriesDataDataLabelsFilter Filter_DefaultValue { get; set; }
		...
		/// </summary>
		public SolidgaugeSeriesDataDataLabelsOverflow Overflow { get; set; }
		private SolidgaugeSeriesDataDataLabelsOverflow Overflow_DefaultValue { get; set; }
		...
		/// </summary>
		public SolidgaugeSeriesDataDataLabelsPosition Position { get; set; }
		private SolidgaugeSeriesDataDataLabelsPosition Position_DefaultValue { get; set; }
		...
		/// </summary>
		public SolidgaugeSeriesDataDataLabelsTextPath TextPath { get; set; }
		private SolidgaugeSeriesDataDataLabelsTextPath TextPath_DefaultValue { get; set; }
		...
		/// </summary>
		public SolidgaugeSeriesDataDataLabelsVerticalAlign VerticalAlign { get; set; }
		private SolidgaugeSeriesDataDataLabelsVerticalAlign VerticalAlign_DefaultValue { get; set; }
		...
		internal override Hashtable ToHashtable(Highcharts highcharts)
		{
			...
			if (Align != SolidgaugeSeriesDataDataLabelsAlign.Null) h.Add("align", highcharts.FirstCharacterToLower(Align.ToString()));
			...
			if (Overflow != SolidgaugeSeriesDataDataLabelsOverflow.Null) h.Add("overflow", highcharts.FirstCharacterToLower(Overflow.ToString()));
			if (Padding != null) h.Add("padding",Padding);
			if (Position != SolidgaugeSeriesDataDataLabelsPosition.Null) h.Add("position", highcharts.FirstCharacterToLower(Position.ToString()));
			...
			if (VerticalAlign != SolidgaugeSeriesDataDataLabelsVerticalAlign.Null) h.Add("verticalAlign", highcharts.FirstCharacterToLower(VerticalAlign.ToString()));
			if (X != null) h.Add("x",X);
			if (Y != null) h.Add("y",Y);
