...
namespace Highsoft.Web.Mvc.Charts
{
	public partial class SolidgaugeSeriesDataDragDropDragHandle  : BaseObject
	{
		...
		internal override Hashtable ToHashtable()
		{
			...
			if (PathFormatter != PathFormatter_DefaultValue) { h.Add("pathFormatter",PathFormatter); Highcharts.AddFunction("6925468a-e8da-41d4-a49b-a6678e73d2a9.pathFormatter", PathFormatter); }  
