...
{
	public partial class SolidgaugeSeriesDataLabels  : BaseObject
	{
		...
		/// </summary>
		public SolidgaugeSeriesDataLabelsFilter Filter { get; set; }
		private SolidgaugeSeriesDataLabelsFilter Filter_DefaultValue { get; set; }
		...
		/// </summary>
		public SolidgaugeSeriesDataLabelsPosition Position { get; set; }
		private SolidgaugeSeriesDataLabelsPosition Position_DefaultValue { get; set; }
		...
		/// </summary>
		public SolidgaugeSeriesDataLabelsTextPath TextPath { get; set; }
		private SolidgaugeSeriesDataLabelsTextPath TextPath_DefaultValue { get; set; }
		...
		/// </summary>
		public SolidgaugeSeriesDataLabelsVerticalAlign VerticalAlign { get; set; }
		private SolidgaugeSeriesDataLabelsVerticalAlign VerticalAlign_DefaultValue { get; set; }
		...
		internal override Hashtable ToHashtable(Highcharts highcharts)
		{
			...
			if (Align != SolidgaugeSeriesDataLabelsAlign.Null) h.Add("align", highcharts.FirstCharacterToLower(Align.ToString()));
			...
			if (Overflow != SolidgaugeSeriesDataLabelsOverflow.Null) h.Add("overflow", highcharts.FirstCharacterToLower(Overflow.ToString()));
			if (Padding != null) h.Add("padding",Padding);
			if (Position != SolidgaugeSeriesDataLabelsPosition.Null) h.Add("position", highcharts.FirstCharacterToLower(Position.ToString()));
			...
			if (VerticalAlign != SolidgaugeSeriesDataLabelsVerticalAlign.Null) h.Add("verticalAlign", highcharts.FirstCharacterToLower(VerticalAlign.ToString()));
			if (X != null) h.Add("x",X);
			if (Y != null) h.Add("y",Y);
