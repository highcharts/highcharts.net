...
namespace Highsoft.Web.Mvc.Charts
{
	public partial class SolidgaugeSeriesDataLabels  : BaseObject
	{
		...
		{
			Align = Align_DefaultValue = SolidgaugeSeriesDataLabelsAlign.Left;
			...
			VerticalAlign = VerticalAlign_DefaultValue = SolidgaugeSeriesDataLabelsVerticalAlign.Top;
		...
		internal override Hashtable ToHashtable()
		{
			...
			if (Formatter != Formatter_DefaultValue) { h.Add("formatter",Formatter); Highcharts.AddFunction("b959b7cd-82b0-46a5-b345-95d10626fd86.formatter", Formatter); }  
