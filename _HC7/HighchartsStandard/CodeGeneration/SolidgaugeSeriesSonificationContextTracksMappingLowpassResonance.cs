...
{
	public partial class SolidgaugeSeriesSonificationContextTracksMappingLowpassResonance  : BaseObject
	{
		Hashtable h = new Hashtable();

		public SolidgaugeSeriesSonificationContextTracksMappingLowpassResonance()
		{
			MapFunction = MapFunction_DefaultValue = SolidgaugeSeriesSonificationContextTracksMappingLowpassResonanceMapFunction.Linear;
			MapTo = MapTo_DefaultValue = "";
			Max = Max_DefaultValue = null;
			Min = Min_DefaultValue = null;
			Value = Value_DefaultValue = null;
			Within = Within_DefaultValue = SolidgaugeSeriesSonificationContextTracksMappingLowpassResonanceWithin.Chart;
		...
		/// </summary>
		public SolidgaugeSeriesSonificationContextTracksMappingLowpassResonanceMapFunction MapFunction { get; set; }
		private SolidgaugeSeriesSonificationContextTracksMappingLowpassResonanceMapFunction MapFunction_DefaultValue { get; set; }
		...
		/// </summary>
		public SolidgaugeSeriesSonificationContextTracksMappingLowpassResonanceWithin Within { get; set; }
		private SolidgaugeSeriesSonificationContextTracksMappingLowpassResonanceWithin Within_DefaultValue { get; set; }
