...
{
	public partial class SolidgaugeSeriesSonificationContextTracksMappingNoteDuration  : BaseObject
	{
		Hashtable h = new Hashtable();

		public SolidgaugeSeriesSonificationContextTracksMappingNoteDuration()
		{
			MapFunction = MapFunction_DefaultValue = SolidgaugeSeriesSonificationContextTracksMappingNoteDurationMapFunction.Linear;
			MapTo = MapTo_DefaultValue = "";
			Max = Max_DefaultValue = null;
			Min = Min_DefaultValue = null;
			Value = Value_DefaultValue = null;
			Within = Within_DefaultValue = SolidgaugeSeriesSonificationContextTracksMappingNoteDurationWithin.Chart;
		...
		/// </summary>
		public SolidgaugeSeriesSonificationContextTracksMappingNoteDurationMapFunction MapFunction { get; set; }
		private SolidgaugeSeriesSonificationContextTracksMappingNoteDurationMapFunction MapFunction_DefaultValue { get; set; }
		...
		/// </summary>
		public SolidgaugeSeriesSonificationContextTracksMappingNoteDurationWithin Within { get; set; }
		private SolidgaugeSeriesSonificationContextTracksMappingNoteDurationWithin Within_DefaultValue { get; set; }
