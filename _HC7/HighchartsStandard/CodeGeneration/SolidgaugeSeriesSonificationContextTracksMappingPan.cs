...
{
	public partial class SolidgaugeSeriesSonificationContextTracksMappingPan  : BaseObject
	{
		Hashtable h = new Hashtable();

		public SolidgaugeSeriesSonificationContextTracksMappingPan()
		{
			MapFunction = MapFunction_DefaultValue = SolidgaugeSeriesSonificationContextTracksMappingPanMapFunction.Linear;
			MapTo = MapTo_DefaultValue = "";
			Max = Max_DefaultValue = null;
			Min = Min_DefaultValue = null;
			Value = Value_DefaultValue = null;
			Within = Within_DefaultValue = SolidgaugeSeriesSonificationContextTracksMappingPanWithin.Chart;
		...
		/// </summary>
		public SolidgaugeSeriesSonificationContextTracksMappingPanMapFunction MapFunction { get; set; }
		private SolidgaugeSeriesSonificationContextTracksMappingPanMapFunction MapFunction_DefaultValue { get; set; }
		...
		/// </summary>
		public SolidgaugeSeriesSonificationContextTracksMappingPanWithin Within { get; set; }
		private SolidgaugeSeriesSonificationContextTracksMappingPanWithin Within_DefaultValue { get; set; }
