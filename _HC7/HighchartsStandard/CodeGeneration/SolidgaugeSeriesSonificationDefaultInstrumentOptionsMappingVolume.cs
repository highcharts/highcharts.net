...
{
	public partial class SolidgaugeSeriesSonificationDefaultInstrumentOptionsMappingVolume  : BaseObject
	{
		Hashtable h = new Hashtable();

		public SolidgaugeSeriesSonificationDefaultInstrumentOptionsMappingVolume()
		{
			MapFunction = MapFunction_DefaultValue = SolidgaugeSeriesSonificationDefaultInstrumentOptionsMappingVolumeMapFunction.Linear;
			MapTo = MapTo_DefaultValue = "";
			Max = Max_DefaultValue = null;
			Min = Min_DefaultValue = null;
			Value = Value_DefaultValue = null;
			Within = Within_DefaultValue = SolidgaugeSeriesSonificationDefaultInstrumentOptionsMappingVolumeWithin.Chart;
		...
		/// </summary>
		public SolidgaugeSeriesSonificationDefaultInstrumentOptionsMappingVolumeMapFunction MapFunction { get; set; }
		private SolidgaugeSeriesSonificationDefaultInstrumentOptionsMappingVolumeMapFunction MapFunction_DefaultValue { get; set; }
		...
		/// </summary>
		public SolidgaugeSeriesSonificationDefaultInstrumentOptionsMappingVolumeWithin Within { get; set; }
		private SolidgaugeSeriesSonificationDefaultInstrumentOptionsMappingVolumeWithin Within_DefaultValue { get; set; }
