...
{
	public partial class SolidgaugeSeriesSonificationDefaultSpeechOptionsMapping  : BaseObject
	{
		Hashtable h = new Hashtable();

		public SolidgaugeSeriesSonificationDefaultSpeechOptionsMapping()
		{
			Frequency = Frequency_DefaultValue = new SolidgaugeSeriesSonificationDefaultSpeechOptionsMappingFrequency();
			GapBetweenNotes = GapBetweenNotes_DefaultValue = new SolidgaugeSeriesSonificationDefaultSpeechOptionsMappingGapBetweenNotes();
			Highpass = Highpass_DefaultValue = new SolidgaugeSeriesSonificationDefaultSpeechOptionsMappingHighpass();
			Lowpass = Lowpass_DefaultValue = new SolidgaugeSeriesSonificationDefaultSpeechOptionsMappingLowpass();
			NoteDuration = NoteDuration_DefaultValue = new SolidgaugeSeriesSonificationDefaultSpeechOptionsMappingNoteDuration();
			Pan = Pan_DefaultValue = new SolidgaugeSeriesSonificationDefaultSpeechOptionsMappingPan();
			Pitch = Pitch_DefaultValue = new SolidgaugeSeriesSonificationDefaultSpeechOptionsMappingPitch();
			PitchString = PitchString_DefaultValue = "null";
			PitchNumber = PitchNumber_DefaultValue = null;
			PlayDelay = PlayDelay_DefaultValue = new SolidgaugeSeriesSonificationDefaultSpeechOptionsMappingPlayDelay();
			Time = Time_DefaultValue = new SolidgaugeSeriesSonificationDefaultSpeechOptionsMappingTime();
			TimeString = TimeString_DefaultValue = "null";
			TimeNumber = TimeNumber_DefaultValue = null;
			Tremolo = Tremolo_DefaultValue = new SolidgaugeSeriesSonificationDefaultSpeechOptionsMappingTremolo();
			Volume = Volume_DefaultValue = new SolidgaugeSeriesSonificationDefaultSpeechOptionsMappingVolume();
		...
		/// </summary>
		public SolidgaugeSeriesSonificationDefaultSpeechOptionsMappingFrequency Frequency { get; set; }
		private SolidgaugeSeriesSonificationDefaultSpeechOptionsMappingFrequency Frequency_DefaultValue { get; set; }
		...
		/// </summary>
		public SolidgaugeSeriesSonificationDefaultSpeechOptionsMappingGapBetweenNotes GapBetweenNotes { get; set; }
		private SolidgaugeSeriesSonificationDefaultSpeechOptionsMappingGapBetweenNotes GapBetweenNotes_DefaultValue { get; set; }
		...
		/// </summary>
		public SolidgaugeSeriesSonificationDefaultSpeechOptionsMappingHighpass Highpass { get; set; }
		private SolidgaugeSeriesSonificationDefaultSpeechOptionsMappingHighpass Highpass_DefaultValue { get; set; }
		...
		/// </summary>
		public SolidgaugeSeriesSonificationDefaultSpeechOptionsMappingLowpass Lowpass { get; set; }
		private SolidgaugeSeriesSonificationDefaultSpeechOptionsMappingLowpass Lowpass_DefaultValue { get; set; }
		...
		/// </summary>
		public SolidgaugeSeriesSonificationDefaultSpeechOptionsMappingNoteDuration NoteDuration { get; set; }
		private SolidgaugeSeriesSonificationDefaultSpeechOptionsMappingNoteDuration NoteDuration_DefaultValue { get; set; }
		...
		/// </summary>
		public SolidgaugeSeriesSonificationDefaultSpeechOptionsMappingPan Pan { get; set; }
		private SolidgaugeSeriesSonificationDefaultSpeechOptionsMappingPan Pan_DefaultValue { get; set; }
		...
		/// </summary>
		public SolidgaugeSeriesSonificationDefaultSpeechOptionsMappingPitch Pitch { get; set; }
		private SolidgaugeSeriesSonificationDefaultSpeechOptionsMappingPitch Pitch_DefaultValue { get; set; }
		...
		/// </summary>
		public SolidgaugeSeriesSonificationDefaultSpeechOptionsMappingPlayDelay PlayDelay { get; set; }
		private SolidgaugeSeriesSonificationDefaultSpeechOptionsMappingPlayDelay PlayDelay_DefaultValue { get; set; }
		...
		/// </summary>
		public SolidgaugeSeriesSonificationDefaultSpeechOptionsMappingTime Time { get; set; }
		private SolidgaugeSeriesSonificationDefaultSpeechOptionsMappingTime Time_DefaultValue { get; set; }
		...
		/// </summary>
		public SolidgaugeSeriesSonificationDefaultSpeechOptionsMappingTremolo Tremolo { get; set; }
		private SolidgaugeSeriesSonificationDefaultSpeechOptionsMappingTremolo Tremolo_DefaultValue { get; set; }
		 

		/// <summary>
		/// The volume of notes, from 0 to 1.
		/// </summary>
		public SolidgaugeSeriesSonificationDefaultSpeechOptionsMappingVolume Volume { get; set; }
		private SolidgaugeSeriesSonificationDefaultSpeechOptionsMappingVolume Volume_DefaultValue { get; set; }
