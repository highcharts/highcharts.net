...
{
	public partial class SolidgaugeSeriesSonificationDefaultSpeechOptionsMappingPlayDelay  : BaseObject
	{
		Hashtable h = new Hashtable();

		public SolidgaugeSeriesSonificationDefaultSpeechOptionsMappingPlayDelay()
		{
			MapFunction = MapFunction_DefaultValue = SolidgaugeSeriesSonificationDefaultSpeechOptionsMappingPlayDelayMapFunction.Linear;
			MapTo = MapTo_DefaultValue = "";
			Max = Max_DefaultValue = null;
			Min = Min_DefaultValue = null;
			Value = Value_DefaultValue = null;
			Within = Within_DefaultValue = SolidgaugeSeriesSonificationDefaultSpeechOptionsMappingPlayDelayWithin.Chart;
		...
		/// </summary>
		public SolidgaugeSeriesSonificationDefaultSpeechOptionsMappingPlayDelayMapFunction MapFunction { get; set; }
		private SolidgaugeSeriesSonificationDefaultSpeechOptionsMappingPlayDelayMapFunction MapFunction_DefaultValue { get; set; }
		...
		/// </summary>
		public SolidgaugeSeriesSonificationDefaultSpeechOptionsMappingPlayDelayWithin Within { get; set; }
		private SolidgaugeSeriesSonificationDefaultSpeechOptionsMappingPlayDelayWithin Within_DefaultValue { get; set; }
