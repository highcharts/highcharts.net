...
{
	public partial class SolidgaugeSeriesSonificationTracksMapping  : BaseObject
	{
		Hashtable h = new Hashtable();

		public SolidgaugeSeriesSonificationTracksMapping()
		{
			Frequency = Frequency_DefaultValue = new SolidgaugeSeriesSonificationTracksMappingFrequency();
			GapBetweenNotes = GapBetweenNotes_DefaultValue = new SolidgaugeSeriesSonificationTracksMappingGapBetweenNotes();
			Highpass = Highpass_DefaultValue = new SolidgaugeSeriesSonificationTracksMappingHighpass();
			Lowpass = Lowpass_DefaultValue = new SolidgaugeSeriesSonificationTracksMappingLowpass();
			NoteDuration = NoteDuration_DefaultValue = new SolidgaugeSeriesSonificationTracksMappingNoteDuration();
			Pan = Pan_DefaultValue = new SolidgaugeSeriesSonificationTracksMappingPan();
			Pitch = Pitch_DefaultValue = new SolidgaugeSeriesSonificationTracksMappingPitch();
			PitchString = PitchString_DefaultValue = "null";
			PitchNumber = PitchNumber_DefaultValue = null;
			PlayDelay = PlayDelay_DefaultValue = new SolidgaugeSeriesSonificationTracksMappingPlayDelay();
			Time = Time_DefaultValue = new SolidgaugeSeriesSonificationTracksMappingTime();
			TimeString = TimeString_DefaultValue = "null";
			TimeNumber = TimeNumber_DefaultValue = null;
			Tremolo = Tremolo_DefaultValue = new SolidgaugeSeriesSonificationTracksMappingTremolo();
			Volume = Volume_DefaultValue = new SolidgaugeSeriesSonificationTracksMappingVolume();
		...
		/// </summary>
		public SolidgaugeSeriesSonificationTracksMappingFrequency Frequency { get; set; }
		private SolidgaugeSeriesSonificationTracksMappingFrequency Frequency_DefaultValue { get; set; }
		...
		/// </summary>
		public SolidgaugeSeriesSonificationTracksMappingGapBetweenNotes GapBetweenNotes { get; set; }
		private SolidgaugeSeriesSonificationTracksMappingGapBetweenNotes GapBetweenNotes_DefaultValue { get; set; }
		...
		/// </summary>
		public SolidgaugeSeriesSonificationTracksMappingHighpass Highpass { get; set; }
		private SolidgaugeSeriesSonificationTracksMappingHighpass Highpass_DefaultValue { get; set; }
		...
		/// </summary>
		public SolidgaugeSeriesSonificationTracksMappingLowpass Lowpass { get; set; }
		private SolidgaugeSeriesSonificationTracksMappingLowpass Lowpass_DefaultValue { get; set; }
		...
		/// </summary>
		public SolidgaugeSeriesSonificationTracksMappingNoteDuration NoteDuration { get; set; }
		private SolidgaugeSeriesSonificationTracksMappingNoteDuration NoteDuration_DefaultValue { get; set; }
		...
		/// </summary>
		public SolidgaugeSeriesSonificationTracksMappingPan Pan { get; set; }
		private SolidgaugeSeriesSonificationTracksMappingPan Pan_DefaultValue { get; set; }
		...
		/// </summary>
		public SolidgaugeSeriesSonificationTracksMappingPitch Pitch { get; set; }
		private SolidgaugeSeriesSonificationTracksMappingPitch Pitch_DefaultValue { get; set; }
		...
		/// </summary>
		public SolidgaugeSeriesSonificationTracksMappingPlayDelay PlayDelay { get; set; }
		private SolidgaugeSeriesSonificationTracksMappingPlayDelay PlayDelay_DefaultValue { get; set; }
		...
		/// </summary>
		public SolidgaugeSeriesSonificationTracksMappingTime Time { get; set; }
		private SolidgaugeSeriesSonificationTracksMappingTime Time_DefaultValue { get; set; }
		...
		/// </summary>
		public SolidgaugeSeriesSonificationTracksMappingTremolo Tremolo { get; set; }
		private SolidgaugeSeriesSonificationTracksMappingTremolo Tremolo_DefaultValue { get; set; }
		 

		/// <summary>
		/// The volume of notes, from 0 to 1.
		/// </summary>
		public SolidgaugeSeriesSonificationTracksMappingVolume Volume { get; set; }
		private SolidgaugeSeriesSonificationTracksMappingVolume Volume_DefaultValue { get; set; }
