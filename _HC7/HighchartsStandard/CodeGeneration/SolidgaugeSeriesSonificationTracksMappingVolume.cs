...
{
	public partial class SolidgaugeSeriesSonificationTracksMappingVolume  : BaseObject
	{
		Hashtable h = new Hashtable();

		public SolidgaugeSeriesSonificationTracksMappingVolume()
		{
			MapFunction = MapFunction_DefaultValue = SolidgaugeSeriesSonificationTracksMappingVolumeMapFunction.Linear;
			MapTo = MapTo_DefaultValue = "";
			Max = Max_DefaultValue = null;
			Min = Min_DefaultValue = null;
			Value = Value_DefaultValue = null;
			Within = Within_DefaultValue = SolidgaugeSeriesSonificationTracksMappingVolumeWithin.Chart;
		...
		/// </summary>
		public SolidgaugeSeriesSonificationTracksMappingVolumeMapFunction MapFunction { get; set; }
		private SolidgaugeSeriesSonificationTracksMappingVolumeMapFunction MapFunction_DefaultValue { get; set; }
		...
		/// </summary>
		public SolidgaugeSeriesSonificationTracksMappingVolumeWithin Within { get; set; }
		private SolidgaugeSeriesSonificationTracksMappingVolumeWithin Within_DefaultValue { get; set; }
