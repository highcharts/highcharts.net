...
{
	public partial class SolidgaugeSeriesTooltip  : BaseObject
	{
		public SolidgaugeSeriesTooltip()
		{
			...
			HeaderShape = HeaderShape_DefaultValue = SolidgaugeSeriesTooltipHeaderShape.Callout;
		...
		/// </summary>
		public SolidgaugeSeriesTooltipHeaderShape HeaderShape { get; set; }
		private SolidgaugeSeriesTooltipHeaderShape HeaderShape_DefaultValue { get; set; }
		...
		internal override Hashtable ToHashtable()
		{
			...
			if (NullFormatter != NullFormatter_DefaultValue) { h.Add("nullFormatter",NullFormatter); Highcharts.AddFunction("SolidgaugeSeriesTooltipNullFormatter.nullFormatter", NullFormatter); }  
			if (Outside != Outside_DefaultValue) h.Add("outside",Outside);
			if (Padding != Padding_DefaultValue) h.Add("padding",Padding);
			if (PointFormat != PointFormat_DefaultValue) h.Add("pointFormat",PointFormat);
			if (PointFormatter != PointFormatter_DefaultValue) { h.Add("pointFormatter",PointFormatter); Highcharts.AddFunction("SolidgaugeSeriesTooltipPointFormatter.pointFormatter", PointFormatter); }  
