...
{
	public partial class SonificationDefaultInstrumentOptionsMappingTime  : BaseObject
	{
		Hashtable h = new Hashtable();

		public SonificationDefaultInstrumentOptionsMappingTime()
		{
			MapFunction = MapFunction_DefaultValue = SonificationDefaultInstrumentOptionsMappingTimeMapFunction.Linear;
			MapTo = MapTo_DefaultValue = "";
			Max = Max_DefaultValue = null;
			Min = Min_DefaultValue = null;
			Value = Value_DefaultValue = null;
			Within = Within_DefaultValue = SonificationDefaultInstrumentOptionsMappingTimeWithin.Chart;
		...
		/// </summary>
		public SonificationDefaultInstrumentOptionsMappingTimeMapFunction MapFunction { get; set; }
		private SonificationDefaultInstrumentOptionsMappingTimeMapFunction MapFunction_DefaultValue { get; set; }
		...
		/// </summary>
		public SonificationDefaultInstrumentOptionsMappingTimeWithin Within { get; set; }
		private SonificationDefaultInstrumentOptionsMappingTimeWithin Within_DefaultValue { get; set; }
