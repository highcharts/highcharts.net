...
{
	public partial class SonificationDefaultSpeechOptions  : BaseObject
	{
		Hashtable h = new Hashtable();

		public SonificationDefaultSpeechOptions()
		{
			ActiveWhen = ActiveWhen_DefaultValue = new SonificationDefaultSpeechOptionsActiveWhen();
			Language = Language_DefaultValue = "en-US";
			Mapping = Mapping_DefaultValue = new SonificationDefaultSpeechOptionsMapping();
			PointGrouping = PointGrouping_DefaultValue = new SonificationDefaultSpeechOptionsPointGrouping();
			PreferredVoice = PreferredVoice_DefaultValue = "";
			ShowPlayMarker = ShowPlayMarker_DefaultValue = true;
			Type = Type_DefaultValue = SonificationDefaultSpeechOptionsType.Speech;
		...
		/// </summary>
		public SonificationDefaultSpeechOptionsActiveWhen ActiveWhen { get; set; }
		private SonificationDefaultSpeechOptionsActiveWhen ActiveWhen_DefaultValue { get; set; }
		...
		/// </summary>
		public SonificationDefaultSpeechOptionsType Type { get; set; }
		private SonificationDefaultSpeechOptionsType Type_DefaultValue { get; set; }
