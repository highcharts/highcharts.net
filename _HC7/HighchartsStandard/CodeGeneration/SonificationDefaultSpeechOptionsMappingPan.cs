...
{
	public partial class SonificationDefaultSpeechOptionsMappingPan  : BaseObject
	{
		Hashtable h = new Hashtable();

		public SonificationDefaultSpeechOptionsMappingPan()
		{
			MapFunction = MapFunction_DefaultValue = SonificationDefaultSpeechOptionsMappingPanMapFunction.Linear;
			MapTo = MapTo_DefaultValue = "";
			Max = Max_DefaultValue = null;
			Min = Min_DefaultValue = null;
			Value = Value_DefaultValue = null;
			Within = Within_DefaultValue = SonificationDefaultSpeechOptionsMappingPanWithin.Chart;
		...
		/// </summary>
		public SonificationDefaultSpeechOptionsMappingPanMapFunction MapFunction { get; set; }
		private SonificationDefaultSpeechOptionsMappingPanMapFunction MapFunction_DefaultValue { get; set; }
		...
		/// </summary>
		public SonificationDefaultSpeechOptionsMappingPanWithin Within { get; set; }
		private SonificationDefaultSpeechOptionsMappingPanWithin Within_DefaultValue { get; set; }
