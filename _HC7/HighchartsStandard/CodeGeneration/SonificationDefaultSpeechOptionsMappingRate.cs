...
{
	public partial class SonificationDefaultSpeechOptionsMappingRate  : BaseObject
	{
		Hashtable h = new Hashtable();

		public SonificationDefaultSpeechOptionsMappingRate()
		{
			MapFunction = MapFunction_DefaultValue = SonificationDefaultSpeechOptionsMappingRateMapFunction.Linear;
			MapTo = MapTo_DefaultValue = "";
			Max = Max_DefaultValue = null;
			Min = Min_DefaultValue = null;
			Value = Value_DefaultValue = null;
			Within = Within_DefaultValue = SonificationDefaultSpeechOptionsMappingRateWithin.Chart;
		...
		/// </summary>
		public SonificationDefaultSpeechOptionsMappingRateMapFunction MapFunction { get; set; }
		private SonificationDefaultSpeechOptionsMappingRateMapFunction MapFunction_DefaultValue { get; set; }
		...
		/// </summary>
		public SonificationDefaultSpeechOptionsMappingRateWithin Within { get; set; }
		private SonificationDefaultSpeechOptionsMappingRateWithin Within_DefaultValue { get; set; }
