...
{
	public partial class SonificationGlobalContextTracksMapping  : BaseObject
	{
		Hashtable h = new Hashtable();

		public SonificationGlobalContextTracksMapping()
		{
			Frequency = Frequency_DefaultValue = new SonificationGlobalContextTracksMappingFrequency();
			GapBetweenNotes = GapBetweenNotes_DefaultValue = new SonificationGlobalContextTracksMappingGapBetweenNotes();
			Highpass = Highpass_DefaultValue = new SonificationGlobalContextTracksMappingHighpass();
			Lowpass = Lowpass_DefaultValue = new SonificationGlobalContextTracksMappingLowpass();
			NoteDuration = NoteDuration_DefaultValue = new SonificationGlobalContextTracksMappingNoteDuration();
			Pan = Pan_DefaultValue = new SonificationGlobalContextTracksMappingPan();
			Pitch = Pitch_DefaultValue = new SonificationGlobalContextTracksMappingPitch();
			PitchString = PitchString_DefaultValue = "null";
			PitchNumber = PitchNumber_DefaultValue = null;
			PlayDelay = PlayDelay_DefaultValue = new SonificationGlobalContextTracksMappingPlayDelay();
			Time = Time_DefaultValue = new SonificationGlobalContextTracksMappingTime();
			TimeString = TimeString_DefaultValue = "null";
			TimeNumber = TimeNumber_DefaultValue = null;
			Tremolo = Tremolo_DefaultValue = new SonificationGlobalContextTracksMappingTremolo();
			Volume = Volume_DefaultValue = new SonificationGlobalContextTracksMappingVolume();
		...
		/// </summary>
		public SonificationGlobalContextTracksMappingFrequency Frequency { get; set; }
		private SonificationGlobalContextTracksMappingFrequency Frequency_DefaultValue { get; set; }
		...
		/// </summary>
		public SonificationGlobalContextTracksMappingGapBetweenNotes GapBetweenNotes { get; set; }
		private SonificationGlobalContextTracksMappingGapBetweenNotes GapBetweenNotes_DefaultValue { get; set; }
		...
		/// </summary>
		public SonificationGlobalContextTracksMappingHighpass Highpass { get; set; }
		private SonificationGlobalContextTracksMappingHighpass Highpass_DefaultValue { get; set; }
		...
		/// </summary>
		public SonificationGlobalContextTracksMappingLowpass Lowpass { get; set; }
		private SonificationGlobalContextTracksMappingLowpass Lowpass_DefaultValue { get; set; }
		...
		/// </summary>
		public SonificationGlobalContextTracksMappingNoteDuration NoteDuration { get; set; }
		private SonificationGlobalContextTracksMappingNoteDuration NoteDuration_DefaultValue { get; set; }
		...
		/// </summary>
		public SonificationGlobalContextTracksMappingPan Pan { get; set; }
		private SonificationGlobalContextTracksMappingPan Pan_DefaultValue { get; set; }
		...
		/// </summary>
		public SonificationGlobalContextTracksMappingPitch Pitch { get; set; }
		private SonificationGlobalContextTracksMappingPitch Pitch_DefaultValue { get; set; }
		...
		/// </summary>
		public SonificationGlobalContextTracksMappingPlayDelay PlayDelay { get; set; }
		private SonificationGlobalContextTracksMappingPlayDelay PlayDelay_DefaultValue { get; set; }
		...
		/// </summary>
		public SonificationGlobalContextTracksMappingTime Time { get; set; }
		private SonificationGlobalContextTracksMappingTime Time_DefaultValue { get; set; }
		...
		/// </summary>
		public SonificationGlobalContextTracksMappingTremolo Tremolo { get; set; }
		private SonificationGlobalContextTracksMappingTremolo Tremolo_DefaultValue { get; set; }
		 

		/// <summary>
		/// The volume of notes, from 0 to 1.
		/// </summary>
		public SonificationGlobalContextTracksMappingVolume Volume { get; set; }
		private SonificationGlobalContextTracksMappingVolume Volume_DefaultValue { get; set; }
