...
{
	public partial class SonificationGlobalContextTracksMappingFrequency  : BaseObject
	{
		Hashtable h = new Hashtable();

		public SonificationGlobalContextTracksMappingFrequency()
		{
			MapFunction = MapFunction_DefaultValue = SonificationGlobalContextTracksMappingFrequencyMapFunction.Linear;
			MapTo = MapTo_DefaultValue = "";
			Max = Max_DefaultValue = null;
			Min = Min_DefaultValue = null;
			Value = Value_DefaultValue = null;
			Within = Within_DefaultValue = SonificationGlobalContextTracksMappingFrequencyWithin.Chart;
		...
		/// </summary>
		public SonificationGlobalContextTracksMappingFrequencyMapFunction MapFunction { get; set; }
		private SonificationGlobalContextTracksMappingFrequencyMapFunction MapFunction_DefaultValue { get; set; }
		...
		/// </summary>
		public SonificationGlobalContextTracksMappingFrequencyWithin Within { get; set; }
		private SonificationGlobalContextTracksMappingFrequencyWithin Within_DefaultValue { get; set; }
