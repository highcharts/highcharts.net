...
{
	public partial class SonificationGlobalContextTracksMappingGapBetweenNotes  : BaseObject
	{
		Hashtable h = new Hashtable();

		public SonificationGlobalContextTracksMappingGapBetweenNotes()
		{
			MapFunction = MapFunction_DefaultValue = SonificationGlobalContextTracksMappingGapBetweenNotesMapFunction.Linear;
			MapTo = MapTo_DefaultValue = "";
			Max = Max_DefaultValue = null;
			Min = Min_DefaultValue = null;
			Value = Value_DefaultValue = null;
			Within = Within_DefaultValue = SonificationGlobalContextTracksMappingGapBetweenNotesWithin.Chart;
		...
		/// </summary>
		public SonificationGlobalContextTracksMappingGapBetweenNotesMapFunction MapFunction { get; set; }
		private SonificationGlobalContextTracksMappingGapBetweenNotesMapFunction MapFunction_DefaultValue { get; set; }
		...
		/// </summary>
		public SonificationGlobalContextTracksMappingGapBetweenNotesWithin Within { get; set; }
		private SonificationGlobalContextTracksMappingGapBetweenNotesWithin Within_DefaultValue { get; set; }
