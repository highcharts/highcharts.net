...
{
	public partial class SonificationGlobalContextTracksMappingHighpassFrequency  : BaseObject
	{
		Hashtable h = new Hashtable();

		public SonificationGlobalContextTracksMappingHighpassFrequency()
		{
			MapFunction = MapFunction_DefaultValue = SonificationGlobalContextTracksMappingHighpassFrequencyMapFunction.Linear;
			MapTo = MapTo_DefaultValue = "";
			Max = Max_DefaultValue = null;
			Min = Min_DefaultValue = null;
			Value = Value_DefaultValue = null;
			Within = Within_DefaultValue = SonificationGlobalContextTracksMappingHighpassFrequencyWithin.Chart;
		...
		/// </summary>
		public SonificationGlobalContextTracksMappingHighpassFrequencyMapFunction MapFunction { get; set; }
		private SonificationGlobalContextTracksMappingHighpassFrequencyMapFunction MapFunction_DefaultValue { get; set; }
		...
		/// </summary>
		public SonificationGlobalContextTracksMappingHighpassFrequencyWithin Within { get; set; }
		private SonificationGlobalContextTracksMappingHighpassFrequencyWithin Within_DefaultValue { get; set; }
