...
{
	public partial class SonificationGlobalContextTracksMappingHighpassResonance  : BaseObject
	{
		Hashtable h = new Hashtable();

		public SonificationGlobalContextTracksMappingHighpassResonance()
		{
			MapFunction = MapFunction_DefaultValue = SonificationGlobalContextTracksMappingHighpassResonanceMapFunction.Linear;
			MapTo = MapTo_DefaultValue = "";
			Max = Max_DefaultValue = null;
			Min = Min_DefaultValue = null;
			Value = Value_DefaultValue = null;
			Within = Within_DefaultValue = SonificationGlobalContextTracksMappingHighpassResonanceWithin.Chart;
		...
		/// </summary>
		public SonificationGlobalContextTracksMappingHighpassResonanceMapFunction MapFunction { get; set; }
		private SonificationGlobalContextTracksMappingHighpassResonanceMapFunction MapFunction_DefaultValue { get; set; }
		...
		/// </summary>
		public SonificationGlobalContextTracksMappingHighpassResonanceWithin Within { get; set; }
		private SonificationGlobalContextTracksMappingHighpassResonanceWithin Within_DefaultValue { get; set; }
