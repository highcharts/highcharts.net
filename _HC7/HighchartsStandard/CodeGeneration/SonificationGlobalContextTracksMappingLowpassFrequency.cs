...
{
	public partial class SonificationGlobalContextTracksMappingLowpassFrequency  : BaseObject
	{
		Hashtable h = new Hashtable();

		public SonificationGlobalContextTracksMappingLowpassFrequency()
		{
			MapFunction = MapFunction_DefaultValue = SonificationGlobalContextTracksMappingLowpassFrequencyMapFunction.Linear;
			MapTo = MapTo_DefaultValue = "";
			Max = Max_DefaultValue = null;
			Min = Min_DefaultValue = null;
			Value = Value_DefaultValue = null;
			Within = Within_DefaultValue = SonificationGlobalContextTracksMappingLowpassFrequencyWithin.Chart;
		...
		/// </summary>
		public SonificationGlobalContextTracksMappingLowpassFrequencyMapFunction MapFunction { get; set; }
		private SonificationGlobalContextTracksMappingLowpassFrequencyMapFunction MapFunction_DefaultValue { get; set; }
		...
		/// </summary>
		public SonificationGlobalContextTracksMappingLowpassFrequencyWithin Within { get; set; }
		private SonificationGlobalContextTracksMappingLowpassFrequencyWithin Within_DefaultValue { get; set; }
