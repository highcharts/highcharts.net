...
{
	public partial class SonificationGlobalContextTracksMappingLowpassResonance  : BaseObject
	{
		Hashtable h = new Hashtable();

		public SonificationGlobalContextTracksMappingLowpassResonance()
		{
			MapFunction = MapFunction_DefaultValue = SonificationGlobalContextTracksMappingLowpassResonanceMapFunction.Linear;
			MapTo = MapTo_DefaultValue = "";
			Max = Max_DefaultValue = null;
			Min = Min_DefaultValue = null;
			Value = Value_DefaultValue = null;
			Within = Within_DefaultValue = SonificationGlobalContextTracksMappingLowpassResonanceWithin.Chart;
		...
		/// </summary>
		public SonificationGlobalContextTracksMappingLowpassResonanceMapFunction MapFunction { get; set; }
		private SonificationGlobalContextTracksMappingLowpassResonanceMapFunction MapFunction_DefaultValue { get; set; }
		...
		/// </summary>
		public SonificationGlobalContextTracksMappingLowpassResonanceWithin Within { get; set; }
		private SonificationGlobalContextTracksMappingLowpassResonanceWithin Within_DefaultValue { get; set; }
