...
{
	public partial class SonificationGlobalContextTracksMappingNoteDuration  : BaseObject
	{
		Hashtable h = new Hashtable();

		public SonificationGlobalContextTracksMappingNoteDuration()
		{
			MapFunction = MapFunction_DefaultValue = SonificationGlobalContextTracksMappingNoteDurationMapFunction.Linear;
			MapTo = MapTo_DefaultValue = "";
			Max = Max_DefaultValue = null;
			Min = Min_DefaultValue = null;
			Value = Value_DefaultValue = null;
			Within = Within_DefaultValue = SonificationGlobalContextTracksMappingNoteDurationWithin.Chart;
		...
		/// </summary>
		public SonificationGlobalContextTracksMappingNoteDurationMapFunction MapFunction { get; set; }
		private SonificationGlobalContextTracksMappingNoteDurationMapFunction MapFunction_DefaultValue { get; set; }
		...
		/// </summary>
		public SonificationGlobalContextTracksMappingNoteDurationWithin Within { get; set; }
		private SonificationGlobalContextTracksMappingNoteDurationWithin Within_DefaultValue { get; set; }
