...
{
	public partial class SonificationGlobalContextTracksMappingPan  : BaseObject
	{
		Hashtable h = new Hashtable();

		public SonificationGlobalContextTracksMappingPan()
		{
			MapFunction = MapFunction_DefaultValue = SonificationGlobalContextTracksMappingPanMapFunction.Linear;
			MapTo = MapTo_DefaultValue = "";
			Max = Max_DefaultValue = null;
			Min = Min_DefaultValue = null;
			Value = Value_DefaultValue = null;
			Within = Within_DefaultValue = SonificationGlobalContextTracksMappingPanWithin.Chart;
		...
		/// </summary>
		public SonificationGlobalContextTracksMappingPanMapFunction MapFunction { get; set; }
		private SonificationGlobalContextTracksMappingPanMapFunction MapFunction_DefaultValue { get; set; }
		...
		/// </summary>
		public SonificationGlobalContextTracksMappingPanWithin Within { get; set; }
		private SonificationGlobalContextTracksMappingPanWithin Within_DefaultValue { get; set; }
