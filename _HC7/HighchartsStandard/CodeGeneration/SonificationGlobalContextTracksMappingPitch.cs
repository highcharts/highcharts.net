...
{
	public partial class SonificationGlobalContextTracksMappingPitch  : BaseObject
	{
		Hashtable h = new Hashtable();

		public SonificationGlobalContextTracksMappingPitch()
		{
			MapFunction = MapFunction_DefaultValue = SonificationGlobalContextTracksMappingPitchMapFunction.Linear;
		...
		/// </summary>
		public SonificationGlobalContextTracksMappingPitchMapFunction MapFunction { get; set; }
		private SonificationGlobalContextTracksMappingPitchMapFunction MapFunction_DefaultValue { get; set; }
