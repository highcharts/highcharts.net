...
{
	public partial class SonificationGlobalContextTracksMappingPlayDelay  : BaseObject
	{
		Hashtable h = new Hashtable();

		public SonificationGlobalContextTracksMappingPlayDelay()
		{
			MapFunction = MapFunction_DefaultValue = SonificationGlobalContextTracksMappingPlayDelayMapFunction.Linear;
			MapTo = MapTo_DefaultValue = "";
			Max = Max_DefaultValue = null;
			Min = Min_DefaultValue = null;
			Value = Value_DefaultValue = null;
			Within = Within_DefaultValue = SonificationGlobalContextTracksMappingPlayDelayWithin.Chart;
		...
		/// </summary>
		public SonificationGlobalContextTracksMappingPlayDelayMapFunction MapFunction { get; set; }
		private SonificationGlobalContextTracksMappingPlayDelayMapFunction MapFunction_DefaultValue { get; set; }
		...
		/// </summary>
		public SonificationGlobalContextTracksMappingPlayDelayWithin Within { get; set; }
		private SonificationGlobalContextTracksMappingPlayDelayWithin Within_DefaultValue { get; set; }
