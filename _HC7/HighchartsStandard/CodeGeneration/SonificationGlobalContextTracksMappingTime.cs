...
{
	public partial class SonificationGlobalContextTracksMappingTime  : BaseObject
	{
		Hashtable h = new Hashtable();

		public SonificationGlobalContextTracksMappingTime()
		{
			MapFunction = MapFunction_DefaultValue = SonificationGlobalContextTracksMappingTimeMapFunction.Linear;
			MapTo = MapTo_DefaultValue = "";
			Max = Max_DefaultValue = null;
			Min = Min_DefaultValue = null;
			Value = Value_DefaultValue = null;
			Within = Within_DefaultValue = SonificationGlobalContextTracksMappingTimeWithin.Chart;
		...
		/// </summary>
		public SonificationGlobalContextTracksMappingTimeMapFunction MapFunction { get; set; }
		private SonificationGlobalContextTracksMappingTimeMapFunction MapFunction_DefaultValue { get; set; }
		...
		/// </summary>
		public SonificationGlobalContextTracksMappingTimeWithin Within { get; set; }
		private SonificationGlobalContextTracksMappingTimeWithin Within_DefaultValue { get; set; }
