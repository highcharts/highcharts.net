...
{
	public partial class SonificationGlobalContextTracksMappingTremoloDepth  : BaseObject
	{
		Hashtable h = new Hashtable();

		public SonificationGlobalContextTracksMappingTremoloDepth()
		{
			MapFunction = MapFunction_DefaultValue = SonificationGlobalContextTracksMappingTremoloDepthMapFunction.Linear;
			MapTo = MapTo_DefaultValue = "";
			Max = Max_DefaultValue = null;
			Min = Min_DefaultValue = null;
			Value = Value_DefaultValue = null;
			Within = Within_DefaultValue = SonificationGlobalContextTracksMappingTremoloDepthWithin.Chart;
		...
		/// </summary>
		public SonificationGlobalContextTracksMappingTremoloDepthMapFunction MapFunction { get; set; }
		private SonificationGlobalContextTracksMappingTremoloDepthMapFunction MapFunction_DefaultValue { get; set; }
		...
		/// </summary>
		public SonificationGlobalContextTracksMappingTremoloDepthWithin Within { get; set; }
		private SonificationGlobalContextTracksMappingTremoloDepthWithin Within_DefaultValue { get; set; }
