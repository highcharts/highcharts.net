...
{
	public partial class SonificationGlobalContextTracksMappingTremoloSpeed  : BaseObject
	{
		Hashtable h = new Hashtable();

		public SonificationGlobalContextTracksMappingTremoloSpeed()
		{
			MapFunction = MapFunction_DefaultValue = SonificationGlobalContextTracksMappingTremoloSpeedMapFunction.Linear;
			MapTo = MapTo_DefaultValue = "";
			Max = Max_DefaultValue = null;
			Min = Min_DefaultValue = null;
			Value = Value_DefaultValue = null;
			Within = Within_DefaultValue = SonificationGlobalContextTracksMappingTremoloSpeedWithin.Chart;
		...
		/// </summary>
		public SonificationGlobalContextTracksMappingTremoloSpeedMapFunction MapFunction { get; set; }
		private SonificationGlobalContextTracksMappingTremoloSpeedMapFunction MapFunction_DefaultValue { get; set; }
		...
		/// </summary>
		public SonificationGlobalContextTracksMappingTremoloSpeedWithin Within { get; set; }
		private SonificationGlobalContextTracksMappingTremoloSpeedWithin Within_DefaultValue { get; set; }
