...
{
	public partial class SonificationGlobalContextTracksMappingVolume  : BaseObject
	{
		Hashtable h = new Hashtable();

		public SonificationGlobalContextTracksMappingVolume()
		{
			MapFunction = MapFunction_DefaultValue = SonificationGlobalContextTracksMappingVolumeMapFunction.Linear;
			MapTo = MapTo_DefaultValue = "";
			Max = Max_DefaultValue = null;
			Min = Min_DefaultValue = null;
			Value = Value_DefaultValue = null;
			Within = Within_DefaultValue = SonificationGlobalContextTracksMappingVolumeWithin.Chart;
		...
		/// </summary>
		public SonificationGlobalContextTracksMappingVolumeMapFunction MapFunction { get; set; }
		private SonificationGlobalContextTracksMappingVolumeMapFunction MapFunction_DefaultValue { get; set; }
		...
		/// </summary>
		public SonificationGlobalContextTracksMappingVolumeWithin Within { get; set; }
		private SonificationGlobalContextTracksMappingVolumeWithin Within_DefaultValue { get; set; }
