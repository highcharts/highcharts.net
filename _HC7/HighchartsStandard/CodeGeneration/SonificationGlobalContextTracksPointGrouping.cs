...
{
	public partial class SonificationGlobalContextTracksPointGrouping  : BaseObject
	{
		Hashtable h = new Hashtable();

		public SonificationGlobalContextTracksPointGrouping()
		{
		...
		/// </summary>
		public SonificationGlobalContextTracksPointGroupingAlgorithm Algorithm { get; set; }
		private SonificationGlobalContextTracksPointGroupingAlgorithm Algorithm_DefaultValue { get; set; }
		...
		internal override Hashtable ToHashtable(Highcharts highcharts)
		{
			...
			if (Algorithm != SonificationGlobalContextTracksPointGroupingAlgorithm.Null) h.Add("algorithm", highcharts.FirstCharacterToLower(Algorithm.ToString()));
