...
{
	public partial class SonificationGlobalTracksMapping  : BaseObject
	{
		Hashtable h = new Hashtable();

		public SonificationGlobalTracksMapping()
		{
			Frequency = Frequency_DefaultValue = new SonificationGlobalTracksMappingFrequency();
			GapBetweenNotes = GapBetweenNotes_DefaultValue = new SonificationGlobalTracksMappingGapBetweenNotes();
			Highpass = Highpass_DefaultValue = new SonificationGlobalTracksMappingHighpass();
			Lowpass = Lowpass_DefaultValue = new SonificationGlobalTracksMappingLowpass();
			NoteDuration = NoteDuration_DefaultValue = new SonificationGlobalTracksMappingNoteDuration();
			Pan = Pan_DefaultValue = new SonificationGlobalTracksMappingPan();
			Pitch = Pitch_DefaultValue = new SonificationGlobalTracksMappingPitch();
		...
		/// </summary>
		public SonificationGlobalTracksMappingFrequency Frequency { get; set; }
		private SonificationGlobalTracksMappingFrequency Frequency_DefaultValue { get; set; }
		...
		/// </summary>
		public SonificationGlobalTracksMappingGapBetweenNotes GapBetweenNotes { get; set; }
		private SonificationGlobalTracksMappingGapBetweenNotes GapBetweenNotes_DefaultValue { get; set; }
		...
		/// </summary>
		public SonificationGlobalTracksMappingHighpass Highpass { get; set; }
		private SonificationGlobalTracksMappingHighpass Highpass_DefaultValue { get; set; }
		...
		/// </summary>
		public SonificationGlobalTracksMappingLowpass Lowpass { get; set; }
		private SonificationGlobalTracksMappingLowpass Lowpass_DefaultValue { get; set; }
		...
		/// </summary>
		public SonificationGlobalTracksMappingNoteDuration NoteDuration { get; set; }
		private SonificationGlobalTracksMappingNoteDuration NoteDuration_DefaultValue { get; set; }
		...
		/// </summary>
		public SonificationGlobalTracksMappingPan Pan { get; set; }
		private SonificationGlobalTracksMappingPan Pan_DefaultValue { get; set; }
		...
		/// </summary>
		public SonificationGlobalTracksMappingPitch Pitch { get; set; }
		private SonificationGlobalTracksMappingPitch Pitch_DefaultValue { get; set; }
		...
		/// </summary>
		public SonificationGlobalTracksMappingPlayDelay PlayDelay { get; set; }
		private SonificationGlobalTracksMappingPlayDelay PlayDelay_DefaultValue { get; set; }
		 

		/// <summary>
		/// Rate mapping for speech tracks.
		/// </summary>
		public SonificationGlobalTracksMappingRate Rate { get; set; }
		private SonificationGlobalTracksMappingRate Rate_DefaultValue { get; set; }
		 

		/// <summary>
		/// Text mapping for speech tracks.
		/// </summary>
		public SonificationGlobalTracksMappingText Text { get; set; }
		private SonificationGlobalTracksMappingText Text_DefaultValue { get; set; }
		...
		/// </summary>
		public SonificationGlobalTracksMappingTremolo Tremolo { get; set; }
		private SonificationGlobalTracksMappingTremolo Tremolo_DefaultValue { get; set; }
		 

		/// <summary>
		/// The volume of notes, from 0 to 1.
		/// </summary>
		public SonificationGlobalTracksMappingVolume Volume { get; set; }
		private SonificationGlobalTracksMappingVolume Volume_DefaultValue { get; set; }
		...
		internal override Hashtable ToHashtable(Highcharts highcharts)
		{
			...
			if (Text.IsDirty(highcharts)) h.Add("text",Text.ToHashtable(highcharts));
