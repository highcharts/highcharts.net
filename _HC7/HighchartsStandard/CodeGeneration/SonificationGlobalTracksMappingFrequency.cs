...
{
	public partial class SonificationGlobalTracksMappingFrequency  : BaseObject
	{
		Hashtable h = new Hashtable();

		public SonificationGlobalTracksMappingFrequency()
		{
			MapFunction = MapFunction_DefaultValue = SonificationGlobalTracksMappingFrequencyMapFunction.Linear;
			MapTo = MapTo_DefaultValue = "";
			Max = Max_DefaultValue = null;
			Min = Min_DefaultValue = null;
			Value = Value_DefaultValue = null;
			Within = Within_DefaultValue = SonificationGlobalTracksMappingFrequencyWithin.Chart;
		...
		/// </summary>
		public SonificationGlobalTracksMappingFrequencyMapFunction MapFunction { get; set; }
		private SonificationGlobalTracksMappingFrequencyMapFunction MapFunction_DefaultValue { get; set; }
		...
		/// </summary>
		public SonificationGlobalTracksMappingFrequencyWithin Within { get; set; }
		private SonificationGlobalTracksMappingFrequencyWithin Within_DefaultValue { get; set; }
