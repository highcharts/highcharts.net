...
{
	public partial class SonificationGlobalTracksMappingGapBetweenNotes  : BaseObject
	{
		Hashtable h = new Hashtable();

		public SonificationGlobalTracksMappingGapBetweenNotes()
		{
			MapFunction = MapFunction_DefaultValue = SonificationGlobalTracksMappingGapBetweenNotesMapFunction.Linear;
			MapTo = MapTo_DefaultValue = "";
			Max = Max_DefaultValue = null;
			Min = Min_DefaultValue = null;
			Value = Value_DefaultValue = null;
			Within = Within_DefaultValue = SonificationGlobalTracksMappingGapBetweenNotesWithin.Chart;
		...
		/// </summary>
		public SonificationGlobalTracksMappingGapBetweenNotesMapFunction MapFunction { get; set; }
		private SonificationGlobalTracksMappingGapBetweenNotesMapFunction MapFunction_DefaultValue { get; set; }
		...
		/// </summary>
		public SonificationGlobalTracksMappingGapBetweenNotesWithin Within { get; set; }
		private SonificationGlobalTracksMappingGapBetweenNotesWithin Within_DefaultValue { get; set; }
