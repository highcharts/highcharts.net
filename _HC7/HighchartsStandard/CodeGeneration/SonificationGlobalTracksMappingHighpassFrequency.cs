...
{
	public partial class SonificationGlobalTracksMappingHighpassFrequency  : BaseObject
	{
		Hashtable h = new Hashtable();

		public SonificationGlobalTracksMappingHighpassFrequency()
		{
			MapFunction = MapFunction_DefaultValue = SonificationGlobalTracksMappingHighpassFrequencyMapFunction.Linear;
			MapTo = MapTo_DefaultValue = "";
			Max = Max_DefaultValue = null;
			Min = Min_DefaultValue = null;
			Value = Value_DefaultValue = null;
			Within = Within_DefaultValue = SonificationGlobalTracksMappingHighpassFrequencyWithin.Chart;
		...
		/// </summary>
		public SonificationGlobalTracksMappingHighpassFrequencyMapFunction MapFunction { get; set; }
		private SonificationGlobalTracksMappingHighpassFrequencyMapFunction MapFunction_DefaultValue { get; set; }
		...
		/// </summary>
		public SonificationGlobalTracksMappingHighpassFrequencyWithin Within { get; set; }
		private SonificationGlobalTracksMappingHighpassFrequencyWithin Within_DefaultValue { get; set; }
