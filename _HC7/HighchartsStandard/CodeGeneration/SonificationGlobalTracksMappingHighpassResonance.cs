...
{
	public partial class SonificationGlobalTracksMappingHighpassResonance  : BaseObject
	{
		Hashtable h = new Hashtable();

		public SonificationGlobalTracksMappingHighpassResonance()
		{
			MapFunction = MapFunction_DefaultValue = SonificationGlobalTracksMappingHighpassResonanceMapFunction.Linear;
			MapTo = MapTo_DefaultValue = "";
			Max = Max_DefaultValue = null;
			Min = Min_DefaultValue = null;
			Value = Value_DefaultValue = null;
			Within = Within_DefaultValue = SonificationGlobalTracksMappingHighpassResonanceWithin.Chart;
		...
		/// </summary>
		public SonificationGlobalTracksMappingHighpassResonanceMapFunction MapFunction { get; set; }
		private SonificationGlobalTracksMappingHighpassResonanceMapFunction MapFunction_DefaultValue { get; set; }
		...
		/// </summary>
		public SonificationGlobalTracksMappingHighpassResonanceWithin Within { get; set; }
		private SonificationGlobalTracksMappingHighpassResonanceWithin Within_DefaultValue { get; set; }
