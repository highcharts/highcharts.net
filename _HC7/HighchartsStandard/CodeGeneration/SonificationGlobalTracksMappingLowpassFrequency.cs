...
{
	public partial class SonificationGlobalTracksMappingLowpassFrequency  : BaseObject
	{
		Hashtable h = new Hashtable();

		public SonificationGlobalTracksMappingLowpassFrequency()
		{
			MapFunction = MapFunction_DefaultValue = SonificationGlobalTracksMappingLowpassFrequencyMapFunction.Linear;
			MapTo = MapTo_DefaultValue = "";
			Max = Max_DefaultValue = null;
			Min = Min_DefaultValue = null;
			Value = Value_DefaultValue = null;
			Within = Within_DefaultValue = SonificationGlobalTracksMappingLowpassFrequencyWithin.Chart;
		...
		/// </summary>
		public SonificationGlobalTracksMappingLowpassFrequencyMapFunction MapFunction { get; set; }
		private SonificationGlobalTracksMappingLowpassFrequencyMapFunction MapFunction_DefaultValue { get; set; }
		...
		/// </summary>
		public SonificationGlobalTracksMappingLowpassFrequencyWithin Within { get; set; }
		private SonificationGlobalTracksMappingLowpassFrequencyWithin Within_DefaultValue { get; set; }
