...
{
	public partial class SonificationGlobalTracksMappingLowpassResonance  : BaseObject
	{
		Hashtable h = new Hashtable();

		public SonificationGlobalTracksMappingLowpassResonance()
		{
			MapFunction = MapFunction_DefaultValue = SonificationGlobalTracksMappingLowpassResonanceMapFunction.Linear;
			MapTo = MapTo_DefaultValue = "";
			Max = Max_DefaultValue = null;
			Min = Min_DefaultValue = null;
			Value = Value_DefaultValue = null;
			Within = Within_DefaultValue = SonificationGlobalTracksMappingLowpassResonanceWithin.Chart;
		...
		/// </summary>
		public SonificationGlobalTracksMappingLowpassResonanceMapFunction MapFunction { get; set; }
		private SonificationGlobalTracksMappingLowpassResonanceMapFunction MapFunction_DefaultValue { get; set; }
		...
		/// </summary>
		public SonificationGlobalTracksMappingLowpassResonanceWithin Within { get; set; }
		private SonificationGlobalTracksMappingLowpassResonanceWithin Within_DefaultValue { get; set; }
