...
{
	public partial class SonificationGlobalTracksMappingNoteDuration  : BaseObject
	{
		Hashtable h = new Hashtable();

		public SonificationGlobalTracksMappingNoteDuration()
		{
			MapFunction = MapFunction_DefaultValue = SonificationGlobalTracksMappingNoteDurationMapFunction.Linear;
			MapTo = MapTo_DefaultValue = "";
			Max = Max_DefaultValue = null;
			Min = Min_DefaultValue = null;
			Value = Value_DefaultValue = null;
			Within = Within_DefaultValue = SonificationGlobalTracksMappingNoteDurationWithin.Chart;
		...
		/// </summary>
		public SonificationGlobalTracksMappingNoteDurationMapFunction MapFunction { get; set; }
		private SonificationGlobalTracksMappingNoteDurationMapFunction MapFunction_DefaultValue { get; set; }
		...
		/// </summary>
		public SonificationGlobalTracksMappingNoteDurationWithin Within { get; set; }
		private SonificationGlobalTracksMappingNoteDurationWithin Within_DefaultValue { get; set; }
