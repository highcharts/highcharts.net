...
{
	public partial class SonificationGlobalTracksMappingPan  : BaseObject
	{
		Hashtable h = new Hashtable();

		public SonificationGlobalTracksMappingPan()
		{
			MapFunction = MapFunction_DefaultValue = SonificationGlobalTracksMappingPanMapFunction.Linear;
			MapTo = MapTo_DefaultValue = "";
			Max = Max_DefaultValue = null;
			Min = Min_DefaultValue = null;
			Value = Value_DefaultValue = null;
			Within = Within_DefaultValue = SonificationGlobalTracksMappingPanWithin.Chart;
		...
		/// </summary>
		public SonificationGlobalTracksMappingPanMapFunction MapFunction { get; set; }
		private SonificationGlobalTracksMappingPanMapFunction MapFunction_DefaultValue { get; set; }
		...
		/// </summary>
		public SonificationGlobalTracksMappingPanWithin Within { get; set; }
		private SonificationGlobalTracksMappingPanWithin Within_DefaultValue { get; set; }
