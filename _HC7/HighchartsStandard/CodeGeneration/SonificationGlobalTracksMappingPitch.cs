...
{
	public partial class SonificationGlobalTracksMappingPitch  : BaseObject
	{
		Hashtable h = new Hashtable();

		public SonificationGlobalTracksMappingPitch()
		{
			MapFunction = MapFunction_DefaultValue = SonificationGlobalTracksMappingPitchMapFunction.Linear;
		...
		/// </summary>
		public SonificationGlobalTracksMappingPitchMapFunction MapFunction { get; set; }
		private SonificationGlobalTracksMappingPitchMapFunction MapFunction_DefaultValue { get; set; }
