...
{
	public partial class SonificationGlobalTracksMappingPlayDelay  : BaseObject
	{
		Hashtable h = new Hashtable();

		public SonificationGlobalTracksMappingPlayDelay()
		{
			MapFunction = MapFunction_DefaultValue = SonificationGlobalTracksMappingPlayDelayMapFunction.Linear;
			MapTo = MapTo_DefaultValue = "";
			Max = Max_DefaultValue = null;
			Min = Min_DefaultValue = null;
			Value = Value_DefaultValue = null;
			Within = Within_DefaultValue = SonificationGlobalTracksMappingPlayDelayWithin.Chart;
		...
		/// </summary>
		public SonificationGlobalTracksMappingPlayDelayMapFunction MapFunction { get; set; }
		private SonificationGlobalTracksMappingPlayDelayMapFunction MapFunction_DefaultValue { get; set; }
		...
		/// </summary>
		public SonificationGlobalTracksMappingPlayDelayWithin Within { get; set; }
		private SonificationGlobalTracksMappingPlayDelayWithin Within_DefaultValue { get; set; }
