...
{
	public partial class SonificationGlobalTracksMappingRate  : BaseObject
	{
		Hashtable h = new Hashtable();

		public SonificationGlobalTracksMappingRate()
		{
			MapFunction = MapFunction_DefaultValue = SonificationGlobalTracksMappingRateMapFunction.Linear;
			MapTo = MapTo_DefaultValue = "";
			Max = Max_DefaultValue = null;
			Min = Min_DefaultValue = null;
			Value = Value_DefaultValue = null;
			Within = Within_DefaultValue = SonificationGlobalTracksMappingRateWithin.Chart;
		...
		/// </summary>
		public SonificationGlobalTracksMappingRateMapFunction MapFunction { get; set; }
		private SonificationGlobalTracksMappingRateMapFunction MapFunction_DefaultValue { get; set; }
		...
		/// </summary>
		public SonificationGlobalTracksMappingRateWithin Within { get; set; }
		private SonificationGlobalTracksMappingRateWithin Within_DefaultValue { get; set; }
