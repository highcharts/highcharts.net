...
{
	public partial class SonificationGlobalTracksMappingTime  : BaseObject
	{
		Hashtable h = new Hashtable();

		public SonificationGlobalTracksMappingTime()
		{
			MapFunction = MapFunction_DefaultValue = SonificationGlobalTracksMappingTimeMapFunction.Linear;
			MapTo = MapTo_DefaultValue = "";
			Max = Max_DefaultValue = null;
			Min = Min_DefaultValue = null;
			Value = Value_DefaultValue = null;
			Within = Within_DefaultValue = SonificationGlobalTracksMappingTimeWithin.Chart;
		...
		/// </summary>
		public SonificationGlobalTracksMappingTimeMapFunction MapFunction { get; set; }
		private SonificationGlobalTracksMappingTimeMapFunction MapFunction_DefaultValue { get; set; }
		...
		/// </summary>
		public SonificationGlobalTracksMappingTimeWithin Within { get; set; }
		private SonificationGlobalTracksMappingTimeWithin Within_DefaultValue { get; set; }
