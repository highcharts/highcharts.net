...
{
	public partial class SonificationGlobalTracksMappingTremoloDepth  : BaseObject
	{
		Hashtable h = new Hashtable();

		public SonificationGlobalTracksMappingTremoloDepth()
		{
			MapFunction = MapFunction_DefaultValue = SonificationGlobalTracksMappingTremoloDepthMapFunction.Linear;
			MapTo = MapTo_DefaultValue = "";
			Max = Max_DefaultValue = null;
			Min = Min_DefaultValue = null;
			Value = Value_DefaultValue = null;
			Within = Within_DefaultValue = SonificationGlobalTracksMappingTremoloDepthWithin.Chart;
		...
		/// </summary>
		public SonificationGlobalTracksMappingTremoloDepthMapFunction MapFunction { get; set; }
		private SonificationGlobalTracksMappingTremoloDepthMapFunction MapFunction_DefaultValue { get; set; }
		...
		/// </summary>
		public SonificationGlobalTracksMappingTremoloDepthWithin Within { get; set; }
		private SonificationGlobalTracksMappingTremoloDepthWithin Within_DefaultValue { get; set; }
