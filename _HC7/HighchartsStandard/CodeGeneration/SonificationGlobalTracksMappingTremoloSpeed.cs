...
{
	public partial class SonificationGlobalTracksMappingTremoloSpeed  : BaseObject
	{
		Hashtable h = new Hashtable();

		public SonificationGlobalTracksMappingTremoloSpeed()
		{
			MapFunction = MapFunction_DefaultValue = SonificationGlobalTracksMappingTremoloSpeedMapFunction.Linear;
			MapTo = MapTo_DefaultValue = "";
			Max = Max_DefaultValue = null;
			Min = Min_DefaultValue = null;
			Value = Value_DefaultValue = null;
			Within = Within_DefaultValue = SonificationGlobalTracksMappingTremoloSpeedWithin.Chart;
		...
		/// </summary>
		public SonificationGlobalTracksMappingTremoloSpeedMapFunction MapFunction { get; set; }
		private SonificationGlobalTracksMappingTremoloSpeedMapFunction MapFunction_DefaultValue { get; set; }
		...
		/// </summary>
		public SonificationGlobalTracksMappingTremoloSpeedWithin Within { get; set; }
		private SonificationGlobalTracksMappingTremoloSpeedWithin Within_DefaultValue { get; set; }
