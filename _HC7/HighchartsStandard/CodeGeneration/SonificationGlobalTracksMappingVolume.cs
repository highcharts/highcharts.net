...
{
	public partial class SonificationGlobalTracksMappingVolume  : BaseObject
	{
		Hashtable h = new Hashtable();

		public SonificationGlobalTracksMappingVolume()
		{
			MapFunction = MapFunction_DefaultValue = SonificationGlobalTracksMappingVolumeMapFunction.Linear;
			MapTo = MapTo_DefaultValue = "";
			Max = Max_DefaultValue = null;
			Min = Min_DefaultValue = null;
			Value = Value_DefaultValue = null;
			Within = Within_DefaultValue = SonificationGlobalTracksMappingVolumeWithin.Chart;
		...
		/// </summary>
		public SonificationGlobalTracksMappingVolumeMapFunction MapFunction { get; set; }
		private SonificationGlobalTracksMappingVolumeMapFunction MapFunction_DefaultValue { get; set; }
		...
		/// </summary>
		public SonificationGlobalTracksMappingVolumeWithin Within { get; set; }
		private SonificationGlobalTracksMappingVolumeWithin Within_DefaultValue { get; set; }
