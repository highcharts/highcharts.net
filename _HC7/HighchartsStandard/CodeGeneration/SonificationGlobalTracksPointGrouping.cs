...
{
	public partial class SonificationGlobalTracksPointGrouping  : BaseObject
	{
		Hashtable h = new Hashtable();

		public SonificationGlobalTracksPointGrouping()
		{
		...
		/// </summary>
		public SonificationGlobalTracksPointGroupingAlgorithm Algorithm { get; set; }
		private SonificationGlobalTracksPointGroupingAlgorithm Algorithm_DefaultValue { get; set; }
		...
		internal override Hashtable ToHashtable(Highcharts highcharts)
		{
			...
			if (Algorithm != SonificationGlobalTracksPointGroupingAlgorithm.Null) h.Add("algorithm", highcharts.FirstCharacterToLower(Algorithm.ToString()));
