...
{
	public partial class SonificationPointGrouping  : BaseObject
	{
		Hashtable h = new Hashtable();

		public SonificationPointGrouping()
		{
		...
		/// </summary>
		public SonificationPointGroupingAlgorithm Algorithm { get; set; }
		private SonificationPointGroupingAlgorithm Algorithm_DefaultValue { get; set; }
		...
		internal override Hashtable ToHashtable(Highcharts highcharts)
		{
			...
			if (Algorithm != SonificationPointGroupingAlgorithm.Null) h.Add("algorithm", highcharts.FirstCharacterToLower(Algorithm.ToString()));
