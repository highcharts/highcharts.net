...
{
	public partial class SplineSeriesData  : BaseObject
	{
		Hashtable h = new Hashtable();

		public SplineSeriesData()
		{
			Accessibility = Accessibility_DefaultValue = new SplineSeriesDataAccessibility();
			...
			DragDrop = DragDrop_DefaultValue = new SplineSeriesDataDragDrop();
			Drilldown = Drilldown_DefaultValue = "";
			Events = Events_DefaultValue = new SplineSeriesDataEvents();
			Id = Id_DefaultValue = "";
			Labelrank = Labelrank_DefaultValue = null;
			Marker = Marker_DefaultValue = new SplineSeriesDataMarker();
		...
		/// </summary>
		public SplineSeriesDataAccessibility Accessibility { get; set; }
		private SplineSeriesDataAccessibility Accessibility_DefaultValue { get; set; }
		...
		/// </summary>
		public SplineSeriesDataDragDrop DragDrop { get; set; }
		private SplineSeriesDataDragDrop DragDrop_DefaultValue { get; set; }
