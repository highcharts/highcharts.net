...
{
	public partial class SplineSeriesDataDataLabels  : BaseObject
	{
		Hashtable h = new Hashtable();

		public SplineSeriesDataDataLabels()
		{
		...
		/// </summary>
		public SplineSeriesDataDataLabelsAlign Align { get; set; }
		private SplineSeriesDataDataLabelsAlign Align_DefaultValue { get; set; }
		...
		/// </summary>
		public SplineSeriesDataDataLabelsFilter Filter { get; set; }
		private SplineSeriesDataDataLabelsFilter Filter_DefaultValue { get; set; }
		...
		/// </summary>
		public SplineSeriesDataDataLabelsOverflow Overflow { get; set; }
		private SplineSeriesDataDataLabelsOverflow Overflow_DefaultValue { get; set; }
		...
		/// </summary>
		public SplineSeriesDataDataLabelsPosition Position { get; set; }
		private SplineSeriesDataDataLabelsPosition Position_DefaultValue { get; set; }
		...
		/// </summary>
		public SplineSeriesDataDataLabelsTextPath TextPath { get; set; }
		private SplineSeriesDataDataLabelsTextPath TextPath_DefaultValue { get; set; }
		...
		/// </summary>
		public SplineSeriesDataDataLabelsVerticalAlign VerticalAlign { get; set; }
		private SplineSeriesDataDataLabelsVerticalAlign VerticalAlign_DefaultValue { get; set; }
		...
		internal override Hashtable ToHashtable(Highcharts highcharts)
		{
			...
			if (Align != SplineSeriesDataDataLabelsAlign.Null) h.Add("align", highcharts.FirstCharacterToLower(Align.ToString()));
			...
			if (Overflow != SplineSeriesDataDataLabelsOverflow.Null) h.Add("overflow", highcharts.FirstCharacterToLower(Overflow.ToString()));
			if (Padding != null) h.Add("padding",Padding);
			if (Position != SplineSeriesDataDataLabelsPosition.Null) h.Add("position", highcharts.FirstCharacterToLower(Position.ToString()));
			...
			if (VerticalAlign != SplineSeriesDataDataLabelsVerticalAlign.Null) h.Add("verticalAlign", highcharts.FirstCharacterToLower(VerticalAlign.ToString()));
			if (X != null) h.Add("x",X);
			if (Y != null) h.Add("y",Y);
