...
namespace Highsoft.Web.Mvc.Charts
{
	public partial class SplineSeriesDataDragDropDragHandle  : BaseObject
	{
		...
		internal override Hashtable ToHashtable()
		{
			...
			if (PathFormatter != PathFormatter_DefaultValue) { h.Add("pathFormatter",PathFormatter); Highcharts.AddFunction("1e50b819-6e63-4017-97cc-3fbde87adb43.pathFormatter", PathFormatter); }  
