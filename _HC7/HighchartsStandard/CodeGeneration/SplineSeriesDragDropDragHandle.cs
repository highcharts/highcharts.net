...
{
	public partial class SplineSeriesDragDropDragHandle  : BaseObject
	{
		public SplineSeriesDragDropDragHandle()
		{
		...
		internal override Hashtable ToHashtable()
		{
			...
			if (PathFormatter != PathFormatter_DefaultValue) { h.Add("pathFormatter",PathFormatter); Highcharts.AddFunction("SplineSeriesDragDropDragHandlePathFormatter.pathFormatter", PathFormatter); }  
