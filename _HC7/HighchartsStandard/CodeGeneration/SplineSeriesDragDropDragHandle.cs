...
namespace Highsoft.Web.Mvc.Charts
{
	public partial class SplineSeriesDragDropDragHandle  : BaseObject
	{
		...
		internal override Hashtable ToHashtable()
		{
			...
			if (PathFormatter != PathFormatter_DefaultValue) { h.Add("pathFormatter",PathFormatter); Highcharts.AddFunction("81b6383a-eb51-494e-9c49-a11aaaa6b50d.pathFormatter", PathFormatter); }  
