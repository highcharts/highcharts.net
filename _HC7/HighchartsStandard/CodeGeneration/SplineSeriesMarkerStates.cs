...
namespace Highsoft.Web.Mvc.Charts
{
	public partial class SplineSeriesMarkerStates  : BaseObject
	{
		public SplineSeriesMarkerStates()
		{
			...
			Inactive = Inactive_DefaultValue = new SplineSeriesMarkerStatesInactive();
		...
		/// 
		/// </summary>
		public SplineSeriesMarkerStatesInactive Inactive { get; set; }
		private SplineSeriesMarkerStatesInactive Inactive_DefaultValue { get; set; }
