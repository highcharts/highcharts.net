...
{
	public partial class SplineSeriesSonificationContextTracksMappingFrequency  : BaseObject
	{
		Hashtable h = new Hashtable();

		public SplineSeriesSonificationContextTracksMappingFrequency()
		{
			MapFunction = MapFunction_DefaultValue = SplineSeriesSonificationContextTracksMappingFrequencyMapFunction.Linear;
			MapTo = MapTo_DefaultValue = "";
			Max = Max_DefaultValue = null;
			Min = Min_DefaultValue = null;
			Value = Value_DefaultValue = null;
			Within = Within_DefaultValue = SplineSeriesSonificationContextTracksMappingFrequencyWithin.Chart;
		...
		/// </summary>
		public SplineSeriesSonificationContextTracksMappingFrequencyMapFunction MapFunction { get; set; }
		private SplineSeriesSonificationContextTracksMappingFrequencyMapFunction MapFunction_DefaultValue { get; set; }
		...
		/// </summary>
		public SplineSeriesSonificationContextTracksMappingFrequencyWithin Within { get; set; }
		private SplineSeriesSonificationContextTracksMappingFrequencyWithin Within_DefaultValue { get; set; }
