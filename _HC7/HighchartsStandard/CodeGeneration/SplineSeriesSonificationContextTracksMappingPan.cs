...
{
	public partial class SplineSeriesSonificationContextTracksMappingPan  : BaseObject
	{
		Hashtable h = new Hashtable();

		public SplineSeriesSonificationContextTracksMappingPan()
		{
			MapFunction = MapFunction_DefaultValue = SplineSeriesSonificationContextTracksMappingPanMapFunction.Linear;
			MapTo = MapTo_DefaultValue = "";
			Max = Max_DefaultValue = null;
			Min = Min_DefaultValue = null;
			Value = Value_DefaultValue = null;
			Within = Within_DefaultValue = SplineSeriesSonificationContextTracksMappingPanWithin.Chart;
		...
		/// </summary>
		public SplineSeriesSonificationContextTracksMappingPanMapFunction MapFunction { get; set; }
		private SplineSeriesSonificationContextTracksMappingPanMapFunction MapFunction_DefaultValue { get; set; }
		...
		/// </summary>
		public SplineSeriesSonificationContextTracksMappingPanWithin Within { get; set; }
		private SplineSeriesSonificationContextTracksMappingPanWithin Within_DefaultValue { get; set; }
