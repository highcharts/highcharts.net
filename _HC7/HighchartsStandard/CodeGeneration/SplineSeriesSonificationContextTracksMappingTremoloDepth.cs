...
{
	public partial class SplineSeriesSonificationContextTracksMappingTremoloDepth  : BaseObject
	{
		Hashtable h = new Hashtable();

		public SplineSeriesSonificationContextTracksMappingTremoloDepth()
		{
			MapFunction = MapFunction_DefaultValue = SplineSeriesSonificationContextTracksMappingTremoloDepthMapFunction.Linear;
			MapTo = MapTo_DefaultValue = "";
			Max = Max_DefaultValue = null;
			Min = Min_DefaultValue = null;
			Value = Value_DefaultValue = null;
			Within = Within_DefaultValue = SplineSeriesSonificationContextTracksMappingTremoloDepthWithin.Chart;
		...
		/// </summary>
		public SplineSeriesSonificationContextTracksMappingTremoloDepthMapFunction MapFunction { get; set; }
		private SplineSeriesSonificationContextTracksMappingTremoloDepthMapFunction MapFunction_DefaultValue { get; set; }
		...
		/// </summary>
		public SplineSeriesSonificationContextTracksMappingTremoloDepthWithin Within { get; set; }
		private SplineSeriesSonificationContextTracksMappingTremoloDepthWithin Within_DefaultValue { get; set; }
