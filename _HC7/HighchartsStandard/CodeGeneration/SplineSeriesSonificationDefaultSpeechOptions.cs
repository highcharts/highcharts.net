...
{
	public partial class SplineSeriesSonificationDefaultSpeechOptions  : BaseObject
	{
		Hashtable h = new Hashtable();

		public SplineSeriesSonificationDefaultSpeechOptions()
		{
			ActiveWhen = ActiveWhen_DefaultValue = new SplineSeriesSonificationDefaultSpeechOptionsActiveWhen();
			Language = Language_DefaultValue = "en-US";
			Mapping = Mapping_DefaultValue = new SplineSeriesSonificationDefaultSpeechOptionsMapping();
			PointGrouping = PointGrouping_DefaultValue = new SplineSeriesSonificationDefaultSpeechOptionsPointGrouping();
			PreferredVoice = PreferredVoice_DefaultValue = "";
			ShowPlayMarker = ShowPlayMarker_DefaultValue = true;
			Type = Type_DefaultValue = SplineSeriesSonificationDefaultSpeechOptionsType.Instrument;
		...
		/// </summary>
		public SplineSeriesSonificationDefaultSpeechOptionsActiveWhen ActiveWhen { get; set; }
		private SplineSeriesSonificationDefaultSpeechOptionsActiveWhen ActiveWhen_DefaultValue { get; set; }
		...
		/// </summary>
		public SplineSeriesSonificationDefaultSpeechOptionsMapping Mapping { get; set; }
		private SplineSeriesSonificationDefaultSpeechOptionsMapping Mapping_DefaultValue { get; set; }
		 

		/// <summary>
		/// Options for point grouping, specifically for instrument tracks.
		/// </summary>
		public SplineSeriesSonificationDefaultSpeechOptionsPointGrouping PointGrouping { get; set; }
		private SplineSeriesSonificationDefaultSpeechOptionsPointGrouping PointGrouping_DefaultValue { get; set; }
		...
		/// </summary>
		public SplineSeriesSonificationDefaultSpeechOptionsType Type { get; set; }
		private SplineSeriesSonificationDefaultSpeechOptionsType Type_DefaultValue { get; set; }
