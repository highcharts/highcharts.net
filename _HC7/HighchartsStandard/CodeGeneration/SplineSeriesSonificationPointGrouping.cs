...
{
	public partial class SplineSeriesSonificationPointGrouping  : BaseObject
	{
		Hashtable h = new Hashtable();

		public SplineSeriesSonificationPointGrouping()
		{
		...
		/// </summary>
		public SplineSeriesSonificationPointGroupingAlgorithm Algorithm { get; set; }
		private SplineSeriesSonificationPointGroupingAlgorithm Algorithm_DefaultValue { get; set; }
		...
		internal override Hashtable ToHashtable(Highcharts highcharts)
		{
			...
			if (Algorithm != SplineSeriesSonificationPointGroupingAlgorithm.Null) h.Add("algorithm", highcharts.FirstCharacterToLower(Algorithm.ToString()));
