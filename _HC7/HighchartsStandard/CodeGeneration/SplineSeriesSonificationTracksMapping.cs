...
{
	public partial class SplineSeriesSonificationTracksMapping  : BaseObject
	{
		Hashtable h = new Hashtable();

		public SplineSeriesSonificationTracksMapping()
		{
			Frequency = Frequency_DefaultValue = new SplineSeriesSonificationTracksMappingFrequency();
			GapBetweenNotes = GapBetweenNotes_DefaultValue = new SplineSeriesSonificationTracksMappingGapBetweenNotes();
			Highpass = Highpass_DefaultValue = new SplineSeriesSonificationTracksMappingHighpass();
			Lowpass = Lowpass_DefaultValue = new SplineSeriesSonificationTracksMappingLowpass();
			NoteDuration = NoteDuration_DefaultValue = new SplineSeriesSonificationTracksMappingNoteDuration();
			Pan = Pan_DefaultValue = new SplineSeriesSonificationTracksMappingPan();
			Pitch = Pitch_DefaultValue = new SplineSeriesSonificationTracksMappingPitch();
			PitchString = PitchString_DefaultValue = "null";
			PitchNumber = PitchNumber_DefaultValue = null;
			PlayDelay = PlayDelay_DefaultValue = new SplineSeriesSonificationTracksMappingPlayDelay();
			Time = Time_DefaultValue = new SplineSeriesSonificationTracksMappingTime();
			TimeString = TimeString_DefaultValue = "null";
			TimeNumber = TimeNumber_DefaultValue = null;
			Tremolo = Tremolo_DefaultValue = new SplineSeriesSonificationTracksMappingTremolo();
			Volume = Volume_DefaultValue = new SplineSeriesSonificationTracksMappingVolume();
		...
		/// </summary>
		public SplineSeriesSonificationTracksMappingFrequency Frequency { get; set; }
		private SplineSeriesSonificationTracksMappingFrequency Frequency_DefaultValue { get; set; }
		...
		/// </summary>
		public SplineSeriesSonificationTracksMappingGapBetweenNotes GapBetweenNotes { get; set; }
		private SplineSeriesSonificationTracksMappingGapBetweenNotes GapBetweenNotes_DefaultValue { get; set; }
		...
		/// </summary>
		public SplineSeriesSonificationTracksMappingHighpass Highpass { get; set; }
		private SplineSeriesSonificationTracksMappingHighpass Highpass_DefaultValue { get; set; }
		...
		/// </summary>
		public SplineSeriesSonificationTracksMappingLowpass Lowpass { get; set; }
		private SplineSeriesSonificationTracksMappingLowpass Lowpass_DefaultValue { get; set; }
		...
		/// </summary>
		public SplineSeriesSonificationTracksMappingNoteDuration NoteDuration { get; set; }
		private SplineSeriesSonificationTracksMappingNoteDuration NoteDuration_DefaultValue { get; set; }
		...
		/// </summary>
		public SplineSeriesSonificationTracksMappingPan Pan { get; set; }
		private SplineSeriesSonificationTracksMappingPan Pan_DefaultValue { get; set; }
		...
		/// </summary>
		public SplineSeriesSonificationTracksMappingPitch Pitch { get; set; }
		private SplineSeriesSonificationTracksMappingPitch Pitch_DefaultValue { get; set; }
		...
		/// </summary>
		public SplineSeriesSonificationTracksMappingPlayDelay PlayDelay { get; set; }
		private SplineSeriesSonificationTracksMappingPlayDelay PlayDelay_DefaultValue { get; set; }
		...
		/// </summary>
		public SplineSeriesSonificationTracksMappingTime Time { get; set; }
		private SplineSeriesSonificationTracksMappingTime Time_DefaultValue { get; set; }
		...
		/// </summary>
		public SplineSeriesSonificationTracksMappingTremolo Tremolo { get; set; }
		private SplineSeriesSonificationTracksMappingTremolo Tremolo_DefaultValue { get; set; }
		 

		/// <summary>
		/// The volume of notes, from 0 to 1.
		/// </summary>
		public SplineSeriesSonificationTracksMappingVolume Volume { get; set; }
		private SplineSeriesSonificationTracksMappingVolume Volume_DefaultValue { get; set; }
