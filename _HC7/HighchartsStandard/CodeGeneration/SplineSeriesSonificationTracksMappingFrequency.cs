...
{
	public partial class SplineSeriesSonificationTracksMappingFrequency  : BaseObject
	{
		Hashtable h = new Hashtable();

		public SplineSeriesSonificationTracksMappingFrequency()
		{
			MapFunction = MapFunction_DefaultValue = SplineSeriesSonificationTracksMappingFrequencyMapFunction.Linear;
			MapTo = MapTo_DefaultValue = "";
			Max = Max_DefaultValue = null;
			Min = Min_DefaultValue = null;
			Value = Value_DefaultValue = null;
			Within = Within_DefaultValue = SplineSeriesSonificationTracksMappingFrequencyWithin.Chart;
		...
		/// </summary>
		public SplineSeriesSonificationTracksMappingFrequencyMapFunction MapFunction { get; set; }
		private SplineSeriesSonificationTracksMappingFrequencyMapFunction MapFunction_DefaultValue { get; set; }
		...
		/// </summary>
		public SplineSeriesSonificationTracksMappingFrequencyWithin Within { get; set; }
		private SplineSeriesSonificationTracksMappingFrequencyWithin Within_DefaultValue { get; set; }
