...
{
	public partial class SplineSeriesSonificationTracksMappingHighpassResonance  : BaseObject
	{
		Hashtable h = new Hashtable();

		public SplineSeriesSonificationTracksMappingHighpassResonance()
		{
			MapFunction = MapFunction_DefaultValue = SplineSeriesSonificationTracksMappingHighpassResonanceMapFunction.Linear;
			MapTo = MapTo_DefaultValue = "";
			Max = Max_DefaultValue = null;
			Min = Min_DefaultValue = null;
			Value = Value_DefaultValue = null;
			Within = Within_DefaultValue = SplineSeriesSonificationTracksMappingHighpassResonanceWithin.Chart;
		...
		/// </summary>
		public SplineSeriesSonificationTracksMappingHighpassResonanceMapFunction MapFunction { get; set; }
		private SplineSeriesSonificationTracksMappingHighpassResonanceMapFunction MapFunction_DefaultValue { get; set; }
		...
		/// </summary>
		public SplineSeriesSonificationTracksMappingHighpassResonanceWithin Within { get; set; }
		private SplineSeriesSonificationTracksMappingHighpassResonanceWithin Within_DefaultValue { get; set; }
