...
{
	public partial class SplineSeriesSonificationTracksMappingLowpassResonance  : BaseObject
	{
		Hashtable h = new Hashtable();

		public SplineSeriesSonificationTracksMappingLowpassResonance()
		{
			MapFunction = MapFunction_DefaultValue = SplineSeriesSonificationTracksMappingLowpassResonanceMapFunction.Linear;
			MapTo = MapTo_DefaultValue = "";
			Max = Max_DefaultValue = null;
			Min = Min_DefaultValue = null;
			Value = Value_DefaultValue = null;
			Within = Within_DefaultValue = SplineSeriesSonificationTracksMappingLowpassResonanceWithin.Chart;
		...
		/// </summary>
		public SplineSeriesSonificationTracksMappingLowpassResonanceMapFunction MapFunction { get; set; }
		private SplineSeriesSonificationTracksMappingLowpassResonanceMapFunction MapFunction_DefaultValue { get; set; }
		...
		/// </summary>
		public SplineSeriesSonificationTracksMappingLowpassResonanceWithin Within { get; set; }
		private SplineSeriesSonificationTracksMappingLowpassResonanceWithin Within_DefaultValue { get; set; }
