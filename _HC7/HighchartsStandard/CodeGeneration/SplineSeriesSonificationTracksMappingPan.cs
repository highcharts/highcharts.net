...
{
	public partial class SplineSeriesSonificationTracksMappingPan  : BaseObject
	{
		Hashtable h = new Hashtable();

		public SplineSeriesSonificationTracksMappingPan()
		{
			MapFunction = MapFunction_DefaultValue = SplineSeriesSonificationTracksMappingPanMapFunction.Linear;
			MapTo = MapTo_DefaultValue = "";
			Max = Max_DefaultValue = null;
			Min = Min_DefaultValue = null;
			Value = Value_DefaultValue = null;
			Within = Within_DefaultValue = SplineSeriesSonificationTracksMappingPanWithin.Chart;
		...
		/// </summary>
		public SplineSeriesSonificationTracksMappingPanMapFunction MapFunction { get; set; }
		private SplineSeriesSonificationTracksMappingPanMapFunction MapFunction_DefaultValue { get; set; }
		...
		/// </summary>
		public SplineSeriesSonificationTracksMappingPanWithin Within { get; set; }
		private SplineSeriesSonificationTracksMappingPanWithin Within_DefaultValue { get; set; }
