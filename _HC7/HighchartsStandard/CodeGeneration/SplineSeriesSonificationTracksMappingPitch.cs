...
{
	public partial class SplineSeriesSonificationTracksMappingPitch  : BaseObject
	{
		Hashtable h = new Hashtable();

		public SplineSeriesSonificationTracksMappingPitch()
		{
			MapFunction = MapFunction_DefaultValue = SplineSeriesSonificationTracksMappingPitchMapFunction.Linear;
		...
		/// </summary>
		public SplineSeriesSonificationTracksMappingPitchMapFunction MapFunction { get; set; }
		private SplineSeriesSonificationTracksMappingPitchMapFunction MapFunction_DefaultValue { get; set; }
