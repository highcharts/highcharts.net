...
{
	public partial class SplineSeriesSonificationTracksMappingPlayDelay  : BaseObject
	{
		Hashtable h = new Hashtable();

		public SplineSeriesSonificationTracksMappingPlayDelay()
		{
			MapFunction = MapFunction_DefaultValue = SplineSeriesSonificationTracksMappingPlayDelayMapFunction.Linear;
			MapTo = MapTo_DefaultValue = "";
			Max = Max_DefaultValue = null;
			Min = Min_DefaultValue = null;
			Value = Value_DefaultValue = null;
			Within = Within_DefaultValue = SplineSeriesSonificationTracksMappingPlayDelayWithin.Chart;
		...
		/// </summary>
		public SplineSeriesSonificationTracksMappingPlayDelayMapFunction MapFunction { get; set; }
		private SplineSeriesSonificationTracksMappingPlayDelayMapFunction MapFunction_DefaultValue { get; set; }
		...
		/// </summary>
		public SplineSeriesSonificationTracksMappingPlayDelayWithin Within { get; set; }
		private SplineSeriesSonificationTracksMappingPlayDelayWithin Within_DefaultValue { get; set; }
