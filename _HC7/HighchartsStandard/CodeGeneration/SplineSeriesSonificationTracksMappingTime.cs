...
{
	public partial class SplineSeriesSonificationTracksMappingTime  : BaseObject
	{
		Hashtable h = new Hashtable();

		public SplineSeriesSonificationTracksMappingTime()
		{
			MapFunction = MapFunction_DefaultValue = SplineSeriesSonificationTracksMappingTimeMapFunction.Linear;
			MapTo = MapTo_DefaultValue = "";
			Max = Max_DefaultValue = null;
			Min = Min_DefaultValue = null;
			Value = Value_DefaultValue = null;
			Within = Within_DefaultValue = SplineSeriesSonificationTracksMappingTimeWithin.Chart;
		...
		/// </summary>
		public SplineSeriesSonificationTracksMappingTimeMapFunction MapFunction { get; set; }
		private SplineSeriesSonificationTracksMappingTimeMapFunction MapFunction_DefaultValue { get; set; }
		...
		/// </summary>
		public SplineSeriesSonificationTracksMappingTimeWithin Within { get; set; }
		private SplineSeriesSonificationTracksMappingTimeWithin Within_DefaultValue { get; set; }
