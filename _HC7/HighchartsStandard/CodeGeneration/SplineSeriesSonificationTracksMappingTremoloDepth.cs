...
{
	public partial class SplineSeriesSonificationTracksMappingTremoloDepth  : BaseObject
	{
		Hashtable h = new Hashtable();

		public SplineSeriesSonificationTracksMappingTremoloDepth()
		{
			MapFunction = MapFunction_DefaultValue = SplineSeriesSonificationTracksMappingTremoloDepthMapFunction.Linear;
			MapTo = MapTo_DefaultValue = "";
			Max = Max_DefaultValue = null;
			Min = Min_DefaultValue = null;
			Value = Value_DefaultValue = null;
			Within = Within_DefaultValue = SplineSeriesSonificationTracksMappingTremoloDepthWithin.Chart;
		...
		/// </summary>
		public SplineSeriesSonificationTracksMappingTremoloDepthMapFunction MapFunction { get; set; }
		private SplineSeriesSonificationTracksMappingTremoloDepthMapFunction MapFunction_DefaultValue { get; set; }
		...
		/// </summary>
		public SplineSeriesSonificationTracksMappingTremoloDepthWithin Within { get; set; }
		private SplineSeriesSonificationTracksMappingTremoloDepthWithin Within_DefaultValue { get; set; }
