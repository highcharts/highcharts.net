...
{
	public partial class SplineSeriesSonificationTracksMappingVolume  : BaseObject
	{
		Hashtable h = new Hashtable();

		public SplineSeriesSonificationTracksMappingVolume()
		{
			MapFunction = MapFunction_DefaultValue = SplineSeriesSonificationTracksMappingVolumeMapFunction.Linear;
			MapTo = MapTo_DefaultValue = "";
			Max = Max_DefaultValue = null;
			Min = Min_DefaultValue = null;
			Value = Value_DefaultValue = null;
			Within = Within_DefaultValue = SplineSeriesSonificationTracksMappingVolumeWithin.Chart;
		...
		/// </summary>
		public SplineSeriesSonificationTracksMappingVolumeMapFunction MapFunction { get; set; }
		private SplineSeriesSonificationTracksMappingVolumeMapFunction MapFunction_DefaultValue { get; set; }
		...
		/// </summary>
		public SplineSeriesSonificationTracksMappingVolumeWithin Within { get; set; }
		private SplineSeriesSonificationTracksMappingVolumeWithin Within_DefaultValue { get; set; }
