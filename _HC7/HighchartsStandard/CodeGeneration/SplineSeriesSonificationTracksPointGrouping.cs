...
{
	public partial class SplineSeriesSonificationTracksPointGrouping  : BaseObject
	{
		Hashtable h = new Hashtable();

		public SplineSeriesSonificationTracksPointGrouping()
		{
		...
		/// </summary>
		public SplineSeriesSonificationTracksPointGroupingAlgorithm Algorithm { get; set; }
		private SplineSeriesSonificationTracksPointGroupingAlgorithm Algorithm_DefaultValue { get; set; }
		...
		internal override Hashtable ToHashtable(Highcharts highcharts)
		{
			...
			if (Algorithm != SplineSeriesSonificationTracksPointGroupingAlgorithm.Null) h.Add("algorithm", highcharts.FirstCharacterToLower(Algorithm.ToString()));
