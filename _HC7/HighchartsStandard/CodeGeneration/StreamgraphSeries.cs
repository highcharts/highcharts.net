...
namespace Highsoft.Web.Mvc.Charts
{
	public partial class StreamgraphSeries  : Series
	{
		...
		internal override Hashtable ToHashtable()
		{
			...
			if (PointDescriptionFormatter != PointDescriptionFormatter_DefaultValue) { h.Add("pointDescriptionFormatter",PointDescriptionFormatter); Highcharts.AddFunction("423f9e97-2a4b-435e-b16b-6d2fdbe54a0e.pointDescriptionFormatter", PointDescriptionFormatter); }  
