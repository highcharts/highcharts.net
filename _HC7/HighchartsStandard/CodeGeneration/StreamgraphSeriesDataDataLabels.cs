...
{
	public partial class StreamgraphSeriesDataDataLabels  : BaseObject
	{
		Hashtable h = new Hashtable();

		public StreamgraphSeriesDataDataLabels()
		{
		...
		/// </summary>
		public StreamgraphSeriesDataDataLabelsAlign Align { get; set; }
		private StreamgraphSeriesDataDataLabelsAlign Align_DefaultValue { get; set; }
		...
		/// </summary>
		public StreamgraphSeriesDataDataLabelsFilter Filter { get; set; }
		private StreamgraphSeriesDataDataLabelsFilter Filter_DefaultValue { get; set; }
		...
		/// </summary>
		public StreamgraphSeriesDataDataLabelsOverflow Overflow { get; set; }
		private StreamgraphSeriesDataDataLabelsOverflow Overflow_DefaultValue { get; set; }
		...
		/// </summary>
		public StreamgraphSeriesDataDataLabelsPosition Position { get; set; }
		private StreamgraphSeriesDataDataLabelsPosition Position_DefaultValue { get; set; }
		...
		/// </summary>
		public StreamgraphSeriesDataDataLabelsTextPath TextPath { get; set; }
		private StreamgraphSeriesDataDataLabelsTextPath TextPath_DefaultValue { get; set; }
		...
		/// </summary>
		public StreamgraphSeriesDataDataLabelsVerticalAlign VerticalAlign { get; set; }
		private StreamgraphSeriesDataDataLabelsVerticalAlign VerticalAlign_DefaultValue { get; set; }
		...
		internal override Hashtable ToHashtable(Highcharts highcharts)
		{
			...
			if (Align != StreamgraphSeriesDataDataLabelsAlign.Null) h.Add("align", highcharts.FirstCharacterToLower(Align.ToString()));
			...
			if (Overflow != StreamgraphSeriesDataDataLabelsOverflow.Null) h.Add("overflow", highcharts.FirstCharacterToLower(Overflow.ToString()));
			if (Padding != null) h.Add("padding",Padding);
			if (Position != StreamgraphSeriesDataDataLabelsPosition.Null) h.Add("position", highcharts.FirstCharacterToLower(Position.ToString()));
			...
			if (VerticalAlign != StreamgraphSeriesDataDataLabelsVerticalAlign.Null) h.Add("verticalAlign", highcharts.FirstCharacterToLower(VerticalAlign.ToString()));
			if (X != null) h.Add("x",X);
			if (Y != null) h.Add("y",Y);
