...
{
	public partial class StreamgraphSeriesDragDrop  : BaseObject
	{
		public StreamgraphSeriesDragDrop()
		{
			DraggableX = DraggableX_DefaultValue = null;
			DraggableY = DraggableY_DefaultValue = null;
			DragHandle = DragHandle_DefaultValue = new StreamgraphSeriesDragDropDragHandle();
			...
			GuideBox = GuideBox_DefaultValue = new StreamgraphSeriesDragDropGuideBox();
		...
		/// </summary>
		public StreamgraphSeriesDragDropDragHandle DragHandle { get; set; }
		private StreamgraphSeriesDragDropDragHandle DragHandle_DefaultValue { get; set; }
		...
		/// </summary>
		public StreamgraphSeriesDragDropGuideBox GuideBox { get; set; }
		private StreamgraphSeriesDragDropGuideBox GuideBox_DefaultValue { get; set; }
