...
{
	public partial class StreamgraphSeriesSonificationContextTracksMapping  : BaseObject
	{
		Hashtable h = new Hashtable();

		public StreamgraphSeriesSonificationContextTracksMapping()
		{
			Frequency = Frequency_DefaultValue = new StreamgraphSeriesSonificationContextTracksMappingFrequency();
			GapBetweenNotes = GapBetweenNotes_DefaultValue = new StreamgraphSeriesSonificationContextTracksMappingGapBetweenNotes();
			Highpass = Highpass_DefaultValue = new StreamgraphSeriesSonificationContextTracksMappingHighpass();
			Lowpass = Lowpass_DefaultValue = new StreamgraphSeriesSonificationContextTracksMappingLowpass();
			NoteDuration = NoteDuration_DefaultValue = new StreamgraphSeriesSonificationContextTracksMappingNoteDuration();
			Pan = Pan_DefaultValue = new StreamgraphSeriesSonificationContextTracksMappingPan();
			Pitch = Pitch_DefaultValue = new StreamgraphSeriesSonificationContextTracksMappingPitch();
			PitchString = PitchString_DefaultValue = "null";
			PitchNumber = PitchNumber_DefaultValue = null;
			PlayDelay = PlayDelay_DefaultValue = new StreamgraphSeriesSonificationContextTracksMappingPlayDelay();
			Time = Time_DefaultValue = new StreamgraphSeriesSonificationContextTracksMappingTime();
			TimeString = TimeString_DefaultValue = "null";
			TimeNumber = TimeNumber_DefaultValue = null;
			Tremolo = Tremolo_DefaultValue = new StreamgraphSeriesSonificationContextTracksMappingTremolo();
			Volume = Volume_DefaultValue = new StreamgraphSeriesSonificationContextTracksMappingVolume();
		...
		/// </summary>
		public StreamgraphSeriesSonificationContextTracksMappingFrequency Frequency { get; set; }
		private StreamgraphSeriesSonificationContextTracksMappingFrequency Frequency_DefaultValue { get; set; }
		...
		/// </summary>
		public StreamgraphSeriesSonificationContextTracksMappingGapBetweenNotes GapBetweenNotes { get; set; }
		private StreamgraphSeriesSonificationContextTracksMappingGapBetweenNotes GapBetweenNotes_DefaultValue { get; set; }
		...
		/// </summary>
		public StreamgraphSeriesSonificationContextTracksMappingHighpass Highpass { get; set; }
		private StreamgraphSeriesSonificationContextTracksMappingHighpass Highpass_DefaultValue { get; set; }
		...
		/// </summary>
		public StreamgraphSeriesSonificationContextTracksMappingLowpass Lowpass { get; set; }
		private StreamgraphSeriesSonificationContextTracksMappingLowpass Lowpass_DefaultValue { get; set; }
		...
		/// </summary>
		public StreamgraphSeriesSonificationContextTracksMappingNoteDuration NoteDuration { get; set; }
		private StreamgraphSeriesSonificationContextTracksMappingNoteDuration NoteDuration_DefaultValue { get; set; }
		...
		/// </summary>
		public StreamgraphSeriesSonificationContextTracksMappingPan Pan { get; set; }
		private StreamgraphSeriesSonificationContextTracksMappingPan Pan_DefaultValue { get; set; }
		...
		/// </summary>
		public StreamgraphSeriesSonificationContextTracksMappingPitch Pitch { get; set; }
		private StreamgraphSeriesSonificationContextTracksMappingPitch Pitch_DefaultValue { get; set; }
		...
		/// </summary>
		public StreamgraphSeriesSonificationContextTracksMappingPlayDelay PlayDelay { get; set; }
		private StreamgraphSeriesSonificationContextTracksMappingPlayDelay PlayDelay_DefaultValue { get; set; }
		...
		/// </summary>
		public StreamgraphSeriesSonificationContextTracksMappingTime Time { get; set; }
		private StreamgraphSeriesSonificationContextTracksMappingTime Time_DefaultValue { get; set; }
		...
		/// </summary>
		public StreamgraphSeriesSonificationContextTracksMappingTremolo Tremolo { get; set; }
		private StreamgraphSeriesSonificationContextTracksMappingTremolo Tremolo_DefaultValue { get; set; }
		 

		/// <summary>
		/// The volume of notes, from 0 to 1.
		/// </summary>
		public StreamgraphSeriesSonificationContextTracksMappingVolume Volume { get; set; }
		private StreamgraphSeriesSonificationContextTracksMappingVolume Volume_DefaultValue { get; set; }
