...
{
	public partial class StreamgraphSeriesSonificationContextTracksMappingPan  : BaseObject
	{
		Hashtable h = new Hashtable();

		public StreamgraphSeriesSonificationContextTracksMappingPan()
		{
			MapFunction = MapFunction_DefaultValue = StreamgraphSeriesSonificationContextTracksMappingPanMapFunction.Linear;
			MapTo = MapTo_DefaultValue = "";
			Max = Max_DefaultValue = null;
			Min = Min_DefaultValue = null;
			Value = Value_DefaultValue = null;
			Within = Within_DefaultValue = StreamgraphSeriesSonificationContextTracksMappingPanWithin.Chart;
		...
		/// </summary>
		public StreamgraphSeriesSonificationContextTracksMappingPanMapFunction MapFunction { get; set; }
		private StreamgraphSeriesSonificationContextTracksMappingPanMapFunction MapFunction_DefaultValue { get; set; }
		...
		/// </summary>
		public StreamgraphSeriesSonificationContextTracksMappingPanWithin Within { get; set; }
		private StreamgraphSeriesSonificationContextTracksMappingPanWithin Within_DefaultValue { get; set; }
