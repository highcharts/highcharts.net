...
{
	public partial class StreamgraphSeriesSonificationContextTracksMappingPitch  : BaseObject
	{
		Hashtable h = new Hashtable();

		public StreamgraphSeriesSonificationContextTracksMappingPitch()
		{
			MapFunction = MapFunction_DefaultValue = StreamgraphSeriesSonificationContextTracksMappingPitchMapFunction.Linear;
		...
		/// </summary>
		public StreamgraphSeriesSonificationContextTracksMappingPitchMapFunction MapFunction { get; set; }
		private StreamgraphSeriesSonificationContextTracksMappingPitchMapFunction MapFunction_DefaultValue { get; set; }
