...
{
	public partial class StreamgraphSeriesSonificationContextTracksMappingPlayDelay  : BaseObject
	{
		Hashtable h = new Hashtable();

		public StreamgraphSeriesSonificationContextTracksMappingPlayDelay()
		{
			MapFunction = MapFunction_DefaultValue = StreamgraphSeriesSonificationContextTracksMappingPlayDelayMapFunction.Linear;
			MapTo = MapTo_DefaultValue = "";
			Max = Max_DefaultValue = null;
			Min = Min_DefaultValue = null;
			Value = Value_DefaultValue = null;
			Within = Within_DefaultValue = StreamgraphSeriesSonificationContextTracksMappingPlayDelayWithin.Chart;
		...
		/// </summary>
		public StreamgraphSeriesSonificationContextTracksMappingPlayDelayMapFunction MapFunction { get; set; }
		private StreamgraphSeriesSonificationContextTracksMappingPlayDelayMapFunction MapFunction_DefaultValue { get; set; }
		...
		/// </summary>
		public StreamgraphSeriesSonificationContextTracksMappingPlayDelayWithin Within { get; set; }
		private StreamgraphSeriesSonificationContextTracksMappingPlayDelayWithin Within_DefaultValue { get; set; }
