...
{
	public partial class StreamgraphSeriesSonificationContextTracksMappingVolume  : BaseObject
	{
		Hashtable h = new Hashtable();

		public StreamgraphSeriesSonificationContextTracksMappingVolume()
		{
			MapFunction = MapFunction_DefaultValue = StreamgraphSeriesSonificationContextTracksMappingVolumeMapFunction.Linear;
			MapTo = MapTo_DefaultValue = "";
			Max = Max_DefaultValue = null;
			Min = Min_DefaultValue = null;
			Value = Value_DefaultValue = null;
			Within = Within_DefaultValue = StreamgraphSeriesSonificationContextTracksMappingVolumeWithin.Chart;
		...
		/// </summary>
		public StreamgraphSeriesSonificationContextTracksMappingVolumeMapFunction MapFunction { get; set; }
		private StreamgraphSeriesSonificationContextTracksMappingVolumeMapFunction MapFunction_DefaultValue { get; set; }
		...
		/// </summary>
		public StreamgraphSeriesSonificationContextTracksMappingVolumeWithin Within { get; set; }
		private StreamgraphSeriesSonificationContextTracksMappingVolumeWithin Within_DefaultValue { get; set; }
