...
{
	public partial class StreamgraphSeriesSonificationContextTracksPointGrouping  : BaseObject
	{
		Hashtable h = new Hashtable();

		public StreamgraphSeriesSonificationContextTracksPointGrouping()
		{
		...
		/// </summary>
		public StreamgraphSeriesSonificationContextTracksPointGroupingAlgorithm Algorithm { get; set; }
		private StreamgraphSeriesSonificationContextTracksPointGroupingAlgorithm Algorithm_DefaultValue { get; set; }
		...
		internal override Hashtable ToHashtable(Highcharts highcharts)
		{
			...
			if (Algorithm != StreamgraphSeriesSonificationContextTracksPointGroupingAlgorithm.Null) h.Add("algorithm", highcharts.FirstCharacterToLower(Algorithm.ToString()));
