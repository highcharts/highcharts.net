...
{
	public partial class StreamgraphSeriesSonificationDefaultInstrumentOptions  : BaseObject
	{
		Hashtable h = new Hashtable();

		public StreamgraphSeriesSonificationDefaultInstrumentOptions()
		{
			ActiveWhen = ActiveWhen_DefaultValue = new StreamgraphSeriesSonificationDefaultInstrumentOptionsActiveWhen();
			Instrument = Instrument_DefaultValue = null;
			InstrumentString = InstrumentString_DefaultValue = "null";
			Mapping = Mapping_DefaultValue = new StreamgraphSeriesSonificationDefaultInstrumentOptionsMapping();
			MidiName = MidiName_DefaultValue = "";
			PointGrouping = PointGrouping_DefaultValue = new StreamgraphSeriesSonificationDefaultInstrumentOptionsPointGrouping();
			RoundToMusicalNotes = RoundToMusicalNotes_DefaultValue = true;
			ShowPlayMarker = ShowPlayMarker_DefaultValue = true;
			Type = Type_DefaultValue = StreamgraphSeriesSonificationDefaultInstrumentOptionsType.Instrument;
		...
		/// </summary>
		public StreamgraphSeriesSonificationDefaultInstrumentOptionsActiveWhen ActiveWhen { get; set; }
		private StreamgraphSeriesSonificationDefaultInstrumentOptionsActiveWhen ActiveWhen_DefaultValue { get; set; }
		...
		/// </summary>
		public StreamgraphSeriesSonificationDefaultInstrumentOptionsMapping Mapping { get; set; }
		private StreamgraphSeriesSonificationDefaultInstrumentOptionsMapping Mapping_DefaultValue { get; set; }
		...
		/// </summary>
		public StreamgraphSeriesSonificationDefaultInstrumentOptionsPointGrouping PointGrouping { get; set; }
		private StreamgraphSeriesSonificationDefaultInstrumentOptionsPointGrouping PointGrouping_DefaultValue { get; set; }
		...
		/// </summary>
		public StreamgraphSeriesSonificationDefaultInstrumentOptionsType Type { get; set; }
		private StreamgraphSeriesSonificationDefaultInstrumentOptionsType Type_DefaultValue { get; set; }
