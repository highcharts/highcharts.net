...
{
	public partial class StreamgraphSeriesSonificationPointGrouping  : BaseObject
	{
		Hashtable h = new Hashtable();

		public StreamgraphSeriesSonificationPointGrouping()
		{
		...
		/// </summary>
		public StreamgraphSeriesSonificationPointGroupingAlgorithm Algorithm { get; set; }
		private StreamgraphSeriesSonificationPointGroupingAlgorithm Algorithm_DefaultValue { get; set; }
		...
		internal override Hashtable ToHashtable(Highcharts highcharts)
		{
			...
			if (Algorithm != StreamgraphSeriesSonificationPointGroupingAlgorithm.Null) h.Add("algorithm", highcharts.FirstCharacterToLower(Algorithm.ToString()));
