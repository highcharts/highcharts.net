...
{
	public partial class StreamgraphSeriesSonificationTracksMapping  : BaseObject
	{
		Hashtable h = new Hashtable();

		public StreamgraphSeriesSonificationTracksMapping()
		{
			Frequency = Frequency_DefaultValue = new StreamgraphSeriesSonificationTracksMappingFrequency();
			GapBetweenNotes = GapBetweenNotes_DefaultValue = new StreamgraphSeriesSonificationTracksMappingGapBetweenNotes();
			Highpass = Highpass_DefaultValue = new StreamgraphSeriesSonificationTracksMappingHighpass();
			Lowpass = Lowpass_DefaultValue = new StreamgraphSeriesSonificationTracksMappingLowpass();
			NoteDuration = NoteDuration_DefaultValue = new StreamgraphSeriesSonificationTracksMappingNoteDuration();
			Pan = Pan_DefaultValue = new StreamgraphSeriesSonificationTracksMappingPan();
			Pitch = Pitch_DefaultValue = new StreamgraphSeriesSonificationTracksMappingPitch();
			PitchString = PitchString_DefaultValue = "null";
			PitchNumber = PitchNumber_DefaultValue = null;
			PlayDelay = PlayDelay_DefaultValue = new StreamgraphSeriesSonificationTracksMappingPlayDelay();
			Time = Time_DefaultValue = new StreamgraphSeriesSonificationTracksMappingTime();
			TimeString = TimeString_DefaultValue = "null";
			TimeNumber = TimeNumber_DefaultValue = null;
			Tremolo = Tremolo_DefaultValue = new StreamgraphSeriesSonificationTracksMappingTremolo();
			Volume = Volume_DefaultValue = new StreamgraphSeriesSonificationTracksMappingVolume();
		...
		/// </summary>
		public StreamgraphSeriesSonificationTracksMappingFrequency Frequency { get; set; }
		private StreamgraphSeriesSonificationTracksMappingFrequency Frequency_DefaultValue { get; set; }
		...
		/// </summary>
		public StreamgraphSeriesSonificationTracksMappingGapBetweenNotes GapBetweenNotes { get; set; }
		private StreamgraphSeriesSonificationTracksMappingGapBetweenNotes GapBetweenNotes_DefaultValue { get; set; }
		...
		/// </summary>
		public StreamgraphSeriesSonificationTracksMappingHighpass Highpass { get; set; }
		private StreamgraphSeriesSonificationTracksMappingHighpass Highpass_DefaultValue { get; set; }
		...
		/// </summary>
		public StreamgraphSeriesSonificationTracksMappingLowpass Lowpass { get; set; }
		private StreamgraphSeriesSonificationTracksMappingLowpass Lowpass_DefaultValue { get; set; }
		...
		/// </summary>
		public StreamgraphSeriesSonificationTracksMappingNoteDuration NoteDuration { get; set; }
		private StreamgraphSeriesSonificationTracksMappingNoteDuration NoteDuration_DefaultValue { get; set; }
		...
		/// </summary>
		public StreamgraphSeriesSonificationTracksMappingPan Pan { get; set; }
		private StreamgraphSeriesSonificationTracksMappingPan Pan_DefaultValue { get; set; }
		...
		/// </summary>
		public StreamgraphSeriesSonificationTracksMappingPitch Pitch { get; set; }
		private StreamgraphSeriesSonificationTracksMappingPitch Pitch_DefaultValue { get; set; }
		...
		/// </summary>
		public StreamgraphSeriesSonificationTracksMappingPlayDelay PlayDelay { get; set; }
		private StreamgraphSeriesSonificationTracksMappingPlayDelay PlayDelay_DefaultValue { get; set; }
		...
		/// </summary>
		public StreamgraphSeriesSonificationTracksMappingTime Time { get; set; }
		private StreamgraphSeriesSonificationTracksMappingTime Time_DefaultValue { get; set; }
		...
		/// </summary>
		public StreamgraphSeriesSonificationTracksMappingTremolo Tremolo { get; set; }
		private StreamgraphSeriesSonificationTracksMappingTremolo Tremolo_DefaultValue { get; set; }
		 

		/// <summary>
		/// The volume of notes, from 0 to 1.
		/// </summary>
		public StreamgraphSeriesSonificationTracksMappingVolume Volume { get; set; }
		private StreamgraphSeriesSonificationTracksMappingVolume Volume_DefaultValue { get; set; }
