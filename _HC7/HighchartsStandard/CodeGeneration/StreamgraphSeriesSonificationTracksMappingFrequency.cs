...
{
	public partial class StreamgraphSeriesSonificationTracksMappingFrequency  : BaseObject
	{
		Hashtable h = new Hashtable();

		public StreamgraphSeriesSonificationTracksMappingFrequency()
		{
			MapFunction = MapFunction_DefaultValue = StreamgraphSeriesSonificationTracksMappingFrequencyMapFunction.Linear;
			MapTo = MapTo_DefaultValue = "";
			Max = Max_DefaultValue = null;
			Min = Min_DefaultValue = null;
			Value = Value_DefaultValue = null;
			Within = Within_DefaultValue = StreamgraphSeriesSonificationTracksMappingFrequencyWithin.Chart;
		...
		/// </summary>
		public StreamgraphSeriesSonificationTracksMappingFrequencyMapFunction MapFunction { get; set; }
		private StreamgraphSeriesSonificationTracksMappingFrequencyMapFunction MapFunction_DefaultValue { get; set; }
		...
		/// </summary>
		public StreamgraphSeriesSonificationTracksMappingFrequencyWithin Within { get; set; }
		private StreamgraphSeriesSonificationTracksMappingFrequencyWithin Within_DefaultValue { get; set; }
