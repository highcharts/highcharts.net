...
{
	public partial class StreamgraphSeriesSonificationTracksMappingPan  : BaseObject
	{
		Hashtable h = new Hashtable();

		public StreamgraphSeriesSonificationTracksMappingPan()
		{
			MapFunction = MapFunction_DefaultValue = StreamgraphSeriesSonificationTracksMappingPanMapFunction.Linear;
			MapTo = MapTo_DefaultValue = "";
			Max = Max_DefaultValue = null;
			Min = Min_DefaultValue = null;
			Value = Value_DefaultValue = null;
			Within = Within_DefaultValue = StreamgraphSeriesSonificationTracksMappingPanWithin.Chart;
		...
		/// </summary>
		public StreamgraphSeriesSonificationTracksMappingPanMapFunction MapFunction { get; set; }
		private StreamgraphSeriesSonificationTracksMappingPanMapFunction MapFunction_DefaultValue { get; set; }
		...
		/// </summary>
		public StreamgraphSeriesSonificationTracksMappingPanWithin Within { get; set; }
		private StreamgraphSeriesSonificationTracksMappingPanWithin Within_DefaultValue { get; set; }
