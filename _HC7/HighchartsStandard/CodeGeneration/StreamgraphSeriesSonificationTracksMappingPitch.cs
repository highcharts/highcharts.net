...
{
	public partial class StreamgraphSeriesSonificationTracksMappingPitch  : BaseObject
	{
		Hashtable h = new Hashtable();

		public StreamgraphSeriesSonificationTracksMappingPitch()
		{
			MapFunction = MapFunction_DefaultValue = StreamgraphSeriesSonificationTracksMappingPitchMapFunction.Linear;
		...
		/// </summary>
		public StreamgraphSeriesSonificationTracksMappingPitchMapFunction MapFunction { get; set; }
		private StreamgraphSeriesSonificationTracksMappingPitchMapFunction MapFunction_DefaultValue { get; set; }
