...
{
	public partial class StreamgraphSeriesSonificationTracksMappingPlayDelay  : BaseObject
	{
		Hashtable h = new Hashtable();

		public StreamgraphSeriesSonificationTracksMappingPlayDelay()
		{
			MapFunction = MapFunction_DefaultValue = StreamgraphSeriesSonificationTracksMappingPlayDelayMapFunction.Linear;
			MapTo = MapTo_DefaultValue = "";
			Max = Max_DefaultValue = null;
			Min = Min_DefaultValue = null;
			Value = Value_DefaultValue = null;
			Within = Within_DefaultValue = StreamgraphSeriesSonificationTracksMappingPlayDelayWithin.Chart;
		...
		/// </summary>
		public StreamgraphSeriesSonificationTracksMappingPlayDelayMapFunction MapFunction { get; set; }
		private StreamgraphSeriesSonificationTracksMappingPlayDelayMapFunction MapFunction_DefaultValue { get; set; }
		...
		/// </summary>
		public StreamgraphSeriesSonificationTracksMappingPlayDelayWithin Within { get; set; }
		private StreamgraphSeriesSonificationTracksMappingPlayDelayWithin Within_DefaultValue { get; set; }
