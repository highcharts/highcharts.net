...
{
	public partial class StreamgraphSeriesSonificationTracksMappingTime  : BaseObject
	{
		Hashtable h = new Hashtable();

		public StreamgraphSeriesSonificationTracksMappingTime()
		{
			MapFunction = MapFunction_DefaultValue = StreamgraphSeriesSonificationTracksMappingTimeMapFunction.Linear;
			MapTo = MapTo_DefaultValue = "";
			Max = Max_DefaultValue = null;
			Min = Min_DefaultValue = null;
			Value = Value_DefaultValue = null;
			Within = Within_DefaultValue = StreamgraphSeriesSonificationTracksMappingTimeWithin.Chart;
		...
		/// </summary>
		public StreamgraphSeriesSonificationTracksMappingTimeMapFunction MapFunction { get; set; }
		private StreamgraphSeriesSonificationTracksMappingTimeMapFunction MapFunction_DefaultValue { get; set; }
		...
		/// </summary>
		public StreamgraphSeriesSonificationTracksMappingTimeWithin Within { get; set; }
		private StreamgraphSeriesSonificationTracksMappingTimeWithin Within_DefaultValue { get; set; }
