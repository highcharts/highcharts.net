...
{
	public partial class StreamgraphSeriesSonificationTracksMappingTremoloSpeed  : BaseObject
	{
		Hashtable h = new Hashtable();

		public StreamgraphSeriesSonificationTracksMappingTremoloSpeed()
		{
			MapFunction = MapFunction_DefaultValue = StreamgraphSeriesSonificationTracksMappingTremoloSpeedMapFunction.Linear;
			MapTo = MapTo_DefaultValue = "";
			Max = Max_DefaultValue = null;
			Min = Min_DefaultValue = null;
			Value = Value_DefaultValue = null;
			Within = Within_DefaultValue = StreamgraphSeriesSonificationTracksMappingTremoloSpeedWithin.Chart;
		...
		/// </summary>
		public StreamgraphSeriesSonificationTracksMappingTremoloSpeedMapFunction MapFunction { get; set; }
		private StreamgraphSeriesSonificationTracksMappingTremoloSpeedMapFunction MapFunction_DefaultValue { get; set; }
		...
		/// </summary>
		public StreamgraphSeriesSonificationTracksMappingTremoloSpeedWithin Within { get; set; }
		private StreamgraphSeriesSonificationTracksMappingTremoloSpeedWithin Within_DefaultValue { get; set; }
