...
{
	public partial class StreamgraphSeriesSonificationTracksMappingVolume  : BaseObject
	{
		Hashtable h = new Hashtable();

		public StreamgraphSeriesSonificationTracksMappingVolume()
		{
			MapFunction = MapFunction_DefaultValue = StreamgraphSeriesSonificationTracksMappingVolumeMapFunction.Linear;
			MapTo = MapTo_DefaultValue = "";
			Max = Max_DefaultValue = null;
			Min = Min_DefaultValue = null;
			Value = Value_DefaultValue = null;
			Within = Within_DefaultValue = StreamgraphSeriesSonificationTracksMappingVolumeWithin.Chart;
		...
		/// </summary>
		public StreamgraphSeriesSonificationTracksMappingVolumeMapFunction MapFunction { get; set; }
		private StreamgraphSeriesSonificationTracksMappingVolumeMapFunction MapFunction_DefaultValue { get; set; }
		...
		/// </summary>
		public StreamgraphSeriesSonificationTracksMappingVolumeWithin Within { get; set; }
		private StreamgraphSeriesSonificationTracksMappingVolumeWithin Within_DefaultValue { get; set; }
