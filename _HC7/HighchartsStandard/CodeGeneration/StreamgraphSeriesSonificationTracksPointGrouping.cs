...
{
	public partial class StreamgraphSeriesSonificationTracksPointGrouping  : BaseObject
	{
		Hashtable h = new Hashtable();

		public StreamgraphSeriesSonificationTracksPointGrouping()
		{
		...
		/// </summary>
		public StreamgraphSeriesSonificationTracksPointGroupingAlgorithm Algorithm { get; set; }
		private StreamgraphSeriesSonificationTracksPointGroupingAlgorithm Algorithm_DefaultValue { get; set; }
		...
		internal override Hashtable ToHashtable(Highcharts highcharts)
		{
			...
			if (Algorithm != StreamgraphSeriesSonificationTracksPointGroupingAlgorithm.Null) h.Add("algorithm", highcharts.FirstCharacterToLower(Algorithm.ToString()));
