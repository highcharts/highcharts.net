...
{
	public partial class StreamgraphSeriesTooltip  : BaseObject
	{
		public StreamgraphSeriesTooltip()
		{
			...
			HeaderShape = HeaderShape_DefaultValue = StreamgraphSeriesTooltipHeaderShape.Callout;
		...
		/// </summary>
		public StreamgraphSeriesTooltipHeaderShape HeaderShape { get; set; }
		private StreamgraphSeriesTooltipHeaderShape HeaderShape_DefaultValue { get; set; }
		...
		internal override Hashtable ToHashtable()
		{
			...
			if (NullFormatter != NullFormatter_DefaultValue) { h.Add("nullFormatter",NullFormatter); Highcharts.AddFunction("StreamgraphSeriesTooltipNullFormatter.nullFormatter", NullFormatter); }  
			if (Outside != Outside_DefaultValue) h.Add("outside",Outside);
			if (Padding != Padding_DefaultValue) h.Add("padding",Padding);
			if (PointFormat != PointFormat_DefaultValue) h.Add("pointFormat",PointFormat);
			if (PointFormatter != PointFormatter_DefaultValue) { h.Add("pointFormatter",PointFormatter); Highcharts.AddFunction("StreamgraphSeriesTooltipPointFormatter.pointFormatter", PointFormatter); }  
