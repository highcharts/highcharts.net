...
namespace Highsoft.Web.Mvc.Charts
{
	public partial class SunburstSeriesData  : BaseObject
	{
		...
		{
			Accessibility = Accessibility_DefaultValue = new SunburstSeriesDataAccessibility();
		...
		/// </summary>
		public SunburstSeriesDataAccessibility Accessibility { get; set; }
		private SunburstSeriesDataAccessibility Accessibility_DefaultValue { get; set; }
		...
		/// </summary>
		public SunburstSeriesDataDragDrop DragDrop { get; set; }
		private SunburstSeriesDataDragDrop DragDrop_DefaultValue { get; set; }
		...
		/// </summary>
		public SunburstSeriesDataMarker Marker { get; set; }
		private SunburstSeriesDataMarker Marker_DefaultValue { get; set; }
