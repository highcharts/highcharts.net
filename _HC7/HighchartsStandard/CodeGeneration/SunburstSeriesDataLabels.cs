...
namespace Highsoft.Web.Mvc.Charts
{
	public partial class SunburstSeriesDataLabels  : BaseObject
	{
		...
		/// </summary>
		public SunburstSeriesDataLabelsPosition Position { get; set; }
		private SunburstSeriesDataLabelsPosition Position_DefaultValue { get; set; }
		...
		/// </summary>
		public SunburstSeriesDataLabelsTextPath TextPath { get; set; }
		private SunburstSeriesDataLabelsTextPath TextPath_DefaultValue { get; set; }
