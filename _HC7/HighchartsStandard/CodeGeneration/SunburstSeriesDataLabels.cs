...
namespace Highsoft.Web.Mvc.Charts
{
	public partial class SunburstSeriesDataLabels  : BaseObject
	{
		...
		{
			Align = Align_DefaultValue = SunburstSeriesDataLabelsAlign.Left;
			...
			VerticalAlign = VerticalAlign_DefaultValue = SunburstSeriesDataLabelsVerticalAlign.Top;
		...
		/// 
		/// </summary>
		public SunburstSeriesDataLabelsAlign Align { get; set; }
		private SunburstSeriesDataLabelsAlign Align_DefaultValue { get; set; }
		...
		/// 
		/// </summary>
		public SunburstSeriesDataLabelsFilter Filter { get; set; }
		private SunburstSeriesDataLabelsFilter Filter_DefaultValue { get; set; }
		...
		internal override Hashtable ToHashtable()
		{
			...
			if (Formatter != Formatter_DefaultValue) { h.Add("formatter",Formatter); Highcharts.AddFunction("SunburstSeriesDataLabelsFormatter.formatter", Formatter); }  
