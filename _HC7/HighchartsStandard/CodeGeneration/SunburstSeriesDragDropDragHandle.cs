...
{
	public partial class SunburstSeriesDragDropDragHandle  : BaseObject
	{
		public SunburstSeriesDragDropDragHandle()
		{
		...
		internal override Hashtable ToHashtable()
		{
			...
			if (PathFormatter != PathFormatter_DefaultValue) { h.Add("pathFormatter",PathFormatter); Highcharts.AddFunction("SunburstSeriesDragDropDragHandlePathFormatter.pathFormatter", PathFormatter); }  
