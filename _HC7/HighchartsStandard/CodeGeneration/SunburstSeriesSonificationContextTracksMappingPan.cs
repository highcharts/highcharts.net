...
{
	public partial class SunburstSeriesSonificationContextTracksMappingPan  : BaseObject
	{
		Hashtable h = new Hashtable();

		public SunburstSeriesSonificationContextTracksMappingPan()
		{
			MapFunction = MapFunction_DefaultValue = SunburstSeriesSonificationContextTracksMappingPanMapFunction.Linear;
			MapTo = MapTo_DefaultValue = "";
			Max = Max_DefaultValue = null;
			Min = Min_DefaultValue = null;
			Value = Value_DefaultValue = null;
			Within = Within_DefaultValue = SunburstSeriesSonificationContextTracksMappingPanWithin.Chart;
		...
		/// </summary>
		public SunburstSeriesSonificationContextTracksMappingPanMapFunction MapFunction { get; set; }
		private SunburstSeriesSonificationContextTracksMappingPanMapFunction MapFunction_DefaultValue { get; set; }
		...
		/// </summary>
		public SunburstSeriesSonificationContextTracksMappingPanWithin Within { get; set; }
		private SunburstSeriesSonificationContextTracksMappingPanWithin Within_DefaultValue { get; set; }
