...
{
	public partial class SunburstSeriesSonificationContextTracksMappingPitch  : BaseObject
	{
		Hashtable h = new Hashtable();

		public SunburstSeriesSonificationContextTracksMappingPitch()
		{
			MapFunction = MapFunction_DefaultValue = SunburstSeriesSonificationContextTracksMappingPitchMapFunction.Linear;
		...
		/// </summary>
		public SunburstSeriesSonificationContextTracksMappingPitchMapFunction MapFunction { get; set; }
		private SunburstSeriesSonificationContextTracksMappingPitchMapFunction MapFunction_DefaultValue { get; set; }
