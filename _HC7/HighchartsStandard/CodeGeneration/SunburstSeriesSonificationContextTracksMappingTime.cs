...
{
	public partial class SunburstSeriesSonificationContextTracksMappingTime  : BaseObject
	{
		Hashtable h = new Hashtable();

		public SunburstSeriesSonificationContextTracksMappingTime()
		{
			MapFunction = MapFunction_DefaultValue = SunburstSeriesSonificationContextTracksMappingTimeMapFunction.Linear;
			MapTo = MapTo_DefaultValue = "";
			Max = Max_DefaultValue = null;
			Min = Min_DefaultValue = null;
			Value = Value_DefaultValue = null;
			Within = Within_DefaultValue = SunburstSeriesSonificationContextTracksMappingTimeWithin.Chart;
		...
		/// </summary>
		public SunburstSeriesSonificationContextTracksMappingTimeMapFunction MapFunction { get; set; }
		private SunburstSeriesSonificationContextTracksMappingTimeMapFunction MapFunction_DefaultValue { get; set; }
		...
		/// </summary>
		public SunburstSeriesSonificationContextTracksMappingTimeWithin Within { get; set; }
		private SunburstSeriesSonificationContextTracksMappingTimeWithin Within_DefaultValue { get; set; }
