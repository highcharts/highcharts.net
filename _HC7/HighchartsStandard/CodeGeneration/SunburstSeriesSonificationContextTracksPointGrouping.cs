...
{
	public partial class SunburstSeriesSonificationContextTracksPointGrouping  : BaseObject
	{
		Hashtable h = new Hashtable();

		public SunburstSeriesSonificationContextTracksPointGrouping()
		{
		...
		/// </summary>
		public SunburstSeriesSonificationContextTracksPointGroupingAlgorithm Algorithm { get; set; }
		private SunburstSeriesSonificationContextTracksPointGroupingAlgorithm Algorithm_DefaultValue { get; set; }
		...
		internal override Hashtable ToHashtable(Highcharts highcharts)
		{
			...
			if (Algorithm != SunburstSeriesSonificationContextTracksPointGroupingAlgorithm.Null) h.Add("algorithm", highcharts.FirstCharacterToLower(Algorithm.ToString()));
