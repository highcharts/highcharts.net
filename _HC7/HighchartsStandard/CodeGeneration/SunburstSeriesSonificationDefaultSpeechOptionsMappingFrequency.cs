...
{
	public partial class SunburstSeriesSonificationDefaultSpeechOptionsMappingFrequency  : BaseObject
	{
		Hashtable h = new Hashtable();

		public SunburstSeriesSonificationDefaultSpeechOptionsMappingFrequency()
		{
			MapFunction = MapFunction_DefaultValue = SunburstSeriesSonificationDefaultSpeechOptionsMappingFrequencyMapFunction.Linear;
			MapTo = MapTo_DefaultValue = "";
			Max = Max_DefaultValue = null;
			Min = Min_DefaultValue = null;
			Value = Value_DefaultValue = null;
			Within = Within_DefaultValue = SunburstSeriesSonificationDefaultSpeechOptionsMappingFrequencyWithin.Chart;
		...
		/// </summary>
		public SunburstSeriesSonificationDefaultSpeechOptionsMappingFrequencyMapFunction MapFunction { get; set; }
		private SunburstSeriesSonificationDefaultSpeechOptionsMappingFrequencyMapFunction MapFunction_DefaultValue { get; set; }
		...
		/// </summary>
		public SunburstSeriesSonificationDefaultSpeechOptionsMappingFrequencyWithin Within { get; set; }
		private SunburstSeriesSonificationDefaultSpeechOptionsMappingFrequencyWithin Within_DefaultValue { get; set; }
