...
{
	public partial class SunburstSeriesSonificationPointGrouping  : BaseObject
	{
		Hashtable h = new Hashtable();

		public SunburstSeriesSonificationPointGrouping()
		{
		...
		/// </summary>
		public SunburstSeriesSonificationPointGroupingAlgorithm Algorithm { get; set; }
		private SunburstSeriesSonificationPointGroupingAlgorithm Algorithm_DefaultValue { get; set; }
		...
		internal override Hashtable ToHashtable(Highcharts highcharts)
		{
			...
			if (Algorithm != SunburstSeriesSonificationPointGroupingAlgorithm.Null) h.Add("algorithm", highcharts.FirstCharacterToLower(Algorithm.ToString()));
