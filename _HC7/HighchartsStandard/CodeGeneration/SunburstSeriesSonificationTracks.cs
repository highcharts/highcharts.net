...
{
	public partial class SunburstSeriesSonificationTracks  : BaseObject
	{
		Hashtable h = new Hashtable();

		public SunburstSeriesSonificationTracks()
		{
			ActiveWhen = ActiveWhen_DefaultValue = new SunburstSeriesSonificationTracksActiveWhen();
			Instrument = Instrument_DefaultValue = null;
			InstrumentString = InstrumentString_DefaultValue = "null";
			Mapping = Mapping_DefaultValue = new SunburstSeriesSonificationTracksMapping();
			MidiName = MidiName_DefaultValue = "";
			PointGrouping = PointGrouping_DefaultValue = new SunburstSeriesSonificationTracksPointGrouping();
			RoundToMusicalNotes = RoundToMusicalNotes_DefaultValue = true;
			ShowPlayMarker = ShowPlayMarker_DefaultValue = true;
			Type = Type_DefaultValue = SunburstSeriesSonificationTracksType.Instrument;
		...
		/// </summary>
		public SunburstSeriesSonificationTracksActiveWhen ActiveWhen { get; set; }
		private SunburstSeriesSonificationTracksActiveWhen ActiveWhen_DefaultValue { get; set; }
		...
		/// </summary>
		public SunburstSeriesSonificationTracksMapping Mapping { get; set; }
		private SunburstSeriesSonificationTracksMapping Mapping_DefaultValue { get; set; }
		...
		/// </summary>
		public SunburstSeriesSonificationTracksPointGrouping PointGrouping { get; set; }
		private SunburstSeriesSonificationTracksPointGrouping PointGrouping_DefaultValue { get; set; }
		...
		/// </summary>
		public SunburstSeriesSonificationTracksType Type { get; set; }
		private SunburstSeriesSonificationTracksType Type_DefaultValue { get; set; }
