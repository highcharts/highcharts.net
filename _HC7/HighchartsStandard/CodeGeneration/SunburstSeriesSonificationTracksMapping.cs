...
{
	public partial class SunburstSeriesSonificationTracksMapping  : BaseObject
	{
		Hashtable h = new Hashtable();

		public SunburstSeriesSonificationTracksMapping()
		{
			Frequency = Frequency_DefaultValue = new SunburstSeriesSonificationTracksMappingFrequency();
			GapBetweenNotes = GapBetweenNotes_DefaultValue = new SunburstSeriesSonificationTracksMappingGapBetweenNotes();
			Highpass = Highpass_DefaultValue = new SunburstSeriesSonificationTracksMappingHighpass();
			Lowpass = Lowpass_DefaultValue = new SunburstSeriesSonificationTracksMappingLowpass();
			NoteDuration = NoteDuration_DefaultValue = new SunburstSeriesSonificationTracksMappingNoteDuration();
			Pan = Pan_DefaultValue = new SunburstSeriesSonificationTracksMappingPan();
			Pitch = Pitch_DefaultValue = new SunburstSeriesSonificationTracksMappingPitch();
			PitchString = PitchString_DefaultValue = "null";
			PitchNumber = PitchNumber_DefaultValue = null;
			PlayDelay = PlayDelay_DefaultValue = new SunburstSeriesSonificationTracksMappingPlayDelay();
			Time = Time_DefaultValue = new SunburstSeriesSonificationTracksMappingTime();
			TimeString = TimeString_DefaultValue = "null";
			TimeNumber = TimeNumber_DefaultValue = null;
			Tremolo = Tremolo_DefaultValue = new SunburstSeriesSonificationTracksMappingTremolo();
			Volume = Volume_DefaultValue = new SunburstSeriesSonificationTracksMappingVolume();
		...
		/// </summary>
		public SunburstSeriesSonificationTracksMappingFrequency Frequency { get; set; }
		private SunburstSeriesSonificationTracksMappingFrequency Frequency_DefaultValue { get; set; }
		...
		/// </summary>
		public SunburstSeriesSonificationTracksMappingGapBetweenNotes GapBetweenNotes { get; set; }
		private SunburstSeriesSonificationTracksMappingGapBetweenNotes GapBetweenNotes_DefaultValue { get; set; }
		...
		/// </summary>
		public SunburstSeriesSonificationTracksMappingHighpass Highpass { get; set; }
		private SunburstSeriesSonificationTracksMappingHighpass Highpass_DefaultValue { get; set; }
		...
		/// </summary>
		public SunburstSeriesSonificationTracksMappingLowpass Lowpass { get; set; }
		private SunburstSeriesSonificationTracksMappingLowpass Lowpass_DefaultValue { get; set; }
		...
		/// </summary>
		public SunburstSeriesSonificationTracksMappingNoteDuration NoteDuration { get; set; }
		private SunburstSeriesSonificationTracksMappingNoteDuration NoteDuration_DefaultValue { get; set; }
		...
		/// </summary>
		public SunburstSeriesSonificationTracksMappingPan Pan { get; set; }
		private SunburstSeriesSonificationTracksMappingPan Pan_DefaultValue { get; set; }
		...
		/// </summary>
		public SunburstSeriesSonificationTracksMappingPitch Pitch { get; set; }
		private SunburstSeriesSonificationTracksMappingPitch Pitch_DefaultValue { get; set; }
		...
		/// </summary>
		public SunburstSeriesSonificationTracksMappingPlayDelay PlayDelay { get; set; }
		private SunburstSeriesSonificationTracksMappingPlayDelay PlayDelay_DefaultValue { get; set; }
		...
		/// </summary>
		public SunburstSeriesSonificationTracksMappingTime Time { get; set; }
		private SunburstSeriesSonificationTracksMappingTime Time_DefaultValue { get; set; }
		...
		/// </summary>
		public SunburstSeriesSonificationTracksMappingTremolo Tremolo { get; set; }
		private SunburstSeriesSonificationTracksMappingTremolo Tremolo_DefaultValue { get; set; }
		 

		/// <summary>
		/// The volume of notes, from 0 to 1.
		/// </summary>
		public SunburstSeriesSonificationTracksMappingVolume Volume { get; set; }
		private SunburstSeriesSonificationTracksMappingVolume Volume_DefaultValue { get; set; }
