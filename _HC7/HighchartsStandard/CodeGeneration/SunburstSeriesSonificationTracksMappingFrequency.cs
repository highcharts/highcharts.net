...
{
	public partial class SunburstSeriesSonificationTracksMappingFrequency  : BaseObject
	{
		Hashtable h = new Hashtable();

		public SunburstSeriesSonificationTracksMappingFrequency()
		{
			MapFunction = MapFunction_DefaultValue = SunburstSeriesSonificationTracksMappingFrequencyMapFunction.Linear;
			MapTo = MapTo_DefaultValue = "";
			Max = Max_DefaultValue = null;
			Min = Min_DefaultValue = null;
			Value = Value_DefaultValue = null;
			Within = Within_DefaultValue = SunburstSeriesSonificationTracksMappingFrequencyWithin.Chart;
		...
		/// </summary>
		public SunburstSeriesSonificationTracksMappingFrequencyMapFunction MapFunction { get; set; }
		private SunburstSeriesSonificationTracksMappingFrequencyMapFunction MapFunction_DefaultValue { get; set; }
		...
		/// </summary>
		public SunburstSeriesSonificationTracksMappingFrequencyWithin Within { get; set; }
		private SunburstSeriesSonificationTracksMappingFrequencyWithin Within_DefaultValue { get; set; }
