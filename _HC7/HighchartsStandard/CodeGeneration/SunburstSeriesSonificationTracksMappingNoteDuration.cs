...
{
	public partial class SunburstSeriesSonificationTracksMappingNoteDuration  : BaseObject
	{
		Hashtable h = new Hashtable();

		public SunburstSeriesSonificationTracksMappingNoteDuration()
		{
			MapFunction = MapFunction_DefaultValue = SunburstSeriesSonificationTracksMappingNoteDurationMapFunction.Linear;
			MapTo = MapTo_DefaultValue = "";
			Max = Max_DefaultValue = null;
			Min = Min_DefaultValue = null;
			Value = Value_DefaultValue = null;
			Within = Within_DefaultValue = SunburstSeriesSonificationTracksMappingNoteDurationWithin.Chart;
		...
		/// </summary>
		public SunburstSeriesSonificationTracksMappingNoteDurationMapFunction MapFunction { get; set; }
		private SunburstSeriesSonificationTracksMappingNoteDurationMapFunction MapFunction_DefaultValue { get; set; }
		...
		/// </summary>
		public SunburstSeriesSonificationTracksMappingNoteDurationWithin Within { get; set; }
		private SunburstSeriesSonificationTracksMappingNoteDurationWithin Within_DefaultValue { get; set; }
