...
{
	public partial class SunburstSeriesSonificationTracksMappingPan  : BaseObject
	{
		Hashtable h = new Hashtable();

		public SunburstSeriesSonificationTracksMappingPan()
		{
			MapFunction = MapFunction_DefaultValue = SunburstSeriesSonificationTracksMappingPanMapFunction.Linear;
			MapTo = MapTo_DefaultValue = "";
			Max = Max_DefaultValue = null;
			Min = Min_DefaultValue = null;
			Value = Value_DefaultValue = null;
			Within = Within_DefaultValue = SunburstSeriesSonificationTracksMappingPanWithin.Chart;
		...
		/// </summary>
		public SunburstSeriesSonificationTracksMappingPanMapFunction MapFunction { get; set; }
		private SunburstSeriesSonificationTracksMappingPanMapFunction MapFunction_DefaultValue { get; set; }
		...
		/// </summary>
		public SunburstSeriesSonificationTracksMappingPanWithin Within { get; set; }
		private SunburstSeriesSonificationTracksMappingPanWithin Within_DefaultValue { get; set; }
