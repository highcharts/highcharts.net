...
{
	public partial class SunburstSeriesSonificationTracksMappingPitch  : BaseObject
	{
		Hashtable h = new Hashtable();

		public SunburstSeriesSonificationTracksMappingPitch()
		{
			MapFunction = MapFunction_DefaultValue = SunburstSeriesSonificationTracksMappingPitchMapFunction.Linear;
		...
		/// </summary>
		public SunburstSeriesSonificationTracksMappingPitchMapFunction MapFunction { get; set; }
		private SunburstSeriesSonificationTracksMappingPitchMapFunction MapFunction_DefaultValue { get; set; }
