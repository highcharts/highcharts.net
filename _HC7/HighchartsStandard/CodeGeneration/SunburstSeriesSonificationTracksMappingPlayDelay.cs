...
{
	public partial class SunburstSeriesSonificationTracksMappingPlayDelay  : BaseObject
	{
		Hashtable h = new Hashtable();

		public SunburstSeriesSonificationTracksMappingPlayDelay()
		{
			MapFunction = MapFunction_DefaultValue = SunburstSeriesSonificationTracksMappingPlayDelayMapFunction.Linear;
			MapTo = MapTo_DefaultValue = "";
			Max = Max_DefaultValue = null;
			Min = Min_DefaultValue = null;
			Value = Value_DefaultValue = null;
			Within = Within_DefaultValue = SunburstSeriesSonificationTracksMappingPlayDelayWithin.Chart;
		...
		/// </summary>
		public SunburstSeriesSonificationTracksMappingPlayDelayMapFunction MapFunction { get; set; }
		private SunburstSeriesSonificationTracksMappingPlayDelayMapFunction MapFunction_DefaultValue { get; set; }
		...
		/// </summary>
		public SunburstSeriesSonificationTracksMappingPlayDelayWithin Within { get; set; }
		private SunburstSeriesSonificationTracksMappingPlayDelayWithin Within_DefaultValue { get; set; }
