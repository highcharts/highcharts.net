...
{
	public partial class SunburstSeriesSonificationTracksMappingTime  : BaseObject
	{
		Hashtable h = new Hashtable();

		public SunburstSeriesSonificationTracksMappingTime()
		{
			MapFunction = MapFunction_DefaultValue = SunburstSeriesSonificationTracksMappingTimeMapFunction.Linear;
			MapTo = MapTo_DefaultValue = "";
			Max = Max_DefaultValue = null;
			Min = Min_DefaultValue = null;
			Value = Value_DefaultValue = null;
			Within = Within_DefaultValue = SunburstSeriesSonificationTracksMappingTimeWithin.Chart;
		...
		/// </summary>
		public SunburstSeriesSonificationTracksMappingTimeMapFunction MapFunction { get; set; }
		private SunburstSeriesSonificationTracksMappingTimeMapFunction MapFunction_DefaultValue { get; set; }
		...
		/// </summary>
		public SunburstSeriesSonificationTracksMappingTimeWithin Within { get; set; }
		private SunburstSeriesSonificationTracksMappingTimeWithin Within_DefaultValue { get; set; }
