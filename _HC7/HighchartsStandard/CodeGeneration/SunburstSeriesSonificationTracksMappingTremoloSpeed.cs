...
{
	public partial class SunburstSeriesSonificationTracksMappingTremoloSpeed  : BaseObject
	{
		Hashtable h = new Hashtable();

		public SunburstSeriesSonificationTracksMappingTremoloSpeed()
		{
			MapFunction = MapFunction_DefaultValue = SunburstSeriesSonificationTracksMappingTremoloSpeedMapFunction.Linear;
			MapTo = MapTo_DefaultValue = "";
			Max = Max_DefaultValue = null;
			Min = Min_DefaultValue = null;
			Value = Value_DefaultValue = null;
			Within = Within_DefaultValue = SunburstSeriesSonificationTracksMappingTremoloSpeedWithin.Chart;
		...
		/// </summary>
		public SunburstSeriesSonificationTracksMappingTremoloSpeedMapFunction MapFunction { get; set; }
		private SunburstSeriesSonificationTracksMappingTremoloSpeedMapFunction MapFunction_DefaultValue { get; set; }
		...
		/// </summary>
		public SunburstSeriesSonificationTracksMappingTremoloSpeedWithin Within { get; set; }
		private SunburstSeriesSonificationTracksMappingTremoloSpeedWithin Within_DefaultValue { get; set; }
