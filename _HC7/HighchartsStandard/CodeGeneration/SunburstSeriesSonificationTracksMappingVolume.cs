...
{
	public partial class SunburstSeriesSonificationTracksMappingVolume  : BaseObject
	{
		Hashtable h = new Hashtable();

		public SunburstSeriesSonificationTracksMappingVolume()
		{
			MapFunction = MapFunction_DefaultValue = SunburstSeriesSonificationTracksMappingVolumeMapFunction.Linear;
			MapTo = MapTo_DefaultValue = "";
			Max = Max_DefaultValue = null;
			Min = Min_DefaultValue = null;
			Value = Value_DefaultValue = null;
			Within = Within_DefaultValue = SunburstSeriesSonificationTracksMappingVolumeWithin.Chart;
		...
		/// </summary>
		public SunburstSeriesSonificationTracksMappingVolumeMapFunction MapFunction { get; set; }
		private SunburstSeriesSonificationTracksMappingVolumeMapFunction MapFunction_DefaultValue { get; set; }
		...
		/// </summary>
		public SunburstSeriesSonificationTracksMappingVolumeWithin Within { get; set; }
		private SunburstSeriesSonificationTracksMappingVolumeWithin Within_DefaultValue { get; set; }
