...
{
	public partial class SunburstSeriesSonificationTracksPointGrouping  : BaseObject
	{
		Hashtable h = new Hashtable();

		public SunburstSeriesSonificationTracksPointGrouping()
		{
		...
		/// </summary>
		public SunburstSeriesSonificationTracksPointGroupingAlgorithm Algorithm { get; set; }
		private SunburstSeriesSonificationTracksPointGroupingAlgorithm Algorithm_DefaultValue { get; set; }
		...
		internal override Hashtable ToHashtable(Highcharts highcharts)
		{
			...
			if (Algorithm != SunburstSeriesSonificationTracksPointGroupingAlgorithm.Null) h.Add("algorithm", highcharts.FirstCharacterToLower(Algorithm.ToString()));
