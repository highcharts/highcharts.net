...
{
	public partial class SunburstSeriesStatesHover  : BaseObject
	{
		public SunburstSeriesStatesHover()
		{
			Animation = Animation_DefaultValue = new Animation() { Enabled = true };
			Enabled = Enabled_DefaultValue = true;
			Halo = Halo_DefaultValue = new SunburstSeriesStatesHoverHalo();
			LineWidth = LineWidth_DefaultValue = null;
			LineWidthPlus = LineWidthPlus_DefaultValue = 1;
			Marker = Marker_DefaultValue = new SunburstSeriesStatesHoverMarker();
		...
		/// </summary>
		public SunburstSeriesStatesHoverHalo Halo { get; set; }
		private SunburstSeriesStatesHoverHalo Halo_DefaultValue { get; set; }
		...
		/// </summary>
		public SunburstSeriesStatesHoverMarker Marker { get; set; }
		private SunburstSeriesStatesHoverMarker Marker_DefaultValue { get; set; }
