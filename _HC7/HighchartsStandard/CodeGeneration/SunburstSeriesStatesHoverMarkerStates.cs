...
namespace Highsoft.Web.Mvc.Charts
{
	public partial class SunburstSeriesStatesHoverMarkerStates  : BaseObject
	{
		public SunburstSeriesStatesHoverMarkerStates()
		{
			...
			Inactive = Inactive_DefaultValue = new SunburstSeriesStatesHoverMarkerStatesInactive();
		...
		/// 
		/// </summary>
		public SunburstSeriesStatesHoverMarkerStatesInactive Inactive { get; set; }
		private SunburstSeriesStatesHoverMarkerStatesInactive Inactive_DefaultValue { get; set; }
