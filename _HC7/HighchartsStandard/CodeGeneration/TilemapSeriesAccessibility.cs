...
namespace Highsoft.Web.Mvc.Charts
{
	public partial class TilemapSeriesAccessibility  : BaseObject
	{
		...
		public TilemapSeriesAccessibility()
		{
			...
			Point = Point_DefaultValue = new TilemapSeriesAccessibilityPoint();
		...
		/// </summary>
		public TilemapSeriesAccessibilityPoint Point { get; set; }
		private TilemapSeriesAccessibilityPoint Point_DefaultValue { get; set; }
