...
{
	public partial class TilemapSeriesDataDataLabels  : BaseObject
	{
		Hashtable h = new Hashtable();

		public TilemapSeriesDataDataLabels()
		{
		...
		/// </summary>
		public TilemapSeriesDataDataLabelsAlign Align { get; set; }
		private TilemapSeriesDataDataLabelsAlign Align_DefaultValue { get; set; }
		...
		/// </summary>
		public TilemapSeriesDataDataLabelsFilter Filter { get; set; }
		private TilemapSeriesDataDataLabelsFilter Filter_DefaultValue { get; set; }
		...
		/// </summary>
		public TilemapSeriesDataDataLabelsOverflow Overflow { get; set; }
		private TilemapSeriesDataDataLabelsOverflow Overflow_DefaultValue { get; set; }
		...
		/// </summary>
		public TilemapSeriesDataDataLabelsPosition Position { get; set; }
		private TilemapSeriesDataDataLabelsPosition Position_DefaultValue { get; set; }
		...
		/// </summary>
		public TilemapSeriesDataDataLabelsTextPath TextPath { get; set; }
		private TilemapSeriesDataDataLabelsTextPath TextPath_DefaultValue { get; set; }
		...
		/// </summary>
		public TilemapSeriesDataDataLabelsVerticalAlign VerticalAlign { get; set; }
		private TilemapSeriesDataDataLabelsVerticalAlign VerticalAlign_DefaultValue { get; set; }
		...
		internal override Hashtable ToHashtable(Highcharts highcharts)
		{
			...
			if (Align != TilemapSeriesDataDataLabelsAlign.Null) h.Add("align", highcharts.FirstCharacterToLower(Align.ToString()));
			...
			if (Overflow != TilemapSeriesDataDataLabelsOverflow.Null) h.Add("overflow", highcharts.FirstCharacterToLower(Overflow.ToString()));
			if (Padding != null) h.Add("padding",Padding);
			if (Position != TilemapSeriesDataDataLabelsPosition.Null) h.Add("position", highcharts.FirstCharacterToLower(Position.ToString()));
			...
			if (VerticalAlign != TilemapSeriesDataDataLabelsVerticalAlign.Null) h.Add("verticalAlign", highcharts.FirstCharacterToLower(VerticalAlign.ToString()));
			if (X != null) h.Add("x",X);
			if (Y != null) h.Add("y",Y);
