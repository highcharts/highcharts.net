...
namespace Highsoft.Web.Mvc.Charts
{
	public partial class TilemapSeriesDataDragDrop  : BaseObject
	{
		public TilemapSeriesDataDragDrop()
		{
			...
			DragHandle = DragHandle_DefaultValue = new TilemapSeriesDataDragDropDragHandle();
			...
			GuideBox = GuideBox_DefaultValue = new TilemapSeriesDataDragDropGuideBox();
		...
		private TilemapSeriesDataDragDropDragHandle DragHandle_DefaultValue { get; set; }
		...
		private TilemapSeriesDataDragDropGuideBox GuideBox_DefaultValue { get; set; }
