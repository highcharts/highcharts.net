...
{
	public partial class TilemapSeriesSonificationContextTracksMapping  : BaseObject
	{
		Hashtable h = new Hashtable();

		public TilemapSeriesSonificationContextTracksMapping()
		{
			Frequency = Frequency_DefaultValue = new TilemapSeriesSonificationContextTracksMappingFrequency();
			GapBetweenNotes = GapBetweenNotes_DefaultValue = new TilemapSeriesSonificationContextTracksMappingGapBetweenNotes();
			Highpass = Highpass_DefaultValue = new TilemapSeriesSonificationContextTracksMappingHighpass();
			Lowpass = Lowpass_DefaultValue = new TilemapSeriesSonificationContextTracksMappingLowpass();
			NoteDuration = NoteDuration_DefaultValue = new TilemapSeriesSonificationContextTracksMappingNoteDuration();
			Pan = Pan_DefaultValue = new TilemapSeriesSonificationContextTracksMappingPan();
			Pitch = Pitch_DefaultValue = new TilemapSeriesSonificationContextTracksMappingPitch();
			PitchString = PitchString_DefaultValue = "null";
			PitchNumber = PitchNumber_DefaultValue = null;
			PlayDelay = PlayDelay_DefaultValue = new TilemapSeriesSonificationContextTracksMappingPlayDelay();
			Time = Time_DefaultValue = new TilemapSeriesSonificationContextTracksMappingTime();
			TimeString = TimeString_DefaultValue = "null";
			TimeNumber = TimeNumber_DefaultValue = null;
			Tremolo = Tremolo_DefaultValue = new TilemapSeriesSonificationContextTracksMappingTremolo();
			Volume = Volume_DefaultValue = new TilemapSeriesSonificationContextTracksMappingVolume();
		...
		/// </summary>
		public TilemapSeriesSonificationContextTracksMappingFrequency Frequency { get; set; }
		private TilemapSeriesSonificationContextTracksMappingFrequency Frequency_DefaultValue { get; set; }
		...
		/// </summary>
		public TilemapSeriesSonificationContextTracksMappingGapBetweenNotes GapBetweenNotes { get; set; }
		private TilemapSeriesSonificationContextTracksMappingGapBetweenNotes GapBetweenNotes_DefaultValue { get; set; }
		...
		/// </summary>
		public TilemapSeriesSonificationContextTracksMappingHighpass Highpass { get; set; }
		private TilemapSeriesSonificationContextTracksMappingHighpass Highpass_DefaultValue { get; set; }
		...
		/// </summary>
		public TilemapSeriesSonificationContextTracksMappingLowpass Lowpass { get; set; }
		private TilemapSeriesSonificationContextTracksMappingLowpass Lowpass_DefaultValue { get; set; }
		...
		/// </summary>
		public TilemapSeriesSonificationContextTracksMappingNoteDuration NoteDuration { get; set; }
		private TilemapSeriesSonificationContextTracksMappingNoteDuration NoteDuration_DefaultValue { get; set; }
		...
		/// </summary>
		public TilemapSeriesSonificationContextTracksMappingPan Pan { get; set; }
		private TilemapSeriesSonificationContextTracksMappingPan Pan_DefaultValue { get; set; }
		...
		/// </summary>
		public TilemapSeriesSonificationContextTracksMappingPitch Pitch { get; set; }
		private TilemapSeriesSonificationContextTracksMappingPitch Pitch_DefaultValue { get; set; }
		...
		/// </summary>
		public TilemapSeriesSonificationContextTracksMappingPlayDelay PlayDelay { get; set; }
		private TilemapSeriesSonificationContextTracksMappingPlayDelay PlayDelay_DefaultValue { get; set; }
		...
		/// </summary>
		public TilemapSeriesSonificationContextTracksMappingTime Time { get; set; }
		private TilemapSeriesSonificationContextTracksMappingTime Time_DefaultValue { get; set; }
		...
		/// </summary>
		public TilemapSeriesSonificationContextTracksMappingTremolo Tremolo { get; set; }
		private TilemapSeriesSonificationContextTracksMappingTremolo Tremolo_DefaultValue { get; set; }
		 

		/// <summary>
		/// The volume of notes, from 0 to 1.
		/// </summary>
		public TilemapSeriesSonificationContextTracksMappingVolume Volume { get; set; }
		private TilemapSeriesSonificationContextTracksMappingVolume Volume_DefaultValue { get; set; }
