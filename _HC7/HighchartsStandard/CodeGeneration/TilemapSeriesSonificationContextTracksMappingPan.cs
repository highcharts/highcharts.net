...
{
	public partial class TilemapSeriesSonificationContextTracksMappingPan  : BaseObject
	{
		Hashtable h = new Hashtable();

		public TilemapSeriesSonificationContextTracksMappingPan()
		{
			MapFunction = MapFunction_DefaultValue = TilemapSeriesSonificationContextTracksMappingPanMapFunction.Linear;
			MapTo = MapTo_DefaultValue = "";
			Max = Max_DefaultValue = null;
			Min = Min_DefaultValue = null;
			Value = Value_DefaultValue = null;
			Within = Within_DefaultValue = TilemapSeriesSonificationContextTracksMappingPanWithin.Chart;
		...
		/// </summary>
		public TilemapSeriesSonificationContextTracksMappingPanMapFunction MapFunction { get; set; }
		private TilemapSeriesSonificationContextTracksMappingPanMapFunction MapFunction_DefaultValue { get; set; }
		...
		/// </summary>
		public TilemapSeriesSonificationContextTracksMappingPanWithin Within { get; set; }
		private TilemapSeriesSonificationContextTracksMappingPanWithin Within_DefaultValue { get; set; }
