...
{
	public partial class TilemapSeriesSonificationContextTracksMappingPitch  : BaseObject
	{
		Hashtable h = new Hashtable();

		public TilemapSeriesSonificationContextTracksMappingPitch()
		{
			MapFunction = MapFunction_DefaultValue = TilemapSeriesSonificationContextTracksMappingPitchMapFunction.Linear;
		...
		/// </summary>
		public TilemapSeriesSonificationContextTracksMappingPitchMapFunction MapFunction { get; set; }
		private TilemapSeriesSonificationContextTracksMappingPitchMapFunction MapFunction_DefaultValue { get; set; }
