...
{
	public partial class TilemapSeriesSonificationContextTracksMappingTremoloSpeed  : BaseObject
	{
		Hashtable h = new Hashtable();

		public TilemapSeriesSonificationContextTracksMappingTremoloSpeed()
		{
			MapFunction = MapFunction_DefaultValue = TilemapSeriesSonificationContextTracksMappingTremoloSpeedMapFunction.Linear;
			MapTo = MapTo_DefaultValue = "";
			Max = Max_DefaultValue = null;
			Min = Min_DefaultValue = null;
			Value = Value_DefaultValue = null;
			Within = Within_DefaultValue = TilemapSeriesSonificationContextTracksMappingTremoloSpeedWithin.Chart;
		...
		/// </summary>
		public TilemapSeriesSonificationContextTracksMappingTremoloSpeedMapFunction MapFunction { get; set; }
		private TilemapSeriesSonificationContextTracksMappingTremoloSpeedMapFunction MapFunction_DefaultValue { get; set; }
		...
		/// </summary>
		public TilemapSeriesSonificationContextTracksMappingTremoloSpeedWithin Within { get; set; }
		private TilemapSeriesSonificationContextTracksMappingTremoloSpeedWithin Within_DefaultValue { get; set; }
