...
{
	public partial class TilemapSeriesSonificationDefaultSpeechOptionsMapping  : BaseObject
	{
		Hashtable h = new Hashtable();

		public TilemapSeriesSonificationDefaultSpeechOptionsMapping()
		{
			Frequency = Frequency_DefaultValue = new TilemapSeriesSonificationDefaultSpeechOptionsMappingFrequency();
			GapBetweenNotes = GapBetweenNotes_DefaultValue = new TilemapSeriesSonificationDefaultSpeechOptionsMappingGapBetweenNotes();
			Highpass = Highpass_DefaultValue = new TilemapSeriesSonificationDefaultSpeechOptionsMappingHighpass();
			Lowpass = Lowpass_DefaultValue = new TilemapSeriesSonificationDefaultSpeechOptionsMappingLowpass();
			NoteDuration = NoteDuration_DefaultValue = new TilemapSeriesSonificationDefaultSpeechOptionsMappingNoteDuration();
			Pan = Pan_DefaultValue = new TilemapSeriesSonificationDefaultSpeechOptionsMappingPan();
			Pitch = Pitch_DefaultValue = new TilemapSeriesSonificationDefaultSpeechOptionsMappingPitch();
			PitchString = PitchString_DefaultValue = "null";
			PitchNumber = PitchNumber_DefaultValue = null;
			PlayDelay = PlayDelay_DefaultValue = new TilemapSeriesSonificationDefaultSpeechOptionsMappingPlayDelay();
			Time = Time_DefaultValue = new TilemapSeriesSonificationDefaultSpeechOptionsMappingTime();
			TimeString = TimeString_DefaultValue = "null";
			TimeNumber = TimeNumber_DefaultValue = null;
			Tremolo = Tremolo_DefaultValue = new TilemapSeriesSonificationDefaultSpeechOptionsMappingTremolo();
			Volume = Volume_DefaultValue = new TilemapSeriesSonificationDefaultSpeechOptionsMappingVolume();
		...
		/// </summary>
		public TilemapSeriesSonificationDefaultSpeechOptionsMappingFrequency Frequency { get; set; }
		private TilemapSeriesSonificationDefaultSpeechOptionsMappingFrequency Frequency_DefaultValue { get; set; }
		...
		/// </summary>
		public TilemapSeriesSonificationDefaultSpeechOptionsMappingGapBetweenNotes GapBetweenNotes { get; set; }
		private TilemapSeriesSonificationDefaultSpeechOptionsMappingGapBetweenNotes GapBetweenNotes_DefaultValue { get; set; }
		...
		/// </summary>
		public TilemapSeriesSonificationDefaultSpeechOptionsMappingHighpass Highpass { get; set; }
		private TilemapSeriesSonificationDefaultSpeechOptionsMappingHighpass Highpass_DefaultValue { get; set; }
		...
		/// </summary>
		public TilemapSeriesSonificationDefaultSpeechOptionsMappingLowpass Lowpass { get; set; }
		private TilemapSeriesSonificationDefaultSpeechOptionsMappingLowpass Lowpass_DefaultValue { get; set; }
		...
		/// </summary>
		public TilemapSeriesSonificationDefaultSpeechOptionsMappingNoteDuration NoteDuration { get; set; }
		private TilemapSeriesSonificationDefaultSpeechOptionsMappingNoteDuration NoteDuration_DefaultValue { get; set; }
		...
		/// </summary>
		public TilemapSeriesSonificationDefaultSpeechOptionsMappingPan Pan { get; set; }
		private TilemapSeriesSonificationDefaultSpeechOptionsMappingPan Pan_DefaultValue { get; set; }
		...
		/// </summary>
		public TilemapSeriesSonificationDefaultSpeechOptionsMappingPitch Pitch { get; set; }
		private TilemapSeriesSonificationDefaultSpeechOptionsMappingPitch Pitch_DefaultValue { get; set; }
		...
		/// </summary>
		public TilemapSeriesSonificationDefaultSpeechOptionsMappingPlayDelay PlayDelay { get; set; }
		private TilemapSeriesSonificationDefaultSpeechOptionsMappingPlayDelay PlayDelay_DefaultValue { get; set; }
		...
		/// </summary>
		public TilemapSeriesSonificationDefaultSpeechOptionsMappingTime Time { get; set; }
		private TilemapSeriesSonificationDefaultSpeechOptionsMappingTime Time_DefaultValue { get; set; }
		...
		/// </summary>
		public TilemapSeriesSonificationDefaultSpeechOptionsMappingTremolo Tremolo { get; set; }
		private TilemapSeriesSonificationDefaultSpeechOptionsMappingTremolo Tremolo_DefaultValue { get; set; }
		 

		/// <summary>
		/// The volume of notes, from 0 to 1.
		/// </summary>
		public TilemapSeriesSonificationDefaultSpeechOptionsMappingVolume Volume { get; set; }
		private TilemapSeriesSonificationDefaultSpeechOptionsMappingVolume Volume_DefaultValue { get; set; }
