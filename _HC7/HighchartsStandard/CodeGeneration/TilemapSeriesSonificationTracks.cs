...
{
	public partial class TilemapSeriesSonificationTracks  : BaseObject
	{
		Hashtable h = new Hashtable();

		public TilemapSeriesSonificationTracks()
		{
			ActiveWhen = ActiveWhen_DefaultValue = new TilemapSeriesSonificationTracksActiveWhen();
			Instrument = Instrument_DefaultValue = null;
			InstrumentString = InstrumentString_DefaultValue = "null";
			Mapping = Mapping_DefaultValue = new TilemapSeriesSonificationTracksMapping();
			MidiName = MidiName_DefaultValue = "";
			PointGrouping = PointGrouping_DefaultValue = new TilemapSeriesSonificationTracksPointGrouping();
			RoundToMusicalNotes = RoundToMusicalNotes_DefaultValue = true;
			ShowPlayMarker = ShowPlayMarker_DefaultValue = true;
			Type = Type_DefaultValue = TilemapSeriesSonificationTracksType.Instrument;
		...
		/// </summary>
		public TilemapSeriesSonificationTracksActiveWhen ActiveWhen { get; set; }
		private TilemapSeriesSonificationTracksActiveWhen ActiveWhen_DefaultValue { get; set; }
		...
		/// </summary>
		public TilemapSeriesSonificationTracksMapping Mapping { get; set; }
		private TilemapSeriesSonificationTracksMapping Mapping_DefaultValue { get; set; }
		...
		/// </summary>
		public TilemapSeriesSonificationTracksPointGrouping PointGrouping { get; set; }
		private TilemapSeriesSonificationTracksPointGrouping PointGrouping_DefaultValue { get; set; }
		...
		/// </summary>
		public TilemapSeriesSonificationTracksType Type { get; set; }
		private TilemapSeriesSonificationTracksType Type_DefaultValue { get; set; }
