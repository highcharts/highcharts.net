...
{
	public partial class TilemapSeriesSonificationTracksMapping  : BaseObject
	{
		Hashtable h = new Hashtable();

		public TilemapSeriesSonificationTracksMapping()
		{
			Frequency = Frequency_DefaultValue = new TilemapSeriesSonificationTracksMappingFrequency();
			GapBetweenNotes = GapBetweenNotes_DefaultValue = new TilemapSeriesSonificationTracksMappingGapBetweenNotes();
			Highpass = Highpass_DefaultValue = new TilemapSeriesSonificationTracksMappingHighpass();
			Lowpass = Lowpass_DefaultValue = new TilemapSeriesSonificationTracksMappingLowpass();
			NoteDuration = NoteDuration_DefaultValue = new TilemapSeriesSonificationTracksMappingNoteDuration();
			Pan = Pan_DefaultValue = new TilemapSeriesSonificationTracksMappingPan();
			Pitch = Pitch_DefaultValue = new TilemapSeriesSonificationTracksMappingPitch();
			PitchString = PitchString_DefaultValue = "null";
			PitchNumber = PitchNumber_DefaultValue = null;
			PlayDelay = PlayDelay_DefaultValue = new TilemapSeriesSonificationTracksMappingPlayDelay();
			Time = Time_DefaultValue = new TilemapSeriesSonificationTracksMappingTime();
			TimeString = TimeString_DefaultValue = "null";
			TimeNumber = TimeNumber_DefaultValue = null;
			Tremolo = Tremolo_DefaultValue = new TilemapSeriesSonificationTracksMappingTremolo();
			Volume = Volume_DefaultValue = new TilemapSeriesSonificationTracksMappingVolume();
		...
		/// </summary>
		public TilemapSeriesSonificationTracksMappingFrequency Frequency { get; set; }
		private TilemapSeriesSonificationTracksMappingFrequency Frequency_DefaultValue { get; set; }
		...
		/// </summary>
		public TilemapSeriesSonificationTracksMappingGapBetweenNotes GapBetweenNotes { get; set; }
		private TilemapSeriesSonificationTracksMappingGapBetweenNotes GapBetweenNotes_DefaultValue { get; set; }
		...
		/// </summary>
		public TilemapSeriesSonificationTracksMappingHighpass Highpass { get; set; }
		private TilemapSeriesSonificationTracksMappingHighpass Highpass_DefaultValue { get; set; }
		...
		/// </summary>
		public TilemapSeriesSonificationTracksMappingLowpass Lowpass { get; set; }
		private TilemapSeriesSonificationTracksMappingLowpass Lowpass_DefaultValue { get; set; }
		...
		/// </summary>
		public TilemapSeriesSonificationTracksMappingNoteDuration NoteDuration { get; set; }
		private TilemapSeriesSonificationTracksMappingNoteDuration NoteDuration_DefaultValue { get; set; }
		...
		/// </summary>
		public TilemapSeriesSonificationTracksMappingPan Pan { get; set; }
		private TilemapSeriesSonificationTracksMappingPan Pan_DefaultValue { get; set; }
		...
		/// </summary>
		public TilemapSeriesSonificationTracksMappingPitch Pitch { get; set; }
		private TilemapSeriesSonificationTracksMappingPitch Pitch_DefaultValue { get; set; }
		...
		/// </summary>
		public TilemapSeriesSonificationTracksMappingPlayDelay PlayDelay { get; set; }
		private TilemapSeriesSonificationTracksMappingPlayDelay PlayDelay_DefaultValue { get; set; }
		...
		/// </summary>
		public TilemapSeriesSonificationTracksMappingTime Time { get; set; }
		private TilemapSeriesSonificationTracksMappingTime Time_DefaultValue { get; set; }
		...
		/// </summary>
		public TilemapSeriesSonificationTracksMappingTremolo Tremolo { get; set; }
		private TilemapSeriesSonificationTracksMappingTremolo Tremolo_DefaultValue { get; set; }
		 

		/// <summary>
		/// The volume of notes, from 0 to 1.
		/// </summary>
		public TilemapSeriesSonificationTracksMappingVolume Volume { get; set; }
		private TilemapSeriesSonificationTracksMappingVolume Volume_DefaultValue { get; set; }
