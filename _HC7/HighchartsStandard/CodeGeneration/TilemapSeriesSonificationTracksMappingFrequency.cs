...
{
	public partial class TilemapSeriesSonificationTracksMappingFrequency  : BaseObject
	{
		Hashtable h = new Hashtable();

		public TilemapSeriesSonificationTracksMappingFrequency()
		{
			MapFunction = MapFunction_DefaultValue = TilemapSeriesSonificationTracksMappingFrequencyMapFunction.Linear;
			MapTo = MapTo_DefaultValue = "";
			Max = Max_DefaultValue = null;
			Min = Min_DefaultValue = null;
			Value = Value_DefaultValue = null;
			Within = Within_DefaultValue = TilemapSeriesSonificationTracksMappingFrequencyWithin.Chart;
		...
		/// </summary>
		public TilemapSeriesSonificationTracksMappingFrequencyMapFunction MapFunction { get; set; }
		private TilemapSeriesSonificationTracksMappingFrequencyMapFunction MapFunction_DefaultValue { get; set; }
		...
		/// </summary>
		public TilemapSeriesSonificationTracksMappingFrequencyWithin Within { get; set; }
		private TilemapSeriesSonificationTracksMappingFrequencyWithin Within_DefaultValue { get; set; }
