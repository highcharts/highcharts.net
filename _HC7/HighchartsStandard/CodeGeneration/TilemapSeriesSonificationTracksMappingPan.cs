...
{
	public partial class TilemapSeriesSonificationTracksMappingPan  : BaseObject
	{
		Hashtable h = new Hashtable();

		public TilemapSeriesSonificationTracksMappingPan()
		{
			MapFunction = MapFunction_DefaultValue = TilemapSeriesSonificationTracksMappingPanMapFunction.Linear;
			MapTo = MapTo_DefaultValue = "";
			Max = Max_DefaultValue = null;
			Min = Min_DefaultValue = null;
			Value = Value_DefaultValue = null;
			Within = Within_DefaultValue = TilemapSeriesSonificationTracksMappingPanWithin.Chart;
		...
		/// </summary>
		public TilemapSeriesSonificationTracksMappingPanMapFunction MapFunction { get; set; }
		private TilemapSeriesSonificationTracksMappingPanMapFunction MapFunction_DefaultValue { get; set; }
		...
		/// </summary>
		public TilemapSeriesSonificationTracksMappingPanWithin Within { get; set; }
		private TilemapSeriesSonificationTracksMappingPanWithin Within_DefaultValue { get; set; }
