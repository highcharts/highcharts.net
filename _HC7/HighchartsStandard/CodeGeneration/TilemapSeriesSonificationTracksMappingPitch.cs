...
{
	public partial class TilemapSeriesSonificationTracksMappingPitch  : BaseObject
	{
		Hashtable h = new Hashtable();

		public TilemapSeriesSonificationTracksMappingPitch()
		{
			MapFunction = MapFunction_DefaultValue = TilemapSeriesSonificationTracksMappingPitchMapFunction.Linear;
		...
		/// </summary>
		public TilemapSeriesSonificationTracksMappingPitchMapFunction MapFunction { get; set; }
		private TilemapSeriesSonificationTracksMappingPitchMapFunction MapFunction_DefaultValue { get; set; }
