...
{
	public partial class TilemapSeriesSonificationTracksMappingPlayDelay  : BaseObject
	{
		Hashtable h = new Hashtable();

		public TilemapSeriesSonificationTracksMappingPlayDelay()
		{
			MapFunction = MapFunction_DefaultValue = TilemapSeriesSonificationTracksMappingPlayDelayMapFunction.Linear;
			MapTo = MapTo_DefaultValue = "";
			Max = Max_DefaultValue = null;
			Min = Min_DefaultValue = null;
			Value = Value_DefaultValue = null;
			Within = Within_DefaultValue = TilemapSeriesSonificationTracksMappingPlayDelayWithin.Chart;
		...
		/// </summary>
		public TilemapSeriesSonificationTracksMappingPlayDelayMapFunction MapFunction { get; set; }
		private TilemapSeriesSonificationTracksMappingPlayDelayMapFunction MapFunction_DefaultValue { get; set; }
		...
		/// </summary>
		public TilemapSeriesSonificationTracksMappingPlayDelayWithin Within { get; set; }
		private TilemapSeriesSonificationTracksMappingPlayDelayWithin Within_DefaultValue { get; set; }
