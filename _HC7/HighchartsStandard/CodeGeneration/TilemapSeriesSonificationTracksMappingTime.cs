...
{
	public partial class TilemapSeriesSonificationTracksMappingTime  : BaseObject
	{
		Hashtable h = new Hashtable();

		public TilemapSeriesSonificationTracksMappingTime()
		{
			MapFunction = MapFunction_DefaultValue = TilemapSeriesSonificationTracksMappingTimeMapFunction.Linear;
			MapTo = MapTo_DefaultValue = "";
			Max = Max_DefaultValue = null;
			Min = Min_DefaultValue = null;
			Value = Value_DefaultValue = null;
			Within = Within_DefaultValue = TilemapSeriesSonificationTracksMappingTimeWithin.Chart;
		...
		/// </summary>
		public TilemapSeriesSonificationTracksMappingTimeMapFunction MapFunction { get; set; }
		private TilemapSeriesSonificationTracksMappingTimeMapFunction MapFunction_DefaultValue { get; set; }
		...
		/// </summary>
		public TilemapSeriesSonificationTracksMappingTimeWithin Within { get; set; }
		private TilemapSeriesSonificationTracksMappingTimeWithin Within_DefaultValue { get; set; }
