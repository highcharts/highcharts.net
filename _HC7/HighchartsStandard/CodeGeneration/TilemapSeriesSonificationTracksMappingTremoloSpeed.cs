...
{
	public partial class TilemapSeriesSonificationTracksMappingTremoloSpeed  : BaseObject
	{
		Hashtable h = new Hashtable();

		public TilemapSeriesSonificationTracksMappingTremoloSpeed()
		{
			MapFunction = MapFunction_DefaultValue = TilemapSeriesSonificationTracksMappingTremoloSpeedMapFunction.Linear;
			MapTo = MapTo_DefaultValue = "";
			Max = Max_DefaultValue = null;
			Min = Min_DefaultValue = null;
			Value = Value_DefaultValue = null;
			Within = Within_DefaultValue = TilemapSeriesSonificationTracksMappingTremoloSpeedWithin.Chart;
		...
		/// </summary>
		public TilemapSeriesSonificationTracksMappingTremoloSpeedMapFunction MapFunction { get; set; }
		private TilemapSeriesSonificationTracksMappingTremoloSpeedMapFunction MapFunction_DefaultValue { get; set; }
		...
		/// </summary>
		public TilemapSeriesSonificationTracksMappingTremoloSpeedWithin Within { get; set; }
		private TilemapSeriesSonificationTracksMappingTremoloSpeedWithin Within_DefaultValue { get; set; }
