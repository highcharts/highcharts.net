...
{
	public partial class TilemapSeriesSonificationTracksMappingVolume  : BaseObject
	{
		Hashtable h = new Hashtable();

		public TilemapSeriesSonificationTracksMappingVolume()
		{
			MapFunction = MapFunction_DefaultValue = TilemapSeriesSonificationTracksMappingVolumeMapFunction.Linear;
			MapTo = MapTo_DefaultValue = "";
			Max = Max_DefaultValue = null;
			Min = Min_DefaultValue = null;
			Value = Value_DefaultValue = null;
			Within = Within_DefaultValue = TilemapSeriesSonificationTracksMappingVolumeWithin.Chart;
		...
		/// </summary>
		public TilemapSeriesSonificationTracksMappingVolumeMapFunction MapFunction { get; set; }
		private TilemapSeriesSonificationTracksMappingVolumeMapFunction MapFunction_DefaultValue { get; set; }
		...
		/// </summary>
		public TilemapSeriesSonificationTracksMappingVolumeWithin Within { get; set; }
		private TilemapSeriesSonificationTracksMappingVolumeWithin Within_DefaultValue { get; set; }
