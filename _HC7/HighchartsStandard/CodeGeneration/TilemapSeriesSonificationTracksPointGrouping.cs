...
{
	public partial class TilemapSeriesSonificationTracksPointGrouping  : BaseObject
	{
		Hashtable h = new Hashtable();

		public TilemapSeriesSonificationTracksPointGrouping()
		{
		...
		/// </summary>
		public TilemapSeriesSonificationTracksPointGroupingAlgorithm Algorithm { get; set; }
		private TilemapSeriesSonificationTracksPointGroupingAlgorithm Algorithm_DefaultValue { get; set; }
		...
		internal override Hashtable ToHashtable(Highcharts highcharts)
		{
			...
			if (Algorithm != TilemapSeriesSonificationTracksPointGroupingAlgorithm.Null) h.Add("algorithm", highcharts.FirstCharacterToLower(Algorithm.ToString()));
