...
namespace Highsoft.Web.Mvc.Charts
{
	public partial class TimelineSeries  : Series
	{
		...
		public TimelineSeries()
		{
			...
			Dumbell = Dumbell_DefaultValue = new TimelineSeriesDumbell();
			...
			LegendSymbol = LegendSymbol_DefaultValue = TimelineSeriesLegendSymbol.Rectangle;
			...
			OnPoint = OnPoint_DefaultValue = new TimelineSeriesOnPoint();
			...
			Sonification = Sonification_DefaultValue = new TimelineSeriesSonification();
		...
		/// 
		/// </summary>
		public TimelineSeriesDumbell Dumbell { get; set; }
		private TimelineSeriesDumbell Dumbell_DefaultValue { get; set; }
		...
		private TimelineSeriesLegendSymbol LegendSymbol_DefaultValue { get; set; }
		...
		private TimelineSeriesOnPoint OnPoint_DefaultValue { get; set; }
		...
		private TimelineSeriesSonification Sonification_DefaultValue { get; set; }
