...
{
	public partial class TimelineSeriesDataDataLabels  : BaseObject
	{
		Hashtable h = new Hashtable();

		public TimelineSeriesDataDataLabels()
		{
		...
		/// </summary>
		public TimelineSeriesDataDataLabelsAlign Align { get; set; }
		private TimelineSeriesDataDataLabelsAlign Align_DefaultValue { get; set; }
		...
		/// </summary>
		public TimelineSeriesDataDataLabelsFilter Filter { get; set; }
		private TimelineSeriesDataDataLabelsFilter Filter_DefaultValue { get; set; }
		...
		/// </summary>
		public TimelineSeriesDataDataLabelsOverflow Overflow { get; set; }
		private TimelineSeriesDataDataLabelsOverflow Overflow_DefaultValue { get; set; }
		...
		/// </summary>
		public TimelineSeriesDataDataLabelsPosition Position { get; set; }
		private TimelineSeriesDataDataLabelsPosition Position_DefaultValue { get; set; }
		...
		/// </summary>
		public TimelineSeriesDataDataLabelsTextPath TextPath { get; set; }
		private TimelineSeriesDataDataLabelsTextPath TextPath_DefaultValue { get; set; }
		...
		/// </summary>
		public TimelineSeriesDataDataLabelsVerticalAlign VerticalAlign { get; set; }
		private TimelineSeriesDataDataLabelsVerticalAlign VerticalAlign_DefaultValue { get; set; }
		...
		internal override Hashtable ToHashtable(Highcharts highcharts)
		{
			...
			if (Align != TimelineSeriesDataDataLabelsAlign.Null) h.Add("align", highcharts.FirstCharacterToLower(Align.ToString()));
			...
			if (Overflow != TimelineSeriesDataDataLabelsOverflow.Null) h.Add("overflow", highcharts.FirstCharacterToLower(Overflow.ToString()));
			if (Padding != null) h.Add("padding",Padding);
			if (Position != TimelineSeriesDataDataLabelsPosition.Null) h.Add("position", highcharts.FirstCharacterToLower(Position.ToString()));
			...
			if (VerticalAlign != TimelineSeriesDataDataLabelsVerticalAlign.Null) h.Add("verticalAlign", highcharts.FirstCharacterToLower(VerticalAlign.ToString()));
			if (X != null) h.Add("x",X);
			if (Y != null) h.Add("y",Y);
