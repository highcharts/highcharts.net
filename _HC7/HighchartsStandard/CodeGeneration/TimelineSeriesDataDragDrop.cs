...
{
	public partial class TimelineSeriesDataDragDrop  : BaseObject
	{
		public TimelineSeriesDataDragDrop()
		{
			DraggableX = DraggableX_DefaultValue = null;
			DraggableY = DraggableY_DefaultValue = null;
			DragHandle = DragHandle_DefaultValue = new TimelineSeriesDataDragDropDragHandle();
			...
			GuideBox = GuideBox_DefaultValue = new TimelineSeriesDataDragDropGuideBox();
		...
		/// </summary>
		public TimelineSeriesDataDragDropDragHandle DragHandle { get; set; }
		private TimelineSeriesDataDragDropDragHandle DragHandle_DefaultValue { get; set; }
		...
		/// </summary>
		public TimelineSeriesDataDragDropGuideBox GuideBox { get; set; }
		private TimelineSeriesDataDragDropGuideBox GuideBox_DefaultValue { get; set; }
