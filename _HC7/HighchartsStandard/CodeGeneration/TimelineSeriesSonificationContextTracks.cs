...
{
	public partial class TimelineSeriesSonificationContextTracks  : BaseObject
	{
		Hashtable h = new Hashtable();

		public TimelineSeriesSonificationContextTracks()
		{
			ActiveWhen = ActiveWhen_DefaultValue = new TimelineSeriesSonificationContextTracksActiveWhen();
			Instrument = Instrument_DefaultValue = null;
			InstrumentString = InstrumentString_DefaultValue = "null";
			Mapping = Mapping_DefaultValue = new TimelineSeriesSonificationContextTracksMapping();
			MidiName = MidiName_DefaultValue = "";
			PointGrouping = PointGrouping_DefaultValue = new TimelineSeriesSonificationContextTracksPointGrouping();
			...
			Type = Type_DefaultValue = TimelineSeriesSonificationContextTracksType.Instrument;
			ValueInterval = ValueInterval_DefaultValue = null;
			ValueMapFunction = ValueMapFunction_DefaultValue = TimelineSeriesSonificationContextTracksValueMapFunction.Linear;
		...
		/// </summary>
		public TimelineSeriesSonificationContextTracksActiveWhen ActiveWhen { get; set; }
		private TimelineSeriesSonificationContextTracksActiveWhen ActiveWhen_DefaultValue { get; set; }
		...
		/// </summary>
		public TimelineSeriesSonificationContextTracksMapping Mapping { get; set; }
		private TimelineSeriesSonificationContextTracksMapping Mapping_DefaultValue { get; set; }
		...
		/// </summary>
		public TimelineSeriesSonificationContextTracksPointGrouping PointGrouping { get; set; }
		private TimelineSeriesSonificationContextTracksPointGrouping PointGrouping_DefaultValue { get; set; }
		...
		/// </summary>
		public TimelineSeriesSonificationContextTracksType Type { get; set; }
		private TimelineSeriesSonificationContextTracksType Type_DefaultValue { get; set; }
		...
		/// </summary>
		public TimelineSeriesSonificationContextTracksValueMapFunction ValueMapFunction { get; set; }
		private TimelineSeriesSonificationContextTracksValueMapFunction ValueMapFunction_DefaultValue { get; set; }
