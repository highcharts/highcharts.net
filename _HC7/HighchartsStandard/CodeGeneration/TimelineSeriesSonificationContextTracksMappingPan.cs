...
{
	public partial class TimelineSeriesSonificationContextTracksMappingPan  : BaseObject
	{
		Hashtable h = new Hashtable();

		public TimelineSeriesSonificationContextTracksMappingPan()
		{
			MapFunction = MapFunction_DefaultValue = TimelineSeriesSonificationContextTracksMappingPanMapFunction.Linear;
			MapTo = MapTo_DefaultValue = "";
			Max = Max_DefaultValue = null;
			Min = Min_DefaultValue = null;
			Value = Value_DefaultValue = null;
			Within = Within_DefaultValue = TimelineSeriesSonificationContextTracksMappingPanWithin.Chart;
		...
		/// </summary>
		public TimelineSeriesSonificationContextTracksMappingPanMapFunction MapFunction { get; set; }
		private TimelineSeriesSonificationContextTracksMappingPanMapFunction MapFunction_DefaultValue { get; set; }
		...
		/// </summary>
		public TimelineSeriesSonificationContextTracksMappingPanWithin Within { get; set; }
		private TimelineSeriesSonificationContextTracksMappingPanWithin Within_DefaultValue { get; set; }
