...
{
	public partial class TimelineSeriesSonificationContextTracksMappingPitch  : BaseObject
	{
		Hashtable h = new Hashtable();

		public TimelineSeriesSonificationContextTracksMappingPitch()
		{
			MapFunction = MapFunction_DefaultValue = TimelineSeriesSonificationContextTracksMappingPitchMapFunction.Linear;
		...
		/// </summary>
		public TimelineSeriesSonificationContextTracksMappingPitchMapFunction MapFunction { get; set; }
		private TimelineSeriesSonificationContextTracksMappingPitchMapFunction MapFunction_DefaultValue { get; set; }
