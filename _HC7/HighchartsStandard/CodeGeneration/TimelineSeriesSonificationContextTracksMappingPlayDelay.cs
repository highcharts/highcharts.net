...
{
	public partial class TimelineSeriesSonificationContextTracksMappingPlayDelay  : BaseObject
	{
		Hashtable h = new Hashtable();

		public TimelineSeriesSonificationContextTracksMappingPlayDelay()
		{
			MapFunction = MapFunction_DefaultValue = TimelineSeriesSonificationContextTracksMappingPlayDelayMapFunction.Linear;
			MapTo = MapTo_DefaultValue = "";
			Max = Max_DefaultValue = null;
			Min = Min_DefaultValue = null;
			Value = Value_DefaultValue = null;
			Within = Within_DefaultValue = TimelineSeriesSonificationContextTracksMappingPlayDelayWithin.Chart;
		...
		/// </summary>
		public TimelineSeriesSonificationContextTracksMappingPlayDelayMapFunction MapFunction { get; set; }
		private TimelineSeriesSonificationContextTracksMappingPlayDelayMapFunction MapFunction_DefaultValue { get; set; }
		...
		/// </summary>
		public TimelineSeriesSonificationContextTracksMappingPlayDelayWithin Within { get; set; }
		private TimelineSeriesSonificationContextTracksMappingPlayDelayWithin Within_DefaultValue { get; set; }
