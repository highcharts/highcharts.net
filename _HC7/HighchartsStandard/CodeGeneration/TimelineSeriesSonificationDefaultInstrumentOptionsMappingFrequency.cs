...
{
	public partial class TimelineSeriesSonificationDefaultInstrumentOptionsMappingFrequency  : BaseObject
	{
		Hashtable h = new Hashtable();

		public TimelineSeriesSonificationDefaultInstrumentOptionsMappingFrequency()
		{
			MapFunction = MapFunction_DefaultValue = TimelineSeriesSonificationDefaultInstrumentOptionsMappingFrequencyMapFunction.Linear;
			MapTo = MapTo_DefaultValue = "";
			Max = Max_DefaultValue = null;
			Min = Min_DefaultValue = null;
			Value = Value_DefaultValue = null;
			Within = Within_DefaultValue = TimelineSeriesSonificationDefaultInstrumentOptionsMappingFrequencyWithin.Chart;
		...
		/// </summary>
		public TimelineSeriesSonificationDefaultInstrumentOptionsMappingFrequencyMapFunction MapFunction { get; set; }
		private TimelineSeriesSonificationDefaultInstrumentOptionsMappingFrequencyMapFunction MapFunction_DefaultValue { get; set; }
		...
		/// </summary>
		public TimelineSeriesSonificationDefaultInstrumentOptionsMappingFrequencyWithin Within { get; set; }
		private TimelineSeriesSonificationDefaultInstrumentOptionsMappingFrequencyWithin Within_DefaultValue { get; set; }
