...
{
	public partial class TimelineSeriesSonificationDefaultSpeechOptionsMapping  : BaseObject
	{
		Hashtable h = new Hashtable();

		public TimelineSeriesSonificationDefaultSpeechOptionsMapping()
		{
			Frequency = Frequency_DefaultValue = new TimelineSeriesSonificationDefaultSpeechOptionsMappingFrequency();
			GapBetweenNotes = GapBetweenNotes_DefaultValue = new TimelineSeriesSonificationDefaultSpeechOptionsMappingGapBetweenNotes();
			Highpass = Highpass_DefaultValue = new TimelineSeriesSonificationDefaultSpeechOptionsMappingHighpass();
			Lowpass = Lowpass_DefaultValue = new TimelineSeriesSonificationDefaultSpeechOptionsMappingLowpass();
			NoteDuration = NoteDuration_DefaultValue = new TimelineSeriesSonificationDefaultSpeechOptionsMappingNoteDuration();
			Pan = Pan_DefaultValue = new TimelineSeriesSonificationDefaultSpeechOptionsMappingPan();
			Pitch = Pitch_DefaultValue = new TimelineSeriesSonificationDefaultSpeechOptionsMappingPitch();
			PitchString = PitchString_DefaultValue = "null";
			PitchNumber = PitchNumber_DefaultValue = null;
			PlayDelay = PlayDelay_DefaultValue = new TimelineSeriesSonificationDefaultSpeechOptionsMappingPlayDelay();
			Time = Time_DefaultValue = new TimelineSeriesSonificationDefaultSpeechOptionsMappingTime();
			TimeString = TimeString_DefaultValue = "null";
			TimeNumber = TimeNumber_DefaultValue = null;
			Tremolo = Tremolo_DefaultValue = new TimelineSeriesSonificationDefaultSpeechOptionsMappingTremolo();
			Volume = Volume_DefaultValue = new TimelineSeriesSonificationDefaultSpeechOptionsMappingVolume();
		...
		/// </summary>
		public TimelineSeriesSonificationDefaultSpeechOptionsMappingFrequency Frequency { get; set; }
		private TimelineSeriesSonificationDefaultSpeechOptionsMappingFrequency Frequency_DefaultValue { get; set; }
		...
		/// </summary>
		public TimelineSeriesSonificationDefaultSpeechOptionsMappingGapBetweenNotes GapBetweenNotes { get; set; }
		private TimelineSeriesSonificationDefaultSpeechOptionsMappingGapBetweenNotes GapBetweenNotes_DefaultValue { get; set; }
		...
		/// </summary>
		public TimelineSeriesSonificationDefaultSpeechOptionsMappingHighpass Highpass { get; set; }
		private TimelineSeriesSonificationDefaultSpeechOptionsMappingHighpass Highpass_DefaultValue { get; set; }
		...
		/// </summary>
		public TimelineSeriesSonificationDefaultSpeechOptionsMappingLowpass Lowpass { get; set; }
		private TimelineSeriesSonificationDefaultSpeechOptionsMappingLowpass Lowpass_DefaultValue { get; set; }
		...
		/// </summary>
		public TimelineSeriesSonificationDefaultSpeechOptionsMappingNoteDuration NoteDuration { get; set; }
		private TimelineSeriesSonificationDefaultSpeechOptionsMappingNoteDuration NoteDuration_DefaultValue { get; set; }
		...
		/// </summary>
		public TimelineSeriesSonificationDefaultSpeechOptionsMappingPan Pan { get; set; }
		private TimelineSeriesSonificationDefaultSpeechOptionsMappingPan Pan_DefaultValue { get; set; }
		...
		/// </summary>
		public TimelineSeriesSonificationDefaultSpeechOptionsMappingPitch Pitch { get; set; }
		private TimelineSeriesSonificationDefaultSpeechOptionsMappingPitch Pitch_DefaultValue { get; set; }
		...
		/// </summary>
		public TimelineSeriesSonificationDefaultSpeechOptionsMappingPlayDelay PlayDelay { get; set; }
		private TimelineSeriesSonificationDefaultSpeechOptionsMappingPlayDelay PlayDelay_DefaultValue { get; set; }
		...
		/// </summary>
		public TimelineSeriesSonificationDefaultSpeechOptionsMappingTime Time { get; set; }
		private TimelineSeriesSonificationDefaultSpeechOptionsMappingTime Time_DefaultValue { get; set; }
		...
		/// </summary>
		public TimelineSeriesSonificationDefaultSpeechOptionsMappingTremolo Tremolo { get; set; }
		private TimelineSeriesSonificationDefaultSpeechOptionsMappingTremolo Tremolo_DefaultValue { get; set; }
		 

		/// <summary>
		/// The volume of notes, from 0 to 1.
		/// </summary>
		public TimelineSeriesSonificationDefaultSpeechOptionsMappingVolume Volume { get; set; }
		private TimelineSeriesSonificationDefaultSpeechOptionsMappingVolume Volume_DefaultValue { get; set; }
