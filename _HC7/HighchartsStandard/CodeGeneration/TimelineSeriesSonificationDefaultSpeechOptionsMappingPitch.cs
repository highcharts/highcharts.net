...
{
	public partial class TimelineSeriesSonificationDefaultSpeechOptionsMappingPitch  : BaseObject
	{
		Hashtable h = new Hashtable();

		public TimelineSeriesSonificationDefaultSpeechOptionsMappingPitch()
		{
			MapFunction = MapFunction_DefaultValue = TimelineSeriesSonificationDefaultSpeechOptionsMappingPitchMapFunction.Linear;
		...
		/// </summary>
		public TimelineSeriesSonificationDefaultSpeechOptionsMappingPitchMapFunction MapFunction { get; set; }
		private TimelineSeriesSonificationDefaultSpeechOptionsMappingPitchMapFunction MapFunction_DefaultValue { get; set; }
