...
namespace Highsoft.Web.Mvc.Charts
{
	public partial class TimelineSeriesSonificationDefaultSpeechOptionsMappingPitch  : BaseObject
	{
		...
		{
			if (MapFunction != TimelineSeriesSonificationDefaultSpeechOptionsMappingPitchMapFunction.Null) h.Add("mapFunction", highcharts.FirstCharacterToLower(MapFunction.ToString()));
