...
{
	public partial class TimelineSeriesSonificationPointGrouping  : BaseObject
	{
		Hashtable h = new Hashtable();

		public TimelineSeriesSonificationPointGrouping()
		{
		...
		/// </summary>
		public TimelineSeriesSonificationPointGroupingAlgorithm Algorithm { get; set; }
		private TimelineSeriesSonificationPointGroupingAlgorithm Algorithm_DefaultValue { get; set; }
		...
		internal override Hashtable ToHashtable(Highcharts highcharts)
		{
			...
			if (Algorithm != TimelineSeriesSonificationPointGroupingAlgorithm.Null) h.Add("algorithm", highcharts.FirstCharacterToLower(Algorithm.ToString()));
