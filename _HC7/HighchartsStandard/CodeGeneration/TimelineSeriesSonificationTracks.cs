...
{
	public partial class TimelineSeriesSonificationTracks  : BaseObject
	{
		Hashtable h = new Hashtable();

		public TimelineSeriesSonificationTracks()
		{
			ActiveWhen = ActiveWhen_DefaultValue = new TimelineSeriesSonificationTracksActiveWhen();
			Instrument = Instrument_DefaultValue = null;
			InstrumentString = InstrumentString_DefaultValue = "null";
			Mapping = Mapping_DefaultValue = new TimelineSeriesSonificationTracksMapping();
			MidiName = MidiName_DefaultValue = "";
			PointGrouping = PointGrouping_DefaultValue = new TimelineSeriesSonificationTracksPointGrouping();
			RoundToMusicalNotes = RoundToMusicalNotes_DefaultValue = true;
			ShowPlayMarker = ShowPlayMarker_DefaultValue = true;
			Type = Type_DefaultValue = TimelineSeriesSonificationTracksType.Instrument;
		...
		/// </summary>
		public TimelineSeriesSonificationTracksActiveWhen ActiveWhen { get; set; }
		private TimelineSeriesSonificationTracksActiveWhen ActiveWhen_DefaultValue { get; set; }
		...
		/// </summary>
		public TimelineSeriesSonificationTracksMapping Mapping { get; set; }
		private TimelineSeriesSonificationTracksMapping Mapping_DefaultValue { get; set; }
		...
		/// </summary>
		public TimelineSeriesSonificationTracksPointGrouping PointGrouping { get; set; }
		private TimelineSeriesSonificationTracksPointGrouping PointGrouping_DefaultValue { get; set; }
		...
		/// </summary>
		public TimelineSeriesSonificationTracksType Type { get; set; }
		private TimelineSeriesSonificationTracksType Type_DefaultValue { get; set; }
