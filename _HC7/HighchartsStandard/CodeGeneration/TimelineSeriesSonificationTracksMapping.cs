...
{
	public partial class TimelineSeriesSonificationTracksMapping  : BaseObject
	{
		Hashtable h = new Hashtable();

		public TimelineSeriesSonificationTracksMapping()
		{
			Frequency = Frequency_DefaultValue = new TimelineSeriesSonificationTracksMappingFrequency();
			GapBetweenNotes = GapBetweenNotes_DefaultValue = new TimelineSeriesSonificationTracksMappingGapBetweenNotes();
			Highpass = Highpass_DefaultValue = new TimelineSeriesSonificationTracksMappingHighpass();
			Lowpass = Lowpass_DefaultValue = new TimelineSeriesSonificationTracksMappingLowpass();
			NoteDuration = NoteDuration_DefaultValue = new TimelineSeriesSonificationTracksMappingNoteDuration();
			Pan = Pan_DefaultValue = new TimelineSeriesSonificationTracksMappingPan();
			Pitch = Pitch_DefaultValue = new TimelineSeriesSonificationTracksMappingPitch();
			PitchString = PitchString_DefaultValue = "null";
			PitchNumber = PitchNumber_DefaultValue = null;
			PlayDelay = PlayDelay_DefaultValue = new TimelineSeriesSonificationTracksMappingPlayDelay();
			Time = Time_DefaultValue = new TimelineSeriesSonificationTracksMappingTime();
			TimeString = TimeString_DefaultValue = "null";
			TimeNumber = TimeNumber_DefaultValue = null;
			Tremolo = Tremolo_DefaultValue = new TimelineSeriesSonificationTracksMappingTremolo();
			Volume = Volume_DefaultValue = new TimelineSeriesSonificationTracksMappingVolume();
		...
		/// </summary>
		public TimelineSeriesSonificationTracksMappingFrequency Frequency { get; set; }
		private TimelineSeriesSonificationTracksMappingFrequency Frequency_DefaultValue { get; set; }
		...
		/// </summary>
		public TimelineSeriesSonificationTracksMappingGapBetweenNotes GapBetweenNotes { get; set; }
		private TimelineSeriesSonificationTracksMappingGapBetweenNotes GapBetweenNotes_DefaultValue { get; set; }
		...
		/// </summary>
		public TimelineSeriesSonificationTracksMappingHighpass Highpass { get; set; }
		private TimelineSeriesSonificationTracksMappingHighpass Highpass_DefaultValue { get; set; }
		...
		/// </summary>
		public TimelineSeriesSonificationTracksMappingLowpass Lowpass { get; set; }
		private TimelineSeriesSonificationTracksMappingLowpass Lowpass_DefaultValue { get; set; }
		...
		/// </summary>
		public TimelineSeriesSonificationTracksMappingNoteDuration NoteDuration { get; set; }
		private TimelineSeriesSonificationTracksMappingNoteDuration NoteDuration_DefaultValue { get; set; }
		...
		/// </summary>
		public TimelineSeriesSonificationTracksMappingPan Pan { get; set; }
		private TimelineSeriesSonificationTracksMappingPan Pan_DefaultValue { get; set; }
		...
		/// </summary>
		public TimelineSeriesSonificationTracksMappingPitch Pitch { get; set; }
		private TimelineSeriesSonificationTracksMappingPitch Pitch_DefaultValue { get; set; }
		...
		/// </summary>
		public TimelineSeriesSonificationTracksMappingPlayDelay PlayDelay { get; set; }
		private TimelineSeriesSonificationTracksMappingPlayDelay PlayDelay_DefaultValue { get; set; }
		...
		/// </summary>
		public TimelineSeriesSonificationTracksMappingTime Time { get; set; }
		private TimelineSeriesSonificationTracksMappingTime Time_DefaultValue { get; set; }
		...
		/// </summary>
		public TimelineSeriesSonificationTracksMappingTremolo Tremolo { get; set; }
		private TimelineSeriesSonificationTracksMappingTremolo Tremolo_DefaultValue { get; set; }
		 

		/// <summary>
		/// The volume of notes, from 0 to 1.
		/// </summary>
		public TimelineSeriesSonificationTracksMappingVolume Volume { get; set; }
		private TimelineSeriesSonificationTracksMappingVolume Volume_DefaultValue { get; set; }
