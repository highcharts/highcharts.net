...
{
	public partial class TimelineSeriesSonificationTracksMappingFrequency  : BaseObject
	{
		Hashtable h = new Hashtable();

		public TimelineSeriesSonificationTracksMappingFrequency()
		{
			MapFunction = MapFunction_DefaultValue = TimelineSeriesSonificationTracksMappingFrequencyMapFunction.Linear;
			MapTo = MapTo_DefaultValue = "";
			Max = Max_DefaultValue = null;
			Min = Min_DefaultValue = null;
			Value = Value_DefaultValue = null;
			Within = Within_DefaultValue = TimelineSeriesSonificationTracksMappingFrequencyWithin.Chart;
		...
		/// </summary>
		public TimelineSeriesSonificationTracksMappingFrequencyMapFunction MapFunction { get; set; }
		private TimelineSeriesSonificationTracksMappingFrequencyMapFunction MapFunction_DefaultValue { get; set; }
		...
		/// </summary>
		public TimelineSeriesSonificationTracksMappingFrequencyWithin Within { get; set; }
		private TimelineSeriesSonificationTracksMappingFrequencyWithin Within_DefaultValue { get; set; }
