...
{
	public partial class TimelineSeriesSonificationTracksMappingLowpassResonance  : BaseObject
	{
		Hashtable h = new Hashtable();

		public TimelineSeriesSonificationTracksMappingLowpassResonance()
		{
			MapFunction = MapFunction_DefaultValue = TimelineSeriesSonificationTracksMappingLowpassResonanceMapFunction.Linear;
			MapTo = MapTo_DefaultValue = "";
			Max = Max_DefaultValue = null;
			Min = Min_DefaultValue = null;
			Value = Value_DefaultValue = null;
			Within = Within_DefaultValue = TimelineSeriesSonificationTracksMappingLowpassResonanceWithin.Chart;
		...
		/// </summary>
		public TimelineSeriesSonificationTracksMappingLowpassResonanceMapFunction MapFunction { get; set; }
		private TimelineSeriesSonificationTracksMappingLowpassResonanceMapFunction MapFunction_DefaultValue { get; set; }
		...
		/// </summary>
		public TimelineSeriesSonificationTracksMappingLowpassResonanceWithin Within { get; set; }
		private TimelineSeriesSonificationTracksMappingLowpassResonanceWithin Within_DefaultValue { get; set; }
