...
{
	public partial class TimelineSeriesSonificationTracksMappingPan  : BaseObject
	{
		Hashtable h = new Hashtable();

		public TimelineSeriesSonificationTracksMappingPan()
		{
			MapFunction = MapFunction_DefaultValue = TimelineSeriesSonificationTracksMappingPanMapFunction.Linear;
			MapTo = MapTo_DefaultValue = "";
			Max = Max_DefaultValue = null;
			Min = Min_DefaultValue = null;
			Value = Value_DefaultValue = null;
			Within = Within_DefaultValue = TimelineSeriesSonificationTracksMappingPanWithin.Chart;
		...
		/// </summary>
		public TimelineSeriesSonificationTracksMappingPanMapFunction MapFunction { get; set; }
		private TimelineSeriesSonificationTracksMappingPanMapFunction MapFunction_DefaultValue { get; set; }
		...
		/// </summary>
		public TimelineSeriesSonificationTracksMappingPanWithin Within { get; set; }
		private TimelineSeriesSonificationTracksMappingPanWithin Within_DefaultValue { get; set; }
