...
{
	public partial class TimelineSeriesSonificationTracksMappingPitch  : BaseObject
	{
		Hashtable h = new Hashtable();

		public TimelineSeriesSonificationTracksMappingPitch()
		{
			MapFunction = MapFunction_DefaultValue = TimelineSeriesSonificationTracksMappingPitchMapFunction.Linear;
		...
		/// </summary>
		public TimelineSeriesSonificationTracksMappingPitchMapFunction MapFunction { get; set; }
		private TimelineSeriesSonificationTracksMappingPitchMapFunction MapFunction_DefaultValue { get; set; }
