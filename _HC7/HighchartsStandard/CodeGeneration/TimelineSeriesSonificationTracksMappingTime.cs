...
{
	public partial class TimelineSeriesSonificationTracksMappingTime  : BaseObject
	{
		Hashtable h = new Hashtable();

		public TimelineSeriesSonificationTracksMappingTime()
		{
			MapFunction = MapFunction_DefaultValue = TimelineSeriesSonificationTracksMappingTimeMapFunction.Linear;
			MapTo = MapTo_DefaultValue = "";
			Max = Max_DefaultValue = null;
			Min = Min_DefaultValue = null;
			Value = Value_DefaultValue = null;
			Within = Within_DefaultValue = TimelineSeriesSonificationTracksMappingTimeWithin.Chart;
		...
		/// </summary>
		public TimelineSeriesSonificationTracksMappingTimeMapFunction MapFunction { get; set; }
		private TimelineSeriesSonificationTracksMappingTimeMapFunction MapFunction_DefaultValue { get; set; }
		...
		/// </summary>
		public TimelineSeriesSonificationTracksMappingTimeWithin Within { get; set; }
		private TimelineSeriesSonificationTracksMappingTimeWithin Within_DefaultValue { get; set; }
