...
{
	public partial class TimelineSeriesSonificationTracksMappingTremoloDepth  : BaseObject
	{
		Hashtable h = new Hashtable();

		public TimelineSeriesSonificationTracksMappingTremoloDepth()
		{
			MapFunction = MapFunction_DefaultValue = TimelineSeriesSonificationTracksMappingTremoloDepthMapFunction.Linear;
			MapTo = MapTo_DefaultValue = "";
			Max = Max_DefaultValue = null;
			Min = Min_DefaultValue = null;
			Value = Value_DefaultValue = null;
			Within = Within_DefaultValue = TimelineSeriesSonificationTracksMappingTremoloDepthWithin.Chart;
		...
		/// </summary>
		public TimelineSeriesSonificationTracksMappingTremoloDepthMapFunction MapFunction { get; set; }
		private TimelineSeriesSonificationTracksMappingTremoloDepthMapFunction MapFunction_DefaultValue { get; set; }
		...
		/// </summary>
		public TimelineSeriesSonificationTracksMappingTremoloDepthWithin Within { get; set; }
		private TimelineSeriesSonificationTracksMappingTremoloDepthWithin Within_DefaultValue { get; set; }
