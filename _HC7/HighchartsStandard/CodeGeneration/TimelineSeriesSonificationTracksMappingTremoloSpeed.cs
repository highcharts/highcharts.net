...
{
	public partial class TimelineSeriesSonificationTracksMappingTremoloSpeed  : BaseObject
	{
		Hashtable h = new Hashtable();

		public TimelineSeriesSonificationTracksMappingTremoloSpeed()
		{
			MapFunction = MapFunction_DefaultValue = TimelineSeriesSonificationTracksMappingTremoloSpeedMapFunction.Linear;
			MapTo = MapTo_DefaultValue = "";
			Max = Max_DefaultValue = null;
			Min = Min_DefaultValue = null;
			Value = Value_DefaultValue = null;
			Within = Within_DefaultValue = TimelineSeriesSonificationTracksMappingTremoloSpeedWithin.Chart;
		...
		/// </summary>
		public TimelineSeriesSonificationTracksMappingTremoloSpeedMapFunction MapFunction { get; set; }
		private TimelineSeriesSonificationTracksMappingTremoloSpeedMapFunction MapFunction_DefaultValue { get; set; }
		...
		/// </summary>
		public TimelineSeriesSonificationTracksMappingTremoloSpeedWithin Within { get; set; }
		private TimelineSeriesSonificationTracksMappingTremoloSpeedWithin Within_DefaultValue { get; set; }
