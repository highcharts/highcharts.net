...
{
	public partial class TimelineSeriesSonificationTracksMappingVolume  : BaseObject
	{
		Hashtable h = new Hashtable();

		public TimelineSeriesSonificationTracksMappingVolume()
		{
			MapFunction = MapFunction_DefaultValue = TimelineSeriesSonificationTracksMappingVolumeMapFunction.Linear;
			MapTo = MapTo_DefaultValue = "";
			Max = Max_DefaultValue = null;
			Min = Min_DefaultValue = null;
			Value = Value_DefaultValue = null;
			Within = Within_DefaultValue = TimelineSeriesSonificationTracksMappingVolumeWithin.Chart;
		...
		/// </summary>
		public TimelineSeriesSonificationTracksMappingVolumeMapFunction MapFunction { get; set; }
		private TimelineSeriesSonificationTracksMappingVolumeMapFunction MapFunction_DefaultValue { get; set; }
		...
		/// </summary>
		public TimelineSeriesSonificationTracksMappingVolumeWithin Within { get; set; }
		private TimelineSeriesSonificationTracksMappingVolumeWithin Within_DefaultValue { get; set; }
