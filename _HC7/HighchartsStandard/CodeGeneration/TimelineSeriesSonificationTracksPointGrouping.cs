...
{
	public partial class TimelineSeriesSonificationTracksPointGrouping  : BaseObject
	{
		Hashtable h = new Hashtable();

		public TimelineSeriesSonificationTracksPointGrouping()
		{
		...
		/// </summary>
		public TimelineSeriesSonificationTracksPointGroupingAlgorithm Algorithm { get; set; }
		private TimelineSeriesSonificationTracksPointGroupingAlgorithm Algorithm_DefaultValue { get; set; }
		...
		internal override Hashtable ToHashtable(Highcharts highcharts)
		{
			...
			if (Algorithm != TimelineSeriesSonificationTracksPointGroupingAlgorithm.Null) h.Add("algorithm", highcharts.FirstCharacterToLower(Algorithm.ToString()));
