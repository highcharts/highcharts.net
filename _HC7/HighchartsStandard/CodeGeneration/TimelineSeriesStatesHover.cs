...
{
	public partial class TimelineSeriesStatesHover  : BaseObject
	{
		public TimelineSeriesStatesHover()
		{
			Animation = Animation_DefaultValue = new Animation() { Enabled = true };
			AnimationBool = AnimationBool_DefaultValue = null;
			Enabled = Enabled_DefaultValue = true;
			Halo = Halo_DefaultValue = new TimelineSeriesStatesHoverHalo();
			LineWidth = LineWidth_DefaultValue = null;
			LineWidthPlus = LineWidthPlus_DefaultValue = 1;
			Marker = Marker_DefaultValue = new TimelineSeriesStatesHoverMarker();
		...
		/// </summary>
		public TimelineSeriesStatesHoverHalo Halo { get; set; }
		private TimelineSeriesStatesHoverHalo Halo_DefaultValue { get; set; }
		...
		/// </summary>
		public TimelineSeriesStatesHoverMarker Marker { get; set; }
		private TimelineSeriesStatesHoverMarker Marker_DefaultValue { get; set; }
