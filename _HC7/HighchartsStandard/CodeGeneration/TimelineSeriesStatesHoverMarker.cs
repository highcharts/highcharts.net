...
{
	public partial class TimelineSeriesStatesHoverMarker  : BaseObject
	{
		public TimelineSeriesStatesHoverMarker()
		{
			...
			States = States_DefaultValue = new TimelineSeriesStatesHoverMarkerStates();
		...
		/// </summary>
		public TimelineSeriesStatesHoverMarkerStates States { get; set; }
		private TimelineSeriesStatesHoverMarkerStates States_DefaultValue { get; set; }
