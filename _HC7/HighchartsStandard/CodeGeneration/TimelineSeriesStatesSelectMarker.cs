...
{
	public partial class TimelineSeriesStatesSelectMarker  : BaseObject
	{
		public TimelineSeriesStatesSelectMarker()
		{
			...
			States = States_DefaultValue = new TimelineSeriesStatesSelectMarkerStates();
		...
		/// </summary>
		public TimelineSeriesStatesSelectMarkerStates States { get; set; }
		private TimelineSeriesStatesSelectMarkerStates States_DefaultValue { get; set; }
