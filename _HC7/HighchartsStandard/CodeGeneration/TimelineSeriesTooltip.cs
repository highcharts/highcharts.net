...
{
	public partial class TimelineSeriesTooltip  : BaseObject
	{
		public TimelineSeriesTooltip()
		{
			...
			HeaderShape = HeaderShape_DefaultValue = TimelineSeriesTooltipHeaderShape.Callout;
		...
		/// </summary>
		public TimelineSeriesTooltipHeaderShape HeaderShape { get; set; }
		private TimelineSeriesTooltipHeaderShape HeaderShape_DefaultValue { get; set; }
		...
		internal override Hashtable ToHashtable()
		{
			...
			if (NullFormatter != NullFormatter_DefaultValue) { h.Add("nullFormatter",NullFormatter); Highcharts.AddFunction("63d5a0f0-5862-4d62-a8fc-d0c4df57713d.nullFormatter", NullFormatter); }  
			if (Outside != Outside_DefaultValue) h.Add("outside",Outside);
			if (Padding != Padding_DefaultValue) h.Add("padding",Padding);
			if (PointFormat != PointFormat_DefaultValue) h.Add("pointFormat",PointFormat);
			if (PointFormatter != PointFormatter_DefaultValue) { h.Add("pointFormatter",PointFormatter); Highcharts.AddFunction("0368d46d-79f4-41c3-a4c1-360b7b0b48f1.pointFormatter", PointFormatter); }  
