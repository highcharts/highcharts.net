...
{
	public partial class TreegraphSeriesDataDragDrop  : BaseObject
	{
		Hashtable h = new Hashtable();

		public TreegraphSeriesDataDragDrop()
		{
			DraggableX = DraggableX_DefaultValue = null;
			DraggableY = DraggableY_DefaultValue = null;
			DragHandle = DragHandle_DefaultValue = new TreegraphSeriesDataDragDropDragHandle();
			...
			GuideBox = GuideBox_DefaultValue = new TreegraphSeriesDataDragDropGuideBox();
		...
		/// </summary>
		public TreegraphSeriesDataDragDropDragHandle DragHandle { get; set; }
		private TreegraphSeriesDataDragDropDragHandle DragHandle_DefaultValue { get; set; }
		...
		/// </summary>
		public TreegraphSeriesDataDragDropGuideBox GuideBox { get; set; }
		private TreegraphSeriesDataDragDropGuideBox GuideBox_DefaultValue { get; set; }
