...
{
	public partial class TreegraphSeriesDataLabels  : BaseObject
	{
		Hashtable h = new Hashtable();

		public TreegraphSeriesDataLabels()
		{
		...
		/// </summary>
		public TreegraphSeriesDataLabelsAlign Align { get; set; }
		private TreegraphSeriesDataLabelsAlign Align_DefaultValue { get; set; }
		...
		/// </summary>
		public TreegraphSeriesDataLabelsFilter Filter { get; set; }
		private TreegraphSeriesDataLabelsFilter Filter_DefaultValue { get; set; }
		...
		/// </summary>
		public TreegraphSeriesDataLabelsOverflow Overflow { get; set; }
		private TreegraphSeriesDataLabelsOverflow Overflow_DefaultValue { get; set; }
		...
		/// </summary>
		public TreegraphSeriesDataLabelsPosition Position { get; set; }
		private TreegraphSeriesDataLabelsPosition Position_DefaultValue { get; set; }
		...
		/// </summary>
		public TreegraphSeriesDataLabelsTextPath TextPath { get; set; }
		private TreegraphSeriesDataLabelsTextPath TextPath_DefaultValue { get; set; }
		...
		/// </summary>
		public TreegraphSeriesDataLabelsVerticalAlign VerticalAlign { get; set; }
		private TreegraphSeriesDataLabelsVerticalAlign VerticalAlign_DefaultValue { get; set; }
		...
		internal override Hashtable ToHashtable(Highcharts highcharts)
		{
			...
			if (Align != TreegraphSeriesDataLabelsAlign.Null) h.Add("align", highcharts.FirstCharacterToLower(Align.ToString()));
			...
			if (Overflow != TreegraphSeriesDataLabelsOverflow.Null) h.Add("overflow", highcharts.FirstCharacterToLower(Overflow.ToString()));
			if (Padding != null) h.Add("padding",Padding);
			if (Position != TreegraphSeriesDataLabelsPosition.Null) h.Add("position", highcharts.FirstCharacterToLower(Position.ToString()));
			...
			if (VerticalAlign != TreegraphSeriesDataLabelsVerticalAlign.Null) h.Add("verticalAlign", highcharts.FirstCharacterToLower(VerticalAlign.ToString()));
			if (X != null) h.Add("x",X);
			if (Y != null) h.Add("y",Y);
