...
{
	public partial class TreegraphSeriesDataMarker  : BaseObject
	{
		Hashtable h = new Hashtable();

		public TreegraphSeriesDataMarker()
		{
			...
			States = States_DefaultValue = new TreegraphSeriesDataMarkerStates();
		...
		/// </summary>
		public TreegraphSeriesDataMarkerStates States { get; set; }
		private TreegraphSeriesDataMarkerStates States_DefaultValue { get; set; }
