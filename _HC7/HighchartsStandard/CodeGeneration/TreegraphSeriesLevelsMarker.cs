...
{
	public partial class TreegraphSeriesLevelsMarker  : BaseObject
	{
		Hashtable h = new Hashtable();

		public TreegraphSeriesLevelsMarker()
		{
			...
			States = States_DefaultValue = new TreegraphSeriesLevelsMarkerStates();
		...
		/// </summary>
		public TreegraphSeriesLevelsMarkerStates States { get; set; }
		private TreegraphSeriesLevelsMarkerStates States_DefaultValue { get; set; }
