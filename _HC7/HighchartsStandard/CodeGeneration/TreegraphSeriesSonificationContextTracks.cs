...
{
	public partial class TreegraphSeriesSonificationContextTracks  : BaseObject
	{
		Hashtable h = new Hashtable();

		public TreegraphSeriesSonificationContextTracks()
		{
			ActiveWhen = ActiveWhen_DefaultValue = new TreegraphSeriesSonificationContextTracksActiveWhen();
			Instrument = Instrument_DefaultValue = null;
			InstrumentString = InstrumentString_DefaultValue = "null";
			Mapping = Mapping_DefaultValue = new TreegraphSeriesSonificationContextTracksMapping();
			MidiName = MidiName_DefaultValue = "";
			PointGrouping = PointGrouping_DefaultValue = new TreegraphSeriesSonificationContextTracksPointGrouping();
			...
			Type = Type_DefaultValue = TreegraphSeriesSonificationContextTracksType.Instrument;
			ValueInterval = ValueInterval_DefaultValue = null;
			ValueMapFunction = ValueMapFunction_DefaultValue = TreegraphSeriesSonificationContextTracksValueMapFunction.Linear;
		...
		/// </summary>
		public TreegraphSeriesSonificationContextTracksActiveWhen ActiveWhen { get; set; }
		private TreegraphSeriesSonificationContextTracksActiveWhen ActiveWhen_DefaultValue { get; set; }
		...
		/// </summary>
		public TreegraphSeriesSonificationContextTracksMapping Mapping { get; set; }
		private TreegraphSeriesSonificationContextTracksMapping Mapping_DefaultValue { get; set; }
		...
		/// </summary>
		public TreegraphSeriesSonificationContextTracksPointGrouping PointGrouping { get; set; }
		private TreegraphSeriesSonificationContextTracksPointGrouping PointGrouping_DefaultValue { get; set; }
		...
		/// </summary>
		public TreegraphSeriesSonificationContextTracksType Type { get; set; }
		private TreegraphSeriesSonificationContextTracksType Type_DefaultValue { get; set; }
		...
		/// </summary>
		public TreegraphSeriesSonificationContextTracksValueMapFunction ValueMapFunction { get; set; }
		private TreegraphSeriesSonificationContextTracksValueMapFunction ValueMapFunction_DefaultValue { get; set; }
