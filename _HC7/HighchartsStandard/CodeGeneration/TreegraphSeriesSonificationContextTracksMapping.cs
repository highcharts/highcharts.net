...
{
	public partial class TreegraphSeriesSonificationContextTracksMapping  : BaseObject
	{
		Hashtable h = new Hashtable();

		public TreegraphSeriesSonificationContextTracksMapping()
		{
			Frequency = Frequency_DefaultValue = new TreegraphSeriesSonificationContextTracksMappingFrequency();
			GapBetweenNotes = GapBetweenNotes_DefaultValue = new TreegraphSeriesSonificationContextTracksMappingGapBetweenNotes();
			Highpass = Highpass_DefaultValue = new TreegraphSeriesSonificationContextTracksMappingHighpass();
			Lowpass = Lowpass_DefaultValue = new TreegraphSeriesSonificationContextTracksMappingLowpass();
			NoteDuration = NoteDuration_DefaultValue = new TreegraphSeriesSonificationContextTracksMappingNoteDuration();
			Pan = Pan_DefaultValue = new TreegraphSeriesSonificationContextTracksMappingPan();
			Pitch = Pitch_DefaultValue = new TreegraphSeriesSonificationContextTracksMappingPitch();
			PitchString = PitchString_DefaultValue = "null";
			PitchNumber = PitchNumber_DefaultValue = null;
			PlayDelay = PlayDelay_DefaultValue = new TreegraphSeriesSonificationContextTracksMappingPlayDelay();
			Time = Time_DefaultValue = new TreegraphSeriesSonificationContextTracksMappingTime();
			TimeString = TimeString_DefaultValue = "null";
			TimeNumber = TimeNumber_DefaultValue = null;
			Tremolo = Tremolo_DefaultValue = new TreegraphSeriesSonificationContextTracksMappingTremolo();
			Volume = Volume_DefaultValue = new TreegraphSeriesSonificationContextTracksMappingVolume();
		...
		/// </summary>
		public TreegraphSeriesSonificationContextTracksMappingFrequency Frequency { get; set; }
		private TreegraphSeriesSonificationContextTracksMappingFrequency Frequency_DefaultValue { get; set; }
		...
		/// </summary>
		public TreegraphSeriesSonificationContextTracksMappingGapBetweenNotes GapBetweenNotes { get; set; }
		private TreegraphSeriesSonificationContextTracksMappingGapBetweenNotes GapBetweenNotes_DefaultValue { get; set; }
		...
		/// </summary>
		public TreegraphSeriesSonificationContextTracksMappingHighpass Highpass { get; set; }
		private TreegraphSeriesSonificationContextTracksMappingHighpass Highpass_DefaultValue { get; set; }
		...
		/// </summary>
		public TreegraphSeriesSonificationContextTracksMappingLowpass Lowpass { get; set; }
		private TreegraphSeriesSonificationContextTracksMappingLowpass Lowpass_DefaultValue { get; set; }
		...
		/// </summary>
		public TreegraphSeriesSonificationContextTracksMappingNoteDuration NoteDuration { get; set; }
		private TreegraphSeriesSonificationContextTracksMappingNoteDuration NoteDuration_DefaultValue { get; set; }
		...
		/// </summary>
		public TreegraphSeriesSonificationContextTracksMappingPan Pan { get; set; }
		private TreegraphSeriesSonificationContextTracksMappingPan Pan_DefaultValue { get; set; }
		...
		/// </summary>
		public TreegraphSeriesSonificationContextTracksMappingPitch Pitch { get; set; }
		private TreegraphSeriesSonificationContextTracksMappingPitch Pitch_DefaultValue { get; set; }
		...
		/// </summary>
		public TreegraphSeriesSonificationContextTracksMappingPlayDelay PlayDelay { get; set; }
		private TreegraphSeriesSonificationContextTracksMappingPlayDelay PlayDelay_DefaultValue { get; set; }
		...
		/// </summary>
		public TreegraphSeriesSonificationContextTracksMappingTime Time { get; set; }
		private TreegraphSeriesSonificationContextTracksMappingTime Time_DefaultValue { get; set; }
		...
		/// </summary>
		public TreegraphSeriesSonificationContextTracksMappingTremolo Tremolo { get; set; }
		private TreegraphSeriesSonificationContextTracksMappingTremolo Tremolo_DefaultValue { get; set; }
		 

		/// <summary>
		/// The volume of notes, from 0 to 1.
		/// </summary>
		public TreegraphSeriesSonificationContextTracksMappingVolume Volume { get; set; }
		private TreegraphSeriesSonificationContextTracksMappingVolume Volume_DefaultValue { get; set; }
