...
{
	public partial class TreegraphSeriesSonificationContextTracksMappingPitch  : BaseObject
	{
		Hashtable h = new Hashtable();

		public TreegraphSeriesSonificationContextTracksMappingPitch()
		{
			MapFunction = MapFunction_DefaultValue = TreegraphSeriesSonificationContextTracksMappingPitchMapFunction.Linear;
		...
		/// </summary>
		public TreegraphSeriesSonificationContextTracksMappingPitchMapFunction MapFunction { get; set; }
		private TreegraphSeriesSonificationContextTracksMappingPitchMapFunction MapFunction_DefaultValue { get; set; }
