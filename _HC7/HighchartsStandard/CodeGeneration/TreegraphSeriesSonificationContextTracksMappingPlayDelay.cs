...
{
	public partial class TreegraphSeriesSonificationContextTracksMappingPlayDelay  : BaseObject
	{
		Hashtable h = new Hashtable();

		public TreegraphSeriesSonificationContextTracksMappingPlayDelay()
		{
			MapFunction = MapFunction_DefaultValue = TreegraphSeriesSonificationContextTracksMappingPlayDelayMapFunction.Linear;
			MapTo = MapTo_DefaultValue = "";
			Max = Max_DefaultValue = null;
			Min = Min_DefaultValue = null;
			Value = Value_DefaultValue = null;
			Within = Within_DefaultValue = TreegraphSeriesSonificationContextTracksMappingPlayDelayWithin.Chart;
		...
		/// </summary>
		public TreegraphSeriesSonificationContextTracksMappingPlayDelayMapFunction MapFunction { get; set; }
		private TreegraphSeriesSonificationContextTracksMappingPlayDelayMapFunction MapFunction_DefaultValue { get; set; }
		...
		/// </summary>
		public TreegraphSeriesSonificationContextTracksMappingPlayDelayWithin Within { get; set; }
		private TreegraphSeriesSonificationContextTracksMappingPlayDelayWithin Within_DefaultValue { get; set; }
