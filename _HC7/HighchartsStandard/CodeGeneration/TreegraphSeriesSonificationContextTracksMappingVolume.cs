...
{
	public partial class TreegraphSeriesSonificationContextTracksMappingVolume  : BaseObject
	{
		Hashtable h = new Hashtable();

		public TreegraphSeriesSonificationContextTracksMappingVolume()
		{
			MapFunction = MapFunction_DefaultValue = TreegraphSeriesSonificationContextTracksMappingVolumeMapFunction.Linear;
			MapTo = MapTo_DefaultValue = "";
			Max = Max_DefaultValue = null;
			Min = Min_DefaultValue = null;
			Value = Value_DefaultValue = null;
			Within = Within_DefaultValue = TreegraphSeriesSonificationContextTracksMappingVolumeWithin.Chart;
		...
		/// </summary>
		public TreegraphSeriesSonificationContextTracksMappingVolumeMapFunction MapFunction { get; set; }
		private TreegraphSeriesSonificationContextTracksMappingVolumeMapFunction MapFunction_DefaultValue { get; set; }
		...
		/// </summary>
		public TreegraphSeriesSonificationContextTracksMappingVolumeWithin Within { get; set; }
		private TreegraphSeriesSonificationContextTracksMappingVolumeWithin Within_DefaultValue { get; set; }
