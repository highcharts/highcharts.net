...
{
	public partial class TreegraphSeriesSonificationDefaultInstrumentOptionsMappingHighpassResonance  : BaseObject
	{
		Hashtable h = new Hashtable();

		public TreegraphSeriesSonificationDefaultInstrumentOptionsMappingHighpassResonance()
		{
			MapFunction = MapFunction_DefaultValue = TreegraphSeriesSonificationDefaultInstrumentOptionsMappingHighpassResonanceMapFunction.Linear;
			MapTo = MapTo_DefaultValue = "";
			Max = Max_DefaultValue = null;
			Min = Min_DefaultValue = null;
			Value = Value_DefaultValue = null;
			Within = Within_DefaultValue = TreegraphSeriesSonificationDefaultInstrumentOptionsMappingHighpassResonanceWithin.Chart;
		...
		/// </summary>
		public TreegraphSeriesSonificationDefaultInstrumentOptionsMappingHighpassResonanceMapFunction MapFunction { get; set; }
		private TreegraphSeriesSonificationDefaultInstrumentOptionsMappingHighpassResonanceMapFunction MapFunction_DefaultValue { get; set; }
		...
		/// </summary>
		public TreegraphSeriesSonificationDefaultInstrumentOptionsMappingHighpassResonanceWithin Within { get; set; }
		private TreegraphSeriesSonificationDefaultInstrumentOptionsMappingHighpassResonanceWithin Within_DefaultValue { get; set; }
