...
{
	public partial class TreegraphSeriesSonificationDefaultSpeechOptions  : BaseObject
	{
		Hashtable h = new Hashtable();

		public TreegraphSeriesSonificationDefaultSpeechOptions()
		{
			ActiveWhen = ActiveWhen_DefaultValue = new TreegraphSeriesSonificationDefaultSpeechOptionsActiveWhen();
			Language = Language_DefaultValue = "en-US";
			Mapping = Mapping_DefaultValue = new TreegraphSeriesSonificationDefaultSpeechOptionsMapping();
			PointGrouping = PointGrouping_DefaultValue = new TreegraphSeriesSonificationDefaultSpeechOptionsPointGrouping();
			PreferredVoice = PreferredVoice_DefaultValue = "";
			ShowPlayMarker = ShowPlayMarker_DefaultValue = true;
			Type = Type_DefaultValue = TreegraphSeriesSonificationDefaultSpeechOptionsType.Instrument;
		...
		/// </summary>
		public TreegraphSeriesSonificationDefaultSpeechOptionsActiveWhen ActiveWhen { get; set; }
		private TreegraphSeriesSonificationDefaultSpeechOptionsActiveWhen ActiveWhen_DefaultValue { get; set; }
		...
		/// </summary>
		public TreegraphSeriesSonificationDefaultSpeechOptionsMapping Mapping { get; set; }
		private TreegraphSeriesSonificationDefaultSpeechOptionsMapping Mapping_DefaultValue { get; set; }
		 

		/// <summary>
		/// Options for point grouping, specifically for instrument tracks.
		/// </summary>
		public TreegraphSeriesSonificationDefaultSpeechOptionsPointGrouping PointGrouping { get; set; }
		private TreegraphSeriesSonificationDefaultSpeechOptionsPointGrouping PointGrouping_DefaultValue { get; set; }
		...
		/// </summary>
		public TreegraphSeriesSonificationDefaultSpeechOptionsType Type { get; set; }
		private TreegraphSeriesSonificationDefaultSpeechOptionsType Type_DefaultValue { get; set; }
