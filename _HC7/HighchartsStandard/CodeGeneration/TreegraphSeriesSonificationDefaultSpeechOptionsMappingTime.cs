...
{
	public partial class TreegraphSeriesSonificationDefaultSpeechOptionsMappingTime  : BaseObject
	{
		Hashtable h = new Hashtable();

		public TreegraphSeriesSonificationDefaultSpeechOptionsMappingTime()
		{
			MapFunction = MapFunction_DefaultValue = TreegraphSeriesSonificationDefaultSpeechOptionsMappingTimeMapFunction.Linear;
			MapTo = MapTo_DefaultValue = "";
			Max = Max_DefaultValue = null;
			Min = Min_DefaultValue = null;
			Value = Value_DefaultValue = null;
			Within = Within_DefaultValue = TreegraphSeriesSonificationDefaultSpeechOptionsMappingTimeWithin.Chart;
		...
		/// </summary>
		public TreegraphSeriesSonificationDefaultSpeechOptionsMappingTimeMapFunction MapFunction { get; set; }
		private TreegraphSeriesSonificationDefaultSpeechOptionsMappingTimeMapFunction MapFunction_DefaultValue { get; set; }
		...
		/// </summary>
		public TreegraphSeriesSonificationDefaultSpeechOptionsMappingTimeWithin Within { get; set; }
		private TreegraphSeriesSonificationDefaultSpeechOptionsMappingTimeWithin Within_DefaultValue { get; set; }
