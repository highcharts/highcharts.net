...
{
	public partial class TreegraphSeriesSonificationPointGrouping  : BaseObject
	{
		Hashtable h = new Hashtable();

		public TreegraphSeriesSonificationPointGrouping()
		{
		...
		/// </summary>
		public TreegraphSeriesSonificationPointGroupingAlgorithm Algorithm { get; set; }
		private TreegraphSeriesSonificationPointGroupingAlgorithm Algorithm_DefaultValue { get; set; }
		...
		internal override Hashtable ToHashtable(Highcharts highcharts)
		{
			...
			if (Algorithm != TreegraphSeriesSonificationPointGroupingAlgorithm.Null) h.Add("algorithm", highcharts.FirstCharacterToLower(Algorithm.ToString()));
