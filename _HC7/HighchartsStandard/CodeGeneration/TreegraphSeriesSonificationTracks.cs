...
{
	public partial class TreegraphSeriesSonificationTracks  : BaseObject
	{
		Hashtable h = new Hashtable();

		public TreegraphSeriesSonificationTracks()
		{
			ActiveWhen = ActiveWhen_DefaultValue = new TreegraphSeriesSonificationTracksActiveWhen();
			Instrument = Instrument_DefaultValue = null;
			InstrumentString = InstrumentString_DefaultValue = "null";
			Mapping = Mapping_DefaultValue = new TreegraphSeriesSonificationTracksMapping();
			MidiName = MidiName_DefaultValue = "";
			PointGrouping = PointGrouping_DefaultValue = new TreegraphSeriesSonificationTracksPointGrouping();
			RoundToMusicalNotes = RoundToMusicalNotes_DefaultValue = true;
			ShowPlayMarker = ShowPlayMarker_DefaultValue = true;
			Type = Type_DefaultValue = TreegraphSeriesSonificationTracksType.Instrument;
		...
		/// </summary>
		public TreegraphSeriesSonificationTracksActiveWhen ActiveWhen { get; set; }
		private TreegraphSeriesSonificationTracksActiveWhen ActiveWhen_DefaultValue { get; set; }
		...
		/// </summary>
		public TreegraphSeriesSonificationTracksMapping Mapping { get; set; }
		private TreegraphSeriesSonificationTracksMapping Mapping_DefaultValue { get; set; }
		...
		/// </summary>
		public TreegraphSeriesSonificationTracksPointGrouping PointGrouping { get; set; }
		private TreegraphSeriesSonificationTracksPointGrouping PointGrouping_DefaultValue { get; set; }
		...
		/// </summary>
		public TreegraphSeriesSonificationTracksType Type { get; set; }
		private TreegraphSeriesSonificationTracksType Type_DefaultValue { get; set; }
