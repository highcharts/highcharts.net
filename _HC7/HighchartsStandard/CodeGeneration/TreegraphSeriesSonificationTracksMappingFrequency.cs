...
{
	public partial class TreegraphSeriesSonificationTracksMappingFrequency  : BaseObject
	{
		Hashtable h = new Hashtable();

		public TreegraphSeriesSonificationTracksMappingFrequency()
		{
			MapFunction = MapFunction_DefaultValue = TreegraphSeriesSonificationTracksMappingFrequencyMapFunction.Linear;
			MapTo = MapTo_DefaultValue = "";
			Max = Max_DefaultValue = null;
			Min = Min_DefaultValue = null;
			Value = Value_DefaultValue = null;
			Within = Within_DefaultValue = TreegraphSeriesSonificationTracksMappingFrequencyWithin.Chart;
		...
		/// </summary>
		public TreegraphSeriesSonificationTracksMappingFrequencyMapFunction MapFunction { get; set; }
		private TreegraphSeriesSonificationTracksMappingFrequencyMapFunction MapFunction_DefaultValue { get; set; }
		...
		/// </summary>
		public TreegraphSeriesSonificationTracksMappingFrequencyWithin Within { get; set; }
		private TreegraphSeriesSonificationTracksMappingFrequencyWithin Within_DefaultValue { get; set; }
