...
{
	public partial class TreegraphSeriesSonificationTracksMappingLowpassResonance  : BaseObject
	{
		Hashtable h = new Hashtable();

		public TreegraphSeriesSonificationTracksMappingLowpassResonance()
		{
			MapFunction = MapFunction_DefaultValue = TreegraphSeriesSonificationTracksMappingLowpassResonanceMapFunction.Linear;
			MapTo = MapTo_DefaultValue = "";
			Max = Max_DefaultValue = null;
			Min = Min_DefaultValue = null;
			Value = Value_DefaultValue = null;
			Within = Within_DefaultValue = TreegraphSeriesSonificationTracksMappingLowpassResonanceWithin.Chart;
		...
		/// </summary>
		public TreegraphSeriesSonificationTracksMappingLowpassResonanceMapFunction MapFunction { get; set; }
		private TreegraphSeriesSonificationTracksMappingLowpassResonanceMapFunction MapFunction_DefaultValue { get; set; }
		...
		/// </summary>
		public TreegraphSeriesSonificationTracksMappingLowpassResonanceWithin Within { get; set; }
		private TreegraphSeriesSonificationTracksMappingLowpassResonanceWithin Within_DefaultValue { get; set; }
