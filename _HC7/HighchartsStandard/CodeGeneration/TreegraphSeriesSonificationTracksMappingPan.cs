...
{
	public partial class TreegraphSeriesSonificationTracksMappingPan  : BaseObject
	{
		Hashtable h = new Hashtable();

		public TreegraphSeriesSonificationTracksMappingPan()
		{
			MapFunction = MapFunction_DefaultValue = TreegraphSeriesSonificationTracksMappingPanMapFunction.Linear;
			MapTo = MapTo_DefaultValue = "";
			Max = Max_DefaultValue = null;
			Min = Min_DefaultValue = null;
			Value = Value_DefaultValue = null;
			Within = Within_DefaultValue = TreegraphSeriesSonificationTracksMappingPanWithin.Chart;
		...
		/// </summary>
		public TreegraphSeriesSonificationTracksMappingPanMapFunction MapFunction { get; set; }
		private TreegraphSeriesSonificationTracksMappingPanMapFunction MapFunction_DefaultValue { get; set; }
		...
		/// </summary>
		public TreegraphSeriesSonificationTracksMappingPanWithin Within { get; set; }
		private TreegraphSeriesSonificationTracksMappingPanWithin Within_DefaultValue { get; set; }
