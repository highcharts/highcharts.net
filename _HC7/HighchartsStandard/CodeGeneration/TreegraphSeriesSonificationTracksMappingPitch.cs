...
{
	public partial class TreegraphSeriesSonificationTracksMappingPitch  : BaseObject
	{
		Hashtable h = new Hashtable();

		public TreegraphSeriesSonificationTracksMappingPitch()
		{
			MapFunction = MapFunction_DefaultValue = TreegraphSeriesSonificationTracksMappingPitchMapFunction.Linear;
		...
		/// </summary>
		public TreegraphSeriesSonificationTracksMappingPitchMapFunction MapFunction { get; set; }
		private TreegraphSeriesSonificationTracksMappingPitchMapFunction MapFunction_DefaultValue { get; set; }
