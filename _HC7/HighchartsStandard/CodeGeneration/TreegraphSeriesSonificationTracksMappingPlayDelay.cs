...
{
	public partial class TreegraphSeriesSonificationTracksMappingPlayDelay  : BaseObject
	{
		Hashtable h = new Hashtable();

		public TreegraphSeriesSonificationTracksMappingPlayDelay()
		{
			MapFunction = MapFunction_DefaultValue = TreegraphSeriesSonificationTracksMappingPlayDelayMapFunction.Linear;
			MapTo = MapTo_DefaultValue = "";
			Max = Max_DefaultValue = null;
			Min = Min_DefaultValue = null;
			Value = Value_DefaultValue = null;
			Within = Within_DefaultValue = TreegraphSeriesSonificationTracksMappingPlayDelayWithin.Chart;
		...
		/// </summary>
		public TreegraphSeriesSonificationTracksMappingPlayDelayMapFunction MapFunction { get; set; }
		private TreegraphSeriesSonificationTracksMappingPlayDelayMapFunction MapFunction_DefaultValue { get; set; }
		...
		/// </summary>
		public TreegraphSeriesSonificationTracksMappingPlayDelayWithin Within { get; set; }
		private TreegraphSeriesSonificationTracksMappingPlayDelayWithin Within_DefaultValue { get; set; }
