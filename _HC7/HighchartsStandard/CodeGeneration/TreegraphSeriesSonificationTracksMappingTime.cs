...
{
	public partial class TreegraphSeriesSonificationTracksMappingTime  : BaseObject
	{
		Hashtable h = new Hashtable();

		public TreegraphSeriesSonificationTracksMappingTime()
		{
			MapFunction = MapFunction_DefaultValue = TreegraphSeriesSonificationTracksMappingTimeMapFunction.Linear;
			MapTo = MapTo_DefaultValue = "";
			Max = Max_DefaultValue = null;
			Min = Min_DefaultValue = null;
			Value = Value_DefaultValue = null;
			Within = Within_DefaultValue = TreegraphSeriesSonificationTracksMappingTimeWithin.Chart;
		...
		/// </summary>
		public TreegraphSeriesSonificationTracksMappingTimeMapFunction MapFunction { get; set; }
		private TreegraphSeriesSonificationTracksMappingTimeMapFunction MapFunction_DefaultValue { get; set; }
		...
		/// </summary>
		public TreegraphSeriesSonificationTracksMappingTimeWithin Within { get; set; }
		private TreegraphSeriesSonificationTracksMappingTimeWithin Within_DefaultValue { get; set; }
