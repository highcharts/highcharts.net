...
{
	public partial class TreegraphSeriesSonificationTracksMappingTremoloDepth  : BaseObject
	{
		Hashtable h = new Hashtable();

		public TreegraphSeriesSonificationTracksMappingTremoloDepth()
		{
			MapFunction = MapFunction_DefaultValue = TreegraphSeriesSonificationTracksMappingTremoloDepthMapFunction.Linear;
			MapTo = MapTo_DefaultValue = "";
			Max = Max_DefaultValue = null;
			Min = Min_DefaultValue = null;
			Value = Value_DefaultValue = null;
			Within = Within_DefaultValue = TreegraphSeriesSonificationTracksMappingTremoloDepthWithin.Chart;
		...
		/// </summary>
		public TreegraphSeriesSonificationTracksMappingTremoloDepthMapFunction MapFunction { get; set; }
		private TreegraphSeriesSonificationTracksMappingTremoloDepthMapFunction MapFunction_DefaultValue { get; set; }
		...
		/// </summary>
		public TreegraphSeriesSonificationTracksMappingTremoloDepthWithin Within { get; set; }
		private TreegraphSeriesSonificationTracksMappingTremoloDepthWithin Within_DefaultValue { get; set; }
