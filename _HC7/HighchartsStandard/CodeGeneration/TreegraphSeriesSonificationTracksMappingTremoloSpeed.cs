...
{
	public partial class TreegraphSeriesSonificationTracksMappingTremoloSpeed  : BaseObject
	{
		Hashtable h = new Hashtable();

		public TreegraphSeriesSonificationTracksMappingTremoloSpeed()
		{
			MapFunction = MapFunction_DefaultValue = TreegraphSeriesSonificationTracksMappingTremoloSpeedMapFunction.Linear;
			MapTo = MapTo_DefaultValue = "";
			Max = Max_DefaultValue = null;
			Min = Min_DefaultValue = null;
			Value = Value_DefaultValue = null;
			Within = Within_DefaultValue = TreegraphSeriesSonificationTracksMappingTremoloSpeedWithin.Chart;
		...
		/// </summary>
		public TreegraphSeriesSonificationTracksMappingTremoloSpeedMapFunction MapFunction { get; set; }
		private TreegraphSeriesSonificationTracksMappingTremoloSpeedMapFunction MapFunction_DefaultValue { get; set; }
		...
		/// </summary>
		public TreegraphSeriesSonificationTracksMappingTremoloSpeedWithin Within { get; set; }
		private TreegraphSeriesSonificationTracksMappingTremoloSpeedWithin Within_DefaultValue { get; set; }
