...
{
	public partial class TreegraphSeriesSonificationTracksMappingVolume  : BaseObject
	{
		Hashtable h = new Hashtable();

		public TreegraphSeriesSonificationTracksMappingVolume()
		{
			MapFunction = MapFunction_DefaultValue = TreegraphSeriesSonificationTracksMappingVolumeMapFunction.Linear;
			MapTo = MapTo_DefaultValue = "";
			Max = Max_DefaultValue = null;
			Min = Min_DefaultValue = null;
			Value = Value_DefaultValue = null;
			Within = Within_DefaultValue = TreegraphSeriesSonificationTracksMappingVolumeWithin.Chart;
		...
		/// </summary>
		public TreegraphSeriesSonificationTracksMappingVolumeMapFunction MapFunction { get; set; }
		private TreegraphSeriesSonificationTracksMappingVolumeMapFunction MapFunction_DefaultValue { get; set; }
		...
		/// </summary>
		public TreegraphSeriesSonificationTracksMappingVolumeWithin Within { get; set; }
		private TreegraphSeriesSonificationTracksMappingVolumeWithin Within_DefaultValue { get; set; }
