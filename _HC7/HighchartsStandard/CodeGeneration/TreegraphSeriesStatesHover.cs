...
{
	public partial class TreegraphSeriesStatesHover  : BaseObject
	{
		Hashtable h = new Hashtable();

		public TreegraphSeriesStatesHover()
		{
			Animation = Animation_DefaultValue = new Animation();
			Enabled = Enabled_DefaultValue = null;
			Halo = Halo_DefaultValue = new TreegraphSeriesStatesHoverHalo();
			LineWidth = LineWidth_DefaultValue = null;
			LineWidthPlus = LineWidthPlus_DefaultValue = null;
			Marker = Marker_DefaultValue = new TreegraphSeriesStatesHoverMarker();
		...
		/// </summary>
		public TreegraphSeriesStatesHoverHalo Halo { get; set; }
		private TreegraphSeriesStatesHoverHalo Halo_DefaultValue { get; set; }
		...
		/// </summary>
		public TreegraphSeriesStatesHoverMarker Marker { get; set; }
		private TreegraphSeriesStatesHoverMarker Marker_DefaultValue { get; set; }
