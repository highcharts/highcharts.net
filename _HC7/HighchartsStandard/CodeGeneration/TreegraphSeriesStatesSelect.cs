...
{
	public partial class TreegraphSeriesStatesSelect  : BaseObject
	{
		Hashtable h = new Hashtable();

		public TreegraphSeriesStatesSelect()
		{
			Animation = Animation_DefaultValue = new Animation();
			Enabled = Enabled_DefaultValue = null;
			Halo = Halo_DefaultValue = new TreegraphSeriesStatesSelectHalo();
			LineWidth = LineWidth_DefaultValue = null;
			LineWidthPlus = LineWidthPlus_DefaultValue = null;
			Marker = Marker_DefaultValue = new TreegraphSeriesStatesSelectMarker();
		...
		/// </summary>
		public TreegraphSeriesStatesSelectHalo Halo { get; set; }
		private TreegraphSeriesStatesSelectHalo Halo_DefaultValue { get; set; }
		...
		/// </summary>
		public TreegraphSeriesStatesSelectMarker Marker { get; set; }
		private TreegraphSeriesStatesSelectMarker Marker_DefaultValue { get; set; }
