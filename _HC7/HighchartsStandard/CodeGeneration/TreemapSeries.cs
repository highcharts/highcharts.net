...
namespace Highsoft.Web.Mvc.Charts
{
	public partial class TreemapSeries  : Series
	{
		...
		/// </summary>
		public TreemapSeriesAccessibility Accessibility { get; set; }
		private TreemapSeriesAccessibility Accessibility_DefaultValue { get; set; }
		...
		/// </summary>
		public TreemapSeriesBoostBlending BoostBlending { get; set; }
		private TreemapSeriesBoostBlending BoostBlending_DefaultValue { get; set; }
		...
		/// </summary>
		public TreemapSeriesBreadcrumbs Breadcrumbs { get; set; }
		private TreemapSeriesBreadcrumbs Breadcrumbs_DefaultValue { get; set; }
		...
		/// </summary>
		public TreemapSeriesLegendSymbol LegendSymbol { get; set; }
		private TreemapSeriesLegendSymbol LegendSymbol_DefaultValue { get; set; }
		...
		/// </summary>
		public TreemapSeriesSonification Sonification { get; set; }
		private TreemapSeriesSonification Sonification_DefaultValue { get; set; }
		...
		/// </summary>
		public TreemapSeriesTraverseUpButton TraverseUpButton { get; set; }
		private TreemapSeriesTraverseUpButton TraverseUpButton_DefaultValue { get; set; }
		...
		internal override Hashtable ToHashtable(Highcharts highcharts)
		{
			...
			if (BoostBlending != TreemapSeriesBoostBlending.Null) h.Add("boostBlending", highcharts.FirstCharacterToLower(BoostBlending.ToString()));
			...
			if (Cursor != TreemapSeriesCursor.Null) h.Add("cursor", highcharts.FirstCharacterToLower(Cursor.ToString()));
			if (Custom != null) h.Add("custom",Custom);
			if (DashStyle != TreemapSeriesDashStyle.Null) h.Add("dashStyle", highcharts.FirstCharacterToLower(DashStyle.ToString()));
			...
			if (FindNearestPointBy != TreemapSeriesFindNearestPointBy.Null) h.Add("findNearestPointBy", highcharts.FirstCharacterToLower(FindNearestPointBy.ToString()));
			...
			if (LayoutAlgorithm != TreemapSeriesLayoutAlgorithm.Null) h.Add("layoutAlgorithm", highcharts.FirstCharacterToLower(LayoutAlgorithm.ToString()));
			if (LayoutStartingDirection != TreemapSeriesLayoutStartingDirection.Null) h.Add("layoutStartingDirection", highcharts.FirstCharacterToLower(LayoutStartingDirection.ToString()));
			if (LegendIndex != null) h.Add("legendIndex",LegendIndex);
			if (LegendSymbol != TreemapSeriesLegendSymbol.Null) h.Add("legendSymbol", highcharts.FirstCharacterToLower(LegendSymbol.ToString()));
			if (LevelIsConstant != null) h.Add("levelIsConstant",LevelIsConstant);
			if (Levels != null) h.Add("levels", HashifyList(highcharts,Levels));
			if (Linecap != TreemapSeriesLinecap.Null) h.Add("linecap", highcharts.FirstCharacterToLower(Linecap.ToString()));
			...
			if (PointIntervalUnit != TreemapSeriesPointIntervalUnit.Null) h.Add("pointIntervalUnit", highcharts.FirstCharacterToLower(PointIntervalUnit.ToString()));
			...
			if (Stacking != TreemapSeriesStacking.Null) h.Add("stacking", highcharts.FirstCharacterToLower(Stacking.ToString()));
			if (States != null) h.Add("states",States.ToHashtable(highcharts));
			if (Step != TreemapSeriesStep.Null) h.Add("step", highcharts.FirstCharacterToLower(Step.ToString()));
