...
namespace Highsoft.Web.Mvc.Charts
{
	public partial class TreemapSeries  : Series
	{
		...
		{
			Accessibility = Accessibility_DefaultValue = new TreemapSeriesAccessibility();
			...
			BoostBlending = BoostBlending_DefaultValue = TreemapSeriesBoostBlending.Undefined;
			...
			LegendSymbol = LegendSymbol_DefaultValue = TreemapSeriesLegendSymbol.Rectangle;
			...
			Sonification = Sonification_DefaultValue = new TreemapSeriesSonification();
			...
			TraverseUpButton = TraverseUpButton_DefaultValue = new TreemapSeriesTraverseUpButton();
		...
		/// 
		/// </summary>
		public TreemapSeriesDumbell Dumbell { get; set; }
		private TreemapSeriesDumbell Dumbell_DefaultValue { get; set; }
		...
		internal override Hashtable ToHashtable(Highcharts highcharts)
		{
			...
			if (Levels != Levels_DefaultValue) h.Add("levels", HashifyList(highcharts,Levels));
