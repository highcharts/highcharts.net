...
namespace Highsoft.Web.Mvc.Charts
{
	public partial class TreemapSeriesBreadcrumbsPosition  : BaseObject
	{
		...
		{
			if (Align != TreemapSeriesBreadcrumbsPositionAlign.Null) h.Add("align", highcharts.FirstCharacterToLower(Align.ToString()));
			if (VerticalAlign != TreemapSeriesBreadcrumbsPositionVerticalAlign.Null) h.Add("verticalAlign", highcharts.FirstCharacterToLower(VerticalAlign.ToString()));
			if (X != null) h.Add("x",X);
			if (Y != null) h.Add("y",Y);
