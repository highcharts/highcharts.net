...
{
	public partial class TreemapSeriesDataDataLabels  : BaseObject
	{
		Hashtable h = new Hashtable();

		public TreemapSeriesDataDataLabels()
		{
		...
		/// </summary>
		public TreemapSeriesDataDataLabelsAlign Align { get; set; }
		private TreemapSeriesDataDataLabelsAlign Align_DefaultValue { get; set; }
		...
		/// </summary>
		public TreemapSeriesDataDataLabelsFilter Filter { get; set; }
		private TreemapSeriesDataDataLabelsFilter Filter_DefaultValue { get; set; }
		...
		/// </summary>
		public TreemapSeriesDataDataLabelsOverflow Overflow { get; set; }
		private TreemapSeriesDataDataLabelsOverflow Overflow_DefaultValue { get; set; }
		...
		/// </summary>
		public TreemapSeriesDataDataLabelsPosition Position { get; set; }
		private TreemapSeriesDataDataLabelsPosition Position_DefaultValue { get; set; }
		...
		/// </summary>
		public TreemapSeriesDataDataLabelsTextPath TextPath { get; set; }
		private TreemapSeriesDataDataLabelsTextPath TextPath_DefaultValue { get; set; }
		...
		/// </summary>
		public TreemapSeriesDataDataLabelsVerticalAlign VerticalAlign { get; set; }
		private TreemapSeriesDataDataLabelsVerticalAlign VerticalAlign_DefaultValue { get; set; }
		...
		internal override Hashtable ToHashtable(Highcharts highcharts)
		{
			...
			if (Align != TreemapSeriesDataDataLabelsAlign.Null) h.Add("align", highcharts.FirstCharacterToLower(Align.ToString()));
			...
			if (Overflow != TreemapSeriesDataDataLabelsOverflow.Null) h.Add("overflow", highcharts.FirstCharacterToLower(Overflow.ToString()));
			if (Padding != null) h.Add("padding",Padding);
			if (Position != TreemapSeriesDataDataLabelsPosition.Null) h.Add("position", highcharts.FirstCharacterToLower(Position.ToString()));
			...
			if (VerticalAlign != TreemapSeriesDataDataLabelsVerticalAlign.Null) h.Add("verticalAlign", highcharts.FirstCharacterToLower(VerticalAlign.ToString()));
			if (X != null) h.Add("x",X);
			if (Y != null) h.Add("y",Y);
