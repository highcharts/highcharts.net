...
{
	public partial class TreemapSeriesDataMarker  : BaseObject
	{
		Hashtable h = new Hashtable();

		public TreemapSeriesDataMarker()
		{
			...
			States = States_DefaultValue = new TreemapSeriesDataMarkerStates();
		...
		/// </summary>
		public TreemapSeriesDataMarkerStates States { get; set; }
		private TreemapSeriesDataMarkerStates States_DefaultValue { get; set; }
