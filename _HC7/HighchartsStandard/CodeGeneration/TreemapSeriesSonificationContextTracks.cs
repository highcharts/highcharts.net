...
{
	public partial class TreemapSeriesSonificationContextTracks  : BaseObject
	{
		Hashtable h = new Hashtable();

		public TreemapSeriesSonificationContextTracks()
		{
			ActiveWhen = ActiveWhen_DefaultValue = new TreemapSeriesSonificationContextTracksActiveWhen();
			Instrument = Instrument_DefaultValue = null;
			InstrumentString = InstrumentString_DefaultValue = "null";
			Mapping = Mapping_DefaultValue = new TreemapSeriesSonificationContextTracksMapping();
			MidiName = MidiName_DefaultValue = "";
			PointGrouping = PointGrouping_DefaultValue = new TreemapSeriesSonificationContextTracksPointGrouping();
			...
			Type = Type_DefaultValue = TreemapSeriesSonificationContextTracksType.Instrument;
			ValueInterval = ValueInterval_DefaultValue = null;
			ValueMapFunction = ValueMapFunction_DefaultValue = TreemapSeriesSonificationContextTracksValueMapFunction.Linear;
		...
		/// </summary>
		public TreemapSeriesSonificationContextTracksActiveWhen ActiveWhen { get; set; }
		private TreemapSeriesSonificationContextTracksActiveWhen ActiveWhen_DefaultValue { get; set; }
		...
		/// </summary>
		public TreemapSeriesSonificationContextTracksMapping Mapping { get; set; }
		private TreemapSeriesSonificationContextTracksMapping Mapping_DefaultValue { get; set; }
		...
		/// </summary>
		public TreemapSeriesSonificationContextTracksPointGrouping PointGrouping { get; set; }
		private TreemapSeriesSonificationContextTracksPointGrouping PointGrouping_DefaultValue { get; set; }
		...
		/// </summary>
		public TreemapSeriesSonificationContextTracksType Type { get; set; }
		private TreemapSeriesSonificationContextTracksType Type_DefaultValue { get; set; }
		...
		/// </summary>
		public TreemapSeriesSonificationContextTracksValueMapFunction ValueMapFunction { get; set; }
		private TreemapSeriesSonificationContextTracksValueMapFunction ValueMapFunction_DefaultValue { get; set; }
