...
{
	public partial class TreemapSeriesSonificationContextTracksMappingGapBetweenNotes  : BaseObject
	{
		Hashtable h = new Hashtable();

		public TreemapSeriesSonificationContextTracksMappingGapBetweenNotes()
		{
			MapFunction = MapFunction_DefaultValue = TreemapSeriesSonificationContextTracksMappingGapBetweenNotesMapFunction.Linear;
			MapTo = MapTo_DefaultValue = "";
			Max = Max_DefaultValue = null;
			Min = Min_DefaultValue = null;
			Value = Value_DefaultValue = null;
			Within = Within_DefaultValue = TreemapSeriesSonificationContextTracksMappingGapBetweenNotesWithin.Chart;
		...
		/// </summary>
		public TreemapSeriesSonificationContextTracksMappingGapBetweenNotesMapFunction MapFunction { get; set; }
		private TreemapSeriesSonificationContextTracksMappingGapBetweenNotesMapFunction MapFunction_DefaultValue { get; set; }
		...
		/// </summary>
		public TreemapSeriesSonificationContextTracksMappingGapBetweenNotesWithin Within { get; set; }
		private TreemapSeriesSonificationContextTracksMappingGapBetweenNotesWithin Within_DefaultValue { get; set; }
