...
{
	public partial class TreemapSeriesSonificationContextTracksMappingLowpassFrequency  : BaseObject
	{
		Hashtable h = new Hashtable();

		public TreemapSeriesSonificationContextTracksMappingLowpassFrequency()
		{
			MapFunction = MapFunction_DefaultValue = TreemapSeriesSonificationContextTracksMappingLowpassFrequencyMapFunction.Linear;
			MapTo = MapTo_DefaultValue = "";
			Max = Max_DefaultValue = null;
			Min = Min_DefaultValue = null;
			Value = Value_DefaultValue = null;
			Within = Within_DefaultValue = TreemapSeriesSonificationContextTracksMappingLowpassFrequencyWithin.Chart;
		...
		/// </summary>
		public TreemapSeriesSonificationContextTracksMappingLowpassFrequencyMapFunction MapFunction { get; set; }
		private TreemapSeriesSonificationContextTracksMappingLowpassFrequencyMapFunction MapFunction_DefaultValue { get; set; }
		...
		/// </summary>
		public TreemapSeriesSonificationContextTracksMappingLowpassFrequencyWithin Within { get; set; }
		private TreemapSeriesSonificationContextTracksMappingLowpassFrequencyWithin Within_DefaultValue { get; set; }
