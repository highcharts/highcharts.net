...
{
	public partial class TreemapSeriesSonificationContextTracksMappingPitch  : BaseObject
	{
		Hashtable h = new Hashtable();

		public TreemapSeriesSonificationContextTracksMappingPitch()
		{
			MapFunction = MapFunction_DefaultValue = TreemapSeriesSonificationContextTracksMappingPitchMapFunction.Linear;
		...
		/// </summary>
		public TreemapSeriesSonificationContextTracksMappingPitchMapFunction MapFunction { get; set; }
		private TreemapSeriesSonificationContextTracksMappingPitchMapFunction MapFunction_DefaultValue { get; set; }
