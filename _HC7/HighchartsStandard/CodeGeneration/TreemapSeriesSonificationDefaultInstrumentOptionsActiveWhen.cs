...
{
	public partial class TreemapSeriesSonificationDefaultInstrumentOptionsActiveWhen  : BaseObject
	{
		Hashtable h = new Hashtable();

		public TreemapSeriesSonificationDefaultInstrumentOptionsActiveWhen()
		{
