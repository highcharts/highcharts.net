...
{
	public partial class TreemapSeriesSonificationDefaultInstrumentOptionsMappingVolume  : BaseObject
	{
		Hashtable h = new Hashtable();

		public TreemapSeriesSonificationDefaultInstrumentOptionsMappingVolume()
		{
			MapFunction = MapFunction_DefaultValue = TreemapSeriesSonificationDefaultInstrumentOptionsMappingVolumeMapFunction.Linear;
			MapTo = MapTo_DefaultValue = "";
			Max = Max_DefaultValue = null;
			Min = Min_DefaultValue = null;
			Value = Value_DefaultValue = null;
			Within = Within_DefaultValue = TreemapSeriesSonificationDefaultInstrumentOptionsMappingVolumeWithin.Chart;
		...
		/// </summary>
		public TreemapSeriesSonificationDefaultInstrumentOptionsMappingVolumeMapFunction MapFunction { get; set; }
		private TreemapSeriesSonificationDefaultInstrumentOptionsMappingVolumeMapFunction MapFunction_DefaultValue { get; set; }
		...
		/// </summary>
		public TreemapSeriesSonificationDefaultInstrumentOptionsMappingVolumeWithin Within { get; set; }
		private TreemapSeriesSonificationDefaultInstrumentOptionsMappingVolumeWithin Within_DefaultValue { get; set; }
