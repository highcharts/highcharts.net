...
{
	public partial class TreemapSeriesSonificationPointGrouping  : BaseObject
	{
		Hashtable h = new Hashtable();

		public TreemapSeriesSonificationPointGrouping()
		{
		...
		/// </summary>
		public TreemapSeriesSonificationPointGroupingAlgorithm Algorithm { get; set; }
		private TreemapSeriesSonificationPointGroupingAlgorithm Algorithm_DefaultValue { get; set; }
		...
		internal override Hashtable ToHashtable(Highcharts highcharts)
		{
			...
			if (Algorithm != TreemapSeriesSonificationPointGroupingAlgorithm.Null) h.Add("algorithm", highcharts.FirstCharacterToLower(Algorithm.ToString()));
