...
{
	public partial class TreemapSeriesSonificationTracks  : BaseObject
	{
		Hashtable h = new Hashtable();

		public TreemapSeriesSonificationTracks()
		{
			ActiveWhen = ActiveWhen_DefaultValue = new TreemapSeriesSonificationTracksActiveWhen();
			Instrument = Instrument_DefaultValue = null;
			InstrumentString = InstrumentString_DefaultValue = "null";
			Mapping = Mapping_DefaultValue = new TreemapSeriesSonificationTracksMapping();
			MidiName = MidiName_DefaultValue = "";
			PointGrouping = PointGrouping_DefaultValue = new TreemapSeriesSonificationTracksPointGrouping();
			RoundToMusicalNotes = RoundToMusicalNotes_DefaultValue = true;
			ShowPlayMarker = ShowPlayMarker_DefaultValue = true;
			Type = Type_DefaultValue = TreemapSeriesSonificationTracksType.Instrument;
		...
		/// </summary>
		public TreemapSeriesSonificationTracksActiveWhen ActiveWhen { get; set; }
		private TreemapSeriesSonificationTracksActiveWhen ActiveWhen_DefaultValue { get; set; }
		...
		/// </summary>
		public TreemapSeriesSonificationTracksMapping Mapping { get; set; }
		private TreemapSeriesSonificationTracksMapping Mapping_DefaultValue { get; set; }
		...
		/// </summary>
		public TreemapSeriesSonificationTracksPointGrouping PointGrouping { get; set; }
		private TreemapSeriesSonificationTracksPointGrouping PointGrouping_DefaultValue { get; set; }
		...
		/// </summary>
		public TreemapSeriesSonificationTracksType Type { get; set; }
		private TreemapSeriesSonificationTracksType Type_DefaultValue { get; set; }
