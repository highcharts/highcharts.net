...
{
	public partial class TreemapSeriesSonificationTracksMappingFrequency  : BaseObject
	{
		Hashtable h = new Hashtable();

		public TreemapSeriesSonificationTracksMappingFrequency()
		{
			MapFunction = MapFunction_DefaultValue = TreemapSeriesSonificationTracksMappingFrequencyMapFunction.Linear;
			MapTo = MapTo_DefaultValue = "";
			Max = Max_DefaultValue = null;
			Min = Min_DefaultValue = null;
			Value = Value_DefaultValue = null;
			Within = Within_DefaultValue = TreemapSeriesSonificationTracksMappingFrequencyWithin.Chart;
		...
		/// </summary>
		public TreemapSeriesSonificationTracksMappingFrequencyMapFunction MapFunction { get; set; }
		private TreemapSeriesSonificationTracksMappingFrequencyMapFunction MapFunction_DefaultValue { get; set; }
		...
		/// </summary>
		public TreemapSeriesSonificationTracksMappingFrequencyWithin Within { get; set; }
		private TreemapSeriesSonificationTracksMappingFrequencyWithin Within_DefaultValue { get; set; }
