...
{
	public partial class TreemapSeriesSonificationTracksMappingHighpassResonance  : BaseObject
	{
		Hashtable h = new Hashtable();

		public TreemapSeriesSonificationTracksMappingHighpassResonance()
		{
			MapFunction = MapFunction_DefaultValue = TreemapSeriesSonificationTracksMappingHighpassResonanceMapFunction.Linear;
			MapTo = MapTo_DefaultValue = "";
			Max = Max_DefaultValue = null;
			Min = Min_DefaultValue = null;
			Value = Value_DefaultValue = null;
			Within = Within_DefaultValue = TreemapSeriesSonificationTracksMappingHighpassResonanceWithin.Chart;
		...
		/// </summary>
		public TreemapSeriesSonificationTracksMappingHighpassResonanceMapFunction MapFunction { get; set; }
		private TreemapSeriesSonificationTracksMappingHighpassResonanceMapFunction MapFunction_DefaultValue { get; set; }
		...
		/// </summary>
		public TreemapSeriesSonificationTracksMappingHighpassResonanceWithin Within { get; set; }
		private TreemapSeriesSonificationTracksMappingHighpassResonanceWithin Within_DefaultValue { get; set; }
