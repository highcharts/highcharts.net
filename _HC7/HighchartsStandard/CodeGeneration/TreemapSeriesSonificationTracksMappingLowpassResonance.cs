...
{
	public partial class TreemapSeriesSonificationTracksMappingLowpassResonance  : BaseObject
	{
		Hashtable h = new Hashtable();

		public TreemapSeriesSonificationTracksMappingLowpassResonance()
		{
			MapFunction = MapFunction_DefaultValue = TreemapSeriesSonificationTracksMappingLowpassResonanceMapFunction.Linear;
			MapTo = MapTo_DefaultValue = "";
			Max = Max_DefaultValue = null;
			Min = Min_DefaultValue = null;
			Value = Value_DefaultValue = null;
			Within = Within_DefaultValue = TreemapSeriesSonificationTracksMappingLowpassResonanceWithin.Chart;
		...
		/// </summary>
		public TreemapSeriesSonificationTracksMappingLowpassResonanceMapFunction MapFunction { get; set; }
		private TreemapSeriesSonificationTracksMappingLowpassResonanceMapFunction MapFunction_DefaultValue { get; set; }
		...
		/// </summary>
		public TreemapSeriesSonificationTracksMappingLowpassResonanceWithin Within { get; set; }
		private TreemapSeriesSonificationTracksMappingLowpassResonanceWithin Within_DefaultValue { get; set; }
