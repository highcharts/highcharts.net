...
{
	public partial class TreemapSeriesSonificationTracksMappingPan  : BaseObject
	{
		Hashtable h = new Hashtable();

		public TreemapSeriesSonificationTracksMappingPan()
		{
			MapFunction = MapFunction_DefaultValue = TreemapSeriesSonificationTracksMappingPanMapFunction.Linear;
			MapTo = MapTo_DefaultValue = "";
			Max = Max_DefaultValue = null;
			Min = Min_DefaultValue = null;
			Value = Value_DefaultValue = null;
			Within = Within_DefaultValue = TreemapSeriesSonificationTracksMappingPanWithin.Chart;
		...
		/// </summary>
		public TreemapSeriesSonificationTracksMappingPanMapFunction MapFunction { get; set; }
		private TreemapSeriesSonificationTracksMappingPanMapFunction MapFunction_DefaultValue { get; set; }
		...
		/// </summary>
		public TreemapSeriesSonificationTracksMappingPanWithin Within { get; set; }
		private TreemapSeriesSonificationTracksMappingPanWithin Within_DefaultValue { get; set; }
