...
{
	public partial class TreemapSeriesSonificationTracksMappingPitch  : BaseObject
	{
		Hashtable h = new Hashtable();

		public TreemapSeriesSonificationTracksMappingPitch()
		{
			MapFunction = MapFunction_DefaultValue = TreemapSeriesSonificationTracksMappingPitchMapFunction.Linear;
		...
		/// </summary>
		public TreemapSeriesSonificationTracksMappingPitchMapFunction MapFunction { get; set; }
		private TreemapSeriesSonificationTracksMappingPitchMapFunction MapFunction_DefaultValue { get; set; }
