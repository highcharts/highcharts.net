...
{
	public partial class TreemapSeriesSonificationTracksMappingPlayDelay  : BaseObject
	{
		Hashtable h = new Hashtable();

		public TreemapSeriesSonificationTracksMappingPlayDelay()
		{
			MapFunction = MapFunction_DefaultValue = TreemapSeriesSonificationTracksMappingPlayDelayMapFunction.Linear;
			MapTo = MapTo_DefaultValue = "";
			Max = Max_DefaultValue = null;
			Min = Min_DefaultValue = null;
			Value = Value_DefaultValue = null;
			Within = Within_DefaultValue = TreemapSeriesSonificationTracksMappingPlayDelayWithin.Chart;
		...
		/// </summary>
		public TreemapSeriesSonificationTracksMappingPlayDelayMapFunction MapFunction { get; set; }
		private TreemapSeriesSonificationTracksMappingPlayDelayMapFunction MapFunction_DefaultValue { get; set; }
		...
		/// </summary>
		public TreemapSeriesSonificationTracksMappingPlayDelayWithin Within { get; set; }
		private TreemapSeriesSonificationTracksMappingPlayDelayWithin Within_DefaultValue { get; set; }
