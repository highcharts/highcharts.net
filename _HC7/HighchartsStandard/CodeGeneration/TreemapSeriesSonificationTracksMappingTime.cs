...
{
	public partial class TreemapSeriesSonificationTracksMappingTime  : BaseObject
	{
		Hashtable h = new Hashtable();

		public TreemapSeriesSonificationTracksMappingTime()
		{
			MapFunction = MapFunction_DefaultValue = TreemapSeriesSonificationTracksMappingTimeMapFunction.Linear;
			MapTo = MapTo_DefaultValue = "";
			Max = Max_DefaultValue = null;
			Min = Min_DefaultValue = null;
			Value = Value_DefaultValue = null;
			Within = Within_DefaultValue = TreemapSeriesSonificationTracksMappingTimeWithin.Chart;
		...
		/// </summary>
		public TreemapSeriesSonificationTracksMappingTimeMapFunction MapFunction { get; set; }
		private TreemapSeriesSonificationTracksMappingTimeMapFunction MapFunction_DefaultValue { get; set; }
		...
		/// </summary>
		public TreemapSeriesSonificationTracksMappingTimeWithin Within { get; set; }
		private TreemapSeriesSonificationTracksMappingTimeWithin Within_DefaultValue { get; set; }
