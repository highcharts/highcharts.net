...
{
	public partial class TreemapSeriesSonificationTracksPointGrouping  : BaseObject
	{
		Hashtable h = new Hashtable();

		public TreemapSeriesSonificationTracksPointGrouping()
		{
		...
		/// </summary>
		public TreemapSeriesSonificationTracksPointGroupingAlgorithm Algorithm { get; set; }
		private TreemapSeriesSonificationTracksPointGroupingAlgorithm Algorithm_DefaultValue { get; set; }
		...
		internal override Hashtable ToHashtable(Highcharts highcharts)
		{
			...
			if (Algorithm != TreemapSeriesSonificationTracksPointGroupingAlgorithm.Null) h.Add("algorithm", highcharts.FirstCharacterToLower(Algorithm.ToString()));
