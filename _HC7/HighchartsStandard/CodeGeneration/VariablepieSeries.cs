...
namespace Highsoft.Web.Mvc.Charts
{
	public partial class VariablepieSeries  : Series
	{
		...
		public VariablepieSeries()
		{
			...
			Dumbell = Dumbell_DefaultValue = new VariablepieSeriesDumbell();
			...
			LegendSymbol = LegendSymbol_DefaultValue = VariablepieSeriesLegendSymbol.Rectangle;
			...
			OnPoint = OnPoint_DefaultValue = new VariablepieSeriesOnPoint();
			...
			Sonification = Sonification_DefaultValue = new VariablepieSeriesSonification();
		...
		/// 
		/// </summary>
		public VariablepieSeriesDumbell Dumbell { get; set; }
		private VariablepieSeriesDumbell Dumbell_DefaultValue { get; set; }
