...
namespace Highsoft.Web.Mvc.Charts
{
	public partial class VariablepieSeries  : Series
	{
		...
		/// </summary>
		public VariablepieSeriesLegendSymbol LegendSymbol { get; set; }
		private VariablepieSeriesLegendSymbol LegendSymbol_DefaultValue { get; set; }
		...
		/// </summary>
		public VariablepieSeriesOnPoint OnPoint { get; set; }
		private VariablepieSeriesOnPoint OnPoint_DefaultValue { get; set; }
		...
		/// </summary>
		public VariablepieSeriesSonification Sonification { get; set; }
		private VariablepieSeriesSonification Sonification_DefaultValue { get; set; }
		...
		internal override Hashtable ToHashtable(Highcharts highcharts)
		{
			...
			if (Cursor != VariablepieSeriesCursor.Null) h.Add("cursor", highcharts.FirstCharacterToLower(Cursor.ToString()));
			...
			if (LegendSymbol != VariablepieSeriesLegendSymbol.Null) h.Add("legendSymbol", highcharts.FirstCharacterToLower(LegendSymbol.ToString()));
			if (Linecap != VariablepieSeriesLinecap.Null) h.Add("linecap", highcharts.FirstCharacterToLower(Linecap.ToString()));
