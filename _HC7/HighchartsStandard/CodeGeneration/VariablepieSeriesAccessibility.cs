...
namespace Highsoft.Web.Mvc.Charts
{
	public partial class VariablepieSeriesAccessibility  : BaseObject
	{
		...
		public VariablepieSeriesAccessibility()
		{
			...
			Point = Point_DefaultValue = new VariablepieSeriesAccessibilityPoint();
		...
		/// </summary>
		public VariablepieSeriesAccessibilityPoint Point { get; set; }
		private VariablepieSeriesAccessibilityPoint Point_DefaultValue { get; set; }
