...
{
	public partial class VariablepieSeriesDataDataLabels  : BaseObject
	{
		Hashtable h = new Hashtable();

		public VariablepieSeriesDataDataLabels()
		{
		...
		/// </summary>
		public VariablepieSeriesDataDataLabelsAlign Align { get; set; }
		private VariablepieSeriesDataDataLabelsAlign Align_DefaultValue { get; set; }
		...
		/// </summary>
		public VariablepieSeriesDataDataLabelsFilter Filter { get; set; }
		private VariablepieSeriesDataDataLabelsFilter Filter_DefaultValue { get; set; }
		...
		/// </summary>
		public VariablepieSeriesDataDataLabelsOverflow Overflow { get; set; }
		private VariablepieSeriesDataDataLabelsOverflow Overflow_DefaultValue { get; set; }
		...
		/// </summary>
		public VariablepieSeriesDataDataLabelsPosition Position { get; set; }
		private VariablepieSeriesDataDataLabelsPosition Position_DefaultValue { get; set; }
		...
		/// </summary>
		public VariablepieSeriesDataDataLabelsTextPath TextPath { get; set; }
		private VariablepieSeriesDataDataLabelsTextPath TextPath_DefaultValue { get; set; }
		...
		/// </summary>
		public VariablepieSeriesDataDataLabelsVerticalAlign VerticalAlign { get; set; }
		private VariablepieSeriesDataDataLabelsVerticalAlign VerticalAlign_DefaultValue { get; set; }
		...
		internal override Hashtable ToHashtable(Highcharts highcharts)
		{
			...
			if (Align != VariablepieSeriesDataDataLabelsAlign.Null) h.Add("align", highcharts.FirstCharacterToLower(Align.ToString()));
			...
			if (Overflow != VariablepieSeriesDataDataLabelsOverflow.Null) h.Add("overflow", highcharts.FirstCharacterToLower(Overflow.ToString()));
			if (Padding != null) h.Add("padding",Padding);
			if (Position != VariablepieSeriesDataDataLabelsPosition.Null) h.Add("position", highcharts.FirstCharacterToLower(Position.ToString()));
			...
			if (VerticalAlign != VariablepieSeriesDataDataLabelsVerticalAlign.Null) h.Add("verticalAlign", highcharts.FirstCharacterToLower(VerticalAlign.ToString()));
			if (X != null) h.Add("x",X);
			if (Y != null) h.Add("y",Y);
