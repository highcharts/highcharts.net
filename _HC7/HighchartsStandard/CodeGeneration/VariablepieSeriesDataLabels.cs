...
namespace Highsoft.Web.Mvc.Charts
{
	public partial class VariablepieSeriesDataLabels  : BaseObject
	{
		...
		/// </summary>
		public VariablepieSeriesDataLabelsFilter Filter { get; set; }
		private VariablepieSeriesDataLabelsFilter Filter_DefaultValue { get; set; }
		...
		/// </summary>
		public VariablepieSeriesDataLabelsPosition Position { get; set; }
		private VariablepieSeriesDataLabelsPosition Position_DefaultValue { get; set; }
		...
		/// </summary>
		public VariablepieSeriesDataLabelsTextPath TextPath { get; set; }
		private VariablepieSeriesDataLabelsTextPath TextPath_DefaultValue { get; set; }
		...
		internal override Hashtable ToHashtable(Highcharts highcharts)
		{
			...
			if (Align != VariablepieSeriesDataLabelsAlign.Null) h.Add("align", highcharts.FirstCharacterToLower(Align.ToString()));
			...
			if (Overflow != VariablepieSeriesDataLabelsOverflow.Null) h.Add("overflow", highcharts.FirstCharacterToLower(Overflow.ToString()));
			if (Padding != null) h.Add("padding",Padding);
			if (Position != VariablepieSeriesDataLabelsPosition.Null) h.Add("position", highcharts.FirstCharacterToLower(Position.ToString()));
			...
			if (VerticalAlign != VariablepieSeriesDataLabelsVerticalAlign.Null) h.Add("verticalAlign", highcharts.FirstCharacterToLower(VerticalAlign.ToString()));
			if (X != null) h.Add("x",X);
			if (Y != null) h.Add("y",Y);
