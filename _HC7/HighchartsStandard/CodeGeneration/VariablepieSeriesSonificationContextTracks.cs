...
{
	public partial class VariablepieSeriesSonificationContextTracks  : BaseObject
	{
		Hashtable h = new Hashtable();

		public VariablepieSeriesSonificationContextTracks()
		{
			ActiveWhen = ActiveWhen_DefaultValue = new VariablepieSeriesSonificationContextTracksActiveWhen();
			Instrument = Instrument_DefaultValue = null;
			InstrumentString = InstrumentString_DefaultValue = "null";
			Mapping = Mapping_DefaultValue = new VariablepieSeriesSonificationContextTracksMapping();
			MidiName = MidiName_DefaultValue = "";
			PointGrouping = PointGrouping_DefaultValue = new VariablepieSeriesSonificationContextTracksPointGrouping();
			...
			Type = Type_DefaultValue = VariablepieSeriesSonificationContextTracksType.Instrument;
			ValueInterval = ValueInterval_DefaultValue = null;
			ValueMapFunction = ValueMapFunction_DefaultValue = VariablepieSeriesSonificationContextTracksValueMapFunction.Linear;
		...
		/// </summary>
		public VariablepieSeriesSonificationContextTracksActiveWhen ActiveWhen { get; set; }
		private VariablepieSeriesSonificationContextTracksActiveWhen ActiveWhen_DefaultValue { get; set; }
		...
		/// </summary>
		public VariablepieSeriesSonificationContextTracksMapping Mapping { get; set; }
		private VariablepieSeriesSonificationContextTracksMapping Mapping_DefaultValue { get; set; }
		...
		/// </summary>
		public VariablepieSeriesSonificationContextTracksPointGrouping PointGrouping { get; set; }
		private VariablepieSeriesSonificationContextTracksPointGrouping PointGrouping_DefaultValue { get; set; }
		...
		/// </summary>
		public VariablepieSeriesSonificationContextTracksType Type { get; set; }
		private VariablepieSeriesSonificationContextTracksType Type_DefaultValue { get; set; }
		...
		/// </summary>
		public VariablepieSeriesSonificationContextTracksValueMapFunction ValueMapFunction { get; set; }
		private VariablepieSeriesSonificationContextTracksValueMapFunction ValueMapFunction_DefaultValue { get; set; }
