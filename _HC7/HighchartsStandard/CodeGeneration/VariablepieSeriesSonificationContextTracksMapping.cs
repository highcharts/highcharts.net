...
{
	public partial class VariablepieSeriesSonificationContextTracksMapping  : BaseObject
	{
		Hashtable h = new Hashtable();

		public VariablepieSeriesSonificationContextTracksMapping()
		{
			Frequency = Frequency_DefaultValue = new VariablepieSeriesSonificationContextTracksMappingFrequency();
			GapBetweenNotes = GapBetweenNotes_DefaultValue = new VariablepieSeriesSonificationContextTracksMappingGapBetweenNotes();
			Highpass = Highpass_DefaultValue = new VariablepieSeriesSonificationContextTracksMappingHighpass();
			Lowpass = Lowpass_DefaultValue = new VariablepieSeriesSonificationContextTracksMappingLowpass();
			NoteDuration = NoteDuration_DefaultValue = new VariablepieSeriesSonificationContextTracksMappingNoteDuration();
			Pan = Pan_DefaultValue = new VariablepieSeriesSonificationContextTracksMappingPan();
			Pitch = Pitch_DefaultValue = new VariablepieSeriesSonificationContextTracksMappingPitch();
			PitchString = PitchString_DefaultValue = "null";
			PitchNumber = PitchNumber_DefaultValue = null;
			PlayDelay = PlayDelay_DefaultValue = new VariablepieSeriesSonificationContextTracksMappingPlayDelay();
			Time = Time_DefaultValue = new VariablepieSeriesSonificationContextTracksMappingTime();
			TimeString = TimeString_DefaultValue = "null";
			TimeNumber = TimeNumber_DefaultValue = null;
			Tremolo = Tremolo_DefaultValue = new VariablepieSeriesSonificationContextTracksMappingTremolo();
			Volume = Volume_DefaultValue = new VariablepieSeriesSonificationContextTracksMappingVolume();
		...
		/// </summary>
		public VariablepieSeriesSonificationContextTracksMappingFrequency Frequency { get; set; }
		private VariablepieSeriesSonificationContextTracksMappingFrequency Frequency_DefaultValue { get; set; }
		...
		/// </summary>
		public VariablepieSeriesSonificationContextTracksMappingGapBetweenNotes GapBetweenNotes { get; set; }
		private VariablepieSeriesSonificationContextTracksMappingGapBetweenNotes GapBetweenNotes_DefaultValue { get; set; }
		...
		/// </summary>
		public VariablepieSeriesSonificationContextTracksMappingHighpass Highpass { get; set; }
		private VariablepieSeriesSonificationContextTracksMappingHighpass Highpass_DefaultValue { get; set; }
		...
		/// </summary>
		public VariablepieSeriesSonificationContextTracksMappingLowpass Lowpass { get; set; }
		private VariablepieSeriesSonificationContextTracksMappingLowpass Lowpass_DefaultValue { get; set; }
		...
		/// </summary>
		public VariablepieSeriesSonificationContextTracksMappingNoteDuration NoteDuration { get; set; }
		private VariablepieSeriesSonificationContextTracksMappingNoteDuration NoteDuration_DefaultValue { get; set; }
		...
		/// </summary>
		public VariablepieSeriesSonificationContextTracksMappingPan Pan { get; set; }
		private VariablepieSeriesSonificationContextTracksMappingPan Pan_DefaultValue { get; set; }
		...
		/// </summary>
		public VariablepieSeriesSonificationContextTracksMappingPitch Pitch { get; set; }
		private VariablepieSeriesSonificationContextTracksMappingPitch Pitch_DefaultValue { get; set; }
		...
		/// </summary>
		public VariablepieSeriesSonificationContextTracksMappingPlayDelay PlayDelay { get; set; }
		private VariablepieSeriesSonificationContextTracksMappingPlayDelay PlayDelay_DefaultValue { get; set; }
		...
		/// </summary>
		public VariablepieSeriesSonificationContextTracksMappingTime Time { get; set; }
		private VariablepieSeriesSonificationContextTracksMappingTime Time_DefaultValue { get; set; }
		...
		/// </summary>
		public VariablepieSeriesSonificationContextTracksMappingTremolo Tremolo { get; set; }
		private VariablepieSeriesSonificationContextTracksMappingTremolo Tremolo_DefaultValue { get; set; }
		 

		/// <summary>
		/// The volume of notes, from 0 to 1.
		/// </summary>
		public VariablepieSeriesSonificationContextTracksMappingVolume Volume { get; set; }
		private VariablepieSeriesSonificationContextTracksMappingVolume Volume_DefaultValue { get; set; }
