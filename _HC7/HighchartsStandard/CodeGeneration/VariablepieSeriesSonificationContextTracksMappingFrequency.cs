...
{
	public partial class VariablepieSeriesSonificationContextTracksMappingFrequency  : BaseObject
	{
		Hashtable h = new Hashtable();

		public VariablepieSeriesSonificationContextTracksMappingFrequency()
		{
			MapFunction = MapFunction_DefaultValue = VariablepieSeriesSonificationContextTracksMappingFrequencyMapFunction.Linear;
			MapTo = MapTo_DefaultValue = "";
			Max = Max_DefaultValue = null;
			Min = Min_DefaultValue = null;
			Value = Value_DefaultValue = null;
			Within = Within_DefaultValue = VariablepieSeriesSonificationContextTracksMappingFrequencyWithin.Chart;
		...
		/// </summary>
		public VariablepieSeriesSonificationContextTracksMappingFrequencyMapFunction MapFunction { get; set; }
		private VariablepieSeriesSonificationContextTracksMappingFrequencyMapFunction MapFunction_DefaultValue { get; set; }
		...
		/// </summary>
		public VariablepieSeriesSonificationContextTracksMappingFrequencyWithin Within { get; set; }
		private VariablepieSeriesSonificationContextTracksMappingFrequencyWithin Within_DefaultValue { get; set; }
