...
{
	public partial class VariablepieSeriesSonificationContextTracksMappingPan  : BaseObject
	{
		Hashtable h = new Hashtable();

		public VariablepieSeriesSonificationContextTracksMappingPan()
		{
			MapFunction = MapFunction_DefaultValue = VariablepieSeriesSonificationContextTracksMappingPanMapFunction.Linear;
			MapTo = MapTo_DefaultValue = "";
			Max = Max_DefaultValue = null;
			Min = Min_DefaultValue = null;
			Value = Value_DefaultValue = null;
			Within = Within_DefaultValue = VariablepieSeriesSonificationContextTracksMappingPanWithin.Chart;
		...
		/// </summary>
		public VariablepieSeriesSonificationContextTracksMappingPanMapFunction MapFunction { get; set; }
		private VariablepieSeriesSonificationContextTracksMappingPanMapFunction MapFunction_DefaultValue { get; set; }
		...
		/// </summary>
		public VariablepieSeriesSonificationContextTracksMappingPanWithin Within { get; set; }
		private VariablepieSeriesSonificationContextTracksMappingPanWithin Within_DefaultValue { get; set; }
