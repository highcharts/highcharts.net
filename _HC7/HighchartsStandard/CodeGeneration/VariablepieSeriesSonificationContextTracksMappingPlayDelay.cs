...
{
	public partial class VariablepieSeriesSonificationContextTracksMappingPlayDelay  : BaseObject
	{
		Hashtable h = new Hashtable();

		public VariablepieSeriesSonificationContextTracksMappingPlayDelay()
		{
			MapFunction = MapFunction_DefaultValue = VariablepieSeriesSonificationContextTracksMappingPlayDelayMapFunction.Linear;
			MapTo = MapTo_DefaultValue = "";
			Max = Max_DefaultValue = null;
			Min = Min_DefaultValue = null;
			Value = Value_DefaultValue = null;
			Within = Within_DefaultValue = VariablepieSeriesSonificationContextTracksMappingPlayDelayWithin.Chart;
		...
		/// </summary>
		public VariablepieSeriesSonificationContextTracksMappingPlayDelayMapFunction MapFunction { get; set; }
		private VariablepieSeriesSonificationContextTracksMappingPlayDelayMapFunction MapFunction_DefaultValue { get; set; }
		...
		/// </summary>
		public VariablepieSeriesSonificationContextTracksMappingPlayDelayWithin Within { get; set; }
		private VariablepieSeriesSonificationContextTracksMappingPlayDelayWithin Within_DefaultValue { get; set; }
