...
{
	public partial class VariablepieSeriesSonificationContextTracksMappingTremoloSpeed  : BaseObject
	{
		Hashtable h = new Hashtable();

		public VariablepieSeriesSonificationContextTracksMappingTremoloSpeed()
		{
			MapFunction = MapFunction_DefaultValue = VariablepieSeriesSonificationContextTracksMappingTremoloSpeedMapFunction.Linear;
			MapTo = MapTo_DefaultValue = "";
			Max = Max_DefaultValue = null;
			Min = Min_DefaultValue = null;
			Value = Value_DefaultValue = null;
			Within = Within_DefaultValue = VariablepieSeriesSonificationContextTracksMappingTremoloSpeedWithin.Chart;
		...
		/// </summary>
		public VariablepieSeriesSonificationContextTracksMappingTremoloSpeedMapFunction MapFunction { get; set; }
		private VariablepieSeriesSonificationContextTracksMappingTremoloSpeedMapFunction MapFunction_DefaultValue { get; set; }
		...
		/// </summary>
		public VariablepieSeriesSonificationContextTracksMappingTremoloSpeedWithin Within { get; set; }
		private VariablepieSeriesSonificationContextTracksMappingTremoloSpeedWithin Within_DefaultValue { get; set; }
