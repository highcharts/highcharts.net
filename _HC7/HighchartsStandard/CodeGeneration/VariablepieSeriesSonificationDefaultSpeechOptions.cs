...
{
	public partial class VariablepieSeriesSonificationDefaultSpeechOptions  : BaseObject
	{
		Hashtable h = new Hashtable();

		public VariablepieSeriesSonificationDefaultSpeechOptions()
		{
			ActiveWhen = ActiveWhen_DefaultValue = new VariablepieSeriesSonificationDefaultSpeechOptionsActiveWhen();
			Language = Language_DefaultValue = "en-US";
			Mapping = Mapping_DefaultValue = new VariablepieSeriesSonificationDefaultSpeechOptionsMapping();
			PointGrouping = PointGrouping_DefaultValue = new VariablepieSeriesSonificationDefaultSpeechOptionsPointGrouping();
			PreferredVoice = PreferredVoice_DefaultValue = "";
			ShowPlayMarker = ShowPlayMarker_DefaultValue = true;
			Type = Type_DefaultValue = VariablepieSeriesSonificationDefaultSpeechOptionsType.Instrument;
		...
		/// </summary>
		public VariablepieSeriesSonificationDefaultSpeechOptionsActiveWhen ActiveWhen { get; set; }
		private VariablepieSeriesSonificationDefaultSpeechOptionsActiveWhen ActiveWhen_DefaultValue { get; set; }
		...
		/// </summary>
		public VariablepieSeriesSonificationDefaultSpeechOptionsMapping Mapping { get; set; }
		private VariablepieSeriesSonificationDefaultSpeechOptionsMapping Mapping_DefaultValue { get; set; }
		 

		/// <summary>
		/// Options for point grouping, specifically for instrument tracks.
		/// </summary>
		public VariablepieSeriesSonificationDefaultSpeechOptionsPointGrouping PointGrouping { get; set; }
		private VariablepieSeriesSonificationDefaultSpeechOptionsPointGrouping PointGrouping_DefaultValue { get; set; }
		...
		/// </summary>
		public VariablepieSeriesSonificationDefaultSpeechOptionsType Type { get; set; }
		private VariablepieSeriesSonificationDefaultSpeechOptionsType Type_DefaultValue { get; set; }
