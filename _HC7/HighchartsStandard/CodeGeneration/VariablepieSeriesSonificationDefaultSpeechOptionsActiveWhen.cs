...
{
	public partial class VariablepieSeriesSonificationDefaultSpeechOptionsActiveWhen  : BaseObject
	{
		Hashtable h = new Hashtable();

		public VariablepieSeriesSonificationDefaultSpeechOptionsActiveWhen()
		{
