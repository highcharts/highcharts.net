...
{
	public partial class VariablepieSeriesSonificationDefaultSpeechOptionsMappingPan  : BaseObject
	{
		Hashtable h = new Hashtable();

		public VariablepieSeriesSonificationDefaultSpeechOptionsMappingPan()
		{
			MapFunction = MapFunction_DefaultValue = VariablepieSeriesSonificationDefaultSpeechOptionsMappingPanMapFunction.Linear;
			MapTo = MapTo_DefaultValue = "";
			Max = Max_DefaultValue = null;
			Min = Min_DefaultValue = null;
			Value = Value_DefaultValue = null;
			Within = Within_DefaultValue = VariablepieSeriesSonificationDefaultSpeechOptionsMappingPanWithin.Chart;
		...
		/// </summary>
		public VariablepieSeriesSonificationDefaultSpeechOptionsMappingPanMapFunction MapFunction { get; set; }
		private VariablepieSeriesSonificationDefaultSpeechOptionsMappingPanMapFunction MapFunction_DefaultValue { get; set; }
		...
		/// </summary>
		public VariablepieSeriesSonificationDefaultSpeechOptionsMappingPanWithin Within { get; set; }
		private VariablepieSeriesSonificationDefaultSpeechOptionsMappingPanWithin Within_DefaultValue { get; set; }
