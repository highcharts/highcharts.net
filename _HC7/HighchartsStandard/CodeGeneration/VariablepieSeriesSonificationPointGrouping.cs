...
{
	public partial class VariablepieSeriesSonificationPointGrouping  : BaseObject
	{
		Hashtable h = new Hashtable();

		public VariablepieSeriesSonificationPointGrouping()
		{
		...
		/// </summary>
		public VariablepieSeriesSonificationPointGroupingAlgorithm Algorithm { get; set; }
		private VariablepieSeriesSonificationPointGroupingAlgorithm Algorithm_DefaultValue { get; set; }
		...
		internal override Hashtable ToHashtable(Highcharts highcharts)
		{
			...
			if (Algorithm != VariablepieSeriesSonificationPointGroupingAlgorithm.Null) h.Add("algorithm", highcharts.FirstCharacterToLower(Algorithm.ToString()));
