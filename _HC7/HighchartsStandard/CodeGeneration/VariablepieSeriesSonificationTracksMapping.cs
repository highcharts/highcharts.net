...
{
	public partial class VariablepieSeriesSonificationTracksMapping  : BaseObject
	{
		Hashtable h = new Hashtable();

		public VariablepieSeriesSonificationTracksMapping()
		{
			Frequency = Frequency_DefaultValue = new VariablepieSeriesSonificationTracksMappingFrequency();
			GapBetweenNotes = GapBetweenNotes_DefaultValue = new VariablepieSeriesSonificationTracksMappingGapBetweenNotes();
			Highpass = Highpass_DefaultValue = new VariablepieSeriesSonificationTracksMappingHighpass();
			Lowpass = Lowpass_DefaultValue = new VariablepieSeriesSonificationTracksMappingLowpass();
			NoteDuration = NoteDuration_DefaultValue = new VariablepieSeriesSonificationTracksMappingNoteDuration();
			Pan = Pan_DefaultValue = new VariablepieSeriesSonificationTracksMappingPan();
			Pitch = Pitch_DefaultValue = new VariablepieSeriesSonificationTracksMappingPitch();
			PitchString = PitchString_DefaultValue = "null";
			PitchNumber = PitchNumber_DefaultValue = null;
			PlayDelay = PlayDelay_DefaultValue = new VariablepieSeriesSonificationTracksMappingPlayDelay();
			Time = Time_DefaultValue = new VariablepieSeriesSonificationTracksMappingTime();
			TimeString = TimeString_DefaultValue = "null";
			TimeNumber = TimeNumber_DefaultValue = null;
			Tremolo = Tremolo_DefaultValue = new VariablepieSeriesSonificationTracksMappingTremolo();
			Volume = Volume_DefaultValue = new VariablepieSeriesSonificationTracksMappingVolume();
		...
		/// </summary>
		public VariablepieSeriesSonificationTracksMappingFrequency Frequency { get; set; }
		private VariablepieSeriesSonificationTracksMappingFrequency Frequency_DefaultValue { get; set; }
		...
		/// </summary>
		public VariablepieSeriesSonificationTracksMappingGapBetweenNotes GapBetweenNotes { get; set; }
		private VariablepieSeriesSonificationTracksMappingGapBetweenNotes GapBetweenNotes_DefaultValue { get; set; }
		...
		/// </summary>
		public VariablepieSeriesSonificationTracksMappingHighpass Highpass { get; set; }
		private VariablepieSeriesSonificationTracksMappingHighpass Highpass_DefaultValue { get; set; }
		...
		/// </summary>
		public VariablepieSeriesSonificationTracksMappingLowpass Lowpass { get; set; }
		private VariablepieSeriesSonificationTracksMappingLowpass Lowpass_DefaultValue { get; set; }
		...
		/// </summary>
		public VariablepieSeriesSonificationTracksMappingNoteDuration NoteDuration { get; set; }
		private VariablepieSeriesSonificationTracksMappingNoteDuration NoteDuration_DefaultValue { get; set; }
		...
		/// </summary>
		public VariablepieSeriesSonificationTracksMappingPan Pan { get; set; }
		private VariablepieSeriesSonificationTracksMappingPan Pan_DefaultValue { get; set; }
		...
		/// </summary>
		public VariablepieSeriesSonificationTracksMappingPitch Pitch { get; set; }
		private VariablepieSeriesSonificationTracksMappingPitch Pitch_DefaultValue { get; set; }
		...
		/// </summary>
		public VariablepieSeriesSonificationTracksMappingPlayDelay PlayDelay { get; set; }
		private VariablepieSeriesSonificationTracksMappingPlayDelay PlayDelay_DefaultValue { get; set; }
		...
		/// </summary>
		public VariablepieSeriesSonificationTracksMappingTime Time { get; set; }
		private VariablepieSeriesSonificationTracksMappingTime Time_DefaultValue { get; set; }
		...
		/// </summary>
		public VariablepieSeriesSonificationTracksMappingTremolo Tremolo { get; set; }
		private VariablepieSeriesSonificationTracksMappingTremolo Tremolo_DefaultValue { get; set; }
		 

		/// <summary>
		/// The volume of notes, from 0 to 1.
		/// </summary>
		public VariablepieSeriesSonificationTracksMappingVolume Volume { get; set; }
		private VariablepieSeriesSonificationTracksMappingVolume Volume_DefaultValue { get; set; }
