...
{
	public partial class VariablepieSeriesSonificationTracksMappingFrequency  : BaseObject
	{
		Hashtable h = new Hashtable();

		public VariablepieSeriesSonificationTracksMappingFrequency()
		{
			MapFunction = MapFunction_DefaultValue = VariablepieSeriesSonificationTracksMappingFrequencyMapFunction.Linear;
			MapTo = MapTo_DefaultValue = "";
			Max = Max_DefaultValue = null;
			Min = Min_DefaultValue = null;
			Value = Value_DefaultValue = null;
			Within = Within_DefaultValue = VariablepieSeriesSonificationTracksMappingFrequencyWithin.Chart;
		...
		/// </summary>
		public VariablepieSeriesSonificationTracksMappingFrequencyMapFunction MapFunction { get; set; }
		private VariablepieSeriesSonificationTracksMappingFrequencyMapFunction MapFunction_DefaultValue { get; set; }
		...
		/// </summary>
		public VariablepieSeriesSonificationTracksMappingFrequencyWithin Within { get; set; }
		private VariablepieSeriesSonificationTracksMappingFrequencyWithin Within_DefaultValue { get; set; }
