...
{
	public partial class VariablepieSeriesSonificationTracksMappingHighpassFrequency  : BaseObject
	{
		Hashtable h = new Hashtable();

		public VariablepieSeriesSonificationTracksMappingHighpassFrequency()
		{
			MapFunction = MapFunction_DefaultValue = VariablepieSeriesSonificationTracksMappingHighpassFrequencyMapFunction.Linear;
			MapTo = MapTo_DefaultValue = "";
			Max = Max_DefaultValue = null;
			Min = Min_DefaultValue = null;
			Value = Value_DefaultValue = null;
			Within = Within_DefaultValue = VariablepieSeriesSonificationTracksMappingHighpassFrequencyWithin.Chart;
		...
		/// </summary>
		public VariablepieSeriesSonificationTracksMappingHighpassFrequencyMapFunction MapFunction { get; set; }
		private VariablepieSeriesSonificationTracksMappingHighpassFrequencyMapFunction MapFunction_DefaultValue { get; set; }
		...
		/// </summary>
		public VariablepieSeriesSonificationTracksMappingHighpassFrequencyWithin Within { get; set; }
		private VariablepieSeriesSonificationTracksMappingHighpassFrequencyWithin Within_DefaultValue { get; set; }
