...
{
	public partial class VariablepieSeriesSonificationTracksMappingLowpassResonance  : BaseObject
	{
		Hashtable h = new Hashtable();

		public VariablepieSeriesSonificationTracksMappingLowpassResonance()
		{
			MapFunction = MapFunction_DefaultValue = VariablepieSeriesSonificationTracksMappingLowpassResonanceMapFunction.Linear;
			MapTo = MapTo_DefaultValue = "";
			Max = Max_DefaultValue = null;
			Min = Min_DefaultValue = null;
			Value = Value_DefaultValue = null;
			Within = Within_DefaultValue = VariablepieSeriesSonificationTracksMappingLowpassResonanceWithin.Chart;
		...
		/// </summary>
		public VariablepieSeriesSonificationTracksMappingLowpassResonanceMapFunction MapFunction { get; set; }
		private VariablepieSeriesSonificationTracksMappingLowpassResonanceMapFunction MapFunction_DefaultValue { get; set; }
		...
		/// </summary>
		public VariablepieSeriesSonificationTracksMappingLowpassResonanceWithin Within { get; set; }
		private VariablepieSeriesSonificationTracksMappingLowpassResonanceWithin Within_DefaultValue { get; set; }
