...
{
	public partial class VariablepieSeriesSonificationTracksMappingNoteDuration  : BaseObject
	{
		Hashtable h = new Hashtable();

		public VariablepieSeriesSonificationTracksMappingNoteDuration()
		{
			MapFunction = MapFunction_DefaultValue = VariablepieSeriesSonificationTracksMappingNoteDurationMapFunction.Linear;
			MapTo = MapTo_DefaultValue = "";
			Max = Max_DefaultValue = null;
			Min = Min_DefaultValue = null;
			Value = Value_DefaultValue = null;
			Within = Within_DefaultValue = VariablepieSeriesSonificationTracksMappingNoteDurationWithin.Chart;
		...
		/// </summary>
		public VariablepieSeriesSonificationTracksMappingNoteDurationMapFunction MapFunction { get; set; }
		private VariablepieSeriesSonificationTracksMappingNoteDurationMapFunction MapFunction_DefaultValue { get; set; }
		...
		/// </summary>
		public VariablepieSeriesSonificationTracksMappingNoteDurationWithin Within { get; set; }
		private VariablepieSeriesSonificationTracksMappingNoteDurationWithin Within_DefaultValue { get; set; }
