...
{
	public partial class VariablepieSeriesSonificationTracksMappingPan  : BaseObject
	{
		Hashtable h = new Hashtable();

		public VariablepieSeriesSonificationTracksMappingPan()
		{
			MapFunction = MapFunction_DefaultValue = VariablepieSeriesSonificationTracksMappingPanMapFunction.Linear;
			MapTo = MapTo_DefaultValue = "";
			Max = Max_DefaultValue = null;
			Min = Min_DefaultValue = null;
			Value = Value_DefaultValue = null;
			Within = Within_DefaultValue = VariablepieSeriesSonificationTracksMappingPanWithin.Chart;
		...
		/// </summary>
		public VariablepieSeriesSonificationTracksMappingPanMapFunction MapFunction { get; set; }
		private VariablepieSeriesSonificationTracksMappingPanMapFunction MapFunction_DefaultValue { get; set; }
		...
		/// </summary>
		public VariablepieSeriesSonificationTracksMappingPanWithin Within { get; set; }
		private VariablepieSeriesSonificationTracksMappingPanWithin Within_DefaultValue { get; set; }
