...
namespace Highsoft.Web.Mvc.Charts
{
	public partial class VariablepieSeriesSonificationTracksMappingPitch  : BaseObject
	{
		...
		{
			if (MapFunction != VariablepieSeriesSonificationTracksMappingPitchMapFunction.Null) h.Add("mapFunction", highcharts.FirstCharacterToLower(MapFunction.ToString()));
