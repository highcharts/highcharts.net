...
{
	public partial class VariablepieSeriesSonificationTracksMappingPitch  : BaseObject
	{
		Hashtable h = new Hashtable();

		public VariablepieSeriesSonificationTracksMappingPitch()
		{
			MapFunction = MapFunction_DefaultValue = VariablepieSeriesSonificationTracksMappingPitchMapFunction.Linear;
		...
		/// </summary>
		public VariablepieSeriesSonificationTracksMappingPitchMapFunction MapFunction { get; set; }
		private VariablepieSeriesSonificationTracksMappingPitchMapFunction MapFunction_DefaultValue { get; set; }
