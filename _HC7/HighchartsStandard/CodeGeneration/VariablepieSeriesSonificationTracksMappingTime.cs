...
{
	public partial class VariablepieSeriesSonificationTracksMappingTime  : BaseObject
	{
		Hashtable h = new Hashtable();

		public VariablepieSeriesSonificationTracksMappingTime()
		{
			MapFunction = MapFunction_DefaultValue = VariablepieSeriesSonificationTracksMappingTimeMapFunction.Linear;
			MapTo = MapTo_DefaultValue = "";
			Max = Max_DefaultValue = null;
			Min = Min_DefaultValue = null;
			Value = Value_DefaultValue = null;
			Within = Within_DefaultValue = VariablepieSeriesSonificationTracksMappingTimeWithin.Chart;
		...
		/// </summary>
		public VariablepieSeriesSonificationTracksMappingTimeMapFunction MapFunction { get; set; }
		private VariablepieSeriesSonificationTracksMappingTimeMapFunction MapFunction_DefaultValue { get; set; }
		...
		/// </summary>
		public VariablepieSeriesSonificationTracksMappingTimeWithin Within { get; set; }
		private VariablepieSeriesSonificationTracksMappingTimeWithin Within_DefaultValue { get; set; }
