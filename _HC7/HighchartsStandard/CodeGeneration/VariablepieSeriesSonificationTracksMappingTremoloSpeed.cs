...
{
	public partial class VariablepieSeriesSonificationTracksMappingTremoloSpeed  : BaseObject
	{
		Hashtable h = new Hashtable();

		public VariablepieSeriesSonificationTracksMappingTremoloSpeed()
		{
			MapFunction = MapFunction_DefaultValue = VariablepieSeriesSonificationTracksMappingTremoloSpeedMapFunction.Linear;
			MapTo = MapTo_DefaultValue = "";
			Max = Max_DefaultValue = null;
			Min = Min_DefaultValue = null;
			Value = Value_DefaultValue = null;
			Within = Within_DefaultValue = VariablepieSeriesSonificationTracksMappingTremoloSpeedWithin.Chart;
		...
		/// </summary>
		public VariablepieSeriesSonificationTracksMappingTremoloSpeedMapFunction MapFunction { get; set; }
		private VariablepieSeriesSonificationTracksMappingTremoloSpeedMapFunction MapFunction_DefaultValue { get; set; }
		...
		/// </summary>
		public VariablepieSeriesSonificationTracksMappingTremoloSpeedWithin Within { get; set; }
		private VariablepieSeriesSonificationTracksMappingTremoloSpeedWithin Within_DefaultValue { get; set; }
