...
{
	public partial class VariablepieSeriesSonificationTracksMappingVolume  : BaseObject
	{
		Hashtable h = new Hashtable();

		public VariablepieSeriesSonificationTracksMappingVolume()
		{
			MapFunction = MapFunction_DefaultValue = VariablepieSeriesSonificationTracksMappingVolumeMapFunction.Linear;
			MapTo = MapTo_DefaultValue = "";
			Max = Max_DefaultValue = null;
			Min = Min_DefaultValue = null;
			Value = Value_DefaultValue = null;
			Within = Within_DefaultValue = VariablepieSeriesSonificationTracksMappingVolumeWithin.Chart;
		...
		/// </summary>
		public VariablepieSeriesSonificationTracksMappingVolumeMapFunction MapFunction { get; set; }
		private VariablepieSeriesSonificationTracksMappingVolumeMapFunction MapFunction_DefaultValue { get; set; }
		...
		/// </summary>
		public VariablepieSeriesSonificationTracksMappingVolumeWithin Within { get; set; }
		private VariablepieSeriesSonificationTracksMappingVolumeWithin Within_DefaultValue { get; set; }
