...
namespace Highsoft.Web.Mvc.Charts
{
	public partial class VariablepieSeriesStatesSelectMarkerStates  : BaseObject
	{
		public VariablepieSeriesStatesSelectMarkerStates()
		{
			...
			Inactive = Inactive_DefaultValue = new VariablepieSeriesStatesSelectMarkerStatesInactive();
			Normal = Normal_DefaultValue = new VariablepieSeriesStatesSelectMarkerStatesNormal();
		...
		/// 
		/// </summary>
		public VariablepieSeriesStatesSelectMarkerStatesInactive Inactive { get; set; }
		private VariablepieSeriesStatesSelectMarkerStatesInactive Inactive_DefaultValue { get; set; }
		 

		/// <summary>
		/// The normal state of a single point marker. Currently onlyused for setting animation when returning to normal statefrom hover.
		/// </summary>
		public VariablepieSeriesStatesSelectMarkerStatesNormal Normal { get; set; }
		private VariablepieSeriesStatesSelectMarkerStatesNormal Normal_DefaultValue { get; set; }
