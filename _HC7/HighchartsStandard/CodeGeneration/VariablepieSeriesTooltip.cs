...
{
	public partial class VariablepieSeriesTooltip  : BaseObject
	{
		public VariablepieSeriesTooltip()
		{
			...
			HeaderShape = HeaderShape_DefaultValue = VariablepieSeriesTooltipHeaderShape.Callout;
		...
		/// </summary>
		public VariablepieSeriesTooltipHeaderShape HeaderShape { get; set; }
		private VariablepieSeriesTooltipHeaderShape HeaderShape_DefaultValue { get; set; }
		...
		internal override Hashtable ToHashtable()
		{
			...
			if (NullFormatter != NullFormatter_DefaultValue) { h.Add("nullFormatter",NullFormatter); Highcharts.AddFunction("VariablepieSeriesTooltipNullFormatter.nullFormatter", NullFormatter); }  
			if (Outside != Outside_DefaultValue) h.Add("outside",Outside);
			if (Padding != Padding_DefaultValue) h.Add("padding",Padding);
			if (PointFormat != PointFormat_DefaultValue) h.Add("pointFormat",PointFormat);
			if (PointFormatter != PointFormatter_DefaultValue) { h.Add("pointFormatter",PointFormatter); Highcharts.AddFunction("VariablepieSeriesTooltipPointFormatter.pointFormatter", PointFormatter); }  
