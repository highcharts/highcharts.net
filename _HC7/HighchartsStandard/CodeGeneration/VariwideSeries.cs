...
{
	public partial class VariwideSeries  : Series
	{
		...
		/// </summary>
		public VariwideSeriesAccessibility Accessibility { get; set; }
		private VariwideSeriesAccessibility Accessibility_DefaultValue { get; set; }
		...
		/// </summary>
		public VariwideSeriesDashStyle DashStyle { get; set; }
		private VariwideSeriesDashStyle DashStyle_DefaultValue { get; set; }
		...
		/// </summary>
		public VariwideSeriesDataSorting DataSorting { get; set; }
		private VariwideSeriesDataSorting DataSorting_DefaultValue { get; set; }
		...
		/// </summary>
		public VariwideSeriesLegendSymbol LegendSymbol { get; set; }
		private VariwideSeriesLegendSymbol LegendSymbol_DefaultValue { get; set; }
		...
		/// </summary>
		public VariwideSeriesOnPoint OnPoint { get; set; }
		private VariwideSeriesOnPoint OnPoint_DefaultValue { get; set; }
		...
		/// </summary>
		public VariwideSeriesPointIntervalUnit PointIntervalUnit { get; set; }
		private VariwideSeriesPointIntervalUnit PointIntervalUnit_DefaultValue { get; set; }
		...
		/// </summary>
		public VariwideSeriesPointPlacement PointPlacement { get; set; }
		private VariwideSeriesPointPlacement PointPlacement_DefaultValue { get; set; }
		...
		/// </summary>
		public VariwideSeriesSonification Sonification { get; set; }
		private VariwideSeriesSonification Sonification_DefaultValue { get; set; }
		...
		internal override Hashtable ToHashtable(Highcharts highcharts)
		{
			...
			if (Cursor != VariwideSeriesCursor.Null) h.Add("cursor", highcharts.FirstCharacterToLower(Cursor.ToString()));
			if (Custom != null) h.Add("custom",Custom);
			if (DashStyle != VariwideSeriesDashStyle.Null) h.Add("dashStyle", highcharts.FirstCharacterToLower(DashStyle.ToString()));
			...
			if (FindNearestPointBy != VariwideSeriesFindNearestPointBy.Null) h.Add("findNearestPointBy", highcharts.FirstCharacterToLower(FindNearestPointBy.ToString()));
			...
			if (LegendSymbol != VariwideSeriesLegendSymbol.Null) h.Add("legendSymbol", highcharts.FirstCharacterToLower(LegendSymbol.ToString()));
			...
			if (PointIntervalUnit != VariwideSeriesPointIntervalUnit.Null) h.Add("pointIntervalUnit", highcharts.FirstCharacterToLower(PointIntervalUnit.ToString()));
			if (PointPadding != null) h.Add("pointPadding",PointPadding);
			if (PointPlacement != VariwideSeriesPointPlacement.Null) h.Add("pointPlacement", highcharts.FirstCharacterToLower(PointPlacement.ToString()));
			...
			if (Stacking != VariwideSeriesStacking.Null) h.Add("stacking", highcharts.FirstCharacterToLower(Stacking.ToString()));
