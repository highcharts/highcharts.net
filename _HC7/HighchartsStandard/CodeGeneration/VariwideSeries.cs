...
namespace Highsoft.Web.Mvc.Charts
{
	public partial class VariwideSeries  : Series
	{
		...
		{
			Accessibility = Accessibility_DefaultValue = new VariwideSeriesAccessibility();
			...
			DashStyle = DashStyle_DefaultValue = VariwideSeriesDashStyle.Null;
			Data = Data_DefaultValue = new List<VariwideSeriesData>();
			DataLabels = DataLabels_DefaultValue = new VariwideSeriesDataLabels();
			DataSorting = DataSorting_DefaultValue = new VariwideSeriesDataSorting();
			Description = Description_DefaultValue = "";
			DragDrop = DragDrop_DefaultValue = new VariwideSeriesDragDrop();
			Dumbell = Dumbell_DefaultValue = new VariwideSeriesDumbell();
			...
			LegendSymbol = LegendSymbol_DefaultValue = VariwideSeriesLegendSymbol.Rectangle;
			LinkedTo = LinkedTo_DefaultValue = "";
			MaxPointWidth = MaxPointWidth_DefaultValue = null;
			MinPointLength = MinPointLength_DefaultValue = 0;
			Name = Name_DefaultValue = "";
			NegativeColor = NegativeColor_DefaultValue = "";
			OnPoint = OnPoint_DefaultValue = new VariwideSeriesOnPoint();
			...
			Sonification = Sonification_DefaultValue = new VariwideSeriesSonification();
		...
		/// 
		/// </summary>
		public VariwideSeriesDumbell Dumbell { get; set; }
		private VariwideSeriesDumbell Dumbell_DefaultValue { get; set; }
