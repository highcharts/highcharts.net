...
{
	public partial class VariwideSeriesDataDataLabels  : BaseObject
	{
		Hashtable h = new Hashtable();

		public VariwideSeriesDataDataLabels()
		{
		...
		/// </summary>
		public VariwideSeriesDataDataLabelsAlign Align { get; set; }
		private VariwideSeriesDataDataLabelsAlign Align_DefaultValue { get; set; }
		...
		/// </summary>
		public VariwideSeriesDataDataLabelsFilter Filter { get; set; }
		private VariwideSeriesDataDataLabelsFilter Filter_DefaultValue { get; set; }
		...
		/// </summary>
		public VariwideSeriesDataDataLabelsOverflow Overflow { get; set; }
		private VariwideSeriesDataDataLabelsOverflow Overflow_DefaultValue { get; set; }
		...
		/// </summary>
		public VariwideSeriesDataDataLabelsPosition Position { get; set; }
		private VariwideSeriesDataDataLabelsPosition Position_DefaultValue { get; set; }
		...
		/// </summary>
		public VariwideSeriesDataDataLabelsTextPath TextPath { get; set; }
		private VariwideSeriesDataDataLabelsTextPath TextPath_DefaultValue { get; set; }
		...
		/// </summary>
		public VariwideSeriesDataDataLabelsVerticalAlign VerticalAlign { get; set; }
		private VariwideSeriesDataDataLabelsVerticalAlign VerticalAlign_DefaultValue { get; set; }
		...
		internal override Hashtable ToHashtable(Highcharts highcharts)
		{
			...
			if (Align != VariwideSeriesDataDataLabelsAlign.Null) h.Add("align", highcharts.FirstCharacterToLower(Align.ToString()));
			...
			if (Overflow != VariwideSeriesDataDataLabelsOverflow.Null) h.Add("overflow", highcharts.FirstCharacterToLower(Overflow.ToString()));
			if (Padding != null) h.Add("padding",Padding);
			if (Position != VariwideSeriesDataDataLabelsPosition.Null) h.Add("position", highcharts.FirstCharacterToLower(Position.ToString()));
			...
			if (VerticalAlign != VariwideSeriesDataDataLabelsVerticalAlign.Null) h.Add("verticalAlign", highcharts.FirstCharacterToLower(VerticalAlign.ToString()));
			if (X != null) h.Add("x",X);
			if (Y != null) h.Add("y",Y);
