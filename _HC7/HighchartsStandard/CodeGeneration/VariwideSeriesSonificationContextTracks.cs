...
{
	public partial class VariwideSeriesSonificationContextTracks  : BaseObject
	{
		Hashtable h = new Hashtable();

		public VariwideSeriesSonificationContextTracks()
		{
			ActiveWhen = ActiveWhen_DefaultValue = new VariwideSeriesSonificationContextTracksActiveWhen();
			Instrument = Instrument_DefaultValue = null;
			InstrumentString = InstrumentString_DefaultValue = "null";
			Mapping = Mapping_DefaultValue = new VariwideSeriesSonificationContextTracksMapping();
			MidiName = MidiName_DefaultValue = "";
			PointGrouping = PointGrouping_DefaultValue = new VariwideSeriesSonificationContextTracksPointGrouping();
			...
			Type = Type_DefaultValue = VariwideSeriesSonificationContextTracksType.Instrument;
			ValueInterval = ValueInterval_DefaultValue = null;
			ValueMapFunction = ValueMapFunction_DefaultValue = VariwideSeriesSonificationContextTracksValueMapFunction.Linear;
		...
		/// </summary>
		public VariwideSeriesSonificationContextTracksActiveWhen ActiveWhen { get; set; }
		private VariwideSeriesSonificationContextTracksActiveWhen ActiveWhen_DefaultValue { get; set; }
		...
		/// </summary>
		public VariwideSeriesSonificationContextTracksMapping Mapping { get; set; }
		private VariwideSeriesSonificationContextTracksMapping Mapping_DefaultValue { get; set; }
		...
		/// </summary>
		public VariwideSeriesSonificationContextTracksPointGrouping PointGrouping { get; set; }
		private VariwideSeriesSonificationContextTracksPointGrouping PointGrouping_DefaultValue { get; set; }
		...
		/// </summary>
		public VariwideSeriesSonificationContextTracksType Type { get; set; }
		private VariwideSeriesSonificationContextTracksType Type_DefaultValue { get; set; }
		...
		/// </summary>
		public VariwideSeriesSonificationContextTracksValueMapFunction ValueMapFunction { get; set; }
		private VariwideSeriesSonificationContextTracksValueMapFunction ValueMapFunction_DefaultValue { get; set; }
