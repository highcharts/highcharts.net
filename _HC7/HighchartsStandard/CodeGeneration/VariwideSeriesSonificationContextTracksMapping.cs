...
{
	public partial class VariwideSeriesSonificationContextTracksMapping  : BaseObject
	{
		Hashtable h = new Hashtable();

		public VariwideSeriesSonificationContextTracksMapping()
		{
			Frequency = Frequency_DefaultValue = new VariwideSeriesSonificationContextTracksMappingFrequency();
			GapBetweenNotes = GapBetweenNotes_DefaultValue = new VariwideSeriesSonificationContextTracksMappingGapBetweenNotes();
			Highpass = Highpass_DefaultValue = new VariwideSeriesSonificationContextTracksMappingHighpass();
			Lowpass = Lowpass_DefaultValue = new VariwideSeriesSonificationContextTracksMappingLowpass();
			NoteDuration = NoteDuration_DefaultValue = new VariwideSeriesSonificationContextTracksMappingNoteDuration();
			Pan = Pan_DefaultValue = new VariwideSeriesSonificationContextTracksMappingPan();
			Pitch = Pitch_DefaultValue = new VariwideSeriesSonificationContextTracksMappingPitch();
			PitchString = PitchString_DefaultValue = "null";
			PitchNumber = PitchNumber_DefaultValue = null;
			PlayDelay = PlayDelay_DefaultValue = new VariwideSeriesSonificationContextTracksMappingPlayDelay();
			Time = Time_DefaultValue = new VariwideSeriesSonificationContextTracksMappingTime();
			TimeString = TimeString_DefaultValue = "null";
			TimeNumber = TimeNumber_DefaultValue = null;
			Tremolo = Tremolo_DefaultValue = new VariwideSeriesSonificationContextTracksMappingTremolo();
			Volume = Volume_DefaultValue = new VariwideSeriesSonificationContextTracksMappingVolume();
		...
		/// </summary>
		public VariwideSeriesSonificationContextTracksMappingFrequency Frequency { get; set; }
		private VariwideSeriesSonificationContextTracksMappingFrequency Frequency_DefaultValue { get; set; }
		...
		/// </summary>
		public VariwideSeriesSonificationContextTracksMappingGapBetweenNotes GapBetweenNotes { get; set; }
		private VariwideSeriesSonificationContextTracksMappingGapBetweenNotes GapBetweenNotes_DefaultValue { get; set; }
		...
		/// </summary>
		public VariwideSeriesSonificationContextTracksMappingHighpass Highpass { get; set; }
		private VariwideSeriesSonificationContextTracksMappingHighpass Highpass_DefaultValue { get; set; }
		...
		/// </summary>
		public VariwideSeriesSonificationContextTracksMappingLowpass Lowpass { get; set; }
		private VariwideSeriesSonificationContextTracksMappingLowpass Lowpass_DefaultValue { get; set; }
		...
		/// </summary>
		public VariwideSeriesSonificationContextTracksMappingNoteDuration NoteDuration { get; set; }
		private VariwideSeriesSonificationContextTracksMappingNoteDuration NoteDuration_DefaultValue { get; set; }
		...
		/// </summary>
		public VariwideSeriesSonificationContextTracksMappingPan Pan { get; set; }
		private VariwideSeriesSonificationContextTracksMappingPan Pan_DefaultValue { get; set; }
		...
		/// </summary>
		public VariwideSeriesSonificationContextTracksMappingPitch Pitch { get; set; }
		private VariwideSeriesSonificationContextTracksMappingPitch Pitch_DefaultValue { get; set; }
		...
		/// </summary>
		public VariwideSeriesSonificationContextTracksMappingPlayDelay PlayDelay { get; set; }
		private VariwideSeriesSonificationContextTracksMappingPlayDelay PlayDelay_DefaultValue { get; set; }
		...
		/// </summary>
		public VariwideSeriesSonificationContextTracksMappingTime Time { get; set; }
		private VariwideSeriesSonificationContextTracksMappingTime Time_DefaultValue { get; set; }
		...
		/// </summary>
		public VariwideSeriesSonificationContextTracksMappingTremolo Tremolo { get; set; }
		private VariwideSeriesSonificationContextTracksMappingTremolo Tremolo_DefaultValue { get; set; }
		 

		/// <summary>
		/// The volume of notes, from 0 to 1.
		/// </summary>
		public VariwideSeriesSonificationContextTracksMappingVolume Volume { get; set; }
		private VariwideSeriesSonificationContextTracksMappingVolume Volume_DefaultValue { get; set; }
