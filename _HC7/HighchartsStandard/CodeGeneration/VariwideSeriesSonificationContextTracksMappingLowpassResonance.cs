...
{
	public partial class VariwideSeriesSonificationContextTracksMappingLowpassResonance  : BaseObject
	{
		Hashtable h = new Hashtable();

		public VariwideSeriesSonificationContextTracksMappingLowpassResonance()
		{
			MapFunction = MapFunction_DefaultValue = VariwideSeriesSonificationContextTracksMappingLowpassResonanceMapFunction.Linear;
			MapTo = MapTo_DefaultValue = "";
			Max = Max_DefaultValue = null;
			Min = Min_DefaultValue = null;
			Value = Value_DefaultValue = null;
			Within = Within_DefaultValue = VariwideSeriesSonificationContextTracksMappingLowpassResonanceWithin.Chart;
		...
		/// </summary>
		public VariwideSeriesSonificationContextTracksMappingLowpassResonanceMapFunction MapFunction { get; set; }
		private VariwideSeriesSonificationContextTracksMappingLowpassResonanceMapFunction MapFunction_DefaultValue { get; set; }
		...
		/// </summary>
		public VariwideSeriesSonificationContextTracksMappingLowpassResonanceWithin Within { get; set; }
		private VariwideSeriesSonificationContextTracksMappingLowpassResonanceWithin Within_DefaultValue { get; set; }
