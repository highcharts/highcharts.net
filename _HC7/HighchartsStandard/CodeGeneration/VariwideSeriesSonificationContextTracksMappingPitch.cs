...
{
	public partial class VariwideSeriesSonificationContextTracksMappingPitch  : BaseObject
	{
		Hashtable h = new Hashtable();

		public VariwideSeriesSonificationContextTracksMappingPitch()
		{
			MapFunction = MapFunction_DefaultValue = VariwideSeriesSonificationContextTracksMappingPitchMapFunction.Linear;
		...
		/// </summary>
		public VariwideSeriesSonificationContextTracksMappingPitchMapFunction MapFunction { get; set; }
		private VariwideSeriesSonificationContextTracksMappingPitchMapFunction MapFunction_DefaultValue { get; set; }
