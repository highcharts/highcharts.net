...
{
	public partial class VariwideSeriesSonificationDefaultSpeechOptionsMapping  : BaseObject
	{
		Hashtable h = new Hashtable();

		public VariwideSeriesSonificationDefaultSpeechOptionsMapping()
		{
			Frequency = Frequency_DefaultValue = new VariwideSeriesSonificationDefaultSpeechOptionsMappingFrequency();
			GapBetweenNotes = GapBetweenNotes_DefaultValue = new VariwideSeriesSonificationDefaultSpeechOptionsMappingGapBetweenNotes();
			Highpass = Highpass_DefaultValue = new VariwideSeriesSonificationDefaultSpeechOptionsMappingHighpass();
			Lowpass = Lowpass_DefaultValue = new VariwideSeriesSonificationDefaultSpeechOptionsMappingLowpass();
			NoteDuration = NoteDuration_DefaultValue = new VariwideSeriesSonificationDefaultSpeechOptionsMappingNoteDuration();
			Pan = Pan_DefaultValue = new VariwideSeriesSonificationDefaultSpeechOptionsMappingPan();
			Pitch = Pitch_DefaultValue = new VariwideSeriesSonificationDefaultSpeechOptionsMappingPitch();
			PitchString = PitchString_DefaultValue = "null";
			PitchNumber = PitchNumber_DefaultValue = null;
			PlayDelay = PlayDelay_DefaultValue = new VariwideSeriesSonificationDefaultSpeechOptionsMappingPlayDelay();
			Time = Time_DefaultValue = new VariwideSeriesSonificationDefaultSpeechOptionsMappingTime();
			TimeString = TimeString_DefaultValue = "null";
			TimeNumber = TimeNumber_DefaultValue = null;
			Tremolo = Tremolo_DefaultValue = new VariwideSeriesSonificationDefaultSpeechOptionsMappingTremolo();
			Volume = Volume_DefaultValue = new VariwideSeriesSonificationDefaultSpeechOptionsMappingVolume();
		...
		/// </summary>
		public VariwideSeriesSonificationDefaultSpeechOptionsMappingFrequency Frequency { get; set; }
		private VariwideSeriesSonificationDefaultSpeechOptionsMappingFrequency Frequency_DefaultValue { get; set; }
		...
		/// </summary>
		public VariwideSeriesSonificationDefaultSpeechOptionsMappingGapBetweenNotes GapBetweenNotes { get; set; }
		private VariwideSeriesSonificationDefaultSpeechOptionsMappingGapBetweenNotes GapBetweenNotes_DefaultValue { get; set; }
		...
		/// </summary>
		public VariwideSeriesSonificationDefaultSpeechOptionsMappingHighpass Highpass { get; set; }
		private VariwideSeriesSonificationDefaultSpeechOptionsMappingHighpass Highpass_DefaultValue { get; set; }
		...
		/// </summary>
		public VariwideSeriesSonificationDefaultSpeechOptionsMappingLowpass Lowpass { get; set; }
		private VariwideSeriesSonificationDefaultSpeechOptionsMappingLowpass Lowpass_DefaultValue { get; set; }
		...
		/// </summary>
		public VariwideSeriesSonificationDefaultSpeechOptionsMappingNoteDuration NoteDuration { get; set; }
		private VariwideSeriesSonificationDefaultSpeechOptionsMappingNoteDuration NoteDuration_DefaultValue { get; set; }
		...
		/// </summary>
		public VariwideSeriesSonificationDefaultSpeechOptionsMappingPan Pan { get; set; }
		private VariwideSeriesSonificationDefaultSpeechOptionsMappingPan Pan_DefaultValue { get; set; }
		...
		/// </summary>
		public VariwideSeriesSonificationDefaultSpeechOptionsMappingPitch Pitch { get; set; }
		private VariwideSeriesSonificationDefaultSpeechOptionsMappingPitch Pitch_DefaultValue { get; set; }
		...
		/// </summary>
		public VariwideSeriesSonificationDefaultSpeechOptionsMappingPlayDelay PlayDelay { get; set; }
		private VariwideSeriesSonificationDefaultSpeechOptionsMappingPlayDelay PlayDelay_DefaultValue { get; set; }
		...
		/// </summary>
		public VariwideSeriesSonificationDefaultSpeechOptionsMappingTime Time { get; set; }
		private VariwideSeriesSonificationDefaultSpeechOptionsMappingTime Time_DefaultValue { get; set; }
		...
		/// </summary>
		public VariwideSeriesSonificationDefaultSpeechOptionsMappingTremolo Tremolo { get; set; }
		private VariwideSeriesSonificationDefaultSpeechOptionsMappingTremolo Tremolo_DefaultValue { get; set; }
		 

		/// <summary>
		/// The volume of notes, from 0 to 1.
		/// </summary>
		public VariwideSeriesSonificationDefaultSpeechOptionsMappingVolume Volume { get; set; }
		private VariwideSeriesSonificationDefaultSpeechOptionsMappingVolume Volume_DefaultValue { get; set; }
