...
{
	public partial class VariwideSeriesSonificationPointGrouping  : BaseObject
	{
		Hashtable h = new Hashtable();

		public VariwideSeriesSonificationPointGrouping()
		{
		...
		/// </summary>
		public VariwideSeriesSonificationPointGroupingAlgorithm Algorithm { get; set; }
		private VariwideSeriesSonificationPointGroupingAlgorithm Algorithm_DefaultValue { get; set; }
		...
		internal override Hashtable ToHashtable(Highcharts highcharts)
		{
			...
			if (Algorithm != VariwideSeriesSonificationPointGroupingAlgorithm.Null) h.Add("algorithm", highcharts.FirstCharacterToLower(Algorithm.ToString()));
