...
{
	public partial class VariwideSeriesSonificationTracksMapping  : BaseObject
	{
		Hashtable h = new Hashtable();

		public VariwideSeriesSonificationTracksMapping()
		{
			Frequency = Frequency_DefaultValue = new VariwideSeriesSonificationTracksMappingFrequency();
			GapBetweenNotes = GapBetweenNotes_DefaultValue = new VariwideSeriesSonificationTracksMappingGapBetweenNotes();
			Highpass = Highpass_DefaultValue = new VariwideSeriesSonificationTracksMappingHighpass();
			Lowpass = Lowpass_DefaultValue = new VariwideSeriesSonificationTracksMappingLowpass();
			NoteDuration = NoteDuration_DefaultValue = new VariwideSeriesSonificationTracksMappingNoteDuration();
			Pan = Pan_DefaultValue = new VariwideSeriesSonificationTracksMappingPan();
			Pitch = Pitch_DefaultValue = new VariwideSeriesSonificationTracksMappingPitch();
			PitchString = PitchString_DefaultValue = "null";
			PitchNumber = PitchNumber_DefaultValue = null;
			PlayDelay = PlayDelay_DefaultValue = new VariwideSeriesSonificationTracksMappingPlayDelay();
			Time = Time_DefaultValue = new VariwideSeriesSonificationTracksMappingTime();
			TimeString = TimeString_DefaultValue = "null";
			TimeNumber = TimeNumber_DefaultValue = null;
			Tremolo = Tremolo_DefaultValue = new VariwideSeriesSonificationTracksMappingTremolo();
			Volume = Volume_DefaultValue = new VariwideSeriesSonificationTracksMappingVolume();
		...
		/// </summary>
		public VariwideSeriesSonificationTracksMappingFrequency Frequency { get; set; }
		private VariwideSeriesSonificationTracksMappingFrequency Frequency_DefaultValue { get; set; }
		...
		/// </summary>
		public VariwideSeriesSonificationTracksMappingGapBetweenNotes GapBetweenNotes { get; set; }
		private VariwideSeriesSonificationTracksMappingGapBetweenNotes GapBetweenNotes_DefaultValue { get; set; }
		...
		/// </summary>
		public VariwideSeriesSonificationTracksMappingHighpass Highpass { get; set; }
		private VariwideSeriesSonificationTracksMappingHighpass Highpass_DefaultValue { get; set; }
		...
		/// </summary>
		public VariwideSeriesSonificationTracksMappingLowpass Lowpass { get; set; }
		private VariwideSeriesSonificationTracksMappingLowpass Lowpass_DefaultValue { get; set; }
		...
		/// </summary>
		public VariwideSeriesSonificationTracksMappingNoteDuration NoteDuration { get; set; }
		private VariwideSeriesSonificationTracksMappingNoteDuration NoteDuration_DefaultValue { get; set; }
		...
		/// </summary>
		public VariwideSeriesSonificationTracksMappingPan Pan { get; set; }
		private VariwideSeriesSonificationTracksMappingPan Pan_DefaultValue { get; set; }
		...
		/// </summary>
		public VariwideSeriesSonificationTracksMappingPitch Pitch { get; set; }
		private VariwideSeriesSonificationTracksMappingPitch Pitch_DefaultValue { get; set; }
		...
		/// </summary>
		public VariwideSeriesSonificationTracksMappingPlayDelay PlayDelay { get; set; }
		private VariwideSeriesSonificationTracksMappingPlayDelay PlayDelay_DefaultValue { get; set; }
		...
		/// </summary>
		public VariwideSeriesSonificationTracksMappingTime Time { get; set; }
		private VariwideSeriesSonificationTracksMappingTime Time_DefaultValue { get; set; }
		...
		/// </summary>
		public VariwideSeriesSonificationTracksMappingTremolo Tremolo { get; set; }
		private VariwideSeriesSonificationTracksMappingTremolo Tremolo_DefaultValue { get; set; }
		 

		/// <summary>
		/// The volume of notes, from 0 to 1.
		/// </summary>
		public VariwideSeriesSonificationTracksMappingVolume Volume { get; set; }
		private VariwideSeriesSonificationTracksMappingVolume Volume_DefaultValue { get; set; }
