...
{
	public partial class VariwideSeriesSonificationTracksMappingFrequency  : BaseObject
	{
		Hashtable h = new Hashtable();

		public VariwideSeriesSonificationTracksMappingFrequency()
		{
			MapFunction = MapFunction_DefaultValue = VariwideSeriesSonificationTracksMappingFrequencyMapFunction.Linear;
			MapTo = MapTo_DefaultValue = "";
			Max = Max_DefaultValue = null;
			Min = Min_DefaultValue = null;
			Value = Value_DefaultValue = null;
			Within = Within_DefaultValue = VariwideSeriesSonificationTracksMappingFrequencyWithin.Chart;
		...
		/// </summary>
		public VariwideSeriesSonificationTracksMappingFrequencyMapFunction MapFunction { get; set; }
		private VariwideSeriesSonificationTracksMappingFrequencyMapFunction MapFunction_DefaultValue { get; set; }
		...
		/// </summary>
		public VariwideSeriesSonificationTracksMappingFrequencyWithin Within { get; set; }
		private VariwideSeriesSonificationTracksMappingFrequencyWithin Within_DefaultValue { get; set; }
