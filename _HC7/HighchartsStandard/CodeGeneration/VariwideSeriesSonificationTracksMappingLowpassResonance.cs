...
{
	public partial class VariwideSeriesSonificationTracksMappingLowpassResonance  : BaseObject
	{
		Hashtable h = new Hashtable();

		public VariwideSeriesSonificationTracksMappingLowpassResonance()
		{
			MapFunction = MapFunction_DefaultValue = VariwideSeriesSonificationTracksMappingLowpassResonanceMapFunction.Linear;
			MapTo = MapTo_DefaultValue = "";
			Max = Max_DefaultValue = null;
			Min = Min_DefaultValue = null;
			Value = Value_DefaultValue = null;
			Within = Within_DefaultValue = VariwideSeriesSonificationTracksMappingLowpassResonanceWithin.Chart;
		...
		/// </summary>
		public VariwideSeriesSonificationTracksMappingLowpassResonanceMapFunction MapFunction { get; set; }
		private VariwideSeriesSonificationTracksMappingLowpassResonanceMapFunction MapFunction_DefaultValue { get; set; }
		...
		/// </summary>
		public VariwideSeriesSonificationTracksMappingLowpassResonanceWithin Within { get; set; }
		private VariwideSeriesSonificationTracksMappingLowpassResonanceWithin Within_DefaultValue { get; set; }
