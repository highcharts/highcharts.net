...
{
	public partial class VariwideSeriesSonificationTracksMappingPan  : BaseObject
	{
		Hashtable h = new Hashtable();

		public VariwideSeriesSonificationTracksMappingPan()
		{
			MapFunction = MapFunction_DefaultValue = VariwideSeriesSonificationTracksMappingPanMapFunction.Linear;
			MapTo = MapTo_DefaultValue = "";
			Max = Max_DefaultValue = null;
			Min = Min_DefaultValue = null;
			Value = Value_DefaultValue = null;
			Within = Within_DefaultValue = VariwideSeriesSonificationTracksMappingPanWithin.Chart;
		...
		/// </summary>
		public VariwideSeriesSonificationTracksMappingPanMapFunction MapFunction { get; set; }
		private VariwideSeriesSonificationTracksMappingPanMapFunction MapFunction_DefaultValue { get; set; }
		...
		/// </summary>
		public VariwideSeriesSonificationTracksMappingPanWithin Within { get; set; }
		private VariwideSeriesSonificationTracksMappingPanWithin Within_DefaultValue { get; set; }
