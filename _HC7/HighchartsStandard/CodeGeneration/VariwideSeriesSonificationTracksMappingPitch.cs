...
{
	public partial class VariwideSeriesSonificationTracksMappingPitch  : BaseObject
	{
		Hashtable h = new Hashtable();

		public VariwideSeriesSonificationTracksMappingPitch()
		{
			MapFunction = MapFunction_DefaultValue = VariwideSeriesSonificationTracksMappingPitchMapFunction.Linear;
		...
		/// </summary>
		public VariwideSeriesSonificationTracksMappingPitchMapFunction MapFunction { get; set; }
		private VariwideSeriesSonificationTracksMappingPitchMapFunction MapFunction_DefaultValue { get; set; }
