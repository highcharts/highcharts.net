...
{
	public partial class VariwideSeriesSonificationTracksMappingPlayDelay  : BaseObject
	{
		Hashtable h = new Hashtable();

		public VariwideSeriesSonificationTracksMappingPlayDelay()
		{
			MapFunction = MapFunction_DefaultValue = VariwideSeriesSonificationTracksMappingPlayDelayMapFunction.Linear;
			MapTo = MapTo_DefaultValue = "";
			Max = Max_DefaultValue = null;
			Min = Min_DefaultValue = null;
			Value = Value_DefaultValue = null;
			Within = Within_DefaultValue = VariwideSeriesSonificationTracksMappingPlayDelayWithin.Chart;
		...
		/// </summary>
		public VariwideSeriesSonificationTracksMappingPlayDelayMapFunction MapFunction { get; set; }
		private VariwideSeriesSonificationTracksMappingPlayDelayMapFunction MapFunction_DefaultValue { get; set; }
		...
		/// </summary>
		public VariwideSeriesSonificationTracksMappingPlayDelayWithin Within { get; set; }
		private VariwideSeriesSonificationTracksMappingPlayDelayWithin Within_DefaultValue { get; set; }
