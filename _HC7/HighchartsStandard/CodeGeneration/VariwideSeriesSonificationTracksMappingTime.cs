...
{
	public partial class VariwideSeriesSonificationTracksMappingTime  : BaseObject
	{
		Hashtable h = new Hashtable();

		public VariwideSeriesSonificationTracksMappingTime()
		{
			MapFunction = MapFunction_DefaultValue = VariwideSeriesSonificationTracksMappingTimeMapFunction.Linear;
			MapTo = MapTo_DefaultValue = "";
			Max = Max_DefaultValue = null;
			Min = Min_DefaultValue = null;
			Value = Value_DefaultValue = null;
			Within = Within_DefaultValue = VariwideSeriesSonificationTracksMappingTimeWithin.Chart;
		...
		/// </summary>
		public VariwideSeriesSonificationTracksMappingTimeMapFunction MapFunction { get; set; }
		private VariwideSeriesSonificationTracksMappingTimeMapFunction MapFunction_DefaultValue { get; set; }
		...
		/// </summary>
		public VariwideSeriesSonificationTracksMappingTimeWithin Within { get; set; }
		private VariwideSeriesSonificationTracksMappingTimeWithin Within_DefaultValue { get; set; }
