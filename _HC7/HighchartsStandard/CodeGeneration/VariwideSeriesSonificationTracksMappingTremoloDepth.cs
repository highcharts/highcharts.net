...
{
	public partial class VariwideSeriesSonificationTracksMappingTremoloDepth  : BaseObject
	{
		Hashtable h = new Hashtable();

		public VariwideSeriesSonificationTracksMappingTremoloDepth()
		{
			MapFunction = MapFunction_DefaultValue = VariwideSeriesSonificationTracksMappingTremoloDepthMapFunction.Linear;
			MapTo = MapTo_DefaultValue = "";
			Max = Max_DefaultValue = null;
			Min = Min_DefaultValue = null;
			Value = Value_DefaultValue = null;
			Within = Within_DefaultValue = VariwideSeriesSonificationTracksMappingTremoloDepthWithin.Chart;
		...
		/// </summary>
		public VariwideSeriesSonificationTracksMappingTremoloDepthMapFunction MapFunction { get; set; }
		private VariwideSeriesSonificationTracksMappingTremoloDepthMapFunction MapFunction_DefaultValue { get; set; }
		...
		/// </summary>
		public VariwideSeriesSonificationTracksMappingTremoloDepthWithin Within { get; set; }
		private VariwideSeriesSonificationTracksMappingTremoloDepthWithin Within_DefaultValue { get; set; }
