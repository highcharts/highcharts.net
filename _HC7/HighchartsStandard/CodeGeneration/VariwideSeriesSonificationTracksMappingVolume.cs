...
{
	public partial class VariwideSeriesSonificationTracksMappingVolume  : BaseObject
	{
		Hashtable h = new Hashtable();

		public VariwideSeriesSonificationTracksMappingVolume()
		{
			MapFunction = MapFunction_DefaultValue = VariwideSeriesSonificationTracksMappingVolumeMapFunction.Linear;
			MapTo = MapTo_DefaultValue = "";
			Max = Max_DefaultValue = null;
			Min = Min_DefaultValue = null;
			Value = Value_DefaultValue = null;
			Within = Within_DefaultValue = VariwideSeriesSonificationTracksMappingVolumeWithin.Chart;
		...
		/// </summary>
		public VariwideSeriesSonificationTracksMappingVolumeMapFunction MapFunction { get; set; }
		private VariwideSeriesSonificationTracksMappingVolumeMapFunction MapFunction_DefaultValue { get; set; }
		...
		/// </summary>
		public VariwideSeriesSonificationTracksMappingVolumeWithin Within { get; set; }
		private VariwideSeriesSonificationTracksMappingVolumeWithin Within_DefaultValue { get; set; }
