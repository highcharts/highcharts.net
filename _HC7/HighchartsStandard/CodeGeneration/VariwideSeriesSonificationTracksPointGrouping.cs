...
{
	public partial class VariwideSeriesSonificationTracksPointGrouping  : BaseObject
	{
		Hashtable h = new Hashtable();

		public VariwideSeriesSonificationTracksPointGrouping()
		{
		...
		/// </summary>
		public VariwideSeriesSonificationTracksPointGroupingAlgorithm Algorithm { get; set; }
		private VariwideSeriesSonificationTracksPointGroupingAlgorithm Algorithm_DefaultValue { get; set; }
		...
		internal override Hashtable ToHashtable(Highcharts highcharts)
		{
			...
			if (Algorithm != VariwideSeriesSonificationTracksPointGroupingAlgorithm.Null) h.Add("algorithm", highcharts.FirstCharacterToLower(Algorithm.ToString()));
