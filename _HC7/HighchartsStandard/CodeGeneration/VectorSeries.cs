...
namespace Highsoft.Web.Mvc.Charts
{
	public partial class VectorSeries  : Series
	{
		...
		/// </summary>
		public VectorSeriesAccessibility Accessibility { get; set; }
		private VectorSeriesAccessibility Accessibility_DefaultValue { get; set; }
		...
		/// </summary>
		public VectorSeriesCluster Cluster { get; set; }
		private VectorSeriesCluster Cluster_DefaultValue { get; set; }
		...
		/// </summary>
		public VectorSeriesDataSorting DataSorting { get; set; }
		private VectorSeriesDataSorting DataSorting_DefaultValue { get; set; }
		...
		/// </summary>
		public VectorSeriesLegendSymbol LegendSymbol { get; set; }
		private VectorSeriesLegendSymbol LegendSymbol_DefaultValue { get; set; }
		...
		/// </summary>
		public VectorSeriesSonification Sonification { get; set; }
		private VectorSeriesSonification Sonification_DefaultValue { get; set; }
		...
		internal override Hashtable ToHashtable(Highcharts highcharts)
		{
			...
			if (Cursor != VectorSeriesCursor.Null) h.Add("cursor", highcharts.FirstCharacterToLower(Cursor.ToString()));
			...
			if (FindNearestPointBy != VectorSeriesFindNearestPointBy.Null) h.Add("findNearestPointBy", highcharts.FirstCharacterToLower(FindNearestPointBy.ToString()));
			...
			if (LegendSymbol != VectorSeriesLegendSymbol.Null) h.Add("legendSymbol", highcharts.FirstCharacterToLower(LegendSymbol.ToString()));
			if (LineWidth != null) h.Add("lineWidth",LineWidth);
			if (LinkedTo != null) h.Add("linkedTo",LinkedTo);
			if (Marker != null) h.Add("marker",Marker);
			...
			if (PointIntervalUnit != VectorSeriesPointIntervalUnit.Null) h.Add("pointIntervalUnit", highcharts.FirstCharacterToLower(PointIntervalUnit.ToString()));
			if (PointStart != null) h.Add("pointStart",PointStart);
			if (RelativeXValue != null) h.Add("relativeXValue",RelativeXValue);
			if (RotationOrigin != VectorSeriesRotationOrigin.Null) h.Add("rotationOrigin", highcharts.FirstCharacterToLower(RotationOrigin.ToString()));
			...
			h.Add("type","vector");
			if (VectorLength != null) h.Add("vectorLength",VectorLength);
