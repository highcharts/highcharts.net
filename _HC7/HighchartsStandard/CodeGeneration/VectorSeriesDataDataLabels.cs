...
{
	public partial class VectorSeriesDataDataLabels  : BaseObject
	{
		Hashtable h = new Hashtable();

		public VectorSeriesDataDataLabels()
		{
		...
		/// </summary>
		public VectorSeriesDataDataLabelsAlign Align { get; set; }
		private VectorSeriesDataDataLabelsAlign Align_DefaultValue { get; set; }
		...
		/// </summary>
		public VectorSeriesDataDataLabelsFilter Filter { get; set; }
		private VectorSeriesDataDataLabelsFilter Filter_DefaultValue { get; set; }
		...
		/// </summary>
		public VectorSeriesDataDataLabelsOverflow Overflow { get; set; }
		private VectorSeriesDataDataLabelsOverflow Overflow_DefaultValue { get; set; }
		...
		/// </summary>
		public VectorSeriesDataDataLabelsPosition Position { get; set; }
		private VectorSeriesDataDataLabelsPosition Position_DefaultValue { get; set; }
		...
		/// </summary>
		public VectorSeriesDataDataLabelsTextPath TextPath { get; set; }
		private VectorSeriesDataDataLabelsTextPath TextPath_DefaultValue { get; set; }
		...
		/// </summary>
		public VectorSeriesDataDataLabelsVerticalAlign VerticalAlign { get; set; }
		private VectorSeriesDataDataLabelsVerticalAlign VerticalAlign_DefaultValue { get; set; }
		...
		internal override Hashtable ToHashtable(Highcharts highcharts)
		{
			...
			if (Align != VectorSeriesDataDataLabelsAlign.Null) h.Add("align", highcharts.FirstCharacterToLower(Align.ToString()));
			...
			if (Overflow != VectorSeriesDataDataLabelsOverflow.Null) h.Add("overflow", highcharts.FirstCharacterToLower(Overflow.ToString()));
			if (Padding != null) h.Add("padding",Padding);
			if (Position != VectorSeriesDataDataLabelsPosition.Null) h.Add("position", highcharts.FirstCharacterToLower(Position.ToString()));
			...
			if (VerticalAlign != VectorSeriesDataDataLabelsVerticalAlign.Null) h.Add("verticalAlign", highcharts.FirstCharacterToLower(VerticalAlign.ToString()));
			if (X != null) h.Add("x",X);
			if (Y != null) h.Add("y",Y);
