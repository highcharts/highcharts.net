...
{
	public partial class VectorSeriesDataDragDropDragHandle  : BaseObject
	{
		public VectorSeriesDataDragDropDragHandle()
		{
		...
		internal override Hashtable ToHashtable()
		{
			...
			if (PathFormatter != PathFormatter_DefaultValue) { h.Add("pathFormatter",PathFormatter); Highcharts.AddFunction("VectorSeriesDataDragDropDragHandlePathFormatter.pathFormatter", PathFormatter); }  
