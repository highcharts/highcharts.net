...
namespace Highsoft.Web.Mvc.Charts
{
	public partial class VectorSeriesDataDragDropDragHandle  : BaseObject
	{
		...
		internal override Hashtable ToHashtable()
		{
			...
			if (PathFormatter != PathFormatter_DefaultValue) { h.Add("pathFormatter",PathFormatter); Highcharts.AddFunction("33168b6b-7085-4c96-8b51-0dc3a0bf3a90.pathFormatter", PathFormatter); }  
