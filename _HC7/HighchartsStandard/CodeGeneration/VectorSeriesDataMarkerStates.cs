...
namespace Highsoft.Web.Mvc.Charts
{
	public partial class VectorSeriesDataMarkerStates  : BaseObject
	{
		public VectorSeriesDataMarkerStates()
		{
			...
			Inactive = Inactive_DefaultValue = new VectorSeriesDataMarkerStatesInactive();
		...
		/// 
		/// </summary>
		public VectorSeriesDataMarkerStatesInactive Inactive { get; set; }
		private VectorSeriesDataMarkerStatesInactive Inactive_DefaultValue { get; set; }
