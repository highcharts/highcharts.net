...
{
	public partial class VectorSeriesSonificationContextTracksMappingPan  : BaseObject
	{
		Hashtable h = new Hashtable();

		public VectorSeriesSonificationContextTracksMappingPan()
		{
			MapFunction = MapFunction_DefaultValue = VectorSeriesSonificationContextTracksMappingPanMapFunction.Linear;
			MapTo = MapTo_DefaultValue = "";
			Max = Max_DefaultValue = null;
			Min = Min_DefaultValue = null;
			Value = Value_DefaultValue = null;
			Within = Within_DefaultValue = VectorSeriesSonificationContextTracksMappingPanWithin.Chart;
		...
		/// </summary>
		public VectorSeriesSonificationContextTracksMappingPanMapFunction MapFunction { get; set; }
		private VectorSeriesSonificationContextTracksMappingPanMapFunction MapFunction_DefaultValue { get; set; }
		...
		/// </summary>
		public VectorSeriesSonificationContextTracksMappingPanWithin Within { get; set; }
		private VectorSeriesSonificationContextTracksMappingPanWithin Within_DefaultValue { get; set; }
