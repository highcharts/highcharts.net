...
{
	public partial class VectorSeriesSonificationContextTracksMappingPitch  : BaseObject
	{
		Hashtable h = new Hashtable();

		public VectorSeriesSonificationContextTracksMappingPitch()
		{
			MapFunction = MapFunction_DefaultValue = VectorSeriesSonificationContextTracksMappingPitchMapFunction.Linear;
		...
		/// </summary>
		public VectorSeriesSonificationContextTracksMappingPitchMapFunction MapFunction { get; set; }
		private VectorSeriesSonificationContextTracksMappingPitchMapFunction MapFunction_DefaultValue { get; set; }
