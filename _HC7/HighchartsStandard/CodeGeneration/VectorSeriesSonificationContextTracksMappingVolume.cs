...
{
	public partial class VectorSeriesSonificationContextTracksMappingVolume  : BaseObject
	{
		Hashtable h = new Hashtable();

		public VectorSeriesSonificationContextTracksMappingVolume()
		{
			MapFunction = MapFunction_DefaultValue = VectorSeriesSonificationContextTracksMappingVolumeMapFunction.Linear;
			MapTo = MapTo_DefaultValue = "";
			Max = Max_DefaultValue = null;
			Min = Min_DefaultValue = null;
			Value = Value_DefaultValue = null;
			Within = Within_DefaultValue = VectorSeriesSonificationContextTracksMappingVolumeWithin.Chart;
		...
		/// </summary>
		public VectorSeriesSonificationContextTracksMappingVolumeMapFunction MapFunction { get; set; }
		private VectorSeriesSonificationContextTracksMappingVolumeMapFunction MapFunction_DefaultValue { get; set; }
		...
		/// </summary>
		public VectorSeriesSonificationContextTracksMappingVolumeWithin Within { get; set; }
		private VectorSeriesSonificationContextTracksMappingVolumeWithin Within_DefaultValue { get; set; }
