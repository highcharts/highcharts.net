...
{
	public partial class VectorSeriesSonificationContextTracksPointGrouping  : BaseObject
	{
		Hashtable h = new Hashtable();

		public VectorSeriesSonificationContextTracksPointGrouping()
		{
		...
		/// </summary>
		public VectorSeriesSonificationContextTracksPointGroupingAlgorithm Algorithm { get; set; }
		private VectorSeriesSonificationContextTracksPointGroupingAlgorithm Algorithm_DefaultValue { get; set; }
		...
		internal override Hashtable ToHashtable(Highcharts highcharts)
		{
			...
			if (Algorithm != VectorSeriesSonificationContextTracksPointGroupingAlgorithm.Null) h.Add("algorithm", highcharts.FirstCharacterToLower(Algorithm.ToString()));
