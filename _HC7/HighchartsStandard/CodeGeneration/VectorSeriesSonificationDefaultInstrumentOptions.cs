...
{
	public partial class VectorSeriesSonificationDefaultInstrumentOptions  : BaseObject
	{
		Hashtable h = new Hashtable();

		public VectorSeriesSonificationDefaultInstrumentOptions()
		{
			ActiveWhen = ActiveWhen_DefaultValue = new VectorSeriesSonificationDefaultInstrumentOptionsActiveWhen();
			Instrument = Instrument_DefaultValue = null;
			InstrumentString = InstrumentString_DefaultValue = "null";
			Mapping = Mapping_DefaultValue = new VectorSeriesSonificationDefaultInstrumentOptionsMapping();
			MidiName = MidiName_DefaultValue = "";
			PointGrouping = PointGrouping_DefaultValue = new VectorSeriesSonificationDefaultInstrumentOptionsPointGrouping();
			RoundToMusicalNotes = RoundToMusicalNotes_DefaultValue = true;
			ShowPlayMarker = ShowPlayMarker_DefaultValue = true;
			Type = Type_DefaultValue = VectorSeriesSonificationDefaultInstrumentOptionsType.Instrument;
		...
		/// </summary>
		public VectorSeriesSonificationDefaultInstrumentOptionsActiveWhen ActiveWhen { get; set; }
		private VectorSeriesSonificationDefaultInstrumentOptionsActiveWhen ActiveWhen_DefaultValue { get; set; }
		...
		/// </summary>
		public VectorSeriesSonificationDefaultInstrumentOptionsMapping Mapping { get; set; }
		private VectorSeriesSonificationDefaultInstrumentOptionsMapping Mapping_DefaultValue { get; set; }
		...
		/// </summary>
		public VectorSeriesSonificationDefaultInstrumentOptionsPointGrouping PointGrouping { get; set; }
		private VectorSeriesSonificationDefaultInstrumentOptionsPointGrouping PointGrouping_DefaultValue { get; set; }
		...
		/// </summary>
		public VectorSeriesSonificationDefaultInstrumentOptionsType Type { get; set; }
		private VectorSeriesSonificationDefaultInstrumentOptionsType Type_DefaultValue { get; set; }
