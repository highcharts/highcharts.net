...
{
	public partial class VectorSeriesSonificationDefaultSpeechOptionsMappingLowpassResonance  : BaseObject
	{
		Hashtable h = new Hashtable();

		public VectorSeriesSonificationDefaultSpeechOptionsMappingLowpassResonance()
		{
			MapFunction = MapFunction_DefaultValue = VectorSeriesSonificationDefaultSpeechOptionsMappingLowpassResonanceMapFunction.Linear;
			MapTo = MapTo_DefaultValue = "";
			Max = Max_DefaultValue = null;
			Min = Min_DefaultValue = null;
			Value = Value_DefaultValue = null;
			Within = Within_DefaultValue = VectorSeriesSonificationDefaultSpeechOptionsMappingLowpassResonanceWithin.Chart;
		...
		/// </summary>
		public VectorSeriesSonificationDefaultSpeechOptionsMappingLowpassResonanceMapFunction MapFunction { get; set; }
		private VectorSeriesSonificationDefaultSpeechOptionsMappingLowpassResonanceMapFunction MapFunction_DefaultValue { get; set; }
		...
		/// </summary>
		public VectorSeriesSonificationDefaultSpeechOptionsMappingLowpassResonanceWithin Within { get; set; }
		private VectorSeriesSonificationDefaultSpeechOptionsMappingLowpassResonanceWithin Within_DefaultValue { get; set; }
