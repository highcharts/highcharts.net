...
{
	public partial class VectorSeriesSonificationPointGrouping  : BaseObject
	{
		Hashtable h = new Hashtable();

		public VectorSeriesSonificationPointGrouping()
		{
		...
		/// </summary>
		public VectorSeriesSonificationPointGroupingAlgorithm Algorithm { get; set; }
		private VectorSeriesSonificationPointGroupingAlgorithm Algorithm_DefaultValue { get; set; }
		...
		internal override Hashtable ToHashtable(Highcharts highcharts)
		{
			...
			if (Algorithm != VectorSeriesSonificationPointGroupingAlgorithm.Null) h.Add("algorithm", highcharts.FirstCharacterToLower(Algorithm.ToString()));
