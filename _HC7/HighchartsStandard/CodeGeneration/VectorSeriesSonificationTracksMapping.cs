...
{
	public partial class VectorSeriesSonificationTracksMapping  : BaseObject
	{
		Hashtable h = new Hashtable();

		public VectorSeriesSonificationTracksMapping()
		{
			Frequency = Frequency_DefaultValue = new VectorSeriesSonificationTracksMappingFrequency();
			GapBetweenNotes = GapBetweenNotes_DefaultValue = new VectorSeriesSonificationTracksMappingGapBetweenNotes();
			Highpass = Highpass_DefaultValue = new VectorSeriesSonificationTracksMappingHighpass();
			Lowpass = Lowpass_DefaultValue = new VectorSeriesSonificationTracksMappingLowpass();
			NoteDuration = NoteDuration_DefaultValue = new VectorSeriesSonificationTracksMappingNoteDuration();
			Pan = Pan_DefaultValue = new VectorSeriesSonificationTracksMappingPan();
			Pitch = Pitch_DefaultValue = new VectorSeriesSonificationTracksMappingPitch();
			PitchString = PitchString_DefaultValue = "null";
			PitchNumber = PitchNumber_DefaultValue = null;
			PlayDelay = PlayDelay_DefaultValue = new VectorSeriesSonificationTracksMappingPlayDelay();
			Time = Time_DefaultValue = new VectorSeriesSonificationTracksMappingTime();
			TimeString = TimeString_DefaultValue = "null";
			TimeNumber = TimeNumber_DefaultValue = null;
			Tremolo = Tremolo_DefaultValue = new VectorSeriesSonificationTracksMappingTremolo();
			Volume = Volume_DefaultValue = new VectorSeriesSonificationTracksMappingVolume();
		...
		/// </summary>
		public VectorSeriesSonificationTracksMappingFrequency Frequency { get; set; }
		private VectorSeriesSonificationTracksMappingFrequency Frequency_DefaultValue { get; set; }
		...
		/// </summary>
		public VectorSeriesSonificationTracksMappingGapBetweenNotes GapBetweenNotes { get; set; }
		private VectorSeriesSonificationTracksMappingGapBetweenNotes GapBetweenNotes_DefaultValue { get; set; }
		...
		/// </summary>
		public VectorSeriesSonificationTracksMappingHighpass Highpass { get; set; }
		private VectorSeriesSonificationTracksMappingHighpass Highpass_DefaultValue { get; set; }
		...
		/// </summary>
		public VectorSeriesSonificationTracksMappingLowpass Lowpass { get; set; }
		private VectorSeriesSonificationTracksMappingLowpass Lowpass_DefaultValue { get; set; }
		...
		/// </summary>
		public VectorSeriesSonificationTracksMappingNoteDuration NoteDuration { get; set; }
		private VectorSeriesSonificationTracksMappingNoteDuration NoteDuration_DefaultValue { get; set; }
		...
		/// </summary>
		public VectorSeriesSonificationTracksMappingPan Pan { get; set; }
		private VectorSeriesSonificationTracksMappingPan Pan_DefaultValue { get; set; }
		...
		/// </summary>
		public VectorSeriesSonificationTracksMappingPitch Pitch { get; set; }
		private VectorSeriesSonificationTracksMappingPitch Pitch_DefaultValue { get; set; }
		...
		/// </summary>
		public VectorSeriesSonificationTracksMappingPlayDelay PlayDelay { get; set; }
		private VectorSeriesSonificationTracksMappingPlayDelay PlayDelay_DefaultValue { get; set; }
		...
		/// </summary>
		public VectorSeriesSonificationTracksMappingTime Time { get; set; }
		private VectorSeriesSonificationTracksMappingTime Time_DefaultValue { get; set; }
		...
		/// </summary>
		public VectorSeriesSonificationTracksMappingTremolo Tremolo { get; set; }
		private VectorSeriesSonificationTracksMappingTremolo Tremolo_DefaultValue { get; set; }
		 

		/// <summary>
		/// The volume of notes, from 0 to 1.
		/// </summary>
		public VectorSeriesSonificationTracksMappingVolume Volume { get; set; }
		private VectorSeriesSonificationTracksMappingVolume Volume_DefaultValue { get; set; }
