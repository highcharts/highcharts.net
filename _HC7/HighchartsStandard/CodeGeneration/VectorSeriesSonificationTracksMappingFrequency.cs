...
{
	public partial class VectorSeriesSonificationTracksMappingFrequency  : BaseObject
	{
		Hashtable h = new Hashtable();

		public VectorSeriesSonificationTracksMappingFrequency()
		{
			MapFunction = MapFunction_DefaultValue = VectorSeriesSonificationTracksMappingFrequencyMapFunction.Linear;
			MapTo = MapTo_DefaultValue = "";
			Max = Max_DefaultValue = null;
			Min = Min_DefaultValue = null;
			Value = Value_DefaultValue = null;
			Within = Within_DefaultValue = VectorSeriesSonificationTracksMappingFrequencyWithin.Chart;
		...
		/// </summary>
		public VectorSeriesSonificationTracksMappingFrequencyMapFunction MapFunction { get; set; }
		private VectorSeriesSonificationTracksMappingFrequencyMapFunction MapFunction_DefaultValue { get; set; }
		...
		/// </summary>
		public VectorSeriesSonificationTracksMappingFrequencyWithin Within { get; set; }
		private VectorSeriesSonificationTracksMappingFrequencyWithin Within_DefaultValue { get; set; }
