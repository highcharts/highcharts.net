...
{
	public partial class VectorSeriesSonificationTracksMappingHighpassFrequency  : BaseObject
	{
		Hashtable h = new Hashtable();

		public VectorSeriesSonificationTracksMappingHighpassFrequency()
		{
			MapFunction = MapFunction_DefaultValue = VectorSeriesSonificationTracksMappingHighpassFrequencyMapFunction.Linear;
			MapTo = MapTo_DefaultValue = "";
			Max = Max_DefaultValue = null;
			Min = Min_DefaultValue = null;
			Value = Value_DefaultValue = null;
			Within = Within_DefaultValue = VectorSeriesSonificationTracksMappingHighpassFrequencyWithin.Chart;
		...
		/// </summary>
		public VectorSeriesSonificationTracksMappingHighpassFrequencyMapFunction MapFunction { get; set; }
		private VectorSeriesSonificationTracksMappingHighpassFrequencyMapFunction MapFunction_DefaultValue { get; set; }
		...
		/// </summary>
		public VectorSeriesSonificationTracksMappingHighpassFrequencyWithin Within { get; set; }
		private VectorSeriesSonificationTracksMappingHighpassFrequencyWithin Within_DefaultValue { get; set; }
