...
{
	public partial class VectorSeriesSonificationTracksMappingLowpassResonance  : BaseObject
	{
		Hashtable h = new Hashtable();

		public VectorSeriesSonificationTracksMappingLowpassResonance()
		{
			MapFunction = MapFunction_DefaultValue = VectorSeriesSonificationTracksMappingLowpassResonanceMapFunction.Linear;
			MapTo = MapTo_DefaultValue = "";
			Max = Max_DefaultValue = null;
			Min = Min_DefaultValue = null;
			Value = Value_DefaultValue = null;
			Within = Within_DefaultValue = VectorSeriesSonificationTracksMappingLowpassResonanceWithin.Chart;
		...
		/// </summary>
		public VectorSeriesSonificationTracksMappingLowpassResonanceMapFunction MapFunction { get; set; }
		private VectorSeriesSonificationTracksMappingLowpassResonanceMapFunction MapFunction_DefaultValue { get; set; }
		...
		/// </summary>
		public VectorSeriesSonificationTracksMappingLowpassResonanceWithin Within { get; set; }
		private VectorSeriesSonificationTracksMappingLowpassResonanceWithin Within_DefaultValue { get; set; }
