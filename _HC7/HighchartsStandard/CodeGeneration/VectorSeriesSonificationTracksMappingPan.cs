...
{
	public partial class VectorSeriesSonificationTracksMappingPan  : BaseObject
	{
		Hashtable h = new Hashtable();

		public VectorSeriesSonificationTracksMappingPan()
		{
			MapFunction = MapFunction_DefaultValue = VectorSeriesSonificationTracksMappingPanMapFunction.Linear;
			MapTo = MapTo_DefaultValue = "";
			Max = Max_DefaultValue = null;
			Min = Min_DefaultValue = null;
			Value = Value_DefaultValue = null;
			Within = Within_DefaultValue = VectorSeriesSonificationTracksMappingPanWithin.Chart;
		...
		/// </summary>
		public VectorSeriesSonificationTracksMappingPanMapFunction MapFunction { get; set; }
		private VectorSeriesSonificationTracksMappingPanMapFunction MapFunction_DefaultValue { get; set; }
		...
		/// </summary>
		public VectorSeriesSonificationTracksMappingPanWithin Within { get; set; }
		private VectorSeriesSonificationTracksMappingPanWithin Within_DefaultValue { get; set; }
