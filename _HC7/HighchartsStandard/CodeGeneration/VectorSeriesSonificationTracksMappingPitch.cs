...
{
	public partial class VectorSeriesSonificationTracksMappingPitch  : BaseObject
	{
		Hashtable h = new Hashtable();

		public VectorSeriesSonificationTracksMappingPitch()
		{
			MapFunction = MapFunction_DefaultValue = VectorSeriesSonificationTracksMappingPitchMapFunction.Linear;
		...
		/// </summary>
		public VectorSeriesSonificationTracksMappingPitchMapFunction MapFunction { get; set; }
		private VectorSeriesSonificationTracksMappingPitchMapFunction MapFunction_DefaultValue { get; set; }
