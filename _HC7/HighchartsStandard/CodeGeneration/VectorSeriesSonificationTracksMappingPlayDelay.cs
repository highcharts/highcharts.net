...
{
	public partial class VectorSeriesSonificationTracksMappingPlayDelay  : BaseObject
	{
		Hashtable h = new Hashtable();

		public VectorSeriesSonificationTracksMappingPlayDelay()
		{
			MapFunction = MapFunction_DefaultValue = VectorSeriesSonificationTracksMappingPlayDelayMapFunction.Linear;
			MapTo = MapTo_DefaultValue = "";
			Max = Max_DefaultValue = null;
			Min = Min_DefaultValue = null;
			Value = Value_DefaultValue = null;
			Within = Within_DefaultValue = VectorSeriesSonificationTracksMappingPlayDelayWithin.Chart;
		...
		/// </summary>
		public VectorSeriesSonificationTracksMappingPlayDelayMapFunction MapFunction { get; set; }
		private VectorSeriesSonificationTracksMappingPlayDelayMapFunction MapFunction_DefaultValue { get; set; }
		...
		/// </summary>
		public VectorSeriesSonificationTracksMappingPlayDelayWithin Within { get; set; }
		private VectorSeriesSonificationTracksMappingPlayDelayWithin Within_DefaultValue { get; set; }
