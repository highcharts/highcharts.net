...
{
	public partial class VectorSeriesSonificationTracksMappingTime  : BaseObject
	{
		Hashtable h = new Hashtable();

		public VectorSeriesSonificationTracksMappingTime()
		{
			MapFunction = MapFunction_DefaultValue = VectorSeriesSonificationTracksMappingTimeMapFunction.Linear;
			MapTo = MapTo_DefaultValue = "";
			Max = Max_DefaultValue = null;
			Min = Min_DefaultValue = null;
			Value = Value_DefaultValue = null;
			Within = Within_DefaultValue = VectorSeriesSonificationTracksMappingTimeWithin.Chart;
		...
		/// </summary>
		public VectorSeriesSonificationTracksMappingTimeMapFunction MapFunction { get; set; }
		private VectorSeriesSonificationTracksMappingTimeMapFunction MapFunction_DefaultValue { get; set; }
		...
		/// </summary>
		public VectorSeriesSonificationTracksMappingTimeWithin Within { get; set; }
		private VectorSeriesSonificationTracksMappingTimeWithin Within_DefaultValue { get; set; }
