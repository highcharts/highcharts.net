...
{
	public partial class VectorSeriesSonificationTracksMappingTremoloSpeed  : BaseObject
	{
		Hashtable h = new Hashtable();

		public VectorSeriesSonificationTracksMappingTremoloSpeed()
		{
			MapFunction = MapFunction_DefaultValue = VectorSeriesSonificationTracksMappingTremoloSpeedMapFunction.Linear;
			MapTo = MapTo_DefaultValue = "";
			Max = Max_DefaultValue = null;
			Min = Min_DefaultValue = null;
			Value = Value_DefaultValue = null;
			Within = Within_DefaultValue = VectorSeriesSonificationTracksMappingTremoloSpeedWithin.Chart;
		...
		/// </summary>
		public VectorSeriesSonificationTracksMappingTremoloSpeedMapFunction MapFunction { get; set; }
		private VectorSeriesSonificationTracksMappingTremoloSpeedMapFunction MapFunction_DefaultValue { get; set; }
		...
		/// </summary>
		public VectorSeriesSonificationTracksMappingTremoloSpeedWithin Within { get; set; }
		private VectorSeriesSonificationTracksMappingTremoloSpeedWithin Within_DefaultValue { get; set; }
