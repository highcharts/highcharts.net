...
{
	public partial class VectorSeriesSonificationTracksMappingVolume  : BaseObject
	{
		Hashtable h = new Hashtable();

		public VectorSeriesSonificationTracksMappingVolume()
		{
			MapFunction = MapFunction_DefaultValue = VectorSeriesSonificationTracksMappingVolumeMapFunction.Linear;
			MapTo = MapTo_DefaultValue = "";
			Max = Max_DefaultValue = null;
			Min = Min_DefaultValue = null;
			Value = Value_DefaultValue = null;
			Within = Within_DefaultValue = VectorSeriesSonificationTracksMappingVolumeWithin.Chart;
		...
		/// </summary>
		public VectorSeriesSonificationTracksMappingVolumeMapFunction MapFunction { get; set; }
		private VectorSeriesSonificationTracksMappingVolumeMapFunction MapFunction_DefaultValue { get; set; }
		...
		/// </summary>
		public VectorSeriesSonificationTracksMappingVolumeWithin Within { get; set; }
		private VectorSeriesSonificationTracksMappingVolumeWithin Within_DefaultValue { get; set; }
