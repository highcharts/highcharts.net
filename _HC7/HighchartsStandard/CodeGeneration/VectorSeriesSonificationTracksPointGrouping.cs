...
{
	public partial class VectorSeriesSonificationTracksPointGrouping  : BaseObject
	{
		Hashtable h = new Hashtable();

		public VectorSeriesSonificationTracksPointGrouping()
		{
		...
		/// </summary>
		public VectorSeriesSonificationTracksPointGroupingAlgorithm Algorithm { get; set; }
		private VectorSeriesSonificationTracksPointGroupingAlgorithm Algorithm_DefaultValue { get; set; }
		...
		internal override Hashtable ToHashtable(Highcharts highcharts)
		{
			...
			if (Algorithm != VectorSeriesSonificationTracksPointGroupingAlgorithm.Null) h.Add("algorithm", highcharts.FirstCharacterToLower(Algorithm.ToString()));
