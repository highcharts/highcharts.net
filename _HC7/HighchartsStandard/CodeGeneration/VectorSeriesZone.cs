...
{
	public partial class VectorSeriesZone  : BaseObject
	{
		Hashtable h = new Hashtable();

		public VectorSeriesZone()
		{
		}	
		...
		internal override Hashtable ToHashtable(Highcharts highcharts)
		{
			...
			if (DashStyle != VectorSeriesZonesDashStyle.Null) h.Add("dashStyle", highcharts.FirstCharacterToLower(DashStyle.ToString()));
