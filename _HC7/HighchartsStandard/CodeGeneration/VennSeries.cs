...
namespace Highsoft.Web.Mvc.Charts
{
	public partial class VennSeries  : Series
	{
		...
		/// </summary>
		public VennSeriesLegendSymbol LegendSymbol { get; set; }
		private VennSeriesLegendSymbol LegendSymbol_DefaultValue { get; set; }
		...
		/// </summary>
		public VennSeriesSonification Sonification { get; set; }
		private VennSeriesSonification Sonification_DefaultValue { get; set; }
		...
		internal override Hashtable ToHashtable(Highcharts highcharts)
		{
			...
			if (Cursor != VennSeriesCursor.Null) h.Add("cursor", highcharts.FirstCharacterToLower(Cursor.ToString()));
			if (Custom != null) h.Add("custom",Custom);
			if (DashStyle != VennSeriesDashStyle.Null) h.Add("dashStyle", highcharts.FirstCharacterToLower(DashStyle.ToString()));
			...
			if (LegendSymbol != VennSeriesLegendSymbol.Null) h.Add("legendSymbol", highcharts.FirstCharacterToLower(LegendSymbol.ToString()));
			...
			if (Step != VennSeriesStep.Null) h.Add("step", highcharts.FirstCharacterToLower(Step.ToString()));
