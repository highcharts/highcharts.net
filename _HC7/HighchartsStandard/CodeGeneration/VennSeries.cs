...
namespace Highsoft.Web.Mvc.Charts
{
	public partial class VennSeries  : Series
	{
		...
		public VennSeries()
		{
			...
			Dumbell = Dumbell_DefaultValue = new VennSeriesDumbell();
			...
			LegendSymbol = LegendSymbol_DefaultValue = VennSeriesLegendSymbol.Rectangle;
			...
			Sonification = Sonification_DefaultValue = new VennSeriesSonification();
		...
		/// 
		/// </summary>
		public VennSeriesDumbell Dumbell { get; set; }
		private VennSeriesDumbell Dumbell_DefaultValue { get; set; }
