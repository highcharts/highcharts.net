...
{
	public partial class VennSeriesDataDataLabels  : BaseObject
	{
		Hashtable h = new Hashtable();

		public VennSeriesDataDataLabels()
		{
		...
		/// </summary>
		public VennSeriesDataDataLabelsAlign Align { get; set; }
		private VennSeriesDataDataLabelsAlign Align_DefaultValue { get; set; }
		...
		/// </summary>
		public VennSeriesDataDataLabelsFilter Filter { get; set; }
		private VennSeriesDataDataLabelsFilter Filter_DefaultValue { get; set; }
		...
		/// </summary>
		public VennSeriesDataDataLabelsOverflow Overflow { get; set; }
		private VennSeriesDataDataLabelsOverflow Overflow_DefaultValue { get; set; }
		...
		/// </summary>
		public VennSeriesDataDataLabelsPosition Position { get; set; }
		private VennSeriesDataDataLabelsPosition Position_DefaultValue { get; set; }
		...
		/// </summary>
		public VennSeriesDataDataLabelsTextPath TextPath { get; set; }
		private VennSeriesDataDataLabelsTextPath TextPath_DefaultValue { get; set; }
		...
		/// </summary>
		public VennSeriesDataDataLabelsVerticalAlign VerticalAlign { get; set; }
		private VennSeriesDataDataLabelsVerticalAlign VerticalAlign_DefaultValue { get; set; }
		...
		internal override Hashtable ToHashtable(Highcharts highcharts)
		{
			...
			if (Align != VennSeriesDataDataLabelsAlign.Null) h.Add("align", highcharts.FirstCharacterToLower(Align.ToString()));
			...
			if (Overflow != VennSeriesDataDataLabelsOverflow.Null) h.Add("overflow", highcharts.FirstCharacterToLower(Overflow.ToString()));
			if (Padding != null) h.Add("padding",Padding);
			if (Position != VennSeriesDataDataLabelsPosition.Null) h.Add("position", highcharts.FirstCharacterToLower(Position.ToString()));
			...
			if (VerticalAlign != VennSeriesDataDataLabelsVerticalAlign.Null) h.Add("verticalAlign", highcharts.FirstCharacterToLower(VerticalAlign.ToString()));
			if (X != null) h.Add("x",X);
			if (Y != null) h.Add("y",Y);
