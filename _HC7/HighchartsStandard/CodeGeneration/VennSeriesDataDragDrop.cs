...
{
	public partial class VennSeriesDataDragDrop  : BaseObject
	{
		public VennSeriesDataDragDrop()
		{
			DraggableX = DraggableX_DefaultValue = null;
			DraggableY = DraggableY_DefaultValue = null;
			DragHandle = DragHandle_DefaultValue = new VennSeriesDataDragDropDragHandle();
			...
			GuideBox = GuideBox_DefaultValue = new VennSeriesDataDragDropGuideBox();
		...
		/// </summary>
		public VennSeriesDataDragDropDragHandle DragHandle { get; set; }
		private VennSeriesDataDragDropDragHandle DragHandle_DefaultValue { get; set; }
		...
		/// </summary>
		public VennSeriesDataDragDropGuideBox GuideBox { get; set; }
		private VennSeriesDataDragDropGuideBox GuideBox_DefaultValue { get; set; }
