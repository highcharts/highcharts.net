...
{
	public partial class VennSeriesDragDropDragHandle  : BaseObject
	{
		public VennSeriesDragDropDragHandle()
		{
		...
		internal override Hashtable ToHashtable()
		{
			...
			if (PathFormatter != PathFormatter_DefaultValue) { h.Add("pathFormatter",PathFormatter); Highcharts.AddFunction("VennSeriesDragDropDragHandlePathFormatter.pathFormatter", PathFormatter); }  
