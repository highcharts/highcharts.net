...
{
	public partial class VennSeriesSonificationContextTracksMappingFrequency  : BaseObject
	{
		Hashtable h = new Hashtable();

		public VennSeriesSonificationContextTracksMappingFrequency()
		{
			MapFunction = MapFunction_DefaultValue = VennSeriesSonificationContextTracksMappingFrequencyMapFunction.Linear;
			MapTo = MapTo_DefaultValue = "";
			Max = Max_DefaultValue = null;
			Min = Min_DefaultValue = null;
			Value = Value_DefaultValue = null;
			Within = Within_DefaultValue = VennSeriesSonificationContextTracksMappingFrequencyWithin.Chart;
		...
		/// </summary>
		public VennSeriesSonificationContextTracksMappingFrequencyMapFunction MapFunction { get; set; }
		private VennSeriesSonificationContextTracksMappingFrequencyMapFunction MapFunction_DefaultValue { get; set; }
		...
		/// </summary>
		public VennSeriesSonificationContextTracksMappingFrequencyWithin Within { get; set; }
		private VennSeriesSonificationContextTracksMappingFrequencyWithin Within_DefaultValue { get; set; }
