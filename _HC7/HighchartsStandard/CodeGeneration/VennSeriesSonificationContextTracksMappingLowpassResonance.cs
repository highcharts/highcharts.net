...
{
	public partial class VennSeriesSonificationContextTracksMappingLowpassResonance  : BaseObject
	{
		Hashtable h = new Hashtable();

		public VennSeriesSonificationContextTracksMappingLowpassResonance()
		{
			MapFunction = MapFunction_DefaultValue = VennSeriesSonificationContextTracksMappingLowpassResonanceMapFunction.Linear;
			MapTo = MapTo_DefaultValue = "";
			Max = Max_DefaultValue = null;
			Min = Min_DefaultValue = null;
			Value = Value_DefaultValue = null;
			Within = Within_DefaultValue = VennSeriesSonificationContextTracksMappingLowpassResonanceWithin.Chart;
		...
		/// </summary>
		public VennSeriesSonificationContextTracksMappingLowpassResonanceMapFunction MapFunction { get; set; }
		private VennSeriesSonificationContextTracksMappingLowpassResonanceMapFunction MapFunction_DefaultValue { get; set; }
		...
		/// </summary>
		public VennSeriesSonificationContextTracksMappingLowpassResonanceWithin Within { get; set; }
		private VennSeriesSonificationContextTracksMappingLowpassResonanceWithin Within_DefaultValue { get; set; }
