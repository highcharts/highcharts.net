...
{
	public partial class VennSeriesSonificationContextTracksMappingPitch  : BaseObject
	{
		Hashtable h = new Hashtable();

		public VennSeriesSonificationContextTracksMappingPitch()
		{
			MapFunction = MapFunction_DefaultValue = VennSeriesSonificationContextTracksMappingPitchMapFunction.Linear;
		...
		/// </summary>
		public VennSeriesSonificationContextTracksMappingPitchMapFunction MapFunction { get; set; }
		private VennSeriesSonificationContextTracksMappingPitchMapFunction MapFunction_DefaultValue { get; set; }
