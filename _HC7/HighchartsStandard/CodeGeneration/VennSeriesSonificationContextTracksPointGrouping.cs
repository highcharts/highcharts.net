...
{
	public partial class VennSeriesSonificationContextTracksPointGrouping  : BaseObject
	{
		Hashtable h = new Hashtable();

		public VennSeriesSonificationContextTracksPointGrouping()
		{
		...
		/// </summary>
		public VennSeriesSonificationContextTracksPointGroupingAlgorithm Algorithm { get; set; }
		private VennSeriesSonificationContextTracksPointGroupingAlgorithm Algorithm_DefaultValue { get; set; }
		...
		internal override Hashtable ToHashtable(Highcharts highcharts)
		{
			...
			if (Algorithm != VennSeriesSonificationContextTracksPointGroupingAlgorithm.Null) h.Add("algorithm", highcharts.FirstCharacterToLower(Algorithm.ToString()));
