...
{
	public partial class VennSeriesSonificationDefaultInstrumentOptionsMappingLowpassFrequency  : BaseObject
	{
		Hashtable h = new Hashtable();

		public VennSeriesSonificationDefaultInstrumentOptionsMappingLowpassFrequency()
		{
			MapFunction = MapFunction_DefaultValue = VennSeriesSonificationDefaultInstrumentOptionsMappingLowpassFrequencyMapFunction.Linear;
			MapTo = MapTo_DefaultValue = "";
			Max = Max_DefaultValue = null;
			Min = Min_DefaultValue = null;
			Value = Value_DefaultValue = null;
			Within = Within_DefaultValue = VennSeriesSonificationDefaultInstrumentOptionsMappingLowpassFrequencyWithin.Chart;
		...
		/// </summary>
		public VennSeriesSonificationDefaultInstrumentOptionsMappingLowpassFrequencyMapFunction MapFunction { get; set; }
		private VennSeriesSonificationDefaultInstrumentOptionsMappingLowpassFrequencyMapFunction MapFunction_DefaultValue { get; set; }
		...
		/// </summary>
		public VennSeriesSonificationDefaultInstrumentOptionsMappingLowpassFrequencyWithin Within { get; set; }
		private VennSeriesSonificationDefaultInstrumentOptionsMappingLowpassFrequencyWithin Within_DefaultValue { get; set; }
