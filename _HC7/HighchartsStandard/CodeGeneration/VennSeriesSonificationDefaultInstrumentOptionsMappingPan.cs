...
{
	public partial class VennSeriesSonificationDefaultInstrumentOptionsMappingPan  : BaseObject
	{
		Hashtable h = new Hashtable();

		public VennSeriesSonificationDefaultInstrumentOptionsMappingPan()
		{
			MapFunction = MapFunction_DefaultValue = VennSeriesSonificationDefaultInstrumentOptionsMappingPanMapFunction.Linear;
			MapTo = MapTo_DefaultValue = "";
			Max = Max_DefaultValue = null;
			Min = Min_DefaultValue = null;
			Value = Value_DefaultValue = null;
			Within = Within_DefaultValue = VennSeriesSonificationDefaultInstrumentOptionsMappingPanWithin.Chart;
		...
		/// </summary>
		public VennSeriesSonificationDefaultInstrumentOptionsMappingPanMapFunction MapFunction { get; set; }
		private VennSeriesSonificationDefaultInstrumentOptionsMappingPanMapFunction MapFunction_DefaultValue { get; set; }
		...
		/// </summary>
		public VennSeriesSonificationDefaultInstrumentOptionsMappingPanWithin Within { get; set; }
		private VennSeriesSonificationDefaultInstrumentOptionsMappingPanWithin Within_DefaultValue { get; set; }
