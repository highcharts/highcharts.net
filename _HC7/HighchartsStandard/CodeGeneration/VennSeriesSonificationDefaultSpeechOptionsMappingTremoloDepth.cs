...
{
	public partial class VennSeriesSonificationDefaultSpeechOptionsMappingTremoloDepth  : BaseObject
	{
		Hashtable h = new Hashtable();

		public VennSeriesSonificationDefaultSpeechOptionsMappingTremoloDepth()
		{
			MapFunction = MapFunction_DefaultValue = VennSeriesSonificationDefaultSpeechOptionsMappingTremoloDepthMapFunction.Linear;
			MapTo = MapTo_DefaultValue = "";
			Max = Max_DefaultValue = null;
			Min = Min_DefaultValue = null;
			Value = Value_DefaultValue = null;
			Within = Within_DefaultValue = VennSeriesSonificationDefaultSpeechOptionsMappingTremoloDepthWithin.Chart;
		...
		/// </summary>
		public VennSeriesSonificationDefaultSpeechOptionsMappingTremoloDepthMapFunction MapFunction { get; set; }
		private VennSeriesSonificationDefaultSpeechOptionsMappingTremoloDepthMapFunction MapFunction_DefaultValue { get; set; }
		...
		/// </summary>
		public VennSeriesSonificationDefaultSpeechOptionsMappingTremoloDepthWithin Within { get; set; }
		private VennSeriesSonificationDefaultSpeechOptionsMappingTremoloDepthWithin Within_DefaultValue { get; set; }
