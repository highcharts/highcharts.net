...
{
	public partial class VennSeriesSonificationPointGrouping  : BaseObject
	{
		Hashtable h = new Hashtable();

		public VennSeriesSonificationPointGrouping()
		{
		...
		/// </summary>
		public VennSeriesSonificationPointGroupingAlgorithm Algorithm { get; set; }
		private VennSeriesSonificationPointGroupingAlgorithm Algorithm_DefaultValue { get; set; }
		...
		internal override Hashtable ToHashtable(Highcharts highcharts)
		{
			...
			if (Algorithm != VennSeriesSonificationPointGroupingAlgorithm.Null) h.Add("algorithm", highcharts.FirstCharacterToLower(Algorithm.ToString()));
