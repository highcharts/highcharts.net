...
{
	public partial class VennSeriesSonificationTracksMapping  : BaseObject
	{
		Hashtable h = new Hashtable();

		public VennSeriesSonificationTracksMapping()
		{
			Frequency = Frequency_DefaultValue = new VennSeriesSonificationTracksMappingFrequency();
			GapBetweenNotes = GapBetweenNotes_DefaultValue = new VennSeriesSonificationTracksMappingGapBetweenNotes();
			Highpass = Highpass_DefaultValue = new VennSeriesSonificationTracksMappingHighpass();
			Lowpass = Lowpass_DefaultValue = new VennSeriesSonificationTracksMappingLowpass();
			NoteDuration = NoteDuration_DefaultValue = new VennSeriesSonificationTracksMappingNoteDuration();
			Pan = Pan_DefaultValue = new VennSeriesSonificationTracksMappingPan();
			Pitch = Pitch_DefaultValue = new VennSeriesSonificationTracksMappingPitch();
			PitchString = PitchString_DefaultValue = "null";
			PitchNumber = PitchNumber_DefaultValue = null;
			PlayDelay = PlayDelay_DefaultValue = new VennSeriesSonificationTracksMappingPlayDelay();
			Time = Time_DefaultValue = new VennSeriesSonificationTracksMappingTime();
			TimeString = TimeString_DefaultValue = "null";
			TimeNumber = TimeNumber_DefaultValue = null;
			Tremolo = Tremolo_DefaultValue = new VennSeriesSonificationTracksMappingTremolo();
			Volume = Volume_DefaultValue = new VennSeriesSonificationTracksMappingVolume();
		...
		/// </summary>
		public VennSeriesSonificationTracksMappingFrequency Frequency { get; set; }
		private VennSeriesSonificationTracksMappingFrequency Frequency_DefaultValue { get; set; }
		...
		/// </summary>
		public VennSeriesSonificationTracksMappingGapBetweenNotes GapBetweenNotes { get; set; }
		private VennSeriesSonificationTracksMappingGapBetweenNotes GapBetweenNotes_DefaultValue { get; set; }
		...
		/// </summary>
		public VennSeriesSonificationTracksMappingHighpass Highpass { get; set; }
		private VennSeriesSonificationTracksMappingHighpass Highpass_DefaultValue { get; set; }
		...
		/// </summary>
		public VennSeriesSonificationTracksMappingLowpass Lowpass { get; set; }
		private VennSeriesSonificationTracksMappingLowpass Lowpass_DefaultValue { get; set; }
		...
		/// </summary>
		public VennSeriesSonificationTracksMappingNoteDuration NoteDuration { get; set; }
		private VennSeriesSonificationTracksMappingNoteDuration NoteDuration_DefaultValue { get; set; }
		...
		/// </summary>
		public VennSeriesSonificationTracksMappingPan Pan { get; set; }
		private VennSeriesSonificationTracksMappingPan Pan_DefaultValue { get; set; }
		...
		/// </summary>
		public VennSeriesSonificationTracksMappingPitch Pitch { get; set; }
		private VennSeriesSonificationTracksMappingPitch Pitch_DefaultValue { get; set; }
		...
		/// </summary>
		public VennSeriesSonificationTracksMappingPlayDelay PlayDelay { get; set; }
		private VennSeriesSonificationTracksMappingPlayDelay PlayDelay_DefaultValue { get; set; }
		...
		/// </summary>
		public VennSeriesSonificationTracksMappingTime Time { get; set; }
		private VennSeriesSonificationTracksMappingTime Time_DefaultValue { get; set; }
		...
		/// </summary>
		public VennSeriesSonificationTracksMappingTremolo Tremolo { get; set; }
		private VennSeriesSonificationTracksMappingTremolo Tremolo_DefaultValue { get; set; }
		 

		/// <summary>
		/// The volume of notes, from 0 to 1.
		/// </summary>
		public VennSeriesSonificationTracksMappingVolume Volume { get; set; }
		private VennSeriesSonificationTracksMappingVolume Volume_DefaultValue { get; set; }
