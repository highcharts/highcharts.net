...
{
	public partial class VennSeriesSonificationTracksMappingFrequency  : BaseObject
	{
		Hashtable h = new Hashtable();

		public VennSeriesSonificationTracksMappingFrequency()
		{
			MapFunction = MapFunction_DefaultValue = VennSeriesSonificationTracksMappingFrequencyMapFunction.Linear;
			MapTo = MapTo_DefaultValue = "";
			Max = Max_DefaultValue = null;
			Min = Min_DefaultValue = null;
			Value = Value_DefaultValue = null;
			Within = Within_DefaultValue = VennSeriesSonificationTracksMappingFrequencyWithin.Chart;
		...
		/// </summary>
		public VennSeriesSonificationTracksMappingFrequencyMapFunction MapFunction { get; set; }
		private VennSeriesSonificationTracksMappingFrequencyMapFunction MapFunction_DefaultValue { get; set; }
		...
		/// </summary>
		public VennSeriesSonificationTracksMappingFrequencyWithin Within { get; set; }
		private VennSeriesSonificationTracksMappingFrequencyWithin Within_DefaultValue { get; set; }
