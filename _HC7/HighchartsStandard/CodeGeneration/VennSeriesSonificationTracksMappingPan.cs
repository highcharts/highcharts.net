...
{
	public partial class VennSeriesSonificationTracksMappingPan  : BaseObject
	{
		Hashtable h = new Hashtable();

		public VennSeriesSonificationTracksMappingPan()
		{
			MapFunction = MapFunction_DefaultValue = VennSeriesSonificationTracksMappingPanMapFunction.Linear;
			MapTo = MapTo_DefaultValue = "";
			Max = Max_DefaultValue = null;
			Min = Min_DefaultValue = null;
			Value = Value_DefaultValue = null;
			Within = Within_DefaultValue = VennSeriesSonificationTracksMappingPanWithin.Chart;
		...
		/// </summary>
		public VennSeriesSonificationTracksMappingPanMapFunction MapFunction { get; set; }
		private VennSeriesSonificationTracksMappingPanMapFunction MapFunction_DefaultValue { get; set; }
		...
		/// </summary>
		public VennSeriesSonificationTracksMappingPanWithin Within { get; set; }
		private VennSeriesSonificationTracksMappingPanWithin Within_DefaultValue { get; set; }
