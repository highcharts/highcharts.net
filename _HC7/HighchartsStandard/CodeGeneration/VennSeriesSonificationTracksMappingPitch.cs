...
{
	public partial class VennSeriesSonificationTracksMappingPitch  : BaseObject
	{
		Hashtable h = new Hashtable();

		public VennSeriesSonificationTracksMappingPitch()
		{
			MapFunction = MapFunction_DefaultValue = VennSeriesSonificationTracksMappingPitchMapFunction.Linear;
		...
		/// </summary>
		public VennSeriesSonificationTracksMappingPitchMapFunction MapFunction { get; set; }
		private VennSeriesSonificationTracksMappingPitchMapFunction MapFunction_DefaultValue { get; set; }
