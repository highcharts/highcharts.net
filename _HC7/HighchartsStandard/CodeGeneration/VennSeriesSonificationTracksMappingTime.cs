...
{
	public partial class VennSeriesSonificationTracksMappingTime  : BaseObject
	{
		Hashtable h = new Hashtable();

		public VennSeriesSonificationTracksMappingTime()
		{
			MapFunction = MapFunction_DefaultValue = VennSeriesSonificationTracksMappingTimeMapFunction.Linear;
			MapTo = MapTo_DefaultValue = "";
			Max = Max_DefaultValue = null;
			Min = Min_DefaultValue = null;
			Value = Value_DefaultValue = null;
			Within = Within_DefaultValue = VennSeriesSonificationTracksMappingTimeWithin.Chart;
		...
		/// </summary>
		public VennSeriesSonificationTracksMappingTimeMapFunction MapFunction { get; set; }
		private VennSeriesSonificationTracksMappingTimeMapFunction MapFunction_DefaultValue { get; set; }
		...
		/// </summary>
		public VennSeriesSonificationTracksMappingTimeWithin Within { get; set; }
		private VennSeriesSonificationTracksMappingTimeWithin Within_DefaultValue { get; set; }
