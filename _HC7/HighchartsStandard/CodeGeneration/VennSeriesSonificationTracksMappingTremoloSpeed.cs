...
{
	public partial class VennSeriesSonificationTracksMappingTremoloSpeed  : BaseObject
	{
		Hashtable h = new Hashtable();

		public VennSeriesSonificationTracksMappingTremoloSpeed()
		{
			MapFunction = MapFunction_DefaultValue = VennSeriesSonificationTracksMappingTremoloSpeedMapFunction.Linear;
			MapTo = MapTo_DefaultValue = "";
			Max = Max_DefaultValue = null;
			Min = Min_DefaultValue = null;
			Value = Value_DefaultValue = null;
			Within = Within_DefaultValue = VennSeriesSonificationTracksMappingTremoloSpeedWithin.Chart;
		...
		/// </summary>
		public VennSeriesSonificationTracksMappingTremoloSpeedMapFunction MapFunction { get; set; }
		private VennSeriesSonificationTracksMappingTremoloSpeedMapFunction MapFunction_DefaultValue { get; set; }
		...
		/// </summary>
		public VennSeriesSonificationTracksMappingTremoloSpeedWithin Within { get; set; }
		private VennSeriesSonificationTracksMappingTremoloSpeedWithin Within_DefaultValue { get; set; }
