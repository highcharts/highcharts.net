...
{
	public partial class VennSeriesSonificationTracksMappingVolume  : BaseObject
	{
		Hashtable h = new Hashtable();

		public VennSeriesSonificationTracksMappingVolume()
		{
			MapFunction = MapFunction_DefaultValue = VennSeriesSonificationTracksMappingVolumeMapFunction.Linear;
			MapTo = MapTo_DefaultValue = "";
			Max = Max_DefaultValue = null;
			Min = Min_DefaultValue = null;
			Value = Value_DefaultValue = null;
			Within = Within_DefaultValue = VennSeriesSonificationTracksMappingVolumeWithin.Chart;
		...
		/// </summary>
		public VennSeriesSonificationTracksMappingVolumeMapFunction MapFunction { get; set; }
		private VennSeriesSonificationTracksMappingVolumeMapFunction MapFunction_DefaultValue { get; set; }
		...
		/// </summary>
		public VennSeriesSonificationTracksMappingVolumeWithin Within { get; set; }
		private VennSeriesSonificationTracksMappingVolumeWithin Within_DefaultValue { get; set; }
