...
{
	public partial class VennSeriesSonificationTracksPointGrouping  : BaseObject
	{
		Hashtable h = new Hashtable();

		public VennSeriesSonificationTracksPointGrouping()
		{
		...
		/// </summary>
		public VennSeriesSonificationTracksPointGroupingAlgorithm Algorithm { get; set; }
		private VennSeriesSonificationTracksPointGroupingAlgorithm Algorithm_DefaultValue { get; set; }
		...
		internal override Hashtable ToHashtable(Highcharts highcharts)
		{
			...
			if (Algorithm != VennSeriesSonificationTracksPointGroupingAlgorithm.Null) h.Add("algorithm", highcharts.FirstCharacterToLower(Algorithm.ToString()));
