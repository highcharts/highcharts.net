...
namespace Highsoft.Web.Mvc.Charts
{
	public partial class WaterfallSeries  : Series
	{
		...
		{
			Accessibility = Accessibility_DefaultValue = new WaterfallSeriesAccessibility();
			...
			DashStyle = DashStyle_DefaultValue = WaterfallSeriesDashStyle.Null;
			Data = Data_DefaultValue = new List<WaterfallSeriesData>();
			DataLabels = DataLabels_DefaultValue = new WaterfallSeriesDataLabels();
			DataSorting = DataSorting_DefaultValue = new WaterfallSeriesDataSorting();
			Depth = Depth_DefaultValue = 25;
			Description = Description_DefaultValue = "";
			DragDrop = DragDrop_DefaultValue = new WaterfallSeriesDragDrop();
			Dumbell = Dumbell_DefaultValue = new WaterfallSeriesDumbell();
			...
			LegendSymbol = LegendSymbol_DefaultValue = WaterfallSeriesLegendSymbol.Rectangle;
			...
			OnPoint = OnPoint_DefaultValue = new WaterfallSeriesOnPoint();
			...
			Sonification = Sonification_DefaultValue = new WaterfallSeriesSonification();
		...
		/// 
		/// </summary>
		public WaterfallSeriesDumbell Dumbell { get; set; }
		private WaterfallSeriesDumbell Dumbell_DefaultValue { get; set; }
