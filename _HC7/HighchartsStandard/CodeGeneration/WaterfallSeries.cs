...
namespace Highsoft.Web.Mvc.Charts
{
	public partial class WaterfallSeries  : Series
	{
		...
		/// </summary>
		public WaterfallSeriesAccessibility Accessibility { get; set; }
		private WaterfallSeriesAccessibility Accessibility_DefaultValue { get; set; }
		...
		/// </summary>
		public WaterfallSeriesDataSorting DataSorting { get; set; }
		private WaterfallSeriesDataSorting DataSorting_DefaultValue { get; set; }
		...
		/// </summary>
		public WaterfallSeriesLegendSymbol LegendSymbol { get; set; }
		private WaterfallSeriesLegendSymbol LegendSymbol_DefaultValue { get; set; }
		...
		/// </summary>
		public WaterfallSeriesOnPoint OnPoint { get; set; }
		private WaterfallSeriesOnPoint OnPoint_DefaultValue { get; set; }
		...
		/// </summary>
		public WaterfallSeriesPointPlacement PointPlacement { get; set; }
		private WaterfallSeriesPointPlacement PointPlacement_DefaultValue { get; set; }
		...
		/// </summary>
		public WaterfallSeriesSonification Sonification { get; set; }
		private WaterfallSeriesSonification Sonification_DefaultValue { get; set; }
		...
		internal override Hashtable ToHashtable(Highcharts highcharts)
		{
			...
			if (Cursor != WaterfallSeriesCursor.Null) h.Add("cursor", highcharts.FirstCharacterToLower(Cursor.ToString()));
			if (Custom != null) h.Add("custom",Custom);
			if (DashStyle != WaterfallSeriesDashStyle.Null) h.Add("dashStyle", highcharts.FirstCharacterToLower(DashStyle.ToString()));
			...
			if (FindNearestPointBy != WaterfallSeriesFindNearestPointBy.Null) h.Add("findNearestPointBy", highcharts.FirstCharacterToLower(FindNearestPointBy.ToString()));
			...
			if (LegendSymbol != WaterfallSeriesLegendSymbol.Null) h.Add("legendSymbol", highcharts.FirstCharacterToLower(LegendSymbol.ToString()));
			...
			if (PointIntervalUnit != WaterfallSeriesPointIntervalUnit.Null) h.Add("pointIntervalUnit", highcharts.FirstCharacterToLower(PointIntervalUnit.ToString()));
			if (PointPadding != null) h.Add("pointPadding",PointPadding);
			if (PointPlacement != WaterfallSeriesPointPlacement.Null) h.Add("pointPlacement", highcharts.FirstCharacterToLower(PointPlacement.ToString()));
			...
			if (Stacking != WaterfallSeriesStacking.Null) h.Add("stacking", highcharts.FirstCharacterToLower(Stacking.ToString()));
