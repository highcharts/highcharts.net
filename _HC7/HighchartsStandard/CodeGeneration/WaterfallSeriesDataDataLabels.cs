...
{
	public partial class WaterfallSeriesDataDataLabels  : BaseObject
	{
		Hashtable h = new Hashtable();

		public WaterfallSeriesDataDataLabels()
		{
		...
		/// </summary>
		public WaterfallSeriesDataDataLabelsAlign Align { get; set; }
		private WaterfallSeriesDataDataLabelsAlign Align_DefaultValue { get; set; }
		...
		/// </summary>
		public WaterfallSeriesDataDataLabelsFilter Filter { get; set; }
		private WaterfallSeriesDataDataLabelsFilter Filter_DefaultValue { get; set; }
		...
		/// </summary>
		public WaterfallSeriesDataDataLabelsOverflow Overflow { get; set; }
		private WaterfallSeriesDataDataLabelsOverflow Overflow_DefaultValue { get; set; }
		...
		/// </summary>
		public WaterfallSeriesDataDataLabelsPosition Position { get; set; }
		private WaterfallSeriesDataDataLabelsPosition Position_DefaultValue { get; set; }
		...
		/// </summary>
		public WaterfallSeriesDataDataLabelsTextPath TextPath { get; set; }
		private WaterfallSeriesDataDataLabelsTextPath TextPath_DefaultValue { get; set; }
		...
		/// </summary>
		public WaterfallSeriesDataDataLabelsVerticalAlign VerticalAlign { get; set; }
		private WaterfallSeriesDataDataLabelsVerticalAlign VerticalAlign_DefaultValue { get; set; }
		...
		internal override Hashtable ToHashtable(Highcharts highcharts)
		{
			...
			if (Align != WaterfallSeriesDataDataLabelsAlign.Null) h.Add("align", highcharts.FirstCharacterToLower(Align.ToString()));
			...
			if (Overflow != WaterfallSeriesDataDataLabelsOverflow.Null) h.Add("overflow", highcharts.FirstCharacterToLower(Overflow.ToString()));
			if (Padding != null) h.Add("padding",Padding);
			if (Position != WaterfallSeriesDataDataLabelsPosition.Null) h.Add("position", highcharts.FirstCharacterToLower(Position.ToString()));
			...
			if (VerticalAlign != WaterfallSeriesDataDataLabelsVerticalAlign.Null) h.Add("verticalAlign", highcharts.FirstCharacterToLower(VerticalAlign.ToString()));
			if (X != null) h.Add("x",X);
			if (Y != null) h.Add("y",Y);
