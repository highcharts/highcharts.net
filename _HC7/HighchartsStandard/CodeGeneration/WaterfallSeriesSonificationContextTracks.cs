...
{
	public partial class WaterfallSeriesSonificationContextTracks  : BaseObject
	{
		Hashtable h = new Hashtable();

		public WaterfallSeriesSonificationContextTracks()
		{
			ActiveWhen = ActiveWhen_DefaultValue = new WaterfallSeriesSonificationContextTracksActiveWhen();
			Instrument = Instrument_DefaultValue = null;
			InstrumentString = InstrumentString_DefaultValue = "null";
			Mapping = Mapping_DefaultValue = new WaterfallSeriesSonificationContextTracksMapping();
			MidiName = MidiName_DefaultValue = "";
			PointGrouping = PointGrouping_DefaultValue = new WaterfallSeriesSonificationContextTracksPointGrouping();
			...
			Type = Type_DefaultValue = WaterfallSeriesSonificationContextTracksType.Instrument;
			ValueInterval = ValueInterval_DefaultValue = null;
			ValueMapFunction = ValueMapFunction_DefaultValue = WaterfallSeriesSonificationContextTracksValueMapFunction.Linear;
		...
		/// </summary>
		public WaterfallSeriesSonificationContextTracksActiveWhen ActiveWhen { get; set; }
		private WaterfallSeriesSonificationContextTracksActiveWhen ActiveWhen_DefaultValue { get; set; }
		...
		/// </summary>
		public WaterfallSeriesSonificationContextTracksMapping Mapping { get; set; }
		private WaterfallSeriesSonificationContextTracksMapping Mapping_DefaultValue { get; set; }
		...
		/// </summary>
		public WaterfallSeriesSonificationContextTracksPointGrouping PointGrouping { get; set; }
		private WaterfallSeriesSonificationContextTracksPointGrouping PointGrouping_DefaultValue { get; set; }
		...
		/// </summary>
		public WaterfallSeriesSonificationContextTracksType Type { get; set; }
		private WaterfallSeriesSonificationContextTracksType Type_DefaultValue { get; set; }
		...
		/// </summary>
		public WaterfallSeriesSonificationContextTracksValueMapFunction ValueMapFunction { get; set; }
		private WaterfallSeriesSonificationContextTracksValueMapFunction ValueMapFunction_DefaultValue { get; set; }
