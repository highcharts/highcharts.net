...
{
	public partial class WaterfallSeriesSonificationContextTracksMapping  : BaseObject
	{
		Hashtable h = new Hashtable();

		public WaterfallSeriesSonificationContextTracksMapping()
		{
			Frequency = Frequency_DefaultValue = new WaterfallSeriesSonificationContextTracksMappingFrequency();
			GapBetweenNotes = GapBetweenNotes_DefaultValue = new WaterfallSeriesSonificationContextTracksMappingGapBetweenNotes();
			Highpass = Highpass_DefaultValue = new WaterfallSeriesSonificationContextTracksMappingHighpass();
			Lowpass = Lowpass_DefaultValue = new WaterfallSeriesSonificationContextTracksMappingLowpass();
			NoteDuration = NoteDuration_DefaultValue = new WaterfallSeriesSonificationContextTracksMappingNoteDuration();
			Pan = Pan_DefaultValue = new WaterfallSeriesSonificationContextTracksMappingPan();
			Pitch = Pitch_DefaultValue = new WaterfallSeriesSonificationContextTracksMappingPitch();
			PitchString = PitchString_DefaultValue = "null";
			PitchNumber = PitchNumber_DefaultValue = null;
			PlayDelay = PlayDelay_DefaultValue = new WaterfallSeriesSonificationContextTracksMappingPlayDelay();
			Time = Time_DefaultValue = new WaterfallSeriesSonificationContextTracksMappingTime();
			TimeString = TimeString_DefaultValue = "null";
			TimeNumber = TimeNumber_DefaultValue = null;
			Tremolo = Tremolo_DefaultValue = new WaterfallSeriesSonificationContextTracksMappingTremolo();
			Volume = Volume_DefaultValue = new WaterfallSeriesSonificationContextTracksMappingVolume();
		...
		/// </summary>
		public WaterfallSeriesSonificationContextTracksMappingFrequency Frequency { get; set; }
		private WaterfallSeriesSonificationContextTracksMappingFrequency Frequency_DefaultValue { get; set; }
		...
		/// </summary>
		public WaterfallSeriesSonificationContextTracksMappingGapBetweenNotes GapBetweenNotes { get; set; }
		private WaterfallSeriesSonificationContextTracksMappingGapBetweenNotes GapBetweenNotes_DefaultValue { get; set; }
		...
		/// </summary>
		public WaterfallSeriesSonificationContextTracksMappingHighpass Highpass { get; set; }
		private WaterfallSeriesSonificationContextTracksMappingHighpass Highpass_DefaultValue { get; set; }
		...
		/// </summary>
		public WaterfallSeriesSonificationContextTracksMappingLowpass Lowpass { get; set; }
		private WaterfallSeriesSonificationContextTracksMappingLowpass Lowpass_DefaultValue { get; set; }
		...
		/// </summary>
		public WaterfallSeriesSonificationContextTracksMappingNoteDuration NoteDuration { get; set; }
		private WaterfallSeriesSonificationContextTracksMappingNoteDuration NoteDuration_DefaultValue { get; set; }
		...
		/// </summary>
		public WaterfallSeriesSonificationContextTracksMappingPan Pan { get; set; }
		private WaterfallSeriesSonificationContextTracksMappingPan Pan_DefaultValue { get; set; }
		...
		/// </summary>
		public WaterfallSeriesSonificationContextTracksMappingPitch Pitch { get; set; }
		private WaterfallSeriesSonificationContextTracksMappingPitch Pitch_DefaultValue { get; set; }
		...
		/// </summary>
		public WaterfallSeriesSonificationContextTracksMappingPlayDelay PlayDelay { get; set; }
		private WaterfallSeriesSonificationContextTracksMappingPlayDelay PlayDelay_DefaultValue { get; set; }
		...
		/// </summary>
		public WaterfallSeriesSonificationContextTracksMappingTime Time { get; set; }
		private WaterfallSeriesSonificationContextTracksMappingTime Time_DefaultValue { get; set; }
		...
		/// </summary>
		public WaterfallSeriesSonificationContextTracksMappingTremolo Tremolo { get; set; }
		private WaterfallSeriesSonificationContextTracksMappingTremolo Tremolo_DefaultValue { get; set; }
		 

		/// <summary>
		/// The volume of notes, from 0 to 1.
		/// </summary>
		public WaterfallSeriesSonificationContextTracksMappingVolume Volume { get; set; }
		private WaterfallSeriesSonificationContextTracksMappingVolume Volume_DefaultValue { get; set; }
