...
{
	public partial class WaterfallSeriesSonificationContextTracksMappingVolume  : BaseObject
	{
		Hashtable h = new Hashtable();

		public WaterfallSeriesSonificationContextTracksMappingVolume()
		{
			MapFunction = MapFunction_DefaultValue = WaterfallSeriesSonificationContextTracksMappingVolumeMapFunction.Linear;
			MapTo = MapTo_DefaultValue = "";
			Max = Max_DefaultValue = null;
			Min = Min_DefaultValue = null;
			Value = Value_DefaultValue = null;
			Within = Within_DefaultValue = WaterfallSeriesSonificationContextTracksMappingVolumeWithin.Chart;
		...
		/// </summary>
		public WaterfallSeriesSonificationContextTracksMappingVolumeMapFunction MapFunction { get; set; }
		private WaterfallSeriesSonificationContextTracksMappingVolumeMapFunction MapFunction_DefaultValue { get; set; }
		...
		/// </summary>
		public WaterfallSeriesSonificationContextTracksMappingVolumeWithin Within { get; set; }
		private WaterfallSeriesSonificationContextTracksMappingVolumeWithin Within_DefaultValue { get; set; }
