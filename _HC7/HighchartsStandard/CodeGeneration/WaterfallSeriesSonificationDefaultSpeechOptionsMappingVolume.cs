...
{
	public partial class WaterfallSeriesSonificationDefaultSpeechOptionsMappingVolume  : BaseObject
	{
		Hashtable h = new Hashtable();

		public WaterfallSeriesSonificationDefaultSpeechOptionsMappingVolume()
		{
			MapFunction = MapFunction_DefaultValue = WaterfallSeriesSonificationDefaultSpeechOptionsMappingVolumeMapFunction.Linear;
			MapTo = MapTo_DefaultValue = "";
			Max = Max_DefaultValue = null;
			Min = Min_DefaultValue = null;
			Value = Value_DefaultValue = null;
			Within = Within_DefaultValue = WaterfallSeriesSonificationDefaultSpeechOptionsMappingVolumeWithin.Chart;
		...
		/// </summary>
		public WaterfallSeriesSonificationDefaultSpeechOptionsMappingVolumeMapFunction MapFunction { get; set; }
		private WaterfallSeriesSonificationDefaultSpeechOptionsMappingVolumeMapFunction MapFunction_DefaultValue { get; set; }
		...
		/// </summary>
		public WaterfallSeriesSonificationDefaultSpeechOptionsMappingVolumeWithin Within { get; set; }
		private WaterfallSeriesSonificationDefaultSpeechOptionsMappingVolumeWithin Within_DefaultValue { get; set; }
