...
{
	public partial class WaterfallSeriesSonificationPointGrouping  : BaseObject
	{
		Hashtable h = new Hashtable();

		public WaterfallSeriesSonificationPointGrouping()
		{
		...
		/// </summary>
		public WaterfallSeriesSonificationPointGroupingAlgorithm Algorithm { get; set; }
		private WaterfallSeriesSonificationPointGroupingAlgorithm Algorithm_DefaultValue { get; set; }
		...
		internal override Hashtable ToHashtable(Highcharts highcharts)
		{
			...
			if (Algorithm != WaterfallSeriesSonificationPointGroupingAlgorithm.Null) h.Add("algorithm", highcharts.FirstCharacterToLower(Algorithm.ToString()));
