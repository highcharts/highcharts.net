...
{
	public partial class WaterfallSeriesSonificationTracksMapping  : BaseObject
	{
		Hashtable h = new Hashtable();

		public WaterfallSeriesSonificationTracksMapping()
		{
			Frequency = Frequency_DefaultValue = new WaterfallSeriesSonificationTracksMappingFrequency();
			GapBetweenNotes = GapBetweenNotes_DefaultValue = new WaterfallSeriesSonificationTracksMappingGapBetweenNotes();
			Highpass = Highpass_DefaultValue = new WaterfallSeriesSonificationTracksMappingHighpass();
			Lowpass = Lowpass_DefaultValue = new WaterfallSeriesSonificationTracksMappingLowpass();
			NoteDuration = NoteDuration_DefaultValue = new WaterfallSeriesSonificationTracksMappingNoteDuration();
			Pan = Pan_DefaultValue = new WaterfallSeriesSonificationTracksMappingPan();
			Pitch = Pitch_DefaultValue = new WaterfallSeriesSonificationTracksMappingPitch();
			PitchString = PitchString_DefaultValue = "null";
			PitchNumber = PitchNumber_DefaultValue = null;
			PlayDelay = PlayDelay_DefaultValue = new WaterfallSeriesSonificationTracksMappingPlayDelay();
			Time = Time_DefaultValue = new WaterfallSeriesSonificationTracksMappingTime();
			TimeString = TimeString_DefaultValue = "null";
			TimeNumber = TimeNumber_DefaultValue = null;
			Tremolo = Tremolo_DefaultValue = new WaterfallSeriesSonificationTracksMappingTremolo();
			Volume = Volume_DefaultValue = new WaterfallSeriesSonificationTracksMappingVolume();
		...
		/// </summary>
		public WaterfallSeriesSonificationTracksMappingFrequency Frequency { get; set; }
		private WaterfallSeriesSonificationTracksMappingFrequency Frequency_DefaultValue { get; set; }
		...
		/// </summary>
		public WaterfallSeriesSonificationTracksMappingGapBetweenNotes GapBetweenNotes { get; set; }
		private WaterfallSeriesSonificationTracksMappingGapBetweenNotes GapBetweenNotes_DefaultValue { get; set; }
		...
		/// </summary>
		public WaterfallSeriesSonificationTracksMappingHighpass Highpass { get; set; }
		private WaterfallSeriesSonificationTracksMappingHighpass Highpass_DefaultValue { get; set; }
		...
		/// </summary>
		public WaterfallSeriesSonificationTracksMappingLowpass Lowpass { get; set; }
		private WaterfallSeriesSonificationTracksMappingLowpass Lowpass_DefaultValue { get; set; }
		...
		/// </summary>
		public WaterfallSeriesSonificationTracksMappingNoteDuration NoteDuration { get; set; }
		private WaterfallSeriesSonificationTracksMappingNoteDuration NoteDuration_DefaultValue { get; set; }
		...
		/// </summary>
		public WaterfallSeriesSonificationTracksMappingPan Pan { get; set; }
		private WaterfallSeriesSonificationTracksMappingPan Pan_DefaultValue { get; set; }
		...
		/// </summary>
		public WaterfallSeriesSonificationTracksMappingPitch Pitch { get; set; }
		private WaterfallSeriesSonificationTracksMappingPitch Pitch_DefaultValue { get; set; }
		...
		/// </summary>
		public WaterfallSeriesSonificationTracksMappingPlayDelay PlayDelay { get; set; }
		private WaterfallSeriesSonificationTracksMappingPlayDelay PlayDelay_DefaultValue { get; set; }
		...
		/// </summary>
		public WaterfallSeriesSonificationTracksMappingTime Time { get; set; }
		private WaterfallSeriesSonificationTracksMappingTime Time_DefaultValue { get; set; }
		...
		/// </summary>
		public WaterfallSeriesSonificationTracksMappingTremolo Tremolo { get; set; }
		private WaterfallSeriesSonificationTracksMappingTremolo Tremolo_DefaultValue { get; set; }
		 

		/// <summary>
		/// The volume of notes, from 0 to 1.
		/// </summary>
		public WaterfallSeriesSonificationTracksMappingVolume Volume { get; set; }
		private WaterfallSeriesSonificationTracksMappingVolume Volume_DefaultValue { get; set; }
