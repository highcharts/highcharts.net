...
{
	public partial class WaterfallSeriesSonificationTracksMappingFrequency  : BaseObject
	{
		Hashtable h = new Hashtable();

		public WaterfallSeriesSonificationTracksMappingFrequency()
		{
			MapFunction = MapFunction_DefaultValue = WaterfallSeriesSonificationTracksMappingFrequencyMapFunction.Linear;
			MapTo = MapTo_DefaultValue = "";
			Max = Max_DefaultValue = null;
			Min = Min_DefaultValue = null;
			Value = Value_DefaultValue = null;
			Within = Within_DefaultValue = WaterfallSeriesSonificationTracksMappingFrequencyWithin.Chart;
		...
		/// </summary>
		public WaterfallSeriesSonificationTracksMappingFrequencyMapFunction MapFunction { get; set; }
		private WaterfallSeriesSonificationTracksMappingFrequencyMapFunction MapFunction_DefaultValue { get; set; }
		...
		/// </summary>
		public WaterfallSeriesSonificationTracksMappingFrequencyWithin Within { get; set; }
		private WaterfallSeriesSonificationTracksMappingFrequencyWithin Within_DefaultValue { get; set; }
