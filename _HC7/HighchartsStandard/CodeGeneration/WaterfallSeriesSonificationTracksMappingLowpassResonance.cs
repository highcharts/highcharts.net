...
{
	public partial class WaterfallSeriesSonificationTracksMappingLowpassResonance  : BaseObject
	{
		Hashtable h = new Hashtable();

		public WaterfallSeriesSonificationTracksMappingLowpassResonance()
		{
			MapFunction = MapFunction_DefaultValue = WaterfallSeriesSonificationTracksMappingLowpassResonanceMapFunction.Linear;
			MapTo = MapTo_DefaultValue = "";
			Max = Max_DefaultValue = null;
			Min = Min_DefaultValue = null;
			Value = Value_DefaultValue = null;
			Within = Within_DefaultValue = WaterfallSeriesSonificationTracksMappingLowpassResonanceWithin.Chart;
		...
		/// </summary>
		public WaterfallSeriesSonificationTracksMappingLowpassResonanceMapFunction MapFunction { get; set; }
		private WaterfallSeriesSonificationTracksMappingLowpassResonanceMapFunction MapFunction_DefaultValue { get; set; }
		...
		/// </summary>
		public WaterfallSeriesSonificationTracksMappingLowpassResonanceWithin Within { get; set; }
		private WaterfallSeriesSonificationTracksMappingLowpassResonanceWithin Within_DefaultValue { get; set; }
