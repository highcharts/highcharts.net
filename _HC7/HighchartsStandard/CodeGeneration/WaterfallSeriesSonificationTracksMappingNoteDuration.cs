...
{
	public partial class WaterfallSeriesSonificationTracksMappingNoteDuration  : BaseObject
	{
		Hashtable h = new Hashtable();

		public WaterfallSeriesSonificationTracksMappingNoteDuration()
		{
			MapFunction = MapFunction_DefaultValue = WaterfallSeriesSonificationTracksMappingNoteDurationMapFunction.Linear;
			MapTo = MapTo_DefaultValue = "";
			Max = Max_DefaultValue = null;
			Min = Min_DefaultValue = null;
			Value = Value_DefaultValue = null;
			Within = Within_DefaultValue = WaterfallSeriesSonificationTracksMappingNoteDurationWithin.Chart;
		...
		/// </summary>
		public WaterfallSeriesSonificationTracksMappingNoteDurationMapFunction MapFunction { get; set; }
		private WaterfallSeriesSonificationTracksMappingNoteDurationMapFunction MapFunction_DefaultValue { get; set; }
		...
		/// </summary>
		public WaterfallSeriesSonificationTracksMappingNoteDurationWithin Within { get; set; }
		private WaterfallSeriesSonificationTracksMappingNoteDurationWithin Within_DefaultValue { get; set; }
