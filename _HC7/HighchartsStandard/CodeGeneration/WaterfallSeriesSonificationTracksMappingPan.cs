...
{
	public partial class WaterfallSeriesSonificationTracksMappingPan  : BaseObject
	{
		Hashtable h = new Hashtable();

		public WaterfallSeriesSonificationTracksMappingPan()
		{
			MapFunction = MapFunction_DefaultValue = WaterfallSeriesSonificationTracksMappingPanMapFunction.Linear;
			MapTo = MapTo_DefaultValue = "";
			Max = Max_DefaultValue = null;
			Min = Min_DefaultValue = null;
			Value = Value_DefaultValue = null;
			Within = Within_DefaultValue = WaterfallSeriesSonificationTracksMappingPanWithin.Chart;
		...
		/// </summary>
		public WaterfallSeriesSonificationTracksMappingPanMapFunction MapFunction { get; set; }
		private WaterfallSeriesSonificationTracksMappingPanMapFunction MapFunction_DefaultValue { get; set; }
		...
		/// </summary>
		public WaterfallSeriesSonificationTracksMappingPanWithin Within { get; set; }
		private WaterfallSeriesSonificationTracksMappingPanWithin Within_DefaultValue { get; set; }
