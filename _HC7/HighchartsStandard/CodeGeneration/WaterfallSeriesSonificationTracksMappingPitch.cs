...
{
	public partial class WaterfallSeriesSonificationTracksMappingPitch  : BaseObject
	{
		Hashtable h = new Hashtable();

		public WaterfallSeriesSonificationTracksMappingPitch()
		{
			MapFunction = MapFunction_DefaultValue = WaterfallSeriesSonificationTracksMappingPitchMapFunction.Linear;
		...
		/// </summary>
		public WaterfallSeriesSonificationTracksMappingPitchMapFunction MapFunction { get; set; }
		private WaterfallSeriesSonificationTracksMappingPitchMapFunction MapFunction_DefaultValue { get; set; }
