...
{
	public partial class WaterfallSeriesSonificationTracksMappingPlayDelay  : BaseObject
	{
		Hashtable h = new Hashtable();

		public WaterfallSeriesSonificationTracksMappingPlayDelay()
		{
			MapFunction = MapFunction_DefaultValue = WaterfallSeriesSonificationTracksMappingPlayDelayMapFunction.Linear;
			MapTo = MapTo_DefaultValue = "";
			Max = Max_DefaultValue = null;
			Min = Min_DefaultValue = null;
			Value = Value_DefaultValue = null;
			Within = Within_DefaultValue = WaterfallSeriesSonificationTracksMappingPlayDelayWithin.Chart;
		...
		/// </summary>
		public WaterfallSeriesSonificationTracksMappingPlayDelayMapFunction MapFunction { get; set; }
		private WaterfallSeriesSonificationTracksMappingPlayDelayMapFunction MapFunction_DefaultValue { get; set; }
		...
		/// </summary>
		public WaterfallSeriesSonificationTracksMappingPlayDelayWithin Within { get; set; }
		private WaterfallSeriesSonificationTracksMappingPlayDelayWithin Within_DefaultValue { get; set; }
