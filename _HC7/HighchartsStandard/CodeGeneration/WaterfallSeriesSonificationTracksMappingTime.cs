...
{
	public partial class WaterfallSeriesSonificationTracksMappingTime  : BaseObject
	{
		Hashtable h = new Hashtable();

		public WaterfallSeriesSonificationTracksMappingTime()
		{
			MapFunction = MapFunction_DefaultValue = WaterfallSeriesSonificationTracksMappingTimeMapFunction.Linear;
			MapTo = MapTo_DefaultValue = "";
			Max = Max_DefaultValue = null;
			Min = Min_DefaultValue = null;
			Value = Value_DefaultValue = null;
			Within = Within_DefaultValue = WaterfallSeriesSonificationTracksMappingTimeWithin.Chart;
		...
		/// </summary>
		public WaterfallSeriesSonificationTracksMappingTimeMapFunction MapFunction { get; set; }
		private WaterfallSeriesSonificationTracksMappingTimeMapFunction MapFunction_DefaultValue { get; set; }
		...
		/// </summary>
		public WaterfallSeriesSonificationTracksMappingTimeWithin Within { get; set; }
		private WaterfallSeriesSonificationTracksMappingTimeWithin Within_DefaultValue { get; set; }
