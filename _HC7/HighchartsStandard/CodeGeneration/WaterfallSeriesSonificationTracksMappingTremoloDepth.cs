...
{
	public partial class WaterfallSeriesSonificationTracksMappingTremoloDepth  : BaseObject
	{
		Hashtable h = new Hashtable();

		public WaterfallSeriesSonificationTracksMappingTremoloDepth()
		{
			MapFunction = MapFunction_DefaultValue = WaterfallSeriesSonificationTracksMappingTremoloDepthMapFunction.Linear;
			MapTo = MapTo_DefaultValue = "";
			Max = Max_DefaultValue = null;
			Min = Min_DefaultValue = null;
			Value = Value_DefaultValue = null;
			Within = Within_DefaultValue = WaterfallSeriesSonificationTracksMappingTremoloDepthWithin.Chart;
		...
		/// </summary>
		public WaterfallSeriesSonificationTracksMappingTremoloDepthMapFunction MapFunction { get; set; }
		private WaterfallSeriesSonificationTracksMappingTremoloDepthMapFunction MapFunction_DefaultValue { get; set; }
		...
		/// </summary>
		public WaterfallSeriesSonificationTracksMappingTremoloDepthWithin Within { get; set; }
		private WaterfallSeriesSonificationTracksMappingTremoloDepthWithin Within_DefaultValue { get; set; }
