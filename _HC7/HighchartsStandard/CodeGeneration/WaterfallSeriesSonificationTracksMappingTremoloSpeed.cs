...
{
	public partial class WaterfallSeriesSonificationTracksMappingTremoloSpeed  : BaseObject
	{
		Hashtable h = new Hashtable();

		public WaterfallSeriesSonificationTracksMappingTremoloSpeed()
		{
			MapFunction = MapFunction_DefaultValue = WaterfallSeriesSonificationTracksMappingTremoloSpeedMapFunction.Linear;
			MapTo = MapTo_DefaultValue = "";
			Max = Max_DefaultValue = null;
			Min = Min_DefaultValue = null;
			Value = Value_DefaultValue = null;
			Within = Within_DefaultValue = WaterfallSeriesSonificationTracksMappingTremoloSpeedWithin.Chart;
		...
		/// </summary>
		public WaterfallSeriesSonificationTracksMappingTremoloSpeedMapFunction MapFunction { get; set; }
		private WaterfallSeriesSonificationTracksMappingTremoloSpeedMapFunction MapFunction_DefaultValue { get; set; }
		...
		/// </summary>
		public WaterfallSeriesSonificationTracksMappingTremoloSpeedWithin Within { get; set; }
		private WaterfallSeriesSonificationTracksMappingTremoloSpeedWithin Within_DefaultValue { get; set; }
