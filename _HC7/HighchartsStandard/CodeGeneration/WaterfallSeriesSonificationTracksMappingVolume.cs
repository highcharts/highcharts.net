...
{
	public partial class WaterfallSeriesSonificationTracksMappingVolume  : BaseObject
	{
		Hashtable h = new Hashtable();

		public WaterfallSeriesSonificationTracksMappingVolume()
		{
			MapFunction = MapFunction_DefaultValue = WaterfallSeriesSonificationTracksMappingVolumeMapFunction.Linear;
			MapTo = MapTo_DefaultValue = "";
			Max = Max_DefaultValue = null;
			Min = Min_DefaultValue = null;
			Value = Value_DefaultValue = null;
			Within = Within_DefaultValue = WaterfallSeriesSonificationTracksMappingVolumeWithin.Chart;
		...
		/// </summary>
		public WaterfallSeriesSonificationTracksMappingVolumeMapFunction MapFunction { get; set; }
		private WaterfallSeriesSonificationTracksMappingVolumeMapFunction MapFunction_DefaultValue { get; set; }
		...
		/// </summary>
		public WaterfallSeriesSonificationTracksMappingVolumeWithin Within { get; set; }
		private WaterfallSeriesSonificationTracksMappingVolumeWithin Within_DefaultValue { get; set; }
