...
namespace Highsoft.Web.Mvc.Charts
{
	public partial class WaterfallSeriesStatesHoverMarkerStates  : BaseObject
	{
		public WaterfallSeriesStatesHoverMarkerStates()
		{
			...
			Inactive = Inactive_DefaultValue = new WaterfallSeriesStatesHoverMarkerStatesInactive();
		...
		/// 
		/// </summary>
		public WaterfallSeriesStatesHoverMarkerStatesInactive Inactive { get; set; }
		private WaterfallSeriesStatesHoverMarkerStatesInactive Inactive_DefaultValue { get; set; }
