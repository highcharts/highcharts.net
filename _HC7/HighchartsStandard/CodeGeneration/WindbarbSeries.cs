...
namespace Highsoft.Web.Mvc.Charts
{
	public partial class WindbarbSeries  : Series
	{
		...
		internal override Hashtable ToHashtable()
		{
			...
			if (PointDescriptionFormatter != PointDescriptionFormatter_DefaultValue) { h.Add("pointDescriptionFormatter",PointDescriptionFormatter); Highcharts.AddFunction("d73235a0-fa95-4116-97a5-ee8b5899aa7f.pointDescriptionFormatter", PointDescriptionFormatter); }  
