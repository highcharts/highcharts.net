...
namespace Highsoft.Web.Mvc.Charts
{
	public partial class WindbarbSeries  : Series
	{
		...
		/// </summary>
		public WindbarbSeriesPointPlacement PointPlacement { get; set; }
		private WindbarbSeriesPointPlacement PointPlacement_DefaultValue { get; set; }
		...
		internal override Hashtable ToHashtable(Highcharts highcharts)
		{
			...
			if (Cursor != WindbarbSeriesCursor.Null) h.Add("cursor", highcharts.FirstCharacterToLower(Cursor.ToString()));
			if (Custom != null) h.Add("custom",Custom);
			if (Data != null) h.Add("data",HashifyList(highcharts,Data));
			if (DataGrouping != null) h.Add("dataGrouping",DataGrouping.ToHashtable(highcharts));
			...
			if (FindNearestPointBy != WindbarbSeriesFindNearestPointBy.Null) h.Add("findNearestPointBy", highcharts.FirstCharacterToLower(FindNearestPointBy.ToString()));
			...
			if (LegendSymbol != WindbarbSeriesLegendSymbol.Null) h.Add("legendSymbol", highcharts.FirstCharacterToLower(LegendSymbol.ToString()));
			...
			if (PointIntervalUnit != WindbarbSeriesPointIntervalUnit.Null) h.Add("pointIntervalUnit", highcharts.FirstCharacterToLower(PointIntervalUnit.ToString()));
			if (PointPadding != null) h.Add("pointPadding",PointPadding);
			if (PointPlacement != WindbarbSeriesPointPlacement.Null) h.Add("pointPlacement", highcharts.FirstCharacterToLower(PointPlacement.ToString()));
			...
			if (XOffset != null) h.Add("xOffset",XOffset);
			if (YAxis != null) h.Add("yAxis",YAxis);
			if (YAxisNumber != null) h.Add("yAxis",YAxisNumber);
			if (YOffset != null) h.Add("yOffset",YOffset);
