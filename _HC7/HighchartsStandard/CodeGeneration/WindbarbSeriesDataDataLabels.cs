...
{
	public partial class WindbarbSeriesDataDataLabels  : BaseObject
	{
		Hashtable h = new Hashtable();

		public WindbarbSeriesDataDataLabels()
		{
		...
		/// </summary>
		public WindbarbSeriesDataDataLabelsAlign Align { get; set; }
		private WindbarbSeriesDataDataLabelsAlign Align_DefaultValue { get; set; }
		...
		/// </summary>
		public WindbarbSeriesDataDataLabelsFilter Filter { get; set; }
		private WindbarbSeriesDataDataLabelsFilter Filter_DefaultValue { get; set; }
		...
		/// </summary>
		public WindbarbSeriesDataDataLabelsOverflow Overflow { get; set; }
		private WindbarbSeriesDataDataLabelsOverflow Overflow_DefaultValue { get; set; }
		...
		/// </summary>
		public WindbarbSeriesDataDataLabelsPosition Position { get; set; }
		private WindbarbSeriesDataDataLabelsPosition Position_DefaultValue { get; set; }
		...
		/// </summary>
		public WindbarbSeriesDataDataLabelsTextPath TextPath { get; set; }
		private WindbarbSeriesDataDataLabelsTextPath TextPath_DefaultValue { get; set; }
		...
		/// </summary>
		public WindbarbSeriesDataDataLabelsVerticalAlign VerticalAlign { get; set; }
		private WindbarbSeriesDataDataLabelsVerticalAlign VerticalAlign_DefaultValue { get; set; }
		...
		internal override Hashtable ToHashtable(Highcharts highcharts)
		{
			...
			if (Align != WindbarbSeriesDataDataLabelsAlign.Null) h.Add("align", highcharts.FirstCharacterToLower(Align.ToString()));
			...
			if (Overflow != WindbarbSeriesDataDataLabelsOverflow.Null) h.Add("overflow", highcharts.FirstCharacterToLower(Overflow.ToString()));
			if (Padding != null) h.Add("padding",Padding);
			if (Position != WindbarbSeriesDataDataLabelsPosition.Null) h.Add("position", highcharts.FirstCharacterToLower(Position.ToString()));
			...
			if (VerticalAlign != WindbarbSeriesDataDataLabelsVerticalAlign.Null) h.Add("verticalAlign", highcharts.FirstCharacterToLower(VerticalAlign.ToString()));
			if (X != null) h.Add("x",X);
			if (Y != null) h.Add("y",Y);
