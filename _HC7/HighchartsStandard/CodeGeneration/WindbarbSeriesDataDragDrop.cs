...
{
	public partial class WindbarbSeriesDataDragDrop  : BaseObject
	{
		public WindbarbSeriesDataDragDrop()
		{
			DraggableX = DraggableX_DefaultValue = null;
			DraggableY = DraggableY_DefaultValue = null;
			DragHandle = DragHandle_DefaultValue = new WindbarbSeriesDataDragDropDragHandle();
			...
			GuideBox = GuideBox_DefaultValue = new WindbarbSeriesDataDragDropGuideBox();
		...
		/// </summary>
		public WindbarbSeriesDataDragDropDragHandle DragHandle { get; set; }
		private WindbarbSeriesDataDragDropDragHandle DragHandle_DefaultValue { get; set; }
		...
		/// </summary>
		public WindbarbSeriesDataDragDropGuideBox GuideBox { get; set; }
		private WindbarbSeriesDataDragDropGuideBox GuideBox_DefaultValue { get; set; }
