...
namespace Highsoft.Web.Mvc.Charts
{
	public partial class WindbarbSeriesDragDropDragHandle  : BaseObject
	{
		...
		internal override Hashtable ToHashtable()
		{
			...
			if (PathFormatter != PathFormatter_DefaultValue) { h.Add("pathFormatter",PathFormatter); Highcharts.AddFunction("63bff127-c798-4a93-ba70-90d14c100e06.pathFormatter", PathFormatter); }  
