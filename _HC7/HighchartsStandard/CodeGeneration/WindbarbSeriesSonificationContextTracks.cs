...
{
	public partial class WindbarbSeriesSonificationContextTracks  : BaseObject
	{
		Hashtable h = new Hashtable();

		public WindbarbSeriesSonificationContextTracks()
		{
			ActiveWhen = ActiveWhen_DefaultValue = new WindbarbSeriesSonificationContextTracksActiveWhen();
			Instrument = Instrument_DefaultValue = null;
			InstrumentString = InstrumentString_DefaultValue = "null";
			Mapping = Mapping_DefaultValue = new WindbarbSeriesSonificationContextTracksMapping();
			MidiName = MidiName_DefaultValue = "";
			PointGrouping = PointGrouping_DefaultValue = new WindbarbSeriesSonificationContextTracksPointGrouping();
			...
			Type = Type_DefaultValue = WindbarbSeriesSonificationContextTracksType.Instrument;
			ValueInterval = ValueInterval_DefaultValue = null;
			ValueMapFunction = ValueMapFunction_DefaultValue = WindbarbSeriesSonificationContextTracksValueMapFunction.Linear;
		...
		/// </summary>
		public WindbarbSeriesSonificationContextTracksActiveWhen ActiveWhen { get; set; }
		private WindbarbSeriesSonificationContextTracksActiveWhen ActiveWhen_DefaultValue { get; set; }
		...
		/// </summary>
		public WindbarbSeriesSonificationContextTracksMapping Mapping { get; set; }
		private WindbarbSeriesSonificationContextTracksMapping Mapping_DefaultValue { get; set; }
		...
		/// </summary>
		public WindbarbSeriesSonificationContextTracksPointGrouping PointGrouping { get; set; }
		private WindbarbSeriesSonificationContextTracksPointGrouping PointGrouping_DefaultValue { get; set; }
		...
		/// </summary>
		public WindbarbSeriesSonificationContextTracksType Type { get; set; }
		private WindbarbSeriesSonificationContextTracksType Type_DefaultValue { get; set; }
		...
		/// </summary>
		public WindbarbSeriesSonificationContextTracksValueMapFunction ValueMapFunction { get; set; }
		private WindbarbSeriesSonificationContextTracksValueMapFunction ValueMapFunction_DefaultValue { get; set; }
