...
{
	public partial class WindbarbSeriesSonificationContextTracksMappingLowpassResonance  : BaseObject
	{
		Hashtable h = new Hashtable();

		public WindbarbSeriesSonificationContextTracksMappingLowpassResonance()
		{
			MapFunction = MapFunction_DefaultValue = WindbarbSeriesSonificationContextTracksMappingLowpassResonanceMapFunction.Linear;
			MapTo = MapTo_DefaultValue = "";
			Max = Max_DefaultValue = null;
			Min = Min_DefaultValue = null;
			Value = Value_DefaultValue = null;
			Within = Within_DefaultValue = WindbarbSeriesSonificationContextTracksMappingLowpassResonanceWithin.Chart;
		...
		/// </summary>
		public WindbarbSeriesSonificationContextTracksMappingLowpassResonanceMapFunction MapFunction { get; set; }
		private WindbarbSeriesSonificationContextTracksMappingLowpassResonanceMapFunction MapFunction_DefaultValue { get; set; }
		...
		/// </summary>
		public WindbarbSeriesSonificationContextTracksMappingLowpassResonanceWithin Within { get; set; }
		private WindbarbSeriesSonificationContextTracksMappingLowpassResonanceWithin Within_DefaultValue { get; set; }
