...
{
	public partial class WindbarbSeriesSonificationContextTracksMappingPan  : BaseObject
	{
		Hashtable h = new Hashtable();

		public WindbarbSeriesSonificationContextTracksMappingPan()
		{
			MapFunction = MapFunction_DefaultValue = WindbarbSeriesSonificationContextTracksMappingPanMapFunction.Linear;
			MapTo = MapTo_DefaultValue = "";
			Max = Max_DefaultValue = null;
			Min = Min_DefaultValue = null;
			Value = Value_DefaultValue = null;
			Within = Within_DefaultValue = WindbarbSeriesSonificationContextTracksMappingPanWithin.Chart;
		...
		/// </summary>
		public WindbarbSeriesSonificationContextTracksMappingPanMapFunction MapFunction { get; set; }
		private WindbarbSeriesSonificationContextTracksMappingPanMapFunction MapFunction_DefaultValue { get; set; }
		...
		/// </summary>
		public WindbarbSeriesSonificationContextTracksMappingPanWithin Within { get; set; }
		private WindbarbSeriesSonificationContextTracksMappingPanWithin Within_DefaultValue { get; set; }
