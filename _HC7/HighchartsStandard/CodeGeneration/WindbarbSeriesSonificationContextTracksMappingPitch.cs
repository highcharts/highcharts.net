...
{
	public partial class WindbarbSeriesSonificationContextTracksMappingPitch  : BaseObject
	{
		Hashtable h = new Hashtable();

		public WindbarbSeriesSonificationContextTracksMappingPitch()
		{
			MapFunction = MapFunction_DefaultValue = WindbarbSeriesSonificationContextTracksMappingPitchMapFunction.Linear;
		...
		/// </summary>
		public WindbarbSeriesSonificationContextTracksMappingPitchMapFunction MapFunction { get; set; }
		private WindbarbSeriesSonificationContextTracksMappingPitchMapFunction MapFunction_DefaultValue { get; set; }
