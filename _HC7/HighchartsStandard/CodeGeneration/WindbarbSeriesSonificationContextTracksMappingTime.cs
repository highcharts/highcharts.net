...
{
	public partial class WindbarbSeriesSonificationContextTracksMappingTime  : BaseObject
	{
		Hashtable h = new Hashtable();

		public WindbarbSeriesSonificationContextTracksMappingTime()
		{
			MapFunction = MapFunction_DefaultValue = WindbarbSeriesSonificationContextTracksMappingTimeMapFunction.Linear;
			MapTo = MapTo_DefaultValue = "";
			Max = Max_DefaultValue = null;
			Min = Min_DefaultValue = null;
			Value = Value_DefaultValue = null;
			Within = Within_DefaultValue = WindbarbSeriesSonificationContextTracksMappingTimeWithin.Chart;
		...
		/// </summary>
		public WindbarbSeriesSonificationContextTracksMappingTimeMapFunction MapFunction { get; set; }
		private WindbarbSeriesSonificationContextTracksMappingTimeMapFunction MapFunction_DefaultValue { get; set; }
		...
		/// </summary>
		public WindbarbSeriesSonificationContextTracksMappingTimeWithin Within { get; set; }
		private WindbarbSeriesSonificationContextTracksMappingTimeWithin Within_DefaultValue { get; set; }
