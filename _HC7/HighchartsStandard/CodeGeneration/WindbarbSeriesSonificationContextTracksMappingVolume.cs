...
{
	public partial class WindbarbSeriesSonificationContextTracksMappingVolume  : BaseObject
	{
		Hashtable h = new Hashtable();

		public WindbarbSeriesSonificationContextTracksMappingVolume()
		{
			MapFunction = MapFunction_DefaultValue = WindbarbSeriesSonificationContextTracksMappingVolumeMapFunction.Linear;
			MapTo = MapTo_DefaultValue = "";
			Max = Max_DefaultValue = null;
			Min = Min_DefaultValue = null;
			Value = Value_DefaultValue = null;
			Within = Within_DefaultValue = WindbarbSeriesSonificationContextTracksMappingVolumeWithin.Chart;
		...
		/// </summary>
		public WindbarbSeriesSonificationContextTracksMappingVolumeMapFunction MapFunction { get; set; }
		private WindbarbSeriesSonificationContextTracksMappingVolumeMapFunction MapFunction_DefaultValue { get; set; }
		...
		/// </summary>
		public WindbarbSeriesSonificationContextTracksMappingVolumeWithin Within { get; set; }
		private WindbarbSeriesSonificationContextTracksMappingVolumeWithin Within_DefaultValue { get; set; }
