...
{
	public partial class WindbarbSeriesSonificationDefaultInstrumentOptionsActiveWhen  : BaseObject
	{
		Hashtable h = new Hashtable();

		public WindbarbSeriesSonificationDefaultInstrumentOptionsActiveWhen()
		{
