...
{
	public partial class WindbarbSeriesSonificationDefaultInstrumentOptionsMappingHighpassFrequency  : BaseObject
	{
		Hashtable h = new Hashtable();

		public WindbarbSeriesSonificationDefaultInstrumentOptionsMappingHighpassFrequency()
		{
			MapFunction = MapFunction_DefaultValue = WindbarbSeriesSonificationDefaultInstrumentOptionsMappingHighpassFrequencyMapFunction.Linear;
			MapTo = MapTo_DefaultValue = "";
			Max = Max_DefaultValue = null;
			Min = Min_DefaultValue = null;
			Value = Value_DefaultValue = null;
			Within = Within_DefaultValue = WindbarbSeriesSonificationDefaultInstrumentOptionsMappingHighpassFrequencyWithin.Chart;
		...
		/// </summary>
		public WindbarbSeriesSonificationDefaultInstrumentOptionsMappingHighpassFrequencyMapFunction MapFunction { get; set; }
		private WindbarbSeriesSonificationDefaultInstrumentOptionsMappingHighpassFrequencyMapFunction MapFunction_DefaultValue { get; set; }
		...
		/// </summary>
		public WindbarbSeriesSonificationDefaultInstrumentOptionsMappingHighpassFrequencyWithin Within { get; set; }
		private WindbarbSeriesSonificationDefaultInstrumentOptionsMappingHighpassFrequencyWithin Within_DefaultValue { get; set; }
