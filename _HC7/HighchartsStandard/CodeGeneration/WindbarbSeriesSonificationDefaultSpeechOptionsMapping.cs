...
{
	public partial class WindbarbSeriesSonificationDefaultSpeechOptionsMapping  : BaseObject
	{
		Hashtable h = new Hashtable();

		public WindbarbSeriesSonificationDefaultSpeechOptionsMapping()
		{
			Frequency = Frequency_DefaultValue = new WindbarbSeriesSonificationDefaultSpeechOptionsMappingFrequency();
			GapBetweenNotes = GapBetweenNotes_DefaultValue = new WindbarbSeriesSonificationDefaultSpeechOptionsMappingGapBetweenNotes();
			Highpass = Highpass_DefaultValue = new WindbarbSeriesSonificationDefaultSpeechOptionsMappingHighpass();
			Lowpass = Lowpass_DefaultValue = new WindbarbSeriesSonificationDefaultSpeechOptionsMappingLowpass();
			NoteDuration = NoteDuration_DefaultValue = new WindbarbSeriesSonificationDefaultSpeechOptionsMappingNoteDuration();
			Pan = Pan_DefaultValue = new WindbarbSeriesSonificationDefaultSpeechOptionsMappingPan();
			Pitch = Pitch_DefaultValue = new WindbarbSeriesSonificationDefaultSpeechOptionsMappingPitch();
			PitchString = PitchString_DefaultValue = "null";
			PitchNumber = PitchNumber_DefaultValue = null;
			PlayDelay = PlayDelay_DefaultValue = new WindbarbSeriesSonificationDefaultSpeechOptionsMappingPlayDelay();
			Time = Time_DefaultValue = new WindbarbSeriesSonificationDefaultSpeechOptionsMappingTime();
			TimeString = TimeString_DefaultValue = "null";
			TimeNumber = TimeNumber_DefaultValue = null;
			Tremolo = Tremolo_DefaultValue = new WindbarbSeriesSonificationDefaultSpeechOptionsMappingTremolo();
			Volume = Volume_DefaultValue = new WindbarbSeriesSonificationDefaultSpeechOptionsMappingVolume();
		...
		/// </summary>
		public WindbarbSeriesSonificationDefaultSpeechOptionsMappingFrequency Frequency { get; set; }
		private WindbarbSeriesSonificationDefaultSpeechOptionsMappingFrequency Frequency_DefaultValue { get; set; }
		...
		/// </summary>
		public WindbarbSeriesSonificationDefaultSpeechOptionsMappingGapBetweenNotes GapBetweenNotes { get; set; }
		private WindbarbSeriesSonificationDefaultSpeechOptionsMappingGapBetweenNotes GapBetweenNotes_DefaultValue { get; set; }
		...
		/// </summary>
		public WindbarbSeriesSonificationDefaultSpeechOptionsMappingHighpass Highpass { get; set; }
		private WindbarbSeriesSonificationDefaultSpeechOptionsMappingHighpass Highpass_DefaultValue { get; set; }
		...
		/// </summary>
		public WindbarbSeriesSonificationDefaultSpeechOptionsMappingLowpass Lowpass { get; set; }
		private WindbarbSeriesSonificationDefaultSpeechOptionsMappingLowpass Lowpass_DefaultValue { get; set; }
		...
		/// </summary>
		public WindbarbSeriesSonificationDefaultSpeechOptionsMappingNoteDuration NoteDuration { get; set; }
		private WindbarbSeriesSonificationDefaultSpeechOptionsMappingNoteDuration NoteDuration_DefaultValue { get; set; }
		...
		/// </summary>
		public WindbarbSeriesSonificationDefaultSpeechOptionsMappingPan Pan { get; set; }
		private WindbarbSeriesSonificationDefaultSpeechOptionsMappingPan Pan_DefaultValue { get; set; }
		...
		/// </summary>
		public WindbarbSeriesSonificationDefaultSpeechOptionsMappingPitch Pitch { get; set; }
		private WindbarbSeriesSonificationDefaultSpeechOptionsMappingPitch Pitch_DefaultValue { get; set; }
		...
		/// </summary>
		public WindbarbSeriesSonificationDefaultSpeechOptionsMappingPlayDelay PlayDelay { get; set; }
		private WindbarbSeriesSonificationDefaultSpeechOptionsMappingPlayDelay PlayDelay_DefaultValue { get; set; }
		...
		/// </summary>
		public WindbarbSeriesSonificationDefaultSpeechOptionsMappingTime Time { get; set; }
		private WindbarbSeriesSonificationDefaultSpeechOptionsMappingTime Time_DefaultValue { get; set; }
		...
		/// </summary>
		public WindbarbSeriesSonificationDefaultSpeechOptionsMappingTremolo Tremolo { get; set; }
		private WindbarbSeriesSonificationDefaultSpeechOptionsMappingTremolo Tremolo_DefaultValue { get; set; }
		 

		/// <summary>
		/// The volume of notes, from 0 to 1.
		/// </summary>
		public WindbarbSeriesSonificationDefaultSpeechOptionsMappingVolume Volume { get; set; }
		private WindbarbSeriesSonificationDefaultSpeechOptionsMappingVolume Volume_DefaultValue { get; set; }
