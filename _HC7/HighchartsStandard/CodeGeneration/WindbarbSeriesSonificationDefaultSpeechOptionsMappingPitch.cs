...
{
	public partial class WindbarbSeriesSonificationDefaultSpeechOptionsMappingPitch  : BaseObject
	{
		Hashtable h = new Hashtable();

		public WindbarbSeriesSonificationDefaultSpeechOptionsMappingPitch()
		{
			MapFunction = MapFunction_DefaultValue = WindbarbSeriesSonificationDefaultSpeechOptionsMappingPitchMapFunction.Linear;
		...
		/// </summary>
		public WindbarbSeriesSonificationDefaultSpeechOptionsMappingPitchMapFunction MapFunction { get; set; }
		private WindbarbSeriesSonificationDefaultSpeechOptionsMappingPitchMapFunction MapFunction_DefaultValue { get; set; }
