...
{
	public partial class WindbarbSeriesSonificationPointGrouping  : BaseObject
	{
		Hashtable h = new Hashtable();

		public WindbarbSeriesSonificationPointGrouping()
		{
		...
		/// </summary>
		public WindbarbSeriesSonificationPointGroupingAlgorithm Algorithm { get; set; }
		private WindbarbSeriesSonificationPointGroupingAlgorithm Algorithm_DefaultValue { get; set; }
		...
		internal override Hashtable ToHashtable(Highcharts highcharts)
		{
			...
			if (Algorithm != WindbarbSeriesSonificationPointGroupingAlgorithm.Null) h.Add("algorithm", highcharts.FirstCharacterToLower(Algorithm.ToString()));
