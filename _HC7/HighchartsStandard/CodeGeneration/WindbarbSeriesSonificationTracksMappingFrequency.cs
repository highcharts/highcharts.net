...
{
	public partial class WindbarbSeriesSonificationTracksMappingFrequency  : BaseObject
	{
		Hashtable h = new Hashtable();

		public WindbarbSeriesSonificationTracksMappingFrequency()
		{
			MapFunction = MapFunction_DefaultValue = WindbarbSeriesSonificationTracksMappingFrequencyMapFunction.Linear;
			MapTo = MapTo_DefaultValue = "";
			Max = Max_DefaultValue = null;
			Min = Min_DefaultValue = null;
			Value = Value_DefaultValue = null;
			Within = Within_DefaultValue = WindbarbSeriesSonificationTracksMappingFrequencyWithin.Chart;
		...
		/// </summary>
		public WindbarbSeriesSonificationTracksMappingFrequencyMapFunction MapFunction { get; set; }
		private WindbarbSeriesSonificationTracksMappingFrequencyMapFunction MapFunction_DefaultValue { get; set; }
		...
		/// </summary>
		public WindbarbSeriesSonificationTracksMappingFrequencyWithin Within { get; set; }
		private WindbarbSeriesSonificationTracksMappingFrequencyWithin Within_DefaultValue { get; set; }
