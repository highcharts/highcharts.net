...
{
	public partial class WindbarbSeriesSonificationTracksMappingHighpassResonance  : BaseObject
	{
		Hashtable h = new Hashtable();

		public WindbarbSeriesSonificationTracksMappingHighpassResonance()
		{
			MapFunction = MapFunction_DefaultValue = WindbarbSeriesSonificationTracksMappingHighpassResonanceMapFunction.Linear;
			MapTo = MapTo_DefaultValue = "";
			Max = Max_DefaultValue = null;
			Min = Min_DefaultValue = null;
			Value = Value_DefaultValue = null;
			Within = Within_DefaultValue = WindbarbSeriesSonificationTracksMappingHighpassResonanceWithin.Chart;
		...
		/// </summary>
		public WindbarbSeriesSonificationTracksMappingHighpassResonanceMapFunction MapFunction { get; set; }
		private WindbarbSeriesSonificationTracksMappingHighpassResonanceMapFunction MapFunction_DefaultValue { get; set; }
		...
		/// </summary>
		public WindbarbSeriesSonificationTracksMappingHighpassResonanceWithin Within { get; set; }
		private WindbarbSeriesSonificationTracksMappingHighpassResonanceWithin Within_DefaultValue { get; set; }
