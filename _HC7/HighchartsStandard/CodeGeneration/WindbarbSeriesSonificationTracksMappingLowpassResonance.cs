...
{
	public partial class WindbarbSeriesSonificationTracksMappingLowpassResonance  : BaseObject
	{
		Hashtable h = new Hashtable();

		public WindbarbSeriesSonificationTracksMappingLowpassResonance()
		{
			MapFunction = MapFunction_DefaultValue = WindbarbSeriesSonificationTracksMappingLowpassResonanceMapFunction.Linear;
			MapTo = MapTo_DefaultValue = "";
			Max = Max_DefaultValue = null;
			Min = Min_DefaultValue = null;
			Value = Value_DefaultValue = null;
			Within = Within_DefaultValue = WindbarbSeriesSonificationTracksMappingLowpassResonanceWithin.Chart;
		...
		/// </summary>
		public WindbarbSeriesSonificationTracksMappingLowpassResonanceMapFunction MapFunction { get; set; }
		private WindbarbSeriesSonificationTracksMappingLowpassResonanceMapFunction MapFunction_DefaultValue { get; set; }
		...
		/// </summary>
		public WindbarbSeriesSonificationTracksMappingLowpassResonanceWithin Within { get; set; }
		private WindbarbSeriesSonificationTracksMappingLowpassResonanceWithin Within_DefaultValue { get; set; }
