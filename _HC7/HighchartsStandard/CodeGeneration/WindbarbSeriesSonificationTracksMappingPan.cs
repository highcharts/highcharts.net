...
{
	public partial class WindbarbSeriesSonificationTracksMappingPan  : BaseObject
	{
		Hashtable h = new Hashtable();

		public WindbarbSeriesSonificationTracksMappingPan()
		{
			MapFunction = MapFunction_DefaultValue = WindbarbSeriesSonificationTracksMappingPanMapFunction.Linear;
			MapTo = MapTo_DefaultValue = "";
			Max = Max_DefaultValue = null;
			Min = Min_DefaultValue = null;
			Value = Value_DefaultValue = null;
			Within = Within_DefaultValue = WindbarbSeriesSonificationTracksMappingPanWithin.Chart;
		...
		/// </summary>
		public WindbarbSeriesSonificationTracksMappingPanMapFunction MapFunction { get; set; }
		private WindbarbSeriesSonificationTracksMappingPanMapFunction MapFunction_DefaultValue { get; set; }
		...
		/// </summary>
		public WindbarbSeriesSonificationTracksMappingPanWithin Within { get; set; }
		private WindbarbSeriesSonificationTracksMappingPanWithin Within_DefaultValue { get; set; }
