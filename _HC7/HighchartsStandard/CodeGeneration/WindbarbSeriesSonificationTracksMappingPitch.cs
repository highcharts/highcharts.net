...
{
	public partial class WindbarbSeriesSonificationTracksMappingPitch  : BaseObject
	{
		Hashtable h = new Hashtable();

		public WindbarbSeriesSonificationTracksMappingPitch()
		{
			MapFunction = MapFunction_DefaultValue = WindbarbSeriesSonificationTracksMappingPitchMapFunction.Linear;
		...
		/// </summary>
		public WindbarbSeriesSonificationTracksMappingPitchMapFunction MapFunction { get; set; }
		private WindbarbSeriesSonificationTracksMappingPitchMapFunction MapFunction_DefaultValue { get; set; }
