...
{
	public partial class WindbarbSeriesSonificationTracksMappingPlayDelay  : BaseObject
	{
		Hashtable h = new Hashtable();

		public WindbarbSeriesSonificationTracksMappingPlayDelay()
		{
			MapFunction = MapFunction_DefaultValue = WindbarbSeriesSonificationTracksMappingPlayDelayMapFunction.Linear;
			MapTo = MapTo_DefaultValue = "";
			Max = Max_DefaultValue = null;
			Min = Min_DefaultValue = null;
			Value = Value_DefaultValue = null;
			Within = Within_DefaultValue = WindbarbSeriesSonificationTracksMappingPlayDelayWithin.Chart;
		...
		/// </summary>
		public WindbarbSeriesSonificationTracksMappingPlayDelayMapFunction MapFunction { get; set; }
		private WindbarbSeriesSonificationTracksMappingPlayDelayMapFunction MapFunction_DefaultValue { get; set; }
		...
		/// </summary>
		public WindbarbSeriesSonificationTracksMappingPlayDelayWithin Within { get; set; }
		private WindbarbSeriesSonificationTracksMappingPlayDelayWithin Within_DefaultValue { get; set; }
