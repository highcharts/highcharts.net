...
{
	public partial class WindbarbSeriesSonificationTracksMappingTime  : BaseObject
	{
		Hashtable h = new Hashtable();

		public WindbarbSeriesSonificationTracksMappingTime()
		{
			MapFunction = MapFunction_DefaultValue = WindbarbSeriesSonificationTracksMappingTimeMapFunction.Linear;
			MapTo = MapTo_DefaultValue = "";
			Max = Max_DefaultValue = null;
			Min = Min_DefaultValue = null;
			Value = Value_DefaultValue = null;
			Within = Within_DefaultValue = WindbarbSeriesSonificationTracksMappingTimeWithin.Chart;
		...
		/// </summary>
		public WindbarbSeriesSonificationTracksMappingTimeMapFunction MapFunction { get; set; }
		private WindbarbSeriesSonificationTracksMappingTimeMapFunction MapFunction_DefaultValue { get; set; }
		...
		/// </summary>
		public WindbarbSeriesSonificationTracksMappingTimeWithin Within { get; set; }
		private WindbarbSeriesSonificationTracksMappingTimeWithin Within_DefaultValue { get; set; }
