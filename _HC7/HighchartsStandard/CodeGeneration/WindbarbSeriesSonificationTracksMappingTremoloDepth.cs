...
{
	public partial class WindbarbSeriesSonificationTracksMappingTremoloDepth  : BaseObject
	{
		Hashtable h = new Hashtable();

		public WindbarbSeriesSonificationTracksMappingTremoloDepth()
		{
			MapFunction = MapFunction_DefaultValue = WindbarbSeriesSonificationTracksMappingTremoloDepthMapFunction.Linear;
			MapTo = MapTo_DefaultValue = "";
			Max = Max_DefaultValue = null;
			Min = Min_DefaultValue = null;
			Value = Value_DefaultValue = null;
			Within = Within_DefaultValue = WindbarbSeriesSonificationTracksMappingTremoloDepthWithin.Chart;
		...
		/// </summary>
		public WindbarbSeriesSonificationTracksMappingTremoloDepthMapFunction MapFunction { get; set; }
		private WindbarbSeriesSonificationTracksMappingTremoloDepthMapFunction MapFunction_DefaultValue { get; set; }
		...
		/// </summary>
		public WindbarbSeriesSonificationTracksMappingTremoloDepthWithin Within { get; set; }
		private WindbarbSeriesSonificationTracksMappingTremoloDepthWithin Within_DefaultValue { get; set; }
