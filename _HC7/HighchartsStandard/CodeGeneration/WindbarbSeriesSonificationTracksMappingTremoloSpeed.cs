...
{
	public partial class WindbarbSeriesSonificationTracksMappingTremoloSpeed  : BaseObject
	{
		Hashtable h = new Hashtable();

		public WindbarbSeriesSonificationTracksMappingTremoloSpeed()
		{
			MapFunction = MapFunction_DefaultValue = WindbarbSeriesSonificationTracksMappingTremoloSpeedMapFunction.Linear;
			MapTo = MapTo_DefaultValue = "";
			Max = Max_DefaultValue = null;
			Min = Min_DefaultValue = null;
			Value = Value_DefaultValue = null;
			Within = Within_DefaultValue = WindbarbSeriesSonificationTracksMappingTremoloSpeedWithin.Chart;
		...
		/// </summary>
		public WindbarbSeriesSonificationTracksMappingTremoloSpeedMapFunction MapFunction { get; set; }
		private WindbarbSeriesSonificationTracksMappingTremoloSpeedMapFunction MapFunction_DefaultValue { get; set; }
		...
		/// </summary>
		public WindbarbSeriesSonificationTracksMappingTremoloSpeedWithin Within { get; set; }
		private WindbarbSeriesSonificationTracksMappingTremoloSpeedWithin Within_DefaultValue { get; set; }
