...
{
	public partial class WindbarbSeriesSonificationTracksMappingVolume  : BaseObject
	{
		Hashtable h = new Hashtable();

		public WindbarbSeriesSonificationTracksMappingVolume()
		{
			MapFunction = MapFunction_DefaultValue = WindbarbSeriesSonificationTracksMappingVolumeMapFunction.Linear;
			MapTo = MapTo_DefaultValue = "";
			Max = Max_DefaultValue = null;
			Min = Min_DefaultValue = null;
			Value = Value_DefaultValue = null;
			Within = Within_DefaultValue = WindbarbSeriesSonificationTracksMappingVolumeWithin.Chart;
		...
		/// </summary>
		public WindbarbSeriesSonificationTracksMappingVolumeMapFunction MapFunction { get; set; }
		private WindbarbSeriesSonificationTracksMappingVolumeMapFunction MapFunction_DefaultValue { get; set; }
		...
		/// </summary>
		public WindbarbSeriesSonificationTracksMappingVolumeWithin Within { get; set; }
		private WindbarbSeriesSonificationTracksMappingVolumeWithin Within_DefaultValue { get; set; }
