...
{
	public partial class WindbarbSeriesStatesSelect  : BaseObject
	{
		Hashtable h = new Hashtable();

		public WindbarbSeriesStatesSelect()
		{
			Animation = Animation_DefaultValue = new Animation();
			Enabled = Enabled_DefaultValue = null;
			Halo = Halo_DefaultValue = new WindbarbSeriesStatesSelectHalo();
			LineWidth = LineWidth_DefaultValue = null;
			LineWidthPlus = LineWidthPlus_DefaultValue = null;
			Marker = Marker_DefaultValue = new WindbarbSeriesStatesSelectMarker();
		...
		/// </summary>
		public WindbarbSeriesStatesSelectHalo Halo { get; set; }
		private WindbarbSeriesStatesSelectHalo Halo_DefaultValue { get; set; }
		...
		/// </summary>
		public WindbarbSeriesStatesSelectMarker Marker { get; set; }
		private WindbarbSeriesStatesSelectMarker Marker_DefaultValue { get; set; }
