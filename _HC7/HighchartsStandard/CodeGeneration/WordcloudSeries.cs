...
namespace Highsoft.Web.Mvc.Charts
{
	public partial class WordcloudSeries  : Series
	{
		...
		public WordcloudSeries()
		{
			...
			Dumbell = Dumbell_DefaultValue = new WordcloudSeriesDumbell();
			...
			LegendSymbol = LegendSymbol_DefaultValue = WordcloudSeriesLegendSymbol.Rectangle;
			LinkedTo = LinkedTo_DefaultValue = "";
			MaxFontSize = MaxFontSize_DefaultValue = 25;
			MinFontSize = MinFontSize_DefaultValue = 1;
			Name = Name_DefaultValue = "";
			OnPoint = OnPoint_DefaultValue = new WordcloudSeriesOnPoint();
			Opacity = Opacity_DefaultValue = 1;
			PlacementStrategy = PlacementStrategy_DefaultValue = WordcloudSeriesPlacementStrategy.Center;
			...
			Sonification = Sonification_DefaultValue = new WordcloudSeriesSonification();
			Spiral = Spiral_DefaultValue = WordcloudSeriesSpiral.Rectangular;
		...
		/// 
		/// </summary>
		public WordcloudSeriesDumbell Dumbell { get; set; }
		private WordcloudSeriesDumbell Dumbell_DefaultValue { get; set; }
