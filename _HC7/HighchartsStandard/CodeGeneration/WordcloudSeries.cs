...
namespace Highsoft.Web.Mvc.Charts
{
	public partial class WordcloudSeries  : Series
	{
		...
		/// </summary>
		public WordcloudSeriesLegendSymbol LegendSymbol { get; set; }
		private WordcloudSeriesLegendSymbol LegendSymbol_DefaultValue { get; set; }
		...
		/// </summary>
		public WordcloudSeriesOnPoint OnPoint { get; set; }
		private WordcloudSeriesOnPoint OnPoint_DefaultValue { get; set; }
		...
		/// </summary>
		public WordcloudSeriesSonification Sonification { get; set; }
		private WordcloudSeriesSonification Sonification_DefaultValue { get; set; }
		...
		internal override Hashtable ToHashtable(Highcharts highcharts)
		{
			...
			if (Cursor != WordcloudSeriesCursor.Null) h.Add("cursor", highcharts.FirstCharacterToLower(Cursor.ToString()));
			if (Custom != null) h.Add("custom",Custom);
			if (DashStyle != WordcloudSeriesDashStyle.Null) h.Add("dashStyle", highcharts.FirstCharacterToLower(DashStyle.ToString()));
			...
			if (LegendSymbol != WordcloudSeriesLegendSymbol.Null) h.Add("legendSymbol", highcharts.FirstCharacterToLower(LegendSymbol.ToString()));
			...
			if (PlacementStrategy != WordcloudSeriesPlacementStrategy.Null) h.Add("placementStrategy", highcharts.FirstCharacterToLower(PlacementStrategy.ToString()));
			...
			if (Spiral != WordcloudSeriesSpiral.Null) h.Add("spiral", highcharts.FirstCharacterToLower(Spiral.ToString()));
