...
namespace Highsoft.Web.Mvc.Charts
{
	public partial class WordcloudSeriesDataDataLabels  : BaseObject
	{
		...
		/// </summary>
		public WordcloudSeriesDataDataLabelsPosition Position { get; set; }
		private WordcloudSeriesDataDataLabelsPosition Position_DefaultValue { get; set; }
		...
		/// </summary>
		public WordcloudSeriesDataDataLabelsTextPath TextPath { get; set; }
		private WordcloudSeriesDataDataLabelsTextPath TextPath_DefaultValue { get; set; }
		...
		internal override Hashtable ToHashtable(Highcharts highcharts)
		{
			...
			if (Align != WordcloudSeriesDataDataLabelsAlign.Null) h.Add("align", highcharts.FirstCharacterToLower(Align.ToString()));
			...
			if (Overflow != WordcloudSeriesDataDataLabelsOverflow.Null) h.Add("overflow", highcharts.FirstCharacterToLower(Overflow.ToString()));
			if (Padding != null) h.Add("padding",Padding);
			if (Position != WordcloudSeriesDataDataLabelsPosition.Null) h.Add("position", highcharts.FirstCharacterToLower(Position.ToString()));
			...
			if (VerticalAlign != WordcloudSeriesDataDataLabelsVerticalAlign.Null) h.Add("verticalAlign", highcharts.FirstCharacterToLower(VerticalAlign.ToString()));
			if (X != null) h.Add("x",X);
			if (Y != null) h.Add("y",Y);
