...
namespace Highsoft.Web.Mvc.Charts
{
	public partial class WordcloudSeriesDataLabels  : BaseObject
	{
		...
		{
			Align = Align_DefaultValue = WordcloudSeriesDataLabelsAlign.Left;
			...
			VerticalAlign = VerticalAlign_DefaultValue = WordcloudSeriesDataLabelsVerticalAlign.Top;
		...
		internal override Hashtable ToHashtable()
		{
			...
			if (Formatter != Formatter_DefaultValue) { h.Add("formatter",Formatter); Highcharts.AddFunction("4b80f12d-34da-49a6-8ab0-018b59fed614.formatter", Formatter); }  
