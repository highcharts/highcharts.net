...
{
	public partial class WordcloudSeriesSonificationContextTracks  : BaseObject
	{
		Hashtable h = new Hashtable();

		public WordcloudSeriesSonificationContextTracks()
		{
			ActiveWhen = ActiveWhen_DefaultValue = new WordcloudSeriesSonificationContextTracksActiveWhen();
			Instrument = Instrument_DefaultValue = null;
			InstrumentString = InstrumentString_DefaultValue = "null";
			Mapping = Mapping_DefaultValue = new WordcloudSeriesSonificationContextTracksMapping();
			MidiName = MidiName_DefaultValue = "";
			PointGrouping = PointGrouping_DefaultValue = new WordcloudSeriesSonificationContextTracksPointGrouping();
			...
			Type = Type_DefaultValue = WordcloudSeriesSonificationContextTracksType.Instrument;
			ValueInterval = ValueInterval_DefaultValue = null;
			ValueMapFunction = ValueMapFunction_DefaultValue = WordcloudSeriesSonificationContextTracksValueMapFunction.Linear;
		...
		/// </summary>
		public WordcloudSeriesSonificationContextTracksActiveWhen ActiveWhen { get; set; }
		private WordcloudSeriesSonificationContextTracksActiveWhen ActiveWhen_DefaultValue { get; set; }
		...
		/// </summary>
		public WordcloudSeriesSonificationContextTracksMapping Mapping { get; set; }
		private WordcloudSeriesSonificationContextTracksMapping Mapping_DefaultValue { get; set; }
		...
		/// </summary>
		public WordcloudSeriesSonificationContextTracksPointGrouping PointGrouping { get; set; }
		private WordcloudSeriesSonificationContextTracksPointGrouping PointGrouping_DefaultValue { get; set; }
		...
		/// </summary>
		public WordcloudSeriesSonificationContextTracksType Type { get; set; }
		private WordcloudSeriesSonificationContextTracksType Type_DefaultValue { get; set; }
		...
		/// </summary>
		public WordcloudSeriesSonificationContextTracksValueMapFunction ValueMapFunction { get; set; }
		private WordcloudSeriesSonificationContextTracksValueMapFunction ValueMapFunction_DefaultValue { get; set; }
