...
{
	public partial class WordcloudSeriesSonificationContextTracksMapping  : BaseObject
	{
		Hashtable h = new Hashtable();

		public WordcloudSeriesSonificationContextTracksMapping()
		{
			Frequency = Frequency_DefaultValue = new WordcloudSeriesSonificationContextTracksMappingFrequency();
			GapBetweenNotes = GapBetweenNotes_DefaultValue = new WordcloudSeriesSonificationContextTracksMappingGapBetweenNotes();
			Highpass = Highpass_DefaultValue = new WordcloudSeriesSonificationContextTracksMappingHighpass();
			Lowpass = Lowpass_DefaultValue = new WordcloudSeriesSonificationContextTracksMappingLowpass();
			NoteDuration = NoteDuration_DefaultValue = new WordcloudSeriesSonificationContextTracksMappingNoteDuration();
			Pan = Pan_DefaultValue = new WordcloudSeriesSonificationContextTracksMappingPan();
			Pitch = Pitch_DefaultValue = new WordcloudSeriesSonificationContextTracksMappingPitch();
			PitchString = PitchString_DefaultValue = "null";
			PitchNumber = PitchNumber_DefaultValue = null;
			PlayDelay = PlayDelay_DefaultValue = new WordcloudSeriesSonificationContextTracksMappingPlayDelay();
			Time = Time_DefaultValue = new WordcloudSeriesSonificationContextTracksMappingTime();
			TimeString = TimeString_DefaultValue = "null";
			TimeNumber = TimeNumber_DefaultValue = null;
			Tremolo = Tremolo_DefaultValue = new WordcloudSeriesSonificationContextTracksMappingTremolo();
			Volume = Volume_DefaultValue = new WordcloudSeriesSonificationContextTracksMappingVolume();
		...
		/// </summary>
		public WordcloudSeriesSonificationContextTracksMappingFrequency Frequency { get; set; }
		private WordcloudSeriesSonificationContextTracksMappingFrequency Frequency_DefaultValue { get; set; }
		...
		/// </summary>
		public WordcloudSeriesSonificationContextTracksMappingGapBetweenNotes GapBetweenNotes { get; set; }
		private WordcloudSeriesSonificationContextTracksMappingGapBetweenNotes GapBetweenNotes_DefaultValue { get; set; }
		...
		/// </summary>
		public WordcloudSeriesSonificationContextTracksMappingHighpass Highpass { get; set; }
		private WordcloudSeriesSonificationContextTracksMappingHighpass Highpass_DefaultValue { get; set; }
		...
		/// </summary>
		public WordcloudSeriesSonificationContextTracksMappingLowpass Lowpass { get; set; }
		private WordcloudSeriesSonificationContextTracksMappingLowpass Lowpass_DefaultValue { get; set; }
		...
		/// </summary>
		public WordcloudSeriesSonificationContextTracksMappingNoteDuration NoteDuration { get; set; }
		private WordcloudSeriesSonificationContextTracksMappingNoteDuration NoteDuration_DefaultValue { get; set; }
		...
		/// </summary>
		public WordcloudSeriesSonificationContextTracksMappingPan Pan { get; set; }
		private WordcloudSeriesSonificationContextTracksMappingPan Pan_DefaultValue { get; set; }
		...
		/// </summary>
		public WordcloudSeriesSonificationContextTracksMappingPitch Pitch { get; set; }
		private WordcloudSeriesSonificationContextTracksMappingPitch Pitch_DefaultValue { get; set; }
		...
		/// </summary>
		public WordcloudSeriesSonificationContextTracksMappingPlayDelay PlayDelay { get; set; }
		private WordcloudSeriesSonificationContextTracksMappingPlayDelay PlayDelay_DefaultValue { get; set; }
		...
		/// </summary>
		public WordcloudSeriesSonificationContextTracksMappingTime Time { get; set; }
		private WordcloudSeriesSonificationContextTracksMappingTime Time_DefaultValue { get; set; }
		...
		/// </summary>
		public WordcloudSeriesSonificationContextTracksMappingTremolo Tremolo { get; set; }
		private WordcloudSeriesSonificationContextTracksMappingTremolo Tremolo_DefaultValue { get; set; }
		 

		/// <summary>
		/// The volume of notes, from 0 to 1.
		/// </summary>
		public WordcloudSeriesSonificationContextTracksMappingVolume Volume { get; set; }
		private WordcloudSeriesSonificationContextTracksMappingVolume Volume_DefaultValue { get; set; }
