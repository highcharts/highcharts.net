...
{
	public partial class WordcloudSeriesSonificationContextTracksMappingFrequency  : BaseObject
	{
		Hashtable h = new Hashtable();

		public WordcloudSeriesSonificationContextTracksMappingFrequency()
		{
			MapFunction = MapFunction_DefaultValue = WordcloudSeriesSonificationContextTracksMappingFrequencyMapFunction.Linear;
			MapTo = MapTo_DefaultValue = "";
			Max = Max_DefaultValue = null;
			Min = Min_DefaultValue = null;
			Value = Value_DefaultValue = null;
			Within = Within_DefaultValue = WordcloudSeriesSonificationContextTracksMappingFrequencyWithin.Chart;
		...
		/// </summary>
		public WordcloudSeriesSonificationContextTracksMappingFrequencyMapFunction MapFunction { get; set; }
		private WordcloudSeriesSonificationContextTracksMappingFrequencyMapFunction MapFunction_DefaultValue { get; set; }
		...
		/// </summary>
		public WordcloudSeriesSonificationContextTracksMappingFrequencyWithin Within { get; set; }
		private WordcloudSeriesSonificationContextTracksMappingFrequencyWithin Within_DefaultValue { get; set; }
