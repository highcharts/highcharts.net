...
{
	public partial class WordcloudSeriesSonificationContextTracksMappingPitch  : BaseObject
	{
		Hashtable h = new Hashtable();

		public WordcloudSeriesSonificationContextTracksMappingPitch()
		{
			MapFunction = MapFunction_DefaultValue = WordcloudSeriesSonificationContextTracksMappingPitchMapFunction.Linear;
		...
		/// </summary>
		public WordcloudSeriesSonificationContextTracksMappingPitchMapFunction MapFunction { get; set; }
		private WordcloudSeriesSonificationContextTracksMappingPitchMapFunction MapFunction_DefaultValue { get; set; }
