...
{
	public partial class WordcloudSeriesSonificationContextTracksMappingTime  : BaseObject
	{
		Hashtable h = new Hashtable();

		public WordcloudSeriesSonificationContextTracksMappingTime()
		{
			MapFunction = MapFunction_DefaultValue = WordcloudSeriesSonificationContextTracksMappingTimeMapFunction.Linear;
			MapTo = MapTo_DefaultValue = "";
			Max = Max_DefaultValue = null;
			Min = Min_DefaultValue = null;
			Value = Value_DefaultValue = null;
			Within = Within_DefaultValue = WordcloudSeriesSonificationContextTracksMappingTimeWithin.Chart;
		...
		/// </summary>
		public WordcloudSeriesSonificationContextTracksMappingTimeMapFunction MapFunction { get; set; }
		private WordcloudSeriesSonificationContextTracksMappingTimeMapFunction MapFunction_DefaultValue { get; set; }
		...
		/// </summary>
		public WordcloudSeriesSonificationContextTracksMappingTimeWithin Within { get; set; }
		private WordcloudSeriesSonificationContextTracksMappingTimeWithin Within_DefaultValue { get; set; }
