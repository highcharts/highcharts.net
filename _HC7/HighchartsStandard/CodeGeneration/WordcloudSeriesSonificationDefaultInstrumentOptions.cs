...
{
	public partial class WordcloudSeriesSonificationDefaultInstrumentOptions  : BaseObject
	{
		Hashtable h = new Hashtable();

		public WordcloudSeriesSonificationDefaultInstrumentOptions()
		{
			ActiveWhen = ActiveWhen_DefaultValue = new WordcloudSeriesSonificationDefaultInstrumentOptionsActiveWhen();
			Instrument = Instrument_DefaultValue = null;
			InstrumentString = InstrumentString_DefaultValue = "null";
			Mapping = Mapping_DefaultValue = new WordcloudSeriesSonificationDefaultInstrumentOptionsMapping();
			MidiName = MidiName_DefaultValue = "";
			PointGrouping = PointGrouping_DefaultValue = new WordcloudSeriesSonificationDefaultInstrumentOptionsPointGrouping();
			RoundToMusicalNotes = RoundToMusicalNotes_DefaultValue = true;
			ShowPlayMarker = ShowPlayMarker_DefaultValue = true;
			Type = Type_DefaultValue = WordcloudSeriesSonificationDefaultInstrumentOptionsType.Instrument;
		...
		/// </summary>
		public WordcloudSeriesSonificationDefaultInstrumentOptionsActiveWhen ActiveWhen { get; set; }
		private WordcloudSeriesSonificationDefaultInstrumentOptionsActiveWhen ActiveWhen_DefaultValue { get; set; }
		...
		/// </summary>
		public WordcloudSeriesSonificationDefaultInstrumentOptionsMapping Mapping { get; set; }
		private WordcloudSeriesSonificationDefaultInstrumentOptionsMapping Mapping_DefaultValue { get; set; }
		...
		/// </summary>
		public WordcloudSeriesSonificationDefaultInstrumentOptionsPointGrouping PointGrouping { get; set; }
		private WordcloudSeriesSonificationDefaultInstrumentOptionsPointGrouping PointGrouping_DefaultValue { get; set; }
		...
		/// </summary>
		public WordcloudSeriesSonificationDefaultInstrumentOptionsType Type { get; set; }
		private WordcloudSeriesSonificationDefaultInstrumentOptionsType Type_DefaultValue { get; set; }
