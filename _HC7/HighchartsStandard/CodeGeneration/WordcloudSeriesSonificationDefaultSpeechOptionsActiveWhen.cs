...
{
	public partial class WordcloudSeriesSonificationDefaultSpeechOptionsActiveWhen  : BaseObject
	{
		Hashtable h = new Hashtable();

		public WordcloudSeriesSonificationDefaultSpeechOptionsActiveWhen()
		{
