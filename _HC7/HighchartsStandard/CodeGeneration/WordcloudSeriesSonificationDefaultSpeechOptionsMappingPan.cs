...
{
	public partial class WordcloudSeriesSonificationDefaultSpeechOptionsMappingPan  : BaseObject
	{
		Hashtable h = new Hashtable();

		public WordcloudSeriesSonificationDefaultSpeechOptionsMappingPan()
		{
			MapFunction = MapFunction_DefaultValue = WordcloudSeriesSonificationDefaultSpeechOptionsMappingPanMapFunction.Linear;
			MapTo = MapTo_DefaultValue = "";
			Max = Max_DefaultValue = null;
			Min = Min_DefaultValue = null;
			Value = Value_DefaultValue = null;
			Within = Within_DefaultValue = WordcloudSeriesSonificationDefaultSpeechOptionsMappingPanWithin.Chart;
		...
		/// </summary>
		public WordcloudSeriesSonificationDefaultSpeechOptionsMappingPanMapFunction MapFunction { get; set; }
		private WordcloudSeriesSonificationDefaultSpeechOptionsMappingPanMapFunction MapFunction_DefaultValue { get; set; }
		...
		/// </summary>
		public WordcloudSeriesSonificationDefaultSpeechOptionsMappingPanWithin Within { get; set; }
		private WordcloudSeriesSonificationDefaultSpeechOptionsMappingPanWithin Within_DefaultValue { get; set; }
