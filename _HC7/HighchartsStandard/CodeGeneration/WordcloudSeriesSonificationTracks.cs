...
{
	public partial class WordcloudSeriesSonificationTracks  : BaseObject
	{
		Hashtable h = new Hashtable();

		public WordcloudSeriesSonificationTracks()
		{
			ActiveWhen = ActiveWhen_DefaultValue = new WordcloudSeriesSonificationTracksActiveWhen();
			Instrument = Instrument_DefaultValue = null;
			InstrumentString = InstrumentString_DefaultValue = "null";
			Mapping = Mapping_DefaultValue = new WordcloudSeriesSonificationTracksMapping();
			MidiName = MidiName_DefaultValue = "";
			PointGrouping = PointGrouping_DefaultValue = new WordcloudSeriesSonificationTracksPointGrouping();
			RoundToMusicalNotes = RoundToMusicalNotes_DefaultValue = true;
			ShowPlayMarker = ShowPlayMarker_DefaultValue = true;
			Type = Type_DefaultValue = WordcloudSeriesSonificationTracksType.Instrument;
		...
		/// </summary>
		public WordcloudSeriesSonificationTracksActiveWhen ActiveWhen { get; set; }
		private WordcloudSeriesSonificationTracksActiveWhen ActiveWhen_DefaultValue { get; set; }
		...
		/// </summary>
		public WordcloudSeriesSonificationTracksMapping Mapping { get; set; }
		private WordcloudSeriesSonificationTracksMapping Mapping_DefaultValue { get; set; }
		...
		/// </summary>
		public WordcloudSeriesSonificationTracksPointGrouping PointGrouping { get; set; }
		private WordcloudSeriesSonificationTracksPointGrouping PointGrouping_DefaultValue { get; set; }
		...
		/// </summary>
		public WordcloudSeriesSonificationTracksType Type { get; set; }
		private WordcloudSeriesSonificationTracksType Type_DefaultValue { get; set; }
