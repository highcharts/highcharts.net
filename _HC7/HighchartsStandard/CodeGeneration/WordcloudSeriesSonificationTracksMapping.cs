...
{
	public partial class WordcloudSeriesSonificationTracksMapping  : BaseObject
	{
		Hashtable h = new Hashtable();

		public WordcloudSeriesSonificationTracksMapping()
		{
			Frequency = Frequency_DefaultValue = new WordcloudSeriesSonificationTracksMappingFrequency();
			GapBetweenNotes = GapBetweenNotes_DefaultValue = new WordcloudSeriesSonificationTracksMappingGapBetweenNotes();
			Highpass = Highpass_DefaultValue = new WordcloudSeriesSonificationTracksMappingHighpass();
			Lowpass = Lowpass_DefaultValue = new WordcloudSeriesSonificationTracksMappingLowpass();
			NoteDuration = NoteDuration_DefaultValue = new WordcloudSeriesSonificationTracksMappingNoteDuration();
			Pan = Pan_DefaultValue = new WordcloudSeriesSonificationTracksMappingPan();
			Pitch = Pitch_DefaultValue = new WordcloudSeriesSonificationTracksMappingPitch();
			PitchString = PitchString_DefaultValue = "null";
			PitchNumber = PitchNumber_DefaultValue = null;
			PlayDelay = PlayDelay_DefaultValue = new WordcloudSeriesSonificationTracksMappingPlayDelay();
			Time = Time_DefaultValue = new WordcloudSeriesSonificationTracksMappingTime();
			TimeString = TimeString_DefaultValue = "null";
			TimeNumber = TimeNumber_DefaultValue = null;
			Tremolo = Tremolo_DefaultValue = new WordcloudSeriesSonificationTracksMappingTremolo();
			Volume = Volume_DefaultValue = new WordcloudSeriesSonificationTracksMappingVolume();
		...
		/// </summary>
		public WordcloudSeriesSonificationTracksMappingFrequency Frequency { get; set; }
		private WordcloudSeriesSonificationTracksMappingFrequency Frequency_DefaultValue { get; set; }
		...
		/// </summary>
		public WordcloudSeriesSonificationTracksMappingGapBetweenNotes GapBetweenNotes { get; set; }
		private WordcloudSeriesSonificationTracksMappingGapBetweenNotes GapBetweenNotes_DefaultValue { get; set; }
		...
		/// </summary>
		public WordcloudSeriesSonificationTracksMappingHighpass Highpass { get; set; }
		private WordcloudSeriesSonificationTracksMappingHighpass Highpass_DefaultValue { get; set; }
		...
		/// </summary>
		public WordcloudSeriesSonificationTracksMappingLowpass Lowpass { get; set; }
		private WordcloudSeriesSonificationTracksMappingLowpass Lowpass_DefaultValue { get; set; }
		...
		/// </summary>
		public WordcloudSeriesSonificationTracksMappingNoteDuration NoteDuration { get; set; }
		private WordcloudSeriesSonificationTracksMappingNoteDuration NoteDuration_DefaultValue { get; set; }
		...
		/// </summary>
		public WordcloudSeriesSonificationTracksMappingPan Pan { get; set; }
		private WordcloudSeriesSonificationTracksMappingPan Pan_DefaultValue { get; set; }
		...
		/// </summary>
		public WordcloudSeriesSonificationTracksMappingPitch Pitch { get; set; }
		private WordcloudSeriesSonificationTracksMappingPitch Pitch_DefaultValue { get; set; }
		...
		/// </summary>
		public WordcloudSeriesSonificationTracksMappingPlayDelay PlayDelay { get; set; }
		private WordcloudSeriesSonificationTracksMappingPlayDelay PlayDelay_DefaultValue { get; set; }
		...
		/// </summary>
		public WordcloudSeriesSonificationTracksMappingTime Time { get; set; }
		private WordcloudSeriesSonificationTracksMappingTime Time_DefaultValue { get; set; }
		...
		/// </summary>
		public WordcloudSeriesSonificationTracksMappingTremolo Tremolo { get; set; }
		private WordcloudSeriesSonificationTracksMappingTremolo Tremolo_DefaultValue { get; set; }
		 

		/// <summary>
		/// The volume of notes, from 0 to 1.
		/// </summary>
		public WordcloudSeriesSonificationTracksMappingVolume Volume { get; set; }
		private WordcloudSeriesSonificationTracksMappingVolume Volume_DefaultValue { get; set; }
