...
{
	public partial class WordcloudSeriesSonificationTracksMappingFrequency  : BaseObject
	{
		Hashtable h = new Hashtable();

		public WordcloudSeriesSonificationTracksMappingFrequency()
		{
			MapFunction = MapFunction_DefaultValue = WordcloudSeriesSonificationTracksMappingFrequencyMapFunction.Linear;
			MapTo = MapTo_DefaultValue = "";
			Max = Max_DefaultValue = null;
			Min = Min_DefaultValue = null;
			Value = Value_DefaultValue = null;
			Within = Within_DefaultValue = WordcloudSeriesSonificationTracksMappingFrequencyWithin.Chart;
		...
		/// </summary>
		public WordcloudSeriesSonificationTracksMappingFrequencyMapFunction MapFunction { get; set; }
		private WordcloudSeriesSonificationTracksMappingFrequencyMapFunction MapFunction_DefaultValue { get; set; }
		...
		/// </summary>
		public WordcloudSeriesSonificationTracksMappingFrequencyWithin Within { get; set; }
		private WordcloudSeriesSonificationTracksMappingFrequencyWithin Within_DefaultValue { get; set; }
