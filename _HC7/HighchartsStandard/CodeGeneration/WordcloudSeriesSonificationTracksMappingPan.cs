...
{
	public partial class WordcloudSeriesSonificationTracksMappingPan  : BaseObject
	{
		Hashtable h = new Hashtable();

		public WordcloudSeriesSonificationTracksMappingPan()
		{
			MapFunction = MapFunction_DefaultValue = WordcloudSeriesSonificationTracksMappingPanMapFunction.Linear;
			MapTo = MapTo_DefaultValue = "";
			Max = Max_DefaultValue = null;
			Min = Min_DefaultValue = null;
			Value = Value_DefaultValue = null;
			Within = Within_DefaultValue = WordcloudSeriesSonificationTracksMappingPanWithin.Chart;
		...
		/// </summary>
		public WordcloudSeriesSonificationTracksMappingPanMapFunction MapFunction { get; set; }
		private WordcloudSeriesSonificationTracksMappingPanMapFunction MapFunction_DefaultValue { get; set; }
		...
		/// </summary>
		public WordcloudSeriesSonificationTracksMappingPanWithin Within { get; set; }
		private WordcloudSeriesSonificationTracksMappingPanWithin Within_DefaultValue { get; set; }
