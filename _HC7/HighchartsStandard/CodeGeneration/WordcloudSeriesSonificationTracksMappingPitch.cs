...
{
	public partial class WordcloudSeriesSonificationTracksMappingPitch  : BaseObject
	{
		Hashtable h = new Hashtable();

		public WordcloudSeriesSonificationTracksMappingPitch()
		{
			MapFunction = MapFunction_DefaultValue = WordcloudSeriesSonificationTracksMappingPitchMapFunction.Linear;
		...
		/// </summary>
		public WordcloudSeriesSonificationTracksMappingPitchMapFunction MapFunction { get; set; }
		private WordcloudSeriesSonificationTracksMappingPitchMapFunction MapFunction_DefaultValue { get; set; }
