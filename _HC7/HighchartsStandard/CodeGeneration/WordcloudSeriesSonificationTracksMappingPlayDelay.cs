...
{
	public partial class WordcloudSeriesSonificationTracksMappingPlayDelay  : BaseObject
	{
		Hashtable h = new Hashtable();

		public WordcloudSeriesSonificationTracksMappingPlayDelay()
		{
			MapFunction = MapFunction_DefaultValue = WordcloudSeriesSonificationTracksMappingPlayDelayMapFunction.Linear;
			MapTo = MapTo_DefaultValue = "";
			Max = Max_DefaultValue = null;
			Min = Min_DefaultValue = null;
			Value = Value_DefaultValue = null;
			Within = Within_DefaultValue = WordcloudSeriesSonificationTracksMappingPlayDelayWithin.Chart;
		...
		/// </summary>
		public WordcloudSeriesSonificationTracksMappingPlayDelayMapFunction MapFunction { get; set; }
		private WordcloudSeriesSonificationTracksMappingPlayDelayMapFunction MapFunction_DefaultValue { get; set; }
		...
		/// </summary>
		public WordcloudSeriesSonificationTracksMappingPlayDelayWithin Within { get; set; }
		private WordcloudSeriesSonificationTracksMappingPlayDelayWithin Within_DefaultValue { get; set; }
