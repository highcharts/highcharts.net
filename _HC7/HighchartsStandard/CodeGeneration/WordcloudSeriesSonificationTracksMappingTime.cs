...
{
	public partial class WordcloudSeriesSonificationTracksMappingTime  : BaseObject
	{
		Hashtable h = new Hashtable();

		public WordcloudSeriesSonificationTracksMappingTime()
		{
			MapFunction = MapFunction_DefaultValue = WordcloudSeriesSonificationTracksMappingTimeMapFunction.Linear;
			MapTo = MapTo_DefaultValue = "";
			Max = Max_DefaultValue = null;
			Min = Min_DefaultValue = null;
			Value = Value_DefaultValue = null;
			Within = Within_DefaultValue = WordcloudSeriesSonificationTracksMappingTimeWithin.Chart;
		...
		/// </summary>
		public WordcloudSeriesSonificationTracksMappingTimeMapFunction MapFunction { get; set; }
		private WordcloudSeriesSonificationTracksMappingTimeMapFunction MapFunction_DefaultValue { get; set; }
		...
		/// </summary>
		public WordcloudSeriesSonificationTracksMappingTimeWithin Within { get; set; }
		private WordcloudSeriesSonificationTracksMappingTimeWithin Within_DefaultValue { get; set; }
