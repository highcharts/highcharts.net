...
{
	public partial class WordcloudSeriesSonificationTracksMappingVolume  : BaseObject
	{
		Hashtable h = new Hashtable();

		public WordcloudSeriesSonificationTracksMappingVolume()
		{
			MapFunction = MapFunction_DefaultValue = WordcloudSeriesSonificationTracksMappingVolumeMapFunction.Linear;
			MapTo = MapTo_DefaultValue = "";
			Max = Max_DefaultValue = null;
			Min = Min_DefaultValue = null;
			Value = Value_DefaultValue = null;
			Within = Within_DefaultValue = WordcloudSeriesSonificationTracksMappingVolumeWithin.Chart;
		...
		/// </summary>
		public WordcloudSeriesSonificationTracksMappingVolumeMapFunction MapFunction { get; set; }
		private WordcloudSeriesSonificationTracksMappingVolumeMapFunction MapFunction_DefaultValue { get; set; }
		...
		/// </summary>
		public WordcloudSeriesSonificationTracksMappingVolumeWithin Within { get; set; }
		private WordcloudSeriesSonificationTracksMappingVolumeWithin Within_DefaultValue { get; set; }
