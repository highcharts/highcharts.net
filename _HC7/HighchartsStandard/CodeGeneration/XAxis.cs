...
namespace Highsoft.Web.Mvc.Charts
{
	public partial class XAxis  : BaseObject
	{
		...
		/// </summary>
		public XAxisAccessibility Accessibility { get; set; }
		private XAxisAccessibility Accessibility_DefaultValue { get; set; }
		...
		/// </summary>
		public List<XAxisBreaks> Breaks { get; set; }
		private List<XAxisBreaks> Breaks_DefaultValue { get; set; }
		...
		/// </summary>
		public XAxisGridLineInterpolation GridLineInterpolation { get; set; }
		private XAxisGridLineInterpolation GridLineInterpolation_DefaultValue { get; set; }
		...
		internal override Hashtable ToHashtable(Highcharts highcharts)
		{
			...
			if (GridLineInterpolation != XAxisGridLineInterpolation.Null) h.Add("gridLineInterpolation", highcharts.FirstCharacterToLower(GridLineInterpolation.ToString()));
			...
			if (MinorTickPosition != XAxisMinorTickPosition.Null) h.Add("minorTickPosition", highcharts.FirstCharacterToLower(MinorTickPosition.ToString()));
			...
			if (TickmarkPlacement != XAxisTickmarkPlacement.Null) h.Add("tickmarkPlacement", highcharts.FirstCharacterToLower(TickmarkPlacement.ToString()));
			if (TickPixelInterval != null) h.Add("tickPixelInterval",TickPixelInterval);
			if (TickPosition != XAxisTickPosition.Null) h.Add("tickPosition", highcharts.FirstCharacterToLower(TickPosition.ToString()));
