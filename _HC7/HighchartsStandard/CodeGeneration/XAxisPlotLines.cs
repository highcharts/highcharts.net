...
namespace Highsoft.Web.Mvc.Charts
{
	public partial class XAxisPlotLines  : BaseObject
	{
		...
		/// 
		/// </summary>
		public XAxisPlotLinesLabels Labels { get; set; }
		private XAxisPlotLinesLabels Labels_DefaultValue { get; set; }
		...
		internal override Hashtable ToHashtable(Highcharts highcharts)
		{
			...
			if (DashStyle != XAxisPlotLinesDashStyle.Null) h.Add("dashStyle", highcharts.FirstCharacterToLower(DashStyle.ToString()));
