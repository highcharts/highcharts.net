...
namespace Highsoft.Web.Mvc.Charts
{
	public partial class XAxisTitle  : BaseObject
	{
		...
		internal override Hashtable ToHashtable(Highcharts highcharts)
		{
			...
			if (Align != XAxisTitleAlign.Null) h.Add("align", highcharts.FirstCharacterToLower(Align.ToString()));
			if (Enabled != null) h.Add("enabled",Enabled);
			if (Margin != null) h.Add("margin",Margin);
			if (Offset != null) h.Add("offset",Offset);
			if (Position3d != XAxisTitlePosition3d.Null) h.Add("position3d", highcharts.FirstCharacterToLower(Position3d.ToString()));
			...
			if (TextAlign != XAxisTitleTextAlign.Null) h.Add("textAlign", highcharts.FirstCharacterToLower(TextAlign.ToString()));
