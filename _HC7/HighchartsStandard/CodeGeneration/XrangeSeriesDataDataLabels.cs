...
{
	public partial class XrangeSeriesDataDataLabels  : BaseObject
	{
		Hashtable h = new Hashtable();

		public XrangeSeriesDataDataLabels()
		{
		...
		/// </summary>
		public XrangeSeriesDataDataLabelsAlign Align { get; set; }
		private XrangeSeriesDataDataLabelsAlign Align_DefaultValue { get; set; }
		...
		/// </summary>
		public XrangeSeriesDataDataLabelsFilter Filter { get; set; }
		private XrangeSeriesDataDataLabelsFilter Filter_DefaultValue { get; set; }
		...
		/// </summary>
		public XrangeSeriesDataDataLabelsOverflow Overflow { get; set; }
		private XrangeSeriesDataDataLabelsOverflow Overflow_DefaultValue { get; set; }
		...
		/// </summary>
		public XrangeSeriesDataDataLabelsPosition Position { get; set; }
		private XrangeSeriesDataDataLabelsPosition Position_DefaultValue { get; set; }
		...
		/// </summary>
		public XrangeSeriesDataDataLabelsTextPath TextPath { get; set; }
		private XrangeSeriesDataDataLabelsTextPath TextPath_DefaultValue { get; set; }
		...
		/// </summary>
		public XrangeSeriesDataDataLabelsVerticalAlign VerticalAlign { get; set; }
		private XrangeSeriesDataDataLabelsVerticalAlign VerticalAlign_DefaultValue { get; set; }
		...
		internal override Hashtable ToHashtable(Highcharts highcharts)
		{
			...
			if (Align != XrangeSeriesDataDataLabelsAlign.Null) h.Add("align", highcharts.FirstCharacterToLower(Align.ToString()));
			...
			if (Overflow != XrangeSeriesDataDataLabelsOverflow.Null) h.Add("overflow", highcharts.FirstCharacterToLower(Overflow.ToString()));
			if (Padding != null) h.Add("padding",Padding);
			if (Position != XrangeSeriesDataDataLabelsPosition.Null) h.Add("position", highcharts.FirstCharacterToLower(Position.ToString()));
			...
			if (VerticalAlign != XrangeSeriesDataDataLabelsVerticalAlign.Null) h.Add("verticalAlign", highcharts.FirstCharacterToLower(VerticalAlign.ToString()));
			if (X != null) h.Add("x",X);
			if (Y != null) h.Add("y",Y);
