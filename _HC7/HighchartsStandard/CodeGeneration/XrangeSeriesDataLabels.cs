...
namespace Highsoft.Web.Mvc.Charts
{
	public partial class XrangeSeriesDataLabels  : BaseObject
	{
		...
		/// </summary>
		public XrangeSeriesDataLabelsFilter Filter { get; set; }
		private XrangeSeriesDataLabelsFilter Filter_DefaultValue { get; set; }
		...
		/// </summary>
		public XrangeSeriesDataLabelsOverflow Overflow { get; set; }
		private XrangeSeriesDataLabelsOverflow Overflow_DefaultValue { get; set; }
		...
		/// </summary>
		public XrangeSeriesDataLabelsPosition Position { get; set; }
		private XrangeSeriesDataLabelsPosition Position_DefaultValue { get; set; }
		...
		/// </summary>
		public XrangeSeriesDataLabelsTextPath TextPath { get; set; }
		private XrangeSeriesDataLabelsTextPath TextPath_DefaultValue { get; set; }
		...
		internal override Hashtable ToHashtable(Highcharts highcharts)
		{
			...
			if (Align != XrangeSeriesDataLabelsAlign.Null) h.Add("align", highcharts.FirstCharacterToLower(Align.ToString()));
			...
			if (Overflow != XrangeSeriesDataLabelsOverflow.Null) h.Add("overflow", highcharts.FirstCharacterToLower(Overflow.ToString()));
			if (Padding != null) h.Add("padding",Padding);
			if (Position != XrangeSeriesDataLabelsPosition.Null) h.Add("position", highcharts.FirstCharacterToLower(Position.ToString()));
			...
			if (VerticalAlign != XrangeSeriesDataLabelsVerticalAlign.Null) h.Add("verticalAlign", highcharts.FirstCharacterToLower(VerticalAlign.ToString()));
			if (X != null) h.Add("x",X);
			if (Y != null) h.Add("y",Y);
