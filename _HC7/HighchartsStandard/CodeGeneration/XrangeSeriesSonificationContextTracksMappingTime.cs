...
{
	public partial class XrangeSeriesSonificationContextTracksMappingTime  : BaseObject
	{
		Hashtable h = new Hashtable();

		public XrangeSeriesSonificationContextTracksMappingTime()
		{
			MapFunction = MapFunction_DefaultValue = XrangeSeriesSonificationContextTracksMappingTimeMapFunction.Linear;
			MapTo = MapTo_DefaultValue = "";
			Max = Max_DefaultValue = null;
			Min = Min_DefaultValue = null;
			Value = Value_DefaultValue = null;
			Within = Within_DefaultValue = XrangeSeriesSonificationContextTracksMappingTimeWithin.Chart;
		...
		/// </summary>
		public XrangeSeriesSonificationContextTracksMappingTimeMapFunction MapFunction { get; set; }
		private XrangeSeriesSonificationContextTracksMappingTimeMapFunction MapFunction_DefaultValue { get; set; }
		...
		/// </summary>
		public XrangeSeriesSonificationContextTracksMappingTimeWithin Within { get; set; }
		private XrangeSeriesSonificationContextTracksMappingTimeWithin Within_DefaultValue { get; set; }
