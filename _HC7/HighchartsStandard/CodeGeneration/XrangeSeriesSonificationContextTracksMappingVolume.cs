...
{
	public partial class XrangeSeriesSonificationContextTracksMappingVolume  : BaseObject
	{
		Hashtable h = new Hashtable();

		public XrangeSeriesSonificationContextTracksMappingVolume()
		{
			MapFunction = MapFunction_DefaultValue = XrangeSeriesSonificationContextTracksMappingVolumeMapFunction.Linear;
			MapTo = MapTo_DefaultValue = "";
			Max = Max_DefaultValue = null;
			Min = Min_DefaultValue = null;
			Value = Value_DefaultValue = null;
			Within = Within_DefaultValue = XrangeSeriesSonificationContextTracksMappingVolumeWithin.Chart;
		...
		/// </summary>
		public XrangeSeriesSonificationContextTracksMappingVolumeMapFunction MapFunction { get; set; }
		private XrangeSeriesSonificationContextTracksMappingVolumeMapFunction MapFunction_DefaultValue { get; set; }
		...
		/// </summary>
		public XrangeSeriesSonificationContextTracksMappingVolumeWithin Within { get; set; }
		private XrangeSeriesSonificationContextTracksMappingVolumeWithin Within_DefaultValue { get; set; }
