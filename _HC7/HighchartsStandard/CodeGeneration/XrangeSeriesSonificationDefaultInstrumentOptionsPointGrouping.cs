...
{
	public partial class XrangeSeriesSonificationDefaultInstrumentOptionsPointGrouping  : BaseObject
	{
		Hashtable h = new Hashtable();

		public XrangeSeriesSonificationDefaultInstrumentOptionsPointGrouping()
		{
		...
		/// </summary>
		public XrangeSeriesSonificationDefaultInstrumentOptionsPointGroupingAlgorithm Algorithm { get; set; }
		private XrangeSeriesSonificationDefaultInstrumentOptionsPointGroupingAlgorithm Algorithm_DefaultValue { get; set; }
		...
		internal override Hashtable ToHashtable(Highcharts highcharts)
		{
			...
			if (Algorithm != XrangeSeriesSonificationDefaultInstrumentOptionsPointGroupingAlgorithm.Null) h.Add("algorithm", highcharts.FirstCharacterToLower(Algorithm.ToString()));
