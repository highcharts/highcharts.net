...
{
	public partial class XrangeSeriesSonificationDefaultSpeechOptionsMappingLowpassFrequency  : BaseObject
	{
		Hashtable h = new Hashtable();

		public XrangeSeriesSonificationDefaultSpeechOptionsMappingLowpassFrequency()
		{
			MapFunction = MapFunction_DefaultValue = XrangeSeriesSonificationDefaultSpeechOptionsMappingLowpassFrequencyMapFunction.Linear;
			MapTo = MapTo_DefaultValue = "";
			Max = Max_DefaultValue = null;
			Min = Min_DefaultValue = null;
			Value = Value_DefaultValue = null;
			Within = Within_DefaultValue = XrangeSeriesSonificationDefaultSpeechOptionsMappingLowpassFrequencyWithin.Chart;
		...
		/// </summary>
		public XrangeSeriesSonificationDefaultSpeechOptionsMappingLowpassFrequencyMapFunction MapFunction { get; set; }
		private XrangeSeriesSonificationDefaultSpeechOptionsMappingLowpassFrequencyMapFunction MapFunction_DefaultValue { get; set; }
		...
		/// </summary>
		public XrangeSeriesSonificationDefaultSpeechOptionsMappingLowpassFrequencyWithin Within { get; set; }
		private XrangeSeriesSonificationDefaultSpeechOptionsMappingLowpassFrequencyWithin Within_DefaultValue { get; set; }
