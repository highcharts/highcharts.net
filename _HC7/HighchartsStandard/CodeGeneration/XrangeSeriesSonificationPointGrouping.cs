...
{
	public partial class XrangeSeriesSonificationPointGrouping  : BaseObject
	{
		Hashtable h = new Hashtable();

		public XrangeSeriesSonificationPointGrouping()
		{
		...
		/// </summary>
		public XrangeSeriesSonificationPointGroupingAlgorithm Algorithm { get; set; }
		private XrangeSeriesSonificationPointGroupingAlgorithm Algorithm_DefaultValue { get; set; }
		...
		internal override Hashtable ToHashtable(Highcharts highcharts)
		{
			...
			if (Algorithm != XrangeSeriesSonificationPointGroupingAlgorithm.Null) h.Add("algorithm", highcharts.FirstCharacterToLower(Algorithm.ToString()));
