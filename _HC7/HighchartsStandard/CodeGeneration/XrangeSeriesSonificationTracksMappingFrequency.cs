...
{
	public partial class XrangeSeriesSonificationTracksMappingFrequency  : BaseObject
	{
		Hashtable h = new Hashtable();

		public XrangeSeriesSonificationTracksMappingFrequency()
		{
			MapFunction = MapFunction_DefaultValue = XrangeSeriesSonificationTracksMappingFrequencyMapFunction.Linear;
			MapTo = MapTo_DefaultValue = "";
			Max = Max_DefaultValue = null;
			Min = Min_DefaultValue = null;
			Value = Value_DefaultValue = null;
			Within = Within_DefaultValue = XrangeSeriesSonificationTracksMappingFrequencyWithin.Chart;
		...
		/// </summary>
		public XrangeSeriesSonificationTracksMappingFrequencyMapFunction MapFunction { get; set; }
		private XrangeSeriesSonificationTracksMappingFrequencyMapFunction MapFunction_DefaultValue { get; set; }
		...
		/// </summary>
		public XrangeSeriesSonificationTracksMappingFrequencyWithin Within { get; set; }
		private XrangeSeriesSonificationTracksMappingFrequencyWithin Within_DefaultValue { get; set; }
