...
{
	public partial class XrangeSeriesSonificationTracksMappingHighpassResonance  : BaseObject
	{
		Hashtable h = new Hashtable();

		public XrangeSeriesSonificationTracksMappingHighpassResonance()
		{
			MapFunction = MapFunction_DefaultValue = XrangeSeriesSonificationTracksMappingHighpassResonanceMapFunction.Linear;
			MapTo = MapTo_DefaultValue = "";
			Max = Max_DefaultValue = null;
			Min = Min_DefaultValue = null;
			Value = Value_DefaultValue = null;
			Within = Within_DefaultValue = XrangeSeriesSonificationTracksMappingHighpassResonanceWithin.Chart;
		...
		/// </summary>
		public XrangeSeriesSonificationTracksMappingHighpassResonanceMapFunction MapFunction { get; set; }
		private XrangeSeriesSonificationTracksMappingHighpassResonanceMapFunction MapFunction_DefaultValue { get; set; }
		...
		/// </summary>
		public XrangeSeriesSonificationTracksMappingHighpassResonanceWithin Within { get; set; }
		private XrangeSeriesSonificationTracksMappingHighpassResonanceWithin Within_DefaultValue { get; set; }
