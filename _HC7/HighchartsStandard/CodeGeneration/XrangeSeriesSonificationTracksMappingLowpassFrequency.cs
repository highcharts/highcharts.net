...
{
	public partial class XrangeSeriesSonificationTracksMappingLowpassFrequency  : BaseObject
	{
		Hashtable h = new Hashtable();

		public XrangeSeriesSonificationTracksMappingLowpassFrequency()
		{
			MapFunction = MapFunction_DefaultValue = XrangeSeriesSonificationTracksMappingLowpassFrequencyMapFunction.Linear;
			MapTo = MapTo_DefaultValue = "";
			Max = Max_DefaultValue = null;
			Min = Min_DefaultValue = null;
			Value = Value_DefaultValue = null;
			Within = Within_DefaultValue = XrangeSeriesSonificationTracksMappingLowpassFrequencyWithin.Chart;
		...
		/// </summary>
		public XrangeSeriesSonificationTracksMappingLowpassFrequencyMapFunction MapFunction { get; set; }
		private XrangeSeriesSonificationTracksMappingLowpassFrequencyMapFunction MapFunction_DefaultValue { get; set; }
		...
		/// </summary>
		public XrangeSeriesSonificationTracksMappingLowpassFrequencyWithin Within { get; set; }
		private XrangeSeriesSonificationTracksMappingLowpassFrequencyWithin Within_DefaultValue { get; set; }
