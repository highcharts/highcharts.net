...
{
	public partial class XrangeSeriesSonificationTracksMappingPan  : BaseObject
	{
		Hashtable h = new Hashtable();

		public XrangeSeriesSonificationTracksMappingPan()
		{
			MapFunction = MapFunction_DefaultValue = XrangeSeriesSonificationTracksMappingPanMapFunction.Linear;
			MapTo = MapTo_DefaultValue = "";
			Max = Max_DefaultValue = null;
			Min = Min_DefaultValue = null;
			Value = Value_DefaultValue = null;
			Within = Within_DefaultValue = XrangeSeriesSonificationTracksMappingPanWithin.Chart;
		...
		/// </summary>
		public XrangeSeriesSonificationTracksMappingPanMapFunction MapFunction { get; set; }
		private XrangeSeriesSonificationTracksMappingPanMapFunction MapFunction_DefaultValue { get; set; }
		...
		/// </summary>
		public XrangeSeriesSonificationTracksMappingPanWithin Within { get; set; }
		private XrangeSeriesSonificationTracksMappingPanWithin Within_DefaultValue { get; set; }
