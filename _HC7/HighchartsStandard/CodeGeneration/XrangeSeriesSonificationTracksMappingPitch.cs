...
{
	public partial class XrangeSeriesSonificationTracksMappingPitch  : BaseObject
	{
		Hashtable h = new Hashtable();

		public XrangeSeriesSonificationTracksMappingPitch()
		{
			MapFunction = MapFunction_DefaultValue = XrangeSeriesSonificationTracksMappingPitchMapFunction.Linear;
		...
		/// </summary>
		public XrangeSeriesSonificationTracksMappingPitchMapFunction MapFunction { get; set; }
		private XrangeSeriesSonificationTracksMappingPitchMapFunction MapFunction_DefaultValue { get; set; }
