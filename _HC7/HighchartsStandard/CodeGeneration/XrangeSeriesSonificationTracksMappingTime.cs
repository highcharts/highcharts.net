...
{
	public partial class XrangeSeriesSonificationTracksMappingTime  : BaseObject
	{
		Hashtable h = new Hashtable();

		public XrangeSeriesSonificationTracksMappingTime()
		{
			MapFunction = MapFunction_DefaultValue = XrangeSeriesSonificationTracksMappingTimeMapFunction.Linear;
			MapTo = MapTo_DefaultValue = "";
			Max = Max_DefaultValue = null;
			Min = Min_DefaultValue = null;
			Value = Value_DefaultValue = null;
			Within = Within_DefaultValue = XrangeSeriesSonificationTracksMappingTimeWithin.Chart;
		...
		/// </summary>
		public XrangeSeriesSonificationTracksMappingTimeMapFunction MapFunction { get; set; }
		private XrangeSeriesSonificationTracksMappingTimeMapFunction MapFunction_DefaultValue { get; set; }
		...
		/// </summary>
		public XrangeSeriesSonificationTracksMappingTimeWithin Within { get; set; }
		private XrangeSeriesSonificationTracksMappingTimeWithin Within_DefaultValue { get; set; }
