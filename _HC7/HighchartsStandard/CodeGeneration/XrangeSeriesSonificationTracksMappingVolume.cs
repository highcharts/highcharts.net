...
{
	public partial class XrangeSeriesSonificationTracksMappingVolume  : BaseObject
	{
		Hashtable h = new Hashtable();

		public XrangeSeriesSonificationTracksMappingVolume()
		{
			MapFunction = MapFunction_DefaultValue = XrangeSeriesSonificationTracksMappingVolumeMapFunction.Linear;
			MapTo = MapTo_DefaultValue = "";
			Max = Max_DefaultValue = null;
			Min = Min_DefaultValue = null;
			Value = Value_DefaultValue = null;
			Within = Within_DefaultValue = XrangeSeriesSonificationTracksMappingVolumeWithin.Chart;
		...
		/// </summary>
		public XrangeSeriesSonificationTracksMappingVolumeMapFunction MapFunction { get; set; }
		private XrangeSeriesSonificationTracksMappingVolumeMapFunction MapFunction_DefaultValue { get; set; }
		...
		/// </summary>
		public XrangeSeriesSonificationTracksMappingVolumeWithin Within { get; set; }
		private XrangeSeriesSonificationTracksMappingVolumeWithin Within_DefaultValue { get; set; }
