...
{
	public partial class XrangeSeriesSonificationTracksPointGrouping  : BaseObject
	{
		Hashtable h = new Hashtable();

		public XrangeSeriesSonificationTracksPointGrouping()
		{
		...
		/// </summary>
		public XrangeSeriesSonificationTracksPointGroupingAlgorithm Algorithm { get; set; }
		private XrangeSeriesSonificationTracksPointGroupingAlgorithm Algorithm_DefaultValue { get; set; }
		...
		internal override Hashtable ToHashtable(Highcharts highcharts)
		{
			...
			if (Algorithm != XrangeSeriesSonificationTracksPointGroupingAlgorithm.Null) h.Add("algorithm", highcharts.FirstCharacterToLower(Algorithm.ToString()));
