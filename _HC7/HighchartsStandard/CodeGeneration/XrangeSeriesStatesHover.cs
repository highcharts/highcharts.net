...
{
	public partial class XrangeSeriesStatesHover  : BaseObject
	{
		Hashtable h = new Hashtable();

		public XrangeSeriesStatesHover()
		{
			Animation = Animation_DefaultValue = new Animation();
			Enabled = Enabled_DefaultValue = null;
			Halo = Halo_DefaultValue = new XrangeSeriesStatesHoverHalo();
			LineWidth = LineWidth_DefaultValue = null;
			LineWidthPlus = LineWidthPlus_DefaultValue = null;
			Marker = Marker_DefaultValue = new XrangeSeriesStatesHoverMarker();
		...
		/// </summary>
		public XrangeSeriesStatesHoverHalo Halo { get; set; }
		private XrangeSeriesStatesHoverHalo Halo_DefaultValue { get; set; }
		...
		/// </summary>
		public XrangeSeriesStatesHoverMarker Marker { get; set; }
		private XrangeSeriesStatesHoverMarker Marker_DefaultValue { get; set; }
