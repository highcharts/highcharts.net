...
{
	public partial class XrangeSeriesStatesHoverMarker  : BaseObject
	{
		public XrangeSeriesStatesHoverMarker()
		{
			...
			States = States_DefaultValue = new XrangeSeriesStatesHoverMarkerStates();
		...
		/// </summary>
		public XrangeSeriesStatesHoverMarkerStates States { get; set; }
		private XrangeSeriesStatesHoverMarkerStates States_DefaultValue { get; set; }
