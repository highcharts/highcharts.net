...
{
	public partial class ZAxisPlotLines  : BaseObject
	{
		...
		/// </summary>
		public ZAxisPlotLinesLabel Label { get; set; }
		private ZAxisPlotLinesLabel Label_DefaultValue { get; set; }
		 

		/// <summary>
		/// 
		/// </summary>
		public ZAxisPlotLinesLabels Labels { get; set; }
		private ZAxisPlotLinesLabels Labels_DefaultValue { get; set; }
