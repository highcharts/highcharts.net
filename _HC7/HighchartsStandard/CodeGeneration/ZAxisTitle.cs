...
{
	public partial class ZAxisTitle  : BaseObject
	{
		...
		/// </summary>
		public ZAxisTitlePosition3d Position3d { get; set; }
		private ZAxisTitlePosition3d Position3d_DefaultValue { get; set; }
		...
		/// </summary>
		public ZAxisTitleTextAlign TextAlign { get; set; }
		private ZAxisTitleTextAlign TextAlign_DefaultValue { get; set; }
		...
		internal override Hashtable ToHashtable(Highcharts highcharts)
		{
			...
			if (Align != ZAxisTitleAlign.Null) h.Add("align", highcharts.FirstCharacterToLower(Align.ToString()));
			if (Enabled != null) h.Add("enabled",Enabled);
			if (Margin != null) h.Add("margin",Margin);
			if (Offset != null) h.Add("offset",Offset);
			if (Position3d != ZAxisTitlePosition3d.Null) h.Add("position3d", highcharts.FirstCharacterToLower(Position3d.ToString()));
			...
			if (TextAlign != ZAxisTitleTextAlign.Null) h.Add("textAlign", highcharts.FirstCharacterToLower(TextAlign.ToString()));
