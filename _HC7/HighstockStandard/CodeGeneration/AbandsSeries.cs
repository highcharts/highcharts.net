...
{
	public partial class AbandsSeries  : Series
	{
		Hashtable h = new Hashtable();

		public AbandsSeries()
		{
			Accessibility = Accessibility_DefaultValue = new AbandsSeriesAccessibility();
			AllowPointSelect = AllowPointSelect_DefaultValue = false;
			Animation = Animation_DefaultValue = new Animation() { Enabled = true };
			AnimationBool = AnimationBool_DefaultValue = true;
			AnimationLimit = AnimationLimit_DefaultValue = null;
			BoostBlending = BoostBlending_DefaultValue = AbandsSeriesBoostBlending.Undefined;
			BoostThreshold = BoostThreshold_DefaultValue = 5000;
			BottomLine = BottomLine_DefaultValue = new AbandsSeriesBottomLine();
			...
			Cursor = Cursor_DefaultValue = AbandsSeriesCursor.Null;
			Custom = Custom_DefaultValue = new Hashtable();
			DashStyle = DashStyle_DefaultValue = AbandsSeriesDashStyle.Null;
			DataGrouping = DataGrouping_DefaultValue = new AbandsSeriesDataGrouping();
			DataLabels = DataLabels_DefaultValue = new AbandsSeriesDataLabels();
			DataSorting = DataSorting_DefaultValue = new AbandsSeriesDataSorting();
			Description = Description_DefaultValue = "";
			Dumbell = Dumbell_DefaultValue = new AbandsSeriesDumbell();
			EnableMouseTracking = EnableMouseTracking_DefaultValue = true;
			Events = Events_DefaultValue = new AbandsSeriesEvents();
			FillColor = FillColor_DefaultValue = "";
			FindNearestPointBy = FindNearestPointBy_DefaultValue = AbandsSeriesFindNearestPointBy.X;
			GapSize = GapSize_DefaultValue = 0;
			GapUnit = GapUnit_DefaultValue = AbandsSeriesGapUnit.Relative;
			GetExtremesFromAll = GetExtremesFromAll_DefaultValue = false;
			Id = Id_DefaultValue = "";
			InactiveOtherPoints = InactiveOtherPoints_DefaultValue = false;
			IncludeInDataExport = IncludeInDataExport_DefaultValue = null;
			Index = Index_DefaultValue = null;
			Label = Label_DefaultValue = new AbandsSeriesLabel();
			LastPrice = LastPrice_DefaultValue = new AbandsSeriesLastPrice();
			LastVisiblePrice = LastVisiblePrice_DefaultValue = new AbandsSeriesLastVisiblePrice();
			LegendIndex = LegendIndex_DefaultValue = null;
			LegendSymbol = LegendSymbol_DefaultValue = AbandsSeriesLegendSymbol.Rectangle;
			Linecap = Linecap_DefaultValue = AbandsSeriesLinecap.Round;
			LineWidth = LineWidth_DefaultValue = 2;
			LinkedTo = LinkedTo_DefaultValue = "";
			Marker = Marker_DefaultValue = new AbandsSeriesMarker();
			Name = Name_DefaultValue = "";
			NegativeColor = NegativeColor_DefaultValue = "";
			OnPoint = OnPoint_DefaultValue = new AbandsSeriesOnPoint();
			Opacity = Opacity_DefaultValue = 1;
			Params = Params_DefaultValue = new AbandsSeriesParams();
			Point = Point_DefaultValue = new AbandsSeriesPoint();
			...
			Sonification = Sonification_DefaultValue = new AbandsSeriesSonification();
			Stack = Stack_DefaultValue = "";
			StackNumber = StackNumber_DefaultValue = null;
			States = States_DefaultValue = new AbandsSeriesStates();
			Step = Step_DefaultValue = AbandsSeriesStep.Null;
			StickyTracking = StickyTracking_DefaultValue = true;
			Threshold = Threshold_DefaultValue = 0;
			Tooltip = Tooltip_DefaultValue = new AbandsSeriesTooltip();
			TopLine = TopLine_DefaultValue = new AbandsSeriesTopLine();
			...
			Zones = Zones_DefaultValue = new List<AbandsSeriesZones>();
		...
		/// </summary>
		public AbandsSeriesAccessibility Accessibility { get; set; }
		private AbandsSeriesAccessibility Accessibility_DefaultValue { get; set; }
		...
		/// </summary>
		public AbandsSeriesBoostBlending BoostBlending { get; set; }
		private AbandsSeriesBoostBlending BoostBlending_DefaultValue { get; set; }
		...
		/// 
		/// </summary>
		public AbandsSeriesBottomLine BottomLine { get; set; }
		private AbandsSeriesBottomLine BottomLine_DefaultValue { get; set; }
		...
		/// </summary>
		public AbandsSeriesCursor Cursor { get; set; }
		private AbandsSeriesCursor Cursor_DefaultValue { get; set; }
		...
		/// </summary>
		public AbandsSeriesDashStyle DashStyle { get; set; }
		private AbandsSeriesDashStyle DashStyle_DefaultValue { get; set; }
		...
		/// </summary>
		public AbandsSeriesDataGrouping DataGrouping { get; set; }
		private AbandsSeriesDataGrouping DataGrouping_DefaultValue { get; set; }
		...
		/// </summary>
		public AbandsSeriesDataLabels DataLabels { get; set; }
		private AbandsSeriesDataLabels DataLabels_DefaultValue { get; set; }
		 

		/// <summary>
		/// Options for the series data sorting.
		/// </summary>
		public AbandsSeriesDataSorting DataSorting { get; set; }
		private AbandsSeriesDataSorting DataSorting_DefaultValue { get; set; }
		...
		/// 
		/// </summary>
		public AbandsSeriesDumbell Dumbell { get; set; }
		private AbandsSeriesDumbell Dumbell_DefaultValue { get; set; }
		...
		/// </summary>
		public AbandsSeriesEvents Events { get; set; }
		private AbandsSeriesEvents Events_DefaultValue { get; set; }
		...
		/// </summary>
		public AbandsSeriesFindNearestPointBy FindNearestPointBy { get; set; }
		private AbandsSeriesFindNearestPointBy FindNearestPointBy_DefaultValue { get; set; }
		...
		/// </summary>
		public AbandsSeriesGapUnit GapUnit { get; set; }
		private AbandsSeriesGapUnit GapUnit_DefaultValue { get; set; }
		...
		/// </summary>
		public AbandsSeriesLabel Label { get; set; }
		private AbandsSeriesLabel Label_DefaultValue { get; set; }
		 

		/// <summary>
		/// The line marks the last price from all points.
		/// </summary>
		public AbandsSeriesLastPrice LastPrice { get; set; }
		private AbandsSeriesLastPrice LastPrice_DefaultValue { get; set; }
		 

		/// <summary>
		/// The line marks the last price from visible range of points.
		/// </summary>
		public AbandsSeriesLastVisiblePrice LastVisiblePrice { get; set; }
		private AbandsSeriesLastVisiblePrice LastVisiblePrice_DefaultValue { get; set; }
		...
		/// </summary>
		public AbandsSeriesLegendSymbol LegendSymbol { get; set; }
		private AbandsSeriesLegendSymbol LegendSymbol_DefaultValue { get; set; }
		 

		/// <summary>
		/// The line cap used for line ends and line joins on the graph.
		/// </summary>
		public AbandsSeriesLinecap Linecap { get; set; }
		private AbandsSeriesLinecap Linecap_DefaultValue { get; set; }
		...
		/// </summary>
		public AbandsSeriesMarker Marker { get; set; }
		private AbandsSeriesMarker Marker_DefaultValue { get; set; }
		...
		/// </summary>
		public AbandsSeriesOnPoint OnPoint { get; set; }
		private AbandsSeriesOnPoint OnPoint_DefaultValue { get; set; }
		...
		/// </summary>
		public AbandsSeriesParams Params { get; set; }
		private AbandsSeriesParams Params_DefaultValue { get; set; }
		 

		/// <summary>
		/// Properties for each single point.
		/// </summary>
		public AbandsSeriesPoint Point { get; set; }
		private AbandsSeriesPoint Point_DefaultValue { get; set; }
		...
		/// </summary>
		public AbandsSeriesSonification Sonification { get; set; }
		private AbandsSeriesSonification Sonification_DefaultValue { get; set; }
		...
		/// 
		/// </summary>
		public AbandsSeriesStates States { get; set; }
		private AbandsSeriesStates States_DefaultValue { get; set; }
		 

		/// <summary>
		/// Whether to apply steps to the line. Possible values are `left`,`center` and `right`.
		/// </summary>
		public AbandsSeriesStep Step { get; set; }
		private AbandsSeriesStep Step_DefaultValue { get; set; }
		...
		/// </summary>
		public AbandsSeriesTooltip Tooltip { get; set; }
		private AbandsSeriesTooltip Tooltip_DefaultValue { get; set; }
		 

		/// <summary>
		/// 
		/// </summary>
		public AbandsSeriesTopLine TopLine { get; set; }
		private AbandsSeriesTopLine TopLine_DefaultValue { get; set; }
		...
		/// </summary>
		public List<AbandsSeriesZones> Zones { get; set; }
		private List<AbandsSeriesZones> Zones_DefaultValue { get; set; }
