...
namespace Highsoft.Web.Mvc.Stocks
{
	public partial class AbandsSeries  : Series
	{
		public AbandsSeries()
		{
			...
			DragDrop = DragDrop_DefaultValue = new AbandsSeriesDragDrop();
		...
		/// </summary>
		public AbandsSeriesDragDrop DragDrop { get; set; }
		private AbandsSeriesDragDrop DragDrop_DefaultValue { get; set; }
