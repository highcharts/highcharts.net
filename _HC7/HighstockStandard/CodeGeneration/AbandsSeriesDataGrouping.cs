...
namespace Highsoft.Web.Mvc.Stocks
{
	public partial class AbandsSeriesDataGrouping  : BaseObject
	{
		...
		internal override Hashtable ToHashtable()
		{
			...
			if (Approximation != Approximation_DefaultValue) { h.Add("approximation",Approximation); Highstock.AddFunction("AbandsSeriesDataGroupingApproximation.approximation", Approximation); }  
