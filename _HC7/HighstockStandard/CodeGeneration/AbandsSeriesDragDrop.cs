...
{
	public partial class AbandsSeriesDragDrop  : BaseObject
	{
		public AbandsSeriesDragDrop()
		{
			DraggableX = DraggableX_DefaultValue = null;
			DraggableY = DraggableY_DefaultValue = null;
			DragHandle = DragHandle_DefaultValue = new AbandsSeriesDragDropDragHandle();
			...
			GuideBox = GuideBox_DefaultValue = new AbandsSeriesDragDropGuideBox();
		...
		/// </summary>
		public AbandsSeriesDragDropDragHandle DragHandle { get; set; }
		private AbandsSeriesDragDropDragHandle DragHandle_DefaultValue { get; set; }
		...
		/// </summary>
		public AbandsSeriesDragDropGuideBox GuideBox { get; set; }
		private AbandsSeriesDragDropGuideBox GuideBox_DefaultValue { get; set; }
