...
{
	public partial class AbandsSeriesDragDropDragHandle  : BaseObject
	{
		public AbandsSeriesDragDropDragHandle()
		{
		...
		internal override Hashtable ToHashtable()
		{
			...
			if (PathFormatter != PathFormatter_DefaultValue) { h.Add("pathFormatter",PathFormatter); Highstock.AddFunction("AbandsSeriesDragDropDragHandlePathFormatter.pathFormatter", PathFormatter); }  
