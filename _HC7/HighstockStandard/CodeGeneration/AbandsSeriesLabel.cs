...
{
	public partial class AbandsSeriesLabel  : BaseObject
	{
		public AbandsSeriesLabel()
		{
			...
			Style = Style_DefaultValue = new AbandsSeriesLabelStyle();
		...
		/// </summary>
		public AbandsSeriesLabelStyle Style { get; set; }
		private AbandsSeriesLabelStyle Style_DefaultValue { get; set; }
