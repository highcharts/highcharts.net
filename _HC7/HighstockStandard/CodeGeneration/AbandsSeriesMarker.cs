...
{
	public partial class AbandsSeriesMarker  : BaseObject
	{
		public AbandsSeriesMarker()
		{
			...
			States = States_DefaultValue = new AbandsSeriesMarkerStates();
		...
		/// </summary>
		public AbandsSeriesMarkerStates States { get; set; }
		private AbandsSeriesMarkerStates States_DefaultValue { get; set; }
