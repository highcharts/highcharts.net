...
{
	public partial class AbandsSeriesSonificationContextTracks  : BaseObject
	{
		Hashtable h = new Hashtable();

		public AbandsSeriesSonificationContextTracks()
		{
			ActiveWhen = ActiveWhen_DefaultValue = new AbandsSeriesSonificationContextTracksActiveWhen();
			Instrument = Instrument_DefaultValue = null;
			InstrumentString = InstrumentString_DefaultValue = "null";
			Mapping = Mapping_DefaultValue = new AbandsSeriesSonificationContextTracksMapping();
			MidiName = MidiName_DefaultValue = "";
			PointGrouping = PointGrouping_DefaultValue = new AbandsSeriesSonificationContextTracksPointGrouping();
			...
			Type = Type_DefaultValue = AbandsSeriesSonificationContextTracksType.Instrument;
			ValueInterval = ValueInterval_DefaultValue = null;
			ValueMapFunction = ValueMapFunction_DefaultValue = AbandsSeriesSonificationContextTracksValueMapFunction.Linear;
		...
		/// </summary>
		public AbandsSeriesSonificationContextTracksActiveWhen ActiveWhen { get; set; }
		private AbandsSeriesSonificationContextTracksActiveWhen ActiveWhen_DefaultValue { get; set; }
		...
		/// </summary>
		public AbandsSeriesSonificationContextTracksMapping Mapping { get; set; }
		private AbandsSeriesSonificationContextTracksMapping Mapping_DefaultValue { get; set; }
		...
		/// </summary>
		public AbandsSeriesSonificationContextTracksPointGrouping PointGrouping { get; set; }
		private AbandsSeriesSonificationContextTracksPointGrouping PointGrouping_DefaultValue { get; set; }
		...
		/// </summary>
		public AbandsSeriesSonificationContextTracksType Type { get; set; }
		private AbandsSeriesSonificationContextTracksType Type_DefaultValue { get; set; }
		...
		/// </summary>
		public AbandsSeriesSonificationContextTracksValueMapFunction ValueMapFunction { get; set; }
		private AbandsSeriesSonificationContextTracksValueMapFunction ValueMapFunction_DefaultValue { get; set; }
