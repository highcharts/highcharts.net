...
{
	public partial class AbandsSeriesSonificationContextTracksMappingPan  : BaseObject
	{
		Hashtable h = new Hashtable();

		public AbandsSeriesSonificationContextTracksMappingPan()
		{
			MapFunction = MapFunction_DefaultValue = AbandsSeriesSonificationContextTracksMappingPanMapFunction.Linear;
			MapTo = MapTo_DefaultValue = "";
			Max = Max_DefaultValue = null;
			Min = Min_DefaultValue = null;
			Value = Value_DefaultValue = null;
			Within = Within_DefaultValue = AbandsSeriesSonificationContextTracksMappingPanWithin.Chart;
		...
		/// </summary>
		public AbandsSeriesSonificationContextTracksMappingPanMapFunction MapFunction { get; set; }
		private AbandsSeriesSonificationContextTracksMappingPanMapFunction MapFunction_DefaultValue { get; set; }
		...
		/// </summary>
		public AbandsSeriesSonificationContextTracksMappingPanWithin Within { get; set; }
		private AbandsSeriesSonificationContextTracksMappingPanWithin Within_DefaultValue { get; set; }
