...
{
	public partial class AbandsSeriesSonificationContextTracksMappingPitch  : BaseObject
	{
		Hashtable h = new Hashtable();

		public AbandsSeriesSonificationContextTracksMappingPitch()
		{
			MapFunction = MapFunction_DefaultValue = AbandsSeriesSonificationContextTracksMappingPitchMapFunction.Linear;
		...
		/// </summary>
		public AbandsSeriesSonificationContextTracksMappingPitchMapFunction MapFunction { get; set; }
		private AbandsSeriesSonificationContextTracksMappingPitchMapFunction MapFunction_DefaultValue { get; set; }
