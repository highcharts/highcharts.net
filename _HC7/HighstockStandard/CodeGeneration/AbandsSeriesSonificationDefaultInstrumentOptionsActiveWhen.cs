...
{
	public partial class AbandsSeriesSonificationDefaultInstrumentOptionsActiveWhen  : BaseObject
	{
		Hashtable h = new Hashtable();

		public AbandsSeriesSonificationDefaultInstrumentOptionsActiveWhen()
		{
