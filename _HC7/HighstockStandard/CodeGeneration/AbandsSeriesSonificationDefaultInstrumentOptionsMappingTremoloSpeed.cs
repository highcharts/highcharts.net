...
{
	public partial class AbandsSeriesSonificationDefaultInstrumentOptionsMappingTremoloSpeed  : BaseObject
	{
		Hashtable h = new Hashtable();

		public AbandsSeriesSonificationDefaultInstrumentOptionsMappingTremoloSpeed()
		{
			MapFunction = MapFunction_DefaultValue = AbandsSeriesSonificationDefaultInstrumentOptionsMappingTremoloSpeedMapFunction.Linear;
			MapTo = MapTo_DefaultValue = "";
			Max = Max_DefaultValue = null;
			Min = Min_DefaultValue = null;
			Value = Value_DefaultValue = null;
			Within = Within_DefaultValue = AbandsSeriesSonificationDefaultInstrumentOptionsMappingTremoloSpeedWithin.Chart;
		...
		/// </summary>
		public AbandsSeriesSonificationDefaultInstrumentOptionsMappingTremoloSpeedMapFunction MapFunction { get; set; }
		private AbandsSeriesSonificationDefaultInstrumentOptionsMappingTremoloSpeedMapFunction MapFunction_DefaultValue { get; set; }
		...
		/// </summary>
		public AbandsSeriesSonificationDefaultInstrumentOptionsMappingTremoloSpeedWithin Within { get; set; }
		private AbandsSeriesSonificationDefaultInstrumentOptionsMappingTremoloSpeedWithin Within_DefaultValue { get; set; }
