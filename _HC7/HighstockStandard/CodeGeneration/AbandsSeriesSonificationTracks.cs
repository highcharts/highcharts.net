...
{
	public partial class AbandsSeriesSonificationTracks  : BaseObject
	{
		Hashtable h = new Hashtable();

		public AbandsSeriesSonificationTracks()
		{
			ActiveWhen = ActiveWhen_DefaultValue = new AbandsSeriesSonificationTracksActiveWhen();
			Instrument = Instrument_DefaultValue = null;
			InstrumentString = InstrumentString_DefaultValue = "null";
			Mapping = Mapping_DefaultValue = new AbandsSeriesSonificationTracksMapping();
			MidiName = MidiName_DefaultValue = "";
			PointGrouping = PointGrouping_DefaultValue = new AbandsSeriesSonificationTracksPointGrouping();
			RoundToMusicalNotes = RoundToMusicalNotes_DefaultValue = true;
			ShowPlayMarker = ShowPlayMarker_DefaultValue = true;
			Type = Type_DefaultValue = AbandsSeriesSonificationTracksType.Instrument;
		...
		/// </summary>
		public AbandsSeriesSonificationTracksActiveWhen ActiveWhen { get; set; }
		private AbandsSeriesSonificationTracksActiveWhen ActiveWhen_DefaultValue { get; set; }
		...
		/// </summary>
		public AbandsSeriesSonificationTracksMapping Mapping { get; set; }
		private AbandsSeriesSonificationTracksMapping Mapping_DefaultValue { get; set; }
		...
		/// </summary>
		public AbandsSeriesSonificationTracksPointGrouping PointGrouping { get; set; }
		private AbandsSeriesSonificationTracksPointGrouping PointGrouping_DefaultValue { get; set; }
		...
		/// </summary>
		public AbandsSeriesSonificationTracksType Type { get; set; }
		private AbandsSeriesSonificationTracksType Type_DefaultValue { get; set; }
