...
{
	public partial class AbandsSeriesSonificationTracksMapping  : BaseObject
	{
		Hashtable h = new Hashtable();

		public AbandsSeriesSonificationTracksMapping()
		{
			Frequency = Frequency_DefaultValue = new AbandsSeriesSonificationTracksMappingFrequency();
			GapBetweenNotes = GapBetweenNotes_DefaultValue = new AbandsSeriesSonificationTracksMappingGapBetweenNotes();
			Highpass = Highpass_DefaultValue = new AbandsSeriesSonificationTracksMappingHighpass();
			Lowpass = Lowpass_DefaultValue = new AbandsSeriesSonificationTracksMappingLowpass();
			NoteDuration = NoteDuration_DefaultValue = new AbandsSeriesSonificationTracksMappingNoteDuration();
			Pan = Pan_DefaultValue = new AbandsSeriesSonificationTracksMappingPan();
			Pitch = Pitch_DefaultValue = new AbandsSeriesSonificationTracksMappingPitch();
			PitchString = PitchString_DefaultValue = "null";
			PitchNumber = PitchNumber_DefaultValue = null;
			PlayDelay = PlayDelay_DefaultValue = new AbandsSeriesSonificationTracksMappingPlayDelay();
			Time = Time_DefaultValue = new AbandsSeriesSonificationTracksMappingTime();
			TimeString = TimeString_DefaultValue = "null";
			TimeNumber = TimeNumber_DefaultValue = null;
			Tremolo = Tremolo_DefaultValue = new AbandsSeriesSonificationTracksMappingTremolo();
			Volume = Volume_DefaultValue = new AbandsSeriesSonificationTracksMappingVolume();
		...
		/// </summary>
		public AbandsSeriesSonificationTracksMappingFrequency Frequency { get; set; }
		private AbandsSeriesSonificationTracksMappingFrequency Frequency_DefaultValue { get; set; }
		...
		/// </summary>
		public AbandsSeriesSonificationTracksMappingGapBetweenNotes GapBetweenNotes { get; set; }
		private AbandsSeriesSonificationTracksMappingGapBetweenNotes GapBetweenNotes_DefaultValue { get; set; }
		...
		/// </summary>
		public AbandsSeriesSonificationTracksMappingHighpass Highpass { get; set; }
		private AbandsSeriesSonificationTracksMappingHighpass Highpass_DefaultValue { get; set; }
		...
		/// </summary>
		public AbandsSeriesSonificationTracksMappingLowpass Lowpass { get; set; }
		private AbandsSeriesSonificationTracksMappingLowpass Lowpass_DefaultValue { get; set; }
		...
		/// </summary>
		public AbandsSeriesSonificationTracksMappingNoteDuration NoteDuration { get; set; }
		private AbandsSeriesSonificationTracksMappingNoteDuration NoteDuration_DefaultValue { get; set; }
		...
		/// </summary>
		public AbandsSeriesSonificationTracksMappingPan Pan { get; set; }
		private AbandsSeriesSonificationTracksMappingPan Pan_DefaultValue { get; set; }
		...
		/// </summary>
		public AbandsSeriesSonificationTracksMappingPitch Pitch { get; set; }
		private AbandsSeriesSonificationTracksMappingPitch Pitch_DefaultValue { get; set; }
		...
		/// </summary>
		public AbandsSeriesSonificationTracksMappingPlayDelay PlayDelay { get; set; }
		private AbandsSeriesSonificationTracksMappingPlayDelay PlayDelay_DefaultValue { get; set; }
		...
		/// </summary>
		public AbandsSeriesSonificationTracksMappingTime Time { get; set; }
		private AbandsSeriesSonificationTracksMappingTime Time_DefaultValue { get; set; }
		...
		/// </summary>
		public AbandsSeriesSonificationTracksMappingTremolo Tremolo { get; set; }
		private AbandsSeriesSonificationTracksMappingTremolo Tremolo_DefaultValue { get; set; }
		 

		/// <summary>
		/// The volume of notes, from 0 to 1.
		/// </summary>
		public AbandsSeriesSonificationTracksMappingVolume Volume { get; set; }
		private AbandsSeriesSonificationTracksMappingVolume Volume_DefaultValue { get; set; }
