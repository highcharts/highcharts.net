...
{
	public partial class AbandsSeriesSonificationTracksMappingFrequency  : BaseObject
	{
		Hashtable h = new Hashtable();

		public AbandsSeriesSonificationTracksMappingFrequency()
		{
			MapFunction = MapFunction_DefaultValue = AbandsSeriesSonificationTracksMappingFrequencyMapFunction.Linear;
			MapTo = MapTo_DefaultValue = "";
			Max = Max_DefaultValue = null;
			Min = Min_DefaultValue = null;
			Value = Value_DefaultValue = null;
			Within = Within_DefaultValue = AbandsSeriesSonificationTracksMappingFrequencyWithin.Chart;
		...
		/// </summary>
		public AbandsSeriesSonificationTracksMappingFrequencyMapFunction MapFunction { get; set; }
		private AbandsSeriesSonificationTracksMappingFrequencyMapFunction MapFunction_DefaultValue { get; set; }
		...
		/// </summary>
		public AbandsSeriesSonificationTracksMappingFrequencyWithin Within { get; set; }
		private AbandsSeriesSonificationTracksMappingFrequencyWithin Within_DefaultValue { get; set; }
