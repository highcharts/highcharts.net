...
{
	public partial class AbandsSeriesSonificationTracksMappingNoteDuration  : BaseObject
	{
		Hashtable h = new Hashtable();

		public AbandsSeriesSonificationTracksMappingNoteDuration()
		{
			MapFunction = MapFunction_DefaultValue = AbandsSeriesSonificationTracksMappingNoteDurationMapFunction.Linear;
			MapTo = MapTo_DefaultValue = "";
			Max = Max_DefaultValue = null;
			Min = Min_DefaultValue = null;
			Value = Value_DefaultValue = null;
			Within = Within_DefaultValue = AbandsSeriesSonificationTracksMappingNoteDurationWithin.Chart;
		...
		/// </summary>
		public AbandsSeriesSonificationTracksMappingNoteDurationMapFunction MapFunction { get; set; }
		private AbandsSeriesSonificationTracksMappingNoteDurationMapFunction MapFunction_DefaultValue { get; set; }
		...
		/// </summary>
		public AbandsSeriesSonificationTracksMappingNoteDurationWithin Within { get; set; }
		private AbandsSeriesSonificationTracksMappingNoteDurationWithin Within_DefaultValue { get; set; }
