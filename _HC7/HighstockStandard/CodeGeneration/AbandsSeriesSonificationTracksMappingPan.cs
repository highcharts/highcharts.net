...
{
	public partial class AbandsSeriesSonificationTracksMappingPan  : BaseObject
	{
		Hashtable h = new Hashtable();

		public AbandsSeriesSonificationTracksMappingPan()
		{
			MapFunction = MapFunction_DefaultValue = AbandsSeriesSonificationTracksMappingPanMapFunction.Linear;
			MapTo = MapTo_DefaultValue = "";
			Max = Max_DefaultValue = null;
			Min = Min_DefaultValue = null;
			Value = Value_DefaultValue = null;
			Within = Within_DefaultValue = AbandsSeriesSonificationTracksMappingPanWithin.Chart;
		...
		/// </summary>
		public AbandsSeriesSonificationTracksMappingPanMapFunction MapFunction { get; set; }
		private AbandsSeriesSonificationTracksMappingPanMapFunction MapFunction_DefaultValue { get; set; }
		...
		/// </summary>
		public AbandsSeriesSonificationTracksMappingPanWithin Within { get; set; }
		private AbandsSeriesSonificationTracksMappingPanWithin Within_DefaultValue { get; set; }
