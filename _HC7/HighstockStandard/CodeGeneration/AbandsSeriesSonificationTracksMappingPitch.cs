...
{
	public partial class AbandsSeriesSonificationTracksMappingPitch  : BaseObject
	{
		Hashtable h = new Hashtable();

		public AbandsSeriesSonificationTracksMappingPitch()
		{
			MapFunction = MapFunction_DefaultValue = AbandsSeriesSonificationTracksMappingPitchMapFunction.Linear;
		...
		/// </summary>
		public AbandsSeriesSonificationTracksMappingPitchMapFunction MapFunction { get; set; }
		private AbandsSeriesSonificationTracksMappingPitchMapFunction MapFunction_DefaultValue { get; set; }
