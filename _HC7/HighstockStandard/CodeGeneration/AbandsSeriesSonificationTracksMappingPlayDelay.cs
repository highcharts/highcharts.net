...
{
	public partial class AbandsSeriesSonificationTracksMappingPlayDelay  : BaseObject
	{
		Hashtable h = new Hashtable();

		public AbandsSeriesSonificationTracksMappingPlayDelay()
		{
			MapFunction = MapFunction_DefaultValue = AbandsSeriesSonificationTracksMappingPlayDelayMapFunction.Linear;
			MapTo = MapTo_DefaultValue = "";
			Max = Max_DefaultValue = null;
			Min = Min_DefaultValue = null;
			Value = Value_DefaultValue = null;
			Within = Within_DefaultValue = AbandsSeriesSonificationTracksMappingPlayDelayWithin.Chart;
		...
		/// </summary>
		public AbandsSeriesSonificationTracksMappingPlayDelayMapFunction MapFunction { get; set; }
		private AbandsSeriesSonificationTracksMappingPlayDelayMapFunction MapFunction_DefaultValue { get; set; }
		...
		/// </summary>
		public AbandsSeriesSonificationTracksMappingPlayDelayWithin Within { get; set; }
		private AbandsSeriesSonificationTracksMappingPlayDelayWithin Within_DefaultValue { get; set; }
