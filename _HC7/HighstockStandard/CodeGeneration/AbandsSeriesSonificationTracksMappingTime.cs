...
{
	public partial class AbandsSeriesSonificationTracksMappingTime  : BaseObject
	{
		Hashtable h = new Hashtable();

		public AbandsSeriesSonificationTracksMappingTime()
		{
			MapFunction = MapFunction_DefaultValue = AbandsSeriesSonificationTracksMappingTimeMapFunction.Linear;
			MapTo = MapTo_DefaultValue = "";
			Max = Max_DefaultValue = null;
			Min = Min_DefaultValue = null;
			Value = Value_DefaultValue = null;
			Within = Within_DefaultValue = AbandsSeriesSonificationTracksMappingTimeWithin.Chart;
		...
		/// </summary>
		public AbandsSeriesSonificationTracksMappingTimeMapFunction MapFunction { get; set; }
		private AbandsSeriesSonificationTracksMappingTimeMapFunction MapFunction_DefaultValue { get; set; }
		...
		/// </summary>
		public AbandsSeriesSonificationTracksMappingTimeWithin Within { get; set; }
		private AbandsSeriesSonificationTracksMappingTimeWithin Within_DefaultValue { get; set; }
