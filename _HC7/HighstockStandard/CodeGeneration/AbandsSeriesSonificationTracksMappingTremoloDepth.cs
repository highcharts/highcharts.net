...
{
	public partial class AbandsSeriesSonificationTracksMappingTremoloDepth  : BaseObject
	{
		Hashtable h = new Hashtable();

		public AbandsSeriesSonificationTracksMappingTremoloDepth()
		{
			MapFunction = MapFunction_DefaultValue = AbandsSeriesSonificationTracksMappingTremoloDepthMapFunction.Linear;
			MapTo = MapTo_DefaultValue = "";
			Max = Max_DefaultValue = null;
			Min = Min_DefaultValue = null;
			Value = Value_DefaultValue = null;
			Within = Within_DefaultValue = AbandsSeriesSonificationTracksMappingTremoloDepthWithin.Chart;
		...
		/// </summary>
		public AbandsSeriesSonificationTracksMappingTremoloDepthMapFunction MapFunction { get; set; }
		private AbandsSeriesSonificationTracksMappingTremoloDepthMapFunction MapFunction_DefaultValue { get; set; }
		...
		/// </summary>
		public AbandsSeriesSonificationTracksMappingTremoloDepthWithin Within { get; set; }
		private AbandsSeriesSonificationTracksMappingTremoloDepthWithin Within_DefaultValue { get; set; }
