...
{
	public partial class AbandsSeriesSonificationTracksMappingTremoloSpeed  : BaseObject
	{
		Hashtable h = new Hashtable();

		public AbandsSeriesSonificationTracksMappingTremoloSpeed()
		{
			MapFunction = MapFunction_DefaultValue = AbandsSeriesSonificationTracksMappingTremoloSpeedMapFunction.Linear;
			MapTo = MapTo_DefaultValue = "";
			Max = Max_DefaultValue = null;
			Min = Min_DefaultValue = null;
			Value = Value_DefaultValue = null;
			Within = Within_DefaultValue = AbandsSeriesSonificationTracksMappingTremoloSpeedWithin.Chart;
		...
		/// </summary>
		public AbandsSeriesSonificationTracksMappingTremoloSpeedMapFunction MapFunction { get; set; }
		private AbandsSeriesSonificationTracksMappingTremoloSpeedMapFunction MapFunction_DefaultValue { get; set; }
		...
		/// </summary>
		public AbandsSeriesSonificationTracksMappingTremoloSpeedWithin Within { get; set; }
		private AbandsSeriesSonificationTracksMappingTremoloSpeedWithin Within_DefaultValue { get; set; }
