...
{
	public partial class AbandsSeriesStatesSelect  : BaseObject
	{
		Hashtable h = new Hashtable();

		public AbandsSeriesStatesSelect()
		{
			Animation = Animation_DefaultValue = new Animation() { Enabled = true };
			Enabled = Enabled_DefaultValue = null;
			Halo = Halo_DefaultValue = new AbandsSeriesStatesSelectHalo();
			LineWidth = LineWidth_DefaultValue = null;
			LineWidthPlus = LineWidthPlus_DefaultValue = null;
			Marker = Marker_DefaultValue = new AbandsSeriesStatesSelectMarker();
		...
		/// </summary>
		public AbandsSeriesStatesSelectHalo Halo { get; set; }
		private AbandsSeriesStatesSelectHalo Halo_DefaultValue { get; set; }
		...
		/// </summary>
		public AbandsSeriesStatesSelectMarker Marker { get; set; }
		private AbandsSeriesStatesSelectMarker Marker_DefaultValue { get; set; }
