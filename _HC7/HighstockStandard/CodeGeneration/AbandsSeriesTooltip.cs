...
{
	public partial class AbandsSeriesTooltip  : BaseObject
	{
		public AbandsSeriesTooltip()
		{
			...
			HeaderShape = HeaderShape_DefaultValue = AbandsSeriesTooltipHeaderShape.Callout;
		...
		/// </summary>
		public AbandsSeriesTooltipHeaderShape HeaderShape { get; set; }
		private AbandsSeriesTooltipHeaderShape HeaderShape_DefaultValue { get; set; }
		...
		internal override Hashtable ToHashtable()
		{
			...
			if (NullFormatter != NullFormatter_DefaultValue) { h.Add("nullFormatter",NullFormatter); Highstock.AddFunction("AbandsSeriesTooltipNullFormatter.nullFormatter", NullFormatter); }  
			if (Outside != Outside_DefaultValue) h.Add("outside",Outside);
			if (Padding != Padding_DefaultValue) h.Add("padding",Padding);
			if (PointFormat != PointFormat_DefaultValue) h.Add("pointFormat",PointFormat);
			if (PointFormatter != PointFormatter_DefaultValue) { h.Add("pointFormatter",PointFormatter); Highstock.AddFunction("AbandsSeriesTooltipPointFormatter.pointFormatter", PointFormatter); }  
