...
namespace Highsoft.Web.Mvc.Stocks
{
	public partial class AccessibilityScreenReaderSection  : BaseObject
	{
		...
		internal override Hashtable ToHashtable(Highstock highstock)
		{
			...
			if (AfterChartFormatter != null) { h.Add("afterChartFormatter",AfterChartFormatter); highstock.AddFunction("afterChartFormatter", AfterChartFormatter); }  
			...
			if (BeforeChartFormatter != null) { h.Add("beforeChartFormatter",BeforeChartFormatter); highstock.AddFunction("beforeChartFormatter", BeforeChartFormatter); }  
			if (OnPlayAsSoundClick != null) { h.Add("onPlayAsSoundClick",OnPlayAsSoundClick); highstock.AddFunction("onPlayAsSoundClick", OnPlayAsSoundClick); }  
			if (OnViewDataTableClick != null) { h.Add("onViewDataTableClick",OnViewDataTableClick); highstock.AddFunction("onViewDataTableClick", OnViewDataTableClick); }  
