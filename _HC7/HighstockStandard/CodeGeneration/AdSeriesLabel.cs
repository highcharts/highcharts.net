...
{
	public partial class AdSeriesLabel  : BaseObject
	{
		public AdSeriesLabel()
		{
			...
			Style = Style_DefaultValue = new AdSeriesLabelStyle();
		...
		/// </summary>
		public AdSeriesLabelStyle Style { get; set; }
		private AdSeriesLabelStyle Style_DefaultValue { get; set; }
