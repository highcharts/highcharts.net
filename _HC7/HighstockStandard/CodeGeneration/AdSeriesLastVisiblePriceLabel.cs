...
{
	public partial class AdSeriesLastVisiblePriceLabel  : BaseObject
	{
		Hashtable h = new Hashtable();

		public AdSeriesLastVisiblePriceLabel()
		{
			Align = Align_DefaultValue = AdSeriesLastVisiblePriceLabelAlign.Null;
		...
		/// 
		/// </summary>
		public AdSeriesLastVisiblePriceLabelAlign Align { get; set; }
		private AdSeriesLastVisiblePriceLabelAlign Align_DefaultValue { get; set; }
