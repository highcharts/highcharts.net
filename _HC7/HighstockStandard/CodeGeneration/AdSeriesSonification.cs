...
{
	public partial class AdSeriesSonification  : BaseObject
	{
		Hashtable h = new Hashtable();

		public AdSeriesSonification()
		{
		}	
		...
		/// </summary>
		public AdSeriesSonificationContextTracks ContextTracks { get; set; }
		 

		/// <summary>
		/// Default options for all this series' instrument tracks.
		/// </summary>
		public AdSeriesSonificationDefaultInstrumentOptions DefaultInstrumentOptions { get; set; }
		 

		/// <summary>
		/// Default options for all this series' speech tracks.
		/// </summary>
		public AdSeriesSonificationDefaultSpeechOptions DefaultSpeechOptions { get; set; }
		...
		/// </summary>
		public AdSeriesSonificationPointGrouping PointGrouping { get; set; }
		 

		/// <summary>
		/// Tracks for this series.Given as an array of instrument tracks, speech tracks, or a mix of both.
		/// </summary>
		public AdSeriesSonificationTracks Tracks { get; set; }
