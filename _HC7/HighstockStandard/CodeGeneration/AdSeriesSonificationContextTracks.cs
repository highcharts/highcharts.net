...
{
	public partial class AdSeriesSonificationContextTracks  : BaseObject
	{
		Hashtable h = new Hashtable();

		public AdSeriesSonificationContextTracks()
		{
			ActiveWhen = ActiveWhen_DefaultValue = new AdSeriesSonificationContextTracksActiveWhen();
			Instrument = Instrument_DefaultValue = null;
			InstrumentString = InstrumentString_DefaultValue = "null";
			Mapping = Mapping_DefaultValue = new AdSeriesSonificationContextTracksMapping();
			MidiName = MidiName_DefaultValue = "";
			PointGrouping = PointGrouping_DefaultValue = new AdSeriesSonificationContextTracksPointGrouping();
			...
			Type = Type_DefaultValue = AdSeriesSonificationContextTracksType.Instrument;
			ValueInterval = ValueInterval_DefaultValue = null;
			ValueMapFunction = ValueMapFunction_DefaultValue = AdSeriesSonificationContextTracksValueMapFunction.Linear;
		...
		/// </summary>
		public AdSeriesSonificationContextTracksActiveWhen ActiveWhen { get; set; }
		private AdSeriesSonificationContextTracksActiveWhen ActiveWhen_DefaultValue { get; set; }
		...
		/// </summary>
		public AdSeriesSonificationContextTracksMapping Mapping { get; set; }
		private AdSeriesSonificationContextTracksMapping Mapping_DefaultValue { get; set; }
		...
		/// </summary>
		public AdSeriesSonificationContextTracksPointGrouping PointGrouping { get; set; }
		private AdSeriesSonificationContextTracksPointGrouping PointGrouping_DefaultValue { get; set; }
		...
		/// </summary>
		public AdSeriesSonificationContextTracksType Type { get; set; }
		private AdSeriesSonificationContextTracksType Type_DefaultValue { get; set; }
		...
		/// </summary>
		public AdSeriesSonificationContextTracksValueMapFunction ValueMapFunction { get; set; }
		private AdSeriesSonificationContextTracksValueMapFunction ValueMapFunction_DefaultValue { get; set; }
