...
{
	public partial class AdSeriesSonificationContextTracksMappingFrequency  : BaseObject
	{
		Hashtable h = new Hashtable();

		public AdSeriesSonificationContextTracksMappingFrequency()
		{
			MapFunction = MapFunction_DefaultValue = AdSeriesSonificationContextTracksMappingFrequencyMapFunction.Linear;
			MapTo = MapTo_DefaultValue = "";
			Max = Max_DefaultValue = null;
			Min = Min_DefaultValue = null;
			Value = Value_DefaultValue = null;
			Within = Within_DefaultValue = AdSeriesSonificationContextTracksMappingFrequencyWithin.Chart;
		...
		/// </summary>
		public AdSeriesSonificationContextTracksMappingFrequencyMapFunction MapFunction { get; set; }
		private AdSeriesSonificationContextTracksMappingFrequencyMapFunction MapFunction_DefaultValue { get; set; }
		...
		/// </summary>
		public AdSeriesSonificationContextTracksMappingFrequencyWithin Within { get; set; }
		private AdSeriesSonificationContextTracksMappingFrequencyWithin Within_DefaultValue { get; set; }
