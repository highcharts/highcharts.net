...
{
	public partial class AdSeriesSonificationContextTracksMappingPan  : BaseObject
	{
		Hashtable h = new Hashtable();

		public AdSeriesSonificationContextTracksMappingPan()
		{
			MapFunction = MapFunction_DefaultValue = AdSeriesSonificationContextTracksMappingPanMapFunction.Linear;
			MapTo = MapTo_DefaultValue = "";
			Max = Max_DefaultValue = null;
			Min = Min_DefaultValue = null;
			Value = Value_DefaultValue = null;
			Within = Within_DefaultValue = AdSeriesSonificationContextTracksMappingPanWithin.Chart;
		...
		/// </summary>
		public AdSeriesSonificationContextTracksMappingPanMapFunction MapFunction { get; set; }
		private AdSeriesSonificationContextTracksMappingPanMapFunction MapFunction_DefaultValue { get; set; }
		...
		/// </summary>
		public AdSeriesSonificationContextTracksMappingPanWithin Within { get; set; }
		private AdSeriesSonificationContextTracksMappingPanWithin Within_DefaultValue { get; set; }
