...
{
	public partial class AdSeriesSonificationContextTracksMappingPlayDelay  : BaseObject
	{
		Hashtable h = new Hashtable();

		public AdSeriesSonificationContextTracksMappingPlayDelay()
		{
			MapFunction = MapFunction_DefaultValue = AdSeriesSonificationContextTracksMappingPlayDelayMapFunction.Linear;
			MapTo = MapTo_DefaultValue = "";
			Max = Max_DefaultValue = null;
			Min = Min_DefaultValue = null;
			Value = Value_DefaultValue = null;
			Within = Within_DefaultValue = AdSeriesSonificationContextTracksMappingPlayDelayWithin.Chart;
		...
		/// </summary>
		public AdSeriesSonificationContextTracksMappingPlayDelayMapFunction MapFunction { get; set; }
		private AdSeriesSonificationContextTracksMappingPlayDelayMapFunction MapFunction_DefaultValue { get; set; }
		...
		/// </summary>
		public AdSeriesSonificationContextTracksMappingPlayDelayWithin Within { get; set; }
		private AdSeriesSonificationContextTracksMappingPlayDelayWithin Within_DefaultValue { get; set; }
