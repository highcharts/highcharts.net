...
{
	public partial class AdSeriesSonificationContextTracksMappingTime  : BaseObject
	{
		Hashtable h = new Hashtable();

		public AdSeriesSonificationContextTracksMappingTime()
		{
			MapFunction = MapFunction_DefaultValue = AdSeriesSonificationContextTracksMappingTimeMapFunction.Linear;
			MapTo = MapTo_DefaultValue = "";
			Max = Max_DefaultValue = null;
			Min = Min_DefaultValue = null;
			Value = Value_DefaultValue = null;
			Within = Within_DefaultValue = AdSeriesSonificationContextTracksMappingTimeWithin.Chart;
		...
		/// </summary>
		public AdSeriesSonificationContextTracksMappingTimeMapFunction MapFunction { get; set; }
		private AdSeriesSonificationContextTracksMappingTimeMapFunction MapFunction_DefaultValue { get; set; }
		...
		/// </summary>
		public AdSeriesSonificationContextTracksMappingTimeWithin Within { get; set; }
		private AdSeriesSonificationContextTracksMappingTimeWithin Within_DefaultValue { get; set; }
