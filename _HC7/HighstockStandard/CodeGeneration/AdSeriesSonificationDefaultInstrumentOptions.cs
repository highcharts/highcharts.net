...
{
	public partial class AdSeriesSonificationDefaultInstrumentOptions  : BaseObject
	{
		Hashtable h = new Hashtable();

		public AdSeriesSonificationDefaultInstrumentOptions()
		{
			ActiveWhen = ActiveWhen_DefaultValue = new AdSeriesSonificationDefaultInstrumentOptionsActiveWhen();
			Instrument = Instrument_DefaultValue = null;
			InstrumentString = InstrumentString_DefaultValue = "null";
			Mapping = Mapping_DefaultValue = new AdSeriesSonificationDefaultInstrumentOptionsMapping();
			MidiName = MidiName_DefaultValue = "";
			PointGrouping = PointGrouping_DefaultValue = new AdSeriesSonificationDefaultInstrumentOptionsPointGrouping();
			RoundToMusicalNotes = RoundToMusicalNotes_DefaultValue = true;
			ShowPlayMarker = ShowPlayMarker_DefaultValue = true;
			Type = Type_DefaultValue = AdSeriesSonificationDefaultInstrumentOptionsType.Instrument;
		...
		/// </summary>
		public AdSeriesSonificationDefaultInstrumentOptionsActiveWhen ActiveWhen { get; set; }
		private AdSeriesSonificationDefaultInstrumentOptionsActiveWhen ActiveWhen_DefaultValue { get; set; }
		...
		/// </summary>
		public AdSeriesSonificationDefaultInstrumentOptionsMapping Mapping { get; set; }
		private AdSeriesSonificationDefaultInstrumentOptionsMapping Mapping_DefaultValue { get; set; }
		...
		/// </summary>
		public AdSeriesSonificationDefaultInstrumentOptionsPointGrouping PointGrouping { get; set; }
		private AdSeriesSonificationDefaultInstrumentOptionsPointGrouping PointGrouping_DefaultValue { get; set; }
		...
		/// </summary>
		public AdSeriesSonificationDefaultInstrumentOptionsType Type { get; set; }
		private AdSeriesSonificationDefaultInstrumentOptionsType Type_DefaultValue { get; set; }
