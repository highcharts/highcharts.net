...
{
	public partial class AdSeriesSonificationDefaultSpeechOptionsMapping  : BaseObject
	{
		Hashtable h = new Hashtable();

		public AdSeriesSonificationDefaultSpeechOptionsMapping()
		{
			Frequency = Frequency_DefaultValue = new AdSeriesSonificationDefaultSpeechOptionsMappingFrequency();
			GapBetweenNotes = GapBetweenNotes_DefaultValue = new AdSeriesSonificationDefaultSpeechOptionsMappingGapBetweenNotes();
			Highpass = Highpass_DefaultValue = new AdSeriesSonificationDefaultSpeechOptionsMappingHighpass();
			Lowpass = Lowpass_DefaultValue = new AdSeriesSonificationDefaultSpeechOptionsMappingLowpass();
			NoteDuration = NoteDuration_DefaultValue = new AdSeriesSonificationDefaultSpeechOptionsMappingNoteDuration();
			Pan = Pan_DefaultValue = new AdSeriesSonificationDefaultSpeechOptionsMappingPan();
			Pitch = Pitch_DefaultValue = new AdSeriesSonificationDefaultSpeechOptionsMappingPitch();
			PitchString = PitchString_DefaultValue = "null";
			PitchNumber = PitchNumber_DefaultValue = null;
			PlayDelay = PlayDelay_DefaultValue = new AdSeriesSonificationDefaultSpeechOptionsMappingPlayDelay();
			Time = Time_DefaultValue = new AdSeriesSonificationDefaultSpeechOptionsMappingTime();
			TimeString = TimeString_DefaultValue = "null";
			TimeNumber = TimeNumber_DefaultValue = null;
			Tremolo = Tremolo_DefaultValue = new AdSeriesSonificationDefaultSpeechOptionsMappingTremolo();
			Volume = Volume_DefaultValue = new AdSeriesSonificationDefaultSpeechOptionsMappingVolume();
		...
		/// </summary>
		public AdSeriesSonificationDefaultSpeechOptionsMappingFrequency Frequency { get; set; }
		private AdSeriesSonificationDefaultSpeechOptionsMappingFrequency Frequency_DefaultValue { get; set; }
		...
		/// </summary>
		public AdSeriesSonificationDefaultSpeechOptionsMappingGapBetweenNotes GapBetweenNotes { get; set; }
		private AdSeriesSonificationDefaultSpeechOptionsMappingGapBetweenNotes GapBetweenNotes_DefaultValue { get; set; }
		...
		/// </summary>
		public AdSeriesSonificationDefaultSpeechOptionsMappingHighpass Highpass { get; set; }
		private AdSeriesSonificationDefaultSpeechOptionsMappingHighpass Highpass_DefaultValue { get; set; }
		...
		/// </summary>
		public AdSeriesSonificationDefaultSpeechOptionsMappingLowpass Lowpass { get; set; }
		private AdSeriesSonificationDefaultSpeechOptionsMappingLowpass Lowpass_DefaultValue { get; set; }
		...
		/// </summary>
		public AdSeriesSonificationDefaultSpeechOptionsMappingNoteDuration NoteDuration { get; set; }
		private AdSeriesSonificationDefaultSpeechOptionsMappingNoteDuration NoteDuration_DefaultValue { get; set; }
		...
		/// </summary>
		public AdSeriesSonificationDefaultSpeechOptionsMappingPan Pan { get; set; }
		private AdSeriesSonificationDefaultSpeechOptionsMappingPan Pan_DefaultValue { get; set; }
		...
		/// </summary>
		public AdSeriesSonificationDefaultSpeechOptionsMappingPitch Pitch { get; set; }
		private AdSeriesSonificationDefaultSpeechOptionsMappingPitch Pitch_DefaultValue { get; set; }
		...
		/// </summary>
		public AdSeriesSonificationDefaultSpeechOptionsMappingPlayDelay PlayDelay { get; set; }
		private AdSeriesSonificationDefaultSpeechOptionsMappingPlayDelay PlayDelay_DefaultValue { get; set; }
		...
		/// </summary>
		public AdSeriesSonificationDefaultSpeechOptionsMappingTime Time { get; set; }
		private AdSeriesSonificationDefaultSpeechOptionsMappingTime Time_DefaultValue { get; set; }
		...
		/// </summary>
		public AdSeriesSonificationDefaultSpeechOptionsMappingTremolo Tremolo { get; set; }
		private AdSeriesSonificationDefaultSpeechOptionsMappingTremolo Tremolo_DefaultValue { get; set; }
		 

		/// <summary>
		/// The volume of notes, from 0 to 1.
		/// </summary>
		public AdSeriesSonificationDefaultSpeechOptionsMappingVolume Volume { get; set; }
		private AdSeriesSonificationDefaultSpeechOptionsMappingVolume Volume_DefaultValue { get; set; }
