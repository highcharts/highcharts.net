...
{
	public partial class AdSeriesSonificationDefaultSpeechOptionsMappingTime  : BaseObject
	{
		Hashtable h = new Hashtable();

		public AdSeriesSonificationDefaultSpeechOptionsMappingTime()
		{
			MapFunction = MapFunction_DefaultValue = AdSeriesSonificationDefaultSpeechOptionsMappingTimeMapFunction.Linear;
			MapTo = MapTo_DefaultValue = "";
			Max = Max_DefaultValue = null;
			Min = Min_DefaultValue = null;
			Value = Value_DefaultValue = null;
			Within = Within_DefaultValue = AdSeriesSonificationDefaultSpeechOptionsMappingTimeWithin.Chart;
		...
		/// </summary>
		public AdSeriesSonificationDefaultSpeechOptionsMappingTimeMapFunction MapFunction { get; set; }
		private AdSeriesSonificationDefaultSpeechOptionsMappingTimeMapFunction MapFunction_DefaultValue { get; set; }
		...
		/// </summary>
		public AdSeriesSonificationDefaultSpeechOptionsMappingTimeWithin Within { get; set; }
		private AdSeriesSonificationDefaultSpeechOptionsMappingTimeWithin Within_DefaultValue { get; set; }
