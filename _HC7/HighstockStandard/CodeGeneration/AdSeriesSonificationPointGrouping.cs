...
{
	public partial class AdSeriesSonificationPointGrouping  : BaseObject
	{
		Hashtable h = new Hashtable();

		public AdSeriesSonificationPointGrouping()
		{
			Algorithm = Algorithm_DefaultValue = AdSeriesSonificationPointGroupingAlgorithm.Minimax;
		...
		/// </summary>
		public AdSeriesSonificationPointGroupingAlgorithm Algorithm { get; set; }
		private AdSeriesSonificationPointGroupingAlgorithm Algorithm_DefaultValue { get; set; }
