...
{
	public partial class AdSeriesSonificationTracks  : BaseObject
	{
		Hashtable h = new Hashtable();

		public AdSeriesSonificationTracks()
		{
			ActiveWhen = ActiveWhen_DefaultValue = new AdSeriesSonificationTracksActiveWhen();
			Instrument = Instrument_DefaultValue = null;
			InstrumentString = InstrumentString_DefaultValue = "null";
			Mapping = Mapping_DefaultValue = new AdSeriesSonificationTracksMapping();
			MidiName = MidiName_DefaultValue = "";
			PointGrouping = PointGrouping_DefaultValue = new AdSeriesSonificationTracksPointGrouping();
			RoundToMusicalNotes = RoundToMusicalNotes_DefaultValue = true;
			ShowPlayMarker = ShowPlayMarker_DefaultValue = true;
			Type = Type_DefaultValue = AdSeriesSonificationTracksType.Instrument;
		...
		/// </summary>
		public AdSeriesSonificationTracksActiveWhen ActiveWhen { get; set; }
		private AdSeriesSonificationTracksActiveWhen ActiveWhen_DefaultValue { get; set; }
		...
		/// </summary>
		public AdSeriesSonificationTracksMapping Mapping { get; set; }
		private AdSeriesSonificationTracksMapping Mapping_DefaultValue { get; set; }
		...
		/// </summary>
		public AdSeriesSonificationTracksPointGrouping PointGrouping { get; set; }
		private AdSeriesSonificationTracksPointGrouping PointGrouping_DefaultValue { get; set; }
		...
		/// </summary>
		public AdSeriesSonificationTracksType Type { get; set; }
		private AdSeriesSonificationTracksType Type_DefaultValue { get; set; }
