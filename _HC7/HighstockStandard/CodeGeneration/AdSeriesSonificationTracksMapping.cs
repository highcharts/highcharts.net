...
{
	public partial class AdSeriesSonificationTracksMapping  : BaseObject
	{
		Hashtable h = new Hashtable();

		public AdSeriesSonificationTracksMapping()
		{
			Frequency = Frequency_DefaultValue = new AdSeriesSonificationTracksMappingFrequency();
			GapBetweenNotes = GapBetweenNotes_DefaultValue = new AdSeriesSonificationTracksMappingGapBetweenNotes();
			Highpass = Highpass_DefaultValue = new AdSeriesSonificationTracksMappingHighpass();
			Lowpass = Lowpass_DefaultValue = new AdSeriesSonificationTracksMappingLowpass();
			NoteDuration = NoteDuration_DefaultValue = new AdSeriesSonificationTracksMappingNoteDuration();
			Pan = Pan_DefaultValue = new AdSeriesSonificationTracksMappingPan();
			Pitch = Pitch_DefaultValue = new AdSeriesSonificationTracksMappingPitch();
			PitchString = PitchString_DefaultValue = "null";
			PitchNumber = PitchNumber_DefaultValue = null;
			PlayDelay = PlayDelay_DefaultValue = new AdSeriesSonificationTracksMappingPlayDelay();
			Time = Time_DefaultValue = new AdSeriesSonificationTracksMappingTime();
			TimeString = TimeString_DefaultValue = "null";
			TimeNumber = TimeNumber_DefaultValue = null;
			Tremolo = Tremolo_DefaultValue = new AdSeriesSonificationTracksMappingTremolo();
			Volume = Volume_DefaultValue = new AdSeriesSonificationTracksMappingVolume();
		...
		/// </summary>
		public AdSeriesSonificationTracksMappingFrequency Frequency { get; set; }
		private AdSeriesSonificationTracksMappingFrequency Frequency_DefaultValue { get; set; }
		...
		/// </summary>
		public AdSeriesSonificationTracksMappingGapBetweenNotes GapBetweenNotes { get; set; }
		private AdSeriesSonificationTracksMappingGapBetweenNotes GapBetweenNotes_DefaultValue { get; set; }
		...
		/// </summary>
		public AdSeriesSonificationTracksMappingHighpass Highpass { get; set; }
		private AdSeriesSonificationTracksMappingHighpass Highpass_DefaultValue { get; set; }
		...
		/// </summary>
		public AdSeriesSonificationTracksMappingLowpass Lowpass { get; set; }
		private AdSeriesSonificationTracksMappingLowpass Lowpass_DefaultValue { get; set; }
		...
		/// </summary>
		public AdSeriesSonificationTracksMappingNoteDuration NoteDuration { get; set; }
		private AdSeriesSonificationTracksMappingNoteDuration NoteDuration_DefaultValue { get; set; }
		...
		/// </summary>
		public AdSeriesSonificationTracksMappingPan Pan { get; set; }
		private AdSeriesSonificationTracksMappingPan Pan_DefaultValue { get; set; }
		...
		/// </summary>
		public AdSeriesSonificationTracksMappingPitch Pitch { get; set; }
		private AdSeriesSonificationTracksMappingPitch Pitch_DefaultValue { get; set; }
		...
		/// </summary>
		public AdSeriesSonificationTracksMappingPlayDelay PlayDelay { get; set; }
		private AdSeriesSonificationTracksMappingPlayDelay PlayDelay_DefaultValue { get; set; }
		...
		/// </summary>
		public AdSeriesSonificationTracksMappingTime Time { get; set; }
		private AdSeriesSonificationTracksMappingTime Time_DefaultValue { get; set; }
		...
		/// </summary>
		public AdSeriesSonificationTracksMappingTremolo Tremolo { get; set; }
		private AdSeriesSonificationTracksMappingTremolo Tremolo_DefaultValue { get; set; }
		 

		/// <summary>
		/// The volume of notes, from 0 to 1.
		/// </summary>
		public AdSeriesSonificationTracksMappingVolume Volume { get; set; }
		private AdSeriesSonificationTracksMappingVolume Volume_DefaultValue { get; set; }
