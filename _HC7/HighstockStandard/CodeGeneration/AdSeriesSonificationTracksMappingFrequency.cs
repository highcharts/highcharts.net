...
{
	public partial class AdSeriesSonificationTracksMappingFrequency  : BaseObject
	{
		Hashtable h = new Hashtable();

		public AdSeriesSonificationTracksMappingFrequency()
		{
			MapFunction = MapFunction_DefaultValue = AdSeriesSonificationTracksMappingFrequencyMapFunction.Linear;
			MapTo = MapTo_DefaultValue = "";
			Max = Max_DefaultValue = null;
			Min = Min_DefaultValue = null;
			Value = Value_DefaultValue = null;
			Within = Within_DefaultValue = AdSeriesSonificationTracksMappingFrequencyWithin.Chart;
		...
		/// </summary>
		public AdSeriesSonificationTracksMappingFrequencyMapFunction MapFunction { get; set; }
		private AdSeriesSonificationTracksMappingFrequencyMapFunction MapFunction_DefaultValue { get; set; }
		...
		/// </summary>
		public AdSeriesSonificationTracksMappingFrequencyWithin Within { get; set; }
		private AdSeriesSonificationTracksMappingFrequencyWithin Within_DefaultValue { get; set; }
