...
{
	public partial class AdSeriesSonificationTracksMappingLowpassResonance  : BaseObject
	{
		Hashtable h = new Hashtable();

		public AdSeriesSonificationTracksMappingLowpassResonance()
		{
			MapFunction = MapFunction_DefaultValue = AdSeriesSonificationTracksMappingLowpassResonanceMapFunction.Linear;
			MapTo = MapTo_DefaultValue = "";
			Max = Max_DefaultValue = null;
			Min = Min_DefaultValue = null;
			Value = Value_DefaultValue = null;
			Within = Within_DefaultValue = AdSeriesSonificationTracksMappingLowpassResonanceWithin.Chart;
		...
		/// </summary>
		public AdSeriesSonificationTracksMappingLowpassResonanceMapFunction MapFunction { get; set; }
		private AdSeriesSonificationTracksMappingLowpassResonanceMapFunction MapFunction_DefaultValue { get; set; }
		...
		/// </summary>
		public AdSeriesSonificationTracksMappingLowpassResonanceWithin Within { get; set; }
		private AdSeriesSonificationTracksMappingLowpassResonanceWithin Within_DefaultValue { get; set; }
