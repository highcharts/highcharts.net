...
{
	public partial class AdSeriesSonificationTracksMappingNoteDuration  : BaseObject
	{
		Hashtable h = new Hashtable();

		public AdSeriesSonificationTracksMappingNoteDuration()
		{
			MapFunction = MapFunction_DefaultValue = AdSeriesSonificationTracksMappingNoteDurationMapFunction.Linear;
			MapTo = MapTo_DefaultValue = "";
			Max = Max_DefaultValue = null;
			Min = Min_DefaultValue = null;
			Value = Value_DefaultValue = null;
			Within = Within_DefaultValue = AdSeriesSonificationTracksMappingNoteDurationWithin.Chart;
		...
		/// </summary>
		public AdSeriesSonificationTracksMappingNoteDurationMapFunction MapFunction { get; set; }
		private AdSeriesSonificationTracksMappingNoteDurationMapFunction MapFunction_DefaultValue { get; set; }
		...
		/// </summary>
		public AdSeriesSonificationTracksMappingNoteDurationWithin Within { get; set; }
		private AdSeriesSonificationTracksMappingNoteDurationWithin Within_DefaultValue { get; set; }
