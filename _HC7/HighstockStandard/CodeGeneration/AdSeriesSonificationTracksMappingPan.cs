...
{
	public partial class AdSeriesSonificationTracksMappingPan  : BaseObject
	{
		Hashtable h = new Hashtable();

		public AdSeriesSonificationTracksMappingPan()
		{
			MapFunction = MapFunction_DefaultValue = AdSeriesSonificationTracksMappingPanMapFunction.Linear;
			MapTo = MapTo_DefaultValue = "";
			Max = Max_DefaultValue = null;
			Min = Min_DefaultValue = null;
			Value = Value_DefaultValue = null;
			Within = Within_DefaultValue = AdSeriesSonificationTracksMappingPanWithin.Chart;
		...
		/// </summary>
		public AdSeriesSonificationTracksMappingPanMapFunction MapFunction { get; set; }
		private AdSeriesSonificationTracksMappingPanMapFunction MapFunction_DefaultValue { get; set; }
		...
		/// </summary>
		public AdSeriesSonificationTracksMappingPanWithin Within { get; set; }
		private AdSeriesSonificationTracksMappingPanWithin Within_DefaultValue { get; set; }
