...
{
	public partial class AdSeriesSonificationTracksMappingPitch  : BaseObject
	{
		Hashtable h = new Hashtable();

		public AdSeriesSonificationTracksMappingPitch()
		{
			MapFunction = MapFunction_DefaultValue = AdSeriesSonificationTracksMappingPitchMapFunction.Linear;
		...
		/// </summary>
		public AdSeriesSonificationTracksMappingPitchMapFunction MapFunction { get; set; }
		private AdSeriesSonificationTracksMappingPitchMapFunction MapFunction_DefaultValue { get; set; }
