...
{
	public partial class AdSeriesSonificationTracksMappingPlayDelay  : BaseObject
	{
		Hashtable h = new Hashtable();

		public AdSeriesSonificationTracksMappingPlayDelay()
		{
			MapFunction = MapFunction_DefaultValue = AdSeriesSonificationTracksMappingPlayDelayMapFunction.Linear;
			MapTo = MapTo_DefaultValue = "";
			Max = Max_DefaultValue = null;
			Min = Min_DefaultValue = null;
			Value = Value_DefaultValue = null;
			Within = Within_DefaultValue = AdSeriesSonificationTracksMappingPlayDelayWithin.Chart;
		...
		/// </summary>
		public AdSeriesSonificationTracksMappingPlayDelayMapFunction MapFunction { get; set; }
		private AdSeriesSonificationTracksMappingPlayDelayMapFunction MapFunction_DefaultValue { get; set; }
		...
		/// </summary>
		public AdSeriesSonificationTracksMappingPlayDelayWithin Within { get; set; }
		private AdSeriesSonificationTracksMappingPlayDelayWithin Within_DefaultValue { get; set; }
