...
{
	public partial class AdSeriesSonificationTracksMappingTime  : BaseObject
	{
		Hashtable h = new Hashtable();

		public AdSeriesSonificationTracksMappingTime()
		{
			MapFunction = MapFunction_DefaultValue = AdSeriesSonificationTracksMappingTimeMapFunction.Linear;
			MapTo = MapTo_DefaultValue = "";
			Max = Max_DefaultValue = null;
			Min = Min_DefaultValue = null;
			Value = Value_DefaultValue = null;
			Within = Within_DefaultValue = AdSeriesSonificationTracksMappingTimeWithin.Chart;
		...
		/// </summary>
		public AdSeriesSonificationTracksMappingTimeMapFunction MapFunction { get; set; }
		private AdSeriesSonificationTracksMappingTimeMapFunction MapFunction_DefaultValue { get; set; }
		...
		/// </summary>
		public AdSeriesSonificationTracksMappingTimeWithin Within { get; set; }
		private AdSeriesSonificationTracksMappingTimeWithin Within_DefaultValue { get; set; }
