...
{
	public partial class AdSeriesSonificationTracksMappingVolume  : BaseObject
	{
		Hashtable h = new Hashtable();

		public AdSeriesSonificationTracksMappingVolume()
		{
			MapFunction = MapFunction_DefaultValue = AdSeriesSonificationTracksMappingVolumeMapFunction.Linear;
			MapTo = MapTo_DefaultValue = "";
			Max = Max_DefaultValue = null;
			Min = Min_DefaultValue = null;
			Value = Value_DefaultValue = null;
			Within = Within_DefaultValue = AdSeriesSonificationTracksMappingVolumeWithin.Chart;
		...
		/// </summary>
		public AdSeriesSonificationTracksMappingVolumeMapFunction MapFunction { get; set; }
		private AdSeriesSonificationTracksMappingVolumeMapFunction MapFunction_DefaultValue { get; set; }
		...
		/// </summary>
		public AdSeriesSonificationTracksMappingVolumeWithin Within { get; set; }
		private AdSeriesSonificationTracksMappingVolumeWithin Within_DefaultValue { get; set; }
