...
{
	public partial class AdSeriesTooltip  : BaseObject
	{
		public AdSeriesTooltip()
		{
			...
			HeaderShape = HeaderShape_DefaultValue = AdSeriesTooltipHeaderShape.Callout;
		...
		/// </summary>
		public AdSeriesTooltipHeaderShape HeaderShape { get; set; }
		private AdSeriesTooltipHeaderShape HeaderShape_DefaultValue { get; set; }
		...
		internal override Hashtable ToHashtable()
		{
			...
			if (NullFormatter != NullFormatter_DefaultValue) { h.Add("nullFormatter",NullFormatter); Highstock.AddFunction("AdSeriesTooltipNullFormatter.nullFormatter", NullFormatter); }  
			if (Outside != Outside_DefaultValue) h.Add("outside",Outside);
			if (Padding != Padding_DefaultValue) h.Add("padding",Padding);
			if (PointFormat != PointFormat_DefaultValue) h.Add("pointFormat",PointFormat);
			if (PointFormatter != PointFormatter_DefaultValue) { h.Add("pointFormatter",PointFormatter); Highstock.AddFunction("AdSeriesTooltipPointFormatter.pointFormatter", PointFormatter); }  
