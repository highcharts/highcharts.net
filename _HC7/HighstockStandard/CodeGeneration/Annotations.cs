...
namespace Highsoft.Web.Mvc.Stocks
{
	public partial class Annotations  : BaseObject
	{
		...
		internal override Hashtable ToHashtable(Highstock highstock)
		{
			...
			if (CrookedLine != null) h.Add("crookedLine",CrookedLine.ToHashtable(highstock));
			if (Crop != null) h.Add("crop",Crop);
			if (Draggable != null) h.Add("draggable",Draggable);
			if (ElliottWave != null) h.Add("elliottWave",ElliottWave.ToHashtable(highstock));
			...
			if (InfinityLine != null) h.Add("infinityLine",InfinityLine.ToHashtable(highstock));
			if (LabelOptions != null) h.Add("labelOptions",LabelOptions.ToHashtable(highstock));
			if (Labels != null) h.Add("labels", HashifyList(highstock,Labels));
			...
			if (Shapes != null) h.Add("shapes", HashifyList(highstock,Shapes));
			if (TimeCycles != null) h.Add("timeCycles",TimeCycles.ToHashtable(highstock));
			if (Tunnel != null) h.Add("tunnel",Tunnel.ToHashtable(highstock));
