...
namespace Highsoft.Web.Mvc.Stocks
{
	public partial class AnnotationsCrookedLineControlPointOptions  : BaseObject
	{
		...
		internal override Hashtable ToHashtable()
		{
			...
			if (Positioner != Positioner_DefaultValue) { h.Add("positioner",Positioner); Highstock.AddFunction("AnnotationsCrookedLineControlPointOptionsPositioner.positioner", Positioner); }  
