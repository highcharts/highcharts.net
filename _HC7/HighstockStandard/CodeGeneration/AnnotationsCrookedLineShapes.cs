...
{
	public partial class AnnotationsCrookedLineShapes  : BaseObject
	{
		public AnnotationsCrookedLineShapes()
		{
			Fill = Fill_DefaultValue = "rgba(0, 0, 0, 0.75)";
			Height = Height_DefaultValue = null;
			MarkerEnd = MarkerEnd_DefaultValue = "";
			MarkerStart = MarkerStart_DefaultValue = "";
			Point = Point_DefaultValue = new AnnotationsCrookedLineShapesPoint();
		...
		/// <summary>
		/// Id of the marker which will be drawn at the finalvertex of the path.Custom markers can be defined in defs property.
		/// </summary>
		...
		/// <summary>
		/// Id of the marker which will be drawn at the firstvertex of the path.Custom markers can be defined in defs property.
		/// </summary>
		...
		/// <summary>
		/// This option defines the point to which the shape will beconnected.It can be either the point which exists in the series - it isreferenced by the point's id - or a new point with defined x, yproperties and optionally axes.
		/// </summary>
		public AnnotationsCrookedLineShapesPoint Point { get; set; }
		private AnnotationsCrookedLineShapesPoint Point_DefaultValue { get; set; }
		...
		internal override Hashtable ToHashtable()
		{
			...
			if (Points.Any()) h.Add("points",Points);
