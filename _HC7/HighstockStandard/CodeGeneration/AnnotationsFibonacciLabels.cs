...
{
	public partial class AnnotationsFibonacciLabels  : BaseObject
	{
		public AnnotationsFibonacciLabels()
		{
			Align = Align_DefaultValue = AnnotationsFibonacciLabelsAlign.Center;
			...
			Overflow = Overflow_DefaultValue = AnnotationsFibonacciLabelsOverflow.Justify;
			Padding = Padding_DefaultValue = "5";
			Point = Point_DefaultValue = new AnnotationsFibonacciLabelsPoint();
			...
			Style = Style_DefaultValue = new AnnotationsFibonacciLabelsStyle();
			Text = Text_DefaultValue = "undefined";
			UseHTML = UseHTML_DefaultValue = false;
			VerticalAlign = VerticalAlign_DefaultValue = AnnotationsFibonacciLabelsVerticalAlign.Bottom;
			X = X_DefaultValue = 0;
			Y = Y_DefaultValue = -16;
		...
		/// </summary>
		public AnnotationsFibonacciLabelsAlign Align { get; set; }
		private AnnotationsFibonacciLabelsAlign Align_DefaultValue { get; set; }
		...
		/// </summary>
		public AnnotationsFibonacciLabelsOverflow Overflow { get; set; }
		private AnnotationsFibonacciLabelsOverflow Overflow_DefaultValue { get; set; }
		...
		/// </summary>
		public AnnotationsFibonacciLabelsPoint Point { get; set; }
		private AnnotationsFibonacciLabelsPoint Point_DefaultValue { get; set; }
		...
		/// </summary>
		public AnnotationsFibonacciLabelsStyle Style { get; set; }
		private AnnotationsFibonacciLabelsStyle Style_DefaultValue { get; set; }
		...
		/// </summary>
		public AnnotationsFibonacciLabelsVerticalAlign VerticalAlign { get; set; }
		private AnnotationsFibonacciLabelsVerticalAlign VerticalAlign_DefaultValue { get; set; }
		...
		internal override Hashtable ToHashtable()
		{
			...
			if (Formatter != Formatter_DefaultValue) { h.Add("formatter",Formatter); Highstock.AddFunction("AnnotationsFibonacciLabelsFormatter.formatter", Formatter); }  
