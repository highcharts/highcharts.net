...
{
	public partial class AnnotationsFibonacciShapes  : BaseObject
	{
		public AnnotationsFibonacciShapes()
		{
		...
		/// </summary>
		public AnnotationsFibonacciShapesPoint Point { get; set; }
		private AnnotationsFibonacciShapesPoint Point_DefaultValue { get; set; }
