...
{
	public partial class AnnotationsInfinityLineControlPointOptions  : BaseObject
	{
		public AnnotationsInfinityLineControlPointOptions()
		{
			...
			Style = Style_DefaultValue = new AnnotationsInfinityLineControlPointOptionsStyle();
		...
		/// 
		/// </summary>
		public AnnotationsInfinityLineControlPointOptionsStyle Style { get; set; }
		private AnnotationsInfinityLineControlPointOptionsStyle Style_DefaultValue { get; set; }
