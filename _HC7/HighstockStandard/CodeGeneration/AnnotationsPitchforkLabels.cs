...
{
	public partial class AnnotationsPitchforkLabels  : BaseObject
	{
		public AnnotationsPitchforkLabels()
		{
			Align = Align_DefaultValue = AnnotationsPitchforkLabelsAlign.Center;
			...
			Overflow = Overflow_DefaultValue = AnnotationsPitchforkLabelsOverflow.Justify;
			Padding = Padding_DefaultValue = "5";
			Point = Point_DefaultValue = new AnnotationsPitchforkLabelsPoint();
			...
			Style = Style_DefaultValue = new AnnotationsPitchforkLabelsStyle();
			Text = Text_DefaultValue = "undefined";
			UseHTML = UseHTML_DefaultValue = false;
			VerticalAlign = VerticalAlign_DefaultValue = AnnotationsPitchforkLabelsVerticalAlign.Bottom;
			X = X_DefaultValue = 0;
			Y = Y_DefaultValue = -16;
		...
		/// </summary>
		public AnnotationsPitchforkLabelsAlign Align { get; set; }
		private AnnotationsPitchforkLabelsAlign Align_DefaultValue { get; set; }
		...
		/// </summary>
		public AnnotationsPitchforkLabelsOverflow Overflow { get; set; }
		private AnnotationsPitchforkLabelsOverflow Overflow_DefaultValue { get; set; }
		...
		/// </summary>
		public AnnotationsPitchforkLabelsPoint Point { get; set; }
		private AnnotationsPitchforkLabelsPoint Point_DefaultValue { get; set; }
		...
		/// </summary>
		public AnnotationsPitchforkLabelsStyle Style { get; set; }
		private AnnotationsPitchforkLabelsStyle Style_DefaultValue { get; set; }
		...
		/// </summary>
		public AnnotationsPitchforkLabelsVerticalAlign VerticalAlign { get; set; }
		private AnnotationsPitchforkLabelsVerticalAlign VerticalAlign_DefaultValue { get; set; }
		...
		internal override Hashtable ToHashtable()
		{
			...
			if (Formatter != Formatter_DefaultValue) { h.Add("formatter",Formatter); Highstock.AddFunction("AnnotationsPitchforkLabelsFormatter.formatter", Formatter); }  
