...
{
	public partial class AnnotationsPitchforkShapes  : BaseObject
	{
		public AnnotationsPitchforkShapes()
		{
			Fill = Fill_DefaultValue = "rgba(0, 0, 0, 0.75)";
			Height = Height_DefaultValue = null;
			MarkerEnd = MarkerEnd_DefaultValue = "";
			MarkerStart = MarkerStart_DefaultValue = "";
			Point = Point_DefaultValue = new AnnotationsPitchforkShapesPoint();
		...
		/// </summary>
		public AnnotationsPitchforkShapesPoint Point { get; set; }
		private AnnotationsPitchforkShapesPoint Point_DefaultValue { get; set; }
