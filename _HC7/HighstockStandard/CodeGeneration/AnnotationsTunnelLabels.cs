...
{
	public partial class AnnotationsTunnelLabels  : BaseObject
	{
		public AnnotationsTunnelLabels()
		{
			Align = Align_DefaultValue = AnnotationsTunnelLabelsAlign.Center;
			...
			Overflow = Overflow_DefaultValue = AnnotationsTunnelLabelsOverflow.Justify;
			Padding = Padding_DefaultValue = "5";
			Point = Point_DefaultValue = new AnnotationsTunnelLabelsPoint();
			...
			Style = Style_DefaultValue = new AnnotationsTunnelLabelsStyle();
			Text = Text_DefaultValue = "undefined";
			UseHTML = UseHTML_DefaultValue = false;
			VerticalAlign = VerticalAlign_DefaultValue = AnnotationsTunnelLabelsVerticalAlign.Bottom;
			X = X_DefaultValue = 0;
			Y = Y_DefaultValue = -16;
		...
		/// </summary>
		public AnnotationsTunnelLabelsAlign Align { get; set; }
		private AnnotationsTunnelLabelsAlign Align_DefaultValue { get; set; }
		...
		/// </summary>
		public AnnotationsTunnelLabelsOverflow Overflow { get; set; }
		private AnnotationsTunnelLabelsOverflow Overflow_DefaultValue { get; set; }
		...
		/// </summary>
		public AnnotationsTunnelLabelsPoint Point { get; set; }
		private AnnotationsTunnelLabelsPoint Point_DefaultValue { get; set; }
		...
		/// </summary>
		public AnnotationsTunnelLabelsStyle Style { get; set; }
		private AnnotationsTunnelLabelsStyle Style_DefaultValue { get; set; }
		...
		/// </summary>
		public AnnotationsTunnelLabelsVerticalAlign VerticalAlign { get; set; }
		private AnnotationsTunnelLabelsVerticalAlign VerticalAlign_DefaultValue { get; set; }
		...
		internal override Hashtable ToHashtable()
		{
			...
			if (Formatter != Formatter_DefaultValue) { h.Add("formatter",Formatter); Highstock.AddFunction("AnnotationsTunnelLabelsFormatter.formatter", Formatter); }  
