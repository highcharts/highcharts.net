...
{
	public partial class AnnotationsTunnelShapes  : BaseObject
	{
		public AnnotationsTunnelShapes()
		{
			Fill = Fill_DefaultValue = "rgba(0, 0, 0, 0.75)";
			Height = Height_DefaultValue = null;
			MarkerEnd = MarkerEnd_DefaultValue = "";
			MarkerStart = MarkerStart_DefaultValue = "";
			Point = Point_DefaultValue = new AnnotationsTunnelShapesPoint();
		...
		/// </summary>
		public AnnotationsTunnelShapesPoint Point { get; set; }
		private AnnotationsTunnelShapesPoint Point_DefaultValue { get; set; }
