...
namespace Highsoft.Web.Mvc.Stocks
{
	public partial class AnnotationsTunnelTypeOptionsPoints  : BaseObject
	{
		public AnnotationsTunnelTypeOptionsPoints()
		{
			...
			Label = Label_DefaultValue = new AnnotationsTunnelTypeOptionsPointsLabel();
		...
		/// 
		/// </summary>
		public AnnotationsTunnelTypeOptionsPointsLabel Label { get; set; }
		private AnnotationsTunnelTypeOptionsPointsLabel Label_DefaultValue { get; set; }
