...
namespace Highsoft.Web.Mvc.Stocks
{
	public partial class AnnotationsVerticalLineLabelOptions  : BaseObject
	{
		public AnnotationsVerticalLineLabelOptions()
		{
			...
			Style = Style_DefaultValue = new AnnotationsVerticalLineLabelOptionsStyle();
		...
		/// </summary>
		public AnnotationsVerticalLineLabelOptionsStyle Style { get; set; }
		private AnnotationsVerticalLineLabelOptionsStyle Style_DefaultValue { get; set; }
