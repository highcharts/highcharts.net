...
namespace Highsoft.Web.Mvc.Stocks
{
	public partial class AnnotationsVerticalLineShapeOptions  : BaseObject
	{
		...
		{
			DashStyle = DashStyle_DefaultValue = AnnotationsVerticalLineShapeOptionsDashStyle.Null;
		...
		/// </summary>
		public AnnotationsVerticalLineShapeOptionsDashStyle DashStyle { get; set; }
		private AnnotationsVerticalLineShapeOptionsDashStyle DashStyle_DefaultValue { get; set; }
