...
{
	public partial class AnnotationsVerticalLineTypeOptionsPointsLabel  : BaseObject
	{
		public AnnotationsVerticalLineTypeOptionsPointsLabel()
		{
			...
			Overflow = Overflow_DefaultValue = AnnotationsVerticalLineTypeOptionsPointsLabelOverflow.Justify;
		...
		/// </summary>
		public AnnotationsVerticalLineTypeOptionsPointsLabelOverflow Overflow { get; set; }
		private AnnotationsVerticalLineTypeOptionsPointsLabelOverflow Overflow_DefaultValue { get; set; }
		...
		/// </summary>
		public AnnotationsVerticalLineTypeOptionsPointsLabelStyle Style { get; set; }
		private AnnotationsVerticalLineTypeOptionsPointsLabelStyle Style_DefaultValue { get; set; }
		...
		internal override Hashtable ToHashtable()
		{
			...
			if (Formatter != Formatter_DefaultValue) { h.Add("formatter",Formatter); Highstock.AddFunction("AnnotationsVerticalLineTypeOptionsPointsLabelFormatter.formatter", Formatter); }  
