...
{
	public partial class AoSeriesLabel  : BaseObject
	{
		public AoSeriesLabel()
		{
			...
			Style = Style_DefaultValue = new AoSeriesLabelStyle();
		...
		/// </summary>
		public AoSeriesLabelStyle Style { get; set; }
		private AoSeriesLabelStyle Style_DefaultValue { get; set; }
