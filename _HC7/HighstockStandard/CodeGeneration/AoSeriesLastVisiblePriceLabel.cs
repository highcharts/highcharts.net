...
{
	public partial class AoSeriesLastVisiblePriceLabel  : BaseObject
	{
		Hashtable h = new Hashtable();

		public AoSeriesLastVisiblePriceLabel()
		{
			Align = Align_DefaultValue = AoSeriesLastVisiblePriceLabelAlign.Null;
		...
		/// 
		/// </summary>
		public AoSeriesLastVisiblePriceLabelAlign Align { get; set; }
		private AoSeriesLastVisiblePriceLabelAlign Align_DefaultValue { get; set; }
