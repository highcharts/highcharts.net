...
{
	public partial class AoSeriesOnPoint  : BaseObject
	{
		Hashtable h = new Hashtable();

		public AoSeriesOnPoint()
		{
			ConnectorOptions = ConnectorOptions_DefaultValue = new AoSeriesOnPointConnectorOptions();
			Id = Id_DefaultValue = "";
			Position = Position_DefaultValue = new AoSeriesOnPointPosition();
		...
		/// </summary>
		public AoSeriesOnPointConnectorOptions ConnectorOptions { get; set; }
		private AoSeriesOnPointConnectorOptions ConnectorOptions_DefaultValue { get; set; }
		...
		/// </summary>
		public AoSeriesOnPointPosition Position { get; set; }
		private AoSeriesOnPointPosition Position_DefaultValue { get; set; }
