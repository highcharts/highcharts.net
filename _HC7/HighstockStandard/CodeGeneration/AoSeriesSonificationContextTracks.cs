...
{
	public partial class AoSeriesSonificationContextTracks  : BaseObject
	{
		Hashtable h = new Hashtable();

		public AoSeriesSonificationContextTracks()
		{
			ActiveWhen = ActiveWhen_DefaultValue = new AoSeriesSonificationContextTracksActiveWhen();
			Instrument = Instrument_DefaultValue = null;
			InstrumentString = InstrumentString_DefaultValue = "null";
			Mapping = Mapping_DefaultValue = new AoSeriesSonificationContextTracksMapping();
			MidiName = MidiName_DefaultValue = "";
			PointGrouping = PointGrouping_DefaultValue = new AoSeriesSonificationContextTracksPointGrouping();
			...
			Type = Type_DefaultValue = AoSeriesSonificationContextTracksType.Instrument;
			ValueInterval = ValueInterval_DefaultValue = null;
			ValueMapFunction = ValueMapFunction_DefaultValue = AoSeriesSonificationContextTracksValueMapFunction.Linear;
		...
		/// </summary>
		public AoSeriesSonificationContextTracksActiveWhen ActiveWhen { get; set; }
		private AoSeriesSonificationContextTracksActiveWhen ActiveWhen_DefaultValue { get; set; }
		...
		/// </summary>
		public AoSeriesSonificationContextTracksMapping Mapping { get; set; }
		private AoSeriesSonificationContextTracksMapping Mapping_DefaultValue { get; set; }
		...
		/// </summary>
		public AoSeriesSonificationContextTracksPointGrouping PointGrouping { get; set; }
		private AoSeriesSonificationContextTracksPointGrouping PointGrouping_DefaultValue { get; set; }
		...
		/// </summary>
		public AoSeriesSonificationContextTracksType Type { get; set; }
		private AoSeriesSonificationContextTracksType Type_DefaultValue { get; set; }
		...
		/// </summary>
		public AoSeriesSonificationContextTracksValueMapFunction ValueMapFunction { get; set; }
		private AoSeriesSonificationContextTracksValueMapFunction ValueMapFunction_DefaultValue { get; set; }
