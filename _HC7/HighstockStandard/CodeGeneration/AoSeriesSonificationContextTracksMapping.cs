...
{
	public partial class AoSeriesSonificationContextTracksMapping  : BaseObject
	{
		Hashtable h = new Hashtable();

		public AoSeriesSonificationContextTracksMapping()
		{
			Frequency = Frequency_DefaultValue = new AoSeriesSonificationContextTracksMappingFrequency();
			GapBetweenNotes = GapBetweenNotes_DefaultValue = new AoSeriesSonificationContextTracksMappingGapBetweenNotes();
			Highpass = Highpass_DefaultValue = new AoSeriesSonificationContextTracksMappingHighpass();
			Lowpass = Lowpass_DefaultValue = new AoSeriesSonificationContextTracksMappingLowpass();
			NoteDuration = NoteDuration_DefaultValue = new AoSeriesSonificationContextTracksMappingNoteDuration();
			Pan = Pan_DefaultValue = new AoSeriesSonificationContextTracksMappingPan();
			Pitch = Pitch_DefaultValue = new AoSeriesSonificationContextTracksMappingPitch();
			PitchString = PitchString_DefaultValue = "null";
			PitchNumber = PitchNumber_DefaultValue = null;
			PlayDelay = PlayDelay_DefaultValue = new AoSeriesSonificationContextTracksMappingPlayDelay();
			Time = Time_DefaultValue = new AoSeriesSonificationContextTracksMappingTime();
			TimeString = TimeString_DefaultValue = "null";
			TimeNumber = TimeNumber_DefaultValue = null;
			Tremolo = Tremolo_DefaultValue = new AoSeriesSonificationContextTracksMappingTremolo();
			Volume = Volume_DefaultValue = new AoSeriesSonificationContextTracksMappingVolume();
		...
		/// </summary>
		public AoSeriesSonificationContextTracksMappingFrequency Frequency { get; set; }
		private AoSeriesSonificationContextTracksMappingFrequency Frequency_DefaultValue { get; set; }
		...
		/// </summary>
		public AoSeriesSonificationContextTracksMappingGapBetweenNotes GapBetweenNotes { get; set; }
		private AoSeriesSonificationContextTracksMappingGapBetweenNotes GapBetweenNotes_DefaultValue { get; set; }
		...
		/// </summary>
		public AoSeriesSonificationContextTracksMappingHighpass Highpass { get; set; }
		private AoSeriesSonificationContextTracksMappingHighpass Highpass_DefaultValue { get; set; }
		...
		/// </summary>
		public AoSeriesSonificationContextTracksMappingLowpass Lowpass { get; set; }
		private AoSeriesSonificationContextTracksMappingLowpass Lowpass_DefaultValue { get; set; }
		...
		/// </summary>
		public AoSeriesSonificationContextTracksMappingNoteDuration NoteDuration { get; set; }
		private AoSeriesSonificationContextTracksMappingNoteDuration NoteDuration_DefaultValue { get; set; }
		...
		/// </summary>
		public AoSeriesSonificationContextTracksMappingPan Pan { get; set; }
		private AoSeriesSonificationContextTracksMappingPan Pan_DefaultValue { get; set; }
		...
		/// </summary>
		public AoSeriesSonificationContextTracksMappingPitch Pitch { get; set; }
		private AoSeriesSonificationContextTracksMappingPitch Pitch_DefaultValue { get; set; }
		...
		/// </summary>
		public AoSeriesSonificationContextTracksMappingPlayDelay PlayDelay { get; set; }
		private AoSeriesSonificationContextTracksMappingPlayDelay PlayDelay_DefaultValue { get; set; }
		...
		/// </summary>
		public AoSeriesSonificationContextTracksMappingTime Time { get; set; }
		private AoSeriesSonificationContextTracksMappingTime Time_DefaultValue { get; set; }
		...
		/// </summary>
		public AoSeriesSonificationContextTracksMappingTremolo Tremolo { get; set; }
		private AoSeriesSonificationContextTracksMappingTremolo Tremolo_DefaultValue { get; set; }
		 

		/// <summary>
		/// The volume of notes, from 0 to 1.
		/// </summary>
		public AoSeriesSonificationContextTracksMappingVolume Volume { get; set; }
		private AoSeriesSonificationContextTracksMappingVolume Volume_DefaultValue { get; set; }
