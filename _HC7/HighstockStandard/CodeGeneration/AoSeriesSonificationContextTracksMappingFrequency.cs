...
{
	public partial class AoSeriesSonificationContextTracksMappingFrequency  : BaseObject
	{
		Hashtable h = new Hashtable();

		public AoSeriesSonificationContextTracksMappingFrequency()
		{
			MapFunction = MapFunction_DefaultValue = AoSeriesSonificationContextTracksMappingFrequencyMapFunction.Linear;
			MapTo = MapTo_DefaultValue = "";
			Max = Max_DefaultValue = null;
			Min = Min_DefaultValue = null;
			Value = Value_DefaultValue = null;
			Within = Within_DefaultValue = AoSeriesSonificationContextTracksMappingFrequencyWithin.Chart;
		...
		/// </summary>
		public AoSeriesSonificationContextTracksMappingFrequencyMapFunction MapFunction { get; set; }
		private AoSeriesSonificationContextTracksMappingFrequencyMapFunction MapFunction_DefaultValue { get; set; }
		...
		/// </summary>
		public AoSeriesSonificationContextTracksMappingFrequencyWithin Within { get; set; }
		private AoSeriesSonificationContextTracksMappingFrequencyWithin Within_DefaultValue { get; set; }
