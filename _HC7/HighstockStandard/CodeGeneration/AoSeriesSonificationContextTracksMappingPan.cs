...
{
	public partial class AoSeriesSonificationContextTracksMappingPan  : BaseObject
	{
		Hashtable h = new Hashtable();

		public AoSeriesSonificationContextTracksMappingPan()
		{
			MapFunction = MapFunction_DefaultValue = AoSeriesSonificationContextTracksMappingPanMapFunction.Linear;
			MapTo = MapTo_DefaultValue = "";
			Max = Max_DefaultValue = null;
			Min = Min_DefaultValue = null;
			Value = Value_DefaultValue = null;
			Within = Within_DefaultValue = AoSeriesSonificationContextTracksMappingPanWithin.Chart;
		...
		/// </summary>
		public AoSeriesSonificationContextTracksMappingPanMapFunction MapFunction { get; set; }
		private AoSeriesSonificationContextTracksMappingPanMapFunction MapFunction_DefaultValue { get; set; }
		...
		/// </summary>
		public AoSeriesSonificationContextTracksMappingPanWithin Within { get; set; }
		private AoSeriesSonificationContextTracksMappingPanWithin Within_DefaultValue { get; set; }
