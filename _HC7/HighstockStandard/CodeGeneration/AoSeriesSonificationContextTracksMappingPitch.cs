...
{
	public partial class AoSeriesSonificationContextTracksMappingPitch  : BaseObject
	{
		Hashtable h = new Hashtable();

		public AoSeriesSonificationContextTracksMappingPitch()
		{
			MapFunction = MapFunction_DefaultValue = AoSeriesSonificationContextTracksMappingPitchMapFunction.Linear;
		...
		/// </summary>
		public AoSeriesSonificationContextTracksMappingPitchMapFunction MapFunction { get; set; }
		private AoSeriesSonificationContextTracksMappingPitchMapFunction MapFunction_DefaultValue { get; set; }
