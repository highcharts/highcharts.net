...
{
	public partial class AoSeriesSonificationContextTracksMappingTime  : BaseObject
	{
		Hashtable h = new Hashtable();

		public AoSeriesSonificationContextTracksMappingTime()
		{
			MapFunction = MapFunction_DefaultValue = AoSeriesSonificationContextTracksMappingTimeMapFunction.Linear;
			MapTo = MapTo_DefaultValue = "";
			Max = Max_DefaultValue = null;
			Min = Min_DefaultValue = null;
			Value = Value_DefaultValue = null;
			Within = Within_DefaultValue = AoSeriesSonificationContextTracksMappingTimeWithin.Chart;
		...
		/// </summary>
		public AoSeriesSonificationContextTracksMappingTimeMapFunction MapFunction { get; set; }
		private AoSeriesSonificationContextTracksMappingTimeMapFunction MapFunction_DefaultValue { get; set; }
		...
		/// </summary>
		public AoSeriesSonificationContextTracksMappingTimeWithin Within { get; set; }
		private AoSeriesSonificationContextTracksMappingTimeWithin Within_DefaultValue { get; set; }
