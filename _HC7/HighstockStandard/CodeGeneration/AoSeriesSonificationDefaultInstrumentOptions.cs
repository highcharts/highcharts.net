...
{
	public partial class AoSeriesSonificationDefaultInstrumentOptions  : BaseObject
	{
		Hashtable h = new Hashtable();

		public AoSeriesSonificationDefaultInstrumentOptions()
		{
			ActiveWhen = ActiveWhen_DefaultValue = new AoSeriesSonificationDefaultInstrumentOptionsActiveWhen();
			Instrument = Instrument_DefaultValue = null;
			InstrumentString = InstrumentString_DefaultValue = "null";
			Mapping = Mapping_DefaultValue = new AoSeriesSonificationDefaultInstrumentOptionsMapping();
			MidiName = MidiName_DefaultValue = "";
			PointGrouping = PointGrouping_DefaultValue = new AoSeriesSonificationDefaultInstrumentOptionsPointGrouping();
			RoundToMusicalNotes = RoundToMusicalNotes_DefaultValue = true;
			ShowPlayMarker = ShowPlayMarker_DefaultValue = true;
			Type = Type_DefaultValue = AoSeriesSonificationDefaultInstrumentOptionsType.Instrument;
		...
		/// </summary>
		public AoSeriesSonificationDefaultInstrumentOptionsActiveWhen ActiveWhen { get; set; }
		private AoSeriesSonificationDefaultInstrumentOptionsActiveWhen ActiveWhen_DefaultValue { get; set; }
		...
		/// </summary>
		public AoSeriesSonificationDefaultInstrumentOptionsMapping Mapping { get; set; }
		private AoSeriesSonificationDefaultInstrumentOptionsMapping Mapping_DefaultValue { get; set; }
		...
		/// </summary>
		public AoSeriesSonificationDefaultInstrumentOptionsPointGrouping PointGrouping { get; set; }
		private AoSeriesSonificationDefaultInstrumentOptionsPointGrouping PointGrouping_DefaultValue { get; set; }
		...
		/// </summary>
		public AoSeriesSonificationDefaultInstrumentOptionsType Type { get; set; }
		private AoSeriesSonificationDefaultInstrumentOptionsType Type_DefaultValue { get; set; }
