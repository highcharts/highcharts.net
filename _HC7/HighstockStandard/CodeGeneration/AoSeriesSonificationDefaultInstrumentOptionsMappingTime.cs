...
{
	public partial class AoSeriesSonificationDefaultInstrumentOptionsMappingTime  : BaseObject
	{
		Hashtable h = new Hashtable();

		public AoSeriesSonificationDefaultInstrumentOptionsMappingTime()
		{
			MapFunction = MapFunction_DefaultValue = AoSeriesSonificationDefaultInstrumentOptionsMappingTimeMapFunction.Linear;
			MapTo = MapTo_DefaultValue = "";
			Max = Max_DefaultValue = null;
			Min = Min_DefaultValue = null;
			Value = Value_DefaultValue = null;
			Within = Within_DefaultValue = AoSeriesSonificationDefaultInstrumentOptionsMappingTimeWithin.Chart;
		...
		/// </summary>
		public AoSeriesSonificationDefaultInstrumentOptionsMappingTimeMapFunction MapFunction { get; set; }
		private AoSeriesSonificationDefaultInstrumentOptionsMappingTimeMapFunction MapFunction_DefaultValue { get; set; }
		...
		/// </summary>
		public AoSeriesSonificationDefaultInstrumentOptionsMappingTimeWithin Within { get; set; }
		private AoSeriesSonificationDefaultInstrumentOptionsMappingTimeWithin Within_DefaultValue { get; set; }
