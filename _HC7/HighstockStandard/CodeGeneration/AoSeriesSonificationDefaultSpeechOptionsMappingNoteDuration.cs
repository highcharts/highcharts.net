...
{
	public partial class AoSeriesSonificationDefaultSpeechOptionsMappingNoteDuration  : BaseObject
	{
		Hashtable h = new Hashtable();

		public AoSeriesSonificationDefaultSpeechOptionsMappingNoteDuration()
		{
			MapFunction = MapFunction_DefaultValue = AoSeriesSonificationDefaultSpeechOptionsMappingNoteDurationMapFunction.Linear;
			MapTo = MapTo_DefaultValue = "";
			Max = Max_DefaultValue = null;
			Min = Min_DefaultValue = null;
			Value = Value_DefaultValue = null;
			Within = Within_DefaultValue = AoSeriesSonificationDefaultSpeechOptionsMappingNoteDurationWithin.Chart;
		...
		/// </summary>
		public AoSeriesSonificationDefaultSpeechOptionsMappingNoteDurationMapFunction MapFunction { get; set; }
		private AoSeriesSonificationDefaultSpeechOptionsMappingNoteDurationMapFunction MapFunction_DefaultValue { get; set; }
		...
		/// </summary>
		public AoSeriesSonificationDefaultSpeechOptionsMappingNoteDurationWithin Within { get; set; }
		private AoSeriesSonificationDefaultSpeechOptionsMappingNoteDurationWithin Within_DefaultValue { get; set; }
