...
{
	public partial class AoSeriesSonificationTracks  : BaseObject
	{
		Hashtable h = new Hashtable();

		public AoSeriesSonificationTracks()
		{
			ActiveWhen = ActiveWhen_DefaultValue = new AoSeriesSonificationTracksActiveWhen();
			Instrument = Instrument_DefaultValue = null;
			InstrumentString = InstrumentString_DefaultValue = "null";
			Mapping = Mapping_DefaultValue = new AoSeriesSonificationTracksMapping();
			MidiName = MidiName_DefaultValue = "";
			PointGrouping = PointGrouping_DefaultValue = new AoSeriesSonificationTracksPointGrouping();
			RoundToMusicalNotes = RoundToMusicalNotes_DefaultValue = true;
			ShowPlayMarker = ShowPlayMarker_DefaultValue = true;
			Type = Type_DefaultValue = AoSeriesSonificationTracksType.Instrument;
		...
		/// </summary>
		public AoSeriesSonificationTracksActiveWhen ActiveWhen { get; set; }
		private AoSeriesSonificationTracksActiveWhen ActiveWhen_DefaultValue { get; set; }
		...
		/// </summary>
		public AoSeriesSonificationTracksMapping Mapping { get; set; }
		private AoSeriesSonificationTracksMapping Mapping_DefaultValue { get; set; }
		...
		/// </summary>
		public AoSeriesSonificationTracksPointGrouping PointGrouping { get; set; }
		private AoSeriesSonificationTracksPointGrouping PointGrouping_DefaultValue { get; set; }
		...
		/// </summary>
		public AoSeriesSonificationTracksType Type { get; set; }
		private AoSeriesSonificationTracksType Type_DefaultValue { get; set; }
