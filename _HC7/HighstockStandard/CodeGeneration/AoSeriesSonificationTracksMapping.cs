...
{
	public partial class AoSeriesSonificationTracksMapping  : BaseObject
	{
		Hashtable h = new Hashtable();

		public AoSeriesSonificationTracksMapping()
		{
			Frequency = Frequency_DefaultValue = new AoSeriesSonificationTracksMappingFrequency();
			GapBetweenNotes = GapBetweenNotes_DefaultValue = new AoSeriesSonificationTracksMappingGapBetweenNotes();
			Highpass = Highpass_DefaultValue = new AoSeriesSonificationTracksMappingHighpass();
			Lowpass = Lowpass_DefaultValue = new AoSeriesSonificationTracksMappingLowpass();
			NoteDuration = NoteDuration_DefaultValue = new AoSeriesSonificationTracksMappingNoteDuration();
			Pan = Pan_DefaultValue = new AoSeriesSonificationTracksMappingPan();
			Pitch = Pitch_DefaultValue = new AoSeriesSonificationTracksMappingPitch();
			PitchString = PitchString_DefaultValue = "null";
			PitchNumber = PitchNumber_DefaultValue = null;
			PlayDelay = PlayDelay_DefaultValue = new AoSeriesSonificationTracksMappingPlayDelay();
			Time = Time_DefaultValue = new AoSeriesSonificationTracksMappingTime();
			TimeString = TimeString_DefaultValue = "null";
			TimeNumber = TimeNumber_DefaultValue = null;
			Tremolo = Tremolo_DefaultValue = new AoSeriesSonificationTracksMappingTremolo();
			Volume = Volume_DefaultValue = new AoSeriesSonificationTracksMappingVolume();
		...
		/// </summary>
		public AoSeriesSonificationTracksMappingFrequency Frequency { get; set; }
		private AoSeriesSonificationTracksMappingFrequency Frequency_DefaultValue { get; set; }
		...
		/// </summary>
		public AoSeriesSonificationTracksMappingGapBetweenNotes GapBetweenNotes { get; set; }
		private AoSeriesSonificationTracksMappingGapBetweenNotes GapBetweenNotes_DefaultValue { get; set; }
		...
		/// </summary>
		public AoSeriesSonificationTracksMappingHighpass Highpass { get; set; }
		private AoSeriesSonificationTracksMappingHighpass Highpass_DefaultValue { get; set; }
		...
		/// </summary>
		public AoSeriesSonificationTracksMappingLowpass Lowpass { get; set; }
		private AoSeriesSonificationTracksMappingLowpass Lowpass_DefaultValue { get; set; }
		...
		/// </summary>
		public AoSeriesSonificationTracksMappingNoteDuration NoteDuration { get; set; }
		private AoSeriesSonificationTracksMappingNoteDuration NoteDuration_DefaultValue { get; set; }
		...
		/// </summary>
		public AoSeriesSonificationTracksMappingPan Pan { get; set; }
		private AoSeriesSonificationTracksMappingPan Pan_DefaultValue { get; set; }
		...
		/// </summary>
		public AoSeriesSonificationTracksMappingPitch Pitch { get; set; }
		private AoSeriesSonificationTracksMappingPitch Pitch_DefaultValue { get; set; }
		...
		/// </summary>
		public AoSeriesSonificationTracksMappingPlayDelay PlayDelay { get; set; }
		private AoSeriesSonificationTracksMappingPlayDelay PlayDelay_DefaultValue { get; set; }
		...
		/// </summary>
		public AoSeriesSonificationTracksMappingTime Time { get; set; }
		private AoSeriesSonificationTracksMappingTime Time_DefaultValue { get; set; }
		...
		/// </summary>
		public AoSeriesSonificationTracksMappingTremolo Tremolo { get; set; }
		private AoSeriesSonificationTracksMappingTremolo Tremolo_DefaultValue { get; set; }
		 

		/// <summary>
		/// The volume of notes, from 0 to 1.
		/// </summary>
		public AoSeriesSonificationTracksMappingVolume Volume { get; set; }
		private AoSeriesSonificationTracksMappingVolume Volume_DefaultValue { get; set; }
