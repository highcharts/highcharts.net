...
{
	public partial class AoSeriesSonificationTracksMappingFrequency  : BaseObject
	{
		Hashtable h = new Hashtable();

		public AoSeriesSonificationTracksMappingFrequency()
		{
			MapFunction = MapFunction_DefaultValue = AoSeriesSonificationTracksMappingFrequencyMapFunction.Linear;
			MapTo = MapTo_DefaultValue = "";
			Max = Max_DefaultValue = null;
			Min = Min_DefaultValue = null;
			Value = Value_DefaultValue = null;
			Within = Within_DefaultValue = AoSeriesSonificationTracksMappingFrequencyWithin.Chart;
		...
		/// </summary>
		public AoSeriesSonificationTracksMappingFrequencyMapFunction MapFunction { get; set; }
		private AoSeriesSonificationTracksMappingFrequencyMapFunction MapFunction_DefaultValue { get; set; }
		...
		/// </summary>
		public AoSeriesSonificationTracksMappingFrequencyWithin Within { get; set; }
		private AoSeriesSonificationTracksMappingFrequencyWithin Within_DefaultValue { get; set; }
