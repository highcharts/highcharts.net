...
{
	public partial class AoSeriesSonificationTracksMappingLowpassResonance  : BaseObject
	{
		Hashtable h = new Hashtable();

		public AoSeriesSonificationTracksMappingLowpassResonance()
		{
			MapFunction = MapFunction_DefaultValue = AoSeriesSonificationTracksMappingLowpassResonanceMapFunction.Linear;
			MapTo = MapTo_DefaultValue = "";
			Max = Max_DefaultValue = null;
			Min = Min_DefaultValue = null;
			Value = Value_DefaultValue = null;
			Within = Within_DefaultValue = AoSeriesSonificationTracksMappingLowpassResonanceWithin.Chart;
		...
		/// </summary>
		public AoSeriesSonificationTracksMappingLowpassResonanceMapFunction MapFunction { get; set; }
		private AoSeriesSonificationTracksMappingLowpassResonanceMapFunction MapFunction_DefaultValue { get; set; }
		...
		/// </summary>
		public AoSeriesSonificationTracksMappingLowpassResonanceWithin Within { get; set; }
		private AoSeriesSonificationTracksMappingLowpassResonanceWithin Within_DefaultValue { get; set; }
