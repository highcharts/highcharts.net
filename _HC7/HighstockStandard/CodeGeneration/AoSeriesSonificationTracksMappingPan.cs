...
{
	public partial class AoSeriesSonificationTracksMappingPan  : BaseObject
	{
		Hashtable h = new Hashtable();

		public AoSeriesSonificationTracksMappingPan()
		{
			MapFunction = MapFunction_DefaultValue = AoSeriesSonificationTracksMappingPanMapFunction.Linear;
			MapTo = MapTo_DefaultValue = "";
			Max = Max_DefaultValue = null;
			Min = Min_DefaultValue = null;
			Value = Value_DefaultValue = null;
			Within = Within_DefaultValue = AoSeriesSonificationTracksMappingPanWithin.Chart;
		...
		/// </summary>
		public AoSeriesSonificationTracksMappingPanMapFunction MapFunction { get; set; }
		private AoSeriesSonificationTracksMappingPanMapFunction MapFunction_DefaultValue { get; set; }
		...
		/// </summary>
		public AoSeriesSonificationTracksMappingPanWithin Within { get; set; }
		private AoSeriesSonificationTracksMappingPanWithin Within_DefaultValue { get; set; }
