...
{
	public partial class AoSeriesSonificationTracksMappingPitch  : BaseObject
	{
		Hashtable h = new Hashtable();

		public AoSeriesSonificationTracksMappingPitch()
		{
			MapFunction = MapFunction_DefaultValue = AoSeriesSonificationTracksMappingPitchMapFunction.Linear;
		...
		/// </summary>
		public AoSeriesSonificationTracksMappingPitchMapFunction MapFunction { get; set; }
		private AoSeriesSonificationTracksMappingPitchMapFunction MapFunction_DefaultValue { get; set; }
