...
{
	public partial class AoSeriesSonificationTracksMappingPlayDelay  : BaseObject
	{
		Hashtable h = new Hashtable();

		public AoSeriesSonificationTracksMappingPlayDelay()
		{
			MapFunction = MapFunction_DefaultValue = AoSeriesSonificationTracksMappingPlayDelayMapFunction.Linear;
			MapTo = MapTo_DefaultValue = "";
			Max = Max_DefaultValue = null;
			Min = Min_DefaultValue = null;
			Value = Value_DefaultValue = null;
			Within = Within_DefaultValue = AoSeriesSonificationTracksMappingPlayDelayWithin.Chart;
		...
		/// </summary>
		public AoSeriesSonificationTracksMappingPlayDelayMapFunction MapFunction { get; set; }
		private AoSeriesSonificationTracksMappingPlayDelayMapFunction MapFunction_DefaultValue { get; set; }
		...
		/// </summary>
		public AoSeriesSonificationTracksMappingPlayDelayWithin Within { get; set; }
		private AoSeriesSonificationTracksMappingPlayDelayWithin Within_DefaultValue { get; set; }
