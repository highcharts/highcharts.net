...
{
	public partial class AoSeriesSonificationTracksMappingTime  : BaseObject
	{
		Hashtable h = new Hashtable();

		public AoSeriesSonificationTracksMappingTime()
		{
			MapFunction = MapFunction_DefaultValue = AoSeriesSonificationTracksMappingTimeMapFunction.Linear;
			MapTo = MapTo_DefaultValue = "";
			Max = Max_DefaultValue = null;
			Min = Min_DefaultValue = null;
			Value = Value_DefaultValue = null;
			Within = Within_DefaultValue = AoSeriesSonificationTracksMappingTimeWithin.Chart;
		...
		/// </summary>
		public AoSeriesSonificationTracksMappingTimeMapFunction MapFunction { get; set; }
		private AoSeriesSonificationTracksMappingTimeMapFunction MapFunction_DefaultValue { get; set; }
		...
		/// </summary>
		public AoSeriesSonificationTracksMappingTimeWithin Within { get; set; }
		private AoSeriesSonificationTracksMappingTimeWithin Within_DefaultValue { get; set; }
