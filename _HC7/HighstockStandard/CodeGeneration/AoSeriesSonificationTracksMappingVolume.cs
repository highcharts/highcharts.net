...
{
	public partial class AoSeriesSonificationTracksMappingVolume  : BaseObject
	{
		Hashtable h = new Hashtable();

		public AoSeriesSonificationTracksMappingVolume()
		{
			MapFunction = MapFunction_DefaultValue = AoSeriesSonificationTracksMappingVolumeMapFunction.Linear;
			MapTo = MapTo_DefaultValue = "";
			Max = Max_DefaultValue = null;
			Min = Min_DefaultValue = null;
			Value = Value_DefaultValue = null;
			Within = Within_DefaultValue = AoSeriesSonificationTracksMappingVolumeWithin.Chart;
		...
		/// </summary>
		public AoSeriesSonificationTracksMappingVolumeMapFunction MapFunction { get; set; }
		private AoSeriesSonificationTracksMappingVolumeMapFunction MapFunction_DefaultValue { get; set; }
		...
		/// </summary>
		public AoSeriesSonificationTracksMappingVolumeWithin Within { get; set; }
		private AoSeriesSonificationTracksMappingVolumeWithin Within_DefaultValue { get; set; }
