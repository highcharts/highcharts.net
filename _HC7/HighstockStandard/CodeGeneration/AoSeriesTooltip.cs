...
namespace Highsoft.Web.Mvc.Stocks
{
	public partial class AoSeriesTooltip  : BaseObject
	{
		public AoSeriesTooltip()
		{
			...
			HeaderShape = HeaderShape_DefaultValue = AoSeriesTooltipHeaderShape.Callout;
		...
		/// </summary>
		public AoSeriesTooltipHeaderShape HeaderShape { get; set; }
		private AoSeriesTooltipHeaderShape HeaderShape_DefaultValue { get; set; }
		...
		internal override Hashtable ToHashtable()
		{
			...
			if (NullFormatter != NullFormatter_DefaultValue) { h.Add("nullFormatter",NullFormatter); Highstock.AddFunction("AoSeriesTooltipNullFormatter.nullFormatter", NullFormatter); }  
			if (Outside != Outside_DefaultValue) h.Add("outside",Outside);
			if (Padding != Padding_DefaultValue) h.Add("padding",Padding);
			if (PointFormat != PointFormat_DefaultValue) h.Add("pointFormat",PointFormat);
			if (PointFormatter != PointFormatter_DefaultValue) { h.Add("pointFormatter",PointFormatter); Highstock.AddFunction("AoSeriesTooltipPointFormatter.pointFormatter", PointFormatter); }  
