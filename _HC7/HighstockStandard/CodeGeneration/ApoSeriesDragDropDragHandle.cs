...
{
	public partial class ApoSeriesDragDropDragHandle  : BaseObject
	{
		public ApoSeriesDragDropDragHandle()
		{
		...
		internal override Hashtable ToHashtable()
		{
			...
			if (PathFormatter != PathFormatter_DefaultValue) { h.Add("pathFormatter",PathFormatter); Highstock.AddFunction("ApoSeriesDragDropDragHandlePathFormatter.pathFormatter", PathFormatter); }  
