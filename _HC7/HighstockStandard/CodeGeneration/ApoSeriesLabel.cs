...
{
	public partial class ApoSeriesLabel  : BaseObject
	{
		public ApoSeriesLabel()
		{
			...
			Style = Style_DefaultValue = new ApoSeriesLabelStyle();
		...
		/// </summary>
		public ApoSeriesLabelStyle Style { get; set; }
		private ApoSeriesLabelStyle Style_DefaultValue { get; set; }
