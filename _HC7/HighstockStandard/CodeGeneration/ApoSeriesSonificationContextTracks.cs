...
{
	public partial class ApoSeriesSonificationContextTracks  : BaseObject
	{
		Hashtable h = new Hashtable();

		public ApoSeriesSonificationContextTracks()
		{
			ActiveWhen = ActiveWhen_DefaultValue = new ApoSeriesSonificationContextTracksActiveWhen();
			Instrument = Instrument_DefaultValue = null;
			InstrumentString = InstrumentString_DefaultValue = "null";
			Mapping = Mapping_DefaultValue = new ApoSeriesSonificationContextTracksMapping();
			MidiName = MidiName_DefaultValue = "";
			PointGrouping = PointGrouping_DefaultValue = new ApoSeriesSonificationContextTracksPointGrouping();
			...
			Type = Type_DefaultValue = ApoSeriesSonificationContextTracksType.Instrument;
			ValueInterval = ValueInterval_DefaultValue = null;
			ValueMapFunction = ValueMapFunction_DefaultValue = ApoSeriesSonificationContextTracksValueMapFunction.Linear;
		...
		/// </summary>
		public ApoSeriesSonificationContextTracksActiveWhen ActiveWhen { get; set; }
		private ApoSeriesSonificationContextTracksActiveWhen ActiveWhen_DefaultValue { get; set; }
		...
		/// </summary>
		public ApoSeriesSonificationContextTracksMapping Mapping { get; set; }
		private ApoSeriesSonificationContextTracksMapping Mapping_DefaultValue { get; set; }
		...
		/// </summary>
		public ApoSeriesSonificationContextTracksPointGrouping PointGrouping { get; set; }
		private ApoSeriesSonificationContextTracksPointGrouping PointGrouping_DefaultValue { get; set; }
		...
		/// </summary>
		public ApoSeriesSonificationContextTracksType Type { get; set; }
		private ApoSeriesSonificationContextTracksType Type_DefaultValue { get; set; }
		...
		/// </summary>
		public ApoSeriesSonificationContextTracksValueMapFunction ValueMapFunction { get; set; }
		private ApoSeriesSonificationContextTracksValueMapFunction ValueMapFunction_DefaultValue { get; set; }
