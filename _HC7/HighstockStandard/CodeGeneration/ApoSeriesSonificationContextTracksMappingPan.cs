...
{
	public partial class ApoSeriesSonificationContextTracksMappingPan  : BaseObject
	{
		Hashtable h = new Hashtable();

		public ApoSeriesSonificationContextTracksMappingPan()
		{
			MapFunction = MapFunction_DefaultValue = ApoSeriesSonificationContextTracksMappingPanMapFunction.Linear;
			MapTo = MapTo_DefaultValue = "";
			Max = Max_DefaultValue = null;
			Min = Min_DefaultValue = null;
			Value = Value_DefaultValue = null;
			Within = Within_DefaultValue = ApoSeriesSonificationContextTracksMappingPanWithin.Chart;
		...
		/// </summary>
		public ApoSeriesSonificationContextTracksMappingPanMapFunction MapFunction { get; set; }
		private ApoSeriesSonificationContextTracksMappingPanMapFunction MapFunction_DefaultValue { get; set; }
		...
		/// </summary>
		public ApoSeriesSonificationContextTracksMappingPanWithin Within { get; set; }
		private ApoSeriesSonificationContextTracksMappingPanWithin Within_DefaultValue { get; set; }
