...
{
	public partial class ApoSeriesSonificationContextTracksMappingPitch  : BaseObject
	{
		Hashtable h = new Hashtable();

		public ApoSeriesSonificationContextTracksMappingPitch()
		{
			MapFunction = MapFunction_DefaultValue = ApoSeriesSonificationContextTracksMappingPitchMapFunction.Linear;
		...
		/// </summary>
		public ApoSeriesSonificationContextTracksMappingPitchMapFunction MapFunction { get; set; }
		private ApoSeriesSonificationContextTracksMappingPitchMapFunction MapFunction_DefaultValue { get; set; }
