...
{
	public partial class ApoSeriesSonificationContextTracksMappingTime  : BaseObject
	{
		Hashtable h = new Hashtable();

		public ApoSeriesSonificationContextTracksMappingTime()
		{
			MapFunction = MapFunction_DefaultValue = ApoSeriesSonificationContextTracksMappingTimeMapFunction.Linear;
			MapTo = MapTo_DefaultValue = "";
			Max = Max_DefaultValue = null;
			Min = Min_DefaultValue = null;
			Value = Value_DefaultValue = null;
			Within = Within_DefaultValue = ApoSeriesSonificationContextTracksMappingTimeWithin.Chart;
		...
		/// </summary>
		public ApoSeriesSonificationContextTracksMappingTimeMapFunction MapFunction { get; set; }
		private ApoSeriesSonificationContextTracksMappingTimeMapFunction MapFunction_DefaultValue { get; set; }
		...
		/// </summary>
		public ApoSeriesSonificationContextTracksMappingTimeWithin Within { get; set; }
		private ApoSeriesSonificationContextTracksMappingTimeWithin Within_DefaultValue { get; set; }
