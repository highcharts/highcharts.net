...
{
	public partial class ApoSeriesSonificationContextTracksMappingVolume  : BaseObject
	{
		Hashtable h = new Hashtable();

		public ApoSeriesSonificationContextTracksMappingVolume()
		{
			MapFunction = MapFunction_DefaultValue = ApoSeriesSonificationContextTracksMappingVolumeMapFunction.Linear;
			MapTo = MapTo_DefaultValue = "";
			Max = Max_DefaultValue = null;
			Min = Min_DefaultValue = null;
			Value = Value_DefaultValue = null;
			Within = Within_DefaultValue = ApoSeriesSonificationContextTracksMappingVolumeWithin.Chart;
		...
		/// </summary>
		public ApoSeriesSonificationContextTracksMappingVolumeMapFunction MapFunction { get; set; }
		private ApoSeriesSonificationContextTracksMappingVolumeMapFunction MapFunction_DefaultValue { get; set; }
		...
		/// </summary>
		public ApoSeriesSonificationContextTracksMappingVolumeWithin Within { get; set; }
		private ApoSeriesSonificationContextTracksMappingVolumeWithin Within_DefaultValue { get; set; }
