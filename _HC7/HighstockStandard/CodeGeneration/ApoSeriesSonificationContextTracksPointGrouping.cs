...
{
	public partial class ApoSeriesSonificationContextTracksPointGrouping  : BaseObject
	{
		Hashtable h = new Hashtable();

		public ApoSeriesSonificationContextTracksPointGrouping()
		{
			Algorithm = Algorithm_DefaultValue = ApoSeriesSonificationContextTracksPointGroupingAlgorithm.Minimax;
		...
		/// </summary>
		public ApoSeriesSonificationContextTracksPointGroupingAlgorithm Algorithm { get; set; }
		private ApoSeriesSonificationContextTracksPointGroupingAlgorithm Algorithm_DefaultValue { get; set; }
