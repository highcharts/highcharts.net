...
{
	public partial class ApoSeriesSonificationDefaultInstrumentOptions  : BaseObject
	{
		Hashtable h = new Hashtable();

		public ApoSeriesSonificationDefaultInstrumentOptions()
		{
			ActiveWhen = ActiveWhen_DefaultValue = new ApoSeriesSonificationDefaultInstrumentOptionsActiveWhen();
			Instrument = Instrument_DefaultValue = null;
			InstrumentString = InstrumentString_DefaultValue = "null";
			Mapping = Mapping_DefaultValue = new ApoSeriesSonificationDefaultInstrumentOptionsMapping();
			MidiName = MidiName_DefaultValue = "";
			PointGrouping = PointGrouping_DefaultValue = new ApoSeriesSonificationDefaultInstrumentOptionsPointGrouping();
			RoundToMusicalNotes = RoundToMusicalNotes_DefaultValue = true;
			ShowPlayMarker = ShowPlayMarker_DefaultValue = true;
			Type = Type_DefaultValue = ApoSeriesSonificationDefaultInstrumentOptionsType.Instrument;
		...
		/// </summary>
		public ApoSeriesSonificationDefaultInstrumentOptionsActiveWhen ActiveWhen { get; set; }
		private ApoSeriesSonificationDefaultInstrumentOptionsActiveWhen ActiveWhen_DefaultValue { get; set; }
		...
		/// </summary>
		public ApoSeriesSonificationDefaultInstrumentOptionsMapping Mapping { get; set; }
		private ApoSeriesSonificationDefaultInstrumentOptionsMapping Mapping_DefaultValue { get; set; }
		...
		/// </summary>
		public ApoSeriesSonificationDefaultInstrumentOptionsPointGrouping PointGrouping { get; set; }
		private ApoSeriesSonificationDefaultInstrumentOptionsPointGrouping PointGrouping_DefaultValue { get; set; }
		...
		/// </summary>
		public ApoSeriesSonificationDefaultInstrumentOptionsType Type { get; set; }
		private ApoSeriesSonificationDefaultInstrumentOptionsType Type_DefaultValue { get; set; }
