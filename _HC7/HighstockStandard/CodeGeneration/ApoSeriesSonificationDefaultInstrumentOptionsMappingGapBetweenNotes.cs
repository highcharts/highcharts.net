...
{
	public partial class ApoSeriesSonificationDefaultInstrumentOptionsMappingGapBetweenNotes  : BaseObject
	{
		Hashtable h = new Hashtable();

		public ApoSeriesSonificationDefaultInstrumentOptionsMappingGapBetweenNotes()
		{
			MapFunction = MapFunction_DefaultValue = ApoSeriesSonificationDefaultInstrumentOptionsMappingGapBetweenNotesMapFunction.Linear;
			MapTo = MapTo_DefaultValue = "";
			Max = Max_DefaultValue = null;
			Min = Min_DefaultValue = null;
			Value = Value_DefaultValue = null;
			Within = Within_DefaultValue = ApoSeriesSonificationDefaultInstrumentOptionsMappingGapBetweenNotesWithin.Chart;
		...
		/// </summary>
		public ApoSeriesSonificationDefaultInstrumentOptionsMappingGapBetweenNotesMapFunction MapFunction { get; set; }
		private ApoSeriesSonificationDefaultInstrumentOptionsMappingGapBetweenNotesMapFunction MapFunction_DefaultValue { get; set; }
		...
		/// </summary>
		public ApoSeriesSonificationDefaultInstrumentOptionsMappingGapBetweenNotesWithin Within { get; set; }
		private ApoSeriesSonificationDefaultInstrumentOptionsMappingGapBetweenNotesWithin Within_DefaultValue { get; set; }
