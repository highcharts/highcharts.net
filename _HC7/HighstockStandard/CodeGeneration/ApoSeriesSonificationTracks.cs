...
{
	public partial class ApoSeriesSonificationTracks  : BaseObject
	{
		Hashtable h = new Hashtable();

		public ApoSeriesSonificationTracks()
		{
			ActiveWhen = ActiveWhen_DefaultValue = new ApoSeriesSonificationTracksActiveWhen();
			Instrument = Instrument_DefaultValue = null;
			InstrumentString = InstrumentString_DefaultValue = "null";
			Mapping = Mapping_DefaultValue = new ApoSeriesSonificationTracksMapping();
			MidiName = MidiName_DefaultValue = "";
			PointGrouping = PointGrouping_DefaultValue = new ApoSeriesSonificationTracksPointGrouping();
			RoundToMusicalNotes = RoundToMusicalNotes_DefaultValue = true;
			ShowPlayMarker = ShowPlayMarker_DefaultValue = true;
			Type = Type_DefaultValue = ApoSeriesSonificationTracksType.Instrument;
		...
		/// </summary>
		public ApoSeriesSonificationTracksActiveWhen ActiveWhen { get; set; }
		private ApoSeriesSonificationTracksActiveWhen ActiveWhen_DefaultValue { get; set; }
		...
		/// </summary>
		public ApoSeriesSonificationTracksMapping Mapping { get; set; }
		private ApoSeriesSonificationTracksMapping Mapping_DefaultValue { get; set; }
		...
		/// </summary>
		public ApoSeriesSonificationTracksPointGrouping PointGrouping { get; set; }
		private ApoSeriesSonificationTracksPointGrouping PointGrouping_DefaultValue { get; set; }
		...
		/// </summary>
		public ApoSeriesSonificationTracksType Type { get; set; }
		private ApoSeriesSonificationTracksType Type_DefaultValue { get; set; }
