...
{
	public partial class ApoSeriesSonificationTracksMapping  : BaseObject
	{
		Hashtable h = new Hashtable();

		public ApoSeriesSonificationTracksMapping()
		{
			Frequency = Frequency_DefaultValue = new ApoSeriesSonificationTracksMappingFrequency();
			GapBetweenNotes = GapBetweenNotes_DefaultValue = new ApoSeriesSonificationTracksMappingGapBetweenNotes();
			Highpass = Highpass_DefaultValue = new ApoSeriesSonificationTracksMappingHighpass();
			Lowpass = Lowpass_DefaultValue = new ApoSeriesSonificationTracksMappingLowpass();
			NoteDuration = NoteDuration_DefaultValue = new ApoSeriesSonificationTracksMappingNoteDuration();
			Pan = Pan_DefaultValue = new ApoSeriesSonificationTracksMappingPan();
			Pitch = Pitch_DefaultValue = new ApoSeriesSonificationTracksMappingPitch();
			PitchString = PitchString_DefaultValue = "null";
			PitchNumber = PitchNumber_DefaultValue = null;
			PlayDelay = PlayDelay_DefaultValue = new ApoSeriesSonificationTracksMappingPlayDelay();
			Time = Time_DefaultValue = new ApoSeriesSonificationTracksMappingTime();
			TimeString = TimeString_DefaultValue = "null";
			TimeNumber = TimeNumber_DefaultValue = null;
			Tremolo = Tremolo_DefaultValue = new ApoSeriesSonificationTracksMappingTremolo();
			Volume = Volume_DefaultValue = new ApoSeriesSonificationTracksMappingVolume();
		...
		/// </summary>
		public ApoSeriesSonificationTracksMappingFrequency Frequency { get; set; }
		private ApoSeriesSonificationTracksMappingFrequency Frequency_DefaultValue { get; set; }
		...
		/// </summary>
		public ApoSeriesSonificationTracksMappingGapBetweenNotes GapBetweenNotes { get; set; }
		private ApoSeriesSonificationTracksMappingGapBetweenNotes GapBetweenNotes_DefaultValue { get; set; }
		...
		/// </summary>
		public ApoSeriesSonificationTracksMappingHighpass Highpass { get; set; }
		private ApoSeriesSonificationTracksMappingHighpass Highpass_DefaultValue { get; set; }
		...
		/// </summary>
		public ApoSeriesSonificationTracksMappingLowpass Lowpass { get; set; }
		private ApoSeriesSonificationTracksMappingLowpass Lowpass_DefaultValue { get; set; }
		...
		/// </summary>
		public ApoSeriesSonificationTracksMappingNoteDuration NoteDuration { get; set; }
		private ApoSeriesSonificationTracksMappingNoteDuration NoteDuration_DefaultValue { get; set; }
		...
		/// </summary>
		public ApoSeriesSonificationTracksMappingPan Pan { get; set; }
		private ApoSeriesSonificationTracksMappingPan Pan_DefaultValue { get; set; }
		...
		/// </summary>
		public ApoSeriesSonificationTracksMappingPitch Pitch { get; set; }
		private ApoSeriesSonificationTracksMappingPitch Pitch_DefaultValue { get; set; }
		...
		/// </summary>
		public ApoSeriesSonificationTracksMappingPlayDelay PlayDelay { get; set; }
		private ApoSeriesSonificationTracksMappingPlayDelay PlayDelay_DefaultValue { get; set; }
		...
		/// </summary>
		public ApoSeriesSonificationTracksMappingTime Time { get; set; }
		private ApoSeriesSonificationTracksMappingTime Time_DefaultValue { get; set; }
		...
		/// </summary>
		public ApoSeriesSonificationTracksMappingTremolo Tremolo { get; set; }
		private ApoSeriesSonificationTracksMappingTremolo Tremolo_DefaultValue { get; set; }
		 

		/// <summary>
		/// The volume of notes, from 0 to 1.
		/// </summary>
		public ApoSeriesSonificationTracksMappingVolume Volume { get; set; }
		private ApoSeriesSonificationTracksMappingVolume Volume_DefaultValue { get; set; }
