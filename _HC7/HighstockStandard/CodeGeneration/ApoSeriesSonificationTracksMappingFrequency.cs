...
{
	public partial class ApoSeriesSonificationTracksMappingFrequency  : BaseObject
	{
		Hashtable h = new Hashtable();

		public ApoSeriesSonificationTracksMappingFrequency()
		{
			MapFunction = MapFunction_DefaultValue = ApoSeriesSonificationTracksMappingFrequencyMapFunction.Linear;
			MapTo = MapTo_DefaultValue = "";
			Max = Max_DefaultValue = null;
			Min = Min_DefaultValue = null;
			Value = Value_DefaultValue = null;
			Within = Within_DefaultValue = ApoSeriesSonificationTracksMappingFrequencyWithin.Chart;
		...
		/// </summary>
		public ApoSeriesSonificationTracksMappingFrequencyMapFunction MapFunction { get; set; }
		private ApoSeriesSonificationTracksMappingFrequencyMapFunction MapFunction_DefaultValue { get; set; }
		...
		/// </summary>
		public ApoSeriesSonificationTracksMappingFrequencyWithin Within { get; set; }
		private ApoSeriesSonificationTracksMappingFrequencyWithin Within_DefaultValue { get; set; }
