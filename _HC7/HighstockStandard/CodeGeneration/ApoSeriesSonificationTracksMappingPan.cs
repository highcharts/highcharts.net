...
{
	public partial class ApoSeriesSonificationTracksMappingPan  : BaseObject
	{
		Hashtable h = new Hashtable();

		public ApoSeriesSonificationTracksMappingPan()
		{
			MapFunction = MapFunction_DefaultValue = ApoSeriesSonificationTracksMappingPanMapFunction.Linear;
			MapTo = MapTo_DefaultValue = "";
			Max = Max_DefaultValue = null;
			Min = Min_DefaultValue = null;
			Value = Value_DefaultValue = null;
			Within = Within_DefaultValue = ApoSeriesSonificationTracksMappingPanWithin.Chart;
		...
		/// </summary>
		public ApoSeriesSonificationTracksMappingPanMapFunction MapFunction { get; set; }
		private ApoSeriesSonificationTracksMappingPanMapFunction MapFunction_DefaultValue { get; set; }
		...
		/// </summary>
		public ApoSeriesSonificationTracksMappingPanWithin Within { get; set; }
		private ApoSeriesSonificationTracksMappingPanWithin Within_DefaultValue { get; set; }
