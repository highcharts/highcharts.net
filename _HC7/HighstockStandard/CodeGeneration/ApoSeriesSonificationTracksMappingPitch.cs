...
{
	public partial class ApoSeriesSonificationTracksMappingPitch  : BaseObject
	{
		Hashtable h = new Hashtable();

		public ApoSeriesSonificationTracksMappingPitch()
		{
			MapFunction = MapFunction_DefaultValue = ApoSeriesSonificationTracksMappingPitchMapFunction.Linear;
		...
		/// </summary>
		public ApoSeriesSonificationTracksMappingPitchMapFunction MapFunction { get; set; }
		private ApoSeriesSonificationTracksMappingPitchMapFunction MapFunction_DefaultValue { get; set; }
