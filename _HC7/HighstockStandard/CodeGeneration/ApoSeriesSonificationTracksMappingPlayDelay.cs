...
{
	public partial class ApoSeriesSonificationTracksMappingPlayDelay  : BaseObject
	{
		Hashtable h = new Hashtable();

		public ApoSeriesSonificationTracksMappingPlayDelay()
		{
			MapFunction = MapFunction_DefaultValue = ApoSeriesSonificationTracksMappingPlayDelayMapFunction.Linear;
			MapTo = MapTo_DefaultValue = "";
			Max = Max_DefaultValue = null;
			Min = Min_DefaultValue = null;
			Value = Value_DefaultValue = null;
			Within = Within_DefaultValue = ApoSeriesSonificationTracksMappingPlayDelayWithin.Chart;
		...
		/// </summary>
		public ApoSeriesSonificationTracksMappingPlayDelayMapFunction MapFunction { get; set; }
		private ApoSeriesSonificationTracksMappingPlayDelayMapFunction MapFunction_DefaultValue { get; set; }
		...
		/// </summary>
		public ApoSeriesSonificationTracksMappingPlayDelayWithin Within { get; set; }
		private ApoSeriesSonificationTracksMappingPlayDelayWithin Within_DefaultValue { get; set; }
