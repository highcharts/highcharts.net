...
{
	public partial class ApoSeriesSonificationTracksMappingTime  : BaseObject
	{
		Hashtable h = new Hashtable();

		public ApoSeriesSonificationTracksMappingTime()
		{
			MapFunction = MapFunction_DefaultValue = ApoSeriesSonificationTracksMappingTimeMapFunction.Linear;
			MapTo = MapTo_DefaultValue = "";
			Max = Max_DefaultValue = null;
			Min = Min_DefaultValue = null;
			Value = Value_DefaultValue = null;
			Within = Within_DefaultValue = ApoSeriesSonificationTracksMappingTimeWithin.Chart;
		...
		/// </summary>
		public ApoSeriesSonificationTracksMappingTimeMapFunction MapFunction { get; set; }
		private ApoSeriesSonificationTracksMappingTimeMapFunction MapFunction_DefaultValue { get; set; }
		...
		/// </summary>
		public ApoSeriesSonificationTracksMappingTimeWithin Within { get; set; }
		private ApoSeriesSonificationTracksMappingTimeWithin Within_DefaultValue { get; set; }
