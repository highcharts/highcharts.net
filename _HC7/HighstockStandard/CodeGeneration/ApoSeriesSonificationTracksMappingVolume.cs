...
{
	public partial class ApoSeriesSonificationTracksMappingVolume  : BaseObject
	{
		Hashtable h = new Hashtable();

		public ApoSeriesSonificationTracksMappingVolume()
		{
			MapFunction = MapFunction_DefaultValue = ApoSeriesSonificationTracksMappingVolumeMapFunction.Linear;
			MapTo = MapTo_DefaultValue = "";
			Max = Max_DefaultValue = null;
			Min = Min_DefaultValue = null;
			Value = Value_DefaultValue = null;
			Within = Within_DefaultValue = ApoSeriesSonificationTracksMappingVolumeWithin.Chart;
		...
		/// </summary>
		public ApoSeriesSonificationTracksMappingVolumeMapFunction MapFunction { get; set; }
		private ApoSeriesSonificationTracksMappingVolumeMapFunction MapFunction_DefaultValue { get; set; }
		...
		/// </summary>
		public ApoSeriesSonificationTracksMappingVolumeWithin Within { get; set; }
		private ApoSeriesSonificationTracksMappingVolumeWithin Within_DefaultValue { get; set; }
