...
{
	public partial class ApoSeriesSonificationTracksPointGrouping  : BaseObject
	{
		Hashtable h = new Hashtable();

		public ApoSeriesSonificationTracksPointGrouping()
		{
			Algorithm = Algorithm_DefaultValue = ApoSeriesSonificationTracksPointGroupingAlgorithm.Minimax;
		...
		/// </summary>
		public ApoSeriesSonificationTracksPointGroupingAlgorithm Algorithm { get; set; }
		private ApoSeriesSonificationTracksPointGroupingAlgorithm Algorithm_DefaultValue { get; set; }
