...
{
	public partial class ApoSeriesStatesHoverMarker  : BaseObject
	{
		public ApoSeriesStatesHoverMarker()
		{
			...
			States = States_DefaultValue = new ApoSeriesStatesHoverMarkerStates();
		...
		/// </summary>
		public ApoSeriesStatesHoverMarkerStates States { get; set; }
		private ApoSeriesStatesHoverMarkerStates States_DefaultValue { get; set; }
