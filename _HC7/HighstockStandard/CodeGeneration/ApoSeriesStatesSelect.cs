...
{
	public partial class ApoSeriesStatesSelect  : BaseObject
	{
		Hashtable h = new Hashtable();

		public ApoSeriesStatesSelect()
		{
			Animation = Animation_DefaultValue = new Animation() { Enabled = true };
			AnimationBool = AnimationBool_DefaultValue = null;
			Enabled = Enabled_DefaultValue = true;
			Halo = Halo_DefaultValue = new ApoSeriesStatesSelectHalo();
			LineWidth = LineWidth_DefaultValue = null;
			LineWidthPlus = LineWidthPlus_DefaultValue = 1;
			Marker = Marker_DefaultValue = new ApoSeriesStatesSelectMarker();
		...
		/// </summary>
		public ApoSeriesStatesSelectHalo Halo { get; set; }
		private ApoSeriesStatesSelectHalo Halo_DefaultValue { get; set; }
		...
		/// </summary>
		public ApoSeriesStatesSelectMarker Marker { get; set; }
		private ApoSeriesStatesSelectMarker Marker_DefaultValue { get; set; }
