...
{
	public partial class AreaSeries  : Series
	{
		Hashtable h = new Hashtable();

		public AreaSeries()
		{
			Accessibility = Accessibility_DefaultValue = new AreaSeriesAccessibility();
			AllowPointSelect = AllowPointSelect_DefaultValue = false;
			Animation = Animation_DefaultValue = new Animation() { Enabled = true };
			AnimationBool = AnimationBool_DefaultValue = true;
			AnimationLimit = AnimationLimit_DefaultValue = null;
			BoostBlending = BoostBlending_DefaultValue = AreaSeriesBoostBlending.Undefined;
			...
			Compare = Compare_DefaultValue = AreaSeriesCompare.Percent;
			...
			Cursor = Cursor_DefaultValue = AreaSeriesCursor.Null;
			Custom = Custom_DefaultValue = new Hashtable();
			DashStyle = DashStyle_DefaultValue = AreaSeriesDashStyle.Null;
			Data = Data_DefaultValue = new List<AreaSeriesData>();
			DataGrouping = DataGrouping_DefaultValue = new AreaSeriesDataGrouping();
			DataLabels = DataLabels_DefaultValue = new AreaSeriesDataLabels();
			DataSorting = DataSorting_DefaultValue = new AreaSeriesDataSorting();
			Description = Description_DefaultValue = "";
			DragDrop = DragDrop_DefaultValue = new AreaSeriesDragDrop();
			Dumbell = Dumbell_DefaultValue = new AreaSeriesDumbell();
			EnableMouseTracking = EnableMouseTracking_DefaultValue = true;
			Events = Events_DefaultValue = new AreaSeriesEvents();
			FillColor = FillColor_DefaultValue = "";
			FillOpacity = FillOpacity_DefaultValue = null;
			FindNearestPointBy = FindNearestPointBy_DefaultValue = AreaSeriesFindNearestPointBy.X;
			GapSize = GapSize_DefaultValue = 0;
			GapUnit = GapUnit_DefaultValue = AreaSeriesGapUnit.Relative;
			...
			Label = Label_DefaultValue = new AreaSeriesLabel();
			LastPrice = LastPrice_DefaultValue = new AreaSeriesLastPrice();
			LastVisiblePrice = LastVisiblePrice_DefaultValue = new AreaSeriesLastVisiblePrice();
			LegendIndex = LegendIndex_DefaultValue = null;
			LegendSymbol = LegendSymbol_DefaultValue = AreaSeriesLegendSymbol.Rectangle;
			Linecap = Linecap_DefaultValue = AreaSeriesLinecap.Round;
			LineColor = LineColor_DefaultValue = "";
			LineWidth = LineWidth_DefaultValue = 2;
			LinkedTo = LinkedTo_DefaultValue = "";
			Marker = Marker_DefaultValue = new AreaSeriesMarker();
			Name = Name_DefaultValue = "";
			NegativeColor = NegativeColor_DefaultValue = "";
			NegativeFillColor = NegativeFillColor_DefaultValue = "";
			OnPoint = OnPoint_DefaultValue = new AreaSeriesOnPoint();
			Opacity = Opacity_DefaultValue = 1;
			Point = Point_DefaultValue = new AreaSeriesPoint();
			PointDescriptionFormat = PointDescriptionFormat_DefaultValue = "";
			PointDescriptionFormatter = PointDescriptionFormatter_DefaultValue = "";
			PointInterval = PointInterval_DefaultValue = 1;
			PointIntervalUnit = PointIntervalUnit_DefaultValue = AreaSeriesPointIntervalUnit.Null;
			...
			Sonification = Sonification_DefaultValue = new AreaSeriesSonification();
			Stack = Stack_DefaultValue = "";
			StackNumber = StackNumber_DefaultValue = null;
			Stacking = Stacking_DefaultValue = AreaSeriesStacking.Null;
			States = States_DefaultValue = new AreaSeriesStates();
			Step = Step_DefaultValue = AreaSeriesStep.Null;
			...
			Zones = Zones_DefaultValue = new List<AreaSeriesZones>();
		...
		/// </summary>
		public AreaSeriesAccessibility Accessibility { get; set; }
		private AreaSeriesAccessibility Accessibility_DefaultValue { get; set; }
		...
		/// </summary>
		public AreaSeriesBoostBlending BoostBlending { get; set; }
		private AreaSeriesBoostBlending BoostBlending_DefaultValue { get; set; }
		...
		/// </summary>
		public AreaSeriesCompare Compare { get; set; }
		private AreaSeriesCompare Compare_DefaultValue { get; set; }
		 

		/// <summary>
		/// When [compare](#plotOptions.series.compare) is `percent`, this optiondictates whether to use 0 or 100 as the base of comparison.
		/// </summary>
		public AreaSeriesCompareBase CompareBase { get; set; }
		private AreaSeriesCompareBase CompareBase_DefaultValue { get; set; }
		...
		/// </summary>
		public AreaSeriesDataGrouping DataGrouping { get; set; }
		private AreaSeriesDataGrouping DataGrouping_DefaultValue { get; set; }
		...
		/// </summary>
		public AreaSeriesDataSorting DataSorting { get; set; }
		private AreaSeriesDataSorting DataSorting_DefaultValue { get; set; }
		...
		/// </summary>
		public AreaSeriesDragDrop DragDrop { get; set; }
		private AreaSeriesDragDrop DragDrop_DefaultValue { get; set; }
		 

		/// <summary>
		/// 
		/// </summary>
		public AreaSeriesDumbell Dumbell { get; set; }
		private AreaSeriesDumbell Dumbell_DefaultValue { get; set; }
		...
		/// </summary>
		public AreaSeriesFindNearestPointBy FindNearestPointBy { get; set; }
		private AreaSeriesFindNearestPointBy FindNearestPointBy_DefaultValue { get; set; }
		...
		/// </summary>
		public AreaSeriesGapUnit GapUnit { get; set; }
		private AreaSeriesGapUnit GapUnit_DefaultValue { get; set; }
		...
		/// </summary>
		public AreaSeriesLabel Label { get; set; }
		private AreaSeriesLabel Label_DefaultValue { get; set; }
		 

		/// <summary>
		/// The line marks the last price from all points.
		/// </summary>
		public AreaSeriesLastPrice LastPrice { get; set; }
		private AreaSeriesLastPrice LastPrice_DefaultValue { get; set; }
		 

		/// <summary>
		/// The line marks the last price from visible range of points.
		/// </summary>
		public AreaSeriesLastVisiblePrice LastVisiblePrice { get; set; }
		private AreaSeriesLastVisiblePrice LastVisiblePrice_DefaultValue { get; set; }
		...
		/// </summary>
		public AreaSeriesLegendSymbol LegendSymbol { get; set; }
		private AreaSeriesLegendSymbol LegendSymbol_DefaultValue { get; set; }
		...
		/// </summary>
		public AreaSeriesOnPoint OnPoint { get; set; }
		private AreaSeriesOnPoint OnPoint_DefaultValue { get; set; }
		...
		/// </summary>
		public AreaSeriesSonification Sonification { get; set; }
		private AreaSeriesSonification Sonification_DefaultValue { get; set; }
		...
		/// </summary>
		public List<AreaSeriesZones> Zones { get; set; }
		private List<AreaSeriesZones> Zones_DefaultValue { get; set; }
