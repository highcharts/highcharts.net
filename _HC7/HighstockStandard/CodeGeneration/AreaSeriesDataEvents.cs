...
namespace Highsoft.Web.Mvc.Stocks
{
	public partial class AreaSeriesDataEvents  : BaseObject
	{
		...
		internal override Hashtable ToHashtable()
		{
			...
			if (Drag != Drag_DefaultValue) { h.Add("drag",Drag); Highstock.AddFunction("AreaSeriesDataEventsDrag.drag", Drag); }  
			if (DragStart != DragStart_DefaultValue) { h.Add("dragStart",DragStart); Highstock.AddFunction("AreaSeriesDataEventsDragStart.dragStart", DragStart); }  
			if (Drop != Drop_DefaultValue) { h.Add("drop",Drop); Highstock.AddFunction("AreaSeriesDataEventsDrop.drop", Drop); }  
