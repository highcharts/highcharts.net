...
{
	public partial class AreaSeriesSonificationContextTracksMapping  : BaseObject
	{
		Hashtable h = new Hashtable();

		public AreaSeriesSonificationContextTracksMapping()
		{
			Frequency = Frequency_DefaultValue = new AreaSeriesSonificationContextTracksMappingFrequency();
			GapBetweenNotes = GapBetweenNotes_DefaultValue = new AreaSeriesSonificationContextTracksMappingGapBetweenNotes();
			Highpass = Highpass_DefaultValue = new AreaSeriesSonificationContextTracksMappingHighpass();
			Lowpass = Lowpass_DefaultValue = new AreaSeriesSonificationContextTracksMappingLowpass();
			NoteDuration = NoteDuration_DefaultValue = new AreaSeriesSonificationContextTracksMappingNoteDuration();
			Pan = Pan_DefaultValue = new AreaSeriesSonificationContextTracksMappingPan();
			Pitch = Pitch_DefaultValue = new AreaSeriesSonificationContextTracksMappingPitch();
			PitchString = PitchString_DefaultValue = "null";
			PitchNumber = PitchNumber_DefaultValue = null;
			PlayDelay = PlayDelay_DefaultValue = new AreaSeriesSonificationContextTracksMappingPlayDelay();
			Time = Time_DefaultValue = new AreaSeriesSonificationContextTracksMappingTime();
			TimeString = TimeString_DefaultValue = "null";
			TimeNumber = TimeNumber_DefaultValue = null;
			Tremolo = Tremolo_DefaultValue = new AreaSeriesSonificationContextTracksMappingTremolo();
			Volume = Volume_DefaultValue = new AreaSeriesSonificationContextTracksMappingVolume();
		...
		/// </summary>
		public AreaSeriesSonificationContextTracksMappingFrequency Frequency { get; set; }
		private AreaSeriesSonificationContextTracksMappingFrequency Frequency_DefaultValue { get; set; }
		...
		/// </summary>
		public AreaSeriesSonificationContextTracksMappingGapBetweenNotes GapBetweenNotes { get; set; }
		private AreaSeriesSonificationContextTracksMappingGapBetweenNotes GapBetweenNotes_DefaultValue { get; set; }
		...
		/// </summary>
		public AreaSeriesSonificationContextTracksMappingHighpass Highpass { get; set; }
		private AreaSeriesSonificationContextTracksMappingHighpass Highpass_DefaultValue { get; set; }
		...
		/// </summary>
		public AreaSeriesSonificationContextTracksMappingLowpass Lowpass { get; set; }
		private AreaSeriesSonificationContextTracksMappingLowpass Lowpass_DefaultValue { get; set; }
		...
		/// </summary>
		public AreaSeriesSonificationContextTracksMappingNoteDuration NoteDuration { get; set; }
		private AreaSeriesSonificationContextTracksMappingNoteDuration NoteDuration_DefaultValue { get; set; }
		...
		/// </summary>
		public AreaSeriesSonificationContextTracksMappingPan Pan { get; set; }
		private AreaSeriesSonificationContextTracksMappingPan Pan_DefaultValue { get; set; }
		...
		/// </summary>
		public AreaSeriesSonificationContextTracksMappingPitch Pitch { get; set; }
		private AreaSeriesSonificationContextTracksMappingPitch Pitch_DefaultValue { get; set; }
		...
		/// </summary>
		public AreaSeriesSonificationContextTracksMappingPlayDelay PlayDelay { get; set; }
		private AreaSeriesSonificationContextTracksMappingPlayDelay PlayDelay_DefaultValue { get; set; }
		...
		/// </summary>
		public AreaSeriesSonificationContextTracksMappingTime Time { get; set; }
		private AreaSeriesSonificationContextTracksMappingTime Time_DefaultValue { get; set; }
		...
		/// </summary>
		public AreaSeriesSonificationContextTracksMappingTremolo Tremolo { get; set; }
		private AreaSeriesSonificationContextTracksMappingTremolo Tremolo_DefaultValue { get; set; }
		 

		/// <summary>
		/// The volume of notes, from 0 to 1.
		/// </summary>
		public AreaSeriesSonificationContextTracksMappingVolume Volume { get; set; }
		private AreaSeriesSonificationContextTracksMappingVolume Volume_DefaultValue { get; set; }
