...
{
	public partial class AreaSeriesSonificationTracksMapping  : BaseObject
	{
		Hashtable h = new Hashtable();

		public AreaSeriesSonificationTracksMapping()
		{
			Frequency = Frequency_DefaultValue = new AreaSeriesSonificationTracksMappingFrequency();
			GapBetweenNotes = GapBetweenNotes_DefaultValue = new AreaSeriesSonificationTracksMappingGapBetweenNotes();
			Highpass = Highpass_DefaultValue = new AreaSeriesSonificationTracksMappingHighpass();
			Lowpass = Lowpass_DefaultValue = new AreaSeriesSonificationTracksMappingLowpass();
			NoteDuration = NoteDuration_DefaultValue = new AreaSeriesSonificationTracksMappingNoteDuration();
			Pan = Pan_DefaultValue = new AreaSeriesSonificationTracksMappingPan();
			Pitch = Pitch_DefaultValue = new AreaSeriesSonificationTracksMappingPitch();
			PitchString = PitchString_DefaultValue = "null";
			PitchNumber = PitchNumber_DefaultValue = null;
			PlayDelay = PlayDelay_DefaultValue = new AreaSeriesSonificationTracksMappingPlayDelay();
			Time = Time_DefaultValue = new AreaSeriesSonificationTracksMappingTime();
			TimeString = TimeString_DefaultValue = "null";
			TimeNumber = TimeNumber_DefaultValue = null;
			Tremolo = Tremolo_DefaultValue = new AreaSeriesSonificationTracksMappingTremolo();
			Volume = Volume_DefaultValue = new AreaSeriesSonificationTracksMappingVolume();
		...
		/// </summary>
		public AreaSeriesSonificationTracksMappingFrequency Frequency { get; set; }
		private AreaSeriesSonificationTracksMappingFrequency Frequency_DefaultValue { get; set; }
		...
		/// </summary>
		public AreaSeriesSonificationTracksMappingGapBetweenNotes GapBetweenNotes { get; set; }
		private AreaSeriesSonificationTracksMappingGapBetweenNotes GapBetweenNotes_DefaultValue { get; set; }
		...
		/// </summary>
		public AreaSeriesSonificationTracksMappingHighpass Highpass { get; set; }
		private AreaSeriesSonificationTracksMappingHighpass Highpass_DefaultValue { get; set; }
		...
		/// </summary>
		public AreaSeriesSonificationTracksMappingLowpass Lowpass { get; set; }
		private AreaSeriesSonificationTracksMappingLowpass Lowpass_DefaultValue { get; set; }
		...
		/// </summary>
		public AreaSeriesSonificationTracksMappingNoteDuration NoteDuration { get; set; }
		private AreaSeriesSonificationTracksMappingNoteDuration NoteDuration_DefaultValue { get; set; }
		...
		/// </summary>
		public AreaSeriesSonificationTracksMappingPan Pan { get; set; }
		private AreaSeriesSonificationTracksMappingPan Pan_DefaultValue { get; set; }
		...
		/// </summary>
		public AreaSeriesSonificationTracksMappingPitch Pitch { get; set; }
		private AreaSeriesSonificationTracksMappingPitch Pitch_DefaultValue { get; set; }
		...
		/// </summary>
		public AreaSeriesSonificationTracksMappingPlayDelay PlayDelay { get; set; }
		private AreaSeriesSonificationTracksMappingPlayDelay PlayDelay_DefaultValue { get; set; }
		...
		/// </summary>
		public AreaSeriesSonificationTracksMappingTime Time { get; set; }
		private AreaSeriesSonificationTracksMappingTime Time_DefaultValue { get; set; }
		...
		/// </summary>
		public AreaSeriesSonificationTracksMappingTremolo Tremolo { get; set; }
		private AreaSeriesSonificationTracksMappingTremolo Tremolo_DefaultValue { get; set; }
		 

		/// <summary>
		/// The volume of notes, from 0 to 1.
		/// </summary>
		public AreaSeriesSonificationTracksMappingVolume Volume { get; set; }
		private AreaSeriesSonificationTracksMappingVolume Volume_DefaultValue { get; set; }
