...
namespace Highsoft.Web.Mvc.Stocks
{
	public partial class AreaSeriesStatesHoverMarkerStates  : BaseObject
	{
		public AreaSeriesStatesHoverMarkerStates()
		{
			...
			Inactive = Inactive_DefaultValue = new AreaSeriesStatesHoverMarkerStatesInactive();
		...
		/// 
		/// </summary>
		public AreaSeriesStatesHoverMarkerStatesInactive Inactive { get; set; }
		private AreaSeriesStatesHoverMarkerStatesInactive Inactive_DefaultValue { get; set; }
