...
{
	public partial class ArearangeSeries  : Series
	{
		Hashtable h = new Hashtable();

		public ArearangeSeries()
		{
			Accessibility = Accessibility_DefaultValue = new ArearangeSeriesAccessibility();
			AllowPointSelect = AllowPointSelect_DefaultValue = false;
			Animation = Animation_DefaultValue = new Animation() { Enabled = true };
			AnimationBool = AnimationBool_DefaultValue = true;
			AnimationLimit = AnimationLimit_DefaultValue = null;
			BoostBlending = BoostBlending_DefaultValue = ArearangeSeriesBoostBlending.Undefined;
			...
			Compare = Compare_DefaultValue = ArearangeSeriesCompare.Percent;
			CompareBase = CompareBase_DefaultValue = ArearangeSeriesCompareBase.Min;
			...
			DashStyle = DashStyle_DefaultValue = ArearangeSeriesDashStyle.Null;
			Data = Data_DefaultValue = new List<ArearangeSeriesData>();
			DataGrouping = DataGrouping_DefaultValue = new ArearangeSeriesDataGrouping();
			DataLabels = DataLabels_DefaultValue = new ArearangeSeriesDataLabels();
			DataSorting = DataSorting_DefaultValue = new ArearangeSeriesDataSorting();
			Description = Description_DefaultValue = "";
			DragDrop = DragDrop_DefaultValue = new ArearangeSeriesDragDrop();
			Dumbell = Dumbell_DefaultValue = new ArearangeSeriesDumbell();
			...
			GapUnit = GapUnit_DefaultValue = ArearangeSeriesGapUnit.Relative;
			...
			Label = Label_DefaultValue = new ArearangeSeriesLabel();
			...
			LowMarker = LowMarker_DefaultValue = new ArearangeSeriesLowMarker();
			...
			OnPoint = OnPoint_DefaultValue = new ArearangeSeriesOnPoint();
			...
			Zones = Zones_DefaultValue = new List<ArearangeSeriesZones>();
		...
		/// </summary>
		public ArearangeSeriesAccessibility Accessibility { get; set; }
		private ArearangeSeriesAccessibility Accessibility_DefaultValue { get; set; }
		...
		/// </summary>
		public ArearangeSeriesBoostBlending BoostBlending { get; set; }
		private ArearangeSeriesBoostBlending BoostBlending_DefaultValue { get; set; }
		...
		/// </summary>
		public ArearangeSeriesCompare Compare { get; set; }
		private ArearangeSeriesCompare Compare_DefaultValue { get; set; }
		 

		/// <summary>
		/// When [compare](#plotOptions.series.compare) is `percent`, this optiondictates whether to use 0 or 100 as the base of comparison.
		/// </summary>
		public ArearangeSeriesCompareBase CompareBase { get; set; }
		private ArearangeSeriesCompareBase CompareBase_DefaultValue { get; set; }
		...
		/// </summary>
		public ArearangeSeriesDataSorting DataSorting { get; set; }
		private ArearangeSeriesDataSorting DataSorting_DefaultValue { get; set; }
		...
		/// 
		/// </summary>
		public ArearangeSeriesDumbell Dumbell { get; set; }
		private ArearangeSeriesDumbell Dumbell_DefaultValue { get; set; }
		...
		/// </summary>
		public ArearangeSeriesGapUnit GapUnit { get; set; }
		private ArearangeSeriesGapUnit GapUnit_DefaultValue { get; set; }
		...
		/// </summary>
		public ArearangeSeriesLabel Label { get; set; }
		private ArearangeSeriesLabel Label_DefaultValue { get; set; }
		 

		/// <summary>
		/// The line marks the last price from all points.
		/// </summary>
		public ArearangeSeriesLastPrice LastPrice { get; set; }
		private ArearangeSeriesLastPrice LastPrice_DefaultValue { get; set; }
		 

		/// <summary>
		/// The line marks the last price from visible range of points.
		/// </summary>
		public ArearangeSeriesLastVisiblePrice LastVisiblePrice { get; set; }
		private ArearangeSeriesLastVisiblePrice LastVisiblePrice_DefaultValue { get; set; }
		...
		/// </summary>
		public ArearangeSeriesLowMarker LowMarker { get; set; }
		private ArearangeSeriesLowMarker LowMarker_DefaultValue { get; set; }
		...
		/// </summary>
		public ArearangeSeriesMarker Marker { get; set; }
		private ArearangeSeriesMarker Marker_DefaultValue { get; set; }
		...
		/// </summary>
		public ArearangeSeriesOnPoint OnPoint { get; set; }
		private ArearangeSeriesOnPoint OnPoint_DefaultValue { get; set; }
		...
		/// </summary>
		public List<ArearangeSeriesZones> Zones { get; set; }
		private List<ArearangeSeriesZones> Zones_DefaultValue { get; set; }
