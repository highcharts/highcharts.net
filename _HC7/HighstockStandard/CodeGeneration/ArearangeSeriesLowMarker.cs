...
{
	public partial class ArearangeSeriesLowMarker  : BaseObject
	{
		Hashtable h = new Hashtable();

		public ArearangeSeriesLowMarker()
		{
			...
			States = States_DefaultValue = new ArearangeSeriesLowMarkerStates();
		...
		/// </summary>
		public ArearangeSeriesLowMarkerStates States { get; set; }
		private ArearangeSeriesLowMarkerStates States_DefaultValue { get; set; }
