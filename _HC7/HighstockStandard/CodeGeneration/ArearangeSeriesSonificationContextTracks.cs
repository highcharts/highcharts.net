...
namespace Highsoft.Web.Mvc.Stocks
{
	public partial class ArearangeSeriesSonificationContextTracks  : BaseObject
	{
		...
		internal override Hashtable ToHashtable(Highstock highstock)
		{
			...
			if (Type != ArearangeSeriesSonificationContextTracksType.Null) h.Add("type", highstock.FirstCharacterToLower(Type.ToString()));
			if (ValueInterval != null) h.Add("valueInterval",ValueInterval);
			if (ValueMapFunction != ArearangeSeriesSonificationContextTracksValueMapFunction.Null) h.Add("valueMapFunction", highstock.FirstCharacterToLower(ValueMapFunction.ToString()));
