...
{
	public partial class ArearangeSeriesSonificationContextTracksMapping  : BaseObject
	{
		Hashtable h = new Hashtable();

		public ArearangeSeriesSonificationContextTracksMapping()
		{
			Frequency = Frequency_DefaultValue = new ArearangeSeriesSonificationContextTracksMappingFrequency();
			GapBetweenNotes = GapBetweenNotes_DefaultValue = new ArearangeSeriesSonificationContextTracksMappingGapBetweenNotes();
			Highpass = Highpass_DefaultValue = new ArearangeSeriesSonificationContextTracksMappingHighpass();
			Lowpass = Lowpass_DefaultValue = new ArearangeSeriesSonificationContextTracksMappingLowpass();
			NoteDuration = NoteDuration_DefaultValue = new ArearangeSeriesSonificationContextTracksMappingNoteDuration();
			Pan = Pan_DefaultValue = new ArearangeSeriesSonificationContextTracksMappingPan();
			Pitch = Pitch_DefaultValue = new ArearangeSeriesSonificationContextTracksMappingPitch();
			PitchString = PitchString_DefaultValue = "null";
			PitchNumber = PitchNumber_DefaultValue = null;
			PlayDelay = PlayDelay_DefaultValue = new ArearangeSeriesSonificationContextTracksMappingPlayDelay();
			Time = Time_DefaultValue = new ArearangeSeriesSonificationContextTracksMappingTime();
			TimeString = TimeString_DefaultValue = "null";
			TimeNumber = TimeNumber_DefaultValue = null;
			Tremolo = Tremolo_DefaultValue = new ArearangeSeriesSonificationContextTracksMappingTremolo();
			Volume = Volume_DefaultValue = new ArearangeSeriesSonificationContextTracksMappingVolume();
		...
		/// </summary>
		public ArearangeSeriesSonificationContextTracksMappingFrequency Frequency { get; set; }
		private ArearangeSeriesSonificationContextTracksMappingFrequency Frequency_DefaultValue { get; set; }
		...
		/// </summary>
		public ArearangeSeriesSonificationContextTracksMappingGapBetweenNotes GapBetweenNotes { get; set; }
		private ArearangeSeriesSonificationContextTracksMappingGapBetweenNotes GapBetweenNotes_DefaultValue { get; set; }
		...
		/// </summary>
		public ArearangeSeriesSonificationContextTracksMappingHighpass Highpass { get; set; }
		private ArearangeSeriesSonificationContextTracksMappingHighpass Highpass_DefaultValue { get; set; }
		...
		/// </summary>
		public ArearangeSeriesSonificationContextTracksMappingLowpass Lowpass { get; set; }
		private ArearangeSeriesSonificationContextTracksMappingLowpass Lowpass_DefaultValue { get; set; }
		...
		/// </summary>
		public ArearangeSeriesSonificationContextTracksMappingNoteDuration NoteDuration { get; set; }
		private ArearangeSeriesSonificationContextTracksMappingNoteDuration NoteDuration_DefaultValue { get; set; }
		...
		/// </summary>
		public ArearangeSeriesSonificationContextTracksMappingPan Pan { get; set; }
		private ArearangeSeriesSonificationContextTracksMappingPan Pan_DefaultValue { get; set; }
		...
		/// </summary>
		public ArearangeSeriesSonificationContextTracksMappingPitch Pitch { get; set; }
		private ArearangeSeriesSonificationContextTracksMappingPitch Pitch_DefaultValue { get; set; }
		...
		/// </summary>
		public ArearangeSeriesSonificationContextTracksMappingPlayDelay PlayDelay { get; set; }
		private ArearangeSeriesSonificationContextTracksMappingPlayDelay PlayDelay_DefaultValue { get; set; }
		...
		/// </summary>
		public ArearangeSeriesSonificationContextTracksMappingTime Time { get; set; }
		private ArearangeSeriesSonificationContextTracksMappingTime Time_DefaultValue { get; set; }
		...
		/// </summary>
		public ArearangeSeriesSonificationContextTracksMappingTremolo Tremolo { get; set; }
		private ArearangeSeriesSonificationContextTracksMappingTremolo Tremolo_DefaultValue { get; set; }
		 

		/// <summary>
		/// The volume of notes, from 0 to 1.
		/// </summary>
		public ArearangeSeriesSonificationContextTracksMappingVolume Volume { get; set; }
		private ArearangeSeriesSonificationContextTracksMappingVolume Volume_DefaultValue { get; set; }
