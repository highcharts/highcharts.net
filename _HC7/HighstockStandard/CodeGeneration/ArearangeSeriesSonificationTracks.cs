...
{
	public partial class ArearangeSeriesSonificationTracks  : BaseObject
	{
		Hashtable h = new Hashtable();

		public ArearangeSeriesSonificationTracks()
		{
			ActiveWhen = ActiveWhen_DefaultValue = new ArearangeSeriesSonificationTracksActiveWhen();
			Instrument = Instrument_DefaultValue = null;
			InstrumentString = InstrumentString_DefaultValue = "null";
			Mapping = Mapping_DefaultValue = new ArearangeSeriesSonificationTracksMapping();
			MidiName = MidiName_DefaultValue = "";
			PointGrouping = PointGrouping_DefaultValue = new ArearangeSeriesSonificationTracksPointGrouping();
			RoundToMusicalNotes = RoundToMusicalNotes_DefaultValue = true;
			ShowPlayMarker = ShowPlayMarker_DefaultValue = true;
			Type = Type_DefaultValue = ArearangeSeriesSonificationTracksType.Instrument;
		...
		/// </summary>
		public ArearangeSeriesSonificationTracksActiveWhen ActiveWhen { get; set; }
		private ArearangeSeriesSonificationTracksActiveWhen ActiveWhen_DefaultValue { get; set; }
		...
		/// </summary>
		public ArearangeSeriesSonificationTracksMapping Mapping { get; set; }
		private ArearangeSeriesSonificationTracksMapping Mapping_DefaultValue { get; set; }
		...
		/// </summary>
		public ArearangeSeriesSonificationTracksPointGrouping PointGrouping { get; set; }
		private ArearangeSeriesSonificationTracksPointGrouping PointGrouping_DefaultValue { get; set; }
		...
		/// </summary>
		public ArearangeSeriesSonificationTracksType Type { get; set; }
		private ArearangeSeriesSonificationTracksType Type_DefaultValue { get; set; }
