...
namespace Highsoft.Web.Mvc.Stocks
{
	public partial class AreasplineSeries  : Series
	{
		...
		{
			Accessibility = Accessibility_DefaultValue = new AreasplineSeriesAccessibility();
			...
			Compare = Compare_DefaultValue = AreasplineSeriesCompare.Percent;
			CompareBase = CompareBase_DefaultValue = AreasplineSeriesCompareBase.Min;
			...
			DashStyle = DashStyle_DefaultValue = AreasplineSeriesDashStyle.Null;
			...
			DataSorting = DataSorting_DefaultValue = new AreasplineSeriesDataSorting();
			Description = Description_DefaultValue = "";
			DragDrop = DragDrop_DefaultValue = new AreasplineSeriesDragDrop();
			Dumbell = Dumbell_DefaultValue = new AreasplineSeriesDumbell();
			...
			FindNearestPointBy = FindNearestPointBy_DefaultValue = AreasplineSeriesFindNearestPointBy.X;
			GapSize = GapSize_DefaultValue = 0;
			GapUnit = GapUnit_DefaultValue = AreasplineSeriesGapUnit.Relative;
			...
			Label = Label_DefaultValue = new AreasplineSeriesLabel();
			LastPrice = LastPrice_DefaultValue = new AreasplineSeriesLastPrice();
			LastVisiblePrice = LastVisiblePrice_DefaultValue = new AreasplineSeriesLastVisiblePrice();
			LegendIndex = LegendIndex_DefaultValue = null;
			LegendSymbol = LegendSymbol_DefaultValue = AreasplineSeriesLegendSymbol.Rectangle;
			Linecap = Linecap_DefaultValue = AreasplineSeriesLinecap.Round;
			...
			OnPoint = OnPoint_DefaultValue = new AreasplineSeriesOnPoint();
			...
			Sonification = Sonification_DefaultValue = new AreasplineSeriesSonification();
			...
			Zones = Zones_DefaultValue = new List<AreasplineSeriesZones>();
		...
		/// </summary>
		public AreasplineSeriesAccessibility Accessibility { get; set; }
		private AreasplineSeriesAccessibility Accessibility_DefaultValue { get; set; }
		...
		/// </summary>
		public AreasplineSeriesCompare Compare { get; set; }
		private AreasplineSeriesCompare Compare_DefaultValue { get; set; }
		 

		/// <summary>
		/// When [compare](#plotOptions.series.compare) is `percent`, this optiondictates whether to use 0 or 100 as the base of comparison.
		/// </summary>
		public AreasplineSeriesCompareBase CompareBase { get; set; }
		private AreasplineSeriesCompareBase CompareBase_DefaultValue { get; set; }
		...
		/// </summary>
		public AreasplineSeriesDataSorting DataSorting { get; set; }
		private AreasplineSeriesDataSorting DataSorting_DefaultValue { get; set; }
		...
		/// </summary>
		public AreasplineSeriesDragDrop DragDrop { get; set; }
		private AreasplineSeriesDragDrop DragDrop_DefaultValue { get; set; }
		 

		/// <summary>
		/// 
		/// </summary>
		public AreasplineSeriesDumbell Dumbell { get; set; }
		private AreasplineSeriesDumbell Dumbell_DefaultValue { get; set; }
		...
		/// </summary>
		public AreasplineSeriesFindNearestPointBy FindNearestPointBy { get; set; }
		private AreasplineSeriesFindNearestPointBy FindNearestPointBy_DefaultValue { get; set; }
		...
		/// </summary>
		public AreasplineSeriesGapUnit GapUnit { get; set; }
		private AreasplineSeriesGapUnit GapUnit_DefaultValue { get; set; }
		...
		/// </summary>
		public AreasplineSeriesLastPrice LastPrice { get; set; }
		private AreasplineSeriesLastPrice LastPrice_DefaultValue { get; set; }
		 

		/// <summary>
		/// The line marks the last price from visible range of points.
		/// </summary>
		public AreasplineSeriesLastVisiblePrice LastVisiblePrice { get; set; }
		private AreasplineSeriesLastVisiblePrice LastVisiblePrice_DefaultValue { get; set; }
		...
		/// </summary>
		public AreasplineSeriesLegendSymbol LegendSymbol { get; set; }
		private AreasplineSeriesLegendSymbol LegendSymbol_DefaultValue { get; set; }
		...
		/// </summary>
		public AreasplineSeriesOnPoint OnPoint { get; set; }
		private AreasplineSeriesOnPoint OnPoint_DefaultValue { get; set; }
		...
		/// </summary>
		public AreasplineSeriesSonification Sonification { get; set; }
		private AreasplineSeriesSonification Sonification_DefaultValue { get; set; }
		...
		/// </summary>
		public List<AreasplineSeriesZones> Zones { get; set; }
		private List<AreasplineSeriesZones> Zones_DefaultValue { get; set; }
