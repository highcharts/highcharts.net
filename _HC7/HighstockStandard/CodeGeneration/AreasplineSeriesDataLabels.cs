...
namespace Highsoft.Web.Mvc.Stocks
{
	public partial class AreasplineSeriesDataLabels  : BaseObject
	{
		...
		{
			if (Align != AreasplineSeriesDataLabelsAlign.Null) h.Add("align", highstock.FirstCharacterToLower(Align.ToString()));
			...
			if (Overflow != AreasplineSeriesDataLabelsOverflow.Null) h.Add("overflow", highstock.FirstCharacterToLower(Overflow.ToString()));
			if (Padding != null) h.Add("padding",Padding);
			if (Position != AreasplineSeriesDataLabelsPosition.Null) h.Add("position", highstock.FirstCharacterToLower(Position.ToString()));
			...
			if (VerticalAlign != AreasplineSeriesDataLabelsVerticalAlign.Null) h.Add("verticalAlign", highstock.FirstCharacterToLower(VerticalAlign.ToString()));
			if (X != null) h.Add("x",X);
			if (Y != null) h.Add("y",Y);
