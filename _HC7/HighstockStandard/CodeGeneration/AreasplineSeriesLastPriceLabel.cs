...
{
	public partial class AreasplineSeriesLastPriceLabel  : BaseObject
	{
		Hashtable h = new Hashtable();

		public AreasplineSeriesLastPriceLabel()
		{
			Align = Align_DefaultValue = AreasplineSeriesLastPriceLabelAlign.Null;
		...
		/// 
		/// </summary>
		public AreasplineSeriesLastPriceLabelAlign Align { get; set; }
		private AreasplineSeriesLastPriceLabelAlign Align_DefaultValue { get; set; }
