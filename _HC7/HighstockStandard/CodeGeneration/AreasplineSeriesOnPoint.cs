...
{
	public partial class AreasplineSeriesOnPoint  : BaseObject
	{
		Hashtable h = new Hashtable();

		public AreasplineSeriesOnPoint()
		{
			ConnectorOptions = ConnectorOptions_DefaultValue = new AreasplineSeriesOnPointConnectorOptions();
			Id = Id_DefaultValue = "";
			Position = Position_DefaultValue = new AreasplineSeriesOnPointPosition();
		...
		/// </summary>
		public AreasplineSeriesOnPointConnectorOptions ConnectorOptions { get; set; }
		private AreasplineSeriesOnPointConnectorOptions ConnectorOptions_DefaultValue { get; set; }
		...
		/// </summary>
		public AreasplineSeriesOnPointPosition Position { get; set; }
		private AreasplineSeriesOnPointPosition Position_DefaultValue { get; set; }
