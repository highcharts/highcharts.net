...
{
	public partial class AreasplineSeriesSonificationDefaultSpeechOptionsMapping  : BaseObject
	{
		Hashtable h = new Hashtable();

		public AreasplineSeriesSonificationDefaultSpeechOptionsMapping()
		{
			Frequency = Frequency_DefaultValue = new AreasplineSeriesSonificationDefaultSpeechOptionsMappingFrequency();
			GapBetweenNotes = GapBetweenNotes_DefaultValue = new AreasplineSeriesSonificationDefaultSpeechOptionsMappingGapBetweenNotes();
			Highpass = Highpass_DefaultValue = new AreasplineSeriesSonificationDefaultSpeechOptionsMappingHighpass();
			Lowpass = Lowpass_DefaultValue = new AreasplineSeriesSonificationDefaultSpeechOptionsMappingLowpass();
			NoteDuration = NoteDuration_DefaultValue = new AreasplineSeriesSonificationDefaultSpeechOptionsMappingNoteDuration();
			Pan = Pan_DefaultValue = new AreasplineSeriesSonificationDefaultSpeechOptionsMappingPan();
			Pitch = Pitch_DefaultValue = new AreasplineSeriesSonificationDefaultSpeechOptionsMappingPitch();
			PitchString = PitchString_DefaultValue = "null";
			PitchNumber = PitchNumber_DefaultValue = null;
			PlayDelay = PlayDelay_DefaultValue = new AreasplineSeriesSonificationDefaultSpeechOptionsMappingPlayDelay();
			Time = Time_DefaultValue = new AreasplineSeriesSonificationDefaultSpeechOptionsMappingTime();
			TimeString = TimeString_DefaultValue = "null";
			TimeNumber = TimeNumber_DefaultValue = null;
			Tremolo = Tremolo_DefaultValue = new AreasplineSeriesSonificationDefaultSpeechOptionsMappingTremolo();
			Volume = Volume_DefaultValue = new AreasplineSeriesSonificationDefaultSpeechOptionsMappingVolume();
		...
		/// </summary>
		public AreasplineSeriesSonificationDefaultSpeechOptionsMappingFrequency Frequency { get; set; }
		private AreasplineSeriesSonificationDefaultSpeechOptionsMappingFrequency Frequency_DefaultValue { get; set; }
		...
		/// </summary>
		public AreasplineSeriesSonificationDefaultSpeechOptionsMappingGapBetweenNotes GapBetweenNotes { get; set; }
		private AreasplineSeriesSonificationDefaultSpeechOptionsMappingGapBetweenNotes GapBetweenNotes_DefaultValue { get; set; }
		...
		/// </summary>
		public AreasplineSeriesSonificationDefaultSpeechOptionsMappingHighpass Highpass { get; set; }
		private AreasplineSeriesSonificationDefaultSpeechOptionsMappingHighpass Highpass_DefaultValue { get; set; }
		...
		/// </summary>
		public AreasplineSeriesSonificationDefaultSpeechOptionsMappingLowpass Lowpass { get; set; }
		private AreasplineSeriesSonificationDefaultSpeechOptionsMappingLowpass Lowpass_DefaultValue { get; set; }
		...
		/// </summary>
		public AreasplineSeriesSonificationDefaultSpeechOptionsMappingNoteDuration NoteDuration { get; set; }
		private AreasplineSeriesSonificationDefaultSpeechOptionsMappingNoteDuration NoteDuration_DefaultValue { get; set; }
		...
		/// </summary>
		public AreasplineSeriesSonificationDefaultSpeechOptionsMappingPan Pan { get; set; }
		private AreasplineSeriesSonificationDefaultSpeechOptionsMappingPan Pan_DefaultValue { get; set; }
		...
		/// </summary>
		public AreasplineSeriesSonificationDefaultSpeechOptionsMappingPitch Pitch { get; set; }
		private AreasplineSeriesSonificationDefaultSpeechOptionsMappingPitch Pitch_DefaultValue { get; set; }
		...
		/// </summary>
		public AreasplineSeriesSonificationDefaultSpeechOptionsMappingPlayDelay PlayDelay { get; set; }
		private AreasplineSeriesSonificationDefaultSpeechOptionsMappingPlayDelay PlayDelay_DefaultValue { get; set; }
		...
		/// </summary>
		public AreasplineSeriesSonificationDefaultSpeechOptionsMappingTime Time { get; set; }
		private AreasplineSeriesSonificationDefaultSpeechOptionsMappingTime Time_DefaultValue { get; set; }
		...
		/// </summary>
		public AreasplineSeriesSonificationDefaultSpeechOptionsMappingTremolo Tremolo { get; set; }
		private AreasplineSeriesSonificationDefaultSpeechOptionsMappingTremolo Tremolo_DefaultValue { get; set; }
		 

		/// <summary>
		/// The volume of notes, from 0 to 1.
		/// </summary>
		public AreasplineSeriesSonificationDefaultSpeechOptionsMappingVolume Volume { get; set; }
		private AreasplineSeriesSonificationDefaultSpeechOptionsMappingVolume Volume_DefaultValue { get; set; }
