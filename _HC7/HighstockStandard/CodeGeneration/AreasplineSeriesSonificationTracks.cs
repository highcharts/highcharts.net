...
{
	public partial class AreasplineSeriesSonificationTracks  : BaseObject
	{
		Hashtable h = new Hashtable();

		public AreasplineSeriesSonificationTracks()
		{
			ActiveWhen = ActiveWhen_DefaultValue = new AreasplineSeriesSonificationTracksActiveWhen();
			Instrument = Instrument_DefaultValue = null;
			InstrumentString = InstrumentString_DefaultValue = "null";
			Mapping = Mapping_DefaultValue = new AreasplineSeriesSonificationTracksMapping();
			MidiName = MidiName_DefaultValue = "";
			PointGrouping = PointGrouping_DefaultValue = new AreasplineSeriesSonificationTracksPointGrouping();
			RoundToMusicalNotes = RoundToMusicalNotes_DefaultValue = true;
			ShowPlayMarker = ShowPlayMarker_DefaultValue = true;
			Type = Type_DefaultValue = AreasplineSeriesSonificationTracksType.Instrument;
		...
		/// </summary>
		public AreasplineSeriesSonificationTracksActiveWhen ActiveWhen { get; set; }
		private AreasplineSeriesSonificationTracksActiveWhen ActiveWhen_DefaultValue { get; set; }
		...
		/// </summary>
		public AreasplineSeriesSonificationTracksMapping Mapping { get; set; }
		private AreasplineSeriesSonificationTracksMapping Mapping_DefaultValue { get; set; }
		...
		/// </summary>
		public AreasplineSeriesSonificationTracksPointGrouping PointGrouping { get; set; }
		private AreasplineSeriesSonificationTracksPointGrouping PointGrouping_DefaultValue { get; set; }
		...
		/// </summary>
		public AreasplineSeriesSonificationTracksType Type { get; set; }
		private AreasplineSeriesSonificationTracksType Type_DefaultValue { get; set; }
