...
namespace Highsoft.Web.Mvc.Stocks
{
	public partial class AreasplinerangeSeries  : Series
	{
		...
		{
			Accessibility = Accessibility_DefaultValue = new AreasplinerangeSeriesAccessibility();
			...
			Compare = Compare_DefaultValue = AreasplinerangeSeriesCompare.Percent;
			CompareBase = CompareBase_DefaultValue = AreasplinerangeSeriesCompareBase.Min;
			...
			DashStyle = DashStyle_DefaultValue = AreasplinerangeSeriesDashStyle.Null;
			Data = Data_DefaultValue = new List<AreasplinerangeSeriesData>();
			DataGrouping = DataGrouping_DefaultValue = new AreasplinerangeSeriesDataGrouping();
			DataLabels = DataLabels_DefaultValue = new AreasplinerangeSeriesDataLabels();
			DataSorting = DataSorting_DefaultValue = new AreasplinerangeSeriesDataSorting();
			Description = Description_DefaultValue = "";
			DragDrop = DragDrop_DefaultValue = new AreasplinerangeSeriesDragDrop();
			Dumbell = Dumbell_DefaultValue = new AreasplinerangeSeriesDumbell();
			...
			FindNearestPointBy = FindNearestPointBy_DefaultValue = AreasplinerangeSeriesFindNearestPointBy.X;
			...
			Label = Label_DefaultValue = new AreasplinerangeSeriesLabel();
			LastPrice = LastPrice_DefaultValue = new AreasplinerangeSeriesLastPrice();
			LastVisiblePrice = LastVisiblePrice_DefaultValue = new AreasplinerangeSeriesLastVisiblePrice();
			...
			OnPoint = OnPoint_DefaultValue = new AreasplinerangeSeriesOnPoint();
			Opacity = Opacity_DefaultValue = 1;
			Point = Point_DefaultValue = new AreasplinerangeSeriesPoint();
			PointDescriptionFormat = PointDescriptionFormat_DefaultValue = "";
			PointDescriptionFormatter = PointDescriptionFormatter_DefaultValue = "";
			PointInterval = PointInterval_DefaultValue = 1;
			PointIntervalUnit = PointIntervalUnit_DefaultValue = AreasplinerangeSeriesPointIntervalUnit.Null;
			...
			Sonification = Sonification_DefaultValue = new AreasplinerangeSeriesSonification();
			States = States_DefaultValue = new AreasplinerangeSeriesStates();
			StickyTracking = StickyTracking_DefaultValue = true;
			Threshold = Threshold_DefaultValue = 0;
			Tooltip = Tooltip_DefaultValue = new AreasplinerangeSeriesTooltip();
			...
			Zones = Zones_DefaultValue = new List<AreasplinerangeSeriesZones>();
		...
		/// </summary>
		public AreasplinerangeSeriesAccessibility Accessibility { get; set; }
		private AreasplinerangeSeriesAccessibility Accessibility_DefaultValue { get; set; }
		...
		/// </summary>
		public AreasplinerangeSeriesCompare Compare { get; set; }
		private AreasplinerangeSeriesCompare Compare_DefaultValue { get; set; }
		 

		/// <summary>
		/// When [compare](#plotOptions.series.compare) is `percent`, this optiondictates whether to use 0 or 100 as the base of comparison.
		/// </summary>
		public AreasplinerangeSeriesCompareBase CompareBase { get; set; }
		private AreasplinerangeSeriesCompareBase CompareBase_DefaultValue { get; set; }
		...
		/// </summary>
		public AreasplinerangeSeriesCursor Cursor { get; set; }
		private AreasplinerangeSeriesCursor Cursor_DefaultValue { get; set; }
		...
		/// </summary>
		public AreasplinerangeSeriesDashStyle DashStyle { get; set; }
		private AreasplinerangeSeriesDashStyle DashStyle_DefaultValue { get; set; }
		...
		/// </summary>
		public AreasplinerangeSeriesDataGrouping DataGrouping { get; set; }
		private AreasplinerangeSeriesDataGrouping DataGrouping_DefaultValue { get; set; }
		...
		/// </summary>
		public AreasplinerangeSeriesDataSorting DataSorting { get; set; }
		private AreasplinerangeSeriesDataSorting DataSorting_DefaultValue { get; set; }
		...
		/// </summary>
		public AreasplinerangeSeriesDragDrop DragDrop { get; set; }
		private AreasplinerangeSeriesDragDrop DragDrop_DefaultValue { get; set; }
		 

		/// <summary>
		/// 
		/// </summary>
		public AreasplinerangeSeriesDumbell Dumbell { get; set; }
		private AreasplinerangeSeriesDumbell Dumbell_DefaultValue { get; set; }
		...
		/// </summary>
		public AreasplinerangeSeriesEvents Events { get; set; }
		private AreasplinerangeSeriesEvents Events_DefaultValue { get; set; }
		...
		/// </summary>
		public AreasplinerangeSeriesFindNearestPointBy FindNearestPointBy { get; set; }
		private AreasplinerangeSeriesFindNearestPointBy FindNearestPointBy_DefaultValue { get; set; }
		...
		/// </summary>
		public AreasplinerangeSeriesGapUnit GapUnit { get; set; }
		private AreasplinerangeSeriesGapUnit GapUnit_DefaultValue { get; set; }
		...
		/// </summary>
		public AreasplinerangeSeriesLabel Label { get; set; }
		private AreasplinerangeSeriesLabel Label_DefaultValue { get; set; }
		 

		/// <summary>
		/// The line marks the last price from all points.
		/// </summary>
		public AreasplinerangeSeriesLastPrice LastPrice { get; set; }
		private AreasplinerangeSeriesLastPrice LastPrice_DefaultValue { get; set; }
		 

		/// <summary>
		/// The line marks the last price from visible range of points.
		/// </summary>
		public AreasplinerangeSeriesLastVisiblePrice LastVisiblePrice { get; set; }
		private AreasplinerangeSeriesLastVisiblePrice LastVisiblePrice_DefaultValue { get; set; }
		...
		/// </summary>
		public AreasplinerangeSeriesLinecap Linecap { get; set; }
		private AreasplinerangeSeriesLinecap Linecap_DefaultValue { get; set; }
		...
		/// </summary>
		public AreasplinerangeSeriesMarker Marker { get; set; }
		private AreasplinerangeSeriesMarker Marker_DefaultValue { get; set; }
		...
		/// </summary>
		public AreasplinerangeSeriesOnPoint OnPoint { get; set; }
		private AreasplinerangeSeriesOnPoint OnPoint_DefaultValue { get; set; }
		...
		/// </summary>
		public AreasplinerangeSeriesPoint Point { get; set; }
		private AreasplinerangeSeriesPoint Point_DefaultValue { get; set; }
		...
		/// </summary>
		public AreasplinerangeSeriesPointIntervalUnit PointIntervalUnit { get; set; }
		private AreasplinerangeSeriesPointIntervalUnit PointIntervalUnit_DefaultValue { get; set; }
		...
		/// </summary>
		public AreasplinerangeSeriesSonification Sonification { get; set; }
		private AreasplinerangeSeriesSonification Sonification_DefaultValue { get; set; }
		...
		/// </summary>
		public AreasplinerangeSeriesTooltip Tooltip { get; set; }
		private AreasplinerangeSeriesTooltip Tooltip_DefaultValue { get; set; }
		...
		/// </summary>
		public List<AreasplinerangeSeriesZones> Zones { get; set; }
		private List<AreasplinerangeSeriesZones> Zones_DefaultValue { get; set; }
