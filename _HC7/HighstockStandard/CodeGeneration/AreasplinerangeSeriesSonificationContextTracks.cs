...
{
	public partial class AreasplinerangeSeriesSonificationContextTracks  : BaseObject
	{
		Hashtable h = new Hashtable();

		public AreasplinerangeSeriesSonificationContextTracks()
		{
			ActiveWhen = ActiveWhen_DefaultValue = new AreasplinerangeSeriesSonificationContextTracksActiveWhen();
			Instrument = Instrument_DefaultValue = null;
			InstrumentString = InstrumentString_DefaultValue = "null";
			Mapping = Mapping_DefaultValue = new AreasplinerangeSeriesSonificationContextTracksMapping();
			MidiName = MidiName_DefaultValue = "";
			PointGrouping = PointGrouping_DefaultValue = new AreasplinerangeSeriesSonificationContextTracksPointGrouping();
			...
			Type = Type_DefaultValue = AreasplinerangeSeriesSonificationContextTracksType.Instrument;
			ValueInterval = ValueInterval_DefaultValue = null;
			ValueMapFunction = ValueMapFunction_DefaultValue = AreasplinerangeSeriesSonificationContextTracksValueMapFunction.Linear;
		...
		/// </summary>
		public AreasplinerangeSeriesSonificationContextTracksActiveWhen ActiveWhen { get; set; }
		private AreasplinerangeSeriesSonificationContextTracksActiveWhen ActiveWhen_DefaultValue { get; set; }
		...
		/// </summary>
		public AreasplinerangeSeriesSonificationContextTracksMapping Mapping { get; set; }
		private AreasplinerangeSeriesSonificationContextTracksMapping Mapping_DefaultValue { get; set; }
		...
		/// </summary>
		public AreasplinerangeSeriesSonificationContextTracksPointGrouping PointGrouping { get; set; }
		private AreasplinerangeSeriesSonificationContextTracksPointGrouping PointGrouping_DefaultValue { get; set; }
		...
		/// </summary>
		public AreasplinerangeSeriesSonificationContextTracksType Type { get; set; }
		private AreasplinerangeSeriesSonificationContextTracksType Type_DefaultValue { get; set; }
		...
		/// </summary>
		public AreasplinerangeSeriesSonificationContextTracksValueMapFunction ValueMapFunction { get; set; }
		private AreasplinerangeSeriesSonificationContextTracksValueMapFunction ValueMapFunction_DefaultValue { get; set; }
