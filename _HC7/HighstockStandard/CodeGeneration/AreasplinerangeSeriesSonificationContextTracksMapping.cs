...
{
	public partial class AreasplinerangeSeriesSonificationContextTracksMapping  : BaseObject
	{
		Hashtable h = new Hashtable();

		public AreasplinerangeSeriesSonificationContextTracksMapping()
		{
			Frequency = Frequency_DefaultValue = new AreasplinerangeSeriesSonificationContextTracksMappingFrequency();
			GapBetweenNotes = GapBetweenNotes_DefaultValue = new AreasplinerangeSeriesSonificationContextTracksMappingGapBetweenNotes();
			Highpass = Highpass_DefaultValue = new AreasplinerangeSeriesSonificationContextTracksMappingHighpass();
			Lowpass = Lowpass_DefaultValue = new AreasplinerangeSeriesSonificationContextTracksMappingLowpass();
			NoteDuration = NoteDuration_DefaultValue = new AreasplinerangeSeriesSonificationContextTracksMappingNoteDuration();
			Pan = Pan_DefaultValue = new AreasplinerangeSeriesSonificationContextTracksMappingPan();
			Pitch = Pitch_DefaultValue = new AreasplinerangeSeriesSonificationContextTracksMappingPitch();
			PitchString = PitchString_DefaultValue = "null";
			PitchNumber = PitchNumber_DefaultValue = null;
			PlayDelay = PlayDelay_DefaultValue = new AreasplinerangeSeriesSonificationContextTracksMappingPlayDelay();
			Time = Time_DefaultValue = new AreasplinerangeSeriesSonificationContextTracksMappingTime();
			TimeString = TimeString_DefaultValue = "null";
			TimeNumber = TimeNumber_DefaultValue = null;
			Tremolo = Tremolo_DefaultValue = new AreasplinerangeSeriesSonificationContextTracksMappingTremolo();
			Volume = Volume_DefaultValue = new AreasplinerangeSeriesSonificationContextTracksMappingVolume();
		...
		/// </summary>
		public AreasplinerangeSeriesSonificationContextTracksMappingFrequency Frequency { get; set; }
		private AreasplinerangeSeriesSonificationContextTracksMappingFrequency Frequency_DefaultValue { get; set; }
		...
		/// </summary>
		public AreasplinerangeSeriesSonificationContextTracksMappingGapBetweenNotes GapBetweenNotes { get; set; }
		private AreasplinerangeSeriesSonificationContextTracksMappingGapBetweenNotes GapBetweenNotes_DefaultValue { get; set; }
		...
		/// </summary>
		public AreasplinerangeSeriesSonificationContextTracksMappingHighpass Highpass { get; set; }
		private AreasplinerangeSeriesSonificationContextTracksMappingHighpass Highpass_DefaultValue { get; set; }
		...
		/// </summary>
		public AreasplinerangeSeriesSonificationContextTracksMappingLowpass Lowpass { get; set; }
		private AreasplinerangeSeriesSonificationContextTracksMappingLowpass Lowpass_DefaultValue { get; set; }
		...
		/// </summary>
		public AreasplinerangeSeriesSonificationContextTracksMappingNoteDuration NoteDuration { get; set; }
		private AreasplinerangeSeriesSonificationContextTracksMappingNoteDuration NoteDuration_DefaultValue { get; set; }
		...
		/// </summary>
		public AreasplinerangeSeriesSonificationContextTracksMappingPan Pan { get; set; }
		private AreasplinerangeSeriesSonificationContextTracksMappingPan Pan_DefaultValue { get; set; }
		...
		/// </summary>
		public AreasplinerangeSeriesSonificationContextTracksMappingPitch Pitch { get; set; }
		private AreasplinerangeSeriesSonificationContextTracksMappingPitch Pitch_DefaultValue { get; set; }
		...
		/// </summary>
		public AreasplinerangeSeriesSonificationContextTracksMappingPlayDelay PlayDelay { get; set; }
		private AreasplinerangeSeriesSonificationContextTracksMappingPlayDelay PlayDelay_DefaultValue { get; set; }
		...
		/// </summary>
		public AreasplinerangeSeriesSonificationContextTracksMappingTime Time { get; set; }
		private AreasplinerangeSeriesSonificationContextTracksMappingTime Time_DefaultValue { get; set; }
		...
		/// </summary>
		public AreasplinerangeSeriesSonificationContextTracksMappingTremolo Tremolo { get; set; }
		private AreasplinerangeSeriesSonificationContextTracksMappingTremolo Tremolo_DefaultValue { get; set; }
		 

		/// <summary>
		/// The volume of notes, from 0 to 1.
		/// </summary>
		public AreasplinerangeSeriesSonificationContextTracksMappingVolume Volume { get; set; }
		private AreasplinerangeSeriesSonificationContextTracksMappingVolume Volume_DefaultValue { get; set; }
