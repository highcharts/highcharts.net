...
{
	public partial class AreasplinerangeSeriesSonificationTracksMapping  : BaseObject
	{
		Hashtable h = new Hashtable();

		public AreasplinerangeSeriesSonificationTracksMapping()
		{
			Frequency = Frequency_DefaultValue = new AreasplinerangeSeriesSonificationTracksMappingFrequency();
			GapBetweenNotes = GapBetweenNotes_DefaultValue = new AreasplinerangeSeriesSonificationTracksMappingGapBetweenNotes();
			Highpass = Highpass_DefaultValue = new AreasplinerangeSeriesSonificationTracksMappingHighpass();
			Lowpass = Lowpass_DefaultValue = new AreasplinerangeSeriesSonificationTracksMappingLowpass();
			NoteDuration = NoteDuration_DefaultValue = new AreasplinerangeSeriesSonificationTracksMappingNoteDuration();
			Pan = Pan_DefaultValue = new AreasplinerangeSeriesSonificationTracksMappingPan();
			Pitch = Pitch_DefaultValue = new AreasplinerangeSeriesSonificationTracksMappingPitch();
			PitchString = PitchString_DefaultValue = "null";
			PitchNumber = PitchNumber_DefaultValue = null;
			PlayDelay = PlayDelay_DefaultValue = new AreasplinerangeSeriesSonificationTracksMappingPlayDelay();
			Time = Time_DefaultValue = new AreasplinerangeSeriesSonificationTracksMappingTime();
			TimeString = TimeString_DefaultValue = "null";
			TimeNumber = TimeNumber_DefaultValue = null;
			Tremolo = Tremolo_DefaultValue = new AreasplinerangeSeriesSonificationTracksMappingTremolo();
			Volume = Volume_DefaultValue = new AreasplinerangeSeriesSonificationTracksMappingVolume();
		...
		/// </summary>
		public AreasplinerangeSeriesSonificationTracksMappingFrequency Frequency { get; set; }
		private AreasplinerangeSeriesSonificationTracksMappingFrequency Frequency_DefaultValue { get; set; }
		...
		/// </summary>
		public AreasplinerangeSeriesSonificationTracksMappingGapBetweenNotes GapBetweenNotes { get; set; }
		private AreasplinerangeSeriesSonificationTracksMappingGapBetweenNotes GapBetweenNotes_DefaultValue { get; set; }
		...
		/// </summary>
		public AreasplinerangeSeriesSonificationTracksMappingHighpass Highpass { get; set; }
		private AreasplinerangeSeriesSonificationTracksMappingHighpass Highpass_DefaultValue { get; set; }
		...
		/// </summary>
		public AreasplinerangeSeriesSonificationTracksMappingLowpass Lowpass { get; set; }
		private AreasplinerangeSeriesSonificationTracksMappingLowpass Lowpass_DefaultValue { get; set; }
		...
		/// </summary>
		public AreasplinerangeSeriesSonificationTracksMappingNoteDuration NoteDuration { get; set; }
		private AreasplinerangeSeriesSonificationTracksMappingNoteDuration NoteDuration_DefaultValue { get; set; }
		...
		/// </summary>
		public AreasplinerangeSeriesSonificationTracksMappingPan Pan { get; set; }
		private AreasplinerangeSeriesSonificationTracksMappingPan Pan_DefaultValue { get; set; }
		...
		/// </summary>
		public AreasplinerangeSeriesSonificationTracksMappingPitch Pitch { get; set; }
		private AreasplinerangeSeriesSonificationTracksMappingPitch Pitch_DefaultValue { get; set; }
		...
		/// </summary>
		public AreasplinerangeSeriesSonificationTracksMappingPlayDelay PlayDelay { get; set; }
		private AreasplinerangeSeriesSonificationTracksMappingPlayDelay PlayDelay_DefaultValue { get; set; }
		...
		/// </summary>
		public AreasplinerangeSeriesSonificationTracksMappingTime Time { get; set; }
		private AreasplinerangeSeriesSonificationTracksMappingTime Time_DefaultValue { get; set; }
		...
		/// </summary>
		public AreasplinerangeSeriesSonificationTracksMappingTremolo Tremolo { get; set; }
		private AreasplinerangeSeriesSonificationTracksMappingTremolo Tremolo_DefaultValue { get; set; }
		 

		/// <summary>
		/// The volume of notes, from 0 to 1.
		/// </summary>
		public AreasplinerangeSeriesSonificationTracksMappingVolume Volume { get; set; }
		private AreasplinerangeSeriesSonificationTracksMappingVolume Volume_DefaultValue { get; set; }
