...
{
	public partial class AreasplinerangeSeriesTooltip  : BaseObject
	{
		public AreasplinerangeSeriesTooltip()
		{
			...
			HeaderShape = HeaderShape_DefaultValue = AreasplinerangeSeriesTooltipHeaderShape.Callout;
		...
		/// </summary>
		public AreasplinerangeSeriesTooltipHeaderShape HeaderShape { get; set; }
		private AreasplinerangeSeriesTooltipHeaderShape HeaderShape_DefaultValue { get; set; }
		...
		internal override Hashtable ToHashtable()
		{
			...
			if (NullFormatter != NullFormatter_DefaultValue) { h.Add("nullFormatter",NullFormatter); Highstock.AddFunction("AreasplinerangeSeriesTooltipNullFormatter.nullFormatter", NullFormatter); }  
			if (Outside != Outside_DefaultValue) h.Add("outside",Outside);
			if (Padding != Padding_DefaultValue) h.Add("padding",Padding);
			if (PointFormat != PointFormat_DefaultValue) h.Add("pointFormat",PointFormat);
			if (PointFormatter != PointFormatter_DefaultValue) { h.Add("pointFormatter",PointFormatter); Highstock.AddFunction("AreasplinerangeSeriesTooltipPointFormatter.pointFormatter", PointFormatter); }  
