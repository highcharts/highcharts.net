...
{
	public partial class AroonSeries  : Series
	{
		Hashtable h = new Hashtable();

		public AroonSeries()
		{
			Accessibility = Accessibility_DefaultValue = new AroonSeriesAccessibility();
			AllowPointSelect = AllowPointSelect_DefaultValue = false;
			Animation = Animation_DefaultValue = new Animation() { Enabled = true };
			AnimationBool = AnimationBool_DefaultValue = true;
			AnimationLimit = AnimationLimit_DefaultValue = null;
			AroonDown = AroonDown_DefaultValue = new AroonSeriesAroonDown();
			BoostBlending = BoostBlending_DefaultValue = AroonSeriesBoostBlending.Undefined;
			...
			DashStyle = DashStyle_DefaultValue = AroonSeriesDashStyle.Null;
			...
			DataSorting = DataSorting_DefaultValue = new AroonSeriesDataSorting();
			Description = Description_DefaultValue = "";
			Dumbell = Dumbell_DefaultValue = new AroonSeriesDumbell();
			EnableMouseTracking = EnableMouseTracking_DefaultValue = true;
			Events = Events_DefaultValue = new AroonSeriesEvents();
			FindNearestPointBy = FindNearestPointBy_DefaultValue = AroonSeriesFindNearestPointBy.X;
			GapSize = GapSize_DefaultValue = 0;
			GapUnit = GapUnit_DefaultValue = AroonSeriesGapUnit.Relative;
			GetExtremesFromAll = GetExtremesFromAll_DefaultValue = false;
			Id = Id_DefaultValue = "";
			InactiveOtherPoints = InactiveOtherPoints_DefaultValue = false;
			IncludeInDataExport = IncludeInDataExport_DefaultValue = null;
			Index = Index_DefaultValue = null;
			Label = Label_DefaultValue = new AroonSeriesLabel();
			...
			LegendSymbol = LegendSymbol_DefaultValue = AroonSeriesLegendSymbol.Rectangle;
			...
			OnPoint = OnPoint_DefaultValue = new AroonSeriesOnPoint();
			Opacity = Opacity_DefaultValue = 1;
			Params = Params_DefaultValue = new AroonSeriesParams();
			Point = Point_DefaultValue = new AroonSeriesPoint();
			...
			Sonification = Sonification_DefaultValue = new AroonSeriesSonification();
			Stack = Stack_DefaultValue = "";
			StackNumber = StackNumber_DefaultValue = null;
			States = States_DefaultValue = new AroonSeriesStates();
			Step = Step_DefaultValue = AroonSeriesStep.Null;
			StickyTracking = StickyTracking_DefaultValue = true;
			Threshold = Threshold_DefaultValue = 0;
			Tooltip = Tooltip_DefaultValue = new AroonSeriesTooltip();
			...
			Zones = Zones_DefaultValue = new List<AroonSeriesZones>();
		...
		/// </summary>
		public AroonSeriesAccessibility Accessibility { get; set; }
		private AroonSeriesAccessibility Accessibility_DefaultValue { get; set; }
		...
		/// </summary>
		public AroonSeriesAroonDown AroonDown { get; set; }
		private AroonSeriesAroonDown AroonDown_DefaultValue { get; set; }
		 

		/// <summary>
		/// Sets the color blending in the boost module.
		/// </summary>
		public AroonSeriesBoostBlending BoostBlending { get; set; }
		private AroonSeriesBoostBlending BoostBlending_DefaultValue { get; set; }
		...
		/// </summary>
		public AroonSeriesCursor Cursor { get; set; }
		private AroonSeriesCursor Cursor_DefaultValue { get; set; }
		...
		/// </summary>
		public AroonSeriesDashStyle DashStyle { get; set; }
		private AroonSeriesDashStyle DashStyle_DefaultValue { get; set; }
		...
		/// </summary>
		public AroonSeriesDataGrouping DataGrouping { get; set; }
		private AroonSeriesDataGrouping DataGrouping_DefaultValue { get; set; }
		...
		/// </summary>
		public AroonSeriesDataSorting DataSorting { get; set; }
		private AroonSeriesDataSorting DataSorting_DefaultValue { get; set; }
		...
		/// 
		/// </summary>
		public AroonSeriesDumbell Dumbell { get; set; }
		private AroonSeriesDumbell Dumbell_DefaultValue { get; set; }
		...
		/// </summary>
		public AroonSeriesEvents Events { get; set; }
		private AroonSeriesEvents Events_DefaultValue { get; set; }
		...
		/// </summary>
		public AroonSeriesFindNearestPointBy FindNearestPointBy { get; set; }
		private AroonSeriesFindNearestPointBy FindNearestPointBy_DefaultValue { get; set; }
		...
		/// </summary>
		public AroonSeriesGapUnit GapUnit { get; set; }
		private AroonSeriesGapUnit GapUnit_DefaultValue { get; set; }
		...
		/// </summary>
		public AroonSeriesLabel Label { get; set; }
		private AroonSeriesLabel Label_DefaultValue { get; set; }
		 

		/// <summary>
		/// The line marks the last price from all points.
		/// </summary>
		public AroonSeriesLastPrice LastPrice { get; set; }
		private AroonSeriesLastPrice LastPrice_DefaultValue { get; set; }
		 

		/// <summary>
		/// The line marks the last price from visible range of points.
		/// </summary>
		public AroonSeriesLastVisiblePrice LastVisiblePrice { get; set; }
		private AroonSeriesLastVisiblePrice LastVisiblePrice_DefaultValue { get; set; }
		...
		/// </summary>
		public AroonSeriesLegendSymbol LegendSymbol { get; set; }
		private AroonSeriesLegendSymbol LegendSymbol_DefaultValue { get; set; }
		...
		/// </summary>
		public AroonSeriesMarker Marker { get; set; }
		private AroonSeriesMarker Marker_DefaultValue { get; set; }
		...
		/// </summary>
		public AroonSeriesOnPoint OnPoint { get; set; }
		private AroonSeriesOnPoint OnPoint_DefaultValue { get; set; }
		...
		/// </summary>
		public AroonSeriesParams Params { get; set; }
		private AroonSeriesParams Params_DefaultValue { get; set; }
		 

		/// <summary>
		/// Properties for each single point.
		/// </summary>
		public AroonSeriesPoint Point { get; set; }
		private AroonSeriesPoint Point_DefaultValue { get; set; }
		...
		/// </summary>
		public AroonSeriesSonification Sonification { get; set; }
		private AroonSeriesSonification Sonification_DefaultValue { get; set; }
		...
		/// 
		/// </summary>
		public AroonSeriesStates States { get; set; }
		private AroonSeriesStates States_DefaultValue { get; set; }
		 

		/// <summary>
		/// Whether to apply steps to the line. Possible values are `left`,`center` and `right`.
		/// </summary>
		public AroonSeriesStep Step { get; set; }
		private AroonSeriesStep Step_DefaultValue { get; set; }
		...
		/// </summary>
		public AroonSeriesTooltip Tooltip { get; set; }
		private AroonSeriesTooltip Tooltip_DefaultValue { get; set; }
		...
		/// </summary>
		public List<AroonSeriesZones> Zones { get; set; }
		private List<AroonSeriesZones> Zones_DefaultValue { get; set; }
