...
{
	public partial class AroonSeriesLabel  : BaseObject
	{
		public AroonSeriesLabel()
		{
			...
			Style = Style_DefaultValue = new AroonSeriesLabelStyle();
		...
		/// </summary>
		public AroonSeriesLabelStyle Style { get; set; }
		private AroonSeriesLabelStyle Style_DefaultValue { get; set; }
