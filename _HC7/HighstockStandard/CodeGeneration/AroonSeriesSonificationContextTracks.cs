...
{
	public partial class AroonSeriesSonificationContextTracks  : BaseObject
	{
		Hashtable h = new Hashtable();

		public AroonSeriesSonificationContextTracks()
		{
			ActiveWhen = ActiveWhen_DefaultValue = new AroonSeriesSonificationContextTracksActiveWhen();
			Instrument = Instrument_DefaultValue = null;
			InstrumentString = InstrumentString_DefaultValue = "null";
			Mapping = Mapping_DefaultValue = new AroonSeriesSonificationContextTracksMapping();
			MidiName = MidiName_DefaultValue = "";
			PointGrouping = PointGrouping_DefaultValue = new AroonSeriesSonificationContextTracksPointGrouping();
			...
			Type = Type_DefaultValue = AroonSeriesSonificationContextTracksType.Instrument;
			ValueInterval = ValueInterval_DefaultValue = null;
			ValueMapFunction = ValueMapFunction_DefaultValue = AroonSeriesSonificationContextTracksValueMapFunction.Linear;
		...
		/// </summary>
		public AroonSeriesSonificationContextTracksActiveWhen ActiveWhen { get; set; }
		private AroonSeriesSonificationContextTracksActiveWhen ActiveWhen_DefaultValue { get; set; }
		...
		/// </summary>
		public AroonSeriesSonificationContextTracksMapping Mapping { get; set; }
		private AroonSeriesSonificationContextTracksMapping Mapping_DefaultValue { get; set; }
		...
		/// </summary>
		public AroonSeriesSonificationContextTracksPointGrouping PointGrouping { get; set; }
		private AroonSeriesSonificationContextTracksPointGrouping PointGrouping_DefaultValue { get; set; }
		...
		/// </summary>
		public AroonSeriesSonificationContextTracksType Type { get; set; }
		private AroonSeriesSonificationContextTracksType Type_DefaultValue { get; set; }
		...
		/// </summary>
		public AroonSeriesSonificationContextTracksValueMapFunction ValueMapFunction { get; set; }
		private AroonSeriesSonificationContextTracksValueMapFunction ValueMapFunction_DefaultValue { get; set; }
