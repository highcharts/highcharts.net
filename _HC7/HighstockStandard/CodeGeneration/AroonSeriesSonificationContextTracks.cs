...
namespace Highsoft.Web.Mvc.Stocks
{
	public partial class AroonSeriesSonificationContextTracks  : BaseObject
	{
		...
		internal override Hashtable ToHashtable(Highstock highstock)
		{
			...
			if (Type != AroonSeriesSonificationContextTracksType.Null) h.Add("type", highstock.FirstCharacterToLower(Type.ToString()));
			if (ValueInterval != null) h.Add("valueInterval",ValueInterval);
			if (ValueMapFunction != AroonSeriesSonificationContextTracksValueMapFunction.Null) h.Add("valueMapFunction", highstock.FirstCharacterToLower(ValueMapFunction.ToString()));
