...
{
	public partial class AroonSeriesSonificationContextTracksMappingFrequency  : BaseObject
	{
		Hashtable h = new Hashtable();

		public AroonSeriesSonificationContextTracksMappingFrequency()
		{
			MapFunction = MapFunction_DefaultValue = AroonSeriesSonificationContextTracksMappingFrequencyMapFunction.Linear;
			MapTo = MapTo_DefaultValue = "";
			Max = Max_DefaultValue = null;
			Min = Min_DefaultValue = null;
			Value = Value_DefaultValue = null;
			Within = Within_DefaultValue = AroonSeriesSonificationContextTracksMappingFrequencyWithin.Chart;
		...
		/// </summary>
		public AroonSeriesSonificationContextTracksMappingFrequencyMapFunction MapFunction { get; set; }
		private AroonSeriesSonificationContextTracksMappingFrequencyMapFunction MapFunction_DefaultValue { get; set; }
		...
		/// </summary>
		public AroonSeriesSonificationContextTracksMappingFrequencyWithin Within { get; set; }
		private AroonSeriesSonificationContextTracksMappingFrequencyWithin Within_DefaultValue { get; set; }
