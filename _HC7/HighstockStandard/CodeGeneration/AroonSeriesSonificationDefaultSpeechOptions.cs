...
{
	public partial class AroonSeriesSonificationDefaultSpeechOptions  : BaseObject
	{
		Hashtable h = new Hashtable();

		public AroonSeriesSonificationDefaultSpeechOptions()
		{
			ActiveWhen = ActiveWhen_DefaultValue = new AroonSeriesSonificationDefaultSpeechOptionsActiveWhen();
			Language = Language_DefaultValue = "en-US";
			Mapping = Mapping_DefaultValue = new AroonSeriesSonificationDefaultSpeechOptionsMapping();
			PointGrouping = PointGrouping_DefaultValue = new AroonSeriesSonificationDefaultSpeechOptionsPointGrouping();
			PreferredVoice = PreferredVoice_DefaultValue = "";
			ShowPlayMarker = ShowPlayMarker_DefaultValue = true;
			Type = Type_DefaultValue = AroonSeriesSonificationDefaultSpeechOptionsType.Instrument;
		...
		/// </summary>
		public AroonSeriesSonificationDefaultSpeechOptionsActiveWhen ActiveWhen { get; set; }
		private AroonSeriesSonificationDefaultSpeechOptionsActiveWhen ActiveWhen_DefaultValue { get; set; }
		...
		/// </summary>
		public AroonSeriesSonificationDefaultSpeechOptionsMapping Mapping { get; set; }
		private AroonSeriesSonificationDefaultSpeechOptionsMapping Mapping_DefaultValue { get; set; }
		 

		/// <summary>
		/// Options for point grouping, specifically for instrument tracks.
		/// </summary>
		public AroonSeriesSonificationDefaultSpeechOptionsPointGrouping PointGrouping { get; set; }
		private AroonSeriesSonificationDefaultSpeechOptionsPointGrouping PointGrouping_DefaultValue { get; set; }
		...
		/// </summary>
		public AroonSeriesSonificationDefaultSpeechOptionsType Type { get; set; }
		private AroonSeriesSonificationDefaultSpeechOptionsType Type_DefaultValue { get; set; }
