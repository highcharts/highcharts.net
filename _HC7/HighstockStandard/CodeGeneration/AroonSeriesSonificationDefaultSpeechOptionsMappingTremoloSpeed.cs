...
{
	public partial class AroonSeriesSonificationDefaultSpeechOptionsMappingTremoloSpeed  : BaseObject
	{
		Hashtable h = new Hashtable();

		public AroonSeriesSonificationDefaultSpeechOptionsMappingTremoloSpeed()
		{
			MapFunction = MapFunction_DefaultValue = AroonSeriesSonificationDefaultSpeechOptionsMappingTremoloSpeedMapFunction.Linear;
			MapTo = MapTo_DefaultValue = "";
			Max = Max_DefaultValue = null;
			Min = Min_DefaultValue = null;
			Value = Value_DefaultValue = null;
			Within = Within_DefaultValue = AroonSeriesSonificationDefaultSpeechOptionsMappingTremoloSpeedWithin.Chart;
		...
		/// </summary>
		public AroonSeriesSonificationDefaultSpeechOptionsMappingTremoloSpeedMapFunction MapFunction { get; set; }
		private AroonSeriesSonificationDefaultSpeechOptionsMappingTremoloSpeedMapFunction MapFunction_DefaultValue { get; set; }
		...
		/// </summary>
		public AroonSeriesSonificationDefaultSpeechOptionsMappingTremoloSpeedWithin Within { get; set; }
		private AroonSeriesSonificationDefaultSpeechOptionsMappingTremoloSpeedWithin Within_DefaultValue { get; set; }
