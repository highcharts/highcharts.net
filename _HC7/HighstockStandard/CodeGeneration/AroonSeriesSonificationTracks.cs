...
{
	public partial class AroonSeriesSonificationTracks  : BaseObject
	{
		Hashtable h = new Hashtable();

		public AroonSeriesSonificationTracks()
		{
			ActiveWhen = ActiveWhen_DefaultValue = new AroonSeriesSonificationTracksActiveWhen();
			Instrument = Instrument_DefaultValue = null;
			InstrumentString = InstrumentString_DefaultValue = "null";
			Mapping = Mapping_DefaultValue = new AroonSeriesSonificationTracksMapping();
			MidiName = MidiName_DefaultValue = "";
			PointGrouping = PointGrouping_DefaultValue = new AroonSeriesSonificationTracksPointGrouping();
			RoundToMusicalNotes = RoundToMusicalNotes_DefaultValue = true;
			ShowPlayMarker = ShowPlayMarker_DefaultValue = true;
			Type = Type_DefaultValue = AroonSeriesSonificationTracksType.Instrument;
		...
		/// </summary>
		public AroonSeriesSonificationTracksActiveWhen ActiveWhen { get; set; }
		private AroonSeriesSonificationTracksActiveWhen ActiveWhen_DefaultValue { get; set; }
		...
		/// </summary>
		public AroonSeriesSonificationTracksMapping Mapping { get; set; }
		private AroonSeriesSonificationTracksMapping Mapping_DefaultValue { get; set; }
		...
		/// </summary>
		public AroonSeriesSonificationTracksPointGrouping PointGrouping { get; set; }
		private AroonSeriesSonificationTracksPointGrouping PointGrouping_DefaultValue { get; set; }
		...
		/// </summary>
		public AroonSeriesSonificationTracksType Type { get; set; }
		private AroonSeriesSonificationTracksType Type_DefaultValue { get; set; }
