...
{
	public partial class AroonSeriesSonificationTracksMappingFrequency  : BaseObject
	{
		Hashtable h = new Hashtable();

		public AroonSeriesSonificationTracksMappingFrequency()
		{
			MapFunction = MapFunction_DefaultValue = AroonSeriesSonificationTracksMappingFrequencyMapFunction.Linear;
			MapTo = MapTo_DefaultValue = "";
			Max = Max_DefaultValue = null;
			Min = Min_DefaultValue = null;
			Value = Value_DefaultValue = null;
			Within = Within_DefaultValue = AroonSeriesSonificationTracksMappingFrequencyWithin.Chart;
		...
		/// </summary>
		public AroonSeriesSonificationTracksMappingFrequencyMapFunction MapFunction { get; set; }
		private AroonSeriesSonificationTracksMappingFrequencyMapFunction MapFunction_DefaultValue { get; set; }
		...
		/// </summary>
		public AroonSeriesSonificationTracksMappingFrequencyWithin Within { get; set; }
		private AroonSeriesSonificationTracksMappingFrequencyWithin Within_DefaultValue { get; set; }
