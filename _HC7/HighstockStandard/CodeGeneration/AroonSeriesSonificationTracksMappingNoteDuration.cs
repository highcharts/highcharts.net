...
{
	public partial class AroonSeriesSonificationTracksMappingNoteDuration  : BaseObject
	{
		Hashtable h = new Hashtable();

		public AroonSeriesSonificationTracksMappingNoteDuration()
		{
			MapFunction = MapFunction_DefaultValue = AroonSeriesSonificationTracksMappingNoteDurationMapFunction.Linear;
			MapTo = MapTo_DefaultValue = "";
			Max = Max_DefaultValue = null;
			Min = Min_DefaultValue = null;
			Value = Value_DefaultValue = null;
			Within = Within_DefaultValue = AroonSeriesSonificationTracksMappingNoteDurationWithin.Chart;
		...
		/// </summary>
		public AroonSeriesSonificationTracksMappingNoteDurationMapFunction MapFunction { get; set; }
		private AroonSeriesSonificationTracksMappingNoteDurationMapFunction MapFunction_DefaultValue { get; set; }
		...
		/// </summary>
		public AroonSeriesSonificationTracksMappingNoteDurationWithin Within { get; set; }
		private AroonSeriesSonificationTracksMappingNoteDurationWithin Within_DefaultValue { get; set; }
