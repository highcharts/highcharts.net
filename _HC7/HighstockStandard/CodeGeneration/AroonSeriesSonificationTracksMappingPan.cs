...
{
	public partial class AroonSeriesSonificationTracksMappingPan  : BaseObject
	{
		Hashtable h = new Hashtable();

		public AroonSeriesSonificationTracksMappingPan()
		{
			MapFunction = MapFunction_DefaultValue = AroonSeriesSonificationTracksMappingPanMapFunction.Linear;
			MapTo = MapTo_DefaultValue = "";
			Max = Max_DefaultValue = null;
			Min = Min_DefaultValue = null;
			Value = Value_DefaultValue = null;
			Within = Within_DefaultValue = AroonSeriesSonificationTracksMappingPanWithin.Chart;
		...
		/// </summary>
		public AroonSeriesSonificationTracksMappingPanMapFunction MapFunction { get; set; }
		private AroonSeriesSonificationTracksMappingPanMapFunction MapFunction_DefaultValue { get; set; }
		...
		/// </summary>
		public AroonSeriesSonificationTracksMappingPanWithin Within { get; set; }
		private AroonSeriesSonificationTracksMappingPanWithin Within_DefaultValue { get; set; }
