...
{
	public partial class AroonSeriesSonificationTracksMappingPitch  : BaseObject
	{
		Hashtable h = new Hashtable();

		public AroonSeriesSonificationTracksMappingPitch()
		{
			MapFunction = MapFunction_DefaultValue = AroonSeriesSonificationTracksMappingPitchMapFunction.Linear;
		...
		/// </summary>
		public AroonSeriesSonificationTracksMappingPitchMapFunction MapFunction { get; set; }
		private AroonSeriesSonificationTracksMappingPitchMapFunction MapFunction_DefaultValue { get; set; }
