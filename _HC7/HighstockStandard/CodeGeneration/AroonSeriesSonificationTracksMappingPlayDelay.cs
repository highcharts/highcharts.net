...
{
	public partial class AroonSeriesSonificationTracksMappingPlayDelay  : BaseObject
	{
		Hashtable h = new Hashtable();

		public AroonSeriesSonificationTracksMappingPlayDelay()
		{
			MapFunction = MapFunction_DefaultValue = AroonSeriesSonificationTracksMappingPlayDelayMapFunction.Linear;
			MapTo = MapTo_DefaultValue = "";
			Max = Max_DefaultValue = null;
			Min = Min_DefaultValue = null;
			Value = Value_DefaultValue = null;
			Within = Within_DefaultValue = AroonSeriesSonificationTracksMappingPlayDelayWithin.Chart;
		...
		/// </summary>
		public AroonSeriesSonificationTracksMappingPlayDelayMapFunction MapFunction { get; set; }
		private AroonSeriesSonificationTracksMappingPlayDelayMapFunction MapFunction_DefaultValue { get; set; }
		...
		/// </summary>
		public AroonSeriesSonificationTracksMappingPlayDelayWithin Within { get; set; }
		private AroonSeriesSonificationTracksMappingPlayDelayWithin Within_DefaultValue { get; set; }
