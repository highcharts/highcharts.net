...
{
	public partial class AroonSeriesSonificationTracksMappingTime  : BaseObject
	{
		Hashtable h = new Hashtable();

		public AroonSeriesSonificationTracksMappingTime()
		{
			MapFunction = MapFunction_DefaultValue = AroonSeriesSonificationTracksMappingTimeMapFunction.Linear;
			MapTo = MapTo_DefaultValue = "";
			Max = Max_DefaultValue = null;
			Min = Min_DefaultValue = null;
			Value = Value_DefaultValue = null;
			Within = Within_DefaultValue = AroonSeriesSonificationTracksMappingTimeWithin.Chart;
		...
		/// </summary>
		public AroonSeriesSonificationTracksMappingTimeMapFunction MapFunction { get; set; }
		private AroonSeriesSonificationTracksMappingTimeMapFunction MapFunction_DefaultValue { get; set; }
		...
		/// </summary>
		public AroonSeriesSonificationTracksMappingTimeWithin Within { get; set; }
		private AroonSeriesSonificationTracksMappingTimeWithin Within_DefaultValue { get; set; }
