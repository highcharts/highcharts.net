...
{
	public partial class AroonSeriesSonificationTracksMappingTremoloSpeed  : BaseObject
	{
		Hashtable h = new Hashtable();

		public AroonSeriesSonificationTracksMappingTremoloSpeed()
		{
			MapFunction = MapFunction_DefaultValue = AroonSeriesSonificationTracksMappingTremoloSpeedMapFunction.Linear;
			MapTo = MapTo_DefaultValue = "";
			Max = Max_DefaultValue = null;
			Min = Min_DefaultValue = null;
			Value = Value_DefaultValue = null;
			Within = Within_DefaultValue = AroonSeriesSonificationTracksMappingTremoloSpeedWithin.Chart;
		...
		/// </summary>
		public AroonSeriesSonificationTracksMappingTremoloSpeedMapFunction MapFunction { get; set; }
		private AroonSeriesSonificationTracksMappingTremoloSpeedMapFunction MapFunction_DefaultValue { get; set; }
		...
		/// </summary>
		public AroonSeriesSonificationTracksMappingTremoloSpeedWithin Within { get; set; }
		private AroonSeriesSonificationTracksMappingTremoloSpeedWithin Within_DefaultValue { get; set; }
