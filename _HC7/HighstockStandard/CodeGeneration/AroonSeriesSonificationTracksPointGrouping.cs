...
{
	public partial class AroonSeriesSonificationTracksPointGrouping  : BaseObject
	{
		Hashtable h = new Hashtable();

		public AroonSeriesSonificationTracksPointGrouping()
		{
			Algorithm = Algorithm_DefaultValue = AroonSeriesSonificationTracksPointGroupingAlgorithm.Minimax;
		...
		/// </summary>
		public AroonSeriesSonificationTracksPointGroupingAlgorithm Algorithm { get; set; }
		private AroonSeriesSonificationTracksPointGroupingAlgorithm Algorithm_DefaultValue { get; set; }
