...
{
	public partial class AroonSeriesStatesHover  : BaseObject
	{
		public AroonSeriesStatesHover()
		{
			Animation = Animation_DefaultValue = new Animation() { Enabled = true };
			AnimationBool = AnimationBool_DefaultValue = null;
			Enabled = Enabled_DefaultValue = true;
			Halo = Halo_DefaultValue = new AroonSeriesStatesHoverHalo();
			LineWidth = LineWidth_DefaultValue = null;
			LineWidthPlus = LineWidthPlus_DefaultValue = 1;
			Marker = Marker_DefaultValue = new AroonSeriesStatesHoverMarker();
		...
		/// </summary>
		public AroonSeriesStatesHoverHalo Halo { get; set; }
		private AroonSeriesStatesHoverHalo Halo_DefaultValue { get; set; }
		...
		/// </summary>
		public AroonSeriesStatesHoverMarker Marker { get; set; }
		private AroonSeriesStatesHoverMarker Marker_DefaultValue { get; set; }
