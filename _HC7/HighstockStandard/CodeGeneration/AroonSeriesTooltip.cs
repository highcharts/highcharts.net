...
{
	public partial class AroonSeriesTooltip  : BaseObject
	{
		public AroonSeriesTooltip()
		{
			...
			HeaderShape = HeaderShape_DefaultValue = AroonSeriesTooltipHeaderShape.Callout;
		...
		/// </summary>
		public AroonSeriesTooltipHeaderShape HeaderShape { get; set; }
		private AroonSeriesTooltipHeaderShape HeaderShape_DefaultValue { get; set; }
		...
		internal override Hashtable ToHashtable()
		{
			...
			if (NullFormatter != NullFormatter_DefaultValue) { h.Add("nullFormatter",NullFormatter); Highstock.AddFunction("AroonSeriesTooltipNullFormatter.nullFormatter", NullFormatter); }  
			if (Outside != Outside_DefaultValue) h.Add("outside",Outside);
			if (Padding != Padding_DefaultValue) h.Add("padding",Padding);
			if (PointFormat != PointFormat_DefaultValue) h.Add("pointFormat",PointFormat);
			if (PointFormatter != PointFormatter_DefaultValue) { h.Add("pointFormatter",PointFormatter); Highstock.AddFunction("AroonSeriesTooltipPointFormatter.pointFormatter", PointFormatter); }  
