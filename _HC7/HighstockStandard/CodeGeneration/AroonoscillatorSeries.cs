...
namespace Highsoft.Web.Mvc.Stocks
{
	public partial class AroonoscillatorSeries  : Series
	{
		...
		public AroonoscillatorSeries()
		{
			...
			Zones = Zones_DefaultValue = new List<AroonoscillatorSeriesZone>();
		...
		/// </summary>
		public List<AroonoscillatorSeriesZone> Zones { get; set; }
		private List<AroonoscillatorSeriesZone> Zones_DefaultValue { get; set; }
