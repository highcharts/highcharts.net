...
{
	public partial class AroonoscillatorSeries  : Series
	{
		Hashtable h = new Hashtable();

		public AroonoscillatorSeries()
		{
			...
			Cursor = Cursor_DefaultValue = AroonoscillatorSeriesCursor.Null;
			Custom = Custom_DefaultValue = new Hashtable();
			DashStyle = DashStyle_DefaultValue = AroonoscillatorSeriesDashStyle.Null;
			DataGrouping = DataGrouping_DefaultValue = new AroonoscillatorSeriesDataGrouping();
			...
			Dumbell = Dumbell_DefaultValue = new AroonoscillatorSeriesDumbell();
			...
			GapUnit = GapUnit_DefaultValue = AroonoscillatorSeriesGapUnit.Relative;
			GetExtremesFromAll = GetExtremesFromAll_DefaultValue = false;
			Id = Id_DefaultValue = "";
			InactiveOtherPoints = InactiveOtherPoints_DefaultValue = false;
			IncludeInDataExport = IncludeInDataExport_DefaultValue = null;
			Index = Index_DefaultValue = null;
			Label = Label_DefaultValue = new AroonoscillatorSeriesLabel();
			LastPrice = LastPrice_DefaultValue = new AroonoscillatorSeriesLastPrice();
			LastVisiblePrice = LastVisiblePrice_DefaultValue = new AroonoscillatorSeriesLastVisiblePrice();
			LegendIndex = LegendIndex_DefaultValue = null;
			LegendSymbol = LegendSymbol_DefaultValue = AroonoscillatorSeriesLegendSymbol.Rectangle;
			Linecap = Linecap_DefaultValue = AroonoscillatorSeriesLinecap.Round;
			LineWidth = LineWidth_DefaultValue = 2;
			LinkedTo = LinkedTo_DefaultValue = "";
			Marker = Marker_DefaultValue = new AroonoscillatorSeriesMarker();
			Name = Name_DefaultValue = "";
			NegativeColor = NegativeColor_DefaultValue = "";
			OnPoint = OnPoint_DefaultValue = new AroonoscillatorSeriesOnPoint();
			Opacity = Opacity_DefaultValue = 1;
			Params = Params_DefaultValue = new AroonoscillatorSeriesParams();
			Point = Point_DefaultValue = new AroonoscillatorSeriesPoint();
			...
			Sonification = Sonification_DefaultValue = new AroonoscillatorSeriesSonification();
			Stack = Stack_DefaultValue = "";
			StackNumber = StackNumber_DefaultValue = null;
			States = States_DefaultValue = new AroonoscillatorSeriesStates();
			Step = Step_DefaultValue = AroonoscillatorSeriesStep.Null;
			StickyTracking = StickyTracking_DefaultValue = true;
			Threshold = Threshold_DefaultValue = 0;
			Tooltip = Tooltip_DefaultValue = new AroonoscillatorSeriesTooltip();
			...
			Zones = Zones_DefaultValue = new List<AroonoscillatorSeriesZones>();
		...
		/// </summary>
		public AroonoscillatorSeriesAccessibility Accessibility { get; set; }
		private AroonoscillatorSeriesAccessibility Accessibility_DefaultValue { get; set; }
		...
		/// </summary>
		public AroonoscillatorSeriesBoostBlending BoostBlending { get; set; }
		private AroonoscillatorSeriesBoostBlending BoostBlending_DefaultValue { get; set; }
		...
		/// </summary>
		public AroonoscillatorSeriesCursor Cursor { get; set; }
		private AroonoscillatorSeriesCursor Cursor_DefaultValue { get; set; }
		...
		/// </summary>
		public AroonoscillatorSeriesDashStyle DashStyle { get; set; }
		private AroonoscillatorSeriesDashStyle DashStyle_DefaultValue { get; set; }
		...
		/// </summary>
		public AroonoscillatorSeriesDataGrouping DataGrouping { get; set; }
		private AroonoscillatorSeriesDataGrouping DataGrouping_DefaultValue { get; set; }
		...
		/// </summary>
		public AroonoscillatorSeriesDataLabels DataLabels { get; set; }
		private AroonoscillatorSeriesDataLabels DataLabels_DefaultValue { get; set; }
		 

		/// <summary>
		/// Options for the series data sorting.
		/// </summary>
		public AroonoscillatorSeriesDataSorting DataSorting { get; set; }
		private AroonoscillatorSeriesDataSorting DataSorting_DefaultValue { get; set; }
		...
		/// 
		/// </summary>
		public AroonoscillatorSeriesDumbell Dumbell { get; set; }
		private AroonoscillatorSeriesDumbell Dumbell_DefaultValue { get; set; }
		...
		/// </summary>
		public AroonoscillatorSeriesEvents Events { get; set; }
		private AroonoscillatorSeriesEvents Events_DefaultValue { get; set; }
		...
		/// </summary>
		public AroonoscillatorSeriesFindNearestPointBy FindNearestPointBy { get; set; }
		private AroonoscillatorSeriesFindNearestPointBy FindNearestPointBy_DefaultValue { get; set; }
		...
		/// </summary>
		public AroonoscillatorSeriesGapUnit GapUnit { get; set; }
		private AroonoscillatorSeriesGapUnit GapUnit_DefaultValue { get; set; }
		...
		/// </summary>
		public AroonoscillatorSeriesLabel Label { get; set; }
		private AroonoscillatorSeriesLabel Label_DefaultValue { get; set; }
		 

		/// <summary>
		/// The line marks the last price from all points.
		/// </summary>
		public AroonoscillatorSeriesLastPrice LastPrice { get; set; }
		private AroonoscillatorSeriesLastPrice LastPrice_DefaultValue { get; set; }
		 

		/// <summary>
		/// The line marks the last price from visible range of points.
		/// </summary>
		public AroonoscillatorSeriesLastVisiblePrice LastVisiblePrice { get; set; }
		private AroonoscillatorSeriesLastVisiblePrice LastVisiblePrice_DefaultValue { get; set; }
		...
		/// </summary>
		public AroonoscillatorSeriesLegendSymbol LegendSymbol { get; set; }
		private AroonoscillatorSeriesLegendSymbol LegendSymbol_DefaultValue { get; set; }
		 

		/// <summary>
		/// The line cap used for line ends and line joins on the graph.
		/// </summary>
		public AroonoscillatorSeriesLinecap Linecap { get; set; }
		private AroonoscillatorSeriesLinecap Linecap_DefaultValue { get; set; }
		...
		/// </summary>
		public AroonoscillatorSeriesMarker Marker { get; set; }
		private AroonoscillatorSeriesMarker Marker_DefaultValue { get; set; }
		...
		/// </summary>
		public AroonoscillatorSeriesPoint Point { get; set; }
		private AroonoscillatorSeriesPoint Point_DefaultValue { get; set; }
		...
		/// </summary>
		public AroonoscillatorSeriesSonification Sonification { get; set; }
		private AroonoscillatorSeriesSonification Sonification_DefaultValue { get; set; }
		...
		/// 
		/// </summary>
		public AroonoscillatorSeriesStates States { get; set; }
		private AroonoscillatorSeriesStates States_DefaultValue { get; set; }
		 

		/// <summary>
		/// Whether to apply steps to the line. Possible values are `left`,`center` and `right`.
		/// </summary>
		public AroonoscillatorSeriesStep Step { get; set; }
		private AroonoscillatorSeriesStep Step_DefaultValue { get; set; }
		...
		/// </summary>
		public AroonoscillatorSeriesTooltip Tooltip { get; set; }
		private AroonoscillatorSeriesTooltip Tooltip_DefaultValue { get; set; }
		...
		/// </summary>
		public List<AroonoscillatorSeriesZones> Zones { get; set; }
		private List<AroonoscillatorSeriesZones> Zones_DefaultValue { get; set; }
