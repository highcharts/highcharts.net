...
{
	public partial class AroonoscillatorSeriesDragDropDragHandle  : BaseObject
	{
		public AroonoscillatorSeriesDragDropDragHandle()
		{
		...
		internal override Hashtable ToHashtable()
		{
			...
			if (PathFormatter != PathFormatter_DefaultValue) { h.Add("pathFormatter",PathFormatter); Highstock.AddFunction("AroonoscillatorSeriesDragDropDragHandlePathFormatter.pathFormatter", PathFormatter); }  
