...
{
	public partial class AroonoscillatorSeriesLastPriceLabel  : BaseObject
	{
		Hashtable h = new Hashtable();

		public AroonoscillatorSeriesLastPriceLabel()
		{
			Align = Align_DefaultValue = AroonoscillatorSeriesLastPriceLabelAlign.Null;
		...
		/// 
		/// </summary>
		public AroonoscillatorSeriesLastPriceLabelAlign Align { get; set; }
		private AroonoscillatorSeriesLastPriceLabelAlign Align_DefaultValue { get; set; }
