...
{
	public partial class AroonoscillatorSeriesMarker  : BaseObject
	{
		Hashtable h = new Hashtable();

		public AroonoscillatorSeriesMarker()
		{
			...
			States = States_DefaultValue = new AroonoscillatorSeriesMarkerStates();
		...
		/// </summary>
		public AroonoscillatorSeriesMarkerStates States { get; set; }
		private AroonoscillatorSeriesMarkerStates States_DefaultValue { get; set; }
