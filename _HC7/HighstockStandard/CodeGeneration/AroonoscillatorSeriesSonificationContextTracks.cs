...
{
	public partial class AroonoscillatorSeriesSonificationContextTracks  : BaseObject
	{
		Hashtable h = new Hashtable();

		public AroonoscillatorSeriesSonificationContextTracks()
		{
			ActiveWhen = ActiveWhen_DefaultValue = new AroonoscillatorSeriesSonificationContextTracksActiveWhen();
			Instrument = Instrument_DefaultValue = null;
			InstrumentString = InstrumentString_DefaultValue = "null";
			Mapping = Mapping_DefaultValue = new AroonoscillatorSeriesSonificationContextTracksMapping();
			MidiName = MidiName_DefaultValue = "";
			PointGrouping = PointGrouping_DefaultValue = new AroonoscillatorSeriesSonificationContextTracksPointGrouping();
			...
			Type = Type_DefaultValue = AroonoscillatorSeriesSonificationContextTracksType.Instrument;
			ValueInterval = ValueInterval_DefaultValue = null;
			ValueMapFunction = ValueMapFunction_DefaultValue = AroonoscillatorSeriesSonificationContextTracksValueMapFunction.Linear;
		...
		/// </summary>
		public AroonoscillatorSeriesSonificationContextTracksActiveWhen ActiveWhen { get; set; }
		private AroonoscillatorSeriesSonificationContextTracksActiveWhen ActiveWhen_DefaultValue { get; set; }
		...
		/// </summary>
		public AroonoscillatorSeriesSonificationContextTracksMapping Mapping { get; set; }
		private AroonoscillatorSeriesSonificationContextTracksMapping Mapping_DefaultValue { get; set; }
		...
		/// </summary>
		public AroonoscillatorSeriesSonificationContextTracksPointGrouping PointGrouping { get; set; }
		private AroonoscillatorSeriesSonificationContextTracksPointGrouping PointGrouping_DefaultValue { get; set; }
		...
		/// </summary>
		public AroonoscillatorSeriesSonificationContextTracksType Type { get; set; }
		private AroonoscillatorSeriesSonificationContextTracksType Type_DefaultValue { get; set; }
		...
		/// </summary>
		public AroonoscillatorSeriesSonificationContextTracksValueMapFunction ValueMapFunction { get; set; }
		private AroonoscillatorSeriesSonificationContextTracksValueMapFunction ValueMapFunction_DefaultValue { get; set; }
