...
{
	public partial class AroonoscillatorSeriesSonificationContextTracksMappingLowpassFrequency  : BaseObject
	{
		Hashtable h = new Hashtable();

		public AroonoscillatorSeriesSonificationContextTracksMappingLowpassFrequency()
		{
			MapFunction = MapFunction_DefaultValue = AroonoscillatorSeriesSonificationContextTracksMappingLowpassFrequencyMapFunction.Linear;
			MapTo = MapTo_DefaultValue = "";
			Max = Max_DefaultValue = null;
			Min = Min_DefaultValue = null;
			Value = Value_DefaultValue = null;
			Within = Within_DefaultValue = AroonoscillatorSeriesSonificationContextTracksMappingLowpassFrequencyWithin.Chart;
		...
		/// </summary>
		public AroonoscillatorSeriesSonificationContextTracksMappingLowpassFrequencyMapFunction MapFunction { get; set; }
		private AroonoscillatorSeriesSonificationContextTracksMappingLowpassFrequencyMapFunction MapFunction_DefaultValue { get; set; }
		...
		/// </summary>
		public AroonoscillatorSeriesSonificationContextTracksMappingLowpassFrequencyWithin Within { get; set; }
		private AroonoscillatorSeriesSonificationContextTracksMappingLowpassFrequencyWithin Within_DefaultValue { get; set; }
