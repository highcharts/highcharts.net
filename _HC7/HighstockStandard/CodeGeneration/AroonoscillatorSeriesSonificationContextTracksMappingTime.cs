...
{
	public partial class AroonoscillatorSeriesSonificationContextTracksMappingTime  : BaseObject
	{
		Hashtable h = new Hashtable();

		public AroonoscillatorSeriesSonificationContextTracksMappingTime()
		{
			MapFunction = MapFunction_DefaultValue = AroonoscillatorSeriesSonificationContextTracksMappingTimeMapFunction.Linear;
			MapTo = MapTo_DefaultValue = "";
			Max = Max_DefaultValue = null;
			Min = Min_DefaultValue = null;
			Value = Value_DefaultValue = null;
			Within = Within_DefaultValue = AroonoscillatorSeriesSonificationContextTracksMappingTimeWithin.Chart;
		...
		/// </summary>
		public AroonoscillatorSeriesSonificationContextTracksMappingTimeMapFunction MapFunction { get; set; }
		private AroonoscillatorSeriesSonificationContextTracksMappingTimeMapFunction MapFunction_DefaultValue { get; set; }
		...
		/// </summary>
		public AroonoscillatorSeriesSonificationContextTracksMappingTimeWithin Within { get; set; }
		private AroonoscillatorSeriesSonificationContextTracksMappingTimeWithin Within_DefaultValue { get; set; }
