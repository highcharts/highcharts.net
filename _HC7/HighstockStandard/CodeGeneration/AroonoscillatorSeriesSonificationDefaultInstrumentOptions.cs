...
{
	public partial class AroonoscillatorSeriesSonificationDefaultInstrumentOptions  : BaseObject
	{
		Hashtable h = new Hashtable();

		public AroonoscillatorSeriesSonificationDefaultInstrumentOptions()
		{
			ActiveWhen = ActiveWhen_DefaultValue = new AroonoscillatorSeriesSonificationDefaultInstrumentOptionsActiveWhen();
			Instrument = Instrument_DefaultValue = null;
			InstrumentString = InstrumentString_DefaultValue = "null";
			Mapping = Mapping_DefaultValue = new AroonoscillatorSeriesSonificationDefaultInstrumentOptionsMapping();
			MidiName = MidiName_DefaultValue = "";
			PointGrouping = PointGrouping_DefaultValue = new AroonoscillatorSeriesSonificationDefaultInstrumentOptionsPointGrouping();
			RoundToMusicalNotes = RoundToMusicalNotes_DefaultValue = true;
			ShowPlayMarker = ShowPlayMarker_DefaultValue = true;
			Type = Type_DefaultValue = AroonoscillatorSeriesSonificationDefaultInstrumentOptionsType.Instrument;
		...
		/// </summary>
		public AroonoscillatorSeriesSonificationDefaultInstrumentOptionsActiveWhen ActiveWhen { get; set; }
		private AroonoscillatorSeriesSonificationDefaultInstrumentOptionsActiveWhen ActiveWhen_DefaultValue { get; set; }
		...
		/// </summary>
		public AroonoscillatorSeriesSonificationDefaultInstrumentOptionsMapping Mapping { get; set; }
		private AroonoscillatorSeriesSonificationDefaultInstrumentOptionsMapping Mapping_DefaultValue { get; set; }
		...
		/// </summary>
		public AroonoscillatorSeriesSonificationDefaultInstrumentOptionsPointGrouping PointGrouping { get; set; }
		private AroonoscillatorSeriesSonificationDefaultInstrumentOptionsPointGrouping PointGrouping_DefaultValue { get; set; }
		...
		/// </summary>
		public AroonoscillatorSeriesSonificationDefaultInstrumentOptionsType Type { get; set; }
		private AroonoscillatorSeriesSonificationDefaultInstrumentOptionsType Type_DefaultValue { get; set; }
