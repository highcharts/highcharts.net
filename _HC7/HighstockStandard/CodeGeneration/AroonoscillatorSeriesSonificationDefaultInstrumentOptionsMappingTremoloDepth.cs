...
{
	public partial class AroonoscillatorSeriesSonificationDefaultInstrumentOptionsMappingTremoloDepth  : BaseObject
	{
		Hashtable h = new Hashtable();

		public AroonoscillatorSeriesSonificationDefaultInstrumentOptionsMappingTremoloDepth()
		{
			MapFunction = MapFunction_DefaultValue = AroonoscillatorSeriesSonificationDefaultInstrumentOptionsMappingTremoloDepthMapFunction.Linear;
			MapTo = MapTo_DefaultValue = "";
			Max = Max_DefaultValue = null;
			Min = Min_DefaultValue = null;
			Value = Value_DefaultValue = null;
			Within = Within_DefaultValue = AroonoscillatorSeriesSonificationDefaultInstrumentOptionsMappingTremoloDepthWithin.Chart;
		...
		/// </summary>
		public AroonoscillatorSeriesSonificationDefaultInstrumentOptionsMappingTremoloDepthMapFunction MapFunction { get; set; }
		private AroonoscillatorSeriesSonificationDefaultInstrumentOptionsMappingTremoloDepthMapFunction MapFunction_DefaultValue { get; set; }
		...
		/// </summary>
		public AroonoscillatorSeriesSonificationDefaultInstrumentOptionsMappingTremoloDepthWithin Within { get; set; }
		private AroonoscillatorSeriesSonificationDefaultInstrumentOptionsMappingTremoloDepthWithin Within_DefaultValue { get; set; }
