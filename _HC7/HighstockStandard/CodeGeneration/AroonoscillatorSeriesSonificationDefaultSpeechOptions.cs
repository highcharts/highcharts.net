...
{
	public partial class AroonoscillatorSeriesSonificationDefaultSpeechOptions  : BaseObject
	{
		Hashtable h = new Hashtable();

		public AroonoscillatorSeriesSonificationDefaultSpeechOptions()
		{
			ActiveWhen = ActiveWhen_DefaultValue = new AroonoscillatorSeriesSonificationDefaultSpeechOptionsActiveWhen();
			Language = Language_DefaultValue = "en-US";
			Mapping = Mapping_DefaultValue = new AroonoscillatorSeriesSonificationDefaultSpeechOptionsMapping();
			PointGrouping = PointGrouping_DefaultValue = new AroonoscillatorSeriesSonificationDefaultSpeechOptionsPointGrouping();
			PreferredVoice = PreferredVoice_DefaultValue = "";
			ShowPlayMarker = ShowPlayMarker_DefaultValue = true;
			Type = Type_DefaultValue = AroonoscillatorSeriesSonificationDefaultSpeechOptionsType.Instrument;
		...
		/// </summary>
		public AroonoscillatorSeriesSonificationDefaultSpeechOptionsActiveWhen ActiveWhen { get; set; }
		private AroonoscillatorSeriesSonificationDefaultSpeechOptionsActiveWhen ActiveWhen_DefaultValue { get; set; }
		...
		/// </summary>
		public AroonoscillatorSeriesSonificationDefaultSpeechOptionsMapping Mapping { get; set; }
		private AroonoscillatorSeriesSonificationDefaultSpeechOptionsMapping Mapping_DefaultValue { get; set; }
		 

		/// <summary>
		/// Options for point grouping, specifically for instrument tracks.
		/// </summary>
		public AroonoscillatorSeriesSonificationDefaultSpeechOptionsPointGrouping PointGrouping { get; set; }
		private AroonoscillatorSeriesSonificationDefaultSpeechOptionsPointGrouping PointGrouping_DefaultValue { get; set; }
		...
		/// </summary>
		public AroonoscillatorSeriesSonificationDefaultSpeechOptionsType Type { get; set; }
		private AroonoscillatorSeriesSonificationDefaultSpeechOptionsType Type_DefaultValue { get; set; }
