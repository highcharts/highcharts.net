...
{
	public partial class AroonoscillatorSeriesSonificationDefaultSpeechOptionsActiveWhen  : BaseObject
	{
		Hashtable h = new Hashtable();

		public AroonoscillatorSeriesSonificationDefaultSpeechOptionsActiveWhen()
		{
