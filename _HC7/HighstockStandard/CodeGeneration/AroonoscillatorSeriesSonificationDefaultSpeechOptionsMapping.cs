...
{
	public partial class AroonoscillatorSeriesSonificationDefaultSpeechOptionsMapping  : BaseObject
	{
		Hashtable h = new Hashtable();

		public AroonoscillatorSeriesSonificationDefaultSpeechOptionsMapping()
		{
			Frequency = Frequency_DefaultValue = new AroonoscillatorSeriesSonificationDefaultSpeechOptionsMappingFrequency();
			GapBetweenNotes = GapBetweenNotes_DefaultValue = new AroonoscillatorSeriesSonificationDefaultSpeechOptionsMappingGapBetweenNotes();
			Highpass = Highpass_DefaultValue = new AroonoscillatorSeriesSonificationDefaultSpeechOptionsMappingHighpass();
			Lowpass = Lowpass_DefaultValue = new AroonoscillatorSeriesSonificationDefaultSpeechOptionsMappingLowpass();
			NoteDuration = NoteDuration_DefaultValue = new AroonoscillatorSeriesSonificationDefaultSpeechOptionsMappingNoteDuration();
			Pan = Pan_DefaultValue = new AroonoscillatorSeriesSonificationDefaultSpeechOptionsMappingPan();
			Pitch = Pitch_DefaultValue = new AroonoscillatorSeriesSonificationDefaultSpeechOptionsMappingPitch();
			PitchString = PitchString_DefaultValue = "null";
			PitchNumber = PitchNumber_DefaultValue = null;
			PlayDelay = PlayDelay_DefaultValue = new AroonoscillatorSeriesSonificationDefaultSpeechOptionsMappingPlayDelay();
			Time = Time_DefaultValue = new AroonoscillatorSeriesSonificationDefaultSpeechOptionsMappingTime();
			TimeString = TimeString_DefaultValue = "null";
			TimeNumber = TimeNumber_DefaultValue = null;
			Tremolo = Tremolo_DefaultValue = new AroonoscillatorSeriesSonificationDefaultSpeechOptionsMappingTremolo();
			Volume = Volume_DefaultValue = new AroonoscillatorSeriesSonificationDefaultSpeechOptionsMappingVolume();
		...
		/// </summary>
		public AroonoscillatorSeriesSonificationDefaultSpeechOptionsMappingFrequency Frequency { get; set; }
		private AroonoscillatorSeriesSonificationDefaultSpeechOptionsMappingFrequency Frequency_DefaultValue { get; set; }
		...
		/// </summary>
		public AroonoscillatorSeriesSonificationDefaultSpeechOptionsMappingGapBetweenNotes GapBetweenNotes { get; set; }
		private AroonoscillatorSeriesSonificationDefaultSpeechOptionsMappingGapBetweenNotes GapBetweenNotes_DefaultValue { get; set; }
		...
		/// </summary>
		public AroonoscillatorSeriesSonificationDefaultSpeechOptionsMappingHighpass Highpass { get; set; }
		private AroonoscillatorSeriesSonificationDefaultSpeechOptionsMappingHighpass Highpass_DefaultValue { get; set; }
		...
		/// </summary>
		public AroonoscillatorSeriesSonificationDefaultSpeechOptionsMappingLowpass Lowpass { get; set; }
		private AroonoscillatorSeriesSonificationDefaultSpeechOptionsMappingLowpass Lowpass_DefaultValue { get; set; }
		...
		/// </summary>
		public AroonoscillatorSeriesSonificationDefaultSpeechOptionsMappingNoteDuration NoteDuration { get; set; }
		private AroonoscillatorSeriesSonificationDefaultSpeechOptionsMappingNoteDuration NoteDuration_DefaultValue { get; set; }
		...
		/// </summary>
		public AroonoscillatorSeriesSonificationDefaultSpeechOptionsMappingPan Pan { get; set; }
		private AroonoscillatorSeriesSonificationDefaultSpeechOptionsMappingPan Pan_DefaultValue { get; set; }
		...
		/// </summary>
		public AroonoscillatorSeriesSonificationDefaultSpeechOptionsMappingPitch Pitch { get; set; }
		private AroonoscillatorSeriesSonificationDefaultSpeechOptionsMappingPitch Pitch_DefaultValue { get; set; }
		...
		/// </summary>
		public AroonoscillatorSeriesSonificationDefaultSpeechOptionsMappingPlayDelay PlayDelay { get; set; }
		private AroonoscillatorSeriesSonificationDefaultSpeechOptionsMappingPlayDelay PlayDelay_DefaultValue { get; set; }
		...
		/// </summary>
		public AroonoscillatorSeriesSonificationDefaultSpeechOptionsMappingTime Time { get; set; }
		private AroonoscillatorSeriesSonificationDefaultSpeechOptionsMappingTime Time_DefaultValue { get; set; }
		...
		/// </summary>
		public AroonoscillatorSeriesSonificationDefaultSpeechOptionsMappingTremolo Tremolo { get; set; }
		private AroonoscillatorSeriesSonificationDefaultSpeechOptionsMappingTremolo Tremolo_DefaultValue { get; set; }
		 

		/// <summary>
		/// The volume of notes, from 0 to 1.
		/// </summary>
		public AroonoscillatorSeriesSonificationDefaultSpeechOptionsMappingVolume Volume { get; set; }
		private AroonoscillatorSeriesSonificationDefaultSpeechOptionsMappingVolume Volume_DefaultValue { get; set; }
