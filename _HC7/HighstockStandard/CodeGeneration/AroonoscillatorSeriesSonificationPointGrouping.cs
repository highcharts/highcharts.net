...
{
	public partial class AroonoscillatorSeriesSonificationPointGrouping  : BaseObject
	{
		Hashtable h = new Hashtable();

		public AroonoscillatorSeriesSonificationPointGrouping()
		{
			Algorithm = Algorithm_DefaultValue = AroonoscillatorSeriesSonificationPointGroupingAlgorithm.Minimax;
		...
		/// </summary>
		public AroonoscillatorSeriesSonificationPointGroupingAlgorithm Algorithm { get; set; }
		private AroonoscillatorSeriesSonificationPointGroupingAlgorithm Algorithm_DefaultValue { get; set; }
