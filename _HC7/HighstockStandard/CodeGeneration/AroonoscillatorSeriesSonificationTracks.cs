...
{
	public partial class AroonoscillatorSeriesSonificationTracks  : BaseObject
	{
		Hashtable h = new Hashtable();

		public AroonoscillatorSeriesSonificationTracks()
		{
			ActiveWhen = ActiveWhen_DefaultValue = new AroonoscillatorSeriesSonificationTracksActiveWhen();
			Instrument = Instrument_DefaultValue = null;
			InstrumentString = InstrumentString_DefaultValue = "null";
			Mapping = Mapping_DefaultValue = new AroonoscillatorSeriesSonificationTracksMapping();
			MidiName = MidiName_DefaultValue = "";
			PointGrouping = PointGrouping_DefaultValue = new AroonoscillatorSeriesSonificationTracksPointGrouping();
			RoundToMusicalNotes = RoundToMusicalNotes_DefaultValue = true;
			ShowPlayMarker = ShowPlayMarker_DefaultValue = true;
			Type = Type_DefaultValue = AroonoscillatorSeriesSonificationTracksType.Instrument;
		...
		/// </summary>
		public AroonoscillatorSeriesSonificationTracksActiveWhen ActiveWhen { get; set; }
		private AroonoscillatorSeriesSonificationTracksActiveWhen ActiveWhen_DefaultValue { get; set; }
		...
		/// </summary>
		public AroonoscillatorSeriesSonificationTracksMapping Mapping { get; set; }
		private AroonoscillatorSeriesSonificationTracksMapping Mapping_DefaultValue { get; set; }
		...
		/// </summary>
		public AroonoscillatorSeriesSonificationTracksPointGrouping PointGrouping { get; set; }
		private AroonoscillatorSeriesSonificationTracksPointGrouping PointGrouping_DefaultValue { get; set; }
		...
		/// </summary>
		public AroonoscillatorSeriesSonificationTracksType Type { get; set; }
		private AroonoscillatorSeriesSonificationTracksType Type_DefaultValue { get; set; }
