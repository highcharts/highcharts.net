...
{
	public partial class AroonoscillatorSeriesSonificationTracksMapping  : BaseObject
	{
		Hashtable h = new Hashtable();

		public AroonoscillatorSeriesSonificationTracksMapping()
		{
			Frequency = Frequency_DefaultValue = new AroonoscillatorSeriesSonificationTracksMappingFrequency();
			GapBetweenNotes = GapBetweenNotes_DefaultValue = new AroonoscillatorSeriesSonificationTracksMappingGapBetweenNotes();
			Highpass = Highpass_DefaultValue = new AroonoscillatorSeriesSonificationTracksMappingHighpass();
			Lowpass = Lowpass_DefaultValue = new AroonoscillatorSeriesSonificationTracksMappingLowpass();
			NoteDuration = NoteDuration_DefaultValue = new AroonoscillatorSeriesSonificationTracksMappingNoteDuration();
			Pan = Pan_DefaultValue = new AroonoscillatorSeriesSonificationTracksMappingPan();
			Pitch = Pitch_DefaultValue = new AroonoscillatorSeriesSonificationTracksMappingPitch();
			PitchString = PitchString_DefaultValue = "null";
			PitchNumber = PitchNumber_DefaultValue = null;
			PlayDelay = PlayDelay_DefaultValue = new AroonoscillatorSeriesSonificationTracksMappingPlayDelay();
			Time = Time_DefaultValue = new AroonoscillatorSeriesSonificationTracksMappingTime();
			TimeString = TimeString_DefaultValue = "null";
			TimeNumber = TimeNumber_DefaultValue = null;
			Tremolo = Tremolo_DefaultValue = new AroonoscillatorSeriesSonificationTracksMappingTremolo();
			Volume = Volume_DefaultValue = new AroonoscillatorSeriesSonificationTracksMappingVolume();
		...
		/// </summary>
		public AroonoscillatorSeriesSonificationTracksMappingFrequency Frequency { get; set; }
		private AroonoscillatorSeriesSonificationTracksMappingFrequency Frequency_DefaultValue { get; set; }
		...
		/// </summary>
		public AroonoscillatorSeriesSonificationTracksMappingGapBetweenNotes GapBetweenNotes { get; set; }
		private AroonoscillatorSeriesSonificationTracksMappingGapBetweenNotes GapBetweenNotes_DefaultValue { get; set; }
		...
		/// </summary>
		public AroonoscillatorSeriesSonificationTracksMappingHighpass Highpass { get; set; }
		private AroonoscillatorSeriesSonificationTracksMappingHighpass Highpass_DefaultValue { get; set; }
		...
		/// </summary>
		public AroonoscillatorSeriesSonificationTracksMappingLowpass Lowpass { get; set; }
		private AroonoscillatorSeriesSonificationTracksMappingLowpass Lowpass_DefaultValue { get; set; }
		...
		/// </summary>
		public AroonoscillatorSeriesSonificationTracksMappingNoteDuration NoteDuration { get; set; }
		private AroonoscillatorSeriesSonificationTracksMappingNoteDuration NoteDuration_DefaultValue { get; set; }
		...
		/// </summary>
		public AroonoscillatorSeriesSonificationTracksMappingPan Pan { get; set; }
		private AroonoscillatorSeriesSonificationTracksMappingPan Pan_DefaultValue { get; set; }
		...
		/// </summary>
		public AroonoscillatorSeriesSonificationTracksMappingPitch Pitch { get; set; }
		private AroonoscillatorSeriesSonificationTracksMappingPitch Pitch_DefaultValue { get; set; }
		...
		/// </summary>
		public AroonoscillatorSeriesSonificationTracksMappingPlayDelay PlayDelay { get; set; }
		private AroonoscillatorSeriesSonificationTracksMappingPlayDelay PlayDelay_DefaultValue { get; set; }
		...
		/// </summary>
		public AroonoscillatorSeriesSonificationTracksMappingTime Time { get; set; }
		private AroonoscillatorSeriesSonificationTracksMappingTime Time_DefaultValue { get; set; }
		...
		/// </summary>
		public AroonoscillatorSeriesSonificationTracksMappingTremolo Tremolo { get; set; }
		private AroonoscillatorSeriesSonificationTracksMappingTremolo Tremolo_DefaultValue { get; set; }
		 

		/// <summary>
		/// The volume of notes, from 0 to 1.
		/// </summary>
		public AroonoscillatorSeriesSonificationTracksMappingVolume Volume { get; set; }
		private AroonoscillatorSeriesSonificationTracksMappingVolume Volume_DefaultValue { get; set; }
