...
{
	public partial class AroonoscillatorSeriesSonificationTracksMappingVolume  : BaseObject
	{
		Hashtable h = new Hashtable();

		public AroonoscillatorSeriesSonificationTracksMappingVolume()
		{
			MapFunction = MapFunction_DefaultValue = AroonoscillatorSeriesSonificationTracksMappingVolumeMapFunction.Linear;
			MapTo = MapTo_DefaultValue = "";
			Max = Max_DefaultValue = null;
			Min = Min_DefaultValue = null;
			Value = Value_DefaultValue = null;
			Within = Within_DefaultValue = AroonoscillatorSeriesSonificationTracksMappingVolumeWithin.Chart;
		...
		/// </summary>
		public AroonoscillatorSeriesSonificationTracksMappingVolumeMapFunction MapFunction { get; set; }
		private AroonoscillatorSeriesSonificationTracksMappingVolumeMapFunction MapFunction_DefaultValue { get; set; }
		...
		/// </summary>
		public AroonoscillatorSeriesSonificationTracksMappingVolumeWithin Within { get; set; }
		private AroonoscillatorSeriesSonificationTracksMappingVolumeWithin Within_DefaultValue { get; set; }
