...
{
	public partial class AroonoscillatorSeriesStatesHoverMarker  : BaseObject
	{
		public AroonoscillatorSeriesStatesHoverMarker()
		{
			...
			States = States_DefaultValue = new AroonoscillatorSeriesStatesHoverMarkerStates();
		...
		/// </summary>
		public AroonoscillatorSeriesStatesHoverMarkerStates States { get; set; }
		private AroonoscillatorSeriesStatesHoverMarkerStates States_DefaultValue { get; set; }
