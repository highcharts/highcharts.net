...
namespace Highsoft.Web.Mvc.Stocks
{
	public partial class AtrSeriesAccessibility  : BaseObject
	{
		...
		public AtrSeriesAccessibility()
		{
			...
			Point = Point_DefaultValue = new AtrSeriesAccessibilityPoint();
		...
		/// </summary>
		public AtrSeriesAccessibilityPoint Point { get; set; }
		private AtrSeriesAccessibilityPoint Point_DefaultValue { get; set; }
