...
namespace Highsoft.Web.Mvc.Stocks
{
	public partial class AtrSeriesDataGrouping  : BaseObject
	{
		...
		internal override Hashtable ToHashtable()
		{
			...
			if (Approximation != Approximation_DefaultValue) { h.Add("approximation",Approximation); Highstock.AddFunction("AtrSeriesDataGroupingApproximation.approximation", Approximation); }  
