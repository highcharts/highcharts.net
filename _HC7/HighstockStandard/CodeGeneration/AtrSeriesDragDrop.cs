...
{
	public partial class AtrSeriesDragDrop  : BaseObject
	{
		public AtrSeriesDragDrop()
		{
			DraggableX = DraggableX_DefaultValue = null;
			DraggableY = DraggableY_DefaultValue = null;
			DragHandle = DragHandle_DefaultValue = new AtrSeriesDragDropDragHandle();
			...
			GuideBox = GuideBox_DefaultValue = new AtrSeriesDragDropGuideBox();
		...
		/// </summary>
		public AtrSeriesDragDropDragHandle DragHandle { get; set; }
		private AtrSeriesDragDropDragHandle DragHandle_DefaultValue { get; set; }
		...
		/// </summary>
		public AtrSeriesDragDropGuideBox GuideBox { get; set; }
		private AtrSeriesDragDropGuideBox GuideBox_DefaultValue { get; set; }
