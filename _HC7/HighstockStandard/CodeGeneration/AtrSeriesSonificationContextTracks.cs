...
{
	public partial class AtrSeriesSonificationContextTracks  : BaseObject
	{
		Hashtable h = new Hashtable();

		public AtrSeriesSonificationContextTracks()
		{
			ActiveWhen = ActiveWhen_DefaultValue = new AtrSeriesSonificationContextTracksActiveWhen();
			Instrument = Instrument_DefaultValue = null;
			InstrumentString = InstrumentString_DefaultValue = "null";
			Mapping = Mapping_DefaultValue = new AtrSeriesSonificationContextTracksMapping();
			MidiName = MidiName_DefaultValue = "";
			PointGrouping = PointGrouping_DefaultValue = new AtrSeriesSonificationContextTracksPointGrouping();
			...
			Type = Type_DefaultValue = AtrSeriesSonificationContextTracksType.Instrument;
			ValueInterval = ValueInterval_DefaultValue = null;
			ValueMapFunction = ValueMapFunction_DefaultValue = AtrSeriesSonificationContextTracksValueMapFunction.Linear;
		...
		/// </summary>
		public AtrSeriesSonificationContextTracksActiveWhen ActiveWhen { get; set; }
		private AtrSeriesSonificationContextTracksActiveWhen ActiveWhen_DefaultValue { get; set; }
		...
		/// </summary>
		public AtrSeriesSonificationContextTracksMapping Mapping { get; set; }
		private AtrSeriesSonificationContextTracksMapping Mapping_DefaultValue { get; set; }
		...
		/// </summary>
		public AtrSeriesSonificationContextTracksPointGrouping PointGrouping { get; set; }
		private AtrSeriesSonificationContextTracksPointGrouping PointGrouping_DefaultValue { get; set; }
		...
		/// </summary>
		public AtrSeriesSonificationContextTracksType Type { get; set; }
		private AtrSeriesSonificationContextTracksType Type_DefaultValue { get; set; }
		...
		/// </summary>
		public AtrSeriesSonificationContextTracksValueMapFunction ValueMapFunction { get; set; }
		private AtrSeriesSonificationContextTracksValueMapFunction ValueMapFunction_DefaultValue { get; set; }
