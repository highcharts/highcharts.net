...
{
	public partial class AtrSeriesSonificationContextTracksMapping  : BaseObject
	{
		Hashtable h = new Hashtable();

		public AtrSeriesSonificationContextTracksMapping()
		{
			Frequency = Frequency_DefaultValue = new AtrSeriesSonificationContextTracksMappingFrequency();
			GapBetweenNotes = GapBetweenNotes_DefaultValue = new AtrSeriesSonificationContextTracksMappingGapBetweenNotes();
			Highpass = Highpass_DefaultValue = new AtrSeriesSonificationContextTracksMappingHighpass();
			Lowpass = Lowpass_DefaultValue = new AtrSeriesSonificationContextTracksMappingLowpass();
			NoteDuration = NoteDuration_DefaultValue = new AtrSeriesSonificationContextTracksMappingNoteDuration();
			Pan = Pan_DefaultValue = new AtrSeriesSonificationContextTracksMappingPan();
			Pitch = Pitch_DefaultValue = new AtrSeriesSonificationContextTracksMappingPitch();
			PitchString = PitchString_DefaultValue = "null";
			PitchNumber = PitchNumber_DefaultValue = null;
			PlayDelay = PlayDelay_DefaultValue = new AtrSeriesSonificationContextTracksMappingPlayDelay();
			Time = Time_DefaultValue = new AtrSeriesSonificationContextTracksMappingTime();
			TimeString = TimeString_DefaultValue = "null";
			TimeNumber = TimeNumber_DefaultValue = null;
			Tremolo = Tremolo_DefaultValue = new AtrSeriesSonificationContextTracksMappingTremolo();
			Volume = Volume_DefaultValue = new AtrSeriesSonificationContextTracksMappingVolume();
		...
		/// </summary>
		public AtrSeriesSonificationContextTracksMappingFrequency Frequency { get; set; }
		private AtrSeriesSonificationContextTracksMappingFrequency Frequency_DefaultValue { get; set; }
		...
		/// </summary>
		public AtrSeriesSonificationContextTracksMappingGapBetweenNotes GapBetweenNotes { get; set; }
		private AtrSeriesSonificationContextTracksMappingGapBetweenNotes GapBetweenNotes_DefaultValue { get; set; }
		...
		/// </summary>
		public AtrSeriesSonificationContextTracksMappingHighpass Highpass { get; set; }
		private AtrSeriesSonificationContextTracksMappingHighpass Highpass_DefaultValue { get; set; }
		...
		/// </summary>
		public AtrSeriesSonificationContextTracksMappingLowpass Lowpass { get; set; }
		private AtrSeriesSonificationContextTracksMappingLowpass Lowpass_DefaultValue { get; set; }
		...
		/// </summary>
		public AtrSeriesSonificationContextTracksMappingNoteDuration NoteDuration { get; set; }
		private AtrSeriesSonificationContextTracksMappingNoteDuration NoteDuration_DefaultValue { get; set; }
		...
		/// </summary>
		public AtrSeriesSonificationContextTracksMappingPan Pan { get; set; }
		private AtrSeriesSonificationContextTracksMappingPan Pan_DefaultValue { get; set; }
		...
		/// </summary>
		public AtrSeriesSonificationContextTracksMappingPitch Pitch { get; set; }
		private AtrSeriesSonificationContextTracksMappingPitch Pitch_DefaultValue { get; set; }
		...
		/// </summary>
		public AtrSeriesSonificationContextTracksMappingPlayDelay PlayDelay { get; set; }
		private AtrSeriesSonificationContextTracksMappingPlayDelay PlayDelay_DefaultValue { get; set; }
		...
		/// </summary>
		public AtrSeriesSonificationContextTracksMappingTime Time { get; set; }
		private AtrSeriesSonificationContextTracksMappingTime Time_DefaultValue { get; set; }
		...
		/// </summary>
		public AtrSeriesSonificationContextTracksMappingTremolo Tremolo { get; set; }
		private AtrSeriesSonificationContextTracksMappingTremolo Tremolo_DefaultValue { get; set; }
		 

		/// <summary>
		/// The volume of notes, from 0 to 1.
		/// </summary>
		public AtrSeriesSonificationContextTracksMappingVolume Volume { get; set; }
		private AtrSeriesSonificationContextTracksMappingVolume Volume_DefaultValue { get; set; }
