...
{
	public partial class AtrSeriesSonificationContextTracksMappingFrequency  : BaseObject
	{
		Hashtable h = new Hashtable();

		public AtrSeriesSonificationContextTracksMappingFrequency()
		{
			MapFunction = MapFunction_DefaultValue = AtrSeriesSonificationContextTracksMappingFrequencyMapFunction.Linear;
			MapTo = MapTo_DefaultValue = "";
			Max = Max_DefaultValue = null;
			Min = Min_DefaultValue = null;
			Value = Value_DefaultValue = null;
			Within = Within_DefaultValue = AtrSeriesSonificationContextTracksMappingFrequencyWithin.Chart;
		...
		/// </summary>
		public AtrSeriesSonificationContextTracksMappingFrequencyMapFunction MapFunction { get; set; }
		private AtrSeriesSonificationContextTracksMappingFrequencyMapFunction MapFunction_DefaultValue { get; set; }
		...
		/// </summary>
		public AtrSeriesSonificationContextTracksMappingFrequencyWithin Within { get; set; }
		private AtrSeriesSonificationContextTracksMappingFrequencyWithin Within_DefaultValue { get; set; }
