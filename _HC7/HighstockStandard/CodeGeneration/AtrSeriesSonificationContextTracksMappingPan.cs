...
{
	public partial class AtrSeriesSonificationContextTracksMappingPan  : BaseObject
	{
		Hashtable h = new Hashtable();

		public AtrSeriesSonificationContextTracksMappingPan()
		{
			MapFunction = MapFunction_DefaultValue = AtrSeriesSonificationContextTracksMappingPanMapFunction.Linear;
			MapTo = MapTo_DefaultValue = "";
			Max = Max_DefaultValue = null;
			Min = Min_DefaultValue = null;
			Value = Value_DefaultValue = null;
			Within = Within_DefaultValue = AtrSeriesSonificationContextTracksMappingPanWithin.Chart;
		...
		/// </summary>
		public AtrSeriesSonificationContextTracksMappingPanMapFunction MapFunction { get; set; }
		private AtrSeriesSonificationContextTracksMappingPanMapFunction MapFunction_DefaultValue { get; set; }
		...
		/// </summary>
		public AtrSeriesSonificationContextTracksMappingPanWithin Within { get; set; }
		private AtrSeriesSonificationContextTracksMappingPanWithin Within_DefaultValue { get; set; }
