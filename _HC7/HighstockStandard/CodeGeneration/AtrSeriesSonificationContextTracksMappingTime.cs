...
{
	public partial class AtrSeriesSonificationContextTracksMappingTime  : BaseObject
	{
		Hashtable h = new Hashtable();

		public AtrSeriesSonificationContextTracksMappingTime()
		{
			MapFunction = MapFunction_DefaultValue = AtrSeriesSonificationContextTracksMappingTimeMapFunction.Linear;
			MapTo = MapTo_DefaultValue = "";
			Max = Max_DefaultValue = null;
			Min = Min_DefaultValue = null;
			Value = Value_DefaultValue = null;
			Within = Within_DefaultValue = AtrSeriesSonificationContextTracksMappingTimeWithin.Chart;
		...
		/// </summary>
		public AtrSeriesSonificationContextTracksMappingTimeMapFunction MapFunction { get; set; }
		private AtrSeriesSonificationContextTracksMappingTimeMapFunction MapFunction_DefaultValue { get; set; }
		...
		/// </summary>
		public AtrSeriesSonificationContextTracksMappingTimeWithin Within { get; set; }
		private AtrSeriesSonificationContextTracksMappingTimeWithin Within_DefaultValue { get; set; }
