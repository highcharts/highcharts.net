...
{
	public partial class AtrSeriesSonificationContextTracksMappingVolume  : BaseObject
	{
		Hashtable h = new Hashtable();

		public AtrSeriesSonificationContextTracksMappingVolume()
		{
			MapFunction = MapFunction_DefaultValue = AtrSeriesSonificationContextTracksMappingVolumeMapFunction.Linear;
			MapTo = MapTo_DefaultValue = "";
			Max = Max_DefaultValue = null;
			Min = Min_DefaultValue = null;
			Value = Value_DefaultValue = null;
			Within = Within_DefaultValue = AtrSeriesSonificationContextTracksMappingVolumeWithin.Chart;
		...
		/// </summary>
		public AtrSeriesSonificationContextTracksMappingVolumeMapFunction MapFunction { get; set; }
		private AtrSeriesSonificationContextTracksMappingVolumeMapFunction MapFunction_DefaultValue { get; set; }
		...
		/// </summary>
		public AtrSeriesSonificationContextTracksMappingVolumeWithin Within { get; set; }
		private AtrSeriesSonificationContextTracksMappingVolumeWithin Within_DefaultValue { get; set; }
