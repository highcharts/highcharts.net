...
{
	public partial class AtrSeriesSonificationContextTracksPointGrouping  : BaseObject
	{
		Hashtable h = new Hashtable();

		public AtrSeriesSonificationContextTracksPointGrouping()
		{
			Algorithm = Algorithm_DefaultValue = AtrSeriesSonificationContextTracksPointGroupingAlgorithm.Minimax;
		...
		/// </summary>
		public AtrSeriesSonificationContextTracksPointGroupingAlgorithm Algorithm { get; set; }
		private AtrSeriesSonificationContextTracksPointGroupingAlgorithm Algorithm_DefaultValue { get; set; }
