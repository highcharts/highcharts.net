...
{
	public partial class AtrSeriesSonificationDefaultInstrumentOptions  : BaseObject
	{
		Hashtable h = new Hashtable();

		public AtrSeriesSonificationDefaultInstrumentOptions()
		{
			ActiveWhen = ActiveWhen_DefaultValue = new AtrSeriesSonificationDefaultInstrumentOptionsActiveWhen();
			Instrument = Instrument_DefaultValue = null;
			InstrumentString = InstrumentString_DefaultValue = "null";
			Mapping = Mapping_DefaultValue = new AtrSeriesSonificationDefaultInstrumentOptionsMapping();
			MidiName = MidiName_DefaultValue = "";
			PointGrouping = PointGrouping_DefaultValue = new AtrSeriesSonificationDefaultInstrumentOptionsPointGrouping();
			RoundToMusicalNotes = RoundToMusicalNotes_DefaultValue = true;
			ShowPlayMarker = ShowPlayMarker_DefaultValue = true;
			Type = Type_DefaultValue = AtrSeriesSonificationDefaultInstrumentOptionsType.Instrument;
		...
		/// </summary>
		public AtrSeriesSonificationDefaultInstrumentOptionsActiveWhen ActiveWhen { get; set; }
		private AtrSeriesSonificationDefaultInstrumentOptionsActiveWhen ActiveWhen_DefaultValue { get; set; }
		...
		/// </summary>
		public AtrSeriesSonificationDefaultInstrumentOptionsMapping Mapping { get; set; }
		private AtrSeriesSonificationDefaultInstrumentOptionsMapping Mapping_DefaultValue { get; set; }
		...
		/// </summary>
		public AtrSeriesSonificationDefaultInstrumentOptionsPointGrouping PointGrouping { get; set; }
		private AtrSeriesSonificationDefaultInstrumentOptionsPointGrouping PointGrouping_DefaultValue { get; set; }
		...
		/// </summary>
		public AtrSeriesSonificationDefaultInstrumentOptionsType Type { get; set; }
		private AtrSeriesSonificationDefaultInstrumentOptionsType Type_DefaultValue { get; set; }
