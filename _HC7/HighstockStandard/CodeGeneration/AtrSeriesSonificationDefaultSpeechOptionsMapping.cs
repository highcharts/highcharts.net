...
{
	public partial class AtrSeriesSonificationDefaultSpeechOptionsMapping  : BaseObject
	{
		Hashtable h = new Hashtable();

		public AtrSeriesSonificationDefaultSpeechOptionsMapping()
		{
			Frequency = Frequency_DefaultValue = new AtrSeriesSonificationDefaultSpeechOptionsMappingFrequency();
			GapBetweenNotes = GapBetweenNotes_DefaultValue = new AtrSeriesSonificationDefaultSpeechOptionsMappingGapBetweenNotes();
			Highpass = Highpass_DefaultValue = new AtrSeriesSonificationDefaultSpeechOptionsMappingHighpass();
			Lowpass = Lowpass_DefaultValue = new AtrSeriesSonificationDefaultSpeechOptionsMappingLowpass();
			NoteDuration = NoteDuration_DefaultValue = new AtrSeriesSonificationDefaultSpeechOptionsMappingNoteDuration();
			Pan = Pan_DefaultValue = new AtrSeriesSonificationDefaultSpeechOptionsMappingPan();
			Pitch = Pitch_DefaultValue = new AtrSeriesSonificationDefaultSpeechOptionsMappingPitch();
			PitchString = PitchString_DefaultValue = "null";
			PitchNumber = PitchNumber_DefaultValue = null;
			PlayDelay = PlayDelay_DefaultValue = new AtrSeriesSonificationDefaultSpeechOptionsMappingPlayDelay();
			Time = Time_DefaultValue = new AtrSeriesSonificationDefaultSpeechOptionsMappingTime();
			TimeString = TimeString_DefaultValue = "null";
			TimeNumber = TimeNumber_DefaultValue = null;
			Tremolo = Tremolo_DefaultValue = new AtrSeriesSonificationDefaultSpeechOptionsMappingTremolo();
			Volume = Volume_DefaultValue = new AtrSeriesSonificationDefaultSpeechOptionsMappingVolume();
		...
		/// </summary>
		public AtrSeriesSonificationDefaultSpeechOptionsMappingFrequency Frequency { get; set; }
		private AtrSeriesSonificationDefaultSpeechOptionsMappingFrequency Frequency_DefaultValue { get; set; }
		...
		/// </summary>
		public AtrSeriesSonificationDefaultSpeechOptionsMappingGapBetweenNotes GapBetweenNotes { get; set; }
		private AtrSeriesSonificationDefaultSpeechOptionsMappingGapBetweenNotes GapBetweenNotes_DefaultValue { get; set; }
		...
		/// </summary>
		public AtrSeriesSonificationDefaultSpeechOptionsMappingHighpass Highpass { get; set; }
		private AtrSeriesSonificationDefaultSpeechOptionsMappingHighpass Highpass_DefaultValue { get; set; }
		...
		/// </summary>
		public AtrSeriesSonificationDefaultSpeechOptionsMappingLowpass Lowpass { get; set; }
		private AtrSeriesSonificationDefaultSpeechOptionsMappingLowpass Lowpass_DefaultValue { get; set; }
		...
		/// </summary>
		public AtrSeriesSonificationDefaultSpeechOptionsMappingNoteDuration NoteDuration { get; set; }
		private AtrSeriesSonificationDefaultSpeechOptionsMappingNoteDuration NoteDuration_DefaultValue { get; set; }
		...
		/// </summary>
		public AtrSeriesSonificationDefaultSpeechOptionsMappingPan Pan { get; set; }
		private AtrSeriesSonificationDefaultSpeechOptionsMappingPan Pan_DefaultValue { get; set; }
		...
		/// </summary>
		public AtrSeriesSonificationDefaultSpeechOptionsMappingPitch Pitch { get; set; }
		private AtrSeriesSonificationDefaultSpeechOptionsMappingPitch Pitch_DefaultValue { get; set; }
		...
		/// </summary>
		public AtrSeriesSonificationDefaultSpeechOptionsMappingPlayDelay PlayDelay { get; set; }
		private AtrSeriesSonificationDefaultSpeechOptionsMappingPlayDelay PlayDelay_DefaultValue { get; set; }
		...
		/// </summary>
		public AtrSeriesSonificationDefaultSpeechOptionsMappingTime Time { get; set; }
		private AtrSeriesSonificationDefaultSpeechOptionsMappingTime Time_DefaultValue { get; set; }
		...
		/// </summary>
		public AtrSeriesSonificationDefaultSpeechOptionsMappingTremolo Tremolo { get; set; }
		private AtrSeriesSonificationDefaultSpeechOptionsMappingTremolo Tremolo_DefaultValue { get; set; }
		 

		/// <summary>
		/// The volume of notes, from 0 to 1.
		/// </summary>
		public AtrSeriesSonificationDefaultSpeechOptionsMappingVolume Volume { get; set; }
		private AtrSeriesSonificationDefaultSpeechOptionsMappingVolume Volume_DefaultValue { get; set; }
