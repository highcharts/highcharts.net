...
{
	public partial class AtrSeriesSonificationDefaultSpeechOptionsPointGrouping  : BaseObject
	{
		Hashtable h = new Hashtable();

		public AtrSeriesSonificationDefaultSpeechOptionsPointGrouping()
		{
			Algorithm = Algorithm_DefaultValue = AtrSeriesSonificationDefaultSpeechOptionsPointGroupingAlgorithm.Minimax;
		...
		/// </summary>
		public AtrSeriesSonificationDefaultSpeechOptionsPointGroupingAlgorithm Algorithm { get; set; }
		private AtrSeriesSonificationDefaultSpeechOptionsPointGroupingAlgorithm Algorithm_DefaultValue { get; set; }
