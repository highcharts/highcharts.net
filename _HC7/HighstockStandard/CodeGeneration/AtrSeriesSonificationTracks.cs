...
{
	public partial class AtrSeriesSonificationTracks  : BaseObject
	{
		Hashtable h = new Hashtable();

		public AtrSeriesSonificationTracks()
		{
			ActiveWhen = ActiveWhen_DefaultValue = new AtrSeriesSonificationTracksActiveWhen();
			Instrument = Instrument_DefaultValue = null;
			InstrumentString = InstrumentString_DefaultValue = "null";
			Mapping = Mapping_DefaultValue = new AtrSeriesSonificationTracksMapping();
			MidiName = MidiName_DefaultValue = "";
			PointGrouping = PointGrouping_DefaultValue = new AtrSeriesSonificationTracksPointGrouping();
			RoundToMusicalNotes = RoundToMusicalNotes_DefaultValue = true;
			ShowPlayMarker = ShowPlayMarker_DefaultValue = true;
			Type = Type_DefaultValue = AtrSeriesSonificationTracksType.Instrument;
		...
		/// </summary>
		public AtrSeriesSonificationTracksActiveWhen ActiveWhen { get; set; }
		private AtrSeriesSonificationTracksActiveWhen ActiveWhen_DefaultValue { get; set; }
		...
		/// </summary>
		public AtrSeriesSonificationTracksMapping Mapping { get; set; }
		private AtrSeriesSonificationTracksMapping Mapping_DefaultValue { get; set; }
		...
		/// </summary>
		public AtrSeriesSonificationTracksPointGrouping PointGrouping { get; set; }
		private AtrSeriesSonificationTracksPointGrouping PointGrouping_DefaultValue { get; set; }
		...
		/// </summary>
		public AtrSeriesSonificationTracksType Type { get; set; }
		private AtrSeriesSonificationTracksType Type_DefaultValue { get; set; }
