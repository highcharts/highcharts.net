...
{
	public partial class AtrSeriesSonificationTracksMapping  : BaseObject
	{
		Hashtable h = new Hashtable();

		public AtrSeriesSonificationTracksMapping()
		{
			Frequency = Frequency_DefaultValue = new AtrSeriesSonificationTracksMappingFrequency();
			GapBetweenNotes = GapBetweenNotes_DefaultValue = new AtrSeriesSonificationTracksMappingGapBetweenNotes();
			Highpass = Highpass_DefaultValue = new AtrSeriesSonificationTracksMappingHighpass();
			Lowpass = Lowpass_DefaultValue = new AtrSeriesSonificationTracksMappingLowpass();
			NoteDuration = NoteDuration_DefaultValue = new AtrSeriesSonificationTracksMappingNoteDuration();
			Pan = Pan_DefaultValue = new AtrSeriesSonificationTracksMappingPan();
			Pitch = Pitch_DefaultValue = new AtrSeriesSonificationTracksMappingPitch();
			PitchString = PitchString_DefaultValue = "null";
			PitchNumber = PitchNumber_DefaultValue = null;
			PlayDelay = PlayDelay_DefaultValue = new AtrSeriesSonificationTracksMappingPlayDelay();
			Time = Time_DefaultValue = new AtrSeriesSonificationTracksMappingTime();
			TimeString = TimeString_DefaultValue = "null";
			TimeNumber = TimeNumber_DefaultValue = null;
			Tremolo = Tremolo_DefaultValue = new AtrSeriesSonificationTracksMappingTremolo();
			Volume = Volume_DefaultValue = new AtrSeriesSonificationTracksMappingVolume();
		...
		/// </summary>
		public AtrSeriesSonificationTracksMappingFrequency Frequency { get; set; }
		private AtrSeriesSonificationTracksMappingFrequency Frequency_DefaultValue { get; set; }
		...
		/// </summary>
		public AtrSeriesSonificationTracksMappingGapBetweenNotes GapBetweenNotes { get; set; }
		private AtrSeriesSonificationTracksMappingGapBetweenNotes GapBetweenNotes_DefaultValue { get; set; }
		...
		/// </summary>
		public AtrSeriesSonificationTracksMappingHighpass Highpass { get; set; }
		private AtrSeriesSonificationTracksMappingHighpass Highpass_DefaultValue { get; set; }
		...
		/// </summary>
		public AtrSeriesSonificationTracksMappingLowpass Lowpass { get; set; }
		private AtrSeriesSonificationTracksMappingLowpass Lowpass_DefaultValue { get; set; }
		...
		/// </summary>
		public AtrSeriesSonificationTracksMappingNoteDuration NoteDuration { get; set; }
		private AtrSeriesSonificationTracksMappingNoteDuration NoteDuration_DefaultValue { get; set; }
		...
		/// </summary>
		public AtrSeriesSonificationTracksMappingPan Pan { get; set; }
		private AtrSeriesSonificationTracksMappingPan Pan_DefaultValue { get; set; }
		...
		/// </summary>
		public AtrSeriesSonificationTracksMappingPitch Pitch { get; set; }
		private AtrSeriesSonificationTracksMappingPitch Pitch_DefaultValue { get; set; }
		...
		/// </summary>
		public AtrSeriesSonificationTracksMappingPlayDelay PlayDelay { get; set; }
		private AtrSeriesSonificationTracksMappingPlayDelay PlayDelay_DefaultValue { get; set; }
		...
		/// </summary>
		public AtrSeriesSonificationTracksMappingTime Time { get; set; }
		private AtrSeriesSonificationTracksMappingTime Time_DefaultValue { get; set; }
		...
		/// </summary>
		public AtrSeriesSonificationTracksMappingTremolo Tremolo { get; set; }
		private AtrSeriesSonificationTracksMappingTremolo Tremolo_DefaultValue { get; set; }
		 

		/// <summary>
		/// The volume of notes, from 0 to 1.
		/// </summary>
		public AtrSeriesSonificationTracksMappingVolume Volume { get; set; }
		private AtrSeriesSonificationTracksMappingVolume Volume_DefaultValue { get; set; }
