...
{
	public partial class AtrSeriesSonificationTracksMappingFrequency  : BaseObject
	{
		Hashtable h = new Hashtable();

		public AtrSeriesSonificationTracksMappingFrequency()
		{
			MapFunction = MapFunction_DefaultValue = AtrSeriesSonificationTracksMappingFrequencyMapFunction.Linear;
			MapTo = MapTo_DefaultValue = "";
			Max = Max_DefaultValue = null;
			Min = Min_DefaultValue = null;
			Value = Value_DefaultValue = null;
			Within = Within_DefaultValue = AtrSeriesSonificationTracksMappingFrequencyWithin.Chart;
		...
		/// </summary>
		public AtrSeriesSonificationTracksMappingFrequencyMapFunction MapFunction { get; set; }
		private AtrSeriesSonificationTracksMappingFrequencyMapFunction MapFunction_DefaultValue { get; set; }
		...
		/// </summary>
		public AtrSeriesSonificationTracksMappingFrequencyWithin Within { get; set; }
		private AtrSeriesSonificationTracksMappingFrequencyWithin Within_DefaultValue { get; set; }
