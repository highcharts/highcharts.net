...
{
	public partial class AtrSeriesSonificationTracksMappingPan  : BaseObject
	{
		Hashtable h = new Hashtable();

		public AtrSeriesSonificationTracksMappingPan()
		{
			MapFunction = MapFunction_DefaultValue = AtrSeriesSonificationTracksMappingPanMapFunction.Linear;
			MapTo = MapTo_DefaultValue = "";
			Max = Max_DefaultValue = null;
			Min = Min_DefaultValue = null;
			Value = Value_DefaultValue = null;
			Within = Within_DefaultValue = AtrSeriesSonificationTracksMappingPanWithin.Chart;
		...
		/// </summary>
		public AtrSeriesSonificationTracksMappingPanMapFunction MapFunction { get; set; }
		private AtrSeriesSonificationTracksMappingPanMapFunction MapFunction_DefaultValue { get; set; }
		...
		/// </summary>
		public AtrSeriesSonificationTracksMappingPanWithin Within { get; set; }
		private AtrSeriesSonificationTracksMappingPanWithin Within_DefaultValue { get; set; }
