...
{
	public partial class AtrSeriesSonificationTracksMappingPitch  : BaseObject
	{
		Hashtable h = new Hashtable();

		public AtrSeriesSonificationTracksMappingPitch()
		{
			MapFunction = MapFunction_DefaultValue = AtrSeriesSonificationTracksMappingPitchMapFunction.Linear;
		...
		/// </summary>
		public AtrSeriesSonificationTracksMappingPitchMapFunction MapFunction { get; set; }
		private AtrSeriesSonificationTracksMappingPitchMapFunction MapFunction_DefaultValue { get; set; }
