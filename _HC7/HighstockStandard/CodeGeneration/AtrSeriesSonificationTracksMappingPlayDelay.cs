...
{
	public partial class AtrSeriesSonificationTracksMappingPlayDelay  : BaseObject
	{
		Hashtable h = new Hashtable();

		public AtrSeriesSonificationTracksMappingPlayDelay()
		{
			MapFunction = MapFunction_DefaultValue = AtrSeriesSonificationTracksMappingPlayDelayMapFunction.Linear;
			MapTo = MapTo_DefaultValue = "";
			Max = Max_DefaultValue = null;
			Min = Min_DefaultValue = null;
			Value = Value_DefaultValue = null;
			Within = Within_DefaultValue = AtrSeriesSonificationTracksMappingPlayDelayWithin.Chart;
		...
		/// </summary>
		public AtrSeriesSonificationTracksMappingPlayDelayMapFunction MapFunction { get; set; }
		private AtrSeriesSonificationTracksMappingPlayDelayMapFunction MapFunction_DefaultValue { get; set; }
		...
		/// </summary>
		public AtrSeriesSonificationTracksMappingPlayDelayWithin Within { get; set; }
		private AtrSeriesSonificationTracksMappingPlayDelayWithin Within_DefaultValue { get; set; }
