...
{
	public partial class AtrSeriesSonificationTracksMappingTime  : BaseObject
	{
		Hashtable h = new Hashtable();

		public AtrSeriesSonificationTracksMappingTime()
		{
			MapFunction = MapFunction_DefaultValue = AtrSeriesSonificationTracksMappingTimeMapFunction.Linear;
			MapTo = MapTo_DefaultValue = "";
			Max = Max_DefaultValue = null;
			Min = Min_DefaultValue = null;
			Value = Value_DefaultValue = null;
			Within = Within_DefaultValue = AtrSeriesSonificationTracksMappingTimeWithin.Chart;
		...
		/// </summary>
		public AtrSeriesSonificationTracksMappingTimeMapFunction MapFunction { get; set; }
		private AtrSeriesSonificationTracksMappingTimeMapFunction MapFunction_DefaultValue { get; set; }
		...
		/// </summary>
		public AtrSeriesSonificationTracksMappingTimeWithin Within { get; set; }
		private AtrSeriesSonificationTracksMappingTimeWithin Within_DefaultValue { get; set; }
