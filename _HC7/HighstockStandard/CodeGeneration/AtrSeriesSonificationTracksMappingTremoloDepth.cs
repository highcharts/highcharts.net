...
{
	public partial class AtrSeriesSonificationTracksMappingTremoloDepth  : BaseObject
	{
		Hashtable h = new Hashtable();

		public AtrSeriesSonificationTracksMappingTremoloDepth()
		{
			MapFunction = MapFunction_DefaultValue = AtrSeriesSonificationTracksMappingTremoloDepthMapFunction.Linear;
			MapTo = MapTo_DefaultValue = "";
			Max = Max_DefaultValue = null;
			Min = Min_DefaultValue = null;
			Value = Value_DefaultValue = null;
			Within = Within_DefaultValue = AtrSeriesSonificationTracksMappingTremoloDepthWithin.Chart;
		...
		/// </summary>
		public AtrSeriesSonificationTracksMappingTremoloDepthMapFunction MapFunction { get; set; }
		private AtrSeriesSonificationTracksMappingTremoloDepthMapFunction MapFunction_DefaultValue { get; set; }
		...
		/// </summary>
		public AtrSeriesSonificationTracksMappingTremoloDepthWithin Within { get; set; }
		private AtrSeriesSonificationTracksMappingTremoloDepthWithin Within_DefaultValue { get; set; }
