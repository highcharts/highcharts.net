...
{
	public partial class AtrSeriesSonificationTracksMappingTremoloSpeed  : BaseObject
	{
		Hashtable h = new Hashtable();

		public AtrSeriesSonificationTracksMappingTremoloSpeed()
		{
			MapFunction = MapFunction_DefaultValue = AtrSeriesSonificationTracksMappingTremoloSpeedMapFunction.Linear;
			MapTo = MapTo_DefaultValue = "";
			Max = Max_DefaultValue = null;
			Min = Min_DefaultValue = null;
			Value = Value_DefaultValue = null;
			Within = Within_DefaultValue = AtrSeriesSonificationTracksMappingTremoloSpeedWithin.Chart;
		...
		/// </summary>
		public AtrSeriesSonificationTracksMappingTremoloSpeedMapFunction MapFunction { get; set; }
		private AtrSeriesSonificationTracksMappingTremoloSpeedMapFunction MapFunction_DefaultValue { get; set; }
		...
		/// </summary>
		public AtrSeriesSonificationTracksMappingTremoloSpeedWithin Within { get; set; }
		private AtrSeriesSonificationTracksMappingTremoloSpeedWithin Within_DefaultValue { get; set; }
