...
{
	public partial class AtrSeriesSonificationTracksMappingVolume  : BaseObject
	{
		Hashtable h = new Hashtable();

		public AtrSeriesSonificationTracksMappingVolume()
		{
			MapFunction = MapFunction_DefaultValue = AtrSeriesSonificationTracksMappingVolumeMapFunction.Linear;
			MapTo = MapTo_DefaultValue = "";
			Max = Max_DefaultValue = null;
			Min = Min_DefaultValue = null;
			Value = Value_DefaultValue = null;
			Within = Within_DefaultValue = AtrSeriesSonificationTracksMappingVolumeWithin.Chart;
		...
		/// </summary>
		public AtrSeriesSonificationTracksMappingVolumeMapFunction MapFunction { get; set; }
		private AtrSeriesSonificationTracksMappingVolumeMapFunction MapFunction_DefaultValue { get; set; }
		...
		/// </summary>
		public AtrSeriesSonificationTracksMappingVolumeWithin Within { get; set; }
		private AtrSeriesSonificationTracksMappingVolumeWithin Within_DefaultValue { get; set; }
