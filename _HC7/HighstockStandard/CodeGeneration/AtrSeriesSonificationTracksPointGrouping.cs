...
{
	public partial class AtrSeriesSonificationTracksPointGrouping  : BaseObject
	{
		Hashtable h = new Hashtable();

		public AtrSeriesSonificationTracksPointGrouping()
		{
			Algorithm = Algorithm_DefaultValue = AtrSeriesSonificationTracksPointGroupingAlgorithm.Minimax;
		...
		/// </summary>
		public AtrSeriesSonificationTracksPointGroupingAlgorithm Algorithm { get; set; }
		private AtrSeriesSonificationTracksPointGroupingAlgorithm Algorithm_DefaultValue { get; set; }
