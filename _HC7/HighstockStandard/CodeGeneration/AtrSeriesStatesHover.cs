...
{
	public partial class AtrSeriesStatesHover  : BaseObject
	{
		Hashtable h = new Hashtable();

		public AtrSeriesStatesHover()
		{
			Animation = Animation_DefaultValue = new Animation() { Enabled = true };
			Enabled = Enabled_DefaultValue = null;
			Halo = Halo_DefaultValue = new AtrSeriesStatesHoverHalo();
			LineWidth = LineWidth_DefaultValue = null;
			LineWidthPlus = LineWidthPlus_DefaultValue = null;
			Marker = Marker_DefaultValue = new AtrSeriesStatesHoverMarker();
		...
		/// </summary>
		public AtrSeriesStatesHoverHalo Halo { get; set; }
		private AtrSeriesStatesHoverHalo Halo_DefaultValue { get; set; }
		...
		/// </summary>
		public AtrSeriesStatesHoverMarker Marker { get; set; }
		private AtrSeriesStatesHoverMarker Marker_DefaultValue { get; set; }
