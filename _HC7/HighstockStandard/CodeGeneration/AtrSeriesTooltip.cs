...
{
	public partial class AtrSeriesTooltip  : BaseObject
	{
		public AtrSeriesTooltip()
		{
			...
			HeaderShape = HeaderShape_DefaultValue = AtrSeriesTooltipHeaderShape.Callout;
		...
		/// </summary>
		public AtrSeriesTooltipHeaderShape HeaderShape { get; set; }
		private AtrSeriesTooltipHeaderShape HeaderShape_DefaultValue { get; set; }
		...
		internal override Hashtable ToHashtable()
		{
			...
			if (NullFormatter != NullFormatter_DefaultValue) { h.Add("nullFormatter",NullFormatter); Highstock.AddFunction("AtrSeriesTooltipNullFormatter.nullFormatter", NullFormatter); }  
			if (Outside != Outside_DefaultValue) h.Add("outside",Outside);
			if (Padding != Padding_DefaultValue) h.Add("padding",Padding);
			if (PointFormat != PointFormat_DefaultValue) h.Add("pointFormat",PointFormat);
			if (PointFormatter != PointFormatter_DefaultValue) { h.Add("pointFormatter",PointFormatter); Highstock.AddFunction("AtrSeriesTooltipPointFormatter.pointFormatter", PointFormatter); }  
