...
{
	public partial class BbSeriesDragDrop  : BaseObject
	{
		public BbSeriesDragDrop()
		{
			DraggableX = DraggableX_DefaultValue = null;
			DraggableY = DraggableY_DefaultValue = null;
			DragHandle = DragHandle_DefaultValue = new BbSeriesDragDropDragHandle();
			...
			GuideBox = GuideBox_DefaultValue = new BbSeriesDragDropGuideBox();
		...
		/// </summary>
		public BbSeriesDragDropDragHandle DragHandle { get; set; }
		private BbSeriesDragDropDragHandle DragHandle_DefaultValue { get; set; }
		...
		/// </summary>
		public BbSeriesDragDropGuideBox GuideBox { get; set; }
		private BbSeriesDragDropGuideBox GuideBox_DefaultValue { get; set; }
