...
{
	public partial class BbSeriesLabel  : BaseObject
	{
		public BbSeriesLabel()
		{
			...
			Style = Style_DefaultValue = new BbSeriesLabelStyle();
		...
		/// </summary>
		public BbSeriesLabelStyle Style { get; set; }
		private BbSeriesLabelStyle Style_DefaultValue { get; set; }
