...
{
	public partial class BbSeriesLastPriceLabel  : BaseObject
	{
		Hashtable h = new Hashtable();

		public BbSeriesLastPriceLabel()
		{
			Align = Align_DefaultValue = BbSeriesLastPriceLabelAlign.Null;
		...
		/// 
		/// </summary>
		public BbSeriesLastPriceLabelAlign Align { get; set; }
		private BbSeriesLastPriceLabelAlign Align_DefaultValue { get; set; }
