...
{
	public partial class BbSeriesSonificationContextTracks  : BaseObject
	{
		Hashtable h = new Hashtable();

		public BbSeriesSonificationContextTracks()
		{
			ActiveWhen = ActiveWhen_DefaultValue = new BbSeriesSonificationContextTracksActiveWhen();
			Instrument = Instrument_DefaultValue = null;
			InstrumentString = InstrumentString_DefaultValue = "null";
			Mapping = Mapping_DefaultValue = new BbSeriesSonificationContextTracksMapping();
			MidiName = MidiName_DefaultValue = "";
			PointGrouping = PointGrouping_DefaultValue = new BbSeriesSonificationContextTracksPointGrouping();
			...
			Type = Type_DefaultValue = BbSeriesSonificationContextTracksType.Instrument;
			ValueInterval = ValueInterval_DefaultValue = null;
			ValueMapFunction = ValueMapFunction_DefaultValue = BbSeriesSonificationContextTracksValueMapFunction.Linear;
		...
		/// </summary>
		public BbSeriesSonificationContextTracksActiveWhen ActiveWhen { get; set; }
		private BbSeriesSonificationContextTracksActiveWhen ActiveWhen_DefaultValue { get; set; }
		...
		/// </summary>
		public BbSeriesSonificationContextTracksMapping Mapping { get; set; }
		private BbSeriesSonificationContextTracksMapping Mapping_DefaultValue { get; set; }
		...
		/// </summary>
		public BbSeriesSonificationContextTracksPointGrouping PointGrouping { get; set; }
		private BbSeriesSonificationContextTracksPointGrouping PointGrouping_DefaultValue { get; set; }
		...
		/// </summary>
		public BbSeriesSonificationContextTracksType Type { get; set; }
		private BbSeriesSonificationContextTracksType Type_DefaultValue { get; set; }
		...
		/// </summary>
		public BbSeriesSonificationContextTracksValueMapFunction ValueMapFunction { get; set; }
		private BbSeriesSonificationContextTracksValueMapFunction ValueMapFunction_DefaultValue { get; set; }
