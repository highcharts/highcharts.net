...
{
	public partial class BbSeriesSonificationContextTracksMappingFrequency  : BaseObject
	{
		Hashtable h = new Hashtable();

		public BbSeriesSonificationContextTracksMappingFrequency()
		{
			MapFunction = MapFunction_DefaultValue = BbSeriesSonificationContextTracksMappingFrequencyMapFunction.Linear;
			MapTo = MapTo_DefaultValue = "";
			Max = Max_DefaultValue = null;
			Min = Min_DefaultValue = null;
			Value = Value_DefaultValue = null;
			Within = Within_DefaultValue = BbSeriesSonificationContextTracksMappingFrequencyWithin.Chart;
		...
		/// </summary>
		public BbSeriesSonificationContextTracksMappingFrequencyMapFunction MapFunction { get; set; }
		private BbSeriesSonificationContextTracksMappingFrequencyMapFunction MapFunction_DefaultValue { get; set; }
		...
		/// </summary>
		public BbSeriesSonificationContextTracksMappingFrequencyWithin Within { get; set; }
		private BbSeriesSonificationContextTracksMappingFrequencyWithin Within_DefaultValue { get; set; }
