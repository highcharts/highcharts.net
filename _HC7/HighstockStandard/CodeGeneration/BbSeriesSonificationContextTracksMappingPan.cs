...
{
	public partial class BbSeriesSonificationContextTracksMappingPan  : BaseObject
	{
		Hashtable h = new Hashtable();

		public BbSeriesSonificationContextTracksMappingPan()
		{
			MapFunction = MapFunction_DefaultValue = BbSeriesSonificationContextTracksMappingPanMapFunction.Linear;
			MapTo = MapTo_DefaultValue = "";
			Max = Max_DefaultValue = null;
			Min = Min_DefaultValue = null;
			Value = Value_DefaultValue = null;
			Within = Within_DefaultValue = BbSeriesSonificationContextTracksMappingPanWithin.Chart;
		...
		/// </summary>
		public BbSeriesSonificationContextTracksMappingPanMapFunction MapFunction { get; set; }
		private BbSeriesSonificationContextTracksMappingPanMapFunction MapFunction_DefaultValue { get; set; }
		...
		/// </summary>
		public BbSeriesSonificationContextTracksMappingPanWithin Within { get; set; }
		private BbSeriesSonificationContextTracksMappingPanWithin Within_DefaultValue { get; set; }
