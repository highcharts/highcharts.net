...
{
	public partial class BbSeriesSonificationContextTracksMappingPitch  : BaseObject
	{
		Hashtable h = new Hashtable();

		public BbSeriesSonificationContextTracksMappingPitch()
		{
			MapFunction = MapFunction_DefaultValue = BbSeriesSonificationContextTracksMappingPitchMapFunction.Linear;
		...
		/// </summary>
		public BbSeriesSonificationContextTracksMappingPitchMapFunction MapFunction { get; set; }
		private BbSeriesSonificationContextTracksMappingPitchMapFunction MapFunction_DefaultValue { get; set; }
