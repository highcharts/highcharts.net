...
{
	public partial class BbSeriesSonificationContextTracksMappingTime  : BaseObject
	{
		Hashtable h = new Hashtable();

		public BbSeriesSonificationContextTracksMappingTime()
		{
			MapFunction = MapFunction_DefaultValue = BbSeriesSonificationContextTracksMappingTimeMapFunction.Linear;
			MapTo = MapTo_DefaultValue = "";
			Max = Max_DefaultValue = null;
			Min = Min_DefaultValue = null;
			Value = Value_DefaultValue = null;
			Within = Within_DefaultValue = BbSeriesSonificationContextTracksMappingTimeWithin.Chart;
		...
		/// </summary>
		public BbSeriesSonificationContextTracksMappingTimeMapFunction MapFunction { get; set; }
		private BbSeriesSonificationContextTracksMappingTimeMapFunction MapFunction_DefaultValue { get; set; }
		...
		/// </summary>
		public BbSeriesSonificationContextTracksMappingTimeWithin Within { get; set; }
		private BbSeriesSonificationContextTracksMappingTimeWithin Within_DefaultValue { get; set; }
