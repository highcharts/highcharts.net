...
{
	public partial class BbSeriesSonificationContextTracksMappingVolume  : BaseObject
	{
		Hashtable h = new Hashtable();

		public BbSeriesSonificationContextTracksMappingVolume()
		{
			MapFunction = MapFunction_DefaultValue = BbSeriesSonificationContextTracksMappingVolumeMapFunction.Linear;
			MapTo = MapTo_DefaultValue = "";
			Max = Max_DefaultValue = null;
			Min = Min_DefaultValue = null;
			Value = Value_DefaultValue = null;
			Within = Within_DefaultValue = BbSeriesSonificationContextTracksMappingVolumeWithin.Chart;
		...
		/// </summary>
		public BbSeriesSonificationContextTracksMappingVolumeMapFunction MapFunction { get; set; }
		private BbSeriesSonificationContextTracksMappingVolumeMapFunction MapFunction_DefaultValue { get; set; }
		...
		/// </summary>
		public BbSeriesSonificationContextTracksMappingVolumeWithin Within { get; set; }
		private BbSeriesSonificationContextTracksMappingVolumeWithin Within_DefaultValue { get; set; }
