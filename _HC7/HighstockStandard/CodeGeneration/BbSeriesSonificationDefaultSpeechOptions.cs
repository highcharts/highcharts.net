...
{
	public partial class BbSeriesSonificationDefaultSpeechOptions  : BaseObject
	{
		Hashtable h = new Hashtable();

		public BbSeriesSonificationDefaultSpeechOptions()
		{
			ActiveWhen = ActiveWhen_DefaultValue = new BbSeriesSonificationDefaultSpeechOptionsActiveWhen();
			Language = Language_DefaultValue = "en-US";
			Mapping = Mapping_DefaultValue = new BbSeriesSonificationDefaultSpeechOptionsMapping();
			PointGrouping = PointGrouping_DefaultValue = new BbSeriesSonificationDefaultSpeechOptionsPointGrouping();
			PreferredVoice = PreferredVoice_DefaultValue = "";
			ShowPlayMarker = ShowPlayMarker_DefaultValue = true;
			Type = Type_DefaultValue = BbSeriesSonificationDefaultSpeechOptionsType.Instrument;
		...
		/// </summary>
		public BbSeriesSonificationDefaultSpeechOptionsActiveWhen ActiveWhen { get; set; }
		private BbSeriesSonificationDefaultSpeechOptionsActiveWhen ActiveWhen_DefaultValue { get; set; }
		...
		/// </summary>
		public BbSeriesSonificationDefaultSpeechOptionsMapping Mapping { get; set; }
		private BbSeriesSonificationDefaultSpeechOptionsMapping Mapping_DefaultValue { get; set; }
		 

		/// <summary>
		/// Options for point grouping, specifically for instrument tracks.
		/// </summary>
		public BbSeriesSonificationDefaultSpeechOptionsPointGrouping PointGrouping { get; set; }
		private BbSeriesSonificationDefaultSpeechOptionsPointGrouping PointGrouping_DefaultValue { get; set; }
		...
		/// </summary>
		public BbSeriesSonificationDefaultSpeechOptionsType Type { get; set; }
		private BbSeriesSonificationDefaultSpeechOptionsType Type_DefaultValue { get; set; }
