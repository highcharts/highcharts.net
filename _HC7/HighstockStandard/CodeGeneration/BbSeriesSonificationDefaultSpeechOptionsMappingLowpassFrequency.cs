...
{
	public partial class BbSeriesSonificationDefaultSpeechOptionsMappingLowpassFrequency  : BaseObject
	{
		Hashtable h = new Hashtable();

		public BbSeriesSonificationDefaultSpeechOptionsMappingLowpassFrequency()
		{
			MapFunction = MapFunction_DefaultValue = BbSeriesSonificationDefaultSpeechOptionsMappingLowpassFrequencyMapFunction.Linear;
			MapTo = MapTo_DefaultValue = "";
			Max = Max_DefaultValue = null;
			Min = Min_DefaultValue = null;
			Value = Value_DefaultValue = null;
			Within = Within_DefaultValue = BbSeriesSonificationDefaultSpeechOptionsMappingLowpassFrequencyWithin.Chart;
		...
		/// </summary>
		public BbSeriesSonificationDefaultSpeechOptionsMappingLowpassFrequencyMapFunction MapFunction { get; set; }
		private BbSeriesSonificationDefaultSpeechOptionsMappingLowpassFrequencyMapFunction MapFunction_DefaultValue { get; set; }
		...
		/// </summary>
		public BbSeriesSonificationDefaultSpeechOptionsMappingLowpassFrequencyWithin Within { get; set; }
		private BbSeriesSonificationDefaultSpeechOptionsMappingLowpassFrequencyWithin Within_DefaultValue { get; set; }
