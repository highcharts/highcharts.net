...
{
	public partial class BbSeriesSonificationTracks  : BaseObject
	{
		Hashtable h = new Hashtable();

		public BbSeriesSonificationTracks()
		{
			ActiveWhen = ActiveWhen_DefaultValue = new BbSeriesSonificationTracksActiveWhen();
			Instrument = Instrument_DefaultValue = null;
			InstrumentString = InstrumentString_DefaultValue = "null";
			Mapping = Mapping_DefaultValue = new BbSeriesSonificationTracksMapping();
			MidiName = MidiName_DefaultValue = "";
			PointGrouping = PointGrouping_DefaultValue = new BbSeriesSonificationTracksPointGrouping();
			RoundToMusicalNotes = RoundToMusicalNotes_DefaultValue = true;
			ShowPlayMarker = ShowPlayMarker_DefaultValue = true;
			Type = Type_DefaultValue = BbSeriesSonificationTracksType.Instrument;
		...
		/// </summary>
		public BbSeriesSonificationTracksActiveWhen ActiveWhen { get; set; }
		private BbSeriesSonificationTracksActiveWhen ActiveWhen_DefaultValue { get; set; }
		...
		/// </summary>
		public BbSeriesSonificationTracksMapping Mapping { get; set; }
		private BbSeriesSonificationTracksMapping Mapping_DefaultValue { get; set; }
		...
		/// </summary>
		public BbSeriesSonificationTracksPointGrouping PointGrouping { get; set; }
		private BbSeriesSonificationTracksPointGrouping PointGrouping_DefaultValue { get; set; }
		...
		/// </summary>
		public BbSeriesSonificationTracksType Type { get; set; }
		private BbSeriesSonificationTracksType Type_DefaultValue { get; set; }
