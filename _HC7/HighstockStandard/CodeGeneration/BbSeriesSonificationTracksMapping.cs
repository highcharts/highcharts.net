...
{
	public partial class BbSeriesSonificationTracksMapping  : BaseObject
	{
		Hashtable h = new Hashtable();

		public BbSeriesSonificationTracksMapping()
		{
			Frequency = Frequency_DefaultValue = new BbSeriesSonificationTracksMappingFrequency();
			GapBetweenNotes = GapBetweenNotes_DefaultValue = new BbSeriesSonificationTracksMappingGapBetweenNotes();
			Highpass = Highpass_DefaultValue = new BbSeriesSonificationTracksMappingHighpass();
			Lowpass = Lowpass_DefaultValue = new BbSeriesSonificationTracksMappingLowpass();
			NoteDuration = NoteDuration_DefaultValue = new BbSeriesSonificationTracksMappingNoteDuration();
			Pan = Pan_DefaultValue = new BbSeriesSonificationTracksMappingPan();
			Pitch = Pitch_DefaultValue = new BbSeriesSonificationTracksMappingPitch();
			PitchString = PitchString_DefaultValue = "null";
			PitchNumber = PitchNumber_DefaultValue = null;
			PlayDelay = PlayDelay_DefaultValue = new BbSeriesSonificationTracksMappingPlayDelay();
			Time = Time_DefaultValue = new BbSeriesSonificationTracksMappingTime();
			TimeString = TimeString_DefaultValue = "null";
			TimeNumber = TimeNumber_DefaultValue = null;
			Tremolo = Tremolo_DefaultValue = new BbSeriesSonificationTracksMappingTremolo();
			Volume = Volume_DefaultValue = new BbSeriesSonificationTracksMappingVolume();
		...
		/// </summary>
		public BbSeriesSonificationTracksMappingFrequency Frequency { get; set; }
		private BbSeriesSonificationTracksMappingFrequency Frequency_DefaultValue { get; set; }
		...
		/// </summary>
		public BbSeriesSonificationTracksMappingGapBetweenNotes GapBetweenNotes { get; set; }
		private BbSeriesSonificationTracksMappingGapBetweenNotes GapBetweenNotes_DefaultValue { get; set; }
		...
		/// </summary>
		public BbSeriesSonificationTracksMappingHighpass Highpass { get; set; }
		private BbSeriesSonificationTracksMappingHighpass Highpass_DefaultValue { get; set; }
		...
		/// </summary>
		public BbSeriesSonificationTracksMappingLowpass Lowpass { get; set; }
		private BbSeriesSonificationTracksMappingLowpass Lowpass_DefaultValue { get; set; }
		...
		/// </summary>
		public BbSeriesSonificationTracksMappingNoteDuration NoteDuration { get; set; }
		private BbSeriesSonificationTracksMappingNoteDuration NoteDuration_DefaultValue { get; set; }
		...
		/// </summary>
		public BbSeriesSonificationTracksMappingPan Pan { get; set; }
		private BbSeriesSonificationTracksMappingPan Pan_DefaultValue { get; set; }
		...
		/// </summary>
		public BbSeriesSonificationTracksMappingPitch Pitch { get; set; }
		private BbSeriesSonificationTracksMappingPitch Pitch_DefaultValue { get; set; }
		...
		/// </summary>
		public BbSeriesSonificationTracksMappingPlayDelay PlayDelay { get; set; }
		private BbSeriesSonificationTracksMappingPlayDelay PlayDelay_DefaultValue { get; set; }
		...
		/// </summary>
		public BbSeriesSonificationTracksMappingTime Time { get; set; }
		private BbSeriesSonificationTracksMappingTime Time_DefaultValue { get; set; }
		...
		/// </summary>
		public BbSeriesSonificationTracksMappingTremolo Tremolo { get; set; }
		private BbSeriesSonificationTracksMappingTremolo Tremolo_DefaultValue { get; set; }
		 

		/// <summary>
		/// The volume of notes, from 0 to 1.
		/// </summary>
		public BbSeriesSonificationTracksMappingVolume Volume { get; set; }
		private BbSeriesSonificationTracksMappingVolume Volume_DefaultValue { get; set; }
