...
{
	public partial class BbSeriesSonificationTracksMappingFrequency  : BaseObject
	{
		Hashtable h = new Hashtable();

		public BbSeriesSonificationTracksMappingFrequency()
		{
			MapFunction = MapFunction_DefaultValue = BbSeriesSonificationTracksMappingFrequencyMapFunction.Linear;
			MapTo = MapTo_DefaultValue = "";
			Max = Max_DefaultValue = null;
			Min = Min_DefaultValue = null;
			Value = Value_DefaultValue = null;
			Within = Within_DefaultValue = BbSeriesSonificationTracksMappingFrequencyWithin.Chart;
		...
		/// </summary>
		public BbSeriesSonificationTracksMappingFrequencyMapFunction MapFunction { get; set; }
		private BbSeriesSonificationTracksMappingFrequencyMapFunction MapFunction_DefaultValue { get; set; }
		...
		/// </summary>
		public BbSeriesSonificationTracksMappingFrequencyWithin Within { get; set; }
		private BbSeriesSonificationTracksMappingFrequencyWithin Within_DefaultValue { get; set; }
