...
{
	public partial class BbSeriesSonificationTracksMappingNoteDuration  : BaseObject
	{
		Hashtable h = new Hashtable();

		public BbSeriesSonificationTracksMappingNoteDuration()
		{
			MapFunction = MapFunction_DefaultValue = BbSeriesSonificationTracksMappingNoteDurationMapFunction.Linear;
			MapTo = MapTo_DefaultValue = "";
			Max = Max_DefaultValue = null;
			Min = Min_DefaultValue = null;
			Value = Value_DefaultValue = null;
			Within = Within_DefaultValue = BbSeriesSonificationTracksMappingNoteDurationWithin.Chart;
		...
		/// </summary>
		public BbSeriesSonificationTracksMappingNoteDurationMapFunction MapFunction { get; set; }
		private BbSeriesSonificationTracksMappingNoteDurationMapFunction MapFunction_DefaultValue { get; set; }
		...
		/// </summary>
		public BbSeriesSonificationTracksMappingNoteDurationWithin Within { get; set; }
		private BbSeriesSonificationTracksMappingNoteDurationWithin Within_DefaultValue { get; set; }
