...
{
	public partial class BbSeriesSonificationTracksMappingPan  : BaseObject
	{
		Hashtable h = new Hashtable();

		public BbSeriesSonificationTracksMappingPan()
		{
			MapFunction = MapFunction_DefaultValue = BbSeriesSonificationTracksMappingPanMapFunction.Linear;
			MapTo = MapTo_DefaultValue = "";
			Max = Max_DefaultValue = null;
			Min = Min_DefaultValue = null;
			Value = Value_DefaultValue = null;
			Within = Within_DefaultValue = BbSeriesSonificationTracksMappingPanWithin.Chart;
		...
		/// </summary>
		public BbSeriesSonificationTracksMappingPanMapFunction MapFunction { get; set; }
		private BbSeriesSonificationTracksMappingPanMapFunction MapFunction_DefaultValue { get; set; }
		...
		/// </summary>
		public BbSeriesSonificationTracksMappingPanWithin Within { get; set; }
		private BbSeriesSonificationTracksMappingPanWithin Within_DefaultValue { get; set; }
