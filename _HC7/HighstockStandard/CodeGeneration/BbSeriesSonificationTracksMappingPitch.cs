...
{
	public partial class BbSeriesSonificationTracksMappingPitch  : BaseObject
	{
		Hashtable h = new Hashtable();

		public BbSeriesSonificationTracksMappingPitch()
		{
			MapFunction = MapFunction_DefaultValue = BbSeriesSonificationTracksMappingPitchMapFunction.Linear;
		...
		/// </summary>
		public BbSeriesSonificationTracksMappingPitchMapFunction MapFunction { get; set; }
		private BbSeriesSonificationTracksMappingPitchMapFunction MapFunction_DefaultValue { get; set; }
