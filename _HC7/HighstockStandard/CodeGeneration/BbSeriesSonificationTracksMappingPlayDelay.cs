...
{
	public partial class BbSeriesSonificationTracksMappingPlayDelay  : BaseObject
	{
		Hashtable h = new Hashtable();

		public BbSeriesSonificationTracksMappingPlayDelay()
		{
			MapFunction = MapFunction_DefaultValue = BbSeriesSonificationTracksMappingPlayDelayMapFunction.Linear;
			MapTo = MapTo_DefaultValue = "";
			Max = Max_DefaultValue = null;
			Min = Min_DefaultValue = null;
			Value = Value_DefaultValue = null;
			Within = Within_DefaultValue = BbSeriesSonificationTracksMappingPlayDelayWithin.Chart;
		...
		/// </summary>
		public BbSeriesSonificationTracksMappingPlayDelayMapFunction MapFunction { get; set; }
		private BbSeriesSonificationTracksMappingPlayDelayMapFunction MapFunction_DefaultValue { get; set; }
		...
		/// </summary>
		public BbSeriesSonificationTracksMappingPlayDelayWithin Within { get; set; }
		private BbSeriesSonificationTracksMappingPlayDelayWithin Within_DefaultValue { get; set; }
