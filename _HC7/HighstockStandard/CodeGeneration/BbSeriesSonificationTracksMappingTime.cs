...
{
	public partial class BbSeriesSonificationTracksMappingTime  : BaseObject
	{
		Hashtable h = new Hashtable();

		public BbSeriesSonificationTracksMappingTime()
		{
			MapFunction = MapFunction_DefaultValue = BbSeriesSonificationTracksMappingTimeMapFunction.Linear;
			MapTo = MapTo_DefaultValue = "";
			Max = Max_DefaultValue = null;
			Min = Min_DefaultValue = null;
			Value = Value_DefaultValue = null;
			Within = Within_DefaultValue = BbSeriesSonificationTracksMappingTimeWithin.Chart;
		...
		/// </summary>
		public BbSeriesSonificationTracksMappingTimeMapFunction MapFunction { get; set; }
		private BbSeriesSonificationTracksMappingTimeMapFunction MapFunction_DefaultValue { get; set; }
		...
		/// </summary>
		public BbSeriesSonificationTracksMappingTimeWithin Within { get; set; }
		private BbSeriesSonificationTracksMappingTimeWithin Within_DefaultValue { get; set; }
