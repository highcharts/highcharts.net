...
{
	public partial class BbSeriesSonificationTracksMappingTremoloDepth  : BaseObject
	{
		Hashtable h = new Hashtable();

		public BbSeriesSonificationTracksMappingTremoloDepth()
		{
			MapFunction = MapFunction_DefaultValue = BbSeriesSonificationTracksMappingTremoloDepthMapFunction.Linear;
			MapTo = MapTo_DefaultValue = "";
			Max = Max_DefaultValue = null;
			Min = Min_DefaultValue = null;
			Value = Value_DefaultValue = null;
			Within = Within_DefaultValue = BbSeriesSonificationTracksMappingTremoloDepthWithin.Chart;
		...
		/// </summary>
		public BbSeriesSonificationTracksMappingTremoloDepthMapFunction MapFunction { get; set; }
		private BbSeriesSonificationTracksMappingTremoloDepthMapFunction MapFunction_DefaultValue { get; set; }
		...
		/// </summary>
		public BbSeriesSonificationTracksMappingTremoloDepthWithin Within { get; set; }
		private BbSeriesSonificationTracksMappingTremoloDepthWithin Within_DefaultValue { get; set; }
