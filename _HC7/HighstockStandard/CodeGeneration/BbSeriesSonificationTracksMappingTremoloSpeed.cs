...
{
	public partial class BbSeriesSonificationTracksMappingTremoloSpeed  : BaseObject
	{
		Hashtable h = new Hashtable();

		public BbSeriesSonificationTracksMappingTremoloSpeed()
		{
			MapFunction = MapFunction_DefaultValue = BbSeriesSonificationTracksMappingTremoloSpeedMapFunction.Linear;
			MapTo = MapTo_DefaultValue = "";
			Max = Max_DefaultValue = null;
			Min = Min_DefaultValue = null;
			Value = Value_DefaultValue = null;
			Within = Within_DefaultValue = BbSeriesSonificationTracksMappingTremoloSpeedWithin.Chart;
		...
		/// </summary>
		public BbSeriesSonificationTracksMappingTremoloSpeedMapFunction MapFunction { get; set; }
		private BbSeriesSonificationTracksMappingTremoloSpeedMapFunction MapFunction_DefaultValue { get; set; }
		...
		/// </summary>
		public BbSeriesSonificationTracksMappingTremoloSpeedWithin Within { get; set; }
		private BbSeriesSonificationTracksMappingTremoloSpeedWithin Within_DefaultValue { get; set; }
