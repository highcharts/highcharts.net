...
{
	public partial class BbSeriesSonificationTracksMappingVolume  : BaseObject
	{
		Hashtable h = new Hashtable();

		public BbSeriesSonificationTracksMappingVolume()
		{
			MapFunction = MapFunction_DefaultValue = BbSeriesSonificationTracksMappingVolumeMapFunction.Linear;
			MapTo = MapTo_DefaultValue = "";
			Max = Max_DefaultValue = null;
			Min = Min_DefaultValue = null;
			Value = Value_DefaultValue = null;
			Within = Within_DefaultValue = BbSeriesSonificationTracksMappingVolumeWithin.Chart;
		...
		/// </summary>
		public BbSeriesSonificationTracksMappingVolumeMapFunction MapFunction { get; set; }
		private BbSeriesSonificationTracksMappingVolumeMapFunction MapFunction_DefaultValue { get; set; }
		...
		/// </summary>
		public BbSeriesSonificationTracksMappingVolumeWithin Within { get; set; }
		private BbSeriesSonificationTracksMappingVolumeWithin Within_DefaultValue { get; set; }
