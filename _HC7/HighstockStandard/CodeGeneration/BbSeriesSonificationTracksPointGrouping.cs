...
{
	public partial class BbSeriesSonificationTracksPointGrouping  : BaseObject
	{
		Hashtable h = new Hashtable();

		public BbSeriesSonificationTracksPointGrouping()
		{
			Algorithm = Algorithm_DefaultValue = BbSeriesSonificationTracksPointGroupingAlgorithm.Minimax;
		...
		/// </summary>
		public BbSeriesSonificationTracksPointGroupingAlgorithm Algorithm { get; set; }
		private BbSeriesSonificationTracksPointGroupingAlgorithm Algorithm_DefaultValue { get; set; }
