...
{
	public partial class BbSeriesStatesHoverMarker  : BaseObject
	{
		public BbSeriesStatesHoverMarker()
		{
			...
			States = States_DefaultValue = new BbSeriesStatesHoverMarkerStates();
		...
		/// </summary>
		public BbSeriesStatesHoverMarkerStates States { get; set; }
		private BbSeriesStatesHoverMarkerStates States_DefaultValue { get; set; }
