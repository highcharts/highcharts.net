...
{
	public partial class BbSeriesTooltip  : BaseObject
	{
		public BbSeriesTooltip()
		{
			...
			HeaderShape = HeaderShape_DefaultValue = BbSeriesTooltipHeaderShape.Callout;
		...
		/// </summary>
		public BbSeriesTooltipHeaderShape HeaderShape { get; set; }
		private BbSeriesTooltipHeaderShape HeaderShape_DefaultValue { get; set; }
		...
		internal override Hashtable ToHashtable()
		{
			...
			if (NullFormatter != NullFormatter_DefaultValue) { h.Add("nullFormatter",NullFormatter); Highstock.AddFunction("BbSeriesTooltipNullFormatter.nullFormatter", NullFormatter); }  
			if (Outside != Outside_DefaultValue) h.Add("outside",Outside);
			if (Padding != Padding_DefaultValue) h.Add("padding",Padding);
			if (PointFormat != PointFormat_DefaultValue) h.Add("pointFormat",PointFormat);
			if (PointFormatter != PointFormatter_DefaultValue) { h.Add("pointFormatter",PointFormatter); Highstock.AddFunction("BbSeriesTooltipPointFormatter.pointFormatter", PointFormatter); }  
