...
namespace Highsoft.Web.Mvc.Stocks
{
	public partial class BubbleSeries  : Series
	{
		...
		public BubbleSeries()
		{
			...
			Compare = Compare_DefaultValue = BubbleSeriesCompare.Percent;
			...
			LegendSymbol = LegendSymbol_DefaultValue = BubbleSeriesLegendSymbol.Rectangle;
			...
			OnPoint = OnPoint_DefaultValue = new BubbleSeriesOnPoint();
			...
			Sonification = Sonification_DefaultValue = new BubbleSeriesSonification();
		...
		private BubbleSeriesCompare Compare_DefaultValue { get; set; }
		...
		private BubbleSeriesLegendSymbol LegendSymbol_DefaultValue { get; set; }
		...
		private BubbleSeriesOnPoint OnPoint_DefaultValue { get; set; }
		...
		private BubbleSeriesSonification Sonification_DefaultValue { get; set; }
