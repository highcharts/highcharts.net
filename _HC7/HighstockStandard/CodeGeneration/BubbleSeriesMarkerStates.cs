...
namespace Highsoft.Web.Mvc.Stocks
{
	public partial class BubbleSeriesMarkerStates  : BaseObject
	{
		public BubbleSeriesMarkerStates()
		{
			...
			Inactive = Inactive_DefaultValue = new BubbleSeriesMarkerStatesInactive();
			Normal = Normal_DefaultValue = new BubbleSeriesMarkerStatesNormal();
		...
		/// 
		/// </summary>
		public BubbleSeriesMarkerStatesInactive Inactive { get; set; }
		private BubbleSeriesMarkerStatesInactive Inactive_DefaultValue { get; set; }
		 

		/// <summary>
		/// The normal state of a single point marker. Currently onlyused for setting animation when returning to normal statefrom hover.
		/// </summary>
		public BubbleSeriesMarkerStatesNormal Normal { get; set; }
		private BubbleSeriesMarkerStatesNormal Normal_DefaultValue { get; set; }
