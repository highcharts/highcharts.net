...
{
	public partial class BubbleSeriesOnPoint  : BaseObject
	{
		Hashtable h = new Hashtable();

		public BubbleSeriesOnPoint()
		{
			ConnectorOptions = ConnectorOptions_DefaultValue = new BubbleSeriesOnPointConnectorOptions();
			Id = Id_DefaultValue = "";
			Position = Position_DefaultValue = new BubbleSeriesOnPointPosition();
		...
		/// </summary>
		public BubbleSeriesOnPointConnectorOptions ConnectorOptions { get; set; }
		private BubbleSeriesOnPointConnectorOptions ConnectorOptions_DefaultValue { get; set; }
		...
		/// </summary>
		public BubbleSeriesOnPointPosition Position { get; set; }
		private BubbleSeriesOnPointPosition Position_DefaultValue { get; set; }
