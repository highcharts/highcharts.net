...
{
	public partial class BubbleSeriesSonificationDefaultSpeechOptionsMapping  : BaseObject
	{
		Hashtable h = new Hashtable();

		public BubbleSeriesSonificationDefaultSpeechOptionsMapping()
		{
			Frequency = Frequency_DefaultValue = new BubbleSeriesSonificationDefaultSpeechOptionsMappingFrequency();
			GapBetweenNotes = GapBetweenNotes_DefaultValue = new BubbleSeriesSonificationDefaultSpeechOptionsMappingGapBetweenNotes();
			Highpass = Highpass_DefaultValue = new BubbleSeriesSonificationDefaultSpeechOptionsMappingHighpass();
			Lowpass = Lowpass_DefaultValue = new BubbleSeriesSonificationDefaultSpeechOptionsMappingLowpass();
			NoteDuration = NoteDuration_DefaultValue = new BubbleSeriesSonificationDefaultSpeechOptionsMappingNoteDuration();
			Pan = Pan_DefaultValue = new BubbleSeriesSonificationDefaultSpeechOptionsMappingPan();
			Pitch = Pitch_DefaultValue = new BubbleSeriesSonificationDefaultSpeechOptionsMappingPitch();
			PitchString = PitchString_DefaultValue = "null";
			PitchNumber = PitchNumber_DefaultValue = null;
			PlayDelay = PlayDelay_DefaultValue = new BubbleSeriesSonificationDefaultSpeechOptionsMappingPlayDelay();
			Time = Time_DefaultValue = new BubbleSeriesSonificationDefaultSpeechOptionsMappingTime();
			TimeString = TimeString_DefaultValue = "null";
			TimeNumber = TimeNumber_DefaultValue = null;
			Tremolo = Tremolo_DefaultValue = new BubbleSeriesSonificationDefaultSpeechOptionsMappingTremolo();
			Volume = Volume_DefaultValue = new BubbleSeriesSonificationDefaultSpeechOptionsMappingVolume();
		...
		/// </summary>
		public BubbleSeriesSonificationDefaultSpeechOptionsMappingFrequency Frequency { get; set; }
		private BubbleSeriesSonificationDefaultSpeechOptionsMappingFrequency Frequency_DefaultValue { get; set; }
		...
		/// </summary>
		public BubbleSeriesSonificationDefaultSpeechOptionsMappingGapBetweenNotes GapBetweenNotes { get; set; }
		private BubbleSeriesSonificationDefaultSpeechOptionsMappingGapBetweenNotes GapBetweenNotes_DefaultValue { get; set; }
		...
		/// </summary>
		public BubbleSeriesSonificationDefaultSpeechOptionsMappingHighpass Highpass { get; set; }
		private BubbleSeriesSonificationDefaultSpeechOptionsMappingHighpass Highpass_DefaultValue { get; set; }
		...
		/// </summary>
		public BubbleSeriesSonificationDefaultSpeechOptionsMappingLowpass Lowpass { get; set; }
		private BubbleSeriesSonificationDefaultSpeechOptionsMappingLowpass Lowpass_DefaultValue { get; set; }
		...
		/// </summary>
		public BubbleSeriesSonificationDefaultSpeechOptionsMappingNoteDuration NoteDuration { get; set; }
		private BubbleSeriesSonificationDefaultSpeechOptionsMappingNoteDuration NoteDuration_DefaultValue { get; set; }
		...
		/// </summary>
		public BubbleSeriesSonificationDefaultSpeechOptionsMappingPan Pan { get; set; }
		private BubbleSeriesSonificationDefaultSpeechOptionsMappingPan Pan_DefaultValue { get; set; }
		...
		/// </summary>
		public BubbleSeriesSonificationDefaultSpeechOptionsMappingPitch Pitch { get; set; }
		private BubbleSeriesSonificationDefaultSpeechOptionsMappingPitch Pitch_DefaultValue { get; set; }
		...
		/// </summary>
		public BubbleSeriesSonificationDefaultSpeechOptionsMappingPlayDelay PlayDelay { get; set; }
		private BubbleSeriesSonificationDefaultSpeechOptionsMappingPlayDelay PlayDelay_DefaultValue { get; set; }
		...
		/// </summary>
		public BubbleSeriesSonificationDefaultSpeechOptionsMappingTime Time { get; set; }
		private BubbleSeriesSonificationDefaultSpeechOptionsMappingTime Time_DefaultValue { get; set; }
		...
		/// </summary>
		public BubbleSeriesSonificationDefaultSpeechOptionsMappingTremolo Tremolo { get; set; }
		private BubbleSeriesSonificationDefaultSpeechOptionsMappingTremolo Tremolo_DefaultValue { get; set; }
		 

		/// <summary>
		/// The volume of notes, from 0 to 1.
		/// </summary>
		public BubbleSeriesSonificationDefaultSpeechOptionsMappingVolume Volume { get; set; }
		private BubbleSeriesSonificationDefaultSpeechOptionsMappingVolume Volume_DefaultValue { get; set; }
