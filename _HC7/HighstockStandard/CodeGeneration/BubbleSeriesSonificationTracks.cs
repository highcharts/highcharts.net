...
{
	public partial class BubbleSeriesSonificationTracks  : BaseObject
	{
		Hashtable h = new Hashtable();

		public BubbleSeriesSonificationTracks()
		{
			ActiveWhen = ActiveWhen_DefaultValue = new BubbleSeriesSonificationTracksActiveWhen();
			Instrument = Instrument_DefaultValue = null;
			InstrumentString = InstrumentString_DefaultValue = "null";
			Mapping = Mapping_DefaultValue = new BubbleSeriesSonificationTracksMapping();
		...
		/// </summary>
		public BubbleSeriesSonificationTracksActiveWhen ActiveWhen { get; set; }
		private BubbleSeriesSonificationTracksActiveWhen ActiveWhen_DefaultValue { get; set; }
		...
		/// </summary>
		public BubbleSeriesSonificationTracksMapping Mapping { get; set; }
		private BubbleSeriesSonificationTracksMapping Mapping_DefaultValue { get; set; }
		...
		/// </summary>
		public BubbleSeriesSonificationTracksPointGrouping PointGrouping { get; set; }
		private BubbleSeriesSonificationTracksPointGrouping PointGrouping_DefaultValue { get; set; }
