...
namespace Highsoft.Web.Mvc.Stocks
{
	public partial class CandleStickSeries  : Series
	{
		...
		{
			Accessibility = Accessibility_DefaultValue = new CandleStickSeriesAccessibility();
			AllowPointSelect = AllowPointSelect_DefaultValue = false;
			Animation = Animation_DefaultValue = new Animation() { Enabled = true };
			AnimationBool = AnimationBool_DefaultValue = true;
			AnimationLimit = AnimationLimit_DefaultValue = null;
			BoostBlending = BoostBlending_DefaultValue = CandleStickSeriesBoostBlending.Undefined;
			...
			Compare = Compare_DefaultValue = CandleStickSeriesCompare.Percent;
			...
			DashStyle = DashStyle_DefaultValue = CandleStickSeriesDashStyle.Null;
			...
			DataSorting = DataSorting_DefaultValue = new CandleStickSeriesDataSorting();
			Depth = Depth_DefaultValue = 25;
			Description = Description_DefaultValue = "";
			DragDrop = DragDrop_DefaultValue = new CandleStickSeriesDragDrop();
			Dumbell = Dumbell_DefaultValue = new CandleStickSeriesDumbell();
			...
			LastPrice = LastPrice_DefaultValue = new CandleStickSeriesLastPrice();
			LastVisiblePrice = LastVisiblePrice_DefaultValue = new CandleStickSeriesLastVisiblePrice();
			LegendIndex = LegendIndex_DefaultValue = null;
			LegendSymbol = LegendSymbol_DefaultValue = CandleStickSeriesLegendSymbol.Rectangle;
			...
			OnPoint = OnPoint_DefaultValue = new CandleStickSeriesOnPoint();
			...
			Sonification = Sonification_DefaultValue = new CandleStickSeriesSonification();
			...
			Zones = Zones_DefaultValue = new List<CandleStickSeriesZones>();
		...
		/// </summary>
		public CandleStickSeriesAccessibility Accessibility { get; set; }
		private CandleStickSeriesAccessibility Accessibility_DefaultValue { get; set; }
		...
		/// </summary>
		public CandleStickSeriesBoostBlending BoostBlending { get; set; }
		private CandleStickSeriesBoostBlending BoostBlending_DefaultValue { get; set; }
		...
		/// </summary>
		public CandleStickSeriesCompare Compare { get; set; }
		private CandleStickSeriesCompare Compare_DefaultValue { get; set; }
		...
		/// </summary>
		public CandleStickSeriesDashStyle DashStyle { get; set; }
		private CandleStickSeriesDashStyle DashStyle_DefaultValue { get; set; }
		...
		/// </summary>
		public CandleStickSeriesDataSorting DataSorting { get; set; }
		private CandleStickSeriesDataSorting DataSorting_DefaultValue { get; set; }
		...
		/// </summary>
		public CandleStickSeriesDragDrop DragDrop { get; set; }
		private CandleStickSeriesDragDrop DragDrop_DefaultValue { get; set; }
		 

		/// <summary>
		/// 
		/// </summary>
		public CandleStickSeriesDumbell Dumbell { get; set; }
		private CandleStickSeriesDumbell Dumbell_DefaultValue { get; set; }
		...
		/// </summary>
		public CandleStickSeriesLastPrice LastPrice { get; set; }
		private CandleStickSeriesLastPrice LastPrice_DefaultValue { get; set; }
		 

		/// <summary>
		/// The line marks the last price from visible range of points.
		/// </summary>
		public CandleStickSeriesLastVisiblePrice LastVisiblePrice { get; set; }
		private CandleStickSeriesLastVisiblePrice LastVisiblePrice_DefaultValue { get; set; }
		...
		/// </summary>
		public CandleStickSeriesLegendSymbol LegendSymbol { get; set; }
		private CandleStickSeriesLegendSymbol LegendSymbol_DefaultValue { get; set; }
		...
		/// </summary>
		public CandleStickSeriesOnPoint OnPoint { get; set; }
		private CandleStickSeriesOnPoint OnPoint_DefaultValue { get; set; }
		...
		/// </summary>
		public CandleStickSeriesSonification Sonification { get; set; }
		private CandleStickSeriesSonification Sonification_DefaultValue { get; set; }
		...
		/// </summary>
		public List<CandleStickSeriesZones> Zones { get; set; }
		private List<CandleStickSeriesZones> Zones_DefaultValue { get; set; }
