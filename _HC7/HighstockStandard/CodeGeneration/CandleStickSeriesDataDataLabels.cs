...
{
	public partial class CandleStickSeriesDataDataLabels  : BaseObject
	{
		Hashtable h = new Hashtable();

		public CandleStickSeriesDataDataLabels()
		{
		}	
		...
		/// </summary>
		public CandleStickSeriesDataDataLabelsAlign Align { get; set; }
		...
		/// </summary>
		public CandleStickSeriesDataDataLabelsFilter Filter { get; set; }
		...
		/// </summary>
		public CandleStickSeriesDataDataLabelsOverflow Overflow { get; set; }
		...
		/// </summary>
		public CandleStickSeriesDataDataLabelsPosition Position { get; set; }
		...
		/// </summary>
		public CandleStickSeriesDataDataLabelsTextPath TextPath { get; set; }
		...
		/// </summary>
		public CandleStickSeriesDataDataLabelsVerticalAlign VerticalAlign { get; set; }
		...
		{
			if (Align != CandleStickSeriesDataDataLabelsAlign.Null) h.Add("align", highstock.FirstCharacterToLower(Align.ToString()));
			...
			if (Overflow != CandleStickSeriesDataDataLabelsOverflow.Null) h.Add("overflow", highstock.FirstCharacterToLower(Overflow.ToString()));
			if (Padding != null) h.Add("padding",Padding);
			if (Position != CandleStickSeriesDataDataLabelsPosition.Null) h.Add("position", highstock.FirstCharacterToLower(Position.ToString()));
			...
			if (VerticalAlign != CandleStickSeriesDataDataLabelsVerticalAlign.Null) h.Add("verticalAlign", highstock.FirstCharacterToLower(VerticalAlign.ToString()));
			if (X != null) h.Add("x",X);
			if (Y != null) h.Add("y",Y);
