...
{
	public partial class CandleStickSeriesSonificationContextTracks  : BaseObject
	{
		Hashtable h = new Hashtable();

		public CandleStickSeriesSonificationContextTracks()
		{
			ActiveWhen = ActiveWhen_DefaultValue = new CandleStickSeriesSonificationContextTracksActiveWhen();
			Instrument = Instrument_DefaultValue = null;
			InstrumentString = InstrumentString_DefaultValue = "null";
			Mapping = Mapping_DefaultValue = new CandleStickSeriesSonificationContextTracksMapping();
			MidiName = MidiName_DefaultValue = "";
			PointGrouping = PointGrouping_DefaultValue = new CandleStickSeriesSonificationContextTracksPointGrouping();
			...
			Type = Type_DefaultValue = CandleStickSeriesSonificationContextTracksType.Instrument;
			ValueInterval = ValueInterval_DefaultValue = null;
			ValueMapFunction = ValueMapFunction_DefaultValue = CandleStickSeriesSonificationContextTracksValueMapFunction.Linear;
		...
		/// </summary>
		public CandleStickSeriesSonificationContextTracksActiveWhen ActiveWhen { get; set; }
		private CandleStickSeriesSonificationContextTracksActiveWhen ActiveWhen_DefaultValue { get; set; }
		...
		/// </summary>
		public CandleStickSeriesSonificationContextTracksMapping Mapping { get; set; }
		private CandleStickSeriesSonificationContextTracksMapping Mapping_DefaultValue { get; set; }
		...
		/// </summary>
		public CandleStickSeriesSonificationContextTracksPointGrouping PointGrouping { get; set; }
		private CandleStickSeriesSonificationContextTracksPointGrouping PointGrouping_DefaultValue { get; set; }
		...
		/// </summary>
		public CandleStickSeriesSonificationContextTracksType Type { get; set; }
		private CandleStickSeriesSonificationContextTracksType Type_DefaultValue { get; set; }
		...
		/// </summary>
		public CandleStickSeriesSonificationContextTracksValueMapFunction ValueMapFunction { get; set; }
		private CandleStickSeriesSonificationContextTracksValueMapFunction ValueMapFunction_DefaultValue { get; set; }
