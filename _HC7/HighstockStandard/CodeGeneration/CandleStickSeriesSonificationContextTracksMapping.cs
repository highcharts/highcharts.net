...
{
	public partial class CandleStickSeriesSonificationContextTracksMapping  : BaseObject
	{
		Hashtable h = new Hashtable();

		public CandleStickSeriesSonificationContextTracksMapping()
		{
			Frequency = Frequency_DefaultValue = new CandleStickSeriesSonificationContextTracksMappingFrequency();
			GapBetweenNotes = GapBetweenNotes_DefaultValue = new CandleStickSeriesSonificationContextTracksMappingGapBetweenNotes();
			Highpass = Highpass_DefaultValue = new CandleStickSeriesSonificationContextTracksMappingHighpass();
			Lowpass = Lowpass_DefaultValue = new CandleStickSeriesSonificationContextTracksMappingLowpass();
			NoteDuration = NoteDuration_DefaultValue = new CandleStickSeriesSonificationContextTracksMappingNoteDuration();
			Pan = Pan_DefaultValue = new CandleStickSeriesSonificationContextTracksMappingPan();
			Pitch = Pitch_DefaultValue = new CandleStickSeriesSonificationContextTracksMappingPitch();
			PitchString = PitchString_DefaultValue = "null";
			PitchNumber = PitchNumber_DefaultValue = null;
			PlayDelay = PlayDelay_DefaultValue = new CandleStickSeriesSonificationContextTracksMappingPlayDelay();
			Time = Time_DefaultValue = new CandleStickSeriesSonificationContextTracksMappingTime();
			TimeString = TimeString_DefaultValue = "null";
			TimeNumber = TimeNumber_DefaultValue = null;
			Tremolo = Tremolo_DefaultValue = new CandleStickSeriesSonificationContextTracksMappingTremolo();
			Volume = Volume_DefaultValue = new CandleStickSeriesSonificationContextTracksMappingVolume();
		...
		/// </summary>
		public CandleStickSeriesSonificationContextTracksMappingFrequency Frequency { get; set; }
		private CandleStickSeriesSonificationContextTracksMappingFrequency Frequency_DefaultValue { get; set; }
		...
		/// </summary>
		public CandleStickSeriesSonificationContextTracksMappingGapBetweenNotes GapBetweenNotes { get; set; }
		private CandleStickSeriesSonificationContextTracksMappingGapBetweenNotes GapBetweenNotes_DefaultValue { get; set; }
		...
		/// </summary>
		public CandleStickSeriesSonificationContextTracksMappingHighpass Highpass { get; set; }
		private CandleStickSeriesSonificationContextTracksMappingHighpass Highpass_DefaultValue { get; set; }
		...
		/// </summary>
		public CandleStickSeriesSonificationContextTracksMappingLowpass Lowpass { get; set; }
		private CandleStickSeriesSonificationContextTracksMappingLowpass Lowpass_DefaultValue { get; set; }
		...
		/// </summary>
		public CandleStickSeriesSonificationContextTracksMappingNoteDuration NoteDuration { get; set; }
		private CandleStickSeriesSonificationContextTracksMappingNoteDuration NoteDuration_DefaultValue { get; set; }
		...
		/// </summary>
		public CandleStickSeriesSonificationContextTracksMappingPan Pan { get; set; }
		private CandleStickSeriesSonificationContextTracksMappingPan Pan_DefaultValue { get; set; }
		...
		/// </summary>
		public CandleStickSeriesSonificationContextTracksMappingPitch Pitch { get; set; }
		private CandleStickSeriesSonificationContextTracksMappingPitch Pitch_DefaultValue { get; set; }
		...
		/// </summary>
		public CandleStickSeriesSonificationContextTracksMappingPlayDelay PlayDelay { get; set; }
		private CandleStickSeriesSonificationContextTracksMappingPlayDelay PlayDelay_DefaultValue { get; set; }
		...
		/// </summary>
		public CandleStickSeriesSonificationContextTracksMappingTime Time { get; set; }
		private CandleStickSeriesSonificationContextTracksMappingTime Time_DefaultValue { get; set; }
		...
		/// </summary>
		public CandleStickSeriesSonificationContextTracksMappingTremolo Tremolo { get; set; }
		private CandleStickSeriesSonificationContextTracksMappingTremolo Tremolo_DefaultValue { get; set; }
		 

		/// <summary>
		/// The volume of notes, from 0 to 1.
		/// </summary>
		public CandleStickSeriesSonificationContextTracksMappingVolume Volume { get; set; }
		private CandleStickSeriesSonificationContextTracksMappingVolume Volume_DefaultValue { get; set; }
