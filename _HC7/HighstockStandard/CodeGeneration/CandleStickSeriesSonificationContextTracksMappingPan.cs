...
{
	public partial class CandleStickSeriesSonificationContextTracksMappingPan  : BaseObject
	{
		Hashtable h = new Hashtable();

		public CandleStickSeriesSonificationContextTracksMappingPan()
		{
			MapFunction = MapFunction_DefaultValue = CandleStickSeriesSonificationContextTracksMappingPanMapFunction.Linear;
			MapTo = MapTo_DefaultValue = "";
			Max = Max_DefaultValue = null;
			Min = Min_DefaultValue = null;
			Value = Value_DefaultValue = null;
			Within = Within_DefaultValue = CandleStickSeriesSonificationContextTracksMappingPanWithin.Chart;
		...
		/// </summary>
		public CandleStickSeriesSonificationContextTracksMappingPanMapFunction MapFunction { get; set; }
		private CandleStickSeriesSonificationContextTracksMappingPanMapFunction MapFunction_DefaultValue { get; set; }
		...
		/// </summary>
		public CandleStickSeriesSonificationContextTracksMappingPanWithin Within { get; set; }
		private CandleStickSeriesSonificationContextTracksMappingPanWithin Within_DefaultValue { get; set; }
