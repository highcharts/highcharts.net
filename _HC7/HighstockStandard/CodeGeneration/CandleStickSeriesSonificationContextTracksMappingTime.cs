...
{
	public partial class CandleStickSeriesSonificationContextTracksMappingTime  : BaseObject
	{
		Hashtable h = new Hashtable();

		public CandleStickSeriesSonificationContextTracksMappingTime()
		{
			MapFunction = MapFunction_DefaultValue = CandleStickSeriesSonificationContextTracksMappingTimeMapFunction.Linear;
			MapTo = MapTo_DefaultValue = "";
			Max = Max_DefaultValue = null;
			Min = Min_DefaultValue = null;
			Value = Value_DefaultValue = null;
			Within = Within_DefaultValue = CandleStickSeriesSonificationContextTracksMappingTimeWithin.Chart;
		...
		/// </summary>
		public CandleStickSeriesSonificationContextTracksMappingTimeMapFunction MapFunction { get; set; }
		private CandleStickSeriesSonificationContextTracksMappingTimeMapFunction MapFunction_DefaultValue { get; set; }
		...
		/// </summary>
		public CandleStickSeriesSonificationContextTracksMappingTimeWithin Within { get; set; }
		private CandleStickSeriesSonificationContextTracksMappingTimeWithin Within_DefaultValue { get; set; }
