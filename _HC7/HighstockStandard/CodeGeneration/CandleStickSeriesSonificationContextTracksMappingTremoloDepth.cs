...
{
	public partial class CandleStickSeriesSonificationContextTracksMappingTremoloDepth  : BaseObject
	{
		Hashtable h = new Hashtable();

		public CandleStickSeriesSonificationContextTracksMappingTremoloDepth()
		{
			MapFunction = MapFunction_DefaultValue = CandleStickSeriesSonificationContextTracksMappingTremoloDepthMapFunction.Linear;
			MapTo = MapTo_DefaultValue = "";
			Max = Max_DefaultValue = null;
			Min = Min_DefaultValue = null;
			Value = Value_DefaultValue = null;
			Within = Within_DefaultValue = CandleStickSeriesSonificationContextTracksMappingTremoloDepthWithin.Chart;
		...
		/// </summary>
		public CandleStickSeriesSonificationContextTracksMappingTremoloDepthMapFunction MapFunction { get; set; }
		private CandleStickSeriesSonificationContextTracksMappingTremoloDepthMapFunction MapFunction_DefaultValue { get; set; }
		...
		/// </summary>
		public CandleStickSeriesSonificationContextTracksMappingTremoloDepthWithin Within { get; set; }
		private CandleStickSeriesSonificationContextTracksMappingTremoloDepthWithin Within_DefaultValue { get; set; }
