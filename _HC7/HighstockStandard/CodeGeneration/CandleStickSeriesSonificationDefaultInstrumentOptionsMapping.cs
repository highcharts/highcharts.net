...
{
	public partial class CandleStickSeriesSonificationDefaultInstrumentOptionsMapping  : BaseObject
	{
		Hashtable h = new Hashtable();

		public CandleStickSeriesSonificationDefaultInstrumentOptionsMapping()
		{
			Frequency = Frequency_DefaultValue = new CandleStickSeriesSonificationDefaultInstrumentOptionsMappingFrequency();
			GapBetweenNotes = GapBetweenNotes_DefaultValue = new CandleStickSeriesSonificationDefaultInstrumentOptionsMappingGapBetweenNotes();
			Highpass = Highpass_DefaultValue = new CandleStickSeriesSonificationDefaultInstrumentOptionsMappingHighpass();
			Lowpass = Lowpass_DefaultValue = new CandleStickSeriesSonificationDefaultInstrumentOptionsMappingLowpass();
			NoteDuration = NoteDuration_DefaultValue = new CandleStickSeriesSonificationDefaultInstrumentOptionsMappingNoteDuration();
			Pan = Pan_DefaultValue = new CandleStickSeriesSonificationDefaultInstrumentOptionsMappingPan();
			Pitch = Pitch_DefaultValue = new CandleStickSeriesSonificationDefaultInstrumentOptionsMappingPitch();
			PitchString = PitchString_DefaultValue = "null";
			PitchNumber = PitchNumber_DefaultValue = null;
			PlayDelay = PlayDelay_DefaultValue = new CandleStickSeriesSonificationDefaultInstrumentOptionsMappingPlayDelay();
			Time = Time_DefaultValue = new CandleStickSeriesSonificationDefaultInstrumentOptionsMappingTime();
			TimeString = TimeString_DefaultValue = "null";
			TimeNumber = TimeNumber_DefaultValue = null;
			Tremolo = Tremolo_DefaultValue = new CandleStickSeriesSonificationDefaultInstrumentOptionsMappingTremolo();
			Volume = Volume_DefaultValue = new CandleStickSeriesSonificationDefaultInstrumentOptionsMappingVolume();
		...
		/// </summary>
		public CandleStickSeriesSonificationDefaultInstrumentOptionsMappingFrequency Frequency { get; set; }
		private CandleStickSeriesSonificationDefaultInstrumentOptionsMappingFrequency Frequency_DefaultValue { get; set; }
		...
		/// </summary>
		public CandleStickSeriesSonificationDefaultInstrumentOptionsMappingGapBetweenNotes GapBetweenNotes { get; set; }
		private CandleStickSeriesSonificationDefaultInstrumentOptionsMappingGapBetweenNotes GapBetweenNotes_DefaultValue { get; set; }
		...
		/// </summary>
		public CandleStickSeriesSonificationDefaultInstrumentOptionsMappingHighpass Highpass { get; set; }
		private CandleStickSeriesSonificationDefaultInstrumentOptionsMappingHighpass Highpass_DefaultValue { get; set; }
		...
		/// </summary>
		public CandleStickSeriesSonificationDefaultInstrumentOptionsMappingLowpass Lowpass { get; set; }
		private CandleStickSeriesSonificationDefaultInstrumentOptionsMappingLowpass Lowpass_DefaultValue { get; set; }
		...
		/// </summary>
		public CandleStickSeriesSonificationDefaultInstrumentOptionsMappingNoteDuration NoteDuration { get; set; }
		private CandleStickSeriesSonificationDefaultInstrumentOptionsMappingNoteDuration NoteDuration_DefaultValue { get; set; }
		...
		/// </summary>
		public CandleStickSeriesSonificationDefaultInstrumentOptionsMappingPan Pan { get; set; }
		private CandleStickSeriesSonificationDefaultInstrumentOptionsMappingPan Pan_DefaultValue { get; set; }
		...
		/// </summary>
		public CandleStickSeriesSonificationDefaultInstrumentOptionsMappingPitch Pitch { get; set; }
		private CandleStickSeriesSonificationDefaultInstrumentOptionsMappingPitch Pitch_DefaultValue { get; set; }
		...
		/// </summary>
		public CandleStickSeriesSonificationDefaultInstrumentOptionsMappingPlayDelay PlayDelay { get; set; }
		private CandleStickSeriesSonificationDefaultInstrumentOptionsMappingPlayDelay PlayDelay_DefaultValue { get; set; }
		...
		/// </summary>
		public CandleStickSeriesSonificationDefaultInstrumentOptionsMappingTime Time { get; set; }
		private CandleStickSeriesSonificationDefaultInstrumentOptionsMappingTime Time_DefaultValue { get; set; }
		...
		/// </summary>
		public CandleStickSeriesSonificationDefaultInstrumentOptionsMappingTremolo Tremolo { get; set; }
		private CandleStickSeriesSonificationDefaultInstrumentOptionsMappingTremolo Tremolo_DefaultValue { get; set; }
		 

		/// <summary>
		/// The volume of notes, from 0 to 1.
		/// </summary>
		public CandleStickSeriesSonificationDefaultInstrumentOptionsMappingVolume Volume { get; set; }
		private CandleStickSeriesSonificationDefaultInstrumentOptionsMappingVolume Volume_DefaultValue { get; set; }
