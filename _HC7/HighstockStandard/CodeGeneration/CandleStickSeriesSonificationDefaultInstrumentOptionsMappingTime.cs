...
{
	public partial class CandleStickSeriesSonificationDefaultInstrumentOptionsMappingTime  : BaseObject
	{
		Hashtable h = new Hashtable();

		public CandleStickSeriesSonificationDefaultInstrumentOptionsMappingTime()
		{
			MapFunction = MapFunction_DefaultValue = CandleStickSeriesSonificationDefaultInstrumentOptionsMappingTimeMapFunction.Linear;
			MapTo = MapTo_DefaultValue = "";
			Max = Max_DefaultValue = null;
			Min = Min_DefaultValue = null;
			Value = Value_DefaultValue = null;
			Within = Within_DefaultValue = CandleStickSeriesSonificationDefaultInstrumentOptionsMappingTimeWithin.Chart;
		...
		/// </summary>
		public CandleStickSeriesSonificationDefaultInstrumentOptionsMappingTimeMapFunction MapFunction { get; set; }
		private CandleStickSeriesSonificationDefaultInstrumentOptionsMappingTimeMapFunction MapFunction_DefaultValue { get; set; }
		...
		/// </summary>
		public CandleStickSeriesSonificationDefaultInstrumentOptionsMappingTimeWithin Within { get; set; }
		private CandleStickSeriesSonificationDefaultInstrumentOptionsMappingTimeWithin Within_DefaultValue { get; set; }
