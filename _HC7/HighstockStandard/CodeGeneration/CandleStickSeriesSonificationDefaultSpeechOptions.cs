...
{
	public partial class CandleStickSeriesSonificationDefaultSpeechOptions  : BaseObject
	{
		Hashtable h = new Hashtable();

		public CandleStickSeriesSonificationDefaultSpeechOptions()
		{
			ActiveWhen = ActiveWhen_DefaultValue = new CandleStickSeriesSonificationDefaultSpeechOptionsActiveWhen();
			Language = Language_DefaultValue = "en-US";
			Mapping = Mapping_DefaultValue = new CandleStickSeriesSonificationDefaultSpeechOptionsMapping();
		...
		/// </summary>
		public CandleStickSeriesSonificationDefaultSpeechOptionsActiveWhen ActiveWhen { get; set; }
		private CandleStickSeriesSonificationDefaultSpeechOptionsActiveWhen ActiveWhen_DefaultValue { get; set; }
		...
		/// </summary>
		public CandleStickSeriesSonificationDefaultSpeechOptionsMapping Mapping { get; set; }
		private CandleStickSeriesSonificationDefaultSpeechOptionsMapping Mapping_DefaultValue { get; set; }
		 

		/// <summary>
		/// Options for point grouping, specifically for instrument tracks.
		/// </summary>
		public CandleStickSeriesSonificationDefaultSpeechOptionsPointGrouping PointGrouping { get; set; }
		private CandleStickSeriesSonificationDefaultSpeechOptionsPointGrouping PointGrouping_DefaultValue { get; set; }
