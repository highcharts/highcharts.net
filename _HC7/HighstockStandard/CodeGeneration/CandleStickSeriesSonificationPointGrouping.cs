...
{
	public partial class CandleStickSeriesSonificationPointGrouping  : BaseObject
	{
		Hashtable h = new Hashtable();

		public CandleStickSeriesSonificationPointGrouping()
		{
			Algorithm = Algorithm_DefaultValue = CandleStickSeriesSonificationPointGroupingAlgorithm.Minimax;
		...
		/// </summary>
		public CandleStickSeriesSonificationPointGroupingAlgorithm Algorithm { get; set; }
		private CandleStickSeriesSonificationPointGroupingAlgorithm Algorithm_DefaultValue { get; set; }
