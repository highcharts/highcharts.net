...
{
	public partial class CandleStickSeriesSonificationTracks  : BaseObject
	{
		Hashtable h = new Hashtable();

		public CandleStickSeriesSonificationTracks()
		{
			ActiveWhen = ActiveWhen_DefaultValue = new CandleStickSeriesSonificationTracksActiveWhen();
			Instrument = Instrument_DefaultValue = null;
			InstrumentString = InstrumentString_DefaultValue = "null";
			Mapping = Mapping_DefaultValue = new CandleStickSeriesSonificationTracksMapping();
			MidiName = MidiName_DefaultValue = "";
			PointGrouping = PointGrouping_DefaultValue = new CandleStickSeriesSonificationTracksPointGrouping();
			RoundToMusicalNotes = RoundToMusicalNotes_DefaultValue = true;
			ShowPlayMarker = ShowPlayMarker_DefaultValue = true;
			Type = Type_DefaultValue = CandleStickSeriesSonificationTracksType.Instrument;
		...
		/// </summary>
		public CandleStickSeriesSonificationTracksActiveWhen ActiveWhen { get; set; }
		private CandleStickSeriesSonificationTracksActiveWhen ActiveWhen_DefaultValue { get; set; }
		...
		/// </summary>
		public CandleStickSeriesSonificationTracksMapping Mapping { get; set; }
		private CandleStickSeriesSonificationTracksMapping Mapping_DefaultValue { get; set; }
		...
		/// </summary>
		public CandleStickSeriesSonificationTracksPointGrouping PointGrouping { get; set; }
		private CandleStickSeriesSonificationTracksPointGrouping PointGrouping_DefaultValue { get; set; }
		...
		/// </summary>
		public CandleStickSeriesSonificationTracksType Type { get; set; }
		private CandleStickSeriesSonificationTracksType Type_DefaultValue { get; set; }
