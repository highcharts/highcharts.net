...
{
	public partial class CandleStickSeriesSonificationTracksMapping  : BaseObject
	{
		Hashtable h = new Hashtable();

		public CandleStickSeriesSonificationTracksMapping()
		{
			Frequency = Frequency_DefaultValue = new CandleStickSeriesSonificationTracksMappingFrequency();
			GapBetweenNotes = GapBetweenNotes_DefaultValue = new CandleStickSeriesSonificationTracksMappingGapBetweenNotes();
			Highpass = Highpass_DefaultValue = new CandleStickSeriesSonificationTracksMappingHighpass();
			Lowpass = Lowpass_DefaultValue = new CandleStickSeriesSonificationTracksMappingLowpass();
			NoteDuration = NoteDuration_DefaultValue = new CandleStickSeriesSonificationTracksMappingNoteDuration();
			Pan = Pan_DefaultValue = new CandleStickSeriesSonificationTracksMappingPan();
			Pitch = Pitch_DefaultValue = new CandleStickSeriesSonificationTracksMappingPitch();
			PitchString = PitchString_DefaultValue = "null";
			PitchNumber = PitchNumber_DefaultValue = null;
			PlayDelay = PlayDelay_DefaultValue = new CandleStickSeriesSonificationTracksMappingPlayDelay();
			Time = Time_DefaultValue = new CandleStickSeriesSonificationTracksMappingTime();
			TimeString = TimeString_DefaultValue = "null";
			TimeNumber = TimeNumber_DefaultValue = null;
			Tremolo = Tremolo_DefaultValue = new CandleStickSeriesSonificationTracksMappingTremolo();
			Volume = Volume_DefaultValue = new CandleStickSeriesSonificationTracksMappingVolume();
		...
		/// </summary>
		public CandleStickSeriesSonificationTracksMappingFrequency Frequency { get; set; }
		private CandleStickSeriesSonificationTracksMappingFrequency Frequency_DefaultValue { get; set; }
		...
		/// </summary>
		public CandleStickSeriesSonificationTracksMappingGapBetweenNotes GapBetweenNotes { get; set; }
		private CandleStickSeriesSonificationTracksMappingGapBetweenNotes GapBetweenNotes_DefaultValue { get; set; }
		...
		/// </summary>
		public CandleStickSeriesSonificationTracksMappingHighpass Highpass { get; set; }
		private CandleStickSeriesSonificationTracksMappingHighpass Highpass_DefaultValue { get; set; }
		...
		/// </summary>
		public CandleStickSeriesSonificationTracksMappingLowpass Lowpass { get; set; }
		private CandleStickSeriesSonificationTracksMappingLowpass Lowpass_DefaultValue { get; set; }
		...
		/// </summary>
		public CandleStickSeriesSonificationTracksMappingNoteDuration NoteDuration { get; set; }
		private CandleStickSeriesSonificationTracksMappingNoteDuration NoteDuration_DefaultValue { get; set; }
		...
		/// </summary>
		public CandleStickSeriesSonificationTracksMappingPan Pan { get; set; }
		private CandleStickSeriesSonificationTracksMappingPan Pan_DefaultValue { get; set; }
		...
		/// </summary>
		public CandleStickSeriesSonificationTracksMappingPitch Pitch { get; set; }
		private CandleStickSeriesSonificationTracksMappingPitch Pitch_DefaultValue { get; set; }
		...
		/// </summary>
		public CandleStickSeriesSonificationTracksMappingPlayDelay PlayDelay { get; set; }
		private CandleStickSeriesSonificationTracksMappingPlayDelay PlayDelay_DefaultValue { get; set; }
		...
		/// </summary>
		public CandleStickSeriesSonificationTracksMappingTime Time { get; set; }
		private CandleStickSeriesSonificationTracksMappingTime Time_DefaultValue { get; set; }
		...
		/// </summary>
		public CandleStickSeriesSonificationTracksMappingTremolo Tremolo { get; set; }
		private CandleStickSeriesSonificationTracksMappingTremolo Tremolo_DefaultValue { get; set; }
		 

		/// <summary>
		/// The volume of notes, from 0 to 1.
		/// </summary>
		public CandleStickSeriesSonificationTracksMappingVolume Volume { get; set; }
		private CandleStickSeriesSonificationTracksMappingVolume Volume_DefaultValue { get; set; }
