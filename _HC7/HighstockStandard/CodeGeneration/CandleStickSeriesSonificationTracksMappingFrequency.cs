...
{
	public partial class CandleStickSeriesSonificationTracksMappingFrequency  : BaseObject
	{
		Hashtable h = new Hashtable();

		public CandleStickSeriesSonificationTracksMappingFrequency()
		{
			MapFunction = MapFunction_DefaultValue = CandleStickSeriesSonificationTracksMappingFrequencyMapFunction.Linear;
			MapTo = MapTo_DefaultValue = "";
			Max = Max_DefaultValue = null;
			Min = Min_DefaultValue = null;
			Value = Value_DefaultValue = null;
			Within = Within_DefaultValue = CandleStickSeriesSonificationTracksMappingFrequencyWithin.Chart;
		...
		/// </summary>
		public CandleStickSeriesSonificationTracksMappingFrequencyMapFunction MapFunction { get; set; }
		private CandleStickSeriesSonificationTracksMappingFrequencyMapFunction MapFunction_DefaultValue { get; set; }
		...
		/// </summary>
		public CandleStickSeriesSonificationTracksMappingFrequencyWithin Within { get; set; }
		private CandleStickSeriesSonificationTracksMappingFrequencyWithin Within_DefaultValue { get; set; }
