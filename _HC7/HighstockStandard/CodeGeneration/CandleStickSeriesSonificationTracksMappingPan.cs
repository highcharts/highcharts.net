...
{
	public partial class CandleStickSeriesSonificationTracksMappingPan  : BaseObject
	{
		Hashtable h = new Hashtable();

		public CandleStickSeriesSonificationTracksMappingPan()
		{
			MapFunction = MapFunction_DefaultValue = CandleStickSeriesSonificationTracksMappingPanMapFunction.Linear;
			MapTo = MapTo_DefaultValue = "";
			Max = Max_DefaultValue = null;
			Min = Min_DefaultValue = null;
			Value = Value_DefaultValue = null;
			Within = Within_DefaultValue = CandleStickSeriesSonificationTracksMappingPanWithin.Chart;
		...
		/// </summary>
		public CandleStickSeriesSonificationTracksMappingPanMapFunction MapFunction { get; set; }
		private CandleStickSeriesSonificationTracksMappingPanMapFunction MapFunction_DefaultValue { get; set; }
		...
		/// </summary>
		public CandleStickSeriesSonificationTracksMappingPanWithin Within { get; set; }
		private CandleStickSeriesSonificationTracksMappingPanWithin Within_DefaultValue { get; set; }
