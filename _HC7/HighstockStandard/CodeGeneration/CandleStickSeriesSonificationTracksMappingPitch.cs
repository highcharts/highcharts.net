...
{
	public partial class CandleStickSeriesSonificationTracksMappingPitch  : BaseObject
	{
		Hashtable h = new Hashtable();

		public CandleStickSeriesSonificationTracksMappingPitch()
		{
			MapFunction = MapFunction_DefaultValue = CandleStickSeriesSonificationTracksMappingPitchMapFunction.Linear;
		...
		/// </summary>
		public CandleStickSeriesSonificationTracksMappingPitchMapFunction MapFunction { get; set; }
		private CandleStickSeriesSonificationTracksMappingPitchMapFunction MapFunction_DefaultValue { get; set; }
