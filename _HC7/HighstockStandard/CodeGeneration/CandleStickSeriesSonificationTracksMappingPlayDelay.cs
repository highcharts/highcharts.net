...
{
	public partial class CandleStickSeriesSonificationTracksMappingPlayDelay  : BaseObject
	{
		Hashtable h = new Hashtable();

		public CandleStickSeriesSonificationTracksMappingPlayDelay()
		{
			MapFunction = MapFunction_DefaultValue = CandleStickSeriesSonificationTracksMappingPlayDelayMapFunction.Linear;
			MapTo = MapTo_DefaultValue = "";
			Max = Max_DefaultValue = null;
			Min = Min_DefaultValue = null;
			Value = Value_DefaultValue = null;
			Within = Within_DefaultValue = CandleStickSeriesSonificationTracksMappingPlayDelayWithin.Chart;
		...
		/// </summary>
		public CandleStickSeriesSonificationTracksMappingPlayDelayMapFunction MapFunction { get; set; }
		private CandleStickSeriesSonificationTracksMappingPlayDelayMapFunction MapFunction_DefaultValue { get; set; }
		...
		/// </summary>
		public CandleStickSeriesSonificationTracksMappingPlayDelayWithin Within { get; set; }
		private CandleStickSeriesSonificationTracksMappingPlayDelayWithin Within_DefaultValue { get; set; }
