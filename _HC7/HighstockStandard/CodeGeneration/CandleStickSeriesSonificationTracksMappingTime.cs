...
{
	public partial class CandleStickSeriesSonificationTracksMappingTime  : BaseObject
	{
		Hashtable h = new Hashtable();

		public CandleStickSeriesSonificationTracksMappingTime()
		{
			MapFunction = MapFunction_DefaultValue = CandleStickSeriesSonificationTracksMappingTimeMapFunction.Linear;
			MapTo = MapTo_DefaultValue = "";
			Max = Max_DefaultValue = null;
			Min = Min_DefaultValue = null;
			Value = Value_DefaultValue = null;
			Within = Within_DefaultValue = CandleStickSeriesSonificationTracksMappingTimeWithin.Chart;
		...
		/// </summary>
		public CandleStickSeriesSonificationTracksMappingTimeMapFunction MapFunction { get; set; }
		private CandleStickSeriesSonificationTracksMappingTimeMapFunction MapFunction_DefaultValue { get; set; }
		...
		/// </summary>
		public CandleStickSeriesSonificationTracksMappingTimeWithin Within { get; set; }
		private CandleStickSeriesSonificationTracksMappingTimeWithin Within_DefaultValue { get; set; }
