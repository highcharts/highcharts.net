...
{
	public partial class CandleStickSeriesSonificationTracksMappingTremoloDepth  : BaseObject
	{
		Hashtable h = new Hashtable();

		public CandleStickSeriesSonificationTracksMappingTremoloDepth()
		{
			MapFunction = MapFunction_DefaultValue = CandleStickSeriesSonificationTracksMappingTremoloDepthMapFunction.Linear;
			MapTo = MapTo_DefaultValue = "";
			Max = Max_DefaultValue = null;
			Min = Min_DefaultValue = null;
			Value = Value_DefaultValue = null;
			Within = Within_DefaultValue = CandleStickSeriesSonificationTracksMappingTremoloDepthWithin.Chart;
		...
		/// </summary>
		public CandleStickSeriesSonificationTracksMappingTremoloDepthMapFunction MapFunction { get; set; }
		private CandleStickSeriesSonificationTracksMappingTremoloDepthMapFunction MapFunction_DefaultValue { get; set; }
		...
		/// </summary>
		public CandleStickSeriesSonificationTracksMappingTremoloDepthWithin Within { get; set; }
		private CandleStickSeriesSonificationTracksMappingTremoloDepthWithin Within_DefaultValue { get; set; }
