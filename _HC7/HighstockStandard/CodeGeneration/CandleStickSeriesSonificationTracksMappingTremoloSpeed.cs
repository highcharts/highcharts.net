...
{
	public partial class CandleStickSeriesSonificationTracksMappingTremoloSpeed  : BaseObject
	{
		Hashtable h = new Hashtable();

		public CandleStickSeriesSonificationTracksMappingTremoloSpeed()
		{
			MapFunction = MapFunction_DefaultValue = CandleStickSeriesSonificationTracksMappingTremoloSpeedMapFunction.Linear;
			MapTo = MapTo_DefaultValue = "";
			Max = Max_DefaultValue = null;
			Min = Min_DefaultValue = null;
			Value = Value_DefaultValue = null;
			Within = Within_DefaultValue = CandleStickSeriesSonificationTracksMappingTremoloSpeedWithin.Chart;
		...
		/// </summary>
		public CandleStickSeriesSonificationTracksMappingTremoloSpeedMapFunction MapFunction { get; set; }
		private CandleStickSeriesSonificationTracksMappingTremoloSpeedMapFunction MapFunction_DefaultValue { get; set; }
		...
		/// </summary>
		public CandleStickSeriesSonificationTracksMappingTremoloSpeedWithin Within { get; set; }
		private CandleStickSeriesSonificationTracksMappingTremoloSpeedWithin Within_DefaultValue { get; set; }
