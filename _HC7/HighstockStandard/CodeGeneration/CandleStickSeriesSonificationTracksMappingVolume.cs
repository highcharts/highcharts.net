...
{
	public partial class CandleStickSeriesSonificationTracksMappingVolume  : BaseObject
	{
		Hashtable h = new Hashtable();

		public CandleStickSeriesSonificationTracksMappingVolume()
		{
			MapFunction = MapFunction_DefaultValue = CandleStickSeriesSonificationTracksMappingVolumeMapFunction.Linear;
			MapTo = MapTo_DefaultValue = "";
			Max = Max_DefaultValue = null;
			Min = Min_DefaultValue = null;
			Value = Value_DefaultValue = null;
			Within = Within_DefaultValue = CandleStickSeriesSonificationTracksMappingVolumeWithin.Chart;
		...
		/// </summary>
		public CandleStickSeriesSonificationTracksMappingVolumeMapFunction MapFunction { get; set; }
		private CandleStickSeriesSonificationTracksMappingVolumeMapFunction MapFunction_DefaultValue { get; set; }
		...
		/// </summary>
		public CandleStickSeriesSonificationTracksMappingVolumeWithin Within { get; set; }
		private CandleStickSeriesSonificationTracksMappingVolumeWithin Within_DefaultValue { get; set; }
