...
namespace Highsoft.Web.Mvc.Stocks
{
	public partial class CandleStickSeriesStatesHoverMarkerStates  : BaseObject
	{
		public CandleStickSeriesStatesHoverMarkerStates()
		{
			...
			Inactive = Inactive_DefaultValue = new CandleStickSeriesStatesHoverMarkerStatesInactive();
		...
		/// 
		/// </summary>
		public CandleStickSeriesStatesHoverMarkerStatesInactive Inactive { get; set; }
		private CandleStickSeriesStatesHoverMarkerStatesInactive Inactive_DefaultValue { get; set; }
