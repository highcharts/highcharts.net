...
namespace Highsoft.Web.Mvc.Stocks
{
	public partial class Caption  : BaseObject
	{
		...
		{
			if (Align != CaptionAlign.Null) h.Add("align", highstock.FirstCharacterToLower(Align.ToString()));
			...
			if (VerticalAlign != CaptionVerticalAlign.Null) h.Add("verticalAlign", highstock.FirstCharacterToLower(VerticalAlign.ToString()));
			if (X != null) h.Add("x",X);
			if (Y != null) h.Add("y",Y);
