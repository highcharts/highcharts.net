...
{
	public partial class CciSeriesDragDropDragHandle  : BaseObject
	{
		public CciSeriesDragDropDragHandle()
		{
		...
		internal override Hashtable ToHashtable()
		{
			...
			if (PathFormatter != PathFormatter_DefaultValue) { h.Add("pathFormatter",PathFormatter); Highstock.AddFunction("CciSeriesDragDropDragHandlePathFormatter.pathFormatter", PathFormatter); }  
