...
{
	public partial class CciSeriesLabel  : BaseObject
	{
		public CciSeriesLabel()
		{
			...
			Style = Style_DefaultValue = new CciSeriesLabelStyle();
		...
		/// </summary>
		public CciSeriesLabelStyle Style { get; set; }
		private CciSeriesLabelStyle Style_DefaultValue { get; set; }
