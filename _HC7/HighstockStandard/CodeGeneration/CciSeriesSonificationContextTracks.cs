...
{
	public partial class CciSeriesSonificationContextTracks  : BaseObject
	{
		Hashtable h = new Hashtable();

		public CciSeriesSonificationContextTracks()
		{
			ActiveWhen = ActiveWhen_DefaultValue = new CciSeriesSonificationContextTracksActiveWhen();
			Instrument = Instrument_DefaultValue = null;
			InstrumentString = InstrumentString_DefaultValue = "null";
			Mapping = Mapping_DefaultValue = new CciSeriesSonificationContextTracksMapping();
			MidiName = MidiName_DefaultValue = "";
			PointGrouping = PointGrouping_DefaultValue = new CciSeriesSonificationContextTracksPointGrouping();
			...
			Type = Type_DefaultValue = CciSeriesSonificationContextTracksType.Instrument;
			ValueInterval = ValueInterval_DefaultValue = null;
			ValueMapFunction = ValueMapFunction_DefaultValue = CciSeriesSonificationContextTracksValueMapFunction.Linear;
		...
		/// </summary>
		public CciSeriesSonificationContextTracksActiveWhen ActiveWhen { get; set; }
		private CciSeriesSonificationContextTracksActiveWhen ActiveWhen_DefaultValue { get; set; }
		...
		/// </summary>
		public CciSeriesSonificationContextTracksMapping Mapping { get; set; }
		private CciSeriesSonificationContextTracksMapping Mapping_DefaultValue { get; set; }
		...
		/// </summary>
		public CciSeriesSonificationContextTracksPointGrouping PointGrouping { get; set; }
		private CciSeriesSonificationContextTracksPointGrouping PointGrouping_DefaultValue { get; set; }
		...
		/// </summary>
		public CciSeriesSonificationContextTracksType Type { get; set; }
		private CciSeriesSonificationContextTracksType Type_DefaultValue { get; set; }
		...
		/// </summary>
		public CciSeriesSonificationContextTracksValueMapFunction ValueMapFunction { get; set; }
		private CciSeriesSonificationContextTracksValueMapFunction ValueMapFunction_DefaultValue { get; set; }
