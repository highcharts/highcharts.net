...
{
	public partial class CciSeriesSonificationContextTracksMapping  : BaseObject
	{
		Hashtable h = new Hashtable();

		public CciSeriesSonificationContextTracksMapping()
		{
			Frequency = Frequency_DefaultValue = new CciSeriesSonificationContextTracksMappingFrequency();
			GapBetweenNotes = GapBetweenNotes_DefaultValue = new CciSeriesSonificationContextTracksMappingGapBetweenNotes();
			Highpass = Highpass_DefaultValue = new CciSeriesSonificationContextTracksMappingHighpass();
			Lowpass = Lowpass_DefaultValue = new CciSeriesSonificationContextTracksMappingLowpass();
			NoteDuration = NoteDuration_DefaultValue = new CciSeriesSonificationContextTracksMappingNoteDuration();
			Pan = Pan_DefaultValue = new CciSeriesSonificationContextTracksMappingPan();
			Pitch = Pitch_DefaultValue = new CciSeriesSonificationContextTracksMappingPitch();
			PitchString = PitchString_DefaultValue = "null";
			PitchNumber = PitchNumber_DefaultValue = null;
			PlayDelay = PlayDelay_DefaultValue = new CciSeriesSonificationContextTracksMappingPlayDelay();
			Time = Time_DefaultValue = new CciSeriesSonificationContextTracksMappingTime();
			TimeString = TimeString_DefaultValue = "null";
			TimeNumber = TimeNumber_DefaultValue = null;
			Tremolo = Tremolo_DefaultValue = new CciSeriesSonificationContextTracksMappingTremolo();
			Volume = Volume_DefaultValue = new CciSeriesSonificationContextTracksMappingVolume();
		...
		/// </summary>
		public CciSeriesSonificationContextTracksMappingFrequency Frequency { get; set; }
		private CciSeriesSonificationContextTracksMappingFrequency Frequency_DefaultValue { get; set; }
		...
		/// </summary>
		public CciSeriesSonificationContextTracksMappingGapBetweenNotes GapBetweenNotes { get; set; }
		private CciSeriesSonificationContextTracksMappingGapBetweenNotes GapBetweenNotes_DefaultValue { get; set; }
		...
		/// </summary>
		public CciSeriesSonificationContextTracksMappingHighpass Highpass { get; set; }
		private CciSeriesSonificationContextTracksMappingHighpass Highpass_DefaultValue { get; set; }
		...
		/// </summary>
		public CciSeriesSonificationContextTracksMappingLowpass Lowpass { get; set; }
		private CciSeriesSonificationContextTracksMappingLowpass Lowpass_DefaultValue { get; set; }
		...
		/// </summary>
		public CciSeriesSonificationContextTracksMappingNoteDuration NoteDuration { get; set; }
		private CciSeriesSonificationContextTracksMappingNoteDuration NoteDuration_DefaultValue { get; set; }
		...
		/// </summary>
		public CciSeriesSonificationContextTracksMappingPan Pan { get; set; }
		private CciSeriesSonificationContextTracksMappingPan Pan_DefaultValue { get; set; }
		...
		/// </summary>
		public CciSeriesSonificationContextTracksMappingPitch Pitch { get; set; }
		private CciSeriesSonificationContextTracksMappingPitch Pitch_DefaultValue { get; set; }
		...
		/// </summary>
		public CciSeriesSonificationContextTracksMappingPlayDelay PlayDelay { get; set; }
		private CciSeriesSonificationContextTracksMappingPlayDelay PlayDelay_DefaultValue { get; set; }
		...
		/// </summary>
		public CciSeriesSonificationContextTracksMappingTime Time { get; set; }
		private CciSeriesSonificationContextTracksMappingTime Time_DefaultValue { get; set; }
		...
		/// </summary>
		public CciSeriesSonificationContextTracksMappingTremolo Tremolo { get; set; }
		private CciSeriesSonificationContextTracksMappingTremolo Tremolo_DefaultValue { get; set; }
		 

		/// <summary>
		/// The volume of notes, from 0 to 1.
		/// </summary>
		public CciSeriesSonificationContextTracksMappingVolume Volume { get; set; }
		private CciSeriesSonificationContextTracksMappingVolume Volume_DefaultValue { get; set; }
