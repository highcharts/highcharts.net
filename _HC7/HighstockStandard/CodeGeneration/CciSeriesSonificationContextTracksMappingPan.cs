...
{
	public partial class CciSeriesSonificationContextTracksMappingPan  : BaseObject
	{
		Hashtable h = new Hashtable();

		public CciSeriesSonificationContextTracksMappingPan()
		{
			MapFunction = MapFunction_DefaultValue = CciSeriesSonificationContextTracksMappingPanMapFunction.Linear;
			MapTo = MapTo_DefaultValue = "";
			Max = Max_DefaultValue = null;
			Min = Min_DefaultValue = null;
			Value = Value_DefaultValue = null;
			Within = Within_DefaultValue = CciSeriesSonificationContextTracksMappingPanWithin.Chart;
		...
		/// </summary>
		public CciSeriesSonificationContextTracksMappingPanMapFunction MapFunction { get; set; }
		private CciSeriesSonificationContextTracksMappingPanMapFunction MapFunction_DefaultValue { get; set; }
		...
		/// </summary>
		public CciSeriesSonificationContextTracksMappingPanWithin Within { get; set; }
		private CciSeriesSonificationContextTracksMappingPanWithin Within_DefaultValue { get; set; }
