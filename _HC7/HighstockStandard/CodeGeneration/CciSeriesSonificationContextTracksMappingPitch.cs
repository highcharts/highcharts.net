...
{
	public partial class CciSeriesSonificationContextTracksMappingPitch  : BaseObject
	{
		Hashtable h = new Hashtable();

		public CciSeriesSonificationContextTracksMappingPitch()
		{
			MapFunction = MapFunction_DefaultValue = CciSeriesSonificationContextTracksMappingPitchMapFunction.Linear;
		...
		/// </summary>
		public CciSeriesSonificationContextTracksMappingPitchMapFunction MapFunction { get; set; }
		private CciSeriesSonificationContextTracksMappingPitchMapFunction MapFunction_DefaultValue { get; set; }
