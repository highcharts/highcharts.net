...
{
	public partial class CciSeriesSonificationContextTracksMappingTime  : BaseObject
	{
		Hashtable h = new Hashtable();

		public CciSeriesSonificationContextTracksMappingTime()
		{
			MapFunction = MapFunction_DefaultValue = CciSeriesSonificationContextTracksMappingTimeMapFunction.Linear;
			MapTo = MapTo_DefaultValue = "";
			Max = Max_DefaultValue = null;
			Min = Min_DefaultValue = null;
			Value = Value_DefaultValue = null;
			Within = Within_DefaultValue = CciSeriesSonificationContextTracksMappingTimeWithin.Chart;
		...
		/// </summary>
		public CciSeriesSonificationContextTracksMappingTimeMapFunction MapFunction { get; set; }
		private CciSeriesSonificationContextTracksMappingTimeMapFunction MapFunction_DefaultValue { get; set; }
		...
		/// </summary>
		public CciSeriesSonificationContextTracksMappingTimeWithin Within { get; set; }
		private CciSeriesSonificationContextTracksMappingTimeWithin Within_DefaultValue { get; set; }
