...
{
	public partial class CciSeriesSonificationContextTracksMappingVolume  : BaseObject
	{
		Hashtable h = new Hashtable();

		public CciSeriesSonificationContextTracksMappingVolume()
		{
			MapFunction = MapFunction_DefaultValue = CciSeriesSonificationContextTracksMappingVolumeMapFunction.Linear;
			MapTo = MapTo_DefaultValue = "";
			Max = Max_DefaultValue = null;
			Min = Min_DefaultValue = null;
			Value = Value_DefaultValue = null;
			Within = Within_DefaultValue = CciSeriesSonificationContextTracksMappingVolumeWithin.Chart;
		...
		/// </summary>
		public CciSeriesSonificationContextTracksMappingVolumeMapFunction MapFunction { get; set; }
		private CciSeriesSonificationContextTracksMappingVolumeMapFunction MapFunction_DefaultValue { get; set; }
		...
		/// </summary>
		public CciSeriesSonificationContextTracksMappingVolumeWithin Within { get; set; }
		private CciSeriesSonificationContextTracksMappingVolumeWithin Within_DefaultValue { get; set; }
