...
{
	public partial class CciSeriesSonificationContextTracksPointGrouping  : BaseObject
	{
		Hashtable h = new Hashtable();

		public CciSeriesSonificationContextTracksPointGrouping()
		{
			Algorithm = Algorithm_DefaultValue = CciSeriesSonificationContextTracksPointGroupingAlgorithm.Minimax;
		...
		/// </summary>
		public CciSeriesSonificationContextTracksPointGroupingAlgorithm Algorithm { get; set; }
		private CciSeriesSonificationContextTracksPointGroupingAlgorithm Algorithm_DefaultValue { get; set; }
