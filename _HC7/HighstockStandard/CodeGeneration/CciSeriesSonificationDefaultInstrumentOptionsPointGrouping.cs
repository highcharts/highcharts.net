...
{
	public partial class CciSeriesSonificationDefaultInstrumentOptionsPointGrouping  : BaseObject
	{
		Hashtable h = new Hashtable();

		public CciSeriesSonificationDefaultInstrumentOptionsPointGrouping()
		{
			Algorithm = Algorithm_DefaultValue = CciSeriesSonificationDefaultInstrumentOptionsPointGroupingAlgorithm.Minimax;
		...
		/// </summary>
		public CciSeriesSonificationDefaultInstrumentOptionsPointGroupingAlgorithm Algorithm { get; set; }
		private CciSeriesSonificationDefaultInstrumentOptionsPointGroupingAlgorithm Algorithm_DefaultValue { get; set; }
