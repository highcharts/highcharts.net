...
{
	public partial class CciSeriesSonificationDefaultSpeechOptions  : BaseObject
	{
		Hashtable h = new Hashtable();

		public CciSeriesSonificationDefaultSpeechOptions()
		{
			ActiveWhen = ActiveWhen_DefaultValue = new CciSeriesSonificationDefaultSpeechOptionsActiveWhen();
			Language = Language_DefaultValue = "en-US";
			Mapping = Mapping_DefaultValue = new CciSeriesSonificationDefaultSpeechOptionsMapping();
			PointGrouping = PointGrouping_DefaultValue = new CciSeriesSonificationDefaultSpeechOptionsPointGrouping();
			PreferredVoice = PreferredVoice_DefaultValue = "";
			ShowPlayMarker = ShowPlayMarker_DefaultValue = true;
			Type = Type_DefaultValue = CciSeriesSonificationDefaultSpeechOptionsType.Instrument;
		...
		/// </summary>
		public CciSeriesSonificationDefaultSpeechOptionsActiveWhen ActiveWhen { get; set; }
		private CciSeriesSonificationDefaultSpeechOptionsActiveWhen ActiveWhen_DefaultValue { get; set; }
		...
		/// </summary>
		public CciSeriesSonificationDefaultSpeechOptionsMapping Mapping { get; set; }
		private CciSeriesSonificationDefaultSpeechOptionsMapping Mapping_DefaultValue { get; set; }
		 

		/// <summary>
		/// Options for point grouping, specifically for instrument tracks.
		/// </summary>
		public CciSeriesSonificationDefaultSpeechOptionsPointGrouping PointGrouping { get; set; }
		private CciSeriesSonificationDefaultSpeechOptionsPointGrouping PointGrouping_DefaultValue { get; set; }
		...
		/// </summary>
		public CciSeriesSonificationDefaultSpeechOptionsType Type { get; set; }
		private CciSeriesSonificationDefaultSpeechOptionsType Type_DefaultValue { get; set; }
