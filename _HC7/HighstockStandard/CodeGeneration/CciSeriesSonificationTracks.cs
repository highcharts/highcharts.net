...
{
	public partial class CciSeriesSonificationTracks  : BaseObject
	{
		Hashtable h = new Hashtable();

		public CciSeriesSonificationTracks()
		{
			ActiveWhen = ActiveWhen_DefaultValue = new CciSeriesSonificationTracksActiveWhen();
			Instrument = Instrument_DefaultValue = null;
			InstrumentString = InstrumentString_DefaultValue = "null";
			Mapping = Mapping_DefaultValue = new CciSeriesSonificationTracksMapping();
			MidiName = MidiName_DefaultValue = "";
			PointGrouping = PointGrouping_DefaultValue = new CciSeriesSonificationTracksPointGrouping();
			RoundToMusicalNotes = RoundToMusicalNotes_DefaultValue = true;
			ShowPlayMarker = ShowPlayMarker_DefaultValue = true;
			Type = Type_DefaultValue = CciSeriesSonificationTracksType.Instrument;
		...
		/// </summary>
		public CciSeriesSonificationTracksActiveWhen ActiveWhen { get; set; }
		private CciSeriesSonificationTracksActiveWhen ActiveWhen_DefaultValue { get; set; }
		...
		/// </summary>
		public CciSeriesSonificationTracksMapping Mapping { get; set; }
		private CciSeriesSonificationTracksMapping Mapping_DefaultValue { get; set; }
		...
		/// </summary>
		public CciSeriesSonificationTracksPointGrouping PointGrouping { get; set; }
		private CciSeriesSonificationTracksPointGrouping PointGrouping_DefaultValue { get; set; }
		...
		/// </summary>
		public CciSeriesSonificationTracksType Type { get; set; }
		private CciSeriesSonificationTracksType Type_DefaultValue { get; set; }
