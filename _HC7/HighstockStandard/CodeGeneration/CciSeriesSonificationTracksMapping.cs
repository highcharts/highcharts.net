...
{
	public partial class CciSeriesSonificationTracksMapping  : BaseObject
	{
		Hashtable h = new Hashtable();

		public CciSeriesSonificationTracksMapping()
		{
			Frequency = Frequency_DefaultValue = new CciSeriesSonificationTracksMappingFrequency();
			GapBetweenNotes = GapBetweenNotes_DefaultValue = new CciSeriesSonificationTracksMappingGapBetweenNotes();
			Highpass = Highpass_DefaultValue = new CciSeriesSonificationTracksMappingHighpass();
			Lowpass = Lowpass_DefaultValue = new CciSeriesSonificationTracksMappingLowpass();
			NoteDuration = NoteDuration_DefaultValue = new CciSeriesSonificationTracksMappingNoteDuration();
			Pan = Pan_DefaultValue = new CciSeriesSonificationTracksMappingPan();
			Pitch = Pitch_DefaultValue = new CciSeriesSonificationTracksMappingPitch();
			PitchString = PitchString_DefaultValue = "null";
			PitchNumber = PitchNumber_DefaultValue = null;
			PlayDelay = PlayDelay_DefaultValue = new CciSeriesSonificationTracksMappingPlayDelay();
			Time = Time_DefaultValue = new CciSeriesSonificationTracksMappingTime();
			TimeString = TimeString_DefaultValue = "null";
			TimeNumber = TimeNumber_DefaultValue = null;
			Tremolo = Tremolo_DefaultValue = new CciSeriesSonificationTracksMappingTremolo();
			Volume = Volume_DefaultValue = new CciSeriesSonificationTracksMappingVolume();
		...
		/// </summary>
		public CciSeriesSonificationTracksMappingFrequency Frequency { get; set; }
		private CciSeriesSonificationTracksMappingFrequency Frequency_DefaultValue { get; set; }
		...
		/// </summary>
		public CciSeriesSonificationTracksMappingGapBetweenNotes GapBetweenNotes { get; set; }
		private CciSeriesSonificationTracksMappingGapBetweenNotes GapBetweenNotes_DefaultValue { get; set; }
		...
		/// </summary>
		public CciSeriesSonificationTracksMappingHighpass Highpass { get; set; }
		private CciSeriesSonificationTracksMappingHighpass Highpass_DefaultValue { get; set; }
		...
		/// </summary>
		public CciSeriesSonificationTracksMappingLowpass Lowpass { get; set; }
		private CciSeriesSonificationTracksMappingLowpass Lowpass_DefaultValue { get; set; }
		...
		/// </summary>
		public CciSeriesSonificationTracksMappingNoteDuration NoteDuration { get; set; }
		private CciSeriesSonificationTracksMappingNoteDuration NoteDuration_DefaultValue { get; set; }
		...
		/// </summary>
		public CciSeriesSonificationTracksMappingPan Pan { get; set; }
		private CciSeriesSonificationTracksMappingPan Pan_DefaultValue { get; set; }
		...
		/// </summary>
		public CciSeriesSonificationTracksMappingPitch Pitch { get; set; }
		private CciSeriesSonificationTracksMappingPitch Pitch_DefaultValue { get; set; }
		...
		/// </summary>
		public CciSeriesSonificationTracksMappingPlayDelay PlayDelay { get; set; }
		private CciSeriesSonificationTracksMappingPlayDelay PlayDelay_DefaultValue { get; set; }
		...
		/// </summary>
		public CciSeriesSonificationTracksMappingTime Time { get; set; }
		private CciSeriesSonificationTracksMappingTime Time_DefaultValue { get; set; }
		...
		/// </summary>
		public CciSeriesSonificationTracksMappingTremolo Tremolo { get; set; }
		private CciSeriesSonificationTracksMappingTremolo Tremolo_DefaultValue { get; set; }
		 

		/// <summary>
		/// The volume of notes, from 0 to 1.
		/// </summary>
		public CciSeriesSonificationTracksMappingVolume Volume { get; set; }
		private CciSeriesSonificationTracksMappingVolume Volume_DefaultValue { get; set; }
