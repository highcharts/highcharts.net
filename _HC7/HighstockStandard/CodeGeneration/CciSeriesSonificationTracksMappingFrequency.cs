...
{
	public partial class CciSeriesSonificationTracksMappingFrequency  : BaseObject
	{
		Hashtable h = new Hashtable();

		public CciSeriesSonificationTracksMappingFrequency()
		{
			MapFunction = MapFunction_DefaultValue = CciSeriesSonificationTracksMappingFrequencyMapFunction.Linear;
			MapTo = MapTo_DefaultValue = "";
			Max = Max_DefaultValue = null;
			Min = Min_DefaultValue = null;
			Value = Value_DefaultValue = null;
			Within = Within_DefaultValue = CciSeriesSonificationTracksMappingFrequencyWithin.Chart;
		...
		/// </summary>
		public CciSeriesSonificationTracksMappingFrequencyMapFunction MapFunction { get; set; }
		private CciSeriesSonificationTracksMappingFrequencyMapFunction MapFunction_DefaultValue { get; set; }
		...
		/// </summary>
		public CciSeriesSonificationTracksMappingFrequencyWithin Within { get; set; }
		private CciSeriesSonificationTracksMappingFrequencyWithin Within_DefaultValue { get; set; }
