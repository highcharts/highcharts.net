...
{
	public partial class CciSeriesSonificationTracksMappingGapBetweenNotes  : BaseObject
	{
		Hashtable h = new Hashtable();

		public CciSeriesSonificationTracksMappingGapBetweenNotes()
		{
			MapFunction = MapFunction_DefaultValue = CciSeriesSonificationTracksMappingGapBetweenNotesMapFunction.Linear;
			MapTo = MapTo_DefaultValue = "";
			Max = Max_DefaultValue = null;
			Min = Min_DefaultValue = null;
			Value = Value_DefaultValue = null;
			Within = Within_DefaultValue = CciSeriesSonificationTracksMappingGapBetweenNotesWithin.Chart;
		...
		/// </summary>
		public CciSeriesSonificationTracksMappingGapBetweenNotesMapFunction MapFunction { get; set; }
		private CciSeriesSonificationTracksMappingGapBetweenNotesMapFunction MapFunction_DefaultValue { get; set; }
		...
		/// </summary>
		public CciSeriesSonificationTracksMappingGapBetweenNotesWithin Within { get; set; }
		private CciSeriesSonificationTracksMappingGapBetweenNotesWithin Within_DefaultValue { get; set; }
