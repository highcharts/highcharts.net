...
{
	public partial class CciSeriesSonificationTracksMappingLowpassResonance  : BaseObject
	{
		Hashtable h = new Hashtable();

		public CciSeriesSonificationTracksMappingLowpassResonance()
		{
			MapFunction = MapFunction_DefaultValue = CciSeriesSonificationTracksMappingLowpassResonanceMapFunction.Linear;
			MapTo = MapTo_DefaultValue = "";
			Max = Max_DefaultValue = null;
			Min = Min_DefaultValue = null;
			Value = Value_DefaultValue = null;
			Within = Within_DefaultValue = CciSeriesSonificationTracksMappingLowpassResonanceWithin.Chart;
		...
		/// </summary>
		public CciSeriesSonificationTracksMappingLowpassResonanceMapFunction MapFunction { get; set; }
		private CciSeriesSonificationTracksMappingLowpassResonanceMapFunction MapFunction_DefaultValue { get; set; }
		...
		/// </summary>
		public CciSeriesSonificationTracksMappingLowpassResonanceWithin Within { get; set; }
		private CciSeriesSonificationTracksMappingLowpassResonanceWithin Within_DefaultValue { get; set; }
