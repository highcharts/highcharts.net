...
{
	public partial class CciSeriesSonificationTracksMappingNoteDuration  : BaseObject
	{
		Hashtable h = new Hashtable();

		public CciSeriesSonificationTracksMappingNoteDuration()
		{
			MapFunction = MapFunction_DefaultValue = CciSeriesSonificationTracksMappingNoteDurationMapFunction.Linear;
			MapTo = MapTo_DefaultValue = "";
			Max = Max_DefaultValue = null;
			Min = Min_DefaultValue = null;
			Value = Value_DefaultValue = null;
			Within = Within_DefaultValue = CciSeriesSonificationTracksMappingNoteDurationWithin.Chart;
		...
		/// </summary>
		public CciSeriesSonificationTracksMappingNoteDurationMapFunction MapFunction { get; set; }
		private CciSeriesSonificationTracksMappingNoteDurationMapFunction MapFunction_DefaultValue { get; set; }
		...
		/// </summary>
		public CciSeriesSonificationTracksMappingNoteDurationWithin Within { get; set; }
		private CciSeriesSonificationTracksMappingNoteDurationWithin Within_DefaultValue { get; set; }
