...
{
	public partial class CciSeriesSonificationTracksMappingPan  : BaseObject
	{
		Hashtable h = new Hashtable();

		public CciSeriesSonificationTracksMappingPan()
		{
			MapFunction = MapFunction_DefaultValue = CciSeriesSonificationTracksMappingPanMapFunction.Linear;
			MapTo = MapTo_DefaultValue = "";
			Max = Max_DefaultValue = null;
			Min = Min_DefaultValue = null;
			Value = Value_DefaultValue = null;
			Within = Within_DefaultValue = CciSeriesSonificationTracksMappingPanWithin.Chart;
		...
		/// </summary>
		public CciSeriesSonificationTracksMappingPanMapFunction MapFunction { get; set; }
		private CciSeriesSonificationTracksMappingPanMapFunction MapFunction_DefaultValue { get; set; }
		...
		/// </summary>
		public CciSeriesSonificationTracksMappingPanWithin Within { get; set; }
		private CciSeriesSonificationTracksMappingPanWithin Within_DefaultValue { get; set; }
