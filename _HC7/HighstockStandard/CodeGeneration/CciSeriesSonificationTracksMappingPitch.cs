...
{
	public partial class CciSeriesSonificationTracksMappingPitch  : BaseObject
	{
		Hashtable h = new Hashtable();

		public CciSeriesSonificationTracksMappingPitch()
		{
			MapFunction = MapFunction_DefaultValue = CciSeriesSonificationTracksMappingPitchMapFunction.Linear;
		...
		/// </summary>
		public CciSeriesSonificationTracksMappingPitchMapFunction MapFunction { get; set; }
		private CciSeriesSonificationTracksMappingPitchMapFunction MapFunction_DefaultValue { get; set; }
