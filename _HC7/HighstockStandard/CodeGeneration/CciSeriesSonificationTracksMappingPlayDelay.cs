...
{
	public partial class CciSeriesSonificationTracksMappingPlayDelay  : BaseObject
	{
		Hashtable h = new Hashtable();

		public CciSeriesSonificationTracksMappingPlayDelay()
		{
			MapFunction = MapFunction_DefaultValue = CciSeriesSonificationTracksMappingPlayDelayMapFunction.Linear;
			MapTo = MapTo_DefaultValue = "";
			Max = Max_DefaultValue = null;
			Min = Min_DefaultValue = null;
			Value = Value_DefaultValue = null;
			Within = Within_DefaultValue = CciSeriesSonificationTracksMappingPlayDelayWithin.Chart;
		...
		/// </summary>
		public CciSeriesSonificationTracksMappingPlayDelayMapFunction MapFunction { get; set; }
		private CciSeriesSonificationTracksMappingPlayDelayMapFunction MapFunction_DefaultValue { get; set; }
		...
		/// </summary>
		public CciSeriesSonificationTracksMappingPlayDelayWithin Within { get; set; }
		private CciSeriesSonificationTracksMappingPlayDelayWithin Within_DefaultValue { get; set; }
