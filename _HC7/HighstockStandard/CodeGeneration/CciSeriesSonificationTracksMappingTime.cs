...
{
	public partial class CciSeriesSonificationTracksMappingTime  : BaseObject
	{
		Hashtable h = new Hashtable();

		public CciSeriesSonificationTracksMappingTime()
		{
			MapFunction = MapFunction_DefaultValue = CciSeriesSonificationTracksMappingTimeMapFunction.Linear;
			MapTo = MapTo_DefaultValue = "";
			Max = Max_DefaultValue = null;
			Min = Min_DefaultValue = null;
			Value = Value_DefaultValue = null;
			Within = Within_DefaultValue = CciSeriesSonificationTracksMappingTimeWithin.Chart;
		...
		/// </summary>
		public CciSeriesSonificationTracksMappingTimeMapFunction MapFunction { get; set; }
		private CciSeriesSonificationTracksMappingTimeMapFunction MapFunction_DefaultValue { get; set; }
		...
		/// </summary>
		public CciSeriesSonificationTracksMappingTimeWithin Within { get; set; }
		private CciSeriesSonificationTracksMappingTimeWithin Within_DefaultValue { get; set; }
