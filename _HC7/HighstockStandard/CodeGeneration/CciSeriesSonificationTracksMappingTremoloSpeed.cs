...
{
	public partial class CciSeriesSonificationTracksMappingTremoloSpeed  : BaseObject
	{
		Hashtable h = new Hashtable();

		public CciSeriesSonificationTracksMappingTremoloSpeed()
		{
			MapFunction = MapFunction_DefaultValue = CciSeriesSonificationTracksMappingTremoloSpeedMapFunction.Linear;
			MapTo = MapTo_DefaultValue = "";
			Max = Max_DefaultValue = null;
			Min = Min_DefaultValue = null;
			Value = Value_DefaultValue = null;
			Within = Within_DefaultValue = CciSeriesSonificationTracksMappingTremoloSpeedWithin.Chart;
		...
		/// </summary>
		public CciSeriesSonificationTracksMappingTremoloSpeedMapFunction MapFunction { get; set; }
		private CciSeriesSonificationTracksMappingTremoloSpeedMapFunction MapFunction_DefaultValue { get; set; }
		...
		/// </summary>
		public CciSeriesSonificationTracksMappingTremoloSpeedWithin Within { get; set; }
		private CciSeriesSonificationTracksMappingTremoloSpeedWithin Within_DefaultValue { get; set; }
