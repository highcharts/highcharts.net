...
{
	public partial class CciSeriesSonificationTracksMappingVolume  : BaseObject
	{
		Hashtable h = new Hashtable();

		public CciSeriesSonificationTracksMappingVolume()
		{
			MapFunction = MapFunction_DefaultValue = CciSeriesSonificationTracksMappingVolumeMapFunction.Linear;
			MapTo = MapTo_DefaultValue = "";
			Max = Max_DefaultValue = null;
			Min = Min_DefaultValue = null;
			Value = Value_DefaultValue = null;
			Within = Within_DefaultValue = CciSeriesSonificationTracksMappingVolumeWithin.Chart;
		...
		/// </summary>
		public CciSeriesSonificationTracksMappingVolumeMapFunction MapFunction { get; set; }
		private CciSeriesSonificationTracksMappingVolumeMapFunction MapFunction_DefaultValue { get; set; }
		...
		/// </summary>
		public CciSeriesSonificationTracksMappingVolumeWithin Within { get; set; }
		private CciSeriesSonificationTracksMappingVolumeWithin Within_DefaultValue { get; set; }
