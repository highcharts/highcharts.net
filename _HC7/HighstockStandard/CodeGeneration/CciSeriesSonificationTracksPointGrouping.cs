...
{
	public partial class CciSeriesSonificationTracksPointGrouping  : BaseObject
	{
		Hashtable h = new Hashtable();

		public CciSeriesSonificationTracksPointGrouping()
		{
			Algorithm = Algorithm_DefaultValue = CciSeriesSonificationTracksPointGroupingAlgorithm.Minimax;
		...
		/// </summary>
		public CciSeriesSonificationTracksPointGroupingAlgorithm Algorithm { get; set; }
		private CciSeriesSonificationTracksPointGroupingAlgorithm Algorithm_DefaultValue { get; set; }
