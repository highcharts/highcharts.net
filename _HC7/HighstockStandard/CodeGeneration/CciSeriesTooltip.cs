...
{
	public partial class CciSeriesTooltip  : BaseObject
	{
		public CciSeriesTooltip()
		{
			...
			HeaderShape = HeaderShape_DefaultValue = CciSeriesTooltipHeaderShape.Callout;
		...
		/// </summary>
		public CciSeriesTooltipHeaderShape HeaderShape { get; set; }
		private CciSeriesTooltipHeaderShape HeaderShape_DefaultValue { get; set; }
		...
		internal override Hashtable ToHashtable()
		{
			...
			if (NullFormatter != NullFormatter_DefaultValue) { h.Add("nullFormatter",NullFormatter); Highstock.AddFunction("CciSeriesTooltipNullFormatter.nullFormatter", NullFormatter); }  
			if (Outside != Outside_DefaultValue) h.Add("outside",Outside);
			if (Padding != Padding_DefaultValue) h.Add("padding",Padding);
			if (PointFormat != PointFormat_DefaultValue) h.Add("pointFormat",PointFormat);
			if (PointFormatter != PointFormatter_DefaultValue) { h.Add("pointFormatter",PointFormatter); Highstock.AddFunction("CciSeriesTooltipPointFormatter.pointFormatter", PointFormatter); }  
