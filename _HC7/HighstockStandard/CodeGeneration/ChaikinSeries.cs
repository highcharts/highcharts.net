...
namespace Highsoft.Web.Mvc.Stocks
{
	public partial class ChaikinSeries  : Series
	{
		...
		public ChaikinSeries()
		{
			...
			Zones = Zones_DefaultValue = new List<ChaikinSeriesZone>();
		...
		/// </summary>
		public List<ChaikinSeriesZone> Zones { get; set; }
		private List<ChaikinSeriesZone> Zones_DefaultValue { get; set; }
