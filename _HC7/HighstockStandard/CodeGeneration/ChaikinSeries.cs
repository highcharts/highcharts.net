...
{
	public partial class ChaikinSeries  : Series
	{
		Hashtable h = new Hashtable();

		public ChaikinSeries()
		{
			Accessibility = Accessibility_DefaultValue = new ChaikinSeriesAccessibility();
			AllowPointSelect = AllowPointSelect_DefaultValue = false;
			Animation = Animation_DefaultValue = new Animation() { Enabled = true };
			AnimationBool = AnimationBool_DefaultValue = true;
			AnimationLimit = AnimationLimit_DefaultValue = null;
			BoostBlending = BoostBlending_DefaultValue = ChaikinSeriesBoostBlending.Undefined;
			...
			Compare = Compare_DefaultValue = ChaikinSeriesCompare.Percent;
			CompareBase = CompareBase_DefaultValue = ChaikinSeriesCompareBase.Min;
			...
			Cursor = Cursor_DefaultValue = ChaikinSeriesCursor.Null;
			Custom = Custom_DefaultValue = new Hashtable();
			DashStyle = DashStyle_DefaultValue = ChaikinSeriesDashStyle.Null;
			DataGrouping = DataGrouping_DefaultValue = new ChaikinSeriesDataGrouping();
			DataLabels = DataLabels_DefaultValue = new ChaikinSeriesDataLabels();
			DataSorting = DataSorting_DefaultValue = new ChaikinSeriesDataSorting();
			Description = Description_DefaultValue = "";
			Dumbell = Dumbell_DefaultValue = new ChaikinSeriesDumbell();
			EnableMouseTracking = EnableMouseTracking_DefaultValue = true;
			Events = Events_DefaultValue = new ChaikinSeriesEvents();
			FindNearestPointBy = FindNearestPointBy_DefaultValue = ChaikinSeriesFindNearestPointBy.X;
			GapSize = GapSize_DefaultValue = 0;
			GapUnit = GapUnit_DefaultValue = ChaikinSeriesGapUnit.Relative;
			GetExtremesFromAll = GetExtremesFromAll_DefaultValue = false;
			Id = Id_DefaultValue = "";
			InactiveOtherPoints = InactiveOtherPoints_DefaultValue = false;
			IncludeInDataExport = IncludeInDataExport_DefaultValue = null;
			Index = Index_DefaultValue = null;
			Label = Label_DefaultValue = new ChaikinSeriesLabel();
			LastPrice = LastPrice_DefaultValue = new ChaikinSeriesLastPrice();
			LastVisiblePrice = LastVisiblePrice_DefaultValue = new ChaikinSeriesLastVisiblePrice();
			LegendIndex = LegendIndex_DefaultValue = null;
			LegendSymbol = LegendSymbol_DefaultValue = ChaikinSeriesLegendSymbol.Rectangle;
			Linecap = Linecap_DefaultValue = ChaikinSeriesLinecap.Round;
			LineWidth = LineWidth_DefaultValue = 2;
			LinkedTo = LinkedTo_DefaultValue = "";
			Marker = Marker_DefaultValue = new ChaikinSeriesMarker();
			Name = Name_DefaultValue = "";
			NegativeColor = NegativeColor_DefaultValue = "";
			OnPoint = OnPoint_DefaultValue = new ChaikinSeriesOnPoint();
			Opacity = Opacity_DefaultValue = 1;
			Params = Params_DefaultValue = new ChaikinSeriesParams();
			Point = Point_DefaultValue = new ChaikinSeriesPoint();
			...
			Sonification = Sonification_DefaultValue = new ChaikinSeriesSonification();
			Stack = Stack_DefaultValue = "";
			StackNumber = StackNumber_DefaultValue = null;
			States = States_DefaultValue = new ChaikinSeriesStates();
			Step = Step_DefaultValue = ChaikinSeriesStep.Null;
			StickyTracking = StickyTracking_DefaultValue = true;
			Threshold = Threshold_DefaultValue = 0;
			Tooltip = Tooltip_DefaultValue = new ChaikinSeriesTooltip();
			...
			Zones = Zones_DefaultValue = new List<ChaikinSeriesZones>();
		...
		/// </summary>
		public ChaikinSeriesAccessibility Accessibility { get; set; }
		private ChaikinSeriesAccessibility Accessibility_DefaultValue { get; set; }
		...
		/// </summary>
		public ChaikinSeriesBoostBlending BoostBlending { get; set; }
		private ChaikinSeriesBoostBlending BoostBlending_DefaultValue { get; set; }
		...
		/// </summary>
		public ChaikinSeriesCompare Compare { get; set; }
		private ChaikinSeriesCompare Compare_DefaultValue { get; set; }
		 

		/// <summary>
		/// When [compare](#plotOptions.series.compare) is `percent`, this optiondictates whether to use 0 or 100 as the base of comparison.
		/// </summary>
		public ChaikinSeriesCompareBase CompareBase { get; set; }
		private ChaikinSeriesCompareBase CompareBase_DefaultValue { get; set; }
		...
		/// </summary>
		public ChaikinSeriesCursor Cursor { get; set; }
		private ChaikinSeriesCursor Cursor_DefaultValue { get; set; }
		...
		/// </summary>
		public ChaikinSeriesDashStyle DashStyle { get; set; }
		private ChaikinSeriesDashStyle DashStyle_DefaultValue { get; set; }
		...
		/// </summary>
		public ChaikinSeriesDataGrouping DataGrouping { get; set; }
		private ChaikinSeriesDataGrouping DataGrouping_DefaultValue { get; set; }
		...
		/// </summary>
		public ChaikinSeriesDataLabels DataLabels { get; set; }
		private ChaikinSeriesDataLabels DataLabels_DefaultValue { get; set; }
		 

		/// <summary>
		/// Options for the series data sorting.
		/// </summary>
		public ChaikinSeriesDataSorting DataSorting { get; set; }
		private ChaikinSeriesDataSorting DataSorting_DefaultValue { get; set; }
		...
		/// 
		/// </summary>
		public ChaikinSeriesDumbell Dumbell { get; set; }
		private ChaikinSeriesDumbell Dumbell_DefaultValue { get; set; }
		...
		/// </summary>
		public ChaikinSeriesEvents Events { get; set; }
		private ChaikinSeriesEvents Events_DefaultValue { get; set; }
		...
		/// </summary>
		public ChaikinSeriesFindNearestPointBy FindNearestPointBy { get; set; }
		private ChaikinSeriesFindNearestPointBy FindNearestPointBy_DefaultValue { get; set; }
		...
		/// </summary>
		public ChaikinSeriesGapUnit GapUnit { get; set; }
		private ChaikinSeriesGapUnit GapUnit_DefaultValue { get; set; }
		...
		/// </summary>
		public ChaikinSeriesLabel Label { get; set; }
		private ChaikinSeriesLabel Label_DefaultValue { get; set; }
		 

		/// <summary>
		/// The line marks the last price from all points.
		/// </summary>
		public ChaikinSeriesLastPrice LastPrice { get; set; }
		private ChaikinSeriesLastPrice LastPrice_DefaultValue { get; set; }
		 

		/// <summary>
		/// The line marks the last price from visible range of points.
		/// </summary>
		public ChaikinSeriesLastVisiblePrice LastVisiblePrice { get; set; }
		private ChaikinSeriesLastVisiblePrice LastVisiblePrice_DefaultValue { get; set; }
		...
		/// </summary>
		public ChaikinSeriesLegendSymbol LegendSymbol { get; set; }
		private ChaikinSeriesLegendSymbol LegendSymbol_DefaultValue { get; set; }
		 

		/// <summary>
		/// The line cap used for line ends and line joins on the graph.
		/// </summary>
		public ChaikinSeriesLinecap Linecap { get; set; }
		private ChaikinSeriesLinecap Linecap_DefaultValue { get; set; }
		...
		/// </summary>
		public ChaikinSeriesMarker Marker { get; set; }
		private ChaikinSeriesMarker Marker_DefaultValue { get; set; }
		...
		/// </summary>
		public ChaikinSeriesOnPoint OnPoint { get; set; }
		private ChaikinSeriesOnPoint OnPoint_DefaultValue { get; set; }
		...
		/// </summary>
		public ChaikinSeriesParams Params { get; set; }
		private ChaikinSeriesParams Params_DefaultValue { get; set; }
		 

		/// <summary>
		/// Properties for each single point.
		/// </summary>
		public ChaikinSeriesPoint Point { get; set; }
		private ChaikinSeriesPoint Point_DefaultValue { get; set; }
		...
		/// </summary>
		public ChaikinSeriesSonification Sonification { get; set; }
		private ChaikinSeriesSonification Sonification_DefaultValue { get; set; }
		...
		/// 
		/// </summary>
		public ChaikinSeriesStates States { get; set; }
		private ChaikinSeriesStates States_DefaultValue { get; set; }
		 

		/// <summary>
		/// Whether to apply steps to the line. Possible values are `left`,`center` and `right`.
		/// </summary>
		public ChaikinSeriesStep Step { get; set; }
		private ChaikinSeriesStep Step_DefaultValue { get; set; }
		...
		/// </summary>
		public ChaikinSeriesTooltip Tooltip { get; set; }
		private ChaikinSeriesTooltip Tooltip_DefaultValue { get; set; }
		...
		/// </summary>
		public List<ChaikinSeriesZones> Zones { get; set; }
		private List<ChaikinSeriesZones> Zones_DefaultValue { get; set; }
