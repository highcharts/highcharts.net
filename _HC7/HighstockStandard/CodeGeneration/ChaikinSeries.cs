...
namespace Highsoft.Web.Mvc.Stocks
{
	public partial class ChaikinSeries  : Series
	{
		public ChaikinSeries()
		{
			...
			DragDrop = DragDrop_DefaultValue = new ChaikinSeriesDragDrop();
		...
		/// </summary>
		public ChaikinSeriesDragDrop DragDrop { get; set; }
		private ChaikinSeriesDragDrop DragDrop_DefaultValue { get; set; }
