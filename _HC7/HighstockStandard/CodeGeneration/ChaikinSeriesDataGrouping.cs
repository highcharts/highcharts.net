...
namespace Highsoft.Web.Mvc.Stocks
{
	public partial class ChaikinSeriesDataGrouping  : BaseObject
	{
		...
		internal override Hashtable ToHashtable()
		{
			...
			if (Approximation != Approximation_DefaultValue) { h.Add("approximation",Approximation); Highstock.AddFunction("ChaikinSeriesDataGroupingApproximation.approximation", Approximation); }  
