...
{
	public partial class ChaikinSeriesLabel  : BaseObject
	{
		public ChaikinSeriesLabel()
		{
			...
			Style = Style_DefaultValue = new ChaikinSeriesLabelStyle();
		...
		/// </summary>
		public ChaikinSeriesLabelStyle Style { get; set; }
		private ChaikinSeriesLabelStyle Style_DefaultValue { get; set; }
