...
{
	public partial class ChaikinSeriesSonificationContextTracks  : BaseObject
	{
		Hashtable h = new Hashtable();

		public ChaikinSeriesSonificationContextTracks()
		{
			ActiveWhen = ActiveWhen_DefaultValue = new ChaikinSeriesSonificationContextTracksActiveWhen();
			Instrument = Instrument_DefaultValue = null;
			InstrumentString = InstrumentString_DefaultValue = "null";
			Mapping = Mapping_DefaultValue = new ChaikinSeriesSonificationContextTracksMapping();
			MidiName = MidiName_DefaultValue = "";
			PointGrouping = PointGrouping_DefaultValue = new ChaikinSeriesSonificationContextTracksPointGrouping();
			...
			Type = Type_DefaultValue = ChaikinSeriesSonificationContextTracksType.Instrument;
			ValueInterval = ValueInterval_DefaultValue = null;
			ValueMapFunction = ValueMapFunction_DefaultValue = ChaikinSeriesSonificationContextTracksValueMapFunction.Linear;
		...
		/// </summary>
		public ChaikinSeriesSonificationContextTracksActiveWhen ActiveWhen { get; set; }
		private ChaikinSeriesSonificationContextTracksActiveWhen ActiveWhen_DefaultValue { get; set; }
		...
		/// </summary>
		public ChaikinSeriesSonificationContextTracksMapping Mapping { get; set; }
		private ChaikinSeriesSonificationContextTracksMapping Mapping_DefaultValue { get; set; }
		...
		/// </summary>
		public ChaikinSeriesSonificationContextTracksPointGrouping PointGrouping { get; set; }
		private ChaikinSeriesSonificationContextTracksPointGrouping PointGrouping_DefaultValue { get; set; }
		...
		/// </summary>
		public ChaikinSeriesSonificationContextTracksType Type { get; set; }
		private ChaikinSeriesSonificationContextTracksType Type_DefaultValue { get; set; }
		...
		/// </summary>
		public ChaikinSeriesSonificationContextTracksValueMapFunction ValueMapFunction { get; set; }
		private ChaikinSeriesSonificationContextTracksValueMapFunction ValueMapFunction_DefaultValue { get; set; }
