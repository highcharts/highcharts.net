...
{
	public partial class ChaikinSeriesSonificationContextTracksMapping  : BaseObject
	{
		Hashtable h = new Hashtable();

		public ChaikinSeriesSonificationContextTracksMapping()
		{
			Frequency = Frequency_DefaultValue = new ChaikinSeriesSonificationContextTracksMappingFrequency();
			GapBetweenNotes = GapBetweenNotes_DefaultValue = new ChaikinSeriesSonificationContextTracksMappingGapBetweenNotes();
			Highpass = Highpass_DefaultValue = new ChaikinSeriesSonificationContextTracksMappingHighpass();
			Lowpass = Lowpass_DefaultValue = new ChaikinSeriesSonificationContextTracksMappingLowpass();
			NoteDuration = NoteDuration_DefaultValue = new ChaikinSeriesSonificationContextTracksMappingNoteDuration();
			Pan = Pan_DefaultValue = new ChaikinSeriesSonificationContextTracksMappingPan();
			Pitch = Pitch_DefaultValue = new ChaikinSeriesSonificationContextTracksMappingPitch();
			PitchString = PitchString_DefaultValue = "null";
			PitchNumber = PitchNumber_DefaultValue = null;
			PlayDelay = PlayDelay_DefaultValue = new ChaikinSeriesSonificationContextTracksMappingPlayDelay();
			Time = Time_DefaultValue = new ChaikinSeriesSonificationContextTracksMappingTime();
			TimeString = TimeString_DefaultValue = "null";
			TimeNumber = TimeNumber_DefaultValue = null;
			Tremolo = Tremolo_DefaultValue = new ChaikinSeriesSonificationContextTracksMappingTremolo();
			Volume = Volume_DefaultValue = new ChaikinSeriesSonificationContextTracksMappingVolume();
		...
		/// </summary>
		public ChaikinSeriesSonificationContextTracksMappingFrequency Frequency { get; set; }
		private ChaikinSeriesSonificationContextTracksMappingFrequency Frequency_DefaultValue { get; set; }
		...
		/// </summary>
		public ChaikinSeriesSonificationContextTracksMappingGapBetweenNotes GapBetweenNotes { get; set; }
		private ChaikinSeriesSonificationContextTracksMappingGapBetweenNotes GapBetweenNotes_DefaultValue { get; set; }
		...
		/// </summary>
		public ChaikinSeriesSonificationContextTracksMappingHighpass Highpass { get; set; }
		private ChaikinSeriesSonificationContextTracksMappingHighpass Highpass_DefaultValue { get; set; }
		...
		/// </summary>
		public ChaikinSeriesSonificationContextTracksMappingLowpass Lowpass { get; set; }
		private ChaikinSeriesSonificationContextTracksMappingLowpass Lowpass_DefaultValue { get; set; }
		...
		/// </summary>
		public ChaikinSeriesSonificationContextTracksMappingNoteDuration NoteDuration { get; set; }
		private ChaikinSeriesSonificationContextTracksMappingNoteDuration NoteDuration_DefaultValue { get; set; }
		...
		/// </summary>
		public ChaikinSeriesSonificationContextTracksMappingPan Pan { get; set; }
		private ChaikinSeriesSonificationContextTracksMappingPan Pan_DefaultValue { get; set; }
		...
		/// </summary>
		public ChaikinSeriesSonificationContextTracksMappingPitch Pitch { get; set; }
		private ChaikinSeriesSonificationContextTracksMappingPitch Pitch_DefaultValue { get; set; }
		...
		/// </summary>
		public ChaikinSeriesSonificationContextTracksMappingPlayDelay PlayDelay { get; set; }
		private ChaikinSeriesSonificationContextTracksMappingPlayDelay PlayDelay_DefaultValue { get; set; }
		...
		/// </summary>
		public ChaikinSeriesSonificationContextTracksMappingTime Time { get; set; }
		private ChaikinSeriesSonificationContextTracksMappingTime Time_DefaultValue { get; set; }
		...
		/// </summary>
		public ChaikinSeriesSonificationContextTracksMappingTremolo Tremolo { get; set; }
		private ChaikinSeriesSonificationContextTracksMappingTremolo Tremolo_DefaultValue { get; set; }
		 

		/// <summary>
		/// The volume of notes, from 0 to 1.
		/// </summary>
		public ChaikinSeriesSonificationContextTracksMappingVolume Volume { get; set; }
		private ChaikinSeriesSonificationContextTracksMappingVolume Volume_DefaultValue { get; set; }
