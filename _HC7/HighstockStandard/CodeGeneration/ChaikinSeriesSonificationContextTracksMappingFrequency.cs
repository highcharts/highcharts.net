...
{
	public partial class ChaikinSeriesSonificationContextTracksMappingFrequency  : BaseObject
	{
		Hashtable h = new Hashtable();

		public ChaikinSeriesSonificationContextTracksMappingFrequency()
		{
			MapFunction = MapFunction_DefaultValue = ChaikinSeriesSonificationContextTracksMappingFrequencyMapFunction.Linear;
			MapTo = MapTo_DefaultValue = "";
			Max = Max_DefaultValue = null;
			Min = Min_DefaultValue = null;
			Value = Value_DefaultValue = null;
			Within = Within_DefaultValue = ChaikinSeriesSonificationContextTracksMappingFrequencyWithin.Chart;
		...
		/// </summary>
		public ChaikinSeriesSonificationContextTracksMappingFrequencyMapFunction MapFunction { get; set; }
		private ChaikinSeriesSonificationContextTracksMappingFrequencyMapFunction MapFunction_DefaultValue { get; set; }
		...
		/// </summary>
		public ChaikinSeriesSonificationContextTracksMappingFrequencyWithin Within { get; set; }
		private ChaikinSeriesSonificationContextTracksMappingFrequencyWithin Within_DefaultValue { get; set; }
