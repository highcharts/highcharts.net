...
{
	public partial class ChaikinSeriesSonificationContextTracksMappingPan  : BaseObject
	{
		Hashtable h = new Hashtable();

		public ChaikinSeriesSonificationContextTracksMappingPan()
		{
			MapFunction = MapFunction_DefaultValue = ChaikinSeriesSonificationContextTracksMappingPanMapFunction.Linear;
			MapTo = MapTo_DefaultValue = "";
			Max = Max_DefaultValue = null;
			Min = Min_DefaultValue = null;
			Value = Value_DefaultValue = null;
			Within = Within_DefaultValue = ChaikinSeriesSonificationContextTracksMappingPanWithin.Chart;
		...
		/// </summary>
		public ChaikinSeriesSonificationContextTracksMappingPanMapFunction MapFunction { get; set; }
		private ChaikinSeriesSonificationContextTracksMappingPanMapFunction MapFunction_DefaultValue { get; set; }
		...
		/// </summary>
		public ChaikinSeriesSonificationContextTracksMappingPanWithin Within { get; set; }
		private ChaikinSeriesSonificationContextTracksMappingPanWithin Within_DefaultValue { get; set; }
