...
{
	public partial class ChaikinSeriesSonificationContextTracksMappingTime  : BaseObject
	{
		Hashtable h = new Hashtable();

		public ChaikinSeriesSonificationContextTracksMappingTime()
		{
			MapFunction = MapFunction_DefaultValue = ChaikinSeriesSonificationContextTracksMappingTimeMapFunction.Linear;
			MapTo = MapTo_DefaultValue = "";
			Max = Max_DefaultValue = null;
			Min = Min_DefaultValue = null;
			Value = Value_DefaultValue = null;
			Within = Within_DefaultValue = ChaikinSeriesSonificationContextTracksMappingTimeWithin.Chart;
		...
		/// </summary>
		public ChaikinSeriesSonificationContextTracksMappingTimeMapFunction MapFunction { get; set; }
		private ChaikinSeriesSonificationContextTracksMappingTimeMapFunction MapFunction_DefaultValue { get; set; }
		...
		/// </summary>
		public ChaikinSeriesSonificationContextTracksMappingTimeWithin Within { get; set; }
		private ChaikinSeriesSonificationContextTracksMappingTimeWithin Within_DefaultValue { get; set; }
