...
{
	public partial class ChaikinSeriesSonificationContextTracksPointGrouping  : BaseObject
	{
		Hashtable h = new Hashtable();

		public ChaikinSeriesSonificationContextTracksPointGrouping()
		{
			Algorithm = Algorithm_DefaultValue = ChaikinSeriesSonificationContextTracksPointGroupingAlgorithm.Minimax;
		...
		/// </summary>
		public ChaikinSeriesSonificationContextTracksPointGroupingAlgorithm Algorithm { get; set; }
		private ChaikinSeriesSonificationContextTracksPointGroupingAlgorithm Algorithm_DefaultValue { get; set; }
