...
{
	public partial class ChaikinSeriesSonificationDefaultSpeechOptions  : BaseObject
	{
		Hashtable h = new Hashtable();

		public ChaikinSeriesSonificationDefaultSpeechOptions()
		{
			ActiveWhen = ActiveWhen_DefaultValue = new ChaikinSeriesSonificationDefaultSpeechOptionsActiveWhen();
			Language = Language_DefaultValue = "en-US";
			Mapping = Mapping_DefaultValue = new ChaikinSeriesSonificationDefaultSpeechOptionsMapping();
			PointGrouping = PointGrouping_DefaultValue = new ChaikinSeriesSonificationDefaultSpeechOptionsPointGrouping();
			PreferredVoice = PreferredVoice_DefaultValue = "";
			ShowPlayMarker = ShowPlayMarker_DefaultValue = true;
			Type = Type_DefaultValue = ChaikinSeriesSonificationDefaultSpeechOptionsType.Instrument;
		...
		/// </summary>
		public ChaikinSeriesSonificationDefaultSpeechOptionsActiveWhen ActiveWhen { get; set; }
		private ChaikinSeriesSonificationDefaultSpeechOptionsActiveWhen ActiveWhen_DefaultValue { get; set; }
		...
		/// </summary>
		public ChaikinSeriesSonificationDefaultSpeechOptionsMapping Mapping { get; set; }
		private ChaikinSeriesSonificationDefaultSpeechOptionsMapping Mapping_DefaultValue { get; set; }
		 

		/// <summary>
		/// Options for point grouping, specifically for instrument tracks.
		/// </summary>
		public ChaikinSeriesSonificationDefaultSpeechOptionsPointGrouping PointGrouping { get; set; }
		private ChaikinSeriesSonificationDefaultSpeechOptionsPointGrouping PointGrouping_DefaultValue { get; set; }
		...
		/// </summary>
		public ChaikinSeriesSonificationDefaultSpeechOptionsType Type { get; set; }
		private ChaikinSeriesSonificationDefaultSpeechOptionsType Type_DefaultValue { get; set; }
