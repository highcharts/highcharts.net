...
{
	public partial class ChaikinSeriesSonificationDefaultSpeechOptionsMapping  : BaseObject
	{
		Hashtable h = new Hashtable();

		public ChaikinSeriesSonificationDefaultSpeechOptionsMapping()
		{
			Frequency = Frequency_DefaultValue = new ChaikinSeriesSonificationDefaultSpeechOptionsMappingFrequency();
			GapBetweenNotes = GapBetweenNotes_DefaultValue = new ChaikinSeriesSonificationDefaultSpeechOptionsMappingGapBetweenNotes();
			Highpass = Highpass_DefaultValue = new ChaikinSeriesSonificationDefaultSpeechOptionsMappingHighpass();
			Lowpass = Lowpass_DefaultValue = new ChaikinSeriesSonificationDefaultSpeechOptionsMappingLowpass();
			NoteDuration = NoteDuration_DefaultValue = new ChaikinSeriesSonificationDefaultSpeechOptionsMappingNoteDuration();
			Pan = Pan_DefaultValue = new ChaikinSeriesSonificationDefaultSpeechOptionsMappingPan();
			Pitch = Pitch_DefaultValue = new ChaikinSeriesSonificationDefaultSpeechOptionsMappingPitch();
			PitchString = PitchString_DefaultValue = "null";
			PitchNumber = PitchNumber_DefaultValue = null;
			PlayDelay = PlayDelay_DefaultValue = new ChaikinSeriesSonificationDefaultSpeechOptionsMappingPlayDelay();
			Time = Time_DefaultValue = new ChaikinSeriesSonificationDefaultSpeechOptionsMappingTime();
			TimeString = TimeString_DefaultValue = "null";
			TimeNumber = TimeNumber_DefaultValue = null;
			Tremolo = Tremolo_DefaultValue = new ChaikinSeriesSonificationDefaultSpeechOptionsMappingTremolo();
			Volume = Volume_DefaultValue = new ChaikinSeriesSonificationDefaultSpeechOptionsMappingVolume();
		...
		/// </summary>
		public ChaikinSeriesSonificationDefaultSpeechOptionsMappingFrequency Frequency { get; set; }
		private ChaikinSeriesSonificationDefaultSpeechOptionsMappingFrequency Frequency_DefaultValue { get; set; }
		...
		/// </summary>
		public ChaikinSeriesSonificationDefaultSpeechOptionsMappingGapBetweenNotes GapBetweenNotes { get; set; }
		private ChaikinSeriesSonificationDefaultSpeechOptionsMappingGapBetweenNotes GapBetweenNotes_DefaultValue { get; set; }
		...
		/// </summary>
		public ChaikinSeriesSonificationDefaultSpeechOptionsMappingHighpass Highpass { get; set; }
		private ChaikinSeriesSonificationDefaultSpeechOptionsMappingHighpass Highpass_DefaultValue { get; set; }
		...
		/// </summary>
		public ChaikinSeriesSonificationDefaultSpeechOptionsMappingLowpass Lowpass { get; set; }
		private ChaikinSeriesSonificationDefaultSpeechOptionsMappingLowpass Lowpass_DefaultValue { get; set; }
		...
		/// </summary>
		public ChaikinSeriesSonificationDefaultSpeechOptionsMappingNoteDuration NoteDuration { get; set; }
		private ChaikinSeriesSonificationDefaultSpeechOptionsMappingNoteDuration NoteDuration_DefaultValue { get; set; }
		...
		/// </summary>
		public ChaikinSeriesSonificationDefaultSpeechOptionsMappingPan Pan { get; set; }
		private ChaikinSeriesSonificationDefaultSpeechOptionsMappingPan Pan_DefaultValue { get; set; }
		...
		/// </summary>
		public ChaikinSeriesSonificationDefaultSpeechOptionsMappingPitch Pitch { get; set; }
		private ChaikinSeriesSonificationDefaultSpeechOptionsMappingPitch Pitch_DefaultValue { get; set; }
		...
		/// </summary>
		public ChaikinSeriesSonificationDefaultSpeechOptionsMappingPlayDelay PlayDelay { get; set; }
		private ChaikinSeriesSonificationDefaultSpeechOptionsMappingPlayDelay PlayDelay_DefaultValue { get; set; }
		...
		/// </summary>
		public ChaikinSeriesSonificationDefaultSpeechOptionsMappingTime Time { get; set; }
		private ChaikinSeriesSonificationDefaultSpeechOptionsMappingTime Time_DefaultValue { get; set; }
		...
		/// </summary>
		public ChaikinSeriesSonificationDefaultSpeechOptionsMappingTremolo Tremolo { get; set; }
		private ChaikinSeriesSonificationDefaultSpeechOptionsMappingTremolo Tremolo_DefaultValue { get; set; }
		 

		/// <summary>
		/// The volume of notes, from 0 to 1.
		/// </summary>
		public ChaikinSeriesSonificationDefaultSpeechOptionsMappingVolume Volume { get; set; }
		private ChaikinSeriesSonificationDefaultSpeechOptionsMappingVolume Volume_DefaultValue { get; set; }
