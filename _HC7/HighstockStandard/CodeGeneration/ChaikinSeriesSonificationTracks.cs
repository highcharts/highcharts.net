...
{
	public partial class ChaikinSeriesSonificationTracks  : BaseObject
	{
		Hashtable h = new Hashtable();

		public ChaikinSeriesSonificationTracks()
		{
			ActiveWhen = ActiveWhen_DefaultValue = new ChaikinSeriesSonificationTracksActiveWhen();
			Instrument = Instrument_DefaultValue = null;
			InstrumentString = InstrumentString_DefaultValue = "null";
			Mapping = Mapping_DefaultValue = new ChaikinSeriesSonificationTracksMapping();
			MidiName = MidiName_DefaultValue = "";
			PointGrouping = PointGrouping_DefaultValue = new ChaikinSeriesSonificationTracksPointGrouping();
			RoundToMusicalNotes = RoundToMusicalNotes_DefaultValue = true;
			ShowPlayMarker = ShowPlayMarker_DefaultValue = true;
			Type = Type_DefaultValue = ChaikinSeriesSonificationTracksType.Instrument;
		...
		/// </summary>
		public ChaikinSeriesSonificationTracksActiveWhen ActiveWhen { get; set; }
		private ChaikinSeriesSonificationTracksActiveWhen ActiveWhen_DefaultValue { get; set; }
		...
		/// </summary>
		public ChaikinSeriesSonificationTracksMapping Mapping { get; set; }
		private ChaikinSeriesSonificationTracksMapping Mapping_DefaultValue { get; set; }
		...
		/// </summary>
		public ChaikinSeriesSonificationTracksPointGrouping PointGrouping { get; set; }
		private ChaikinSeriesSonificationTracksPointGrouping PointGrouping_DefaultValue { get; set; }
		...
		/// </summary>
		public ChaikinSeriesSonificationTracksType Type { get; set; }
		private ChaikinSeriesSonificationTracksType Type_DefaultValue { get; set; }
