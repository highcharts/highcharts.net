...
{
	public partial class ChaikinSeriesSonificationTracksMappingFrequency  : BaseObject
	{
		Hashtable h = new Hashtable();

		public ChaikinSeriesSonificationTracksMappingFrequency()
		{
			MapFunction = MapFunction_DefaultValue = ChaikinSeriesSonificationTracksMappingFrequencyMapFunction.Linear;
			MapTo = MapTo_DefaultValue = "";
			Max = Max_DefaultValue = null;
			Min = Min_DefaultValue = null;
			Value = Value_DefaultValue = null;
			Within = Within_DefaultValue = ChaikinSeriesSonificationTracksMappingFrequencyWithin.Chart;
		...
		/// </summary>
		public ChaikinSeriesSonificationTracksMappingFrequencyMapFunction MapFunction { get; set; }
		private ChaikinSeriesSonificationTracksMappingFrequencyMapFunction MapFunction_DefaultValue { get; set; }
		...
		/// </summary>
		public ChaikinSeriesSonificationTracksMappingFrequencyWithin Within { get; set; }
		private ChaikinSeriesSonificationTracksMappingFrequencyWithin Within_DefaultValue { get; set; }
