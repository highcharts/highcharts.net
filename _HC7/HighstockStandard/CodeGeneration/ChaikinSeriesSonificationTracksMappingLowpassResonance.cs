...
{
	public partial class ChaikinSeriesSonificationTracksMappingLowpassResonance  : BaseObject
	{
		Hashtable h = new Hashtable();

		public ChaikinSeriesSonificationTracksMappingLowpassResonance()
		{
			MapFunction = MapFunction_DefaultValue = ChaikinSeriesSonificationTracksMappingLowpassResonanceMapFunction.Linear;
			MapTo = MapTo_DefaultValue = "";
			Max = Max_DefaultValue = null;
			Min = Min_DefaultValue = null;
			Value = Value_DefaultValue = null;
			Within = Within_DefaultValue = ChaikinSeriesSonificationTracksMappingLowpassResonanceWithin.Chart;
		...
		/// </summary>
		public ChaikinSeriesSonificationTracksMappingLowpassResonanceMapFunction MapFunction { get; set; }
		private ChaikinSeriesSonificationTracksMappingLowpassResonanceMapFunction MapFunction_DefaultValue { get; set; }
		...
		/// </summary>
		public ChaikinSeriesSonificationTracksMappingLowpassResonanceWithin Within { get; set; }
		private ChaikinSeriesSonificationTracksMappingLowpassResonanceWithin Within_DefaultValue { get; set; }
