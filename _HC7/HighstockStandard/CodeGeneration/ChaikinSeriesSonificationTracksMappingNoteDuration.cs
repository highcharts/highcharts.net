...
{
	public partial class ChaikinSeriesSonificationTracksMappingNoteDuration  : BaseObject
	{
		Hashtable h = new Hashtable();

		public ChaikinSeriesSonificationTracksMappingNoteDuration()
		{
			MapFunction = MapFunction_DefaultValue = ChaikinSeriesSonificationTracksMappingNoteDurationMapFunction.Linear;
			MapTo = MapTo_DefaultValue = "";
			Max = Max_DefaultValue = null;
			Min = Min_DefaultValue = null;
			Value = Value_DefaultValue = null;
			Within = Within_DefaultValue = ChaikinSeriesSonificationTracksMappingNoteDurationWithin.Chart;
		...
		/// </summary>
		public ChaikinSeriesSonificationTracksMappingNoteDurationMapFunction MapFunction { get; set; }
		private ChaikinSeriesSonificationTracksMappingNoteDurationMapFunction MapFunction_DefaultValue { get; set; }
		...
		/// </summary>
		public ChaikinSeriesSonificationTracksMappingNoteDurationWithin Within { get; set; }
		private ChaikinSeriesSonificationTracksMappingNoteDurationWithin Within_DefaultValue { get; set; }
