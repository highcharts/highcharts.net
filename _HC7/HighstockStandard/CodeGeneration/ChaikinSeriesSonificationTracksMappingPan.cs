...
{
	public partial class ChaikinSeriesSonificationTracksMappingPan  : BaseObject
	{
		Hashtable h = new Hashtable();

		public ChaikinSeriesSonificationTracksMappingPan()
		{
			MapFunction = MapFunction_DefaultValue = ChaikinSeriesSonificationTracksMappingPanMapFunction.Linear;
			MapTo = MapTo_DefaultValue = "";
			Max = Max_DefaultValue = null;
			Min = Min_DefaultValue = null;
			Value = Value_DefaultValue = null;
			Within = Within_DefaultValue = ChaikinSeriesSonificationTracksMappingPanWithin.Chart;
		...
		/// </summary>
		public ChaikinSeriesSonificationTracksMappingPanMapFunction MapFunction { get; set; }
		private ChaikinSeriesSonificationTracksMappingPanMapFunction MapFunction_DefaultValue { get; set; }
		...
		/// </summary>
		public ChaikinSeriesSonificationTracksMappingPanWithin Within { get; set; }
		private ChaikinSeriesSonificationTracksMappingPanWithin Within_DefaultValue { get; set; }
