...
{
	public partial class ChaikinSeriesSonificationTracksMappingPitch  : BaseObject
	{
		Hashtable h = new Hashtable();

		public ChaikinSeriesSonificationTracksMappingPitch()
		{
			MapFunction = MapFunction_DefaultValue = ChaikinSeriesSonificationTracksMappingPitchMapFunction.Linear;
		...
		/// </summary>
		public ChaikinSeriesSonificationTracksMappingPitchMapFunction MapFunction { get; set; }
		private ChaikinSeriesSonificationTracksMappingPitchMapFunction MapFunction_DefaultValue { get; set; }
