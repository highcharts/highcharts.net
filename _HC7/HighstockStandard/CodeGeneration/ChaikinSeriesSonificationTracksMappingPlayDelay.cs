...
{
	public partial class ChaikinSeriesSonificationTracksMappingPlayDelay  : BaseObject
	{
		Hashtable h = new Hashtable();

		public ChaikinSeriesSonificationTracksMappingPlayDelay()
		{
			MapFunction = MapFunction_DefaultValue = ChaikinSeriesSonificationTracksMappingPlayDelayMapFunction.Linear;
			MapTo = MapTo_DefaultValue = "";
			Max = Max_DefaultValue = null;
			Min = Min_DefaultValue = null;
			Value = Value_DefaultValue = null;
			Within = Within_DefaultValue = ChaikinSeriesSonificationTracksMappingPlayDelayWithin.Chart;
		...
		/// </summary>
		public ChaikinSeriesSonificationTracksMappingPlayDelayMapFunction MapFunction { get; set; }
		private ChaikinSeriesSonificationTracksMappingPlayDelayMapFunction MapFunction_DefaultValue { get; set; }
		...
		/// </summary>
		public ChaikinSeriesSonificationTracksMappingPlayDelayWithin Within { get; set; }
		private ChaikinSeriesSonificationTracksMappingPlayDelayWithin Within_DefaultValue { get; set; }
