...
{
	public partial class ChaikinSeriesSonificationTracksMappingTime  : BaseObject
	{
		Hashtable h = new Hashtable();

		public ChaikinSeriesSonificationTracksMappingTime()
		{
			MapFunction = MapFunction_DefaultValue = ChaikinSeriesSonificationTracksMappingTimeMapFunction.Linear;
			MapTo = MapTo_DefaultValue = "";
			Max = Max_DefaultValue = null;
			Min = Min_DefaultValue = null;
			Value = Value_DefaultValue = null;
			Within = Within_DefaultValue = ChaikinSeriesSonificationTracksMappingTimeWithin.Chart;
		...
		/// </summary>
		public ChaikinSeriesSonificationTracksMappingTimeMapFunction MapFunction { get; set; }
		private ChaikinSeriesSonificationTracksMappingTimeMapFunction MapFunction_DefaultValue { get; set; }
		...
		/// </summary>
		public ChaikinSeriesSonificationTracksMappingTimeWithin Within { get; set; }
		private ChaikinSeriesSonificationTracksMappingTimeWithin Within_DefaultValue { get; set; }
