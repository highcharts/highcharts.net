...
{
	public partial class ChaikinSeriesTooltip  : BaseObject
	{
		public ChaikinSeriesTooltip()
		{
			...
			HeaderShape = HeaderShape_DefaultValue = ChaikinSeriesTooltipHeaderShape.Callout;
		...
		/// </summary>
		public ChaikinSeriesTooltipHeaderShape HeaderShape { get; set; }
		private ChaikinSeriesTooltipHeaderShape HeaderShape_DefaultValue { get; set; }
		...
		internal override Hashtable ToHashtable()
		{
			...
			if (NullFormatter != NullFormatter_DefaultValue) { h.Add("nullFormatter",NullFormatter); Highstock.AddFunction("ChaikinSeriesTooltipNullFormatter.nullFormatter", NullFormatter); }  
			if (Outside != Outside_DefaultValue) h.Add("outside",Outside);
			if (Padding != Padding_DefaultValue) h.Add("padding",Padding);
			if (PointFormat != PointFormat_DefaultValue) h.Add("pointFormat",PointFormat);
			if (PointFormatter != PointFormatter_DefaultValue) { h.Add("pointFormatter",PointFormatter); Highstock.AddFunction("ChaikinSeriesTooltipPointFormatter.pointFormatter", PointFormatter); }  
