...
namespace Highsoft.Web.Mvc.Stocks
{
	public partial class Chart  : BaseObject
	{
		...
		internal override Hashtable ToHashtable(Highstock highstock)
		{
			...
			if (NumberFormatter != null) { h.Add("numberFormatter",NumberFormatter); highstock.AddFunction("numberFormatter", NumberFormatter); }  
			if (Panning != null) h.Add("panning",Panning.ToHashtable(highstock));
			if (PinchType != ChartPinchType.Null) h.Add("pinchType", highstock.FirstCharacterToLower(PinchType.ToString()));
			...
			if (PlotShadow != null) h.Add("plotShadow",PlotShadow.ToHashtable(highstock));
			...
			if (ResetZoomButton != null) h.Add("resetZoomButton",ResetZoomButton.ToHashtable(highstock));
			...
			if (Type != ChartType.Null) h.Add("type", highstock.FirstCharacterToLower(Type.ToString()));
			if (Width != null) h.Add("width",Width);
			if (WidthNumber != null) h.Add("width",WidthNumber);
			if (Zooming != null) h.Add("zooming",Zooming.ToHashtable(highstock));
			if (ZoomKey != ChartZoomKey.Null) h.Add("zoomKey", highstock.FirstCharacterToLower(ZoomKey.ToString()));
			if (ZoomType != ChartZoomType.Null) h.Add("zoomType", highstock.FirstCharacterToLower(ZoomType.ToString()));
