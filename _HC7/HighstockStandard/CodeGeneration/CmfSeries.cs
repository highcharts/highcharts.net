...
{
	public partial class CmfSeries  : Series
	{
		Hashtable h = new Hashtable();

		public CmfSeries()
		{
			Accessibility = Accessibility_DefaultValue = new CmfSeriesAccessibility();
			AllowPointSelect = AllowPointSelect_DefaultValue = false;
			Animation = Animation_DefaultValue = new Animation() { Enabled = true };
			AnimationBool = AnimationBool_DefaultValue = true;
			BoostBlending = BoostBlending_DefaultValue = CmfSeriesBoostBlending.Undefined;
			...
			Compare = Compare_DefaultValue = CmfSeriesCompare.Percent;
			CompareBase = CompareBase_DefaultValue = CmfSeriesCompareBase.Min;
			...
			DashStyle = DashStyle_DefaultValue = CmfSeriesDashStyle.Null;
			...
			DataSorting = DataSorting_DefaultValue = new CmfSeriesDataSorting();
			Description = Description_DefaultValue = "";
			Dumbell = Dumbell_DefaultValue = new CmfSeriesDumbell();
			EnableMouseTracking = EnableMouseTracking_DefaultValue = true;
			Events = Events_DefaultValue = new CmfSeriesEvents();
			FindNearestPointBy = FindNearestPointBy_DefaultValue = CmfSeriesFindNearestPointBy.X;
			GapSize = GapSize_DefaultValue = 0;
			GapUnit = GapUnit_DefaultValue = CmfSeriesGapUnit.Relative;
			...
			LegendSymbol = LegendSymbol_DefaultValue = CmfSeriesLegendSymbol.Rectangle;
			Linecap = Linecap_DefaultValue = CmfSeriesLinecap.Round;
			LineWidth = LineWidth_DefaultValue = 2;
			LinkedTo = LinkedTo_DefaultValue = "";
			Marker = Marker_DefaultValue = new CmfSeriesMarker();
			Name = Name_DefaultValue = "";
			NegativeColor = NegativeColor_DefaultValue = "";
			OnPoint = OnPoint_DefaultValue = new CmfSeriesOnPoint();
			Opacity = Opacity_DefaultValue = 1;
			Params = Params_DefaultValue = new CmfSeriesParams();
			Point = Point_DefaultValue = new CmfSeriesPoint();
			...
			Sonification = Sonification_DefaultValue = new CmfSeriesSonification();
			Stack = Stack_DefaultValue = "";
			StackNumber = StackNumber_DefaultValue = null;
			States = States_DefaultValue = new CmfSeriesStates();
			Step = Step_DefaultValue = CmfSeriesStep.Null;
			StickyTracking = StickyTracking_DefaultValue = true;
			Threshold = Threshold_DefaultValue = 0;
			Tooltip = Tooltip_DefaultValue = new CmfSeriesTooltip();
			...
			Zones = Zones_DefaultValue = new List<CmfSeriesZones>();
		...
		/// </summary>
		public CmfSeriesAccessibility Accessibility { get; set; }
		private CmfSeriesAccessibility Accessibility_DefaultValue { get; set; }
		...
		/// </summary>
		public CmfSeriesBoostBlending BoostBlending { get; set; }
		private CmfSeriesBoostBlending BoostBlending_DefaultValue { get; set; }
		...
		/// </summary>
		public CmfSeriesCompare Compare { get; set; }
		private CmfSeriesCompare Compare_DefaultValue { get; set; }
		 

		/// <summary>
		/// When [compare](#plotOptions.series.compare) is `percent`, this optiondictates whether to use 0 or 100 as the base of comparison.
		/// </summary>
		public CmfSeriesCompareBase CompareBase { get; set; }
		private CmfSeriesCompareBase CompareBase_DefaultValue { get; set; }
		...
		/// </summary>
		public CmfSeriesCursor Cursor { get; set; }
		private CmfSeriesCursor Cursor_DefaultValue { get; set; }
		...
		/// </summary>
		public CmfSeriesDashStyle DashStyle { get; set; }
		private CmfSeriesDashStyle DashStyle_DefaultValue { get; set; }
		...
		/// </summary>
		public CmfSeriesDataLabels DataLabels { get; set; }
		private CmfSeriesDataLabels DataLabels_DefaultValue { get; set; }
		 

		/// <summary>
		/// Options for the series data sorting.
		/// </summary>
		public CmfSeriesDataSorting DataSorting { get; set; }
		private CmfSeriesDataSorting DataSorting_DefaultValue { get; set; }
		...
		/// 
		/// </summary>
		public CmfSeriesDumbell Dumbell { get; set; }
		private CmfSeriesDumbell Dumbell_DefaultValue { get; set; }
		...
		/// </summary>
		public CmfSeriesEvents Events { get; set; }
		private CmfSeriesEvents Events_DefaultValue { get; set; }
		...
		/// </summary>
		public CmfSeriesFindNearestPointBy FindNearestPointBy { get; set; }
		private CmfSeriesFindNearestPointBy FindNearestPointBy_DefaultValue { get; set; }
		...
		/// </summary>
		public CmfSeriesGapUnit GapUnit { get; set; }
		private CmfSeriesGapUnit GapUnit_DefaultValue { get; set; }
		...
		/// </summary>
		public CmfSeriesLabel Label { get; set; }
		private CmfSeriesLabel Label_DefaultValue { get; set; }
		...
		/// </summary>
		public CmfSeriesLegendSymbol LegendSymbol { get; set; }
		private CmfSeriesLegendSymbol LegendSymbol_DefaultValue { get; set; }
		 

		/// <summary>
		/// The line cap used for line ends and line joins on the graph.
		/// </summary>
		public CmfSeriesLinecap Linecap { get; set; }
		private CmfSeriesLinecap Linecap_DefaultValue { get; set; }
		...
		/// </summary>
		public CmfSeriesMarker Marker { get; set; }
		private CmfSeriesMarker Marker_DefaultValue { get; set; }
		...
		/// </summary>
		public CmfSeriesOnPoint OnPoint { get; set; }
		private CmfSeriesOnPoint OnPoint_DefaultValue { get; set; }
		...
		/// </summary>
		public CmfSeriesPoint Point { get; set; }
		private CmfSeriesPoint Point_DefaultValue { get; set; }
		...
		/// </summary>
		public CmfSeriesSonification Sonification { get; set; }
		private CmfSeriesSonification Sonification_DefaultValue { get; set; }
		...
		/// 
		/// </summary>
		public CmfSeriesStates States { get; set; }
		private CmfSeriesStates States_DefaultValue { get; set; }
		 

		/// <summary>
		/// Whether to apply steps to the line. Possible values are `left`,`center` and `right`.
		/// </summary>
		public CmfSeriesStep Step { get; set; }
		private CmfSeriesStep Step_DefaultValue { get; set; }
		...
		/// </summary>
		public CmfSeriesTooltip Tooltip { get; set; }
		private CmfSeriesTooltip Tooltip_DefaultValue { get; set; }
		...
		/// </summary>
		public List<CmfSeriesZones> Zones { get; set; }
		private List<CmfSeriesZones> Zones_DefaultValue { get; set; }
