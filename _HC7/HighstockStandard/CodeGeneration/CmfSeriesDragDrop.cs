...
{
	public partial class CmfSeriesDragDrop  : BaseObject
	{
		public CmfSeriesDragDrop()
		{
			DraggableX = DraggableX_DefaultValue = null;
			DraggableY = DraggableY_DefaultValue = null;
			DragHandle = DragHandle_DefaultValue = new CmfSeriesDragDropDragHandle();
			...
			GuideBox = GuideBox_DefaultValue = new CmfSeriesDragDropGuideBox();
		...
		/// </summary>
		public CmfSeriesDragDropDragHandle DragHandle { get; set; }
		private CmfSeriesDragDropDragHandle DragHandle_DefaultValue { get; set; }
		...
		/// </summary>
		public CmfSeriesDragDropGuideBox GuideBox { get; set; }
		private CmfSeriesDragDropGuideBox GuideBox_DefaultValue { get; set; }
