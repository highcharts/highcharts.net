...
namespace Highsoft.Web.Mvc.Stocks
{
	public partial class CmfSeriesMarkerStates  : BaseObject
	{
		public CmfSeriesMarkerStates()
		{
			...
			Inactive = Inactive_DefaultValue = new CmfSeriesMarkerStatesInactive();
		...
		/// 
		/// </summary>
		public CmfSeriesMarkerStatesInactive Inactive { get; set; }
		private CmfSeriesMarkerStatesInactive Inactive_DefaultValue { get; set; }
