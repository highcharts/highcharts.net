...
{
	public partial class CmfSeriesSonificationContextTracks  : BaseObject
	{
		Hashtable h = new Hashtable();

		public CmfSeriesSonificationContextTracks()
		{
			ActiveWhen = ActiveWhen_DefaultValue = new CmfSeriesSonificationContextTracksActiveWhen();
			Instrument = Instrument_DefaultValue = null;
			InstrumentString = InstrumentString_DefaultValue = "null";
			Mapping = Mapping_DefaultValue = new CmfSeriesSonificationContextTracksMapping();
			MidiName = MidiName_DefaultValue = "";
			PointGrouping = PointGrouping_DefaultValue = new CmfSeriesSonificationContextTracksPointGrouping();
			...
			Type = Type_DefaultValue = CmfSeriesSonificationContextTracksType.Instrument;
			ValueInterval = ValueInterval_DefaultValue = null;
			ValueMapFunction = ValueMapFunction_DefaultValue = CmfSeriesSonificationContextTracksValueMapFunction.Linear;
		...
		/// </summary>
		public CmfSeriesSonificationContextTracksActiveWhen ActiveWhen { get; set; }
		private CmfSeriesSonificationContextTracksActiveWhen ActiveWhen_DefaultValue { get; set; }
		...
		/// </summary>
		public CmfSeriesSonificationContextTracksMapping Mapping { get; set; }
		private CmfSeriesSonificationContextTracksMapping Mapping_DefaultValue { get; set; }
		...
		/// </summary>
		public CmfSeriesSonificationContextTracksPointGrouping PointGrouping { get; set; }
		private CmfSeriesSonificationContextTracksPointGrouping PointGrouping_DefaultValue { get; set; }
		...
		/// </summary>
		public CmfSeriesSonificationContextTracksType Type { get; set; }
		private CmfSeriesSonificationContextTracksType Type_DefaultValue { get; set; }
		...
		/// </summary>
		public CmfSeriesSonificationContextTracksValueMapFunction ValueMapFunction { get; set; }
		private CmfSeriesSonificationContextTracksValueMapFunction ValueMapFunction_DefaultValue { get; set; }
