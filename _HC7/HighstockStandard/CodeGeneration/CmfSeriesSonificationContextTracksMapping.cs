...
{
	public partial class CmfSeriesSonificationContextTracksMapping  : BaseObject
	{
		Hashtable h = new Hashtable();

		public CmfSeriesSonificationContextTracksMapping()
		{
			Frequency = Frequency_DefaultValue = new CmfSeriesSonificationContextTracksMappingFrequency();
			GapBetweenNotes = GapBetweenNotes_DefaultValue = new CmfSeriesSonificationContextTracksMappingGapBetweenNotes();
			Highpass = Highpass_DefaultValue = new CmfSeriesSonificationContextTracksMappingHighpass();
			Lowpass = Lowpass_DefaultValue = new CmfSeriesSonificationContextTracksMappingLowpass();
			NoteDuration = NoteDuration_DefaultValue = new CmfSeriesSonificationContextTracksMappingNoteDuration();
			Pan = Pan_DefaultValue = new CmfSeriesSonificationContextTracksMappingPan();
			Pitch = Pitch_DefaultValue = new CmfSeriesSonificationContextTracksMappingPitch();
			PitchString = PitchString_DefaultValue = "null";
			PitchNumber = PitchNumber_DefaultValue = null;
			PlayDelay = PlayDelay_DefaultValue = new CmfSeriesSonificationContextTracksMappingPlayDelay();
			Time = Time_DefaultValue = new CmfSeriesSonificationContextTracksMappingTime();
			TimeString = TimeString_DefaultValue = "null";
			TimeNumber = TimeNumber_DefaultValue = null;
			Tremolo = Tremolo_DefaultValue = new CmfSeriesSonificationContextTracksMappingTremolo();
			Volume = Volume_DefaultValue = new CmfSeriesSonificationContextTracksMappingVolume();
		...
		/// </summary>
		public CmfSeriesSonificationContextTracksMappingFrequency Frequency { get; set; }
		private CmfSeriesSonificationContextTracksMappingFrequency Frequency_DefaultValue { get; set; }
		...
		/// </summary>
		public CmfSeriesSonificationContextTracksMappingGapBetweenNotes GapBetweenNotes { get; set; }
		private CmfSeriesSonificationContextTracksMappingGapBetweenNotes GapBetweenNotes_DefaultValue { get; set; }
		...
		/// </summary>
		public CmfSeriesSonificationContextTracksMappingHighpass Highpass { get; set; }
		private CmfSeriesSonificationContextTracksMappingHighpass Highpass_DefaultValue { get; set; }
		...
		/// </summary>
		public CmfSeriesSonificationContextTracksMappingLowpass Lowpass { get; set; }
		private CmfSeriesSonificationContextTracksMappingLowpass Lowpass_DefaultValue { get; set; }
		...
		/// </summary>
		public CmfSeriesSonificationContextTracksMappingNoteDuration NoteDuration { get; set; }
		private CmfSeriesSonificationContextTracksMappingNoteDuration NoteDuration_DefaultValue { get; set; }
		...
		/// </summary>
		public CmfSeriesSonificationContextTracksMappingPan Pan { get; set; }
		private CmfSeriesSonificationContextTracksMappingPan Pan_DefaultValue { get; set; }
		...
		/// </summary>
		public CmfSeriesSonificationContextTracksMappingPitch Pitch { get; set; }
		private CmfSeriesSonificationContextTracksMappingPitch Pitch_DefaultValue { get; set; }
		...
		/// </summary>
		public CmfSeriesSonificationContextTracksMappingPlayDelay PlayDelay { get; set; }
		private CmfSeriesSonificationContextTracksMappingPlayDelay PlayDelay_DefaultValue { get; set; }
		...
		/// </summary>
		public CmfSeriesSonificationContextTracksMappingTime Time { get; set; }
		private CmfSeriesSonificationContextTracksMappingTime Time_DefaultValue { get; set; }
		...
		/// </summary>
		public CmfSeriesSonificationContextTracksMappingTremolo Tremolo { get; set; }
		private CmfSeriesSonificationContextTracksMappingTremolo Tremolo_DefaultValue { get; set; }
		 

		/// <summary>
		/// The volume of notes, from 0 to 1.
		/// </summary>
		public CmfSeriesSonificationContextTracksMappingVolume Volume { get; set; }
		private CmfSeriesSonificationContextTracksMappingVolume Volume_DefaultValue { get; set; }
