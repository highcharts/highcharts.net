...
{
	public partial class CmfSeriesSonificationContextTracksMappingPan  : BaseObject
	{
		Hashtable h = new Hashtable();

		public CmfSeriesSonificationContextTracksMappingPan()
		{
			MapFunction = MapFunction_DefaultValue = CmfSeriesSonificationContextTracksMappingPanMapFunction.Linear;
			MapTo = MapTo_DefaultValue = "";
			Max = Max_DefaultValue = null;
			Min = Min_DefaultValue = null;
			Value = Value_DefaultValue = null;
			Within = Within_DefaultValue = CmfSeriesSonificationContextTracksMappingPanWithin.Chart;
		...
		/// </summary>
		public CmfSeriesSonificationContextTracksMappingPanMapFunction MapFunction { get; set; }
		private CmfSeriesSonificationContextTracksMappingPanMapFunction MapFunction_DefaultValue { get; set; }
		...
		/// </summary>
		public CmfSeriesSonificationContextTracksMappingPanWithin Within { get; set; }
		private CmfSeriesSonificationContextTracksMappingPanWithin Within_DefaultValue { get; set; }
