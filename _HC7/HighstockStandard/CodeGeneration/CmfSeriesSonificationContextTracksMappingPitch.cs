...
{
	public partial class CmfSeriesSonificationContextTracksMappingPitch  : BaseObject
	{
		Hashtable h = new Hashtable();

		public CmfSeriesSonificationContextTracksMappingPitch()
		{
			MapFunction = MapFunction_DefaultValue = CmfSeriesSonificationContextTracksMappingPitchMapFunction.Linear;
		...
		/// </summary>
		public CmfSeriesSonificationContextTracksMappingPitchMapFunction MapFunction { get; set; }
		private CmfSeriesSonificationContextTracksMappingPitchMapFunction MapFunction_DefaultValue { get; set; }
