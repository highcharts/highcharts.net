...
{
	public partial class CmfSeriesSonificationContextTracksPointGrouping  : BaseObject
	{
		Hashtable h = new Hashtable();

		public CmfSeriesSonificationContextTracksPointGrouping()
		{
			Algorithm = Algorithm_DefaultValue = CmfSeriesSonificationContextTracksPointGroupingAlgorithm.Minimax;
		...
		/// </summary>
		public CmfSeriesSonificationContextTracksPointGroupingAlgorithm Algorithm { get; set; }
		private CmfSeriesSonificationContextTracksPointGroupingAlgorithm Algorithm_DefaultValue { get; set; }
