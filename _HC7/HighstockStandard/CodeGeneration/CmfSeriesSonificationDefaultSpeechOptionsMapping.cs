...
{
	public partial class CmfSeriesSonificationDefaultSpeechOptionsMapping  : BaseObject
	{
		Hashtable h = new Hashtable();

		public CmfSeriesSonificationDefaultSpeechOptionsMapping()
		{
			Frequency = Frequency_DefaultValue = new CmfSeriesSonificationDefaultSpeechOptionsMappingFrequency();
			GapBetweenNotes = GapBetweenNotes_DefaultValue = new CmfSeriesSonificationDefaultSpeechOptionsMappingGapBetweenNotes();
			Highpass = Highpass_DefaultValue = new CmfSeriesSonificationDefaultSpeechOptionsMappingHighpass();
			Lowpass = Lowpass_DefaultValue = new CmfSeriesSonificationDefaultSpeechOptionsMappingLowpass();
			NoteDuration = NoteDuration_DefaultValue = new CmfSeriesSonificationDefaultSpeechOptionsMappingNoteDuration();
			Pan = Pan_DefaultValue = new CmfSeriesSonificationDefaultSpeechOptionsMappingPan();
			Pitch = Pitch_DefaultValue = new CmfSeriesSonificationDefaultSpeechOptionsMappingPitch();
			PitchString = PitchString_DefaultValue = "null";
			PitchNumber = PitchNumber_DefaultValue = null;
			PlayDelay = PlayDelay_DefaultValue = new CmfSeriesSonificationDefaultSpeechOptionsMappingPlayDelay();
			Time = Time_DefaultValue = new CmfSeriesSonificationDefaultSpeechOptionsMappingTime();
			TimeString = TimeString_DefaultValue = "null";
			TimeNumber = TimeNumber_DefaultValue = null;
			Tremolo = Tremolo_DefaultValue = new CmfSeriesSonificationDefaultSpeechOptionsMappingTremolo();
			Volume = Volume_DefaultValue = new CmfSeriesSonificationDefaultSpeechOptionsMappingVolume();
		...
		/// </summary>
		public CmfSeriesSonificationDefaultSpeechOptionsMappingFrequency Frequency { get; set; }
		private CmfSeriesSonificationDefaultSpeechOptionsMappingFrequency Frequency_DefaultValue { get; set; }
		...
		/// </summary>
		public CmfSeriesSonificationDefaultSpeechOptionsMappingGapBetweenNotes GapBetweenNotes { get; set; }
		private CmfSeriesSonificationDefaultSpeechOptionsMappingGapBetweenNotes GapBetweenNotes_DefaultValue { get; set; }
		...
		/// </summary>
		public CmfSeriesSonificationDefaultSpeechOptionsMappingHighpass Highpass { get; set; }
		private CmfSeriesSonificationDefaultSpeechOptionsMappingHighpass Highpass_DefaultValue { get; set; }
		...
		/// </summary>
		public CmfSeriesSonificationDefaultSpeechOptionsMappingLowpass Lowpass { get; set; }
		private CmfSeriesSonificationDefaultSpeechOptionsMappingLowpass Lowpass_DefaultValue { get; set; }
		...
		/// </summary>
		public CmfSeriesSonificationDefaultSpeechOptionsMappingNoteDuration NoteDuration { get; set; }
		private CmfSeriesSonificationDefaultSpeechOptionsMappingNoteDuration NoteDuration_DefaultValue { get; set; }
		...
		/// </summary>
		public CmfSeriesSonificationDefaultSpeechOptionsMappingPan Pan { get; set; }
		private CmfSeriesSonificationDefaultSpeechOptionsMappingPan Pan_DefaultValue { get; set; }
		...
		/// </summary>
		public CmfSeriesSonificationDefaultSpeechOptionsMappingPitch Pitch { get; set; }
		private CmfSeriesSonificationDefaultSpeechOptionsMappingPitch Pitch_DefaultValue { get; set; }
		...
		/// </summary>
		public CmfSeriesSonificationDefaultSpeechOptionsMappingPlayDelay PlayDelay { get; set; }
		private CmfSeriesSonificationDefaultSpeechOptionsMappingPlayDelay PlayDelay_DefaultValue { get; set; }
		...
		/// </summary>
		public CmfSeriesSonificationDefaultSpeechOptionsMappingTime Time { get; set; }
		private CmfSeriesSonificationDefaultSpeechOptionsMappingTime Time_DefaultValue { get; set; }
		...
		/// </summary>
		public CmfSeriesSonificationDefaultSpeechOptionsMappingTremolo Tremolo { get; set; }
		private CmfSeriesSonificationDefaultSpeechOptionsMappingTremolo Tremolo_DefaultValue { get; set; }
		 

		/// <summary>
		/// The volume of notes, from 0 to 1.
		/// </summary>
		public CmfSeriesSonificationDefaultSpeechOptionsMappingVolume Volume { get; set; }
		private CmfSeriesSonificationDefaultSpeechOptionsMappingVolume Volume_DefaultValue { get; set; }
