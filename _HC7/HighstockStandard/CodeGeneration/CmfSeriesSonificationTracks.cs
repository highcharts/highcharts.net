...
{
	public partial class CmfSeriesSonificationTracks  : BaseObject
	{
		Hashtable h = new Hashtable();

		public CmfSeriesSonificationTracks()
		{
			ActiveWhen = ActiveWhen_DefaultValue = new CmfSeriesSonificationTracksActiveWhen();
			Instrument = Instrument_DefaultValue = null;
			InstrumentString = InstrumentString_DefaultValue = "null";
			Mapping = Mapping_DefaultValue = new CmfSeriesSonificationTracksMapping();
			MidiName = MidiName_DefaultValue = "";
			PointGrouping = PointGrouping_DefaultValue = new CmfSeriesSonificationTracksPointGrouping();
			RoundToMusicalNotes = RoundToMusicalNotes_DefaultValue = true;
			ShowPlayMarker = ShowPlayMarker_DefaultValue = true;
			Type = Type_DefaultValue = CmfSeriesSonificationTracksType.Instrument;
		...
		/// </summary>
		public CmfSeriesSonificationTracksActiveWhen ActiveWhen { get; set; }
		private CmfSeriesSonificationTracksActiveWhen ActiveWhen_DefaultValue { get; set; }
		...
		/// </summary>
		public CmfSeriesSonificationTracksMapping Mapping { get; set; }
		private CmfSeriesSonificationTracksMapping Mapping_DefaultValue { get; set; }
		...
		/// </summary>
		public CmfSeriesSonificationTracksPointGrouping PointGrouping { get; set; }
		private CmfSeriesSonificationTracksPointGrouping PointGrouping_DefaultValue { get; set; }
		...
		/// </summary>
		public CmfSeriesSonificationTracksType Type { get; set; }
		private CmfSeriesSonificationTracksType Type_DefaultValue { get; set; }
