...
{
	public partial class CmfSeriesSonificationTracksMapping  : BaseObject
	{
		Hashtable h = new Hashtable();

		public CmfSeriesSonificationTracksMapping()
		{
			Frequency = Frequency_DefaultValue = new CmfSeriesSonificationTracksMappingFrequency();
			GapBetweenNotes = GapBetweenNotes_DefaultValue = new CmfSeriesSonificationTracksMappingGapBetweenNotes();
			Highpass = Highpass_DefaultValue = new CmfSeriesSonificationTracksMappingHighpass();
			Lowpass = Lowpass_DefaultValue = new CmfSeriesSonificationTracksMappingLowpass();
			NoteDuration = NoteDuration_DefaultValue = new CmfSeriesSonificationTracksMappingNoteDuration();
			Pan = Pan_DefaultValue = new CmfSeriesSonificationTracksMappingPan();
			Pitch = Pitch_DefaultValue = new CmfSeriesSonificationTracksMappingPitch();
			PitchString = PitchString_DefaultValue = "null";
			PitchNumber = PitchNumber_DefaultValue = null;
			PlayDelay = PlayDelay_DefaultValue = new CmfSeriesSonificationTracksMappingPlayDelay();
			Time = Time_DefaultValue = new CmfSeriesSonificationTracksMappingTime();
			TimeString = TimeString_DefaultValue = "null";
			TimeNumber = TimeNumber_DefaultValue = null;
			Tremolo = Tremolo_DefaultValue = new CmfSeriesSonificationTracksMappingTremolo();
			Volume = Volume_DefaultValue = new CmfSeriesSonificationTracksMappingVolume();
		...
		/// </summary>
		public CmfSeriesSonificationTracksMappingFrequency Frequency { get; set; }
		private CmfSeriesSonificationTracksMappingFrequency Frequency_DefaultValue { get; set; }
		...
		/// </summary>
		public CmfSeriesSonificationTracksMappingGapBetweenNotes GapBetweenNotes { get; set; }
		private CmfSeriesSonificationTracksMappingGapBetweenNotes GapBetweenNotes_DefaultValue { get; set; }
		...
		/// </summary>
		public CmfSeriesSonificationTracksMappingHighpass Highpass { get; set; }
		private CmfSeriesSonificationTracksMappingHighpass Highpass_DefaultValue { get; set; }
		...
		/// </summary>
		public CmfSeriesSonificationTracksMappingLowpass Lowpass { get; set; }
		private CmfSeriesSonificationTracksMappingLowpass Lowpass_DefaultValue { get; set; }
		...
		/// </summary>
		public CmfSeriesSonificationTracksMappingNoteDuration NoteDuration { get; set; }
		private CmfSeriesSonificationTracksMappingNoteDuration NoteDuration_DefaultValue { get; set; }
		...
		/// </summary>
		public CmfSeriesSonificationTracksMappingPan Pan { get; set; }
		private CmfSeriesSonificationTracksMappingPan Pan_DefaultValue { get; set; }
		...
		/// </summary>
		public CmfSeriesSonificationTracksMappingPitch Pitch { get; set; }
		private CmfSeriesSonificationTracksMappingPitch Pitch_DefaultValue { get; set; }
		...
		/// </summary>
		public CmfSeriesSonificationTracksMappingPlayDelay PlayDelay { get; set; }
		private CmfSeriesSonificationTracksMappingPlayDelay PlayDelay_DefaultValue { get; set; }
		...
		/// </summary>
		public CmfSeriesSonificationTracksMappingTime Time { get; set; }
		private CmfSeriesSonificationTracksMappingTime Time_DefaultValue { get; set; }
		...
		/// </summary>
		public CmfSeriesSonificationTracksMappingTremolo Tremolo { get; set; }
		private CmfSeriesSonificationTracksMappingTremolo Tremolo_DefaultValue { get; set; }
		 

		/// <summary>
		/// The volume of notes, from 0 to 1.
		/// </summary>
		public CmfSeriesSonificationTracksMappingVolume Volume { get; set; }
		private CmfSeriesSonificationTracksMappingVolume Volume_DefaultValue { get; set; }
