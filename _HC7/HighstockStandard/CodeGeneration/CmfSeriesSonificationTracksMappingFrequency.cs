...
{
	public partial class CmfSeriesSonificationTracksMappingFrequency  : BaseObject
	{
		Hashtable h = new Hashtable();

		public CmfSeriesSonificationTracksMappingFrequency()
		{
			MapFunction = MapFunction_DefaultValue = CmfSeriesSonificationTracksMappingFrequencyMapFunction.Linear;
			MapTo = MapTo_DefaultValue = "";
			Max = Max_DefaultValue = null;
			Min = Min_DefaultValue = null;
			Value = Value_DefaultValue = null;
			Within = Within_DefaultValue = CmfSeriesSonificationTracksMappingFrequencyWithin.Chart;
		...
		/// </summary>
		public CmfSeriesSonificationTracksMappingFrequencyMapFunction MapFunction { get; set; }
		private CmfSeriesSonificationTracksMappingFrequencyMapFunction MapFunction_DefaultValue { get; set; }
		...
		/// </summary>
		public CmfSeriesSonificationTracksMappingFrequencyWithin Within { get; set; }
		private CmfSeriesSonificationTracksMappingFrequencyWithin Within_DefaultValue { get; set; }
