...
{
	public partial class CmfSeriesSonificationTracksMappingGapBetweenNotes  : BaseObject
	{
		Hashtable h = new Hashtable();

		public CmfSeriesSonificationTracksMappingGapBetweenNotes()
		{
			MapFunction = MapFunction_DefaultValue = CmfSeriesSonificationTracksMappingGapBetweenNotesMapFunction.Linear;
			MapTo = MapTo_DefaultValue = "";
			Max = Max_DefaultValue = null;
			Min = Min_DefaultValue = null;
			Value = Value_DefaultValue = null;
			Within = Within_DefaultValue = CmfSeriesSonificationTracksMappingGapBetweenNotesWithin.Chart;
		...
		/// </summary>
		public CmfSeriesSonificationTracksMappingGapBetweenNotesMapFunction MapFunction { get; set; }
		private CmfSeriesSonificationTracksMappingGapBetweenNotesMapFunction MapFunction_DefaultValue { get; set; }
		...
		/// </summary>
		public CmfSeriesSonificationTracksMappingGapBetweenNotesWithin Within { get; set; }
		private CmfSeriesSonificationTracksMappingGapBetweenNotesWithin Within_DefaultValue { get; set; }
