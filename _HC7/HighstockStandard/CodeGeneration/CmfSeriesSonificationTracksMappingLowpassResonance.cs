...
{
	public partial class CmfSeriesSonificationTracksMappingLowpassResonance  : BaseObject
	{
		Hashtable h = new Hashtable();

		public CmfSeriesSonificationTracksMappingLowpassResonance()
		{
			MapFunction = MapFunction_DefaultValue = CmfSeriesSonificationTracksMappingLowpassResonanceMapFunction.Linear;
			MapTo = MapTo_DefaultValue = "";
			Max = Max_DefaultValue = null;
			Min = Min_DefaultValue = null;
			Value = Value_DefaultValue = null;
			Within = Within_DefaultValue = CmfSeriesSonificationTracksMappingLowpassResonanceWithin.Chart;
		...
		/// </summary>
		public CmfSeriesSonificationTracksMappingLowpassResonanceMapFunction MapFunction { get; set; }
		private CmfSeriesSonificationTracksMappingLowpassResonanceMapFunction MapFunction_DefaultValue { get; set; }
		...
		/// </summary>
		public CmfSeriesSonificationTracksMappingLowpassResonanceWithin Within { get; set; }
		private CmfSeriesSonificationTracksMappingLowpassResonanceWithin Within_DefaultValue { get; set; }
