...
{
	public partial class CmfSeriesSonificationTracksMappingNoteDuration  : BaseObject
	{
		Hashtable h = new Hashtable();

		public CmfSeriesSonificationTracksMappingNoteDuration()
		{
			MapFunction = MapFunction_DefaultValue = CmfSeriesSonificationTracksMappingNoteDurationMapFunction.Linear;
			MapTo = MapTo_DefaultValue = "";
			Max = Max_DefaultValue = null;
			Min = Min_DefaultValue = null;
			Value = Value_DefaultValue = null;
			Within = Within_DefaultValue = CmfSeriesSonificationTracksMappingNoteDurationWithin.Chart;
		...
		/// </summary>
		public CmfSeriesSonificationTracksMappingNoteDurationMapFunction MapFunction { get; set; }
		private CmfSeriesSonificationTracksMappingNoteDurationMapFunction MapFunction_DefaultValue { get; set; }
		...
		/// </summary>
		public CmfSeriesSonificationTracksMappingNoteDurationWithin Within { get; set; }
		private CmfSeriesSonificationTracksMappingNoteDurationWithin Within_DefaultValue { get; set; }
