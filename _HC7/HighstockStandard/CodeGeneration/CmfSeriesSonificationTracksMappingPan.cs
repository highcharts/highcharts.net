...
{
	public partial class CmfSeriesSonificationTracksMappingPan  : BaseObject
	{
		Hashtable h = new Hashtable();

		public CmfSeriesSonificationTracksMappingPan()
		{
			MapFunction = MapFunction_DefaultValue = CmfSeriesSonificationTracksMappingPanMapFunction.Linear;
			MapTo = MapTo_DefaultValue = "";
			Max = Max_DefaultValue = null;
			Min = Min_DefaultValue = null;
			Value = Value_DefaultValue = null;
			Within = Within_DefaultValue = CmfSeriesSonificationTracksMappingPanWithin.Chart;
		...
		/// </summary>
		public CmfSeriesSonificationTracksMappingPanMapFunction MapFunction { get; set; }
		private CmfSeriesSonificationTracksMappingPanMapFunction MapFunction_DefaultValue { get; set; }
		...
		/// </summary>
		public CmfSeriesSonificationTracksMappingPanWithin Within { get; set; }
		private CmfSeriesSonificationTracksMappingPanWithin Within_DefaultValue { get; set; }
