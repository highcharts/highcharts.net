...
{
	public partial class CmfSeriesSonificationTracksMappingPitch  : BaseObject
	{
		Hashtable h = new Hashtable();

		public CmfSeriesSonificationTracksMappingPitch()
		{
			MapFunction = MapFunction_DefaultValue = CmfSeriesSonificationTracksMappingPitchMapFunction.Linear;
		...
		/// </summary>
		public CmfSeriesSonificationTracksMappingPitchMapFunction MapFunction { get; set; }
		private CmfSeriesSonificationTracksMappingPitchMapFunction MapFunction_DefaultValue { get; set; }
