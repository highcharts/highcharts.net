...
{
	public partial class CmfSeriesSonificationTracksMappingPlayDelay  : BaseObject
	{
		Hashtable h = new Hashtable();

		public CmfSeriesSonificationTracksMappingPlayDelay()
		{
			MapFunction = MapFunction_DefaultValue = CmfSeriesSonificationTracksMappingPlayDelayMapFunction.Linear;
			MapTo = MapTo_DefaultValue = "";
			Max = Max_DefaultValue = null;
			Min = Min_DefaultValue = null;
			Value = Value_DefaultValue = null;
			Within = Within_DefaultValue = CmfSeriesSonificationTracksMappingPlayDelayWithin.Chart;
		...
		/// </summary>
		public CmfSeriesSonificationTracksMappingPlayDelayMapFunction MapFunction { get; set; }
		private CmfSeriesSonificationTracksMappingPlayDelayMapFunction MapFunction_DefaultValue { get; set; }
		...
		/// </summary>
		public CmfSeriesSonificationTracksMappingPlayDelayWithin Within { get; set; }
		private CmfSeriesSonificationTracksMappingPlayDelayWithin Within_DefaultValue { get; set; }
