...
{
	public partial class CmfSeriesSonificationTracksMappingTime  : BaseObject
	{
		Hashtable h = new Hashtable();

		public CmfSeriesSonificationTracksMappingTime()
		{
			MapFunction = MapFunction_DefaultValue = CmfSeriesSonificationTracksMappingTimeMapFunction.Linear;
			MapTo = MapTo_DefaultValue = "";
			Max = Max_DefaultValue = null;
			Min = Min_DefaultValue = null;
			Value = Value_DefaultValue = null;
			Within = Within_DefaultValue = CmfSeriesSonificationTracksMappingTimeWithin.Chart;
		...
		/// </summary>
		public CmfSeriesSonificationTracksMappingTimeMapFunction MapFunction { get; set; }
		private CmfSeriesSonificationTracksMappingTimeMapFunction MapFunction_DefaultValue { get; set; }
		...
		/// </summary>
		public CmfSeriesSonificationTracksMappingTimeWithin Within { get; set; }
		private CmfSeriesSonificationTracksMappingTimeWithin Within_DefaultValue { get; set; }
