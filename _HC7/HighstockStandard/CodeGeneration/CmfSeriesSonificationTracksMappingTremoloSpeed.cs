...
{
	public partial class CmfSeriesSonificationTracksMappingTremoloSpeed  : BaseObject
	{
		Hashtable h = new Hashtable();

		public CmfSeriesSonificationTracksMappingTremoloSpeed()
		{
			MapFunction = MapFunction_DefaultValue = CmfSeriesSonificationTracksMappingTremoloSpeedMapFunction.Linear;
			MapTo = MapTo_DefaultValue = "";
			Max = Max_DefaultValue = null;
			Min = Min_DefaultValue = null;
			Value = Value_DefaultValue = null;
			Within = Within_DefaultValue = CmfSeriesSonificationTracksMappingTremoloSpeedWithin.Chart;
		...
		/// </summary>
		public CmfSeriesSonificationTracksMappingTremoloSpeedMapFunction MapFunction { get; set; }
		private CmfSeriesSonificationTracksMappingTremoloSpeedMapFunction MapFunction_DefaultValue { get; set; }
		...
		/// </summary>
		public CmfSeriesSonificationTracksMappingTremoloSpeedWithin Within { get; set; }
		private CmfSeriesSonificationTracksMappingTremoloSpeedWithin Within_DefaultValue { get; set; }
