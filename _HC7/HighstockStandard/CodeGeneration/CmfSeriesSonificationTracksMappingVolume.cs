...
{
	public partial class CmfSeriesSonificationTracksMappingVolume  : BaseObject
	{
		Hashtable h = new Hashtable();

		public CmfSeriesSonificationTracksMappingVolume()
		{
			MapFunction = MapFunction_DefaultValue = CmfSeriesSonificationTracksMappingVolumeMapFunction.Linear;
			MapTo = MapTo_DefaultValue = "";
			Max = Max_DefaultValue = null;
			Min = Min_DefaultValue = null;
			Value = Value_DefaultValue = null;
			Within = Within_DefaultValue = CmfSeriesSonificationTracksMappingVolumeWithin.Chart;
		...
		/// </summary>
		public CmfSeriesSonificationTracksMappingVolumeMapFunction MapFunction { get; set; }
		private CmfSeriesSonificationTracksMappingVolumeMapFunction MapFunction_DefaultValue { get; set; }
		...
		/// </summary>
		public CmfSeriesSonificationTracksMappingVolumeWithin Within { get; set; }
		private CmfSeriesSonificationTracksMappingVolumeWithin Within_DefaultValue { get; set; }
