...
{
	public partial class CmfSeriesSonificationTracksPointGrouping  : BaseObject
	{
		Hashtable h = new Hashtable();

		public CmfSeriesSonificationTracksPointGrouping()
		{
			Algorithm = Algorithm_DefaultValue = CmfSeriesSonificationTracksPointGroupingAlgorithm.Minimax;
		...
		/// </summary>
		public CmfSeriesSonificationTracksPointGroupingAlgorithm Algorithm { get; set; }
		private CmfSeriesSonificationTracksPointGroupingAlgorithm Algorithm_DefaultValue { get; set; }
