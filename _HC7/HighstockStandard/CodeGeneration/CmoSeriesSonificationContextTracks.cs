...
{
	public partial class CmoSeriesSonificationContextTracks  : BaseObject
	{
		Hashtable h = new Hashtable();

		public CmoSeriesSonificationContextTracks()
		{
			ActiveWhen = ActiveWhen_DefaultValue = new CmoSeriesSonificationContextTracksActiveWhen();
			Instrument = Instrument_DefaultValue = null;
			InstrumentString = InstrumentString_DefaultValue = "null";
			Mapping = Mapping_DefaultValue = new CmoSeriesSonificationContextTracksMapping();
			MidiName = MidiName_DefaultValue = "";
			PointGrouping = PointGrouping_DefaultValue = new CmoSeriesSonificationContextTracksPointGrouping();
			...
			Type = Type_DefaultValue = CmoSeriesSonificationContextTracksType.Instrument;
			ValueInterval = ValueInterval_DefaultValue = null;
			ValueMapFunction = ValueMapFunction_DefaultValue = CmoSeriesSonificationContextTracksValueMapFunction.Linear;
		...
		/// </summary>
		public CmoSeriesSonificationContextTracksActiveWhen ActiveWhen { get; set; }
		private CmoSeriesSonificationContextTracksActiveWhen ActiveWhen_DefaultValue { get; set; }
		...
		/// </summary>
		public CmoSeriesSonificationContextTracksMapping Mapping { get; set; }
		private CmoSeriesSonificationContextTracksMapping Mapping_DefaultValue { get; set; }
		...
		/// </summary>
		public CmoSeriesSonificationContextTracksPointGrouping PointGrouping { get; set; }
		private CmoSeriesSonificationContextTracksPointGrouping PointGrouping_DefaultValue { get; set; }
		...
		/// </summary>
		public CmoSeriesSonificationContextTracksType Type { get; set; }
		private CmoSeriesSonificationContextTracksType Type_DefaultValue { get; set; }
		...
		/// </summary>
		public CmoSeriesSonificationContextTracksValueMapFunction ValueMapFunction { get; set; }
		private CmoSeriesSonificationContextTracksValueMapFunction ValueMapFunction_DefaultValue { get; set; }
