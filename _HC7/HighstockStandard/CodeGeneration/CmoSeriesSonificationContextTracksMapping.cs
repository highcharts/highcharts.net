...
{
	public partial class CmoSeriesSonificationContextTracksMapping  : BaseObject
	{
		Hashtable h = new Hashtable();

		public CmoSeriesSonificationContextTracksMapping()
		{
			Frequency = Frequency_DefaultValue = new CmoSeriesSonificationContextTracksMappingFrequency();
			GapBetweenNotes = GapBetweenNotes_DefaultValue = new CmoSeriesSonificationContextTracksMappingGapBetweenNotes();
			Highpass = Highpass_DefaultValue = new CmoSeriesSonificationContextTracksMappingHighpass();
			Lowpass = Lowpass_DefaultValue = new CmoSeriesSonificationContextTracksMappingLowpass();
			NoteDuration = NoteDuration_DefaultValue = new CmoSeriesSonificationContextTracksMappingNoteDuration();
			Pan = Pan_DefaultValue = new CmoSeriesSonificationContextTracksMappingPan();
			Pitch = Pitch_DefaultValue = new CmoSeriesSonificationContextTracksMappingPitch();
			PitchString = PitchString_DefaultValue = "null";
			PitchNumber = PitchNumber_DefaultValue = null;
			PlayDelay = PlayDelay_DefaultValue = new CmoSeriesSonificationContextTracksMappingPlayDelay();
			Time = Time_DefaultValue = new CmoSeriesSonificationContextTracksMappingTime();
			TimeString = TimeString_DefaultValue = "null";
			TimeNumber = TimeNumber_DefaultValue = null;
			Tremolo = Tremolo_DefaultValue = new CmoSeriesSonificationContextTracksMappingTremolo();
			Volume = Volume_DefaultValue = new CmoSeriesSonificationContextTracksMappingVolume();
		...
		/// </summary>
		public CmoSeriesSonificationContextTracksMappingFrequency Frequency { get; set; }
		private CmoSeriesSonificationContextTracksMappingFrequency Frequency_DefaultValue { get; set; }
		...
		/// </summary>
		public CmoSeriesSonificationContextTracksMappingGapBetweenNotes GapBetweenNotes { get; set; }
		private CmoSeriesSonificationContextTracksMappingGapBetweenNotes GapBetweenNotes_DefaultValue { get; set; }
		...
		/// </summary>
		public CmoSeriesSonificationContextTracksMappingHighpass Highpass { get; set; }
		private CmoSeriesSonificationContextTracksMappingHighpass Highpass_DefaultValue { get; set; }
		...
		/// </summary>
		public CmoSeriesSonificationContextTracksMappingLowpass Lowpass { get; set; }
		private CmoSeriesSonificationContextTracksMappingLowpass Lowpass_DefaultValue { get; set; }
		...
		/// </summary>
		public CmoSeriesSonificationContextTracksMappingNoteDuration NoteDuration { get; set; }
		private CmoSeriesSonificationContextTracksMappingNoteDuration NoteDuration_DefaultValue { get; set; }
		...
		/// </summary>
		public CmoSeriesSonificationContextTracksMappingPan Pan { get; set; }
		private CmoSeriesSonificationContextTracksMappingPan Pan_DefaultValue { get; set; }
		...
		/// </summary>
		public CmoSeriesSonificationContextTracksMappingPitch Pitch { get; set; }
		private CmoSeriesSonificationContextTracksMappingPitch Pitch_DefaultValue { get; set; }
		...
		/// </summary>
		public CmoSeriesSonificationContextTracksMappingPlayDelay PlayDelay { get; set; }
		private CmoSeriesSonificationContextTracksMappingPlayDelay PlayDelay_DefaultValue { get; set; }
		...
		/// </summary>
		public CmoSeriesSonificationContextTracksMappingTime Time { get; set; }
		private CmoSeriesSonificationContextTracksMappingTime Time_DefaultValue { get; set; }
		...
		/// </summary>
		public CmoSeriesSonificationContextTracksMappingTremolo Tremolo { get; set; }
		private CmoSeriesSonificationContextTracksMappingTremolo Tremolo_DefaultValue { get; set; }
		 

		/// <summary>
		/// The volume of notes, from 0 to 1.
		/// </summary>
		public CmoSeriesSonificationContextTracksMappingVolume Volume { get; set; }
		private CmoSeriesSonificationContextTracksMappingVolume Volume_DefaultValue { get; set; }
