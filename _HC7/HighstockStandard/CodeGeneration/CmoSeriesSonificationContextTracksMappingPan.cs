...
{
	public partial class CmoSeriesSonificationContextTracksMappingPan  : BaseObject
	{
		Hashtable h = new Hashtable();

		public CmoSeriesSonificationContextTracksMappingPan()
		{
			MapFunction = MapFunction_DefaultValue = CmoSeriesSonificationContextTracksMappingPanMapFunction.Linear;
			MapTo = MapTo_DefaultValue = "";
			Max = Max_DefaultValue = null;
			Min = Min_DefaultValue = null;
			Value = Value_DefaultValue = null;
			Within = Within_DefaultValue = CmoSeriesSonificationContextTracksMappingPanWithin.Chart;
		...
		/// </summary>
		public CmoSeriesSonificationContextTracksMappingPanMapFunction MapFunction { get; set; }
		private CmoSeriesSonificationContextTracksMappingPanMapFunction MapFunction_DefaultValue { get; set; }
		...
		/// </summary>
		public CmoSeriesSonificationContextTracksMappingPanWithin Within { get; set; }
		private CmoSeriesSonificationContextTracksMappingPanWithin Within_DefaultValue { get; set; }
