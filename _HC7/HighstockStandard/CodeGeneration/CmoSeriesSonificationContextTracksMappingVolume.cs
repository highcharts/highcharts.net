...
{
	public partial class CmoSeriesSonificationContextTracksMappingVolume  : BaseObject
	{
		Hashtable h = new Hashtable();

		public CmoSeriesSonificationContextTracksMappingVolume()
		{
			MapFunction = MapFunction_DefaultValue = CmoSeriesSonificationContextTracksMappingVolumeMapFunction.Linear;
			MapTo = MapTo_DefaultValue = "";
			Max = Max_DefaultValue = null;
			Min = Min_DefaultValue = null;
			Value = Value_DefaultValue = null;
			Within = Within_DefaultValue = CmoSeriesSonificationContextTracksMappingVolumeWithin.Chart;
		...
		/// </summary>
		public CmoSeriesSonificationContextTracksMappingVolumeMapFunction MapFunction { get; set; }
		private CmoSeriesSonificationContextTracksMappingVolumeMapFunction MapFunction_DefaultValue { get; set; }
		...
		/// </summary>
		public CmoSeriesSonificationContextTracksMappingVolumeWithin Within { get; set; }
		private CmoSeriesSonificationContextTracksMappingVolumeWithin Within_DefaultValue { get; set; }
