...
{
	public partial class CmoSeriesSonificationDefaultInstrumentOptions  : BaseObject
	{
		Hashtable h = new Hashtable();

		public CmoSeriesSonificationDefaultInstrumentOptions()
		{
			ActiveWhen = ActiveWhen_DefaultValue = new CmoSeriesSonificationDefaultInstrumentOptionsActiveWhen();
			Instrument = Instrument_DefaultValue = null;
			InstrumentString = InstrumentString_DefaultValue = "null";
			Mapping = Mapping_DefaultValue = new CmoSeriesSonificationDefaultInstrumentOptionsMapping();
		...
		/// </summary>
		public CmoSeriesSonificationDefaultInstrumentOptionsActiveWhen ActiveWhen { get; set; }
		private CmoSeriesSonificationDefaultInstrumentOptionsActiveWhen ActiveWhen_DefaultValue { get; set; }
		...
		/// </summary>
		public CmoSeriesSonificationDefaultInstrumentOptionsMapping Mapping { get; set; }
		private CmoSeriesSonificationDefaultInstrumentOptionsMapping Mapping_DefaultValue { get; set; }
		...
		/// </summary>
		public CmoSeriesSonificationDefaultInstrumentOptionsPointGrouping PointGrouping { get; set; }
		private CmoSeriesSonificationDefaultInstrumentOptionsPointGrouping PointGrouping_DefaultValue { get; set; }
