...
{
	public partial class CmoSeriesSonificationDefaultSpeechOptionsMapping  : BaseObject
	{
		Hashtable h = new Hashtable();

		public CmoSeriesSonificationDefaultSpeechOptionsMapping()
		{
			Frequency = Frequency_DefaultValue = new CmoSeriesSonificationDefaultSpeechOptionsMappingFrequency();
			GapBetweenNotes = GapBetweenNotes_DefaultValue = new CmoSeriesSonificationDefaultSpeechOptionsMappingGapBetweenNotes();
			Highpass = Highpass_DefaultValue = new CmoSeriesSonificationDefaultSpeechOptionsMappingHighpass();
			Lowpass = Lowpass_DefaultValue = new CmoSeriesSonificationDefaultSpeechOptionsMappingLowpass();
			NoteDuration = NoteDuration_DefaultValue = new CmoSeriesSonificationDefaultSpeechOptionsMappingNoteDuration();
			Pan = Pan_DefaultValue = new CmoSeriesSonificationDefaultSpeechOptionsMappingPan();
			Pitch = Pitch_DefaultValue = new CmoSeriesSonificationDefaultSpeechOptionsMappingPitch();
			PitchString = PitchString_DefaultValue = "null";
			PitchNumber = PitchNumber_DefaultValue = null;
			PlayDelay = PlayDelay_DefaultValue = new CmoSeriesSonificationDefaultSpeechOptionsMappingPlayDelay();
			Time = Time_DefaultValue = new CmoSeriesSonificationDefaultSpeechOptionsMappingTime();
			TimeString = TimeString_DefaultValue = "null";
			TimeNumber = TimeNumber_DefaultValue = null;
			Tremolo = Tremolo_DefaultValue = new CmoSeriesSonificationDefaultSpeechOptionsMappingTremolo();
			Volume = Volume_DefaultValue = new CmoSeriesSonificationDefaultSpeechOptionsMappingVolume();
		...
		/// </summary>
		public CmoSeriesSonificationDefaultSpeechOptionsMappingFrequency Frequency { get; set; }
		private CmoSeriesSonificationDefaultSpeechOptionsMappingFrequency Frequency_DefaultValue { get; set; }
		...
		/// </summary>
		public CmoSeriesSonificationDefaultSpeechOptionsMappingGapBetweenNotes GapBetweenNotes { get; set; }
		private CmoSeriesSonificationDefaultSpeechOptionsMappingGapBetweenNotes GapBetweenNotes_DefaultValue { get; set; }
		...
		/// </summary>
		public CmoSeriesSonificationDefaultSpeechOptionsMappingHighpass Highpass { get; set; }
		private CmoSeriesSonificationDefaultSpeechOptionsMappingHighpass Highpass_DefaultValue { get; set; }
		...
		/// </summary>
		public CmoSeriesSonificationDefaultSpeechOptionsMappingLowpass Lowpass { get; set; }
		private CmoSeriesSonificationDefaultSpeechOptionsMappingLowpass Lowpass_DefaultValue { get; set; }
		...
		/// </summary>
		public CmoSeriesSonificationDefaultSpeechOptionsMappingNoteDuration NoteDuration { get; set; }
		private CmoSeriesSonificationDefaultSpeechOptionsMappingNoteDuration NoteDuration_DefaultValue { get; set; }
		...
		/// </summary>
		public CmoSeriesSonificationDefaultSpeechOptionsMappingPan Pan { get; set; }
		private CmoSeriesSonificationDefaultSpeechOptionsMappingPan Pan_DefaultValue { get; set; }
		...
		/// </summary>
		public CmoSeriesSonificationDefaultSpeechOptionsMappingPitch Pitch { get; set; }
		private CmoSeriesSonificationDefaultSpeechOptionsMappingPitch Pitch_DefaultValue { get; set; }
		...
		/// </summary>
		public CmoSeriesSonificationDefaultSpeechOptionsMappingPlayDelay PlayDelay { get; set; }
		private CmoSeriesSonificationDefaultSpeechOptionsMappingPlayDelay PlayDelay_DefaultValue { get; set; }
		...
		/// </summary>
		public CmoSeriesSonificationDefaultSpeechOptionsMappingTime Time { get; set; }
		private CmoSeriesSonificationDefaultSpeechOptionsMappingTime Time_DefaultValue { get; set; }
		...
		/// </summary>
		public CmoSeriesSonificationDefaultSpeechOptionsMappingTremolo Tremolo { get; set; }
		private CmoSeriesSonificationDefaultSpeechOptionsMappingTremolo Tremolo_DefaultValue { get; set; }
		 

		/// <summary>
		/// The volume of notes, from 0 to 1.
		/// </summary>
		public CmoSeriesSonificationDefaultSpeechOptionsMappingVolume Volume { get; set; }
		private CmoSeriesSonificationDefaultSpeechOptionsMappingVolume Volume_DefaultValue { get; set; }
