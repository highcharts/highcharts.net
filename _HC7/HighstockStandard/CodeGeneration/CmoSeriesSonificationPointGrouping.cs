...
{
	public partial class CmoSeriesSonificationPointGrouping  : BaseObject
	{
		Hashtable h = new Hashtable();

		public CmoSeriesSonificationPointGrouping()
		{
			Algorithm = Algorithm_DefaultValue = CmoSeriesSonificationPointGroupingAlgorithm.Minimax;
		...
		/// </summary>
		public CmoSeriesSonificationPointGroupingAlgorithm Algorithm { get; set; }
		private CmoSeriesSonificationPointGroupingAlgorithm Algorithm_DefaultValue { get; set; }
