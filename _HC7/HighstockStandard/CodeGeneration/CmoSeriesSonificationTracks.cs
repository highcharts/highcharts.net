...
{
	public partial class CmoSeriesSonificationTracks  : BaseObject
	{
		Hashtable h = new Hashtable();

		public CmoSeriesSonificationTracks()
		{
			ActiveWhen = ActiveWhen_DefaultValue = new CmoSeriesSonificationTracksActiveWhen();
			Instrument = Instrument_DefaultValue = null;
			InstrumentString = InstrumentString_DefaultValue = "null";
			Mapping = Mapping_DefaultValue = new CmoSeriesSonificationTracksMapping();
			MidiName = MidiName_DefaultValue = "";
			PointGrouping = PointGrouping_DefaultValue = new CmoSeriesSonificationTracksPointGrouping();
			RoundToMusicalNotes = RoundToMusicalNotes_DefaultValue = true;
			ShowPlayMarker = ShowPlayMarker_DefaultValue = true;
			Type = Type_DefaultValue = CmoSeriesSonificationTracksType.Instrument;
		...
		/// </summary>
		public CmoSeriesSonificationTracksActiveWhen ActiveWhen { get; set; }
		private CmoSeriesSonificationTracksActiveWhen ActiveWhen_DefaultValue { get; set; }
		...
		/// </summary>
		public CmoSeriesSonificationTracksMapping Mapping { get; set; }
		private CmoSeriesSonificationTracksMapping Mapping_DefaultValue { get; set; }
		...
		/// </summary>
		public CmoSeriesSonificationTracksPointGrouping PointGrouping { get; set; }
		private CmoSeriesSonificationTracksPointGrouping PointGrouping_DefaultValue { get; set; }
		...
		/// </summary>
		public CmoSeriesSonificationTracksType Type { get; set; }
		private CmoSeriesSonificationTracksType Type_DefaultValue { get; set; }
