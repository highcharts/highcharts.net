...
{
	public partial class CmoSeriesSonificationTracksMapping  : BaseObject
	{
		Hashtable h = new Hashtable();

		public CmoSeriesSonificationTracksMapping()
		{
			Frequency = Frequency_DefaultValue = new CmoSeriesSonificationTracksMappingFrequency();
			GapBetweenNotes = GapBetweenNotes_DefaultValue = new CmoSeriesSonificationTracksMappingGapBetweenNotes();
			Highpass = Highpass_DefaultValue = new CmoSeriesSonificationTracksMappingHighpass();
			Lowpass = Lowpass_DefaultValue = new CmoSeriesSonificationTracksMappingLowpass();
			NoteDuration = NoteDuration_DefaultValue = new CmoSeriesSonificationTracksMappingNoteDuration();
			Pan = Pan_DefaultValue = new CmoSeriesSonificationTracksMappingPan();
			Pitch = Pitch_DefaultValue = new CmoSeriesSonificationTracksMappingPitch();
			PitchString = PitchString_DefaultValue = "null";
			PitchNumber = PitchNumber_DefaultValue = null;
			PlayDelay = PlayDelay_DefaultValue = new CmoSeriesSonificationTracksMappingPlayDelay();
			Time = Time_DefaultValue = new CmoSeriesSonificationTracksMappingTime();
			TimeString = TimeString_DefaultValue = "null";
			TimeNumber = TimeNumber_DefaultValue = null;
			Tremolo = Tremolo_DefaultValue = new CmoSeriesSonificationTracksMappingTremolo();
			Volume = Volume_DefaultValue = new CmoSeriesSonificationTracksMappingVolume();
		...
		/// </summary>
		public CmoSeriesSonificationTracksMappingFrequency Frequency { get; set; }
		private CmoSeriesSonificationTracksMappingFrequency Frequency_DefaultValue { get; set; }
		...
		/// </summary>
		public CmoSeriesSonificationTracksMappingGapBetweenNotes GapBetweenNotes { get; set; }
		private CmoSeriesSonificationTracksMappingGapBetweenNotes GapBetweenNotes_DefaultValue { get; set; }
		...
		/// </summary>
		public CmoSeriesSonificationTracksMappingHighpass Highpass { get; set; }
		private CmoSeriesSonificationTracksMappingHighpass Highpass_DefaultValue { get; set; }
		...
		/// </summary>
		public CmoSeriesSonificationTracksMappingLowpass Lowpass { get; set; }
		private CmoSeriesSonificationTracksMappingLowpass Lowpass_DefaultValue { get; set; }
		...
		/// </summary>
		public CmoSeriesSonificationTracksMappingNoteDuration NoteDuration { get; set; }
		private CmoSeriesSonificationTracksMappingNoteDuration NoteDuration_DefaultValue { get; set; }
		...
		/// </summary>
		public CmoSeriesSonificationTracksMappingPan Pan { get; set; }
		private CmoSeriesSonificationTracksMappingPan Pan_DefaultValue { get; set; }
		...
		/// </summary>
		public CmoSeriesSonificationTracksMappingPitch Pitch { get; set; }
		private CmoSeriesSonificationTracksMappingPitch Pitch_DefaultValue { get; set; }
		...
		/// </summary>
		public CmoSeriesSonificationTracksMappingPlayDelay PlayDelay { get; set; }
		private CmoSeriesSonificationTracksMappingPlayDelay PlayDelay_DefaultValue { get; set; }
		...
		/// </summary>
		public CmoSeriesSonificationTracksMappingTime Time { get; set; }
		private CmoSeriesSonificationTracksMappingTime Time_DefaultValue { get; set; }
		...
		/// </summary>
		public CmoSeriesSonificationTracksMappingTremolo Tremolo { get; set; }
		private CmoSeriesSonificationTracksMappingTremolo Tremolo_DefaultValue { get; set; }
		 

		/// <summary>
		/// The volume of notes, from 0 to 1.
		/// </summary>
		public CmoSeriesSonificationTracksMappingVolume Volume { get; set; }
		private CmoSeriesSonificationTracksMappingVolume Volume_DefaultValue { get; set; }
