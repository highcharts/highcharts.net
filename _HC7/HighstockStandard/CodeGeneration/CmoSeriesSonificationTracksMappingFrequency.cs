...
{
	public partial class CmoSeriesSonificationTracksMappingFrequency  : BaseObject
	{
		Hashtable h = new Hashtable();

		public CmoSeriesSonificationTracksMappingFrequency()
		{
			MapFunction = MapFunction_DefaultValue = CmoSeriesSonificationTracksMappingFrequencyMapFunction.Linear;
			MapTo = MapTo_DefaultValue = "";
			Max = Max_DefaultValue = null;
			Min = Min_DefaultValue = null;
			Value = Value_DefaultValue = null;
			Within = Within_DefaultValue = CmoSeriesSonificationTracksMappingFrequencyWithin.Chart;
		...
		/// </summary>
		public CmoSeriesSonificationTracksMappingFrequencyMapFunction MapFunction { get; set; }
		private CmoSeriesSonificationTracksMappingFrequencyMapFunction MapFunction_DefaultValue { get; set; }
		...
		/// </summary>
		public CmoSeriesSonificationTracksMappingFrequencyWithin Within { get; set; }
		private CmoSeriesSonificationTracksMappingFrequencyWithin Within_DefaultValue { get; set; }
