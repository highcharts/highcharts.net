...
{
	public partial class CmoSeriesSonificationTracksMappingLowpassFrequency  : BaseObject
	{
		Hashtable h = new Hashtable();

		public CmoSeriesSonificationTracksMappingLowpassFrequency()
		{
			MapFunction = MapFunction_DefaultValue = CmoSeriesSonificationTracksMappingLowpassFrequencyMapFunction.Linear;
			MapTo = MapTo_DefaultValue = "";
			Max = Max_DefaultValue = null;
			Min = Min_DefaultValue = null;
			Value = Value_DefaultValue = null;
			Within = Within_DefaultValue = CmoSeriesSonificationTracksMappingLowpassFrequencyWithin.Chart;
		...
		/// </summary>
		public CmoSeriesSonificationTracksMappingLowpassFrequencyMapFunction MapFunction { get; set; }
		private CmoSeriesSonificationTracksMappingLowpassFrequencyMapFunction MapFunction_DefaultValue { get; set; }
		...
		/// </summary>
		public CmoSeriesSonificationTracksMappingLowpassFrequencyWithin Within { get; set; }
		private CmoSeriesSonificationTracksMappingLowpassFrequencyWithin Within_DefaultValue { get; set; }
