...
{
	public partial class CmoSeriesSonificationTracksMappingLowpassResonance  : BaseObject
	{
		Hashtable h = new Hashtable();

		public CmoSeriesSonificationTracksMappingLowpassResonance()
		{
			MapFunction = MapFunction_DefaultValue = CmoSeriesSonificationTracksMappingLowpassResonanceMapFunction.Linear;
			MapTo = MapTo_DefaultValue = "";
			Max = Max_DefaultValue = null;
			Min = Min_DefaultValue = null;
			Value = Value_DefaultValue = null;
			Within = Within_DefaultValue = CmoSeriesSonificationTracksMappingLowpassResonanceWithin.Chart;
		...
		/// </summary>
		public CmoSeriesSonificationTracksMappingLowpassResonanceMapFunction MapFunction { get; set; }
		private CmoSeriesSonificationTracksMappingLowpassResonanceMapFunction MapFunction_DefaultValue { get; set; }
		...
		/// </summary>
		public CmoSeriesSonificationTracksMappingLowpassResonanceWithin Within { get; set; }
		private CmoSeriesSonificationTracksMappingLowpassResonanceWithin Within_DefaultValue { get; set; }
