...
{
	public partial class CmoSeriesSonificationTracksMappingNoteDuration  : BaseObject
	{
		Hashtable h = new Hashtable();

		public CmoSeriesSonificationTracksMappingNoteDuration()
		{
			MapFunction = MapFunction_DefaultValue = CmoSeriesSonificationTracksMappingNoteDurationMapFunction.Linear;
			MapTo = MapTo_DefaultValue = "";
			Max = Max_DefaultValue = null;
			Min = Min_DefaultValue = null;
			Value = Value_DefaultValue = null;
			Within = Within_DefaultValue = CmoSeriesSonificationTracksMappingNoteDurationWithin.Chart;
		...
		/// </summary>
		public CmoSeriesSonificationTracksMappingNoteDurationMapFunction MapFunction { get; set; }
		private CmoSeriesSonificationTracksMappingNoteDurationMapFunction MapFunction_DefaultValue { get; set; }
		...
		/// </summary>
		public CmoSeriesSonificationTracksMappingNoteDurationWithin Within { get; set; }
		private CmoSeriesSonificationTracksMappingNoteDurationWithin Within_DefaultValue { get; set; }
