...
{
	public partial class CmoSeriesSonificationTracksMappingPan  : BaseObject
	{
		Hashtable h = new Hashtable();

		public CmoSeriesSonificationTracksMappingPan()
		{
			MapFunction = MapFunction_DefaultValue = CmoSeriesSonificationTracksMappingPanMapFunction.Linear;
			MapTo = MapTo_DefaultValue = "";
			Max = Max_DefaultValue = null;
			Min = Min_DefaultValue = null;
			Value = Value_DefaultValue = null;
			Within = Within_DefaultValue = CmoSeriesSonificationTracksMappingPanWithin.Chart;
		...
		/// </summary>
		public CmoSeriesSonificationTracksMappingPanMapFunction MapFunction { get; set; }
		private CmoSeriesSonificationTracksMappingPanMapFunction MapFunction_DefaultValue { get; set; }
		...
		/// </summary>
		public CmoSeriesSonificationTracksMappingPanWithin Within { get; set; }
		private CmoSeriesSonificationTracksMappingPanWithin Within_DefaultValue { get; set; }
