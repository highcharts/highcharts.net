...
{
	public partial class CmoSeriesSonificationTracksMappingPitch  : BaseObject
	{
		Hashtable h = new Hashtable();

		public CmoSeriesSonificationTracksMappingPitch()
		{
			MapFunction = MapFunction_DefaultValue = CmoSeriesSonificationTracksMappingPitchMapFunction.Linear;
		...
		/// </summary>
		public CmoSeriesSonificationTracksMappingPitchMapFunction MapFunction { get; set; }
		private CmoSeriesSonificationTracksMappingPitchMapFunction MapFunction_DefaultValue { get; set; }
