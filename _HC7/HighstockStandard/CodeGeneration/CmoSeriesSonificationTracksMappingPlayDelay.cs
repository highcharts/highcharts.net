...
{
	public partial class CmoSeriesSonificationTracksMappingPlayDelay  : BaseObject
	{
		Hashtable h = new Hashtable();

		public CmoSeriesSonificationTracksMappingPlayDelay()
		{
			MapFunction = MapFunction_DefaultValue = CmoSeriesSonificationTracksMappingPlayDelayMapFunction.Linear;
			MapTo = MapTo_DefaultValue = "";
			Max = Max_DefaultValue = null;
			Min = Min_DefaultValue = null;
			Value = Value_DefaultValue = null;
			Within = Within_DefaultValue = CmoSeriesSonificationTracksMappingPlayDelayWithin.Chart;
		...
		/// </summary>
		public CmoSeriesSonificationTracksMappingPlayDelayMapFunction MapFunction { get; set; }
		private CmoSeriesSonificationTracksMappingPlayDelayMapFunction MapFunction_DefaultValue { get; set; }
		...
		/// </summary>
		public CmoSeriesSonificationTracksMappingPlayDelayWithin Within { get; set; }
		private CmoSeriesSonificationTracksMappingPlayDelayWithin Within_DefaultValue { get; set; }
