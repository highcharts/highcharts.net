...
{
	public partial class CmoSeriesSonificationTracksMappingTime  : BaseObject
	{
		Hashtable h = new Hashtable();

		public CmoSeriesSonificationTracksMappingTime()
		{
			MapFunction = MapFunction_DefaultValue = CmoSeriesSonificationTracksMappingTimeMapFunction.Linear;
			MapTo = MapTo_DefaultValue = "";
			Max = Max_DefaultValue = null;
			Min = Min_DefaultValue = null;
			Value = Value_DefaultValue = null;
			Within = Within_DefaultValue = CmoSeriesSonificationTracksMappingTimeWithin.Chart;
		...
		/// </summary>
		public CmoSeriesSonificationTracksMappingTimeMapFunction MapFunction { get; set; }
		private CmoSeriesSonificationTracksMappingTimeMapFunction MapFunction_DefaultValue { get; set; }
		...
		/// </summary>
		public CmoSeriesSonificationTracksMappingTimeWithin Within { get; set; }
		private CmoSeriesSonificationTracksMappingTimeWithin Within_DefaultValue { get; set; }
