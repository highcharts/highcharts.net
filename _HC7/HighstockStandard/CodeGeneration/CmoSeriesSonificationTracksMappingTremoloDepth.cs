...
{
	public partial class CmoSeriesSonificationTracksMappingTremoloDepth  : BaseObject
	{
		Hashtable h = new Hashtable();

		public CmoSeriesSonificationTracksMappingTremoloDepth()
		{
			MapFunction = MapFunction_DefaultValue = CmoSeriesSonificationTracksMappingTremoloDepthMapFunction.Linear;
			MapTo = MapTo_DefaultValue = "";
			Max = Max_DefaultValue = null;
			Min = Min_DefaultValue = null;
			Value = Value_DefaultValue = null;
			Within = Within_DefaultValue = CmoSeriesSonificationTracksMappingTremoloDepthWithin.Chart;
		...
		/// </summary>
		public CmoSeriesSonificationTracksMappingTremoloDepthMapFunction MapFunction { get; set; }
		private CmoSeriesSonificationTracksMappingTremoloDepthMapFunction MapFunction_DefaultValue { get; set; }
		...
		/// </summary>
		public CmoSeriesSonificationTracksMappingTremoloDepthWithin Within { get; set; }
		private CmoSeriesSonificationTracksMappingTremoloDepthWithin Within_DefaultValue { get; set; }
