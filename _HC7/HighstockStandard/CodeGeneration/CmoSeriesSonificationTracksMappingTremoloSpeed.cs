...
{
	public partial class CmoSeriesSonificationTracksMappingTremoloSpeed  : BaseObject
	{
		Hashtable h = new Hashtable();

		public CmoSeriesSonificationTracksMappingTremoloSpeed()
		{
			MapFunction = MapFunction_DefaultValue = CmoSeriesSonificationTracksMappingTremoloSpeedMapFunction.Linear;
			MapTo = MapTo_DefaultValue = "";
			Max = Max_DefaultValue = null;
			Min = Min_DefaultValue = null;
			Value = Value_DefaultValue = null;
			Within = Within_DefaultValue = CmoSeriesSonificationTracksMappingTremoloSpeedWithin.Chart;
		...
		/// </summary>
		public CmoSeriesSonificationTracksMappingTremoloSpeedMapFunction MapFunction { get; set; }
		private CmoSeriesSonificationTracksMappingTremoloSpeedMapFunction MapFunction_DefaultValue { get; set; }
		...
		/// </summary>
		public CmoSeriesSonificationTracksMappingTremoloSpeedWithin Within { get; set; }
		private CmoSeriesSonificationTracksMappingTremoloSpeedWithin Within_DefaultValue { get; set; }
