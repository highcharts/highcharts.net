...
{
	public partial class CmoSeriesSonificationTracksMappingVolume  : BaseObject
	{
		Hashtable h = new Hashtable();

		public CmoSeriesSonificationTracksMappingVolume()
		{
			MapFunction = MapFunction_DefaultValue = CmoSeriesSonificationTracksMappingVolumeMapFunction.Linear;
			MapTo = MapTo_DefaultValue = "";
			Max = Max_DefaultValue = null;
			Min = Min_DefaultValue = null;
			Value = Value_DefaultValue = null;
			Within = Within_DefaultValue = CmoSeriesSonificationTracksMappingVolumeWithin.Chart;
		...
		/// </summary>
		public CmoSeriesSonificationTracksMappingVolumeMapFunction MapFunction { get; set; }
		private CmoSeriesSonificationTracksMappingVolumeMapFunction MapFunction_DefaultValue { get; set; }
		...
		/// </summary>
		public CmoSeriesSonificationTracksMappingVolumeWithin Within { get; set; }
		private CmoSeriesSonificationTracksMappingVolumeWithin Within_DefaultValue { get; set; }
