...
{
	public partial class CmoSeriesSonificationTracksPointGrouping  : BaseObject
	{
		Hashtable h = new Hashtable();

		public CmoSeriesSonificationTracksPointGrouping()
		{
			Algorithm = Algorithm_DefaultValue = CmoSeriesSonificationTracksPointGroupingAlgorithm.Minimax;
		...
		/// </summary>
		public CmoSeriesSonificationTracksPointGroupingAlgorithm Algorithm { get; set; }
		private CmoSeriesSonificationTracksPointGroupingAlgorithm Algorithm_DefaultValue { get; set; }
