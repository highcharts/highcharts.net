...
namespace Highsoft.Web.Mvc.Stocks
{
	public partial class ColumnSeriesAccessibility  : BaseObject
	{
		...
		public ColumnSeriesAccessibility()
		{
			...
			Point = Point_DefaultValue = new ColumnSeriesAccessibilityPoint();
		...
		/// </summary>
		public ColumnSeriesAccessibilityPoint Point { get; set; }
		private ColumnSeriesAccessibilityPoint Point_DefaultValue { get; set; }
