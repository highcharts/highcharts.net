...
{
	public partial class ColumnSeriesSonificationDefaultSpeechOptionsMapping  : BaseObject
	{
		Hashtable h = new Hashtable();

		public ColumnSeriesSonificationDefaultSpeechOptionsMapping()
		{
			Frequency = Frequency_DefaultValue = new ColumnSeriesSonificationDefaultSpeechOptionsMappingFrequency();
			GapBetweenNotes = GapBetweenNotes_DefaultValue = new ColumnSeriesSonificationDefaultSpeechOptionsMappingGapBetweenNotes();
			Highpass = Highpass_DefaultValue = new ColumnSeriesSonificationDefaultSpeechOptionsMappingHighpass();
			Lowpass = Lowpass_DefaultValue = new ColumnSeriesSonificationDefaultSpeechOptionsMappingLowpass();
			NoteDuration = NoteDuration_DefaultValue = new ColumnSeriesSonificationDefaultSpeechOptionsMappingNoteDuration();
			Pan = Pan_DefaultValue = new ColumnSeriesSonificationDefaultSpeechOptionsMappingPan();
			Pitch = Pitch_DefaultValue = new ColumnSeriesSonificationDefaultSpeechOptionsMappingPitch();
			PitchString = PitchString_DefaultValue = "null";
			PitchNumber = PitchNumber_DefaultValue = null;
			PlayDelay = PlayDelay_DefaultValue = new ColumnSeriesSonificationDefaultSpeechOptionsMappingPlayDelay();
			Time = Time_DefaultValue = new ColumnSeriesSonificationDefaultSpeechOptionsMappingTime();
			TimeString = TimeString_DefaultValue = "null";
			TimeNumber = TimeNumber_DefaultValue = null;
			Tremolo = Tremolo_DefaultValue = new ColumnSeriesSonificationDefaultSpeechOptionsMappingTremolo();
			Volume = Volume_DefaultValue = new ColumnSeriesSonificationDefaultSpeechOptionsMappingVolume();
		...
		/// </summary>
		public ColumnSeriesSonificationDefaultSpeechOptionsMappingFrequency Frequency { get; set; }
		private ColumnSeriesSonificationDefaultSpeechOptionsMappingFrequency Frequency_DefaultValue { get; set; }
		...
		/// </summary>
		public ColumnSeriesSonificationDefaultSpeechOptionsMappingGapBetweenNotes GapBetweenNotes { get; set; }
		private ColumnSeriesSonificationDefaultSpeechOptionsMappingGapBetweenNotes GapBetweenNotes_DefaultValue { get; set; }
		...
		/// </summary>
		public ColumnSeriesSonificationDefaultSpeechOptionsMappingHighpass Highpass { get; set; }
		private ColumnSeriesSonificationDefaultSpeechOptionsMappingHighpass Highpass_DefaultValue { get; set; }
		...
		/// </summary>
		public ColumnSeriesSonificationDefaultSpeechOptionsMappingLowpass Lowpass { get; set; }
		private ColumnSeriesSonificationDefaultSpeechOptionsMappingLowpass Lowpass_DefaultValue { get; set; }
		...
		/// </summary>
		public ColumnSeriesSonificationDefaultSpeechOptionsMappingNoteDuration NoteDuration { get; set; }
		private ColumnSeriesSonificationDefaultSpeechOptionsMappingNoteDuration NoteDuration_DefaultValue { get; set; }
		...
		/// </summary>
		public ColumnSeriesSonificationDefaultSpeechOptionsMappingPan Pan { get; set; }
		private ColumnSeriesSonificationDefaultSpeechOptionsMappingPan Pan_DefaultValue { get; set; }
		...
		/// </summary>
		public ColumnSeriesSonificationDefaultSpeechOptionsMappingPitch Pitch { get; set; }
		private ColumnSeriesSonificationDefaultSpeechOptionsMappingPitch Pitch_DefaultValue { get; set; }
		...
		/// </summary>
		public ColumnSeriesSonificationDefaultSpeechOptionsMappingPlayDelay PlayDelay { get; set; }
		private ColumnSeriesSonificationDefaultSpeechOptionsMappingPlayDelay PlayDelay_DefaultValue { get; set; }
		...
		/// </summary>
		public ColumnSeriesSonificationDefaultSpeechOptionsMappingTime Time { get; set; }
		private ColumnSeriesSonificationDefaultSpeechOptionsMappingTime Time_DefaultValue { get; set; }
		...
		/// </summary>
		public ColumnSeriesSonificationDefaultSpeechOptionsMappingTremolo Tremolo { get; set; }
		private ColumnSeriesSonificationDefaultSpeechOptionsMappingTremolo Tremolo_DefaultValue { get; set; }
		 

		/// <summary>
		/// The volume of notes, from 0 to 1.
		/// </summary>
		public ColumnSeriesSonificationDefaultSpeechOptionsMappingVolume Volume { get; set; }
		private ColumnSeriesSonificationDefaultSpeechOptionsMappingVolume Volume_DefaultValue { get; set; }
