...
namespace Highsoft.Web.Mvc.Stocks
{
	public partial class ColumnSeriesSonificationDefaultSpeechOptionsPointGrouping  : BaseObject
	{
		...
		{
			if (Algorithm != ColumnSeriesSonificationDefaultSpeechOptionsPointGroupingAlgorithm.Null) h.Add("algorithm", highstock.FirstCharacterToLower(Algorithm.ToString()));
