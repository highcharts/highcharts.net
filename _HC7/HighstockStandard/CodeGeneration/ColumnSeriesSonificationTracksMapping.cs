...
{
	public partial class ColumnSeriesSonificationTracksMapping  : BaseObject
	{
		Hashtable h = new Hashtable();

		public ColumnSeriesSonificationTracksMapping()
		{
			Frequency = Frequency_DefaultValue = new ColumnSeriesSonificationTracksMappingFrequency();
			GapBetweenNotes = GapBetweenNotes_DefaultValue = new ColumnSeriesSonificationTracksMappingGapBetweenNotes();
			Highpass = Highpass_DefaultValue = new ColumnSeriesSonificationTracksMappingHighpass();
			Lowpass = Lowpass_DefaultValue = new ColumnSeriesSonificationTracksMappingLowpass();
			NoteDuration = NoteDuration_DefaultValue = new ColumnSeriesSonificationTracksMappingNoteDuration();
			Pan = Pan_DefaultValue = new ColumnSeriesSonificationTracksMappingPan();
			Pitch = Pitch_DefaultValue = new ColumnSeriesSonificationTracksMappingPitch();
			PitchString = PitchString_DefaultValue = "null";
			PitchNumber = PitchNumber_DefaultValue = null;
			PlayDelay = PlayDelay_DefaultValue = new ColumnSeriesSonificationTracksMappingPlayDelay();
			Time = Time_DefaultValue = new ColumnSeriesSonificationTracksMappingTime();
			TimeString = TimeString_DefaultValue = "null";
			TimeNumber = TimeNumber_DefaultValue = null;
			Tremolo = Tremolo_DefaultValue = new ColumnSeriesSonificationTracksMappingTremolo();
			Volume = Volume_DefaultValue = new ColumnSeriesSonificationTracksMappingVolume();
		...
		/// </summary>
		public ColumnSeriesSonificationTracksMappingFrequency Frequency { get; set; }
		private ColumnSeriesSonificationTracksMappingFrequency Frequency_DefaultValue { get; set; }
		...
		/// </summary>
		public ColumnSeriesSonificationTracksMappingGapBetweenNotes GapBetweenNotes { get; set; }
		private ColumnSeriesSonificationTracksMappingGapBetweenNotes GapBetweenNotes_DefaultValue { get; set; }
		...
		/// </summary>
		public ColumnSeriesSonificationTracksMappingHighpass Highpass { get; set; }
		private ColumnSeriesSonificationTracksMappingHighpass Highpass_DefaultValue { get; set; }
		...
		/// </summary>
		public ColumnSeriesSonificationTracksMappingLowpass Lowpass { get; set; }
		private ColumnSeriesSonificationTracksMappingLowpass Lowpass_DefaultValue { get; set; }
		...
		/// </summary>
		public ColumnSeriesSonificationTracksMappingNoteDuration NoteDuration { get; set; }
		private ColumnSeriesSonificationTracksMappingNoteDuration NoteDuration_DefaultValue { get; set; }
		...
		/// </summary>
		public ColumnSeriesSonificationTracksMappingPan Pan { get; set; }
		private ColumnSeriesSonificationTracksMappingPan Pan_DefaultValue { get; set; }
		...
		/// </summary>
		public ColumnSeriesSonificationTracksMappingPitch Pitch { get; set; }
		private ColumnSeriesSonificationTracksMappingPitch Pitch_DefaultValue { get; set; }
		...
		/// </summary>
		public ColumnSeriesSonificationTracksMappingPlayDelay PlayDelay { get; set; }
		private ColumnSeriesSonificationTracksMappingPlayDelay PlayDelay_DefaultValue { get; set; }
		...
		/// </summary>
		public ColumnSeriesSonificationTracksMappingTime Time { get; set; }
		private ColumnSeriesSonificationTracksMappingTime Time_DefaultValue { get; set; }
		...
		/// </summary>
		public ColumnSeriesSonificationTracksMappingTremolo Tremolo { get; set; }
		private ColumnSeriesSonificationTracksMappingTremolo Tremolo_DefaultValue { get; set; }
		 

		/// <summary>
		/// The volume of notes, from 0 to 1.
		/// </summary>
		public ColumnSeriesSonificationTracksMappingVolume Volume { get; set; }
		private ColumnSeriesSonificationTracksMappingVolume Volume_DefaultValue { get; set; }
