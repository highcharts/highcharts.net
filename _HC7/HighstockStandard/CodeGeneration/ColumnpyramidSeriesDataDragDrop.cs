...
namespace Highsoft.Web.Mvc.Stocks
{
	public partial class ColumnpyramidSeriesDataDragDrop  : BaseObject
	{
		public ColumnpyramidSeriesDataDragDrop()
		{
			...
			DragHandle = DragHandle_DefaultValue = new ColumnpyramidSeriesDataDragDropDragHandle();
			...
			GuideBox = GuideBox_DefaultValue = new ColumnpyramidSeriesDataDragDropGuideBox();
