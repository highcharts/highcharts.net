...
namespace Highsoft.Web.Mvc.Stocks
{
	public partial class ColumnpyramidSeriesDataGrouping  : BaseObject
	{
		...
		internal override Hashtable ToHashtable()
		{
			...
			if (Approximation != Approximation_DefaultValue) { h.Add("approximation",Approximation); Highstock.AddFunction("ColumnpyramidSeriesDataGroupingApproximation.approximation", Approximation); }  
