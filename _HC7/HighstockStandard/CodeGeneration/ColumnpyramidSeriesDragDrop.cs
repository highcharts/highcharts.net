...
{
	public partial class ColumnpyramidSeriesDragDrop  : BaseObject
	{
		public ColumnpyramidSeriesDragDrop()
		{
			DraggableX = DraggableX_DefaultValue = null;
			DraggableY = DraggableY_DefaultValue = null;
			DragHandle = DragHandle_DefaultValue = new ColumnpyramidSeriesDragDropDragHandle();
			...
			GuideBox = GuideBox_DefaultValue = new ColumnpyramidSeriesDragDropGuideBox();
		...
		/// </summary>
		public ColumnpyramidSeriesDragDropDragHandle DragHandle { get; set; }
		private ColumnpyramidSeriesDragDropDragHandle DragHandle_DefaultValue { get; set; }
		...
		/// </summary>
		public ColumnpyramidSeriesDragDropGuideBox GuideBox { get; set; }
		private ColumnpyramidSeriesDragDropGuideBox GuideBox_DefaultValue { get; set; }
