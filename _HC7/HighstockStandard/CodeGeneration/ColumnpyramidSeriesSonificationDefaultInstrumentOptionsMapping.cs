...
{
	public partial class ColumnpyramidSeriesSonificationDefaultInstrumentOptionsMapping  : BaseObject
	{
		Hashtable h = new Hashtable();

		public ColumnpyramidSeriesSonificationDefaultInstrumentOptionsMapping()
		{
			Frequency = Frequency_DefaultValue = new ColumnpyramidSeriesSonificationDefaultInstrumentOptionsMappingFrequency();
			GapBetweenNotes = GapBetweenNotes_DefaultValue = new ColumnpyramidSeriesSonificationDefaultInstrumentOptionsMappingGapBetweenNotes();
			Highpass = Highpass_DefaultValue = new ColumnpyramidSeriesSonificationDefaultInstrumentOptionsMappingHighpass();
			Lowpass = Lowpass_DefaultValue = new ColumnpyramidSeriesSonificationDefaultInstrumentOptionsMappingLowpass();
			NoteDuration = NoteDuration_DefaultValue = new ColumnpyramidSeriesSonificationDefaultInstrumentOptionsMappingNoteDuration();
			Pan = Pan_DefaultValue = new ColumnpyramidSeriesSonificationDefaultInstrumentOptionsMappingPan();
			Pitch = Pitch_DefaultValue = new ColumnpyramidSeriesSonificationDefaultInstrumentOptionsMappingPitch();
			PitchString = PitchString_DefaultValue = "null";
			PitchNumber = PitchNumber_DefaultValue = null;
			PlayDelay = PlayDelay_DefaultValue = new ColumnpyramidSeriesSonificationDefaultInstrumentOptionsMappingPlayDelay();
			Time = Time_DefaultValue = new ColumnpyramidSeriesSonificationDefaultInstrumentOptionsMappingTime();
			TimeString = TimeString_DefaultValue = "null";
			TimeNumber = TimeNumber_DefaultValue = null;
			Tremolo = Tremolo_DefaultValue = new ColumnpyramidSeriesSonificationDefaultInstrumentOptionsMappingTremolo();
			Volume = Volume_DefaultValue = new ColumnpyramidSeriesSonificationDefaultInstrumentOptionsMappingVolume();
		...
		/// </summary>
		public ColumnpyramidSeriesSonificationDefaultInstrumentOptionsMappingFrequency Frequency { get; set; }
		private ColumnpyramidSeriesSonificationDefaultInstrumentOptionsMappingFrequency Frequency_DefaultValue { get; set; }
		...
		/// </summary>
		public ColumnpyramidSeriesSonificationDefaultInstrumentOptionsMappingGapBetweenNotes GapBetweenNotes { get; set; }
		private ColumnpyramidSeriesSonificationDefaultInstrumentOptionsMappingGapBetweenNotes GapBetweenNotes_DefaultValue { get; set; }
		...
		/// </summary>
		public ColumnpyramidSeriesSonificationDefaultInstrumentOptionsMappingHighpass Highpass { get; set; }
		private ColumnpyramidSeriesSonificationDefaultInstrumentOptionsMappingHighpass Highpass_DefaultValue { get; set; }
		...
		/// </summary>
		public ColumnpyramidSeriesSonificationDefaultInstrumentOptionsMappingLowpass Lowpass { get; set; }
		private ColumnpyramidSeriesSonificationDefaultInstrumentOptionsMappingLowpass Lowpass_DefaultValue { get; set; }
		...
		/// </summary>
		public ColumnpyramidSeriesSonificationDefaultInstrumentOptionsMappingNoteDuration NoteDuration { get; set; }
		private ColumnpyramidSeriesSonificationDefaultInstrumentOptionsMappingNoteDuration NoteDuration_DefaultValue { get; set; }
		...
		/// </summary>
		public ColumnpyramidSeriesSonificationDefaultInstrumentOptionsMappingPan Pan { get; set; }
		private ColumnpyramidSeriesSonificationDefaultInstrumentOptionsMappingPan Pan_DefaultValue { get; set; }
		...
		/// </summary>
		public ColumnpyramidSeriesSonificationDefaultInstrumentOptionsMappingPitch Pitch { get; set; }
		private ColumnpyramidSeriesSonificationDefaultInstrumentOptionsMappingPitch Pitch_DefaultValue { get; set; }
		...
		/// </summary>
		public ColumnpyramidSeriesSonificationDefaultInstrumentOptionsMappingPlayDelay PlayDelay { get; set; }
		private ColumnpyramidSeriesSonificationDefaultInstrumentOptionsMappingPlayDelay PlayDelay_DefaultValue { get; set; }
		...
		/// </summary>
		public ColumnpyramidSeriesSonificationDefaultInstrumentOptionsMappingTime Time { get; set; }
		private ColumnpyramidSeriesSonificationDefaultInstrumentOptionsMappingTime Time_DefaultValue { get; set; }
		...
		/// </summary>
		public ColumnpyramidSeriesSonificationDefaultInstrumentOptionsMappingTremolo Tremolo { get; set; }
		private ColumnpyramidSeriesSonificationDefaultInstrumentOptionsMappingTremolo Tremolo_DefaultValue { get; set; }
		 

		/// <summary>
		/// The volume of notes, from 0 to 1.
		/// </summary>
		public ColumnpyramidSeriesSonificationDefaultInstrumentOptionsMappingVolume Volume { get; set; }
		private ColumnpyramidSeriesSonificationDefaultInstrumentOptionsMappingVolume Volume_DefaultValue { get; set; }
