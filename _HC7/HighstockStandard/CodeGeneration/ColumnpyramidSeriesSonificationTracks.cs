...
{
	public partial class ColumnpyramidSeriesSonificationTracks  : BaseObject
	{
		Hashtable h = new Hashtable();

		public ColumnpyramidSeriesSonificationTracks()
		{
			ActiveWhen = ActiveWhen_DefaultValue = new ColumnpyramidSeriesSonificationTracksActiveWhen();
			Instrument = Instrument_DefaultValue = null;
			InstrumentString = InstrumentString_DefaultValue = "null";
			Mapping = Mapping_DefaultValue = new ColumnpyramidSeriesSonificationTracksMapping();
			MidiName = MidiName_DefaultValue = "";
			PointGrouping = PointGrouping_DefaultValue = new ColumnpyramidSeriesSonificationTracksPointGrouping();
			RoundToMusicalNotes = RoundToMusicalNotes_DefaultValue = true;
			ShowPlayMarker = ShowPlayMarker_DefaultValue = true;
			Type = Type_DefaultValue = ColumnpyramidSeriesSonificationTracksType.Instrument;
		...
		/// </summary>
		public ColumnpyramidSeriesSonificationTracksActiveWhen ActiveWhen { get; set; }
		private ColumnpyramidSeriesSonificationTracksActiveWhen ActiveWhen_DefaultValue { get; set; }
		...
		/// </summary>
		public ColumnpyramidSeriesSonificationTracksMapping Mapping { get; set; }
		private ColumnpyramidSeriesSonificationTracksMapping Mapping_DefaultValue { get; set; }
		...
		/// </summary>
		public ColumnpyramidSeriesSonificationTracksPointGrouping PointGrouping { get; set; }
		private ColumnpyramidSeriesSonificationTracksPointGrouping PointGrouping_DefaultValue { get; set; }
		...
		/// </summary>
		public ColumnpyramidSeriesSonificationTracksType Type { get; set; }
		private ColumnpyramidSeriesSonificationTracksType Type_DefaultValue { get; set; }
