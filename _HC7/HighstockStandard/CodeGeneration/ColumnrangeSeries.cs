...
namespace Highsoft.Web.Mvc.Stocks
{
	public partial class ColumnrangeSeries  : Series
	{
		...
		public ColumnrangeSeries()
		{
			...
			Compare = Compare_DefaultValue = ColumnrangeSeriesCompare.Percent;
			...
			DataSorting = DataSorting_DefaultValue = new ColumnrangeSeriesDataSorting();
			Depth = Depth_DefaultValue = 25;
			Description = Description_DefaultValue = "";
			DragDrop = DragDrop_DefaultValue = new ColumnrangeSeriesDragDrop();
			Dumbell = Dumbell_DefaultValue = new ColumnrangeSeriesDumbell();
			...
			LastPrice = LastPrice_DefaultValue = new ColumnrangeSeriesLastPrice();
			LastVisiblePrice = LastVisiblePrice_DefaultValue = new ColumnrangeSeriesLastVisiblePrice();
			LegendIndex = LegendIndex_DefaultValue = null;
			LegendSymbol = LegendSymbol_DefaultValue = ColumnrangeSeriesLegendSymbol.Rectangle;
			...
			Sonification = Sonification_DefaultValue = new ColumnrangeSeriesSonification();
			...
			Zones = Zones_DefaultValue = new List<ColumnrangeSeriesZones>();
		...
		/// </summary>
		public ColumnrangeSeriesAccessibility Accessibility { get; set; }
		private ColumnrangeSeriesAccessibility Accessibility_DefaultValue { get; set; }
		...
		/// </summary>
		public ColumnrangeSeriesBoostBlending BoostBlending { get; set; }
		private ColumnrangeSeriesBoostBlending BoostBlending_DefaultValue { get; set; }
		...
		/// </summary>
		public ColumnrangeSeriesCompare Compare { get; set; }
		private ColumnrangeSeriesCompare Compare_DefaultValue { get; set; }
		 

		/// <summary>
		/// When [compare](#plotOptions.series.compare) is `percent`, this optiondictates whether to use 0 or 100 as the base of comparison.
		/// </summary>
		public ColumnrangeSeriesCompareBase CompareBase { get; set; }
		private ColumnrangeSeriesCompareBase CompareBase_DefaultValue { get; set; }
		...
		/// </summary>
		public ColumnrangeSeriesDataSorting DataSorting { get; set; }
		private ColumnrangeSeriesDataSorting DataSorting_DefaultValue { get; set; }
		...
		/// </summary>
		public ColumnrangeSeriesDragDrop DragDrop { get; set; }
		private ColumnrangeSeriesDragDrop DragDrop_DefaultValue { get; set; }
		 

		/// <summary>
		/// 
		/// </summary>
		public ColumnrangeSeriesDumbell Dumbell { get; set; }
		private ColumnrangeSeriesDumbell Dumbell_DefaultValue { get; set; }
		...
		/// </summary>
		public ColumnrangeSeriesLastPrice LastPrice { get; set; }
		private ColumnrangeSeriesLastPrice LastPrice_DefaultValue { get; set; }
		 

		/// <summary>
		/// The line marks the last price from visible range of points.
		/// </summary>
		public ColumnrangeSeriesLastVisiblePrice LastVisiblePrice { get; set; }
		private ColumnrangeSeriesLastVisiblePrice LastVisiblePrice_DefaultValue { get; set; }
		...
		/// </summary>
		public ColumnrangeSeriesLegendSymbol LegendSymbol { get; set; }
		private ColumnrangeSeriesLegendSymbol LegendSymbol_DefaultValue { get; set; }
		...
		/// </summary>
		public ColumnrangeSeriesSonification Sonification { get; set; }
		private ColumnrangeSeriesSonification Sonification_DefaultValue { get; set; }
		...
		/// </summary>
		public List<ColumnrangeSeriesZones> Zones { get; set; }
		private List<ColumnrangeSeriesZones> Zones_DefaultValue { get; set; }
