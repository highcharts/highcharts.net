...
{
	public partial class ColumnrangeSeriesSonificationContextTracks  : BaseObject
	{
		Hashtable h = new Hashtable();

		public ColumnrangeSeriesSonificationContextTracks()
		{
			ActiveWhen = ActiveWhen_DefaultValue = new ColumnrangeSeriesSonificationContextTracksActiveWhen();
			Instrument = Instrument_DefaultValue = null;
			InstrumentString = InstrumentString_DefaultValue = "null";
			Mapping = Mapping_DefaultValue = new ColumnrangeSeriesSonificationContextTracksMapping();
			MidiName = MidiName_DefaultValue = "";
			PointGrouping = PointGrouping_DefaultValue = new ColumnrangeSeriesSonificationContextTracksPointGrouping();
			...
			Type = Type_DefaultValue = ColumnrangeSeriesSonificationContextTracksType.Instrument;
			ValueInterval = ValueInterval_DefaultValue = null;
			ValueMapFunction = ValueMapFunction_DefaultValue = ColumnrangeSeriesSonificationContextTracksValueMapFunction.Linear;
		...
		/// </summary>
		public ColumnrangeSeriesSonificationContextTracksActiveWhen ActiveWhen { get; set; }
		private ColumnrangeSeriesSonificationContextTracksActiveWhen ActiveWhen_DefaultValue { get; set; }
		...
		/// </summary>
		public ColumnrangeSeriesSonificationContextTracksMapping Mapping { get; set; }
		private ColumnrangeSeriesSonificationContextTracksMapping Mapping_DefaultValue { get; set; }
		...
		/// </summary>
		public ColumnrangeSeriesSonificationContextTracksPointGrouping PointGrouping { get; set; }
		private ColumnrangeSeriesSonificationContextTracksPointGrouping PointGrouping_DefaultValue { get; set; }
		...
		/// </summary>
		public ColumnrangeSeriesSonificationContextTracksType Type { get; set; }
		private ColumnrangeSeriesSonificationContextTracksType Type_DefaultValue { get; set; }
		...
		/// </summary>
		public ColumnrangeSeriesSonificationContextTracksValueMapFunction ValueMapFunction { get; set; }
		private ColumnrangeSeriesSonificationContextTracksValueMapFunction ValueMapFunction_DefaultValue { get; set; }
