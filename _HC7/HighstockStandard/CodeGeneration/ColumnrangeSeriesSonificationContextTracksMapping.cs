...
{
	public partial class ColumnrangeSeriesSonificationContextTracksMapping  : BaseObject
	{
		Hashtable h = new Hashtable();

		public ColumnrangeSeriesSonificationContextTracksMapping()
		{
			Frequency = Frequency_DefaultValue = new ColumnrangeSeriesSonificationContextTracksMappingFrequency();
			GapBetweenNotes = GapBetweenNotes_DefaultValue = new ColumnrangeSeriesSonificationContextTracksMappingGapBetweenNotes();
			Highpass = Highpass_DefaultValue = new ColumnrangeSeriesSonificationContextTracksMappingHighpass();
			Lowpass = Lowpass_DefaultValue = new ColumnrangeSeriesSonificationContextTracksMappingLowpass();
			NoteDuration = NoteDuration_DefaultValue = new ColumnrangeSeriesSonificationContextTracksMappingNoteDuration();
			Pan = Pan_DefaultValue = new ColumnrangeSeriesSonificationContextTracksMappingPan();
			Pitch = Pitch_DefaultValue = new ColumnrangeSeriesSonificationContextTracksMappingPitch();
			PitchString = PitchString_DefaultValue = "null";
			PitchNumber = PitchNumber_DefaultValue = null;
			PlayDelay = PlayDelay_DefaultValue = new ColumnrangeSeriesSonificationContextTracksMappingPlayDelay();
			Time = Time_DefaultValue = new ColumnrangeSeriesSonificationContextTracksMappingTime();
			TimeString = TimeString_DefaultValue = "null";
			TimeNumber = TimeNumber_DefaultValue = null;
			Tremolo = Tremolo_DefaultValue = new ColumnrangeSeriesSonificationContextTracksMappingTremolo();
			Volume = Volume_DefaultValue = new ColumnrangeSeriesSonificationContextTracksMappingVolume();
		...
		/// </summary>
		public ColumnrangeSeriesSonificationContextTracksMappingFrequency Frequency { get; set; }
		private ColumnrangeSeriesSonificationContextTracksMappingFrequency Frequency_DefaultValue { get; set; }
		...
		/// </summary>
		public ColumnrangeSeriesSonificationContextTracksMappingGapBetweenNotes GapBetweenNotes { get; set; }
		private ColumnrangeSeriesSonificationContextTracksMappingGapBetweenNotes GapBetweenNotes_DefaultValue { get; set; }
		...
		/// </summary>
		public ColumnrangeSeriesSonificationContextTracksMappingHighpass Highpass { get; set; }
		private ColumnrangeSeriesSonificationContextTracksMappingHighpass Highpass_DefaultValue { get; set; }
		...
		/// </summary>
		public ColumnrangeSeriesSonificationContextTracksMappingLowpass Lowpass { get; set; }
		private ColumnrangeSeriesSonificationContextTracksMappingLowpass Lowpass_DefaultValue { get; set; }
		...
		/// </summary>
		public ColumnrangeSeriesSonificationContextTracksMappingNoteDuration NoteDuration { get; set; }
		private ColumnrangeSeriesSonificationContextTracksMappingNoteDuration NoteDuration_DefaultValue { get; set; }
		...
		/// </summary>
		public ColumnrangeSeriesSonificationContextTracksMappingPan Pan { get; set; }
		private ColumnrangeSeriesSonificationContextTracksMappingPan Pan_DefaultValue { get; set; }
		...
		/// </summary>
		public ColumnrangeSeriesSonificationContextTracksMappingPitch Pitch { get; set; }
		private ColumnrangeSeriesSonificationContextTracksMappingPitch Pitch_DefaultValue { get; set; }
		...
		/// </summary>
		public ColumnrangeSeriesSonificationContextTracksMappingPlayDelay PlayDelay { get; set; }
		private ColumnrangeSeriesSonificationContextTracksMappingPlayDelay PlayDelay_DefaultValue { get; set; }
		...
		/// </summary>
		public ColumnrangeSeriesSonificationContextTracksMappingTime Time { get; set; }
		private ColumnrangeSeriesSonificationContextTracksMappingTime Time_DefaultValue { get; set; }
		...
		/// </summary>
		public ColumnrangeSeriesSonificationContextTracksMappingTremolo Tremolo { get; set; }
		private ColumnrangeSeriesSonificationContextTracksMappingTremolo Tremolo_DefaultValue { get; set; }
		 

		/// <summary>
		/// The volume of notes, from 0 to 1.
		/// </summary>
		public ColumnrangeSeriesSonificationContextTracksMappingVolume Volume { get; set; }
		private ColumnrangeSeriesSonificationContextTracksMappingVolume Volume_DefaultValue { get; set; }
