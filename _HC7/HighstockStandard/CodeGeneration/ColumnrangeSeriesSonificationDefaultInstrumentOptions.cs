...
{
	public partial class ColumnrangeSeriesSonificationDefaultInstrumentOptions  : BaseObject
	{
		Hashtable h = new Hashtable();

		public ColumnrangeSeriesSonificationDefaultInstrumentOptions()
		{
			ActiveWhen = ActiveWhen_DefaultValue = new ColumnrangeSeriesSonificationDefaultInstrumentOptionsActiveWhen();
			Instrument = Instrument_DefaultValue = null;
			InstrumentString = InstrumentString_DefaultValue = "null";
			Mapping = Mapping_DefaultValue = new ColumnrangeSeriesSonificationDefaultInstrumentOptionsMapping();
			MidiName = MidiName_DefaultValue = "";
			PointGrouping = PointGrouping_DefaultValue = new ColumnrangeSeriesSonificationDefaultInstrumentOptionsPointGrouping();
			RoundToMusicalNotes = RoundToMusicalNotes_DefaultValue = true;
			ShowPlayMarker = ShowPlayMarker_DefaultValue = true;
			Type = Type_DefaultValue = ColumnrangeSeriesSonificationDefaultInstrumentOptionsType.Instrument;
		...
		/// </summary>
		public ColumnrangeSeriesSonificationDefaultInstrumentOptionsActiveWhen ActiveWhen { get; set; }
		private ColumnrangeSeriesSonificationDefaultInstrumentOptionsActiveWhen ActiveWhen_DefaultValue { get; set; }
		...
		/// </summary>
		public ColumnrangeSeriesSonificationDefaultInstrumentOptionsMapping Mapping { get; set; }
		private ColumnrangeSeriesSonificationDefaultInstrumentOptionsMapping Mapping_DefaultValue { get; set; }
		...
		/// </summary>
		public ColumnrangeSeriesSonificationDefaultInstrumentOptionsPointGrouping PointGrouping { get; set; }
		private ColumnrangeSeriesSonificationDefaultInstrumentOptionsPointGrouping PointGrouping_DefaultValue { get; set; }
		...
		/// </summary>
		public ColumnrangeSeriesSonificationDefaultInstrumentOptionsType Type { get; set; }
		private ColumnrangeSeriesSonificationDefaultInstrumentOptionsType Type_DefaultValue { get; set; }
