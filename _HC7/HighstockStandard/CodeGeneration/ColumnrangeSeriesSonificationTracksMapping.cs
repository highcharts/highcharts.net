...
{
	public partial class ColumnrangeSeriesSonificationTracksMapping  : BaseObject
	{
		Hashtable h = new Hashtable();

		public ColumnrangeSeriesSonificationTracksMapping()
		{
			Frequency = Frequency_DefaultValue = new ColumnrangeSeriesSonificationTracksMappingFrequency();
			GapBetweenNotes = GapBetweenNotes_DefaultValue = new ColumnrangeSeriesSonificationTracksMappingGapBetweenNotes();
			Highpass = Highpass_DefaultValue = new ColumnrangeSeriesSonificationTracksMappingHighpass();
			Lowpass = Lowpass_DefaultValue = new ColumnrangeSeriesSonificationTracksMappingLowpass();
			NoteDuration = NoteDuration_DefaultValue = new ColumnrangeSeriesSonificationTracksMappingNoteDuration();
			Pan = Pan_DefaultValue = new ColumnrangeSeriesSonificationTracksMappingPan();
			Pitch = Pitch_DefaultValue = new ColumnrangeSeriesSonificationTracksMappingPitch();
			PitchString = PitchString_DefaultValue = "null";
			PitchNumber = PitchNumber_DefaultValue = null;
			PlayDelay = PlayDelay_DefaultValue = new ColumnrangeSeriesSonificationTracksMappingPlayDelay();
			Time = Time_DefaultValue = new ColumnrangeSeriesSonificationTracksMappingTime();
			TimeString = TimeString_DefaultValue = "null";
			TimeNumber = TimeNumber_DefaultValue = null;
			Tremolo = Tremolo_DefaultValue = new ColumnrangeSeriesSonificationTracksMappingTremolo();
			Volume = Volume_DefaultValue = new ColumnrangeSeriesSonificationTracksMappingVolume();
		...
		/// </summary>
		public ColumnrangeSeriesSonificationTracksMappingFrequency Frequency { get; set; }
		private ColumnrangeSeriesSonificationTracksMappingFrequency Frequency_DefaultValue { get; set; }
		...
		/// </summary>
		public ColumnrangeSeriesSonificationTracksMappingGapBetweenNotes GapBetweenNotes { get; set; }
		private ColumnrangeSeriesSonificationTracksMappingGapBetweenNotes GapBetweenNotes_DefaultValue { get; set; }
		...
		/// </summary>
		public ColumnrangeSeriesSonificationTracksMappingHighpass Highpass { get; set; }
		private ColumnrangeSeriesSonificationTracksMappingHighpass Highpass_DefaultValue { get; set; }
		...
		/// </summary>
		public ColumnrangeSeriesSonificationTracksMappingLowpass Lowpass { get; set; }
		private ColumnrangeSeriesSonificationTracksMappingLowpass Lowpass_DefaultValue { get; set; }
		...
		/// </summary>
		public ColumnrangeSeriesSonificationTracksMappingNoteDuration NoteDuration { get; set; }
		private ColumnrangeSeriesSonificationTracksMappingNoteDuration NoteDuration_DefaultValue { get; set; }
		...
		/// </summary>
		public ColumnrangeSeriesSonificationTracksMappingPan Pan { get; set; }
		private ColumnrangeSeriesSonificationTracksMappingPan Pan_DefaultValue { get; set; }
		...
		/// </summary>
		public ColumnrangeSeriesSonificationTracksMappingPitch Pitch { get; set; }
		private ColumnrangeSeriesSonificationTracksMappingPitch Pitch_DefaultValue { get; set; }
		...
		/// </summary>
		public ColumnrangeSeriesSonificationTracksMappingPlayDelay PlayDelay { get; set; }
		private ColumnrangeSeriesSonificationTracksMappingPlayDelay PlayDelay_DefaultValue { get; set; }
		...
		/// </summary>
		public ColumnrangeSeriesSonificationTracksMappingTime Time { get; set; }
		private ColumnrangeSeriesSonificationTracksMappingTime Time_DefaultValue { get; set; }
		...
		/// </summary>
		public ColumnrangeSeriesSonificationTracksMappingTremolo Tremolo { get; set; }
		private ColumnrangeSeriesSonificationTracksMappingTremolo Tremolo_DefaultValue { get; set; }
		 

		/// <summary>
		/// The volume of notes, from 0 to 1.
		/// </summary>
		public ColumnrangeSeriesSonificationTracksMappingVolume Volume { get; set; }
		private ColumnrangeSeriesSonificationTracksMappingVolume Volume_DefaultValue { get; set; }
