...
namespace Highsoft.Web.Mvc.Stocks
{
	public partial class ColumnrangeSeriesTooltip  : BaseObject
	{
		public ColumnrangeSeriesTooltip()
		{
			...
			HeaderShape = HeaderShape_DefaultValue = ColumnrangeSeriesTooltipHeaderShape.Callout;
		...
		/// </summary>
		public ColumnrangeSeriesTooltipHeaderShape HeaderShape { get; set; }
		private ColumnrangeSeriesTooltipHeaderShape HeaderShape_DefaultValue { get; set; }
		...
		internal override Hashtable ToHashtable()
		{
			...
			if (NullFormatter != NullFormatter_DefaultValue) { h.Add("nullFormatter",NullFormatter); Highstock.AddFunction("ColumnrangeSeriesTooltipNullFormatter.nullFormatter", NullFormatter); }  
			if (Outside != Outside_DefaultValue) h.Add("outside",Outside);
			if (Padding != Padding_DefaultValue) h.Add("padding",Padding);
			if (PointFormat != PointFormat_DefaultValue) h.Add("pointFormat",PointFormat);
			if (PointFormatter != PointFormatter_DefaultValue) { h.Add("pointFormatter",PointFormatter); Highstock.AddFunction("ColumnrangeSeriesTooltipPointFormatter.pointFormatter", PointFormatter); }  
