...
namespace Highsoft.Web.Mvc.Stocks
{
	public partial class Data  : BaseObject
	{
		...
		{
			if (BeforeParse != null) { h.Add("beforeParse",BeforeParse); highstock.AddFunction("beforeParse", BeforeParse); }  
			if (Columns != null) h.Add("columns",Columns);
			if (ColumnsURL != null) h.Add("columnsURL",ColumnsURL);
			if (ColumnTypes != DataColumnTypes.Null) h.Add("columnTypes", highstock.FirstCharacterToLower(ColumnTypes.ToString()));
			if (Complete != null) { h.Add("complete",Complete); highstock.AddFunction("complete", Complete); }  
			...
			if (Parsed != null) { h.Add("parsed",Parsed); highstock.AddFunction("parsed", Parsed); }  
			if (ParseDate != null) { h.Add("parseDate",ParseDate); highstock.AddFunction("parseDate", ParseDate); }  
