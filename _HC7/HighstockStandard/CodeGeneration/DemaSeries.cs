...
{
	public partial class DemaSeries  : Series
	{
		Hashtable h = new Hashtable();

		public DemaSeries()
		{
			Accessibility = Accessibility_DefaultValue = new DemaSeriesAccessibility();
			AllowPointSelect = AllowPointSelect_DefaultValue = false;
			Animation = Animation_DefaultValue = new Animation() { Enabled = true };
			AnimationBool = AnimationBool_DefaultValue = true;
			AnimationLimit = AnimationLimit_DefaultValue = null;
			BoostBlending = BoostBlending_DefaultValue = DemaSeriesBoostBlending.Undefined;
			...
			Cursor = Cursor_DefaultValue = DemaSeriesCursor.Null;
			Custom = Custom_DefaultValue = new Hashtable();
			DashStyle = DashStyle_DefaultValue = DemaSeriesDashStyle.Null;
			DataGrouping = DataGrouping_DefaultValue = new DemaSeriesDataGrouping();
			DataLabels = DataLabels_DefaultValue = new DemaSeriesDataLabels();
			DataSorting = DataSorting_DefaultValue = new DemaSeriesDataSorting();
			Description = Description_DefaultValue = "";
			Dumbell = Dumbell_DefaultValue = new DemaSeriesDumbell();
			EnableMouseTracking = EnableMouseTracking_DefaultValue = true;
			Events = Events_DefaultValue = new DemaSeriesEvents();
			FindNearestPointBy = FindNearestPointBy_DefaultValue = DemaSeriesFindNearestPointBy.X;
			GapSize = GapSize_DefaultValue = 0;
			GapUnit = GapUnit_DefaultValue = DemaSeriesGapUnit.Relative;
			GetExtremesFromAll = GetExtremesFromAll_DefaultValue = false;
			Id = Id_DefaultValue = "";
			InactiveOtherPoints = InactiveOtherPoints_DefaultValue = false;
			IncludeInDataExport = IncludeInDataExport_DefaultValue = null;
			Index = Index_DefaultValue = null;
			Label = Label_DefaultValue = new DemaSeriesLabel();
			LastPrice = LastPrice_DefaultValue = new DemaSeriesLastPrice();
			LastVisiblePrice = LastVisiblePrice_DefaultValue = new DemaSeriesLastVisiblePrice();
			LegendIndex = LegendIndex_DefaultValue = null;
			LegendSymbol = LegendSymbol_DefaultValue = DemaSeriesLegendSymbol.Rectangle;
			Linecap = Linecap_DefaultValue = DemaSeriesLinecap.Round;
			LineWidth = LineWidth_DefaultValue = 2;
			LinkedTo = LinkedTo_DefaultValue = "";
			Marker = Marker_DefaultValue = new DemaSeriesMarker();
			Name = Name_DefaultValue = "";
			NegativeColor = NegativeColor_DefaultValue = "";
			OnPoint = OnPoint_DefaultValue = new DemaSeriesOnPoint();
			Opacity = Opacity_DefaultValue = 1;
			Params = Params_DefaultValue = new DemaSeriesParams();
			Point = Point_DefaultValue = new DemaSeriesPoint();
			...
			Sonification = Sonification_DefaultValue = new DemaSeriesSonification();
			Stack = Stack_DefaultValue = "";
			StackNumber = StackNumber_DefaultValue = null;
			States = States_DefaultValue = new DemaSeriesStates();
			Step = Step_DefaultValue = DemaSeriesStep.Null;
			StickyTracking = StickyTracking_DefaultValue = true;
			Threshold = Threshold_DefaultValue = 0;
			Tooltip = Tooltip_DefaultValue = new DemaSeriesTooltip();
			...
			Zones = Zones_DefaultValue = new List<DemaSeriesZones>();
		...
		/// </summary>
		public DemaSeriesAccessibility Accessibility { get; set; }
		private DemaSeriesAccessibility Accessibility_DefaultValue { get; set; }
		...
		/// </summary>
		public DemaSeriesBoostBlending BoostBlending { get; set; }
		private DemaSeriesBoostBlending BoostBlending_DefaultValue { get; set; }
		...
		/// </summary>
		public DemaSeriesCursor Cursor { get; set; }
		private DemaSeriesCursor Cursor_DefaultValue { get; set; }
		...
		/// </summary>
		public DemaSeriesDashStyle DashStyle { get; set; }
		private DemaSeriesDashStyle DashStyle_DefaultValue { get; set; }
		...
		/// </summary>
		public DemaSeriesDataGrouping DataGrouping { get; set; }
		private DemaSeriesDataGrouping DataGrouping_DefaultValue { get; set; }
		...
		/// </summary>
		public DemaSeriesDataLabels DataLabels { get; set; }
		private DemaSeriesDataLabels DataLabels_DefaultValue { get; set; }
		 

		/// <summary>
		/// Options for the series data sorting.
		/// </summary>
		public DemaSeriesDataSorting DataSorting { get; set; }
		private DemaSeriesDataSorting DataSorting_DefaultValue { get; set; }
		...
		/// 
		/// </summary>
		public DemaSeriesDumbell Dumbell { get; set; }
		private DemaSeriesDumbell Dumbell_DefaultValue { get; set; }
		...
		/// </summary>
		public DemaSeriesEvents Events { get; set; }
		private DemaSeriesEvents Events_DefaultValue { get; set; }
		...
		/// </summary>
		public DemaSeriesFindNearestPointBy FindNearestPointBy { get; set; }
		private DemaSeriesFindNearestPointBy FindNearestPointBy_DefaultValue { get; set; }
		...
		/// </summary>
		public DemaSeriesGapUnit GapUnit { get; set; }
		private DemaSeriesGapUnit GapUnit_DefaultValue { get; set; }
		...
		/// </summary>
		public DemaSeriesLabel Label { get; set; }
		private DemaSeriesLabel Label_DefaultValue { get; set; }
		 

		/// <summary>
		/// The line marks the last price from all points.
		/// </summary>
		public DemaSeriesLastPrice LastPrice { get; set; }
		private DemaSeriesLastPrice LastPrice_DefaultValue { get; set; }
		 

		/// <summary>
		/// The line marks the last price from visible range of points.
		/// </summary>
		public DemaSeriesLastVisiblePrice LastVisiblePrice { get; set; }
		private DemaSeriesLastVisiblePrice LastVisiblePrice_DefaultValue { get; set; }
		...
		/// </summary>
		public DemaSeriesLegendSymbol LegendSymbol { get; set; }
		private DemaSeriesLegendSymbol LegendSymbol_DefaultValue { get; set; }
		 

		/// <summary>
		/// The line cap used for line ends and line joins on the graph.
		/// </summary>
		public DemaSeriesLinecap Linecap { get; set; }
		private DemaSeriesLinecap Linecap_DefaultValue { get; set; }
		...
		/// </summary>
		public DemaSeriesMarker Marker { get; set; }
		private DemaSeriesMarker Marker_DefaultValue { get; set; }
		...
		/// </summary>
		public DemaSeriesOnPoint OnPoint { get; set; }
		private DemaSeriesOnPoint OnPoint_DefaultValue { get; set; }
		...
		/// </summary>
		public DemaSeriesParams Params { get; set; }
		private DemaSeriesParams Params_DefaultValue { get; set; }
		 

		/// <summary>
		/// Properties for each single point.
		/// </summary>
		public DemaSeriesPoint Point { get; set; }
		private DemaSeriesPoint Point_DefaultValue { get; set; }
		...
		/// </summary>
		public DemaSeriesSonification Sonification { get; set; }
		private DemaSeriesSonification Sonification_DefaultValue { get; set; }
		...
		/// 
		/// </summary>
		public DemaSeriesStates States { get; set; }
		private DemaSeriesStates States_DefaultValue { get; set; }
		 

		/// <summary>
		/// Whether to apply steps to the line. Possible values are `left`,`center` and `right`.
		/// </summary>
		public DemaSeriesStep Step { get; set; }
		private DemaSeriesStep Step_DefaultValue { get; set; }
		...
		/// </summary>
		public DemaSeriesTooltip Tooltip { get; set; }
		private DemaSeriesTooltip Tooltip_DefaultValue { get; set; }
		...
		/// </summary>
		public List<DemaSeriesZones> Zones { get; set; }
		private List<DemaSeriesZones> Zones_DefaultValue { get; set; }
