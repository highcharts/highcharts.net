...
namespace Highsoft.Web.Mvc.Stocks
{
	public partial class DemaSeriesDataGrouping  : BaseObject
	{
		...
		internal override Hashtable ToHashtable()
		{
			...
			if (Approximation != Approximation_DefaultValue) { h.Add("approximation",Approximation); Highstock.AddFunction("DemaSeriesDataGroupingApproximation.approximation", Approximation); }  
