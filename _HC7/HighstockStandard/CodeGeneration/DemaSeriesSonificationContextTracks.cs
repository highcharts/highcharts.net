...
{
	public partial class DemaSeriesSonificationContextTracks  : BaseObject
	{
		Hashtable h = new Hashtable();

		public DemaSeriesSonificationContextTracks()
		{
			ActiveWhen = ActiveWhen_DefaultValue = new DemaSeriesSonificationContextTracksActiveWhen();
			Instrument = Instrument_DefaultValue = null;
			InstrumentString = InstrumentString_DefaultValue = "null";
			Mapping = Mapping_DefaultValue = new DemaSeriesSonificationContextTracksMapping();
			MidiName = MidiName_DefaultValue = "";
			PointGrouping = PointGrouping_DefaultValue = new DemaSeriesSonificationContextTracksPointGrouping();
			...
			Type = Type_DefaultValue = DemaSeriesSonificationContextTracksType.Instrument;
			ValueInterval = ValueInterval_DefaultValue = null;
			ValueMapFunction = ValueMapFunction_DefaultValue = DemaSeriesSonificationContextTracksValueMapFunction.Linear;
		...
		/// </summary>
		public DemaSeriesSonificationContextTracksActiveWhen ActiveWhen { get; set; }
		private DemaSeriesSonificationContextTracksActiveWhen ActiveWhen_DefaultValue { get; set; }
		...
		/// </summary>
		public DemaSeriesSonificationContextTracksMapping Mapping { get; set; }
		private DemaSeriesSonificationContextTracksMapping Mapping_DefaultValue { get; set; }
		...
		/// </summary>
		public DemaSeriesSonificationContextTracksPointGrouping PointGrouping { get; set; }
		private DemaSeriesSonificationContextTracksPointGrouping PointGrouping_DefaultValue { get; set; }
		...
		/// </summary>
		public DemaSeriesSonificationContextTracksType Type { get; set; }
		private DemaSeriesSonificationContextTracksType Type_DefaultValue { get; set; }
		...
		/// </summary>
		public DemaSeriesSonificationContextTracksValueMapFunction ValueMapFunction { get; set; }
		private DemaSeriesSonificationContextTracksValueMapFunction ValueMapFunction_DefaultValue { get; set; }
