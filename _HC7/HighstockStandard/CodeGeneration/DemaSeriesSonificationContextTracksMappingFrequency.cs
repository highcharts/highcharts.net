...
{
	public partial class DemaSeriesSonificationContextTracksMappingFrequency  : BaseObject
	{
		Hashtable h = new Hashtable();

		public DemaSeriesSonificationContextTracksMappingFrequency()
		{
			MapFunction = MapFunction_DefaultValue = DemaSeriesSonificationContextTracksMappingFrequencyMapFunction.Linear;
			MapTo = MapTo_DefaultValue = "";
			Max = Max_DefaultValue = null;
			Min = Min_DefaultValue = null;
			Value = Value_DefaultValue = null;
			Within = Within_DefaultValue = DemaSeriesSonificationContextTracksMappingFrequencyWithin.Chart;
		...
		/// </summary>
		public DemaSeriesSonificationContextTracksMappingFrequencyMapFunction MapFunction { get; set; }
		private DemaSeriesSonificationContextTracksMappingFrequencyMapFunction MapFunction_DefaultValue { get; set; }
		...
		/// </summary>
		public DemaSeriesSonificationContextTracksMappingFrequencyWithin Within { get; set; }
		private DemaSeriesSonificationContextTracksMappingFrequencyWithin Within_DefaultValue { get; set; }
