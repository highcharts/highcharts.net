...
{
	public partial class DemaSeriesSonificationContextTracksMappingGapBetweenNotes  : BaseObject
	{
		Hashtable h = new Hashtable();

		public DemaSeriesSonificationContextTracksMappingGapBetweenNotes()
		{
			MapFunction = MapFunction_DefaultValue = DemaSeriesSonificationContextTracksMappingGapBetweenNotesMapFunction.Linear;
			MapTo = MapTo_DefaultValue = "";
			Max = Max_DefaultValue = null;
			Min = Min_DefaultValue = null;
			Value = Value_DefaultValue = null;
			Within = Within_DefaultValue = DemaSeriesSonificationContextTracksMappingGapBetweenNotesWithin.Chart;
		...
		/// </summary>
		public DemaSeriesSonificationContextTracksMappingGapBetweenNotesMapFunction MapFunction { get; set; }
		private DemaSeriesSonificationContextTracksMappingGapBetweenNotesMapFunction MapFunction_DefaultValue { get; set; }
		...
		/// </summary>
		public DemaSeriesSonificationContextTracksMappingGapBetweenNotesWithin Within { get; set; }
		private DemaSeriesSonificationContextTracksMappingGapBetweenNotesWithin Within_DefaultValue { get; set; }
