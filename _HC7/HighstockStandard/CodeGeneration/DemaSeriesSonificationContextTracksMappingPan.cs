...
{
	public partial class DemaSeriesSonificationContextTracksMappingPan  : BaseObject
	{
		Hashtable h = new Hashtable();

		public DemaSeriesSonificationContextTracksMappingPan()
		{
			MapFunction = MapFunction_DefaultValue = DemaSeriesSonificationContextTracksMappingPanMapFunction.Linear;
			MapTo = MapTo_DefaultValue = "";
			Max = Max_DefaultValue = null;
			Min = Min_DefaultValue = null;
			Value = Value_DefaultValue = null;
			Within = Within_DefaultValue = DemaSeriesSonificationContextTracksMappingPanWithin.Chart;
		...
		/// </summary>
		public DemaSeriesSonificationContextTracksMappingPanMapFunction MapFunction { get; set; }
		private DemaSeriesSonificationContextTracksMappingPanMapFunction MapFunction_DefaultValue { get; set; }
		...
		/// </summary>
		public DemaSeriesSonificationContextTracksMappingPanWithin Within { get; set; }
		private DemaSeriesSonificationContextTracksMappingPanWithin Within_DefaultValue { get; set; }
