...
{
	public partial class DemaSeriesSonificationContextTracksMappingPitch  : BaseObject
	{
		Hashtable h = new Hashtable();

		public DemaSeriesSonificationContextTracksMappingPitch()
		{
			MapFunction = MapFunction_DefaultValue = DemaSeriesSonificationContextTracksMappingPitchMapFunction.Linear;
		...
		/// </summary>
		public DemaSeriesSonificationContextTracksMappingPitchMapFunction MapFunction { get; set; }
		private DemaSeriesSonificationContextTracksMappingPitchMapFunction MapFunction_DefaultValue { get; set; }
