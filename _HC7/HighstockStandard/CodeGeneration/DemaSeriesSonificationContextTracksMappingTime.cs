...
{
	public partial class DemaSeriesSonificationContextTracksMappingTime  : BaseObject
	{
		Hashtable h = new Hashtable();

		public DemaSeriesSonificationContextTracksMappingTime()
		{
			MapFunction = MapFunction_DefaultValue = DemaSeriesSonificationContextTracksMappingTimeMapFunction.Linear;
			MapTo = MapTo_DefaultValue = "";
			Max = Max_DefaultValue = null;
			Min = Min_DefaultValue = null;
			Value = Value_DefaultValue = null;
			Within = Within_DefaultValue = DemaSeriesSonificationContextTracksMappingTimeWithin.Chart;
		...
		/// </summary>
		public DemaSeriesSonificationContextTracksMappingTimeMapFunction MapFunction { get; set; }
		private DemaSeriesSonificationContextTracksMappingTimeMapFunction MapFunction_DefaultValue { get; set; }
		...
		/// </summary>
		public DemaSeriesSonificationContextTracksMappingTimeWithin Within { get; set; }
		private DemaSeriesSonificationContextTracksMappingTimeWithin Within_DefaultValue { get; set; }
