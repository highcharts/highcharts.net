...
{
	public partial class DemaSeriesSonificationDefaultSpeechOptionsMapping  : BaseObject
	{
		Hashtable h = new Hashtable();

		public DemaSeriesSonificationDefaultSpeechOptionsMapping()
		{
			Frequency = Frequency_DefaultValue = new DemaSeriesSonificationDefaultSpeechOptionsMappingFrequency();
			GapBetweenNotes = GapBetweenNotes_DefaultValue = new DemaSeriesSonificationDefaultSpeechOptionsMappingGapBetweenNotes();
			Highpass = Highpass_DefaultValue = new DemaSeriesSonificationDefaultSpeechOptionsMappingHighpass();
			Lowpass = Lowpass_DefaultValue = new DemaSeriesSonificationDefaultSpeechOptionsMappingLowpass();
			NoteDuration = NoteDuration_DefaultValue = new DemaSeriesSonificationDefaultSpeechOptionsMappingNoteDuration();
			Pan = Pan_DefaultValue = new DemaSeriesSonificationDefaultSpeechOptionsMappingPan();
			Pitch = Pitch_DefaultValue = new DemaSeriesSonificationDefaultSpeechOptionsMappingPitch();
			PitchString = PitchString_DefaultValue = "null";
			PitchNumber = PitchNumber_DefaultValue = null;
			PlayDelay = PlayDelay_DefaultValue = new DemaSeriesSonificationDefaultSpeechOptionsMappingPlayDelay();
			Time = Time_DefaultValue = new DemaSeriesSonificationDefaultSpeechOptionsMappingTime();
			TimeString = TimeString_DefaultValue = "null";
			TimeNumber = TimeNumber_DefaultValue = null;
			Tremolo = Tremolo_DefaultValue = new DemaSeriesSonificationDefaultSpeechOptionsMappingTremolo();
			Volume = Volume_DefaultValue = new DemaSeriesSonificationDefaultSpeechOptionsMappingVolume();
		...
		/// </summary>
		public DemaSeriesSonificationDefaultSpeechOptionsMappingFrequency Frequency { get; set; }
		private DemaSeriesSonificationDefaultSpeechOptionsMappingFrequency Frequency_DefaultValue { get; set; }
		...
		/// </summary>
		public DemaSeriesSonificationDefaultSpeechOptionsMappingGapBetweenNotes GapBetweenNotes { get; set; }
		private DemaSeriesSonificationDefaultSpeechOptionsMappingGapBetweenNotes GapBetweenNotes_DefaultValue { get; set; }
		...
		/// </summary>
		public DemaSeriesSonificationDefaultSpeechOptionsMappingHighpass Highpass { get; set; }
		private DemaSeriesSonificationDefaultSpeechOptionsMappingHighpass Highpass_DefaultValue { get; set; }
		...
		/// </summary>
		public DemaSeriesSonificationDefaultSpeechOptionsMappingLowpass Lowpass { get; set; }
		private DemaSeriesSonificationDefaultSpeechOptionsMappingLowpass Lowpass_DefaultValue { get; set; }
		...
		/// </summary>
		public DemaSeriesSonificationDefaultSpeechOptionsMappingNoteDuration NoteDuration { get; set; }
		private DemaSeriesSonificationDefaultSpeechOptionsMappingNoteDuration NoteDuration_DefaultValue { get; set; }
		...
		/// </summary>
		public DemaSeriesSonificationDefaultSpeechOptionsMappingPan Pan { get; set; }
		private DemaSeriesSonificationDefaultSpeechOptionsMappingPan Pan_DefaultValue { get; set; }
		...
		/// </summary>
		public DemaSeriesSonificationDefaultSpeechOptionsMappingPitch Pitch { get; set; }
		private DemaSeriesSonificationDefaultSpeechOptionsMappingPitch Pitch_DefaultValue { get; set; }
		...
		/// </summary>
		public DemaSeriesSonificationDefaultSpeechOptionsMappingPlayDelay PlayDelay { get; set; }
		private DemaSeriesSonificationDefaultSpeechOptionsMappingPlayDelay PlayDelay_DefaultValue { get; set; }
		...
		/// </summary>
		public DemaSeriesSonificationDefaultSpeechOptionsMappingTime Time { get; set; }
		private DemaSeriesSonificationDefaultSpeechOptionsMappingTime Time_DefaultValue { get; set; }
		...
		/// </summary>
		public DemaSeriesSonificationDefaultSpeechOptionsMappingTremolo Tremolo { get; set; }
		private DemaSeriesSonificationDefaultSpeechOptionsMappingTremolo Tremolo_DefaultValue { get; set; }
		 

		/// <summary>
		/// The volume of notes, from 0 to 1.
		/// </summary>
		public DemaSeriesSonificationDefaultSpeechOptionsMappingVolume Volume { get; set; }
		private DemaSeriesSonificationDefaultSpeechOptionsMappingVolume Volume_DefaultValue { get; set; }
