...
{
	public partial class DemaSeriesSonificationDefaultSpeechOptionsMappingLowpassResonance  : BaseObject
	{
		Hashtable h = new Hashtable();

		public DemaSeriesSonificationDefaultSpeechOptionsMappingLowpassResonance()
		{
			MapFunction = MapFunction_DefaultValue = DemaSeriesSonificationDefaultSpeechOptionsMappingLowpassResonanceMapFunction.Linear;
			MapTo = MapTo_DefaultValue = "";
			Max = Max_DefaultValue = null;
			Min = Min_DefaultValue = null;
			Value = Value_DefaultValue = null;
			Within = Within_DefaultValue = DemaSeriesSonificationDefaultSpeechOptionsMappingLowpassResonanceWithin.Chart;
		...
		/// </summary>
		public DemaSeriesSonificationDefaultSpeechOptionsMappingLowpassResonanceMapFunction MapFunction { get; set; }
		private DemaSeriesSonificationDefaultSpeechOptionsMappingLowpassResonanceMapFunction MapFunction_DefaultValue { get; set; }
		...
		/// </summary>
		public DemaSeriesSonificationDefaultSpeechOptionsMappingLowpassResonanceWithin Within { get; set; }
		private DemaSeriesSonificationDefaultSpeechOptionsMappingLowpassResonanceWithin Within_DefaultValue { get; set; }
