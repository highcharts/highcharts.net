...
{
	public partial class DemaSeriesSonificationDefaultSpeechOptionsMappingPan  : BaseObject
	{
		Hashtable h = new Hashtable();

		public DemaSeriesSonificationDefaultSpeechOptionsMappingPan()
		{
			MapFunction = MapFunction_DefaultValue = DemaSeriesSonificationDefaultSpeechOptionsMappingPanMapFunction.Linear;
			MapTo = MapTo_DefaultValue = "";
			Max = Max_DefaultValue = null;
			Min = Min_DefaultValue = null;
			Value = Value_DefaultValue = null;
			Within = Within_DefaultValue = DemaSeriesSonificationDefaultSpeechOptionsMappingPanWithin.Chart;
		...
		/// </summary>
		public DemaSeriesSonificationDefaultSpeechOptionsMappingPanMapFunction MapFunction { get; set; }
		private DemaSeriesSonificationDefaultSpeechOptionsMappingPanMapFunction MapFunction_DefaultValue { get; set; }
		...
		/// </summary>
		public DemaSeriesSonificationDefaultSpeechOptionsMappingPanWithin Within { get; set; }
		private DemaSeriesSonificationDefaultSpeechOptionsMappingPanWithin Within_DefaultValue { get; set; }
