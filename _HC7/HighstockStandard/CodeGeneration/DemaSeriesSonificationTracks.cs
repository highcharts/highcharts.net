...
{
	public partial class DemaSeriesSonificationTracks  : BaseObject
	{
		Hashtable h = new Hashtable();

		public DemaSeriesSonificationTracks()
		{
			ActiveWhen = ActiveWhen_DefaultValue = new DemaSeriesSonificationTracksActiveWhen();
			Instrument = Instrument_DefaultValue = null;
			InstrumentString = InstrumentString_DefaultValue = "null";
			Mapping = Mapping_DefaultValue = new DemaSeriesSonificationTracksMapping();
			MidiName = MidiName_DefaultValue = "";
			PointGrouping = PointGrouping_DefaultValue = new DemaSeriesSonificationTracksPointGrouping();
			RoundToMusicalNotes = RoundToMusicalNotes_DefaultValue = true;
			ShowPlayMarker = ShowPlayMarker_DefaultValue = true;
			Type = Type_DefaultValue = DemaSeriesSonificationTracksType.Instrument;
		...
		/// </summary>
		public DemaSeriesSonificationTracksActiveWhen ActiveWhen { get; set; }
		private DemaSeriesSonificationTracksActiveWhen ActiveWhen_DefaultValue { get; set; }
		...
		/// </summary>
		public DemaSeriesSonificationTracksMapping Mapping { get; set; }
		private DemaSeriesSonificationTracksMapping Mapping_DefaultValue { get; set; }
		...
		/// </summary>
		public DemaSeriesSonificationTracksPointGrouping PointGrouping { get; set; }
		private DemaSeriesSonificationTracksPointGrouping PointGrouping_DefaultValue { get; set; }
		...
		/// </summary>
		public DemaSeriesSonificationTracksType Type { get; set; }
		private DemaSeriesSonificationTracksType Type_DefaultValue { get; set; }
