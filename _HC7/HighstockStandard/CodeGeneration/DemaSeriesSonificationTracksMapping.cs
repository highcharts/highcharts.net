...
{
	public partial class DemaSeriesSonificationTracksMapping  : BaseObject
	{
		Hashtable h = new Hashtable();

		public DemaSeriesSonificationTracksMapping()
		{
			Frequency = Frequency_DefaultValue = new DemaSeriesSonificationTracksMappingFrequency();
			GapBetweenNotes = GapBetweenNotes_DefaultValue = new DemaSeriesSonificationTracksMappingGapBetweenNotes();
			Highpass = Highpass_DefaultValue = new DemaSeriesSonificationTracksMappingHighpass();
			Lowpass = Lowpass_DefaultValue = new DemaSeriesSonificationTracksMappingLowpass();
			NoteDuration = NoteDuration_DefaultValue = new DemaSeriesSonificationTracksMappingNoteDuration();
			Pan = Pan_DefaultValue = new DemaSeriesSonificationTracksMappingPan();
			Pitch = Pitch_DefaultValue = new DemaSeriesSonificationTracksMappingPitch();
			PitchString = PitchString_DefaultValue = "null";
			PitchNumber = PitchNumber_DefaultValue = null;
			PlayDelay = PlayDelay_DefaultValue = new DemaSeriesSonificationTracksMappingPlayDelay();
			Time = Time_DefaultValue = new DemaSeriesSonificationTracksMappingTime();
			TimeString = TimeString_DefaultValue = "null";
			TimeNumber = TimeNumber_DefaultValue = null;
			Tremolo = Tremolo_DefaultValue = new DemaSeriesSonificationTracksMappingTremolo();
			Volume = Volume_DefaultValue = new DemaSeriesSonificationTracksMappingVolume();
		...
		/// </summary>
		public DemaSeriesSonificationTracksMappingFrequency Frequency { get; set; }
		private DemaSeriesSonificationTracksMappingFrequency Frequency_DefaultValue { get; set; }
		...
		/// </summary>
		public DemaSeriesSonificationTracksMappingGapBetweenNotes GapBetweenNotes { get; set; }
		private DemaSeriesSonificationTracksMappingGapBetweenNotes GapBetweenNotes_DefaultValue { get; set; }
		...
		/// </summary>
		public DemaSeriesSonificationTracksMappingHighpass Highpass { get; set; }
		private DemaSeriesSonificationTracksMappingHighpass Highpass_DefaultValue { get; set; }
		...
		/// </summary>
		public DemaSeriesSonificationTracksMappingLowpass Lowpass { get; set; }
		private DemaSeriesSonificationTracksMappingLowpass Lowpass_DefaultValue { get; set; }
		...
		/// </summary>
		public DemaSeriesSonificationTracksMappingNoteDuration NoteDuration { get; set; }
		private DemaSeriesSonificationTracksMappingNoteDuration NoteDuration_DefaultValue { get; set; }
		...
		/// </summary>
		public DemaSeriesSonificationTracksMappingPan Pan { get; set; }
		private DemaSeriesSonificationTracksMappingPan Pan_DefaultValue { get; set; }
		...
		/// </summary>
		public DemaSeriesSonificationTracksMappingPitch Pitch { get; set; }
		private DemaSeriesSonificationTracksMappingPitch Pitch_DefaultValue { get; set; }
		...
		/// </summary>
		public DemaSeriesSonificationTracksMappingPlayDelay PlayDelay { get; set; }
		private DemaSeriesSonificationTracksMappingPlayDelay PlayDelay_DefaultValue { get; set; }
		...
		/// </summary>
		public DemaSeriesSonificationTracksMappingTime Time { get; set; }
		private DemaSeriesSonificationTracksMappingTime Time_DefaultValue { get; set; }
		...
		/// </summary>
		public DemaSeriesSonificationTracksMappingTremolo Tremolo { get; set; }
		private DemaSeriesSonificationTracksMappingTremolo Tremolo_DefaultValue { get; set; }
		 

		/// <summary>
		/// The volume of notes, from 0 to 1.
		/// </summary>
		public DemaSeriesSonificationTracksMappingVolume Volume { get; set; }
		private DemaSeriesSonificationTracksMappingVolume Volume_DefaultValue { get; set; }
