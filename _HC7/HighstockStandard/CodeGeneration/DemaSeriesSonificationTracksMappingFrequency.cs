...
{
	public partial class DemaSeriesSonificationTracksMappingFrequency  : BaseObject
	{
		Hashtable h = new Hashtable();

		public DemaSeriesSonificationTracksMappingFrequency()
		{
			MapFunction = MapFunction_DefaultValue = DemaSeriesSonificationTracksMappingFrequencyMapFunction.Linear;
			MapTo = MapTo_DefaultValue = "";
			Max = Max_DefaultValue = null;
			Min = Min_DefaultValue = null;
			Value = Value_DefaultValue = null;
			Within = Within_DefaultValue = DemaSeriesSonificationTracksMappingFrequencyWithin.Chart;
		...
		/// </summary>
		public DemaSeriesSonificationTracksMappingFrequencyMapFunction MapFunction { get; set; }
		private DemaSeriesSonificationTracksMappingFrequencyMapFunction MapFunction_DefaultValue { get; set; }
		...
		/// </summary>
		public DemaSeriesSonificationTracksMappingFrequencyWithin Within { get; set; }
		private DemaSeriesSonificationTracksMappingFrequencyWithin Within_DefaultValue { get; set; }
