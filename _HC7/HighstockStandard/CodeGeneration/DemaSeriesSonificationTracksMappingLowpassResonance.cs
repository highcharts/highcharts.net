...
{
	public partial class DemaSeriesSonificationTracksMappingLowpassResonance  : BaseObject
	{
		Hashtable h = new Hashtable();

		public DemaSeriesSonificationTracksMappingLowpassResonance()
		{
			MapFunction = MapFunction_DefaultValue = DemaSeriesSonificationTracksMappingLowpassResonanceMapFunction.Linear;
			MapTo = MapTo_DefaultValue = "";
			Max = Max_DefaultValue = null;
			Min = Min_DefaultValue = null;
			Value = Value_DefaultValue = null;
			Within = Within_DefaultValue = DemaSeriesSonificationTracksMappingLowpassResonanceWithin.Chart;
		...
		/// </summary>
		public DemaSeriesSonificationTracksMappingLowpassResonanceMapFunction MapFunction { get; set; }
		private DemaSeriesSonificationTracksMappingLowpassResonanceMapFunction MapFunction_DefaultValue { get; set; }
		...
		/// </summary>
		public DemaSeriesSonificationTracksMappingLowpassResonanceWithin Within { get; set; }
		private DemaSeriesSonificationTracksMappingLowpassResonanceWithin Within_DefaultValue { get; set; }
