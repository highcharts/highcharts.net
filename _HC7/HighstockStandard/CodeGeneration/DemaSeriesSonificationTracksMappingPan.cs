...
{
	public partial class DemaSeriesSonificationTracksMappingPan  : BaseObject
	{
		Hashtable h = new Hashtable();

		public DemaSeriesSonificationTracksMappingPan()
		{
			MapFunction = MapFunction_DefaultValue = DemaSeriesSonificationTracksMappingPanMapFunction.Linear;
			MapTo = MapTo_DefaultValue = "";
			Max = Max_DefaultValue = null;
			Min = Min_DefaultValue = null;
			Value = Value_DefaultValue = null;
			Within = Within_DefaultValue = DemaSeriesSonificationTracksMappingPanWithin.Chart;
		...
		/// </summary>
		public DemaSeriesSonificationTracksMappingPanMapFunction MapFunction { get; set; }
		private DemaSeriesSonificationTracksMappingPanMapFunction MapFunction_DefaultValue { get; set; }
		...
		/// </summary>
		public DemaSeriesSonificationTracksMappingPanWithin Within { get; set; }
		private DemaSeriesSonificationTracksMappingPanWithin Within_DefaultValue { get; set; }
