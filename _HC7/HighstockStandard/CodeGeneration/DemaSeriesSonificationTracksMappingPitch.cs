...
{
	public partial class DemaSeriesSonificationTracksMappingPitch  : BaseObject
	{
		Hashtable h = new Hashtable();

		public DemaSeriesSonificationTracksMappingPitch()
		{
			MapFunction = MapFunction_DefaultValue = DemaSeriesSonificationTracksMappingPitchMapFunction.Linear;
		...
		/// </summary>
		public DemaSeriesSonificationTracksMappingPitchMapFunction MapFunction { get; set; }
		private DemaSeriesSonificationTracksMappingPitchMapFunction MapFunction_DefaultValue { get; set; }
