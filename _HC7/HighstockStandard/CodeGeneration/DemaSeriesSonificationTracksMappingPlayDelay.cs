...
{
	public partial class DemaSeriesSonificationTracksMappingPlayDelay  : BaseObject
	{
		Hashtable h = new Hashtable();

		public DemaSeriesSonificationTracksMappingPlayDelay()
		{
			MapFunction = MapFunction_DefaultValue = DemaSeriesSonificationTracksMappingPlayDelayMapFunction.Linear;
			MapTo = MapTo_DefaultValue = "";
			Max = Max_DefaultValue = null;
			Min = Min_DefaultValue = null;
			Value = Value_DefaultValue = null;
			Within = Within_DefaultValue = DemaSeriesSonificationTracksMappingPlayDelayWithin.Chart;
		...
		/// </summary>
		public DemaSeriesSonificationTracksMappingPlayDelayMapFunction MapFunction { get; set; }
		private DemaSeriesSonificationTracksMappingPlayDelayMapFunction MapFunction_DefaultValue { get; set; }
		...
		/// </summary>
		public DemaSeriesSonificationTracksMappingPlayDelayWithin Within { get; set; }
		private DemaSeriesSonificationTracksMappingPlayDelayWithin Within_DefaultValue { get; set; }
