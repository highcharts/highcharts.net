...
{
	public partial class DemaSeriesSonificationTracksMappingTime  : BaseObject
	{
		Hashtable h = new Hashtable();

		public DemaSeriesSonificationTracksMappingTime()
		{
			MapFunction = MapFunction_DefaultValue = DemaSeriesSonificationTracksMappingTimeMapFunction.Linear;
			MapTo = MapTo_DefaultValue = "";
			Max = Max_DefaultValue = null;
			Min = Min_DefaultValue = null;
			Value = Value_DefaultValue = null;
			Within = Within_DefaultValue = DemaSeriesSonificationTracksMappingTimeWithin.Chart;
		...
		/// </summary>
		public DemaSeriesSonificationTracksMappingTimeMapFunction MapFunction { get; set; }
		private DemaSeriesSonificationTracksMappingTimeMapFunction MapFunction_DefaultValue { get; set; }
		...
		/// </summary>
		public DemaSeriesSonificationTracksMappingTimeWithin Within { get; set; }
		private DemaSeriesSonificationTracksMappingTimeWithin Within_DefaultValue { get; set; }
