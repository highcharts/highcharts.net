...
{
	public partial class DemaSeriesSonificationTracksMappingTremoloDepth  : BaseObject
	{
		Hashtable h = new Hashtable();

		public DemaSeriesSonificationTracksMappingTremoloDepth()
		{
			MapFunction = MapFunction_DefaultValue = DemaSeriesSonificationTracksMappingTremoloDepthMapFunction.Linear;
			MapTo = MapTo_DefaultValue = "";
			Max = Max_DefaultValue = null;
			Min = Min_DefaultValue = null;
			Value = Value_DefaultValue = null;
			Within = Within_DefaultValue = DemaSeriesSonificationTracksMappingTremoloDepthWithin.Chart;
		...
		/// </summary>
		public DemaSeriesSonificationTracksMappingTremoloDepthMapFunction MapFunction { get; set; }
		private DemaSeriesSonificationTracksMappingTremoloDepthMapFunction MapFunction_DefaultValue { get; set; }
		...
		/// </summary>
		public DemaSeriesSonificationTracksMappingTremoloDepthWithin Within { get; set; }
		private DemaSeriesSonificationTracksMappingTremoloDepthWithin Within_DefaultValue { get; set; }
