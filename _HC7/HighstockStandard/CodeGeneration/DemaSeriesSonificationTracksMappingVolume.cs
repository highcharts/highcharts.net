...
namespace Highsoft.Web.Mvc.Stocks
{
	public partial class DemaSeriesSonificationTracksMappingVolume  : BaseObject
	{
		...
		{
			MapFunction = MapFunction_DefaultValue = DemaSeriesSonificationTracksMappingVolumeMapFunction.Linear;
			MapTo = MapTo_DefaultValue = "";
			Max = Max_DefaultValue = null;
			Min = Min_DefaultValue = null;
			Value = Value_DefaultValue = null;
			Within = Within_DefaultValue = DemaSeriesSonificationTracksMappingVolumeWithin.Chart;
		...
		private DemaSeriesSonificationTracksMappingVolumeMapFunction MapFunction_DefaultValue { get; set; }
		...
		private DemaSeriesSonificationTracksMappingVolumeWithin Within_DefaultValue { get; set; }
