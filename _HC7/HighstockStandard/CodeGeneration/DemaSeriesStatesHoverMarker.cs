...
{
	public partial class DemaSeriesStatesHoverMarker  : BaseObject
	{
		public DemaSeriesStatesHoverMarker()
		{
			...
			States = States_DefaultValue = new DemaSeriesStatesHoverMarkerStates();
		...
		/// </summary>
		public DemaSeriesStatesHoverMarkerStates States { get; set; }
		private DemaSeriesStatesHoverMarkerStates States_DefaultValue { get; set; }
