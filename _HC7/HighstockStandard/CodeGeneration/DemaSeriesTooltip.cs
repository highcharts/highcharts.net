...
{
	public partial class DemaSeriesTooltip  : BaseObject
	{
		public DemaSeriesTooltip()
		{
			...
			HeaderShape = HeaderShape_DefaultValue = DemaSeriesTooltipHeaderShape.Callout;
		...
		/// </summary>
		public DemaSeriesTooltipHeaderShape HeaderShape { get; set; }
		private DemaSeriesTooltipHeaderShape HeaderShape_DefaultValue { get; set; }
		...
		internal override Hashtable ToHashtable()
		{
			...
			if (NullFormatter != NullFormatter_DefaultValue) { h.Add("nullFormatter",NullFormatter); Highstock.AddFunction("DemaSeriesTooltipNullFormatter.nullFormatter", NullFormatter); }  
			if (Outside != Outside_DefaultValue) h.Add("outside",Outside);
			if (Padding != Padding_DefaultValue) h.Add("padding",Padding);
			if (PointFormat != PointFormat_DefaultValue) h.Add("pointFormat",PointFormat);
			if (PointFormatter != PointFormatter_DefaultValue) { h.Add("pointFormatter",PointFormatter); Highstock.AddFunction("DemaSeriesTooltipPointFormatter.pointFormatter", PointFormatter); }  
