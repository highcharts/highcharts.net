...
{
	public partial class DisparityindexSeries  : Series
	{
		Hashtable h = new Hashtable();

		public DisparityindexSeries()
		{
			Accessibility = Accessibility_DefaultValue = new DisparityindexSeriesAccessibility();
			AllowPointSelect = AllowPointSelect_DefaultValue = false;
			Animation = Animation_DefaultValue = new Animation() { Enabled = true };
			AnimationBool = AnimationBool_DefaultValue = true;
			AnimationLimit = AnimationLimit_DefaultValue = null;
			BoostBlending = BoostBlending_DefaultValue = DisparityindexSeriesBoostBlending.Undefined;
			...
			Compare = Compare_DefaultValue = DisparityindexSeriesCompare.Percent;
			CompareBase = CompareBase_DefaultValue = DisparityindexSeriesCompareBase.Min;
			...
			Cursor = Cursor_DefaultValue = DisparityindexSeriesCursor.Null;
			Custom = Custom_DefaultValue = new Hashtable();
			DashStyle = DashStyle_DefaultValue = DisparityindexSeriesDashStyle.Null;
			DataGrouping = DataGrouping_DefaultValue = new DisparityindexSeriesDataGrouping();
			DataLabels = DataLabels_DefaultValue = new DisparityindexSeriesDataLabels();
			DataSorting = DataSorting_DefaultValue = new DisparityindexSeriesDataSorting();
			Description = Description_DefaultValue = "";
			Dumbell = Dumbell_DefaultValue = new DisparityindexSeriesDumbell();
			EnableMouseTracking = EnableMouseTracking_DefaultValue = true;
			Events = Events_DefaultValue = new DisparityindexSeriesEvents();
			FindNearestPointBy = FindNearestPointBy_DefaultValue = DisparityindexSeriesFindNearestPointBy.X;
			GapSize = GapSize_DefaultValue = 0;
			GapUnit = GapUnit_DefaultValue = DisparityindexSeriesGapUnit.Relative;
			GetExtremesFromAll = GetExtremesFromAll_DefaultValue = false;
			Id = Id_DefaultValue = "";
			InactiveOtherPoints = InactiveOtherPoints_DefaultValue = false;
			IncludeInDataExport = IncludeInDataExport_DefaultValue = null;
			Index = Index_DefaultValue = null;
			Label = Label_DefaultValue = new DisparityindexSeriesLabel();
			LastPrice = LastPrice_DefaultValue = new DisparityindexSeriesLastPrice();
			LastVisiblePrice = LastVisiblePrice_DefaultValue = new DisparityindexSeriesLastVisiblePrice();
			LegendIndex = LegendIndex_DefaultValue = null;
			LegendSymbol = LegendSymbol_DefaultValue = DisparityindexSeriesLegendSymbol.Rectangle;
			Linecap = Linecap_DefaultValue = DisparityindexSeriesLinecap.Round;
			LineWidth = LineWidth_DefaultValue = 2;
			LinkedTo = LinkedTo_DefaultValue = "";
			Marker = Marker_DefaultValue = new DisparityindexSeriesMarker();
			Name = Name_DefaultValue = "";
			NegativeColor = NegativeColor_DefaultValue = "";
			OnPoint = OnPoint_DefaultValue = new DisparityindexSeriesOnPoint();
			Opacity = Opacity_DefaultValue = 1;
			Params = Params_DefaultValue = new DisparityindexSeriesParams();
			Point = Point_DefaultValue = new DisparityindexSeriesPoint();
			...
			Sonification = Sonification_DefaultValue = new DisparityindexSeriesSonification();
			Stack = Stack_DefaultValue = "";
			StackNumber = StackNumber_DefaultValue = null;
			States = States_DefaultValue = new DisparityindexSeriesStates();
			Step = Step_DefaultValue = DisparityindexSeriesStep.Null;
			StickyTracking = StickyTracking_DefaultValue = true;
			Threshold = Threshold_DefaultValue = 0;
			Tooltip = Tooltip_DefaultValue = new DisparityindexSeriesTooltip();
			...
			Zones = Zones_DefaultValue = new List<DisparityindexSeriesZones>();
		...
		/// </summary>
		public DisparityindexSeriesAccessibility Accessibility { get; set; }
		private DisparityindexSeriesAccessibility Accessibility_DefaultValue { get; set; }
		...
		/// </summary>
		public DisparityindexSeriesBoostBlending BoostBlending { get; set; }
		private DisparityindexSeriesBoostBlending BoostBlending_DefaultValue { get; set; }
		...
		/// </summary>
		public DisparityindexSeriesCompare Compare { get; set; }
		private DisparityindexSeriesCompare Compare_DefaultValue { get; set; }
		 

		/// <summary>
		/// When [compare](#plotOptions.series.compare) is `percent`, this optiondictates whether to use 0 or 100 as the base of comparison.
		/// </summary>
		public DisparityindexSeriesCompareBase CompareBase { get; set; }
		private DisparityindexSeriesCompareBase CompareBase_DefaultValue { get; set; }
		...
		/// </summary>
		public DisparityindexSeriesCursor Cursor { get; set; }
		private DisparityindexSeriesCursor Cursor_DefaultValue { get; set; }
		...
		/// </summary>
		public DisparityindexSeriesDashStyle DashStyle { get; set; }
		private DisparityindexSeriesDashStyle DashStyle_DefaultValue { get; set; }
		...
		/// </summary>
		public DisparityindexSeriesDataGrouping DataGrouping { get; set; }
		private DisparityindexSeriesDataGrouping DataGrouping_DefaultValue { get; set; }
		...
		/// </summary>
		public DisparityindexSeriesDataLabels DataLabels { get; set; }
		private DisparityindexSeriesDataLabels DataLabels_DefaultValue { get; set; }
		 

		/// <summary>
		/// Options for the series data sorting.
		/// </summary>
		public DisparityindexSeriesDataSorting DataSorting { get; set; }
		private DisparityindexSeriesDataSorting DataSorting_DefaultValue { get; set; }
		...
		/// 
		/// </summary>
		public DisparityindexSeriesDumbell Dumbell { get; set; }
		private DisparityindexSeriesDumbell Dumbell_DefaultValue { get; set; }
		...
		/// </summary>
		public DisparityindexSeriesEvents Events { get; set; }
		private DisparityindexSeriesEvents Events_DefaultValue { get; set; }
		...
		/// </summary>
		public DisparityindexSeriesFindNearestPointBy FindNearestPointBy { get; set; }
		private DisparityindexSeriesFindNearestPointBy FindNearestPointBy_DefaultValue { get; set; }
		...
		/// </summary>
		public DisparityindexSeriesGapUnit GapUnit { get; set; }
		private DisparityindexSeriesGapUnit GapUnit_DefaultValue { get; set; }
		...
		/// </summary>
		public DisparityindexSeriesLabel Label { get; set; }
		private DisparityindexSeriesLabel Label_DefaultValue { get; set; }
		 

		/// <summary>
		/// The line marks the last price from all points.
		/// </summary>
		public DisparityindexSeriesLastPrice LastPrice { get; set; }
		private DisparityindexSeriesLastPrice LastPrice_DefaultValue { get; set; }
		 

		/// <summary>
		/// The line marks the last price from visible range of points.
		/// </summary>
		public DisparityindexSeriesLastVisiblePrice LastVisiblePrice { get; set; }
		private DisparityindexSeriesLastVisiblePrice LastVisiblePrice_DefaultValue { get; set; }
		...
		/// </summary>
		public DisparityindexSeriesLegendSymbol LegendSymbol { get; set; }
		private DisparityindexSeriesLegendSymbol LegendSymbol_DefaultValue { get; set; }
		 

		/// <summary>
		/// The line cap used for line ends and line joins on the graph.
		/// </summary>
		public DisparityindexSeriesLinecap Linecap { get; set; }
		private DisparityindexSeriesLinecap Linecap_DefaultValue { get; set; }
		...
		/// </summary>
		public DisparityindexSeriesMarker Marker { get; set; }
		private DisparityindexSeriesMarker Marker_DefaultValue { get; set; }
		...
		/// </summary>
		public DisparityindexSeriesOnPoint OnPoint { get; set; }
		private DisparityindexSeriesOnPoint OnPoint_DefaultValue { get; set; }
		...
		/// </summary>
		public DisparityindexSeriesParams Params { get; set; }
		private DisparityindexSeriesParams Params_DefaultValue { get; set; }
		 

		/// <summary>
		/// Properties for each single point.
		/// </summary>
		public DisparityindexSeriesPoint Point { get; set; }
		private DisparityindexSeriesPoint Point_DefaultValue { get; set; }
		...
		/// </summary>
		public DisparityindexSeriesSonification Sonification { get; set; }
		private DisparityindexSeriesSonification Sonification_DefaultValue { get; set; }
		...
		/// 
		/// </summary>
		public DisparityindexSeriesStates States { get; set; }
		private DisparityindexSeriesStates States_DefaultValue { get; set; }
		 

		/// <summary>
		/// Whether to apply steps to the line. Possible values are `left`,`center` and `right`.
		/// </summary>
		public DisparityindexSeriesStep Step { get; set; }
		private DisparityindexSeriesStep Step_DefaultValue { get; set; }
		...
		/// </summary>
		public DisparityindexSeriesTooltip Tooltip { get; set; }
		private DisparityindexSeriesTooltip Tooltip_DefaultValue { get; set; }
		...
		/// </summary>
		public List<DisparityindexSeriesZones> Zones { get; set; }
		private List<DisparityindexSeriesZones> Zones_DefaultValue { get; set; }
