...
namespace Highsoft.Web.Mvc.Stocks
{
	public partial class DisparityindexSeries  : Series
	{
		...
		public DisparityindexSeries()
		{
			...
			Zones = Zones_DefaultValue = new List<DisparityindexSeriesZone>();
		...
		/// </summary>
		public List<DisparityindexSeriesZone> Zones { get; set; }
		private List<DisparityindexSeriesZone> Zones_DefaultValue { get; set; }
