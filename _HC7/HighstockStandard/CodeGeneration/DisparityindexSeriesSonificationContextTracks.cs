...
{
	public partial class DisparityindexSeriesSonificationContextTracks  : BaseObject
	{
		Hashtable h = new Hashtable();

		public DisparityindexSeriesSonificationContextTracks()
		{
			ActiveWhen = ActiveWhen_DefaultValue = new DisparityindexSeriesSonificationContextTracksActiveWhen();
			Instrument = Instrument_DefaultValue = null;
			InstrumentString = InstrumentString_DefaultValue = "null";
			Mapping = Mapping_DefaultValue = new DisparityindexSeriesSonificationContextTracksMapping();
			MidiName = MidiName_DefaultValue = "";
			PointGrouping = PointGrouping_DefaultValue = new DisparityindexSeriesSonificationContextTracksPointGrouping();
			...
			Type = Type_DefaultValue = DisparityindexSeriesSonificationContextTracksType.Instrument;
			ValueInterval = ValueInterval_DefaultValue = null;
			ValueMapFunction = ValueMapFunction_DefaultValue = DisparityindexSeriesSonificationContextTracksValueMapFunction.Linear;
		...
		/// </summary>
		public DisparityindexSeriesSonificationContextTracksActiveWhen ActiveWhen { get; set; }
		private DisparityindexSeriesSonificationContextTracksActiveWhen ActiveWhen_DefaultValue { get; set; }
		...
		/// </summary>
		public DisparityindexSeriesSonificationContextTracksMapping Mapping { get; set; }
		private DisparityindexSeriesSonificationContextTracksMapping Mapping_DefaultValue { get; set; }
		...
		/// </summary>
		public DisparityindexSeriesSonificationContextTracksPointGrouping PointGrouping { get; set; }
		private DisparityindexSeriesSonificationContextTracksPointGrouping PointGrouping_DefaultValue { get; set; }
		...
		/// </summary>
		public DisparityindexSeriesSonificationContextTracksType Type { get; set; }
		private DisparityindexSeriesSonificationContextTracksType Type_DefaultValue { get; set; }
		...
		/// </summary>
		public DisparityindexSeriesSonificationContextTracksValueMapFunction ValueMapFunction { get; set; }
		private DisparityindexSeriesSonificationContextTracksValueMapFunction ValueMapFunction_DefaultValue { get; set; }
