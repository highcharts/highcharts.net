...
{
	public partial class DisparityindexSeriesSonificationContextTracksMapping  : BaseObject
	{
		Hashtable h = new Hashtable();

		public DisparityindexSeriesSonificationContextTracksMapping()
		{
			Frequency = Frequency_DefaultValue = new DisparityindexSeriesSonificationContextTracksMappingFrequency();
			GapBetweenNotes = GapBetweenNotes_DefaultValue = new DisparityindexSeriesSonificationContextTracksMappingGapBetweenNotes();
			Highpass = Highpass_DefaultValue = new DisparityindexSeriesSonificationContextTracksMappingHighpass();
			Lowpass = Lowpass_DefaultValue = new DisparityindexSeriesSonificationContextTracksMappingLowpass();
			NoteDuration = NoteDuration_DefaultValue = new DisparityindexSeriesSonificationContextTracksMappingNoteDuration();
			Pan = Pan_DefaultValue = new DisparityindexSeriesSonificationContextTracksMappingPan();
			Pitch = Pitch_DefaultValue = new DisparityindexSeriesSonificationContextTracksMappingPitch();
			PitchString = PitchString_DefaultValue = "null";
			PitchNumber = PitchNumber_DefaultValue = null;
			PlayDelay = PlayDelay_DefaultValue = new DisparityindexSeriesSonificationContextTracksMappingPlayDelay();
			Time = Time_DefaultValue = new DisparityindexSeriesSonificationContextTracksMappingTime();
			TimeString = TimeString_DefaultValue = "null";
			TimeNumber = TimeNumber_DefaultValue = null;
			Tremolo = Tremolo_DefaultValue = new DisparityindexSeriesSonificationContextTracksMappingTremolo();
			Volume = Volume_DefaultValue = new DisparityindexSeriesSonificationContextTracksMappingVolume();
		...
		/// </summary>
		public DisparityindexSeriesSonificationContextTracksMappingFrequency Frequency { get; set; }
		private DisparityindexSeriesSonificationContextTracksMappingFrequency Frequency_DefaultValue { get; set; }
		...
		/// </summary>
		public DisparityindexSeriesSonificationContextTracksMappingGapBetweenNotes GapBetweenNotes { get; set; }
		private DisparityindexSeriesSonificationContextTracksMappingGapBetweenNotes GapBetweenNotes_DefaultValue { get; set; }
		...
		/// </summary>
		public DisparityindexSeriesSonificationContextTracksMappingHighpass Highpass { get; set; }
		private DisparityindexSeriesSonificationContextTracksMappingHighpass Highpass_DefaultValue { get; set; }
		...
		/// </summary>
		public DisparityindexSeriesSonificationContextTracksMappingLowpass Lowpass { get; set; }
		private DisparityindexSeriesSonificationContextTracksMappingLowpass Lowpass_DefaultValue { get; set; }
		...
		/// </summary>
		public DisparityindexSeriesSonificationContextTracksMappingNoteDuration NoteDuration { get; set; }
		private DisparityindexSeriesSonificationContextTracksMappingNoteDuration NoteDuration_DefaultValue { get; set; }
		...
		/// </summary>
		public DisparityindexSeriesSonificationContextTracksMappingPan Pan { get; set; }
		private DisparityindexSeriesSonificationContextTracksMappingPan Pan_DefaultValue { get; set; }
		...
		/// </summary>
		public DisparityindexSeriesSonificationContextTracksMappingPitch Pitch { get; set; }
		private DisparityindexSeriesSonificationContextTracksMappingPitch Pitch_DefaultValue { get; set; }
		...
		/// </summary>
		public DisparityindexSeriesSonificationContextTracksMappingPlayDelay PlayDelay { get; set; }
		private DisparityindexSeriesSonificationContextTracksMappingPlayDelay PlayDelay_DefaultValue { get; set; }
		...
		/// </summary>
		public DisparityindexSeriesSonificationContextTracksMappingTime Time { get; set; }
		private DisparityindexSeriesSonificationContextTracksMappingTime Time_DefaultValue { get; set; }
		...
		/// </summary>
		public DisparityindexSeriesSonificationContextTracksMappingTremolo Tremolo { get; set; }
		private DisparityindexSeriesSonificationContextTracksMappingTremolo Tremolo_DefaultValue { get; set; }
		 

		/// <summary>
		/// The volume of notes, from 0 to 1.
		/// </summary>
		public DisparityindexSeriesSonificationContextTracksMappingVolume Volume { get; set; }
		private DisparityindexSeriesSonificationContextTracksMappingVolume Volume_DefaultValue { get; set; }
