...
{
	public partial class DisparityindexSeriesSonificationContextTracksMappingTremoloDepth  : BaseObject
	{
		Hashtable h = new Hashtable();

		public DisparityindexSeriesSonificationContextTracksMappingTremoloDepth()
		{
			MapFunction = MapFunction_DefaultValue = DisparityindexSeriesSonificationContextTracksMappingTremoloDepthMapFunction.Linear;
			MapTo = MapTo_DefaultValue = "";
			Max = Max_DefaultValue = null;
			Min = Min_DefaultValue = null;
			Value = Value_DefaultValue = null;
			Within = Within_DefaultValue = DisparityindexSeriesSonificationContextTracksMappingTremoloDepthWithin.Chart;
		...
		/// </summary>
		public DisparityindexSeriesSonificationContextTracksMappingTremoloDepthMapFunction MapFunction { get; set; }
		private DisparityindexSeriesSonificationContextTracksMappingTremoloDepthMapFunction MapFunction_DefaultValue { get; set; }
		...
		/// </summary>
		public DisparityindexSeriesSonificationContextTracksMappingTremoloDepthWithin Within { get; set; }
		private DisparityindexSeriesSonificationContextTracksMappingTremoloDepthWithin Within_DefaultValue { get; set; }
