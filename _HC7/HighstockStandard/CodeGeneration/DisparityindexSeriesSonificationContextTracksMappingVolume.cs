...
{
	public partial class DisparityindexSeriesSonificationContextTracksMappingVolume  : BaseObject
	{
		Hashtable h = new Hashtable();

		public DisparityindexSeriesSonificationContextTracksMappingVolume()
		{
			MapFunction = MapFunction_DefaultValue = DisparityindexSeriesSonificationContextTracksMappingVolumeMapFunction.Linear;
			MapTo = MapTo_DefaultValue = "";
			Max = Max_DefaultValue = null;
			Min = Min_DefaultValue = null;
			Value = Value_DefaultValue = null;
			Within = Within_DefaultValue = DisparityindexSeriesSonificationContextTracksMappingVolumeWithin.Chart;
		...
		/// </summary>
		public DisparityindexSeriesSonificationContextTracksMappingVolumeMapFunction MapFunction { get; set; }
		private DisparityindexSeriesSonificationContextTracksMappingVolumeMapFunction MapFunction_DefaultValue { get; set; }
		...
		/// </summary>
		public DisparityindexSeriesSonificationContextTracksMappingVolumeWithin Within { get; set; }
		private DisparityindexSeriesSonificationContextTracksMappingVolumeWithin Within_DefaultValue { get; set; }
