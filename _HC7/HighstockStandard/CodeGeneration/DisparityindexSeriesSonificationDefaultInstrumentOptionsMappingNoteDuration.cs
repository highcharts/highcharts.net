...
{
	public partial class DisparityindexSeriesSonificationDefaultInstrumentOptionsMappingNoteDuration  : BaseObject
	{
		Hashtable h = new Hashtable();

		public DisparityindexSeriesSonificationDefaultInstrumentOptionsMappingNoteDuration()
		{
			MapFunction = MapFunction_DefaultValue = DisparityindexSeriesSonificationDefaultInstrumentOptionsMappingNoteDurationMapFunction.Linear;
			MapTo = MapTo_DefaultValue = "";
			Max = Max_DefaultValue = null;
			Min = Min_DefaultValue = null;
			Value = Value_DefaultValue = null;
			Within = Within_DefaultValue = DisparityindexSeriesSonificationDefaultInstrumentOptionsMappingNoteDurationWithin.Chart;
		...
		/// </summary>
		public DisparityindexSeriesSonificationDefaultInstrumentOptionsMappingNoteDurationMapFunction MapFunction { get; set; }
		private DisparityindexSeriesSonificationDefaultInstrumentOptionsMappingNoteDurationMapFunction MapFunction_DefaultValue { get; set; }
		...
		/// </summary>
		public DisparityindexSeriesSonificationDefaultInstrumentOptionsMappingNoteDurationWithin Within { get; set; }
		private DisparityindexSeriesSonificationDefaultInstrumentOptionsMappingNoteDurationWithin Within_DefaultValue { get; set; }
