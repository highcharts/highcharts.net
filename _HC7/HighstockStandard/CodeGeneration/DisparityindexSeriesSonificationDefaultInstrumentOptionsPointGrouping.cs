...
{
	public partial class DisparityindexSeriesSonificationDefaultInstrumentOptionsPointGrouping  : BaseObject
	{
		Hashtable h = new Hashtable();

		public DisparityindexSeriesSonificationDefaultInstrumentOptionsPointGrouping()
		{
			Algorithm = Algorithm_DefaultValue = DisparityindexSeriesSonificationDefaultInstrumentOptionsPointGroupingAlgorithm.Minimax;
		...
		/// </summary>
		public DisparityindexSeriesSonificationDefaultInstrumentOptionsPointGroupingAlgorithm Algorithm { get; set; }
		private DisparityindexSeriesSonificationDefaultInstrumentOptionsPointGroupingAlgorithm Algorithm_DefaultValue { get; set; }
