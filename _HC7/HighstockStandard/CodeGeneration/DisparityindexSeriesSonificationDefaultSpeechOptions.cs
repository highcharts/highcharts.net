...
{
	public partial class DisparityindexSeriesSonificationDefaultSpeechOptions  : BaseObject
	{
		Hashtable h = new Hashtable();

		public DisparityindexSeriesSonificationDefaultSpeechOptions()
		{
			ActiveWhen = ActiveWhen_DefaultValue = new DisparityindexSeriesSonificationDefaultSpeechOptionsActiveWhen();
			Language = Language_DefaultValue = "en-US";
			Mapping = Mapping_DefaultValue = new DisparityindexSeriesSonificationDefaultSpeechOptionsMapping();
			PointGrouping = PointGrouping_DefaultValue = new DisparityindexSeriesSonificationDefaultSpeechOptionsPointGrouping();
			PreferredVoice = PreferredVoice_DefaultValue = "";
			ShowPlayMarker = ShowPlayMarker_DefaultValue = true;
			Type = Type_DefaultValue = DisparityindexSeriesSonificationDefaultSpeechOptionsType.Instrument;
		...
		/// </summary>
		public DisparityindexSeriesSonificationDefaultSpeechOptionsActiveWhen ActiveWhen { get; set; }
		private DisparityindexSeriesSonificationDefaultSpeechOptionsActiveWhen ActiveWhen_DefaultValue { get; set; }
		...
		/// </summary>
		public DisparityindexSeriesSonificationDefaultSpeechOptionsMapping Mapping { get; set; }
		private DisparityindexSeriesSonificationDefaultSpeechOptionsMapping Mapping_DefaultValue { get; set; }
		 

		/// <summary>
		/// Options for point grouping, specifically for instrument tracks.
		/// </summary>
		public DisparityindexSeriesSonificationDefaultSpeechOptionsPointGrouping PointGrouping { get; set; }
		private DisparityindexSeriesSonificationDefaultSpeechOptionsPointGrouping PointGrouping_DefaultValue { get; set; }
		...
		/// </summary>
		public DisparityindexSeriesSonificationDefaultSpeechOptionsType Type { get; set; }
		private DisparityindexSeriesSonificationDefaultSpeechOptionsType Type_DefaultValue { get; set; }
