...
{
	public partial class DisparityindexSeriesSonificationDefaultSpeechOptionsMapping  : BaseObject
	{
		Hashtable h = new Hashtable();

		public DisparityindexSeriesSonificationDefaultSpeechOptionsMapping()
		{
			Frequency = Frequency_DefaultValue = new DisparityindexSeriesSonificationDefaultSpeechOptionsMappingFrequency();
			GapBetweenNotes = GapBetweenNotes_DefaultValue = new DisparityindexSeriesSonificationDefaultSpeechOptionsMappingGapBetweenNotes();
			Highpass = Highpass_DefaultValue = new DisparityindexSeriesSonificationDefaultSpeechOptionsMappingHighpass();
			Lowpass = Lowpass_DefaultValue = new DisparityindexSeriesSonificationDefaultSpeechOptionsMappingLowpass();
			NoteDuration = NoteDuration_DefaultValue = new DisparityindexSeriesSonificationDefaultSpeechOptionsMappingNoteDuration();
			Pan = Pan_DefaultValue = new DisparityindexSeriesSonificationDefaultSpeechOptionsMappingPan();
			Pitch = Pitch_DefaultValue = new DisparityindexSeriesSonificationDefaultSpeechOptionsMappingPitch();
			PitchString = PitchString_DefaultValue = "null";
			PitchNumber = PitchNumber_DefaultValue = null;
			PlayDelay = PlayDelay_DefaultValue = new DisparityindexSeriesSonificationDefaultSpeechOptionsMappingPlayDelay();
			Time = Time_DefaultValue = new DisparityindexSeriesSonificationDefaultSpeechOptionsMappingTime();
			TimeString = TimeString_DefaultValue = "null";
			TimeNumber = TimeNumber_DefaultValue = null;
			Tremolo = Tremolo_DefaultValue = new DisparityindexSeriesSonificationDefaultSpeechOptionsMappingTremolo();
			Volume = Volume_DefaultValue = new DisparityindexSeriesSonificationDefaultSpeechOptionsMappingVolume();
		...
		/// </summary>
		public DisparityindexSeriesSonificationDefaultSpeechOptionsMappingFrequency Frequency { get; set; }
		private DisparityindexSeriesSonificationDefaultSpeechOptionsMappingFrequency Frequency_DefaultValue { get; set; }
		...
		/// </summary>
		public DisparityindexSeriesSonificationDefaultSpeechOptionsMappingGapBetweenNotes GapBetweenNotes { get; set; }
		private DisparityindexSeriesSonificationDefaultSpeechOptionsMappingGapBetweenNotes GapBetweenNotes_DefaultValue { get; set; }
		...
		/// </summary>
		public DisparityindexSeriesSonificationDefaultSpeechOptionsMappingHighpass Highpass { get; set; }
		private DisparityindexSeriesSonificationDefaultSpeechOptionsMappingHighpass Highpass_DefaultValue { get; set; }
		...
		/// </summary>
		public DisparityindexSeriesSonificationDefaultSpeechOptionsMappingLowpass Lowpass { get; set; }
		private DisparityindexSeriesSonificationDefaultSpeechOptionsMappingLowpass Lowpass_DefaultValue { get; set; }
		...
		/// </summary>
		public DisparityindexSeriesSonificationDefaultSpeechOptionsMappingNoteDuration NoteDuration { get; set; }
		private DisparityindexSeriesSonificationDefaultSpeechOptionsMappingNoteDuration NoteDuration_DefaultValue { get; set; }
		...
		/// </summary>
		public DisparityindexSeriesSonificationDefaultSpeechOptionsMappingPan Pan { get; set; }
		private DisparityindexSeriesSonificationDefaultSpeechOptionsMappingPan Pan_DefaultValue { get; set; }
		...
		/// </summary>
		public DisparityindexSeriesSonificationDefaultSpeechOptionsMappingPitch Pitch { get; set; }
		private DisparityindexSeriesSonificationDefaultSpeechOptionsMappingPitch Pitch_DefaultValue { get; set; }
		...
		/// </summary>
		public DisparityindexSeriesSonificationDefaultSpeechOptionsMappingPlayDelay PlayDelay { get; set; }
		private DisparityindexSeriesSonificationDefaultSpeechOptionsMappingPlayDelay PlayDelay_DefaultValue { get; set; }
		...
		/// </summary>
		public DisparityindexSeriesSonificationDefaultSpeechOptionsMappingTime Time { get; set; }
		private DisparityindexSeriesSonificationDefaultSpeechOptionsMappingTime Time_DefaultValue { get; set; }
		...
		/// </summary>
		public DisparityindexSeriesSonificationDefaultSpeechOptionsMappingTremolo Tremolo { get; set; }
		private DisparityindexSeriesSonificationDefaultSpeechOptionsMappingTremolo Tremolo_DefaultValue { get; set; }
		 

		/// <summary>
		/// The volume of notes, from 0 to 1.
		/// </summary>
		public DisparityindexSeriesSonificationDefaultSpeechOptionsMappingVolume Volume { get; set; }
		private DisparityindexSeriesSonificationDefaultSpeechOptionsMappingVolume Volume_DefaultValue { get; set; }
