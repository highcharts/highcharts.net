...
{
	public partial class DisparityindexSeriesSonificationTracks  : BaseObject
	{
		Hashtable h = new Hashtable();

		public DisparityindexSeriesSonificationTracks()
		{
			ActiveWhen = ActiveWhen_DefaultValue = new DisparityindexSeriesSonificationTracksActiveWhen();
			Instrument = Instrument_DefaultValue = null;
			InstrumentString = InstrumentString_DefaultValue = "null";
			Mapping = Mapping_DefaultValue = new DisparityindexSeriesSonificationTracksMapping();
			MidiName = MidiName_DefaultValue = "";
			PointGrouping = PointGrouping_DefaultValue = new DisparityindexSeriesSonificationTracksPointGrouping();
			RoundToMusicalNotes = RoundToMusicalNotes_DefaultValue = true;
			ShowPlayMarker = ShowPlayMarker_DefaultValue = true;
			Type = Type_DefaultValue = DisparityindexSeriesSonificationTracksType.Instrument;
		...
		/// </summary>
		public DisparityindexSeriesSonificationTracksActiveWhen ActiveWhen { get; set; }
		private DisparityindexSeriesSonificationTracksActiveWhen ActiveWhen_DefaultValue { get; set; }
		...
		/// </summary>
		public DisparityindexSeriesSonificationTracksMapping Mapping { get; set; }
		private DisparityindexSeriesSonificationTracksMapping Mapping_DefaultValue { get; set; }
		...
		/// </summary>
		public DisparityindexSeriesSonificationTracksPointGrouping PointGrouping { get; set; }
		private DisparityindexSeriesSonificationTracksPointGrouping PointGrouping_DefaultValue { get; set; }
		...
		/// </summary>
		public DisparityindexSeriesSonificationTracksType Type { get; set; }
		private DisparityindexSeriesSonificationTracksType Type_DefaultValue { get; set; }
