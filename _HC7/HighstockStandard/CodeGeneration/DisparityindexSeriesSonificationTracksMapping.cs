...
{
	public partial class DisparityindexSeriesSonificationTracksMapping  : BaseObject
	{
		Hashtable h = new Hashtable();

		public DisparityindexSeriesSonificationTracksMapping()
		{
			Frequency = Frequency_DefaultValue = new DisparityindexSeriesSonificationTracksMappingFrequency();
			GapBetweenNotes = GapBetweenNotes_DefaultValue = new DisparityindexSeriesSonificationTracksMappingGapBetweenNotes();
			Highpass = Highpass_DefaultValue = new DisparityindexSeriesSonificationTracksMappingHighpass();
			Lowpass = Lowpass_DefaultValue = new DisparityindexSeriesSonificationTracksMappingLowpass();
			NoteDuration = NoteDuration_DefaultValue = new DisparityindexSeriesSonificationTracksMappingNoteDuration();
			Pan = Pan_DefaultValue = new DisparityindexSeriesSonificationTracksMappingPan();
			Pitch = Pitch_DefaultValue = new DisparityindexSeriesSonificationTracksMappingPitch();
			PitchString = PitchString_DefaultValue = "null";
			PitchNumber = PitchNumber_DefaultValue = null;
			PlayDelay = PlayDelay_DefaultValue = new DisparityindexSeriesSonificationTracksMappingPlayDelay();
			Time = Time_DefaultValue = new DisparityindexSeriesSonificationTracksMappingTime();
			TimeString = TimeString_DefaultValue = "null";
			TimeNumber = TimeNumber_DefaultValue = null;
			Tremolo = Tremolo_DefaultValue = new DisparityindexSeriesSonificationTracksMappingTremolo();
			Volume = Volume_DefaultValue = new DisparityindexSeriesSonificationTracksMappingVolume();
		...
		/// </summary>
		public DisparityindexSeriesSonificationTracksMappingFrequency Frequency { get; set; }
		private DisparityindexSeriesSonificationTracksMappingFrequency Frequency_DefaultValue { get; set; }
		...
		/// </summary>
		public DisparityindexSeriesSonificationTracksMappingGapBetweenNotes GapBetweenNotes { get; set; }
		private DisparityindexSeriesSonificationTracksMappingGapBetweenNotes GapBetweenNotes_DefaultValue { get; set; }
		...
		/// </summary>
		public DisparityindexSeriesSonificationTracksMappingHighpass Highpass { get; set; }
		private DisparityindexSeriesSonificationTracksMappingHighpass Highpass_DefaultValue { get; set; }
		...
		/// </summary>
		public DisparityindexSeriesSonificationTracksMappingLowpass Lowpass { get; set; }
		private DisparityindexSeriesSonificationTracksMappingLowpass Lowpass_DefaultValue { get; set; }
		...
		/// </summary>
		public DisparityindexSeriesSonificationTracksMappingNoteDuration NoteDuration { get; set; }
		private DisparityindexSeriesSonificationTracksMappingNoteDuration NoteDuration_DefaultValue { get; set; }
		...
		/// </summary>
		public DisparityindexSeriesSonificationTracksMappingPan Pan { get; set; }
		private DisparityindexSeriesSonificationTracksMappingPan Pan_DefaultValue { get; set; }
		...
		/// </summary>
		public DisparityindexSeriesSonificationTracksMappingPitch Pitch { get; set; }
		private DisparityindexSeriesSonificationTracksMappingPitch Pitch_DefaultValue { get; set; }
		...
		/// </summary>
		public DisparityindexSeriesSonificationTracksMappingPlayDelay PlayDelay { get; set; }
		private DisparityindexSeriesSonificationTracksMappingPlayDelay PlayDelay_DefaultValue { get; set; }
		...
		/// </summary>
		public DisparityindexSeriesSonificationTracksMappingTime Time { get; set; }
		private DisparityindexSeriesSonificationTracksMappingTime Time_DefaultValue { get; set; }
		...
		/// </summary>
		public DisparityindexSeriesSonificationTracksMappingTremolo Tremolo { get; set; }
		private DisparityindexSeriesSonificationTracksMappingTremolo Tremolo_DefaultValue { get; set; }
		 

		/// <summary>
		/// The volume of notes, from 0 to 1.
		/// </summary>
		public DisparityindexSeriesSonificationTracksMappingVolume Volume { get; set; }
		private DisparityindexSeriesSonificationTracksMappingVolume Volume_DefaultValue { get; set; }
