...
{
	public partial class DisparityindexSeriesSonificationTracksMappingHighpassResonance  : BaseObject
	{
		Hashtable h = new Hashtable();

		public DisparityindexSeriesSonificationTracksMappingHighpassResonance()
		{
			MapFunction = MapFunction_DefaultValue = DisparityindexSeriesSonificationTracksMappingHighpassResonanceMapFunction.Linear;
			MapTo = MapTo_DefaultValue = "";
			Max = Max_DefaultValue = null;
			Min = Min_DefaultValue = null;
			Value = Value_DefaultValue = null;
			Within = Within_DefaultValue = DisparityindexSeriesSonificationTracksMappingHighpassResonanceWithin.Chart;
		...
		/// </summary>
		public DisparityindexSeriesSonificationTracksMappingHighpassResonanceMapFunction MapFunction { get; set; }
		private DisparityindexSeriesSonificationTracksMappingHighpassResonanceMapFunction MapFunction_DefaultValue { get; set; }
		...
		/// </summary>
		public DisparityindexSeriesSonificationTracksMappingHighpassResonanceWithin Within { get; set; }
		private DisparityindexSeriesSonificationTracksMappingHighpassResonanceWithin Within_DefaultValue { get; set; }
