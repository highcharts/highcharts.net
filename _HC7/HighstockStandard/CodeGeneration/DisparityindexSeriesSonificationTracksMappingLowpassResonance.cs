...
{
	public partial class DisparityindexSeriesSonificationTracksMappingLowpassResonance  : BaseObject
	{
		Hashtable h = new Hashtable();

		public DisparityindexSeriesSonificationTracksMappingLowpassResonance()
		{
			MapFunction = MapFunction_DefaultValue = DisparityindexSeriesSonificationTracksMappingLowpassResonanceMapFunction.Linear;
			MapTo = MapTo_DefaultValue = "";
			Max = Max_DefaultValue = null;
			Min = Min_DefaultValue = null;
			Value = Value_DefaultValue = null;
			Within = Within_DefaultValue = DisparityindexSeriesSonificationTracksMappingLowpassResonanceWithin.Chart;
		...
		/// </summary>
		public DisparityindexSeriesSonificationTracksMappingLowpassResonanceMapFunction MapFunction { get; set; }
		private DisparityindexSeriesSonificationTracksMappingLowpassResonanceMapFunction MapFunction_DefaultValue { get; set; }
		...
		/// </summary>
		public DisparityindexSeriesSonificationTracksMappingLowpassResonanceWithin Within { get; set; }
		private DisparityindexSeriesSonificationTracksMappingLowpassResonanceWithin Within_DefaultValue { get; set; }
