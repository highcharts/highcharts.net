...
{
	public partial class DisparityindexSeriesSonificationTracksMappingPan  : BaseObject
	{
		Hashtable h = new Hashtable();

		public DisparityindexSeriesSonificationTracksMappingPan()
		{
			MapFunction = MapFunction_DefaultValue = DisparityindexSeriesSonificationTracksMappingPanMapFunction.Linear;
			MapTo = MapTo_DefaultValue = "";
			Max = Max_DefaultValue = null;
			Min = Min_DefaultValue = null;
			Value = Value_DefaultValue = null;
			Within = Within_DefaultValue = DisparityindexSeriesSonificationTracksMappingPanWithin.Chart;
		...
		/// </summary>
		public DisparityindexSeriesSonificationTracksMappingPanMapFunction MapFunction { get; set; }
		private DisparityindexSeriesSonificationTracksMappingPanMapFunction MapFunction_DefaultValue { get; set; }
		...
		/// </summary>
		public DisparityindexSeriesSonificationTracksMappingPanWithin Within { get; set; }
		private DisparityindexSeriesSonificationTracksMappingPanWithin Within_DefaultValue { get; set; }
