...
{
	public partial class DisparityindexSeriesSonificationTracksMappingPitch  : BaseObject
	{
		Hashtable h = new Hashtable();

		public DisparityindexSeriesSonificationTracksMappingPitch()
		{
			MapFunction = MapFunction_DefaultValue = DisparityindexSeriesSonificationTracksMappingPitchMapFunction.Linear;
		...
		/// </summary>
		public DisparityindexSeriesSonificationTracksMappingPitchMapFunction MapFunction { get; set; }
		private DisparityindexSeriesSonificationTracksMappingPitchMapFunction MapFunction_DefaultValue { get; set; }
