...
{
	public partial class DisparityindexSeriesSonificationTracksMappingPlayDelay  : BaseObject
	{
		Hashtable h = new Hashtable();

		public DisparityindexSeriesSonificationTracksMappingPlayDelay()
		{
			MapFunction = MapFunction_DefaultValue = DisparityindexSeriesSonificationTracksMappingPlayDelayMapFunction.Linear;
			MapTo = MapTo_DefaultValue = "";
			Max = Max_DefaultValue = null;
			Min = Min_DefaultValue = null;
			Value = Value_DefaultValue = null;
			Within = Within_DefaultValue = DisparityindexSeriesSonificationTracksMappingPlayDelayWithin.Chart;
		...
		/// </summary>
		public DisparityindexSeriesSonificationTracksMappingPlayDelayMapFunction MapFunction { get; set; }
		private DisparityindexSeriesSonificationTracksMappingPlayDelayMapFunction MapFunction_DefaultValue { get; set; }
		...
		/// </summary>
		public DisparityindexSeriesSonificationTracksMappingPlayDelayWithin Within { get; set; }
		private DisparityindexSeriesSonificationTracksMappingPlayDelayWithin Within_DefaultValue { get; set; }
