...
{
	public partial class DisparityindexSeriesSonificationTracksMappingVolume  : BaseObject
	{
		Hashtable h = new Hashtable();

		public DisparityindexSeriesSonificationTracksMappingVolume()
		{
			MapFunction = MapFunction_DefaultValue = DisparityindexSeriesSonificationTracksMappingVolumeMapFunction.Linear;
			MapTo = MapTo_DefaultValue = "";
			Max = Max_DefaultValue = null;
			Min = Min_DefaultValue = null;
			Value = Value_DefaultValue = null;
			Within = Within_DefaultValue = DisparityindexSeriesSonificationTracksMappingVolumeWithin.Chart;
		...
		/// </summary>
		public DisparityindexSeriesSonificationTracksMappingVolumeMapFunction MapFunction { get; set; }
		private DisparityindexSeriesSonificationTracksMappingVolumeMapFunction MapFunction_DefaultValue { get; set; }
		...
		/// </summary>
		public DisparityindexSeriesSonificationTracksMappingVolumeWithin Within { get; set; }
		private DisparityindexSeriesSonificationTracksMappingVolumeWithin Within_DefaultValue { get; set; }
