...
{
	public partial class DisparityindexSeriesSonificationTracksPointGrouping  : BaseObject
	{
		Hashtable h = new Hashtable();

		public DisparityindexSeriesSonificationTracksPointGrouping()
		{
			Algorithm = Algorithm_DefaultValue = DisparityindexSeriesSonificationTracksPointGroupingAlgorithm.Minimax;
		...
		/// </summary>
		public DisparityindexSeriesSonificationTracksPointGroupingAlgorithm Algorithm { get; set; }
		private DisparityindexSeriesSonificationTracksPointGroupingAlgorithm Algorithm_DefaultValue { get; set; }
