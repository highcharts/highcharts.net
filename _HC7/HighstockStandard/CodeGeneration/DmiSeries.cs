...
{
	public partial class DmiSeries  : Series
	{
		...
		public DmiSeries()
		{
			...
			Cursor = Cursor_DefaultValue = DmiSeriesCursor.Null;
			Custom = Custom_DefaultValue = new Hashtable();
			DashStyle = DashStyle_DefaultValue = DmiSeriesDashStyle.Null;
			DataGrouping = DataGrouping_DefaultValue = new DmiSeriesDataGrouping();
			DataLabels = DataLabels_DefaultValue = new DmiSeriesDataLabels();
			DataSorting = DataSorting_DefaultValue = new DmiSeriesDataSorting();
			Description = Description_DefaultValue = "";
			Dumbell = Dumbell_DefaultValue = new DmiSeriesDumbell();
			EnableMouseTracking = EnableMouseTracking_DefaultValue = true;
			Events = Events_DefaultValue = new DmiSeriesEvents();
			FindNearestPointBy = FindNearestPointBy_DefaultValue = DmiSeriesFindNearestPointBy.X;
			GapSize = GapSize_DefaultValue = 0;
			GapUnit = GapUnit_DefaultValue = DmiSeriesGapUnit.Relative;
			GetExtremesFromAll = GetExtremesFromAll_DefaultValue = false;
			Id = Id_DefaultValue = "";
			InactiveOtherPoints = InactiveOtherPoints_DefaultValue = false;
			IncludeInDataExport = IncludeInDataExport_DefaultValue = null;
			Index = Index_DefaultValue = null;
			Label = Label_DefaultValue = new DmiSeriesLabel();
			LastPrice = LastPrice_DefaultValue = new DmiSeriesLastPrice();
			LastVisiblePrice = LastVisiblePrice_DefaultValue = new DmiSeriesLastVisiblePrice();
			LegendIndex = LegendIndex_DefaultValue = null;
			LegendSymbol = LegendSymbol_DefaultValue = DmiSeriesLegendSymbol.Rectangle;
			Linecap = Linecap_DefaultValue = DmiSeriesLinecap.Round;
			LineWidth = LineWidth_DefaultValue = 2;
			LinkedTo = LinkedTo_DefaultValue = "";
			Marker = Marker_DefaultValue = new DmiSeriesMarker();
			MinusDILine = MinusDILine_DefaultValue = new DmiSeriesMinusDILine();
			Name = Name_DefaultValue = "";
			NegativeColor = NegativeColor_DefaultValue = "";
			OnPoint = OnPoint_DefaultValue = new DmiSeriesOnPoint();
			...
			Sonification = Sonification_DefaultValue = new DmiSeriesSonification();
			Stack = Stack_DefaultValue = "";
			StackNumber = StackNumber_DefaultValue = null;
			States = States_DefaultValue = new DmiSeriesStates();
			Step = Step_DefaultValue = DmiSeriesStep.Null;
			StickyTracking = StickyTracking_DefaultValue = true;
			Threshold = Threshold_DefaultValue = 0;
			Tooltip = Tooltip_DefaultValue = new DmiSeriesTooltip();
			...
			Zones = Zones_DefaultValue = new List<DmiSeriesZones>();
		...
		/// </summary>
		public DmiSeriesAccessibility Accessibility { get; set; }
		private DmiSeriesAccessibility Accessibility_DefaultValue { get; set; }
		...
		/// </summary>
		public DmiSeriesBoostBlending BoostBlending { get; set; }
		private DmiSeriesBoostBlending BoostBlending_DefaultValue { get; set; }
		...
		/// </summary>
		public DmiSeriesCompare Compare { get; set; }
		private DmiSeriesCompare Compare_DefaultValue { get; set; }
		 

		/// <summary>
		/// When [compare](#plotOptions.series.compare) is `percent`, this optiondictates whether to use 0 or 100 as the base of comparison.
		/// </summary>
		public DmiSeriesCompareBase CompareBase { get; set; }
		private DmiSeriesCompareBase CompareBase_DefaultValue { get; set; }
		...
		/// </summary>
		public DmiSeriesCursor Cursor { get; set; }
		private DmiSeriesCursor Cursor_DefaultValue { get; set; }
		...
		/// </summary>
		public DmiSeriesDashStyle DashStyle { get; set; }
		private DmiSeriesDashStyle DashStyle_DefaultValue { get; set; }
		...
		/// </summary>
		public DmiSeriesDataGrouping DataGrouping { get; set; }
		private DmiSeriesDataGrouping DataGrouping_DefaultValue { get; set; }
		...
		/// </summary>
		public DmiSeriesDataLabels DataLabels { get; set; }
		private DmiSeriesDataLabels DataLabels_DefaultValue { get; set; }
		 

		/// <summary>
		/// Options for the series data sorting.
		/// </summary>
		public DmiSeriesDataSorting DataSorting { get; set; }
		private DmiSeriesDataSorting DataSorting_DefaultValue { get; set; }
		...
		/// 
		/// </summary>
		public DmiSeriesDumbell Dumbell { get; set; }
		private DmiSeriesDumbell Dumbell_DefaultValue { get; set; }
		...
		/// </summary>
		public DmiSeriesEvents Events { get; set; }
		private DmiSeriesEvents Events_DefaultValue { get; set; }
		...
		/// </summary>
		public DmiSeriesFindNearestPointBy FindNearestPointBy { get; set; }
		private DmiSeriesFindNearestPointBy FindNearestPointBy_DefaultValue { get; set; }
		...
		/// </summary>
		public DmiSeriesGapUnit GapUnit { get; set; }
		private DmiSeriesGapUnit GapUnit_DefaultValue { get; set; }
		...
		/// </summary>
		public DmiSeriesLabel Label { get; set; }
		private DmiSeriesLabel Label_DefaultValue { get; set; }
		 

		/// <summary>
		/// The line marks the last price from all points.
		/// </summary>
		public DmiSeriesLastPrice LastPrice { get; set; }
		private DmiSeriesLastPrice LastPrice_DefaultValue { get; set; }
		 

		/// <summary>
		/// The line marks the last price from visible range of points.
		/// </summary>
		public DmiSeriesLastVisiblePrice LastVisiblePrice { get; set; }
		private DmiSeriesLastVisiblePrice LastVisiblePrice_DefaultValue { get; set; }
		...
		/// </summary>
		public DmiSeriesLegendSymbol LegendSymbol { get; set; }
		private DmiSeriesLegendSymbol LegendSymbol_DefaultValue { get; set; }
		 

		/// <summary>
		/// The line cap used for line ends and line joins on the graph.
		/// </summary>
		public DmiSeriesLinecap Linecap { get; set; }
		private DmiSeriesLinecap Linecap_DefaultValue { get; set; }
		...
		/// -DI line options.
		/// </summary>
		public DmiSeriesMinusDILine MinusDILine { get; set; }
		private DmiSeriesMinusDILine MinusDILine_DefaultValue { get; set; }
		...
		/// </summary>
		public DmiSeriesOnPoint OnPoint { get; set; }
		private DmiSeriesOnPoint OnPoint_DefaultValue { get; set; }
		...
		/// </summary>
		public DmiSeriesParams Params { get; set; }
		private DmiSeriesParams Params_DefaultValue { get; set; }
		 

		/// <summary>
		/// +DI line options.
		/// </summary>
		public DmiSeriesPlusDILine PlusDILine { get; set; }
		private DmiSeriesPlusDILine PlusDILine_DefaultValue { get; set; }
		...
		/// </summary>
		public DmiSeriesSonification Sonification { get; set; }
		private DmiSeriesSonification Sonification_DefaultValue { get; set; }
		...
		/// 
		/// </summary>
		public DmiSeriesStates States { get; set; }
		private DmiSeriesStates States_DefaultValue { get; set; }
		 

		/// <summary>
		/// Whether to apply steps to the line. Possible values are `left`,`center` and `right`.
		/// </summary>
		public DmiSeriesStep Step { get; set; }
		private DmiSeriesStep Step_DefaultValue { get; set; }
		...
		/// </summary>
		public DmiSeriesTooltip Tooltip { get; set; }
		private DmiSeriesTooltip Tooltip_DefaultValue { get; set; }
		...
		/// </summary>
		public List<DmiSeriesZones> Zones { get; set; }
		private List<DmiSeriesZones> Zones_DefaultValue { get; set; }
