...
{
	public partial class DmiSeriesSonificationContextTracks  : BaseObject
	{
		Hashtable h = new Hashtable();

		public DmiSeriesSonificationContextTracks()
		{
			ActiveWhen = ActiveWhen_DefaultValue = new DmiSeriesSonificationContextTracksActiveWhen();
			Instrument = Instrument_DefaultValue = null;
			InstrumentString = InstrumentString_DefaultValue = "null";
			Mapping = Mapping_DefaultValue = new DmiSeriesSonificationContextTracksMapping();
			MidiName = MidiName_DefaultValue = "";
			PointGrouping = PointGrouping_DefaultValue = new DmiSeriesSonificationContextTracksPointGrouping();
			...
			Type = Type_DefaultValue = DmiSeriesSonificationContextTracksType.Instrument;
			ValueInterval = ValueInterval_DefaultValue = null;
			ValueMapFunction = ValueMapFunction_DefaultValue = DmiSeriesSonificationContextTracksValueMapFunction.Linear;
		...
		/// </summary>
		public DmiSeriesSonificationContextTracksActiveWhen ActiveWhen { get; set; }
		private DmiSeriesSonificationContextTracksActiveWhen ActiveWhen_DefaultValue { get; set; }
		...
		/// </summary>
		public DmiSeriesSonificationContextTracksMapping Mapping { get; set; }
		private DmiSeriesSonificationContextTracksMapping Mapping_DefaultValue { get; set; }
		...
		/// </summary>
		public DmiSeriesSonificationContextTracksPointGrouping PointGrouping { get; set; }
		private DmiSeriesSonificationContextTracksPointGrouping PointGrouping_DefaultValue { get; set; }
		...
		/// </summary>
		public DmiSeriesSonificationContextTracksType Type { get; set; }
		private DmiSeriesSonificationContextTracksType Type_DefaultValue { get; set; }
		...
		/// </summary>
		public DmiSeriesSonificationContextTracksValueMapFunction ValueMapFunction { get; set; }
		private DmiSeriesSonificationContextTracksValueMapFunction ValueMapFunction_DefaultValue { get; set; }
