...
{
	public partial class DmiSeriesSonificationContextTracksMappingPan  : BaseObject
	{
		Hashtable h = new Hashtable();

		public DmiSeriesSonificationContextTracksMappingPan()
		{
			MapFunction = MapFunction_DefaultValue = DmiSeriesSonificationContextTracksMappingPanMapFunction.Linear;
			MapTo = MapTo_DefaultValue = "";
			Max = Max_DefaultValue = null;
			Min = Min_DefaultValue = null;
			Value = Value_DefaultValue = null;
			Within = Within_DefaultValue = DmiSeriesSonificationContextTracksMappingPanWithin.Chart;
		...
		/// </summary>
		public DmiSeriesSonificationContextTracksMappingPanMapFunction MapFunction { get; set; }
		private DmiSeriesSonificationContextTracksMappingPanMapFunction MapFunction_DefaultValue { get; set; }
		...
		/// </summary>
		public DmiSeriesSonificationContextTracksMappingPanWithin Within { get; set; }
		private DmiSeriesSonificationContextTracksMappingPanWithin Within_DefaultValue { get; set; }
