...
{
	public partial class DmiSeriesSonificationContextTracksMappingPitch  : BaseObject
	{
		Hashtable h = new Hashtable();

		public DmiSeriesSonificationContextTracksMappingPitch()
		{
			MapFunction = MapFunction_DefaultValue = DmiSeriesSonificationContextTracksMappingPitchMapFunction.Linear;
		...
		/// </summary>
		public DmiSeriesSonificationContextTracksMappingPitchMapFunction MapFunction { get; set; }
		private DmiSeriesSonificationContextTracksMappingPitchMapFunction MapFunction_DefaultValue { get; set; }
