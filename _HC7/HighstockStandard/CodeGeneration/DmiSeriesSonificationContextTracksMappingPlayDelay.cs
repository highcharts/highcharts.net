...
{
	public partial class DmiSeriesSonificationContextTracksMappingPlayDelay  : BaseObject
	{
		Hashtable h = new Hashtable();

		public DmiSeriesSonificationContextTracksMappingPlayDelay()
		{
			MapFunction = MapFunction_DefaultValue = DmiSeriesSonificationContextTracksMappingPlayDelayMapFunction.Linear;
			MapTo = MapTo_DefaultValue = "";
			Max = Max_DefaultValue = null;
			Min = Min_DefaultValue = null;
			Value = Value_DefaultValue = null;
			Within = Within_DefaultValue = DmiSeriesSonificationContextTracksMappingPlayDelayWithin.Chart;
		...
		/// </summary>
		public DmiSeriesSonificationContextTracksMappingPlayDelayMapFunction MapFunction { get; set; }
		private DmiSeriesSonificationContextTracksMappingPlayDelayMapFunction MapFunction_DefaultValue { get; set; }
		...
		/// </summary>
		public DmiSeriesSonificationContextTracksMappingPlayDelayWithin Within { get; set; }
		private DmiSeriesSonificationContextTracksMappingPlayDelayWithin Within_DefaultValue { get; set; }
