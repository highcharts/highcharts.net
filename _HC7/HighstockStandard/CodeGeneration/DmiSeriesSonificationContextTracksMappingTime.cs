...
{
	public partial class DmiSeriesSonificationContextTracksMappingTime  : BaseObject
	{
		Hashtable h = new Hashtable();

		public DmiSeriesSonificationContextTracksMappingTime()
		{
			MapFunction = MapFunction_DefaultValue = DmiSeriesSonificationContextTracksMappingTimeMapFunction.Linear;
			MapTo = MapTo_DefaultValue = "";
			Max = Max_DefaultValue = null;
			Min = Min_DefaultValue = null;
			Value = Value_DefaultValue = null;
			Within = Within_DefaultValue = DmiSeriesSonificationContextTracksMappingTimeWithin.Chart;
		...
		/// </summary>
		public DmiSeriesSonificationContextTracksMappingTimeMapFunction MapFunction { get; set; }
		private DmiSeriesSonificationContextTracksMappingTimeMapFunction MapFunction_DefaultValue { get; set; }
		...
		/// </summary>
		public DmiSeriesSonificationContextTracksMappingTimeWithin Within { get; set; }
		private DmiSeriesSonificationContextTracksMappingTimeWithin Within_DefaultValue { get; set; }
