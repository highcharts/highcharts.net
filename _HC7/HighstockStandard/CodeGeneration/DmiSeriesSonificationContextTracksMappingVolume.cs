...
{
	public partial class DmiSeriesSonificationContextTracksMappingVolume  : BaseObject
	{
		Hashtable h = new Hashtable();

		public DmiSeriesSonificationContextTracksMappingVolume()
		{
			MapFunction = MapFunction_DefaultValue = DmiSeriesSonificationContextTracksMappingVolumeMapFunction.Linear;
			MapTo = MapTo_DefaultValue = "";
			Max = Max_DefaultValue = null;
			Min = Min_DefaultValue = null;
			Value = Value_DefaultValue = null;
			Within = Within_DefaultValue = DmiSeriesSonificationContextTracksMappingVolumeWithin.Chart;
		...
		/// </summary>
		public DmiSeriesSonificationContextTracksMappingVolumeMapFunction MapFunction { get; set; }
		private DmiSeriesSonificationContextTracksMappingVolumeMapFunction MapFunction_DefaultValue { get; set; }
		...
		/// </summary>
		public DmiSeriesSonificationContextTracksMappingVolumeWithin Within { get; set; }
		private DmiSeriesSonificationContextTracksMappingVolumeWithin Within_DefaultValue { get; set; }
