...
{
	public partial class DmiSeriesSonificationContextTracksPointGrouping  : BaseObject
	{
		Hashtable h = new Hashtable();

		public DmiSeriesSonificationContextTracksPointGrouping()
		{
			Algorithm = Algorithm_DefaultValue = DmiSeriesSonificationContextTracksPointGroupingAlgorithm.Minimax;
		...
		/// </summary>
		public DmiSeriesSonificationContextTracksPointGroupingAlgorithm Algorithm { get; set; }
		private DmiSeriesSonificationContextTracksPointGroupingAlgorithm Algorithm_DefaultValue { get; set; }
