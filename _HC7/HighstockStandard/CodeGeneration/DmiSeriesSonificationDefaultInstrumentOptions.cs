...
{
	public partial class DmiSeriesSonificationDefaultInstrumentOptions  : BaseObject
	{
		Hashtable h = new Hashtable();

		public DmiSeriesSonificationDefaultInstrumentOptions()
		{
			ActiveWhen = ActiveWhen_DefaultValue = new DmiSeriesSonificationDefaultInstrumentOptionsActiveWhen();
			Instrument = Instrument_DefaultValue = null;
			InstrumentString = InstrumentString_DefaultValue = "null";
			Mapping = Mapping_DefaultValue = new DmiSeriesSonificationDefaultInstrumentOptionsMapping();
			MidiName = MidiName_DefaultValue = "";
			PointGrouping = PointGrouping_DefaultValue = new DmiSeriesSonificationDefaultInstrumentOptionsPointGrouping();
			RoundToMusicalNotes = RoundToMusicalNotes_DefaultValue = true;
			ShowPlayMarker = ShowPlayMarker_DefaultValue = true;
			Type = Type_DefaultValue = DmiSeriesSonificationDefaultInstrumentOptionsType.Instrument;
		...
		/// </summary>
		public DmiSeriesSonificationDefaultInstrumentOptionsActiveWhen ActiveWhen { get; set; }
		private DmiSeriesSonificationDefaultInstrumentOptionsActiveWhen ActiveWhen_DefaultValue { get; set; }
		...
		/// </summary>
		public DmiSeriesSonificationDefaultInstrumentOptionsMapping Mapping { get; set; }
		private DmiSeriesSonificationDefaultInstrumentOptionsMapping Mapping_DefaultValue { get; set; }
		...
		/// </summary>
		public DmiSeriesSonificationDefaultInstrumentOptionsPointGrouping PointGrouping { get; set; }
		private DmiSeriesSonificationDefaultInstrumentOptionsPointGrouping PointGrouping_DefaultValue { get; set; }
		...
		/// </summary>
		public DmiSeriesSonificationDefaultInstrumentOptionsType Type { get; set; }
		private DmiSeriesSonificationDefaultInstrumentOptionsType Type_DefaultValue { get; set; }
