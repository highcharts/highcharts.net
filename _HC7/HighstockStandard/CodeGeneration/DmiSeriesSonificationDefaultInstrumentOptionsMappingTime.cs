...
{
	public partial class DmiSeriesSonificationDefaultInstrumentOptionsMappingTime  : BaseObject
	{
		Hashtable h = new Hashtable();

		public DmiSeriesSonificationDefaultInstrumentOptionsMappingTime()
		{
			MapFunction = MapFunction_DefaultValue = DmiSeriesSonificationDefaultInstrumentOptionsMappingTimeMapFunction.Linear;
			MapTo = MapTo_DefaultValue = "";
			Max = Max_DefaultValue = null;
			Min = Min_DefaultValue = null;
			Value = Value_DefaultValue = null;
			Within = Within_DefaultValue = DmiSeriesSonificationDefaultInstrumentOptionsMappingTimeWithin.Chart;
		...
		/// </summary>
		public DmiSeriesSonificationDefaultInstrumentOptionsMappingTimeMapFunction MapFunction { get; set; }
		private DmiSeriesSonificationDefaultInstrumentOptionsMappingTimeMapFunction MapFunction_DefaultValue { get; set; }
		...
		/// </summary>
		public DmiSeriesSonificationDefaultInstrumentOptionsMappingTimeWithin Within { get; set; }
		private DmiSeriesSonificationDefaultInstrumentOptionsMappingTimeWithin Within_DefaultValue { get; set; }
