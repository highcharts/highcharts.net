...
{
	public partial class DmiSeriesSonificationDefaultSpeechOptions  : BaseObject
	{
		Hashtable h = new Hashtable();

		public DmiSeriesSonificationDefaultSpeechOptions()
		{
			ActiveWhen = ActiveWhen_DefaultValue = new DmiSeriesSonificationDefaultSpeechOptionsActiveWhen();
			Language = Language_DefaultValue = "en-US";
			Mapping = Mapping_DefaultValue = new DmiSeriesSonificationDefaultSpeechOptionsMapping();
			PointGrouping = PointGrouping_DefaultValue = new DmiSeriesSonificationDefaultSpeechOptionsPointGrouping();
			PreferredVoice = PreferredVoice_DefaultValue = "";
			ShowPlayMarker = ShowPlayMarker_DefaultValue = true;
			Type = Type_DefaultValue = DmiSeriesSonificationDefaultSpeechOptionsType.Instrument;
		...
		/// </summary>
		public DmiSeriesSonificationDefaultSpeechOptionsActiveWhen ActiveWhen { get; set; }
		private DmiSeriesSonificationDefaultSpeechOptionsActiveWhen ActiveWhen_DefaultValue { get; set; }
		...
		/// </summary>
		public DmiSeriesSonificationDefaultSpeechOptionsMapping Mapping { get; set; }
		private DmiSeriesSonificationDefaultSpeechOptionsMapping Mapping_DefaultValue { get; set; }
		 

		/// <summary>
		/// Options for point grouping, specifically for instrument tracks.
		/// </summary>
		public DmiSeriesSonificationDefaultSpeechOptionsPointGrouping PointGrouping { get; set; }
		private DmiSeriesSonificationDefaultSpeechOptionsPointGrouping PointGrouping_DefaultValue { get; set; }
		...
		/// </summary>
		public DmiSeriesSonificationDefaultSpeechOptionsType Type { get; set; }
		private DmiSeriesSonificationDefaultSpeechOptionsType Type_DefaultValue { get; set; }
