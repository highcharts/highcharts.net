...
{
	public partial class DmiSeriesSonificationDefaultSpeechOptionsMapping  : BaseObject
	{
		Hashtable h = new Hashtable();

		public DmiSeriesSonificationDefaultSpeechOptionsMapping()
		{
			Frequency = Frequency_DefaultValue = new DmiSeriesSonificationDefaultSpeechOptionsMappingFrequency();
			GapBetweenNotes = GapBetweenNotes_DefaultValue = new DmiSeriesSonificationDefaultSpeechOptionsMappingGapBetweenNotes();
			Highpass = Highpass_DefaultValue = new DmiSeriesSonificationDefaultSpeechOptionsMappingHighpass();
			Lowpass = Lowpass_DefaultValue = new DmiSeriesSonificationDefaultSpeechOptionsMappingLowpass();
			NoteDuration = NoteDuration_DefaultValue = new DmiSeriesSonificationDefaultSpeechOptionsMappingNoteDuration();
			Pan = Pan_DefaultValue = new DmiSeriesSonificationDefaultSpeechOptionsMappingPan();
			Pitch = Pitch_DefaultValue = new DmiSeriesSonificationDefaultSpeechOptionsMappingPitch();
			PitchString = PitchString_DefaultValue = "null";
			PitchNumber = PitchNumber_DefaultValue = null;
			PlayDelay = PlayDelay_DefaultValue = new DmiSeriesSonificationDefaultSpeechOptionsMappingPlayDelay();
			Time = Time_DefaultValue = new DmiSeriesSonificationDefaultSpeechOptionsMappingTime();
			TimeString = TimeString_DefaultValue = "null";
			TimeNumber = TimeNumber_DefaultValue = null;
			Tremolo = Tremolo_DefaultValue = new DmiSeriesSonificationDefaultSpeechOptionsMappingTremolo();
			Volume = Volume_DefaultValue = new DmiSeriesSonificationDefaultSpeechOptionsMappingVolume();
		...
		/// </summary>
		public DmiSeriesSonificationDefaultSpeechOptionsMappingFrequency Frequency { get; set; }
		private DmiSeriesSonificationDefaultSpeechOptionsMappingFrequency Frequency_DefaultValue { get; set; }
		...
		/// </summary>
		public DmiSeriesSonificationDefaultSpeechOptionsMappingGapBetweenNotes GapBetweenNotes { get; set; }
		private DmiSeriesSonificationDefaultSpeechOptionsMappingGapBetweenNotes GapBetweenNotes_DefaultValue { get; set; }
		...
		/// </summary>
		public DmiSeriesSonificationDefaultSpeechOptionsMappingHighpass Highpass { get; set; }
		private DmiSeriesSonificationDefaultSpeechOptionsMappingHighpass Highpass_DefaultValue { get; set; }
		...
		/// </summary>
		public DmiSeriesSonificationDefaultSpeechOptionsMappingLowpass Lowpass { get; set; }
		private DmiSeriesSonificationDefaultSpeechOptionsMappingLowpass Lowpass_DefaultValue { get; set; }
		...
		/// </summary>
		public DmiSeriesSonificationDefaultSpeechOptionsMappingNoteDuration NoteDuration { get; set; }
		private DmiSeriesSonificationDefaultSpeechOptionsMappingNoteDuration NoteDuration_DefaultValue { get; set; }
		...
		/// </summary>
		public DmiSeriesSonificationDefaultSpeechOptionsMappingPan Pan { get; set; }
		private DmiSeriesSonificationDefaultSpeechOptionsMappingPan Pan_DefaultValue { get; set; }
		...
		/// </summary>
		public DmiSeriesSonificationDefaultSpeechOptionsMappingPitch Pitch { get; set; }
		private DmiSeriesSonificationDefaultSpeechOptionsMappingPitch Pitch_DefaultValue { get; set; }
		...
		/// </summary>
		public DmiSeriesSonificationDefaultSpeechOptionsMappingPlayDelay PlayDelay { get; set; }
		private DmiSeriesSonificationDefaultSpeechOptionsMappingPlayDelay PlayDelay_DefaultValue { get; set; }
		...
		/// </summary>
		public DmiSeriesSonificationDefaultSpeechOptionsMappingTime Time { get; set; }
		private DmiSeriesSonificationDefaultSpeechOptionsMappingTime Time_DefaultValue { get; set; }
		...
		/// </summary>
		public DmiSeriesSonificationDefaultSpeechOptionsMappingTremolo Tremolo { get; set; }
		private DmiSeriesSonificationDefaultSpeechOptionsMappingTremolo Tremolo_DefaultValue { get; set; }
		 

		/// <summary>
		/// The volume of notes, from 0 to 1.
		/// </summary>
		public DmiSeriesSonificationDefaultSpeechOptionsMappingVolume Volume { get; set; }
		private DmiSeriesSonificationDefaultSpeechOptionsMappingVolume Volume_DefaultValue { get; set; }
