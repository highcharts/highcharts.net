...
{
	public partial class DmiSeriesSonificationDefaultSpeechOptionsMappingTremoloDepth  : BaseObject
	{
		Hashtable h = new Hashtable();

		public DmiSeriesSonificationDefaultSpeechOptionsMappingTremoloDepth()
		{
			MapFunction = MapFunction_DefaultValue = DmiSeriesSonificationDefaultSpeechOptionsMappingTremoloDepthMapFunction.Linear;
			MapTo = MapTo_DefaultValue = "";
			Max = Max_DefaultValue = null;
			Min = Min_DefaultValue = null;
			Value = Value_DefaultValue = null;
			Within = Within_DefaultValue = DmiSeriesSonificationDefaultSpeechOptionsMappingTremoloDepthWithin.Chart;
		...
		/// </summary>
		public DmiSeriesSonificationDefaultSpeechOptionsMappingTremoloDepthMapFunction MapFunction { get; set; }
		private DmiSeriesSonificationDefaultSpeechOptionsMappingTremoloDepthMapFunction MapFunction_DefaultValue { get; set; }
		...
		/// </summary>
		public DmiSeriesSonificationDefaultSpeechOptionsMappingTremoloDepthWithin Within { get; set; }
		private DmiSeriesSonificationDefaultSpeechOptionsMappingTremoloDepthWithin Within_DefaultValue { get; set; }
