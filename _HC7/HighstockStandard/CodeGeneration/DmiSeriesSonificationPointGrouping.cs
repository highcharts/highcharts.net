...
{
	public partial class DmiSeriesSonificationPointGrouping  : BaseObject
	{
		Hashtable h = new Hashtable();

		public DmiSeriesSonificationPointGrouping()
		{
			Algorithm = Algorithm_DefaultValue = DmiSeriesSonificationPointGroupingAlgorithm.Minimax;
		...
		/// </summary>
		public DmiSeriesSonificationPointGroupingAlgorithm Algorithm { get; set; }
		private DmiSeriesSonificationPointGroupingAlgorithm Algorithm_DefaultValue { get; set; }
