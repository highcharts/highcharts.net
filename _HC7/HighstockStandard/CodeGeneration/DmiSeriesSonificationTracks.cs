...
{
	public partial class DmiSeriesSonificationTracks  : BaseObject
	{
		Hashtable h = new Hashtable();

		public DmiSeriesSonificationTracks()
		{
			ActiveWhen = ActiveWhen_DefaultValue = new DmiSeriesSonificationTracksActiveWhen();
			Instrument = Instrument_DefaultValue = null;
			InstrumentString = InstrumentString_DefaultValue = "null";
			Mapping = Mapping_DefaultValue = new DmiSeriesSonificationTracksMapping();
			MidiName = MidiName_DefaultValue = "";
			PointGrouping = PointGrouping_DefaultValue = new DmiSeriesSonificationTracksPointGrouping();
			RoundToMusicalNotes = RoundToMusicalNotes_DefaultValue = true;
			ShowPlayMarker = ShowPlayMarker_DefaultValue = true;
			Type = Type_DefaultValue = DmiSeriesSonificationTracksType.Instrument;
		...
		/// </summary>
		public DmiSeriesSonificationTracksActiveWhen ActiveWhen { get; set; }
		private DmiSeriesSonificationTracksActiveWhen ActiveWhen_DefaultValue { get; set; }
		...
		/// </summary>
		public DmiSeriesSonificationTracksMapping Mapping { get; set; }
		private DmiSeriesSonificationTracksMapping Mapping_DefaultValue { get; set; }
		...
		/// </summary>
		public DmiSeriesSonificationTracksPointGrouping PointGrouping { get; set; }
		private DmiSeriesSonificationTracksPointGrouping PointGrouping_DefaultValue { get; set; }
		...
		/// </summary>
		public DmiSeriesSonificationTracksType Type { get; set; }
		private DmiSeriesSonificationTracksType Type_DefaultValue { get; set; }
