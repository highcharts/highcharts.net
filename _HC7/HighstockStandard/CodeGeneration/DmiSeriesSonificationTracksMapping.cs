...
{
	public partial class DmiSeriesSonificationTracksMapping  : BaseObject
	{
		Hashtable h = new Hashtable();

		public DmiSeriesSonificationTracksMapping()
		{
			Frequency = Frequency_DefaultValue = new DmiSeriesSonificationTracksMappingFrequency();
			GapBetweenNotes = GapBetweenNotes_DefaultValue = new DmiSeriesSonificationTracksMappingGapBetweenNotes();
			Highpass = Highpass_DefaultValue = new DmiSeriesSonificationTracksMappingHighpass();
			Lowpass = Lowpass_DefaultValue = new DmiSeriesSonificationTracksMappingLowpass();
			NoteDuration = NoteDuration_DefaultValue = new DmiSeriesSonificationTracksMappingNoteDuration();
			Pan = Pan_DefaultValue = new DmiSeriesSonificationTracksMappingPan();
			Pitch = Pitch_DefaultValue = new DmiSeriesSonificationTracksMappingPitch();
			PitchString = PitchString_DefaultValue = "null";
			PitchNumber = PitchNumber_DefaultValue = null;
			PlayDelay = PlayDelay_DefaultValue = new DmiSeriesSonificationTracksMappingPlayDelay();
			Time = Time_DefaultValue = new DmiSeriesSonificationTracksMappingTime();
			TimeString = TimeString_DefaultValue = "null";
			TimeNumber = TimeNumber_DefaultValue = null;
			Tremolo = Tremolo_DefaultValue = new DmiSeriesSonificationTracksMappingTremolo();
			Volume = Volume_DefaultValue = new DmiSeriesSonificationTracksMappingVolume();
		...
		/// </summary>
		public DmiSeriesSonificationTracksMappingFrequency Frequency { get; set; }
		private DmiSeriesSonificationTracksMappingFrequency Frequency_DefaultValue { get; set; }
		...
		/// </summary>
		public DmiSeriesSonificationTracksMappingGapBetweenNotes GapBetweenNotes { get; set; }
		private DmiSeriesSonificationTracksMappingGapBetweenNotes GapBetweenNotes_DefaultValue { get; set; }
		...
		/// </summary>
		public DmiSeriesSonificationTracksMappingHighpass Highpass { get; set; }
		private DmiSeriesSonificationTracksMappingHighpass Highpass_DefaultValue { get; set; }
		...
		/// </summary>
		public DmiSeriesSonificationTracksMappingLowpass Lowpass { get; set; }
		private DmiSeriesSonificationTracksMappingLowpass Lowpass_DefaultValue { get; set; }
		...
		/// </summary>
		public DmiSeriesSonificationTracksMappingNoteDuration NoteDuration { get; set; }
		private DmiSeriesSonificationTracksMappingNoteDuration NoteDuration_DefaultValue { get; set; }
		...
		/// </summary>
		public DmiSeriesSonificationTracksMappingPan Pan { get; set; }
		private DmiSeriesSonificationTracksMappingPan Pan_DefaultValue { get; set; }
		...
		/// </summary>
		public DmiSeriesSonificationTracksMappingPitch Pitch { get; set; }
		private DmiSeriesSonificationTracksMappingPitch Pitch_DefaultValue { get; set; }
		...
		/// </summary>
		public DmiSeriesSonificationTracksMappingPlayDelay PlayDelay { get; set; }
		private DmiSeriesSonificationTracksMappingPlayDelay PlayDelay_DefaultValue { get; set; }
		...
		/// </summary>
		public DmiSeriesSonificationTracksMappingTime Time { get; set; }
		private DmiSeriesSonificationTracksMappingTime Time_DefaultValue { get; set; }
		...
		/// </summary>
		public DmiSeriesSonificationTracksMappingTremolo Tremolo { get; set; }
		private DmiSeriesSonificationTracksMappingTremolo Tremolo_DefaultValue { get; set; }
		 

		/// <summary>
		/// The volume of notes, from 0 to 1.
		/// </summary>
		public DmiSeriesSonificationTracksMappingVolume Volume { get; set; }
		private DmiSeriesSonificationTracksMappingVolume Volume_DefaultValue { get; set; }
