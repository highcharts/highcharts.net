...
{
	public partial class DmiSeriesSonificationTracksMappingFrequency  : BaseObject
	{
		Hashtable h = new Hashtable();

		public DmiSeriesSonificationTracksMappingFrequency()
		{
			MapFunction = MapFunction_DefaultValue = DmiSeriesSonificationTracksMappingFrequencyMapFunction.Linear;
			MapTo = MapTo_DefaultValue = "";
			Max = Max_DefaultValue = null;
			Min = Min_DefaultValue = null;
			Value = Value_DefaultValue = null;
			Within = Within_DefaultValue = DmiSeriesSonificationTracksMappingFrequencyWithin.Chart;
		...
		/// </summary>
		public DmiSeriesSonificationTracksMappingFrequencyMapFunction MapFunction { get; set; }
		private DmiSeriesSonificationTracksMappingFrequencyMapFunction MapFunction_DefaultValue { get; set; }
		...
		/// </summary>
		public DmiSeriesSonificationTracksMappingFrequencyWithin Within { get; set; }
		private DmiSeriesSonificationTracksMappingFrequencyWithin Within_DefaultValue { get; set; }
