...
{
	public partial class DmiSeriesSonificationTracksMappingHighpassResonance  : BaseObject
	{
		Hashtable h = new Hashtable();

		public DmiSeriesSonificationTracksMappingHighpassResonance()
		{
			MapFunction = MapFunction_DefaultValue = DmiSeriesSonificationTracksMappingHighpassResonanceMapFunction.Linear;
			MapTo = MapTo_DefaultValue = "";
			Max = Max_DefaultValue = null;
			Min = Min_DefaultValue = null;
			Value = Value_DefaultValue = null;
			Within = Within_DefaultValue = DmiSeriesSonificationTracksMappingHighpassResonanceWithin.Chart;
		...
		/// </summary>
		public DmiSeriesSonificationTracksMappingHighpassResonanceMapFunction MapFunction { get; set; }
		private DmiSeriesSonificationTracksMappingHighpassResonanceMapFunction MapFunction_DefaultValue { get; set; }
		...
		/// </summary>
		public DmiSeriesSonificationTracksMappingHighpassResonanceWithin Within { get; set; }
		private DmiSeriesSonificationTracksMappingHighpassResonanceWithin Within_DefaultValue { get; set; }
