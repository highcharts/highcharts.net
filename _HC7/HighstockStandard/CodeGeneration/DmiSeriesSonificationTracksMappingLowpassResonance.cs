...
{
	public partial class DmiSeriesSonificationTracksMappingLowpassResonance  : BaseObject
	{
		Hashtable h = new Hashtable();

		public DmiSeriesSonificationTracksMappingLowpassResonance()
		{
			MapFunction = MapFunction_DefaultValue = DmiSeriesSonificationTracksMappingLowpassResonanceMapFunction.Linear;
			MapTo = MapTo_DefaultValue = "";
			Max = Max_DefaultValue = null;
			Min = Min_DefaultValue = null;
			Value = Value_DefaultValue = null;
			Within = Within_DefaultValue = DmiSeriesSonificationTracksMappingLowpassResonanceWithin.Chart;
		...
		/// </summary>
		public DmiSeriesSonificationTracksMappingLowpassResonanceMapFunction MapFunction { get; set; }
		private DmiSeriesSonificationTracksMappingLowpassResonanceMapFunction MapFunction_DefaultValue { get; set; }
		...
		/// </summary>
		public DmiSeriesSonificationTracksMappingLowpassResonanceWithin Within { get; set; }
		private DmiSeriesSonificationTracksMappingLowpassResonanceWithin Within_DefaultValue { get; set; }
