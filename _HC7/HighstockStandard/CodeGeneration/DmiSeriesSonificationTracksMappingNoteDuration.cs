...
{
	public partial class DmiSeriesSonificationTracksMappingNoteDuration  : BaseObject
	{
		Hashtable h = new Hashtable();

		public DmiSeriesSonificationTracksMappingNoteDuration()
		{
			MapFunction = MapFunction_DefaultValue = DmiSeriesSonificationTracksMappingNoteDurationMapFunction.Linear;
			MapTo = MapTo_DefaultValue = "";
			Max = Max_DefaultValue = null;
			Min = Min_DefaultValue = null;
			Value = Value_DefaultValue = null;
			Within = Within_DefaultValue = DmiSeriesSonificationTracksMappingNoteDurationWithin.Chart;
		...
		/// </summary>
		public DmiSeriesSonificationTracksMappingNoteDurationMapFunction MapFunction { get; set; }
		private DmiSeriesSonificationTracksMappingNoteDurationMapFunction MapFunction_DefaultValue { get; set; }
		...
		/// </summary>
		public DmiSeriesSonificationTracksMappingNoteDurationWithin Within { get; set; }
		private DmiSeriesSonificationTracksMappingNoteDurationWithin Within_DefaultValue { get; set; }
