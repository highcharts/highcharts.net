...
{
	public partial class DmiSeriesSonificationTracksMappingPan  : BaseObject
	{
		Hashtable h = new Hashtable();

		public DmiSeriesSonificationTracksMappingPan()
		{
			MapFunction = MapFunction_DefaultValue = DmiSeriesSonificationTracksMappingPanMapFunction.Linear;
			MapTo = MapTo_DefaultValue = "";
			Max = Max_DefaultValue = null;
			Min = Min_DefaultValue = null;
			Value = Value_DefaultValue = null;
			Within = Within_DefaultValue = DmiSeriesSonificationTracksMappingPanWithin.Chart;
		...
		/// </summary>
		public DmiSeriesSonificationTracksMappingPanMapFunction MapFunction { get; set; }
		private DmiSeriesSonificationTracksMappingPanMapFunction MapFunction_DefaultValue { get; set; }
		...
		/// </summary>
		public DmiSeriesSonificationTracksMappingPanWithin Within { get; set; }
		private DmiSeriesSonificationTracksMappingPanWithin Within_DefaultValue { get; set; }
