...
{
	public partial class DmiSeriesSonificationTracksMappingPitch  : BaseObject
	{
		Hashtable h = new Hashtable();

		public DmiSeriesSonificationTracksMappingPitch()
		{
			MapFunction = MapFunction_DefaultValue = DmiSeriesSonificationTracksMappingPitchMapFunction.Linear;
		...
		/// </summary>
		public DmiSeriesSonificationTracksMappingPitchMapFunction MapFunction { get; set; }
		private DmiSeriesSonificationTracksMappingPitchMapFunction MapFunction_DefaultValue { get; set; }
