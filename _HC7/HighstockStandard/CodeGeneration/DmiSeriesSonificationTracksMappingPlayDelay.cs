...
{
	public partial class DmiSeriesSonificationTracksMappingPlayDelay  : BaseObject
	{
		Hashtable h = new Hashtable();

		public DmiSeriesSonificationTracksMappingPlayDelay()
		{
			MapFunction = MapFunction_DefaultValue = DmiSeriesSonificationTracksMappingPlayDelayMapFunction.Linear;
			MapTo = MapTo_DefaultValue = "";
			Max = Max_DefaultValue = null;
			Min = Min_DefaultValue = null;
			Value = Value_DefaultValue = null;
			Within = Within_DefaultValue = DmiSeriesSonificationTracksMappingPlayDelayWithin.Chart;
		...
		/// </summary>
		public DmiSeriesSonificationTracksMappingPlayDelayMapFunction MapFunction { get; set; }
		private DmiSeriesSonificationTracksMappingPlayDelayMapFunction MapFunction_DefaultValue { get; set; }
		...
		/// </summary>
		public DmiSeriesSonificationTracksMappingPlayDelayWithin Within { get; set; }
		private DmiSeriesSonificationTracksMappingPlayDelayWithin Within_DefaultValue { get; set; }
