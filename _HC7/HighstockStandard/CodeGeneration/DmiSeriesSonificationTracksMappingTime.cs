...
{
	public partial class DmiSeriesSonificationTracksMappingTime  : BaseObject
	{
		Hashtable h = new Hashtable();

		public DmiSeriesSonificationTracksMappingTime()
		{
			MapFunction = MapFunction_DefaultValue = DmiSeriesSonificationTracksMappingTimeMapFunction.Linear;
			MapTo = MapTo_DefaultValue = "";
			Max = Max_DefaultValue = null;
			Min = Min_DefaultValue = null;
			Value = Value_DefaultValue = null;
			Within = Within_DefaultValue = DmiSeriesSonificationTracksMappingTimeWithin.Chart;
		...
		/// </summary>
		public DmiSeriesSonificationTracksMappingTimeMapFunction MapFunction { get; set; }
		private DmiSeriesSonificationTracksMappingTimeMapFunction MapFunction_DefaultValue { get; set; }
		...
		/// </summary>
		public DmiSeriesSonificationTracksMappingTimeWithin Within { get; set; }
		private DmiSeriesSonificationTracksMappingTimeWithin Within_DefaultValue { get; set; }
