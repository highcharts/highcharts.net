...
{
	public partial class DmiSeriesSonificationTracksMappingTremoloDepth  : BaseObject
	{
		Hashtable h = new Hashtable();

		public DmiSeriesSonificationTracksMappingTremoloDepth()
		{
			MapFunction = MapFunction_DefaultValue = DmiSeriesSonificationTracksMappingTremoloDepthMapFunction.Linear;
			MapTo = MapTo_DefaultValue = "";
			Max = Max_DefaultValue = null;
			Min = Min_DefaultValue = null;
			Value = Value_DefaultValue = null;
			Within = Within_DefaultValue = DmiSeriesSonificationTracksMappingTremoloDepthWithin.Chart;
		...
		/// </summary>
		public DmiSeriesSonificationTracksMappingTremoloDepthMapFunction MapFunction { get; set; }
		private DmiSeriesSonificationTracksMappingTremoloDepthMapFunction MapFunction_DefaultValue { get; set; }
		...
		/// </summary>
		public DmiSeriesSonificationTracksMappingTremoloDepthWithin Within { get; set; }
		private DmiSeriesSonificationTracksMappingTremoloDepthWithin Within_DefaultValue { get; set; }
