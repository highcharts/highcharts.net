...
{
	public partial class DmiSeriesSonificationTracksMappingTremoloSpeed  : BaseObject
	{
		Hashtable h = new Hashtable();

		public DmiSeriesSonificationTracksMappingTremoloSpeed()
		{
			MapFunction = MapFunction_DefaultValue = DmiSeriesSonificationTracksMappingTremoloSpeedMapFunction.Linear;
			MapTo = MapTo_DefaultValue = "";
			Max = Max_DefaultValue = null;
			Min = Min_DefaultValue = null;
			Value = Value_DefaultValue = null;
			Within = Within_DefaultValue = DmiSeriesSonificationTracksMappingTremoloSpeedWithin.Chart;
		...
		/// </summary>
		public DmiSeriesSonificationTracksMappingTremoloSpeedMapFunction MapFunction { get; set; }
		private DmiSeriesSonificationTracksMappingTremoloSpeedMapFunction MapFunction_DefaultValue { get; set; }
		...
		/// </summary>
		public DmiSeriesSonificationTracksMappingTremoloSpeedWithin Within { get; set; }
		private DmiSeriesSonificationTracksMappingTremoloSpeedWithin Within_DefaultValue { get; set; }
