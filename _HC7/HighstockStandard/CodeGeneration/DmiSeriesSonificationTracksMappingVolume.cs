...
{
	public partial class DmiSeriesSonificationTracksMappingVolume  : BaseObject
	{
		Hashtable h = new Hashtable();

		public DmiSeriesSonificationTracksMappingVolume()
		{
			MapFunction = MapFunction_DefaultValue = DmiSeriesSonificationTracksMappingVolumeMapFunction.Linear;
			MapTo = MapTo_DefaultValue = "";
			Max = Max_DefaultValue = null;
			Min = Min_DefaultValue = null;
			Value = Value_DefaultValue = null;
			Within = Within_DefaultValue = DmiSeriesSonificationTracksMappingVolumeWithin.Chart;
		...
		/// </summary>
		public DmiSeriesSonificationTracksMappingVolumeMapFunction MapFunction { get; set; }
		private DmiSeriesSonificationTracksMappingVolumeMapFunction MapFunction_DefaultValue { get; set; }
		...
		/// </summary>
		public DmiSeriesSonificationTracksMappingVolumeWithin Within { get; set; }
		private DmiSeriesSonificationTracksMappingVolumeWithin Within_DefaultValue { get; set; }
