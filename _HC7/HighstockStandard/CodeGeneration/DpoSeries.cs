...
{
	public partial class DpoSeries  : Series
	{
		Hashtable h = new Hashtable();

		public DpoSeries()
		{
			Accessibility = Accessibility_DefaultValue = new DpoSeriesAccessibility();
			AllowPointSelect = AllowPointSelect_DefaultValue = false;
			Animation = Animation_DefaultValue = new Animation() { Enabled = true };
			AnimationBool = AnimationBool_DefaultValue = true;
			AnimationLimit = AnimationLimit_DefaultValue = null;
			BoostBlending = BoostBlending_DefaultValue = DpoSeriesBoostBlending.Undefined;
			...
			Cursor = Cursor_DefaultValue = DpoSeriesCursor.Null;
			Custom = Custom_DefaultValue = new Hashtable();
			DashStyle = DashStyle_DefaultValue = DpoSeriesDashStyle.Null;
			DataGrouping = DataGrouping_DefaultValue = new DpoSeriesDataGrouping();
			DataLabels = DataLabels_DefaultValue = new DpoSeriesDataLabels();
			DataSorting = DataSorting_DefaultValue = new DpoSeriesDataSorting();
			Description = Description_DefaultValue = "";
			Dumbell = Dumbell_DefaultValue = new DpoSeriesDumbell();
			EnableMouseTracking = EnableMouseTracking_DefaultValue = true;
			Events = Events_DefaultValue = new DpoSeriesEvents();
			FindNearestPointBy = FindNearestPointBy_DefaultValue = DpoSeriesFindNearestPointBy.X;
			GapSize = GapSize_DefaultValue = 0;
			GapUnit = GapUnit_DefaultValue = DpoSeriesGapUnit.Relative;
			GetExtremesFromAll = GetExtremesFromAll_DefaultValue = false;
			Id = Id_DefaultValue = "";
			InactiveOtherPoints = InactiveOtherPoints_DefaultValue = false;
			IncludeInDataExport = IncludeInDataExport_DefaultValue = null;
			Index = Index_DefaultValue = null;
			Label = Label_DefaultValue = new DpoSeriesLabel();
			LastPrice = LastPrice_DefaultValue = new DpoSeriesLastPrice();
			LastVisiblePrice = LastVisiblePrice_DefaultValue = new DpoSeriesLastVisiblePrice();
			LegendIndex = LegendIndex_DefaultValue = null;
			LegendSymbol = LegendSymbol_DefaultValue = DpoSeriesLegendSymbol.Rectangle;
			Linecap = Linecap_DefaultValue = DpoSeriesLinecap.Round;
			LineWidth = LineWidth_DefaultValue = 2;
			LinkedTo = LinkedTo_DefaultValue = "";
			Marker = Marker_DefaultValue = new DpoSeriesMarker();
			Name = Name_DefaultValue = "";
			NegativeColor = NegativeColor_DefaultValue = "";
			OnPoint = OnPoint_DefaultValue = new DpoSeriesOnPoint();
			Opacity = Opacity_DefaultValue = 1;
			Params = Params_DefaultValue = new DpoSeriesParams();
			Point = Point_DefaultValue = new DpoSeriesPoint();
			...
			Sonification = Sonification_DefaultValue = new DpoSeriesSonification();
			Stack = Stack_DefaultValue = "";
			StackNumber = StackNumber_DefaultValue = null;
			States = States_DefaultValue = new DpoSeriesStates();
			Step = Step_DefaultValue = DpoSeriesStep.Null;
			StickyTracking = StickyTracking_DefaultValue = true;
			Threshold = Threshold_DefaultValue = 0;
			Tooltip = Tooltip_DefaultValue = new DpoSeriesTooltip();
			...
			Zones = Zones_DefaultValue = new List<DpoSeriesZones>();
		...
		/// </summary>
		public DpoSeriesAccessibility Accessibility { get; set; }
		private DpoSeriesAccessibility Accessibility_DefaultValue { get; set; }
		...
		/// </summary>
		public DpoSeriesBoostBlending BoostBlending { get; set; }
		private DpoSeriesBoostBlending BoostBlending_DefaultValue { get; set; }
		...
		/// </summary>
		public DpoSeriesCursor Cursor { get; set; }
		private DpoSeriesCursor Cursor_DefaultValue { get; set; }
		...
		/// </summary>
		public DpoSeriesDashStyle DashStyle { get; set; }
		private DpoSeriesDashStyle DashStyle_DefaultValue { get; set; }
		...
		/// </summary>
		public DpoSeriesDataGrouping DataGrouping { get; set; }
		private DpoSeriesDataGrouping DataGrouping_DefaultValue { get; set; }
		...
		/// </summary>
		public DpoSeriesDataLabels DataLabels { get; set; }
		private DpoSeriesDataLabels DataLabels_DefaultValue { get; set; }
		 

		/// <summary>
		/// Options for the series data sorting.
		/// </summary>
		public DpoSeriesDataSorting DataSorting { get; set; }
		private DpoSeriesDataSorting DataSorting_DefaultValue { get; set; }
		...
		/// 
		/// </summary>
		public DpoSeriesDumbell Dumbell { get; set; }
		private DpoSeriesDumbell Dumbell_DefaultValue { get; set; }
		...
		/// </summary>
		public DpoSeriesEvents Events { get; set; }
		private DpoSeriesEvents Events_DefaultValue { get; set; }
		...
		/// </summary>
		public DpoSeriesFindNearestPointBy FindNearestPointBy { get; set; }
		private DpoSeriesFindNearestPointBy FindNearestPointBy_DefaultValue { get; set; }
		...
		/// </summary>
		public DpoSeriesGapUnit GapUnit { get; set; }
		private DpoSeriesGapUnit GapUnit_DefaultValue { get; set; }
		...
		/// </summary>
		public DpoSeriesLabel Label { get; set; }
		private DpoSeriesLabel Label_DefaultValue { get; set; }
		 

		/// <summary>
		/// The line marks the last price from all points.
		/// </summary>
		public DpoSeriesLastPrice LastPrice { get; set; }
		private DpoSeriesLastPrice LastPrice_DefaultValue { get; set; }
		 

		/// <summary>
		/// The line marks the last price from visible range of points.
		/// </summary>
		public DpoSeriesLastVisiblePrice LastVisiblePrice { get; set; }
		private DpoSeriesLastVisiblePrice LastVisiblePrice_DefaultValue { get; set; }
		...
		/// </summary>
		public DpoSeriesLegendSymbol LegendSymbol { get; set; }
		private DpoSeriesLegendSymbol LegendSymbol_DefaultValue { get; set; }
		 

		/// <summary>
		/// The line cap used for line ends and line joins on the graph.
		/// </summary>
		public DpoSeriesLinecap Linecap { get; set; }
		private DpoSeriesLinecap Linecap_DefaultValue { get; set; }
		...
		/// </summary>
		public DpoSeriesMarker Marker { get; set; }
		private DpoSeriesMarker Marker_DefaultValue { get; set; }
		...
		/// </summary>
		public DpoSeriesOnPoint OnPoint { get; set; }
		private DpoSeriesOnPoint OnPoint_DefaultValue { get; set; }
		...
		/// </summary>
		public DpoSeriesParams Params { get; set; }
		private DpoSeriesParams Params_DefaultValue { get; set; }
		 

		/// <summary>
		/// Properties for each single point.
		/// </summary>
		public DpoSeriesPoint Point { get; set; }
		private DpoSeriesPoint Point_DefaultValue { get; set; }
		...
		/// </summary>
		public DpoSeriesSonification Sonification { get; set; }
		private DpoSeriesSonification Sonification_DefaultValue { get; set; }
		...
		/// 
		/// </summary>
		public DpoSeriesStates States { get; set; }
		private DpoSeriesStates States_DefaultValue { get; set; }
		 

		/// <summary>
		/// Whether to apply steps to the line. Possible values are `left`,`center` and `right`.
		/// </summary>
		public DpoSeriesStep Step { get; set; }
		private DpoSeriesStep Step_DefaultValue { get; set; }
		...
		/// </summary>
		public DpoSeriesTooltip Tooltip { get; set; }
		private DpoSeriesTooltip Tooltip_DefaultValue { get; set; }
		...
		/// </summary>
		public List<DpoSeriesZones> Zones { get; set; }
		private List<DpoSeriesZones> Zones_DefaultValue { get; set; }
