...
{
	public partial class DpoSeriesLabel  : BaseObject
	{
		public DpoSeriesLabel()
		{
			...
			Style = Style_DefaultValue = new DpoSeriesLabelStyle();
		...
		/// </summary>
		public DpoSeriesLabelStyle Style { get; set; }
		private DpoSeriesLabelStyle Style_DefaultValue { get; set; }
