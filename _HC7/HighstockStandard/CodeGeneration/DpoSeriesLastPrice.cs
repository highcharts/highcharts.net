...
namespace Highsoft.Web.Mvc.Stocks
{
	public partial class DpoSeriesLastPrice  : BaseObject
	{
		...
		public DpoSeriesLastPrice()
		{
			...
			Label = Label_DefaultValue = new DpoSeriesLastPriceLabel();
		...
		/// 
		/// </summary>
		public DpoSeriesLastPriceLabel Label { get; set; }
		private DpoSeriesLastPriceLabel Label_DefaultValue { get; set; }
