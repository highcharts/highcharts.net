...
{
	public partial class DpoSeriesOnPoint  : BaseObject
	{
		Hashtable h = new Hashtable();

		public DpoSeriesOnPoint()
		{
			ConnectorOptions = ConnectorOptions_DefaultValue = new DpoSeriesOnPointConnectorOptions();
			Id = Id_DefaultValue = "";
			Position = Position_DefaultValue = new DpoSeriesOnPointPosition();
		...
		/// </summary>
		public DpoSeriesOnPointConnectorOptions ConnectorOptions { get; set; }
		private DpoSeriesOnPointConnectorOptions ConnectorOptions_DefaultValue { get; set; }
		...
		/// </summary>
		public DpoSeriesOnPointPosition Position { get; set; }
		private DpoSeriesOnPointPosition Position_DefaultValue { get; set; }
