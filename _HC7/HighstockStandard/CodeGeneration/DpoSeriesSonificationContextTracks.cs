...
{
	public partial class DpoSeriesSonificationContextTracks  : BaseObject
	{
		Hashtable h = new Hashtable();

		public DpoSeriesSonificationContextTracks()
		{
			ActiveWhen = ActiveWhen_DefaultValue = new DpoSeriesSonificationContextTracksActiveWhen();
			Instrument = Instrument_DefaultValue = null;
			InstrumentString = InstrumentString_DefaultValue = "null";
			Mapping = Mapping_DefaultValue = new DpoSeriesSonificationContextTracksMapping();
			MidiName = MidiName_DefaultValue = "";
			PointGrouping = PointGrouping_DefaultValue = new DpoSeriesSonificationContextTracksPointGrouping();
			...
			Type = Type_DefaultValue = DpoSeriesSonificationContextTracksType.Instrument;
			ValueInterval = ValueInterval_DefaultValue = null;
			ValueMapFunction = ValueMapFunction_DefaultValue = DpoSeriesSonificationContextTracksValueMapFunction.Linear;
		...
		/// </summary>
		public DpoSeriesSonificationContextTracksActiveWhen ActiveWhen { get; set; }
		private DpoSeriesSonificationContextTracksActiveWhen ActiveWhen_DefaultValue { get; set; }
		...
		/// </summary>
		public DpoSeriesSonificationContextTracksMapping Mapping { get; set; }
		private DpoSeriesSonificationContextTracksMapping Mapping_DefaultValue { get; set; }
		...
		/// </summary>
		public DpoSeriesSonificationContextTracksPointGrouping PointGrouping { get; set; }
		private DpoSeriesSonificationContextTracksPointGrouping PointGrouping_DefaultValue { get; set; }
		...
		/// </summary>
		public DpoSeriesSonificationContextTracksType Type { get; set; }
		private DpoSeriesSonificationContextTracksType Type_DefaultValue { get; set; }
		...
		/// </summary>
		public DpoSeriesSonificationContextTracksValueMapFunction ValueMapFunction { get; set; }
		private DpoSeriesSonificationContextTracksValueMapFunction ValueMapFunction_DefaultValue { get; set; }
