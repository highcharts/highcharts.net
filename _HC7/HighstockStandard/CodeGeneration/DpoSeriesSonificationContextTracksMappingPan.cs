...
{
	public partial class DpoSeriesSonificationContextTracksMappingPan  : BaseObject
	{
		Hashtable h = new Hashtable();

		public DpoSeriesSonificationContextTracksMappingPan()
		{
			MapFunction = MapFunction_DefaultValue = DpoSeriesSonificationContextTracksMappingPanMapFunction.Linear;
			MapTo = MapTo_DefaultValue = "";
			Max = Max_DefaultValue = null;
			Min = Min_DefaultValue = null;
			Value = Value_DefaultValue = null;
			Within = Within_DefaultValue = DpoSeriesSonificationContextTracksMappingPanWithin.Chart;
		...
		/// </summary>
		public DpoSeriesSonificationContextTracksMappingPanMapFunction MapFunction { get; set; }
		private DpoSeriesSonificationContextTracksMappingPanMapFunction MapFunction_DefaultValue { get; set; }
		...
		/// </summary>
		public DpoSeriesSonificationContextTracksMappingPanWithin Within { get; set; }
		private DpoSeriesSonificationContextTracksMappingPanWithin Within_DefaultValue { get; set; }
