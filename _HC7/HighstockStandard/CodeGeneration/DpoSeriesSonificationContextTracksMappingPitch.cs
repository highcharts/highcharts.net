...
{
	public partial class DpoSeriesSonificationContextTracksMappingPitch  : BaseObject
	{
		Hashtable h = new Hashtable();

		public DpoSeriesSonificationContextTracksMappingPitch()
		{
			MapFunction = MapFunction_DefaultValue = DpoSeriesSonificationContextTracksMappingPitchMapFunction.Linear;
		...
		/// </summary>
		public DpoSeriesSonificationContextTracksMappingPitchMapFunction MapFunction { get; set; }
		private DpoSeriesSonificationContextTracksMappingPitchMapFunction MapFunction_DefaultValue { get; set; }
