...
{
	public partial class DpoSeriesSonificationContextTracksPointGrouping  : BaseObject
	{
		Hashtable h = new Hashtable();

		public DpoSeriesSonificationContextTracksPointGrouping()
		{
			Algorithm = Algorithm_DefaultValue = DpoSeriesSonificationContextTracksPointGroupingAlgorithm.Minimax;
		...
		/// </summary>
		public DpoSeriesSonificationContextTracksPointGroupingAlgorithm Algorithm { get; set; }
		private DpoSeriesSonificationContextTracksPointGroupingAlgorithm Algorithm_DefaultValue { get; set; }
