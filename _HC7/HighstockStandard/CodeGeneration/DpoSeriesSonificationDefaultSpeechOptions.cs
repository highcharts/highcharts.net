...
{
	public partial class DpoSeriesSonificationDefaultSpeechOptions  : BaseObject
	{
		Hashtable h = new Hashtable();

		public DpoSeriesSonificationDefaultSpeechOptions()
		{
			ActiveWhen = ActiveWhen_DefaultValue = new DpoSeriesSonificationDefaultSpeechOptionsActiveWhen();
			Language = Language_DefaultValue = "en-US";
			Mapping = Mapping_DefaultValue = new DpoSeriesSonificationDefaultSpeechOptionsMapping();
			PointGrouping = PointGrouping_DefaultValue = new DpoSeriesSonificationDefaultSpeechOptionsPointGrouping();
			PreferredVoice = PreferredVoice_DefaultValue = "";
			ShowPlayMarker = ShowPlayMarker_DefaultValue = true;
			Type = Type_DefaultValue = DpoSeriesSonificationDefaultSpeechOptionsType.Instrument;
		...
		/// </summary>
		public DpoSeriesSonificationDefaultSpeechOptionsActiveWhen ActiveWhen { get; set; }
		private DpoSeriesSonificationDefaultSpeechOptionsActiveWhen ActiveWhen_DefaultValue { get; set; }
		...
		/// </summary>
		public DpoSeriesSonificationDefaultSpeechOptionsMapping Mapping { get; set; }
		private DpoSeriesSonificationDefaultSpeechOptionsMapping Mapping_DefaultValue { get; set; }
		 

		/// <summary>
		/// Options for point grouping, specifically for instrument tracks.
		/// </summary>
		public DpoSeriesSonificationDefaultSpeechOptionsPointGrouping PointGrouping { get; set; }
		private DpoSeriesSonificationDefaultSpeechOptionsPointGrouping PointGrouping_DefaultValue { get; set; }
		...
		/// </summary>
		public DpoSeriesSonificationDefaultSpeechOptionsType Type { get; set; }
		private DpoSeriesSonificationDefaultSpeechOptionsType Type_DefaultValue { get; set; }
