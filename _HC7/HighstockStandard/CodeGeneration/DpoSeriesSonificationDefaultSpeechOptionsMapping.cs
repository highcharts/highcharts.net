...
{
	public partial class DpoSeriesSonificationDefaultSpeechOptionsMapping  : BaseObject
	{
		Hashtable h = new Hashtable();

		public DpoSeriesSonificationDefaultSpeechOptionsMapping()
		{
			Frequency = Frequency_DefaultValue = new DpoSeriesSonificationDefaultSpeechOptionsMappingFrequency();
			GapBetweenNotes = GapBetweenNotes_DefaultValue = new DpoSeriesSonificationDefaultSpeechOptionsMappingGapBetweenNotes();
			Highpass = Highpass_DefaultValue = new DpoSeriesSonificationDefaultSpeechOptionsMappingHighpass();
			Lowpass = Lowpass_DefaultValue = new DpoSeriesSonificationDefaultSpeechOptionsMappingLowpass();
			NoteDuration = NoteDuration_DefaultValue = new DpoSeriesSonificationDefaultSpeechOptionsMappingNoteDuration();
			Pan = Pan_DefaultValue = new DpoSeriesSonificationDefaultSpeechOptionsMappingPan();
			Pitch = Pitch_DefaultValue = new DpoSeriesSonificationDefaultSpeechOptionsMappingPitch();
			PitchString = PitchString_DefaultValue = "null";
			PitchNumber = PitchNumber_DefaultValue = null;
			PlayDelay = PlayDelay_DefaultValue = new DpoSeriesSonificationDefaultSpeechOptionsMappingPlayDelay();
			Time = Time_DefaultValue = new DpoSeriesSonificationDefaultSpeechOptionsMappingTime();
			TimeString = TimeString_DefaultValue = "null";
			TimeNumber = TimeNumber_DefaultValue = null;
			Tremolo = Tremolo_DefaultValue = new DpoSeriesSonificationDefaultSpeechOptionsMappingTremolo();
			Volume = Volume_DefaultValue = new DpoSeriesSonificationDefaultSpeechOptionsMappingVolume();
		...
		/// </summary>
		public DpoSeriesSonificationDefaultSpeechOptionsMappingFrequency Frequency { get; set; }
		private DpoSeriesSonificationDefaultSpeechOptionsMappingFrequency Frequency_DefaultValue { get; set; }
		...
		/// </summary>
		public DpoSeriesSonificationDefaultSpeechOptionsMappingGapBetweenNotes GapBetweenNotes { get; set; }
		private DpoSeriesSonificationDefaultSpeechOptionsMappingGapBetweenNotes GapBetweenNotes_DefaultValue { get; set; }
		...
		/// </summary>
		public DpoSeriesSonificationDefaultSpeechOptionsMappingHighpass Highpass { get; set; }
		private DpoSeriesSonificationDefaultSpeechOptionsMappingHighpass Highpass_DefaultValue { get; set; }
		...
		/// </summary>
		public DpoSeriesSonificationDefaultSpeechOptionsMappingLowpass Lowpass { get; set; }
		private DpoSeriesSonificationDefaultSpeechOptionsMappingLowpass Lowpass_DefaultValue { get; set; }
		...
		/// </summary>
		public DpoSeriesSonificationDefaultSpeechOptionsMappingNoteDuration NoteDuration { get; set; }
		private DpoSeriesSonificationDefaultSpeechOptionsMappingNoteDuration NoteDuration_DefaultValue { get; set; }
		...
		/// </summary>
		public DpoSeriesSonificationDefaultSpeechOptionsMappingPan Pan { get; set; }
		private DpoSeriesSonificationDefaultSpeechOptionsMappingPan Pan_DefaultValue { get; set; }
		...
		/// </summary>
		public DpoSeriesSonificationDefaultSpeechOptionsMappingPitch Pitch { get; set; }
		private DpoSeriesSonificationDefaultSpeechOptionsMappingPitch Pitch_DefaultValue { get; set; }
		...
		/// </summary>
		public DpoSeriesSonificationDefaultSpeechOptionsMappingPlayDelay PlayDelay { get; set; }
		private DpoSeriesSonificationDefaultSpeechOptionsMappingPlayDelay PlayDelay_DefaultValue { get; set; }
		...
		/// </summary>
		public DpoSeriesSonificationDefaultSpeechOptionsMappingTime Time { get; set; }
		private DpoSeriesSonificationDefaultSpeechOptionsMappingTime Time_DefaultValue { get; set; }
		...
		/// </summary>
		public DpoSeriesSonificationDefaultSpeechOptionsMappingTremolo Tremolo { get; set; }
		private DpoSeriesSonificationDefaultSpeechOptionsMappingTremolo Tremolo_DefaultValue { get; set; }
		 

		/// <summary>
		/// The volume of notes, from 0 to 1.
		/// </summary>
		public DpoSeriesSonificationDefaultSpeechOptionsMappingVolume Volume { get; set; }
		private DpoSeriesSonificationDefaultSpeechOptionsMappingVolume Volume_DefaultValue { get; set; }
