...
{
	public partial class DpoSeriesSonificationDefaultSpeechOptionsMappingLowpassResonance  : BaseObject
	{
		Hashtable h = new Hashtable();

		public DpoSeriesSonificationDefaultSpeechOptionsMappingLowpassResonance()
		{
			MapFunction = MapFunction_DefaultValue = DpoSeriesSonificationDefaultSpeechOptionsMappingLowpassResonanceMapFunction.Linear;
			MapTo = MapTo_DefaultValue = "";
			Max = Max_DefaultValue = null;
			Min = Min_DefaultValue = null;
			Value = Value_DefaultValue = null;
			Within = Within_DefaultValue = DpoSeriesSonificationDefaultSpeechOptionsMappingLowpassResonanceWithin.Chart;
		...
		/// </summary>
		public DpoSeriesSonificationDefaultSpeechOptionsMappingLowpassResonanceMapFunction MapFunction { get; set; }
		private DpoSeriesSonificationDefaultSpeechOptionsMappingLowpassResonanceMapFunction MapFunction_DefaultValue { get; set; }
		...
		/// </summary>
		public DpoSeriesSonificationDefaultSpeechOptionsMappingLowpassResonanceWithin Within { get; set; }
		private DpoSeriesSonificationDefaultSpeechOptionsMappingLowpassResonanceWithin Within_DefaultValue { get; set; }
