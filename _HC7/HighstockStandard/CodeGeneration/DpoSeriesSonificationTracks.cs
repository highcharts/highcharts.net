...
{
	public partial class DpoSeriesSonificationTracks  : BaseObject
	{
		Hashtable h = new Hashtable();

		public DpoSeriesSonificationTracks()
		{
			ActiveWhen = ActiveWhen_DefaultValue = new DpoSeriesSonificationTracksActiveWhen();
			Instrument = Instrument_DefaultValue = null;
			InstrumentString = InstrumentString_DefaultValue = "null";
			Mapping = Mapping_DefaultValue = new DpoSeriesSonificationTracksMapping();
			MidiName = MidiName_DefaultValue = "";
			PointGrouping = PointGrouping_DefaultValue = new DpoSeriesSonificationTracksPointGrouping();
			RoundToMusicalNotes = RoundToMusicalNotes_DefaultValue = true;
			ShowPlayMarker = ShowPlayMarker_DefaultValue = true;
			Type = Type_DefaultValue = DpoSeriesSonificationTracksType.Instrument;
		...
		/// </summary>
		public DpoSeriesSonificationTracksActiveWhen ActiveWhen { get; set; }
		private DpoSeriesSonificationTracksActiveWhen ActiveWhen_DefaultValue { get; set; }
		...
		/// </summary>
		public DpoSeriesSonificationTracksMapping Mapping { get; set; }
		private DpoSeriesSonificationTracksMapping Mapping_DefaultValue { get; set; }
		...
		/// </summary>
		public DpoSeriesSonificationTracksPointGrouping PointGrouping { get; set; }
		private DpoSeriesSonificationTracksPointGrouping PointGrouping_DefaultValue { get; set; }
		...
		/// </summary>
		public DpoSeriesSonificationTracksType Type { get; set; }
		private DpoSeriesSonificationTracksType Type_DefaultValue { get; set; }
