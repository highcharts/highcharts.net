...
{
	public partial class DpoSeriesSonificationTracksMapping  : BaseObject
	{
		Hashtable h = new Hashtable();

		public DpoSeriesSonificationTracksMapping()
		{
			Frequency = Frequency_DefaultValue = new DpoSeriesSonificationTracksMappingFrequency();
			GapBetweenNotes = GapBetweenNotes_DefaultValue = new DpoSeriesSonificationTracksMappingGapBetweenNotes();
			Highpass = Highpass_DefaultValue = new DpoSeriesSonificationTracksMappingHighpass();
			Lowpass = Lowpass_DefaultValue = new DpoSeriesSonificationTracksMappingLowpass();
			NoteDuration = NoteDuration_DefaultValue = new DpoSeriesSonificationTracksMappingNoteDuration();
			Pan = Pan_DefaultValue = new DpoSeriesSonificationTracksMappingPan();
			Pitch = Pitch_DefaultValue = new DpoSeriesSonificationTracksMappingPitch();
			PitchString = PitchString_DefaultValue = "null";
			PitchNumber = PitchNumber_DefaultValue = null;
			PlayDelay = PlayDelay_DefaultValue = new DpoSeriesSonificationTracksMappingPlayDelay();
			Time = Time_DefaultValue = new DpoSeriesSonificationTracksMappingTime();
			TimeString = TimeString_DefaultValue = "null";
			TimeNumber = TimeNumber_DefaultValue = null;
			Tremolo = Tremolo_DefaultValue = new DpoSeriesSonificationTracksMappingTremolo();
			Volume = Volume_DefaultValue = new DpoSeriesSonificationTracksMappingVolume();
		...
		/// </summary>
		public DpoSeriesSonificationTracksMappingFrequency Frequency { get; set; }
		private DpoSeriesSonificationTracksMappingFrequency Frequency_DefaultValue { get; set; }
		...
		/// </summary>
		public DpoSeriesSonificationTracksMappingGapBetweenNotes GapBetweenNotes { get; set; }
		private DpoSeriesSonificationTracksMappingGapBetweenNotes GapBetweenNotes_DefaultValue { get; set; }
		...
		/// </summary>
		public DpoSeriesSonificationTracksMappingHighpass Highpass { get; set; }
		private DpoSeriesSonificationTracksMappingHighpass Highpass_DefaultValue { get; set; }
		...
		/// </summary>
		public DpoSeriesSonificationTracksMappingLowpass Lowpass { get; set; }
		private DpoSeriesSonificationTracksMappingLowpass Lowpass_DefaultValue { get; set; }
		...
		/// </summary>
		public DpoSeriesSonificationTracksMappingNoteDuration NoteDuration { get; set; }
		private DpoSeriesSonificationTracksMappingNoteDuration NoteDuration_DefaultValue { get; set; }
		...
		/// </summary>
		public DpoSeriesSonificationTracksMappingPan Pan { get; set; }
		private DpoSeriesSonificationTracksMappingPan Pan_DefaultValue { get; set; }
		...
		/// </summary>
		public DpoSeriesSonificationTracksMappingPitch Pitch { get; set; }
		private DpoSeriesSonificationTracksMappingPitch Pitch_DefaultValue { get; set; }
		...
		/// </summary>
		public DpoSeriesSonificationTracksMappingPlayDelay PlayDelay { get; set; }
		private DpoSeriesSonificationTracksMappingPlayDelay PlayDelay_DefaultValue { get; set; }
		...
		/// </summary>
		public DpoSeriesSonificationTracksMappingTime Time { get; set; }
		private DpoSeriesSonificationTracksMappingTime Time_DefaultValue { get; set; }
		...
		/// </summary>
		public DpoSeriesSonificationTracksMappingTremolo Tremolo { get; set; }
		private DpoSeriesSonificationTracksMappingTremolo Tremolo_DefaultValue { get; set; }
		 

		/// <summary>
		/// The volume of notes, from 0 to 1.
		/// </summary>
		public DpoSeriesSonificationTracksMappingVolume Volume { get; set; }
		private DpoSeriesSonificationTracksMappingVolume Volume_DefaultValue { get; set; }
