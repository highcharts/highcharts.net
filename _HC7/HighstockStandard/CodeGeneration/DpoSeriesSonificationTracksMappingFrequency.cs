...
{
	public partial class DpoSeriesSonificationTracksMappingFrequency  : BaseObject
	{
		Hashtable h = new Hashtable();

		public DpoSeriesSonificationTracksMappingFrequency()
		{
			MapFunction = MapFunction_DefaultValue = DpoSeriesSonificationTracksMappingFrequencyMapFunction.Linear;
			MapTo = MapTo_DefaultValue = "";
			Max = Max_DefaultValue = null;
			Min = Min_DefaultValue = null;
			Value = Value_DefaultValue = null;
			Within = Within_DefaultValue = DpoSeriesSonificationTracksMappingFrequencyWithin.Chart;
		...
		/// </summary>
		public DpoSeriesSonificationTracksMappingFrequencyMapFunction MapFunction { get; set; }
		private DpoSeriesSonificationTracksMappingFrequencyMapFunction MapFunction_DefaultValue { get; set; }
		...
		/// </summary>
		public DpoSeriesSonificationTracksMappingFrequencyWithin Within { get; set; }
		private DpoSeriesSonificationTracksMappingFrequencyWithin Within_DefaultValue { get; set; }
