...
{
	public partial class DpoSeriesSonificationTracksMappingLowpassResonance  : BaseObject
	{
		Hashtable h = new Hashtable();

		public DpoSeriesSonificationTracksMappingLowpassResonance()
		{
			MapFunction = MapFunction_DefaultValue = DpoSeriesSonificationTracksMappingLowpassResonanceMapFunction.Linear;
			MapTo = MapTo_DefaultValue = "";
			Max = Max_DefaultValue = null;
			Min = Min_DefaultValue = null;
			Value = Value_DefaultValue = null;
			Within = Within_DefaultValue = DpoSeriesSonificationTracksMappingLowpassResonanceWithin.Chart;
		...
		/// </summary>
		public DpoSeriesSonificationTracksMappingLowpassResonanceMapFunction MapFunction { get; set; }
		private DpoSeriesSonificationTracksMappingLowpassResonanceMapFunction MapFunction_DefaultValue { get; set; }
		...
		/// </summary>
		public DpoSeriesSonificationTracksMappingLowpassResonanceWithin Within { get; set; }
		private DpoSeriesSonificationTracksMappingLowpassResonanceWithin Within_DefaultValue { get; set; }
