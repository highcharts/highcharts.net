...
{
	public partial class DpoSeriesSonificationTracksMappingPan  : BaseObject
	{
		Hashtable h = new Hashtable();

		public DpoSeriesSonificationTracksMappingPan()
		{
			MapFunction = MapFunction_DefaultValue = DpoSeriesSonificationTracksMappingPanMapFunction.Linear;
			MapTo = MapTo_DefaultValue = "";
			Max = Max_DefaultValue = null;
			Min = Min_DefaultValue = null;
			Value = Value_DefaultValue = null;
			Within = Within_DefaultValue = DpoSeriesSonificationTracksMappingPanWithin.Chart;
		...
		/// </summary>
		public DpoSeriesSonificationTracksMappingPanMapFunction MapFunction { get; set; }
		private DpoSeriesSonificationTracksMappingPanMapFunction MapFunction_DefaultValue { get; set; }
		...
		/// </summary>
		public DpoSeriesSonificationTracksMappingPanWithin Within { get; set; }
		private DpoSeriesSonificationTracksMappingPanWithin Within_DefaultValue { get; set; }
