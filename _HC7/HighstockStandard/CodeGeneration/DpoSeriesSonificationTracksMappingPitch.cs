...
{
	public partial class DpoSeriesSonificationTracksMappingPitch  : BaseObject
	{
		Hashtable h = new Hashtable();

		public DpoSeriesSonificationTracksMappingPitch()
		{
			MapFunction = MapFunction_DefaultValue = DpoSeriesSonificationTracksMappingPitchMapFunction.Linear;
		...
		/// </summary>
		public DpoSeriesSonificationTracksMappingPitchMapFunction MapFunction { get; set; }
		private DpoSeriesSonificationTracksMappingPitchMapFunction MapFunction_DefaultValue { get; set; }
