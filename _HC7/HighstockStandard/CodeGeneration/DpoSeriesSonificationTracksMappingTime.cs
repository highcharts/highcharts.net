...
{
	public partial class DpoSeriesSonificationTracksMappingTime  : BaseObject
	{
		Hashtable h = new Hashtable();

		public DpoSeriesSonificationTracksMappingTime()
		{
			MapFunction = MapFunction_DefaultValue = DpoSeriesSonificationTracksMappingTimeMapFunction.Linear;
			MapTo = MapTo_DefaultValue = "";
			Max = Max_DefaultValue = null;
			Min = Min_DefaultValue = null;
			Value = Value_DefaultValue = null;
			Within = Within_DefaultValue = DpoSeriesSonificationTracksMappingTimeWithin.Chart;
		...
		/// </summary>
		public DpoSeriesSonificationTracksMappingTimeMapFunction MapFunction { get; set; }
		private DpoSeriesSonificationTracksMappingTimeMapFunction MapFunction_DefaultValue { get; set; }
		...
		/// </summary>
		public DpoSeriesSonificationTracksMappingTimeWithin Within { get; set; }
		private DpoSeriesSonificationTracksMappingTimeWithin Within_DefaultValue { get; set; }
