...
{
	public partial class DpoSeriesSonificationTracksMappingTremoloDepth  : BaseObject
	{
		Hashtable h = new Hashtable();

		public DpoSeriesSonificationTracksMappingTremoloDepth()
		{
			MapFunction = MapFunction_DefaultValue = DpoSeriesSonificationTracksMappingTremoloDepthMapFunction.Linear;
			MapTo = MapTo_DefaultValue = "";
			Max = Max_DefaultValue = null;
			Min = Min_DefaultValue = null;
			Value = Value_DefaultValue = null;
			Within = Within_DefaultValue = DpoSeriesSonificationTracksMappingTremoloDepthWithin.Chart;
		...
		/// </summary>
		public DpoSeriesSonificationTracksMappingTremoloDepthMapFunction MapFunction { get; set; }
		private DpoSeriesSonificationTracksMappingTremoloDepthMapFunction MapFunction_DefaultValue { get; set; }
		...
		/// </summary>
		public DpoSeriesSonificationTracksMappingTremoloDepthWithin Within { get; set; }
		private DpoSeriesSonificationTracksMappingTremoloDepthWithin Within_DefaultValue { get; set; }
