...
{
	public partial class DpoSeriesSonificationTracksMappingTremoloSpeed  : BaseObject
	{
		Hashtable h = new Hashtable();

		public DpoSeriesSonificationTracksMappingTremoloSpeed()
		{
			MapFunction = MapFunction_DefaultValue = DpoSeriesSonificationTracksMappingTremoloSpeedMapFunction.Linear;
			MapTo = MapTo_DefaultValue = "";
			Max = Max_DefaultValue = null;
			Min = Min_DefaultValue = null;
			Value = Value_DefaultValue = null;
			Within = Within_DefaultValue = DpoSeriesSonificationTracksMappingTremoloSpeedWithin.Chart;
		...
		/// </summary>
		public DpoSeriesSonificationTracksMappingTremoloSpeedMapFunction MapFunction { get; set; }
		private DpoSeriesSonificationTracksMappingTremoloSpeedMapFunction MapFunction_DefaultValue { get; set; }
		...
		/// </summary>
		public DpoSeriesSonificationTracksMappingTremoloSpeedWithin Within { get; set; }
		private DpoSeriesSonificationTracksMappingTremoloSpeedWithin Within_DefaultValue { get; set; }
