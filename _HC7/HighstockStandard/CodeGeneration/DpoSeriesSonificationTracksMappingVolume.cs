...
{
	public partial class DpoSeriesSonificationTracksMappingVolume  : BaseObject
	{
		Hashtable h = new Hashtable();

		public DpoSeriesSonificationTracksMappingVolume()
		{
			MapFunction = MapFunction_DefaultValue = DpoSeriesSonificationTracksMappingVolumeMapFunction.Linear;
			MapTo = MapTo_DefaultValue = "";
			Max = Max_DefaultValue = null;
			Min = Min_DefaultValue = null;
			Value = Value_DefaultValue = null;
			Within = Within_DefaultValue = DpoSeriesSonificationTracksMappingVolumeWithin.Chart;
		...
		/// </summary>
		public DpoSeriesSonificationTracksMappingVolumeMapFunction MapFunction { get; set; }
		private DpoSeriesSonificationTracksMappingVolumeMapFunction MapFunction_DefaultValue { get; set; }
		...
		/// </summary>
		public DpoSeriesSonificationTracksMappingVolumeWithin Within { get; set; }
		private DpoSeriesSonificationTracksMappingVolumeWithin Within_DefaultValue { get; set; }
