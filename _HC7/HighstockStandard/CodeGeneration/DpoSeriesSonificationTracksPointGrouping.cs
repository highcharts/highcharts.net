...
{
	public partial class DpoSeriesSonificationTracksPointGrouping  : BaseObject
	{
		Hashtable h = new Hashtable();

		public DpoSeriesSonificationTracksPointGrouping()
		{
			Algorithm = Algorithm_DefaultValue = DpoSeriesSonificationTracksPointGroupingAlgorithm.Minimax;
		...
		/// </summary>
		public DpoSeriesSonificationTracksPointGroupingAlgorithm Algorithm { get; set; }
		private DpoSeriesSonificationTracksPointGroupingAlgorithm Algorithm_DefaultValue { get; set; }
