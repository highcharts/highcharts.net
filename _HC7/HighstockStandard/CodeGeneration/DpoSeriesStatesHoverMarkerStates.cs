...
namespace Highsoft.Web.Mvc.Stocks
{
	public partial class DpoSeriesStatesHoverMarkerStates  : BaseObject
	{
		public DpoSeriesStatesHoverMarkerStates()
		{
			...
			Inactive = Inactive_DefaultValue = new DpoSeriesStatesHoverMarkerStatesInactive();
		...
		/// 
		/// </summary>
		public DpoSeriesStatesHoverMarkerStatesInactive Inactive { get; set; }
		private DpoSeriesStatesHoverMarkerStatesInactive Inactive_DefaultValue { get; set; }
