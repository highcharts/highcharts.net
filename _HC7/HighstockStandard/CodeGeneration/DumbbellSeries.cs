...
{
	public partial class DumbbellSeries  : Series
	{
		Hashtable h = new Hashtable();

		public DumbbellSeries()
		{
			Accessibility = Accessibility_DefaultValue = new DumbbellSeriesAccessibility();
			...
			Compare = Compare_DefaultValue = DumbbellSeriesCompare.Percent;
			CompareBase = CompareBase_DefaultValue = DumbbellSeriesCompareBase.Min;
			...
			DashStyle = DashStyle_DefaultValue = DumbbellSeriesDashStyle.Null;
			Data = Data_DefaultValue = new List<DumbbellSeriesData>();
			DataGrouping = DataGrouping_DefaultValue = new DumbbellSeriesDataGrouping();
			DataLabels = DataLabels_DefaultValue = new DumbbellSeriesDataLabels();
			DataSorting = DataSorting_DefaultValue = new DumbbellSeriesDataSorting();
			Description = Description_DefaultValue = "";
			DragDrop = DragDrop_DefaultValue = new DumbbellSeriesDragDrop();
			Dumbell = Dumbell_DefaultValue = new DumbbellSeriesDumbell();
			...
			GapUnit = GapUnit_DefaultValue = DumbbellSeriesGapUnit.Relative;
			...
			Label = Label_DefaultValue = new DumbbellSeriesLabel();
			LastPrice = LastPrice_DefaultValue = new DumbbellSeriesLastPrice();
			LastVisiblePrice = LastVisiblePrice_DefaultValue = new DumbbellSeriesLastVisiblePrice();
			LegendIndex = LegendIndex_DefaultValue = null;
			LegendSymbol = LegendSymbol_DefaultValue = DumbbellSeriesLegendSymbol.Rectangle;
			...
			OnPoint = OnPoint_DefaultValue = new DumbbellSeriesOnPoint();
			Opacity = Opacity_DefaultValue = 1;
			Point = Point_DefaultValue = new DumbbellSeriesPoint();
			...
			Sonification = Sonification_DefaultValue = new DumbbellSeriesSonification();
			Stack = Stack_DefaultValue = "";
			StackNumber = StackNumber_DefaultValue = null;
			States = States_DefaultValue = new DumbbellSeriesStates();
			Step = Step_DefaultValue = DumbbellSeriesStep.Null;
			Threshold = Threshold_DefaultValue = 0;
			Tooltip = Tooltip_DefaultValue = new DumbbellSeriesTooltip();
			...
			Zones = Zones_DefaultValue = new List<DumbbellSeriesZones>();
		...
		/// </summary>
		public DumbbellSeriesAccessibility Accessibility { get; set; }
		private DumbbellSeriesAccessibility Accessibility_DefaultValue { get; set; }
		...
		/// </summary>
		public DumbbellSeriesCompare Compare { get; set; }
		private DumbbellSeriesCompare Compare_DefaultValue { get; set; }
		 

		/// <summary>
		/// When [compare](#plotOptions.series.compare) is `percent`, this optiondictates whether to use 0 or 100 as the base of comparison.
		/// </summary>
		public DumbbellSeriesCompareBase CompareBase { get; set; }
		private DumbbellSeriesCompareBase CompareBase_DefaultValue { get; set; }
		...
		/// </summary>
		public DumbbellSeriesCursor Cursor { get; set; }
		private DumbbellSeriesCursor Cursor_DefaultValue { get; set; }
		...
		/// </summary>
		public DumbbellSeriesDataGrouping DataGrouping { get; set; }
		private DumbbellSeriesDataGrouping DataGrouping_DefaultValue { get; set; }
		...
		/// </summary>
		public DumbbellSeriesDataLabels DataLabels { get; set; }
		private DumbbellSeriesDataLabels DataLabels_DefaultValue { get; set; }
		 

		/// <summary>
		/// Options for the series data sorting.
		/// </summary>
		public DumbbellSeriesDataSorting DataSorting { get; set; }
		private DumbbellSeriesDataSorting DataSorting_DefaultValue { get; set; }
		...
		/// </summary>
		public DumbbellSeriesDragDrop DragDrop { get; set; }
		private DumbbellSeriesDragDrop DragDrop_DefaultValue { get; set; }
		 

		/// <summary>
		/// 
		/// </summary>
		public DumbbellSeriesDumbell Dumbell { get; set; }
		private DumbbellSeriesDumbell Dumbell_DefaultValue { get; set; }
		...
		/// </summary>
		public DumbbellSeriesEvents Events { get; set; }
		private DumbbellSeriesEvents Events_DefaultValue { get; set; }
		...
		/// </summary>
		public DumbbellSeriesFindNearestPointBy FindNearestPointBy { get; set; }
		private DumbbellSeriesFindNearestPointBy FindNearestPointBy_DefaultValue { get; set; }
		...
		/// </summary>
		public DumbbellSeriesGapUnit GapUnit { get; set; }
		private DumbbellSeriesGapUnit GapUnit_DefaultValue { get; set; }
		...
		/// </summary>
		public DumbbellSeriesLabel Label { get; set; }
		private DumbbellSeriesLabel Label_DefaultValue { get; set; }
		 

		/// <summary>
		/// The line marks the last price from all points.
		/// </summary>
		public DumbbellSeriesLastPrice LastPrice { get; set; }
		private DumbbellSeriesLastPrice LastPrice_DefaultValue { get; set; }
		 

		/// <summary>
		/// The line marks the last price from visible range of points.
		/// </summary>
		public DumbbellSeriesLastVisiblePrice LastVisiblePrice { get; set; }
		private DumbbellSeriesLastVisiblePrice LastVisiblePrice_DefaultValue { get; set; }
		...
		/// </summary>
		public DumbbellSeriesLinecap Linecap { get; set; }
		private DumbbellSeriesLinecap Linecap_DefaultValue { get; set; }
		...
		/// </summary>
		public DumbbellSeriesMarker Marker { get; set; }
		private DumbbellSeriesMarker Marker_DefaultValue { get; set; }
		...
		/// </summary>
		public DumbbellSeriesOnPoint OnPoint { get; set; }
		private DumbbellSeriesOnPoint OnPoint_DefaultValue { get; set; }
		...
		/// </summary>
		public DumbbellSeriesPoint Point { get; set; }
		private DumbbellSeriesPoint Point_DefaultValue { get; set; }
		...
		/// </summary>
		public DumbbellSeriesPointIntervalUnit PointIntervalUnit { get; set; }
		private DumbbellSeriesPointIntervalUnit PointIntervalUnit_DefaultValue { get; set; }
		...
		/// </summary>
		public DumbbellSeriesSonification Sonification { get; set; }
		private DumbbellSeriesSonification Sonification_DefaultValue { get; set; }
		...
		/// 
		/// </summary>
		public DumbbellSeriesStates States { get; set; }
		private DumbbellSeriesStates States_DefaultValue { get; set; }
		 

		/// <summary>
		/// Whether to apply steps to the line. Possible values are `left`,`center` and `right`.
		/// </summary>
		public DumbbellSeriesStep Step { get; set; }
		private DumbbellSeriesStep Step_DefaultValue { get; set; }
		...
		/// </summary>
		public DumbbellSeriesTooltip Tooltip { get; set; }
		private DumbbellSeriesTooltip Tooltip_DefaultValue { get; set; }
		...
		/// </summary>
		public List<DumbbellSeriesZones> Zones { get; set; }
		private List<DumbbellSeriesZones> Zones_DefaultValue { get; set; }
