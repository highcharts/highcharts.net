...
{
	public partial class DumbbellSeriesLastVisiblePriceLabel  : BaseObject
	{
		Hashtable h = new Hashtable();

		public DumbbellSeriesLastVisiblePriceLabel()
		{
			Align = Align_DefaultValue = DumbbellSeriesLastVisiblePriceLabelAlign.Null;
		...
		/// 
		/// </summary>
		public DumbbellSeriesLastVisiblePriceLabelAlign Align { get; set; }
		private DumbbellSeriesLastVisiblePriceLabelAlign Align_DefaultValue { get; set; }
