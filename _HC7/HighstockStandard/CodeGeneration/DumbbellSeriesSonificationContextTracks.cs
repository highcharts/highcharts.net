...
{
	public partial class DumbbellSeriesSonificationContextTracks  : BaseObject
	{
		Hashtable h = new Hashtable();

		public DumbbellSeriesSonificationContextTracks()
		{
			ActiveWhen = ActiveWhen_DefaultValue = new DumbbellSeriesSonificationContextTracksActiveWhen();
			Instrument = Instrument_DefaultValue = null;
			InstrumentString = InstrumentString_DefaultValue = "null";
			Mapping = Mapping_DefaultValue = new DumbbellSeriesSonificationContextTracksMapping();
			MidiName = MidiName_DefaultValue = "";
			PointGrouping = PointGrouping_DefaultValue = new DumbbellSeriesSonificationContextTracksPointGrouping();
			...
			Type = Type_DefaultValue = DumbbellSeriesSonificationContextTracksType.Instrument;
			ValueInterval = ValueInterval_DefaultValue = null;
			ValueMapFunction = ValueMapFunction_DefaultValue = DumbbellSeriesSonificationContextTracksValueMapFunction.Linear;
		...
		/// </summary>
		public DumbbellSeriesSonificationContextTracksActiveWhen ActiveWhen { get; set; }
		private DumbbellSeriesSonificationContextTracksActiveWhen ActiveWhen_DefaultValue { get; set; }
		...
		/// </summary>
		public DumbbellSeriesSonificationContextTracksMapping Mapping { get; set; }
		private DumbbellSeriesSonificationContextTracksMapping Mapping_DefaultValue { get; set; }
		...
		/// </summary>
		public DumbbellSeriesSonificationContextTracksPointGrouping PointGrouping { get; set; }
		private DumbbellSeriesSonificationContextTracksPointGrouping PointGrouping_DefaultValue { get; set; }
		...
		/// </summary>
		public DumbbellSeriesSonificationContextTracksType Type { get; set; }
		private DumbbellSeriesSonificationContextTracksType Type_DefaultValue { get; set; }
		...
		/// </summary>
		public DumbbellSeriesSonificationContextTracksValueMapFunction ValueMapFunction { get; set; }
		private DumbbellSeriesSonificationContextTracksValueMapFunction ValueMapFunction_DefaultValue { get; set; }
