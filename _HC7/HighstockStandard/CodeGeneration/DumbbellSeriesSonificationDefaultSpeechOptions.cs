...
{
	public partial class DumbbellSeriesSonificationDefaultSpeechOptions  : BaseObject
	{
		Hashtable h = new Hashtable();

		public DumbbellSeriesSonificationDefaultSpeechOptions()
		{
			ActiveWhen = ActiveWhen_DefaultValue = new DumbbellSeriesSonificationDefaultSpeechOptionsActiveWhen();
			Language = Language_DefaultValue = "en-US";
			Mapping = Mapping_DefaultValue = new DumbbellSeriesSonificationDefaultSpeechOptionsMapping();
			PointGrouping = PointGrouping_DefaultValue = new DumbbellSeriesSonificationDefaultSpeechOptionsPointGrouping();
			PreferredVoice = PreferredVoice_DefaultValue = "";
			ShowPlayMarker = ShowPlayMarker_DefaultValue = true;
			Type = Type_DefaultValue = DumbbellSeriesSonificationDefaultSpeechOptionsType.Instrument;
		...
		/// </summary>
		public DumbbellSeriesSonificationDefaultSpeechOptionsActiveWhen ActiveWhen { get; set; }
		private DumbbellSeriesSonificationDefaultSpeechOptionsActiveWhen ActiveWhen_DefaultValue { get; set; }
		...
		/// </summary>
		public DumbbellSeriesSonificationDefaultSpeechOptionsMapping Mapping { get; set; }
		private DumbbellSeriesSonificationDefaultSpeechOptionsMapping Mapping_DefaultValue { get; set; }
		 

		/// <summary>
		/// Options for point grouping, specifically for instrument tracks.
		/// </summary>
		public DumbbellSeriesSonificationDefaultSpeechOptionsPointGrouping PointGrouping { get; set; }
		private DumbbellSeriesSonificationDefaultSpeechOptionsPointGrouping PointGrouping_DefaultValue { get; set; }
		...
		/// </summary>
		public DumbbellSeriesSonificationDefaultSpeechOptionsType Type { get; set; }
		private DumbbellSeriesSonificationDefaultSpeechOptionsType Type_DefaultValue { get; set; }
