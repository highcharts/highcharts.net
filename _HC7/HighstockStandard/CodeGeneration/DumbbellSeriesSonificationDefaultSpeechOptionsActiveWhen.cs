...
{
	public partial class DumbbellSeriesSonificationDefaultSpeechOptionsActiveWhen  : BaseObject
	{
		Hashtable h = new Hashtable();

		public DumbbellSeriesSonificationDefaultSpeechOptionsActiveWhen()
		{
		}	
