...
{
	public partial class DumbbellSeriesSonificationTracksMapping  : BaseObject
	{
		Hashtable h = new Hashtable();

		public DumbbellSeriesSonificationTracksMapping()
		{
			Frequency = Frequency_DefaultValue = new DumbbellSeriesSonificationTracksMappingFrequency();
			GapBetweenNotes = GapBetweenNotes_DefaultValue = new DumbbellSeriesSonificationTracksMappingGapBetweenNotes();
			Highpass = Highpass_DefaultValue = new DumbbellSeriesSonificationTracksMappingHighpass();
			Lowpass = Lowpass_DefaultValue = new DumbbellSeriesSonificationTracksMappingLowpass();
			NoteDuration = NoteDuration_DefaultValue = new DumbbellSeriesSonificationTracksMappingNoteDuration();
			Pan = Pan_DefaultValue = new DumbbellSeriesSonificationTracksMappingPan();
			Pitch = Pitch_DefaultValue = new DumbbellSeriesSonificationTracksMappingPitch();
			PitchString = PitchString_DefaultValue = "null";
			PitchNumber = PitchNumber_DefaultValue = null;
			PlayDelay = PlayDelay_DefaultValue = new DumbbellSeriesSonificationTracksMappingPlayDelay();
			Time = Time_DefaultValue = new DumbbellSeriesSonificationTracksMappingTime();
			TimeString = TimeString_DefaultValue = "null";
			TimeNumber = TimeNumber_DefaultValue = null;
			Tremolo = Tremolo_DefaultValue = new DumbbellSeriesSonificationTracksMappingTremolo();
			Volume = Volume_DefaultValue = new DumbbellSeriesSonificationTracksMappingVolume();
		...
		/// </summary>
		public DumbbellSeriesSonificationTracksMappingFrequency Frequency { get; set; }
		private DumbbellSeriesSonificationTracksMappingFrequency Frequency_DefaultValue { get; set; }
		...
		/// </summary>
		public DumbbellSeriesSonificationTracksMappingGapBetweenNotes GapBetweenNotes { get; set; }
		private DumbbellSeriesSonificationTracksMappingGapBetweenNotes GapBetweenNotes_DefaultValue { get; set; }
		...
		/// </summary>
		public DumbbellSeriesSonificationTracksMappingHighpass Highpass { get; set; }
		private DumbbellSeriesSonificationTracksMappingHighpass Highpass_DefaultValue { get; set; }
		...
		/// </summary>
		public DumbbellSeriesSonificationTracksMappingLowpass Lowpass { get; set; }
		private DumbbellSeriesSonificationTracksMappingLowpass Lowpass_DefaultValue { get; set; }
		...
		/// </summary>
		public DumbbellSeriesSonificationTracksMappingNoteDuration NoteDuration { get; set; }
		private DumbbellSeriesSonificationTracksMappingNoteDuration NoteDuration_DefaultValue { get; set; }
		...
		/// </summary>
		public DumbbellSeriesSonificationTracksMappingPan Pan { get; set; }
		private DumbbellSeriesSonificationTracksMappingPan Pan_DefaultValue { get; set; }
		...
		/// </summary>
		public DumbbellSeriesSonificationTracksMappingPitch Pitch { get; set; }
		private DumbbellSeriesSonificationTracksMappingPitch Pitch_DefaultValue { get; set; }
		...
		/// </summary>
		public DumbbellSeriesSonificationTracksMappingPlayDelay PlayDelay { get; set; }
		private DumbbellSeriesSonificationTracksMappingPlayDelay PlayDelay_DefaultValue { get; set; }
		...
		/// </summary>
		public DumbbellSeriesSonificationTracksMappingTime Time { get; set; }
		private DumbbellSeriesSonificationTracksMappingTime Time_DefaultValue { get; set; }
		...
		/// </summary>
		public DumbbellSeriesSonificationTracksMappingTremolo Tremolo { get; set; }
		private DumbbellSeriesSonificationTracksMappingTremolo Tremolo_DefaultValue { get; set; }
		 

		/// <summary>
		/// The volume of notes, from 0 to 1.
		/// </summary>
		public DumbbellSeriesSonificationTracksMappingVolume Volume { get; set; }
		private DumbbellSeriesSonificationTracksMappingVolume Volume_DefaultValue { get; set; }
