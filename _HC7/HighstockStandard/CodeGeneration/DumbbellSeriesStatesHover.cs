...
{
	public partial class DumbbellSeriesStatesHover  : BaseObject
	{
		Hashtable h = new Hashtable();

		public DumbbellSeriesStatesHover()
		{
			Animation = Animation_DefaultValue = new Animation() { Enabled = true };
			AnimationBool = AnimationBool_DefaultValue = null;
			Enabled = Enabled_DefaultValue = true;
			Halo = Halo_DefaultValue = new DumbbellSeriesStatesHoverHalo();
			LineWidth = LineWidth_DefaultValue = null;
			LineWidthPlus = LineWidthPlus_DefaultValue = 1;
			Marker = Marker_DefaultValue = new DumbbellSeriesStatesHoverMarker();
		...
		/// </summary>
		public DumbbellSeriesStatesHoverHalo Halo { get; set; }
		private DumbbellSeriesStatesHoverHalo Halo_DefaultValue { get; set; }
		...
		/// </summary>
		public DumbbellSeriesStatesHoverMarker Marker { get; set; }
		private DumbbellSeriesStatesHoverMarker Marker_DefaultValue { get; set; }
