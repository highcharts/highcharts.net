...
{
	public partial class EmaSeries  : Series
	{
		Hashtable h = new Hashtable();

		public EmaSeries()
		{
			Accessibility = Accessibility_DefaultValue = new EmaSeriesAccessibility();
			AllowPointSelect = AllowPointSelect_DefaultValue = false;
			Animation = Animation_DefaultValue = new Animation() { Enabled = true };
			AnimationBool = AnimationBool_DefaultValue = true;
			AnimationLimit = AnimationLimit_DefaultValue = null;
			BoostBlending = BoostBlending_DefaultValue = EmaSeriesBoostBlending.Undefined;
			...
			Compare = Compare_DefaultValue = EmaSeriesCompare.Percent;
			CompareBase = CompareBase_DefaultValue = EmaSeriesCompareBase.Min;
			...
			Cursor = Cursor_DefaultValue = EmaSeriesCursor.Null;
			Custom = Custom_DefaultValue = new Hashtable();
			DashStyle = DashStyle_DefaultValue = EmaSeriesDashStyle.Null;
			DataGrouping = DataGrouping_DefaultValue = new EmaSeriesDataGrouping();
			DataLabels = DataLabels_DefaultValue = new EmaSeriesDataLabels();
			DataSorting = DataSorting_DefaultValue = new EmaSeriesDataSorting();
			Description = Description_DefaultValue = "";
			Dumbell = Dumbell_DefaultValue = new EmaSeriesDumbell();
			EnableMouseTracking = EnableMouseTracking_DefaultValue = true;
			Events = Events_DefaultValue = new EmaSeriesEvents();
			FindNearestPointBy = FindNearestPointBy_DefaultValue = EmaSeriesFindNearestPointBy.X;
			GapSize = GapSize_DefaultValue = 0;
			GapUnit = GapUnit_DefaultValue = EmaSeriesGapUnit.Relative;
			GetExtremesFromAll = GetExtremesFromAll_DefaultValue = false;
			Id = Id_DefaultValue = "";
			InactiveOtherPoints = InactiveOtherPoints_DefaultValue = false;
			IncludeInDataExport = IncludeInDataExport_DefaultValue = null;
			Index = Index_DefaultValue = null;
			Label = Label_DefaultValue = new EmaSeriesLabel();
			LastPrice = LastPrice_DefaultValue = new EmaSeriesLastPrice();
			LastVisiblePrice = LastVisiblePrice_DefaultValue = new EmaSeriesLastVisiblePrice();
			LegendIndex = LegendIndex_DefaultValue = null;
			LegendSymbol = LegendSymbol_DefaultValue = EmaSeriesLegendSymbol.Rectangle;
			Linecap = Linecap_DefaultValue = EmaSeriesLinecap.Round;
			LineWidth = LineWidth_DefaultValue = 2;
			LinkedTo = LinkedTo_DefaultValue = "";
			Marker = Marker_DefaultValue = new EmaSeriesMarker();
			Name = Name_DefaultValue = "";
			NegativeColor = NegativeColor_DefaultValue = "";
			OnPoint = OnPoint_DefaultValue = new EmaSeriesOnPoint();
			Opacity = Opacity_DefaultValue = 1;
			Params = Params_DefaultValue = new EmaSeriesParams();
			Point = Point_DefaultValue = new EmaSeriesPoint();
			...
			Sonification = Sonification_DefaultValue = new EmaSeriesSonification();
			Stack = Stack_DefaultValue = "";
			StackNumber = StackNumber_DefaultValue = null;
			States = States_DefaultValue = new EmaSeriesStates();
			Step = Step_DefaultValue = EmaSeriesStep.Null;
			StickyTracking = StickyTracking_DefaultValue = true;
			Threshold = Threshold_DefaultValue = 0;
			Tooltip = Tooltip_DefaultValue = new EmaSeriesTooltip();
			...
			Zones = Zones_DefaultValue = new List<EmaSeriesZones>();
		...
		/// </summary>
		public EmaSeriesAccessibility Accessibility { get; set; }
		private EmaSeriesAccessibility Accessibility_DefaultValue { get; set; }
		...
		/// </summary>
		public EmaSeriesBoostBlending BoostBlending { get; set; }
		private EmaSeriesBoostBlending BoostBlending_DefaultValue { get; set; }
		...
		/// </summary>
		public EmaSeriesCompare Compare { get; set; }
		private EmaSeriesCompare Compare_DefaultValue { get; set; }
		 

		/// <summary>
		/// When [compare](#plotOptions.series.compare) is `percent`, this optiondictates whether to use 0 or 100 as the base of comparison.
		/// </summary>
		public EmaSeriesCompareBase CompareBase { get; set; }
		private EmaSeriesCompareBase CompareBase_DefaultValue { get; set; }
		...
		/// </summary>
		public EmaSeriesCursor Cursor { get; set; }
		private EmaSeriesCursor Cursor_DefaultValue { get; set; }
		...
		/// </summary>
		public EmaSeriesDashStyle DashStyle { get; set; }
		private EmaSeriesDashStyle DashStyle_DefaultValue { get; set; }
		...
		/// </summary>
		public EmaSeriesDataGrouping DataGrouping { get; set; }
		private EmaSeriesDataGrouping DataGrouping_DefaultValue { get; set; }
		...
		/// </summary>
		public EmaSeriesDataLabels DataLabels { get; set; }
		private EmaSeriesDataLabels DataLabels_DefaultValue { get; set; }
		 

		/// <summary>
		/// Options for the series data sorting.
		/// </summary>
		public EmaSeriesDataSorting DataSorting { get; set; }
		private EmaSeriesDataSorting DataSorting_DefaultValue { get; set; }
		...
		/// 
		/// </summary>
		public EmaSeriesDumbell Dumbell { get; set; }
		private EmaSeriesDumbell Dumbell_DefaultValue { get; set; }
		...
		/// </summary>
		public EmaSeriesEvents Events { get; set; }
		private EmaSeriesEvents Events_DefaultValue { get; set; }
		...
		/// </summary>
		public EmaSeriesFindNearestPointBy FindNearestPointBy { get; set; }
		private EmaSeriesFindNearestPointBy FindNearestPointBy_DefaultValue { get; set; }
		...
		/// </summary>
		public EmaSeriesGapUnit GapUnit { get; set; }
		private EmaSeriesGapUnit GapUnit_DefaultValue { get; set; }
		...
		/// </summary>
		public EmaSeriesLabel Label { get; set; }
		private EmaSeriesLabel Label_DefaultValue { get; set; }
		 

		/// <summary>
		/// The line marks the last price from all points.
		/// </summary>
		public EmaSeriesLastPrice LastPrice { get; set; }
		private EmaSeriesLastPrice LastPrice_DefaultValue { get; set; }
		 

		/// <summary>
		/// The line marks the last price from visible range of points.
		/// </summary>
		public EmaSeriesLastVisiblePrice LastVisiblePrice { get; set; }
		private EmaSeriesLastVisiblePrice LastVisiblePrice_DefaultValue { get; set; }
		...
		/// </summary>
		public EmaSeriesLegendSymbol LegendSymbol { get; set; }
		private EmaSeriesLegendSymbol LegendSymbol_DefaultValue { get; set; }
		 

		/// <summary>
		/// The line cap used for line ends and line joins on the graph.
		/// </summary>
		public EmaSeriesLinecap Linecap { get; set; }
		private EmaSeriesLinecap Linecap_DefaultValue { get; set; }
		...
		/// </summary>
		public EmaSeriesMarker Marker { get; set; }
		private EmaSeriesMarker Marker_DefaultValue { get; set; }
		...
		/// </summary>
		public EmaSeriesOnPoint OnPoint { get; set; }
		private EmaSeriesOnPoint OnPoint_DefaultValue { get; set; }
		...
		/// </summary>
		public EmaSeriesParams Params { get; set; }
		private EmaSeriesParams Params_DefaultValue { get; set; }
		 

		/// <summary>
		/// Properties for each single point.
		/// </summary>
		public EmaSeriesPoint Point { get; set; }
		private EmaSeriesPoint Point_DefaultValue { get; set; }
		...
		/// </summary>
		public EmaSeriesSonification Sonification { get; set; }
		private EmaSeriesSonification Sonification_DefaultValue { get; set; }
		...
		/// 
		/// </summary>
		public EmaSeriesStates States { get; set; }
		private EmaSeriesStates States_DefaultValue { get; set; }
		 

		/// <summary>
		/// Whether to apply steps to the line. Possible values are `left`,`center` and `right`.
		/// </summary>
		public EmaSeriesStep Step { get; set; }
		private EmaSeriesStep Step_DefaultValue { get; set; }
		...
		/// </summary>
		public EmaSeriesTooltip Tooltip { get; set; }
		private EmaSeriesTooltip Tooltip_DefaultValue { get; set; }
		...
		/// </summary>
		public List<EmaSeriesZones> Zones { get; set; }
		private List<EmaSeriesZones> Zones_DefaultValue { get; set; }
