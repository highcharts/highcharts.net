...
{
	public partial class EmaSeriesSonification  : BaseObject
	{
		Hashtable h = new Hashtable();

		public EmaSeriesSonification()
		{
		}	
		...
		/// </summary>
		public EmaSeriesSonificationContextTracks ContextTracks { get; set; }
		 

		/// <summary>
		/// Default options for all this series' instrument tracks.
		/// </summary>
		public EmaSeriesSonificationDefaultInstrumentOptions DefaultInstrumentOptions { get; set; }
		 

		/// <summary>
		/// Default options for all this series' speech tracks.
		/// </summary>
		public EmaSeriesSonificationDefaultSpeechOptions DefaultSpeechOptions { get; set; }
		...
		/// </summary>
		public EmaSeriesSonificationPointGrouping PointGrouping { get; set; }
		 

		/// <summary>
		/// Tracks for this series.Given as an array of instrument tracks, speech tracks, or a mix of both.
		/// </summary>
		public EmaSeriesSonificationTracks Tracks { get; set; }
