...
{
	public partial class EmaSeriesSonificationContextTracks  : BaseObject
	{
		Hashtable h = new Hashtable();

		public EmaSeriesSonificationContextTracks()
		{
			ActiveWhen = ActiveWhen_DefaultValue = new EmaSeriesSonificationContextTracksActiveWhen();
			Instrument = Instrument_DefaultValue = null;
			InstrumentString = InstrumentString_DefaultValue = "null";
			Mapping = Mapping_DefaultValue = new EmaSeriesSonificationContextTracksMapping();
			MidiName = MidiName_DefaultValue = "";
			PointGrouping = PointGrouping_DefaultValue = new EmaSeriesSonificationContextTracksPointGrouping();
			...
			Type = Type_DefaultValue = EmaSeriesSonificationContextTracksType.Instrument;
			ValueInterval = ValueInterval_DefaultValue = null;
			ValueMapFunction = ValueMapFunction_DefaultValue = EmaSeriesSonificationContextTracksValueMapFunction.Linear;
		...
		/// </summary>
		public EmaSeriesSonificationContextTracksActiveWhen ActiveWhen { get; set; }
		private EmaSeriesSonificationContextTracksActiveWhen ActiveWhen_DefaultValue { get; set; }
		...
		/// </summary>
		public EmaSeriesSonificationContextTracksMapping Mapping { get; set; }
		private EmaSeriesSonificationContextTracksMapping Mapping_DefaultValue { get; set; }
		...
		/// </summary>
		public EmaSeriesSonificationContextTracksPointGrouping PointGrouping { get; set; }
		private EmaSeriesSonificationContextTracksPointGrouping PointGrouping_DefaultValue { get; set; }
		...
		/// </summary>
		public EmaSeriesSonificationContextTracksType Type { get; set; }
		private EmaSeriesSonificationContextTracksType Type_DefaultValue { get; set; }
		...
		/// </summary>
		public EmaSeriesSonificationContextTracksValueMapFunction ValueMapFunction { get; set; }
		private EmaSeriesSonificationContextTracksValueMapFunction ValueMapFunction_DefaultValue { get; set; }
