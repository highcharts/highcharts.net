...
{
	public partial class EmaSeriesSonificationContextTracksMappingFrequency  : BaseObject
	{
		Hashtable h = new Hashtable();

		public EmaSeriesSonificationContextTracksMappingFrequency()
		{
			MapFunction = MapFunction_DefaultValue = EmaSeriesSonificationContextTracksMappingFrequencyMapFunction.Linear;
			MapTo = MapTo_DefaultValue = "";
			Max = Max_DefaultValue = null;
			Min = Min_DefaultValue = null;
			Value = Value_DefaultValue = null;
			Within = Within_DefaultValue = EmaSeriesSonificationContextTracksMappingFrequencyWithin.Chart;
		...
		/// </summary>
		public EmaSeriesSonificationContextTracksMappingFrequencyMapFunction MapFunction { get; set; }
		private EmaSeriesSonificationContextTracksMappingFrequencyMapFunction MapFunction_DefaultValue { get; set; }
		...
		/// </summary>
		public EmaSeriesSonificationContextTracksMappingFrequencyWithin Within { get; set; }
		private EmaSeriesSonificationContextTracksMappingFrequencyWithin Within_DefaultValue { get; set; }
