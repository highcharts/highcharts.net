...
{
	public partial class EmaSeriesSonificationContextTracksMappingPan  : BaseObject
	{
		Hashtable h = new Hashtable();

		public EmaSeriesSonificationContextTracksMappingPan()
		{
			MapFunction = MapFunction_DefaultValue = EmaSeriesSonificationContextTracksMappingPanMapFunction.Linear;
			MapTo = MapTo_DefaultValue = "";
			Max = Max_DefaultValue = null;
			Min = Min_DefaultValue = null;
			Value = Value_DefaultValue = null;
			Within = Within_DefaultValue = EmaSeriesSonificationContextTracksMappingPanWithin.Chart;
		...
		/// </summary>
		public EmaSeriesSonificationContextTracksMappingPanMapFunction MapFunction { get; set; }
		private EmaSeriesSonificationContextTracksMappingPanMapFunction MapFunction_DefaultValue { get; set; }
		...
		/// </summary>
		public EmaSeriesSonificationContextTracksMappingPanWithin Within { get; set; }
		private EmaSeriesSonificationContextTracksMappingPanWithin Within_DefaultValue { get; set; }
