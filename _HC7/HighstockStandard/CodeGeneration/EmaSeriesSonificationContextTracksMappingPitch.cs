...
{
	public partial class EmaSeriesSonificationContextTracksMappingPitch  : BaseObject
	{
		Hashtable h = new Hashtable();

		public EmaSeriesSonificationContextTracksMappingPitch()
		{
			MapFunction = MapFunction_DefaultValue = EmaSeriesSonificationContextTracksMappingPitchMapFunction.Linear;
		...
		/// </summary>
		public EmaSeriesSonificationContextTracksMappingPitchMapFunction MapFunction { get; set; }
		private EmaSeriesSonificationContextTracksMappingPitchMapFunction MapFunction_DefaultValue { get; set; }
