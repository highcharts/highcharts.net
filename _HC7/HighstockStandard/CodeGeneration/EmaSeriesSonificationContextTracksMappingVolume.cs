...
{
	public partial class EmaSeriesSonificationContextTracksMappingVolume  : BaseObject
	{
		Hashtable h = new Hashtable();

		public EmaSeriesSonificationContextTracksMappingVolume()
		{
			MapFunction = MapFunction_DefaultValue = EmaSeriesSonificationContextTracksMappingVolumeMapFunction.Linear;
			MapTo = MapTo_DefaultValue = "";
			Max = Max_DefaultValue = null;
			Min = Min_DefaultValue = null;
			Value = Value_DefaultValue = null;
			Within = Within_DefaultValue = EmaSeriesSonificationContextTracksMappingVolumeWithin.Chart;
		...
		/// </summary>
		public EmaSeriesSonificationContextTracksMappingVolumeMapFunction MapFunction { get; set; }
		private EmaSeriesSonificationContextTracksMappingVolumeMapFunction MapFunction_DefaultValue { get; set; }
		...
		/// </summary>
		public EmaSeriesSonificationContextTracksMappingVolumeWithin Within { get; set; }
		private EmaSeriesSonificationContextTracksMappingVolumeWithin Within_DefaultValue { get; set; }
