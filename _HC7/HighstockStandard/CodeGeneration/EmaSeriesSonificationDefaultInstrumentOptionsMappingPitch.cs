...
namespace Highsoft.Web.Mvc.Stocks
{
	public partial class EmaSeriesSonificationDefaultInstrumentOptionsMappingPitch  : BaseObject
	{
		...
		{
			if (MapFunction != EmaSeriesSonificationDefaultInstrumentOptionsMappingPitchMapFunction.Null) h.Add("mapFunction", highstock.FirstCharacterToLower(MapFunction.ToString()));
