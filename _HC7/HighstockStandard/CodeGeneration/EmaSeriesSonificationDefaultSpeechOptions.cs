...
{
	public partial class EmaSeriesSonificationDefaultSpeechOptions  : BaseObject
	{
		Hashtable h = new Hashtable();

		public EmaSeriesSonificationDefaultSpeechOptions()
		{
			ActiveWhen = ActiveWhen_DefaultValue = new EmaSeriesSonificationDefaultSpeechOptionsActiveWhen();
			Language = Language_DefaultValue = "en-US";
			Mapping = Mapping_DefaultValue = new EmaSeriesSonificationDefaultSpeechOptionsMapping();
			PointGrouping = PointGrouping_DefaultValue = new EmaSeriesSonificationDefaultSpeechOptionsPointGrouping();
			PreferredVoice = PreferredVoice_DefaultValue = "";
			ShowPlayMarker = ShowPlayMarker_DefaultValue = true;
			Type = Type_DefaultValue = EmaSeriesSonificationDefaultSpeechOptionsType.Instrument;
		...
		/// </summary>
		public EmaSeriesSonificationDefaultSpeechOptionsActiveWhen ActiveWhen { get; set; }
		private EmaSeriesSonificationDefaultSpeechOptionsActiveWhen ActiveWhen_DefaultValue { get; set; }
		...
		/// </summary>
		public EmaSeriesSonificationDefaultSpeechOptionsMapping Mapping { get; set; }
		private EmaSeriesSonificationDefaultSpeechOptionsMapping Mapping_DefaultValue { get; set; }
		 

		/// <summary>
		/// Options for point grouping, specifically for instrument tracks.
		/// </summary>
		public EmaSeriesSonificationDefaultSpeechOptionsPointGrouping PointGrouping { get; set; }
		private EmaSeriesSonificationDefaultSpeechOptionsPointGrouping PointGrouping_DefaultValue { get; set; }
		...
		/// </summary>
		public EmaSeriesSonificationDefaultSpeechOptionsType Type { get; set; }
		private EmaSeriesSonificationDefaultSpeechOptionsType Type_DefaultValue { get; set; }
