...
{
	public partial class EmaSeriesSonificationDefaultSpeechOptionsMapping  : BaseObject
	{
		Hashtable h = new Hashtable();

		public EmaSeriesSonificationDefaultSpeechOptionsMapping()
		{
			Frequency = Frequency_DefaultValue = new EmaSeriesSonificationDefaultSpeechOptionsMappingFrequency();
			GapBetweenNotes = GapBetweenNotes_DefaultValue = new EmaSeriesSonificationDefaultSpeechOptionsMappingGapBetweenNotes();
			Highpass = Highpass_DefaultValue = new EmaSeriesSonificationDefaultSpeechOptionsMappingHighpass();
			Lowpass = Lowpass_DefaultValue = new EmaSeriesSonificationDefaultSpeechOptionsMappingLowpass();
			NoteDuration = NoteDuration_DefaultValue = new EmaSeriesSonificationDefaultSpeechOptionsMappingNoteDuration();
			Pan = Pan_DefaultValue = new EmaSeriesSonificationDefaultSpeechOptionsMappingPan();
			Pitch = Pitch_DefaultValue = new EmaSeriesSonificationDefaultSpeechOptionsMappingPitch();
			PitchString = PitchString_DefaultValue = "null";
			PitchNumber = PitchNumber_DefaultValue = null;
			PlayDelay = PlayDelay_DefaultValue = new EmaSeriesSonificationDefaultSpeechOptionsMappingPlayDelay();
			Time = Time_DefaultValue = new EmaSeriesSonificationDefaultSpeechOptionsMappingTime();
			TimeString = TimeString_DefaultValue = "null";
			TimeNumber = TimeNumber_DefaultValue = null;
			Tremolo = Tremolo_DefaultValue = new EmaSeriesSonificationDefaultSpeechOptionsMappingTremolo();
			Volume = Volume_DefaultValue = new EmaSeriesSonificationDefaultSpeechOptionsMappingVolume();
		...
		/// </summary>
		public EmaSeriesSonificationDefaultSpeechOptionsMappingFrequency Frequency { get; set; }
		private EmaSeriesSonificationDefaultSpeechOptionsMappingFrequency Frequency_DefaultValue { get; set; }
		...
		/// </summary>
		public EmaSeriesSonificationDefaultSpeechOptionsMappingGapBetweenNotes GapBetweenNotes { get; set; }
		private EmaSeriesSonificationDefaultSpeechOptionsMappingGapBetweenNotes GapBetweenNotes_DefaultValue { get; set; }
		...
		/// </summary>
		public EmaSeriesSonificationDefaultSpeechOptionsMappingHighpass Highpass { get; set; }
		private EmaSeriesSonificationDefaultSpeechOptionsMappingHighpass Highpass_DefaultValue { get; set; }
		...
		/// </summary>
		public EmaSeriesSonificationDefaultSpeechOptionsMappingLowpass Lowpass { get; set; }
		private EmaSeriesSonificationDefaultSpeechOptionsMappingLowpass Lowpass_DefaultValue { get; set; }
		...
		/// </summary>
		public EmaSeriesSonificationDefaultSpeechOptionsMappingNoteDuration NoteDuration { get; set; }
		private EmaSeriesSonificationDefaultSpeechOptionsMappingNoteDuration NoteDuration_DefaultValue { get; set; }
		...
		/// </summary>
		public EmaSeriesSonificationDefaultSpeechOptionsMappingPan Pan { get; set; }
		private EmaSeriesSonificationDefaultSpeechOptionsMappingPan Pan_DefaultValue { get; set; }
		...
		/// </summary>
		public EmaSeriesSonificationDefaultSpeechOptionsMappingPitch Pitch { get; set; }
		private EmaSeriesSonificationDefaultSpeechOptionsMappingPitch Pitch_DefaultValue { get; set; }
		...
		/// </summary>
		public EmaSeriesSonificationDefaultSpeechOptionsMappingPlayDelay PlayDelay { get; set; }
		private EmaSeriesSonificationDefaultSpeechOptionsMappingPlayDelay PlayDelay_DefaultValue { get; set; }
		...
		/// </summary>
		public EmaSeriesSonificationDefaultSpeechOptionsMappingTime Time { get; set; }
		private EmaSeriesSonificationDefaultSpeechOptionsMappingTime Time_DefaultValue { get; set; }
		...
		/// </summary>
		public EmaSeriesSonificationDefaultSpeechOptionsMappingTremolo Tremolo { get; set; }
		private EmaSeriesSonificationDefaultSpeechOptionsMappingTremolo Tremolo_DefaultValue { get; set; }
		 

		/// <summary>
		/// The volume of notes, from 0 to 1.
		/// </summary>
		public EmaSeriesSonificationDefaultSpeechOptionsMappingVolume Volume { get; set; }
		private EmaSeriesSonificationDefaultSpeechOptionsMappingVolume Volume_DefaultValue { get; set; }
