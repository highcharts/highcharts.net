...
{
	public partial class EmaSeriesSonificationDefaultSpeechOptionsMappingNoteDuration  : BaseObject
	{
		Hashtable h = new Hashtable();

		public EmaSeriesSonificationDefaultSpeechOptionsMappingNoteDuration()
		{
			MapFunction = MapFunction_DefaultValue = EmaSeriesSonificationDefaultSpeechOptionsMappingNoteDurationMapFunction.Linear;
			MapTo = MapTo_DefaultValue = "";
			Max = Max_DefaultValue = null;
			Min = Min_DefaultValue = null;
			Value = Value_DefaultValue = null;
			Within = Within_DefaultValue = EmaSeriesSonificationDefaultSpeechOptionsMappingNoteDurationWithin.Chart;
		...
		/// </summary>
		public EmaSeriesSonificationDefaultSpeechOptionsMappingNoteDurationMapFunction MapFunction { get; set; }
		private EmaSeriesSonificationDefaultSpeechOptionsMappingNoteDurationMapFunction MapFunction_DefaultValue { get; set; }
		...
		/// </summary>
		public EmaSeriesSonificationDefaultSpeechOptionsMappingNoteDurationWithin Within { get; set; }
		private EmaSeriesSonificationDefaultSpeechOptionsMappingNoteDurationWithin Within_DefaultValue { get; set; }
