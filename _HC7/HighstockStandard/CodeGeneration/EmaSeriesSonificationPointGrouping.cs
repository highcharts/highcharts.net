...
{
	public partial class EmaSeriesSonificationPointGrouping  : BaseObject
	{
		Hashtable h = new Hashtable();

		public EmaSeriesSonificationPointGrouping()
		{
			Algorithm = Algorithm_DefaultValue = EmaSeriesSonificationPointGroupingAlgorithm.Minimax;
		...
		/// </summary>
		public EmaSeriesSonificationPointGroupingAlgorithm Algorithm { get; set; }
		private EmaSeriesSonificationPointGroupingAlgorithm Algorithm_DefaultValue { get; set; }
