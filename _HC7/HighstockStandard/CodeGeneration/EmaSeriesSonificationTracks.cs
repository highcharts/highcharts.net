...
{
	public partial class EmaSeriesSonificationTracks  : BaseObject
	{
		Hashtable h = new Hashtable();

		public EmaSeriesSonificationTracks()
		{
			ActiveWhen = ActiveWhen_DefaultValue = new EmaSeriesSonificationTracksActiveWhen();
			Instrument = Instrument_DefaultValue = null;
			InstrumentString = InstrumentString_DefaultValue = "null";
			Mapping = Mapping_DefaultValue = new EmaSeriesSonificationTracksMapping();
			MidiName = MidiName_DefaultValue = "";
			PointGrouping = PointGrouping_DefaultValue = new EmaSeriesSonificationTracksPointGrouping();
			RoundToMusicalNotes = RoundToMusicalNotes_DefaultValue = true;
			ShowPlayMarker = ShowPlayMarker_DefaultValue = true;
			Type = Type_DefaultValue = EmaSeriesSonificationTracksType.Instrument;
		...
		/// </summary>
		public EmaSeriesSonificationTracksActiveWhen ActiveWhen { get; set; }
		private EmaSeriesSonificationTracksActiveWhen ActiveWhen_DefaultValue { get; set; }
		...
		/// </summary>
		public EmaSeriesSonificationTracksMapping Mapping { get; set; }
		private EmaSeriesSonificationTracksMapping Mapping_DefaultValue { get; set; }
		...
		/// </summary>
		public EmaSeriesSonificationTracksPointGrouping PointGrouping { get; set; }
		private EmaSeriesSonificationTracksPointGrouping PointGrouping_DefaultValue { get; set; }
		...
		/// </summary>
		public EmaSeriesSonificationTracksType Type { get; set; }
		private EmaSeriesSonificationTracksType Type_DefaultValue { get; set; }
