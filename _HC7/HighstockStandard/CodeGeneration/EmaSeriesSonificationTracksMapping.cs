...
{
	public partial class EmaSeriesSonificationTracksMapping  : BaseObject
	{
		Hashtable h = new Hashtable();

		public EmaSeriesSonificationTracksMapping()
		{
			Frequency = Frequency_DefaultValue = new EmaSeriesSonificationTracksMappingFrequency();
			GapBetweenNotes = GapBetweenNotes_DefaultValue = new EmaSeriesSonificationTracksMappingGapBetweenNotes();
			Highpass = Highpass_DefaultValue = new EmaSeriesSonificationTracksMappingHighpass();
			Lowpass = Lowpass_DefaultValue = new EmaSeriesSonificationTracksMappingLowpass();
			NoteDuration = NoteDuration_DefaultValue = new EmaSeriesSonificationTracksMappingNoteDuration();
			Pan = Pan_DefaultValue = new EmaSeriesSonificationTracksMappingPan();
			Pitch = Pitch_DefaultValue = new EmaSeriesSonificationTracksMappingPitch();
			PitchString = PitchString_DefaultValue = "null";
			PitchNumber = PitchNumber_DefaultValue = null;
			PlayDelay = PlayDelay_DefaultValue = new EmaSeriesSonificationTracksMappingPlayDelay();
			Time = Time_DefaultValue = new EmaSeriesSonificationTracksMappingTime();
			TimeString = TimeString_DefaultValue = "null";
			TimeNumber = TimeNumber_DefaultValue = null;
			Tremolo = Tremolo_DefaultValue = new EmaSeriesSonificationTracksMappingTremolo();
			Volume = Volume_DefaultValue = new EmaSeriesSonificationTracksMappingVolume();
		...
		/// </summary>
		public EmaSeriesSonificationTracksMappingFrequency Frequency { get; set; }
		private EmaSeriesSonificationTracksMappingFrequency Frequency_DefaultValue { get; set; }
		...
		/// </summary>
		public EmaSeriesSonificationTracksMappingGapBetweenNotes GapBetweenNotes { get; set; }
		private EmaSeriesSonificationTracksMappingGapBetweenNotes GapBetweenNotes_DefaultValue { get; set; }
		...
		/// </summary>
		public EmaSeriesSonificationTracksMappingHighpass Highpass { get; set; }
		private EmaSeriesSonificationTracksMappingHighpass Highpass_DefaultValue { get; set; }
		...
		/// </summary>
		public EmaSeriesSonificationTracksMappingLowpass Lowpass { get; set; }
		private EmaSeriesSonificationTracksMappingLowpass Lowpass_DefaultValue { get; set; }
		...
		/// </summary>
		public EmaSeriesSonificationTracksMappingNoteDuration NoteDuration { get; set; }
		private EmaSeriesSonificationTracksMappingNoteDuration NoteDuration_DefaultValue { get; set; }
		...
		/// </summary>
		public EmaSeriesSonificationTracksMappingPan Pan { get; set; }
		private EmaSeriesSonificationTracksMappingPan Pan_DefaultValue { get; set; }
		...
		/// </summary>
		public EmaSeriesSonificationTracksMappingPitch Pitch { get; set; }
		private EmaSeriesSonificationTracksMappingPitch Pitch_DefaultValue { get; set; }
		...
		/// </summary>
		public EmaSeriesSonificationTracksMappingPlayDelay PlayDelay { get; set; }
		private EmaSeriesSonificationTracksMappingPlayDelay PlayDelay_DefaultValue { get; set; }
		...
		/// </summary>
		public EmaSeriesSonificationTracksMappingTime Time { get; set; }
		private EmaSeriesSonificationTracksMappingTime Time_DefaultValue { get; set; }
		...
		/// </summary>
		public EmaSeriesSonificationTracksMappingTremolo Tremolo { get; set; }
		private EmaSeriesSonificationTracksMappingTremolo Tremolo_DefaultValue { get; set; }
		 

		/// <summary>
		/// The volume of notes, from 0 to 1.
		/// </summary>
		public EmaSeriesSonificationTracksMappingVolume Volume { get; set; }
		private EmaSeriesSonificationTracksMappingVolume Volume_DefaultValue { get; set; }
