...
{
	public partial class EmaSeriesSonificationTracksMappingFrequency  : BaseObject
	{
		Hashtable h = new Hashtable();

		public EmaSeriesSonificationTracksMappingFrequency()
		{
			MapFunction = MapFunction_DefaultValue = EmaSeriesSonificationTracksMappingFrequencyMapFunction.Linear;
			MapTo = MapTo_DefaultValue = "";
			Max = Max_DefaultValue = null;
			Min = Min_DefaultValue = null;
			Value = Value_DefaultValue = null;
			Within = Within_DefaultValue = EmaSeriesSonificationTracksMappingFrequencyWithin.Chart;
		...
		/// </summary>
		public EmaSeriesSonificationTracksMappingFrequencyMapFunction MapFunction { get; set; }
		private EmaSeriesSonificationTracksMappingFrequencyMapFunction MapFunction_DefaultValue { get; set; }
		...
		/// </summary>
		public EmaSeriesSonificationTracksMappingFrequencyWithin Within { get; set; }
		private EmaSeriesSonificationTracksMappingFrequencyWithin Within_DefaultValue { get; set; }
