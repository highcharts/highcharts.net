...
{
	public partial class EmaSeriesSonificationTracksMappingGapBetweenNotes  : BaseObject
	{
		Hashtable h = new Hashtable();

		public EmaSeriesSonificationTracksMappingGapBetweenNotes()
		{
			MapFunction = MapFunction_DefaultValue = EmaSeriesSonificationTracksMappingGapBetweenNotesMapFunction.Linear;
			MapTo = MapTo_DefaultValue = "";
			Max = Max_DefaultValue = null;
			Min = Min_DefaultValue = null;
			Value = Value_DefaultValue = null;
			Within = Within_DefaultValue = EmaSeriesSonificationTracksMappingGapBetweenNotesWithin.Chart;
		...
		/// </summary>
		public EmaSeriesSonificationTracksMappingGapBetweenNotesMapFunction MapFunction { get; set; }
		private EmaSeriesSonificationTracksMappingGapBetweenNotesMapFunction MapFunction_DefaultValue { get; set; }
		...
		/// </summary>
		public EmaSeriesSonificationTracksMappingGapBetweenNotesWithin Within { get; set; }
		private EmaSeriesSonificationTracksMappingGapBetweenNotesWithin Within_DefaultValue { get; set; }
