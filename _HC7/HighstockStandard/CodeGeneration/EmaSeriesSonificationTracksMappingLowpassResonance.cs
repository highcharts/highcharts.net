...
{
	public partial class EmaSeriesSonificationTracksMappingLowpassResonance  : BaseObject
	{
		Hashtable h = new Hashtable();

		public EmaSeriesSonificationTracksMappingLowpassResonance()
		{
			MapFunction = MapFunction_DefaultValue = EmaSeriesSonificationTracksMappingLowpassResonanceMapFunction.Linear;
			MapTo = MapTo_DefaultValue = "";
			Max = Max_DefaultValue = null;
			Min = Min_DefaultValue = null;
			Value = Value_DefaultValue = null;
			Within = Within_DefaultValue = EmaSeriesSonificationTracksMappingLowpassResonanceWithin.Chart;
		...
		/// </summary>
		public EmaSeriesSonificationTracksMappingLowpassResonanceMapFunction MapFunction { get; set; }
		private EmaSeriesSonificationTracksMappingLowpassResonanceMapFunction MapFunction_DefaultValue { get; set; }
		...
		/// </summary>
		public EmaSeriesSonificationTracksMappingLowpassResonanceWithin Within { get; set; }
		private EmaSeriesSonificationTracksMappingLowpassResonanceWithin Within_DefaultValue { get; set; }
