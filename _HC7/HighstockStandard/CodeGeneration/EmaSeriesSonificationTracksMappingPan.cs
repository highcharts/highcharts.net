...
{
	public partial class EmaSeriesSonificationTracksMappingPan  : BaseObject
	{
		Hashtable h = new Hashtable();

		public EmaSeriesSonificationTracksMappingPan()
		{
			MapFunction = MapFunction_DefaultValue = EmaSeriesSonificationTracksMappingPanMapFunction.Linear;
			MapTo = MapTo_DefaultValue = "";
			Max = Max_DefaultValue = null;
			Min = Min_DefaultValue = null;
			Value = Value_DefaultValue = null;
			Within = Within_DefaultValue = EmaSeriesSonificationTracksMappingPanWithin.Chart;
		...
		/// </summary>
		public EmaSeriesSonificationTracksMappingPanMapFunction MapFunction { get; set; }
		private EmaSeriesSonificationTracksMappingPanMapFunction MapFunction_DefaultValue { get; set; }
		...
		/// </summary>
		public EmaSeriesSonificationTracksMappingPanWithin Within { get; set; }
		private EmaSeriesSonificationTracksMappingPanWithin Within_DefaultValue { get; set; }
