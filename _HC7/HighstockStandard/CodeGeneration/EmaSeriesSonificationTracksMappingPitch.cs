...
{
	public partial class EmaSeriesSonificationTracksMappingPitch  : BaseObject
	{
		Hashtable h = new Hashtable();

		public EmaSeriesSonificationTracksMappingPitch()
		{
			MapFunction = MapFunction_DefaultValue = EmaSeriesSonificationTracksMappingPitchMapFunction.Linear;
		...
		/// </summary>
		public EmaSeriesSonificationTracksMappingPitchMapFunction MapFunction { get; set; }
		private EmaSeriesSonificationTracksMappingPitchMapFunction MapFunction_DefaultValue { get; set; }
