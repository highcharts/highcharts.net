...
{
	public partial class EmaSeriesSonificationTracksMappingTime  : BaseObject
	{
		Hashtable h = new Hashtable();

		public EmaSeriesSonificationTracksMappingTime()
		{
			MapFunction = MapFunction_DefaultValue = EmaSeriesSonificationTracksMappingTimeMapFunction.Linear;
			MapTo = MapTo_DefaultValue = "";
			Max = Max_DefaultValue = null;
			Min = Min_DefaultValue = null;
			Value = Value_DefaultValue = null;
			Within = Within_DefaultValue = EmaSeriesSonificationTracksMappingTimeWithin.Chart;
		...
		/// </summary>
		public EmaSeriesSonificationTracksMappingTimeMapFunction MapFunction { get; set; }
		private EmaSeriesSonificationTracksMappingTimeMapFunction MapFunction_DefaultValue { get; set; }
		...
		/// </summary>
		public EmaSeriesSonificationTracksMappingTimeWithin Within { get; set; }
		private EmaSeriesSonificationTracksMappingTimeWithin Within_DefaultValue { get; set; }
