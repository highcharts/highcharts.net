...
{
	public partial class EmaSeriesSonificationTracksMappingTremoloSpeed  : BaseObject
	{
		Hashtable h = new Hashtable();

		public EmaSeriesSonificationTracksMappingTremoloSpeed()
		{
			MapFunction = MapFunction_DefaultValue = EmaSeriesSonificationTracksMappingTremoloSpeedMapFunction.Linear;
			MapTo = MapTo_DefaultValue = "";
			Max = Max_DefaultValue = null;
			Min = Min_DefaultValue = null;
			Value = Value_DefaultValue = null;
			Within = Within_DefaultValue = EmaSeriesSonificationTracksMappingTremoloSpeedWithin.Chart;
		...
		/// </summary>
		public EmaSeriesSonificationTracksMappingTremoloSpeedMapFunction MapFunction { get; set; }
		private EmaSeriesSonificationTracksMappingTremoloSpeedMapFunction MapFunction_DefaultValue { get; set; }
		...
		/// </summary>
		public EmaSeriesSonificationTracksMappingTremoloSpeedWithin Within { get; set; }
		private EmaSeriesSonificationTracksMappingTremoloSpeedWithin Within_DefaultValue { get; set; }
