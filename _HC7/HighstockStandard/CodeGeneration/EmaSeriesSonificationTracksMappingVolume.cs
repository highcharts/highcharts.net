...
{
	public partial class EmaSeriesSonificationTracksMappingVolume  : BaseObject
	{
		Hashtable h = new Hashtable();

		public EmaSeriesSonificationTracksMappingVolume()
		{
			MapFunction = MapFunction_DefaultValue = EmaSeriesSonificationTracksMappingVolumeMapFunction.Linear;
			MapTo = MapTo_DefaultValue = "";
			Max = Max_DefaultValue = null;
			Min = Min_DefaultValue = null;
			Value = Value_DefaultValue = null;
			Within = Within_DefaultValue = EmaSeriesSonificationTracksMappingVolumeWithin.Chart;
		...
		/// </summary>
		public EmaSeriesSonificationTracksMappingVolumeMapFunction MapFunction { get; set; }
		private EmaSeriesSonificationTracksMappingVolumeMapFunction MapFunction_DefaultValue { get; set; }
		...
		/// </summary>
		public EmaSeriesSonificationTracksMappingVolumeWithin Within { get; set; }
		private EmaSeriesSonificationTracksMappingVolumeWithin Within_DefaultValue { get; set; }
