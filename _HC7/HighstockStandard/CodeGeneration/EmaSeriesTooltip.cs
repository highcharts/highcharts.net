...
{
	public partial class EmaSeriesTooltip  : BaseObject
	{
		public EmaSeriesTooltip()
		{
			...
			HeaderShape = HeaderShape_DefaultValue = EmaSeriesTooltipHeaderShape.Callout;
		...
		/// </summary>
		public EmaSeriesTooltipHeaderShape HeaderShape { get; set; }
		private EmaSeriesTooltipHeaderShape HeaderShape_DefaultValue { get; set; }
		...
		internal override Hashtable ToHashtable()
		{
			...
			if (NullFormatter != NullFormatter_DefaultValue) { h.Add("nullFormatter",NullFormatter); Highstock.AddFunction("EmaSeriesTooltipNullFormatter.nullFormatter", NullFormatter); }  
			if (Outside != Outside_DefaultValue) h.Add("outside",Outside);
			if (Padding != Padding_DefaultValue) h.Add("padding",Padding);
			if (PointFormat != PointFormat_DefaultValue) h.Add("pointFormat",PointFormat);
			if (PointFormatter != PointFormatter_DefaultValue) { h.Add("pointFormatter",PointFormatter); Highstock.AddFunction("EmaSeriesTooltipPointFormatter.pointFormatter", PointFormatter); }  
