...
namespace Highsoft.Web.Mvc.Stocks
{
	public partial class Exporting  : BaseObject
	{
		...
		internal override Hashtable ToHashtable(Highstock highstock)
		{
			...
			if (Buttons != null) h.Add("buttons",Buttons.ToHashtable(highstock));
			if (ChartOptions != null) h.Add("chartOptions",ChartOptions);
			if (Csv != null) h.Add("csv",Csv.ToHashtable(highstock));
			if (Enabled != null) h.Add("enabled",Enabled);
			if (Error != null) { h.Add("error",Error); highstock.AddFunction("error", Error); }  
			...
			if (MenuItemDefinitions != null) h.Add("menuItemDefinitions", HashifyDictionary(highstock,MenuItemDefinitions));
			if (PdfFont != null) h.Add("pdfFont",PdfFont.ToHashtable(highstock));
