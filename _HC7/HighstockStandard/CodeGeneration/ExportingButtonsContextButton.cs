...
namespace Highsoft.Web.Mvc.Stocks
{
	public partial class ExportingButtonsContextButton  : BaseObject
	{
		...
		internal override Hashtable ToHashtable(Highstock highstock)
		{
			...
			if (Align != ExportingButtonsContextButtonAlign.Null) h.Add("align", highstock.FirstCharacterToLower(Align.ToString()));
			...
			if (VerticalAlign != ExportingButtonsContextButtonVerticalAlign.Null) h.Add("verticalAlign", highstock.FirstCharacterToLower(VerticalAlign.ToString()));
