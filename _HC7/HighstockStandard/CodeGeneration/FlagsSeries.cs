...
namespace Highsoft.Web.Mvc.Stocks
{
	public partial class FlagsSeries  : Series
	{
		...
		/// </summary>
		public FlagsSeriesAccessibility Accessibility { get; set; }
		...
		/// </summary>
		public FlagsSeriesBoostBlending BoostBlending { get; set; }
		...
		/// </summary>
		public FlagsSeriesCompare Compare { get; set; }
		...
		/// </summary>
		public FlagsSeriesDataSorting DataSorting { get; set; }
		...
		/// </summary>
		public FlagsSeriesDragDrop DragDrop { get; set; }
		...
		/// </summary>
		public FlagsSeriesLastPrice LastPrice { get; set; }
		 

		/// <summary>
		/// The line marks the last price from visible range of points.
		/// </summary>
		public FlagsSeriesLastVisiblePrice LastVisiblePrice { get; set; }
		...
		/// </summary>
		public FlagsSeriesLegendSymbol LegendSymbol { get; set; }
		...
		/// </summary>
		public FlagsSeriesOnPoint OnPoint { get; set; }
		...
		/// </summary>
		public FlagsSeriesPointPlacement PointPlacement { get; set; }
		 

		/// <summary>
		/// Possible values: `"on"`, `"between"`, `number`.In a column chart, when pointPlacement is `"on"`, the point will notcreate any padding of the X axis. In a polar column chart this meansthat the first column points directly north. If the pointPlacement is`"between"`, the columns will be laid out between ticks. This isuseful for example for visualising an amount between two points intime or in a certain sector of a polar chart.Since Highcharts 3.0.2, the point placement can also be numeric,where 0 is on the axis value, -0.5 is between this value and theprevious, and 0.5 is between this value and the next. Unlike thetextual options, numeric point placement options won't affect axispadding.Note that pointPlacement needs a [pointRange](#plotOptions.series.pointRange) to work. For column series this iscomputed, but for line-type series it needs to be set.For the `xrange` series type and gantt charts, if the Y axis is acategory axis, the `pointPlacement` applies to the Y axis rather thanthe (typically datetime) X axis.Defaults to `undefined` in cartesian charts, `"between"` in polarcharts.
		/// </summary>
		public FlagsSeriesPointPlacement PointPlacementNumber { get; set; }
		...
		/// </summary>
		public FlagsSeriesSonification Sonification { get; set; }
		...
		/// </summary>
		public List<FlagsSeriesZones> Zones { get; set; }
		...
		internal override Hashtable ToHashtable(Highstock highstock)
		{
			...
			if (BoostBlending != FlagsSeriesBoostBlending.Null) h.Add("boostBlending", highstock.FirstCharacterToLower(BoostBlending.ToString()));
			...
			if (Compare != FlagsSeriesCompare.Null) h.Add("compare", highstock.FirstCharacterToLower(Compare.ToString()));
			if (CompareBase != FlagsSeriesCompareBase.Null) h.Add("compareBase", highstock.FirstCharacterToLower(CompareBase.ToString()));
			...
			if (Cursor != FlagsSeriesCursor.Null) h.Add("cursor", highstock.FirstCharacterToLower(Cursor.ToString()));
			...
			if (FindNearestPointBy != FlagsSeriesFindNearestPointBy.Null) h.Add("findNearestPointBy", highstock.FirstCharacterToLower(FindNearestPointBy.ToString()));
			...
			if (LegendSymbol != FlagsSeriesLegendSymbol.Null) h.Add("legendSymbol", highstock.FirstCharacterToLower(LegendSymbol.ToString()));
			...
			if (OnKey != FlagsSeriesOnKey.Null) h.Add("onKey", highstock.FirstCharacterToLower(OnKey.ToString()));
			...
			if (PointIntervalUnit != FlagsSeriesPointIntervalUnit.Null) h.Add("pointIntervalUnit", highstock.FirstCharacterToLower(PointIntervalUnit.ToString()));
			if (PointPlacement != FlagsSeriesPointPlacement.Null) h.Add("pointPlacement", highstock.FirstCharacterToLower(PointPlacement.ToString()));
			if (PointPlacementNumber != FlagsSeriesPointPlacement.Null) h.Add("pointPlacement", highstock.FirstCharacterToLower(PointPlacementNumber.ToString()));
			...
			if (Stacking != FlagsSeriesStacking.Null) h.Add("stacking", highstock.FirstCharacterToLower(Stacking.ToString()));
			if (States != null) h.Add("states",States.ToHashtable(highstock));
			if (StickyTracking != null) h.Add("stickyTracking",StickyTracking);
			if (Style != null) h.Add("style",Style);
			if (TextAlign != FlagsSeriesTextAlign.Null) h.Add("textAlign", highstock.FirstCharacterToLower(TextAlign.ToString()));
