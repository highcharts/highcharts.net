...
namespace Highsoft.Web.Mvc.Stocks
{
	public partial class FlagsSeries  : Series
	{
		...
		public FlagsSeries()
		{
			Accessibility = Accessibility_DefaultValue = new FlagsSeriesAccessibility();
			AllowOverlapX = AllowOverlapX_DefaultValue = false;
			AllowPointSelect = AllowPointSelect_DefaultValue = false;
			AnimationLimit = AnimationLimit_DefaultValue = null;
			BoostBlending = BoostBlending_DefaultValue = FlagsSeriesBoostBlending.Undefined;
			...
			Compare = Compare_DefaultValue = FlagsSeriesCompare.Percent;
			...
			DataSorting = DataSorting_DefaultValue = new FlagsSeriesDataSorting();
			Depth = Depth_DefaultValue = 25;
			Description = Description_DefaultValue = "";
			DragDrop = DragDrop_DefaultValue = new FlagsSeriesDragDrop();
			Dumbell = Dumbell_DefaultValue = new FlagsSeriesDumbell();
			...
			LastPrice = LastPrice_DefaultValue = new FlagsSeriesLastPrice();
			LastVisiblePrice = LastVisiblePrice_DefaultValue = new FlagsSeriesLastVisiblePrice();
			LegendIndex = LegendIndex_DefaultValue = null;
			LegendSymbol = LegendSymbol_DefaultValue = FlagsSeriesLegendSymbol.Rectangle;
			...
			OnPoint = OnPoint_DefaultValue = new FlagsSeriesOnPoint();
			...
			Sonification = Sonification_DefaultValue = new FlagsSeriesSonification();
			...
			Zones = Zones_DefaultValue = new List<FlagsSeriesZones>();
		...
		private FlagsSeriesAccessibility Accessibility_DefaultValue { get; set; }
		...
		private FlagsSeriesBoostBlending BoostBlending_DefaultValue { get; set; }
		...
		private FlagsSeriesCompare Compare_DefaultValue { get; set; }
		...
		private FlagsSeriesDataSorting DataSorting_DefaultValue { get; set; }
		...
		private FlagsSeriesDragDrop DragDrop_DefaultValue { get; set; }
		 

		/// <summary>
		/// 
		/// </summary>
		public FlagsSeriesDumbell Dumbell { get; set; }
		private FlagsSeriesDumbell Dumbell_DefaultValue { get; set; }
		...
		private FlagsSeriesLastPrice LastPrice_DefaultValue { get; set; }
		...
		private FlagsSeriesLastVisiblePrice LastVisiblePrice_DefaultValue { get; set; }
		...
		private FlagsSeriesLegendSymbol LegendSymbol_DefaultValue { get; set; }
		...
		private FlagsSeriesOnPoint OnPoint_DefaultValue { get; set; }
		...
		private FlagsSeriesSonification Sonification_DefaultValue { get; set; }
		...
		private List<FlagsSeriesZones> Zones_DefaultValue { get; set; }
