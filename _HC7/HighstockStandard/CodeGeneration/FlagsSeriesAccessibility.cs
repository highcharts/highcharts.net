...
namespace Highsoft.Web.Mvc.Stocks
{
	public partial class FlagsSeriesAccessibility  : BaseObject
	{
		...
		public FlagsSeriesAccessibility()
		{
			...
			Point = Point_DefaultValue = new FlagsSeriesAccessibilityPoint();
		...
		/// </summary>
		public FlagsSeriesAccessibilityPoint Point { get; set; }
		private FlagsSeriesAccessibilityPoint Point_DefaultValue { get; set; }
