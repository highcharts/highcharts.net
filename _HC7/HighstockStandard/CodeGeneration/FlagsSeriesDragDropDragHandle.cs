...
{
	public partial class FlagsSeriesDragDropDragHandle  : BaseObject
	{
		public FlagsSeriesDragDropDragHandle()
		{
		...
		internal override Hashtable ToHashtable()
		{
			...
			if (PathFormatter != PathFormatter_DefaultValue) { h.Add("pathFormatter",PathFormatter); Highstock.AddFunction("FlagsSeriesDragDropDragHandlePathFormatter.pathFormatter", PathFormatter); }  
