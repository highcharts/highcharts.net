...
{
	public partial class FlagsSeriesLabel  : BaseObject
	{
		public FlagsSeriesLabel()
		{
			...
			Style = Style_DefaultValue = new FlagsSeriesLabelStyle();
		...
		/// </summary>
		public FlagsSeriesLabelStyle Style { get; set; }
		private FlagsSeriesLabelStyle Style_DefaultValue { get; set; }
