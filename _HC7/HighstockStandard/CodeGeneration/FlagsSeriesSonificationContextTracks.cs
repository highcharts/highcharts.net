...
{
	public partial class FlagsSeriesSonificationContextTracks  : BaseObject
	{
		Hashtable h = new Hashtable();

		public FlagsSeriesSonificationContextTracks()
		{
			ActiveWhen = ActiveWhen_DefaultValue = new FlagsSeriesSonificationContextTracksActiveWhen();
			Instrument = Instrument_DefaultValue = null;
			InstrumentString = InstrumentString_DefaultValue = "null";
			Mapping = Mapping_DefaultValue = new FlagsSeriesSonificationContextTracksMapping();
			MidiName = MidiName_DefaultValue = "";
			PointGrouping = PointGrouping_DefaultValue = new FlagsSeriesSonificationContextTracksPointGrouping();
			...
			Type = Type_DefaultValue = FlagsSeriesSonificationContextTracksType.Instrument;
			ValueInterval = ValueInterval_DefaultValue = null;
			ValueMapFunction = ValueMapFunction_DefaultValue = FlagsSeriesSonificationContextTracksValueMapFunction.Linear;
		...
		/// </summary>
		public FlagsSeriesSonificationContextTracksActiveWhen ActiveWhen { get; set; }
		private FlagsSeriesSonificationContextTracksActiveWhen ActiveWhen_DefaultValue { get; set; }
		...
		/// </summary>
		public FlagsSeriesSonificationContextTracksMapping Mapping { get; set; }
		private FlagsSeriesSonificationContextTracksMapping Mapping_DefaultValue { get; set; }
		...
		/// </summary>
		public FlagsSeriesSonificationContextTracksPointGrouping PointGrouping { get; set; }
		private FlagsSeriesSonificationContextTracksPointGrouping PointGrouping_DefaultValue { get; set; }
		...
		/// </summary>
		public FlagsSeriesSonificationContextTracksType Type { get; set; }
		private FlagsSeriesSonificationContextTracksType Type_DefaultValue { get; set; }
		...
		/// </summary>
		public FlagsSeriesSonificationContextTracksValueMapFunction ValueMapFunction { get; set; }
		private FlagsSeriesSonificationContextTracksValueMapFunction ValueMapFunction_DefaultValue { get; set; }
