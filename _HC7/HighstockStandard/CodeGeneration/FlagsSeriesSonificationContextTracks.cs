...
namespace Highsoft.Web.Mvc.Stocks
{
	public partial class FlagsSeriesSonificationContextTracks  : BaseObject
	{
		...
		internal override Hashtable ToHashtable(Highstock highstock)
		{
			...
			if (Type != FlagsSeriesSonificationContextTracksType.Null) h.Add("type", highstock.FirstCharacterToLower(Type.ToString()));
			if (ValueInterval != null) h.Add("valueInterval",ValueInterval);
			if (ValueMapFunction != FlagsSeriesSonificationContextTracksValueMapFunction.Null) h.Add("valueMapFunction", highstock.FirstCharacterToLower(ValueMapFunction.ToString()));
