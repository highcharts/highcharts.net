...
{
	public partial class FlagsSeriesSonificationContextTracksMappingPan  : BaseObject
	{
		Hashtable h = new Hashtable();

		public FlagsSeriesSonificationContextTracksMappingPan()
		{
			MapFunction = MapFunction_DefaultValue = FlagsSeriesSonificationContextTracksMappingPanMapFunction.Linear;
			MapTo = MapTo_DefaultValue = "";
			Max = Max_DefaultValue = null;
			Min = Min_DefaultValue = null;
			Value = Value_DefaultValue = null;
			Within = Within_DefaultValue = FlagsSeriesSonificationContextTracksMappingPanWithin.Chart;
		...
		/// </summary>
		public FlagsSeriesSonificationContextTracksMappingPanMapFunction MapFunction { get; set; }
		private FlagsSeriesSonificationContextTracksMappingPanMapFunction MapFunction_DefaultValue { get; set; }
		...
		/// </summary>
		public FlagsSeriesSonificationContextTracksMappingPanWithin Within { get; set; }
		private FlagsSeriesSonificationContextTracksMappingPanWithin Within_DefaultValue { get; set; }
