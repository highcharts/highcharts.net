...
{
	public partial class FlagsSeriesSonificationContextTracksMappingPitch  : BaseObject
	{
		Hashtable h = new Hashtable();

		public FlagsSeriesSonificationContextTracksMappingPitch()
		{
			MapFunction = MapFunction_DefaultValue = FlagsSeriesSonificationContextTracksMappingPitchMapFunction.Linear;
		...
		/// </summary>
		public FlagsSeriesSonificationContextTracksMappingPitchMapFunction MapFunction { get; set; }
		private FlagsSeriesSonificationContextTracksMappingPitchMapFunction MapFunction_DefaultValue { get; set; }
