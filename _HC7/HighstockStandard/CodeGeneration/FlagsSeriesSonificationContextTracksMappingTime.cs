...
{
	public partial class FlagsSeriesSonificationContextTracksMappingTime  : BaseObject
	{
		Hashtable h = new Hashtable();

		public FlagsSeriesSonificationContextTracksMappingTime()
		{
			MapFunction = MapFunction_DefaultValue = FlagsSeriesSonificationContextTracksMappingTimeMapFunction.Linear;
			MapTo = MapTo_DefaultValue = "";
			Max = Max_DefaultValue = null;
			Min = Min_DefaultValue = null;
			Value = Value_DefaultValue = null;
			Within = Within_DefaultValue = FlagsSeriesSonificationContextTracksMappingTimeWithin.Chart;
		...
		/// </summary>
		public FlagsSeriesSonificationContextTracksMappingTimeMapFunction MapFunction { get; set; }
		private FlagsSeriesSonificationContextTracksMappingTimeMapFunction MapFunction_DefaultValue { get; set; }
		...
		/// </summary>
		public FlagsSeriesSonificationContextTracksMappingTimeWithin Within { get; set; }
		private FlagsSeriesSonificationContextTracksMappingTimeWithin Within_DefaultValue { get; set; }
