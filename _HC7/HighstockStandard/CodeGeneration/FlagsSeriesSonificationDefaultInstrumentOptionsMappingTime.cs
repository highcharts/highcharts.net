...
{
	public partial class FlagsSeriesSonificationDefaultInstrumentOptionsMappingTime  : BaseObject
	{
		Hashtable h = new Hashtable();

		public FlagsSeriesSonificationDefaultInstrumentOptionsMappingTime()
		{
			MapFunction = MapFunction_DefaultValue = FlagsSeriesSonificationDefaultInstrumentOptionsMappingTimeMapFunction.Linear;
			MapTo = MapTo_DefaultValue = "";
			Max = Max_DefaultValue = null;
			Min = Min_DefaultValue = null;
			Value = Value_DefaultValue = null;
			Within = Within_DefaultValue = FlagsSeriesSonificationDefaultInstrumentOptionsMappingTimeWithin.Chart;
		...
		/// </summary>
		public FlagsSeriesSonificationDefaultInstrumentOptionsMappingTimeMapFunction MapFunction { get; set; }
		private FlagsSeriesSonificationDefaultInstrumentOptionsMappingTimeMapFunction MapFunction_DefaultValue { get; set; }
		...
		/// </summary>
		public FlagsSeriesSonificationDefaultInstrumentOptionsMappingTimeWithin Within { get; set; }
		private FlagsSeriesSonificationDefaultInstrumentOptionsMappingTimeWithin Within_DefaultValue { get; set; }
