...
{
	public partial class FlagsSeriesSonificationDefaultSpeechOptionsMappingTime  : BaseObject
	{
		Hashtable h = new Hashtable();

		public FlagsSeriesSonificationDefaultSpeechOptionsMappingTime()
		{
			MapFunction = MapFunction_DefaultValue = FlagsSeriesSonificationDefaultSpeechOptionsMappingTimeMapFunction.Linear;
			MapTo = MapTo_DefaultValue = "";
			Max = Max_DefaultValue = null;
			Min = Min_DefaultValue = null;
			Value = Value_DefaultValue = null;
			Within = Within_DefaultValue = FlagsSeriesSonificationDefaultSpeechOptionsMappingTimeWithin.Chart;
		...
		/// </summary>
		public FlagsSeriesSonificationDefaultSpeechOptionsMappingTimeMapFunction MapFunction { get; set; }
		private FlagsSeriesSonificationDefaultSpeechOptionsMappingTimeMapFunction MapFunction_DefaultValue { get; set; }
		...
		/// </summary>
		public FlagsSeriesSonificationDefaultSpeechOptionsMappingTimeWithin Within { get; set; }
		private FlagsSeriesSonificationDefaultSpeechOptionsMappingTimeWithin Within_DefaultValue { get; set; }
