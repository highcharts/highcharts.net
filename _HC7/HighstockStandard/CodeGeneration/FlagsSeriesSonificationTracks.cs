...
{
	public partial class FlagsSeriesSonificationTracks  : BaseObject
	{
		Hashtable h = new Hashtable();

		public FlagsSeriesSonificationTracks()
		{
			ActiveWhen = ActiveWhen_DefaultValue = new FlagsSeriesSonificationTracksActiveWhen();
			Instrument = Instrument_DefaultValue = null;
			InstrumentString = InstrumentString_DefaultValue = "null";
			Mapping = Mapping_DefaultValue = new FlagsSeriesSonificationTracksMapping();
			MidiName = MidiName_DefaultValue = "";
			PointGrouping = PointGrouping_DefaultValue = new FlagsSeriesSonificationTracksPointGrouping();
			RoundToMusicalNotes = RoundToMusicalNotes_DefaultValue = true;
			ShowPlayMarker = ShowPlayMarker_DefaultValue = true;
			Type = Type_DefaultValue = FlagsSeriesSonificationTracksType.Instrument;
		...
		/// </summary>
		public FlagsSeriesSonificationTracksActiveWhen ActiveWhen { get; set; }
		private FlagsSeriesSonificationTracksActiveWhen ActiveWhen_DefaultValue { get; set; }
		...
		/// </summary>
		public FlagsSeriesSonificationTracksMapping Mapping { get; set; }
		private FlagsSeriesSonificationTracksMapping Mapping_DefaultValue { get; set; }
		...
		/// </summary>
		public FlagsSeriesSonificationTracksPointGrouping PointGrouping { get; set; }
		private FlagsSeriesSonificationTracksPointGrouping PointGrouping_DefaultValue { get; set; }
		...
		/// </summary>
		public FlagsSeriesSonificationTracksType Type { get; set; }
		private FlagsSeriesSonificationTracksType Type_DefaultValue { get; set; }
