...
{
	public partial class FlagsSeriesSonificationTracksMapping  : BaseObject
	{
		Hashtable h = new Hashtable();

		public FlagsSeriesSonificationTracksMapping()
		{
			Frequency = Frequency_DefaultValue = new FlagsSeriesSonificationTracksMappingFrequency();
			GapBetweenNotes = GapBetweenNotes_DefaultValue = new FlagsSeriesSonificationTracksMappingGapBetweenNotes();
			Highpass = Highpass_DefaultValue = new FlagsSeriesSonificationTracksMappingHighpass();
			Lowpass = Lowpass_DefaultValue = new FlagsSeriesSonificationTracksMappingLowpass();
			NoteDuration = NoteDuration_DefaultValue = new FlagsSeriesSonificationTracksMappingNoteDuration();
			Pan = Pan_DefaultValue = new FlagsSeriesSonificationTracksMappingPan();
			Pitch = Pitch_DefaultValue = new FlagsSeriesSonificationTracksMappingPitch();
			PitchString = PitchString_DefaultValue = "null";
			PitchNumber = PitchNumber_DefaultValue = null;
			PlayDelay = PlayDelay_DefaultValue = new FlagsSeriesSonificationTracksMappingPlayDelay();
			Time = Time_DefaultValue = new FlagsSeriesSonificationTracksMappingTime();
			TimeString = TimeString_DefaultValue = "null";
			TimeNumber = TimeNumber_DefaultValue = null;
			Tremolo = Tremolo_DefaultValue = new FlagsSeriesSonificationTracksMappingTremolo();
			Volume = Volume_DefaultValue = new FlagsSeriesSonificationTracksMappingVolume();
		...
		/// </summary>
		public FlagsSeriesSonificationTracksMappingFrequency Frequency { get; set; }
		private FlagsSeriesSonificationTracksMappingFrequency Frequency_DefaultValue { get; set; }
		...
		/// </summary>
		public FlagsSeriesSonificationTracksMappingGapBetweenNotes GapBetweenNotes { get; set; }
		private FlagsSeriesSonificationTracksMappingGapBetweenNotes GapBetweenNotes_DefaultValue { get; set; }
		...
		/// </summary>
		public FlagsSeriesSonificationTracksMappingHighpass Highpass { get; set; }
		private FlagsSeriesSonificationTracksMappingHighpass Highpass_DefaultValue { get; set; }
		...
		/// </summary>
		public FlagsSeriesSonificationTracksMappingLowpass Lowpass { get; set; }
		private FlagsSeriesSonificationTracksMappingLowpass Lowpass_DefaultValue { get; set; }
		...
		/// </summary>
		public FlagsSeriesSonificationTracksMappingNoteDuration NoteDuration { get; set; }
		private FlagsSeriesSonificationTracksMappingNoteDuration NoteDuration_DefaultValue { get; set; }
		...
		/// </summary>
		public FlagsSeriesSonificationTracksMappingPan Pan { get; set; }
		private FlagsSeriesSonificationTracksMappingPan Pan_DefaultValue { get; set; }
		...
		/// </summary>
		public FlagsSeriesSonificationTracksMappingPitch Pitch { get; set; }
		private FlagsSeriesSonificationTracksMappingPitch Pitch_DefaultValue { get; set; }
		...
		/// </summary>
		public FlagsSeriesSonificationTracksMappingPlayDelay PlayDelay { get; set; }
		private FlagsSeriesSonificationTracksMappingPlayDelay PlayDelay_DefaultValue { get; set; }
		...
		/// </summary>
		public FlagsSeriesSonificationTracksMappingTime Time { get; set; }
		private FlagsSeriesSonificationTracksMappingTime Time_DefaultValue { get; set; }
		...
		/// </summary>
		public FlagsSeriesSonificationTracksMappingTremolo Tremolo { get; set; }
		private FlagsSeriesSonificationTracksMappingTremolo Tremolo_DefaultValue { get; set; }
		 

		/// <summary>
		/// The volume of notes, from 0 to 1.
		/// </summary>
		public FlagsSeriesSonificationTracksMappingVolume Volume { get; set; }
		private FlagsSeriesSonificationTracksMappingVolume Volume_DefaultValue { get; set; }
