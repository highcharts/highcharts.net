...
{
	public partial class FlagsSeriesSonificationTracksMappingFrequency  : BaseObject
	{
		Hashtable h = new Hashtable();

		public FlagsSeriesSonificationTracksMappingFrequency()
		{
			MapFunction = MapFunction_DefaultValue = FlagsSeriesSonificationTracksMappingFrequencyMapFunction.Linear;
			MapTo = MapTo_DefaultValue = "";
			Max = Max_DefaultValue = null;
			Min = Min_DefaultValue = null;
			Value = Value_DefaultValue = null;
			Within = Within_DefaultValue = FlagsSeriesSonificationTracksMappingFrequencyWithin.Chart;
		...
		/// </summary>
		public FlagsSeriesSonificationTracksMappingFrequencyMapFunction MapFunction { get; set; }
		private FlagsSeriesSonificationTracksMappingFrequencyMapFunction MapFunction_DefaultValue { get; set; }
		...
		/// </summary>
		public FlagsSeriesSonificationTracksMappingFrequencyWithin Within { get; set; }
		private FlagsSeriesSonificationTracksMappingFrequencyWithin Within_DefaultValue { get; set; }
