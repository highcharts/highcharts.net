...
{
	public partial class FlagsSeriesSonificationTracksMappingLowpassResonance  : BaseObject
	{
		Hashtable h = new Hashtable();

		public FlagsSeriesSonificationTracksMappingLowpassResonance()
		{
			MapFunction = MapFunction_DefaultValue = FlagsSeriesSonificationTracksMappingLowpassResonanceMapFunction.Linear;
			MapTo = MapTo_DefaultValue = "";
			Max = Max_DefaultValue = null;
			Min = Min_DefaultValue = null;
			Value = Value_DefaultValue = null;
			Within = Within_DefaultValue = FlagsSeriesSonificationTracksMappingLowpassResonanceWithin.Chart;
		...
		/// </summary>
		public FlagsSeriesSonificationTracksMappingLowpassResonanceMapFunction MapFunction { get; set; }
		private FlagsSeriesSonificationTracksMappingLowpassResonanceMapFunction MapFunction_DefaultValue { get; set; }
		...
		/// </summary>
		public FlagsSeriesSonificationTracksMappingLowpassResonanceWithin Within { get; set; }
		private FlagsSeriesSonificationTracksMappingLowpassResonanceWithin Within_DefaultValue { get; set; }
