...
{
	public partial class FlagsSeriesSonificationTracksMappingPan  : BaseObject
	{
		Hashtable h = new Hashtable();

		public FlagsSeriesSonificationTracksMappingPan()
		{
			MapFunction = MapFunction_DefaultValue = FlagsSeriesSonificationTracksMappingPanMapFunction.Linear;
			MapTo = MapTo_DefaultValue = "";
			Max = Max_DefaultValue = null;
			Min = Min_DefaultValue = null;
			Value = Value_DefaultValue = null;
			Within = Within_DefaultValue = FlagsSeriesSonificationTracksMappingPanWithin.Chart;
		...
		/// </summary>
		public FlagsSeriesSonificationTracksMappingPanMapFunction MapFunction { get; set; }
		private FlagsSeriesSonificationTracksMappingPanMapFunction MapFunction_DefaultValue { get; set; }
		...
		/// </summary>
		public FlagsSeriesSonificationTracksMappingPanWithin Within { get; set; }
		private FlagsSeriesSonificationTracksMappingPanWithin Within_DefaultValue { get; set; }
