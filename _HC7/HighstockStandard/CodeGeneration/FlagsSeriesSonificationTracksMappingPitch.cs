...
{
	public partial class FlagsSeriesSonificationTracksMappingPitch  : BaseObject
	{
		Hashtable h = new Hashtable();

		public FlagsSeriesSonificationTracksMappingPitch()
		{
			MapFunction = MapFunction_DefaultValue = FlagsSeriesSonificationTracksMappingPitchMapFunction.Linear;
		...
		/// </summary>
		public FlagsSeriesSonificationTracksMappingPitchMapFunction MapFunction { get; set; }
		private FlagsSeriesSonificationTracksMappingPitchMapFunction MapFunction_DefaultValue { get; set; }
