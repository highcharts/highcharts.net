...
{
	public partial class FlagsSeriesSonificationTracksMappingTime  : BaseObject
	{
		Hashtable h = new Hashtable();

		public FlagsSeriesSonificationTracksMappingTime()
		{
			MapFunction = MapFunction_DefaultValue = FlagsSeriesSonificationTracksMappingTimeMapFunction.Linear;
			MapTo = MapTo_DefaultValue = "";
			Max = Max_DefaultValue = null;
			Min = Min_DefaultValue = null;
			Value = Value_DefaultValue = null;
			Within = Within_DefaultValue = FlagsSeriesSonificationTracksMappingTimeWithin.Chart;
		...
		/// </summary>
		public FlagsSeriesSonificationTracksMappingTimeMapFunction MapFunction { get; set; }
		private FlagsSeriesSonificationTracksMappingTimeMapFunction MapFunction_DefaultValue { get; set; }
		...
		/// </summary>
		public FlagsSeriesSonificationTracksMappingTimeWithin Within { get; set; }
		private FlagsSeriesSonificationTracksMappingTimeWithin Within_DefaultValue { get; set; }
