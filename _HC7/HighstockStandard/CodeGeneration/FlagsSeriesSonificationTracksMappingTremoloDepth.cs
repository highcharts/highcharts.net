...
{
	public partial class FlagsSeriesSonificationTracksMappingTremoloDepth  : BaseObject
	{
		Hashtable h = new Hashtable();

		public FlagsSeriesSonificationTracksMappingTremoloDepth()
		{
			MapFunction = MapFunction_DefaultValue = FlagsSeriesSonificationTracksMappingTremoloDepthMapFunction.Linear;
			MapTo = MapTo_DefaultValue = "";
			Max = Max_DefaultValue = null;
			Min = Min_DefaultValue = null;
			Value = Value_DefaultValue = null;
			Within = Within_DefaultValue = FlagsSeriesSonificationTracksMappingTremoloDepthWithin.Chart;
		...
		/// </summary>
		public FlagsSeriesSonificationTracksMappingTremoloDepthMapFunction MapFunction { get; set; }
		private FlagsSeriesSonificationTracksMappingTremoloDepthMapFunction MapFunction_DefaultValue { get; set; }
		...
		/// </summary>
		public FlagsSeriesSonificationTracksMappingTremoloDepthWithin Within { get; set; }
		private FlagsSeriesSonificationTracksMappingTremoloDepthWithin Within_DefaultValue { get; set; }
