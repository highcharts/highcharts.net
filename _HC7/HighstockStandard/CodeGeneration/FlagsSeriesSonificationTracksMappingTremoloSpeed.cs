...
{
	public partial class FlagsSeriesSonificationTracksMappingTremoloSpeed  : BaseObject
	{
		Hashtable h = new Hashtable();

		public FlagsSeriesSonificationTracksMappingTremoloSpeed()
		{
			MapFunction = MapFunction_DefaultValue = FlagsSeriesSonificationTracksMappingTremoloSpeedMapFunction.Linear;
			MapTo = MapTo_DefaultValue = "";
			Max = Max_DefaultValue = null;
			Min = Min_DefaultValue = null;
			Value = Value_DefaultValue = null;
			Within = Within_DefaultValue = FlagsSeriesSonificationTracksMappingTremoloSpeedWithin.Chart;
		...
		/// </summary>
		public FlagsSeriesSonificationTracksMappingTremoloSpeedMapFunction MapFunction { get; set; }
		private FlagsSeriesSonificationTracksMappingTremoloSpeedMapFunction MapFunction_DefaultValue { get; set; }
		...
		/// </summary>
		public FlagsSeriesSonificationTracksMappingTremoloSpeedWithin Within { get; set; }
		private FlagsSeriesSonificationTracksMappingTremoloSpeedWithin Within_DefaultValue { get; set; }
