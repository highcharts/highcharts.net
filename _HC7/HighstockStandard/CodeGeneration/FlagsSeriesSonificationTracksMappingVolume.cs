...
{
	public partial class FlagsSeriesSonificationTracksMappingVolume  : BaseObject
	{
		Hashtable h = new Hashtable();

		public FlagsSeriesSonificationTracksMappingVolume()
		{
			MapFunction = MapFunction_DefaultValue = FlagsSeriesSonificationTracksMappingVolumeMapFunction.Linear;
			MapTo = MapTo_DefaultValue = "";
			Max = Max_DefaultValue = null;
			Min = Min_DefaultValue = null;
			Value = Value_DefaultValue = null;
			Within = Within_DefaultValue = FlagsSeriesSonificationTracksMappingVolumeWithin.Chart;
		...
		/// </summary>
		public FlagsSeriesSonificationTracksMappingVolumeMapFunction MapFunction { get; set; }
		private FlagsSeriesSonificationTracksMappingVolumeMapFunction MapFunction_DefaultValue { get; set; }
		...
		/// </summary>
		public FlagsSeriesSonificationTracksMappingVolumeWithin Within { get; set; }
		private FlagsSeriesSonificationTracksMappingVolumeWithin Within_DefaultValue { get; set; }
