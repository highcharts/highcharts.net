...
{
	public partial class FlagsSeriesSonificationTracksPointGrouping  : BaseObject
	{
		Hashtable h = new Hashtable();

		public FlagsSeriesSonificationTracksPointGrouping()
		{
			Algorithm = Algorithm_DefaultValue = FlagsSeriesSonificationTracksPointGroupingAlgorithm.Minimax;
		...
		/// </summary>
		public FlagsSeriesSonificationTracksPointGroupingAlgorithm Algorithm { get; set; }
		private FlagsSeriesSonificationTracksPointGroupingAlgorithm Algorithm_DefaultValue { get; set; }
