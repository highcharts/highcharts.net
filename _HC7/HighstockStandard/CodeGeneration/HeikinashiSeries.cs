...
namespace Highsoft.Web.Mvc.Stocks
{
	public partial class HeikinashiSeries  : Series
	{
		...
		public HeikinashiSeries()
		{
			...
			Zones = Zones_DefaultValue = new List<HeikinashiSeriesZone>();
		...
		/// </summary>
		public List<HeikinashiSeriesZone> Zones { get; set; }
		private List<HeikinashiSeriesZone> Zones_DefaultValue { get; set; }
