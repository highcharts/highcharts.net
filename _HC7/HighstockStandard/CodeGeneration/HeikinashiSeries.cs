...
{
	public partial class HeikinashiSeries  : Series
	{
		Hashtable h = new Hashtable();

		public HeikinashiSeries()
		{
			Accessibility = Accessibility_DefaultValue = new HeikinashiSeriesAccessibility();
			AllowPointSelect = AllowPointSelect_DefaultValue = false;
			Animation = Animation_DefaultValue = new Animation() { Enabled = true };
			AnimationBool = AnimationBool_DefaultValue = true;
			AnimationLimit = AnimationLimit_DefaultValue = null;
			BoostBlending = BoostBlending_DefaultValue = HeikinashiSeriesBoostBlending.Undefined;
			...
			Compare = Compare_DefaultValue = HeikinashiSeriesCompare.Percent;
			CompareBase = CompareBase_DefaultValue = HeikinashiSeriesCompareBase.Min;
			CompareStart = CompareStart_DefaultValue = false;
			CropThreshold = CropThreshold_DefaultValue = 300;
			Cumulative = Cumulative_DefaultValue = false;
			CumulativeStart = CumulativeStart_DefaultValue = false;
			Cursor = Cursor_DefaultValue = HeikinashiSeriesCursor.Null;
			Custom = Custom_DefaultValue = new Hashtable();
			DashStyle = DashStyle_DefaultValue = HeikinashiSeriesDashStyle.Null;
			Data = Data_DefaultValue = new List<HeikinashiSeriesData>();
			DataGrouping = DataGrouping_DefaultValue = new HeikinashiSeriesDataGrouping();
			DataLabels = DataLabels_DefaultValue = new HeikinashiSeriesDataLabels();
			DataSorting = DataSorting_DefaultValue = new HeikinashiSeriesDataSorting();
			Depth = Depth_DefaultValue = 25;
			Description = Description_DefaultValue = "";
			DragDrop = DragDrop_DefaultValue = new HeikinashiSeriesDragDrop();
			Dumbell = Dumbell_DefaultValue = new HeikinashiSeriesDumbell();
			EdgeColor = EdgeColor_DefaultValue = "";
			EdgeWidth = EdgeWidth_DefaultValue = 1;
			EnableMouseTracking = EnableMouseTracking_DefaultValue = true;
			Events = Events_DefaultValue = new HeikinashiSeriesEvents();
			FindNearestPointBy = FindNearestPointBy_DefaultValue = HeikinashiSeriesFindNearestPointBy.X;
			...
			Label = Label_DefaultValue = new HeikinashiSeriesLabel();
			LastPrice = LastPrice_DefaultValue = new HeikinashiSeriesLastPrice();
			LastVisiblePrice = LastVisiblePrice_DefaultValue = new HeikinashiSeriesLastVisiblePrice();
			LegendIndex = LegendIndex_DefaultValue = null;
			LegendSymbol = LegendSymbol_DefaultValue = HeikinashiSeriesLegendSymbol.Rectangle;
			...
			OnPoint = OnPoint_DefaultValue = new HeikinashiSeriesOnPoint();
			Opacity = Opacity_DefaultValue = 1;
			Point = Point_DefaultValue = new HeikinashiSeriesPoint();
			PointDescriptionFormat = PointDescriptionFormat_DefaultValue = "";
			PointDescriptionFormatter = PointDescriptionFormatter_DefaultValue = "";
			PointInterval = PointInterval_DefaultValue = 1;
			PointIntervalUnit = PointIntervalUnit_DefaultValue = HeikinashiSeriesPointIntervalUnit.Null;
			PointPadding = PointPadding_DefaultValue = null;
			PointPlacement = PointPlacement_DefaultValue = new PointPlacement();
			PointRange = PointRange_DefaultValue = 0;
			PointStart = PointStart_DefaultValue = 0;
			PointValKey = PointValKey_DefaultValue = HeikinashiSeriesPointValKey.Close;
			...
			Sonification = Sonification_DefaultValue = new HeikinashiSeriesSonification();
			Stack = Stack_DefaultValue = "";
			StackNumber = StackNumber_DefaultValue = null;
			States = States_DefaultValue = new HeikinashiSeriesStates();
			StickyTracking = StickyTracking_DefaultValue = true;
			Threshold = Threshold_DefaultValue = 0;
			Tooltip = Tooltip_DefaultValue = new HeikinashiSeriesTooltip();
			...
			Zones = Zones_DefaultValue = new List<HeikinashiSeriesZones>();
		...
		/// </summary>
		public HeikinashiSeriesAccessibility Accessibility { get; set; }
		private HeikinashiSeriesAccessibility Accessibility_DefaultValue { get; set; }
		...
		/// </summary>
		public HeikinashiSeriesBoostBlending BoostBlending { get; set; }
		private HeikinashiSeriesBoostBlending BoostBlending_DefaultValue { get; set; }
		...
		/// </summary>
		public HeikinashiSeriesCompare Compare { get; set; }
		private HeikinashiSeriesCompare Compare_DefaultValue { get; set; }
		 

		/// <summary>
		/// When [compare](#plotOptions.series.compare) is `percent`, this optiondictates whether to use 0 or 100 as the base of comparison.
		/// </summary>
		public HeikinashiSeriesCompareBase CompareBase { get; set; }
		private HeikinashiSeriesCompareBase CompareBase_DefaultValue { get; set; }
		...
		/// </summary>
		public HeikinashiSeriesCursor Cursor { get; set; }
		private HeikinashiSeriesCursor Cursor_DefaultValue { get; set; }
		...
		/// </summary>
		public HeikinashiSeriesDataGrouping DataGrouping { get; set; }
		private HeikinashiSeriesDataGrouping DataGrouping_DefaultValue { get; set; }
		...
		/// </summary>
		public HeikinashiSeriesDataLabels DataLabels { get; set; }
		private HeikinashiSeriesDataLabels DataLabels_DefaultValue { get; set; }
		 

		/// <summary>
		/// Options for the series data sorting.
		/// </summary>
		public HeikinashiSeriesDataSorting DataSorting { get; set; }
		private HeikinashiSeriesDataSorting DataSorting_DefaultValue { get; set; }
		...
		/// </summary>
		public HeikinashiSeriesDragDrop DragDrop { get; set; }
		private HeikinashiSeriesDragDrop DragDrop_DefaultValue { get; set; }
		 

		/// <summary>
		/// 
		/// </summary>
		public HeikinashiSeriesDumbell Dumbell { get; set; }
		private HeikinashiSeriesDumbell Dumbell_DefaultValue { get; set; }
		...
		/// </summary>
		public HeikinashiSeriesEvents Events { get; set; }
		private HeikinashiSeriesEvents Events_DefaultValue { get; set; }
		...
		/// </summary>
		public HeikinashiSeriesFindNearestPointBy FindNearestPointBy { get; set; }
		private HeikinashiSeriesFindNearestPointBy FindNearestPointBy_DefaultValue { get; set; }
		...
		/// </summary>
		public HeikinashiSeriesLabel Label { get; set; }
		private HeikinashiSeriesLabel Label_DefaultValue { get; set; }
		 

		/// <summary>
		/// The line marks the last price from all points.
		/// </summary>
		public HeikinashiSeriesLastPrice LastPrice { get; set; }
		private HeikinashiSeriesLastPrice LastPrice_DefaultValue { get; set; }
		 

		/// <summary>
		/// The line marks the last price from visible range of points.
		/// </summary>
		public HeikinashiSeriesLastVisiblePrice LastVisiblePrice { get; set; }
		private HeikinashiSeriesLastVisiblePrice LastVisiblePrice_DefaultValue { get; set; }
		...
		/// </summary>
		public HeikinashiSeriesLegendSymbol LegendSymbol { get; set; }
		private HeikinashiSeriesLegendSymbol LegendSymbol_DefaultValue { get; set; }
		...
		/// </summary>
		public HeikinashiSeriesOnPoint OnPoint { get; set; }
		private HeikinashiSeriesOnPoint OnPoint_DefaultValue { get; set; }
		...
		/// </summary>
		public HeikinashiSeriesPoint Point { get; set; }
		private HeikinashiSeriesPoint Point_DefaultValue { get; set; }
		...
		/// </summary>
		public HeikinashiSeriesPointIntervalUnit PointIntervalUnit { get; set; }
		private HeikinashiSeriesPointIntervalUnit PointIntervalUnit_DefaultValue { get; set; }
		...
		/// </summary>
		public HeikinashiSeriesPointValKey PointValKey { get; set; }
		private HeikinashiSeriesPointValKey PointValKey_DefaultValue { get; set; }
		...
		/// </summary>
		public HeikinashiSeriesSonification Sonification { get; set; }
		private HeikinashiSeriesSonification Sonification_DefaultValue { get; set; }
		...
		/// 
		/// </summary>
		public HeikinashiSeriesStates States { get; set; }
		private HeikinashiSeriesStates States_DefaultValue { get; set; }
		...
		/// </summary>
		public HeikinashiSeriesTooltip Tooltip { get; set; }
		private HeikinashiSeriesTooltip Tooltip_DefaultValue { get; set; }
		...
		/// </summary>
		public List<HeikinashiSeriesZones> Zones { get; set; }
		private List<HeikinashiSeriesZones> Zones_DefaultValue { get; set; }
