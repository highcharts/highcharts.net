...
{
	public partial class HeikinashiSeriesAccessibility  : BaseObject
	{
		...
		public HeikinashiSeriesAccessibility()
		{
			...
			Point = Point_DefaultValue = new HeikinashiSeriesAccessibilityPoint();
		...
		/// </summary>
		public HeikinashiSeriesAccessibilityKeyboardNavigation KeyboardNavigation { get; set; }
		private HeikinashiSeriesAccessibilityKeyboardNavigation KeyboardNavigation_DefaultValue { get; set; }
		 

		/// <summary>
		/// Point accessibility options for a series.
		/// </summary>
		public HeikinashiSeriesAccessibilityPoint Point { get; set; }
		private HeikinashiSeriesAccessibilityPoint Point_DefaultValue { get; set; }
