...
{
	public partial class HeikinashiSeriesDataDataLabels  : BaseObject
	{
		Hashtable h = new Hashtable();

		public HeikinashiSeriesDataDataLabels()
		{
		}	
		...
		/// </summary>
		public HeikinashiSeriesDataDataLabelsAlign Align { get; set; }
		...
		/// </summary>
		public HeikinashiSeriesDataDataLabelsFilter Filter { get; set; }
		...
		/// </summary>
		public HeikinashiSeriesDataDataLabelsOverflow Overflow { get; set; }
		...
		/// </summary>
		public HeikinashiSeriesDataDataLabelsPosition Position { get; set; }
		...
		/// </summary>
		public HeikinashiSeriesDataDataLabelsTextPath TextPath { get; set; }
		...
		/// </summary>
		public HeikinashiSeriesDataDataLabelsVerticalAlign VerticalAlign { get; set; }
		...
		{
			if (Align != HeikinashiSeriesDataDataLabelsAlign.Null) h.Add("align", highstock.FirstCharacterToLower(Align.ToString()));
			...
			if (Overflow != HeikinashiSeriesDataDataLabelsOverflow.Null) h.Add("overflow", highstock.FirstCharacterToLower(Overflow.ToString()));
			if (Padding != null) h.Add("padding",Padding);
			if (Position != HeikinashiSeriesDataDataLabelsPosition.Null) h.Add("position", highstock.FirstCharacterToLower(Position.ToString()));
			...
			if (VerticalAlign != HeikinashiSeriesDataDataLabelsVerticalAlign.Null) h.Add("verticalAlign", highstock.FirstCharacterToLower(VerticalAlign.ToString()));
			if (X != null) h.Add("x",X);
			if (Y != null) h.Add("y",Y);
