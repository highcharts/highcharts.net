...
{
	public partial class HeikinashiSeriesDataDragDrop  : BaseObject
	{
		Hashtable h = new Hashtable();

		public HeikinashiSeriesDataDragDrop()
		{
			DraggableX = DraggableX_DefaultValue = null;
			DraggableY = DraggableY_DefaultValue = null;
			DragHandle = DragHandle_DefaultValue = new HeikinashiSeriesDataDragDropDragHandle();
			...
			GuideBox = GuideBox_DefaultValue = new HeikinashiSeriesDataDragDropGuideBox();
		...
		/// </summary>
		public HeikinashiSeriesDataDragDropDragHandle DragHandle { get; set; }
		private HeikinashiSeriesDataDragDropDragHandle DragHandle_DefaultValue { get; set; }
		...
		/// </summary>
		public HeikinashiSeriesDataDragDropGuideBox GuideBox { get; set; }
		private HeikinashiSeriesDataDragDropGuideBox GuideBox_DefaultValue { get; set; }
