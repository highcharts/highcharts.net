...
{
	public partial class HeikinashiSeriesLastPriceLabel  : BaseObject
	{
		Hashtable h = new Hashtable();

		public HeikinashiSeriesLastPriceLabel()
		{
			Align = Align_DefaultValue = HeikinashiSeriesLastPriceLabelAlign.Null;
		...
		/// 
		/// </summary>
		public HeikinashiSeriesLastPriceLabelAlign Align { get; set; }
		private HeikinashiSeriesLastPriceLabelAlign Align_DefaultValue { get; set; }
