...
{
	public partial class HeikinashiSeriesSonificationContextTracks  : BaseObject
	{
		Hashtable h = new Hashtable();

		public HeikinashiSeriesSonificationContextTracks()
		{
			ActiveWhen = ActiveWhen_DefaultValue = new HeikinashiSeriesSonificationContextTracksActiveWhen();
			Instrument = Instrument_DefaultValue = null;
			InstrumentString = InstrumentString_DefaultValue = "null";
			Mapping = Mapping_DefaultValue = new HeikinashiSeriesSonificationContextTracksMapping();
			MidiName = MidiName_DefaultValue = "";
			PointGrouping = PointGrouping_DefaultValue = new HeikinashiSeriesSonificationContextTracksPointGrouping();
			...
			Type = Type_DefaultValue = HeikinashiSeriesSonificationContextTracksType.Instrument;
			ValueInterval = ValueInterval_DefaultValue = null;
			ValueMapFunction = ValueMapFunction_DefaultValue = HeikinashiSeriesSonificationContextTracksValueMapFunction.Linear;
		...
		/// </summary>
		public HeikinashiSeriesSonificationContextTracksActiveWhen ActiveWhen { get; set; }
		private HeikinashiSeriesSonificationContextTracksActiveWhen ActiveWhen_DefaultValue { get; set; }
		...
		/// </summary>
		public HeikinashiSeriesSonificationContextTracksMapping Mapping { get; set; }
		private HeikinashiSeriesSonificationContextTracksMapping Mapping_DefaultValue { get; set; }
		...
		/// </summary>
		public HeikinashiSeriesSonificationContextTracksPointGrouping PointGrouping { get; set; }
		private HeikinashiSeriesSonificationContextTracksPointGrouping PointGrouping_DefaultValue { get; set; }
		...
		/// </summary>
		public HeikinashiSeriesSonificationContextTracksType Type { get; set; }
		private HeikinashiSeriesSonificationContextTracksType Type_DefaultValue { get; set; }
		...
		/// </summary>
		public HeikinashiSeriesSonificationContextTracksValueMapFunction ValueMapFunction { get; set; }
		private HeikinashiSeriesSonificationContextTracksValueMapFunction ValueMapFunction_DefaultValue { get; set; }
