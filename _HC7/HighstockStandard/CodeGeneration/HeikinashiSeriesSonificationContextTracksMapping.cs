...
{
	public partial class HeikinashiSeriesSonificationContextTracksMapping  : BaseObject
	{
		Hashtable h = new Hashtable();

		public HeikinashiSeriesSonificationContextTracksMapping()
		{
			Frequency = Frequency_DefaultValue = new HeikinashiSeriesSonificationContextTracksMappingFrequency();
			GapBetweenNotes = GapBetweenNotes_DefaultValue = new HeikinashiSeriesSonificationContextTracksMappingGapBetweenNotes();
			Highpass = Highpass_DefaultValue = new HeikinashiSeriesSonificationContextTracksMappingHighpass();
			Lowpass = Lowpass_DefaultValue = new HeikinashiSeriesSonificationContextTracksMappingLowpass();
			NoteDuration = NoteDuration_DefaultValue = new HeikinashiSeriesSonificationContextTracksMappingNoteDuration();
			Pan = Pan_DefaultValue = new HeikinashiSeriesSonificationContextTracksMappingPan();
			Pitch = Pitch_DefaultValue = new HeikinashiSeriesSonificationContextTracksMappingPitch();
			PitchString = PitchString_DefaultValue = "null";
			PitchNumber = PitchNumber_DefaultValue = null;
			PlayDelay = PlayDelay_DefaultValue = new HeikinashiSeriesSonificationContextTracksMappingPlayDelay();
			Time = Time_DefaultValue = new HeikinashiSeriesSonificationContextTracksMappingTime();
			TimeString = TimeString_DefaultValue = "null";
			TimeNumber = TimeNumber_DefaultValue = null;
			Tremolo = Tremolo_DefaultValue = new HeikinashiSeriesSonificationContextTracksMappingTremolo();
			Volume = Volume_DefaultValue = new HeikinashiSeriesSonificationContextTracksMappingVolume();
		...
		/// </summary>
		public HeikinashiSeriesSonificationContextTracksMappingFrequency Frequency { get; set; }
		private HeikinashiSeriesSonificationContextTracksMappingFrequency Frequency_DefaultValue { get; set; }
		...
		/// </summary>
		public HeikinashiSeriesSonificationContextTracksMappingGapBetweenNotes GapBetweenNotes { get; set; }
		private HeikinashiSeriesSonificationContextTracksMappingGapBetweenNotes GapBetweenNotes_DefaultValue { get; set; }
		...
		/// </summary>
		public HeikinashiSeriesSonificationContextTracksMappingHighpass Highpass { get; set; }
		private HeikinashiSeriesSonificationContextTracksMappingHighpass Highpass_DefaultValue { get; set; }
		...
		/// </summary>
		public HeikinashiSeriesSonificationContextTracksMappingLowpass Lowpass { get; set; }
		private HeikinashiSeriesSonificationContextTracksMappingLowpass Lowpass_DefaultValue { get; set; }
		...
		/// </summary>
		public HeikinashiSeriesSonificationContextTracksMappingNoteDuration NoteDuration { get; set; }
		private HeikinashiSeriesSonificationContextTracksMappingNoteDuration NoteDuration_DefaultValue { get; set; }
		...
		/// </summary>
		public HeikinashiSeriesSonificationContextTracksMappingPan Pan { get; set; }
		private HeikinashiSeriesSonificationContextTracksMappingPan Pan_DefaultValue { get; set; }
		...
		/// </summary>
		public HeikinashiSeriesSonificationContextTracksMappingPitch Pitch { get; set; }
		private HeikinashiSeriesSonificationContextTracksMappingPitch Pitch_DefaultValue { get; set; }
		...
		/// </summary>
		public HeikinashiSeriesSonificationContextTracksMappingPlayDelay PlayDelay { get; set; }
		private HeikinashiSeriesSonificationContextTracksMappingPlayDelay PlayDelay_DefaultValue { get; set; }
		...
		/// </summary>
		public HeikinashiSeriesSonificationContextTracksMappingTime Time { get; set; }
		private HeikinashiSeriesSonificationContextTracksMappingTime Time_DefaultValue { get; set; }
		...
		/// </summary>
		public HeikinashiSeriesSonificationContextTracksMappingTremolo Tremolo { get; set; }
		private HeikinashiSeriesSonificationContextTracksMappingTremolo Tremolo_DefaultValue { get; set; }
		 

		/// <summary>
		/// The volume of notes, from 0 to 1.
		/// </summary>
		public HeikinashiSeriesSonificationContextTracksMappingVolume Volume { get; set; }
		private HeikinashiSeriesSonificationContextTracksMappingVolume Volume_DefaultValue { get; set; }
