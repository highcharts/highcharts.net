...
{
	public partial class HeikinashiSeriesSonificationTracks  : BaseObject
	{
		Hashtable h = new Hashtable();

		public HeikinashiSeriesSonificationTracks()
		{
			ActiveWhen = ActiveWhen_DefaultValue = new HeikinashiSeriesSonificationTracksActiveWhen();
			Instrument = Instrument_DefaultValue = null;
			InstrumentString = InstrumentString_DefaultValue = "null";
			Mapping = Mapping_DefaultValue = new HeikinashiSeriesSonificationTracksMapping();
			MidiName = MidiName_DefaultValue = "";
			PointGrouping = PointGrouping_DefaultValue = new HeikinashiSeriesSonificationTracksPointGrouping();
			RoundToMusicalNotes = RoundToMusicalNotes_DefaultValue = true;
			ShowPlayMarker = ShowPlayMarker_DefaultValue = true;
			Type = Type_DefaultValue = HeikinashiSeriesSonificationTracksType.Instrument;
		...
		/// </summary>
		public HeikinashiSeriesSonificationTracksActiveWhen ActiveWhen { get; set; }
		private HeikinashiSeriesSonificationTracksActiveWhen ActiveWhen_DefaultValue { get; set; }
		...
		/// </summary>
		public HeikinashiSeriesSonificationTracksMapping Mapping { get; set; }
		private HeikinashiSeriesSonificationTracksMapping Mapping_DefaultValue { get; set; }
		...
		/// </summary>
		public HeikinashiSeriesSonificationTracksPointGrouping PointGrouping { get; set; }
		private HeikinashiSeriesSonificationTracksPointGrouping PointGrouping_DefaultValue { get; set; }
		...
		/// </summary>
		public HeikinashiSeriesSonificationTracksType Type { get; set; }
		private HeikinashiSeriesSonificationTracksType Type_DefaultValue { get; set; }
