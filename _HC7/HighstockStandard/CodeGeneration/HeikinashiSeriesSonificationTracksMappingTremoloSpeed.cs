...
{
	public partial class HeikinashiSeriesSonificationTracksMappingTremoloSpeed  : BaseObject
	{
		Hashtable h = new Hashtable();

		public HeikinashiSeriesSonificationTracksMappingTremoloSpeed()
		{
			MapFunction = MapFunction_DefaultValue = HeikinashiSeriesSonificationTracksMappingTremoloSpeedMapFunction.Linear;
			MapTo = MapTo_DefaultValue = "";
			Max = Max_DefaultValue = null;
			Min = Min_DefaultValue = null;
			Value = Value_DefaultValue = null;
			Within = Within_DefaultValue = HeikinashiSeriesSonificationTracksMappingTremoloSpeedWithin.Chart;
		...
		/// </summary>
		public HeikinashiSeriesSonificationTracksMappingTremoloSpeedMapFunction MapFunction { get; set; }
		private HeikinashiSeriesSonificationTracksMappingTremoloSpeedMapFunction MapFunction_DefaultValue { get; set; }
		...
		/// </summary>
		public HeikinashiSeriesSonificationTracksMappingTremoloSpeedWithin Within { get; set; }
		private HeikinashiSeriesSonificationTracksMappingTremoloSpeedWithin Within_DefaultValue { get; set; }
