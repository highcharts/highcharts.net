...
{
	public partial class HeikinashiSeriesStatesHover  : BaseObject
	{
		Hashtable h = new Hashtable();

		public HeikinashiSeriesStatesHover()
		{
			Animation = Animation_DefaultValue = new Animation() { Enabled = true };
			AnimationBool = AnimationBool_DefaultValue = null;
			Enabled = Enabled_DefaultValue = true;
			Halo = Halo_DefaultValue = new HeikinashiSeriesStatesHoverHalo();
			LineWidth = LineWidth_DefaultValue = null;
			LineWidthPlus = LineWidthPlus_DefaultValue = 1;
			Marker = Marker_DefaultValue = new HeikinashiSeriesStatesHoverMarker();
		...
		/// </summary>
		public HeikinashiSeriesStatesHoverHalo Halo { get; set; }
		private HeikinashiSeriesStatesHoverHalo Halo_DefaultValue { get; set; }
		...
		/// </summary>
		public HeikinashiSeriesStatesHoverMarker Marker { get; set; }
		private HeikinashiSeriesStatesHoverMarker Marker_DefaultValue { get; set; }
