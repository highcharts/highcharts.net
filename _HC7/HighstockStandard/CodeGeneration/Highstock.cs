...
namespace Highsoft.Web.Mvc.Stocks
{
	public partial class Highstock  : BaseObject
	{
		...
		internal override Hashtable ToHashtable(Highstock highstock)
		{
			...
			if (Boost.IsDirty(highstock)) h.Add("boost",Boost.ToHashtable(highstock));
			if (Caption.IsDirty(highstock)) h.Add("caption",Caption.ToHashtable(highstock));
			if (Chart.IsDirty(highstock)) h.Add("chart",Chart.ToHashtable(highstock));
			if (ColorAxis.IsDirty(highstock)) h.Add("colorAxis",ColorAxis.ToHashtable(highstock));
			if (Colors != Colors_DefaultValue) h.Add("colors",Colors);
			if (Credits.IsDirty(highstock)) h.Add("credits",Credits.ToHashtable(highstock));
			if (Data.IsDirty(highstock)) h.Add("data",Data.ToHashtable(highstock));
			...
			if (NoData.IsDirty(highstock)) h.Add("noData",NoData.ToHashtable(highstock));
			if (PlotOptions.IsDirty(highstock)) h.Add("plotOptions",PlotOptions.ToHashtable(highstock));
