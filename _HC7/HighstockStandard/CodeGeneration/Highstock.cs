...
namespace Highsoft.Web.Mvc.Stocks
{
	public partial class Highstock  : BaseObject
	{
		...
		internal override Hashtable ToHashtable(Highstock highstock)
		{
			...
			if (Boost != null) h.Add("boost",Boost.ToHashtable(highstock));
			if (Caption != null) h.Add("caption",Caption.ToHashtable(highstock));
			if (Chart != null) h.Add("chart",Chart.ToHashtable(highstock));
			if (ColorAxis != null) h.Add("colorAxis",ColorAxis.ToHashtable(highstock));
			if (Colors != null) h.Add("colors",Colors);
			if (Credits != null) h.Add("credits",Credits.ToHashtable(highstock));
			if (Data != null) h.Add("data",Data.ToHashtable(highstock));
			if (Defs != null) h.Add("defs",Defs.ToHashtable(highstock));
			if (Exporting != null) h.Add("exporting",Exporting.ToHashtable(highstock));
			if (Global != null) h.Add("global",Global.ToHashtable(highstock));
			if (Lang != null) h.Add("lang",Lang.ToHashtable(highstock));
			if (Legend != null) h.Add("legend",Legend.ToHashtable(highstock));
			if (Loading != null) h.Add("loading",Loading.ToHashtable(highstock));
			if (Navigation != null) h.Add("navigation",Navigation.ToHashtable(highstock));
			if (Navigator != null) h.Add("navigator",Navigator.ToHashtable(highstock));
			if (NoData != null) h.Add("noData",NoData.ToHashtable(highstock));
			if (PlotOptions != null) h.Add("plotOptions",PlotOptions.ToHashtable(highstock));
			if (RangeSelector != null) h.Add("rangeSelector",RangeSelector.ToHashtable(highstock));
			if (Responsive != null) h.Add("responsive",Responsive.ToHashtable(highstock));
			if (Scrollbar != null) h.Add("scrollbar",Scrollbar.ToHashtable(highstock));
			if (Series != null) h.Add("series", HashifyList(highstock,Series));
			if (Sonification != null) h.Add("sonification",Sonification.ToHashtable(highstock));
			if (StockTools != null) h.Add("stockTools",StockTools.ToHashtable(highstock));
			if (Subtitle != null) h.Add("subtitle",Subtitle.ToHashtable(highstock));
			if (Time != null) h.Add("time",Time.ToHashtable(highstock));
			if (Title != null) h.Add("title",Title.ToHashtable(highstock));
			if (Tooltip != null) h.Add("tooltip",Tooltip.ToHashtable(highstock));
			if (XAxis != null) h.Add("xAxis", HashifyList(highstock,XAxis));
			if (YAxis != null) h.Add("yAxis", HashifyList(highstock,YAxis));
