...
{
	public partial class HlcSeriesData  : BaseObject
	{
		Hashtable h = new Hashtable();

		public HlcSeriesData()
		{
			Accessibility = Accessibility_DefaultValue = new HlcSeriesDataAccessibility();
			...
			DragDrop = DragDrop_DefaultValue = new HlcSeriesDataDragDrop();
			Drilldown = Drilldown_DefaultValue = "";
			Events = Events_DefaultValue = new HlcSeriesDataEvents();
		...
		/// </summary>
		public HlcSeriesDataAccessibility Accessibility { get; set; }
		private HlcSeriesDataAccessibility Accessibility_DefaultValue { get; set; }
		...
		/// </summary>
		public HlcSeriesDataDragDrop DragDrop { get; set; }
		private HlcSeriesDataDragDrop DragDrop_DefaultValue { get; set; }
		...
		/// </summary>
		public HlcSeriesDataEvents Events { get; set; }
		private HlcSeriesDataEvents Events_DefaultValue { get; set; }
