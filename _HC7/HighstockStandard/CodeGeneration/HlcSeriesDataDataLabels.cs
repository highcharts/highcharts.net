...
{
	public partial class HlcSeriesDataDataLabels  : BaseObject
	{
		Hashtable h = new Hashtable();

		public HlcSeriesDataDataLabels()
		{
		}	
		...
		/// </summary>
		public HlcSeriesDataDataLabelsAlign Align { get; set; }
		...
		/// </summary>
		public HlcSeriesDataDataLabelsFilter Filter { get; set; }
		...
		/// </summary>
		public HlcSeriesDataDataLabelsOverflow Overflow { get; set; }
		...
		/// </summary>
		public HlcSeriesDataDataLabelsPosition Position { get; set; }
		...
		/// </summary>
		public HlcSeriesDataDataLabelsTextPath TextPath { get; set; }
		...
		/// </summary>
		public HlcSeriesDataDataLabelsVerticalAlign VerticalAlign { get; set; }
		...
		{
			if (Align != HlcSeriesDataDataLabelsAlign.Null) h.Add("align", highstock.FirstCharacterToLower(Align.ToString()));
			...
			if (Overflow != HlcSeriesDataDataLabelsOverflow.Null) h.Add("overflow", highstock.FirstCharacterToLower(Overflow.ToString()));
			if (Padding != null) h.Add("padding",Padding);
			if (Position != HlcSeriesDataDataLabelsPosition.Null) h.Add("position", highstock.FirstCharacterToLower(Position.ToString()));
			...
			if (VerticalAlign != HlcSeriesDataDataLabelsVerticalAlign.Null) h.Add("verticalAlign", highstock.FirstCharacterToLower(VerticalAlign.ToString()));
			if (X != null) h.Add("x",X);
			if (Y != null) h.Add("y",Y);
