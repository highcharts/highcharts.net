...
{
	public partial class HlcSeriesSonificationContextTracks  : BaseObject
	{
		Hashtable h = new Hashtable();

		public HlcSeriesSonificationContextTracks()
		{
			ActiveWhen = ActiveWhen_DefaultValue = new HlcSeriesSonificationContextTracksActiveWhen();
			Instrument = Instrument_DefaultValue = null;
			InstrumentString = InstrumentString_DefaultValue = "null";
			Mapping = Mapping_DefaultValue = new HlcSeriesSonificationContextTracksMapping();
			MidiName = MidiName_DefaultValue = "";
			PointGrouping = PointGrouping_DefaultValue = new HlcSeriesSonificationContextTracksPointGrouping();
			...
			Type = Type_DefaultValue = HlcSeriesSonificationContextTracksType.Instrument;
			ValueInterval = ValueInterval_DefaultValue = null;
			ValueMapFunction = ValueMapFunction_DefaultValue = HlcSeriesSonificationContextTracksValueMapFunction.Linear;
		...
		/// </summary>
		public HlcSeriesSonificationContextTracksActiveWhen ActiveWhen { get; set; }
		private HlcSeriesSonificationContextTracksActiveWhen ActiveWhen_DefaultValue { get; set; }
		...
		/// </summary>
		public HlcSeriesSonificationContextTracksMapping Mapping { get; set; }
		private HlcSeriesSonificationContextTracksMapping Mapping_DefaultValue { get; set; }
		...
		/// </summary>
		public HlcSeriesSonificationContextTracksPointGrouping PointGrouping { get; set; }
		private HlcSeriesSonificationContextTracksPointGrouping PointGrouping_DefaultValue { get; set; }
		...
		/// </summary>
		public HlcSeriesSonificationContextTracksType Type { get; set; }
		private HlcSeriesSonificationContextTracksType Type_DefaultValue { get; set; }
		...
		/// </summary>
		public HlcSeriesSonificationContextTracksValueMapFunction ValueMapFunction { get; set; }
		private HlcSeriesSonificationContextTracksValueMapFunction ValueMapFunction_DefaultValue { get; set; }
