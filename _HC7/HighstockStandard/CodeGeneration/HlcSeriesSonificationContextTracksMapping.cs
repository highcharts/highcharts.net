...
{
	public partial class HlcSeriesSonificationContextTracksMapping  : BaseObject
	{
		Hashtable h = new Hashtable();

		public HlcSeriesSonificationContextTracksMapping()
		{
			Frequency = Frequency_DefaultValue = new HlcSeriesSonificationContextTracksMappingFrequency();
			GapBetweenNotes = GapBetweenNotes_DefaultValue = new HlcSeriesSonificationContextTracksMappingGapBetweenNotes();
			Highpass = Highpass_DefaultValue = new HlcSeriesSonificationContextTracksMappingHighpass();
			Lowpass = Lowpass_DefaultValue = new HlcSeriesSonificationContextTracksMappingLowpass();
			NoteDuration = NoteDuration_DefaultValue = new HlcSeriesSonificationContextTracksMappingNoteDuration();
			Pan = Pan_DefaultValue = new HlcSeriesSonificationContextTracksMappingPan();
			Pitch = Pitch_DefaultValue = new HlcSeriesSonificationContextTracksMappingPitch();
			PitchString = PitchString_DefaultValue = "null";
			PitchNumber = PitchNumber_DefaultValue = null;
			PlayDelay = PlayDelay_DefaultValue = new HlcSeriesSonificationContextTracksMappingPlayDelay();
			Time = Time_DefaultValue = new HlcSeriesSonificationContextTracksMappingTime();
			TimeString = TimeString_DefaultValue = "null";
			TimeNumber = TimeNumber_DefaultValue = null;
			Tremolo = Tremolo_DefaultValue = new HlcSeriesSonificationContextTracksMappingTremolo();
			Volume = Volume_DefaultValue = new HlcSeriesSonificationContextTracksMappingVolume();
		...
		/// </summary>
		public HlcSeriesSonificationContextTracksMappingFrequency Frequency { get; set; }
		private HlcSeriesSonificationContextTracksMappingFrequency Frequency_DefaultValue { get; set; }
		...
		/// </summary>
		public HlcSeriesSonificationContextTracksMappingGapBetweenNotes GapBetweenNotes { get; set; }
		private HlcSeriesSonificationContextTracksMappingGapBetweenNotes GapBetweenNotes_DefaultValue { get; set; }
		...
		/// </summary>
		public HlcSeriesSonificationContextTracksMappingHighpass Highpass { get; set; }
		private HlcSeriesSonificationContextTracksMappingHighpass Highpass_DefaultValue { get; set; }
		...
		/// </summary>
		public HlcSeriesSonificationContextTracksMappingLowpass Lowpass { get; set; }
		private HlcSeriesSonificationContextTracksMappingLowpass Lowpass_DefaultValue { get; set; }
		...
		/// </summary>
		public HlcSeriesSonificationContextTracksMappingNoteDuration NoteDuration { get; set; }
		private HlcSeriesSonificationContextTracksMappingNoteDuration NoteDuration_DefaultValue { get; set; }
		...
		/// </summary>
		public HlcSeriesSonificationContextTracksMappingPan Pan { get; set; }
		private HlcSeriesSonificationContextTracksMappingPan Pan_DefaultValue { get; set; }
		...
		/// </summary>
		public HlcSeriesSonificationContextTracksMappingPitch Pitch { get; set; }
		private HlcSeriesSonificationContextTracksMappingPitch Pitch_DefaultValue { get; set; }
		...
		/// </summary>
		public HlcSeriesSonificationContextTracksMappingPlayDelay PlayDelay { get; set; }
		private HlcSeriesSonificationContextTracksMappingPlayDelay PlayDelay_DefaultValue { get; set; }
		...
		/// </summary>
		public HlcSeriesSonificationContextTracksMappingTime Time { get; set; }
		private HlcSeriesSonificationContextTracksMappingTime Time_DefaultValue { get; set; }
		...
		/// </summary>
		public HlcSeriesSonificationContextTracksMappingTremolo Tremolo { get; set; }
		private HlcSeriesSonificationContextTracksMappingTremolo Tremolo_DefaultValue { get; set; }
		 

		/// <summary>
		/// The volume of notes, from 0 to 1.
		/// </summary>
		public HlcSeriesSonificationContextTracksMappingVolume Volume { get; set; }
		private HlcSeriesSonificationContextTracksMappingVolume Volume_DefaultValue { get; set; }
