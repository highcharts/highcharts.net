...
{
	public partial class HlcSeriesSonificationContextTracksMappingFrequency  : BaseObject
	{
		Hashtable h = new Hashtable();

		public HlcSeriesSonificationContextTracksMappingFrequency()
		{
			MapFunction = MapFunction_DefaultValue = HlcSeriesSonificationContextTracksMappingFrequencyMapFunction.Linear;
			MapTo = MapTo_DefaultValue = "";
			Max = Max_DefaultValue = null;
			Min = Min_DefaultValue = null;
			Value = Value_DefaultValue = null;
			Within = Within_DefaultValue = HlcSeriesSonificationContextTracksMappingFrequencyWithin.Chart;
		...
		/// </summary>
		public HlcSeriesSonificationContextTracksMappingFrequencyMapFunction MapFunction { get; set; }
		private HlcSeriesSonificationContextTracksMappingFrequencyMapFunction MapFunction_DefaultValue { get; set; }
		...
		/// </summary>
		public HlcSeriesSonificationContextTracksMappingFrequencyWithin Within { get; set; }
		private HlcSeriesSonificationContextTracksMappingFrequencyWithin Within_DefaultValue { get; set; }
