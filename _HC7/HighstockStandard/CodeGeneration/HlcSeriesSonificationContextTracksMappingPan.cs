...
{
	public partial class HlcSeriesSonificationContextTracksMappingPan  : BaseObject
	{
		Hashtable h = new Hashtable();

		public HlcSeriesSonificationContextTracksMappingPan()
		{
			MapFunction = MapFunction_DefaultValue = HlcSeriesSonificationContextTracksMappingPanMapFunction.Linear;
			MapTo = MapTo_DefaultValue = "";
			Max = Max_DefaultValue = null;
			Min = Min_DefaultValue = null;
			Value = Value_DefaultValue = null;
			Within = Within_DefaultValue = HlcSeriesSonificationContextTracksMappingPanWithin.Chart;
		...
		/// </summary>
		public HlcSeriesSonificationContextTracksMappingPanMapFunction MapFunction { get; set; }
		private HlcSeriesSonificationContextTracksMappingPanMapFunction MapFunction_DefaultValue { get; set; }
		...
		/// </summary>
		public HlcSeriesSonificationContextTracksMappingPanWithin Within { get; set; }
		private HlcSeriesSonificationContextTracksMappingPanWithin Within_DefaultValue { get; set; }
