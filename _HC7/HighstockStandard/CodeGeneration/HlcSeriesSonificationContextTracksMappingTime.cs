...
{
	public partial class HlcSeriesSonificationContextTracksMappingTime  : BaseObject
	{
		Hashtable h = new Hashtable();

		public HlcSeriesSonificationContextTracksMappingTime()
		{
			MapFunction = MapFunction_DefaultValue = HlcSeriesSonificationContextTracksMappingTimeMapFunction.Linear;
			MapTo = MapTo_DefaultValue = "";
			Max = Max_DefaultValue = null;
			Min = Min_DefaultValue = null;
			Value = Value_DefaultValue = null;
			Within = Within_DefaultValue = HlcSeriesSonificationContextTracksMappingTimeWithin.Chart;
		...
		/// </summary>
		public HlcSeriesSonificationContextTracksMappingTimeMapFunction MapFunction { get; set; }
		private HlcSeriesSonificationContextTracksMappingTimeMapFunction MapFunction_DefaultValue { get; set; }
		...
		/// </summary>
		public HlcSeriesSonificationContextTracksMappingTimeWithin Within { get; set; }
		private HlcSeriesSonificationContextTracksMappingTimeWithin Within_DefaultValue { get; set; }
