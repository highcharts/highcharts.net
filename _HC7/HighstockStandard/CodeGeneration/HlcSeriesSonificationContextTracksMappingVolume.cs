...
{
	public partial class HlcSeriesSonificationContextTracksMappingVolume  : BaseObject
	{
		Hashtable h = new Hashtable();

		public HlcSeriesSonificationContextTracksMappingVolume()
		{
			MapFunction = MapFunction_DefaultValue = HlcSeriesSonificationContextTracksMappingVolumeMapFunction.Linear;
			MapTo = MapTo_DefaultValue = "";
			Max = Max_DefaultValue = null;
			Min = Min_DefaultValue = null;
			Value = Value_DefaultValue = null;
			Within = Within_DefaultValue = HlcSeriesSonificationContextTracksMappingVolumeWithin.Chart;
		...
		/// </summary>
		public HlcSeriesSonificationContextTracksMappingVolumeMapFunction MapFunction { get; set; }
		private HlcSeriesSonificationContextTracksMappingVolumeMapFunction MapFunction_DefaultValue { get; set; }
		...
		/// </summary>
		public HlcSeriesSonificationContextTracksMappingVolumeWithin Within { get; set; }
		private HlcSeriesSonificationContextTracksMappingVolumeWithin Within_DefaultValue { get; set; }
