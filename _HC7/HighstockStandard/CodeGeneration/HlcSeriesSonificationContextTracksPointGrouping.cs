...
{
	public partial class HlcSeriesSonificationContextTracksPointGrouping  : BaseObject
	{
		Hashtable h = new Hashtable();

		public HlcSeriesSonificationContextTracksPointGrouping()
		{
			Algorithm = Algorithm_DefaultValue = HlcSeriesSonificationContextTracksPointGroupingAlgorithm.Minimax;
		...
		/// </summary>
		public HlcSeriesSonificationContextTracksPointGroupingAlgorithm Algorithm { get; set; }
		private HlcSeriesSonificationContextTracksPointGroupingAlgorithm Algorithm_DefaultValue { get; set; }
