...
{
	public partial class HlcSeriesSonificationPointGrouping  : BaseObject
	{
		Hashtable h = new Hashtable();

		public HlcSeriesSonificationPointGrouping()
		{
			Algorithm = Algorithm_DefaultValue = HlcSeriesSonificationPointGroupingAlgorithm.Minimax;
		...
		/// </summary>
		public HlcSeriesSonificationPointGroupingAlgorithm Algorithm { get; set; }
		private HlcSeriesSonificationPointGroupingAlgorithm Algorithm_DefaultValue { get; set; }
