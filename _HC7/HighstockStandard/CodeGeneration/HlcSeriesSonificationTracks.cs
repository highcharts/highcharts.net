...
{
	public partial class HlcSeriesSonificationTracks  : BaseObject
	{
		Hashtable h = new Hashtable();

		public HlcSeriesSonificationTracks()
		{
			ActiveWhen = ActiveWhen_DefaultValue = new HlcSeriesSonificationTracksActiveWhen();
			Instrument = Instrument_DefaultValue = null;
			InstrumentString = InstrumentString_DefaultValue = "null";
			Mapping = Mapping_DefaultValue = new HlcSeriesSonificationTracksMapping();
			MidiName = MidiName_DefaultValue = "";
			PointGrouping = PointGrouping_DefaultValue = new HlcSeriesSonificationTracksPointGrouping();
			RoundToMusicalNotes = RoundToMusicalNotes_DefaultValue = true;
			ShowPlayMarker = ShowPlayMarker_DefaultValue = true;
			Type = Type_DefaultValue = HlcSeriesSonificationTracksType.Instrument;
		...
		/// </summary>
		public HlcSeriesSonificationTracksActiveWhen ActiveWhen { get; set; }
		private HlcSeriesSonificationTracksActiveWhen ActiveWhen_DefaultValue { get; set; }
		...
		/// </summary>
		public HlcSeriesSonificationTracksMapping Mapping { get; set; }
		private HlcSeriesSonificationTracksMapping Mapping_DefaultValue { get; set; }
		...
		/// </summary>
		public HlcSeriesSonificationTracksPointGrouping PointGrouping { get; set; }
		private HlcSeriesSonificationTracksPointGrouping PointGrouping_DefaultValue { get; set; }
		...
		/// </summary>
		public HlcSeriesSonificationTracksType Type { get; set; }
		private HlcSeriesSonificationTracksType Type_DefaultValue { get; set; }
