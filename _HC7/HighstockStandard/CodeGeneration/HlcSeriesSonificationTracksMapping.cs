...
{
	public partial class HlcSeriesSonificationTracksMapping  : BaseObject
	{
		Hashtable h = new Hashtable();

		public HlcSeriesSonificationTracksMapping()
		{
			Frequency = Frequency_DefaultValue = new HlcSeriesSonificationTracksMappingFrequency();
			GapBetweenNotes = GapBetweenNotes_DefaultValue = new HlcSeriesSonificationTracksMappingGapBetweenNotes();
			Highpass = Highpass_DefaultValue = new HlcSeriesSonificationTracksMappingHighpass();
			Lowpass = Lowpass_DefaultValue = new HlcSeriesSonificationTracksMappingLowpass();
			NoteDuration = NoteDuration_DefaultValue = new HlcSeriesSonificationTracksMappingNoteDuration();
			Pan = Pan_DefaultValue = new HlcSeriesSonificationTracksMappingPan();
			Pitch = Pitch_DefaultValue = new HlcSeriesSonificationTracksMappingPitch();
			PitchString = PitchString_DefaultValue = "null";
			PitchNumber = PitchNumber_DefaultValue = null;
			PlayDelay = PlayDelay_DefaultValue = new HlcSeriesSonificationTracksMappingPlayDelay();
			Time = Time_DefaultValue = new HlcSeriesSonificationTracksMappingTime();
			TimeString = TimeString_DefaultValue = "null";
			TimeNumber = TimeNumber_DefaultValue = null;
			Tremolo = Tremolo_DefaultValue = new HlcSeriesSonificationTracksMappingTremolo();
			Volume = Volume_DefaultValue = new HlcSeriesSonificationTracksMappingVolume();
		...
		/// </summary>
		public HlcSeriesSonificationTracksMappingFrequency Frequency { get; set; }
		private HlcSeriesSonificationTracksMappingFrequency Frequency_DefaultValue { get; set; }
		...
		/// </summary>
		public HlcSeriesSonificationTracksMappingGapBetweenNotes GapBetweenNotes { get; set; }
		private HlcSeriesSonificationTracksMappingGapBetweenNotes GapBetweenNotes_DefaultValue { get; set; }
		...
		/// </summary>
		public HlcSeriesSonificationTracksMappingHighpass Highpass { get; set; }
		private HlcSeriesSonificationTracksMappingHighpass Highpass_DefaultValue { get; set; }
		...
		/// </summary>
		public HlcSeriesSonificationTracksMappingLowpass Lowpass { get; set; }
		private HlcSeriesSonificationTracksMappingLowpass Lowpass_DefaultValue { get; set; }
		...
		/// </summary>
		public HlcSeriesSonificationTracksMappingNoteDuration NoteDuration { get; set; }
		private HlcSeriesSonificationTracksMappingNoteDuration NoteDuration_DefaultValue { get; set; }
		...
		/// </summary>
		public HlcSeriesSonificationTracksMappingPan Pan { get; set; }
		private HlcSeriesSonificationTracksMappingPan Pan_DefaultValue { get; set; }
		...
		/// </summary>
		public HlcSeriesSonificationTracksMappingPitch Pitch { get; set; }
		private HlcSeriesSonificationTracksMappingPitch Pitch_DefaultValue { get; set; }
		...
		/// </summary>
		public HlcSeriesSonificationTracksMappingPlayDelay PlayDelay { get; set; }
		private HlcSeriesSonificationTracksMappingPlayDelay PlayDelay_DefaultValue { get; set; }
		...
		/// </summary>
		public HlcSeriesSonificationTracksMappingTime Time { get; set; }
		private HlcSeriesSonificationTracksMappingTime Time_DefaultValue { get; set; }
		...
		/// </summary>
		public HlcSeriesSonificationTracksMappingTremolo Tremolo { get; set; }
		private HlcSeriesSonificationTracksMappingTremolo Tremolo_DefaultValue { get; set; }
		 

		/// <summary>
		/// The volume of notes, from 0 to 1.
		/// </summary>
		public HlcSeriesSonificationTracksMappingVolume Volume { get; set; }
		private HlcSeriesSonificationTracksMappingVolume Volume_DefaultValue { get; set; }
