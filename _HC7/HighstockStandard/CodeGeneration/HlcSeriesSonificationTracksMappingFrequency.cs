...
{
	public partial class HlcSeriesSonificationTracksMappingFrequency  : BaseObject
	{
		Hashtable h = new Hashtable();

		public HlcSeriesSonificationTracksMappingFrequency()
		{
			MapFunction = MapFunction_DefaultValue = HlcSeriesSonificationTracksMappingFrequencyMapFunction.Linear;
			MapTo = MapTo_DefaultValue = "";
			Max = Max_DefaultValue = null;
			Min = Min_DefaultValue = null;
			Value = Value_DefaultValue = null;
			Within = Within_DefaultValue = HlcSeriesSonificationTracksMappingFrequencyWithin.Chart;
		...
		/// </summary>
		public HlcSeriesSonificationTracksMappingFrequencyMapFunction MapFunction { get; set; }
		private HlcSeriesSonificationTracksMappingFrequencyMapFunction MapFunction_DefaultValue { get; set; }
		...
		/// </summary>
		public HlcSeriesSonificationTracksMappingFrequencyWithin Within { get; set; }
		private HlcSeriesSonificationTracksMappingFrequencyWithin Within_DefaultValue { get; set; }
