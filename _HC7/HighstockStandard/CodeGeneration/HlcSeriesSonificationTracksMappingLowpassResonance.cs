...
{
	public partial class HlcSeriesSonificationTracksMappingLowpassResonance  : BaseObject
	{
		Hashtable h = new Hashtable();

		public HlcSeriesSonificationTracksMappingLowpassResonance()
		{
			MapFunction = MapFunction_DefaultValue = HlcSeriesSonificationTracksMappingLowpassResonanceMapFunction.Linear;
			MapTo = MapTo_DefaultValue = "";
			Max = Max_DefaultValue = null;
			Min = Min_DefaultValue = null;
			Value = Value_DefaultValue = null;
			Within = Within_DefaultValue = HlcSeriesSonificationTracksMappingLowpassResonanceWithin.Chart;
		...
		/// </summary>
		public HlcSeriesSonificationTracksMappingLowpassResonanceMapFunction MapFunction { get; set; }
		private HlcSeriesSonificationTracksMappingLowpassResonanceMapFunction MapFunction_DefaultValue { get; set; }
		...
		/// </summary>
		public HlcSeriesSonificationTracksMappingLowpassResonanceWithin Within { get; set; }
		private HlcSeriesSonificationTracksMappingLowpassResonanceWithin Within_DefaultValue { get; set; }
