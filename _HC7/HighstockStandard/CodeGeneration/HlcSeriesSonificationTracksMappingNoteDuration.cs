...
{
	public partial class HlcSeriesSonificationTracksMappingNoteDuration  : BaseObject
	{
		Hashtable h = new Hashtable();

		public HlcSeriesSonificationTracksMappingNoteDuration()
		{
			MapFunction = MapFunction_DefaultValue = HlcSeriesSonificationTracksMappingNoteDurationMapFunction.Linear;
			MapTo = MapTo_DefaultValue = "";
			Max = Max_DefaultValue = null;
			Min = Min_DefaultValue = null;
			Value = Value_DefaultValue = null;
			Within = Within_DefaultValue = HlcSeriesSonificationTracksMappingNoteDurationWithin.Chart;
		...
		/// </summary>
		public HlcSeriesSonificationTracksMappingNoteDurationMapFunction MapFunction { get; set; }
		private HlcSeriesSonificationTracksMappingNoteDurationMapFunction MapFunction_DefaultValue { get; set; }
		...
		/// </summary>
		public HlcSeriesSonificationTracksMappingNoteDurationWithin Within { get; set; }
		private HlcSeriesSonificationTracksMappingNoteDurationWithin Within_DefaultValue { get; set; }
