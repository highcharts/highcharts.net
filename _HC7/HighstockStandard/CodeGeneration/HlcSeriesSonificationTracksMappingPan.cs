...
{
	public partial class HlcSeriesSonificationTracksMappingPan  : BaseObject
	{
		Hashtable h = new Hashtable();

		public HlcSeriesSonificationTracksMappingPan()
		{
			MapFunction = MapFunction_DefaultValue = HlcSeriesSonificationTracksMappingPanMapFunction.Linear;
			MapTo = MapTo_DefaultValue = "";
			Max = Max_DefaultValue = null;
			Min = Min_DefaultValue = null;
			Value = Value_DefaultValue = null;
			Within = Within_DefaultValue = HlcSeriesSonificationTracksMappingPanWithin.Chart;
		...
		/// </summary>
		public HlcSeriesSonificationTracksMappingPanMapFunction MapFunction { get; set; }
		private HlcSeriesSonificationTracksMappingPanMapFunction MapFunction_DefaultValue { get; set; }
		...
		/// </summary>
		public HlcSeriesSonificationTracksMappingPanWithin Within { get; set; }
		private HlcSeriesSonificationTracksMappingPanWithin Within_DefaultValue { get; set; }
