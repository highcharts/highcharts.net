...
{
	public partial class HlcSeriesSonificationTracksMappingPitch  : BaseObject
	{
		Hashtable h = new Hashtable();

		public HlcSeriesSonificationTracksMappingPitch()
		{
			MapFunction = MapFunction_DefaultValue = HlcSeriesSonificationTracksMappingPitchMapFunction.Linear;
		...
		/// </summary>
		public HlcSeriesSonificationTracksMappingPitchMapFunction MapFunction { get; set; }
		private HlcSeriesSonificationTracksMappingPitchMapFunction MapFunction_DefaultValue { get; set; }
