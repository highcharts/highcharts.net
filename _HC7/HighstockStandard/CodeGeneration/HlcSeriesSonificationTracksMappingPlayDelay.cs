...
{
	public partial class HlcSeriesSonificationTracksMappingPlayDelay  : BaseObject
	{
		Hashtable h = new Hashtable();

		public HlcSeriesSonificationTracksMappingPlayDelay()
		{
			MapFunction = MapFunction_DefaultValue = HlcSeriesSonificationTracksMappingPlayDelayMapFunction.Linear;
			MapTo = MapTo_DefaultValue = "";
			Max = Max_DefaultValue = null;
			Min = Min_DefaultValue = null;
			Value = Value_DefaultValue = null;
			Within = Within_DefaultValue = HlcSeriesSonificationTracksMappingPlayDelayWithin.Chart;
		...
		/// </summary>
		public HlcSeriesSonificationTracksMappingPlayDelayMapFunction MapFunction { get; set; }
		private HlcSeriesSonificationTracksMappingPlayDelayMapFunction MapFunction_DefaultValue { get; set; }
		...
		/// </summary>
		public HlcSeriesSonificationTracksMappingPlayDelayWithin Within { get; set; }
		private HlcSeriesSonificationTracksMappingPlayDelayWithin Within_DefaultValue { get; set; }
