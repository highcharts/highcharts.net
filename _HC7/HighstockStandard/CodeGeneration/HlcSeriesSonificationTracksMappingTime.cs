...
{
	public partial class HlcSeriesSonificationTracksMappingTime  : BaseObject
	{
		Hashtable h = new Hashtable();

		public HlcSeriesSonificationTracksMappingTime()
		{
			MapFunction = MapFunction_DefaultValue = HlcSeriesSonificationTracksMappingTimeMapFunction.Linear;
			MapTo = MapTo_DefaultValue = "";
			Max = Max_DefaultValue = null;
			Min = Min_DefaultValue = null;
			Value = Value_DefaultValue = null;
			Within = Within_DefaultValue = HlcSeriesSonificationTracksMappingTimeWithin.Chart;
		...
		/// </summary>
		public HlcSeriesSonificationTracksMappingTimeMapFunction MapFunction { get; set; }
		private HlcSeriesSonificationTracksMappingTimeMapFunction MapFunction_DefaultValue { get; set; }
		...
		/// </summary>
		public HlcSeriesSonificationTracksMappingTimeWithin Within { get; set; }
		private HlcSeriesSonificationTracksMappingTimeWithin Within_DefaultValue { get; set; }
