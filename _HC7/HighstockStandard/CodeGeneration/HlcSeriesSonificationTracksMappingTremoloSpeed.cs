...
{
	public partial class HlcSeriesSonificationTracksMappingTremoloSpeed  : BaseObject
	{
		Hashtable h = new Hashtable();

		public HlcSeriesSonificationTracksMappingTremoloSpeed()
		{
			MapFunction = MapFunction_DefaultValue = HlcSeriesSonificationTracksMappingTremoloSpeedMapFunction.Linear;
			MapTo = MapTo_DefaultValue = "";
			Max = Max_DefaultValue = null;
			Min = Min_DefaultValue = null;
			Value = Value_DefaultValue = null;
			Within = Within_DefaultValue = HlcSeriesSonificationTracksMappingTremoloSpeedWithin.Chart;
		...
		/// </summary>
		public HlcSeriesSonificationTracksMappingTremoloSpeedMapFunction MapFunction { get; set; }
		private HlcSeriesSonificationTracksMappingTremoloSpeedMapFunction MapFunction_DefaultValue { get; set; }
		...
		/// </summary>
		public HlcSeriesSonificationTracksMappingTremoloSpeedWithin Within { get; set; }
		private HlcSeriesSonificationTracksMappingTremoloSpeedWithin Within_DefaultValue { get; set; }
