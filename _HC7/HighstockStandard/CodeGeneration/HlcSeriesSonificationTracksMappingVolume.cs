...
{
	public partial class HlcSeriesSonificationTracksMappingVolume  : BaseObject
	{
		Hashtable h = new Hashtable();

		public HlcSeriesSonificationTracksMappingVolume()
		{
			MapFunction = MapFunction_DefaultValue = HlcSeriesSonificationTracksMappingVolumeMapFunction.Linear;
			MapTo = MapTo_DefaultValue = "";
			Max = Max_DefaultValue = null;
			Min = Min_DefaultValue = null;
			Value = Value_DefaultValue = null;
			Within = Within_DefaultValue = HlcSeriesSonificationTracksMappingVolumeWithin.Chart;
		...
		/// </summary>
		public HlcSeriesSonificationTracksMappingVolumeMapFunction MapFunction { get; set; }
		private HlcSeriesSonificationTracksMappingVolumeMapFunction MapFunction_DefaultValue { get; set; }
		...
		/// </summary>
		public HlcSeriesSonificationTracksMappingVolumeWithin Within { get; set; }
		private HlcSeriesSonificationTracksMappingVolumeWithin Within_DefaultValue { get; set; }
