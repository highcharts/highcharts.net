...
{
	public partial class HollowcandlestickSeries  : Series
	{
		Hashtable h = new Hashtable();

		public HollowcandlestickSeries()
		{
			Accessibility = Accessibility_DefaultValue = new HollowcandlestickSeriesAccessibility();
			AllowPointSelect = AllowPointSelect_DefaultValue = false;
			Animation = Animation_DefaultValue = new Animation() { Enabled = true };
			AnimationBool = AnimationBool_DefaultValue = true;
			AnimationLimit = AnimationLimit_DefaultValue = null;
			BoostBlending = BoostBlending_DefaultValue = HollowcandlestickSeriesBoostBlending.Undefined;
			...
			Compare = Compare_DefaultValue = HollowcandlestickSeriesCompare.Percent;
			CompareBase = CompareBase_DefaultValue = HollowcandlestickSeriesCompareBase.Min;
			CompareStart = CompareStart_DefaultValue = false;
			CropThreshold = CropThreshold_DefaultValue = 300;
			Cumulative = Cumulative_DefaultValue = false;
			CumulativeStart = CumulativeStart_DefaultValue = false;
			Cursor = Cursor_DefaultValue = HollowcandlestickSeriesCursor.Null;
			Custom = Custom_DefaultValue = new Hashtable();
			DashStyle = DashStyle_DefaultValue = HollowcandlestickSeriesDashStyle.Null;
			Data = Data_DefaultValue = new List<HollowcandlestickSeriesData>();
			DataGrouping = DataGrouping_DefaultValue = new HollowcandlestickSeriesDataGrouping();
			DataLabels = DataLabels_DefaultValue = new HollowcandlestickSeriesDataLabels();
			DataSorting = DataSorting_DefaultValue = new HollowcandlestickSeriesDataSorting();
			Depth = Depth_DefaultValue = 25;
			Description = Description_DefaultValue = "";
			DragDrop = DragDrop_DefaultValue = new HollowcandlestickSeriesDragDrop();
			Dumbell = Dumbell_DefaultValue = new HollowcandlestickSeriesDumbell();
			EdgeColor = EdgeColor_DefaultValue = "";
			EdgeWidth = EdgeWidth_DefaultValue = 1;
			EnableMouseTracking = EnableMouseTracking_DefaultValue = true;
			Events = Events_DefaultValue = new HollowcandlestickSeriesEvents();
			FindNearestPointBy = FindNearestPointBy_DefaultValue = HollowcandlestickSeriesFindNearestPointBy.X;
			...
			Label = Label_DefaultValue = new HollowcandlestickSeriesLabel();
			LastPrice = LastPrice_DefaultValue = new HollowcandlestickSeriesLastPrice();
			LastVisiblePrice = LastVisiblePrice_DefaultValue = new HollowcandlestickSeriesLastVisiblePrice();
			LegendIndex = LegendIndex_DefaultValue = null;
			LegendSymbol = LegendSymbol_DefaultValue = HollowcandlestickSeriesLegendSymbol.Rectangle;
			...
			OnPoint = OnPoint_DefaultValue = new HollowcandlestickSeriesOnPoint();
			Opacity = Opacity_DefaultValue = 1;
			Point = Point_DefaultValue = new HollowcandlestickSeriesPoint();
			PointDescriptionFormat = PointDescriptionFormat_DefaultValue = "";
			PointDescriptionFormatter = PointDescriptionFormatter_DefaultValue = "";
			PointInterval = PointInterval_DefaultValue = 1;
			PointIntervalUnit = PointIntervalUnit_DefaultValue = HollowcandlestickSeriesPointIntervalUnit.Null;
			PointPadding = PointPadding_DefaultValue = null;
			PointPlacement = PointPlacement_DefaultValue = new PointPlacement();
			PointRange = PointRange_DefaultValue = 0;
			PointStart = PointStart_DefaultValue = 0;
			PointValKey = PointValKey_DefaultValue = HollowcandlestickSeriesPointValKey.Close;
			...
			Sonification = Sonification_DefaultValue = new HollowcandlestickSeriesSonification();
			Stack = Stack_DefaultValue = "";
			StackNumber = StackNumber_DefaultValue = null;
			States = States_DefaultValue = new HollowcandlestickSeriesStates();
			StickyTracking = StickyTracking_DefaultValue = true;
			Threshold = Threshold_DefaultValue = 0;
			Tooltip = Tooltip_DefaultValue = new HollowcandlestickSeriesTooltip();
			TurboThreshold = TurboThreshold_DefaultValue = 1000;
			UpColor = UpColor_DefaultValue = "";
			UpLineColor = UpLineColor_DefaultValue = "";
			...
			Zones = Zones_DefaultValue = new List<HollowcandlestickSeriesZones>();
		...
		/// </summary>
		public HollowcandlestickSeriesAccessibility Accessibility { get; set; }
		private HollowcandlestickSeriesAccessibility Accessibility_DefaultValue { get; set; }
		...
		/// </summary>
		public HollowcandlestickSeriesBoostBlending BoostBlending { get; set; }
		private HollowcandlestickSeriesBoostBlending BoostBlending_DefaultValue { get; set; }
		...
		/// </summary>
		public HollowcandlestickSeriesCompare Compare { get; set; }
		private HollowcandlestickSeriesCompare Compare_DefaultValue { get; set; }
		 

		/// <summary>
		/// When [compare](#plotOptions.series.compare) is `percent`, this optiondictates whether to use 0 or 100 as the base of comparison.
		/// </summary>
		public HollowcandlestickSeriesCompareBase CompareBase { get; set; }
		private HollowcandlestickSeriesCompareBase CompareBase_DefaultValue { get; set; }
		...
		/// </summary>
		public HollowcandlestickSeriesCursor Cursor { get; set; }
		private HollowcandlestickSeriesCursor Cursor_DefaultValue { get; set; }
		...
		/// </summary>
		public HollowcandlestickSeriesDataGrouping DataGrouping { get; set; }
		private HollowcandlestickSeriesDataGrouping DataGrouping_DefaultValue { get; set; }
		...
		/// </summary>
		public HollowcandlestickSeriesDataLabels DataLabels { get; set; }
		private HollowcandlestickSeriesDataLabels DataLabels_DefaultValue { get; set; }
		 

		/// <summary>
		/// Options for the series data sorting.
		/// </summary>
		public HollowcandlestickSeriesDataSorting DataSorting { get; set; }
		private HollowcandlestickSeriesDataSorting DataSorting_DefaultValue { get; set; }
		...
		/// </summary>
		public HollowcandlestickSeriesDragDrop DragDrop { get; set; }
		private HollowcandlestickSeriesDragDrop DragDrop_DefaultValue { get; set; }
		 

		/// <summary>
		/// 
		/// </summary>
		public HollowcandlestickSeriesDumbell Dumbell { get; set; }
		private HollowcandlestickSeriesDumbell Dumbell_DefaultValue { get; set; }
		...
		/// </summary>
		public HollowcandlestickSeriesEvents Events { get; set; }
		private HollowcandlestickSeriesEvents Events_DefaultValue { get; set; }
		...
		/// </summary>
		public HollowcandlestickSeriesFindNearestPointBy FindNearestPointBy { get; set; }
		private HollowcandlestickSeriesFindNearestPointBy FindNearestPointBy_DefaultValue { get; set; }
		...
		/// </summary>
		public HollowcandlestickSeriesLabel Label { get; set; }
		private HollowcandlestickSeriesLabel Label_DefaultValue { get; set; }
		 

		/// <summary>
		/// The line marks the last price from all points.
		/// </summary>
		public HollowcandlestickSeriesLastPrice LastPrice { get; set; }
		private HollowcandlestickSeriesLastPrice LastPrice_DefaultValue { get; set; }
		 

		/// <summary>
		/// The line marks the last price from visible range of points.
		/// </summary>
		public HollowcandlestickSeriesLastVisiblePrice LastVisiblePrice { get; set; }
		private HollowcandlestickSeriesLastVisiblePrice LastVisiblePrice_DefaultValue { get; set; }
		...
		/// </summary>
		public HollowcandlestickSeriesLegendSymbol LegendSymbol { get; set; }
		private HollowcandlestickSeriesLegendSymbol LegendSymbol_DefaultValue { get; set; }
		...
		/// </summary>
		public HollowcandlestickSeriesOnPoint OnPoint { get; set; }
		private HollowcandlestickSeriesOnPoint OnPoint_DefaultValue { get; set; }
		...
		/// </summary>
		public HollowcandlestickSeriesPoint Point { get; set; }
		private HollowcandlestickSeriesPoint Point_DefaultValue { get; set; }
		...
		/// </summary>
		public HollowcandlestickSeriesPointIntervalUnit PointIntervalUnit { get; set; }
		private HollowcandlestickSeriesPointIntervalUnit PointIntervalUnit_DefaultValue { get; set; }
		...
		/// </summary>
		public HollowcandlestickSeriesPointValKey PointValKey { get; set; }
		private HollowcandlestickSeriesPointValKey PointValKey_DefaultValue { get; set; }
		...
		/// </summary>
		public HollowcandlestickSeriesSonification Sonification { get; set; }
		private HollowcandlestickSeriesSonification Sonification_DefaultValue { get; set; }
		...
		/// 
		/// </summary>
		public HollowcandlestickSeriesStates States { get; set; }
		private HollowcandlestickSeriesStates States_DefaultValue { get; set; }
		...
		/// </summary>
		public HollowcandlestickSeriesTooltip Tooltip { get; set; }
		private HollowcandlestickSeriesTooltip Tooltip_DefaultValue { get; set; }
		...
		/// <summary>
		/// The specific line color for up candle sticks. The default is toinherit the general `lineColor` setting.
		/// </summary>
		...
		/// </summary>
		public List<HollowcandlestickSeriesZones> Zones { get; set; }
		private List<HollowcandlestickSeriesZones> Zones_DefaultValue { get; set; }
