...
namespace Highsoft.Web.Mvc.Stocks
{
	public partial class HollowcandlestickSeries  : Series
	{
		...
		public HollowcandlestickSeries()
		{
			...
			Zones = Zones_DefaultValue = new List<HollowcandlestickSeriesZone>();
		...
		/// </summary>
		public List<HollowcandlestickSeriesZone> Zones { get; set; }
		private List<HollowcandlestickSeriesZone> Zones_DefaultValue { get; set; }
