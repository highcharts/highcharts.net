...
{
	public partial class HollowcandlestickSeriesDataDataLabels  : BaseObject
	{
		Hashtable h = new Hashtable();

		public HollowcandlestickSeriesDataDataLabels()
		{
		}	
		...
		/// </summary>
		public HollowcandlestickSeriesDataDataLabelsAlign Align { get; set; }
		...
		/// </summary>
		public HollowcandlestickSeriesDataDataLabelsFilter Filter { get; set; }
		...
		/// </summary>
		public HollowcandlestickSeriesDataDataLabelsOverflow Overflow { get; set; }
		...
		/// </summary>
		public HollowcandlestickSeriesDataDataLabelsPosition Position { get; set; }
		...
		/// </summary>
		public HollowcandlestickSeriesDataDataLabelsTextPath TextPath { get; set; }
		...
		/// </summary>
		public HollowcandlestickSeriesDataDataLabelsVerticalAlign VerticalAlign { get; set; }
		...
		{
			if (Align != HollowcandlestickSeriesDataDataLabelsAlign.Null) h.Add("align", highstock.FirstCharacterToLower(Align.ToString()));
			...
			if (Overflow != HollowcandlestickSeriesDataDataLabelsOverflow.Null) h.Add("overflow", highstock.FirstCharacterToLower(Overflow.ToString()));
			if (Padding != null) h.Add("padding",Padding);
			if (Position != HollowcandlestickSeriesDataDataLabelsPosition.Null) h.Add("position", highstock.FirstCharacterToLower(Position.ToString()));
			...
			if (VerticalAlign != HollowcandlestickSeriesDataDataLabelsVerticalAlign.Null) h.Add("verticalAlign", highstock.FirstCharacterToLower(VerticalAlign.ToString()));
			if (X != null) h.Add("x",X);
			if (Y != null) h.Add("y",Y);
