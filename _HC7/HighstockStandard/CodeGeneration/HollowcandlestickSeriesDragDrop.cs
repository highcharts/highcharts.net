...
{
	public partial class HollowcandlestickSeriesDragDrop  : BaseObject
	{
		Hashtable h = new Hashtable();

		public HollowcandlestickSeriesDragDrop()
		{
			DraggableX = DraggableX_DefaultValue = null;
			DraggableY = DraggableY_DefaultValue = null;
			DragHandle = DragHandle_DefaultValue = new HollowcandlestickSeriesDragDropDragHandle();
			...
			GuideBox = GuideBox_DefaultValue = new HollowcandlestickSeriesDragDropGuideBox();
		...
		/// </summary>
		public HollowcandlestickSeriesDragDropDragHandle DragHandle { get; set; }
		private HollowcandlestickSeriesDragDropDragHandle DragHandle_DefaultValue { get; set; }
		...
		/// </summary>
		public HollowcandlestickSeriesDragDropGuideBox GuideBox { get; set; }
		private HollowcandlestickSeriesDragDropGuideBox GuideBox_DefaultValue { get; set; }
