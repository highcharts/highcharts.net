...
{
	public partial class HollowcandlestickSeriesSonificationContextTracks  : BaseObject
	{
		Hashtable h = new Hashtable();

		public HollowcandlestickSeriesSonificationContextTracks()
		{
			ActiveWhen = ActiveWhen_DefaultValue = new HollowcandlestickSeriesSonificationContextTracksActiveWhen();
			Instrument = Instrument_DefaultValue = null;
			InstrumentString = InstrumentString_DefaultValue = "null";
			Mapping = Mapping_DefaultValue = new HollowcandlestickSeriesSonificationContextTracksMapping();
			MidiName = MidiName_DefaultValue = "";
			PointGrouping = PointGrouping_DefaultValue = new HollowcandlestickSeriesSonificationContextTracksPointGrouping();
			...
			Type = Type_DefaultValue = HollowcandlestickSeriesSonificationContextTracksType.Instrument;
			ValueInterval = ValueInterval_DefaultValue = null;
			ValueMapFunction = ValueMapFunction_DefaultValue = HollowcandlestickSeriesSonificationContextTracksValueMapFunction.Linear;
		...
		/// </summary>
		public HollowcandlestickSeriesSonificationContextTracksActiveWhen ActiveWhen { get; set; }
		private HollowcandlestickSeriesSonificationContextTracksActiveWhen ActiveWhen_DefaultValue { get; set; }
		...
		/// </summary>
		public HollowcandlestickSeriesSonificationContextTracksMapping Mapping { get; set; }
		private HollowcandlestickSeriesSonificationContextTracksMapping Mapping_DefaultValue { get; set; }
		...
		/// </summary>
		public HollowcandlestickSeriesSonificationContextTracksPointGrouping PointGrouping { get; set; }
		private HollowcandlestickSeriesSonificationContextTracksPointGrouping PointGrouping_DefaultValue { get; set; }
		...
		/// </summary>
		public HollowcandlestickSeriesSonificationContextTracksType Type { get; set; }
		private HollowcandlestickSeriesSonificationContextTracksType Type_DefaultValue { get; set; }
		...
		/// </summary>
		public HollowcandlestickSeriesSonificationContextTracksValueMapFunction ValueMapFunction { get; set; }
		private HollowcandlestickSeriesSonificationContextTracksValueMapFunction ValueMapFunction_DefaultValue { get; set; }
