...
{
	public partial class HollowcandlestickSeriesSonificationContextTracksActiveWhen  : BaseObject
	{
		Hashtable h = new Hashtable();

		public HollowcandlestickSeriesSonificationContextTracksActiveWhen()
		{
		}	
