...
{
	public partial class HollowcandlestickSeriesSonificationContextTracksMapping  : BaseObject
	{
		Hashtable h = new Hashtable();

		public HollowcandlestickSeriesSonificationContextTracksMapping()
		{
			Frequency = Frequency_DefaultValue = new HollowcandlestickSeriesSonificationContextTracksMappingFrequency();
			GapBetweenNotes = GapBetweenNotes_DefaultValue = new HollowcandlestickSeriesSonificationContextTracksMappingGapBetweenNotes();
			Highpass = Highpass_DefaultValue = new HollowcandlestickSeriesSonificationContextTracksMappingHighpass();
			Lowpass = Lowpass_DefaultValue = new HollowcandlestickSeriesSonificationContextTracksMappingLowpass();
			NoteDuration = NoteDuration_DefaultValue = new HollowcandlestickSeriesSonificationContextTracksMappingNoteDuration();
			Pan = Pan_DefaultValue = new HollowcandlestickSeriesSonificationContextTracksMappingPan();
			Pitch = Pitch_DefaultValue = new HollowcandlestickSeriesSonificationContextTracksMappingPitch();
			PitchString = PitchString_DefaultValue = "null";
			PitchNumber = PitchNumber_DefaultValue = null;
			PlayDelay = PlayDelay_DefaultValue = new HollowcandlestickSeriesSonificationContextTracksMappingPlayDelay();
			Time = Time_DefaultValue = new HollowcandlestickSeriesSonificationContextTracksMappingTime();
			TimeString = TimeString_DefaultValue = "null";
			TimeNumber = TimeNumber_DefaultValue = null;
			Tremolo = Tremolo_DefaultValue = new HollowcandlestickSeriesSonificationContextTracksMappingTremolo();
			Volume = Volume_DefaultValue = new HollowcandlestickSeriesSonificationContextTracksMappingVolume();
		...
		/// </summary>
		public HollowcandlestickSeriesSonificationContextTracksMappingFrequency Frequency { get; set; }
		private HollowcandlestickSeriesSonificationContextTracksMappingFrequency Frequency_DefaultValue { get; set; }
		...
		/// </summary>
		public HollowcandlestickSeriesSonificationContextTracksMappingGapBetweenNotes GapBetweenNotes { get; set; }
		private HollowcandlestickSeriesSonificationContextTracksMappingGapBetweenNotes GapBetweenNotes_DefaultValue { get; set; }
		...
		/// </summary>
		public HollowcandlestickSeriesSonificationContextTracksMappingHighpass Highpass { get; set; }
		private HollowcandlestickSeriesSonificationContextTracksMappingHighpass Highpass_DefaultValue { get; set; }
		...
		/// </summary>
		public HollowcandlestickSeriesSonificationContextTracksMappingLowpass Lowpass { get; set; }
		private HollowcandlestickSeriesSonificationContextTracksMappingLowpass Lowpass_DefaultValue { get; set; }
		...
		/// </summary>
		public HollowcandlestickSeriesSonificationContextTracksMappingNoteDuration NoteDuration { get; set; }
		private HollowcandlestickSeriesSonificationContextTracksMappingNoteDuration NoteDuration_DefaultValue { get; set; }
		...
		/// </summary>
		public HollowcandlestickSeriesSonificationContextTracksMappingPan Pan { get; set; }
		private HollowcandlestickSeriesSonificationContextTracksMappingPan Pan_DefaultValue { get; set; }
		...
		/// </summary>
		public HollowcandlestickSeriesSonificationContextTracksMappingPitch Pitch { get; set; }
		private HollowcandlestickSeriesSonificationContextTracksMappingPitch Pitch_DefaultValue { get; set; }
		...
		/// </summary>
		public HollowcandlestickSeriesSonificationContextTracksMappingPlayDelay PlayDelay { get; set; }
		private HollowcandlestickSeriesSonificationContextTracksMappingPlayDelay PlayDelay_DefaultValue { get; set; }
		...
		/// </summary>
		public HollowcandlestickSeriesSonificationContextTracksMappingTime Time { get; set; }
		private HollowcandlestickSeriesSonificationContextTracksMappingTime Time_DefaultValue { get; set; }
		...
		/// </summary>
		public HollowcandlestickSeriesSonificationContextTracksMappingTremolo Tremolo { get; set; }
		private HollowcandlestickSeriesSonificationContextTracksMappingTremolo Tremolo_DefaultValue { get; set; }
		 

		/// <summary>
		/// The volume of notes, from 0 to 1.
		/// </summary>
		public HollowcandlestickSeriesSonificationContextTracksMappingVolume Volume { get; set; }
		private HollowcandlestickSeriesSonificationContextTracksMappingVolume Volume_DefaultValue { get; set; }
