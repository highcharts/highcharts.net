...
{
	public partial class HollowcandlestickSeriesSonificationContextTracksMappingVolume  : BaseObject
	{
		Hashtable h = new Hashtable();

		public HollowcandlestickSeriesSonificationContextTracksMappingVolume()
		{
			MapFunction = MapFunction_DefaultValue = HollowcandlestickSeriesSonificationContextTracksMappingVolumeMapFunction.Linear;
			MapTo = MapTo_DefaultValue = "";
			Max = Max_DefaultValue = null;
			Min = Min_DefaultValue = null;
			Value = Value_DefaultValue = null;
			Within = Within_DefaultValue = HollowcandlestickSeriesSonificationContextTracksMappingVolumeWithin.Chart;
		...
		/// </summary>
		public HollowcandlestickSeriesSonificationContextTracksMappingVolumeMapFunction MapFunction { get; set; }
		private HollowcandlestickSeriesSonificationContextTracksMappingVolumeMapFunction MapFunction_DefaultValue { get; set; }
		...
		/// </summary>
		public HollowcandlestickSeriesSonificationContextTracksMappingVolumeWithin Within { get; set; }
		private HollowcandlestickSeriesSonificationContextTracksMappingVolumeWithin Within_DefaultValue { get; set; }
