...
{
	public partial class HollowcandlestickSeriesSonificationContextTracksPointGrouping  : BaseObject
	{
		Hashtable h = new Hashtable();

		public HollowcandlestickSeriesSonificationContextTracksPointGrouping()
		{
			Algorithm = Algorithm_DefaultValue = HollowcandlestickSeriesSonificationContextTracksPointGroupingAlgorithm.Minimax;
		...
		/// </summary>
		public HollowcandlestickSeriesSonificationContextTracksPointGroupingAlgorithm Algorithm { get; set; }
		private HollowcandlestickSeriesSonificationContextTracksPointGroupingAlgorithm Algorithm_DefaultValue { get; set; }
