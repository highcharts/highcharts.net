...
{
	public partial class HollowcandlestickSeriesSonificationDefaultInstrumentOptionsMappingTime  : BaseObject
	{
		Hashtable h = new Hashtable();

		public HollowcandlestickSeriesSonificationDefaultInstrumentOptionsMappingTime()
		{
			MapFunction = MapFunction_DefaultValue = HollowcandlestickSeriesSonificationDefaultInstrumentOptionsMappingTimeMapFunction.Linear;
			MapTo = MapTo_DefaultValue = "";
			Max = Max_DefaultValue = null;
			Min = Min_DefaultValue = null;
			Value = Value_DefaultValue = null;
			Within = Within_DefaultValue = HollowcandlestickSeriesSonificationDefaultInstrumentOptionsMappingTimeWithin.Chart;
		...
		/// </summary>
		public HollowcandlestickSeriesSonificationDefaultInstrumentOptionsMappingTimeMapFunction MapFunction { get; set; }
		private HollowcandlestickSeriesSonificationDefaultInstrumentOptionsMappingTimeMapFunction MapFunction_DefaultValue { get; set; }
		...
		/// </summary>
		public HollowcandlestickSeriesSonificationDefaultInstrumentOptionsMappingTimeWithin Within { get; set; }
		private HollowcandlestickSeriesSonificationDefaultInstrumentOptionsMappingTimeWithin Within_DefaultValue { get; set; }
