...
{
	public partial class HollowcandlestickSeriesSonificationDefaultSpeechOptions  : BaseObject
	{
		Hashtable h = new Hashtable();

		public HollowcandlestickSeriesSonificationDefaultSpeechOptions()
		{
			ActiveWhen = ActiveWhen_DefaultValue = new HollowcandlestickSeriesSonificationDefaultSpeechOptionsActiveWhen();
			Language = Language_DefaultValue = "en-US";
			Mapping = Mapping_DefaultValue = new HollowcandlestickSeriesSonificationDefaultSpeechOptionsMapping();
			PointGrouping = PointGrouping_DefaultValue = new HollowcandlestickSeriesSonificationDefaultSpeechOptionsPointGrouping();
			PreferredVoice = PreferredVoice_DefaultValue = "";
			ShowPlayMarker = ShowPlayMarker_DefaultValue = true;
			Type = Type_DefaultValue = HollowcandlestickSeriesSonificationDefaultSpeechOptionsType.Instrument;
		...
		/// </summary>
		public HollowcandlestickSeriesSonificationDefaultSpeechOptionsActiveWhen ActiveWhen { get; set; }
		private HollowcandlestickSeriesSonificationDefaultSpeechOptionsActiveWhen ActiveWhen_DefaultValue { get; set; }
		...
		/// </summary>
		public HollowcandlestickSeriesSonificationDefaultSpeechOptionsMapping Mapping { get; set; }
		private HollowcandlestickSeriesSonificationDefaultSpeechOptionsMapping Mapping_DefaultValue { get; set; }
		 

		/// <summary>
		/// Options for point grouping, specifically for instrument tracks.
		/// </summary>
		public HollowcandlestickSeriesSonificationDefaultSpeechOptionsPointGrouping PointGrouping { get; set; }
		private HollowcandlestickSeriesSonificationDefaultSpeechOptionsPointGrouping PointGrouping_DefaultValue { get; set; }
		...
		/// </summary>
		public HollowcandlestickSeriesSonificationDefaultSpeechOptionsType Type { get; set; }
		private HollowcandlestickSeriesSonificationDefaultSpeechOptionsType Type_DefaultValue { get; set; }
