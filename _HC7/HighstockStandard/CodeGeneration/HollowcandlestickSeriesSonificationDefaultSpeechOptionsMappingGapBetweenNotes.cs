...
{
	public partial class HollowcandlestickSeriesSonificationDefaultSpeechOptionsMappingGapBetweenNotes  : BaseObject
	{
		Hashtable h = new Hashtable();

		public HollowcandlestickSeriesSonificationDefaultSpeechOptionsMappingGapBetweenNotes()
		{
			MapFunction = MapFunction_DefaultValue = HollowcandlestickSeriesSonificationDefaultSpeechOptionsMappingGapBetweenNotesMapFunction.Linear;
			MapTo = MapTo_DefaultValue = "";
			Max = Max_DefaultValue = null;
			Min = Min_DefaultValue = null;
			Value = Value_DefaultValue = null;
			Within = Within_DefaultValue = HollowcandlestickSeriesSonificationDefaultSpeechOptionsMappingGapBetweenNotesWithin.Chart;
		...
		/// </summary>
		public HollowcandlestickSeriesSonificationDefaultSpeechOptionsMappingGapBetweenNotesMapFunction MapFunction { get; set; }
		private HollowcandlestickSeriesSonificationDefaultSpeechOptionsMappingGapBetweenNotesMapFunction MapFunction_DefaultValue { get; set; }
		...
		/// </summary>
		public HollowcandlestickSeriesSonificationDefaultSpeechOptionsMappingGapBetweenNotesWithin Within { get; set; }
		private HollowcandlestickSeriesSonificationDefaultSpeechOptionsMappingGapBetweenNotesWithin Within_DefaultValue { get; set; }
