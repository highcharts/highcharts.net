...
{
	public partial class HollowcandlestickSeriesSonificationPointGrouping  : BaseObject
	{
		Hashtable h = new Hashtable();

		public HollowcandlestickSeriesSonificationPointGrouping()
		{
			Algorithm = Algorithm_DefaultValue = HollowcandlestickSeriesSonificationPointGroupingAlgorithm.Minimax;
		...
		/// </summary>
		public HollowcandlestickSeriesSonificationPointGroupingAlgorithm Algorithm { get; set; }
		private HollowcandlestickSeriesSonificationPointGroupingAlgorithm Algorithm_DefaultValue { get; set; }
