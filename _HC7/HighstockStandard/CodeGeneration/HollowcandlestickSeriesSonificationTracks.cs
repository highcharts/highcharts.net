...
{
	public partial class HollowcandlestickSeriesSonificationTracks  : BaseObject
	{
		Hashtable h = new Hashtable();

		public HollowcandlestickSeriesSonificationTracks()
		{
			ActiveWhen = ActiveWhen_DefaultValue = new HollowcandlestickSeriesSonificationTracksActiveWhen();
			Instrument = Instrument_DefaultValue = null;
			InstrumentString = InstrumentString_DefaultValue = "null";
			Mapping = Mapping_DefaultValue = new HollowcandlestickSeriesSonificationTracksMapping();
			MidiName = MidiName_DefaultValue = "";
			PointGrouping = PointGrouping_DefaultValue = new HollowcandlestickSeriesSonificationTracksPointGrouping();
			RoundToMusicalNotes = RoundToMusicalNotes_DefaultValue = true;
			ShowPlayMarker = ShowPlayMarker_DefaultValue = true;
			Type = Type_DefaultValue = HollowcandlestickSeriesSonificationTracksType.Instrument;
		...
		/// </summary>
		public HollowcandlestickSeriesSonificationTracksActiveWhen ActiveWhen { get; set; }
		private HollowcandlestickSeriesSonificationTracksActiveWhen ActiveWhen_DefaultValue { get; set; }
		...
		/// </summary>
		public HollowcandlestickSeriesSonificationTracksMapping Mapping { get; set; }
		private HollowcandlestickSeriesSonificationTracksMapping Mapping_DefaultValue { get; set; }
		...
		/// </summary>
		public HollowcandlestickSeriesSonificationTracksPointGrouping PointGrouping { get; set; }
		private HollowcandlestickSeriesSonificationTracksPointGrouping PointGrouping_DefaultValue { get; set; }
		...
		/// </summary>
		public HollowcandlestickSeriesSonificationTracksType Type { get; set; }
		private HollowcandlestickSeriesSonificationTracksType Type_DefaultValue { get; set; }
