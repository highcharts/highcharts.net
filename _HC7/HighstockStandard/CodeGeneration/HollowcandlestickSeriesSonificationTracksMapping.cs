...
{
	public partial class HollowcandlestickSeriesSonificationTracksMapping  : BaseObject
	{
		Hashtable h = new Hashtable();

		public HollowcandlestickSeriesSonificationTracksMapping()
		{
			Frequency = Frequency_DefaultValue = new HollowcandlestickSeriesSonificationTracksMappingFrequency();
			GapBetweenNotes = GapBetweenNotes_DefaultValue = new HollowcandlestickSeriesSonificationTracksMappingGapBetweenNotes();
			Highpass = Highpass_DefaultValue = new HollowcandlestickSeriesSonificationTracksMappingHighpass();
			Lowpass = Lowpass_DefaultValue = new HollowcandlestickSeriesSonificationTracksMappingLowpass();
			NoteDuration = NoteDuration_DefaultValue = new HollowcandlestickSeriesSonificationTracksMappingNoteDuration();
			Pan = Pan_DefaultValue = new HollowcandlestickSeriesSonificationTracksMappingPan();
			Pitch = Pitch_DefaultValue = new HollowcandlestickSeriesSonificationTracksMappingPitch();
			PitchString = PitchString_DefaultValue = "null";
			PitchNumber = PitchNumber_DefaultValue = null;
			PlayDelay = PlayDelay_DefaultValue = new HollowcandlestickSeriesSonificationTracksMappingPlayDelay();
			Time = Time_DefaultValue = new HollowcandlestickSeriesSonificationTracksMappingTime();
			TimeString = TimeString_DefaultValue = "null";
			TimeNumber = TimeNumber_DefaultValue = null;
			Tremolo = Tremolo_DefaultValue = new HollowcandlestickSeriesSonificationTracksMappingTremolo();
			Volume = Volume_DefaultValue = new HollowcandlestickSeriesSonificationTracksMappingVolume();
		...
		/// </summary>
		public HollowcandlestickSeriesSonificationTracksMappingFrequency Frequency { get; set; }
		private HollowcandlestickSeriesSonificationTracksMappingFrequency Frequency_DefaultValue { get; set; }
		...
		/// </summary>
		public HollowcandlestickSeriesSonificationTracksMappingGapBetweenNotes GapBetweenNotes { get; set; }
		private HollowcandlestickSeriesSonificationTracksMappingGapBetweenNotes GapBetweenNotes_DefaultValue { get; set; }
		...
		/// </summary>
		public HollowcandlestickSeriesSonificationTracksMappingHighpass Highpass { get; set; }
		private HollowcandlestickSeriesSonificationTracksMappingHighpass Highpass_DefaultValue { get; set; }
		...
		/// </summary>
		public HollowcandlestickSeriesSonificationTracksMappingLowpass Lowpass { get; set; }
		private HollowcandlestickSeriesSonificationTracksMappingLowpass Lowpass_DefaultValue { get; set; }
		...
		/// </summary>
		public HollowcandlestickSeriesSonificationTracksMappingNoteDuration NoteDuration { get; set; }
		private HollowcandlestickSeriesSonificationTracksMappingNoteDuration NoteDuration_DefaultValue { get; set; }
		...
		/// </summary>
		public HollowcandlestickSeriesSonificationTracksMappingPan Pan { get; set; }
		private HollowcandlestickSeriesSonificationTracksMappingPan Pan_DefaultValue { get; set; }
		...
		/// </summary>
		public HollowcandlestickSeriesSonificationTracksMappingPitch Pitch { get; set; }
		private HollowcandlestickSeriesSonificationTracksMappingPitch Pitch_DefaultValue { get; set; }
		...
		/// </summary>
		public HollowcandlestickSeriesSonificationTracksMappingPlayDelay PlayDelay { get; set; }
		private HollowcandlestickSeriesSonificationTracksMappingPlayDelay PlayDelay_DefaultValue { get; set; }
		...
		/// </summary>
		public HollowcandlestickSeriesSonificationTracksMappingTime Time { get; set; }
		private HollowcandlestickSeriesSonificationTracksMappingTime Time_DefaultValue { get; set; }
		...
		/// </summary>
		public HollowcandlestickSeriesSonificationTracksMappingTremolo Tremolo { get; set; }
		private HollowcandlestickSeriesSonificationTracksMappingTremolo Tremolo_DefaultValue { get; set; }
		 

		/// <summary>
		/// The volume of notes, from 0 to 1.
		/// </summary>
		public HollowcandlestickSeriesSonificationTracksMappingVolume Volume { get; set; }
		private HollowcandlestickSeriesSonificationTracksMappingVolume Volume_DefaultValue { get; set; }
