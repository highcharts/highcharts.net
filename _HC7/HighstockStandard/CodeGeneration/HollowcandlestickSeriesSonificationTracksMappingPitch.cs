...
namespace Highsoft.Web.Mvc.Stocks
{
	public partial class HollowcandlestickSeriesSonificationTracksMappingPitch  : BaseObject
	{
		...
		{
			if (MapFunction != HollowcandlestickSeriesSonificationTracksMappingPitchMapFunction.Null) h.Add("mapFunction", highstock.FirstCharacterToLower(MapFunction.ToString()));
