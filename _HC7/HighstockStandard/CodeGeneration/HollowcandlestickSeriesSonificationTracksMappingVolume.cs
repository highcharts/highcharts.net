...
{
	public partial class HollowcandlestickSeriesSonificationTracksMappingVolume  : BaseObject
	{
		Hashtable h = new Hashtable();

		public HollowcandlestickSeriesSonificationTracksMappingVolume()
		{
			MapFunction = MapFunction_DefaultValue = HollowcandlestickSeriesSonificationTracksMappingVolumeMapFunction.Linear;
			MapTo = MapTo_DefaultValue = "";
			Max = Max_DefaultValue = null;
			Min = Min_DefaultValue = null;
			Value = Value_DefaultValue = null;
			Within = Within_DefaultValue = HollowcandlestickSeriesSonificationTracksMappingVolumeWithin.Chart;
		...
		/// </summary>
		public HollowcandlestickSeriesSonificationTracksMappingVolumeMapFunction MapFunction { get; set; }
		private HollowcandlestickSeriesSonificationTracksMappingVolumeMapFunction MapFunction_DefaultValue { get; set; }
		...
		/// </summary>
		public HollowcandlestickSeriesSonificationTracksMappingVolumeWithin Within { get; set; }
		private HollowcandlestickSeriesSonificationTracksMappingVolumeWithin Within_DefaultValue { get; set; }
