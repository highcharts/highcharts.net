...
{
	public partial class HollowcandlestickSeriesSonificationTracksPointGrouping  : BaseObject
	{
		Hashtable h = new Hashtable();

		public HollowcandlestickSeriesSonificationTracksPointGrouping()
		{
			Algorithm = Algorithm_DefaultValue = HollowcandlestickSeriesSonificationTracksPointGroupingAlgorithm.Minimax;
		...
		/// </summary>
		public HollowcandlestickSeriesSonificationTracksPointGroupingAlgorithm Algorithm { get; set; }
		private HollowcandlestickSeriesSonificationTracksPointGroupingAlgorithm Algorithm_DefaultValue { get; set; }
