...
namespace Highsoft.Web.Mvc.Stocks
{
	public partial class IkhSeries  : Series
	{
		...
		internal override Hashtable ToHashtable(Highstock highstock)
		{
			...
			if (BoostBlending != IkhSeriesBoostBlending.Null) h.Add("boostBlending", highstock.FirstCharacterToLower(BoostBlending.ToString()));
			if (BoostThreshold != null) h.Add("boostThreshold",BoostThreshold);
			if (ChikouLine != null) h.Add("chikouLine",ChikouLine.ToHashtable(highstock));
			...
			if (Cursor != IkhSeriesCursor.Null) h.Add("cursor", highstock.FirstCharacterToLower(Cursor.ToString()));
			if (Custom != null) h.Add("custom",Custom);
			if (DashStyle != IkhSeriesDashStyle.Null) h.Add("dashStyle", highstock.FirstCharacterToLower(DashStyle.ToString()));
			...
			if (FindNearestPointBy != IkhSeriesFindNearestPointBy.Null) h.Add("findNearestPointBy", highstock.FirstCharacterToLower(FindNearestPointBy.ToString()));
			if (GapSize != null) h.Add("gapSize",GapSize);
			if (GapUnit != IkhSeriesGapUnit.Null) h.Add("gapUnit", highstock.FirstCharacterToLower(GapUnit.ToString()));
			...
			if (KijunLine != null) h.Add("kijunLine",KijunLine.ToHashtable(highstock));
			...
			if (LegendSymbol != IkhSeriesLegendSymbol.Null) h.Add("legendSymbol", highstock.FirstCharacterToLower(LegendSymbol.ToString()));
			if (Linecap != IkhSeriesLinecap.Null) h.Add("linecap", highstock.FirstCharacterToLower(Linecap.ToString()));
			...
			if (SenkouSpan != null) h.Add("senkouSpan",SenkouSpan.ToHashtable(highstock));
			if (SenkouSpanA != null) h.Add("senkouSpanA",SenkouSpanA.ToHashtable(highstock));
			if (SenkouSpanB != null) h.Add("senkouSpanB",SenkouSpanB.ToHashtable(highstock));
			...
			if (Step != IkhSeriesStep.Null) h.Add("step", highstock.FirstCharacterToLower(Step.ToString()));
			if (StickyTracking != null) h.Add("stickyTracking",StickyTracking);
			if (TenkanLine != null) h.Add("tenkanLine",TenkanLine.ToHashtable(highstock));
