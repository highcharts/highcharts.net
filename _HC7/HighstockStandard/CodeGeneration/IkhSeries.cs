...
{
	public partial class IkhSeries  : Series
	{
		Hashtable h = new Hashtable();

		public IkhSeries()
		{
			Accessibility = Accessibility_DefaultValue = new IkhSeriesAccessibility();
			AllowPointSelect = AllowPointSelect_DefaultValue = false;
			Animation = Animation_DefaultValue = new Animation() { Enabled = true };
			AnimationBool = AnimationBool_DefaultValue = true;
			AnimationLimit = AnimationLimit_DefaultValue = null;
			BoostBlending = BoostBlending_DefaultValue = IkhSeriesBoostBlending.Undefined;
			BoostThreshold = BoostThreshold_DefaultValue = 5000;
			ChikouLine = ChikouLine_DefaultValue = new IkhSeriesChikouLine();
			...
			DashStyle = DashStyle_DefaultValue = IkhSeriesDashStyle.Null;
			...
			DataSorting = DataSorting_DefaultValue = new IkhSeriesDataSorting();
			Description = Description_DefaultValue = "";
			Dumbell = Dumbell_DefaultValue = new IkhSeriesDumbell();
			EnableMouseTracking = EnableMouseTracking_DefaultValue = true;
			Events = Events_DefaultValue = new IkhSeriesEvents();
			FindNearestPointBy = FindNearestPointBy_DefaultValue = IkhSeriesFindNearestPointBy.X;
			GapSize = GapSize_DefaultValue = 0;
			GapUnit = GapUnit_DefaultValue = IkhSeriesGapUnit.Relative;
			...
			LegendSymbol = LegendSymbol_DefaultValue = IkhSeriesLegendSymbol.Rectangle;
			Linecap = Linecap_DefaultValue = IkhSeriesLinecap.Round;
			LineWidth = LineWidth_DefaultValue = 2;
			LinkedTo = LinkedTo_DefaultValue = "";
			Marker = Marker_DefaultValue = new IkhSeriesMarker();
			Name = Name_DefaultValue = "";
			NegativeColor = NegativeColor_DefaultValue = "";
			OnPoint = OnPoint_DefaultValue = new IkhSeriesOnPoint();
			Opacity = Opacity_DefaultValue = 1;
			Params = Params_DefaultValue = new IkhSeriesParams();
			Point = Point_DefaultValue = new IkhSeriesPoint();
			...
			SenkouSpan = SenkouSpan_DefaultValue = new IkhSeriesSenkouSpan();
			SenkouSpanA = SenkouSpanA_DefaultValue = new IkhSeriesSenkouSpanA();
			SenkouSpanB = SenkouSpanB_DefaultValue = new IkhSeriesSenkouSpanB();
			...
			Sonification = Sonification_DefaultValue = new IkhSeriesSonification();
			Stack = Stack_DefaultValue = "";
			StackNumber = StackNumber_DefaultValue = null;
			States = States_DefaultValue = new IkhSeriesStates();
			Step = Step_DefaultValue = IkhSeriesStep.Null;
			...
			Zones = Zones_DefaultValue = new List<IkhSeriesZones>();
		...
		/// </summary>
		public IkhSeriesAccessibility Accessibility { get; set; }
		private IkhSeriesAccessibility Accessibility_DefaultValue { get; set; }
		...
		/// </summary>
		public IkhSeriesBoostBlending BoostBlending { get; set; }
		private IkhSeriesBoostBlending BoostBlending_DefaultValue { get; set; }
		...
		/// </summary>
		public IkhSeriesCursor Cursor { get; set; }
		private IkhSeriesCursor Cursor_DefaultValue { get; set; }
		...
		/// </summary>
		public IkhSeriesDashStyle DashStyle { get; set; }
		private IkhSeriesDashStyle DashStyle_DefaultValue { get; set; }
		...
		/// </summary>
		public IkhSeriesDataLabels DataLabels { get; set; }
		private IkhSeriesDataLabels DataLabels_DefaultValue { get; set; }
		 

		/// <summary>
		/// Options for the series data sorting.
		/// </summary>
		public IkhSeriesDataSorting DataSorting { get; set; }
		private IkhSeriesDataSorting DataSorting_DefaultValue { get; set; }
		...
		/// 
		/// </summary>
		public IkhSeriesDumbell Dumbell { get; set; }
		private IkhSeriesDumbell Dumbell_DefaultValue { get; set; }
		...
		/// </summary>
		public IkhSeriesEvents Events { get; set; }
		private IkhSeriesEvents Events_DefaultValue { get; set; }
		...
		/// </summary>
		public IkhSeriesFindNearestPointBy FindNearestPointBy { get; set; }
		private IkhSeriesFindNearestPointBy FindNearestPointBy_DefaultValue { get; set; }
		...
		/// </summary>
		public IkhSeriesGapUnit GapUnit { get; set; }
		private IkhSeriesGapUnit GapUnit_DefaultValue { get; set; }
		...
		/// </summary>
		public IkhSeriesLabel Label { get; set; }
		private IkhSeriesLabel Label_DefaultValue { get; set; }
		...
		/// </summary>
		public IkhSeriesLegendSymbol LegendSymbol { get; set; }
		private IkhSeriesLegendSymbol LegendSymbol_DefaultValue { get; set; }
		 

		/// <summary>
		/// The line cap used for line ends and line joins on the graph.
		/// </summary>
		public IkhSeriesLinecap Linecap { get; set; }
		private IkhSeriesLinecap Linecap_DefaultValue { get; set; }
		...
		/// </summary>
		public IkhSeriesMarker Marker { get; set; }
		private IkhSeriesMarker Marker_DefaultValue { get; set; }
		...
		/// </summary>
		public IkhSeriesOnPoint OnPoint { get; set; }
		private IkhSeriesOnPoint OnPoint_DefaultValue { get; set; }
		...
		/// </summary>
		public IkhSeriesPoint Point { get; set; }
		private IkhSeriesPoint Point_DefaultValue { get; set; }
		...
		/// </summary>
		public IkhSeriesSonification Sonification { get; set; }
		private IkhSeriesSonification Sonification_DefaultValue { get; set; }
		...
		/// 
		/// </summary>
		public IkhSeriesStates States { get; set; }
		private IkhSeriesStates States_DefaultValue { get; set; }
		 

		/// <summary>
		/// Whether to apply steps to the line. Possible values are `left`,`center` and `right`.
		/// </summary>
		public IkhSeriesStep Step { get; set; }
		private IkhSeriesStep Step_DefaultValue { get; set; }
		...
		/// </summary>
		public IkhSeriesTooltip Tooltip { get; set; }
		private IkhSeriesTooltip Tooltip_DefaultValue { get; set; }
		...
		/// </summary>
		public List<IkhSeriesZones> Zones { get; set; }
		private List<IkhSeriesZones> Zones_DefaultValue { get; set; }
		...
		internal override Hashtable ToHashtable(Highstock highstock)
		{
			...
			if (ChikouLine.IsDirty(highstock)) h.Add("chikouLine",ChikouLine.ToHashtable(highstock));
			...
			if (SenkouSpan.IsDirty(highstock)) h.Add("senkouSpan",SenkouSpan.ToHashtable(highstock));
			if (SenkouSpanA.IsDirty(highstock)) h.Add("senkouSpanA",SenkouSpanA.ToHashtable(highstock));
			if (SenkouSpanB.IsDirty(highstock)) h.Add("senkouSpanB",SenkouSpanB.ToHashtable(highstock));
			...
			if (TenkanLine.IsDirty(highstock)) h.Add("tenkanLine",TenkanLine.ToHashtable(highstock));
