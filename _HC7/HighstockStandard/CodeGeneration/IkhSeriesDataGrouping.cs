...
namespace Highsoft.Web.Mvc.Stocks
{
	public partial class IkhSeriesDataGrouping  : BaseObject
	{
		...
		internal override Hashtable ToHashtable()
		{
			...
			if (Approximation != Approximation_DefaultValue) { h.Add("approximation",Approximation); Highstock.AddFunction("IkhSeriesDataGroupingApproximation.approximation", Approximation); }  
