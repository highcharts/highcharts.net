...
{
	public partial class IkhSeriesDragDrop  : BaseObject
	{
		public IkhSeriesDragDrop()
		{
			DraggableX = DraggableX_DefaultValue = null;
			DraggableY = DraggableY_DefaultValue = null;
			DragHandle = DragHandle_DefaultValue = new IkhSeriesDragDropDragHandle();
			...
			GuideBox = GuideBox_DefaultValue = new IkhSeriesDragDropGuideBox();
		...
		/// </summary>
		public IkhSeriesDragDropDragHandle DragHandle { get; set; }
		private IkhSeriesDragDropDragHandle DragHandle_DefaultValue { get; set; }
		...
		/// </summary>
		public IkhSeriesDragDropGuideBox GuideBox { get; set; }
		private IkhSeriesDragDropGuideBox GuideBox_DefaultValue { get; set; }
