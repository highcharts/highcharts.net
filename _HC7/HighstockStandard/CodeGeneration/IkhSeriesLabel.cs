...
{
	public partial class IkhSeriesLabel  : BaseObject
	{
		public IkhSeriesLabel()
		{
			...
			Style = Style_DefaultValue = new IkhSeriesLabelStyle();
		...
		/// </summary>
		public IkhSeriesLabelStyle Style { get; set; }
		private IkhSeriesLabelStyle Style_DefaultValue { get; set; }
