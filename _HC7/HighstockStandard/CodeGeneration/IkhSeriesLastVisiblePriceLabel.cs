...
{
	public partial class IkhSeriesLastVisiblePriceLabel  : BaseObject
	{
		Hashtable h = new Hashtable();

		public IkhSeriesLastVisiblePriceLabel()
		{
			Align = Align_DefaultValue = IkhSeriesLastVisiblePriceLabelAlign.Null;
		...
		/// 
		/// </summary>
		public IkhSeriesLastVisiblePriceLabelAlign Align { get; set; }
		private IkhSeriesLastVisiblePriceLabelAlign Align_DefaultValue { get; set; }
