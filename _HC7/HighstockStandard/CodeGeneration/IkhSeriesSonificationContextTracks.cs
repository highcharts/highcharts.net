...
{
	public partial class IkhSeriesSonificationContextTracks  : BaseObject
	{
		Hashtable h = new Hashtable();

		public IkhSeriesSonificationContextTracks()
		{
			ActiveWhen = ActiveWhen_DefaultValue = new IkhSeriesSonificationContextTracksActiveWhen();
			Instrument = Instrument_DefaultValue = null;
			InstrumentString = InstrumentString_DefaultValue = "null";
			Mapping = Mapping_DefaultValue = new IkhSeriesSonificationContextTracksMapping();
			MidiName = MidiName_DefaultValue = "";
			PointGrouping = PointGrouping_DefaultValue = new IkhSeriesSonificationContextTracksPointGrouping();
			...
			Type = Type_DefaultValue = IkhSeriesSonificationContextTracksType.Instrument;
			ValueInterval = ValueInterval_DefaultValue = null;
			ValueMapFunction = ValueMapFunction_DefaultValue = IkhSeriesSonificationContextTracksValueMapFunction.Linear;
		...
		/// </summary>
		public IkhSeriesSonificationContextTracksActiveWhen ActiveWhen { get; set; }
		private IkhSeriesSonificationContextTracksActiveWhen ActiveWhen_DefaultValue { get; set; }
		...
		/// </summary>
		public IkhSeriesSonificationContextTracksMapping Mapping { get; set; }
		private IkhSeriesSonificationContextTracksMapping Mapping_DefaultValue { get; set; }
		...
		/// </summary>
		public IkhSeriesSonificationContextTracksPointGrouping PointGrouping { get; set; }
		private IkhSeriesSonificationContextTracksPointGrouping PointGrouping_DefaultValue { get; set; }
		...
		/// </summary>
		public IkhSeriesSonificationContextTracksType Type { get; set; }
		private IkhSeriesSonificationContextTracksType Type_DefaultValue { get; set; }
		...
		/// </summary>
		public IkhSeriesSonificationContextTracksValueMapFunction ValueMapFunction { get; set; }
		private IkhSeriesSonificationContextTracksValueMapFunction ValueMapFunction_DefaultValue { get; set; }
