...
{
	public partial class IkhSeriesSonificationContextTracksMappingFrequency  : BaseObject
	{
		Hashtable h = new Hashtable();

		public IkhSeriesSonificationContextTracksMappingFrequency()
		{
			MapFunction = MapFunction_DefaultValue = IkhSeriesSonificationContextTracksMappingFrequencyMapFunction.Linear;
			MapTo = MapTo_DefaultValue = "";
			Max = Max_DefaultValue = null;
			Min = Min_DefaultValue = null;
			Value = Value_DefaultValue = null;
			Within = Within_DefaultValue = IkhSeriesSonificationContextTracksMappingFrequencyWithin.Chart;
		...
		/// </summary>
		public IkhSeriesSonificationContextTracksMappingFrequencyMapFunction MapFunction { get; set; }
		private IkhSeriesSonificationContextTracksMappingFrequencyMapFunction MapFunction_DefaultValue { get; set; }
		...
		/// </summary>
		public IkhSeriesSonificationContextTracksMappingFrequencyWithin Within { get; set; }
		private IkhSeriesSonificationContextTracksMappingFrequencyWithin Within_DefaultValue { get; set; }
