...
{
	public partial class IkhSeriesSonificationContextTracksMappingPan  : BaseObject
	{
		Hashtable h = new Hashtable();

		public IkhSeriesSonificationContextTracksMappingPan()
		{
			MapFunction = MapFunction_DefaultValue = IkhSeriesSonificationContextTracksMappingPanMapFunction.Linear;
			MapTo = MapTo_DefaultValue = "";
			Max = Max_DefaultValue = null;
			Min = Min_DefaultValue = null;
			Value = Value_DefaultValue = null;
			Within = Within_DefaultValue = IkhSeriesSonificationContextTracksMappingPanWithin.Chart;
		...
		/// </summary>
		public IkhSeriesSonificationContextTracksMappingPanMapFunction MapFunction { get; set; }
		private IkhSeriesSonificationContextTracksMappingPanMapFunction MapFunction_DefaultValue { get; set; }
		...
		/// </summary>
		public IkhSeriesSonificationContextTracksMappingPanWithin Within { get; set; }
		private IkhSeriesSonificationContextTracksMappingPanWithin Within_DefaultValue { get; set; }
