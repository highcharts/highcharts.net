...
{
	public partial class IkhSeriesSonificationContextTracksMappingPitch  : BaseObject
	{
		Hashtable h = new Hashtable();

		public IkhSeriesSonificationContextTracksMappingPitch()
		{
			MapFunction = MapFunction_DefaultValue = IkhSeriesSonificationContextTracksMappingPitchMapFunction.Linear;
		...
		/// </summary>
		public IkhSeriesSonificationContextTracksMappingPitchMapFunction MapFunction { get; set; }
		private IkhSeriesSonificationContextTracksMappingPitchMapFunction MapFunction_DefaultValue { get; set; }
