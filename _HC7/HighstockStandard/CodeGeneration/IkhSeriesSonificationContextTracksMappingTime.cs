...
{
	public partial class IkhSeriesSonificationContextTracksMappingTime  : BaseObject
	{
		Hashtable h = new Hashtable();

		public IkhSeriesSonificationContextTracksMappingTime()
		{
			MapFunction = MapFunction_DefaultValue = IkhSeriesSonificationContextTracksMappingTimeMapFunction.Linear;
			MapTo = MapTo_DefaultValue = "";
			Max = Max_DefaultValue = null;
			Min = Min_DefaultValue = null;
			Value = Value_DefaultValue = null;
			Within = Within_DefaultValue = IkhSeriesSonificationContextTracksMappingTimeWithin.Chart;
		...
		/// </summary>
		public IkhSeriesSonificationContextTracksMappingTimeMapFunction MapFunction { get; set; }
		private IkhSeriesSonificationContextTracksMappingTimeMapFunction MapFunction_DefaultValue { get; set; }
		...
		/// </summary>
		public IkhSeriesSonificationContextTracksMappingTimeWithin Within { get; set; }
		private IkhSeriesSonificationContextTracksMappingTimeWithin Within_DefaultValue { get; set; }
