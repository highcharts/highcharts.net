...
{
	public partial class IkhSeriesSonificationContextTracksMappingTremoloSpeed  : BaseObject
	{
		Hashtable h = new Hashtable();

		public IkhSeriesSonificationContextTracksMappingTremoloSpeed()
		{
			MapFunction = MapFunction_DefaultValue = IkhSeriesSonificationContextTracksMappingTremoloSpeedMapFunction.Linear;
			MapTo = MapTo_DefaultValue = "";
			Max = Max_DefaultValue = null;
			Min = Min_DefaultValue = null;
			Value = Value_DefaultValue = null;
			Within = Within_DefaultValue = IkhSeriesSonificationContextTracksMappingTremoloSpeedWithin.Chart;
		...
		/// </summary>
		public IkhSeriesSonificationContextTracksMappingTremoloSpeedMapFunction MapFunction { get; set; }
		private IkhSeriesSonificationContextTracksMappingTremoloSpeedMapFunction MapFunction_DefaultValue { get; set; }
		...
		/// </summary>
		public IkhSeriesSonificationContextTracksMappingTremoloSpeedWithin Within { get; set; }
		private IkhSeriesSonificationContextTracksMappingTremoloSpeedWithin Within_DefaultValue { get; set; }
