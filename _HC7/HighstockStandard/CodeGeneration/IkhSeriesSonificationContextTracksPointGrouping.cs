...
{
	public partial class IkhSeriesSonificationContextTracksPointGrouping  : BaseObject
	{
		Hashtable h = new Hashtable();

		public IkhSeriesSonificationContextTracksPointGrouping()
		{
			Algorithm = Algorithm_DefaultValue = IkhSeriesSonificationContextTracksPointGroupingAlgorithm.Minimax;
		...
		/// </summary>
		public IkhSeriesSonificationContextTracksPointGroupingAlgorithm Algorithm { get; set; }
		private IkhSeriesSonificationContextTracksPointGroupingAlgorithm Algorithm_DefaultValue { get; set; }
