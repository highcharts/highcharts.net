...
{
	public partial class IkhSeriesSonificationDefaultInstrumentOptionsMappingLowpassResonance  : BaseObject
	{
		Hashtable h = new Hashtable();

		public IkhSeriesSonificationDefaultInstrumentOptionsMappingLowpassResonance()
		{
			MapFunction = MapFunction_DefaultValue = IkhSeriesSonificationDefaultInstrumentOptionsMappingLowpassResonanceMapFunction.Linear;
			MapTo = MapTo_DefaultValue = "";
			Max = Max_DefaultValue = null;
			Min = Min_DefaultValue = null;
			Value = Value_DefaultValue = null;
			Within = Within_DefaultValue = IkhSeriesSonificationDefaultInstrumentOptionsMappingLowpassResonanceWithin.Chart;
		...
		/// </summary>
		public IkhSeriesSonificationDefaultInstrumentOptionsMappingLowpassResonanceMapFunction MapFunction { get; set; }
		private IkhSeriesSonificationDefaultInstrumentOptionsMappingLowpassResonanceMapFunction MapFunction_DefaultValue { get; set; }
		...
		/// </summary>
		public IkhSeriesSonificationDefaultInstrumentOptionsMappingLowpassResonanceWithin Within { get; set; }
		private IkhSeriesSonificationDefaultInstrumentOptionsMappingLowpassResonanceWithin Within_DefaultValue { get; set; }
