...
{
	public partial class IkhSeriesSonificationDefaultSpeechOptions  : BaseObject
	{
		Hashtable h = new Hashtable();

		public IkhSeriesSonificationDefaultSpeechOptions()
		{
			ActiveWhen = ActiveWhen_DefaultValue = new IkhSeriesSonificationDefaultSpeechOptionsActiveWhen();
			Language = Language_DefaultValue = "en-US";
			Mapping = Mapping_DefaultValue = new IkhSeriesSonificationDefaultSpeechOptionsMapping();
			PointGrouping = PointGrouping_DefaultValue = new IkhSeriesSonificationDefaultSpeechOptionsPointGrouping();
			PreferredVoice = PreferredVoice_DefaultValue = "";
			ShowPlayMarker = ShowPlayMarker_DefaultValue = true;
			Type = Type_DefaultValue = IkhSeriesSonificationDefaultSpeechOptionsType.Instrument;
		...
		/// </summary>
		public IkhSeriesSonificationDefaultSpeechOptionsActiveWhen ActiveWhen { get; set; }
		private IkhSeriesSonificationDefaultSpeechOptionsActiveWhen ActiveWhen_DefaultValue { get; set; }
		...
		/// </summary>
		public IkhSeriesSonificationDefaultSpeechOptionsMapping Mapping { get; set; }
		private IkhSeriesSonificationDefaultSpeechOptionsMapping Mapping_DefaultValue { get; set; }
		 

		/// <summary>
		/// Options for point grouping, specifically for instrument tracks.
		/// </summary>
		public IkhSeriesSonificationDefaultSpeechOptionsPointGrouping PointGrouping { get; set; }
		private IkhSeriesSonificationDefaultSpeechOptionsPointGrouping PointGrouping_DefaultValue { get; set; }
		...
		/// </summary>
		public IkhSeriesSonificationDefaultSpeechOptionsType Type { get; set; }
		private IkhSeriesSonificationDefaultSpeechOptionsType Type_DefaultValue { get; set; }
