...
{
	public partial class IkhSeriesSonificationTracks  : BaseObject
	{
		Hashtable h = new Hashtable();

		public IkhSeriesSonificationTracks()
		{
			ActiveWhen = ActiveWhen_DefaultValue = new IkhSeriesSonificationTracksActiveWhen();
			Instrument = Instrument_DefaultValue = null;
			InstrumentString = InstrumentString_DefaultValue = "null";
			Mapping = Mapping_DefaultValue = new IkhSeriesSonificationTracksMapping();
			MidiName = MidiName_DefaultValue = "";
			PointGrouping = PointGrouping_DefaultValue = new IkhSeriesSonificationTracksPointGrouping();
			RoundToMusicalNotes = RoundToMusicalNotes_DefaultValue = true;
			ShowPlayMarker = ShowPlayMarker_DefaultValue = true;
			Type = Type_DefaultValue = IkhSeriesSonificationTracksType.Instrument;
		...
		/// </summary>
		public IkhSeriesSonificationTracksActiveWhen ActiveWhen { get; set; }
		private IkhSeriesSonificationTracksActiveWhen ActiveWhen_DefaultValue { get; set; }
		...
		/// </summary>
		public IkhSeriesSonificationTracksMapping Mapping { get; set; }
		private IkhSeriesSonificationTracksMapping Mapping_DefaultValue { get; set; }
		...
		/// </summary>
		public IkhSeriesSonificationTracksPointGrouping PointGrouping { get; set; }
		private IkhSeriesSonificationTracksPointGrouping PointGrouping_DefaultValue { get; set; }
		...
		/// </summary>
		public IkhSeriesSonificationTracksType Type { get; set; }
		private IkhSeriesSonificationTracksType Type_DefaultValue { get; set; }
