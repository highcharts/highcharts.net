...
{
	public partial class IkhSeriesSonificationTracksMapping  : BaseObject
	{
		Hashtable h = new Hashtable();

		public IkhSeriesSonificationTracksMapping()
		{
			Frequency = Frequency_DefaultValue = new IkhSeriesSonificationTracksMappingFrequency();
			GapBetweenNotes = GapBetweenNotes_DefaultValue = new IkhSeriesSonificationTracksMappingGapBetweenNotes();
			Highpass = Highpass_DefaultValue = new IkhSeriesSonificationTracksMappingHighpass();
			Lowpass = Lowpass_DefaultValue = new IkhSeriesSonificationTracksMappingLowpass();
			NoteDuration = NoteDuration_DefaultValue = new IkhSeriesSonificationTracksMappingNoteDuration();
			Pan = Pan_DefaultValue = new IkhSeriesSonificationTracksMappingPan();
			Pitch = Pitch_DefaultValue = new IkhSeriesSonificationTracksMappingPitch();
			PitchString = PitchString_DefaultValue = "null";
			PitchNumber = PitchNumber_DefaultValue = null;
			PlayDelay = PlayDelay_DefaultValue = new IkhSeriesSonificationTracksMappingPlayDelay();
			Time = Time_DefaultValue = new IkhSeriesSonificationTracksMappingTime();
			TimeString = TimeString_DefaultValue = "null";
			TimeNumber = TimeNumber_DefaultValue = null;
			Tremolo = Tremolo_DefaultValue = new IkhSeriesSonificationTracksMappingTremolo();
			Volume = Volume_DefaultValue = new IkhSeriesSonificationTracksMappingVolume();
		...
		/// </summary>
		public IkhSeriesSonificationTracksMappingFrequency Frequency { get; set; }
		private IkhSeriesSonificationTracksMappingFrequency Frequency_DefaultValue { get; set; }
		...
		/// </summary>
		public IkhSeriesSonificationTracksMappingGapBetweenNotes GapBetweenNotes { get; set; }
		private IkhSeriesSonificationTracksMappingGapBetweenNotes GapBetweenNotes_DefaultValue { get; set; }
		...
		/// </summary>
		public IkhSeriesSonificationTracksMappingHighpass Highpass { get; set; }
		private IkhSeriesSonificationTracksMappingHighpass Highpass_DefaultValue { get; set; }
		...
		/// </summary>
		public IkhSeriesSonificationTracksMappingLowpass Lowpass { get; set; }
		private IkhSeriesSonificationTracksMappingLowpass Lowpass_DefaultValue { get; set; }
		...
		/// </summary>
		public IkhSeriesSonificationTracksMappingNoteDuration NoteDuration { get; set; }
		private IkhSeriesSonificationTracksMappingNoteDuration NoteDuration_DefaultValue { get; set; }
		...
		/// </summary>
		public IkhSeriesSonificationTracksMappingPan Pan { get; set; }
		private IkhSeriesSonificationTracksMappingPan Pan_DefaultValue { get; set; }
		...
		/// </summary>
		public IkhSeriesSonificationTracksMappingPitch Pitch { get; set; }
		private IkhSeriesSonificationTracksMappingPitch Pitch_DefaultValue { get; set; }
		...
		/// </summary>
		public IkhSeriesSonificationTracksMappingPlayDelay PlayDelay { get; set; }
		private IkhSeriesSonificationTracksMappingPlayDelay PlayDelay_DefaultValue { get; set; }
		...
		/// </summary>
		public IkhSeriesSonificationTracksMappingTime Time { get; set; }
		private IkhSeriesSonificationTracksMappingTime Time_DefaultValue { get; set; }
		...
		/// </summary>
		public IkhSeriesSonificationTracksMappingTremolo Tremolo { get; set; }
		private IkhSeriesSonificationTracksMappingTremolo Tremolo_DefaultValue { get; set; }
		 

		/// <summary>
		/// The volume of notes, from 0 to 1.
		/// </summary>
		public IkhSeriesSonificationTracksMappingVolume Volume { get; set; }
		private IkhSeriesSonificationTracksMappingVolume Volume_DefaultValue { get; set; }
