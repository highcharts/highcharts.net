...
{
	public partial class IkhSeriesSonificationTracksMappingFrequency  : BaseObject
	{
		Hashtable h = new Hashtable();

		public IkhSeriesSonificationTracksMappingFrequency()
		{
			MapFunction = MapFunction_DefaultValue = IkhSeriesSonificationTracksMappingFrequencyMapFunction.Linear;
			MapTo = MapTo_DefaultValue = "";
			Max = Max_DefaultValue = null;
			Min = Min_DefaultValue = null;
			Value = Value_DefaultValue = null;
			Within = Within_DefaultValue = IkhSeriesSonificationTracksMappingFrequencyWithin.Chart;
		...
		/// </summary>
		public IkhSeriesSonificationTracksMappingFrequencyMapFunction MapFunction { get; set; }
		private IkhSeriesSonificationTracksMappingFrequencyMapFunction MapFunction_DefaultValue { get; set; }
		...
		/// </summary>
		public IkhSeriesSonificationTracksMappingFrequencyWithin Within { get; set; }
		private IkhSeriesSonificationTracksMappingFrequencyWithin Within_DefaultValue { get; set; }
