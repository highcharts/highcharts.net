...
{
	public partial class IkhSeriesSonificationTracksMappingLowpassResonance  : BaseObject
	{
		Hashtable h = new Hashtable();

		public IkhSeriesSonificationTracksMappingLowpassResonance()
		{
			MapFunction = MapFunction_DefaultValue = IkhSeriesSonificationTracksMappingLowpassResonanceMapFunction.Linear;
			MapTo = MapTo_DefaultValue = "";
			Max = Max_DefaultValue = null;
			Min = Min_DefaultValue = null;
			Value = Value_DefaultValue = null;
			Within = Within_DefaultValue = IkhSeriesSonificationTracksMappingLowpassResonanceWithin.Chart;
		...
		/// </summary>
		public IkhSeriesSonificationTracksMappingLowpassResonanceMapFunction MapFunction { get; set; }
		private IkhSeriesSonificationTracksMappingLowpassResonanceMapFunction MapFunction_DefaultValue { get; set; }
		...
		/// </summary>
		public IkhSeriesSonificationTracksMappingLowpassResonanceWithin Within { get; set; }
		private IkhSeriesSonificationTracksMappingLowpassResonanceWithin Within_DefaultValue { get; set; }
