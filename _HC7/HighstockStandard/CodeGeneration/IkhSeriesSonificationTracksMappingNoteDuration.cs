...
{
	public partial class IkhSeriesSonificationTracksMappingNoteDuration  : BaseObject
	{
		Hashtable h = new Hashtable();

		public IkhSeriesSonificationTracksMappingNoteDuration()
		{
			MapFunction = MapFunction_DefaultValue = IkhSeriesSonificationTracksMappingNoteDurationMapFunction.Linear;
			MapTo = MapTo_DefaultValue = "";
			Max = Max_DefaultValue = null;
			Min = Min_DefaultValue = null;
			Value = Value_DefaultValue = null;
			Within = Within_DefaultValue = IkhSeriesSonificationTracksMappingNoteDurationWithin.Chart;
		...
		/// </summary>
		public IkhSeriesSonificationTracksMappingNoteDurationMapFunction MapFunction { get; set; }
		private IkhSeriesSonificationTracksMappingNoteDurationMapFunction MapFunction_DefaultValue { get; set; }
		...
		/// </summary>
		public IkhSeriesSonificationTracksMappingNoteDurationWithin Within { get; set; }
		private IkhSeriesSonificationTracksMappingNoteDurationWithin Within_DefaultValue { get; set; }
