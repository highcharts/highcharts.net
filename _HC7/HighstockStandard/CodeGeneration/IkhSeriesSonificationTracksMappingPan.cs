...
{
	public partial class IkhSeriesSonificationTracksMappingPan  : BaseObject
	{
		Hashtable h = new Hashtable();

		public IkhSeriesSonificationTracksMappingPan()
		{
			MapFunction = MapFunction_DefaultValue = IkhSeriesSonificationTracksMappingPanMapFunction.Linear;
			MapTo = MapTo_DefaultValue = "";
			Max = Max_DefaultValue = null;
			Min = Min_DefaultValue = null;
			Value = Value_DefaultValue = null;
			Within = Within_DefaultValue = IkhSeriesSonificationTracksMappingPanWithin.Chart;
		...
		/// </summary>
		public IkhSeriesSonificationTracksMappingPanMapFunction MapFunction { get; set; }
		private IkhSeriesSonificationTracksMappingPanMapFunction MapFunction_DefaultValue { get; set; }
		...
		/// </summary>
		public IkhSeriesSonificationTracksMappingPanWithin Within { get; set; }
		private IkhSeriesSonificationTracksMappingPanWithin Within_DefaultValue { get; set; }
