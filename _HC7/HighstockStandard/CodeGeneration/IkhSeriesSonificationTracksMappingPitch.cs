...
{
	public partial class IkhSeriesSonificationTracksMappingPitch  : BaseObject
	{
		Hashtable h = new Hashtable();

		public IkhSeriesSonificationTracksMappingPitch()
		{
			MapFunction = MapFunction_DefaultValue = IkhSeriesSonificationTracksMappingPitchMapFunction.Linear;
		...
		/// </summary>
		public IkhSeriesSonificationTracksMappingPitchMapFunction MapFunction { get; set; }
		private IkhSeriesSonificationTracksMappingPitchMapFunction MapFunction_DefaultValue { get; set; }
