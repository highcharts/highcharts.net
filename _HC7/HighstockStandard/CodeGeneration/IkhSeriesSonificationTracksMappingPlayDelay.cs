...
{
	public partial class IkhSeriesSonificationTracksMappingPlayDelay  : BaseObject
	{
		Hashtable h = new Hashtable();

		public IkhSeriesSonificationTracksMappingPlayDelay()
		{
			MapFunction = MapFunction_DefaultValue = IkhSeriesSonificationTracksMappingPlayDelayMapFunction.Linear;
			MapTo = MapTo_DefaultValue = "";
			Max = Max_DefaultValue = null;
			Min = Min_DefaultValue = null;
			Value = Value_DefaultValue = null;
			Within = Within_DefaultValue = IkhSeriesSonificationTracksMappingPlayDelayWithin.Chart;
		...
		/// </summary>
		public IkhSeriesSonificationTracksMappingPlayDelayMapFunction MapFunction { get; set; }
		private IkhSeriesSonificationTracksMappingPlayDelayMapFunction MapFunction_DefaultValue { get; set; }
		...
		/// </summary>
		public IkhSeriesSonificationTracksMappingPlayDelayWithin Within { get; set; }
		private IkhSeriesSonificationTracksMappingPlayDelayWithin Within_DefaultValue { get; set; }
