...
{
	public partial class IkhSeriesSonificationTracksMappingTime  : BaseObject
	{
		Hashtable h = new Hashtable();

		public IkhSeriesSonificationTracksMappingTime()
		{
			MapFunction = MapFunction_DefaultValue = IkhSeriesSonificationTracksMappingTimeMapFunction.Linear;
			MapTo = MapTo_DefaultValue = "";
			Max = Max_DefaultValue = null;
			Min = Min_DefaultValue = null;
			Value = Value_DefaultValue = null;
			Within = Within_DefaultValue = IkhSeriesSonificationTracksMappingTimeWithin.Chart;
		...
		/// </summary>
		public IkhSeriesSonificationTracksMappingTimeMapFunction MapFunction { get; set; }
		private IkhSeriesSonificationTracksMappingTimeMapFunction MapFunction_DefaultValue { get; set; }
		...
		/// </summary>
		public IkhSeriesSonificationTracksMappingTimeWithin Within { get; set; }
		private IkhSeriesSonificationTracksMappingTimeWithin Within_DefaultValue { get; set; }
