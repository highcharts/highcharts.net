...
{
	public partial class IkhSeriesSonificationTracksMappingTremoloSpeed  : BaseObject
	{
		Hashtable h = new Hashtable();

		public IkhSeriesSonificationTracksMappingTremoloSpeed()
		{
			MapFunction = MapFunction_DefaultValue = IkhSeriesSonificationTracksMappingTremoloSpeedMapFunction.Linear;
			MapTo = MapTo_DefaultValue = "";
			Max = Max_DefaultValue = null;
			Min = Min_DefaultValue = null;
			Value = Value_DefaultValue = null;
			Within = Within_DefaultValue = IkhSeriesSonificationTracksMappingTremoloSpeedWithin.Chart;
		...
		/// </summary>
		public IkhSeriesSonificationTracksMappingTremoloSpeedMapFunction MapFunction { get; set; }
		private IkhSeriesSonificationTracksMappingTremoloSpeedMapFunction MapFunction_DefaultValue { get; set; }
		...
		/// </summary>
		public IkhSeriesSonificationTracksMappingTremoloSpeedWithin Within { get; set; }
		private IkhSeriesSonificationTracksMappingTremoloSpeedWithin Within_DefaultValue { get; set; }
