...
{
	public partial class IkhSeriesSonificationTracksMappingVolume  : BaseObject
	{
		Hashtable h = new Hashtable();

		public IkhSeriesSonificationTracksMappingVolume()
		{
			MapFunction = MapFunction_DefaultValue = IkhSeriesSonificationTracksMappingVolumeMapFunction.Linear;
			MapTo = MapTo_DefaultValue = "";
			Max = Max_DefaultValue = null;
			Min = Min_DefaultValue = null;
			Value = Value_DefaultValue = null;
			Within = Within_DefaultValue = IkhSeriesSonificationTracksMappingVolumeWithin.Chart;
		...
		/// </summary>
		public IkhSeriesSonificationTracksMappingVolumeMapFunction MapFunction { get; set; }
		private IkhSeriesSonificationTracksMappingVolumeMapFunction MapFunction_DefaultValue { get; set; }
		...
		/// </summary>
		public IkhSeriesSonificationTracksMappingVolumeWithin Within { get; set; }
		private IkhSeriesSonificationTracksMappingVolumeWithin Within_DefaultValue { get; set; }
