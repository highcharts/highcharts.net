...
{
	public partial class IkhSeriesTooltip  : BaseObject
	{
		public IkhSeriesTooltip()
		{
			...
			HeaderShape = HeaderShape_DefaultValue = IkhSeriesTooltipHeaderShape.Callout;
		...
		/// </summary>
		public IkhSeriesTooltipHeaderShape HeaderShape { get; set; }
		private IkhSeriesTooltipHeaderShape HeaderShape_DefaultValue { get; set; }
		...
		internal override Hashtable ToHashtable()
		{
			...
			if (NullFormatter != NullFormatter_DefaultValue) { h.Add("nullFormatter",NullFormatter); Highstock.AddFunction("IkhSeriesTooltipNullFormatter.nullFormatter", NullFormatter); }  
			if (Outside != Outside_DefaultValue) h.Add("outside",Outside);
			if (Padding != Padding_DefaultValue) h.Add("padding",Padding);
			if (PointFormat != PointFormat_DefaultValue) h.Add("pointFormat",PointFormat);
			if (PointFormatter != PointFormatter_DefaultValue) { h.Add("pointFormatter",PointFormatter); Highstock.AddFunction("IkhSeriesTooltipPointFormatter.pointFormatter", PointFormatter); }  
