...
{
	public partial class KeltnerchannelsSeries  : Series
	{
		Hashtable h = new Hashtable();

		public KeltnerchannelsSeries()
		{
			Accessibility = Accessibility_DefaultValue = new KeltnerchannelsSeriesAccessibility();
			AllowPointSelect = AllowPointSelect_DefaultValue = false;
			Animation = Animation_DefaultValue = new Animation() { Enabled = true };
			AnimationBool = AnimationBool_DefaultValue = true;
			AnimationLimit = AnimationLimit_DefaultValue = null;
			BoostBlending = BoostBlending_DefaultValue = KeltnerchannelsSeriesBoostBlending.Undefined;
			BoostThreshold = BoostThreshold_DefaultValue = 5000;
			BottomLine = BottomLine_DefaultValue = new KeltnerchannelsSeriesBottomLine();
			...
			Cursor = Cursor_DefaultValue = KeltnerchannelsSeriesCursor.Null;
			Custom = Custom_DefaultValue = new Hashtable();
			DashStyle = DashStyle_DefaultValue = KeltnerchannelsSeriesDashStyle.Null;
			DataGrouping = DataGrouping_DefaultValue = new KeltnerchannelsSeriesDataGrouping();
			DataLabels = DataLabels_DefaultValue = new KeltnerchannelsSeriesDataLabels();
			DataSorting = DataSorting_DefaultValue = new KeltnerchannelsSeriesDataSorting();
			Description = Description_DefaultValue = "";
			Dumbell = Dumbell_DefaultValue = new KeltnerchannelsSeriesDumbell();
			EnableMouseTracking = EnableMouseTracking_DefaultValue = true;
			Events = Events_DefaultValue = new KeltnerchannelsSeriesEvents();
			FillColor = FillColor_DefaultValue = "";
			FindNearestPointBy = FindNearestPointBy_DefaultValue = KeltnerchannelsSeriesFindNearestPointBy.X;
			GapSize = GapSize_DefaultValue = 0;
			GapUnit = GapUnit_DefaultValue = KeltnerchannelsSeriesGapUnit.Relative;
			GetExtremesFromAll = GetExtremesFromAll_DefaultValue = false;
			Id = Id_DefaultValue = "";
			InactiveOtherPoints = InactiveOtherPoints_DefaultValue = false;
			IncludeInDataExport = IncludeInDataExport_DefaultValue = null;
			Index = Index_DefaultValue = null;
			Label = Label_DefaultValue = new KeltnerchannelsSeriesLabel();
			LastPrice = LastPrice_DefaultValue = new KeltnerchannelsSeriesLastPrice();
			LastVisiblePrice = LastVisiblePrice_DefaultValue = new KeltnerchannelsSeriesLastVisiblePrice();
			LegendIndex = LegendIndex_DefaultValue = null;
			LegendSymbol = LegendSymbol_DefaultValue = KeltnerchannelsSeriesLegendSymbol.Rectangle;
			Linecap = Linecap_DefaultValue = KeltnerchannelsSeriesLinecap.Round;
			LineWidth = LineWidth_DefaultValue = 2;
			LinkedTo = LinkedTo_DefaultValue = "";
			Marker = Marker_DefaultValue = new KeltnerchannelsSeriesMarker();
			Name = Name_DefaultValue = "";
			NegativeColor = NegativeColor_DefaultValue = "";
			OnPoint = OnPoint_DefaultValue = new KeltnerchannelsSeriesOnPoint();
			Opacity = Opacity_DefaultValue = 1;
			Params = Params_DefaultValue = new KeltnerchannelsSeriesParams();
			Point = Point_DefaultValue = new KeltnerchannelsSeriesPoint();
			...
			Sonification = Sonification_DefaultValue = new KeltnerchannelsSeriesSonification();
			Stack = Stack_DefaultValue = "";
			StackNumber = StackNumber_DefaultValue = null;
			States = States_DefaultValue = new KeltnerchannelsSeriesStates();
			Step = Step_DefaultValue = KeltnerchannelsSeriesStep.Null;
			StickyTracking = StickyTracking_DefaultValue = true;
			Threshold = Threshold_DefaultValue = 0;
			Tooltip = Tooltip_DefaultValue = new KeltnerchannelsSeriesTooltip();
			TopLine = TopLine_DefaultValue = new KeltnerchannelsSeriesTopLine();
			...
			Zones = Zones_DefaultValue = new List<KeltnerchannelsSeriesZones>();
		...
		/// </summary>
		public KeltnerchannelsSeriesAccessibility Accessibility { get; set; }
		private KeltnerchannelsSeriesAccessibility Accessibility_DefaultValue { get; set; }
		...
		/// </summary>
		public KeltnerchannelsSeriesBoostBlending BoostBlending { get; set; }
		private KeltnerchannelsSeriesBoostBlending BoostBlending_DefaultValue { get; set; }
		...
		/// Bottom line options.
		/// </summary>
		public KeltnerchannelsSeriesBottomLine BottomLine { get; set; }
		private KeltnerchannelsSeriesBottomLine BottomLine_DefaultValue { get; set; }
		...
		/// </summary>
		public KeltnerchannelsSeriesCursor Cursor { get; set; }
		private KeltnerchannelsSeriesCursor Cursor_DefaultValue { get; set; }
		...
		/// </summary>
		public KeltnerchannelsSeriesDashStyle DashStyle { get; set; }
		private KeltnerchannelsSeriesDashStyle DashStyle_DefaultValue { get; set; }
		...
		/// </summary>
		public KeltnerchannelsSeriesDataGrouping DataGrouping { get; set; }
		private KeltnerchannelsSeriesDataGrouping DataGrouping_DefaultValue { get; set; }
		...
		/// </summary>
		public KeltnerchannelsSeriesDataLabels DataLabels { get; set; }
		private KeltnerchannelsSeriesDataLabels DataLabels_DefaultValue { get; set; }
		 

		/// <summary>
		/// Options for the series data sorting.
		/// </summary>
		public KeltnerchannelsSeriesDataSorting DataSorting { get; set; }
		private KeltnerchannelsSeriesDataSorting DataSorting_DefaultValue { get; set; }
		...
		/// 
		/// </summary>
		public KeltnerchannelsSeriesDumbell Dumbell { get; set; }
		private KeltnerchannelsSeriesDumbell Dumbell_DefaultValue { get; set; }
		...
		/// </summary>
		public KeltnerchannelsSeriesEvents Events { get; set; }
		private KeltnerchannelsSeriesEvents Events_DefaultValue { get; set; }
		...
		/// </summary>
		public KeltnerchannelsSeriesFindNearestPointBy FindNearestPointBy { get; set; }
		private KeltnerchannelsSeriesFindNearestPointBy FindNearestPointBy_DefaultValue { get; set; }
		...
		/// </summary>
		public KeltnerchannelsSeriesGapUnit GapUnit { get; set; }
		private KeltnerchannelsSeriesGapUnit GapUnit_DefaultValue { get; set; }
		...
		/// </summary>
		public KeltnerchannelsSeriesLabel Label { get; set; }
		private KeltnerchannelsSeriesLabel Label_DefaultValue { get; set; }
		 

		/// <summary>
		/// The line marks the last price from all points.
		/// </summary>
		public KeltnerchannelsSeriesLastPrice LastPrice { get; set; }
		private KeltnerchannelsSeriesLastPrice LastPrice_DefaultValue { get; set; }
		 

		/// <summary>
		/// The line marks the last price from visible range of points.
		/// </summary>
		public KeltnerchannelsSeriesLastVisiblePrice LastVisiblePrice { get; set; }
		private KeltnerchannelsSeriesLastVisiblePrice LastVisiblePrice_DefaultValue { get; set; }
		...
		/// </summary>
		public KeltnerchannelsSeriesLegendSymbol LegendSymbol { get; set; }
		private KeltnerchannelsSeriesLegendSymbol LegendSymbol_DefaultValue { get; set; }
		 

		/// <summary>
		/// The line cap used for line ends and line joins on the graph.
		/// </summary>
		public KeltnerchannelsSeriesLinecap Linecap { get; set; }
		private KeltnerchannelsSeriesLinecap Linecap_DefaultValue { get; set; }
		...
		/// </summary>
		public KeltnerchannelsSeriesMarker Marker { get; set; }
		private KeltnerchannelsSeriesMarker Marker_DefaultValue { get; set; }
		...
		/// </summary>
		public KeltnerchannelsSeriesOnPoint OnPoint { get; set; }
		private KeltnerchannelsSeriesOnPoint OnPoint_DefaultValue { get; set; }
		...
		/// </summary>
		public KeltnerchannelsSeriesParams Params { get; set; }
		private KeltnerchannelsSeriesParams Params_DefaultValue { get; set; }
		 

		/// <summary>
		/// Properties for each single point.
		/// </summary>
		public KeltnerchannelsSeriesPoint Point { get; set; }
		private KeltnerchannelsSeriesPoint Point_DefaultValue { get; set; }
		...
		/// </summary>
		public KeltnerchannelsSeriesSonification Sonification { get; set; }
		private KeltnerchannelsSeriesSonification Sonification_DefaultValue { get; set; }
		...
		/// 
		/// </summary>
		public KeltnerchannelsSeriesStates States { get; set; }
		private KeltnerchannelsSeriesStates States_DefaultValue { get; set; }
		 

		/// <summary>
		/// Whether to apply steps to the line. Possible values are `left`,`center` and `right`.
		/// </summary>
		public KeltnerchannelsSeriesStep Step { get; set; }
		private KeltnerchannelsSeriesStep Step_DefaultValue { get; set; }
		...
		/// </summary>
		public KeltnerchannelsSeriesTooltip Tooltip { get; set; }
		private KeltnerchannelsSeriesTooltip Tooltip_DefaultValue { get; set; }
		 

		/// <summary>
		/// Top line options.
		/// </summary>
		public KeltnerchannelsSeriesTopLine TopLine { get; set; }
		private KeltnerchannelsSeriesTopLine TopLine_DefaultValue { get; set; }
		...
		/// </summary>
		public List<KeltnerchannelsSeriesZones> Zones { get; set; }
		private List<KeltnerchannelsSeriesZones> Zones_DefaultValue { get; set; }
