...
namespace Highsoft.Web.Mvc.Stocks
{
	public partial class KeltnerchannelsSeries  : Series
	{
		...
		public KeltnerchannelsSeries()
		{
			...
			Zones = Zones_DefaultValue = new List<KeltnerchannelsSeriesZone>();
		...
		/// </summary>
		public List<KeltnerchannelsSeriesZone> Zones { get; set; }
		private List<KeltnerchannelsSeriesZone> Zones_DefaultValue { get; set; }
