...
{
	public partial class KeltnerchannelsSeriesDragDrop  : BaseObject
	{
		public KeltnerchannelsSeriesDragDrop()
		{
			DraggableX = DraggableX_DefaultValue = null;
			DraggableY = DraggableY_DefaultValue = null;
			DragHandle = DragHandle_DefaultValue = new KeltnerchannelsSeriesDragDropDragHandle();
			...
			GuideBox = GuideBox_DefaultValue = new KeltnerchannelsSeriesDragDropGuideBox();
		...
		/// </summary>
		public KeltnerchannelsSeriesDragDropDragHandle DragHandle { get; set; }
		private KeltnerchannelsSeriesDragDropDragHandle DragHandle_DefaultValue { get; set; }
		...
		/// </summary>
		public KeltnerchannelsSeriesDragDropGuideBox GuideBox { get; set; }
		private KeltnerchannelsSeriesDragDropGuideBox GuideBox_DefaultValue { get; set; }
