...
{
	public partial class KeltnerchannelsSeriesLabel  : BaseObject
	{
		public KeltnerchannelsSeriesLabel()
		{
			...
			Style = Style_DefaultValue = new KeltnerchannelsSeriesLabelStyle();
		...
		/// </summary>
		public KeltnerchannelsSeriesLabelStyle Style { get; set; }
		private KeltnerchannelsSeriesLabelStyle Style_DefaultValue { get; set; }
