...
{
	public partial class KeltnerchannelsSeriesLastVisiblePriceLabel  : BaseObject
	{
		Hashtable h = new Hashtable();

		public KeltnerchannelsSeriesLastVisiblePriceLabel()
		{
			Align = Align_DefaultValue = KeltnerchannelsSeriesLastVisiblePriceLabelAlign.Null;
		...
		/// 
		/// </summary>
		public KeltnerchannelsSeriesLastVisiblePriceLabelAlign Align { get; set; }
		private KeltnerchannelsSeriesLastVisiblePriceLabelAlign Align_DefaultValue { get; set; }
