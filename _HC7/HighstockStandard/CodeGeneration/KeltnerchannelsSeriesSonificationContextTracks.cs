...
{
	public partial class KeltnerchannelsSeriesSonificationContextTracks  : BaseObject
	{
		Hashtable h = new Hashtable();

		public KeltnerchannelsSeriesSonificationContextTracks()
		{
			ActiveWhen = ActiveWhen_DefaultValue = new KeltnerchannelsSeriesSonificationContextTracksActiveWhen();
			Instrument = Instrument_DefaultValue = null;
			InstrumentString = InstrumentString_DefaultValue = "null";
			Mapping = Mapping_DefaultValue = new KeltnerchannelsSeriesSonificationContextTracksMapping();
			MidiName = MidiName_DefaultValue = "";
			PointGrouping = PointGrouping_DefaultValue = new KeltnerchannelsSeriesSonificationContextTracksPointGrouping();
			...
			Type = Type_DefaultValue = KeltnerchannelsSeriesSonificationContextTracksType.Instrument;
			ValueInterval = ValueInterval_DefaultValue = null;
			ValueMapFunction = ValueMapFunction_DefaultValue = KeltnerchannelsSeriesSonificationContextTracksValueMapFunction.Linear;
		...
		/// </summary>
		public KeltnerchannelsSeriesSonificationContextTracksActiveWhen ActiveWhen { get; set; }
		private KeltnerchannelsSeriesSonificationContextTracksActiveWhen ActiveWhen_DefaultValue { get; set; }
		...
		/// </summary>
		public KeltnerchannelsSeriesSonificationContextTracksMapping Mapping { get; set; }
		private KeltnerchannelsSeriesSonificationContextTracksMapping Mapping_DefaultValue { get; set; }
		...
		/// </summary>
		public KeltnerchannelsSeriesSonificationContextTracksPointGrouping PointGrouping { get; set; }
		private KeltnerchannelsSeriesSonificationContextTracksPointGrouping PointGrouping_DefaultValue { get; set; }
		...
		/// </summary>
		public KeltnerchannelsSeriesSonificationContextTracksType Type { get; set; }
		private KeltnerchannelsSeriesSonificationContextTracksType Type_DefaultValue { get; set; }
		...
		/// </summary>
		public KeltnerchannelsSeriesSonificationContextTracksValueMapFunction ValueMapFunction { get; set; }
		private KeltnerchannelsSeriesSonificationContextTracksValueMapFunction ValueMapFunction_DefaultValue { get; set; }
