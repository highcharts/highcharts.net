...
{
	public partial class KeltnerchannelsSeriesSonificationContextTracksActiveWhen  : BaseObject
	{
		Hashtable h = new Hashtable();

		public KeltnerchannelsSeriesSonificationContextTracksActiveWhen()
		{
