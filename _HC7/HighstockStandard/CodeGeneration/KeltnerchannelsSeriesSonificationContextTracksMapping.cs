...
{
	public partial class KeltnerchannelsSeriesSonificationContextTracksMapping  : BaseObject
	{
		Hashtable h = new Hashtable();

		public KeltnerchannelsSeriesSonificationContextTracksMapping()
		{
			Frequency = Frequency_DefaultValue = new KeltnerchannelsSeriesSonificationContextTracksMappingFrequency();
			GapBetweenNotes = GapBetweenNotes_DefaultValue = new KeltnerchannelsSeriesSonificationContextTracksMappingGapBetweenNotes();
			Highpass = Highpass_DefaultValue = new KeltnerchannelsSeriesSonificationContextTracksMappingHighpass();
			Lowpass = Lowpass_DefaultValue = new KeltnerchannelsSeriesSonificationContextTracksMappingLowpass();
			NoteDuration = NoteDuration_DefaultValue = new KeltnerchannelsSeriesSonificationContextTracksMappingNoteDuration();
			Pan = Pan_DefaultValue = new KeltnerchannelsSeriesSonificationContextTracksMappingPan();
			Pitch = Pitch_DefaultValue = new KeltnerchannelsSeriesSonificationContextTracksMappingPitch();
			PitchString = PitchString_DefaultValue = "null";
			PitchNumber = PitchNumber_DefaultValue = null;
			PlayDelay = PlayDelay_DefaultValue = new KeltnerchannelsSeriesSonificationContextTracksMappingPlayDelay();
			Time = Time_DefaultValue = new KeltnerchannelsSeriesSonificationContextTracksMappingTime();
			TimeString = TimeString_DefaultValue = "null";
			TimeNumber = TimeNumber_DefaultValue = null;
			Tremolo = Tremolo_DefaultValue = new KeltnerchannelsSeriesSonificationContextTracksMappingTremolo();
			Volume = Volume_DefaultValue = new KeltnerchannelsSeriesSonificationContextTracksMappingVolume();
		...
		/// </summary>
		public KeltnerchannelsSeriesSonificationContextTracksMappingFrequency Frequency { get; set; }
		private KeltnerchannelsSeriesSonificationContextTracksMappingFrequency Frequency_DefaultValue { get; set; }
		...
		/// </summary>
		public KeltnerchannelsSeriesSonificationContextTracksMappingGapBetweenNotes GapBetweenNotes { get; set; }
		private KeltnerchannelsSeriesSonificationContextTracksMappingGapBetweenNotes GapBetweenNotes_DefaultValue { get; set; }
		...
		/// </summary>
		public KeltnerchannelsSeriesSonificationContextTracksMappingHighpass Highpass { get; set; }
		private KeltnerchannelsSeriesSonificationContextTracksMappingHighpass Highpass_DefaultValue { get; set; }
		...
		/// </summary>
		public KeltnerchannelsSeriesSonificationContextTracksMappingLowpass Lowpass { get; set; }
		private KeltnerchannelsSeriesSonificationContextTracksMappingLowpass Lowpass_DefaultValue { get; set; }
		...
		/// </summary>
		public KeltnerchannelsSeriesSonificationContextTracksMappingNoteDuration NoteDuration { get; set; }
		private KeltnerchannelsSeriesSonificationContextTracksMappingNoteDuration NoteDuration_DefaultValue { get; set; }
		...
		/// </summary>
		public KeltnerchannelsSeriesSonificationContextTracksMappingPan Pan { get; set; }
		private KeltnerchannelsSeriesSonificationContextTracksMappingPan Pan_DefaultValue { get; set; }
		...
		/// </summary>
		public KeltnerchannelsSeriesSonificationContextTracksMappingPitch Pitch { get; set; }
		private KeltnerchannelsSeriesSonificationContextTracksMappingPitch Pitch_DefaultValue { get; set; }
		...
		/// </summary>
		public KeltnerchannelsSeriesSonificationContextTracksMappingPlayDelay PlayDelay { get; set; }
		private KeltnerchannelsSeriesSonificationContextTracksMappingPlayDelay PlayDelay_DefaultValue { get; set; }
		...
		/// </summary>
		public KeltnerchannelsSeriesSonificationContextTracksMappingTime Time { get; set; }
		private KeltnerchannelsSeriesSonificationContextTracksMappingTime Time_DefaultValue { get; set; }
		...
		/// </summary>
		public KeltnerchannelsSeriesSonificationContextTracksMappingTremolo Tremolo { get; set; }
		private KeltnerchannelsSeriesSonificationContextTracksMappingTremolo Tremolo_DefaultValue { get; set; }
		 

		/// <summary>
		/// The volume of notes, from 0 to 1.
		/// </summary>
		public KeltnerchannelsSeriesSonificationContextTracksMappingVolume Volume { get; set; }
		private KeltnerchannelsSeriesSonificationContextTracksMappingVolume Volume_DefaultValue { get; set; }
