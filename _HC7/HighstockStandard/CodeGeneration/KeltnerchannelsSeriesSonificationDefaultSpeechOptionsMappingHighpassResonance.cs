...
{
	public partial class KeltnerchannelsSeriesSonificationDefaultSpeechOptionsMappingHighpassResonance  : BaseObject
	{
		Hashtable h = new Hashtable();

		public KeltnerchannelsSeriesSonificationDefaultSpeechOptionsMappingHighpassResonance()
		{
			MapFunction = MapFunction_DefaultValue = KeltnerchannelsSeriesSonificationDefaultSpeechOptionsMappingHighpassResonanceMapFunction.Linear;
			MapTo = MapTo_DefaultValue = "";
			Max = Max_DefaultValue = null;
			Min = Min_DefaultValue = null;
			Value = Value_DefaultValue = null;
			Within = Within_DefaultValue = KeltnerchannelsSeriesSonificationDefaultSpeechOptionsMappingHighpassResonanceWithin.Chart;
		...
		/// </summary>
		public KeltnerchannelsSeriesSonificationDefaultSpeechOptionsMappingHighpassResonanceMapFunction MapFunction { get; set; }
		private KeltnerchannelsSeriesSonificationDefaultSpeechOptionsMappingHighpassResonanceMapFunction MapFunction_DefaultValue { get; set; }
		...
		/// </summary>
		public KeltnerchannelsSeriesSonificationDefaultSpeechOptionsMappingHighpassResonanceWithin Within { get; set; }
		private KeltnerchannelsSeriesSonificationDefaultSpeechOptionsMappingHighpassResonanceWithin Within_DefaultValue { get; set; }
