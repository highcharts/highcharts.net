...
{
	public partial class KeltnerchannelsSeriesSonificationPointGrouping  : BaseObject
	{
		Hashtable h = new Hashtable();

		public KeltnerchannelsSeriesSonificationPointGrouping()
		{
			Algorithm = Algorithm_DefaultValue = KeltnerchannelsSeriesSonificationPointGroupingAlgorithm.Minimax;
		...
		/// </summary>
		public KeltnerchannelsSeriesSonificationPointGroupingAlgorithm Algorithm { get; set; }
		private KeltnerchannelsSeriesSonificationPointGroupingAlgorithm Algorithm_DefaultValue { get; set; }
