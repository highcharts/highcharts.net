...
{
	public partial class KeltnerchannelsSeriesSonificationTracks  : BaseObject
	{
		Hashtable h = new Hashtable();

		public KeltnerchannelsSeriesSonificationTracks()
		{
			ActiveWhen = ActiveWhen_DefaultValue = new KeltnerchannelsSeriesSonificationTracksActiveWhen();
			Instrument = Instrument_DefaultValue = null;
			InstrumentString = InstrumentString_DefaultValue = "null";
			Mapping = Mapping_DefaultValue = new KeltnerchannelsSeriesSonificationTracksMapping();
			MidiName = MidiName_DefaultValue = "";
			PointGrouping = PointGrouping_DefaultValue = new KeltnerchannelsSeriesSonificationTracksPointGrouping();
			RoundToMusicalNotes = RoundToMusicalNotes_DefaultValue = true;
			ShowPlayMarker = ShowPlayMarker_DefaultValue = true;
			Type = Type_DefaultValue = KeltnerchannelsSeriesSonificationTracksType.Instrument;
		...
		/// </summary>
		public KeltnerchannelsSeriesSonificationTracksActiveWhen ActiveWhen { get; set; }
		private KeltnerchannelsSeriesSonificationTracksActiveWhen ActiveWhen_DefaultValue { get; set; }
		...
		/// </summary>
		public KeltnerchannelsSeriesSonificationTracksMapping Mapping { get; set; }
		private KeltnerchannelsSeriesSonificationTracksMapping Mapping_DefaultValue { get; set; }
		...
		/// </summary>
		public KeltnerchannelsSeriesSonificationTracksPointGrouping PointGrouping { get; set; }
		private KeltnerchannelsSeriesSonificationTracksPointGrouping PointGrouping_DefaultValue { get; set; }
		...
		/// </summary>
		public KeltnerchannelsSeriesSonificationTracksType Type { get; set; }
		private KeltnerchannelsSeriesSonificationTracksType Type_DefaultValue { get; set; }
