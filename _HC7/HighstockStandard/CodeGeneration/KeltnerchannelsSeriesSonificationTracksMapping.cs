...
{
	public partial class KeltnerchannelsSeriesSonificationTracksMapping  : BaseObject
	{
		Hashtable h = new Hashtable();

		public KeltnerchannelsSeriesSonificationTracksMapping()
		{
			Frequency = Frequency_DefaultValue = new KeltnerchannelsSeriesSonificationTracksMappingFrequency();
			GapBetweenNotes = GapBetweenNotes_DefaultValue = new KeltnerchannelsSeriesSonificationTracksMappingGapBetweenNotes();
			Highpass = Highpass_DefaultValue = new KeltnerchannelsSeriesSonificationTracksMappingHighpass();
			Lowpass = Lowpass_DefaultValue = new KeltnerchannelsSeriesSonificationTracksMappingLowpass();
			NoteDuration = NoteDuration_DefaultValue = new KeltnerchannelsSeriesSonificationTracksMappingNoteDuration();
			Pan = Pan_DefaultValue = new KeltnerchannelsSeriesSonificationTracksMappingPan();
			Pitch = Pitch_DefaultValue = new KeltnerchannelsSeriesSonificationTracksMappingPitch();
			PitchString = PitchString_DefaultValue = "null";
			PitchNumber = PitchNumber_DefaultValue = null;
			PlayDelay = PlayDelay_DefaultValue = new KeltnerchannelsSeriesSonificationTracksMappingPlayDelay();
			Time = Time_DefaultValue = new KeltnerchannelsSeriesSonificationTracksMappingTime();
			TimeString = TimeString_DefaultValue = "null";
			TimeNumber = TimeNumber_DefaultValue = null;
			Tremolo = Tremolo_DefaultValue = new KeltnerchannelsSeriesSonificationTracksMappingTremolo();
			Volume = Volume_DefaultValue = new KeltnerchannelsSeriesSonificationTracksMappingVolume();
		...
		/// </summary>
		public KeltnerchannelsSeriesSonificationTracksMappingFrequency Frequency { get; set; }
		private KeltnerchannelsSeriesSonificationTracksMappingFrequency Frequency_DefaultValue { get; set; }
		...
		/// </summary>
		public KeltnerchannelsSeriesSonificationTracksMappingGapBetweenNotes GapBetweenNotes { get; set; }
		private KeltnerchannelsSeriesSonificationTracksMappingGapBetweenNotes GapBetweenNotes_DefaultValue { get; set; }
		...
		/// </summary>
		public KeltnerchannelsSeriesSonificationTracksMappingHighpass Highpass { get; set; }
		private KeltnerchannelsSeriesSonificationTracksMappingHighpass Highpass_DefaultValue { get; set; }
		...
		/// </summary>
		public KeltnerchannelsSeriesSonificationTracksMappingLowpass Lowpass { get; set; }
		private KeltnerchannelsSeriesSonificationTracksMappingLowpass Lowpass_DefaultValue { get; set; }
		...
		/// </summary>
		public KeltnerchannelsSeriesSonificationTracksMappingNoteDuration NoteDuration { get; set; }
		private KeltnerchannelsSeriesSonificationTracksMappingNoteDuration NoteDuration_DefaultValue { get; set; }
		...
		/// </summary>
		public KeltnerchannelsSeriesSonificationTracksMappingPan Pan { get; set; }
		private KeltnerchannelsSeriesSonificationTracksMappingPan Pan_DefaultValue { get; set; }
		...
		/// </summary>
		public KeltnerchannelsSeriesSonificationTracksMappingPitch Pitch { get; set; }
		private KeltnerchannelsSeriesSonificationTracksMappingPitch Pitch_DefaultValue { get; set; }
		...
		/// </summary>
		public KeltnerchannelsSeriesSonificationTracksMappingPlayDelay PlayDelay { get; set; }
		private KeltnerchannelsSeriesSonificationTracksMappingPlayDelay PlayDelay_DefaultValue { get; set; }
		...
		/// </summary>
		public KeltnerchannelsSeriesSonificationTracksMappingTime Time { get; set; }
		private KeltnerchannelsSeriesSonificationTracksMappingTime Time_DefaultValue { get; set; }
		...
		/// </summary>
		public KeltnerchannelsSeriesSonificationTracksMappingTremolo Tremolo { get; set; }
		private KeltnerchannelsSeriesSonificationTracksMappingTremolo Tremolo_DefaultValue { get; set; }
		 

		/// <summary>
		/// The volume of notes, from 0 to 1.
		/// </summary>
		public KeltnerchannelsSeriesSonificationTracksMappingVolume Volume { get; set; }
		private KeltnerchannelsSeriesSonificationTracksMappingVolume Volume_DefaultValue { get; set; }
