...
{
	public partial class KeltnerchannelsSeriesSonificationTracksMappingLowpassResonance  : BaseObject
	{
		Hashtable h = new Hashtable();

		public KeltnerchannelsSeriesSonificationTracksMappingLowpassResonance()
		{
			MapFunction = MapFunction_DefaultValue = KeltnerchannelsSeriesSonificationTracksMappingLowpassResonanceMapFunction.Linear;
			MapTo = MapTo_DefaultValue = "";
			Max = Max_DefaultValue = null;
			Min = Min_DefaultValue = null;
			Value = Value_DefaultValue = null;
			Within = Within_DefaultValue = KeltnerchannelsSeriesSonificationTracksMappingLowpassResonanceWithin.Chart;
		...
		/// </summary>
		public KeltnerchannelsSeriesSonificationTracksMappingLowpassResonanceMapFunction MapFunction { get; set; }
		private KeltnerchannelsSeriesSonificationTracksMappingLowpassResonanceMapFunction MapFunction_DefaultValue { get; set; }
		...
		/// </summary>
		public KeltnerchannelsSeriesSonificationTracksMappingLowpassResonanceWithin Within { get; set; }
		private KeltnerchannelsSeriesSonificationTracksMappingLowpassResonanceWithin Within_DefaultValue { get; set; }
