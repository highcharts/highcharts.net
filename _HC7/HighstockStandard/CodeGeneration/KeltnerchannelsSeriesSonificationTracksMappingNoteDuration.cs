...
{
	public partial class KeltnerchannelsSeriesSonificationTracksMappingNoteDuration  : BaseObject
	{
		Hashtable h = new Hashtable();

		public KeltnerchannelsSeriesSonificationTracksMappingNoteDuration()
		{
			MapFunction = MapFunction_DefaultValue = KeltnerchannelsSeriesSonificationTracksMappingNoteDurationMapFunction.Linear;
			MapTo = MapTo_DefaultValue = "";
			Max = Max_DefaultValue = null;
			Min = Min_DefaultValue = null;
			Value = Value_DefaultValue = null;
			Within = Within_DefaultValue = KeltnerchannelsSeriesSonificationTracksMappingNoteDurationWithin.Chart;
		...
		/// </summary>
		public KeltnerchannelsSeriesSonificationTracksMappingNoteDurationMapFunction MapFunction { get; set; }
		private KeltnerchannelsSeriesSonificationTracksMappingNoteDurationMapFunction MapFunction_DefaultValue { get; set; }
		...
		/// </summary>
		public KeltnerchannelsSeriesSonificationTracksMappingNoteDurationWithin Within { get; set; }
		private KeltnerchannelsSeriesSonificationTracksMappingNoteDurationWithin Within_DefaultValue { get; set; }
