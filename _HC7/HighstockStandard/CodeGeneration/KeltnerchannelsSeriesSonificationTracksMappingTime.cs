...
{
	public partial class KeltnerchannelsSeriesSonificationTracksMappingTime  : BaseObject
	{
		Hashtable h = new Hashtable();

		public KeltnerchannelsSeriesSonificationTracksMappingTime()
		{
			MapFunction = MapFunction_DefaultValue = KeltnerchannelsSeriesSonificationTracksMappingTimeMapFunction.Linear;
			MapTo = MapTo_DefaultValue = "";
			Max = Max_DefaultValue = null;
			Min = Min_DefaultValue = null;
			Value = Value_DefaultValue = null;
			Within = Within_DefaultValue = KeltnerchannelsSeriesSonificationTracksMappingTimeWithin.Chart;
		...
		/// </summary>
		public KeltnerchannelsSeriesSonificationTracksMappingTimeMapFunction MapFunction { get; set; }
		private KeltnerchannelsSeriesSonificationTracksMappingTimeMapFunction MapFunction_DefaultValue { get; set; }
		...
		/// </summary>
		public KeltnerchannelsSeriesSonificationTracksMappingTimeWithin Within { get; set; }
		private KeltnerchannelsSeriesSonificationTracksMappingTimeWithin Within_DefaultValue { get; set; }
