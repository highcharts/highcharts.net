...
{
	public partial class KeltnerchannelsSeriesStatesSelect  : BaseObject
	{
		Hashtable h = new Hashtable();

		public KeltnerchannelsSeriesStatesSelect()
		{
			Animation = Animation_DefaultValue = new Animation() { Enabled = true };
			Enabled = Enabled_DefaultValue = null;
			Halo = Halo_DefaultValue = new KeltnerchannelsSeriesStatesSelectHalo();
			LineWidth = LineWidth_DefaultValue = null;
			LineWidthPlus = LineWidthPlus_DefaultValue = null;
			Marker = Marker_DefaultValue = new KeltnerchannelsSeriesStatesSelectMarker();
		...
		/// </summary>
		public KeltnerchannelsSeriesStatesSelectHalo Halo { get; set; }
		private KeltnerchannelsSeriesStatesSelectHalo Halo_DefaultValue { get; set; }
		...
		/// </summary>
		public KeltnerchannelsSeriesStatesSelectMarker Marker { get; set; }
		private KeltnerchannelsSeriesStatesSelectMarker Marker_DefaultValue { get; set; }
