...
{
	public partial class KeltnerchannelsSeriesTooltip  : BaseObject
	{
		public KeltnerchannelsSeriesTooltip()
		{
			...
			HeaderShape = HeaderShape_DefaultValue = KeltnerchannelsSeriesTooltipHeaderShape.Callout;
		...
		/// </summary>
		public KeltnerchannelsSeriesTooltipHeaderShape HeaderShape { get; set; }
		private KeltnerchannelsSeriesTooltipHeaderShape HeaderShape_DefaultValue { get; set; }
		...
		internal override Hashtable ToHashtable()
		{
			...
			if (NullFormatter != NullFormatter_DefaultValue) { h.Add("nullFormatter",NullFormatter); Highstock.AddFunction("KeltnerchannelsSeriesTooltipNullFormatter.nullFormatter", NullFormatter); }  
			if (Outside != Outside_DefaultValue) h.Add("outside",Outside);
			if (Padding != Padding_DefaultValue) h.Add("padding",Padding);
			if (PointFormat != PointFormat_DefaultValue) h.Add("pointFormat",PointFormat);
			if (PointFormatter != PointFormatter_DefaultValue) { h.Add("pointFormatter",PointFormatter); Highstock.AddFunction("KeltnerchannelsSeriesTooltipPointFormatter.pointFormatter", PointFormatter); }  
