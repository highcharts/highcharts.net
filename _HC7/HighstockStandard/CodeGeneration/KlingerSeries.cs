...
namespace Highsoft.Web.Mvc.Stocks
{
	public partial class KlingerSeries  : Series
	{
		...
		public KlingerSeries()
		{
			...
			Zones = Zones_DefaultValue = new List<KlingerSeriesZone>();
		...
		/// </summary>
		public List<KlingerSeriesZone> Zones { get; set; }
		private List<KlingerSeriesZone> Zones_DefaultValue { get; set; }
