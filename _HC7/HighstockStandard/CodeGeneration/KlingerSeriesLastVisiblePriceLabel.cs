...
{
	public partial class KlingerSeriesLastVisiblePriceLabel  : BaseObject
	{
		Hashtable h = new Hashtable();

		public KlingerSeriesLastVisiblePriceLabel()
		{
			Align = Align_DefaultValue = KlingerSeriesLastVisiblePriceLabelAlign.Null;
		...
		/// 
		/// </summary>
		public KlingerSeriesLastVisiblePriceLabelAlign Align { get; set; }
		private KlingerSeriesLastVisiblePriceLabelAlign Align_DefaultValue { get; set; }
