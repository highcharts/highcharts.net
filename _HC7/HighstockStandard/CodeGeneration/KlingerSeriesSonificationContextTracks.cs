...
{
	public partial class KlingerSeriesSonificationContextTracks  : BaseObject
	{
		Hashtable h = new Hashtable();

		public KlingerSeriesSonificationContextTracks()
		{
			ActiveWhen = ActiveWhen_DefaultValue = new KlingerSeriesSonificationContextTracksActiveWhen();
			Instrument = Instrument_DefaultValue = null;
			InstrumentString = InstrumentString_DefaultValue = "null";
			Mapping = Mapping_DefaultValue = new KlingerSeriesSonificationContextTracksMapping();
			MidiName = MidiName_DefaultValue = "";
			PointGrouping = PointGrouping_DefaultValue = new KlingerSeriesSonificationContextTracksPointGrouping();
			...
			Type = Type_DefaultValue = KlingerSeriesSonificationContextTracksType.Instrument;
			ValueInterval = ValueInterval_DefaultValue = null;
			ValueMapFunction = ValueMapFunction_DefaultValue = KlingerSeriesSonificationContextTracksValueMapFunction.Linear;
		...
		/// </summary>
		public KlingerSeriesSonificationContextTracksActiveWhen ActiveWhen { get; set; }
		private KlingerSeriesSonificationContextTracksActiveWhen ActiveWhen_DefaultValue { get; set; }
		...
		/// </summary>
		public KlingerSeriesSonificationContextTracksMapping Mapping { get; set; }
		private KlingerSeriesSonificationContextTracksMapping Mapping_DefaultValue { get; set; }
		...
		/// </summary>
		public KlingerSeriesSonificationContextTracksPointGrouping PointGrouping { get; set; }
		private KlingerSeriesSonificationContextTracksPointGrouping PointGrouping_DefaultValue { get; set; }
		...
		/// </summary>
		public KlingerSeriesSonificationContextTracksType Type { get; set; }
		private KlingerSeriesSonificationContextTracksType Type_DefaultValue { get; set; }
		...
		/// </summary>
		public KlingerSeriesSonificationContextTracksValueMapFunction ValueMapFunction { get; set; }
		private KlingerSeriesSonificationContextTracksValueMapFunction ValueMapFunction_DefaultValue { get; set; }
