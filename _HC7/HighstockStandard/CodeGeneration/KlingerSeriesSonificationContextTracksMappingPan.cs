...
{
	public partial class KlingerSeriesSonificationContextTracksMappingPan  : BaseObject
	{
		Hashtable h = new Hashtable();

		public KlingerSeriesSonificationContextTracksMappingPan()
		{
			MapFunction = MapFunction_DefaultValue = KlingerSeriesSonificationContextTracksMappingPanMapFunction.Linear;
			MapTo = MapTo_DefaultValue = "";
			Max = Max_DefaultValue = null;
			Min = Min_DefaultValue = null;
			Value = Value_DefaultValue = null;
			Within = Within_DefaultValue = KlingerSeriesSonificationContextTracksMappingPanWithin.Chart;
		...
		/// </summary>
		public KlingerSeriesSonificationContextTracksMappingPanMapFunction MapFunction { get; set; }
		private KlingerSeriesSonificationContextTracksMappingPanMapFunction MapFunction_DefaultValue { get; set; }
		...
		/// </summary>
		public KlingerSeriesSonificationContextTracksMappingPanWithin Within { get; set; }
		private KlingerSeriesSonificationContextTracksMappingPanWithin Within_DefaultValue { get; set; }
