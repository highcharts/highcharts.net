...
{
	public partial class KlingerSeriesSonificationContextTracksMappingPitch  : BaseObject
	{
		Hashtable h = new Hashtable();

		public KlingerSeriesSonificationContextTracksMappingPitch()
		{
			MapFunction = MapFunction_DefaultValue = KlingerSeriesSonificationContextTracksMappingPitchMapFunction.Linear;
		...
		/// </summary>
		public KlingerSeriesSonificationContextTracksMappingPitchMapFunction MapFunction { get; set; }
		private KlingerSeriesSonificationContextTracksMappingPitchMapFunction MapFunction_DefaultValue { get; set; }
