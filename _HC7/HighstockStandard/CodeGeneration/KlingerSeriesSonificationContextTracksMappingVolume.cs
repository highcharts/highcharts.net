...
{
	public partial class KlingerSeriesSonificationContextTracksMappingVolume  : BaseObject
	{
		Hashtable h = new Hashtable();

		public KlingerSeriesSonificationContextTracksMappingVolume()
		{
			MapFunction = MapFunction_DefaultValue = KlingerSeriesSonificationContextTracksMappingVolumeMapFunction.Linear;
			MapTo = MapTo_DefaultValue = "";
			Max = Max_DefaultValue = null;
			Min = Min_DefaultValue = null;
			Value = Value_DefaultValue = null;
			Within = Within_DefaultValue = KlingerSeriesSonificationContextTracksMappingVolumeWithin.Chart;
		...
		/// </summary>
		public KlingerSeriesSonificationContextTracksMappingVolumeMapFunction MapFunction { get; set; }
		private KlingerSeriesSonificationContextTracksMappingVolumeMapFunction MapFunction_DefaultValue { get; set; }
		...
		/// </summary>
		public KlingerSeriesSonificationContextTracksMappingVolumeWithin Within { get; set; }
		private KlingerSeriesSonificationContextTracksMappingVolumeWithin Within_DefaultValue { get; set; }
