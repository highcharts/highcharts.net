...
{
	public partial class KlingerSeriesSonificationDefaultInstrumentOptions  : BaseObject
	{
		Hashtable h = new Hashtable();

		public KlingerSeriesSonificationDefaultInstrumentOptions()
		{
			ActiveWhen = ActiveWhen_DefaultValue = new KlingerSeriesSonificationDefaultInstrumentOptionsActiveWhen();
			Instrument = Instrument_DefaultValue = null;
			InstrumentString = InstrumentString_DefaultValue = "null";
			Mapping = Mapping_DefaultValue = new KlingerSeriesSonificationDefaultInstrumentOptionsMapping();
			MidiName = MidiName_DefaultValue = "";
			PointGrouping = PointGrouping_DefaultValue = new KlingerSeriesSonificationDefaultInstrumentOptionsPointGrouping();
			RoundToMusicalNotes = RoundToMusicalNotes_DefaultValue = true;
			ShowPlayMarker = ShowPlayMarker_DefaultValue = true;
			Type = Type_DefaultValue = KlingerSeriesSonificationDefaultInstrumentOptionsType.Instrument;
		...
		/// </summary>
		public KlingerSeriesSonificationDefaultInstrumentOptionsActiveWhen ActiveWhen { get; set; }
		private KlingerSeriesSonificationDefaultInstrumentOptionsActiveWhen ActiveWhen_DefaultValue { get; set; }
		...
		/// </summary>
		public KlingerSeriesSonificationDefaultInstrumentOptionsMapping Mapping { get; set; }
		private KlingerSeriesSonificationDefaultInstrumentOptionsMapping Mapping_DefaultValue { get; set; }
		...
		/// </summary>
		public KlingerSeriesSonificationDefaultInstrumentOptionsPointGrouping PointGrouping { get; set; }
		private KlingerSeriesSonificationDefaultInstrumentOptionsPointGrouping PointGrouping_DefaultValue { get; set; }
		...
		/// </summary>
		public KlingerSeriesSonificationDefaultInstrumentOptionsType Type { get; set; }
		private KlingerSeriesSonificationDefaultInstrumentOptionsType Type_DefaultValue { get; set; }
