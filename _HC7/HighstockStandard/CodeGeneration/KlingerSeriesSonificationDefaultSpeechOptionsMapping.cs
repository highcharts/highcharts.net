...
{
	public partial class KlingerSeriesSonificationDefaultSpeechOptionsMapping  : BaseObject
	{
		Hashtable h = new Hashtable();

		public KlingerSeriesSonificationDefaultSpeechOptionsMapping()
		{
			Frequency = Frequency_DefaultValue = new KlingerSeriesSonificationDefaultSpeechOptionsMappingFrequency();
			GapBetweenNotes = GapBetweenNotes_DefaultValue = new KlingerSeriesSonificationDefaultSpeechOptionsMappingGapBetweenNotes();
			Highpass = Highpass_DefaultValue = new KlingerSeriesSonificationDefaultSpeechOptionsMappingHighpass();
			Lowpass = Lowpass_DefaultValue = new KlingerSeriesSonificationDefaultSpeechOptionsMappingLowpass();
			NoteDuration = NoteDuration_DefaultValue = new KlingerSeriesSonificationDefaultSpeechOptionsMappingNoteDuration();
			Pan = Pan_DefaultValue = new KlingerSeriesSonificationDefaultSpeechOptionsMappingPan();
			Pitch = Pitch_DefaultValue = new KlingerSeriesSonificationDefaultSpeechOptionsMappingPitch();
			PitchString = PitchString_DefaultValue = "null";
			PitchNumber = PitchNumber_DefaultValue = null;
			PlayDelay = PlayDelay_DefaultValue = new KlingerSeriesSonificationDefaultSpeechOptionsMappingPlayDelay();
			Time = Time_DefaultValue = new KlingerSeriesSonificationDefaultSpeechOptionsMappingTime();
			TimeString = TimeString_DefaultValue = "null";
			TimeNumber = TimeNumber_DefaultValue = null;
			Tremolo = Tremolo_DefaultValue = new KlingerSeriesSonificationDefaultSpeechOptionsMappingTremolo();
			Volume = Volume_DefaultValue = new KlingerSeriesSonificationDefaultSpeechOptionsMappingVolume();
		...
		/// </summary>
		public KlingerSeriesSonificationDefaultSpeechOptionsMappingFrequency Frequency { get; set; }
		private KlingerSeriesSonificationDefaultSpeechOptionsMappingFrequency Frequency_DefaultValue { get; set; }
		...
		/// </summary>
		public KlingerSeriesSonificationDefaultSpeechOptionsMappingGapBetweenNotes GapBetweenNotes { get; set; }
		private KlingerSeriesSonificationDefaultSpeechOptionsMappingGapBetweenNotes GapBetweenNotes_DefaultValue { get; set; }
		...
		/// </summary>
		public KlingerSeriesSonificationDefaultSpeechOptionsMappingHighpass Highpass { get; set; }
		private KlingerSeriesSonificationDefaultSpeechOptionsMappingHighpass Highpass_DefaultValue { get; set; }
		...
		/// </summary>
		public KlingerSeriesSonificationDefaultSpeechOptionsMappingLowpass Lowpass { get; set; }
		private KlingerSeriesSonificationDefaultSpeechOptionsMappingLowpass Lowpass_DefaultValue { get; set; }
		...
		/// </summary>
		public KlingerSeriesSonificationDefaultSpeechOptionsMappingNoteDuration NoteDuration { get; set; }
		private KlingerSeriesSonificationDefaultSpeechOptionsMappingNoteDuration NoteDuration_DefaultValue { get; set; }
		...
		/// </summary>
		public KlingerSeriesSonificationDefaultSpeechOptionsMappingPan Pan { get; set; }
		private KlingerSeriesSonificationDefaultSpeechOptionsMappingPan Pan_DefaultValue { get; set; }
		...
		/// </summary>
		public KlingerSeriesSonificationDefaultSpeechOptionsMappingPitch Pitch { get; set; }
		private KlingerSeriesSonificationDefaultSpeechOptionsMappingPitch Pitch_DefaultValue { get; set; }
		...
		/// </summary>
		public KlingerSeriesSonificationDefaultSpeechOptionsMappingPlayDelay PlayDelay { get; set; }
		private KlingerSeriesSonificationDefaultSpeechOptionsMappingPlayDelay PlayDelay_DefaultValue { get; set; }
		...
		/// </summary>
		public KlingerSeriesSonificationDefaultSpeechOptionsMappingTime Time { get; set; }
		private KlingerSeriesSonificationDefaultSpeechOptionsMappingTime Time_DefaultValue { get; set; }
		...
		/// </summary>
		public KlingerSeriesSonificationDefaultSpeechOptionsMappingTremolo Tremolo { get; set; }
		private KlingerSeriesSonificationDefaultSpeechOptionsMappingTremolo Tremolo_DefaultValue { get; set; }
		 

		/// <summary>
		/// The volume of notes, from 0 to 1.
		/// </summary>
		public KlingerSeriesSonificationDefaultSpeechOptionsMappingVolume Volume { get; set; }
		private KlingerSeriesSonificationDefaultSpeechOptionsMappingVolume Volume_DefaultValue { get; set; }
