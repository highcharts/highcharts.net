...
{
	public partial class KlingerSeriesSonificationPointGrouping  : BaseObject
	{
		Hashtable h = new Hashtable();

		public KlingerSeriesSonificationPointGrouping()
		{
			Algorithm = Algorithm_DefaultValue = KlingerSeriesSonificationPointGroupingAlgorithm.Minimax;
		...
		/// </summary>
		public KlingerSeriesSonificationPointGroupingAlgorithm Algorithm { get; set; }
		private KlingerSeriesSonificationPointGroupingAlgorithm Algorithm_DefaultValue { get; set; }
