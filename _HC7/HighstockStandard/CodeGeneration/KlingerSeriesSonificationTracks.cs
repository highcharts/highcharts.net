...
{
	public partial class KlingerSeriesSonificationTracks  : BaseObject
	{
		Hashtable h = new Hashtable();

		public KlingerSeriesSonificationTracks()
		{
			ActiveWhen = ActiveWhen_DefaultValue = new KlingerSeriesSonificationTracksActiveWhen();
			Instrument = Instrument_DefaultValue = null;
			InstrumentString = InstrumentString_DefaultValue = "null";
			Mapping = Mapping_DefaultValue = new KlingerSeriesSonificationTracksMapping();
			MidiName = MidiName_DefaultValue = "";
			PointGrouping = PointGrouping_DefaultValue = new KlingerSeriesSonificationTracksPointGrouping();
			RoundToMusicalNotes = RoundToMusicalNotes_DefaultValue = true;
			ShowPlayMarker = ShowPlayMarker_DefaultValue = true;
			Type = Type_DefaultValue = KlingerSeriesSonificationTracksType.Instrument;
		...
		/// </summary>
		public KlingerSeriesSonificationTracksActiveWhen ActiveWhen { get; set; }
		private KlingerSeriesSonificationTracksActiveWhen ActiveWhen_DefaultValue { get; set; }
		...
		/// </summary>
		public KlingerSeriesSonificationTracksMapping Mapping { get; set; }
		private KlingerSeriesSonificationTracksMapping Mapping_DefaultValue { get; set; }
		...
		/// </summary>
		public KlingerSeriesSonificationTracksPointGrouping PointGrouping { get; set; }
		private KlingerSeriesSonificationTracksPointGrouping PointGrouping_DefaultValue { get; set; }
		...
		/// </summary>
		public KlingerSeriesSonificationTracksType Type { get; set; }
		private KlingerSeriesSonificationTracksType Type_DefaultValue { get; set; }
