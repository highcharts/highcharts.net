...
{
	public partial class KlingerSeriesSonificationTracksMapping  : BaseObject
	{
		Hashtable h = new Hashtable();

		public KlingerSeriesSonificationTracksMapping()
		{
			Frequency = Frequency_DefaultValue = new KlingerSeriesSonificationTracksMappingFrequency();
			GapBetweenNotes = GapBetweenNotes_DefaultValue = new KlingerSeriesSonificationTracksMappingGapBetweenNotes();
			Highpass = Highpass_DefaultValue = new KlingerSeriesSonificationTracksMappingHighpass();
			Lowpass = Lowpass_DefaultValue = new KlingerSeriesSonificationTracksMappingLowpass();
			NoteDuration = NoteDuration_DefaultValue = new KlingerSeriesSonificationTracksMappingNoteDuration();
			Pan = Pan_DefaultValue = new KlingerSeriesSonificationTracksMappingPan();
			Pitch = Pitch_DefaultValue = new KlingerSeriesSonificationTracksMappingPitch();
			PitchString = PitchString_DefaultValue = "null";
			PitchNumber = PitchNumber_DefaultValue = null;
			PlayDelay = PlayDelay_DefaultValue = new KlingerSeriesSonificationTracksMappingPlayDelay();
			Time = Time_DefaultValue = new KlingerSeriesSonificationTracksMappingTime();
			TimeString = TimeString_DefaultValue = "null";
			TimeNumber = TimeNumber_DefaultValue = null;
			Tremolo = Tremolo_DefaultValue = new KlingerSeriesSonificationTracksMappingTremolo();
			Volume = Volume_DefaultValue = new KlingerSeriesSonificationTracksMappingVolume();
		...
		/// </summary>
		public KlingerSeriesSonificationTracksMappingFrequency Frequency { get; set; }
		private KlingerSeriesSonificationTracksMappingFrequency Frequency_DefaultValue { get; set; }
		...
		/// </summary>
		public KlingerSeriesSonificationTracksMappingGapBetweenNotes GapBetweenNotes { get; set; }
		private KlingerSeriesSonificationTracksMappingGapBetweenNotes GapBetweenNotes_DefaultValue { get; set; }
		...
		/// </summary>
		public KlingerSeriesSonificationTracksMappingHighpass Highpass { get; set; }
		private KlingerSeriesSonificationTracksMappingHighpass Highpass_DefaultValue { get; set; }
		...
		/// </summary>
		public KlingerSeriesSonificationTracksMappingLowpass Lowpass { get; set; }
		private KlingerSeriesSonificationTracksMappingLowpass Lowpass_DefaultValue { get; set; }
		...
		/// </summary>
		public KlingerSeriesSonificationTracksMappingNoteDuration NoteDuration { get; set; }
		private KlingerSeriesSonificationTracksMappingNoteDuration NoteDuration_DefaultValue { get; set; }
		...
		/// </summary>
		public KlingerSeriesSonificationTracksMappingPan Pan { get; set; }
		private KlingerSeriesSonificationTracksMappingPan Pan_DefaultValue { get; set; }
		...
		/// </summary>
		public KlingerSeriesSonificationTracksMappingPitch Pitch { get; set; }
		private KlingerSeriesSonificationTracksMappingPitch Pitch_DefaultValue { get; set; }
		...
		/// </summary>
		public KlingerSeriesSonificationTracksMappingPlayDelay PlayDelay { get; set; }
		private KlingerSeriesSonificationTracksMappingPlayDelay PlayDelay_DefaultValue { get; set; }
		...
		/// </summary>
		public KlingerSeriesSonificationTracksMappingTime Time { get; set; }
		private KlingerSeriesSonificationTracksMappingTime Time_DefaultValue { get; set; }
		...
		/// </summary>
		public KlingerSeriesSonificationTracksMappingTremolo Tremolo { get; set; }
		private KlingerSeriesSonificationTracksMappingTremolo Tremolo_DefaultValue { get; set; }
		 

		/// <summary>
		/// The volume of notes, from 0 to 1.
		/// </summary>
		public KlingerSeriesSonificationTracksMappingVolume Volume { get; set; }
		private KlingerSeriesSonificationTracksMappingVolume Volume_DefaultValue { get; set; }
