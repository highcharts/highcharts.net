...
{
	public partial class KlingerSeriesSonificationTracksMappingFrequency  : BaseObject
	{
		Hashtable h = new Hashtable();

		public KlingerSeriesSonificationTracksMappingFrequency()
		{
			MapFunction = MapFunction_DefaultValue = KlingerSeriesSonificationTracksMappingFrequencyMapFunction.Linear;
			MapTo = MapTo_DefaultValue = "";
			Max = Max_DefaultValue = null;
			Min = Min_DefaultValue = null;
			Value = Value_DefaultValue = null;
			Within = Within_DefaultValue = KlingerSeriesSonificationTracksMappingFrequencyWithin.Chart;
		...
		/// </summary>
		public KlingerSeriesSonificationTracksMappingFrequencyMapFunction MapFunction { get; set; }
		private KlingerSeriesSonificationTracksMappingFrequencyMapFunction MapFunction_DefaultValue { get; set; }
		...
		/// </summary>
		public KlingerSeriesSonificationTracksMappingFrequencyWithin Within { get; set; }
		private KlingerSeriesSonificationTracksMappingFrequencyWithin Within_DefaultValue { get; set; }
