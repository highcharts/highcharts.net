...
{
	public partial class KlingerSeriesSonificationTracksMappingHighpassResonance  : BaseObject
	{
		Hashtable h = new Hashtable();

		public KlingerSeriesSonificationTracksMappingHighpassResonance()
		{
			MapFunction = MapFunction_DefaultValue = KlingerSeriesSonificationTracksMappingHighpassResonanceMapFunction.Linear;
			MapTo = MapTo_DefaultValue = "";
			Max = Max_DefaultValue = null;
			Min = Min_DefaultValue = null;
			Value = Value_DefaultValue = null;
			Within = Within_DefaultValue = KlingerSeriesSonificationTracksMappingHighpassResonanceWithin.Chart;
		...
		/// </summary>
		public KlingerSeriesSonificationTracksMappingHighpassResonanceMapFunction MapFunction { get; set; }
		private KlingerSeriesSonificationTracksMappingHighpassResonanceMapFunction MapFunction_DefaultValue { get; set; }
		...
		/// </summary>
		public KlingerSeriesSonificationTracksMappingHighpassResonanceWithin Within { get; set; }
		private KlingerSeriesSonificationTracksMappingHighpassResonanceWithin Within_DefaultValue { get; set; }
