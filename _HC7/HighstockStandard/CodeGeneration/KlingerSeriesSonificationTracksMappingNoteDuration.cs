...
{
	public partial class KlingerSeriesSonificationTracksMappingNoteDuration  : BaseObject
	{
		Hashtable h = new Hashtable();

		public KlingerSeriesSonificationTracksMappingNoteDuration()
		{
			MapFunction = MapFunction_DefaultValue = KlingerSeriesSonificationTracksMappingNoteDurationMapFunction.Linear;
			MapTo = MapTo_DefaultValue = "";
			Max = Max_DefaultValue = null;
			Min = Min_DefaultValue = null;
			Value = Value_DefaultValue = null;
			Within = Within_DefaultValue = KlingerSeriesSonificationTracksMappingNoteDurationWithin.Chart;
		...
		/// </summary>
		public KlingerSeriesSonificationTracksMappingNoteDurationMapFunction MapFunction { get; set; }
		private KlingerSeriesSonificationTracksMappingNoteDurationMapFunction MapFunction_DefaultValue { get; set; }
		...
		/// </summary>
		public KlingerSeriesSonificationTracksMappingNoteDurationWithin Within { get; set; }
		private KlingerSeriesSonificationTracksMappingNoteDurationWithin Within_DefaultValue { get; set; }
