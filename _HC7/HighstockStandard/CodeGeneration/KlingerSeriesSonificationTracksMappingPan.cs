...
{
	public partial class KlingerSeriesSonificationTracksMappingPan  : BaseObject
	{
		Hashtable h = new Hashtable();

		public KlingerSeriesSonificationTracksMappingPan()
		{
			MapFunction = MapFunction_DefaultValue = KlingerSeriesSonificationTracksMappingPanMapFunction.Linear;
			MapTo = MapTo_DefaultValue = "";
			Max = Max_DefaultValue = null;
			Min = Min_DefaultValue = null;
			Value = Value_DefaultValue = null;
			Within = Within_DefaultValue = KlingerSeriesSonificationTracksMappingPanWithin.Chart;
		...
		/// </summary>
		public KlingerSeriesSonificationTracksMappingPanMapFunction MapFunction { get; set; }
		private KlingerSeriesSonificationTracksMappingPanMapFunction MapFunction_DefaultValue { get; set; }
		...
		/// </summary>
		public KlingerSeriesSonificationTracksMappingPanWithin Within { get; set; }
		private KlingerSeriesSonificationTracksMappingPanWithin Within_DefaultValue { get; set; }
