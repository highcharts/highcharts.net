...
{
	public partial class KlingerSeriesSonificationTracksMappingPitch  : BaseObject
	{
		Hashtable h = new Hashtable();

		public KlingerSeriesSonificationTracksMappingPitch()
		{
			MapFunction = MapFunction_DefaultValue = KlingerSeriesSonificationTracksMappingPitchMapFunction.Linear;
		...
		/// </summary>
		public KlingerSeriesSonificationTracksMappingPitchMapFunction MapFunction { get; set; }
		private KlingerSeriesSonificationTracksMappingPitchMapFunction MapFunction_DefaultValue { get; set; }
