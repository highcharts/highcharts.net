...
{
	public partial class KlingerSeriesSonificationTracksMappingPlayDelay  : BaseObject
	{
		Hashtable h = new Hashtable();

		public KlingerSeriesSonificationTracksMappingPlayDelay()
		{
			MapFunction = MapFunction_DefaultValue = KlingerSeriesSonificationTracksMappingPlayDelayMapFunction.Linear;
			MapTo = MapTo_DefaultValue = "";
			Max = Max_DefaultValue = null;
			Min = Min_DefaultValue = null;
			Value = Value_DefaultValue = null;
			Within = Within_DefaultValue = KlingerSeriesSonificationTracksMappingPlayDelayWithin.Chart;
		...
		/// </summary>
		public KlingerSeriesSonificationTracksMappingPlayDelayMapFunction MapFunction { get; set; }
		private KlingerSeriesSonificationTracksMappingPlayDelayMapFunction MapFunction_DefaultValue { get; set; }
		...
		/// </summary>
		public KlingerSeriesSonificationTracksMappingPlayDelayWithin Within { get; set; }
		private KlingerSeriesSonificationTracksMappingPlayDelayWithin Within_DefaultValue { get; set; }
