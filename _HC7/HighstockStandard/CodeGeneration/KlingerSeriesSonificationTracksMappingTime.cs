...
{
	public partial class KlingerSeriesSonificationTracksMappingTime  : BaseObject
	{
		Hashtable h = new Hashtable();

		public KlingerSeriesSonificationTracksMappingTime()
		{
			MapFunction = MapFunction_DefaultValue = KlingerSeriesSonificationTracksMappingTimeMapFunction.Linear;
			MapTo = MapTo_DefaultValue = "";
			Max = Max_DefaultValue = null;
			Min = Min_DefaultValue = null;
			Value = Value_DefaultValue = null;
			Within = Within_DefaultValue = KlingerSeriesSonificationTracksMappingTimeWithin.Chart;
		...
		/// </summary>
		public KlingerSeriesSonificationTracksMappingTimeMapFunction MapFunction { get; set; }
		private KlingerSeriesSonificationTracksMappingTimeMapFunction MapFunction_DefaultValue { get; set; }
		...
		/// </summary>
		public KlingerSeriesSonificationTracksMappingTimeWithin Within { get; set; }
		private KlingerSeriesSonificationTracksMappingTimeWithin Within_DefaultValue { get; set; }
