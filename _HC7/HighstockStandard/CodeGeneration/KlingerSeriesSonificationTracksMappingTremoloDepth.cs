...
{
	public partial class KlingerSeriesSonificationTracksMappingTremoloDepth  : BaseObject
	{
		Hashtable h = new Hashtable();

		public KlingerSeriesSonificationTracksMappingTremoloDepth()
		{
			MapFunction = MapFunction_DefaultValue = KlingerSeriesSonificationTracksMappingTremoloDepthMapFunction.Linear;
			MapTo = MapTo_DefaultValue = "";
			Max = Max_DefaultValue = null;
			Min = Min_DefaultValue = null;
			Value = Value_DefaultValue = null;
			Within = Within_DefaultValue = KlingerSeriesSonificationTracksMappingTremoloDepthWithin.Chart;
		...
		/// </summary>
		public KlingerSeriesSonificationTracksMappingTremoloDepthMapFunction MapFunction { get; set; }
		private KlingerSeriesSonificationTracksMappingTremoloDepthMapFunction MapFunction_DefaultValue { get; set; }
		...
		/// </summary>
		public KlingerSeriesSonificationTracksMappingTremoloDepthWithin Within { get; set; }
		private KlingerSeriesSonificationTracksMappingTremoloDepthWithin Within_DefaultValue { get; set; }
