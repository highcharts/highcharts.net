...
{
	public partial class KlingerSeriesSonificationTracksMappingTremoloSpeed  : BaseObject
	{
		Hashtable h = new Hashtable();

		public KlingerSeriesSonificationTracksMappingTremoloSpeed()
		{
			MapFunction = MapFunction_DefaultValue = KlingerSeriesSonificationTracksMappingTremoloSpeedMapFunction.Linear;
			MapTo = MapTo_DefaultValue = "";
			Max = Max_DefaultValue = null;
			Min = Min_DefaultValue = null;
			Value = Value_DefaultValue = null;
			Within = Within_DefaultValue = KlingerSeriesSonificationTracksMappingTremoloSpeedWithin.Chart;
		...
		/// </summary>
		public KlingerSeriesSonificationTracksMappingTremoloSpeedMapFunction MapFunction { get; set; }
		private KlingerSeriesSonificationTracksMappingTremoloSpeedMapFunction MapFunction_DefaultValue { get; set; }
		...
		/// </summary>
		public KlingerSeriesSonificationTracksMappingTremoloSpeedWithin Within { get; set; }
		private KlingerSeriesSonificationTracksMappingTremoloSpeedWithin Within_DefaultValue { get; set; }
