...
{
	public partial class KlingerSeriesSonificationTracksMappingVolume  : BaseObject
	{
		Hashtable h = new Hashtable();

		public KlingerSeriesSonificationTracksMappingVolume()
		{
			MapFunction = MapFunction_DefaultValue = KlingerSeriesSonificationTracksMappingVolumeMapFunction.Linear;
			MapTo = MapTo_DefaultValue = "";
			Max = Max_DefaultValue = null;
			Min = Min_DefaultValue = null;
			Value = Value_DefaultValue = null;
			Within = Within_DefaultValue = KlingerSeriesSonificationTracksMappingVolumeWithin.Chart;
		...
		/// </summary>
		public KlingerSeriesSonificationTracksMappingVolumeMapFunction MapFunction { get; set; }
		private KlingerSeriesSonificationTracksMappingVolumeMapFunction MapFunction_DefaultValue { get; set; }
		...
		/// </summary>
		public KlingerSeriesSonificationTracksMappingVolumeWithin Within { get; set; }
		private KlingerSeriesSonificationTracksMappingVolumeWithin Within_DefaultValue { get; set; }
