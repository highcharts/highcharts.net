...
namespace Highsoft.Web.Mvc.Stocks
{
	public partial class Lang  : BaseObject
	{
		...
		internal override Hashtable ToHashtable(Highstock highstock)
		{
			...
			if (ExportData != null) h.Add("exportData",ExportData.ToHashtable(highstock));
			...
			if (RangeSelectorFrom != null) h.Add("rangeSelectorFrom",RangeSelectorFrom);
			if (RangeSelectorTo != null) h.Add("rangeSelectorTo",RangeSelectorTo);
			if (RangeSelectorZoom != null) h.Add("rangeSelectorZoom",RangeSelectorZoom);
