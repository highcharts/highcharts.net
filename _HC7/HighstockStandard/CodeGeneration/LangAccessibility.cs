...
namespace Highsoft.Web.Mvc.Stocks
{
	public partial class LangAccessibility  : BaseObject
	{
		...
		{
			if (AnnounceNewData != null) h.Add("announceNewData",AnnounceNewData.ToHashtable(highstock));
			if (Axis != null) h.Add("axis",Axis.ToHashtable(highstock));
			if (ChartContainerLabel != null) h.Add("chartContainerLabel",ChartContainerLabel);
			if (ChartTypes != null) h.Add("chartTypes",ChartTypes.ToHashtable(highstock));
			...
			if (ScreenReaderSection != null) h.Add("screenReaderSection",ScreenReaderSection.ToHashtable(highstock));
			if (Series != null) h.Add("series",Series.ToHashtable(highstock));
			if (SeriesTypeDescriptions != null) h.Add("seriesTypeDescriptions",SeriesTypeDescriptions.ToHashtable(highstock));
			...
			if (Table != null) h.Add("table",Table.ToHashtable(highstock));
			if (ThousandsSep != null) h.Add("thousandsSep",ThousandsSep);
			if (Zoom != null) h.Add("zoom",Zoom.ToHashtable(highstock));
