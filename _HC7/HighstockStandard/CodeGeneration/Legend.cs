...
namespace Highsoft.Web.Mvc.Stocks
{
	public partial class Legend  : BaseObject
	{
		...
		internal override Hashtable ToHashtable(Highstock highstock)
		{
			...
			if (Align != LegendAlign.Null) h.Add("align", highstock.FirstCharacterToLower(Align.ToString()));
			...
			if (BubbleLegend != null) h.Add("bubbleLegend",BubbleLegend.ToHashtable(highstock));
			...
			if (Layout != LegendLayout.Null) h.Add("layout", highstock.FirstCharacterToLower(Layout.ToString()));
			...
			if (VerticalAlign != LegendVerticalAlign.Null) h.Add("verticalAlign", highstock.FirstCharacterToLower(VerticalAlign.ToString()));
