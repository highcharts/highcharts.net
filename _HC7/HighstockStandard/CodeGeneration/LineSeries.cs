...
namespace Highsoft.Web.Mvc.Stocks
{
	public partial class LineSeries  : Series
	{
		...
		public LineSeries()
		{
			Accessibility = Accessibility_DefaultValue = new LineSeriesAccessibility();
			AllowPointSelect = AllowPointSelect_DefaultValue = false;
			Animation = Animation_DefaultValue = new Animation() { Enabled = true };
			AnimationBool = AnimationBool_DefaultValue = true;
			AnimationLimit = AnimationLimit_DefaultValue = null;
			BoostBlending = BoostBlending_DefaultValue = LineSeriesBoostBlending.Undefined;
			...
			Compare = Compare_DefaultValue = LineSeriesCompare.Percent;
			...
			DashStyle = DashStyle_DefaultValue = LineSeriesDashStyle.Null;
			...
			DataSorting = DataSorting_DefaultValue = new LineSeriesDataSorting();
			Description = Description_DefaultValue = "";
			DragDrop = DragDrop_DefaultValue = new LineSeriesDragDrop();
			Dumbell = Dumbell_DefaultValue = new LineSeriesDumbell();
			EnableMouseTracking = EnableMouseTracking_DefaultValue = true;
			Events = Events_DefaultValue = new LineSeriesEvents();
			FindNearestPointBy = FindNearestPointBy_DefaultValue = LineSeriesFindNearestPointBy.X;
			GapSize = GapSize_DefaultValue = 0;
			GapUnit = GapUnit_DefaultValue = LineSeriesGapUnit.Relative;
			...
			LegendSymbol = LegendSymbol_DefaultValue = LineSeriesLegendSymbol.Rectangle;
			...
			OnPoint = OnPoint_DefaultValue = new LineSeriesOnPoint();
			...
			Sonification = Sonification_DefaultValue = new LineSeriesSonification();
			...
			Step = Step_DefaultValue = LineSeriesStep.Null;
			...
			Zones = Zones_DefaultValue = new List<LineSeriesZones>();
		...
		private LineSeriesCompare Compare_DefaultValue { get; set; }
		...
		private LineSeriesCompareBase CompareBase_DefaultValue { get; set; }
		...
		/// 
		/// </summary>
		public LineSeriesDumbell Dumbell { get; set; }
		private LineSeriesDumbell Dumbell_DefaultValue { get; set; }
		...
		private LineSeriesGapUnit GapUnit_DefaultValue { get; set; }
		...
		private List<LineSeriesZones> Zones_DefaultValue { get; set; }
