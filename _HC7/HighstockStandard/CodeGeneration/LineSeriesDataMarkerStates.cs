...
namespace Highsoft.Web.Mvc.Stocks
{
	public partial class LineSeriesDataMarkerStates  : BaseObject
	{
		public LineSeriesDataMarkerStates()
		{
			...
			Inactive = Inactive_DefaultValue = new LineSeriesDataMarkerStatesInactive();
		...
		/// 
		/// </summary>
		public LineSeriesDataMarkerStatesInactive Inactive { get; set; }
		private LineSeriesDataMarkerStatesInactive Inactive_DefaultValue { get; set; }
