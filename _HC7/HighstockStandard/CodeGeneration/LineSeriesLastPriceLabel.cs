...
{
	public partial class LineSeriesLastPriceLabel  : BaseObject
	{
		Hashtable h = new Hashtable();

		public LineSeriesLastPriceLabel()
		{
			Align = Align_DefaultValue = LineSeriesLastPriceLabelAlign.Null;
		...
		/// 
		/// </summary>
		public LineSeriesLastPriceLabelAlign Align { get; set; }
		private LineSeriesLastPriceLabelAlign Align_DefaultValue { get; set; }
