...
namespace Highsoft.Web.Mvc.Stocks
{
	public partial class LineSeriesMarkerStates  : BaseObject
	{
		public LineSeriesMarkerStates()
		{
			...
			Inactive = Inactive_DefaultValue = new LineSeriesMarkerStatesInactive();
		...
		/// 
		/// </summary>
		public LineSeriesMarkerStatesInactive Inactive { get; set; }
		private LineSeriesMarkerStatesInactive Inactive_DefaultValue { get; set; }
