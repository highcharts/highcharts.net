...
{
	public partial class LineSeriesSonificationContextTracksMapping  : BaseObject
	{
		Hashtable h = new Hashtable();

		public LineSeriesSonificationContextTracksMapping()
		{
			Frequency = Frequency_DefaultValue = new LineSeriesSonificationContextTracksMappingFrequency();
			GapBetweenNotes = GapBetweenNotes_DefaultValue = new LineSeriesSonificationContextTracksMappingGapBetweenNotes();
			Highpass = Highpass_DefaultValue = new LineSeriesSonificationContextTracksMappingHighpass();
			Lowpass = Lowpass_DefaultValue = new LineSeriesSonificationContextTracksMappingLowpass();
			NoteDuration = NoteDuration_DefaultValue = new LineSeriesSonificationContextTracksMappingNoteDuration();
			Pan = Pan_DefaultValue = new LineSeriesSonificationContextTracksMappingPan();
			Pitch = Pitch_DefaultValue = new LineSeriesSonificationContextTracksMappingPitch();
			PitchString = PitchString_DefaultValue = "null";
			PitchNumber = PitchNumber_DefaultValue = null;
			PlayDelay = PlayDelay_DefaultValue = new LineSeriesSonificationContextTracksMappingPlayDelay();
			Time = Time_DefaultValue = new LineSeriesSonificationContextTracksMappingTime();
			TimeString = TimeString_DefaultValue = "null";
			TimeNumber = TimeNumber_DefaultValue = null;
			Tremolo = Tremolo_DefaultValue = new LineSeriesSonificationContextTracksMappingTremolo();
			Volume = Volume_DefaultValue = new LineSeriesSonificationContextTracksMappingVolume();
		...
		/// </summary>
		public LineSeriesSonificationContextTracksMappingFrequency Frequency { get; set; }
		private LineSeriesSonificationContextTracksMappingFrequency Frequency_DefaultValue { get; set; }
		...
		/// </summary>
		public LineSeriesSonificationContextTracksMappingGapBetweenNotes GapBetweenNotes { get; set; }
		private LineSeriesSonificationContextTracksMappingGapBetweenNotes GapBetweenNotes_DefaultValue { get; set; }
		...
		/// </summary>
		public LineSeriesSonificationContextTracksMappingHighpass Highpass { get; set; }
		private LineSeriesSonificationContextTracksMappingHighpass Highpass_DefaultValue { get; set; }
		...
		/// </summary>
		public LineSeriesSonificationContextTracksMappingLowpass Lowpass { get; set; }
		private LineSeriesSonificationContextTracksMappingLowpass Lowpass_DefaultValue { get; set; }
		...
		/// </summary>
		public LineSeriesSonificationContextTracksMappingNoteDuration NoteDuration { get; set; }
		private LineSeriesSonificationContextTracksMappingNoteDuration NoteDuration_DefaultValue { get; set; }
		...
		/// </summary>
		public LineSeriesSonificationContextTracksMappingPan Pan { get; set; }
		private LineSeriesSonificationContextTracksMappingPan Pan_DefaultValue { get; set; }
		...
		/// </summary>
		public LineSeriesSonificationContextTracksMappingPitch Pitch { get; set; }
		private LineSeriesSonificationContextTracksMappingPitch Pitch_DefaultValue { get; set; }
		...
		/// </summary>
		public LineSeriesSonificationContextTracksMappingPlayDelay PlayDelay { get; set; }
		private LineSeriesSonificationContextTracksMappingPlayDelay PlayDelay_DefaultValue { get; set; }
		...
		/// </summary>
		public LineSeriesSonificationContextTracksMappingTime Time { get; set; }
		private LineSeriesSonificationContextTracksMappingTime Time_DefaultValue { get; set; }
		...
		/// </summary>
		public LineSeriesSonificationContextTracksMappingTremolo Tremolo { get; set; }
		private LineSeriesSonificationContextTracksMappingTremolo Tremolo_DefaultValue { get; set; }
		 

		/// <summary>
		/// The volume of notes, from 0 to 1.
		/// </summary>
		public LineSeriesSonificationContextTracksMappingVolume Volume { get; set; }
		private LineSeriesSonificationContextTracksMappingVolume Volume_DefaultValue { get; set; }
