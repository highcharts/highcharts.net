...
{
	public partial class LineSeriesSonificationDefaultInstrumentOptionsActiveWhen  : BaseObject
	{
		Hashtable h = new Hashtable();

		public LineSeriesSonificationDefaultInstrumentOptionsActiveWhen()
		{
