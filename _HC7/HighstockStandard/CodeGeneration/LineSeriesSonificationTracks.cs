...
{
	public partial class LineSeriesSonificationTracks  : BaseObject
	{
		Hashtable h = new Hashtable();

		public LineSeriesSonificationTracks()
		{
			ActiveWhen = ActiveWhen_DefaultValue = new LineSeriesSonificationTracksActiveWhen();
			Instrument = Instrument_DefaultValue = null;
			InstrumentString = InstrumentString_DefaultValue = "null";
			Mapping = Mapping_DefaultValue = new LineSeriesSonificationTracksMapping();
			MidiName = MidiName_DefaultValue = "";
			PointGrouping = PointGrouping_DefaultValue = new LineSeriesSonificationTracksPointGrouping();
			RoundToMusicalNotes = RoundToMusicalNotes_DefaultValue = true;
			ShowPlayMarker = ShowPlayMarker_DefaultValue = true;
			Type = Type_DefaultValue = LineSeriesSonificationTracksType.Instrument;
		...
		/// </summary>
		public LineSeriesSonificationTracksActiveWhen ActiveWhen { get; set; }
		private LineSeriesSonificationTracksActiveWhen ActiveWhen_DefaultValue { get; set; }
		...
		/// </summary>
		public LineSeriesSonificationTracksMapping Mapping { get; set; }
		private LineSeriesSonificationTracksMapping Mapping_DefaultValue { get; set; }
		...
		/// </summary>
		public LineSeriesSonificationTracksPointGrouping PointGrouping { get; set; }
		private LineSeriesSonificationTracksPointGrouping PointGrouping_DefaultValue { get; set; }
		...
		/// </summary>
		public LineSeriesSonificationTracksType Type { get; set; }
		private LineSeriesSonificationTracksType Type_DefaultValue { get; set; }
