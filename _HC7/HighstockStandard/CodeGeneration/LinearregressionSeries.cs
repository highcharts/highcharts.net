...
{
	public partial class LinearregressionSeries  : Series
	{
		Hashtable h = new Hashtable();

		public LinearregressionSeries()
		{
			Accessibility = Accessibility_DefaultValue = new LinearregressionSeriesAccessibility();
			AllowPointSelect = AllowPointSelect_DefaultValue = false;
			Animation = Animation_DefaultValue = new Animation() { Enabled = true };
			AnimationBool = AnimationBool_DefaultValue = true;
			AnimationLimit = AnimationLimit_DefaultValue = null;
			BoostBlending = BoostBlending_DefaultValue = LinearregressionSeriesBoostBlending.Undefined;
			...
			Compare = Compare_DefaultValue = LinearregressionSeriesCompare.Percent;
			CompareBase = CompareBase_DefaultValue = LinearregressionSeriesCompareBase.Min;
			...
			Cursor = Cursor_DefaultValue = LinearregressionSeriesCursor.Null;
			Custom = Custom_DefaultValue = new Hashtable();
			DashStyle = DashStyle_DefaultValue = LinearregressionSeriesDashStyle.Null;
			DataGrouping = DataGrouping_DefaultValue = new LinearregressionSeriesDataGrouping();
			DataLabels = DataLabels_DefaultValue = new LinearregressionSeriesDataLabels();
			DataSorting = DataSorting_DefaultValue = new LinearregressionSeriesDataSorting();
			Description = Description_DefaultValue = "";
			Dumbell = Dumbell_DefaultValue = new LinearregressionSeriesDumbell();
			EnableMouseTracking = EnableMouseTracking_DefaultValue = true;
			Events = Events_DefaultValue = new LinearregressionSeriesEvents();
			FindNearestPointBy = FindNearestPointBy_DefaultValue = LinearregressionSeriesFindNearestPointBy.X;
			GapSize = GapSize_DefaultValue = 0;
			GapUnit = GapUnit_DefaultValue = LinearregressionSeriesGapUnit.Relative;
			GetExtremesFromAll = GetExtremesFromAll_DefaultValue = false;
			Id = Id_DefaultValue = "";
			InactiveOtherPoints = InactiveOtherPoints_DefaultValue = false;
			IncludeInDataExport = IncludeInDataExport_DefaultValue = null;
			Index = Index_DefaultValue = null;
			Label = Label_DefaultValue = new LinearregressionSeriesLabel();
			LastPrice = LastPrice_DefaultValue = new LinearregressionSeriesLastPrice();
			LastVisiblePrice = LastVisiblePrice_DefaultValue = new LinearregressionSeriesLastVisiblePrice();
			LegendIndex = LegendIndex_DefaultValue = null;
			LegendSymbol = LegendSymbol_DefaultValue = LinearregressionSeriesLegendSymbol.Rectangle;
			Linecap = Linecap_DefaultValue = LinearregressionSeriesLinecap.Round;
			LineWidth = LineWidth_DefaultValue = 2;
			LinkedTo = LinkedTo_DefaultValue = "";
			Marker = Marker_DefaultValue = new LinearregressionSeriesMarker();
			Name = Name_DefaultValue = "";
			NegativeColor = NegativeColor_DefaultValue = "";
			OnPoint = OnPoint_DefaultValue = new LinearregressionSeriesOnPoint();
			Opacity = Opacity_DefaultValue = 1;
			Params = Params_DefaultValue = new LinearregressionSeriesParams();
			Point = Point_DefaultValue = new LinearregressionSeriesPoint();
			...
			Sonification = Sonification_DefaultValue = new LinearregressionSeriesSonification();
			Stack = Stack_DefaultValue = "";
			StackNumber = StackNumber_DefaultValue = null;
			States = States_DefaultValue = new LinearregressionSeriesStates();
			Step = Step_DefaultValue = LinearregressionSeriesStep.Null;
			StickyTracking = StickyTracking_DefaultValue = true;
			Threshold = Threshold_DefaultValue = 0;
			Tooltip = Tooltip_DefaultValue = new LinearregressionSeriesTooltip();
			...
			Zones = Zones_DefaultValue = new List<LinearregressionSeriesZones>();
		...
		/// </summary>
		public LinearregressionSeriesAccessibility Accessibility { get; set; }
		private LinearregressionSeriesAccessibility Accessibility_DefaultValue { get; set; }
		...
		/// </summary>
		public LinearregressionSeriesBoostBlending BoostBlending { get; set; }
		private LinearregressionSeriesBoostBlending BoostBlending_DefaultValue { get; set; }
		...
		/// </summary>
		public LinearregressionSeriesCompare Compare { get; set; }
		private LinearregressionSeriesCompare Compare_DefaultValue { get; set; }
		 

		/// <summary>
		/// When [compare](#plotOptions.series.compare) is `percent`, this optiondictates whether to use 0 or 100 as the base of comparison.
		/// </summary>
		public LinearregressionSeriesCompareBase CompareBase { get; set; }
		private LinearregressionSeriesCompareBase CompareBase_DefaultValue { get; set; }
		...
		/// </summary>
		public LinearregressionSeriesCursor Cursor { get; set; }
		private LinearregressionSeriesCursor Cursor_DefaultValue { get; set; }
		...
		/// </summary>
		public LinearregressionSeriesDashStyle DashStyle { get; set; }
		private LinearregressionSeriesDashStyle DashStyle_DefaultValue { get; set; }
		...
		/// </summary>
		public LinearregressionSeriesDataGrouping DataGrouping { get; set; }
		private LinearregressionSeriesDataGrouping DataGrouping_DefaultValue { get; set; }
		...
		/// </summary>
		public LinearregressionSeriesDataLabels DataLabels { get; set; }
		private LinearregressionSeriesDataLabels DataLabels_DefaultValue { get; set; }
		 

		/// <summary>
		/// Options for the series data sorting.
		/// </summary>
		public LinearregressionSeriesDataSorting DataSorting { get; set; }
		private LinearregressionSeriesDataSorting DataSorting_DefaultValue { get; set; }
		...
		/// 
		/// </summary>
		public LinearregressionSeriesDumbell Dumbell { get; set; }
		private LinearregressionSeriesDumbell Dumbell_DefaultValue { get; set; }
		...
		/// </summary>
		public LinearregressionSeriesEvents Events { get; set; }
		private LinearregressionSeriesEvents Events_DefaultValue { get; set; }
		...
		/// </summary>
		public LinearregressionSeriesFindNearestPointBy FindNearestPointBy { get; set; }
		private LinearregressionSeriesFindNearestPointBy FindNearestPointBy_DefaultValue { get; set; }
		...
		/// </summary>
		public LinearregressionSeriesGapUnit GapUnit { get; set; }
		private LinearregressionSeriesGapUnit GapUnit_DefaultValue { get; set; }
		...
		/// </summary>
		public LinearregressionSeriesLabel Label { get; set; }
		private LinearregressionSeriesLabel Label_DefaultValue { get; set; }
		 

		/// <summary>
		/// The line marks the last price from all points.
		/// </summary>
		public LinearregressionSeriesLastPrice LastPrice { get; set; }
		private LinearregressionSeriesLastPrice LastPrice_DefaultValue { get; set; }
		 

		/// <summary>
		/// The line marks the last price from visible range of points.
		/// </summary>
		public LinearregressionSeriesLastVisiblePrice LastVisiblePrice { get; set; }
		private LinearregressionSeriesLastVisiblePrice LastVisiblePrice_DefaultValue { get; set; }
		...
		/// </summary>
		public LinearregressionSeriesLegendSymbol LegendSymbol { get; set; }
		private LinearregressionSeriesLegendSymbol LegendSymbol_DefaultValue { get; set; }
		 

		/// <summary>
		/// The line cap used for line ends and line joins on the graph.
		/// </summary>
		public LinearregressionSeriesLinecap Linecap { get; set; }
		private LinearregressionSeriesLinecap Linecap_DefaultValue { get; set; }
		...
		/// </summary>
		public LinearregressionSeriesMarker Marker { get; set; }
		private LinearregressionSeriesMarker Marker_DefaultValue { get; set; }
		...
		/// </summary>
		public LinearregressionSeriesOnPoint OnPoint { get; set; }
		private LinearregressionSeriesOnPoint OnPoint_DefaultValue { get; set; }
		...
		/// </summary>
		public LinearregressionSeriesParams Params { get; set; }
		private LinearregressionSeriesParams Params_DefaultValue { get; set; }
		 

		/// <summary>
		/// Properties for each single point.
		/// </summary>
		public LinearregressionSeriesPoint Point { get; set; }
		private LinearregressionSeriesPoint Point_DefaultValue { get; set; }
		...
		/// </summary>
		public LinearregressionSeriesSonification Sonification { get; set; }
		private LinearregressionSeriesSonification Sonification_DefaultValue { get; set; }
		...
		/// 
		/// </summary>
		public LinearregressionSeriesStates States { get; set; }
		private LinearregressionSeriesStates States_DefaultValue { get; set; }
		 

		/// <summary>
		/// Whether to apply steps to the line. Possible values are `left`,`center` and `right`.
		/// </summary>
		public LinearregressionSeriesStep Step { get; set; }
		private LinearregressionSeriesStep Step_DefaultValue { get; set; }
		...
		/// </summary>
		public LinearregressionSeriesTooltip Tooltip { get; set; }
		private LinearregressionSeriesTooltip Tooltip_DefaultValue { get; set; }
		...
		/// </summary>
		public List<LinearregressionSeriesZones> Zones { get; set; }
		private List<LinearregressionSeriesZones> Zones_DefaultValue { get; set; }
