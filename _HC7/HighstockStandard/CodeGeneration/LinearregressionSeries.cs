...
namespace Highsoft.Web.Mvc.Stocks
{
	public partial class LinearregressionSeries  : Series
	{
		...
		public LinearregressionSeries()
		{
			...
			Zones = Zones_DefaultValue = new List<LinearregressionSeriesZone>();
		...
		/// </summary>
		public List<LinearregressionSeriesZone> Zones { get; set; }
		private List<LinearregressionSeriesZone> Zones_DefaultValue { get; set; }
