...
{
	public partial class LinearregressionSeriesDragDropDragHandle  : BaseObject
	{
		public LinearregressionSeriesDragDropDragHandle()
		{
		...
		internal override Hashtable ToHashtable()
		{
			...
			if (PathFormatter != PathFormatter_DefaultValue) { h.Add("pathFormatter",PathFormatter); Highstock.AddFunction("LinearregressionSeriesDragDropDragHandlePathFormatter.pathFormatter", PathFormatter); }  
