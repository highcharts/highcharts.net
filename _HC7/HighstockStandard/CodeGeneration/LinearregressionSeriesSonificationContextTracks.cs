...
{
	public partial class LinearregressionSeriesSonificationContextTracks  : BaseObject
	{
		Hashtable h = new Hashtable();

		public LinearregressionSeriesSonificationContextTracks()
		{
			ActiveWhen = ActiveWhen_DefaultValue = new LinearregressionSeriesSonificationContextTracksActiveWhen();
			Instrument = Instrument_DefaultValue = null;
			InstrumentString = InstrumentString_DefaultValue = "null";
			Mapping = Mapping_DefaultValue = new LinearregressionSeriesSonificationContextTracksMapping();
			MidiName = MidiName_DefaultValue = "";
			PointGrouping = PointGrouping_DefaultValue = new LinearregressionSeriesSonificationContextTracksPointGrouping();
			...
			Type = Type_DefaultValue = LinearregressionSeriesSonificationContextTracksType.Instrument;
			ValueInterval = ValueInterval_DefaultValue = null;
			ValueMapFunction = ValueMapFunction_DefaultValue = LinearregressionSeriesSonificationContextTracksValueMapFunction.Linear;
		...
		/// </summary>
		public LinearregressionSeriesSonificationContextTracksActiveWhen ActiveWhen { get; set; }
		private LinearregressionSeriesSonificationContextTracksActiveWhen ActiveWhen_DefaultValue { get; set; }
		...
		/// </summary>
		public LinearregressionSeriesSonificationContextTracksMapping Mapping { get; set; }
		private LinearregressionSeriesSonificationContextTracksMapping Mapping_DefaultValue { get; set; }
		...
		/// </summary>
		public LinearregressionSeriesSonificationContextTracksPointGrouping PointGrouping { get; set; }
		private LinearregressionSeriesSonificationContextTracksPointGrouping PointGrouping_DefaultValue { get; set; }
		...
		/// </summary>
		public LinearregressionSeriesSonificationContextTracksType Type { get; set; }
		private LinearregressionSeriesSonificationContextTracksType Type_DefaultValue { get; set; }
		...
		/// </summary>
		public LinearregressionSeriesSonificationContextTracksValueMapFunction ValueMapFunction { get; set; }
		private LinearregressionSeriesSonificationContextTracksValueMapFunction ValueMapFunction_DefaultValue { get; set; }
