...
namespace Highsoft.Web.Mvc.Stocks
{
	public partial class LinearregressionSeriesSonificationContextTracks  : BaseObject
	{
		...
		internal override Hashtable ToHashtable(Highstock highstock)
		{
			...
			if (Type != LinearregressionSeriesSonificationContextTracksType.Null) h.Add("type", highstock.FirstCharacterToLower(Type.ToString()));
			if (ValueInterval != null) h.Add("valueInterval",ValueInterval);
			if (ValueMapFunction != LinearregressionSeriesSonificationContextTracksValueMapFunction.Null) h.Add("valueMapFunction", highstock.FirstCharacterToLower(ValueMapFunction.ToString()));
