...
{
	public partial class LinearregressionSeriesSonificationContextTracksMapping  : BaseObject
	{
		Hashtable h = new Hashtable();

		public LinearregressionSeriesSonificationContextTracksMapping()
		{
			Frequency = Frequency_DefaultValue = new LinearregressionSeriesSonificationContextTracksMappingFrequency();
			GapBetweenNotes = GapBetweenNotes_DefaultValue = new LinearregressionSeriesSonificationContextTracksMappingGapBetweenNotes();
			Highpass = Highpass_DefaultValue = new LinearregressionSeriesSonificationContextTracksMappingHighpass();
			Lowpass = Lowpass_DefaultValue = new LinearregressionSeriesSonificationContextTracksMappingLowpass();
			NoteDuration = NoteDuration_DefaultValue = new LinearregressionSeriesSonificationContextTracksMappingNoteDuration();
			Pan = Pan_DefaultValue = new LinearregressionSeriesSonificationContextTracksMappingPan();
			Pitch = Pitch_DefaultValue = new LinearregressionSeriesSonificationContextTracksMappingPitch();
			PitchString = PitchString_DefaultValue = "null";
			PitchNumber = PitchNumber_DefaultValue = null;
			PlayDelay = PlayDelay_DefaultValue = new LinearregressionSeriesSonificationContextTracksMappingPlayDelay();
			Time = Time_DefaultValue = new LinearregressionSeriesSonificationContextTracksMappingTime();
			TimeString = TimeString_DefaultValue = "null";
			TimeNumber = TimeNumber_DefaultValue = null;
			Tremolo = Tremolo_DefaultValue = new LinearregressionSeriesSonificationContextTracksMappingTremolo();
			Volume = Volume_DefaultValue = new LinearregressionSeriesSonificationContextTracksMappingVolume();
		...
		/// </summary>
		public LinearregressionSeriesSonificationContextTracksMappingFrequency Frequency { get; set; }
		private LinearregressionSeriesSonificationContextTracksMappingFrequency Frequency_DefaultValue { get; set; }
		...
		/// </summary>
		public LinearregressionSeriesSonificationContextTracksMappingGapBetweenNotes GapBetweenNotes { get; set; }
		private LinearregressionSeriesSonificationContextTracksMappingGapBetweenNotes GapBetweenNotes_DefaultValue { get; set; }
		...
		/// </summary>
		public LinearregressionSeriesSonificationContextTracksMappingHighpass Highpass { get; set; }
		private LinearregressionSeriesSonificationContextTracksMappingHighpass Highpass_DefaultValue { get; set; }
		...
		/// </summary>
		public LinearregressionSeriesSonificationContextTracksMappingLowpass Lowpass { get; set; }
		private LinearregressionSeriesSonificationContextTracksMappingLowpass Lowpass_DefaultValue { get; set; }
		...
		/// </summary>
		public LinearregressionSeriesSonificationContextTracksMappingNoteDuration NoteDuration { get; set; }
		private LinearregressionSeriesSonificationContextTracksMappingNoteDuration NoteDuration_DefaultValue { get; set; }
		...
		/// </summary>
		public LinearregressionSeriesSonificationContextTracksMappingPan Pan { get; set; }
		private LinearregressionSeriesSonificationContextTracksMappingPan Pan_DefaultValue { get; set; }
		...
		/// </summary>
		public LinearregressionSeriesSonificationContextTracksMappingPitch Pitch { get; set; }
		private LinearregressionSeriesSonificationContextTracksMappingPitch Pitch_DefaultValue { get; set; }
		...
		/// </summary>
		public LinearregressionSeriesSonificationContextTracksMappingPlayDelay PlayDelay { get; set; }
		private LinearregressionSeriesSonificationContextTracksMappingPlayDelay PlayDelay_DefaultValue { get; set; }
		...
		/// </summary>
		public LinearregressionSeriesSonificationContextTracksMappingTime Time { get; set; }
		private LinearregressionSeriesSonificationContextTracksMappingTime Time_DefaultValue { get; set; }
		...
		/// </summary>
		public LinearregressionSeriesSonificationContextTracksMappingTremolo Tremolo { get; set; }
		private LinearregressionSeriesSonificationContextTracksMappingTremolo Tremolo_DefaultValue { get; set; }
		 

		/// <summary>
		/// The volume of notes, from 0 to 1.
		/// </summary>
		public LinearregressionSeriesSonificationContextTracksMappingVolume Volume { get; set; }
		private LinearregressionSeriesSonificationContextTracksMappingVolume Volume_DefaultValue { get; set; }
