...
{
	public partial class LinearregressionSeriesSonificationContextTracksMappingLowpassResonance  : BaseObject
	{
		Hashtable h = new Hashtable();

		public LinearregressionSeriesSonificationContextTracksMappingLowpassResonance()
		{
			MapFunction = MapFunction_DefaultValue = LinearregressionSeriesSonificationContextTracksMappingLowpassResonanceMapFunction.Linear;
			MapTo = MapTo_DefaultValue = "";
			Max = Max_DefaultValue = null;
			Min = Min_DefaultValue = null;
			Value = Value_DefaultValue = null;
			Within = Within_DefaultValue = LinearregressionSeriesSonificationContextTracksMappingLowpassResonanceWithin.Chart;
		...
		/// </summary>
		public LinearregressionSeriesSonificationContextTracksMappingLowpassResonanceMapFunction MapFunction { get; set; }
		private LinearregressionSeriesSonificationContextTracksMappingLowpassResonanceMapFunction MapFunction_DefaultValue { get; set; }
		...
		/// </summary>
		public LinearregressionSeriesSonificationContextTracksMappingLowpassResonanceWithin Within { get; set; }
		private LinearregressionSeriesSonificationContextTracksMappingLowpassResonanceWithin Within_DefaultValue { get; set; }
