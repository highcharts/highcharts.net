...
{
	public partial class LinearregressionSeriesSonificationContextTracksPointGrouping  : BaseObject
	{
		Hashtable h = new Hashtable();

		public LinearregressionSeriesSonificationContextTracksPointGrouping()
		{
			Algorithm = Algorithm_DefaultValue = LinearregressionSeriesSonificationContextTracksPointGroupingAlgorithm.Minimax;
		...
		/// </summary>
		public LinearregressionSeriesSonificationContextTracksPointGroupingAlgorithm Algorithm { get; set; }
		private LinearregressionSeriesSonificationContextTracksPointGroupingAlgorithm Algorithm_DefaultValue { get; set; }
