...
{
	public partial class LinearregressionSeriesSonificationDefaultSpeechOptions  : BaseObject
	{
		Hashtable h = new Hashtable();

		public LinearregressionSeriesSonificationDefaultSpeechOptions()
		{
			ActiveWhen = ActiveWhen_DefaultValue = new LinearregressionSeriesSonificationDefaultSpeechOptionsActiveWhen();
			Language = Language_DefaultValue = "en-US";
			Mapping = Mapping_DefaultValue = new LinearregressionSeriesSonificationDefaultSpeechOptionsMapping();
			PointGrouping = PointGrouping_DefaultValue = new LinearregressionSeriesSonificationDefaultSpeechOptionsPointGrouping();
			PreferredVoice = PreferredVoice_DefaultValue = "";
			ShowPlayMarker = ShowPlayMarker_DefaultValue = true;
			Type = Type_DefaultValue = LinearregressionSeriesSonificationDefaultSpeechOptionsType.Instrument;
		...
		/// </summary>
		public LinearregressionSeriesSonificationDefaultSpeechOptionsActiveWhen ActiveWhen { get; set; }
		private LinearregressionSeriesSonificationDefaultSpeechOptionsActiveWhen ActiveWhen_DefaultValue { get; set; }
		...
		/// </summary>
		public LinearregressionSeriesSonificationDefaultSpeechOptionsMapping Mapping { get; set; }
		private LinearregressionSeriesSonificationDefaultSpeechOptionsMapping Mapping_DefaultValue { get; set; }
		 

		/// <summary>
		/// Options for point grouping, specifically for instrument tracks.
		/// </summary>
		public LinearregressionSeriesSonificationDefaultSpeechOptionsPointGrouping PointGrouping { get; set; }
		private LinearregressionSeriesSonificationDefaultSpeechOptionsPointGrouping PointGrouping_DefaultValue { get; set; }
		...
		/// </summary>
		public LinearregressionSeriesSonificationDefaultSpeechOptionsType Type { get; set; }
		private LinearregressionSeriesSonificationDefaultSpeechOptionsType Type_DefaultValue { get; set; }
