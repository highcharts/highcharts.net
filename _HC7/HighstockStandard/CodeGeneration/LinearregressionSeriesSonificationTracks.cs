...
{
	public partial class LinearregressionSeriesSonificationTracks  : BaseObject
	{
		Hashtable h = new Hashtable();

		public LinearregressionSeriesSonificationTracks()
		{
			ActiveWhen = ActiveWhen_DefaultValue = new LinearregressionSeriesSonificationTracksActiveWhen();
			Instrument = Instrument_DefaultValue = null;
			InstrumentString = InstrumentString_DefaultValue = "null";
			Mapping = Mapping_DefaultValue = new LinearregressionSeriesSonificationTracksMapping();
			MidiName = MidiName_DefaultValue = "";
			PointGrouping = PointGrouping_DefaultValue = new LinearregressionSeriesSonificationTracksPointGrouping();
			RoundToMusicalNotes = RoundToMusicalNotes_DefaultValue = true;
			ShowPlayMarker = ShowPlayMarker_DefaultValue = true;
			Type = Type_DefaultValue = LinearregressionSeriesSonificationTracksType.Instrument;
		...
		/// </summary>
		public LinearregressionSeriesSonificationTracksActiveWhen ActiveWhen { get; set; }
		private LinearregressionSeriesSonificationTracksActiveWhen ActiveWhen_DefaultValue { get; set; }
		...
		/// </summary>
		public LinearregressionSeriesSonificationTracksMapping Mapping { get; set; }
		private LinearregressionSeriesSonificationTracksMapping Mapping_DefaultValue { get; set; }
		...
		/// </summary>
		public LinearregressionSeriesSonificationTracksPointGrouping PointGrouping { get; set; }
		private LinearregressionSeriesSonificationTracksPointGrouping PointGrouping_DefaultValue { get; set; }
		...
		/// </summary>
		public LinearregressionSeriesSonificationTracksType Type { get; set; }
		private LinearregressionSeriesSonificationTracksType Type_DefaultValue { get; set; }
