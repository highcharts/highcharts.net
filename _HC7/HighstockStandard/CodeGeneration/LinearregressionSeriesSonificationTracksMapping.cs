...
{
	public partial class LinearregressionSeriesSonificationTracksMapping  : BaseObject
	{
		Hashtable h = new Hashtable();

		public LinearregressionSeriesSonificationTracksMapping()
		{
			Frequency = Frequency_DefaultValue = new LinearregressionSeriesSonificationTracksMappingFrequency();
			GapBetweenNotes = GapBetweenNotes_DefaultValue = new LinearregressionSeriesSonificationTracksMappingGapBetweenNotes();
			Highpass = Highpass_DefaultValue = new LinearregressionSeriesSonificationTracksMappingHighpass();
			Lowpass = Lowpass_DefaultValue = new LinearregressionSeriesSonificationTracksMappingLowpass();
			NoteDuration = NoteDuration_DefaultValue = new LinearregressionSeriesSonificationTracksMappingNoteDuration();
			Pan = Pan_DefaultValue = new LinearregressionSeriesSonificationTracksMappingPan();
			Pitch = Pitch_DefaultValue = new LinearregressionSeriesSonificationTracksMappingPitch();
			PitchString = PitchString_DefaultValue = "null";
			PitchNumber = PitchNumber_DefaultValue = null;
			PlayDelay = PlayDelay_DefaultValue = new LinearregressionSeriesSonificationTracksMappingPlayDelay();
			Time = Time_DefaultValue = new LinearregressionSeriesSonificationTracksMappingTime();
			TimeString = TimeString_DefaultValue = "null";
			TimeNumber = TimeNumber_DefaultValue = null;
			Tremolo = Tremolo_DefaultValue = new LinearregressionSeriesSonificationTracksMappingTremolo();
			Volume = Volume_DefaultValue = new LinearregressionSeriesSonificationTracksMappingVolume();
		...
		/// </summary>
		public LinearregressionSeriesSonificationTracksMappingFrequency Frequency { get; set; }
		private LinearregressionSeriesSonificationTracksMappingFrequency Frequency_DefaultValue { get; set; }
		...
		/// </summary>
		public LinearregressionSeriesSonificationTracksMappingGapBetweenNotes GapBetweenNotes { get; set; }
		private LinearregressionSeriesSonificationTracksMappingGapBetweenNotes GapBetweenNotes_DefaultValue { get; set; }
		...
		/// </summary>
		public LinearregressionSeriesSonificationTracksMappingHighpass Highpass { get; set; }
		private LinearregressionSeriesSonificationTracksMappingHighpass Highpass_DefaultValue { get; set; }
		...
		/// </summary>
		public LinearregressionSeriesSonificationTracksMappingLowpass Lowpass { get; set; }
		private LinearregressionSeriesSonificationTracksMappingLowpass Lowpass_DefaultValue { get; set; }
		...
		/// </summary>
		public LinearregressionSeriesSonificationTracksMappingNoteDuration NoteDuration { get; set; }
		private LinearregressionSeriesSonificationTracksMappingNoteDuration NoteDuration_DefaultValue { get; set; }
		...
		/// </summary>
		public LinearregressionSeriesSonificationTracksMappingPan Pan { get; set; }
		private LinearregressionSeriesSonificationTracksMappingPan Pan_DefaultValue { get; set; }
		...
		/// </summary>
		public LinearregressionSeriesSonificationTracksMappingPitch Pitch { get; set; }
		private LinearregressionSeriesSonificationTracksMappingPitch Pitch_DefaultValue { get; set; }
		...
		/// </summary>
		public LinearregressionSeriesSonificationTracksMappingPlayDelay PlayDelay { get; set; }
		private LinearregressionSeriesSonificationTracksMappingPlayDelay PlayDelay_DefaultValue { get; set; }
		...
		/// </summary>
		public LinearregressionSeriesSonificationTracksMappingTime Time { get; set; }
		private LinearregressionSeriesSonificationTracksMappingTime Time_DefaultValue { get; set; }
		...
		/// </summary>
		public LinearregressionSeriesSonificationTracksMappingTremolo Tremolo { get; set; }
		private LinearregressionSeriesSonificationTracksMappingTremolo Tremolo_DefaultValue { get; set; }
		 

		/// <summary>
		/// The volume of notes, from 0 to 1.
		/// </summary>
		public LinearregressionSeriesSonificationTracksMappingVolume Volume { get; set; }
		private LinearregressionSeriesSonificationTracksMappingVolume Volume_DefaultValue { get; set; }
