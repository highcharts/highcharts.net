...
{
	public partial class LinearregressionSeriesSonificationTracksMappingFrequency  : BaseObject
	{
		Hashtable h = new Hashtable();

		public LinearregressionSeriesSonificationTracksMappingFrequency()
		{
			MapFunction = MapFunction_DefaultValue = LinearregressionSeriesSonificationTracksMappingFrequencyMapFunction.Linear;
			MapTo = MapTo_DefaultValue = "";
			Max = Max_DefaultValue = null;
			Min = Min_DefaultValue = null;
			Value = Value_DefaultValue = null;
			Within = Within_DefaultValue = LinearregressionSeriesSonificationTracksMappingFrequencyWithin.Chart;
		...
		/// </summary>
		public LinearregressionSeriesSonificationTracksMappingFrequencyMapFunction MapFunction { get; set; }
		private LinearregressionSeriesSonificationTracksMappingFrequencyMapFunction MapFunction_DefaultValue { get; set; }
		...
		/// </summary>
		public LinearregressionSeriesSonificationTracksMappingFrequencyWithin Within { get; set; }
		private LinearregressionSeriesSonificationTracksMappingFrequencyWithin Within_DefaultValue { get; set; }
