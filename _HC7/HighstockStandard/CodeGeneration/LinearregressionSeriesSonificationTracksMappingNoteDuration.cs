...
{
	public partial class LinearregressionSeriesSonificationTracksMappingNoteDuration  : BaseObject
	{
		Hashtable h = new Hashtable();

		public LinearregressionSeriesSonificationTracksMappingNoteDuration()
		{
			MapFunction = MapFunction_DefaultValue = LinearregressionSeriesSonificationTracksMappingNoteDurationMapFunction.Linear;
			MapTo = MapTo_DefaultValue = "";
			Max = Max_DefaultValue = null;
			Min = Min_DefaultValue = null;
			Value = Value_DefaultValue = null;
			Within = Within_DefaultValue = LinearregressionSeriesSonificationTracksMappingNoteDurationWithin.Chart;
		...
		/// </summary>
		public LinearregressionSeriesSonificationTracksMappingNoteDurationMapFunction MapFunction { get; set; }
		private LinearregressionSeriesSonificationTracksMappingNoteDurationMapFunction MapFunction_DefaultValue { get; set; }
		...
		/// </summary>
		public LinearregressionSeriesSonificationTracksMappingNoteDurationWithin Within { get; set; }
		private LinearregressionSeriesSonificationTracksMappingNoteDurationWithin Within_DefaultValue { get; set; }
