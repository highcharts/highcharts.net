...
{
	public partial class LinearregressionSeriesSonificationTracksMappingPan  : BaseObject
	{
		Hashtable h = new Hashtable();

		public LinearregressionSeriesSonificationTracksMappingPan()
		{
			MapFunction = MapFunction_DefaultValue = LinearregressionSeriesSonificationTracksMappingPanMapFunction.Linear;
			MapTo = MapTo_DefaultValue = "";
			Max = Max_DefaultValue = null;
			Min = Min_DefaultValue = null;
			Value = Value_DefaultValue = null;
			Within = Within_DefaultValue = LinearregressionSeriesSonificationTracksMappingPanWithin.Chart;
		...
		/// </summary>
		public LinearregressionSeriesSonificationTracksMappingPanMapFunction MapFunction { get; set; }
		private LinearregressionSeriesSonificationTracksMappingPanMapFunction MapFunction_DefaultValue { get; set; }
		...
		/// </summary>
		public LinearregressionSeriesSonificationTracksMappingPanWithin Within { get; set; }
		private LinearregressionSeriesSonificationTracksMappingPanWithin Within_DefaultValue { get; set; }
