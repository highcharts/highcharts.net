...
{
	public partial class LinearregressionSeriesSonificationTracksMappingPitch  : BaseObject
	{
		Hashtable h = new Hashtable();

		public LinearregressionSeriesSonificationTracksMappingPitch()
		{
			MapFunction = MapFunction_DefaultValue = LinearregressionSeriesSonificationTracksMappingPitchMapFunction.Linear;
		...
		/// </summary>
		public LinearregressionSeriesSonificationTracksMappingPitchMapFunction MapFunction { get; set; }
		private LinearregressionSeriesSonificationTracksMappingPitchMapFunction MapFunction_DefaultValue { get; set; }
