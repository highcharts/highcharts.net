...
{
	public partial class LinearregressionSeriesSonificationTracksMappingTremoloDepth  : BaseObject
	{
		Hashtable h = new Hashtable();

		public LinearregressionSeriesSonificationTracksMappingTremoloDepth()
		{
			MapFunction = MapFunction_DefaultValue = LinearregressionSeriesSonificationTracksMappingTremoloDepthMapFunction.Linear;
			MapTo = MapTo_DefaultValue = "";
			Max = Max_DefaultValue = null;
			Min = Min_DefaultValue = null;
			Value = Value_DefaultValue = null;
			Within = Within_DefaultValue = LinearregressionSeriesSonificationTracksMappingTremoloDepthWithin.Chart;
		...
		/// </summary>
		public LinearregressionSeriesSonificationTracksMappingTremoloDepthMapFunction MapFunction { get; set; }
		private LinearregressionSeriesSonificationTracksMappingTremoloDepthMapFunction MapFunction_DefaultValue { get; set; }
		...
		/// </summary>
		public LinearregressionSeriesSonificationTracksMappingTremoloDepthWithin Within { get; set; }
		private LinearregressionSeriesSonificationTracksMappingTremoloDepthWithin Within_DefaultValue { get; set; }
