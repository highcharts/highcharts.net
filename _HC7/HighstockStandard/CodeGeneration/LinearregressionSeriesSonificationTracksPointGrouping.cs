...
{
	public partial class LinearregressionSeriesSonificationTracksPointGrouping  : BaseObject
	{
		Hashtable h = new Hashtable();

		public LinearregressionSeriesSonificationTracksPointGrouping()
		{
			Algorithm = Algorithm_DefaultValue = LinearregressionSeriesSonificationTracksPointGroupingAlgorithm.Minimax;
		...
		/// </summary>
		public LinearregressionSeriesSonificationTracksPointGroupingAlgorithm Algorithm { get; set; }
		private LinearregressionSeriesSonificationTracksPointGroupingAlgorithm Algorithm_DefaultValue { get; set; }
