...
{
	public partial class LinearregressionSeriesTooltip  : BaseObject
	{
		public LinearregressionSeriesTooltip()
		{
			...
			HeaderShape = HeaderShape_DefaultValue = LinearregressionSeriesTooltipHeaderShape.Callout;
		...
		/// </summary>
		public LinearregressionSeriesTooltipHeaderShape HeaderShape { get; set; }
		private LinearregressionSeriesTooltipHeaderShape HeaderShape_DefaultValue { get; set; }
		...
		internal override Hashtable ToHashtable()
		{
			...
			if (NullFormatter != NullFormatter_DefaultValue) { h.Add("nullFormatter",NullFormatter); Highstock.AddFunction("LinearregressionSeriesTooltipNullFormatter.nullFormatter", NullFormatter); }  
			if (Outside != Outside_DefaultValue) h.Add("outside",Outside);
			if (Padding != Padding_DefaultValue) h.Add("padding",Padding);
			if (PointFormat != PointFormat_DefaultValue) h.Add("pointFormat",PointFormat);
			if (PointFormatter != PointFormatter_DefaultValue) { h.Add("pointFormatter",PointFormatter); Highstock.AddFunction("LinearregressionSeriesTooltipPointFormatter.pointFormatter", PointFormatter); }  
