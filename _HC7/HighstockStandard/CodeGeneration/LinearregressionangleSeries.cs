...
{
	public partial class LinearregressionangleSeries  : Series
	{
		Hashtable h = new Hashtable();

		public LinearregressionangleSeries()
		{
			Accessibility = Accessibility_DefaultValue = new LinearregressionangleSeriesAccessibility();
			AllowPointSelect = AllowPointSelect_DefaultValue = false;
			Animation = Animation_DefaultValue = new Animation() { Enabled = true };
			AnimationBool = AnimationBool_DefaultValue = true;
			AnimationLimit = AnimationLimit_DefaultValue = null;
			BoostBlending = BoostBlending_DefaultValue = LinearregressionangleSeriesBoostBlending.Undefined;
			...
			Compare = Compare_DefaultValue = LinearregressionangleSeriesCompare.Percent;
			CompareBase = CompareBase_DefaultValue = LinearregressionangleSeriesCompareBase.Min;
			...
			Cursor = Cursor_DefaultValue = LinearregressionangleSeriesCursor.Null;
			Custom = Custom_DefaultValue = new Hashtable();
			DashStyle = DashStyle_DefaultValue = LinearregressionangleSeriesDashStyle.Null;
			DataGrouping = DataGrouping_DefaultValue = new LinearregressionangleSeriesDataGrouping();
			DataLabels = DataLabels_DefaultValue = new LinearregressionangleSeriesDataLabels();
			DataSorting = DataSorting_DefaultValue = new LinearregressionangleSeriesDataSorting();
			Description = Description_DefaultValue = "";
			Dumbell = Dumbell_DefaultValue = new LinearregressionangleSeriesDumbell();
			EnableMouseTracking = EnableMouseTracking_DefaultValue = true;
			Events = Events_DefaultValue = new LinearregressionangleSeriesEvents();
			FindNearestPointBy = FindNearestPointBy_DefaultValue = LinearregressionangleSeriesFindNearestPointBy.X;
			GapSize = GapSize_DefaultValue = 0;
			GapUnit = GapUnit_DefaultValue = LinearregressionangleSeriesGapUnit.Relative;
			GetExtremesFromAll = GetExtremesFromAll_DefaultValue = false;
			Id = Id_DefaultValue = "";
			InactiveOtherPoints = InactiveOtherPoints_DefaultValue = false;
			IncludeInDataExport = IncludeInDataExport_DefaultValue = null;
			Index = Index_DefaultValue = null;
			Label = Label_DefaultValue = new LinearregressionangleSeriesLabel();
			LastPrice = LastPrice_DefaultValue = new LinearregressionangleSeriesLastPrice();
			LastVisiblePrice = LastVisiblePrice_DefaultValue = new LinearregressionangleSeriesLastVisiblePrice();
			LegendIndex = LegendIndex_DefaultValue = null;
			LegendSymbol = LegendSymbol_DefaultValue = LinearregressionangleSeriesLegendSymbol.Rectangle;
			Linecap = Linecap_DefaultValue = LinearregressionangleSeriesLinecap.Round;
			LineWidth = LineWidth_DefaultValue = 2;
			LinkedTo = LinkedTo_DefaultValue = "";
			Marker = Marker_DefaultValue = new LinearregressionangleSeriesMarker();
			Name = Name_DefaultValue = "";
			NegativeColor = NegativeColor_DefaultValue = "";
			OnPoint = OnPoint_DefaultValue = new LinearregressionangleSeriesOnPoint();
			Opacity = Opacity_DefaultValue = 1;
			Params = Params_DefaultValue = new LinearregressionangleSeriesParams();
			Point = Point_DefaultValue = new LinearregressionangleSeriesPoint();
			...
			Sonification = Sonification_DefaultValue = new LinearregressionangleSeriesSonification();
			Stack = Stack_DefaultValue = "";
			StackNumber = StackNumber_DefaultValue = null;
			States = States_DefaultValue = new LinearregressionangleSeriesStates();
			Step = Step_DefaultValue = LinearregressionangleSeriesStep.Null;
			StickyTracking = StickyTracking_DefaultValue = true;
			Threshold = Threshold_DefaultValue = 0;
			Tooltip = Tooltip_DefaultValue = new LinearregressionangleSeriesTooltip();
			...
			Zones = Zones_DefaultValue = new List<LinearregressionangleSeriesZones>();
		...
		/// </summary>
		public LinearregressionangleSeriesAccessibility Accessibility { get; set; }
		private LinearregressionangleSeriesAccessibility Accessibility_DefaultValue { get; set; }
		...
		/// </summary>
		public LinearregressionangleSeriesBoostBlending BoostBlending { get; set; }
		private LinearregressionangleSeriesBoostBlending BoostBlending_DefaultValue { get; set; }
		...
		/// </summary>
		public LinearregressionangleSeriesCompare Compare { get; set; }
		private LinearregressionangleSeriesCompare Compare_DefaultValue { get; set; }
		 

		/// <summary>
		/// When [compare](#plotOptions.series.compare) is `percent`, this optiondictates whether to use 0 or 100 as the base of comparison.
		/// </summary>
		public LinearregressionangleSeriesCompareBase CompareBase { get; set; }
		private LinearregressionangleSeriesCompareBase CompareBase_DefaultValue { get; set; }
		...
		/// </summary>
		public LinearregressionangleSeriesCursor Cursor { get; set; }
		private LinearregressionangleSeriesCursor Cursor_DefaultValue { get; set; }
		...
		/// </summary>
		public LinearregressionangleSeriesDashStyle DashStyle { get; set; }
		private LinearregressionangleSeriesDashStyle DashStyle_DefaultValue { get; set; }
		...
		/// </summary>
		public LinearregressionangleSeriesDataGrouping DataGrouping { get; set; }
		private LinearregressionangleSeriesDataGrouping DataGrouping_DefaultValue { get; set; }
		...
		/// </summary>
		public LinearregressionangleSeriesDataLabels DataLabels { get; set; }
		private LinearregressionangleSeriesDataLabels DataLabels_DefaultValue { get; set; }
		 

		/// <summary>
		/// Options for the series data sorting.
		/// </summary>
		public LinearregressionangleSeriesDataSorting DataSorting { get; set; }
		private LinearregressionangleSeriesDataSorting DataSorting_DefaultValue { get; set; }
		...
		/// 
		/// </summary>
		public LinearregressionangleSeriesDumbell Dumbell { get; set; }
		private LinearregressionangleSeriesDumbell Dumbell_DefaultValue { get; set; }
		...
		/// </summary>
		public LinearregressionangleSeriesEvents Events { get; set; }
		private LinearregressionangleSeriesEvents Events_DefaultValue { get; set; }
		...
		/// </summary>
		public LinearregressionangleSeriesFindNearestPointBy FindNearestPointBy { get; set; }
		private LinearregressionangleSeriesFindNearestPointBy FindNearestPointBy_DefaultValue { get; set; }
		...
		/// </summary>
		public LinearregressionangleSeriesGapUnit GapUnit { get; set; }
		private LinearregressionangleSeriesGapUnit GapUnit_DefaultValue { get; set; }
		...
		/// </summary>
		public LinearregressionangleSeriesLabel Label { get; set; }
		private LinearregressionangleSeriesLabel Label_DefaultValue { get; set; }
		 

		/// <summary>
		/// The line marks the last price from all points.
		/// </summary>
		public LinearregressionangleSeriesLastPrice LastPrice { get; set; }
		private LinearregressionangleSeriesLastPrice LastPrice_DefaultValue { get; set; }
		 

		/// <summary>
		/// The line marks the last price from visible range of points.
		/// </summary>
		public LinearregressionangleSeriesLastVisiblePrice LastVisiblePrice { get; set; }
		private LinearregressionangleSeriesLastVisiblePrice LastVisiblePrice_DefaultValue { get; set; }
		...
		/// </summary>
		public LinearregressionangleSeriesLegendSymbol LegendSymbol { get; set; }
		private LinearregressionangleSeriesLegendSymbol LegendSymbol_DefaultValue { get; set; }
		 

		/// <summary>
		/// The line cap used for line ends and line joins on the graph.
		/// </summary>
		public LinearregressionangleSeriesLinecap Linecap { get; set; }
		private LinearregressionangleSeriesLinecap Linecap_DefaultValue { get; set; }
		...
		/// </summary>
		public LinearregressionangleSeriesMarker Marker { get; set; }
		private LinearregressionangleSeriesMarker Marker_DefaultValue { get; set; }
		...
		/// </summary>
		public LinearregressionangleSeriesOnPoint OnPoint { get; set; }
		private LinearregressionangleSeriesOnPoint OnPoint_DefaultValue { get; set; }
		...
		/// </summary>
		public LinearregressionangleSeriesParams Params { get; set; }
		private LinearregressionangleSeriesParams Params_DefaultValue { get; set; }
		 

		/// <summary>
		/// Properties for each single point.
		/// </summary>
		public LinearregressionangleSeriesPoint Point { get; set; }
		private LinearregressionangleSeriesPoint Point_DefaultValue { get; set; }
		...
		/// </summary>
		public LinearregressionangleSeriesSonification Sonification { get; set; }
		private LinearregressionangleSeriesSonification Sonification_DefaultValue { get; set; }
		...
		/// 
		/// </summary>
		public LinearregressionangleSeriesStates States { get; set; }
		private LinearregressionangleSeriesStates States_DefaultValue { get; set; }
		 

		/// <summary>
		/// Whether to apply steps to the line. Possible values are `left`,`center` and `right`.
		/// </summary>
		public LinearregressionangleSeriesStep Step { get; set; }
		private LinearregressionangleSeriesStep Step_DefaultValue { get; set; }
		...
		/// </summary>
		public LinearregressionangleSeriesTooltip Tooltip { get; set; }
		private LinearregressionangleSeriesTooltip Tooltip_DefaultValue { get; set; }
		...
		/// </summary>
		public List<LinearregressionangleSeriesZones> Zones { get; set; }
		private List<LinearregressionangleSeriesZones> Zones_DefaultValue { get; set; }
		...
		internal override Hashtable ToHashtable(Highstock highstock)
		{
			...
			h.Add("type","linearregressionangle");
