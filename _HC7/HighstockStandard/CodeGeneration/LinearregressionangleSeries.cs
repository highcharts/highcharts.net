...
namespace Highsoft.Web.Mvc.Stocks
{
	public partial class LinearregressionangleSeries  : Series
	{
		...
		public LinearregressionangleSeries()
		{
			...
			Zones = Zones_DefaultValue = new List<LinearregressionangleSeriesZone>();
		...
		/// </summary>
		public List<LinearregressionangleSeriesZone> Zones { get; set; }
		private List<LinearregressionangleSeriesZone> Zones_DefaultValue { get; set; }
