...
{
	public partial class LinearregressionangleSeriesLabel  : BaseObject
	{
		public LinearregressionangleSeriesLabel()
		{
			...
			Style = Style_DefaultValue = new LinearregressionangleSeriesLabelStyle();
		...
		/// </summary>
		public LinearregressionangleSeriesLabelStyle Style { get; set; }
		private LinearregressionangleSeriesLabelStyle Style_DefaultValue { get; set; }
