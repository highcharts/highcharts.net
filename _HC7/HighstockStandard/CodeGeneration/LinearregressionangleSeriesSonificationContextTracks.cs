...
{
	public partial class LinearregressionangleSeriesSonificationContextTracks  : BaseObject
	{
		Hashtable h = new Hashtable();

		public LinearregressionangleSeriesSonificationContextTracks()
		{
			ActiveWhen = ActiveWhen_DefaultValue = new LinearregressionangleSeriesSonificationContextTracksActiveWhen();
			Instrument = Instrument_DefaultValue = null;
			InstrumentString = InstrumentString_DefaultValue = "null";
			Mapping = Mapping_DefaultValue = new LinearregressionangleSeriesSonificationContextTracksMapping();
			MidiName = MidiName_DefaultValue = "";
			PointGrouping = PointGrouping_DefaultValue = new LinearregressionangleSeriesSonificationContextTracksPointGrouping();
			...
			Type = Type_DefaultValue = LinearregressionangleSeriesSonificationContextTracksType.Instrument;
			ValueInterval = ValueInterval_DefaultValue = null;
			ValueMapFunction = ValueMapFunction_DefaultValue = LinearregressionangleSeriesSonificationContextTracksValueMapFunction.Linear;
		...
		/// </summary>
		public LinearregressionangleSeriesSonificationContextTracksActiveWhen ActiveWhen { get; set; }
		private LinearregressionangleSeriesSonificationContextTracksActiveWhen ActiveWhen_DefaultValue { get; set; }
		...
		/// </summary>
		public LinearregressionangleSeriesSonificationContextTracksMapping Mapping { get; set; }
		private LinearregressionangleSeriesSonificationContextTracksMapping Mapping_DefaultValue { get; set; }
		...
		/// </summary>
		public LinearregressionangleSeriesSonificationContextTracksPointGrouping PointGrouping { get; set; }
		private LinearregressionangleSeriesSonificationContextTracksPointGrouping PointGrouping_DefaultValue { get; set; }
		...
		/// </summary>
		public LinearregressionangleSeriesSonificationContextTracksType Type { get; set; }
		private LinearregressionangleSeriesSonificationContextTracksType Type_DefaultValue { get; set; }
		...
		/// </summary>
		public LinearregressionangleSeriesSonificationContextTracksValueMapFunction ValueMapFunction { get; set; }
		private LinearregressionangleSeriesSonificationContextTracksValueMapFunction ValueMapFunction_DefaultValue { get; set; }
