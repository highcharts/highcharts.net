...
{
	public partial class LinearregressionangleSeriesSonificationContextTracksMapping  : BaseObject
	{
		Hashtable h = new Hashtable();

		public LinearregressionangleSeriesSonificationContextTracksMapping()
		{
			Frequency = Frequency_DefaultValue = new LinearregressionangleSeriesSonificationContextTracksMappingFrequency();
			GapBetweenNotes = GapBetweenNotes_DefaultValue = new LinearregressionangleSeriesSonificationContextTracksMappingGapBetweenNotes();
			Highpass = Highpass_DefaultValue = new LinearregressionangleSeriesSonificationContextTracksMappingHighpass();
			Lowpass = Lowpass_DefaultValue = new LinearregressionangleSeriesSonificationContextTracksMappingLowpass();
			NoteDuration = NoteDuration_DefaultValue = new LinearregressionangleSeriesSonificationContextTracksMappingNoteDuration();
			Pan = Pan_DefaultValue = new LinearregressionangleSeriesSonificationContextTracksMappingPan();
			Pitch = Pitch_DefaultValue = new LinearregressionangleSeriesSonificationContextTracksMappingPitch();
			PitchString = PitchString_DefaultValue = "null";
			PitchNumber = PitchNumber_DefaultValue = null;
			PlayDelay = PlayDelay_DefaultValue = new LinearregressionangleSeriesSonificationContextTracksMappingPlayDelay();
			Time = Time_DefaultValue = new LinearregressionangleSeriesSonificationContextTracksMappingTime();
			TimeString = TimeString_DefaultValue = "null";
			TimeNumber = TimeNumber_DefaultValue = null;
			Tremolo = Tremolo_DefaultValue = new LinearregressionangleSeriesSonificationContextTracksMappingTremolo();
			Volume = Volume_DefaultValue = new LinearregressionangleSeriesSonificationContextTracksMappingVolume();
		...
		/// </summary>
		public LinearregressionangleSeriesSonificationContextTracksMappingFrequency Frequency { get; set; }
		private LinearregressionangleSeriesSonificationContextTracksMappingFrequency Frequency_DefaultValue { get; set; }
		...
		/// </summary>
		public LinearregressionangleSeriesSonificationContextTracksMappingGapBetweenNotes GapBetweenNotes { get; set; }
		private LinearregressionangleSeriesSonificationContextTracksMappingGapBetweenNotes GapBetweenNotes_DefaultValue { get; set; }
		...
		/// </summary>
		public LinearregressionangleSeriesSonificationContextTracksMappingHighpass Highpass { get; set; }
		private LinearregressionangleSeriesSonificationContextTracksMappingHighpass Highpass_DefaultValue { get; set; }
		...
		/// </summary>
		public LinearregressionangleSeriesSonificationContextTracksMappingLowpass Lowpass { get; set; }
		private LinearregressionangleSeriesSonificationContextTracksMappingLowpass Lowpass_DefaultValue { get; set; }
		...
		/// </summary>
		public LinearregressionangleSeriesSonificationContextTracksMappingNoteDuration NoteDuration { get; set; }
		private LinearregressionangleSeriesSonificationContextTracksMappingNoteDuration NoteDuration_DefaultValue { get; set; }
		...
		/// </summary>
		public LinearregressionangleSeriesSonificationContextTracksMappingPan Pan { get; set; }
		private LinearregressionangleSeriesSonificationContextTracksMappingPan Pan_DefaultValue { get; set; }
		...
		/// </summary>
		public LinearregressionangleSeriesSonificationContextTracksMappingPitch Pitch { get; set; }
		private LinearregressionangleSeriesSonificationContextTracksMappingPitch Pitch_DefaultValue { get; set; }
		...
		/// </summary>
		public LinearregressionangleSeriesSonificationContextTracksMappingPlayDelay PlayDelay { get; set; }
		private LinearregressionangleSeriesSonificationContextTracksMappingPlayDelay PlayDelay_DefaultValue { get; set; }
		...
		/// </summary>
		public LinearregressionangleSeriesSonificationContextTracksMappingTime Time { get; set; }
		private LinearregressionangleSeriesSonificationContextTracksMappingTime Time_DefaultValue { get; set; }
		...
		/// </summary>
		public LinearregressionangleSeriesSonificationContextTracksMappingTremolo Tremolo { get; set; }
		private LinearregressionangleSeriesSonificationContextTracksMappingTremolo Tremolo_DefaultValue { get; set; }
		 

		/// <summary>
		/// The volume of notes, from 0 to 1.
		/// </summary>
		public LinearregressionangleSeriesSonificationContextTracksMappingVolume Volume { get; set; }
		private LinearregressionangleSeriesSonificationContextTracksMappingVolume Volume_DefaultValue { get; set; }
