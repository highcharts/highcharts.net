...
{
	public partial class LinearregressionangleSeriesSonificationContextTracksMappingTime  : BaseObject
	{
		Hashtable h = new Hashtable();

		public LinearregressionangleSeriesSonificationContextTracksMappingTime()
		{
			MapFunction = MapFunction_DefaultValue = LinearregressionangleSeriesSonificationContextTracksMappingTimeMapFunction.Linear;
			MapTo = MapTo_DefaultValue = "";
			Max = Max_DefaultValue = null;
			Min = Min_DefaultValue = null;
			Value = Value_DefaultValue = null;
			Within = Within_DefaultValue = LinearregressionangleSeriesSonificationContextTracksMappingTimeWithin.Chart;
		...
		/// </summary>
		public LinearregressionangleSeriesSonificationContextTracksMappingTimeMapFunction MapFunction { get; set; }
		private LinearregressionangleSeriesSonificationContextTracksMappingTimeMapFunction MapFunction_DefaultValue { get; set; }
		...
		/// </summary>
		public LinearregressionangleSeriesSonificationContextTracksMappingTimeWithin Within { get; set; }
		private LinearregressionangleSeriesSonificationContextTracksMappingTimeWithin Within_DefaultValue { get; set; }
