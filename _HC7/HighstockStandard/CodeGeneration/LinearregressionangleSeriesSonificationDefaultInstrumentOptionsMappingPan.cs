...
{
	public partial class LinearregressionangleSeriesSonificationDefaultInstrumentOptionsMappingPan  : BaseObject
	{
		Hashtable h = new Hashtable();

		public LinearregressionangleSeriesSonificationDefaultInstrumentOptionsMappingPan()
		{
			MapFunction = MapFunction_DefaultValue = LinearregressionangleSeriesSonificationDefaultInstrumentOptionsMappingPanMapFunction.Linear;
			MapTo = MapTo_DefaultValue = "";
			Max = Max_DefaultValue = null;
			Min = Min_DefaultValue = null;
			Value = Value_DefaultValue = null;
			Within = Within_DefaultValue = LinearregressionangleSeriesSonificationDefaultInstrumentOptionsMappingPanWithin.Chart;
		...
		/// </summary>
		public LinearregressionangleSeriesSonificationDefaultInstrumentOptionsMappingPanMapFunction MapFunction { get; set; }
		private LinearregressionangleSeriesSonificationDefaultInstrumentOptionsMappingPanMapFunction MapFunction_DefaultValue { get; set; }
		...
		/// </summary>
		public LinearregressionangleSeriesSonificationDefaultInstrumentOptionsMappingPanWithin Within { get; set; }
		private LinearregressionangleSeriesSonificationDefaultInstrumentOptionsMappingPanWithin Within_DefaultValue { get; set; }
