...
{
	public partial class LinearregressionangleSeriesSonificationDefaultSpeechOptions  : BaseObject
	{
		Hashtable h = new Hashtable();

		public LinearregressionangleSeriesSonificationDefaultSpeechOptions()
		{
			ActiveWhen = ActiveWhen_DefaultValue = new LinearregressionangleSeriesSonificationDefaultSpeechOptionsActiveWhen();
			Language = Language_DefaultValue = "en-US";
			Mapping = Mapping_DefaultValue = new LinearregressionangleSeriesSonificationDefaultSpeechOptionsMapping();
			PointGrouping = PointGrouping_DefaultValue = new LinearregressionangleSeriesSonificationDefaultSpeechOptionsPointGrouping();
			PreferredVoice = PreferredVoice_DefaultValue = "";
			ShowPlayMarker = ShowPlayMarker_DefaultValue = true;
			Type = Type_DefaultValue = LinearregressionangleSeriesSonificationDefaultSpeechOptionsType.Instrument;
		...
		/// </summary>
		public LinearregressionangleSeriesSonificationDefaultSpeechOptionsActiveWhen ActiveWhen { get; set; }
		private LinearregressionangleSeriesSonificationDefaultSpeechOptionsActiveWhen ActiveWhen_DefaultValue { get; set; }
		...
		/// </summary>
		public LinearregressionangleSeriesSonificationDefaultSpeechOptionsMapping Mapping { get; set; }
		private LinearregressionangleSeriesSonificationDefaultSpeechOptionsMapping Mapping_DefaultValue { get; set; }
		 

		/// <summary>
		/// Options for point grouping, specifically for instrument tracks.
		/// </summary>
		public LinearregressionangleSeriesSonificationDefaultSpeechOptionsPointGrouping PointGrouping { get; set; }
		private LinearregressionangleSeriesSonificationDefaultSpeechOptionsPointGrouping PointGrouping_DefaultValue { get; set; }
		...
		/// </summary>
		public LinearregressionangleSeriesSonificationDefaultSpeechOptionsType Type { get; set; }
		private LinearregressionangleSeriesSonificationDefaultSpeechOptionsType Type_DefaultValue { get; set; }
