...
{
	public partial class LinearregressionangleSeriesSonificationDefaultSpeechOptionsMapping  : BaseObject
	{
		Hashtable h = new Hashtable();

		public LinearregressionangleSeriesSonificationDefaultSpeechOptionsMapping()
		{
			Frequency = Frequency_DefaultValue = new LinearregressionangleSeriesSonificationDefaultSpeechOptionsMappingFrequency();
			GapBetweenNotes = GapBetweenNotes_DefaultValue = new LinearregressionangleSeriesSonificationDefaultSpeechOptionsMappingGapBetweenNotes();
			Highpass = Highpass_DefaultValue = new LinearregressionangleSeriesSonificationDefaultSpeechOptionsMappingHighpass();
			Lowpass = Lowpass_DefaultValue = new LinearregressionangleSeriesSonificationDefaultSpeechOptionsMappingLowpass();
			NoteDuration = NoteDuration_DefaultValue = new LinearregressionangleSeriesSonificationDefaultSpeechOptionsMappingNoteDuration();
			Pan = Pan_DefaultValue = new LinearregressionangleSeriesSonificationDefaultSpeechOptionsMappingPan();
			Pitch = Pitch_DefaultValue = new LinearregressionangleSeriesSonificationDefaultSpeechOptionsMappingPitch();
			PitchString = PitchString_DefaultValue = "null";
			PitchNumber = PitchNumber_DefaultValue = null;
			PlayDelay = PlayDelay_DefaultValue = new LinearregressionangleSeriesSonificationDefaultSpeechOptionsMappingPlayDelay();
			Time = Time_DefaultValue = new LinearregressionangleSeriesSonificationDefaultSpeechOptionsMappingTime();
			TimeString = TimeString_DefaultValue = "null";
			TimeNumber = TimeNumber_DefaultValue = null;
			Tremolo = Tremolo_DefaultValue = new LinearregressionangleSeriesSonificationDefaultSpeechOptionsMappingTremolo();
			Volume = Volume_DefaultValue = new LinearregressionangleSeriesSonificationDefaultSpeechOptionsMappingVolume();
		...
		/// </summary>
		public LinearregressionangleSeriesSonificationDefaultSpeechOptionsMappingFrequency Frequency { get; set; }
		private LinearregressionangleSeriesSonificationDefaultSpeechOptionsMappingFrequency Frequency_DefaultValue { get; set; }
		...
		/// </summary>
		public LinearregressionangleSeriesSonificationDefaultSpeechOptionsMappingGapBetweenNotes GapBetweenNotes { get; set; }
		private LinearregressionangleSeriesSonificationDefaultSpeechOptionsMappingGapBetweenNotes GapBetweenNotes_DefaultValue { get; set; }
		...
		/// </summary>
		public LinearregressionangleSeriesSonificationDefaultSpeechOptionsMappingHighpass Highpass { get; set; }
		private LinearregressionangleSeriesSonificationDefaultSpeechOptionsMappingHighpass Highpass_DefaultValue { get; set; }
		...
		/// </summary>
		public LinearregressionangleSeriesSonificationDefaultSpeechOptionsMappingLowpass Lowpass { get; set; }
		private LinearregressionangleSeriesSonificationDefaultSpeechOptionsMappingLowpass Lowpass_DefaultValue { get; set; }
		...
		/// </summary>
		public LinearregressionangleSeriesSonificationDefaultSpeechOptionsMappingNoteDuration NoteDuration { get; set; }
		private LinearregressionangleSeriesSonificationDefaultSpeechOptionsMappingNoteDuration NoteDuration_DefaultValue { get; set; }
		...
		/// </summary>
		public LinearregressionangleSeriesSonificationDefaultSpeechOptionsMappingPan Pan { get; set; }
		private LinearregressionangleSeriesSonificationDefaultSpeechOptionsMappingPan Pan_DefaultValue { get; set; }
		...
		/// </summary>
		public LinearregressionangleSeriesSonificationDefaultSpeechOptionsMappingPitch Pitch { get; set; }
		private LinearregressionangleSeriesSonificationDefaultSpeechOptionsMappingPitch Pitch_DefaultValue { get; set; }
		...
		/// </summary>
		public LinearregressionangleSeriesSonificationDefaultSpeechOptionsMappingPlayDelay PlayDelay { get; set; }
		private LinearregressionangleSeriesSonificationDefaultSpeechOptionsMappingPlayDelay PlayDelay_DefaultValue { get; set; }
		...
		/// </summary>
		public LinearregressionangleSeriesSonificationDefaultSpeechOptionsMappingTime Time { get; set; }
		private LinearregressionangleSeriesSonificationDefaultSpeechOptionsMappingTime Time_DefaultValue { get; set; }
		...
		/// </summary>
		public LinearregressionangleSeriesSonificationDefaultSpeechOptionsMappingTremolo Tremolo { get; set; }
		private LinearregressionangleSeriesSonificationDefaultSpeechOptionsMappingTremolo Tremolo_DefaultValue { get; set; }
		 

		/// <summary>
		/// The volume of notes, from 0 to 1.
		/// </summary>
		public LinearregressionangleSeriesSonificationDefaultSpeechOptionsMappingVolume Volume { get; set; }
		private LinearregressionangleSeriesSonificationDefaultSpeechOptionsMappingVolume Volume_DefaultValue { get; set; }
