...
{
	public partial class LinearregressionangleSeriesSonificationPointGrouping  : BaseObject
	{
		Hashtable h = new Hashtable();

		public LinearregressionangleSeriesSonificationPointGrouping()
		{
			Algorithm = Algorithm_DefaultValue = LinearregressionangleSeriesSonificationPointGroupingAlgorithm.Minimax;
		...
		/// </summary>
		public LinearregressionangleSeriesSonificationPointGroupingAlgorithm Algorithm { get; set; }
		private LinearregressionangleSeriesSonificationPointGroupingAlgorithm Algorithm_DefaultValue { get; set; }
