...
{
	public partial class LinearregressionangleSeriesSonificationTracks  : BaseObject
	{
		Hashtable h = new Hashtable();

		public LinearregressionangleSeriesSonificationTracks()
		{
			ActiveWhen = ActiveWhen_DefaultValue = new LinearregressionangleSeriesSonificationTracksActiveWhen();
			Instrument = Instrument_DefaultValue = null;
			InstrumentString = InstrumentString_DefaultValue = "null";
			Mapping = Mapping_DefaultValue = new LinearregressionangleSeriesSonificationTracksMapping();
			MidiName = MidiName_DefaultValue = "";
			PointGrouping = PointGrouping_DefaultValue = new LinearregressionangleSeriesSonificationTracksPointGrouping();
			RoundToMusicalNotes = RoundToMusicalNotes_DefaultValue = true;
			ShowPlayMarker = ShowPlayMarker_DefaultValue = true;
			Type = Type_DefaultValue = LinearregressionangleSeriesSonificationTracksType.Instrument;
		...
		/// </summary>
		public LinearregressionangleSeriesSonificationTracksActiveWhen ActiveWhen { get; set; }
		private LinearregressionangleSeriesSonificationTracksActiveWhen ActiveWhen_DefaultValue { get; set; }
		...
		/// </summary>
		public LinearregressionangleSeriesSonificationTracksMapping Mapping { get; set; }
		private LinearregressionangleSeriesSonificationTracksMapping Mapping_DefaultValue { get; set; }
		...
		/// </summary>
		public LinearregressionangleSeriesSonificationTracksPointGrouping PointGrouping { get; set; }
		private LinearregressionangleSeriesSonificationTracksPointGrouping PointGrouping_DefaultValue { get; set; }
		...
		/// </summary>
		public LinearregressionangleSeriesSonificationTracksType Type { get; set; }
		private LinearregressionangleSeriesSonificationTracksType Type_DefaultValue { get; set; }
