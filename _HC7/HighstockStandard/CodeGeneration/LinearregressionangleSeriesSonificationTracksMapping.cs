...
{
	public partial class LinearregressionangleSeriesSonificationTracksMapping  : BaseObject
	{
		Hashtable h = new Hashtable();

		public LinearregressionangleSeriesSonificationTracksMapping()
		{
			Frequency = Frequency_DefaultValue = new LinearregressionangleSeriesSonificationTracksMappingFrequency();
			GapBetweenNotes = GapBetweenNotes_DefaultValue = new LinearregressionangleSeriesSonificationTracksMappingGapBetweenNotes();
			Highpass = Highpass_DefaultValue = new LinearregressionangleSeriesSonificationTracksMappingHighpass();
			Lowpass = Lowpass_DefaultValue = new LinearregressionangleSeriesSonificationTracksMappingLowpass();
			NoteDuration = NoteDuration_DefaultValue = new LinearregressionangleSeriesSonificationTracksMappingNoteDuration();
			Pan = Pan_DefaultValue = new LinearregressionangleSeriesSonificationTracksMappingPan();
			Pitch = Pitch_DefaultValue = new LinearregressionangleSeriesSonificationTracksMappingPitch();
			PitchString = PitchString_DefaultValue = "null";
			PitchNumber = PitchNumber_DefaultValue = null;
			PlayDelay = PlayDelay_DefaultValue = new LinearregressionangleSeriesSonificationTracksMappingPlayDelay();
			Time = Time_DefaultValue = new LinearregressionangleSeriesSonificationTracksMappingTime();
			TimeString = TimeString_DefaultValue = "null";
			TimeNumber = TimeNumber_DefaultValue = null;
			Tremolo = Tremolo_DefaultValue = new LinearregressionangleSeriesSonificationTracksMappingTremolo();
			Volume = Volume_DefaultValue = new LinearregressionangleSeriesSonificationTracksMappingVolume();
		...
		/// </summary>
		public LinearregressionangleSeriesSonificationTracksMappingFrequency Frequency { get; set; }
		private LinearregressionangleSeriesSonificationTracksMappingFrequency Frequency_DefaultValue { get; set; }
		...
		/// </summary>
		public LinearregressionangleSeriesSonificationTracksMappingGapBetweenNotes GapBetweenNotes { get; set; }
		private LinearregressionangleSeriesSonificationTracksMappingGapBetweenNotes GapBetweenNotes_DefaultValue { get; set; }
		...
		/// </summary>
		public LinearregressionangleSeriesSonificationTracksMappingHighpass Highpass { get; set; }
		private LinearregressionangleSeriesSonificationTracksMappingHighpass Highpass_DefaultValue { get; set; }
		...
		/// </summary>
		public LinearregressionangleSeriesSonificationTracksMappingLowpass Lowpass { get; set; }
		private LinearregressionangleSeriesSonificationTracksMappingLowpass Lowpass_DefaultValue { get; set; }
		...
		/// </summary>
		public LinearregressionangleSeriesSonificationTracksMappingNoteDuration NoteDuration { get; set; }
		private LinearregressionangleSeriesSonificationTracksMappingNoteDuration NoteDuration_DefaultValue { get; set; }
		...
		/// </summary>
		public LinearregressionangleSeriesSonificationTracksMappingPan Pan { get; set; }
		private LinearregressionangleSeriesSonificationTracksMappingPan Pan_DefaultValue { get; set; }
		...
		/// </summary>
		public LinearregressionangleSeriesSonificationTracksMappingPitch Pitch { get; set; }
		private LinearregressionangleSeriesSonificationTracksMappingPitch Pitch_DefaultValue { get; set; }
		...
		/// </summary>
		public LinearregressionangleSeriesSonificationTracksMappingPlayDelay PlayDelay { get; set; }
		private LinearregressionangleSeriesSonificationTracksMappingPlayDelay PlayDelay_DefaultValue { get; set; }
		...
		/// </summary>
		public LinearregressionangleSeriesSonificationTracksMappingTime Time { get; set; }
		private LinearregressionangleSeriesSonificationTracksMappingTime Time_DefaultValue { get; set; }
		...
		/// </summary>
		public LinearregressionangleSeriesSonificationTracksMappingTremolo Tremolo { get; set; }
		private LinearregressionangleSeriesSonificationTracksMappingTremolo Tremolo_DefaultValue { get; set; }
		 

		/// <summary>
		/// The volume of notes, from 0 to 1.
		/// </summary>
		public LinearregressionangleSeriesSonificationTracksMappingVolume Volume { get; set; }
		private LinearregressionangleSeriesSonificationTracksMappingVolume Volume_DefaultValue { get; set; }
