...
namespace Highsoft.Web.Mvc.Stocks
{
	public partial class LinearregressionangleSeriesSonificationTracksMappingPitch  : BaseObject
	{
		...
		{
			if (MapFunction != LinearregressionangleSeriesSonificationTracksMappingPitchMapFunction.Null) h.Add("mapFunction", highstock.FirstCharacterToLower(MapFunction.ToString()));
