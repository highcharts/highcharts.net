...
{
	public partial class LinearregressionangleSeriesSonificationTracksMappingVolume  : BaseObject
	{
		Hashtable h = new Hashtable();

		public LinearregressionangleSeriesSonificationTracksMappingVolume()
		{
			MapFunction = MapFunction_DefaultValue = LinearregressionangleSeriesSonificationTracksMappingVolumeMapFunction.Linear;
			MapTo = MapTo_DefaultValue = "";
			Max = Max_DefaultValue = null;
			Min = Min_DefaultValue = null;
			Value = Value_DefaultValue = null;
			Within = Within_DefaultValue = LinearregressionangleSeriesSonificationTracksMappingVolumeWithin.Chart;
		...
		/// </summary>
		public LinearregressionangleSeriesSonificationTracksMappingVolumeMapFunction MapFunction { get; set; }
		private LinearregressionangleSeriesSonificationTracksMappingVolumeMapFunction MapFunction_DefaultValue { get; set; }
		...
		/// </summary>
		public LinearregressionangleSeriesSonificationTracksMappingVolumeWithin Within { get; set; }
		private LinearregressionangleSeriesSonificationTracksMappingVolumeWithin Within_DefaultValue { get; set; }
