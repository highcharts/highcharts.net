...
{
	public partial class LinearregressionangleSeriesSonificationTracksPointGrouping  : BaseObject
	{
		Hashtable h = new Hashtable();

		public LinearregressionangleSeriesSonificationTracksPointGrouping()
		{
			Algorithm = Algorithm_DefaultValue = LinearregressionangleSeriesSonificationTracksPointGroupingAlgorithm.Minimax;
		...
		/// </summary>
		public LinearregressionangleSeriesSonificationTracksPointGroupingAlgorithm Algorithm { get; set; }
		private LinearregressionangleSeriesSonificationTracksPointGroupingAlgorithm Algorithm_DefaultValue { get; set; }
