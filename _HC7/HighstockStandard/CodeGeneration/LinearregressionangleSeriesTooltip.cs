...
{
	public partial class LinearregressionangleSeriesTooltip  : BaseObject
	{
		public LinearregressionangleSeriesTooltip()
		{
			...
			HeaderShape = HeaderShape_DefaultValue = LinearregressionangleSeriesTooltipHeaderShape.Callout;
		...
		/// </summary>
		public LinearregressionangleSeriesTooltipHeaderShape HeaderShape { get; set; }
		private LinearregressionangleSeriesTooltipHeaderShape HeaderShape_DefaultValue { get; set; }
		...
		internal override Hashtable ToHashtable()
		{
			...
			if (NullFormatter != NullFormatter_DefaultValue) { h.Add("nullFormatter",NullFormatter); Highstock.AddFunction("LinearregressionangleSeriesTooltipNullFormatter.nullFormatter", NullFormatter); }  
			if (Outside != Outside_DefaultValue) h.Add("outside",Outside);
			if (Padding != Padding_DefaultValue) h.Add("padding",Padding);
			if (PointFormat != PointFormat_DefaultValue) h.Add("pointFormat",PointFormat);
			if (PointFormatter != PointFormatter_DefaultValue) { h.Add("pointFormatter",PointFormatter); Highstock.AddFunction("LinearregressionangleSeriesTooltipPointFormatter.pointFormatter", PointFormatter); }  
