...
{
	public partial class LinearregressioninterceptSeries  : Series
	{
		Hashtable h = new Hashtable();

		public LinearregressioninterceptSeries()
		{
			Accessibility = Accessibility_DefaultValue = new LinearregressioninterceptSeriesAccessibility();
			AllowPointSelect = AllowPointSelect_DefaultValue = false;
			Animation = Animation_DefaultValue = new Animation() { Enabled = true };
			AnimationBool = AnimationBool_DefaultValue = true;
			AnimationLimit = AnimationLimit_DefaultValue = null;
			BoostBlending = BoostBlending_DefaultValue = LinearregressioninterceptSeriesBoostBlending.Undefined;
			...
			Compare = Compare_DefaultValue = LinearregressioninterceptSeriesCompare.Percent;
			CompareBase = CompareBase_DefaultValue = LinearregressioninterceptSeriesCompareBase.Min;
			...
			Cursor = Cursor_DefaultValue = LinearregressioninterceptSeriesCursor.Null;
			Custom = Custom_DefaultValue = new Hashtable();
			DashStyle = DashStyle_DefaultValue = LinearregressioninterceptSeriesDashStyle.Null;
			DataGrouping = DataGrouping_DefaultValue = new LinearregressioninterceptSeriesDataGrouping();
			DataLabels = DataLabels_DefaultValue = new LinearregressioninterceptSeriesDataLabels();
			DataSorting = DataSorting_DefaultValue = new LinearregressioninterceptSeriesDataSorting();
			Description = Description_DefaultValue = "";
			Dumbell = Dumbell_DefaultValue = new LinearregressioninterceptSeriesDumbell();
			EnableMouseTracking = EnableMouseTracking_DefaultValue = true;
			Events = Events_DefaultValue = new LinearregressioninterceptSeriesEvents();
			FindNearestPointBy = FindNearestPointBy_DefaultValue = LinearregressioninterceptSeriesFindNearestPointBy.X;
			GapSize = GapSize_DefaultValue = 0;
			GapUnit = GapUnit_DefaultValue = LinearregressioninterceptSeriesGapUnit.Relative;
			GetExtremesFromAll = GetExtremesFromAll_DefaultValue = false;
			Id = Id_DefaultValue = "";
			InactiveOtherPoints = InactiveOtherPoints_DefaultValue = false;
			IncludeInDataExport = IncludeInDataExport_DefaultValue = null;
			Index = Index_DefaultValue = null;
			Label = Label_DefaultValue = new LinearregressioninterceptSeriesLabel();
			LastPrice = LastPrice_DefaultValue = new LinearregressioninterceptSeriesLastPrice();
			LastVisiblePrice = LastVisiblePrice_DefaultValue = new LinearregressioninterceptSeriesLastVisiblePrice();
			LegendIndex = LegendIndex_DefaultValue = null;
			LegendSymbol = LegendSymbol_DefaultValue = LinearregressioninterceptSeriesLegendSymbol.Rectangle;
			Linecap = Linecap_DefaultValue = LinearregressioninterceptSeriesLinecap.Round;
			LineWidth = LineWidth_DefaultValue = 2;
			LinkedTo = LinkedTo_DefaultValue = "";
			Marker = Marker_DefaultValue = new LinearregressioninterceptSeriesMarker();
			Name = Name_DefaultValue = "";
			NegativeColor = NegativeColor_DefaultValue = "";
			OnPoint = OnPoint_DefaultValue = new LinearregressioninterceptSeriesOnPoint();
			Opacity = Opacity_DefaultValue = 1;
			Params = Params_DefaultValue = new LinearregressioninterceptSeriesParams();
			Point = Point_DefaultValue = new LinearregressioninterceptSeriesPoint();
			...
			Sonification = Sonification_DefaultValue = new LinearregressioninterceptSeriesSonification();
			Stack = Stack_DefaultValue = "";
			StackNumber = StackNumber_DefaultValue = null;
			States = States_DefaultValue = new LinearregressioninterceptSeriesStates();
			Step = Step_DefaultValue = LinearregressioninterceptSeriesStep.Null;
			StickyTracking = StickyTracking_DefaultValue = true;
			Threshold = Threshold_DefaultValue = 0;
			Tooltip = Tooltip_DefaultValue = new LinearregressioninterceptSeriesTooltip();
			...
			Zones = Zones_DefaultValue = new List<LinearregressioninterceptSeriesZones>();
		...
		/// </summary>
		public LinearregressioninterceptSeriesAccessibility Accessibility { get; set; }
		private LinearregressioninterceptSeriesAccessibility Accessibility_DefaultValue { get; set; }
		...
		/// </summary>
		public LinearregressioninterceptSeriesBoostBlending BoostBlending { get; set; }
		private LinearregressioninterceptSeriesBoostBlending BoostBlending_DefaultValue { get; set; }
		...
		/// </summary>
		public LinearregressioninterceptSeriesCompare Compare { get; set; }
		private LinearregressioninterceptSeriesCompare Compare_DefaultValue { get; set; }
		 

		/// <summary>
		/// When [compare](#plotOptions.series.compare) is `percent`, this optiondictates whether to use 0 or 100 as the base of comparison.
		/// </summary>
		public LinearregressioninterceptSeriesCompareBase CompareBase { get; set; }
		private LinearregressioninterceptSeriesCompareBase CompareBase_DefaultValue { get; set; }
		...
		/// </summary>
		public LinearregressioninterceptSeriesCursor Cursor { get; set; }
		private LinearregressioninterceptSeriesCursor Cursor_DefaultValue { get; set; }
		...
		/// </summary>
		public LinearregressioninterceptSeriesDashStyle DashStyle { get; set; }
		private LinearregressioninterceptSeriesDashStyle DashStyle_DefaultValue { get; set; }
		...
		/// </summary>
		public LinearregressioninterceptSeriesDataGrouping DataGrouping { get; set; }
		private LinearregressioninterceptSeriesDataGrouping DataGrouping_DefaultValue { get; set; }
		...
		/// </summary>
		public LinearregressioninterceptSeriesDataLabels DataLabels { get; set; }
		private LinearregressioninterceptSeriesDataLabels DataLabels_DefaultValue { get; set; }
		 

		/// <summary>
		/// Options for the series data sorting.
		/// </summary>
		public LinearregressioninterceptSeriesDataSorting DataSorting { get; set; }
		private LinearregressioninterceptSeriesDataSorting DataSorting_DefaultValue { get; set; }
		...
		/// 
		/// </summary>
		public LinearregressioninterceptSeriesDumbell Dumbell { get; set; }
		private LinearregressioninterceptSeriesDumbell Dumbell_DefaultValue { get; set; }
		...
		/// </summary>
		public LinearregressioninterceptSeriesEvents Events { get; set; }
		private LinearregressioninterceptSeriesEvents Events_DefaultValue { get; set; }
		...
		/// </summary>
		public LinearregressioninterceptSeriesFindNearestPointBy FindNearestPointBy { get; set; }
		private LinearregressioninterceptSeriesFindNearestPointBy FindNearestPointBy_DefaultValue { get; set; }
		...
		/// </summary>
		public LinearregressioninterceptSeriesGapUnit GapUnit { get; set; }
		private LinearregressioninterceptSeriesGapUnit GapUnit_DefaultValue { get; set; }
		...
		/// </summary>
		public LinearregressioninterceptSeriesLabel Label { get; set; }
		private LinearregressioninterceptSeriesLabel Label_DefaultValue { get; set; }
		 

		/// <summary>
		/// The line marks the last price from all points.
		/// </summary>
		public LinearregressioninterceptSeriesLastPrice LastPrice { get; set; }
		private LinearregressioninterceptSeriesLastPrice LastPrice_DefaultValue { get; set; }
		 

		/// <summary>
		/// The line marks the last price from visible range of points.
		/// </summary>
		public LinearregressioninterceptSeriesLastVisiblePrice LastVisiblePrice { get; set; }
		private LinearregressioninterceptSeriesLastVisiblePrice LastVisiblePrice_DefaultValue { get; set; }
		...
		/// </summary>
		public LinearregressioninterceptSeriesLegendSymbol LegendSymbol { get; set; }
		private LinearregressioninterceptSeriesLegendSymbol LegendSymbol_DefaultValue { get; set; }
		 

		/// <summary>
		/// The line cap used for line ends and line joins on the graph.
		/// </summary>
		public LinearregressioninterceptSeriesLinecap Linecap { get; set; }
		private LinearregressioninterceptSeriesLinecap Linecap_DefaultValue { get; set; }
		...
		/// </summary>
		public LinearregressioninterceptSeriesMarker Marker { get; set; }
		private LinearregressioninterceptSeriesMarker Marker_DefaultValue { get; set; }
		...
		/// </summary>
		public LinearregressioninterceptSeriesOnPoint OnPoint { get; set; }
		private LinearregressioninterceptSeriesOnPoint OnPoint_DefaultValue { get; set; }
		...
		/// </summary>
		public LinearregressioninterceptSeriesParams Params { get; set; }
		private LinearregressioninterceptSeriesParams Params_DefaultValue { get; set; }
		 

		/// <summary>
		/// Properties for each single point.
		/// </summary>
		public LinearregressioninterceptSeriesPoint Point { get; set; }
		private LinearregressioninterceptSeriesPoint Point_DefaultValue { get; set; }
		...
		/// </summary>
		public LinearregressioninterceptSeriesSonification Sonification { get; set; }
		private LinearregressioninterceptSeriesSonification Sonification_DefaultValue { get; set; }
		...
		/// 
		/// </summary>
		public LinearregressioninterceptSeriesStates States { get; set; }
		private LinearregressioninterceptSeriesStates States_DefaultValue { get; set; }
		 

		/// <summary>
		/// Whether to apply steps to the line. Possible values are `left`,`center` and `right`.
		/// </summary>
		public LinearregressioninterceptSeriesStep Step { get; set; }
		private LinearregressioninterceptSeriesStep Step_DefaultValue { get; set; }
		...
		/// </summary>
		public LinearregressioninterceptSeriesTooltip Tooltip { get; set; }
		private LinearregressioninterceptSeriesTooltip Tooltip_DefaultValue { get; set; }
		...
		/// </summary>
		public List<LinearregressioninterceptSeriesZones> Zones { get; set; }
		private List<LinearregressioninterceptSeriesZones> Zones_DefaultValue { get; set; }
		...
		internal override Hashtable ToHashtable(Highstock highstock)
		{
			...
			h.Add("type","linearregressionintercept");
