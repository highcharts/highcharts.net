...
namespace Highsoft.Web.Mvc.Stocks
{
	public partial class LinearregressioninterceptSeries  : Series
	{
		...
		public LinearregressioninterceptSeries()
		{
			...
			Zones = Zones_DefaultValue = new List<LinearregressioninterceptSeriesZone>();
		...
		/// </summary>
		public List<LinearregressioninterceptSeriesZone> Zones { get; set; }
		private List<LinearregressioninterceptSeriesZone> Zones_DefaultValue { get; set; }
