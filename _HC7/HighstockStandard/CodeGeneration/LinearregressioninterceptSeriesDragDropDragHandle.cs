...
{
	public partial class LinearregressioninterceptSeriesDragDropDragHandle  : BaseObject
	{
		public LinearregressioninterceptSeriesDragDropDragHandle()
		{
		...
		internal override Hashtable ToHashtable()
		{
			...
			if (PathFormatter != PathFormatter_DefaultValue) { h.Add("pathFormatter",PathFormatter); Highstock.AddFunction("LinearregressioninterceptSeriesDragDropDragHandlePathFormatter.pathFormatter", PathFormatter); }  
