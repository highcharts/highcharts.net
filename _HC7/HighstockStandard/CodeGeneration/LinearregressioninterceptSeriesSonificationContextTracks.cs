...
{
	public partial class LinearregressioninterceptSeriesSonificationContextTracks  : BaseObject
	{
		Hashtable h = new Hashtable();

		public LinearregressioninterceptSeriesSonificationContextTracks()
		{
			ActiveWhen = ActiveWhen_DefaultValue = new LinearregressioninterceptSeriesSonificationContextTracksActiveWhen();
			Instrument = Instrument_DefaultValue = null;
			InstrumentString = InstrumentString_DefaultValue = "null";
			Mapping = Mapping_DefaultValue = new LinearregressioninterceptSeriesSonificationContextTracksMapping();
			MidiName = MidiName_DefaultValue = "";
			PointGrouping = PointGrouping_DefaultValue = new LinearregressioninterceptSeriesSonificationContextTracksPointGrouping();
			...
			Type = Type_DefaultValue = LinearregressioninterceptSeriesSonificationContextTracksType.Instrument;
			ValueInterval = ValueInterval_DefaultValue = null;
			ValueMapFunction = ValueMapFunction_DefaultValue = LinearregressioninterceptSeriesSonificationContextTracksValueMapFunction.Linear;
		...
		/// </summary>
		public LinearregressioninterceptSeriesSonificationContextTracksActiveWhen ActiveWhen { get; set; }
		private LinearregressioninterceptSeriesSonificationContextTracksActiveWhen ActiveWhen_DefaultValue { get; set; }
		...
		/// </summary>
		public LinearregressioninterceptSeriesSonificationContextTracksMapping Mapping { get; set; }
		private LinearregressioninterceptSeriesSonificationContextTracksMapping Mapping_DefaultValue { get; set; }
		...
		/// </summary>
		public LinearregressioninterceptSeriesSonificationContextTracksPointGrouping PointGrouping { get; set; }
		private LinearregressioninterceptSeriesSonificationContextTracksPointGrouping PointGrouping_DefaultValue { get; set; }
		...
		/// </summary>
		public LinearregressioninterceptSeriesSonificationContextTracksType Type { get; set; }
		private LinearregressioninterceptSeriesSonificationContextTracksType Type_DefaultValue { get; set; }
		...
		/// </summary>
		public LinearregressioninterceptSeriesSonificationContextTracksValueMapFunction ValueMapFunction { get; set; }
		private LinearregressioninterceptSeriesSonificationContextTracksValueMapFunction ValueMapFunction_DefaultValue { get; set; }
