...
{
	public partial class LinearregressioninterceptSeriesSonificationContextTracksMappingTime  : BaseObject
	{
		Hashtable h = new Hashtable();

		public LinearregressioninterceptSeriesSonificationContextTracksMappingTime()
		{
			MapFunction = MapFunction_DefaultValue = LinearregressioninterceptSeriesSonificationContextTracksMappingTimeMapFunction.Linear;
			MapTo = MapTo_DefaultValue = "";
			Max = Max_DefaultValue = null;
			Min = Min_DefaultValue = null;
			Value = Value_DefaultValue = null;
			Within = Within_DefaultValue = LinearregressioninterceptSeriesSonificationContextTracksMappingTimeWithin.Chart;
		...
		/// </summary>
		public LinearregressioninterceptSeriesSonificationContextTracksMappingTimeMapFunction MapFunction { get; set; }
		private LinearregressioninterceptSeriesSonificationContextTracksMappingTimeMapFunction MapFunction_DefaultValue { get; set; }
		...
		/// </summary>
		public LinearregressioninterceptSeriesSonificationContextTracksMappingTimeWithin Within { get; set; }
		private LinearregressioninterceptSeriesSonificationContextTracksMappingTimeWithin Within_DefaultValue { get; set; }
