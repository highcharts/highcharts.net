...
{
	public partial class LinearregressioninterceptSeriesSonificationDefaultSpeechOptionsMappingTremoloSpeed  : BaseObject
	{
		Hashtable h = new Hashtable();

		public LinearregressioninterceptSeriesSonificationDefaultSpeechOptionsMappingTremoloSpeed()
		{
			MapFunction = MapFunction_DefaultValue = LinearregressioninterceptSeriesSonificationDefaultSpeechOptionsMappingTremoloSpeedMapFunction.Linear;
			MapTo = MapTo_DefaultValue = "";
			Max = Max_DefaultValue = null;
			Min = Min_DefaultValue = null;
			Value = Value_DefaultValue = null;
			Within = Within_DefaultValue = LinearregressioninterceptSeriesSonificationDefaultSpeechOptionsMappingTremoloSpeedWithin.Chart;
		...
		/// </summary>
		public LinearregressioninterceptSeriesSonificationDefaultSpeechOptionsMappingTremoloSpeedMapFunction MapFunction { get; set; }
		private LinearregressioninterceptSeriesSonificationDefaultSpeechOptionsMappingTremoloSpeedMapFunction MapFunction_DefaultValue { get; set; }
		...
		/// </summary>
		public LinearregressioninterceptSeriesSonificationDefaultSpeechOptionsMappingTremoloSpeedWithin Within { get; set; }
		private LinearregressioninterceptSeriesSonificationDefaultSpeechOptionsMappingTremoloSpeedWithin Within_DefaultValue { get; set; }
