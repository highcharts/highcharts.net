...
{
	public partial class LinearregressioninterceptSeriesSonificationPointGrouping  : BaseObject
	{
		Hashtable h = new Hashtable();

		public LinearregressioninterceptSeriesSonificationPointGrouping()
		{
			Algorithm = Algorithm_DefaultValue = LinearregressioninterceptSeriesSonificationPointGroupingAlgorithm.Minimax;
		...
		/// </summary>
		public LinearregressioninterceptSeriesSonificationPointGroupingAlgorithm Algorithm { get; set; }
		private LinearregressioninterceptSeriesSonificationPointGroupingAlgorithm Algorithm_DefaultValue { get; set; }
