...
namespace Highsoft.Web.Mvc.Stocks
{
	public partial class LinearregressioninterceptSeriesSonificationPointGrouping  : BaseObject
	{
		...
		{
			if (Algorithm != LinearregressioninterceptSeriesSonificationPointGroupingAlgorithm.Null) h.Add("algorithm", highstock.FirstCharacterToLower(Algorithm.ToString()));
