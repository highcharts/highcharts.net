...
{
	public partial class LinearregressioninterceptSeriesSonificationTracks  : BaseObject
	{
		Hashtable h = new Hashtable();

		public LinearregressioninterceptSeriesSonificationTracks()
		{
			ActiveWhen = ActiveWhen_DefaultValue = new LinearregressioninterceptSeriesSonificationTracksActiveWhen();
			Instrument = Instrument_DefaultValue = null;
			InstrumentString = InstrumentString_DefaultValue = "null";
			Mapping = Mapping_DefaultValue = new LinearregressioninterceptSeriesSonificationTracksMapping();
			MidiName = MidiName_DefaultValue = "";
			PointGrouping = PointGrouping_DefaultValue = new LinearregressioninterceptSeriesSonificationTracksPointGrouping();
			RoundToMusicalNotes = RoundToMusicalNotes_DefaultValue = true;
			ShowPlayMarker = ShowPlayMarker_DefaultValue = true;
			Type = Type_DefaultValue = LinearregressioninterceptSeriesSonificationTracksType.Instrument;
		...
		/// </summary>
		public LinearregressioninterceptSeriesSonificationTracksActiveWhen ActiveWhen { get; set; }
		private LinearregressioninterceptSeriesSonificationTracksActiveWhen ActiveWhen_DefaultValue { get; set; }
		...
		/// </summary>
		public LinearregressioninterceptSeriesSonificationTracksMapping Mapping { get; set; }
		private LinearregressioninterceptSeriesSonificationTracksMapping Mapping_DefaultValue { get; set; }
		...
		/// </summary>
		public LinearregressioninterceptSeriesSonificationTracksPointGrouping PointGrouping { get; set; }
		private LinearregressioninterceptSeriesSonificationTracksPointGrouping PointGrouping_DefaultValue { get; set; }
		...
		/// </summary>
		public LinearregressioninterceptSeriesSonificationTracksType Type { get; set; }
		private LinearregressioninterceptSeriesSonificationTracksType Type_DefaultValue { get; set; }
