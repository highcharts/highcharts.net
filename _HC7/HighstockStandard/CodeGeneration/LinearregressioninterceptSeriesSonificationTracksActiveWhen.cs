...
{
	public partial class LinearregressioninterceptSeriesSonificationTracksActiveWhen  : BaseObject
	{
		Hashtable h = new Hashtable();

		public LinearregressioninterceptSeriesSonificationTracksActiveWhen()
		{
		}	
