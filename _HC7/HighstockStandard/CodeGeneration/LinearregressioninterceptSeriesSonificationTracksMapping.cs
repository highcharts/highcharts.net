...
{
	public partial class LinearregressioninterceptSeriesSonificationTracksMapping  : BaseObject
	{
		Hashtable h = new Hashtable();

		public LinearregressioninterceptSeriesSonificationTracksMapping()
		{
			Frequency = Frequency_DefaultValue = new LinearregressioninterceptSeriesSonificationTracksMappingFrequency();
			GapBetweenNotes = GapBetweenNotes_DefaultValue = new LinearregressioninterceptSeriesSonificationTracksMappingGapBetweenNotes();
			Highpass = Highpass_DefaultValue = new LinearregressioninterceptSeriesSonificationTracksMappingHighpass();
			Lowpass = Lowpass_DefaultValue = new LinearregressioninterceptSeriesSonificationTracksMappingLowpass();
			NoteDuration = NoteDuration_DefaultValue = new LinearregressioninterceptSeriesSonificationTracksMappingNoteDuration();
			Pan = Pan_DefaultValue = new LinearregressioninterceptSeriesSonificationTracksMappingPan();
			Pitch = Pitch_DefaultValue = new LinearregressioninterceptSeriesSonificationTracksMappingPitch();
			PitchString = PitchString_DefaultValue = "null";
			PitchNumber = PitchNumber_DefaultValue = null;
			PlayDelay = PlayDelay_DefaultValue = new LinearregressioninterceptSeriesSonificationTracksMappingPlayDelay();
			Time = Time_DefaultValue = new LinearregressioninterceptSeriesSonificationTracksMappingTime();
			TimeString = TimeString_DefaultValue = "null";
			TimeNumber = TimeNumber_DefaultValue = null;
			Tremolo = Tremolo_DefaultValue = new LinearregressioninterceptSeriesSonificationTracksMappingTremolo();
			Volume = Volume_DefaultValue = new LinearregressioninterceptSeriesSonificationTracksMappingVolume();
		...
		/// </summary>
		public LinearregressioninterceptSeriesSonificationTracksMappingFrequency Frequency { get; set; }
		private LinearregressioninterceptSeriesSonificationTracksMappingFrequency Frequency_DefaultValue { get; set; }
		...
		/// </summary>
		public LinearregressioninterceptSeriesSonificationTracksMappingGapBetweenNotes GapBetweenNotes { get; set; }
		private LinearregressioninterceptSeriesSonificationTracksMappingGapBetweenNotes GapBetweenNotes_DefaultValue { get; set; }
		...
		/// </summary>
		public LinearregressioninterceptSeriesSonificationTracksMappingHighpass Highpass { get; set; }
		private LinearregressioninterceptSeriesSonificationTracksMappingHighpass Highpass_DefaultValue { get; set; }
		...
		/// </summary>
		public LinearregressioninterceptSeriesSonificationTracksMappingLowpass Lowpass { get; set; }
		private LinearregressioninterceptSeriesSonificationTracksMappingLowpass Lowpass_DefaultValue { get; set; }
		...
		/// </summary>
		public LinearregressioninterceptSeriesSonificationTracksMappingNoteDuration NoteDuration { get; set; }
		private LinearregressioninterceptSeriesSonificationTracksMappingNoteDuration NoteDuration_DefaultValue { get; set; }
		...
		/// </summary>
		public LinearregressioninterceptSeriesSonificationTracksMappingPan Pan { get; set; }
		private LinearregressioninterceptSeriesSonificationTracksMappingPan Pan_DefaultValue { get; set; }
		...
		/// </summary>
		public LinearregressioninterceptSeriesSonificationTracksMappingPitch Pitch { get; set; }
		private LinearregressioninterceptSeriesSonificationTracksMappingPitch Pitch_DefaultValue { get; set; }
		...
		/// </summary>
		public LinearregressioninterceptSeriesSonificationTracksMappingPlayDelay PlayDelay { get; set; }
		private LinearregressioninterceptSeriesSonificationTracksMappingPlayDelay PlayDelay_DefaultValue { get; set; }
		...
		/// </summary>
		public LinearregressioninterceptSeriesSonificationTracksMappingTime Time { get; set; }
		private LinearregressioninterceptSeriesSonificationTracksMappingTime Time_DefaultValue { get; set; }
		...
		/// </summary>
		public LinearregressioninterceptSeriesSonificationTracksMappingTremolo Tremolo { get; set; }
		private LinearregressioninterceptSeriesSonificationTracksMappingTremolo Tremolo_DefaultValue { get; set; }
		 

		/// <summary>
		/// The volume of notes, from 0 to 1.
		/// </summary>
		public LinearregressioninterceptSeriesSonificationTracksMappingVolume Volume { get; set; }
		private LinearregressioninterceptSeriesSonificationTracksMappingVolume Volume_DefaultValue { get; set; }
