...
{
	public partial class LinearregressioninterceptSeriesSonificationTracksMappingTime  : BaseObject
	{
		Hashtable h = new Hashtable();

		public LinearregressioninterceptSeriesSonificationTracksMappingTime()
		{
			MapFunction = MapFunction_DefaultValue = LinearregressioninterceptSeriesSonificationTracksMappingTimeMapFunction.Linear;
			MapTo = MapTo_DefaultValue = "";
			Max = Max_DefaultValue = null;
			Min = Min_DefaultValue = null;
			Value = Value_DefaultValue = null;
			Within = Within_DefaultValue = LinearregressioninterceptSeriesSonificationTracksMappingTimeWithin.Chart;
		...
		/// </summary>
		public LinearregressioninterceptSeriesSonificationTracksMappingTimeMapFunction MapFunction { get; set; }
		private LinearregressioninterceptSeriesSonificationTracksMappingTimeMapFunction MapFunction_DefaultValue { get; set; }
		...
		/// </summary>
		public LinearregressioninterceptSeriesSonificationTracksMappingTimeWithin Within { get; set; }
		private LinearregressioninterceptSeriesSonificationTracksMappingTimeWithin Within_DefaultValue { get; set; }
