...
{
	public partial class LinearregressioninterceptSeriesStatesHover  : BaseObject
	{
		Hashtable h = new Hashtable();

		public LinearregressioninterceptSeriesStatesHover()
		{
			Animation = Animation_DefaultValue = new Animation() { Enabled = true };
			AnimationBool = AnimationBool_DefaultValue = null;
			Enabled = Enabled_DefaultValue = true;
			Halo = Halo_DefaultValue = new LinearregressioninterceptSeriesStatesHoverHalo();
			LineWidth = LineWidth_DefaultValue = null;
			LineWidthPlus = LineWidthPlus_DefaultValue = 1;
			Marker = Marker_DefaultValue = new LinearregressioninterceptSeriesStatesHoverMarker();
		...
		/// </summary>
		public LinearregressioninterceptSeriesStatesHoverHalo Halo { get; set; }
		private LinearregressioninterceptSeriesStatesHoverHalo Halo_DefaultValue { get; set; }
		...
		/// </summary>
		public LinearregressioninterceptSeriesStatesHoverMarker Marker { get; set; }
		private LinearregressioninterceptSeriesStatesHoverMarker Marker_DefaultValue { get; set; }
