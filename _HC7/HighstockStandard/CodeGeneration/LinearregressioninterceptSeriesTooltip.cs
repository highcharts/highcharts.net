...
{
	public partial class LinearregressioninterceptSeriesTooltip  : BaseObject
	{
		public LinearregressioninterceptSeriesTooltip()
		{
			...
			HeaderShape = HeaderShape_DefaultValue = LinearregressioninterceptSeriesTooltipHeaderShape.Callout;
		...
		/// </summary>
		public LinearregressioninterceptSeriesTooltipHeaderShape HeaderShape { get; set; }
		private LinearregressioninterceptSeriesTooltipHeaderShape HeaderShape_DefaultValue { get; set; }
		...
		internal override Hashtable ToHashtable()
		{
			...
			if (NullFormatter != NullFormatter_DefaultValue) { h.Add("nullFormatter",NullFormatter); Highstock.AddFunction("LinearregressioninterceptSeriesTooltipNullFormatter.nullFormatter", NullFormatter); }  
			if (Outside != Outside_DefaultValue) h.Add("outside",Outside);
			if (Padding != Padding_DefaultValue) h.Add("padding",Padding);
			if (PointFormat != PointFormat_DefaultValue) h.Add("pointFormat",PointFormat);
			if (PointFormatter != PointFormatter_DefaultValue) { h.Add("pointFormatter",PointFormatter); Highstock.AddFunction("LinearregressioninterceptSeriesTooltipPointFormatter.pointFormatter", PointFormatter); }  
