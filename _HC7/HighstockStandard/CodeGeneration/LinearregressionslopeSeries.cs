...
namespace Highsoft.Web.Mvc.Stocks
{
	public partial class LinearregressionslopeSeries  : Series
	{
		...
		public LinearregressionslopeSeries()
		{
			...
			Zones = Zones_DefaultValue = new List<LinearregressionslopeSeriesZone>();
		...
		/// </summary>
		public List<LinearregressionslopeSeriesZone> Zones { get; set; }
		private List<LinearregressionslopeSeriesZone> Zones_DefaultValue { get; set; }
