...
{
	public partial class LinearregressionslopeSeries  : Series
	{
		Hashtable h = new Hashtable();

		public LinearregressionslopeSeries()
		{
			Accessibility = Accessibility_DefaultValue = new LinearregressionslopeSeriesAccessibility();
			AllowPointSelect = AllowPointSelect_DefaultValue = false;
			Animation = Animation_DefaultValue = new Animation() { Enabled = true };
			AnimationBool = AnimationBool_DefaultValue = true;
			AnimationLimit = AnimationLimit_DefaultValue = null;
			BoostBlending = BoostBlending_DefaultValue = LinearregressionslopeSeriesBoostBlending.Undefined;
			...
			Compare = Compare_DefaultValue = LinearregressionslopeSeriesCompare.Percent;
			CompareBase = CompareBase_DefaultValue = LinearregressionslopeSeriesCompareBase.Min;
			...
			Cursor = Cursor_DefaultValue = LinearregressionslopeSeriesCursor.Null;
			Custom = Custom_DefaultValue = new Hashtable();
			DashStyle = DashStyle_DefaultValue = LinearregressionslopeSeriesDashStyle.Null;
			DataGrouping = DataGrouping_DefaultValue = new LinearregressionslopeSeriesDataGrouping();
			DataLabels = DataLabels_DefaultValue = new LinearregressionslopeSeriesDataLabels();
			DataSorting = DataSorting_DefaultValue = new LinearregressionslopeSeriesDataSorting();
			Description = Description_DefaultValue = "";
			Dumbell = Dumbell_DefaultValue = new LinearregressionslopeSeriesDumbell();
			EnableMouseTracking = EnableMouseTracking_DefaultValue = true;
			Events = Events_DefaultValue = new LinearregressionslopeSeriesEvents();
			FindNearestPointBy = FindNearestPointBy_DefaultValue = LinearregressionslopeSeriesFindNearestPointBy.X;
			GapSize = GapSize_DefaultValue = 0;
			GapUnit = GapUnit_DefaultValue = LinearregressionslopeSeriesGapUnit.Relative;
			GetExtremesFromAll = GetExtremesFromAll_DefaultValue = false;
			Id = Id_DefaultValue = "";
			InactiveOtherPoints = InactiveOtherPoints_DefaultValue = false;
			IncludeInDataExport = IncludeInDataExport_DefaultValue = null;
			Index = Index_DefaultValue = null;
			Label = Label_DefaultValue = new LinearregressionslopeSeriesLabel();
			LastPrice = LastPrice_DefaultValue = new LinearregressionslopeSeriesLastPrice();
			LastVisiblePrice = LastVisiblePrice_DefaultValue = new LinearregressionslopeSeriesLastVisiblePrice();
			LegendIndex = LegendIndex_DefaultValue = null;
			LegendSymbol = LegendSymbol_DefaultValue = LinearregressionslopeSeriesLegendSymbol.Rectangle;
			Linecap = Linecap_DefaultValue = LinearregressionslopeSeriesLinecap.Round;
			LineWidth = LineWidth_DefaultValue = 2;
			LinkedTo = LinkedTo_DefaultValue = "";
			Marker = Marker_DefaultValue = new LinearregressionslopeSeriesMarker();
			Name = Name_DefaultValue = "";
			NegativeColor = NegativeColor_DefaultValue = "";
			OnPoint = OnPoint_DefaultValue = new LinearregressionslopeSeriesOnPoint();
			Opacity = Opacity_DefaultValue = 1;
			Params = Params_DefaultValue = new LinearregressionslopeSeriesParams();
			Point = Point_DefaultValue = new LinearregressionslopeSeriesPoint();
			...
			Sonification = Sonification_DefaultValue = new LinearregressionslopeSeriesSonification();
			Stack = Stack_DefaultValue = "";
			StackNumber = StackNumber_DefaultValue = null;
			States = States_DefaultValue = new LinearregressionslopeSeriesStates();
			Step = Step_DefaultValue = LinearregressionslopeSeriesStep.Null;
			StickyTracking = StickyTracking_DefaultValue = true;
			Threshold = Threshold_DefaultValue = 0;
			Tooltip = Tooltip_DefaultValue = new LinearregressionslopeSeriesTooltip();
			...
			Zones = Zones_DefaultValue = new List<LinearregressionslopeSeriesZones>();
		...
		/// </summary>
		public LinearregressionslopeSeriesAccessibility Accessibility { get; set; }
		private LinearregressionslopeSeriesAccessibility Accessibility_DefaultValue { get; set; }
		...
		/// </summary>
		public LinearregressionslopeSeriesBoostBlending BoostBlending { get; set; }
		private LinearregressionslopeSeriesBoostBlending BoostBlending_DefaultValue { get; set; }
		...
		/// </summary>
		public LinearregressionslopeSeriesCompare Compare { get; set; }
		private LinearregressionslopeSeriesCompare Compare_DefaultValue { get; set; }
		 

		/// <summary>
		/// When [compare](#plotOptions.series.compare) is `percent`, this optiondictates whether to use 0 or 100 as the base of comparison.
		/// </summary>
		public LinearregressionslopeSeriesCompareBase CompareBase { get; set; }
		private LinearregressionslopeSeriesCompareBase CompareBase_DefaultValue { get; set; }
		...
		/// </summary>
		public LinearregressionslopeSeriesCursor Cursor { get; set; }
		private LinearregressionslopeSeriesCursor Cursor_DefaultValue { get; set; }
		...
		/// </summary>
		public LinearregressionslopeSeriesDashStyle DashStyle { get; set; }
		private LinearregressionslopeSeriesDashStyle DashStyle_DefaultValue { get; set; }
		...
		/// </summary>
		public LinearregressionslopeSeriesDataGrouping DataGrouping { get; set; }
		private LinearregressionslopeSeriesDataGrouping DataGrouping_DefaultValue { get; set; }
		...
		/// </summary>
		public LinearregressionslopeSeriesDataLabels DataLabels { get; set; }
		private LinearregressionslopeSeriesDataLabels DataLabels_DefaultValue { get; set; }
		 

		/// <summary>
		/// Options for the series data sorting.
		/// </summary>
		public LinearregressionslopeSeriesDataSorting DataSorting { get; set; }
		private LinearregressionslopeSeriesDataSorting DataSorting_DefaultValue { get; set; }
		...
		/// 
		/// </summary>
		public LinearregressionslopeSeriesDumbell Dumbell { get; set; }
		private LinearregressionslopeSeriesDumbell Dumbell_DefaultValue { get; set; }
		...
		/// </summary>
		public LinearregressionslopeSeriesEvents Events { get; set; }
		private LinearregressionslopeSeriesEvents Events_DefaultValue { get; set; }
		...
		/// </summary>
		public LinearregressionslopeSeriesFindNearestPointBy FindNearestPointBy { get; set; }
		private LinearregressionslopeSeriesFindNearestPointBy FindNearestPointBy_DefaultValue { get; set; }
		...
		/// </summary>
		public LinearregressionslopeSeriesGapUnit GapUnit { get; set; }
		private LinearregressionslopeSeriesGapUnit GapUnit_DefaultValue { get; set; }
		...
		/// </summary>
		public LinearregressionslopeSeriesLabel Label { get; set; }
		private LinearregressionslopeSeriesLabel Label_DefaultValue { get; set; }
		 

		/// <summary>
		/// The line marks the last price from all points.
		/// </summary>
		public LinearregressionslopeSeriesLastPrice LastPrice { get; set; }
		private LinearregressionslopeSeriesLastPrice LastPrice_DefaultValue { get; set; }
		 

		/// <summary>
		/// The line marks the last price from visible range of points.
		/// </summary>
		public LinearregressionslopeSeriesLastVisiblePrice LastVisiblePrice { get; set; }
		private LinearregressionslopeSeriesLastVisiblePrice LastVisiblePrice_DefaultValue { get; set; }
		...
		/// </summary>
		public LinearregressionslopeSeriesLegendSymbol LegendSymbol { get; set; }
		private LinearregressionslopeSeriesLegendSymbol LegendSymbol_DefaultValue { get; set; }
		 

		/// <summary>
		/// The line cap used for line ends and line joins on the graph.
		/// </summary>
		public LinearregressionslopeSeriesLinecap Linecap { get; set; }
		private LinearregressionslopeSeriesLinecap Linecap_DefaultValue { get; set; }
		...
		/// </summary>
		public LinearregressionslopeSeriesMarker Marker { get; set; }
		private LinearregressionslopeSeriesMarker Marker_DefaultValue { get; set; }
		...
		/// </summary>
		public LinearregressionslopeSeriesOnPoint OnPoint { get; set; }
		private LinearregressionslopeSeriesOnPoint OnPoint_DefaultValue { get; set; }
		...
		/// </summary>
		public LinearregressionslopeSeriesParams Params { get; set; }
		private LinearregressionslopeSeriesParams Params_DefaultValue { get; set; }
		 

		/// <summary>
		/// Properties for each single point.
		/// </summary>
		public LinearregressionslopeSeriesPoint Point { get; set; }
		private LinearregressionslopeSeriesPoint Point_DefaultValue { get; set; }
		...
		/// </summary>
		public LinearregressionslopeSeriesSonification Sonification { get; set; }
		private LinearregressionslopeSeriesSonification Sonification_DefaultValue { get; set; }
		...
		/// 
		/// </summary>
		public LinearregressionslopeSeriesStates States { get; set; }
		private LinearregressionslopeSeriesStates States_DefaultValue { get; set; }
		 

		/// <summary>
		/// Whether to apply steps to the line. Possible values are `left`,`center` and `right`.
		/// </summary>
		public LinearregressionslopeSeriesStep Step { get; set; }
		private LinearregressionslopeSeriesStep Step_DefaultValue { get; set; }
		...
		/// </summary>
		public LinearregressionslopeSeriesTooltip Tooltip { get; set; }
		private LinearregressionslopeSeriesTooltip Tooltip_DefaultValue { get; set; }
		...
		/// </summary>
		public List<LinearregressionslopeSeriesZones> Zones { get; set; }
		private List<LinearregressionslopeSeriesZones> Zones_DefaultValue { get; set; }
		...
		internal override Hashtable ToHashtable(Highstock highstock)
		{
			...
			h.Add("type","linearregressionslope");
