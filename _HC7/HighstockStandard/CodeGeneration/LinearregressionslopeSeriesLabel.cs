...
{
	public partial class LinearregressionslopeSeriesLabel  : BaseObject
	{
		public LinearregressionslopeSeriesLabel()
		{
			...
			Style = Style_DefaultValue = new LinearregressionslopeSeriesLabelStyle();
		...
		/// </summary>
		public LinearregressionslopeSeriesLabelStyle Style { get; set; }
		private LinearregressionslopeSeriesLabelStyle Style_DefaultValue { get; set; }
