...
{
	public partial class LinearregressionslopeSeriesSonificationContextTracks  : BaseObject
	{
		Hashtable h = new Hashtable();

		public LinearregressionslopeSeriesSonificationContextTracks()
		{
			ActiveWhen = ActiveWhen_DefaultValue = new LinearregressionslopeSeriesSonificationContextTracksActiveWhen();
			Instrument = Instrument_DefaultValue = null;
			InstrumentString = InstrumentString_DefaultValue = "null";
			Mapping = Mapping_DefaultValue = new LinearregressionslopeSeriesSonificationContextTracksMapping();
			MidiName = MidiName_DefaultValue = "";
			PointGrouping = PointGrouping_DefaultValue = new LinearregressionslopeSeriesSonificationContextTracksPointGrouping();
			...
			Type = Type_DefaultValue = LinearregressionslopeSeriesSonificationContextTracksType.Instrument;
			ValueInterval = ValueInterval_DefaultValue = null;
			ValueMapFunction = ValueMapFunction_DefaultValue = LinearregressionslopeSeriesSonificationContextTracksValueMapFunction.Linear;
		...
		/// </summary>
		public LinearregressionslopeSeriesSonificationContextTracksActiveWhen ActiveWhen { get; set; }
		private LinearregressionslopeSeriesSonificationContextTracksActiveWhen ActiveWhen_DefaultValue { get; set; }
		...
		/// </summary>
		public LinearregressionslopeSeriesSonificationContextTracksMapping Mapping { get; set; }
		private LinearregressionslopeSeriesSonificationContextTracksMapping Mapping_DefaultValue { get; set; }
		...
		/// </summary>
		public LinearregressionslopeSeriesSonificationContextTracksPointGrouping PointGrouping { get; set; }
		private LinearregressionslopeSeriesSonificationContextTracksPointGrouping PointGrouping_DefaultValue { get; set; }
		...
		/// </summary>
		public LinearregressionslopeSeriesSonificationContextTracksType Type { get; set; }
		private LinearregressionslopeSeriesSonificationContextTracksType Type_DefaultValue { get; set; }
		...
		/// </summary>
		public LinearregressionslopeSeriesSonificationContextTracksValueMapFunction ValueMapFunction { get; set; }
		private LinearregressionslopeSeriesSonificationContextTracksValueMapFunction ValueMapFunction_DefaultValue { get; set; }
