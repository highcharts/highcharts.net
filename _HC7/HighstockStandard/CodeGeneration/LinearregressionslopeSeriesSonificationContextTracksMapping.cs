...
{
	public partial class LinearregressionslopeSeriesSonificationContextTracksMapping  : BaseObject
	{
		Hashtable h = new Hashtable();

		public LinearregressionslopeSeriesSonificationContextTracksMapping()
		{
			Frequency = Frequency_DefaultValue = new LinearregressionslopeSeriesSonificationContextTracksMappingFrequency();
			GapBetweenNotes = GapBetweenNotes_DefaultValue = new LinearregressionslopeSeriesSonificationContextTracksMappingGapBetweenNotes();
			Highpass = Highpass_DefaultValue = new LinearregressionslopeSeriesSonificationContextTracksMappingHighpass();
			Lowpass = Lowpass_DefaultValue = new LinearregressionslopeSeriesSonificationContextTracksMappingLowpass();
			NoteDuration = NoteDuration_DefaultValue = new LinearregressionslopeSeriesSonificationContextTracksMappingNoteDuration();
			Pan = Pan_DefaultValue = new LinearregressionslopeSeriesSonificationContextTracksMappingPan();
			Pitch = Pitch_DefaultValue = new LinearregressionslopeSeriesSonificationContextTracksMappingPitch();
			PitchString = PitchString_DefaultValue = "null";
			PitchNumber = PitchNumber_DefaultValue = null;
			PlayDelay = PlayDelay_DefaultValue = new LinearregressionslopeSeriesSonificationContextTracksMappingPlayDelay();
			Time = Time_DefaultValue = new LinearregressionslopeSeriesSonificationContextTracksMappingTime();
			TimeString = TimeString_DefaultValue = "null";
			TimeNumber = TimeNumber_DefaultValue = null;
			Tremolo = Tremolo_DefaultValue = new LinearregressionslopeSeriesSonificationContextTracksMappingTremolo();
			Volume = Volume_DefaultValue = new LinearregressionslopeSeriesSonificationContextTracksMappingVolume();
		...
		/// </summary>
		public LinearregressionslopeSeriesSonificationContextTracksMappingFrequency Frequency { get; set; }
		private LinearregressionslopeSeriesSonificationContextTracksMappingFrequency Frequency_DefaultValue { get; set; }
		...
		/// </summary>
		public LinearregressionslopeSeriesSonificationContextTracksMappingGapBetweenNotes GapBetweenNotes { get; set; }
		private LinearregressionslopeSeriesSonificationContextTracksMappingGapBetweenNotes GapBetweenNotes_DefaultValue { get; set; }
		...
		/// </summary>
		public LinearregressionslopeSeriesSonificationContextTracksMappingHighpass Highpass { get; set; }
		private LinearregressionslopeSeriesSonificationContextTracksMappingHighpass Highpass_DefaultValue { get; set; }
		...
		/// </summary>
		public LinearregressionslopeSeriesSonificationContextTracksMappingLowpass Lowpass { get; set; }
		private LinearregressionslopeSeriesSonificationContextTracksMappingLowpass Lowpass_DefaultValue { get; set; }
		...
		/// </summary>
		public LinearregressionslopeSeriesSonificationContextTracksMappingNoteDuration NoteDuration { get; set; }
		private LinearregressionslopeSeriesSonificationContextTracksMappingNoteDuration NoteDuration_DefaultValue { get; set; }
		...
		/// </summary>
		public LinearregressionslopeSeriesSonificationContextTracksMappingPan Pan { get; set; }
		private LinearregressionslopeSeriesSonificationContextTracksMappingPan Pan_DefaultValue { get; set; }
		...
		/// </summary>
		public LinearregressionslopeSeriesSonificationContextTracksMappingPitch Pitch { get; set; }
		private LinearregressionslopeSeriesSonificationContextTracksMappingPitch Pitch_DefaultValue { get; set; }
		...
		/// </summary>
		public LinearregressionslopeSeriesSonificationContextTracksMappingPlayDelay PlayDelay { get; set; }
		private LinearregressionslopeSeriesSonificationContextTracksMappingPlayDelay PlayDelay_DefaultValue { get; set; }
		...
		/// </summary>
		public LinearregressionslopeSeriesSonificationContextTracksMappingTime Time { get; set; }
		private LinearregressionslopeSeriesSonificationContextTracksMappingTime Time_DefaultValue { get; set; }
		...
		/// </summary>
		public LinearregressionslopeSeriesSonificationContextTracksMappingTremolo Tremolo { get; set; }
		private LinearregressionslopeSeriesSonificationContextTracksMappingTremolo Tremolo_DefaultValue { get; set; }
		 

		/// <summary>
		/// The volume of notes, from 0 to 1.
		/// </summary>
		public LinearregressionslopeSeriesSonificationContextTracksMappingVolume Volume { get; set; }
		private LinearregressionslopeSeriesSonificationContextTracksMappingVolume Volume_DefaultValue { get; set; }
