...
{
	public partial class LinearregressionslopeSeriesSonificationContextTracksPointGrouping  : BaseObject
	{
		Hashtable h = new Hashtable();

		public LinearregressionslopeSeriesSonificationContextTracksPointGrouping()
		{
			Algorithm = Algorithm_DefaultValue = LinearregressionslopeSeriesSonificationContextTracksPointGroupingAlgorithm.Minimax;
		...
		/// </summary>
		public LinearregressionslopeSeriesSonificationContextTracksPointGroupingAlgorithm Algorithm { get; set; }
		private LinearregressionslopeSeriesSonificationContextTracksPointGroupingAlgorithm Algorithm_DefaultValue { get; set; }
