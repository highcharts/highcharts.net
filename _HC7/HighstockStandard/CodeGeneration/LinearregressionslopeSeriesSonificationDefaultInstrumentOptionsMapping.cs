...
{
	public partial class LinearregressionslopeSeriesSonificationDefaultInstrumentOptionsMapping  : BaseObject
	{
		Hashtable h = new Hashtable();

		public LinearregressionslopeSeriesSonificationDefaultInstrumentOptionsMapping()
		{
			Frequency = Frequency_DefaultValue = new LinearregressionslopeSeriesSonificationDefaultInstrumentOptionsMappingFrequency();
			GapBetweenNotes = GapBetweenNotes_DefaultValue = new LinearregressionslopeSeriesSonificationDefaultInstrumentOptionsMappingGapBetweenNotes();
			Highpass = Highpass_DefaultValue = new LinearregressionslopeSeriesSonificationDefaultInstrumentOptionsMappingHighpass();
			Lowpass = Lowpass_DefaultValue = new LinearregressionslopeSeriesSonificationDefaultInstrumentOptionsMappingLowpass();
			NoteDuration = NoteDuration_DefaultValue = new LinearregressionslopeSeriesSonificationDefaultInstrumentOptionsMappingNoteDuration();
			Pan = Pan_DefaultValue = new LinearregressionslopeSeriesSonificationDefaultInstrumentOptionsMappingPan();
			Pitch = Pitch_DefaultValue = new LinearregressionslopeSeriesSonificationDefaultInstrumentOptionsMappingPitch();
			PitchString = PitchString_DefaultValue = "null";
			PitchNumber = PitchNumber_DefaultValue = null;
			PlayDelay = PlayDelay_DefaultValue = new LinearregressionslopeSeriesSonificationDefaultInstrumentOptionsMappingPlayDelay();
			Time = Time_DefaultValue = new LinearregressionslopeSeriesSonificationDefaultInstrumentOptionsMappingTime();
			TimeString = TimeString_DefaultValue = "null";
			TimeNumber = TimeNumber_DefaultValue = null;
			Tremolo = Tremolo_DefaultValue = new LinearregressionslopeSeriesSonificationDefaultInstrumentOptionsMappingTremolo();
			Volume = Volume_DefaultValue = new LinearregressionslopeSeriesSonificationDefaultInstrumentOptionsMappingVolume();
		...
		/// </summary>
		public LinearregressionslopeSeriesSonificationDefaultInstrumentOptionsMappingFrequency Frequency { get; set; }
		private LinearregressionslopeSeriesSonificationDefaultInstrumentOptionsMappingFrequency Frequency_DefaultValue { get; set; }
		...
		/// </summary>
		public LinearregressionslopeSeriesSonificationDefaultInstrumentOptionsMappingGapBetweenNotes GapBetweenNotes { get; set; }
		private LinearregressionslopeSeriesSonificationDefaultInstrumentOptionsMappingGapBetweenNotes GapBetweenNotes_DefaultValue { get; set; }
		...
		/// </summary>
		public LinearregressionslopeSeriesSonificationDefaultInstrumentOptionsMappingHighpass Highpass { get; set; }
		private LinearregressionslopeSeriesSonificationDefaultInstrumentOptionsMappingHighpass Highpass_DefaultValue { get; set; }
		...
		/// </summary>
		public LinearregressionslopeSeriesSonificationDefaultInstrumentOptionsMappingLowpass Lowpass { get; set; }
		private LinearregressionslopeSeriesSonificationDefaultInstrumentOptionsMappingLowpass Lowpass_DefaultValue { get; set; }
		...
		/// </summary>
		public LinearregressionslopeSeriesSonificationDefaultInstrumentOptionsMappingNoteDuration NoteDuration { get; set; }
		private LinearregressionslopeSeriesSonificationDefaultInstrumentOptionsMappingNoteDuration NoteDuration_DefaultValue { get; set; }
		...
		/// </summary>
		public LinearregressionslopeSeriesSonificationDefaultInstrumentOptionsMappingPan Pan { get; set; }
		private LinearregressionslopeSeriesSonificationDefaultInstrumentOptionsMappingPan Pan_DefaultValue { get; set; }
		...
		/// </summary>
		public LinearregressionslopeSeriesSonificationDefaultInstrumentOptionsMappingPitch Pitch { get; set; }
		private LinearregressionslopeSeriesSonificationDefaultInstrumentOptionsMappingPitch Pitch_DefaultValue { get; set; }
		...
		/// </summary>
		public LinearregressionslopeSeriesSonificationDefaultInstrumentOptionsMappingPlayDelay PlayDelay { get; set; }
		private LinearregressionslopeSeriesSonificationDefaultInstrumentOptionsMappingPlayDelay PlayDelay_DefaultValue { get; set; }
		...
		/// </summary>
		public LinearregressionslopeSeriesSonificationDefaultInstrumentOptionsMappingTime Time { get; set; }
		private LinearregressionslopeSeriesSonificationDefaultInstrumentOptionsMappingTime Time_DefaultValue { get; set; }
		...
		/// </summary>
		public LinearregressionslopeSeriesSonificationDefaultInstrumentOptionsMappingTremolo Tremolo { get; set; }
		private LinearregressionslopeSeriesSonificationDefaultInstrumentOptionsMappingTremolo Tremolo_DefaultValue { get; set; }
		 

		/// <summary>
		/// The volume of notes, from 0 to 1.
		/// </summary>
		public LinearregressionslopeSeriesSonificationDefaultInstrumentOptionsMappingVolume Volume { get; set; }
		private LinearregressionslopeSeriesSonificationDefaultInstrumentOptionsMappingVolume Volume_DefaultValue { get; set; }
