...
{
	public partial class LinearregressionslopeSeriesSonificationDefaultSpeechOptionsMapping  : BaseObject
	{
		Hashtable h = new Hashtable();

		public LinearregressionslopeSeriesSonificationDefaultSpeechOptionsMapping()
		{
			Frequency = Frequency_DefaultValue = new LinearregressionslopeSeriesSonificationDefaultSpeechOptionsMappingFrequency();
			GapBetweenNotes = GapBetweenNotes_DefaultValue = new LinearregressionslopeSeriesSonificationDefaultSpeechOptionsMappingGapBetweenNotes();
			Highpass = Highpass_DefaultValue = new LinearregressionslopeSeriesSonificationDefaultSpeechOptionsMappingHighpass();
			Lowpass = Lowpass_DefaultValue = new LinearregressionslopeSeriesSonificationDefaultSpeechOptionsMappingLowpass();
			NoteDuration = NoteDuration_DefaultValue = new LinearregressionslopeSeriesSonificationDefaultSpeechOptionsMappingNoteDuration();
			Pan = Pan_DefaultValue = new LinearregressionslopeSeriesSonificationDefaultSpeechOptionsMappingPan();
			Pitch = Pitch_DefaultValue = new LinearregressionslopeSeriesSonificationDefaultSpeechOptionsMappingPitch();
			PitchString = PitchString_DefaultValue = "null";
			PitchNumber = PitchNumber_DefaultValue = null;
			PlayDelay = PlayDelay_DefaultValue = new LinearregressionslopeSeriesSonificationDefaultSpeechOptionsMappingPlayDelay();
			Time = Time_DefaultValue = new LinearregressionslopeSeriesSonificationDefaultSpeechOptionsMappingTime();
			TimeString = TimeString_DefaultValue = "null";
			TimeNumber = TimeNumber_DefaultValue = null;
			Tremolo = Tremolo_DefaultValue = new LinearregressionslopeSeriesSonificationDefaultSpeechOptionsMappingTremolo();
			Volume = Volume_DefaultValue = new LinearregressionslopeSeriesSonificationDefaultSpeechOptionsMappingVolume();
		...
		/// </summary>
		public LinearregressionslopeSeriesSonificationDefaultSpeechOptionsMappingFrequency Frequency { get; set; }
		private LinearregressionslopeSeriesSonificationDefaultSpeechOptionsMappingFrequency Frequency_DefaultValue { get; set; }
		...
		/// </summary>
		public LinearregressionslopeSeriesSonificationDefaultSpeechOptionsMappingGapBetweenNotes GapBetweenNotes { get; set; }
		private LinearregressionslopeSeriesSonificationDefaultSpeechOptionsMappingGapBetweenNotes GapBetweenNotes_DefaultValue { get; set; }
		...
		/// </summary>
		public LinearregressionslopeSeriesSonificationDefaultSpeechOptionsMappingHighpass Highpass { get; set; }
		private LinearregressionslopeSeriesSonificationDefaultSpeechOptionsMappingHighpass Highpass_DefaultValue { get; set; }
		...
		/// </summary>
		public LinearregressionslopeSeriesSonificationDefaultSpeechOptionsMappingLowpass Lowpass { get; set; }
		private LinearregressionslopeSeriesSonificationDefaultSpeechOptionsMappingLowpass Lowpass_DefaultValue { get; set; }
		...
		/// </summary>
		public LinearregressionslopeSeriesSonificationDefaultSpeechOptionsMappingNoteDuration NoteDuration { get; set; }
		private LinearregressionslopeSeriesSonificationDefaultSpeechOptionsMappingNoteDuration NoteDuration_DefaultValue { get; set; }
		...
		/// </summary>
		public LinearregressionslopeSeriesSonificationDefaultSpeechOptionsMappingPan Pan { get; set; }
		private LinearregressionslopeSeriesSonificationDefaultSpeechOptionsMappingPan Pan_DefaultValue { get; set; }
		...
		/// </summary>
		public LinearregressionslopeSeriesSonificationDefaultSpeechOptionsMappingPitch Pitch { get; set; }
		private LinearregressionslopeSeriesSonificationDefaultSpeechOptionsMappingPitch Pitch_DefaultValue { get; set; }
		...
		/// </summary>
		public LinearregressionslopeSeriesSonificationDefaultSpeechOptionsMappingPlayDelay PlayDelay { get; set; }
		private LinearregressionslopeSeriesSonificationDefaultSpeechOptionsMappingPlayDelay PlayDelay_DefaultValue { get; set; }
		...
		/// </summary>
		public LinearregressionslopeSeriesSonificationDefaultSpeechOptionsMappingTime Time { get; set; }
		private LinearregressionslopeSeriesSonificationDefaultSpeechOptionsMappingTime Time_DefaultValue { get; set; }
		...
		/// </summary>
		public LinearregressionslopeSeriesSonificationDefaultSpeechOptionsMappingTremolo Tremolo { get; set; }
		private LinearregressionslopeSeriesSonificationDefaultSpeechOptionsMappingTremolo Tremolo_DefaultValue { get; set; }
		 

		/// <summary>
		/// The volume of notes, from 0 to 1.
		/// </summary>
		public LinearregressionslopeSeriesSonificationDefaultSpeechOptionsMappingVolume Volume { get; set; }
		private LinearregressionslopeSeriesSonificationDefaultSpeechOptionsMappingVolume Volume_DefaultValue { get; set; }
