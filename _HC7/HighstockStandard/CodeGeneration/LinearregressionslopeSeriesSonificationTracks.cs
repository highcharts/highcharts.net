...
{
	public partial class LinearregressionslopeSeriesSonificationTracks  : BaseObject
	{
		Hashtable h = new Hashtable();

		public LinearregressionslopeSeriesSonificationTracks()
		{
			ActiveWhen = ActiveWhen_DefaultValue = new LinearregressionslopeSeriesSonificationTracksActiveWhen();
			Instrument = Instrument_DefaultValue = null;
			InstrumentString = InstrumentString_DefaultValue = "null";
			Mapping = Mapping_DefaultValue = new LinearregressionslopeSeriesSonificationTracksMapping();
			MidiName = MidiName_DefaultValue = "";
			PointGrouping = PointGrouping_DefaultValue = new LinearregressionslopeSeriesSonificationTracksPointGrouping();
			RoundToMusicalNotes = RoundToMusicalNotes_DefaultValue = true;
			ShowPlayMarker = ShowPlayMarker_DefaultValue = true;
			Type = Type_DefaultValue = LinearregressionslopeSeriesSonificationTracksType.Instrument;
		...
		/// </summary>
		public LinearregressionslopeSeriesSonificationTracksActiveWhen ActiveWhen { get; set; }
		private LinearregressionslopeSeriesSonificationTracksActiveWhen ActiveWhen_DefaultValue { get; set; }
		...
		/// </summary>
		public LinearregressionslopeSeriesSonificationTracksMapping Mapping { get; set; }
		private LinearregressionslopeSeriesSonificationTracksMapping Mapping_DefaultValue { get; set; }
		...
		/// </summary>
		public LinearregressionslopeSeriesSonificationTracksPointGrouping PointGrouping { get; set; }
		private LinearregressionslopeSeriesSonificationTracksPointGrouping PointGrouping_DefaultValue { get; set; }
		...
		/// </summary>
		public LinearregressionslopeSeriesSonificationTracksType Type { get; set; }
		private LinearregressionslopeSeriesSonificationTracksType Type_DefaultValue { get; set; }
