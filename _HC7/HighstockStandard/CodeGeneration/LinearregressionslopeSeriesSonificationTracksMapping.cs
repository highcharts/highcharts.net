...
{
	public partial class LinearregressionslopeSeriesSonificationTracksMapping  : BaseObject
	{
		Hashtable h = new Hashtable();

		public LinearregressionslopeSeriesSonificationTracksMapping()
		{
			Frequency = Frequency_DefaultValue = new LinearregressionslopeSeriesSonificationTracksMappingFrequency();
			GapBetweenNotes = GapBetweenNotes_DefaultValue = new LinearregressionslopeSeriesSonificationTracksMappingGapBetweenNotes();
			Highpass = Highpass_DefaultValue = new LinearregressionslopeSeriesSonificationTracksMappingHighpass();
			Lowpass = Lowpass_DefaultValue = new LinearregressionslopeSeriesSonificationTracksMappingLowpass();
			NoteDuration = NoteDuration_DefaultValue = new LinearregressionslopeSeriesSonificationTracksMappingNoteDuration();
			Pan = Pan_DefaultValue = new LinearregressionslopeSeriesSonificationTracksMappingPan();
			Pitch = Pitch_DefaultValue = new LinearregressionslopeSeriesSonificationTracksMappingPitch();
			PitchString = PitchString_DefaultValue = "null";
			PitchNumber = PitchNumber_DefaultValue = null;
			PlayDelay = PlayDelay_DefaultValue = new LinearregressionslopeSeriesSonificationTracksMappingPlayDelay();
			Time = Time_DefaultValue = new LinearregressionslopeSeriesSonificationTracksMappingTime();
			TimeString = TimeString_DefaultValue = "null";
			TimeNumber = TimeNumber_DefaultValue = null;
			Tremolo = Tremolo_DefaultValue = new LinearregressionslopeSeriesSonificationTracksMappingTremolo();
			Volume = Volume_DefaultValue = new LinearregressionslopeSeriesSonificationTracksMappingVolume();
		...
		/// </summary>
		public LinearregressionslopeSeriesSonificationTracksMappingFrequency Frequency { get; set; }
		private LinearregressionslopeSeriesSonificationTracksMappingFrequency Frequency_DefaultValue { get; set; }
		...
		/// </summary>
		public LinearregressionslopeSeriesSonificationTracksMappingGapBetweenNotes GapBetweenNotes { get; set; }
		private LinearregressionslopeSeriesSonificationTracksMappingGapBetweenNotes GapBetweenNotes_DefaultValue { get; set; }
		...
		/// </summary>
		public LinearregressionslopeSeriesSonificationTracksMappingHighpass Highpass { get; set; }
		private LinearregressionslopeSeriesSonificationTracksMappingHighpass Highpass_DefaultValue { get; set; }
		...
		/// </summary>
		public LinearregressionslopeSeriesSonificationTracksMappingLowpass Lowpass { get; set; }
		private LinearregressionslopeSeriesSonificationTracksMappingLowpass Lowpass_DefaultValue { get; set; }
		...
		/// </summary>
		public LinearregressionslopeSeriesSonificationTracksMappingNoteDuration NoteDuration { get; set; }
		private LinearregressionslopeSeriesSonificationTracksMappingNoteDuration NoteDuration_DefaultValue { get; set; }
		...
		/// </summary>
		public LinearregressionslopeSeriesSonificationTracksMappingPan Pan { get; set; }
		private LinearregressionslopeSeriesSonificationTracksMappingPan Pan_DefaultValue { get; set; }
		...
		/// </summary>
		public LinearregressionslopeSeriesSonificationTracksMappingPitch Pitch { get; set; }
		private LinearregressionslopeSeriesSonificationTracksMappingPitch Pitch_DefaultValue { get; set; }
		...
		/// </summary>
		public LinearregressionslopeSeriesSonificationTracksMappingPlayDelay PlayDelay { get; set; }
		private LinearregressionslopeSeriesSonificationTracksMappingPlayDelay PlayDelay_DefaultValue { get; set; }
		...
		/// </summary>
		public LinearregressionslopeSeriesSonificationTracksMappingTime Time { get; set; }
		private LinearregressionslopeSeriesSonificationTracksMappingTime Time_DefaultValue { get; set; }
		...
		/// </summary>
		public LinearregressionslopeSeriesSonificationTracksMappingTremolo Tremolo { get; set; }
		private LinearregressionslopeSeriesSonificationTracksMappingTremolo Tremolo_DefaultValue { get; set; }
		 

		/// <summary>
		/// The volume of notes, from 0 to 1.
		/// </summary>
		public LinearregressionslopeSeriesSonificationTracksMappingVolume Volume { get; set; }
		private LinearregressionslopeSeriesSonificationTracksMappingVolume Volume_DefaultValue { get; set; }
