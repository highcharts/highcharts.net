...
{
	public partial class LinearregressionslopeSeriesSonificationTracksMappingPitch  : BaseObject
	{
		Hashtable h = new Hashtable();

		public LinearregressionslopeSeriesSonificationTracksMappingPitch()
		{
			MapFunction = MapFunction_DefaultValue = LinearregressionslopeSeriesSonificationTracksMappingPitchMapFunction.Linear;
		...
		/// </summary>
		public LinearregressionslopeSeriesSonificationTracksMappingPitchMapFunction MapFunction { get; set; }
		private LinearregressionslopeSeriesSonificationTracksMappingPitchMapFunction MapFunction_DefaultValue { get; set; }
