...
{
	public partial class LinearregressionslopeSeriesSonificationTracksMappingPlayDelay  : BaseObject
	{
		Hashtable h = new Hashtable();

		public LinearregressionslopeSeriesSonificationTracksMappingPlayDelay()
		{
			MapFunction = MapFunction_DefaultValue = LinearregressionslopeSeriesSonificationTracksMappingPlayDelayMapFunction.Linear;
			MapTo = MapTo_DefaultValue = "";
			Max = Max_DefaultValue = null;
			Min = Min_DefaultValue = null;
			Value = Value_DefaultValue = null;
			Within = Within_DefaultValue = LinearregressionslopeSeriesSonificationTracksMappingPlayDelayWithin.Chart;
		...
		/// </summary>
		public LinearregressionslopeSeriesSonificationTracksMappingPlayDelayMapFunction MapFunction { get; set; }
		private LinearregressionslopeSeriesSonificationTracksMappingPlayDelayMapFunction MapFunction_DefaultValue { get; set; }
		...
		/// </summary>
		public LinearregressionslopeSeriesSonificationTracksMappingPlayDelayWithin Within { get; set; }
		private LinearregressionslopeSeriesSonificationTracksMappingPlayDelayWithin Within_DefaultValue { get; set; }
