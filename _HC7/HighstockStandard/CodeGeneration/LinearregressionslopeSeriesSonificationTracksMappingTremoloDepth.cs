...
{
	public partial class LinearregressionslopeSeriesSonificationTracksMappingTremoloDepth  : BaseObject
	{
		Hashtable h = new Hashtable();

		public LinearregressionslopeSeriesSonificationTracksMappingTremoloDepth()
		{
			MapFunction = MapFunction_DefaultValue = LinearregressionslopeSeriesSonificationTracksMappingTremoloDepthMapFunction.Linear;
			MapTo = MapTo_DefaultValue = "";
			Max = Max_DefaultValue = null;
			Min = Min_DefaultValue = null;
			Value = Value_DefaultValue = null;
			Within = Within_DefaultValue = LinearregressionslopeSeriesSonificationTracksMappingTremoloDepthWithin.Chart;
		...
		/// </summary>
		public LinearregressionslopeSeriesSonificationTracksMappingTremoloDepthMapFunction MapFunction { get; set; }
		private LinearregressionslopeSeriesSonificationTracksMappingTremoloDepthMapFunction MapFunction_DefaultValue { get; set; }
		...
		/// </summary>
		public LinearregressionslopeSeriesSonificationTracksMappingTremoloDepthWithin Within { get; set; }
		private LinearregressionslopeSeriesSonificationTracksMappingTremoloDepthWithin Within_DefaultValue { get; set; }
