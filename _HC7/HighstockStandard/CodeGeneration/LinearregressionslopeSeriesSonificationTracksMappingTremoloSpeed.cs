...
{
	public partial class LinearregressionslopeSeriesSonificationTracksMappingTremoloSpeed  : BaseObject
	{
		Hashtable h = new Hashtable();

		public LinearregressionslopeSeriesSonificationTracksMappingTremoloSpeed()
		{
			MapFunction = MapFunction_DefaultValue = LinearregressionslopeSeriesSonificationTracksMappingTremoloSpeedMapFunction.Linear;
			MapTo = MapTo_DefaultValue = "";
			Max = Max_DefaultValue = null;
			Min = Min_DefaultValue = null;
			Value = Value_DefaultValue = null;
			Within = Within_DefaultValue = LinearregressionslopeSeriesSonificationTracksMappingTremoloSpeedWithin.Chart;
		...
		/// </summary>
		public LinearregressionslopeSeriesSonificationTracksMappingTremoloSpeedMapFunction MapFunction { get; set; }
		private LinearregressionslopeSeriesSonificationTracksMappingTremoloSpeedMapFunction MapFunction_DefaultValue { get; set; }
		...
		/// </summary>
		public LinearregressionslopeSeriesSonificationTracksMappingTremoloSpeedWithin Within { get; set; }
		private LinearregressionslopeSeriesSonificationTracksMappingTremoloSpeedWithin Within_DefaultValue { get; set; }
