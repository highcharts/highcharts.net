...
{
	public partial class LinearregressionslopeSeriesStatesHoverMarker  : BaseObject
	{
		public LinearregressionslopeSeriesStatesHoverMarker()
		{
			...
			States = States_DefaultValue = new LinearregressionslopeSeriesStatesHoverMarkerStates();
		...
		/// </summary>
		public LinearregressionslopeSeriesStatesHoverMarkerStates States { get; set; }
		private LinearregressionslopeSeriesStatesHoverMarkerStates States_DefaultValue { get; set; }
