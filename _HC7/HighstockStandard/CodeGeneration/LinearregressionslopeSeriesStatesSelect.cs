...
{
	public partial class LinearregressionslopeSeriesStatesSelect  : BaseObject
	{
		Hashtable h = new Hashtable();

		public LinearregressionslopeSeriesStatesSelect()
		{
			Animation = Animation_DefaultValue = new Animation() { Enabled = true };
			AnimationBool = AnimationBool_DefaultValue = null;
			Enabled = Enabled_DefaultValue = true;
			Halo = Halo_DefaultValue = new LinearregressionslopeSeriesStatesSelectHalo();
			LineWidth = LineWidth_DefaultValue = null;
			LineWidthPlus = LineWidthPlus_DefaultValue = 1;
			Marker = Marker_DefaultValue = new LinearregressionslopeSeriesStatesSelectMarker();
		...
		/// </summary>
		public LinearregressionslopeSeriesStatesSelectHalo Halo { get; set; }
		private LinearregressionslopeSeriesStatesSelectHalo Halo_DefaultValue { get; set; }
		...
		/// </summary>
		public LinearregressionslopeSeriesStatesSelectMarker Marker { get; set; }
		private LinearregressionslopeSeriesStatesSelectMarker Marker_DefaultValue { get; set; }
