...
{
	public partial class LinearregressionslopeSeriesTooltip  : BaseObject
	{
		public LinearregressionslopeSeriesTooltip()
		{
			...
			HeaderShape = HeaderShape_DefaultValue = LinearregressionslopeSeriesTooltipHeaderShape.Callout;
		...
		/// </summary>
		public LinearregressionslopeSeriesTooltipHeaderShape HeaderShape { get; set; }
		private LinearregressionslopeSeriesTooltipHeaderShape HeaderShape_DefaultValue { get; set; }
		...
		internal override Hashtable ToHashtable()
		{
			...
			if (NullFormatter != NullFormatter_DefaultValue) { h.Add("nullFormatter",NullFormatter); Highstock.AddFunction("LinearregressionslopeSeriesTooltipNullFormatter.nullFormatter", NullFormatter); }  
			if (Outside != Outside_DefaultValue) h.Add("outside",Outside);
			if (Padding != Padding_DefaultValue) h.Add("padding",Padding);
			if (PointFormat != PointFormat_DefaultValue) h.Add("pointFormat",PointFormat);
			if (PointFormatter != PointFormatter_DefaultValue) { h.Add("pointFormatter",PointFormatter); Highstock.AddFunction("LinearregressionslopeSeriesTooltipPointFormatter.pointFormatter", PointFormatter); }  
