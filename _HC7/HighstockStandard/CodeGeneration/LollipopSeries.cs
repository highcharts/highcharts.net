...
namespace Highsoft.Web.Mvc.Stocks
{
	public partial class LollipopSeries  : Series
	{
		...
		public LollipopSeries()
		{
			...
			Zones = Zones_DefaultValue = new List<LollipopSeriesZone>();
		...
		/// </summary>
		public List<LollipopSeriesZone> Zones { get; set; }
		private List<LollipopSeriesZone> Zones_DefaultValue { get; set; }
