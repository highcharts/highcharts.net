...
{
	public partial class LollipopSeries  : Series
	{
		Hashtable h = new Hashtable();

		public LollipopSeries()
		{
			...
			Compare = Compare_DefaultValue = LollipopSeriesCompare.Percent;
			CompareBase = CompareBase_DefaultValue = LollipopSeriesCompareBase.Min;
			...
			Cursor = Cursor_DefaultValue = LollipopSeriesCursor.Null;
			Custom = Custom_DefaultValue = new Hashtable();
			DashStyle = DashStyle_DefaultValue = LollipopSeriesDashStyle.Null;
			Data = Data_DefaultValue = new List<LollipopSeriesData>();
			DataGrouping = DataGrouping_DefaultValue = new LollipopSeriesDataGrouping();
			DataLabels = DataLabels_DefaultValue = new LollipopSeriesDataLabels();
			DataSorting = DataSorting_DefaultValue = new LollipopSeriesDataSorting();
			Description = Description_DefaultValue = "";
			DragDrop = DragDrop_DefaultValue = new LollipopSeriesDragDrop();
			Dumbell = Dumbell_DefaultValue = new LollipopSeriesDumbell();
			...
			Label = Label_DefaultValue = new LollipopSeriesLabel();
			LastPrice = LastPrice_DefaultValue = new LollipopSeriesLastPrice();
			LastVisiblePrice = LastVisiblePrice_DefaultValue = new LollipopSeriesLastVisiblePrice();
			LegendIndex = LegendIndex_DefaultValue = null;
			LegendSymbol = LegendSymbol_DefaultValue = LollipopSeriesLegendSymbol.Rectangle;
			Linecap = Linecap_DefaultValue = LollipopSeriesLinecap.Round;
			LineColor = LineColor_DefaultValue = "";
			LinkedTo = LinkedTo_DefaultValue = "";
			LowMarker = LowMarker_DefaultValue = new LollipopSeriesLowMarker();
			...
			OnPoint = OnPoint_DefaultValue = new LollipopSeriesOnPoint();
			Opacity = Opacity_DefaultValue = 1;
			Point = Point_DefaultValue = new LollipopSeriesPoint();
			PointDescriptionFormat = PointDescriptionFormat_DefaultValue = "";
			PointDescriptionFormatter = PointDescriptionFormatter_DefaultValue = "";
			PointInterval = PointInterval_DefaultValue = 1;
			PointIntervalUnit = PointIntervalUnit_DefaultValue = LollipopSeriesPointIntervalUnit.Null;
			...
			Sonification = Sonification_DefaultValue = new LollipopSeriesSonification();
			...
			Zones = Zones_DefaultValue = new List<LollipopSeriesZones>();
		...
		/// </summary>
		public LollipopSeriesAccessibility Accessibility { get; set; }
		private LollipopSeriesAccessibility Accessibility_DefaultValue { get; set; }
		...
		/// </summary>
		public LollipopSeriesCompare Compare { get; set; }
		private LollipopSeriesCompare Compare_DefaultValue { get; set; }
		 

		/// <summary>
		/// When [compare](#plotOptions.series.compare) is `percent`, this optiondictates whether to use 0 or 100 as the base of comparison.
		/// </summary>
		public LollipopSeriesCompareBase CompareBase { get; set; }
		private LollipopSeriesCompareBase CompareBase_DefaultValue { get; set; }
		...
		/// </summary>
		public LollipopSeriesCursor Cursor { get; set; }
		private LollipopSeriesCursor Cursor_DefaultValue { get; set; }
		...
		/// </summary>
		public LollipopSeriesDataGrouping DataGrouping { get; set; }
		private LollipopSeriesDataGrouping DataGrouping_DefaultValue { get; set; }
		...
		/// </summary>
		public LollipopSeriesDataLabels DataLabels { get; set; }
		private LollipopSeriesDataLabels DataLabels_DefaultValue { get; set; }
		 

		/// <summary>
		/// Options for the series data sorting.
		/// </summary>
		public LollipopSeriesDataSorting DataSorting { get; set; }
		private LollipopSeriesDataSorting DataSorting_DefaultValue { get; set; }
		...
		/// </summary>
		public LollipopSeriesDragDrop DragDrop { get; set; }
		private LollipopSeriesDragDrop DragDrop_DefaultValue { get; set; }
		 

		/// <summary>
		/// 
		/// </summary>
		public LollipopSeriesDumbell Dumbell { get; set; }
		private LollipopSeriesDumbell Dumbell_DefaultValue { get; set; }
		...
		/// </summary>
		public LollipopSeriesEvents Events { get; set; }
		private LollipopSeriesEvents Events_DefaultValue { get; set; }
		...
		private LollipopSeriesFindNearestPointBy FindNearestPointBy_DefaultValue { get; set; }
		...
		/// </summary>
		public LollipopSeriesGapUnit GapUnit { get; set; }
		private LollipopSeriesGapUnit GapUnit_DefaultValue { get; set; }
		...
		/// </summary>
		public LollipopSeriesLabel Label { get; set; }
		private LollipopSeriesLabel Label_DefaultValue { get; set; }
		 

		/// <summary>
		/// The line marks the last price from all points.
		/// </summary>
		public LollipopSeriesLastPrice LastPrice { get; set; }
		private LollipopSeriesLastPrice LastPrice_DefaultValue { get; set; }
		 

		/// <summary>
		/// The line marks the last price from visible range of points.
		/// </summary>
		public LollipopSeriesLastVisiblePrice LastVisiblePrice { get; set; }
		private LollipopSeriesLastVisiblePrice LastVisiblePrice_DefaultValue { get; set; }
		...
		/// </summary>
		public LollipopSeriesLegendSymbol LegendSymbol { get; set; }
		private LollipopSeriesLegendSymbol LegendSymbol_DefaultValue { get; set; }
		 

		/// <summary>
		/// The line cap used for line ends and line joins on the graph.
		/// </summary>
		public LollipopSeriesLinecap Linecap { get; set; }
		private LollipopSeriesLinecap Linecap_DefaultValue { get; set; }
		...
		/// </summary>
		public LollipopSeriesLowMarker LowMarker { get; set; }
		private LollipopSeriesLowMarker LowMarker_DefaultValue { get; set; }
		...
		/// </summary>
		public LollipopSeriesMarker Marker { get; set; }
		private LollipopSeriesMarker Marker_DefaultValue { get; set; }
		...
		/// </summary>
		public LollipopSeriesPoint Point { get; set; }
		private LollipopSeriesPoint Point_DefaultValue { get; set; }
		...
		/// </summary>
		public LollipopSeriesPointIntervalUnit PointIntervalUnit { get; set; }
		private LollipopSeriesPointIntervalUnit PointIntervalUnit_DefaultValue { get; set; }
		...
		/// </summary>
		public LollipopSeriesSonification Sonification { get; set; }
		private LollipopSeriesSonification Sonification_DefaultValue { get; set; }
		...
		private LollipopSeriesStates States_DefaultValue { get; set; }
		...
		/// </summary>
		public LollipopSeriesTooltip Tooltip { get; set; }
		private LollipopSeriesTooltip Tooltip_DefaultValue { get; set; }
		...
		/// </summary>
		public List<LollipopSeriesZones> Zones { get; set; }
		private List<LollipopSeriesZones> Zones_DefaultValue { get; set; }
