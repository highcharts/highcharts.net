...
{
	public partial class LollipopSeriesLastPriceLabel  : BaseObject
	{
		Hashtable h = new Hashtable();

		public LollipopSeriesLastPriceLabel()
		{
			Align = Align_DefaultValue = LollipopSeriesLastPriceLabelAlign.Null;
		...
		/// 
		/// </summary>
		public LollipopSeriesLastPriceLabelAlign Align { get; set; }
		private LollipopSeriesLastPriceLabelAlign Align_DefaultValue { get; set; }
