...
{
	public partial class LollipopSeriesLowMarker  : BaseObject
	{
		Hashtable h = new Hashtable();

		public LollipopSeriesLowMarker()
		{
			...
			States = States_DefaultValue = new LollipopSeriesLowMarkerStates();
		...
		/// </summary>
		public LollipopSeriesLowMarkerStates States { get; set; }
		private LollipopSeriesLowMarkerStates States_DefaultValue { get; set; }
