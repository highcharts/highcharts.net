...
{
	public partial class LollipopSeriesSonificationContextTracks  : BaseObject
	{
		Hashtable h = new Hashtable();

		public LollipopSeriesSonificationContextTracks()
		{
			ActiveWhen = ActiveWhen_DefaultValue = new LollipopSeriesSonificationContextTracksActiveWhen();
			Instrument = Instrument_DefaultValue = null;
			InstrumentString = InstrumentString_DefaultValue = "null";
			Mapping = Mapping_DefaultValue = new LollipopSeriesSonificationContextTracksMapping();
			MidiName = MidiName_DefaultValue = "";
			PointGrouping = PointGrouping_DefaultValue = new LollipopSeriesSonificationContextTracksPointGrouping();
			...
			Type = Type_DefaultValue = LollipopSeriesSonificationContextTracksType.Instrument;
			ValueInterval = ValueInterval_DefaultValue = null;
			ValueMapFunction = ValueMapFunction_DefaultValue = LollipopSeriesSonificationContextTracksValueMapFunction.Linear;
		...
		/// </summary>
		public LollipopSeriesSonificationContextTracksActiveWhen ActiveWhen { get; set; }
		private LollipopSeriesSonificationContextTracksActiveWhen ActiveWhen_DefaultValue { get; set; }
		...
		/// </summary>
		public LollipopSeriesSonificationContextTracksMapping Mapping { get; set; }
		private LollipopSeriesSonificationContextTracksMapping Mapping_DefaultValue { get; set; }
		...
		/// </summary>
		public LollipopSeriesSonificationContextTracksPointGrouping PointGrouping { get; set; }
		private LollipopSeriesSonificationContextTracksPointGrouping PointGrouping_DefaultValue { get; set; }
		...
		/// </summary>
		public LollipopSeriesSonificationContextTracksType Type { get; set; }
		private LollipopSeriesSonificationContextTracksType Type_DefaultValue { get; set; }
		...
		/// </summary>
		public LollipopSeriesSonificationContextTracksValueMapFunction ValueMapFunction { get; set; }
		private LollipopSeriesSonificationContextTracksValueMapFunction ValueMapFunction_DefaultValue { get; set; }
