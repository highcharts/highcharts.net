...
{
	public partial class LollipopSeriesSonificationTracks  : BaseObject
	{
		Hashtable h = new Hashtable();

		public LollipopSeriesSonificationTracks()
		{
			ActiveWhen = ActiveWhen_DefaultValue = new LollipopSeriesSonificationTracksActiveWhen();
			Instrument = Instrument_DefaultValue = null;
			InstrumentString = InstrumentString_DefaultValue = "null";
			Mapping = Mapping_DefaultValue = new LollipopSeriesSonificationTracksMapping();
			MidiName = MidiName_DefaultValue = "";
			PointGrouping = PointGrouping_DefaultValue = new LollipopSeriesSonificationTracksPointGrouping();
			RoundToMusicalNotes = RoundToMusicalNotes_DefaultValue = true;
			ShowPlayMarker = ShowPlayMarker_DefaultValue = true;
			Type = Type_DefaultValue = LollipopSeriesSonificationTracksType.Instrument;
		...
		/// </summary>
		public LollipopSeriesSonificationTracksActiveWhen ActiveWhen { get; set; }
		private LollipopSeriesSonificationTracksActiveWhen ActiveWhen_DefaultValue { get; set; }
		...
		/// </summary>
		public LollipopSeriesSonificationTracksMapping Mapping { get; set; }
		private LollipopSeriesSonificationTracksMapping Mapping_DefaultValue { get; set; }
		...
		/// </summary>
		public LollipopSeriesSonificationTracksPointGrouping PointGrouping { get; set; }
		private LollipopSeriesSonificationTracksPointGrouping PointGrouping_DefaultValue { get; set; }
		...
		/// </summary>
		public LollipopSeriesSonificationTracksType Type { get; set; }
		private LollipopSeriesSonificationTracksType Type_DefaultValue { get; set; }
