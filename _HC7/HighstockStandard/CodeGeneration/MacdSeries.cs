...
{
	public partial class MacdSeries  : Series
	{
		Hashtable h = new Hashtable();

		public MacdSeries()
		{
			Accessibility = Accessibility_DefaultValue = new MacdSeriesAccessibility();
			AllowPointSelect = AllowPointSelect_DefaultValue = false;
			Animation = Animation_DefaultValue = new Animation() { Enabled = true };
			AnimationBool = AnimationBool_DefaultValue = true;
			AnimationLimit = AnimationLimit_DefaultValue = null;
			BoostBlending = BoostBlending_DefaultValue = MacdSeriesBoostBlending.Undefined;
			...
			Compare = Compare_DefaultValue = MacdSeriesCompare.Percent;
			CompareBase = CompareBase_DefaultValue = MacdSeriesCompareBase.Min;
			...
			Cursor = Cursor_DefaultValue = MacdSeriesCursor.Null;
			Custom = Custom_DefaultValue = new Hashtable();
			DashStyle = DashStyle_DefaultValue = MacdSeriesDashStyle.Null;
			DataGrouping = DataGrouping_DefaultValue = new MacdSeriesDataGrouping();
			DataLabels = DataLabels_DefaultValue = new MacdSeriesDataLabels();
			DataSorting = DataSorting_DefaultValue = new MacdSeriesDataSorting();
			Description = Description_DefaultValue = "";
			Dumbell = Dumbell_DefaultValue = new MacdSeriesDumbell();
			EnableMouseTracking = EnableMouseTracking_DefaultValue = true;
			Events = Events_DefaultValue = new MacdSeriesEvents();
			FindNearestPointBy = FindNearestPointBy_DefaultValue = MacdSeriesFindNearestPointBy.X;
			GapSize = GapSize_DefaultValue = 0;
			GapUnit = GapUnit_DefaultValue = MacdSeriesGapUnit.Relative;
			...
			LastPrice = LastPrice_DefaultValue = new MacdSeriesLastPrice();
			LastVisiblePrice = LastVisiblePrice_DefaultValue = new MacdSeriesLastVisiblePrice();
			...
			OnPoint = OnPoint_DefaultValue = new MacdSeriesOnPoint();
			Opacity = Opacity_DefaultValue = 1;
			Params = Params_DefaultValue = new MacdSeriesParams();
			Point = Point_DefaultValue = new MacdSeriesPoint();
			...
			SignalLine = SignalLine_DefaultValue = new MacdSeriesSignalLine();
			SkipKeyboardNavigation = SkipKeyboardNavigation_DefaultValue = null;
			SoftThreshold = SoftThreshold_DefaultValue = true;
			Sonification = Sonification_DefaultValue = new MacdSeriesSonification();
			Stack = Stack_DefaultValue = "";
			StackNumber = StackNumber_DefaultValue = null;
			States = States_DefaultValue = new MacdSeriesStates();
			Step = Step_DefaultValue = MacdSeriesStep.Null;
			StickyTracking = StickyTracking_DefaultValue = true;
			Threshold = Threshold_DefaultValue = 0;
			Tooltip = Tooltip_DefaultValue = new MacdSeriesTooltip();
			...
			Zones = Zones_DefaultValue = new List<MacdSeriesZones>();
		...
		/// </summary>
		public MacdSeriesAccessibility Accessibility { get; set; }
		private MacdSeriesAccessibility Accessibility_DefaultValue { get; set; }
		...
		/// </summary>
		public MacdSeriesBoostBlending BoostBlending { get; set; }
		private MacdSeriesBoostBlending BoostBlending_DefaultValue { get; set; }
		...
		/// </summary>
		public MacdSeriesCompare Compare { get; set; }
		private MacdSeriesCompare Compare_DefaultValue { get; set; }
		 

		/// <summary>
		/// When [compare](#plotOptions.series.compare) is `percent`, this optiondictates whether to use 0 or 100 as the base of comparison.
		/// </summary>
		public MacdSeriesCompareBase CompareBase { get; set; }
		private MacdSeriesCompareBase CompareBase_DefaultValue { get; set; }
		...
		/// </summary>
		public MacdSeriesCursor Cursor { get; set; }
		private MacdSeriesCursor Cursor_DefaultValue { get; set; }
		...
		/// </summary>
		public MacdSeriesDashStyle DashStyle { get; set; }
		private MacdSeriesDashStyle DashStyle_DefaultValue { get; set; }
		...
		/// </summary>
		public MacdSeriesDataGrouping DataGrouping { get; set; }
		private MacdSeriesDataGrouping DataGrouping_DefaultValue { get; set; }
		...
		/// </summary>
		public MacdSeriesDataLabels DataLabels { get; set; }
		private MacdSeriesDataLabels DataLabels_DefaultValue { get; set; }
		 

		/// <summary>
		/// Options for the series data sorting.
		/// </summary>
		public MacdSeriesDataSorting DataSorting { get; set; }
		private MacdSeriesDataSorting DataSorting_DefaultValue { get; set; }
		...
		/// 
		/// </summary>
		public MacdSeriesDumbell Dumbell { get; set; }
		private MacdSeriesDumbell Dumbell_DefaultValue { get; set; }
		...
		/// </summary>
		public MacdSeriesEvents Events { get; set; }
		private MacdSeriesEvents Events_DefaultValue { get; set; }
		...
		/// </summary>
		public MacdSeriesFindNearestPointBy FindNearestPointBy { get; set; }
		private MacdSeriesFindNearestPointBy FindNearestPointBy_DefaultValue { get; set; }
		...
		/// </summary>
		public MacdSeriesGapUnit GapUnit { get; set; }
		private MacdSeriesGapUnit GapUnit_DefaultValue { get; set; }
		...
		/// </summary>
		public MacdSeriesLabel Label { get; set; }
		private MacdSeriesLabel Label_DefaultValue { get; set; }
		 

		/// <summary>
		/// The line marks the last price from all points.
		/// </summary>
		public MacdSeriesLastPrice LastPrice { get; set; }
		private MacdSeriesLastPrice LastPrice_DefaultValue { get; set; }
		 

		/// <summary>
		/// The line marks the last price from visible range of points.
		/// </summary>
		public MacdSeriesLastVisiblePrice LastVisiblePrice { get; set; }
		private MacdSeriesLastVisiblePrice LastVisiblePrice_DefaultValue { get; set; }
		...
		/// </summary>
		public MacdSeriesLinecap Linecap { get; set; }
		private MacdSeriesLinecap Linecap_DefaultValue { get; set; }
		...
		/// </summary>
		public MacdSeriesMacdLine MacdLine { get; set; }
		private MacdSeriesMacdLine MacdLine_DefaultValue { get; set; }
		...
		/// </summary>
		public MacdSeriesMarker Marker { get; set; }
		private MacdSeriesMarker Marker_DefaultValue { get; set; }
		...
		/// </summary>
		public MacdSeriesOnPoint OnPoint { get; set; }
		private MacdSeriesOnPoint OnPoint_DefaultValue { get; set; }
		...
		/// </summary>
		public MacdSeriesParams Params { get; set; }
		private MacdSeriesParams Params_DefaultValue { get; set; }
		 

		/// <summary>
		/// Properties for each single point.
		/// </summary>
		public MacdSeriesPoint Point { get; set; }
		private MacdSeriesPoint Point_DefaultValue { get; set; }
		...
		/// </summary>
		public MacdSeriesSignalLine SignalLine { get; set; }
		private MacdSeriesSignalLine SignalLine_DefaultValue { get; set; }
		...
		/// </summary>
		public MacdSeriesSonification Sonification { get; set; }
		private MacdSeriesSonification Sonification_DefaultValue { get; set; }
		...
		/// 
		/// </summary>
		public MacdSeriesStates States { get; set; }
		private MacdSeriesStates States_DefaultValue { get; set; }
		 

		/// <summary>
		/// Whether to apply steps to the line. Possible values are `left`,`center` and `right`.
		/// </summary>
		public MacdSeriesStep Step { get; set; }
		private MacdSeriesStep Step_DefaultValue { get; set; }
		...
		/// </summary>
		public MacdSeriesTooltip Tooltip { get; set; }
		private MacdSeriesTooltip Tooltip_DefaultValue { get; set; }
		...
		/// </summary>
		public List<MacdSeriesZones> Zones { get; set; }
		private List<MacdSeriesZones> Zones_DefaultValue { get; set; }
		...
		internal override Hashtable ToHashtable(Highstock highstock)
		{
			...
			if (MacdLine.IsDirty(highstock)) h.Add("macdLine",MacdLine.ToHashtable(highstock));
