...
namespace Highsoft.Web.Mvc.Stocks
{
	public partial class MacdSeries  : Series
	{
		public MacdSeries()
		{
			...
			DragDrop = DragDrop_DefaultValue = new MacdSeriesDragDrop();
		...
		/// </summary>
		public MacdSeriesDragDrop DragDrop { get; set; }
		private MacdSeriesDragDrop DragDrop_DefaultValue { get; set; }
