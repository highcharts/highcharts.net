...
namespace Highsoft.Web.Mvc.Stocks
{
	public partial class MacdSeriesAccessibility  : BaseObject
	{
		...
		public MacdSeriesAccessibility()
		{
			...
			Point = Point_DefaultValue = new MacdSeriesAccessibilityPoint();
		...
		/// </summary>
		public MacdSeriesAccessibilityPoint Point { get; set; }
		private MacdSeriesAccessibilityPoint Point_DefaultValue { get; set; }
