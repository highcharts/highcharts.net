...
{
	public partial class MacdSeriesDragDrop  : BaseObject
	{
		public MacdSeriesDragDrop()
		{
			DraggableX = DraggableX_DefaultValue = null;
			DraggableY = DraggableY_DefaultValue = null;
			DragHandle = DragHandle_DefaultValue = new MacdSeriesDragDropDragHandle();
			...
			GuideBox = GuideBox_DefaultValue = new MacdSeriesDragDropGuideBox();
		...
		/// </summary>
		public MacdSeriesDragDropDragHandle DragHandle { get; set; }
		private MacdSeriesDragDropDragHandle DragHandle_DefaultValue { get; set; }
		...
		/// </summary>
		public MacdSeriesDragDropGuideBox GuideBox { get; set; }
		private MacdSeriesDragDropGuideBox GuideBox_DefaultValue { get; set; }
