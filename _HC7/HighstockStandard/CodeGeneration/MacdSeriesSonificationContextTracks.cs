...
{
	public partial class MacdSeriesSonificationContextTracks  : BaseObject
	{
		Hashtable h = new Hashtable();

		public MacdSeriesSonificationContextTracks()
		{
			ActiveWhen = ActiveWhen_DefaultValue = new MacdSeriesSonificationContextTracksActiveWhen();
			Instrument = Instrument_DefaultValue = null;
			InstrumentString = InstrumentString_DefaultValue = "null";
			Mapping = Mapping_DefaultValue = new MacdSeriesSonificationContextTracksMapping();
			MidiName = MidiName_DefaultValue = "";
			PointGrouping = PointGrouping_DefaultValue = new MacdSeriesSonificationContextTracksPointGrouping();
			...
			Type = Type_DefaultValue = MacdSeriesSonificationContextTracksType.Instrument;
			ValueInterval = ValueInterval_DefaultValue = null;
			ValueMapFunction = ValueMapFunction_DefaultValue = MacdSeriesSonificationContextTracksValueMapFunction.Linear;
		...
		/// </summary>
		public MacdSeriesSonificationContextTracksActiveWhen ActiveWhen { get; set; }
		private MacdSeriesSonificationContextTracksActiveWhen ActiveWhen_DefaultValue { get; set; }
		...
		/// </summary>
		public MacdSeriesSonificationContextTracksMapping Mapping { get; set; }
		private MacdSeriesSonificationContextTracksMapping Mapping_DefaultValue { get; set; }
		...
		/// </summary>
		public MacdSeriesSonificationContextTracksPointGrouping PointGrouping { get; set; }
		private MacdSeriesSonificationContextTracksPointGrouping PointGrouping_DefaultValue { get; set; }
		...
		/// </summary>
		public MacdSeriesSonificationContextTracksType Type { get; set; }
		private MacdSeriesSonificationContextTracksType Type_DefaultValue { get; set; }
		...
		/// </summary>
		public MacdSeriesSonificationContextTracksValueMapFunction ValueMapFunction { get; set; }
		private MacdSeriesSonificationContextTracksValueMapFunction ValueMapFunction_DefaultValue { get; set; }
