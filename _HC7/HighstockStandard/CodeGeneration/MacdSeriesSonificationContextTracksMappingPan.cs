...
{
	public partial class MacdSeriesSonificationContextTracksMappingPan  : BaseObject
	{
		Hashtable h = new Hashtable();

		public MacdSeriesSonificationContextTracksMappingPan()
		{
			MapFunction = MapFunction_DefaultValue = MacdSeriesSonificationContextTracksMappingPanMapFunction.Linear;
			MapTo = MapTo_DefaultValue = "";
			Max = Max_DefaultValue = null;
			Min = Min_DefaultValue = null;
			Value = Value_DefaultValue = null;
			Within = Within_DefaultValue = MacdSeriesSonificationContextTracksMappingPanWithin.Chart;
		...
		/// </summary>
		public MacdSeriesSonificationContextTracksMappingPanMapFunction MapFunction { get; set; }
		private MacdSeriesSonificationContextTracksMappingPanMapFunction MapFunction_DefaultValue { get; set; }
		...
		/// </summary>
		public MacdSeriesSonificationContextTracksMappingPanWithin Within { get; set; }
		private MacdSeriesSonificationContextTracksMappingPanWithin Within_DefaultValue { get; set; }
