...
{
	public partial class MacdSeriesSonificationContextTracksMappingTime  : BaseObject
	{
		Hashtable h = new Hashtable();

		public MacdSeriesSonificationContextTracksMappingTime()
		{
			MapFunction = MapFunction_DefaultValue = MacdSeriesSonificationContextTracksMappingTimeMapFunction.Linear;
			MapTo = MapTo_DefaultValue = "";
			Max = Max_DefaultValue = null;
			Min = Min_DefaultValue = null;
			Value = Value_DefaultValue = null;
			Within = Within_DefaultValue = MacdSeriesSonificationContextTracksMappingTimeWithin.Chart;
		...
		/// </summary>
		public MacdSeriesSonificationContextTracksMappingTimeMapFunction MapFunction { get; set; }
		private MacdSeriesSonificationContextTracksMappingTimeMapFunction MapFunction_DefaultValue { get; set; }
		...
		/// </summary>
		public MacdSeriesSonificationContextTracksMappingTimeWithin Within { get; set; }
		private MacdSeriesSonificationContextTracksMappingTimeWithin Within_DefaultValue { get; set; }
