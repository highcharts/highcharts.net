...
{
	public partial class MacdSeriesSonificationContextTracksMappingVolume  : BaseObject
	{
		Hashtable h = new Hashtable();

		public MacdSeriesSonificationContextTracksMappingVolume()
		{
			MapFunction = MapFunction_DefaultValue = MacdSeriesSonificationContextTracksMappingVolumeMapFunction.Linear;
			MapTo = MapTo_DefaultValue = "";
			Max = Max_DefaultValue = null;
			Min = Min_DefaultValue = null;
			Value = Value_DefaultValue = null;
			Within = Within_DefaultValue = MacdSeriesSonificationContextTracksMappingVolumeWithin.Chart;
		...
		/// </summary>
		public MacdSeriesSonificationContextTracksMappingVolumeMapFunction MapFunction { get; set; }
		private MacdSeriesSonificationContextTracksMappingVolumeMapFunction MapFunction_DefaultValue { get; set; }
		...
		/// </summary>
		public MacdSeriesSonificationContextTracksMappingVolumeWithin Within { get; set; }
		private MacdSeriesSonificationContextTracksMappingVolumeWithin Within_DefaultValue { get; set; }
