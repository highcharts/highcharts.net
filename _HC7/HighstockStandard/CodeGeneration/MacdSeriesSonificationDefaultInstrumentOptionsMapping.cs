...
{
	public partial class MacdSeriesSonificationDefaultInstrumentOptionsMapping  : BaseObject
	{
		Hashtable h = new Hashtable();

		public MacdSeriesSonificationDefaultInstrumentOptionsMapping()
		{
			Frequency = Frequency_DefaultValue = new MacdSeriesSonificationDefaultInstrumentOptionsMappingFrequency();
			GapBetweenNotes = GapBetweenNotes_DefaultValue = new MacdSeriesSonificationDefaultInstrumentOptionsMappingGapBetweenNotes();
			Highpass = Highpass_DefaultValue = new MacdSeriesSonificationDefaultInstrumentOptionsMappingHighpass();
			Lowpass = Lowpass_DefaultValue = new MacdSeriesSonificationDefaultInstrumentOptionsMappingLowpass();
			NoteDuration = NoteDuration_DefaultValue = new MacdSeriesSonificationDefaultInstrumentOptionsMappingNoteDuration();
			Pan = Pan_DefaultValue = new MacdSeriesSonificationDefaultInstrumentOptionsMappingPan();
			Pitch = Pitch_DefaultValue = new MacdSeriesSonificationDefaultInstrumentOptionsMappingPitch();
			PitchString = PitchString_DefaultValue = "null";
			PitchNumber = PitchNumber_DefaultValue = null;
			PlayDelay = PlayDelay_DefaultValue = new MacdSeriesSonificationDefaultInstrumentOptionsMappingPlayDelay();
			Time = Time_DefaultValue = new MacdSeriesSonificationDefaultInstrumentOptionsMappingTime();
			TimeString = TimeString_DefaultValue = "null";
			TimeNumber = TimeNumber_DefaultValue = null;
			Tremolo = Tremolo_DefaultValue = new MacdSeriesSonificationDefaultInstrumentOptionsMappingTremolo();
			Volume = Volume_DefaultValue = new MacdSeriesSonificationDefaultInstrumentOptionsMappingVolume();
		...
		/// </summary>
		public MacdSeriesSonificationDefaultInstrumentOptionsMappingFrequency Frequency { get; set; }
		private MacdSeriesSonificationDefaultInstrumentOptionsMappingFrequency Frequency_DefaultValue { get; set; }
		...
		/// </summary>
		public MacdSeriesSonificationDefaultInstrumentOptionsMappingGapBetweenNotes GapBetweenNotes { get; set; }
		private MacdSeriesSonificationDefaultInstrumentOptionsMappingGapBetweenNotes GapBetweenNotes_DefaultValue { get; set; }
		...
		/// </summary>
		public MacdSeriesSonificationDefaultInstrumentOptionsMappingHighpass Highpass { get; set; }
		private MacdSeriesSonificationDefaultInstrumentOptionsMappingHighpass Highpass_DefaultValue { get; set; }
		...
		/// </summary>
		public MacdSeriesSonificationDefaultInstrumentOptionsMappingLowpass Lowpass { get; set; }
		private MacdSeriesSonificationDefaultInstrumentOptionsMappingLowpass Lowpass_DefaultValue { get; set; }
		...
		/// </summary>
		public MacdSeriesSonificationDefaultInstrumentOptionsMappingNoteDuration NoteDuration { get; set; }
		private MacdSeriesSonificationDefaultInstrumentOptionsMappingNoteDuration NoteDuration_DefaultValue { get; set; }
		...
		/// </summary>
		public MacdSeriesSonificationDefaultInstrumentOptionsMappingPan Pan { get; set; }
		private MacdSeriesSonificationDefaultInstrumentOptionsMappingPan Pan_DefaultValue { get; set; }
		...
		/// </summary>
		public MacdSeriesSonificationDefaultInstrumentOptionsMappingPitch Pitch { get; set; }
		private MacdSeriesSonificationDefaultInstrumentOptionsMappingPitch Pitch_DefaultValue { get; set; }
		...
		/// </summary>
		public MacdSeriesSonificationDefaultInstrumentOptionsMappingPlayDelay PlayDelay { get; set; }
		private MacdSeriesSonificationDefaultInstrumentOptionsMappingPlayDelay PlayDelay_DefaultValue { get; set; }
		...
		/// </summary>
		public MacdSeriesSonificationDefaultInstrumentOptionsMappingTime Time { get; set; }
		private MacdSeriesSonificationDefaultInstrumentOptionsMappingTime Time_DefaultValue { get; set; }
		...
		/// </summary>
		public MacdSeriesSonificationDefaultInstrumentOptionsMappingTremolo Tremolo { get; set; }
		private MacdSeriesSonificationDefaultInstrumentOptionsMappingTremolo Tremolo_DefaultValue { get; set; }
		 

		/// <summary>
		/// The volume of notes, from 0 to 1.
		/// </summary>
		public MacdSeriesSonificationDefaultInstrumentOptionsMappingVolume Volume { get; set; }
		private MacdSeriesSonificationDefaultInstrumentOptionsMappingVolume Volume_DefaultValue { get; set; }
