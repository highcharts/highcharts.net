...
{
	public partial class MacdSeriesSonificationDefaultInstrumentOptionsMappingHighpassFrequency  : BaseObject
	{
		Hashtable h = new Hashtable();

		public MacdSeriesSonificationDefaultInstrumentOptionsMappingHighpassFrequency()
		{
			MapFunction = MapFunction_DefaultValue = MacdSeriesSonificationDefaultInstrumentOptionsMappingHighpassFrequencyMapFunction.Linear;
			MapTo = MapTo_DefaultValue = "";
			Max = Max_DefaultValue = null;
			Min = Min_DefaultValue = null;
			Value = Value_DefaultValue = null;
			Within = Within_DefaultValue = MacdSeriesSonificationDefaultInstrumentOptionsMappingHighpassFrequencyWithin.Chart;
		...
		/// </summary>
		public MacdSeriesSonificationDefaultInstrumentOptionsMappingHighpassFrequencyMapFunction MapFunction { get; set; }
		private MacdSeriesSonificationDefaultInstrumentOptionsMappingHighpassFrequencyMapFunction MapFunction_DefaultValue { get; set; }
		...
		/// </summary>
		public MacdSeriesSonificationDefaultInstrumentOptionsMappingHighpassFrequencyWithin Within { get; set; }
		private MacdSeriesSonificationDefaultInstrumentOptionsMappingHighpassFrequencyWithin Within_DefaultValue { get; set; }
