...
{
	public partial class MacdSeriesSonificationDefaultSpeechOptionsMapping  : BaseObject
	{
		Hashtable h = new Hashtable();

		public MacdSeriesSonificationDefaultSpeechOptionsMapping()
		{
			Frequency = Frequency_DefaultValue = new MacdSeriesSonificationDefaultSpeechOptionsMappingFrequency();
			GapBetweenNotes = GapBetweenNotes_DefaultValue = new MacdSeriesSonificationDefaultSpeechOptionsMappingGapBetweenNotes();
			Highpass = Highpass_DefaultValue = new MacdSeriesSonificationDefaultSpeechOptionsMappingHighpass();
			Lowpass = Lowpass_DefaultValue = new MacdSeriesSonificationDefaultSpeechOptionsMappingLowpass();
			NoteDuration = NoteDuration_DefaultValue = new MacdSeriesSonificationDefaultSpeechOptionsMappingNoteDuration();
			Pan = Pan_DefaultValue = new MacdSeriesSonificationDefaultSpeechOptionsMappingPan();
			Pitch = Pitch_DefaultValue = new MacdSeriesSonificationDefaultSpeechOptionsMappingPitch();
			PitchString = PitchString_DefaultValue = "null";
			PitchNumber = PitchNumber_DefaultValue = null;
			PlayDelay = PlayDelay_DefaultValue = new MacdSeriesSonificationDefaultSpeechOptionsMappingPlayDelay();
			Time = Time_DefaultValue = new MacdSeriesSonificationDefaultSpeechOptionsMappingTime();
			TimeString = TimeString_DefaultValue = "null";
			TimeNumber = TimeNumber_DefaultValue = null;
			Tremolo = Tremolo_DefaultValue = new MacdSeriesSonificationDefaultSpeechOptionsMappingTremolo();
			Volume = Volume_DefaultValue = new MacdSeriesSonificationDefaultSpeechOptionsMappingVolume();
		...
		/// </summary>
		public MacdSeriesSonificationDefaultSpeechOptionsMappingFrequency Frequency { get; set; }
		private MacdSeriesSonificationDefaultSpeechOptionsMappingFrequency Frequency_DefaultValue { get; set; }
		...
		/// </summary>
		public MacdSeriesSonificationDefaultSpeechOptionsMappingGapBetweenNotes GapBetweenNotes { get; set; }
		private MacdSeriesSonificationDefaultSpeechOptionsMappingGapBetweenNotes GapBetweenNotes_DefaultValue { get; set; }
		...
		/// </summary>
		public MacdSeriesSonificationDefaultSpeechOptionsMappingHighpass Highpass { get; set; }
		private MacdSeriesSonificationDefaultSpeechOptionsMappingHighpass Highpass_DefaultValue { get; set; }
		...
		/// </summary>
		public MacdSeriesSonificationDefaultSpeechOptionsMappingLowpass Lowpass { get; set; }
		private MacdSeriesSonificationDefaultSpeechOptionsMappingLowpass Lowpass_DefaultValue { get; set; }
		...
		/// </summary>
		public MacdSeriesSonificationDefaultSpeechOptionsMappingNoteDuration NoteDuration { get; set; }
		private MacdSeriesSonificationDefaultSpeechOptionsMappingNoteDuration NoteDuration_DefaultValue { get; set; }
		...
		/// </summary>
		public MacdSeriesSonificationDefaultSpeechOptionsMappingPan Pan { get; set; }
		private MacdSeriesSonificationDefaultSpeechOptionsMappingPan Pan_DefaultValue { get; set; }
		...
		/// </summary>
		public MacdSeriesSonificationDefaultSpeechOptionsMappingPitch Pitch { get; set; }
		private MacdSeriesSonificationDefaultSpeechOptionsMappingPitch Pitch_DefaultValue { get; set; }
		...
		/// </summary>
		public MacdSeriesSonificationDefaultSpeechOptionsMappingPlayDelay PlayDelay { get; set; }
		private MacdSeriesSonificationDefaultSpeechOptionsMappingPlayDelay PlayDelay_DefaultValue { get; set; }
		...
		/// </summary>
		public MacdSeriesSonificationDefaultSpeechOptionsMappingTime Time { get; set; }
		private MacdSeriesSonificationDefaultSpeechOptionsMappingTime Time_DefaultValue { get; set; }
		...
		/// </summary>
		public MacdSeriesSonificationDefaultSpeechOptionsMappingTremolo Tremolo { get; set; }
		private MacdSeriesSonificationDefaultSpeechOptionsMappingTremolo Tremolo_DefaultValue { get; set; }
		 

		/// <summary>
		/// The volume of notes, from 0 to 1.
		/// </summary>
		public MacdSeriesSonificationDefaultSpeechOptionsMappingVolume Volume { get; set; }
		private MacdSeriesSonificationDefaultSpeechOptionsMappingVolume Volume_DefaultValue { get; set; }
