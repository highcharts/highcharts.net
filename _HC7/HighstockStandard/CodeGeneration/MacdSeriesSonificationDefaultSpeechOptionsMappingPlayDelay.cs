...
{
	public partial class MacdSeriesSonificationDefaultSpeechOptionsMappingPlayDelay  : BaseObject
	{
		Hashtable h = new Hashtable();

		public MacdSeriesSonificationDefaultSpeechOptionsMappingPlayDelay()
		{
			MapFunction = MapFunction_DefaultValue = MacdSeriesSonificationDefaultSpeechOptionsMappingPlayDelayMapFunction.Linear;
			MapTo = MapTo_DefaultValue = "";
			Max = Max_DefaultValue = null;
			Min = Min_DefaultValue = null;
			Value = Value_DefaultValue = null;
			Within = Within_DefaultValue = MacdSeriesSonificationDefaultSpeechOptionsMappingPlayDelayWithin.Chart;
		...
		/// </summary>
		public MacdSeriesSonificationDefaultSpeechOptionsMappingPlayDelayMapFunction MapFunction { get; set; }
		private MacdSeriesSonificationDefaultSpeechOptionsMappingPlayDelayMapFunction MapFunction_DefaultValue { get; set; }
		...
		/// </summary>
		public MacdSeriesSonificationDefaultSpeechOptionsMappingPlayDelayWithin Within { get; set; }
		private MacdSeriesSonificationDefaultSpeechOptionsMappingPlayDelayWithin Within_DefaultValue { get; set; }
