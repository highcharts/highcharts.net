...
{
	public partial class MacdSeriesSonificationTracks  : BaseObject
	{
		Hashtable h = new Hashtable();

		public MacdSeriesSonificationTracks()
		{
			ActiveWhen = ActiveWhen_DefaultValue = new MacdSeriesSonificationTracksActiveWhen();
			Instrument = Instrument_DefaultValue = null;
			InstrumentString = InstrumentString_DefaultValue = "null";
			Mapping = Mapping_DefaultValue = new MacdSeriesSonificationTracksMapping();
			MidiName = MidiName_DefaultValue = "";
			PointGrouping = PointGrouping_DefaultValue = new MacdSeriesSonificationTracksPointGrouping();
			RoundToMusicalNotes = RoundToMusicalNotes_DefaultValue = true;
			ShowPlayMarker = ShowPlayMarker_DefaultValue = true;
			Type = Type_DefaultValue = MacdSeriesSonificationTracksType.Instrument;
		...
		/// </summary>
		public MacdSeriesSonificationTracksActiveWhen ActiveWhen { get; set; }
		private MacdSeriesSonificationTracksActiveWhen ActiveWhen_DefaultValue { get; set; }
		...
		/// </summary>
		public MacdSeriesSonificationTracksMapping Mapping { get; set; }
		private MacdSeriesSonificationTracksMapping Mapping_DefaultValue { get; set; }
		...
		/// </summary>
		public MacdSeriesSonificationTracksPointGrouping PointGrouping { get; set; }
		private MacdSeriesSonificationTracksPointGrouping PointGrouping_DefaultValue { get; set; }
		...
		/// </summary>
		public MacdSeriesSonificationTracksType Type { get; set; }
		private MacdSeriesSonificationTracksType Type_DefaultValue { get; set; }
