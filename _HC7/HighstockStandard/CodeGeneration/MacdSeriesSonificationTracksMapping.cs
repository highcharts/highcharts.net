...
{
	public partial class MacdSeriesSonificationTracksMapping  : BaseObject
	{
		Hashtable h = new Hashtable();

		public MacdSeriesSonificationTracksMapping()
		{
			Frequency = Frequency_DefaultValue = new MacdSeriesSonificationTracksMappingFrequency();
			GapBetweenNotes = GapBetweenNotes_DefaultValue = new MacdSeriesSonificationTracksMappingGapBetweenNotes();
			Highpass = Highpass_DefaultValue = new MacdSeriesSonificationTracksMappingHighpass();
			Lowpass = Lowpass_DefaultValue = new MacdSeriesSonificationTracksMappingLowpass();
			NoteDuration = NoteDuration_DefaultValue = new MacdSeriesSonificationTracksMappingNoteDuration();
			Pan = Pan_DefaultValue = new MacdSeriesSonificationTracksMappingPan();
			Pitch = Pitch_DefaultValue = new MacdSeriesSonificationTracksMappingPitch();
			PitchString = PitchString_DefaultValue = "null";
			PitchNumber = PitchNumber_DefaultValue = null;
			PlayDelay = PlayDelay_DefaultValue = new MacdSeriesSonificationTracksMappingPlayDelay();
			Time = Time_DefaultValue = new MacdSeriesSonificationTracksMappingTime();
			TimeString = TimeString_DefaultValue = "null";
			TimeNumber = TimeNumber_DefaultValue = null;
			Tremolo = Tremolo_DefaultValue = new MacdSeriesSonificationTracksMappingTremolo();
			Volume = Volume_DefaultValue = new MacdSeriesSonificationTracksMappingVolume();
		...
		/// </summary>
		public MacdSeriesSonificationTracksMappingFrequency Frequency { get; set; }
		private MacdSeriesSonificationTracksMappingFrequency Frequency_DefaultValue { get; set; }
		...
		/// </summary>
		public MacdSeriesSonificationTracksMappingGapBetweenNotes GapBetweenNotes { get; set; }
		private MacdSeriesSonificationTracksMappingGapBetweenNotes GapBetweenNotes_DefaultValue { get; set; }
		...
		/// </summary>
		public MacdSeriesSonificationTracksMappingHighpass Highpass { get; set; }
		private MacdSeriesSonificationTracksMappingHighpass Highpass_DefaultValue { get; set; }
		...
		/// </summary>
		public MacdSeriesSonificationTracksMappingLowpass Lowpass { get; set; }
		private MacdSeriesSonificationTracksMappingLowpass Lowpass_DefaultValue { get; set; }
		...
		/// </summary>
		public MacdSeriesSonificationTracksMappingNoteDuration NoteDuration { get; set; }
		private MacdSeriesSonificationTracksMappingNoteDuration NoteDuration_DefaultValue { get; set; }
		...
		/// </summary>
		public MacdSeriesSonificationTracksMappingPan Pan { get; set; }
		private MacdSeriesSonificationTracksMappingPan Pan_DefaultValue { get; set; }
		...
		/// </summary>
		public MacdSeriesSonificationTracksMappingPitch Pitch { get; set; }
		private MacdSeriesSonificationTracksMappingPitch Pitch_DefaultValue { get; set; }
		...
		/// </summary>
		public MacdSeriesSonificationTracksMappingPlayDelay PlayDelay { get; set; }
		private MacdSeriesSonificationTracksMappingPlayDelay PlayDelay_DefaultValue { get; set; }
		...
		/// </summary>
		public MacdSeriesSonificationTracksMappingTime Time { get; set; }
		private MacdSeriesSonificationTracksMappingTime Time_DefaultValue { get; set; }
		...
		/// </summary>
		public MacdSeriesSonificationTracksMappingTremolo Tremolo { get; set; }
		private MacdSeriesSonificationTracksMappingTremolo Tremolo_DefaultValue { get; set; }
		 

		/// <summary>
		/// The volume of notes, from 0 to 1.
		/// </summary>
		public MacdSeriesSonificationTracksMappingVolume Volume { get; set; }
		private MacdSeriesSonificationTracksMappingVolume Volume_DefaultValue { get; set; }
