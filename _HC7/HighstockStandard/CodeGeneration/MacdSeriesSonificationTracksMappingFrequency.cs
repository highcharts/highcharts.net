...
{
	public partial class MacdSeriesSonificationTracksMappingFrequency  : BaseObject
	{
		Hashtable h = new Hashtable();

		public MacdSeriesSonificationTracksMappingFrequency()
		{
			MapFunction = MapFunction_DefaultValue = MacdSeriesSonificationTracksMappingFrequencyMapFunction.Linear;
			MapTo = MapTo_DefaultValue = "";
			Max = Max_DefaultValue = null;
			Min = Min_DefaultValue = null;
			Value = Value_DefaultValue = null;
			Within = Within_DefaultValue = MacdSeriesSonificationTracksMappingFrequencyWithin.Chart;
		...
		/// </summary>
		public MacdSeriesSonificationTracksMappingFrequencyMapFunction MapFunction { get; set; }
		private MacdSeriesSonificationTracksMappingFrequencyMapFunction MapFunction_DefaultValue { get; set; }
		...
		/// </summary>
		public MacdSeriesSonificationTracksMappingFrequencyWithin Within { get; set; }
		private MacdSeriesSonificationTracksMappingFrequencyWithin Within_DefaultValue { get; set; }
