...
{
	public partial class MacdSeriesSonificationTracksMappingLowpassResonance  : BaseObject
	{
		Hashtable h = new Hashtable();

		public MacdSeriesSonificationTracksMappingLowpassResonance()
		{
			MapFunction = MapFunction_DefaultValue = MacdSeriesSonificationTracksMappingLowpassResonanceMapFunction.Linear;
			MapTo = MapTo_DefaultValue = "";
			Max = Max_DefaultValue = null;
			Min = Min_DefaultValue = null;
			Value = Value_DefaultValue = null;
			Within = Within_DefaultValue = MacdSeriesSonificationTracksMappingLowpassResonanceWithin.Chart;
		...
		/// </summary>
		public MacdSeriesSonificationTracksMappingLowpassResonanceMapFunction MapFunction { get; set; }
		private MacdSeriesSonificationTracksMappingLowpassResonanceMapFunction MapFunction_DefaultValue { get; set; }
		...
		/// </summary>
		public MacdSeriesSonificationTracksMappingLowpassResonanceWithin Within { get; set; }
		private MacdSeriesSonificationTracksMappingLowpassResonanceWithin Within_DefaultValue { get; set; }
