...
{
	public partial class MacdSeriesSonificationTracksMappingNoteDuration  : BaseObject
	{
		Hashtable h = new Hashtable();

		public MacdSeriesSonificationTracksMappingNoteDuration()
		{
			MapFunction = MapFunction_DefaultValue = MacdSeriesSonificationTracksMappingNoteDurationMapFunction.Linear;
			MapTo = MapTo_DefaultValue = "";
			Max = Max_DefaultValue = null;
			Min = Min_DefaultValue = null;
			Value = Value_DefaultValue = null;
			Within = Within_DefaultValue = MacdSeriesSonificationTracksMappingNoteDurationWithin.Chart;
		...
		/// </summary>
		public MacdSeriesSonificationTracksMappingNoteDurationMapFunction MapFunction { get; set; }
		private MacdSeriesSonificationTracksMappingNoteDurationMapFunction MapFunction_DefaultValue { get; set; }
		...
		/// </summary>
		public MacdSeriesSonificationTracksMappingNoteDurationWithin Within { get; set; }
		private MacdSeriesSonificationTracksMappingNoteDurationWithin Within_DefaultValue { get; set; }
