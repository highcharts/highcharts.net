...
{
	public partial class MacdSeriesSonificationTracksMappingPan  : BaseObject
	{
		Hashtable h = new Hashtable();

		public MacdSeriesSonificationTracksMappingPan()
		{
			MapFunction = MapFunction_DefaultValue = MacdSeriesSonificationTracksMappingPanMapFunction.Linear;
			MapTo = MapTo_DefaultValue = "";
			Max = Max_DefaultValue = null;
			Min = Min_DefaultValue = null;
			Value = Value_DefaultValue = null;
			Within = Within_DefaultValue = MacdSeriesSonificationTracksMappingPanWithin.Chart;
		...
		/// </summary>
		public MacdSeriesSonificationTracksMappingPanMapFunction MapFunction { get; set; }
		private MacdSeriesSonificationTracksMappingPanMapFunction MapFunction_DefaultValue { get; set; }
		...
		/// </summary>
		public MacdSeriesSonificationTracksMappingPanWithin Within { get; set; }
		private MacdSeriesSonificationTracksMappingPanWithin Within_DefaultValue { get; set; }
