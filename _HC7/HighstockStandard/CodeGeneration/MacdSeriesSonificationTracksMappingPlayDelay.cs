...
{
	public partial class MacdSeriesSonificationTracksMappingPlayDelay  : BaseObject
	{
		Hashtable h = new Hashtable();

		public MacdSeriesSonificationTracksMappingPlayDelay()
		{
			MapFunction = MapFunction_DefaultValue = MacdSeriesSonificationTracksMappingPlayDelayMapFunction.Linear;
			MapTo = MapTo_DefaultValue = "";
			Max = Max_DefaultValue = null;
			Min = Min_DefaultValue = null;
			Value = Value_DefaultValue = null;
			Within = Within_DefaultValue = MacdSeriesSonificationTracksMappingPlayDelayWithin.Chart;
		...
		/// </summary>
		public MacdSeriesSonificationTracksMappingPlayDelayMapFunction MapFunction { get; set; }
		private MacdSeriesSonificationTracksMappingPlayDelayMapFunction MapFunction_DefaultValue { get; set; }
		...
		/// </summary>
		public MacdSeriesSonificationTracksMappingPlayDelayWithin Within { get; set; }
		private MacdSeriesSonificationTracksMappingPlayDelayWithin Within_DefaultValue { get; set; }
