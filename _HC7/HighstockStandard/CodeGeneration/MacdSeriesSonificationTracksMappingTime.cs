...
{
	public partial class MacdSeriesSonificationTracksMappingTime  : BaseObject
	{
		Hashtable h = new Hashtable();

		public MacdSeriesSonificationTracksMappingTime()
		{
			MapFunction = MapFunction_DefaultValue = MacdSeriesSonificationTracksMappingTimeMapFunction.Linear;
			MapTo = MapTo_DefaultValue = "";
			Max = Max_DefaultValue = null;
			Min = Min_DefaultValue = null;
			Value = Value_DefaultValue = null;
			Within = Within_DefaultValue = MacdSeriesSonificationTracksMappingTimeWithin.Chart;
		...
		/// </summary>
		public MacdSeriesSonificationTracksMappingTimeMapFunction MapFunction { get; set; }
		private MacdSeriesSonificationTracksMappingTimeMapFunction MapFunction_DefaultValue { get; set; }
		...
		/// </summary>
		public MacdSeriesSonificationTracksMappingTimeWithin Within { get; set; }
		private MacdSeriesSonificationTracksMappingTimeWithin Within_DefaultValue { get; set; }
