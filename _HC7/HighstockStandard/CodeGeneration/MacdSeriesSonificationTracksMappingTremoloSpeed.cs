...
{
	public partial class MacdSeriesSonificationTracksMappingTremoloSpeed  : BaseObject
	{
		Hashtable h = new Hashtable();

		public MacdSeriesSonificationTracksMappingTremoloSpeed()
		{
			MapFunction = MapFunction_DefaultValue = MacdSeriesSonificationTracksMappingTremoloSpeedMapFunction.Linear;
			MapTo = MapTo_DefaultValue = "";
			Max = Max_DefaultValue = null;
			Min = Min_DefaultValue = null;
			Value = Value_DefaultValue = null;
			Within = Within_DefaultValue = MacdSeriesSonificationTracksMappingTremoloSpeedWithin.Chart;
		...
		/// </summary>
		public MacdSeriesSonificationTracksMappingTremoloSpeedMapFunction MapFunction { get; set; }
		private MacdSeriesSonificationTracksMappingTremoloSpeedMapFunction MapFunction_DefaultValue { get; set; }
		...
		/// </summary>
		public MacdSeriesSonificationTracksMappingTremoloSpeedWithin Within { get; set; }
		private MacdSeriesSonificationTracksMappingTremoloSpeedWithin Within_DefaultValue { get; set; }
