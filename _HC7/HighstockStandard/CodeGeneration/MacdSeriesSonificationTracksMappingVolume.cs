...
{
	public partial class MacdSeriesSonificationTracksMappingVolume  : BaseObject
	{
		Hashtable h = new Hashtable();

		public MacdSeriesSonificationTracksMappingVolume()
		{
			MapFunction = MapFunction_DefaultValue = MacdSeriesSonificationTracksMappingVolumeMapFunction.Linear;
			MapTo = MapTo_DefaultValue = "";
			Max = Max_DefaultValue = null;
			Min = Min_DefaultValue = null;
			Value = Value_DefaultValue = null;
			Within = Within_DefaultValue = MacdSeriesSonificationTracksMappingVolumeWithin.Chart;
		...
		/// </summary>
		public MacdSeriesSonificationTracksMappingVolumeMapFunction MapFunction { get; set; }
		private MacdSeriesSonificationTracksMappingVolumeMapFunction MapFunction_DefaultValue { get; set; }
		...
		/// </summary>
		public MacdSeriesSonificationTracksMappingVolumeWithin Within { get; set; }
		private MacdSeriesSonificationTracksMappingVolumeWithin Within_DefaultValue { get; set; }
