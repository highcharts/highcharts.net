...
namespace Highsoft.Web.Mvc.Stocks
{
	public partial class MacdSeriesStatesHoverMarkerStates  : BaseObject
	{
		public MacdSeriesStatesHoverMarkerStates()
		{
			...
			Inactive = Inactive_DefaultValue = new MacdSeriesStatesHoverMarkerStatesInactive();
		...
		/// 
		/// </summary>
		public MacdSeriesStatesHoverMarkerStatesInactive Inactive { get; set; }
		private MacdSeriesStatesHoverMarkerStatesInactive Inactive_DefaultValue { get; set; }
