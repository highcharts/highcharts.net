...
{
	public partial class MacdSeriesTooltip  : BaseObject
	{
		public MacdSeriesTooltip()
		{
			...
			HeaderShape = HeaderShape_DefaultValue = MacdSeriesTooltipHeaderShape.Callout;
		...
		/// </summary>
		public MacdSeriesTooltipHeaderShape HeaderShape { get; set; }
		private MacdSeriesTooltipHeaderShape HeaderShape_DefaultValue { get; set; }
		...
		internal override Hashtable ToHashtable()
		{
			...
			if (NullFormatter != NullFormatter_DefaultValue) { h.Add("nullFormatter",NullFormatter); Highstock.AddFunction("MacdSeriesTooltipNullFormatter.nullFormatter", NullFormatter); }  
			if (Outside != Outside_DefaultValue) h.Add("outside",Outside);
			if (Padding != Padding_DefaultValue) h.Add("padding",Padding);
			if (PointFormat != PointFormat_DefaultValue) h.Add("pointFormat",PointFormat);
			if (PointFormatter != PointFormatter_DefaultValue) { h.Add("pointFormatter",PointFormatter); Highstock.AddFunction("MacdSeriesTooltipPointFormatter.pointFormatter", PointFormatter); }  
