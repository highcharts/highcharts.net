...
{
	public partial class MfiSeriesDragDropDragHandle  : BaseObject
	{
		public MfiSeriesDragDropDragHandle()
		{
		...
		internal override Hashtable ToHashtable()
		{
			...
			if (PathFormatter != PathFormatter_DefaultValue) { h.Add("pathFormatter",PathFormatter); Highstock.AddFunction("MfiSeriesDragDropDragHandlePathFormatter.pathFormatter", PathFormatter); }  
