...
{
	public partial class MfiSeriesSonificationContextTracks  : BaseObject
	{
		Hashtable h = new Hashtable();

		public MfiSeriesSonificationContextTracks()
		{
			ActiveWhen = ActiveWhen_DefaultValue = new MfiSeriesSonificationContextTracksActiveWhen();
			Instrument = Instrument_DefaultValue = null;
			InstrumentString = InstrumentString_DefaultValue = "null";
			Mapping = Mapping_DefaultValue = new MfiSeriesSonificationContextTracksMapping();
			MidiName = MidiName_DefaultValue = "";
			PointGrouping = PointGrouping_DefaultValue = new MfiSeriesSonificationContextTracksPointGrouping();
			...
			Type = Type_DefaultValue = MfiSeriesSonificationContextTracksType.Instrument;
			ValueInterval = ValueInterval_DefaultValue = null;
			ValueMapFunction = ValueMapFunction_DefaultValue = MfiSeriesSonificationContextTracksValueMapFunction.Linear;
		...
		/// </summary>
		public MfiSeriesSonificationContextTracksActiveWhen ActiveWhen { get; set; }
		private MfiSeriesSonificationContextTracksActiveWhen ActiveWhen_DefaultValue { get; set; }
		...
		/// </summary>
		public MfiSeriesSonificationContextTracksMapping Mapping { get; set; }
		private MfiSeriesSonificationContextTracksMapping Mapping_DefaultValue { get; set; }
		...
		/// </summary>
		public MfiSeriesSonificationContextTracksPointGrouping PointGrouping { get; set; }
		private MfiSeriesSonificationContextTracksPointGrouping PointGrouping_DefaultValue { get; set; }
		...
		/// </summary>
		public MfiSeriesSonificationContextTracksType Type { get; set; }
		private MfiSeriesSonificationContextTracksType Type_DefaultValue { get; set; }
		...
		/// </summary>
		public MfiSeriesSonificationContextTracksValueMapFunction ValueMapFunction { get; set; }
		private MfiSeriesSonificationContextTracksValueMapFunction ValueMapFunction_DefaultValue { get; set; }
