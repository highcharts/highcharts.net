...
{
	public partial class MfiSeriesSonificationContextTracksMapping  : BaseObject
	{
		Hashtable h = new Hashtable();

		public MfiSeriesSonificationContextTracksMapping()
		{
			Frequency = Frequency_DefaultValue = new MfiSeriesSonificationContextTracksMappingFrequency();
			GapBetweenNotes = GapBetweenNotes_DefaultValue = new MfiSeriesSonificationContextTracksMappingGapBetweenNotes();
			Highpass = Highpass_DefaultValue = new MfiSeriesSonificationContextTracksMappingHighpass();
			Lowpass = Lowpass_DefaultValue = new MfiSeriesSonificationContextTracksMappingLowpass();
			NoteDuration = NoteDuration_DefaultValue = new MfiSeriesSonificationContextTracksMappingNoteDuration();
			Pan = Pan_DefaultValue = new MfiSeriesSonificationContextTracksMappingPan();
			Pitch = Pitch_DefaultValue = new MfiSeriesSonificationContextTracksMappingPitch();
			PitchString = PitchString_DefaultValue = "null";
			PitchNumber = PitchNumber_DefaultValue = null;
			PlayDelay = PlayDelay_DefaultValue = new MfiSeriesSonificationContextTracksMappingPlayDelay();
			Time = Time_DefaultValue = new MfiSeriesSonificationContextTracksMappingTime();
			TimeString = TimeString_DefaultValue = "null";
			TimeNumber = TimeNumber_DefaultValue = null;
			Tremolo = Tremolo_DefaultValue = new MfiSeriesSonificationContextTracksMappingTremolo();
			Volume = Volume_DefaultValue = new MfiSeriesSonificationContextTracksMappingVolume();
		...
		/// </summary>
		public MfiSeriesSonificationContextTracksMappingFrequency Frequency { get; set; }
		private MfiSeriesSonificationContextTracksMappingFrequency Frequency_DefaultValue { get; set; }
		...
		/// </summary>
		public MfiSeriesSonificationContextTracksMappingGapBetweenNotes GapBetweenNotes { get; set; }
		private MfiSeriesSonificationContextTracksMappingGapBetweenNotes GapBetweenNotes_DefaultValue { get; set; }
		...
		/// </summary>
		public MfiSeriesSonificationContextTracksMappingHighpass Highpass { get; set; }
		private MfiSeriesSonificationContextTracksMappingHighpass Highpass_DefaultValue { get; set; }
		...
		/// </summary>
		public MfiSeriesSonificationContextTracksMappingLowpass Lowpass { get; set; }
		private MfiSeriesSonificationContextTracksMappingLowpass Lowpass_DefaultValue { get; set; }
		...
		/// </summary>
		public MfiSeriesSonificationContextTracksMappingNoteDuration NoteDuration { get; set; }
		private MfiSeriesSonificationContextTracksMappingNoteDuration NoteDuration_DefaultValue { get; set; }
		...
		/// </summary>
		public MfiSeriesSonificationContextTracksMappingPan Pan { get; set; }
		private MfiSeriesSonificationContextTracksMappingPan Pan_DefaultValue { get; set; }
		...
		/// </summary>
		public MfiSeriesSonificationContextTracksMappingPitch Pitch { get; set; }
		private MfiSeriesSonificationContextTracksMappingPitch Pitch_DefaultValue { get; set; }
		...
		/// </summary>
		public MfiSeriesSonificationContextTracksMappingPlayDelay PlayDelay { get; set; }
		private MfiSeriesSonificationContextTracksMappingPlayDelay PlayDelay_DefaultValue { get; set; }
		...
		/// </summary>
		public MfiSeriesSonificationContextTracksMappingTime Time { get; set; }
		private MfiSeriesSonificationContextTracksMappingTime Time_DefaultValue { get; set; }
		...
		/// </summary>
		public MfiSeriesSonificationContextTracksMappingTremolo Tremolo { get; set; }
		private MfiSeriesSonificationContextTracksMappingTremolo Tremolo_DefaultValue { get; set; }
		 

		/// <summary>
		/// The volume of notes, from 0 to 1.
		/// </summary>
		public MfiSeriesSonificationContextTracksMappingVolume Volume { get; set; }
		private MfiSeriesSonificationContextTracksMappingVolume Volume_DefaultValue { get; set; }
