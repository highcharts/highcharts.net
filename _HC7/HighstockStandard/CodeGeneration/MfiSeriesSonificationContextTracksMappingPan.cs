...
{
	public partial class MfiSeriesSonificationContextTracksMappingPan  : BaseObject
	{
		Hashtable h = new Hashtable();

		public MfiSeriesSonificationContextTracksMappingPan()
		{
			MapFunction = MapFunction_DefaultValue = MfiSeriesSonificationContextTracksMappingPanMapFunction.Linear;
			MapTo = MapTo_DefaultValue = "";
			Max = Max_DefaultValue = null;
			Min = Min_DefaultValue = null;
			Value = Value_DefaultValue = null;
			Within = Within_DefaultValue = MfiSeriesSonificationContextTracksMappingPanWithin.Chart;
		...
		/// </summary>
		public MfiSeriesSonificationContextTracksMappingPanMapFunction MapFunction { get; set; }
		private MfiSeriesSonificationContextTracksMappingPanMapFunction MapFunction_DefaultValue { get; set; }
		...
		/// </summary>
		public MfiSeriesSonificationContextTracksMappingPanWithin Within { get; set; }
		private MfiSeriesSonificationContextTracksMappingPanWithin Within_DefaultValue { get; set; }
