...
{
	public partial class MfiSeriesSonificationContextTracksMappingPitch  : BaseObject
	{
		Hashtable h = new Hashtable();

		public MfiSeriesSonificationContextTracksMappingPitch()
		{
			MapFunction = MapFunction_DefaultValue = MfiSeriesSonificationContextTracksMappingPitchMapFunction.Linear;
		...
		/// </summary>
		public MfiSeriesSonificationContextTracksMappingPitchMapFunction MapFunction { get; set; }
		private MfiSeriesSonificationContextTracksMappingPitchMapFunction MapFunction_DefaultValue { get; set; }
