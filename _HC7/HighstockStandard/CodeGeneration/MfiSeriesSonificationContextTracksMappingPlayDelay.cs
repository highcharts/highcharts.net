...
{
	public partial class MfiSeriesSonificationContextTracksMappingPlayDelay  : BaseObject
	{
		Hashtable h = new Hashtable();

		public MfiSeriesSonificationContextTracksMappingPlayDelay()
		{
			MapFunction = MapFunction_DefaultValue = MfiSeriesSonificationContextTracksMappingPlayDelayMapFunction.Linear;
			MapTo = MapTo_DefaultValue = "";
			Max = Max_DefaultValue = null;
			Min = Min_DefaultValue = null;
			Value = Value_DefaultValue = null;
			Within = Within_DefaultValue = MfiSeriesSonificationContextTracksMappingPlayDelayWithin.Chart;
		...
		/// </summary>
		public MfiSeriesSonificationContextTracksMappingPlayDelayMapFunction MapFunction { get; set; }
		private MfiSeriesSonificationContextTracksMappingPlayDelayMapFunction MapFunction_DefaultValue { get; set; }
		...
		/// </summary>
		public MfiSeriesSonificationContextTracksMappingPlayDelayWithin Within { get; set; }
		private MfiSeriesSonificationContextTracksMappingPlayDelayWithin Within_DefaultValue { get; set; }
