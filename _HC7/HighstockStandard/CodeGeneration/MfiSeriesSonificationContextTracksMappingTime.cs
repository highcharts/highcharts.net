...
{
	public partial class MfiSeriesSonificationContextTracksMappingTime  : BaseObject
	{
		Hashtable h = new Hashtable();

		public MfiSeriesSonificationContextTracksMappingTime()
		{
			MapFunction = MapFunction_DefaultValue = MfiSeriesSonificationContextTracksMappingTimeMapFunction.Linear;
			MapTo = MapTo_DefaultValue = "";
			Max = Max_DefaultValue = null;
			Min = Min_DefaultValue = null;
			Value = Value_DefaultValue = null;
			Within = Within_DefaultValue = MfiSeriesSonificationContextTracksMappingTimeWithin.Chart;
		...
		/// </summary>
		public MfiSeriesSonificationContextTracksMappingTimeMapFunction MapFunction { get; set; }
		private MfiSeriesSonificationContextTracksMappingTimeMapFunction MapFunction_DefaultValue { get; set; }
		...
		/// </summary>
		public MfiSeriesSonificationContextTracksMappingTimeWithin Within { get; set; }
		private MfiSeriesSonificationContextTracksMappingTimeWithin Within_DefaultValue { get; set; }
