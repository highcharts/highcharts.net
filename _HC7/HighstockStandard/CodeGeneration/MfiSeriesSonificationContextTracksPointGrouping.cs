...
{
	public partial class MfiSeriesSonificationContextTracksPointGrouping  : BaseObject
	{
		Hashtable h = new Hashtable();

		public MfiSeriesSonificationContextTracksPointGrouping()
		{
			Algorithm = Algorithm_DefaultValue = MfiSeriesSonificationContextTracksPointGroupingAlgorithm.Minimax;
		...
		/// </summary>
		public MfiSeriesSonificationContextTracksPointGroupingAlgorithm Algorithm { get; set; }
		private MfiSeriesSonificationContextTracksPointGroupingAlgorithm Algorithm_DefaultValue { get; set; }
