...
{
	public partial class MfiSeriesSonificationDefaultInstrumentOptionsMappingTremoloDepth  : BaseObject
	{
		Hashtable h = new Hashtable();

		public MfiSeriesSonificationDefaultInstrumentOptionsMappingTremoloDepth()
		{
			MapFunction = MapFunction_DefaultValue = MfiSeriesSonificationDefaultInstrumentOptionsMappingTremoloDepthMapFunction.Linear;
			MapTo = MapTo_DefaultValue = "";
			Max = Max_DefaultValue = null;
			Min = Min_DefaultValue = null;
			Value = Value_DefaultValue = null;
			Within = Within_DefaultValue = MfiSeriesSonificationDefaultInstrumentOptionsMappingTremoloDepthWithin.Chart;
		...
		/// </summary>
		public MfiSeriesSonificationDefaultInstrumentOptionsMappingTremoloDepthMapFunction MapFunction { get; set; }
		private MfiSeriesSonificationDefaultInstrumentOptionsMappingTremoloDepthMapFunction MapFunction_DefaultValue { get; set; }
		...
		/// </summary>
		public MfiSeriesSonificationDefaultInstrumentOptionsMappingTremoloDepthWithin Within { get; set; }
		private MfiSeriesSonificationDefaultInstrumentOptionsMappingTremoloDepthWithin Within_DefaultValue { get; set; }
