...
{
	public partial class MfiSeriesSonificationDefaultSpeechOptionsMapping  : BaseObject
	{
		Hashtable h = new Hashtable();

		public MfiSeriesSonificationDefaultSpeechOptionsMapping()
		{
			Frequency = Frequency_DefaultValue = new MfiSeriesSonificationDefaultSpeechOptionsMappingFrequency();
			GapBetweenNotes = GapBetweenNotes_DefaultValue = new MfiSeriesSonificationDefaultSpeechOptionsMappingGapBetweenNotes();
			Highpass = Highpass_DefaultValue = new MfiSeriesSonificationDefaultSpeechOptionsMappingHighpass();
			Lowpass = Lowpass_DefaultValue = new MfiSeriesSonificationDefaultSpeechOptionsMappingLowpass();
			NoteDuration = NoteDuration_DefaultValue = new MfiSeriesSonificationDefaultSpeechOptionsMappingNoteDuration();
			Pan = Pan_DefaultValue = new MfiSeriesSonificationDefaultSpeechOptionsMappingPan();
			Pitch = Pitch_DefaultValue = new MfiSeriesSonificationDefaultSpeechOptionsMappingPitch();
			PitchString = PitchString_DefaultValue = "null";
			PitchNumber = PitchNumber_DefaultValue = null;
			PlayDelay = PlayDelay_DefaultValue = new MfiSeriesSonificationDefaultSpeechOptionsMappingPlayDelay();
			Time = Time_DefaultValue = new MfiSeriesSonificationDefaultSpeechOptionsMappingTime();
			TimeString = TimeString_DefaultValue = "null";
			TimeNumber = TimeNumber_DefaultValue = null;
			Tremolo = Tremolo_DefaultValue = new MfiSeriesSonificationDefaultSpeechOptionsMappingTremolo();
			Volume = Volume_DefaultValue = new MfiSeriesSonificationDefaultSpeechOptionsMappingVolume();
		...
		/// </summary>
		public MfiSeriesSonificationDefaultSpeechOptionsMappingFrequency Frequency { get; set; }
		private MfiSeriesSonificationDefaultSpeechOptionsMappingFrequency Frequency_DefaultValue { get; set; }
		...
		/// </summary>
		public MfiSeriesSonificationDefaultSpeechOptionsMappingGapBetweenNotes GapBetweenNotes { get; set; }
		private MfiSeriesSonificationDefaultSpeechOptionsMappingGapBetweenNotes GapBetweenNotes_DefaultValue { get; set; }
		...
		/// </summary>
		public MfiSeriesSonificationDefaultSpeechOptionsMappingHighpass Highpass { get; set; }
		private MfiSeriesSonificationDefaultSpeechOptionsMappingHighpass Highpass_DefaultValue { get; set; }
		...
		/// </summary>
		public MfiSeriesSonificationDefaultSpeechOptionsMappingLowpass Lowpass { get; set; }
		private MfiSeriesSonificationDefaultSpeechOptionsMappingLowpass Lowpass_DefaultValue { get; set; }
		...
		/// </summary>
		public MfiSeriesSonificationDefaultSpeechOptionsMappingNoteDuration NoteDuration { get; set; }
		private MfiSeriesSonificationDefaultSpeechOptionsMappingNoteDuration NoteDuration_DefaultValue { get; set; }
		...
		/// </summary>
		public MfiSeriesSonificationDefaultSpeechOptionsMappingPan Pan { get; set; }
		private MfiSeriesSonificationDefaultSpeechOptionsMappingPan Pan_DefaultValue { get; set; }
		...
		/// </summary>
		public MfiSeriesSonificationDefaultSpeechOptionsMappingPitch Pitch { get; set; }
		private MfiSeriesSonificationDefaultSpeechOptionsMappingPitch Pitch_DefaultValue { get; set; }
		...
		/// </summary>
		public MfiSeriesSonificationDefaultSpeechOptionsMappingPlayDelay PlayDelay { get; set; }
		private MfiSeriesSonificationDefaultSpeechOptionsMappingPlayDelay PlayDelay_DefaultValue { get; set; }
		...
		/// </summary>
		public MfiSeriesSonificationDefaultSpeechOptionsMappingTime Time { get; set; }
		private MfiSeriesSonificationDefaultSpeechOptionsMappingTime Time_DefaultValue { get; set; }
		...
		/// </summary>
		public MfiSeriesSonificationDefaultSpeechOptionsMappingTremolo Tremolo { get; set; }
		private MfiSeriesSonificationDefaultSpeechOptionsMappingTremolo Tremolo_DefaultValue { get; set; }
		 

		/// <summary>
		/// The volume of notes, from 0 to 1.
		/// </summary>
		public MfiSeriesSonificationDefaultSpeechOptionsMappingVolume Volume { get; set; }
		private MfiSeriesSonificationDefaultSpeechOptionsMappingVolume Volume_DefaultValue { get; set; }
