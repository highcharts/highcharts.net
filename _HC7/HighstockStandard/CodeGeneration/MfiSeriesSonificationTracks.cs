...
{
	public partial class MfiSeriesSonificationTracks  : BaseObject
	{
		Hashtable h = new Hashtable();

		public MfiSeriesSonificationTracks()
		{
			ActiveWhen = ActiveWhen_DefaultValue = new MfiSeriesSonificationTracksActiveWhen();
			Instrument = Instrument_DefaultValue = null;
			InstrumentString = InstrumentString_DefaultValue = "null";
			Mapping = Mapping_DefaultValue = new MfiSeriesSonificationTracksMapping();
			MidiName = MidiName_DefaultValue = "";
			PointGrouping = PointGrouping_DefaultValue = new MfiSeriesSonificationTracksPointGrouping();
			RoundToMusicalNotes = RoundToMusicalNotes_DefaultValue = true;
			ShowPlayMarker = ShowPlayMarker_DefaultValue = true;
			Type = Type_DefaultValue = MfiSeriesSonificationTracksType.Instrument;
		...
		/// </summary>
		public MfiSeriesSonificationTracksActiveWhen ActiveWhen { get; set; }
		private MfiSeriesSonificationTracksActiveWhen ActiveWhen_DefaultValue { get; set; }
		...
		/// </summary>
		public MfiSeriesSonificationTracksMapping Mapping { get; set; }
		private MfiSeriesSonificationTracksMapping Mapping_DefaultValue { get; set; }
		...
		/// </summary>
		public MfiSeriesSonificationTracksPointGrouping PointGrouping { get; set; }
		private MfiSeriesSonificationTracksPointGrouping PointGrouping_DefaultValue { get; set; }
		...
		/// </summary>
		public MfiSeriesSonificationTracksType Type { get; set; }
		private MfiSeriesSonificationTracksType Type_DefaultValue { get; set; }
