...
{
	public partial class MfiSeriesSonificationTracksMapping  : BaseObject
	{
		Hashtable h = new Hashtable();

		public MfiSeriesSonificationTracksMapping()
		{
			Frequency = Frequency_DefaultValue = new MfiSeriesSonificationTracksMappingFrequency();
			GapBetweenNotes = GapBetweenNotes_DefaultValue = new MfiSeriesSonificationTracksMappingGapBetweenNotes();
			Highpass = Highpass_DefaultValue = new MfiSeriesSonificationTracksMappingHighpass();
			Lowpass = Lowpass_DefaultValue = new MfiSeriesSonificationTracksMappingLowpass();
			NoteDuration = NoteDuration_DefaultValue = new MfiSeriesSonificationTracksMappingNoteDuration();
			Pan = Pan_DefaultValue = new MfiSeriesSonificationTracksMappingPan();
			Pitch = Pitch_DefaultValue = new MfiSeriesSonificationTracksMappingPitch();
			PitchString = PitchString_DefaultValue = "null";
			PitchNumber = PitchNumber_DefaultValue = null;
			PlayDelay = PlayDelay_DefaultValue = new MfiSeriesSonificationTracksMappingPlayDelay();
			Time = Time_DefaultValue = new MfiSeriesSonificationTracksMappingTime();
			TimeString = TimeString_DefaultValue = "null";
			TimeNumber = TimeNumber_DefaultValue = null;
			Tremolo = Tremolo_DefaultValue = new MfiSeriesSonificationTracksMappingTremolo();
			Volume = Volume_DefaultValue = new MfiSeriesSonificationTracksMappingVolume();
		...
		/// </summary>
		public MfiSeriesSonificationTracksMappingFrequency Frequency { get; set; }
		private MfiSeriesSonificationTracksMappingFrequency Frequency_DefaultValue { get; set; }
		...
		/// </summary>
		public MfiSeriesSonificationTracksMappingGapBetweenNotes GapBetweenNotes { get; set; }
		private MfiSeriesSonificationTracksMappingGapBetweenNotes GapBetweenNotes_DefaultValue { get; set; }
		...
		/// </summary>
		public MfiSeriesSonificationTracksMappingHighpass Highpass { get; set; }
		private MfiSeriesSonificationTracksMappingHighpass Highpass_DefaultValue { get; set; }
		...
		/// </summary>
		public MfiSeriesSonificationTracksMappingLowpass Lowpass { get; set; }
		private MfiSeriesSonificationTracksMappingLowpass Lowpass_DefaultValue { get; set; }
		...
		/// </summary>
		public MfiSeriesSonificationTracksMappingNoteDuration NoteDuration { get; set; }
		private MfiSeriesSonificationTracksMappingNoteDuration NoteDuration_DefaultValue { get; set; }
		...
		/// </summary>
		public MfiSeriesSonificationTracksMappingPan Pan { get; set; }
		private MfiSeriesSonificationTracksMappingPan Pan_DefaultValue { get; set; }
		...
		/// </summary>
		public MfiSeriesSonificationTracksMappingPitch Pitch { get; set; }
		private MfiSeriesSonificationTracksMappingPitch Pitch_DefaultValue { get; set; }
		...
		/// </summary>
		public MfiSeriesSonificationTracksMappingPlayDelay PlayDelay { get; set; }
		private MfiSeriesSonificationTracksMappingPlayDelay PlayDelay_DefaultValue { get; set; }
		...
		/// </summary>
		public MfiSeriesSonificationTracksMappingTime Time { get; set; }
		private MfiSeriesSonificationTracksMappingTime Time_DefaultValue { get; set; }
		...
		/// </summary>
		public MfiSeriesSonificationTracksMappingTremolo Tremolo { get; set; }
		private MfiSeriesSonificationTracksMappingTremolo Tremolo_DefaultValue { get; set; }
		 

		/// <summary>
		/// The volume of notes, from 0 to 1.
		/// </summary>
		public MfiSeriesSonificationTracksMappingVolume Volume { get; set; }
		private MfiSeriesSonificationTracksMappingVolume Volume_DefaultValue { get; set; }
