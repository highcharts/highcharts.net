...
{
	public partial class MfiSeriesSonificationTracksMappingFrequency  : BaseObject
	{
		Hashtable h = new Hashtable();

		public MfiSeriesSonificationTracksMappingFrequency()
		{
			MapFunction = MapFunction_DefaultValue = MfiSeriesSonificationTracksMappingFrequencyMapFunction.Linear;
			MapTo = MapTo_DefaultValue = "";
			Max = Max_DefaultValue = null;
			Min = Min_DefaultValue = null;
			Value = Value_DefaultValue = null;
			Within = Within_DefaultValue = MfiSeriesSonificationTracksMappingFrequencyWithin.Chart;
		...
		/// </summary>
		public MfiSeriesSonificationTracksMappingFrequencyMapFunction MapFunction { get; set; }
		private MfiSeriesSonificationTracksMappingFrequencyMapFunction MapFunction_DefaultValue { get; set; }
		...
		/// </summary>
		public MfiSeriesSonificationTracksMappingFrequencyWithin Within { get; set; }
		private MfiSeriesSonificationTracksMappingFrequencyWithin Within_DefaultValue { get; set; }
