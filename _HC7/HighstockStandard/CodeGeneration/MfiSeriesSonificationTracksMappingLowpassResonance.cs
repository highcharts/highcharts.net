...
{
	public partial class MfiSeriesSonificationTracksMappingLowpassResonance  : BaseObject
	{
		Hashtable h = new Hashtable();

		public MfiSeriesSonificationTracksMappingLowpassResonance()
		{
			MapFunction = MapFunction_DefaultValue = MfiSeriesSonificationTracksMappingLowpassResonanceMapFunction.Linear;
			MapTo = MapTo_DefaultValue = "";
			Max = Max_DefaultValue = null;
			Min = Min_DefaultValue = null;
			Value = Value_DefaultValue = null;
			Within = Within_DefaultValue = MfiSeriesSonificationTracksMappingLowpassResonanceWithin.Chart;
		...
		/// </summary>
		public MfiSeriesSonificationTracksMappingLowpassResonanceMapFunction MapFunction { get; set; }
		private MfiSeriesSonificationTracksMappingLowpassResonanceMapFunction MapFunction_DefaultValue { get; set; }
		...
		/// </summary>
		public MfiSeriesSonificationTracksMappingLowpassResonanceWithin Within { get; set; }
		private MfiSeriesSonificationTracksMappingLowpassResonanceWithin Within_DefaultValue { get; set; }
