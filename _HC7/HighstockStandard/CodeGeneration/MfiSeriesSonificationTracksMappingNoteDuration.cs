...
{
	public partial class MfiSeriesSonificationTracksMappingNoteDuration  : BaseObject
	{
		Hashtable h = new Hashtable();

		public MfiSeriesSonificationTracksMappingNoteDuration()
		{
			MapFunction = MapFunction_DefaultValue = MfiSeriesSonificationTracksMappingNoteDurationMapFunction.Linear;
			MapTo = MapTo_DefaultValue = "";
			Max = Max_DefaultValue = null;
			Min = Min_DefaultValue = null;
			Value = Value_DefaultValue = null;
			Within = Within_DefaultValue = MfiSeriesSonificationTracksMappingNoteDurationWithin.Chart;
		...
		/// </summary>
		public MfiSeriesSonificationTracksMappingNoteDurationMapFunction MapFunction { get; set; }
		private MfiSeriesSonificationTracksMappingNoteDurationMapFunction MapFunction_DefaultValue { get; set; }
		...
		/// </summary>
		public MfiSeriesSonificationTracksMappingNoteDurationWithin Within { get; set; }
		private MfiSeriesSonificationTracksMappingNoteDurationWithin Within_DefaultValue { get; set; }
