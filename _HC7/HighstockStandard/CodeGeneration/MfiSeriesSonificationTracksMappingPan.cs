...
{
	public partial class MfiSeriesSonificationTracksMappingPan  : BaseObject
	{
		Hashtable h = new Hashtable();

		public MfiSeriesSonificationTracksMappingPan()
		{
			MapFunction = MapFunction_DefaultValue = MfiSeriesSonificationTracksMappingPanMapFunction.Linear;
			MapTo = MapTo_DefaultValue = "";
			Max = Max_DefaultValue = null;
			Min = Min_DefaultValue = null;
			Value = Value_DefaultValue = null;
			Within = Within_DefaultValue = MfiSeriesSonificationTracksMappingPanWithin.Chart;
		...
		/// </summary>
		public MfiSeriesSonificationTracksMappingPanMapFunction MapFunction { get; set; }
		private MfiSeriesSonificationTracksMappingPanMapFunction MapFunction_DefaultValue { get; set; }
		...
		/// </summary>
		public MfiSeriesSonificationTracksMappingPanWithin Within { get; set; }
		private MfiSeriesSonificationTracksMappingPanWithin Within_DefaultValue { get; set; }
