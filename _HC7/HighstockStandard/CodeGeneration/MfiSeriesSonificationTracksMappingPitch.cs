...
{
	public partial class MfiSeriesSonificationTracksMappingPitch  : BaseObject
	{
		Hashtable h = new Hashtable();

		public MfiSeriesSonificationTracksMappingPitch()
		{
			MapFunction = MapFunction_DefaultValue = MfiSeriesSonificationTracksMappingPitchMapFunction.Linear;
		...
		/// </summary>
		public MfiSeriesSonificationTracksMappingPitchMapFunction MapFunction { get; set; }
		private MfiSeriesSonificationTracksMappingPitchMapFunction MapFunction_DefaultValue { get; set; }
