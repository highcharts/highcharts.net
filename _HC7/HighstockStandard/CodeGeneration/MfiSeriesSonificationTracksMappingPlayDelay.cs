...
{
	public partial class MfiSeriesSonificationTracksMappingPlayDelay  : BaseObject
	{
		Hashtable h = new Hashtable();

		public MfiSeriesSonificationTracksMappingPlayDelay()
		{
			MapFunction = MapFunction_DefaultValue = MfiSeriesSonificationTracksMappingPlayDelayMapFunction.Linear;
			MapTo = MapTo_DefaultValue = "";
			Max = Max_DefaultValue = null;
			Min = Min_DefaultValue = null;
			Value = Value_DefaultValue = null;
			Within = Within_DefaultValue = MfiSeriesSonificationTracksMappingPlayDelayWithin.Chart;
		...
		/// </summary>
		public MfiSeriesSonificationTracksMappingPlayDelayMapFunction MapFunction { get; set; }
		private MfiSeriesSonificationTracksMappingPlayDelayMapFunction MapFunction_DefaultValue { get; set; }
		...
		/// </summary>
		public MfiSeriesSonificationTracksMappingPlayDelayWithin Within { get; set; }
		private MfiSeriesSonificationTracksMappingPlayDelayWithin Within_DefaultValue { get; set; }
