...
{
	public partial class MfiSeriesSonificationTracksMappingTime  : BaseObject
	{
		Hashtable h = new Hashtable();

		public MfiSeriesSonificationTracksMappingTime()
		{
			MapFunction = MapFunction_DefaultValue = MfiSeriesSonificationTracksMappingTimeMapFunction.Linear;
			MapTo = MapTo_DefaultValue = "";
			Max = Max_DefaultValue = null;
			Min = Min_DefaultValue = null;
			Value = Value_DefaultValue = null;
			Within = Within_DefaultValue = MfiSeriesSonificationTracksMappingTimeWithin.Chart;
		...
		/// </summary>
		public MfiSeriesSonificationTracksMappingTimeMapFunction MapFunction { get; set; }
		private MfiSeriesSonificationTracksMappingTimeMapFunction MapFunction_DefaultValue { get; set; }
		...
		/// </summary>
		public MfiSeriesSonificationTracksMappingTimeWithin Within { get; set; }
		private MfiSeriesSonificationTracksMappingTimeWithin Within_DefaultValue { get; set; }
