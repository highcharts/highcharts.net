...
{
	public partial class MfiSeriesSonificationTracksMappingTremoloSpeed  : BaseObject
	{
		Hashtable h = new Hashtable();

		public MfiSeriesSonificationTracksMappingTremoloSpeed()
		{
			MapFunction = MapFunction_DefaultValue = MfiSeriesSonificationTracksMappingTremoloSpeedMapFunction.Linear;
			MapTo = MapTo_DefaultValue = "";
			Max = Max_DefaultValue = null;
			Min = Min_DefaultValue = null;
			Value = Value_DefaultValue = null;
			Within = Within_DefaultValue = MfiSeriesSonificationTracksMappingTremoloSpeedWithin.Chart;
		...
		/// </summary>
		public MfiSeriesSonificationTracksMappingTremoloSpeedMapFunction MapFunction { get; set; }
		private MfiSeriesSonificationTracksMappingTremoloSpeedMapFunction MapFunction_DefaultValue { get; set; }
		...
		/// </summary>
		public MfiSeriesSonificationTracksMappingTremoloSpeedWithin Within { get; set; }
		private MfiSeriesSonificationTracksMappingTremoloSpeedWithin Within_DefaultValue { get; set; }
