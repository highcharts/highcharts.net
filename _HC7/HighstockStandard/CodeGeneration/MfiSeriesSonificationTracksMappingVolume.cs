...
{
	public partial class MfiSeriesSonificationTracksMappingVolume  : BaseObject
	{
		Hashtable h = new Hashtable();

		public MfiSeriesSonificationTracksMappingVolume()
		{
			MapFunction = MapFunction_DefaultValue = MfiSeriesSonificationTracksMappingVolumeMapFunction.Linear;
			MapTo = MapTo_DefaultValue = "";
			Max = Max_DefaultValue = null;
			Min = Min_DefaultValue = null;
			Value = Value_DefaultValue = null;
			Within = Within_DefaultValue = MfiSeriesSonificationTracksMappingVolumeWithin.Chart;
		...
		/// </summary>
		public MfiSeriesSonificationTracksMappingVolumeMapFunction MapFunction { get; set; }
		private MfiSeriesSonificationTracksMappingVolumeMapFunction MapFunction_DefaultValue { get; set; }
		...
		/// </summary>
		public MfiSeriesSonificationTracksMappingVolumeWithin Within { get; set; }
		private MfiSeriesSonificationTracksMappingVolumeWithin Within_DefaultValue { get; set; }
