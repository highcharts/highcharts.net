...
{
	public partial class MfiSeriesSonificationTracksPointGrouping  : BaseObject
	{
		Hashtable h = new Hashtable();

		public MfiSeriesSonificationTracksPointGrouping()
		{
			Algorithm = Algorithm_DefaultValue = MfiSeriesSonificationTracksPointGroupingAlgorithm.Minimax;
		...
		/// </summary>
		public MfiSeriesSonificationTracksPointGroupingAlgorithm Algorithm { get; set; }
		private MfiSeriesSonificationTracksPointGroupingAlgorithm Algorithm_DefaultValue { get; set; }
