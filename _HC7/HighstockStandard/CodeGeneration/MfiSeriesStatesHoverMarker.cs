...
{
	public partial class MfiSeriesStatesHoverMarker  : BaseObject
	{
		public MfiSeriesStatesHoverMarker()
		{
			...
			States = States_DefaultValue = new MfiSeriesStatesHoverMarkerStates();
		...
		/// </summary>
		public MfiSeriesStatesHoverMarkerStates States { get; set; }
		private MfiSeriesStatesHoverMarkerStates States_DefaultValue { get; set; }
