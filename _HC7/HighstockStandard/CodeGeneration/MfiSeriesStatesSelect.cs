...
{
	public partial class MfiSeriesStatesSelect  : BaseObject
	{
		Hashtable h = new Hashtable();

		public MfiSeriesStatesSelect()
		{
			Animation = Animation_DefaultValue = new Animation() { Enabled = true };
			Enabled = Enabled_DefaultValue = null;
			Halo = Halo_DefaultValue = new MfiSeriesStatesSelectHalo();
			LineWidth = LineWidth_DefaultValue = null;
			LineWidthPlus = LineWidthPlus_DefaultValue = null;
			Marker = Marker_DefaultValue = new MfiSeriesStatesSelectMarker();
		...
		/// </summary>
		public MfiSeriesStatesSelectHalo Halo { get; set; }
		private MfiSeriesStatesSelectHalo Halo_DefaultValue { get; set; }
		...
		/// </summary>
		public MfiSeriesStatesSelectMarker Marker { get; set; }
		private MfiSeriesStatesSelectMarker Marker_DefaultValue { get; set; }
