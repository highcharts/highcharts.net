...
{
	public partial class MfiSeriesTooltip  : BaseObject
	{
		public MfiSeriesTooltip()
		{
			...
			HeaderShape = HeaderShape_DefaultValue = MfiSeriesTooltipHeaderShape.Callout;
		...
		/// </summary>
		public MfiSeriesTooltipHeaderShape HeaderShape { get; set; }
		private MfiSeriesTooltipHeaderShape HeaderShape_DefaultValue { get; set; }
		...
		internal override Hashtable ToHashtable()
		{
			...
			if (NullFormatter != NullFormatter_DefaultValue) { h.Add("nullFormatter",NullFormatter); Highstock.AddFunction("MfiSeriesTooltipNullFormatter.nullFormatter", NullFormatter); }  
			if (Outside != Outside_DefaultValue) h.Add("outside",Outside);
			if (Padding != Padding_DefaultValue) h.Add("padding",Padding);
			if (PointFormat != PointFormat_DefaultValue) h.Add("pointFormat",PointFormat);
			if (PointFormatter != PointFormatter_DefaultValue) { h.Add("pointFormatter",PointFormatter); Highstock.AddFunction("MfiSeriesTooltipPointFormatter.pointFormatter", PointFormatter); }  
