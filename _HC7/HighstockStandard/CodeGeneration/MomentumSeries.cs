...
namespace Highsoft.Web.Mvc.Stocks
{
	public partial class MomentumSeries  : Series
	{
		...
		public MomentumSeries()
		{
			...
			Zones = Zones_DefaultValue = new List<MomentumSeriesZone>();
		...
		/// </summary>
		public List<MomentumSeriesZone> Zones { get; set; }
		private List<MomentumSeriesZone> Zones_DefaultValue { get; set; }
