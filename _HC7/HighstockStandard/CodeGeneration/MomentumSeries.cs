...
{
	public partial class MomentumSeries  : Series
	{
		Hashtable h = new Hashtable();

		public MomentumSeries()
		{
			Accessibility = Accessibility_DefaultValue = new MomentumSeriesAccessibility();
			AllowPointSelect = AllowPointSelect_DefaultValue = false;
			Animation = Animation_DefaultValue = new Animation() { Enabled = true };
			AnimationBool = AnimationBool_DefaultValue = true;
			AnimationLimit = AnimationLimit_DefaultValue = null;
			BoostBlending = BoostBlending_DefaultValue = MomentumSeriesBoostBlending.Undefined;
			...
			Compare = Compare_DefaultValue = MomentumSeriesCompare.Percent;
			CompareBase = CompareBase_DefaultValue = MomentumSeriesCompareBase.Min;
			...
			Cursor = Cursor_DefaultValue = MomentumSeriesCursor.Null;
			Custom = Custom_DefaultValue = new Hashtable();
			DashStyle = DashStyle_DefaultValue = MomentumSeriesDashStyle.Null;
			DataGrouping = DataGrouping_DefaultValue = new MomentumSeriesDataGrouping();
			DataLabels = DataLabels_DefaultValue = new MomentumSeriesDataLabels();
			DataSorting = DataSorting_DefaultValue = new MomentumSeriesDataSorting();
			Description = Description_DefaultValue = "";
			Dumbell = Dumbell_DefaultValue = new MomentumSeriesDumbell();
			EnableMouseTracking = EnableMouseTracking_DefaultValue = true;
			Events = Events_DefaultValue = new MomentumSeriesEvents();
			FindNearestPointBy = FindNearestPointBy_DefaultValue = MomentumSeriesFindNearestPointBy.X;
			GapSize = GapSize_DefaultValue = 0;
			GapUnit = GapUnit_DefaultValue = MomentumSeriesGapUnit.Relative;
			GetExtremesFromAll = GetExtremesFromAll_DefaultValue = false;
			Id = Id_DefaultValue = "";
			InactiveOtherPoints = InactiveOtherPoints_DefaultValue = false;
			IncludeInDataExport = IncludeInDataExport_DefaultValue = null;
			Index = Index_DefaultValue = null;
			Label = Label_DefaultValue = new MomentumSeriesLabel();
			LastPrice = LastPrice_DefaultValue = new MomentumSeriesLastPrice();
			LastVisiblePrice = LastVisiblePrice_DefaultValue = new MomentumSeriesLastVisiblePrice();
			LegendIndex = LegendIndex_DefaultValue = null;
			LegendSymbol = LegendSymbol_DefaultValue = MomentumSeriesLegendSymbol.Rectangle;
			Linecap = Linecap_DefaultValue = MomentumSeriesLinecap.Round;
			LineWidth = LineWidth_DefaultValue = 2;
			LinkedTo = LinkedTo_DefaultValue = "";
			Marker = Marker_DefaultValue = new MomentumSeriesMarker();
			Name = Name_DefaultValue = "";
			NegativeColor = NegativeColor_DefaultValue = "";
			OnPoint = OnPoint_DefaultValue = new MomentumSeriesOnPoint();
			Opacity = Opacity_DefaultValue = 1;
			Params = Params_DefaultValue = new MomentumSeriesParams();
			Point = Point_DefaultValue = new MomentumSeriesPoint();
			...
			Sonification = Sonification_DefaultValue = new MomentumSeriesSonification();
			Stack = Stack_DefaultValue = "";
			StackNumber = StackNumber_DefaultValue = null;
			States = States_DefaultValue = new MomentumSeriesStates();
			Step = Step_DefaultValue = MomentumSeriesStep.Null;
			StickyTracking = StickyTracking_DefaultValue = true;
			Threshold = Threshold_DefaultValue = 0;
			Tooltip = Tooltip_DefaultValue = new MomentumSeriesTooltip();
			...
			Zones = Zones_DefaultValue = new List<MomentumSeriesZones>();
		...
		/// </summary>
		public MomentumSeriesAccessibility Accessibility { get; set; }
		private MomentumSeriesAccessibility Accessibility_DefaultValue { get; set; }
		...
		/// </summary>
		public MomentumSeriesBoostBlending BoostBlending { get; set; }
		private MomentumSeriesBoostBlending BoostBlending_DefaultValue { get; set; }
		...
		/// </summary>
		public MomentumSeriesCompare Compare { get; set; }
		private MomentumSeriesCompare Compare_DefaultValue { get; set; }
		 

		/// <summary>
		/// When [compare](#plotOptions.series.compare) is `percent`, this optiondictates whether to use 0 or 100 as the base of comparison.
		/// </summary>
		public MomentumSeriesCompareBase CompareBase { get; set; }
		private MomentumSeriesCompareBase CompareBase_DefaultValue { get; set; }
		...
		/// </summary>
		public MomentumSeriesCursor Cursor { get; set; }
		private MomentumSeriesCursor Cursor_DefaultValue { get; set; }
		...
		/// </summary>
		public MomentumSeriesDashStyle DashStyle { get; set; }
		private MomentumSeriesDashStyle DashStyle_DefaultValue { get; set; }
		...
		/// </summary>
		public MomentumSeriesDataGrouping DataGrouping { get; set; }
		private MomentumSeriesDataGrouping DataGrouping_DefaultValue { get; set; }
		...
		/// </summary>
		public MomentumSeriesDataLabels DataLabels { get; set; }
		private MomentumSeriesDataLabels DataLabels_DefaultValue { get; set; }
		 

		/// <summary>
		/// Options for the series data sorting.
		/// </summary>
		public MomentumSeriesDataSorting DataSorting { get; set; }
		private MomentumSeriesDataSorting DataSorting_DefaultValue { get; set; }
		...
		/// 
		/// </summary>
		public MomentumSeriesDumbell Dumbell { get; set; }
		private MomentumSeriesDumbell Dumbell_DefaultValue { get; set; }
		...
		/// </summary>
		public MomentumSeriesEvents Events { get; set; }
		private MomentumSeriesEvents Events_DefaultValue { get; set; }
		...
		/// </summary>
		public MomentumSeriesFindNearestPointBy FindNearestPointBy { get; set; }
		private MomentumSeriesFindNearestPointBy FindNearestPointBy_DefaultValue { get; set; }
		...
		/// </summary>
		public MomentumSeriesGapUnit GapUnit { get; set; }
		private MomentumSeriesGapUnit GapUnit_DefaultValue { get; set; }
		...
		/// </summary>
		public MomentumSeriesLabel Label { get; set; }
		private MomentumSeriesLabel Label_DefaultValue { get; set; }
		 

		/// <summary>
		/// The line marks the last price from all points.
		/// </summary>
		public MomentumSeriesLastPrice LastPrice { get; set; }
		private MomentumSeriesLastPrice LastPrice_DefaultValue { get; set; }
		 

		/// <summary>
		/// The line marks the last price from visible range of points.
		/// </summary>
		public MomentumSeriesLastVisiblePrice LastVisiblePrice { get; set; }
		private MomentumSeriesLastVisiblePrice LastVisiblePrice_DefaultValue { get; set; }
		...
		/// </summary>
		public MomentumSeriesLegendSymbol LegendSymbol { get; set; }
		private MomentumSeriesLegendSymbol LegendSymbol_DefaultValue { get; set; }
		 

		/// <summary>
		/// The line cap used for line ends and line joins on the graph.
		/// </summary>
		public MomentumSeriesLinecap Linecap { get; set; }
		private MomentumSeriesLinecap Linecap_DefaultValue { get; set; }
		...
		/// </summary>
		public MomentumSeriesMarker Marker { get; set; }
		private MomentumSeriesMarker Marker_DefaultValue { get; set; }
		...
		/// </summary>
		public MomentumSeriesOnPoint OnPoint { get; set; }
		private MomentumSeriesOnPoint OnPoint_DefaultValue { get; set; }
		...
		/// </summary>
		public MomentumSeriesParams Params { get; set; }
		private MomentumSeriesParams Params_DefaultValue { get; set; }
		 

		/// <summary>
		/// Properties for each single point.
		/// </summary>
		public MomentumSeriesPoint Point { get; set; }
		private MomentumSeriesPoint Point_DefaultValue { get; set; }
		...
		/// </summary>
		public MomentumSeriesSonification Sonification { get; set; }
		private MomentumSeriesSonification Sonification_DefaultValue { get; set; }
		...
		/// 
		/// </summary>
		public MomentumSeriesStates States { get; set; }
		private MomentumSeriesStates States_DefaultValue { get; set; }
		 

		/// <summary>
		/// Whether to apply steps to the line. Possible values are `left`,`center` and `right`.
		/// </summary>
		public MomentumSeriesStep Step { get; set; }
		private MomentumSeriesStep Step_DefaultValue { get; set; }
		...
		/// </summary>
		public MomentumSeriesTooltip Tooltip { get; set; }
		private MomentumSeriesTooltip Tooltip_DefaultValue { get; set; }
		...
		/// </summary>
		public List<MomentumSeriesZones> Zones { get; set; }
		private List<MomentumSeriesZones> Zones_DefaultValue { get; set; }
