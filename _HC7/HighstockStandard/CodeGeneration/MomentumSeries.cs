...
namespace Highsoft.Web.Mvc.Stocks
{
	public partial class MomentumSeries  : Series
	{
		public MomentumSeries()
		{
			...
			DragDrop = DragDrop_DefaultValue = new MomentumSeriesDragDrop();
		...
		/// </summary>
		public MomentumSeriesDragDrop DragDrop { get; set; }
		private MomentumSeriesDragDrop DragDrop_DefaultValue { get; set; }
