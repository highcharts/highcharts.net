...
namespace Highsoft.Web.Mvc.Stocks
{
	public partial class MomentumSeriesDataGrouping  : BaseObject
	{
		...
		internal override Hashtable ToHashtable()
		{
			...
			if (Approximation != Approximation_DefaultValue) { h.Add("approximation",Approximation); Highstock.AddFunction("MomentumSeriesDataGroupingApproximation.approximation", Approximation); }  
