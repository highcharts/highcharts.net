...
{
	public partial class MomentumSeriesDragDrop  : BaseObject
	{
		public MomentumSeriesDragDrop()
		{
			DraggableX = DraggableX_DefaultValue = null;
			DraggableY = DraggableY_DefaultValue = null;
			DragHandle = DragHandle_DefaultValue = new MomentumSeriesDragDropDragHandle();
			...
			GuideBox = GuideBox_DefaultValue = new MomentumSeriesDragDropGuideBox();
		...
		/// </summary>
		public MomentumSeriesDragDropDragHandle DragHandle { get; set; }
		private MomentumSeriesDragDropDragHandle DragHandle_DefaultValue { get; set; }
		...
		/// </summary>
		public MomentumSeriesDragDropGuideBox GuideBox { get; set; }
		private MomentumSeriesDragDropGuideBox GuideBox_DefaultValue { get; set; }
