...
{
	public partial class MomentumSeriesSonificationContextTracks  : BaseObject
	{
		Hashtable h = new Hashtable();

		public MomentumSeriesSonificationContextTracks()
		{
			ActiveWhen = ActiveWhen_DefaultValue = new MomentumSeriesSonificationContextTracksActiveWhen();
			Instrument = Instrument_DefaultValue = null;
			InstrumentString = InstrumentString_DefaultValue = "null";
			Mapping = Mapping_DefaultValue = new MomentumSeriesSonificationContextTracksMapping();
			MidiName = MidiName_DefaultValue = "";
			PointGrouping = PointGrouping_DefaultValue = new MomentumSeriesSonificationContextTracksPointGrouping();
			...
			Type = Type_DefaultValue = MomentumSeriesSonificationContextTracksType.Instrument;
			ValueInterval = ValueInterval_DefaultValue = null;
			ValueMapFunction = ValueMapFunction_DefaultValue = MomentumSeriesSonificationContextTracksValueMapFunction.Linear;
		...
		/// </summary>
		public MomentumSeriesSonificationContextTracksActiveWhen ActiveWhen { get; set; }
		private MomentumSeriesSonificationContextTracksActiveWhen ActiveWhen_DefaultValue { get; set; }
		...
		/// </summary>
		public MomentumSeriesSonificationContextTracksMapping Mapping { get; set; }
		private MomentumSeriesSonificationContextTracksMapping Mapping_DefaultValue { get; set; }
		...
		/// </summary>
		public MomentumSeriesSonificationContextTracksPointGrouping PointGrouping { get; set; }
		private MomentumSeriesSonificationContextTracksPointGrouping PointGrouping_DefaultValue { get; set; }
		...
		/// </summary>
		public MomentumSeriesSonificationContextTracksType Type { get; set; }
		private MomentumSeriesSonificationContextTracksType Type_DefaultValue { get; set; }
		...
		/// </summary>
		public MomentumSeriesSonificationContextTracksValueMapFunction ValueMapFunction { get; set; }
		private MomentumSeriesSonificationContextTracksValueMapFunction ValueMapFunction_DefaultValue { get; set; }
