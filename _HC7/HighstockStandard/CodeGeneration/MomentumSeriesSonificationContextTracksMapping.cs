...
{
	public partial class MomentumSeriesSonificationContextTracksMapping  : BaseObject
	{
		Hashtable h = new Hashtable();

		public MomentumSeriesSonificationContextTracksMapping()
		{
			Frequency = Frequency_DefaultValue = new MomentumSeriesSonificationContextTracksMappingFrequency();
			GapBetweenNotes = GapBetweenNotes_DefaultValue = new MomentumSeriesSonificationContextTracksMappingGapBetweenNotes();
			Highpass = Highpass_DefaultValue = new MomentumSeriesSonificationContextTracksMappingHighpass();
			Lowpass = Lowpass_DefaultValue = new MomentumSeriesSonificationContextTracksMappingLowpass();
			NoteDuration = NoteDuration_DefaultValue = new MomentumSeriesSonificationContextTracksMappingNoteDuration();
			Pan = Pan_DefaultValue = new MomentumSeriesSonificationContextTracksMappingPan();
			Pitch = Pitch_DefaultValue = new MomentumSeriesSonificationContextTracksMappingPitch();
			PitchString = PitchString_DefaultValue = "null";
			PitchNumber = PitchNumber_DefaultValue = null;
			PlayDelay = PlayDelay_DefaultValue = new MomentumSeriesSonificationContextTracksMappingPlayDelay();
			Time = Time_DefaultValue = new MomentumSeriesSonificationContextTracksMappingTime();
			TimeString = TimeString_DefaultValue = "null";
			TimeNumber = TimeNumber_DefaultValue = null;
			Tremolo = Tremolo_DefaultValue = new MomentumSeriesSonificationContextTracksMappingTremolo();
			Volume = Volume_DefaultValue = new MomentumSeriesSonificationContextTracksMappingVolume();
		...
		/// </summary>
		public MomentumSeriesSonificationContextTracksMappingFrequency Frequency { get; set; }
		private MomentumSeriesSonificationContextTracksMappingFrequency Frequency_DefaultValue { get; set; }
		...
		/// </summary>
		public MomentumSeriesSonificationContextTracksMappingGapBetweenNotes GapBetweenNotes { get; set; }
		private MomentumSeriesSonificationContextTracksMappingGapBetweenNotes GapBetweenNotes_DefaultValue { get; set; }
		...
		/// </summary>
		public MomentumSeriesSonificationContextTracksMappingHighpass Highpass { get; set; }
		private MomentumSeriesSonificationContextTracksMappingHighpass Highpass_DefaultValue { get; set; }
		...
		/// </summary>
		public MomentumSeriesSonificationContextTracksMappingLowpass Lowpass { get; set; }
		private MomentumSeriesSonificationContextTracksMappingLowpass Lowpass_DefaultValue { get; set; }
		...
		/// </summary>
		public MomentumSeriesSonificationContextTracksMappingNoteDuration NoteDuration { get; set; }
		private MomentumSeriesSonificationContextTracksMappingNoteDuration NoteDuration_DefaultValue { get; set; }
		...
		/// </summary>
		public MomentumSeriesSonificationContextTracksMappingPan Pan { get; set; }
		private MomentumSeriesSonificationContextTracksMappingPan Pan_DefaultValue { get; set; }
		...
		/// </summary>
		public MomentumSeriesSonificationContextTracksMappingPitch Pitch { get; set; }
		private MomentumSeriesSonificationContextTracksMappingPitch Pitch_DefaultValue { get; set; }
		...
		/// </summary>
		public MomentumSeriesSonificationContextTracksMappingPlayDelay PlayDelay { get; set; }
		private MomentumSeriesSonificationContextTracksMappingPlayDelay PlayDelay_DefaultValue { get; set; }
		...
		/// </summary>
		public MomentumSeriesSonificationContextTracksMappingTime Time { get; set; }
		private MomentumSeriesSonificationContextTracksMappingTime Time_DefaultValue { get; set; }
		...
		/// </summary>
		public MomentumSeriesSonificationContextTracksMappingTremolo Tremolo { get; set; }
		private MomentumSeriesSonificationContextTracksMappingTremolo Tremolo_DefaultValue { get; set; }
		 

		/// <summary>
		/// The volume of notes, from 0 to 1.
		/// </summary>
		public MomentumSeriesSonificationContextTracksMappingVolume Volume { get; set; }
		private MomentumSeriesSonificationContextTracksMappingVolume Volume_DefaultValue { get; set; }
