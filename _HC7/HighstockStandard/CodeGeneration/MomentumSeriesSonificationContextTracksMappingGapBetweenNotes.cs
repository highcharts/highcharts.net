...
{
	public partial class MomentumSeriesSonificationContextTracksMappingGapBetweenNotes  : BaseObject
	{
		Hashtable h = new Hashtable();

		public MomentumSeriesSonificationContextTracksMappingGapBetweenNotes()
		{
			MapFunction = MapFunction_DefaultValue = MomentumSeriesSonificationContextTracksMappingGapBetweenNotesMapFunction.Linear;
			MapTo = MapTo_DefaultValue = "";
			Max = Max_DefaultValue = null;
			Min = Min_DefaultValue = null;
			Value = Value_DefaultValue = null;
			Within = Within_DefaultValue = MomentumSeriesSonificationContextTracksMappingGapBetweenNotesWithin.Chart;
		...
		/// </summary>
		public MomentumSeriesSonificationContextTracksMappingGapBetweenNotesMapFunction MapFunction { get; set; }
		private MomentumSeriesSonificationContextTracksMappingGapBetweenNotesMapFunction MapFunction_DefaultValue { get; set; }
		...
		/// </summary>
		public MomentumSeriesSonificationContextTracksMappingGapBetweenNotesWithin Within { get; set; }
		private MomentumSeriesSonificationContextTracksMappingGapBetweenNotesWithin Within_DefaultValue { get; set; }
