...
{
	public partial class MomentumSeriesSonificationDefaultSpeechOptionsMapping  : BaseObject
	{
		Hashtable h = new Hashtable();

		public MomentumSeriesSonificationDefaultSpeechOptionsMapping()
		{
			Frequency = Frequency_DefaultValue = new MomentumSeriesSonificationDefaultSpeechOptionsMappingFrequency();
			GapBetweenNotes = GapBetweenNotes_DefaultValue = new MomentumSeriesSonificationDefaultSpeechOptionsMappingGapBetweenNotes();
			Highpass = Highpass_DefaultValue = new MomentumSeriesSonificationDefaultSpeechOptionsMappingHighpass();
			Lowpass = Lowpass_DefaultValue = new MomentumSeriesSonificationDefaultSpeechOptionsMappingLowpass();
			NoteDuration = NoteDuration_DefaultValue = new MomentumSeriesSonificationDefaultSpeechOptionsMappingNoteDuration();
			Pan = Pan_DefaultValue = new MomentumSeriesSonificationDefaultSpeechOptionsMappingPan();
			Pitch = Pitch_DefaultValue = new MomentumSeriesSonificationDefaultSpeechOptionsMappingPitch();
			PitchString = PitchString_DefaultValue = "null";
			PitchNumber = PitchNumber_DefaultValue = null;
			PlayDelay = PlayDelay_DefaultValue = new MomentumSeriesSonificationDefaultSpeechOptionsMappingPlayDelay();
			Time = Time_DefaultValue = new MomentumSeriesSonificationDefaultSpeechOptionsMappingTime();
			TimeString = TimeString_DefaultValue = "null";
			TimeNumber = TimeNumber_DefaultValue = null;
			Tremolo = Tremolo_DefaultValue = new MomentumSeriesSonificationDefaultSpeechOptionsMappingTremolo();
			Volume = Volume_DefaultValue = new MomentumSeriesSonificationDefaultSpeechOptionsMappingVolume();
		...
		/// </summary>
		public MomentumSeriesSonificationDefaultSpeechOptionsMappingFrequency Frequency { get; set; }
		private MomentumSeriesSonificationDefaultSpeechOptionsMappingFrequency Frequency_DefaultValue { get; set; }
		...
		/// </summary>
		public MomentumSeriesSonificationDefaultSpeechOptionsMappingGapBetweenNotes GapBetweenNotes { get; set; }
		private MomentumSeriesSonificationDefaultSpeechOptionsMappingGapBetweenNotes GapBetweenNotes_DefaultValue { get; set; }
		...
		/// </summary>
		public MomentumSeriesSonificationDefaultSpeechOptionsMappingHighpass Highpass { get; set; }
		private MomentumSeriesSonificationDefaultSpeechOptionsMappingHighpass Highpass_DefaultValue { get; set; }
		...
		/// </summary>
		public MomentumSeriesSonificationDefaultSpeechOptionsMappingLowpass Lowpass { get; set; }
		private MomentumSeriesSonificationDefaultSpeechOptionsMappingLowpass Lowpass_DefaultValue { get; set; }
		...
		/// </summary>
		public MomentumSeriesSonificationDefaultSpeechOptionsMappingNoteDuration NoteDuration { get; set; }
		private MomentumSeriesSonificationDefaultSpeechOptionsMappingNoteDuration NoteDuration_DefaultValue { get; set; }
		...
		/// </summary>
		public MomentumSeriesSonificationDefaultSpeechOptionsMappingPan Pan { get; set; }
		private MomentumSeriesSonificationDefaultSpeechOptionsMappingPan Pan_DefaultValue { get; set; }
		...
		/// </summary>
		public MomentumSeriesSonificationDefaultSpeechOptionsMappingPitch Pitch { get; set; }
		private MomentumSeriesSonificationDefaultSpeechOptionsMappingPitch Pitch_DefaultValue { get; set; }
		...
		/// </summary>
		public MomentumSeriesSonificationDefaultSpeechOptionsMappingPlayDelay PlayDelay { get; set; }
		private MomentumSeriesSonificationDefaultSpeechOptionsMappingPlayDelay PlayDelay_DefaultValue { get; set; }
		...
		/// </summary>
		public MomentumSeriesSonificationDefaultSpeechOptionsMappingTime Time { get; set; }
		private MomentumSeriesSonificationDefaultSpeechOptionsMappingTime Time_DefaultValue { get; set; }
		...
		/// </summary>
		public MomentumSeriesSonificationDefaultSpeechOptionsMappingTremolo Tremolo { get; set; }
		private MomentumSeriesSonificationDefaultSpeechOptionsMappingTremolo Tremolo_DefaultValue { get; set; }
		 

		/// <summary>
		/// The volume of notes, from 0 to 1.
		/// </summary>
		public MomentumSeriesSonificationDefaultSpeechOptionsMappingVolume Volume { get; set; }
		private MomentumSeriesSonificationDefaultSpeechOptionsMappingVolume Volume_DefaultValue { get; set; }
