...
{
	public partial class MomentumSeriesSonificationTracks  : BaseObject
	{
		Hashtable h = new Hashtable();

		public MomentumSeriesSonificationTracks()
		{
			ActiveWhen = ActiveWhen_DefaultValue = new MomentumSeriesSonificationTracksActiveWhen();
			Instrument = Instrument_DefaultValue = null;
			InstrumentString = InstrumentString_DefaultValue = "null";
			Mapping = Mapping_DefaultValue = new MomentumSeriesSonificationTracksMapping();
			MidiName = MidiName_DefaultValue = "";
			PointGrouping = PointGrouping_DefaultValue = new MomentumSeriesSonificationTracksPointGrouping();
			RoundToMusicalNotes = RoundToMusicalNotes_DefaultValue = true;
			ShowPlayMarker = ShowPlayMarker_DefaultValue = true;
			Type = Type_DefaultValue = MomentumSeriesSonificationTracksType.Instrument;
		...
		/// </summary>
		public MomentumSeriesSonificationTracksActiveWhen ActiveWhen { get; set; }
		private MomentumSeriesSonificationTracksActiveWhen ActiveWhen_DefaultValue { get; set; }
		...
		/// </summary>
		public MomentumSeriesSonificationTracksMapping Mapping { get; set; }
		private MomentumSeriesSonificationTracksMapping Mapping_DefaultValue { get; set; }
		...
		/// </summary>
		public MomentumSeriesSonificationTracksPointGrouping PointGrouping { get; set; }
		private MomentumSeriesSonificationTracksPointGrouping PointGrouping_DefaultValue { get; set; }
		...
		/// </summary>
		public MomentumSeriesSonificationTracksType Type { get; set; }
		private MomentumSeriesSonificationTracksType Type_DefaultValue { get; set; }
