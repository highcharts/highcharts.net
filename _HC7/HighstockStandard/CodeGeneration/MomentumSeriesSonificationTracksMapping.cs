...
{
	public partial class MomentumSeriesSonificationTracksMapping  : BaseObject
	{
		Hashtable h = new Hashtable();

		public MomentumSeriesSonificationTracksMapping()
		{
			Frequency = Frequency_DefaultValue = new MomentumSeriesSonificationTracksMappingFrequency();
			GapBetweenNotes = GapBetweenNotes_DefaultValue = new MomentumSeriesSonificationTracksMappingGapBetweenNotes();
			Highpass = Highpass_DefaultValue = new MomentumSeriesSonificationTracksMappingHighpass();
			Lowpass = Lowpass_DefaultValue = new MomentumSeriesSonificationTracksMappingLowpass();
			NoteDuration = NoteDuration_DefaultValue = new MomentumSeriesSonificationTracksMappingNoteDuration();
			Pan = Pan_DefaultValue = new MomentumSeriesSonificationTracksMappingPan();
			Pitch = Pitch_DefaultValue = new MomentumSeriesSonificationTracksMappingPitch();
			PitchString = PitchString_DefaultValue = "null";
			PitchNumber = PitchNumber_DefaultValue = null;
			PlayDelay = PlayDelay_DefaultValue = new MomentumSeriesSonificationTracksMappingPlayDelay();
			Time = Time_DefaultValue = new MomentumSeriesSonificationTracksMappingTime();
			TimeString = TimeString_DefaultValue = "null";
			TimeNumber = TimeNumber_DefaultValue = null;
			Tremolo = Tremolo_DefaultValue = new MomentumSeriesSonificationTracksMappingTremolo();
			Volume = Volume_DefaultValue = new MomentumSeriesSonificationTracksMappingVolume();
		...
		/// </summary>
		public MomentumSeriesSonificationTracksMappingFrequency Frequency { get; set; }
		private MomentumSeriesSonificationTracksMappingFrequency Frequency_DefaultValue { get; set; }
		...
		/// </summary>
		public MomentumSeriesSonificationTracksMappingGapBetweenNotes GapBetweenNotes { get; set; }
		private MomentumSeriesSonificationTracksMappingGapBetweenNotes GapBetweenNotes_DefaultValue { get; set; }
		...
		/// </summary>
		public MomentumSeriesSonificationTracksMappingHighpass Highpass { get; set; }
		private MomentumSeriesSonificationTracksMappingHighpass Highpass_DefaultValue { get; set; }
		...
		/// </summary>
		public MomentumSeriesSonificationTracksMappingLowpass Lowpass { get; set; }
		private MomentumSeriesSonificationTracksMappingLowpass Lowpass_DefaultValue { get; set; }
		...
		/// </summary>
		public MomentumSeriesSonificationTracksMappingNoteDuration NoteDuration { get; set; }
		private MomentumSeriesSonificationTracksMappingNoteDuration NoteDuration_DefaultValue { get; set; }
		...
		/// </summary>
		public MomentumSeriesSonificationTracksMappingPan Pan { get; set; }
		private MomentumSeriesSonificationTracksMappingPan Pan_DefaultValue { get; set; }
		...
		/// </summary>
		public MomentumSeriesSonificationTracksMappingPitch Pitch { get; set; }
		private MomentumSeriesSonificationTracksMappingPitch Pitch_DefaultValue { get; set; }
		...
		/// </summary>
		public MomentumSeriesSonificationTracksMappingPlayDelay PlayDelay { get; set; }
		private MomentumSeriesSonificationTracksMappingPlayDelay PlayDelay_DefaultValue { get; set; }
		...
		/// </summary>
		public MomentumSeriesSonificationTracksMappingTime Time { get; set; }
		private MomentumSeriesSonificationTracksMappingTime Time_DefaultValue { get; set; }
		...
		/// </summary>
		public MomentumSeriesSonificationTracksMappingTremolo Tremolo { get; set; }
		private MomentumSeriesSonificationTracksMappingTremolo Tremolo_DefaultValue { get; set; }
		 

		/// <summary>
		/// The volume of notes, from 0 to 1.
		/// </summary>
		public MomentumSeriesSonificationTracksMappingVolume Volume { get; set; }
		private MomentumSeriesSonificationTracksMappingVolume Volume_DefaultValue { get; set; }
