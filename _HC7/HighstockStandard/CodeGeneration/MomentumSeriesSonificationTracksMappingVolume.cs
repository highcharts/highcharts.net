...
{
	public partial class MomentumSeriesSonificationTracksMappingVolume  : BaseObject
	{
		Hashtable h = new Hashtable();

		public MomentumSeriesSonificationTracksMappingVolume()
		{
			MapFunction = MapFunction_DefaultValue = MomentumSeriesSonificationTracksMappingVolumeMapFunction.Linear;
			MapTo = MapTo_DefaultValue = "";
			Max = Max_DefaultValue = null;
			Min = Min_DefaultValue = null;
			Value = Value_DefaultValue = null;
			Within = Within_DefaultValue = MomentumSeriesSonificationTracksMappingVolumeWithin.Chart;
		...
		/// </summary>
		public MomentumSeriesSonificationTracksMappingVolumeMapFunction MapFunction { get; set; }
		private MomentumSeriesSonificationTracksMappingVolumeMapFunction MapFunction_DefaultValue { get; set; }
		...
		/// </summary>
		public MomentumSeriesSonificationTracksMappingVolumeWithin Within { get; set; }
		private MomentumSeriesSonificationTracksMappingVolumeWithin Within_DefaultValue { get; set; }
