...
{
	public partial class MomentumSeriesSonificationTracksPointGrouping  : BaseObject
	{
		Hashtable h = new Hashtable();

		public MomentumSeriesSonificationTracksPointGrouping()
		{
			Algorithm = Algorithm_DefaultValue = MomentumSeriesSonificationTracksPointGroupingAlgorithm.Minimax;
		...
		/// </summary>
		public MomentumSeriesSonificationTracksPointGroupingAlgorithm Algorithm { get; set; }
		private MomentumSeriesSonificationTracksPointGroupingAlgorithm Algorithm_DefaultValue { get; set; }
