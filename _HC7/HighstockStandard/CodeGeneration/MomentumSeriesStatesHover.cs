...
{
	public partial class MomentumSeriesStatesHover  : BaseObject
	{
		Hashtable h = new Hashtable();

		public MomentumSeriesStatesHover()
		{
			Animation = Animation_DefaultValue = new Animation() { Enabled = true };
			AnimationBool = AnimationBool_DefaultValue = null;
			Enabled = Enabled_DefaultValue = true;
			Halo = Halo_DefaultValue = new MomentumSeriesStatesHoverHalo();
			LineWidth = LineWidth_DefaultValue = null;
			LineWidthPlus = LineWidthPlus_DefaultValue = 1;
			Marker = Marker_DefaultValue = new MomentumSeriesStatesHoverMarker();
		...
		/// </summary>
		public MomentumSeriesStatesHoverHalo Halo { get; set; }
		private MomentumSeriesStatesHoverHalo Halo_DefaultValue { get; set; }
		...
		/// </summary>
		public MomentumSeriesStatesHoverMarker Marker { get; set; }
		private MomentumSeriesStatesHoverMarker Marker_DefaultValue { get; set; }
