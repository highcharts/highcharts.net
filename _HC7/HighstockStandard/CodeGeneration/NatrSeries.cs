...
namespace Highsoft.Web.Mvc.Stocks
{
	public partial class NatrSeries  : Series
	{
		public NatrSeries()
		{
			...
			DragDrop = DragDrop_DefaultValue = new NatrSeriesDragDrop();
		...
		/// </summary>
		public NatrSeriesDragDrop DragDrop { get; set; }
		private NatrSeriesDragDrop DragDrop_DefaultValue { get; set; }
