...
{
	public partial class NatrSeriesDragDropDragHandle  : BaseObject
	{
		public NatrSeriesDragDropDragHandle()
		{
		...
		internal override Hashtable ToHashtable()
		{
			...
			if (PathFormatter != PathFormatter_DefaultValue) { h.Add("pathFormatter",PathFormatter); Highstock.AddFunction("NatrSeriesDragDropDragHandlePathFormatter.pathFormatter", PathFormatter); }  
