...
{
	public partial class NatrSeriesLabel  : BaseObject
	{
		public NatrSeriesLabel()
		{
			...
			Style = Style_DefaultValue = new NatrSeriesLabelStyle();
		...
		/// </summary>
		public NatrSeriesLabelStyle Style { get; set; }
		private NatrSeriesLabelStyle Style_DefaultValue { get; set; }
