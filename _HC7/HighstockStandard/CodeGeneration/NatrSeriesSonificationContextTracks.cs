...
{
	public partial class NatrSeriesSonificationContextTracks  : BaseObject
	{
		Hashtable h = new Hashtable();

		public NatrSeriesSonificationContextTracks()
		{
			ActiveWhen = ActiveWhen_DefaultValue = new NatrSeriesSonificationContextTracksActiveWhen();
			Instrument = Instrument_DefaultValue = null;
			InstrumentString = InstrumentString_DefaultValue = "null";
			Mapping = Mapping_DefaultValue = new NatrSeriesSonificationContextTracksMapping();
			MidiName = MidiName_DefaultValue = "";
			PointGrouping = PointGrouping_DefaultValue = new NatrSeriesSonificationContextTracksPointGrouping();
			...
			Type = Type_DefaultValue = NatrSeriesSonificationContextTracksType.Instrument;
			ValueInterval = ValueInterval_DefaultValue = null;
			ValueMapFunction = ValueMapFunction_DefaultValue = NatrSeriesSonificationContextTracksValueMapFunction.Linear;
		...
		/// </summary>
		public NatrSeriesSonificationContextTracksActiveWhen ActiveWhen { get; set; }
		private NatrSeriesSonificationContextTracksActiveWhen ActiveWhen_DefaultValue { get; set; }
		...
		/// </summary>
		public NatrSeriesSonificationContextTracksMapping Mapping { get; set; }
		private NatrSeriesSonificationContextTracksMapping Mapping_DefaultValue { get; set; }
		...
		/// </summary>
		public NatrSeriesSonificationContextTracksPointGrouping PointGrouping { get; set; }
		private NatrSeriesSonificationContextTracksPointGrouping PointGrouping_DefaultValue { get; set; }
		...
		/// </summary>
		public NatrSeriesSonificationContextTracksType Type { get; set; }
		private NatrSeriesSonificationContextTracksType Type_DefaultValue { get; set; }
		...
		/// </summary>
		public NatrSeriesSonificationContextTracksValueMapFunction ValueMapFunction { get; set; }
		private NatrSeriesSonificationContextTracksValueMapFunction ValueMapFunction_DefaultValue { get; set; }
