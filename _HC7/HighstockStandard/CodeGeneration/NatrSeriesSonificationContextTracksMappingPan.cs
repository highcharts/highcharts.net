...
{
	public partial class NatrSeriesSonificationContextTracksMappingPan  : BaseObject
	{
		Hashtable h = new Hashtable();

		public NatrSeriesSonificationContextTracksMappingPan()
		{
			MapFunction = MapFunction_DefaultValue = NatrSeriesSonificationContextTracksMappingPanMapFunction.Linear;
			MapTo = MapTo_DefaultValue = "";
			Max = Max_DefaultValue = null;
			Min = Min_DefaultValue = null;
			Value = Value_DefaultValue = null;
			Within = Within_DefaultValue = NatrSeriesSonificationContextTracksMappingPanWithin.Chart;
		...
		/// </summary>
		public NatrSeriesSonificationContextTracksMappingPanMapFunction MapFunction { get; set; }
		private NatrSeriesSonificationContextTracksMappingPanMapFunction MapFunction_DefaultValue { get; set; }
		...
		/// </summary>
		public NatrSeriesSonificationContextTracksMappingPanWithin Within { get; set; }
		private NatrSeriesSonificationContextTracksMappingPanWithin Within_DefaultValue { get; set; }
