...
{
	public partial class NatrSeriesSonificationContextTracksMappingPlayDelay  : BaseObject
	{
		Hashtable h = new Hashtable();

		public NatrSeriesSonificationContextTracksMappingPlayDelay()
		{
			MapFunction = MapFunction_DefaultValue = NatrSeriesSonificationContextTracksMappingPlayDelayMapFunction.Linear;
			MapTo = MapTo_DefaultValue = "";
			Max = Max_DefaultValue = null;
			Min = Min_DefaultValue = null;
			Value = Value_DefaultValue = null;
			Within = Within_DefaultValue = NatrSeriesSonificationContextTracksMappingPlayDelayWithin.Chart;
		...
		/// </summary>
		public NatrSeriesSonificationContextTracksMappingPlayDelayMapFunction MapFunction { get; set; }
		private NatrSeriesSonificationContextTracksMappingPlayDelayMapFunction MapFunction_DefaultValue { get; set; }
		...
		/// </summary>
		public NatrSeriesSonificationContextTracksMappingPlayDelayWithin Within { get; set; }
		private NatrSeriesSonificationContextTracksMappingPlayDelayWithin Within_DefaultValue { get; set; }
