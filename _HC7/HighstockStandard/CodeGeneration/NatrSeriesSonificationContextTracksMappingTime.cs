...
{
	public partial class NatrSeriesSonificationContextTracksMappingTime  : BaseObject
	{
		Hashtable h = new Hashtable();

		public NatrSeriesSonificationContextTracksMappingTime()
		{
			MapFunction = MapFunction_DefaultValue = NatrSeriesSonificationContextTracksMappingTimeMapFunction.Linear;
			MapTo = MapTo_DefaultValue = "";
			Max = Max_DefaultValue = null;
			Min = Min_DefaultValue = null;
			Value = Value_DefaultValue = null;
			Within = Within_DefaultValue = NatrSeriesSonificationContextTracksMappingTimeWithin.Chart;
		...
		/// </summary>
		public NatrSeriesSonificationContextTracksMappingTimeMapFunction MapFunction { get; set; }
		private NatrSeriesSonificationContextTracksMappingTimeMapFunction MapFunction_DefaultValue { get; set; }
		...
		/// </summary>
		public NatrSeriesSonificationContextTracksMappingTimeWithin Within { get; set; }
		private NatrSeriesSonificationContextTracksMappingTimeWithin Within_DefaultValue { get; set; }
