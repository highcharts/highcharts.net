...
{
	public partial class NatrSeriesSonificationContextTracksPointGrouping  : BaseObject
	{
		Hashtable h = new Hashtable();

		public NatrSeriesSonificationContextTracksPointGrouping()
		{
			Algorithm = Algorithm_DefaultValue = NatrSeriesSonificationContextTracksPointGroupingAlgorithm.Minimax;
		...
		/// </summary>
		public NatrSeriesSonificationContextTracksPointGroupingAlgorithm Algorithm { get; set; }
		private NatrSeriesSonificationContextTracksPointGroupingAlgorithm Algorithm_DefaultValue { get; set; }
