...
{
	public partial class NatrSeriesSonificationPointGrouping  : BaseObject
	{
		Hashtable h = new Hashtable();

		public NatrSeriesSonificationPointGrouping()
		{
			Algorithm = Algorithm_DefaultValue = NatrSeriesSonificationPointGroupingAlgorithm.Minimax;
		...
		/// </summary>
		public NatrSeriesSonificationPointGroupingAlgorithm Algorithm { get; set; }
		private NatrSeriesSonificationPointGroupingAlgorithm Algorithm_DefaultValue { get; set; }
