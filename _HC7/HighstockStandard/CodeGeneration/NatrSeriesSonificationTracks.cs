...
{
	public partial class NatrSeriesSonificationTracks  : BaseObject
	{
		Hashtable h = new Hashtable();

		public NatrSeriesSonificationTracks()
		{
			ActiveWhen = ActiveWhen_DefaultValue = new NatrSeriesSonificationTracksActiveWhen();
			Instrument = Instrument_DefaultValue = null;
			InstrumentString = InstrumentString_DefaultValue = "null";
			Mapping = Mapping_DefaultValue = new NatrSeriesSonificationTracksMapping();
			MidiName = MidiName_DefaultValue = "";
			PointGrouping = PointGrouping_DefaultValue = new NatrSeriesSonificationTracksPointGrouping();
			RoundToMusicalNotes = RoundToMusicalNotes_DefaultValue = true;
			ShowPlayMarker = ShowPlayMarker_DefaultValue = true;
			Type = Type_DefaultValue = NatrSeriesSonificationTracksType.Instrument;
		...
		/// </summary>
		public NatrSeriesSonificationTracksActiveWhen ActiveWhen { get; set; }
		private NatrSeriesSonificationTracksActiveWhen ActiveWhen_DefaultValue { get; set; }
		...
		/// </summary>
		public NatrSeriesSonificationTracksMapping Mapping { get; set; }
		private NatrSeriesSonificationTracksMapping Mapping_DefaultValue { get; set; }
		...
		/// </summary>
		public NatrSeriesSonificationTracksPointGrouping PointGrouping { get; set; }
		private NatrSeriesSonificationTracksPointGrouping PointGrouping_DefaultValue { get; set; }
		...
		/// </summary>
		public NatrSeriesSonificationTracksType Type { get; set; }
		private NatrSeriesSonificationTracksType Type_DefaultValue { get; set; }
