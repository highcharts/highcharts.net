...
{
	public partial class NatrSeriesSonificationTracksMapping  : BaseObject
	{
		Hashtable h = new Hashtable();

		public NatrSeriesSonificationTracksMapping()
		{
			Frequency = Frequency_DefaultValue = new NatrSeriesSonificationTracksMappingFrequency();
			GapBetweenNotes = GapBetweenNotes_DefaultValue = new NatrSeriesSonificationTracksMappingGapBetweenNotes();
			Highpass = Highpass_DefaultValue = new NatrSeriesSonificationTracksMappingHighpass();
			Lowpass = Lowpass_DefaultValue = new NatrSeriesSonificationTracksMappingLowpass();
			NoteDuration = NoteDuration_DefaultValue = new NatrSeriesSonificationTracksMappingNoteDuration();
			Pan = Pan_DefaultValue = new NatrSeriesSonificationTracksMappingPan();
			Pitch = Pitch_DefaultValue = new NatrSeriesSonificationTracksMappingPitch();
			PitchString = PitchString_DefaultValue = "null";
			PitchNumber = PitchNumber_DefaultValue = null;
			PlayDelay = PlayDelay_DefaultValue = new NatrSeriesSonificationTracksMappingPlayDelay();
			Time = Time_DefaultValue = new NatrSeriesSonificationTracksMappingTime();
			TimeString = TimeString_DefaultValue = "null";
			TimeNumber = TimeNumber_DefaultValue = null;
			Tremolo = Tremolo_DefaultValue = new NatrSeriesSonificationTracksMappingTremolo();
			Volume = Volume_DefaultValue = new NatrSeriesSonificationTracksMappingVolume();
		...
		/// </summary>
		public NatrSeriesSonificationTracksMappingFrequency Frequency { get; set; }
		private NatrSeriesSonificationTracksMappingFrequency Frequency_DefaultValue { get; set; }
		...
		/// </summary>
		public NatrSeriesSonificationTracksMappingGapBetweenNotes GapBetweenNotes { get; set; }
		private NatrSeriesSonificationTracksMappingGapBetweenNotes GapBetweenNotes_DefaultValue { get; set; }
		...
		/// </summary>
		public NatrSeriesSonificationTracksMappingHighpass Highpass { get; set; }
		private NatrSeriesSonificationTracksMappingHighpass Highpass_DefaultValue { get; set; }
		...
		/// </summary>
		public NatrSeriesSonificationTracksMappingLowpass Lowpass { get; set; }
		private NatrSeriesSonificationTracksMappingLowpass Lowpass_DefaultValue { get; set; }
		...
		/// </summary>
		public NatrSeriesSonificationTracksMappingNoteDuration NoteDuration { get; set; }
		private NatrSeriesSonificationTracksMappingNoteDuration NoteDuration_DefaultValue { get; set; }
		...
		/// </summary>
		public NatrSeriesSonificationTracksMappingPan Pan { get; set; }
		private NatrSeriesSonificationTracksMappingPan Pan_DefaultValue { get; set; }
		...
		/// </summary>
		public NatrSeriesSonificationTracksMappingPitch Pitch { get; set; }
		private NatrSeriesSonificationTracksMappingPitch Pitch_DefaultValue { get; set; }
		...
		/// </summary>
		public NatrSeriesSonificationTracksMappingPlayDelay PlayDelay { get; set; }
		private NatrSeriesSonificationTracksMappingPlayDelay PlayDelay_DefaultValue { get; set; }
		...
		/// </summary>
		public NatrSeriesSonificationTracksMappingTime Time { get; set; }
		private NatrSeriesSonificationTracksMappingTime Time_DefaultValue { get; set; }
		...
		/// </summary>
		public NatrSeriesSonificationTracksMappingTremolo Tremolo { get; set; }
		private NatrSeriesSonificationTracksMappingTremolo Tremolo_DefaultValue { get; set; }
		 

		/// <summary>
		/// The volume of notes, from 0 to 1.
		/// </summary>
		public NatrSeriesSonificationTracksMappingVolume Volume { get; set; }
		private NatrSeriesSonificationTracksMappingVolume Volume_DefaultValue { get; set; }
