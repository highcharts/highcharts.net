...
{
	public partial class NatrSeriesSonificationTracksMappingFrequency  : BaseObject
	{
		Hashtable h = new Hashtable();

		public NatrSeriesSonificationTracksMappingFrequency()
		{
			MapFunction = MapFunction_DefaultValue = NatrSeriesSonificationTracksMappingFrequencyMapFunction.Linear;
			MapTo = MapTo_DefaultValue = "";
			Max = Max_DefaultValue = null;
			Min = Min_DefaultValue = null;
			Value = Value_DefaultValue = null;
			Within = Within_DefaultValue = NatrSeriesSonificationTracksMappingFrequencyWithin.Chart;
		...
		/// </summary>
		public NatrSeriesSonificationTracksMappingFrequencyMapFunction MapFunction { get; set; }
		private NatrSeriesSonificationTracksMappingFrequencyMapFunction MapFunction_DefaultValue { get; set; }
		...
		/// </summary>
		public NatrSeriesSonificationTracksMappingFrequencyWithin Within { get; set; }
		private NatrSeriesSonificationTracksMappingFrequencyWithin Within_DefaultValue { get; set; }
