...
{
	public partial class NatrSeriesSonificationTracksMappingNoteDuration  : BaseObject
	{
		Hashtable h = new Hashtable();

		public NatrSeriesSonificationTracksMappingNoteDuration()
		{
			MapFunction = MapFunction_DefaultValue = NatrSeriesSonificationTracksMappingNoteDurationMapFunction.Linear;
			MapTo = MapTo_DefaultValue = "";
			Max = Max_DefaultValue = null;
			Min = Min_DefaultValue = null;
			Value = Value_DefaultValue = null;
			Within = Within_DefaultValue = NatrSeriesSonificationTracksMappingNoteDurationWithin.Chart;
		...
		/// </summary>
		public NatrSeriesSonificationTracksMappingNoteDurationMapFunction MapFunction { get; set; }
		private NatrSeriesSonificationTracksMappingNoteDurationMapFunction MapFunction_DefaultValue { get; set; }
		...
		/// </summary>
		public NatrSeriesSonificationTracksMappingNoteDurationWithin Within { get; set; }
		private NatrSeriesSonificationTracksMappingNoteDurationWithin Within_DefaultValue { get; set; }
