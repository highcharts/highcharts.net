...
{
	public partial class NatrSeriesSonificationTracksMappingPan  : BaseObject
	{
		Hashtable h = new Hashtable();

		public NatrSeriesSonificationTracksMappingPan()
		{
			MapFunction = MapFunction_DefaultValue = NatrSeriesSonificationTracksMappingPanMapFunction.Linear;
			MapTo = MapTo_DefaultValue = "";
			Max = Max_DefaultValue = null;
			Min = Min_DefaultValue = null;
			Value = Value_DefaultValue = null;
			Within = Within_DefaultValue = NatrSeriesSonificationTracksMappingPanWithin.Chart;
		...
		/// </summary>
		public NatrSeriesSonificationTracksMappingPanMapFunction MapFunction { get; set; }
		private NatrSeriesSonificationTracksMappingPanMapFunction MapFunction_DefaultValue { get; set; }
		...
		/// </summary>
		public NatrSeriesSonificationTracksMappingPanWithin Within { get; set; }
		private NatrSeriesSonificationTracksMappingPanWithin Within_DefaultValue { get; set; }
