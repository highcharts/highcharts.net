...
{
	public partial class NatrSeriesSonificationTracksMappingPitch  : BaseObject
	{
		Hashtable h = new Hashtable();

		public NatrSeriesSonificationTracksMappingPitch()
		{
			MapFunction = MapFunction_DefaultValue = NatrSeriesSonificationTracksMappingPitchMapFunction.Linear;
		...
		/// </summary>
		public NatrSeriesSonificationTracksMappingPitchMapFunction MapFunction { get; set; }
		private NatrSeriesSonificationTracksMappingPitchMapFunction MapFunction_DefaultValue { get; set; }
