...
{
	public partial class NatrSeriesSonificationTracksMappingPlayDelay  : BaseObject
	{
		Hashtable h = new Hashtable();

		public NatrSeriesSonificationTracksMappingPlayDelay()
		{
			MapFunction = MapFunction_DefaultValue = NatrSeriesSonificationTracksMappingPlayDelayMapFunction.Linear;
			MapTo = MapTo_DefaultValue = "";
			Max = Max_DefaultValue = null;
			Min = Min_DefaultValue = null;
			Value = Value_DefaultValue = null;
			Within = Within_DefaultValue = NatrSeriesSonificationTracksMappingPlayDelayWithin.Chart;
		...
		/// </summary>
		public NatrSeriesSonificationTracksMappingPlayDelayMapFunction MapFunction { get; set; }
		private NatrSeriesSonificationTracksMappingPlayDelayMapFunction MapFunction_DefaultValue { get; set; }
		...
		/// </summary>
		public NatrSeriesSonificationTracksMappingPlayDelayWithin Within { get; set; }
		private NatrSeriesSonificationTracksMappingPlayDelayWithin Within_DefaultValue { get; set; }
