...
{
	public partial class NatrSeriesSonificationTracksMappingTime  : BaseObject
	{
		Hashtable h = new Hashtable();

		public NatrSeriesSonificationTracksMappingTime()
		{
			MapFunction = MapFunction_DefaultValue = NatrSeriesSonificationTracksMappingTimeMapFunction.Linear;
			MapTo = MapTo_DefaultValue = "";
			Max = Max_DefaultValue = null;
			Min = Min_DefaultValue = null;
			Value = Value_DefaultValue = null;
			Within = Within_DefaultValue = NatrSeriesSonificationTracksMappingTimeWithin.Chart;
		...
		/// </summary>
		public NatrSeriesSonificationTracksMappingTimeMapFunction MapFunction { get; set; }
		private NatrSeriesSonificationTracksMappingTimeMapFunction MapFunction_DefaultValue { get; set; }
		...
		/// </summary>
		public NatrSeriesSonificationTracksMappingTimeWithin Within { get; set; }
		private NatrSeriesSonificationTracksMappingTimeWithin Within_DefaultValue { get; set; }
