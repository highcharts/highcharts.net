...
{
	public partial class NatrSeriesSonificationTracksMappingTremoloSpeed  : BaseObject
	{
		Hashtable h = new Hashtable();

		public NatrSeriesSonificationTracksMappingTremoloSpeed()
		{
			MapFunction = MapFunction_DefaultValue = NatrSeriesSonificationTracksMappingTremoloSpeedMapFunction.Linear;
			MapTo = MapTo_DefaultValue = "";
			Max = Max_DefaultValue = null;
			Min = Min_DefaultValue = null;
			Value = Value_DefaultValue = null;
			Within = Within_DefaultValue = NatrSeriesSonificationTracksMappingTremoloSpeedWithin.Chart;
		...
		/// </summary>
		public NatrSeriesSonificationTracksMappingTremoloSpeedMapFunction MapFunction { get; set; }
		private NatrSeriesSonificationTracksMappingTremoloSpeedMapFunction MapFunction_DefaultValue { get; set; }
		...
		/// </summary>
		public NatrSeriesSonificationTracksMappingTremoloSpeedWithin Within { get; set; }
		private NatrSeriesSonificationTracksMappingTremoloSpeedWithin Within_DefaultValue { get; set; }
