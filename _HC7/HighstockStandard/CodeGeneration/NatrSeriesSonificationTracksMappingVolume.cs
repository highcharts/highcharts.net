...
{
	public partial class NatrSeriesSonificationTracksMappingVolume  : BaseObject
	{
		Hashtable h = new Hashtable();

		public NatrSeriesSonificationTracksMappingVolume()
		{
			MapFunction = MapFunction_DefaultValue = NatrSeriesSonificationTracksMappingVolumeMapFunction.Linear;
			MapTo = MapTo_DefaultValue = "";
			Max = Max_DefaultValue = null;
			Min = Min_DefaultValue = null;
			Value = Value_DefaultValue = null;
			Within = Within_DefaultValue = NatrSeriesSonificationTracksMappingVolumeWithin.Chart;
		...
		/// </summary>
		public NatrSeriesSonificationTracksMappingVolumeMapFunction MapFunction { get; set; }
		private NatrSeriesSonificationTracksMappingVolumeMapFunction MapFunction_DefaultValue { get; set; }
		...
		/// </summary>
		public NatrSeriesSonificationTracksMappingVolumeWithin Within { get; set; }
		private NatrSeriesSonificationTracksMappingVolumeWithin Within_DefaultValue { get; set; }
