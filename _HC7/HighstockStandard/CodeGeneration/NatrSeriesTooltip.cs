...
{
	public partial class NatrSeriesTooltip  : BaseObject
	{
		public NatrSeriesTooltip()
		{
			...
			HeaderShape = HeaderShape_DefaultValue = NatrSeriesTooltipHeaderShape.Callout;
		...
		/// </summary>
		public NatrSeriesTooltipHeaderShape HeaderShape { get; set; }
		private NatrSeriesTooltipHeaderShape HeaderShape_DefaultValue { get; set; }
		...
		internal override Hashtable ToHashtable()
		{
			...
			if (NullFormatter != NullFormatter_DefaultValue) { h.Add("nullFormatter",NullFormatter); Highstock.AddFunction("NatrSeriesTooltipNullFormatter.nullFormatter", NullFormatter); }  
			if (Outside != Outside_DefaultValue) h.Add("outside",Outside);
			if (Padding != Padding_DefaultValue) h.Add("padding",Padding);
			if (PointFormat != PointFormat_DefaultValue) h.Add("pointFormat",PointFormat);
			if (PointFormatter != PointFormatter_DefaultValue) { h.Add("pointFormatter",PointFormatter); Highstock.AddFunction("NatrSeriesTooltipPointFormatter.pointFormatter", PointFormatter); }  
