...
namespace Highsoft.Web.Mvc.Stocks
{
	public partial class NavigationAnnotationsOptionsFibonacciTimeZonesShapeOptions  : BaseObject
	{
		...
		{
			if (DashStyle != NavigationAnnotationsOptionsFibonacciTimeZonesShapeOptionsDashStyle.Null) h.Add("dashStyle", highstock.FirstCharacterToLower(DashStyle.ToString()));
