...
namespace Highsoft.Web.Mvc.Stocks
{
	public partial class NavigationAnnotationsOptionsLabelOptions  : BaseObject
	{
		...
		internal override Hashtable ToHashtable(Highstock highstock)
		{
			...
			if (Align != NavigationAnnotationsOptionsLabelOptionsAlign.Null) h.Add("align", highstock.FirstCharacterToLower(Align.ToString()));
			...
			if (Overflow != NavigationAnnotationsOptionsLabelOptionsOverflow.Null) h.Add("overflow", highstock.FirstCharacterToLower(Overflow.ToString()));
			...
			if (VerticalAlign != NavigationAnnotationsOptionsLabelOptionsVerticalAlign.Null) h.Add("verticalAlign", highstock.FirstCharacterToLower(VerticalAlign.ToString()));
			if (X != null) h.Add("x",X);
			if (Y != null) h.Add("y",Y);
