...
namespace Highsoft.Web.Mvc.Stocks
{
	public partial class NavigationAnnotationsOptionsShapes  : BaseObject
	{
		...
		{
			if (DashStyle != NavigationAnnotationsOptionsShapesDashStyle.Null) h.Add("dashStyle", highstock.FirstCharacterToLower(DashStyle.ToString()));
			...
			if (Points != null) h.Add("points",Points.ToHashtable(highstock));
			if (R != null) h.Add("r",R);
