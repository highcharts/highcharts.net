...
{
	public partial class NavigationAnnotationsOptionsTimeCyclesShapeOptions  : BaseObject
	{
		Hashtable h = new Hashtable();

		public NavigationAnnotationsOptionsTimeCyclesShapeOptions()
		{
			DashStyle = DashStyle_DefaultValue = NavigationAnnotationsOptionsTimeCyclesShapeOptionsDashStyle.Null;
		...
		/// </summary>
		public NavigationAnnotationsOptionsTimeCyclesShapeOptionsDashStyle DashStyle { get; set; }
		private NavigationAnnotationsOptionsTimeCyclesShapeOptionsDashStyle DashStyle_DefaultValue { get; set; }
