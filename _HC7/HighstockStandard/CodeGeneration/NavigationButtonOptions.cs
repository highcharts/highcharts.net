...
namespace Highsoft.Web.Mvc.Stocks
{
	public partial class NavigationButtonOptions  : BaseObject
	{
		...
		{
			if (Align != NavigationButtonOptionsAlign.Null) h.Add("align", highstock.FirstCharacterToLower(Align.ToString()));
			...
			if (VerticalAlign != NavigationButtonOptionsVerticalAlign.Null) h.Add("verticalAlign", highstock.FirstCharacterToLower(VerticalAlign.ToString()));
