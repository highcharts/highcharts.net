...
namespace Highsoft.Web.Mvc.Stocks
{
	public partial class NavigatorXAxis  : BaseObject
	{
		...
		/// </summary>
		public NavigatorXAxisAccessibility Accessibility { get; set; }
		...
		internal override Hashtable ToHashtable(Highstock highstock)
		{
			...
			if (MinorTickPosition != NavigatorXAxisMinorTickPosition.Null) h.Add("minorTickPosition", highstock.FirstCharacterToLower(MinorTickPosition.ToString()));
			...
			if (TickPosition != NavigatorXAxisTickPosition.Null) h.Add("tickPosition", highstock.FirstCharacterToLower(TickPosition.ToString()));
