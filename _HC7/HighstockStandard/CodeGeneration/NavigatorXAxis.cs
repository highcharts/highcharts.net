...
namespace Highsoft.Web.Mvc.Stocks
{
	public partial class NavigatorXAxis  : BaseObject
	{
		...
		{
			Accessibility = Accessibility_DefaultValue = new NavigatorXAxisAccessibility();
		...
		private NavigatorXAxisAccessibility Accessibility_DefaultValue { get; set; }
		...
		/// </summary>
		public NavigatorXAxisTickWidth TickWidth { get; set; }
		private NavigatorXAxisTickWidth TickWidth_DefaultValue { get; set; }
