...
{
	public partial class NavigatorXAxisPlotLines  : BaseObject
	{
		Hashtable h = new Hashtable();

		public NavigatorXAxisPlotLines()
		{
			AcrossPanes = AcrossPanes_DefaultValue = true;
			ClassName = ClassName_DefaultValue = "";
			Color = Color_DefaultValue = "#999999";
			DashStyle = DashStyle_DefaultValue = NavigatorXAxisPlotLinesDashStyle.Null;
			Events = Events_DefaultValue = null;
			Id = Id_DefaultValue = "";
			Label = Label_DefaultValue = new NavigatorXAxisPlotLinesLabel();
			Labels = Labels_DefaultValue = new NavigatorXAxisPlotLinesLabels();
		...
		/// </summary>
		public NavigatorXAxisPlotLinesDashStyle DashStyle { get; set; }
		private NavigatorXAxisPlotLinesDashStyle DashStyle_DefaultValue { get; set; }
		...
		/// </summary>
		public NavigatorXAxisPlotLinesLabel Label { get; set; }
		private NavigatorXAxisPlotLinesLabel Label_DefaultValue { get; set; }
		 

		/// <summary>
		/// 
		/// </summary>
		public NavigatorXAxisPlotLinesLabels Labels { get; set; }
		private NavigatorXAxisPlotLinesLabels Labels_DefaultValue { get; set; }
