...
{
	public partial class NavigatorXAxisPlotLinesLabel  : BaseObject
	{
		Hashtable h = new Hashtable();

		public NavigatorXAxisPlotLinesLabel()
		{
		}	
		...
		/// </summary>
		public NavigatorXAxisPlotLinesLabelAlign Align { get; set; }
		...
		/// </summary>
		public NavigatorXAxisPlotLinesLabelTextAlign TextAlign { get; set; }
		...
		/// </summary>
		public NavigatorXAxisPlotLinesLabelVerticalAlign VerticalAlign { get; set; }
		...
		{
			if (Align != NavigatorXAxisPlotLinesLabelAlign.Null) h.Add("align", highstock.FirstCharacterToLower(Align.ToString()));
			...
			if (TextAlign != NavigatorXAxisPlotLinesLabelTextAlign.Null) h.Add("textAlign", highstock.FirstCharacterToLower(TextAlign.ToString()));
			if (UseHTML != null) h.Add("useHTML",UseHTML);
			if (VerticalAlign != NavigatorXAxisPlotLinesLabelVerticalAlign.Null) h.Add("verticalAlign", highstock.FirstCharacterToLower(VerticalAlign.ToString()));
			if (X != null) h.Add("x",X);
			if (Y != null) h.Add("y",Y);
