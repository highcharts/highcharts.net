...
namespace Highsoft.Web.Mvc.Stocks
{
	public partial class NavigatorXAxisPlotLinesLabel  : BaseObject
	{
		...
		{
			Align = Align_DefaultValue = NavigatorXAxisPlotLinesLabelAlign.Left;
		...
		private NavigatorXAxisPlotLinesLabelAlign Align_DefaultValue { get; set; }
		...
		private NavigatorXAxisPlotLinesLabelVerticalAlign VerticalAlign_DefaultValue { get; set; }
		...
		internal override Hashtable ToHashtable()
		{
			...
			if (Formatter != Formatter_DefaultValue) { h.Add("formatter",Formatter); Highstock.AddFunction("NavigatorXAxisPlotLinesLabelFormatter.formatter", Formatter); }  
