...
namespace Highsoft.Web.Mvc.Stocks
{
	public partial class NavigatorYAxis  : BaseObject
	{
		...
		/// </summary>
		public NavigatorYAxisAccessibility Accessibility { get; set; }
		...
		internal override Hashtable ToHashtable(Highstock highstock)
		{
			...
			if (MinorTickPosition != NavigatorYAxisMinorTickPosition.Null) h.Add("minorTickPosition", highstock.FirstCharacterToLower(MinorTickPosition.ToString()));
			...
			if (TickPosition != NavigatorYAxisTickPosition.Null) h.Add("tickPosition", highstock.FirstCharacterToLower(TickPosition.ToString()));
