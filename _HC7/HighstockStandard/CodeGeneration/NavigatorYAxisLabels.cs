...
namespace Highsoft.Web.Mvc.Stocks
{
	public partial class NavigatorYAxisLabels  : BaseObject
	{
		...
		{
			if (Align != NavigatorYAxisLabelsAlign.Null) h.Add("align", highstock.FirstCharacterToLower(Align.ToString()));
			...
			if (Overflow != NavigatorYAxisLabelsOverflow.Null) h.Add("overflow", highstock.FirstCharacterToLower(Overflow.ToString()));
