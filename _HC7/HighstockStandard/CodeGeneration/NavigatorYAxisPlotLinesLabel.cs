...
namespace Highsoft.Web.Mvc.Stocks
{
	public partial class NavigatorYAxisPlotLinesLabel  : BaseObject
	{
		...
		public NavigatorYAxisPlotLinesLabel()
		{
			...
			TextAlign = TextAlign_DefaultValue = NavigatorYAxisPlotLinesLabelTextAlign.Null;
			UseHTML = UseHTML_DefaultValue = false;
			VerticalAlign = VerticalAlign_DefaultValue = NavigatorYAxisPlotLinesLabelVerticalAlign.Top;
		...
		private NavigatorYAxisPlotLinesLabelTextAlign TextAlign_DefaultValue { get; set; }
		...
		private NavigatorYAxisPlotLinesLabelVerticalAlign VerticalAlign_DefaultValue { get; set; }
