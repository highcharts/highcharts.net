...
{
	public partial class NavigatorYAxisPlotLinesLabel  : BaseObject
	{
		...
		/// </summary>
		public NavigatorYAxisPlotLinesLabelTextAlign TextAlign { get; set; }
		...
		/// </summary>
		public NavigatorYAxisPlotLinesLabelVerticalAlign VerticalAlign { get; set; }
		...
		{
			if (Align != NavigatorYAxisPlotLinesLabelAlign.Null) h.Add("align", highstock.FirstCharacterToLower(Align.ToString()));
			...
			if (TextAlign != NavigatorYAxisPlotLinesLabelTextAlign.Null) h.Add("textAlign", highstock.FirstCharacterToLower(TextAlign.ToString()));
			if (UseHTML != null) h.Add("useHTML",UseHTML);
			if (VerticalAlign != NavigatorYAxisPlotLinesLabelVerticalAlign.Null) h.Add("verticalAlign", highstock.FirstCharacterToLower(VerticalAlign.ToString()));
			if (X != null) h.Add("x",X);
			if (Y != null) h.Add("y",Y);
