...
{
	public partial class ObvSeries  : Series
	{
		Hashtable h = new Hashtable();

		public ObvSeries()
		{
			Accessibility = Accessibility_DefaultValue = new ObvSeriesAccessibility();
			AllowPointSelect = AllowPointSelect_DefaultValue = false;
			Animation = Animation_DefaultValue = new Animation() { Enabled = true };
			AnimationBool = AnimationBool_DefaultValue = true;
			AnimationLimit = AnimationLimit_DefaultValue = null;
			BoostBlending = BoostBlending_DefaultValue = ObvSeriesBoostBlending.Undefined;
			...
			Compare = Compare_DefaultValue = ObvSeriesCompare.Percent;
			CompareBase = CompareBase_DefaultValue = ObvSeriesCompareBase.Min;
			...
			Cursor = Cursor_DefaultValue = ObvSeriesCursor.Null;
			Custom = Custom_DefaultValue = new Hashtable();
			DashStyle = DashStyle_DefaultValue = ObvSeriesDashStyle.Null;
			DataGrouping = DataGrouping_DefaultValue = new ObvSeriesDataGrouping();
			DataLabels = DataLabels_DefaultValue = new ObvSeriesDataLabels();
			DataSorting = DataSorting_DefaultValue = new ObvSeriesDataSorting();
			Description = Description_DefaultValue = "";
			Dumbell = Dumbell_DefaultValue = new ObvSeriesDumbell();
			EnableMouseTracking = EnableMouseTracking_DefaultValue = true;
			Events = Events_DefaultValue = new ObvSeriesEvents();
			FindNearestPointBy = FindNearestPointBy_DefaultValue = ObvSeriesFindNearestPointBy.X;
			GapSize = GapSize_DefaultValue = 0;
			GapUnit = GapUnit_DefaultValue = ObvSeriesGapUnit.Relative;
			GetExtremesFromAll = GetExtremesFromAll_DefaultValue = false;
			Id = Id_DefaultValue = "";
			InactiveOtherPoints = InactiveOtherPoints_DefaultValue = false;
			IncludeInDataExport = IncludeInDataExport_DefaultValue = null;
			Index = Index_DefaultValue = null;
			Label = Label_DefaultValue = new ObvSeriesLabel();
			LastPrice = LastPrice_DefaultValue = new ObvSeriesLastPrice();
			LastVisiblePrice = LastVisiblePrice_DefaultValue = new ObvSeriesLastVisiblePrice();
			LegendIndex = LegendIndex_DefaultValue = null;
			LegendSymbol = LegendSymbol_DefaultValue = ObvSeriesLegendSymbol.Rectangle;
			Linecap = Linecap_DefaultValue = ObvSeriesLinecap.Round;
			LineWidth = LineWidth_DefaultValue = 2;
			LinkedTo = LinkedTo_DefaultValue = "";
			Marker = Marker_DefaultValue = new ObvSeriesMarker();
			Name = Name_DefaultValue = "";
			NegativeColor = NegativeColor_DefaultValue = "";
			OnPoint = OnPoint_DefaultValue = new ObvSeriesOnPoint();
			Opacity = Opacity_DefaultValue = 1;
			Params = Params_DefaultValue = new ObvSeriesParams();
			Point = Point_DefaultValue = new ObvSeriesPoint();
			...
			Sonification = Sonification_DefaultValue = new ObvSeriesSonification();
			Stack = Stack_DefaultValue = "";
			StackNumber = StackNumber_DefaultValue = null;
			States = States_DefaultValue = new ObvSeriesStates();
			Step = Step_DefaultValue = ObvSeriesStep.Null;
			StickyTracking = StickyTracking_DefaultValue = true;
			Threshold = Threshold_DefaultValue = 0;
			Tooltip = Tooltip_DefaultValue = new ObvSeriesTooltip();
			...
			Zones = Zones_DefaultValue = new List<ObvSeriesZones>();
		...
		/// </summary>
		public ObvSeriesAccessibility Accessibility { get; set; }
		private ObvSeriesAccessibility Accessibility_DefaultValue { get; set; }
		...
		/// </summary>
		public ObvSeriesBoostBlending BoostBlending { get; set; }
		private ObvSeriesBoostBlending BoostBlending_DefaultValue { get; set; }
		...
		/// </summary>
		public ObvSeriesCompare Compare { get; set; }
		private ObvSeriesCompare Compare_DefaultValue { get; set; }
		 

		/// <summary>
		/// When [compare](#plotOptions.series.compare) is `percent`, this optiondictates whether to use 0 or 100 as the base of comparison.
		/// </summary>
		public ObvSeriesCompareBase CompareBase { get; set; }
		private ObvSeriesCompareBase CompareBase_DefaultValue { get; set; }
		...
		/// </summary>
		public ObvSeriesCursor Cursor { get; set; }
		private ObvSeriesCursor Cursor_DefaultValue { get; set; }
		...
		/// </summary>
		public ObvSeriesDashStyle DashStyle { get; set; }
		private ObvSeriesDashStyle DashStyle_DefaultValue { get; set; }
		...
		/// </summary>
		public ObvSeriesDataGrouping DataGrouping { get; set; }
		private ObvSeriesDataGrouping DataGrouping_DefaultValue { get; set; }
		...
		/// </summary>
		public ObvSeriesDataLabels DataLabels { get; set; }
		private ObvSeriesDataLabels DataLabels_DefaultValue { get; set; }
		 

		/// <summary>
		/// Options for the series data sorting.
		/// </summary>
		public ObvSeriesDataSorting DataSorting { get; set; }
		private ObvSeriesDataSorting DataSorting_DefaultValue { get; set; }
		...
		/// 
		/// </summary>
		public ObvSeriesDumbell Dumbell { get; set; }
		private ObvSeriesDumbell Dumbell_DefaultValue { get; set; }
		...
		/// </summary>
		public ObvSeriesEvents Events { get; set; }
		private ObvSeriesEvents Events_DefaultValue { get; set; }
		...
		/// </summary>
		public ObvSeriesFindNearestPointBy FindNearestPointBy { get; set; }
		private ObvSeriesFindNearestPointBy FindNearestPointBy_DefaultValue { get; set; }
		...
		/// </summary>
		public ObvSeriesLabel Label { get; set; }
		private ObvSeriesLabel Label_DefaultValue { get; set; }
		 

		/// <summary>
		/// The line marks the last price from all points.
		/// </summary>
		public ObvSeriesLastPrice LastPrice { get; set; }
		private ObvSeriesLastPrice LastPrice_DefaultValue { get; set; }
		 

		/// <summary>
		/// The line marks the last price from visible range of points.
		/// </summary>
		public ObvSeriesLastVisiblePrice LastVisiblePrice { get; set; }
		private ObvSeriesLastVisiblePrice LastVisiblePrice_DefaultValue { get; set; }
		...
		/// </summary>
		public ObvSeriesLegendSymbol LegendSymbol { get; set; }
		private ObvSeriesLegendSymbol LegendSymbol_DefaultValue { get; set; }
		 

		/// <summary>
		/// The line cap used for line ends and line joins on the graph.
		/// </summary>
		public ObvSeriesLinecap Linecap { get; set; }
		private ObvSeriesLinecap Linecap_DefaultValue { get; set; }
		...
		/// </summary>
		public ObvSeriesMarker Marker { get; set; }
		private ObvSeriesMarker Marker_DefaultValue { get; set; }
		...
		/// </summary>
		public ObvSeriesOnPoint OnPoint { get; set; }
		private ObvSeriesOnPoint OnPoint_DefaultValue { get; set; }
		...
		/// </summary>
		public ObvSeriesParams Params { get; set; }
		private ObvSeriesParams Params_DefaultValue { get; set; }
		 

		/// <summary>
		/// Properties for each single point.
		/// </summary>
		public ObvSeriesPoint Point { get; set; }
		private ObvSeriesPoint Point_DefaultValue { get; set; }
		...
		/// </summary>
		public ObvSeriesSonification Sonification { get; set; }
		private ObvSeriesSonification Sonification_DefaultValue { get; set; }
		...
		/// 
		/// </summary>
		public ObvSeriesStates States { get; set; }
		private ObvSeriesStates States_DefaultValue { get; set; }
		 

		/// <summary>
		/// Whether to apply steps to the line. Possible values are `left`,`center` and `right`.
		/// </summary>
		public ObvSeriesStep Step { get; set; }
		private ObvSeriesStep Step_DefaultValue { get; set; }
		...
		/// </summary>
		public ObvSeriesTooltip Tooltip { get; set; }
		private ObvSeriesTooltip Tooltip_DefaultValue { get; set; }
		...
		/// </summary>
		public List<ObvSeriesZones> Zones { get; set; }
		private List<ObvSeriesZones> Zones_DefaultValue { get; set; }
