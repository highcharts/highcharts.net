...
{
	public partial class ObvSeriesLastPriceLabel  : BaseObject
	{
		Hashtable h = new Hashtable();

		public ObvSeriesLastPriceLabel()
		{
			Align = Align_DefaultValue = ObvSeriesLastPriceLabelAlign.Null;
		...
		/// 
		/// </summary>
		public ObvSeriesLastPriceLabelAlign Align { get; set; }
		private ObvSeriesLastPriceLabelAlign Align_DefaultValue { get; set; }
