...
{
	public partial class ObvSeriesSonificationContextTracks  : BaseObject
	{
		Hashtable h = new Hashtable();

		public ObvSeriesSonificationContextTracks()
		{
			ActiveWhen = ActiveWhen_DefaultValue = new ObvSeriesSonificationContextTracksActiveWhen();
			Instrument = Instrument_DefaultValue = null;
			InstrumentString = InstrumentString_DefaultValue = "null";
			Mapping = Mapping_DefaultValue = new ObvSeriesSonificationContextTracksMapping();
			MidiName = MidiName_DefaultValue = "";
			PointGrouping = PointGrouping_DefaultValue = new ObvSeriesSonificationContextTracksPointGrouping();
			...
			Type = Type_DefaultValue = ObvSeriesSonificationContextTracksType.Instrument;
			ValueInterval = ValueInterval_DefaultValue = null;
			ValueMapFunction = ValueMapFunction_DefaultValue = ObvSeriesSonificationContextTracksValueMapFunction.Linear;
		...
		/// </summary>
		public ObvSeriesSonificationContextTracksActiveWhen ActiveWhen { get; set; }
		private ObvSeriesSonificationContextTracksActiveWhen ActiveWhen_DefaultValue { get; set; }
		...
		/// </summary>
		public ObvSeriesSonificationContextTracksMapping Mapping { get; set; }
		private ObvSeriesSonificationContextTracksMapping Mapping_DefaultValue { get; set; }
		...
		/// </summary>
		public ObvSeriesSonificationContextTracksPointGrouping PointGrouping { get; set; }
		private ObvSeriesSonificationContextTracksPointGrouping PointGrouping_DefaultValue { get; set; }
		...
		/// </summary>
		public ObvSeriesSonificationContextTracksType Type { get; set; }
		private ObvSeriesSonificationContextTracksType Type_DefaultValue { get; set; }
		...
		/// </summary>
		public ObvSeriesSonificationContextTracksValueMapFunction ValueMapFunction { get; set; }
		private ObvSeriesSonificationContextTracksValueMapFunction ValueMapFunction_DefaultValue { get; set; }
