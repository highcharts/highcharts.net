...
{
	public partial class ObvSeriesSonificationContextTracksMappingGapBetweenNotes  : BaseObject
	{
		Hashtable h = new Hashtable();

		public ObvSeriesSonificationContextTracksMappingGapBetweenNotes()
		{
			MapFunction = MapFunction_DefaultValue = ObvSeriesSonificationContextTracksMappingGapBetweenNotesMapFunction.Linear;
			MapTo = MapTo_DefaultValue = "";
			Max = Max_DefaultValue = null;
			Min = Min_DefaultValue = null;
			Value = Value_DefaultValue = null;
			Within = Within_DefaultValue = ObvSeriesSonificationContextTracksMappingGapBetweenNotesWithin.Chart;
		...
		/// </summary>
		public ObvSeriesSonificationContextTracksMappingGapBetweenNotesMapFunction MapFunction { get; set; }
		private ObvSeriesSonificationContextTracksMappingGapBetweenNotesMapFunction MapFunction_DefaultValue { get; set; }
		...
		/// </summary>
		public ObvSeriesSonificationContextTracksMappingGapBetweenNotesWithin Within { get; set; }
		private ObvSeriesSonificationContextTracksMappingGapBetweenNotesWithin Within_DefaultValue { get; set; }
