...
{
	public partial class ObvSeriesSonificationContextTracksMappingLowpassResonance  : BaseObject
	{
		Hashtable h = new Hashtable();

		public ObvSeriesSonificationContextTracksMappingLowpassResonance()
		{
			MapFunction = MapFunction_DefaultValue = ObvSeriesSonificationContextTracksMappingLowpassResonanceMapFunction.Linear;
			MapTo = MapTo_DefaultValue = "";
			Max = Max_DefaultValue = null;
			Min = Min_DefaultValue = null;
			Value = Value_DefaultValue = null;
			Within = Within_DefaultValue = ObvSeriesSonificationContextTracksMappingLowpassResonanceWithin.Chart;
		...
		/// </summary>
		public ObvSeriesSonificationContextTracksMappingLowpassResonanceMapFunction MapFunction { get; set; }
		private ObvSeriesSonificationContextTracksMappingLowpassResonanceMapFunction MapFunction_DefaultValue { get; set; }
		...
		/// </summary>
		public ObvSeriesSonificationContextTracksMappingLowpassResonanceWithin Within { get; set; }
		private ObvSeriesSonificationContextTracksMappingLowpassResonanceWithin Within_DefaultValue { get; set; }
