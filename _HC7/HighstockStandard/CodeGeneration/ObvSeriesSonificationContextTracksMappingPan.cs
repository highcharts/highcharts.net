...
{
	public partial class ObvSeriesSonificationContextTracksMappingPan  : BaseObject
	{
		Hashtable h = new Hashtable();

		public ObvSeriesSonificationContextTracksMappingPan()
		{
			MapFunction = MapFunction_DefaultValue = ObvSeriesSonificationContextTracksMappingPanMapFunction.Linear;
			MapTo = MapTo_DefaultValue = "";
			Max = Max_DefaultValue = null;
			Min = Min_DefaultValue = null;
			Value = Value_DefaultValue = null;
			Within = Within_DefaultValue = ObvSeriesSonificationContextTracksMappingPanWithin.Chart;
		...
		/// </summary>
		public ObvSeriesSonificationContextTracksMappingPanMapFunction MapFunction { get; set; }
		private ObvSeriesSonificationContextTracksMappingPanMapFunction MapFunction_DefaultValue { get; set; }
		...
		/// </summary>
		public ObvSeriesSonificationContextTracksMappingPanWithin Within { get; set; }
		private ObvSeriesSonificationContextTracksMappingPanWithin Within_DefaultValue { get; set; }
