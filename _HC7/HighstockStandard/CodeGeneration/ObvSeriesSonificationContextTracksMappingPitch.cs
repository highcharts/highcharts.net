...
{
	public partial class ObvSeriesSonificationContextTracksMappingPitch  : BaseObject
	{
		Hashtable h = new Hashtable();

		public ObvSeriesSonificationContextTracksMappingPitch()
		{
			MapFunction = MapFunction_DefaultValue = ObvSeriesSonificationContextTracksMappingPitchMapFunction.Linear;
		...
		/// </summary>
		public ObvSeriesSonificationContextTracksMappingPitchMapFunction MapFunction { get; set; }
		private ObvSeriesSonificationContextTracksMappingPitchMapFunction MapFunction_DefaultValue { get; set; }
