...
{
	public partial class ObvSeriesSonificationContextTracksMappingPlayDelay  : BaseObject
	{
		Hashtable h = new Hashtable();

		public ObvSeriesSonificationContextTracksMappingPlayDelay()
		{
			MapFunction = MapFunction_DefaultValue = ObvSeriesSonificationContextTracksMappingPlayDelayMapFunction.Linear;
			MapTo = MapTo_DefaultValue = "";
			Max = Max_DefaultValue = null;
			Min = Min_DefaultValue = null;
			Value = Value_DefaultValue = null;
			Within = Within_DefaultValue = ObvSeriesSonificationContextTracksMappingPlayDelayWithin.Chart;
		...
		/// </summary>
		public ObvSeriesSonificationContextTracksMappingPlayDelayMapFunction MapFunction { get; set; }
		private ObvSeriesSonificationContextTracksMappingPlayDelayMapFunction MapFunction_DefaultValue { get; set; }
		...
		/// </summary>
		public ObvSeriesSonificationContextTracksMappingPlayDelayWithin Within { get; set; }
		private ObvSeriesSonificationContextTracksMappingPlayDelayWithin Within_DefaultValue { get; set; }
