...
{
	public partial class ObvSeriesSonificationContextTracksMappingTime  : BaseObject
	{
		Hashtable h = new Hashtable();

		public ObvSeriesSonificationContextTracksMappingTime()
		{
			MapFunction = MapFunction_DefaultValue = ObvSeriesSonificationContextTracksMappingTimeMapFunction.Linear;
			MapTo = MapTo_DefaultValue = "";
			Max = Max_DefaultValue = null;
			Min = Min_DefaultValue = null;
			Value = Value_DefaultValue = null;
			Within = Within_DefaultValue = ObvSeriesSonificationContextTracksMappingTimeWithin.Chart;
		...
		/// </summary>
		public ObvSeriesSonificationContextTracksMappingTimeMapFunction MapFunction { get; set; }
		private ObvSeriesSonificationContextTracksMappingTimeMapFunction MapFunction_DefaultValue { get; set; }
		...
		/// </summary>
		public ObvSeriesSonificationContextTracksMappingTimeWithin Within { get; set; }
		private ObvSeriesSonificationContextTracksMappingTimeWithin Within_DefaultValue { get; set; }
