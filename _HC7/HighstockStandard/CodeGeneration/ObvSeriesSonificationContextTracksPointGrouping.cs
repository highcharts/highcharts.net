...
{
	public partial class ObvSeriesSonificationContextTracksPointGrouping  : BaseObject
	{
		Hashtable h = new Hashtable();

		public ObvSeriesSonificationContextTracksPointGrouping()
		{
			Algorithm = Algorithm_DefaultValue = ObvSeriesSonificationContextTracksPointGroupingAlgorithm.Minimax;
		...
		/// </summary>
		public ObvSeriesSonificationContextTracksPointGroupingAlgorithm Algorithm { get; set; }
		private ObvSeriesSonificationContextTracksPointGroupingAlgorithm Algorithm_DefaultValue { get; set; }
