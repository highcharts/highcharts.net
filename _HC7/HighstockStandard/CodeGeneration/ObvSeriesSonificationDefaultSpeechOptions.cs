...
namespace Highsoft.Web.Mvc.Stocks
{
	public partial class ObvSeriesSonificationDefaultSpeechOptions  : BaseObject
	{
		...
		public ObvSeriesSonificationDefaultSpeechOptions()
		{
			...
			Type = Type_DefaultValue = ObvSeriesSonificationDefaultSpeechOptionsType.Instrument;
		...
		/// </summary>
		public ObvSeriesSonificationDefaultSpeechOptionsType Type { get; set; }
		private ObvSeriesSonificationDefaultSpeechOptionsType Type_DefaultValue { get; set; }
