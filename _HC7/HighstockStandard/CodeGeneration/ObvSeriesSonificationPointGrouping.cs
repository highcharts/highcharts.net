...
{
	public partial class ObvSeriesSonificationPointGrouping  : BaseObject
	{
		Hashtable h = new Hashtable();

		public ObvSeriesSonificationPointGrouping()
		{
			Algorithm = Algorithm_DefaultValue = ObvSeriesSonificationPointGroupingAlgorithm.Minimax;
		...
		/// </summary>
		public ObvSeriesSonificationPointGroupingAlgorithm Algorithm { get; set; }
		private ObvSeriesSonificationPointGroupingAlgorithm Algorithm_DefaultValue { get; set; }
