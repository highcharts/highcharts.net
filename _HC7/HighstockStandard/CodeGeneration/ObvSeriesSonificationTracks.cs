...
{
	public partial class ObvSeriesSonificationTracks  : BaseObject
	{
		Hashtable h = new Hashtable();

		public ObvSeriesSonificationTracks()
		{
			ActiveWhen = ActiveWhen_DefaultValue = new ObvSeriesSonificationTracksActiveWhen();
			Instrument = Instrument_DefaultValue = null;
			InstrumentString = InstrumentString_DefaultValue = "null";
			Mapping = Mapping_DefaultValue = new ObvSeriesSonificationTracksMapping();
			MidiName = MidiName_DefaultValue = "";
			PointGrouping = PointGrouping_DefaultValue = new ObvSeriesSonificationTracksPointGrouping();
			RoundToMusicalNotes = RoundToMusicalNotes_DefaultValue = true;
			ShowPlayMarker = ShowPlayMarker_DefaultValue = true;
			Type = Type_DefaultValue = ObvSeriesSonificationTracksType.Instrument;
		...
		/// </summary>
		public ObvSeriesSonificationTracksActiveWhen ActiveWhen { get; set; }
		private ObvSeriesSonificationTracksActiveWhen ActiveWhen_DefaultValue { get; set; }
		...
		/// </summary>
		public ObvSeriesSonificationTracksMapping Mapping { get; set; }
		private ObvSeriesSonificationTracksMapping Mapping_DefaultValue { get; set; }
		...
		/// </summary>
		public ObvSeriesSonificationTracksPointGrouping PointGrouping { get; set; }
		private ObvSeriesSonificationTracksPointGrouping PointGrouping_DefaultValue { get; set; }
		...
		/// </summary>
		public ObvSeriesSonificationTracksType Type { get; set; }
		private ObvSeriesSonificationTracksType Type_DefaultValue { get; set; }
