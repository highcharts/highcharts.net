...
{
	public partial class ObvSeriesSonificationTracksMapping  : BaseObject
	{
		Hashtable h = new Hashtable();

		public ObvSeriesSonificationTracksMapping()
		{
			Frequency = Frequency_DefaultValue = new ObvSeriesSonificationTracksMappingFrequency();
			GapBetweenNotes = GapBetweenNotes_DefaultValue = new ObvSeriesSonificationTracksMappingGapBetweenNotes();
			Highpass = Highpass_DefaultValue = new ObvSeriesSonificationTracksMappingHighpass();
			Lowpass = Lowpass_DefaultValue = new ObvSeriesSonificationTracksMappingLowpass();
			NoteDuration = NoteDuration_DefaultValue = new ObvSeriesSonificationTracksMappingNoteDuration();
			Pan = Pan_DefaultValue = new ObvSeriesSonificationTracksMappingPan();
			Pitch = Pitch_DefaultValue = new ObvSeriesSonificationTracksMappingPitch();
			PitchString = PitchString_DefaultValue = "null";
			PitchNumber = PitchNumber_DefaultValue = null;
			PlayDelay = PlayDelay_DefaultValue = new ObvSeriesSonificationTracksMappingPlayDelay();
			Time = Time_DefaultValue = new ObvSeriesSonificationTracksMappingTime();
			TimeString = TimeString_DefaultValue = "null";
			TimeNumber = TimeNumber_DefaultValue = null;
			Tremolo = Tremolo_DefaultValue = new ObvSeriesSonificationTracksMappingTremolo();
			Volume = Volume_DefaultValue = new ObvSeriesSonificationTracksMappingVolume();
		...
		/// </summary>
		public ObvSeriesSonificationTracksMappingFrequency Frequency { get; set; }
		private ObvSeriesSonificationTracksMappingFrequency Frequency_DefaultValue { get; set; }
		...
		/// </summary>
		public ObvSeriesSonificationTracksMappingGapBetweenNotes GapBetweenNotes { get; set; }
		private ObvSeriesSonificationTracksMappingGapBetweenNotes GapBetweenNotes_DefaultValue { get; set; }
		...
		/// </summary>
		public ObvSeriesSonificationTracksMappingHighpass Highpass { get; set; }
		private ObvSeriesSonificationTracksMappingHighpass Highpass_DefaultValue { get; set; }
		...
		/// </summary>
		public ObvSeriesSonificationTracksMappingLowpass Lowpass { get; set; }
		private ObvSeriesSonificationTracksMappingLowpass Lowpass_DefaultValue { get; set; }
		...
		/// </summary>
		public ObvSeriesSonificationTracksMappingNoteDuration NoteDuration { get; set; }
		private ObvSeriesSonificationTracksMappingNoteDuration NoteDuration_DefaultValue { get; set; }
		...
		/// </summary>
		public ObvSeriesSonificationTracksMappingPan Pan { get; set; }
		private ObvSeriesSonificationTracksMappingPan Pan_DefaultValue { get; set; }
		...
		/// </summary>
		public ObvSeriesSonificationTracksMappingPitch Pitch { get; set; }
		private ObvSeriesSonificationTracksMappingPitch Pitch_DefaultValue { get; set; }
		...
		/// </summary>
		public ObvSeriesSonificationTracksMappingPlayDelay PlayDelay { get; set; }
		private ObvSeriesSonificationTracksMappingPlayDelay PlayDelay_DefaultValue { get; set; }
		...
		/// </summary>
		public ObvSeriesSonificationTracksMappingTime Time { get; set; }
		private ObvSeriesSonificationTracksMappingTime Time_DefaultValue { get; set; }
		...
		/// </summary>
		public ObvSeriesSonificationTracksMappingTremolo Tremolo { get; set; }
		private ObvSeriesSonificationTracksMappingTremolo Tremolo_DefaultValue { get; set; }
		 

		/// <summary>
		/// The volume of notes, from 0 to 1.
		/// </summary>
		public ObvSeriesSonificationTracksMappingVolume Volume { get; set; }
		private ObvSeriesSonificationTracksMappingVolume Volume_DefaultValue { get; set; }
