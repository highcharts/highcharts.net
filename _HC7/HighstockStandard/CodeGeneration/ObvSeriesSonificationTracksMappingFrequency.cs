...
{
	public partial class ObvSeriesSonificationTracksMappingFrequency  : BaseObject
	{
		Hashtable h = new Hashtable();

		public ObvSeriesSonificationTracksMappingFrequency()
		{
			MapFunction = MapFunction_DefaultValue = ObvSeriesSonificationTracksMappingFrequencyMapFunction.Linear;
			MapTo = MapTo_DefaultValue = "";
			Max = Max_DefaultValue = null;
			Min = Min_DefaultValue = null;
			Value = Value_DefaultValue = null;
			Within = Within_DefaultValue = ObvSeriesSonificationTracksMappingFrequencyWithin.Chart;
		...
		/// </summary>
		public ObvSeriesSonificationTracksMappingFrequencyMapFunction MapFunction { get; set; }
		private ObvSeriesSonificationTracksMappingFrequencyMapFunction MapFunction_DefaultValue { get; set; }
		...
		/// </summary>
		public ObvSeriesSonificationTracksMappingFrequencyWithin Within { get; set; }
		private ObvSeriesSonificationTracksMappingFrequencyWithin Within_DefaultValue { get; set; }
