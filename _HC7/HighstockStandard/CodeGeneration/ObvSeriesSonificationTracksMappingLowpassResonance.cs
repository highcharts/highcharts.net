...
{
	public partial class ObvSeriesSonificationTracksMappingLowpassResonance  : BaseObject
	{
		Hashtable h = new Hashtable();

		public ObvSeriesSonificationTracksMappingLowpassResonance()
		{
			MapFunction = MapFunction_DefaultValue = ObvSeriesSonificationTracksMappingLowpassResonanceMapFunction.Linear;
			MapTo = MapTo_DefaultValue = "";
			Max = Max_DefaultValue = null;
			Min = Min_DefaultValue = null;
			Value = Value_DefaultValue = null;
			Within = Within_DefaultValue = ObvSeriesSonificationTracksMappingLowpassResonanceWithin.Chart;
		...
		/// </summary>
		public ObvSeriesSonificationTracksMappingLowpassResonanceMapFunction MapFunction { get; set; }
		private ObvSeriesSonificationTracksMappingLowpassResonanceMapFunction MapFunction_DefaultValue { get; set; }
		...
		/// </summary>
		public ObvSeriesSonificationTracksMappingLowpassResonanceWithin Within { get; set; }
		private ObvSeriesSonificationTracksMappingLowpassResonanceWithin Within_DefaultValue { get; set; }
