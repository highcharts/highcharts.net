...
{
	public partial class ObvSeriesSonificationTracksMappingPan  : BaseObject
	{
		Hashtable h = new Hashtable();

		public ObvSeriesSonificationTracksMappingPan()
		{
			MapFunction = MapFunction_DefaultValue = ObvSeriesSonificationTracksMappingPanMapFunction.Linear;
			MapTo = MapTo_DefaultValue = "";
			Max = Max_DefaultValue = null;
			Min = Min_DefaultValue = null;
			Value = Value_DefaultValue = null;
			Within = Within_DefaultValue = ObvSeriesSonificationTracksMappingPanWithin.Chart;
		...
		/// </summary>
		public ObvSeriesSonificationTracksMappingPanMapFunction MapFunction { get; set; }
		private ObvSeriesSonificationTracksMappingPanMapFunction MapFunction_DefaultValue { get; set; }
		...
		/// </summary>
		public ObvSeriesSonificationTracksMappingPanWithin Within { get; set; }
		private ObvSeriesSonificationTracksMappingPanWithin Within_DefaultValue { get; set; }
