...
{
	public partial class ObvSeriesSonificationTracksMappingPitch  : BaseObject
	{
		Hashtable h = new Hashtable();

		public ObvSeriesSonificationTracksMappingPitch()
		{
			MapFunction = MapFunction_DefaultValue = ObvSeriesSonificationTracksMappingPitchMapFunction.Linear;
		...
		/// </summary>
		public ObvSeriesSonificationTracksMappingPitchMapFunction MapFunction { get; set; }
		private ObvSeriesSonificationTracksMappingPitchMapFunction MapFunction_DefaultValue { get; set; }
