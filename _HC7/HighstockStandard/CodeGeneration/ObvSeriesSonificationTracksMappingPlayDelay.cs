...
{
	public partial class ObvSeriesSonificationTracksMappingPlayDelay  : BaseObject
	{
		Hashtable h = new Hashtable();

		public ObvSeriesSonificationTracksMappingPlayDelay()
		{
			MapFunction = MapFunction_DefaultValue = ObvSeriesSonificationTracksMappingPlayDelayMapFunction.Linear;
			MapTo = MapTo_DefaultValue = "";
			Max = Max_DefaultValue = null;
			Min = Min_DefaultValue = null;
			Value = Value_DefaultValue = null;
			Within = Within_DefaultValue = ObvSeriesSonificationTracksMappingPlayDelayWithin.Chart;
		...
		/// </summary>
		public ObvSeriesSonificationTracksMappingPlayDelayMapFunction MapFunction { get; set; }
		private ObvSeriesSonificationTracksMappingPlayDelayMapFunction MapFunction_DefaultValue { get; set; }
		...
		/// </summary>
		public ObvSeriesSonificationTracksMappingPlayDelayWithin Within { get; set; }
		private ObvSeriesSonificationTracksMappingPlayDelayWithin Within_DefaultValue { get; set; }
