...
{
	public partial class ObvSeriesSonificationTracksMappingTime  : BaseObject
	{
		Hashtable h = new Hashtable();

		public ObvSeriesSonificationTracksMappingTime()
		{
			MapFunction = MapFunction_DefaultValue = ObvSeriesSonificationTracksMappingTimeMapFunction.Linear;
			MapTo = MapTo_DefaultValue = "";
			Max = Max_DefaultValue = null;
			Min = Min_DefaultValue = null;
			Value = Value_DefaultValue = null;
			Within = Within_DefaultValue = ObvSeriesSonificationTracksMappingTimeWithin.Chart;
		...
		/// </summary>
		public ObvSeriesSonificationTracksMappingTimeMapFunction MapFunction { get; set; }
		private ObvSeriesSonificationTracksMappingTimeMapFunction MapFunction_DefaultValue { get; set; }
		...
		/// </summary>
		public ObvSeriesSonificationTracksMappingTimeWithin Within { get; set; }
		private ObvSeriesSonificationTracksMappingTimeWithin Within_DefaultValue { get; set; }
