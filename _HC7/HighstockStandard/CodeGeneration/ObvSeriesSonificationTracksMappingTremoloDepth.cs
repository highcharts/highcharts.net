...
{
	public partial class ObvSeriesSonificationTracksMappingTremoloDepth  : BaseObject
	{
		Hashtable h = new Hashtable();

		public ObvSeriesSonificationTracksMappingTremoloDepth()
		{
			MapFunction = MapFunction_DefaultValue = ObvSeriesSonificationTracksMappingTremoloDepthMapFunction.Linear;
			MapTo = MapTo_DefaultValue = "";
			Max = Max_DefaultValue = null;
			Min = Min_DefaultValue = null;
			Value = Value_DefaultValue = null;
			Within = Within_DefaultValue = ObvSeriesSonificationTracksMappingTremoloDepthWithin.Chart;
		...
		/// </summary>
		public ObvSeriesSonificationTracksMappingTremoloDepthMapFunction MapFunction { get; set; }
		private ObvSeriesSonificationTracksMappingTremoloDepthMapFunction MapFunction_DefaultValue { get; set; }
		...
		/// </summary>
		public ObvSeriesSonificationTracksMappingTremoloDepthWithin Within { get; set; }
		private ObvSeriesSonificationTracksMappingTremoloDepthWithin Within_DefaultValue { get; set; }
