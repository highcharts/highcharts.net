...
{
	public partial class ObvSeriesSonificationTracksMappingVolume  : BaseObject
	{
		Hashtable h = new Hashtable();

		public ObvSeriesSonificationTracksMappingVolume()
		{
			MapFunction = MapFunction_DefaultValue = ObvSeriesSonificationTracksMappingVolumeMapFunction.Linear;
			MapTo = MapTo_DefaultValue = "";
			Max = Max_DefaultValue = null;
			Min = Min_DefaultValue = null;
			Value = Value_DefaultValue = null;
			Within = Within_DefaultValue = ObvSeriesSonificationTracksMappingVolumeWithin.Chart;
		...
		/// </summary>
		public ObvSeriesSonificationTracksMappingVolumeMapFunction MapFunction { get; set; }
		private ObvSeriesSonificationTracksMappingVolumeMapFunction MapFunction_DefaultValue { get; set; }
		...
		/// </summary>
		public ObvSeriesSonificationTracksMappingVolumeWithin Within { get; set; }
		private ObvSeriesSonificationTracksMappingVolumeWithin Within_DefaultValue { get; set; }
