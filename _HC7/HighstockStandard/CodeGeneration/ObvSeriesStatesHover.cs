...
{
	public partial class ObvSeriesStatesHover  : BaseObject
	{
		Hashtable h = new Hashtable();

		public ObvSeriesStatesHover()
		{
			Animation = Animation_DefaultValue = new Animation() { Enabled = true };
			AnimationBool = AnimationBool_DefaultValue = null;
			Enabled = Enabled_DefaultValue = true;
			Halo = Halo_DefaultValue = new ObvSeriesStatesHoverHalo();
			LineWidth = LineWidth_DefaultValue = null;
			LineWidthPlus = LineWidthPlus_DefaultValue = 1;
			Marker = Marker_DefaultValue = new ObvSeriesStatesHoverMarker();
		...
		/// </summary>
		public ObvSeriesStatesHoverHalo Halo { get; set; }
		private ObvSeriesStatesHoverHalo Halo_DefaultValue { get; set; }
		...
		/// </summary>
		public ObvSeriesStatesHoverMarker Marker { get; set; }
		private ObvSeriesStatesHoverMarker Marker_DefaultValue { get; set; }
