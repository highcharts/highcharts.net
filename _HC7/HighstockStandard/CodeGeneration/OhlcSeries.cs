...
namespace Highsoft.Web.Mvc.Stocks
{
	public partial class OhlcSeries  : Series
	{
		...
		public OhlcSeries()
		{
			Accessibility = Accessibility_DefaultValue = new OhlcSeriesAccessibility();
			AllowPointSelect = AllowPointSelect_DefaultValue = false;
			Animation = Animation_DefaultValue = new Animation() { Enabled = true };
			AnimationBool = AnimationBool_DefaultValue = true;
			AnimationLimit = AnimationLimit_DefaultValue = null;
			BoostBlending = BoostBlending_DefaultValue = OhlcSeriesBoostBlending.Undefined;
			...
			Compare = Compare_DefaultValue = OhlcSeriesCompare.Percent;
			...
			DashStyle = DashStyle_DefaultValue = OhlcSeriesDashStyle.Null;
			...
			DataSorting = DataSorting_DefaultValue = new OhlcSeriesDataSorting();
			Depth = Depth_DefaultValue = 25;
			Description = Description_DefaultValue = "";
			DragDrop = DragDrop_DefaultValue = new OhlcSeriesDragDrop();
			Dumbell = Dumbell_DefaultValue = new OhlcSeriesDumbell();
			...
			LastPrice = LastPrice_DefaultValue = new OhlcSeriesLastPrice();
			LastVisiblePrice = LastVisiblePrice_DefaultValue = new OhlcSeriesLastVisiblePrice();
			LegendIndex = LegendIndex_DefaultValue = null;
			LegendSymbol = LegendSymbol_DefaultValue = OhlcSeriesLegendSymbol.Rectangle;
			...
			OnPoint = OnPoint_DefaultValue = new OhlcSeriesOnPoint();
			...
			PointValKey = PointValKey_DefaultValue = OhlcSeriesPointValKey.Close;
			...
			Sonification = Sonification_DefaultValue = new OhlcSeriesSonification();
		...
		/// </summary>
		public OhlcSeriesAccessibility Accessibility { get; set; }
		private OhlcSeriesAccessibility Accessibility_DefaultValue { get; set; }
		...
		/// </summary>
		public OhlcSeriesBoostBlending BoostBlending { get; set; }
		private OhlcSeriesBoostBlending BoostBlending_DefaultValue { get; set; }
		...
		/// </summary>
		public OhlcSeriesCompare Compare { get; set; }
		private OhlcSeriesCompare Compare_DefaultValue { get; set; }
		...
		/// </summary>
		public OhlcSeriesDataSorting DataSorting { get; set; }
		private OhlcSeriesDataSorting DataSorting_DefaultValue { get; set; }
		...
		/// </summary>
		public OhlcSeriesDragDrop DragDrop { get; set; }
		private OhlcSeriesDragDrop DragDrop_DefaultValue { get; set; }
		 

		/// <summary>
		/// 
		/// </summary>
		public OhlcSeriesDumbell Dumbell { get; set; }
		private OhlcSeriesDumbell Dumbell_DefaultValue { get; set; }
		...
		/// </summary>
		public OhlcSeriesLastPrice LastPrice { get; set; }
		private OhlcSeriesLastPrice LastPrice_DefaultValue { get; set; }
		 

		/// <summary>
		/// The line marks the last price from visible range of points.
		/// </summary>
		public OhlcSeriesLastVisiblePrice LastVisiblePrice { get; set; }
		private OhlcSeriesLastVisiblePrice LastVisiblePrice_DefaultValue { get; set; }
		...
		/// </summary>
		public OhlcSeriesLegendSymbol LegendSymbol { get; set; }
		private OhlcSeriesLegendSymbol LegendSymbol_DefaultValue { get; set; }
		...
		/// </summary>
		public OhlcSeriesOnPoint OnPoint { get; set; }
		private OhlcSeriesOnPoint OnPoint_DefaultValue { get; set; }
		...
		/// </summary>
		public OhlcSeriesPointValKey PointValKey { get; set; }
		private OhlcSeriesPointValKey PointValKey_DefaultValue { get; set; }
		...
		/// </summary>
		public OhlcSeriesSonification Sonification { get; set; }
		private OhlcSeriesSonification Sonification_DefaultValue { get; set; }
