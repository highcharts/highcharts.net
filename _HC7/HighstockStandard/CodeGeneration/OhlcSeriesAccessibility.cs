...
namespace Highsoft.Web.Mvc.Stocks
{
	public partial class OhlcSeriesAccessibility  : BaseObject
	{
		...
		public OhlcSeriesAccessibility()
		{
			...
			Point = Point_DefaultValue = new OhlcSeriesAccessibilityPoint();
		...
		/// </summary>
		public OhlcSeriesAccessibilityPoint Point { get; set; }
		private OhlcSeriesAccessibilityPoint Point_DefaultValue { get; set; }
