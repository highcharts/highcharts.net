...
{
	public partial class OhlcSeriesDataDataLabels  : BaseObject
	{
		Hashtable h = new Hashtable();

		public OhlcSeriesDataDataLabels()
		{
		}	
		...
		/// </summary>
		public OhlcSeriesDataDataLabelsAlign Align { get; set; }
		...
		/// </summary>
		public OhlcSeriesDataDataLabelsFilter Filter { get; set; }
		...
		/// </summary>
		public OhlcSeriesDataDataLabelsOverflow Overflow { get; set; }
		...
		/// </summary>
		public OhlcSeriesDataDataLabelsPosition Position { get; set; }
		...
		/// </summary>
		public OhlcSeriesDataDataLabelsTextPath TextPath { get; set; }
		...
		/// </summary>
		public OhlcSeriesDataDataLabelsVerticalAlign VerticalAlign { get; set; }
		...
		{
			if (Align != OhlcSeriesDataDataLabelsAlign.Null) h.Add("align", highstock.FirstCharacterToLower(Align.ToString()));
			...
			if (Overflow != OhlcSeriesDataDataLabelsOverflow.Null) h.Add("overflow", highstock.FirstCharacterToLower(Overflow.ToString()));
			if (Padding != null) h.Add("padding",Padding);
			if (Position != OhlcSeriesDataDataLabelsPosition.Null) h.Add("position", highstock.FirstCharacterToLower(Position.ToString()));
			...
			if (VerticalAlign != OhlcSeriesDataDataLabelsVerticalAlign.Null) h.Add("verticalAlign", highstock.FirstCharacterToLower(VerticalAlign.ToString()));
			if (X != null) h.Add("x",X);
			if (Y != null) h.Add("y",Y);
