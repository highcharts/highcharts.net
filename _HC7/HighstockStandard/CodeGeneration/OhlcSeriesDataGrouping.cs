...
namespace Highsoft.Web.Mvc.Stocks
{
	public partial class OhlcSeriesDataGrouping  : BaseObject
	{
		...
		internal override Hashtable ToHashtable()
		{
			...
			if (Approximation != Approximation_DefaultValue) { h.Add("approximation",Approximation); Highstock.AddFunction("OhlcSeriesDataGroupingApproximation.approximation", Approximation); }  
