...
{
	public partial class OhlcSeriesSonificationContextTracks  : BaseObject
	{
		Hashtable h = new Hashtable();

		public OhlcSeriesSonificationContextTracks()
		{
			ActiveWhen = ActiveWhen_DefaultValue = new OhlcSeriesSonificationContextTracksActiveWhen();
			Instrument = Instrument_DefaultValue = null;
			InstrumentString = InstrumentString_DefaultValue = "null";
			Mapping = Mapping_DefaultValue = new OhlcSeriesSonificationContextTracksMapping();
			MidiName = MidiName_DefaultValue = "";
			PointGrouping = PointGrouping_DefaultValue = new OhlcSeriesSonificationContextTracksPointGrouping();
			...
			Type = Type_DefaultValue = OhlcSeriesSonificationContextTracksType.Instrument;
			ValueInterval = ValueInterval_DefaultValue = null;
			ValueMapFunction = ValueMapFunction_DefaultValue = OhlcSeriesSonificationContextTracksValueMapFunction.Linear;
		...
		/// </summary>
		public OhlcSeriesSonificationContextTracksActiveWhen ActiveWhen { get; set; }
		private OhlcSeriesSonificationContextTracksActiveWhen ActiveWhen_DefaultValue { get; set; }
		...
		/// </summary>
		public OhlcSeriesSonificationContextTracksMapping Mapping { get; set; }
		private OhlcSeriesSonificationContextTracksMapping Mapping_DefaultValue { get; set; }
		...
		/// </summary>
		public OhlcSeriesSonificationContextTracksPointGrouping PointGrouping { get; set; }
		private OhlcSeriesSonificationContextTracksPointGrouping PointGrouping_DefaultValue { get; set; }
		...
		/// </summary>
		public OhlcSeriesSonificationContextTracksType Type { get; set; }
		private OhlcSeriesSonificationContextTracksType Type_DefaultValue { get; set; }
		...
		/// </summary>
		public OhlcSeriesSonificationContextTracksValueMapFunction ValueMapFunction { get; set; }
		private OhlcSeriesSonificationContextTracksValueMapFunction ValueMapFunction_DefaultValue { get; set; }
