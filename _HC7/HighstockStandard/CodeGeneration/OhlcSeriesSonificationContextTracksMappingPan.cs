...
{
	public partial class OhlcSeriesSonificationContextTracksMappingPan  : BaseObject
	{
		Hashtable h = new Hashtable();

		public OhlcSeriesSonificationContextTracksMappingPan()
		{
			MapFunction = MapFunction_DefaultValue = OhlcSeriesSonificationContextTracksMappingPanMapFunction.Linear;
			MapTo = MapTo_DefaultValue = "";
			Max = Max_DefaultValue = null;
			Min = Min_DefaultValue = null;
			Value = Value_DefaultValue = null;
			Within = Within_DefaultValue = OhlcSeriesSonificationContextTracksMappingPanWithin.Chart;
		...
		/// </summary>
		public OhlcSeriesSonificationContextTracksMappingPanMapFunction MapFunction { get; set; }
		private OhlcSeriesSonificationContextTracksMappingPanMapFunction MapFunction_DefaultValue { get; set; }
		...
		/// </summary>
		public OhlcSeriesSonificationContextTracksMappingPanWithin Within { get; set; }
		private OhlcSeriesSonificationContextTracksMappingPanWithin Within_DefaultValue { get; set; }
