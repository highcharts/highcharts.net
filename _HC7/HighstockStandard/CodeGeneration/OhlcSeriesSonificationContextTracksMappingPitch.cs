...
{
	public partial class OhlcSeriesSonificationContextTracksMappingPitch  : BaseObject
	{
		Hashtable h = new Hashtable();

		public OhlcSeriesSonificationContextTracksMappingPitch()
		{
			MapFunction = MapFunction_DefaultValue = OhlcSeriesSonificationContextTracksMappingPitchMapFunction.Linear;
		...
		/// </summary>
		public OhlcSeriesSonificationContextTracksMappingPitchMapFunction MapFunction { get; set; }
		private OhlcSeriesSonificationContextTracksMappingPitchMapFunction MapFunction_DefaultValue { get; set; }
