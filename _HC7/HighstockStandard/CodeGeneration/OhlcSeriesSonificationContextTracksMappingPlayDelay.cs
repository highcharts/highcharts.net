...
{
	public partial class OhlcSeriesSonificationContextTracksMappingPlayDelay  : BaseObject
	{
		Hashtable h = new Hashtable();

		public OhlcSeriesSonificationContextTracksMappingPlayDelay()
		{
			MapFunction = MapFunction_DefaultValue = OhlcSeriesSonificationContextTracksMappingPlayDelayMapFunction.Linear;
			MapTo = MapTo_DefaultValue = "";
			Max = Max_DefaultValue = null;
			Min = Min_DefaultValue = null;
			Value = Value_DefaultValue = null;
			Within = Within_DefaultValue = OhlcSeriesSonificationContextTracksMappingPlayDelayWithin.Chart;
		...
		/// </summary>
		public OhlcSeriesSonificationContextTracksMappingPlayDelayMapFunction MapFunction { get; set; }
		private OhlcSeriesSonificationContextTracksMappingPlayDelayMapFunction MapFunction_DefaultValue { get; set; }
		...
		/// </summary>
		public OhlcSeriesSonificationContextTracksMappingPlayDelayWithin Within { get; set; }
		private OhlcSeriesSonificationContextTracksMappingPlayDelayWithin Within_DefaultValue { get; set; }
