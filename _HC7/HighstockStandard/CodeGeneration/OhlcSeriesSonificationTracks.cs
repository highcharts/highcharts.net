...
{
	public partial class OhlcSeriesSonificationTracks  : BaseObject
	{
		Hashtable h = new Hashtable();

		public OhlcSeriesSonificationTracks()
		{
			ActiveWhen = ActiveWhen_DefaultValue = new OhlcSeriesSonificationTracksActiveWhen();
			Instrument = Instrument_DefaultValue = null;
			InstrumentString = InstrumentString_DefaultValue = "null";
			Mapping = Mapping_DefaultValue = new OhlcSeriesSonificationTracksMapping();
			MidiName = MidiName_DefaultValue = "";
			PointGrouping = PointGrouping_DefaultValue = new OhlcSeriesSonificationTracksPointGrouping();
			RoundToMusicalNotes = RoundToMusicalNotes_DefaultValue = true;
			ShowPlayMarker = ShowPlayMarker_DefaultValue = true;
			Type = Type_DefaultValue = OhlcSeriesSonificationTracksType.Instrument;
		...
		/// </summary>
		public OhlcSeriesSonificationTracksActiveWhen ActiveWhen { get; set; }
		private OhlcSeriesSonificationTracksActiveWhen ActiveWhen_DefaultValue { get; set; }
		...
		/// </summary>
		public OhlcSeriesSonificationTracksMapping Mapping { get; set; }
		private OhlcSeriesSonificationTracksMapping Mapping_DefaultValue { get; set; }
		...
		/// </summary>
		public OhlcSeriesSonificationTracksPointGrouping PointGrouping { get; set; }
		private OhlcSeriesSonificationTracksPointGrouping PointGrouping_DefaultValue { get; set; }
		...
		/// </summary>
		public OhlcSeriesSonificationTracksType Type { get; set; }
		private OhlcSeriesSonificationTracksType Type_DefaultValue { get; set; }
