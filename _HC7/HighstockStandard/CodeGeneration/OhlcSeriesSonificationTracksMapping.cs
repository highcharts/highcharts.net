...
{
	public partial class OhlcSeriesSonificationTracksMapping  : BaseObject
	{
		Hashtable h = new Hashtable();

		public OhlcSeriesSonificationTracksMapping()
		{
			Frequency = Frequency_DefaultValue = new OhlcSeriesSonificationTracksMappingFrequency();
			GapBetweenNotes = GapBetweenNotes_DefaultValue = new OhlcSeriesSonificationTracksMappingGapBetweenNotes();
			Highpass = Highpass_DefaultValue = new OhlcSeriesSonificationTracksMappingHighpass();
			Lowpass = Lowpass_DefaultValue = new OhlcSeriesSonificationTracksMappingLowpass();
			NoteDuration = NoteDuration_DefaultValue = new OhlcSeriesSonificationTracksMappingNoteDuration();
			Pan = Pan_DefaultValue = new OhlcSeriesSonificationTracksMappingPan();
			Pitch = Pitch_DefaultValue = new OhlcSeriesSonificationTracksMappingPitch();
			PitchString = PitchString_DefaultValue = "null";
			PitchNumber = PitchNumber_DefaultValue = null;
			PlayDelay = PlayDelay_DefaultValue = new OhlcSeriesSonificationTracksMappingPlayDelay();
			Time = Time_DefaultValue = new OhlcSeriesSonificationTracksMappingTime();
			TimeString = TimeString_DefaultValue = "null";
			TimeNumber = TimeNumber_DefaultValue = null;
			Tremolo = Tremolo_DefaultValue = new OhlcSeriesSonificationTracksMappingTremolo();
			Volume = Volume_DefaultValue = new OhlcSeriesSonificationTracksMappingVolume();
		...
		/// </summary>
		public OhlcSeriesSonificationTracksMappingFrequency Frequency { get; set; }
		private OhlcSeriesSonificationTracksMappingFrequency Frequency_DefaultValue { get; set; }
		...
		/// </summary>
		public OhlcSeriesSonificationTracksMappingGapBetweenNotes GapBetweenNotes { get; set; }
		private OhlcSeriesSonificationTracksMappingGapBetweenNotes GapBetweenNotes_DefaultValue { get; set; }
		...
		/// </summary>
		public OhlcSeriesSonificationTracksMappingHighpass Highpass { get; set; }
		private OhlcSeriesSonificationTracksMappingHighpass Highpass_DefaultValue { get; set; }
		...
		/// </summary>
		public OhlcSeriesSonificationTracksMappingLowpass Lowpass { get; set; }
		private OhlcSeriesSonificationTracksMappingLowpass Lowpass_DefaultValue { get; set; }
		...
		/// </summary>
		public OhlcSeriesSonificationTracksMappingNoteDuration NoteDuration { get; set; }
		private OhlcSeriesSonificationTracksMappingNoteDuration NoteDuration_DefaultValue { get; set; }
		...
		/// </summary>
		public OhlcSeriesSonificationTracksMappingPan Pan { get; set; }
		private OhlcSeriesSonificationTracksMappingPan Pan_DefaultValue { get; set; }
		...
		/// </summary>
		public OhlcSeriesSonificationTracksMappingPitch Pitch { get; set; }
		private OhlcSeriesSonificationTracksMappingPitch Pitch_DefaultValue { get; set; }
		...
		/// </summary>
		public OhlcSeriesSonificationTracksMappingPlayDelay PlayDelay { get; set; }
		private OhlcSeriesSonificationTracksMappingPlayDelay PlayDelay_DefaultValue { get; set; }
		...
		/// </summary>
		public OhlcSeriesSonificationTracksMappingTime Time { get; set; }
		private OhlcSeriesSonificationTracksMappingTime Time_DefaultValue { get; set; }
		...
		/// </summary>
		public OhlcSeriesSonificationTracksMappingTremolo Tremolo { get; set; }
		private OhlcSeriesSonificationTracksMappingTremolo Tremolo_DefaultValue { get; set; }
		 

		/// <summary>
		/// The volume of notes, from 0 to 1.
		/// </summary>
		public OhlcSeriesSonificationTracksMappingVolume Volume { get; set; }
		private OhlcSeriesSonificationTracksMappingVolume Volume_DefaultValue { get; set; }
