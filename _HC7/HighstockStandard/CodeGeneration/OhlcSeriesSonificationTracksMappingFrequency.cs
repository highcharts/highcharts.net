...
{
	public partial class OhlcSeriesSonificationTracksMappingFrequency  : BaseObject
	{
		Hashtable h = new Hashtable();

		public OhlcSeriesSonificationTracksMappingFrequency()
		{
			MapFunction = MapFunction_DefaultValue = OhlcSeriesSonificationTracksMappingFrequencyMapFunction.Linear;
			MapTo = MapTo_DefaultValue = "";
			Max = Max_DefaultValue = null;
			Min = Min_DefaultValue = null;
			Value = Value_DefaultValue = null;
			Within = Within_DefaultValue = OhlcSeriesSonificationTracksMappingFrequencyWithin.Chart;
		...
		/// </summary>
		public OhlcSeriesSonificationTracksMappingFrequencyMapFunction MapFunction { get; set; }
		private OhlcSeriesSonificationTracksMappingFrequencyMapFunction MapFunction_DefaultValue { get; set; }
		...
		/// </summary>
		public OhlcSeriesSonificationTracksMappingFrequencyWithin Within { get; set; }
		private OhlcSeriesSonificationTracksMappingFrequencyWithin Within_DefaultValue { get; set; }
