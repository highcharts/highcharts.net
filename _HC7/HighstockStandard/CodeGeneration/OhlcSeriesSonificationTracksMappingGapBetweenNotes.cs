...
{
	public partial class OhlcSeriesSonificationTracksMappingGapBetweenNotes  : BaseObject
	{
		Hashtable h = new Hashtable();

		public OhlcSeriesSonificationTracksMappingGapBetweenNotes()
		{
			MapFunction = MapFunction_DefaultValue = OhlcSeriesSonificationTracksMappingGapBetweenNotesMapFunction.Linear;
			MapTo = MapTo_DefaultValue = "";
			Max = Max_DefaultValue = null;
			Min = Min_DefaultValue = null;
			Value = Value_DefaultValue = null;
			Within = Within_DefaultValue = OhlcSeriesSonificationTracksMappingGapBetweenNotesWithin.Chart;
		...
		/// </summary>
		public OhlcSeriesSonificationTracksMappingGapBetweenNotesMapFunction MapFunction { get; set; }
		private OhlcSeriesSonificationTracksMappingGapBetweenNotesMapFunction MapFunction_DefaultValue { get; set; }
		...
		/// </summary>
		public OhlcSeriesSonificationTracksMappingGapBetweenNotesWithin Within { get; set; }
		private OhlcSeriesSonificationTracksMappingGapBetweenNotesWithin Within_DefaultValue { get; set; }
