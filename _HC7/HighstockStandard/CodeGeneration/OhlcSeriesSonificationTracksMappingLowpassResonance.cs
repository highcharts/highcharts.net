...
{
	public partial class OhlcSeriesSonificationTracksMappingLowpassResonance  : BaseObject
	{
		Hashtable h = new Hashtable();

		public OhlcSeriesSonificationTracksMappingLowpassResonance()
		{
			MapFunction = MapFunction_DefaultValue = OhlcSeriesSonificationTracksMappingLowpassResonanceMapFunction.Linear;
			MapTo = MapTo_DefaultValue = "";
			Max = Max_DefaultValue = null;
			Min = Min_DefaultValue = null;
			Value = Value_DefaultValue = null;
			Within = Within_DefaultValue = OhlcSeriesSonificationTracksMappingLowpassResonanceWithin.Chart;
		...
		/// </summary>
		public OhlcSeriesSonificationTracksMappingLowpassResonanceMapFunction MapFunction { get; set; }
		private OhlcSeriesSonificationTracksMappingLowpassResonanceMapFunction MapFunction_DefaultValue { get; set; }
		...
		/// </summary>
		public OhlcSeriesSonificationTracksMappingLowpassResonanceWithin Within { get; set; }
		private OhlcSeriesSonificationTracksMappingLowpassResonanceWithin Within_DefaultValue { get; set; }
