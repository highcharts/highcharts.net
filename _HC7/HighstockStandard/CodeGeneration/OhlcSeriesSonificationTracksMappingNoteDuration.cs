...
{
	public partial class OhlcSeriesSonificationTracksMappingNoteDuration  : BaseObject
	{
		Hashtable h = new Hashtable();

		public OhlcSeriesSonificationTracksMappingNoteDuration()
		{
			MapFunction = MapFunction_DefaultValue = OhlcSeriesSonificationTracksMappingNoteDurationMapFunction.Linear;
			MapTo = MapTo_DefaultValue = "";
			Max = Max_DefaultValue = null;
			Min = Min_DefaultValue = null;
			Value = Value_DefaultValue = null;
			Within = Within_DefaultValue = OhlcSeriesSonificationTracksMappingNoteDurationWithin.Chart;
		...
		/// </summary>
		public OhlcSeriesSonificationTracksMappingNoteDurationMapFunction MapFunction { get; set; }
		private OhlcSeriesSonificationTracksMappingNoteDurationMapFunction MapFunction_DefaultValue { get; set; }
		...
		/// </summary>
		public OhlcSeriesSonificationTracksMappingNoteDurationWithin Within { get; set; }
		private OhlcSeriesSonificationTracksMappingNoteDurationWithin Within_DefaultValue { get; set; }
