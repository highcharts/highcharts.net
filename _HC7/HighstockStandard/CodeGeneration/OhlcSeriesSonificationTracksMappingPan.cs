...
{
	public partial class OhlcSeriesSonificationTracksMappingPan  : BaseObject
	{
		Hashtable h = new Hashtable();

		public OhlcSeriesSonificationTracksMappingPan()
		{
			MapFunction = MapFunction_DefaultValue = OhlcSeriesSonificationTracksMappingPanMapFunction.Linear;
			MapTo = MapTo_DefaultValue = "";
			Max = Max_DefaultValue = null;
			Min = Min_DefaultValue = null;
			Value = Value_DefaultValue = null;
			Within = Within_DefaultValue = OhlcSeriesSonificationTracksMappingPanWithin.Chart;
		...
		/// </summary>
		public OhlcSeriesSonificationTracksMappingPanMapFunction MapFunction { get; set; }
		private OhlcSeriesSonificationTracksMappingPanMapFunction MapFunction_DefaultValue { get; set; }
		...
		/// </summary>
		public OhlcSeriesSonificationTracksMappingPanWithin Within { get; set; }
		private OhlcSeriesSonificationTracksMappingPanWithin Within_DefaultValue { get; set; }
