...
{
	public partial class OhlcSeriesSonificationTracksMappingPitch  : BaseObject
	{
		Hashtable h = new Hashtable();

		public OhlcSeriesSonificationTracksMappingPitch()
		{
			MapFunction = MapFunction_DefaultValue = OhlcSeriesSonificationTracksMappingPitchMapFunction.Linear;
		...
		/// </summary>
		public OhlcSeriesSonificationTracksMappingPitchMapFunction MapFunction { get; set; }
		private OhlcSeriesSonificationTracksMappingPitchMapFunction MapFunction_DefaultValue { get; set; }
