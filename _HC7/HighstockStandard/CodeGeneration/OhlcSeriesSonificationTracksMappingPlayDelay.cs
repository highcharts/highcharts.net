...
{
	public partial class OhlcSeriesSonificationTracksMappingPlayDelay  : BaseObject
	{
		Hashtable h = new Hashtable();

		public OhlcSeriesSonificationTracksMappingPlayDelay()
		{
			MapFunction = MapFunction_DefaultValue = OhlcSeriesSonificationTracksMappingPlayDelayMapFunction.Linear;
			MapTo = MapTo_DefaultValue = "";
			Max = Max_DefaultValue = null;
			Min = Min_DefaultValue = null;
			Value = Value_DefaultValue = null;
			Within = Within_DefaultValue = OhlcSeriesSonificationTracksMappingPlayDelayWithin.Chart;
		...
		/// </summary>
		public OhlcSeriesSonificationTracksMappingPlayDelayMapFunction MapFunction { get; set; }
		private OhlcSeriesSonificationTracksMappingPlayDelayMapFunction MapFunction_DefaultValue { get; set; }
		...
		/// </summary>
		public OhlcSeriesSonificationTracksMappingPlayDelayWithin Within { get; set; }
		private OhlcSeriesSonificationTracksMappingPlayDelayWithin Within_DefaultValue { get; set; }
