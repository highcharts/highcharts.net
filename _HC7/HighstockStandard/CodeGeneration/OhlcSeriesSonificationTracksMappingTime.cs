...
{
	public partial class OhlcSeriesSonificationTracksMappingTime  : BaseObject
	{
		Hashtable h = new Hashtable();

		public OhlcSeriesSonificationTracksMappingTime()
		{
			MapFunction = MapFunction_DefaultValue = OhlcSeriesSonificationTracksMappingTimeMapFunction.Linear;
			MapTo = MapTo_DefaultValue = "";
			Max = Max_DefaultValue = null;
			Min = Min_DefaultValue = null;
			Value = Value_DefaultValue = null;
			Within = Within_DefaultValue = OhlcSeriesSonificationTracksMappingTimeWithin.Chart;
		...
		/// </summary>
		public OhlcSeriesSonificationTracksMappingTimeMapFunction MapFunction { get; set; }
		private OhlcSeriesSonificationTracksMappingTimeMapFunction MapFunction_DefaultValue { get; set; }
		...
		/// </summary>
		public OhlcSeriesSonificationTracksMappingTimeWithin Within { get; set; }
		private OhlcSeriesSonificationTracksMappingTimeWithin Within_DefaultValue { get; set; }
