...
{
	public partial class OhlcSeriesSonificationTracksMappingTremoloSpeed  : BaseObject
	{
		Hashtable h = new Hashtable();

		public OhlcSeriesSonificationTracksMappingTremoloSpeed()
		{
			MapFunction = MapFunction_DefaultValue = OhlcSeriesSonificationTracksMappingTremoloSpeedMapFunction.Linear;
			MapTo = MapTo_DefaultValue = "";
			Max = Max_DefaultValue = null;
			Min = Min_DefaultValue = null;
			Value = Value_DefaultValue = null;
			Within = Within_DefaultValue = OhlcSeriesSonificationTracksMappingTremoloSpeedWithin.Chart;
		...
		/// </summary>
		public OhlcSeriesSonificationTracksMappingTremoloSpeedMapFunction MapFunction { get; set; }
		private OhlcSeriesSonificationTracksMappingTremoloSpeedMapFunction MapFunction_DefaultValue { get; set; }
		...
		/// </summary>
		public OhlcSeriesSonificationTracksMappingTremoloSpeedWithin Within { get; set; }
		private OhlcSeriesSonificationTracksMappingTremoloSpeedWithin Within_DefaultValue { get; set; }
