...
{
	public partial class OhlcSeriesSonificationTracksMappingVolume  : BaseObject
	{
		Hashtable h = new Hashtable();

		public OhlcSeriesSonificationTracksMappingVolume()
		{
			MapFunction = MapFunction_DefaultValue = OhlcSeriesSonificationTracksMappingVolumeMapFunction.Linear;
			MapTo = MapTo_DefaultValue = "";
			Max = Max_DefaultValue = null;
			Min = Min_DefaultValue = null;
			Value = Value_DefaultValue = null;
			Within = Within_DefaultValue = OhlcSeriesSonificationTracksMappingVolumeWithin.Chart;
		...
		/// </summary>
		public OhlcSeriesSonificationTracksMappingVolumeMapFunction MapFunction { get; set; }
		private OhlcSeriesSonificationTracksMappingVolumeMapFunction MapFunction_DefaultValue { get; set; }
		...
		/// </summary>
		public OhlcSeriesSonificationTracksMappingVolumeWithin Within { get; set; }
		private OhlcSeriesSonificationTracksMappingVolumeWithin Within_DefaultValue { get; set; }
