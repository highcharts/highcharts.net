...
{
	public partial class OhlcSeriesSonificationTracksPointGrouping  : BaseObject
	{
		Hashtable h = new Hashtable();

		public OhlcSeriesSonificationTracksPointGrouping()
		{
			Algorithm = Algorithm_DefaultValue = OhlcSeriesSonificationTracksPointGroupingAlgorithm.Minimax;
		...
		/// </summary>
		public OhlcSeriesSonificationTracksPointGroupingAlgorithm Algorithm { get; set; }
		private OhlcSeriesSonificationTracksPointGroupingAlgorithm Algorithm_DefaultValue { get; set; }
