...
{
	public partial class OhlcSeriesStatesSelect  : BaseObject
	{
		public OhlcSeriesStatesSelect()
		{
			Animation = Animation_DefaultValue = new Animation() { Enabled = true };
			Enabled = Enabled_DefaultValue = true;
			Halo = Halo_DefaultValue = new OhlcSeriesStatesSelectHalo();
			LineWidth = LineWidth_DefaultValue = null;
			LineWidthPlus = LineWidthPlus_DefaultValue = 1;
			Marker = Marker_DefaultValue = new OhlcSeriesStatesSelectMarker();
		...
		/// </summary>
		public OhlcSeriesStatesSelectHalo Halo { get; set; }
		private OhlcSeriesStatesSelectHalo Halo_DefaultValue { get; set; }
		...
		/// </summary>
		public OhlcSeriesStatesSelectMarker Marker { get; set; }
		private OhlcSeriesStatesSelectMarker Marker_DefaultValue { get; set; }
