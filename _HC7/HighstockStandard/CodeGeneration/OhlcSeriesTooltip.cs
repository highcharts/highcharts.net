...
{
	public partial class OhlcSeriesTooltip  : BaseObject
	{
		public OhlcSeriesTooltip()
		{
			...
			HeaderShape = HeaderShape_DefaultValue = OhlcSeriesTooltipHeaderShape.Callout;
		...
		/// </summary>
		public OhlcSeriesTooltipHeaderShape HeaderShape { get; set; }
		private OhlcSeriesTooltipHeaderShape HeaderShape_DefaultValue { get; set; }
		...
		internal override Hashtable ToHashtable()
		{
			...
			if (NullFormatter != NullFormatter_DefaultValue) { h.Add("nullFormatter",NullFormatter); Highstock.AddFunction("OhlcSeriesTooltipNullFormatter.nullFormatter", NullFormatter); }  
			if (Outside != Outside_DefaultValue) h.Add("outside",Outside);
			if (Padding != Padding_DefaultValue) h.Add("padding",Padding);
			if (PointFormat != PointFormat_DefaultValue) h.Add("pointFormat",PointFormat);
			if (PointFormatter != PointFormatter_DefaultValue) { h.Add("pointFormatter",PointFormatter); Highstock.AddFunction("OhlcSeriesTooltipPointFormatter.pointFormatter", PointFormatter); }  
