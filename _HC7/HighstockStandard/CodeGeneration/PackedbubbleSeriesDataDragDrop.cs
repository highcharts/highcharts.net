...
{
	public partial class PackedbubbleSeriesDataDragDrop  : BaseObject
	{
		public PackedbubbleSeriesDataDragDrop()
		{
			DraggableX = DraggableX_DefaultValue = null;
			DraggableY = DraggableY_DefaultValue = null;
			DragHandle = DragHandle_DefaultValue = new PackedbubbleSeriesDataDragDropDragHandle();
			...
			GuideBox = GuideBox_DefaultValue = new PackedbubbleSeriesDataDragDropGuideBox();
		...
		/// </summary>
		public PackedbubbleSeriesDataDragDropDragHandle DragHandle { get; set; }
		private PackedbubbleSeriesDataDragDropDragHandle DragHandle_DefaultValue { get; set; }
		...
		/// </summary>
		public PackedbubbleSeriesDataDragDropGuideBox GuideBox { get; set; }
		private PackedbubbleSeriesDataDragDropGuideBox GuideBox_DefaultValue { get; set; }
