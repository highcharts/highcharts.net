...
{
	public partial class PcSeries  : Series
	{
		Hashtable h = new Hashtable();

		public PcSeries()
		{
			Accessibility = Accessibility_DefaultValue = new PcSeriesAccessibility();
			AllowPointSelect = AllowPointSelect_DefaultValue = false;
			Animation = Animation_DefaultValue = new Animation() { Enabled = true };
			AnimationBool = AnimationBool_DefaultValue = true;
			AnimationLimit = AnimationLimit_DefaultValue = null;
			BoostBlending = BoostBlending_DefaultValue = PcSeriesBoostBlending.Undefined;
			BoostThreshold = BoostThreshold_DefaultValue = 5000;
			BottomLine = BottomLine_DefaultValue = new PcSeriesBottomLine();
			...
			Cursor = Cursor_DefaultValue = PcSeriesCursor.Null;
			Custom = Custom_DefaultValue = new Hashtable();
			DashStyle = DashStyle_DefaultValue = PcSeriesDashStyle.Null;
			DataGrouping = DataGrouping_DefaultValue = new PcSeriesDataGrouping();
			DataLabels = DataLabels_DefaultValue = new PcSeriesDataLabels();
			DataSorting = DataSorting_DefaultValue = new PcSeriesDataSorting();
			Description = Description_DefaultValue = "";
			Dumbell = Dumbell_DefaultValue = new PcSeriesDumbell();
			EnableMouseTracking = EnableMouseTracking_DefaultValue = true;
			Events = Events_DefaultValue = new PcSeriesEvents();
			FillColor = FillColor_DefaultValue = "";
			FindNearestPointBy = FindNearestPointBy_DefaultValue = PcSeriesFindNearestPointBy.X;
			GapSize = GapSize_DefaultValue = 0;
			GapUnit = GapUnit_DefaultValue = PcSeriesGapUnit.Relative;
			GetExtremesFromAll = GetExtremesFromAll_DefaultValue = false;
			Id = Id_DefaultValue = "";
			InactiveOtherPoints = InactiveOtherPoints_DefaultValue = false;
			IncludeInDataExport = IncludeInDataExport_DefaultValue = null;
			Index = Index_DefaultValue = null;
			Label = Label_DefaultValue = new PcSeriesLabel();
			LastPrice = LastPrice_DefaultValue = new PcSeriesLastPrice();
			LastVisiblePrice = LastVisiblePrice_DefaultValue = new PcSeriesLastVisiblePrice();
			LegendIndex = LegendIndex_DefaultValue = null;
			LegendSymbol = LegendSymbol_DefaultValue = PcSeriesLegendSymbol.Rectangle;
			Linecap = Linecap_DefaultValue = PcSeriesLinecap.Round;
			LineWidth = LineWidth_DefaultValue = 2;
			LinkedTo = LinkedTo_DefaultValue = "";
			Marker = Marker_DefaultValue = new PcSeriesMarker();
			Name = Name_DefaultValue = "";
			NegativeColor = NegativeColor_DefaultValue = "";
			OnPoint = OnPoint_DefaultValue = new PcSeriesOnPoint();
			Opacity = Opacity_DefaultValue = 1;
			Params = Params_DefaultValue = new PcSeriesParams();
			Point = Point_DefaultValue = new PcSeriesPoint();
			...
			Sonification = Sonification_DefaultValue = new PcSeriesSonification();
			Stack = Stack_DefaultValue = "";
			StackNumber = StackNumber_DefaultValue = null;
			States = States_DefaultValue = new PcSeriesStates();
			Step = Step_DefaultValue = PcSeriesStep.Null;
			StickyTracking = StickyTracking_DefaultValue = true;
			Threshold = Threshold_DefaultValue = 0;
			Tooltip = Tooltip_DefaultValue = new PcSeriesTooltip();
			TopLine = TopLine_DefaultValue = new PcSeriesTopLine();
			...
			Zones = Zones_DefaultValue = new List<PcSeriesZones>();
		...
		/// </summary>
		public PcSeriesAccessibility Accessibility { get; set; }
		private PcSeriesAccessibility Accessibility_DefaultValue { get; set; }
		...
		/// </summary>
		public PcSeriesBoostBlending BoostBlending { get; set; }
		private PcSeriesBoostBlending BoostBlending_DefaultValue { get; set; }
		...
		/// 
		/// </summary>
		public PcSeriesBottomLine BottomLine { get; set; }
		private PcSeriesBottomLine BottomLine_DefaultValue { get; set; }
		...
		/// </summary>
		public PcSeriesCursor Cursor { get; set; }
		private PcSeriesCursor Cursor_DefaultValue { get; set; }
		...
		/// </summary>
		public PcSeriesDashStyle DashStyle { get; set; }
		private PcSeriesDashStyle DashStyle_DefaultValue { get; set; }
		...
		/// </summary>
		public PcSeriesDataGrouping DataGrouping { get; set; }
		private PcSeriesDataGrouping DataGrouping_DefaultValue { get; set; }
		...
		/// </summary>
		public PcSeriesDataLabels DataLabels { get; set; }
		private PcSeriesDataLabels DataLabels_DefaultValue { get; set; }
		 

		/// <summary>
		/// Options for the series data sorting.
		/// </summary>
		public PcSeriesDataSorting DataSorting { get; set; }
		private PcSeriesDataSorting DataSorting_DefaultValue { get; set; }
		...
		/// 
		/// </summary>
		public PcSeriesDumbell Dumbell { get; set; }
		private PcSeriesDumbell Dumbell_DefaultValue { get; set; }
		...
		/// </summary>
		public PcSeriesEvents Events { get; set; }
		private PcSeriesEvents Events_DefaultValue { get; set; }
		...
		/// </summary>
		public PcSeriesFindNearestPointBy FindNearestPointBy { get; set; }
		private PcSeriesFindNearestPointBy FindNearestPointBy_DefaultValue { get; set; }
		...
		/// </summary>
		public PcSeriesGapUnit GapUnit { get; set; }
		private PcSeriesGapUnit GapUnit_DefaultValue { get; set; }
		...
		/// </summary>
		public PcSeriesLabel Label { get; set; }
		private PcSeriesLabel Label_DefaultValue { get; set; }
		 

		/// <summary>
		/// The line marks the last price from all points.
		/// </summary>
		public PcSeriesLastPrice LastPrice { get; set; }
		private PcSeriesLastPrice LastPrice_DefaultValue { get; set; }
		 

		/// <summary>
		/// The line marks the last price from visible range of points.
		/// </summary>
		public PcSeriesLastVisiblePrice LastVisiblePrice { get; set; }
		private PcSeriesLastVisiblePrice LastVisiblePrice_DefaultValue { get; set; }
		...
		/// </summary>
		public PcSeriesLegendSymbol LegendSymbol { get; set; }
		private PcSeriesLegendSymbol LegendSymbol_DefaultValue { get; set; }
		 

		/// <summary>
		/// The line cap used for line ends and line joins on the graph.
		/// </summary>
		public PcSeriesLinecap Linecap { get; set; }
		private PcSeriesLinecap Linecap_DefaultValue { get; set; }
		...
		/// </summary>
		public PcSeriesMarker Marker { get; set; }
		private PcSeriesMarker Marker_DefaultValue { get; set; }
		...
		/// </summary>
		public PcSeriesOnPoint OnPoint { get; set; }
		private PcSeriesOnPoint OnPoint_DefaultValue { get; set; }
		...
		/// </summary>
		public PcSeriesParams Params { get; set; }
		private PcSeriesParams Params_DefaultValue { get; set; }
		 

		/// <summary>
		/// Properties for each single point.
		/// </summary>
		public PcSeriesPoint Point { get; set; }
		private PcSeriesPoint Point_DefaultValue { get; set; }
		...
		/// </summary>
		public PcSeriesSonification Sonification { get; set; }
		private PcSeriesSonification Sonification_DefaultValue { get; set; }
		...
		/// 
		/// </summary>
		public PcSeriesStates States { get; set; }
		private PcSeriesStates States_DefaultValue { get; set; }
		 

		/// <summary>
		/// Whether to apply steps to the line. Possible values are `left`,`center` and `right`.
		/// </summary>
		public PcSeriesStep Step { get; set; }
		private PcSeriesStep Step_DefaultValue { get; set; }
		...
		/// </summary>
		public PcSeriesTooltip Tooltip { get; set; }
		private PcSeriesTooltip Tooltip_DefaultValue { get; set; }
		 

		/// <summary>
		/// 
		/// </summary>
		public PcSeriesTopLine TopLine { get; set; }
		private PcSeriesTopLine TopLine_DefaultValue { get; set; }
		...
		/// </summary>
		public List<PcSeriesZones> Zones { get; set; }
		private List<PcSeriesZones> Zones_DefaultValue { get; set; }
