...
{
	public partial class PcSeriesDragDropDragHandle  : BaseObject
	{
		public PcSeriesDragDropDragHandle()
		{
		...
		internal override Hashtable ToHashtable()
		{
			...
			if (PathFormatter != PathFormatter_DefaultValue) { h.Add("pathFormatter",PathFormatter); Highstock.AddFunction("PcSeriesDragDropDragHandlePathFormatter.pathFormatter", PathFormatter); }  
