...
{
	public partial class PcSeriesOnPoint  : BaseObject
	{
		Hashtable h = new Hashtable();

		public PcSeriesOnPoint()
		{
			ConnectorOptions = ConnectorOptions_DefaultValue = new PcSeriesOnPointConnectorOptions();
			Id = Id_DefaultValue = "";
			Position = Position_DefaultValue = new PcSeriesOnPointPosition();
		...
		/// </summary>
		public PcSeriesOnPointConnectorOptions ConnectorOptions { get; set; }
		private PcSeriesOnPointConnectorOptions ConnectorOptions_DefaultValue { get; set; }
		...
		/// </summary>
		public PcSeriesOnPointPosition Position { get; set; }
		private PcSeriesOnPointPosition Position_DefaultValue { get; set; }
