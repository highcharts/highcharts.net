...
{
	public partial class PcSeriesSonificationContextTracks  : BaseObject
	{
		Hashtable h = new Hashtable();

		public PcSeriesSonificationContextTracks()
		{
			ActiveWhen = ActiveWhen_DefaultValue = new PcSeriesSonificationContextTracksActiveWhen();
			Instrument = Instrument_DefaultValue = null;
			InstrumentString = InstrumentString_DefaultValue = "null";
			Mapping = Mapping_DefaultValue = new PcSeriesSonificationContextTracksMapping();
			MidiName = MidiName_DefaultValue = "";
			PointGrouping = PointGrouping_DefaultValue = new PcSeriesSonificationContextTracksPointGrouping();
			...
			Type = Type_DefaultValue = PcSeriesSonificationContextTracksType.Instrument;
			ValueInterval = ValueInterval_DefaultValue = null;
			ValueMapFunction = ValueMapFunction_DefaultValue = PcSeriesSonificationContextTracksValueMapFunction.Linear;
		...
		/// </summary>
		public PcSeriesSonificationContextTracksActiveWhen ActiveWhen { get; set; }
		private PcSeriesSonificationContextTracksActiveWhen ActiveWhen_DefaultValue { get; set; }
		...
		/// </summary>
		public PcSeriesSonificationContextTracksMapping Mapping { get; set; }
		private PcSeriesSonificationContextTracksMapping Mapping_DefaultValue { get; set; }
		...
		/// </summary>
		public PcSeriesSonificationContextTracksPointGrouping PointGrouping { get; set; }
		private PcSeriesSonificationContextTracksPointGrouping PointGrouping_DefaultValue { get; set; }
		...
		/// </summary>
		public PcSeriesSonificationContextTracksType Type { get; set; }
		private PcSeriesSonificationContextTracksType Type_DefaultValue { get; set; }
		...
		/// </summary>
		public PcSeriesSonificationContextTracksValueMapFunction ValueMapFunction { get; set; }
		private PcSeriesSonificationContextTracksValueMapFunction ValueMapFunction_DefaultValue { get; set; }
