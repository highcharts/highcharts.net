...
{
	public partial class PcSeriesSonificationContextTracksMappingPan  : BaseObject
	{
		Hashtable h = new Hashtable();

		public PcSeriesSonificationContextTracksMappingPan()
		{
			MapFunction = MapFunction_DefaultValue = PcSeriesSonificationContextTracksMappingPanMapFunction.Linear;
			MapTo = MapTo_DefaultValue = "";
			Max = Max_DefaultValue = null;
			Min = Min_DefaultValue = null;
			Value = Value_DefaultValue = null;
			Within = Within_DefaultValue = PcSeriesSonificationContextTracksMappingPanWithin.Chart;
		...
		/// </summary>
		public PcSeriesSonificationContextTracksMappingPanMapFunction MapFunction { get; set; }
		private PcSeriesSonificationContextTracksMappingPanMapFunction MapFunction_DefaultValue { get; set; }
		...
		/// </summary>
		public PcSeriesSonificationContextTracksMappingPanWithin Within { get; set; }
		private PcSeriesSonificationContextTracksMappingPanWithin Within_DefaultValue { get; set; }
