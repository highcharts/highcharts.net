...
{
	public partial class PcSeriesSonificationContextTracksMappingPitch  : BaseObject
	{
		Hashtable h = new Hashtable();

		public PcSeriesSonificationContextTracksMappingPitch()
		{
			MapFunction = MapFunction_DefaultValue = PcSeriesSonificationContextTracksMappingPitchMapFunction.Linear;
		...
		/// </summary>
		public PcSeriesSonificationContextTracksMappingPitchMapFunction MapFunction { get; set; }
		private PcSeriesSonificationContextTracksMappingPitchMapFunction MapFunction_DefaultValue { get; set; }
