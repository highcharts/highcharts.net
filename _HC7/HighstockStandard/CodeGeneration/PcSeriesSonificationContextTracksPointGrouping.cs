...
{
	public partial class PcSeriesSonificationContextTracksPointGrouping  : BaseObject
	{
		Hashtable h = new Hashtable();

		public PcSeriesSonificationContextTracksPointGrouping()
		{
			Algorithm = Algorithm_DefaultValue = PcSeriesSonificationContextTracksPointGroupingAlgorithm.Minimax;
		...
		/// </summary>
		public PcSeriesSonificationContextTracksPointGroupingAlgorithm Algorithm { get; set; }
		private PcSeriesSonificationContextTracksPointGroupingAlgorithm Algorithm_DefaultValue { get; set; }
