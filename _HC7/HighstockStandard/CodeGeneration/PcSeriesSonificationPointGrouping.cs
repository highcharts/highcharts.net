...
{
	public partial class PcSeriesSonificationPointGrouping  : BaseObject
	{
		Hashtable h = new Hashtable();

		public PcSeriesSonificationPointGrouping()
		{
			Algorithm = Algorithm_DefaultValue = PcSeriesSonificationPointGroupingAlgorithm.Minimax;
		...
		/// </summary>
		public PcSeriesSonificationPointGroupingAlgorithm Algorithm { get; set; }
		private PcSeriesSonificationPointGroupingAlgorithm Algorithm_DefaultValue { get; set; }
