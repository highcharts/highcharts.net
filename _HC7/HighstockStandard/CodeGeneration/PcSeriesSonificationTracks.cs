...
{
	public partial class PcSeriesSonificationTracks  : BaseObject
	{
		Hashtable h = new Hashtable();

		public PcSeriesSonificationTracks()
		{
			ActiveWhen = ActiveWhen_DefaultValue = new PcSeriesSonificationTracksActiveWhen();
			Instrument = Instrument_DefaultValue = null;
			InstrumentString = InstrumentString_DefaultValue = "null";
			Mapping = Mapping_DefaultValue = new PcSeriesSonificationTracksMapping();
			MidiName = MidiName_DefaultValue = "";
			PointGrouping = PointGrouping_DefaultValue = new PcSeriesSonificationTracksPointGrouping();
			RoundToMusicalNotes = RoundToMusicalNotes_DefaultValue = true;
			ShowPlayMarker = ShowPlayMarker_DefaultValue = true;
			Type = Type_DefaultValue = PcSeriesSonificationTracksType.Instrument;
		...
		/// </summary>
		public PcSeriesSonificationTracksActiveWhen ActiveWhen { get; set; }
		private PcSeriesSonificationTracksActiveWhen ActiveWhen_DefaultValue { get; set; }
		...
		/// </summary>
		public PcSeriesSonificationTracksMapping Mapping { get; set; }
		private PcSeriesSonificationTracksMapping Mapping_DefaultValue { get; set; }
		...
		/// </summary>
		public PcSeriesSonificationTracksPointGrouping PointGrouping { get; set; }
		private PcSeriesSonificationTracksPointGrouping PointGrouping_DefaultValue { get; set; }
		...
		/// </summary>
		public PcSeriesSonificationTracksType Type { get; set; }
		private PcSeriesSonificationTracksType Type_DefaultValue { get; set; }
