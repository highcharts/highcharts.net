...
{
	public partial class PcSeriesSonificationTracksMapping  : BaseObject
	{
		Hashtable h = new Hashtable();

		public PcSeriesSonificationTracksMapping()
		{
			Frequency = Frequency_DefaultValue = new PcSeriesSonificationTracksMappingFrequency();
			GapBetweenNotes = GapBetweenNotes_DefaultValue = new PcSeriesSonificationTracksMappingGapBetweenNotes();
			Highpass = Highpass_DefaultValue = new PcSeriesSonificationTracksMappingHighpass();
			Lowpass = Lowpass_DefaultValue = new PcSeriesSonificationTracksMappingLowpass();
			NoteDuration = NoteDuration_DefaultValue = new PcSeriesSonificationTracksMappingNoteDuration();
			Pan = Pan_DefaultValue = new PcSeriesSonificationTracksMappingPan();
			Pitch = Pitch_DefaultValue = new PcSeriesSonificationTracksMappingPitch();
			PitchString = PitchString_DefaultValue = "null";
			PitchNumber = PitchNumber_DefaultValue = null;
			PlayDelay = PlayDelay_DefaultValue = new PcSeriesSonificationTracksMappingPlayDelay();
			Time = Time_DefaultValue = new PcSeriesSonificationTracksMappingTime();
			TimeString = TimeString_DefaultValue = "null";
			TimeNumber = TimeNumber_DefaultValue = null;
			Tremolo = Tremolo_DefaultValue = new PcSeriesSonificationTracksMappingTremolo();
			Volume = Volume_DefaultValue = new PcSeriesSonificationTracksMappingVolume();
		...
		/// </summary>
		public PcSeriesSonificationTracksMappingFrequency Frequency { get; set; }
		private PcSeriesSonificationTracksMappingFrequency Frequency_DefaultValue { get; set; }
		...
		/// </summary>
		public PcSeriesSonificationTracksMappingGapBetweenNotes GapBetweenNotes { get; set; }
		private PcSeriesSonificationTracksMappingGapBetweenNotes GapBetweenNotes_DefaultValue { get; set; }
		...
		/// </summary>
		public PcSeriesSonificationTracksMappingHighpass Highpass { get; set; }
		private PcSeriesSonificationTracksMappingHighpass Highpass_DefaultValue { get; set; }
		...
		/// </summary>
		public PcSeriesSonificationTracksMappingLowpass Lowpass { get; set; }
		private PcSeriesSonificationTracksMappingLowpass Lowpass_DefaultValue { get; set; }
		...
		/// </summary>
		public PcSeriesSonificationTracksMappingNoteDuration NoteDuration { get; set; }
		private PcSeriesSonificationTracksMappingNoteDuration NoteDuration_DefaultValue { get; set; }
		...
		/// </summary>
		public PcSeriesSonificationTracksMappingPan Pan { get; set; }
		private PcSeriesSonificationTracksMappingPan Pan_DefaultValue { get; set; }
		...
		/// </summary>
		public PcSeriesSonificationTracksMappingPitch Pitch { get; set; }
		private PcSeriesSonificationTracksMappingPitch Pitch_DefaultValue { get; set; }
		...
		/// </summary>
		public PcSeriesSonificationTracksMappingPlayDelay PlayDelay { get; set; }
		private PcSeriesSonificationTracksMappingPlayDelay PlayDelay_DefaultValue { get; set; }
		...
		/// </summary>
		public PcSeriesSonificationTracksMappingTime Time { get; set; }
		private PcSeriesSonificationTracksMappingTime Time_DefaultValue { get; set; }
		...
		/// </summary>
		public PcSeriesSonificationTracksMappingTremolo Tremolo { get; set; }
		private PcSeriesSonificationTracksMappingTremolo Tremolo_DefaultValue { get; set; }
		 

		/// <summary>
		/// The volume of notes, from 0 to 1.
		/// </summary>
		public PcSeriesSonificationTracksMappingVolume Volume { get; set; }
		private PcSeriesSonificationTracksMappingVolume Volume_DefaultValue { get; set; }
