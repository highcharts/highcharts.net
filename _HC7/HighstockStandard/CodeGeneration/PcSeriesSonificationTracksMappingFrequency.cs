...
{
	public partial class PcSeriesSonificationTracksMappingFrequency  : BaseObject
	{
		Hashtable h = new Hashtable();

		public PcSeriesSonificationTracksMappingFrequency()
		{
			MapFunction = MapFunction_DefaultValue = PcSeriesSonificationTracksMappingFrequencyMapFunction.Linear;
			MapTo = MapTo_DefaultValue = "";
			Max = Max_DefaultValue = null;
			Min = Min_DefaultValue = null;
			Value = Value_DefaultValue = null;
			Within = Within_DefaultValue = PcSeriesSonificationTracksMappingFrequencyWithin.Chart;
		...
		/// </summary>
		public PcSeriesSonificationTracksMappingFrequencyMapFunction MapFunction { get; set; }
		private PcSeriesSonificationTracksMappingFrequencyMapFunction MapFunction_DefaultValue { get; set; }
		...
		/// </summary>
		public PcSeriesSonificationTracksMappingFrequencyWithin Within { get; set; }
		private PcSeriesSonificationTracksMappingFrequencyWithin Within_DefaultValue { get; set; }
