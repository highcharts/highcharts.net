...
{
	public partial class PcSeriesSonificationTracksMappingHighpassResonance  : BaseObject
	{
		Hashtable h = new Hashtable();

		public PcSeriesSonificationTracksMappingHighpassResonance()
		{
			MapFunction = MapFunction_DefaultValue = PcSeriesSonificationTracksMappingHighpassResonanceMapFunction.Linear;
			MapTo = MapTo_DefaultValue = "";
			Max = Max_DefaultValue = null;
			Min = Min_DefaultValue = null;
			Value = Value_DefaultValue = null;
			Within = Within_DefaultValue = PcSeriesSonificationTracksMappingHighpassResonanceWithin.Chart;
		...
		/// </summary>
		public PcSeriesSonificationTracksMappingHighpassResonanceMapFunction MapFunction { get; set; }
		private PcSeriesSonificationTracksMappingHighpassResonanceMapFunction MapFunction_DefaultValue { get; set; }
		...
		/// </summary>
		public PcSeriesSonificationTracksMappingHighpassResonanceWithin Within { get; set; }
		private PcSeriesSonificationTracksMappingHighpassResonanceWithin Within_DefaultValue { get; set; }
