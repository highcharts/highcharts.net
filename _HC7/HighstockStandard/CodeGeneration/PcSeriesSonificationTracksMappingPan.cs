...
{
	public partial class PcSeriesSonificationTracksMappingPan  : BaseObject
	{
		Hashtable h = new Hashtable();

		public PcSeriesSonificationTracksMappingPan()
		{
			MapFunction = MapFunction_DefaultValue = PcSeriesSonificationTracksMappingPanMapFunction.Linear;
			MapTo = MapTo_DefaultValue = "";
			Max = Max_DefaultValue = null;
			Min = Min_DefaultValue = null;
			Value = Value_DefaultValue = null;
			Within = Within_DefaultValue = PcSeriesSonificationTracksMappingPanWithin.Chart;
		...
		/// </summary>
		public PcSeriesSonificationTracksMappingPanMapFunction MapFunction { get; set; }
		private PcSeriesSonificationTracksMappingPanMapFunction MapFunction_DefaultValue { get; set; }
		...
		/// </summary>
		public PcSeriesSonificationTracksMappingPanWithin Within { get; set; }
		private PcSeriesSonificationTracksMappingPanWithin Within_DefaultValue { get; set; }
