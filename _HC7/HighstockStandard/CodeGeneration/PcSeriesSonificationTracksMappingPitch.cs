...
{
	public partial class PcSeriesSonificationTracksMappingPitch  : BaseObject
	{
		Hashtable h = new Hashtable();

		public PcSeriesSonificationTracksMappingPitch()
		{
			MapFunction = MapFunction_DefaultValue = PcSeriesSonificationTracksMappingPitchMapFunction.Linear;
		...
		/// </summary>
		public PcSeriesSonificationTracksMappingPitchMapFunction MapFunction { get; set; }
		private PcSeriesSonificationTracksMappingPitchMapFunction MapFunction_DefaultValue { get; set; }
