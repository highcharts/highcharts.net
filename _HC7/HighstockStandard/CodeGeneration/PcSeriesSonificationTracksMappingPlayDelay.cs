...
{
	public partial class PcSeriesSonificationTracksMappingPlayDelay  : BaseObject
	{
		Hashtable h = new Hashtable();

		public PcSeriesSonificationTracksMappingPlayDelay()
		{
			MapFunction = MapFunction_DefaultValue = PcSeriesSonificationTracksMappingPlayDelayMapFunction.Linear;
			MapTo = MapTo_DefaultValue = "";
			Max = Max_DefaultValue = null;
			Min = Min_DefaultValue = null;
			Value = Value_DefaultValue = null;
			Within = Within_DefaultValue = PcSeriesSonificationTracksMappingPlayDelayWithin.Chart;
		...
		/// </summary>
		public PcSeriesSonificationTracksMappingPlayDelayMapFunction MapFunction { get; set; }
		private PcSeriesSonificationTracksMappingPlayDelayMapFunction MapFunction_DefaultValue { get; set; }
		...
		/// </summary>
		public PcSeriesSonificationTracksMappingPlayDelayWithin Within { get; set; }
		private PcSeriesSonificationTracksMappingPlayDelayWithin Within_DefaultValue { get; set; }
