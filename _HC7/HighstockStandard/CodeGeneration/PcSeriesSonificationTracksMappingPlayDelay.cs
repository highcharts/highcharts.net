...
namespace Highsoft.Web.Mvc.Stocks
{
	public partial class PcSeriesSonificationTracksMappingPlayDelay  : BaseObject
	{
		...
		{
			if (MapFunction != PcSeriesSonificationTracksMappingPlayDelayMapFunction.Null) h.Add("mapFunction", highstock.FirstCharacterToLower(MapFunction.ToString()));
			if (MapTo != null) h.Add("mapTo",MapTo);
			if (Max != null) h.Add("max",Max);
			if (Min != null) h.Add("min",Min);
			if (Value != null) h.Add("value",Value);
			if (Within != PcSeriesSonificationTracksMappingPlayDelayWithin.Null) h.Add("within", highstock.FirstCharacterToLower(Within.ToString()));
