...
{
	public partial class PcSeriesSonificationTracksMappingTime  : BaseObject
	{
		Hashtable h = new Hashtable();

		public PcSeriesSonificationTracksMappingTime()
		{
			MapFunction = MapFunction_DefaultValue = PcSeriesSonificationTracksMappingTimeMapFunction.Linear;
			MapTo = MapTo_DefaultValue = "";
			Max = Max_DefaultValue = null;
			Min = Min_DefaultValue = null;
			Value = Value_DefaultValue = null;
			Within = Within_DefaultValue = PcSeriesSonificationTracksMappingTimeWithin.Chart;
		...
		/// </summary>
		public PcSeriesSonificationTracksMappingTimeMapFunction MapFunction { get; set; }
		private PcSeriesSonificationTracksMappingTimeMapFunction MapFunction_DefaultValue { get; set; }
		...
		/// </summary>
		public PcSeriesSonificationTracksMappingTimeWithin Within { get; set; }
		private PcSeriesSonificationTracksMappingTimeWithin Within_DefaultValue { get; set; }
