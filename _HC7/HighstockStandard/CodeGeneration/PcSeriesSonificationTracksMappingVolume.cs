...
{
	public partial class PcSeriesSonificationTracksMappingVolume  : BaseObject
	{
		Hashtable h = new Hashtable();

		public PcSeriesSonificationTracksMappingVolume()
		{
			MapFunction = MapFunction_DefaultValue = PcSeriesSonificationTracksMappingVolumeMapFunction.Linear;
			MapTo = MapTo_DefaultValue = "";
			Max = Max_DefaultValue = null;
			Min = Min_DefaultValue = null;
			Value = Value_DefaultValue = null;
			Within = Within_DefaultValue = PcSeriesSonificationTracksMappingVolumeWithin.Chart;
		...
		/// </summary>
		public PcSeriesSonificationTracksMappingVolumeMapFunction MapFunction { get; set; }
		private PcSeriesSonificationTracksMappingVolumeMapFunction MapFunction_DefaultValue { get; set; }
		...
		/// </summary>
		public PcSeriesSonificationTracksMappingVolumeWithin Within { get; set; }
		private PcSeriesSonificationTracksMappingVolumeWithin Within_DefaultValue { get; set; }
