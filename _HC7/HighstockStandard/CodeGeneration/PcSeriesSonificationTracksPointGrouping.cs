...
{
	public partial class PcSeriesSonificationTracksPointGrouping  : BaseObject
	{
		Hashtable h = new Hashtable();

		public PcSeriesSonificationTracksPointGrouping()
		{
			Algorithm = Algorithm_DefaultValue = PcSeriesSonificationTracksPointGroupingAlgorithm.Minimax;
		...
		/// </summary>
		public PcSeriesSonificationTracksPointGroupingAlgorithm Algorithm { get; set; }
		private PcSeriesSonificationTracksPointGroupingAlgorithm Algorithm_DefaultValue { get; set; }
