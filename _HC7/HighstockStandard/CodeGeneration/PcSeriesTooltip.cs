...
{
	public partial class PcSeriesTooltip  : BaseObject
	{
		public PcSeriesTooltip()
		{
			...
			HeaderShape = HeaderShape_DefaultValue = PcSeriesTooltipHeaderShape.Callout;
		...
		/// </summary>
		public PcSeriesTooltipHeaderShape HeaderShape { get; set; }
		private PcSeriesTooltipHeaderShape HeaderShape_DefaultValue { get; set; }
		...
		internal override Hashtable ToHashtable()
		{
			...
			if (NullFormatter != NullFormatter_DefaultValue) { h.Add("nullFormatter",NullFormatter); Highstock.AddFunction("PcSeriesTooltipNullFormatter.nullFormatter", NullFormatter); }  
			if (Outside != Outside_DefaultValue) h.Add("outside",Outside);
			if (Padding != Padding_DefaultValue) h.Add("padding",Padding);
			if (PointFormat != PointFormat_DefaultValue) h.Add("pointFormat",PointFormat);
			if (PointFormatter != PointFormatter_DefaultValue) { h.Add("pointFormatter",PointFormatter); Highstock.AddFunction("PcSeriesTooltipPointFormatter.pointFormatter", PointFormatter); }  
