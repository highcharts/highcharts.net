...
{
	public partial class PivotpointsSeries  : Series
	{
		Hashtable h = new Hashtable();

		public PivotpointsSeries()
		{
			Accessibility = Accessibility_DefaultValue = new PivotpointsSeriesAccessibility();
			AllowPointSelect = AllowPointSelect_DefaultValue = false;
			Animation = Animation_DefaultValue = new Animation() { Enabled = true };
			AnimationBool = AnimationBool_DefaultValue = true;
			AnimationLimit = AnimationLimit_DefaultValue = null;
			BoostBlending = BoostBlending_DefaultValue = PivotpointsSeriesBoostBlending.Undefined;
			...
			Compare = Compare_DefaultValue = PivotpointsSeriesCompare.Percent;
			CompareBase = CompareBase_DefaultValue = PivotpointsSeriesCompareBase.Min;
			...
			Cursor = Cursor_DefaultValue = PivotpointsSeriesCursor.Null;
			Custom = Custom_DefaultValue = new Hashtable();
			DashStyle = DashStyle_DefaultValue = PivotpointsSeriesDashStyle.Null;
			DataGrouping = DataGrouping_DefaultValue = new PivotpointsSeriesDataGrouping();
			DataLabels = DataLabels_DefaultValue = new PivotpointsSeriesDataLabels();
			DataSorting = DataSorting_DefaultValue = new PivotpointsSeriesDataSorting();
			Description = Description_DefaultValue = "";
			Dumbell = Dumbell_DefaultValue = new PivotpointsSeriesDumbell();
			EnableMouseTracking = EnableMouseTracking_DefaultValue = true;
			Events = Events_DefaultValue = new PivotpointsSeriesEvents();
			FindNearestPointBy = FindNearestPointBy_DefaultValue = PivotpointsSeriesFindNearestPointBy.X;
			GapSize = GapSize_DefaultValue = 0;
			GapUnit = GapUnit_DefaultValue = PivotpointsSeriesGapUnit.Relative;
			GetExtremesFromAll = GetExtremesFromAll_DefaultValue = false;
			Id = Id_DefaultValue = "";
			InactiveOtherPoints = InactiveOtherPoints_DefaultValue = false;
			IncludeInDataExport = IncludeInDataExport_DefaultValue = null;
			Index = Index_DefaultValue = null;
			Label = Label_DefaultValue = new PivotpointsSeriesLabel();
			LastPrice = LastPrice_DefaultValue = new PivotpointsSeriesLastPrice();
			LastVisiblePrice = LastVisiblePrice_DefaultValue = new PivotpointsSeriesLastVisiblePrice();
			LegendIndex = LegendIndex_DefaultValue = null;
			LegendSymbol = LegendSymbol_DefaultValue = PivotpointsSeriesLegendSymbol.Rectangle;
			Linecap = Linecap_DefaultValue = PivotpointsSeriesLinecap.Round;
			LineWidth = LineWidth_DefaultValue = 2;
			LinkedTo = LinkedTo_DefaultValue = "";
			Marker = Marker_DefaultValue = new PivotpointsSeriesMarker();
			Name = Name_DefaultValue = "";
			NegativeColor = NegativeColor_DefaultValue = "";
			OnPoint = OnPoint_DefaultValue = new PivotpointsSeriesOnPoint();
			Opacity = Opacity_DefaultValue = 1;
			Params = Params_DefaultValue = new PivotpointsSeriesParams();
			Point = Point_DefaultValue = new PivotpointsSeriesPoint();
			...
			Sonification = Sonification_DefaultValue = new PivotpointsSeriesSonification();
			Stack = Stack_DefaultValue = "";
			StackNumber = StackNumber_DefaultValue = null;
			States = States_DefaultValue = new PivotpointsSeriesStates();
			Step = Step_DefaultValue = PivotpointsSeriesStep.Null;
			StickyTracking = StickyTracking_DefaultValue = true;
			Threshold = Threshold_DefaultValue = 0;
			Tooltip = Tooltip_DefaultValue = new PivotpointsSeriesTooltip();
			...
			Zones = Zones_DefaultValue = new List<PivotpointsSeriesZones>();
		...
		/// </summary>
		public PivotpointsSeriesAccessibility Accessibility { get; set; }
		private PivotpointsSeriesAccessibility Accessibility_DefaultValue { get; set; }
		...
		/// </summary>
		public PivotpointsSeriesBoostBlending BoostBlending { get; set; }
		private PivotpointsSeriesBoostBlending BoostBlending_DefaultValue { get; set; }
		...
		/// </summary>
		public PivotpointsSeriesCompare Compare { get; set; }
		private PivotpointsSeriesCompare Compare_DefaultValue { get; set; }
		 

		/// <summary>
		/// When [compare](#plotOptions.series.compare) is `percent`, this optiondictates whether to use 0 or 100 as the base of comparison.
		/// </summary>
		public PivotpointsSeriesCompareBase CompareBase { get; set; }
		private PivotpointsSeriesCompareBase CompareBase_DefaultValue { get; set; }
		...
		/// </summary>
		public PivotpointsSeriesCursor Cursor { get; set; }
		private PivotpointsSeriesCursor Cursor_DefaultValue { get; set; }
		...
		/// </summary>
		public PivotpointsSeriesDashStyle DashStyle { get; set; }
		private PivotpointsSeriesDashStyle DashStyle_DefaultValue { get; set; }
		...
		/// </summary>
		public PivotpointsSeriesDataGrouping DataGrouping { get; set; }
		private PivotpointsSeriesDataGrouping DataGrouping_DefaultValue { get; set; }
		...
		/// </summary>
		public PivotpointsSeriesDataLabels DataLabels { get; set; }
		private PivotpointsSeriesDataLabels DataLabels_DefaultValue { get; set; }
		 

		/// <summary>
		/// Options for the series data sorting.
		/// </summary>
		public PivotpointsSeriesDataSorting DataSorting { get; set; }
		private PivotpointsSeriesDataSorting DataSorting_DefaultValue { get; set; }
		...
		/// 
		/// </summary>
		public PivotpointsSeriesDumbell Dumbell { get; set; }
		private PivotpointsSeriesDumbell Dumbell_DefaultValue { get; set; }
		...
		/// </summary>
		public PivotpointsSeriesEvents Events { get; set; }
		private PivotpointsSeriesEvents Events_DefaultValue { get; set; }
		...
		/// </summary>
		public PivotpointsSeriesFindNearestPointBy FindNearestPointBy { get; set; }
		private PivotpointsSeriesFindNearestPointBy FindNearestPointBy_DefaultValue { get; set; }
		...
		/// </summary>
		public PivotpointsSeriesGapUnit GapUnit { get; set; }
		private PivotpointsSeriesGapUnit GapUnit_DefaultValue { get; set; }
		...
		/// </summary>
		public PivotpointsSeriesLabel Label { get; set; }
		private PivotpointsSeriesLabel Label_DefaultValue { get; set; }
		 

		/// <summary>
		/// The line marks the last price from all points.
		/// </summary>
		public PivotpointsSeriesLastPrice LastPrice { get; set; }
		private PivotpointsSeriesLastPrice LastPrice_DefaultValue { get; set; }
		 

		/// <summary>
		/// The line marks the last price from visible range of points.
		/// </summary>
		public PivotpointsSeriesLastVisiblePrice LastVisiblePrice { get; set; }
		private PivotpointsSeriesLastVisiblePrice LastVisiblePrice_DefaultValue { get; set; }
		...
		/// </summary>
		public PivotpointsSeriesLegendSymbol LegendSymbol { get; set; }
		private PivotpointsSeriesLegendSymbol LegendSymbol_DefaultValue { get; set; }
		 

		/// <summary>
		/// The line cap used for line ends and line joins on the graph.
		/// </summary>
		public PivotpointsSeriesLinecap Linecap { get; set; }
		private PivotpointsSeriesLinecap Linecap_DefaultValue { get; set; }
		...
		/// </summary>
		public PivotpointsSeriesMarker Marker { get; set; }
		private PivotpointsSeriesMarker Marker_DefaultValue { get; set; }
		...
		/// </summary>
		public PivotpointsSeriesOnPoint OnPoint { get; set; }
		private PivotpointsSeriesOnPoint OnPoint_DefaultValue { get; set; }
		...
		/// </summary>
		public PivotpointsSeriesParams Params { get; set; }
		private PivotpointsSeriesParams Params_DefaultValue { get; set; }
		 

		/// <summary>
		/// Properties for each single point.
		/// </summary>
		public PivotpointsSeriesPoint Point { get; set; }
		private PivotpointsSeriesPoint Point_DefaultValue { get; set; }
		...
		/// </summary>
		public PivotpointsSeriesSonification Sonification { get; set; }
		private PivotpointsSeriesSonification Sonification_DefaultValue { get; set; }
		...
		/// 
		/// </summary>
		public PivotpointsSeriesStates States { get; set; }
		private PivotpointsSeriesStates States_DefaultValue { get; set; }
		 

		/// <summary>
		/// Whether to apply steps to the line. Possible values are `left`,`center` and `right`.
		/// </summary>
		public PivotpointsSeriesStep Step { get; set; }
		private PivotpointsSeriesStep Step_DefaultValue { get; set; }
		...
		/// </summary>
		public PivotpointsSeriesTooltip Tooltip { get; set; }
		private PivotpointsSeriesTooltip Tooltip_DefaultValue { get; set; }
		...
		/// </summary>
		public List<PivotpointsSeriesZones> Zones { get; set; }
		private List<PivotpointsSeriesZones> Zones_DefaultValue { get; set; }
