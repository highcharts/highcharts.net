...
namespace Highsoft.Web.Mvc.Stocks
{
	public partial class PivotpointsSeries  : Series
	{
		...
		public PivotpointsSeries()
		{
			...
			Zones = Zones_DefaultValue = new List<PivotpointsSeriesZone>();
		...
		/// </summary>
		public List<PivotpointsSeriesZone> Zones { get; set; }
		private List<PivotpointsSeriesZone> Zones_DefaultValue { get; set; }
