...
namespace Highsoft.Web.Mvc.Stocks
{
	public partial class PivotpointsSeriesDataGrouping  : BaseObject
	{
		...
		internal override Hashtable ToHashtable()
		{
			...
			if (Approximation != Approximation_DefaultValue) { h.Add("approximation",Approximation); Highstock.AddFunction("PivotpointsSeriesDataGroupingApproximation.approximation", Approximation); }  
