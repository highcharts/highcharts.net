...
namespace Highsoft.Web.Mvc.Stocks
{
	public partial class PivotpointsSeriesMarkerStates  : BaseObject
	{
		public PivotpointsSeriesMarkerStates()
		{
			...
			Inactive = Inactive_DefaultValue = new PivotpointsSeriesMarkerStatesInactive();
		...
		/// 
		/// </summary>
		public PivotpointsSeriesMarkerStatesInactive Inactive { get; set; }
		private PivotpointsSeriesMarkerStatesInactive Inactive_DefaultValue { get; set; }
