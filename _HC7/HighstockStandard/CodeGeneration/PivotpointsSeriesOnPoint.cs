...
{
	public partial class PivotpointsSeriesOnPoint  : BaseObject
	{
		Hashtable h = new Hashtable();

		public PivotpointsSeriesOnPoint()
		{
			ConnectorOptions = ConnectorOptions_DefaultValue = new PivotpointsSeriesOnPointConnectorOptions();
			Id = Id_DefaultValue = "";
			Position = Position_DefaultValue = new PivotpointsSeriesOnPointPosition();
		...
		/// </summary>
		public PivotpointsSeriesOnPointConnectorOptions ConnectorOptions { get; set; }
		private PivotpointsSeriesOnPointConnectorOptions ConnectorOptions_DefaultValue { get; set; }
		...
		/// </summary>
		public PivotpointsSeriesOnPointPosition Position { get; set; }
		private PivotpointsSeriesOnPointPosition Position_DefaultValue { get; set; }
