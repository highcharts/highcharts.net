...
{
	public partial class PivotpointsSeriesSonificationContextTracks  : BaseObject
	{
		Hashtable h = new Hashtable();

		public PivotpointsSeriesSonificationContextTracks()
		{
			ActiveWhen = ActiveWhen_DefaultValue = new PivotpointsSeriesSonificationContextTracksActiveWhen();
			Instrument = Instrument_DefaultValue = null;
			InstrumentString = InstrumentString_DefaultValue = "null";
			Mapping = Mapping_DefaultValue = new PivotpointsSeriesSonificationContextTracksMapping();
			MidiName = MidiName_DefaultValue = "";
			PointGrouping = PointGrouping_DefaultValue = new PivotpointsSeriesSonificationContextTracksPointGrouping();
			...
			Type = Type_DefaultValue = PivotpointsSeriesSonificationContextTracksType.Instrument;
			ValueInterval = ValueInterval_DefaultValue = null;
			ValueMapFunction = ValueMapFunction_DefaultValue = PivotpointsSeriesSonificationContextTracksValueMapFunction.Linear;
		...
		/// </summary>
		public PivotpointsSeriesSonificationContextTracksActiveWhen ActiveWhen { get; set; }
		private PivotpointsSeriesSonificationContextTracksActiveWhen ActiveWhen_DefaultValue { get; set; }
		...
		/// </summary>
		public PivotpointsSeriesSonificationContextTracksMapping Mapping { get; set; }
		private PivotpointsSeriesSonificationContextTracksMapping Mapping_DefaultValue { get; set; }
		...
		/// </summary>
		public PivotpointsSeriesSonificationContextTracksPointGrouping PointGrouping { get; set; }
		private PivotpointsSeriesSonificationContextTracksPointGrouping PointGrouping_DefaultValue { get; set; }
		...
		/// </summary>
		public PivotpointsSeriesSonificationContextTracksType Type { get; set; }
		private PivotpointsSeriesSonificationContextTracksType Type_DefaultValue { get; set; }
		...
		/// </summary>
		public PivotpointsSeriesSonificationContextTracksValueMapFunction ValueMapFunction { get; set; }
		private PivotpointsSeriesSonificationContextTracksValueMapFunction ValueMapFunction_DefaultValue { get; set; }
