...
{
	public partial class PivotpointsSeriesSonificationContextTracksMapping  : BaseObject
	{
		Hashtable h = new Hashtable();

		public PivotpointsSeriesSonificationContextTracksMapping()
		{
			Frequency = Frequency_DefaultValue = new PivotpointsSeriesSonificationContextTracksMappingFrequency();
			GapBetweenNotes = GapBetweenNotes_DefaultValue = new PivotpointsSeriesSonificationContextTracksMappingGapBetweenNotes();
			Highpass = Highpass_DefaultValue = new PivotpointsSeriesSonificationContextTracksMappingHighpass();
			Lowpass = Lowpass_DefaultValue = new PivotpointsSeriesSonificationContextTracksMappingLowpass();
			NoteDuration = NoteDuration_DefaultValue = new PivotpointsSeriesSonificationContextTracksMappingNoteDuration();
			Pan = Pan_DefaultValue = new PivotpointsSeriesSonificationContextTracksMappingPan();
			Pitch = Pitch_DefaultValue = new PivotpointsSeriesSonificationContextTracksMappingPitch();
			PitchString = PitchString_DefaultValue = "null";
			PitchNumber = PitchNumber_DefaultValue = null;
			PlayDelay = PlayDelay_DefaultValue = new PivotpointsSeriesSonificationContextTracksMappingPlayDelay();
			Time = Time_DefaultValue = new PivotpointsSeriesSonificationContextTracksMappingTime();
			TimeString = TimeString_DefaultValue = "null";
			TimeNumber = TimeNumber_DefaultValue = null;
			Tremolo = Tremolo_DefaultValue = new PivotpointsSeriesSonificationContextTracksMappingTremolo();
			Volume = Volume_DefaultValue = new PivotpointsSeriesSonificationContextTracksMappingVolume();
		...
		/// </summary>
		public PivotpointsSeriesSonificationContextTracksMappingFrequency Frequency { get; set; }
		private PivotpointsSeriesSonificationContextTracksMappingFrequency Frequency_DefaultValue { get; set; }
		...
		/// </summary>
		public PivotpointsSeriesSonificationContextTracksMappingGapBetweenNotes GapBetweenNotes { get; set; }
		private PivotpointsSeriesSonificationContextTracksMappingGapBetweenNotes GapBetweenNotes_DefaultValue { get; set; }
		...
		/// </summary>
		public PivotpointsSeriesSonificationContextTracksMappingHighpass Highpass { get; set; }
		private PivotpointsSeriesSonificationContextTracksMappingHighpass Highpass_DefaultValue { get; set; }
		...
		/// </summary>
		public PivotpointsSeriesSonificationContextTracksMappingLowpass Lowpass { get; set; }
		private PivotpointsSeriesSonificationContextTracksMappingLowpass Lowpass_DefaultValue { get; set; }
		...
		/// </summary>
		public PivotpointsSeriesSonificationContextTracksMappingNoteDuration NoteDuration { get; set; }
		private PivotpointsSeriesSonificationContextTracksMappingNoteDuration NoteDuration_DefaultValue { get; set; }
		...
		/// </summary>
		public PivotpointsSeriesSonificationContextTracksMappingPan Pan { get; set; }
		private PivotpointsSeriesSonificationContextTracksMappingPan Pan_DefaultValue { get; set; }
		...
		/// </summary>
		public PivotpointsSeriesSonificationContextTracksMappingPitch Pitch { get; set; }
		private PivotpointsSeriesSonificationContextTracksMappingPitch Pitch_DefaultValue { get; set; }
		...
		/// </summary>
		public PivotpointsSeriesSonificationContextTracksMappingPlayDelay PlayDelay { get; set; }
		private PivotpointsSeriesSonificationContextTracksMappingPlayDelay PlayDelay_DefaultValue { get; set; }
		...
		/// </summary>
		public PivotpointsSeriesSonificationContextTracksMappingTime Time { get; set; }
		private PivotpointsSeriesSonificationContextTracksMappingTime Time_DefaultValue { get; set; }
		...
		/// </summary>
		public PivotpointsSeriesSonificationContextTracksMappingTremolo Tremolo { get; set; }
		private PivotpointsSeriesSonificationContextTracksMappingTremolo Tremolo_DefaultValue { get; set; }
		 

		/// <summary>
		/// The volume of notes, from 0 to 1.
		/// </summary>
		public PivotpointsSeriesSonificationContextTracksMappingVolume Volume { get; set; }
		private PivotpointsSeriesSonificationContextTracksMappingVolume Volume_DefaultValue { get; set; }
