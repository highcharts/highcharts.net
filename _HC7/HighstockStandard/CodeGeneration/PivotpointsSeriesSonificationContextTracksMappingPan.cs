...
{
	public partial class PivotpointsSeriesSonificationContextTracksMappingPan  : BaseObject
	{
		Hashtable h = new Hashtable();

		public PivotpointsSeriesSonificationContextTracksMappingPan()
		{
			MapFunction = MapFunction_DefaultValue = PivotpointsSeriesSonificationContextTracksMappingPanMapFunction.Linear;
			MapTo = MapTo_DefaultValue = "";
			Max = Max_DefaultValue = null;
			Min = Min_DefaultValue = null;
			Value = Value_DefaultValue = null;
			Within = Within_DefaultValue = PivotpointsSeriesSonificationContextTracksMappingPanWithin.Chart;
		...
		/// </summary>
		public PivotpointsSeriesSonificationContextTracksMappingPanMapFunction MapFunction { get; set; }
		private PivotpointsSeriesSonificationContextTracksMappingPanMapFunction MapFunction_DefaultValue { get; set; }
		...
		/// </summary>
		public PivotpointsSeriesSonificationContextTracksMappingPanWithin Within { get; set; }
		private PivotpointsSeriesSonificationContextTracksMappingPanWithin Within_DefaultValue { get; set; }
