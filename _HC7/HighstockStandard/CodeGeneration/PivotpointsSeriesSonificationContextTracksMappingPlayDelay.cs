...
{
	public partial class PivotpointsSeriesSonificationContextTracksMappingPlayDelay  : BaseObject
	{
		Hashtable h = new Hashtable();

		public PivotpointsSeriesSonificationContextTracksMappingPlayDelay()
		{
			MapFunction = MapFunction_DefaultValue = PivotpointsSeriesSonificationContextTracksMappingPlayDelayMapFunction.Linear;
			MapTo = MapTo_DefaultValue = "";
			Max = Max_DefaultValue = null;
			Min = Min_DefaultValue = null;
			Value = Value_DefaultValue = null;
			Within = Within_DefaultValue = PivotpointsSeriesSonificationContextTracksMappingPlayDelayWithin.Chart;
		...
		/// </summary>
		public PivotpointsSeriesSonificationContextTracksMappingPlayDelayMapFunction MapFunction { get; set; }
		private PivotpointsSeriesSonificationContextTracksMappingPlayDelayMapFunction MapFunction_DefaultValue { get; set; }
		...
		/// </summary>
		public PivotpointsSeriesSonificationContextTracksMappingPlayDelayWithin Within { get; set; }
		private PivotpointsSeriesSonificationContextTracksMappingPlayDelayWithin Within_DefaultValue { get; set; }
