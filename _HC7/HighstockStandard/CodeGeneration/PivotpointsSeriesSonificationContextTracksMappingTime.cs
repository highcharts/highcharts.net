...
{
	public partial class PivotpointsSeriesSonificationContextTracksMappingTime  : BaseObject
	{
		Hashtable h = new Hashtable();

		public PivotpointsSeriesSonificationContextTracksMappingTime()
		{
			MapFunction = MapFunction_DefaultValue = PivotpointsSeriesSonificationContextTracksMappingTimeMapFunction.Linear;
			MapTo = MapTo_DefaultValue = "";
			Max = Max_DefaultValue = null;
			Min = Min_DefaultValue = null;
			Value = Value_DefaultValue = null;
			Within = Within_DefaultValue = PivotpointsSeriesSonificationContextTracksMappingTimeWithin.Chart;
		...
		/// </summary>
		public PivotpointsSeriesSonificationContextTracksMappingTimeMapFunction MapFunction { get; set; }
		private PivotpointsSeriesSonificationContextTracksMappingTimeMapFunction MapFunction_DefaultValue { get; set; }
		...
		/// </summary>
		public PivotpointsSeriesSonificationContextTracksMappingTimeWithin Within { get; set; }
		private PivotpointsSeriesSonificationContextTracksMappingTimeWithin Within_DefaultValue { get; set; }
