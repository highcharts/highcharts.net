...
{
	public partial class PivotpointsSeriesSonificationContextTracksMappingVolume  : BaseObject
	{
		Hashtable h = new Hashtable();

		public PivotpointsSeriesSonificationContextTracksMappingVolume()
		{
			MapFunction = MapFunction_DefaultValue = PivotpointsSeriesSonificationContextTracksMappingVolumeMapFunction.Linear;
			MapTo = MapTo_DefaultValue = "";
			Max = Max_DefaultValue = null;
			Min = Min_DefaultValue = null;
			Value = Value_DefaultValue = null;
			Within = Within_DefaultValue = PivotpointsSeriesSonificationContextTracksMappingVolumeWithin.Chart;
		...
		/// </summary>
		public PivotpointsSeriesSonificationContextTracksMappingVolumeMapFunction MapFunction { get; set; }
		private PivotpointsSeriesSonificationContextTracksMappingVolumeMapFunction MapFunction_DefaultValue { get; set; }
		...
		/// </summary>
		public PivotpointsSeriesSonificationContextTracksMappingVolumeWithin Within { get; set; }
		private PivotpointsSeriesSonificationContextTracksMappingVolumeWithin Within_DefaultValue { get; set; }
