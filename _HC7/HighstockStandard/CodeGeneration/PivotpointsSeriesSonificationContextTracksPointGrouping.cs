...
{
	public partial class PivotpointsSeriesSonificationContextTracksPointGrouping  : BaseObject
	{
		Hashtable h = new Hashtable();

		public PivotpointsSeriesSonificationContextTracksPointGrouping()
		{
			Algorithm = Algorithm_DefaultValue = PivotpointsSeriesSonificationContextTracksPointGroupingAlgorithm.Minimax;
		...
		/// </summary>
		public PivotpointsSeriesSonificationContextTracksPointGroupingAlgorithm Algorithm { get; set; }
		private PivotpointsSeriesSonificationContextTracksPointGroupingAlgorithm Algorithm_DefaultValue { get; set; }
