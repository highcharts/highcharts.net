...
{
	public partial class PivotpointsSeriesSonificationDefaultSpeechOptions  : BaseObject
	{
		Hashtable h = new Hashtable();

		public PivotpointsSeriesSonificationDefaultSpeechOptions()
		{
			ActiveWhen = ActiveWhen_DefaultValue = new PivotpointsSeriesSonificationDefaultSpeechOptionsActiveWhen();
			Language = Language_DefaultValue = "en-US";
			Mapping = Mapping_DefaultValue = new PivotpointsSeriesSonificationDefaultSpeechOptionsMapping();
			PointGrouping = PointGrouping_DefaultValue = new PivotpointsSeriesSonificationDefaultSpeechOptionsPointGrouping();
			PreferredVoice = PreferredVoice_DefaultValue = "";
			ShowPlayMarker = ShowPlayMarker_DefaultValue = true;
			Type = Type_DefaultValue = PivotpointsSeriesSonificationDefaultSpeechOptionsType.Instrument;
		...
		/// </summary>
		public PivotpointsSeriesSonificationDefaultSpeechOptionsActiveWhen ActiveWhen { get; set; }
		private PivotpointsSeriesSonificationDefaultSpeechOptionsActiveWhen ActiveWhen_DefaultValue { get; set; }
		...
		/// </summary>
		public PivotpointsSeriesSonificationDefaultSpeechOptionsMapping Mapping { get; set; }
		private PivotpointsSeriesSonificationDefaultSpeechOptionsMapping Mapping_DefaultValue { get; set; }
		 

		/// <summary>
		/// Options for point grouping, specifically for instrument tracks.
		/// </summary>
		public PivotpointsSeriesSonificationDefaultSpeechOptionsPointGrouping PointGrouping { get; set; }
		private PivotpointsSeriesSonificationDefaultSpeechOptionsPointGrouping PointGrouping_DefaultValue { get; set; }
		...
		/// </summary>
		public PivotpointsSeriesSonificationDefaultSpeechOptionsType Type { get; set; }
		private PivotpointsSeriesSonificationDefaultSpeechOptionsType Type_DefaultValue { get; set; }
