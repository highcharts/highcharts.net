...
{
	public partial class PivotpointsSeriesSonificationDefaultSpeechOptionsMapping  : BaseObject
	{
		Hashtable h = new Hashtable();

		public PivotpointsSeriesSonificationDefaultSpeechOptionsMapping()
		{
			Frequency = Frequency_DefaultValue = new PivotpointsSeriesSonificationDefaultSpeechOptionsMappingFrequency();
			GapBetweenNotes = GapBetweenNotes_DefaultValue = new PivotpointsSeriesSonificationDefaultSpeechOptionsMappingGapBetweenNotes();
			Highpass = Highpass_DefaultValue = new PivotpointsSeriesSonificationDefaultSpeechOptionsMappingHighpass();
			Lowpass = Lowpass_DefaultValue = new PivotpointsSeriesSonificationDefaultSpeechOptionsMappingLowpass();
			NoteDuration = NoteDuration_DefaultValue = new PivotpointsSeriesSonificationDefaultSpeechOptionsMappingNoteDuration();
			Pan = Pan_DefaultValue = new PivotpointsSeriesSonificationDefaultSpeechOptionsMappingPan();
			Pitch = Pitch_DefaultValue = new PivotpointsSeriesSonificationDefaultSpeechOptionsMappingPitch();
			PitchString = PitchString_DefaultValue = "null";
			PitchNumber = PitchNumber_DefaultValue = null;
			PlayDelay = PlayDelay_DefaultValue = new PivotpointsSeriesSonificationDefaultSpeechOptionsMappingPlayDelay();
			Time = Time_DefaultValue = new PivotpointsSeriesSonificationDefaultSpeechOptionsMappingTime();
			TimeString = TimeString_DefaultValue = "null";
			TimeNumber = TimeNumber_DefaultValue = null;
			Tremolo = Tremolo_DefaultValue = new PivotpointsSeriesSonificationDefaultSpeechOptionsMappingTremolo();
			Volume = Volume_DefaultValue = new PivotpointsSeriesSonificationDefaultSpeechOptionsMappingVolume();
		...
		/// </summary>
		public PivotpointsSeriesSonificationDefaultSpeechOptionsMappingFrequency Frequency { get; set; }
		private PivotpointsSeriesSonificationDefaultSpeechOptionsMappingFrequency Frequency_DefaultValue { get; set; }
		...
		/// </summary>
		public PivotpointsSeriesSonificationDefaultSpeechOptionsMappingGapBetweenNotes GapBetweenNotes { get; set; }
		private PivotpointsSeriesSonificationDefaultSpeechOptionsMappingGapBetweenNotes GapBetweenNotes_DefaultValue { get; set; }
		...
		/// </summary>
		public PivotpointsSeriesSonificationDefaultSpeechOptionsMappingHighpass Highpass { get; set; }
		private PivotpointsSeriesSonificationDefaultSpeechOptionsMappingHighpass Highpass_DefaultValue { get; set; }
		...
		/// </summary>
		public PivotpointsSeriesSonificationDefaultSpeechOptionsMappingLowpass Lowpass { get; set; }
		private PivotpointsSeriesSonificationDefaultSpeechOptionsMappingLowpass Lowpass_DefaultValue { get; set; }
		...
		/// </summary>
		public PivotpointsSeriesSonificationDefaultSpeechOptionsMappingNoteDuration NoteDuration { get; set; }
		private PivotpointsSeriesSonificationDefaultSpeechOptionsMappingNoteDuration NoteDuration_DefaultValue { get; set; }
		...
		/// </summary>
		public PivotpointsSeriesSonificationDefaultSpeechOptionsMappingPan Pan { get; set; }
		private PivotpointsSeriesSonificationDefaultSpeechOptionsMappingPan Pan_DefaultValue { get; set; }
		...
		/// </summary>
		public PivotpointsSeriesSonificationDefaultSpeechOptionsMappingPitch Pitch { get; set; }
		private PivotpointsSeriesSonificationDefaultSpeechOptionsMappingPitch Pitch_DefaultValue { get; set; }
		...
		/// </summary>
		public PivotpointsSeriesSonificationDefaultSpeechOptionsMappingPlayDelay PlayDelay { get; set; }
		private PivotpointsSeriesSonificationDefaultSpeechOptionsMappingPlayDelay PlayDelay_DefaultValue { get; set; }
		...
		/// </summary>
		public PivotpointsSeriesSonificationDefaultSpeechOptionsMappingTime Time { get; set; }
		private PivotpointsSeriesSonificationDefaultSpeechOptionsMappingTime Time_DefaultValue { get; set; }
		...
		/// </summary>
		public PivotpointsSeriesSonificationDefaultSpeechOptionsMappingTremolo Tremolo { get; set; }
		private PivotpointsSeriesSonificationDefaultSpeechOptionsMappingTremolo Tremolo_DefaultValue { get; set; }
		 

		/// <summary>
		/// The volume of notes, from 0 to 1.
		/// </summary>
		public PivotpointsSeriesSonificationDefaultSpeechOptionsMappingVolume Volume { get; set; }
		private PivotpointsSeriesSonificationDefaultSpeechOptionsMappingVolume Volume_DefaultValue { get; set; }
