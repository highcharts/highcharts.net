...
{
	public partial class PivotpointsSeriesSonificationDefaultSpeechOptionsMappingPitch  : BaseObject
	{
		Hashtable h = new Hashtable();

		public PivotpointsSeriesSonificationDefaultSpeechOptionsMappingPitch()
		{
			MapFunction = MapFunction_DefaultValue = PivotpointsSeriesSonificationDefaultSpeechOptionsMappingPitchMapFunction.Linear;
		...
		/// </summary>
		public PivotpointsSeriesSonificationDefaultSpeechOptionsMappingPitchMapFunction MapFunction { get; set; }
		private PivotpointsSeriesSonificationDefaultSpeechOptionsMappingPitchMapFunction MapFunction_DefaultValue { get; set; }
