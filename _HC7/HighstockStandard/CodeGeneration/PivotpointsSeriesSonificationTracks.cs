...
{
	public partial class PivotpointsSeriesSonificationTracks  : BaseObject
	{
		Hashtable h = new Hashtable();

		public PivotpointsSeriesSonificationTracks()
		{
			ActiveWhen = ActiveWhen_DefaultValue = new PivotpointsSeriesSonificationTracksActiveWhen();
			Instrument = Instrument_DefaultValue = null;
			InstrumentString = InstrumentString_DefaultValue = "null";
			Mapping = Mapping_DefaultValue = new PivotpointsSeriesSonificationTracksMapping();
			MidiName = MidiName_DefaultValue = "";
			PointGrouping = PointGrouping_DefaultValue = new PivotpointsSeriesSonificationTracksPointGrouping();
			RoundToMusicalNotes = RoundToMusicalNotes_DefaultValue = true;
			ShowPlayMarker = ShowPlayMarker_DefaultValue = true;
			Type = Type_DefaultValue = PivotpointsSeriesSonificationTracksType.Instrument;
		...
		/// </summary>
		public PivotpointsSeriesSonificationTracksActiveWhen ActiveWhen { get; set; }
		private PivotpointsSeriesSonificationTracksActiveWhen ActiveWhen_DefaultValue { get; set; }
		...
		/// </summary>
		public PivotpointsSeriesSonificationTracksMapping Mapping { get; set; }
		private PivotpointsSeriesSonificationTracksMapping Mapping_DefaultValue { get; set; }
		...
		/// </summary>
		public PivotpointsSeriesSonificationTracksPointGrouping PointGrouping { get; set; }
		private PivotpointsSeriesSonificationTracksPointGrouping PointGrouping_DefaultValue { get; set; }
		...
		/// </summary>
		public PivotpointsSeriesSonificationTracksType Type { get; set; }
		private PivotpointsSeriesSonificationTracksType Type_DefaultValue { get; set; }
