...
{
	public partial class PivotpointsSeriesSonificationTracksMapping  : BaseObject
	{
		Hashtable h = new Hashtable();

		public PivotpointsSeriesSonificationTracksMapping()
		{
			Frequency = Frequency_DefaultValue = new PivotpointsSeriesSonificationTracksMappingFrequency();
			GapBetweenNotes = GapBetweenNotes_DefaultValue = new PivotpointsSeriesSonificationTracksMappingGapBetweenNotes();
			Highpass = Highpass_DefaultValue = new PivotpointsSeriesSonificationTracksMappingHighpass();
			Lowpass = Lowpass_DefaultValue = new PivotpointsSeriesSonificationTracksMappingLowpass();
			NoteDuration = NoteDuration_DefaultValue = new PivotpointsSeriesSonificationTracksMappingNoteDuration();
			Pan = Pan_DefaultValue = new PivotpointsSeriesSonificationTracksMappingPan();
			Pitch = Pitch_DefaultValue = new PivotpointsSeriesSonificationTracksMappingPitch();
			PitchString = PitchString_DefaultValue = "null";
			PitchNumber = PitchNumber_DefaultValue = null;
			PlayDelay = PlayDelay_DefaultValue = new PivotpointsSeriesSonificationTracksMappingPlayDelay();
			Time = Time_DefaultValue = new PivotpointsSeriesSonificationTracksMappingTime();
			TimeString = TimeString_DefaultValue = "null";
			TimeNumber = TimeNumber_DefaultValue = null;
			Tremolo = Tremolo_DefaultValue = new PivotpointsSeriesSonificationTracksMappingTremolo();
			Volume = Volume_DefaultValue = new PivotpointsSeriesSonificationTracksMappingVolume();
		...
		/// </summary>
		public PivotpointsSeriesSonificationTracksMappingFrequency Frequency { get; set; }
		private PivotpointsSeriesSonificationTracksMappingFrequency Frequency_DefaultValue { get; set; }
		...
		/// </summary>
		public PivotpointsSeriesSonificationTracksMappingGapBetweenNotes GapBetweenNotes { get; set; }
		private PivotpointsSeriesSonificationTracksMappingGapBetweenNotes GapBetweenNotes_DefaultValue { get; set; }
		...
		/// </summary>
		public PivotpointsSeriesSonificationTracksMappingHighpass Highpass { get; set; }
		private PivotpointsSeriesSonificationTracksMappingHighpass Highpass_DefaultValue { get; set; }
		...
		/// </summary>
		public PivotpointsSeriesSonificationTracksMappingLowpass Lowpass { get; set; }
		private PivotpointsSeriesSonificationTracksMappingLowpass Lowpass_DefaultValue { get; set; }
		...
		/// </summary>
		public PivotpointsSeriesSonificationTracksMappingNoteDuration NoteDuration { get; set; }
		private PivotpointsSeriesSonificationTracksMappingNoteDuration NoteDuration_DefaultValue { get; set; }
		...
		/// </summary>
		public PivotpointsSeriesSonificationTracksMappingPan Pan { get; set; }
		private PivotpointsSeriesSonificationTracksMappingPan Pan_DefaultValue { get; set; }
		...
		/// </summary>
		public PivotpointsSeriesSonificationTracksMappingPitch Pitch { get; set; }
		private PivotpointsSeriesSonificationTracksMappingPitch Pitch_DefaultValue { get; set; }
		...
		/// </summary>
		public PivotpointsSeriesSonificationTracksMappingPlayDelay PlayDelay { get; set; }
		private PivotpointsSeriesSonificationTracksMappingPlayDelay PlayDelay_DefaultValue { get; set; }
		...
		/// </summary>
		public PivotpointsSeriesSonificationTracksMappingTime Time { get; set; }
		private PivotpointsSeriesSonificationTracksMappingTime Time_DefaultValue { get; set; }
		...
		/// </summary>
		public PivotpointsSeriesSonificationTracksMappingTremolo Tremolo { get; set; }
		private PivotpointsSeriesSonificationTracksMappingTremolo Tremolo_DefaultValue { get; set; }
		 

		/// <summary>
		/// The volume of notes, from 0 to 1.
		/// </summary>
		public PivotpointsSeriesSonificationTracksMappingVolume Volume { get; set; }
		private PivotpointsSeriesSonificationTracksMappingVolume Volume_DefaultValue { get; set; }
