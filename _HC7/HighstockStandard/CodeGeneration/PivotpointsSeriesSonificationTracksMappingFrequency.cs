...
{
	public partial class PivotpointsSeriesSonificationTracksMappingFrequency  : BaseObject
	{
		Hashtable h = new Hashtable();

		public PivotpointsSeriesSonificationTracksMappingFrequency()
		{
			MapFunction = MapFunction_DefaultValue = PivotpointsSeriesSonificationTracksMappingFrequencyMapFunction.Linear;
			MapTo = MapTo_DefaultValue = "";
			Max = Max_DefaultValue = null;
			Min = Min_DefaultValue = null;
			Value = Value_DefaultValue = null;
			Within = Within_DefaultValue = PivotpointsSeriesSonificationTracksMappingFrequencyWithin.Chart;
		...
		/// </summary>
		public PivotpointsSeriesSonificationTracksMappingFrequencyMapFunction MapFunction { get; set; }
		private PivotpointsSeriesSonificationTracksMappingFrequencyMapFunction MapFunction_DefaultValue { get; set; }
		...
		/// </summary>
		public PivotpointsSeriesSonificationTracksMappingFrequencyWithin Within { get; set; }
		private PivotpointsSeriesSonificationTracksMappingFrequencyWithin Within_DefaultValue { get; set; }
