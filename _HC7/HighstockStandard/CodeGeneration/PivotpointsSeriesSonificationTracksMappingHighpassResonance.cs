...
{
	public partial class PivotpointsSeriesSonificationTracksMappingHighpassResonance  : BaseObject
	{
		Hashtable h = new Hashtable();

		public PivotpointsSeriesSonificationTracksMappingHighpassResonance()
		{
			MapFunction = MapFunction_DefaultValue = PivotpointsSeriesSonificationTracksMappingHighpassResonanceMapFunction.Linear;
			MapTo = MapTo_DefaultValue = "";
			Max = Max_DefaultValue = null;
			Min = Min_DefaultValue = null;
			Value = Value_DefaultValue = null;
			Within = Within_DefaultValue = PivotpointsSeriesSonificationTracksMappingHighpassResonanceWithin.Chart;
		...
		/// </summary>
		public PivotpointsSeriesSonificationTracksMappingHighpassResonanceMapFunction MapFunction { get; set; }
		private PivotpointsSeriesSonificationTracksMappingHighpassResonanceMapFunction MapFunction_DefaultValue { get; set; }
		...
		/// </summary>
		public PivotpointsSeriesSonificationTracksMappingHighpassResonanceWithin Within { get; set; }
		private PivotpointsSeriesSonificationTracksMappingHighpassResonanceWithin Within_DefaultValue { get; set; }
