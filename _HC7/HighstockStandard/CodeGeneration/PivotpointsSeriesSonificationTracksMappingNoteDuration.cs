...
{
	public partial class PivotpointsSeriesSonificationTracksMappingNoteDuration  : BaseObject
	{
		Hashtable h = new Hashtable();

		public PivotpointsSeriesSonificationTracksMappingNoteDuration()
		{
			MapFunction = MapFunction_DefaultValue = PivotpointsSeriesSonificationTracksMappingNoteDurationMapFunction.Linear;
			MapTo = MapTo_DefaultValue = "";
			Max = Max_DefaultValue = null;
			Min = Min_DefaultValue = null;
			Value = Value_DefaultValue = null;
			Within = Within_DefaultValue = PivotpointsSeriesSonificationTracksMappingNoteDurationWithin.Chart;
		...
		/// </summary>
		public PivotpointsSeriesSonificationTracksMappingNoteDurationMapFunction MapFunction { get; set; }
		private PivotpointsSeriesSonificationTracksMappingNoteDurationMapFunction MapFunction_DefaultValue { get; set; }
		...
		/// </summary>
		public PivotpointsSeriesSonificationTracksMappingNoteDurationWithin Within { get; set; }
		private PivotpointsSeriesSonificationTracksMappingNoteDurationWithin Within_DefaultValue { get; set; }
