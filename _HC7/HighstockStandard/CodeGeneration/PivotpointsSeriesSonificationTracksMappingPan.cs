...
{
	public partial class PivotpointsSeriesSonificationTracksMappingPan  : BaseObject
	{
		Hashtable h = new Hashtable();

		public PivotpointsSeriesSonificationTracksMappingPan()
		{
			MapFunction = MapFunction_DefaultValue = PivotpointsSeriesSonificationTracksMappingPanMapFunction.Linear;
			MapTo = MapTo_DefaultValue = "";
			Max = Max_DefaultValue = null;
			Min = Min_DefaultValue = null;
			Value = Value_DefaultValue = null;
			Within = Within_DefaultValue = PivotpointsSeriesSonificationTracksMappingPanWithin.Chart;
		...
		/// </summary>
		public PivotpointsSeriesSonificationTracksMappingPanMapFunction MapFunction { get; set; }
		private PivotpointsSeriesSonificationTracksMappingPanMapFunction MapFunction_DefaultValue { get; set; }
		...
		/// </summary>
		public PivotpointsSeriesSonificationTracksMappingPanWithin Within { get; set; }
		private PivotpointsSeriesSonificationTracksMappingPanWithin Within_DefaultValue { get; set; }
