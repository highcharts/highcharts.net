...
{
	public partial class PivotpointsSeriesSonificationTracksMappingPitch  : BaseObject
	{
		Hashtable h = new Hashtable();

		public PivotpointsSeriesSonificationTracksMappingPitch()
		{
			MapFunction = MapFunction_DefaultValue = PivotpointsSeriesSonificationTracksMappingPitchMapFunction.Linear;
		...
		/// </summary>
		public PivotpointsSeriesSonificationTracksMappingPitchMapFunction MapFunction { get; set; }
		private PivotpointsSeriesSonificationTracksMappingPitchMapFunction MapFunction_DefaultValue { get; set; }
