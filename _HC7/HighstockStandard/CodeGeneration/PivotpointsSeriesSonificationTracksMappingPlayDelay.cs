...
{
	public partial class PivotpointsSeriesSonificationTracksMappingPlayDelay  : BaseObject
	{
		Hashtable h = new Hashtable();

		public PivotpointsSeriesSonificationTracksMappingPlayDelay()
		{
			MapFunction = MapFunction_DefaultValue = PivotpointsSeriesSonificationTracksMappingPlayDelayMapFunction.Linear;
			MapTo = MapTo_DefaultValue = "";
			Max = Max_DefaultValue = null;
			Min = Min_DefaultValue = null;
			Value = Value_DefaultValue = null;
			Within = Within_DefaultValue = PivotpointsSeriesSonificationTracksMappingPlayDelayWithin.Chart;
		...
		/// </summary>
		public PivotpointsSeriesSonificationTracksMappingPlayDelayMapFunction MapFunction { get; set; }
		private PivotpointsSeriesSonificationTracksMappingPlayDelayMapFunction MapFunction_DefaultValue { get; set; }
		...
		/// </summary>
		public PivotpointsSeriesSonificationTracksMappingPlayDelayWithin Within { get; set; }
		private PivotpointsSeriesSonificationTracksMappingPlayDelayWithin Within_DefaultValue { get; set; }
