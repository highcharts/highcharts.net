...
{
	public partial class PivotpointsSeriesSonificationTracksMappingTime  : BaseObject
	{
		Hashtable h = new Hashtable();

		public PivotpointsSeriesSonificationTracksMappingTime()
		{
			MapFunction = MapFunction_DefaultValue = PivotpointsSeriesSonificationTracksMappingTimeMapFunction.Linear;
			MapTo = MapTo_DefaultValue = "";
			Max = Max_DefaultValue = null;
			Min = Min_DefaultValue = null;
			Value = Value_DefaultValue = null;
			Within = Within_DefaultValue = PivotpointsSeriesSonificationTracksMappingTimeWithin.Chart;
		...
		/// </summary>
		public PivotpointsSeriesSonificationTracksMappingTimeMapFunction MapFunction { get; set; }
		private PivotpointsSeriesSonificationTracksMappingTimeMapFunction MapFunction_DefaultValue { get; set; }
		...
		/// </summary>
		public PivotpointsSeriesSonificationTracksMappingTimeWithin Within { get; set; }
		private PivotpointsSeriesSonificationTracksMappingTimeWithin Within_DefaultValue { get; set; }
