...
{
	public partial class PivotpointsSeriesSonificationTracksMappingTremoloSpeed  : BaseObject
	{
		Hashtable h = new Hashtable();

		public PivotpointsSeriesSonificationTracksMappingTremoloSpeed()
		{
			MapFunction = MapFunction_DefaultValue = PivotpointsSeriesSonificationTracksMappingTremoloSpeedMapFunction.Linear;
			MapTo = MapTo_DefaultValue = "";
			Max = Max_DefaultValue = null;
			Min = Min_DefaultValue = null;
			Value = Value_DefaultValue = null;
			Within = Within_DefaultValue = PivotpointsSeriesSonificationTracksMappingTremoloSpeedWithin.Chart;
		...
		/// </summary>
		public PivotpointsSeriesSonificationTracksMappingTremoloSpeedMapFunction MapFunction { get; set; }
		private PivotpointsSeriesSonificationTracksMappingTremoloSpeedMapFunction MapFunction_DefaultValue { get; set; }
		...
		/// </summary>
		public PivotpointsSeriesSonificationTracksMappingTremoloSpeedWithin Within { get; set; }
		private PivotpointsSeriesSonificationTracksMappingTremoloSpeedWithin Within_DefaultValue { get; set; }
