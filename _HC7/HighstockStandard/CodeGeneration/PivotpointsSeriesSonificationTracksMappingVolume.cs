...
{
	public partial class PivotpointsSeriesSonificationTracksMappingVolume  : BaseObject
	{
		Hashtable h = new Hashtable();

		public PivotpointsSeriesSonificationTracksMappingVolume()
		{
			MapFunction = MapFunction_DefaultValue = PivotpointsSeriesSonificationTracksMappingVolumeMapFunction.Linear;
			MapTo = MapTo_DefaultValue = "";
			Max = Max_DefaultValue = null;
			Min = Min_DefaultValue = null;
			Value = Value_DefaultValue = null;
			Within = Within_DefaultValue = PivotpointsSeriesSonificationTracksMappingVolumeWithin.Chart;
		...
		/// </summary>
		public PivotpointsSeriesSonificationTracksMappingVolumeMapFunction MapFunction { get; set; }
		private PivotpointsSeriesSonificationTracksMappingVolumeMapFunction MapFunction_DefaultValue { get; set; }
		...
		/// </summary>
		public PivotpointsSeriesSonificationTracksMappingVolumeWithin Within { get; set; }
		private PivotpointsSeriesSonificationTracksMappingVolumeWithin Within_DefaultValue { get; set; }
