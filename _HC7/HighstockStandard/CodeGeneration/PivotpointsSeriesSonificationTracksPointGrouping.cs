...
{
	public partial class PivotpointsSeriesSonificationTracksPointGrouping  : BaseObject
	{
		Hashtable h = new Hashtable();

		public PivotpointsSeriesSonificationTracksPointGrouping()
		{
			Algorithm = Algorithm_DefaultValue = PivotpointsSeriesSonificationTracksPointGroupingAlgorithm.Minimax;
		...
		/// </summary>
		public PivotpointsSeriesSonificationTracksPointGroupingAlgorithm Algorithm { get; set; }
		private PivotpointsSeriesSonificationTracksPointGroupingAlgorithm Algorithm_DefaultValue { get; set; }
