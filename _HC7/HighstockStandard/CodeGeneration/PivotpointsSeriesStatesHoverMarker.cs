...
{
	public partial class PivotpointsSeriesStatesHoverMarker  : BaseObject
	{
		public PivotpointsSeriesStatesHoverMarker()
		{
			...
			States = States_DefaultValue = new PivotpointsSeriesStatesHoverMarkerStates();
		...
		/// </summary>
		public PivotpointsSeriesStatesHoverMarkerStates States { get; set; }
		private PivotpointsSeriesStatesHoverMarkerStates States_DefaultValue { get; set; }
