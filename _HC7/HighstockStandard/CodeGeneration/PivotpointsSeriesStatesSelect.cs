...
{
	public partial class PivotpointsSeriesStatesSelect  : BaseObject
	{
		public PivotpointsSeriesStatesSelect()
		{
			Animation = Animation_DefaultValue = new Animation() { Enabled = true };
			Enabled = Enabled_DefaultValue = true;
			Halo = Halo_DefaultValue = new PivotpointsSeriesStatesSelectHalo();
			LineWidth = LineWidth_DefaultValue = null;
			LineWidthPlus = LineWidthPlus_DefaultValue = 1;
			Marker = Marker_DefaultValue = new PivotpointsSeriesStatesSelectMarker();
		...
		/// </summary>
		public PivotpointsSeriesStatesSelectHalo Halo { get; set; }
		private PivotpointsSeriesStatesSelectHalo Halo_DefaultValue { get; set; }
		...
		/// </summary>
		public PivotpointsSeriesStatesSelectMarker Marker { get; set; }
		private PivotpointsSeriesStatesSelectMarker Marker_DefaultValue { get; set; }
