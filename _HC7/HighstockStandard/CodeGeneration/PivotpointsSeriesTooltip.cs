...
{
	public partial class PivotpointsSeriesTooltip  : BaseObject
	{
		public PivotpointsSeriesTooltip()
		{
			...
			HeaderShape = HeaderShape_DefaultValue = PivotpointsSeriesTooltipHeaderShape.Callout;
		...
		/// </summary>
		public PivotpointsSeriesTooltipHeaderShape HeaderShape { get; set; }
		private PivotpointsSeriesTooltipHeaderShape HeaderShape_DefaultValue { get; set; }
		...
		internal override Hashtable ToHashtable()
		{
			...
			if (NullFormatter != NullFormatter_DefaultValue) { h.Add("nullFormatter",NullFormatter); Highstock.AddFunction("PivotpointsSeriesTooltipNullFormatter.nullFormatter", NullFormatter); }  
			if (Outside != Outside_DefaultValue) h.Add("outside",Outside);
			if (Padding != Padding_DefaultValue) h.Add("padding",Padding);
			if (PointFormat != PointFormat_DefaultValue) h.Add("pointFormat",PointFormat);
			if (PointFormatter != PointFormatter_DefaultValue) { h.Add("pointFormatter",PointFormatter); Highstock.AddFunction("PivotpointsSeriesTooltipPointFormatter.pointFormatter", PointFormatter); }  
