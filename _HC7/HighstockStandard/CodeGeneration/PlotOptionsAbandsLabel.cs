...
{
	public partial class PlotOptionsAbandsLabel  : BaseObject
	{
		public PlotOptionsAbandsLabel()
		{
			...
			Style = Style_DefaultValue = new PlotOptionsAbandsLabelStyle();
		...
		/// </summary>
		public PlotOptionsAbandsLabelStyle Style { get; set; }
		private PlotOptionsAbandsLabelStyle Style_DefaultValue { get; set; }
