...
{
	public partial class PlotOptionsAbandsSonificationContextTracksMappingPitch  : BaseObject
	{
		Hashtable h = new Hashtable();

		public PlotOptionsAbandsSonificationContextTracksMappingPitch()
		{
			MapFunction = MapFunction_DefaultValue = PlotOptionsAbandsSonificationContextTracksMappingPitchMapFunction.Linear;
		...
		/// </summary>
		public PlotOptionsAbandsSonificationContextTracksMappingPitchMapFunction MapFunction { get; set; }
		private PlotOptionsAbandsSonificationContextTracksMappingPitchMapFunction MapFunction_DefaultValue { get; set; }
