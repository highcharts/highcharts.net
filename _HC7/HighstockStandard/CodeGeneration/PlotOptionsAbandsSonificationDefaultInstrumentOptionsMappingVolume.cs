...
{
	public partial class PlotOptionsAbandsSonificationDefaultInstrumentOptionsMappingVolume  : BaseObject
	{
		Hashtable h = new Hashtable();

		public PlotOptionsAbandsSonificationDefaultInstrumentOptionsMappingVolume()
		{
			MapFunction = MapFunction_DefaultValue = PlotOptionsAbandsSonificationDefaultInstrumentOptionsMappingVolumeMapFunction.Linear;
			MapTo = MapTo_DefaultValue = "";
			Max = Max_DefaultValue = null;
			Min = Min_DefaultValue = null;
			Value = Value_DefaultValue = null;
			Within = Within_DefaultValue = PlotOptionsAbandsSonificationDefaultInstrumentOptionsMappingVolumeWithin.Chart;
		...
		/// </summary>
		public PlotOptionsAbandsSonificationDefaultInstrumentOptionsMappingVolumeMapFunction MapFunction { get; set; }
		private PlotOptionsAbandsSonificationDefaultInstrumentOptionsMappingVolumeMapFunction MapFunction_DefaultValue { get; set; }
		...
		/// </summary>
		public PlotOptionsAbandsSonificationDefaultInstrumentOptionsMappingVolumeWithin Within { get; set; }
		private PlotOptionsAbandsSonificationDefaultInstrumentOptionsMappingVolumeWithin Within_DefaultValue { get; set; }
