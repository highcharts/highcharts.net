...
{
	public partial class PlotOptionsAbandsSonificationTracksMapping  : BaseObject
	{
		Hashtable h = new Hashtable();

		public PlotOptionsAbandsSonificationTracksMapping()
		{
			Frequency = Frequency_DefaultValue = new PlotOptionsAbandsSonificationTracksMappingFrequency();
			GapBetweenNotes = GapBetweenNotes_DefaultValue = new PlotOptionsAbandsSonificationTracksMappingGapBetweenNotes();
			Highpass = Highpass_DefaultValue = new PlotOptionsAbandsSonificationTracksMappingHighpass();
			Lowpass = Lowpass_DefaultValue = new PlotOptionsAbandsSonificationTracksMappingLowpass();
			NoteDuration = NoteDuration_DefaultValue = new PlotOptionsAbandsSonificationTracksMappingNoteDuration();
			Pan = Pan_DefaultValue = new PlotOptionsAbandsSonificationTracksMappingPan();
			Pitch = Pitch_DefaultValue = new PlotOptionsAbandsSonificationTracksMappingPitch();
			PitchString = PitchString_DefaultValue = "null";
			PitchNumber = PitchNumber_DefaultValue = null;
			PlayDelay = PlayDelay_DefaultValue = new PlotOptionsAbandsSonificationTracksMappingPlayDelay();
			Time = Time_DefaultValue = new PlotOptionsAbandsSonificationTracksMappingTime();
			TimeString = TimeString_DefaultValue = "null";
			TimeNumber = TimeNumber_DefaultValue = null;
			Tremolo = Tremolo_DefaultValue = new PlotOptionsAbandsSonificationTracksMappingTremolo();
			Volume = Volume_DefaultValue = new PlotOptionsAbandsSonificationTracksMappingVolume();
		...
		/// </summary>
		public PlotOptionsAbandsSonificationTracksMappingFrequency Frequency { get; set; }
		private PlotOptionsAbandsSonificationTracksMappingFrequency Frequency_DefaultValue { get; set; }
		...
		/// </summary>
		public PlotOptionsAbandsSonificationTracksMappingGapBetweenNotes GapBetweenNotes { get; set; }
		private PlotOptionsAbandsSonificationTracksMappingGapBetweenNotes GapBetweenNotes_DefaultValue { get; set; }
		...
		/// </summary>
		public PlotOptionsAbandsSonificationTracksMappingHighpass Highpass { get; set; }
		private PlotOptionsAbandsSonificationTracksMappingHighpass Highpass_DefaultValue { get; set; }
		...
		/// </summary>
		public PlotOptionsAbandsSonificationTracksMappingLowpass Lowpass { get; set; }
		private PlotOptionsAbandsSonificationTracksMappingLowpass Lowpass_DefaultValue { get; set; }
		...
		/// </summary>
		public PlotOptionsAbandsSonificationTracksMappingNoteDuration NoteDuration { get; set; }
		private PlotOptionsAbandsSonificationTracksMappingNoteDuration NoteDuration_DefaultValue { get; set; }
		...
		/// </summary>
		public PlotOptionsAbandsSonificationTracksMappingPan Pan { get; set; }
		private PlotOptionsAbandsSonificationTracksMappingPan Pan_DefaultValue { get; set; }
		...
		/// </summary>
		public PlotOptionsAbandsSonificationTracksMappingPitch Pitch { get; set; }
		private PlotOptionsAbandsSonificationTracksMappingPitch Pitch_DefaultValue { get; set; }
		...
		/// </summary>
		public PlotOptionsAbandsSonificationTracksMappingPlayDelay PlayDelay { get; set; }
		private PlotOptionsAbandsSonificationTracksMappingPlayDelay PlayDelay_DefaultValue { get; set; }
		...
		/// </summary>
		public PlotOptionsAbandsSonificationTracksMappingTime Time { get; set; }
		private PlotOptionsAbandsSonificationTracksMappingTime Time_DefaultValue { get; set; }
		...
		/// </summary>
		public PlotOptionsAbandsSonificationTracksMappingTremolo Tremolo { get; set; }
		private PlotOptionsAbandsSonificationTracksMappingTremolo Tremolo_DefaultValue { get; set; }
		 

		/// <summary>
		/// The volume of notes, from 0 to 1.
		/// </summary>
		public PlotOptionsAbandsSonificationTracksMappingVolume Volume { get; set; }
		private PlotOptionsAbandsSonificationTracksMappingVolume Volume_DefaultValue { get; set; }
