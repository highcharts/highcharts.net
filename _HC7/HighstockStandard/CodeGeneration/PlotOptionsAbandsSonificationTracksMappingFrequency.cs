...
{
	public partial class PlotOptionsAbandsSonificationTracksMappingFrequency  : BaseObject
	{
		Hashtable h = new Hashtable();

		public PlotOptionsAbandsSonificationTracksMappingFrequency()
		{
			MapFunction = MapFunction_DefaultValue = PlotOptionsAbandsSonificationTracksMappingFrequencyMapFunction.Linear;
			MapTo = MapTo_DefaultValue = "";
			Max = Max_DefaultValue = null;
			Min = Min_DefaultValue = null;
			Value = Value_DefaultValue = null;
			Within = Within_DefaultValue = PlotOptionsAbandsSonificationTracksMappingFrequencyWithin.Chart;
		...
		/// </summary>
		public PlotOptionsAbandsSonificationTracksMappingFrequencyMapFunction MapFunction { get; set; }
		private PlotOptionsAbandsSonificationTracksMappingFrequencyMapFunction MapFunction_DefaultValue { get; set; }
		...
		/// </summary>
		public PlotOptionsAbandsSonificationTracksMappingFrequencyWithin Within { get; set; }
		private PlotOptionsAbandsSonificationTracksMappingFrequencyWithin Within_DefaultValue { get; set; }
