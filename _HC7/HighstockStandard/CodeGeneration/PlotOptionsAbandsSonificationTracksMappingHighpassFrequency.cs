...
{
	public partial class PlotOptionsAbandsSonificationTracksMappingHighpassFrequency  : BaseObject
	{
		Hashtable h = new Hashtable();

		public PlotOptionsAbandsSonificationTracksMappingHighpassFrequency()
		{
			MapFunction = MapFunction_DefaultValue = PlotOptionsAbandsSonificationTracksMappingHighpassFrequencyMapFunction.Linear;
			MapTo = MapTo_DefaultValue = "";
			Max = Max_DefaultValue = null;
			Min = Min_DefaultValue = null;
			Value = Value_DefaultValue = null;
			Within = Within_DefaultValue = PlotOptionsAbandsSonificationTracksMappingHighpassFrequencyWithin.Chart;
		...
		/// </summary>
		public PlotOptionsAbandsSonificationTracksMappingHighpassFrequencyMapFunction MapFunction { get; set; }
		private PlotOptionsAbandsSonificationTracksMappingHighpassFrequencyMapFunction MapFunction_DefaultValue { get; set; }
		...
		/// </summary>
		public PlotOptionsAbandsSonificationTracksMappingHighpassFrequencyWithin Within { get; set; }
		private PlotOptionsAbandsSonificationTracksMappingHighpassFrequencyWithin Within_DefaultValue { get; set; }
