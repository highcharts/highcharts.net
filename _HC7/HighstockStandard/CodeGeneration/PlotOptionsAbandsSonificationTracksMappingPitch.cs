...
{
	public partial class PlotOptionsAbandsSonificationTracksMappingPitch  : BaseObject
	{
		Hashtable h = new Hashtable();

		public PlotOptionsAbandsSonificationTracksMappingPitch()
		{
			MapFunction = MapFunction_DefaultValue = PlotOptionsAbandsSonificationTracksMappingPitchMapFunction.Linear;
		...
		/// </summary>
		public PlotOptionsAbandsSonificationTracksMappingPitchMapFunction MapFunction { get; set; }
		private PlotOptionsAbandsSonificationTracksMappingPitchMapFunction MapFunction_DefaultValue { get; set; }
