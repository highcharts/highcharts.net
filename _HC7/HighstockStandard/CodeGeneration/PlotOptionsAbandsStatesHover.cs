...
{
	public partial class PlotOptionsAbandsStatesHover  : BaseObject
	{
		public PlotOptionsAbandsStatesHover()
		{
			Animation = Animation_DefaultValue = new Animation() { Enabled = true };
			AnimationBool = AnimationBool_DefaultValue = null;
			Enabled = Enabled_DefaultValue = true;
			Halo = Halo_DefaultValue = new PlotOptionsAbandsStatesHoverHalo();
			LineWidth = LineWidth_DefaultValue = null;
			LineWidthPlus = LineWidthPlus_DefaultValue = 1;
			Marker = Marker_DefaultValue = new PlotOptionsAbandsStatesHoverMarker();
		...
		/// </summary>
		public PlotOptionsAbandsStatesHoverHalo Halo { get; set; }
		private PlotOptionsAbandsStatesHoverHalo Halo_DefaultValue { get; set; }
		...
		/// </summary>
		public PlotOptionsAbandsStatesHoverMarker Marker { get; set; }
		private PlotOptionsAbandsStatesHoverMarker Marker_DefaultValue { get; set; }
