...
{
	public partial class PlotOptionsAbandsTooltip  : BaseObject
	{
		public PlotOptionsAbandsTooltip()
		{
			...
			HeaderShape = HeaderShape_DefaultValue = PlotOptionsAbandsTooltipHeaderShape.Callout;
		...
		/// </summary>
		public PlotOptionsAbandsTooltipHeaderShape HeaderShape { get; set; }
		private PlotOptionsAbandsTooltipHeaderShape HeaderShape_DefaultValue { get; set; }
		...
		internal override Hashtable ToHashtable()
		{
			...
			if (NullFormatter != NullFormatter_DefaultValue) { h.Add("nullFormatter",NullFormatter); Highstock.AddFunction("PlotOptionsAbandsTooltipNullFormatter.nullFormatter", NullFormatter); }  
			if (Outside != Outside_DefaultValue) h.Add("outside",Outside);
			if (Padding != Padding_DefaultValue) h.Add("padding",Padding);
			if (PointFormat != PointFormat_DefaultValue) h.Add("pointFormat",PointFormat);
			if (PointFormatter != PointFormatter_DefaultValue) { h.Add("pointFormatter",PointFormatter); Highstock.AddFunction("PlotOptionsAbandsTooltipPointFormatter.pointFormatter", PointFormatter); }  
