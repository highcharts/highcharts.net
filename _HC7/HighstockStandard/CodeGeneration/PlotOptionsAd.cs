...
namespace Highsoft.Web.Mvc.Stocks
{
	public partial class PlotOptionsAd  : BaseObject
	{
		...
		public PlotOptionsAd()
		{
			...
			Zones = Zones_DefaultValue = new List<PlotOptionsAdZone>();
		...
		/// </summary>
		public List<PlotOptionsAdZone> Zones { get; set; }
		private List<PlotOptionsAdZone> Zones_DefaultValue { get; set; }
