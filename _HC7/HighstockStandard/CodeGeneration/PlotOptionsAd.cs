...
{
	public partial class PlotOptionsAd  : BaseObject
	{
		Hashtable h = new Hashtable();

		public PlotOptionsAd()
		{
			Accessibility = Accessibility_DefaultValue = new PlotOptionsAdAccessibility();
			AllowPointSelect = AllowPointSelect_DefaultValue = false;
			Animation = Animation_DefaultValue = new Animation() { Enabled = true };
			AnimationBool = AnimationBool_DefaultValue = true;
			AnimationLimit = AnimationLimit_DefaultValue = null;
			BoostBlending = BoostBlending_DefaultValue = PlotOptionsAdBoostBlending.Undefined;
			...
			Compare = Compare_DefaultValue = PlotOptionsAdCompare.Percent;
			CompareBase = CompareBase_DefaultValue = PlotOptionsAdCompareBase.Min;
			...
			Cursor = Cursor_DefaultValue = PlotOptionsAdCursor.Null;
			Custom = Custom_DefaultValue = new Hashtable();
			DashStyle = DashStyle_DefaultValue = PlotOptionsAdDashStyle.Null;
			DataGrouping = DataGrouping_DefaultValue = new PlotOptionsAdDataGrouping();
			DataLabels = DataLabels_DefaultValue = new PlotOptionsAdDataLabels();
			DataSorting = DataSorting_DefaultValue = new PlotOptionsAdDataSorting();
			Description = Description_DefaultValue = "";
			EnableMouseTracking = EnableMouseTracking_DefaultValue = true;
			Events = Events_DefaultValue = new PlotOptionsAdEvents();
			FindNearestPointBy = FindNearestPointBy_DefaultValue = PlotOptionsAdFindNearestPointBy.X;
			GapSize = GapSize_DefaultValue = 0;
			GapUnit = GapUnit_DefaultValue = PlotOptionsAdGapUnit.Relative;
			GetExtremesFromAll = GetExtremesFromAll_DefaultValue = false;
			InactiveOtherPoints = InactiveOtherPoints_DefaultValue = false;
			IncludeInDataExport = IncludeInDataExport_DefaultValue = null;
			Label = Label_DefaultValue = new PlotOptionsAdLabel();
			LastPrice = LastPrice_DefaultValue = new PlotOptionsAdLastPrice();
			LastVisiblePrice = LastVisiblePrice_DefaultValue = new PlotOptionsAdLastVisiblePrice();
			LegendSymbol = LegendSymbol_DefaultValue = PlotOptionsAdLegendSymbol.Rectangle;
			Linecap = Linecap_DefaultValue = PlotOptionsAdLinecap.Round;
			LineWidth = LineWidth_DefaultValue = 2;
			LinkedTo = LinkedTo_DefaultValue = "";
			Marker = Marker_DefaultValue = new PlotOptionsAdMarker();
			NegativeColor = NegativeColor_DefaultValue = "";
			OnPoint = OnPoint_DefaultValue = new PlotOptionsAdOnPoint();
			Opacity = Opacity_DefaultValue = 1;
			Params = Params_DefaultValue = new PlotOptionsAdParams();
			Point = Point_DefaultValue = new PlotOptionsAdPoint();
			...
			Sonification = Sonification_DefaultValue = new PlotOptionsAdSonification();
			States = States_DefaultValue = new PlotOptionsAdStates();
			Step = Step_DefaultValue = PlotOptionsAdStep.Null;
			StickyTracking = StickyTracking_DefaultValue = true;
			Threshold = Threshold_DefaultValue = 0;
			Tooltip = Tooltip_DefaultValue = new PlotOptionsAdTooltip();
			TurboThreshold = TurboThreshold_DefaultValue = 1000;
			Visible = Visible_DefaultValue = true;
			ZoneAxis = ZoneAxis_DefaultValue = "y";
			Zones = Zones_DefaultValue = new List<PlotOptionsAdZones>();
		...
		/// </summary>
		public PlotOptionsAdAccessibility Accessibility { get; set; }
		private PlotOptionsAdAccessibility Accessibility_DefaultValue { get; set; }
		...
		/// </summary>
		public PlotOptionsAdBoostBlending BoostBlending { get; set; }
		private PlotOptionsAdBoostBlending BoostBlending_DefaultValue { get; set; }
		...
		/// </summary>
		public PlotOptionsAdCompare Compare { get; set; }
		private PlotOptionsAdCompare Compare_DefaultValue { get; set; }
		 

		/// <summary>
		/// When [compare](#plotOptions.series.compare) is `percent`, this optiondictates whether to use 0 or 100 as the base of comparison.
		/// </summary>
		public PlotOptionsAdCompareBase CompareBase { get; set; }
		private PlotOptionsAdCompareBase CompareBase_DefaultValue { get; set; }
		...
		/// </summary>
		public PlotOptionsAdCursor Cursor { get; set; }
		private PlotOptionsAdCursor Cursor_DefaultValue { get; set; }
		...
		/// </summary>
		public PlotOptionsAdDashStyle DashStyle { get; set; }
		private PlotOptionsAdDashStyle DashStyle_DefaultValue { get; set; }
		...
		/// </summary>
		public PlotOptionsAdDataGrouping DataGrouping { get; set; }
		private PlotOptionsAdDataGrouping DataGrouping_DefaultValue { get; set; }
		...
		/// </summary>
		public PlotOptionsAdDataLabels DataLabels { get; set; }
		private PlotOptionsAdDataLabels DataLabels_DefaultValue { get; set; }
		 

		/// <summary>
		/// Options for the series data sorting.
		/// </summary>
		public PlotOptionsAdDataSorting DataSorting { get; set; }
		private PlotOptionsAdDataSorting DataSorting_DefaultValue { get; set; }
		...
		/// </summary>
		public PlotOptionsAdEvents Events { get; set; }
		private PlotOptionsAdEvents Events_DefaultValue { get; set; }
		...
		/// </summary>
		public PlotOptionsAdFindNearestPointBy FindNearestPointBy { get; set; }
		private PlotOptionsAdFindNearestPointBy FindNearestPointBy_DefaultValue { get; set; }
		...
		/// </summary>
		public PlotOptionsAdGapUnit GapUnit { get; set; }
		private PlotOptionsAdGapUnit GapUnit_DefaultValue { get; set; }
		...
		/// </summary>
		public PlotOptionsAdLabel Label { get; set; }
		private PlotOptionsAdLabel Label_DefaultValue { get; set; }
		 

		/// <summary>
		/// The line marks the last price from all points.
		/// </summary>
		public PlotOptionsAdLastPrice LastPrice { get; set; }
		private PlotOptionsAdLastPrice LastPrice_DefaultValue { get; set; }
		 

		/// <summary>
		/// The line marks the last price from visible range of points.
		/// </summary>
		public PlotOptionsAdLastVisiblePrice LastVisiblePrice { get; set; }
		private PlotOptionsAdLastVisiblePrice LastVisiblePrice_DefaultValue { get; set; }
		 

		/// <summary>
		/// What type of legend symbol to render for this series. Can be one of`lineMarker` or `rectangle`.
		/// </summary>
		public PlotOptionsAdLegendSymbol LegendSymbol { get; set; }
		private PlotOptionsAdLegendSymbol LegendSymbol_DefaultValue { get; set; }
		 

		/// <summary>
		/// The line cap used for line ends and line joins on the graph.
		/// </summary>
		public PlotOptionsAdLinecap Linecap { get; set; }
		private PlotOptionsAdLinecap Linecap_DefaultValue { get; set; }
		...
		/// </summary>
		public PlotOptionsAdMarker Marker { get; set; }
		private PlotOptionsAdMarker Marker_DefaultValue { get; set; }
		...
		/// </summary>
		public PlotOptionsAdOnPoint OnPoint { get; set; }
		private PlotOptionsAdOnPoint OnPoint_DefaultValue { get; set; }
		...
		/// 
		/// </summary>
		public PlotOptionsAdParams Params { get; set; }
		private PlotOptionsAdParams Params_DefaultValue { get; set; }
		 

		/// <summary>
		/// Properties for each single point.
		/// </summary>
		public PlotOptionsAdPoint Point { get; set; }
		private PlotOptionsAdPoint Point_DefaultValue { get; set; }
		...
		/// </summary>
		public PlotOptionsAdSonification Sonification { get; set; }
		private PlotOptionsAdSonification Sonification_DefaultValue { get; set; }
		 

		/// <summary>
		/// 
		/// </summary>
		public PlotOptionsAdStates States { get; set; }
		private PlotOptionsAdStates States_DefaultValue { get; set; }
		 

		/// <summary>
		/// Whether to apply steps to the line. Possible values are `left`,`center` and `right`.
		/// </summary>
		public PlotOptionsAdStep Step { get; set; }
		private PlotOptionsAdStep Step_DefaultValue { get; set; }
		...
		/// </summary>
		public PlotOptionsAdTooltip Tooltip { get; set; }
		private PlotOptionsAdTooltip Tooltip_DefaultValue { get; set; }
		...
		/// </summary>
		public List<PlotOptionsAdZones> Zones { get; set; }
		private List<PlotOptionsAdZones> Zones_DefaultValue { get; set; }
