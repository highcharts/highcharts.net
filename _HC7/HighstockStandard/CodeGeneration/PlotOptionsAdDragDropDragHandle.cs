...
{
	public partial class PlotOptionsAdDragDropDragHandle  : BaseObject
	{
		public PlotOptionsAdDragDropDragHandle()
		{
		...
		internal override Hashtable ToHashtable()
		{
			...
			if (PathFormatter != PathFormatter_DefaultValue) { h.Add("pathFormatter",PathFormatter); Highstock.AddFunction("PlotOptionsAdDragDropDragHandlePathFormatter.pathFormatter", PathFormatter); }  
