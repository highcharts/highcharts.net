...
{
	public partial class PlotOptionsAdLabel  : BaseObject
	{
		public PlotOptionsAdLabel()
		{
			...
			Style = Style_DefaultValue = new PlotOptionsAdLabelStyle();
		...
		/// </summary>
		public PlotOptionsAdLabelStyle Style { get; set; }
		private PlotOptionsAdLabelStyle Style_DefaultValue { get; set; }
