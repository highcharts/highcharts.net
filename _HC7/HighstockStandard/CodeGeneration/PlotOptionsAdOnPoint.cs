...
{
	public partial class PlotOptionsAdOnPoint  : BaseObject
	{
		Hashtable h = new Hashtable();

		public PlotOptionsAdOnPoint()
		{
			ConnectorOptions = ConnectorOptions_DefaultValue = new PlotOptionsAdOnPointConnectorOptions();
			Id = Id_DefaultValue = "";
			Position = Position_DefaultValue = new PlotOptionsAdOnPointPosition();
		...
		/// </summary>
		public PlotOptionsAdOnPointConnectorOptions ConnectorOptions { get; set; }
		private PlotOptionsAdOnPointConnectorOptions ConnectorOptions_DefaultValue { get; set; }
		...
		/// </summary>
		public PlotOptionsAdOnPointPosition Position { get; set; }
		private PlotOptionsAdOnPointPosition Position_DefaultValue { get; set; }
