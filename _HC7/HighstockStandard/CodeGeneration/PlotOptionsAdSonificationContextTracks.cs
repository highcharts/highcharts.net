...
{
	public partial class PlotOptionsAdSonificationContextTracks  : BaseObject
	{
		Hashtable h = new Hashtable();

		public PlotOptionsAdSonificationContextTracks()
		{
			ActiveWhen = ActiveWhen_DefaultValue = new PlotOptionsAdSonificationContextTracksActiveWhen();
			Instrument = Instrument_DefaultValue = null;
			InstrumentString = InstrumentString_DefaultValue = "null";
			Mapping = Mapping_DefaultValue = new PlotOptionsAdSonificationContextTracksMapping();
			MidiName = MidiName_DefaultValue = "";
			PointGrouping = PointGrouping_DefaultValue = new PlotOptionsAdSonificationContextTracksPointGrouping();
			...
			Type = Type_DefaultValue = PlotOptionsAdSonificationContextTracksType.Instrument;
			ValueInterval = ValueInterval_DefaultValue = null;
			ValueMapFunction = ValueMapFunction_DefaultValue = PlotOptionsAdSonificationContextTracksValueMapFunction.Linear;
		...
		/// </summary>
		public PlotOptionsAdSonificationContextTracksActiveWhen ActiveWhen { get; set; }
		private PlotOptionsAdSonificationContextTracksActiveWhen ActiveWhen_DefaultValue { get; set; }
		...
		/// </summary>
		public PlotOptionsAdSonificationContextTracksMapping Mapping { get; set; }
		private PlotOptionsAdSonificationContextTracksMapping Mapping_DefaultValue { get; set; }
		...
		/// </summary>
		public PlotOptionsAdSonificationContextTracksPointGrouping PointGrouping { get; set; }
		private PlotOptionsAdSonificationContextTracksPointGrouping PointGrouping_DefaultValue { get; set; }
		...
		/// </summary>
		public PlotOptionsAdSonificationContextTracksType Type { get; set; }
		private PlotOptionsAdSonificationContextTracksType Type_DefaultValue { get; set; }
		...
		/// </summary>
		public PlotOptionsAdSonificationContextTracksValueMapFunction ValueMapFunction { get; set; }
		private PlotOptionsAdSonificationContextTracksValueMapFunction ValueMapFunction_DefaultValue { get; set; }
