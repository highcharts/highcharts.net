...
{
	public partial class PlotOptionsAdSonificationContextTracksMapping  : BaseObject
	{
		Hashtable h = new Hashtable();

		public PlotOptionsAdSonificationContextTracksMapping()
		{
			Frequency = Frequency_DefaultValue = new PlotOptionsAdSonificationContextTracksMappingFrequency();
			GapBetweenNotes = GapBetweenNotes_DefaultValue = new PlotOptionsAdSonificationContextTracksMappingGapBetweenNotes();
			Highpass = Highpass_DefaultValue = new PlotOptionsAdSonificationContextTracksMappingHighpass();
			Lowpass = Lowpass_DefaultValue = new PlotOptionsAdSonificationContextTracksMappingLowpass();
			NoteDuration = NoteDuration_DefaultValue = new PlotOptionsAdSonificationContextTracksMappingNoteDuration();
			Pan = Pan_DefaultValue = new PlotOptionsAdSonificationContextTracksMappingPan();
			Pitch = Pitch_DefaultValue = new PlotOptionsAdSonificationContextTracksMappingPitch();
			PitchString = PitchString_DefaultValue = "null";
			PitchNumber = PitchNumber_DefaultValue = null;
			PlayDelay = PlayDelay_DefaultValue = new PlotOptionsAdSonificationContextTracksMappingPlayDelay();
			Time = Time_DefaultValue = new PlotOptionsAdSonificationContextTracksMappingTime();
			TimeString = TimeString_DefaultValue = "null";
			TimeNumber = TimeNumber_DefaultValue = null;
			Tremolo = Tremolo_DefaultValue = new PlotOptionsAdSonificationContextTracksMappingTremolo();
			Volume = Volume_DefaultValue = new PlotOptionsAdSonificationContextTracksMappingVolume();
		...
		/// </summary>
		public PlotOptionsAdSonificationContextTracksMappingFrequency Frequency { get; set; }
		private PlotOptionsAdSonificationContextTracksMappingFrequency Frequency_DefaultValue { get; set; }
		...
		/// </summary>
		public PlotOptionsAdSonificationContextTracksMappingGapBetweenNotes GapBetweenNotes { get; set; }
		private PlotOptionsAdSonificationContextTracksMappingGapBetweenNotes GapBetweenNotes_DefaultValue { get; set; }
		...
		/// </summary>
		public PlotOptionsAdSonificationContextTracksMappingHighpass Highpass { get; set; }
		private PlotOptionsAdSonificationContextTracksMappingHighpass Highpass_DefaultValue { get; set; }
		...
		/// </summary>
		public PlotOptionsAdSonificationContextTracksMappingLowpass Lowpass { get; set; }
		private PlotOptionsAdSonificationContextTracksMappingLowpass Lowpass_DefaultValue { get; set; }
		...
		/// </summary>
		public PlotOptionsAdSonificationContextTracksMappingNoteDuration NoteDuration { get; set; }
		private PlotOptionsAdSonificationContextTracksMappingNoteDuration NoteDuration_DefaultValue { get; set; }
		...
		/// </summary>
		public PlotOptionsAdSonificationContextTracksMappingPan Pan { get; set; }
		private PlotOptionsAdSonificationContextTracksMappingPan Pan_DefaultValue { get; set; }
		...
		/// </summary>
		public PlotOptionsAdSonificationContextTracksMappingPitch Pitch { get; set; }
		private PlotOptionsAdSonificationContextTracksMappingPitch Pitch_DefaultValue { get; set; }
		...
		/// </summary>
		public PlotOptionsAdSonificationContextTracksMappingPlayDelay PlayDelay { get; set; }
		private PlotOptionsAdSonificationContextTracksMappingPlayDelay PlayDelay_DefaultValue { get; set; }
		...
		/// </summary>
		public PlotOptionsAdSonificationContextTracksMappingTime Time { get; set; }
		private PlotOptionsAdSonificationContextTracksMappingTime Time_DefaultValue { get; set; }
		...
		/// </summary>
		public PlotOptionsAdSonificationContextTracksMappingTremolo Tremolo { get; set; }
		private PlotOptionsAdSonificationContextTracksMappingTremolo Tremolo_DefaultValue { get; set; }
		 

		/// <summary>
		/// The volume of notes, from 0 to 1.
		/// </summary>
		public PlotOptionsAdSonificationContextTracksMappingVolume Volume { get; set; }
		private PlotOptionsAdSonificationContextTracksMappingVolume Volume_DefaultValue { get; set; }
