...
{
	public partial class PlotOptionsAdSonificationContextTracksMappingPitch  : BaseObject
	{
		Hashtable h = new Hashtable();

		public PlotOptionsAdSonificationContextTracksMappingPitch()
		{
			MapFunction = MapFunction_DefaultValue = PlotOptionsAdSonificationContextTracksMappingPitchMapFunction.Linear;
		...
		/// </summary>
		public PlotOptionsAdSonificationContextTracksMappingPitchMapFunction MapFunction { get; set; }
		private PlotOptionsAdSonificationContextTracksMappingPitchMapFunction MapFunction_DefaultValue { get; set; }
