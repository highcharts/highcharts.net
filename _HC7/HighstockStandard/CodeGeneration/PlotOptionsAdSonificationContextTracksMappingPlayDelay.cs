...
{
	public partial class PlotOptionsAdSonificationContextTracksMappingPlayDelay  : BaseObject
	{
		Hashtable h = new Hashtable();

		public PlotOptionsAdSonificationContextTracksMappingPlayDelay()
		{
			MapFunction = MapFunction_DefaultValue = PlotOptionsAdSonificationContextTracksMappingPlayDelayMapFunction.Linear;
			MapTo = MapTo_DefaultValue = "";
			Max = Max_DefaultValue = null;
			Min = Min_DefaultValue = null;
			Value = Value_DefaultValue = null;
			Within = Within_DefaultValue = PlotOptionsAdSonificationContextTracksMappingPlayDelayWithin.Chart;
		...
		/// </summary>
		public PlotOptionsAdSonificationContextTracksMappingPlayDelayMapFunction MapFunction { get; set; }
		private PlotOptionsAdSonificationContextTracksMappingPlayDelayMapFunction MapFunction_DefaultValue { get; set; }
		...
		/// </summary>
		public PlotOptionsAdSonificationContextTracksMappingPlayDelayWithin Within { get; set; }
		private PlotOptionsAdSonificationContextTracksMappingPlayDelayWithin Within_DefaultValue { get; set; }
