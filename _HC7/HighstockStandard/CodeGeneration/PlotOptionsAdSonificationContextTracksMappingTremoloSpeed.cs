...
{
	public partial class PlotOptionsAdSonificationContextTracksMappingTremoloSpeed  : BaseObject
	{
		Hashtable h = new Hashtable();

		public PlotOptionsAdSonificationContextTracksMappingTremoloSpeed()
		{
			MapFunction = MapFunction_DefaultValue = PlotOptionsAdSonificationContextTracksMappingTremoloSpeedMapFunction.Linear;
			MapTo = MapTo_DefaultValue = "";
			Max = Max_DefaultValue = null;
			Min = Min_DefaultValue = null;
			Value = Value_DefaultValue = null;
			Within = Within_DefaultValue = PlotOptionsAdSonificationContextTracksMappingTremoloSpeedWithin.Chart;
		...
		/// </summary>
		public PlotOptionsAdSonificationContextTracksMappingTremoloSpeedMapFunction MapFunction { get; set; }
		private PlotOptionsAdSonificationContextTracksMappingTremoloSpeedMapFunction MapFunction_DefaultValue { get; set; }
		...
		/// </summary>
		public PlotOptionsAdSonificationContextTracksMappingTremoloSpeedWithin Within { get; set; }
		private PlotOptionsAdSonificationContextTracksMappingTremoloSpeedWithin Within_DefaultValue { get; set; }
