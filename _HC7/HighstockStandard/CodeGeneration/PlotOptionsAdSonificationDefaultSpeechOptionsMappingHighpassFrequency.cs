...
{
	public partial class PlotOptionsAdSonificationDefaultSpeechOptionsMappingHighpassFrequency  : BaseObject
	{
		Hashtable h = new Hashtable();

		public PlotOptionsAdSonificationDefaultSpeechOptionsMappingHighpassFrequency()
		{
			MapFunction = MapFunction_DefaultValue = PlotOptionsAdSonificationDefaultSpeechOptionsMappingHighpassFrequencyMapFunction.Linear;
			MapTo = MapTo_DefaultValue = "";
			Max = Max_DefaultValue = null;
			Min = Min_DefaultValue = null;
			Value = Value_DefaultValue = null;
			Within = Within_DefaultValue = PlotOptionsAdSonificationDefaultSpeechOptionsMappingHighpassFrequencyWithin.Chart;
		...
		/// </summary>
		public PlotOptionsAdSonificationDefaultSpeechOptionsMappingHighpassFrequencyMapFunction MapFunction { get; set; }
		private PlotOptionsAdSonificationDefaultSpeechOptionsMappingHighpassFrequencyMapFunction MapFunction_DefaultValue { get; set; }
		...
		/// </summary>
		public PlotOptionsAdSonificationDefaultSpeechOptionsMappingHighpassFrequencyWithin Within { get; set; }
		private PlotOptionsAdSonificationDefaultSpeechOptionsMappingHighpassFrequencyWithin Within_DefaultValue { get; set; }
