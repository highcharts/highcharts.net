...
{
	public partial class PlotOptionsAdSonificationDefaultSpeechOptionsMappingLowpassFrequency  : BaseObject
	{
		Hashtable h = new Hashtable();

		public PlotOptionsAdSonificationDefaultSpeechOptionsMappingLowpassFrequency()
		{
			MapFunction = MapFunction_DefaultValue = PlotOptionsAdSonificationDefaultSpeechOptionsMappingLowpassFrequencyMapFunction.Linear;
			MapTo = MapTo_DefaultValue = "";
			Max = Max_DefaultValue = null;
			Min = Min_DefaultValue = null;
			Value = Value_DefaultValue = null;
			Within = Within_DefaultValue = PlotOptionsAdSonificationDefaultSpeechOptionsMappingLowpassFrequencyWithin.Chart;
		...
		/// </summary>
		public PlotOptionsAdSonificationDefaultSpeechOptionsMappingLowpassFrequencyMapFunction MapFunction { get; set; }
		private PlotOptionsAdSonificationDefaultSpeechOptionsMappingLowpassFrequencyMapFunction MapFunction_DefaultValue { get; set; }
		...
		/// </summary>
		public PlotOptionsAdSonificationDefaultSpeechOptionsMappingLowpassFrequencyWithin Within { get; set; }
		private PlotOptionsAdSonificationDefaultSpeechOptionsMappingLowpassFrequencyWithin Within_DefaultValue { get; set; }
