...
{
	public partial class PlotOptionsAdSonificationDefaultSpeechOptionsMappingPan  : BaseObject
	{
		Hashtable h = new Hashtable();

		public PlotOptionsAdSonificationDefaultSpeechOptionsMappingPan()
		{
			MapFunction = MapFunction_DefaultValue = PlotOptionsAdSonificationDefaultSpeechOptionsMappingPanMapFunction.Linear;
			MapTo = MapTo_DefaultValue = "";
			Max = Max_DefaultValue = null;
			Min = Min_DefaultValue = null;
			Value = Value_DefaultValue = null;
			Within = Within_DefaultValue = PlotOptionsAdSonificationDefaultSpeechOptionsMappingPanWithin.Chart;
		...
		/// </summary>
		public PlotOptionsAdSonificationDefaultSpeechOptionsMappingPanMapFunction MapFunction { get; set; }
		private PlotOptionsAdSonificationDefaultSpeechOptionsMappingPanMapFunction MapFunction_DefaultValue { get; set; }
		...
		/// </summary>
		public PlotOptionsAdSonificationDefaultSpeechOptionsMappingPanWithin Within { get; set; }
		private PlotOptionsAdSonificationDefaultSpeechOptionsMappingPanWithin Within_DefaultValue { get; set; }
