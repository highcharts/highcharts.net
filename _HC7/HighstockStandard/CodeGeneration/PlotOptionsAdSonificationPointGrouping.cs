...
{
	public partial class PlotOptionsAdSonificationPointGrouping  : BaseObject
	{
		Hashtable h = new Hashtable();

		public PlotOptionsAdSonificationPointGrouping()
		{
			Algorithm = Algorithm_DefaultValue = PlotOptionsAdSonificationPointGroupingAlgorithm.Minimax;
		...
		/// </summary>
		public PlotOptionsAdSonificationPointGroupingAlgorithm Algorithm { get; set; }
		private PlotOptionsAdSonificationPointGroupingAlgorithm Algorithm_DefaultValue { get; set; }
