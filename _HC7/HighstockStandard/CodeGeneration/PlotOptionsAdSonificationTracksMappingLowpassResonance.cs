...
{
	public partial class PlotOptionsAdSonificationTracksMappingLowpassResonance  : BaseObject
	{
		Hashtable h = new Hashtable();

		public PlotOptionsAdSonificationTracksMappingLowpassResonance()
		{
			MapFunction = MapFunction_DefaultValue = PlotOptionsAdSonificationTracksMappingLowpassResonanceMapFunction.Linear;
			MapTo = MapTo_DefaultValue = "";
			Max = Max_DefaultValue = null;
			Min = Min_DefaultValue = null;
			Value = Value_DefaultValue = null;
			Within = Within_DefaultValue = PlotOptionsAdSonificationTracksMappingLowpassResonanceWithin.Chart;
		...
		/// </summary>
		public PlotOptionsAdSonificationTracksMappingLowpassResonanceMapFunction MapFunction { get; set; }
		private PlotOptionsAdSonificationTracksMappingLowpassResonanceMapFunction MapFunction_DefaultValue { get; set; }
		...
		/// </summary>
		public PlotOptionsAdSonificationTracksMappingLowpassResonanceWithin Within { get; set; }
		private PlotOptionsAdSonificationTracksMappingLowpassResonanceWithin Within_DefaultValue { get; set; }
