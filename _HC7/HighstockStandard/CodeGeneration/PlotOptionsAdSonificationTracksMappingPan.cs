...
{
	public partial class PlotOptionsAdSonificationTracksMappingPan  : BaseObject
	{
		Hashtable h = new Hashtable();

		public PlotOptionsAdSonificationTracksMappingPan()
		{
			MapFunction = MapFunction_DefaultValue = PlotOptionsAdSonificationTracksMappingPanMapFunction.Linear;
			MapTo = MapTo_DefaultValue = "";
			Max = Max_DefaultValue = null;
			Min = Min_DefaultValue = null;
			Value = Value_DefaultValue = null;
			Within = Within_DefaultValue = PlotOptionsAdSonificationTracksMappingPanWithin.Chart;
		...
		/// </summary>
		public PlotOptionsAdSonificationTracksMappingPanMapFunction MapFunction { get; set; }
		private PlotOptionsAdSonificationTracksMappingPanMapFunction MapFunction_DefaultValue { get; set; }
		...
		/// </summary>
		public PlotOptionsAdSonificationTracksMappingPanWithin Within { get; set; }
		private PlotOptionsAdSonificationTracksMappingPanWithin Within_DefaultValue { get; set; }
