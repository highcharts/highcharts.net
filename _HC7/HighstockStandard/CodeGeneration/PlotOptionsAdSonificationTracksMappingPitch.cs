...
{
	public partial class PlotOptionsAdSonificationTracksMappingPitch  : BaseObject
	{
		Hashtable h = new Hashtable();

		public PlotOptionsAdSonificationTracksMappingPitch()
		{
			MapFunction = MapFunction_DefaultValue = PlotOptionsAdSonificationTracksMappingPitchMapFunction.Linear;
		...
		/// </summary>
		public PlotOptionsAdSonificationTracksMappingPitchMapFunction MapFunction { get; set; }
		private PlotOptionsAdSonificationTracksMappingPitchMapFunction MapFunction_DefaultValue { get; set; }
