...
{
	public partial class PlotOptionsAdSonificationTracksMappingVolume  : BaseObject
	{
		Hashtable h = new Hashtable();

		public PlotOptionsAdSonificationTracksMappingVolume()
		{
			MapFunction = MapFunction_DefaultValue = PlotOptionsAdSonificationTracksMappingVolumeMapFunction.Linear;
			MapTo = MapTo_DefaultValue = "";
			Max = Max_DefaultValue = null;
			Min = Min_DefaultValue = null;
			Value = Value_DefaultValue = null;
			Within = Within_DefaultValue = PlotOptionsAdSonificationTracksMappingVolumeWithin.Chart;
		...
		/// </summary>
		public PlotOptionsAdSonificationTracksMappingVolumeMapFunction MapFunction { get; set; }
		private PlotOptionsAdSonificationTracksMappingVolumeMapFunction MapFunction_DefaultValue { get; set; }
		...
		/// </summary>
		public PlotOptionsAdSonificationTracksMappingVolumeWithin Within { get; set; }
		private PlotOptionsAdSonificationTracksMappingVolumeWithin Within_DefaultValue { get; set; }
