...
{
	public partial class PlotOptionsAdSonificationTracksPointGrouping  : BaseObject
	{
		Hashtable h = new Hashtable();

		public PlotOptionsAdSonificationTracksPointGrouping()
		{
			Algorithm = Algorithm_DefaultValue = PlotOptionsAdSonificationTracksPointGroupingAlgorithm.Minimax;
		...
		/// </summary>
		public PlotOptionsAdSonificationTracksPointGroupingAlgorithm Algorithm { get; set; }
		private PlotOptionsAdSonificationTracksPointGroupingAlgorithm Algorithm_DefaultValue { get; set; }
