...
{
	public partial class PlotOptionsAdTooltip  : BaseObject
	{
		public PlotOptionsAdTooltip()
		{
			...
			HeaderShape = HeaderShape_DefaultValue = PlotOptionsAdTooltipHeaderShape.Callout;
		...
		/// </summary>
		public PlotOptionsAdTooltipHeaderShape HeaderShape { get; set; }
		private PlotOptionsAdTooltipHeaderShape HeaderShape_DefaultValue { get; set; }
		...
		internal override Hashtable ToHashtable()
		{
			...
			if (NullFormatter != NullFormatter_DefaultValue) { h.Add("nullFormatter",NullFormatter); Highstock.AddFunction("PlotOptionsAdTooltipNullFormatter.nullFormatter", NullFormatter); }  
			if (Outside != Outside_DefaultValue) h.Add("outside",Outside);
			if (Padding != Padding_DefaultValue) h.Add("padding",Padding);
			if (PointFormat != PointFormat_DefaultValue) h.Add("pointFormat",PointFormat);
			if (PointFormatter != PointFormatter_DefaultValue) { h.Add("pointFormatter",PointFormatter); Highstock.AddFunction("PlotOptionsAdTooltipPointFormatter.pointFormatter", PointFormatter); }  
