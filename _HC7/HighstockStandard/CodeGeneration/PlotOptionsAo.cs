...
{
	public partial class PlotOptionsAo  : BaseObject
	{
		Hashtable h = new Hashtable();

		public PlotOptionsAo()
		{
			Accessibility = Accessibility_DefaultValue = new PlotOptionsAoAccessibility();
			AllowPointSelect = AllowPointSelect_DefaultValue = false;
			Animation = Animation_DefaultValue = new Animation() { Enabled = true };
			AnimationBool = AnimationBool_DefaultValue = true;
			AnimationLimit = AnimationLimit_DefaultValue = null;
			BoostBlending = BoostBlending_DefaultValue = PlotOptionsAoBoostBlending.Undefined;
			...
			Compare = Compare_DefaultValue = PlotOptionsAoCompare.Percent;
			CompareBase = CompareBase_DefaultValue = PlotOptionsAoCompareBase.Min;
			...
			Cursor = Cursor_DefaultValue = PlotOptionsAoCursor.Null;
			Custom = Custom_DefaultValue = new Hashtable();
			DashStyle = DashStyle_DefaultValue = PlotOptionsAoDashStyle.Null;
			DataGrouping = DataGrouping_DefaultValue = new PlotOptionsAoDataGrouping();
			DataLabels = DataLabels_DefaultValue = new PlotOptionsAoDataLabels();
			DataSorting = DataSorting_DefaultValue = new PlotOptionsAoDataSorting();
			Description = Description_DefaultValue = "";
			EnableMouseTracking = EnableMouseTracking_DefaultValue = true;
			Events = Events_DefaultValue = new PlotOptionsAoEvents();
			FindNearestPointBy = FindNearestPointBy_DefaultValue = PlotOptionsAoFindNearestPointBy.X;
			GapSize = GapSize_DefaultValue = 0;
			GapUnit = GapUnit_DefaultValue = PlotOptionsAoGapUnit.Relative;
			GetExtremesFromAll = GetExtremesFromAll_DefaultValue = false;
			GreaterBarColor = GreaterBarColor_DefaultValue = "#06b535";
			GroupPadding = GroupPadding_DefaultValue = null;
			IncludeInDataExport = IncludeInDataExport_DefaultValue = null;
			Label = Label_DefaultValue = new PlotOptionsAoLabel();
			LastPrice = LastPrice_DefaultValue = new PlotOptionsAoLastPrice();
			LastVisiblePrice = LastVisiblePrice_DefaultValue = new PlotOptionsAoLastVisiblePrice();
			LegendSymbol = LegendSymbol_DefaultValue = PlotOptionsAoLegendSymbol.Rectangle;
			Linecap = Linecap_DefaultValue = PlotOptionsAoLinecap.Round;
			LineWidth = LineWidth_DefaultValue = 1;
			LinkedTo = LinkedTo_DefaultValue = "";
			LowerBarColor = LowerBarColor_DefaultValue = "#f21313";
			Marker = Marker_DefaultValue = new PlotOptionsAoMarker();
			NegativeColor = NegativeColor_DefaultValue = "";
			OnPoint = OnPoint_DefaultValue = new PlotOptionsAoOnPoint();
			Opacity = Opacity_DefaultValue = 1;
			Params = Params_DefaultValue = new PlotOptionsAoParams();
			Point = Point_DefaultValue = new PlotOptionsAoPoint();
			...
			Sonification = Sonification_DefaultValue = new PlotOptionsAoSonification();
			States = States_DefaultValue = new PlotOptionsAoStates();
			Step = Step_DefaultValue = PlotOptionsAoStep.Null;
			StickyTracking = StickyTracking_DefaultValue = true;
			Threshold = Threshold_DefaultValue = 0;
			Tooltip = Tooltip_DefaultValue = new PlotOptionsAoTooltip();
			TurboThreshold = TurboThreshold_DefaultValue = 1000;
			Visible = Visible_DefaultValue = true;
			ZoneAxis = ZoneAxis_DefaultValue = "y";
			Zones = Zones_DefaultValue = new List<PlotOptionsAoZones>();
		...
		/// </summary>
		public PlotOptionsAoAccessibility Accessibility { get; set; }
		private PlotOptionsAoAccessibility Accessibility_DefaultValue { get; set; }
		...
		/// </summary>
		public PlotOptionsAoBoostBlending BoostBlending { get; set; }
		private PlotOptionsAoBoostBlending BoostBlending_DefaultValue { get; set; }
		...
		/// </summary>
		public PlotOptionsAoCompare Compare { get; set; }
		private PlotOptionsAoCompare Compare_DefaultValue { get; set; }
		 

		/// <summary>
		/// When [compare](#plotOptions.series.compare) is `percent`, this optiondictates whether to use 0 or 100 as the base of comparison.
		/// </summary>
		public PlotOptionsAoCompareBase CompareBase { get; set; }
		private PlotOptionsAoCompareBase CompareBase_DefaultValue { get; set; }
		...
		/// </summary>
		public PlotOptionsAoCursor Cursor { get; set; }
		private PlotOptionsAoCursor Cursor_DefaultValue { get; set; }
		...
		/// </summary>
		public PlotOptionsAoDashStyle DashStyle { get; set; }
		private PlotOptionsAoDashStyle DashStyle_DefaultValue { get; set; }
		...
		/// </summary>
		public PlotOptionsAoDataGrouping DataGrouping { get; set; }
		private PlotOptionsAoDataGrouping DataGrouping_DefaultValue { get; set; }
		...
		/// </summary>
		public PlotOptionsAoDataLabels DataLabels { get; set; }
		private PlotOptionsAoDataLabels DataLabels_DefaultValue { get; set; }
		 

		/// <summary>
		/// Options for the series data sorting.
		/// </summary>
		public PlotOptionsAoDataSorting DataSorting { get; set; }
		private PlotOptionsAoDataSorting DataSorting_DefaultValue { get; set; }
		...
		/// </summary>
		public PlotOptionsAoEvents Events { get; set; }
		private PlotOptionsAoEvents Events_DefaultValue { get; set; }
		...
		/// </summary>
		public PlotOptionsAoFindNearestPointBy FindNearestPointBy { get; set; }
		private PlotOptionsAoFindNearestPointBy FindNearestPointBy_DefaultValue { get; set; }
		...
		/// </summary>
		public PlotOptionsAoGapUnit GapUnit { get; set; }
		private PlotOptionsAoGapUnit GapUnit_DefaultValue { get; set; }
		...
		/// <summary>
		/// Color of the Awesome oscillator series bar that is greater than theprevious one. Note that if a `color` is defined, the `color`takes precedence and the `greaterBarColor` is ignored.
		/// </summary>
		public string GreaterBarColor { get; set; }
		private string GreaterBarColor_DefaultValue { get; set; }
		...
		/// </summary>
		public PlotOptionsAoLabel Label { get; set; }
		private PlotOptionsAoLabel Label_DefaultValue { get; set; }
		 

		/// <summary>
		/// The line marks the last price from all points.
		/// </summary>
		public PlotOptionsAoLastPrice LastPrice { get; set; }
		private PlotOptionsAoLastPrice LastPrice_DefaultValue { get; set; }
		 

		/// <summary>
		/// The line marks the last price from visible range of points.
		/// </summary>
		public PlotOptionsAoLastVisiblePrice LastVisiblePrice { get; set; }
		private PlotOptionsAoLastVisiblePrice LastVisiblePrice_DefaultValue { get; set; }
		 

		/// <summary>
		/// What type of legend symbol to render for this series. Can be one of`lineMarker` or `rectangle`.
		/// </summary>
		public PlotOptionsAoLegendSymbol LegendSymbol { get; set; }
		private PlotOptionsAoLegendSymbol LegendSymbol_DefaultValue { get; set; }
		 

		/// <summary>
		/// The line cap used for line ends and line joins on the graph.
		/// </summary>
		public PlotOptionsAoLinecap Linecap { get; set; }
		private PlotOptionsAoLinecap Linecap_DefaultValue { get; set; }
		...
		/// <summary>
		/// Color of the Awesome oscillator series bar that is lower than theprevious one. Note that if a `color` is defined, the `color`takes precedence and the `lowerBarColor` is ignored.
		/// </summary>
		public string LowerBarColor { get; set; }
		private string LowerBarColor_DefaultValue { get; set; }
		...
		/// </summary>
		public PlotOptionsAoMarker Marker { get; set; }
		private PlotOptionsAoMarker Marker_DefaultValue { get; set; }
		...
		/// </summary>
		public PlotOptionsAoOnPoint OnPoint { get; set; }
		private PlotOptionsAoOnPoint OnPoint_DefaultValue { get; set; }
		...
		/// 
		/// </summary>
		public PlotOptionsAoParams Params { get; set; }
		private PlotOptionsAoParams Params_DefaultValue { get; set; }
		 

		/// <summary>
		/// Properties for each single point.
		/// </summary>
		public PlotOptionsAoPoint Point { get; set; }
		private PlotOptionsAoPoint Point_DefaultValue { get; set; }
		...
		/// </summary>
		public PlotOptionsAoSonification Sonification { get; set; }
		private PlotOptionsAoSonification Sonification_DefaultValue { get; set; }
		 

		/// <summary>
		/// 
		/// </summary>
		public PlotOptionsAoStates States { get; set; }
		private PlotOptionsAoStates States_DefaultValue { get; set; }
		 

		/// <summary>
		/// Whether to apply steps to the line. Possible values are `left`,`center` and `right`.
		/// </summary>
		public PlotOptionsAoStep Step { get; set; }
		private PlotOptionsAoStep Step_DefaultValue { get; set; }
		...
		/// </summary>
		public PlotOptionsAoTooltip Tooltip { get; set; }
		private PlotOptionsAoTooltip Tooltip_DefaultValue { get; set; }
		...
		/// </summary>
		public List<PlotOptionsAoZones> Zones { get; set; }
		private List<PlotOptionsAoZones> Zones_DefaultValue { get; set; }
		...
		internal override Hashtable ToHashtable(Highstock highstock)
		{
			...
			if (GreaterBarColor != GreaterBarColor_DefaultValue) h.Add("greaterBarColor",GreaterBarColor);
			...
			if (LowerBarColor != LowerBarColor_DefaultValue) h.Add("lowerBarColor",LowerBarColor);
