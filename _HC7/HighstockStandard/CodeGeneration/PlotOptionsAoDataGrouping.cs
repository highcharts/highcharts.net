...
namespace Highsoft.Web.Mvc.Stocks
{
	public partial class PlotOptionsAoDataGrouping  : BaseObject
	{
		...
		internal override Hashtable ToHashtable()
		{
			...
			if (Approximation != Approximation_DefaultValue) { h.Add("approximation",Approximation); Highstock.AddFunction("PlotOptionsAoDataGroupingApproximation.approximation", Approximation); }  
