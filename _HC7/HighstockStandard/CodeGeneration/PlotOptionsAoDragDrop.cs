...
{
	public partial class PlotOptionsAoDragDrop  : BaseObject
	{
		public PlotOptionsAoDragDrop()
		{
			DraggableX = DraggableX_DefaultValue = null;
			DraggableY = DraggableY_DefaultValue = null;
			DragHandle = DragHandle_DefaultValue = new PlotOptionsAoDragDropDragHandle();
			...
			GuideBox = GuideBox_DefaultValue = new PlotOptionsAoDragDropGuideBox();
		...
		/// </summary>
		public PlotOptionsAoDragDropDragHandle DragHandle { get; set; }
		private PlotOptionsAoDragDropDragHandle DragHandle_DefaultValue { get; set; }
		...
		/// </summary>
		public PlotOptionsAoDragDropGuideBox GuideBox { get; set; }
		private PlotOptionsAoDragDropGuideBox GuideBox_DefaultValue { get; set; }
