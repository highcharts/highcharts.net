...
{
	public partial class PlotOptionsAoLabel  : BaseObject
	{
		public PlotOptionsAoLabel()
		{
			...
			Style = Style_DefaultValue = new PlotOptionsAoLabelStyle();
		...
		/// </summary>
		public PlotOptionsAoLabelStyle Style { get; set; }
		private PlotOptionsAoLabelStyle Style_DefaultValue { get; set; }
