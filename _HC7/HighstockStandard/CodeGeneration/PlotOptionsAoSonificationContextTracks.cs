...
{
	public partial class PlotOptionsAoSonificationContextTracks  : BaseObject
	{
		Hashtable h = new Hashtable();

		public PlotOptionsAoSonificationContextTracks()
		{
			ActiveWhen = ActiveWhen_DefaultValue = new PlotOptionsAoSonificationContextTracksActiveWhen();
			Instrument = Instrument_DefaultValue = null;
			InstrumentString = InstrumentString_DefaultValue = "null";
			Mapping = Mapping_DefaultValue = new PlotOptionsAoSonificationContextTracksMapping();
			MidiName = MidiName_DefaultValue = "";
			PointGrouping = PointGrouping_DefaultValue = new PlotOptionsAoSonificationContextTracksPointGrouping();
			...
			Type = Type_DefaultValue = PlotOptionsAoSonificationContextTracksType.Instrument;
			ValueInterval = ValueInterval_DefaultValue = null;
			ValueMapFunction = ValueMapFunction_DefaultValue = PlotOptionsAoSonificationContextTracksValueMapFunction.Linear;
		...
		/// </summary>
		public PlotOptionsAoSonificationContextTracksActiveWhen ActiveWhen { get; set; }
		private PlotOptionsAoSonificationContextTracksActiveWhen ActiveWhen_DefaultValue { get; set; }
		...
		/// </summary>
		public PlotOptionsAoSonificationContextTracksMapping Mapping { get; set; }
		private PlotOptionsAoSonificationContextTracksMapping Mapping_DefaultValue { get; set; }
		...
		/// </summary>
		public PlotOptionsAoSonificationContextTracksPointGrouping PointGrouping { get; set; }
		private PlotOptionsAoSonificationContextTracksPointGrouping PointGrouping_DefaultValue { get; set; }
		...
		/// </summary>
		public PlotOptionsAoSonificationContextTracksType Type { get; set; }
		private PlotOptionsAoSonificationContextTracksType Type_DefaultValue { get; set; }
		...
		/// </summary>
		public PlotOptionsAoSonificationContextTracksValueMapFunction ValueMapFunction { get; set; }
		private PlotOptionsAoSonificationContextTracksValueMapFunction ValueMapFunction_DefaultValue { get; set; }
