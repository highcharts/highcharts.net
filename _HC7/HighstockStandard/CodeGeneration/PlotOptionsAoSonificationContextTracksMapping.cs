...
{
	public partial class PlotOptionsAoSonificationContextTracksMapping  : BaseObject
	{
		Hashtable h = new Hashtable();

		public PlotOptionsAoSonificationContextTracksMapping()
		{
			Frequency = Frequency_DefaultValue = new PlotOptionsAoSonificationContextTracksMappingFrequency();
			GapBetweenNotes = GapBetweenNotes_DefaultValue = new PlotOptionsAoSonificationContextTracksMappingGapBetweenNotes();
			Highpass = Highpass_DefaultValue = new PlotOptionsAoSonificationContextTracksMappingHighpass();
			Lowpass = Lowpass_DefaultValue = new PlotOptionsAoSonificationContextTracksMappingLowpass();
			NoteDuration = NoteDuration_DefaultValue = new PlotOptionsAoSonificationContextTracksMappingNoteDuration();
			Pan = Pan_DefaultValue = new PlotOptionsAoSonificationContextTracksMappingPan();
			Pitch = Pitch_DefaultValue = new PlotOptionsAoSonificationContextTracksMappingPitch();
			PitchString = PitchString_DefaultValue = "null";
			PitchNumber = PitchNumber_DefaultValue = null;
			PlayDelay = PlayDelay_DefaultValue = new PlotOptionsAoSonificationContextTracksMappingPlayDelay();
			Time = Time_DefaultValue = new PlotOptionsAoSonificationContextTracksMappingTime();
			TimeString = TimeString_DefaultValue = "null";
			TimeNumber = TimeNumber_DefaultValue = null;
			Tremolo = Tremolo_DefaultValue = new PlotOptionsAoSonificationContextTracksMappingTremolo();
			Volume = Volume_DefaultValue = new PlotOptionsAoSonificationContextTracksMappingVolume();
		...
		/// </summary>
		public PlotOptionsAoSonificationContextTracksMappingFrequency Frequency { get; set; }
		private PlotOptionsAoSonificationContextTracksMappingFrequency Frequency_DefaultValue { get; set; }
		...
		/// </summary>
		public PlotOptionsAoSonificationContextTracksMappingGapBetweenNotes GapBetweenNotes { get; set; }
		private PlotOptionsAoSonificationContextTracksMappingGapBetweenNotes GapBetweenNotes_DefaultValue { get; set; }
		...
		/// </summary>
		public PlotOptionsAoSonificationContextTracksMappingHighpass Highpass { get; set; }
		private PlotOptionsAoSonificationContextTracksMappingHighpass Highpass_DefaultValue { get; set; }
		...
		/// </summary>
		public PlotOptionsAoSonificationContextTracksMappingLowpass Lowpass { get; set; }
		private PlotOptionsAoSonificationContextTracksMappingLowpass Lowpass_DefaultValue { get; set; }
		...
		/// </summary>
		public PlotOptionsAoSonificationContextTracksMappingNoteDuration NoteDuration { get; set; }
		private PlotOptionsAoSonificationContextTracksMappingNoteDuration NoteDuration_DefaultValue { get; set; }
		...
		/// </summary>
		public PlotOptionsAoSonificationContextTracksMappingPan Pan { get; set; }
		private PlotOptionsAoSonificationContextTracksMappingPan Pan_DefaultValue { get; set; }
		...
		/// </summary>
		public PlotOptionsAoSonificationContextTracksMappingPitch Pitch { get; set; }
		private PlotOptionsAoSonificationContextTracksMappingPitch Pitch_DefaultValue { get; set; }
		...
		/// </summary>
		public PlotOptionsAoSonificationContextTracksMappingPlayDelay PlayDelay { get; set; }
		private PlotOptionsAoSonificationContextTracksMappingPlayDelay PlayDelay_DefaultValue { get; set; }
		...
		/// </summary>
		public PlotOptionsAoSonificationContextTracksMappingTime Time { get; set; }
		private PlotOptionsAoSonificationContextTracksMappingTime Time_DefaultValue { get; set; }
		...
		/// </summary>
		public PlotOptionsAoSonificationContextTracksMappingTremolo Tremolo { get; set; }
		private PlotOptionsAoSonificationContextTracksMappingTremolo Tremolo_DefaultValue { get; set; }
		 

		/// <summary>
		/// The volume of notes, from 0 to 1.
		/// </summary>
		public PlotOptionsAoSonificationContextTracksMappingVolume Volume { get; set; }
		private PlotOptionsAoSonificationContextTracksMappingVolume Volume_DefaultValue { get; set; }
