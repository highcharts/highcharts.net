...
{
	public partial class PlotOptionsAoSonificationContextTracksMappingPitch  : BaseObject
	{
		Hashtable h = new Hashtable();

		public PlotOptionsAoSonificationContextTracksMappingPitch()
		{
			MapFunction = MapFunction_DefaultValue = PlotOptionsAoSonificationContextTracksMappingPitchMapFunction.Linear;
		...
		/// </summary>
		public PlotOptionsAoSonificationContextTracksMappingPitchMapFunction MapFunction { get; set; }
		private PlotOptionsAoSonificationContextTracksMappingPitchMapFunction MapFunction_DefaultValue { get; set; }
