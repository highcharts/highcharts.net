...
{
	public partial class PlotOptionsAoSonificationContextTracksMappingPlayDelay  : BaseObject
	{
		Hashtable h = new Hashtable();

		public PlotOptionsAoSonificationContextTracksMappingPlayDelay()
		{
			MapFunction = MapFunction_DefaultValue = PlotOptionsAoSonificationContextTracksMappingPlayDelayMapFunction.Linear;
			MapTo = MapTo_DefaultValue = "";
			Max = Max_DefaultValue = null;
			Min = Min_DefaultValue = null;
			Value = Value_DefaultValue = null;
			Within = Within_DefaultValue = PlotOptionsAoSonificationContextTracksMappingPlayDelayWithin.Chart;
		...
		/// </summary>
		public PlotOptionsAoSonificationContextTracksMappingPlayDelayMapFunction MapFunction { get; set; }
		private PlotOptionsAoSonificationContextTracksMappingPlayDelayMapFunction MapFunction_DefaultValue { get; set; }
		...
		/// </summary>
		public PlotOptionsAoSonificationContextTracksMappingPlayDelayWithin Within { get; set; }
		private PlotOptionsAoSonificationContextTracksMappingPlayDelayWithin Within_DefaultValue { get; set; }
