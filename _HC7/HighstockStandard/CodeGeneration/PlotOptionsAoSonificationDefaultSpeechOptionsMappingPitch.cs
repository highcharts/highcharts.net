...
{
	public partial class PlotOptionsAoSonificationDefaultSpeechOptionsMappingPitch  : BaseObject
	{
		Hashtable h = new Hashtable();

		public PlotOptionsAoSonificationDefaultSpeechOptionsMappingPitch()
		{
			MapFunction = MapFunction_DefaultValue = PlotOptionsAoSonificationDefaultSpeechOptionsMappingPitchMapFunction.Linear;
		...
		/// </summary>
		public PlotOptionsAoSonificationDefaultSpeechOptionsMappingPitchMapFunction MapFunction { get; set; }
		private PlotOptionsAoSonificationDefaultSpeechOptionsMappingPitchMapFunction MapFunction_DefaultValue { get; set; }
