...
{
	public partial class PlotOptionsAoSonificationPointGrouping  : BaseObject
	{
		Hashtable h = new Hashtable();

		public PlotOptionsAoSonificationPointGrouping()
		{
			Algorithm = Algorithm_DefaultValue = PlotOptionsAoSonificationPointGroupingAlgorithm.Minimax;
		...
		/// </summary>
		public PlotOptionsAoSonificationPointGroupingAlgorithm Algorithm { get; set; }
		private PlotOptionsAoSonificationPointGroupingAlgorithm Algorithm_DefaultValue { get; set; }
