...
{
	public partial class PlotOptionsAoSonificationTracks  : BaseObject
	{
		Hashtable h = new Hashtable();

		public PlotOptionsAoSonificationTracks()
		{
			ActiveWhen = ActiveWhen_DefaultValue = new PlotOptionsAoSonificationTracksActiveWhen();
			Instrument = Instrument_DefaultValue = null;
			InstrumentString = InstrumentString_DefaultValue = "null";
			Mapping = Mapping_DefaultValue = new PlotOptionsAoSonificationTracksMapping();
			MidiName = MidiName_DefaultValue = "";
			PointGrouping = PointGrouping_DefaultValue = new PlotOptionsAoSonificationTracksPointGrouping();
			RoundToMusicalNotes = RoundToMusicalNotes_DefaultValue = true;
			ShowPlayMarker = ShowPlayMarker_DefaultValue = true;
			Type = Type_DefaultValue = PlotOptionsAoSonificationTracksType.Instrument;
		...
		/// </summary>
		public PlotOptionsAoSonificationTracksActiveWhen ActiveWhen { get; set; }
		private PlotOptionsAoSonificationTracksActiveWhen ActiveWhen_DefaultValue { get; set; }
		...
		/// </summary>
		public PlotOptionsAoSonificationTracksMapping Mapping { get; set; }
		private PlotOptionsAoSonificationTracksMapping Mapping_DefaultValue { get; set; }
		...
		/// </summary>
		public PlotOptionsAoSonificationTracksPointGrouping PointGrouping { get; set; }
		private PlotOptionsAoSonificationTracksPointGrouping PointGrouping_DefaultValue { get; set; }
		...
		/// </summary>
		public PlotOptionsAoSonificationTracksType Type { get; set; }
		private PlotOptionsAoSonificationTracksType Type_DefaultValue { get; set; }
