...
{
	public partial class PlotOptionsAoSonificationTracksMapping  : BaseObject
	{
		Hashtable h = new Hashtable();

		public PlotOptionsAoSonificationTracksMapping()
		{
			Frequency = Frequency_DefaultValue = new PlotOptionsAoSonificationTracksMappingFrequency();
			GapBetweenNotes = GapBetweenNotes_DefaultValue = new PlotOptionsAoSonificationTracksMappingGapBetweenNotes();
			Highpass = Highpass_DefaultValue = new PlotOptionsAoSonificationTracksMappingHighpass();
			Lowpass = Lowpass_DefaultValue = new PlotOptionsAoSonificationTracksMappingLowpass();
			NoteDuration = NoteDuration_DefaultValue = new PlotOptionsAoSonificationTracksMappingNoteDuration();
			Pan = Pan_DefaultValue = new PlotOptionsAoSonificationTracksMappingPan();
			Pitch = Pitch_DefaultValue = new PlotOptionsAoSonificationTracksMappingPitch();
			PitchString = PitchString_DefaultValue = "null";
			PitchNumber = PitchNumber_DefaultValue = null;
			PlayDelay = PlayDelay_DefaultValue = new PlotOptionsAoSonificationTracksMappingPlayDelay();
			Time = Time_DefaultValue = new PlotOptionsAoSonificationTracksMappingTime();
			TimeString = TimeString_DefaultValue = "null";
			TimeNumber = TimeNumber_DefaultValue = null;
			Tremolo = Tremolo_DefaultValue = new PlotOptionsAoSonificationTracksMappingTremolo();
			Volume = Volume_DefaultValue = new PlotOptionsAoSonificationTracksMappingVolume();
		...
		/// </summary>
		public PlotOptionsAoSonificationTracksMappingFrequency Frequency { get; set; }
		private PlotOptionsAoSonificationTracksMappingFrequency Frequency_DefaultValue { get; set; }
		...
		/// </summary>
		public PlotOptionsAoSonificationTracksMappingGapBetweenNotes GapBetweenNotes { get; set; }
		private PlotOptionsAoSonificationTracksMappingGapBetweenNotes GapBetweenNotes_DefaultValue { get; set; }
		...
		/// </summary>
		public PlotOptionsAoSonificationTracksMappingHighpass Highpass { get; set; }
		private PlotOptionsAoSonificationTracksMappingHighpass Highpass_DefaultValue { get; set; }
		...
		/// </summary>
		public PlotOptionsAoSonificationTracksMappingLowpass Lowpass { get; set; }
		private PlotOptionsAoSonificationTracksMappingLowpass Lowpass_DefaultValue { get; set; }
		...
		/// </summary>
		public PlotOptionsAoSonificationTracksMappingNoteDuration NoteDuration { get; set; }
		private PlotOptionsAoSonificationTracksMappingNoteDuration NoteDuration_DefaultValue { get; set; }
		...
		/// </summary>
		public PlotOptionsAoSonificationTracksMappingPan Pan { get; set; }
		private PlotOptionsAoSonificationTracksMappingPan Pan_DefaultValue { get; set; }
		...
		/// </summary>
		public PlotOptionsAoSonificationTracksMappingPitch Pitch { get; set; }
		private PlotOptionsAoSonificationTracksMappingPitch Pitch_DefaultValue { get; set; }
		...
		/// </summary>
		public PlotOptionsAoSonificationTracksMappingPlayDelay PlayDelay { get; set; }
		private PlotOptionsAoSonificationTracksMappingPlayDelay PlayDelay_DefaultValue { get; set; }
		...
		/// </summary>
		public PlotOptionsAoSonificationTracksMappingTime Time { get; set; }
		private PlotOptionsAoSonificationTracksMappingTime Time_DefaultValue { get; set; }
		...
		/// </summary>
		public PlotOptionsAoSonificationTracksMappingTremolo Tremolo { get; set; }
		private PlotOptionsAoSonificationTracksMappingTremolo Tremolo_DefaultValue { get; set; }
		 

		/// <summary>
		/// The volume of notes, from 0 to 1.
		/// </summary>
		public PlotOptionsAoSonificationTracksMappingVolume Volume { get; set; }
		private PlotOptionsAoSonificationTracksMappingVolume Volume_DefaultValue { get; set; }
