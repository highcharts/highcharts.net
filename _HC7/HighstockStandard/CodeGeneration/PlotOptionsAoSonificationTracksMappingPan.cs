...
{
	public partial class PlotOptionsAoSonificationTracksMappingPan  : BaseObject
	{
		Hashtable h = new Hashtable();

		public PlotOptionsAoSonificationTracksMappingPan()
		{
			MapFunction = MapFunction_DefaultValue = PlotOptionsAoSonificationTracksMappingPanMapFunction.Linear;
			MapTo = MapTo_DefaultValue = "";
			Max = Max_DefaultValue = null;
			Min = Min_DefaultValue = null;
			Value = Value_DefaultValue = null;
			Within = Within_DefaultValue = PlotOptionsAoSonificationTracksMappingPanWithin.Chart;
		...
		/// </summary>
		public PlotOptionsAoSonificationTracksMappingPanMapFunction MapFunction { get; set; }
		private PlotOptionsAoSonificationTracksMappingPanMapFunction MapFunction_DefaultValue { get; set; }
		...
		/// </summary>
		public PlotOptionsAoSonificationTracksMappingPanWithin Within { get; set; }
		private PlotOptionsAoSonificationTracksMappingPanWithin Within_DefaultValue { get; set; }
