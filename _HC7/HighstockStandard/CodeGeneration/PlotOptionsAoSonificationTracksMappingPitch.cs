...
{
	public partial class PlotOptionsAoSonificationTracksMappingPitch  : BaseObject
	{
		Hashtable h = new Hashtable();

		public PlotOptionsAoSonificationTracksMappingPitch()
		{
			MapFunction = MapFunction_DefaultValue = PlotOptionsAoSonificationTracksMappingPitchMapFunction.Linear;
		...
		/// </summary>
		public PlotOptionsAoSonificationTracksMappingPitchMapFunction MapFunction { get; set; }
		private PlotOptionsAoSonificationTracksMappingPitchMapFunction MapFunction_DefaultValue { get; set; }
