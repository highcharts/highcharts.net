...
{
	public partial class PlotOptionsAoSonificationTracksMappingTime  : BaseObject
	{
		Hashtable h = new Hashtable();

		public PlotOptionsAoSonificationTracksMappingTime()
		{
			MapFunction = MapFunction_DefaultValue = PlotOptionsAoSonificationTracksMappingTimeMapFunction.Linear;
			MapTo = MapTo_DefaultValue = "";
			Max = Max_DefaultValue = null;
			Min = Min_DefaultValue = null;
			Value = Value_DefaultValue = null;
			Within = Within_DefaultValue = PlotOptionsAoSonificationTracksMappingTimeWithin.Chart;
		...
		/// </summary>
		public PlotOptionsAoSonificationTracksMappingTimeMapFunction MapFunction { get; set; }
		private PlotOptionsAoSonificationTracksMappingTimeMapFunction MapFunction_DefaultValue { get; set; }
		...
		/// </summary>
		public PlotOptionsAoSonificationTracksMappingTimeWithin Within { get; set; }
		private PlotOptionsAoSonificationTracksMappingTimeWithin Within_DefaultValue { get; set; }
