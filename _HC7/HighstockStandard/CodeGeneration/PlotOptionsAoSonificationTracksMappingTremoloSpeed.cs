...
{
	public partial class PlotOptionsAoSonificationTracksMappingTremoloSpeed  : BaseObject
	{
		Hashtable h = new Hashtable();

		public PlotOptionsAoSonificationTracksMappingTremoloSpeed()
		{
			MapFunction = MapFunction_DefaultValue = PlotOptionsAoSonificationTracksMappingTremoloSpeedMapFunction.Linear;
			MapTo = MapTo_DefaultValue = "";
			Max = Max_DefaultValue = null;
			Min = Min_DefaultValue = null;
			Value = Value_DefaultValue = null;
			Within = Within_DefaultValue = PlotOptionsAoSonificationTracksMappingTremoloSpeedWithin.Chart;
		...
		/// </summary>
		public PlotOptionsAoSonificationTracksMappingTremoloSpeedMapFunction MapFunction { get; set; }
		private PlotOptionsAoSonificationTracksMappingTremoloSpeedMapFunction MapFunction_DefaultValue { get; set; }
		...
		/// </summary>
		public PlotOptionsAoSonificationTracksMappingTremoloSpeedWithin Within { get; set; }
		private PlotOptionsAoSonificationTracksMappingTremoloSpeedWithin Within_DefaultValue { get; set; }
