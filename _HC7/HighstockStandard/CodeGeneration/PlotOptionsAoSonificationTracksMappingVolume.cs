...
{
	public partial class PlotOptionsAoSonificationTracksMappingVolume  : BaseObject
	{
		Hashtable h = new Hashtable();

		public PlotOptionsAoSonificationTracksMappingVolume()
		{
			MapFunction = MapFunction_DefaultValue = PlotOptionsAoSonificationTracksMappingVolumeMapFunction.Linear;
			MapTo = MapTo_DefaultValue = "";
			Max = Max_DefaultValue = null;
			Min = Min_DefaultValue = null;
			Value = Value_DefaultValue = null;
			Within = Within_DefaultValue = PlotOptionsAoSonificationTracksMappingVolumeWithin.Chart;
		...
		/// </summary>
		public PlotOptionsAoSonificationTracksMappingVolumeMapFunction MapFunction { get; set; }
		private PlotOptionsAoSonificationTracksMappingVolumeMapFunction MapFunction_DefaultValue { get; set; }
		...
		/// </summary>
		public PlotOptionsAoSonificationTracksMappingVolumeWithin Within { get; set; }
		private PlotOptionsAoSonificationTracksMappingVolumeWithin Within_DefaultValue { get; set; }
