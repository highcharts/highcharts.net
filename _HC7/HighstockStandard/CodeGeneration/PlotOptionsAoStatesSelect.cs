...
{
	public partial class PlotOptionsAoStatesSelect  : BaseObject
	{
		public PlotOptionsAoStatesSelect()
		{
			Animation = Animation_DefaultValue = new Animation() { Enabled = true };
			Enabled = Enabled_DefaultValue = true;
			Halo = Halo_DefaultValue = new PlotOptionsAoStatesSelectHalo();
			LineWidth = LineWidth_DefaultValue = null;
			LineWidthPlus = LineWidthPlus_DefaultValue = 1;
			Marker = Marker_DefaultValue = new PlotOptionsAoStatesSelectMarker();
		...
		/// </summary>
		public PlotOptionsAoStatesSelectHalo Halo { get; set; }
		private PlotOptionsAoStatesSelectHalo Halo_DefaultValue { get; set; }
		...
		/// </summary>
		public PlotOptionsAoStatesSelectMarker Marker { get; set; }
		private PlotOptionsAoStatesSelectMarker Marker_DefaultValue { get; set; }
