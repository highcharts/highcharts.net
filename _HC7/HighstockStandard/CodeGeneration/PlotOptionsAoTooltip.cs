...
{
	public partial class PlotOptionsAoTooltip  : BaseObject
	{
		public PlotOptionsAoTooltip()
		{
			...
			HeaderShape = HeaderShape_DefaultValue = PlotOptionsAoTooltipHeaderShape.Callout;
		...
		/// </summary>
		public PlotOptionsAoTooltipHeaderShape HeaderShape { get; set; }
		private PlotOptionsAoTooltipHeaderShape HeaderShape_DefaultValue { get; set; }
		...
		internal override Hashtable ToHashtable()
		{
			...
			if (NullFormatter != NullFormatter_DefaultValue) { h.Add("nullFormatter",NullFormatter); Highstock.AddFunction("PlotOptionsAoTooltipNullFormatter.nullFormatter", NullFormatter); }  
			if (Outside != Outside_DefaultValue) h.Add("outside",Outside);
			if (Padding != Padding_DefaultValue) h.Add("padding",Padding);
			if (PointFormat != PointFormat_DefaultValue) h.Add("pointFormat",PointFormat);
			if (PointFormatter != PointFormatter_DefaultValue) { h.Add("pointFormatter",PointFormatter); Highstock.AddFunction("PlotOptionsAoTooltipPointFormatter.pointFormatter", PointFormatter); }  
