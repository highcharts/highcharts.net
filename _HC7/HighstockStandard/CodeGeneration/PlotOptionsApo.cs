...
{
	public partial class PlotOptionsApo  : BaseObject
	{
		Hashtable h = new Hashtable();

		public PlotOptionsApo()
		{
			Accessibility = Accessibility_DefaultValue = new PlotOptionsApoAccessibility();
			AllowPointSelect = AllowPointSelect_DefaultValue = false;
			Animation = Animation_DefaultValue = new Animation() { Enabled = true };
			AnimationBool = AnimationBool_DefaultValue = true;
			AnimationLimit = AnimationLimit_DefaultValue = null;
			BoostBlending = BoostBlending_DefaultValue = PlotOptionsApoBoostBlending.Undefined;
			...
			Compare = Compare_DefaultValue = PlotOptionsApoCompare.Percent;
			CompareBase = CompareBase_DefaultValue = PlotOptionsApoCompareBase.Min;
			...
			Cursor = Cursor_DefaultValue = PlotOptionsApoCursor.Null;
			Custom = Custom_DefaultValue = new Hashtable();
			DashStyle = DashStyle_DefaultValue = PlotOptionsApoDashStyle.Null;
			DataGrouping = DataGrouping_DefaultValue = new PlotOptionsApoDataGrouping();
			DataLabels = DataLabels_DefaultValue = new PlotOptionsApoDataLabels();
			DataSorting = DataSorting_DefaultValue = new PlotOptionsApoDataSorting();
			Description = Description_DefaultValue = "";
			EnableMouseTracking = EnableMouseTracking_DefaultValue = true;
			Events = Events_DefaultValue = new PlotOptionsApoEvents();
			FindNearestPointBy = FindNearestPointBy_DefaultValue = PlotOptionsApoFindNearestPointBy.X;
			GapSize = GapSize_DefaultValue = 0;
			GapUnit = GapUnit_DefaultValue = PlotOptionsApoGapUnit.Relative;
			GetExtremesFromAll = GetExtremesFromAll_DefaultValue = false;
			InactiveOtherPoints = InactiveOtherPoints_DefaultValue = false;
			IncludeInDataExport = IncludeInDataExport_DefaultValue = null;
			Label = Label_DefaultValue = new PlotOptionsApoLabel();
			LastPrice = LastPrice_DefaultValue = new PlotOptionsApoLastPrice();
			LastVisiblePrice = LastVisiblePrice_DefaultValue = new PlotOptionsApoLastVisiblePrice();
			LegendSymbol = LegendSymbol_DefaultValue = PlotOptionsApoLegendSymbol.Rectangle;
			Linecap = Linecap_DefaultValue = PlotOptionsApoLinecap.Round;
			LineWidth = LineWidth_DefaultValue = 2;
			LinkedTo = LinkedTo_DefaultValue = "";
			Marker = Marker_DefaultValue = new PlotOptionsApoMarker();
			NegativeColor = NegativeColor_DefaultValue = "";
			OnPoint = OnPoint_DefaultValue = new PlotOptionsApoOnPoint();
			Opacity = Opacity_DefaultValue = 1;
			Params = Params_DefaultValue = new PlotOptionsApoParams();
			Point = Point_DefaultValue = new PlotOptionsApoPoint();
			...
			Sonification = Sonification_DefaultValue = new PlotOptionsApoSonification();
			States = States_DefaultValue = new PlotOptionsApoStates();
			Step = Step_DefaultValue = PlotOptionsApoStep.Null;
			StickyTracking = StickyTracking_DefaultValue = true;
			Threshold = Threshold_DefaultValue = 0;
			Tooltip = Tooltip_DefaultValue = new PlotOptionsApoTooltip();
			TurboThreshold = TurboThreshold_DefaultValue = 1000;
			Visible = Visible_DefaultValue = true;
			ZoneAxis = ZoneAxis_DefaultValue = "y";
			Zones = Zones_DefaultValue = new List<PlotOptionsApoZones>();
		...
		/// </summary>
		public PlotOptionsApoAccessibility Accessibility { get; set; }
		private PlotOptionsApoAccessibility Accessibility_DefaultValue { get; set; }
		...
		/// </summary>
		public PlotOptionsApoBoostBlending BoostBlending { get; set; }
		private PlotOptionsApoBoostBlending BoostBlending_DefaultValue { get; set; }
		...
		/// </summary>
		public PlotOptionsApoCompare Compare { get; set; }
		private PlotOptionsApoCompare Compare_DefaultValue { get; set; }
		 

		/// <summary>
		/// When [compare](#plotOptions.series.compare) is `percent`, this optiondictates whether to use 0 or 100 as the base of comparison.
		/// </summary>
		public PlotOptionsApoCompareBase CompareBase { get; set; }
		private PlotOptionsApoCompareBase CompareBase_DefaultValue { get; set; }
		...
		/// </summary>
		public PlotOptionsApoCursor Cursor { get; set; }
		private PlotOptionsApoCursor Cursor_DefaultValue { get; set; }
		...
		/// </summary>
		public PlotOptionsApoDashStyle DashStyle { get; set; }
		private PlotOptionsApoDashStyle DashStyle_DefaultValue { get; set; }
		...
		/// </summary>
		public PlotOptionsApoDataGrouping DataGrouping { get; set; }
		private PlotOptionsApoDataGrouping DataGrouping_DefaultValue { get; set; }
		...
		/// </summary>
		public PlotOptionsApoDataLabels DataLabels { get; set; }
		private PlotOptionsApoDataLabels DataLabels_DefaultValue { get; set; }
		 

		/// <summary>
		/// Options for the series data sorting.
		/// </summary>
		public PlotOptionsApoDataSorting DataSorting { get; set; }
		private PlotOptionsApoDataSorting DataSorting_DefaultValue { get; set; }
		...
		/// </summary>
		public PlotOptionsApoEvents Events { get; set; }
		private PlotOptionsApoEvents Events_DefaultValue { get; set; }
		...
		/// </summary>
		public PlotOptionsApoFindNearestPointBy FindNearestPointBy { get; set; }
		private PlotOptionsApoFindNearestPointBy FindNearestPointBy_DefaultValue { get; set; }
		...
		/// </summary>
		public PlotOptionsApoGapUnit GapUnit { get; set; }
		private PlotOptionsApoGapUnit GapUnit_DefaultValue { get; set; }
		...
		/// </summary>
		public PlotOptionsApoLabel Label { get; set; }
		private PlotOptionsApoLabel Label_DefaultValue { get; set; }
		 

		/// <summary>
		/// The line marks the last price from all points.
		/// </summary>
		public PlotOptionsApoLastPrice LastPrice { get; set; }
		private PlotOptionsApoLastPrice LastPrice_DefaultValue { get; set; }
		 

		/// <summary>
		/// The line marks the last price from visible range of points.
		/// </summary>
		public PlotOptionsApoLastVisiblePrice LastVisiblePrice { get; set; }
		private PlotOptionsApoLastVisiblePrice LastVisiblePrice_DefaultValue { get; set; }
		 

		/// <summary>
		/// What type of legend symbol to render for this series. Can be one of`areaMarker`, `lineMarker` or `rectangle`.
		/// </summary>
		public PlotOptionsApoLegendSymbol LegendSymbol { get; set; }
		private PlotOptionsApoLegendSymbol LegendSymbol_DefaultValue { get; set; }
		 

		/// <summary>
		/// The line cap used for line ends and line joins on the graph.
		/// </summary>
		public PlotOptionsApoLinecap Linecap { get; set; }
		private PlotOptionsApoLinecap Linecap_DefaultValue { get; set; }
		...
		/// </summary>
		public PlotOptionsApoMarker Marker { get; set; }
		private PlotOptionsApoMarker Marker_DefaultValue { get; set; }
		...
		/// </summary>
		public PlotOptionsApoOnPoint OnPoint { get; set; }
		private PlotOptionsApoOnPoint OnPoint_DefaultValue { get; set; }
		...
		/// </summary>
		public PlotOptionsApoPoint Point { get; set; }
		private PlotOptionsApoPoint Point_DefaultValue { get; set; }
		...
		/// </summary>
		public PlotOptionsApoSonification Sonification { get; set; }
		private PlotOptionsApoSonification Sonification_DefaultValue { get; set; }
		 

		/// <summary>
		/// 
		/// </summary>
		public PlotOptionsApoStates States { get; set; }
		private PlotOptionsApoStates States_DefaultValue { get; set; }
		 

		/// <summary>
		/// Whether to apply steps to the line. Possible values are `left`,`center` and `right`.
		/// </summary>
		public PlotOptionsApoStep Step { get; set; }
		private PlotOptionsApoStep Step_DefaultValue { get; set; }
		...
		/// </summary>
		public PlotOptionsApoTooltip Tooltip { get; set; }
		private PlotOptionsApoTooltip Tooltip_DefaultValue { get; set; }
		...
		/// </summary>
		public List<PlotOptionsApoZones> Zones { get; set; }
		private List<PlotOptionsApoZones> Zones_DefaultValue { get; set; }
