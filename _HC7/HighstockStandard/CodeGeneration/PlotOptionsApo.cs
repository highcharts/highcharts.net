...
namespace Highsoft.Web.Mvc.Stocks
{
	public partial class PlotOptionsApo  : BaseObject
	{
		...
		public PlotOptionsApo()
		{
			...
			Zones = Zones_DefaultValue = new List<PlotOptionsApoZone>();
		...
		/// </summary>
		public List<PlotOptionsApoZone> Zones { get; set; }
		private List<PlotOptionsApoZone> Zones_DefaultValue { get; set; }
