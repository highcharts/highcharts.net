...
{
	public partial class PlotOptionsApoDragDrop  : BaseObject
	{
		public PlotOptionsApoDragDrop()
		{
			DraggableX = DraggableX_DefaultValue = null;
			DraggableY = DraggableY_DefaultValue = null;
			DragHandle = DragHandle_DefaultValue = new PlotOptionsApoDragDropDragHandle();
			...
			GuideBox = GuideBox_DefaultValue = new PlotOptionsApoDragDropGuideBox();
		...
		/// </summary>
		public PlotOptionsApoDragDropDragHandle DragHandle { get; set; }
		private PlotOptionsApoDragDropDragHandle DragHandle_DefaultValue { get; set; }
		...
		/// </summary>
		public PlotOptionsApoDragDropGuideBox GuideBox { get; set; }
		private PlotOptionsApoDragDropGuideBox GuideBox_DefaultValue { get; set; }
