...
{
	public partial class PlotOptionsApoLabel  : BaseObject
	{
		public PlotOptionsApoLabel()
		{
			...
			Style = Style_DefaultValue = new PlotOptionsApoLabelStyle();
		...
		/// </summary>
		public PlotOptionsApoLabelStyle Style { get; set; }
		private PlotOptionsApoLabelStyle Style_DefaultValue { get; set; }
