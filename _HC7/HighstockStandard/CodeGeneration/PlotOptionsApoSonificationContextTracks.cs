...
{
	public partial class PlotOptionsApoSonificationContextTracks  : BaseObject
	{
		Hashtable h = new Hashtable();

		public PlotOptionsApoSonificationContextTracks()
		{
			ActiveWhen = ActiveWhen_DefaultValue = new PlotOptionsApoSonificationContextTracksActiveWhen();
			Instrument = Instrument_DefaultValue = null;
			InstrumentString = InstrumentString_DefaultValue = "null";
			Mapping = Mapping_DefaultValue = new PlotOptionsApoSonificationContextTracksMapping();
			MidiName = MidiName_DefaultValue = "";
			PointGrouping = PointGrouping_DefaultValue = new PlotOptionsApoSonificationContextTracksPointGrouping();
			...
			Type = Type_DefaultValue = PlotOptionsApoSonificationContextTracksType.Instrument;
			ValueInterval = ValueInterval_DefaultValue = null;
			ValueMapFunction = ValueMapFunction_DefaultValue = PlotOptionsApoSonificationContextTracksValueMapFunction.Linear;
		...
		/// </summary>
		public PlotOptionsApoSonificationContextTracksActiveWhen ActiveWhen { get; set; }
		private PlotOptionsApoSonificationContextTracksActiveWhen ActiveWhen_DefaultValue { get; set; }
		...
		/// </summary>
		public PlotOptionsApoSonificationContextTracksMapping Mapping { get; set; }
		private PlotOptionsApoSonificationContextTracksMapping Mapping_DefaultValue { get; set; }
		...
		/// </summary>
		public PlotOptionsApoSonificationContextTracksPointGrouping PointGrouping { get; set; }
		private PlotOptionsApoSonificationContextTracksPointGrouping PointGrouping_DefaultValue { get; set; }
		...
		/// </summary>
		public PlotOptionsApoSonificationContextTracksType Type { get; set; }
		private PlotOptionsApoSonificationContextTracksType Type_DefaultValue { get; set; }
		...
		/// </summary>
		public PlotOptionsApoSonificationContextTracksValueMapFunction ValueMapFunction { get; set; }
		private PlotOptionsApoSonificationContextTracksValueMapFunction ValueMapFunction_DefaultValue { get; set; }
