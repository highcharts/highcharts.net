...
{
	public partial class PlotOptionsApoSonificationContextTracksMapping  : BaseObject
	{
		Hashtable h = new Hashtable();

		public PlotOptionsApoSonificationContextTracksMapping()
		{
			Frequency = Frequency_DefaultValue = new PlotOptionsApoSonificationContextTracksMappingFrequency();
			GapBetweenNotes = GapBetweenNotes_DefaultValue = new PlotOptionsApoSonificationContextTracksMappingGapBetweenNotes();
			Highpass = Highpass_DefaultValue = new PlotOptionsApoSonificationContextTracksMappingHighpass();
			Lowpass = Lowpass_DefaultValue = new PlotOptionsApoSonificationContextTracksMappingLowpass();
			NoteDuration = NoteDuration_DefaultValue = new PlotOptionsApoSonificationContextTracksMappingNoteDuration();
			Pan = Pan_DefaultValue = new PlotOptionsApoSonificationContextTracksMappingPan();
			Pitch = Pitch_DefaultValue = new PlotOptionsApoSonificationContextTracksMappingPitch();
			PitchString = PitchString_DefaultValue = "null";
			PitchNumber = PitchNumber_DefaultValue = null;
			PlayDelay = PlayDelay_DefaultValue = new PlotOptionsApoSonificationContextTracksMappingPlayDelay();
			Time = Time_DefaultValue = new PlotOptionsApoSonificationContextTracksMappingTime();
			TimeString = TimeString_DefaultValue = "null";
			TimeNumber = TimeNumber_DefaultValue = null;
			Tremolo = Tremolo_DefaultValue = new PlotOptionsApoSonificationContextTracksMappingTremolo();
			Volume = Volume_DefaultValue = new PlotOptionsApoSonificationContextTracksMappingVolume();
		...
		/// </summary>
		public PlotOptionsApoSonificationContextTracksMappingFrequency Frequency { get; set; }
		private PlotOptionsApoSonificationContextTracksMappingFrequency Frequency_DefaultValue { get; set; }
		...
		/// </summary>
		public PlotOptionsApoSonificationContextTracksMappingGapBetweenNotes GapBetweenNotes { get; set; }
		private PlotOptionsApoSonificationContextTracksMappingGapBetweenNotes GapBetweenNotes_DefaultValue { get; set; }
		...
		/// </summary>
		public PlotOptionsApoSonificationContextTracksMappingHighpass Highpass { get; set; }
		private PlotOptionsApoSonificationContextTracksMappingHighpass Highpass_DefaultValue { get; set; }
		...
		/// </summary>
		public PlotOptionsApoSonificationContextTracksMappingLowpass Lowpass { get; set; }
		private PlotOptionsApoSonificationContextTracksMappingLowpass Lowpass_DefaultValue { get; set; }
		...
		/// </summary>
		public PlotOptionsApoSonificationContextTracksMappingNoteDuration NoteDuration { get; set; }
		private PlotOptionsApoSonificationContextTracksMappingNoteDuration NoteDuration_DefaultValue { get; set; }
		...
		/// </summary>
		public PlotOptionsApoSonificationContextTracksMappingPan Pan { get; set; }
		private PlotOptionsApoSonificationContextTracksMappingPan Pan_DefaultValue { get; set; }
		...
		/// </summary>
		public PlotOptionsApoSonificationContextTracksMappingPitch Pitch { get; set; }
		private PlotOptionsApoSonificationContextTracksMappingPitch Pitch_DefaultValue { get; set; }
		...
		/// </summary>
		public PlotOptionsApoSonificationContextTracksMappingPlayDelay PlayDelay { get; set; }
		private PlotOptionsApoSonificationContextTracksMappingPlayDelay PlayDelay_DefaultValue { get; set; }
		...
		/// </summary>
		public PlotOptionsApoSonificationContextTracksMappingTime Time { get; set; }
		private PlotOptionsApoSonificationContextTracksMappingTime Time_DefaultValue { get; set; }
		...
		/// </summary>
		public PlotOptionsApoSonificationContextTracksMappingTremolo Tremolo { get; set; }
		private PlotOptionsApoSonificationContextTracksMappingTremolo Tremolo_DefaultValue { get; set; }
		 

		/// <summary>
		/// The volume of notes, from 0 to 1.
		/// </summary>
		public PlotOptionsApoSonificationContextTracksMappingVolume Volume { get; set; }
		private PlotOptionsApoSonificationContextTracksMappingVolume Volume_DefaultValue { get; set; }
