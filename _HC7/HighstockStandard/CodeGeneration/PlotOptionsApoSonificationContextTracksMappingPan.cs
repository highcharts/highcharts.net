...
{
	public partial class PlotOptionsApoSonificationContextTracksMappingPan  : BaseObject
	{
		Hashtable h = new Hashtable();

		public PlotOptionsApoSonificationContextTracksMappingPan()
		{
			MapFunction = MapFunction_DefaultValue = PlotOptionsApoSonificationContextTracksMappingPanMapFunction.Linear;
			MapTo = MapTo_DefaultValue = "";
			Max = Max_DefaultValue = null;
			Min = Min_DefaultValue = null;
			Value = Value_DefaultValue = null;
			Within = Within_DefaultValue = PlotOptionsApoSonificationContextTracksMappingPanWithin.Chart;
		...
		/// </summary>
		public PlotOptionsApoSonificationContextTracksMappingPanMapFunction MapFunction { get; set; }
		private PlotOptionsApoSonificationContextTracksMappingPanMapFunction MapFunction_DefaultValue { get; set; }
		...
		/// </summary>
		public PlotOptionsApoSonificationContextTracksMappingPanWithin Within { get; set; }
		private PlotOptionsApoSonificationContextTracksMappingPanWithin Within_DefaultValue { get; set; }
