...
{
	public partial class PlotOptionsApoSonificationContextTracksMappingPitch  : BaseObject
	{
		Hashtable h = new Hashtable();

		public PlotOptionsApoSonificationContextTracksMappingPitch()
		{
			MapFunction = MapFunction_DefaultValue = PlotOptionsApoSonificationContextTracksMappingPitchMapFunction.Linear;
		...
		/// </summary>
		public PlotOptionsApoSonificationContextTracksMappingPitchMapFunction MapFunction { get; set; }
		private PlotOptionsApoSonificationContextTracksMappingPitchMapFunction MapFunction_DefaultValue { get; set; }
