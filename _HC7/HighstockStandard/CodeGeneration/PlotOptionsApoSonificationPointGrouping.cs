...
{
	public partial class PlotOptionsApoSonificationPointGrouping  : BaseObject
	{
		Hashtable h = new Hashtable();

		public PlotOptionsApoSonificationPointGrouping()
		{
			Algorithm = Algorithm_DefaultValue = PlotOptionsApoSonificationPointGroupingAlgorithm.Minimax;
		...
		/// </summary>
		public PlotOptionsApoSonificationPointGroupingAlgorithm Algorithm { get; set; }
		private PlotOptionsApoSonificationPointGroupingAlgorithm Algorithm_DefaultValue { get; set; }
