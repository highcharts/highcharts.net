...
{
	public partial class PlotOptionsApoSonificationTracks  : BaseObject
	{
		Hashtable h = new Hashtable();

		public PlotOptionsApoSonificationTracks()
		{
			ActiveWhen = ActiveWhen_DefaultValue = new PlotOptionsApoSonificationTracksActiveWhen();
			Instrument = Instrument_DefaultValue = null;
			InstrumentString = InstrumentString_DefaultValue = "null";
			Mapping = Mapping_DefaultValue = new PlotOptionsApoSonificationTracksMapping();
			MidiName = MidiName_DefaultValue = "";
			PointGrouping = PointGrouping_DefaultValue = new PlotOptionsApoSonificationTracksPointGrouping();
			RoundToMusicalNotes = RoundToMusicalNotes_DefaultValue = true;
			ShowPlayMarker = ShowPlayMarker_DefaultValue = true;
			Type = Type_DefaultValue = PlotOptionsApoSonificationTracksType.Instrument;
		...
		/// </summary>
		public PlotOptionsApoSonificationTracksActiveWhen ActiveWhen { get; set; }
		private PlotOptionsApoSonificationTracksActiveWhen ActiveWhen_DefaultValue { get; set; }
		...
		/// </summary>
		public PlotOptionsApoSonificationTracksMapping Mapping { get; set; }
		private PlotOptionsApoSonificationTracksMapping Mapping_DefaultValue { get; set; }
		...
		/// </summary>
		public PlotOptionsApoSonificationTracksPointGrouping PointGrouping { get; set; }
		private PlotOptionsApoSonificationTracksPointGrouping PointGrouping_DefaultValue { get; set; }
		...
		/// </summary>
		public PlotOptionsApoSonificationTracksType Type { get; set; }
		private PlotOptionsApoSonificationTracksType Type_DefaultValue { get; set; }
