...
{
	public partial class PlotOptionsApoSonificationTracksMappingNoteDuration  : BaseObject
	{
		Hashtable h = new Hashtable();

		public PlotOptionsApoSonificationTracksMappingNoteDuration()
		{
			MapFunction = MapFunction_DefaultValue = PlotOptionsApoSonificationTracksMappingNoteDurationMapFunction.Linear;
			MapTo = MapTo_DefaultValue = "";
			Max = Max_DefaultValue = null;
			Min = Min_DefaultValue = null;
			Value = Value_DefaultValue = null;
			Within = Within_DefaultValue = PlotOptionsApoSonificationTracksMappingNoteDurationWithin.Chart;
		...
		/// </summary>
		public PlotOptionsApoSonificationTracksMappingNoteDurationMapFunction MapFunction { get; set; }
		private PlotOptionsApoSonificationTracksMappingNoteDurationMapFunction MapFunction_DefaultValue { get; set; }
		...
		/// </summary>
		public PlotOptionsApoSonificationTracksMappingNoteDurationWithin Within { get; set; }
		private PlotOptionsApoSonificationTracksMappingNoteDurationWithin Within_DefaultValue { get; set; }
