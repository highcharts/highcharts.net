...
{
	public partial class PlotOptionsApoSonificationTracksMappingPan  : BaseObject
	{
		Hashtable h = new Hashtable();

		public PlotOptionsApoSonificationTracksMappingPan()
		{
			MapFunction = MapFunction_DefaultValue = PlotOptionsApoSonificationTracksMappingPanMapFunction.Linear;
			MapTo = MapTo_DefaultValue = "";
			Max = Max_DefaultValue = null;
			Min = Min_DefaultValue = null;
			Value = Value_DefaultValue = null;
			Within = Within_DefaultValue = PlotOptionsApoSonificationTracksMappingPanWithin.Chart;
		...
		/// </summary>
		public PlotOptionsApoSonificationTracksMappingPanMapFunction MapFunction { get; set; }
		private PlotOptionsApoSonificationTracksMappingPanMapFunction MapFunction_DefaultValue { get; set; }
		...
		/// </summary>
		public PlotOptionsApoSonificationTracksMappingPanWithin Within { get; set; }
		private PlotOptionsApoSonificationTracksMappingPanWithin Within_DefaultValue { get; set; }
