...
{
	public partial class PlotOptionsApoSonificationTracksMappingPitch  : BaseObject
	{
		Hashtable h = new Hashtable();

		public PlotOptionsApoSonificationTracksMappingPitch()
		{
			MapFunction = MapFunction_DefaultValue = PlotOptionsApoSonificationTracksMappingPitchMapFunction.Linear;
		...
		/// </summary>
		public PlotOptionsApoSonificationTracksMappingPitchMapFunction MapFunction { get; set; }
		private PlotOptionsApoSonificationTracksMappingPitchMapFunction MapFunction_DefaultValue { get; set; }
