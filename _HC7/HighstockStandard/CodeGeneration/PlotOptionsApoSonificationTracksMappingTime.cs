...
{
	public partial class PlotOptionsApoSonificationTracksMappingTime  : BaseObject
	{
		Hashtable h = new Hashtable();

		public PlotOptionsApoSonificationTracksMappingTime()
		{
			MapFunction = MapFunction_DefaultValue = PlotOptionsApoSonificationTracksMappingTimeMapFunction.Linear;
			MapTo = MapTo_DefaultValue = "";
			Max = Max_DefaultValue = null;
			Min = Min_DefaultValue = null;
			Value = Value_DefaultValue = null;
			Within = Within_DefaultValue = PlotOptionsApoSonificationTracksMappingTimeWithin.Chart;
		...
		/// </summary>
		public PlotOptionsApoSonificationTracksMappingTimeMapFunction MapFunction { get; set; }
		private PlotOptionsApoSonificationTracksMappingTimeMapFunction MapFunction_DefaultValue { get; set; }
		...
		/// </summary>
		public PlotOptionsApoSonificationTracksMappingTimeWithin Within { get; set; }
		private PlotOptionsApoSonificationTracksMappingTimeWithin Within_DefaultValue { get; set; }
