...
{
	public partial class PlotOptionsApoSonificationTracksMappingVolume  : BaseObject
	{
		Hashtable h = new Hashtable();

		public PlotOptionsApoSonificationTracksMappingVolume()
		{
			MapFunction = MapFunction_DefaultValue = PlotOptionsApoSonificationTracksMappingVolumeMapFunction.Linear;
			MapTo = MapTo_DefaultValue = "";
			Max = Max_DefaultValue = null;
			Min = Min_DefaultValue = null;
			Value = Value_DefaultValue = null;
			Within = Within_DefaultValue = PlotOptionsApoSonificationTracksMappingVolumeWithin.Chart;
		...
		/// </summary>
		public PlotOptionsApoSonificationTracksMappingVolumeMapFunction MapFunction { get; set; }
		private PlotOptionsApoSonificationTracksMappingVolumeMapFunction MapFunction_DefaultValue { get; set; }
		...
		/// </summary>
		public PlotOptionsApoSonificationTracksMappingVolumeWithin Within { get; set; }
		private PlotOptionsApoSonificationTracksMappingVolumeWithin Within_DefaultValue { get; set; }
