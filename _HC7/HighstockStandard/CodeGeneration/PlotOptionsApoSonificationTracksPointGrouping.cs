...
{
	public partial class PlotOptionsApoSonificationTracksPointGrouping  : BaseObject
	{
		Hashtable h = new Hashtable();

		public PlotOptionsApoSonificationTracksPointGrouping()
		{
			Algorithm = Algorithm_DefaultValue = PlotOptionsApoSonificationTracksPointGroupingAlgorithm.Minimax;
		...
		/// </summary>
		public PlotOptionsApoSonificationTracksPointGroupingAlgorithm Algorithm { get; set; }
		private PlotOptionsApoSonificationTracksPointGroupingAlgorithm Algorithm_DefaultValue { get; set; }
