...
{
	public partial class PlotOptionsApoStatesHoverMarker  : BaseObject
	{
		public PlotOptionsApoStatesHoverMarker()
		{
			...
			States = States_DefaultValue = new PlotOptionsApoStatesHoverMarkerStates();
		...
		/// </summary>
		public PlotOptionsApoStatesHoverMarkerStates States { get; set; }
		private PlotOptionsApoStatesHoverMarkerStates States_DefaultValue { get; set; }
