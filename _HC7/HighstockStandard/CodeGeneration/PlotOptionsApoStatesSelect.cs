...
{
	public partial class PlotOptionsApoStatesSelect  : BaseObject
	{
		public PlotOptionsApoStatesSelect()
		{
			Animation = Animation_DefaultValue = new Animation() { Enabled = true };
			Enabled = Enabled_DefaultValue = true;
			Halo = Halo_DefaultValue = new PlotOptionsApoStatesSelectHalo();
			LineWidth = LineWidth_DefaultValue = null;
			LineWidthPlus = LineWidthPlus_DefaultValue = 1;
			Marker = Marker_DefaultValue = new PlotOptionsApoStatesSelectMarker();
		...
		/// </summary>
		public PlotOptionsApoStatesSelectHalo Halo { get; set; }
		private PlotOptionsApoStatesSelectHalo Halo_DefaultValue { get; set; }
		...
		/// </summary>
		public PlotOptionsApoStatesSelectMarker Marker { get; set; }
		private PlotOptionsApoStatesSelectMarker Marker_DefaultValue { get; set; }
