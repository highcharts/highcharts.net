...
{
	public partial class PlotOptionsApoTooltip  : BaseObject
	{
		public PlotOptionsApoTooltip()
		{
			...
			HeaderShape = HeaderShape_DefaultValue = PlotOptionsApoTooltipHeaderShape.Callout;
		...
		/// </summary>
		public PlotOptionsApoTooltipHeaderShape HeaderShape { get; set; }
		private PlotOptionsApoTooltipHeaderShape HeaderShape_DefaultValue { get; set; }
		...
		internal override Hashtable ToHashtable()
		{
			...
			if (NullFormatter != NullFormatter_DefaultValue) { h.Add("nullFormatter",NullFormatter); Highstock.AddFunction("PlotOptionsApoTooltipNullFormatter.nullFormatter", NullFormatter); }  
			if (Outside != Outside_DefaultValue) h.Add("outside",Outside);
			if (Padding != Padding_DefaultValue) h.Add("padding",Padding);
			if (PointFormat != PointFormat_DefaultValue) h.Add("pointFormat",PointFormat);
			if (PointFormatter != PointFormatter_DefaultValue) { h.Add("pointFormatter",PointFormatter); Highstock.AddFunction("PlotOptionsApoTooltipPointFormatter.pointFormatter", PointFormatter); }  
