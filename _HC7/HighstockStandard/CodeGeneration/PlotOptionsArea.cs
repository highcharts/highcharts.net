...
namespace Highsoft.Web.Mvc.Stocks
{
	public partial class PlotOptionsArea  : BaseObject
	{
		...
		{
			Accessibility = Accessibility_DefaultValue = new PlotOptionsAreaAccessibility();
			AllowPointSelect = AllowPointSelect_DefaultValue = false;
			Animation = Animation_DefaultValue = new Animation() { Enabled = true };
			AnimationBool = AnimationBool_DefaultValue = true;
			AnimationLimit = AnimationLimit_DefaultValue = null;
			BoostBlending = BoostBlending_DefaultValue = PlotOptionsAreaBoostBlending.Undefined;
			...
			Compare = Compare_DefaultValue = PlotOptionsAreaCompare.Percent;
			...
			DashStyle = DashStyle_DefaultValue = PlotOptionsAreaDashStyle.Null;
			...
			DataSorting = DataSorting_DefaultValue = new PlotOptionsAreaDataSorting();
			Description = Description_DefaultValue = "";
			DragDrop = DragDrop_DefaultValue = new PlotOptionsAreaDragDrop();
			...
			GapUnit = GapUnit_DefaultValue = PlotOptionsAreaGapUnit.Relative;
			...
			OnPoint = OnPoint_DefaultValue = new PlotOptionsAreaOnPoint();
			...
			Sonification = Sonification_DefaultValue = new PlotOptionsAreaSonification();
			Stacking = Stacking_DefaultValue = PlotOptionsAreaStacking.Null;
			States = States_DefaultValue = new PlotOptionsAreaStates();
			Step = Step_DefaultValue = PlotOptionsAreaStep.Null;
			...
			Zones = Zones_DefaultValue = new List<PlotOptionsAreaZones>();
		...
		private PlotOptionsAreaAccessibility Accessibility_DefaultValue { get; set; }
		...
		private PlotOptionsAreaBoostBlending BoostBlending_DefaultValue { get; set; }
		...
		private PlotOptionsAreaCompare Compare_DefaultValue { get; set; }
		...
		private PlotOptionsAreaDataSorting DataSorting_DefaultValue { get; set; }
		...
		private PlotOptionsAreaDragDrop DragDrop_DefaultValue { get; set; }
		...
		private PlotOptionsAreaFindNearestPointBy FindNearestPointBy_DefaultValue { get; set; }
		...
		private PlotOptionsAreaGapUnit GapUnit_DefaultValue { get; set; }
		...
		private PlotOptionsAreaLastPrice LastPrice_DefaultValue { get; set; }
		...
		private PlotOptionsAreaLastVisiblePrice LastVisiblePrice_DefaultValue { get; set; }
		...
		private PlotOptionsAreaOnPoint OnPoint_DefaultValue { get; set; }
		...
		private PlotOptionsAreaSonification Sonification_DefaultValue { get; set; }
