...
{
	public partial class PlotOptionsAreaDragDrop  : BaseObject
	{
		public PlotOptionsAreaDragDrop()
		{
			DraggableX = DraggableX_DefaultValue = null;
			DraggableY = DraggableY_DefaultValue = null;
			DragHandle = DragHandle_DefaultValue = new PlotOptionsAreaDragDropDragHandle();
			...
			GuideBox = GuideBox_DefaultValue = new PlotOptionsAreaDragDropGuideBox();
		...
		/// </summary>
		public PlotOptionsAreaDragDropDragHandle DragHandle { get; set; }
		private PlotOptionsAreaDragDropDragHandle DragHandle_DefaultValue { get; set; }
		...
		/// </summary>
		public PlotOptionsAreaDragDropGuideBox GuideBox { get; set; }
		private PlotOptionsAreaDragDropGuideBox GuideBox_DefaultValue { get; set; }
