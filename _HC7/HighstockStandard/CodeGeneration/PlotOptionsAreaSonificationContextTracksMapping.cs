...
{
	public partial class PlotOptionsAreaSonificationContextTracksMapping  : BaseObject
	{
		Hashtable h = new Hashtable();

		public PlotOptionsAreaSonificationContextTracksMapping()
		{
			Frequency = Frequency_DefaultValue = new PlotOptionsAreaSonificationContextTracksMappingFrequency();
			GapBetweenNotes = GapBetweenNotes_DefaultValue = new PlotOptionsAreaSonificationContextTracksMappingGapBetweenNotes();
			Highpass = Highpass_DefaultValue = new PlotOptionsAreaSonificationContextTracksMappingHighpass();
			Lowpass = Lowpass_DefaultValue = new PlotOptionsAreaSonificationContextTracksMappingLowpass();
			NoteDuration = NoteDuration_DefaultValue = new PlotOptionsAreaSonificationContextTracksMappingNoteDuration();
			Pan = Pan_DefaultValue = new PlotOptionsAreaSonificationContextTracksMappingPan();
			Pitch = Pitch_DefaultValue = new PlotOptionsAreaSonificationContextTracksMappingPitch();
			PitchString = PitchString_DefaultValue = "null";
			PitchNumber = PitchNumber_DefaultValue = null;
			PlayDelay = PlayDelay_DefaultValue = new PlotOptionsAreaSonificationContextTracksMappingPlayDelay();
			Time = Time_DefaultValue = new PlotOptionsAreaSonificationContextTracksMappingTime();
			TimeString = TimeString_DefaultValue = "null";
			TimeNumber = TimeNumber_DefaultValue = null;
			Tremolo = Tremolo_DefaultValue = new PlotOptionsAreaSonificationContextTracksMappingTremolo();
			Volume = Volume_DefaultValue = new PlotOptionsAreaSonificationContextTracksMappingVolume();
		...
		/// </summary>
		public PlotOptionsAreaSonificationContextTracksMappingFrequency Frequency { get; set; }
		private PlotOptionsAreaSonificationContextTracksMappingFrequency Frequency_DefaultValue { get; set; }
		...
		/// </summary>
		public PlotOptionsAreaSonificationContextTracksMappingGapBetweenNotes GapBetweenNotes { get; set; }
		private PlotOptionsAreaSonificationContextTracksMappingGapBetweenNotes GapBetweenNotes_DefaultValue { get; set; }
		...
		/// </summary>
		public PlotOptionsAreaSonificationContextTracksMappingHighpass Highpass { get; set; }
		private PlotOptionsAreaSonificationContextTracksMappingHighpass Highpass_DefaultValue { get; set; }
		...
		/// </summary>
		public PlotOptionsAreaSonificationContextTracksMappingLowpass Lowpass { get; set; }
		private PlotOptionsAreaSonificationContextTracksMappingLowpass Lowpass_DefaultValue { get; set; }
		...
		/// </summary>
		public PlotOptionsAreaSonificationContextTracksMappingNoteDuration NoteDuration { get; set; }
		private PlotOptionsAreaSonificationContextTracksMappingNoteDuration NoteDuration_DefaultValue { get; set; }
		...
		/// </summary>
		public PlotOptionsAreaSonificationContextTracksMappingPan Pan { get; set; }
		private PlotOptionsAreaSonificationContextTracksMappingPan Pan_DefaultValue { get; set; }
		...
		/// </summary>
		public PlotOptionsAreaSonificationContextTracksMappingPitch Pitch { get; set; }
		private PlotOptionsAreaSonificationContextTracksMappingPitch Pitch_DefaultValue { get; set; }
		...
		/// </summary>
		public PlotOptionsAreaSonificationContextTracksMappingPlayDelay PlayDelay { get; set; }
		private PlotOptionsAreaSonificationContextTracksMappingPlayDelay PlayDelay_DefaultValue { get; set; }
		...
		/// </summary>
		public PlotOptionsAreaSonificationContextTracksMappingTime Time { get; set; }
		private PlotOptionsAreaSonificationContextTracksMappingTime Time_DefaultValue { get; set; }
		...
		/// </summary>
		public PlotOptionsAreaSonificationContextTracksMappingTremolo Tremolo { get; set; }
		private PlotOptionsAreaSonificationContextTracksMappingTremolo Tremolo_DefaultValue { get; set; }
		 

		/// <summary>
		/// The volume of notes, from 0 to 1.
		/// </summary>
		public PlotOptionsAreaSonificationContextTracksMappingVolume Volume { get; set; }
		private PlotOptionsAreaSonificationContextTracksMappingVolume Volume_DefaultValue { get; set; }
