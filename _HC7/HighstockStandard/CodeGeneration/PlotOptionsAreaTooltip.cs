...
namespace Highsoft.Web.Mvc.Stocks
{
	public partial class PlotOptionsAreaTooltip  : BaseObject
	{
		...
		internal override Hashtable ToHashtable()
		{
			...
			if (NullFormatter != NullFormatter_DefaultValue) { h.Add("nullFormatter",NullFormatter); Highstock.AddFunction("PlotOptionsAreaTooltipNullFormatter.nullFormatter", NullFormatter); }  
