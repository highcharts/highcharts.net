...
namespace Highsoft.Web.Mvc.Stocks
{
	public partial class PlotOptionsArearange  : BaseObject
	{
		...
		public PlotOptionsArearange()
		{
			...
			Compare = Compare_DefaultValue = PlotOptionsArearangeCompare.Percent;
			...
			LegendSymbol = LegendSymbol_DefaultValue = PlotOptionsArearangeLegendSymbol.Rectangle;
			...
			Sonification = Sonification_DefaultValue = new PlotOptionsArearangeSonification();
			...
			Zones = Zones_DefaultValue = new List<PlotOptionsArearangeZones>();
		...
		private List<PlotOptionsArearangeZones> Zones_DefaultValue { get; set; }
