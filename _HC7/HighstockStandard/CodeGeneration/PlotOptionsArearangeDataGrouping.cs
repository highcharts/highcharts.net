...
namespace Highsoft.Web.Mvc.Stocks
{
	public partial class PlotOptionsArearangeDataGrouping  : BaseObject
	{
		...
		internal override Hashtable ToHashtable()
		{
			...
			if (Approximation != Approximation_DefaultValue) { h.Add("approximation",Approximation); Highstock.AddFunction("PlotOptionsArearangeDataGroupingApproximation.approximation", Approximation); }  
