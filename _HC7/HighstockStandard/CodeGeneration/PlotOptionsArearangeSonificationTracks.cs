...
{
	public partial class PlotOptionsArearangeSonificationTracks  : BaseObject
	{
		Hashtable h = new Hashtable();

		public PlotOptionsArearangeSonificationTracks()
		{
			ActiveWhen = ActiveWhen_DefaultValue = new PlotOptionsArearangeSonificationTracksActiveWhen();
			Instrument = Instrument_DefaultValue = null;
			InstrumentString = InstrumentString_DefaultValue = "null";
			Mapping = Mapping_DefaultValue = new PlotOptionsArearangeSonificationTracksMapping();
			MidiName = MidiName_DefaultValue = "";
			PointGrouping = PointGrouping_DefaultValue = new PlotOptionsArearangeSonificationTracksPointGrouping();
			RoundToMusicalNotes = RoundToMusicalNotes_DefaultValue = true;
			ShowPlayMarker = ShowPlayMarker_DefaultValue = true;
			Type = Type_DefaultValue = PlotOptionsArearangeSonificationTracksType.Instrument;
		...
		/// </summary>
		public PlotOptionsArearangeSonificationTracksActiveWhen ActiveWhen { get; set; }
		private PlotOptionsArearangeSonificationTracksActiveWhen ActiveWhen_DefaultValue { get; set; }
		...
		/// </summary>
		public PlotOptionsArearangeSonificationTracksMapping Mapping { get; set; }
		private PlotOptionsArearangeSonificationTracksMapping Mapping_DefaultValue { get; set; }
		...
		/// </summary>
		public PlotOptionsArearangeSonificationTracksPointGrouping PointGrouping { get; set; }
		private PlotOptionsArearangeSonificationTracksPointGrouping PointGrouping_DefaultValue { get; set; }
		...
		/// </summary>
		public PlotOptionsArearangeSonificationTracksType Type { get; set; }
		private PlotOptionsArearangeSonificationTracksType Type_DefaultValue { get; set; }
