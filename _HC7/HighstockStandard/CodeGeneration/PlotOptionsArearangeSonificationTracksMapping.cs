...
{
	public partial class PlotOptionsArearangeSonificationTracksMapping  : BaseObject
	{
		Hashtable h = new Hashtable();

		public PlotOptionsArearangeSonificationTracksMapping()
		{
			Frequency = Frequency_DefaultValue = new PlotOptionsArearangeSonificationTracksMappingFrequency();
			GapBetweenNotes = GapBetweenNotes_DefaultValue = new PlotOptionsArearangeSonificationTracksMappingGapBetweenNotes();
			Highpass = Highpass_DefaultValue = new PlotOptionsArearangeSonificationTracksMappingHighpass();
			Lowpass = Lowpass_DefaultValue = new PlotOptionsArearangeSonificationTracksMappingLowpass();
			NoteDuration = NoteDuration_DefaultValue = new PlotOptionsArearangeSonificationTracksMappingNoteDuration();
			Pan = Pan_DefaultValue = new PlotOptionsArearangeSonificationTracksMappingPan();
			Pitch = Pitch_DefaultValue = new PlotOptionsArearangeSonificationTracksMappingPitch();
			PitchString = PitchString_DefaultValue = "null";
			PitchNumber = PitchNumber_DefaultValue = null;
			PlayDelay = PlayDelay_DefaultValue = new PlotOptionsArearangeSonificationTracksMappingPlayDelay();
			Time = Time_DefaultValue = new PlotOptionsArearangeSonificationTracksMappingTime();
			TimeString = TimeString_DefaultValue = "null";
			TimeNumber = TimeNumber_DefaultValue = null;
			Tremolo = Tremolo_DefaultValue = new PlotOptionsArearangeSonificationTracksMappingTremolo();
			Volume = Volume_DefaultValue = new PlotOptionsArearangeSonificationTracksMappingVolume();
		...
		/// </summary>
		public PlotOptionsArearangeSonificationTracksMappingFrequency Frequency { get; set; }
		private PlotOptionsArearangeSonificationTracksMappingFrequency Frequency_DefaultValue { get; set; }
		...
		/// </summary>
		public PlotOptionsArearangeSonificationTracksMappingGapBetweenNotes GapBetweenNotes { get; set; }
		private PlotOptionsArearangeSonificationTracksMappingGapBetweenNotes GapBetweenNotes_DefaultValue { get; set; }
		...
		/// </summary>
		public PlotOptionsArearangeSonificationTracksMappingHighpass Highpass { get; set; }
		private PlotOptionsArearangeSonificationTracksMappingHighpass Highpass_DefaultValue { get; set; }
		...
		/// </summary>
		public PlotOptionsArearangeSonificationTracksMappingLowpass Lowpass { get; set; }
		private PlotOptionsArearangeSonificationTracksMappingLowpass Lowpass_DefaultValue { get; set; }
		...
		/// </summary>
		public PlotOptionsArearangeSonificationTracksMappingNoteDuration NoteDuration { get; set; }
		private PlotOptionsArearangeSonificationTracksMappingNoteDuration NoteDuration_DefaultValue { get; set; }
		...
		/// </summary>
		public PlotOptionsArearangeSonificationTracksMappingPan Pan { get; set; }
		private PlotOptionsArearangeSonificationTracksMappingPan Pan_DefaultValue { get; set; }
		...
		/// </summary>
		public PlotOptionsArearangeSonificationTracksMappingPitch Pitch { get; set; }
		private PlotOptionsArearangeSonificationTracksMappingPitch Pitch_DefaultValue { get; set; }
		...
		/// </summary>
		public PlotOptionsArearangeSonificationTracksMappingPlayDelay PlayDelay { get; set; }
		private PlotOptionsArearangeSonificationTracksMappingPlayDelay PlayDelay_DefaultValue { get; set; }
		...
		/// </summary>
		public PlotOptionsArearangeSonificationTracksMappingTime Time { get; set; }
		private PlotOptionsArearangeSonificationTracksMappingTime Time_DefaultValue { get; set; }
		...
		/// </summary>
		public PlotOptionsArearangeSonificationTracksMappingTremolo Tremolo { get; set; }
		private PlotOptionsArearangeSonificationTracksMappingTremolo Tremolo_DefaultValue { get; set; }
		 

		/// <summary>
		/// The volume of notes, from 0 to 1.
		/// </summary>
		public PlotOptionsArearangeSonificationTracksMappingVolume Volume { get; set; }
		private PlotOptionsArearangeSonificationTracksMappingVolume Volume_DefaultValue { get; set; }
