...
{
	public partial class PlotOptionsAreaspline  : BaseObject
	{
		Hashtable h = new Hashtable();

		public PlotOptionsAreaspline()
		{
			Accessibility = Accessibility_DefaultValue = new PlotOptionsAreasplineAccessibility();
			...
			Compare = Compare_DefaultValue = PlotOptionsAreasplineCompare.Percent;
			CompareBase = CompareBase_DefaultValue = PlotOptionsAreasplineCompareBase.Min;
			...
			DashStyle = DashStyle_DefaultValue = PlotOptionsAreasplineDashStyle.Null;
			DataGrouping = DataGrouping_DefaultValue = new PlotOptionsAreasplineDataGrouping();
			DataLabels = DataLabels_DefaultValue = new PlotOptionsAreasplineDataLabels();
			DataSorting = DataSorting_DefaultValue = new PlotOptionsAreasplineDataSorting();
			Description = Description_DefaultValue = "";
			DragDrop = DragDrop_DefaultValue = new PlotOptionsAreasplineDragDrop();
			...
			FindNearestPointBy = FindNearestPointBy_DefaultValue = PlotOptionsAreasplineFindNearestPointBy.X;
			GapSize = GapSize_DefaultValue = 0;
			GapUnit = GapUnit_DefaultValue = PlotOptionsAreasplineGapUnit.Relative;
			GetExtremesFromAll = GetExtremesFromAll_DefaultValue = false;
			InactiveOtherPoints = InactiveOtherPoints_DefaultValue = false;
			IncludeInDataExport = IncludeInDataExport_DefaultValue = null;
			Keys = Keys_DefaultValue = new List<string>();
			Label = Label_DefaultValue = new PlotOptionsAreasplineLabel();
			LastPrice = LastPrice_DefaultValue = new PlotOptionsAreasplineLastPrice();
			LastVisiblePrice = LastVisiblePrice_DefaultValue = new PlotOptionsAreasplineLastVisiblePrice();
			LegendSymbol = LegendSymbol_DefaultValue = PlotOptionsAreasplineLegendSymbol.Rectangle;
			Linecap = Linecap_DefaultValue = PlotOptionsAreasplineLinecap.Round;
			LineColor = LineColor_DefaultValue = "";
			LineWidth = LineWidth_DefaultValue = 2;
			LinkedTo = LinkedTo_DefaultValue = "";
			Marker = Marker_DefaultValue = new PlotOptionsAreasplineMarker();
			NegativeColor = NegativeColor_DefaultValue = "";
			NegativeFillColor = NegativeFillColor_DefaultValue = "";
			OnPoint = OnPoint_DefaultValue = new PlotOptionsAreasplineOnPoint();
			Opacity = Opacity_DefaultValue = 1;
			Point = Point_DefaultValue = new PlotOptionsAreasplinePoint();
			PointDescriptionFormat = PointDescriptionFormat_DefaultValue = "";
			PointDescriptionFormatter = PointDescriptionFormatter_DefaultValue = "";
			PointInterval = PointInterval_DefaultValue = 1;
			PointIntervalUnit = PointIntervalUnit_DefaultValue = PlotOptionsAreasplinePointIntervalUnit.Null;
			...
			Sonification = Sonification_DefaultValue = new PlotOptionsAreasplineSonification();
			Stacking = Stacking_DefaultValue = PlotOptionsAreasplineStacking.Null;
			States = States_DefaultValue = new PlotOptionsAreasplineStates();
			StickyTracking = StickyTracking_DefaultValue = true;
			Threshold = Threshold_DefaultValue = 0;
			Tooltip = Tooltip_DefaultValue = new PlotOptionsAreasplineTooltip();
			TrackByArea = TrackByArea_DefaultValue = false;
			TurboThreshold = TurboThreshold_DefaultValue = 1000;
			Visible = Visible_DefaultValue = true;
			ZoneAxis = ZoneAxis_DefaultValue = "y";
			Zones = Zones_DefaultValue = new List<PlotOptionsAreasplineZones>();
		...
		/// </summary>
		public PlotOptionsAreasplineAccessibility Accessibility { get; set; }
		private PlotOptionsAreasplineAccessibility Accessibility_DefaultValue { get; set; }
		...
		/// </summary>
		public PlotOptionsAreasplineCompare Compare { get; set; }
		private PlotOptionsAreasplineCompare Compare_DefaultValue { get; set; }
		 

		/// <summary>
		/// When [compare](#plotOptions.series.compare) is `percent`, this optiondictates whether to use 0 or 100 as the base of comparison.
		/// </summary>
		public PlotOptionsAreasplineCompareBase CompareBase { get; set; }
		private PlotOptionsAreasplineCompareBase CompareBase_DefaultValue { get; set; }
		...
		/// </summary>
		public PlotOptionsAreasplineDataSorting DataSorting { get; set; }
		private PlotOptionsAreasplineDataSorting DataSorting_DefaultValue { get; set; }
		...
		/// </summary>
		public PlotOptionsAreasplineDragDrop DragDrop { get; set; }
		private PlotOptionsAreasplineDragDrop DragDrop_DefaultValue { get; set; }
		...
		/// </summary>
		public PlotOptionsAreasplineFindNearestPointBy FindNearestPointBy { get; set; }
		private PlotOptionsAreasplineFindNearestPointBy FindNearestPointBy_DefaultValue { get; set; }
		...
		/// </summary>
		public PlotOptionsAreasplineGapUnit GapUnit { get; set; }
		private PlotOptionsAreasplineGapUnit GapUnit_DefaultValue { get; set; }
		...
		/// </summary>
		public PlotOptionsAreasplineLabel Label { get; set; }
		private PlotOptionsAreasplineLabel Label_DefaultValue { get; set; }
		 

		/// <summary>
		/// The line marks the last price from all points.
		/// </summary>
		public PlotOptionsAreasplineLastPrice LastPrice { get; set; }
		private PlotOptionsAreasplineLastPrice LastPrice_DefaultValue { get; set; }
		 

		/// <summary>
		/// The line marks the last price from visible range of points.
		/// </summary>
		public PlotOptionsAreasplineLastVisiblePrice LastVisiblePrice { get; set; }
		private PlotOptionsAreasplineLastVisiblePrice LastVisiblePrice_DefaultValue { get; set; }
		 

		/// <summary>
		/// What type of legend symbol to render for this series. Can be one of`areaMarker`, `lineMarker` or `rectangle`.
		/// </summary>
		public PlotOptionsAreasplineLegendSymbol LegendSymbol { get; set; }
		private PlotOptionsAreasplineLegendSymbol LegendSymbol_DefaultValue { get; set; }
		...
		/// </summary>
		public PlotOptionsAreasplineOnPoint OnPoint { get; set; }
		private PlotOptionsAreasplineOnPoint OnPoint_DefaultValue { get; set; }
		...
		/// </summary>
		public PlotOptionsAreasplineSonification Sonification { get; set; }
		private PlotOptionsAreasplineSonification Sonification_DefaultValue { get; set; }
		...
		/// </summary>
		public List<PlotOptionsAreasplineZones> Zones { get; set; }
		private List<PlotOptionsAreasplineZones> Zones_DefaultValue { get; set; }
