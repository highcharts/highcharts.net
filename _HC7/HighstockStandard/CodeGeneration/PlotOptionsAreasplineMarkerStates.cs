...
namespace Highsoft.Web.Mvc.Stocks
{
	public partial class PlotOptionsAreasplineMarkerStates  : BaseObject
	{
		public PlotOptionsAreasplineMarkerStates()
		{
			...
			Inactive = Inactive_DefaultValue = new PlotOptionsAreasplineMarkerStatesInactive();
		...
		/// 
		/// </summary>
		public PlotOptionsAreasplineMarkerStatesInactive Inactive { get; set; }
		private PlotOptionsAreasplineMarkerStatesInactive Inactive_DefaultValue { get; set; }
