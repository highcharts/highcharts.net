...
{
	public partial class PlotOptionsAreasplineSonificationContextTracksActiveWhen  : BaseObject
	{
		Hashtable h = new Hashtable();

		public PlotOptionsAreasplineSonificationContextTracksActiveWhen()
		{
		}	
