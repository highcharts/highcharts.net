...
{
	public partial class PlotOptionsAreasplineSonificationTracks  : BaseObject
	{
		Hashtable h = new Hashtable();

		public PlotOptionsAreasplineSonificationTracks()
		{
			ActiveWhen = ActiveWhen_DefaultValue = new PlotOptionsAreasplineSonificationTracksActiveWhen();
			Instrument = Instrument_DefaultValue = null;
			InstrumentString = InstrumentString_DefaultValue = "null";
			Mapping = Mapping_DefaultValue = new PlotOptionsAreasplineSonificationTracksMapping();
			MidiName = MidiName_DefaultValue = "";
			PointGrouping = PointGrouping_DefaultValue = new PlotOptionsAreasplineSonificationTracksPointGrouping();
			RoundToMusicalNotes = RoundToMusicalNotes_DefaultValue = true;
			ShowPlayMarker = ShowPlayMarker_DefaultValue = true;
			Type = Type_DefaultValue = PlotOptionsAreasplineSonificationTracksType.Instrument;
		...
		/// </summary>
		public PlotOptionsAreasplineSonificationTracksActiveWhen ActiveWhen { get; set; }
		private PlotOptionsAreasplineSonificationTracksActiveWhen ActiveWhen_DefaultValue { get; set; }
		...
		/// </summary>
		public PlotOptionsAreasplineSonificationTracksMapping Mapping { get; set; }
		private PlotOptionsAreasplineSonificationTracksMapping Mapping_DefaultValue { get; set; }
		...
		/// </summary>
		public PlotOptionsAreasplineSonificationTracksPointGrouping PointGrouping { get; set; }
		private PlotOptionsAreasplineSonificationTracksPointGrouping PointGrouping_DefaultValue { get; set; }
		...
		/// </summary>
		public PlotOptionsAreasplineSonificationTracksType Type { get; set; }
		private PlotOptionsAreasplineSonificationTracksType Type_DefaultValue { get; set; }
