...
namespace Highsoft.Web.Mvc.Stocks
{
	public partial class PlotOptionsAreasplinerange  : BaseObject
	{
		...
		{
			Accessibility = Accessibility_DefaultValue = new PlotOptionsAreasplinerangeAccessibility();
			...
			Compare = Compare_DefaultValue = PlotOptionsAreasplinerangeCompare.Percent;
			...
			DashStyle = DashStyle_DefaultValue = PlotOptionsAreasplinerangeDashStyle.Null;
			...
			DataSorting = DataSorting_DefaultValue = new PlotOptionsAreasplinerangeDataSorting();
			...
			OnPoint = OnPoint_DefaultValue = new PlotOptionsAreasplinerangeOnPoint();
			...
			Sonification = Sonification_DefaultValue = new PlotOptionsAreasplinerangeSonification();
			...
			Zones = Zones_DefaultValue = new List<PlotOptionsAreasplinerangeZones>();
		...
		private PlotOptionsAreasplinerangeAccessibility Accessibility_DefaultValue { get; set; }
		...
		private PlotOptionsAreasplinerangeCompare Compare_DefaultValue { get; set; }
		...
		private PlotOptionsAreasplinerangeDataSorting DataSorting_DefaultValue { get; set; }
		...
		private PlotOptionsAreasplinerangeDragDrop DragDrop_DefaultValue { get; set; }
		...
		private PlotOptionsAreasplinerangeLastPrice LastPrice_DefaultValue { get; set; }
		...
		private PlotOptionsAreasplinerangeLastVisiblePrice LastVisiblePrice_DefaultValue { get; set; }
		...
		private PlotOptionsAreasplinerangeLegendSymbol LegendSymbol_DefaultValue { get; set; }
		...
		private PlotOptionsAreasplinerangeOnPoint OnPoint_DefaultValue { get; set; }
		...
		private PlotOptionsAreasplinerangeSonification Sonification_DefaultValue { get; set; }
		...
		private List<PlotOptionsAreasplinerangeZones> Zones_DefaultValue { get; set; }
