...
{
	public partial class PlotOptionsAreasplinerangeSonificationContextTracksMapping  : BaseObject
	{
		Hashtable h = new Hashtable();

		public PlotOptionsAreasplinerangeSonificationContextTracksMapping()
		{
			Frequency = Frequency_DefaultValue = new PlotOptionsAreasplinerangeSonificationContextTracksMappingFrequency();
			GapBetweenNotes = GapBetweenNotes_DefaultValue = new PlotOptionsAreasplinerangeSonificationContextTracksMappingGapBetweenNotes();
			Highpass = Highpass_DefaultValue = new PlotOptionsAreasplinerangeSonificationContextTracksMappingHighpass();
			Lowpass = Lowpass_DefaultValue = new PlotOptionsAreasplinerangeSonificationContextTracksMappingLowpass();
			NoteDuration = NoteDuration_DefaultValue = new PlotOptionsAreasplinerangeSonificationContextTracksMappingNoteDuration();
			Pan = Pan_DefaultValue = new PlotOptionsAreasplinerangeSonificationContextTracksMappingPan();
			Pitch = Pitch_DefaultValue = new PlotOptionsAreasplinerangeSonificationContextTracksMappingPitch();
			PitchString = PitchString_DefaultValue = "null";
			PitchNumber = PitchNumber_DefaultValue = null;
			PlayDelay = PlayDelay_DefaultValue = new PlotOptionsAreasplinerangeSonificationContextTracksMappingPlayDelay();
			Time = Time_DefaultValue = new PlotOptionsAreasplinerangeSonificationContextTracksMappingTime();
			TimeString = TimeString_DefaultValue = "null";
			TimeNumber = TimeNumber_DefaultValue = null;
			Tremolo = Tremolo_DefaultValue = new PlotOptionsAreasplinerangeSonificationContextTracksMappingTremolo();
			Volume = Volume_DefaultValue = new PlotOptionsAreasplinerangeSonificationContextTracksMappingVolume();
		...
		/// </summary>
		public PlotOptionsAreasplinerangeSonificationContextTracksMappingFrequency Frequency { get; set; }
		private PlotOptionsAreasplinerangeSonificationContextTracksMappingFrequency Frequency_DefaultValue { get; set; }
		...
		/// </summary>
		public PlotOptionsAreasplinerangeSonificationContextTracksMappingGapBetweenNotes GapBetweenNotes { get; set; }
		private PlotOptionsAreasplinerangeSonificationContextTracksMappingGapBetweenNotes GapBetweenNotes_DefaultValue { get; set; }
		...
		/// </summary>
		public PlotOptionsAreasplinerangeSonificationContextTracksMappingHighpass Highpass { get; set; }
		private PlotOptionsAreasplinerangeSonificationContextTracksMappingHighpass Highpass_DefaultValue { get; set; }
		...
		/// </summary>
		public PlotOptionsAreasplinerangeSonificationContextTracksMappingLowpass Lowpass { get; set; }
		private PlotOptionsAreasplinerangeSonificationContextTracksMappingLowpass Lowpass_DefaultValue { get; set; }
		...
		/// </summary>
		public PlotOptionsAreasplinerangeSonificationContextTracksMappingNoteDuration NoteDuration { get; set; }
		private PlotOptionsAreasplinerangeSonificationContextTracksMappingNoteDuration NoteDuration_DefaultValue { get; set; }
		...
		/// </summary>
		public PlotOptionsAreasplinerangeSonificationContextTracksMappingPan Pan { get; set; }
		private PlotOptionsAreasplinerangeSonificationContextTracksMappingPan Pan_DefaultValue { get; set; }
		...
		/// </summary>
		public PlotOptionsAreasplinerangeSonificationContextTracksMappingPitch Pitch { get; set; }
		private PlotOptionsAreasplinerangeSonificationContextTracksMappingPitch Pitch_DefaultValue { get; set; }
		...
		/// </summary>
		public PlotOptionsAreasplinerangeSonificationContextTracksMappingPlayDelay PlayDelay { get; set; }
		private PlotOptionsAreasplinerangeSonificationContextTracksMappingPlayDelay PlayDelay_DefaultValue { get; set; }
		...
		/// </summary>
		public PlotOptionsAreasplinerangeSonificationContextTracksMappingTime Time { get; set; }
		private PlotOptionsAreasplinerangeSonificationContextTracksMappingTime Time_DefaultValue { get; set; }
		...
		/// </summary>
		public PlotOptionsAreasplinerangeSonificationContextTracksMappingTremolo Tremolo { get; set; }
		private PlotOptionsAreasplinerangeSonificationContextTracksMappingTremolo Tremolo_DefaultValue { get; set; }
		 

		/// <summary>
		/// The volume of notes, from 0 to 1.
		/// </summary>
		public PlotOptionsAreasplinerangeSonificationContextTracksMappingVolume Volume { get; set; }
		private PlotOptionsAreasplinerangeSonificationContextTracksMappingVolume Volume_DefaultValue { get; set; }
