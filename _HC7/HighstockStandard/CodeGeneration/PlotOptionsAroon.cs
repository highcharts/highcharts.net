...
{
	public partial class PlotOptionsAroon  : BaseObject
	{
		Hashtable h = new Hashtable();

		public PlotOptionsAroon()
		{
			Accessibility = Accessibility_DefaultValue = new PlotOptionsAroonAccessibility();
			AllowPointSelect = AllowPointSelect_DefaultValue = false;
			Animation = Animation_DefaultValue = new Animation() { Enabled = true };
			AnimationBool = AnimationBool_DefaultValue = true;
			AnimationLimit = AnimationLimit_DefaultValue = null;
			AroonDown = AroonDown_DefaultValue = new PlotOptionsAroonAroonDown();
			BoostBlending = BoostBlending_DefaultValue = PlotOptionsAroonBoostBlending.Undefined;
			...
			Cursor = Cursor_DefaultValue = PlotOptionsAroonCursor.Null;
			Custom = Custom_DefaultValue = new Hashtable();
			DashStyle = DashStyle_DefaultValue = PlotOptionsAroonDashStyle.Null;
			DataGrouping = DataGrouping_DefaultValue = new PlotOptionsAroonDataGrouping();
			DataLabels = DataLabels_DefaultValue = new PlotOptionsAroonDataLabels();
			DataSorting = DataSorting_DefaultValue = new PlotOptionsAroonDataSorting();
			Description = Description_DefaultValue = "";
			EnableMouseTracking = EnableMouseTracking_DefaultValue = true;
			Events = Events_DefaultValue = new PlotOptionsAroonEvents();
			FindNearestPointBy = FindNearestPointBy_DefaultValue = PlotOptionsAroonFindNearestPointBy.X;
			GapSize = GapSize_DefaultValue = 0;
			GapUnit = GapUnit_DefaultValue = PlotOptionsAroonGapUnit.Relative;
			GetExtremesFromAll = GetExtremesFromAll_DefaultValue = false;
			IncludeInDataExport = IncludeInDataExport_DefaultValue = null;
			Label = Label_DefaultValue = new PlotOptionsAroonLabel();
			LastPrice = LastPrice_DefaultValue = new PlotOptionsAroonLastPrice();
			LastVisiblePrice = LastVisiblePrice_DefaultValue = new PlotOptionsAroonLastVisiblePrice();
			LegendSymbol = LegendSymbol_DefaultValue = PlotOptionsAroonLegendSymbol.Rectangle;
			Linecap = Linecap_DefaultValue = PlotOptionsAroonLinecap.Round;
			LineWidth = LineWidth_DefaultValue = 1;
			LinkedTo = LinkedTo_DefaultValue = "";
			Marker = Marker_DefaultValue = new PlotOptionsAroonMarker();
			NegativeColor = NegativeColor_DefaultValue = "";
			OnPoint = OnPoint_DefaultValue = new PlotOptionsAroonOnPoint();
			Opacity = Opacity_DefaultValue = 1;
			Params = Params_DefaultValue = new PlotOptionsAroonParams();
			Point = Point_DefaultValue = new PlotOptionsAroonPoint();
			...
			Sonification = Sonification_DefaultValue = new PlotOptionsAroonSonification();
			States = States_DefaultValue = new PlotOptionsAroonStates();
			Step = Step_DefaultValue = PlotOptionsAroonStep.Null;
			StickyTracking = StickyTracking_DefaultValue = true;
			Threshold = Threshold_DefaultValue = 0;
			Tooltip = Tooltip_DefaultValue = new PlotOptionsAroonTooltip();
		...
		/// </summary>
		public PlotOptionsAroonAccessibility Accessibility { get; set; }
		private PlotOptionsAroonAccessibility Accessibility_DefaultValue { get; set; }
		...
		/// </summary>
		public PlotOptionsAroonAroonDown AroonDown { get; set; }
		private PlotOptionsAroonAroonDown AroonDown_DefaultValue { get; set; }
		 

		/// <summary>
		/// Sets the color blending in the boost module.
		/// </summary>
		public PlotOptionsAroonBoostBlending BoostBlending { get; set; }
		private PlotOptionsAroonBoostBlending BoostBlending_DefaultValue { get; set; }
		...
		/// </summary>
		public PlotOptionsAroonCursor Cursor { get; set; }
		private PlotOptionsAroonCursor Cursor_DefaultValue { get; set; }
		...
		/// </summary>
		public PlotOptionsAroonDashStyle DashStyle { get; set; }
		private PlotOptionsAroonDashStyle DashStyle_DefaultValue { get; set; }
		 

		/// <summary>
		/// 
		/// </summary>
		public PlotOptionsAroonDataGrouping DataGrouping { get; set; }
		private PlotOptionsAroonDataGrouping DataGrouping_DefaultValue { get; set; }
		...
		/// </summary>
		public PlotOptionsAroonDataLabels DataLabels { get; set; }
		private PlotOptionsAroonDataLabels DataLabels_DefaultValue { get; set; }
		 

		/// <summary>
		/// Options for the series data sorting.
		/// </summary>
		public PlotOptionsAroonDataSorting DataSorting { get; set; }
		private PlotOptionsAroonDataSorting DataSorting_DefaultValue { get; set; }
		...
		/// </summary>
		public PlotOptionsAroonEvents Events { get; set; }
		private PlotOptionsAroonEvents Events_DefaultValue { get; set; }
		...
		/// </summary>
		public PlotOptionsAroonFindNearestPointBy FindNearestPointBy { get; set; }
		private PlotOptionsAroonFindNearestPointBy FindNearestPointBy_DefaultValue { get; set; }
		...
		/// </summary>
		public PlotOptionsAroonGapUnit GapUnit { get; set; }
		private PlotOptionsAroonGapUnit GapUnit_DefaultValue { get; set; }
		...
		/// </summary>
		public PlotOptionsAroonLabel Label { get; set; }
		private PlotOptionsAroonLabel Label_DefaultValue { get; set; }
		 

		/// <summary>
		/// The line marks the last price from all points.
		/// </summary>
		public PlotOptionsAroonLastPrice LastPrice { get; set; }
		private PlotOptionsAroonLastPrice LastPrice_DefaultValue { get; set; }
		 

		/// <summary>
		/// The line marks the last price from visible range of points.
		/// </summary>
		public PlotOptionsAroonLastVisiblePrice LastVisiblePrice { get; set; }
		private PlotOptionsAroonLastVisiblePrice LastVisiblePrice_DefaultValue { get; set; }
		 

		/// <summary>
		/// What type of legend symbol to render for this series. Can be one of`lineMarker` or `rectangle`.
		/// </summary>
		public PlotOptionsAroonLegendSymbol LegendSymbol { get; set; }
		private PlotOptionsAroonLegendSymbol LegendSymbol_DefaultValue { get; set; }
		 

		/// <summary>
		/// The line cap used for line ends and line joins on the graph.
		/// </summary>
		public PlotOptionsAroonLinecap Linecap { get; set; }
		private PlotOptionsAroonLinecap Linecap_DefaultValue { get; set; }
		...
		/// 
		/// </summary>
		public PlotOptionsAroonMarker Marker { get; set; }
		private PlotOptionsAroonMarker Marker_DefaultValue { get; set; }
		...
		/// </summary>
		public PlotOptionsAroonOnPoint OnPoint { get; set; }
		private PlotOptionsAroonOnPoint OnPoint_DefaultValue { get; set; }
		...
		/// </summary>
		public PlotOptionsAroonPoint Point { get; set; }
		private PlotOptionsAroonPoint Point_DefaultValue { get; set; }
		...
		/// </summary>
		public PlotOptionsAroonSonification Sonification { get; set; }
		private PlotOptionsAroonSonification Sonification_DefaultValue { get; set; }
		 

		/// <summary>
		/// 
		/// </summary>
		public PlotOptionsAroonStates States { get; set; }
		private PlotOptionsAroonStates States_DefaultValue { get; set; }
		 

		/// <summary>
		/// Whether to apply steps to the line. Possible values are `left`,`center` and `right`.
		/// </summary>
		public PlotOptionsAroonStep Step { get; set; }
		private PlotOptionsAroonStep Step_DefaultValue { get; set; }
		...
		/// 
		/// </summary>
		public PlotOptionsAroonTooltip Tooltip { get; set; }
		private PlotOptionsAroonTooltip Tooltip_DefaultValue { get; set; }
