...
{
	public partial class PlotOptionsAroonDragDrop  : BaseObject
	{
		public PlotOptionsAroonDragDrop()
		{
			DraggableX = DraggableX_DefaultValue = null;
			DraggableY = DraggableY_DefaultValue = null;
			DragHandle = DragHandle_DefaultValue = new PlotOptionsAroonDragDropDragHandle();
			...
			GuideBox = GuideBox_DefaultValue = new PlotOptionsAroonDragDropGuideBox();
		...
		/// </summary>
		public PlotOptionsAroonDragDropDragHandle DragHandle { get; set; }
		private PlotOptionsAroonDragDropDragHandle DragHandle_DefaultValue { get; set; }
		...
		/// </summary>
		public PlotOptionsAroonDragDropGuideBox GuideBox { get; set; }
		private PlotOptionsAroonDragDropGuideBox GuideBox_DefaultValue { get; set; }
