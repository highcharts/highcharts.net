...
{
	public partial class PlotOptionsAroonLabel  : BaseObject
	{
		public PlotOptionsAroonLabel()
		{
			...
			Style = Style_DefaultValue = new PlotOptionsAroonLabelStyle();
		...
		/// </summary>
		public PlotOptionsAroonLabelStyle Style { get; set; }
		private PlotOptionsAroonLabelStyle Style_DefaultValue { get; set; }
