...
namespace Highsoft.Web.Mvc.Stocks
{
	public partial class PlotOptionsAroonMarkerStates  : BaseObject
	{
		public PlotOptionsAroonMarkerStates()
		{
			...
			Inactive = Inactive_DefaultValue = new PlotOptionsAroonMarkerStatesInactive();
		...
		/// 
		/// </summary>
		public PlotOptionsAroonMarkerStatesInactive Inactive { get; set; }
		private PlotOptionsAroonMarkerStatesInactive Inactive_DefaultValue { get; set; }
