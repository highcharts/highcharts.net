...
{
	public partial class PlotOptionsAroonSonification  : BaseObject
	{
		Hashtable h = new Hashtable();

		public PlotOptionsAroonSonification()
		{
		}	
		...
		/// </summary>
		public PlotOptionsAroonSonificationContextTracks ContextTracks { get; set; }
		 

		/// <summary>
		/// Default options for all this series' instrument tracks.
		/// </summary>
		public PlotOptionsAroonSonificationDefaultInstrumentOptions DefaultInstrumentOptions { get; set; }
		 

		/// <summary>
		/// Default options for all this series' speech tracks.
		/// </summary>
		public PlotOptionsAroonSonificationDefaultSpeechOptions DefaultSpeechOptions { get; set; }
		...
		/// </summary>
		public PlotOptionsAroonSonificationPointGrouping PointGrouping { get; set; }
		 

		/// <summary>
		/// Tracks for this series.Given as an array of instrument tracks, speech tracks, or a mix of both.
		/// </summary>
		public PlotOptionsAroonSonificationTracks Tracks { get; set; }
