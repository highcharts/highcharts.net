...
{
	public partial class PlotOptionsAroonSonificationContextTracksMappingVolume  : BaseObject
	{
		Hashtable h = new Hashtable();

		public PlotOptionsAroonSonificationContextTracksMappingVolume()
		{
			MapFunction = MapFunction_DefaultValue = PlotOptionsAroonSonificationContextTracksMappingVolumeMapFunction.Linear;
			MapTo = MapTo_DefaultValue = "";
			Max = Max_DefaultValue = null;
			Min = Min_DefaultValue = null;
			Value = Value_DefaultValue = null;
			Within = Within_DefaultValue = PlotOptionsAroonSonificationContextTracksMappingVolumeWithin.Chart;
		...
		/// </summary>
		public PlotOptionsAroonSonificationContextTracksMappingVolumeMapFunction MapFunction { get; set; }
		private PlotOptionsAroonSonificationContextTracksMappingVolumeMapFunction MapFunction_DefaultValue { get; set; }
		...
		/// </summary>
		public PlotOptionsAroonSonificationContextTracksMappingVolumeWithin Within { get; set; }
		private PlotOptionsAroonSonificationContextTracksMappingVolumeWithin Within_DefaultValue { get; set; }
