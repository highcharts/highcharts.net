...
{
	public partial class PlotOptionsAroonSonificationDefaultInstrumentOptionsPointGrouping  : BaseObject
	{
		Hashtable h = new Hashtable();

		public PlotOptionsAroonSonificationDefaultInstrumentOptionsPointGrouping()
		{
			Algorithm = Algorithm_DefaultValue = PlotOptionsAroonSonificationDefaultInstrumentOptionsPointGroupingAlgorithm.Minimax;
		...
		/// </summary>
		public PlotOptionsAroonSonificationDefaultInstrumentOptionsPointGroupingAlgorithm Algorithm { get; set; }
		private PlotOptionsAroonSonificationDefaultInstrumentOptionsPointGroupingAlgorithm Algorithm_DefaultValue { get; set; }
