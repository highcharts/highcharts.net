...
{
	public partial class PlotOptionsAroonSonificationPointGrouping  : BaseObject
	{
		Hashtable h = new Hashtable();

		public PlotOptionsAroonSonificationPointGrouping()
		{
			Algorithm = Algorithm_DefaultValue = PlotOptionsAroonSonificationPointGroupingAlgorithm.Minimax;
		...
		/// </summary>
		public PlotOptionsAroonSonificationPointGroupingAlgorithm Algorithm { get; set; }
		private PlotOptionsAroonSonificationPointGroupingAlgorithm Algorithm_DefaultValue { get; set; }
