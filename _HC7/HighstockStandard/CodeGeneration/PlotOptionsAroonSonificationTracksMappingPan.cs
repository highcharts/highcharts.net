...
{
	public partial class PlotOptionsAroonSonificationTracksMappingPan  : BaseObject
	{
		Hashtable h = new Hashtable();

		public PlotOptionsAroonSonificationTracksMappingPan()
		{
			MapFunction = MapFunction_DefaultValue = PlotOptionsAroonSonificationTracksMappingPanMapFunction.Linear;
			MapTo = MapTo_DefaultValue = "";
			Max = Max_DefaultValue = null;
			Min = Min_DefaultValue = null;
			Value = Value_DefaultValue = null;
			Within = Within_DefaultValue = PlotOptionsAroonSonificationTracksMappingPanWithin.Chart;
		...
		/// </summary>
		public PlotOptionsAroonSonificationTracksMappingPanMapFunction MapFunction { get; set; }
		private PlotOptionsAroonSonificationTracksMappingPanMapFunction MapFunction_DefaultValue { get; set; }
		...
		/// </summary>
		public PlotOptionsAroonSonificationTracksMappingPanWithin Within { get; set; }
		private PlotOptionsAroonSonificationTracksMappingPanWithin Within_DefaultValue { get; set; }
