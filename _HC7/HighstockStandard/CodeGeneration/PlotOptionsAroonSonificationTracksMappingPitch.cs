...
{
	public partial class PlotOptionsAroonSonificationTracksMappingPitch  : BaseObject
	{
		Hashtable h = new Hashtable();

		public PlotOptionsAroonSonificationTracksMappingPitch()
		{
			MapFunction = MapFunction_DefaultValue = PlotOptionsAroonSonificationTracksMappingPitchMapFunction.Linear;
		...
		/// </summary>
		public PlotOptionsAroonSonificationTracksMappingPitchMapFunction MapFunction { get; set; }
		private PlotOptionsAroonSonificationTracksMappingPitchMapFunction MapFunction_DefaultValue { get; set; }
