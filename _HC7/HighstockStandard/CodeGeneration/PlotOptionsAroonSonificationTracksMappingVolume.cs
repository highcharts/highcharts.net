...
{
	public partial class PlotOptionsAroonSonificationTracksMappingVolume  : BaseObject
	{
		Hashtable h = new Hashtable();

		public PlotOptionsAroonSonificationTracksMappingVolume()
		{
			MapFunction = MapFunction_DefaultValue = PlotOptionsAroonSonificationTracksMappingVolumeMapFunction.Linear;
			MapTo = MapTo_DefaultValue = "";
			Max = Max_DefaultValue = null;
			Min = Min_DefaultValue = null;
			Value = Value_DefaultValue = null;
			Within = Within_DefaultValue = PlotOptionsAroonSonificationTracksMappingVolumeWithin.Chart;
		...
		/// </summary>
		public PlotOptionsAroonSonificationTracksMappingVolumeMapFunction MapFunction { get; set; }
		private PlotOptionsAroonSonificationTracksMappingVolumeMapFunction MapFunction_DefaultValue { get; set; }
		...
		/// </summary>
		public PlotOptionsAroonSonificationTracksMappingVolumeWithin Within { get; set; }
		private PlotOptionsAroonSonificationTracksMappingVolumeWithin Within_DefaultValue { get; set; }
