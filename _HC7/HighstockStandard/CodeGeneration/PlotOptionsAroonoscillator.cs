...
{
	public partial class PlotOptionsAroonoscillator  : BaseObject
	{
		Hashtable h = new Hashtable();

		public PlotOptionsAroonoscillator()
		{
			Accessibility = Accessibility_DefaultValue = new PlotOptionsAroonoscillatorAccessibility();
			AllowPointSelect = AllowPointSelect_DefaultValue = false;
			Animation = Animation_DefaultValue = new Animation() { Enabled = true };
			AnimationBool = AnimationBool_DefaultValue = true;
			AnimationLimit = AnimationLimit_DefaultValue = null;
			BoostBlending = BoostBlending_DefaultValue = PlotOptionsAroonoscillatorBoostBlending.Undefined;
			...
			Cursor = Cursor_DefaultValue = PlotOptionsAroonoscillatorCursor.Null;
			Custom = Custom_DefaultValue = new Hashtable();
			DashStyle = DashStyle_DefaultValue = PlotOptionsAroonoscillatorDashStyle.Null;
			DataGrouping = DataGrouping_DefaultValue = new PlotOptionsAroonoscillatorDataGrouping();
			DataLabels = DataLabels_DefaultValue = new PlotOptionsAroonoscillatorDataLabels();
			DataSorting = DataSorting_DefaultValue = new PlotOptionsAroonoscillatorDataSorting();
			Description = Description_DefaultValue = "";
			EnableMouseTracking = EnableMouseTracking_DefaultValue = true;
			Events = Events_DefaultValue = new PlotOptionsAroonoscillatorEvents();
			FindNearestPointBy = FindNearestPointBy_DefaultValue = PlotOptionsAroonoscillatorFindNearestPointBy.X;
			GapSize = GapSize_DefaultValue = 0;
			GapUnit = GapUnit_DefaultValue = PlotOptionsAroonoscillatorGapUnit.Relative;
			GetExtremesFromAll = GetExtremesFromAll_DefaultValue = false;
			InactiveOtherPoints = InactiveOtherPoints_DefaultValue = false;
			IncludeInDataExport = IncludeInDataExport_DefaultValue = null;
			Label = Label_DefaultValue = new PlotOptionsAroonoscillatorLabel();
			LastPrice = LastPrice_DefaultValue = new PlotOptionsAroonoscillatorLastPrice();
			LastVisiblePrice = LastVisiblePrice_DefaultValue = new PlotOptionsAroonoscillatorLastVisiblePrice();
			LegendSymbol = LegendSymbol_DefaultValue = PlotOptionsAroonoscillatorLegendSymbol.Rectangle;
			Linecap = Linecap_DefaultValue = PlotOptionsAroonoscillatorLinecap.Round;
			LineWidth = LineWidth_DefaultValue = 2;
			LinkedTo = LinkedTo_DefaultValue = "";
			Marker = Marker_DefaultValue = new PlotOptionsAroonoscillatorMarker();
			NegativeColor = NegativeColor_DefaultValue = "";
			OnPoint = OnPoint_DefaultValue = new PlotOptionsAroonoscillatorOnPoint();
			Opacity = Opacity_DefaultValue = 1;
			Params = Params_DefaultValue = new PlotOptionsAroonoscillatorParams();
			Point = Point_DefaultValue = new PlotOptionsAroonoscillatorPoint();
			...
			Sonification = Sonification_DefaultValue = new PlotOptionsAroonoscillatorSonification();
			States = States_DefaultValue = new PlotOptionsAroonoscillatorStates();
			Step = Step_DefaultValue = PlotOptionsAroonoscillatorStep.Null;
			StickyTracking = StickyTracking_DefaultValue = true;
			Threshold = Threshold_DefaultValue = 0;
			Tooltip = Tooltip_DefaultValue = new PlotOptionsAroonoscillatorTooltip();
			TurboThreshold = TurboThreshold_DefaultValue = 1000;
			Visible = Visible_DefaultValue = true;
			ZoneAxis = ZoneAxis_DefaultValue = "y";
			Zones = Zones_DefaultValue = new List<PlotOptionsAroonoscillatorZones>();
		...
		/// </summary>
		public PlotOptionsAroonoscillatorAccessibility Accessibility { get; set; }
		private PlotOptionsAroonoscillatorAccessibility Accessibility_DefaultValue { get; set; }
		...
		/// </summary>
		public PlotOptionsAroonoscillatorBoostBlending BoostBlending { get; set; }
		private PlotOptionsAroonoscillatorBoostBlending BoostBlending_DefaultValue { get; set; }
		...
		/// </summary>
		public PlotOptionsAroonoscillatorCursor Cursor { get; set; }
		private PlotOptionsAroonoscillatorCursor Cursor_DefaultValue { get; set; }
		...
		/// </summary>
		public PlotOptionsAroonoscillatorDashStyle DashStyle { get; set; }
		private PlotOptionsAroonoscillatorDashStyle DashStyle_DefaultValue { get; set; }
		...
		/// </summary>
		public PlotOptionsAroonoscillatorDataGrouping DataGrouping { get; set; }
		private PlotOptionsAroonoscillatorDataGrouping DataGrouping_DefaultValue { get; set; }
		...
		/// </summary>
		public PlotOptionsAroonoscillatorDataLabels DataLabels { get; set; }
		private PlotOptionsAroonoscillatorDataLabels DataLabels_DefaultValue { get; set; }
		 

		/// <summary>
		/// Options for the series data sorting.
		/// </summary>
		public PlotOptionsAroonoscillatorDataSorting DataSorting { get; set; }
		private PlotOptionsAroonoscillatorDataSorting DataSorting_DefaultValue { get; set; }
		...
		/// </summary>
		public PlotOptionsAroonoscillatorEvents Events { get; set; }
		private PlotOptionsAroonoscillatorEvents Events_DefaultValue { get; set; }
		...
		/// </summary>
		public PlotOptionsAroonoscillatorFindNearestPointBy FindNearestPointBy { get; set; }
		private PlotOptionsAroonoscillatorFindNearestPointBy FindNearestPointBy_DefaultValue { get; set; }
		...
		/// </summary>
		public PlotOptionsAroonoscillatorGapUnit GapUnit { get; set; }
		private PlotOptionsAroonoscillatorGapUnit GapUnit_DefaultValue { get; set; }
		...
		/// </summary>
		public PlotOptionsAroonoscillatorLabel Label { get; set; }
		private PlotOptionsAroonoscillatorLabel Label_DefaultValue { get; set; }
		 

		/// <summary>
		/// The line marks the last price from all points.
		/// </summary>
		public PlotOptionsAroonoscillatorLastPrice LastPrice { get; set; }
		private PlotOptionsAroonoscillatorLastPrice LastPrice_DefaultValue { get; set; }
		 

		/// <summary>
		/// The line marks the last price from visible range of points.
		/// </summary>
		public PlotOptionsAroonoscillatorLastVisiblePrice LastVisiblePrice { get; set; }
		private PlotOptionsAroonoscillatorLastVisiblePrice LastVisiblePrice_DefaultValue { get; set; }
		 

		/// <summary>
		/// What type of legend symbol to render for this series. Can be one of`areaMarker`, `lineMarker` or `rectangle`.
		/// </summary>
		public PlotOptionsAroonoscillatorLegendSymbol LegendSymbol { get; set; }
		private PlotOptionsAroonoscillatorLegendSymbol LegendSymbol_DefaultValue { get; set; }
		 

		/// <summary>
		/// The line cap used for line ends and line joins on the graph.
		/// </summary>
		public PlotOptionsAroonoscillatorLinecap Linecap { get; set; }
		private PlotOptionsAroonoscillatorLinecap Linecap_DefaultValue { get; set; }
		...
		/// </summary>
		public PlotOptionsAroonoscillatorMarker Marker { get; set; }
		private PlotOptionsAroonoscillatorMarker Marker_DefaultValue { get; set; }
		...
		/// </summary>
		public PlotOptionsAroonoscillatorOnPoint OnPoint { get; set; }
		private PlotOptionsAroonoscillatorOnPoint OnPoint_DefaultValue { get; set; }
		...
		/// </summary>
		public PlotOptionsAroonoscillatorParams Params { get; set; }
		private PlotOptionsAroonoscillatorParams Params_DefaultValue { get; set; }
		 

		/// <summary>
		/// Properties for each single point.
		/// </summary>
		public PlotOptionsAroonoscillatorPoint Point { get; set; }
		private PlotOptionsAroonoscillatorPoint Point_DefaultValue { get; set; }
		...
		/// </summary>
		public PlotOptionsAroonoscillatorSonification Sonification { get; set; }
		private PlotOptionsAroonoscillatorSonification Sonification_DefaultValue { get; set; }
		 

		/// <summary>
		/// 
		/// </summary>
		public PlotOptionsAroonoscillatorStates States { get; set; }
		private PlotOptionsAroonoscillatorStates States_DefaultValue { get; set; }
		 

		/// <summary>
		/// Whether to apply steps to the line. Possible values are `left`,`center` and `right`.
		/// </summary>
		public PlotOptionsAroonoscillatorStep Step { get; set; }
		private PlotOptionsAroonoscillatorStep Step_DefaultValue { get; set; }
		...
		/// 
		/// </summary>
		public PlotOptionsAroonoscillatorTooltip Tooltip { get; set; }
		private PlotOptionsAroonoscillatorTooltip Tooltip_DefaultValue { get; set; }
		...
		/// </summary>
		public List<PlotOptionsAroonoscillatorZones> Zones { get; set; }
		private List<PlotOptionsAroonoscillatorZones> Zones_DefaultValue { get; set; }
