...
namespace Highsoft.Web.Mvc.Stocks
{
	public partial class PlotOptionsAroonoscillator  : BaseObject
	{
		...
		public PlotOptionsAroonoscillator()
		{
			...
			Zones = Zones_DefaultValue = new List<PlotOptionsAroonoscillatorZone>();
		...
		/// </summary>
		public List<PlotOptionsAroonoscillatorZone> Zones { get; set; }
		private List<PlotOptionsAroonoscillatorZone> Zones_DefaultValue { get; set; }
