...
{
	public partial class PlotOptionsAroonoscillatorLabel  : BaseObject
	{
		public PlotOptionsAroonoscillatorLabel()
		{
			...
			Style = Style_DefaultValue = new PlotOptionsAroonoscillatorLabelStyle();
		...
		/// </summary>
		public PlotOptionsAroonoscillatorLabelStyle Style { get; set; }
		private PlotOptionsAroonoscillatorLabelStyle Style_DefaultValue { get; set; }
