...
{
	public partial class PlotOptionsAroonoscillatorSonificationContextTracks  : BaseObject
	{
		Hashtable h = new Hashtable();

		public PlotOptionsAroonoscillatorSonificationContextTracks()
		{
			ActiveWhen = ActiveWhen_DefaultValue = new PlotOptionsAroonoscillatorSonificationContextTracksActiveWhen();
			Instrument = Instrument_DefaultValue = null;
			InstrumentString = InstrumentString_DefaultValue = "null";
			Mapping = Mapping_DefaultValue = new PlotOptionsAroonoscillatorSonificationContextTracksMapping();
			MidiName = MidiName_DefaultValue = "";
			PointGrouping = PointGrouping_DefaultValue = new PlotOptionsAroonoscillatorSonificationContextTracksPointGrouping();
			...
			Type = Type_DefaultValue = PlotOptionsAroonoscillatorSonificationContextTracksType.Instrument;
			ValueInterval = ValueInterval_DefaultValue = null;
			ValueMapFunction = ValueMapFunction_DefaultValue = PlotOptionsAroonoscillatorSonificationContextTracksValueMapFunction.Linear;
		...
		/// </summary>
		public PlotOptionsAroonoscillatorSonificationContextTracksActiveWhen ActiveWhen { get; set; }
		private PlotOptionsAroonoscillatorSonificationContextTracksActiveWhen ActiveWhen_DefaultValue { get; set; }
		...
		/// </summary>
		public PlotOptionsAroonoscillatorSonificationContextTracksMapping Mapping { get; set; }
		private PlotOptionsAroonoscillatorSonificationContextTracksMapping Mapping_DefaultValue { get; set; }
		...
		/// </summary>
		public PlotOptionsAroonoscillatorSonificationContextTracksPointGrouping PointGrouping { get; set; }
		private PlotOptionsAroonoscillatorSonificationContextTracksPointGrouping PointGrouping_DefaultValue { get; set; }
		...
		/// </summary>
		public PlotOptionsAroonoscillatorSonificationContextTracksType Type { get; set; }
		private PlotOptionsAroonoscillatorSonificationContextTracksType Type_DefaultValue { get; set; }
		...
		/// </summary>
		public PlotOptionsAroonoscillatorSonificationContextTracksValueMapFunction ValueMapFunction { get; set; }
		private PlotOptionsAroonoscillatorSonificationContextTracksValueMapFunction ValueMapFunction_DefaultValue { get; set; }
