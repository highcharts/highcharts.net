...
{
	public partial class PlotOptionsAroonoscillatorSonificationContextTracksMapping  : BaseObject
	{
		Hashtable h = new Hashtable();

		public PlotOptionsAroonoscillatorSonificationContextTracksMapping()
		{
			Frequency = Frequency_DefaultValue = new PlotOptionsAroonoscillatorSonificationContextTracksMappingFrequency();
			GapBetweenNotes = GapBetweenNotes_DefaultValue = new PlotOptionsAroonoscillatorSonificationContextTracksMappingGapBetweenNotes();
			Highpass = Highpass_DefaultValue = new PlotOptionsAroonoscillatorSonificationContextTracksMappingHighpass();
			Lowpass = Lowpass_DefaultValue = new PlotOptionsAroonoscillatorSonificationContextTracksMappingLowpass();
			NoteDuration = NoteDuration_DefaultValue = new PlotOptionsAroonoscillatorSonificationContextTracksMappingNoteDuration();
			Pan = Pan_DefaultValue = new PlotOptionsAroonoscillatorSonificationContextTracksMappingPan();
			Pitch = Pitch_DefaultValue = new PlotOptionsAroonoscillatorSonificationContextTracksMappingPitch();
			PitchString = PitchString_DefaultValue = "null";
			PitchNumber = PitchNumber_DefaultValue = null;
			PlayDelay = PlayDelay_DefaultValue = new PlotOptionsAroonoscillatorSonificationContextTracksMappingPlayDelay();
			Time = Time_DefaultValue = new PlotOptionsAroonoscillatorSonificationContextTracksMappingTime();
			TimeString = TimeString_DefaultValue = "null";
			TimeNumber = TimeNumber_DefaultValue = null;
			Tremolo = Tremolo_DefaultValue = new PlotOptionsAroonoscillatorSonificationContextTracksMappingTremolo();
			Volume = Volume_DefaultValue = new PlotOptionsAroonoscillatorSonificationContextTracksMappingVolume();
		...
		/// </summary>
		public PlotOptionsAroonoscillatorSonificationContextTracksMappingFrequency Frequency { get; set; }
		private PlotOptionsAroonoscillatorSonificationContextTracksMappingFrequency Frequency_DefaultValue { get; set; }
		...
		/// </summary>
		public PlotOptionsAroonoscillatorSonificationContextTracksMappingGapBetweenNotes GapBetweenNotes { get; set; }
		private PlotOptionsAroonoscillatorSonificationContextTracksMappingGapBetweenNotes GapBetweenNotes_DefaultValue { get; set; }
		...
		/// </summary>
		public PlotOptionsAroonoscillatorSonificationContextTracksMappingHighpass Highpass { get; set; }
		private PlotOptionsAroonoscillatorSonificationContextTracksMappingHighpass Highpass_DefaultValue { get; set; }
		...
		/// </summary>
		public PlotOptionsAroonoscillatorSonificationContextTracksMappingLowpass Lowpass { get; set; }
		private PlotOptionsAroonoscillatorSonificationContextTracksMappingLowpass Lowpass_DefaultValue { get; set; }
		...
		/// </summary>
		public PlotOptionsAroonoscillatorSonificationContextTracksMappingNoteDuration NoteDuration { get; set; }
		private PlotOptionsAroonoscillatorSonificationContextTracksMappingNoteDuration NoteDuration_DefaultValue { get; set; }
		...
		/// </summary>
		public PlotOptionsAroonoscillatorSonificationContextTracksMappingPan Pan { get; set; }
		private PlotOptionsAroonoscillatorSonificationContextTracksMappingPan Pan_DefaultValue { get; set; }
		...
		/// </summary>
		public PlotOptionsAroonoscillatorSonificationContextTracksMappingPitch Pitch { get; set; }
		private PlotOptionsAroonoscillatorSonificationContextTracksMappingPitch Pitch_DefaultValue { get; set; }
		...
		/// </summary>
		public PlotOptionsAroonoscillatorSonificationContextTracksMappingPlayDelay PlayDelay { get; set; }
		private PlotOptionsAroonoscillatorSonificationContextTracksMappingPlayDelay PlayDelay_DefaultValue { get; set; }
		...
		/// </summary>
		public PlotOptionsAroonoscillatorSonificationContextTracksMappingTime Time { get; set; }
		private PlotOptionsAroonoscillatorSonificationContextTracksMappingTime Time_DefaultValue { get; set; }
		...
		/// </summary>
		public PlotOptionsAroonoscillatorSonificationContextTracksMappingTremolo Tremolo { get; set; }
		private PlotOptionsAroonoscillatorSonificationContextTracksMappingTremolo Tremolo_DefaultValue { get; set; }
		 

		/// <summary>
		/// The volume of notes, from 0 to 1.
		/// </summary>
		public PlotOptionsAroonoscillatorSonificationContextTracksMappingVolume Volume { get; set; }
		private PlotOptionsAroonoscillatorSonificationContextTracksMappingVolume Volume_DefaultValue { get; set; }
