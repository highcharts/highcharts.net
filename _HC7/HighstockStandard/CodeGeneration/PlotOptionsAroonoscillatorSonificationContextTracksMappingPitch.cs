...
{
	public partial class PlotOptionsAroonoscillatorSonificationContextTracksMappingPitch  : BaseObject
	{
		Hashtable h = new Hashtable();

		public PlotOptionsAroonoscillatorSonificationContextTracksMappingPitch()
		{
			MapFunction = MapFunction_DefaultValue = PlotOptionsAroonoscillatorSonificationContextTracksMappingPitchMapFunction.Linear;
		...
		/// </summary>
		public PlotOptionsAroonoscillatorSonificationContextTracksMappingPitchMapFunction MapFunction { get; set; }
		private PlotOptionsAroonoscillatorSonificationContextTracksMappingPitchMapFunction MapFunction_DefaultValue { get; set; }
