...
{
	public partial class PlotOptionsAroonoscillatorSonificationContextTracksMappingVolume  : BaseObject
	{
		Hashtable h = new Hashtable();

		public PlotOptionsAroonoscillatorSonificationContextTracksMappingVolume()
		{
			MapFunction = MapFunction_DefaultValue = PlotOptionsAroonoscillatorSonificationContextTracksMappingVolumeMapFunction.Linear;
			MapTo = MapTo_DefaultValue = "";
			Max = Max_DefaultValue = null;
			Min = Min_DefaultValue = null;
			Value = Value_DefaultValue = null;
			Within = Within_DefaultValue = PlotOptionsAroonoscillatorSonificationContextTracksMappingVolumeWithin.Chart;
		...
		/// </summary>
		public PlotOptionsAroonoscillatorSonificationContextTracksMappingVolumeMapFunction MapFunction { get; set; }
		private PlotOptionsAroonoscillatorSonificationContextTracksMappingVolumeMapFunction MapFunction_DefaultValue { get; set; }
		...
		/// </summary>
		public PlotOptionsAroonoscillatorSonificationContextTracksMappingVolumeWithin Within { get; set; }
		private PlotOptionsAroonoscillatorSonificationContextTracksMappingVolumeWithin Within_DefaultValue { get; set; }
