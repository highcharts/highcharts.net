...
{
	public partial class PlotOptionsAroonoscillatorSonificationContextTracksPointGrouping  : BaseObject
	{
		Hashtable h = new Hashtable();

		public PlotOptionsAroonoscillatorSonificationContextTracksPointGrouping()
		{
			Algorithm = Algorithm_DefaultValue = PlotOptionsAroonoscillatorSonificationContextTracksPointGroupingAlgorithm.Minimax;
		...
		/// </summary>
		public PlotOptionsAroonoscillatorSonificationContextTracksPointGroupingAlgorithm Algorithm { get; set; }
		private PlotOptionsAroonoscillatorSonificationContextTracksPointGroupingAlgorithm Algorithm_DefaultValue { get; set; }
