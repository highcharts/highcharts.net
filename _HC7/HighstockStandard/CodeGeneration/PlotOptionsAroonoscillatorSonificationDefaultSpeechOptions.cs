...
{
	public partial class PlotOptionsAroonoscillatorSonificationDefaultSpeechOptions  : BaseObject
	{
		Hashtable h = new Hashtable();

		public PlotOptionsAroonoscillatorSonificationDefaultSpeechOptions()
		{
			ActiveWhen = ActiveWhen_DefaultValue = new PlotOptionsAroonoscillatorSonificationDefaultSpeechOptionsActiveWhen();
			Language = Language_DefaultValue = "en-US";
			Mapping = Mapping_DefaultValue = new PlotOptionsAroonoscillatorSonificationDefaultSpeechOptionsMapping();
			PointGrouping = PointGrouping_DefaultValue = new PlotOptionsAroonoscillatorSonificationDefaultSpeechOptionsPointGrouping();
			PreferredVoice = PreferredVoice_DefaultValue = "";
			ShowPlayMarker = ShowPlayMarker_DefaultValue = true;
			Type = Type_DefaultValue = PlotOptionsAroonoscillatorSonificationDefaultSpeechOptionsType.Instrument;
		...
		/// </summary>
		public PlotOptionsAroonoscillatorSonificationDefaultSpeechOptionsActiveWhen ActiveWhen { get; set; }
		private PlotOptionsAroonoscillatorSonificationDefaultSpeechOptionsActiveWhen ActiveWhen_DefaultValue { get; set; }
		...
		/// </summary>
		public PlotOptionsAroonoscillatorSonificationDefaultSpeechOptionsMapping Mapping { get; set; }
		private PlotOptionsAroonoscillatorSonificationDefaultSpeechOptionsMapping Mapping_DefaultValue { get; set; }
		 

		/// <summary>
		/// Options for point grouping, specifically for instrument tracks.
		/// </summary>
		public PlotOptionsAroonoscillatorSonificationDefaultSpeechOptionsPointGrouping PointGrouping { get; set; }
		private PlotOptionsAroonoscillatorSonificationDefaultSpeechOptionsPointGrouping PointGrouping_DefaultValue { get; set; }
		...
		/// </summary>
		public PlotOptionsAroonoscillatorSonificationDefaultSpeechOptionsType Type { get; set; }
		private PlotOptionsAroonoscillatorSonificationDefaultSpeechOptionsType Type_DefaultValue { get; set; }
