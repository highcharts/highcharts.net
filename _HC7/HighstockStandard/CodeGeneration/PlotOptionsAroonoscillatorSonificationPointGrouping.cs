...
{
	public partial class PlotOptionsAroonoscillatorSonificationPointGrouping  : BaseObject
	{
		Hashtable h = new Hashtable();

		public PlotOptionsAroonoscillatorSonificationPointGrouping()
		{
			Algorithm = Algorithm_DefaultValue = PlotOptionsAroonoscillatorSonificationPointGroupingAlgorithm.Minimax;
		...
		/// </summary>
		public PlotOptionsAroonoscillatorSonificationPointGroupingAlgorithm Algorithm { get; set; }
		private PlotOptionsAroonoscillatorSonificationPointGroupingAlgorithm Algorithm_DefaultValue { get; set; }
