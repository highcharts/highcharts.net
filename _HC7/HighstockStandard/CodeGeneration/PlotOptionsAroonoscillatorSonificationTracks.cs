...
{
	public partial class PlotOptionsAroonoscillatorSonificationTracks  : BaseObject
	{
		Hashtable h = new Hashtable();

		public PlotOptionsAroonoscillatorSonificationTracks()
		{
			ActiveWhen = ActiveWhen_DefaultValue = new PlotOptionsAroonoscillatorSonificationTracksActiveWhen();
			Instrument = Instrument_DefaultValue = null;
			InstrumentString = InstrumentString_DefaultValue = "null";
			Mapping = Mapping_DefaultValue = new PlotOptionsAroonoscillatorSonificationTracksMapping();
			MidiName = MidiName_DefaultValue = "";
			PointGrouping = PointGrouping_DefaultValue = new PlotOptionsAroonoscillatorSonificationTracksPointGrouping();
			RoundToMusicalNotes = RoundToMusicalNotes_DefaultValue = true;
			ShowPlayMarker = ShowPlayMarker_DefaultValue = true;
			Type = Type_DefaultValue = PlotOptionsAroonoscillatorSonificationTracksType.Instrument;
		...
		/// </summary>
		public PlotOptionsAroonoscillatorSonificationTracksActiveWhen ActiveWhen { get; set; }
		private PlotOptionsAroonoscillatorSonificationTracksActiveWhen ActiveWhen_DefaultValue { get; set; }
		...
		/// </summary>
		public PlotOptionsAroonoscillatorSonificationTracksMapping Mapping { get; set; }
		private PlotOptionsAroonoscillatorSonificationTracksMapping Mapping_DefaultValue { get; set; }
		...
		/// </summary>
		public PlotOptionsAroonoscillatorSonificationTracksPointGrouping PointGrouping { get; set; }
		private PlotOptionsAroonoscillatorSonificationTracksPointGrouping PointGrouping_DefaultValue { get; set; }
		...
		/// </summary>
		public PlotOptionsAroonoscillatorSonificationTracksType Type { get; set; }
		private PlotOptionsAroonoscillatorSonificationTracksType Type_DefaultValue { get; set; }
