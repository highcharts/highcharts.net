...
{
	public partial class PlotOptionsAroonoscillatorStatesHover  : BaseObject
	{
		public PlotOptionsAroonoscillatorStatesHover()
		{
			Animation = Animation_DefaultValue = new Animation() { Enabled = true };
			AnimationBool = AnimationBool_DefaultValue = null;
			Enabled = Enabled_DefaultValue = true;
			Halo = Halo_DefaultValue = new PlotOptionsAroonoscillatorStatesHoverHalo();
			LineWidth = LineWidth_DefaultValue = null;
			LineWidthPlus = LineWidthPlus_DefaultValue = 1;
			Marker = Marker_DefaultValue = new PlotOptionsAroonoscillatorStatesHoverMarker();
		...
		/// </summary>
		public PlotOptionsAroonoscillatorStatesHoverHalo Halo { get; set; }
		private PlotOptionsAroonoscillatorStatesHoverHalo Halo_DefaultValue { get; set; }
		...
		/// </summary>
		public PlotOptionsAroonoscillatorStatesHoverMarker Marker { get; set; }
		private PlotOptionsAroonoscillatorStatesHoverMarker Marker_DefaultValue { get; set; }
