...
{
	public partial class PlotOptionsAroonoscillatorStatesHoverMarker  : BaseObject
	{
		public PlotOptionsAroonoscillatorStatesHoverMarker()
		{
			...
			States = States_DefaultValue = new PlotOptionsAroonoscillatorStatesHoverMarkerStates();
		...
		/// </summary>
		public PlotOptionsAroonoscillatorStatesHoverMarkerStates States { get; set; }
		private PlotOptionsAroonoscillatorStatesHoverMarkerStates States_DefaultValue { get; set; }
