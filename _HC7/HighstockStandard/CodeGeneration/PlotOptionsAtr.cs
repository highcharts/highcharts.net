...
namespace Highsoft.Web.Mvc.Stocks
{
	public partial class PlotOptionsAtr  : BaseObject
	{
		...
		public PlotOptionsAtr()
		{
			...
			Zones = Zones_DefaultValue = new List<PlotOptionsAtrZone>();
		...
		/// </summary>
		public List<PlotOptionsAtrZone> Zones { get; set; }
		private List<PlotOptionsAtrZone> Zones_DefaultValue { get; set; }
