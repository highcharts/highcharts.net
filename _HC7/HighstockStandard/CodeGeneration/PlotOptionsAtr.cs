...
{
	public partial class PlotOptionsAtr  : BaseObject
	{
		Hashtable h = new Hashtable();

		public PlotOptionsAtr()
		{
			Accessibility = Accessibility_DefaultValue = new PlotOptionsAtrAccessibility();
			AllowPointSelect = AllowPointSelect_DefaultValue = false;
			Animation = Animation_DefaultValue = new Animation() { Enabled = true };
			AnimationBool = AnimationBool_DefaultValue = true;
			AnimationLimit = AnimationLimit_DefaultValue = null;
			BoostBlending = BoostBlending_DefaultValue = PlotOptionsAtrBoostBlending.Undefined;
			...
			Compare = Compare_DefaultValue = PlotOptionsAtrCompare.Percent;
			CompareBase = CompareBase_DefaultValue = PlotOptionsAtrCompareBase.Min;
			...
			Cursor = Cursor_DefaultValue = PlotOptionsAtrCursor.Null;
			Custom = Custom_DefaultValue = new Hashtable();
			DashStyle = DashStyle_DefaultValue = PlotOptionsAtrDashStyle.Null;
			DataGrouping = DataGrouping_DefaultValue = new PlotOptionsAtrDataGrouping();
			DataLabels = DataLabels_DefaultValue = new PlotOptionsAtrDataLabels();
			DataSorting = DataSorting_DefaultValue = new PlotOptionsAtrDataSorting();
			Description = Description_DefaultValue = "";
			EnableMouseTracking = EnableMouseTracking_DefaultValue = true;
			Events = Events_DefaultValue = new PlotOptionsAtrEvents();
			FindNearestPointBy = FindNearestPointBy_DefaultValue = PlotOptionsAtrFindNearestPointBy.X;
			GapSize = GapSize_DefaultValue = 0;
			GapUnit = GapUnit_DefaultValue = PlotOptionsAtrGapUnit.Relative;
			GetExtremesFromAll = GetExtremesFromAll_DefaultValue = false;
			InactiveOtherPoints = InactiveOtherPoints_DefaultValue = false;
			IncludeInDataExport = IncludeInDataExport_DefaultValue = null;
			Label = Label_DefaultValue = new PlotOptionsAtrLabel();
			LastPrice = LastPrice_DefaultValue = new PlotOptionsAtrLastPrice();
			LastVisiblePrice = LastVisiblePrice_DefaultValue = new PlotOptionsAtrLastVisiblePrice();
			LegendSymbol = LegendSymbol_DefaultValue = PlotOptionsAtrLegendSymbol.Rectangle;
			Linecap = Linecap_DefaultValue = PlotOptionsAtrLinecap.Round;
			LineWidth = LineWidth_DefaultValue = 2;
			LinkedTo = LinkedTo_DefaultValue = "";
			Marker = Marker_DefaultValue = new PlotOptionsAtrMarker();
			NegativeColor = NegativeColor_DefaultValue = "";
			OnPoint = OnPoint_DefaultValue = new PlotOptionsAtrOnPoint();
			Opacity = Opacity_DefaultValue = 1;
			Params = Params_DefaultValue = new PlotOptionsAtrParams();
			Point = Point_DefaultValue = new PlotOptionsAtrPoint();
			...
			Sonification = Sonification_DefaultValue = new PlotOptionsAtrSonification();
			States = States_DefaultValue = new PlotOptionsAtrStates();
			Step = Step_DefaultValue = PlotOptionsAtrStep.Null;
			StickyTracking = StickyTracking_DefaultValue = true;
			Threshold = Threshold_DefaultValue = 0;
			Tooltip = Tooltip_DefaultValue = new PlotOptionsAtrTooltip();
			TurboThreshold = TurboThreshold_DefaultValue = 1000;
			Visible = Visible_DefaultValue = true;
			ZoneAxis = ZoneAxis_DefaultValue = "y";
			Zones = Zones_DefaultValue = new List<PlotOptionsAtrZones>();
		...
		/// </summary>
		public PlotOptionsAtrAccessibility Accessibility { get; set; }
		private PlotOptionsAtrAccessibility Accessibility_DefaultValue { get; set; }
		...
		/// </summary>
		public PlotOptionsAtrBoostBlending BoostBlending { get; set; }
		private PlotOptionsAtrBoostBlending BoostBlending_DefaultValue { get; set; }
		...
		/// </summary>
		public PlotOptionsAtrCompare Compare { get; set; }
		private PlotOptionsAtrCompare Compare_DefaultValue { get; set; }
		 

		/// <summary>
		/// When [compare](#plotOptions.series.compare) is `percent`, this optiondictates whether to use 0 or 100 as the base of comparison.
		/// </summary>
		public PlotOptionsAtrCompareBase CompareBase { get; set; }
		private PlotOptionsAtrCompareBase CompareBase_DefaultValue { get; set; }
		...
		/// </summary>
		public PlotOptionsAtrCursor Cursor { get; set; }
		private PlotOptionsAtrCursor Cursor_DefaultValue { get; set; }
		...
		/// </summary>
		public PlotOptionsAtrDashStyle DashStyle { get; set; }
		private PlotOptionsAtrDashStyle DashStyle_DefaultValue { get; set; }
		...
		/// </summary>
		public PlotOptionsAtrDataGrouping DataGrouping { get; set; }
		private PlotOptionsAtrDataGrouping DataGrouping_DefaultValue { get; set; }
		...
		/// </summary>
		public PlotOptionsAtrDataLabels DataLabels { get; set; }
		private PlotOptionsAtrDataLabels DataLabels_DefaultValue { get; set; }
		 

		/// <summary>
		/// Options for the series data sorting.
		/// </summary>
		public PlotOptionsAtrDataSorting DataSorting { get; set; }
		private PlotOptionsAtrDataSorting DataSorting_DefaultValue { get; set; }
		...
		/// </summary>
		public PlotOptionsAtrEvents Events { get; set; }
		private PlotOptionsAtrEvents Events_DefaultValue { get; set; }
		...
		/// </summary>
		public PlotOptionsAtrFindNearestPointBy FindNearestPointBy { get; set; }
		private PlotOptionsAtrFindNearestPointBy FindNearestPointBy_DefaultValue { get; set; }
		...
		/// </summary>
		public PlotOptionsAtrGapUnit GapUnit { get; set; }
		private PlotOptionsAtrGapUnit GapUnit_DefaultValue { get; set; }
		...
		/// </summary>
		public PlotOptionsAtrLabel Label { get; set; }
		private PlotOptionsAtrLabel Label_DefaultValue { get; set; }
		 

		/// <summary>
		/// The line marks the last price from all points.
		/// </summary>
		public PlotOptionsAtrLastPrice LastPrice { get; set; }
		private PlotOptionsAtrLastPrice LastPrice_DefaultValue { get; set; }
		 

		/// <summary>
		/// The line marks the last price from visible range of points.
		/// </summary>
		public PlotOptionsAtrLastVisiblePrice LastVisiblePrice { get; set; }
		private PlotOptionsAtrLastVisiblePrice LastVisiblePrice_DefaultValue { get; set; }
		 

		/// <summary>
		/// What type of legend symbol to render for this series. Can be one of`areaMarker`, `lineMarker` or `rectangle`.
		/// </summary>
		public PlotOptionsAtrLegendSymbol LegendSymbol { get; set; }
		private PlotOptionsAtrLegendSymbol LegendSymbol_DefaultValue { get; set; }
		 

		/// <summary>
		/// The line cap used for line ends and line joins on the graph.
		/// </summary>
		public PlotOptionsAtrLinecap Linecap { get; set; }
		private PlotOptionsAtrLinecap Linecap_DefaultValue { get; set; }
		...
		/// </summary>
		public PlotOptionsAtrMarker Marker { get; set; }
		private PlotOptionsAtrMarker Marker_DefaultValue { get; set; }
		...
		/// </summary>
		public PlotOptionsAtrOnPoint OnPoint { get; set; }
		private PlotOptionsAtrOnPoint OnPoint_DefaultValue { get; set; }
		...
		/// 
		/// </summary>
		public PlotOptionsAtrParams Params { get; set; }
		private PlotOptionsAtrParams Params_DefaultValue { get; set; }
		 

		/// <summary>
		/// Properties for each single point.
		/// </summary>
		public PlotOptionsAtrPoint Point { get; set; }
		private PlotOptionsAtrPoint Point_DefaultValue { get; set; }
		...
		/// </summary>
		public PlotOptionsAtrSonification Sonification { get; set; }
		private PlotOptionsAtrSonification Sonification_DefaultValue { get; set; }
		 

		/// <summary>
		/// 
		/// </summary>
		public PlotOptionsAtrStates States { get; set; }
		private PlotOptionsAtrStates States_DefaultValue { get; set; }
		 

		/// <summary>
		/// Whether to apply steps to the line. Possible values are `left`,`center` and `right`.
		/// </summary>
		public PlotOptionsAtrStep Step { get; set; }
		private PlotOptionsAtrStep Step_DefaultValue { get; set; }
		...
		/// </summary>
		public PlotOptionsAtrTooltip Tooltip { get; set; }
		private PlotOptionsAtrTooltip Tooltip_DefaultValue { get; set; }
		...
		/// </summary>
		public List<PlotOptionsAtrZones> Zones { get; set; }
		private List<PlotOptionsAtrZones> Zones_DefaultValue { get; set; }
