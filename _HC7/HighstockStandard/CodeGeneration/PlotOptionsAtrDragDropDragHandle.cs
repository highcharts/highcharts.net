...
{
	public partial class PlotOptionsAtrDragDropDragHandle  : BaseObject
	{
		public PlotOptionsAtrDragDropDragHandle()
		{
		...
		internal override Hashtable ToHashtable()
		{
			...
			if (PathFormatter != PathFormatter_DefaultValue) { h.Add("pathFormatter",PathFormatter); Highstock.AddFunction("PlotOptionsAtrDragDropDragHandlePathFormatter.pathFormatter", PathFormatter); }  
