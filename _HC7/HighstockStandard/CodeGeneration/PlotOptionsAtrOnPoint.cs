...
{
	public partial class PlotOptionsAtrOnPoint  : BaseObject
	{
		Hashtable h = new Hashtable();

		public PlotOptionsAtrOnPoint()
		{
			ConnectorOptions = ConnectorOptions_DefaultValue = new PlotOptionsAtrOnPointConnectorOptions();
			Id = Id_DefaultValue = "";
			Position = Position_DefaultValue = new PlotOptionsAtrOnPointPosition();
		...
		/// </summary>
		public PlotOptionsAtrOnPointConnectorOptions ConnectorOptions { get; set; }
		private PlotOptionsAtrOnPointConnectorOptions ConnectorOptions_DefaultValue { get; set; }
		...
		/// </summary>
		public PlotOptionsAtrOnPointPosition Position { get; set; }
		private PlotOptionsAtrOnPointPosition Position_DefaultValue { get; set; }
