...
{
	public partial class PlotOptionsAtrSonificationContextTracksMapping  : BaseObject
	{
		Hashtable h = new Hashtable();

		public PlotOptionsAtrSonificationContextTracksMapping()
		{
			Frequency = Frequency_DefaultValue = new PlotOptionsAtrSonificationContextTracksMappingFrequency();
			GapBetweenNotes = GapBetweenNotes_DefaultValue = new PlotOptionsAtrSonificationContextTracksMappingGapBetweenNotes();
			Highpass = Highpass_DefaultValue = new PlotOptionsAtrSonificationContextTracksMappingHighpass();
			Lowpass = Lowpass_DefaultValue = new PlotOptionsAtrSonificationContextTracksMappingLowpass();
			NoteDuration = NoteDuration_DefaultValue = new PlotOptionsAtrSonificationContextTracksMappingNoteDuration();
			Pan = Pan_DefaultValue = new PlotOptionsAtrSonificationContextTracksMappingPan();
			Pitch = Pitch_DefaultValue = new PlotOptionsAtrSonificationContextTracksMappingPitch();
			PitchString = PitchString_DefaultValue = "null";
			PitchNumber = PitchNumber_DefaultValue = null;
			PlayDelay = PlayDelay_DefaultValue = new PlotOptionsAtrSonificationContextTracksMappingPlayDelay();
			Time = Time_DefaultValue = new PlotOptionsAtrSonificationContextTracksMappingTime();
			TimeString = TimeString_DefaultValue = "null";
			TimeNumber = TimeNumber_DefaultValue = null;
			Tremolo = Tremolo_DefaultValue = new PlotOptionsAtrSonificationContextTracksMappingTremolo();
			Volume = Volume_DefaultValue = new PlotOptionsAtrSonificationContextTracksMappingVolume();
		...
		/// </summary>
		public PlotOptionsAtrSonificationContextTracksMappingFrequency Frequency { get; set; }
		private PlotOptionsAtrSonificationContextTracksMappingFrequency Frequency_DefaultValue { get; set; }
		...
		/// </summary>
		public PlotOptionsAtrSonificationContextTracksMappingGapBetweenNotes GapBetweenNotes { get; set; }
		private PlotOptionsAtrSonificationContextTracksMappingGapBetweenNotes GapBetweenNotes_DefaultValue { get; set; }
		...
		/// </summary>
		public PlotOptionsAtrSonificationContextTracksMappingHighpass Highpass { get; set; }
		private PlotOptionsAtrSonificationContextTracksMappingHighpass Highpass_DefaultValue { get; set; }
		...
		/// </summary>
		public PlotOptionsAtrSonificationContextTracksMappingLowpass Lowpass { get; set; }
		private PlotOptionsAtrSonificationContextTracksMappingLowpass Lowpass_DefaultValue { get; set; }
		...
		/// </summary>
		public PlotOptionsAtrSonificationContextTracksMappingNoteDuration NoteDuration { get; set; }
		private PlotOptionsAtrSonificationContextTracksMappingNoteDuration NoteDuration_DefaultValue { get; set; }
		...
		/// </summary>
		public PlotOptionsAtrSonificationContextTracksMappingPan Pan { get; set; }
		private PlotOptionsAtrSonificationContextTracksMappingPan Pan_DefaultValue { get; set; }
		...
		/// </summary>
		public PlotOptionsAtrSonificationContextTracksMappingPitch Pitch { get; set; }
		private PlotOptionsAtrSonificationContextTracksMappingPitch Pitch_DefaultValue { get; set; }
		...
		/// </summary>
		public PlotOptionsAtrSonificationContextTracksMappingPlayDelay PlayDelay { get; set; }
		private PlotOptionsAtrSonificationContextTracksMappingPlayDelay PlayDelay_DefaultValue { get; set; }
		...
		/// </summary>
		public PlotOptionsAtrSonificationContextTracksMappingTime Time { get; set; }
		private PlotOptionsAtrSonificationContextTracksMappingTime Time_DefaultValue { get; set; }
		...
		/// </summary>
		public PlotOptionsAtrSonificationContextTracksMappingTremolo Tremolo { get; set; }
		private PlotOptionsAtrSonificationContextTracksMappingTremolo Tremolo_DefaultValue { get; set; }
		 

		/// <summary>
		/// The volume of notes, from 0 to 1.
		/// </summary>
		public PlotOptionsAtrSonificationContextTracksMappingVolume Volume { get; set; }
		private PlotOptionsAtrSonificationContextTracksMappingVolume Volume_DefaultValue { get; set; }
