...
{
	public partial class PlotOptionsAtrSonificationContextTracksMappingHighpassFrequency  : BaseObject
	{
		Hashtable h = new Hashtable();

		public PlotOptionsAtrSonificationContextTracksMappingHighpassFrequency()
		{
			MapFunction = MapFunction_DefaultValue = PlotOptionsAtrSonificationContextTracksMappingHighpassFrequencyMapFunction.Linear;
			MapTo = MapTo_DefaultValue = "";
			Max = Max_DefaultValue = null;
			Min = Min_DefaultValue = null;
			Value = Value_DefaultValue = null;
			Within = Within_DefaultValue = PlotOptionsAtrSonificationContextTracksMappingHighpassFrequencyWithin.Chart;
		...
		/// </summary>
		public PlotOptionsAtrSonificationContextTracksMappingHighpassFrequencyMapFunction MapFunction { get; set; }
		private PlotOptionsAtrSonificationContextTracksMappingHighpassFrequencyMapFunction MapFunction_DefaultValue { get; set; }
		...
		/// </summary>
		public PlotOptionsAtrSonificationContextTracksMappingHighpassFrequencyWithin Within { get; set; }
		private PlotOptionsAtrSonificationContextTracksMappingHighpassFrequencyWithin Within_DefaultValue { get; set; }
