...
{
	public partial class PlotOptionsAtrSonificationPointGrouping  : BaseObject
	{
		Hashtable h = new Hashtable();

		public PlotOptionsAtrSonificationPointGrouping()
		{
			Algorithm = Algorithm_DefaultValue = PlotOptionsAtrSonificationPointGroupingAlgorithm.Minimax;
		...
		/// </summary>
		public PlotOptionsAtrSonificationPointGroupingAlgorithm Algorithm { get; set; }
		private PlotOptionsAtrSonificationPointGroupingAlgorithm Algorithm_DefaultValue { get; set; }
