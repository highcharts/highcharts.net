...
{
	public partial class PlotOptionsAtrSonificationTracks  : BaseObject
	{
		Hashtable h = new Hashtable();

		public PlotOptionsAtrSonificationTracks()
		{
			ActiveWhen = ActiveWhen_DefaultValue = new PlotOptionsAtrSonificationTracksActiveWhen();
			Instrument = Instrument_DefaultValue = null;
			InstrumentString = InstrumentString_DefaultValue = "null";
			Mapping = Mapping_DefaultValue = new PlotOptionsAtrSonificationTracksMapping();
			MidiName = MidiName_DefaultValue = "";
			PointGrouping = PointGrouping_DefaultValue = new PlotOptionsAtrSonificationTracksPointGrouping();
			RoundToMusicalNotes = RoundToMusicalNotes_DefaultValue = true;
			ShowPlayMarker = ShowPlayMarker_DefaultValue = true;
			Type = Type_DefaultValue = PlotOptionsAtrSonificationTracksType.Instrument;
		...
		/// </summary>
		public PlotOptionsAtrSonificationTracksActiveWhen ActiveWhen { get; set; }
		private PlotOptionsAtrSonificationTracksActiveWhen ActiveWhen_DefaultValue { get; set; }
		...
		/// </summary>
		public PlotOptionsAtrSonificationTracksMapping Mapping { get; set; }
		private PlotOptionsAtrSonificationTracksMapping Mapping_DefaultValue { get; set; }
		...
		/// </summary>
		public PlotOptionsAtrSonificationTracksPointGrouping PointGrouping { get; set; }
		private PlotOptionsAtrSonificationTracksPointGrouping PointGrouping_DefaultValue { get; set; }
		...
		/// </summary>
		public PlotOptionsAtrSonificationTracksType Type { get; set; }
		private PlotOptionsAtrSonificationTracksType Type_DefaultValue { get; set; }
