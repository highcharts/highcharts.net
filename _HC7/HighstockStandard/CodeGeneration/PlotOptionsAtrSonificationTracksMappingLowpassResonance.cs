...
{
	public partial class PlotOptionsAtrSonificationTracksMappingLowpassResonance  : BaseObject
	{
		Hashtable h = new Hashtable();

		public PlotOptionsAtrSonificationTracksMappingLowpassResonance()
		{
			MapFunction = MapFunction_DefaultValue = PlotOptionsAtrSonificationTracksMappingLowpassResonanceMapFunction.Linear;
			MapTo = MapTo_DefaultValue = "";
			Max = Max_DefaultValue = null;
			Min = Min_DefaultValue = null;
			Value = Value_DefaultValue = null;
			Within = Within_DefaultValue = PlotOptionsAtrSonificationTracksMappingLowpassResonanceWithin.Chart;
		...
		/// </summary>
		public PlotOptionsAtrSonificationTracksMappingLowpassResonanceMapFunction MapFunction { get; set; }
		private PlotOptionsAtrSonificationTracksMappingLowpassResonanceMapFunction MapFunction_DefaultValue { get; set; }
		...
		/// </summary>
		public PlotOptionsAtrSonificationTracksMappingLowpassResonanceWithin Within { get; set; }
		private PlotOptionsAtrSonificationTracksMappingLowpassResonanceWithin Within_DefaultValue { get; set; }
