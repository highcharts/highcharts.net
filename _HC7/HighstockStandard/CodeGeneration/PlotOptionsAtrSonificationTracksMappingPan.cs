...
{
	public partial class PlotOptionsAtrSonificationTracksMappingPan  : BaseObject
	{
		Hashtable h = new Hashtable();

		public PlotOptionsAtrSonificationTracksMappingPan()
		{
			MapFunction = MapFunction_DefaultValue = PlotOptionsAtrSonificationTracksMappingPanMapFunction.Linear;
			MapTo = MapTo_DefaultValue = "";
			Max = Max_DefaultValue = null;
			Min = Min_DefaultValue = null;
			Value = Value_DefaultValue = null;
			Within = Within_DefaultValue = PlotOptionsAtrSonificationTracksMappingPanWithin.Chart;
		...
		/// </summary>
		public PlotOptionsAtrSonificationTracksMappingPanMapFunction MapFunction { get; set; }
		private PlotOptionsAtrSonificationTracksMappingPanMapFunction MapFunction_DefaultValue { get; set; }
		...
		/// </summary>
		public PlotOptionsAtrSonificationTracksMappingPanWithin Within { get; set; }
		private PlotOptionsAtrSonificationTracksMappingPanWithin Within_DefaultValue { get; set; }
