...
{
	public partial class PlotOptionsAtrSonificationTracksMappingPitch  : BaseObject
	{
		Hashtable h = new Hashtable();

		public PlotOptionsAtrSonificationTracksMappingPitch()
		{
			MapFunction = MapFunction_DefaultValue = PlotOptionsAtrSonificationTracksMappingPitchMapFunction.Linear;
		...
		/// </summary>
		public PlotOptionsAtrSonificationTracksMappingPitchMapFunction MapFunction { get; set; }
		private PlotOptionsAtrSonificationTracksMappingPitchMapFunction MapFunction_DefaultValue { get; set; }
