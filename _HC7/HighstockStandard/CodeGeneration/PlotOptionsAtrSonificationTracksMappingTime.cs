...
{
	public partial class PlotOptionsAtrSonificationTracksMappingTime  : BaseObject
	{
		Hashtable h = new Hashtable();

		public PlotOptionsAtrSonificationTracksMappingTime()
		{
			MapFunction = MapFunction_DefaultValue = PlotOptionsAtrSonificationTracksMappingTimeMapFunction.Linear;
			MapTo = MapTo_DefaultValue = "";
			Max = Max_DefaultValue = null;
			Min = Min_DefaultValue = null;
			Value = Value_DefaultValue = null;
			Within = Within_DefaultValue = PlotOptionsAtrSonificationTracksMappingTimeWithin.Chart;
		...
		/// </summary>
		public PlotOptionsAtrSonificationTracksMappingTimeMapFunction MapFunction { get; set; }
		private PlotOptionsAtrSonificationTracksMappingTimeMapFunction MapFunction_DefaultValue { get; set; }
		...
		/// </summary>
		public PlotOptionsAtrSonificationTracksMappingTimeWithin Within { get; set; }
		private PlotOptionsAtrSonificationTracksMappingTimeWithin Within_DefaultValue { get; set; }
