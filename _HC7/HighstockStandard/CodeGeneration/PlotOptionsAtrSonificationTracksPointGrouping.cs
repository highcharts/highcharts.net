...
{
	public partial class PlotOptionsAtrSonificationTracksPointGrouping  : BaseObject
	{
		Hashtable h = new Hashtable();

		public PlotOptionsAtrSonificationTracksPointGrouping()
		{
			Algorithm = Algorithm_DefaultValue = PlotOptionsAtrSonificationTracksPointGroupingAlgorithm.Minimax;
		...
		/// </summary>
		public PlotOptionsAtrSonificationTracksPointGroupingAlgorithm Algorithm { get; set; }
		private PlotOptionsAtrSonificationTracksPointGroupingAlgorithm Algorithm_DefaultValue { get; set; }
