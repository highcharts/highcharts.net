...
{
	public partial class PlotOptionsAtrStatesSelect  : BaseObject
	{
		Hashtable h = new Hashtable();

		public PlotOptionsAtrStatesSelect()
		{
			Animation = Animation_DefaultValue = new Animation() { Enabled = true };
			Enabled = Enabled_DefaultValue = null;
			Halo = Halo_DefaultValue = new PlotOptionsAtrStatesSelectHalo();
			LineWidth = LineWidth_DefaultValue = null;
			LineWidthPlus = LineWidthPlus_DefaultValue = null;
			Marker = Marker_DefaultValue = new PlotOptionsAtrStatesSelectMarker();
		...
		/// </summary>
		public PlotOptionsAtrStatesSelectHalo Halo { get; set; }
		private PlotOptionsAtrStatesSelectHalo Halo_DefaultValue { get; set; }
		...
		/// </summary>
		public PlotOptionsAtrStatesSelectMarker Marker { get; set; }
		private PlotOptionsAtrStatesSelectMarker Marker_DefaultValue { get; set; }
