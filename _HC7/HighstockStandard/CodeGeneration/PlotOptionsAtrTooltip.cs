...
{
	public partial class PlotOptionsAtrTooltip  : BaseObject
	{
		public PlotOptionsAtrTooltip()
		{
			...
			HeaderShape = HeaderShape_DefaultValue = PlotOptionsAtrTooltipHeaderShape.Callout;
		...
		/// </summary>
		public PlotOptionsAtrTooltipHeaderShape HeaderShape { get; set; }
		private PlotOptionsAtrTooltipHeaderShape HeaderShape_DefaultValue { get; set; }
		...
		internal override Hashtable ToHashtable()
		{
			...
			if (NullFormatter != NullFormatter_DefaultValue) { h.Add("nullFormatter",NullFormatter); Highstock.AddFunction("PlotOptionsAtrTooltipNullFormatter.nullFormatter", NullFormatter); }  
			if (Outside != Outside_DefaultValue) h.Add("outside",Outside);
			if (Padding != Padding_DefaultValue) h.Add("padding",Padding);
			if (PointFormat != PointFormat_DefaultValue) h.Add("pointFormat",PointFormat);
			if (PointFormatter != PointFormatter_DefaultValue) { h.Add("pointFormatter",PointFormatter); Highstock.AddFunction("PlotOptionsAtrTooltipPointFormatter.pointFormatter", PointFormatter); }  
