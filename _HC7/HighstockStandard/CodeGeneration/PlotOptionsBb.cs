...
namespace Highsoft.Web.Mvc.Stocks
{
	public partial class PlotOptionsBb  : BaseObject
	{
		...
		{
			Accessibility = Accessibility_DefaultValue = new PlotOptionsBbAccessibility();
			AllowPointSelect = AllowPointSelect_DefaultValue = false;
			Animation = Animation_DefaultValue = new Animation() { Enabled = true };
			AnimationBool = AnimationBool_DefaultValue = true;
			AnimationLimit = AnimationLimit_DefaultValue = null;
			BoostBlending = BoostBlending_DefaultValue = PlotOptionsBbBoostBlending.Undefined;
			...
			Compare = Compare_DefaultValue = PlotOptionsBbCompare.Percent;
			CompareBase = CompareBase_DefaultValue = PlotOptionsBbCompareBase.Min;
			...
			DashStyle = DashStyle_DefaultValue = PlotOptionsBbDashStyle.Null;
			...
			DataSorting = DataSorting_DefaultValue = new PlotOptionsBbDataSorting();
			...
			LastPrice = LastPrice_DefaultValue = new PlotOptionsBbLastPrice();
			LastVisiblePrice = LastVisiblePrice_DefaultValue = new PlotOptionsBbLastVisiblePrice();
			LegendSymbol = LegendSymbol_DefaultValue = PlotOptionsBbLegendSymbol.Rectangle;
			...
			OnPoint = OnPoint_DefaultValue = new PlotOptionsBbOnPoint();
			...
			Sonification = Sonification_DefaultValue = new PlotOptionsBbSonification();
			...
			Zones = Zones_DefaultValue = new List<PlotOptionsBbZones>();
		...
		/// </summary>
		public PlotOptionsBbAccessibility Accessibility { get; set; }
		private PlotOptionsBbAccessibility Accessibility_DefaultValue { get; set; }
		...
		/// </summary>
		public PlotOptionsBbBoostBlending BoostBlending { get; set; }
		private PlotOptionsBbBoostBlending BoostBlending_DefaultValue { get; set; }
		...
		/// </summary>
		public PlotOptionsBbCompare Compare { get; set; }
		private PlotOptionsBbCompare Compare_DefaultValue { get; set; }
		 

		/// <summary>
		/// When [compare](#plotOptions.series.compare) is `percent`, this optiondictates whether to use 0 or 100 as the base of comparison.
		/// </summary>
		public PlotOptionsBbCompareBase CompareBase { get; set; }
		private PlotOptionsBbCompareBase CompareBase_DefaultValue { get; set; }
		...
		/// </summary>
		public PlotOptionsBbDataSorting DataSorting { get; set; }
		private PlotOptionsBbDataSorting DataSorting_DefaultValue { get; set; }
		...
		/// </summary>
		public PlotOptionsBbLastPrice LastPrice { get; set; }
		private PlotOptionsBbLastPrice LastPrice_DefaultValue { get; set; }
		 

		/// <summary>
		/// The line marks the last price from visible range of points.
		/// </summary>
		public PlotOptionsBbLastVisiblePrice LastVisiblePrice { get; set; }
		private PlotOptionsBbLastVisiblePrice LastVisiblePrice_DefaultValue { get; set; }
		 

		/// <summary>
		/// What type of legend symbol to render for this series. Can be one of`areaMarker`, `lineMarker` or `rectangle`.
		/// </summary>
		public PlotOptionsBbLegendSymbol LegendSymbol { get; set; }
		private PlotOptionsBbLegendSymbol LegendSymbol_DefaultValue { get; set; }
		...
		/// </summary>
		public PlotOptionsBbOnPoint OnPoint { get; set; }
		private PlotOptionsBbOnPoint OnPoint_DefaultValue { get; set; }
		...
		/// </summary>
		public PlotOptionsBbSonification Sonification { get; set; }
		private PlotOptionsBbSonification Sonification_DefaultValue { get; set; }
		...
		/// </summary>
		public List<PlotOptionsBbZones> Zones { get; set; }
		private List<PlotOptionsBbZones> Zones_DefaultValue { get; set; }
