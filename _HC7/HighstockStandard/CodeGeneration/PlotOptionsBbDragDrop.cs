...
{
	public partial class PlotOptionsBbDragDrop  : BaseObject
	{
		public PlotOptionsBbDragDrop()
		{
			DraggableX = DraggableX_DefaultValue = null;
			DraggableY = DraggableY_DefaultValue = null;
			DragHandle = DragHandle_DefaultValue = new PlotOptionsBbDragDropDragHandle();
			...
			GuideBox = GuideBox_DefaultValue = new PlotOptionsBbDragDropGuideBox();
		...
		/// </summary>
		public PlotOptionsBbDragDropDragHandle DragHandle { get; set; }
		private PlotOptionsBbDragDropDragHandle DragHandle_DefaultValue { get; set; }
		...
		/// </summary>
		public PlotOptionsBbDragDropGuideBox GuideBox { get; set; }
		private PlotOptionsBbDragDropGuideBox GuideBox_DefaultValue { get; set; }
