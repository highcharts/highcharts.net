...
{
	public partial class PlotOptionsBbSonificationContextTracksMappingPitch  : BaseObject
	{
		Hashtable h = new Hashtable();

		public PlotOptionsBbSonificationContextTracksMappingPitch()
		{
			MapFunction = MapFunction_DefaultValue = PlotOptionsBbSonificationContextTracksMappingPitchMapFunction.Linear;
		...
		/// </summary>
		public PlotOptionsBbSonificationContextTracksMappingPitchMapFunction MapFunction { get; set; }
		private PlotOptionsBbSonificationContextTracksMappingPitchMapFunction MapFunction_DefaultValue { get; set; }
