...
{
	public partial class PlotOptionsBbSonificationTracks  : BaseObject
	{
		Hashtable h = new Hashtable();

		public PlotOptionsBbSonificationTracks()
		{
			ActiveWhen = ActiveWhen_DefaultValue = new PlotOptionsBbSonificationTracksActiveWhen();
			Instrument = Instrument_DefaultValue = null;
			InstrumentString = InstrumentString_DefaultValue = "null";
			Mapping = Mapping_DefaultValue = new PlotOptionsBbSonificationTracksMapping();
			MidiName = MidiName_DefaultValue = "";
			PointGrouping = PointGrouping_DefaultValue = new PlotOptionsBbSonificationTracksPointGrouping();
			RoundToMusicalNotes = RoundToMusicalNotes_DefaultValue = true;
			ShowPlayMarker = ShowPlayMarker_DefaultValue = true;
			Type = Type_DefaultValue = PlotOptionsBbSonificationTracksType.Instrument;
		...
		/// </summary>
		public PlotOptionsBbSonificationTracksActiveWhen ActiveWhen { get; set; }
		private PlotOptionsBbSonificationTracksActiveWhen ActiveWhen_DefaultValue { get; set; }
		...
		/// </summary>
		public PlotOptionsBbSonificationTracksMapping Mapping { get; set; }
		private PlotOptionsBbSonificationTracksMapping Mapping_DefaultValue { get; set; }
		...
		/// </summary>
		public PlotOptionsBbSonificationTracksPointGrouping PointGrouping { get; set; }
		private PlotOptionsBbSonificationTracksPointGrouping PointGrouping_DefaultValue { get; set; }
		...
		/// </summary>
		public PlotOptionsBbSonificationTracksType Type { get; set; }
		private PlotOptionsBbSonificationTracksType Type_DefaultValue { get; set; }
