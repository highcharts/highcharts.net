...
{
	public partial class PlotOptionsBbSonificationTracksMappingPitch  : BaseObject
	{
		Hashtable h = new Hashtable();

		public PlotOptionsBbSonificationTracksMappingPitch()
		{
			MapFunction = MapFunction_DefaultValue = PlotOptionsBbSonificationTracksMappingPitchMapFunction.Linear;
		...
		/// </summary>
		public PlotOptionsBbSonificationTracksMappingPitchMapFunction MapFunction { get; set; }
		private PlotOptionsBbSonificationTracksMappingPitchMapFunction MapFunction_DefaultValue { get; set; }
