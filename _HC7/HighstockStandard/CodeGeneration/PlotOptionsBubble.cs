...
namespace Highsoft.Web.Mvc.Stocks
{
	public partial class PlotOptionsBubble  : BaseObject
	{
		...
		public PlotOptionsBubble()
		{
			...
			Compare = Compare_DefaultValue = PlotOptionsBubbleCompare.Percent;
			...
			LegendSymbol = LegendSymbol_DefaultValue = PlotOptionsBubbleLegendSymbol.Rectangle;
			...
			Sonification = Sonification_DefaultValue = new PlotOptionsBubbleSonification();
			...
			Zones = Zones_DefaultValue = new List<PlotOptionsBubbleZones>();
		...
		private List<PlotOptionsBubbleZones> Zones_DefaultValue { get; set; }
