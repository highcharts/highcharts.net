...
namespace Highsoft.Web.Mvc.Stocks
{
	public partial class PlotOptionsBubbleDataGrouping  : BaseObject
	{
		...
		internal override Hashtable ToHashtable()
		{
			...
			if (Approximation != Approximation_DefaultValue) { h.Add("approximation",Approximation); Highstock.AddFunction("PlotOptionsBubbleDataGroupingApproximation.approximation", Approximation); }  
