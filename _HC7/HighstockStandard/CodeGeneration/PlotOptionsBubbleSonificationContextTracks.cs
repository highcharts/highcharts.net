...
{
	public partial class PlotOptionsBubbleSonificationContextTracks  : BaseObject
	{
		Hashtable h = new Hashtable();

		public PlotOptionsBubbleSonificationContextTracks()
		{
			ActiveWhen = ActiveWhen_DefaultValue = new PlotOptionsBubbleSonificationContextTracksActiveWhen();
			Instrument = Instrument_DefaultValue = null;
			InstrumentString = InstrumentString_DefaultValue = "null";
			Mapping = Mapping_DefaultValue = new PlotOptionsBubbleSonificationContextTracksMapping();
			MidiName = MidiName_DefaultValue = "";
			PointGrouping = PointGrouping_DefaultValue = new PlotOptionsBubbleSonificationContextTracksPointGrouping();
			...
			Type = Type_DefaultValue = PlotOptionsBubbleSonificationContextTracksType.Instrument;
			ValueInterval = ValueInterval_DefaultValue = null;
			ValueMapFunction = ValueMapFunction_DefaultValue = PlotOptionsBubbleSonificationContextTracksValueMapFunction.Linear;
		...
		/// </summary>
		public PlotOptionsBubbleSonificationContextTracksActiveWhen ActiveWhen { get; set; }
		private PlotOptionsBubbleSonificationContextTracksActiveWhen ActiveWhen_DefaultValue { get; set; }
		...
		/// </summary>
		public PlotOptionsBubbleSonificationContextTracksMapping Mapping { get; set; }
		private PlotOptionsBubbleSonificationContextTracksMapping Mapping_DefaultValue { get; set; }
		...
		/// </summary>
		public PlotOptionsBubbleSonificationContextTracksPointGrouping PointGrouping { get; set; }
		private PlotOptionsBubbleSonificationContextTracksPointGrouping PointGrouping_DefaultValue { get; set; }
		...
		/// </summary>
		public PlotOptionsBubbleSonificationContextTracksType Type { get; set; }
		private PlotOptionsBubbleSonificationContextTracksType Type_DefaultValue { get; set; }
		...
		/// </summary>
		public PlotOptionsBubbleSonificationContextTracksValueMapFunction ValueMapFunction { get; set; }
		private PlotOptionsBubbleSonificationContextTracksValueMapFunction ValueMapFunction_DefaultValue { get; set; }
