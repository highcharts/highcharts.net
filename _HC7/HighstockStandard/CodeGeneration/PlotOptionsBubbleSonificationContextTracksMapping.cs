...
{
	public partial class PlotOptionsBubbleSonificationContextTracksMapping  : BaseObject
	{
		Hashtable h = new Hashtable();

		public PlotOptionsBubbleSonificationContextTracksMapping()
		{
			Frequency = Frequency_DefaultValue = new PlotOptionsBubbleSonificationContextTracksMappingFrequency();
			GapBetweenNotes = GapBetweenNotes_DefaultValue = new PlotOptionsBubbleSonificationContextTracksMappingGapBetweenNotes();
			Highpass = Highpass_DefaultValue = new PlotOptionsBubbleSonificationContextTracksMappingHighpass();
			Lowpass = Lowpass_DefaultValue = new PlotOptionsBubbleSonificationContextTracksMappingLowpass();
			NoteDuration = NoteDuration_DefaultValue = new PlotOptionsBubbleSonificationContextTracksMappingNoteDuration();
			Pan = Pan_DefaultValue = new PlotOptionsBubbleSonificationContextTracksMappingPan();
			Pitch = Pitch_DefaultValue = new PlotOptionsBubbleSonificationContextTracksMappingPitch();
			PitchString = PitchString_DefaultValue = "null";
			PitchNumber = PitchNumber_DefaultValue = null;
			PlayDelay = PlayDelay_DefaultValue = new PlotOptionsBubbleSonificationContextTracksMappingPlayDelay();
			Time = Time_DefaultValue = new PlotOptionsBubbleSonificationContextTracksMappingTime();
			TimeString = TimeString_DefaultValue = "null";
			TimeNumber = TimeNumber_DefaultValue = null;
			Tremolo = Tremolo_DefaultValue = new PlotOptionsBubbleSonificationContextTracksMappingTremolo();
			Volume = Volume_DefaultValue = new PlotOptionsBubbleSonificationContextTracksMappingVolume();
		...
		/// </summary>
		public PlotOptionsBubbleSonificationContextTracksMappingFrequency Frequency { get; set; }
		private PlotOptionsBubbleSonificationContextTracksMappingFrequency Frequency_DefaultValue { get; set; }
		...
		/// </summary>
		public PlotOptionsBubbleSonificationContextTracksMappingGapBetweenNotes GapBetweenNotes { get; set; }
		private PlotOptionsBubbleSonificationContextTracksMappingGapBetweenNotes GapBetweenNotes_DefaultValue { get; set; }
		...
		/// </summary>
		public PlotOptionsBubbleSonificationContextTracksMappingHighpass Highpass { get; set; }
		private PlotOptionsBubbleSonificationContextTracksMappingHighpass Highpass_DefaultValue { get; set; }
		...
		/// </summary>
		public PlotOptionsBubbleSonificationContextTracksMappingLowpass Lowpass { get; set; }
		private PlotOptionsBubbleSonificationContextTracksMappingLowpass Lowpass_DefaultValue { get; set; }
		...
		/// </summary>
		public PlotOptionsBubbleSonificationContextTracksMappingNoteDuration NoteDuration { get; set; }
		private PlotOptionsBubbleSonificationContextTracksMappingNoteDuration NoteDuration_DefaultValue { get; set; }
		...
		/// </summary>
		public PlotOptionsBubbleSonificationContextTracksMappingPan Pan { get; set; }
		private PlotOptionsBubbleSonificationContextTracksMappingPan Pan_DefaultValue { get; set; }
		...
		/// </summary>
		public PlotOptionsBubbleSonificationContextTracksMappingPitch Pitch { get; set; }
		private PlotOptionsBubbleSonificationContextTracksMappingPitch Pitch_DefaultValue { get; set; }
		...
		/// </summary>
		public PlotOptionsBubbleSonificationContextTracksMappingPlayDelay PlayDelay { get; set; }
		private PlotOptionsBubbleSonificationContextTracksMappingPlayDelay PlayDelay_DefaultValue { get; set; }
		...
		/// </summary>
		public PlotOptionsBubbleSonificationContextTracksMappingTime Time { get; set; }
		private PlotOptionsBubbleSonificationContextTracksMappingTime Time_DefaultValue { get; set; }
		...
		/// </summary>
		public PlotOptionsBubbleSonificationContextTracksMappingTremolo Tremolo { get; set; }
		private PlotOptionsBubbleSonificationContextTracksMappingTremolo Tremolo_DefaultValue { get; set; }
		 

		/// <summary>
		/// The volume of notes, from 0 to 1.
		/// </summary>
		public PlotOptionsBubbleSonificationContextTracksMappingVolume Volume { get; set; }
		private PlotOptionsBubbleSonificationContextTracksMappingVolume Volume_DefaultValue { get; set; }
