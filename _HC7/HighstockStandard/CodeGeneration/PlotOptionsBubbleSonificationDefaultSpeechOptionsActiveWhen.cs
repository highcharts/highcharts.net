...
{
	public partial class PlotOptionsBubbleSonificationDefaultSpeechOptionsActiveWhen  : BaseObject
	{
		Hashtable h = new Hashtable();

		public PlotOptionsBubbleSonificationDefaultSpeechOptionsActiveWhen()
		{
		}	
