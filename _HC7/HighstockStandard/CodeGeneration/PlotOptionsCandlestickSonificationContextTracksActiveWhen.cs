...
{
	public partial class PlotOptionsCandlestickSonificationContextTracksActiveWhen  : BaseObject
	{
		Hashtable h = new Hashtable();

		public PlotOptionsCandlestickSonificationContextTracksActiveWhen()
		{
		}	
