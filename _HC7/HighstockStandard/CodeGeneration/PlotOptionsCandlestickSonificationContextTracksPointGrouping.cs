...
{
	public partial class PlotOptionsCandlestickSonificationContextTracksPointGrouping  : BaseObject
	{
		Hashtable h = new Hashtable();

		public PlotOptionsCandlestickSonificationContextTracksPointGrouping()
		{
			Algorithm = Algorithm_DefaultValue = PlotOptionsCandlestickSonificationContextTracksPointGroupingAlgorithm.Minimax;
		...
		/// </summary>
		public PlotOptionsCandlestickSonificationContextTracksPointGroupingAlgorithm Algorithm { get; set; }
		private PlotOptionsCandlestickSonificationContextTracksPointGroupingAlgorithm Algorithm_DefaultValue { get; set; }
