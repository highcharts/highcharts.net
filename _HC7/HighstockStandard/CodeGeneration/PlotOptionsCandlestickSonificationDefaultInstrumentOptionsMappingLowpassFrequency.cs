...
{
	public partial class PlotOptionsCandlestickSonificationDefaultInstrumentOptionsMappingLowpassFrequency  : BaseObject
	{
		Hashtable h = new Hashtable();

		public PlotOptionsCandlestickSonificationDefaultInstrumentOptionsMappingLowpassFrequency()
		{
			MapFunction = MapFunction_DefaultValue = PlotOptionsCandlestickSonificationDefaultInstrumentOptionsMappingLowpassFrequencyMapFunction.Linear;
			MapTo = MapTo_DefaultValue = "";
			Max = Max_DefaultValue = null;
			Min = Min_DefaultValue = null;
			Value = Value_DefaultValue = null;
			Within = Within_DefaultValue = PlotOptionsCandlestickSonificationDefaultInstrumentOptionsMappingLowpassFrequencyWithin.Chart;
		...
		/// </summary>
		public PlotOptionsCandlestickSonificationDefaultInstrumentOptionsMappingLowpassFrequencyMapFunction MapFunction { get; set; }
		private PlotOptionsCandlestickSonificationDefaultInstrumentOptionsMappingLowpassFrequencyMapFunction MapFunction_DefaultValue { get; set; }
		...
		/// </summary>
		public PlotOptionsCandlestickSonificationDefaultInstrumentOptionsMappingLowpassFrequencyWithin Within { get; set; }
		private PlotOptionsCandlestickSonificationDefaultInstrumentOptionsMappingLowpassFrequencyWithin Within_DefaultValue { get; set; }
