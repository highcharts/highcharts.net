...
{
	public partial class PlotOptionsCandlestickSonificationTracks  : BaseObject
	{
		Hashtable h = new Hashtable();

		public PlotOptionsCandlestickSonificationTracks()
		{
			ActiveWhen = ActiveWhen_DefaultValue = new PlotOptionsCandlestickSonificationTracksActiveWhen();
			Instrument = Instrument_DefaultValue = null;
			InstrumentString = InstrumentString_DefaultValue = "null";
			Mapping = Mapping_DefaultValue = new PlotOptionsCandlestickSonificationTracksMapping();
			MidiName = MidiName_DefaultValue = "";
			PointGrouping = PointGrouping_DefaultValue = new PlotOptionsCandlestickSonificationTracksPointGrouping();
			RoundToMusicalNotes = RoundToMusicalNotes_DefaultValue = true;
			ShowPlayMarker = ShowPlayMarker_DefaultValue = true;
			Type = Type_DefaultValue = PlotOptionsCandlestickSonificationTracksType.Instrument;
		...
		/// </summary>
		public PlotOptionsCandlestickSonificationTracksActiveWhen ActiveWhen { get; set; }
		private PlotOptionsCandlestickSonificationTracksActiveWhen ActiveWhen_DefaultValue { get; set; }
		...
		/// </summary>
		public PlotOptionsCandlestickSonificationTracksMapping Mapping { get; set; }
		private PlotOptionsCandlestickSonificationTracksMapping Mapping_DefaultValue { get; set; }
		...
		/// </summary>
		public PlotOptionsCandlestickSonificationTracksPointGrouping PointGrouping { get; set; }
		private PlotOptionsCandlestickSonificationTracksPointGrouping PointGrouping_DefaultValue { get; set; }
		...
		/// </summary>
		public PlotOptionsCandlestickSonificationTracksType Type { get; set; }
		private PlotOptionsCandlestickSonificationTracksType Type_DefaultValue { get; set; }
