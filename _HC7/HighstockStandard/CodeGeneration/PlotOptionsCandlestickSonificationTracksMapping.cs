...
{
	public partial class PlotOptionsCandlestickSonificationTracksMapping  : BaseObject
	{
		Hashtable h = new Hashtable();

		public PlotOptionsCandlestickSonificationTracksMapping()
		{
			Frequency = Frequency_DefaultValue = new PlotOptionsCandlestickSonificationTracksMappingFrequency();
			GapBetweenNotes = GapBetweenNotes_DefaultValue = new PlotOptionsCandlestickSonificationTracksMappingGapBetweenNotes();
			Highpass = Highpass_DefaultValue = new PlotOptionsCandlestickSonificationTracksMappingHighpass();
			Lowpass = Lowpass_DefaultValue = new PlotOptionsCandlestickSonificationTracksMappingLowpass();
			NoteDuration = NoteDuration_DefaultValue = new PlotOptionsCandlestickSonificationTracksMappingNoteDuration();
			Pan = Pan_DefaultValue = new PlotOptionsCandlestickSonificationTracksMappingPan();
			Pitch = Pitch_DefaultValue = new PlotOptionsCandlestickSonificationTracksMappingPitch();
			PitchString = PitchString_DefaultValue = "null";
			PitchNumber = PitchNumber_DefaultValue = null;
			PlayDelay = PlayDelay_DefaultValue = new PlotOptionsCandlestickSonificationTracksMappingPlayDelay();
			Time = Time_DefaultValue = new PlotOptionsCandlestickSonificationTracksMappingTime();
			TimeString = TimeString_DefaultValue = "null";
			TimeNumber = TimeNumber_DefaultValue = null;
			Tremolo = Tremolo_DefaultValue = new PlotOptionsCandlestickSonificationTracksMappingTremolo();
			Volume = Volume_DefaultValue = new PlotOptionsCandlestickSonificationTracksMappingVolume();
		...
		/// </summary>
		public PlotOptionsCandlestickSonificationTracksMappingFrequency Frequency { get; set; }
		private PlotOptionsCandlestickSonificationTracksMappingFrequency Frequency_DefaultValue { get; set; }
		...
		/// </summary>
		public PlotOptionsCandlestickSonificationTracksMappingGapBetweenNotes GapBetweenNotes { get; set; }
		private PlotOptionsCandlestickSonificationTracksMappingGapBetweenNotes GapBetweenNotes_DefaultValue { get; set; }
		...
		/// </summary>
		public PlotOptionsCandlestickSonificationTracksMappingHighpass Highpass { get; set; }
		private PlotOptionsCandlestickSonificationTracksMappingHighpass Highpass_DefaultValue { get; set; }
		...
		/// </summary>
		public PlotOptionsCandlestickSonificationTracksMappingLowpass Lowpass { get; set; }
		private PlotOptionsCandlestickSonificationTracksMappingLowpass Lowpass_DefaultValue { get; set; }
		...
		/// </summary>
		public PlotOptionsCandlestickSonificationTracksMappingNoteDuration NoteDuration { get; set; }
		private PlotOptionsCandlestickSonificationTracksMappingNoteDuration NoteDuration_DefaultValue { get; set; }
		...
		/// </summary>
		public PlotOptionsCandlestickSonificationTracksMappingPan Pan { get; set; }
		private PlotOptionsCandlestickSonificationTracksMappingPan Pan_DefaultValue { get; set; }
		...
		/// </summary>
		public PlotOptionsCandlestickSonificationTracksMappingPitch Pitch { get; set; }
		private PlotOptionsCandlestickSonificationTracksMappingPitch Pitch_DefaultValue { get; set; }
		...
		/// </summary>
		public PlotOptionsCandlestickSonificationTracksMappingPlayDelay PlayDelay { get; set; }
		private PlotOptionsCandlestickSonificationTracksMappingPlayDelay PlayDelay_DefaultValue { get; set; }
		...
		/// </summary>
		public PlotOptionsCandlestickSonificationTracksMappingTime Time { get; set; }
		private PlotOptionsCandlestickSonificationTracksMappingTime Time_DefaultValue { get; set; }
		...
		/// </summary>
		public PlotOptionsCandlestickSonificationTracksMappingTremolo Tremolo { get; set; }
		private PlotOptionsCandlestickSonificationTracksMappingTremolo Tremolo_DefaultValue { get; set; }
		 

		/// <summary>
		/// The volume of notes, from 0 to 1.
		/// </summary>
		public PlotOptionsCandlestickSonificationTracksMappingVolume Volume { get; set; }
		private PlotOptionsCandlestickSonificationTracksMappingVolume Volume_DefaultValue { get; set; }
