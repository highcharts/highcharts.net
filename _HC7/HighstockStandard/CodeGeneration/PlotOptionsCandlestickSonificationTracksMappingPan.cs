...
{
	public partial class PlotOptionsCandlestickSonificationTracksMappingPan  : BaseObject
	{
		Hashtable h = new Hashtable();

		public PlotOptionsCandlestickSonificationTracksMappingPan()
		{
			MapFunction = MapFunction_DefaultValue = PlotOptionsCandlestickSonificationTracksMappingPanMapFunction.Linear;
			MapTo = MapTo_DefaultValue = "";
			Max = Max_DefaultValue = null;
			Min = Min_DefaultValue = null;
			Value = Value_DefaultValue = null;
			Within = Within_DefaultValue = PlotOptionsCandlestickSonificationTracksMappingPanWithin.Chart;
		...
		/// </summary>
		public PlotOptionsCandlestickSonificationTracksMappingPanMapFunction MapFunction { get; set; }
		private PlotOptionsCandlestickSonificationTracksMappingPanMapFunction MapFunction_DefaultValue { get; set; }
		...
		/// </summary>
		public PlotOptionsCandlestickSonificationTracksMappingPanWithin Within { get; set; }
		private PlotOptionsCandlestickSonificationTracksMappingPanWithin Within_DefaultValue { get; set; }
