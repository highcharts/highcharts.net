...
{
	public partial class PlotOptionsCandlestickSonificationTracksMappingPitch  : BaseObject
	{
		Hashtable h = new Hashtable();

		public PlotOptionsCandlestickSonificationTracksMappingPitch()
		{
			MapFunction = MapFunction_DefaultValue = PlotOptionsCandlestickSonificationTracksMappingPitchMapFunction.Linear;
		...
		/// </summary>
		public PlotOptionsCandlestickSonificationTracksMappingPitchMapFunction MapFunction { get; set; }
		private PlotOptionsCandlestickSonificationTracksMappingPitchMapFunction MapFunction_DefaultValue { get; set; }
