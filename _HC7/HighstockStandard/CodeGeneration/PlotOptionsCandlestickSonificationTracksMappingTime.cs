...
{
	public partial class PlotOptionsCandlestickSonificationTracksMappingTime  : BaseObject
	{
		Hashtable h = new Hashtable();

		public PlotOptionsCandlestickSonificationTracksMappingTime()
		{
			MapFunction = MapFunction_DefaultValue = PlotOptionsCandlestickSonificationTracksMappingTimeMapFunction.Linear;
			MapTo = MapTo_DefaultValue = "";
			Max = Max_DefaultValue = null;
			Min = Min_DefaultValue = null;
			Value = Value_DefaultValue = null;
			Within = Within_DefaultValue = PlotOptionsCandlestickSonificationTracksMappingTimeWithin.Chart;
		...
		/// </summary>
		public PlotOptionsCandlestickSonificationTracksMappingTimeMapFunction MapFunction { get; set; }
		private PlotOptionsCandlestickSonificationTracksMappingTimeMapFunction MapFunction_DefaultValue { get; set; }
		...
		/// </summary>
		public PlotOptionsCandlestickSonificationTracksMappingTimeWithin Within { get; set; }
		private PlotOptionsCandlestickSonificationTracksMappingTimeWithin Within_DefaultValue { get; set; }
