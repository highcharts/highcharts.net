...
{
	public partial class PlotOptionsCandlestickSonificationTracksPointGrouping  : BaseObject
	{
		Hashtable h = new Hashtable();

		public PlotOptionsCandlestickSonificationTracksPointGrouping()
		{
			Algorithm = Algorithm_DefaultValue = PlotOptionsCandlestickSonificationTracksPointGroupingAlgorithm.Minimax;
		...
		/// </summary>
		public PlotOptionsCandlestickSonificationTracksPointGroupingAlgorithm Algorithm { get; set; }
		private PlotOptionsCandlestickSonificationTracksPointGroupingAlgorithm Algorithm_DefaultValue { get; set; }
