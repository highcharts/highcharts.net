...
namespace Highsoft.Web.Mvc.Stocks
{
	public partial class PlotOptionsCci  : BaseObject
	{
		...
		public PlotOptionsCci()
		{
			...
			Zones = Zones_DefaultValue = new List<PlotOptionsCciZone>();
		...
		/// </summary>
		public List<PlotOptionsCciZone> Zones { get; set; }
		private List<PlotOptionsCciZone> Zones_DefaultValue { get; set; }
