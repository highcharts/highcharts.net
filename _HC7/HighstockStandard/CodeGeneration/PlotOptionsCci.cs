...
{
	public partial class PlotOptionsCci  : BaseObject
	{
		Hashtable h = new Hashtable();

		public PlotOptionsCci()
		{
			Accessibility = Accessibility_DefaultValue = new PlotOptionsCciAccessibility();
			AllowPointSelect = AllowPointSelect_DefaultValue = false;
			Animation = Animation_DefaultValue = new Animation() { Enabled = true };
			AnimationBool = AnimationBool_DefaultValue = true;
			AnimationLimit = AnimationLimit_DefaultValue = null;
			BoostBlending = BoostBlending_DefaultValue = PlotOptionsCciBoostBlending.Undefined;
			...
			Compare = Compare_DefaultValue = PlotOptionsCciCompare.Percent;
			CompareBase = CompareBase_DefaultValue = PlotOptionsCciCompareBase.Min;
			...
			Cursor = Cursor_DefaultValue = PlotOptionsCciCursor.Null;
			Custom = Custom_DefaultValue = new Hashtable();
			DashStyle = DashStyle_DefaultValue = PlotOptionsCciDashStyle.Null;
			DataGrouping = DataGrouping_DefaultValue = new PlotOptionsCciDataGrouping();
			DataLabels = DataLabels_DefaultValue = new PlotOptionsCciDataLabels();
			DataSorting = DataSorting_DefaultValue = new PlotOptionsCciDataSorting();
			Description = Description_DefaultValue = "";
			EnableMouseTracking = EnableMouseTracking_DefaultValue = true;
			Events = Events_DefaultValue = new PlotOptionsCciEvents();
			FindNearestPointBy = FindNearestPointBy_DefaultValue = PlotOptionsCciFindNearestPointBy.X;
			GapSize = GapSize_DefaultValue = 0;
			GapUnit = GapUnit_DefaultValue = PlotOptionsCciGapUnit.Relative;
			GetExtremesFromAll = GetExtremesFromAll_DefaultValue = false;
			InactiveOtherPoints = InactiveOtherPoints_DefaultValue = false;
			IncludeInDataExport = IncludeInDataExport_DefaultValue = null;
			Label = Label_DefaultValue = new PlotOptionsCciLabel();
			LastPrice = LastPrice_DefaultValue = new PlotOptionsCciLastPrice();
			LastVisiblePrice = LastVisiblePrice_DefaultValue = new PlotOptionsCciLastVisiblePrice();
			LegendSymbol = LegendSymbol_DefaultValue = PlotOptionsCciLegendSymbol.Rectangle;
			Linecap = Linecap_DefaultValue = PlotOptionsCciLinecap.Round;
			LineWidth = LineWidth_DefaultValue = 2;
			LinkedTo = LinkedTo_DefaultValue = "";
			Marker = Marker_DefaultValue = new PlotOptionsCciMarker();
			NegativeColor = NegativeColor_DefaultValue = "";
			OnPoint = OnPoint_DefaultValue = new PlotOptionsCciOnPoint();
			Opacity = Opacity_DefaultValue = 1;
			Params = Params_DefaultValue = new PlotOptionsCciParams();
			Point = Point_DefaultValue = new PlotOptionsCciPoint();
			...
			Sonification = Sonification_DefaultValue = new PlotOptionsCciSonification();
			States = States_DefaultValue = new PlotOptionsCciStates();
			Step = Step_DefaultValue = PlotOptionsCciStep.Null;
			StickyTracking = StickyTracking_DefaultValue = true;
			Threshold = Threshold_DefaultValue = 0;
			Tooltip = Tooltip_DefaultValue = new PlotOptionsCciTooltip();
			TurboThreshold = TurboThreshold_DefaultValue = 1000;
			Visible = Visible_DefaultValue = true;
			ZoneAxis = ZoneAxis_DefaultValue = "y";
			Zones = Zones_DefaultValue = new List<PlotOptionsCciZones>();
		...
		/// </summary>
		public PlotOptionsCciAccessibility Accessibility { get; set; }
		private PlotOptionsCciAccessibility Accessibility_DefaultValue { get; set; }
		...
		/// </summary>
		public PlotOptionsCciBoostBlending BoostBlending { get; set; }
		private PlotOptionsCciBoostBlending BoostBlending_DefaultValue { get; set; }
		...
		/// </summary>
		public PlotOptionsCciCompare Compare { get; set; }
		private PlotOptionsCciCompare Compare_DefaultValue { get; set; }
		 

		/// <summary>
		/// When [compare](#plotOptions.series.compare) is `percent`, this optiondictates whether to use 0 or 100 as the base of comparison.
		/// </summary>
		public PlotOptionsCciCompareBase CompareBase { get; set; }
		private PlotOptionsCciCompareBase CompareBase_DefaultValue { get; set; }
		...
		/// </summary>
		public PlotOptionsCciCursor Cursor { get; set; }
		private PlotOptionsCciCursor Cursor_DefaultValue { get; set; }
		...
		/// </summary>
		public PlotOptionsCciDashStyle DashStyle { get; set; }
		private PlotOptionsCciDashStyle DashStyle_DefaultValue { get; set; }
		...
		/// </summary>
		public PlotOptionsCciDataGrouping DataGrouping { get; set; }
		private PlotOptionsCciDataGrouping DataGrouping_DefaultValue { get; set; }
		...
		/// </summary>
		public PlotOptionsCciDataLabels DataLabels { get; set; }
		private PlotOptionsCciDataLabels DataLabels_DefaultValue { get; set; }
		 

		/// <summary>
		/// Options for the series data sorting.
		/// </summary>
		public PlotOptionsCciDataSorting DataSorting { get; set; }
		private PlotOptionsCciDataSorting DataSorting_DefaultValue { get; set; }
		...
		/// </summary>
		public PlotOptionsCciEvents Events { get; set; }
		private PlotOptionsCciEvents Events_DefaultValue { get; set; }
		...
		/// </summary>
		public PlotOptionsCciFindNearestPointBy FindNearestPointBy { get; set; }
		private PlotOptionsCciFindNearestPointBy FindNearestPointBy_DefaultValue { get; set; }
		...
		/// </summary>
		public PlotOptionsCciGapUnit GapUnit { get; set; }
		private PlotOptionsCciGapUnit GapUnit_DefaultValue { get; set; }
		...
		/// </summary>
		public PlotOptionsCciLabel Label { get; set; }
		private PlotOptionsCciLabel Label_DefaultValue { get; set; }
		 

		/// <summary>
		/// The line marks the last price from all points.
		/// </summary>
		public PlotOptionsCciLastPrice LastPrice { get; set; }
		private PlotOptionsCciLastPrice LastPrice_DefaultValue { get; set; }
		 

		/// <summary>
		/// The line marks the last price from visible range of points.
		/// </summary>
		public PlotOptionsCciLastVisiblePrice LastVisiblePrice { get; set; }
		private PlotOptionsCciLastVisiblePrice LastVisiblePrice_DefaultValue { get; set; }
		 

		/// <summary>
		/// What type of legend symbol to render for this series. Can be one of`lineMarker` or `rectangle`.
		/// </summary>
		public PlotOptionsCciLegendSymbol LegendSymbol { get; set; }
		private PlotOptionsCciLegendSymbol LegendSymbol_DefaultValue { get; set; }
		 

		/// <summary>
		/// The line cap used for line ends and line joins on the graph.
		/// </summary>
		public PlotOptionsCciLinecap Linecap { get; set; }
		private PlotOptionsCciLinecap Linecap_DefaultValue { get; set; }
		...
		/// </summary>
		public PlotOptionsCciMarker Marker { get; set; }
		private PlotOptionsCciMarker Marker_DefaultValue { get; set; }
		...
		/// </summary>
		public PlotOptionsCciOnPoint OnPoint { get; set; }
		private PlotOptionsCciOnPoint OnPoint_DefaultValue { get; set; }
		...
		/// 
		/// </summary>
		public PlotOptionsCciParams Params { get; set; }
		private PlotOptionsCciParams Params_DefaultValue { get; set; }
		 

		/// <summary>
		/// Properties for each single point.
		/// </summary>
		public PlotOptionsCciPoint Point { get; set; }
		private PlotOptionsCciPoint Point_DefaultValue { get; set; }
		...
		/// </summary>
		public PlotOptionsCciSonification Sonification { get; set; }
		private PlotOptionsCciSonification Sonification_DefaultValue { get; set; }
		 

		/// <summary>
		/// 
		/// </summary>
		public PlotOptionsCciStates States { get; set; }
		private PlotOptionsCciStates States_DefaultValue { get; set; }
		 

		/// <summary>
		/// Whether to apply steps to the line. Possible values are `left`,`center` and `right`.
		/// </summary>
		public PlotOptionsCciStep Step { get; set; }
		private PlotOptionsCciStep Step_DefaultValue { get; set; }
		...
		/// </summary>
		public PlotOptionsCciTooltip Tooltip { get; set; }
		private PlotOptionsCciTooltip Tooltip_DefaultValue { get; set; }
		...
		/// </summary>
		public List<PlotOptionsCciZones> Zones { get; set; }
		private List<PlotOptionsCciZones> Zones_DefaultValue { get; set; }
