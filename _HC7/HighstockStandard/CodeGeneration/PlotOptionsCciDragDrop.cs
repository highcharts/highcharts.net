...
{
	public partial class PlotOptionsCciDragDrop  : BaseObject
	{
		public PlotOptionsCciDragDrop()
		{
			DraggableX = DraggableX_DefaultValue = null;
			DraggableY = DraggableY_DefaultValue = null;
			DragHandle = DragHandle_DefaultValue = new PlotOptionsCciDragDropDragHandle();
			...
			GuideBox = GuideBox_DefaultValue = new PlotOptionsCciDragDropGuideBox();
		...
		/// </summary>
		public PlotOptionsCciDragDropDragHandle DragHandle { get; set; }
		private PlotOptionsCciDragDropDragHandle DragHandle_DefaultValue { get; set; }
		...
		/// </summary>
		public PlotOptionsCciDragDropGuideBox GuideBox { get; set; }
		private PlotOptionsCciDragDropGuideBox GuideBox_DefaultValue { get; set; }
