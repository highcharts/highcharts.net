...
{
	public partial class PlotOptionsCciDragDropDragHandle  : BaseObject
	{
		public PlotOptionsCciDragDropDragHandle()
		{
		...
		internal override Hashtable ToHashtable()
		{
			...
			if (PathFormatter != PathFormatter_DefaultValue) { h.Add("pathFormatter",PathFormatter); Highstock.AddFunction("PlotOptionsCciDragDropDragHandlePathFormatter.pathFormatter", PathFormatter); }  
