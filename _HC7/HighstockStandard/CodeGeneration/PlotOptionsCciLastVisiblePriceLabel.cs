...
{
	public partial class PlotOptionsCciLastVisiblePriceLabel  : BaseObject
	{
		Hashtable h = new Hashtable();

		public PlotOptionsCciLastVisiblePriceLabel()
		{
			Align = Align_DefaultValue = PlotOptionsCciLastVisiblePriceLabelAlign.Null;
		...
		/// 
		/// </summary>
		public PlotOptionsCciLastVisiblePriceLabelAlign Align { get; set; }
		private PlotOptionsCciLastVisiblePriceLabelAlign Align_DefaultValue { get; set; }
