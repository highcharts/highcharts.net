...
{
	public partial class PlotOptionsCciMarkerStates  : BaseObject
	{
		public PlotOptionsCciMarkerStates()
		{
			Hover = Hover_DefaultValue = new PlotOptionsCciMarkerStatesHover();
			Inactive = Inactive_DefaultValue = new PlotOptionsCciMarkerStatesInactive();
		...
		/// 
		/// </summary>
		public PlotOptionsCciMarkerStatesInactive Inactive { get; set; }
		private PlotOptionsCciMarkerStatesInactive Inactive_DefaultValue { get; set; }
		...
		/// </summary>
		public PlotOptionsCciMarkerStatesSelect Select { get; set; }
		private PlotOptionsCciMarkerStatesSelect Select_DefaultValue { get; set; }
