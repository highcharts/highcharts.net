...
{
	public partial class PlotOptionsCciOnPoint  : BaseObject
	{
		Hashtable h = new Hashtable();

		public PlotOptionsCciOnPoint()
		{
			ConnectorOptions = ConnectorOptions_DefaultValue = new PlotOptionsCciOnPointConnectorOptions();
			Id = Id_DefaultValue = "";
			Position = Position_DefaultValue = new PlotOptionsCciOnPointPosition();
		...
		/// </summary>
		public PlotOptionsCciOnPointConnectorOptions ConnectorOptions { get; set; }
		private PlotOptionsCciOnPointConnectorOptions ConnectorOptions_DefaultValue { get; set; }
		...
		/// </summary>
		public PlotOptionsCciOnPointPosition Position { get; set; }
		private PlotOptionsCciOnPointPosition Position_DefaultValue { get; set; }
