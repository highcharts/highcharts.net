...
{
	public partial class PlotOptionsCciSonificationContextTracks  : BaseObject
	{
		Hashtable h = new Hashtable();

		public PlotOptionsCciSonificationContextTracks()
		{
			ActiveWhen = ActiveWhen_DefaultValue = new PlotOptionsCciSonificationContextTracksActiveWhen();
			Instrument = Instrument_DefaultValue = null;
			InstrumentString = InstrumentString_DefaultValue = "null";
			Mapping = Mapping_DefaultValue = new PlotOptionsCciSonificationContextTracksMapping();
			MidiName = MidiName_DefaultValue = "";
			PointGrouping = PointGrouping_DefaultValue = new PlotOptionsCciSonificationContextTracksPointGrouping();
			...
			Type = Type_DefaultValue = PlotOptionsCciSonificationContextTracksType.Instrument;
			ValueInterval = ValueInterval_DefaultValue = null;
			ValueMapFunction = ValueMapFunction_DefaultValue = PlotOptionsCciSonificationContextTracksValueMapFunction.Linear;
		...
		/// </summary>
		public PlotOptionsCciSonificationContextTracksActiveWhen ActiveWhen { get; set; }
		private PlotOptionsCciSonificationContextTracksActiveWhen ActiveWhen_DefaultValue { get; set; }
		...
		/// </summary>
		public PlotOptionsCciSonificationContextTracksMapping Mapping { get; set; }
		private PlotOptionsCciSonificationContextTracksMapping Mapping_DefaultValue { get; set; }
		...
		/// </summary>
		public PlotOptionsCciSonificationContextTracksPointGrouping PointGrouping { get; set; }
		private PlotOptionsCciSonificationContextTracksPointGrouping PointGrouping_DefaultValue { get; set; }
		...
		/// </summary>
		public PlotOptionsCciSonificationContextTracksType Type { get; set; }
		private PlotOptionsCciSonificationContextTracksType Type_DefaultValue { get; set; }
		...
		/// </summary>
		public PlotOptionsCciSonificationContextTracksValueMapFunction ValueMapFunction { get; set; }
		private PlotOptionsCciSonificationContextTracksValueMapFunction ValueMapFunction_DefaultValue { get; set; }
