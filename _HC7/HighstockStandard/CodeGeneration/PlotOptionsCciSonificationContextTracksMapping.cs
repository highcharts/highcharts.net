...
{
	public partial class PlotOptionsCciSonificationContextTracksMapping  : BaseObject
	{
		Hashtable h = new Hashtable();

		public PlotOptionsCciSonificationContextTracksMapping()
		{
			Frequency = Frequency_DefaultValue = new PlotOptionsCciSonificationContextTracksMappingFrequency();
			GapBetweenNotes = GapBetweenNotes_DefaultValue = new PlotOptionsCciSonificationContextTracksMappingGapBetweenNotes();
			Highpass = Highpass_DefaultValue = new PlotOptionsCciSonificationContextTracksMappingHighpass();
			Lowpass = Lowpass_DefaultValue = new PlotOptionsCciSonificationContextTracksMappingLowpass();
			NoteDuration = NoteDuration_DefaultValue = new PlotOptionsCciSonificationContextTracksMappingNoteDuration();
			Pan = Pan_DefaultValue = new PlotOptionsCciSonificationContextTracksMappingPan();
			Pitch = Pitch_DefaultValue = new PlotOptionsCciSonificationContextTracksMappingPitch();
			PitchString = PitchString_DefaultValue = "null";
			PitchNumber = PitchNumber_DefaultValue = null;
			PlayDelay = PlayDelay_DefaultValue = new PlotOptionsCciSonificationContextTracksMappingPlayDelay();
			Time = Time_DefaultValue = new PlotOptionsCciSonificationContextTracksMappingTime();
			TimeString = TimeString_DefaultValue = "null";
			TimeNumber = TimeNumber_DefaultValue = null;
			Tremolo = Tremolo_DefaultValue = new PlotOptionsCciSonificationContextTracksMappingTremolo();
			Volume = Volume_DefaultValue = new PlotOptionsCciSonificationContextTracksMappingVolume();
		...
		/// </summary>
		public PlotOptionsCciSonificationContextTracksMappingFrequency Frequency { get; set; }
		private PlotOptionsCciSonificationContextTracksMappingFrequency Frequency_DefaultValue { get; set; }
		...
		/// </summary>
		public PlotOptionsCciSonificationContextTracksMappingGapBetweenNotes GapBetweenNotes { get; set; }
		private PlotOptionsCciSonificationContextTracksMappingGapBetweenNotes GapBetweenNotes_DefaultValue { get; set; }
		...
		/// </summary>
		public PlotOptionsCciSonificationContextTracksMappingHighpass Highpass { get; set; }
		private PlotOptionsCciSonificationContextTracksMappingHighpass Highpass_DefaultValue { get; set; }
		...
		/// </summary>
		public PlotOptionsCciSonificationContextTracksMappingLowpass Lowpass { get; set; }
		private PlotOptionsCciSonificationContextTracksMappingLowpass Lowpass_DefaultValue { get; set; }
		...
		/// </summary>
		public PlotOptionsCciSonificationContextTracksMappingNoteDuration NoteDuration { get; set; }
		private PlotOptionsCciSonificationContextTracksMappingNoteDuration NoteDuration_DefaultValue { get; set; }
		...
		/// </summary>
		public PlotOptionsCciSonificationContextTracksMappingPan Pan { get; set; }
		private PlotOptionsCciSonificationContextTracksMappingPan Pan_DefaultValue { get; set; }
		...
		/// </summary>
		public PlotOptionsCciSonificationContextTracksMappingPitch Pitch { get; set; }
		private PlotOptionsCciSonificationContextTracksMappingPitch Pitch_DefaultValue { get; set; }
		...
		/// </summary>
		public PlotOptionsCciSonificationContextTracksMappingPlayDelay PlayDelay { get; set; }
		private PlotOptionsCciSonificationContextTracksMappingPlayDelay PlayDelay_DefaultValue { get; set; }
		...
		/// </summary>
		public PlotOptionsCciSonificationContextTracksMappingTime Time { get; set; }
		private PlotOptionsCciSonificationContextTracksMappingTime Time_DefaultValue { get; set; }
		...
		/// </summary>
		public PlotOptionsCciSonificationContextTracksMappingTremolo Tremolo { get; set; }
		private PlotOptionsCciSonificationContextTracksMappingTremolo Tremolo_DefaultValue { get; set; }
		 

		/// <summary>
		/// The volume of notes, from 0 to 1.
		/// </summary>
		public PlotOptionsCciSonificationContextTracksMappingVolume Volume { get; set; }
		private PlotOptionsCciSonificationContextTracksMappingVolume Volume_DefaultValue { get; set; }
