...
{
	public partial class PlotOptionsCciSonificationContextTracksMappingLowpassFrequency  : BaseObject
	{
		Hashtable h = new Hashtable();

		public PlotOptionsCciSonificationContextTracksMappingLowpassFrequency()
		{
			MapFunction = MapFunction_DefaultValue = PlotOptionsCciSonificationContextTracksMappingLowpassFrequencyMapFunction.Linear;
			MapTo = MapTo_DefaultValue = "";
			Max = Max_DefaultValue = null;
			Min = Min_DefaultValue = null;
			Value = Value_DefaultValue = null;
			Within = Within_DefaultValue = PlotOptionsCciSonificationContextTracksMappingLowpassFrequencyWithin.Chart;
		...
		/// </summary>
		public PlotOptionsCciSonificationContextTracksMappingLowpassFrequencyMapFunction MapFunction { get; set; }
		private PlotOptionsCciSonificationContextTracksMappingLowpassFrequencyMapFunction MapFunction_DefaultValue { get; set; }
		...
		/// </summary>
		public PlotOptionsCciSonificationContextTracksMappingLowpassFrequencyWithin Within { get; set; }
		private PlotOptionsCciSonificationContextTracksMappingLowpassFrequencyWithin Within_DefaultValue { get; set; }
