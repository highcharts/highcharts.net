...
{
	public partial class PlotOptionsCciSonificationContextTracksMappingNoteDuration  : BaseObject
	{
		Hashtable h = new Hashtable();

		public PlotOptionsCciSonificationContextTracksMappingNoteDuration()
		{
			MapFunction = MapFunction_DefaultValue = PlotOptionsCciSonificationContextTracksMappingNoteDurationMapFunction.Linear;
			MapTo = MapTo_DefaultValue = "";
			Max = Max_DefaultValue = null;
			Min = Min_DefaultValue = null;
			Value = Value_DefaultValue = null;
			Within = Within_DefaultValue = PlotOptionsCciSonificationContextTracksMappingNoteDurationWithin.Chart;
		...
		/// </summary>
		public PlotOptionsCciSonificationContextTracksMappingNoteDurationMapFunction MapFunction { get; set; }
		private PlotOptionsCciSonificationContextTracksMappingNoteDurationMapFunction MapFunction_DefaultValue { get; set; }
		...
		/// </summary>
		public PlotOptionsCciSonificationContextTracksMappingNoteDurationWithin Within { get; set; }
		private PlotOptionsCciSonificationContextTracksMappingNoteDurationWithin Within_DefaultValue { get; set; }
