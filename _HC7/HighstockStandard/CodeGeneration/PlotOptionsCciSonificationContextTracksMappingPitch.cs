...
{
	public partial class PlotOptionsCciSonificationContextTracksMappingPitch  : BaseObject
	{
		Hashtable h = new Hashtable();

		public PlotOptionsCciSonificationContextTracksMappingPitch()
		{
			MapFunction = MapFunction_DefaultValue = PlotOptionsCciSonificationContextTracksMappingPitchMapFunction.Linear;
		...
		/// </summary>
		public PlotOptionsCciSonificationContextTracksMappingPitchMapFunction MapFunction { get; set; }
		private PlotOptionsCciSonificationContextTracksMappingPitchMapFunction MapFunction_DefaultValue { get; set; }
