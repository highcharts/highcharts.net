...
{
	public partial class PlotOptionsCciSonificationContextTracksMappingPlayDelay  : BaseObject
	{
		Hashtable h = new Hashtable();

		public PlotOptionsCciSonificationContextTracksMappingPlayDelay()
		{
			MapFunction = MapFunction_DefaultValue = PlotOptionsCciSonificationContextTracksMappingPlayDelayMapFunction.Linear;
			MapTo = MapTo_DefaultValue = "";
			Max = Max_DefaultValue = null;
			Min = Min_DefaultValue = null;
			Value = Value_DefaultValue = null;
			Within = Within_DefaultValue = PlotOptionsCciSonificationContextTracksMappingPlayDelayWithin.Chart;
		...
		/// </summary>
		public PlotOptionsCciSonificationContextTracksMappingPlayDelayMapFunction MapFunction { get; set; }
		private PlotOptionsCciSonificationContextTracksMappingPlayDelayMapFunction MapFunction_DefaultValue { get; set; }
		...
		/// </summary>
		public PlotOptionsCciSonificationContextTracksMappingPlayDelayWithin Within { get; set; }
		private PlotOptionsCciSonificationContextTracksMappingPlayDelayWithin Within_DefaultValue { get; set; }
