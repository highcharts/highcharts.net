...
{
	public partial class PlotOptionsCciSonificationDefaultInstrumentOptionsMappingLowpassFrequency  : BaseObject
	{
		Hashtable h = new Hashtable();

		public PlotOptionsCciSonificationDefaultInstrumentOptionsMappingLowpassFrequency()
		{
			MapFunction = MapFunction_DefaultValue = PlotOptionsCciSonificationDefaultInstrumentOptionsMappingLowpassFrequencyMapFunction.Linear;
			MapTo = MapTo_DefaultValue = "";
			Max = Max_DefaultValue = null;
			Min = Min_DefaultValue = null;
			Value = Value_DefaultValue = null;
			Within = Within_DefaultValue = PlotOptionsCciSonificationDefaultInstrumentOptionsMappingLowpassFrequencyWithin.Chart;
		...
		/// </summary>
		public PlotOptionsCciSonificationDefaultInstrumentOptionsMappingLowpassFrequencyMapFunction MapFunction { get; set; }
		private PlotOptionsCciSonificationDefaultInstrumentOptionsMappingLowpassFrequencyMapFunction MapFunction_DefaultValue { get; set; }
		...
		/// </summary>
		public PlotOptionsCciSonificationDefaultInstrumentOptionsMappingLowpassFrequencyWithin Within { get; set; }
		private PlotOptionsCciSonificationDefaultInstrumentOptionsMappingLowpassFrequencyWithin Within_DefaultValue { get; set; }
