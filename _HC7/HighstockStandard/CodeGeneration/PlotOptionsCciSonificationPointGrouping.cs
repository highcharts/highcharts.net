...
{
	public partial class PlotOptionsCciSonificationPointGrouping  : BaseObject
	{
		Hashtable h = new Hashtable();

		public PlotOptionsCciSonificationPointGrouping()
		{
			Algorithm = Algorithm_DefaultValue = PlotOptionsCciSonificationPointGroupingAlgorithm.Minimax;
		...
		/// </summary>
		public PlotOptionsCciSonificationPointGroupingAlgorithm Algorithm { get; set; }
		private PlotOptionsCciSonificationPointGroupingAlgorithm Algorithm_DefaultValue { get; set; }
