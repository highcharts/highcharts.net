...
{
	public partial class PlotOptionsCciSonificationTracks  : BaseObject
	{
		Hashtable h = new Hashtable();

		public PlotOptionsCciSonificationTracks()
		{
			ActiveWhen = ActiveWhen_DefaultValue = new PlotOptionsCciSonificationTracksActiveWhen();
			Instrument = Instrument_DefaultValue = null;
			InstrumentString = InstrumentString_DefaultValue = "null";
			Mapping = Mapping_DefaultValue = new PlotOptionsCciSonificationTracksMapping();
			MidiName = MidiName_DefaultValue = "";
			PointGrouping = PointGrouping_DefaultValue = new PlotOptionsCciSonificationTracksPointGrouping();
			RoundToMusicalNotes = RoundToMusicalNotes_DefaultValue = true;
			ShowPlayMarker = ShowPlayMarker_DefaultValue = true;
			Type = Type_DefaultValue = PlotOptionsCciSonificationTracksType.Instrument;
		...
		/// </summary>
		public PlotOptionsCciSonificationTracksActiveWhen ActiveWhen { get; set; }
		private PlotOptionsCciSonificationTracksActiveWhen ActiveWhen_DefaultValue { get; set; }
		...
		/// </summary>
		public PlotOptionsCciSonificationTracksMapping Mapping { get; set; }
		private PlotOptionsCciSonificationTracksMapping Mapping_DefaultValue { get; set; }
		...
		/// </summary>
		public PlotOptionsCciSonificationTracksPointGrouping PointGrouping { get; set; }
		private PlotOptionsCciSonificationTracksPointGrouping PointGrouping_DefaultValue { get; set; }
		...
		/// </summary>
		public PlotOptionsCciSonificationTracksType Type { get; set; }
		private PlotOptionsCciSonificationTracksType Type_DefaultValue { get; set; }
