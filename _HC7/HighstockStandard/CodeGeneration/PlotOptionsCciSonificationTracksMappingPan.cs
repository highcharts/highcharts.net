...
{
	public partial class PlotOptionsCciSonificationTracksMappingPan  : BaseObject
	{
		Hashtable h = new Hashtable();

		public PlotOptionsCciSonificationTracksMappingPan()
		{
			MapFunction = MapFunction_DefaultValue = PlotOptionsCciSonificationTracksMappingPanMapFunction.Linear;
			MapTo = MapTo_DefaultValue = "";
			Max = Max_DefaultValue = null;
			Min = Min_DefaultValue = null;
			Value = Value_DefaultValue = null;
			Within = Within_DefaultValue = PlotOptionsCciSonificationTracksMappingPanWithin.Chart;
		...
		/// </summary>
		public PlotOptionsCciSonificationTracksMappingPanMapFunction MapFunction { get; set; }
		private PlotOptionsCciSonificationTracksMappingPanMapFunction MapFunction_DefaultValue { get; set; }
		...
		/// </summary>
		public PlotOptionsCciSonificationTracksMappingPanWithin Within { get; set; }
		private PlotOptionsCciSonificationTracksMappingPanWithin Within_DefaultValue { get; set; }
