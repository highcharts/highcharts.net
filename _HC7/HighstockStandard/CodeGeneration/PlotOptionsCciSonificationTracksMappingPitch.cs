...
{
	public partial class PlotOptionsCciSonificationTracksMappingPitch  : BaseObject
	{
		Hashtable h = new Hashtable();

		public PlotOptionsCciSonificationTracksMappingPitch()
		{
			MapFunction = MapFunction_DefaultValue = PlotOptionsCciSonificationTracksMappingPitchMapFunction.Linear;
		...
		/// </summary>
		public PlotOptionsCciSonificationTracksMappingPitchMapFunction MapFunction { get; set; }
		private PlotOptionsCciSonificationTracksMappingPitchMapFunction MapFunction_DefaultValue { get; set; }
