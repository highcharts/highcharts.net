...
{
	public partial class PlotOptionsCciSonificationTracksMappingTime  : BaseObject
	{
		Hashtable h = new Hashtable();

		public PlotOptionsCciSonificationTracksMappingTime()
		{
			MapFunction = MapFunction_DefaultValue = PlotOptionsCciSonificationTracksMappingTimeMapFunction.Linear;
			MapTo = MapTo_DefaultValue = "";
			Max = Max_DefaultValue = null;
			Min = Min_DefaultValue = null;
			Value = Value_DefaultValue = null;
			Within = Within_DefaultValue = PlotOptionsCciSonificationTracksMappingTimeWithin.Chart;
		...
		/// </summary>
		public PlotOptionsCciSonificationTracksMappingTimeMapFunction MapFunction { get; set; }
		private PlotOptionsCciSonificationTracksMappingTimeMapFunction MapFunction_DefaultValue { get; set; }
		...
		/// </summary>
		public PlotOptionsCciSonificationTracksMappingTimeWithin Within { get; set; }
		private PlotOptionsCciSonificationTracksMappingTimeWithin Within_DefaultValue { get; set; }
