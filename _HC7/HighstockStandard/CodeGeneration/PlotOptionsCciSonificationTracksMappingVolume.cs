...
{
	public partial class PlotOptionsCciSonificationTracksMappingVolume  : BaseObject
	{
		Hashtable h = new Hashtable();

		public PlotOptionsCciSonificationTracksMappingVolume()
		{
			MapFunction = MapFunction_DefaultValue = PlotOptionsCciSonificationTracksMappingVolumeMapFunction.Linear;
			MapTo = MapTo_DefaultValue = "";
			Max = Max_DefaultValue = null;
			Min = Min_DefaultValue = null;
			Value = Value_DefaultValue = null;
			Within = Within_DefaultValue = PlotOptionsCciSonificationTracksMappingVolumeWithin.Chart;
		...
		/// </summary>
		public PlotOptionsCciSonificationTracksMappingVolumeMapFunction MapFunction { get; set; }
		private PlotOptionsCciSonificationTracksMappingVolumeMapFunction MapFunction_DefaultValue { get; set; }
		...
		/// </summary>
		public PlotOptionsCciSonificationTracksMappingVolumeWithin Within { get; set; }
		private PlotOptionsCciSonificationTracksMappingVolumeWithin Within_DefaultValue { get; set; }
