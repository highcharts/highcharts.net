...
{
	public partial class PlotOptionsCciSonificationTracksPointGrouping  : BaseObject
	{
		Hashtable h = new Hashtable();

		public PlotOptionsCciSonificationTracksPointGrouping()
		{
			Algorithm = Algorithm_DefaultValue = PlotOptionsCciSonificationTracksPointGroupingAlgorithm.Minimax;
		...
		/// </summary>
		public PlotOptionsCciSonificationTracksPointGroupingAlgorithm Algorithm { get; set; }
		private PlotOptionsCciSonificationTracksPointGroupingAlgorithm Algorithm_DefaultValue { get; set; }
