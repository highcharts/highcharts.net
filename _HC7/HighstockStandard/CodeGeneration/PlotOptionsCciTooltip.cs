...
{
	public partial class PlotOptionsCciTooltip  : BaseObject
	{
		public PlotOptionsCciTooltip()
		{
			...
			HeaderShape = HeaderShape_DefaultValue = PlotOptionsCciTooltipHeaderShape.Callout;
		...
		/// </summary>
		public PlotOptionsCciTooltipHeaderShape HeaderShape { get; set; }
		private PlotOptionsCciTooltipHeaderShape HeaderShape_DefaultValue { get; set; }
		...
		internal override Hashtable ToHashtable()
		{
			...
			if (NullFormatter != NullFormatter_DefaultValue) { h.Add("nullFormatter",NullFormatter); Highstock.AddFunction("PlotOptionsCciTooltipNullFormatter.nullFormatter", NullFormatter); }  
			if (Outside != Outside_DefaultValue) h.Add("outside",Outside);
			if (Padding != Padding_DefaultValue) h.Add("padding",Padding);
			if (PointFormat != PointFormat_DefaultValue) h.Add("pointFormat",PointFormat);
			if (PointFormatter != PointFormatter_DefaultValue) { h.Add("pointFormatter",PointFormatter); Highstock.AddFunction("PlotOptionsCciTooltipPointFormatter.pointFormatter", PointFormatter); }  
