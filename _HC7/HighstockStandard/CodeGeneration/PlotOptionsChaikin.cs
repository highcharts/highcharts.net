...
{
	public partial class PlotOptionsChaikin  : BaseObject
	{
		Hashtable h = new Hashtable();

		public PlotOptionsChaikin()
		{
			Accessibility = Accessibility_DefaultValue = new PlotOptionsChaikinAccessibility();
			AllowPointSelect = AllowPointSelect_DefaultValue = false;
			Animation = Animation_DefaultValue = new Animation() { Enabled = true };
			AnimationBool = AnimationBool_DefaultValue = true;
			AnimationLimit = AnimationLimit_DefaultValue = null;
			BoostBlending = BoostBlending_DefaultValue = PlotOptionsChaikinBoostBlending.Undefined;
			...
			Compare = Compare_DefaultValue = PlotOptionsChaikinCompare.Percent;
			CompareBase = CompareBase_DefaultValue = PlotOptionsChaikinCompareBase.Min;
			...
			Cursor = Cursor_DefaultValue = PlotOptionsChaikinCursor.Null;
			Custom = Custom_DefaultValue = new Hashtable();
			DashStyle = DashStyle_DefaultValue = PlotOptionsChaikinDashStyle.Null;
			DataGrouping = DataGrouping_DefaultValue = new PlotOptionsChaikinDataGrouping();
			DataLabels = DataLabels_DefaultValue = new PlotOptionsChaikinDataLabels();
			DataSorting = DataSorting_DefaultValue = new PlotOptionsChaikinDataSorting();
			Description = Description_DefaultValue = "";
			EnableMouseTracking = EnableMouseTracking_DefaultValue = true;
			Events = Events_DefaultValue = new PlotOptionsChaikinEvents();
			FindNearestPointBy = FindNearestPointBy_DefaultValue = PlotOptionsChaikinFindNearestPointBy.X;
			GapSize = GapSize_DefaultValue = 0;
			GapUnit = GapUnit_DefaultValue = PlotOptionsChaikinGapUnit.Relative;
			GetExtremesFromAll = GetExtremesFromAll_DefaultValue = false;
			InactiveOtherPoints = InactiveOtherPoints_DefaultValue = false;
			IncludeInDataExport = IncludeInDataExport_DefaultValue = null;
			Label = Label_DefaultValue = new PlotOptionsChaikinLabel();
			LastPrice = LastPrice_DefaultValue = new PlotOptionsChaikinLastPrice();
			LastVisiblePrice = LastVisiblePrice_DefaultValue = new PlotOptionsChaikinLastVisiblePrice();
			LegendSymbol = LegendSymbol_DefaultValue = PlotOptionsChaikinLegendSymbol.Rectangle;
			Linecap = Linecap_DefaultValue = PlotOptionsChaikinLinecap.Round;
			LineWidth = LineWidth_DefaultValue = 2;
			LinkedTo = LinkedTo_DefaultValue = "";
			Marker = Marker_DefaultValue = new PlotOptionsChaikinMarker();
			NegativeColor = NegativeColor_DefaultValue = "";
			OnPoint = OnPoint_DefaultValue = new PlotOptionsChaikinOnPoint();
			Opacity = Opacity_DefaultValue = 1;
			Params = Params_DefaultValue = new PlotOptionsChaikinParams();
			Point = Point_DefaultValue = new PlotOptionsChaikinPoint();
			...
			Sonification = Sonification_DefaultValue = new PlotOptionsChaikinSonification();
			States = States_DefaultValue = new PlotOptionsChaikinStates();
			Step = Step_DefaultValue = PlotOptionsChaikinStep.Null;
			StickyTracking = StickyTracking_DefaultValue = true;
			Threshold = Threshold_DefaultValue = 0;
			Tooltip = Tooltip_DefaultValue = new PlotOptionsChaikinTooltip();
			TurboThreshold = TurboThreshold_DefaultValue = 1000;
			Visible = Visible_DefaultValue = true;
			ZoneAxis = ZoneAxis_DefaultValue = "y";
			Zones = Zones_DefaultValue = new List<PlotOptionsChaikinZones>();
		...
		/// </summary>
		public PlotOptionsChaikinAccessibility Accessibility { get; set; }
		private PlotOptionsChaikinAccessibility Accessibility_DefaultValue { get; set; }
		...
		/// </summary>
		public PlotOptionsChaikinBoostBlending BoostBlending { get; set; }
		private PlotOptionsChaikinBoostBlending BoostBlending_DefaultValue { get; set; }
		...
		/// </summary>
		public PlotOptionsChaikinCompare Compare { get; set; }
		private PlotOptionsChaikinCompare Compare_DefaultValue { get; set; }
		 

		/// <summary>
		/// When [compare](#plotOptions.series.compare) is `percent`, this optiondictates whether to use 0 or 100 as the base of comparison.
		/// </summary>
		public PlotOptionsChaikinCompareBase CompareBase { get; set; }
		private PlotOptionsChaikinCompareBase CompareBase_DefaultValue { get; set; }
		...
		/// </summary>
		public PlotOptionsChaikinCursor Cursor { get; set; }
		private PlotOptionsChaikinCursor Cursor_DefaultValue { get; set; }
		...
		/// </summary>
		public PlotOptionsChaikinDashStyle DashStyle { get; set; }
		private PlotOptionsChaikinDashStyle DashStyle_DefaultValue { get; set; }
		...
		/// </summary>
		public PlotOptionsChaikinDataGrouping DataGrouping { get; set; }
		private PlotOptionsChaikinDataGrouping DataGrouping_DefaultValue { get; set; }
		...
		/// </summary>
		public PlotOptionsChaikinDataLabels DataLabels { get; set; }
		private PlotOptionsChaikinDataLabels DataLabels_DefaultValue { get; set; }
		 

		/// <summary>
		/// Options for the series data sorting.
		/// </summary>
		public PlotOptionsChaikinDataSorting DataSorting { get; set; }
		private PlotOptionsChaikinDataSorting DataSorting_DefaultValue { get; set; }
		...
		/// </summary>
		public PlotOptionsChaikinEvents Events { get; set; }
		private PlotOptionsChaikinEvents Events_DefaultValue { get; set; }
		...
		/// </summary>
		public PlotOptionsChaikinFindNearestPointBy FindNearestPointBy { get; set; }
		private PlotOptionsChaikinFindNearestPointBy FindNearestPointBy_DefaultValue { get; set; }
		...
		/// </summary>
		public PlotOptionsChaikinGapUnit GapUnit { get; set; }
		private PlotOptionsChaikinGapUnit GapUnit_DefaultValue { get; set; }
		...
		/// </summary>
		public PlotOptionsChaikinLabel Label { get; set; }
		private PlotOptionsChaikinLabel Label_DefaultValue { get; set; }
		 

		/// <summary>
		/// The line marks the last price from all points.
		/// </summary>
		public PlotOptionsChaikinLastPrice LastPrice { get; set; }
		private PlotOptionsChaikinLastPrice LastPrice_DefaultValue { get; set; }
		 

		/// <summary>
		/// The line marks the last price from visible range of points.
		/// </summary>
		public PlotOptionsChaikinLastVisiblePrice LastVisiblePrice { get; set; }
		private PlotOptionsChaikinLastVisiblePrice LastVisiblePrice_DefaultValue { get; set; }
		 

		/// <summary>
		/// What type of legend symbol to render for this series. Can be one of`areaMarker`, `lineMarker` or `rectangle`.
		/// </summary>
		public PlotOptionsChaikinLegendSymbol LegendSymbol { get; set; }
		private PlotOptionsChaikinLegendSymbol LegendSymbol_DefaultValue { get; set; }
		 

		/// <summary>
		/// The line cap used for line ends and line joins on the graph.
		/// </summary>
		public PlotOptionsChaikinLinecap Linecap { get; set; }
		private PlotOptionsChaikinLinecap Linecap_DefaultValue { get; set; }
		...
		/// </summary>
		public PlotOptionsChaikinMarker Marker { get; set; }
		private PlotOptionsChaikinMarker Marker_DefaultValue { get; set; }
		...
		/// </summary>
		public PlotOptionsChaikinOnPoint OnPoint { get; set; }
		private PlotOptionsChaikinOnPoint OnPoint_DefaultValue { get; set; }
		...
		/// </summary>
		public PlotOptionsChaikinPoint Point { get; set; }
		private PlotOptionsChaikinPoint Point_DefaultValue { get; set; }
		...
		/// </summary>
		public PlotOptionsChaikinSonification Sonification { get; set; }
		private PlotOptionsChaikinSonification Sonification_DefaultValue { get; set; }
		 

		/// <summary>
		/// 
		/// </summary>
		public PlotOptionsChaikinStates States { get; set; }
		private PlotOptionsChaikinStates States_DefaultValue { get; set; }
		 

		/// <summary>
		/// Whether to apply steps to the line. Possible values are `left`,`center` and `right`.
		/// </summary>
		public PlotOptionsChaikinStep Step { get; set; }
		private PlotOptionsChaikinStep Step_DefaultValue { get; set; }
		...
		/// </summary>
		public PlotOptionsChaikinTooltip Tooltip { get; set; }
		private PlotOptionsChaikinTooltip Tooltip_DefaultValue { get; set; }
		...
		/// </summary>
		public List<PlotOptionsChaikinZones> Zones { get; set; }
		private List<PlotOptionsChaikinZones> Zones_DefaultValue { get; set; }
