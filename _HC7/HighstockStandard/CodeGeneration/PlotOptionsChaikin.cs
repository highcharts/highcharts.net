...
namespace Highsoft.Web.Mvc.Stocks
{
	public partial class PlotOptionsChaikin  : BaseObject
	{
		...
		public PlotOptionsChaikin()
		{
			...
			Zones = Zones_DefaultValue = new List<PlotOptionsChaikinZone>();
		...
		/// </summary>
		public List<PlotOptionsChaikinZone> Zones { get; set; }
		private List<PlotOptionsChaikinZone> Zones_DefaultValue { get; set; }
