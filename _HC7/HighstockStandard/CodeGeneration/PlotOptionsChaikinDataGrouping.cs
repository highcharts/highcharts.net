...
namespace Highsoft.Web.Mvc.Stocks
{
	public partial class PlotOptionsChaikinDataGrouping  : BaseObject
	{
		...
		internal override Hashtable ToHashtable()
		{
			...
			if (Approximation != Approximation_DefaultValue) { h.Add("approximation",Approximation); Highstock.AddFunction("PlotOptionsChaikinDataGroupingApproximation.approximation", Approximation); }  
