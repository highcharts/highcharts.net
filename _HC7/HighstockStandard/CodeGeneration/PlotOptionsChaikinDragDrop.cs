...
{
	public partial class PlotOptionsChaikinDragDrop  : BaseObject
	{
		public PlotOptionsChaikinDragDrop()
		{
			DraggableX = DraggableX_DefaultValue = null;
			DraggableY = DraggableY_DefaultValue = null;
			DragHandle = DragHandle_DefaultValue = new PlotOptionsChaikinDragDropDragHandle();
			...
			GuideBox = GuideBox_DefaultValue = new PlotOptionsChaikinDragDropGuideBox();
		...
		/// </summary>
		public PlotOptionsChaikinDragDropDragHandle DragHandle { get; set; }
		private PlotOptionsChaikinDragDropDragHandle DragHandle_DefaultValue { get; set; }
		...
		/// </summary>
		public PlotOptionsChaikinDragDropGuideBox GuideBox { get; set; }
		private PlotOptionsChaikinDragDropGuideBox GuideBox_DefaultValue { get; set; }
