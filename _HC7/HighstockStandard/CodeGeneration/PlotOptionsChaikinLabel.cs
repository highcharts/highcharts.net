...
{
	public partial class PlotOptionsChaikinLabel  : BaseObject
	{
		public PlotOptionsChaikinLabel()
		{
			...
			Style = Style_DefaultValue = new PlotOptionsChaikinLabelStyle();
		...
		/// </summary>
		public PlotOptionsChaikinLabelStyle Style { get; set; }
		private PlotOptionsChaikinLabelStyle Style_DefaultValue { get; set; }
