...
{
	public partial class PlotOptionsChaikinMarker  : BaseObject
	{
		public PlotOptionsChaikinMarker()
		{
			...
			States = States_DefaultValue = new PlotOptionsChaikinMarkerStates();
		...
		/// </summary>
		public PlotOptionsChaikinMarkerStates States { get; set; }
		private PlotOptionsChaikinMarkerStates States_DefaultValue { get; set; }
