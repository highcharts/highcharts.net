...
{
	public partial class PlotOptionsChaikinSonificationContextTracksMapping  : BaseObject
	{
		Hashtable h = new Hashtable();

		public PlotOptionsChaikinSonificationContextTracksMapping()
		{
			Frequency = Frequency_DefaultValue = new PlotOptionsChaikinSonificationContextTracksMappingFrequency();
			GapBetweenNotes = GapBetweenNotes_DefaultValue = new PlotOptionsChaikinSonificationContextTracksMappingGapBetweenNotes();
			Highpass = Highpass_DefaultValue = new PlotOptionsChaikinSonificationContextTracksMappingHighpass();
			Lowpass = Lowpass_DefaultValue = new PlotOptionsChaikinSonificationContextTracksMappingLowpass();
			NoteDuration = NoteDuration_DefaultValue = new PlotOptionsChaikinSonificationContextTracksMappingNoteDuration();
			Pan = Pan_DefaultValue = new PlotOptionsChaikinSonificationContextTracksMappingPan();
			Pitch = Pitch_DefaultValue = new PlotOptionsChaikinSonificationContextTracksMappingPitch();
			PitchString = PitchString_DefaultValue = "null";
			PitchNumber = PitchNumber_DefaultValue = null;
			PlayDelay = PlayDelay_DefaultValue = new PlotOptionsChaikinSonificationContextTracksMappingPlayDelay();
			Time = Time_DefaultValue = new PlotOptionsChaikinSonificationContextTracksMappingTime();
			TimeString = TimeString_DefaultValue = "null";
			TimeNumber = TimeNumber_DefaultValue = null;
			Tremolo = Tremolo_DefaultValue = new PlotOptionsChaikinSonificationContextTracksMappingTremolo();
			Volume = Volume_DefaultValue = new PlotOptionsChaikinSonificationContextTracksMappingVolume();
		...
		/// </summary>
		public PlotOptionsChaikinSonificationContextTracksMappingFrequency Frequency { get; set; }
		private PlotOptionsChaikinSonificationContextTracksMappingFrequency Frequency_DefaultValue { get; set; }
		...
		/// </summary>
		public PlotOptionsChaikinSonificationContextTracksMappingGapBetweenNotes GapBetweenNotes { get; set; }
		private PlotOptionsChaikinSonificationContextTracksMappingGapBetweenNotes GapBetweenNotes_DefaultValue { get; set; }
		...
		/// </summary>
		public PlotOptionsChaikinSonificationContextTracksMappingHighpass Highpass { get; set; }
		private PlotOptionsChaikinSonificationContextTracksMappingHighpass Highpass_DefaultValue { get; set; }
		...
		/// </summary>
		public PlotOptionsChaikinSonificationContextTracksMappingLowpass Lowpass { get; set; }
		private PlotOptionsChaikinSonificationContextTracksMappingLowpass Lowpass_DefaultValue { get; set; }
		...
		/// </summary>
		public PlotOptionsChaikinSonificationContextTracksMappingNoteDuration NoteDuration { get; set; }
		private PlotOptionsChaikinSonificationContextTracksMappingNoteDuration NoteDuration_DefaultValue { get; set; }
		...
		/// </summary>
		public PlotOptionsChaikinSonificationContextTracksMappingPan Pan { get; set; }
		private PlotOptionsChaikinSonificationContextTracksMappingPan Pan_DefaultValue { get; set; }
		...
		/// </summary>
		public PlotOptionsChaikinSonificationContextTracksMappingPitch Pitch { get; set; }
		private PlotOptionsChaikinSonificationContextTracksMappingPitch Pitch_DefaultValue { get; set; }
		...
		/// </summary>
		public PlotOptionsChaikinSonificationContextTracksMappingPlayDelay PlayDelay { get; set; }
		private PlotOptionsChaikinSonificationContextTracksMappingPlayDelay PlayDelay_DefaultValue { get; set; }
		...
		/// </summary>
		public PlotOptionsChaikinSonificationContextTracksMappingTime Time { get; set; }
		private PlotOptionsChaikinSonificationContextTracksMappingTime Time_DefaultValue { get; set; }
		...
		/// </summary>
		public PlotOptionsChaikinSonificationContextTracksMappingTremolo Tremolo { get; set; }
		private PlotOptionsChaikinSonificationContextTracksMappingTremolo Tremolo_DefaultValue { get; set; }
		 

		/// <summary>
		/// The volume of notes, from 0 to 1.
		/// </summary>
		public PlotOptionsChaikinSonificationContextTracksMappingVolume Volume { get; set; }
		private PlotOptionsChaikinSonificationContextTracksMappingVolume Volume_DefaultValue { get; set; }
