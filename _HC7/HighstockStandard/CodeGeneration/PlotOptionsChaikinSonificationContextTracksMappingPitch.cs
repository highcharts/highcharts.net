...
{
	public partial class PlotOptionsChaikinSonificationContextTracksMappingPitch  : BaseObject
	{
		Hashtable h = new Hashtable();

		public PlotOptionsChaikinSonificationContextTracksMappingPitch()
		{
			MapFunction = MapFunction_DefaultValue = PlotOptionsChaikinSonificationContextTracksMappingPitchMapFunction.Linear;
		...
		/// </summary>
		public PlotOptionsChaikinSonificationContextTracksMappingPitchMapFunction MapFunction { get; set; }
		private PlotOptionsChaikinSonificationContextTracksMappingPitchMapFunction MapFunction_DefaultValue { get; set; }
