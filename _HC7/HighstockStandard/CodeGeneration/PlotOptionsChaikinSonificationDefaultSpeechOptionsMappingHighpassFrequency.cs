...
{
	public partial class PlotOptionsChaikinSonificationDefaultSpeechOptionsMappingHighpassFrequency  : BaseObject
	{
		Hashtable h = new Hashtable();

		public PlotOptionsChaikinSonificationDefaultSpeechOptionsMappingHighpassFrequency()
		{
			MapFunction = MapFunction_DefaultValue = PlotOptionsChaikinSonificationDefaultSpeechOptionsMappingHighpassFrequencyMapFunction.Linear;
			MapTo = MapTo_DefaultValue = "";
			Max = Max_DefaultValue = null;
			Min = Min_DefaultValue = null;
			Value = Value_DefaultValue = null;
			Within = Within_DefaultValue = PlotOptionsChaikinSonificationDefaultSpeechOptionsMappingHighpassFrequencyWithin.Chart;
		...
		/// </summary>
		public PlotOptionsChaikinSonificationDefaultSpeechOptionsMappingHighpassFrequencyMapFunction MapFunction { get; set; }
		private PlotOptionsChaikinSonificationDefaultSpeechOptionsMappingHighpassFrequencyMapFunction MapFunction_DefaultValue { get; set; }
		...
		/// </summary>
		public PlotOptionsChaikinSonificationDefaultSpeechOptionsMappingHighpassFrequencyWithin Within { get; set; }
		private PlotOptionsChaikinSonificationDefaultSpeechOptionsMappingHighpassFrequencyWithin Within_DefaultValue { get; set; }
