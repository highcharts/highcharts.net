...
{
	public partial class PlotOptionsChaikinSonificationDefaultSpeechOptionsMappingTremoloDepth  : BaseObject
	{
		Hashtable h = new Hashtable();

		public PlotOptionsChaikinSonificationDefaultSpeechOptionsMappingTremoloDepth()
		{
			MapFunction = MapFunction_DefaultValue = PlotOptionsChaikinSonificationDefaultSpeechOptionsMappingTremoloDepthMapFunction.Linear;
			MapTo = MapTo_DefaultValue = "";
			Max = Max_DefaultValue = null;
			Min = Min_DefaultValue = null;
			Value = Value_DefaultValue = null;
			Within = Within_DefaultValue = PlotOptionsChaikinSonificationDefaultSpeechOptionsMappingTremoloDepthWithin.Chart;
		...
		/// </summary>
		public PlotOptionsChaikinSonificationDefaultSpeechOptionsMappingTremoloDepthMapFunction MapFunction { get; set; }
		private PlotOptionsChaikinSonificationDefaultSpeechOptionsMappingTremoloDepthMapFunction MapFunction_DefaultValue { get; set; }
		...
		/// </summary>
		public PlotOptionsChaikinSonificationDefaultSpeechOptionsMappingTremoloDepthWithin Within { get; set; }
		private PlotOptionsChaikinSonificationDefaultSpeechOptionsMappingTremoloDepthWithin Within_DefaultValue { get; set; }
