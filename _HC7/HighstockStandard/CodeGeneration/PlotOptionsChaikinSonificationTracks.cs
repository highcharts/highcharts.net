...
{
	public partial class PlotOptionsChaikinSonificationTracks  : BaseObject
	{
		Hashtable h = new Hashtable();

		public PlotOptionsChaikinSonificationTracks()
		{
			ActiveWhen = ActiveWhen_DefaultValue = new PlotOptionsChaikinSonificationTracksActiveWhen();
			Instrument = Instrument_DefaultValue = null;
			InstrumentString = InstrumentString_DefaultValue = "null";
			Mapping = Mapping_DefaultValue = new PlotOptionsChaikinSonificationTracksMapping();
			MidiName = MidiName_DefaultValue = "";
			PointGrouping = PointGrouping_DefaultValue = new PlotOptionsChaikinSonificationTracksPointGrouping();
			RoundToMusicalNotes = RoundToMusicalNotes_DefaultValue = true;
			ShowPlayMarker = ShowPlayMarker_DefaultValue = true;
			Type = Type_DefaultValue = PlotOptionsChaikinSonificationTracksType.Instrument;
		...
		/// </summary>
		public PlotOptionsChaikinSonificationTracksActiveWhen ActiveWhen { get; set; }
		private PlotOptionsChaikinSonificationTracksActiveWhen ActiveWhen_DefaultValue { get; set; }
		...
		/// </summary>
		public PlotOptionsChaikinSonificationTracksMapping Mapping { get; set; }
		private PlotOptionsChaikinSonificationTracksMapping Mapping_DefaultValue { get; set; }
		...
		/// </summary>
		public PlotOptionsChaikinSonificationTracksPointGrouping PointGrouping { get; set; }
		private PlotOptionsChaikinSonificationTracksPointGrouping PointGrouping_DefaultValue { get; set; }
		...
		/// </summary>
		public PlotOptionsChaikinSonificationTracksType Type { get; set; }
		private PlotOptionsChaikinSonificationTracksType Type_DefaultValue { get; set; }
