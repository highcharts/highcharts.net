...
{
	public partial class PlotOptionsChaikinSonificationTracksMapping  : BaseObject
	{
		Hashtable h = new Hashtable();

		public PlotOptionsChaikinSonificationTracksMapping()
		{
			Frequency = Frequency_DefaultValue = new PlotOptionsChaikinSonificationTracksMappingFrequency();
			GapBetweenNotes = GapBetweenNotes_DefaultValue = new PlotOptionsChaikinSonificationTracksMappingGapBetweenNotes();
			Highpass = Highpass_DefaultValue = new PlotOptionsChaikinSonificationTracksMappingHighpass();
			Lowpass = Lowpass_DefaultValue = new PlotOptionsChaikinSonificationTracksMappingLowpass();
			NoteDuration = NoteDuration_DefaultValue = new PlotOptionsChaikinSonificationTracksMappingNoteDuration();
			Pan = Pan_DefaultValue = new PlotOptionsChaikinSonificationTracksMappingPan();
			Pitch = Pitch_DefaultValue = new PlotOptionsChaikinSonificationTracksMappingPitch();
			PitchString = PitchString_DefaultValue = "null";
			PitchNumber = PitchNumber_DefaultValue = null;
			PlayDelay = PlayDelay_DefaultValue = new PlotOptionsChaikinSonificationTracksMappingPlayDelay();
			Time = Time_DefaultValue = new PlotOptionsChaikinSonificationTracksMappingTime();
			TimeString = TimeString_DefaultValue = "null";
			TimeNumber = TimeNumber_DefaultValue = null;
			Tremolo = Tremolo_DefaultValue = new PlotOptionsChaikinSonificationTracksMappingTremolo();
			Volume = Volume_DefaultValue = new PlotOptionsChaikinSonificationTracksMappingVolume();
		...
		/// </summary>
		public PlotOptionsChaikinSonificationTracksMappingFrequency Frequency { get; set; }
		private PlotOptionsChaikinSonificationTracksMappingFrequency Frequency_DefaultValue { get; set; }
		...
		/// </summary>
		public PlotOptionsChaikinSonificationTracksMappingGapBetweenNotes GapBetweenNotes { get; set; }
		private PlotOptionsChaikinSonificationTracksMappingGapBetweenNotes GapBetweenNotes_DefaultValue { get; set; }
		...
		/// </summary>
		public PlotOptionsChaikinSonificationTracksMappingHighpass Highpass { get; set; }
		private PlotOptionsChaikinSonificationTracksMappingHighpass Highpass_DefaultValue { get; set; }
		...
		/// </summary>
		public PlotOptionsChaikinSonificationTracksMappingLowpass Lowpass { get; set; }
		private PlotOptionsChaikinSonificationTracksMappingLowpass Lowpass_DefaultValue { get; set; }
		...
		/// </summary>
		public PlotOptionsChaikinSonificationTracksMappingNoteDuration NoteDuration { get; set; }
		private PlotOptionsChaikinSonificationTracksMappingNoteDuration NoteDuration_DefaultValue { get; set; }
		...
		/// </summary>
		public PlotOptionsChaikinSonificationTracksMappingPan Pan { get; set; }
		private PlotOptionsChaikinSonificationTracksMappingPan Pan_DefaultValue { get; set; }
		...
		/// </summary>
		public PlotOptionsChaikinSonificationTracksMappingPitch Pitch { get; set; }
		private PlotOptionsChaikinSonificationTracksMappingPitch Pitch_DefaultValue { get; set; }
		...
		/// </summary>
		public PlotOptionsChaikinSonificationTracksMappingPlayDelay PlayDelay { get; set; }
		private PlotOptionsChaikinSonificationTracksMappingPlayDelay PlayDelay_DefaultValue { get; set; }
		...
		/// </summary>
		public PlotOptionsChaikinSonificationTracksMappingTime Time { get; set; }
		private PlotOptionsChaikinSonificationTracksMappingTime Time_DefaultValue { get; set; }
		...
		/// </summary>
		public PlotOptionsChaikinSonificationTracksMappingTremolo Tremolo { get; set; }
		private PlotOptionsChaikinSonificationTracksMappingTremolo Tremolo_DefaultValue { get; set; }
		 

		/// <summary>
		/// The volume of notes, from 0 to 1.
		/// </summary>
		public PlotOptionsChaikinSonificationTracksMappingVolume Volume { get; set; }
		private PlotOptionsChaikinSonificationTracksMappingVolume Volume_DefaultValue { get; set; }
