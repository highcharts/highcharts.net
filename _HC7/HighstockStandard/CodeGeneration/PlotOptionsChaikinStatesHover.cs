...
{
	public partial class PlotOptionsChaikinStatesHover  : BaseObject
	{
		Hashtable h = new Hashtable();

		public PlotOptionsChaikinStatesHover()
		{
			Animation = Animation_DefaultValue = new Animation() { Enabled = true };
			Enabled = Enabled_DefaultValue = null;
			Halo = Halo_DefaultValue = new PlotOptionsChaikinStatesHoverHalo();
			LineWidth = LineWidth_DefaultValue = null;
			LineWidthPlus = LineWidthPlus_DefaultValue = null;
			Marker = Marker_DefaultValue = new PlotOptionsChaikinStatesHoverMarker();
		...
		/// </summary>
		public PlotOptionsChaikinStatesHoverHalo Halo { get; set; }
		private PlotOptionsChaikinStatesHoverHalo Halo_DefaultValue { get; set; }
		...
		/// </summary>
		public PlotOptionsChaikinStatesHoverMarker Marker { get; set; }
		private PlotOptionsChaikinStatesHoverMarker Marker_DefaultValue { get; set; }
