...
{
	public partial class PlotOptionsChaikinTooltip  : BaseObject
	{
		public PlotOptionsChaikinTooltip()
		{
			...
			HeaderShape = HeaderShape_DefaultValue = PlotOptionsChaikinTooltipHeaderShape.Callout;
		...
		/// </summary>
		public PlotOptionsChaikinTooltipHeaderShape HeaderShape { get; set; }
		private PlotOptionsChaikinTooltipHeaderShape HeaderShape_DefaultValue { get; set; }
		...
		internal override Hashtable ToHashtable()
		{
			...
			if (NullFormatter != NullFormatter_DefaultValue) { h.Add("nullFormatter",NullFormatter); Highstock.AddFunction("PlotOptionsChaikinTooltipNullFormatter.nullFormatter", NullFormatter); }  
			if (Outside != Outside_DefaultValue) h.Add("outside",Outside);
			if (Padding != Padding_DefaultValue) h.Add("padding",Padding);
			if (PointFormat != PointFormat_DefaultValue) h.Add("pointFormat",PointFormat);
			if (PointFormatter != PointFormatter_DefaultValue) { h.Add("pointFormatter",PointFormatter); Highstock.AddFunction("PlotOptionsChaikinTooltipPointFormatter.pointFormatter", PointFormatter); }  
