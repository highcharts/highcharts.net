...
{
	public partial class PlotOptionsCmf  : BaseObject
	{
		Hashtable h = new Hashtable();

		public PlotOptionsCmf()
		{
			Accessibility = Accessibility_DefaultValue = new PlotOptionsCmfAccessibility();
			AllowPointSelect = AllowPointSelect_DefaultValue = false;
			Animation = Animation_DefaultValue = new Animation() { Enabled = true };
			AnimationBool = AnimationBool_DefaultValue = true;
			BoostBlending = BoostBlending_DefaultValue = PlotOptionsCmfBoostBlending.Undefined;
			...
			Compare = Compare_DefaultValue = PlotOptionsCmfCompare.Percent;
			CompareBase = CompareBase_DefaultValue = PlotOptionsCmfCompareBase.Min;
			...
			Cursor = Cursor_DefaultValue = PlotOptionsCmfCursor.Null;
			Custom = Custom_DefaultValue = new Hashtable();
			DashStyle = DashStyle_DefaultValue = PlotOptionsCmfDashStyle.Null;
			DataGrouping = DataGrouping_DefaultValue = new PlotOptionsCmfDataGrouping();
			DataLabels = DataLabels_DefaultValue = new PlotOptionsCmfDataLabels();
			DataSorting = DataSorting_DefaultValue = new PlotOptionsCmfDataSorting();
			Description = Description_DefaultValue = "";
			EnableMouseTracking = EnableMouseTracking_DefaultValue = true;
			Events = Events_DefaultValue = new PlotOptionsCmfEvents();
			FindNearestPointBy = FindNearestPointBy_DefaultValue = PlotOptionsCmfFindNearestPointBy.X;
			GapSize = GapSize_DefaultValue = 0;
			GapUnit = GapUnit_DefaultValue = PlotOptionsCmfGapUnit.Relative;
			GetExtremesFromAll = GetExtremesFromAll_DefaultValue = false;
			InactiveOtherPoints = InactiveOtherPoints_DefaultValue = false;
			IncludeInDataExport = IncludeInDataExport_DefaultValue = null;
			Label = Label_DefaultValue = new PlotOptionsCmfLabel();
			LastPrice = LastPrice_DefaultValue = new PlotOptionsCmfLastPrice();
			LastVisiblePrice = LastVisiblePrice_DefaultValue = new PlotOptionsCmfLastVisiblePrice();
			LegendSymbol = LegendSymbol_DefaultValue = PlotOptionsCmfLegendSymbol.Rectangle;
			Linecap = Linecap_DefaultValue = PlotOptionsCmfLinecap.Round;
			LineWidth = LineWidth_DefaultValue = 2;
			LinkedTo = LinkedTo_DefaultValue = "";
			Marker = Marker_DefaultValue = new PlotOptionsCmfMarker();
			NegativeColor = NegativeColor_DefaultValue = "";
			OnPoint = OnPoint_DefaultValue = new PlotOptionsCmfOnPoint();
			Opacity = Opacity_DefaultValue = 1;
			Params = Params_DefaultValue = new PlotOptionsCmfParams();
			Point = Point_DefaultValue = new PlotOptionsCmfPoint();
			...
			Sonification = Sonification_DefaultValue = new PlotOptionsCmfSonification();
			States = States_DefaultValue = new PlotOptionsCmfStates();
			Step = Step_DefaultValue = PlotOptionsCmfStep.Null;
			...
			Zones = Zones_DefaultValue = new List<PlotOptionsCmfZones>();
		...
		/// </summary>
		public PlotOptionsCmfAccessibility Accessibility { get; set; }
		private PlotOptionsCmfAccessibility Accessibility_DefaultValue { get; set; }
		...
		/// </summary>
		public PlotOptionsCmfBoostBlending BoostBlending { get; set; }
		private PlotOptionsCmfBoostBlending BoostBlending_DefaultValue { get; set; }
		...
		/// </summary>
		public PlotOptionsCmfCompare Compare { get; set; }
		private PlotOptionsCmfCompare Compare_DefaultValue { get; set; }
		 

		/// <summary>
		/// When [compare](#plotOptions.series.compare) is `percent`, this optiondictates whether to use 0 or 100 as the base of comparison.
		/// </summary>
		public PlotOptionsCmfCompareBase CompareBase { get; set; }
		private PlotOptionsCmfCompareBase CompareBase_DefaultValue { get; set; }
		...
		/// </summary>
		public PlotOptionsCmfCursor Cursor { get; set; }
		private PlotOptionsCmfCursor Cursor_DefaultValue { get; set; }
		...
		/// </summary>
		public PlotOptionsCmfDashStyle DashStyle { get; set; }
		private PlotOptionsCmfDashStyle DashStyle_DefaultValue { get; set; }
		...
		/// </summary>
		public PlotOptionsCmfDataGrouping DataGrouping { get; set; }
		private PlotOptionsCmfDataGrouping DataGrouping_DefaultValue { get; set; }
		...
		/// </summary>
		public PlotOptionsCmfDataLabels DataLabels { get; set; }
		private PlotOptionsCmfDataLabels DataLabels_DefaultValue { get; set; }
		 

		/// <summary>
		/// Options for the series data sorting.
		/// </summary>
		public PlotOptionsCmfDataSorting DataSorting { get; set; }
		private PlotOptionsCmfDataSorting DataSorting_DefaultValue { get; set; }
		...
		/// </summary>
		public PlotOptionsCmfEvents Events { get; set; }
		private PlotOptionsCmfEvents Events_DefaultValue { get; set; }
		...
		/// </summary>
		public PlotOptionsCmfFindNearestPointBy FindNearestPointBy { get; set; }
		private PlotOptionsCmfFindNearestPointBy FindNearestPointBy_DefaultValue { get; set; }
		...
		/// </summary>
		public PlotOptionsCmfGapUnit GapUnit { get; set; }
		private PlotOptionsCmfGapUnit GapUnit_DefaultValue { get; set; }
		...
		/// </summary>
		public PlotOptionsCmfLabel Label { get; set; }
		private PlotOptionsCmfLabel Label_DefaultValue { get; set; }
		 

		/// <summary>
		/// The line marks the last price from all points.
		/// </summary>
		public PlotOptionsCmfLastPrice LastPrice { get; set; }
		private PlotOptionsCmfLastPrice LastPrice_DefaultValue { get; set; }
		 

		/// <summary>
		/// The line marks the last price from visible range of points.
		/// </summary>
		public PlotOptionsCmfLastVisiblePrice LastVisiblePrice { get; set; }
		private PlotOptionsCmfLastVisiblePrice LastVisiblePrice_DefaultValue { get; set; }
		 

		/// <summary>
		/// What type of legend symbol to render for this series. Can be one of`areaMarker`, `lineMarker` or `rectangle`.
		/// </summary>
		public PlotOptionsCmfLegendSymbol LegendSymbol { get; set; }
		private PlotOptionsCmfLegendSymbol LegendSymbol_DefaultValue { get; set; }
		 

		/// <summary>
		/// The line cap used for line ends and line joins on the graph.
		/// </summary>
		public PlotOptionsCmfLinecap Linecap { get; set; }
		private PlotOptionsCmfLinecap Linecap_DefaultValue { get; set; }
		...
		/// </summary>
		public PlotOptionsCmfMarker Marker { get; set; }
		private PlotOptionsCmfMarker Marker_DefaultValue { get; set; }
		...
		/// </summary>
		public PlotOptionsCmfOnPoint OnPoint { get; set; }
		private PlotOptionsCmfOnPoint OnPoint_DefaultValue { get; set; }
		...
		private PlotOptionsCmfParams Params_DefaultValue { get; set; }
		 

		/// <summary>
		/// Properties for each single point.
		/// </summary>
		public PlotOptionsCmfPoint Point { get; set; }
		private PlotOptionsCmfPoint Point_DefaultValue { get; set; }
		...
		/// </summary>
		public PlotOptionsCmfSonification Sonification { get; set; }
		private PlotOptionsCmfSonification Sonification_DefaultValue { get; set; }
		 

		/// <summary>
		/// 
		/// </summary>
		public PlotOptionsCmfStates States { get; set; }
		private PlotOptionsCmfStates States_DefaultValue { get; set; }
		 

		/// <summary>
		/// Whether to apply steps to the line. Possible values are `left`,`center` and `right`.
		/// </summary>
		public PlotOptionsCmfStep Step { get; set; }
		private PlotOptionsCmfStep Step_DefaultValue { get; set; }
		...
		/// </summary>
		public PlotOptionsCmfTooltip Tooltip { get; set; }
		private PlotOptionsCmfTooltip Tooltip_DefaultValue { get; set; }
		...
		/// </summary>
		public List<PlotOptionsCmfZones> Zones { get; set; }
		private List<PlotOptionsCmfZones> Zones_DefaultValue { get; set; }
