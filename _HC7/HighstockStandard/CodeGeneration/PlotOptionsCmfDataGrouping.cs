...
namespace Highsoft.Web.Mvc.Stocks
{
	public partial class PlotOptionsCmfDataGrouping  : BaseObject
	{
		...
		internal override Hashtable ToHashtable()
		{
			...
			if (Approximation != Approximation_DefaultValue) { h.Add("approximation",Approximation); Highstock.AddFunction("PlotOptionsCmfDataGroupingApproximation.approximation", Approximation); }  
