...
{
	public partial class PlotOptionsCmfDragDrop  : BaseObject
	{
		public PlotOptionsCmfDragDrop()
		{
			DraggableX = DraggableX_DefaultValue = null;
			DraggableY = DraggableY_DefaultValue = null;
			DragHandle = DragHandle_DefaultValue = new PlotOptionsCmfDragDropDragHandle();
			...
			GuideBox = GuideBox_DefaultValue = new PlotOptionsCmfDragDropGuideBox();
		...
		/// </summary>
		public PlotOptionsCmfDragDropDragHandle DragHandle { get; set; }
		private PlotOptionsCmfDragDropDragHandle DragHandle_DefaultValue { get; set; }
		...
		/// </summary>
		public PlotOptionsCmfDragDropGuideBox GuideBox { get; set; }
		private PlotOptionsCmfDragDropGuideBox GuideBox_DefaultValue { get; set; }
