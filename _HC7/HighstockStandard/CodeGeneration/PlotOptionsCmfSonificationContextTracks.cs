...
{
	public partial class PlotOptionsCmfSonificationContextTracks  : BaseObject
	{
		Hashtable h = new Hashtable();

		public PlotOptionsCmfSonificationContextTracks()
		{
			ActiveWhen = ActiveWhen_DefaultValue = new PlotOptionsCmfSonificationContextTracksActiveWhen();
			Instrument = Instrument_DefaultValue = null;
			InstrumentString = InstrumentString_DefaultValue = "null";
			Mapping = Mapping_DefaultValue = new PlotOptionsCmfSonificationContextTracksMapping();
			MidiName = MidiName_DefaultValue = "";
			PointGrouping = PointGrouping_DefaultValue = new PlotOptionsCmfSonificationContextTracksPointGrouping();
			...
			Type = Type_DefaultValue = PlotOptionsCmfSonificationContextTracksType.Instrument;
			ValueInterval = ValueInterval_DefaultValue = null;
			ValueMapFunction = ValueMapFunction_DefaultValue = PlotOptionsCmfSonificationContextTracksValueMapFunction.Linear;
		...
		/// </summary>
		public PlotOptionsCmfSonificationContextTracksActiveWhen ActiveWhen { get; set; }
		private PlotOptionsCmfSonificationContextTracksActiveWhen ActiveWhen_DefaultValue { get; set; }
		...
		/// </summary>
		public PlotOptionsCmfSonificationContextTracksMapping Mapping { get; set; }
		private PlotOptionsCmfSonificationContextTracksMapping Mapping_DefaultValue { get; set; }
		...
		/// </summary>
		public PlotOptionsCmfSonificationContextTracksPointGrouping PointGrouping { get; set; }
		private PlotOptionsCmfSonificationContextTracksPointGrouping PointGrouping_DefaultValue { get; set; }
		...
		/// </summary>
		public PlotOptionsCmfSonificationContextTracksType Type { get; set; }
		private PlotOptionsCmfSonificationContextTracksType Type_DefaultValue { get; set; }
		...
		/// </summary>
		public PlotOptionsCmfSonificationContextTracksValueMapFunction ValueMapFunction { get; set; }
		private PlotOptionsCmfSonificationContextTracksValueMapFunction ValueMapFunction_DefaultValue { get; set; }
