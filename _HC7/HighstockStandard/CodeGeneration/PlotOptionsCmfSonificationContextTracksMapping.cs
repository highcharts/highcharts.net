...
{
	public partial class PlotOptionsCmfSonificationContextTracksMapping  : BaseObject
	{
		Hashtable h = new Hashtable();

		public PlotOptionsCmfSonificationContextTracksMapping()
		{
			Frequency = Frequency_DefaultValue = new PlotOptionsCmfSonificationContextTracksMappingFrequency();
			GapBetweenNotes = GapBetweenNotes_DefaultValue = new PlotOptionsCmfSonificationContextTracksMappingGapBetweenNotes();
			Highpass = Highpass_DefaultValue = new PlotOptionsCmfSonificationContextTracksMappingHighpass();
			Lowpass = Lowpass_DefaultValue = new PlotOptionsCmfSonificationContextTracksMappingLowpass();
			NoteDuration = NoteDuration_DefaultValue = new PlotOptionsCmfSonificationContextTracksMappingNoteDuration();
			Pan = Pan_DefaultValue = new PlotOptionsCmfSonificationContextTracksMappingPan();
			Pitch = Pitch_DefaultValue = new PlotOptionsCmfSonificationContextTracksMappingPitch();
			PitchString = PitchString_DefaultValue = "null";
			PitchNumber = PitchNumber_DefaultValue = null;
			PlayDelay = PlayDelay_DefaultValue = new PlotOptionsCmfSonificationContextTracksMappingPlayDelay();
			Time = Time_DefaultValue = new PlotOptionsCmfSonificationContextTracksMappingTime();
			TimeString = TimeString_DefaultValue = "null";
			TimeNumber = TimeNumber_DefaultValue = null;
			Tremolo = Tremolo_DefaultValue = new PlotOptionsCmfSonificationContextTracksMappingTremolo();
			Volume = Volume_DefaultValue = new PlotOptionsCmfSonificationContextTracksMappingVolume();
		...
		/// </summary>
		public PlotOptionsCmfSonificationContextTracksMappingFrequency Frequency { get; set; }
		private PlotOptionsCmfSonificationContextTracksMappingFrequency Frequency_DefaultValue { get; set; }
		...
		/// </summary>
		public PlotOptionsCmfSonificationContextTracksMappingGapBetweenNotes GapBetweenNotes { get; set; }
		private PlotOptionsCmfSonificationContextTracksMappingGapBetweenNotes GapBetweenNotes_DefaultValue { get; set; }
		...
		/// </summary>
		public PlotOptionsCmfSonificationContextTracksMappingHighpass Highpass { get; set; }
		private PlotOptionsCmfSonificationContextTracksMappingHighpass Highpass_DefaultValue { get; set; }
		...
		/// </summary>
		public PlotOptionsCmfSonificationContextTracksMappingLowpass Lowpass { get; set; }
		private PlotOptionsCmfSonificationContextTracksMappingLowpass Lowpass_DefaultValue { get; set; }
		...
		/// </summary>
		public PlotOptionsCmfSonificationContextTracksMappingNoteDuration NoteDuration { get; set; }
		private PlotOptionsCmfSonificationContextTracksMappingNoteDuration NoteDuration_DefaultValue { get; set; }
		...
		/// </summary>
		public PlotOptionsCmfSonificationContextTracksMappingPan Pan { get; set; }
		private PlotOptionsCmfSonificationContextTracksMappingPan Pan_DefaultValue { get; set; }
		...
		/// </summary>
		public PlotOptionsCmfSonificationContextTracksMappingPitch Pitch { get; set; }
		private PlotOptionsCmfSonificationContextTracksMappingPitch Pitch_DefaultValue { get; set; }
		...
		/// </summary>
		public PlotOptionsCmfSonificationContextTracksMappingPlayDelay PlayDelay { get; set; }
		private PlotOptionsCmfSonificationContextTracksMappingPlayDelay PlayDelay_DefaultValue { get; set; }
		...
		/// </summary>
		public PlotOptionsCmfSonificationContextTracksMappingTime Time { get; set; }
		private PlotOptionsCmfSonificationContextTracksMappingTime Time_DefaultValue { get; set; }
		...
		/// </summary>
		public PlotOptionsCmfSonificationContextTracksMappingTremolo Tremolo { get; set; }
		private PlotOptionsCmfSonificationContextTracksMappingTremolo Tremolo_DefaultValue { get; set; }
		 

		/// <summary>
		/// The volume of notes, from 0 to 1.
		/// </summary>
		public PlotOptionsCmfSonificationContextTracksMappingVolume Volume { get; set; }
		private PlotOptionsCmfSonificationContextTracksMappingVolume Volume_DefaultValue { get; set; }
