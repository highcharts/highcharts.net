...
{
	public partial class PlotOptionsCmfSonificationContextTracksMappingLowpassFrequency  : BaseObject
	{
		Hashtable h = new Hashtable();

		public PlotOptionsCmfSonificationContextTracksMappingLowpassFrequency()
		{
			MapFunction = MapFunction_DefaultValue = PlotOptionsCmfSonificationContextTracksMappingLowpassFrequencyMapFunction.Linear;
			MapTo = MapTo_DefaultValue = "";
			Max = Max_DefaultValue = null;
			Min = Min_DefaultValue = null;
			Value = Value_DefaultValue = null;
			Within = Within_DefaultValue = PlotOptionsCmfSonificationContextTracksMappingLowpassFrequencyWithin.Chart;
		...
		/// </summary>
		public PlotOptionsCmfSonificationContextTracksMappingLowpassFrequencyMapFunction MapFunction { get; set; }
		private PlotOptionsCmfSonificationContextTracksMappingLowpassFrequencyMapFunction MapFunction_DefaultValue { get; set; }
		...
		/// </summary>
		public PlotOptionsCmfSonificationContextTracksMappingLowpassFrequencyWithin Within { get; set; }
		private PlotOptionsCmfSonificationContextTracksMappingLowpassFrequencyWithin Within_DefaultValue { get; set; }
