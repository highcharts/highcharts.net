...
{
	public partial class PlotOptionsCmfSonificationContextTracksMappingPitch  : BaseObject
	{
		Hashtable h = new Hashtable();

		public PlotOptionsCmfSonificationContextTracksMappingPitch()
		{
			MapFunction = MapFunction_DefaultValue = PlotOptionsCmfSonificationContextTracksMappingPitchMapFunction.Linear;
		...
		/// </summary>
		public PlotOptionsCmfSonificationContextTracksMappingPitchMapFunction MapFunction { get; set; }
		private PlotOptionsCmfSonificationContextTracksMappingPitchMapFunction MapFunction_DefaultValue { get; set; }
