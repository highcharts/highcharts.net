...
{
	public partial class PlotOptionsCmfSonificationContextTracksMappingPlayDelay  : BaseObject
	{
		Hashtable h = new Hashtable();

		public PlotOptionsCmfSonificationContextTracksMappingPlayDelay()
		{
			MapFunction = MapFunction_DefaultValue = PlotOptionsCmfSonificationContextTracksMappingPlayDelayMapFunction.Linear;
			MapTo = MapTo_DefaultValue = "";
			Max = Max_DefaultValue = null;
			Min = Min_DefaultValue = null;
			Value = Value_DefaultValue = null;
			Within = Within_DefaultValue = PlotOptionsCmfSonificationContextTracksMappingPlayDelayWithin.Chart;
		...
		/// </summary>
		public PlotOptionsCmfSonificationContextTracksMappingPlayDelayMapFunction MapFunction { get; set; }
		private PlotOptionsCmfSonificationContextTracksMappingPlayDelayMapFunction MapFunction_DefaultValue { get; set; }
		...
		/// </summary>
		public PlotOptionsCmfSonificationContextTracksMappingPlayDelayWithin Within { get; set; }
		private PlotOptionsCmfSonificationContextTracksMappingPlayDelayWithin Within_DefaultValue { get; set; }
