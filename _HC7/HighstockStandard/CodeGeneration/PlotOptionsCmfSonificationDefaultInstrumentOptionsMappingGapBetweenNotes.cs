...
{
	public partial class PlotOptionsCmfSonificationDefaultInstrumentOptionsMappingGapBetweenNotes  : BaseObject
	{
		Hashtable h = new Hashtable();

		public PlotOptionsCmfSonificationDefaultInstrumentOptionsMappingGapBetweenNotes()
		{
			MapFunction = MapFunction_DefaultValue = PlotOptionsCmfSonificationDefaultInstrumentOptionsMappingGapBetweenNotesMapFunction.Linear;
			MapTo = MapTo_DefaultValue = "";
			Max = Max_DefaultValue = null;
			Min = Min_DefaultValue = null;
			Value = Value_DefaultValue = null;
			Within = Within_DefaultValue = PlotOptionsCmfSonificationDefaultInstrumentOptionsMappingGapBetweenNotesWithin.Chart;
		...
		/// </summary>
		public PlotOptionsCmfSonificationDefaultInstrumentOptionsMappingGapBetweenNotesMapFunction MapFunction { get; set; }
		private PlotOptionsCmfSonificationDefaultInstrumentOptionsMappingGapBetweenNotesMapFunction MapFunction_DefaultValue { get; set; }
		...
		/// </summary>
		public PlotOptionsCmfSonificationDefaultInstrumentOptionsMappingGapBetweenNotesWithin Within { get; set; }
		private PlotOptionsCmfSonificationDefaultInstrumentOptionsMappingGapBetweenNotesWithin Within_DefaultValue { get; set; }
