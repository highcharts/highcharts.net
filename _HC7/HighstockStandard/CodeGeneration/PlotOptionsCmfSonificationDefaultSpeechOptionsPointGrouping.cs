...
{
	public partial class PlotOptionsCmfSonificationDefaultSpeechOptionsPointGrouping  : BaseObject
	{
		Hashtable h = new Hashtable();

		public PlotOptionsCmfSonificationDefaultSpeechOptionsPointGrouping()
		{
			Algorithm = Algorithm_DefaultValue = PlotOptionsCmfSonificationDefaultSpeechOptionsPointGroupingAlgorithm.Minimax;
		...
		/// </summary>
		public PlotOptionsCmfSonificationDefaultSpeechOptionsPointGroupingAlgorithm Algorithm { get; set; }
		private PlotOptionsCmfSonificationDefaultSpeechOptionsPointGroupingAlgorithm Algorithm_DefaultValue { get; set; }
