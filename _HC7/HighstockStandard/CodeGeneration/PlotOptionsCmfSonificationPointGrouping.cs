...
{
	public partial class PlotOptionsCmfSonificationPointGrouping  : BaseObject
	{
		Hashtable h = new Hashtable();

		public PlotOptionsCmfSonificationPointGrouping()
		{
			Algorithm = Algorithm_DefaultValue = PlotOptionsCmfSonificationPointGroupingAlgorithm.Minimax;
		...
		/// </summary>
		public PlotOptionsCmfSonificationPointGroupingAlgorithm Algorithm { get; set; }
		private PlotOptionsCmfSonificationPointGroupingAlgorithm Algorithm_DefaultValue { get; set; }
