...
{
	public partial class PlotOptionsCmfSonificationTracksMappingNoteDuration  : BaseObject
	{
		Hashtable h = new Hashtable();

		public PlotOptionsCmfSonificationTracksMappingNoteDuration()
		{
			MapFunction = MapFunction_DefaultValue = PlotOptionsCmfSonificationTracksMappingNoteDurationMapFunction.Linear;
			MapTo = MapTo_DefaultValue = "";
			Max = Max_DefaultValue = null;
			Min = Min_DefaultValue = null;
			Value = Value_DefaultValue = null;
			Within = Within_DefaultValue = PlotOptionsCmfSonificationTracksMappingNoteDurationWithin.Chart;
		...
		/// </summary>
		public PlotOptionsCmfSonificationTracksMappingNoteDurationMapFunction MapFunction { get; set; }
		private PlotOptionsCmfSonificationTracksMappingNoteDurationMapFunction MapFunction_DefaultValue { get; set; }
		...
		/// </summary>
		public PlotOptionsCmfSonificationTracksMappingNoteDurationWithin Within { get; set; }
		private PlotOptionsCmfSonificationTracksMappingNoteDurationWithin Within_DefaultValue { get; set; }
