...
{
	public partial class PlotOptionsCmfSonificationTracksMappingPan  : BaseObject
	{
		Hashtable h = new Hashtable();

		public PlotOptionsCmfSonificationTracksMappingPan()
		{
			MapFunction = MapFunction_DefaultValue = PlotOptionsCmfSonificationTracksMappingPanMapFunction.Linear;
			MapTo = MapTo_DefaultValue = "";
			Max = Max_DefaultValue = null;
			Min = Min_DefaultValue = null;
			Value = Value_DefaultValue = null;
			Within = Within_DefaultValue = PlotOptionsCmfSonificationTracksMappingPanWithin.Chart;
		...
		/// </summary>
		public PlotOptionsCmfSonificationTracksMappingPanMapFunction MapFunction { get; set; }
		private PlotOptionsCmfSonificationTracksMappingPanMapFunction MapFunction_DefaultValue { get; set; }
		...
		/// </summary>
		public PlotOptionsCmfSonificationTracksMappingPanWithin Within { get; set; }
		private PlotOptionsCmfSonificationTracksMappingPanWithin Within_DefaultValue { get; set; }
