...
{
	public partial class PlotOptionsCmfSonificationTracksMappingPitch  : BaseObject
	{
		Hashtable h = new Hashtable();

		public PlotOptionsCmfSonificationTracksMappingPitch()
		{
			MapFunction = MapFunction_DefaultValue = PlotOptionsCmfSonificationTracksMappingPitchMapFunction.Linear;
		...
		/// </summary>
		public PlotOptionsCmfSonificationTracksMappingPitchMapFunction MapFunction { get; set; }
		private PlotOptionsCmfSonificationTracksMappingPitchMapFunction MapFunction_DefaultValue { get; set; }
