...
{
	public partial class PlotOptionsCmfSonificationTracksMappingTime  : BaseObject
	{
		Hashtable h = new Hashtable();

		public PlotOptionsCmfSonificationTracksMappingTime()
		{
			MapFunction = MapFunction_DefaultValue = PlotOptionsCmfSonificationTracksMappingTimeMapFunction.Linear;
			MapTo = MapTo_DefaultValue = "";
			Max = Max_DefaultValue = null;
			Min = Min_DefaultValue = null;
			Value = Value_DefaultValue = null;
			Within = Within_DefaultValue = PlotOptionsCmfSonificationTracksMappingTimeWithin.Chart;
		...
		/// </summary>
		public PlotOptionsCmfSonificationTracksMappingTimeMapFunction MapFunction { get; set; }
		private PlotOptionsCmfSonificationTracksMappingTimeMapFunction MapFunction_DefaultValue { get; set; }
		...
		/// </summary>
		public PlotOptionsCmfSonificationTracksMappingTimeWithin Within { get; set; }
		private PlotOptionsCmfSonificationTracksMappingTimeWithin Within_DefaultValue { get; set; }
