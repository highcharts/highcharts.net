...
{
	public partial class PlotOptionsCmfSonificationTracksMappingVolume  : BaseObject
	{
		Hashtable h = new Hashtable();

		public PlotOptionsCmfSonificationTracksMappingVolume()
		{
			MapFunction = MapFunction_DefaultValue = PlotOptionsCmfSonificationTracksMappingVolumeMapFunction.Linear;
			MapTo = MapTo_DefaultValue = "";
			Max = Max_DefaultValue = null;
			Min = Min_DefaultValue = null;
			Value = Value_DefaultValue = null;
			Within = Within_DefaultValue = PlotOptionsCmfSonificationTracksMappingVolumeWithin.Chart;
		...
		/// </summary>
		public PlotOptionsCmfSonificationTracksMappingVolumeMapFunction MapFunction { get; set; }
		private PlotOptionsCmfSonificationTracksMappingVolumeMapFunction MapFunction_DefaultValue { get; set; }
		...
		/// </summary>
		public PlotOptionsCmfSonificationTracksMappingVolumeWithin Within { get; set; }
		private PlotOptionsCmfSonificationTracksMappingVolumeWithin Within_DefaultValue { get; set; }
