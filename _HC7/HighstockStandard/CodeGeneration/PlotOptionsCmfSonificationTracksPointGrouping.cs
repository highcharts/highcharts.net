...
{
	public partial class PlotOptionsCmfSonificationTracksPointGrouping  : BaseObject
	{
		Hashtable h = new Hashtable();

		public PlotOptionsCmfSonificationTracksPointGrouping()
		{
			Algorithm = Algorithm_DefaultValue = PlotOptionsCmfSonificationTracksPointGroupingAlgorithm.Minimax;
		...
		/// </summary>
		public PlotOptionsCmfSonificationTracksPointGroupingAlgorithm Algorithm { get; set; }
		private PlotOptionsCmfSonificationTracksPointGroupingAlgorithm Algorithm_DefaultValue { get; set; }
