...
{
	public partial class PlotOptionsCmfStatesSelect  : BaseObject
	{
		public PlotOptionsCmfStatesSelect()
		{
			Animation = Animation_DefaultValue = new Animation() { Enabled = true };
			Enabled = Enabled_DefaultValue = true;
			Halo = Halo_DefaultValue = new PlotOptionsCmfStatesSelectHalo();
			LineWidth = LineWidth_DefaultValue = null;
			LineWidthPlus = LineWidthPlus_DefaultValue = 1;
			Marker = Marker_DefaultValue = new PlotOptionsCmfStatesSelectMarker();
		...
		/// </summary>
		public PlotOptionsCmfStatesSelectHalo Halo { get; set; }
		private PlotOptionsCmfStatesSelectHalo Halo_DefaultValue { get; set; }
		...
		/// </summary>
		public PlotOptionsCmfStatesSelectMarker Marker { get; set; }
		private PlotOptionsCmfStatesSelectMarker Marker_DefaultValue { get; set; }
