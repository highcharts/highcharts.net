...
namespace Highsoft.Web.Mvc.Stocks
{
	public partial class PlotOptionsCmfTooltip  : BaseObject
	{
		public PlotOptionsCmfTooltip()
		{
			...
			HeaderShape = HeaderShape_DefaultValue = PlotOptionsCmfTooltipHeaderShape.Callout;
		...
		/// </summary>
		public PlotOptionsCmfTooltipHeaderShape HeaderShape { get; set; }
		private PlotOptionsCmfTooltipHeaderShape HeaderShape_DefaultValue { get; set; }
		...
		internal override Hashtable ToHashtable()
		{
			...
			if (NullFormatter != NullFormatter_DefaultValue) { h.Add("nullFormatter",NullFormatter); Highstock.AddFunction("PlotOptionsCmfTooltipNullFormatter.nullFormatter", NullFormatter); }  
			if (Outside != Outside_DefaultValue) h.Add("outside",Outside);
			if (Padding != Padding_DefaultValue) h.Add("padding",Padding);
			if (PointFormat != PointFormat_DefaultValue) h.Add("pointFormat",PointFormat);
			if (PointFormatter != PointFormatter_DefaultValue) { h.Add("pointFormatter",PointFormatter); Highstock.AddFunction("PlotOptionsCmfTooltipPointFormatter.pointFormatter", PointFormatter); }  
