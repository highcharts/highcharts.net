...
{
	public partial class PlotOptionsCmo  : BaseObject
	{
		Hashtable h = new Hashtable();

		public PlotOptionsCmo()
		{
			Accessibility = Accessibility_DefaultValue = new PlotOptionsCmoAccessibility();
			AllowPointSelect = AllowPointSelect_DefaultValue = false;
			Animation = Animation_DefaultValue = new Animation() { Enabled = true };
			AnimationBool = AnimationBool_DefaultValue = true;
			AnimationLimit = AnimationLimit_DefaultValue = null;
			BoostBlending = BoostBlending_DefaultValue = PlotOptionsCmoBoostBlending.Undefined;
			...
			Compare = Compare_DefaultValue = PlotOptionsCmoCompare.Percent;
			CompareBase = CompareBase_DefaultValue = PlotOptionsCmoCompareBase.Min;
			...
			Cursor = Cursor_DefaultValue = PlotOptionsCmoCursor.Null;
			Custom = Custom_DefaultValue = new Hashtable();
			DashStyle = DashStyle_DefaultValue = PlotOptionsCmoDashStyle.Null;
			DataGrouping = DataGrouping_DefaultValue = new PlotOptionsCmoDataGrouping();
			DataLabels = DataLabels_DefaultValue = new PlotOptionsCmoDataLabels();
			DataSorting = DataSorting_DefaultValue = new PlotOptionsCmoDataSorting();
			Description = Description_DefaultValue = "";
			EnableMouseTracking = EnableMouseTracking_DefaultValue = true;
			Events = Events_DefaultValue = new PlotOptionsCmoEvents();
			FindNearestPointBy = FindNearestPointBy_DefaultValue = PlotOptionsCmoFindNearestPointBy.X;
			GapSize = GapSize_DefaultValue = 0;
			GapUnit = GapUnit_DefaultValue = PlotOptionsCmoGapUnit.Relative;
			GetExtremesFromAll = GetExtremesFromAll_DefaultValue = false;
			InactiveOtherPoints = InactiveOtherPoints_DefaultValue = false;
			IncludeInDataExport = IncludeInDataExport_DefaultValue = null;
			Label = Label_DefaultValue = new PlotOptionsCmoLabel();
			LastPrice = LastPrice_DefaultValue = new PlotOptionsCmoLastPrice();
			LastVisiblePrice = LastVisiblePrice_DefaultValue = new PlotOptionsCmoLastVisiblePrice();
			LegendSymbol = LegendSymbol_DefaultValue = PlotOptionsCmoLegendSymbol.Rectangle;
			Linecap = Linecap_DefaultValue = PlotOptionsCmoLinecap.Round;
			LineWidth = LineWidth_DefaultValue = 2;
			LinkedTo = LinkedTo_DefaultValue = "";
			Marker = Marker_DefaultValue = new PlotOptionsCmoMarker();
			NegativeColor = NegativeColor_DefaultValue = "";
			OnPoint = OnPoint_DefaultValue = new PlotOptionsCmoOnPoint();
			Opacity = Opacity_DefaultValue = 1;
			Params = Params_DefaultValue = new PlotOptionsCmoParams();
			Point = Point_DefaultValue = new PlotOptionsCmoPoint();
			...
			Sonification = Sonification_DefaultValue = new PlotOptionsCmoSonification();
			States = States_DefaultValue = new PlotOptionsCmoStates();
			Step = Step_DefaultValue = PlotOptionsCmoStep.Null;
			StickyTracking = StickyTracking_DefaultValue = true;
			Threshold = Threshold_DefaultValue = 0;
			Tooltip = Tooltip_DefaultValue = new PlotOptionsCmoTooltip();
			TurboThreshold = TurboThreshold_DefaultValue = 1000;
			Visible = Visible_DefaultValue = true;
			ZoneAxis = ZoneAxis_DefaultValue = "y";
			Zones = Zones_DefaultValue = new List<PlotOptionsCmoZones>();
		...
		/// </summary>
		public PlotOptionsCmoAccessibility Accessibility { get; set; }
		private PlotOptionsCmoAccessibility Accessibility_DefaultValue { get; set; }
		...
		/// </summary>
		public PlotOptionsCmoBoostBlending BoostBlending { get; set; }
		private PlotOptionsCmoBoostBlending BoostBlending_DefaultValue { get; set; }
		...
		/// </summary>
		public PlotOptionsCmoCompare Compare { get; set; }
		private PlotOptionsCmoCompare Compare_DefaultValue { get; set; }
		 

		/// <summary>
		/// When [compare](#plotOptions.series.compare) is `percent`, this optiondictates whether to use 0 or 100 as the base of comparison.
		/// </summary>
		public PlotOptionsCmoCompareBase CompareBase { get; set; }
		private PlotOptionsCmoCompareBase CompareBase_DefaultValue { get; set; }
		...
		/// </summary>
		public PlotOptionsCmoCursor Cursor { get; set; }
		private PlotOptionsCmoCursor Cursor_DefaultValue { get; set; }
		...
		/// </summary>
		public PlotOptionsCmoDashStyle DashStyle { get; set; }
		private PlotOptionsCmoDashStyle DashStyle_DefaultValue { get; set; }
		...
		/// </summary>
		public PlotOptionsCmoDataGrouping DataGrouping { get; set; }
		private PlotOptionsCmoDataGrouping DataGrouping_DefaultValue { get; set; }
		...
		/// </summary>
		public PlotOptionsCmoDataLabels DataLabels { get; set; }
		private PlotOptionsCmoDataLabels DataLabels_DefaultValue { get; set; }
		 

		/// <summary>
		/// Options for the series data sorting.
		/// </summary>
		public PlotOptionsCmoDataSorting DataSorting { get; set; }
		private PlotOptionsCmoDataSorting DataSorting_DefaultValue { get; set; }
		...
		/// </summary>
		public PlotOptionsCmoEvents Events { get; set; }
		private PlotOptionsCmoEvents Events_DefaultValue { get; set; }
		...
		/// </summary>
		public PlotOptionsCmoFindNearestPointBy FindNearestPointBy { get; set; }
		private PlotOptionsCmoFindNearestPointBy FindNearestPointBy_DefaultValue { get; set; }
		...
		/// </summary>
		public PlotOptionsCmoGapUnit GapUnit { get; set; }
		private PlotOptionsCmoGapUnit GapUnit_DefaultValue { get; set; }
		...
		/// </summary>
		public PlotOptionsCmoLabel Label { get; set; }
		private PlotOptionsCmoLabel Label_DefaultValue { get; set; }
		 

		/// <summary>
		/// The line marks the last price from all points.
		/// </summary>
		public PlotOptionsCmoLastPrice LastPrice { get; set; }
		private PlotOptionsCmoLastPrice LastPrice_DefaultValue { get; set; }
		 

		/// <summary>
		/// The line marks the last price from visible range of points.
		/// </summary>
		public PlotOptionsCmoLastVisiblePrice LastVisiblePrice { get; set; }
		private PlotOptionsCmoLastVisiblePrice LastVisiblePrice_DefaultValue { get; set; }
		 

		/// <summary>
		/// What type of legend symbol to render for this series. Can be one of`areaMarker`, `lineMarker` or `rectangle`.
		/// </summary>
		public PlotOptionsCmoLegendSymbol LegendSymbol { get; set; }
		private PlotOptionsCmoLegendSymbol LegendSymbol_DefaultValue { get; set; }
		 

		/// <summary>
		/// The line cap used for line ends and line joins on the graph.
		/// </summary>
		public PlotOptionsCmoLinecap Linecap { get; set; }
		private PlotOptionsCmoLinecap Linecap_DefaultValue { get; set; }
		...
		/// </summary>
		public PlotOptionsCmoMarker Marker { get; set; }
		private PlotOptionsCmoMarker Marker_DefaultValue { get; set; }
		...
		/// </summary>
		public PlotOptionsCmoOnPoint OnPoint { get; set; }
		private PlotOptionsCmoOnPoint OnPoint_DefaultValue { get; set; }
		...
		/// 
		/// </summary>
		public PlotOptionsCmoParams Params { get; set; }
		private PlotOptionsCmoParams Params_DefaultValue { get; set; }
		 

		/// <summary>
		/// Properties for each single point.
		/// </summary>
		public PlotOptionsCmoPoint Point { get; set; }
		private PlotOptionsCmoPoint Point_DefaultValue { get; set; }
		...
		/// </summary>
		public PlotOptionsCmoSonification Sonification { get; set; }
		private PlotOptionsCmoSonification Sonification_DefaultValue { get; set; }
		 

		/// <summary>
		/// 
		/// </summary>
		public PlotOptionsCmoStates States { get; set; }
		private PlotOptionsCmoStates States_DefaultValue { get; set; }
		 

		/// <summary>
		/// Whether to apply steps to the line. Possible values are `left`,`center` and `right`.
		/// </summary>
		public PlotOptionsCmoStep Step { get; set; }
		private PlotOptionsCmoStep Step_DefaultValue { get; set; }
		...
		/// </summary>
		public PlotOptionsCmoTooltip Tooltip { get; set; }
		private PlotOptionsCmoTooltip Tooltip_DefaultValue { get; set; }
		...
		/// </summary>
		public List<PlotOptionsCmoZones> Zones { get; set; }
		private List<PlotOptionsCmoZones> Zones_DefaultValue { get; set; }
