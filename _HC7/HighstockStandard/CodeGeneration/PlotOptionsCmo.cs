...
namespace Highsoft.Web.Mvc.Stocks
{
	public partial class PlotOptionsCmo  : BaseObject
	{
		...
		public PlotOptionsCmo()
		{
			...
			Zones = Zones_DefaultValue = new List<PlotOptionsCmoZone>();
		...
		/// </summary>
		public List<PlotOptionsCmoZone> Zones { get; set; }
		private List<PlotOptionsCmoZone> Zones_DefaultValue { get; set; }
