...
{
	public partial class PlotOptionsCmoLastPriceLabel  : BaseObject
	{
		Hashtable h = new Hashtable();

		public PlotOptionsCmoLastPriceLabel()
		{
			Align = Align_DefaultValue = PlotOptionsCmoLastPriceLabelAlign.Null;
		...
		/// 
		/// </summary>
		public PlotOptionsCmoLastPriceLabelAlign Align { get; set; }
		private PlotOptionsCmoLastPriceLabelAlign Align_DefaultValue { get; set; }
