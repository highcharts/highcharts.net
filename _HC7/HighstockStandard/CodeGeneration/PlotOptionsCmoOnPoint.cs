...
namespace Highsoft.Web.Mvc.Stocks
{
	public partial class PlotOptionsCmoOnPoint  : BaseObject
	{
		...
		{
			ConnectorOptions = ConnectorOptions_DefaultValue = new PlotOptionsCmoOnPointConnectorOptions();
			Id = Id_DefaultValue = "";
			Position = Position_DefaultValue = new PlotOptionsCmoOnPointPosition();
		...
		private PlotOptionsCmoOnPointConnectorOptions ConnectorOptions_DefaultValue { get; set; }
		...
		private PlotOptionsCmoOnPointPosition Position_DefaultValue { get; set; }
