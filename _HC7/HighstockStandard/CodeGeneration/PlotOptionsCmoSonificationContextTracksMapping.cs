...
{
	public partial class PlotOptionsCmoSonificationContextTracksMapping  : BaseObject
	{
		Hashtable h = new Hashtable();

		public PlotOptionsCmoSonificationContextTracksMapping()
		{
			Frequency = Frequency_DefaultValue = new PlotOptionsCmoSonificationContextTracksMappingFrequency();
			GapBetweenNotes = GapBetweenNotes_DefaultValue = new PlotOptionsCmoSonificationContextTracksMappingGapBetweenNotes();
			Highpass = Highpass_DefaultValue = new PlotOptionsCmoSonificationContextTracksMappingHighpass();
			Lowpass = Lowpass_DefaultValue = new PlotOptionsCmoSonificationContextTracksMappingLowpass();
			NoteDuration = NoteDuration_DefaultValue = new PlotOptionsCmoSonificationContextTracksMappingNoteDuration();
			Pan = Pan_DefaultValue = new PlotOptionsCmoSonificationContextTracksMappingPan();
			Pitch = Pitch_DefaultValue = new PlotOptionsCmoSonificationContextTracksMappingPitch();
			PitchString = PitchString_DefaultValue = "null";
			PitchNumber = PitchNumber_DefaultValue = null;
			PlayDelay = PlayDelay_DefaultValue = new PlotOptionsCmoSonificationContextTracksMappingPlayDelay();
			Time = Time_DefaultValue = new PlotOptionsCmoSonificationContextTracksMappingTime();
			TimeString = TimeString_DefaultValue = "null";
			TimeNumber = TimeNumber_DefaultValue = null;
			Tremolo = Tremolo_DefaultValue = new PlotOptionsCmoSonificationContextTracksMappingTremolo();
			Volume = Volume_DefaultValue = new PlotOptionsCmoSonificationContextTracksMappingVolume();
		...
		/// </summary>
		public PlotOptionsCmoSonificationContextTracksMappingFrequency Frequency { get; set; }
		private PlotOptionsCmoSonificationContextTracksMappingFrequency Frequency_DefaultValue { get; set; }
		...
		/// </summary>
		public PlotOptionsCmoSonificationContextTracksMappingGapBetweenNotes GapBetweenNotes { get; set; }
		private PlotOptionsCmoSonificationContextTracksMappingGapBetweenNotes GapBetweenNotes_DefaultValue { get; set; }
		...
		/// </summary>
		public PlotOptionsCmoSonificationContextTracksMappingHighpass Highpass { get; set; }
		private PlotOptionsCmoSonificationContextTracksMappingHighpass Highpass_DefaultValue { get; set; }
		...
		/// </summary>
		public PlotOptionsCmoSonificationContextTracksMappingLowpass Lowpass { get; set; }
		private PlotOptionsCmoSonificationContextTracksMappingLowpass Lowpass_DefaultValue { get; set; }
		...
		/// </summary>
		public PlotOptionsCmoSonificationContextTracksMappingNoteDuration NoteDuration { get; set; }
		private PlotOptionsCmoSonificationContextTracksMappingNoteDuration NoteDuration_DefaultValue { get; set; }
		...
		/// </summary>
		public PlotOptionsCmoSonificationContextTracksMappingPan Pan { get; set; }
		private PlotOptionsCmoSonificationContextTracksMappingPan Pan_DefaultValue { get; set; }
		...
		/// </summary>
		public PlotOptionsCmoSonificationContextTracksMappingPitch Pitch { get; set; }
		private PlotOptionsCmoSonificationContextTracksMappingPitch Pitch_DefaultValue { get; set; }
		...
		/// </summary>
		public PlotOptionsCmoSonificationContextTracksMappingPlayDelay PlayDelay { get; set; }
		private PlotOptionsCmoSonificationContextTracksMappingPlayDelay PlayDelay_DefaultValue { get; set; }
		...
		/// </summary>
		public PlotOptionsCmoSonificationContextTracksMappingTime Time { get; set; }
		private PlotOptionsCmoSonificationContextTracksMappingTime Time_DefaultValue { get; set; }
		...
		/// </summary>
		public PlotOptionsCmoSonificationContextTracksMappingTremolo Tremolo { get; set; }
		private PlotOptionsCmoSonificationContextTracksMappingTremolo Tremolo_DefaultValue { get; set; }
		 

		/// <summary>
		/// The volume of notes, from 0 to 1.
		/// </summary>
		public PlotOptionsCmoSonificationContextTracksMappingVolume Volume { get; set; }
		private PlotOptionsCmoSonificationContextTracksMappingVolume Volume_DefaultValue { get; set; }
