...
{
	public partial class PlotOptionsCmoSonificationContextTracksMappingPitch  : BaseObject
	{
		Hashtable h = new Hashtable();

		public PlotOptionsCmoSonificationContextTracksMappingPitch()
		{
			MapFunction = MapFunction_DefaultValue = PlotOptionsCmoSonificationContextTracksMappingPitchMapFunction.Linear;
		...
		/// </summary>
		public PlotOptionsCmoSonificationContextTracksMappingPitchMapFunction MapFunction { get; set; }
		private PlotOptionsCmoSonificationContextTracksMappingPitchMapFunction MapFunction_DefaultValue { get; set; }
