...
{
	public partial class PlotOptionsCmoSonificationContextTracksMappingVolume  : BaseObject
	{
		Hashtable h = new Hashtable();

		public PlotOptionsCmoSonificationContextTracksMappingVolume()
		{
			MapFunction = MapFunction_DefaultValue = PlotOptionsCmoSonificationContextTracksMappingVolumeMapFunction.Linear;
			MapTo = MapTo_DefaultValue = "";
			Max = Max_DefaultValue = null;
			Min = Min_DefaultValue = null;
			Value = Value_DefaultValue = null;
			Within = Within_DefaultValue = PlotOptionsCmoSonificationContextTracksMappingVolumeWithin.Chart;
		...
		/// </summary>
		public PlotOptionsCmoSonificationContextTracksMappingVolumeMapFunction MapFunction { get; set; }
		private PlotOptionsCmoSonificationContextTracksMappingVolumeMapFunction MapFunction_DefaultValue { get; set; }
		...
		/// </summary>
		public PlotOptionsCmoSonificationContextTracksMappingVolumeWithin Within { get; set; }
		private PlotOptionsCmoSonificationContextTracksMappingVolumeWithin Within_DefaultValue { get; set; }
