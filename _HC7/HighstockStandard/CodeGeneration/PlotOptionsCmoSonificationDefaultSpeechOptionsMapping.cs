...
{
	public partial class PlotOptionsCmoSonificationDefaultSpeechOptionsMapping  : BaseObject
	{
		Hashtable h = new Hashtable();

		public PlotOptionsCmoSonificationDefaultSpeechOptionsMapping()
		{
			Frequency = Frequency_DefaultValue = new PlotOptionsCmoSonificationDefaultSpeechOptionsMappingFrequency();
			GapBetweenNotes = GapBetweenNotes_DefaultValue = new PlotOptionsCmoSonificationDefaultSpeechOptionsMappingGapBetweenNotes();
			Highpass = Highpass_DefaultValue = new PlotOptionsCmoSonificationDefaultSpeechOptionsMappingHighpass();
			Lowpass = Lowpass_DefaultValue = new PlotOptionsCmoSonificationDefaultSpeechOptionsMappingLowpass();
			NoteDuration = NoteDuration_DefaultValue = new PlotOptionsCmoSonificationDefaultSpeechOptionsMappingNoteDuration();
			Pan = Pan_DefaultValue = new PlotOptionsCmoSonificationDefaultSpeechOptionsMappingPan();
			Pitch = Pitch_DefaultValue = new PlotOptionsCmoSonificationDefaultSpeechOptionsMappingPitch();
			PitchString = PitchString_DefaultValue = "null";
			PitchNumber = PitchNumber_DefaultValue = null;
			PlayDelay = PlayDelay_DefaultValue = new PlotOptionsCmoSonificationDefaultSpeechOptionsMappingPlayDelay();
			Time = Time_DefaultValue = new PlotOptionsCmoSonificationDefaultSpeechOptionsMappingTime();
			TimeString = TimeString_DefaultValue = "null";
			TimeNumber = TimeNumber_DefaultValue = null;
			Tremolo = Tremolo_DefaultValue = new PlotOptionsCmoSonificationDefaultSpeechOptionsMappingTremolo();
			Volume = Volume_DefaultValue = new PlotOptionsCmoSonificationDefaultSpeechOptionsMappingVolume();
		...
		/// </summary>
		public PlotOptionsCmoSonificationDefaultSpeechOptionsMappingFrequency Frequency { get; set; }
		private PlotOptionsCmoSonificationDefaultSpeechOptionsMappingFrequency Frequency_DefaultValue { get; set; }
		...
		/// </summary>
		public PlotOptionsCmoSonificationDefaultSpeechOptionsMappingGapBetweenNotes GapBetweenNotes { get; set; }
		private PlotOptionsCmoSonificationDefaultSpeechOptionsMappingGapBetweenNotes GapBetweenNotes_DefaultValue { get; set; }
		...
		/// </summary>
		public PlotOptionsCmoSonificationDefaultSpeechOptionsMappingHighpass Highpass { get; set; }
		private PlotOptionsCmoSonificationDefaultSpeechOptionsMappingHighpass Highpass_DefaultValue { get; set; }
		...
		/// </summary>
		public PlotOptionsCmoSonificationDefaultSpeechOptionsMappingLowpass Lowpass { get; set; }
		private PlotOptionsCmoSonificationDefaultSpeechOptionsMappingLowpass Lowpass_DefaultValue { get; set; }
		...
		/// </summary>
		public PlotOptionsCmoSonificationDefaultSpeechOptionsMappingNoteDuration NoteDuration { get; set; }
		private PlotOptionsCmoSonificationDefaultSpeechOptionsMappingNoteDuration NoteDuration_DefaultValue { get; set; }
		...
		/// </summary>
		public PlotOptionsCmoSonificationDefaultSpeechOptionsMappingPan Pan { get; set; }
		private PlotOptionsCmoSonificationDefaultSpeechOptionsMappingPan Pan_DefaultValue { get; set; }
		...
		/// </summary>
		public PlotOptionsCmoSonificationDefaultSpeechOptionsMappingPitch Pitch { get; set; }
		private PlotOptionsCmoSonificationDefaultSpeechOptionsMappingPitch Pitch_DefaultValue { get; set; }
		...
		/// </summary>
		public PlotOptionsCmoSonificationDefaultSpeechOptionsMappingPlayDelay PlayDelay { get; set; }
		private PlotOptionsCmoSonificationDefaultSpeechOptionsMappingPlayDelay PlayDelay_DefaultValue { get; set; }
		...
		/// </summary>
		public PlotOptionsCmoSonificationDefaultSpeechOptionsMappingTime Time { get; set; }
		private PlotOptionsCmoSonificationDefaultSpeechOptionsMappingTime Time_DefaultValue { get; set; }
		...
		/// </summary>
		public PlotOptionsCmoSonificationDefaultSpeechOptionsMappingTremolo Tremolo { get; set; }
		private PlotOptionsCmoSonificationDefaultSpeechOptionsMappingTremolo Tremolo_DefaultValue { get; set; }
		 

		/// <summary>
		/// The volume of notes, from 0 to 1.
		/// </summary>
		public PlotOptionsCmoSonificationDefaultSpeechOptionsMappingVolume Volume { get; set; }
		private PlotOptionsCmoSonificationDefaultSpeechOptionsMappingVolume Volume_DefaultValue { get; set; }
