...
{
	public partial class PlotOptionsCmoSonificationTracks  : BaseObject
	{
		Hashtable h = new Hashtable();

		public PlotOptionsCmoSonificationTracks()
		{
			ActiveWhen = ActiveWhen_DefaultValue = new PlotOptionsCmoSonificationTracksActiveWhen();
			Instrument = Instrument_DefaultValue = null;
			InstrumentString = InstrumentString_DefaultValue = "null";
			Mapping = Mapping_DefaultValue = new PlotOptionsCmoSonificationTracksMapping();
			MidiName = MidiName_DefaultValue = "";
			PointGrouping = PointGrouping_DefaultValue = new PlotOptionsCmoSonificationTracksPointGrouping();
			RoundToMusicalNotes = RoundToMusicalNotes_DefaultValue = true;
			ShowPlayMarker = ShowPlayMarker_DefaultValue = true;
			Type = Type_DefaultValue = PlotOptionsCmoSonificationTracksType.Instrument;
		...
		/// </summary>
		public PlotOptionsCmoSonificationTracksActiveWhen ActiveWhen { get; set; }
		private PlotOptionsCmoSonificationTracksActiveWhen ActiveWhen_DefaultValue { get; set; }
		...
		/// </summary>
		public PlotOptionsCmoSonificationTracksMapping Mapping { get; set; }
		private PlotOptionsCmoSonificationTracksMapping Mapping_DefaultValue { get; set; }
		...
		/// </summary>
		public PlotOptionsCmoSonificationTracksPointGrouping PointGrouping { get; set; }
		private PlotOptionsCmoSonificationTracksPointGrouping PointGrouping_DefaultValue { get; set; }
		...
		/// </summary>
		public PlotOptionsCmoSonificationTracksType Type { get; set; }
		private PlotOptionsCmoSonificationTracksType Type_DefaultValue { get; set; }
