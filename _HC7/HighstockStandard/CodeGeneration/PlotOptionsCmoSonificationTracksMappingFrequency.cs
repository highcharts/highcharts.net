...
{
	public partial class PlotOptionsCmoSonificationTracksMappingFrequency  : BaseObject
	{
		Hashtable h = new Hashtable();

		public PlotOptionsCmoSonificationTracksMappingFrequency()
		{
			MapFunction = MapFunction_DefaultValue = PlotOptionsCmoSonificationTracksMappingFrequencyMapFunction.Linear;
			MapTo = MapTo_DefaultValue = "";
			Max = Max_DefaultValue = null;
			Min = Min_DefaultValue = null;
			Value = Value_DefaultValue = null;
			Within = Within_DefaultValue = PlotOptionsCmoSonificationTracksMappingFrequencyWithin.Chart;
		...
		/// </summary>
		public PlotOptionsCmoSonificationTracksMappingFrequencyMapFunction MapFunction { get; set; }
		private PlotOptionsCmoSonificationTracksMappingFrequencyMapFunction MapFunction_DefaultValue { get; set; }
		...
		/// </summary>
		public PlotOptionsCmoSonificationTracksMappingFrequencyWithin Within { get; set; }
		private PlotOptionsCmoSonificationTracksMappingFrequencyWithin Within_DefaultValue { get; set; }
