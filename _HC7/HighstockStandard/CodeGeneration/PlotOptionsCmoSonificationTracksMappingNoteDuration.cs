...
{
	public partial class PlotOptionsCmoSonificationTracksMappingNoteDuration  : BaseObject
	{
		Hashtable h = new Hashtable();

		public PlotOptionsCmoSonificationTracksMappingNoteDuration()
		{
			MapFunction = MapFunction_DefaultValue = PlotOptionsCmoSonificationTracksMappingNoteDurationMapFunction.Linear;
			MapTo = MapTo_DefaultValue = "";
			Max = Max_DefaultValue = null;
			Min = Min_DefaultValue = null;
			Value = Value_DefaultValue = null;
			Within = Within_DefaultValue = PlotOptionsCmoSonificationTracksMappingNoteDurationWithin.Chart;
		...
		/// </summary>
		public PlotOptionsCmoSonificationTracksMappingNoteDurationMapFunction MapFunction { get; set; }
		private PlotOptionsCmoSonificationTracksMappingNoteDurationMapFunction MapFunction_DefaultValue { get; set; }
		...
		/// </summary>
		public PlotOptionsCmoSonificationTracksMappingNoteDurationWithin Within { get; set; }
		private PlotOptionsCmoSonificationTracksMappingNoteDurationWithin Within_DefaultValue { get; set; }
