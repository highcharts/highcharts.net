...
{
	public partial class PlotOptionsCmoSonificationTracksMappingPan  : BaseObject
	{
		Hashtable h = new Hashtable();

		public PlotOptionsCmoSonificationTracksMappingPan()
		{
			MapFunction = MapFunction_DefaultValue = PlotOptionsCmoSonificationTracksMappingPanMapFunction.Linear;
			MapTo = MapTo_DefaultValue = "";
			Max = Max_DefaultValue = null;
			Min = Min_DefaultValue = null;
			Value = Value_DefaultValue = null;
			Within = Within_DefaultValue = PlotOptionsCmoSonificationTracksMappingPanWithin.Chart;
		...
		/// </summary>
		public PlotOptionsCmoSonificationTracksMappingPanMapFunction MapFunction { get; set; }
		private PlotOptionsCmoSonificationTracksMappingPanMapFunction MapFunction_DefaultValue { get; set; }
		...
		/// </summary>
		public PlotOptionsCmoSonificationTracksMappingPanWithin Within { get; set; }
		private PlotOptionsCmoSonificationTracksMappingPanWithin Within_DefaultValue { get; set; }
