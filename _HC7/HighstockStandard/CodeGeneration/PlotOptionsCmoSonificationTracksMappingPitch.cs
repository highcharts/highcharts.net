...
{
	public partial class PlotOptionsCmoSonificationTracksMappingPitch  : BaseObject
	{
		Hashtable h = new Hashtable();

		public PlotOptionsCmoSonificationTracksMappingPitch()
		{
			MapFunction = MapFunction_DefaultValue = PlotOptionsCmoSonificationTracksMappingPitchMapFunction.Linear;
		...
		/// </summary>
		public PlotOptionsCmoSonificationTracksMappingPitchMapFunction MapFunction { get; set; }
		private PlotOptionsCmoSonificationTracksMappingPitchMapFunction MapFunction_DefaultValue { get; set; }
