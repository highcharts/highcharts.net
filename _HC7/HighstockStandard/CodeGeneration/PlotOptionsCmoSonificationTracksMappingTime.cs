...
{
	public partial class PlotOptionsCmoSonificationTracksMappingTime  : BaseObject
	{
		Hashtable h = new Hashtable();

		public PlotOptionsCmoSonificationTracksMappingTime()
		{
			MapFunction = MapFunction_DefaultValue = PlotOptionsCmoSonificationTracksMappingTimeMapFunction.Linear;
			MapTo = MapTo_DefaultValue = "";
			Max = Max_DefaultValue = null;
			Min = Min_DefaultValue = null;
			Value = Value_DefaultValue = null;
			Within = Within_DefaultValue = PlotOptionsCmoSonificationTracksMappingTimeWithin.Chart;
		...
		/// </summary>
		public PlotOptionsCmoSonificationTracksMappingTimeMapFunction MapFunction { get; set; }
		private PlotOptionsCmoSonificationTracksMappingTimeMapFunction MapFunction_DefaultValue { get; set; }
		...
		/// </summary>
		public PlotOptionsCmoSonificationTracksMappingTimeWithin Within { get; set; }
		private PlotOptionsCmoSonificationTracksMappingTimeWithin Within_DefaultValue { get; set; }
