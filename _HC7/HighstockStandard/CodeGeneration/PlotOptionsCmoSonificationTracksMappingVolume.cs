...
{
	public partial class PlotOptionsCmoSonificationTracksMappingVolume  : BaseObject
	{
		Hashtable h = new Hashtable();

		public PlotOptionsCmoSonificationTracksMappingVolume()
		{
			MapFunction = MapFunction_DefaultValue = PlotOptionsCmoSonificationTracksMappingVolumeMapFunction.Linear;
			MapTo = MapTo_DefaultValue = "";
			Max = Max_DefaultValue = null;
			Min = Min_DefaultValue = null;
			Value = Value_DefaultValue = null;
			Within = Within_DefaultValue = PlotOptionsCmoSonificationTracksMappingVolumeWithin.Chart;
		...
		/// </summary>
		public PlotOptionsCmoSonificationTracksMappingVolumeMapFunction MapFunction { get; set; }
		private PlotOptionsCmoSonificationTracksMappingVolumeMapFunction MapFunction_DefaultValue { get; set; }
		...
		/// </summary>
		public PlotOptionsCmoSonificationTracksMappingVolumeWithin Within { get; set; }
		private PlotOptionsCmoSonificationTracksMappingVolumeWithin Within_DefaultValue { get; set; }
