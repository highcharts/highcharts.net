...
{
	public partial class PlotOptionsCmoSonificationTracksPointGrouping  : BaseObject
	{
		Hashtable h = new Hashtable();

		public PlotOptionsCmoSonificationTracksPointGrouping()
		{
			Algorithm = Algorithm_DefaultValue = PlotOptionsCmoSonificationTracksPointGroupingAlgorithm.Minimax;
		...
		/// </summary>
		public PlotOptionsCmoSonificationTracksPointGroupingAlgorithm Algorithm { get; set; }
		private PlotOptionsCmoSonificationTracksPointGroupingAlgorithm Algorithm_DefaultValue { get; set; }
