...
{
	public partial class PlotOptionsCmoStatesHover  : BaseObject
	{
		Hashtable h = new Hashtable();

		public PlotOptionsCmoStatesHover()
		{
			Animation = Animation_DefaultValue = new Animation() { Enabled = true };
			Enabled = Enabled_DefaultValue = null;
			Halo = Halo_DefaultValue = new PlotOptionsCmoStatesHoverHalo();
			LineWidth = LineWidth_DefaultValue = null;
			LineWidthPlus = LineWidthPlus_DefaultValue = null;
			Marker = Marker_DefaultValue = new PlotOptionsCmoStatesHoverMarker();
		...
		/// </summary>
		public PlotOptionsCmoStatesHoverHalo Halo { get; set; }
		private PlotOptionsCmoStatesHoverHalo Halo_DefaultValue { get; set; }
		...
		/// </summary>
		public PlotOptionsCmoStatesHoverMarker Marker { get; set; }
		private PlotOptionsCmoStatesHoverMarker Marker_DefaultValue { get; set; }
