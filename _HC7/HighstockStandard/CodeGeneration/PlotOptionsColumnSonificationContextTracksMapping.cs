...
{
	public partial class PlotOptionsColumnSonificationContextTracksMapping  : BaseObject
	{
		Hashtable h = new Hashtable();

		public PlotOptionsColumnSonificationContextTracksMapping()
		{
			Frequency = Frequency_DefaultValue = new PlotOptionsColumnSonificationContextTracksMappingFrequency();
			GapBetweenNotes = GapBetweenNotes_DefaultValue = new PlotOptionsColumnSonificationContextTracksMappingGapBetweenNotes();
			Highpass = Highpass_DefaultValue = new PlotOptionsColumnSonificationContextTracksMappingHighpass();
			Lowpass = Lowpass_DefaultValue = new PlotOptionsColumnSonificationContextTracksMappingLowpass();
			NoteDuration = NoteDuration_DefaultValue = new PlotOptionsColumnSonificationContextTracksMappingNoteDuration();
			Pan = Pan_DefaultValue = new PlotOptionsColumnSonificationContextTracksMappingPan();
			Pitch = Pitch_DefaultValue = new PlotOptionsColumnSonificationContextTracksMappingPitch();
			PitchString = PitchString_DefaultValue = "null";
			PitchNumber = PitchNumber_DefaultValue = null;
			PlayDelay = PlayDelay_DefaultValue = new PlotOptionsColumnSonificationContextTracksMappingPlayDelay();
			Time = Time_DefaultValue = new PlotOptionsColumnSonificationContextTracksMappingTime();
			TimeString = TimeString_DefaultValue = "null";
			TimeNumber = TimeNumber_DefaultValue = null;
			Tremolo = Tremolo_DefaultValue = new PlotOptionsColumnSonificationContextTracksMappingTremolo();
			Volume = Volume_DefaultValue = new PlotOptionsColumnSonificationContextTracksMappingVolume();
		...
		/// </summary>
		public PlotOptionsColumnSonificationContextTracksMappingFrequency Frequency { get; set; }
		private PlotOptionsColumnSonificationContextTracksMappingFrequency Frequency_DefaultValue { get; set; }
		...
		/// </summary>
		public PlotOptionsColumnSonificationContextTracksMappingGapBetweenNotes GapBetweenNotes { get; set; }
		private PlotOptionsColumnSonificationContextTracksMappingGapBetweenNotes GapBetweenNotes_DefaultValue { get; set; }
		...
		/// </summary>
		public PlotOptionsColumnSonificationContextTracksMappingHighpass Highpass { get; set; }
		private PlotOptionsColumnSonificationContextTracksMappingHighpass Highpass_DefaultValue { get; set; }
		...
		/// </summary>
		public PlotOptionsColumnSonificationContextTracksMappingLowpass Lowpass { get; set; }
		private PlotOptionsColumnSonificationContextTracksMappingLowpass Lowpass_DefaultValue { get; set; }
		...
		/// </summary>
		public PlotOptionsColumnSonificationContextTracksMappingNoteDuration NoteDuration { get; set; }
		private PlotOptionsColumnSonificationContextTracksMappingNoteDuration NoteDuration_DefaultValue { get; set; }
		...
		/// </summary>
		public PlotOptionsColumnSonificationContextTracksMappingPan Pan { get; set; }
		private PlotOptionsColumnSonificationContextTracksMappingPan Pan_DefaultValue { get; set; }
		...
		/// </summary>
		public PlotOptionsColumnSonificationContextTracksMappingPitch Pitch { get; set; }
		private PlotOptionsColumnSonificationContextTracksMappingPitch Pitch_DefaultValue { get; set; }
		...
		/// </summary>
		public PlotOptionsColumnSonificationContextTracksMappingPlayDelay PlayDelay { get; set; }
		private PlotOptionsColumnSonificationContextTracksMappingPlayDelay PlayDelay_DefaultValue { get; set; }
		...
		/// </summary>
		public PlotOptionsColumnSonificationContextTracksMappingTime Time { get; set; }
		private PlotOptionsColumnSonificationContextTracksMappingTime Time_DefaultValue { get; set; }
		...
		/// </summary>
		public PlotOptionsColumnSonificationContextTracksMappingTremolo Tremolo { get; set; }
		private PlotOptionsColumnSonificationContextTracksMappingTremolo Tremolo_DefaultValue { get; set; }
		 

		/// <summary>
		/// The volume of notes, from 0 to 1.
		/// </summary>
		public PlotOptionsColumnSonificationContextTracksMappingVolume Volume { get; set; }
		private PlotOptionsColumnSonificationContextTracksMappingVolume Volume_DefaultValue { get; set; }
