...
{
	public partial class PlotOptionsColumnSonificationTracks  : BaseObject
	{
		Hashtable h = new Hashtable();

		public PlotOptionsColumnSonificationTracks()
		{
			ActiveWhen = ActiveWhen_DefaultValue = new PlotOptionsColumnSonificationTracksActiveWhen();
			Instrument = Instrument_DefaultValue = null;
			InstrumentString = InstrumentString_DefaultValue = "null";
			Mapping = Mapping_DefaultValue = new PlotOptionsColumnSonificationTracksMapping();
			MidiName = MidiName_DefaultValue = "";
			PointGrouping = PointGrouping_DefaultValue = new PlotOptionsColumnSonificationTracksPointGrouping();
			RoundToMusicalNotes = RoundToMusicalNotes_DefaultValue = true;
			ShowPlayMarker = ShowPlayMarker_DefaultValue = true;
			Type = Type_DefaultValue = PlotOptionsColumnSonificationTracksType.Instrument;
		...
		/// </summary>
		public PlotOptionsColumnSonificationTracksActiveWhen ActiveWhen { get; set; }
		private PlotOptionsColumnSonificationTracksActiveWhen ActiveWhen_DefaultValue { get; set; }
		...
		/// </summary>
		public PlotOptionsColumnSonificationTracksMapping Mapping { get; set; }
		private PlotOptionsColumnSonificationTracksMapping Mapping_DefaultValue { get; set; }
		...
		/// </summary>
		public PlotOptionsColumnSonificationTracksPointGrouping PointGrouping { get; set; }
		private PlotOptionsColumnSonificationTracksPointGrouping PointGrouping_DefaultValue { get; set; }
		...
		/// </summary>
		public PlotOptionsColumnSonificationTracksType Type { get; set; }
		private PlotOptionsColumnSonificationTracksType Type_DefaultValue { get; set; }
