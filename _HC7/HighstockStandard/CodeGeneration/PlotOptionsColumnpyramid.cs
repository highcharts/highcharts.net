...
{
	public partial class PlotOptionsColumnpyramid  : BaseObject
	{
		Hashtable h = new Hashtable();

		public PlotOptionsColumnpyramid()
		{
			Accessibility = Accessibility_DefaultValue = new PlotOptionsColumnpyramidAccessibility();
			...
			Compare = Compare_DefaultValue = PlotOptionsColumnpyramidCompare.Percent;
			...
			DataGrouping = DataGrouping_DefaultValue = new PlotOptionsColumnpyramidDataGrouping();
			DataLabels = DataLabels_DefaultValue = new PlotOptionsColumnpyramidDataLabels();
			DataSorting = DataSorting_DefaultValue = new PlotOptionsColumnpyramidDataSorting();
			Description = Description_DefaultValue = "";
			DragDrop = DragDrop_DefaultValue = new PlotOptionsColumnpyramidDragDrop();
			EnableMouseTracking = EnableMouseTracking_DefaultValue = true;
			Events = Events_DefaultValue = new PlotOptionsColumnpyramidEvents();
			FindNearestPointBy = FindNearestPointBy_DefaultValue = PlotOptionsColumnpyramidFindNearestPointBy.X;
			GetExtremesFromAll = GetExtremesFromAll_DefaultValue = false;
			Grouping = Grouping_DefaultValue = true;
			GroupPadding = GroupPadding_DefaultValue = null;
			IncludeInDataExport = IncludeInDataExport_DefaultValue = null;
			Keys = Keys_DefaultValue = new List<string>();
			Label = Label_DefaultValue = new PlotOptionsColumnpyramidLabel();
			LastPrice = LastPrice_DefaultValue = new PlotOptionsColumnpyramidLastPrice();
			LastVisiblePrice = LastVisiblePrice_DefaultValue = new PlotOptionsColumnpyramidLastVisiblePrice();
			LegendSymbol = LegendSymbol_DefaultValue = PlotOptionsColumnpyramidLegendSymbol.Rectangle;
			LinkedTo = LinkedTo_DefaultValue = "";
			MaxPointWidth = MaxPointWidth_DefaultValue = null;
			MinPointLength = MinPointLength_DefaultValue = 0;
			OnPoint = OnPoint_DefaultValue = new PlotOptionsColumnpyramidOnPoint();
			Opacity = Opacity_DefaultValue = 1;
			Point = Point_DefaultValue = new PlotOptionsColumnpyramidPoint();
			PointDescriptionFormat = PointDescriptionFormat_DefaultValue = "";
			PointDescriptionFormatter = PointDescriptionFormatter_DefaultValue = "";
			PointInterval = PointInterval_DefaultValue = 1;
			PointIntervalUnit = PointIntervalUnit_DefaultValue = PlotOptionsColumnpyramidPointIntervalUnit.Null;
			...
			Sonification = Sonification_DefaultValue = new PlotOptionsColumnpyramidSonification();
			Stacking = Stacking_DefaultValue = PlotOptionsColumnpyramidStacking.Null;
			States = States_DefaultValue = new PlotOptionsColumnpyramidStates();
			StickyTracking = StickyTracking_DefaultValue = true;
			Tooltip = Tooltip_DefaultValue = new PlotOptionsColumnpyramidTooltip();
		...
		/// </summary>
		public PlotOptionsColumnpyramidAccessibility Accessibility { get; set; }
		private PlotOptionsColumnpyramidAccessibility Accessibility_DefaultValue { get; set; }
		...
		/// </summary>
		public PlotOptionsColumnpyramidCompare Compare { get; set; }
		private PlotOptionsColumnpyramidCompare Compare_DefaultValue { get; set; }
		 

		/// <summary>
		/// When [compare](#plotOptions.series.compare) is `percent`, this optiondictates whether to use 0 or 100 as the base of comparison.
		/// </summary>
		public PlotOptionsColumnpyramidCompareBase CompareBase { get; set; }
		private PlotOptionsColumnpyramidCompareBase CompareBase_DefaultValue { get; set; }
		...
		/// </summary>
		public PlotOptionsColumnpyramidCursor Cursor { get; set; }
		private PlotOptionsColumnpyramidCursor Cursor_DefaultValue { get; set; }
		...
		/// </summary>
		public PlotOptionsColumnpyramidDashStyle DashStyle { get; set; }
		private PlotOptionsColumnpyramidDashStyle DashStyle_DefaultValue { get; set; }
		...
		/// </summary>
		public PlotOptionsColumnpyramidDataGrouping DataGrouping { get; set; }
		private PlotOptionsColumnpyramidDataGrouping DataGrouping_DefaultValue { get; set; }
		...
		/// </summary>
		public PlotOptionsColumnpyramidDataLabels DataLabels { get; set; }
		private PlotOptionsColumnpyramidDataLabels DataLabels_DefaultValue { get; set; }
		 

		/// <summary>
		/// Options for the series data sorting.
		/// </summary>
		public PlotOptionsColumnpyramidDataSorting DataSorting { get; set; }
		private PlotOptionsColumnpyramidDataSorting DataSorting_DefaultValue { get; set; }
		...
		/// </summary>
		public PlotOptionsColumnpyramidDragDrop DragDrop { get; set; }
		private PlotOptionsColumnpyramidDragDrop DragDrop_DefaultValue { get; set; }
		...
		/// </summary>
		public PlotOptionsColumnpyramidEvents Events { get; set; }
		private PlotOptionsColumnpyramidEvents Events_DefaultValue { get; set; }
		...
		/// </summary>
		public PlotOptionsColumnpyramidFindNearestPointBy FindNearestPointBy { get; set; }
		private PlotOptionsColumnpyramidFindNearestPointBy FindNearestPointBy_DefaultValue { get; set; }
		...
		/// </summary>
		public PlotOptionsColumnpyramidLabel Label { get; set; }
		private PlotOptionsColumnpyramidLabel Label_DefaultValue { get; set; }
		 

		/// <summary>
		/// The line marks the last price from all points.
		/// </summary>
		public PlotOptionsColumnpyramidLastPrice LastPrice { get; set; }
		private PlotOptionsColumnpyramidLastPrice LastPrice_DefaultValue { get; set; }
		 

		/// <summary>
		/// The line marks the last price from visible range of points.
		/// </summary>
		public PlotOptionsColumnpyramidLastVisiblePrice LastVisiblePrice { get; set; }
		private PlotOptionsColumnpyramidLastVisiblePrice LastVisiblePrice_DefaultValue { get; set; }
		 

		/// <summary>
		/// What type of legend symbol to render for this series. Can be one of`lineMarker` or `rectangle`.
		/// </summary>
		public PlotOptionsColumnpyramidLegendSymbol LegendSymbol { get; set; }
		private PlotOptionsColumnpyramidLegendSymbol LegendSymbol_DefaultValue { get; set; }
		...
		/// </summary>
		public PlotOptionsColumnpyramidOnPoint OnPoint { get; set; }
		private PlotOptionsColumnpyramidOnPoint OnPoint_DefaultValue { get; set; }
		...
		/// </summary>
		public PlotOptionsColumnpyramidPoint Point { get; set; }
		private PlotOptionsColumnpyramidPoint Point_DefaultValue { get; set; }
		...
		/// </summary>
		public PlotOptionsColumnpyramidPointIntervalUnit PointIntervalUnit { get; set; }
		private PlotOptionsColumnpyramidPointIntervalUnit PointIntervalUnit_DefaultValue { get; set; }
		...
		/// </summary>
		public PlotOptionsColumnpyramidSonification Sonification { get; set; }
		private PlotOptionsColumnpyramidSonification Sonification_DefaultValue { get; set; }
		...
		/// </summary>
		public PlotOptionsColumnpyramidStacking Stacking { get; set; }
		private PlotOptionsColumnpyramidStacking Stacking_DefaultValue { get; set; }
		 

		/// <summary>
		/// 
		/// </summary>
		public PlotOptionsColumnpyramidStates States { get; set; }
		private PlotOptionsColumnpyramidStates States_DefaultValue { get; set; }
		...
		/// </summary>
		public PlotOptionsColumnpyramidTooltip Tooltip { get; set; }
		private PlotOptionsColumnpyramidTooltip Tooltip_DefaultValue { get; set; }
