...
{
	public partial class PlotOptionsColumnpyramidDragDrop  : BaseObject
	{
		public PlotOptionsColumnpyramidDragDrop()
		{
			DraggableX = DraggableX_DefaultValue = null;
			DraggableY = DraggableY_DefaultValue = null;
			DragHandle = DragHandle_DefaultValue = new PlotOptionsColumnpyramidDragDropDragHandle();
			...
			GuideBox = GuideBox_DefaultValue = new PlotOptionsColumnpyramidDragDropGuideBox();
		...
		/// </summary>
		public PlotOptionsColumnpyramidDragDropDragHandle DragHandle { get; set; }
		private PlotOptionsColumnpyramidDragDropDragHandle DragHandle_DefaultValue { get; set; }
		...
		/// </summary>
		public PlotOptionsColumnpyramidDragDropGuideBox GuideBox { get; set; }
		private PlotOptionsColumnpyramidDragDropGuideBox GuideBox_DefaultValue { get; set; }
