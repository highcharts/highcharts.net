...
{
	public partial class PlotOptionsColumnpyramidSonificationContextTracksActiveWhen  : BaseObject
	{
		Hashtable h = new Hashtable();

		public PlotOptionsColumnpyramidSonificationContextTracksActiveWhen()
		{
		}	
