...
{
	public partial class PlotOptionsColumnpyramidSonificationDefaultSpeechOptions  : BaseObject
	{
		Hashtable h = new Hashtable();

		public PlotOptionsColumnpyramidSonificationDefaultSpeechOptions()
		{
			ActiveWhen = ActiveWhen_DefaultValue = new PlotOptionsColumnpyramidSonificationDefaultSpeechOptionsActiveWhen();
			Language = Language_DefaultValue = "en-US";
			Mapping = Mapping_DefaultValue = new PlotOptionsColumnpyramidSonificationDefaultSpeechOptionsMapping();
			PointGrouping = PointGrouping_DefaultValue = new PlotOptionsColumnpyramidSonificationDefaultSpeechOptionsPointGrouping();
			PreferredVoice = PreferredVoice_DefaultValue = "";
			ShowPlayMarker = ShowPlayMarker_DefaultValue = true;
			Type = Type_DefaultValue = PlotOptionsColumnpyramidSonificationDefaultSpeechOptionsType.Instrument;
		...
		/// </summary>
		public PlotOptionsColumnpyramidSonificationDefaultSpeechOptionsActiveWhen ActiveWhen { get; set; }
		private PlotOptionsColumnpyramidSonificationDefaultSpeechOptionsActiveWhen ActiveWhen_DefaultValue { get; set; }
		...
		/// </summary>
		public PlotOptionsColumnpyramidSonificationDefaultSpeechOptionsMapping Mapping { get; set; }
		private PlotOptionsColumnpyramidSonificationDefaultSpeechOptionsMapping Mapping_DefaultValue { get; set; }
		 

		/// <summary>
		/// Options for point grouping, specifically for instrument tracks.
		/// </summary>
		public PlotOptionsColumnpyramidSonificationDefaultSpeechOptionsPointGrouping PointGrouping { get; set; }
		private PlotOptionsColumnpyramidSonificationDefaultSpeechOptionsPointGrouping PointGrouping_DefaultValue { get; set; }
		...
		/// </summary>
		public PlotOptionsColumnpyramidSonificationDefaultSpeechOptionsType Type { get; set; }
		private PlotOptionsColumnpyramidSonificationDefaultSpeechOptionsType Type_DefaultValue { get; set; }
