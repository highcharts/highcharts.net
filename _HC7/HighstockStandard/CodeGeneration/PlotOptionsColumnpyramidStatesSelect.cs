...
namespace Highsoft.Web.Mvc.Stocks
{
	...
	{
		public PlotOptionsColumnpyramidStatesSelect()
		{
			Animation = Animation_DefaultValue = new Animation() { Enabled = true };
			Enabled = Enabled_DefaultValue = true;
			Halo = Halo_DefaultValue = new PlotOptionsColumnpyramidStatesSelectHalo();
			LineWidth = LineWidth_DefaultValue = null;
			LineWidthPlus = LineWidthPlus_DefaultValue = 1;
			Marker = Marker_DefaultValue = new PlotOptionsColumnpyramidStatesSelectMarker();
		...
		/// </summary>
		public PlotOptionsColumnpyramidStatesSelectHalo Halo { get; set; }
		private PlotOptionsColumnpyramidStatesSelectHalo Halo_DefaultValue { get; set; }
		...
		/// </summary>
		public PlotOptionsColumnpyramidStatesSelectMarker Marker { get; set; }
		private PlotOptionsColumnpyramidStatesSelectMarker Marker_DefaultValue { get; set; }
