...
{
	public partial class PlotOptionsColumnrangeDragDrop  : BaseObject
	{
		...
		/// </summary>
		public PlotOptionsColumnrangeDragDropDragHandle DragHandle { get; set; }
		private PlotOptionsColumnrangeDragDropDragHandle DragHandle_DefaultValue { get; set; }
		...
		/// </summary>
		public PlotOptionsColumnrangeDragDropGuideBox GuideBox { get; set; }
		private PlotOptionsColumnrangeDragDropGuideBox GuideBox_DefaultValue { get; set; }
