...
{
	public partial class PlotOptionsColumnrangeSonificationContextTracksActiveWhen  : BaseObject
	{
		Hashtable h = new Hashtable();

		public PlotOptionsColumnrangeSonificationContextTracksActiveWhen()
		{
		}	
