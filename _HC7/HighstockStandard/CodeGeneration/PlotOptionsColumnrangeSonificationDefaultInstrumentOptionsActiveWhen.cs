...
{
	public partial class PlotOptionsColumnrangeSonificationDefaultInstrumentOptionsActiveWhen  : BaseObject
	{
		Hashtable h = new Hashtable();

		public PlotOptionsColumnrangeSonificationDefaultInstrumentOptionsActiveWhen()
		{
