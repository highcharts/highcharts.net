...
{
	public partial class PlotOptionsColumnrangeSonificationTracksMapping  : BaseObject
	{
		Hashtable h = new Hashtable();

		public PlotOptionsColumnrangeSonificationTracksMapping()
		{
			Frequency = Frequency_DefaultValue = new PlotOptionsColumnrangeSonificationTracksMappingFrequency();
			GapBetweenNotes = GapBetweenNotes_DefaultValue = new PlotOptionsColumnrangeSonificationTracksMappingGapBetweenNotes();
			Highpass = Highpass_DefaultValue = new PlotOptionsColumnrangeSonificationTracksMappingHighpass();
			Lowpass = Lowpass_DefaultValue = new PlotOptionsColumnrangeSonificationTracksMappingLowpass();
			NoteDuration = NoteDuration_DefaultValue = new PlotOptionsColumnrangeSonificationTracksMappingNoteDuration();
			Pan = Pan_DefaultValue = new PlotOptionsColumnrangeSonificationTracksMappingPan();
			Pitch = Pitch_DefaultValue = new PlotOptionsColumnrangeSonificationTracksMappingPitch();
			PitchString = PitchString_DefaultValue = "null";
			PitchNumber = PitchNumber_DefaultValue = null;
			PlayDelay = PlayDelay_DefaultValue = new PlotOptionsColumnrangeSonificationTracksMappingPlayDelay();
			Time = Time_DefaultValue = new PlotOptionsColumnrangeSonificationTracksMappingTime();
			TimeString = TimeString_DefaultValue = "null";
			TimeNumber = TimeNumber_DefaultValue = null;
			Tremolo = Tremolo_DefaultValue = new PlotOptionsColumnrangeSonificationTracksMappingTremolo();
			Volume = Volume_DefaultValue = new PlotOptionsColumnrangeSonificationTracksMappingVolume();
		...
		/// </summary>
		public PlotOptionsColumnrangeSonificationTracksMappingFrequency Frequency { get; set; }
		private PlotOptionsColumnrangeSonificationTracksMappingFrequency Frequency_DefaultValue { get; set; }
		...
		/// </summary>
		public PlotOptionsColumnrangeSonificationTracksMappingGapBetweenNotes GapBetweenNotes { get; set; }
		private PlotOptionsColumnrangeSonificationTracksMappingGapBetweenNotes GapBetweenNotes_DefaultValue { get; set; }
		...
		/// </summary>
		public PlotOptionsColumnrangeSonificationTracksMappingHighpass Highpass { get; set; }
		private PlotOptionsColumnrangeSonificationTracksMappingHighpass Highpass_DefaultValue { get; set; }
		...
		/// </summary>
		public PlotOptionsColumnrangeSonificationTracksMappingLowpass Lowpass { get; set; }
		private PlotOptionsColumnrangeSonificationTracksMappingLowpass Lowpass_DefaultValue { get; set; }
		...
		/// </summary>
		public PlotOptionsColumnrangeSonificationTracksMappingNoteDuration NoteDuration { get; set; }
		private PlotOptionsColumnrangeSonificationTracksMappingNoteDuration NoteDuration_DefaultValue { get; set; }
		...
		/// </summary>
		public PlotOptionsColumnrangeSonificationTracksMappingPan Pan { get; set; }
		private PlotOptionsColumnrangeSonificationTracksMappingPan Pan_DefaultValue { get; set; }
		...
		/// </summary>
		public PlotOptionsColumnrangeSonificationTracksMappingPitch Pitch { get; set; }
		private PlotOptionsColumnrangeSonificationTracksMappingPitch Pitch_DefaultValue { get; set; }
		...
		/// </summary>
		public PlotOptionsColumnrangeSonificationTracksMappingPlayDelay PlayDelay { get; set; }
		private PlotOptionsColumnrangeSonificationTracksMappingPlayDelay PlayDelay_DefaultValue { get; set; }
		...
		/// </summary>
		public PlotOptionsColumnrangeSonificationTracksMappingTime Time { get; set; }
		private PlotOptionsColumnrangeSonificationTracksMappingTime Time_DefaultValue { get; set; }
		...
		/// </summary>
		public PlotOptionsColumnrangeSonificationTracksMappingTremolo Tremolo { get; set; }
		private PlotOptionsColumnrangeSonificationTracksMappingTremolo Tremolo_DefaultValue { get; set; }
		 

		/// <summary>
		/// The volume of notes, from 0 to 1.
		/// </summary>
		public PlotOptionsColumnrangeSonificationTracksMappingVolume Volume { get; set; }
		private PlotOptionsColumnrangeSonificationTracksMappingVolume Volume_DefaultValue { get; set; }
