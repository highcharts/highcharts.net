...
namespace Highsoft.Web.Mvc.Stocks
{
	public partial class PlotOptionsDema  : BaseObject
	{
		...
		public PlotOptionsDema()
		{
			...
			Zones = Zones_DefaultValue = new List<PlotOptionsDemaZone>();
		...
		/// </summary>
		public List<PlotOptionsDemaZone> Zones { get; set; }
		private List<PlotOptionsDemaZone> Zones_DefaultValue { get; set; }
