...
{
	public partial class PlotOptionsDema  : BaseObject
	{
		Hashtable h = new Hashtable();

		public PlotOptionsDema()
		{
			Accessibility = Accessibility_DefaultValue = new PlotOptionsDemaAccessibility();
			AllowPointSelect = AllowPointSelect_DefaultValue = false;
			Animation = Animation_DefaultValue = new Animation() { Enabled = true };
			AnimationBool = AnimationBool_DefaultValue = true;
			AnimationLimit = AnimationLimit_DefaultValue = null;
			BoostBlending = BoostBlending_DefaultValue = PlotOptionsDemaBoostBlending.Undefined;
			...
			Cursor = Cursor_DefaultValue = PlotOptionsDemaCursor.Null;
			Custom = Custom_DefaultValue = new Hashtable();
			DashStyle = DashStyle_DefaultValue = PlotOptionsDemaDashStyle.Null;
			DataGrouping = DataGrouping_DefaultValue = new PlotOptionsDemaDataGrouping();
			DataLabels = DataLabels_DefaultValue = new PlotOptionsDemaDataLabels();
			DataSorting = DataSorting_DefaultValue = new PlotOptionsDemaDataSorting();
			Description = Description_DefaultValue = "";
			EnableMouseTracking = EnableMouseTracking_DefaultValue = true;
			Events = Events_DefaultValue = new PlotOptionsDemaEvents();
			FindNearestPointBy = FindNearestPointBy_DefaultValue = PlotOptionsDemaFindNearestPointBy.X;
			GapSize = GapSize_DefaultValue = 0;
			GapUnit = GapUnit_DefaultValue = PlotOptionsDemaGapUnit.Relative;
			GetExtremesFromAll = GetExtremesFromAll_DefaultValue = false;
			InactiveOtherPoints = InactiveOtherPoints_DefaultValue = false;
			IncludeInDataExport = IncludeInDataExport_DefaultValue = null;
			Label = Label_DefaultValue = new PlotOptionsDemaLabel();
			LastPrice = LastPrice_DefaultValue = new PlotOptionsDemaLastPrice();
			LastVisiblePrice = LastVisiblePrice_DefaultValue = new PlotOptionsDemaLastVisiblePrice();
			LegendSymbol = LegendSymbol_DefaultValue = PlotOptionsDemaLegendSymbol.Rectangle;
			Linecap = Linecap_DefaultValue = PlotOptionsDemaLinecap.Round;
			LineWidth = LineWidth_DefaultValue = 2;
			LinkedTo = LinkedTo_DefaultValue = "";
			Marker = Marker_DefaultValue = new PlotOptionsDemaMarker();
			NegativeColor = NegativeColor_DefaultValue = "";
			OnPoint = OnPoint_DefaultValue = new PlotOptionsDemaOnPoint();
			Opacity = Opacity_DefaultValue = 1;
			Params = Params_DefaultValue = new PlotOptionsDemaParams();
			Point = Point_DefaultValue = new PlotOptionsDemaPoint();
			...
			Sonification = Sonification_DefaultValue = new PlotOptionsDemaSonification();
			States = States_DefaultValue = new PlotOptionsDemaStates();
			Step = Step_DefaultValue = PlotOptionsDemaStep.Null;
			StickyTracking = StickyTracking_DefaultValue = true;
			Threshold = Threshold_DefaultValue = 0;
			Tooltip = Tooltip_DefaultValue = new PlotOptionsDemaTooltip();
			TurboThreshold = TurboThreshold_DefaultValue = 1000;
			Visible = Visible_DefaultValue = true;
			ZoneAxis = ZoneAxis_DefaultValue = "y";
			Zones = Zones_DefaultValue = new List<PlotOptionsDemaZones>();
		...
		/// </summary>
		public PlotOptionsDemaAccessibility Accessibility { get; set; }
		private PlotOptionsDemaAccessibility Accessibility_DefaultValue { get; set; }
		...
		/// </summary>
		public PlotOptionsDemaBoostBlending BoostBlending { get; set; }
		private PlotOptionsDemaBoostBlending BoostBlending_DefaultValue { get; set; }
		...
		/// </summary>
		public PlotOptionsDemaCursor Cursor { get; set; }
		private PlotOptionsDemaCursor Cursor_DefaultValue { get; set; }
		...
		/// </summary>
		public PlotOptionsDemaDashStyle DashStyle { get; set; }
		private PlotOptionsDemaDashStyle DashStyle_DefaultValue { get; set; }
		...
		/// </summary>
		public PlotOptionsDemaDataGrouping DataGrouping { get; set; }
		private PlotOptionsDemaDataGrouping DataGrouping_DefaultValue { get; set; }
		...
		/// </summary>
		public PlotOptionsDemaDataLabels DataLabels { get; set; }
		private PlotOptionsDemaDataLabels DataLabels_DefaultValue { get; set; }
		 

		/// <summary>
		/// Options for the series data sorting.
		/// </summary>
		public PlotOptionsDemaDataSorting DataSorting { get; set; }
		private PlotOptionsDemaDataSorting DataSorting_DefaultValue { get; set; }
		...
		/// </summary>
		public PlotOptionsDemaEvents Events { get; set; }
		private PlotOptionsDemaEvents Events_DefaultValue { get; set; }
		...
		/// </summary>
		public PlotOptionsDemaFindNearestPointBy FindNearestPointBy { get; set; }
		private PlotOptionsDemaFindNearestPointBy FindNearestPointBy_DefaultValue { get; set; }
		...
		/// </summary>
		public PlotOptionsDemaGapUnit GapUnit { get; set; }
		private PlotOptionsDemaGapUnit GapUnit_DefaultValue { get; set; }
		...
		/// </summary>
		public PlotOptionsDemaLabel Label { get; set; }
		private PlotOptionsDemaLabel Label_DefaultValue { get; set; }
		 

		/// <summary>
		/// The line marks the last price from all points.
		/// </summary>
		public PlotOptionsDemaLastPrice LastPrice { get; set; }
		private PlotOptionsDemaLastPrice LastPrice_DefaultValue { get; set; }
		 

		/// <summary>
		/// The line marks the last price from visible range of points.
		/// </summary>
		public PlotOptionsDemaLastVisiblePrice LastVisiblePrice { get; set; }
		private PlotOptionsDemaLastVisiblePrice LastVisiblePrice_DefaultValue { get; set; }
		 

		/// <summary>
		/// What type of legend symbol to render for this series. Can be one of`areaMarker`, `lineMarker` or `rectangle`.
		/// </summary>
		public PlotOptionsDemaLegendSymbol LegendSymbol { get; set; }
		private PlotOptionsDemaLegendSymbol LegendSymbol_DefaultValue { get; set; }
		 

		/// <summary>
		/// The line cap used for line ends and line joins on the graph.
		/// </summary>
		public PlotOptionsDemaLinecap Linecap { get; set; }
		private PlotOptionsDemaLinecap Linecap_DefaultValue { get; set; }
		...
		/// </summary>
		public PlotOptionsDemaMarker Marker { get; set; }
		private PlotOptionsDemaMarker Marker_DefaultValue { get; set; }
		...
		/// </summary>
		public PlotOptionsDemaOnPoint OnPoint { get; set; }
		private PlotOptionsDemaOnPoint OnPoint_DefaultValue { get; set; }
		...
		/// </summary>
		public PlotOptionsDemaParams Params { get; set; }
		private PlotOptionsDemaParams Params_DefaultValue { get; set; }
		 

		/// <summary>
		/// Properties for each single point.
		/// </summary>
		public PlotOptionsDemaPoint Point { get; set; }
		private PlotOptionsDemaPoint Point_DefaultValue { get; set; }
		...
		/// </summary>
		public PlotOptionsDemaSonification Sonification { get; set; }
		private PlotOptionsDemaSonification Sonification_DefaultValue { get; set; }
		 

		/// <summary>
		/// 
		/// </summary>
		public PlotOptionsDemaStates States { get; set; }
		private PlotOptionsDemaStates States_DefaultValue { get; set; }
		 

		/// <summary>
		/// Whether to apply steps to the line. Possible values are `left`,`center` and `right`.
		/// </summary>
		public PlotOptionsDemaStep Step { get; set; }
		private PlotOptionsDemaStep Step_DefaultValue { get; set; }
		...
		/// </summary>
		public PlotOptionsDemaTooltip Tooltip { get; set; }
		private PlotOptionsDemaTooltip Tooltip_DefaultValue { get; set; }
		...
		/// </summary>
		public List<PlotOptionsDemaZones> Zones { get; set; }
		private List<PlotOptionsDemaZones> Zones_DefaultValue { get; set; }
