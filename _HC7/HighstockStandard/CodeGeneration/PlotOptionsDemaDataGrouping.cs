...
namespace Highsoft.Web.Mvc.Stocks
{
	public partial class PlotOptionsDemaDataGrouping  : BaseObject
	{
		...
		internal override Hashtable ToHashtable()
		{
			...
			if (Approximation != Approximation_DefaultValue) { h.Add("approximation",Approximation); Highstock.AddFunction("PlotOptionsDemaDataGroupingApproximation.approximation", Approximation); }  
