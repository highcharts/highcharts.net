...
{
	public partial class PlotOptionsDemaDragDropDragHandle  : BaseObject
	{
		public PlotOptionsDemaDragDropDragHandle()
		{
		...
		internal override Hashtable ToHashtable()
		{
			...
			if (PathFormatter != PathFormatter_DefaultValue) { h.Add("pathFormatter",PathFormatter); Highstock.AddFunction("PlotOptionsDemaDragDropDragHandlePathFormatter.pathFormatter", PathFormatter); }  
