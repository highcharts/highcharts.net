...
{
	public partial class PlotOptionsDemaSonificationContextTracks  : BaseObject
	{
		Hashtable h = new Hashtable();

		public PlotOptionsDemaSonificationContextTracks()
		{
			ActiveWhen = ActiveWhen_DefaultValue = new PlotOptionsDemaSonificationContextTracksActiveWhen();
			Instrument = Instrument_DefaultValue = null;
			InstrumentString = InstrumentString_DefaultValue = "null";
			Mapping = Mapping_DefaultValue = new PlotOptionsDemaSonificationContextTracksMapping();
			MidiName = MidiName_DefaultValue = "";
			PointGrouping = PointGrouping_DefaultValue = new PlotOptionsDemaSonificationContextTracksPointGrouping();
			...
			Type = Type_DefaultValue = PlotOptionsDemaSonificationContextTracksType.Instrument;
			ValueInterval = ValueInterval_DefaultValue = null;
			ValueMapFunction = ValueMapFunction_DefaultValue = PlotOptionsDemaSonificationContextTracksValueMapFunction.Linear;
		...
		/// </summary>
		public PlotOptionsDemaSonificationContextTracksActiveWhen ActiveWhen { get; set; }
		private PlotOptionsDemaSonificationContextTracksActiveWhen ActiveWhen_DefaultValue { get; set; }
		...
		/// </summary>
		public PlotOptionsDemaSonificationContextTracksMapping Mapping { get; set; }
		private PlotOptionsDemaSonificationContextTracksMapping Mapping_DefaultValue { get; set; }
		...
		/// </summary>
		public PlotOptionsDemaSonificationContextTracksPointGrouping PointGrouping { get; set; }
		private PlotOptionsDemaSonificationContextTracksPointGrouping PointGrouping_DefaultValue { get; set; }
		...
		/// </summary>
		public PlotOptionsDemaSonificationContextTracksType Type { get; set; }
		private PlotOptionsDemaSonificationContextTracksType Type_DefaultValue { get; set; }
		...
		/// </summary>
		public PlotOptionsDemaSonificationContextTracksValueMapFunction ValueMapFunction { get; set; }
		private PlotOptionsDemaSonificationContextTracksValueMapFunction ValueMapFunction_DefaultValue { get; set; }
