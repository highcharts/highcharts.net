...
{
	public partial class PlotOptionsDemaSonificationContextTracksMapping  : BaseObject
	{
		Hashtable h = new Hashtable();

		public PlotOptionsDemaSonificationContextTracksMapping()
		{
			Frequency = Frequency_DefaultValue = new PlotOptionsDemaSonificationContextTracksMappingFrequency();
			GapBetweenNotes = GapBetweenNotes_DefaultValue = new PlotOptionsDemaSonificationContextTracksMappingGapBetweenNotes();
			Highpass = Highpass_DefaultValue = new PlotOptionsDemaSonificationContextTracksMappingHighpass();
			Lowpass = Lowpass_DefaultValue = new PlotOptionsDemaSonificationContextTracksMappingLowpass();
			NoteDuration = NoteDuration_DefaultValue = new PlotOptionsDemaSonificationContextTracksMappingNoteDuration();
			Pan = Pan_DefaultValue = new PlotOptionsDemaSonificationContextTracksMappingPan();
			Pitch = Pitch_DefaultValue = new PlotOptionsDemaSonificationContextTracksMappingPitch();
			PitchString = PitchString_DefaultValue = "null";
			PitchNumber = PitchNumber_DefaultValue = null;
			PlayDelay = PlayDelay_DefaultValue = new PlotOptionsDemaSonificationContextTracksMappingPlayDelay();
			Time = Time_DefaultValue = new PlotOptionsDemaSonificationContextTracksMappingTime();
			TimeString = TimeString_DefaultValue = "null";
			TimeNumber = TimeNumber_DefaultValue = null;
			Tremolo = Tremolo_DefaultValue = new PlotOptionsDemaSonificationContextTracksMappingTremolo();
			Volume = Volume_DefaultValue = new PlotOptionsDemaSonificationContextTracksMappingVolume();
		...
		/// </summary>
		public PlotOptionsDemaSonificationContextTracksMappingFrequency Frequency { get; set; }
		private PlotOptionsDemaSonificationContextTracksMappingFrequency Frequency_DefaultValue { get; set; }
		...
		/// </summary>
		public PlotOptionsDemaSonificationContextTracksMappingGapBetweenNotes GapBetweenNotes { get; set; }
		private PlotOptionsDemaSonificationContextTracksMappingGapBetweenNotes GapBetweenNotes_DefaultValue { get; set; }
		...
		/// </summary>
		public PlotOptionsDemaSonificationContextTracksMappingHighpass Highpass { get; set; }
		private PlotOptionsDemaSonificationContextTracksMappingHighpass Highpass_DefaultValue { get; set; }
		...
		/// </summary>
		public PlotOptionsDemaSonificationContextTracksMappingLowpass Lowpass { get; set; }
		private PlotOptionsDemaSonificationContextTracksMappingLowpass Lowpass_DefaultValue { get; set; }
		...
		/// </summary>
		public PlotOptionsDemaSonificationContextTracksMappingNoteDuration NoteDuration { get; set; }
		private PlotOptionsDemaSonificationContextTracksMappingNoteDuration NoteDuration_DefaultValue { get; set; }
		...
		/// </summary>
		public PlotOptionsDemaSonificationContextTracksMappingPan Pan { get; set; }
		private PlotOptionsDemaSonificationContextTracksMappingPan Pan_DefaultValue { get; set; }
		...
		/// </summary>
		public PlotOptionsDemaSonificationContextTracksMappingPitch Pitch { get; set; }
		private PlotOptionsDemaSonificationContextTracksMappingPitch Pitch_DefaultValue { get; set; }
		...
		/// </summary>
		public PlotOptionsDemaSonificationContextTracksMappingPlayDelay PlayDelay { get; set; }
		private PlotOptionsDemaSonificationContextTracksMappingPlayDelay PlayDelay_DefaultValue { get; set; }
		...
		/// </summary>
		public PlotOptionsDemaSonificationContextTracksMappingTime Time { get; set; }
		private PlotOptionsDemaSonificationContextTracksMappingTime Time_DefaultValue { get; set; }
		...
		/// </summary>
		public PlotOptionsDemaSonificationContextTracksMappingTremolo Tremolo { get; set; }
		private PlotOptionsDemaSonificationContextTracksMappingTremolo Tremolo_DefaultValue { get; set; }
		 

		/// <summary>
		/// The volume of notes, from 0 to 1.
		/// </summary>
		public PlotOptionsDemaSonificationContextTracksMappingVolume Volume { get; set; }
		private PlotOptionsDemaSonificationContextTracksMappingVolume Volume_DefaultValue { get; set; }
