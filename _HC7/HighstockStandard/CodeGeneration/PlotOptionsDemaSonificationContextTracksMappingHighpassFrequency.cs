...
{
	public partial class PlotOptionsDemaSonificationContextTracksMappingHighpassFrequency  : BaseObject
	{
		Hashtable h = new Hashtable();

		public PlotOptionsDemaSonificationContextTracksMappingHighpassFrequency()
		{
			MapFunction = MapFunction_DefaultValue = PlotOptionsDemaSonificationContextTracksMappingHighpassFrequencyMapFunction.Linear;
			MapTo = MapTo_DefaultValue = "";
			Max = Max_DefaultValue = null;
			Min = Min_DefaultValue = null;
			Value = Value_DefaultValue = null;
			Within = Within_DefaultValue = PlotOptionsDemaSonificationContextTracksMappingHighpassFrequencyWithin.Chart;
		...
		/// </summary>
		public PlotOptionsDemaSonificationContextTracksMappingHighpassFrequencyMapFunction MapFunction { get; set; }
		private PlotOptionsDemaSonificationContextTracksMappingHighpassFrequencyMapFunction MapFunction_DefaultValue { get; set; }
		...
		/// </summary>
		public PlotOptionsDemaSonificationContextTracksMappingHighpassFrequencyWithin Within { get; set; }
		private PlotOptionsDemaSonificationContextTracksMappingHighpassFrequencyWithin Within_DefaultValue { get; set; }
