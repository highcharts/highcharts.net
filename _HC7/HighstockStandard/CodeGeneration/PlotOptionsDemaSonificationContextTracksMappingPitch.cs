...
{
	public partial class PlotOptionsDemaSonificationContextTracksMappingPitch  : BaseObject
	{
		Hashtable h = new Hashtable();

		public PlotOptionsDemaSonificationContextTracksMappingPitch()
		{
			MapFunction = MapFunction_DefaultValue = PlotOptionsDemaSonificationContextTracksMappingPitchMapFunction.Linear;
		...
		/// </summary>
		public PlotOptionsDemaSonificationContextTracksMappingPitchMapFunction MapFunction { get; set; }
		private PlotOptionsDemaSonificationContextTracksMappingPitchMapFunction MapFunction_DefaultValue { get; set; }
