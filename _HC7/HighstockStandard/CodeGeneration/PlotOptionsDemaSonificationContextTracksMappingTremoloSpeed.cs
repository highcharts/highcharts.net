...
{
	public partial class PlotOptionsDemaSonificationContextTracksMappingTremoloSpeed  : BaseObject
	{
		Hashtable h = new Hashtable();

		public PlotOptionsDemaSonificationContextTracksMappingTremoloSpeed()
		{
			MapFunction = MapFunction_DefaultValue = PlotOptionsDemaSonificationContextTracksMappingTremoloSpeedMapFunction.Linear;
			MapTo = MapTo_DefaultValue = "";
			Max = Max_DefaultValue = null;
			Min = Min_DefaultValue = null;
			Value = Value_DefaultValue = null;
			Within = Within_DefaultValue = PlotOptionsDemaSonificationContextTracksMappingTremoloSpeedWithin.Chart;
		...
		/// </summary>
		public PlotOptionsDemaSonificationContextTracksMappingTremoloSpeedMapFunction MapFunction { get; set; }
		private PlotOptionsDemaSonificationContextTracksMappingTremoloSpeedMapFunction MapFunction_DefaultValue { get; set; }
		...
		/// </summary>
		public PlotOptionsDemaSonificationContextTracksMappingTremoloSpeedWithin Within { get; set; }
		private PlotOptionsDemaSonificationContextTracksMappingTremoloSpeedWithin Within_DefaultValue { get; set; }
