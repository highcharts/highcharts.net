...
{
	public partial class PlotOptionsDemaSonificationDefaultInstrumentOptionsActiveWhen  : BaseObject
	{
		Hashtable h = new Hashtable();

		public PlotOptionsDemaSonificationDefaultInstrumentOptionsActiveWhen()
		{
