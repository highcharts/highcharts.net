...
{
	public partial class PlotOptionsDemaSonificationDefaultInstrumentOptionsMappingHighpassResonance  : BaseObject
	{
		Hashtable h = new Hashtable();

		public PlotOptionsDemaSonificationDefaultInstrumentOptionsMappingHighpassResonance()
		{
			MapFunction = MapFunction_DefaultValue = PlotOptionsDemaSonificationDefaultInstrumentOptionsMappingHighpassResonanceMapFunction.Linear;
			MapTo = MapTo_DefaultValue = "";
			Max = Max_DefaultValue = null;
			Min = Min_DefaultValue = null;
			Value = Value_DefaultValue = null;
			Within = Within_DefaultValue = PlotOptionsDemaSonificationDefaultInstrumentOptionsMappingHighpassResonanceWithin.Chart;
		...
		/// </summary>
		public PlotOptionsDemaSonificationDefaultInstrumentOptionsMappingHighpassResonanceMapFunction MapFunction { get; set; }
		private PlotOptionsDemaSonificationDefaultInstrumentOptionsMappingHighpassResonanceMapFunction MapFunction_DefaultValue { get; set; }
		...
		/// </summary>
		public PlotOptionsDemaSonificationDefaultInstrumentOptionsMappingHighpassResonanceWithin Within { get; set; }
		private PlotOptionsDemaSonificationDefaultInstrumentOptionsMappingHighpassResonanceWithin Within_DefaultValue { get; set; }
