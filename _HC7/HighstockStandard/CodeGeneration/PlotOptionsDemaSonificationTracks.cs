...
{
	public partial class PlotOptionsDemaSonificationTracks  : BaseObject
	{
		Hashtable h = new Hashtable();

		public PlotOptionsDemaSonificationTracks()
		{
			ActiveWhen = ActiveWhen_DefaultValue = new PlotOptionsDemaSonificationTracksActiveWhen();
			Instrument = Instrument_DefaultValue = null;
			InstrumentString = InstrumentString_DefaultValue = "null";
			Mapping = Mapping_DefaultValue = new PlotOptionsDemaSonificationTracksMapping();
			MidiName = MidiName_DefaultValue = "";
			PointGrouping = PointGrouping_DefaultValue = new PlotOptionsDemaSonificationTracksPointGrouping();
			RoundToMusicalNotes = RoundToMusicalNotes_DefaultValue = true;
			ShowPlayMarker = ShowPlayMarker_DefaultValue = true;
			Type = Type_DefaultValue = PlotOptionsDemaSonificationTracksType.Instrument;
		...
		/// </summary>
		public PlotOptionsDemaSonificationTracksActiveWhen ActiveWhen { get; set; }
		private PlotOptionsDemaSonificationTracksActiveWhen ActiveWhen_DefaultValue { get; set; }
		...
		/// </summary>
		public PlotOptionsDemaSonificationTracksMapping Mapping { get; set; }
		private PlotOptionsDemaSonificationTracksMapping Mapping_DefaultValue { get; set; }
		...
		/// </summary>
		public PlotOptionsDemaSonificationTracksPointGrouping PointGrouping { get; set; }
		private PlotOptionsDemaSonificationTracksPointGrouping PointGrouping_DefaultValue { get; set; }
		...
		/// </summary>
		public PlotOptionsDemaSonificationTracksType Type { get; set; }
		private PlotOptionsDemaSonificationTracksType Type_DefaultValue { get; set; }
