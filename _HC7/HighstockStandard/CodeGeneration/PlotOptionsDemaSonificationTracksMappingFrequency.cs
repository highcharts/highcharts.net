...
{
	public partial class PlotOptionsDemaSonificationTracksMappingFrequency  : BaseObject
	{
		Hashtable h = new Hashtable();

		public PlotOptionsDemaSonificationTracksMappingFrequency()
		{
			MapFunction = MapFunction_DefaultValue = PlotOptionsDemaSonificationTracksMappingFrequencyMapFunction.Linear;
			MapTo = MapTo_DefaultValue = "";
			Max = Max_DefaultValue = null;
			Min = Min_DefaultValue = null;
			Value = Value_DefaultValue = null;
			Within = Within_DefaultValue = PlotOptionsDemaSonificationTracksMappingFrequencyWithin.Chart;
		...
		/// </summary>
		public PlotOptionsDemaSonificationTracksMappingFrequencyMapFunction MapFunction { get; set; }
		private PlotOptionsDemaSonificationTracksMappingFrequencyMapFunction MapFunction_DefaultValue { get; set; }
		...
		/// </summary>
		public PlotOptionsDemaSonificationTracksMappingFrequencyWithin Within { get; set; }
		private PlotOptionsDemaSonificationTracksMappingFrequencyWithin Within_DefaultValue { get; set; }
