...
{
	public partial class PlotOptionsDemaSonificationTracksMappingPan  : BaseObject
	{
		Hashtable h = new Hashtable();

		public PlotOptionsDemaSonificationTracksMappingPan()
		{
			MapFunction = MapFunction_DefaultValue = PlotOptionsDemaSonificationTracksMappingPanMapFunction.Linear;
			MapTo = MapTo_DefaultValue = "";
			Max = Max_DefaultValue = null;
			Min = Min_DefaultValue = null;
			Value = Value_DefaultValue = null;
			Within = Within_DefaultValue = PlotOptionsDemaSonificationTracksMappingPanWithin.Chart;
		...
		/// </summary>
		public PlotOptionsDemaSonificationTracksMappingPanMapFunction MapFunction { get; set; }
		private PlotOptionsDemaSonificationTracksMappingPanMapFunction MapFunction_DefaultValue { get; set; }
		...
		/// </summary>
		public PlotOptionsDemaSonificationTracksMappingPanWithin Within { get; set; }
		private PlotOptionsDemaSonificationTracksMappingPanWithin Within_DefaultValue { get; set; }
