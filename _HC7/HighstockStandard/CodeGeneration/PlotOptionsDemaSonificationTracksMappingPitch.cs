...
{
	public partial class PlotOptionsDemaSonificationTracksMappingPitch  : BaseObject
	{
		Hashtable h = new Hashtable();

		public PlotOptionsDemaSonificationTracksMappingPitch()
		{
			MapFunction = MapFunction_DefaultValue = PlotOptionsDemaSonificationTracksMappingPitchMapFunction.Linear;
		...
		/// </summary>
		public PlotOptionsDemaSonificationTracksMappingPitchMapFunction MapFunction { get; set; }
		private PlotOptionsDemaSonificationTracksMappingPitchMapFunction MapFunction_DefaultValue { get; set; }
