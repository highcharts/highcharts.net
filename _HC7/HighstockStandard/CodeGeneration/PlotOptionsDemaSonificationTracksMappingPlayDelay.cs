...
{
	public partial class PlotOptionsDemaSonificationTracksMappingPlayDelay  : BaseObject
	{
		Hashtable h = new Hashtable();

		public PlotOptionsDemaSonificationTracksMappingPlayDelay()
		{
			MapFunction = MapFunction_DefaultValue = PlotOptionsDemaSonificationTracksMappingPlayDelayMapFunction.Linear;
			MapTo = MapTo_DefaultValue = "";
			Max = Max_DefaultValue = null;
			Min = Min_DefaultValue = null;
			Value = Value_DefaultValue = null;
			Within = Within_DefaultValue = PlotOptionsDemaSonificationTracksMappingPlayDelayWithin.Chart;
		...
		/// </summary>
		public PlotOptionsDemaSonificationTracksMappingPlayDelayMapFunction MapFunction { get; set; }
		private PlotOptionsDemaSonificationTracksMappingPlayDelayMapFunction MapFunction_DefaultValue { get; set; }
		...
		/// </summary>
		public PlotOptionsDemaSonificationTracksMappingPlayDelayWithin Within { get; set; }
		private PlotOptionsDemaSonificationTracksMappingPlayDelayWithin Within_DefaultValue { get; set; }
