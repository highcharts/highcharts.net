...
{
	public partial class PlotOptionsDemaSonificationTracksMappingTime  : BaseObject
	{
		Hashtable h = new Hashtable();

		public PlotOptionsDemaSonificationTracksMappingTime()
		{
			MapFunction = MapFunction_DefaultValue = PlotOptionsDemaSonificationTracksMappingTimeMapFunction.Linear;
			MapTo = MapTo_DefaultValue = "";
			Max = Max_DefaultValue = null;
			Min = Min_DefaultValue = null;
			Value = Value_DefaultValue = null;
			Within = Within_DefaultValue = PlotOptionsDemaSonificationTracksMappingTimeWithin.Chart;
		...
		/// </summary>
		public PlotOptionsDemaSonificationTracksMappingTimeMapFunction MapFunction { get; set; }
		private PlotOptionsDemaSonificationTracksMappingTimeMapFunction MapFunction_DefaultValue { get; set; }
		...
		/// </summary>
		public PlotOptionsDemaSonificationTracksMappingTimeWithin Within { get; set; }
		private PlotOptionsDemaSonificationTracksMappingTimeWithin Within_DefaultValue { get; set; }
