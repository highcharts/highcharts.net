...
{
	public partial class PlotOptionsDemaSonificationTracksMappingVolume  : BaseObject
	{
		Hashtable h = new Hashtable();

		public PlotOptionsDemaSonificationTracksMappingVolume()
		{
			MapFunction = MapFunction_DefaultValue = PlotOptionsDemaSonificationTracksMappingVolumeMapFunction.Linear;
			MapTo = MapTo_DefaultValue = "";
			Max = Max_DefaultValue = null;
			Min = Min_DefaultValue = null;
			Value = Value_DefaultValue = null;
			Within = Within_DefaultValue = PlotOptionsDemaSonificationTracksMappingVolumeWithin.Chart;
		...
		/// </summary>
		public PlotOptionsDemaSonificationTracksMappingVolumeMapFunction MapFunction { get; set; }
		private PlotOptionsDemaSonificationTracksMappingVolumeMapFunction MapFunction_DefaultValue { get; set; }
		...
		/// </summary>
		public PlotOptionsDemaSonificationTracksMappingVolumeWithin Within { get; set; }
		private PlotOptionsDemaSonificationTracksMappingVolumeWithin Within_DefaultValue { get; set; }
