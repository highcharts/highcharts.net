...
{
	public partial class PlotOptionsDemaSonificationTracksPointGrouping  : BaseObject
	{
		Hashtable h = new Hashtable();

		public PlotOptionsDemaSonificationTracksPointGrouping()
		{
			Algorithm = Algorithm_DefaultValue = PlotOptionsDemaSonificationTracksPointGroupingAlgorithm.Minimax;
		...
		/// </summary>
		public PlotOptionsDemaSonificationTracksPointGroupingAlgorithm Algorithm { get; set; }
		private PlotOptionsDemaSonificationTracksPointGroupingAlgorithm Algorithm_DefaultValue { get; set; }
