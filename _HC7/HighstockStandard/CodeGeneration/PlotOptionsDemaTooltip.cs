...
{
	public partial class PlotOptionsDemaTooltip  : BaseObject
	{
		public PlotOptionsDemaTooltip()
		{
			...
			HeaderShape = HeaderShape_DefaultValue = PlotOptionsDemaTooltipHeaderShape.Callout;
		...
		/// </summary>
		public PlotOptionsDemaTooltipHeaderShape HeaderShape { get; set; }
		private PlotOptionsDemaTooltipHeaderShape HeaderShape_DefaultValue { get; set; }
		...
		internal override Hashtable ToHashtable()
		{
			...
			if (NullFormatter != NullFormatter_DefaultValue) { h.Add("nullFormatter",NullFormatter); Highstock.AddFunction("PlotOptionsDemaTooltipNullFormatter.nullFormatter", NullFormatter); }  
			if (Outside != Outside_DefaultValue) h.Add("outside",Outside);
			if (Padding != Padding_DefaultValue) h.Add("padding",Padding);
			if (PointFormat != PointFormat_DefaultValue) h.Add("pointFormat",PointFormat);
			if (PointFormatter != PointFormatter_DefaultValue) { h.Add("pointFormatter",PointFormatter); Highstock.AddFunction("PlotOptionsDemaTooltipPointFormatter.pointFormatter", PointFormatter); }  
