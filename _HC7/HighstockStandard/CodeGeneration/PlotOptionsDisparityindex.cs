...
namespace Highsoft.Web.Mvc.Stocks
{
	public partial class PlotOptionsDisparityindex  : BaseObject
	{
		...
		public PlotOptionsDisparityindex()
		{
			...
			Zones = Zones_DefaultValue = new List<PlotOptionsDisparityindexZone>();
		...
		/// </summary>
		public List<PlotOptionsDisparityindexZone> Zones { get; set; }
		private List<PlotOptionsDisparityindexZone> Zones_DefaultValue { get; set; }
