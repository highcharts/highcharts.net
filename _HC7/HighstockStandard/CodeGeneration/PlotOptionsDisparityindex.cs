...
{
	public partial class PlotOptionsDisparityindex  : BaseObject
	{
		Hashtable h = new Hashtable();

		public PlotOptionsDisparityindex()
		{
			Accessibility = Accessibility_DefaultValue = new PlotOptionsDisparityindexAccessibility();
			AllowPointSelect = AllowPointSelect_DefaultValue = false;
			Animation = Animation_DefaultValue = new Animation() { Enabled = true };
			AnimationBool = AnimationBool_DefaultValue = true;
			AnimationLimit = AnimationLimit_DefaultValue = null;
			BoostBlending = BoostBlending_DefaultValue = PlotOptionsDisparityindexBoostBlending.Undefined;
			...
			Compare = Compare_DefaultValue = PlotOptionsDisparityindexCompare.Percent;
			CompareBase = CompareBase_DefaultValue = PlotOptionsDisparityindexCompareBase.Min;
			...
			Cursor = Cursor_DefaultValue = PlotOptionsDisparityindexCursor.Null;
			Custom = Custom_DefaultValue = new Hashtable();
			DashStyle = DashStyle_DefaultValue = PlotOptionsDisparityindexDashStyle.Null;
			DataGrouping = DataGrouping_DefaultValue = new PlotOptionsDisparityindexDataGrouping();
			DataLabels = DataLabels_DefaultValue = new PlotOptionsDisparityindexDataLabels();
			DataSorting = DataSorting_DefaultValue = new PlotOptionsDisparityindexDataSorting();
			Description = Description_DefaultValue = "";
			EnableMouseTracking = EnableMouseTracking_DefaultValue = true;
			Events = Events_DefaultValue = new PlotOptionsDisparityindexEvents();
			FindNearestPointBy = FindNearestPointBy_DefaultValue = PlotOptionsDisparityindexFindNearestPointBy.X;
			GapSize = GapSize_DefaultValue = 0;
			GapUnit = GapUnit_DefaultValue = PlotOptionsDisparityindexGapUnit.Relative;
			GetExtremesFromAll = GetExtremesFromAll_DefaultValue = false;
			InactiveOtherPoints = InactiveOtherPoints_DefaultValue = false;
			IncludeInDataExport = IncludeInDataExport_DefaultValue = null;
			Label = Label_DefaultValue = new PlotOptionsDisparityindexLabel();
			LastPrice = LastPrice_DefaultValue = new PlotOptionsDisparityindexLastPrice();
			LastVisiblePrice = LastVisiblePrice_DefaultValue = new PlotOptionsDisparityindexLastVisiblePrice();
			LegendSymbol = LegendSymbol_DefaultValue = PlotOptionsDisparityindexLegendSymbol.Rectangle;
			Linecap = Linecap_DefaultValue = PlotOptionsDisparityindexLinecap.Round;
			LineWidth = LineWidth_DefaultValue = 2;
			LinkedTo = LinkedTo_DefaultValue = "";
			Marker = Marker_DefaultValue = new PlotOptionsDisparityindexMarker();
			NegativeColor = NegativeColor_DefaultValue = "";
			OnPoint = OnPoint_DefaultValue = new PlotOptionsDisparityindexOnPoint();
			Opacity = Opacity_DefaultValue = 1;
			Params = Params_DefaultValue = new PlotOptionsDisparityindexParams();
			Point = Point_DefaultValue = new PlotOptionsDisparityindexPoint();
			...
			Sonification = Sonification_DefaultValue = new PlotOptionsDisparityindexSonification();
			States = States_DefaultValue = new PlotOptionsDisparityindexStates();
			Step = Step_DefaultValue = PlotOptionsDisparityindexStep.Null;
			StickyTracking = StickyTracking_DefaultValue = true;
			Threshold = Threshold_DefaultValue = 0;
			Tooltip = Tooltip_DefaultValue = new PlotOptionsDisparityindexTooltip();
			TurboThreshold = TurboThreshold_DefaultValue = 1000;
			Visible = Visible_DefaultValue = true;
			ZoneAxis = ZoneAxis_DefaultValue = "y";
			Zones = Zones_DefaultValue = new List<PlotOptionsDisparityindexZones>();
		...
		/// </summary>
		public PlotOptionsDisparityindexAccessibility Accessibility { get; set; }
		private PlotOptionsDisparityindexAccessibility Accessibility_DefaultValue { get; set; }
		...
		/// </summary>
		public PlotOptionsDisparityindexBoostBlending BoostBlending { get; set; }
		private PlotOptionsDisparityindexBoostBlending BoostBlending_DefaultValue { get; set; }
		...
		/// </summary>
		public PlotOptionsDisparityindexCompare Compare { get; set; }
		private PlotOptionsDisparityindexCompare Compare_DefaultValue { get; set; }
		 

		/// <summary>
		/// When [compare](#plotOptions.series.compare) is `percent`, this optiondictates whether to use 0 or 100 as the base of comparison.
		/// </summary>
		public PlotOptionsDisparityindexCompareBase CompareBase { get; set; }
		private PlotOptionsDisparityindexCompareBase CompareBase_DefaultValue { get; set; }
		...
		/// </summary>
		public PlotOptionsDisparityindexCursor Cursor { get; set; }
		private PlotOptionsDisparityindexCursor Cursor_DefaultValue { get; set; }
		...
		/// </summary>
		public PlotOptionsDisparityindexDashStyle DashStyle { get; set; }
		private PlotOptionsDisparityindexDashStyle DashStyle_DefaultValue { get; set; }
		 

		/// <summary>
		/// 
		/// </summary>
		public PlotOptionsDisparityindexDataGrouping DataGrouping { get; set; }
		private PlotOptionsDisparityindexDataGrouping DataGrouping_DefaultValue { get; set; }
		...
		/// </summary>
		public PlotOptionsDisparityindexDataLabels DataLabels { get; set; }
		private PlotOptionsDisparityindexDataLabels DataLabels_DefaultValue { get; set; }
		 

		/// <summary>
		/// Options for the series data sorting.
		/// </summary>
		public PlotOptionsDisparityindexDataSorting DataSorting { get; set; }
		private PlotOptionsDisparityindexDataSorting DataSorting_DefaultValue { get; set; }
		...
		/// </summary>
		public PlotOptionsDisparityindexEvents Events { get; set; }
		private PlotOptionsDisparityindexEvents Events_DefaultValue { get; set; }
		...
		/// </summary>
		public PlotOptionsDisparityindexFindNearestPointBy FindNearestPointBy { get; set; }
		private PlotOptionsDisparityindexFindNearestPointBy FindNearestPointBy_DefaultValue { get; set; }
		...
		/// </summary>
		public PlotOptionsDisparityindexGapUnit GapUnit { get; set; }
		private PlotOptionsDisparityindexGapUnit GapUnit_DefaultValue { get; set; }
		...
		/// </summary>
		public PlotOptionsDisparityindexLabel Label { get; set; }
		private PlotOptionsDisparityindexLabel Label_DefaultValue { get; set; }
		 

		/// <summary>
		/// The line marks the last price from all points.
		/// </summary>
		public PlotOptionsDisparityindexLastPrice LastPrice { get; set; }
		private PlotOptionsDisparityindexLastPrice LastPrice_DefaultValue { get; set; }
		 

		/// <summary>
		/// The line marks the last price from visible range of points.
		/// </summary>
		public PlotOptionsDisparityindexLastVisiblePrice LastVisiblePrice { get; set; }
		private PlotOptionsDisparityindexLastVisiblePrice LastVisiblePrice_DefaultValue { get; set; }
		 

		/// <summary>
		/// What type of legend symbol to render for this series. Can be one of`areaMarker`, `lineMarker` or `rectangle`.
		/// </summary>
		public PlotOptionsDisparityindexLegendSymbol LegendSymbol { get; set; }
		private PlotOptionsDisparityindexLegendSymbol LegendSymbol_DefaultValue { get; set; }
		 

		/// <summary>
		/// The line cap used for line ends and line joins on the graph.
		/// </summary>
		public PlotOptionsDisparityindexLinecap Linecap { get; set; }
		private PlotOptionsDisparityindexLinecap Linecap_DefaultValue { get; set; }
		...
		/// 
		/// </summary>
		public PlotOptionsDisparityindexMarker Marker { get; set; }
		private PlotOptionsDisparityindexMarker Marker_DefaultValue { get; set; }
		...
		/// </summary>
		public PlotOptionsDisparityindexOnPoint OnPoint { get; set; }
		private PlotOptionsDisparityindexOnPoint OnPoint_DefaultValue { get; set; }
		...
		/// 
		/// </summary>
		public PlotOptionsDisparityindexParams Params { get; set; }
		private PlotOptionsDisparityindexParams Params_DefaultValue { get; set; }
		 

		/// <summary>
		/// Properties for each single point.
		/// </summary>
		public PlotOptionsDisparityindexPoint Point { get; set; }
		private PlotOptionsDisparityindexPoint Point_DefaultValue { get; set; }
		...
		/// </summary>
		public PlotOptionsDisparityindexSonification Sonification { get; set; }
		private PlotOptionsDisparityindexSonification Sonification_DefaultValue { get; set; }
		 

		/// <summary>
		/// 
		/// </summary>
		public PlotOptionsDisparityindexStates States { get; set; }
		private PlotOptionsDisparityindexStates States_DefaultValue { get; set; }
		 

		/// <summary>
		/// Whether to apply steps to the line. Possible values are `left`,`center` and `right`.
		/// </summary>
		public PlotOptionsDisparityindexStep Step { get; set; }
		private PlotOptionsDisparityindexStep Step_DefaultValue { get; set; }
		...
		/// </summary>
		public PlotOptionsDisparityindexTooltip Tooltip { get; set; }
		private PlotOptionsDisparityindexTooltip Tooltip_DefaultValue { get; set; }
		...
		/// </summary>
		public List<PlotOptionsDisparityindexZones> Zones { get; set; }
		private List<PlotOptionsDisparityindexZones> Zones_DefaultValue { get; set; }
