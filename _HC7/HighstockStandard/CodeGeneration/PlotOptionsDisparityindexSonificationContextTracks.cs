...
{
	public partial class PlotOptionsDisparityindexSonificationContextTracks  : BaseObject
	{
		Hashtable h = new Hashtable();

		public PlotOptionsDisparityindexSonificationContextTracks()
		{
			ActiveWhen = ActiveWhen_DefaultValue = new PlotOptionsDisparityindexSonificationContextTracksActiveWhen();
			Instrument = Instrument_DefaultValue = null;
			InstrumentString = InstrumentString_DefaultValue = "null";
			Mapping = Mapping_DefaultValue = new PlotOptionsDisparityindexSonificationContextTracksMapping();
			MidiName = MidiName_DefaultValue = "";
			PointGrouping = PointGrouping_DefaultValue = new PlotOptionsDisparityindexSonificationContextTracksPointGrouping();
			...
			Type = Type_DefaultValue = PlotOptionsDisparityindexSonificationContextTracksType.Instrument;
			ValueInterval = ValueInterval_DefaultValue = null;
			ValueMapFunction = ValueMapFunction_DefaultValue = PlotOptionsDisparityindexSonificationContextTracksValueMapFunction.Linear;
		...
		/// </summary>
		public PlotOptionsDisparityindexSonificationContextTracksActiveWhen ActiveWhen { get; set; }
		private PlotOptionsDisparityindexSonificationContextTracksActiveWhen ActiveWhen_DefaultValue { get; set; }
		...
		/// </summary>
		public PlotOptionsDisparityindexSonificationContextTracksMapping Mapping { get; set; }
		private PlotOptionsDisparityindexSonificationContextTracksMapping Mapping_DefaultValue { get; set; }
		...
		/// </summary>
		public PlotOptionsDisparityindexSonificationContextTracksPointGrouping PointGrouping { get; set; }
		private PlotOptionsDisparityindexSonificationContextTracksPointGrouping PointGrouping_DefaultValue { get; set; }
		...
		/// </summary>
		public PlotOptionsDisparityindexSonificationContextTracksType Type { get; set; }
		private PlotOptionsDisparityindexSonificationContextTracksType Type_DefaultValue { get; set; }
		...
		/// </summary>
		public PlotOptionsDisparityindexSonificationContextTracksValueMapFunction ValueMapFunction { get; set; }
		private PlotOptionsDisparityindexSonificationContextTracksValueMapFunction ValueMapFunction_DefaultValue { get; set; }
