...
{
	public partial class PlotOptionsDisparityindexSonificationContextTracksActiveWhen  : BaseObject
	{
		Hashtable h = new Hashtable();

		public PlotOptionsDisparityindexSonificationContextTracksActiveWhen()
		{
