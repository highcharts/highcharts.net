...
{
	public partial class PlotOptionsDisparityindexSonificationContextTracksPointGrouping  : BaseObject
	{
		Hashtable h = new Hashtable();

		public PlotOptionsDisparityindexSonificationContextTracksPointGrouping()
		{
			Algorithm = Algorithm_DefaultValue = PlotOptionsDisparityindexSonificationContextTracksPointGroupingAlgorithm.Minimax;
		...
		/// </summary>
		public PlotOptionsDisparityindexSonificationContextTracksPointGroupingAlgorithm Algorithm { get; set; }
		private PlotOptionsDisparityindexSonificationContextTracksPointGroupingAlgorithm Algorithm_DefaultValue { get; set; }
