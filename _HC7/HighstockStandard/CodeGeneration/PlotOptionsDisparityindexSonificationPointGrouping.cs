...
{
	public partial class PlotOptionsDisparityindexSonificationPointGrouping  : BaseObject
	{
		Hashtable h = new Hashtable();

		public PlotOptionsDisparityindexSonificationPointGrouping()
		{
			Algorithm = Algorithm_DefaultValue = PlotOptionsDisparityindexSonificationPointGroupingAlgorithm.Minimax;
		...
		/// </summary>
		public PlotOptionsDisparityindexSonificationPointGroupingAlgorithm Algorithm { get; set; }
		private PlotOptionsDisparityindexSonificationPointGroupingAlgorithm Algorithm_DefaultValue { get; set; }
