...
{
	public partial class PlotOptionsDisparityindexSonificationTracks  : BaseObject
	{
		Hashtable h = new Hashtable();

		public PlotOptionsDisparityindexSonificationTracks()
		{
			ActiveWhen = ActiveWhen_DefaultValue = new PlotOptionsDisparityindexSonificationTracksActiveWhen();
			Instrument = Instrument_DefaultValue = null;
			InstrumentString = InstrumentString_DefaultValue = "null";
			Mapping = Mapping_DefaultValue = new PlotOptionsDisparityindexSonificationTracksMapping();
			MidiName = MidiName_DefaultValue = "";
			PointGrouping = PointGrouping_DefaultValue = new PlotOptionsDisparityindexSonificationTracksPointGrouping();
			RoundToMusicalNotes = RoundToMusicalNotes_DefaultValue = true;
			ShowPlayMarker = ShowPlayMarker_DefaultValue = true;
			Type = Type_DefaultValue = PlotOptionsDisparityindexSonificationTracksType.Instrument;
		...
		/// </summary>
		public PlotOptionsDisparityindexSonificationTracksActiveWhen ActiveWhen { get; set; }
		private PlotOptionsDisparityindexSonificationTracksActiveWhen ActiveWhen_DefaultValue { get; set; }
		...
		/// </summary>
		public PlotOptionsDisparityindexSonificationTracksMapping Mapping { get; set; }
		private PlotOptionsDisparityindexSonificationTracksMapping Mapping_DefaultValue { get; set; }
		...
		/// </summary>
		public PlotOptionsDisparityindexSonificationTracksPointGrouping PointGrouping { get; set; }
		private PlotOptionsDisparityindexSonificationTracksPointGrouping PointGrouping_DefaultValue { get; set; }
		...
		/// </summary>
		public PlotOptionsDisparityindexSonificationTracksType Type { get; set; }
		private PlotOptionsDisparityindexSonificationTracksType Type_DefaultValue { get; set; }
