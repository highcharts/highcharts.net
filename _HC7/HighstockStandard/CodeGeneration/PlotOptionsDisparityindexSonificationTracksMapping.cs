...
{
	public partial class PlotOptionsDisparityindexSonificationTracksMapping  : BaseObject
	{
		Hashtable h = new Hashtable();

		public PlotOptionsDisparityindexSonificationTracksMapping()
		{
			Frequency = Frequency_DefaultValue = new PlotOptionsDisparityindexSonificationTracksMappingFrequency();
			GapBetweenNotes = GapBetweenNotes_DefaultValue = new PlotOptionsDisparityindexSonificationTracksMappingGapBetweenNotes();
			Highpass = Highpass_DefaultValue = new PlotOptionsDisparityindexSonificationTracksMappingHighpass();
			Lowpass = Lowpass_DefaultValue = new PlotOptionsDisparityindexSonificationTracksMappingLowpass();
			NoteDuration = NoteDuration_DefaultValue = new PlotOptionsDisparityindexSonificationTracksMappingNoteDuration();
			Pan = Pan_DefaultValue = new PlotOptionsDisparityindexSonificationTracksMappingPan();
			Pitch = Pitch_DefaultValue = new PlotOptionsDisparityindexSonificationTracksMappingPitch();
			PitchString = PitchString_DefaultValue = "null";
			PitchNumber = PitchNumber_DefaultValue = null;
			PlayDelay = PlayDelay_DefaultValue = new PlotOptionsDisparityindexSonificationTracksMappingPlayDelay();
			Time = Time_DefaultValue = new PlotOptionsDisparityindexSonificationTracksMappingTime();
			TimeString = TimeString_DefaultValue = "null";
			TimeNumber = TimeNumber_DefaultValue = null;
			Tremolo = Tremolo_DefaultValue = new PlotOptionsDisparityindexSonificationTracksMappingTremolo();
			Volume = Volume_DefaultValue = new PlotOptionsDisparityindexSonificationTracksMappingVolume();
		...
		/// </summary>
		public PlotOptionsDisparityindexSonificationTracksMappingFrequency Frequency { get; set; }
		private PlotOptionsDisparityindexSonificationTracksMappingFrequency Frequency_DefaultValue { get; set; }
		...
		/// </summary>
		public PlotOptionsDisparityindexSonificationTracksMappingGapBetweenNotes GapBetweenNotes { get; set; }
		private PlotOptionsDisparityindexSonificationTracksMappingGapBetweenNotes GapBetweenNotes_DefaultValue { get; set; }
		...
		/// </summary>
		public PlotOptionsDisparityindexSonificationTracksMappingHighpass Highpass { get; set; }
		private PlotOptionsDisparityindexSonificationTracksMappingHighpass Highpass_DefaultValue { get; set; }
		...
		/// </summary>
		public PlotOptionsDisparityindexSonificationTracksMappingLowpass Lowpass { get; set; }
		private PlotOptionsDisparityindexSonificationTracksMappingLowpass Lowpass_DefaultValue { get; set; }
		...
		/// </summary>
		public PlotOptionsDisparityindexSonificationTracksMappingNoteDuration NoteDuration { get; set; }
		private PlotOptionsDisparityindexSonificationTracksMappingNoteDuration NoteDuration_DefaultValue { get; set; }
		...
		/// </summary>
		public PlotOptionsDisparityindexSonificationTracksMappingPan Pan { get; set; }
		private PlotOptionsDisparityindexSonificationTracksMappingPan Pan_DefaultValue { get; set; }
		...
		/// </summary>
		public PlotOptionsDisparityindexSonificationTracksMappingPitch Pitch { get; set; }
		private PlotOptionsDisparityindexSonificationTracksMappingPitch Pitch_DefaultValue { get; set; }
		...
		/// </summary>
		public PlotOptionsDisparityindexSonificationTracksMappingPlayDelay PlayDelay { get; set; }
		private PlotOptionsDisparityindexSonificationTracksMappingPlayDelay PlayDelay_DefaultValue { get; set; }
		...
		/// </summary>
		public PlotOptionsDisparityindexSonificationTracksMappingTime Time { get; set; }
		private PlotOptionsDisparityindexSonificationTracksMappingTime Time_DefaultValue { get; set; }
		...
		/// </summary>
		public PlotOptionsDisparityindexSonificationTracksMappingTremolo Tremolo { get; set; }
		private PlotOptionsDisparityindexSonificationTracksMappingTremolo Tremolo_DefaultValue { get; set; }
		 

		/// <summary>
		/// The volume of notes, from 0 to 1.
		/// </summary>
		public PlotOptionsDisparityindexSonificationTracksMappingVolume Volume { get; set; }
		private PlotOptionsDisparityindexSonificationTracksMappingVolume Volume_DefaultValue { get; set; }
