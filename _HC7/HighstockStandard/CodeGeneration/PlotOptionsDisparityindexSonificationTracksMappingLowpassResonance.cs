...
{
	public partial class PlotOptionsDisparityindexSonificationTracksMappingLowpassResonance  : BaseObject
	{
		Hashtable h = new Hashtable();

		public PlotOptionsDisparityindexSonificationTracksMappingLowpassResonance()
		{
			MapFunction = MapFunction_DefaultValue = PlotOptionsDisparityindexSonificationTracksMappingLowpassResonanceMapFunction.Linear;
			MapTo = MapTo_DefaultValue = "";
			Max = Max_DefaultValue = null;
			Min = Min_DefaultValue = null;
			Value = Value_DefaultValue = null;
			Within = Within_DefaultValue = PlotOptionsDisparityindexSonificationTracksMappingLowpassResonanceWithin.Chart;
		...
		/// </summary>
		public PlotOptionsDisparityindexSonificationTracksMappingLowpassResonanceMapFunction MapFunction { get; set; }
		private PlotOptionsDisparityindexSonificationTracksMappingLowpassResonanceMapFunction MapFunction_DefaultValue { get; set; }
		...
		/// </summary>
		public PlotOptionsDisparityindexSonificationTracksMappingLowpassResonanceWithin Within { get; set; }
		private PlotOptionsDisparityindexSonificationTracksMappingLowpassResonanceWithin Within_DefaultValue { get; set; }
