...
{
	public partial class PlotOptionsDisparityindexSonificationTracksMappingNoteDuration  : BaseObject
	{
		Hashtable h = new Hashtable();

		public PlotOptionsDisparityindexSonificationTracksMappingNoteDuration()
		{
			MapFunction = MapFunction_DefaultValue = PlotOptionsDisparityindexSonificationTracksMappingNoteDurationMapFunction.Linear;
			MapTo = MapTo_DefaultValue = "";
			Max = Max_DefaultValue = null;
			Min = Min_DefaultValue = null;
			Value = Value_DefaultValue = null;
			Within = Within_DefaultValue = PlotOptionsDisparityindexSonificationTracksMappingNoteDurationWithin.Chart;
		...
		/// </summary>
		public PlotOptionsDisparityindexSonificationTracksMappingNoteDurationMapFunction MapFunction { get; set; }
		private PlotOptionsDisparityindexSonificationTracksMappingNoteDurationMapFunction MapFunction_DefaultValue { get; set; }
		...
		/// </summary>
		public PlotOptionsDisparityindexSonificationTracksMappingNoteDurationWithin Within { get; set; }
		private PlotOptionsDisparityindexSonificationTracksMappingNoteDurationWithin Within_DefaultValue { get; set; }
