...
{
	public partial class PlotOptionsDisparityindexSonificationTracksMappingPan  : BaseObject
	{
		Hashtable h = new Hashtable();

		public PlotOptionsDisparityindexSonificationTracksMappingPan()
		{
			MapFunction = MapFunction_DefaultValue = PlotOptionsDisparityindexSonificationTracksMappingPanMapFunction.Linear;
			MapTo = MapTo_DefaultValue = "";
			Max = Max_DefaultValue = null;
			Min = Min_DefaultValue = null;
			Value = Value_DefaultValue = null;
			Within = Within_DefaultValue = PlotOptionsDisparityindexSonificationTracksMappingPanWithin.Chart;
		...
		/// </summary>
		public PlotOptionsDisparityindexSonificationTracksMappingPanMapFunction MapFunction { get; set; }
		private PlotOptionsDisparityindexSonificationTracksMappingPanMapFunction MapFunction_DefaultValue { get; set; }
		...
		/// </summary>
		public PlotOptionsDisparityindexSonificationTracksMappingPanWithin Within { get; set; }
		private PlotOptionsDisparityindexSonificationTracksMappingPanWithin Within_DefaultValue { get; set; }
