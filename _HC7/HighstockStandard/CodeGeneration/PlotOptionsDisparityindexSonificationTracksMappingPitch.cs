...
{
	public partial class PlotOptionsDisparityindexSonificationTracksMappingPitch  : BaseObject
	{
		Hashtable h = new Hashtable();

		public PlotOptionsDisparityindexSonificationTracksMappingPitch()
		{
			MapFunction = MapFunction_DefaultValue = PlotOptionsDisparityindexSonificationTracksMappingPitchMapFunction.Linear;
		...
		/// </summary>
		public PlotOptionsDisparityindexSonificationTracksMappingPitchMapFunction MapFunction { get; set; }
		private PlotOptionsDisparityindexSonificationTracksMappingPitchMapFunction MapFunction_DefaultValue { get; set; }
