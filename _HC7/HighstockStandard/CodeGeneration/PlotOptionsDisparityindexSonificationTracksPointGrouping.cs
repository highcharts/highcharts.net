...
namespace Highsoft.Web.Mvc.Stocks
{
	public partial class PlotOptionsDisparityindexSonificationTracksPointGrouping  : BaseObject
	{
		...
		{
			if (Algorithm != PlotOptionsDisparityindexSonificationTracksPointGroupingAlgorithm.Null) h.Add("algorithm", highstock.FirstCharacterToLower(Algorithm.ToString()));
