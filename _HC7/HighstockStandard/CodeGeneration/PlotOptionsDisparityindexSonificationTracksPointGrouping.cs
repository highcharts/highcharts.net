...
{
	public partial class PlotOptionsDisparityindexSonificationTracksPointGrouping  : BaseObject
	{
		Hashtable h = new Hashtable();

		public PlotOptionsDisparityindexSonificationTracksPointGrouping()
		{
			Algorithm = Algorithm_DefaultValue = PlotOptionsDisparityindexSonificationTracksPointGroupingAlgorithm.Minimax;
		...
		/// </summary>
		public PlotOptionsDisparityindexSonificationTracksPointGroupingAlgorithm Algorithm { get; set; }
		private PlotOptionsDisparityindexSonificationTracksPointGroupingAlgorithm Algorithm_DefaultValue { get; set; }
