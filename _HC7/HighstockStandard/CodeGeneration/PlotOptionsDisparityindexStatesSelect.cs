...
{
	public partial class PlotOptionsDisparityindexStatesSelect  : BaseObject
	{
		Hashtable h = new Hashtable();

		public PlotOptionsDisparityindexStatesSelect()
		{
			Animation = Animation_DefaultValue = new Animation() { Enabled = true };
			Enabled = Enabled_DefaultValue = null;
			Halo = Halo_DefaultValue = new PlotOptionsDisparityindexStatesSelectHalo();
			LineWidth = LineWidth_DefaultValue = null;
			LineWidthPlus = LineWidthPlus_DefaultValue = null;
			Marker = Marker_DefaultValue = new PlotOptionsDisparityindexStatesSelectMarker();
		...
		/// </summary>
		public PlotOptionsDisparityindexStatesSelectHalo Halo { get; set; }
		private PlotOptionsDisparityindexStatesSelectHalo Halo_DefaultValue { get; set; }
		...
		/// </summary>
		public PlotOptionsDisparityindexStatesSelectMarker Marker { get; set; }
		private PlotOptionsDisparityindexStatesSelectMarker Marker_DefaultValue { get; set; }
