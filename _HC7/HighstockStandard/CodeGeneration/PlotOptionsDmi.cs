...
namespace Highsoft.Web.Mvc.Stocks
{
	public partial class PlotOptionsDmi  : BaseObject
	{
		...
		public PlotOptionsDmi()
		{
			...
			Zones = Zones_DefaultValue = new List<PlotOptionsDmiZone>();
		...
		/// </summary>
		public List<PlotOptionsDmiZone> Zones { get; set; }
		private List<PlotOptionsDmiZone> Zones_DefaultValue { get; set; }
