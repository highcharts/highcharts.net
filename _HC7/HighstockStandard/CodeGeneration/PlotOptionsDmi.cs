...
{
	public partial class PlotOptionsDmi  : BaseObject
	{
		Hashtable h = new Hashtable();

		public PlotOptionsDmi()
		{
			Accessibility = Accessibility_DefaultValue = new PlotOptionsDmiAccessibility();
			AllowPointSelect = AllowPointSelect_DefaultValue = false;
			Animation = Animation_DefaultValue = new Animation() { Enabled = true };
			AnimationBool = AnimationBool_DefaultValue = true;
			AnimationLimit = AnimationLimit_DefaultValue = null;
			BoostBlending = BoostBlending_DefaultValue = PlotOptionsDmiBoostBlending.Undefined;
			...
			Compare = Compare_DefaultValue = PlotOptionsDmiCompare.Percent;
			CompareBase = CompareBase_DefaultValue = PlotOptionsDmiCompareBase.Min;
			...
			Cursor = Cursor_DefaultValue = PlotOptionsDmiCursor.Null;
			Custom = Custom_DefaultValue = new Hashtable();
			DashStyle = DashStyle_DefaultValue = PlotOptionsDmiDashStyle.Null;
			DataGrouping = DataGrouping_DefaultValue = new PlotOptionsDmiDataGrouping();
			DataLabels = DataLabels_DefaultValue = new PlotOptionsDmiDataLabels();
			DataSorting = DataSorting_DefaultValue = new PlotOptionsDmiDataSorting();
			Description = Description_DefaultValue = "";
			EnableMouseTracking = EnableMouseTracking_DefaultValue = true;
			Events = Events_DefaultValue = new PlotOptionsDmiEvents();
			FindNearestPointBy = FindNearestPointBy_DefaultValue = PlotOptionsDmiFindNearestPointBy.X;
			GapSize = GapSize_DefaultValue = 0;
			GapUnit = GapUnit_DefaultValue = PlotOptionsDmiGapUnit.Relative;
			GetExtremesFromAll = GetExtremesFromAll_DefaultValue = false;
			InactiveOtherPoints = InactiveOtherPoints_DefaultValue = false;
			IncludeInDataExport = IncludeInDataExport_DefaultValue = null;
			Label = Label_DefaultValue = new PlotOptionsDmiLabel();
			LastPrice = LastPrice_DefaultValue = new PlotOptionsDmiLastPrice();
			LastVisiblePrice = LastVisiblePrice_DefaultValue = new PlotOptionsDmiLastVisiblePrice();
			LegendSymbol = LegendSymbol_DefaultValue = PlotOptionsDmiLegendSymbol.Rectangle;
			Linecap = Linecap_DefaultValue = PlotOptionsDmiLinecap.Round;
			LineWidth = LineWidth_DefaultValue = 2;
			LinkedTo = LinkedTo_DefaultValue = "";
			Marker = Marker_DefaultValue = new PlotOptionsDmiMarker();
			MinusDILine = MinusDILine_DefaultValue = new PlotOptionsDmiMinusDILine();
			NegativeColor = NegativeColor_DefaultValue = "";
			OnPoint = OnPoint_DefaultValue = new PlotOptionsDmiOnPoint();
			Opacity = Opacity_DefaultValue = 1;
			Params = Params_DefaultValue = new PlotOptionsDmiParams();
			...
			Sonification = Sonification_DefaultValue = new PlotOptionsDmiSonification();
			States = States_DefaultValue = new PlotOptionsDmiStates();
			Step = Step_DefaultValue = PlotOptionsDmiStep.Null;
			StickyTracking = StickyTracking_DefaultValue = true;
			Threshold = Threshold_DefaultValue = 0;
			Tooltip = Tooltip_DefaultValue = new PlotOptionsDmiTooltip();
			TurboThreshold = TurboThreshold_DefaultValue = 1000;
			Visible = Visible_DefaultValue = true;
			ZoneAxis = ZoneAxis_DefaultValue = "y";
			Zones = Zones_DefaultValue = new List<PlotOptionsDmiZones>();
		...
		/// </summary>
		public PlotOptionsDmiAccessibility Accessibility { get; set; }
		private PlotOptionsDmiAccessibility Accessibility_DefaultValue { get; set; }
		...
		/// </summary>
		public PlotOptionsDmiBoostBlending BoostBlending { get; set; }
		private PlotOptionsDmiBoostBlending BoostBlending_DefaultValue { get; set; }
		...
		/// </summary>
		public PlotOptionsDmiCompare Compare { get; set; }
		private PlotOptionsDmiCompare Compare_DefaultValue { get; set; }
		 

		/// <summary>
		/// When [compare](#plotOptions.series.compare) is `percent`, this optiondictates whether to use 0 or 100 as the base of comparison.
		/// </summary>
		public PlotOptionsDmiCompareBase CompareBase { get; set; }
		private PlotOptionsDmiCompareBase CompareBase_DefaultValue { get; set; }
		...
		/// </summary>
		public PlotOptionsDmiCursor Cursor { get; set; }
		private PlotOptionsDmiCursor Cursor_DefaultValue { get; set; }
		...
		/// </summary>
		public PlotOptionsDmiDashStyle DashStyle { get; set; }
		private PlotOptionsDmiDashStyle DashStyle_DefaultValue { get; set; }
		 

		/// <summary>
		/// 
		/// </summary>
		public PlotOptionsDmiDataGrouping DataGrouping { get; set; }
		private PlotOptionsDmiDataGrouping DataGrouping_DefaultValue { get; set; }
		...
		/// </summary>
		public PlotOptionsDmiDataLabels DataLabels { get; set; }
		private PlotOptionsDmiDataLabels DataLabels_DefaultValue { get; set; }
		 

		/// <summary>
		/// Options for the series data sorting.
		/// </summary>
		public PlotOptionsDmiDataSorting DataSorting { get; set; }
		private PlotOptionsDmiDataSorting DataSorting_DefaultValue { get; set; }
		...
		/// </summary>
		public PlotOptionsDmiEvents Events { get; set; }
		private PlotOptionsDmiEvents Events_DefaultValue { get; set; }
		...
		/// </summary>
		public PlotOptionsDmiFindNearestPointBy FindNearestPointBy { get; set; }
		private PlotOptionsDmiFindNearestPointBy FindNearestPointBy_DefaultValue { get; set; }
		...
		/// </summary>
		public PlotOptionsDmiGapUnit GapUnit { get; set; }
		private PlotOptionsDmiGapUnit GapUnit_DefaultValue { get; set; }
		...
		/// </summary>
		public PlotOptionsDmiLabel Label { get; set; }
		private PlotOptionsDmiLabel Label_DefaultValue { get; set; }
		 

		/// <summary>
		/// The line marks the last price from all points.
		/// </summary>
		public PlotOptionsDmiLastPrice LastPrice { get; set; }
		private PlotOptionsDmiLastPrice LastPrice_DefaultValue { get; set; }
		 

		/// <summary>
		/// The line marks the last price from visible range of points.
		/// </summary>
		public PlotOptionsDmiLastVisiblePrice LastVisiblePrice { get; set; }
		private PlotOptionsDmiLastVisiblePrice LastVisiblePrice_DefaultValue { get; set; }
		 

		/// <summary>
		/// What type of legend symbol to render for this series. Can be one of`areaMarker`, `lineMarker` or `rectangle`.
		/// </summary>
		public PlotOptionsDmiLegendSymbol LegendSymbol { get; set; }
		private PlotOptionsDmiLegendSymbol LegendSymbol_DefaultValue { get; set; }
		 

		/// <summary>
		/// The line cap used for line ends and line joins on the graph.
		/// </summary>
		public PlotOptionsDmiLinecap Linecap { get; set; }
		private PlotOptionsDmiLinecap Linecap_DefaultValue { get; set; }
		...
		/// 
		/// </summary>
		public PlotOptionsDmiMarker Marker { get; set; }
		private PlotOptionsDmiMarker Marker_DefaultValue { get; set; }
		 

		/// <summary>
		/// -DI line options.
		/// </summary>
		public PlotOptionsDmiMinusDILine MinusDILine { get; set; }
		private PlotOptionsDmiMinusDILine MinusDILine_DefaultValue { get; set; }
		...
		/// </summary>
		public PlotOptionsDmiOnPoint OnPoint { get; set; }
		private PlotOptionsDmiOnPoint OnPoint_DefaultValue { get; set; }
		...
		/// 
		/// </summary>
		public PlotOptionsDmiParams Params { get; set; }
		private PlotOptionsDmiParams Params_DefaultValue { get; set; }
		 

		/// <summary>
		/// +DI line options.
		/// </summary>
		public PlotOptionsDmiPlusDILine PlusDILine { get; set; }
		private PlotOptionsDmiPlusDILine PlusDILine_DefaultValue { get; set; }
		 

		/// <summary>
		/// Properties for each single point.
		/// </summary>
		public PlotOptionsDmiPoint Point { get; set; }
		private PlotOptionsDmiPoint Point_DefaultValue { get; set; }
		...
		/// </summary>
		public PlotOptionsDmiSonification Sonification { get; set; }
		private PlotOptionsDmiSonification Sonification_DefaultValue { get; set; }
		 

		/// <summary>
		/// 
		/// </summary>
		public PlotOptionsDmiStates States { get; set; }
		private PlotOptionsDmiStates States_DefaultValue { get; set; }
		 

		/// <summary>
		/// Whether to apply steps to the line. Possible values are `left`,`center` and `right`.
		/// </summary>
		public PlotOptionsDmiStep Step { get; set; }
		private PlotOptionsDmiStep Step_DefaultValue { get; set; }
		...
		/// 
		/// </summary>
		public PlotOptionsDmiTooltip Tooltip { get; set; }
		private PlotOptionsDmiTooltip Tooltip_DefaultValue { get; set; }
		...
		/// </summary>
		public List<PlotOptionsDmiZones> Zones { get; set; }
		private List<PlotOptionsDmiZones> Zones_DefaultValue { get; set; }
		...
		internal override Hashtable ToHashtable(Highstock highstock)
		{
			...
			if (MinusDILine.IsDirty(highstock)) h.Add("minusDILine",MinusDILine.ToHashtable(highstock));
