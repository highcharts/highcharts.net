...
{
	public partial class PlotOptionsDmiSonification  : BaseObject
	{
		Hashtable h = new Hashtable();

		public PlotOptionsDmiSonification()
		{
		}	
		...
		/// </summary>
		public PlotOptionsDmiSonificationContextTracks ContextTracks { get; set; }
		 

		/// <summary>
		/// Default options for all this series' instrument tracks.
		/// </summary>
		public PlotOptionsDmiSonificationDefaultInstrumentOptions DefaultInstrumentOptions { get; set; }
		 

		/// <summary>
		/// Default options for all this series' speech tracks.
		/// </summary>
		public PlotOptionsDmiSonificationDefaultSpeechOptions DefaultSpeechOptions { get; set; }
		...
		/// </summary>
		public PlotOptionsDmiSonificationPointGrouping PointGrouping { get; set; }
		 

		/// <summary>
		/// Tracks for this series.Given as an array of instrument tracks, speech tracks, or a mix of both.
		/// </summary>
		public PlotOptionsDmiSonificationTracks Tracks { get; set; }
