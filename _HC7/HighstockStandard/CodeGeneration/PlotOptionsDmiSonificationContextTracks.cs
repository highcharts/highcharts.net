...
{
	public partial class PlotOptionsDmiSonificationContextTracks  : BaseObject
	{
		Hashtable h = new Hashtable();

		public PlotOptionsDmiSonificationContextTracks()
		{
			ActiveWhen = ActiveWhen_DefaultValue = new PlotOptionsDmiSonificationContextTracksActiveWhen();
			Instrument = Instrument_DefaultValue = null;
			InstrumentString = InstrumentString_DefaultValue = "null";
			Mapping = Mapping_DefaultValue = new PlotOptionsDmiSonificationContextTracksMapping();
			MidiName = MidiName_DefaultValue = "";
			PointGrouping = PointGrouping_DefaultValue = new PlotOptionsDmiSonificationContextTracksPointGrouping();
			...
			Type = Type_DefaultValue = PlotOptionsDmiSonificationContextTracksType.Instrument;
			ValueInterval = ValueInterval_DefaultValue = null;
			ValueMapFunction = ValueMapFunction_DefaultValue = PlotOptionsDmiSonificationContextTracksValueMapFunction.Linear;
		...
		/// </summary>
		public PlotOptionsDmiSonificationContextTracksActiveWhen ActiveWhen { get; set; }
		private PlotOptionsDmiSonificationContextTracksActiveWhen ActiveWhen_DefaultValue { get; set; }
		...
		/// </summary>
		public PlotOptionsDmiSonificationContextTracksMapping Mapping { get; set; }
		private PlotOptionsDmiSonificationContextTracksMapping Mapping_DefaultValue { get; set; }
		...
		/// </summary>
		public PlotOptionsDmiSonificationContextTracksPointGrouping PointGrouping { get; set; }
		private PlotOptionsDmiSonificationContextTracksPointGrouping PointGrouping_DefaultValue { get; set; }
		...
		/// </summary>
		public PlotOptionsDmiSonificationContextTracksType Type { get; set; }
		private PlotOptionsDmiSonificationContextTracksType Type_DefaultValue { get; set; }
		...
		/// </summary>
		public PlotOptionsDmiSonificationContextTracksValueMapFunction ValueMapFunction { get; set; }
		private PlotOptionsDmiSonificationContextTracksValueMapFunction ValueMapFunction_DefaultValue { get; set; }
