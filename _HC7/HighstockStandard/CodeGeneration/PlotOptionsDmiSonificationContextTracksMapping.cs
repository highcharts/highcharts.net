...
{
	public partial class PlotOptionsDmiSonificationContextTracksMapping  : BaseObject
	{
		Hashtable h = new Hashtable();

		public PlotOptionsDmiSonificationContextTracksMapping()
		{
			Frequency = Frequency_DefaultValue = new PlotOptionsDmiSonificationContextTracksMappingFrequency();
			GapBetweenNotes = GapBetweenNotes_DefaultValue = new PlotOptionsDmiSonificationContextTracksMappingGapBetweenNotes();
			Highpass = Highpass_DefaultValue = new PlotOptionsDmiSonificationContextTracksMappingHighpass();
			Lowpass = Lowpass_DefaultValue = new PlotOptionsDmiSonificationContextTracksMappingLowpass();
			NoteDuration = NoteDuration_DefaultValue = new PlotOptionsDmiSonificationContextTracksMappingNoteDuration();
			Pan = Pan_DefaultValue = new PlotOptionsDmiSonificationContextTracksMappingPan();
			Pitch = Pitch_DefaultValue = new PlotOptionsDmiSonificationContextTracksMappingPitch();
			PitchString = PitchString_DefaultValue = "null";
			PitchNumber = PitchNumber_DefaultValue = null;
			PlayDelay = PlayDelay_DefaultValue = new PlotOptionsDmiSonificationContextTracksMappingPlayDelay();
			Time = Time_DefaultValue = new PlotOptionsDmiSonificationContextTracksMappingTime();
			TimeString = TimeString_DefaultValue = "null";
			TimeNumber = TimeNumber_DefaultValue = null;
			Tremolo = Tremolo_DefaultValue = new PlotOptionsDmiSonificationContextTracksMappingTremolo();
			Volume = Volume_DefaultValue = new PlotOptionsDmiSonificationContextTracksMappingVolume();
		...
		/// </summary>
		public PlotOptionsDmiSonificationContextTracksMappingFrequency Frequency { get; set; }
		private PlotOptionsDmiSonificationContextTracksMappingFrequency Frequency_DefaultValue { get; set; }
		...
		/// </summary>
		public PlotOptionsDmiSonificationContextTracksMappingGapBetweenNotes GapBetweenNotes { get; set; }
		private PlotOptionsDmiSonificationContextTracksMappingGapBetweenNotes GapBetweenNotes_DefaultValue { get; set; }
		...
		/// </summary>
		public PlotOptionsDmiSonificationContextTracksMappingHighpass Highpass { get; set; }
		private PlotOptionsDmiSonificationContextTracksMappingHighpass Highpass_DefaultValue { get; set; }
		...
		/// </summary>
		public PlotOptionsDmiSonificationContextTracksMappingLowpass Lowpass { get; set; }
		private PlotOptionsDmiSonificationContextTracksMappingLowpass Lowpass_DefaultValue { get; set; }
		...
		/// </summary>
		public PlotOptionsDmiSonificationContextTracksMappingNoteDuration NoteDuration { get; set; }
		private PlotOptionsDmiSonificationContextTracksMappingNoteDuration NoteDuration_DefaultValue { get; set; }
		...
		/// </summary>
		public PlotOptionsDmiSonificationContextTracksMappingPan Pan { get; set; }
		private PlotOptionsDmiSonificationContextTracksMappingPan Pan_DefaultValue { get; set; }
		...
		/// </summary>
		public PlotOptionsDmiSonificationContextTracksMappingPitch Pitch { get; set; }
		private PlotOptionsDmiSonificationContextTracksMappingPitch Pitch_DefaultValue { get; set; }
		...
		/// </summary>
		public PlotOptionsDmiSonificationContextTracksMappingPlayDelay PlayDelay { get; set; }
		private PlotOptionsDmiSonificationContextTracksMappingPlayDelay PlayDelay_DefaultValue { get; set; }
		...
		/// </summary>
		public PlotOptionsDmiSonificationContextTracksMappingTime Time { get; set; }
		private PlotOptionsDmiSonificationContextTracksMappingTime Time_DefaultValue { get; set; }
		...
		/// </summary>
		public PlotOptionsDmiSonificationContextTracksMappingTremolo Tremolo { get; set; }
		private PlotOptionsDmiSonificationContextTracksMappingTremolo Tremolo_DefaultValue { get; set; }
		 

		/// <summary>
		/// The volume of notes, from 0 to 1.
		/// </summary>
		public PlotOptionsDmiSonificationContextTracksMappingVolume Volume { get; set; }
		private PlotOptionsDmiSonificationContextTracksMappingVolume Volume_DefaultValue { get; set; }
