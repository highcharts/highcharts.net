...
{
	public partial class PlotOptionsDmiSonificationContextTracksMappingPitch  : BaseObject
	{
		Hashtable h = new Hashtable();

		public PlotOptionsDmiSonificationContextTracksMappingPitch()
		{
			MapFunction = MapFunction_DefaultValue = PlotOptionsDmiSonificationContextTracksMappingPitchMapFunction.Linear;
		...
		/// </summary>
		public PlotOptionsDmiSonificationContextTracksMappingPitchMapFunction MapFunction { get; set; }
		private PlotOptionsDmiSonificationContextTracksMappingPitchMapFunction MapFunction_DefaultValue { get; set; }
