...
{
	public partial class PlotOptionsDmiSonificationContextTracksMappingVolume  : BaseObject
	{
		Hashtable h = new Hashtable();

		public PlotOptionsDmiSonificationContextTracksMappingVolume()
		{
			MapFunction = MapFunction_DefaultValue = PlotOptionsDmiSonificationContextTracksMappingVolumeMapFunction.Linear;
			MapTo = MapTo_DefaultValue = "";
			Max = Max_DefaultValue = null;
			Min = Min_DefaultValue = null;
			Value = Value_DefaultValue = null;
			Within = Within_DefaultValue = PlotOptionsDmiSonificationContextTracksMappingVolumeWithin.Chart;
		...
		/// </summary>
		public PlotOptionsDmiSonificationContextTracksMappingVolumeMapFunction MapFunction { get; set; }
		private PlotOptionsDmiSonificationContextTracksMappingVolumeMapFunction MapFunction_DefaultValue { get; set; }
		...
		/// </summary>
		public PlotOptionsDmiSonificationContextTracksMappingVolumeWithin Within { get; set; }
		private PlotOptionsDmiSonificationContextTracksMappingVolumeWithin Within_DefaultValue { get; set; }
