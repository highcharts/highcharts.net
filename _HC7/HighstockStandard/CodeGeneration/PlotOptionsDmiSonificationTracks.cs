...
{
	public partial class PlotOptionsDmiSonificationTracks  : BaseObject
	{
		Hashtable h = new Hashtable();

		public PlotOptionsDmiSonificationTracks()
		{
			ActiveWhen = ActiveWhen_DefaultValue = new PlotOptionsDmiSonificationTracksActiveWhen();
			Instrument = Instrument_DefaultValue = null;
			InstrumentString = InstrumentString_DefaultValue = "null";
			Mapping = Mapping_DefaultValue = new PlotOptionsDmiSonificationTracksMapping();
			MidiName = MidiName_DefaultValue = "";
			PointGrouping = PointGrouping_DefaultValue = new PlotOptionsDmiSonificationTracksPointGrouping();
			RoundToMusicalNotes = RoundToMusicalNotes_DefaultValue = true;
			ShowPlayMarker = ShowPlayMarker_DefaultValue = true;
			Type = Type_DefaultValue = PlotOptionsDmiSonificationTracksType.Instrument;
		...
		/// </summary>
		public PlotOptionsDmiSonificationTracksActiveWhen ActiveWhen { get; set; }
		private PlotOptionsDmiSonificationTracksActiveWhen ActiveWhen_DefaultValue { get; set; }
		...
		/// </summary>
		public PlotOptionsDmiSonificationTracksMapping Mapping { get; set; }
		private PlotOptionsDmiSonificationTracksMapping Mapping_DefaultValue { get; set; }
		...
		/// </summary>
		public PlotOptionsDmiSonificationTracksPointGrouping PointGrouping { get; set; }
		private PlotOptionsDmiSonificationTracksPointGrouping PointGrouping_DefaultValue { get; set; }
		...
		/// </summary>
		public PlotOptionsDmiSonificationTracksType Type { get; set; }
		private PlotOptionsDmiSonificationTracksType Type_DefaultValue { get; set; }
