...
{
	public partial class PlotOptionsDmiSonificationTracksMappingFrequency  : BaseObject
	{
		Hashtable h = new Hashtable();

		public PlotOptionsDmiSonificationTracksMappingFrequency()
		{
			MapFunction = MapFunction_DefaultValue = PlotOptionsDmiSonificationTracksMappingFrequencyMapFunction.Linear;
			MapTo = MapTo_DefaultValue = "";
			Max = Max_DefaultValue = null;
			Min = Min_DefaultValue = null;
			Value = Value_DefaultValue = null;
			Within = Within_DefaultValue = PlotOptionsDmiSonificationTracksMappingFrequencyWithin.Chart;
		...
		/// </summary>
		public PlotOptionsDmiSonificationTracksMappingFrequencyMapFunction MapFunction { get; set; }
		private PlotOptionsDmiSonificationTracksMappingFrequencyMapFunction MapFunction_DefaultValue { get; set; }
		...
		/// </summary>
		public PlotOptionsDmiSonificationTracksMappingFrequencyWithin Within { get; set; }
		private PlotOptionsDmiSonificationTracksMappingFrequencyWithin Within_DefaultValue { get; set; }
