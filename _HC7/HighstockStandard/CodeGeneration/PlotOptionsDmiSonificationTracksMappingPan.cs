...
{
	public partial class PlotOptionsDmiSonificationTracksMappingPan  : BaseObject
	{
		Hashtable h = new Hashtable();

		public PlotOptionsDmiSonificationTracksMappingPan()
		{
			MapFunction = MapFunction_DefaultValue = PlotOptionsDmiSonificationTracksMappingPanMapFunction.Linear;
			MapTo = MapTo_DefaultValue = "";
			Max = Max_DefaultValue = null;
			Min = Min_DefaultValue = null;
			Value = Value_DefaultValue = null;
			Within = Within_DefaultValue = PlotOptionsDmiSonificationTracksMappingPanWithin.Chart;
		...
		/// </summary>
		public PlotOptionsDmiSonificationTracksMappingPanMapFunction MapFunction { get; set; }
		private PlotOptionsDmiSonificationTracksMappingPanMapFunction MapFunction_DefaultValue { get; set; }
		...
		/// </summary>
		public PlotOptionsDmiSonificationTracksMappingPanWithin Within { get; set; }
		private PlotOptionsDmiSonificationTracksMappingPanWithin Within_DefaultValue { get; set; }
