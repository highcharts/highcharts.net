...
{
	public partial class PlotOptionsDmiSonificationTracksMappingPitch  : BaseObject
	{
		Hashtable h = new Hashtable();

		public PlotOptionsDmiSonificationTracksMappingPitch()
		{
			MapFunction = MapFunction_DefaultValue = PlotOptionsDmiSonificationTracksMappingPitchMapFunction.Linear;
		...
		/// </summary>
		public PlotOptionsDmiSonificationTracksMappingPitchMapFunction MapFunction { get; set; }
		private PlotOptionsDmiSonificationTracksMappingPitchMapFunction MapFunction_DefaultValue { get; set; }
