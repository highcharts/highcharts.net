...
{
	public partial class PlotOptionsDmiSonificationTracksMappingTime  : BaseObject
	{
		Hashtable h = new Hashtable();

		public PlotOptionsDmiSonificationTracksMappingTime()
		{
			MapFunction = MapFunction_DefaultValue = PlotOptionsDmiSonificationTracksMappingTimeMapFunction.Linear;
			MapTo = MapTo_DefaultValue = "";
			Max = Max_DefaultValue = null;
			Min = Min_DefaultValue = null;
			Value = Value_DefaultValue = null;
			Within = Within_DefaultValue = PlotOptionsDmiSonificationTracksMappingTimeWithin.Chart;
		...
		/// </summary>
		public PlotOptionsDmiSonificationTracksMappingTimeMapFunction MapFunction { get; set; }
		private PlotOptionsDmiSonificationTracksMappingTimeMapFunction MapFunction_DefaultValue { get; set; }
		...
		/// </summary>
		public PlotOptionsDmiSonificationTracksMappingTimeWithin Within { get; set; }
		private PlotOptionsDmiSonificationTracksMappingTimeWithin Within_DefaultValue { get; set; }
