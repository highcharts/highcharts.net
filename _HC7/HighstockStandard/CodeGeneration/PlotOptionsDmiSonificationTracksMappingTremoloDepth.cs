...
{
	public partial class PlotOptionsDmiSonificationTracksMappingTremoloDepth  : BaseObject
	{
		Hashtable h = new Hashtable();

		public PlotOptionsDmiSonificationTracksMappingTremoloDepth()
		{
			MapFunction = MapFunction_DefaultValue = PlotOptionsDmiSonificationTracksMappingTremoloDepthMapFunction.Linear;
			MapTo = MapTo_DefaultValue = "";
			Max = Max_DefaultValue = null;
			Min = Min_DefaultValue = null;
			Value = Value_DefaultValue = null;
			Within = Within_DefaultValue = PlotOptionsDmiSonificationTracksMappingTremoloDepthWithin.Chart;
		...
		/// </summary>
		public PlotOptionsDmiSonificationTracksMappingTremoloDepthMapFunction MapFunction { get; set; }
		private PlotOptionsDmiSonificationTracksMappingTremoloDepthMapFunction MapFunction_DefaultValue { get; set; }
		...
		/// </summary>
		public PlotOptionsDmiSonificationTracksMappingTremoloDepthWithin Within { get; set; }
		private PlotOptionsDmiSonificationTracksMappingTremoloDepthWithin Within_DefaultValue { get; set; }
