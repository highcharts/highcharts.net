...
{
	public partial class PlotOptionsDmiSonificationTracksMappingVolume  : BaseObject
	{
		Hashtable h = new Hashtable();

		public PlotOptionsDmiSonificationTracksMappingVolume()
		{
			MapFunction = MapFunction_DefaultValue = PlotOptionsDmiSonificationTracksMappingVolumeMapFunction.Linear;
			MapTo = MapTo_DefaultValue = "";
			Max = Max_DefaultValue = null;
			Min = Min_DefaultValue = null;
			Value = Value_DefaultValue = null;
			Within = Within_DefaultValue = PlotOptionsDmiSonificationTracksMappingVolumeWithin.Chart;
		...
		/// </summary>
		public PlotOptionsDmiSonificationTracksMappingVolumeMapFunction MapFunction { get; set; }
		private PlotOptionsDmiSonificationTracksMappingVolumeMapFunction MapFunction_DefaultValue { get; set; }
		...
		/// </summary>
		public PlotOptionsDmiSonificationTracksMappingVolumeWithin Within { get; set; }
		private PlotOptionsDmiSonificationTracksMappingVolumeWithin Within_DefaultValue { get; set; }
