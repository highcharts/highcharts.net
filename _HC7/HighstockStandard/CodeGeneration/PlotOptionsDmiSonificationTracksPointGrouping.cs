...
{
	public partial class PlotOptionsDmiSonificationTracksPointGrouping  : BaseObject
	{
		Hashtable h = new Hashtable();

		public PlotOptionsDmiSonificationTracksPointGrouping()
		{
			Algorithm = Algorithm_DefaultValue = PlotOptionsDmiSonificationTracksPointGroupingAlgorithm.Minimax;
		...
		/// </summary>
		public PlotOptionsDmiSonificationTracksPointGroupingAlgorithm Algorithm { get; set; }
		private PlotOptionsDmiSonificationTracksPointGroupingAlgorithm Algorithm_DefaultValue { get; set; }
