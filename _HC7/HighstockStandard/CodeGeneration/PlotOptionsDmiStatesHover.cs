...
{
	public partial class PlotOptionsDmiStatesHover  : BaseObject
	{
		Hashtable h = new Hashtable();

		public PlotOptionsDmiStatesHover()
		{
			Animation = Animation_DefaultValue = new Animation() { Enabled = true };
			AnimationBool = AnimationBool_DefaultValue = null;
			Enabled = Enabled_DefaultValue = true;
			Halo = Halo_DefaultValue = new PlotOptionsDmiStatesHoverHalo();
			LineWidth = LineWidth_DefaultValue = null;
			LineWidthPlus = LineWidthPlus_DefaultValue = 1;
			Marker = Marker_DefaultValue = new PlotOptionsDmiStatesHoverMarker();
		...
		/// </summary>
		public PlotOptionsDmiStatesHoverHalo Halo { get; set; }
		private PlotOptionsDmiStatesHoverHalo Halo_DefaultValue { get; set; }
		...
		/// </summary>
		public PlotOptionsDmiStatesHoverMarker Marker { get; set; }
		private PlotOptionsDmiStatesHoverMarker Marker_DefaultValue { get; set; }
