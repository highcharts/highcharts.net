...
namespace Highsoft.Web.Mvc.Stocks
{
	public partial class PlotOptionsDpo  : BaseObject
	{
		...
		public PlotOptionsDpo()
		{
			...
			Zones = Zones_DefaultValue = new List<PlotOptionsDpoZone>();
		...
		/// </summary>
		public List<PlotOptionsDpoZone> Zones { get; set; }
		private List<PlotOptionsDpoZone> Zones_DefaultValue { get; set; }
