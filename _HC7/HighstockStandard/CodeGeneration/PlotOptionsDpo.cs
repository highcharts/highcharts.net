...
{
	public partial class PlotOptionsDpo  : BaseObject
	{
		Hashtable h = new Hashtable();

		public PlotOptionsDpo()
		{
			Accessibility = Accessibility_DefaultValue = new PlotOptionsDpoAccessibility();
			AllowPointSelect = AllowPointSelect_DefaultValue = false;
			Animation = Animation_DefaultValue = new Animation() { Enabled = true };
			AnimationBool = AnimationBool_DefaultValue = true;
			AnimationLimit = AnimationLimit_DefaultValue = null;
			BoostBlending = BoostBlending_DefaultValue = PlotOptionsDpoBoostBlending.Undefined;
			...
			Cursor = Cursor_DefaultValue = PlotOptionsDpoCursor.Null;
			Custom = Custom_DefaultValue = new Hashtable();
			DashStyle = DashStyle_DefaultValue = PlotOptionsDpoDashStyle.Null;
			DataGrouping = DataGrouping_DefaultValue = new PlotOptionsDpoDataGrouping();
			DataLabels = DataLabels_DefaultValue = new PlotOptionsDpoDataLabels();
			DataSorting = DataSorting_DefaultValue = new PlotOptionsDpoDataSorting();
			Description = Description_DefaultValue = "";
			EnableMouseTracking = EnableMouseTracking_DefaultValue = true;
			Events = Events_DefaultValue = new PlotOptionsDpoEvents();
			FindNearestPointBy = FindNearestPointBy_DefaultValue = PlotOptionsDpoFindNearestPointBy.X;
			GapSize = GapSize_DefaultValue = 0;
			GapUnit = GapUnit_DefaultValue = PlotOptionsDpoGapUnit.Relative;
			GetExtremesFromAll = GetExtremesFromAll_DefaultValue = false;
			InactiveOtherPoints = InactiveOtherPoints_DefaultValue = false;
			IncludeInDataExport = IncludeInDataExport_DefaultValue = null;
			Label = Label_DefaultValue = new PlotOptionsDpoLabel();
			LastPrice = LastPrice_DefaultValue = new PlotOptionsDpoLastPrice();
			LastVisiblePrice = LastVisiblePrice_DefaultValue = new PlotOptionsDpoLastVisiblePrice();
			LegendSymbol = LegendSymbol_DefaultValue = PlotOptionsDpoLegendSymbol.Rectangle;
			Linecap = Linecap_DefaultValue = PlotOptionsDpoLinecap.Round;
			LineWidth = LineWidth_DefaultValue = 2;
			LinkedTo = LinkedTo_DefaultValue = "";
			Marker = Marker_DefaultValue = new PlotOptionsDpoMarker();
			NegativeColor = NegativeColor_DefaultValue = "";
			OnPoint = OnPoint_DefaultValue = new PlotOptionsDpoOnPoint();
			Opacity = Opacity_DefaultValue = 1;
			Params = Params_DefaultValue = new PlotOptionsDpoParams();
			Point = Point_DefaultValue = new PlotOptionsDpoPoint();
			...
			Sonification = Sonification_DefaultValue = new PlotOptionsDpoSonification();
			States = States_DefaultValue = new PlotOptionsDpoStates();
			Step = Step_DefaultValue = PlotOptionsDpoStep.Null;
			StickyTracking = StickyTracking_DefaultValue = true;
			Threshold = Threshold_DefaultValue = 0;
			Tooltip = Tooltip_DefaultValue = new PlotOptionsDpoTooltip();
			TurboThreshold = TurboThreshold_DefaultValue = 1000;
			Visible = Visible_DefaultValue = true;
			ZoneAxis = ZoneAxis_DefaultValue = "y";
			Zones = Zones_DefaultValue = new List<PlotOptionsDpoZones>();
		...
		/// </summary>
		public PlotOptionsDpoAccessibility Accessibility { get; set; }
		private PlotOptionsDpoAccessibility Accessibility_DefaultValue { get; set; }
		...
		/// </summary>
		public PlotOptionsDpoBoostBlending BoostBlending { get; set; }
		private PlotOptionsDpoBoostBlending BoostBlending_DefaultValue { get; set; }
		...
		/// </summary>
		public PlotOptionsDpoCursor Cursor { get; set; }
		private PlotOptionsDpoCursor Cursor_DefaultValue { get; set; }
		...
		/// </summary>
		public PlotOptionsDpoDashStyle DashStyle { get; set; }
		private PlotOptionsDpoDashStyle DashStyle_DefaultValue { get; set; }
		...
		/// </summary>
		public PlotOptionsDpoDataGrouping DataGrouping { get; set; }
		private PlotOptionsDpoDataGrouping DataGrouping_DefaultValue { get; set; }
		...
		/// </summary>
		public PlotOptionsDpoDataLabels DataLabels { get; set; }
		private PlotOptionsDpoDataLabels DataLabels_DefaultValue { get; set; }
		 

		/// <summary>
		/// Options for the series data sorting.
		/// </summary>
		public PlotOptionsDpoDataSorting DataSorting { get; set; }
		private PlotOptionsDpoDataSorting DataSorting_DefaultValue { get; set; }
		...
		/// </summary>
		public PlotOptionsDpoEvents Events { get; set; }
		private PlotOptionsDpoEvents Events_DefaultValue { get; set; }
		...
		/// </summary>
		public PlotOptionsDpoFindNearestPointBy FindNearestPointBy { get; set; }
		private PlotOptionsDpoFindNearestPointBy FindNearestPointBy_DefaultValue { get; set; }
		...
		/// </summary>
		public PlotOptionsDpoGapUnit GapUnit { get; set; }
		private PlotOptionsDpoGapUnit GapUnit_DefaultValue { get; set; }
		...
		/// </summary>
		public PlotOptionsDpoLabel Label { get; set; }
		private PlotOptionsDpoLabel Label_DefaultValue { get; set; }
		 

		/// <summary>
		/// The line marks the last price from all points.
		/// </summary>
		public PlotOptionsDpoLastPrice LastPrice { get; set; }
		private PlotOptionsDpoLastPrice LastPrice_DefaultValue { get; set; }
		 

		/// <summary>
		/// The line marks the last price from visible range of points.
		/// </summary>
		public PlotOptionsDpoLastVisiblePrice LastVisiblePrice { get; set; }
		private PlotOptionsDpoLastVisiblePrice LastVisiblePrice_DefaultValue { get; set; }
		 

		/// <summary>
		/// What type of legend symbol to render for this series. Can be one of`lineMarker` or `rectangle`.
		/// </summary>
		public PlotOptionsDpoLegendSymbol LegendSymbol { get; set; }
		private PlotOptionsDpoLegendSymbol LegendSymbol_DefaultValue { get; set; }
		 

		/// <summary>
		/// The line cap used for line ends and line joins on the graph.
		/// </summary>
		public PlotOptionsDpoLinecap Linecap { get; set; }
		private PlotOptionsDpoLinecap Linecap_DefaultValue { get; set; }
		...
		/// </summary>
		public PlotOptionsDpoMarker Marker { get; set; }
		private PlotOptionsDpoMarker Marker_DefaultValue { get; set; }
		...
		/// </summary>
		public PlotOptionsDpoOnPoint OnPoint { get; set; }
		private PlotOptionsDpoOnPoint OnPoint_DefaultValue { get; set; }
		...
		/// <summary>
		/// Parameters used in calculation of Detrended Price Oscillator seriespoints.
		/// </summary>
		public PlotOptionsDpoParams Params { get; set; }
		private PlotOptionsDpoParams Params_DefaultValue { get; set; }
		 

		/// <summary>
		/// Properties for each single point.
		/// </summary>
		public PlotOptionsDpoPoint Point { get; set; }
		private PlotOptionsDpoPoint Point_DefaultValue { get; set; }
		...
		/// </summary>
		public PlotOptionsDpoSonification Sonification { get; set; }
		private PlotOptionsDpoSonification Sonification_DefaultValue { get; set; }
		 

		/// <summary>
		/// 
		/// </summary>
		public PlotOptionsDpoStates States { get; set; }
		private PlotOptionsDpoStates States_DefaultValue { get; set; }
		 

		/// <summary>
		/// Whether to apply steps to the line. Possible values are `left`,`center` and `right`.
		/// </summary>
		public PlotOptionsDpoStep Step { get; set; }
		private PlotOptionsDpoStep Step_DefaultValue { get; set; }
		...
		/// </summary>
		public PlotOptionsDpoTooltip Tooltip { get; set; }
		private PlotOptionsDpoTooltip Tooltip_DefaultValue { get; set; }
		...
		/// </summary>
		public List<PlotOptionsDpoZones> Zones { get; set; }
		private List<PlotOptionsDpoZones> Zones_DefaultValue { get; set; }
