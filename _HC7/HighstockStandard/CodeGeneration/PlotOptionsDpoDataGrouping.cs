...
namespace Highsoft.Web.Mvc.Stocks
{
	public partial class PlotOptionsDpoDataGrouping  : BaseObject
	{
		...
		internal override Hashtable ToHashtable()
		{
			...
			if (Approximation != Approximation_DefaultValue) { h.Add("approximation",Approximation); Highstock.AddFunction("PlotOptionsDpoDataGroupingApproximation.approximation", Approximation); }  
