...
{
	public partial class PlotOptionsDpoDragDropDragHandle  : BaseObject
	{
		public PlotOptionsDpoDragDropDragHandle()
		{
		...
		internal override Hashtable ToHashtable()
		{
			...
			if (PathFormatter != PathFormatter_DefaultValue) { h.Add("pathFormatter",PathFormatter); Highstock.AddFunction("PlotOptionsDpoDragDropDragHandlePathFormatter.pathFormatter", PathFormatter); }  
