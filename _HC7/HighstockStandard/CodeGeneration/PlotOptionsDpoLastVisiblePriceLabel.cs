...
{
	public partial class PlotOptionsDpoLastVisiblePriceLabel  : BaseObject
	{
		Hashtable h = new Hashtable();

		public PlotOptionsDpoLastVisiblePriceLabel()
		{
			Align = Align_DefaultValue = PlotOptionsDpoLastVisiblePriceLabelAlign.Null;
		...
		/// 
		/// </summary>
		public PlotOptionsDpoLastVisiblePriceLabelAlign Align { get; set; }
		private PlotOptionsDpoLastVisiblePriceLabelAlign Align_DefaultValue { get; set; }
