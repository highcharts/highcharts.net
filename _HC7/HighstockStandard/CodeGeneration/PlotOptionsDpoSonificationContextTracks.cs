...
{
	public partial class PlotOptionsDpoSonificationContextTracks  : BaseObject
	{
		Hashtable h = new Hashtable();

		public PlotOptionsDpoSonificationContextTracks()
		{
			ActiveWhen = ActiveWhen_DefaultValue = new PlotOptionsDpoSonificationContextTracksActiveWhen();
			Instrument = Instrument_DefaultValue = null;
			InstrumentString = InstrumentString_DefaultValue = "null";
			Mapping = Mapping_DefaultValue = new PlotOptionsDpoSonificationContextTracksMapping();
			MidiName = MidiName_DefaultValue = "";
			PointGrouping = PointGrouping_DefaultValue = new PlotOptionsDpoSonificationContextTracksPointGrouping();
			...
			Type = Type_DefaultValue = PlotOptionsDpoSonificationContextTracksType.Instrument;
			ValueInterval = ValueInterval_DefaultValue = null;
			ValueMapFunction = ValueMapFunction_DefaultValue = PlotOptionsDpoSonificationContextTracksValueMapFunction.Linear;
		...
		/// </summary>
		public PlotOptionsDpoSonificationContextTracksActiveWhen ActiveWhen { get; set; }
		private PlotOptionsDpoSonificationContextTracksActiveWhen ActiveWhen_DefaultValue { get; set; }
		...
		/// </summary>
		public PlotOptionsDpoSonificationContextTracksMapping Mapping { get; set; }
		private PlotOptionsDpoSonificationContextTracksMapping Mapping_DefaultValue { get; set; }
		...
		/// </summary>
		public PlotOptionsDpoSonificationContextTracksPointGrouping PointGrouping { get; set; }
		private PlotOptionsDpoSonificationContextTracksPointGrouping PointGrouping_DefaultValue { get; set; }
		...
		/// </summary>
		public PlotOptionsDpoSonificationContextTracksType Type { get; set; }
		private PlotOptionsDpoSonificationContextTracksType Type_DefaultValue { get; set; }
		...
		/// </summary>
		public PlotOptionsDpoSonificationContextTracksValueMapFunction ValueMapFunction { get; set; }
		private PlotOptionsDpoSonificationContextTracksValueMapFunction ValueMapFunction_DefaultValue { get; set; }
