...
{
	public partial class PlotOptionsDpoSonificationContextTracksMapping  : BaseObject
	{
		Hashtable h = new Hashtable();

		public PlotOptionsDpoSonificationContextTracksMapping()
		{
			Frequency = Frequency_DefaultValue = new PlotOptionsDpoSonificationContextTracksMappingFrequency();
			GapBetweenNotes = GapBetweenNotes_DefaultValue = new PlotOptionsDpoSonificationContextTracksMappingGapBetweenNotes();
			Highpass = Highpass_DefaultValue = new PlotOptionsDpoSonificationContextTracksMappingHighpass();
			Lowpass = Lowpass_DefaultValue = new PlotOptionsDpoSonificationContextTracksMappingLowpass();
			NoteDuration = NoteDuration_DefaultValue = new PlotOptionsDpoSonificationContextTracksMappingNoteDuration();
			Pan = Pan_DefaultValue = new PlotOptionsDpoSonificationContextTracksMappingPan();
			Pitch = Pitch_DefaultValue = new PlotOptionsDpoSonificationContextTracksMappingPitch();
			PitchString = PitchString_DefaultValue = "null";
			PitchNumber = PitchNumber_DefaultValue = null;
			PlayDelay = PlayDelay_DefaultValue = new PlotOptionsDpoSonificationContextTracksMappingPlayDelay();
			Time = Time_DefaultValue = new PlotOptionsDpoSonificationContextTracksMappingTime();
			TimeString = TimeString_DefaultValue = "null";
			TimeNumber = TimeNumber_DefaultValue = null;
			Tremolo = Tremolo_DefaultValue = new PlotOptionsDpoSonificationContextTracksMappingTremolo();
			Volume = Volume_DefaultValue = new PlotOptionsDpoSonificationContextTracksMappingVolume();
		...
		/// </summary>
		public PlotOptionsDpoSonificationContextTracksMappingFrequency Frequency { get; set; }
		private PlotOptionsDpoSonificationContextTracksMappingFrequency Frequency_DefaultValue { get; set; }
		...
		/// </summary>
		public PlotOptionsDpoSonificationContextTracksMappingGapBetweenNotes GapBetweenNotes { get; set; }
		private PlotOptionsDpoSonificationContextTracksMappingGapBetweenNotes GapBetweenNotes_DefaultValue { get; set; }
		...
		/// </summary>
		public PlotOptionsDpoSonificationContextTracksMappingHighpass Highpass { get; set; }
		private PlotOptionsDpoSonificationContextTracksMappingHighpass Highpass_DefaultValue { get; set; }
		...
		/// </summary>
		public PlotOptionsDpoSonificationContextTracksMappingLowpass Lowpass { get; set; }
		private PlotOptionsDpoSonificationContextTracksMappingLowpass Lowpass_DefaultValue { get; set; }
		...
		/// </summary>
		public PlotOptionsDpoSonificationContextTracksMappingNoteDuration NoteDuration { get; set; }
		private PlotOptionsDpoSonificationContextTracksMappingNoteDuration NoteDuration_DefaultValue { get; set; }
		...
		/// </summary>
		public PlotOptionsDpoSonificationContextTracksMappingPan Pan { get; set; }
		private PlotOptionsDpoSonificationContextTracksMappingPan Pan_DefaultValue { get; set; }
		...
		/// </summary>
		public PlotOptionsDpoSonificationContextTracksMappingPitch Pitch { get; set; }
		private PlotOptionsDpoSonificationContextTracksMappingPitch Pitch_DefaultValue { get; set; }
		...
		/// </summary>
		public PlotOptionsDpoSonificationContextTracksMappingPlayDelay PlayDelay { get; set; }
		private PlotOptionsDpoSonificationContextTracksMappingPlayDelay PlayDelay_DefaultValue { get; set; }
		...
		/// </summary>
		public PlotOptionsDpoSonificationContextTracksMappingTime Time { get; set; }
		private PlotOptionsDpoSonificationContextTracksMappingTime Time_DefaultValue { get; set; }
		...
		/// </summary>
		public PlotOptionsDpoSonificationContextTracksMappingTremolo Tremolo { get; set; }
		private PlotOptionsDpoSonificationContextTracksMappingTremolo Tremolo_DefaultValue { get; set; }
		 

		/// <summary>
		/// The volume of notes, from 0 to 1.
		/// </summary>
		public PlotOptionsDpoSonificationContextTracksMappingVolume Volume { get; set; }
		private PlotOptionsDpoSonificationContextTracksMappingVolume Volume_DefaultValue { get; set; }
