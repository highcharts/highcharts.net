...
{
	public partial class PlotOptionsDpoSonificationDefaultInstrumentOptionsActiveWhen  : BaseObject
	{
		Hashtable h = new Hashtable();

		public PlotOptionsDpoSonificationDefaultInstrumentOptionsActiveWhen()
		{
