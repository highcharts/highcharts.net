...
{
	public partial class PlotOptionsDpoSonificationDefaultInstrumentOptionsMappingHighpassFrequency  : BaseObject
	{
		Hashtable h = new Hashtable();

		public PlotOptionsDpoSonificationDefaultInstrumentOptionsMappingHighpassFrequency()
		{
			MapFunction = MapFunction_DefaultValue = PlotOptionsDpoSonificationDefaultInstrumentOptionsMappingHighpassFrequencyMapFunction.Linear;
			MapTo = MapTo_DefaultValue = "";
			Max = Max_DefaultValue = null;
			Min = Min_DefaultValue = null;
			Value = Value_DefaultValue = null;
			Within = Within_DefaultValue = PlotOptionsDpoSonificationDefaultInstrumentOptionsMappingHighpassFrequencyWithin.Chart;
		...
		/// </summary>
		public PlotOptionsDpoSonificationDefaultInstrumentOptionsMappingHighpassFrequencyMapFunction MapFunction { get; set; }
		private PlotOptionsDpoSonificationDefaultInstrumentOptionsMappingHighpassFrequencyMapFunction MapFunction_DefaultValue { get; set; }
		...
		/// </summary>
		public PlotOptionsDpoSonificationDefaultInstrumentOptionsMappingHighpassFrequencyWithin Within { get; set; }
		private PlotOptionsDpoSonificationDefaultInstrumentOptionsMappingHighpassFrequencyWithin Within_DefaultValue { get; set; }
