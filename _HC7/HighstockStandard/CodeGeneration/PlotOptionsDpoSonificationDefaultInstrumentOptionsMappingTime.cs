...
{
	public partial class PlotOptionsDpoSonificationDefaultInstrumentOptionsMappingTime  : BaseObject
	{
		Hashtable h = new Hashtable();

		public PlotOptionsDpoSonificationDefaultInstrumentOptionsMappingTime()
		{
			MapFunction = MapFunction_DefaultValue = PlotOptionsDpoSonificationDefaultInstrumentOptionsMappingTimeMapFunction.Linear;
			MapTo = MapTo_DefaultValue = "";
			Max = Max_DefaultValue = null;
			Min = Min_DefaultValue = null;
			Value = Value_DefaultValue = null;
			Within = Within_DefaultValue = PlotOptionsDpoSonificationDefaultInstrumentOptionsMappingTimeWithin.Chart;
		...
		/// </summary>
		public PlotOptionsDpoSonificationDefaultInstrumentOptionsMappingTimeMapFunction MapFunction { get; set; }
		private PlotOptionsDpoSonificationDefaultInstrumentOptionsMappingTimeMapFunction MapFunction_DefaultValue { get; set; }
		...
		/// </summary>
		public PlotOptionsDpoSonificationDefaultInstrumentOptionsMappingTimeWithin Within { get; set; }
		private PlotOptionsDpoSonificationDefaultInstrumentOptionsMappingTimeWithin Within_DefaultValue { get; set; }
