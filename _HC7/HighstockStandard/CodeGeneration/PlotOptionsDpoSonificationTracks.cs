...
{
	public partial class PlotOptionsDpoSonificationTracks  : BaseObject
	{
		Hashtable h = new Hashtable();

		public PlotOptionsDpoSonificationTracks()
		{
			ActiveWhen = ActiveWhen_DefaultValue = new PlotOptionsDpoSonificationTracksActiveWhen();
			Instrument = Instrument_DefaultValue = null;
			InstrumentString = InstrumentString_DefaultValue = "null";
			Mapping = Mapping_DefaultValue = new PlotOptionsDpoSonificationTracksMapping();
			MidiName = MidiName_DefaultValue = "";
			PointGrouping = PointGrouping_DefaultValue = new PlotOptionsDpoSonificationTracksPointGrouping();
			RoundToMusicalNotes = RoundToMusicalNotes_DefaultValue = true;
			ShowPlayMarker = ShowPlayMarker_DefaultValue = true;
			Type = Type_DefaultValue = PlotOptionsDpoSonificationTracksType.Instrument;
		...
		/// </summary>
		public PlotOptionsDpoSonificationTracksActiveWhen ActiveWhen { get; set; }
		private PlotOptionsDpoSonificationTracksActiveWhen ActiveWhen_DefaultValue { get; set; }
		...
		/// </summary>
		public PlotOptionsDpoSonificationTracksMapping Mapping { get; set; }
		private PlotOptionsDpoSonificationTracksMapping Mapping_DefaultValue { get; set; }
		...
		/// </summary>
		public PlotOptionsDpoSonificationTracksPointGrouping PointGrouping { get; set; }
		private PlotOptionsDpoSonificationTracksPointGrouping PointGrouping_DefaultValue { get; set; }
		...
		/// </summary>
		public PlotOptionsDpoSonificationTracksType Type { get; set; }
		private PlotOptionsDpoSonificationTracksType Type_DefaultValue { get; set; }
