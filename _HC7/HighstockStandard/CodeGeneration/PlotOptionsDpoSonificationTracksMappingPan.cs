...
{
	public partial class PlotOptionsDpoSonificationTracksMappingPan  : BaseObject
	{
		Hashtable h = new Hashtable();

		public PlotOptionsDpoSonificationTracksMappingPan()
		{
			MapFunction = MapFunction_DefaultValue = PlotOptionsDpoSonificationTracksMappingPanMapFunction.Linear;
			MapTo = MapTo_DefaultValue = "";
			Max = Max_DefaultValue = null;
			Min = Min_DefaultValue = null;
			Value = Value_DefaultValue = null;
			Within = Within_DefaultValue = PlotOptionsDpoSonificationTracksMappingPanWithin.Chart;
		...
		/// </summary>
		public PlotOptionsDpoSonificationTracksMappingPanMapFunction MapFunction { get; set; }
		private PlotOptionsDpoSonificationTracksMappingPanMapFunction MapFunction_DefaultValue { get; set; }
		...
		/// </summary>
		public PlotOptionsDpoSonificationTracksMappingPanWithin Within { get; set; }
		private PlotOptionsDpoSonificationTracksMappingPanWithin Within_DefaultValue { get; set; }
