...
{
	public partial class PlotOptionsDpoSonificationTracksMappingPitch  : BaseObject
	{
		Hashtable h = new Hashtable();

		public PlotOptionsDpoSonificationTracksMappingPitch()
		{
			MapFunction = MapFunction_DefaultValue = PlotOptionsDpoSonificationTracksMappingPitchMapFunction.Linear;
		...
		/// </summary>
		public PlotOptionsDpoSonificationTracksMappingPitchMapFunction MapFunction { get; set; }
		private PlotOptionsDpoSonificationTracksMappingPitchMapFunction MapFunction_DefaultValue { get; set; }
