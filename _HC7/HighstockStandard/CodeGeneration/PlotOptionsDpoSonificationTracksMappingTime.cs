...
{
	public partial class PlotOptionsDpoSonificationTracksMappingTime  : BaseObject
	{
		Hashtable h = new Hashtable();

		public PlotOptionsDpoSonificationTracksMappingTime()
		{
			MapFunction = MapFunction_DefaultValue = PlotOptionsDpoSonificationTracksMappingTimeMapFunction.Linear;
			MapTo = MapTo_DefaultValue = "";
			Max = Max_DefaultValue = null;
			Min = Min_DefaultValue = null;
			Value = Value_DefaultValue = null;
			Within = Within_DefaultValue = PlotOptionsDpoSonificationTracksMappingTimeWithin.Chart;
		...
		/// </summary>
		public PlotOptionsDpoSonificationTracksMappingTimeMapFunction MapFunction { get; set; }
		private PlotOptionsDpoSonificationTracksMappingTimeMapFunction MapFunction_DefaultValue { get; set; }
		...
		/// </summary>
		public PlotOptionsDpoSonificationTracksMappingTimeWithin Within { get; set; }
		private PlotOptionsDpoSonificationTracksMappingTimeWithin Within_DefaultValue { get; set; }
