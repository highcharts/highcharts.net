...
{
	public partial class PlotOptionsDpoSonificationTracksMappingTremoloSpeed  : BaseObject
	{
		Hashtable h = new Hashtable();

		public PlotOptionsDpoSonificationTracksMappingTremoloSpeed()
		{
			MapFunction = MapFunction_DefaultValue = PlotOptionsDpoSonificationTracksMappingTremoloSpeedMapFunction.Linear;
			MapTo = MapTo_DefaultValue = "";
			Max = Max_DefaultValue = null;
			Min = Min_DefaultValue = null;
			Value = Value_DefaultValue = null;
			Within = Within_DefaultValue = PlotOptionsDpoSonificationTracksMappingTremoloSpeedWithin.Chart;
		...
		/// </summary>
		public PlotOptionsDpoSonificationTracksMappingTremoloSpeedMapFunction MapFunction { get; set; }
		private PlotOptionsDpoSonificationTracksMappingTremoloSpeedMapFunction MapFunction_DefaultValue { get; set; }
		...
		/// </summary>
		public PlotOptionsDpoSonificationTracksMappingTremoloSpeedWithin Within { get; set; }
		private PlotOptionsDpoSonificationTracksMappingTremoloSpeedWithin Within_DefaultValue { get; set; }
