...
{
	public partial class PlotOptionsDpoSonificationTracksMappingVolume  : BaseObject
	{
		Hashtable h = new Hashtable();

		public PlotOptionsDpoSonificationTracksMappingVolume()
		{
			MapFunction = MapFunction_DefaultValue = PlotOptionsDpoSonificationTracksMappingVolumeMapFunction.Linear;
			MapTo = MapTo_DefaultValue = "";
			Max = Max_DefaultValue = null;
			Min = Min_DefaultValue = null;
			Value = Value_DefaultValue = null;
			Within = Within_DefaultValue = PlotOptionsDpoSonificationTracksMappingVolumeWithin.Chart;
		...
		/// </summary>
		public PlotOptionsDpoSonificationTracksMappingVolumeMapFunction MapFunction { get; set; }
		private PlotOptionsDpoSonificationTracksMappingVolumeMapFunction MapFunction_DefaultValue { get; set; }
		...
		/// </summary>
		public PlotOptionsDpoSonificationTracksMappingVolumeWithin Within { get; set; }
		private PlotOptionsDpoSonificationTracksMappingVolumeWithin Within_DefaultValue { get; set; }
