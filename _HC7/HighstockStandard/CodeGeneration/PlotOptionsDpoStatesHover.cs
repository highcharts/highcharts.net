...
{
	public partial class PlotOptionsDpoStatesHover  : BaseObject
	{
		Hashtable h = new Hashtable();

		public PlotOptionsDpoStatesHover()
		{
			Animation = Animation_DefaultValue = new Animation() { Enabled = true };
			AnimationBool = AnimationBool_DefaultValue = null;
			Enabled = Enabled_DefaultValue = true;
			Halo = Halo_DefaultValue = new PlotOptionsDpoStatesHoverHalo();
			LineWidth = LineWidth_DefaultValue = null;
			LineWidthPlus = LineWidthPlus_DefaultValue = 1;
			Marker = Marker_DefaultValue = new PlotOptionsDpoStatesHoverMarker();
		...
		/// </summary>
		public PlotOptionsDpoStatesHoverHalo Halo { get; set; }
		private PlotOptionsDpoStatesHoverHalo Halo_DefaultValue { get; set; }
		...
		/// </summary>
		public PlotOptionsDpoStatesHoverMarker Marker { get; set; }
		private PlotOptionsDpoStatesHoverMarker Marker_DefaultValue { get; set; }
