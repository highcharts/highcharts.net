...
{
	public partial class PlotOptionsDpoStatesSelect  : BaseObject
	{
		Hashtable h = new Hashtable();

		public PlotOptionsDpoStatesSelect()
		{
			Animation = Animation_DefaultValue = new Animation() { Enabled = true };
			Enabled = Enabled_DefaultValue = null;
			Halo = Halo_DefaultValue = new PlotOptionsDpoStatesSelectHalo();
			LineWidth = LineWidth_DefaultValue = null;
			LineWidthPlus = LineWidthPlus_DefaultValue = null;
			Marker = Marker_DefaultValue = new PlotOptionsDpoStatesSelectMarker();
		...
		/// </summary>
		public PlotOptionsDpoStatesSelectHalo Halo { get; set; }
		private PlotOptionsDpoStatesSelectHalo Halo_DefaultValue { get; set; }
		...
		/// </summary>
		public PlotOptionsDpoStatesSelectMarker Marker { get; set; }
		private PlotOptionsDpoStatesSelectMarker Marker_DefaultValue { get; set; }
