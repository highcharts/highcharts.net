...
namespace Highsoft.Web.Mvc.Stocks
{
	public partial class PlotOptionsDumbbell  : BaseObject
	{
		...
		public PlotOptionsDumbbell()
		{
			...
			Zones = Zones_DefaultValue = new List<PlotOptionsDumbbellZone>();
		...
		/// </summary>
		public List<PlotOptionsDumbbellZone> Zones { get; set; }
		private List<PlotOptionsDumbbellZone> Zones_DefaultValue { get; set; }
