...
{
	public partial class PlotOptionsDumbbell  : BaseObject
	{
		Hashtable h = new Hashtable();

		public PlotOptionsDumbbell()
		{
			Accessibility = Accessibility_DefaultValue = new PlotOptionsDumbbellAccessibility();
			...
			Compare = Compare_DefaultValue = PlotOptionsDumbbellCompare.Percent;
			CompareBase = CompareBase_DefaultValue = PlotOptionsDumbbellCompareBase.Min;
			...
			Cursor = Cursor_DefaultValue = PlotOptionsDumbbellCursor.Null;
			Custom = Custom_DefaultValue = new Hashtable();
			DashStyle = DashStyle_DefaultValue = PlotOptionsDumbbellDashStyle.Null;
			DataGrouping = DataGrouping_DefaultValue = new PlotOptionsDumbbellDataGrouping();
			DataLabels = DataLabels_DefaultValue = new PlotOptionsDumbbellDataLabels();
			DataSorting = DataSorting_DefaultValue = new PlotOptionsDumbbellDataSorting();
			Description = Description_DefaultValue = "";
			DragDrop = DragDrop_DefaultValue = new PlotOptionsDumbbellDragDrop();
			EnableMouseTracking = EnableMouseTracking_DefaultValue = true;
			Events = Events_DefaultValue = new PlotOptionsDumbbellEvents();
			FindNearestPointBy = FindNearestPointBy_DefaultValue = PlotOptionsDumbbellFindNearestPointBy.X;
			GapSize = GapSize_DefaultValue = 0;
			GapUnit = GapUnit_DefaultValue = PlotOptionsDumbbellGapUnit.Relative;
			GetExtremesFromAll = GetExtremesFromAll_DefaultValue = false;
			InactiveOtherPoints = InactiveOtherPoints_DefaultValue = false;
			IncludeInDataExport = IncludeInDataExport_DefaultValue = null;
			Keys = Keys_DefaultValue = new List<string>();
			Label = Label_DefaultValue = new PlotOptionsDumbbellLabel();
			LastPrice = LastPrice_DefaultValue = new PlotOptionsDumbbellLastPrice();
			LastVisiblePrice = LastVisiblePrice_DefaultValue = new PlotOptionsDumbbellLastVisiblePrice();
			LegendSymbol = LegendSymbol_DefaultValue = PlotOptionsDumbbellLegendSymbol.Rectangle;
			Linecap = Linecap_DefaultValue = PlotOptionsDumbbellLinecap.Round;
			LineColor = LineColor_DefaultValue = "";
			LinkedTo = LinkedTo_DefaultValue = "";
			LowMarker = LowMarker_DefaultValue = new PlotOptionsDumbbellLowMarker();
			Marker = Marker_DefaultValue = new PlotOptionsDumbbellMarker();
			NegativeColor = NegativeColor_DefaultValue = "";
			NegativeFillColor = NegativeFillColor_DefaultValue = "";
			OnPoint = OnPoint_DefaultValue = new PlotOptionsDumbbellOnPoint();
			Opacity = Opacity_DefaultValue = 1;
			Point = Point_DefaultValue = new PlotOptionsDumbbellPoint();
			PointDescriptionFormat = PointDescriptionFormat_DefaultValue = "";
			PointDescriptionFormatter = PointDescriptionFormatter_DefaultValue = "";
			PointInterval = PointInterval_DefaultValue = 1;
			PointIntervalUnit = PointIntervalUnit_DefaultValue = PlotOptionsDumbbellPointIntervalUnit.Null;
			...
			Sonification = Sonification_DefaultValue = new PlotOptionsDumbbellSonification();
			States = States_DefaultValue = new PlotOptionsDumbbellStates();
			Step = Step_DefaultValue = PlotOptionsDumbbellStep.Null;
			Threshold = Threshold_DefaultValue = 0;
			Tooltip = Tooltip_DefaultValue = new PlotOptionsDumbbellTooltip();
			TurboThreshold = TurboThreshold_DefaultValue = 1000;
			Visible = Visible_DefaultValue = true;
			ZoneAxis = ZoneAxis_DefaultValue = "y";
			Zones = Zones_DefaultValue = new List<PlotOptionsDumbbellZones>();
		...
		/// </summary>
		public PlotOptionsDumbbellAccessibility Accessibility { get; set; }
		private PlotOptionsDumbbellAccessibility Accessibility_DefaultValue { get; set; }
		...
		/// </summary>
		public PlotOptionsDumbbellCompare Compare { get; set; }
		private PlotOptionsDumbbellCompare Compare_DefaultValue { get; set; }
		 

		/// <summary>
		/// When [compare](#plotOptions.series.compare) is `percent`, this optiondictates whether to use 0 or 100 as the base of comparison.
		/// </summary>
		public PlotOptionsDumbbellCompareBase CompareBase { get; set; }
		private PlotOptionsDumbbellCompareBase CompareBase_DefaultValue { get; set; }
		...
		/// </summary>
		public PlotOptionsDumbbellCursor Cursor { get; set; }
		private PlotOptionsDumbbellCursor Cursor_DefaultValue { get; set; }
		...
		/// </summary>
		public PlotOptionsDumbbellDashStyle DashStyle { get; set; }
		private PlotOptionsDumbbellDashStyle DashStyle_DefaultValue { get; set; }
		...
		/// </summary>
		public PlotOptionsDumbbellDataGrouping DataGrouping { get; set; }
		private PlotOptionsDumbbellDataGrouping DataGrouping_DefaultValue { get; set; }
		...
		/// </summary>
		public PlotOptionsDumbbellDataLabels DataLabels { get; set; }
		private PlotOptionsDumbbellDataLabels DataLabels_DefaultValue { get; set; }
		 

		/// <summary>
		/// Options for the series data sorting.
		/// </summary>
		public PlotOptionsDumbbellDataSorting DataSorting { get; set; }
		private PlotOptionsDumbbellDataSorting DataSorting_DefaultValue { get; set; }
		...
		/// </summary>
		public PlotOptionsDumbbellDragDrop DragDrop { get; set; }
		private PlotOptionsDumbbellDragDrop DragDrop_DefaultValue { get; set; }
		...
		/// </summary>
		public PlotOptionsDumbbellEvents Events { get; set; }
		private PlotOptionsDumbbellEvents Events_DefaultValue { get; set; }
		...
		/// </summary>
		public PlotOptionsDumbbellFindNearestPointBy FindNearestPointBy { get; set; }
		private PlotOptionsDumbbellFindNearestPointBy FindNearestPointBy_DefaultValue { get; set; }
		...
		/// </summary>
		public PlotOptionsDumbbellGapUnit GapUnit { get; set; }
		private PlotOptionsDumbbellGapUnit GapUnit_DefaultValue { get; set; }
		...
		/// </summary>
		public PlotOptionsDumbbellLabel Label { get; set; }
		private PlotOptionsDumbbellLabel Label_DefaultValue { get; set; }
		 

		/// <summary>
		/// The line marks the last price from all points.
		/// </summary>
		public PlotOptionsDumbbellLastPrice LastPrice { get; set; }
		private PlotOptionsDumbbellLastPrice LastPrice_DefaultValue { get; set; }
		 

		/// <summary>
		/// The line marks the last price from visible range of points.
		/// </summary>
		public PlotOptionsDumbbellLastVisiblePrice LastVisiblePrice { get; set; }
		private PlotOptionsDumbbellLastVisiblePrice LastVisiblePrice_DefaultValue { get; set; }
		 

		/// <summary>
		/// What type of legend symbol to render for this series. Can be one of`areaMarker`, `lineMarker` or `rectangle`.
		/// </summary>
		public PlotOptionsDumbbellLegendSymbol LegendSymbol { get; set; }
		private PlotOptionsDumbbellLegendSymbol LegendSymbol_DefaultValue { get; set; }
		 

		/// <summary>
		/// The line cap used for line ends and line joins on the graph.
		/// </summary>
		public PlotOptionsDumbbellLinecap Linecap { get; set; }
		private PlotOptionsDumbbellLinecap Linecap_DefaultValue { get; set; }
		...
		/// </summary>
		public PlotOptionsDumbbellLowMarker LowMarker { get; set; }
		private PlotOptionsDumbbellLowMarker LowMarker_DefaultValue { get; set; }
		...
		/// </summary>
		public PlotOptionsDumbbellMarker Marker { get; set; }
		private PlotOptionsDumbbellMarker Marker_DefaultValue { get; set; }
		...
		/// </summary>
		public PlotOptionsDumbbellOnPoint OnPoint { get; set; }
		private PlotOptionsDumbbellOnPoint OnPoint_DefaultValue { get; set; }
		...
		/// </summary>
		public PlotOptionsDumbbellPoint Point { get; set; }
		private PlotOptionsDumbbellPoint Point_DefaultValue { get; set; }
		...
		/// </summary>
		public PlotOptionsDumbbellPointIntervalUnit PointIntervalUnit { get; set; }
		private PlotOptionsDumbbellPointIntervalUnit PointIntervalUnit_DefaultValue { get; set; }
		...
		/// </summary>
		public PlotOptionsDumbbellSonification Sonification { get; set; }
		private PlotOptionsDumbbellSonification Sonification_DefaultValue { get; set; }
		 

		/// <summary>
		/// 
		/// </summary>
		public PlotOptionsDumbbellStates States { get; set; }
		private PlotOptionsDumbbellStates States_DefaultValue { get; set; }
		 

		/// <summary>
		/// Whether to apply steps to the line. Possible values are `left`,`center` and `right`.
		/// </summary>
		public PlotOptionsDumbbellStep Step { get; set; }
		private PlotOptionsDumbbellStep Step_DefaultValue { get; set; }
		...
		/// </summary>
		public PlotOptionsDumbbellTooltip Tooltip { get; set; }
		private PlotOptionsDumbbellTooltip Tooltip_DefaultValue { get; set; }
		...
		/// </summary>
		public List<PlotOptionsDumbbellZones> Zones { get; set; }
		private List<PlotOptionsDumbbellZones> Zones_DefaultValue { get; set; }
