...
{
	public partial class PlotOptionsDumbbellLastVisiblePriceLabel  : BaseObject
	{
		Hashtable h = new Hashtable();

		public PlotOptionsDumbbellLastVisiblePriceLabel()
		{
			Align = Align_DefaultValue = PlotOptionsDumbbellLastVisiblePriceLabelAlign.Null;
		...
		/// 
		/// </summary>
		public PlotOptionsDumbbellLastVisiblePriceLabelAlign Align { get; set; }
		private PlotOptionsDumbbellLastVisiblePriceLabelAlign Align_DefaultValue { get; set; }
