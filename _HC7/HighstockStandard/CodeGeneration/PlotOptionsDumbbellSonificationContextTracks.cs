...
{
	public partial class PlotOptionsDumbbellSonificationContextTracks  : BaseObject
	{
		Hashtable h = new Hashtable();

		public PlotOptionsDumbbellSonificationContextTracks()
		{
			ActiveWhen = ActiveWhen_DefaultValue = new PlotOptionsDumbbellSonificationContextTracksActiveWhen();
			Instrument = Instrument_DefaultValue = null;
			InstrumentString = InstrumentString_DefaultValue = "null";
			Mapping = Mapping_DefaultValue = new PlotOptionsDumbbellSonificationContextTracksMapping();
			MidiName = MidiName_DefaultValue = "";
			PointGrouping = PointGrouping_DefaultValue = new PlotOptionsDumbbellSonificationContextTracksPointGrouping();
			...
			Type = Type_DefaultValue = PlotOptionsDumbbellSonificationContextTracksType.Instrument;
			ValueInterval = ValueInterval_DefaultValue = null;
			ValueMapFunction = ValueMapFunction_DefaultValue = PlotOptionsDumbbellSonificationContextTracksValueMapFunction.Linear;
		...
		/// </summary>
		public PlotOptionsDumbbellSonificationContextTracksActiveWhen ActiveWhen { get; set; }
		private PlotOptionsDumbbellSonificationContextTracksActiveWhen ActiveWhen_DefaultValue { get; set; }
		...
		/// </summary>
		public PlotOptionsDumbbellSonificationContextTracksMapping Mapping { get; set; }
		private PlotOptionsDumbbellSonificationContextTracksMapping Mapping_DefaultValue { get; set; }
		...
		/// </summary>
		public PlotOptionsDumbbellSonificationContextTracksPointGrouping PointGrouping { get; set; }
		private PlotOptionsDumbbellSonificationContextTracksPointGrouping PointGrouping_DefaultValue { get; set; }
		...
		/// </summary>
		public PlotOptionsDumbbellSonificationContextTracksType Type { get; set; }
		private PlotOptionsDumbbellSonificationContextTracksType Type_DefaultValue { get; set; }
		...
		/// </summary>
		public PlotOptionsDumbbellSonificationContextTracksValueMapFunction ValueMapFunction { get; set; }
		private PlotOptionsDumbbellSonificationContextTracksValueMapFunction ValueMapFunction_DefaultValue { get; set; }
