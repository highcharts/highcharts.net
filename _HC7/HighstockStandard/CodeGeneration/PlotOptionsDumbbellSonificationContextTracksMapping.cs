...
{
	public partial class PlotOptionsDumbbellSonificationContextTracksMapping  : BaseObject
	{
		Hashtable h = new Hashtable();

		public PlotOptionsDumbbellSonificationContextTracksMapping()
		{
			Frequency = Frequency_DefaultValue = new PlotOptionsDumbbellSonificationContextTracksMappingFrequency();
			GapBetweenNotes = GapBetweenNotes_DefaultValue = new PlotOptionsDumbbellSonificationContextTracksMappingGapBetweenNotes();
			Highpass = Highpass_DefaultValue = new PlotOptionsDumbbellSonificationContextTracksMappingHighpass();
			Lowpass = Lowpass_DefaultValue = new PlotOptionsDumbbellSonificationContextTracksMappingLowpass();
			NoteDuration = NoteDuration_DefaultValue = new PlotOptionsDumbbellSonificationContextTracksMappingNoteDuration();
			Pan = Pan_DefaultValue = new PlotOptionsDumbbellSonificationContextTracksMappingPan();
			Pitch = Pitch_DefaultValue = new PlotOptionsDumbbellSonificationContextTracksMappingPitch();
			PitchString = PitchString_DefaultValue = "null";
			PitchNumber = PitchNumber_DefaultValue = null;
			PlayDelay = PlayDelay_DefaultValue = new PlotOptionsDumbbellSonificationContextTracksMappingPlayDelay();
			Time = Time_DefaultValue = new PlotOptionsDumbbellSonificationContextTracksMappingTime();
			TimeString = TimeString_DefaultValue = "null";
			TimeNumber = TimeNumber_DefaultValue = null;
			Tremolo = Tremolo_DefaultValue = new PlotOptionsDumbbellSonificationContextTracksMappingTremolo();
			Volume = Volume_DefaultValue = new PlotOptionsDumbbellSonificationContextTracksMappingVolume();
		...
		/// </summary>
		public PlotOptionsDumbbellSonificationContextTracksMappingFrequency Frequency { get; set; }
		private PlotOptionsDumbbellSonificationContextTracksMappingFrequency Frequency_DefaultValue { get; set; }
		...
		/// </summary>
		public PlotOptionsDumbbellSonificationContextTracksMappingGapBetweenNotes GapBetweenNotes { get; set; }
		private PlotOptionsDumbbellSonificationContextTracksMappingGapBetweenNotes GapBetweenNotes_DefaultValue { get; set; }
		...
		/// </summary>
		public PlotOptionsDumbbellSonificationContextTracksMappingHighpass Highpass { get; set; }
		private PlotOptionsDumbbellSonificationContextTracksMappingHighpass Highpass_DefaultValue { get; set; }
		...
		/// </summary>
		public PlotOptionsDumbbellSonificationContextTracksMappingLowpass Lowpass { get; set; }
		private PlotOptionsDumbbellSonificationContextTracksMappingLowpass Lowpass_DefaultValue { get; set; }
		...
		/// </summary>
		public PlotOptionsDumbbellSonificationContextTracksMappingNoteDuration NoteDuration { get; set; }
		private PlotOptionsDumbbellSonificationContextTracksMappingNoteDuration NoteDuration_DefaultValue { get; set; }
		...
		/// </summary>
		public PlotOptionsDumbbellSonificationContextTracksMappingPan Pan { get; set; }
		private PlotOptionsDumbbellSonificationContextTracksMappingPan Pan_DefaultValue { get; set; }
		...
		/// </summary>
		public PlotOptionsDumbbellSonificationContextTracksMappingPitch Pitch { get; set; }
		private PlotOptionsDumbbellSonificationContextTracksMappingPitch Pitch_DefaultValue { get; set; }
		...
		/// </summary>
		public PlotOptionsDumbbellSonificationContextTracksMappingPlayDelay PlayDelay { get; set; }
		private PlotOptionsDumbbellSonificationContextTracksMappingPlayDelay PlayDelay_DefaultValue { get; set; }
		...
		/// </summary>
		public PlotOptionsDumbbellSonificationContextTracksMappingTime Time { get; set; }
		private PlotOptionsDumbbellSonificationContextTracksMappingTime Time_DefaultValue { get; set; }
		...
		/// </summary>
		public PlotOptionsDumbbellSonificationContextTracksMappingTremolo Tremolo { get; set; }
		private PlotOptionsDumbbellSonificationContextTracksMappingTremolo Tremolo_DefaultValue { get; set; }
		 

		/// <summary>
		/// The volume of notes, from 0 to 1.
		/// </summary>
		public PlotOptionsDumbbellSonificationContextTracksMappingVolume Volume { get; set; }
		private PlotOptionsDumbbellSonificationContextTracksMappingVolume Volume_DefaultValue { get; set; }
