...
{
	public partial class PlotOptionsDumbbellSonificationTracksMapping  : BaseObject
	{
		Hashtable h = new Hashtable();

		public PlotOptionsDumbbellSonificationTracksMapping()
		{
			Frequency = Frequency_DefaultValue = new PlotOptionsDumbbellSonificationTracksMappingFrequency();
			GapBetweenNotes = GapBetweenNotes_DefaultValue = new PlotOptionsDumbbellSonificationTracksMappingGapBetweenNotes();
			Highpass = Highpass_DefaultValue = new PlotOptionsDumbbellSonificationTracksMappingHighpass();
			Lowpass = Lowpass_DefaultValue = new PlotOptionsDumbbellSonificationTracksMappingLowpass();
			NoteDuration = NoteDuration_DefaultValue = new PlotOptionsDumbbellSonificationTracksMappingNoteDuration();
			Pan = Pan_DefaultValue = new PlotOptionsDumbbellSonificationTracksMappingPan();
			Pitch = Pitch_DefaultValue = new PlotOptionsDumbbellSonificationTracksMappingPitch();
			PitchString = PitchString_DefaultValue = "null";
			PitchNumber = PitchNumber_DefaultValue = null;
			PlayDelay = PlayDelay_DefaultValue = new PlotOptionsDumbbellSonificationTracksMappingPlayDelay();
			Time = Time_DefaultValue = new PlotOptionsDumbbellSonificationTracksMappingTime();
			TimeString = TimeString_DefaultValue = "null";
			TimeNumber = TimeNumber_DefaultValue = null;
			Tremolo = Tremolo_DefaultValue = new PlotOptionsDumbbellSonificationTracksMappingTremolo();
			Volume = Volume_DefaultValue = new PlotOptionsDumbbellSonificationTracksMappingVolume();
		...
		/// </summary>
		public PlotOptionsDumbbellSonificationTracksMappingFrequency Frequency { get; set; }
		private PlotOptionsDumbbellSonificationTracksMappingFrequency Frequency_DefaultValue { get; set; }
		...
		/// </summary>
		public PlotOptionsDumbbellSonificationTracksMappingGapBetweenNotes GapBetweenNotes { get; set; }
		private PlotOptionsDumbbellSonificationTracksMappingGapBetweenNotes GapBetweenNotes_DefaultValue { get; set; }
		...
		/// </summary>
		public PlotOptionsDumbbellSonificationTracksMappingHighpass Highpass { get; set; }
		private PlotOptionsDumbbellSonificationTracksMappingHighpass Highpass_DefaultValue { get; set; }
		...
		/// </summary>
		public PlotOptionsDumbbellSonificationTracksMappingLowpass Lowpass { get; set; }
		private PlotOptionsDumbbellSonificationTracksMappingLowpass Lowpass_DefaultValue { get; set; }
		...
		/// </summary>
		public PlotOptionsDumbbellSonificationTracksMappingNoteDuration NoteDuration { get; set; }
		private PlotOptionsDumbbellSonificationTracksMappingNoteDuration NoteDuration_DefaultValue { get; set; }
		...
		/// </summary>
		public PlotOptionsDumbbellSonificationTracksMappingPan Pan { get; set; }
		private PlotOptionsDumbbellSonificationTracksMappingPan Pan_DefaultValue { get; set; }
		...
		/// </summary>
		public PlotOptionsDumbbellSonificationTracksMappingPitch Pitch { get; set; }
		private PlotOptionsDumbbellSonificationTracksMappingPitch Pitch_DefaultValue { get; set; }
		...
		/// </summary>
		public PlotOptionsDumbbellSonificationTracksMappingPlayDelay PlayDelay { get; set; }
		private PlotOptionsDumbbellSonificationTracksMappingPlayDelay PlayDelay_DefaultValue { get; set; }
		...
		/// </summary>
		public PlotOptionsDumbbellSonificationTracksMappingTime Time { get; set; }
		private PlotOptionsDumbbellSonificationTracksMappingTime Time_DefaultValue { get; set; }
		...
		/// </summary>
		public PlotOptionsDumbbellSonificationTracksMappingTremolo Tremolo { get; set; }
		private PlotOptionsDumbbellSonificationTracksMappingTremolo Tremolo_DefaultValue { get; set; }
		 

		/// <summary>
		/// The volume of notes, from 0 to 1.
		/// </summary>
		public PlotOptionsDumbbellSonificationTracksMappingVolume Volume { get; set; }
		private PlotOptionsDumbbellSonificationTracksMappingVolume Volume_DefaultValue { get; set; }
