...
namespace Highsoft.Web.Mvc.Stocks
{
	public partial class PlotOptionsEma  : BaseObject
	{
		public PlotOptionsEma()
		{
			...
			DragDrop = DragDrop_DefaultValue = new PlotOptionsEmaDragDrop();
		...
		/// </summary>
		public PlotOptionsEmaDragDrop DragDrop { get; set; }
		private PlotOptionsEmaDragDrop DragDrop_DefaultValue { get; set; }
