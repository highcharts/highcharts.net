...
namespace Highsoft.Web.Mvc.Stocks
{
	public partial class PlotOptionsEma  : BaseObject
	{
		...
		{
			Accessibility = Accessibility_DefaultValue = new PlotOptionsEmaAccessibility();
			AllowPointSelect = AllowPointSelect_DefaultValue = false;
			Animation = Animation_DefaultValue = new Animation() { Enabled = true };
			AnimationBool = AnimationBool_DefaultValue = true;
			AnimationLimit = AnimationLimit_DefaultValue = null;
			BoostBlending = BoostBlending_DefaultValue = PlotOptionsEmaBoostBlending.Undefined;
			...
			Compare = Compare_DefaultValue = PlotOptionsEmaCompare.Percent;
			CompareBase = CompareBase_DefaultValue = PlotOptionsEmaCompareBase.Min;
			...
			DashStyle = DashStyle_DefaultValue = PlotOptionsEmaDashStyle.Null;
			...
			DataSorting = DataSorting_DefaultValue = new PlotOptionsEmaDataSorting();
			...
			LastPrice = LastPrice_DefaultValue = new PlotOptionsEmaLastPrice();
			LastVisiblePrice = LastVisiblePrice_DefaultValue = new PlotOptionsEmaLastVisiblePrice();
			LegendSymbol = LegendSymbol_DefaultValue = PlotOptionsEmaLegendSymbol.Rectangle;
			...
			OnPoint = OnPoint_DefaultValue = new PlotOptionsEmaOnPoint();
			...
			Sonification = Sonification_DefaultValue = new PlotOptionsEmaSonification();
			...
			Zones = Zones_DefaultValue = new List<PlotOptionsEmaZones>();
		...
		/// </summary>
		public PlotOptionsEmaAccessibility Accessibility { get; set; }
		private PlotOptionsEmaAccessibility Accessibility_DefaultValue { get; set; }
		...
		/// </summary>
		public PlotOptionsEmaBoostBlending BoostBlending { get; set; }
		private PlotOptionsEmaBoostBlending BoostBlending_DefaultValue { get; set; }
		...
		/// </summary>
		public PlotOptionsEmaCompare Compare { get; set; }
		private PlotOptionsEmaCompare Compare_DefaultValue { get; set; }
		 

		/// <summary>
		/// When [compare](#plotOptions.series.compare) is `percent`, this optiondictates whether to use 0 or 100 as the base of comparison.
		/// </summary>
		public PlotOptionsEmaCompareBase CompareBase { get; set; }
		private PlotOptionsEmaCompareBase CompareBase_DefaultValue { get; set; }
		...
		/// </summary>
		public PlotOptionsEmaDataSorting DataSorting { get; set; }
		private PlotOptionsEmaDataSorting DataSorting_DefaultValue { get; set; }
		...
		/// </summary>
		public PlotOptionsEmaLastPrice LastPrice { get; set; }
		private PlotOptionsEmaLastPrice LastPrice_DefaultValue { get; set; }
		 

		/// <summary>
		/// The line marks the last price from visible range of points.
		/// </summary>
		public PlotOptionsEmaLastVisiblePrice LastVisiblePrice { get; set; }
		private PlotOptionsEmaLastVisiblePrice LastVisiblePrice_DefaultValue { get; set; }
		 

		/// <summary>
		/// What type of legend symbol to render for this series. Can be one of`lineMarker` or `rectangle`.
		/// </summary>
		public PlotOptionsEmaLegendSymbol LegendSymbol { get; set; }
		private PlotOptionsEmaLegendSymbol LegendSymbol_DefaultValue { get; set; }
		...
		/// </summary>
		public PlotOptionsEmaOnPoint OnPoint { get; set; }
		private PlotOptionsEmaOnPoint OnPoint_DefaultValue { get; set; }
		...
		/// </summary>
		public PlotOptionsEmaSonification Sonification { get; set; }
		private PlotOptionsEmaSonification Sonification_DefaultValue { get; set; }
		...
		/// </summary>
		public List<PlotOptionsEmaZones> Zones { get; set; }
		private List<PlotOptionsEmaZones> Zones_DefaultValue { get; set; }
