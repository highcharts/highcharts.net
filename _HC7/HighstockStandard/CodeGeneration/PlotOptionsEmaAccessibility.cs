...
namespace Highsoft.Web.Mvc.Stocks
{
	public partial class PlotOptionsEmaAccessibility  : BaseObject
	{
		...
		public PlotOptionsEmaAccessibility()
		{
			...
			Point = Point_DefaultValue = new PlotOptionsEmaAccessibilityPoint();
		...
		/// </summary>
		public PlotOptionsEmaAccessibilityPoint Point { get; set; }
		private PlotOptionsEmaAccessibilityPoint Point_DefaultValue { get; set; }
