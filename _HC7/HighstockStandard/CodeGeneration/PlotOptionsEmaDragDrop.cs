...
{
	public partial class PlotOptionsEmaDragDrop  : BaseObject
	{
		public PlotOptionsEmaDragDrop()
		{
			DraggableX = DraggableX_DefaultValue = null;
			DraggableY = DraggableY_DefaultValue = null;
			DragHandle = DragHandle_DefaultValue = new PlotOptionsEmaDragDropDragHandle();
			...
			GuideBox = GuideBox_DefaultValue = new PlotOptionsEmaDragDropGuideBox();
		...
		/// </summary>
		public PlotOptionsEmaDragDropDragHandle DragHandle { get; set; }
		private PlotOptionsEmaDragDropDragHandle DragHandle_DefaultValue { get; set; }
		...
		/// </summary>
		public PlotOptionsEmaDragDropGuideBox GuideBox { get; set; }
		private PlotOptionsEmaDragDropGuideBox GuideBox_DefaultValue { get; set; }
