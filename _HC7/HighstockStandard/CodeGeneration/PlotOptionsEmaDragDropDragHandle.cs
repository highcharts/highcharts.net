...
{
	public partial class PlotOptionsEmaDragDropDragHandle  : BaseObject
	{
		public PlotOptionsEmaDragDropDragHandle()
		{
		...
		internal override Hashtable ToHashtable()
		{
			...
			if (PathFormatter != PathFormatter_DefaultValue) { h.Add("pathFormatter",PathFormatter); Highstock.AddFunction("PlotOptionsEmaDragDropDragHandlePathFormatter.pathFormatter", PathFormatter); }  
