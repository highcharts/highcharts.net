...
{
	public partial class PlotOptionsEmaLabel  : BaseObject
	{
		public PlotOptionsEmaLabel()
		{
			...
			Style = Style_DefaultValue = new PlotOptionsEmaLabelStyle();
		...
		/// </summary>
		public PlotOptionsEmaLabelStyle Style { get; set; }
		private PlotOptionsEmaLabelStyle Style_DefaultValue { get; set; }
