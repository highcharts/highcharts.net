...
{
	public partial class PlotOptionsEmaMarker  : BaseObject
	{
		public PlotOptionsEmaMarker()
		{
			...
			States = States_DefaultValue = new PlotOptionsEmaMarkerStates();
		...
		/// </summary>
		public PlotOptionsEmaMarkerStates States { get; set; }
		private PlotOptionsEmaMarkerStates States_DefaultValue { get; set; }
