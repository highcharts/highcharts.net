...
{
	public partial class PlotOptionsEmaSonificationContextTracks  : BaseObject
	{
		Hashtable h = new Hashtable();

		public PlotOptionsEmaSonificationContextTracks()
		{
			ActiveWhen = ActiveWhen_DefaultValue = new PlotOptionsEmaSonificationContextTracksActiveWhen();
			Instrument = Instrument_DefaultValue = null;
			InstrumentString = InstrumentString_DefaultValue = "null";
			Mapping = Mapping_DefaultValue = new PlotOptionsEmaSonificationContextTracksMapping();
			MidiName = MidiName_DefaultValue = "";
			PointGrouping = PointGrouping_DefaultValue = new PlotOptionsEmaSonificationContextTracksPointGrouping();
			...
			Type = Type_DefaultValue = PlotOptionsEmaSonificationContextTracksType.Instrument;
			ValueInterval = ValueInterval_DefaultValue = null;
			ValueMapFunction = ValueMapFunction_DefaultValue = PlotOptionsEmaSonificationContextTracksValueMapFunction.Linear;
		...
		/// </summary>
		public PlotOptionsEmaSonificationContextTracksActiveWhen ActiveWhen { get; set; }
		private PlotOptionsEmaSonificationContextTracksActiveWhen ActiveWhen_DefaultValue { get; set; }
		...
		/// </summary>
		public PlotOptionsEmaSonificationContextTracksMapping Mapping { get; set; }
		private PlotOptionsEmaSonificationContextTracksMapping Mapping_DefaultValue { get; set; }
		...
		/// </summary>
		public PlotOptionsEmaSonificationContextTracksPointGrouping PointGrouping { get; set; }
		private PlotOptionsEmaSonificationContextTracksPointGrouping PointGrouping_DefaultValue { get; set; }
		...
		/// </summary>
		public PlotOptionsEmaSonificationContextTracksType Type { get; set; }
		private PlotOptionsEmaSonificationContextTracksType Type_DefaultValue { get; set; }
		...
		/// </summary>
		public PlotOptionsEmaSonificationContextTracksValueMapFunction ValueMapFunction { get; set; }
		private PlotOptionsEmaSonificationContextTracksValueMapFunction ValueMapFunction_DefaultValue { get; set; }
