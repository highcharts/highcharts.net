...
{
	public partial class PlotOptionsEmaSonificationContextTracksMapping  : BaseObject
	{
		Hashtable h = new Hashtable();

		public PlotOptionsEmaSonificationContextTracksMapping()
		{
			Frequency = Frequency_DefaultValue = new PlotOptionsEmaSonificationContextTracksMappingFrequency();
			GapBetweenNotes = GapBetweenNotes_DefaultValue = new PlotOptionsEmaSonificationContextTracksMappingGapBetweenNotes();
			Highpass = Highpass_DefaultValue = new PlotOptionsEmaSonificationContextTracksMappingHighpass();
			Lowpass = Lowpass_DefaultValue = new PlotOptionsEmaSonificationContextTracksMappingLowpass();
			NoteDuration = NoteDuration_DefaultValue = new PlotOptionsEmaSonificationContextTracksMappingNoteDuration();
			Pan = Pan_DefaultValue = new PlotOptionsEmaSonificationContextTracksMappingPan();
			Pitch = Pitch_DefaultValue = new PlotOptionsEmaSonificationContextTracksMappingPitch();
			PitchString = PitchString_DefaultValue = "null";
			PitchNumber = PitchNumber_DefaultValue = null;
			PlayDelay = PlayDelay_DefaultValue = new PlotOptionsEmaSonificationContextTracksMappingPlayDelay();
			Time = Time_DefaultValue = new PlotOptionsEmaSonificationContextTracksMappingTime();
			TimeString = TimeString_DefaultValue = "null";
			TimeNumber = TimeNumber_DefaultValue = null;
			Tremolo = Tremolo_DefaultValue = new PlotOptionsEmaSonificationContextTracksMappingTremolo();
			Volume = Volume_DefaultValue = new PlotOptionsEmaSonificationContextTracksMappingVolume();
		...
		/// </summary>
		public PlotOptionsEmaSonificationContextTracksMappingFrequency Frequency { get; set; }
		private PlotOptionsEmaSonificationContextTracksMappingFrequency Frequency_DefaultValue { get; set; }
		...
		/// </summary>
		public PlotOptionsEmaSonificationContextTracksMappingGapBetweenNotes GapBetweenNotes { get; set; }
		private PlotOptionsEmaSonificationContextTracksMappingGapBetweenNotes GapBetweenNotes_DefaultValue { get; set; }
		...
		/// </summary>
		public PlotOptionsEmaSonificationContextTracksMappingHighpass Highpass { get; set; }
		private PlotOptionsEmaSonificationContextTracksMappingHighpass Highpass_DefaultValue { get; set; }
		...
		/// </summary>
		public PlotOptionsEmaSonificationContextTracksMappingLowpass Lowpass { get; set; }
		private PlotOptionsEmaSonificationContextTracksMappingLowpass Lowpass_DefaultValue { get; set; }
		...
		/// </summary>
		public PlotOptionsEmaSonificationContextTracksMappingNoteDuration NoteDuration { get; set; }
		private PlotOptionsEmaSonificationContextTracksMappingNoteDuration NoteDuration_DefaultValue { get; set; }
		...
		/// </summary>
		public PlotOptionsEmaSonificationContextTracksMappingPan Pan { get; set; }
		private PlotOptionsEmaSonificationContextTracksMappingPan Pan_DefaultValue { get; set; }
		...
		/// </summary>
		public PlotOptionsEmaSonificationContextTracksMappingPitch Pitch { get; set; }
		private PlotOptionsEmaSonificationContextTracksMappingPitch Pitch_DefaultValue { get; set; }
		...
		/// </summary>
		public PlotOptionsEmaSonificationContextTracksMappingPlayDelay PlayDelay { get; set; }
		private PlotOptionsEmaSonificationContextTracksMappingPlayDelay PlayDelay_DefaultValue { get; set; }
		...
		/// </summary>
		public PlotOptionsEmaSonificationContextTracksMappingTime Time { get; set; }
		private PlotOptionsEmaSonificationContextTracksMappingTime Time_DefaultValue { get; set; }
		...
		/// </summary>
		public PlotOptionsEmaSonificationContextTracksMappingTremolo Tremolo { get; set; }
		private PlotOptionsEmaSonificationContextTracksMappingTremolo Tremolo_DefaultValue { get; set; }
		 

		/// <summary>
		/// The volume of notes, from 0 to 1.
		/// </summary>
		public PlotOptionsEmaSonificationContextTracksMappingVolume Volume { get; set; }
		private PlotOptionsEmaSonificationContextTracksMappingVolume Volume_DefaultValue { get; set; }
