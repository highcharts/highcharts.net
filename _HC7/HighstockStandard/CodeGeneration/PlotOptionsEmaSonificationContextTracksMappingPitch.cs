...
{
	public partial class PlotOptionsEmaSonificationContextTracksMappingPitch  : BaseObject
	{
		Hashtable h = new Hashtable();

		public PlotOptionsEmaSonificationContextTracksMappingPitch()
		{
			MapFunction = MapFunction_DefaultValue = PlotOptionsEmaSonificationContextTracksMappingPitchMapFunction.Linear;
		...
		/// </summary>
		public PlotOptionsEmaSonificationContextTracksMappingPitchMapFunction MapFunction { get; set; }
		private PlotOptionsEmaSonificationContextTracksMappingPitchMapFunction MapFunction_DefaultValue { get; set; }
