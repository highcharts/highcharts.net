...
{
	public partial class PlotOptionsEmaSonificationDefaultInstrumentOptionsMappingPan  : BaseObject
	{
		Hashtable h = new Hashtable();

		public PlotOptionsEmaSonificationDefaultInstrumentOptionsMappingPan()
		{
			MapFunction = MapFunction_DefaultValue = PlotOptionsEmaSonificationDefaultInstrumentOptionsMappingPanMapFunction.Linear;
			MapTo = MapTo_DefaultValue = "";
			Max = Max_DefaultValue = null;
			Min = Min_DefaultValue = null;
			Value = Value_DefaultValue = null;
			Within = Within_DefaultValue = PlotOptionsEmaSonificationDefaultInstrumentOptionsMappingPanWithin.Chart;
		...
		/// </summary>
		public PlotOptionsEmaSonificationDefaultInstrumentOptionsMappingPanMapFunction MapFunction { get; set; }
		private PlotOptionsEmaSonificationDefaultInstrumentOptionsMappingPanMapFunction MapFunction_DefaultValue { get; set; }
		...
		/// </summary>
		public PlotOptionsEmaSonificationDefaultInstrumentOptionsMappingPanWithin Within { get; set; }
		private PlotOptionsEmaSonificationDefaultInstrumentOptionsMappingPanWithin Within_DefaultValue { get; set; }
