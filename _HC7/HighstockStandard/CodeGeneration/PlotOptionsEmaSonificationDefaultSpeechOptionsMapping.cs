...
{
	public partial class PlotOptionsEmaSonificationDefaultSpeechOptionsMapping  : BaseObject
	{
		Hashtable h = new Hashtable();

		public PlotOptionsEmaSonificationDefaultSpeechOptionsMapping()
		{
			Frequency = Frequency_DefaultValue = new PlotOptionsEmaSonificationDefaultSpeechOptionsMappingFrequency();
			GapBetweenNotes = GapBetweenNotes_DefaultValue = new PlotOptionsEmaSonificationDefaultSpeechOptionsMappingGapBetweenNotes();
			Highpass = Highpass_DefaultValue = new PlotOptionsEmaSonificationDefaultSpeechOptionsMappingHighpass();
			Lowpass = Lowpass_DefaultValue = new PlotOptionsEmaSonificationDefaultSpeechOptionsMappingLowpass();
			NoteDuration = NoteDuration_DefaultValue = new PlotOptionsEmaSonificationDefaultSpeechOptionsMappingNoteDuration();
			Pan = Pan_DefaultValue = new PlotOptionsEmaSonificationDefaultSpeechOptionsMappingPan();
			Pitch = Pitch_DefaultValue = new PlotOptionsEmaSonificationDefaultSpeechOptionsMappingPitch();
			PitchString = PitchString_DefaultValue = "null";
			PitchNumber = PitchNumber_DefaultValue = null;
			PlayDelay = PlayDelay_DefaultValue = new PlotOptionsEmaSonificationDefaultSpeechOptionsMappingPlayDelay();
			Time = Time_DefaultValue = new PlotOptionsEmaSonificationDefaultSpeechOptionsMappingTime();
			TimeString = TimeString_DefaultValue = "null";
			TimeNumber = TimeNumber_DefaultValue = null;
			Tremolo = Tremolo_DefaultValue = new PlotOptionsEmaSonificationDefaultSpeechOptionsMappingTremolo();
			Volume = Volume_DefaultValue = new PlotOptionsEmaSonificationDefaultSpeechOptionsMappingVolume();
		...
		/// </summary>
		public PlotOptionsEmaSonificationDefaultSpeechOptionsMappingFrequency Frequency { get; set; }
		private PlotOptionsEmaSonificationDefaultSpeechOptionsMappingFrequency Frequency_DefaultValue { get; set; }
		...
		/// </summary>
		public PlotOptionsEmaSonificationDefaultSpeechOptionsMappingGapBetweenNotes GapBetweenNotes { get; set; }
		private PlotOptionsEmaSonificationDefaultSpeechOptionsMappingGapBetweenNotes GapBetweenNotes_DefaultValue { get; set; }
		...
		/// </summary>
		public PlotOptionsEmaSonificationDefaultSpeechOptionsMappingHighpass Highpass { get; set; }
		private PlotOptionsEmaSonificationDefaultSpeechOptionsMappingHighpass Highpass_DefaultValue { get; set; }
		...
		/// </summary>
		public PlotOptionsEmaSonificationDefaultSpeechOptionsMappingLowpass Lowpass { get; set; }
		private PlotOptionsEmaSonificationDefaultSpeechOptionsMappingLowpass Lowpass_DefaultValue { get; set; }
		...
		/// </summary>
		public PlotOptionsEmaSonificationDefaultSpeechOptionsMappingNoteDuration NoteDuration { get; set; }
		private PlotOptionsEmaSonificationDefaultSpeechOptionsMappingNoteDuration NoteDuration_DefaultValue { get; set; }
		...
		/// </summary>
		public PlotOptionsEmaSonificationDefaultSpeechOptionsMappingPan Pan { get; set; }
		private PlotOptionsEmaSonificationDefaultSpeechOptionsMappingPan Pan_DefaultValue { get; set; }
		...
		/// </summary>
		public PlotOptionsEmaSonificationDefaultSpeechOptionsMappingPitch Pitch { get; set; }
		private PlotOptionsEmaSonificationDefaultSpeechOptionsMappingPitch Pitch_DefaultValue { get; set; }
		...
		/// </summary>
		public PlotOptionsEmaSonificationDefaultSpeechOptionsMappingPlayDelay PlayDelay { get; set; }
		private PlotOptionsEmaSonificationDefaultSpeechOptionsMappingPlayDelay PlayDelay_DefaultValue { get; set; }
		...
		/// </summary>
		public PlotOptionsEmaSonificationDefaultSpeechOptionsMappingTime Time { get; set; }
		private PlotOptionsEmaSonificationDefaultSpeechOptionsMappingTime Time_DefaultValue { get; set; }
		...
		/// </summary>
		public PlotOptionsEmaSonificationDefaultSpeechOptionsMappingTremolo Tremolo { get; set; }
		private PlotOptionsEmaSonificationDefaultSpeechOptionsMappingTremolo Tremolo_DefaultValue { get; set; }
		 

		/// <summary>
		/// The volume of notes, from 0 to 1.
		/// </summary>
		public PlotOptionsEmaSonificationDefaultSpeechOptionsMappingVolume Volume { get; set; }
		private PlotOptionsEmaSonificationDefaultSpeechOptionsMappingVolume Volume_DefaultValue { get; set; }
