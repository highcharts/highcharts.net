...
{
	public partial class PlotOptionsEmaSonificationTracksMappingPan  : BaseObject
	{
		Hashtable h = new Hashtable();

		public PlotOptionsEmaSonificationTracksMappingPan()
		{
			MapFunction = MapFunction_DefaultValue = PlotOptionsEmaSonificationTracksMappingPanMapFunction.Linear;
			MapTo = MapTo_DefaultValue = "";
			Max = Max_DefaultValue = null;
			Min = Min_DefaultValue = null;
			Value = Value_DefaultValue = null;
			Within = Within_DefaultValue = PlotOptionsEmaSonificationTracksMappingPanWithin.Chart;
		...
		/// </summary>
		public PlotOptionsEmaSonificationTracksMappingPanMapFunction MapFunction { get; set; }
		private PlotOptionsEmaSonificationTracksMappingPanMapFunction MapFunction_DefaultValue { get; set; }
		...
		/// </summary>
		public PlotOptionsEmaSonificationTracksMappingPanWithin Within { get; set; }
		private PlotOptionsEmaSonificationTracksMappingPanWithin Within_DefaultValue { get; set; }
