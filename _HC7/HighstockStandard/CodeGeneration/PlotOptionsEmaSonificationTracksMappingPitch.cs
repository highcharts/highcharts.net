...
{
	public partial class PlotOptionsEmaSonificationTracksMappingPitch  : BaseObject
	{
		Hashtable h = new Hashtable();

		public PlotOptionsEmaSonificationTracksMappingPitch()
		{
			MapFunction = MapFunction_DefaultValue = PlotOptionsEmaSonificationTracksMappingPitchMapFunction.Linear;
		...
		/// </summary>
		public PlotOptionsEmaSonificationTracksMappingPitchMapFunction MapFunction { get; set; }
		private PlotOptionsEmaSonificationTracksMappingPitchMapFunction MapFunction_DefaultValue { get; set; }
