...
{
	public partial class PlotOptionsEmaSonificationTracksMappingTime  : BaseObject
	{
		Hashtable h = new Hashtable();

		public PlotOptionsEmaSonificationTracksMappingTime()
		{
			MapFunction = MapFunction_DefaultValue = PlotOptionsEmaSonificationTracksMappingTimeMapFunction.Linear;
			MapTo = MapTo_DefaultValue = "";
			Max = Max_DefaultValue = null;
			Min = Min_DefaultValue = null;
			Value = Value_DefaultValue = null;
			Within = Within_DefaultValue = PlotOptionsEmaSonificationTracksMappingTimeWithin.Chart;
		...
		/// </summary>
		public PlotOptionsEmaSonificationTracksMappingTimeMapFunction MapFunction { get; set; }
		private PlotOptionsEmaSonificationTracksMappingTimeMapFunction MapFunction_DefaultValue { get; set; }
		...
		/// </summary>
		public PlotOptionsEmaSonificationTracksMappingTimeWithin Within { get; set; }
		private PlotOptionsEmaSonificationTracksMappingTimeWithin Within_DefaultValue { get; set; }
