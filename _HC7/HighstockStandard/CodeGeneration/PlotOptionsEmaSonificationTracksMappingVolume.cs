...
{
	public partial class PlotOptionsEmaSonificationTracksMappingVolume  : BaseObject
	{
		Hashtable h = new Hashtable();

		public PlotOptionsEmaSonificationTracksMappingVolume()
		{
			MapFunction = MapFunction_DefaultValue = PlotOptionsEmaSonificationTracksMappingVolumeMapFunction.Linear;
			MapTo = MapTo_DefaultValue = "";
			Max = Max_DefaultValue = null;
			Min = Min_DefaultValue = null;
			Value = Value_DefaultValue = null;
			Within = Within_DefaultValue = PlotOptionsEmaSonificationTracksMappingVolumeWithin.Chart;
		...
		/// </summary>
		public PlotOptionsEmaSonificationTracksMappingVolumeMapFunction MapFunction { get; set; }
		private PlotOptionsEmaSonificationTracksMappingVolumeMapFunction MapFunction_DefaultValue { get; set; }
		...
		/// </summary>
		public PlotOptionsEmaSonificationTracksMappingVolumeWithin Within { get; set; }
		private PlotOptionsEmaSonificationTracksMappingVolumeWithin Within_DefaultValue { get; set; }
