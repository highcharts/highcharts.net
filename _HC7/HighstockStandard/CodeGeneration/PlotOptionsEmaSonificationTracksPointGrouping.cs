...
{
	public partial class PlotOptionsEmaSonificationTracksPointGrouping  : BaseObject
	{
		Hashtable h = new Hashtable();

		public PlotOptionsEmaSonificationTracksPointGrouping()
		{
			Algorithm = Algorithm_DefaultValue = PlotOptionsEmaSonificationTracksPointGroupingAlgorithm.Minimax;
		...
		/// </summary>
		public PlotOptionsEmaSonificationTracksPointGroupingAlgorithm Algorithm { get; set; }
		private PlotOptionsEmaSonificationTracksPointGroupingAlgorithm Algorithm_DefaultValue { get; set; }
