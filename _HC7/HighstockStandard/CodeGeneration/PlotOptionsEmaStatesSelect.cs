...
{
	public partial class PlotOptionsEmaStatesSelect  : BaseObject
	{
		Hashtable h = new Hashtable();

		public PlotOptionsEmaStatesSelect()
		{
			Animation = Animation_DefaultValue = new Animation() { Enabled = true };
			AnimationBool = AnimationBool_DefaultValue = null;
			Enabled = Enabled_DefaultValue = true;
			Halo = Halo_DefaultValue = new PlotOptionsEmaStatesSelectHalo();
			LineWidth = LineWidth_DefaultValue = null;
			LineWidthPlus = LineWidthPlus_DefaultValue = 1;
			Marker = Marker_DefaultValue = new PlotOptionsEmaStatesSelectMarker();
		...
		/// </summary>
		public PlotOptionsEmaStatesSelectHalo Halo { get; set; }
		private PlotOptionsEmaStatesSelectHalo Halo_DefaultValue { get; set; }
		...
		/// </summary>
		public PlotOptionsEmaStatesSelectMarker Marker { get; set; }
		private PlotOptionsEmaStatesSelectMarker Marker_DefaultValue { get; set; }
