...
{
	public partial class PlotOptionsEmaTooltip  : BaseObject
	{
		public PlotOptionsEmaTooltip()
		{
			...
			HeaderShape = HeaderShape_DefaultValue = PlotOptionsEmaTooltipHeaderShape.Callout;
		...
		/// </summary>
		public PlotOptionsEmaTooltipHeaderShape HeaderShape { get; set; }
		private PlotOptionsEmaTooltipHeaderShape HeaderShape_DefaultValue { get; set; }
		...
		internal override Hashtable ToHashtable()
		{
			...
			if (NullFormatter != NullFormatter_DefaultValue) { h.Add("nullFormatter",NullFormatter); Highstock.AddFunction("PlotOptionsEmaTooltipNullFormatter.nullFormatter", NullFormatter); }  
			if (Outside != Outside_DefaultValue) h.Add("outside",Outside);
			if (Padding != Padding_DefaultValue) h.Add("padding",Padding);
			if (PointFormat != PointFormat_DefaultValue) h.Add("pointFormat",PointFormat);
			if (PointFormatter != PointFormatter_DefaultValue) { h.Add("pointFormatter",PointFormatter); Highstock.AddFunction("PlotOptionsEmaTooltipPointFormatter.pointFormatter", PointFormatter); }  
