...
namespace Highsoft.Web.Mvc.Stocks
{
	public partial class PlotOptionsFlags  : BaseObject
	{
		...
		{
			Accessibility = Accessibility_DefaultValue = new PlotOptionsFlagsAccessibility();
			...
			DataSorting = DataSorting_DefaultValue = new PlotOptionsFlagsDataSorting();
			...
			LegendSymbol = LegendSymbol_DefaultValue = PlotOptionsFlagsLegendSymbol.Rectangle;
			...
			OnPoint = OnPoint_DefaultValue = new PlotOptionsFlagsOnPoint();
			...
			Sonification = Sonification_DefaultValue = new PlotOptionsFlagsSonification();
			...
			Zones = Zones_DefaultValue = new List<PlotOptionsFlagsZones>();
		...
		private PlotOptionsFlagsAccessibility Accessibility_DefaultValue { get; set; }
		...
		private PlotOptionsFlagsBoostBlending BoostBlending_DefaultValue { get; set; }
		...
		private PlotOptionsFlagsCompare Compare_DefaultValue { get; set; }
		...
		private PlotOptionsFlagsDashStyle DashStyle_DefaultValue { get; set; }
		...
		private PlotOptionsFlagsDataSorting DataSorting_DefaultValue { get; set; }
		...
		private PlotOptionsFlagsLegendSymbol LegendSymbol_DefaultValue { get; set; }
		...
		private PlotOptionsFlagsOnPoint OnPoint_DefaultValue { get; set; }
		...
		private PlotOptionsFlagsSonification Sonification_DefaultValue { get; set; }
		...
		private List<PlotOptionsFlagsZones> Zones_DefaultValue { get; set; }
