...
namespace Highsoft.Web.Mvc.Stocks
{
	public partial class PlotOptionsFlags  : BaseObject
	{
		...
		/// </summary>
		public PlotOptionsFlagsAccessibility Accessibility { get; set; }
		 

		/// <summary>
		/// Whether the flags are allowed to overlap sideways. If `false`, theflags are moved sideways using an algorithm that seeks to place everyflag as close as possible to its original position.
		/// </summary>
		...
		/// </summary>
		public PlotOptionsFlagsBoostBlending BoostBlending { get; set; }
		...
		/// </summary>
		public PlotOptionsFlagsCompare Compare { get; set; }
		...
		/// </summary>
		public PlotOptionsFlagsDashStyle DashStyle { get; set; }
		...
		/// </summary>
		public PlotOptionsFlagsDataSorting DataSorting { get; set; }
		...
		/// <summary>
		/// Fixed height of the flag's shape. By default, height isautocalculated according to the flag's title.
		/// </summary>
		...
		/// </summary>
		public PlotOptionsFlagsLegendSymbol LegendSymbol { get; set; }
		...
		/// </summary>
		public PlotOptionsFlagsOnPoint OnPoint { get; set; }
		...
		/// </summary>
		public PlotOptionsFlagsPointPlacement PointPlacement { get; set; }
		 

		/// <summary>
		/// Possible values: `"on"`, `"between"`, `number`.In a column chart, when pointPlacement is `"on"`, the point will notcreate any padding of the X axis. In a polar column chart this meansthat the first column points directly north. If the pointPlacement is`"between"`, the columns will be laid out between ticks. This isuseful for example for visualising an amount between two points intime or in a certain sector of a polar chart.Since Highcharts 3.0.2, the point placement can also be numeric,where 0 is on the axis value, -0.5 is between this value and theprevious, and 0.5 is between this value and the next. Unlike thetextual options, numeric point placement options won't affect axispadding.Note that pointPlacement needs a [pointRange](#plotOptions.series.pointRange) to work. For column series this iscomputed, but for line-type series it needs to be set.For the `xrange` series type and gantt charts, if the Y axis is acategory axis, the `pointPlacement` applies to the Y axis rather thanthe (typically datetime) X axis.Defaults to `undefined` in cartesian charts, `"between"` in polarcharts.
		/// </summary>
		public PlotOptionsFlagsPointPlacement PointPlacementNumber { get; set; }
		...
		/// </summary>
		public PlotOptionsFlagsSonification Sonification { get; set; }
		...
		/// <summary>
		/// The text to display on each flag. This can be defined on serieslevel, or individually for each point. Defaults to `"A"`.
		/// </summary>
		...
		/// </summary>
		public List<PlotOptionsFlagsZones> Zones { get; set; }
		  

		internal override Hashtable ToHashtable(Highstock highstock)
		{
			if (Accessibility != null) h.Add("accessibility",Accessibility.ToHashtable(highstock));
			if (AllowOverlapX != null) h.Add("allowOverlapX",AllowOverlapX);
			...
			if (BoostBlending != PlotOptionsFlagsBoostBlending.Null) h.Add("boostBlending", highstock.FirstCharacterToLower(BoostBlending.ToString()));
			...
			if (Compare != PlotOptionsFlagsCompare.Null) h.Add("compare", highstock.FirstCharacterToLower(Compare.ToString()));
			if (CompareBase != PlotOptionsFlagsCompareBase.Null) h.Add("compareBase", highstock.FirstCharacterToLower(CompareBase.ToString()));
			...
			if (Cursor != PlotOptionsFlagsCursor.Null) h.Add("cursor", highstock.FirstCharacterToLower(Cursor.ToString()));
			if (Custom != null) h.Add("custom",Custom);
			if (DashStyle != PlotOptionsFlagsDashStyle.Null) h.Add("dashStyle", highstock.FirstCharacterToLower(DashStyle.ToString()));
			...
			if (FindNearestPointBy != PlotOptionsFlagsFindNearestPointBy.Null) h.Add("findNearestPointBy", highstock.FirstCharacterToLower(FindNearestPointBy.ToString()));
			...
			if (LegendSymbol != PlotOptionsFlagsLegendSymbol.Null) h.Add("legendSymbol", highstock.FirstCharacterToLower(LegendSymbol.ToString()));
			...
			if (OnKey != PlotOptionsFlagsOnKey.Null) h.Add("onKey", highstock.FirstCharacterToLower(OnKey.ToString()));
			if (OnPoint != null) h.Add("onPoint",OnPoint.ToHashtable(highstock));
			if (OnSeries != null) h.Add("onSeries",OnSeries);
			...
			if (PointIntervalUnit != PlotOptionsFlagsPointIntervalUnit.Null) h.Add("pointIntervalUnit", highstock.FirstCharacterToLower(PointIntervalUnit.ToString()));
			if (PointPlacement != PlotOptionsFlagsPointPlacement.Null) h.Add("pointPlacement", highstock.FirstCharacterToLower(PointPlacement.ToString()));
			if (PointPlacementNumber != PlotOptionsFlagsPointPlacement.Null) h.Add("pointPlacement", highstock.FirstCharacterToLower(PointPlacementNumber.ToString()));
			...
			if (StackDistance != null) h.Add("stackDistance",StackDistance);
			if (Stacking != PlotOptionsFlagsStacking.Null) h.Add("stacking", highstock.FirstCharacterToLower(Stacking.ToString()));
			if (States != null) h.Add("states",States.ToHashtable(highstock));
			if (StickyTracking != null) h.Add("stickyTracking",StickyTracking);
			if (Style != null) h.Add("style",Style);
			if (TextAlign != PlotOptionsFlagsTextAlign.Null) h.Add("textAlign", highstock.FirstCharacterToLower(TextAlign.ToString()));
