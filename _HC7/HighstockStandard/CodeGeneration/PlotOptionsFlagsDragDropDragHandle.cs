...
{
	public partial class PlotOptionsFlagsDragDropDragHandle  : BaseObject
	{
		public PlotOptionsFlagsDragDropDragHandle()
		{
		...
		internal override Hashtable ToHashtable()
		{
			...
			if (PathFormatter != PathFormatter_DefaultValue) { h.Add("pathFormatter",PathFormatter); Highstock.AddFunction("PlotOptionsFlagsDragDropDragHandlePathFormatter.pathFormatter", PathFormatter); }  
