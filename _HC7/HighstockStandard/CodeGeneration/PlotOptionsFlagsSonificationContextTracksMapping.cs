...
{
	public partial class PlotOptionsFlagsSonificationContextTracksMapping  : BaseObject
	{
		Hashtable h = new Hashtable();

		public PlotOptionsFlagsSonificationContextTracksMapping()
		{
			Frequency = Frequency_DefaultValue = new PlotOptionsFlagsSonificationContextTracksMappingFrequency();
			GapBetweenNotes = GapBetweenNotes_DefaultValue = new PlotOptionsFlagsSonificationContextTracksMappingGapBetweenNotes();
			Highpass = Highpass_DefaultValue = new PlotOptionsFlagsSonificationContextTracksMappingHighpass();
			Lowpass = Lowpass_DefaultValue = new PlotOptionsFlagsSonificationContextTracksMappingLowpass();
			NoteDuration = NoteDuration_DefaultValue = new PlotOptionsFlagsSonificationContextTracksMappingNoteDuration();
			Pan = Pan_DefaultValue = new PlotOptionsFlagsSonificationContextTracksMappingPan();
			Pitch = Pitch_DefaultValue = new PlotOptionsFlagsSonificationContextTracksMappingPitch();
			PitchString = PitchString_DefaultValue = "null";
			PitchNumber = PitchNumber_DefaultValue = null;
			PlayDelay = PlayDelay_DefaultValue = new PlotOptionsFlagsSonificationContextTracksMappingPlayDelay();
			Time = Time_DefaultValue = new PlotOptionsFlagsSonificationContextTracksMappingTime();
			TimeString = TimeString_DefaultValue = "null";
			TimeNumber = TimeNumber_DefaultValue = null;
			Tremolo = Tremolo_DefaultValue = new PlotOptionsFlagsSonificationContextTracksMappingTremolo();
			Volume = Volume_DefaultValue = new PlotOptionsFlagsSonificationContextTracksMappingVolume();
		...
		/// </summary>
		public PlotOptionsFlagsSonificationContextTracksMappingFrequency Frequency { get; set; }
		private PlotOptionsFlagsSonificationContextTracksMappingFrequency Frequency_DefaultValue { get; set; }
		...
		/// </summary>
		public PlotOptionsFlagsSonificationContextTracksMappingGapBetweenNotes GapBetweenNotes { get; set; }
		private PlotOptionsFlagsSonificationContextTracksMappingGapBetweenNotes GapBetweenNotes_DefaultValue { get; set; }
		...
		/// </summary>
		public PlotOptionsFlagsSonificationContextTracksMappingHighpass Highpass { get; set; }
		private PlotOptionsFlagsSonificationContextTracksMappingHighpass Highpass_DefaultValue { get; set; }
		...
		/// </summary>
		public PlotOptionsFlagsSonificationContextTracksMappingLowpass Lowpass { get; set; }
		private PlotOptionsFlagsSonificationContextTracksMappingLowpass Lowpass_DefaultValue { get; set; }
		...
		/// </summary>
		public PlotOptionsFlagsSonificationContextTracksMappingNoteDuration NoteDuration { get; set; }
		private PlotOptionsFlagsSonificationContextTracksMappingNoteDuration NoteDuration_DefaultValue { get; set; }
		...
		/// </summary>
		public PlotOptionsFlagsSonificationContextTracksMappingPan Pan { get; set; }
		private PlotOptionsFlagsSonificationContextTracksMappingPan Pan_DefaultValue { get; set; }
		...
		/// </summary>
		public PlotOptionsFlagsSonificationContextTracksMappingPitch Pitch { get; set; }
		private PlotOptionsFlagsSonificationContextTracksMappingPitch Pitch_DefaultValue { get; set; }
		...
		/// </summary>
		public PlotOptionsFlagsSonificationContextTracksMappingPlayDelay PlayDelay { get; set; }
		private PlotOptionsFlagsSonificationContextTracksMappingPlayDelay PlayDelay_DefaultValue { get; set; }
		...
		/// </summary>
		public PlotOptionsFlagsSonificationContextTracksMappingTime Time { get; set; }
		private PlotOptionsFlagsSonificationContextTracksMappingTime Time_DefaultValue { get; set; }
		...
		/// </summary>
		public PlotOptionsFlagsSonificationContextTracksMappingTremolo Tremolo { get; set; }
		private PlotOptionsFlagsSonificationContextTracksMappingTremolo Tremolo_DefaultValue { get; set; }
		 

		/// <summary>
		/// The volume of notes, from 0 to 1.
		/// </summary>
		public PlotOptionsFlagsSonificationContextTracksMappingVolume Volume { get; set; }
		private PlotOptionsFlagsSonificationContextTracksMappingVolume Volume_DefaultValue { get; set; }
