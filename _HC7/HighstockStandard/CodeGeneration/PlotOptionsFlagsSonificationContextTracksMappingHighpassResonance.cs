...
{
	public partial class PlotOptionsFlagsSonificationContextTracksMappingHighpassResonance  : BaseObject
	{
		Hashtable h = new Hashtable();

		public PlotOptionsFlagsSonificationContextTracksMappingHighpassResonance()
		{
			MapFunction = MapFunction_DefaultValue = PlotOptionsFlagsSonificationContextTracksMappingHighpassResonanceMapFunction.Linear;
			MapTo = MapTo_DefaultValue = "";
			Max = Max_DefaultValue = null;
			Min = Min_DefaultValue = null;
			Value = Value_DefaultValue = null;
			Within = Within_DefaultValue = PlotOptionsFlagsSonificationContextTracksMappingHighpassResonanceWithin.Chart;
		...
		/// </summary>
		public PlotOptionsFlagsSonificationContextTracksMappingHighpassResonanceMapFunction MapFunction { get; set; }
		private PlotOptionsFlagsSonificationContextTracksMappingHighpassResonanceMapFunction MapFunction_DefaultValue { get; set; }
		...
		/// </summary>
		public PlotOptionsFlagsSonificationContextTracksMappingHighpassResonanceWithin Within { get; set; }
		private PlotOptionsFlagsSonificationContextTracksMappingHighpassResonanceWithin Within_DefaultValue { get; set; }
