...
{
	public partial class PlotOptionsFlagsSonificationContextTracksMappingLowpassFrequency  : BaseObject
	{
		Hashtable h = new Hashtable();

		public PlotOptionsFlagsSonificationContextTracksMappingLowpassFrequency()
		{
			MapFunction = MapFunction_DefaultValue = PlotOptionsFlagsSonificationContextTracksMappingLowpassFrequencyMapFunction.Linear;
			MapTo = MapTo_DefaultValue = "";
			Max = Max_DefaultValue = null;
			Min = Min_DefaultValue = null;
			Value = Value_DefaultValue = null;
			Within = Within_DefaultValue = PlotOptionsFlagsSonificationContextTracksMappingLowpassFrequencyWithin.Chart;
		...
		/// </summary>
		public PlotOptionsFlagsSonificationContextTracksMappingLowpassFrequencyMapFunction MapFunction { get; set; }
		private PlotOptionsFlagsSonificationContextTracksMappingLowpassFrequencyMapFunction MapFunction_DefaultValue { get; set; }
		...
		/// </summary>
		public PlotOptionsFlagsSonificationContextTracksMappingLowpassFrequencyWithin Within { get; set; }
		private PlotOptionsFlagsSonificationContextTracksMappingLowpassFrequencyWithin Within_DefaultValue { get; set; }
