...
{
	public partial class PlotOptionsFlagsSonificationContextTracksMappingNoteDuration  : BaseObject
	{
		Hashtable h = new Hashtable();

		public PlotOptionsFlagsSonificationContextTracksMappingNoteDuration()
		{
			MapFunction = MapFunction_DefaultValue = PlotOptionsFlagsSonificationContextTracksMappingNoteDurationMapFunction.Linear;
			MapTo = MapTo_DefaultValue = "";
			Max = Max_DefaultValue = null;
			Min = Min_DefaultValue = null;
			Value = Value_DefaultValue = null;
			Within = Within_DefaultValue = PlotOptionsFlagsSonificationContextTracksMappingNoteDurationWithin.Chart;
		...
		/// </summary>
		public PlotOptionsFlagsSonificationContextTracksMappingNoteDurationMapFunction MapFunction { get; set; }
		private PlotOptionsFlagsSonificationContextTracksMappingNoteDurationMapFunction MapFunction_DefaultValue { get; set; }
		...
		/// </summary>
		public PlotOptionsFlagsSonificationContextTracksMappingNoteDurationWithin Within { get; set; }
		private PlotOptionsFlagsSonificationContextTracksMappingNoteDurationWithin Within_DefaultValue { get; set; }
