...
{
	public partial class PlotOptionsFlagsSonificationDefaultInstrumentOptionsActiveWhen  : BaseObject
	{
		Hashtable h = new Hashtable();

		public PlotOptionsFlagsSonificationDefaultInstrumentOptionsActiveWhen()
		{
