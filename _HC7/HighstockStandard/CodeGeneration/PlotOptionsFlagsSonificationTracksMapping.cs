...
{
	public partial class PlotOptionsFlagsSonificationTracksMapping  : BaseObject
	{
		Hashtable h = new Hashtable();

		public PlotOptionsFlagsSonificationTracksMapping()
		{
			Frequency = Frequency_DefaultValue = new PlotOptionsFlagsSonificationTracksMappingFrequency();
			GapBetweenNotes = GapBetweenNotes_DefaultValue = new PlotOptionsFlagsSonificationTracksMappingGapBetweenNotes();
			Highpass = Highpass_DefaultValue = new PlotOptionsFlagsSonificationTracksMappingHighpass();
			Lowpass = Lowpass_DefaultValue = new PlotOptionsFlagsSonificationTracksMappingLowpass();
			NoteDuration = NoteDuration_DefaultValue = new PlotOptionsFlagsSonificationTracksMappingNoteDuration();
			Pan = Pan_DefaultValue = new PlotOptionsFlagsSonificationTracksMappingPan();
			Pitch = Pitch_DefaultValue = new PlotOptionsFlagsSonificationTracksMappingPitch();
			PitchString = PitchString_DefaultValue = "null";
			PitchNumber = PitchNumber_DefaultValue = null;
			PlayDelay = PlayDelay_DefaultValue = new PlotOptionsFlagsSonificationTracksMappingPlayDelay();
			Time = Time_DefaultValue = new PlotOptionsFlagsSonificationTracksMappingTime();
			TimeString = TimeString_DefaultValue = "null";
			TimeNumber = TimeNumber_DefaultValue = null;
			Tremolo = Tremolo_DefaultValue = new PlotOptionsFlagsSonificationTracksMappingTremolo();
			Volume = Volume_DefaultValue = new PlotOptionsFlagsSonificationTracksMappingVolume();
		...
		/// </summary>
		public PlotOptionsFlagsSonificationTracksMappingFrequency Frequency { get; set; }
		private PlotOptionsFlagsSonificationTracksMappingFrequency Frequency_DefaultValue { get; set; }
		...
		/// </summary>
		public PlotOptionsFlagsSonificationTracksMappingGapBetweenNotes GapBetweenNotes { get; set; }
		private PlotOptionsFlagsSonificationTracksMappingGapBetweenNotes GapBetweenNotes_DefaultValue { get; set; }
		...
		/// </summary>
		public PlotOptionsFlagsSonificationTracksMappingHighpass Highpass { get; set; }
		private PlotOptionsFlagsSonificationTracksMappingHighpass Highpass_DefaultValue { get; set; }
		...
		/// </summary>
		public PlotOptionsFlagsSonificationTracksMappingLowpass Lowpass { get; set; }
		private PlotOptionsFlagsSonificationTracksMappingLowpass Lowpass_DefaultValue { get; set; }
		...
		/// </summary>
		public PlotOptionsFlagsSonificationTracksMappingNoteDuration NoteDuration { get; set; }
		private PlotOptionsFlagsSonificationTracksMappingNoteDuration NoteDuration_DefaultValue { get; set; }
		...
		/// </summary>
		public PlotOptionsFlagsSonificationTracksMappingPan Pan { get; set; }
		private PlotOptionsFlagsSonificationTracksMappingPan Pan_DefaultValue { get; set; }
		...
		/// </summary>
		public PlotOptionsFlagsSonificationTracksMappingPitch Pitch { get; set; }
		private PlotOptionsFlagsSonificationTracksMappingPitch Pitch_DefaultValue { get; set; }
		...
		/// </summary>
		public PlotOptionsFlagsSonificationTracksMappingPlayDelay PlayDelay { get; set; }
		private PlotOptionsFlagsSonificationTracksMappingPlayDelay PlayDelay_DefaultValue { get; set; }
		...
		/// </summary>
		public PlotOptionsFlagsSonificationTracksMappingTime Time { get; set; }
		private PlotOptionsFlagsSonificationTracksMappingTime Time_DefaultValue { get; set; }
		...
		/// </summary>
		public PlotOptionsFlagsSonificationTracksMappingTremolo Tremolo { get; set; }
		private PlotOptionsFlagsSonificationTracksMappingTremolo Tremolo_DefaultValue { get; set; }
		 

		/// <summary>
		/// The volume of notes, from 0 to 1.
		/// </summary>
		public PlotOptionsFlagsSonificationTracksMappingVolume Volume { get; set; }
		private PlotOptionsFlagsSonificationTracksMappingVolume Volume_DefaultValue { get; set; }
