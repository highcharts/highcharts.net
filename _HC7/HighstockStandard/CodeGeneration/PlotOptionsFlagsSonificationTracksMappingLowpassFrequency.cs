...
{
	public partial class PlotOptionsFlagsSonificationTracksMappingLowpassFrequency  : BaseObject
	{
		Hashtable h = new Hashtable();

		public PlotOptionsFlagsSonificationTracksMappingLowpassFrequency()
		{
			MapFunction = MapFunction_DefaultValue = PlotOptionsFlagsSonificationTracksMappingLowpassFrequencyMapFunction.Linear;
			MapTo = MapTo_DefaultValue = "";
			Max = Max_DefaultValue = null;
			Min = Min_DefaultValue = null;
			Value = Value_DefaultValue = null;
			Within = Within_DefaultValue = PlotOptionsFlagsSonificationTracksMappingLowpassFrequencyWithin.Chart;
		...
		/// </summary>
		public PlotOptionsFlagsSonificationTracksMappingLowpassFrequencyMapFunction MapFunction { get; set; }
		private PlotOptionsFlagsSonificationTracksMappingLowpassFrequencyMapFunction MapFunction_DefaultValue { get; set; }
		...
		/// </summary>
		public PlotOptionsFlagsSonificationTracksMappingLowpassFrequencyWithin Within { get; set; }
		private PlotOptionsFlagsSonificationTracksMappingLowpassFrequencyWithin Within_DefaultValue { get; set; }
