...
{
	public partial class PlotOptionsFlagsSonificationTracksMappingPan  : BaseObject
	{
		Hashtable h = new Hashtable();

		public PlotOptionsFlagsSonificationTracksMappingPan()
		{
			MapFunction = MapFunction_DefaultValue = PlotOptionsFlagsSonificationTracksMappingPanMapFunction.Linear;
			MapTo = MapTo_DefaultValue = "";
			Max = Max_DefaultValue = null;
			Min = Min_DefaultValue = null;
			Value = Value_DefaultValue = null;
			Within = Within_DefaultValue = PlotOptionsFlagsSonificationTracksMappingPanWithin.Chart;
		...
		/// </summary>
		public PlotOptionsFlagsSonificationTracksMappingPanMapFunction MapFunction { get; set; }
		private PlotOptionsFlagsSonificationTracksMappingPanMapFunction MapFunction_DefaultValue { get; set; }
		...
		/// </summary>
		public PlotOptionsFlagsSonificationTracksMappingPanWithin Within { get; set; }
		private PlotOptionsFlagsSonificationTracksMappingPanWithin Within_DefaultValue { get; set; }
