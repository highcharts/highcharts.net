...
{
	public partial class PlotOptionsFlagsSonificationTracksMappingPitch  : BaseObject
	{
		Hashtable h = new Hashtable();

		public PlotOptionsFlagsSonificationTracksMappingPitch()
		{
			MapFunction = MapFunction_DefaultValue = PlotOptionsFlagsSonificationTracksMappingPitchMapFunction.Linear;
		...
		/// </summary>
		public PlotOptionsFlagsSonificationTracksMappingPitchMapFunction MapFunction { get; set; }
		private PlotOptionsFlagsSonificationTracksMappingPitchMapFunction MapFunction_DefaultValue { get; set; }
