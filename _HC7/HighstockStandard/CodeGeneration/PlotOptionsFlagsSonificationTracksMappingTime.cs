...
{
	public partial class PlotOptionsFlagsSonificationTracksMappingTime  : BaseObject
	{
		Hashtable h = new Hashtable();

		public PlotOptionsFlagsSonificationTracksMappingTime()
		{
			MapFunction = MapFunction_DefaultValue = PlotOptionsFlagsSonificationTracksMappingTimeMapFunction.Linear;
			MapTo = MapTo_DefaultValue = "";
			Max = Max_DefaultValue = null;
			Min = Min_DefaultValue = null;
			Value = Value_DefaultValue = null;
			Within = Within_DefaultValue = PlotOptionsFlagsSonificationTracksMappingTimeWithin.Chart;
		...
		/// </summary>
		public PlotOptionsFlagsSonificationTracksMappingTimeMapFunction MapFunction { get; set; }
		private PlotOptionsFlagsSonificationTracksMappingTimeMapFunction MapFunction_DefaultValue { get; set; }
		...
		/// </summary>
		public PlotOptionsFlagsSonificationTracksMappingTimeWithin Within { get; set; }
		private PlotOptionsFlagsSonificationTracksMappingTimeWithin Within_DefaultValue { get; set; }
