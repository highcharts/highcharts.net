...
{
	public partial class PlotOptionsFlagsSonificationTracksMappingVolume  : BaseObject
	{
		Hashtable h = new Hashtable();

		public PlotOptionsFlagsSonificationTracksMappingVolume()
		{
			MapFunction = MapFunction_DefaultValue = PlotOptionsFlagsSonificationTracksMappingVolumeMapFunction.Linear;
			MapTo = MapTo_DefaultValue = "";
			Max = Max_DefaultValue = null;
			Min = Min_DefaultValue = null;
			Value = Value_DefaultValue = null;
			Within = Within_DefaultValue = PlotOptionsFlagsSonificationTracksMappingVolumeWithin.Chart;
		...
		/// </summary>
		public PlotOptionsFlagsSonificationTracksMappingVolumeMapFunction MapFunction { get; set; }
		private PlotOptionsFlagsSonificationTracksMappingVolumeMapFunction MapFunction_DefaultValue { get; set; }
		...
		/// </summary>
		public PlotOptionsFlagsSonificationTracksMappingVolumeWithin Within { get; set; }
		private PlotOptionsFlagsSonificationTracksMappingVolumeWithin Within_DefaultValue { get; set; }
