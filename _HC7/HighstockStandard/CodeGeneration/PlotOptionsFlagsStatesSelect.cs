...
{
	public partial class PlotOptionsFlagsStatesSelect  : BaseObject
	{
		public PlotOptionsFlagsStatesSelect()
		{
			Animation = Animation_DefaultValue = new Animation() { Enabled = true };
			Enabled = Enabled_DefaultValue = true;
			Halo = Halo_DefaultValue = new PlotOptionsFlagsStatesSelectHalo();
			LineWidth = LineWidth_DefaultValue = null;
			LineWidthPlus = LineWidthPlus_DefaultValue = 1;
			Marker = Marker_DefaultValue = new PlotOptionsFlagsStatesSelectMarker();
		...
		/// </summary>
		public PlotOptionsFlagsStatesSelectHalo Halo { get; set; }
		private PlotOptionsFlagsStatesSelectHalo Halo_DefaultValue { get; set; }
		...
		/// </summary>
		public PlotOptionsFlagsStatesSelectMarker Marker { get; set; }
		private PlotOptionsFlagsStatesSelectMarker Marker_DefaultValue { get; set; }
