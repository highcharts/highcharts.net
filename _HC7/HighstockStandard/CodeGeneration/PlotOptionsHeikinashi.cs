...
namespace Highsoft.Web.Mvc.Stocks
{
	public partial class PlotOptionsHeikinashi  : BaseObject
	{
		...
		public PlotOptionsHeikinashi()
		{
			...
			Zones = Zones_DefaultValue = new List<PlotOptionsHeikinashiZone>();
		...
		/// </summary>
		public List<PlotOptionsHeikinashiZone> Zones { get; set; }
		private List<PlotOptionsHeikinashiZone> Zones_DefaultValue { get; set; }
