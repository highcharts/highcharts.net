...
{
	public partial class PlotOptionsHeikinashi  : BaseObject
	{
		Hashtable h = new Hashtable();

		public PlotOptionsHeikinashi()
		{
			Accessibility = Accessibility_DefaultValue = new PlotOptionsHeikinashiAccessibility();
			AllowPointSelect = AllowPointSelect_DefaultValue = false;
			Animation = Animation_DefaultValue = new Animation() { Enabled = true };
			AnimationBool = AnimationBool_DefaultValue = true;
			AnimationLimit = AnimationLimit_DefaultValue = null;
			BoostBlending = BoostBlending_DefaultValue = PlotOptionsHeikinashiBoostBlending.Undefined;
			...
			Compare = Compare_DefaultValue = PlotOptionsHeikinashiCompare.Percent;
			CompareBase = CompareBase_DefaultValue = PlotOptionsHeikinashiCompareBase.Min;
			CompareStart = CompareStart_DefaultValue = false;
			CropThreshold = CropThreshold_DefaultValue = 300;
			Cumulative = Cumulative_DefaultValue = false;
			Cursor = Cursor_DefaultValue = PlotOptionsHeikinashiCursor.Null;
			Custom = Custom_DefaultValue = new Hashtable();
			DashStyle = DashStyle_DefaultValue = PlotOptionsHeikinashiDashStyle.Null;
			DataGrouping = DataGrouping_DefaultValue = new PlotOptionsHeikinashiDataGrouping();
			DataLabels = DataLabels_DefaultValue = new PlotOptionsHeikinashiDataLabels();
			DataSorting = DataSorting_DefaultValue = new PlotOptionsHeikinashiDataSorting();
			Depth = Depth_DefaultValue = 25;
			Description = Description_DefaultValue = "";
			DragDrop = DragDrop_DefaultValue = new PlotOptionsHeikinashiDragDrop();
			EdgeColor = EdgeColor_DefaultValue = "";
			EdgeWidth = EdgeWidth_DefaultValue = 1;
			EnableMouseTracking = EnableMouseTracking_DefaultValue = true;
			Events = Events_DefaultValue = new PlotOptionsHeikinashiEvents();
			FindNearestPointBy = FindNearestPointBy_DefaultValue = PlotOptionsHeikinashiFindNearestPointBy.X;
			...
			Label = Label_DefaultValue = new PlotOptionsHeikinashiLabel();
			LastPrice = LastPrice_DefaultValue = new PlotOptionsHeikinashiLastPrice();
			LastVisiblePrice = LastVisiblePrice_DefaultValue = new PlotOptionsHeikinashiLastVisiblePrice();
			LegendSymbol = LegendSymbol_DefaultValue = PlotOptionsHeikinashiLegendSymbol.Rectangle;
			...
			OnPoint = OnPoint_DefaultValue = new PlotOptionsHeikinashiOnPoint();
			Opacity = Opacity_DefaultValue = 1;
			Point = Point_DefaultValue = new PlotOptionsHeikinashiPoint();
			PointDescriptionFormat = PointDescriptionFormat_DefaultValue = "";
			PointDescriptionFormatter = PointDescriptionFormatter_DefaultValue = "";
			PointInterval = PointInterval_DefaultValue = 1;
			PointIntervalUnit = PointIntervalUnit_DefaultValue = PlotOptionsHeikinashiPointIntervalUnit.Null;
			PointPadding = PointPadding_DefaultValue = null;
			PointPlacement = PointPlacement_DefaultValue = new PointPlacement();
			PointRange = PointRange_DefaultValue = 0;
			PointStart = PointStart_DefaultValue = 0;
			PointValKey = PointValKey_DefaultValue = PlotOptionsHeikinashiPointValKey.Close;
			...
			Sonification = Sonification_DefaultValue = new PlotOptionsHeikinashiSonification();
			States = States_DefaultValue = new PlotOptionsHeikinashiStates();
			StickyTracking = StickyTracking_DefaultValue = true;
			Threshold = Threshold_DefaultValue = 0;
			Tooltip = Tooltip_DefaultValue = new PlotOptionsHeikinashiTooltip();
			TurboThreshold = TurboThreshold_DefaultValue = 1000;
			UpColor = UpColor_DefaultValue = "";
			UpLineColor = UpLineColor_DefaultValue = "";
			Visible = Visible_DefaultValue = true;
			ZoneAxis = ZoneAxis_DefaultValue = "y";
			Zones = Zones_DefaultValue = new List<PlotOptionsHeikinashiZones>();
		...
		/// </summary>
		public PlotOptionsHeikinashiAccessibility Accessibility { get; set; }
		private PlotOptionsHeikinashiAccessibility Accessibility_DefaultValue { get; set; }
		...
		/// </summary>
		public PlotOptionsHeikinashiBoostBlending BoostBlending { get; set; }
		private PlotOptionsHeikinashiBoostBlending BoostBlending_DefaultValue { get; set; }
		...
		/// </summary>
		public PlotOptionsHeikinashiCompare Compare { get; set; }
		private PlotOptionsHeikinashiCompare Compare_DefaultValue { get; set; }
		 

		/// <summary>
		/// When [compare](#plotOptions.series.compare) is `percent`, this optiondictates whether to use 0 or 100 as the base of comparison.
		/// </summary>
		public PlotOptionsHeikinashiCompareBase CompareBase { get; set; }
		private PlotOptionsHeikinashiCompareBase CompareBase_DefaultValue { get; set; }
		...
		/// </summary>
		public PlotOptionsHeikinashiCursor Cursor { get; set; }
		private PlotOptionsHeikinashiCursor Cursor_DefaultValue { get; set; }
		...
		/// </summary>
		public PlotOptionsHeikinashiDashStyle DashStyle { get; set; }
		private PlotOptionsHeikinashiDashStyle DashStyle_DefaultValue { get; set; }
		 

		/// <summary>
		/// 
		/// </summary>
		public PlotOptionsHeikinashiDataGrouping DataGrouping { get; set; }
		private PlotOptionsHeikinashiDataGrouping DataGrouping_DefaultValue { get; set; }
		...
		/// </summary>
		public PlotOptionsHeikinashiDataLabels DataLabels { get; set; }
		private PlotOptionsHeikinashiDataLabels DataLabels_DefaultValue { get; set; }
		 

		/// <summary>
		/// Options for the series data sorting.
		/// </summary>
		public PlotOptionsHeikinashiDataSorting DataSorting { get; set; }
		private PlotOptionsHeikinashiDataSorting DataSorting_DefaultValue { get; set; }
		...
		/// </summary>
		public PlotOptionsHeikinashiDragDrop DragDrop { get; set; }
		private PlotOptionsHeikinashiDragDrop DragDrop_DefaultValue { get; set; }
		...
		/// </summary>
		public PlotOptionsHeikinashiEvents Events { get; set; }
		private PlotOptionsHeikinashiEvents Events_DefaultValue { get; set; }
		...
		/// </summary>
		public PlotOptionsHeikinashiFindNearestPointBy FindNearestPointBy { get; set; }
		private PlotOptionsHeikinashiFindNearestPointBy FindNearestPointBy_DefaultValue { get; set; }
		...
		/// </summary>
		public PlotOptionsHeikinashiLabel Label { get; set; }
		private PlotOptionsHeikinashiLabel Label_DefaultValue { get; set; }
		 

		/// <summary>
		/// The line marks the last price from all points.
		/// </summary>
		public PlotOptionsHeikinashiLastPrice LastPrice { get; set; }
		private PlotOptionsHeikinashiLastPrice LastPrice_DefaultValue { get; set; }
		 

		/// <summary>
		/// The line marks the last price from visible range of points.
		/// </summary>
		public PlotOptionsHeikinashiLastVisiblePrice LastVisiblePrice { get; set; }
		private PlotOptionsHeikinashiLastVisiblePrice LastVisiblePrice_DefaultValue { get; set; }
		 

		/// <summary>
		/// What type of legend symbol to render for this series. Can be one of`areaMarker`, `lineMarker` or `rectangle`.
		/// </summary>
		public PlotOptionsHeikinashiLegendSymbol LegendSymbol { get; set; }
		private PlotOptionsHeikinashiLegendSymbol LegendSymbol_DefaultValue { get; set; }
		...
		/// </summary>
		public PlotOptionsHeikinashiOnPoint OnPoint { get; set; }
		private PlotOptionsHeikinashiOnPoint OnPoint_DefaultValue { get; set; }
		...
		/// </summary>
		public PlotOptionsHeikinashiPoint Point { get; set; }
		private PlotOptionsHeikinashiPoint Point_DefaultValue { get; set; }
		...
		/// </summary>
		public PlotOptionsHeikinashiPointIntervalUnit PointIntervalUnit { get; set; }
		private PlotOptionsHeikinashiPointIntervalUnit PointIntervalUnit_DefaultValue { get; set; }
		...
		/// </summary>
		public PlotOptionsHeikinashiPointValKey PointValKey { get; set; }
		private PlotOptionsHeikinashiPointValKey PointValKey_DefaultValue { get; set; }
		...
		/// </summary>
		public PlotOptionsHeikinashiSonification Sonification { get; set; }
		private PlotOptionsHeikinashiSonification Sonification_DefaultValue { get; set; }
		 

		/// <summary>
		/// 
		/// </summary>
		public PlotOptionsHeikinashiStates States { get; set; }
		private PlotOptionsHeikinashiStates States_DefaultValue { get; set; }
		...
		/// </summary>
		public PlotOptionsHeikinashiTooltip Tooltip { get; set; }
		private PlotOptionsHeikinashiTooltip Tooltip_DefaultValue { get; set; }
		...
		/// </summary>
		public List<PlotOptionsHeikinashiZones> Zones { get; set; }
		private List<PlotOptionsHeikinashiZones> Zones_DefaultValue { get; set; }
