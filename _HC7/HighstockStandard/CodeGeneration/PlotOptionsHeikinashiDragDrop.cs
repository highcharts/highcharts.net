...
{
	public partial class PlotOptionsHeikinashiDragDrop  : BaseObject
	{
		Hashtable h = new Hashtable();

		public PlotOptionsHeikinashiDragDrop()
		{
			DraggableX = DraggableX_DefaultValue = null;
			DraggableY = DraggableY_DefaultValue = null;
			DragHandle = DragHandle_DefaultValue = new PlotOptionsHeikinashiDragDropDragHandle();
			...
			GuideBox = GuideBox_DefaultValue = new PlotOptionsHeikinashiDragDropGuideBox();
		...
		/// </summary>
		public PlotOptionsHeikinashiDragDropDragHandle DragHandle { get; set; }
		private PlotOptionsHeikinashiDragDropDragHandle DragHandle_DefaultValue { get; set; }
		...
		/// </summary>
		public PlotOptionsHeikinashiDragDropGuideBox GuideBox { get; set; }
		private PlotOptionsHeikinashiDragDropGuideBox GuideBox_DefaultValue { get; set; }
