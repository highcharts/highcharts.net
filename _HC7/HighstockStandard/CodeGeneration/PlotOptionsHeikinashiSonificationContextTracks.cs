...
{
	public partial class PlotOptionsHeikinashiSonificationContextTracks  : BaseObject
	{
		Hashtable h = new Hashtable();

		public PlotOptionsHeikinashiSonificationContextTracks()
		{
			ActiveWhen = ActiveWhen_DefaultValue = new PlotOptionsHeikinashiSonificationContextTracksActiveWhen();
			Instrument = Instrument_DefaultValue = null;
			InstrumentString = InstrumentString_DefaultValue = "null";
			Mapping = Mapping_DefaultValue = new PlotOptionsHeikinashiSonificationContextTracksMapping();
			MidiName = MidiName_DefaultValue = "";
			PointGrouping = PointGrouping_DefaultValue = new PlotOptionsHeikinashiSonificationContextTracksPointGrouping();
			...
			Type = Type_DefaultValue = PlotOptionsHeikinashiSonificationContextTracksType.Instrument;
			ValueInterval = ValueInterval_DefaultValue = null;
			ValueMapFunction = ValueMapFunction_DefaultValue = PlotOptionsHeikinashiSonificationContextTracksValueMapFunction.Linear;
		...
		/// </summary>
		public PlotOptionsHeikinashiSonificationContextTracksActiveWhen ActiveWhen { get; set; }
		private PlotOptionsHeikinashiSonificationContextTracksActiveWhen ActiveWhen_DefaultValue { get; set; }
		...
		/// </summary>
		public PlotOptionsHeikinashiSonificationContextTracksMapping Mapping { get; set; }
		private PlotOptionsHeikinashiSonificationContextTracksMapping Mapping_DefaultValue { get; set; }
		...
		/// </summary>
		public PlotOptionsHeikinashiSonificationContextTracksPointGrouping PointGrouping { get; set; }
		private PlotOptionsHeikinashiSonificationContextTracksPointGrouping PointGrouping_DefaultValue { get; set; }
		...
		/// </summary>
		public PlotOptionsHeikinashiSonificationContextTracksType Type { get; set; }
		private PlotOptionsHeikinashiSonificationContextTracksType Type_DefaultValue { get; set; }
		...
		/// </summary>
		public PlotOptionsHeikinashiSonificationContextTracksValueMapFunction ValueMapFunction { get; set; }
		private PlotOptionsHeikinashiSonificationContextTracksValueMapFunction ValueMapFunction_DefaultValue { get; set; }
