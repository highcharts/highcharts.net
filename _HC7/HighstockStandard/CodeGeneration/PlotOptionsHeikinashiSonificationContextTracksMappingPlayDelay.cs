...
{
	public partial class PlotOptionsHeikinashiSonificationContextTracksMappingPlayDelay  : BaseObject
	{
		Hashtable h = new Hashtable();

		public PlotOptionsHeikinashiSonificationContextTracksMappingPlayDelay()
		{
			MapFunction = MapFunction_DefaultValue = PlotOptionsHeikinashiSonificationContextTracksMappingPlayDelayMapFunction.Linear;
			MapTo = MapTo_DefaultValue = "";
			Max = Max_DefaultValue = null;
			Min = Min_DefaultValue = null;
			Value = Value_DefaultValue = null;
			Within = Within_DefaultValue = PlotOptionsHeikinashiSonificationContextTracksMappingPlayDelayWithin.Chart;
		...
		/// </summary>
		public PlotOptionsHeikinashiSonificationContextTracksMappingPlayDelayMapFunction MapFunction { get; set; }
		private PlotOptionsHeikinashiSonificationContextTracksMappingPlayDelayMapFunction MapFunction_DefaultValue { get; set; }
		...
		/// </summary>
		public PlotOptionsHeikinashiSonificationContextTracksMappingPlayDelayWithin Within { get; set; }
		private PlotOptionsHeikinashiSonificationContextTracksMappingPlayDelayWithin Within_DefaultValue { get; set; }
