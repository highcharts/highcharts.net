...
{
	public partial class PlotOptionsHeikinashiSonificationDefaultSpeechOptionsMappingFrequency  : BaseObject
	{
		Hashtable h = new Hashtable();

		public PlotOptionsHeikinashiSonificationDefaultSpeechOptionsMappingFrequency()
		{
			MapFunction = MapFunction_DefaultValue = PlotOptionsHeikinashiSonificationDefaultSpeechOptionsMappingFrequencyMapFunction.Linear;
			MapTo = MapTo_DefaultValue = "";
			Max = Max_DefaultValue = null;
			Min = Min_DefaultValue = null;
			Value = Value_DefaultValue = null;
			Within = Within_DefaultValue = PlotOptionsHeikinashiSonificationDefaultSpeechOptionsMappingFrequencyWithin.Chart;
		...
		/// </summary>
		public PlotOptionsHeikinashiSonificationDefaultSpeechOptionsMappingFrequencyMapFunction MapFunction { get; set; }
		private PlotOptionsHeikinashiSonificationDefaultSpeechOptionsMappingFrequencyMapFunction MapFunction_DefaultValue { get; set; }
		...
		/// </summary>
		public PlotOptionsHeikinashiSonificationDefaultSpeechOptionsMappingFrequencyWithin Within { get; set; }
		private PlotOptionsHeikinashiSonificationDefaultSpeechOptionsMappingFrequencyWithin Within_DefaultValue { get; set; }
