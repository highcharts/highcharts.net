...
namespace Highsoft.Web.Mvc.Stocks
{
	public partial class PlotOptionsHlc  : BaseObject
	{
		...
		public PlotOptionsHlc()
		{
			...
			Zones = Zones_DefaultValue = new List<PlotOptionsHlcZone>();
		...
		/// </summary>
		public List<PlotOptionsHlcZone> Zones { get; set; }
		private List<PlotOptionsHlcZone> Zones_DefaultValue { get; set; }
