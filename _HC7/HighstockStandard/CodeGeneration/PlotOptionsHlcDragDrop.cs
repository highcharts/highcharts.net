...
{
	public partial class PlotOptionsHlcDragDrop  : BaseObject
	{
		Hashtable h = new Hashtable();

		public PlotOptionsHlcDragDrop()
		{
			DraggableX = DraggableX_DefaultValue = null;
			DraggableY = DraggableY_DefaultValue = null;
			DragHandle = DragHandle_DefaultValue = new PlotOptionsHlcDragDropDragHandle();
			...
			GuideBox = GuideBox_DefaultValue = new PlotOptionsHlcDragDropGuideBox();
		...
		/// </summary>
		public PlotOptionsHlcDragDropDragHandle DragHandle { get; set; }
		private PlotOptionsHlcDragDropDragHandle DragHandle_DefaultValue { get; set; }
		...
		/// </summary>
		public PlotOptionsHlcDragDropGuideBox GuideBox { get; set; }
		private PlotOptionsHlcDragDropGuideBox GuideBox_DefaultValue { get; set; }
