...
{
	public partial class PlotOptionsHlcSonificationContextTracks  : BaseObject
	{
		Hashtable h = new Hashtable();

		public PlotOptionsHlcSonificationContextTracks()
		{
			ActiveWhen = ActiveWhen_DefaultValue = new PlotOptionsHlcSonificationContextTracksActiveWhen();
			Instrument = Instrument_DefaultValue = null;
			InstrumentString = InstrumentString_DefaultValue = "null";
			Mapping = Mapping_DefaultValue = new PlotOptionsHlcSonificationContextTracksMapping();
			MidiName = MidiName_DefaultValue = "";
			PointGrouping = PointGrouping_DefaultValue = new PlotOptionsHlcSonificationContextTracksPointGrouping();
			...
			Type = Type_DefaultValue = PlotOptionsHlcSonificationContextTracksType.Instrument;
			ValueInterval = ValueInterval_DefaultValue = null;
			ValueMapFunction = ValueMapFunction_DefaultValue = PlotOptionsHlcSonificationContextTracksValueMapFunction.Linear;
		...
		/// </summary>
		public PlotOptionsHlcSonificationContextTracksActiveWhen ActiveWhen { get; set; }
		private PlotOptionsHlcSonificationContextTracksActiveWhen ActiveWhen_DefaultValue { get; set; }
		...
		/// </summary>
		public PlotOptionsHlcSonificationContextTracksMapping Mapping { get; set; }
		private PlotOptionsHlcSonificationContextTracksMapping Mapping_DefaultValue { get; set; }
		...
		/// </summary>
		public PlotOptionsHlcSonificationContextTracksPointGrouping PointGrouping { get; set; }
		private PlotOptionsHlcSonificationContextTracksPointGrouping PointGrouping_DefaultValue { get; set; }
		...
		/// </summary>
		public PlotOptionsHlcSonificationContextTracksType Type { get; set; }
		private PlotOptionsHlcSonificationContextTracksType Type_DefaultValue { get; set; }
		...
		/// </summary>
		public PlotOptionsHlcSonificationContextTracksValueMapFunction ValueMapFunction { get; set; }
		private PlotOptionsHlcSonificationContextTracksValueMapFunction ValueMapFunction_DefaultValue { get; set; }
