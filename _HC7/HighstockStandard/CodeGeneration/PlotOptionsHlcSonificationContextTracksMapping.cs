...
{
	public partial class PlotOptionsHlcSonificationContextTracksMapping  : BaseObject
	{
		Hashtable h = new Hashtable();

		public PlotOptionsHlcSonificationContextTracksMapping()
		{
			Frequency = Frequency_DefaultValue = new PlotOptionsHlcSonificationContextTracksMappingFrequency();
			GapBetweenNotes = GapBetweenNotes_DefaultValue = new PlotOptionsHlcSonificationContextTracksMappingGapBetweenNotes();
			Highpass = Highpass_DefaultValue = new PlotOptionsHlcSonificationContextTracksMappingHighpass();
			Lowpass = Lowpass_DefaultValue = new PlotOptionsHlcSonificationContextTracksMappingLowpass();
			NoteDuration = NoteDuration_DefaultValue = new PlotOptionsHlcSonificationContextTracksMappingNoteDuration();
			Pan = Pan_DefaultValue = new PlotOptionsHlcSonificationContextTracksMappingPan();
			Pitch = Pitch_DefaultValue = new PlotOptionsHlcSonificationContextTracksMappingPitch();
			PitchString = PitchString_DefaultValue = "null";
			PitchNumber = PitchNumber_DefaultValue = null;
			PlayDelay = PlayDelay_DefaultValue = new PlotOptionsHlcSonificationContextTracksMappingPlayDelay();
			Time = Time_DefaultValue = new PlotOptionsHlcSonificationContextTracksMappingTime();
			TimeString = TimeString_DefaultValue = "null";
			TimeNumber = TimeNumber_DefaultValue = null;
			Tremolo = Tremolo_DefaultValue = new PlotOptionsHlcSonificationContextTracksMappingTremolo();
			Volume = Volume_DefaultValue = new PlotOptionsHlcSonificationContextTracksMappingVolume();
		...
		/// </summary>
		public PlotOptionsHlcSonificationContextTracksMappingFrequency Frequency { get; set; }
		private PlotOptionsHlcSonificationContextTracksMappingFrequency Frequency_DefaultValue { get; set; }
		...
		/// </summary>
		public PlotOptionsHlcSonificationContextTracksMappingGapBetweenNotes GapBetweenNotes { get; set; }
		private PlotOptionsHlcSonificationContextTracksMappingGapBetweenNotes GapBetweenNotes_DefaultValue { get; set; }
		...
		/// </summary>
		public PlotOptionsHlcSonificationContextTracksMappingHighpass Highpass { get; set; }
		private PlotOptionsHlcSonificationContextTracksMappingHighpass Highpass_DefaultValue { get; set; }
		...
		/// </summary>
		public PlotOptionsHlcSonificationContextTracksMappingLowpass Lowpass { get; set; }
		private PlotOptionsHlcSonificationContextTracksMappingLowpass Lowpass_DefaultValue { get; set; }
		...
		/// </summary>
		public PlotOptionsHlcSonificationContextTracksMappingNoteDuration NoteDuration { get; set; }
		private PlotOptionsHlcSonificationContextTracksMappingNoteDuration NoteDuration_DefaultValue { get; set; }
		...
		/// </summary>
		public PlotOptionsHlcSonificationContextTracksMappingPan Pan { get; set; }
		private PlotOptionsHlcSonificationContextTracksMappingPan Pan_DefaultValue { get; set; }
		...
		/// </summary>
		public PlotOptionsHlcSonificationContextTracksMappingPitch Pitch { get; set; }
		private PlotOptionsHlcSonificationContextTracksMappingPitch Pitch_DefaultValue { get; set; }
		...
		/// </summary>
		public PlotOptionsHlcSonificationContextTracksMappingPlayDelay PlayDelay { get; set; }
		private PlotOptionsHlcSonificationContextTracksMappingPlayDelay PlayDelay_DefaultValue { get; set; }
		...
		/// </summary>
		public PlotOptionsHlcSonificationContextTracksMappingTime Time { get; set; }
		private PlotOptionsHlcSonificationContextTracksMappingTime Time_DefaultValue { get; set; }
		...
		/// </summary>
		public PlotOptionsHlcSonificationContextTracksMappingTremolo Tremolo { get; set; }
		private PlotOptionsHlcSonificationContextTracksMappingTremolo Tremolo_DefaultValue { get; set; }
		 

		/// <summary>
		/// The volume of notes, from 0 to 1.
		/// </summary>
		public PlotOptionsHlcSonificationContextTracksMappingVolume Volume { get; set; }
		private PlotOptionsHlcSonificationContextTracksMappingVolume Volume_DefaultValue { get; set; }
