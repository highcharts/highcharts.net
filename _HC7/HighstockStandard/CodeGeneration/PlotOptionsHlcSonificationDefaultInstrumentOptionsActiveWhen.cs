...
{
	public partial class PlotOptionsHlcSonificationDefaultInstrumentOptionsActiveWhen  : BaseObject
	{
		Hashtable h = new Hashtable();

		public PlotOptionsHlcSonificationDefaultInstrumentOptionsActiveWhen()
		{
