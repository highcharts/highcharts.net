...
{
	public partial class PlotOptionsHlcSonificationTracks  : BaseObject
	{
		Hashtable h = new Hashtable();

		public PlotOptionsHlcSonificationTracks()
		{
			ActiveWhen = ActiveWhen_DefaultValue = new PlotOptionsHlcSonificationTracksActiveWhen();
			Instrument = Instrument_DefaultValue = null;
			InstrumentString = InstrumentString_DefaultValue = "null";
			Mapping = Mapping_DefaultValue = new PlotOptionsHlcSonificationTracksMapping();
			MidiName = MidiName_DefaultValue = "";
			PointGrouping = PointGrouping_DefaultValue = new PlotOptionsHlcSonificationTracksPointGrouping();
			RoundToMusicalNotes = RoundToMusicalNotes_DefaultValue = true;
			ShowPlayMarker = ShowPlayMarker_DefaultValue = true;
			Type = Type_DefaultValue = PlotOptionsHlcSonificationTracksType.Instrument;
		...
		/// </summary>
		public PlotOptionsHlcSonificationTracksActiveWhen ActiveWhen { get; set; }
		private PlotOptionsHlcSonificationTracksActiveWhen ActiveWhen_DefaultValue { get; set; }
		...
		/// </summary>
		public PlotOptionsHlcSonificationTracksMapping Mapping { get; set; }
		private PlotOptionsHlcSonificationTracksMapping Mapping_DefaultValue { get; set; }
		...
		/// </summary>
		public PlotOptionsHlcSonificationTracksPointGrouping PointGrouping { get; set; }
		private PlotOptionsHlcSonificationTracksPointGrouping PointGrouping_DefaultValue { get; set; }
		...
		/// </summary>
		public PlotOptionsHlcSonificationTracksType Type { get; set; }
		private PlotOptionsHlcSonificationTracksType Type_DefaultValue { get; set; }
