...
{
	public partial class PlotOptionsHlcSonificationTracksMappingFrequency  : BaseObject
	{
		Hashtable h = new Hashtable();

		public PlotOptionsHlcSonificationTracksMappingFrequency()
		{
			MapFunction = MapFunction_DefaultValue = PlotOptionsHlcSonificationTracksMappingFrequencyMapFunction.Linear;
			MapTo = MapTo_DefaultValue = "";
			Max = Max_DefaultValue = null;
			Min = Min_DefaultValue = null;
			Value = Value_DefaultValue = null;
			Within = Within_DefaultValue = PlotOptionsHlcSonificationTracksMappingFrequencyWithin.Chart;
		...
		/// </summary>
		public PlotOptionsHlcSonificationTracksMappingFrequencyMapFunction MapFunction { get; set; }
		private PlotOptionsHlcSonificationTracksMappingFrequencyMapFunction MapFunction_DefaultValue { get; set; }
		...
		/// </summary>
		public PlotOptionsHlcSonificationTracksMappingFrequencyWithin Within { get; set; }
		private PlotOptionsHlcSonificationTracksMappingFrequencyWithin Within_DefaultValue { get; set; }
