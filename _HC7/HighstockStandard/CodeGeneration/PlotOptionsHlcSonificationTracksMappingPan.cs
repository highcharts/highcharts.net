...
{
	public partial class PlotOptionsHlcSonificationTracksMappingPan  : BaseObject
	{
		Hashtable h = new Hashtable();

		public PlotOptionsHlcSonificationTracksMappingPan()
		{
			MapFunction = MapFunction_DefaultValue = PlotOptionsHlcSonificationTracksMappingPanMapFunction.Linear;
			MapTo = MapTo_DefaultValue = "";
			Max = Max_DefaultValue = null;
			Min = Min_DefaultValue = null;
			Value = Value_DefaultValue = null;
			Within = Within_DefaultValue = PlotOptionsHlcSonificationTracksMappingPanWithin.Chart;
		...
		/// </summary>
		public PlotOptionsHlcSonificationTracksMappingPanMapFunction MapFunction { get; set; }
		private PlotOptionsHlcSonificationTracksMappingPanMapFunction MapFunction_DefaultValue { get; set; }
		...
		/// </summary>
		public PlotOptionsHlcSonificationTracksMappingPanWithin Within { get; set; }
		private PlotOptionsHlcSonificationTracksMappingPanWithin Within_DefaultValue { get; set; }
