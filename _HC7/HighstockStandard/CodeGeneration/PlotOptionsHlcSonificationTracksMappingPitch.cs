...
{
	public partial class PlotOptionsHlcSonificationTracksMappingPitch  : BaseObject
	{
		Hashtable h = new Hashtable();

		public PlotOptionsHlcSonificationTracksMappingPitch()
		{
			MapFunction = MapFunction_DefaultValue = PlotOptionsHlcSonificationTracksMappingPitchMapFunction.Linear;
		...
		/// </summary>
		public PlotOptionsHlcSonificationTracksMappingPitchMapFunction MapFunction { get; set; }
		private PlotOptionsHlcSonificationTracksMappingPitchMapFunction MapFunction_DefaultValue { get; set; }
