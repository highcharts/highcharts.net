...
{
	public partial class PlotOptionsHlcSonificationTracksMappingTime  : BaseObject
	{
		Hashtable h = new Hashtable();

		public PlotOptionsHlcSonificationTracksMappingTime()
		{
			MapFunction = MapFunction_DefaultValue = PlotOptionsHlcSonificationTracksMappingTimeMapFunction.Linear;
			MapTo = MapTo_DefaultValue = "";
			Max = Max_DefaultValue = null;
			Min = Min_DefaultValue = null;
			Value = Value_DefaultValue = null;
			Within = Within_DefaultValue = PlotOptionsHlcSonificationTracksMappingTimeWithin.Chart;
		...
		/// </summary>
		public PlotOptionsHlcSonificationTracksMappingTimeMapFunction MapFunction { get; set; }
		private PlotOptionsHlcSonificationTracksMappingTimeMapFunction MapFunction_DefaultValue { get; set; }
		...
		/// </summary>
		public PlotOptionsHlcSonificationTracksMappingTimeWithin Within { get; set; }
		private PlotOptionsHlcSonificationTracksMappingTimeWithin Within_DefaultValue { get; set; }
