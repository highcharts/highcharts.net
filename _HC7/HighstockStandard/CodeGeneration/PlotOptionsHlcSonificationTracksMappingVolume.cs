...
{
	public partial class PlotOptionsHlcSonificationTracksMappingVolume  : BaseObject
	{
		Hashtable h = new Hashtable();

		public PlotOptionsHlcSonificationTracksMappingVolume()
		{
			MapFunction = MapFunction_DefaultValue = PlotOptionsHlcSonificationTracksMappingVolumeMapFunction.Linear;
			MapTo = MapTo_DefaultValue = "";
			Max = Max_DefaultValue = null;
			Min = Min_DefaultValue = null;
			Value = Value_DefaultValue = null;
			Within = Within_DefaultValue = PlotOptionsHlcSonificationTracksMappingVolumeWithin.Chart;
		...
		/// </summary>
		public PlotOptionsHlcSonificationTracksMappingVolumeMapFunction MapFunction { get; set; }
		private PlotOptionsHlcSonificationTracksMappingVolumeMapFunction MapFunction_DefaultValue { get; set; }
		...
		/// </summary>
		public PlotOptionsHlcSonificationTracksMappingVolumeWithin Within { get; set; }
		private PlotOptionsHlcSonificationTracksMappingVolumeWithin Within_DefaultValue { get; set; }
