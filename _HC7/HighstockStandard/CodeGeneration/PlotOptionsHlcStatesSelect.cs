...
{
	public partial class PlotOptionsHlcStatesSelect  : BaseObject
	{
		Hashtable h = new Hashtable();

		public PlotOptionsHlcStatesSelect()
		{
			Animation = Animation_DefaultValue = new Animation() { Enabled = true };
			AnimationBool = AnimationBool_DefaultValue = null;
			Enabled = Enabled_DefaultValue = true;
			Halo = Halo_DefaultValue = new PlotOptionsHlcStatesSelectHalo();
			LineWidth = LineWidth_DefaultValue = null;
			LineWidthPlus = LineWidthPlus_DefaultValue = 1;
			Marker = Marker_DefaultValue = new PlotOptionsHlcStatesSelectMarker();
		...
		/// </summary>
		public PlotOptionsHlcStatesSelectHalo Halo { get; set; }
		private PlotOptionsHlcStatesSelectHalo Halo_DefaultValue { get; set; }
		...
		/// </summary>
		public PlotOptionsHlcStatesSelectMarker Marker { get; set; }
		private PlotOptionsHlcStatesSelectMarker Marker_DefaultValue { get; set; }
