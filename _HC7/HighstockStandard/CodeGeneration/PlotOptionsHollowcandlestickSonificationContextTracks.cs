...
{
	public partial class PlotOptionsHollowcandlestickSonificationContextTracks  : BaseObject
	{
		Hashtable h = new Hashtable();

		public PlotOptionsHollowcandlestickSonificationContextTracks()
		{
			ActiveWhen = ActiveWhen_DefaultValue = new PlotOptionsHollowcandlestickSonificationContextTracksActiveWhen();
			Instrument = Instrument_DefaultValue = null;
			InstrumentString = InstrumentString_DefaultValue = "null";
			Mapping = Mapping_DefaultValue = new PlotOptionsHollowcandlestickSonificationContextTracksMapping();
			MidiName = MidiName_DefaultValue = "";
			PointGrouping = PointGrouping_DefaultValue = new PlotOptionsHollowcandlestickSonificationContextTracksPointGrouping();
			...
			Type = Type_DefaultValue = PlotOptionsHollowcandlestickSonificationContextTracksType.Instrument;
			ValueInterval = ValueInterval_DefaultValue = null;
			ValueMapFunction = ValueMapFunction_DefaultValue = PlotOptionsHollowcandlestickSonificationContextTracksValueMapFunction.Linear;
		...
		/// </summary>
		public PlotOptionsHollowcandlestickSonificationContextTracksActiveWhen ActiveWhen { get; set; }
		private PlotOptionsHollowcandlestickSonificationContextTracksActiveWhen ActiveWhen_DefaultValue { get; set; }
		...
		/// </summary>
		public PlotOptionsHollowcandlestickSonificationContextTracksMapping Mapping { get; set; }
		private PlotOptionsHollowcandlestickSonificationContextTracksMapping Mapping_DefaultValue { get; set; }
		...
		/// </summary>
		public PlotOptionsHollowcandlestickSonificationContextTracksPointGrouping PointGrouping { get; set; }
		private PlotOptionsHollowcandlestickSonificationContextTracksPointGrouping PointGrouping_DefaultValue { get; set; }
		...
		/// </summary>
		public PlotOptionsHollowcandlestickSonificationContextTracksType Type { get; set; }
		private PlotOptionsHollowcandlestickSonificationContextTracksType Type_DefaultValue { get; set; }
		...
		/// </summary>
		public PlotOptionsHollowcandlestickSonificationContextTracksValueMapFunction ValueMapFunction { get; set; }
		private PlotOptionsHollowcandlestickSonificationContextTracksValueMapFunction ValueMapFunction_DefaultValue { get; set; }
