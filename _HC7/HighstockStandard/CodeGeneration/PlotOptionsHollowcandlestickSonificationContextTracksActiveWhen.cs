...
{
	public partial class PlotOptionsHollowcandlestickSonificationContextTracksActiveWhen  : BaseObject
	{
		Hashtable h = new Hashtable();

		public PlotOptionsHollowcandlestickSonificationContextTracksActiveWhen()
		{
		}	
