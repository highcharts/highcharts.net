...
{
	public partial class PlotOptionsHollowcandlestickSonificationDefaultInstrumentOptionsMappingFrequency  : BaseObject
	{
		Hashtable h = new Hashtable();

		public PlotOptionsHollowcandlestickSonificationDefaultInstrumentOptionsMappingFrequency()
		{
			MapFunction = MapFunction_DefaultValue = PlotOptionsHollowcandlestickSonificationDefaultInstrumentOptionsMappingFrequencyMapFunction.Linear;
			MapTo = MapTo_DefaultValue = "";
			Max = Max_DefaultValue = null;
			Min = Min_DefaultValue = null;
			Value = Value_DefaultValue = null;
			Within = Within_DefaultValue = PlotOptionsHollowcandlestickSonificationDefaultInstrumentOptionsMappingFrequencyWithin.Chart;
		...
		/// </summary>
		public PlotOptionsHollowcandlestickSonificationDefaultInstrumentOptionsMappingFrequencyMapFunction MapFunction { get; set; }
		private PlotOptionsHollowcandlestickSonificationDefaultInstrumentOptionsMappingFrequencyMapFunction MapFunction_DefaultValue { get; set; }
		...
		/// </summary>
		public PlotOptionsHollowcandlestickSonificationDefaultInstrumentOptionsMappingFrequencyWithin Within { get; set; }
		private PlotOptionsHollowcandlestickSonificationDefaultInstrumentOptionsMappingFrequencyWithin Within_DefaultValue { get; set; }
