...
{
	public partial class PlotOptionsHollowcandlestickSonificationDefaultSpeechOptionsMappingHighpassFrequency  : BaseObject
	{
		Hashtable h = new Hashtable();

		public PlotOptionsHollowcandlestickSonificationDefaultSpeechOptionsMappingHighpassFrequency()
		{
			MapFunction = MapFunction_DefaultValue = PlotOptionsHollowcandlestickSonificationDefaultSpeechOptionsMappingHighpassFrequencyMapFunction.Linear;
			MapTo = MapTo_DefaultValue = "";
			Max = Max_DefaultValue = null;
			Min = Min_DefaultValue = null;
			Value = Value_DefaultValue = null;
			Within = Within_DefaultValue = PlotOptionsHollowcandlestickSonificationDefaultSpeechOptionsMappingHighpassFrequencyWithin.Chart;
		...
		/// </summary>
		public PlotOptionsHollowcandlestickSonificationDefaultSpeechOptionsMappingHighpassFrequencyMapFunction MapFunction { get; set; }
		private PlotOptionsHollowcandlestickSonificationDefaultSpeechOptionsMappingHighpassFrequencyMapFunction MapFunction_DefaultValue { get; set; }
		...
		/// </summary>
		public PlotOptionsHollowcandlestickSonificationDefaultSpeechOptionsMappingHighpassFrequencyWithin Within { get; set; }
		private PlotOptionsHollowcandlestickSonificationDefaultSpeechOptionsMappingHighpassFrequencyWithin Within_DefaultValue { get; set; }
