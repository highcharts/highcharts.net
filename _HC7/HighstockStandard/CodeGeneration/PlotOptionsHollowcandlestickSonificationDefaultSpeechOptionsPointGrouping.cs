...
{
	public partial class PlotOptionsHollowcandlestickSonificationDefaultSpeechOptionsPointGrouping  : BaseObject
	{
		Hashtable h = new Hashtable();

		public PlotOptionsHollowcandlestickSonificationDefaultSpeechOptionsPointGrouping()
		{
			Algorithm = Algorithm_DefaultValue = PlotOptionsHollowcandlestickSonificationDefaultSpeechOptionsPointGroupingAlgorithm.Minimax;
		...
		/// </summary>
		public PlotOptionsHollowcandlestickSonificationDefaultSpeechOptionsPointGroupingAlgorithm Algorithm { get; set; }
		private PlotOptionsHollowcandlestickSonificationDefaultSpeechOptionsPointGroupingAlgorithm Algorithm_DefaultValue { get; set; }
