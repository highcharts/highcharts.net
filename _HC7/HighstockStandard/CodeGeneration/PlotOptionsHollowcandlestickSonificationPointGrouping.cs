...
{
	public partial class PlotOptionsHollowcandlestickSonificationPointGrouping  : BaseObject
	{
		Hashtable h = new Hashtable();

		public PlotOptionsHollowcandlestickSonificationPointGrouping()
		{
			Algorithm = Algorithm_DefaultValue = PlotOptionsHollowcandlestickSonificationPointGroupingAlgorithm.Minimax;
		...
		/// </summary>
		public PlotOptionsHollowcandlestickSonificationPointGroupingAlgorithm Algorithm { get; set; }
		private PlotOptionsHollowcandlestickSonificationPointGroupingAlgorithm Algorithm_DefaultValue { get; set; }
