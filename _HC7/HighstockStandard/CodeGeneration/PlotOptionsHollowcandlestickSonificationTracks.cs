...
{
	public partial class PlotOptionsHollowcandlestickSonificationTracks  : BaseObject
	{
		Hashtable h = new Hashtable();

		public PlotOptionsHollowcandlestickSonificationTracks()
		{
			ActiveWhen = ActiveWhen_DefaultValue = new PlotOptionsHollowcandlestickSonificationTracksActiveWhen();
			Instrument = Instrument_DefaultValue = null;
			InstrumentString = InstrumentString_DefaultValue = "null";
			Mapping = Mapping_DefaultValue = new PlotOptionsHollowcandlestickSonificationTracksMapping();
			MidiName = MidiName_DefaultValue = "";
			PointGrouping = PointGrouping_DefaultValue = new PlotOptionsHollowcandlestickSonificationTracksPointGrouping();
			RoundToMusicalNotes = RoundToMusicalNotes_DefaultValue = true;
			ShowPlayMarker = ShowPlayMarker_DefaultValue = true;
			Type = Type_DefaultValue = PlotOptionsHollowcandlestickSonificationTracksType.Instrument;
		...
		/// </summary>
		public PlotOptionsHollowcandlestickSonificationTracksActiveWhen ActiveWhen { get; set; }
		private PlotOptionsHollowcandlestickSonificationTracksActiveWhen ActiveWhen_DefaultValue { get; set; }
		...
		/// </summary>
		public PlotOptionsHollowcandlestickSonificationTracksMapping Mapping { get; set; }
		private PlotOptionsHollowcandlestickSonificationTracksMapping Mapping_DefaultValue { get; set; }
		...
		/// </summary>
		public PlotOptionsHollowcandlestickSonificationTracksPointGrouping PointGrouping { get; set; }
		private PlotOptionsHollowcandlestickSonificationTracksPointGrouping PointGrouping_DefaultValue { get; set; }
		...
		/// </summary>
		public PlotOptionsHollowcandlestickSonificationTracksType Type { get; set; }
		private PlotOptionsHollowcandlestickSonificationTracksType Type_DefaultValue { get; set; }
