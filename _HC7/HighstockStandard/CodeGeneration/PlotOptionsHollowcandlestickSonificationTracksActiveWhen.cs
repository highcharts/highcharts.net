...
{
	public partial class PlotOptionsHollowcandlestickSonificationTracksActiveWhen  : BaseObject
	{
		Hashtable h = new Hashtable();

		public PlotOptionsHollowcandlestickSonificationTracksActiveWhen()
		{
