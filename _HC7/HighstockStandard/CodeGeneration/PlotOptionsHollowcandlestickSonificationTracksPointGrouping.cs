...
{
	public partial class PlotOptionsHollowcandlestickSonificationTracksPointGrouping  : BaseObject
	{
		Hashtable h = new Hashtable();

		public PlotOptionsHollowcandlestickSonificationTracksPointGrouping()
		{
			Algorithm = Algorithm_DefaultValue = PlotOptionsHollowcandlestickSonificationTracksPointGroupingAlgorithm.Minimax;
		...
		/// </summary>
		public PlotOptionsHollowcandlestickSonificationTracksPointGroupingAlgorithm Algorithm { get; set; }
		private PlotOptionsHollowcandlestickSonificationTracksPointGroupingAlgorithm Algorithm_DefaultValue { get; set; }
