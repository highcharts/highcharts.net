...
{
	public partial class PlotOptionsHollowcandlestickStatesHover  : BaseObject
	{
		Hashtable h = new Hashtable();

		public PlotOptionsHollowcandlestickStatesHover()
		{
			Animation = Animation_DefaultValue = new Animation() { Enabled = true };
			Enabled = Enabled_DefaultValue = null;
			Halo = Halo_DefaultValue = new PlotOptionsHollowcandlestickStatesHoverHalo();
			LineWidth = LineWidth_DefaultValue = null;
			LineWidthPlus = LineWidthPlus_DefaultValue = null;
			Marker = Marker_DefaultValue = new PlotOptionsHollowcandlestickStatesHoverMarker();
		...
		/// </summary>
		public PlotOptionsHollowcandlestickStatesHoverHalo Halo { get; set; }
		private PlotOptionsHollowcandlestickStatesHoverHalo Halo_DefaultValue { get; set; }
		...
		/// </summary>
		public PlotOptionsHollowcandlestickStatesHoverMarker Marker { get; set; }
		private PlotOptionsHollowcandlestickStatesHoverMarker Marker_DefaultValue { get; set; }
