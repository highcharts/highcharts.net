...
{
	public partial class PlotOptionsHollowcandlestickStatesSelect  : BaseObject
	{
		Hashtable h = new Hashtable();

		public PlotOptionsHollowcandlestickStatesSelect()
		{
			Animation = Animation_DefaultValue = new Animation() { Enabled = true };
			AnimationBool = AnimationBool_DefaultValue = null;
			Enabled = Enabled_DefaultValue = true;
			Halo = Halo_DefaultValue = new PlotOptionsHollowcandlestickStatesSelectHalo();
			LineWidth = LineWidth_DefaultValue = null;
			LineWidthPlus = LineWidthPlus_DefaultValue = 1;
			Marker = Marker_DefaultValue = new PlotOptionsHollowcandlestickStatesSelectMarker();
		...
		/// </summary>
		public PlotOptionsHollowcandlestickStatesSelectHalo Halo { get; set; }
		private PlotOptionsHollowcandlestickStatesSelectHalo Halo_DefaultValue { get; set; }
		...
		/// </summary>
		public PlotOptionsHollowcandlestickStatesSelectMarker Marker { get; set; }
		private PlotOptionsHollowcandlestickStatesSelectMarker Marker_DefaultValue { get; set; }
