...
{
	public partial class PlotOptionsIkhDragDropDragHandle  : BaseObject
	{
		public PlotOptionsIkhDragDropDragHandle()
		{
		...
		internal override Hashtable ToHashtable()
		{
			...
			if (PathFormatter != PathFormatter_DefaultValue) { h.Add("pathFormatter",PathFormatter); Highstock.AddFunction("PlotOptionsIkhDragDropDragHandlePathFormatter.pathFormatter", PathFormatter); }  
