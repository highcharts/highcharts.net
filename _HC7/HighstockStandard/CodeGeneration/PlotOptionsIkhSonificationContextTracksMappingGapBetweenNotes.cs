...
{
	public partial class PlotOptionsIkhSonificationContextTracksMappingGapBetweenNotes  : BaseObject
	{
		Hashtable h = new Hashtable();

		public PlotOptionsIkhSonificationContextTracksMappingGapBetweenNotes()
		{
			MapFunction = MapFunction_DefaultValue = PlotOptionsIkhSonificationContextTracksMappingGapBetweenNotesMapFunction.Linear;
			MapTo = MapTo_DefaultValue = "";
			Max = Max_DefaultValue = null;
			Min = Min_DefaultValue = null;
			Value = Value_DefaultValue = null;
			Within = Within_DefaultValue = PlotOptionsIkhSonificationContextTracksMappingGapBetweenNotesWithin.Chart;
		...
		/// </summary>
		public PlotOptionsIkhSonificationContextTracksMappingGapBetweenNotesMapFunction MapFunction { get; set; }
		private PlotOptionsIkhSonificationContextTracksMappingGapBetweenNotesMapFunction MapFunction_DefaultValue { get; set; }
		...
		/// </summary>
		public PlotOptionsIkhSonificationContextTracksMappingGapBetweenNotesWithin Within { get; set; }
		private PlotOptionsIkhSonificationContextTracksMappingGapBetweenNotesWithin Within_DefaultValue { get; set; }
