...
{
	public partial class PlotOptionsIkhSonificationContextTracksMappingLowpassResonance  : BaseObject
	{
		Hashtable h = new Hashtable();

		public PlotOptionsIkhSonificationContextTracksMappingLowpassResonance()
		{
			MapFunction = MapFunction_DefaultValue = PlotOptionsIkhSonificationContextTracksMappingLowpassResonanceMapFunction.Linear;
			MapTo = MapTo_DefaultValue = "";
			Max = Max_DefaultValue = null;
			Min = Min_DefaultValue = null;
			Value = Value_DefaultValue = null;
			Within = Within_DefaultValue = PlotOptionsIkhSonificationContextTracksMappingLowpassResonanceWithin.Chart;
		...
		/// </summary>
		public PlotOptionsIkhSonificationContextTracksMappingLowpassResonanceMapFunction MapFunction { get; set; }
		private PlotOptionsIkhSonificationContextTracksMappingLowpassResonanceMapFunction MapFunction_DefaultValue { get; set; }
		...
		/// </summary>
		public PlotOptionsIkhSonificationContextTracksMappingLowpassResonanceWithin Within { get; set; }
		private PlotOptionsIkhSonificationContextTracksMappingLowpassResonanceWithin Within_DefaultValue { get; set; }
