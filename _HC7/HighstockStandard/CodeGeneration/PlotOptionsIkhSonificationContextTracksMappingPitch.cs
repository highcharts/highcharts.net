...
{
	public partial class PlotOptionsIkhSonificationContextTracksMappingPitch  : BaseObject
	{
		Hashtable h = new Hashtable();

		public PlotOptionsIkhSonificationContextTracksMappingPitch()
		{
			MapFunction = MapFunction_DefaultValue = PlotOptionsIkhSonificationContextTracksMappingPitchMapFunction.Linear;
		...
		/// </summary>
		public PlotOptionsIkhSonificationContextTracksMappingPitchMapFunction MapFunction { get; set; }
		private PlotOptionsIkhSonificationContextTracksMappingPitchMapFunction MapFunction_DefaultValue { get; set; }
