...
{
	public partial class PlotOptionsIkhSonificationContextTracksMappingPlayDelay  : BaseObject
	{
		Hashtable h = new Hashtable();

		public PlotOptionsIkhSonificationContextTracksMappingPlayDelay()
		{
			MapFunction = MapFunction_DefaultValue = PlotOptionsIkhSonificationContextTracksMappingPlayDelayMapFunction.Linear;
			MapTo = MapTo_DefaultValue = "";
			Max = Max_DefaultValue = null;
			Min = Min_DefaultValue = null;
			Value = Value_DefaultValue = null;
			Within = Within_DefaultValue = PlotOptionsIkhSonificationContextTracksMappingPlayDelayWithin.Chart;
		...
		/// </summary>
		public PlotOptionsIkhSonificationContextTracksMappingPlayDelayMapFunction MapFunction { get; set; }
		private PlotOptionsIkhSonificationContextTracksMappingPlayDelayMapFunction MapFunction_DefaultValue { get; set; }
		...
		/// </summary>
		public PlotOptionsIkhSonificationContextTracksMappingPlayDelayWithin Within { get; set; }
		private PlotOptionsIkhSonificationContextTracksMappingPlayDelayWithin Within_DefaultValue { get; set; }
