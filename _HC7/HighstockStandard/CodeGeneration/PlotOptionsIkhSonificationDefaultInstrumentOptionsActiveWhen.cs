...
{
	public partial class PlotOptionsIkhSonificationDefaultInstrumentOptionsActiveWhen  : BaseObject
	{
		Hashtable h = new Hashtable();

		public PlotOptionsIkhSonificationDefaultInstrumentOptionsActiveWhen()
		{
		}	
