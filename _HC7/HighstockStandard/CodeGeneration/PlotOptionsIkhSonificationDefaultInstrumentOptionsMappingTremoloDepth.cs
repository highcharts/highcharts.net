...
{
	public partial class PlotOptionsIkhSonificationDefaultInstrumentOptionsMappingTremoloDepth  : BaseObject
	{
		Hashtable h = new Hashtable();

		public PlotOptionsIkhSonificationDefaultInstrumentOptionsMappingTremoloDepth()
		{
			MapFunction = MapFunction_DefaultValue = PlotOptionsIkhSonificationDefaultInstrumentOptionsMappingTremoloDepthMapFunction.Linear;
			MapTo = MapTo_DefaultValue = "";
			Max = Max_DefaultValue = null;
			Min = Min_DefaultValue = null;
			Value = Value_DefaultValue = null;
			Within = Within_DefaultValue = PlotOptionsIkhSonificationDefaultInstrumentOptionsMappingTremoloDepthWithin.Chart;
		...
		/// </summary>
		public PlotOptionsIkhSonificationDefaultInstrumentOptionsMappingTremoloDepthMapFunction MapFunction { get; set; }
		private PlotOptionsIkhSonificationDefaultInstrumentOptionsMappingTremoloDepthMapFunction MapFunction_DefaultValue { get; set; }
		...
		/// </summary>
		public PlotOptionsIkhSonificationDefaultInstrumentOptionsMappingTremoloDepthWithin Within { get; set; }
		private PlotOptionsIkhSonificationDefaultInstrumentOptionsMappingTremoloDepthWithin Within_DefaultValue { get; set; }
