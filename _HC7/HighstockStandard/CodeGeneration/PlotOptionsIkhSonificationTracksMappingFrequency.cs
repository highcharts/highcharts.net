...
{
	public partial class PlotOptionsIkhSonificationTracksMappingFrequency  : BaseObject
	{
		Hashtable h = new Hashtable();

		public PlotOptionsIkhSonificationTracksMappingFrequency()
		{
			MapFunction = MapFunction_DefaultValue = PlotOptionsIkhSonificationTracksMappingFrequencyMapFunction.Linear;
			MapTo = MapTo_DefaultValue = "";
			Max = Max_DefaultValue = null;
			Min = Min_DefaultValue = null;
			Value = Value_DefaultValue = null;
			Within = Within_DefaultValue = PlotOptionsIkhSonificationTracksMappingFrequencyWithin.Chart;
		...
		/// </summary>
		public PlotOptionsIkhSonificationTracksMappingFrequencyMapFunction MapFunction { get; set; }
		private PlotOptionsIkhSonificationTracksMappingFrequencyMapFunction MapFunction_DefaultValue { get; set; }
		...
		/// </summary>
		public PlotOptionsIkhSonificationTracksMappingFrequencyWithin Within { get; set; }
		private PlotOptionsIkhSonificationTracksMappingFrequencyWithin Within_DefaultValue { get; set; }
