...
{
	public partial class PlotOptionsIkhSonificationTracksMappingPan  : BaseObject
	{
		Hashtable h = new Hashtable();

		public PlotOptionsIkhSonificationTracksMappingPan()
		{
			MapFunction = MapFunction_DefaultValue = PlotOptionsIkhSonificationTracksMappingPanMapFunction.Linear;
			MapTo = MapTo_DefaultValue = "";
			Max = Max_DefaultValue = null;
			Min = Min_DefaultValue = null;
			Value = Value_DefaultValue = null;
			Within = Within_DefaultValue = PlotOptionsIkhSonificationTracksMappingPanWithin.Chart;
		...
		/// </summary>
		public PlotOptionsIkhSonificationTracksMappingPanMapFunction MapFunction { get; set; }
		private PlotOptionsIkhSonificationTracksMappingPanMapFunction MapFunction_DefaultValue { get; set; }
		...
		/// </summary>
		public PlotOptionsIkhSonificationTracksMappingPanWithin Within { get; set; }
		private PlotOptionsIkhSonificationTracksMappingPanWithin Within_DefaultValue { get; set; }
