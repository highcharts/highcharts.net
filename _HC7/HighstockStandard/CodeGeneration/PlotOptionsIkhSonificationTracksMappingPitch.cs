...
{
	public partial class PlotOptionsIkhSonificationTracksMappingPitch  : BaseObject
	{
		Hashtable h = new Hashtable();

		public PlotOptionsIkhSonificationTracksMappingPitch()
		{
			MapFunction = MapFunction_DefaultValue = PlotOptionsIkhSonificationTracksMappingPitchMapFunction.Linear;
		...
		/// </summary>
		public PlotOptionsIkhSonificationTracksMappingPitchMapFunction MapFunction { get; set; }
		private PlotOptionsIkhSonificationTracksMappingPitchMapFunction MapFunction_DefaultValue { get; set; }
