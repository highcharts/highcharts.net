...
{
	public partial class PlotOptionsIkhSonificationTracksMappingPlayDelay  : BaseObject
	{
		Hashtable h = new Hashtable();

		public PlotOptionsIkhSonificationTracksMappingPlayDelay()
		{
			MapFunction = MapFunction_DefaultValue = PlotOptionsIkhSonificationTracksMappingPlayDelayMapFunction.Linear;
			MapTo = MapTo_DefaultValue = "";
			Max = Max_DefaultValue = null;
			Min = Min_DefaultValue = null;
			Value = Value_DefaultValue = null;
			Within = Within_DefaultValue = PlotOptionsIkhSonificationTracksMappingPlayDelayWithin.Chart;
		...
		/// </summary>
		public PlotOptionsIkhSonificationTracksMappingPlayDelayMapFunction MapFunction { get; set; }
		private PlotOptionsIkhSonificationTracksMappingPlayDelayMapFunction MapFunction_DefaultValue { get; set; }
		...
		/// </summary>
		public PlotOptionsIkhSonificationTracksMappingPlayDelayWithin Within { get; set; }
		private PlotOptionsIkhSonificationTracksMappingPlayDelayWithin Within_DefaultValue { get; set; }
