...
{
	public partial class PlotOptionsIkhSonificationTracksMappingTime  : BaseObject
	{
		Hashtable h = new Hashtable();

		public PlotOptionsIkhSonificationTracksMappingTime()
		{
			MapFunction = MapFunction_DefaultValue = PlotOptionsIkhSonificationTracksMappingTimeMapFunction.Linear;
			MapTo = MapTo_DefaultValue = "";
			Max = Max_DefaultValue = null;
			Min = Min_DefaultValue = null;
			Value = Value_DefaultValue = null;
			Within = Within_DefaultValue = PlotOptionsIkhSonificationTracksMappingTimeWithin.Chart;
		...
		/// </summary>
		public PlotOptionsIkhSonificationTracksMappingTimeMapFunction MapFunction { get; set; }
		private PlotOptionsIkhSonificationTracksMappingTimeMapFunction MapFunction_DefaultValue { get; set; }
		...
		/// </summary>
		public PlotOptionsIkhSonificationTracksMappingTimeWithin Within { get; set; }
		private PlotOptionsIkhSonificationTracksMappingTimeWithin Within_DefaultValue { get; set; }
