...
{
	public partial class PlotOptionsIkhSonificationTracksMappingTremoloDepth  : BaseObject
	{
		Hashtable h = new Hashtable();

		public PlotOptionsIkhSonificationTracksMappingTremoloDepth()
		{
			MapFunction = MapFunction_DefaultValue = PlotOptionsIkhSonificationTracksMappingTremoloDepthMapFunction.Linear;
			MapTo = MapTo_DefaultValue = "";
			Max = Max_DefaultValue = null;
			Min = Min_DefaultValue = null;
			Value = Value_DefaultValue = null;
			Within = Within_DefaultValue = PlotOptionsIkhSonificationTracksMappingTremoloDepthWithin.Chart;
		...
		/// </summary>
		public PlotOptionsIkhSonificationTracksMappingTremoloDepthMapFunction MapFunction { get; set; }
		private PlotOptionsIkhSonificationTracksMappingTremoloDepthMapFunction MapFunction_DefaultValue { get; set; }
		...
		/// </summary>
		public PlotOptionsIkhSonificationTracksMappingTremoloDepthWithin Within { get; set; }
		private PlotOptionsIkhSonificationTracksMappingTremoloDepthWithin Within_DefaultValue { get; set; }
