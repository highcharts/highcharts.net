...
namespace Highsoft.Web.Mvc.Stocks
{
	public partial class PlotOptionsKeltnerchannels  : BaseObject
	{
		...
		public PlotOptionsKeltnerchannels()
		{
			...
			Zones = Zones_DefaultValue = new List<PlotOptionsKeltnerchannelsZone>();
		...
		/// </summary>
		public List<PlotOptionsKeltnerchannelsZone> Zones { get; set; }
		private List<PlotOptionsKeltnerchannelsZone> Zones_DefaultValue { get; set; }
