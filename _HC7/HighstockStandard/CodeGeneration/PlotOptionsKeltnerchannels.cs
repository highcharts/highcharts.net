...
{
	public partial class PlotOptionsKeltnerchannels  : BaseObject
	{
		Hashtable h = new Hashtable();

		public PlotOptionsKeltnerchannels()
		{
			Accessibility = Accessibility_DefaultValue = new PlotOptionsKeltnerchannelsAccessibility();
			AllowPointSelect = AllowPointSelect_DefaultValue = false;
			Animation = Animation_DefaultValue = new Animation() { Enabled = true };
			AnimationBool = AnimationBool_DefaultValue = true;
			AnimationLimit = AnimationLimit_DefaultValue = null;
			BoostBlending = BoostBlending_DefaultValue = PlotOptionsKeltnerchannelsBoostBlending.Undefined;
			BoostThreshold = BoostThreshold_DefaultValue = 5000;
			BottomLine = BottomLine_DefaultValue = new PlotOptionsKeltnerchannelsBottomLine();
			...
			Cursor = Cursor_DefaultValue = PlotOptionsKeltnerchannelsCursor.Null;
			Custom = Custom_DefaultValue = new Hashtable();
			DashStyle = DashStyle_DefaultValue = PlotOptionsKeltnerchannelsDashStyle.Null;
			DataGrouping = DataGrouping_DefaultValue = new PlotOptionsKeltnerchannelsDataGrouping();
			DataLabels = DataLabels_DefaultValue = new PlotOptionsKeltnerchannelsDataLabels();
			DataSorting = DataSorting_DefaultValue = new PlotOptionsKeltnerchannelsDataSorting();
			Description = Description_DefaultValue = "";
			EnableMouseTracking = EnableMouseTracking_DefaultValue = true;
			Events = Events_DefaultValue = new PlotOptionsKeltnerchannelsEvents();
			FillColor = FillColor_DefaultValue = "";
			FindNearestPointBy = FindNearestPointBy_DefaultValue = PlotOptionsKeltnerchannelsFindNearestPointBy.X;
			GapSize = GapSize_DefaultValue = 0;
			GapUnit = GapUnit_DefaultValue = PlotOptionsKeltnerchannelsGapUnit.Relative;
			GetExtremesFromAll = GetExtremesFromAll_DefaultValue = false;
			InactiveOtherPoints = InactiveOtherPoints_DefaultValue = false;
			IncludeInDataExport = IncludeInDataExport_DefaultValue = null;
			Label = Label_DefaultValue = new PlotOptionsKeltnerchannelsLabel();
			LastPrice = LastPrice_DefaultValue = new PlotOptionsKeltnerchannelsLastPrice();
			LastVisiblePrice = LastVisiblePrice_DefaultValue = new PlotOptionsKeltnerchannelsLastVisiblePrice();
			LegendSymbol = LegendSymbol_DefaultValue = PlotOptionsKeltnerchannelsLegendSymbol.Rectangle;
			Linecap = Linecap_DefaultValue = PlotOptionsKeltnerchannelsLinecap.Round;
			LineWidth = LineWidth_DefaultValue = 1;
			LinkedTo = LinkedTo_DefaultValue = "";
			Marker = Marker_DefaultValue = new PlotOptionsKeltnerchannelsMarker();
			NegativeColor = NegativeColor_DefaultValue = "";
			OnPoint = OnPoint_DefaultValue = new PlotOptionsKeltnerchannelsOnPoint();
			Opacity = Opacity_DefaultValue = 1;
			Params = Params_DefaultValue = new PlotOptionsKeltnerchannelsParams();
			Point = Point_DefaultValue = new PlotOptionsKeltnerchannelsPoint();
			...
			Sonification = Sonification_DefaultValue = new PlotOptionsKeltnerchannelsSonification();
			States = States_DefaultValue = new PlotOptionsKeltnerchannelsStates();
			Step = Step_DefaultValue = PlotOptionsKeltnerchannelsStep.Null;
			StickyTracking = StickyTracking_DefaultValue = true;
			Threshold = Threshold_DefaultValue = 0;
			Tooltip = Tooltip_DefaultValue = new PlotOptionsKeltnerchannelsTooltip();
			TopLine = TopLine_DefaultValue = new PlotOptionsKeltnerchannelsTopLine();
			TurboThreshold = TurboThreshold_DefaultValue = 1000;
			Visible = Visible_DefaultValue = true;
			ZoneAxis = ZoneAxis_DefaultValue = "y";
			Zones = Zones_DefaultValue = new List<PlotOptionsKeltnerchannelsZones>();
		...
		/// </summary>
		public PlotOptionsKeltnerchannelsAccessibility Accessibility { get; set; }
		private PlotOptionsKeltnerchannelsAccessibility Accessibility_DefaultValue { get; set; }
		...
		/// </summary>
		public PlotOptionsKeltnerchannelsBoostBlending BoostBlending { get; set; }
		private PlotOptionsKeltnerchannelsBoostBlending BoostBlending_DefaultValue { get; set; }
		...
		/// Bottom line options.
		/// </summary>
		public PlotOptionsKeltnerchannelsBottomLine BottomLine { get; set; }
		private PlotOptionsKeltnerchannelsBottomLine BottomLine_DefaultValue { get; set; }
		...
		/// </summary>
		public PlotOptionsKeltnerchannelsCursor Cursor { get; set; }
		private PlotOptionsKeltnerchannelsCursor Cursor_DefaultValue { get; set; }
		...
		/// </summary>
		public PlotOptionsKeltnerchannelsDashStyle DashStyle { get; set; }
		private PlotOptionsKeltnerchannelsDashStyle DashStyle_DefaultValue { get; set; }
		 

		/// <summary>
		/// 
		/// </summary>
		public PlotOptionsKeltnerchannelsDataGrouping DataGrouping { get; set; }
		private PlotOptionsKeltnerchannelsDataGrouping DataGrouping_DefaultValue { get; set; }
		...
		/// </summary>
		public PlotOptionsKeltnerchannelsDataLabels DataLabels { get; set; }
		private PlotOptionsKeltnerchannelsDataLabels DataLabels_DefaultValue { get; set; }
		 

		/// <summary>
		/// Options for the series data sorting.
		/// </summary>
		public PlotOptionsKeltnerchannelsDataSorting DataSorting { get; set; }
		private PlotOptionsKeltnerchannelsDataSorting DataSorting_DefaultValue { get; set; }
		...
		/// </summary>
		public PlotOptionsKeltnerchannelsEvents Events { get; set; }
		private PlotOptionsKeltnerchannelsEvents Events_DefaultValue { get; set; }
		...
		/// </summary>
		public PlotOptionsKeltnerchannelsFindNearestPointBy FindNearestPointBy { get; set; }
		private PlotOptionsKeltnerchannelsFindNearestPointBy FindNearestPointBy_DefaultValue { get; set; }
		...
		/// </summary>
		public PlotOptionsKeltnerchannelsGapUnit GapUnit { get; set; }
		private PlotOptionsKeltnerchannelsGapUnit GapUnit_DefaultValue { get; set; }
		...
		/// </summary>
		public PlotOptionsKeltnerchannelsLabel Label { get; set; }
		private PlotOptionsKeltnerchannelsLabel Label_DefaultValue { get; set; }
		 

		/// <summary>
		/// The line marks the last price from all points.
		/// </summary>
		public PlotOptionsKeltnerchannelsLastPrice LastPrice { get; set; }
		private PlotOptionsKeltnerchannelsLastPrice LastPrice_DefaultValue { get; set; }
		 

		/// <summary>
		/// The line marks the last price from visible range of points.
		/// </summary>
		public PlotOptionsKeltnerchannelsLastVisiblePrice LastVisiblePrice { get; set; }
		private PlotOptionsKeltnerchannelsLastVisiblePrice LastVisiblePrice_DefaultValue { get; set; }
		 

		/// <summary>
		/// What type of legend symbol to render for this series. Can be one of`lineMarker` or `rectangle`.
		/// </summary>
		public PlotOptionsKeltnerchannelsLegendSymbol LegendSymbol { get; set; }
		private PlotOptionsKeltnerchannelsLegendSymbol LegendSymbol_DefaultValue { get; set; }
		 

		/// <summary>
		/// The line cap used for line ends and line joins on the graph.
		/// </summary>
		public PlotOptionsKeltnerchannelsLinecap Linecap { get; set; }
		private PlotOptionsKeltnerchannelsLinecap Linecap_DefaultValue { get; set; }
		...
		/// 
		/// </summary>
		public PlotOptionsKeltnerchannelsMarker Marker { get; set; }
		private PlotOptionsKeltnerchannelsMarker Marker_DefaultValue { get; set; }
		...
		/// </summary>
		public PlotOptionsKeltnerchannelsOnPoint OnPoint { get; set; }
		private PlotOptionsKeltnerchannelsOnPoint OnPoint_DefaultValue { get; set; }
		...
		/// </summary>
		public PlotOptionsKeltnerchannelsParams Params { get; set; }
		private PlotOptionsKeltnerchannelsParams Params_DefaultValue { get; set; }
		 

		/// <summary>
		/// Properties for each single point.
		/// </summary>
		public PlotOptionsKeltnerchannelsPoint Point { get; set; }
		private PlotOptionsKeltnerchannelsPoint Point_DefaultValue { get; set; }
		...
		/// </summary>
		public PlotOptionsKeltnerchannelsSonification Sonification { get; set; }
		private PlotOptionsKeltnerchannelsSonification Sonification_DefaultValue { get; set; }
		 

		/// <summary>
		/// 
		/// </summary>
		public PlotOptionsKeltnerchannelsStates States { get; set; }
		private PlotOptionsKeltnerchannelsStates States_DefaultValue { get; set; }
		 

		/// <summary>
		/// Whether to apply steps to the line. Possible values are `left`,`center` and `right`.
		/// </summary>
		public PlotOptionsKeltnerchannelsStep Step { get; set; }
		private PlotOptionsKeltnerchannelsStep Step_DefaultValue { get; set; }
		...
		/// 
		/// </summary>
		public PlotOptionsKeltnerchannelsTooltip Tooltip { get; set; }
		private PlotOptionsKeltnerchannelsTooltip Tooltip_DefaultValue { get; set; }
		 

		/// <summary>
		/// Top line options.
		/// </summary>
		public PlotOptionsKeltnerchannelsTopLine TopLine { get; set; }
		private PlotOptionsKeltnerchannelsTopLine TopLine_DefaultValue { get; set; }
		...
		/// </summary>
		public List<PlotOptionsKeltnerchannelsZones> Zones { get; set; }
		private List<PlotOptionsKeltnerchannelsZones> Zones_DefaultValue { get; set; }
