...
{
	public partial class PlotOptionsKeltnerchannelsLastVisiblePriceLabel  : BaseObject
	{
		Hashtable h = new Hashtable();

		public PlotOptionsKeltnerchannelsLastVisiblePriceLabel()
		{
			Align = Align_DefaultValue = PlotOptionsKeltnerchannelsLastVisiblePriceLabelAlign.Null;
		...
		/// 
		/// </summary>
		public PlotOptionsKeltnerchannelsLastVisiblePriceLabelAlign Align { get; set; }
		private PlotOptionsKeltnerchannelsLastVisiblePriceLabelAlign Align_DefaultValue { get; set; }
