...
{
	public partial class PlotOptionsKeltnerchannelsSonificationContextTracks  : BaseObject
	{
		Hashtable h = new Hashtable();

		public PlotOptionsKeltnerchannelsSonificationContextTracks()
		{
			ActiveWhen = ActiveWhen_DefaultValue = new PlotOptionsKeltnerchannelsSonificationContextTracksActiveWhen();
			Instrument = Instrument_DefaultValue = null;
			InstrumentString = InstrumentString_DefaultValue = "null";
			Mapping = Mapping_DefaultValue = new PlotOptionsKeltnerchannelsSonificationContextTracksMapping();
			MidiName = MidiName_DefaultValue = "";
			PointGrouping = PointGrouping_DefaultValue = new PlotOptionsKeltnerchannelsSonificationContextTracksPointGrouping();
			...
			Type = Type_DefaultValue = PlotOptionsKeltnerchannelsSonificationContextTracksType.Instrument;
			ValueInterval = ValueInterval_DefaultValue = null;
			ValueMapFunction = ValueMapFunction_DefaultValue = PlotOptionsKeltnerchannelsSonificationContextTracksValueMapFunction.Linear;
		...
		/// </summary>
		public PlotOptionsKeltnerchannelsSonificationContextTracksActiveWhen ActiveWhen { get; set; }
		private PlotOptionsKeltnerchannelsSonificationContextTracksActiveWhen ActiveWhen_DefaultValue { get; set; }
		...
		/// </summary>
		public PlotOptionsKeltnerchannelsSonificationContextTracksMapping Mapping { get; set; }
		private PlotOptionsKeltnerchannelsSonificationContextTracksMapping Mapping_DefaultValue { get; set; }
		...
		/// </summary>
		public PlotOptionsKeltnerchannelsSonificationContextTracksPointGrouping PointGrouping { get; set; }
		private PlotOptionsKeltnerchannelsSonificationContextTracksPointGrouping PointGrouping_DefaultValue { get; set; }
		...
		/// </summary>
		public PlotOptionsKeltnerchannelsSonificationContextTracksType Type { get; set; }
		private PlotOptionsKeltnerchannelsSonificationContextTracksType Type_DefaultValue { get; set; }
		...
		/// </summary>
		public PlotOptionsKeltnerchannelsSonificationContextTracksValueMapFunction ValueMapFunction { get; set; }
		private PlotOptionsKeltnerchannelsSonificationContextTracksValueMapFunction ValueMapFunction_DefaultValue { get; set; }
