...
{
	public partial class PlotOptionsKeltnerchannelsSonificationContextTracksActiveWhen  : BaseObject
	{
		Hashtable h = new Hashtable();

		public PlotOptionsKeltnerchannelsSonificationContextTracksActiveWhen()
		{
		}	
