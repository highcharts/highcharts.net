...
{
	public partial class PlotOptionsKeltnerchannelsSonificationContextTracksPointGrouping  : BaseObject
	{
		Hashtable h = new Hashtable();

		public PlotOptionsKeltnerchannelsSonificationContextTracksPointGrouping()
		{
			Algorithm = Algorithm_DefaultValue = PlotOptionsKeltnerchannelsSonificationContextTracksPointGroupingAlgorithm.Minimax;
		...
		/// </summary>
		public PlotOptionsKeltnerchannelsSonificationContextTracksPointGroupingAlgorithm Algorithm { get; set; }
		private PlotOptionsKeltnerchannelsSonificationContextTracksPointGroupingAlgorithm Algorithm_DefaultValue { get; set; }
