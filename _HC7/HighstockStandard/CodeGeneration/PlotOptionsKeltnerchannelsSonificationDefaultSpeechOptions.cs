...
{
	public partial class PlotOptionsKeltnerchannelsSonificationDefaultSpeechOptions  : BaseObject
	{
		Hashtable h = new Hashtable();

		public PlotOptionsKeltnerchannelsSonificationDefaultSpeechOptions()
		{
			ActiveWhen = ActiveWhen_DefaultValue = new PlotOptionsKeltnerchannelsSonificationDefaultSpeechOptionsActiveWhen();
			Language = Language_DefaultValue = "en-US";
			Mapping = Mapping_DefaultValue = new PlotOptionsKeltnerchannelsSonificationDefaultSpeechOptionsMapping();
			PointGrouping = PointGrouping_DefaultValue = new PlotOptionsKeltnerchannelsSonificationDefaultSpeechOptionsPointGrouping();
			PreferredVoice = PreferredVoice_DefaultValue = "";
			ShowPlayMarker = ShowPlayMarker_DefaultValue = true;
			Type = Type_DefaultValue = PlotOptionsKeltnerchannelsSonificationDefaultSpeechOptionsType.Instrument;
		...
		/// </summary>
		public PlotOptionsKeltnerchannelsSonificationDefaultSpeechOptionsActiveWhen ActiveWhen { get; set; }
		private PlotOptionsKeltnerchannelsSonificationDefaultSpeechOptionsActiveWhen ActiveWhen_DefaultValue { get; set; }
		...
		/// </summary>
		public PlotOptionsKeltnerchannelsSonificationDefaultSpeechOptionsMapping Mapping { get; set; }
		private PlotOptionsKeltnerchannelsSonificationDefaultSpeechOptionsMapping Mapping_DefaultValue { get; set; }
		 

		/// <summary>
		/// Options for point grouping, specifically for instrument tracks.
		/// </summary>
		public PlotOptionsKeltnerchannelsSonificationDefaultSpeechOptionsPointGrouping PointGrouping { get; set; }
		private PlotOptionsKeltnerchannelsSonificationDefaultSpeechOptionsPointGrouping PointGrouping_DefaultValue { get; set; }
		...
		/// </summary>
		public PlotOptionsKeltnerchannelsSonificationDefaultSpeechOptionsType Type { get; set; }
		private PlotOptionsKeltnerchannelsSonificationDefaultSpeechOptionsType Type_DefaultValue { get; set; }
