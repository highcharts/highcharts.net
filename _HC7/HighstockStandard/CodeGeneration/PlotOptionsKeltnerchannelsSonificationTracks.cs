...
{
	public partial class PlotOptionsKeltnerchannelsSonificationTracks  : BaseObject
	{
		Hashtable h = new Hashtable();

		public PlotOptionsKeltnerchannelsSonificationTracks()
		{
			ActiveWhen = ActiveWhen_DefaultValue = new PlotOptionsKeltnerchannelsSonificationTracksActiveWhen();
			Instrument = Instrument_DefaultValue = null;
			InstrumentString = InstrumentString_DefaultValue = "null";
			Mapping = Mapping_DefaultValue = new PlotOptionsKeltnerchannelsSonificationTracksMapping();
			MidiName = MidiName_DefaultValue = "";
			PointGrouping = PointGrouping_DefaultValue = new PlotOptionsKeltnerchannelsSonificationTracksPointGrouping();
			RoundToMusicalNotes = RoundToMusicalNotes_DefaultValue = true;
			ShowPlayMarker = ShowPlayMarker_DefaultValue = true;
			Type = Type_DefaultValue = PlotOptionsKeltnerchannelsSonificationTracksType.Instrument;
		...
		/// </summary>
		public PlotOptionsKeltnerchannelsSonificationTracksActiveWhen ActiveWhen { get; set; }
		private PlotOptionsKeltnerchannelsSonificationTracksActiveWhen ActiveWhen_DefaultValue { get; set; }
		...
		/// </summary>
		public PlotOptionsKeltnerchannelsSonificationTracksMapping Mapping { get; set; }
		private PlotOptionsKeltnerchannelsSonificationTracksMapping Mapping_DefaultValue { get; set; }
		...
		/// </summary>
		public PlotOptionsKeltnerchannelsSonificationTracksPointGrouping PointGrouping { get; set; }
		private PlotOptionsKeltnerchannelsSonificationTracksPointGrouping PointGrouping_DefaultValue { get; set; }
		...
		/// </summary>
		public PlotOptionsKeltnerchannelsSonificationTracksType Type { get; set; }
		private PlotOptionsKeltnerchannelsSonificationTracksType Type_DefaultValue { get; set; }
