...
{
	public partial class PlotOptionsKeltnerchannelsSonificationTracksPointGrouping  : BaseObject
	{
		Hashtable h = new Hashtable();

		public PlotOptionsKeltnerchannelsSonificationTracksPointGrouping()
		{
			Algorithm = Algorithm_DefaultValue = PlotOptionsKeltnerchannelsSonificationTracksPointGroupingAlgorithm.Minimax;
		...
		/// </summary>
		public PlotOptionsKeltnerchannelsSonificationTracksPointGroupingAlgorithm Algorithm { get; set; }
		private PlotOptionsKeltnerchannelsSonificationTracksPointGroupingAlgorithm Algorithm_DefaultValue { get; set; }
