...
{
	public partial class PlotOptionsKeltnerchannelsStatesHover  : BaseObject
	{
		Hashtable h = new Hashtable();

		public PlotOptionsKeltnerchannelsStatesHover()
		{
			Animation = Animation_DefaultValue = new Animation() { Enabled = true };
			AnimationBool = AnimationBool_DefaultValue = null;
			Enabled = Enabled_DefaultValue = true;
			Halo = Halo_DefaultValue = new PlotOptionsKeltnerchannelsStatesHoverHalo();
			LineWidth = LineWidth_DefaultValue = null;
			LineWidthPlus = LineWidthPlus_DefaultValue = 1;
			Marker = Marker_DefaultValue = new PlotOptionsKeltnerchannelsStatesHoverMarker();
		...
		/// </summary>
		public PlotOptionsKeltnerchannelsStatesHoverHalo Halo { get; set; }
		private PlotOptionsKeltnerchannelsStatesHoverHalo Halo_DefaultValue { get; set; }
		...
		/// </summary>
		public PlotOptionsKeltnerchannelsStatesHoverMarker Marker { get; set; }
		private PlotOptionsKeltnerchannelsStatesHoverMarker Marker_DefaultValue { get; set; }
