...
{
	public partial class PlotOptionsKeltnerchannelsStatesSelect  : BaseObject
	{
		public PlotOptionsKeltnerchannelsStatesSelect()
		{
			Animation = Animation_DefaultValue = new Animation() { Enabled = true };
			Enabled = Enabled_DefaultValue = true;
			Halo = Halo_DefaultValue = new PlotOptionsKeltnerchannelsStatesSelectHalo();
			LineWidth = LineWidth_DefaultValue = null;
			LineWidthPlus = LineWidthPlus_DefaultValue = 1;
			Marker = Marker_DefaultValue = new PlotOptionsKeltnerchannelsStatesSelectMarker();
		...
		/// </summary>
		public PlotOptionsKeltnerchannelsStatesSelectHalo Halo { get; set; }
		private PlotOptionsKeltnerchannelsStatesSelectHalo Halo_DefaultValue { get; set; }
		...
		/// </summary>
		public PlotOptionsKeltnerchannelsStatesSelectMarker Marker { get; set; }
		private PlotOptionsKeltnerchannelsStatesSelectMarker Marker_DefaultValue { get; set; }
