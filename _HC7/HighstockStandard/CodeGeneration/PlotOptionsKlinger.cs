...
namespace Highsoft.Web.Mvc.Stocks
{
	public partial class PlotOptionsKlinger  : BaseObject
	{
		...
		public PlotOptionsKlinger()
		{
			...
			Zones = Zones_DefaultValue = new List<PlotOptionsKlingerZone>();
		...
		/// </summary>
		public List<PlotOptionsKlingerZone> Zones { get; set; }
		private List<PlotOptionsKlingerZone> Zones_DefaultValue { get; set; }
