...
{
	public partial class PlotOptionsKlinger  : BaseObject
	{
		Hashtable h = new Hashtable();

		public PlotOptionsKlinger()
		{
			Accessibility = Accessibility_DefaultValue = new PlotOptionsKlingerAccessibility();
			AllowPointSelect = AllowPointSelect_DefaultValue = false;
			Animation = Animation_DefaultValue = new Animation() { Enabled = true };
			AnimationBool = AnimationBool_DefaultValue = true;
			AnimationLimit = AnimationLimit_DefaultValue = null;
			BoostBlending = BoostBlending_DefaultValue = PlotOptionsKlingerBoostBlending.Undefined;
			...
			Compare = Compare_DefaultValue = PlotOptionsKlingerCompare.Percent;
			CompareBase = CompareBase_DefaultValue = PlotOptionsKlingerCompareBase.Min;
			...
			Cursor = Cursor_DefaultValue = PlotOptionsKlingerCursor.Null;
			Custom = Custom_DefaultValue = new Hashtable();
			DashStyle = DashStyle_DefaultValue = PlotOptionsKlingerDashStyle.Null;
			DataGrouping = DataGrouping_DefaultValue = new PlotOptionsKlingerDataGrouping();
			DataLabels = DataLabels_DefaultValue = new PlotOptionsKlingerDataLabels();
			DataSorting = DataSorting_DefaultValue = new PlotOptionsKlingerDataSorting();
			Description = Description_DefaultValue = "";
			EnableMouseTracking = EnableMouseTracking_DefaultValue = true;
			Events = Events_DefaultValue = new PlotOptionsKlingerEvents();
			FindNearestPointBy = FindNearestPointBy_DefaultValue = PlotOptionsKlingerFindNearestPointBy.X;
			GapSize = GapSize_DefaultValue = 0;
			GapUnit = GapUnit_DefaultValue = PlotOptionsKlingerGapUnit.Relative;
			GetExtremesFromAll = GetExtremesFromAll_DefaultValue = false;
			InactiveOtherPoints = InactiveOtherPoints_DefaultValue = false;
			IncludeInDataExport = IncludeInDataExport_DefaultValue = null;
			Label = Label_DefaultValue = new PlotOptionsKlingerLabel();
			LastPrice = LastPrice_DefaultValue = new PlotOptionsKlingerLastPrice();
			LastVisiblePrice = LastVisiblePrice_DefaultValue = new PlotOptionsKlingerLastVisiblePrice();
			LegendSymbol = LegendSymbol_DefaultValue = PlotOptionsKlingerLegendSymbol.Rectangle;
			Linecap = Linecap_DefaultValue = PlotOptionsKlingerLinecap.Round;
			LineWidth = LineWidth_DefaultValue = 2;
			LinkedTo = LinkedTo_DefaultValue = "";
			Marker = Marker_DefaultValue = new PlotOptionsKlingerMarker();
			NegativeColor = NegativeColor_DefaultValue = "";
			OnPoint = OnPoint_DefaultValue = new PlotOptionsKlingerOnPoint();
			Opacity = Opacity_DefaultValue = 1;
			Params = Params_DefaultValue = new PlotOptionsKlingerParams();
			Point = Point_DefaultValue = new PlotOptionsKlingerPoint();
			...
			SignalLine = SignalLine_DefaultValue = new PlotOptionsKlingerSignalLine();
			SkipKeyboardNavigation = SkipKeyboardNavigation_DefaultValue = null;
			SoftThreshold = SoftThreshold_DefaultValue = true;
			Sonification = Sonification_DefaultValue = new PlotOptionsKlingerSonification();
			States = States_DefaultValue = new PlotOptionsKlingerStates();
			Step = Step_DefaultValue = PlotOptionsKlingerStep.Null;
			StickyTracking = StickyTracking_DefaultValue = true;
			Threshold = Threshold_DefaultValue = 0;
			Tooltip = Tooltip_DefaultValue = new PlotOptionsKlingerTooltip();
			TurboThreshold = TurboThreshold_DefaultValue = 1000;
			Visible = Visible_DefaultValue = true;
			ZoneAxis = ZoneAxis_DefaultValue = "y";
			Zones = Zones_DefaultValue = new List<PlotOptionsKlingerZones>();
		...
		/// </summary>
		public PlotOptionsKlingerAccessibility Accessibility { get; set; }
		private PlotOptionsKlingerAccessibility Accessibility_DefaultValue { get; set; }
		...
		/// </summary>
		public PlotOptionsKlingerBoostBlending BoostBlending { get; set; }
		private PlotOptionsKlingerBoostBlending BoostBlending_DefaultValue { get; set; }
		...
		/// </summary>
		public PlotOptionsKlingerCompare Compare { get; set; }
		private PlotOptionsKlingerCompare Compare_DefaultValue { get; set; }
		 

		/// <summary>
		/// When [compare](#plotOptions.series.compare) is `percent`, this optiondictates whether to use 0 or 100 as the base of comparison.
		/// </summary>
		public PlotOptionsKlingerCompareBase CompareBase { get; set; }
		private PlotOptionsKlingerCompareBase CompareBase_DefaultValue { get; set; }
		...
		/// </summary>
		public PlotOptionsKlingerCursor Cursor { get; set; }
		private PlotOptionsKlingerCursor Cursor_DefaultValue { get; set; }
		...
		/// </summary>
		public PlotOptionsKlingerDashStyle DashStyle { get; set; }
		private PlotOptionsKlingerDashStyle DashStyle_DefaultValue { get; set; }
		 

		/// <summary>
		/// 
		/// </summary>
		public PlotOptionsKlingerDataGrouping DataGrouping { get; set; }
		private PlotOptionsKlingerDataGrouping DataGrouping_DefaultValue { get; set; }
		...
		/// </summary>
		public PlotOptionsKlingerDataLabels DataLabels { get; set; }
		private PlotOptionsKlingerDataLabels DataLabels_DefaultValue { get; set; }
		 

		/// <summary>
		/// Options for the series data sorting.
		/// </summary>
		public PlotOptionsKlingerDataSorting DataSorting { get; set; }
		private PlotOptionsKlingerDataSorting DataSorting_DefaultValue { get; set; }
		...
		/// </summary>
		public PlotOptionsKlingerEvents Events { get; set; }
		private PlotOptionsKlingerEvents Events_DefaultValue { get; set; }
		...
		/// </summary>
		public PlotOptionsKlingerFindNearestPointBy FindNearestPointBy { get; set; }
		private PlotOptionsKlingerFindNearestPointBy FindNearestPointBy_DefaultValue { get; set; }
		...
		/// </summary>
		public PlotOptionsKlingerGapUnit GapUnit { get; set; }
		private PlotOptionsKlingerGapUnit GapUnit_DefaultValue { get; set; }
		...
		/// </summary>
		public PlotOptionsKlingerLabel Label { get; set; }
		private PlotOptionsKlingerLabel Label_DefaultValue { get; set; }
		 

		/// <summary>
		/// The line marks the last price from all points.
		/// </summary>
		public PlotOptionsKlingerLastPrice LastPrice { get; set; }
		private PlotOptionsKlingerLastPrice LastPrice_DefaultValue { get; set; }
		 

		/// <summary>
		/// The line marks the last price from visible range of points.
		/// </summary>
		public PlotOptionsKlingerLastVisiblePrice LastVisiblePrice { get; set; }
		private PlotOptionsKlingerLastVisiblePrice LastVisiblePrice_DefaultValue { get; set; }
		 

		/// <summary>
		/// What type of legend symbol to render for this series. Can be one of`lineMarker` or `rectangle`.
		/// </summary>
		public PlotOptionsKlingerLegendSymbol LegendSymbol { get; set; }
		private PlotOptionsKlingerLegendSymbol LegendSymbol_DefaultValue { get; set; }
		 

		/// <summary>
		/// The line cap used for line ends and line joins on the graph.
		/// </summary>
		public PlotOptionsKlingerLinecap Linecap { get; set; }
		private PlotOptionsKlingerLinecap Linecap_DefaultValue { get; set; }
		...
		/// </summary>
		public PlotOptionsKlingerMarker Marker { get; set; }
		private PlotOptionsKlingerMarker Marker_DefaultValue { get; set; }
		...
		/// </summary>
		public PlotOptionsKlingerOnPoint OnPoint { get; set; }
		private PlotOptionsKlingerOnPoint OnPoint_DefaultValue { get; set; }
		...
		/// </summary>
		public PlotOptionsKlingerPoint Point { get; set; }
		private PlotOptionsKlingerPoint Point_DefaultValue { get; set; }
		...
		/// 
		/// </summary>
		public PlotOptionsKlingerSignalLine SignalLine { get; set; }
		private PlotOptionsKlingerSignalLine SignalLine_DefaultValue { get; set; }
		...
		/// </summary>
		public PlotOptionsKlingerSonification Sonification { get; set; }
		private PlotOptionsKlingerSonification Sonification_DefaultValue { get; set; }
		 

		/// <summary>
		/// 
		/// </summary>
		public PlotOptionsKlingerStates States { get; set; }
		private PlotOptionsKlingerStates States_DefaultValue { get; set; }
		 

		/// <summary>
		/// Whether to apply steps to the line. Possible values are `left`,`center` and `right`.
		/// </summary>
		public PlotOptionsKlingerStep Step { get; set; }
		private PlotOptionsKlingerStep Step_DefaultValue { get; set; }
		...
		/// 
		/// </summary>
		public PlotOptionsKlingerTooltip Tooltip { get; set; }
		private PlotOptionsKlingerTooltip Tooltip_DefaultValue { get; set; }
		...
		/// </summary>
		public List<PlotOptionsKlingerZones> Zones { get; set; }
		private List<PlotOptionsKlingerZones> Zones_DefaultValue { get; set; }
		...
		internal override Hashtable ToHashtable(Highstock highstock)
		{
			...
			if (SignalLine.IsDirty(highstock)) h.Add("signalLine",SignalLine.ToHashtable(highstock));
