...
{
	public partial class PlotOptionsKlingerSonificationContextTracksMapping  : BaseObject
	{
		Hashtable h = new Hashtable();

		public PlotOptionsKlingerSonificationContextTracksMapping()
		{
			Frequency = Frequency_DefaultValue = new PlotOptionsKlingerSonificationContextTracksMappingFrequency();
			GapBetweenNotes = GapBetweenNotes_DefaultValue = new PlotOptionsKlingerSonificationContextTracksMappingGapBetweenNotes();
			Highpass = Highpass_DefaultValue = new PlotOptionsKlingerSonificationContextTracksMappingHighpass();
			Lowpass = Lowpass_DefaultValue = new PlotOptionsKlingerSonificationContextTracksMappingLowpass();
			NoteDuration = NoteDuration_DefaultValue = new PlotOptionsKlingerSonificationContextTracksMappingNoteDuration();
			Pan = Pan_DefaultValue = new PlotOptionsKlingerSonificationContextTracksMappingPan();
			Pitch = Pitch_DefaultValue = new PlotOptionsKlingerSonificationContextTracksMappingPitch();
			PitchString = PitchString_DefaultValue = "null";
			PitchNumber = PitchNumber_DefaultValue = null;
			PlayDelay = PlayDelay_DefaultValue = new PlotOptionsKlingerSonificationContextTracksMappingPlayDelay();
			Time = Time_DefaultValue = new PlotOptionsKlingerSonificationContextTracksMappingTime();
			TimeString = TimeString_DefaultValue = "null";
			TimeNumber = TimeNumber_DefaultValue = null;
			Tremolo = Tremolo_DefaultValue = new PlotOptionsKlingerSonificationContextTracksMappingTremolo();
			Volume = Volume_DefaultValue = new PlotOptionsKlingerSonificationContextTracksMappingVolume();
		...
		/// </summary>
		public PlotOptionsKlingerSonificationContextTracksMappingFrequency Frequency { get; set; }
		private PlotOptionsKlingerSonificationContextTracksMappingFrequency Frequency_DefaultValue { get; set; }
		...
		/// </summary>
		public PlotOptionsKlingerSonificationContextTracksMappingGapBetweenNotes GapBetweenNotes { get; set; }
		private PlotOptionsKlingerSonificationContextTracksMappingGapBetweenNotes GapBetweenNotes_DefaultValue { get; set; }
		...
		/// </summary>
		public PlotOptionsKlingerSonificationContextTracksMappingHighpass Highpass { get; set; }
		private PlotOptionsKlingerSonificationContextTracksMappingHighpass Highpass_DefaultValue { get; set; }
		...
		/// </summary>
		public PlotOptionsKlingerSonificationContextTracksMappingLowpass Lowpass { get; set; }
		private PlotOptionsKlingerSonificationContextTracksMappingLowpass Lowpass_DefaultValue { get; set; }
		...
		/// </summary>
		public PlotOptionsKlingerSonificationContextTracksMappingNoteDuration NoteDuration { get; set; }
		private PlotOptionsKlingerSonificationContextTracksMappingNoteDuration NoteDuration_DefaultValue { get; set; }
		...
		/// </summary>
		public PlotOptionsKlingerSonificationContextTracksMappingPan Pan { get; set; }
		private PlotOptionsKlingerSonificationContextTracksMappingPan Pan_DefaultValue { get; set; }
		...
		/// </summary>
		public PlotOptionsKlingerSonificationContextTracksMappingPitch Pitch { get; set; }
		private PlotOptionsKlingerSonificationContextTracksMappingPitch Pitch_DefaultValue { get; set; }
		...
		/// </summary>
		public PlotOptionsKlingerSonificationContextTracksMappingPlayDelay PlayDelay { get; set; }
		private PlotOptionsKlingerSonificationContextTracksMappingPlayDelay PlayDelay_DefaultValue { get; set; }
		...
		/// </summary>
		public PlotOptionsKlingerSonificationContextTracksMappingTime Time { get; set; }
		private PlotOptionsKlingerSonificationContextTracksMappingTime Time_DefaultValue { get; set; }
		...
		/// </summary>
		public PlotOptionsKlingerSonificationContextTracksMappingTremolo Tremolo { get; set; }
		private PlotOptionsKlingerSonificationContextTracksMappingTremolo Tremolo_DefaultValue { get; set; }
		 

		/// <summary>
		/// The volume of notes, from 0 to 1.
		/// </summary>
		public PlotOptionsKlingerSonificationContextTracksMappingVolume Volume { get; set; }
		private PlotOptionsKlingerSonificationContextTracksMappingVolume Volume_DefaultValue { get; set; }
