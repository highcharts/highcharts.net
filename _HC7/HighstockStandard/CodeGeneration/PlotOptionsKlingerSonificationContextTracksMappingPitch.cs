...
{
	public partial class PlotOptionsKlingerSonificationContextTracksMappingPitch  : BaseObject
	{
		Hashtable h = new Hashtable();

		public PlotOptionsKlingerSonificationContextTracksMappingPitch()
		{
			MapFunction = MapFunction_DefaultValue = PlotOptionsKlingerSonificationContextTracksMappingPitchMapFunction.Linear;
		...
		/// </summary>
		public PlotOptionsKlingerSonificationContextTracksMappingPitchMapFunction MapFunction { get; set; }
		private PlotOptionsKlingerSonificationContextTracksMappingPitchMapFunction MapFunction_DefaultValue { get; set; }
