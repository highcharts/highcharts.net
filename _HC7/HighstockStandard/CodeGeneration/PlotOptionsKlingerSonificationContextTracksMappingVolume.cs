...
{
	public partial class PlotOptionsKlingerSonificationContextTracksMappingVolume  : BaseObject
	{
		Hashtable h = new Hashtable();

		public PlotOptionsKlingerSonificationContextTracksMappingVolume()
		{
			MapFunction = MapFunction_DefaultValue = PlotOptionsKlingerSonificationContextTracksMappingVolumeMapFunction.Linear;
			MapTo = MapTo_DefaultValue = "";
			Max = Max_DefaultValue = null;
			Min = Min_DefaultValue = null;
			Value = Value_DefaultValue = null;
			Within = Within_DefaultValue = PlotOptionsKlingerSonificationContextTracksMappingVolumeWithin.Chart;
		...
		/// </summary>
		public PlotOptionsKlingerSonificationContextTracksMappingVolumeMapFunction MapFunction { get; set; }
		private PlotOptionsKlingerSonificationContextTracksMappingVolumeMapFunction MapFunction_DefaultValue { get; set; }
		...
		/// </summary>
		public PlotOptionsKlingerSonificationContextTracksMappingVolumeWithin Within { get; set; }
		private PlotOptionsKlingerSonificationContextTracksMappingVolumeWithin Within_DefaultValue { get; set; }
