...
{
	public partial class PlotOptionsKlingerSonificationContextTracksPointGrouping  : BaseObject
	{
		Hashtable h = new Hashtable();

		public PlotOptionsKlingerSonificationContextTracksPointGrouping()
		{
			Algorithm = Algorithm_DefaultValue = PlotOptionsKlingerSonificationContextTracksPointGroupingAlgorithm.Minimax;
		...
		/// </summary>
		public PlotOptionsKlingerSonificationContextTracksPointGroupingAlgorithm Algorithm { get; set; }
		private PlotOptionsKlingerSonificationContextTracksPointGroupingAlgorithm Algorithm_DefaultValue { get; set; }
