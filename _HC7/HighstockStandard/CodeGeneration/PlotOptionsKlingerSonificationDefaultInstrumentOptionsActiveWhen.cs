...
{
	public partial class PlotOptionsKlingerSonificationDefaultInstrumentOptionsActiveWhen  : BaseObject
	{
		Hashtable h = new Hashtable();

		public PlotOptionsKlingerSonificationDefaultInstrumentOptionsActiveWhen()
		{
