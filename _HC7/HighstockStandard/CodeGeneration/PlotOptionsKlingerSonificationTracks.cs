...
{
	public partial class PlotOptionsKlingerSonificationTracks  : BaseObject
	{
		Hashtable h = new Hashtable();

		public PlotOptionsKlingerSonificationTracks()
		{
			ActiveWhen = ActiveWhen_DefaultValue = new PlotOptionsKlingerSonificationTracksActiveWhen();
			Instrument = Instrument_DefaultValue = null;
			InstrumentString = InstrumentString_DefaultValue = "null";
			Mapping = Mapping_DefaultValue = new PlotOptionsKlingerSonificationTracksMapping();
			MidiName = MidiName_DefaultValue = "";
			PointGrouping = PointGrouping_DefaultValue = new PlotOptionsKlingerSonificationTracksPointGrouping();
			RoundToMusicalNotes = RoundToMusicalNotes_DefaultValue = true;
			ShowPlayMarker = ShowPlayMarker_DefaultValue = true;
			Type = Type_DefaultValue = PlotOptionsKlingerSonificationTracksType.Instrument;
		...
		/// </summary>
		public PlotOptionsKlingerSonificationTracksActiveWhen ActiveWhen { get; set; }
		private PlotOptionsKlingerSonificationTracksActiveWhen ActiveWhen_DefaultValue { get; set; }
		...
		/// </summary>
		public PlotOptionsKlingerSonificationTracksMapping Mapping { get; set; }
		private PlotOptionsKlingerSonificationTracksMapping Mapping_DefaultValue { get; set; }
		...
		/// </summary>
		public PlotOptionsKlingerSonificationTracksPointGrouping PointGrouping { get; set; }
		private PlotOptionsKlingerSonificationTracksPointGrouping PointGrouping_DefaultValue { get; set; }
		...
		/// </summary>
		public PlotOptionsKlingerSonificationTracksType Type { get; set; }
		private PlotOptionsKlingerSonificationTracksType Type_DefaultValue { get; set; }
