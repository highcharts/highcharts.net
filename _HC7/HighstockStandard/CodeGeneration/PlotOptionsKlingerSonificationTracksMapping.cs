...
{
	public partial class PlotOptionsKlingerSonificationTracksMapping  : BaseObject
	{
		Hashtable h = new Hashtable();

		public PlotOptionsKlingerSonificationTracksMapping()
		{
			Frequency = Frequency_DefaultValue = new PlotOptionsKlingerSonificationTracksMappingFrequency();
			GapBetweenNotes = GapBetweenNotes_DefaultValue = new PlotOptionsKlingerSonificationTracksMappingGapBetweenNotes();
			Highpass = Highpass_DefaultValue = new PlotOptionsKlingerSonificationTracksMappingHighpass();
			Lowpass = Lowpass_DefaultValue = new PlotOptionsKlingerSonificationTracksMappingLowpass();
			NoteDuration = NoteDuration_DefaultValue = new PlotOptionsKlingerSonificationTracksMappingNoteDuration();
			Pan = Pan_DefaultValue = new PlotOptionsKlingerSonificationTracksMappingPan();
			Pitch = Pitch_DefaultValue = new PlotOptionsKlingerSonificationTracksMappingPitch();
			PitchString = PitchString_DefaultValue = "null";
			PitchNumber = PitchNumber_DefaultValue = null;
			PlayDelay = PlayDelay_DefaultValue = new PlotOptionsKlingerSonificationTracksMappingPlayDelay();
			Time = Time_DefaultValue = new PlotOptionsKlingerSonificationTracksMappingTime();
			TimeString = TimeString_DefaultValue = "null";
			TimeNumber = TimeNumber_DefaultValue = null;
			Tremolo = Tremolo_DefaultValue = new PlotOptionsKlingerSonificationTracksMappingTremolo();
			Volume = Volume_DefaultValue = new PlotOptionsKlingerSonificationTracksMappingVolume();
		...
		/// </summary>
		public PlotOptionsKlingerSonificationTracksMappingFrequency Frequency { get; set; }
		private PlotOptionsKlingerSonificationTracksMappingFrequency Frequency_DefaultValue { get; set; }
		...
		/// </summary>
		public PlotOptionsKlingerSonificationTracksMappingGapBetweenNotes GapBetweenNotes { get; set; }
		private PlotOptionsKlingerSonificationTracksMappingGapBetweenNotes GapBetweenNotes_DefaultValue { get; set; }
		...
		/// </summary>
		public PlotOptionsKlingerSonificationTracksMappingHighpass Highpass { get; set; }
		private PlotOptionsKlingerSonificationTracksMappingHighpass Highpass_DefaultValue { get; set; }
		...
		/// </summary>
		public PlotOptionsKlingerSonificationTracksMappingLowpass Lowpass { get; set; }
		private PlotOptionsKlingerSonificationTracksMappingLowpass Lowpass_DefaultValue { get; set; }
		...
		/// </summary>
		public PlotOptionsKlingerSonificationTracksMappingNoteDuration NoteDuration { get; set; }
		private PlotOptionsKlingerSonificationTracksMappingNoteDuration NoteDuration_DefaultValue { get; set; }
		...
		/// </summary>
		public PlotOptionsKlingerSonificationTracksMappingPan Pan { get; set; }
		private PlotOptionsKlingerSonificationTracksMappingPan Pan_DefaultValue { get; set; }
		...
		/// </summary>
		public PlotOptionsKlingerSonificationTracksMappingPitch Pitch { get; set; }
		private PlotOptionsKlingerSonificationTracksMappingPitch Pitch_DefaultValue { get; set; }
		...
		/// </summary>
		public PlotOptionsKlingerSonificationTracksMappingPlayDelay PlayDelay { get; set; }
		private PlotOptionsKlingerSonificationTracksMappingPlayDelay PlayDelay_DefaultValue { get; set; }
		...
		/// </summary>
		public PlotOptionsKlingerSonificationTracksMappingTime Time { get; set; }
		private PlotOptionsKlingerSonificationTracksMappingTime Time_DefaultValue { get; set; }
		...
		/// </summary>
		public PlotOptionsKlingerSonificationTracksMappingTremolo Tremolo { get; set; }
		private PlotOptionsKlingerSonificationTracksMappingTremolo Tremolo_DefaultValue { get; set; }
		 

		/// <summary>
		/// The volume of notes, from 0 to 1.
		/// </summary>
		public PlotOptionsKlingerSonificationTracksMappingVolume Volume { get; set; }
		private PlotOptionsKlingerSonificationTracksMappingVolume Volume_DefaultValue { get; set; }
