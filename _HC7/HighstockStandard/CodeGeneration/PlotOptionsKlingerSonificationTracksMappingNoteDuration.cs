...
{
	public partial class PlotOptionsKlingerSonificationTracksMappingNoteDuration  : BaseObject
	{
		Hashtable h = new Hashtable();

		public PlotOptionsKlingerSonificationTracksMappingNoteDuration()
		{
			MapFunction = MapFunction_DefaultValue = PlotOptionsKlingerSonificationTracksMappingNoteDurationMapFunction.Linear;
			MapTo = MapTo_DefaultValue = "";
			Max = Max_DefaultValue = null;
			Min = Min_DefaultValue = null;
			Value = Value_DefaultValue = null;
			Within = Within_DefaultValue = PlotOptionsKlingerSonificationTracksMappingNoteDurationWithin.Chart;
		...
		/// </summary>
		public PlotOptionsKlingerSonificationTracksMappingNoteDurationMapFunction MapFunction { get; set; }
		private PlotOptionsKlingerSonificationTracksMappingNoteDurationMapFunction MapFunction_DefaultValue { get; set; }
		...
		/// </summary>
		public PlotOptionsKlingerSonificationTracksMappingNoteDurationWithin Within { get; set; }
		private PlotOptionsKlingerSonificationTracksMappingNoteDurationWithin Within_DefaultValue { get; set; }
