...
{
	public partial class PlotOptionsKlingerSonificationTracksMappingPan  : BaseObject
	{
		Hashtable h = new Hashtable();

		public PlotOptionsKlingerSonificationTracksMappingPan()
		{
			MapFunction = MapFunction_DefaultValue = PlotOptionsKlingerSonificationTracksMappingPanMapFunction.Linear;
			MapTo = MapTo_DefaultValue = "";
			Max = Max_DefaultValue = null;
			Min = Min_DefaultValue = null;
			Value = Value_DefaultValue = null;
			Within = Within_DefaultValue = PlotOptionsKlingerSonificationTracksMappingPanWithin.Chart;
		...
		/// </summary>
		public PlotOptionsKlingerSonificationTracksMappingPanMapFunction MapFunction { get; set; }
		private PlotOptionsKlingerSonificationTracksMappingPanMapFunction MapFunction_DefaultValue { get; set; }
		...
		/// </summary>
		public PlotOptionsKlingerSonificationTracksMappingPanWithin Within { get; set; }
		private PlotOptionsKlingerSonificationTracksMappingPanWithin Within_DefaultValue { get; set; }
