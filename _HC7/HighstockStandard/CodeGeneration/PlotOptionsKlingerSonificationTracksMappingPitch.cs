...
{
	public partial class PlotOptionsKlingerSonificationTracksMappingPitch  : BaseObject
	{
		Hashtable h = new Hashtable();

		public PlotOptionsKlingerSonificationTracksMappingPitch()
		{
			MapFunction = MapFunction_DefaultValue = PlotOptionsKlingerSonificationTracksMappingPitchMapFunction.Linear;
		...
		/// </summary>
		public PlotOptionsKlingerSonificationTracksMappingPitchMapFunction MapFunction { get; set; }
		private PlotOptionsKlingerSonificationTracksMappingPitchMapFunction MapFunction_DefaultValue { get; set; }
