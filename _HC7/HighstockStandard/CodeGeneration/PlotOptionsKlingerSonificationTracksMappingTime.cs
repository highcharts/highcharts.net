...
{
	public partial class PlotOptionsKlingerSonificationTracksMappingTime  : BaseObject
	{
		Hashtable h = new Hashtable();

		public PlotOptionsKlingerSonificationTracksMappingTime()
		{
			MapFunction = MapFunction_DefaultValue = PlotOptionsKlingerSonificationTracksMappingTimeMapFunction.Linear;
			MapTo = MapTo_DefaultValue = "";
			Max = Max_DefaultValue = null;
			Min = Min_DefaultValue = null;
			Value = Value_DefaultValue = null;
			Within = Within_DefaultValue = PlotOptionsKlingerSonificationTracksMappingTimeWithin.Chart;
		...
		/// </summary>
		public PlotOptionsKlingerSonificationTracksMappingTimeMapFunction MapFunction { get; set; }
		private PlotOptionsKlingerSonificationTracksMappingTimeMapFunction MapFunction_DefaultValue { get; set; }
		...
		/// </summary>
		public PlotOptionsKlingerSonificationTracksMappingTimeWithin Within { get; set; }
		private PlotOptionsKlingerSonificationTracksMappingTimeWithin Within_DefaultValue { get; set; }
