...
{
	public partial class PlotOptionsKlingerSonificationTracksMappingVolume  : BaseObject
	{
		Hashtable h = new Hashtable();

		public PlotOptionsKlingerSonificationTracksMappingVolume()
		{
			MapFunction = MapFunction_DefaultValue = PlotOptionsKlingerSonificationTracksMappingVolumeMapFunction.Linear;
			MapTo = MapTo_DefaultValue = "";
			Max = Max_DefaultValue = null;
			Min = Min_DefaultValue = null;
			Value = Value_DefaultValue = null;
			Within = Within_DefaultValue = PlotOptionsKlingerSonificationTracksMappingVolumeWithin.Chart;
		...
		/// </summary>
		public PlotOptionsKlingerSonificationTracksMappingVolumeMapFunction MapFunction { get; set; }
		private PlotOptionsKlingerSonificationTracksMappingVolumeMapFunction MapFunction_DefaultValue { get; set; }
		...
		/// </summary>
		public PlotOptionsKlingerSonificationTracksMappingVolumeWithin Within { get; set; }
		private PlotOptionsKlingerSonificationTracksMappingVolumeWithin Within_DefaultValue { get; set; }
