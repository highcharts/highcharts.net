...
{
	public partial class PlotOptionsKlingerStatesHover  : BaseObject
	{
		Hashtable h = new Hashtable();

		public PlotOptionsKlingerStatesHover()
		{
			Animation = Animation_DefaultValue = new Animation() { Enabled = true };
			AnimationBool = AnimationBool_DefaultValue = null;
			Enabled = Enabled_DefaultValue = true;
			Halo = Halo_DefaultValue = new PlotOptionsKlingerStatesHoverHalo();
			LineWidth = LineWidth_DefaultValue = null;
			LineWidthPlus = LineWidthPlus_DefaultValue = 1;
			Marker = Marker_DefaultValue = new PlotOptionsKlingerStatesHoverMarker();
		...
		/// </summary>
		public PlotOptionsKlingerStatesHoverHalo Halo { get; set; }
		private PlotOptionsKlingerStatesHoverHalo Halo_DefaultValue { get; set; }
		...
		/// </summary>
		public PlotOptionsKlingerStatesHoverMarker Marker { get; set; }
		private PlotOptionsKlingerStatesHoverMarker Marker_DefaultValue { get; set; }
