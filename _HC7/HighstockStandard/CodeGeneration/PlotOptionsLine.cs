...
namespace Highsoft.Web.Mvc.Stocks
{
	public partial class PlotOptionsLine  : BaseObject
	{
		...
		{
			Accessibility = Accessibility_DefaultValue = new PlotOptionsLineAccessibility();
			AllowPointSelect = AllowPointSelect_DefaultValue = false;
			Animation = Animation_DefaultValue = new Animation() { Enabled = true };
			AnimationBool = AnimationBool_DefaultValue = true;
			AnimationLimit = AnimationLimit_DefaultValue = null;
			BoostBlending = BoostBlending_DefaultValue = PlotOptionsLineBoostBlending.Undefined;
			...
			Compare = Compare_DefaultValue = PlotOptionsLineCompare.Percent;
			...
			DashStyle = DashStyle_DefaultValue = PlotOptionsLineDashStyle.Null;
			DataGrouping = DataGrouping_DefaultValue = new PlotOptionsLineDataGrouping();
			DataLabels = DataLabels_DefaultValue = new PlotOptionsLineDataLabels();
			DataSorting = DataSorting_DefaultValue = new PlotOptionsLineDataSorting();
			Description = Description_DefaultValue = "";
			DragDrop = DragDrop_DefaultValue = new PlotOptionsLineDragDrop();
			EnableMouseTracking = EnableMouseTracking_DefaultValue = true;
			Events = Events_DefaultValue = new PlotOptionsLineEvents();
			FindNearestPointBy = FindNearestPointBy_DefaultValue = PlotOptionsLineFindNearestPointBy.X;
			GapSize = GapSize_DefaultValue = 0;
			GapUnit = GapUnit_DefaultValue = PlotOptionsLineGapUnit.Relative;
			...
			LastPrice = LastPrice_DefaultValue = new PlotOptionsLineLastPrice();
			LastVisiblePrice = LastVisiblePrice_DefaultValue = new PlotOptionsLineLastVisiblePrice();
			LegendSymbol = LegendSymbol_DefaultValue = PlotOptionsLineLegendSymbol.Rectangle;
			...
			OnPoint = OnPoint_DefaultValue = new PlotOptionsLineOnPoint();
			Opacity = Opacity_DefaultValue = 1;
			Point = Point_DefaultValue = new PlotOptionsLinePoint();
			PointDescriptionFormat = PointDescriptionFormat_DefaultValue = "";
			PointDescriptionFormatter = PointDescriptionFormatter_DefaultValue = "";
			PointInterval = PointInterval_DefaultValue = 1;
			PointIntervalUnit = PointIntervalUnit_DefaultValue = PlotOptionsLinePointIntervalUnit.Null;
			...
			Sonification = Sonification_DefaultValue = new PlotOptionsLineSonification();
			Stacking = Stacking_DefaultValue = PlotOptionsLineStacking.Null;
			States = States_DefaultValue = new PlotOptionsLineStates();
			Step = Step_DefaultValue = PlotOptionsLineStep.Null;
			StickyTracking = StickyTracking_DefaultValue = true;
			Threshold = Threshold_DefaultValue = 0;
			Tooltip = Tooltip_DefaultValue = new PlotOptionsLineTooltip();
			TurboThreshold = TurboThreshold_DefaultValue = 1000;
			UseOhlcData = UseOhlcData_DefaultValue = null;
			Visible = Visible_DefaultValue = true;
			ZoneAxis = ZoneAxis_DefaultValue = "y";
			Zones = Zones_DefaultValue = new List<PlotOptionsLineZones>();
		...
		/// </summary>
		public PlotOptionsLineAccessibility Accessibility { get; set; }
		private PlotOptionsLineAccessibility Accessibility_DefaultValue { get; set; }
		...
		/// </summary>
		public PlotOptionsLineBoostBlending BoostBlending { get; set; }
		private PlotOptionsLineBoostBlending BoostBlending_DefaultValue { get; set; }
		...
		/// </summary>
		public PlotOptionsLineCompare Compare { get; set; }
		private PlotOptionsLineCompare Compare_DefaultValue { get; set; }
		...
		/// </summary>
		public PlotOptionsLineDataSorting DataSorting { get; set; }
		private PlotOptionsLineDataSorting DataSorting_DefaultValue { get; set; }
		...
		/// </summary>
		public PlotOptionsLineDragDrop DragDrop { get; set; }
		private PlotOptionsLineDragDrop DragDrop_DefaultValue { get; set; }
		...
		/// </summary>
		public PlotOptionsLineFindNearestPointBy FindNearestPointBy { get; set; }
		private PlotOptionsLineFindNearestPointBy FindNearestPointBy_DefaultValue { get; set; }
		...
		/// </summary>
		public PlotOptionsLineGapUnit GapUnit { get; set; }
		private PlotOptionsLineGapUnit GapUnit_DefaultValue { get; set; }
		...
		/// </summary>
		public PlotOptionsLineLabel Label { get; set; }
		private PlotOptionsLineLabel Label_DefaultValue { get; set; }
		 

		/// <summary>
		/// The line marks the last price from all points.
		/// </summary>
		public PlotOptionsLineLastPrice LastPrice { get; set; }
		private PlotOptionsLineLastPrice LastPrice_DefaultValue { get; set; }
		 

		/// <summary>
		/// The line marks the last price from visible range of points.
		/// </summary>
		public PlotOptionsLineLastVisiblePrice LastVisiblePrice { get; set; }
		private PlotOptionsLineLastVisiblePrice LastVisiblePrice_DefaultValue { get; set; }
		 

		/// <summary>
		/// What type of legend symbol to render for this series. Can be one of`areaMarker`, `lineMarker` or `rectangle`.
		/// </summary>
		public PlotOptionsLineLegendSymbol LegendSymbol { get; set; }
		private PlotOptionsLineLegendSymbol LegendSymbol_DefaultValue { get; set; }
		...
		/// </summary>
		public PlotOptionsLineOnPoint OnPoint { get; set; }
		private PlotOptionsLineOnPoint OnPoint_DefaultValue { get; set; }
		...
		/// </summary>
		public PlotOptionsLineSonification Sonification { get; set; }
		private PlotOptionsLineSonification Sonification_DefaultValue { get; set; }
		...
		/// </summary>
		public List<PlotOptionsLineZones> Zones { get; set; }
		private List<PlotOptionsLineZones> Zones_DefaultValue { get; set; }
