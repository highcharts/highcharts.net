...
{
	public partial class PlotOptionsLineSonificationContextTracks  : BaseObject
	{
		Hashtable h = new Hashtable();

		public PlotOptionsLineSonificationContextTracks()
		{
			ActiveWhen = ActiveWhen_DefaultValue = new PlotOptionsLineSonificationContextTracksActiveWhen();
			Instrument = Instrument_DefaultValue = null;
			InstrumentString = InstrumentString_DefaultValue = "null";
			Mapping = Mapping_DefaultValue = new PlotOptionsLineSonificationContextTracksMapping();
			MidiName = MidiName_DefaultValue = "";
			PointGrouping = PointGrouping_DefaultValue = new PlotOptionsLineSonificationContextTracksPointGrouping();
			...
			Type = Type_DefaultValue = PlotOptionsLineSonificationContextTracksType.Instrument;
			ValueInterval = ValueInterval_DefaultValue = null;
			ValueMapFunction = ValueMapFunction_DefaultValue = PlotOptionsLineSonificationContextTracksValueMapFunction.Linear;
		...
		/// </summary>
		public PlotOptionsLineSonificationContextTracksActiveWhen ActiveWhen { get; set; }
		private PlotOptionsLineSonificationContextTracksActiveWhen ActiveWhen_DefaultValue { get; set; }
		...
		/// </summary>
		public PlotOptionsLineSonificationContextTracksMapping Mapping { get; set; }
		private PlotOptionsLineSonificationContextTracksMapping Mapping_DefaultValue { get; set; }
		...
		/// </summary>
		public PlotOptionsLineSonificationContextTracksPointGrouping PointGrouping { get; set; }
		private PlotOptionsLineSonificationContextTracksPointGrouping PointGrouping_DefaultValue { get; set; }
		...
		/// </summary>
		public PlotOptionsLineSonificationContextTracksType Type { get; set; }
		private PlotOptionsLineSonificationContextTracksType Type_DefaultValue { get; set; }
		...
		/// </summary>
		public PlotOptionsLineSonificationContextTracksValueMapFunction ValueMapFunction { get; set; }
		private PlotOptionsLineSonificationContextTracksValueMapFunction ValueMapFunction_DefaultValue { get; set; }
