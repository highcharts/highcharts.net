...
namespace Highsoft.Web.Mvc.Stocks
{
	public partial class PlotOptionsLineSonificationContextTracksMapping  : BaseObject
	{
		...
		public PlotOptionsLineSonificationContextTracksMapping()
		{
			...
			Time = Time_DefaultValue = new PlotOptionsLineSonificationContextTracksMappingTime();
		...
		private PlotOptionsLineSonificationContextTracksMappingTime Time_DefaultValue { get; set; }
