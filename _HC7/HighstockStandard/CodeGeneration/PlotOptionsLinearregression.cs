...
namespace Highsoft.Web.Mvc.Stocks
{
	public partial class PlotOptionsLinearregression  : BaseObject
	{
		...
		public PlotOptionsLinearregression()
		{
			...
			Zones = Zones_DefaultValue = new List<PlotOptionsLinearregressionZone>();
		...
		/// </summary>
		public List<PlotOptionsLinearregressionZone> Zones { get; set; }
		private List<PlotOptionsLinearregressionZone> Zones_DefaultValue { get; set; }
