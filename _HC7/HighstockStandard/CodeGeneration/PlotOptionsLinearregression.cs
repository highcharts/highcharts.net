...
{
	public partial class PlotOptionsLinearregression  : BaseObject
	{
		Hashtable h = new Hashtable();

		public PlotOptionsLinearregression()
		{
			Accessibility = Accessibility_DefaultValue = new PlotOptionsLinearregressionAccessibility();
			AllowPointSelect = AllowPointSelect_DefaultValue = false;
			Animation = Animation_DefaultValue = new Animation() { Enabled = true };
			AnimationBool = AnimationBool_DefaultValue = true;
			AnimationLimit = AnimationLimit_DefaultValue = null;
			BoostBlending = BoostBlending_DefaultValue = PlotOptionsLinearregressionBoostBlending.Undefined;
			...
			Compare = Compare_DefaultValue = PlotOptionsLinearregressionCompare.Percent;
			CompareBase = CompareBase_DefaultValue = PlotOptionsLinearregressionCompareBase.Min;
			...
			Cursor = Cursor_DefaultValue = PlotOptionsLinearregressionCursor.Null;
			Custom = Custom_DefaultValue = new Hashtable();
			DashStyle = DashStyle_DefaultValue = PlotOptionsLinearregressionDashStyle.Null;
			DataGrouping = DataGrouping_DefaultValue = new PlotOptionsLinearregressionDataGrouping();
			DataLabels = DataLabels_DefaultValue = new PlotOptionsLinearregressionDataLabels();
			DataSorting = DataSorting_DefaultValue = new PlotOptionsLinearregressionDataSorting();
			Description = Description_DefaultValue = "";
			EnableMouseTracking = EnableMouseTracking_DefaultValue = true;
			Events = Events_DefaultValue = new PlotOptionsLinearregressionEvents();
			FindNearestPointBy = FindNearestPointBy_DefaultValue = PlotOptionsLinearregressionFindNearestPointBy.X;
			GapSize = GapSize_DefaultValue = 0;
			GapUnit = GapUnit_DefaultValue = PlotOptionsLinearregressionGapUnit.Relative;
			GetExtremesFromAll = GetExtremesFromAll_DefaultValue = false;
			InactiveOtherPoints = InactiveOtherPoints_DefaultValue = false;
			IncludeInDataExport = IncludeInDataExport_DefaultValue = null;
			Label = Label_DefaultValue = new PlotOptionsLinearregressionLabel();
			LastPrice = LastPrice_DefaultValue = new PlotOptionsLinearregressionLastPrice();
			LastVisiblePrice = LastVisiblePrice_DefaultValue = new PlotOptionsLinearregressionLastVisiblePrice();
			LegendSymbol = LegendSymbol_DefaultValue = PlotOptionsLinearregressionLegendSymbol.Rectangle;
			Linecap = Linecap_DefaultValue = PlotOptionsLinearregressionLinecap.Round;
			LineWidth = LineWidth_DefaultValue = 2;
			LinkedTo = LinkedTo_DefaultValue = "";
			Marker = Marker_DefaultValue = new PlotOptionsLinearregressionMarker();
			NegativeColor = NegativeColor_DefaultValue = "";
			OnPoint = OnPoint_DefaultValue = new PlotOptionsLinearregressionOnPoint();
			Opacity = Opacity_DefaultValue = 1;
			Params = Params_DefaultValue = new PlotOptionsLinearregressionParams();
			Point = Point_DefaultValue = new PlotOptionsLinearregressionPoint();
			...
			Sonification = Sonification_DefaultValue = new PlotOptionsLinearregressionSonification();
			States = States_DefaultValue = new PlotOptionsLinearregressionStates();
			Step = Step_DefaultValue = PlotOptionsLinearregressionStep.Null;
			StickyTracking = StickyTracking_DefaultValue = true;
			Threshold = Threshold_DefaultValue = 0;
			Tooltip = Tooltip_DefaultValue = new PlotOptionsLinearregressionTooltip();
			TurboThreshold = TurboThreshold_DefaultValue = 1000;
			Visible = Visible_DefaultValue = true;
			ZoneAxis = ZoneAxis_DefaultValue = "y";
			Zones = Zones_DefaultValue = new List<PlotOptionsLinearregressionZones>();
		...
		/// </summary>
		public PlotOptionsLinearregressionAccessibility Accessibility { get; set; }
		private PlotOptionsLinearregressionAccessibility Accessibility_DefaultValue { get; set; }
		...
		/// </summary>
		public PlotOptionsLinearregressionBoostBlending BoostBlending { get; set; }
		private PlotOptionsLinearregressionBoostBlending BoostBlending_DefaultValue { get; set; }
		...
		/// </summary>
		public PlotOptionsLinearregressionCompare Compare { get; set; }
		private PlotOptionsLinearregressionCompare Compare_DefaultValue { get; set; }
		 

		/// <summary>
		/// When [compare](#plotOptions.series.compare) is `percent`, this optiondictates whether to use 0 or 100 as the base of comparison.
		/// </summary>
		public PlotOptionsLinearregressionCompareBase CompareBase { get; set; }
		private PlotOptionsLinearregressionCompareBase CompareBase_DefaultValue { get; set; }
		...
		/// </summary>
		public PlotOptionsLinearregressionCursor Cursor { get; set; }
		private PlotOptionsLinearregressionCursor Cursor_DefaultValue { get; set; }
		...
		/// </summary>
		public PlotOptionsLinearregressionDashStyle DashStyle { get; set; }
		private PlotOptionsLinearregressionDashStyle DashStyle_DefaultValue { get; set; }
		...
		/// </summary>
		public PlotOptionsLinearregressionDataGrouping DataGrouping { get; set; }
		private PlotOptionsLinearregressionDataGrouping DataGrouping_DefaultValue { get; set; }
		...
		/// </summary>
		public PlotOptionsLinearregressionDataLabels DataLabels { get; set; }
		private PlotOptionsLinearregressionDataLabels DataLabels_DefaultValue { get; set; }
		 

		/// <summary>
		/// Options for the series data sorting.
		/// </summary>
		public PlotOptionsLinearregressionDataSorting DataSorting { get; set; }
		private PlotOptionsLinearregressionDataSorting DataSorting_DefaultValue { get; set; }
		...
		/// </summary>
		public PlotOptionsLinearregressionEvents Events { get; set; }
		private PlotOptionsLinearregressionEvents Events_DefaultValue { get; set; }
		...
		/// </summary>
		public PlotOptionsLinearregressionFindNearestPointBy FindNearestPointBy { get; set; }
		private PlotOptionsLinearregressionFindNearestPointBy FindNearestPointBy_DefaultValue { get; set; }
		...
		/// </summary>
		public PlotOptionsLinearregressionGapUnit GapUnit { get; set; }
		private PlotOptionsLinearregressionGapUnit GapUnit_DefaultValue { get; set; }
		...
		/// </summary>
		public PlotOptionsLinearregressionLabel Label { get; set; }
		private PlotOptionsLinearregressionLabel Label_DefaultValue { get; set; }
		 

		/// <summary>
		/// The line marks the last price from all points.
		/// </summary>
		public PlotOptionsLinearregressionLastPrice LastPrice { get; set; }
		private PlotOptionsLinearregressionLastPrice LastPrice_DefaultValue { get; set; }
		 

		/// <summary>
		/// The line marks the last price from visible range of points.
		/// </summary>
		public PlotOptionsLinearregressionLastVisiblePrice LastVisiblePrice { get; set; }
		private PlotOptionsLinearregressionLastVisiblePrice LastVisiblePrice_DefaultValue { get; set; }
		 

		/// <summary>
		/// What type of legend symbol to render for this series. Can be one of`areaMarker`, `lineMarker` or `rectangle`.
		/// </summary>
		public PlotOptionsLinearregressionLegendSymbol LegendSymbol { get; set; }
		private PlotOptionsLinearregressionLegendSymbol LegendSymbol_DefaultValue { get; set; }
		 

		/// <summary>
		/// The line cap used for line ends and line joins on the graph.
		/// </summary>
		public PlotOptionsLinearregressionLinecap Linecap { get; set; }
		private PlotOptionsLinearregressionLinecap Linecap_DefaultValue { get; set; }
		...
		/// </summary>
		public PlotOptionsLinearregressionMarker Marker { get; set; }
		private PlotOptionsLinearregressionMarker Marker_DefaultValue { get; set; }
		...
		/// </summary>
		public PlotOptionsLinearregressionOnPoint OnPoint { get; set; }
		private PlotOptionsLinearregressionOnPoint OnPoint_DefaultValue { get; set; }
		...
		/// 
		/// </summary>
		public PlotOptionsLinearregressionParams Params { get; set; }
		private PlotOptionsLinearregressionParams Params_DefaultValue { get; set; }
		 

		/// <summary>
		/// Properties for each single point.
		/// </summary>
		public PlotOptionsLinearregressionPoint Point { get; set; }
		private PlotOptionsLinearregressionPoint Point_DefaultValue { get; set; }
		...
		/// </summary>
		public PlotOptionsLinearregressionSonification Sonification { get; set; }
		private PlotOptionsLinearregressionSonification Sonification_DefaultValue { get; set; }
		 

		/// <summary>
		/// 
		/// </summary>
		public PlotOptionsLinearregressionStates States { get; set; }
		private PlotOptionsLinearregressionStates States_DefaultValue { get; set; }
		 

		/// <summary>
		/// Whether to apply steps to the line. Possible values are `left`,`center` and `right`.
		/// </summary>
		public PlotOptionsLinearregressionStep Step { get; set; }
		private PlotOptionsLinearregressionStep Step_DefaultValue { get; set; }
		...
		/// 
		/// </summary>
		public PlotOptionsLinearregressionTooltip Tooltip { get; set; }
		private PlotOptionsLinearregressionTooltip Tooltip_DefaultValue { get; set; }
		...
		/// </summary>
		public List<PlotOptionsLinearregressionZones> Zones { get; set; }
		private List<PlotOptionsLinearregressionZones> Zones_DefaultValue { get; set; }
