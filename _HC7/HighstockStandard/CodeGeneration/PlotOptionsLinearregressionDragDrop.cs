...
{
	public partial class PlotOptionsLinearregressionDragDrop  : BaseObject
	{
		public PlotOptionsLinearregressionDragDrop()
		{
			DraggableX = DraggableX_DefaultValue = null;
			DraggableY = DraggableY_DefaultValue = null;
			DragHandle = DragHandle_DefaultValue = new PlotOptionsLinearregressionDragDropDragHandle();
			...
			GuideBox = GuideBox_DefaultValue = new PlotOptionsLinearregressionDragDropGuideBox();
		...
		/// </summary>
		public PlotOptionsLinearregressionDragDropDragHandle DragHandle { get; set; }
		private PlotOptionsLinearregressionDragDropDragHandle DragHandle_DefaultValue { get; set; }
		...
		/// </summary>
		public PlotOptionsLinearregressionDragDropGuideBox GuideBox { get; set; }
		private PlotOptionsLinearregressionDragDropGuideBox GuideBox_DefaultValue { get; set; }
