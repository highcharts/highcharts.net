...
{
	public partial class PlotOptionsLinearregressionMarker  : BaseObject
	{
		Hashtable h = new Hashtable();

		public PlotOptionsLinearregressionMarker()
		{
			...
			States = States_DefaultValue = new PlotOptionsLinearregressionMarkerStates();
		...
		/// </summary>
		public PlotOptionsLinearregressionMarkerStates States { get; set; }
		private PlotOptionsLinearregressionMarkerStates States_DefaultValue { get; set; }
