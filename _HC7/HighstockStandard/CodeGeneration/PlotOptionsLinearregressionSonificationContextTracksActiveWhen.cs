...
{
	public partial class PlotOptionsLinearregressionSonificationContextTracksActiveWhen  : BaseObject
	{
		Hashtable h = new Hashtable();

		public PlotOptionsLinearregressionSonificationContextTracksActiveWhen()
		{
