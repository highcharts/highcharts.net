...
{
	public partial class PlotOptionsLinearregressionSonificationContextTracksPointGrouping  : BaseObject
	{
		Hashtable h = new Hashtable();

		public PlotOptionsLinearregressionSonificationContextTracksPointGrouping()
		{
			Algorithm = Algorithm_DefaultValue = PlotOptionsLinearregressionSonificationContextTracksPointGroupingAlgorithm.Minimax;
		...
		/// </summary>
		public PlotOptionsLinearregressionSonificationContextTracksPointGroupingAlgorithm Algorithm { get; set; }
		private PlotOptionsLinearregressionSonificationContextTracksPointGroupingAlgorithm Algorithm_DefaultValue { get; set; }
