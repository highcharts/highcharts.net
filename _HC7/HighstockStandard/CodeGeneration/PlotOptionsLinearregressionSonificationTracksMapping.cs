...
{
	public partial class PlotOptionsLinearregressionSonificationTracksMapping  : BaseObject
	{
		Hashtable h = new Hashtable();

		public PlotOptionsLinearregressionSonificationTracksMapping()
		{
			Frequency = Frequency_DefaultValue = new PlotOptionsLinearregressionSonificationTracksMappingFrequency();
			GapBetweenNotes = GapBetweenNotes_DefaultValue = new PlotOptionsLinearregressionSonificationTracksMappingGapBetweenNotes();
			Highpass = Highpass_DefaultValue = new PlotOptionsLinearregressionSonificationTracksMappingHighpass();
			Lowpass = Lowpass_DefaultValue = new PlotOptionsLinearregressionSonificationTracksMappingLowpass();
			NoteDuration = NoteDuration_DefaultValue = new PlotOptionsLinearregressionSonificationTracksMappingNoteDuration();
			Pan = Pan_DefaultValue = new PlotOptionsLinearregressionSonificationTracksMappingPan();
			Pitch = Pitch_DefaultValue = new PlotOptionsLinearregressionSonificationTracksMappingPitch();
			PitchString = PitchString_DefaultValue = "null";
			PitchNumber = PitchNumber_DefaultValue = null;
			PlayDelay = PlayDelay_DefaultValue = new PlotOptionsLinearregressionSonificationTracksMappingPlayDelay();
			Time = Time_DefaultValue = new PlotOptionsLinearregressionSonificationTracksMappingTime();
			TimeString = TimeString_DefaultValue = "null";
			TimeNumber = TimeNumber_DefaultValue = null;
			Tremolo = Tremolo_DefaultValue = new PlotOptionsLinearregressionSonificationTracksMappingTremolo();
			Volume = Volume_DefaultValue = new PlotOptionsLinearregressionSonificationTracksMappingVolume();
		...
		/// </summary>
		public PlotOptionsLinearregressionSonificationTracksMappingFrequency Frequency { get; set; }
		private PlotOptionsLinearregressionSonificationTracksMappingFrequency Frequency_DefaultValue { get; set; }
		...
		/// </summary>
		public PlotOptionsLinearregressionSonificationTracksMappingGapBetweenNotes GapBetweenNotes { get; set; }
		private PlotOptionsLinearregressionSonificationTracksMappingGapBetweenNotes GapBetweenNotes_DefaultValue { get; set; }
		...
		/// </summary>
		public PlotOptionsLinearregressionSonificationTracksMappingHighpass Highpass { get; set; }
		private PlotOptionsLinearregressionSonificationTracksMappingHighpass Highpass_DefaultValue { get; set; }
		...
		/// </summary>
		public PlotOptionsLinearregressionSonificationTracksMappingLowpass Lowpass { get; set; }
		private PlotOptionsLinearregressionSonificationTracksMappingLowpass Lowpass_DefaultValue { get; set; }
		...
		/// </summary>
		public PlotOptionsLinearregressionSonificationTracksMappingNoteDuration NoteDuration { get; set; }
		private PlotOptionsLinearregressionSonificationTracksMappingNoteDuration NoteDuration_DefaultValue { get; set; }
		...
		/// </summary>
		public PlotOptionsLinearregressionSonificationTracksMappingPan Pan { get; set; }
		private PlotOptionsLinearregressionSonificationTracksMappingPan Pan_DefaultValue { get; set; }
		...
		/// </summary>
		public PlotOptionsLinearregressionSonificationTracksMappingPitch Pitch { get; set; }
		private PlotOptionsLinearregressionSonificationTracksMappingPitch Pitch_DefaultValue { get; set; }
		...
		/// </summary>
		public PlotOptionsLinearregressionSonificationTracksMappingPlayDelay PlayDelay { get; set; }
		private PlotOptionsLinearregressionSonificationTracksMappingPlayDelay PlayDelay_DefaultValue { get; set; }
		...
		/// </summary>
		public PlotOptionsLinearregressionSonificationTracksMappingTime Time { get; set; }
		private PlotOptionsLinearregressionSonificationTracksMappingTime Time_DefaultValue { get; set; }
		...
		/// </summary>
		public PlotOptionsLinearregressionSonificationTracksMappingTremolo Tremolo { get; set; }
		private PlotOptionsLinearregressionSonificationTracksMappingTremolo Tremolo_DefaultValue { get; set; }
		 

		/// <summary>
		/// The volume of notes, from 0 to 1.
		/// </summary>
		public PlotOptionsLinearregressionSonificationTracksMappingVolume Volume { get; set; }
		private PlotOptionsLinearregressionSonificationTracksMappingVolume Volume_DefaultValue { get; set; }
