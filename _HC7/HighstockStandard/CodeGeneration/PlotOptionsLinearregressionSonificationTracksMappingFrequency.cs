...
{
	public partial class PlotOptionsLinearregressionSonificationTracksMappingFrequency  : BaseObject
	{
		Hashtable h = new Hashtable();

		public PlotOptionsLinearregressionSonificationTracksMappingFrequency()
		{
			MapFunction = MapFunction_DefaultValue = PlotOptionsLinearregressionSonificationTracksMappingFrequencyMapFunction.Linear;
			MapTo = MapTo_DefaultValue = "";
			Max = Max_DefaultValue = null;
			Min = Min_DefaultValue = null;
			Value = Value_DefaultValue = null;
			Within = Within_DefaultValue = PlotOptionsLinearregressionSonificationTracksMappingFrequencyWithin.Chart;
		...
		/// </summary>
		public PlotOptionsLinearregressionSonificationTracksMappingFrequencyMapFunction MapFunction { get; set; }
		private PlotOptionsLinearregressionSonificationTracksMappingFrequencyMapFunction MapFunction_DefaultValue { get; set; }
		...
		/// </summary>
		public PlotOptionsLinearregressionSonificationTracksMappingFrequencyWithin Within { get; set; }
		private PlotOptionsLinearregressionSonificationTracksMappingFrequencyWithin Within_DefaultValue { get; set; }
