...
{
	public partial class PlotOptionsLinearregressionSonificationTracksMappingPitch  : BaseObject
	{
		Hashtable h = new Hashtable();

		public PlotOptionsLinearregressionSonificationTracksMappingPitch()
		{
			MapFunction = MapFunction_DefaultValue = PlotOptionsLinearregressionSonificationTracksMappingPitchMapFunction.Linear;
		...
		/// </summary>
		public PlotOptionsLinearregressionSonificationTracksMappingPitchMapFunction MapFunction { get; set; }
		private PlotOptionsLinearregressionSonificationTracksMappingPitchMapFunction MapFunction_DefaultValue { get; set; }
