...
{
	public partial class PlotOptionsLinearregressionSonificationTracksMappingVolume  : BaseObject
	{
		Hashtable h = new Hashtable();

		public PlotOptionsLinearregressionSonificationTracksMappingVolume()
		{
			MapFunction = MapFunction_DefaultValue = PlotOptionsLinearregressionSonificationTracksMappingVolumeMapFunction.Linear;
			MapTo = MapTo_DefaultValue = "";
			Max = Max_DefaultValue = null;
			Min = Min_DefaultValue = null;
			Value = Value_DefaultValue = null;
			Within = Within_DefaultValue = PlotOptionsLinearregressionSonificationTracksMappingVolumeWithin.Chart;
		...
		/// </summary>
		public PlotOptionsLinearregressionSonificationTracksMappingVolumeMapFunction MapFunction { get; set; }
		private PlotOptionsLinearregressionSonificationTracksMappingVolumeMapFunction MapFunction_DefaultValue { get; set; }
		...
		/// </summary>
		public PlotOptionsLinearregressionSonificationTracksMappingVolumeWithin Within { get; set; }
		private PlotOptionsLinearregressionSonificationTracksMappingVolumeWithin Within_DefaultValue { get; set; }
