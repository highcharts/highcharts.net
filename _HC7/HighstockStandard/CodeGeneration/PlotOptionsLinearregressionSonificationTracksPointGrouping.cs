...
{
	public partial class PlotOptionsLinearregressionSonificationTracksPointGrouping  : BaseObject
	{
		Hashtable h = new Hashtable();

		public PlotOptionsLinearregressionSonificationTracksPointGrouping()
		{
			Algorithm = Algorithm_DefaultValue = PlotOptionsLinearregressionSonificationTracksPointGroupingAlgorithm.Minimax;
		...
		/// </summary>
		public PlotOptionsLinearregressionSonificationTracksPointGroupingAlgorithm Algorithm { get; set; }
		private PlotOptionsLinearregressionSonificationTracksPointGroupingAlgorithm Algorithm_DefaultValue { get; set; }
