...
{
	public partial class PlotOptionsLinearregressionangle  : BaseObject
	{
		Hashtable h = new Hashtable();

		public PlotOptionsLinearregressionangle()
		{
			Accessibility = Accessibility_DefaultValue = new PlotOptionsLinearregressionangleAccessibility();
			AllowPointSelect = AllowPointSelect_DefaultValue = false;
			Animation = Animation_DefaultValue = new Animation() { Enabled = true };
			AnimationBool = AnimationBool_DefaultValue = true;
			AnimationLimit = AnimationLimit_DefaultValue = null;
			BoostBlending = BoostBlending_DefaultValue = PlotOptionsLinearregressionangleBoostBlending.Undefined;
			...
			Compare = Compare_DefaultValue = PlotOptionsLinearregressionangleCompare.Percent;
			CompareBase = CompareBase_DefaultValue = PlotOptionsLinearregressionangleCompareBase.Min;
			...
			Cursor = Cursor_DefaultValue = PlotOptionsLinearregressionangleCursor.Null;
			Custom = Custom_DefaultValue = new Hashtable();
			DashStyle = DashStyle_DefaultValue = PlotOptionsLinearregressionangleDashStyle.Null;
			DataGrouping = DataGrouping_DefaultValue = new PlotOptionsLinearregressionangleDataGrouping();
			DataLabels = DataLabels_DefaultValue = new PlotOptionsLinearregressionangleDataLabels();
			DataSorting = DataSorting_DefaultValue = new PlotOptionsLinearregressionangleDataSorting();
			Description = Description_DefaultValue = "";
			EnableMouseTracking = EnableMouseTracking_DefaultValue = true;
			Events = Events_DefaultValue = new PlotOptionsLinearregressionangleEvents();
			FindNearestPointBy = FindNearestPointBy_DefaultValue = PlotOptionsLinearregressionangleFindNearestPointBy.X;
			GapSize = GapSize_DefaultValue = 0;
			GapUnit = GapUnit_DefaultValue = PlotOptionsLinearregressionangleGapUnit.Relative;
			GetExtremesFromAll = GetExtremesFromAll_DefaultValue = false;
			InactiveOtherPoints = InactiveOtherPoints_DefaultValue = false;
			IncludeInDataExport = IncludeInDataExport_DefaultValue = null;
			Label = Label_DefaultValue = new PlotOptionsLinearregressionangleLabel();
			LastPrice = LastPrice_DefaultValue = new PlotOptionsLinearregressionangleLastPrice();
			LastVisiblePrice = LastVisiblePrice_DefaultValue = new PlotOptionsLinearregressionangleLastVisiblePrice();
			LegendSymbol = LegendSymbol_DefaultValue = PlotOptionsLinearregressionangleLegendSymbol.Rectangle;
			Linecap = Linecap_DefaultValue = PlotOptionsLinearregressionangleLinecap.Round;
			LineWidth = LineWidth_DefaultValue = 2;
			LinkedTo = LinkedTo_DefaultValue = "";
			Marker = Marker_DefaultValue = new PlotOptionsLinearregressionangleMarker();
			NegativeColor = NegativeColor_DefaultValue = "";
			OnPoint = OnPoint_DefaultValue = new PlotOptionsLinearregressionangleOnPoint();
			Opacity = Opacity_DefaultValue = 1;
			Params = Params_DefaultValue = new PlotOptionsLinearregressionangleParams();
			Point = Point_DefaultValue = new PlotOptionsLinearregressionanglePoint();
			...
			Sonification = Sonification_DefaultValue = new PlotOptionsLinearregressionangleSonification();
			States = States_DefaultValue = new PlotOptionsLinearregressionangleStates();
			Step = Step_DefaultValue = PlotOptionsLinearregressionangleStep.Null;
			StickyTracking = StickyTracking_DefaultValue = true;
			Threshold = Threshold_DefaultValue = 0;
			Tooltip = Tooltip_DefaultValue = new PlotOptionsLinearregressionangleTooltip();
			TurboThreshold = TurboThreshold_DefaultValue = 1000;
			Visible = Visible_DefaultValue = true;
			ZoneAxis = ZoneAxis_DefaultValue = "y";
			Zones = Zones_DefaultValue = new List<PlotOptionsLinearregressionangleZones>();
		...
		/// </summary>
		public PlotOptionsLinearregressionangleAccessibility Accessibility { get; set; }
		private PlotOptionsLinearregressionangleAccessibility Accessibility_DefaultValue { get; set; }
		...
		/// </summary>
		public PlotOptionsLinearregressionangleBoostBlending BoostBlending { get; set; }
		private PlotOptionsLinearregressionangleBoostBlending BoostBlending_DefaultValue { get; set; }
		...
		/// </summary>
		public PlotOptionsLinearregressionangleCompare Compare { get; set; }
		private PlotOptionsLinearregressionangleCompare Compare_DefaultValue { get; set; }
		 

		/// <summary>
		/// When [compare](#plotOptions.series.compare) is `percent`, this optiondictates whether to use 0 or 100 as the base of comparison.
		/// </summary>
		public PlotOptionsLinearregressionangleCompareBase CompareBase { get; set; }
		private PlotOptionsLinearregressionangleCompareBase CompareBase_DefaultValue { get; set; }
		...
		/// </summary>
		public PlotOptionsLinearregressionangleCursor Cursor { get; set; }
		private PlotOptionsLinearregressionangleCursor Cursor_DefaultValue { get; set; }
		...
		/// </summary>
		public PlotOptionsLinearregressionangleDashStyle DashStyle { get; set; }
		private PlotOptionsLinearregressionangleDashStyle DashStyle_DefaultValue { get; set; }
		...
		/// </summary>
		public PlotOptionsLinearregressionangleDataGrouping DataGrouping { get; set; }
		private PlotOptionsLinearregressionangleDataGrouping DataGrouping_DefaultValue { get; set; }
		...
		/// </summary>
		public PlotOptionsLinearregressionangleDataLabels DataLabels { get; set; }
		private PlotOptionsLinearregressionangleDataLabels DataLabels_DefaultValue { get; set; }
		 

		/// <summary>
		/// Options for the series data sorting.
		/// </summary>
		public PlotOptionsLinearregressionangleDataSorting DataSorting { get; set; }
		private PlotOptionsLinearregressionangleDataSorting DataSorting_DefaultValue { get; set; }
		...
		/// </summary>
		public PlotOptionsLinearregressionangleEvents Events { get; set; }
		private PlotOptionsLinearregressionangleEvents Events_DefaultValue { get; set; }
		...
		/// </summary>
		public PlotOptionsLinearregressionangleFindNearestPointBy FindNearestPointBy { get; set; }
		private PlotOptionsLinearregressionangleFindNearestPointBy FindNearestPointBy_DefaultValue { get; set; }
		...
		/// </summary>
		public PlotOptionsLinearregressionangleGapUnit GapUnit { get; set; }
		private PlotOptionsLinearregressionangleGapUnit GapUnit_DefaultValue { get; set; }
		...
		/// </summary>
		public PlotOptionsLinearregressionangleLabel Label { get; set; }
		private PlotOptionsLinearregressionangleLabel Label_DefaultValue { get; set; }
		 

		/// <summary>
		/// The line marks the last price from all points.
		/// </summary>
		public PlotOptionsLinearregressionangleLastPrice LastPrice { get; set; }
		private PlotOptionsLinearregressionangleLastPrice LastPrice_DefaultValue { get; set; }
		 

		/// <summary>
		/// The line marks the last price from visible range of points.
		/// </summary>
		public PlotOptionsLinearregressionangleLastVisiblePrice LastVisiblePrice { get; set; }
		private PlotOptionsLinearregressionangleLastVisiblePrice LastVisiblePrice_DefaultValue { get; set; }
		 

		/// <summary>
		/// What type of legend symbol to render for this series. Can be one of`lineMarker` or `rectangle`.
		/// </summary>
		public PlotOptionsLinearregressionangleLegendSymbol LegendSymbol { get; set; }
		private PlotOptionsLinearregressionangleLegendSymbol LegendSymbol_DefaultValue { get; set; }
		 

		/// <summary>
		/// The line cap used for line ends and line joins on the graph.
		/// </summary>
		public PlotOptionsLinearregressionangleLinecap Linecap { get; set; }
		private PlotOptionsLinearregressionangleLinecap Linecap_DefaultValue { get; set; }
		...
		/// </summary>
		public PlotOptionsLinearregressionangleMarker Marker { get; set; }
		private PlotOptionsLinearregressionangleMarker Marker_DefaultValue { get; set; }
		...
		/// </summary>
		public PlotOptionsLinearregressionangleOnPoint OnPoint { get; set; }
		private PlotOptionsLinearregressionangleOnPoint OnPoint_DefaultValue { get; set; }
		...
		/// </summary>
		public PlotOptionsLinearregressionangleParams Params { get; set; }
		private PlotOptionsLinearregressionangleParams Params_DefaultValue { get; set; }
		 

		/// <summary>
		/// Properties for each single point.
		/// </summary>
		public PlotOptionsLinearregressionanglePoint Point { get; set; }
		private PlotOptionsLinearregressionanglePoint Point_DefaultValue { get; set; }
		...
		/// </summary>
		public PlotOptionsLinearregressionangleSonification Sonification { get; set; }
		private PlotOptionsLinearregressionangleSonification Sonification_DefaultValue { get; set; }
		 

		/// <summary>
		/// 
		/// </summary>
		public PlotOptionsLinearregressionangleStates States { get; set; }
		private PlotOptionsLinearregressionangleStates States_DefaultValue { get; set; }
		 

		/// <summary>
		/// Whether to apply steps to the line. Possible values are `left`,`center` and `right`.
		/// </summary>
		public PlotOptionsLinearregressionangleStep Step { get; set; }
		private PlotOptionsLinearregressionangleStep Step_DefaultValue { get; set; }
		...
		/// 
		/// </summary>
		public PlotOptionsLinearregressionangleTooltip Tooltip { get; set; }
		private PlotOptionsLinearregressionangleTooltip Tooltip_DefaultValue { get; set; }
		...
		/// </summary>
		public List<PlotOptionsLinearregressionangleZones> Zones { get; set; }
		private List<PlotOptionsLinearregressionangleZones> Zones_DefaultValue { get; set; }
