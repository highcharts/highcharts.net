...
namespace Highsoft.Web.Mvc.Stocks
{
	public partial class PlotOptionsLinearregressionangle  : BaseObject
	{
		...
		public PlotOptionsLinearregressionangle()
		{
			...
			Zones = Zones_DefaultValue = new List<PlotOptionsLinearregressionangleZone>();
		...
		/// </summary>
		public List<PlotOptionsLinearregressionangleZone> Zones { get; set; }
		private List<PlotOptionsLinearregressionangleZone> Zones_DefaultValue { get; set; }
