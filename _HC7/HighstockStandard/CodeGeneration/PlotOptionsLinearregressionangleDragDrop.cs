...
{
	public partial class PlotOptionsLinearregressionangleDragDrop  : BaseObject
	{
		public PlotOptionsLinearregressionangleDragDrop()
		{
			DraggableX = DraggableX_DefaultValue = null;
			DraggableY = DraggableY_DefaultValue = null;
			DragHandle = DragHandle_DefaultValue = new PlotOptionsLinearregressionangleDragDropDragHandle();
			...
			GuideBox = GuideBox_DefaultValue = new PlotOptionsLinearregressionangleDragDropGuideBox();
		...
		/// </summary>
		public PlotOptionsLinearregressionangleDragDropDragHandle DragHandle { get; set; }
		private PlotOptionsLinearregressionangleDragDropDragHandle DragHandle_DefaultValue { get; set; }
		...
		/// </summary>
		public PlotOptionsLinearregressionangleDragDropGuideBox GuideBox { get; set; }
		private PlotOptionsLinearregressionangleDragDropGuideBox GuideBox_DefaultValue { get; set; }
