...
{
	public partial class PlotOptionsLinearregressionangleSonificationContextTracksActiveWhen  : BaseObject
	{
		Hashtable h = new Hashtable();

		public PlotOptionsLinearregressionangleSonificationContextTracksActiveWhen()
		{
