...
{
	public partial class PlotOptionsLinearregressionangleSonificationContextTracksMappingHighpassFrequency  : BaseObject
	{
		Hashtable h = new Hashtable();

		public PlotOptionsLinearregressionangleSonificationContextTracksMappingHighpassFrequency()
		{
			MapFunction = MapFunction_DefaultValue = PlotOptionsLinearregressionangleSonificationContextTracksMappingHighpassFrequencyMapFunction.Linear;
			MapTo = MapTo_DefaultValue = "";
			Max = Max_DefaultValue = null;
			Min = Min_DefaultValue = null;
			Value = Value_DefaultValue = null;
			Within = Within_DefaultValue = PlotOptionsLinearregressionangleSonificationContextTracksMappingHighpassFrequencyWithin.Chart;
		...
		/// </summary>
		public PlotOptionsLinearregressionangleSonificationContextTracksMappingHighpassFrequencyMapFunction MapFunction { get; set; }
		private PlotOptionsLinearregressionangleSonificationContextTracksMappingHighpassFrequencyMapFunction MapFunction_DefaultValue { get; set; }
		...
		/// </summary>
		public PlotOptionsLinearregressionangleSonificationContextTracksMappingHighpassFrequencyWithin Within { get; set; }
		private PlotOptionsLinearregressionangleSonificationContextTracksMappingHighpassFrequencyWithin Within_DefaultValue { get; set; }
