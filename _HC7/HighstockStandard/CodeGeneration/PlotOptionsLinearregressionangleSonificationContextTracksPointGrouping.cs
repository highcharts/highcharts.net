...
{
	public partial class PlotOptionsLinearregressionangleSonificationContextTracksPointGrouping  : BaseObject
	{
		Hashtable h = new Hashtable();

		public PlotOptionsLinearregressionangleSonificationContextTracksPointGrouping()
		{
			Algorithm = Algorithm_DefaultValue = PlotOptionsLinearregressionangleSonificationContextTracksPointGroupingAlgorithm.Minimax;
		...
		/// </summary>
		public PlotOptionsLinearregressionangleSonificationContextTracksPointGroupingAlgorithm Algorithm { get; set; }
		private PlotOptionsLinearregressionangleSonificationContextTracksPointGroupingAlgorithm Algorithm_DefaultValue { get; set; }
