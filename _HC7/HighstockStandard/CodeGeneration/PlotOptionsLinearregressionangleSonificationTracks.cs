...
{
	public partial class PlotOptionsLinearregressionangleSonificationTracks  : BaseObject
	{
		Hashtable h = new Hashtable();

		public PlotOptionsLinearregressionangleSonificationTracks()
		{
			ActiveWhen = ActiveWhen_DefaultValue = new PlotOptionsLinearregressionangleSonificationTracksActiveWhen();
			Instrument = Instrument_DefaultValue = null;
			InstrumentString = InstrumentString_DefaultValue = "null";
			Mapping = Mapping_DefaultValue = new PlotOptionsLinearregressionangleSonificationTracksMapping();
			MidiName = MidiName_DefaultValue = "";
			PointGrouping = PointGrouping_DefaultValue = new PlotOptionsLinearregressionangleSonificationTracksPointGrouping();
			RoundToMusicalNotes = RoundToMusicalNotes_DefaultValue = true;
			ShowPlayMarker = ShowPlayMarker_DefaultValue = true;
			Type = Type_DefaultValue = PlotOptionsLinearregressionangleSonificationTracksType.Instrument;
		...
		/// </summary>
		public PlotOptionsLinearregressionangleSonificationTracksActiveWhen ActiveWhen { get; set; }
		private PlotOptionsLinearregressionangleSonificationTracksActiveWhen ActiveWhen_DefaultValue { get; set; }
		...
		/// </summary>
		public PlotOptionsLinearregressionangleSonificationTracksMapping Mapping { get; set; }
		private PlotOptionsLinearregressionangleSonificationTracksMapping Mapping_DefaultValue { get; set; }
		...
		/// </summary>
		public PlotOptionsLinearregressionangleSonificationTracksPointGrouping PointGrouping { get; set; }
		private PlotOptionsLinearregressionangleSonificationTracksPointGrouping PointGrouping_DefaultValue { get; set; }
		...
		/// </summary>
		public PlotOptionsLinearregressionangleSonificationTracksType Type { get; set; }
		private PlotOptionsLinearregressionangleSonificationTracksType Type_DefaultValue { get; set; }
