...
{
	public partial class PlotOptionsLinearregressionangleSonificationTracksMapping  : BaseObject
	{
		Hashtable h = new Hashtable();

		public PlotOptionsLinearregressionangleSonificationTracksMapping()
		{
			Frequency = Frequency_DefaultValue = new PlotOptionsLinearregressionangleSonificationTracksMappingFrequency();
			GapBetweenNotes = GapBetweenNotes_DefaultValue = new PlotOptionsLinearregressionangleSonificationTracksMappingGapBetweenNotes();
			Highpass = Highpass_DefaultValue = new PlotOptionsLinearregressionangleSonificationTracksMappingHighpass();
			Lowpass = Lowpass_DefaultValue = new PlotOptionsLinearregressionangleSonificationTracksMappingLowpass();
			NoteDuration = NoteDuration_DefaultValue = new PlotOptionsLinearregressionangleSonificationTracksMappingNoteDuration();
			Pan = Pan_DefaultValue = new PlotOptionsLinearregressionangleSonificationTracksMappingPan();
			Pitch = Pitch_DefaultValue = new PlotOptionsLinearregressionangleSonificationTracksMappingPitch();
			PitchString = PitchString_DefaultValue = "null";
			PitchNumber = PitchNumber_DefaultValue = null;
			PlayDelay = PlayDelay_DefaultValue = new PlotOptionsLinearregressionangleSonificationTracksMappingPlayDelay();
			Time = Time_DefaultValue = new PlotOptionsLinearregressionangleSonificationTracksMappingTime();
			TimeString = TimeString_DefaultValue = "null";
			TimeNumber = TimeNumber_DefaultValue = null;
			Tremolo = Tremolo_DefaultValue = new PlotOptionsLinearregressionangleSonificationTracksMappingTremolo();
			Volume = Volume_DefaultValue = new PlotOptionsLinearregressionangleSonificationTracksMappingVolume();
		...
		/// </summary>
		public PlotOptionsLinearregressionangleSonificationTracksMappingFrequency Frequency { get; set; }
		private PlotOptionsLinearregressionangleSonificationTracksMappingFrequency Frequency_DefaultValue { get; set; }
		...
		/// </summary>
		public PlotOptionsLinearregressionangleSonificationTracksMappingGapBetweenNotes GapBetweenNotes { get; set; }
		private PlotOptionsLinearregressionangleSonificationTracksMappingGapBetweenNotes GapBetweenNotes_DefaultValue { get; set; }
		...
		/// </summary>
		public PlotOptionsLinearregressionangleSonificationTracksMappingHighpass Highpass { get; set; }
		private PlotOptionsLinearregressionangleSonificationTracksMappingHighpass Highpass_DefaultValue { get; set; }
		...
		/// </summary>
		public PlotOptionsLinearregressionangleSonificationTracksMappingLowpass Lowpass { get; set; }
		private PlotOptionsLinearregressionangleSonificationTracksMappingLowpass Lowpass_DefaultValue { get; set; }
		...
		/// </summary>
		public PlotOptionsLinearregressionangleSonificationTracksMappingNoteDuration NoteDuration { get; set; }
		private PlotOptionsLinearregressionangleSonificationTracksMappingNoteDuration NoteDuration_DefaultValue { get; set; }
		...
		/// </summary>
		public PlotOptionsLinearregressionangleSonificationTracksMappingPan Pan { get; set; }
		private PlotOptionsLinearregressionangleSonificationTracksMappingPan Pan_DefaultValue { get; set; }
		...
		/// </summary>
		public PlotOptionsLinearregressionangleSonificationTracksMappingPitch Pitch { get; set; }
		private PlotOptionsLinearregressionangleSonificationTracksMappingPitch Pitch_DefaultValue { get; set; }
		...
		/// </summary>
		public PlotOptionsLinearregressionangleSonificationTracksMappingPlayDelay PlayDelay { get; set; }
		private PlotOptionsLinearregressionangleSonificationTracksMappingPlayDelay PlayDelay_DefaultValue { get; set; }
		...
		/// </summary>
		public PlotOptionsLinearregressionangleSonificationTracksMappingTime Time { get; set; }
		private PlotOptionsLinearregressionangleSonificationTracksMappingTime Time_DefaultValue { get; set; }
		...
		/// </summary>
		public PlotOptionsLinearregressionangleSonificationTracksMappingTremolo Tremolo { get; set; }
		private PlotOptionsLinearregressionangleSonificationTracksMappingTremolo Tremolo_DefaultValue { get; set; }
		 

		/// <summary>
		/// The volume of notes, from 0 to 1.
		/// </summary>
		public PlotOptionsLinearregressionangleSonificationTracksMappingVolume Volume { get; set; }
		private PlotOptionsLinearregressionangleSonificationTracksMappingVolume Volume_DefaultValue { get; set; }
