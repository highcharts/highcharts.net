...
namespace Highsoft.Web.Mvc.Stocks
{
	public partial class PlotOptionsLinearregressionangleSonificationTracksPointGrouping  : BaseObject
	{
		...
		{
			if (Algorithm != PlotOptionsLinearregressionangleSonificationTracksPointGroupingAlgorithm.Null) h.Add("algorithm", highstock.FirstCharacterToLower(Algorithm.ToString()));
