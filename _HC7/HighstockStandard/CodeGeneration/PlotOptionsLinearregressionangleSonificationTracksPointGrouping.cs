...
{
	public partial class PlotOptionsLinearregressionangleSonificationTracksPointGrouping  : BaseObject
	{
		Hashtable h = new Hashtable();

		public PlotOptionsLinearregressionangleSonificationTracksPointGrouping()
		{
			Algorithm = Algorithm_DefaultValue = PlotOptionsLinearregressionangleSonificationTracksPointGroupingAlgorithm.Minimax;
		...
		/// </summary>
		public PlotOptionsLinearregressionangleSonificationTracksPointGroupingAlgorithm Algorithm { get; set; }
		private PlotOptionsLinearregressionangleSonificationTracksPointGroupingAlgorithm Algorithm_DefaultValue { get; set; }
