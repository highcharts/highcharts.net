...
{
	public partial class PlotOptionsLinearregressionintercept  : BaseObject
	{
		Hashtable h = new Hashtable();

		public PlotOptionsLinearregressionintercept()
		{
			Accessibility = Accessibility_DefaultValue = new PlotOptionsLinearregressioninterceptAccessibility();
			AllowPointSelect = AllowPointSelect_DefaultValue = false;
			Animation = Animation_DefaultValue = new Animation() { Enabled = true };
			AnimationBool = AnimationBool_DefaultValue = true;
			AnimationLimit = AnimationLimit_DefaultValue = null;
			BoostBlending = BoostBlending_DefaultValue = PlotOptionsLinearregressioninterceptBoostBlending.Undefined;
			...
			Compare = Compare_DefaultValue = PlotOptionsLinearregressioninterceptCompare.Percent;
			CompareBase = CompareBase_DefaultValue = PlotOptionsLinearregressioninterceptCompareBase.Min;
			...
			Cursor = Cursor_DefaultValue = PlotOptionsLinearregressioninterceptCursor.Null;
			Custom = Custom_DefaultValue = new Hashtable();
			DashStyle = DashStyle_DefaultValue = PlotOptionsLinearregressioninterceptDashStyle.Null;
			DataGrouping = DataGrouping_DefaultValue = new PlotOptionsLinearregressioninterceptDataGrouping();
			DataLabels = DataLabels_DefaultValue = new PlotOptionsLinearregressioninterceptDataLabels();
			DataSorting = DataSorting_DefaultValue = new PlotOptionsLinearregressioninterceptDataSorting();
			Description = Description_DefaultValue = "";
			EnableMouseTracking = EnableMouseTracking_DefaultValue = true;
			Events = Events_DefaultValue = new PlotOptionsLinearregressioninterceptEvents();
			FindNearestPointBy = FindNearestPointBy_DefaultValue = PlotOptionsLinearregressioninterceptFindNearestPointBy.X;
			GapSize = GapSize_DefaultValue = 0;
			GapUnit = GapUnit_DefaultValue = PlotOptionsLinearregressioninterceptGapUnit.Relative;
			GetExtremesFromAll = GetExtremesFromAll_DefaultValue = false;
			InactiveOtherPoints = InactiveOtherPoints_DefaultValue = false;
			IncludeInDataExport = IncludeInDataExport_DefaultValue = null;
			Label = Label_DefaultValue = new PlotOptionsLinearregressioninterceptLabel();
			LastPrice = LastPrice_DefaultValue = new PlotOptionsLinearregressioninterceptLastPrice();
			LastVisiblePrice = LastVisiblePrice_DefaultValue = new PlotOptionsLinearregressioninterceptLastVisiblePrice();
			LegendSymbol = LegendSymbol_DefaultValue = PlotOptionsLinearregressioninterceptLegendSymbol.Rectangle;
			Linecap = Linecap_DefaultValue = PlotOptionsLinearregressioninterceptLinecap.Round;
			LineWidth = LineWidth_DefaultValue = 2;
			LinkedTo = LinkedTo_DefaultValue = "";
			Marker = Marker_DefaultValue = new PlotOptionsLinearregressioninterceptMarker();
			NegativeColor = NegativeColor_DefaultValue = "";
			OnPoint = OnPoint_DefaultValue = new PlotOptionsLinearregressioninterceptOnPoint();
			Opacity = Opacity_DefaultValue = 1;
			Params = Params_DefaultValue = new PlotOptionsLinearregressioninterceptParams();
			Point = Point_DefaultValue = new PlotOptionsLinearregressioninterceptPoint();
			...
			Sonification = Sonification_DefaultValue = new PlotOptionsLinearregressioninterceptSonification();
			States = States_DefaultValue = new PlotOptionsLinearregressioninterceptStates();
			Step = Step_DefaultValue = PlotOptionsLinearregressioninterceptStep.Null;
			StickyTracking = StickyTracking_DefaultValue = true;
			Threshold = Threshold_DefaultValue = 0;
			Tooltip = Tooltip_DefaultValue = new PlotOptionsLinearregressioninterceptTooltip();
			TurboThreshold = TurboThreshold_DefaultValue = 1000;
			Visible = Visible_DefaultValue = true;
			ZoneAxis = ZoneAxis_DefaultValue = "y";
			Zones = Zones_DefaultValue = new List<PlotOptionsLinearregressioninterceptZones>();
		...
		/// </summary>
		public PlotOptionsLinearregressioninterceptAccessibility Accessibility { get; set; }
		private PlotOptionsLinearregressioninterceptAccessibility Accessibility_DefaultValue { get; set; }
		...
		/// </summary>
		public PlotOptionsLinearregressioninterceptBoostBlending BoostBlending { get; set; }
		private PlotOptionsLinearregressioninterceptBoostBlending BoostBlending_DefaultValue { get; set; }
		...
		/// </summary>
		public PlotOptionsLinearregressioninterceptCompare Compare { get; set; }
		private PlotOptionsLinearregressioninterceptCompare Compare_DefaultValue { get; set; }
		 

		/// <summary>
		/// When [compare](#plotOptions.series.compare) is `percent`, this optiondictates whether to use 0 or 100 as the base of comparison.
		/// </summary>
		public PlotOptionsLinearregressioninterceptCompareBase CompareBase { get; set; }
		private PlotOptionsLinearregressioninterceptCompareBase CompareBase_DefaultValue { get; set; }
		...
		/// </summary>
		public PlotOptionsLinearregressioninterceptCursor Cursor { get; set; }
		private PlotOptionsLinearregressioninterceptCursor Cursor_DefaultValue { get; set; }
		...
		/// </summary>
		public PlotOptionsLinearregressioninterceptDashStyle DashStyle { get; set; }
		private PlotOptionsLinearregressioninterceptDashStyle DashStyle_DefaultValue { get; set; }
		...
		/// </summary>
		public PlotOptionsLinearregressioninterceptDataGrouping DataGrouping { get; set; }
		private PlotOptionsLinearregressioninterceptDataGrouping DataGrouping_DefaultValue { get; set; }
		...
		/// </summary>
		public PlotOptionsLinearregressioninterceptDataLabels DataLabels { get; set; }
		private PlotOptionsLinearregressioninterceptDataLabels DataLabels_DefaultValue { get; set; }
		 

		/// <summary>
		/// Options for the series data sorting.
		/// </summary>
		public PlotOptionsLinearregressioninterceptDataSorting DataSorting { get; set; }
		private PlotOptionsLinearregressioninterceptDataSorting DataSorting_DefaultValue { get; set; }
		...
		/// </summary>
		public PlotOptionsLinearregressioninterceptEvents Events { get; set; }
		private PlotOptionsLinearregressioninterceptEvents Events_DefaultValue { get; set; }
		...
		/// </summary>
		public PlotOptionsLinearregressioninterceptFindNearestPointBy FindNearestPointBy { get; set; }
		private PlotOptionsLinearregressioninterceptFindNearestPointBy FindNearestPointBy_DefaultValue { get; set; }
		...
		/// </summary>
		public PlotOptionsLinearregressioninterceptGapUnit GapUnit { get; set; }
		private PlotOptionsLinearregressioninterceptGapUnit GapUnit_DefaultValue { get; set; }
		...
		/// </summary>
		public PlotOptionsLinearregressioninterceptLabel Label { get; set; }
		private PlotOptionsLinearregressioninterceptLabel Label_DefaultValue { get; set; }
		 

		/// <summary>
		/// The line marks the last price from all points.
		/// </summary>
		public PlotOptionsLinearregressioninterceptLastPrice LastPrice { get; set; }
		private PlotOptionsLinearregressioninterceptLastPrice LastPrice_DefaultValue { get; set; }
		 

		/// <summary>
		/// The line marks the last price from visible range of points.
		/// </summary>
		public PlotOptionsLinearregressioninterceptLastVisiblePrice LastVisiblePrice { get; set; }
		private PlotOptionsLinearregressioninterceptLastVisiblePrice LastVisiblePrice_DefaultValue { get; set; }
		 

		/// <summary>
		/// What type of legend symbol to render for this series. Can be one of`lineMarker` or `rectangle`.
		/// </summary>
		public PlotOptionsLinearregressioninterceptLegendSymbol LegendSymbol { get; set; }
		private PlotOptionsLinearregressioninterceptLegendSymbol LegendSymbol_DefaultValue { get; set; }
		 

		/// <summary>
		/// The line cap used for line ends and line joins on the graph.
		/// </summary>
		public PlotOptionsLinearregressioninterceptLinecap Linecap { get; set; }
		private PlotOptionsLinearregressioninterceptLinecap Linecap_DefaultValue { get; set; }
		...
		/// </summary>
		public PlotOptionsLinearregressioninterceptMarker Marker { get; set; }
		private PlotOptionsLinearregressioninterceptMarker Marker_DefaultValue { get; set; }
		...
		/// </summary>
		public PlotOptionsLinearregressioninterceptOnPoint OnPoint { get; set; }
		private PlotOptionsLinearregressioninterceptOnPoint OnPoint_DefaultValue { get; set; }
		...
		/// </summary>
		public PlotOptionsLinearregressioninterceptPoint Point { get; set; }
		private PlotOptionsLinearregressioninterceptPoint Point_DefaultValue { get; set; }
		...
		/// </summary>
		public PlotOptionsLinearregressioninterceptSonification Sonification { get; set; }
		private PlotOptionsLinearregressioninterceptSonification Sonification_DefaultValue { get; set; }
		 

		/// <summary>
		/// 
		/// </summary>
		public PlotOptionsLinearregressioninterceptStates States { get; set; }
		private PlotOptionsLinearregressioninterceptStates States_DefaultValue { get; set; }
		 

		/// <summary>
		/// Whether to apply steps to the line. Possible values are `left`,`center` and `right`.
		/// </summary>
		public PlotOptionsLinearregressioninterceptStep Step { get; set; }
		private PlotOptionsLinearregressioninterceptStep Step_DefaultValue { get; set; }
		...
		/// </summary>
		public PlotOptionsLinearregressioninterceptTooltip Tooltip { get; set; }
		private PlotOptionsLinearregressioninterceptTooltip Tooltip_DefaultValue { get; set; }
		...
		/// </summary>
		public List<PlotOptionsLinearregressioninterceptZones> Zones { get; set; }
		private List<PlotOptionsLinearregressioninterceptZones> Zones_DefaultValue { get; set; }
