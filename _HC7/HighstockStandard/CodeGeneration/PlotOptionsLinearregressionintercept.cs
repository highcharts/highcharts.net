...
namespace Highsoft.Web.Mvc.Stocks
{
	public partial class PlotOptionsLinearregressionintercept  : BaseObject
	{
		...
		public PlotOptionsLinearregressionintercept()
		{
			...
			Zones = Zones_DefaultValue = new List<PlotOptionsLinearregressioninterceptZone>();
		...
		/// </summary>
		public List<PlotOptionsLinearregressioninterceptZone> Zones { get; set; }
		private List<PlotOptionsLinearregressioninterceptZone> Zones_DefaultValue { get; set; }
