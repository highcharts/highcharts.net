...
{
	public partial class PlotOptionsLinearregressioninterceptDragDrop  : BaseObject
	{
		public PlotOptionsLinearregressioninterceptDragDrop()
		{
			DraggableX = DraggableX_DefaultValue = null;
			DraggableY = DraggableY_DefaultValue = null;
			DragHandle = DragHandle_DefaultValue = new PlotOptionsLinearregressioninterceptDragDropDragHandle();
			...
			GuideBox = GuideBox_DefaultValue = new PlotOptionsLinearregressioninterceptDragDropGuideBox();
		...
		/// </summary>
		public PlotOptionsLinearregressioninterceptDragDropDragHandle DragHandle { get; set; }
		private PlotOptionsLinearregressioninterceptDragDropDragHandle DragHandle_DefaultValue { get; set; }
		...
		/// </summary>
		public PlotOptionsLinearregressioninterceptDragDropGuideBox GuideBox { get; set; }
		private PlotOptionsLinearregressioninterceptDragDropGuideBox GuideBox_DefaultValue { get; set; }
