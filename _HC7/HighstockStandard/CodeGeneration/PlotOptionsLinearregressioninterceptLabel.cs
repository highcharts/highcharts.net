...
{
	public partial class PlotOptionsLinearregressioninterceptLabel  : BaseObject
	{
		public PlotOptionsLinearregressioninterceptLabel()
		{
			...
			Style = Style_DefaultValue = new PlotOptionsLinearregressioninterceptLabelStyle();
		...
		/// </summary>
		public PlotOptionsLinearregressioninterceptLabelStyle Style { get; set; }
		private PlotOptionsLinearregressioninterceptLabelStyle Style_DefaultValue { get; set; }
