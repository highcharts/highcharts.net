...
{
	public partial class PlotOptionsLinearregressioninterceptLastPriceLabel  : BaseObject
	{
		Hashtable h = new Hashtable();

		public PlotOptionsLinearregressioninterceptLastPriceLabel()
		{
			Align = Align_DefaultValue = PlotOptionsLinearregressioninterceptLastPriceLabelAlign.Null;
		...
		/// 
		/// </summary>
		public PlotOptionsLinearregressioninterceptLastPriceLabelAlign Align { get; set; }
		private PlotOptionsLinearregressioninterceptLastPriceLabelAlign Align_DefaultValue { get; set; }
