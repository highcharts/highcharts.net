...
namespace Highsoft.Web.Mvc.Stocks
{
	public partial class PlotOptionsLinearregressioninterceptMarkerStates  : BaseObject
	{
		public PlotOptionsLinearregressioninterceptMarkerStates()
		{
			...
			Inactive = Inactive_DefaultValue = new PlotOptionsLinearregressioninterceptMarkerStatesInactive();
		...
		/// 
		/// </summary>
		public PlotOptionsLinearregressioninterceptMarkerStatesInactive Inactive { get; set; }
		private PlotOptionsLinearregressioninterceptMarkerStatesInactive Inactive_DefaultValue { get; set; }
