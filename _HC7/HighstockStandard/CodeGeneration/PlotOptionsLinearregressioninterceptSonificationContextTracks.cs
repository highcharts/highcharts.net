...
{
	public partial class PlotOptionsLinearregressioninterceptSonificationContextTracks  : BaseObject
	{
		Hashtable h = new Hashtable();

		public PlotOptionsLinearregressioninterceptSonificationContextTracks()
		{
			ActiveWhen = ActiveWhen_DefaultValue = new PlotOptionsLinearregressioninterceptSonificationContextTracksActiveWhen();
			Instrument = Instrument_DefaultValue = null;
			InstrumentString = InstrumentString_DefaultValue = "null";
			Mapping = Mapping_DefaultValue = new PlotOptionsLinearregressioninterceptSonificationContextTracksMapping();
			MidiName = MidiName_DefaultValue = "";
			PointGrouping = PointGrouping_DefaultValue = new PlotOptionsLinearregressioninterceptSonificationContextTracksPointGrouping();
			...
			Type = Type_DefaultValue = PlotOptionsLinearregressioninterceptSonificationContextTracksType.Instrument;
			ValueInterval = ValueInterval_DefaultValue = null;
			ValueMapFunction = ValueMapFunction_DefaultValue = PlotOptionsLinearregressioninterceptSonificationContextTracksValueMapFunction.Linear;
		...
		/// </summary>
		public PlotOptionsLinearregressioninterceptSonificationContextTracksActiveWhen ActiveWhen { get; set; }
		private PlotOptionsLinearregressioninterceptSonificationContextTracksActiveWhen ActiveWhen_DefaultValue { get; set; }
		...
		/// </summary>
		public PlotOptionsLinearregressioninterceptSonificationContextTracksMapping Mapping { get; set; }
		private PlotOptionsLinearregressioninterceptSonificationContextTracksMapping Mapping_DefaultValue { get; set; }
		...
		/// </summary>
		public PlotOptionsLinearregressioninterceptSonificationContextTracksPointGrouping PointGrouping { get; set; }
		private PlotOptionsLinearregressioninterceptSonificationContextTracksPointGrouping PointGrouping_DefaultValue { get; set; }
		...
		/// </summary>
		public PlotOptionsLinearregressioninterceptSonificationContextTracksType Type { get; set; }
		private PlotOptionsLinearregressioninterceptSonificationContextTracksType Type_DefaultValue { get; set; }
		...
		/// </summary>
		public PlotOptionsLinearregressioninterceptSonificationContextTracksValueMapFunction ValueMapFunction { get; set; }
		private PlotOptionsLinearregressioninterceptSonificationContextTracksValueMapFunction ValueMapFunction_DefaultValue { get; set; }
