...
{
	public partial class PlotOptionsLinearregressioninterceptSonificationContextTracksActiveWhen  : BaseObject
	{
		Hashtable h = new Hashtable();

		public PlotOptionsLinearregressioninterceptSonificationContextTracksActiveWhen()
		{
		}	
