...
namespace Highsoft.Web.Mvc.Stocks
{
	public partial class PlotOptionsLinearregressioninterceptSonificationContextTracksMappingHighpass  : BaseObject
	{
		...
		{
			Frequency = Frequency_DefaultValue = new PlotOptionsLinearregressioninterceptSonificationContextTracksMappingHighpassFrequency();
			Resonance = Resonance_DefaultValue = new PlotOptionsLinearregressioninterceptSonificationContextTracksMappingHighpassResonance();
		...
		private PlotOptionsLinearregressioninterceptSonificationContextTracksMappingHighpassFrequency Frequency_DefaultValue { get; set; }
		...
		private PlotOptionsLinearregressioninterceptSonificationContextTracksMappingHighpassResonance Resonance_DefaultValue { get; set; }
