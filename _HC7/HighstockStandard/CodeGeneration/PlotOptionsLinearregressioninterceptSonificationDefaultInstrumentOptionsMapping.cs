...
namespace Highsoft.Web.Mvc.Stocks
{
	public partial class PlotOptionsLinearregressioninterceptSonificationDefaultInstrumentOptionsMapping  : BaseObject
	{
		...
		internal override Hashtable ToHashtable(Highstock highstock)
		{
			...
			if (GapBetweenNotes != null) h.Add("gapBetweenNotes",GapBetweenNotes.ToHashtable(highstock));
			if (Highpass != null) h.Add("highpass",Highpass.ToHashtable(highstock));
			if (Lowpass != null) h.Add("lowpass",Lowpass.ToHashtable(highstock));
			if (NoteDuration != null) h.Add("noteDuration",NoteDuration.ToHashtable(highstock));
			if (Pan != null) h.Add("pan",Pan.ToHashtable(highstock));
			if (Pitch != null) h.Add("pitch",Pitch.ToHashtable(highstock));
			if (PitchString != null) h.Add("pitch",PitchString);
			if (PitchNumber != null) h.Add("pitch",PitchNumber);
			if (PlayDelay != null) h.Add("playDelay",PlayDelay.ToHashtable(highstock));
			if (Time != null) h.Add("time",Time.ToHashtable(highstock));
			if (TimeString != null) h.Add("time",TimeString);
			if (TimeNumber != null) h.Add("time",TimeNumber);
			if (Tremolo != null) h.Add("tremolo",Tremolo.ToHashtable(highstock));
			if (Volume != null) h.Add("volume",Volume.ToHashtable(highstock));
