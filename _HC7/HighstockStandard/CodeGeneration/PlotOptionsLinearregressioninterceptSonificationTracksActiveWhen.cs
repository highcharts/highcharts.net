...
{
	public partial class PlotOptionsLinearregressioninterceptSonificationTracksActiveWhen  : BaseObject
	{
		Hashtable h = new Hashtable();

		public PlotOptionsLinearregressioninterceptSonificationTracksActiveWhen()
		{
