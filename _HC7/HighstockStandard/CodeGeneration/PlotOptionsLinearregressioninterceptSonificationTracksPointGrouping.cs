...
{
	public partial class PlotOptionsLinearregressioninterceptSonificationTracksPointGrouping  : BaseObject
	{
		Hashtable h = new Hashtable();

		public PlotOptionsLinearregressioninterceptSonificationTracksPointGrouping()
		{
			Algorithm = Algorithm_DefaultValue = PlotOptionsLinearregressioninterceptSonificationTracksPointGroupingAlgorithm.Minimax;
		...
		/// </summary>
		public PlotOptionsLinearregressioninterceptSonificationTracksPointGroupingAlgorithm Algorithm { get; set; }
		private PlotOptionsLinearregressioninterceptSonificationTracksPointGroupingAlgorithm Algorithm_DefaultValue { get; set; }
