...
{
	public partial class PlotOptionsLinearregressioninterceptStatesHoverMarker  : BaseObject
	{
		public PlotOptionsLinearregressioninterceptStatesHoverMarker()
		{
			...
			States = States_DefaultValue = new PlotOptionsLinearregressioninterceptStatesHoverMarkerStates();
		...
		/// </summary>
		public PlotOptionsLinearregressioninterceptStatesHoverMarkerStates States { get; set; }
		private PlotOptionsLinearregressioninterceptStatesHoverMarkerStates States_DefaultValue { get; set; }
