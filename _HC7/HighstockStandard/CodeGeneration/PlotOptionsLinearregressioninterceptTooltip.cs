...
{
	public partial class PlotOptionsLinearregressioninterceptTooltip  : BaseObject
	{
		public PlotOptionsLinearregressioninterceptTooltip()
		{
			...
			HeaderShape = HeaderShape_DefaultValue = PlotOptionsLinearregressioninterceptTooltipHeaderShape.Callout;
		...
		/// </summary>
		public PlotOptionsLinearregressioninterceptTooltipHeaderShape HeaderShape { get; set; }
		private PlotOptionsLinearregressioninterceptTooltipHeaderShape HeaderShape_DefaultValue { get; set; }
		...
		internal override Hashtable ToHashtable()
		{
			...
			if (NullFormatter != NullFormatter_DefaultValue) { h.Add("nullFormatter",NullFormatter); Highstock.AddFunction("PlotOptionsLinearregressioninterceptTooltipNullFormatter.nullFormatter", NullFormatter); }  
			if (Outside != Outside_DefaultValue) h.Add("outside",Outside);
			if (Padding != Padding_DefaultValue) h.Add("padding",Padding);
			if (PointFormat != PointFormat_DefaultValue) h.Add("pointFormat",PointFormat);
			if (PointFormatter != PointFormatter_DefaultValue) { h.Add("pointFormatter",PointFormatter); Highstock.AddFunction("PlotOptionsLinearregressioninterceptTooltipPointFormatter.pointFormatter", PointFormatter); }  
