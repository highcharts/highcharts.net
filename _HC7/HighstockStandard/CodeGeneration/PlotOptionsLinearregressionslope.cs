...
{
	public partial class PlotOptionsLinearregressionslope  : BaseObject
	{
		Hashtable h = new Hashtable();

		public PlotOptionsLinearregressionslope()
		{
			Accessibility = Accessibility_DefaultValue = new PlotOptionsLinearregressionslopeAccessibility();
			AllowPointSelect = AllowPointSelect_DefaultValue = false;
			Animation = Animation_DefaultValue = new Animation() { Enabled = true };
			AnimationBool = AnimationBool_DefaultValue = true;
			AnimationLimit = AnimationLimit_DefaultValue = null;
			BoostBlending = BoostBlending_DefaultValue = PlotOptionsLinearregressionslopeBoostBlending.Undefined;
			...
			Compare = Compare_DefaultValue = PlotOptionsLinearregressionslopeCompare.Percent;
			CompareBase = CompareBase_DefaultValue = PlotOptionsLinearregressionslopeCompareBase.Min;
			...
			Cursor = Cursor_DefaultValue = PlotOptionsLinearregressionslopeCursor.Null;
			Custom = Custom_DefaultValue = new Hashtable();
			DashStyle = DashStyle_DefaultValue = PlotOptionsLinearregressionslopeDashStyle.Null;
			DataGrouping = DataGrouping_DefaultValue = new PlotOptionsLinearregressionslopeDataGrouping();
			DataLabels = DataLabels_DefaultValue = new PlotOptionsLinearregressionslopeDataLabels();
			DataSorting = DataSorting_DefaultValue = new PlotOptionsLinearregressionslopeDataSorting();
			Description = Description_DefaultValue = "";
			EnableMouseTracking = EnableMouseTracking_DefaultValue = true;
			Events = Events_DefaultValue = new PlotOptionsLinearregressionslopeEvents();
			FindNearestPointBy = FindNearestPointBy_DefaultValue = PlotOptionsLinearregressionslopeFindNearestPointBy.X;
			GapSize = GapSize_DefaultValue = 0;
			GapUnit = GapUnit_DefaultValue = PlotOptionsLinearregressionslopeGapUnit.Relative;
			GetExtremesFromAll = GetExtremesFromAll_DefaultValue = false;
			InactiveOtherPoints = InactiveOtherPoints_DefaultValue = false;
			IncludeInDataExport = IncludeInDataExport_DefaultValue = null;
			Label = Label_DefaultValue = new PlotOptionsLinearregressionslopeLabel();
			LastPrice = LastPrice_DefaultValue = new PlotOptionsLinearregressionslopeLastPrice();
			LastVisiblePrice = LastVisiblePrice_DefaultValue = new PlotOptionsLinearregressionslopeLastVisiblePrice();
			LegendSymbol = LegendSymbol_DefaultValue = PlotOptionsLinearregressionslopeLegendSymbol.Rectangle;
			Linecap = Linecap_DefaultValue = PlotOptionsLinearregressionslopeLinecap.Round;
			LineWidth = LineWidth_DefaultValue = 2;
			LinkedTo = LinkedTo_DefaultValue = "";
			Marker = Marker_DefaultValue = new PlotOptionsLinearregressionslopeMarker();
			NegativeColor = NegativeColor_DefaultValue = "";
			OnPoint = OnPoint_DefaultValue = new PlotOptionsLinearregressionslopeOnPoint();
			Opacity = Opacity_DefaultValue = 1;
			Params = Params_DefaultValue = new PlotOptionsLinearregressionslopeParams();
			Point = Point_DefaultValue = new PlotOptionsLinearregressionslopePoint();
			...
			Sonification = Sonification_DefaultValue = new PlotOptionsLinearregressionslopeSonification();
			States = States_DefaultValue = new PlotOptionsLinearregressionslopeStates();
			Step = Step_DefaultValue = PlotOptionsLinearregressionslopeStep.Null;
			StickyTracking = StickyTracking_DefaultValue = true;
			Threshold = Threshold_DefaultValue = 0;
			Tooltip = Tooltip_DefaultValue = new PlotOptionsLinearregressionslopeTooltip();
			TurboThreshold = TurboThreshold_DefaultValue = 1000;
			Visible = Visible_DefaultValue = true;
			ZoneAxis = ZoneAxis_DefaultValue = "y";
			Zones = Zones_DefaultValue = new List<PlotOptionsLinearregressionslopeZones>();
		...
		/// </summary>
		public PlotOptionsLinearregressionslopeAccessibility Accessibility { get; set; }
		private PlotOptionsLinearregressionslopeAccessibility Accessibility_DefaultValue { get; set; }
		...
		/// </summary>
		public PlotOptionsLinearregressionslopeBoostBlending BoostBlending { get; set; }
		private PlotOptionsLinearregressionslopeBoostBlending BoostBlending_DefaultValue { get; set; }
		...
		/// </summary>
		public PlotOptionsLinearregressionslopeCompare Compare { get; set; }
		private PlotOptionsLinearregressionslopeCompare Compare_DefaultValue { get; set; }
		 

		/// <summary>
		/// When [compare](#plotOptions.series.compare) is `percent`, this optiondictates whether to use 0 or 100 as the base of comparison.
		/// </summary>
		public PlotOptionsLinearregressionslopeCompareBase CompareBase { get; set; }
		private PlotOptionsLinearregressionslopeCompareBase CompareBase_DefaultValue { get; set; }
		...
		/// </summary>
		public PlotOptionsLinearregressionslopeCursor Cursor { get; set; }
		private PlotOptionsLinearregressionslopeCursor Cursor_DefaultValue { get; set; }
		...
		/// </summary>
		public PlotOptionsLinearregressionslopeDashStyle DashStyle { get; set; }
		private PlotOptionsLinearregressionslopeDashStyle DashStyle_DefaultValue { get; set; }
		...
		/// </summary>
		public PlotOptionsLinearregressionslopeDataGrouping DataGrouping { get; set; }
		private PlotOptionsLinearregressionslopeDataGrouping DataGrouping_DefaultValue { get; set; }
		...
		/// </summary>
		public PlotOptionsLinearregressionslopeDataLabels DataLabels { get; set; }
		private PlotOptionsLinearregressionslopeDataLabels DataLabels_DefaultValue { get; set; }
		 

		/// <summary>
		/// Options for the series data sorting.
		/// </summary>
		public PlotOptionsLinearregressionslopeDataSorting DataSorting { get; set; }
		private PlotOptionsLinearregressionslopeDataSorting DataSorting_DefaultValue { get; set; }
		...
		/// </summary>
		public PlotOptionsLinearregressionslopeEvents Events { get; set; }
		private PlotOptionsLinearregressionslopeEvents Events_DefaultValue { get; set; }
		...
		/// </summary>
		public PlotOptionsLinearregressionslopeFindNearestPointBy FindNearestPointBy { get; set; }
		private PlotOptionsLinearregressionslopeFindNearestPointBy FindNearestPointBy_DefaultValue { get; set; }
		...
		/// </summary>
		public PlotOptionsLinearregressionslopeGapUnit GapUnit { get; set; }
		private PlotOptionsLinearregressionslopeGapUnit GapUnit_DefaultValue { get; set; }
		...
		/// </summary>
		public PlotOptionsLinearregressionslopeLabel Label { get; set; }
		private PlotOptionsLinearregressionslopeLabel Label_DefaultValue { get; set; }
		 

		/// <summary>
		/// The line marks the last price from all points.
		/// </summary>
		public PlotOptionsLinearregressionslopeLastPrice LastPrice { get; set; }
		private PlotOptionsLinearregressionslopeLastPrice LastPrice_DefaultValue { get; set; }
		 

		/// <summary>
		/// The line marks the last price from visible range of points.
		/// </summary>
		public PlotOptionsLinearregressionslopeLastVisiblePrice LastVisiblePrice { get; set; }
		private PlotOptionsLinearregressionslopeLastVisiblePrice LastVisiblePrice_DefaultValue { get; set; }
		 

		/// <summary>
		/// What type of legend symbol to render for this series. Can be one of`areaMarker`, `lineMarker` or `rectangle`.
		/// </summary>
		public PlotOptionsLinearregressionslopeLegendSymbol LegendSymbol { get; set; }
		private PlotOptionsLinearregressionslopeLegendSymbol LegendSymbol_DefaultValue { get; set; }
		 

		/// <summary>
		/// The line cap used for line ends and line joins on the graph.
		/// </summary>
		public PlotOptionsLinearregressionslopeLinecap Linecap { get; set; }
		private PlotOptionsLinearregressionslopeLinecap Linecap_DefaultValue { get; set; }
		...
		/// </summary>
		public PlotOptionsLinearregressionslopeMarker Marker { get; set; }
		private PlotOptionsLinearregressionslopeMarker Marker_DefaultValue { get; set; }
		...
		/// </summary>
		public PlotOptionsLinearregressionslopeOnPoint OnPoint { get; set; }
		private PlotOptionsLinearregressionslopeOnPoint OnPoint_DefaultValue { get; set; }
		...
		/// </summary>
		public PlotOptionsLinearregressionslopeParams Params { get; set; }
		private PlotOptionsLinearregressionslopeParams Params_DefaultValue { get; set; }
		 

		/// <summary>
		/// Properties for each single point.
		/// </summary>
		public PlotOptionsLinearregressionslopePoint Point { get; set; }
		private PlotOptionsLinearregressionslopePoint Point_DefaultValue { get; set; }
		...
		/// </summary>
		public PlotOptionsLinearregressionslopeSonification Sonification { get; set; }
		private PlotOptionsLinearregressionslopeSonification Sonification_DefaultValue { get; set; }
		 

		/// <summary>
		/// 
		/// </summary>
		public PlotOptionsLinearregressionslopeStates States { get; set; }
		private PlotOptionsLinearregressionslopeStates States_DefaultValue { get; set; }
		 

		/// <summary>
		/// Whether to apply steps to the line. Possible values are `left`,`center` and `right`.
		/// </summary>
		public PlotOptionsLinearregressionslopeStep Step { get; set; }
		private PlotOptionsLinearregressionslopeStep Step_DefaultValue { get; set; }
		...
		/// </summary>
		public PlotOptionsLinearregressionslopeTooltip Tooltip { get; set; }
		private PlotOptionsLinearregressionslopeTooltip Tooltip_DefaultValue { get; set; }
		...
		/// </summary>
		public List<PlotOptionsLinearregressionslopeZones> Zones { get; set; }
		private List<PlotOptionsLinearregressionslopeZones> Zones_DefaultValue { get; set; }
