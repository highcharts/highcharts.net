...
namespace Highsoft.Web.Mvc.Stocks
{
	public partial class PlotOptionsLinearregressionslope  : BaseObject
	{
		...
		public PlotOptionsLinearregressionslope()
		{
			...
			Zones = Zones_DefaultValue = new List<PlotOptionsLinearregressionslopeZone>();
		...
		/// </summary>
		public List<PlotOptionsLinearregressionslopeZone> Zones { get; set; }
		private List<PlotOptionsLinearregressionslopeZone> Zones_DefaultValue { get; set; }
