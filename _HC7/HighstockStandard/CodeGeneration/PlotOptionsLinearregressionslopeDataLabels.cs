...
namespace Highsoft.Web.Mvc.Stocks
{
	public partial class PlotOptionsLinearregressionslopeDataLabels  : BaseObject
	{
		...
		{
			if (Align != PlotOptionsLinearregressionslopeDataLabelsAlign.Null) h.Add("align", highstock.FirstCharacterToLower(Align.ToString()));
			...
			if (Overflow != PlotOptionsLinearregressionslopeDataLabelsOverflow.Null) h.Add("overflow", highstock.FirstCharacterToLower(Overflow.ToString()));
			if (Padding != null) h.Add("padding",Padding);
			if (Position != PlotOptionsLinearregressionslopeDataLabelsPosition.Null) h.Add("position", highstock.FirstCharacterToLower(Position.ToString()));
			...
			if (VerticalAlign != PlotOptionsLinearregressionslopeDataLabelsVerticalAlign.Null) h.Add("verticalAlign", highstock.FirstCharacterToLower(VerticalAlign.ToString()));
			if (X != null) h.Add("x",X);
			if (Y != null) h.Add("y",Y);
