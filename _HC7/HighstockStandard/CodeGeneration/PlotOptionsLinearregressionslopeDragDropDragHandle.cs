...
{
	public partial class PlotOptionsLinearregressionslopeDragDropDragHandle  : BaseObject
	{
		public PlotOptionsLinearregressionslopeDragDropDragHandle()
		{
		...
		internal override Hashtable ToHashtable()
		{
			...
			if (PathFormatter != PathFormatter_DefaultValue) { h.Add("pathFormatter",PathFormatter); Highstock.AddFunction("PlotOptionsLinearregressionslopeDragDropDragHandlePathFormatter.pathFormatter", PathFormatter); }  
