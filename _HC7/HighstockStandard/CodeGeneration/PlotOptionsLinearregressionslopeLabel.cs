...
{
	public partial class PlotOptionsLinearregressionslopeLabel  : BaseObject
	{
		public PlotOptionsLinearregressionslopeLabel()
		{
			...
			Style = Style_DefaultValue = new PlotOptionsLinearregressionslopeLabelStyle();
		...
		/// </summary>
		public PlotOptionsLinearregressionslopeLabelStyle Style { get; set; }
		private PlotOptionsLinearregressionslopeLabelStyle Style_DefaultValue { get; set; }
