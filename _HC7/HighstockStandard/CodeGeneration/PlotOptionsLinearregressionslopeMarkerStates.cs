...
namespace Highsoft.Web.Mvc.Stocks
{
	public partial class PlotOptionsLinearregressionslopeMarkerStates  : BaseObject
	{
		public PlotOptionsLinearregressionslopeMarkerStates()
		{
			...
			Inactive = Inactive_DefaultValue = new PlotOptionsLinearregressionslopeMarkerStatesInactive();
		...
		/// 
		/// </summary>
		public PlotOptionsLinearregressionslopeMarkerStatesInactive Inactive { get; set; }
		private PlotOptionsLinearregressionslopeMarkerStatesInactive Inactive_DefaultValue { get; set; }
