...
{
	public partial class PlotOptionsLinearregressionslopeSonificationContextTracksActiveWhen  : BaseObject
	{
		Hashtable h = new Hashtable();

		public PlotOptionsLinearregressionslopeSonificationContextTracksActiveWhen()
		{
