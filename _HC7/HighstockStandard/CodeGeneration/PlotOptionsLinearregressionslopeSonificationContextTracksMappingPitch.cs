...
{
	public partial class PlotOptionsLinearregressionslopeSonificationContextTracksMappingPitch  : BaseObject
	{
		Hashtable h = new Hashtable();

		public PlotOptionsLinearregressionslopeSonificationContextTracksMappingPitch()
		{
			MapFunction = MapFunction_DefaultValue = PlotOptionsLinearregressionslopeSonificationContextTracksMappingPitchMapFunction.Linear;
		...
		/// </summary>
		public PlotOptionsLinearregressionslopeSonificationContextTracksMappingPitchMapFunction MapFunction { get; set; }
		private PlotOptionsLinearregressionslopeSonificationContextTracksMappingPitchMapFunction MapFunction_DefaultValue { get; set; }
