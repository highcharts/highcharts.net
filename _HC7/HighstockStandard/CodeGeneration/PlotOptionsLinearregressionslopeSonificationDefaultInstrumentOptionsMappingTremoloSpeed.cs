...
{
	public partial class PlotOptionsLinearregressionslopeSonificationDefaultInstrumentOptionsMappingTremoloSpeed  : BaseObject
	{
		Hashtable h = new Hashtable();

		public PlotOptionsLinearregressionslopeSonificationDefaultInstrumentOptionsMappingTremoloSpeed()
		{
			MapFunction = MapFunction_DefaultValue = PlotOptionsLinearregressionslopeSonificationDefaultInstrumentOptionsMappingTremoloSpeedMapFunction.Linear;
			MapTo = MapTo_DefaultValue = "";
			Max = Max_DefaultValue = null;
			Min = Min_DefaultValue = null;
			Value = Value_DefaultValue = null;
			Within = Within_DefaultValue = PlotOptionsLinearregressionslopeSonificationDefaultInstrumentOptionsMappingTremoloSpeedWithin.Chart;
		...
		/// </summary>
		public PlotOptionsLinearregressionslopeSonificationDefaultInstrumentOptionsMappingTremoloSpeedMapFunction MapFunction { get; set; }
		private PlotOptionsLinearregressionslopeSonificationDefaultInstrumentOptionsMappingTremoloSpeedMapFunction MapFunction_DefaultValue { get; set; }
		...
		/// </summary>
		public PlotOptionsLinearregressionslopeSonificationDefaultInstrumentOptionsMappingTremoloSpeedWithin Within { get; set; }
		private PlotOptionsLinearregressionslopeSonificationDefaultInstrumentOptionsMappingTremoloSpeedWithin Within_DefaultValue { get; set; }
