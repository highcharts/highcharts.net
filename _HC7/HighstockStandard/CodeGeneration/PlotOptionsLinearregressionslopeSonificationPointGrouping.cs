...
{
	public partial class PlotOptionsLinearregressionslopeSonificationPointGrouping  : BaseObject
	{
		Hashtable h = new Hashtable();

		public PlotOptionsLinearregressionslopeSonificationPointGrouping()
		{
			Algorithm = Algorithm_DefaultValue = PlotOptionsLinearregressionslopeSonificationPointGroupingAlgorithm.Minimax;
		...
		/// </summary>
		public PlotOptionsLinearregressionslopeSonificationPointGroupingAlgorithm Algorithm { get; set; }
		private PlotOptionsLinearregressionslopeSonificationPointGroupingAlgorithm Algorithm_DefaultValue { get; set; }
