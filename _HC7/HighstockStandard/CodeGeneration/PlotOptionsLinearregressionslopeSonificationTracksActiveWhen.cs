...
{
	public partial class PlotOptionsLinearregressionslopeSonificationTracksActiveWhen  : BaseObject
	{
		Hashtable h = new Hashtable();

		public PlotOptionsLinearregressionslopeSonificationTracksActiveWhen()
		{
