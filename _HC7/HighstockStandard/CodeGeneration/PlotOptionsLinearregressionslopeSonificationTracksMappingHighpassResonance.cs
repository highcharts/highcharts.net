...
{
	public partial class PlotOptionsLinearregressionslopeSonificationTracksMappingHighpassResonance  : BaseObject
	{
		Hashtable h = new Hashtable();

		public PlotOptionsLinearregressionslopeSonificationTracksMappingHighpassResonance()
		{
			MapFunction = MapFunction_DefaultValue = PlotOptionsLinearregressionslopeSonificationTracksMappingHighpassResonanceMapFunction.Linear;
			MapTo = MapTo_DefaultValue = "";
			Max = Max_DefaultValue = null;
			Min = Min_DefaultValue = null;
			Value = Value_DefaultValue = null;
			Within = Within_DefaultValue = PlotOptionsLinearregressionslopeSonificationTracksMappingHighpassResonanceWithin.Chart;
		...
		/// </summary>
		public PlotOptionsLinearregressionslopeSonificationTracksMappingHighpassResonanceMapFunction MapFunction { get; set; }
		private PlotOptionsLinearregressionslopeSonificationTracksMappingHighpassResonanceMapFunction MapFunction_DefaultValue { get; set; }
		...
		/// </summary>
		public PlotOptionsLinearregressionslopeSonificationTracksMappingHighpassResonanceWithin Within { get; set; }
		private PlotOptionsLinearregressionslopeSonificationTracksMappingHighpassResonanceWithin Within_DefaultValue { get; set; }
