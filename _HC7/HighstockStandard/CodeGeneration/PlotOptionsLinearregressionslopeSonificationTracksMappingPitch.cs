...
{
	public partial class PlotOptionsLinearregressionslopeSonificationTracksMappingPitch  : BaseObject
	{
		Hashtable h = new Hashtable();

		public PlotOptionsLinearregressionslopeSonificationTracksMappingPitch()
		{
			MapFunction = MapFunction_DefaultValue = PlotOptionsLinearregressionslopeSonificationTracksMappingPitchMapFunction.Linear;
		...
		/// </summary>
		public PlotOptionsLinearregressionslopeSonificationTracksMappingPitchMapFunction MapFunction { get; set; }
		private PlotOptionsLinearregressionslopeSonificationTracksMappingPitchMapFunction MapFunction_DefaultValue { get; set; }
