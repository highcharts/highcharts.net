...
{
	public partial class PlotOptionsLinearregressionslopeSonificationTracksMappingTime  : BaseObject
	{
		Hashtable h = new Hashtable();

		public PlotOptionsLinearregressionslopeSonificationTracksMappingTime()
		{
			MapFunction = MapFunction_DefaultValue = PlotOptionsLinearregressionslopeSonificationTracksMappingTimeMapFunction.Linear;
			MapTo = MapTo_DefaultValue = "";
			Max = Max_DefaultValue = null;
			Min = Min_DefaultValue = null;
			Value = Value_DefaultValue = null;
			Within = Within_DefaultValue = PlotOptionsLinearregressionslopeSonificationTracksMappingTimeWithin.Chart;
		...
		/// </summary>
		public PlotOptionsLinearregressionslopeSonificationTracksMappingTimeMapFunction MapFunction { get; set; }
		private PlotOptionsLinearregressionslopeSonificationTracksMappingTimeMapFunction MapFunction_DefaultValue { get; set; }
		...
		/// </summary>
		public PlotOptionsLinearregressionslopeSonificationTracksMappingTimeWithin Within { get; set; }
		private PlotOptionsLinearregressionslopeSonificationTracksMappingTimeWithin Within_DefaultValue { get; set; }
