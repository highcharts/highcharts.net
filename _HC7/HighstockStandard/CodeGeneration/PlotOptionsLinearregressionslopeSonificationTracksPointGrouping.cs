...
{
	public partial class PlotOptionsLinearregressionslopeSonificationTracksPointGrouping  : BaseObject
	{
		Hashtable h = new Hashtable();

		public PlotOptionsLinearregressionslopeSonificationTracksPointGrouping()
		{
			Algorithm = Algorithm_DefaultValue = PlotOptionsLinearregressionslopeSonificationTracksPointGroupingAlgorithm.Minimax;
		...
		/// </summary>
		public PlotOptionsLinearregressionslopeSonificationTracksPointGroupingAlgorithm Algorithm { get; set; }
		private PlotOptionsLinearregressionslopeSonificationTracksPointGroupingAlgorithm Algorithm_DefaultValue { get; set; }
