...
{
	public partial class PlotOptionsLinearregressionslopeStatesHover  : BaseObject
	{
		Hashtable h = new Hashtable();

		public PlotOptionsLinearregressionslopeStatesHover()
		{
			Animation = Animation_DefaultValue = new Animation() { Enabled = true };
			AnimationBool = AnimationBool_DefaultValue = null;
			Enabled = Enabled_DefaultValue = true;
			Halo = Halo_DefaultValue = new PlotOptionsLinearregressionslopeStatesHoverHalo();
			LineWidth = LineWidth_DefaultValue = null;
			LineWidthPlus = LineWidthPlus_DefaultValue = 1;
			Marker = Marker_DefaultValue = new PlotOptionsLinearregressionslopeStatesHoverMarker();
		...
		/// </summary>
		public PlotOptionsLinearregressionslopeStatesHoverHalo Halo { get; set; }
		private PlotOptionsLinearregressionslopeStatesHoverHalo Halo_DefaultValue { get; set; }
		...
		/// </summary>
		public PlotOptionsLinearregressionslopeStatesHoverMarker Marker { get; set; }
		private PlotOptionsLinearregressionslopeStatesHoverMarker Marker_DefaultValue { get; set; }
