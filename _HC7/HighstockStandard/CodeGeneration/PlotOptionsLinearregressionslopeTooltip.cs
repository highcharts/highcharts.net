...
{
	public partial class PlotOptionsLinearregressionslopeTooltip  : BaseObject
	{
		public PlotOptionsLinearregressionslopeTooltip()
		{
			...
			HeaderShape = HeaderShape_DefaultValue = PlotOptionsLinearregressionslopeTooltipHeaderShape.Callout;
		...
		/// </summary>
		public PlotOptionsLinearregressionslopeTooltipHeaderShape HeaderShape { get; set; }
		private PlotOptionsLinearregressionslopeTooltipHeaderShape HeaderShape_DefaultValue { get; set; }
		...
		internal override Hashtable ToHashtable()
		{
			...
			if (NullFormatter != NullFormatter_DefaultValue) { h.Add("nullFormatter",NullFormatter); Highstock.AddFunction("PlotOptionsLinearregressionslopeTooltipNullFormatter.nullFormatter", NullFormatter); }  
			if (Outside != Outside_DefaultValue) h.Add("outside",Outside);
			if (Padding != Padding_DefaultValue) h.Add("padding",Padding);
			if (PointFormat != PointFormat_DefaultValue) h.Add("pointFormat",PointFormat);
			if (PointFormatter != PointFormatter_DefaultValue) { h.Add("pointFormatter",PointFormatter); Highstock.AddFunction("PlotOptionsLinearregressionslopeTooltipPointFormatter.pointFormatter", PointFormatter); }  
