...
{
	public partial class PlotOptionsLinearregressionslopeTooltipDateTimeLabelFormats  : BaseObject
	{
		Hashtable h = new Hashtable();

		public PlotOptionsLinearregressionslopeTooltipDateTimeLabelFormats()
		{
