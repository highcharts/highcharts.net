...
{
	public partial class PlotOptionsLollipop  : BaseObject
	{
		Hashtable h = new Hashtable();

		public PlotOptionsLollipop()
		{
			...
			Compare = Compare_DefaultValue = PlotOptionsLollipopCompare.Percent;
			CompareBase = CompareBase_DefaultValue = PlotOptionsLollipopCompareBase.Min;
			...
			Cursor = Cursor_DefaultValue = PlotOptionsLollipopCursor.Null;
			Custom = Custom_DefaultValue = new Hashtable();
			DashStyle = DashStyle_DefaultValue = PlotOptionsLollipopDashStyle.Null;
			DataGrouping = DataGrouping_DefaultValue = new PlotOptionsLollipopDataGrouping();
			DataLabels = DataLabels_DefaultValue = new PlotOptionsLollipopDataLabels();
			DataSorting = DataSorting_DefaultValue = new PlotOptionsLollipopDataSorting();
			Description = Description_DefaultValue = "";
			DragDrop = DragDrop_DefaultValue = new PlotOptionsLollipopDragDrop();
			EnableMouseTracking = EnableMouseTracking_DefaultValue = true;
			Events = Events_DefaultValue = new PlotOptionsLollipopEvents();
			FindNearestPointBy = FindNearestPointBy_DefaultValue = PlotOptionsLollipopFindNearestPointBy.X;
			...
			LastPrice = LastPrice_DefaultValue = new PlotOptionsLollipopLastPrice();
			LastVisiblePrice = LastVisiblePrice_DefaultValue = new PlotOptionsLollipopLastVisiblePrice();
			LegendSymbol = LegendSymbol_DefaultValue = PlotOptionsLollipopLegendSymbol.Rectangle;
			...
			OnPoint = OnPoint_DefaultValue = new PlotOptionsLollipopOnPoint();
			Opacity = Opacity_DefaultValue = 1;
			Point = Point_DefaultValue = new PlotOptionsLollipopPoint();
			...
			Sonification = Sonification_DefaultValue = new PlotOptionsLollipopSonification();
			States = States_DefaultValue = new PlotOptionsLollipopStates();
			Step = Step_DefaultValue = PlotOptionsLollipopStep.Null;
			Threshold = Threshold_DefaultValue = 0;
			Tooltip = Tooltip_DefaultValue = new PlotOptionsLollipopTooltip();
			TurboThreshold = TurboThreshold_DefaultValue = 1000;
			Visible = Visible_DefaultValue = true;
			ZoneAxis = ZoneAxis_DefaultValue = "y";
			Zones = Zones_DefaultValue = new List<PlotOptionsLollipopZones>();
		...
		/// </summary>
		public PlotOptionsLollipopAccessibility Accessibility { get; set; }
		private PlotOptionsLollipopAccessibility Accessibility_DefaultValue { get; set; }
		...
		/// </summary>
		public PlotOptionsLollipopCompare Compare { get; set; }
		private PlotOptionsLollipopCompare Compare_DefaultValue { get; set; }
		 

		/// <summary>
		/// When [compare](#plotOptions.series.compare) is `percent`, this optiondictates whether to use 0 or 100 as the base of comparison.
		/// </summary>
		public PlotOptionsLollipopCompareBase CompareBase { get; set; }
		private PlotOptionsLollipopCompareBase CompareBase_DefaultValue { get; set; }
		...
		/// </summary>
		public PlotOptionsLollipopCursor Cursor { get; set; }
		private PlotOptionsLollipopCursor Cursor_DefaultValue { get; set; }
		...
		/// </summary>
		public PlotOptionsLollipopDashStyle DashStyle { get; set; }
		private PlotOptionsLollipopDashStyle DashStyle_DefaultValue { get; set; }
		...
		/// </summary>
		public PlotOptionsLollipopDataGrouping DataGrouping { get; set; }
		private PlotOptionsLollipopDataGrouping DataGrouping_DefaultValue { get; set; }
		...
		/// </summary>
		public PlotOptionsLollipopDataSorting DataSorting { get; set; }
		private PlotOptionsLollipopDataSorting DataSorting_DefaultValue { get; set; }
		...
		/// </summary>
		public PlotOptionsLollipopDragDrop DragDrop { get; set; }
		private PlotOptionsLollipopDragDrop DragDrop_DefaultValue { get; set; }
		...
		/// </summary>
		public PlotOptionsLollipopEvents Events { get; set; }
		private PlotOptionsLollipopEvents Events_DefaultValue { get; set; }
		...
		/// </summary>
		public PlotOptionsLollipopFindNearestPointBy FindNearestPointBy { get; set; }
		private PlotOptionsLollipopFindNearestPointBy FindNearestPointBy_DefaultValue { get; set; }
		...
		/// </summary>
		public PlotOptionsLollipopGapUnit GapUnit { get; set; }
		private PlotOptionsLollipopGapUnit GapUnit_DefaultValue { get; set; }
		...
		/// </summary>
		public PlotOptionsLollipopLabel Label { get; set; }
		private PlotOptionsLollipopLabel Label_DefaultValue { get; set; }
		 

		/// <summary>
		/// The line marks the last price from all points.
		/// </summary>
		public PlotOptionsLollipopLastPrice LastPrice { get; set; }
		private PlotOptionsLollipopLastPrice LastPrice_DefaultValue { get; set; }
		 

		/// <summary>
		/// The line marks the last price from visible range of points.
		/// </summary>
		public PlotOptionsLollipopLastVisiblePrice LastVisiblePrice { get; set; }
		private PlotOptionsLollipopLastVisiblePrice LastVisiblePrice_DefaultValue { get; set; }
		 

		/// <summary>
		/// What type of legend symbol to render for this series. Can be one of`areaMarker`, `lineMarker` or `rectangle`.
		/// </summary>
		public PlotOptionsLollipopLegendSymbol LegendSymbol { get; set; }
		private PlotOptionsLollipopLegendSymbol LegendSymbol_DefaultValue { get; set; }
		 

		/// <summary>
		/// The line cap used for line ends and line joins on the graph.
		/// </summary>
		public PlotOptionsLollipopLinecap Linecap { get; set; }
		private PlotOptionsLollipopLinecap Linecap_DefaultValue { get; set; }
		...
		/// </summary>
		public PlotOptionsLollipopOnPoint OnPoint { get; set; }
		private PlotOptionsLollipopOnPoint OnPoint_DefaultValue { get; set; }
		...
		/// </summary>
		public PlotOptionsLollipopPoint Point { get; set; }
		private PlotOptionsLollipopPoint Point_DefaultValue { get; set; }
		...
		/// </summary>
		public PlotOptionsLollipopSonification Sonification { get; set; }
		private PlotOptionsLollipopSonification Sonification_DefaultValue { get; set; }
		 

		/// <summary>
		/// 
		/// </summary>
		public PlotOptionsLollipopStates States { get; set; }
		private PlotOptionsLollipopStates States_DefaultValue { get; set; }
		 

		/// <summary>
		/// Whether to apply steps to the line. Possible values are `left`,`center` and `right`.
		/// </summary>
		public PlotOptionsLollipopStep Step { get; set; }
		private PlotOptionsLollipopStep Step_DefaultValue { get; set; }
		...
		/// </summary>
		public List<PlotOptionsLollipopZones> Zones { get; set; }
		private List<PlotOptionsLollipopZones> Zones_DefaultValue { get; set; }
