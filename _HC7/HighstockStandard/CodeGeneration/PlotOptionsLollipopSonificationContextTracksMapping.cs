...
{
	public partial class PlotOptionsLollipopSonificationContextTracksMapping  : BaseObject
	{
		Hashtable h = new Hashtable();

		public PlotOptionsLollipopSonificationContextTracksMapping()
		{
			Frequency = Frequency_DefaultValue = new PlotOptionsLollipopSonificationContextTracksMappingFrequency();
			GapBetweenNotes = GapBetweenNotes_DefaultValue = new PlotOptionsLollipopSonificationContextTracksMappingGapBetweenNotes();
			Highpass = Highpass_DefaultValue = new PlotOptionsLollipopSonificationContextTracksMappingHighpass();
			Lowpass = Lowpass_DefaultValue = new PlotOptionsLollipopSonificationContextTracksMappingLowpass();
			NoteDuration = NoteDuration_DefaultValue = new PlotOptionsLollipopSonificationContextTracksMappingNoteDuration();
			Pan = Pan_DefaultValue = new PlotOptionsLollipopSonificationContextTracksMappingPan();
			Pitch = Pitch_DefaultValue = new PlotOptionsLollipopSonificationContextTracksMappingPitch();
			PitchString = PitchString_DefaultValue = "null";
			PitchNumber = PitchNumber_DefaultValue = null;
			PlayDelay = PlayDelay_DefaultValue = new PlotOptionsLollipopSonificationContextTracksMappingPlayDelay();
			Time = Time_DefaultValue = new PlotOptionsLollipopSonificationContextTracksMappingTime();
			TimeString = TimeString_DefaultValue = "null";
			TimeNumber = TimeNumber_DefaultValue = null;
			Tremolo = Tremolo_DefaultValue = new PlotOptionsLollipopSonificationContextTracksMappingTremolo();
			Volume = Volume_DefaultValue = new PlotOptionsLollipopSonificationContextTracksMappingVolume();
		...
		/// </summary>
		public PlotOptionsLollipopSonificationContextTracksMappingFrequency Frequency { get; set; }
		private PlotOptionsLollipopSonificationContextTracksMappingFrequency Frequency_DefaultValue { get; set; }
		...
		/// </summary>
		public PlotOptionsLollipopSonificationContextTracksMappingGapBetweenNotes GapBetweenNotes { get; set; }
		private PlotOptionsLollipopSonificationContextTracksMappingGapBetweenNotes GapBetweenNotes_DefaultValue { get; set; }
		...
		/// </summary>
		public PlotOptionsLollipopSonificationContextTracksMappingHighpass Highpass { get; set; }
		private PlotOptionsLollipopSonificationContextTracksMappingHighpass Highpass_DefaultValue { get; set; }
		...
		/// </summary>
		public PlotOptionsLollipopSonificationContextTracksMappingLowpass Lowpass { get; set; }
		private PlotOptionsLollipopSonificationContextTracksMappingLowpass Lowpass_DefaultValue { get; set; }
		...
		/// </summary>
		public PlotOptionsLollipopSonificationContextTracksMappingNoteDuration NoteDuration { get; set; }
		private PlotOptionsLollipopSonificationContextTracksMappingNoteDuration NoteDuration_DefaultValue { get; set; }
		...
		/// </summary>
		public PlotOptionsLollipopSonificationContextTracksMappingPan Pan { get; set; }
		private PlotOptionsLollipopSonificationContextTracksMappingPan Pan_DefaultValue { get; set; }
		...
		/// </summary>
		public PlotOptionsLollipopSonificationContextTracksMappingPitch Pitch { get; set; }
		private PlotOptionsLollipopSonificationContextTracksMappingPitch Pitch_DefaultValue { get; set; }
		...
		/// </summary>
		public PlotOptionsLollipopSonificationContextTracksMappingPlayDelay PlayDelay { get; set; }
		private PlotOptionsLollipopSonificationContextTracksMappingPlayDelay PlayDelay_DefaultValue { get; set; }
		...
		/// </summary>
		public PlotOptionsLollipopSonificationContextTracksMappingTime Time { get; set; }
		private PlotOptionsLollipopSonificationContextTracksMappingTime Time_DefaultValue { get; set; }
		...
		/// </summary>
		public PlotOptionsLollipopSonificationContextTracksMappingTremolo Tremolo { get; set; }
		private PlotOptionsLollipopSonificationContextTracksMappingTremolo Tremolo_DefaultValue { get; set; }
		 

		/// <summary>
		/// The volume of notes, from 0 to 1.
		/// </summary>
		public PlotOptionsLollipopSonificationContextTracksMappingVolume Volume { get; set; }
		private PlotOptionsLollipopSonificationContextTracksMappingVolume Volume_DefaultValue { get; set; }
