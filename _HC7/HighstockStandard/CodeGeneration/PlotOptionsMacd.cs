...
{
	public partial class PlotOptionsMacd  : BaseObject
	{
		Hashtable h = new Hashtable();

		public PlotOptionsMacd()
		{
			Accessibility = Accessibility_DefaultValue = new PlotOptionsMacdAccessibility();
			AllowPointSelect = AllowPointSelect_DefaultValue = false;
			Animation = Animation_DefaultValue = new Animation() { Enabled = true };
			AnimationBool = AnimationBool_DefaultValue = true;
			AnimationLimit = AnimationLimit_DefaultValue = null;
			BoostBlending = BoostBlending_DefaultValue = PlotOptionsMacdBoostBlending.Undefined;
			...
			Compare = Compare_DefaultValue = PlotOptionsMacdCompare.Percent;
			CompareBase = CompareBase_DefaultValue = PlotOptionsMacdCompareBase.Min;
			...
			Cursor = Cursor_DefaultValue = PlotOptionsMacdCursor.Null;
			Custom = Custom_DefaultValue = new Hashtable();
			DashStyle = DashStyle_DefaultValue = PlotOptionsMacdDashStyle.Null;
			DataGrouping = DataGrouping_DefaultValue = new PlotOptionsMacdDataGrouping();
			DataLabels = DataLabels_DefaultValue = new PlotOptionsMacdDataLabels();
			DataSorting = DataSorting_DefaultValue = new PlotOptionsMacdDataSorting();
			Description = Description_DefaultValue = "";
			EnableMouseTracking = EnableMouseTracking_DefaultValue = true;
			Events = Events_DefaultValue = new PlotOptionsMacdEvents();
			FindNearestPointBy = FindNearestPointBy_DefaultValue = PlotOptionsMacdFindNearestPointBy.X;
			GapSize = GapSize_DefaultValue = 0;
			GapUnit = GapUnit_DefaultValue = PlotOptionsMacdGapUnit.Relative;
			...
			Label = Label_DefaultValue = new PlotOptionsMacdLabel();
			LastPrice = LastPrice_DefaultValue = new PlotOptionsMacdLastPrice();
			LastVisiblePrice = LastVisiblePrice_DefaultValue = new PlotOptionsMacdLastVisiblePrice();
			LegendSymbol = LegendSymbol_DefaultValue = PlotOptionsMacdLegendSymbol.Rectangle;
			Linecap = Linecap_DefaultValue = PlotOptionsMacdLinecap.Round;
			LineWidth = LineWidth_DefaultValue = 2;
			LinkedTo = LinkedTo_DefaultValue = "";
			MacdLine = MacdLine_DefaultValue = new PlotOptionsMacdMacdLine();
			Marker = Marker_DefaultValue = new PlotOptionsMacdMarker();
			MinPointLength = MinPointLength_DefaultValue = 0;
			NegativeColor = NegativeColor_DefaultValue = "";
			OnPoint = OnPoint_DefaultValue = new PlotOptionsMacdOnPoint();
			Opacity = Opacity_DefaultValue = 1;
			Params = Params_DefaultValue = new PlotOptionsMacdParams();
			Point = Point_DefaultValue = new PlotOptionsMacdPoint();
			...
			Sonification = Sonification_DefaultValue = new PlotOptionsMacdSonification();
			States = States_DefaultValue = new PlotOptionsMacdStates();
			Step = Step_DefaultValue = PlotOptionsMacdStep.Null;
			...
			Zones = Zones_DefaultValue = new List<PlotOptionsMacdZones>();
		...
		/// </summary>
		public PlotOptionsMacdAccessibility Accessibility { get; set; }
		private PlotOptionsMacdAccessibility Accessibility_DefaultValue { get; set; }
		...
		/// </summary>
		public PlotOptionsMacdBoostBlending BoostBlending { get; set; }
		private PlotOptionsMacdBoostBlending BoostBlending_DefaultValue { get; set; }
		...
		/// </summary>
		public PlotOptionsMacdCompare Compare { get; set; }
		private PlotOptionsMacdCompare Compare_DefaultValue { get; set; }
		 

		/// <summary>
		/// When [compare](#plotOptions.series.compare) is `percent`, this optiondictates whether to use 0 or 100 as the base of comparison.
		/// </summary>
		public PlotOptionsMacdCompareBase CompareBase { get; set; }
		private PlotOptionsMacdCompareBase CompareBase_DefaultValue { get; set; }
		...
		/// </summary>
		public PlotOptionsMacdCursor Cursor { get; set; }
		private PlotOptionsMacdCursor Cursor_DefaultValue { get; set; }
		...
		/// </summary>
		public PlotOptionsMacdDashStyle DashStyle { get; set; }
		private PlotOptionsMacdDashStyle DashStyle_DefaultValue { get; set; }
		 

		/// <summary>
		/// 
		/// </summary>
		public PlotOptionsMacdDataGrouping DataGrouping { get; set; }
		private PlotOptionsMacdDataGrouping DataGrouping_DefaultValue { get; set; }
		...
		/// </summary>
		public PlotOptionsMacdDataSorting DataSorting { get; set; }
		private PlotOptionsMacdDataSorting DataSorting_DefaultValue { get; set; }
		...
		/// </summary>
		public PlotOptionsMacdFindNearestPointBy FindNearestPointBy { get; set; }
		private PlotOptionsMacdFindNearestPointBy FindNearestPointBy_DefaultValue { get; set; }
		...
		/// </summary>
		public PlotOptionsMacdLabel Label { get; set; }
		private PlotOptionsMacdLabel Label_DefaultValue { get; set; }
		 

		/// <summary>
		/// The line marks the last price from all points.
		/// </summary>
		public PlotOptionsMacdLastPrice LastPrice { get; set; }
		private PlotOptionsMacdLastPrice LastPrice_DefaultValue { get; set; }
		 

		/// <summary>
		/// The line marks the last price from visible range of points.
		/// </summary>
		public PlotOptionsMacdLastVisiblePrice LastVisiblePrice { get; set; }
		private PlotOptionsMacdLastVisiblePrice LastVisiblePrice_DefaultValue { get; set; }
		 

		/// <summary>
		/// What type of legend symbol to render for this series. Can be one of`areaMarker`, `lineMarker` or `rectangle`.
		/// </summary>
		public PlotOptionsMacdLegendSymbol LegendSymbol { get; set; }
		private PlotOptionsMacdLegendSymbol LegendSymbol_DefaultValue { get; set; }
		 

		/// <summary>
		/// The line cap used for line ends and line joins on the graph.
		/// </summary>
		public PlotOptionsMacdLinecap Linecap { get; set; }
		private PlotOptionsMacdLinecap Linecap_DefaultValue { get; set; }
		...
		/// </summary>
		public PlotOptionsMacdMarker Marker { get; set; }
		private PlotOptionsMacdMarker Marker_DefaultValue { get; set; }
		...
		/// </summary>
		public PlotOptionsMacdOnPoint OnPoint { get; set; }
		private PlotOptionsMacdOnPoint OnPoint_DefaultValue { get; set; }
		...
		/// 
		/// </summary>
		public PlotOptionsMacdParams Params { get; set; }
		private PlotOptionsMacdParams Params_DefaultValue { get; set; }
		 

		/// <summary>
		/// Properties for each single point.
		/// </summary>
		public PlotOptionsMacdPoint Point { get; set; }
		private PlotOptionsMacdPoint Point_DefaultValue { get; set; }
		...
		/// </summary>
		public PlotOptionsMacdSonification Sonification { get; set; }
		private PlotOptionsMacdSonification Sonification_DefaultValue { get; set; }
		 

		/// <summary>
		/// 
		/// </summary>
		public PlotOptionsMacdStates States { get; set; }
		private PlotOptionsMacdStates States_DefaultValue { get; set; }
		 

		/// <summary>
		/// Whether to apply steps to the line. Possible values are `left`,`center` and `right`.
		/// </summary>
		public PlotOptionsMacdStep Step { get; set; }
		private PlotOptionsMacdStep Step_DefaultValue { get; set; }
		...
		/// 
		/// </summary>
		public PlotOptionsMacdTooltip Tooltip { get; set; }
		private PlotOptionsMacdTooltip Tooltip_DefaultValue { get; set; }
		...
		/// </summary>
		public List<PlotOptionsMacdZones> Zones { get; set; }
		private List<PlotOptionsMacdZones> Zones_DefaultValue { get; set; }
