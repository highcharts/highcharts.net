...
namespace Highsoft.Web.Mvc.Stocks
{
	public partial class PlotOptionsMacdDataLabels  : BaseObject
	{
		...
		{
			Align = Align_DefaultValue = PlotOptionsMacdDataLabelsAlign.Left;
			...
			Style = Style_DefaultValue = new PlotOptionsMacdDataLabelsStyle();
			UseHTML = UseHTML_DefaultValue = false;
			VerticalAlign = VerticalAlign_DefaultValue = PlotOptionsMacdDataLabelsVerticalAlign.Top;
		...
		/// 
		/// </summary>
		public PlotOptionsMacdDataLabelsStyle Style { get; set; }
		private PlotOptionsMacdDataLabelsStyle Style_DefaultValue { get; set; }
		...
		internal override Hashtable ToHashtable()
		{
			...
			if (Formatter != Formatter_DefaultValue) { h.Add("formatter",Formatter); Highstock.AddFunction("PlotOptionsMacdDataLabelsFormatter.formatter", Formatter); }  
