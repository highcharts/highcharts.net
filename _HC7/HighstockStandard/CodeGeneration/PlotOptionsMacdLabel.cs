...
{
	public partial class PlotOptionsMacdLabel  : BaseObject
	{
		public PlotOptionsMacdLabel()
		{
			...
			Style = Style_DefaultValue = new PlotOptionsMacdLabelStyle();
		...
		/// </summary>
		public PlotOptionsMacdLabelStyle Style { get; set; }
		private PlotOptionsMacdLabelStyle Style_DefaultValue { get; set; }
