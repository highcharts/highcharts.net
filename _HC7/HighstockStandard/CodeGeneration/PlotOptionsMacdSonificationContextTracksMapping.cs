...
{
	public partial class PlotOptionsMacdSonificationContextTracksMapping  : BaseObject
	{
		Hashtable h = new Hashtable();

		public PlotOptionsMacdSonificationContextTracksMapping()
		{
			Frequency = Frequency_DefaultValue = new PlotOptionsMacdSonificationContextTracksMappingFrequency();
			GapBetweenNotes = GapBetweenNotes_DefaultValue = new PlotOptionsMacdSonificationContextTracksMappingGapBetweenNotes();
			Highpass = Highpass_DefaultValue = new PlotOptionsMacdSonificationContextTracksMappingHighpass();
			Lowpass = Lowpass_DefaultValue = new PlotOptionsMacdSonificationContextTracksMappingLowpass();
			NoteDuration = NoteDuration_DefaultValue = new PlotOptionsMacdSonificationContextTracksMappingNoteDuration();
			Pan = Pan_DefaultValue = new PlotOptionsMacdSonificationContextTracksMappingPan();
			Pitch = Pitch_DefaultValue = new PlotOptionsMacdSonificationContextTracksMappingPitch();
			PitchString = PitchString_DefaultValue = "null";
			PitchNumber = PitchNumber_DefaultValue = null;
			PlayDelay = PlayDelay_DefaultValue = new PlotOptionsMacdSonificationContextTracksMappingPlayDelay();
			Time = Time_DefaultValue = new PlotOptionsMacdSonificationContextTracksMappingTime();
			TimeString = TimeString_DefaultValue = "null";
			TimeNumber = TimeNumber_DefaultValue = null;
			Tremolo = Tremolo_DefaultValue = new PlotOptionsMacdSonificationContextTracksMappingTremolo();
			Volume = Volume_DefaultValue = new PlotOptionsMacdSonificationContextTracksMappingVolume();
		...
		/// </summary>
		public PlotOptionsMacdSonificationContextTracksMappingFrequency Frequency { get; set; }
		private PlotOptionsMacdSonificationContextTracksMappingFrequency Frequency_DefaultValue { get; set; }
		...
		/// </summary>
		public PlotOptionsMacdSonificationContextTracksMappingGapBetweenNotes GapBetweenNotes { get; set; }
		private PlotOptionsMacdSonificationContextTracksMappingGapBetweenNotes GapBetweenNotes_DefaultValue { get; set; }
		...
		/// </summary>
		public PlotOptionsMacdSonificationContextTracksMappingHighpass Highpass { get; set; }
		private PlotOptionsMacdSonificationContextTracksMappingHighpass Highpass_DefaultValue { get; set; }
		...
		/// </summary>
		public PlotOptionsMacdSonificationContextTracksMappingLowpass Lowpass { get; set; }
		private PlotOptionsMacdSonificationContextTracksMappingLowpass Lowpass_DefaultValue { get; set; }
		...
		/// </summary>
		public PlotOptionsMacdSonificationContextTracksMappingNoteDuration NoteDuration { get; set; }
		private PlotOptionsMacdSonificationContextTracksMappingNoteDuration NoteDuration_DefaultValue { get; set; }
		...
		/// </summary>
		public PlotOptionsMacdSonificationContextTracksMappingPan Pan { get; set; }
		private PlotOptionsMacdSonificationContextTracksMappingPan Pan_DefaultValue { get; set; }
		...
		/// </summary>
		public PlotOptionsMacdSonificationContextTracksMappingPitch Pitch { get; set; }
		private PlotOptionsMacdSonificationContextTracksMappingPitch Pitch_DefaultValue { get; set; }
		...
		/// </summary>
		public PlotOptionsMacdSonificationContextTracksMappingPlayDelay PlayDelay { get; set; }
		private PlotOptionsMacdSonificationContextTracksMappingPlayDelay PlayDelay_DefaultValue { get; set; }
		...
		/// </summary>
		public PlotOptionsMacdSonificationContextTracksMappingTime Time { get; set; }
		private PlotOptionsMacdSonificationContextTracksMappingTime Time_DefaultValue { get; set; }
		...
		/// </summary>
		public PlotOptionsMacdSonificationContextTracksMappingTremolo Tremolo { get; set; }
		private PlotOptionsMacdSonificationContextTracksMappingTremolo Tremolo_DefaultValue { get; set; }
		 

		/// <summary>
		/// The volume of notes, from 0 to 1.
		/// </summary>
		public PlotOptionsMacdSonificationContextTracksMappingVolume Volume { get; set; }
		private PlotOptionsMacdSonificationContextTracksMappingVolume Volume_DefaultValue { get; set; }
