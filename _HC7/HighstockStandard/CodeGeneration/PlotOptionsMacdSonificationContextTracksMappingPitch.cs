...
{
	public partial class PlotOptionsMacdSonificationContextTracksMappingPitch  : BaseObject
	{
		Hashtable h = new Hashtable();

		public PlotOptionsMacdSonificationContextTracksMappingPitch()
		{
			MapFunction = MapFunction_DefaultValue = PlotOptionsMacdSonificationContextTracksMappingPitchMapFunction.Linear;
		...
		/// </summary>
		public PlotOptionsMacdSonificationContextTracksMappingPitchMapFunction MapFunction { get; set; }
		private PlotOptionsMacdSonificationContextTracksMappingPitchMapFunction MapFunction_DefaultValue { get; set; }
