...
{
	public partial class PlotOptionsMacdSonificationContextTracksMappingPlayDelay  : BaseObject
	{
		Hashtable h = new Hashtable();

		public PlotOptionsMacdSonificationContextTracksMappingPlayDelay()
		{
			MapFunction = MapFunction_DefaultValue = PlotOptionsMacdSonificationContextTracksMappingPlayDelayMapFunction.Linear;
			MapTo = MapTo_DefaultValue = "";
			Max = Max_DefaultValue = null;
			Min = Min_DefaultValue = null;
			Value = Value_DefaultValue = null;
			Within = Within_DefaultValue = PlotOptionsMacdSonificationContextTracksMappingPlayDelayWithin.Chart;
		...
		/// </summary>
		public PlotOptionsMacdSonificationContextTracksMappingPlayDelayMapFunction MapFunction { get; set; }
		private PlotOptionsMacdSonificationContextTracksMappingPlayDelayMapFunction MapFunction_DefaultValue { get; set; }
		...
		/// </summary>
		public PlotOptionsMacdSonificationContextTracksMappingPlayDelayWithin Within { get; set; }
		private PlotOptionsMacdSonificationContextTracksMappingPlayDelayWithin Within_DefaultValue { get; set; }
