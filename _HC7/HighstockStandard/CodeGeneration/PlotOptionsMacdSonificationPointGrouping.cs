...
{
	public partial class PlotOptionsMacdSonificationPointGrouping  : BaseObject
	{
		Hashtable h = new Hashtable();

		public PlotOptionsMacdSonificationPointGrouping()
		{
			Algorithm = Algorithm_DefaultValue = PlotOptionsMacdSonificationPointGroupingAlgorithm.Minimax;
		...
		/// </summary>
		public PlotOptionsMacdSonificationPointGroupingAlgorithm Algorithm { get; set; }
		private PlotOptionsMacdSonificationPointGroupingAlgorithm Algorithm_DefaultValue { get; set; }
