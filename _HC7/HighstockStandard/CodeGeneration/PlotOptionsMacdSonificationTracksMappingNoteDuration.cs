...
{
	public partial class PlotOptionsMacdSonificationTracksMappingNoteDuration  : BaseObject
	{
		Hashtable h = new Hashtable();

		public PlotOptionsMacdSonificationTracksMappingNoteDuration()
		{
			MapFunction = MapFunction_DefaultValue = PlotOptionsMacdSonificationTracksMappingNoteDurationMapFunction.Linear;
			MapTo = MapTo_DefaultValue = "";
			Max = Max_DefaultValue = null;
			Min = Min_DefaultValue = null;
			Value = Value_DefaultValue = null;
			Within = Within_DefaultValue = PlotOptionsMacdSonificationTracksMappingNoteDurationWithin.Chart;
		...
		/// </summary>
		public PlotOptionsMacdSonificationTracksMappingNoteDurationMapFunction MapFunction { get; set; }
		private PlotOptionsMacdSonificationTracksMappingNoteDurationMapFunction MapFunction_DefaultValue { get; set; }
		...
		/// </summary>
		public PlotOptionsMacdSonificationTracksMappingNoteDurationWithin Within { get; set; }
		private PlotOptionsMacdSonificationTracksMappingNoteDurationWithin Within_DefaultValue { get; set; }
