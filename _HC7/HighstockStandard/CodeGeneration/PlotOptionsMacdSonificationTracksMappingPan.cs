...
{
	public partial class PlotOptionsMacdSonificationTracksMappingPan  : BaseObject
	{
		Hashtable h = new Hashtable();

		public PlotOptionsMacdSonificationTracksMappingPan()
		{
			MapFunction = MapFunction_DefaultValue = PlotOptionsMacdSonificationTracksMappingPanMapFunction.Linear;
			MapTo = MapTo_DefaultValue = "";
			Max = Max_DefaultValue = null;
			Min = Min_DefaultValue = null;
			Value = Value_DefaultValue = null;
			Within = Within_DefaultValue = PlotOptionsMacdSonificationTracksMappingPanWithin.Chart;
		...
		/// </summary>
		public PlotOptionsMacdSonificationTracksMappingPanMapFunction MapFunction { get; set; }
		private PlotOptionsMacdSonificationTracksMappingPanMapFunction MapFunction_DefaultValue { get; set; }
		...
		/// </summary>
		public PlotOptionsMacdSonificationTracksMappingPanWithin Within { get; set; }
		private PlotOptionsMacdSonificationTracksMappingPanWithin Within_DefaultValue { get; set; }
