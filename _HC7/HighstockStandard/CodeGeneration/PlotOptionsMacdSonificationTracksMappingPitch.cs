...
{
	public partial class PlotOptionsMacdSonificationTracksMappingPitch  : BaseObject
	{
		Hashtable h = new Hashtable();

		public PlotOptionsMacdSonificationTracksMappingPitch()
		{
			MapFunction = MapFunction_DefaultValue = PlotOptionsMacdSonificationTracksMappingPitchMapFunction.Linear;
		...
		/// </summary>
		public PlotOptionsMacdSonificationTracksMappingPitchMapFunction MapFunction { get; set; }
		private PlotOptionsMacdSonificationTracksMappingPitchMapFunction MapFunction_DefaultValue { get; set; }
