...
{
	public partial class PlotOptionsMacdSonificationTracksMappingTime  : BaseObject
	{
		Hashtable h = new Hashtable();

		public PlotOptionsMacdSonificationTracksMappingTime()
		{
			MapFunction = MapFunction_DefaultValue = PlotOptionsMacdSonificationTracksMappingTimeMapFunction.Linear;
			MapTo = MapTo_DefaultValue = "";
			Max = Max_DefaultValue = null;
			Min = Min_DefaultValue = null;
			Value = Value_DefaultValue = null;
			Within = Within_DefaultValue = PlotOptionsMacdSonificationTracksMappingTimeWithin.Chart;
		...
		/// </summary>
		public PlotOptionsMacdSonificationTracksMappingTimeMapFunction MapFunction { get; set; }
		private PlotOptionsMacdSonificationTracksMappingTimeMapFunction MapFunction_DefaultValue { get; set; }
		...
		/// </summary>
		public PlotOptionsMacdSonificationTracksMappingTimeWithin Within { get; set; }
		private PlotOptionsMacdSonificationTracksMappingTimeWithin Within_DefaultValue { get; set; }
