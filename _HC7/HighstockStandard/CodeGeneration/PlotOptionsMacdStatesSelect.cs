...
{
	public partial class PlotOptionsMacdStatesSelect  : BaseObject
	{
		public PlotOptionsMacdStatesSelect()
		{
			Animation = Animation_DefaultValue = new Animation() { Enabled = true };
			Enabled = Enabled_DefaultValue = true;
			Halo = Halo_DefaultValue = new PlotOptionsMacdStatesSelectHalo();
			LineWidth = LineWidth_DefaultValue = null;
			LineWidthPlus = LineWidthPlus_DefaultValue = 1;
			Marker = Marker_DefaultValue = new PlotOptionsMacdStatesSelectMarker();
		...
		/// </summary>
		public PlotOptionsMacdStatesSelectHalo Halo { get; set; }
		private PlotOptionsMacdStatesSelectHalo Halo_DefaultValue { get; set; }
		...
		/// </summary>
		public PlotOptionsMacdStatesSelectMarker Marker { get; set; }
		private PlotOptionsMacdStatesSelectMarker Marker_DefaultValue { get; set; }
