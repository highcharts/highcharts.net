...
{
	public partial class PlotOptionsMfi  : BaseObject
	{
		Hashtable h = new Hashtable();

		public PlotOptionsMfi()
		{
			Accessibility = Accessibility_DefaultValue = new PlotOptionsMfiAccessibility();
			AllowPointSelect = AllowPointSelect_DefaultValue = false;
			Animation = Animation_DefaultValue = new Animation() { Enabled = true };
			AnimationBool = AnimationBool_DefaultValue = true;
			AnimationLimit = AnimationLimit_DefaultValue = null;
			BoostBlending = BoostBlending_DefaultValue = PlotOptionsMfiBoostBlending.Undefined;
			...
			Compare = Compare_DefaultValue = PlotOptionsMfiCompare.Percent;
			CompareBase = CompareBase_DefaultValue = PlotOptionsMfiCompareBase.Min;
			...
			Cursor = Cursor_DefaultValue = PlotOptionsMfiCursor.Null;
			Custom = Custom_DefaultValue = new Hashtable();
			DashStyle = DashStyle_DefaultValue = PlotOptionsMfiDashStyle.Null;
			DataGrouping = DataGrouping_DefaultValue = new PlotOptionsMfiDataGrouping();
			DataLabels = DataLabels_DefaultValue = new PlotOptionsMfiDataLabels();
			DataSorting = DataSorting_DefaultValue = new PlotOptionsMfiDataSorting();
			Description = Description_DefaultValue = "";
			EnableMouseTracking = EnableMouseTracking_DefaultValue = true;
			Events = Events_DefaultValue = new PlotOptionsMfiEvents();
			FindNearestPointBy = FindNearestPointBy_DefaultValue = PlotOptionsMfiFindNearestPointBy.X;
			GapSize = GapSize_DefaultValue = 0;
			GapUnit = GapUnit_DefaultValue = PlotOptionsMfiGapUnit.Relative;
			GetExtremesFromAll = GetExtremesFromAll_DefaultValue = false;
			InactiveOtherPoints = InactiveOtherPoints_DefaultValue = false;
			IncludeInDataExport = IncludeInDataExport_DefaultValue = null;
			Label = Label_DefaultValue = new PlotOptionsMfiLabel();
			LastPrice = LastPrice_DefaultValue = new PlotOptionsMfiLastPrice();
			LastVisiblePrice = LastVisiblePrice_DefaultValue = new PlotOptionsMfiLastVisiblePrice();
			LegendSymbol = LegendSymbol_DefaultValue = PlotOptionsMfiLegendSymbol.Rectangle;
			Linecap = Linecap_DefaultValue = PlotOptionsMfiLinecap.Round;
			LineWidth = LineWidth_DefaultValue = 2;
			LinkedTo = LinkedTo_DefaultValue = "";
			Marker = Marker_DefaultValue = new PlotOptionsMfiMarker();
			NegativeColor = NegativeColor_DefaultValue = "";
			OnPoint = OnPoint_DefaultValue = new PlotOptionsMfiOnPoint();
			Opacity = Opacity_DefaultValue = 1;
			Params = Params_DefaultValue = new PlotOptionsMfiParams();
			Point = Point_DefaultValue = new PlotOptionsMfiPoint();
			...
			Sonification = Sonification_DefaultValue = new PlotOptionsMfiSonification();
			States = States_DefaultValue = new PlotOptionsMfiStates();
			Step = Step_DefaultValue = PlotOptionsMfiStep.Null;
			StickyTracking = StickyTracking_DefaultValue = true;
			Threshold = Threshold_DefaultValue = 0;
			Tooltip = Tooltip_DefaultValue = new PlotOptionsMfiTooltip();
			TurboThreshold = TurboThreshold_DefaultValue = 1000;
			Visible = Visible_DefaultValue = true;
			ZoneAxis = ZoneAxis_DefaultValue = "y";
			Zones = Zones_DefaultValue = new List<PlotOptionsMfiZones>();
		...
		/// </summary>
		public PlotOptionsMfiAccessibility Accessibility { get; set; }
		private PlotOptionsMfiAccessibility Accessibility_DefaultValue { get; set; }
		...
		/// </summary>
		public PlotOptionsMfiBoostBlending BoostBlending { get; set; }
		private PlotOptionsMfiBoostBlending BoostBlending_DefaultValue { get; set; }
		...
		/// </summary>
		public PlotOptionsMfiCompare Compare { get; set; }
		private PlotOptionsMfiCompare Compare_DefaultValue { get; set; }
		 

		/// <summary>
		/// When [compare](#plotOptions.series.compare) is `percent`, this optiondictates whether to use 0 or 100 as the base of comparison.
		/// </summary>
		public PlotOptionsMfiCompareBase CompareBase { get; set; }
		private PlotOptionsMfiCompareBase CompareBase_DefaultValue { get; set; }
		...
		/// </summary>
		public PlotOptionsMfiCursor Cursor { get; set; }
		private PlotOptionsMfiCursor Cursor_DefaultValue { get; set; }
		...
		/// </summary>
		public PlotOptionsMfiDashStyle DashStyle { get; set; }
		private PlotOptionsMfiDashStyle DashStyle_DefaultValue { get; set; }
		...
		/// </summary>
		public PlotOptionsMfiDataGrouping DataGrouping { get; set; }
		private PlotOptionsMfiDataGrouping DataGrouping_DefaultValue { get; set; }
		...
		/// </summary>
		public PlotOptionsMfiDataLabels DataLabels { get; set; }
		private PlotOptionsMfiDataLabels DataLabels_DefaultValue { get; set; }
		 

		/// <summary>
		/// Options for the series data sorting.
		/// </summary>
		public PlotOptionsMfiDataSorting DataSorting { get; set; }
		private PlotOptionsMfiDataSorting DataSorting_DefaultValue { get; set; }
		...
		/// </summary>
		public PlotOptionsMfiEvents Events { get; set; }
		private PlotOptionsMfiEvents Events_DefaultValue { get; set; }
		...
		/// </summary>
		public PlotOptionsMfiFindNearestPointBy FindNearestPointBy { get; set; }
		private PlotOptionsMfiFindNearestPointBy FindNearestPointBy_DefaultValue { get; set; }
		...
		/// </summary>
		public PlotOptionsMfiGapUnit GapUnit { get; set; }
		private PlotOptionsMfiGapUnit GapUnit_DefaultValue { get; set; }
		...
		/// </summary>
		public PlotOptionsMfiLabel Label { get; set; }
		private PlotOptionsMfiLabel Label_DefaultValue { get; set; }
		 

		/// <summary>
		/// The line marks the last price from all points.
		/// </summary>
		public PlotOptionsMfiLastPrice LastPrice { get; set; }
		private PlotOptionsMfiLastPrice LastPrice_DefaultValue { get; set; }
		 

		/// <summary>
		/// The line marks the last price from visible range of points.
		/// </summary>
		public PlotOptionsMfiLastVisiblePrice LastVisiblePrice { get; set; }
		private PlotOptionsMfiLastVisiblePrice LastVisiblePrice_DefaultValue { get; set; }
		 

		/// <summary>
		/// What type of legend symbol to render for this series. Can be one of`lineMarker` or `rectangle`.
		/// </summary>
		public PlotOptionsMfiLegendSymbol LegendSymbol { get; set; }
		private PlotOptionsMfiLegendSymbol LegendSymbol_DefaultValue { get; set; }
		 

		/// <summary>
		/// The line cap used for line ends and line joins on the graph.
		/// </summary>
		public PlotOptionsMfiLinecap Linecap { get; set; }
		private PlotOptionsMfiLinecap Linecap_DefaultValue { get; set; }
		...
		/// </summary>
		public PlotOptionsMfiMarker Marker { get; set; }
		private PlotOptionsMfiMarker Marker_DefaultValue { get; set; }
		...
		/// </summary>
		public PlotOptionsMfiOnPoint OnPoint { get; set; }
		private PlotOptionsMfiOnPoint OnPoint_DefaultValue { get; set; }
		...
		/// 
		/// </summary>
		public PlotOptionsMfiParams Params { get; set; }
		private PlotOptionsMfiParams Params_DefaultValue { get; set; }
		 

		/// <summary>
		/// Properties for each single point.
		/// </summary>
		public PlotOptionsMfiPoint Point { get; set; }
		private PlotOptionsMfiPoint Point_DefaultValue { get; set; }
		...
		/// </summary>
		public PlotOptionsMfiSonification Sonification { get; set; }
		private PlotOptionsMfiSonification Sonification_DefaultValue { get; set; }
		 

		/// <summary>
		/// 
		/// </summary>
		public PlotOptionsMfiStates States { get; set; }
		private PlotOptionsMfiStates States_DefaultValue { get; set; }
		 

		/// <summary>
		/// Whether to apply steps to the line. Possible values are `left`,`center` and `right`.
		/// </summary>
		public PlotOptionsMfiStep Step { get; set; }
		private PlotOptionsMfiStep Step_DefaultValue { get; set; }
		...
		/// </summary>
		public PlotOptionsMfiTooltip Tooltip { get; set; }
		private PlotOptionsMfiTooltip Tooltip_DefaultValue { get; set; }
		...
		/// </summary>
		public List<PlotOptionsMfiZones> Zones { get; set; }
		private List<PlotOptionsMfiZones> Zones_DefaultValue { get; set; }
