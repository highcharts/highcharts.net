...
namespace Highsoft.Web.Mvc.Stocks
{
	public partial class PlotOptionsMfi  : BaseObject
	{
		...
		public PlotOptionsMfi()
		{
			...
			Zones = Zones_DefaultValue = new List<PlotOptionsMfiZone>();
		...
		/// </summary>
		public List<PlotOptionsMfiZone> Zones { get; set; }
		private List<PlotOptionsMfiZone> Zones_DefaultValue { get; set; }
