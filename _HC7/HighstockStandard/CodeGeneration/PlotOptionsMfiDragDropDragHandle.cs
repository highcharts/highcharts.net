...
{
	public partial class PlotOptionsMfiDragDropDragHandle  : BaseObject
	{
		public PlotOptionsMfiDragDropDragHandle()
		{
		...
		internal override Hashtable ToHashtable()
		{
			...
			if (PathFormatter != PathFormatter_DefaultValue) { h.Add("pathFormatter",PathFormatter); Highstock.AddFunction("PlotOptionsMfiDragDropDragHandlePathFormatter.pathFormatter", PathFormatter); }  
