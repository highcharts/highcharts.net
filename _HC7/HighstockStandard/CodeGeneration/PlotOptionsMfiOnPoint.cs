...
{
	public partial class PlotOptionsMfiOnPoint  : BaseObject
	{
		Hashtable h = new Hashtable();

		public PlotOptionsMfiOnPoint()
		{
			ConnectorOptions = ConnectorOptions_DefaultValue = new PlotOptionsMfiOnPointConnectorOptions();
			Id = Id_DefaultValue = "";
			Position = Position_DefaultValue = new PlotOptionsMfiOnPointPosition();
		...
		/// </summary>
		public PlotOptionsMfiOnPointConnectorOptions ConnectorOptions { get; set; }
		private PlotOptionsMfiOnPointConnectorOptions ConnectorOptions_DefaultValue { get; set; }
		...
		/// </summary>
		public PlotOptionsMfiOnPointPosition Position { get; set; }
		private PlotOptionsMfiOnPointPosition Position_DefaultValue { get; set; }
