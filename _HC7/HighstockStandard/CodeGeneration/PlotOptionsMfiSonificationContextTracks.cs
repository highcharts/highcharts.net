...
{
	public partial class PlotOptionsMfiSonificationContextTracks  : BaseObject
	{
		Hashtable h = new Hashtable();

		public PlotOptionsMfiSonificationContextTracks()
		{
			ActiveWhen = ActiveWhen_DefaultValue = new PlotOptionsMfiSonificationContextTracksActiveWhen();
			Instrument = Instrument_DefaultValue = null;
			InstrumentString = InstrumentString_DefaultValue = "null";
			Mapping = Mapping_DefaultValue = new PlotOptionsMfiSonificationContextTracksMapping();
			MidiName = MidiName_DefaultValue = "";
			PointGrouping = PointGrouping_DefaultValue = new PlotOptionsMfiSonificationContextTracksPointGrouping();
			...
			Type = Type_DefaultValue = PlotOptionsMfiSonificationContextTracksType.Instrument;
			ValueInterval = ValueInterval_DefaultValue = null;
			ValueMapFunction = ValueMapFunction_DefaultValue = PlotOptionsMfiSonificationContextTracksValueMapFunction.Linear;
		...
		/// </summary>
		public PlotOptionsMfiSonificationContextTracksActiveWhen ActiveWhen { get; set; }
		private PlotOptionsMfiSonificationContextTracksActiveWhen ActiveWhen_DefaultValue { get; set; }
		...
		/// </summary>
		public PlotOptionsMfiSonificationContextTracksMapping Mapping { get; set; }
		private PlotOptionsMfiSonificationContextTracksMapping Mapping_DefaultValue { get; set; }
		...
		/// </summary>
		public PlotOptionsMfiSonificationContextTracksPointGrouping PointGrouping { get; set; }
		private PlotOptionsMfiSonificationContextTracksPointGrouping PointGrouping_DefaultValue { get; set; }
		...
		/// </summary>
		public PlotOptionsMfiSonificationContextTracksType Type { get; set; }
		private PlotOptionsMfiSonificationContextTracksType Type_DefaultValue { get; set; }
		...
		/// </summary>
		public PlotOptionsMfiSonificationContextTracksValueMapFunction ValueMapFunction { get; set; }
		private PlotOptionsMfiSonificationContextTracksValueMapFunction ValueMapFunction_DefaultValue { get; set; }
