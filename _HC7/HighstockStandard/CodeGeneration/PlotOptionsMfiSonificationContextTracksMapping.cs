...
{
	public partial class PlotOptionsMfiSonificationContextTracksMapping  : BaseObject
	{
		Hashtable h = new Hashtable();

		public PlotOptionsMfiSonificationContextTracksMapping()
		{
			Frequency = Frequency_DefaultValue = new PlotOptionsMfiSonificationContextTracksMappingFrequency();
			GapBetweenNotes = GapBetweenNotes_DefaultValue = new PlotOptionsMfiSonificationContextTracksMappingGapBetweenNotes();
			Highpass = Highpass_DefaultValue = new PlotOptionsMfiSonificationContextTracksMappingHighpass();
			Lowpass = Lowpass_DefaultValue = new PlotOptionsMfiSonificationContextTracksMappingLowpass();
			NoteDuration = NoteDuration_DefaultValue = new PlotOptionsMfiSonificationContextTracksMappingNoteDuration();
			Pan = Pan_DefaultValue = new PlotOptionsMfiSonificationContextTracksMappingPan();
			Pitch = Pitch_DefaultValue = new PlotOptionsMfiSonificationContextTracksMappingPitch();
			PitchString = PitchString_DefaultValue = "null";
			PitchNumber = PitchNumber_DefaultValue = null;
			PlayDelay = PlayDelay_DefaultValue = new PlotOptionsMfiSonificationContextTracksMappingPlayDelay();
			Time = Time_DefaultValue = new PlotOptionsMfiSonificationContextTracksMappingTime();
			TimeString = TimeString_DefaultValue = "null";
			TimeNumber = TimeNumber_DefaultValue = null;
			Tremolo = Tremolo_DefaultValue = new PlotOptionsMfiSonificationContextTracksMappingTremolo();
			Volume = Volume_DefaultValue = new PlotOptionsMfiSonificationContextTracksMappingVolume();
		...
		/// </summary>
		public PlotOptionsMfiSonificationContextTracksMappingFrequency Frequency { get; set; }
		private PlotOptionsMfiSonificationContextTracksMappingFrequency Frequency_DefaultValue { get; set; }
		...
		/// </summary>
		public PlotOptionsMfiSonificationContextTracksMappingGapBetweenNotes GapBetweenNotes { get; set; }
		private PlotOptionsMfiSonificationContextTracksMappingGapBetweenNotes GapBetweenNotes_DefaultValue { get; set; }
		...
		/// </summary>
		public PlotOptionsMfiSonificationContextTracksMappingHighpass Highpass { get; set; }
		private PlotOptionsMfiSonificationContextTracksMappingHighpass Highpass_DefaultValue { get; set; }
		...
		/// </summary>
		public PlotOptionsMfiSonificationContextTracksMappingLowpass Lowpass { get; set; }
		private PlotOptionsMfiSonificationContextTracksMappingLowpass Lowpass_DefaultValue { get; set; }
		...
		/// </summary>
		public PlotOptionsMfiSonificationContextTracksMappingNoteDuration NoteDuration { get; set; }
		private PlotOptionsMfiSonificationContextTracksMappingNoteDuration NoteDuration_DefaultValue { get; set; }
		...
		/// </summary>
		public PlotOptionsMfiSonificationContextTracksMappingPan Pan { get; set; }
		private PlotOptionsMfiSonificationContextTracksMappingPan Pan_DefaultValue { get; set; }
		...
		/// </summary>
		public PlotOptionsMfiSonificationContextTracksMappingPitch Pitch { get; set; }
		private PlotOptionsMfiSonificationContextTracksMappingPitch Pitch_DefaultValue { get; set; }
		...
		/// </summary>
		public PlotOptionsMfiSonificationContextTracksMappingPlayDelay PlayDelay { get; set; }
		private PlotOptionsMfiSonificationContextTracksMappingPlayDelay PlayDelay_DefaultValue { get; set; }
		...
		/// </summary>
		public PlotOptionsMfiSonificationContextTracksMappingTime Time { get; set; }
		private PlotOptionsMfiSonificationContextTracksMappingTime Time_DefaultValue { get; set; }
		...
		/// </summary>
		public PlotOptionsMfiSonificationContextTracksMappingTremolo Tremolo { get; set; }
		private PlotOptionsMfiSonificationContextTracksMappingTremolo Tremolo_DefaultValue { get; set; }
		 

		/// <summary>
		/// The volume of notes, from 0 to 1.
		/// </summary>
		public PlotOptionsMfiSonificationContextTracksMappingVolume Volume { get; set; }
		private PlotOptionsMfiSonificationContextTracksMappingVolume Volume_DefaultValue { get; set; }
