...
{
	public partial class PlotOptionsMfiSonificationContextTracksMappingLowpassFrequency  : BaseObject
	{
		Hashtable h = new Hashtable();

		public PlotOptionsMfiSonificationContextTracksMappingLowpassFrequency()
		{
			MapFunction = MapFunction_DefaultValue = PlotOptionsMfiSonificationContextTracksMappingLowpassFrequencyMapFunction.Linear;
			MapTo = MapTo_DefaultValue = "";
			Max = Max_DefaultValue = null;
			Min = Min_DefaultValue = null;
			Value = Value_DefaultValue = null;
			Within = Within_DefaultValue = PlotOptionsMfiSonificationContextTracksMappingLowpassFrequencyWithin.Chart;
		...
		/// </summary>
		public PlotOptionsMfiSonificationContextTracksMappingLowpassFrequencyMapFunction MapFunction { get; set; }
		private PlotOptionsMfiSonificationContextTracksMappingLowpassFrequencyMapFunction MapFunction_DefaultValue { get; set; }
		...
		/// </summary>
		public PlotOptionsMfiSonificationContextTracksMappingLowpassFrequencyWithin Within { get; set; }
		private PlotOptionsMfiSonificationContextTracksMappingLowpassFrequencyWithin Within_DefaultValue { get; set; }
