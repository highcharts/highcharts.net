...
{
	public partial class PlotOptionsMfiSonificationContextTracksMappingPitch  : BaseObject
	{
		Hashtable h = new Hashtable();

		public PlotOptionsMfiSonificationContextTracksMappingPitch()
		{
			MapFunction = MapFunction_DefaultValue = PlotOptionsMfiSonificationContextTracksMappingPitchMapFunction.Linear;
		...
		/// </summary>
		public PlotOptionsMfiSonificationContextTracksMappingPitchMapFunction MapFunction { get; set; }
		private PlotOptionsMfiSonificationContextTracksMappingPitchMapFunction MapFunction_DefaultValue { get; set; }
