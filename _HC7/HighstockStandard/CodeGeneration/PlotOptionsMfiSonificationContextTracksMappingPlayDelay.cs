...
{
	public partial class PlotOptionsMfiSonificationContextTracksMappingPlayDelay  : BaseObject
	{
		Hashtable h = new Hashtable();

		public PlotOptionsMfiSonificationContextTracksMappingPlayDelay()
		{
			MapFunction = MapFunction_DefaultValue = PlotOptionsMfiSonificationContextTracksMappingPlayDelayMapFunction.Linear;
			MapTo = MapTo_DefaultValue = "";
			Max = Max_DefaultValue = null;
			Min = Min_DefaultValue = null;
			Value = Value_DefaultValue = null;
			Within = Within_DefaultValue = PlotOptionsMfiSonificationContextTracksMappingPlayDelayWithin.Chart;
		...
		/// </summary>
		public PlotOptionsMfiSonificationContextTracksMappingPlayDelayMapFunction MapFunction { get; set; }
		private PlotOptionsMfiSonificationContextTracksMappingPlayDelayMapFunction MapFunction_DefaultValue { get; set; }
		...
		/// </summary>
		public PlotOptionsMfiSonificationContextTracksMappingPlayDelayWithin Within { get; set; }
		private PlotOptionsMfiSonificationContextTracksMappingPlayDelayWithin Within_DefaultValue { get; set; }
