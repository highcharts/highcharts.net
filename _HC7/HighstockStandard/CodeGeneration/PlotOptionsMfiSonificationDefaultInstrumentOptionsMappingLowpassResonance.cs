...
{
	public partial class PlotOptionsMfiSonificationDefaultInstrumentOptionsMappingLowpassResonance  : BaseObject
	{
		Hashtable h = new Hashtable();

		public PlotOptionsMfiSonificationDefaultInstrumentOptionsMappingLowpassResonance()
		{
			MapFunction = MapFunction_DefaultValue = PlotOptionsMfiSonificationDefaultInstrumentOptionsMappingLowpassResonanceMapFunction.Linear;
			MapTo = MapTo_DefaultValue = "";
			Max = Max_DefaultValue = null;
			Min = Min_DefaultValue = null;
			Value = Value_DefaultValue = null;
			Within = Within_DefaultValue = PlotOptionsMfiSonificationDefaultInstrumentOptionsMappingLowpassResonanceWithin.Chart;
		...
		/// </summary>
		public PlotOptionsMfiSonificationDefaultInstrumentOptionsMappingLowpassResonanceMapFunction MapFunction { get; set; }
		private PlotOptionsMfiSonificationDefaultInstrumentOptionsMappingLowpassResonanceMapFunction MapFunction_DefaultValue { get; set; }
		...
		/// </summary>
		public PlotOptionsMfiSonificationDefaultInstrumentOptionsMappingLowpassResonanceWithin Within { get; set; }
		private PlotOptionsMfiSonificationDefaultInstrumentOptionsMappingLowpassResonanceWithin Within_DefaultValue { get; set; }
