...
{
	public partial class PlotOptionsMfiSonificationTracks  : BaseObject
	{
		Hashtable h = new Hashtable();

		public PlotOptionsMfiSonificationTracks()
		{
			ActiveWhen = ActiveWhen_DefaultValue = new PlotOptionsMfiSonificationTracksActiveWhen();
			Instrument = Instrument_DefaultValue = null;
			InstrumentString = InstrumentString_DefaultValue = "null";
			Mapping = Mapping_DefaultValue = new PlotOptionsMfiSonificationTracksMapping();
			MidiName = MidiName_DefaultValue = "";
			PointGrouping = PointGrouping_DefaultValue = new PlotOptionsMfiSonificationTracksPointGrouping();
			RoundToMusicalNotes = RoundToMusicalNotes_DefaultValue = true;
			ShowPlayMarker = ShowPlayMarker_DefaultValue = true;
			Type = Type_DefaultValue = PlotOptionsMfiSonificationTracksType.Instrument;
		...
		/// </summary>
		public PlotOptionsMfiSonificationTracksActiveWhen ActiveWhen { get; set; }
		private PlotOptionsMfiSonificationTracksActiveWhen ActiveWhen_DefaultValue { get; set; }
		...
		/// </summary>
		public PlotOptionsMfiSonificationTracksMapping Mapping { get; set; }
		private PlotOptionsMfiSonificationTracksMapping Mapping_DefaultValue { get; set; }
		...
		/// </summary>
		public PlotOptionsMfiSonificationTracksPointGrouping PointGrouping { get; set; }
		private PlotOptionsMfiSonificationTracksPointGrouping PointGrouping_DefaultValue { get; set; }
		...
		/// </summary>
		public PlotOptionsMfiSonificationTracksType Type { get; set; }
		private PlotOptionsMfiSonificationTracksType Type_DefaultValue { get; set; }
