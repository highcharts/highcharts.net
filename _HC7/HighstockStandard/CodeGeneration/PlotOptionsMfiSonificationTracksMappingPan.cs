...
{
	public partial class PlotOptionsMfiSonificationTracksMappingPan  : BaseObject
	{
		Hashtable h = new Hashtable();

		public PlotOptionsMfiSonificationTracksMappingPan()
		{
			MapFunction = MapFunction_DefaultValue = PlotOptionsMfiSonificationTracksMappingPanMapFunction.Linear;
			MapTo = MapTo_DefaultValue = "";
			Max = Max_DefaultValue = null;
			Min = Min_DefaultValue = null;
			Value = Value_DefaultValue = null;
			Within = Within_DefaultValue = PlotOptionsMfiSonificationTracksMappingPanWithin.Chart;
		...
		/// </summary>
		public PlotOptionsMfiSonificationTracksMappingPanMapFunction MapFunction { get; set; }
		private PlotOptionsMfiSonificationTracksMappingPanMapFunction MapFunction_DefaultValue { get; set; }
		...
		/// </summary>
		public PlotOptionsMfiSonificationTracksMappingPanWithin Within { get; set; }
		private PlotOptionsMfiSonificationTracksMappingPanWithin Within_DefaultValue { get; set; }
