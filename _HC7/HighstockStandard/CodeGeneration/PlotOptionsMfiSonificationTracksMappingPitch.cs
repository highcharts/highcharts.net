...
{
	public partial class PlotOptionsMfiSonificationTracksMappingPitch  : BaseObject
	{
		Hashtable h = new Hashtable();

		public PlotOptionsMfiSonificationTracksMappingPitch()
		{
			MapFunction = MapFunction_DefaultValue = PlotOptionsMfiSonificationTracksMappingPitchMapFunction.Linear;
		...
		/// </summary>
		public PlotOptionsMfiSonificationTracksMappingPitchMapFunction MapFunction { get; set; }
		private PlotOptionsMfiSonificationTracksMappingPitchMapFunction MapFunction_DefaultValue { get; set; }
