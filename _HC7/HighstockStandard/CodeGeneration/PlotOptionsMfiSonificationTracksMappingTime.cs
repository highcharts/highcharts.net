...
{
	public partial class PlotOptionsMfiSonificationTracksMappingTime  : BaseObject
	{
		Hashtable h = new Hashtable();

		public PlotOptionsMfiSonificationTracksMappingTime()
		{
			MapFunction = MapFunction_DefaultValue = PlotOptionsMfiSonificationTracksMappingTimeMapFunction.Linear;
			MapTo = MapTo_DefaultValue = "";
			Max = Max_DefaultValue = null;
			Min = Min_DefaultValue = null;
			Value = Value_DefaultValue = null;
			Within = Within_DefaultValue = PlotOptionsMfiSonificationTracksMappingTimeWithin.Chart;
		...
		/// </summary>
		public PlotOptionsMfiSonificationTracksMappingTimeMapFunction MapFunction { get; set; }
		private PlotOptionsMfiSonificationTracksMappingTimeMapFunction MapFunction_DefaultValue { get; set; }
		...
		/// </summary>
		public PlotOptionsMfiSonificationTracksMappingTimeWithin Within { get; set; }
		private PlotOptionsMfiSonificationTracksMappingTimeWithin Within_DefaultValue { get; set; }
