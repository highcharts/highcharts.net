...
{
	public partial class PlotOptionsMfiSonificationTracksMappingVolume  : BaseObject
	{
		Hashtable h = new Hashtable();

		public PlotOptionsMfiSonificationTracksMappingVolume()
		{
			MapFunction = MapFunction_DefaultValue = PlotOptionsMfiSonificationTracksMappingVolumeMapFunction.Linear;
			MapTo = MapTo_DefaultValue = "";
			Max = Max_DefaultValue = null;
			Min = Min_DefaultValue = null;
			Value = Value_DefaultValue = null;
			Within = Within_DefaultValue = PlotOptionsMfiSonificationTracksMappingVolumeWithin.Chart;
		...
		/// </summary>
		public PlotOptionsMfiSonificationTracksMappingVolumeMapFunction MapFunction { get; set; }
		private PlotOptionsMfiSonificationTracksMappingVolumeMapFunction MapFunction_DefaultValue { get; set; }
		...
		/// </summary>
		public PlotOptionsMfiSonificationTracksMappingVolumeWithin Within { get; set; }
		private PlotOptionsMfiSonificationTracksMappingVolumeWithin Within_DefaultValue { get; set; }
