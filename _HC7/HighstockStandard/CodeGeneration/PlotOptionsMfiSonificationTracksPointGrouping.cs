...
{
	public partial class PlotOptionsMfiSonificationTracksPointGrouping  : BaseObject
	{
		Hashtable h = new Hashtable();

		public PlotOptionsMfiSonificationTracksPointGrouping()
		{
			Algorithm = Algorithm_DefaultValue = PlotOptionsMfiSonificationTracksPointGroupingAlgorithm.Minimax;
		...
		/// </summary>
		public PlotOptionsMfiSonificationTracksPointGroupingAlgorithm Algorithm { get; set; }
		private PlotOptionsMfiSonificationTracksPointGroupingAlgorithm Algorithm_DefaultValue { get; set; }
