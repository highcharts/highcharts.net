...
namespace Highsoft.Web.Mvc.Stocks
{
	public partial class PlotOptionsMfiStatesHoverMarkerStates  : BaseObject
	{
		public PlotOptionsMfiStatesHoverMarkerStates()
		{
			...
			Inactive = Inactive_DefaultValue = new PlotOptionsMfiStatesHoverMarkerStatesInactive();
			Normal = Normal_DefaultValue = new PlotOptionsMfiStatesHoverMarkerStatesNormal();
		...
		/// 
		/// </summary>
		public PlotOptionsMfiStatesHoverMarkerStatesInactive Inactive { get; set; }
		private PlotOptionsMfiStatesHoverMarkerStatesInactive Inactive_DefaultValue { get; set; }
		 

		/// <summary>
		/// The normal state of a single point marker. Currently onlyused for setting animation when returning to normal statefrom hover.
		/// </summary>
		public PlotOptionsMfiStatesHoverMarkerStatesNormal Normal { get; set; }
		private PlotOptionsMfiStatesHoverMarkerStatesNormal Normal_DefaultValue { get; set; }
