...
namespace Highsoft.Web.Mvc.Stocks
{
	public partial class PlotOptionsMomentum  : BaseObject
	{
		...
		public PlotOptionsMomentum()
		{
			...
			Zones = Zones_DefaultValue = new List<PlotOptionsMomentumZone>();
		...
		/// </summary>
		public List<PlotOptionsMomentumZone> Zones { get; set; }
		private List<PlotOptionsMomentumZone> Zones_DefaultValue { get; set; }
