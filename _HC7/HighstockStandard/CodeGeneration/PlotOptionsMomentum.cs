...
{
	public partial class PlotOptionsMomentum  : BaseObject
	{
		Hashtable h = new Hashtable();

		public PlotOptionsMomentum()
		{
			Accessibility = Accessibility_DefaultValue = new PlotOptionsMomentumAccessibility();
			AllowPointSelect = AllowPointSelect_DefaultValue = false;
			Animation = Animation_DefaultValue = new Animation() { Enabled = true };
			AnimationBool = AnimationBool_DefaultValue = true;
			AnimationLimit = AnimationLimit_DefaultValue = null;
			BoostBlending = BoostBlending_DefaultValue = PlotOptionsMomentumBoostBlending.Undefined;
			...
			Compare = Compare_DefaultValue = PlotOptionsMomentumCompare.Percent;
			CompareBase = CompareBase_DefaultValue = PlotOptionsMomentumCompareBase.Min;
			...
			Cursor = Cursor_DefaultValue = PlotOptionsMomentumCursor.Null;
			Custom = Custom_DefaultValue = new Hashtable();
			DashStyle = DashStyle_DefaultValue = PlotOptionsMomentumDashStyle.Null;
			DataGrouping = DataGrouping_DefaultValue = new PlotOptionsMomentumDataGrouping();
			DataLabels = DataLabels_DefaultValue = new PlotOptionsMomentumDataLabels();
			DataSorting = DataSorting_DefaultValue = new PlotOptionsMomentumDataSorting();
			Description = Description_DefaultValue = "";
			EnableMouseTracking = EnableMouseTracking_DefaultValue = true;
			Events = Events_DefaultValue = new PlotOptionsMomentumEvents();
			FindNearestPointBy = FindNearestPointBy_DefaultValue = PlotOptionsMomentumFindNearestPointBy.X;
			GapSize = GapSize_DefaultValue = 0;
			GapUnit = GapUnit_DefaultValue = PlotOptionsMomentumGapUnit.Relative;
			GetExtremesFromAll = GetExtremesFromAll_DefaultValue = false;
			InactiveOtherPoints = InactiveOtherPoints_DefaultValue = false;
			IncludeInDataExport = IncludeInDataExport_DefaultValue = null;
			Label = Label_DefaultValue = new PlotOptionsMomentumLabel();
			LastPrice = LastPrice_DefaultValue = new PlotOptionsMomentumLastPrice();
			LastVisiblePrice = LastVisiblePrice_DefaultValue = new PlotOptionsMomentumLastVisiblePrice();
			LegendSymbol = LegendSymbol_DefaultValue = PlotOptionsMomentumLegendSymbol.Rectangle;
			Linecap = Linecap_DefaultValue = PlotOptionsMomentumLinecap.Round;
			LineWidth = LineWidth_DefaultValue = 2;
			LinkedTo = LinkedTo_DefaultValue = "";
			Marker = Marker_DefaultValue = new PlotOptionsMomentumMarker();
			NegativeColor = NegativeColor_DefaultValue = "";
			OnPoint = OnPoint_DefaultValue = new PlotOptionsMomentumOnPoint();
			Opacity = Opacity_DefaultValue = 1;
			Params = Params_DefaultValue = new PlotOptionsMomentumParams();
			Point = Point_DefaultValue = new PlotOptionsMomentumPoint();
			...
			Sonification = Sonification_DefaultValue = new PlotOptionsMomentumSonification();
			States = States_DefaultValue = new PlotOptionsMomentumStates();
			Step = Step_DefaultValue = PlotOptionsMomentumStep.Null;
			StickyTracking = StickyTracking_DefaultValue = true;
			Threshold = Threshold_DefaultValue = 0;
			Tooltip = Tooltip_DefaultValue = new PlotOptionsMomentumTooltip();
			TurboThreshold = TurboThreshold_DefaultValue = 1000;
			Visible = Visible_DefaultValue = true;
			ZoneAxis = ZoneAxis_DefaultValue = "y";
			Zones = Zones_DefaultValue = new List<PlotOptionsMomentumZones>();
		...
		/// </summary>
		public PlotOptionsMomentumAccessibility Accessibility { get; set; }
		private PlotOptionsMomentumAccessibility Accessibility_DefaultValue { get; set; }
		...
		/// </summary>
		public PlotOptionsMomentumBoostBlending BoostBlending { get; set; }
		private PlotOptionsMomentumBoostBlending BoostBlending_DefaultValue { get; set; }
		...
		/// </summary>
		public PlotOptionsMomentumCompare Compare { get; set; }
		private PlotOptionsMomentumCompare Compare_DefaultValue { get; set; }
		 

		/// <summary>
		/// When [compare](#plotOptions.series.compare) is `percent`, this optiondictates whether to use 0 or 100 as the base of comparison.
		/// </summary>
		public PlotOptionsMomentumCompareBase CompareBase { get; set; }
		private PlotOptionsMomentumCompareBase CompareBase_DefaultValue { get; set; }
		...
		/// </summary>
		public PlotOptionsMomentumCursor Cursor { get; set; }
		private PlotOptionsMomentumCursor Cursor_DefaultValue { get; set; }
		...
		/// </summary>
		public PlotOptionsMomentumDashStyle DashStyle { get; set; }
		private PlotOptionsMomentumDashStyle DashStyle_DefaultValue { get; set; }
		...
		/// </summary>
		public PlotOptionsMomentumDataGrouping DataGrouping { get; set; }
		private PlotOptionsMomentumDataGrouping DataGrouping_DefaultValue { get; set; }
		...
		/// </summary>
		public PlotOptionsMomentumDataLabels DataLabels { get; set; }
		private PlotOptionsMomentumDataLabels DataLabels_DefaultValue { get; set; }
		 

		/// <summary>
		/// Options for the series data sorting.
		/// </summary>
		public PlotOptionsMomentumDataSorting DataSorting { get; set; }
		private PlotOptionsMomentumDataSorting DataSorting_DefaultValue { get; set; }
		...
		/// </summary>
		public PlotOptionsMomentumEvents Events { get; set; }
		private PlotOptionsMomentumEvents Events_DefaultValue { get; set; }
		...
		/// </summary>
		public PlotOptionsMomentumFindNearestPointBy FindNearestPointBy { get; set; }
		private PlotOptionsMomentumFindNearestPointBy FindNearestPointBy_DefaultValue { get; set; }
		...
		/// </summary>
		public PlotOptionsMomentumGapUnit GapUnit { get; set; }
		private PlotOptionsMomentumGapUnit GapUnit_DefaultValue { get; set; }
		...
		/// </summary>
		public PlotOptionsMomentumLabel Label { get; set; }
		private PlotOptionsMomentumLabel Label_DefaultValue { get; set; }
		 

		/// <summary>
		/// The line marks the last price from all points.
		/// </summary>
		public PlotOptionsMomentumLastPrice LastPrice { get; set; }
		private PlotOptionsMomentumLastPrice LastPrice_DefaultValue { get; set; }
		 

		/// <summary>
		/// The line marks the last price from visible range of points.
		/// </summary>
		public PlotOptionsMomentumLastVisiblePrice LastVisiblePrice { get; set; }
		private PlotOptionsMomentumLastVisiblePrice LastVisiblePrice_DefaultValue { get; set; }
		 

		/// <summary>
		/// What type of legend symbol to render for this series. Can be one of`areaMarker`, `lineMarker` or `rectangle`.
		/// </summary>
		public PlotOptionsMomentumLegendSymbol LegendSymbol { get; set; }
		private PlotOptionsMomentumLegendSymbol LegendSymbol_DefaultValue { get; set; }
		 

		/// <summary>
		/// The line cap used for line ends and line joins on the graph.
		/// </summary>
		public PlotOptionsMomentumLinecap Linecap { get; set; }
		private PlotOptionsMomentumLinecap Linecap_DefaultValue { get; set; }
		...
		/// </summary>
		public PlotOptionsMomentumMarker Marker { get; set; }
		private PlotOptionsMomentumMarker Marker_DefaultValue { get; set; }
		...
		/// </summary>
		public PlotOptionsMomentumOnPoint OnPoint { get; set; }
		private PlotOptionsMomentumOnPoint OnPoint_DefaultValue { get; set; }
		...
		/// 
		/// </summary>
		public PlotOptionsMomentumParams Params { get; set; }
		private PlotOptionsMomentumParams Params_DefaultValue { get; set; }
		 

		/// <summary>
		/// Properties for each single point.
		/// </summary>
		public PlotOptionsMomentumPoint Point { get; set; }
		private PlotOptionsMomentumPoint Point_DefaultValue { get; set; }
		...
		/// </summary>
		public PlotOptionsMomentumSonification Sonification { get; set; }
		private PlotOptionsMomentumSonification Sonification_DefaultValue { get; set; }
		 

		/// <summary>
		/// 
		/// </summary>
		public PlotOptionsMomentumStates States { get; set; }
		private PlotOptionsMomentumStates States_DefaultValue { get; set; }
		 

		/// <summary>
		/// Whether to apply steps to the line. Possible values are `left`,`center` and `right`.
		/// </summary>
		public PlotOptionsMomentumStep Step { get; set; }
		private PlotOptionsMomentumStep Step_DefaultValue { get; set; }
		...
		/// </summary>
		public PlotOptionsMomentumTooltip Tooltip { get; set; }
		private PlotOptionsMomentumTooltip Tooltip_DefaultValue { get; set; }
		...
		/// </summary>
		public List<PlotOptionsMomentumZones> Zones { get; set; }
		private List<PlotOptionsMomentumZones> Zones_DefaultValue { get; set; }
