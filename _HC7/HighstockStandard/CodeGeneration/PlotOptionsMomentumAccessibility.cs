...
namespace Highsoft.Web.Mvc.Stocks
{
	public partial class PlotOptionsMomentumAccessibility  : BaseObject
	{
		...
		public PlotOptionsMomentumAccessibility()
		{
			...
			Point = Point_DefaultValue = new PlotOptionsMomentumAccessibilityPoint();
		...
		/// </summary>
		public PlotOptionsMomentumAccessibilityPoint Point { get; set; }
		private PlotOptionsMomentumAccessibilityPoint Point_DefaultValue { get; set; }
