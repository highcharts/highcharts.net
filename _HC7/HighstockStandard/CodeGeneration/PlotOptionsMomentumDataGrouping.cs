...
namespace Highsoft.Web.Mvc.Stocks
{
	public partial class PlotOptionsMomentumDataGrouping  : BaseObject
	{
		...
		internal override Hashtable ToHashtable()
		{
			...
			if (Approximation != Approximation_DefaultValue) { h.Add("approximation",Approximation); Highstock.AddFunction("PlotOptionsMomentumDataGroupingApproximation.approximation", Approximation); }  
