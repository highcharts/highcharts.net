...
namespace Highsoft.Web.Mvc.Stocks
{
	public partial class PlotOptionsMomentumDataLabels  : BaseObject
	{
		...
		{
			if (Align != PlotOptionsMomentumDataLabelsAlign.Null) h.Add("align", highstock.FirstCharacterToLower(Align.ToString()));
			...
			if (Overflow != PlotOptionsMomentumDataLabelsOverflow.Null) h.Add("overflow", highstock.FirstCharacterToLower(Overflow.ToString()));
			if (Padding != null) h.Add("padding",Padding);
			if (Position != PlotOptionsMomentumDataLabelsPosition.Null) h.Add("position", highstock.FirstCharacterToLower(Position.ToString()));
			...
			if (VerticalAlign != PlotOptionsMomentumDataLabelsVerticalAlign.Null) h.Add("verticalAlign", highstock.FirstCharacterToLower(VerticalAlign.ToString()));
			if (X != null) h.Add("x",X);
			if (Y != null) h.Add("y",Y);
