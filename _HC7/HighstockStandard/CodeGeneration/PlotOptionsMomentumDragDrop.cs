...
{
	public partial class PlotOptionsMomentumDragDrop  : BaseObject
	{
		public PlotOptionsMomentumDragDrop()
		{
			DraggableX = DraggableX_DefaultValue = null;
			DraggableY = DraggableY_DefaultValue = null;
			DragHandle = DragHandle_DefaultValue = new PlotOptionsMomentumDragDropDragHandle();
			...
			GuideBox = GuideBox_DefaultValue = new PlotOptionsMomentumDragDropGuideBox();
		...
		/// </summary>
		public PlotOptionsMomentumDragDropDragHandle DragHandle { get; set; }
		private PlotOptionsMomentumDragDropDragHandle DragHandle_DefaultValue { get; set; }
		...
		/// </summary>
		public PlotOptionsMomentumDragDropGuideBox GuideBox { get; set; }
		private PlotOptionsMomentumDragDropGuideBox GuideBox_DefaultValue { get; set; }
