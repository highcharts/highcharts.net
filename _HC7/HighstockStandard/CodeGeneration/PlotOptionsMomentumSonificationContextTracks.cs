...
{
	public partial class PlotOptionsMomentumSonificationContextTracks  : BaseObject
	{
		Hashtable h = new Hashtable();

		public PlotOptionsMomentumSonificationContextTracks()
		{
			ActiveWhen = ActiveWhen_DefaultValue = new PlotOptionsMomentumSonificationContextTracksActiveWhen();
			Instrument = Instrument_DefaultValue = null;
			InstrumentString = InstrumentString_DefaultValue = "null";
			Mapping = Mapping_DefaultValue = new PlotOptionsMomentumSonificationContextTracksMapping();
			MidiName = MidiName_DefaultValue = "";
			PointGrouping = PointGrouping_DefaultValue = new PlotOptionsMomentumSonificationContextTracksPointGrouping();
			...
			Type = Type_DefaultValue = PlotOptionsMomentumSonificationContextTracksType.Instrument;
			ValueInterval = ValueInterval_DefaultValue = null;
			ValueMapFunction = ValueMapFunction_DefaultValue = PlotOptionsMomentumSonificationContextTracksValueMapFunction.Linear;
		...
		/// </summary>
		public PlotOptionsMomentumSonificationContextTracksActiveWhen ActiveWhen { get; set; }
		private PlotOptionsMomentumSonificationContextTracksActiveWhen ActiveWhen_DefaultValue { get; set; }
		...
		/// </summary>
		public PlotOptionsMomentumSonificationContextTracksMapping Mapping { get; set; }
		private PlotOptionsMomentumSonificationContextTracksMapping Mapping_DefaultValue { get; set; }
		...
		/// </summary>
		public PlotOptionsMomentumSonificationContextTracksPointGrouping PointGrouping { get; set; }
		private PlotOptionsMomentumSonificationContextTracksPointGrouping PointGrouping_DefaultValue { get; set; }
		...
		/// </summary>
		public PlotOptionsMomentumSonificationContextTracksType Type { get; set; }
		private PlotOptionsMomentumSonificationContextTracksType Type_DefaultValue { get; set; }
		...
		/// </summary>
		public PlotOptionsMomentumSonificationContextTracksValueMapFunction ValueMapFunction { get; set; }
		private PlotOptionsMomentumSonificationContextTracksValueMapFunction ValueMapFunction_DefaultValue { get; set; }
