...
{
	public partial class PlotOptionsMomentumSonificationContextTracksMappingPitch  : BaseObject
	{
		Hashtable h = new Hashtable();

		public PlotOptionsMomentumSonificationContextTracksMappingPitch()
		{
			MapFunction = MapFunction_DefaultValue = PlotOptionsMomentumSonificationContextTracksMappingPitchMapFunction.Linear;
		...
		/// </summary>
		public PlotOptionsMomentumSonificationContextTracksMappingPitchMapFunction MapFunction { get; set; }
		private PlotOptionsMomentumSonificationContextTracksMappingPitchMapFunction MapFunction_DefaultValue { get; set; }
