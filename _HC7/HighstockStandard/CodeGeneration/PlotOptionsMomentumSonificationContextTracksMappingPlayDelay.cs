...
{
	public partial class PlotOptionsMomentumSonificationContextTracksMappingPlayDelay  : BaseObject
	{
		Hashtable h = new Hashtable();

		public PlotOptionsMomentumSonificationContextTracksMappingPlayDelay()
		{
			MapFunction = MapFunction_DefaultValue = PlotOptionsMomentumSonificationContextTracksMappingPlayDelayMapFunction.Linear;
			MapTo = MapTo_DefaultValue = "";
			Max = Max_DefaultValue = null;
			Min = Min_DefaultValue = null;
			Value = Value_DefaultValue = null;
			Within = Within_DefaultValue = PlotOptionsMomentumSonificationContextTracksMappingPlayDelayWithin.Chart;
		...
		/// </summary>
		public PlotOptionsMomentumSonificationContextTracksMappingPlayDelayMapFunction MapFunction { get; set; }
		private PlotOptionsMomentumSonificationContextTracksMappingPlayDelayMapFunction MapFunction_DefaultValue { get; set; }
		...
		/// </summary>
		public PlotOptionsMomentumSonificationContextTracksMappingPlayDelayWithin Within { get; set; }
		private PlotOptionsMomentumSonificationContextTracksMappingPlayDelayWithin Within_DefaultValue { get; set; }
