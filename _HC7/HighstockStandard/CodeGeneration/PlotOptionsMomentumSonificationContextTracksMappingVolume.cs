...
{
	public partial class PlotOptionsMomentumSonificationContextTracksMappingVolume  : BaseObject
	{
		Hashtable h = new Hashtable();

		public PlotOptionsMomentumSonificationContextTracksMappingVolume()
		{
			MapFunction = MapFunction_DefaultValue = PlotOptionsMomentumSonificationContextTracksMappingVolumeMapFunction.Linear;
			MapTo = MapTo_DefaultValue = "";
			Max = Max_DefaultValue = null;
			Min = Min_DefaultValue = null;
			Value = Value_DefaultValue = null;
			Within = Within_DefaultValue = PlotOptionsMomentumSonificationContextTracksMappingVolumeWithin.Chart;
		...
		/// </summary>
		public PlotOptionsMomentumSonificationContextTracksMappingVolumeMapFunction MapFunction { get; set; }
		private PlotOptionsMomentumSonificationContextTracksMappingVolumeMapFunction MapFunction_DefaultValue { get; set; }
		...
		/// </summary>
		public PlotOptionsMomentumSonificationContextTracksMappingVolumeWithin Within { get; set; }
		private PlotOptionsMomentumSonificationContextTracksMappingVolumeWithin Within_DefaultValue { get; set; }
