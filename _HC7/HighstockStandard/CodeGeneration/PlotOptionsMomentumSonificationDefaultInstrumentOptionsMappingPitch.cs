...
{
	public partial class PlotOptionsMomentumSonificationDefaultInstrumentOptionsMappingPitch  : BaseObject
	{
		Hashtable h = new Hashtable();

		public PlotOptionsMomentumSonificationDefaultInstrumentOptionsMappingPitch()
		{
			MapFunction = MapFunction_DefaultValue = PlotOptionsMomentumSonificationDefaultInstrumentOptionsMappingPitchMapFunction.Linear;
		...
		/// </summary>
		public PlotOptionsMomentumSonificationDefaultInstrumentOptionsMappingPitchMapFunction MapFunction { get; set; }
		private PlotOptionsMomentumSonificationDefaultInstrumentOptionsMappingPitchMapFunction MapFunction_DefaultValue { get; set; }
