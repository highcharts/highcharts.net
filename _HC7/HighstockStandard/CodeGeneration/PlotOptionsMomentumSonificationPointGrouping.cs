...
{
	public partial class PlotOptionsMomentumSonificationPointGrouping  : BaseObject
	{
		Hashtable h = new Hashtable();

		public PlotOptionsMomentumSonificationPointGrouping()
		{
			Algorithm = Algorithm_DefaultValue = PlotOptionsMomentumSonificationPointGroupingAlgorithm.Minimax;
		...
		/// </summary>
		public PlotOptionsMomentumSonificationPointGroupingAlgorithm Algorithm { get; set; }
		private PlotOptionsMomentumSonificationPointGroupingAlgorithm Algorithm_DefaultValue { get; set; }
