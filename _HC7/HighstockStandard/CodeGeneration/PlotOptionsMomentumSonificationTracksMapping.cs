...
{
	public partial class PlotOptionsMomentumSonificationTracksMapping  : BaseObject
	{
		Hashtable h = new Hashtable();

		public PlotOptionsMomentumSonificationTracksMapping()
		{
			Frequency = Frequency_DefaultValue = new PlotOptionsMomentumSonificationTracksMappingFrequency();
			GapBetweenNotes = GapBetweenNotes_DefaultValue = new PlotOptionsMomentumSonificationTracksMappingGapBetweenNotes();
			Highpass = Highpass_DefaultValue = new PlotOptionsMomentumSonificationTracksMappingHighpass();
			Lowpass = Lowpass_DefaultValue = new PlotOptionsMomentumSonificationTracksMappingLowpass();
			NoteDuration = NoteDuration_DefaultValue = new PlotOptionsMomentumSonificationTracksMappingNoteDuration();
			Pan = Pan_DefaultValue = new PlotOptionsMomentumSonificationTracksMappingPan();
			Pitch = Pitch_DefaultValue = new PlotOptionsMomentumSonificationTracksMappingPitch();
			PitchString = PitchString_DefaultValue = "null";
			PitchNumber = PitchNumber_DefaultValue = null;
			PlayDelay = PlayDelay_DefaultValue = new PlotOptionsMomentumSonificationTracksMappingPlayDelay();
			Time = Time_DefaultValue = new PlotOptionsMomentumSonificationTracksMappingTime();
			TimeString = TimeString_DefaultValue = "null";
			TimeNumber = TimeNumber_DefaultValue = null;
			Tremolo = Tremolo_DefaultValue = new PlotOptionsMomentumSonificationTracksMappingTremolo();
			Volume = Volume_DefaultValue = new PlotOptionsMomentumSonificationTracksMappingVolume();
		...
		/// </summary>
		public PlotOptionsMomentumSonificationTracksMappingFrequency Frequency { get; set; }
		private PlotOptionsMomentumSonificationTracksMappingFrequency Frequency_DefaultValue { get; set; }
		...
		/// </summary>
		public PlotOptionsMomentumSonificationTracksMappingGapBetweenNotes GapBetweenNotes { get; set; }
		private PlotOptionsMomentumSonificationTracksMappingGapBetweenNotes GapBetweenNotes_DefaultValue { get; set; }
		...
		/// </summary>
		public PlotOptionsMomentumSonificationTracksMappingHighpass Highpass { get; set; }
		private PlotOptionsMomentumSonificationTracksMappingHighpass Highpass_DefaultValue { get; set; }
		...
		/// </summary>
		public PlotOptionsMomentumSonificationTracksMappingLowpass Lowpass { get; set; }
		private PlotOptionsMomentumSonificationTracksMappingLowpass Lowpass_DefaultValue { get; set; }
		...
		/// </summary>
		public PlotOptionsMomentumSonificationTracksMappingNoteDuration NoteDuration { get; set; }
		private PlotOptionsMomentumSonificationTracksMappingNoteDuration NoteDuration_DefaultValue { get; set; }
		...
		/// </summary>
		public PlotOptionsMomentumSonificationTracksMappingPan Pan { get; set; }
		private PlotOptionsMomentumSonificationTracksMappingPan Pan_DefaultValue { get; set; }
		...
		/// </summary>
		public PlotOptionsMomentumSonificationTracksMappingPitch Pitch { get; set; }
		private PlotOptionsMomentumSonificationTracksMappingPitch Pitch_DefaultValue { get; set; }
		...
		/// </summary>
		public PlotOptionsMomentumSonificationTracksMappingPlayDelay PlayDelay { get; set; }
		private PlotOptionsMomentumSonificationTracksMappingPlayDelay PlayDelay_DefaultValue { get; set; }
		...
		/// </summary>
		public PlotOptionsMomentumSonificationTracksMappingTime Time { get; set; }
		private PlotOptionsMomentumSonificationTracksMappingTime Time_DefaultValue { get; set; }
		...
		/// </summary>
		public PlotOptionsMomentumSonificationTracksMappingTremolo Tremolo { get; set; }
		private PlotOptionsMomentumSonificationTracksMappingTremolo Tremolo_DefaultValue { get; set; }
		 

		/// <summary>
		/// The volume of notes, from 0 to 1.
		/// </summary>
		public PlotOptionsMomentumSonificationTracksMappingVolume Volume { get; set; }
		private PlotOptionsMomentumSonificationTracksMappingVolume Volume_DefaultValue { get; set; }
