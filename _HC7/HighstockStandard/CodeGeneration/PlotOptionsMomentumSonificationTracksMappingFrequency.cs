...
{
	public partial class PlotOptionsMomentumSonificationTracksMappingFrequency  : BaseObject
	{
		Hashtable h = new Hashtable();

		public PlotOptionsMomentumSonificationTracksMappingFrequency()
		{
			MapFunction = MapFunction_DefaultValue = PlotOptionsMomentumSonificationTracksMappingFrequencyMapFunction.Linear;
			MapTo = MapTo_DefaultValue = "";
			Max = Max_DefaultValue = null;
			Min = Min_DefaultValue = null;
			Value = Value_DefaultValue = null;
			Within = Within_DefaultValue = PlotOptionsMomentumSonificationTracksMappingFrequencyWithin.Chart;
		...
		/// </summary>
		public PlotOptionsMomentumSonificationTracksMappingFrequencyMapFunction MapFunction { get; set; }
		private PlotOptionsMomentumSonificationTracksMappingFrequencyMapFunction MapFunction_DefaultValue { get; set; }
		...
		/// </summary>
		public PlotOptionsMomentumSonificationTracksMappingFrequencyWithin Within { get; set; }
		private PlotOptionsMomentumSonificationTracksMappingFrequencyWithin Within_DefaultValue { get; set; }
