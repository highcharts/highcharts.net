...
{
	public partial class PlotOptionsMomentumSonificationTracksMappingLowpassResonance  : BaseObject
	{
		Hashtable h = new Hashtable();

		public PlotOptionsMomentumSonificationTracksMappingLowpassResonance()
		{
			MapFunction = MapFunction_DefaultValue = PlotOptionsMomentumSonificationTracksMappingLowpassResonanceMapFunction.Linear;
			MapTo = MapTo_DefaultValue = "";
			Max = Max_DefaultValue = null;
			Min = Min_DefaultValue = null;
			Value = Value_DefaultValue = null;
			Within = Within_DefaultValue = PlotOptionsMomentumSonificationTracksMappingLowpassResonanceWithin.Chart;
		...
		/// </summary>
		public PlotOptionsMomentumSonificationTracksMappingLowpassResonanceMapFunction MapFunction { get; set; }
		private PlotOptionsMomentumSonificationTracksMappingLowpassResonanceMapFunction MapFunction_DefaultValue { get; set; }
		...
		/// </summary>
		public PlotOptionsMomentumSonificationTracksMappingLowpassResonanceWithin Within { get; set; }
		private PlotOptionsMomentumSonificationTracksMappingLowpassResonanceWithin Within_DefaultValue { get; set; }
