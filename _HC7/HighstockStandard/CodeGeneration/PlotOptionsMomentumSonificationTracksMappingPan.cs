...
{
	public partial class PlotOptionsMomentumSonificationTracksMappingPan  : BaseObject
	{
		Hashtable h = new Hashtable();

		public PlotOptionsMomentumSonificationTracksMappingPan()
		{
			MapFunction = MapFunction_DefaultValue = PlotOptionsMomentumSonificationTracksMappingPanMapFunction.Linear;
			MapTo = MapTo_DefaultValue = "";
			Max = Max_DefaultValue = null;
			Min = Min_DefaultValue = null;
			Value = Value_DefaultValue = null;
			Within = Within_DefaultValue = PlotOptionsMomentumSonificationTracksMappingPanWithin.Chart;
		...
		/// </summary>
		public PlotOptionsMomentumSonificationTracksMappingPanMapFunction MapFunction { get; set; }
		private PlotOptionsMomentumSonificationTracksMappingPanMapFunction MapFunction_DefaultValue { get; set; }
		...
		/// </summary>
		public PlotOptionsMomentumSonificationTracksMappingPanWithin Within { get; set; }
		private PlotOptionsMomentumSonificationTracksMappingPanWithin Within_DefaultValue { get; set; }
