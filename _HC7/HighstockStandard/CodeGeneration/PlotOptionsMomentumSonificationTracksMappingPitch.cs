...
{
	public partial class PlotOptionsMomentumSonificationTracksMappingPitch  : BaseObject
	{
		Hashtable h = new Hashtable();

		public PlotOptionsMomentumSonificationTracksMappingPitch()
		{
			MapFunction = MapFunction_DefaultValue = PlotOptionsMomentumSonificationTracksMappingPitchMapFunction.Linear;
		...
		/// </summary>
		public PlotOptionsMomentumSonificationTracksMappingPitchMapFunction MapFunction { get; set; }
		private PlotOptionsMomentumSonificationTracksMappingPitchMapFunction MapFunction_DefaultValue { get; set; }
