...
{
	public partial class PlotOptionsMomentumStatesHoverMarker  : BaseObject
	{
		public PlotOptionsMomentumStatesHoverMarker()
		{
			...
			States = States_DefaultValue = new PlotOptionsMomentumStatesHoverMarkerStates();
		...
		/// </summary>
		public PlotOptionsMomentumStatesHoverMarkerStates States { get; set; }
		private PlotOptionsMomentumStatesHoverMarkerStates States_DefaultValue { get; set; }
