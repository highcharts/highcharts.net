...
{
	public partial class PlotOptionsMomentumTooltip  : BaseObject
	{
		public PlotOptionsMomentumTooltip()
		{
			...
			HeaderShape = HeaderShape_DefaultValue = PlotOptionsMomentumTooltipHeaderShape.Callout;
		...
		/// </summary>
		public PlotOptionsMomentumTooltipHeaderShape HeaderShape { get; set; }
		private PlotOptionsMomentumTooltipHeaderShape HeaderShape_DefaultValue { get; set; }
		...
		internal override Hashtable ToHashtable()
		{
			...
			if (NullFormatter != NullFormatter_DefaultValue) { h.Add("nullFormatter",NullFormatter); Highstock.AddFunction("PlotOptionsMomentumTooltipNullFormatter.nullFormatter", NullFormatter); }  
			if (Outside != Outside_DefaultValue) h.Add("outside",Outside);
			if (Padding != Padding_DefaultValue) h.Add("padding",Padding);
			if (PointFormat != PointFormat_DefaultValue) h.Add("pointFormat",PointFormat);
			if (PointFormatter != PointFormatter_DefaultValue) { h.Add("pointFormatter",PointFormatter); Highstock.AddFunction("PlotOptionsMomentumTooltipPointFormatter.pointFormatter", PointFormatter); }  
