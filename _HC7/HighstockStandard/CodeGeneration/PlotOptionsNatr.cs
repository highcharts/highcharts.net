...
namespace Highsoft.Web.Mvc.Stocks
{
	public partial class PlotOptionsNatr  : BaseObject
	{
		...
		public PlotOptionsNatr()
		{
			...
			Zones = Zones_DefaultValue = new List<PlotOptionsNatrZone>();
		...
		/// </summary>
		public List<PlotOptionsNatrZone> Zones { get; set; }
		private List<PlotOptionsNatrZone> Zones_DefaultValue { get; set; }
