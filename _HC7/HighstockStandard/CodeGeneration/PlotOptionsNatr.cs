...
{
	public partial class PlotOptionsNatr  : BaseObject
	{
		Hashtable h = new Hashtable();

		public PlotOptionsNatr()
		{
			Accessibility = Accessibility_DefaultValue = new PlotOptionsNatrAccessibility();
			AllowPointSelect = AllowPointSelect_DefaultValue = false;
			Animation = Animation_DefaultValue = new Animation() { Enabled = true };
			AnimationBool = AnimationBool_DefaultValue = true;
			AnimationLimit = AnimationLimit_DefaultValue = null;
			BoostBlending = BoostBlending_DefaultValue = PlotOptionsNatrBoostBlending.Undefined;
			...
			Compare = Compare_DefaultValue = PlotOptionsNatrCompare.Percent;
			CompareBase = CompareBase_DefaultValue = PlotOptionsNatrCompareBase.Min;
			...
			Cursor = Cursor_DefaultValue = PlotOptionsNatrCursor.Null;
			Custom = Custom_DefaultValue = new Hashtable();
			DashStyle = DashStyle_DefaultValue = PlotOptionsNatrDashStyle.Null;
			DataGrouping = DataGrouping_DefaultValue = new PlotOptionsNatrDataGrouping();
			DataLabels = DataLabels_DefaultValue = new PlotOptionsNatrDataLabels();
			DataSorting = DataSorting_DefaultValue = new PlotOptionsNatrDataSorting();
			Description = Description_DefaultValue = "";
			EnableMouseTracking = EnableMouseTracking_DefaultValue = true;
			Events = Events_DefaultValue = new PlotOptionsNatrEvents();
			FindNearestPointBy = FindNearestPointBy_DefaultValue = PlotOptionsNatrFindNearestPointBy.X;
			GapSize = GapSize_DefaultValue = 0;
			GapUnit = GapUnit_DefaultValue = PlotOptionsNatrGapUnit.Relative;
			GetExtremesFromAll = GetExtremesFromAll_DefaultValue = false;
			InactiveOtherPoints = InactiveOtherPoints_DefaultValue = false;
			IncludeInDataExport = IncludeInDataExport_DefaultValue = null;
			Label = Label_DefaultValue = new PlotOptionsNatrLabel();
			LastPrice = LastPrice_DefaultValue = new PlotOptionsNatrLastPrice();
			LastVisiblePrice = LastVisiblePrice_DefaultValue = new PlotOptionsNatrLastVisiblePrice();
			LegendSymbol = LegendSymbol_DefaultValue = PlotOptionsNatrLegendSymbol.Rectangle;
			Linecap = Linecap_DefaultValue = PlotOptionsNatrLinecap.Round;
			LineWidth = LineWidth_DefaultValue = 2;
			LinkedTo = LinkedTo_DefaultValue = "";
			Marker = Marker_DefaultValue = new PlotOptionsNatrMarker();
			NegativeColor = NegativeColor_DefaultValue = "";
			OnPoint = OnPoint_DefaultValue = new PlotOptionsNatrOnPoint();
			Opacity = Opacity_DefaultValue = 1;
			Params = Params_DefaultValue = new PlotOptionsNatrParams();
			Point = Point_DefaultValue = new PlotOptionsNatrPoint();
			...
			Sonification = Sonification_DefaultValue = new PlotOptionsNatrSonification();
			States = States_DefaultValue = new PlotOptionsNatrStates();
			Step = Step_DefaultValue = PlotOptionsNatrStep.Null;
			StickyTracking = StickyTracking_DefaultValue = true;
			Threshold = Threshold_DefaultValue = 0;
			Tooltip = Tooltip_DefaultValue = new PlotOptionsNatrTooltip();
			TurboThreshold = TurboThreshold_DefaultValue = 1000;
			Visible = Visible_DefaultValue = true;
			ZoneAxis = ZoneAxis_DefaultValue = "y";
			Zones = Zones_DefaultValue = new List<PlotOptionsNatrZones>();
		...
		/// </summary>
		public PlotOptionsNatrAccessibility Accessibility { get; set; }
		private PlotOptionsNatrAccessibility Accessibility_DefaultValue { get; set; }
		...
		/// </summary>
		public PlotOptionsNatrBoostBlending BoostBlending { get; set; }
		private PlotOptionsNatrBoostBlending BoostBlending_DefaultValue { get; set; }
		...
		/// </summary>
		public PlotOptionsNatrCompare Compare { get; set; }
		private PlotOptionsNatrCompare Compare_DefaultValue { get; set; }
		 

		/// <summary>
		/// When [compare](#plotOptions.series.compare) is `percent`, this optiondictates whether to use 0 or 100 as the base of comparison.
		/// </summary>
		public PlotOptionsNatrCompareBase CompareBase { get; set; }
		private PlotOptionsNatrCompareBase CompareBase_DefaultValue { get; set; }
		...
		/// </summary>
		public PlotOptionsNatrCursor Cursor { get; set; }
		private PlotOptionsNatrCursor Cursor_DefaultValue { get; set; }
		...
		/// </summary>
		public PlotOptionsNatrDashStyle DashStyle { get; set; }
		private PlotOptionsNatrDashStyle DashStyle_DefaultValue { get; set; }
		...
		/// </summary>
		public PlotOptionsNatrDataGrouping DataGrouping { get; set; }
		private PlotOptionsNatrDataGrouping DataGrouping_DefaultValue { get; set; }
		...
		/// </summary>
		public PlotOptionsNatrDataLabels DataLabels { get; set; }
		private PlotOptionsNatrDataLabels DataLabels_DefaultValue { get; set; }
		 

		/// <summary>
		/// Options for the series data sorting.
		/// </summary>
		public PlotOptionsNatrDataSorting DataSorting { get; set; }
		private PlotOptionsNatrDataSorting DataSorting_DefaultValue { get; set; }
		...
		/// </summary>
		public PlotOptionsNatrEvents Events { get; set; }
		private PlotOptionsNatrEvents Events_DefaultValue { get; set; }
		...
		/// </summary>
		public PlotOptionsNatrFindNearestPointBy FindNearestPointBy { get; set; }
		private PlotOptionsNatrFindNearestPointBy FindNearestPointBy_DefaultValue { get; set; }
		...
		/// </summary>
		public PlotOptionsNatrGapUnit GapUnit { get; set; }
		private PlotOptionsNatrGapUnit GapUnit_DefaultValue { get; set; }
		...
		/// </summary>
		public PlotOptionsNatrLabel Label { get; set; }
		private PlotOptionsNatrLabel Label_DefaultValue { get; set; }
		 

		/// <summary>
		/// The line marks the last price from all points.
		/// </summary>
		public PlotOptionsNatrLastPrice LastPrice { get; set; }
		private PlotOptionsNatrLastPrice LastPrice_DefaultValue { get; set; }
		 

		/// <summary>
		/// The line marks the last price from visible range of points.
		/// </summary>
		public PlotOptionsNatrLastVisiblePrice LastVisiblePrice { get; set; }
		private PlotOptionsNatrLastVisiblePrice LastVisiblePrice_DefaultValue { get; set; }
		 

		/// <summary>
		/// What type of legend symbol to render for this series. Can be one of`areaMarker`, `lineMarker` or `rectangle`.
		/// </summary>
		public PlotOptionsNatrLegendSymbol LegendSymbol { get; set; }
		private PlotOptionsNatrLegendSymbol LegendSymbol_DefaultValue { get; set; }
		 

		/// <summary>
		/// The line cap used for line ends and line joins on the graph.
		/// </summary>
		public PlotOptionsNatrLinecap Linecap { get; set; }
		private PlotOptionsNatrLinecap Linecap_DefaultValue { get; set; }
		...
		/// </summary>
		public PlotOptionsNatrMarker Marker { get; set; }
		private PlotOptionsNatrMarker Marker_DefaultValue { get; set; }
		...
		/// </summary>
		public PlotOptionsNatrOnPoint OnPoint { get; set; }
		private PlotOptionsNatrOnPoint OnPoint_DefaultValue { get; set; }
		...
		/// </summary>
		public PlotOptionsNatrParams Params { get; set; }
		private PlotOptionsNatrParams Params_DefaultValue { get; set; }
		 

		/// <summary>
		/// Properties for each single point.
		/// </summary>
		public PlotOptionsNatrPoint Point { get; set; }
		private PlotOptionsNatrPoint Point_DefaultValue { get; set; }
		...
		/// </summary>
		public PlotOptionsNatrSonification Sonification { get; set; }
		private PlotOptionsNatrSonification Sonification_DefaultValue { get; set; }
		 

		/// <summary>
		/// 
		/// </summary>
		public PlotOptionsNatrStates States { get; set; }
		private PlotOptionsNatrStates States_DefaultValue { get; set; }
		 

		/// <summary>
		/// Whether to apply steps to the line. Possible values are `left`,`center` and `right`.
		/// </summary>
		public PlotOptionsNatrStep Step { get; set; }
		private PlotOptionsNatrStep Step_DefaultValue { get; set; }
		...
		/// 
		/// </summary>
		public PlotOptionsNatrTooltip Tooltip { get; set; }
		private PlotOptionsNatrTooltip Tooltip_DefaultValue { get; set; }
		...
		/// </summary>
		public List<PlotOptionsNatrZones> Zones { get; set; }
		private List<PlotOptionsNatrZones> Zones_DefaultValue { get; set; }
