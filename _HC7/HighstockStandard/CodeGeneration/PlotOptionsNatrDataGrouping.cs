...
namespace Highsoft.Web.Mvc.Stocks
{
	public partial class PlotOptionsNatrDataGrouping  : BaseObject
	{
		...
		internal override Hashtable ToHashtable()
		{
			...
			if (Approximation != Approximation_DefaultValue) { h.Add("approximation",Approximation); Highstock.AddFunction("PlotOptionsNatrDataGroupingApproximation.approximation", Approximation); }  
