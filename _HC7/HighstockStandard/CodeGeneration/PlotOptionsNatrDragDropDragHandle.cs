...
{
	public partial class PlotOptionsNatrDragDropDragHandle  : BaseObject
	{
		public PlotOptionsNatrDragDropDragHandle()
		{
		...
		internal override Hashtable ToHashtable()
		{
			...
			if (PathFormatter != PathFormatter_DefaultValue) { h.Add("pathFormatter",PathFormatter); Highstock.AddFunction("PlotOptionsNatrDragDropDragHandlePathFormatter.pathFormatter", PathFormatter); }  
