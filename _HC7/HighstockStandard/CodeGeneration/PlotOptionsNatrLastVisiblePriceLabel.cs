...
{
	public partial class PlotOptionsNatrLastVisiblePriceLabel  : BaseObject
	{
		Hashtable h = new Hashtable();

		public PlotOptionsNatrLastVisiblePriceLabel()
		{
			Align = Align_DefaultValue = PlotOptionsNatrLastVisiblePriceLabelAlign.Null;
		...
		/// 
		/// </summary>
		public PlotOptionsNatrLastVisiblePriceLabelAlign Align { get; set; }
		private PlotOptionsNatrLastVisiblePriceLabelAlign Align_DefaultValue { get; set; }
