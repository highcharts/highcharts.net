...
{
	public partial class PlotOptionsNatrMarker  : BaseObject
	{
		public PlotOptionsNatrMarker()
		{
			...
			States = States_DefaultValue = new PlotOptionsNatrMarkerStates();
		...
		/// </summary>
		public PlotOptionsNatrMarkerStates States { get; set; }
		private PlotOptionsNatrMarkerStates States_DefaultValue { get; set; }
