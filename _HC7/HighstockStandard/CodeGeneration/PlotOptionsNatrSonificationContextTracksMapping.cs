...
{
	public partial class PlotOptionsNatrSonificationContextTracksMapping  : BaseObject
	{
		Hashtable h = new Hashtable();

		public PlotOptionsNatrSonificationContextTracksMapping()
		{
			Frequency = Frequency_DefaultValue = new PlotOptionsNatrSonificationContextTracksMappingFrequency();
			GapBetweenNotes = GapBetweenNotes_DefaultValue = new PlotOptionsNatrSonificationContextTracksMappingGapBetweenNotes();
			Highpass = Highpass_DefaultValue = new PlotOptionsNatrSonificationContextTracksMappingHighpass();
			Lowpass = Lowpass_DefaultValue = new PlotOptionsNatrSonificationContextTracksMappingLowpass();
			NoteDuration = NoteDuration_DefaultValue = new PlotOptionsNatrSonificationContextTracksMappingNoteDuration();
			Pan = Pan_DefaultValue = new PlotOptionsNatrSonificationContextTracksMappingPan();
			Pitch = Pitch_DefaultValue = new PlotOptionsNatrSonificationContextTracksMappingPitch();
			PitchString = PitchString_DefaultValue = "null";
			PitchNumber = PitchNumber_DefaultValue = null;
			PlayDelay = PlayDelay_DefaultValue = new PlotOptionsNatrSonificationContextTracksMappingPlayDelay();
			Time = Time_DefaultValue = new PlotOptionsNatrSonificationContextTracksMappingTime();
			TimeString = TimeString_DefaultValue = "null";
			TimeNumber = TimeNumber_DefaultValue = null;
			Tremolo = Tremolo_DefaultValue = new PlotOptionsNatrSonificationContextTracksMappingTremolo();
			Volume = Volume_DefaultValue = new PlotOptionsNatrSonificationContextTracksMappingVolume();
		...
		/// </summary>
		public PlotOptionsNatrSonificationContextTracksMappingFrequency Frequency { get; set; }
		private PlotOptionsNatrSonificationContextTracksMappingFrequency Frequency_DefaultValue { get; set; }
		...
		/// </summary>
		public PlotOptionsNatrSonificationContextTracksMappingGapBetweenNotes GapBetweenNotes { get; set; }
		private PlotOptionsNatrSonificationContextTracksMappingGapBetweenNotes GapBetweenNotes_DefaultValue { get; set; }
		...
		/// </summary>
		public PlotOptionsNatrSonificationContextTracksMappingHighpass Highpass { get; set; }
		private PlotOptionsNatrSonificationContextTracksMappingHighpass Highpass_DefaultValue { get; set; }
		...
		/// </summary>
		public PlotOptionsNatrSonificationContextTracksMappingLowpass Lowpass { get; set; }
		private PlotOptionsNatrSonificationContextTracksMappingLowpass Lowpass_DefaultValue { get; set; }
		...
		/// </summary>
		public PlotOptionsNatrSonificationContextTracksMappingNoteDuration NoteDuration { get; set; }
		private PlotOptionsNatrSonificationContextTracksMappingNoteDuration NoteDuration_DefaultValue { get; set; }
		...
		/// </summary>
		public PlotOptionsNatrSonificationContextTracksMappingPan Pan { get; set; }
		private PlotOptionsNatrSonificationContextTracksMappingPan Pan_DefaultValue { get; set; }
		...
		/// </summary>
		public PlotOptionsNatrSonificationContextTracksMappingPitch Pitch { get; set; }
		private PlotOptionsNatrSonificationContextTracksMappingPitch Pitch_DefaultValue { get; set; }
		...
		/// </summary>
		public PlotOptionsNatrSonificationContextTracksMappingPlayDelay PlayDelay { get; set; }
		private PlotOptionsNatrSonificationContextTracksMappingPlayDelay PlayDelay_DefaultValue { get; set; }
		...
		/// </summary>
		public PlotOptionsNatrSonificationContextTracksMappingTime Time { get; set; }
		private PlotOptionsNatrSonificationContextTracksMappingTime Time_DefaultValue { get; set; }
		...
		/// </summary>
		public PlotOptionsNatrSonificationContextTracksMappingTremolo Tremolo { get; set; }
		private PlotOptionsNatrSonificationContextTracksMappingTremolo Tremolo_DefaultValue { get; set; }
		 

		/// <summary>
		/// The volume of notes, from 0 to 1.
		/// </summary>
		public PlotOptionsNatrSonificationContextTracksMappingVolume Volume { get; set; }
		private PlotOptionsNatrSonificationContextTracksMappingVolume Volume_DefaultValue { get; set; }
