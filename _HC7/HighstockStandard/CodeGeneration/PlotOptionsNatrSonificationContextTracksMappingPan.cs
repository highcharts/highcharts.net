...
{
	public partial class PlotOptionsNatrSonificationContextTracksMappingPan  : BaseObject
	{
		Hashtable h = new Hashtable();

		public PlotOptionsNatrSonificationContextTracksMappingPan()
		{
			MapFunction = MapFunction_DefaultValue = PlotOptionsNatrSonificationContextTracksMappingPanMapFunction.Linear;
			MapTo = MapTo_DefaultValue = "";
			Max = Max_DefaultValue = null;
			Min = Min_DefaultValue = null;
			Value = Value_DefaultValue = null;
			Within = Within_DefaultValue = PlotOptionsNatrSonificationContextTracksMappingPanWithin.Chart;
		...
		/// </summary>
		public PlotOptionsNatrSonificationContextTracksMappingPanMapFunction MapFunction { get; set; }
		private PlotOptionsNatrSonificationContextTracksMappingPanMapFunction MapFunction_DefaultValue { get; set; }
		...
		/// </summary>
		public PlotOptionsNatrSonificationContextTracksMappingPanWithin Within { get; set; }
		private PlotOptionsNatrSonificationContextTracksMappingPanWithin Within_DefaultValue { get; set; }
