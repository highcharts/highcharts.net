...
{
	public partial class PlotOptionsNatrSonificationContextTracksMappingVolume  : BaseObject
	{
		Hashtable h = new Hashtable();

		public PlotOptionsNatrSonificationContextTracksMappingVolume()
		{
			MapFunction = MapFunction_DefaultValue = PlotOptionsNatrSonificationContextTracksMappingVolumeMapFunction.Linear;
			MapTo = MapTo_DefaultValue = "";
			Max = Max_DefaultValue = null;
			Min = Min_DefaultValue = null;
			Value = Value_DefaultValue = null;
			Within = Within_DefaultValue = PlotOptionsNatrSonificationContextTracksMappingVolumeWithin.Chart;
		...
		/// </summary>
		public PlotOptionsNatrSonificationContextTracksMappingVolumeMapFunction MapFunction { get; set; }
		private PlotOptionsNatrSonificationContextTracksMappingVolumeMapFunction MapFunction_DefaultValue { get; set; }
		...
		/// </summary>
		public PlotOptionsNatrSonificationContextTracksMappingVolumeWithin Within { get; set; }
		private PlotOptionsNatrSonificationContextTracksMappingVolumeWithin Within_DefaultValue { get; set; }
