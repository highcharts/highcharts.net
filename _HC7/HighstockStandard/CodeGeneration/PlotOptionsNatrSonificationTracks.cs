...
{
	public partial class PlotOptionsNatrSonificationTracks  : BaseObject
	{
		Hashtable h = new Hashtable();

		public PlotOptionsNatrSonificationTracks()
		{
			ActiveWhen = ActiveWhen_DefaultValue = new PlotOptionsNatrSonificationTracksActiveWhen();
			Instrument = Instrument_DefaultValue = null;
			InstrumentString = InstrumentString_DefaultValue = "null";
			Mapping = Mapping_DefaultValue = new PlotOptionsNatrSonificationTracksMapping();
			MidiName = MidiName_DefaultValue = "";
			PointGrouping = PointGrouping_DefaultValue = new PlotOptionsNatrSonificationTracksPointGrouping();
			RoundToMusicalNotes = RoundToMusicalNotes_DefaultValue = true;
			ShowPlayMarker = ShowPlayMarker_DefaultValue = true;
			Type = Type_DefaultValue = PlotOptionsNatrSonificationTracksType.Instrument;
		...
		/// </summary>
		public PlotOptionsNatrSonificationTracksActiveWhen ActiveWhen { get; set; }
		private PlotOptionsNatrSonificationTracksActiveWhen ActiveWhen_DefaultValue { get; set; }
		...
		/// </summary>
		public PlotOptionsNatrSonificationTracksMapping Mapping { get; set; }
		private PlotOptionsNatrSonificationTracksMapping Mapping_DefaultValue { get; set; }
		...
		/// </summary>
		public PlotOptionsNatrSonificationTracksPointGrouping PointGrouping { get; set; }
		private PlotOptionsNatrSonificationTracksPointGrouping PointGrouping_DefaultValue { get; set; }
		...
		/// </summary>
		public PlotOptionsNatrSonificationTracksType Type { get; set; }
		private PlotOptionsNatrSonificationTracksType Type_DefaultValue { get; set; }
