...
{
	public partial class PlotOptionsNatrSonificationTracksMappingPan  : BaseObject
	{
		Hashtable h = new Hashtable();

		public PlotOptionsNatrSonificationTracksMappingPan()
		{
			MapFunction = MapFunction_DefaultValue = PlotOptionsNatrSonificationTracksMappingPanMapFunction.Linear;
			MapTo = MapTo_DefaultValue = "";
			Max = Max_DefaultValue = null;
			Min = Min_DefaultValue = null;
			Value = Value_DefaultValue = null;
			Within = Within_DefaultValue = PlotOptionsNatrSonificationTracksMappingPanWithin.Chart;
		...
		/// </summary>
		public PlotOptionsNatrSonificationTracksMappingPanMapFunction MapFunction { get; set; }
		private PlotOptionsNatrSonificationTracksMappingPanMapFunction MapFunction_DefaultValue { get; set; }
		...
		/// </summary>
		public PlotOptionsNatrSonificationTracksMappingPanWithin Within { get; set; }
		private PlotOptionsNatrSonificationTracksMappingPanWithin Within_DefaultValue { get; set; }
