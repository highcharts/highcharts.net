...
{
	public partial class PlotOptionsNatrSonificationTracksMappingPitch  : BaseObject
	{
		Hashtable h = new Hashtable();

		public PlotOptionsNatrSonificationTracksMappingPitch()
		{
			MapFunction = MapFunction_DefaultValue = PlotOptionsNatrSonificationTracksMappingPitchMapFunction.Linear;
		...
		/// </summary>
		public PlotOptionsNatrSonificationTracksMappingPitchMapFunction MapFunction { get; set; }
		private PlotOptionsNatrSonificationTracksMappingPitchMapFunction MapFunction_DefaultValue { get; set; }
