...
{
	public partial class PlotOptionsNatrSonificationTracksMappingTime  : BaseObject
	{
		Hashtable h = new Hashtable();

		public PlotOptionsNatrSonificationTracksMappingTime()
		{
			MapFunction = MapFunction_DefaultValue = PlotOptionsNatrSonificationTracksMappingTimeMapFunction.Linear;
			MapTo = MapTo_DefaultValue = "";
			Max = Max_DefaultValue = null;
			Min = Min_DefaultValue = null;
			Value = Value_DefaultValue = null;
			Within = Within_DefaultValue = PlotOptionsNatrSonificationTracksMappingTimeWithin.Chart;
		...
		/// </summary>
		public PlotOptionsNatrSonificationTracksMappingTimeMapFunction MapFunction { get; set; }
		private PlotOptionsNatrSonificationTracksMappingTimeMapFunction MapFunction_DefaultValue { get; set; }
		...
		/// </summary>
		public PlotOptionsNatrSonificationTracksMappingTimeWithin Within { get; set; }
		private PlotOptionsNatrSonificationTracksMappingTimeWithin Within_DefaultValue { get; set; }
