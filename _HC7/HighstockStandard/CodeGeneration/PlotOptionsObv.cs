...
namespace Highsoft.Web.Mvc.Stocks
{
	public partial class PlotOptionsObv  : BaseObject
	{
		...
		public PlotOptionsObv()
		{
			...
			Zones = Zones_DefaultValue = new List<PlotOptionsObvZone>();
		...
		/// </summary>
		public List<PlotOptionsObvZone> Zones { get; set; }
		private List<PlotOptionsObvZone> Zones_DefaultValue { get; set; }
