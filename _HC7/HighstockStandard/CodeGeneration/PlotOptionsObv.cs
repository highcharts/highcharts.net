...
{
	public partial class PlotOptionsObv  : BaseObject
	{
		Hashtable h = new Hashtable();

		public PlotOptionsObv()
		{
			Accessibility = Accessibility_DefaultValue = new PlotOptionsObvAccessibility();
			AllowPointSelect = AllowPointSelect_DefaultValue = false;
			Animation = Animation_DefaultValue = new Animation() { Enabled = true };
			AnimationBool = AnimationBool_DefaultValue = true;
			AnimationLimit = AnimationLimit_DefaultValue = null;
			BoostBlending = BoostBlending_DefaultValue = PlotOptionsObvBoostBlending.Undefined;
			...
			Compare = Compare_DefaultValue = PlotOptionsObvCompare.Percent;
			CompareBase = CompareBase_DefaultValue = PlotOptionsObvCompareBase.Min;
			...
			Cursor = Cursor_DefaultValue = PlotOptionsObvCursor.Null;
			Custom = Custom_DefaultValue = new Hashtable();
			DashStyle = DashStyle_DefaultValue = PlotOptionsObvDashStyle.Null;
			DataGrouping = DataGrouping_DefaultValue = new PlotOptionsObvDataGrouping();
			DataLabels = DataLabels_DefaultValue = new PlotOptionsObvDataLabels();
			DataSorting = DataSorting_DefaultValue = new PlotOptionsObvDataSorting();
			Description = Description_DefaultValue = "";
			EnableMouseTracking = EnableMouseTracking_DefaultValue = true;
			Events = Events_DefaultValue = new PlotOptionsObvEvents();
			FindNearestPointBy = FindNearestPointBy_DefaultValue = PlotOptionsObvFindNearestPointBy.X;
			GapSize = GapSize_DefaultValue = 0;
			GapUnit = GapUnit_DefaultValue = PlotOptionsObvGapUnit.Relative;
			GetExtremesFromAll = GetExtremesFromAll_DefaultValue = false;
			InactiveOtherPoints = InactiveOtherPoints_DefaultValue = false;
			IncludeInDataExport = IncludeInDataExport_DefaultValue = null;
			Label = Label_DefaultValue = new PlotOptionsObvLabel();
			LastPrice = LastPrice_DefaultValue = new PlotOptionsObvLastPrice();
			LastVisiblePrice = LastVisiblePrice_DefaultValue = new PlotOptionsObvLastVisiblePrice();
			LegendSymbol = LegendSymbol_DefaultValue = PlotOptionsObvLegendSymbol.Rectangle;
			Linecap = Linecap_DefaultValue = PlotOptionsObvLinecap.Round;
			LineWidth = LineWidth_DefaultValue = 2;
			LinkedTo = LinkedTo_DefaultValue = "";
			Marker = Marker_DefaultValue = new PlotOptionsObvMarker();
			NegativeColor = NegativeColor_DefaultValue = "";
			OnPoint = OnPoint_DefaultValue = new PlotOptionsObvOnPoint();
			Opacity = Opacity_DefaultValue = 1;
			Params = Params_DefaultValue = new PlotOptionsObvParams();
			Point = Point_DefaultValue = new PlotOptionsObvPoint();
			...
			Sonification = Sonification_DefaultValue = new PlotOptionsObvSonification();
			States = States_DefaultValue = new PlotOptionsObvStates();
			Step = Step_DefaultValue = PlotOptionsObvStep.Null;
			StickyTracking = StickyTracking_DefaultValue = true;
			Threshold = Threshold_DefaultValue = 0;
			Tooltip = Tooltip_DefaultValue = new PlotOptionsObvTooltip();
			TurboThreshold = TurboThreshold_DefaultValue = 1000;
			Visible = Visible_DefaultValue = true;
			ZoneAxis = ZoneAxis_DefaultValue = "y";
			Zones = Zones_DefaultValue = new List<PlotOptionsObvZones>();
		...
		/// </summary>
		public PlotOptionsObvAccessibility Accessibility { get; set; }
		private PlotOptionsObvAccessibility Accessibility_DefaultValue { get; set; }
		...
		/// </summary>
		public PlotOptionsObvBoostBlending BoostBlending { get; set; }
		private PlotOptionsObvBoostBlending BoostBlending_DefaultValue { get; set; }
		...
		/// </summary>
		public PlotOptionsObvCompare Compare { get; set; }
		private PlotOptionsObvCompare Compare_DefaultValue { get; set; }
		 

		/// <summary>
		/// When [compare](#plotOptions.series.compare) is `percent`, this optiondictates whether to use 0 or 100 as the base of comparison.
		/// </summary>
		public PlotOptionsObvCompareBase CompareBase { get; set; }
		private PlotOptionsObvCompareBase CompareBase_DefaultValue { get; set; }
		...
		/// </summary>
		public PlotOptionsObvCursor Cursor { get; set; }
		private PlotOptionsObvCursor Cursor_DefaultValue { get; set; }
		...
		/// </summary>
		public PlotOptionsObvDashStyle DashStyle { get; set; }
		private PlotOptionsObvDashStyle DashStyle_DefaultValue { get; set; }
		...
		/// </summary>
		public PlotOptionsObvDataGrouping DataGrouping { get; set; }
		private PlotOptionsObvDataGrouping DataGrouping_DefaultValue { get; set; }
		...
		/// </summary>
		public PlotOptionsObvDataLabels DataLabels { get; set; }
		private PlotOptionsObvDataLabels DataLabels_DefaultValue { get; set; }
		 

		/// <summary>
		/// Options for the series data sorting.
		/// </summary>
		public PlotOptionsObvDataSorting DataSorting { get; set; }
		private PlotOptionsObvDataSorting DataSorting_DefaultValue { get; set; }
		...
		/// </summary>
		public PlotOptionsObvEvents Events { get; set; }
		private PlotOptionsObvEvents Events_DefaultValue { get; set; }
		...
		/// </summary>
		public PlotOptionsObvFindNearestPointBy FindNearestPointBy { get; set; }
		private PlotOptionsObvFindNearestPointBy FindNearestPointBy_DefaultValue { get; set; }
		...
		/// </summary>
		public PlotOptionsObvGapUnit GapUnit { get; set; }
		private PlotOptionsObvGapUnit GapUnit_DefaultValue { get; set; }
		...
		/// </summary>
		public PlotOptionsObvLabel Label { get; set; }
		private PlotOptionsObvLabel Label_DefaultValue { get; set; }
		 

		/// <summary>
		/// The line marks the last price from all points.
		/// </summary>
		public PlotOptionsObvLastPrice LastPrice { get; set; }
		private PlotOptionsObvLastPrice LastPrice_DefaultValue { get; set; }
		 

		/// <summary>
		/// The line marks the last price from visible range of points.
		/// </summary>
		public PlotOptionsObvLastVisiblePrice LastVisiblePrice { get; set; }
		private PlotOptionsObvLastVisiblePrice LastVisiblePrice_DefaultValue { get; set; }
		 

		/// <summary>
		/// What type of legend symbol to render for this series. Can be one of`lineMarker` or `rectangle`.
		/// </summary>
		public PlotOptionsObvLegendSymbol LegendSymbol { get; set; }
		private PlotOptionsObvLegendSymbol LegendSymbol_DefaultValue { get; set; }
		 

		/// <summary>
		/// The line cap used for line ends and line joins on the graph.
		/// </summary>
		public PlotOptionsObvLinecap Linecap { get; set; }
		private PlotOptionsObvLinecap Linecap_DefaultValue { get; set; }
		...
		/// 
		/// </summary>
		public PlotOptionsObvMarker Marker { get; set; }
		private PlotOptionsObvMarker Marker_DefaultValue { get; set; }
		...
		/// </summary>
		public PlotOptionsObvOnPoint OnPoint { get; set; }
		private PlotOptionsObvOnPoint OnPoint_DefaultValue { get; set; }
		...
		/// 
		/// </summary>
		public PlotOptionsObvParams Params { get; set; }
		private PlotOptionsObvParams Params_DefaultValue { get; set; }
		 

		/// <summary>
		/// Properties for each single point.
		/// </summary>
		public PlotOptionsObvPoint Point { get; set; }
		private PlotOptionsObvPoint Point_DefaultValue { get; set; }
		...
		/// </summary>
		public PlotOptionsObvSonification Sonification { get; set; }
		private PlotOptionsObvSonification Sonification_DefaultValue { get; set; }
		 

		/// <summary>
		/// 
		/// </summary>
		public PlotOptionsObvStates States { get; set; }
		private PlotOptionsObvStates States_DefaultValue { get; set; }
		 

		/// <summary>
		/// Whether to apply steps to the line. Possible values are `left`,`center` and `right`.
		/// </summary>
		public PlotOptionsObvStep Step { get; set; }
		private PlotOptionsObvStep Step_DefaultValue { get; set; }
		...
		/// 
		/// </summary>
		public PlotOptionsObvTooltip Tooltip { get; set; }
		private PlotOptionsObvTooltip Tooltip_DefaultValue { get; set; }
		...
		/// </summary>
		public List<PlotOptionsObvZones> Zones { get; set; }
		private List<PlotOptionsObvZones> Zones_DefaultValue { get; set; }
