...
{
	public partial class PlotOptionsObvSonificationContextTracks  : BaseObject
	{
		Hashtable h = new Hashtable();

		public PlotOptionsObvSonificationContextTracks()
		{
			ActiveWhen = ActiveWhen_DefaultValue = new PlotOptionsObvSonificationContextTracksActiveWhen();
			Instrument = Instrument_DefaultValue = null;
			InstrumentString = InstrumentString_DefaultValue = "null";
			Mapping = Mapping_DefaultValue = new PlotOptionsObvSonificationContextTracksMapping();
			MidiName = MidiName_DefaultValue = "";
			PointGrouping = PointGrouping_DefaultValue = new PlotOptionsObvSonificationContextTracksPointGrouping();
			...
			Type = Type_DefaultValue = PlotOptionsObvSonificationContextTracksType.Instrument;
			ValueInterval = ValueInterval_DefaultValue = null;
			ValueMapFunction = ValueMapFunction_DefaultValue = PlotOptionsObvSonificationContextTracksValueMapFunction.Linear;
		...
		/// </summary>
		public PlotOptionsObvSonificationContextTracksActiveWhen ActiveWhen { get; set; }
		private PlotOptionsObvSonificationContextTracksActiveWhen ActiveWhen_DefaultValue { get; set; }
		...
		/// </summary>
		public PlotOptionsObvSonificationContextTracksMapping Mapping { get; set; }
		private PlotOptionsObvSonificationContextTracksMapping Mapping_DefaultValue { get; set; }
		...
		/// </summary>
		public PlotOptionsObvSonificationContextTracksPointGrouping PointGrouping { get; set; }
		private PlotOptionsObvSonificationContextTracksPointGrouping PointGrouping_DefaultValue { get; set; }
		...
		/// </summary>
		public PlotOptionsObvSonificationContextTracksType Type { get; set; }
		private PlotOptionsObvSonificationContextTracksType Type_DefaultValue { get; set; }
		...
		/// </summary>
		public PlotOptionsObvSonificationContextTracksValueMapFunction ValueMapFunction { get; set; }
		private PlotOptionsObvSonificationContextTracksValueMapFunction ValueMapFunction_DefaultValue { get; set; }
