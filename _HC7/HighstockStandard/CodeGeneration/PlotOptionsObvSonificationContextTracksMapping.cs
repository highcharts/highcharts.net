...
{
	public partial class PlotOptionsObvSonificationContextTracksMapping  : BaseObject
	{
		Hashtable h = new Hashtable();

		public PlotOptionsObvSonificationContextTracksMapping()
		{
			Frequency = Frequency_DefaultValue = new PlotOptionsObvSonificationContextTracksMappingFrequency();
			GapBetweenNotes = GapBetweenNotes_DefaultValue = new PlotOptionsObvSonificationContextTracksMappingGapBetweenNotes();
			Highpass = Highpass_DefaultValue = new PlotOptionsObvSonificationContextTracksMappingHighpass();
			Lowpass = Lowpass_DefaultValue = new PlotOptionsObvSonificationContextTracksMappingLowpass();
			NoteDuration = NoteDuration_DefaultValue = new PlotOptionsObvSonificationContextTracksMappingNoteDuration();
			Pan = Pan_DefaultValue = new PlotOptionsObvSonificationContextTracksMappingPan();
			Pitch = Pitch_DefaultValue = new PlotOptionsObvSonificationContextTracksMappingPitch();
			PitchString = PitchString_DefaultValue = "null";
			PitchNumber = PitchNumber_DefaultValue = null;
			PlayDelay = PlayDelay_DefaultValue = new PlotOptionsObvSonificationContextTracksMappingPlayDelay();
			Time = Time_DefaultValue = new PlotOptionsObvSonificationContextTracksMappingTime();
			TimeString = TimeString_DefaultValue = "null";
			TimeNumber = TimeNumber_DefaultValue = null;
			Tremolo = Tremolo_DefaultValue = new PlotOptionsObvSonificationContextTracksMappingTremolo();
			Volume = Volume_DefaultValue = new PlotOptionsObvSonificationContextTracksMappingVolume();
		...
		/// </summary>
		public PlotOptionsObvSonificationContextTracksMappingFrequency Frequency { get; set; }
		private PlotOptionsObvSonificationContextTracksMappingFrequency Frequency_DefaultValue { get; set; }
		...
		/// </summary>
		public PlotOptionsObvSonificationContextTracksMappingGapBetweenNotes GapBetweenNotes { get; set; }
		private PlotOptionsObvSonificationContextTracksMappingGapBetweenNotes GapBetweenNotes_DefaultValue { get; set; }
		...
		/// </summary>
		public PlotOptionsObvSonificationContextTracksMappingHighpass Highpass { get; set; }
		private PlotOptionsObvSonificationContextTracksMappingHighpass Highpass_DefaultValue { get; set; }
		...
		/// </summary>
		public PlotOptionsObvSonificationContextTracksMappingLowpass Lowpass { get; set; }
		private PlotOptionsObvSonificationContextTracksMappingLowpass Lowpass_DefaultValue { get; set; }
		...
		/// </summary>
		public PlotOptionsObvSonificationContextTracksMappingNoteDuration NoteDuration { get; set; }
		private PlotOptionsObvSonificationContextTracksMappingNoteDuration NoteDuration_DefaultValue { get; set; }
		...
		/// </summary>
		public PlotOptionsObvSonificationContextTracksMappingPan Pan { get; set; }
		private PlotOptionsObvSonificationContextTracksMappingPan Pan_DefaultValue { get; set; }
		...
		/// </summary>
		public PlotOptionsObvSonificationContextTracksMappingPitch Pitch { get; set; }
		private PlotOptionsObvSonificationContextTracksMappingPitch Pitch_DefaultValue { get; set; }
		...
		/// </summary>
		public PlotOptionsObvSonificationContextTracksMappingPlayDelay PlayDelay { get; set; }
		private PlotOptionsObvSonificationContextTracksMappingPlayDelay PlayDelay_DefaultValue { get; set; }
		...
		/// </summary>
		public PlotOptionsObvSonificationContextTracksMappingTime Time { get; set; }
		private PlotOptionsObvSonificationContextTracksMappingTime Time_DefaultValue { get; set; }
		...
		/// </summary>
		public PlotOptionsObvSonificationContextTracksMappingTremolo Tremolo { get; set; }
		private PlotOptionsObvSonificationContextTracksMappingTremolo Tremolo_DefaultValue { get; set; }
		 

		/// <summary>
		/// The volume of notes, from 0 to 1.
		/// </summary>
		public PlotOptionsObvSonificationContextTracksMappingVolume Volume { get; set; }
		private PlotOptionsObvSonificationContextTracksMappingVolume Volume_DefaultValue { get; set; }
