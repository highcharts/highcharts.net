...
{
	public partial class PlotOptionsObvSonificationContextTracksMappingFrequency  : BaseObject
	{
		Hashtable h = new Hashtable();

		public PlotOptionsObvSonificationContextTracksMappingFrequency()
		{
			MapFunction = MapFunction_DefaultValue = PlotOptionsObvSonificationContextTracksMappingFrequencyMapFunction.Linear;
			MapTo = MapTo_DefaultValue = "";
			Max = Max_DefaultValue = null;
			Min = Min_DefaultValue = null;
			Value = Value_DefaultValue = null;
			Within = Within_DefaultValue = PlotOptionsObvSonificationContextTracksMappingFrequencyWithin.Chart;
		...
		/// </summary>
		public PlotOptionsObvSonificationContextTracksMappingFrequencyMapFunction MapFunction { get; set; }
		private PlotOptionsObvSonificationContextTracksMappingFrequencyMapFunction MapFunction_DefaultValue { get; set; }
		...
		/// </summary>
		public PlotOptionsObvSonificationContextTracksMappingFrequencyWithin Within { get; set; }
		private PlotOptionsObvSonificationContextTracksMappingFrequencyWithin Within_DefaultValue { get; set; }
