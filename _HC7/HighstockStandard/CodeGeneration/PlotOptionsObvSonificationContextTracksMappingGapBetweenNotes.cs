...
{
	public partial class PlotOptionsObvSonificationContextTracksMappingGapBetweenNotes  : BaseObject
	{
		Hashtable h = new Hashtable();

		public PlotOptionsObvSonificationContextTracksMappingGapBetweenNotes()
		{
			MapFunction = MapFunction_DefaultValue = PlotOptionsObvSonificationContextTracksMappingGapBetweenNotesMapFunction.Linear;
			MapTo = MapTo_DefaultValue = "";
			Max = Max_DefaultValue = null;
			Min = Min_DefaultValue = null;
			Value = Value_DefaultValue = null;
			Within = Within_DefaultValue = PlotOptionsObvSonificationContextTracksMappingGapBetweenNotesWithin.Chart;
		...
		/// </summary>
		public PlotOptionsObvSonificationContextTracksMappingGapBetweenNotesMapFunction MapFunction { get; set; }
		private PlotOptionsObvSonificationContextTracksMappingGapBetweenNotesMapFunction MapFunction_DefaultValue { get; set; }
		...
		/// </summary>
		public PlotOptionsObvSonificationContextTracksMappingGapBetweenNotesWithin Within { get; set; }
		private PlotOptionsObvSonificationContextTracksMappingGapBetweenNotesWithin Within_DefaultValue { get; set; }
