...
{
	public partial class PlotOptionsObvSonificationDefaultSpeechOptionsMappingLowpassResonance  : BaseObject
	{
		Hashtable h = new Hashtable();

		public PlotOptionsObvSonificationDefaultSpeechOptionsMappingLowpassResonance()
		{
			MapFunction = MapFunction_DefaultValue = PlotOptionsObvSonificationDefaultSpeechOptionsMappingLowpassResonanceMapFunction.Linear;
			MapTo = MapTo_DefaultValue = "";
			Max = Max_DefaultValue = null;
			Min = Min_DefaultValue = null;
			Value = Value_DefaultValue = null;
			Within = Within_DefaultValue = PlotOptionsObvSonificationDefaultSpeechOptionsMappingLowpassResonanceWithin.Chart;
		...
		/// </summary>
		public PlotOptionsObvSonificationDefaultSpeechOptionsMappingLowpassResonanceMapFunction MapFunction { get; set; }
		private PlotOptionsObvSonificationDefaultSpeechOptionsMappingLowpassResonanceMapFunction MapFunction_DefaultValue { get; set; }
		...
		/// </summary>
		public PlotOptionsObvSonificationDefaultSpeechOptionsMappingLowpassResonanceWithin Within { get; set; }
		private PlotOptionsObvSonificationDefaultSpeechOptionsMappingLowpassResonanceWithin Within_DefaultValue { get; set; }
