...
{
	public partial class PlotOptionsObvSonificationPointGrouping  : BaseObject
	{
		Hashtable h = new Hashtable();

		public PlotOptionsObvSonificationPointGrouping()
		{
			Algorithm = Algorithm_DefaultValue = PlotOptionsObvSonificationPointGroupingAlgorithm.Minimax;
		...
		/// </summary>
		public PlotOptionsObvSonificationPointGroupingAlgorithm Algorithm { get; set; }
		private PlotOptionsObvSonificationPointGroupingAlgorithm Algorithm_DefaultValue { get; set; }
