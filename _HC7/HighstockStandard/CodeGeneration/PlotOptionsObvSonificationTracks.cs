...
{
	public partial class PlotOptionsObvSonificationTracks  : BaseObject
	{
		Hashtable h = new Hashtable();

		public PlotOptionsObvSonificationTracks()
		{
			ActiveWhen = ActiveWhen_DefaultValue = new PlotOptionsObvSonificationTracksActiveWhen();
			Instrument = Instrument_DefaultValue = null;
			InstrumentString = InstrumentString_DefaultValue = "null";
			Mapping = Mapping_DefaultValue = new PlotOptionsObvSonificationTracksMapping();
			MidiName = MidiName_DefaultValue = "";
			PointGrouping = PointGrouping_DefaultValue = new PlotOptionsObvSonificationTracksPointGrouping();
			RoundToMusicalNotes = RoundToMusicalNotes_DefaultValue = true;
			ShowPlayMarker = ShowPlayMarker_DefaultValue = true;
			Type = Type_DefaultValue = PlotOptionsObvSonificationTracksType.Instrument;
		...
		/// </summary>
		public PlotOptionsObvSonificationTracksActiveWhen ActiveWhen { get; set; }
		private PlotOptionsObvSonificationTracksActiveWhen ActiveWhen_DefaultValue { get; set; }
		...
		/// </summary>
		public PlotOptionsObvSonificationTracksMapping Mapping { get; set; }
		private PlotOptionsObvSonificationTracksMapping Mapping_DefaultValue { get; set; }
		...
		/// </summary>
		public PlotOptionsObvSonificationTracksPointGrouping PointGrouping { get; set; }
		private PlotOptionsObvSonificationTracksPointGrouping PointGrouping_DefaultValue { get; set; }
		...
		/// </summary>
		public PlotOptionsObvSonificationTracksType Type { get; set; }
		private PlotOptionsObvSonificationTracksType Type_DefaultValue { get; set; }
