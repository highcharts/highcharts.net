...
{
	public partial class PlotOptionsObvSonificationTracksMappingFrequency  : BaseObject
	{
		Hashtable h = new Hashtable();

		public PlotOptionsObvSonificationTracksMappingFrequency()
		{
			MapFunction = MapFunction_DefaultValue = PlotOptionsObvSonificationTracksMappingFrequencyMapFunction.Linear;
			MapTo = MapTo_DefaultValue = "";
			Max = Max_DefaultValue = null;
			Min = Min_DefaultValue = null;
			Value = Value_DefaultValue = null;
			Within = Within_DefaultValue = PlotOptionsObvSonificationTracksMappingFrequencyWithin.Chart;
		...
		/// </summary>
		public PlotOptionsObvSonificationTracksMappingFrequencyMapFunction MapFunction { get; set; }
		private PlotOptionsObvSonificationTracksMappingFrequencyMapFunction MapFunction_DefaultValue { get; set; }
		...
		/// </summary>
		public PlotOptionsObvSonificationTracksMappingFrequencyWithin Within { get; set; }
		private PlotOptionsObvSonificationTracksMappingFrequencyWithin Within_DefaultValue { get; set; }
