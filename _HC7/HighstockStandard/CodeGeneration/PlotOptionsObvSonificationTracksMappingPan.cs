...
{
	public partial class PlotOptionsObvSonificationTracksMappingPan  : BaseObject
	{
		Hashtable h = new Hashtable();

		public PlotOptionsObvSonificationTracksMappingPan()
		{
			MapFunction = MapFunction_DefaultValue = PlotOptionsObvSonificationTracksMappingPanMapFunction.Linear;
			MapTo = MapTo_DefaultValue = "";
			Max = Max_DefaultValue = null;
			Min = Min_DefaultValue = null;
			Value = Value_DefaultValue = null;
			Within = Within_DefaultValue = PlotOptionsObvSonificationTracksMappingPanWithin.Chart;
		...
		/// </summary>
		public PlotOptionsObvSonificationTracksMappingPanMapFunction MapFunction { get; set; }
		private PlotOptionsObvSonificationTracksMappingPanMapFunction MapFunction_DefaultValue { get; set; }
		...
		/// </summary>
		public PlotOptionsObvSonificationTracksMappingPanWithin Within { get; set; }
		private PlotOptionsObvSonificationTracksMappingPanWithin Within_DefaultValue { get; set; }
