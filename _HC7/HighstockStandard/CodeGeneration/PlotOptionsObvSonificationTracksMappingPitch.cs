...
{
	public partial class PlotOptionsObvSonificationTracksMappingPitch  : BaseObject
	{
		Hashtable h = new Hashtable();

		public PlotOptionsObvSonificationTracksMappingPitch()
		{
			MapFunction = MapFunction_DefaultValue = PlotOptionsObvSonificationTracksMappingPitchMapFunction.Linear;
		...
		/// </summary>
		public PlotOptionsObvSonificationTracksMappingPitchMapFunction MapFunction { get; set; }
		private PlotOptionsObvSonificationTracksMappingPitchMapFunction MapFunction_DefaultValue { get; set; }
