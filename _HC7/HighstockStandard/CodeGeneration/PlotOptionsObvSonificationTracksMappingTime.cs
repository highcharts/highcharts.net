...
{
	public partial class PlotOptionsObvSonificationTracksMappingTime  : BaseObject
	{
		Hashtable h = new Hashtable();

		public PlotOptionsObvSonificationTracksMappingTime()
		{
			MapFunction = MapFunction_DefaultValue = PlotOptionsObvSonificationTracksMappingTimeMapFunction.Linear;
			MapTo = MapTo_DefaultValue = "";
			Max = Max_DefaultValue = null;
			Min = Min_DefaultValue = null;
			Value = Value_DefaultValue = null;
			Within = Within_DefaultValue = PlotOptionsObvSonificationTracksMappingTimeWithin.Chart;
		...
		/// </summary>
		public PlotOptionsObvSonificationTracksMappingTimeMapFunction MapFunction { get; set; }
		private PlotOptionsObvSonificationTracksMappingTimeMapFunction MapFunction_DefaultValue { get; set; }
		...
		/// </summary>
		public PlotOptionsObvSonificationTracksMappingTimeWithin Within { get; set; }
		private PlotOptionsObvSonificationTracksMappingTimeWithin Within_DefaultValue { get; set; }
