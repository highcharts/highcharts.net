...
{
	public partial class PlotOptionsObvSonificationTracksMappingVolume  : BaseObject
	{
		Hashtable h = new Hashtable();

		public PlotOptionsObvSonificationTracksMappingVolume()
		{
			MapFunction = MapFunction_DefaultValue = PlotOptionsObvSonificationTracksMappingVolumeMapFunction.Linear;
			MapTo = MapTo_DefaultValue = "";
			Max = Max_DefaultValue = null;
			Min = Min_DefaultValue = null;
			Value = Value_DefaultValue = null;
			Within = Within_DefaultValue = PlotOptionsObvSonificationTracksMappingVolumeWithin.Chart;
		...
		/// </summary>
		public PlotOptionsObvSonificationTracksMappingVolumeMapFunction MapFunction { get; set; }
		private PlotOptionsObvSonificationTracksMappingVolumeMapFunction MapFunction_DefaultValue { get; set; }
		...
		/// </summary>
		public PlotOptionsObvSonificationTracksMappingVolumeWithin Within { get; set; }
		private PlotOptionsObvSonificationTracksMappingVolumeWithin Within_DefaultValue { get; set; }
