...
{
	public partial class PlotOptionsObvSonificationTracksPointGrouping  : BaseObject
	{
		Hashtable h = new Hashtable();

		public PlotOptionsObvSonificationTracksPointGrouping()
		{
			Algorithm = Algorithm_DefaultValue = PlotOptionsObvSonificationTracksPointGroupingAlgorithm.Minimax;
		...
		/// </summary>
		public PlotOptionsObvSonificationTracksPointGroupingAlgorithm Algorithm { get; set; }
		private PlotOptionsObvSonificationTracksPointGroupingAlgorithm Algorithm_DefaultValue { get; set; }
