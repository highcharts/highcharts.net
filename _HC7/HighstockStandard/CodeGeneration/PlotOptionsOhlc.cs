...
{
	public partial class PlotOptionsOhlc  : BaseObject
	{
		Hashtable h = new Hashtable();

		public PlotOptionsOhlc()
		{
			Accessibility = Accessibility_DefaultValue = new PlotOptionsOhlcAccessibility();
			AllowPointSelect = AllowPointSelect_DefaultValue = false;
			Animation = Animation_DefaultValue = new Animation() { Enabled = true };
			AnimationBool = AnimationBool_DefaultValue = true;
			AnimationLimit = AnimationLimit_DefaultValue = null;
			BoostBlending = BoostBlending_DefaultValue = PlotOptionsOhlcBoostBlending.Undefined;
			...
			Compare = Compare_DefaultValue = PlotOptionsOhlcCompare.Percent;
			...
			DataLabels = DataLabels_DefaultValue = new PlotOptionsOhlcDataLabels();
			DataSorting = DataSorting_DefaultValue = new PlotOptionsOhlcDataSorting();
			Depth = Depth_DefaultValue = 25;
			Description = Description_DefaultValue = "";
			DragDrop = DragDrop_DefaultValue = new PlotOptionsOhlcDragDrop();
			EdgeColor = EdgeColor_DefaultValue = "";
			EdgeWidth = EdgeWidth_DefaultValue = 1;
			EnableMouseTracking = EnableMouseTracking_DefaultValue = true;
			Events = Events_DefaultValue = new PlotOptionsOhlcEvents();
			FindNearestPointBy = FindNearestPointBy_DefaultValue = PlotOptionsOhlcFindNearestPointBy.X;
			...
			LegendSymbol = LegendSymbol_DefaultValue = PlotOptionsOhlcLegendSymbol.Rectangle;
			LineWidth = LineWidth_DefaultValue = 1;
			LinkedTo = LinkedTo_DefaultValue = "";
			MaxPointWidth = MaxPointWidth_DefaultValue = null;
			MinPointLength = MinPointLength_DefaultValue = 0;
			NegativeColor = NegativeColor_DefaultValue = "";
			OnPoint = OnPoint_DefaultValue = new PlotOptionsOhlcOnPoint();
			Opacity = Opacity_DefaultValue = 1;
			Point = Point_DefaultValue = new PlotOptionsOhlcPoint();
			PointDescriptionFormat = PointDescriptionFormat_DefaultValue = "";
			PointDescriptionFormatter = PointDescriptionFormatter_DefaultValue = "";
			PointInterval = PointInterval_DefaultValue = 1;
			PointIntervalUnit = PointIntervalUnit_DefaultValue = PlotOptionsOhlcPointIntervalUnit.Null;
			PointPadding = PointPadding_DefaultValue = null;
			PointPlacement = PointPlacement_DefaultValue = new PointPlacement();
			PointRange = PointRange_DefaultValue = 0;
			PointStart = PointStart_DefaultValue = 0;
			PointValKey = PointValKey_DefaultValue = PlotOptionsOhlcPointValKey.Close;
			...
			Sonification = Sonification_DefaultValue = new PlotOptionsOhlcSonification();
			...
			Zones = Zones_DefaultValue = new List<PlotOptionsOhlcZones>();
		...
		/// </summary>
		public PlotOptionsOhlcAccessibility Accessibility { get; set; }
		private PlotOptionsOhlcAccessibility Accessibility_DefaultValue { get; set; }
		...
		/// </summary>
		public PlotOptionsOhlcBoostBlending BoostBlending { get; set; }
		private PlotOptionsOhlcBoostBlending BoostBlending_DefaultValue { get; set; }
		...
		/// </summary>
		public PlotOptionsOhlcCompare Compare { get; set; }
		private PlotOptionsOhlcCompare Compare_DefaultValue { get; set; }
		...
		/// </summary>
		public PlotOptionsOhlcDashStyle DashStyle { get; set; }
		private PlotOptionsOhlcDashStyle DashStyle_DefaultValue { get; set; }
		...
		/// </summary>
		public PlotOptionsOhlcDataSorting DataSorting { get; set; }
		private PlotOptionsOhlcDataSorting DataSorting_DefaultValue { get; set; }
		...
		/// 
		/// </summary>
		public PlotOptionsOhlcDragDrop DragDrop { get; set; }
		private PlotOptionsOhlcDragDrop DragDrop_DefaultValue { get; set; }
		...
		/// </summary>
		public PlotOptionsOhlcFindNearestPointBy FindNearestPointBy { get; set; }
		private PlotOptionsOhlcFindNearestPointBy FindNearestPointBy_DefaultValue { get; set; }
		...
		/// </summary>
		public PlotOptionsOhlcLegendSymbol LegendSymbol { get; set; }
		private PlotOptionsOhlcLegendSymbol LegendSymbol_DefaultValue { get; set; }
		...
		/// </summary>
		public PlotOptionsOhlcOnPoint OnPoint { get; set; }
		private PlotOptionsOhlcOnPoint OnPoint_DefaultValue { get; set; }
		...
		/// </summary>
		public PlotOptionsOhlcSonification Sonification { get; set; }
		private PlotOptionsOhlcSonification Sonification_DefaultValue { get; set; }
		...
		/// </summary>
		public List<PlotOptionsOhlcZones> Zones { get; set; }
		private List<PlotOptionsOhlcZones> Zones_DefaultValue { get; set; }
