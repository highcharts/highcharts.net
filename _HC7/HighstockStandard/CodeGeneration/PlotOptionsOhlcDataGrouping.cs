...
namespace Highsoft.Web.Mvc.Stocks
{
	public partial class PlotOptionsOhlcDataGrouping  : BaseObject
	{
		...
		internal override Hashtable ToHashtable()
		{
			...
			if (Approximation != Approximation_DefaultValue) { h.Add("approximation",Approximation); Highstock.AddFunction("PlotOptionsOhlcDataGroupingApproximation.approximation", Approximation); }  
