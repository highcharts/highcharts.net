...
namespace Highsoft.Web.Mvc.Stocks
{
	public partial class PlotOptionsOhlcDragDrop  : BaseObject
	{
		...
		internal override Hashtable ToHashtable(Highstock highstock)
		{
			...
			if (GuideBox != null) h.Add("guideBox",GuideBox.ToHashtable(highstock));
