...
{
	public partial class PlotOptionsOhlcSonificationContextTracks  : BaseObject
	{
		Hashtable h = new Hashtable();

		public PlotOptionsOhlcSonificationContextTracks()
		{
			ActiveWhen = ActiveWhen_DefaultValue = new PlotOptionsOhlcSonificationContextTracksActiveWhen();
			Instrument = Instrument_DefaultValue = null;
			InstrumentString = InstrumentString_DefaultValue = "null";
			Mapping = Mapping_DefaultValue = new PlotOptionsOhlcSonificationContextTracksMapping();
			MidiName = MidiName_DefaultValue = "";
			PointGrouping = PointGrouping_DefaultValue = new PlotOptionsOhlcSonificationContextTracksPointGrouping();
			...
			Type = Type_DefaultValue = PlotOptionsOhlcSonificationContextTracksType.Instrument;
			ValueInterval = ValueInterval_DefaultValue = null;
			ValueMapFunction = ValueMapFunction_DefaultValue = PlotOptionsOhlcSonificationContextTracksValueMapFunction.Linear;
		...
		/// </summary>
		public PlotOptionsOhlcSonificationContextTracksActiveWhen ActiveWhen { get; set; }
		private PlotOptionsOhlcSonificationContextTracksActiveWhen ActiveWhen_DefaultValue { get; set; }
		...
		/// </summary>
		public PlotOptionsOhlcSonificationContextTracksMapping Mapping { get; set; }
		private PlotOptionsOhlcSonificationContextTracksMapping Mapping_DefaultValue { get; set; }
		...
		/// </summary>
		public PlotOptionsOhlcSonificationContextTracksPointGrouping PointGrouping { get; set; }
		private PlotOptionsOhlcSonificationContextTracksPointGrouping PointGrouping_DefaultValue { get; set; }
		...
		/// </summary>
		public PlotOptionsOhlcSonificationContextTracksType Type { get; set; }
		private PlotOptionsOhlcSonificationContextTracksType Type_DefaultValue { get; set; }
		...
		/// </summary>
		public PlotOptionsOhlcSonificationContextTracksValueMapFunction ValueMapFunction { get; set; }
		private PlotOptionsOhlcSonificationContextTracksValueMapFunction ValueMapFunction_DefaultValue { get; set; }
