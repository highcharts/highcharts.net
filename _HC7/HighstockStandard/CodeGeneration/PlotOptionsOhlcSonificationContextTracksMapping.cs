...
{
	public partial class PlotOptionsOhlcSonificationContextTracksMapping  : BaseObject
	{
		Hashtable h = new Hashtable();

		public PlotOptionsOhlcSonificationContextTracksMapping()
		{
			Frequency = Frequency_DefaultValue = new PlotOptionsOhlcSonificationContextTracksMappingFrequency();
			GapBetweenNotes = GapBetweenNotes_DefaultValue = new PlotOptionsOhlcSonificationContextTracksMappingGapBetweenNotes();
			Highpass = Highpass_DefaultValue = new PlotOptionsOhlcSonificationContextTracksMappingHighpass();
			Lowpass = Lowpass_DefaultValue = new PlotOptionsOhlcSonificationContextTracksMappingLowpass();
			NoteDuration = NoteDuration_DefaultValue = new PlotOptionsOhlcSonificationContextTracksMappingNoteDuration();
			Pan = Pan_DefaultValue = new PlotOptionsOhlcSonificationContextTracksMappingPan();
			Pitch = Pitch_DefaultValue = new PlotOptionsOhlcSonificationContextTracksMappingPitch();
			PitchString = PitchString_DefaultValue = "null";
			PitchNumber = PitchNumber_DefaultValue = null;
			PlayDelay = PlayDelay_DefaultValue = new PlotOptionsOhlcSonificationContextTracksMappingPlayDelay();
			Time = Time_DefaultValue = new PlotOptionsOhlcSonificationContextTracksMappingTime();
			TimeString = TimeString_DefaultValue = "null";
			TimeNumber = TimeNumber_DefaultValue = null;
			Tremolo = Tremolo_DefaultValue = new PlotOptionsOhlcSonificationContextTracksMappingTremolo();
			Volume = Volume_DefaultValue = new PlotOptionsOhlcSonificationContextTracksMappingVolume();
		...
		/// </summary>
		public PlotOptionsOhlcSonificationContextTracksMappingFrequency Frequency { get; set; }
		private PlotOptionsOhlcSonificationContextTracksMappingFrequency Frequency_DefaultValue { get; set; }
		...
		/// </summary>
		public PlotOptionsOhlcSonificationContextTracksMappingGapBetweenNotes GapBetweenNotes { get; set; }
		private PlotOptionsOhlcSonificationContextTracksMappingGapBetweenNotes GapBetweenNotes_DefaultValue { get; set; }
		...
		/// </summary>
		public PlotOptionsOhlcSonificationContextTracksMappingHighpass Highpass { get; set; }
		private PlotOptionsOhlcSonificationContextTracksMappingHighpass Highpass_DefaultValue { get; set; }
		...
		/// </summary>
		public PlotOptionsOhlcSonificationContextTracksMappingLowpass Lowpass { get; set; }
		private PlotOptionsOhlcSonificationContextTracksMappingLowpass Lowpass_DefaultValue { get; set; }
		...
		/// </summary>
		public PlotOptionsOhlcSonificationContextTracksMappingNoteDuration NoteDuration { get; set; }
		private PlotOptionsOhlcSonificationContextTracksMappingNoteDuration NoteDuration_DefaultValue { get; set; }
		...
		/// </summary>
		public PlotOptionsOhlcSonificationContextTracksMappingPan Pan { get; set; }
		private PlotOptionsOhlcSonificationContextTracksMappingPan Pan_DefaultValue { get; set; }
		...
		/// </summary>
		public PlotOptionsOhlcSonificationContextTracksMappingPitch Pitch { get; set; }
		private PlotOptionsOhlcSonificationContextTracksMappingPitch Pitch_DefaultValue { get; set; }
		...
		/// </summary>
		public PlotOptionsOhlcSonificationContextTracksMappingPlayDelay PlayDelay { get; set; }
		private PlotOptionsOhlcSonificationContextTracksMappingPlayDelay PlayDelay_DefaultValue { get; set; }
		...
		/// </summary>
		public PlotOptionsOhlcSonificationContextTracksMappingTime Time { get; set; }
		private PlotOptionsOhlcSonificationContextTracksMappingTime Time_DefaultValue { get; set; }
		...
		/// </summary>
		public PlotOptionsOhlcSonificationContextTracksMappingTremolo Tremolo { get; set; }
		private PlotOptionsOhlcSonificationContextTracksMappingTremolo Tremolo_DefaultValue { get; set; }
		 

		/// <summary>
		/// The volume of notes, from 0 to 1.
		/// </summary>
		public PlotOptionsOhlcSonificationContextTracksMappingVolume Volume { get; set; }
		private PlotOptionsOhlcSonificationContextTracksMappingVolume Volume_DefaultValue { get; set; }
