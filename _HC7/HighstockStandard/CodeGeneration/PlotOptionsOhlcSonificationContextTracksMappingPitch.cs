...
{
	public partial class PlotOptionsOhlcSonificationContextTracksMappingPitch  : BaseObject
	{
		Hashtable h = new Hashtable();

		public PlotOptionsOhlcSonificationContextTracksMappingPitch()
		{
			MapFunction = MapFunction_DefaultValue = PlotOptionsOhlcSonificationContextTracksMappingPitchMapFunction.Linear;
		...
		/// </summary>
		public PlotOptionsOhlcSonificationContextTracksMappingPitchMapFunction MapFunction { get; set; }
		private PlotOptionsOhlcSonificationContextTracksMappingPitchMapFunction MapFunction_DefaultValue { get; set; }
