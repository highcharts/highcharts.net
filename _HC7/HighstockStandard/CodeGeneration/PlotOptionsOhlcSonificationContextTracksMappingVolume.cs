...
{
	public partial class PlotOptionsOhlcSonificationContextTracksMappingVolume  : BaseObject
	{
		Hashtable h = new Hashtable();

		public PlotOptionsOhlcSonificationContextTracksMappingVolume()
		{
			MapFunction = MapFunction_DefaultValue = PlotOptionsOhlcSonificationContextTracksMappingVolumeMapFunction.Linear;
			MapTo = MapTo_DefaultValue = "";
			Max = Max_DefaultValue = null;
			Min = Min_DefaultValue = null;
			Value = Value_DefaultValue = null;
			Within = Within_DefaultValue = PlotOptionsOhlcSonificationContextTracksMappingVolumeWithin.Chart;
		...
		/// </summary>
		public PlotOptionsOhlcSonificationContextTracksMappingVolumeMapFunction MapFunction { get; set; }
		private PlotOptionsOhlcSonificationContextTracksMappingVolumeMapFunction MapFunction_DefaultValue { get; set; }
		...
		/// </summary>
		public PlotOptionsOhlcSonificationContextTracksMappingVolumeWithin Within { get; set; }
		private PlotOptionsOhlcSonificationContextTracksMappingVolumeWithin Within_DefaultValue { get; set; }
