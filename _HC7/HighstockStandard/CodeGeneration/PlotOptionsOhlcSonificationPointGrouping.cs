...
{
	public partial class PlotOptionsOhlcSonificationPointGrouping  : BaseObject
	{
		Hashtable h = new Hashtable();

		public PlotOptionsOhlcSonificationPointGrouping()
		{
			Algorithm = Algorithm_DefaultValue = PlotOptionsOhlcSonificationPointGroupingAlgorithm.Minimax;
		...
		/// </summary>
		public PlotOptionsOhlcSonificationPointGroupingAlgorithm Algorithm { get; set; }
		private PlotOptionsOhlcSonificationPointGroupingAlgorithm Algorithm_DefaultValue { get; set; }
