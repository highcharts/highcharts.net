...
{
	public partial class PlotOptionsOhlcSonificationTracks  : BaseObject
	{
		Hashtable h = new Hashtable();

		public PlotOptionsOhlcSonificationTracks()
		{
			ActiveWhen = ActiveWhen_DefaultValue = new PlotOptionsOhlcSonificationTracksActiveWhen();
			Instrument = Instrument_DefaultValue = null;
			InstrumentString = InstrumentString_DefaultValue = "null";
			Mapping = Mapping_DefaultValue = new PlotOptionsOhlcSonificationTracksMapping();
			MidiName = MidiName_DefaultValue = "";
			PointGrouping = PointGrouping_DefaultValue = new PlotOptionsOhlcSonificationTracksPointGrouping();
			RoundToMusicalNotes = RoundToMusicalNotes_DefaultValue = true;
			ShowPlayMarker = ShowPlayMarker_DefaultValue = true;
			Type = Type_DefaultValue = PlotOptionsOhlcSonificationTracksType.Instrument;
		...
		/// </summary>
		public PlotOptionsOhlcSonificationTracksActiveWhen ActiveWhen { get; set; }
		private PlotOptionsOhlcSonificationTracksActiveWhen ActiveWhen_DefaultValue { get; set; }
		...
		/// </summary>
		public PlotOptionsOhlcSonificationTracksMapping Mapping { get; set; }
		private PlotOptionsOhlcSonificationTracksMapping Mapping_DefaultValue { get; set; }
		...
		/// </summary>
		public PlotOptionsOhlcSonificationTracksPointGrouping PointGrouping { get; set; }
		private PlotOptionsOhlcSonificationTracksPointGrouping PointGrouping_DefaultValue { get; set; }
		...
		/// </summary>
		public PlotOptionsOhlcSonificationTracksType Type { get; set; }
		private PlotOptionsOhlcSonificationTracksType Type_DefaultValue { get; set; }
