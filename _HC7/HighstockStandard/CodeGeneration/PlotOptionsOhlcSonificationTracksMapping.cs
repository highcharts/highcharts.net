...
{
	public partial class PlotOptionsOhlcSonificationTracksMapping  : BaseObject
	{
		Hashtable h = new Hashtable();

		public PlotOptionsOhlcSonificationTracksMapping()
		{
			Frequency = Frequency_DefaultValue = new PlotOptionsOhlcSonificationTracksMappingFrequency();
			GapBetweenNotes = GapBetweenNotes_DefaultValue = new PlotOptionsOhlcSonificationTracksMappingGapBetweenNotes();
			Highpass = Highpass_DefaultValue = new PlotOptionsOhlcSonificationTracksMappingHighpass();
			Lowpass = Lowpass_DefaultValue = new PlotOptionsOhlcSonificationTracksMappingLowpass();
			NoteDuration = NoteDuration_DefaultValue = new PlotOptionsOhlcSonificationTracksMappingNoteDuration();
			Pan = Pan_DefaultValue = new PlotOptionsOhlcSonificationTracksMappingPan();
			Pitch = Pitch_DefaultValue = new PlotOptionsOhlcSonificationTracksMappingPitch();
			PitchString = PitchString_DefaultValue = "null";
			PitchNumber = PitchNumber_DefaultValue = null;
			PlayDelay = PlayDelay_DefaultValue = new PlotOptionsOhlcSonificationTracksMappingPlayDelay();
			Time = Time_DefaultValue = new PlotOptionsOhlcSonificationTracksMappingTime();
			TimeString = TimeString_DefaultValue = "null";
			TimeNumber = TimeNumber_DefaultValue = null;
			Tremolo = Tremolo_DefaultValue = new PlotOptionsOhlcSonificationTracksMappingTremolo();
			Volume = Volume_DefaultValue = new PlotOptionsOhlcSonificationTracksMappingVolume();
		...
		/// </summary>
		public PlotOptionsOhlcSonificationTracksMappingFrequency Frequency { get; set; }
		private PlotOptionsOhlcSonificationTracksMappingFrequency Frequency_DefaultValue { get; set; }
		...
		/// </summary>
		public PlotOptionsOhlcSonificationTracksMappingGapBetweenNotes GapBetweenNotes { get; set; }
		private PlotOptionsOhlcSonificationTracksMappingGapBetweenNotes GapBetweenNotes_DefaultValue { get; set; }
		...
		/// </summary>
		public PlotOptionsOhlcSonificationTracksMappingHighpass Highpass { get; set; }
		private PlotOptionsOhlcSonificationTracksMappingHighpass Highpass_DefaultValue { get; set; }
		...
		/// </summary>
		public PlotOptionsOhlcSonificationTracksMappingLowpass Lowpass { get; set; }
		private PlotOptionsOhlcSonificationTracksMappingLowpass Lowpass_DefaultValue { get; set; }
		...
		/// </summary>
		public PlotOptionsOhlcSonificationTracksMappingNoteDuration NoteDuration { get; set; }
		private PlotOptionsOhlcSonificationTracksMappingNoteDuration NoteDuration_DefaultValue { get; set; }
		...
		/// </summary>
		public PlotOptionsOhlcSonificationTracksMappingPan Pan { get; set; }
		private PlotOptionsOhlcSonificationTracksMappingPan Pan_DefaultValue { get; set; }
		...
		/// </summary>
		public PlotOptionsOhlcSonificationTracksMappingPitch Pitch { get; set; }
		private PlotOptionsOhlcSonificationTracksMappingPitch Pitch_DefaultValue { get; set; }
		...
		/// </summary>
		public PlotOptionsOhlcSonificationTracksMappingPlayDelay PlayDelay { get; set; }
		private PlotOptionsOhlcSonificationTracksMappingPlayDelay PlayDelay_DefaultValue { get; set; }
		...
		/// </summary>
		public PlotOptionsOhlcSonificationTracksMappingTime Time { get; set; }
		private PlotOptionsOhlcSonificationTracksMappingTime Time_DefaultValue { get; set; }
		...
		/// </summary>
		public PlotOptionsOhlcSonificationTracksMappingTremolo Tremolo { get; set; }
		private PlotOptionsOhlcSonificationTracksMappingTremolo Tremolo_DefaultValue { get; set; }
		 

		/// <summary>
		/// The volume of notes, from 0 to 1.
		/// </summary>
		public PlotOptionsOhlcSonificationTracksMappingVolume Volume { get; set; }
		private PlotOptionsOhlcSonificationTracksMappingVolume Volume_DefaultValue { get; set; }
