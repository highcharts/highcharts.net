...
{
	public partial class PlotOptionsOhlcSonificationTracksMappingFrequency  : BaseObject
	{
		Hashtable h = new Hashtable();

		public PlotOptionsOhlcSonificationTracksMappingFrequency()
		{
			MapFunction = MapFunction_DefaultValue = PlotOptionsOhlcSonificationTracksMappingFrequencyMapFunction.Linear;
			MapTo = MapTo_DefaultValue = "";
			Max = Max_DefaultValue = null;
			Min = Min_DefaultValue = null;
			Value = Value_DefaultValue = null;
			Within = Within_DefaultValue = PlotOptionsOhlcSonificationTracksMappingFrequencyWithin.Chart;
		...
		/// </summary>
		public PlotOptionsOhlcSonificationTracksMappingFrequencyMapFunction MapFunction { get; set; }
		private PlotOptionsOhlcSonificationTracksMappingFrequencyMapFunction MapFunction_DefaultValue { get; set; }
		...
		/// </summary>
		public PlotOptionsOhlcSonificationTracksMappingFrequencyWithin Within { get; set; }
		private PlotOptionsOhlcSonificationTracksMappingFrequencyWithin Within_DefaultValue { get; set; }
