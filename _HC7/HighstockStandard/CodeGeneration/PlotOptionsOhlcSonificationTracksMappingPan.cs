...
{
	public partial class PlotOptionsOhlcSonificationTracksMappingPan  : BaseObject
	{
		Hashtable h = new Hashtable();

		public PlotOptionsOhlcSonificationTracksMappingPan()
		{
			MapFunction = MapFunction_DefaultValue = PlotOptionsOhlcSonificationTracksMappingPanMapFunction.Linear;
			MapTo = MapTo_DefaultValue = "";
			Max = Max_DefaultValue = null;
			Min = Min_DefaultValue = null;
			Value = Value_DefaultValue = null;
			Within = Within_DefaultValue = PlotOptionsOhlcSonificationTracksMappingPanWithin.Chart;
		...
		/// </summary>
		public PlotOptionsOhlcSonificationTracksMappingPanMapFunction MapFunction { get; set; }
		private PlotOptionsOhlcSonificationTracksMappingPanMapFunction MapFunction_DefaultValue { get; set; }
		...
		/// </summary>
		public PlotOptionsOhlcSonificationTracksMappingPanWithin Within { get; set; }
		private PlotOptionsOhlcSonificationTracksMappingPanWithin Within_DefaultValue { get; set; }
