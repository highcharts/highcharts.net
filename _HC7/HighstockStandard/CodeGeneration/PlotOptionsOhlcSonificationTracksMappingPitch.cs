...
{
	public partial class PlotOptionsOhlcSonificationTracksMappingPitch  : BaseObject
	{
		Hashtable h = new Hashtable();

		public PlotOptionsOhlcSonificationTracksMappingPitch()
		{
			MapFunction = MapFunction_DefaultValue = PlotOptionsOhlcSonificationTracksMappingPitchMapFunction.Linear;
		...
		/// </summary>
		public PlotOptionsOhlcSonificationTracksMappingPitchMapFunction MapFunction { get; set; }
		private PlotOptionsOhlcSonificationTracksMappingPitchMapFunction MapFunction_DefaultValue { get; set; }
