...
{
	public partial class PlotOptionsOhlcSonificationTracksMappingTime  : BaseObject
	{
		Hashtable h = new Hashtable();

		public PlotOptionsOhlcSonificationTracksMappingTime()
		{
			MapFunction = MapFunction_DefaultValue = PlotOptionsOhlcSonificationTracksMappingTimeMapFunction.Linear;
			MapTo = MapTo_DefaultValue = "";
			Max = Max_DefaultValue = null;
			Min = Min_DefaultValue = null;
			Value = Value_DefaultValue = null;
			Within = Within_DefaultValue = PlotOptionsOhlcSonificationTracksMappingTimeWithin.Chart;
		...
		/// </summary>
		public PlotOptionsOhlcSonificationTracksMappingTimeMapFunction MapFunction { get; set; }
		private PlotOptionsOhlcSonificationTracksMappingTimeMapFunction MapFunction_DefaultValue { get; set; }
		...
		/// </summary>
		public PlotOptionsOhlcSonificationTracksMappingTimeWithin Within { get; set; }
		private PlotOptionsOhlcSonificationTracksMappingTimeWithin Within_DefaultValue { get; set; }
