...
{
	public partial class PlotOptionsOhlcStatesSelect  : BaseObject
	{
		Hashtable h = new Hashtable();

		public PlotOptionsOhlcStatesSelect()
		{
			Animation = Animation_DefaultValue = new Animation() { Enabled = true };
			AnimationBool = AnimationBool_DefaultValue = null;
			Enabled = Enabled_DefaultValue = true;
			Halo = Halo_DefaultValue = new PlotOptionsOhlcStatesSelectHalo();
			LineWidth = LineWidth_DefaultValue = null;
			LineWidthPlus = LineWidthPlus_DefaultValue = 1;
			Marker = Marker_DefaultValue = new PlotOptionsOhlcStatesSelectMarker();
		...
		/// </summary>
		public PlotOptionsOhlcStatesSelectHalo Halo { get; set; }
		private PlotOptionsOhlcStatesSelectHalo Halo_DefaultValue { get; set; }
		...
		/// </summary>
		public PlotOptionsOhlcStatesSelectMarker Marker { get; set; }
		private PlotOptionsOhlcStatesSelectMarker Marker_DefaultValue { get; set; }
