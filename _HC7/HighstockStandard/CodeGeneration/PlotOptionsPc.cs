...
namespace Highsoft.Web.Mvc.Stocks
{
	public partial class PlotOptionsPc  : BaseObject
	{
		...
		public PlotOptionsPc()
		{
			...
			Zones = Zones_DefaultValue = new List<PlotOptionsPcZone>();
		...
		/// </summary>
		public List<PlotOptionsPcZone> Zones { get; set; }
		private List<PlotOptionsPcZone> Zones_DefaultValue { get; set; }
