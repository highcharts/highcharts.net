...
{
	public partial class PlotOptionsPc  : BaseObject
	{
		Hashtable h = new Hashtable();

		public PlotOptionsPc()
		{
			Accessibility = Accessibility_DefaultValue = new PlotOptionsPcAccessibility();
			AllowPointSelect = AllowPointSelect_DefaultValue = false;
			Animation = Animation_DefaultValue = new Animation() { Enabled = true };
			AnimationBool = AnimationBool_DefaultValue = true;
			AnimationLimit = AnimationLimit_DefaultValue = null;
			BoostBlending = BoostBlending_DefaultValue = PlotOptionsPcBoostBlending.Undefined;
			BoostThreshold = BoostThreshold_DefaultValue = 5000;
			BottomLine = BottomLine_DefaultValue = new PlotOptionsPcBottomLine();
			...
			Cursor = Cursor_DefaultValue = PlotOptionsPcCursor.Null;
			Custom = Custom_DefaultValue = new Hashtable();
			DashStyle = DashStyle_DefaultValue = PlotOptionsPcDashStyle.Null;
			DataGrouping = DataGrouping_DefaultValue = new PlotOptionsPcDataGrouping();
			DataLabels = DataLabels_DefaultValue = new PlotOptionsPcDataLabels();
			DataSorting = DataSorting_DefaultValue = new PlotOptionsPcDataSorting();
			Description = Description_DefaultValue = "";
			EnableMouseTracking = EnableMouseTracking_DefaultValue = true;
			Events = Events_DefaultValue = new PlotOptionsPcEvents();
			FillColor = FillColor_DefaultValue = "";
			FindNearestPointBy = FindNearestPointBy_DefaultValue = PlotOptionsPcFindNearestPointBy.X;
			GapSize = GapSize_DefaultValue = 0;
			GapUnit = GapUnit_DefaultValue = PlotOptionsPcGapUnit.Relative;
			GetExtremesFromAll = GetExtremesFromAll_DefaultValue = false;
			IncludeInDataExport = IncludeInDataExport_DefaultValue = null;
			Label = Label_DefaultValue = new PlotOptionsPcLabel();
			LastPrice = LastPrice_DefaultValue = new PlotOptionsPcLastPrice();
			LastVisiblePrice = LastVisiblePrice_DefaultValue = new PlotOptionsPcLastVisiblePrice();
			LegendSymbol = LegendSymbol_DefaultValue = PlotOptionsPcLegendSymbol.Rectangle;
			Linecap = Linecap_DefaultValue = PlotOptionsPcLinecap.Round;
			LineWidth = LineWidth_DefaultValue = 1;
			LinkedTo = LinkedTo_DefaultValue = "";
			Marker = Marker_DefaultValue = new PlotOptionsPcMarker();
			NegativeColor = NegativeColor_DefaultValue = "";
			OnPoint = OnPoint_DefaultValue = new PlotOptionsPcOnPoint();
			Opacity = Opacity_DefaultValue = 1;
			Params = Params_DefaultValue = new PlotOptionsPcParams();
			Point = Point_DefaultValue = new PlotOptionsPcPoint();
			...
			Sonification = Sonification_DefaultValue = new PlotOptionsPcSonification();
			States = States_DefaultValue = new PlotOptionsPcStates();
			Step = Step_DefaultValue = PlotOptionsPcStep.Null;
			StickyTracking = StickyTracking_DefaultValue = true;
			Threshold = Threshold_DefaultValue = 0;
			Tooltip = Tooltip_DefaultValue = new PlotOptionsPcTooltip();
			TopLine = TopLine_DefaultValue = new PlotOptionsPcTopLine();
			TurboThreshold = TurboThreshold_DefaultValue = 1000;
			Visible = Visible_DefaultValue = true;
			ZoneAxis = ZoneAxis_DefaultValue = "y";
			Zones = Zones_DefaultValue = new List<PlotOptionsPcZones>();
		...
		/// </summary>
		public PlotOptionsPcAccessibility Accessibility { get; set; }
		private PlotOptionsPcAccessibility Accessibility_DefaultValue { get; set; }
		...
		/// </summary>
		public PlotOptionsPcBoostBlending BoostBlending { get; set; }
		private PlotOptionsPcBoostBlending BoostBlending_DefaultValue { get; set; }
		...
		/// 
		/// </summary>
		public PlotOptionsPcBottomLine BottomLine { get; set; }
		private PlotOptionsPcBottomLine BottomLine_DefaultValue { get; set; }
		...
		/// </summary>
		public PlotOptionsPcCursor Cursor { get; set; }
		private PlotOptionsPcCursor Cursor_DefaultValue { get; set; }
		...
		/// </summary>
		public PlotOptionsPcDashStyle DashStyle { get; set; }
		private PlotOptionsPcDashStyle DashStyle_DefaultValue { get; set; }
		 

		/// <summary>
		/// 
		/// </summary>
		public PlotOptionsPcDataGrouping DataGrouping { get; set; }
		private PlotOptionsPcDataGrouping DataGrouping_DefaultValue { get; set; }
		...
		/// </summary>
		public PlotOptionsPcDataLabels DataLabels { get; set; }
		private PlotOptionsPcDataLabels DataLabels_DefaultValue { get; set; }
		 

		/// <summary>
		/// Options for the series data sorting.
		/// </summary>
		public PlotOptionsPcDataSorting DataSorting { get; set; }
		private PlotOptionsPcDataSorting DataSorting_DefaultValue { get; set; }
		...
		/// </summary>
		public PlotOptionsPcEvents Events { get; set; }
		private PlotOptionsPcEvents Events_DefaultValue { get; set; }
		...
		/// </summary>
		public PlotOptionsPcFindNearestPointBy FindNearestPointBy { get; set; }
		private PlotOptionsPcFindNearestPointBy FindNearestPointBy_DefaultValue { get; set; }
		...
		/// </summary>
		public PlotOptionsPcGapUnit GapUnit { get; set; }
		private PlotOptionsPcGapUnit GapUnit_DefaultValue { get; set; }
		...
		/// </summary>
		public PlotOptionsPcLabel Label { get; set; }
		private PlotOptionsPcLabel Label_DefaultValue { get; set; }
		 

		/// <summary>
		/// The line marks the last price from all points.
		/// </summary>
		public PlotOptionsPcLastPrice LastPrice { get; set; }
		private PlotOptionsPcLastPrice LastPrice_DefaultValue { get; set; }
		 

		/// <summary>
		/// The line marks the last price from visible range of points.
		/// </summary>
		public PlotOptionsPcLastVisiblePrice LastVisiblePrice { get; set; }
		private PlotOptionsPcLastVisiblePrice LastVisiblePrice_DefaultValue { get; set; }
		 

		/// <summary>
		/// What type of legend symbol to render for this series. Can be one of`lineMarker` or `rectangle`.
		/// </summary>
		public PlotOptionsPcLegendSymbol LegendSymbol { get; set; }
		private PlotOptionsPcLegendSymbol LegendSymbol_DefaultValue { get; set; }
		 

		/// <summary>
		/// The line cap used for line ends and line joins on the graph.
		/// </summary>
		public PlotOptionsPcLinecap Linecap { get; set; }
		private PlotOptionsPcLinecap Linecap_DefaultValue { get; set; }
		...
		/// </summary>
		public PlotOptionsPcMarker Marker { get; set; }
		private PlotOptionsPcMarker Marker_DefaultValue { get; set; }
		...
		/// </summary>
		public PlotOptionsPcOnPoint OnPoint { get; set; }
		private PlotOptionsPcOnPoint OnPoint_DefaultValue { get; set; }
		...
		/// 
		/// </summary>
		public PlotOptionsPcParams Params { get; set; }
		private PlotOptionsPcParams Params_DefaultValue { get; set; }
		 

		/// <summary>
		/// Properties for each single point.
		/// </summary>
		public PlotOptionsPcPoint Point { get; set; }
		private PlotOptionsPcPoint Point_DefaultValue { get; set; }
		...
		/// </summary>
		public PlotOptionsPcSonification Sonification { get; set; }
		private PlotOptionsPcSonification Sonification_DefaultValue { get; set; }
		 

		/// <summary>
		/// 
		/// </summary>
		public PlotOptionsPcStates States { get; set; }
		private PlotOptionsPcStates States_DefaultValue { get; set; }
		 

		/// <summary>
		/// Whether to apply steps to the line. Possible values are `left`,`center` and `right`.
		/// </summary>
		public PlotOptionsPcStep Step { get; set; }
		private PlotOptionsPcStep Step_DefaultValue { get; set; }
		...
		/// </summary>
		public PlotOptionsPcTooltip Tooltip { get; set; }
		private PlotOptionsPcTooltip Tooltip_DefaultValue { get; set; }
		 

		/// <summary>
		/// 
		/// </summary>
		public PlotOptionsPcTopLine TopLine { get; set; }
		private PlotOptionsPcTopLine TopLine_DefaultValue { get; set; }
		...
		/// </summary>
		public List<PlotOptionsPcZones> Zones { get; set; }
		private List<PlotOptionsPcZones> Zones_DefaultValue { get; set; }
