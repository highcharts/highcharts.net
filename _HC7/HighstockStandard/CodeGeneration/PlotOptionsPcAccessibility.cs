...
namespace Highsoft.Web.Mvc.Stocks
{
	public partial class PlotOptionsPcAccessibility  : BaseObject
	{
		...
		public PlotOptionsPcAccessibility()
		{
			...
			Point = Point_DefaultValue = new PlotOptionsPcAccessibilityPoint();
		...
		/// </summary>
		public PlotOptionsPcAccessibilityPoint Point { get; set; }
		private PlotOptionsPcAccessibilityPoint Point_DefaultValue { get; set; }
