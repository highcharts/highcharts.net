...
{
	public partial class PlotOptionsPcSonificationContextTracksMapping  : BaseObject
	{
		Hashtable h = new Hashtable();

		public PlotOptionsPcSonificationContextTracksMapping()
		{
			Frequency = Frequency_DefaultValue = new PlotOptionsPcSonificationContextTracksMappingFrequency();
			GapBetweenNotes = GapBetweenNotes_DefaultValue = new PlotOptionsPcSonificationContextTracksMappingGapBetweenNotes();
			Highpass = Highpass_DefaultValue = new PlotOptionsPcSonificationContextTracksMappingHighpass();
			Lowpass = Lowpass_DefaultValue = new PlotOptionsPcSonificationContextTracksMappingLowpass();
			NoteDuration = NoteDuration_DefaultValue = new PlotOptionsPcSonificationContextTracksMappingNoteDuration();
			Pan = Pan_DefaultValue = new PlotOptionsPcSonificationContextTracksMappingPan();
			Pitch = Pitch_DefaultValue = new PlotOptionsPcSonificationContextTracksMappingPitch();
			PitchString = PitchString_DefaultValue = "null";
			PitchNumber = PitchNumber_DefaultValue = null;
			PlayDelay = PlayDelay_DefaultValue = new PlotOptionsPcSonificationContextTracksMappingPlayDelay();
			Time = Time_DefaultValue = new PlotOptionsPcSonificationContextTracksMappingTime();
			TimeString = TimeString_DefaultValue = "null";
			TimeNumber = TimeNumber_DefaultValue = null;
			Tremolo = Tremolo_DefaultValue = new PlotOptionsPcSonificationContextTracksMappingTremolo();
			Volume = Volume_DefaultValue = new PlotOptionsPcSonificationContextTracksMappingVolume();
		...
		/// </summary>
		public PlotOptionsPcSonificationContextTracksMappingFrequency Frequency { get; set; }
		private PlotOptionsPcSonificationContextTracksMappingFrequency Frequency_DefaultValue { get; set; }
		...
		/// </summary>
		public PlotOptionsPcSonificationContextTracksMappingGapBetweenNotes GapBetweenNotes { get; set; }
		private PlotOptionsPcSonificationContextTracksMappingGapBetweenNotes GapBetweenNotes_DefaultValue { get; set; }
		...
		/// </summary>
		public PlotOptionsPcSonificationContextTracksMappingHighpass Highpass { get; set; }
		private PlotOptionsPcSonificationContextTracksMappingHighpass Highpass_DefaultValue { get; set; }
		...
		/// </summary>
		public PlotOptionsPcSonificationContextTracksMappingLowpass Lowpass { get; set; }
		private PlotOptionsPcSonificationContextTracksMappingLowpass Lowpass_DefaultValue { get; set; }
		...
		/// </summary>
		public PlotOptionsPcSonificationContextTracksMappingNoteDuration NoteDuration { get; set; }
		private PlotOptionsPcSonificationContextTracksMappingNoteDuration NoteDuration_DefaultValue { get; set; }
		...
		/// </summary>
		public PlotOptionsPcSonificationContextTracksMappingPan Pan { get; set; }
		private PlotOptionsPcSonificationContextTracksMappingPan Pan_DefaultValue { get; set; }
		...
		/// </summary>
		public PlotOptionsPcSonificationContextTracksMappingPitch Pitch { get; set; }
		private PlotOptionsPcSonificationContextTracksMappingPitch Pitch_DefaultValue { get; set; }
		...
		/// </summary>
		public PlotOptionsPcSonificationContextTracksMappingPlayDelay PlayDelay { get; set; }
		private PlotOptionsPcSonificationContextTracksMappingPlayDelay PlayDelay_DefaultValue { get; set; }
		...
		/// </summary>
		public PlotOptionsPcSonificationContextTracksMappingTime Time { get; set; }
		private PlotOptionsPcSonificationContextTracksMappingTime Time_DefaultValue { get; set; }
		...
		/// </summary>
		public PlotOptionsPcSonificationContextTracksMappingTremolo Tremolo { get; set; }
		private PlotOptionsPcSonificationContextTracksMappingTremolo Tremolo_DefaultValue { get; set; }
		 

		/// <summary>
		/// The volume of notes, from 0 to 1.
		/// </summary>
		public PlotOptionsPcSonificationContextTracksMappingVolume Volume { get; set; }
		private PlotOptionsPcSonificationContextTracksMappingVolume Volume_DefaultValue { get; set; }
