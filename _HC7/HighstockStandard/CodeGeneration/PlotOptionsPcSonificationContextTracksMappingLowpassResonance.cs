...
{
	public partial class PlotOptionsPcSonificationContextTracksMappingLowpassResonance  : BaseObject
	{
		Hashtable h = new Hashtable();

		public PlotOptionsPcSonificationContextTracksMappingLowpassResonance()
		{
			MapFunction = MapFunction_DefaultValue = PlotOptionsPcSonificationContextTracksMappingLowpassResonanceMapFunction.Linear;
			MapTo = MapTo_DefaultValue = "";
			Max = Max_DefaultValue = null;
			Min = Min_DefaultValue = null;
			Value = Value_DefaultValue = null;
			Within = Within_DefaultValue = PlotOptionsPcSonificationContextTracksMappingLowpassResonanceWithin.Chart;
		...
		/// </summary>
		public PlotOptionsPcSonificationContextTracksMappingLowpassResonanceMapFunction MapFunction { get; set; }
		private PlotOptionsPcSonificationContextTracksMappingLowpassResonanceMapFunction MapFunction_DefaultValue { get; set; }
		...
		/// </summary>
		public PlotOptionsPcSonificationContextTracksMappingLowpassResonanceWithin Within { get; set; }
		private PlotOptionsPcSonificationContextTracksMappingLowpassResonanceWithin Within_DefaultValue { get; set; }
