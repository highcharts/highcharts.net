...
{
	public partial class PlotOptionsPcSonificationContextTracksMappingPitch  : BaseObject
	{
		Hashtable h = new Hashtable();

		public PlotOptionsPcSonificationContextTracksMappingPitch()
		{
			MapFunction = MapFunction_DefaultValue = PlotOptionsPcSonificationContextTracksMappingPitchMapFunction.Linear;
		...
		/// </summary>
		public PlotOptionsPcSonificationContextTracksMappingPitchMapFunction MapFunction { get; set; }
		private PlotOptionsPcSonificationContextTracksMappingPitchMapFunction MapFunction_DefaultValue { get; set; }
