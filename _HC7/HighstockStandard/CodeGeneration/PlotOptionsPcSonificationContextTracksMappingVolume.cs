...
{
	public partial class PlotOptionsPcSonificationContextTracksMappingVolume  : BaseObject
	{
		Hashtable h = new Hashtable();

		public PlotOptionsPcSonificationContextTracksMappingVolume()
		{
			MapFunction = MapFunction_DefaultValue = PlotOptionsPcSonificationContextTracksMappingVolumeMapFunction.Linear;
			MapTo = MapTo_DefaultValue = "";
			Max = Max_DefaultValue = null;
			Min = Min_DefaultValue = null;
			Value = Value_DefaultValue = null;
			Within = Within_DefaultValue = PlotOptionsPcSonificationContextTracksMappingVolumeWithin.Chart;
		...
		/// </summary>
		public PlotOptionsPcSonificationContextTracksMappingVolumeMapFunction MapFunction { get; set; }
		private PlotOptionsPcSonificationContextTracksMappingVolumeMapFunction MapFunction_DefaultValue { get; set; }
		...
		/// </summary>
		public PlotOptionsPcSonificationContextTracksMappingVolumeWithin Within { get; set; }
		private PlotOptionsPcSonificationContextTracksMappingVolumeWithin Within_DefaultValue { get; set; }
