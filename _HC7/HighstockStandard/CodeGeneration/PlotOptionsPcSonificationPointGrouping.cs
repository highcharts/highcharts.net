...
{
	public partial class PlotOptionsPcSonificationPointGrouping  : BaseObject
	{
		Hashtable h = new Hashtable();

		public PlotOptionsPcSonificationPointGrouping()
		{
			Algorithm = Algorithm_DefaultValue = PlotOptionsPcSonificationPointGroupingAlgorithm.Minimax;
		...
		/// </summary>
		public PlotOptionsPcSonificationPointGroupingAlgorithm Algorithm { get; set; }
		private PlotOptionsPcSonificationPointGroupingAlgorithm Algorithm_DefaultValue { get; set; }
