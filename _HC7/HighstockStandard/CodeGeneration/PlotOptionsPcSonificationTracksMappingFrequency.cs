...
{
	public partial class PlotOptionsPcSonificationTracksMappingFrequency  : BaseObject
	{
		Hashtable h = new Hashtable();

		public PlotOptionsPcSonificationTracksMappingFrequency()
		{
			MapFunction = MapFunction_DefaultValue = PlotOptionsPcSonificationTracksMappingFrequencyMapFunction.Linear;
			MapTo = MapTo_DefaultValue = "";
			Max = Max_DefaultValue = null;
			Min = Min_DefaultValue = null;
			Value = Value_DefaultValue = null;
			Within = Within_DefaultValue = PlotOptionsPcSonificationTracksMappingFrequencyWithin.Chart;
		...
		/// </summary>
		public PlotOptionsPcSonificationTracksMappingFrequencyMapFunction MapFunction { get; set; }
		private PlotOptionsPcSonificationTracksMappingFrequencyMapFunction MapFunction_DefaultValue { get; set; }
		...
		/// </summary>
		public PlotOptionsPcSonificationTracksMappingFrequencyWithin Within { get; set; }
		private PlotOptionsPcSonificationTracksMappingFrequencyWithin Within_DefaultValue { get; set; }
