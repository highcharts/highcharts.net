...
{
	public partial class PlotOptionsPcSonificationTracksMappingNoteDuration  : BaseObject
	{
		Hashtable h = new Hashtable();

		public PlotOptionsPcSonificationTracksMappingNoteDuration()
		{
			MapFunction = MapFunction_DefaultValue = PlotOptionsPcSonificationTracksMappingNoteDurationMapFunction.Linear;
			MapTo = MapTo_DefaultValue = "";
			Max = Max_DefaultValue = null;
			Min = Min_DefaultValue = null;
			Value = Value_DefaultValue = null;
			Within = Within_DefaultValue = PlotOptionsPcSonificationTracksMappingNoteDurationWithin.Chart;
		...
		/// </summary>
		public PlotOptionsPcSonificationTracksMappingNoteDurationMapFunction MapFunction { get; set; }
		private PlotOptionsPcSonificationTracksMappingNoteDurationMapFunction MapFunction_DefaultValue { get; set; }
		...
		/// </summary>
		public PlotOptionsPcSonificationTracksMappingNoteDurationWithin Within { get; set; }
		private PlotOptionsPcSonificationTracksMappingNoteDurationWithin Within_DefaultValue { get; set; }
