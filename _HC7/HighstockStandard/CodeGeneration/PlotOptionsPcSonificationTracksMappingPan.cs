...
{
	public partial class PlotOptionsPcSonificationTracksMappingPan  : BaseObject
	{
		Hashtable h = new Hashtable();

		public PlotOptionsPcSonificationTracksMappingPan()
		{
			MapFunction = MapFunction_DefaultValue = PlotOptionsPcSonificationTracksMappingPanMapFunction.Linear;
			MapTo = MapTo_DefaultValue = "";
			Max = Max_DefaultValue = null;
			Min = Min_DefaultValue = null;
			Value = Value_DefaultValue = null;
			Within = Within_DefaultValue = PlotOptionsPcSonificationTracksMappingPanWithin.Chart;
		...
		/// </summary>
		public PlotOptionsPcSonificationTracksMappingPanMapFunction MapFunction { get; set; }
		private PlotOptionsPcSonificationTracksMappingPanMapFunction MapFunction_DefaultValue { get; set; }
		...
		/// </summary>
		public PlotOptionsPcSonificationTracksMappingPanWithin Within { get; set; }
		private PlotOptionsPcSonificationTracksMappingPanWithin Within_DefaultValue { get; set; }
