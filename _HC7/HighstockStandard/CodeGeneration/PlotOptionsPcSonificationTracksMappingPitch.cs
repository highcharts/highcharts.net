...
{
	public partial class PlotOptionsPcSonificationTracksMappingPitch  : BaseObject
	{
		Hashtable h = new Hashtable();

		public PlotOptionsPcSonificationTracksMappingPitch()
		{
			MapFunction = MapFunction_DefaultValue = PlotOptionsPcSonificationTracksMappingPitchMapFunction.Linear;
		...
		/// </summary>
		public PlotOptionsPcSonificationTracksMappingPitchMapFunction MapFunction { get; set; }
		private PlotOptionsPcSonificationTracksMappingPitchMapFunction MapFunction_DefaultValue { get; set; }
