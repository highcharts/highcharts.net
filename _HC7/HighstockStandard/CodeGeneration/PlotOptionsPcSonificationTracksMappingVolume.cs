...
{
	public partial class PlotOptionsPcSonificationTracksMappingVolume  : BaseObject
	{
		Hashtable h = new Hashtable();

		public PlotOptionsPcSonificationTracksMappingVolume()
		{
			MapFunction = MapFunction_DefaultValue = PlotOptionsPcSonificationTracksMappingVolumeMapFunction.Linear;
			MapTo = MapTo_DefaultValue = "";
			Max = Max_DefaultValue = null;
			Min = Min_DefaultValue = null;
			Value = Value_DefaultValue = null;
			Within = Within_DefaultValue = PlotOptionsPcSonificationTracksMappingVolumeWithin.Chart;
		...
		/// </summary>
		public PlotOptionsPcSonificationTracksMappingVolumeMapFunction MapFunction { get; set; }
		private PlotOptionsPcSonificationTracksMappingVolumeMapFunction MapFunction_DefaultValue { get; set; }
		...
		/// </summary>
		public PlotOptionsPcSonificationTracksMappingVolumeWithin Within { get; set; }
		private PlotOptionsPcSonificationTracksMappingVolumeWithin Within_DefaultValue { get; set; }
