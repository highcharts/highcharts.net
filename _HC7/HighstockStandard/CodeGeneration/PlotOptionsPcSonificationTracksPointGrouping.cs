...
{
	public partial class PlotOptionsPcSonificationTracksPointGrouping  : BaseObject
	{
		Hashtable h = new Hashtable();

		public PlotOptionsPcSonificationTracksPointGrouping()
		{
			Algorithm = Algorithm_DefaultValue = PlotOptionsPcSonificationTracksPointGroupingAlgorithm.Minimax;
		...
		/// </summary>
		public PlotOptionsPcSonificationTracksPointGroupingAlgorithm Algorithm { get; set; }
		private PlotOptionsPcSonificationTracksPointGroupingAlgorithm Algorithm_DefaultValue { get; set; }
