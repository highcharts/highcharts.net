...
{
	public partial class PlotOptionsPcStatesSelect  : BaseObject
	{
		Hashtable h = new Hashtable();

		public PlotOptionsPcStatesSelect()
		{
			Animation = Animation_DefaultValue = new Animation() { Enabled = true };
			Enabled = Enabled_DefaultValue = null;
			Halo = Halo_DefaultValue = new PlotOptionsPcStatesSelectHalo();
			LineWidth = LineWidth_DefaultValue = null;
			LineWidthPlus = LineWidthPlus_DefaultValue = null;
			Marker = Marker_DefaultValue = new PlotOptionsPcStatesSelectMarker();
		...
		/// </summary>
		public PlotOptionsPcStatesSelectHalo Halo { get; set; }
		private PlotOptionsPcStatesSelectHalo Halo_DefaultValue { get; set; }
		...
		/// </summary>
		public PlotOptionsPcStatesSelectMarker Marker { get; set; }
		private PlotOptionsPcStatesSelectMarker Marker_DefaultValue { get; set; }
