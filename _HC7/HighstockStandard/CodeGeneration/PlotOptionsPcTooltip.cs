...
{
	public partial class PlotOptionsPcTooltip  : BaseObject
	{
		public PlotOptionsPcTooltip()
		{
			...
			HeaderShape = HeaderShape_DefaultValue = PlotOptionsPcTooltipHeaderShape.Callout;
		...
		/// </summary>
		public PlotOptionsPcTooltipHeaderShape HeaderShape { get; set; }
		private PlotOptionsPcTooltipHeaderShape HeaderShape_DefaultValue { get; set; }
		...
		internal override Hashtable ToHashtable()
		{
			...
			if (NullFormatter != NullFormatter_DefaultValue) { h.Add("nullFormatter",NullFormatter); Highstock.AddFunction("PlotOptionsPcTooltipNullFormatter.nullFormatter", NullFormatter); }  
			if (Outside != Outside_DefaultValue) h.Add("outside",Outside);
			if (Padding != Padding_DefaultValue) h.Add("padding",Padding);
			if (PointFormat != PointFormat_DefaultValue) h.Add("pointFormat",PointFormat);
			if (PointFormatter != PointFormatter_DefaultValue) { h.Add("pointFormatter",PointFormatter); Highstock.AddFunction("PlotOptionsPcTooltipPointFormatter.pointFormatter", PointFormatter); }  
