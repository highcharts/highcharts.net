...
{
	public partial class PlotOptionsPivotpoints  : BaseObject
	{
		Hashtable h = new Hashtable();

		public PlotOptionsPivotpoints()
		{
			Accessibility = Accessibility_DefaultValue = new PlotOptionsPivotpointsAccessibility();
			AllowPointSelect = AllowPointSelect_DefaultValue = false;
			Animation = Animation_DefaultValue = new Animation() { Enabled = true };
			AnimationBool = AnimationBool_DefaultValue = true;
			AnimationLimit = AnimationLimit_DefaultValue = null;
			BoostBlending = BoostBlending_DefaultValue = PlotOptionsPivotpointsBoostBlending.Undefined;
			...
			Compare = Compare_DefaultValue = PlotOptionsPivotpointsCompare.Percent;
			CompareBase = CompareBase_DefaultValue = PlotOptionsPivotpointsCompareBase.Min;
			...
			DashStyle = DashStyle_DefaultValue = PlotOptionsPivotpointsDashStyle.Null;
			...
			DataSorting = DataSorting_DefaultValue = new PlotOptionsPivotpointsDataSorting();
			...
			FindNearestPointBy = FindNearestPointBy_DefaultValue = PlotOptionsPivotpointsFindNearestPointBy.X;
			...
			LastPrice = LastPrice_DefaultValue = new PlotOptionsPivotpointsLastPrice();
			LastVisiblePrice = LastVisiblePrice_DefaultValue = new PlotOptionsPivotpointsLastVisiblePrice();
			LegendSymbol = LegendSymbol_DefaultValue = PlotOptionsPivotpointsLegendSymbol.Rectangle;
			...
			OnPoint = OnPoint_DefaultValue = new PlotOptionsPivotpointsOnPoint();
			...
			Sonification = Sonification_DefaultValue = new PlotOptionsPivotpointsSonification();
			States = States_DefaultValue = new PlotOptionsPivotpointsStates();
			Step = Step_DefaultValue = PlotOptionsPivotpointsStep.Null;
			...
			Zones = Zones_DefaultValue = new List<PlotOptionsPivotpointsZones>();
		...
		/// </summary>
		public PlotOptionsPivotpointsAccessibility Accessibility { get; set; }
		private PlotOptionsPivotpointsAccessibility Accessibility_DefaultValue { get; set; }
		...
		/// </summary>
		public PlotOptionsPivotpointsBoostBlending BoostBlending { get; set; }
		private PlotOptionsPivotpointsBoostBlending BoostBlending_DefaultValue { get; set; }
		...
		/// </summary>
		public PlotOptionsPivotpointsCompare Compare { get; set; }
		private PlotOptionsPivotpointsCompare Compare_DefaultValue { get; set; }
		 

		/// <summary>
		/// When [compare](#plotOptions.series.compare) is `percent`, this optiondictates whether to use 0 or 100 as the base of comparison.
		/// </summary>
		public PlotOptionsPivotpointsCompareBase CompareBase { get; set; }
		private PlotOptionsPivotpointsCompareBase CompareBase_DefaultValue { get; set; }
		...
		/// </summary>
		public PlotOptionsPivotpointsCursor Cursor { get; set; }
		private PlotOptionsPivotpointsCursor Cursor_DefaultValue { get; set; }
		...
		/// </summary>
		public PlotOptionsPivotpointsDashStyle DashStyle { get; set; }
		private PlotOptionsPivotpointsDashStyle DashStyle_DefaultValue { get; set; }
		...
		/// </summary>
		public PlotOptionsPivotpointsDataSorting DataSorting { get; set; }
		private PlotOptionsPivotpointsDataSorting DataSorting_DefaultValue { get; set; }
		...
		/// </summary>
		public PlotOptionsPivotpointsEvents Events { get; set; }
		private PlotOptionsPivotpointsEvents Events_DefaultValue { get; set; }
		...
		/// </summary>
		public PlotOptionsPivotpointsFindNearestPointBy FindNearestPointBy { get; set; }
		private PlotOptionsPivotpointsFindNearestPointBy FindNearestPointBy_DefaultValue { get; set; }
		...
		/// </summary>
		public PlotOptionsPivotpointsGapUnit GapUnit { get; set; }
		private PlotOptionsPivotpointsGapUnit GapUnit_DefaultValue { get; set; }
		...
		/// </summary>
		public PlotOptionsPivotpointsLastPrice LastPrice { get; set; }
		private PlotOptionsPivotpointsLastPrice LastPrice_DefaultValue { get; set; }
		 

		/// <summary>
		/// The line marks the last price from visible range of points.
		/// </summary>
		public PlotOptionsPivotpointsLastVisiblePrice LastVisiblePrice { get; set; }
		private PlotOptionsPivotpointsLastVisiblePrice LastVisiblePrice_DefaultValue { get; set; }
		 

		/// <summary>
		/// What type of legend symbol to render for this series. Can be one of`lineMarker` or `rectangle`.
		/// </summary>
		public PlotOptionsPivotpointsLegendSymbol LegendSymbol { get; set; }
		private PlotOptionsPivotpointsLegendSymbol LegendSymbol_DefaultValue { get; set; }
		 

		/// <summary>
		/// The line cap used for line ends and line joins on the graph.
		/// </summary>
		public PlotOptionsPivotpointsLinecap Linecap { get; set; }
		private PlotOptionsPivotpointsLinecap Linecap_DefaultValue { get; set; }
		...
		/// </summary>
		public PlotOptionsPivotpointsOnPoint OnPoint { get; set; }
		private PlotOptionsPivotpointsOnPoint OnPoint_DefaultValue { get; set; }
		...
		/// </summary>
		public PlotOptionsPivotpointsSonification Sonification { get; set; }
		private PlotOptionsPivotpointsSonification Sonification_DefaultValue { get; set; }
		 

		/// <summary>
		/// 
		/// </summary>
		public PlotOptionsPivotpointsStates States { get; set; }
		private PlotOptionsPivotpointsStates States_DefaultValue { get; set; }
		 

		/// <summary>
		/// Whether to apply steps to the line. Possible values are `left`,`center` and `right`.
		/// </summary>
		public PlotOptionsPivotpointsStep Step { get; set; }
		private PlotOptionsPivotpointsStep Step_DefaultValue { get; set; }
		...
		/// </summary>
		public PlotOptionsPivotpointsTooltip Tooltip { get; set; }
		private PlotOptionsPivotpointsTooltip Tooltip_DefaultValue { get; set; }
		...
		/// </summary>
		public List<PlotOptionsPivotpointsZones> Zones { get; set; }
		private List<PlotOptionsPivotpointsZones> Zones_DefaultValue { get; set; }
