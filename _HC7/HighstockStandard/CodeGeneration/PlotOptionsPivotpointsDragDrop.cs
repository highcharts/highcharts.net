...
{
	public partial class PlotOptionsPivotpointsDragDrop  : BaseObject
	{
		public PlotOptionsPivotpointsDragDrop()
		{
			DraggableX = DraggableX_DefaultValue = null;
			DraggableY = DraggableY_DefaultValue = null;
			DragHandle = DragHandle_DefaultValue = new PlotOptionsPivotpointsDragDropDragHandle();
			...
			GuideBox = GuideBox_DefaultValue = new PlotOptionsPivotpointsDragDropGuideBox();
		...
		/// </summary>
		public PlotOptionsPivotpointsDragDropDragHandle DragHandle { get; set; }
		private PlotOptionsPivotpointsDragDropDragHandle DragHandle_DefaultValue { get; set; }
		...
		/// </summary>
		public PlotOptionsPivotpointsDragDropGuideBox GuideBox { get; set; }
		private PlotOptionsPivotpointsDragDropGuideBox GuideBox_DefaultValue { get; set; }
