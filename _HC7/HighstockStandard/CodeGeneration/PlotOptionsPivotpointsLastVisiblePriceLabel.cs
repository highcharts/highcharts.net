...
{
	public partial class PlotOptionsPivotpointsLastVisiblePriceLabel  : BaseObject
	{
		Hashtable h = new Hashtable();

		public PlotOptionsPivotpointsLastVisiblePriceLabel()
		{
			Align = Align_DefaultValue = PlotOptionsPivotpointsLastVisiblePriceLabelAlign.Null;
		...
		/// 
		/// </summary>
		public PlotOptionsPivotpointsLastVisiblePriceLabelAlign Align { get; set; }
		private PlotOptionsPivotpointsLastVisiblePriceLabelAlign Align_DefaultValue { get; set; }
