...
{
	public partial class PlotOptionsPivotpointsSonificationContextTracks  : BaseObject
	{
		Hashtable h = new Hashtable();

		public PlotOptionsPivotpointsSonificationContextTracks()
		{
			ActiveWhen = ActiveWhen_DefaultValue = new PlotOptionsPivotpointsSonificationContextTracksActiveWhen();
			Instrument = Instrument_DefaultValue = null;
			InstrumentString = InstrumentString_DefaultValue = "null";
			Mapping = Mapping_DefaultValue = new PlotOptionsPivotpointsSonificationContextTracksMapping();
			MidiName = MidiName_DefaultValue = "";
			PointGrouping = PointGrouping_DefaultValue = new PlotOptionsPivotpointsSonificationContextTracksPointGrouping();
			...
			Type = Type_DefaultValue = PlotOptionsPivotpointsSonificationContextTracksType.Instrument;
			ValueInterval = ValueInterval_DefaultValue = null;
			ValueMapFunction = ValueMapFunction_DefaultValue = PlotOptionsPivotpointsSonificationContextTracksValueMapFunction.Linear;
		...
		/// </summary>
		public PlotOptionsPivotpointsSonificationContextTracksActiveWhen ActiveWhen { get; set; }
		private PlotOptionsPivotpointsSonificationContextTracksActiveWhen ActiveWhen_DefaultValue { get; set; }
		...
		/// </summary>
		public PlotOptionsPivotpointsSonificationContextTracksMapping Mapping { get; set; }
		private PlotOptionsPivotpointsSonificationContextTracksMapping Mapping_DefaultValue { get; set; }
		...
		/// </summary>
		public PlotOptionsPivotpointsSonificationContextTracksPointGrouping PointGrouping { get; set; }
		private PlotOptionsPivotpointsSonificationContextTracksPointGrouping PointGrouping_DefaultValue { get; set; }
		...
		/// </summary>
		public PlotOptionsPivotpointsSonificationContextTracksType Type { get; set; }
		private PlotOptionsPivotpointsSonificationContextTracksType Type_DefaultValue { get; set; }
		...
		/// </summary>
		public PlotOptionsPivotpointsSonificationContextTracksValueMapFunction ValueMapFunction { get; set; }
		private PlotOptionsPivotpointsSonificationContextTracksValueMapFunction ValueMapFunction_DefaultValue { get; set; }
