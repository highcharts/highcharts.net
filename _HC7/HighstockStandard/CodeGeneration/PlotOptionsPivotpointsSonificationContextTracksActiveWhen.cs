...
{
	public partial class PlotOptionsPivotpointsSonificationContextTracksActiveWhen  : BaseObject
	{
		Hashtable h = new Hashtable();

		public PlotOptionsPivotpointsSonificationContextTracksActiveWhen()
		{
