...
{
	public partial class PlotOptionsPivotpointsSonificationContextTracksMappingVolume  : BaseObject
	{
		Hashtable h = new Hashtable();

		public PlotOptionsPivotpointsSonificationContextTracksMappingVolume()
		{
			MapFunction = MapFunction_DefaultValue = PlotOptionsPivotpointsSonificationContextTracksMappingVolumeMapFunction.Linear;
			MapTo = MapTo_DefaultValue = "";
			Max = Max_DefaultValue = null;
			Min = Min_DefaultValue = null;
			Value = Value_DefaultValue = null;
			Within = Within_DefaultValue = PlotOptionsPivotpointsSonificationContextTracksMappingVolumeWithin.Chart;
		...
		/// </summary>
		public PlotOptionsPivotpointsSonificationContextTracksMappingVolumeMapFunction MapFunction { get; set; }
		private PlotOptionsPivotpointsSonificationContextTracksMappingVolumeMapFunction MapFunction_DefaultValue { get; set; }
		...
		/// </summary>
		public PlotOptionsPivotpointsSonificationContextTracksMappingVolumeWithin Within { get; set; }
		private PlotOptionsPivotpointsSonificationContextTracksMappingVolumeWithin Within_DefaultValue { get; set; }
