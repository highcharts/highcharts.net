...
{
	public partial class PlotOptionsPivotpointsSonificationDefaultSpeechOptionsPointGrouping  : BaseObject
	{
		Hashtable h = new Hashtable();

		public PlotOptionsPivotpointsSonificationDefaultSpeechOptionsPointGrouping()
		{
			Algorithm = Algorithm_DefaultValue = PlotOptionsPivotpointsSonificationDefaultSpeechOptionsPointGroupingAlgorithm.Minimax;
		...
		/// </summary>
		public PlotOptionsPivotpointsSonificationDefaultSpeechOptionsPointGroupingAlgorithm Algorithm { get; set; }
		private PlotOptionsPivotpointsSonificationDefaultSpeechOptionsPointGroupingAlgorithm Algorithm_DefaultValue { get; set; }
