...
{
	public partial class PlotOptionsPivotpointsSonificationPointGrouping  : BaseObject
	{
		Hashtable h = new Hashtable();

		public PlotOptionsPivotpointsSonificationPointGrouping()
		{
			Algorithm = Algorithm_DefaultValue = PlotOptionsPivotpointsSonificationPointGroupingAlgorithm.Minimax;
		...
		/// </summary>
		public PlotOptionsPivotpointsSonificationPointGroupingAlgorithm Algorithm { get; set; }
		private PlotOptionsPivotpointsSonificationPointGroupingAlgorithm Algorithm_DefaultValue { get; set; }
