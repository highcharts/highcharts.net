...
{
	public partial class PlotOptionsPivotpointsSonificationTracks  : BaseObject
	{
		Hashtable h = new Hashtable();

		public PlotOptionsPivotpointsSonificationTracks()
		{
			ActiveWhen = ActiveWhen_DefaultValue = new PlotOptionsPivotpointsSonificationTracksActiveWhen();
			Instrument = Instrument_DefaultValue = null;
			InstrumentString = InstrumentString_DefaultValue = "null";
			Mapping = Mapping_DefaultValue = new PlotOptionsPivotpointsSonificationTracksMapping();
			MidiName = MidiName_DefaultValue = "";
			PointGrouping = PointGrouping_DefaultValue = new PlotOptionsPivotpointsSonificationTracksPointGrouping();
			RoundToMusicalNotes = RoundToMusicalNotes_DefaultValue = true;
			ShowPlayMarker = ShowPlayMarker_DefaultValue = true;
			Type = Type_DefaultValue = PlotOptionsPivotpointsSonificationTracksType.Instrument;
		...
		/// </summary>
		public PlotOptionsPivotpointsSonificationTracksActiveWhen ActiveWhen { get; set; }
		private PlotOptionsPivotpointsSonificationTracksActiveWhen ActiveWhen_DefaultValue { get; set; }
		...
		/// </summary>
		public PlotOptionsPivotpointsSonificationTracksMapping Mapping { get; set; }
		private PlotOptionsPivotpointsSonificationTracksMapping Mapping_DefaultValue { get; set; }
		...
		/// </summary>
		public PlotOptionsPivotpointsSonificationTracksPointGrouping PointGrouping { get; set; }
		private PlotOptionsPivotpointsSonificationTracksPointGrouping PointGrouping_DefaultValue { get; set; }
		...
		/// </summary>
		public PlotOptionsPivotpointsSonificationTracksType Type { get; set; }
		private PlotOptionsPivotpointsSonificationTracksType Type_DefaultValue { get; set; }
