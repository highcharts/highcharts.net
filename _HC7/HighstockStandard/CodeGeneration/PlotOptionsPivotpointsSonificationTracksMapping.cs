...
{
	public partial class PlotOptionsPivotpointsSonificationTracksMapping  : BaseObject
	{
		Hashtable h = new Hashtable();

		public PlotOptionsPivotpointsSonificationTracksMapping()
		{
			Frequency = Frequency_DefaultValue = new PlotOptionsPivotpointsSonificationTracksMappingFrequency();
			GapBetweenNotes = GapBetweenNotes_DefaultValue = new PlotOptionsPivotpointsSonificationTracksMappingGapBetweenNotes();
			Highpass = Highpass_DefaultValue = new PlotOptionsPivotpointsSonificationTracksMappingHighpass();
			Lowpass = Lowpass_DefaultValue = new PlotOptionsPivotpointsSonificationTracksMappingLowpass();
			NoteDuration = NoteDuration_DefaultValue = new PlotOptionsPivotpointsSonificationTracksMappingNoteDuration();
			Pan = Pan_DefaultValue = new PlotOptionsPivotpointsSonificationTracksMappingPan();
			Pitch = Pitch_DefaultValue = new PlotOptionsPivotpointsSonificationTracksMappingPitch();
			PitchString = PitchString_DefaultValue = "null";
			PitchNumber = PitchNumber_DefaultValue = null;
			PlayDelay = PlayDelay_DefaultValue = new PlotOptionsPivotpointsSonificationTracksMappingPlayDelay();
			Time = Time_DefaultValue = new PlotOptionsPivotpointsSonificationTracksMappingTime();
			TimeString = TimeString_DefaultValue = "null";
			TimeNumber = TimeNumber_DefaultValue = null;
			Tremolo = Tremolo_DefaultValue = new PlotOptionsPivotpointsSonificationTracksMappingTremolo();
			Volume = Volume_DefaultValue = new PlotOptionsPivotpointsSonificationTracksMappingVolume();
		...
		/// </summary>
		public PlotOptionsPivotpointsSonificationTracksMappingFrequency Frequency { get; set; }
		private PlotOptionsPivotpointsSonificationTracksMappingFrequency Frequency_DefaultValue { get; set; }
		...
		/// </summary>
		public PlotOptionsPivotpointsSonificationTracksMappingGapBetweenNotes GapBetweenNotes { get; set; }
		private PlotOptionsPivotpointsSonificationTracksMappingGapBetweenNotes GapBetweenNotes_DefaultValue { get; set; }
		...
		/// </summary>
		public PlotOptionsPivotpointsSonificationTracksMappingHighpass Highpass { get; set; }
		private PlotOptionsPivotpointsSonificationTracksMappingHighpass Highpass_DefaultValue { get; set; }
		...
		/// </summary>
		public PlotOptionsPivotpointsSonificationTracksMappingLowpass Lowpass { get; set; }
		private PlotOptionsPivotpointsSonificationTracksMappingLowpass Lowpass_DefaultValue { get; set; }
		...
		/// </summary>
		public PlotOptionsPivotpointsSonificationTracksMappingNoteDuration NoteDuration { get; set; }
		private PlotOptionsPivotpointsSonificationTracksMappingNoteDuration NoteDuration_DefaultValue { get; set; }
		...
		/// </summary>
		public PlotOptionsPivotpointsSonificationTracksMappingPan Pan { get; set; }
		private PlotOptionsPivotpointsSonificationTracksMappingPan Pan_DefaultValue { get; set; }
		...
		/// </summary>
		public PlotOptionsPivotpointsSonificationTracksMappingPitch Pitch { get; set; }
		private PlotOptionsPivotpointsSonificationTracksMappingPitch Pitch_DefaultValue { get; set; }
		...
		/// </summary>
		public PlotOptionsPivotpointsSonificationTracksMappingPlayDelay PlayDelay { get; set; }
		private PlotOptionsPivotpointsSonificationTracksMappingPlayDelay PlayDelay_DefaultValue { get; set; }
		...
		/// </summary>
		public PlotOptionsPivotpointsSonificationTracksMappingTime Time { get; set; }
		private PlotOptionsPivotpointsSonificationTracksMappingTime Time_DefaultValue { get; set; }
		...
		/// </summary>
		public PlotOptionsPivotpointsSonificationTracksMappingTremolo Tremolo { get; set; }
		private PlotOptionsPivotpointsSonificationTracksMappingTremolo Tremolo_DefaultValue { get; set; }
		 

		/// <summary>
		/// The volume of notes, from 0 to 1.
		/// </summary>
		public PlotOptionsPivotpointsSonificationTracksMappingVolume Volume { get; set; }
		private PlotOptionsPivotpointsSonificationTracksMappingVolume Volume_DefaultValue { get; set; }
