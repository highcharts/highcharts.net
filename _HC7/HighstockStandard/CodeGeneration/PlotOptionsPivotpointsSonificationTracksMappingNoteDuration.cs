...
{
	public partial class PlotOptionsPivotpointsSonificationTracksMappingNoteDuration  : BaseObject
	{
		Hashtable h = new Hashtable();

		public PlotOptionsPivotpointsSonificationTracksMappingNoteDuration()
		{
			MapFunction = MapFunction_DefaultValue = PlotOptionsPivotpointsSonificationTracksMappingNoteDurationMapFunction.Linear;
			MapTo = MapTo_DefaultValue = "";
			Max = Max_DefaultValue = null;
			Min = Min_DefaultValue = null;
			Value = Value_DefaultValue = null;
			Within = Within_DefaultValue = PlotOptionsPivotpointsSonificationTracksMappingNoteDurationWithin.Chart;
		...
		/// </summary>
		public PlotOptionsPivotpointsSonificationTracksMappingNoteDurationMapFunction MapFunction { get; set; }
		private PlotOptionsPivotpointsSonificationTracksMappingNoteDurationMapFunction MapFunction_DefaultValue { get; set; }
		...
		/// </summary>
		public PlotOptionsPivotpointsSonificationTracksMappingNoteDurationWithin Within { get; set; }
		private PlotOptionsPivotpointsSonificationTracksMappingNoteDurationWithin Within_DefaultValue { get; set; }
