...
{
	public partial class PlotOptionsPivotpointsSonificationTracksMappingPan  : BaseObject
	{
		Hashtable h = new Hashtable();

		public PlotOptionsPivotpointsSonificationTracksMappingPan()
		{
			MapFunction = MapFunction_DefaultValue = PlotOptionsPivotpointsSonificationTracksMappingPanMapFunction.Linear;
			MapTo = MapTo_DefaultValue = "";
			Max = Max_DefaultValue = null;
			Min = Min_DefaultValue = null;
			Value = Value_DefaultValue = null;
			Within = Within_DefaultValue = PlotOptionsPivotpointsSonificationTracksMappingPanWithin.Chart;
		...
		/// </summary>
		public PlotOptionsPivotpointsSonificationTracksMappingPanMapFunction MapFunction { get; set; }
		private PlotOptionsPivotpointsSonificationTracksMappingPanMapFunction MapFunction_DefaultValue { get; set; }
		...
		/// </summary>
		public PlotOptionsPivotpointsSonificationTracksMappingPanWithin Within { get; set; }
		private PlotOptionsPivotpointsSonificationTracksMappingPanWithin Within_DefaultValue { get; set; }
