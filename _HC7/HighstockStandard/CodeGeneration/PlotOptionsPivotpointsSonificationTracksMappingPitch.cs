...
{
	public partial class PlotOptionsPivotpointsSonificationTracksMappingPitch  : BaseObject
	{
		Hashtable h = new Hashtable();

		public PlotOptionsPivotpointsSonificationTracksMappingPitch()
		{
			MapFunction = MapFunction_DefaultValue = PlotOptionsPivotpointsSonificationTracksMappingPitchMapFunction.Linear;
		...
		/// </summary>
		public PlotOptionsPivotpointsSonificationTracksMappingPitchMapFunction MapFunction { get; set; }
		private PlotOptionsPivotpointsSonificationTracksMappingPitchMapFunction MapFunction_DefaultValue { get; set; }
