...
{
	public partial class PlotOptionsPivotpointsSonificationTracksMappingTime  : BaseObject
	{
		Hashtable h = new Hashtable();

		public PlotOptionsPivotpointsSonificationTracksMappingTime()
		{
			MapFunction = MapFunction_DefaultValue = PlotOptionsPivotpointsSonificationTracksMappingTimeMapFunction.Linear;
			MapTo = MapTo_DefaultValue = "";
			Max = Max_DefaultValue = null;
			Min = Min_DefaultValue = null;
			Value = Value_DefaultValue = null;
			Within = Within_DefaultValue = PlotOptionsPivotpointsSonificationTracksMappingTimeWithin.Chart;
		...
		/// </summary>
		public PlotOptionsPivotpointsSonificationTracksMappingTimeMapFunction MapFunction { get; set; }
		private PlotOptionsPivotpointsSonificationTracksMappingTimeMapFunction MapFunction_DefaultValue { get; set; }
		...
		/// </summary>
		public PlotOptionsPivotpointsSonificationTracksMappingTimeWithin Within { get; set; }
		private PlotOptionsPivotpointsSonificationTracksMappingTimeWithin Within_DefaultValue { get; set; }
