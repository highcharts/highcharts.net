...
{
	public partial class PlotOptionsPivotpointsSonificationTracksPointGrouping  : BaseObject
	{
		Hashtable h = new Hashtable();

		public PlotOptionsPivotpointsSonificationTracksPointGrouping()
		{
			Algorithm = Algorithm_DefaultValue = PlotOptionsPivotpointsSonificationTracksPointGroupingAlgorithm.Minimax;
		...
		/// </summary>
		public PlotOptionsPivotpointsSonificationTracksPointGroupingAlgorithm Algorithm { get; set; }
		private PlotOptionsPivotpointsSonificationTracksPointGroupingAlgorithm Algorithm_DefaultValue { get; set; }
