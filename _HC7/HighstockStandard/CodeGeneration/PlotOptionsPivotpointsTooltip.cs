...
{
	public partial class PlotOptionsPivotpointsTooltip  : BaseObject
	{
		public PlotOptionsPivotpointsTooltip()
		{
			...
			HeaderShape = HeaderShape_DefaultValue = PlotOptionsPivotpointsTooltipHeaderShape.Callout;
		...
		/// </summary>
		public PlotOptionsPivotpointsTooltipHeaderShape HeaderShape { get; set; }
		private PlotOptionsPivotpointsTooltipHeaderShape HeaderShape_DefaultValue { get; set; }
		...
		internal override Hashtable ToHashtable()
		{
			...
			if (NullFormatter != NullFormatter_DefaultValue) { h.Add("nullFormatter",NullFormatter); Highstock.AddFunction("PlotOptionsPivotpointsTooltipNullFormatter.nullFormatter", NullFormatter); }  
			if (Outside != Outside_DefaultValue) h.Add("outside",Outside);
			if (Padding != Padding_DefaultValue) h.Add("padding",Padding);
			if (PointFormat != PointFormat_DefaultValue) h.Add("pointFormat",PointFormat);
			if (PointFormatter != PointFormatter_DefaultValue) { h.Add("pointFormatter",PointFormatter); Highstock.AddFunction("PlotOptionsPivotpointsTooltipPointFormatter.pointFormatter", PointFormatter); }  
