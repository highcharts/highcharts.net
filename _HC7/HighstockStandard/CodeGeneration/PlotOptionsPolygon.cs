...
namespace Highsoft.Web.Mvc.Stocks
{
	public partial class PlotOptionsPolygon  : BaseObject
	{
		...
		public PlotOptionsPolygon()
		{
			...
			Compare = Compare_DefaultValue = PlotOptionsPolygonCompare.Percent;
			...
			Sonification = Sonification_DefaultValue = new PlotOptionsPolygonSonification();
			...
			Zones = Zones_DefaultValue = new List<PlotOptionsPolygonZones>();
		...
		/// </summary>
		public PlotOptionsPolygonSonification Sonification { get; set; }
		private PlotOptionsPolygonSonification Sonification_DefaultValue { get; set; }
