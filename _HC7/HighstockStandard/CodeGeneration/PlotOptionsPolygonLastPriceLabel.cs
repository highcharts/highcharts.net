...
{
	public partial class PlotOptionsPolygonLastPriceLabel  : BaseObject
	{
		Hashtable h = new Hashtable();

		public PlotOptionsPolygonLastPriceLabel()
		{
			Align = Align_DefaultValue = PlotOptionsPolygonLastPriceLabelAlign.Null;
		...
		/// 
		/// </summary>
		public PlotOptionsPolygonLastPriceLabelAlign Align { get; set; }
		private PlotOptionsPolygonLastPriceLabelAlign Align_DefaultValue { get; set; }
