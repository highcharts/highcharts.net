...
namespace Highsoft.Web.Mvc.Stocks
{
	public partial class PlotOptionsPpo  : BaseObject
	{
		public PlotOptionsPpo()
		{
			...
			DragDrop = DragDrop_DefaultValue = new PlotOptionsPpoDragDrop();
		...
		/// </summary>
		public PlotOptionsPpoDragDrop DragDrop { get; set; }
		private PlotOptionsPpoDragDrop DragDrop_DefaultValue { get; set; }
