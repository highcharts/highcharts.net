...
{
	public partial class PlotOptionsPpoDragDrop  : BaseObject
	{
		public PlotOptionsPpoDragDrop()
		{
			DraggableX = DraggableX_DefaultValue = null;
			DraggableY = DraggableY_DefaultValue = null;
			DragHandle = DragHandle_DefaultValue = new PlotOptionsPpoDragDropDragHandle();
			...
			GuideBox = GuideBox_DefaultValue = new PlotOptionsPpoDragDropGuideBox();
		...
		/// </summary>
		public PlotOptionsPpoDragDropDragHandle DragHandle { get; set; }
		private PlotOptionsPpoDragDropDragHandle DragHandle_DefaultValue { get; set; }
		...
		/// </summary>
		public PlotOptionsPpoDragDropGuideBox GuideBox { get; set; }
		private PlotOptionsPpoDragDropGuideBox GuideBox_DefaultValue { get; set; }
