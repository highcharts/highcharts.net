...
{
	public partial class PlotOptionsPpoLabel  : BaseObject
	{
		public PlotOptionsPpoLabel()
		{
			...
			Style = Style_DefaultValue = new PlotOptionsPpoLabelStyle();
		...
		/// </summary>
		public PlotOptionsPpoLabelStyle Style { get; set; }
		private PlotOptionsPpoLabelStyle Style_DefaultValue { get; set; }
