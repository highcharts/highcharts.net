...
{
	public partial class PlotOptionsPpoSonificationContextTracks  : BaseObject
	{
		Hashtable h = new Hashtable();

		public PlotOptionsPpoSonificationContextTracks()
		{
			ActiveWhen = ActiveWhen_DefaultValue = new PlotOptionsPpoSonificationContextTracksActiveWhen();
			Instrument = Instrument_DefaultValue = null;
			InstrumentString = InstrumentString_DefaultValue = "null";
			Mapping = Mapping_DefaultValue = new PlotOptionsPpoSonificationContextTracksMapping();
			MidiName = MidiName_DefaultValue = "";
			PointGrouping = PointGrouping_DefaultValue = new PlotOptionsPpoSonificationContextTracksPointGrouping();
			...
			Type = Type_DefaultValue = PlotOptionsPpoSonificationContextTracksType.Instrument;
			ValueInterval = ValueInterval_DefaultValue = null;
			ValueMapFunction = ValueMapFunction_DefaultValue = PlotOptionsPpoSonificationContextTracksValueMapFunction.Linear;
		...
		/// </summary>
		public PlotOptionsPpoSonificationContextTracksActiveWhen ActiveWhen { get; set; }
		private PlotOptionsPpoSonificationContextTracksActiveWhen ActiveWhen_DefaultValue { get; set; }
		...
		/// </summary>
		public PlotOptionsPpoSonificationContextTracksMapping Mapping { get; set; }
		private PlotOptionsPpoSonificationContextTracksMapping Mapping_DefaultValue { get; set; }
		...
		/// </summary>
		public PlotOptionsPpoSonificationContextTracksPointGrouping PointGrouping { get; set; }
		private PlotOptionsPpoSonificationContextTracksPointGrouping PointGrouping_DefaultValue { get; set; }
		...
		/// </summary>
		public PlotOptionsPpoSonificationContextTracksType Type { get; set; }
		private PlotOptionsPpoSonificationContextTracksType Type_DefaultValue { get; set; }
		...
		/// </summary>
		public PlotOptionsPpoSonificationContextTracksValueMapFunction ValueMapFunction { get; set; }
		private PlotOptionsPpoSonificationContextTracksValueMapFunction ValueMapFunction_DefaultValue { get; set; }
