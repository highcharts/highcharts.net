...
{
	public partial class PlotOptionsPpoSonificationContextTracksMapping  : BaseObject
	{
		Hashtable h = new Hashtable();

		public PlotOptionsPpoSonificationContextTracksMapping()
		{
			Frequency = Frequency_DefaultValue = new PlotOptionsPpoSonificationContextTracksMappingFrequency();
			GapBetweenNotes = GapBetweenNotes_DefaultValue = new PlotOptionsPpoSonificationContextTracksMappingGapBetweenNotes();
			Highpass = Highpass_DefaultValue = new PlotOptionsPpoSonificationContextTracksMappingHighpass();
			Lowpass = Lowpass_DefaultValue = new PlotOptionsPpoSonificationContextTracksMappingLowpass();
			NoteDuration = NoteDuration_DefaultValue = new PlotOptionsPpoSonificationContextTracksMappingNoteDuration();
			Pan = Pan_DefaultValue = new PlotOptionsPpoSonificationContextTracksMappingPan();
			Pitch = Pitch_DefaultValue = new PlotOptionsPpoSonificationContextTracksMappingPitch();
			PitchString = PitchString_DefaultValue = "null";
			PitchNumber = PitchNumber_DefaultValue = null;
			PlayDelay = PlayDelay_DefaultValue = new PlotOptionsPpoSonificationContextTracksMappingPlayDelay();
			Time = Time_DefaultValue = new PlotOptionsPpoSonificationContextTracksMappingTime();
			TimeString = TimeString_DefaultValue = "null";
			TimeNumber = TimeNumber_DefaultValue = null;
			Tremolo = Tremolo_DefaultValue = new PlotOptionsPpoSonificationContextTracksMappingTremolo();
			Volume = Volume_DefaultValue = new PlotOptionsPpoSonificationContextTracksMappingVolume();
		...
		/// </summary>
		public PlotOptionsPpoSonificationContextTracksMappingFrequency Frequency { get; set; }
		private PlotOptionsPpoSonificationContextTracksMappingFrequency Frequency_DefaultValue { get; set; }
		...
		/// </summary>
		public PlotOptionsPpoSonificationContextTracksMappingGapBetweenNotes GapBetweenNotes { get; set; }
		private PlotOptionsPpoSonificationContextTracksMappingGapBetweenNotes GapBetweenNotes_DefaultValue { get; set; }
		...
		/// </summary>
		public PlotOptionsPpoSonificationContextTracksMappingHighpass Highpass { get; set; }
		private PlotOptionsPpoSonificationContextTracksMappingHighpass Highpass_DefaultValue { get; set; }
		...
		/// </summary>
		public PlotOptionsPpoSonificationContextTracksMappingLowpass Lowpass { get; set; }
		private PlotOptionsPpoSonificationContextTracksMappingLowpass Lowpass_DefaultValue { get; set; }
		...
		/// </summary>
		public PlotOptionsPpoSonificationContextTracksMappingNoteDuration NoteDuration { get; set; }
		private PlotOptionsPpoSonificationContextTracksMappingNoteDuration NoteDuration_DefaultValue { get; set; }
		...
		/// </summary>
		public PlotOptionsPpoSonificationContextTracksMappingPan Pan { get; set; }
		private PlotOptionsPpoSonificationContextTracksMappingPan Pan_DefaultValue { get; set; }
		...
		/// </summary>
		public PlotOptionsPpoSonificationContextTracksMappingPitch Pitch { get; set; }
		private PlotOptionsPpoSonificationContextTracksMappingPitch Pitch_DefaultValue { get; set; }
		...
		/// </summary>
		public PlotOptionsPpoSonificationContextTracksMappingPlayDelay PlayDelay { get; set; }
		private PlotOptionsPpoSonificationContextTracksMappingPlayDelay PlayDelay_DefaultValue { get; set; }
		...
		/// </summary>
		public PlotOptionsPpoSonificationContextTracksMappingTime Time { get; set; }
		private PlotOptionsPpoSonificationContextTracksMappingTime Time_DefaultValue { get; set; }
		...
		/// </summary>
		public PlotOptionsPpoSonificationContextTracksMappingTremolo Tremolo { get; set; }
		private PlotOptionsPpoSonificationContextTracksMappingTremolo Tremolo_DefaultValue { get; set; }
		 

		/// <summary>
		/// The volume of notes, from 0 to 1.
		/// </summary>
		public PlotOptionsPpoSonificationContextTracksMappingVolume Volume { get; set; }
		private PlotOptionsPpoSonificationContextTracksMappingVolume Volume_DefaultValue { get; set; }
