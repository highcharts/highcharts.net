...
{
	public partial class PlotOptionsPpoSonificationContextTracksMappingPitch  : BaseObject
	{
		Hashtable h = new Hashtable();

		public PlotOptionsPpoSonificationContextTracksMappingPitch()
		{
			MapFunction = MapFunction_DefaultValue = PlotOptionsPpoSonificationContextTracksMappingPitchMapFunction.Linear;
		...
		/// </summary>
		public PlotOptionsPpoSonificationContextTracksMappingPitchMapFunction MapFunction { get; set; }
		private PlotOptionsPpoSonificationContextTracksMappingPitchMapFunction MapFunction_DefaultValue { get; set; }
