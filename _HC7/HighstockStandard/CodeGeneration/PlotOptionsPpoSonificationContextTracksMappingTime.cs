...
{
	public partial class PlotOptionsPpoSonificationContextTracksMappingTime  : BaseObject
	{
		Hashtable h = new Hashtable();

		public PlotOptionsPpoSonificationContextTracksMappingTime()
		{
			MapFunction = MapFunction_DefaultValue = PlotOptionsPpoSonificationContextTracksMappingTimeMapFunction.Linear;
			MapTo = MapTo_DefaultValue = "";
			Max = Max_DefaultValue = null;
			Min = Min_DefaultValue = null;
			Value = Value_DefaultValue = null;
			Within = Within_DefaultValue = PlotOptionsPpoSonificationContextTracksMappingTimeWithin.Chart;
		...
		/// </summary>
		public PlotOptionsPpoSonificationContextTracksMappingTimeMapFunction MapFunction { get; set; }
		private PlotOptionsPpoSonificationContextTracksMappingTimeMapFunction MapFunction_DefaultValue { get; set; }
		...
		/// </summary>
		public PlotOptionsPpoSonificationContextTracksMappingTimeWithin Within { get; set; }
		private PlotOptionsPpoSonificationContextTracksMappingTimeWithin Within_DefaultValue { get; set; }
