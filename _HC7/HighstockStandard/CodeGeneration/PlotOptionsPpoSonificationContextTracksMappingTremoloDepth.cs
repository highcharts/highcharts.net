...
{
	public partial class PlotOptionsPpoSonificationContextTracksMappingTremoloDepth  : BaseObject
	{
		Hashtable h = new Hashtable();

		public PlotOptionsPpoSonificationContextTracksMappingTremoloDepth()
		{
			MapFunction = MapFunction_DefaultValue = PlotOptionsPpoSonificationContextTracksMappingTremoloDepthMapFunction.Linear;
			MapTo = MapTo_DefaultValue = "";
			Max = Max_DefaultValue = null;
			Min = Min_DefaultValue = null;
			Value = Value_DefaultValue = null;
			Within = Within_DefaultValue = PlotOptionsPpoSonificationContextTracksMappingTremoloDepthWithin.Chart;
		...
		/// </summary>
		public PlotOptionsPpoSonificationContextTracksMappingTremoloDepthMapFunction MapFunction { get; set; }
		private PlotOptionsPpoSonificationContextTracksMappingTremoloDepthMapFunction MapFunction_DefaultValue { get; set; }
		...
		/// </summary>
		public PlotOptionsPpoSonificationContextTracksMappingTremoloDepthWithin Within { get; set; }
		private PlotOptionsPpoSonificationContextTracksMappingTremoloDepthWithin Within_DefaultValue { get; set; }
