...
{
	public partial class PlotOptionsPpoSonificationDefaultInstrumentOptionsMappingPlayDelay  : BaseObject
	{
		Hashtable h = new Hashtable();

		public PlotOptionsPpoSonificationDefaultInstrumentOptionsMappingPlayDelay()
		{
			MapFunction = MapFunction_DefaultValue = PlotOptionsPpoSonificationDefaultInstrumentOptionsMappingPlayDelayMapFunction.Linear;
			MapTo = MapTo_DefaultValue = "";
			Max = Max_DefaultValue = null;
			Min = Min_DefaultValue = null;
			Value = Value_DefaultValue = null;
			Within = Within_DefaultValue = PlotOptionsPpoSonificationDefaultInstrumentOptionsMappingPlayDelayWithin.Chart;
		...
		/// </summary>
		public PlotOptionsPpoSonificationDefaultInstrumentOptionsMappingPlayDelayMapFunction MapFunction { get; set; }
		private PlotOptionsPpoSonificationDefaultInstrumentOptionsMappingPlayDelayMapFunction MapFunction_DefaultValue { get; set; }
		...
		/// </summary>
		public PlotOptionsPpoSonificationDefaultInstrumentOptionsMappingPlayDelayWithin Within { get; set; }
		private PlotOptionsPpoSonificationDefaultInstrumentOptionsMappingPlayDelayWithin Within_DefaultValue { get; set; }
