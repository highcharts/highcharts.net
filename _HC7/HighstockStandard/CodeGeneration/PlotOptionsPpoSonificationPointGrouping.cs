...
{
	public partial class PlotOptionsPpoSonificationPointGrouping  : BaseObject
	{
		Hashtable h = new Hashtable();

		public PlotOptionsPpoSonificationPointGrouping()
		{
			Algorithm = Algorithm_DefaultValue = PlotOptionsPpoSonificationPointGroupingAlgorithm.Minimax;
		...
		/// </summary>
		public PlotOptionsPpoSonificationPointGroupingAlgorithm Algorithm { get; set; }
		private PlotOptionsPpoSonificationPointGroupingAlgorithm Algorithm_DefaultValue { get; set; }
