...
{
	public partial class PlotOptionsPpoSonificationTracks  : BaseObject
	{
		Hashtable h = new Hashtable();

		public PlotOptionsPpoSonificationTracks()
		{
			ActiveWhen = ActiveWhen_DefaultValue = new PlotOptionsPpoSonificationTracksActiveWhen();
			Instrument = Instrument_DefaultValue = null;
			InstrumentString = InstrumentString_DefaultValue = "null";
			Mapping = Mapping_DefaultValue = new PlotOptionsPpoSonificationTracksMapping();
			MidiName = MidiName_DefaultValue = "";
			PointGrouping = PointGrouping_DefaultValue = new PlotOptionsPpoSonificationTracksPointGrouping();
			RoundToMusicalNotes = RoundToMusicalNotes_DefaultValue = true;
			ShowPlayMarker = ShowPlayMarker_DefaultValue = true;
			Type = Type_DefaultValue = PlotOptionsPpoSonificationTracksType.Instrument;
		...
		/// </summary>
		public PlotOptionsPpoSonificationTracksActiveWhen ActiveWhen { get; set; }
		private PlotOptionsPpoSonificationTracksActiveWhen ActiveWhen_DefaultValue { get; set; }
		...
		/// </summary>
		public PlotOptionsPpoSonificationTracksMapping Mapping { get; set; }
		private PlotOptionsPpoSonificationTracksMapping Mapping_DefaultValue { get; set; }
		...
		/// </summary>
		public PlotOptionsPpoSonificationTracksPointGrouping PointGrouping { get; set; }
		private PlotOptionsPpoSonificationTracksPointGrouping PointGrouping_DefaultValue { get; set; }
		...
		/// </summary>
		public PlotOptionsPpoSonificationTracksType Type { get; set; }
		private PlotOptionsPpoSonificationTracksType Type_DefaultValue { get; set; }
