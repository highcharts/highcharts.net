...
{
	public partial class PlotOptionsPpoSonificationTracksMappingPan  : BaseObject
	{
		Hashtable h = new Hashtable();

		public PlotOptionsPpoSonificationTracksMappingPan()
		{
			MapFunction = MapFunction_DefaultValue = PlotOptionsPpoSonificationTracksMappingPanMapFunction.Linear;
			MapTo = MapTo_DefaultValue = "";
			Max = Max_DefaultValue = null;
			Min = Min_DefaultValue = null;
			Value = Value_DefaultValue = null;
			Within = Within_DefaultValue = PlotOptionsPpoSonificationTracksMappingPanWithin.Chart;
		...
		/// </summary>
		public PlotOptionsPpoSonificationTracksMappingPanMapFunction MapFunction { get; set; }
		private PlotOptionsPpoSonificationTracksMappingPanMapFunction MapFunction_DefaultValue { get; set; }
		...
		/// </summary>
		public PlotOptionsPpoSonificationTracksMappingPanWithin Within { get; set; }
		private PlotOptionsPpoSonificationTracksMappingPanWithin Within_DefaultValue { get; set; }
