...
{
	public partial class PlotOptionsPpoSonificationTracksMappingPitch  : BaseObject
	{
		Hashtable h = new Hashtable();

		public PlotOptionsPpoSonificationTracksMappingPitch()
		{
			MapFunction = MapFunction_DefaultValue = PlotOptionsPpoSonificationTracksMappingPitchMapFunction.Linear;
		...
		/// </summary>
		public PlotOptionsPpoSonificationTracksMappingPitchMapFunction MapFunction { get; set; }
		private PlotOptionsPpoSonificationTracksMappingPitchMapFunction MapFunction_DefaultValue { get; set; }
