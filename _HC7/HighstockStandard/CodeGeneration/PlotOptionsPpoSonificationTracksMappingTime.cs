...
{
	public partial class PlotOptionsPpoSonificationTracksMappingTime  : BaseObject
	{
		Hashtable h = new Hashtable();

		public PlotOptionsPpoSonificationTracksMappingTime()
		{
			MapFunction = MapFunction_DefaultValue = PlotOptionsPpoSonificationTracksMappingTimeMapFunction.Linear;
			MapTo = MapTo_DefaultValue = "";
			Max = Max_DefaultValue = null;
			Min = Min_DefaultValue = null;
			Value = Value_DefaultValue = null;
			Within = Within_DefaultValue = PlotOptionsPpoSonificationTracksMappingTimeWithin.Chart;
		...
		/// </summary>
		public PlotOptionsPpoSonificationTracksMappingTimeMapFunction MapFunction { get; set; }
		private PlotOptionsPpoSonificationTracksMappingTimeMapFunction MapFunction_DefaultValue { get; set; }
		...
		/// </summary>
		public PlotOptionsPpoSonificationTracksMappingTimeWithin Within { get; set; }
		private PlotOptionsPpoSonificationTracksMappingTimeWithin Within_DefaultValue { get; set; }
