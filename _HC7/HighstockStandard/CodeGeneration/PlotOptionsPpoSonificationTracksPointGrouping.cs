...
{
	public partial class PlotOptionsPpoSonificationTracksPointGrouping  : BaseObject
	{
		Hashtable h = new Hashtable();

		public PlotOptionsPpoSonificationTracksPointGrouping()
		{
			Algorithm = Algorithm_DefaultValue = PlotOptionsPpoSonificationTracksPointGroupingAlgorithm.Minimax;
		...
		/// </summary>
		public PlotOptionsPpoSonificationTracksPointGroupingAlgorithm Algorithm { get; set; }
		private PlotOptionsPpoSonificationTracksPointGroupingAlgorithm Algorithm_DefaultValue { get; set; }
