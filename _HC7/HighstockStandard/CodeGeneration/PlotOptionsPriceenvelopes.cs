...
{
	public partial class PlotOptionsPriceenvelopes  : BaseObject
	{
		Hashtable h = new Hashtable();

		public PlotOptionsPriceenvelopes()
		{
			Accessibility = Accessibility_DefaultValue = new PlotOptionsPriceenvelopesAccessibility();
			AllowPointSelect = AllowPointSelect_DefaultValue = false;
			Animation = Animation_DefaultValue = new Animation() { Enabled = true };
			AnimationBool = AnimationBool_DefaultValue = true;
			AnimationLimit = AnimationLimit_DefaultValue = null;
			BoostBlending = BoostBlending_DefaultValue = PlotOptionsPriceenvelopesBoostBlending.Undefined;
			...
			Compare = Compare_DefaultValue = PlotOptionsPriceenvelopesCompare.Percent;
			...
			DashStyle = DashStyle_DefaultValue = PlotOptionsPriceenvelopesDashStyle.Null;
			...
			DataSorting = DataSorting_DefaultValue = new PlotOptionsPriceenvelopesDataSorting();
			Description = Description_DefaultValue = "";
			EnableMouseTracking = EnableMouseTracking_DefaultValue = true;
			Events = Events_DefaultValue = new PlotOptionsPriceenvelopesEvents();
			FindNearestPointBy = FindNearestPointBy_DefaultValue = PlotOptionsPriceenvelopesFindNearestPointBy.X;
			...
			LegendSymbol = LegendSymbol_DefaultValue = PlotOptionsPriceenvelopesLegendSymbol.Rectangle;
			...
			OnPoint = OnPoint_DefaultValue = new PlotOptionsPriceenvelopesOnPoint();
			...
			Sonification = Sonification_DefaultValue = new PlotOptionsPriceenvelopesSonification();
			States = States_DefaultValue = new PlotOptionsPriceenvelopesStates();
			Step = Step_DefaultValue = PlotOptionsPriceenvelopesStep.Null;
			...
			Zones = Zones_DefaultValue = new List<PlotOptionsPriceenvelopesZones>();
		...
		/// </summary>
		public PlotOptionsPriceenvelopesAccessibility Accessibility { get; set; }
		private PlotOptionsPriceenvelopesAccessibility Accessibility_DefaultValue { get; set; }
		...
		/// </summary>
		public PlotOptionsPriceenvelopesBoostBlending BoostBlending { get; set; }
		private PlotOptionsPriceenvelopesBoostBlending BoostBlending_DefaultValue { get; set; }
		...
		/// Bottom line options.
		/// </summary>
		public PlotOptionsPriceenvelopesBottomLine BottomLine { get; set; }
		private PlotOptionsPriceenvelopesBottomLine BottomLine_DefaultValue { get; set; }
		...
		/// </summary>
		public PlotOptionsPriceenvelopesCompare Compare { get; set; }
		private PlotOptionsPriceenvelopesCompare Compare_DefaultValue { get; set; }
		...
		/// </summary>
		public PlotOptionsPriceenvelopesCursor Cursor { get; set; }
		private PlotOptionsPriceenvelopesCursor Cursor_DefaultValue { get; set; }
		...
		/// </summary>
		public PlotOptionsPriceenvelopesDashStyle DashStyle { get; set; }
		private PlotOptionsPriceenvelopesDashStyle DashStyle_DefaultValue { get; set; }
		...
		/// </summary>
		public PlotOptionsPriceenvelopesDataSorting DataSorting { get; set; }
		private PlotOptionsPriceenvelopesDataSorting DataSorting_DefaultValue { get; set; }
		...
		/// </summary>
		public PlotOptionsPriceenvelopesFindNearestPointBy FindNearestPointBy { get; set; }
		private PlotOptionsPriceenvelopesFindNearestPointBy FindNearestPointBy_DefaultValue { get; set; }
		...
		/// </summary>
		public PlotOptionsPriceenvelopesGapUnit GapUnit { get; set; }
		private PlotOptionsPriceenvelopesGapUnit GapUnit_DefaultValue { get; set; }
		...
		/// </summary>
		public PlotOptionsPriceenvelopesLastPrice LastPrice { get; set; }
		private PlotOptionsPriceenvelopesLastPrice LastPrice_DefaultValue { get; set; }
		 

		/// <summary>
		/// The line marks the last price from visible range of points.
		/// </summary>
		public PlotOptionsPriceenvelopesLastVisiblePrice LastVisiblePrice { get; set; }
		private PlotOptionsPriceenvelopesLastVisiblePrice LastVisiblePrice_DefaultValue { get; set; }
		 

		/// <summary>
		/// What type of legend symbol to render for this series. Can be one of`lineMarker` or `rectangle`.
		/// </summary>
		public PlotOptionsPriceenvelopesLegendSymbol LegendSymbol { get; set; }
		private PlotOptionsPriceenvelopesLegendSymbol LegendSymbol_DefaultValue { get; set; }
		...
		/// </summary>
		public PlotOptionsPriceenvelopesOnPoint OnPoint { get; set; }
		private PlotOptionsPriceenvelopesOnPoint OnPoint_DefaultValue { get; set; }
		...
		/// </summary>
		public PlotOptionsPriceenvelopesPoint Point { get; set; }
		private PlotOptionsPriceenvelopesPoint Point_DefaultValue { get; set; }
		...
		/// </summary>
		public PlotOptionsPriceenvelopesSonification Sonification { get; set; }
		private PlotOptionsPriceenvelopesSonification Sonification_DefaultValue { get; set; }
		 

		/// <summary>
		/// 
		/// </summary>
		public PlotOptionsPriceenvelopesStates States { get; set; }
		private PlotOptionsPriceenvelopesStates States_DefaultValue { get; set; }
		 

		/// <summary>
		/// Whether to apply steps to the line. Possible values are `left`,`center` and `right`.
		/// </summary>
		public PlotOptionsPriceenvelopesStep Step { get; set; }
		private PlotOptionsPriceenvelopesStep Step_DefaultValue { get; set; }
		...
		/// </summary>
		public List<PlotOptionsPriceenvelopesZones> Zones { get; set; }
		private List<PlotOptionsPriceenvelopesZones> Zones_DefaultValue { get; set; }
