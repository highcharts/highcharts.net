...
{
	public partial class PlotOptionsPriceenvelopesLabel  : BaseObject
	{
		public PlotOptionsPriceenvelopesLabel()
		{
			...
			Style = Style_DefaultValue = new PlotOptionsPriceenvelopesLabelStyle();
		...
		/// </summary>
		public PlotOptionsPriceenvelopesLabelStyle Style { get; set; }
		private PlotOptionsPriceenvelopesLabelStyle Style_DefaultValue { get; set; }
