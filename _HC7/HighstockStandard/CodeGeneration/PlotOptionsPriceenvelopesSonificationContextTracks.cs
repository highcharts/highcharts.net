...
{
	public partial class PlotOptionsPriceenvelopesSonificationContextTracks  : BaseObject
	{
		Hashtable h = new Hashtable();

		public PlotOptionsPriceenvelopesSonificationContextTracks()
		{
			ActiveWhen = ActiveWhen_DefaultValue = new PlotOptionsPriceenvelopesSonificationContextTracksActiveWhen();
			Instrument = Instrument_DefaultValue = null;
			InstrumentString = InstrumentString_DefaultValue = "null";
			Mapping = Mapping_DefaultValue = new PlotOptionsPriceenvelopesSonificationContextTracksMapping();
			MidiName = MidiName_DefaultValue = "";
			PointGrouping = PointGrouping_DefaultValue = new PlotOptionsPriceenvelopesSonificationContextTracksPointGrouping();
			...
			Type = Type_DefaultValue = PlotOptionsPriceenvelopesSonificationContextTracksType.Instrument;
			ValueInterval = ValueInterval_DefaultValue = null;
			ValueMapFunction = ValueMapFunction_DefaultValue = PlotOptionsPriceenvelopesSonificationContextTracksValueMapFunction.Linear;
		...
		/// </summary>
		public PlotOptionsPriceenvelopesSonificationContextTracksActiveWhen ActiveWhen { get; set; }
		private PlotOptionsPriceenvelopesSonificationContextTracksActiveWhen ActiveWhen_DefaultValue { get; set; }
		...
		/// </summary>
		public PlotOptionsPriceenvelopesSonificationContextTracksMapping Mapping { get; set; }
		private PlotOptionsPriceenvelopesSonificationContextTracksMapping Mapping_DefaultValue { get; set; }
		...
		/// </summary>
		public PlotOptionsPriceenvelopesSonificationContextTracksPointGrouping PointGrouping { get; set; }
		private PlotOptionsPriceenvelopesSonificationContextTracksPointGrouping PointGrouping_DefaultValue { get; set; }
		...
		/// </summary>
		public PlotOptionsPriceenvelopesSonificationContextTracksType Type { get; set; }
		private PlotOptionsPriceenvelopesSonificationContextTracksType Type_DefaultValue { get; set; }
		...
		/// </summary>
		public PlotOptionsPriceenvelopesSonificationContextTracksValueMapFunction ValueMapFunction { get; set; }
		private PlotOptionsPriceenvelopesSonificationContextTracksValueMapFunction ValueMapFunction_DefaultValue { get; set; }
