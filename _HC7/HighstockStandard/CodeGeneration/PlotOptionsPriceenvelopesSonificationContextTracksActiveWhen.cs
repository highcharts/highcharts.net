...
{
	public partial class PlotOptionsPriceenvelopesSonificationContextTracksActiveWhen  : BaseObject
	{
		Hashtable h = new Hashtable();

		public PlotOptionsPriceenvelopesSonificationContextTracksActiveWhen()
		{
		}	
