...
{
	public partial class PlotOptionsPriceenvelopesSonificationContextTracksPointGrouping  : BaseObject
	{
		Hashtable h = new Hashtable();

		public PlotOptionsPriceenvelopesSonificationContextTracksPointGrouping()
		{
			Algorithm = Algorithm_DefaultValue = PlotOptionsPriceenvelopesSonificationContextTracksPointGroupingAlgorithm.Minimax;
		...
		/// </summary>
		public PlotOptionsPriceenvelopesSonificationContextTracksPointGroupingAlgorithm Algorithm { get; set; }
		private PlotOptionsPriceenvelopesSonificationContextTracksPointGroupingAlgorithm Algorithm_DefaultValue { get; set; }
