...
{
	public partial class PlotOptionsPriceenvelopesSonificationDefaultSpeechOptionsMappingTremoloSpeed  : BaseObject
	{
		Hashtable h = new Hashtable();

		public PlotOptionsPriceenvelopesSonificationDefaultSpeechOptionsMappingTremoloSpeed()
		{
			MapFunction = MapFunction_DefaultValue = PlotOptionsPriceenvelopesSonificationDefaultSpeechOptionsMappingTremoloSpeedMapFunction.Linear;
			MapTo = MapTo_DefaultValue = "";
			Max = Max_DefaultValue = null;
			Min = Min_DefaultValue = null;
			Value = Value_DefaultValue = null;
			Within = Within_DefaultValue = PlotOptionsPriceenvelopesSonificationDefaultSpeechOptionsMappingTremoloSpeedWithin.Chart;
		...
		/// </summary>
		public PlotOptionsPriceenvelopesSonificationDefaultSpeechOptionsMappingTremoloSpeedMapFunction MapFunction { get; set; }
		private PlotOptionsPriceenvelopesSonificationDefaultSpeechOptionsMappingTremoloSpeedMapFunction MapFunction_DefaultValue { get; set; }
		...
		/// </summary>
		public PlotOptionsPriceenvelopesSonificationDefaultSpeechOptionsMappingTremoloSpeedWithin Within { get; set; }
		private PlotOptionsPriceenvelopesSonificationDefaultSpeechOptionsMappingTremoloSpeedWithin Within_DefaultValue { get; set; }
