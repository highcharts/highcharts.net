...
{
	public partial class PlotOptionsPriceenvelopesSonificationPointGrouping  : BaseObject
	{
		Hashtable h = new Hashtable();

		public PlotOptionsPriceenvelopesSonificationPointGrouping()
		{
			Algorithm = Algorithm_DefaultValue = PlotOptionsPriceenvelopesSonificationPointGroupingAlgorithm.Minimax;
		...
		/// </summary>
		public PlotOptionsPriceenvelopesSonificationPointGroupingAlgorithm Algorithm { get; set; }
		private PlotOptionsPriceenvelopesSonificationPointGroupingAlgorithm Algorithm_DefaultValue { get; set; }
