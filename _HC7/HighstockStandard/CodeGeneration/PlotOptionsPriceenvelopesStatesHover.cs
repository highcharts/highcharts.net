...
{
	public partial class PlotOptionsPriceenvelopesStatesHover  : BaseObject
	{
		public PlotOptionsPriceenvelopesStatesHover()
		{
			Animation = Animation_DefaultValue = new Animation() { Enabled = true };
			AnimationBool = AnimationBool_DefaultValue = null;
			Enabled = Enabled_DefaultValue = true;
			Halo = Halo_DefaultValue = new PlotOptionsPriceenvelopesStatesHoverHalo();
			LineWidth = LineWidth_DefaultValue = null;
			LineWidthPlus = LineWidthPlus_DefaultValue = 1;
			Marker = Marker_DefaultValue = new PlotOptionsPriceenvelopesStatesHoverMarker();
		...
		/// </summary>
		public PlotOptionsPriceenvelopesStatesHoverHalo Halo { get; set; }
		private PlotOptionsPriceenvelopesStatesHoverHalo Halo_DefaultValue { get; set; }
		...
		/// </summary>
		public PlotOptionsPriceenvelopesStatesHoverMarker Marker { get; set; }
		private PlotOptionsPriceenvelopesStatesHoverMarker Marker_DefaultValue { get; set; }
