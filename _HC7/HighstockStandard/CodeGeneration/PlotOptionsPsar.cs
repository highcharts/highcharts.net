...
{
	public partial class PlotOptionsPsar  : BaseObject
	{
		Hashtable h = new Hashtable();

		public PlotOptionsPsar()
		{
			Accessibility = Accessibility_DefaultValue = new PlotOptionsPsarAccessibility();
			AllowPointSelect = AllowPointSelect_DefaultValue = false;
			Animation = Animation_DefaultValue = new Animation() { Enabled = true };
			AnimationBool = AnimationBool_DefaultValue = true;
			AnimationLimit = AnimationLimit_DefaultValue = null;
			BoostBlending = BoostBlending_DefaultValue = PlotOptionsPsarBoostBlending.Undefined;
			...
			Compare = Compare_DefaultValue = PlotOptionsPsarCompare.Percent;
			CompareBase = CompareBase_DefaultValue = PlotOptionsPsarCompareBase.Min;
			...
			Cursor = Cursor_DefaultValue = PlotOptionsPsarCursor.Null;
			Custom = Custom_DefaultValue = new Hashtable();
			DashStyle = DashStyle_DefaultValue = PlotOptionsPsarDashStyle.Null;
			...
			DataSorting = DataSorting_DefaultValue = new PlotOptionsPsarDataSorting();
			...
			LastPrice = LastPrice_DefaultValue = new PlotOptionsPsarLastPrice();
			LastVisiblePrice = LastVisiblePrice_DefaultValue = new PlotOptionsPsarLastVisiblePrice();
			LegendSymbol = LegendSymbol_DefaultValue = PlotOptionsPsarLegendSymbol.Rectangle;
			Linecap = Linecap_DefaultValue = PlotOptionsPsarLinecap.Round;
			LineWidth = LineWidth_DefaultValue = 0;
			LinkedTo = LinkedTo_DefaultValue = "";
			Marker = Marker_DefaultValue = new PlotOptionsPsarMarker();
			NegativeColor = NegativeColor_DefaultValue = "";
			OnPoint = OnPoint_DefaultValue = new PlotOptionsPsarOnPoint();
			...
			Sonification = Sonification_DefaultValue = new PlotOptionsPsarSonification();
			States = States_DefaultValue = new PlotOptionsPsarStates();
			Step = Step_DefaultValue = PlotOptionsPsarStep.Null;
			...
			Zones = Zones_DefaultValue = new List<PlotOptionsPsarZones>();
		...
		/// </summary>
		public PlotOptionsPsarAccessibility Accessibility { get; set; }
		private PlotOptionsPsarAccessibility Accessibility_DefaultValue { get; set; }
		...
		/// </summary>
		public PlotOptionsPsarBoostBlending BoostBlending { get; set; }
		private PlotOptionsPsarBoostBlending BoostBlending_DefaultValue { get; set; }
		...
		/// </summary>
		public PlotOptionsPsarCompare Compare { get; set; }
		private PlotOptionsPsarCompare Compare_DefaultValue { get; set; }
		 

		/// <summary>
		/// When [compare](#plotOptions.series.compare) is `percent`, this optiondictates whether to use 0 or 100 as the base of comparison.
		/// </summary>
		public PlotOptionsPsarCompareBase CompareBase { get; set; }
		private PlotOptionsPsarCompareBase CompareBase_DefaultValue { get; set; }
		...
		/// </summary>
		public PlotOptionsPsarCursor Cursor { get; set; }
		private PlotOptionsPsarCursor Cursor_DefaultValue { get; set; }
		...
		/// </summary>
		public PlotOptionsPsarDashStyle DashStyle { get; set; }
		private PlotOptionsPsarDashStyle DashStyle_DefaultValue { get; set; }
		...
		/// </summary>
		public PlotOptionsPsarDataGrouping DataGrouping { get; set; }
		private PlotOptionsPsarDataGrouping DataGrouping_DefaultValue { get; set; }
		...
		/// </summary>
		public PlotOptionsPsarDataLabels DataLabels { get; set; }
		private PlotOptionsPsarDataLabels DataLabels_DefaultValue { get; set; }
		 

		/// <summary>
		/// Options for the series data sorting.
		/// </summary>
		public PlotOptionsPsarDataSorting DataSorting { get; set; }
		private PlotOptionsPsarDataSorting DataSorting_DefaultValue { get; set; }
		...
		/// </summary>
		public PlotOptionsPsarEvents Events { get; set; }
		private PlotOptionsPsarEvents Events_DefaultValue { get; set; }
		...
		/// </summary>
		public PlotOptionsPsarFindNearestPointBy FindNearestPointBy { get; set; }
		private PlotOptionsPsarFindNearestPointBy FindNearestPointBy_DefaultValue { get; set; }
		...
		/// </summary>
		public PlotOptionsPsarGapUnit GapUnit { get; set; }
		private PlotOptionsPsarGapUnit GapUnit_DefaultValue { get; set; }
		...
		/// </summary>
		public PlotOptionsPsarLabel Label { get; set; }
		private PlotOptionsPsarLabel Label_DefaultValue { get; set; }
		 

		/// <summary>
		/// The line marks the last price from all points.
		/// </summary>
		public PlotOptionsPsarLastPrice LastPrice { get; set; }
		private PlotOptionsPsarLastPrice LastPrice_DefaultValue { get; set; }
		 

		/// <summary>
		/// The line marks the last price from visible range of points.
		/// </summary>
		public PlotOptionsPsarLastVisiblePrice LastVisiblePrice { get; set; }
		private PlotOptionsPsarLastVisiblePrice LastVisiblePrice_DefaultValue { get; set; }
		 

		/// <summary>
		/// What type of legend symbol to render for this series. Can be one of`lineMarker` or `rectangle`.
		/// </summary>
		public PlotOptionsPsarLegendSymbol LegendSymbol { get; set; }
		private PlotOptionsPsarLegendSymbol LegendSymbol_DefaultValue { get; set; }
		 

		/// <summary>
		/// The line cap used for line ends and line joins on the graph.
		/// </summary>
		public PlotOptionsPsarLinecap Linecap { get; set; }
		private PlotOptionsPsarLinecap Linecap_DefaultValue { get; set; }
		...
		/// </summary>
		public PlotOptionsPsarOnPoint OnPoint { get; set; }
		private PlotOptionsPsarOnPoint OnPoint_DefaultValue { get; set; }
		...
		private PlotOptionsPsarPoint Point_DefaultValue { get; set; }
		...
		/// </summary>
		public PlotOptionsPsarSonification Sonification { get; set; }
		private PlotOptionsPsarSonification Sonification_DefaultValue { get; set; }
		...
		/// </summary>
		public PlotOptionsPsarStep Step { get; set; }
		private PlotOptionsPsarStep Step_DefaultValue { get; set; }
		...
		/// </summary>
		public PlotOptionsPsarTooltip Tooltip { get; set; }
		private PlotOptionsPsarTooltip Tooltip_DefaultValue { get; set; }
		...
		/// </summary>
		public List<PlotOptionsPsarZones> Zones { get; set; }
		private List<PlotOptionsPsarZones> Zones_DefaultValue { get; set; }
