...
{
	public partial class PlotOptionsPsarDragDrop  : BaseObject
	{
		public PlotOptionsPsarDragDrop()
		{
			DraggableX = DraggableX_DefaultValue = null;
			DraggableY = DraggableY_DefaultValue = null;
			DragHandle = DragHandle_DefaultValue = new PlotOptionsPsarDragDropDragHandle();
			...
			GuideBox = GuideBox_DefaultValue = new PlotOptionsPsarDragDropGuideBox();
		...
		/// </summary>
		public PlotOptionsPsarDragDropDragHandle DragHandle { get; set; }
		private PlotOptionsPsarDragDropDragHandle DragHandle_DefaultValue { get; set; }
		...
		/// </summary>
		public PlotOptionsPsarDragDropGuideBox GuideBox { get; set; }
		private PlotOptionsPsarDragDropGuideBox GuideBox_DefaultValue { get; set; }
