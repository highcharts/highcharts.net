...
{
	public partial class PlotOptionsPsarDragDropDragHandle  : BaseObject
	{
		public PlotOptionsPsarDragDropDragHandle()
		{
		...
		internal override Hashtable ToHashtable()
		{
			...
			if (PathFormatter != PathFormatter_DefaultValue) { h.Add("pathFormatter",PathFormatter); Highstock.AddFunction("PlotOptionsPsarDragDropDragHandlePathFormatter.pathFormatter", PathFormatter); }  
