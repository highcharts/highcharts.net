...
{
	public partial class PlotOptionsPsarOnPoint  : BaseObject
	{
		Hashtable h = new Hashtable();

		public PlotOptionsPsarOnPoint()
		{
			ConnectorOptions = ConnectorOptions_DefaultValue = new PlotOptionsPsarOnPointConnectorOptions();
			Id = Id_DefaultValue = "";
			Position = Position_DefaultValue = new PlotOptionsPsarOnPointPosition();
		...
		/// </summary>
		public PlotOptionsPsarOnPointConnectorOptions ConnectorOptions { get; set; }
		private PlotOptionsPsarOnPointConnectorOptions ConnectorOptions_DefaultValue { get; set; }
		...
		/// </summary>
		public PlotOptionsPsarOnPointPosition Position { get; set; }
		private PlotOptionsPsarOnPointPosition Position_DefaultValue { get; set; }
