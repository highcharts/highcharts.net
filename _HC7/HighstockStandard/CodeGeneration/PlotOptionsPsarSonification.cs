...
{
	public partial class PlotOptionsPsarSonification  : BaseObject
	{
		Hashtable h = new Hashtable();

		public PlotOptionsPsarSonification()
		{
		}	
		...
		/// </summary>
		public PlotOptionsPsarSonificationContextTracks ContextTracks { get; set; }
		 

		/// <summary>
		/// Default options for all this series' instrument tracks.
		/// </summary>
		public PlotOptionsPsarSonificationDefaultInstrumentOptions DefaultInstrumentOptions { get; set; }
		 

		/// <summary>
		/// Default options for all this series' speech tracks.
		/// </summary>
		public PlotOptionsPsarSonificationDefaultSpeechOptions DefaultSpeechOptions { get; set; }
		...
		/// </summary>
		public PlotOptionsPsarSonificationPointGrouping PointGrouping { get; set; }
		 

		/// <summary>
		/// Tracks for this series.Given as an array of instrument tracks, speech tracks, or a mix of both.
		/// </summary>
		public PlotOptionsPsarSonificationTracks Tracks { get; set; }
