...
{
	public partial class PlotOptionsPsarSonificationContextTracks  : BaseObject
	{
		Hashtable h = new Hashtable();

		public PlotOptionsPsarSonificationContextTracks()
		{
			ActiveWhen = ActiveWhen_DefaultValue = new PlotOptionsPsarSonificationContextTracksActiveWhen();
			Instrument = Instrument_DefaultValue = null;
			InstrumentString = InstrumentString_DefaultValue = "null";
			Mapping = Mapping_DefaultValue = new PlotOptionsPsarSonificationContextTracksMapping();
			MidiName = MidiName_DefaultValue = "";
			PointGrouping = PointGrouping_DefaultValue = new PlotOptionsPsarSonificationContextTracksPointGrouping();
			...
			Type = Type_DefaultValue = PlotOptionsPsarSonificationContextTracksType.Instrument;
			ValueInterval = ValueInterval_DefaultValue = null;
			ValueMapFunction = ValueMapFunction_DefaultValue = PlotOptionsPsarSonificationContextTracksValueMapFunction.Linear;
		...
		/// </summary>
		public PlotOptionsPsarSonificationContextTracksActiveWhen ActiveWhen { get; set; }
		private PlotOptionsPsarSonificationContextTracksActiveWhen ActiveWhen_DefaultValue { get; set; }
		...
		/// </summary>
		public PlotOptionsPsarSonificationContextTracksMapping Mapping { get; set; }
		private PlotOptionsPsarSonificationContextTracksMapping Mapping_DefaultValue { get; set; }
		...
		/// </summary>
		public PlotOptionsPsarSonificationContextTracksPointGrouping PointGrouping { get; set; }
		private PlotOptionsPsarSonificationContextTracksPointGrouping PointGrouping_DefaultValue { get; set; }
		...
		/// </summary>
		public PlotOptionsPsarSonificationContextTracksType Type { get; set; }
		private PlotOptionsPsarSonificationContextTracksType Type_DefaultValue { get; set; }
		...
		/// </summary>
		public PlotOptionsPsarSonificationContextTracksValueMapFunction ValueMapFunction { get; set; }
		private PlotOptionsPsarSonificationContextTracksValueMapFunction ValueMapFunction_DefaultValue { get; set; }
