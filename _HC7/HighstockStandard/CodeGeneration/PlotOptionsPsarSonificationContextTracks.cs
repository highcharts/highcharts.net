...
namespace Highsoft.Web.Mvc.Stocks
{
	public partial class PlotOptionsPsarSonificationContextTracks  : BaseObject
	{
		...
		internal override Hashtable ToHashtable(Highstock highstock)
		{
			...
			if (Type != PlotOptionsPsarSonificationContextTracksType.Null) h.Add("type", highstock.FirstCharacterToLower(Type.ToString()));
			if (ValueInterval != null) h.Add("valueInterval",ValueInterval);
			if (ValueMapFunction != PlotOptionsPsarSonificationContextTracksValueMapFunction.Null) h.Add("valueMapFunction", highstock.FirstCharacterToLower(ValueMapFunction.ToString()));
