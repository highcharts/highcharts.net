...
{
	public partial class PlotOptionsPsarSonificationContextTracksMapping  : BaseObject
	{
		Hashtable h = new Hashtable();

		public PlotOptionsPsarSonificationContextTracksMapping()
		{
			Frequency = Frequency_DefaultValue = new PlotOptionsPsarSonificationContextTracksMappingFrequency();
			GapBetweenNotes = GapBetweenNotes_DefaultValue = new PlotOptionsPsarSonificationContextTracksMappingGapBetweenNotes();
			Highpass = Highpass_DefaultValue = new PlotOptionsPsarSonificationContextTracksMappingHighpass();
			Lowpass = Lowpass_DefaultValue = new PlotOptionsPsarSonificationContextTracksMappingLowpass();
			NoteDuration = NoteDuration_DefaultValue = new PlotOptionsPsarSonificationContextTracksMappingNoteDuration();
			Pan = Pan_DefaultValue = new PlotOptionsPsarSonificationContextTracksMappingPan();
			Pitch = Pitch_DefaultValue = new PlotOptionsPsarSonificationContextTracksMappingPitch();
			PitchString = PitchString_DefaultValue = "null";
			PitchNumber = PitchNumber_DefaultValue = null;
			PlayDelay = PlayDelay_DefaultValue = new PlotOptionsPsarSonificationContextTracksMappingPlayDelay();
			Time = Time_DefaultValue = new PlotOptionsPsarSonificationContextTracksMappingTime();
			TimeString = TimeString_DefaultValue = "null";
			TimeNumber = TimeNumber_DefaultValue = null;
			Tremolo = Tremolo_DefaultValue = new PlotOptionsPsarSonificationContextTracksMappingTremolo();
			Volume = Volume_DefaultValue = new PlotOptionsPsarSonificationContextTracksMappingVolume();
		...
		/// </summary>
		public PlotOptionsPsarSonificationContextTracksMappingFrequency Frequency { get; set; }
		private PlotOptionsPsarSonificationContextTracksMappingFrequency Frequency_DefaultValue { get; set; }
		...
		/// </summary>
		public PlotOptionsPsarSonificationContextTracksMappingGapBetweenNotes GapBetweenNotes { get; set; }
		private PlotOptionsPsarSonificationContextTracksMappingGapBetweenNotes GapBetweenNotes_DefaultValue { get; set; }
		...
		/// </summary>
		public PlotOptionsPsarSonificationContextTracksMappingHighpass Highpass { get; set; }
		private PlotOptionsPsarSonificationContextTracksMappingHighpass Highpass_DefaultValue { get; set; }
		...
		/// </summary>
		public PlotOptionsPsarSonificationContextTracksMappingLowpass Lowpass { get; set; }
		private PlotOptionsPsarSonificationContextTracksMappingLowpass Lowpass_DefaultValue { get; set; }
		...
		/// </summary>
		public PlotOptionsPsarSonificationContextTracksMappingNoteDuration NoteDuration { get; set; }
		private PlotOptionsPsarSonificationContextTracksMappingNoteDuration NoteDuration_DefaultValue { get; set; }
		...
		/// </summary>
		public PlotOptionsPsarSonificationContextTracksMappingPan Pan { get; set; }
		private PlotOptionsPsarSonificationContextTracksMappingPan Pan_DefaultValue { get; set; }
		...
		/// </summary>
		public PlotOptionsPsarSonificationContextTracksMappingPitch Pitch { get; set; }
		private PlotOptionsPsarSonificationContextTracksMappingPitch Pitch_DefaultValue { get; set; }
		...
		/// </summary>
		public PlotOptionsPsarSonificationContextTracksMappingPlayDelay PlayDelay { get; set; }
		private PlotOptionsPsarSonificationContextTracksMappingPlayDelay PlayDelay_DefaultValue { get; set; }
		...
		/// </summary>
		public PlotOptionsPsarSonificationContextTracksMappingTime Time { get; set; }
		private PlotOptionsPsarSonificationContextTracksMappingTime Time_DefaultValue { get; set; }
		...
		/// </summary>
		public PlotOptionsPsarSonificationContextTracksMappingTremolo Tremolo { get; set; }
		private PlotOptionsPsarSonificationContextTracksMappingTremolo Tremolo_DefaultValue { get; set; }
		 

		/// <summary>
		/// The volume of notes, from 0 to 1.
		/// </summary>
		public PlotOptionsPsarSonificationContextTracksMappingVolume Volume { get; set; }
		private PlotOptionsPsarSonificationContextTracksMappingVolume Volume_DefaultValue { get; set; }
