...
{
	public partial class PlotOptionsPsarSonificationContextTracksMappingNoteDuration  : BaseObject
	{
		Hashtable h = new Hashtable();

		public PlotOptionsPsarSonificationContextTracksMappingNoteDuration()
		{
			MapFunction = MapFunction_DefaultValue = PlotOptionsPsarSonificationContextTracksMappingNoteDurationMapFunction.Linear;
			MapTo = MapTo_DefaultValue = "";
			Max = Max_DefaultValue = null;
			Min = Min_DefaultValue = null;
			Value = Value_DefaultValue = null;
			Within = Within_DefaultValue = PlotOptionsPsarSonificationContextTracksMappingNoteDurationWithin.Chart;
		...
		/// </summary>
		public PlotOptionsPsarSonificationContextTracksMappingNoteDurationMapFunction MapFunction { get; set; }
		private PlotOptionsPsarSonificationContextTracksMappingNoteDurationMapFunction MapFunction_DefaultValue { get; set; }
		...
		/// </summary>
		public PlotOptionsPsarSonificationContextTracksMappingNoteDurationWithin Within { get; set; }
		private PlotOptionsPsarSonificationContextTracksMappingNoteDurationWithin Within_DefaultValue { get; set; }
