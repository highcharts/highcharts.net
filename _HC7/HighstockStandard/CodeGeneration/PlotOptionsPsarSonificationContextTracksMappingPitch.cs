...
{
	public partial class PlotOptionsPsarSonificationContextTracksMappingPitch  : BaseObject
	{
		Hashtable h = new Hashtable();

		public PlotOptionsPsarSonificationContextTracksMappingPitch()
		{
			MapFunction = MapFunction_DefaultValue = PlotOptionsPsarSonificationContextTracksMappingPitchMapFunction.Linear;
		...
		/// </summary>
		public PlotOptionsPsarSonificationContextTracksMappingPitchMapFunction MapFunction { get; set; }
		private PlotOptionsPsarSonificationContextTracksMappingPitchMapFunction MapFunction_DefaultValue { get; set; }
