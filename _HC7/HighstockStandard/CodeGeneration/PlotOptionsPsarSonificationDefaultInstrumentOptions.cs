...
{
	public partial class PlotOptionsPsarSonificationDefaultInstrumentOptions  : BaseObject
	{
		Hashtable h = new Hashtable();

		public PlotOptionsPsarSonificationDefaultInstrumentOptions()
		{
			ActiveWhen = ActiveWhen_DefaultValue = new PlotOptionsPsarSonificationDefaultInstrumentOptionsActiveWhen();
			Instrument = Instrument_DefaultValue = null;
			InstrumentString = InstrumentString_DefaultValue = "null";
			Mapping = Mapping_DefaultValue = new PlotOptionsPsarSonificationDefaultInstrumentOptionsMapping();
			MidiName = MidiName_DefaultValue = "";
			PointGrouping = PointGrouping_DefaultValue = new PlotOptionsPsarSonificationDefaultInstrumentOptionsPointGrouping();
			RoundToMusicalNotes = RoundToMusicalNotes_DefaultValue = true;
			ShowPlayMarker = ShowPlayMarker_DefaultValue = true;
			Type = Type_DefaultValue = PlotOptionsPsarSonificationDefaultInstrumentOptionsType.Instrument;
		...
		/// </summary>
		public PlotOptionsPsarSonificationDefaultInstrumentOptionsActiveWhen ActiveWhen { get; set; }
		private PlotOptionsPsarSonificationDefaultInstrumentOptionsActiveWhen ActiveWhen_DefaultValue { get; set; }
		...
		/// </summary>
		public PlotOptionsPsarSonificationDefaultInstrumentOptionsMapping Mapping { get; set; }
		private PlotOptionsPsarSonificationDefaultInstrumentOptionsMapping Mapping_DefaultValue { get; set; }
		...
		/// </summary>
		public PlotOptionsPsarSonificationDefaultInstrumentOptionsPointGrouping PointGrouping { get; set; }
		private PlotOptionsPsarSonificationDefaultInstrumentOptionsPointGrouping PointGrouping_DefaultValue { get; set; }
		...
		/// </summary>
		public PlotOptionsPsarSonificationDefaultInstrumentOptionsType Type { get; set; }
		private PlotOptionsPsarSonificationDefaultInstrumentOptionsType Type_DefaultValue { get; set; }
