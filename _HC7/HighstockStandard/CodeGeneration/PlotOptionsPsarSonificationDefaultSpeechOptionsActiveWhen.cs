...
{
	public partial class PlotOptionsPsarSonificationDefaultSpeechOptionsActiveWhen  : BaseObject
	{
		Hashtable h = new Hashtable();

		public PlotOptionsPsarSonificationDefaultSpeechOptionsActiveWhen()
		{
		}	
