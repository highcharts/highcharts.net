...
{
	public partial class PlotOptionsPsarSonificationPointGrouping  : BaseObject
	{
		Hashtable h = new Hashtable();

		public PlotOptionsPsarSonificationPointGrouping()
		{
			Algorithm = Algorithm_DefaultValue = PlotOptionsPsarSonificationPointGroupingAlgorithm.Minimax;
		...
		/// </summary>
		public PlotOptionsPsarSonificationPointGroupingAlgorithm Algorithm { get; set; }
		private PlotOptionsPsarSonificationPointGroupingAlgorithm Algorithm_DefaultValue { get; set; }
