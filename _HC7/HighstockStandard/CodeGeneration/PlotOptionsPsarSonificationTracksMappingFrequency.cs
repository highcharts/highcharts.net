...
{
	public partial class PlotOptionsPsarSonificationTracksMappingFrequency  : BaseObject
	{
		Hashtable h = new Hashtable();

		public PlotOptionsPsarSonificationTracksMappingFrequency()
		{
			MapFunction = MapFunction_DefaultValue = PlotOptionsPsarSonificationTracksMappingFrequencyMapFunction.Linear;
			MapTo = MapTo_DefaultValue = "";
			Max = Max_DefaultValue = null;
			Min = Min_DefaultValue = null;
			Value = Value_DefaultValue = null;
			Within = Within_DefaultValue = PlotOptionsPsarSonificationTracksMappingFrequencyWithin.Chart;
		...
		/// </summary>
		public PlotOptionsPsarSonificationTracksMappingFrequencyMapFunction MapFunction { get; set; }
		private PlotOptionsPsarSonificationTracksMappingFrequencyMapFunction MapFunction_DefaultValue { get; set; }
		...
		/// </summary>
		public PlotOptionsPsarSonificationTracksMappingFrequencyWithin Within { get; set; }
		private PlotOptionsPsarSonificationTracksMappingFrequencyWithin Within_DefaultValue { get; set; }
