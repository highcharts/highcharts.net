...
{
	public partial class PlotOptionsPsarSonificationTracksMappingNoteDuration  : BaseObject
	{
		Hashtable h = new Hashtable();

		public PlotOptionsPsarSonificationTracksMappingNoteDuration()
		{
			MapFunction = MapFunction_DefaultValue = PlotOptionsPsarSonificationTracksMappingNoteDurationMapFunction.Linear;
			MapTo = MapTo_DefaultValue = "";
			Max = Max_DefaultValue = null;
			Min = Min_DefaultValue = null;
			Value = Value_DefaultValue = null;
			Within = Within_DefaultValue = PlotOptionsPsarSonificationTracksMappingNoteDurationWithin.Chart;
		...
		/// </summary>
		public PlotOptionsPsarSonificationTracksMappingNoteDurationMapFunction MapFunction { get; set; }
		private PlotOptionsPsarSonificationTracksMappingNoteDurationMapFunction MapFunction_DefaultValue { get; set; }
		...
		/// </summary>
		public PlotOptionsPsarSonificationTracksMappingNoteDurationWithin Within { get; set; }
		private PlotOptionsPsarSonificationTracksMappingNoteDurationWithin Within_DefaultValue { get; set; }
