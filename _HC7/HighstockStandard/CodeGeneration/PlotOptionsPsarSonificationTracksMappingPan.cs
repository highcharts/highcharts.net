...
{
	public partial class PlotOptionsPsarSonificationTracksMappingPan  : BaseObject
	{
		Hashtable h = new Hashtable();

		public PlotOptionsPsarSonificationTracksMappingPan()
		{
			MapFunction = MapFunction_DefaultValue = PlotOptionsPsarSonificationTracksMappingPanMapFunction.Linear;
			MapTo = MapTo_DefaultValue = "";
			Max = Max_DefaultValue = null;
			Min = Min_DefaultValue = null;
			Value = Value_DefaultValue = null;
			Within = Within_DefaultValue = PlotOptionsPsarSonificationTracksMappingPanWithin.Chart;
		...
		/// </summary>
		public PlotOptionsPsarSonificationTracksMappingPanMapFunction MapFunction { get; set; }
		private PlotOptionsPsarSonificationTracksMappingPanMapFunction MapFunction_DefaultValue { get; set; }
		...
		/// </summary>
		public PlotOptionsPsarSonificationTracksMappingPanWithin Within { get; set; }
		private PlotOptionsPsarSonificationTracksMappingPanWithin Within_DefaultValue { get; set; }
