...
{
	public partial class PlotOptionsPsarSonificationTracksMappingPitch  : BaseObject
	{
		Hashtable h = new Hashtable();

		public PlotOptionsPsarSonificationTracksMappingPitch()
		{
			MapFunction = MapFunction_DefaultValue = PlotOptionsPsarSonificationTracksMappingPitchMapFunction.Linear;
		...
		/// </summary>
		public PlotOptionsPsarSonificationTracksMappingPitchMapFunction MapFunction { get; set; }
		private PlotOptionsPsarSonificationTracksMappingPitchMapFunction MapFunction_DefaultValue { get; set; }
