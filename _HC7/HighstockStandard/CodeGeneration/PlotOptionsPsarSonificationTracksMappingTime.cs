...
{
	public partial class PlotOptionsPsarSonificationTracksMappingTime  : BaseObject
	{
		Hashtable h = new Hashtable();

		public PlotOptionsPsarSonificationTracksMappingTime()
		{
			MapFunction = MapFunction_DefaultValue = PlotOptionsPsarSonificationTracksMappingTimeMapFunction.Linear;
			MapTo = MapTo_DefaultValue = "";
			Max = Max_DefaultValue = null;
			Min = Min_DefaultValue = null;
			Value = Value_DefaultValue = null;
			Within = Within_DefaultValue = PlotOptionsPsarSonificationTracksMappingTimeWithin.Chart;
		...
		/// </summary>
		public PlotOptionsPsarSonificationTracksMappingTimeMapFunction MapFunction { get; set; }
		private PlotOptionsPsarSonificationTracksMappingTimeMapFunction MapFunction_DefaultValue { get; set; }
		...
		/// </summary>
		public PlotOptionsPsarSonificationTracksMappingTimeWithin Within { get; set; }
		private PlotOptionsPsarSonificationTracksMappingTimeWithin Within_DefaultValue { get; set; }
