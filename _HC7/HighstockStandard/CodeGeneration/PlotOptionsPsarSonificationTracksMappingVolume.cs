...
{
	public partial class PlotOptionsPsarSonificationTracksMappingVolume  : BaseObject
	{
		Hashtable h = new Hashtable();

		public PlotOptionsPsarSonificationTracksMappingVolume()
		{
			MapFunction = MapFunction_DefaultValue = PlotOptionsPsarSonificationTracksMappingVolumeMapFunction.Linear;
			MapTo = MapTo_DefaultValue = "";
			Max = Max_DefaultValue = null;
			Min = Min_DefaultValue = null;
			Value = Value_DefaultValue = null;
			Within = Within_DefaultValue = PlotOptionsPsarSonificationTracksMappingVolumeWithin.Chart;
		...
		/// </summary>
		public PlotOptionsPsarSonificationTracksMappingVolumeMapFunction MapFunction { get; set; }
		private PlotOptionsPsarSonificationTracksMappingVolumeMapFunction MapFunction_DefaultValue { get; set; }
		...
		/// </summary>
		public PlotOptionsPsarSonificationTracksMappingVolumeWithin Within { get; set; }
		private PlotOptionsPsarSonificationTracksMappingVolumeWithin Within_DefaultValue { get; set; }
