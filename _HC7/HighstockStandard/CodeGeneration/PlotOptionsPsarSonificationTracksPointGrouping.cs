...
{
	public partial class PlotOptionsPsarSonificationTracksPointGrouping  : BaseObject
	{
		Hashtable h = new Hashtable();

		public PlotOptionsPsarSonificationTracksPointGrouping()
		{
			Algorithm = Algorithm_DefaultValue = PlotOptionsPsarSonificationTracksPointGroupingAlgorithm.Minimax;
		...
		/// </summary>
		public PlotOptionsPsarSonificationTracksPointGroupingAlgorithm Algorithm { get; set; }
		private PlotOptionsPsarSonificationTracksPointGroupingAlgorithm Algorithm_DefaultValue { get; set; }
