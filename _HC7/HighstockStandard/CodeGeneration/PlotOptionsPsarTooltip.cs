...
{
	public partial class PlotOptionsPsarTooltip  : BaseObject
	{
		public PlotOptionsPsarTooltip()
		{
			...
			HeaderShape = HeaderShape_DefaultValue = PlotOptionsPsarTooltipHeaderShape.Callout;
		...
		/// </summary>
		public PlotOptionsPsarTooltipHeaderShape HeaderShape { get; set; }
		private PlotOptionsPsarTooltipHeaderShape HeaderShape_DefaultValue { get; set; }
		...
		internal override Hashtable ToHashtable()
		{
			...
			if (NullFormatter != NullFormatter_DefaultValue) { h.Add("nullFormatter",NullFormatter); Highstock.AddFunction("PlotOptionsPsarTooltipNullFormatter.nullFormatter", NullFormatter); }  
			if (Outside != Outside_DefaultValue) h.Add("outside",Outside);
			if (Padding != Padding_DefaultValue) h.Add("padding",Padding);
			if (PointFormat != PointFormat_DefaultValue) h.Add("pointFormat",PointFormat);
			if (PointFormatter != PointFormatter_DefaultValue) { h.Add("pointFormatter",PointFormatter); Highstock.AddFunction("PlotOptionsPsarTooltipPointFormatter.pointFormatter", PointFormatter); }  
