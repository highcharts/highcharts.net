...
{
	public partial class PlotOptionsRoc  : BaseObject
	{
		Hashtable h = new Hashtable();

		public PlotOptionsRoc()
		{
			Accessibility = Accessibility_DefaultValue = new PlotOptionsRocAccessibility();
			AllowPointSelect = AllowPointSelect_DefaultValue = false;
			Animation = Animation_DefaultValue = new Animation() { Enabled = true };
			AnimationBool = AnimationBool_DefaultValue = true;
			AnimationLimit = AnimationLimit_DefaultValue = null;
			BoostBlending = BoostBlending_DefaultValue = PlotOptionsRocBoostBlending.Undefined;
			...
			Compare = Compare_DefaultValue = PlotOptionsRocCompare.Percent;
			CompareBase = CompareBase_DefaultValue = PlotOptionsRocCompareBase.Min;
			...
			Cursor = Cursor_DefaultValue = PlotOptionsRocCursor.Null;
			Custom = Custom_DefaultValue = new Hashtable();
			DashStyle = DashStyle_DefaultValue = PlotOptionsRocDashStyle.Null;
			DataGrouping = DataGrouping_DefaultValue = new PlotOptionsRocDataGrouping();
			DataLabels = DataLabels_DefaultValue = new PlotOptionsRocDataLabels();
			DataSorting = DataSorting_DefaultValue = new PlotOptionsRocDataSorting();
			Description = Description_DefaultValue = "";
			EnableMouseTracking = EnableMouseTracking_DefaultValue = true;
			Events = Events_DefaultValue = new PlotOptionsRocEvents();
			FindNearestPointBy = FindNearestPointBy_DefaultValue = PlotOptionsRocFindNearestPointBy.X;
			GapSize = GapSize_DefaultValue = 0;
			GapUnit = GapUnit_DefaultValue = PlotOptionsRocGapUnit.Relative;
			GetExtremesFromAll = GetExtremesFromAll_DefaultValue = false;
			IncludeInDataExport = IncludeInDataExport_DefaultValue = null;
			Label = Label_DefaultValue = new PlotOptionsRocLabel();
			LastPrice = LastPrice_DefaultValue = new PlotOptionsRocLastPrice();
			LastVisiblePrice = LastVisiblePrice_DefaultValue = new PlotOptionsRocLastVisiblePrice();
			LegendSymbol = LegendSymbol_DefaultValue = PlotOptionsRocLegendSymbol.Rectangle;
			Linecap = Linecap_DefaultValue = PlotOptionsRocLinecap.Round;
			LineWidth = LineWidth_DefaultValue = 1;
			LinkedTo = LinkedTo_DefaultValue = "";
			Marker = Marker_DefaultValue = new PlotOptionsRocMarker();
			NegativeColor = NegativeColor_DefaultValue = "";
			OnPoint = OnPoint_DefaultValue = new PlotOptionsRocOnPoint();
			...
			Sonification = Sonification_DefaultValue = new PlotOptionsRocSonification();
			States = States_DefaultValue = new PlotOptionsRocStates();
			Step = Step_DefaultValue = PlotOptionsRocStep.Null;
			...
			Zones = Zones_DefaultValue = new List<PlotOptionsRocZones>();
		...
		/// </summary>
		public PlotOptionsRocAccessibility Accessibility { get; set; }
		private PlotOptionsRocAccessibility Accessibility_DefaultValue { get; set; }
		...
		/// </summary>
		public PlotOptionsRocBoostBlending BoostBlending { get; set; }
		private PlotOptionsRocBoostBlending BoostBlending_DefaultValue { get; set; }
		...
		/// </summary>
		public PlotOptionsRocCompare Compare { get; set; }
		private PlotOptionsRocCompare Compare_DefaultValue { get; set; }
		 

		/// <summary>
		/// When [compare](#plotOptions.series.compare) is `percent`, this optiondictates whether to use 0 or 100 as the base of comparison.
		/// </summary>
		public PlotOptionsRocCompareBase CompareBase { get; set; }
		private PlotOptionsRocCompareBase CompareBase_DefaultValue { get; set; }
		...
		/// </summary>
		public PlotOptionsRocCursor Cursor { get; set; }
		private PlotOptionsRocCursor Cursor_DefaultValue { get; set; }
		...
		/// </summary>
		public PlotOptionsRocDashStyle DashStyle { get; set; }
		private PlotOptionsRocDashStyle DashStyle_DefaultValue { get; set; }
		...
		/// </summary>
		public PlotOptionsRocDataLabels DataLabels { get; set; }
		private PlotOptionsRocDataLabels DataLabels_DefaultValue { get; set; }
		 

		/// <summary>
		/// Options for the series data sorting.
		/// </summary>
		public PlotOptionsRocDataSorting DataSorting { get; set; }
		private PlotOptionsRocDataSorting DataSorting_DefaultValue { get; set; }
		...
		/// </summary>
		public PlotOptionsRocEvents Events { get; set; }
		private PlotOptionsRocEvents Events_DefaultValue { get; set; }
		...
		/// </summary>
		public PlotOptionsRocFindNearestPointBy FindNearestPointBy { get; set; }
		private PlotOptionsRocFindNearestPointBy FindNearestPointBy_DefaultValue { get; set; }
		...
		/// </summary>
		public PlotOptionsRocGapUnit GapUnit { get; set; }
		private PlotOptionsRocGapUnit GapUnit_DefaultValue { get; set; }
		...
		/// </summary>
		public PlotOptionsRocLabel Label { get; set; }
		private PlotOptionsRocLabel Label_DefaultValue { get; set; }
		 

		/// <summary>
		/// The line marks the last price from all points.
		/// </summary>
		public PlotOptionsRocLastPrice LastPrice { get; set; }
		private PlotOptionsRocLastPrice LastPrice_DefaultValue { get; set; }
		 

		/// <summary>
		/// The line marks the last price from visible range of points.
		/// </summary>
		public PlotOptionsRocLastVisiblePrice LastVisiblePrice { get; set; }
		private PlotOptionsRocLastVisiblePrice LastVisiblePrice_DefaultValue { get; set; }
		 

		/// <summary>
		/// What type of legend symbol to render for this series. Can be one of`lineMarker` or `rectangle`.
		/// </summary>
		public PlotOptionsRocLegendSymbol LegendSymbol { get; set; }
		private PlotOptionsRocLegendSymbol LegendSymbol_DefaultValue { get; set; }
		 

		/// <summary>
		/// The line cap used for line ends and line joins on the graph.
		/// </summary>
		public PlotOptionsRocLinecap Linecap { get; set; }
		private PlotOptionsRocLinecap Linecap_DefaultValue { get; set; }
		...
		/// </summary>
		public PlotOptionsRocOnPoint OnPoint { get; set; }
		private PlotOptionsRocOnPoint OnPoint_DefaultValue { get; set; }
		...
		/// </summary>
		public PlotOptionsRocPoint Point { get; set; }
		private PlotOptionsRocPoint Point_DefaultValue { get; set; }
		...
		/// </summary>
		public PlotOptionsRocSonification Sonification { get; set; }
		private PlotOptionsRocSonification Sonification_DefaultValue { get; set; }
		 

		/// <summary>
		/// 
		/// </summary>
		public PlotOptionsRocStates States { get; set; }
		private PlotOptionsRocStates States_DefaultValue { get; set; }
		 

		/// <summary>
		/// Whether to apply steps to the line. Possible values are `left`,`center` and `right`.
		/// </summary>
		public PlotOptionsRocStep Step { get; set; }
		private PlotOptionsRocStep Step_DefaultValue { get; set; }
		...
		/// </summary>
		public PlotOptionsRocTooltip Tooltip { get; set; }
		private PlotOptionsRocTooltip Tooltip_DefaultValue { get; set; }
		...
		/// </summary>
		public List<PlotOptionsRocZones> Zones { get; set; }
		private List<PlotOptionsRocZones> Zones_DefaultValue { get; set; }
