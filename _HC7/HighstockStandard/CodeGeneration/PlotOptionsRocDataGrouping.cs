...
namespace Highsoft.Web.Mvc.Stocks
{
	public partial class PlotOptionsRocDataGrouping  : BaseObject
	{
		...
		internal override Hashtable ToHashtable()
		{
			...
			if (Approximation != Approximation_DefaultValue) { h.Add("approximation",Approximation); Highstock.AddFunction("PlotOptionsRocDataGroupingApproximation.approximation", Approximation); }  
