...
{
	public partial class PlotOptionsRocDragDropDragHandle  : BaseObject
	{
		public PlotOptionsRocDragDropDragHandle()
		{
		...
		internal override Hashtable ToHashtable()
		{
			...
			if (PathFormatter != PathFormatter_DefaultValue) { h.Add("pathFormatter",PathFormatter); Highstock.AddFunction("PlotOptionsRocDragDropDragHandlePathFormatter.pathFormatter", PathFormatter); }  
