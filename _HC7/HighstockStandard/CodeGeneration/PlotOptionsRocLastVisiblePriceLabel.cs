...
{
	public partial class PlotOptionsRocLastVisiblePriceLabel  : BaseObject
	{
		Hashtable h = new Hashtable();

		public PlotOptionsRocLastVisiblePriceLabel()
		{
			Align = Align_DefaultValue = PlotOptionsRocLastVisiblePriceLabelAlign.Null;
		...
		/// 
		/// </summary>
		public PlotOptionsRocLastVisiblePriceLabelAlign Align { get; set; }
		private PlotOptionsRocLastVisiblePriceLabelAlign Align_DefaultValue { get; set; }
