...
namespace Highsoft.Web.Mvc.Stocks
{
	public partial class PlotOptionsRocMarkerStates  : BaseObject
	{
		public PlotOptionsRocMarkerStates()
		{
			...
			Inactive = Inactive_DefaultValue = new PlotOptionsRocMarkerStatesInactive();
			Normal = Normal_DefaultValue = new PlotOptionsRocMarkerStatesNormal();
		...
		/// 
		/// </summary>
		public PlotOptionsRocMarkerStatesInactive Inactive { get; set; }
		private PlotOptionsRocMarkerStatesInactive Inactive_DefaultValue { get; set; }
		 

		/// <summary>
		/// The normal state of a single point marker. Currently onlyused for setting animation when returning to normal statefrom hover.
		/// </summary>
		public PlotOptionsRocMarkerStatesNormal Normal { get; set; }
		private PlotOptionsRocMarkerStatesNormal Normal_DefaultValue { get; set; }
