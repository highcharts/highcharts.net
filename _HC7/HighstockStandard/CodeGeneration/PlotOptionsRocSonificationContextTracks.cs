...
{
	public partial class PlotOptionsRocSonificationContextTracks  : BaseObject
	{
		Hashtable h = new Hashtable();

		public PlotOptionsRocSonificationContextTracks()
		{
			ActiveWhen = ActiveWhen_DefaultValue = new PlotOptionsRocSonificationContextTracksActiveWhen();
			Instrument = Instrument_DefaultValue = null;
			InstrumentString = InstrumentString_DefaultValue = "null";
			Mapping = Mapping_DefaultValue = new PlotOptionsRocSonificationContextTracksMapping();
			MidiName = MidiName_DefaultValue = "";
			PointGrouping = PointGrouping_DefaultValue = new PlotOptionsRocSonificationContextTracksPointGrouping();
			...
			Type = Type_DefaultValue = PlotOptionsRocSonificationContextTracksType.Instrument;
			ValueInterval = ValueInterval_DefaultValue = null;
			ValueMapFunction = ValueMapFunction_DefaultValue = PlotOptionsRocSonificationContextTracksValueMapFunction.Linear;
		...
		/// </summary>
		public PlotOptionsRocSonificationContextTracksActiveWhen ActiveWhen { get; set; }
		private PlotOptionsRocSonificationContextTracksActiveWhen ActiveWhen_DefaultValue { get; set; }
		...
		/// </summary>
		public PlotOptionsRocSonificationContextTracksMapping Mapping { get; set; }
		private PlotOptionsRocSonificationContextTracksMapping Mapping_DefaultValue { get; set; }
		...
		/// </summary>
		public PlotOptionsRocSonificationContextTracksPointGrouping PointGrouping { get; set; }
		private PlotOptionsRocSonificationContextTracksPointGrouping PointGrouping_DefaultValue { get; set; }
		...
		/// </summary>
		public PlotOptionsRocSonificationContextTracksType Type { get; set; }
		private PlotOptionsRocSonificationContextTracksType Type_DefaultValue { get; set; }
		...
		/// </summary>
		public PlotOptionsRocSonificationContextTracksValueMapFunction ValueMapFunction { get; set; }
		private PlotOptionsRocSonificationContextTracksValueMapFunction ValueMapFunction_DefaultValue { get; set; }
