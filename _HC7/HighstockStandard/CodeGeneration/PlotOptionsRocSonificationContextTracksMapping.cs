...
{
	public partial class PlotOptionsRocSonificationContextTracksMapping  : BaseObject
	{
		Hashtable h = new Hashtable();

		public PlotOptionsRocSonificationContextTracksMapping()
		{
			Frequency = Frequency_DefaultValue = new PlotOptionsRocSonificationContextTracksMappingFrequency();
			GapBetweenNotes = GapBetweenNotes_DefaultValue = new PlotOptionsRocSonificationContextTracksMappingGapBetweenNotes();
			Highpass = Highpass_DefaultValue = new PlotOptionsRocSonificationContextTracksMappingHighpass();
			Lowpass = Lowpass_DefaultValue = new PlotOptionsRocSonificationContextTracksMappingLowpass();
			NoteDuration = NoteDuration_DefaultValue = new PlotOptionsRocSonificationContextTracksMappingNoteDuration();
			Pan = Pan_DefaultValue = new PlotOptionsRocSonificationContextTracksMappingPan();
			Pitch = Pitch_DefaultValue = new PlotOptionsRocSonificationContextTracksMappingPitch();
			PitchString = PitchString_DefaultValue = "null";
			PitchNumber = PitchNumber_DefaultValue = null;
			PlayDelay = PlayDelay_DefaultValue = new PlotOptionsRocSonificationContextTracksMappingPlayDelay();
			Time = Time_DefaultValue = new PlotOptionsRocSonificationContextTracksMappingTime();
			TimeString = TimeString_DefaultValue = "null";
			TimeNumber = TimeNumber_DefaultValue = null;
			Tremolo = Tremolo_DefaultValue = new PlotOptionsRocSonificationContextTracksMappingTremolo();
			Volume = Volume_DefaultValue = new PlotOptionsRocSonificationContextTracksMappingVolume();
		...
		/// </summary>
		public PlotOptionsRocSonificationContextTracksMappingFrequency Frequency { get; set; }
		private PlotOptionsRocSonificationContextTracksMappingFrequency Frequency_DefaultValue { get; set; }
		...
		/// </summary>
		public PlotOptionsRocSonificationContextTracksMappingGapBetweenNotes GapBetweenNotes { get; set; }
		private PlotOptionsRocSonificationContextTracksMappingGapBetweenNotes GapBetweenNotes_DefaultValue { get; set; }
		...
		/// </summary>
		public PlotOptionsRocSonificationContextTracksMappingHighpass Highpass { get; set; }
		private PlotOptionsRocSonificationContextTracksMappingHighpass Highpass_DefaultValue { get; set; }
		...
		/// </summary>
		public PlotOptionsRocSonificationContextTracksMappingLowpass Lowpass { get; set; }
		private PlotOptionsRocSonificationContextTracksMappingLowpass Lowpass_DefaultValue { get; set; }
		...
		/// </summary>
		public PlotOptionsRocSonificationContextTracksMappingNoteDuration NoteDuration { get; set; }
		private PlotOptionsRocSonificationContextTracksMappingNoteDuration NoteDuration_DefaultValue { get; set; }
		...
		/// </summary>
		public PlotOptionsRocSonificationContextTracksMappingPan Pan { get; set; }
		private PlotOptionsRocSonificationContextTracksMappingPan Pan_DefaultValue { get; set; }
		...
		/// </summary>
		public PlotOptionsRocSonificationContextTracksMappingPitch Pitch { get; set; }
		private PlotOptionsRocSonificationContextTracksMappingPitch Pitch_DefaultValue { get; set; }
		...
		/// </summary>
		public PlotOptionsRocSonificationContextTracksMappingPlayDelay PlayDelay { get; set; }
		private PlotOptionsRocSonificationContextTracksMappingPlayDelay PlayDelay_DefaultValue { get; set; }
		...
		/// </summary>
		public PlotOptionsRocSonificationContextTracksMappingTime Time { get; set; }
		private PlotOptionsRocSonificationContextTracksMappingTime Time_DefaultValue { get; set; }
		...
		/// </summary>
		public PlotOptionsRocSonificationContextTracksMappingTremolo Tremolo { get; set; }
		private PlotOptionsRocSonificationContextTracksMappingTremolo Tremolo_DefaultValue { get; set; }
		 

		/// <summary>
		/// The volume of notes, from 0 to 1.
		/// </summary>
		public PlotOptionsRocSonificationContextTracksMappingVolume Volume { get; set; }
		private PlotOptionsRocSonificationContextTracksMappingVolume Volume_DefaultValue { get; set; }
