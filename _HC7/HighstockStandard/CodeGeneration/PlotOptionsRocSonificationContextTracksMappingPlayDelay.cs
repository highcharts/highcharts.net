...
{
	public partial class PlotOptionsRocSonificationContextTracksMappingPlayDelay  : BaseObject
	{
		Hashtable h = new Hashtable();

		public PlotOptionsRocSonificationContextTracksMappingPlayDelay()
		{
			MapFunction = MapFunction_DefaultValue = PlotOptionsRocSonificationContextTracksMappingPlayDelayMapFunction.Linear;
			MapTo = MapTo_DefaultValue = "";
			Max = Max_DefaultValue = null;
			Min = Min_DefaultValue = null;
			Value = Value_DefaultValue = null;
			Within = Within_DefaultValue = PlotOptionsRocSonificationContextTracksMappingPlayDelayWithin.Chart;
		...
		/// </summary>
		public PlotOptionsRocSonificationContextTracksMappingPlayDelayMapFunction MapFunction { get; set; }
		private PlotOptionsRocSonificationContextTracksMappingPlayDelayMapFunction MapFunction_DefaultValue { get; set; }
		...
		/// </summary>
		public PlotOptionsRocSonificationContextTracksMappingPlayDelayWithin Within { get; set; }
		private PlotOptionsRocSonificationContextTracksMappingPlayDelayWithin Within_DefaultValue { get; set; }
