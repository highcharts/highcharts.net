...
{
	public partial class PlotOptionsRocSonificationDefaultSpeechOptionsActiveWhen  : BaseObject
	{
		Hashtable h = new Hashtable();

		public PlotOptionsRocSonificationDefaultSpeechOptionsActiveWhen()
		{
