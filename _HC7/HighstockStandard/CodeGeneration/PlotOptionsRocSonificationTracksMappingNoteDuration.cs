...
{
	public partial class PlotOptionsRocSonificationTracksMappingNoteDuration  : BaseObject
	{
		Hashtable h = new Hashtable();

		public PlotOptionsRocSonificationTracksMappingNoteDuration()
		{
			MapFunction = MapFunction_DefaultValue = PlotOptionsRocSonificationTracksMappingNoteDurationMapFunction.Linear;
			MapTo = MapTo_DefaultValue = "";
			Max = Max_DefaultValue = null;
			Min = Min_DefaultValue = null;
			Value = Value_DefaultValue = null;
			Within = Within_DefaultValue = PlotOptionsRocSonificationTracksMappingNoteDurationWithin.Chart;
		...
		/// </summary>
		public PlotOptionsRocSonificationTracksMappingNoteDurationMapFunction MapFunction { get; set; }
		private PlotOptionsRocSonificationTracksMappingNoteDurationMapFunction MapFunction_DefaultValue { get; set; }
		...
		/// </summary>
		public PlotOptionsRocSonificationTracksMappingNoteDurationWithin Within { get; set; }
		private PlotOptionsRocSonificationTracksMappingNoteDurationWithin Within_DefaultValue { get; set; }
