...
{
	public partial class PlotOptionsRocSonificationTracksMappingPan  : BaseObject
	{
		Hashtable h = new Hashtable();

		public PlotOptionsRocSonificationTracksMappingPan()
		{
			MapFunction = MapFunction_DefaultValue = PlotOptionsRocSonificationTracksMappingPanMapFunction.Linear;
			MapTo = MapTo_DefaultValue = "";
			Max = Max_DefaultValue = null;
			Min = Min_DefaultValue = null;
			Value = Value_DefaultValue = null;
			Within = Within_DefaultValue = PlotOptionsRocSonificationTracksMappingPanWithin.Chart;
		...
		/// </summary>
		public PlotOptionsRocSonificationTracksMappingPanMapFunction MapFunction { get; set; }
		private PlotOptionsRocSonificationTracksMappingPanMapFunction MapFunction_DefaultValue { get; set; }
		...
		/// </summary>
		public PlotOptionsRocSonificationTracksMappingPanWithin Within { get; set; }
		private PlotOptionsRocSonificationTracksMappingPanWithin Within_DefaultValue { get; set; }
