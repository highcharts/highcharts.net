...
{
	public partial class PlotOptionsRocSonificationTracksMappingPitch  : BaseObject
	{
		Hashtable h = new Hashtable();

		public PlotOptionsRocSonificationTracksMappingPitch()
		{
			MapFunction = MapFunction_DefaultValue = PlotOptionsRocSonificationTracksMappingPitchMapFunction.Linear;
		...
		/// </summary>
		public PlotOptionsRocSonificationTracksMappingPitchMapFunction MapFunction { get; set; }
		private PlotOptionsRocSonificationTracksMappingPitchMapFunction MapFunction_DefaultValue { get; set; }
