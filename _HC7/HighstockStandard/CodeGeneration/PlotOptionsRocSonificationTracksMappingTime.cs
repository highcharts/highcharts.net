...
{
	public partial class PlotOptionsRocSonificationTracksMappingTime  : BaseObject
	{
		Hashtable h = new Hashtable();

		public PlotOptionsRocSonificationTracksMappingTime()
		{
			MapFunction = MapFunction_DefaultValue = PlotOptionsRocSonificationTracksMappingTimeMapFunction.Linear;
			MapTo = MapTo_DefaultValue = "";
			Max = Max_DefaultValue = null;
			Min = Min_DefaultValue = null;
			Value = Value_DefaultValue = null;
			Within = Within_DefaultValue = PlotOptionsRocSonificationTracksMappingTimeWithin.Chart;
		...
		/// </summary>
		public PlotOptionsRocSonificationTracksMappingTimeMapFunction MapFunction { get; set; }
		private PlotOptionsRocSonificationTracksMappingTimeMapFunction MapFunction_DefaultValue { get; set; }
		...
		/// </summary>
		public PlotOptionsRocSonificationTracksMappingTimeWithin Within { get; set; }
		private PlotOptionsRocSonificationTracksMappingTimeWithin Within_DefaultValue { get; set; }
