...
{
	public partial class PlotOptionsRocSonificationTracksMappingVolume  : BaseObject
	{
		Hashtable h = new Hashtable();

		public PlotOptionsRocSonificationTracksMappingVolume()
		{
			MapFunction = MapFunction_DefaultValue = PlotOptionsRocSonificationTracksMappingVolumeMapFunction.Linear;
			MapTo = MapTo_DefaultValue = "";
			Max = Max_DefaultValue = null;
			Min = Min_DefaultValue = null;
			Value = Value_DefaultValue = null;
			Within = Within_DefaultValue = PlotOptionsRocSonificationTracksMappingVolumeWithin.Chart;
		...
		/// </summary>
		public PlotOptionsRocSonificationTracksMappingVolumeMapFunction MapFunction { get; set; }
		private PlotOptionsRocSonificationTracksMappingVolumeMapFunction MapFunction_DefaultValue { get; set; }
		...
		/// </summary>
		public PlotOptionsRocSonificationTracksMappingVolumeWithin Within { get; set; }
		private PlotOptionsRocSonificationTracksMappingVolumeWithin Within_DefaultValue { get; set; }
