...
{
	public partial class PlotOptionsRocSonificationTracksPointGrouping  : BaseObject
	{
		Hashtable h = new Hashtable();

		public PlotOptionsRocSonificationTracksPointGrouping()
		{
			Algorithm = Algorithm_DefaultValue = PlotOptionsRocSonificationTracksPointGroupingAlgorithm.Minimax;
		...
		/// </summary>
		public PlotOptionsRocSonificationTracksPointGroupingAlgorithm Algorithm { get; set; }
		private PlotOptionsRocSonificationTracksPointGroupingAlgorithm Algorithm_DefaultValue { get; set; }
