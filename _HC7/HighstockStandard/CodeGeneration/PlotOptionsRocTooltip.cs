...
{
	public partial class PlotOptionsRocTooltip  : BaseObject
	{
		public PlotOptionsRocTooltip()
		{
			...
			HeaderShape = HeaderShape_DefaultValue = PlotOptionsRocTooltipHeaderShape.Callout;
		...
		/// </summary>
		public PlotOptionsRocTooltipHeaderShape HeaderShape { get; set; }
		private PlotOptionsRocTooltipHeaderShape HeaderShape_DefaultValue { get; set; }
		...
		internal override Hashtable ToHashtable()
		{
			...
			if (NullFormatter != NullFormatter_DefaultValue) { h.Add("nullFormatter",NullFormatter); Highstock.AddFunction("PlotOptionsRocTooltipNullFormatter.nullFormatter", NullFormatter); }  
			if (Outside != Outside_DefaultValue) h.Add("outside",Outside);
			if (Padding != Padding_DefaultValue) h.Add("padding",Padding);
			if (PointFormat != PointFormat_DefaultValue) h.Add("pointFormat",PointFormat);
			if (PointFormatter != PointFormatter_DefaultValue) { h.Add("pointFormatter",PointFormatter); Highstock.AddFunction("PlotOptionsRocTooltipPointFormatter.pointFormatter", PointFormatter); }  
