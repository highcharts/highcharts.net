...
{
	public partial class PlotOptionsRsi  : BaseObject
	{
		Hashtable h = new Hashtable();

		public PlotOptionsRsi()
		{
			Accessibility = Accessibility_DefaultValue = new PlotOptionsRsiAccessibility();
			AllowPointSelect = AllowPointSelect_DefaultValue = false;
			Animation = Animation_DefaultValue = new Animation() { Enabled = true };
			AnimationBool = AnimationBool_DefaultValue = true;
			AnimationLimit = AnimationLimit_DefaultValue = null;
			BoostBlending = BoostBlending_DefaultValue = PlotOptionsRsiBoostBlending.Undefined;
			...
			Compare = Compare_DefaultValue = PlotOptionsRsiCompare.Percent;
			CompareBase = CompareBase_DefaultValue = PlotOptionsRsiCompareBase.Min;
			...
			Cursor = Cursor_DefaultValue = PlotOptionsRsiCursor.Null;
			Custom = Custom_DefaultValue = new Hashtable();
			DashStyle = DashStyle_DefaultValue = PlotOptionsRsiDashStyle.Null;
			DataGrouping = DataGrouping_DefaultValue = new PlotOptionsRsiDataGrouping();
			DataLabels = DataLabels_DefaultValue = new PlotOptionsRsiDataLabels();
			DataSorting = DataSorting_DefaultValue = new PlotOptionsRsiDataSorting();
			Description = Description_DefaultValue = "";
			EnableMouseTracking = EnableMouseTracking_DefaultValue = true;
			Events = Events_DefaultValue = new PlotOptionsRsiEvents();
			FindNearestPointBy = FindNearestPointBy_DefaultValue = PlotOptionsRsiFindNearestPointBy.X;
			GapSize = GapSize_DefaultValue = 0;
			GapUnit = GapUnit_DefaultValue = PlotOptionsRsiGapUnit.Relative;
			GetExtremesFromAll = GetExtremesFromAll_DefaultValue = false;
			IncludeInDataExport = IncludeInDataExport_DefaultValue = null;
			Label = Label_DefaultValue = new PlotOptionsRsiLabel();
			LastPrice = LastPrice_DefaultValue = new PlotOptionsRsiLastPrice();
			LastVisiblePrice = LastVisiblePrice_DefaultValue = new PlotOptionsRsiLastVisiblePrice();
			LegendSymbol = LegendSymbol_DefaultValue = PlotOptionsRsiLegendSymbol.Rectangle;
			Linecap = Linecap_DefaultValue = PlotOptionsRsiLinecap.Round;
			LineWidth = LineWidth_DefaultValue = 1;
			LinkedTo = LinkedTo_DefaultValue = "";
			Marker = Marker_DefaultValue = new PlotOptionsRsiMarker();
			NegativeColor = NegativeColor_DefaultValue = "";
			OnPoint = OnPoint_DefaultValue = new PlotOptionsRsiOnPoint();
			Opacity = Opacity_DefaultValue = 1;
			Params = Params_DefaultValue = new PlotOptionsRsiParams();
			Point = Point_DefaultValue = new PlotOptionsRsiPoint();
			...
			Sonification = Sonification_DefaultValue = new PlotOptionsRsiSonification();
			States = States_DefaultValue = new PlotOptionsRsiStates();
			Step = Step_DefaultValue = PlotOptionsRsiStep.Null;
			...
			Zones = Zones_DefaultValue = new List<PlotOptionsRsiZones>();
		...
		/// </summary>
		public PlotOptionsRsiAccessibility Accessibility { get; set; }
		private PlotOptionsRsiAccessibility Accessibility_DefaultValue { get; set; }
		...
		/// </summary>
		public PlotOptionsRsiBoostBlending BoostBlending { get; set; }
		private PlotOptionsRsiBoostBlending BoostBlending_DefaultValue { get; set; }
		...
		/// </summary>
		public PlotOptionsRsiCompare Compare { get; set; }
		private PlotOptionsRsiCompare Compare_DefaultValue { get; set; }
		 

		/// <summary>
		/// When [compare](#plotOptions.series.compare) is `percent`, this optiondictates whether to use 0 or 100 as the base of comparison.
		/// </summary>
		public PlotOptionsRsiCompareBase CompareBase { get; set; }
		private PlotOptionsRsiCompareBase CompareBase_DefaultValue { get; set; }
		...
		/// </summary>
		public PlotOptionsRsiCursor Cursor { get; set; }
		private PlotOptionsRsiCursor Cursor_DefaultValue { get; set; }
		...
		/// </summary>
		public PlotOptionsRsiDashStyle DashStyle { get; set; }
		private PlotOptionsRsiDashStyle DashStyle_DefaultValue { get; set; }
		...
		/// </summary>
		public PlotOptionsRsiDataGrouping DataGrouping { get; set; }
		private PlotOptionsRsiDataGrouping DataGrouping_DefaultValue { get; set; }
		...
		/// </summary>
		public PlotOptionsRsiDataLabels DataLabels { get; set; }
		private PlotOptionsRsiDataLabels DataLabels_DefaultValue { get; set; }
		 

		/// <summary>
		/// Options for the series data sorting.
		/// </summary>
		public PlotOptionsRsiDataSorting DataSorting { get; set; }
		private PlotOptionsRsiDataSorting DataSorting_DefaultValue { get; set; }
		...
		/// </summary>
		public PlotOptionsRsiEvents Events { get; set; }
		private PlotOptionsRsiEvents Events_DefaultValue { get; set; }
		...
		/// </summary>
		public PlotOptionsRsiFindNearestPointBy FindNearestPointBy { get; set; }
		private PlotOptionsRsiFindNearestPointBy FindNearestPointBy_DefaultValue { get; set; }
		...
		/// </summary>
		public PlotOptionsRsiGapUnit GapUnit { get; set; }
		private PlotOptionsRsiGapUnit GapUnit_DefaultValue { get; set; }
		...
		/// </summary>
		public PlotOptionsRsiLabel Label { get; set; }
		private PlotOptionsRsiLabel Label_DefaultValue { get; set; }
		 

		/// <summary>
		/// The line marks the last price from all points.
		/// </summary>
		public PlotOptionsRsiLastPrice LastPrice { get; set; }
		private PlotOptionsRsiLastPrice LastPrice_DefaultValue { get; set; }
		 

		/// <summary>
		/// The line marks the last price from visible range of points.
		/// </summary>
		public PlotOptionsRsiLastVisiblePrice LastVisiblePrice { get; set; }
		private PlotOptionsRsiLastVisiblePrice LastVisiblePrice_DefaultValue { get; set; }
		 

		/// <summary>
		/// What type of legend symbol to render for this series. Can be one of`lineMarker` or `rectangle`.
		/// </summary>
		public PlotOptionsRsiLegendSymbol LegendSymbol { get; set; }
		private PlotOptionsRsiLegendSymbol LegendSymbol_DefaultValue { get; set; }
		 

		/// <summary>
		/// The line cap used for line ends and line joins on the graph.
		/// </summary>
		public PlotOptionsRsiLinecap Linecap { get; set; }
		private PlotOptionsRsiLinecap Linecap_DefaultValue { get; set; }
		...
		/// </summary>
		public PlotOptionsRsiMarker Marker { get; set; }
		private PlotOptionsRsiMarker Marker_DefaultValue { get; set; }
		...
		/// </summary>
		public PlotOptionsRsiOnPoint OnPoint { get; set; }
		private PlotOptionsRsiOnPoint OnPoint_DefaultValue { get; set; }
		...
		private PlotOptionsRsiParams Params_DefaultValue { get; set; }
		 

		/// <summary>
		/// Properties for each single point.
		/// </summary>
		public PlotOptionsRsiPoint Point { get; set; }
		private PlotOptionsRsiPoint Point_DefaultValue { get; set; }
		...
		/// </summary>
		public PlotOptionsRsiSonification Sonification { get; set; }
		private PlotOptionsRsiSonification Sonification_DefaultValue { get; set; }
		 

		/// <summary>
		/// 
		/// </summary>
		public PlotOptionsRsiStates States { get; set; }
		private PlotOptionsRsiStates States_DefaultValue { get; set; }
		 

		/// <summary>
		/// Whether to apply steps to the line. Possible values are `left`,`center` and `right`.
		/// </summary>
		public PlotOptionsRsiStep Step { get; set; }
		private PlotOptionsRsiStep Step_DefaultValue { get; set; }
		...
		/// </summary>
		public PlotOptionsRsiTooltip Tooltip { get; set; }
		private PlotOptionsRsiTooltip Tooltip_DefaultValue { get; set; }
		...
		/// </summary>
		public List<PlotOptionsRsiZones> Zones { get; set; }
		private List<PlotOptionsRsiZones> Zones_DefaultValue { get; set; }
