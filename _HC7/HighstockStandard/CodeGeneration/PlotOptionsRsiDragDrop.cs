...
{
	public partial class PlotOptionsRsiDragDrop  : BaseObject
	{
		public PlotOptionsRsiDragDrop()
		{
			DraggableX = DraggableX_DefaultValue = null;
			DraggableY = DraggableY_DefaultValue = null;
			DragHandle = DragHandle_DefaultValue = new PlotOptionsRsiDragDropDragHandle();
			...
			GuideBox = GuideBox_DefaultValue = new PlotOptionsRsiDragDropGuideBox();
		...
		/// </summary>
		public PlotOptionsRsiDragDropDragHandle DragHandle { get; set; }
		private PlotOptionsRsiDragDropDragHandle DragHandle_DefaultValue { get; set; }
		...
		/// </summary>
		public PlotOptionsRsiDragDropGuideBox GuideBox { get; set; }
		private PlotOptionsRsiDragDropGuideBox GuideBox_DefaultValue { get; set; }
