...
{
	public partial class PlotOptionsRsiSonificationContextTracks  : BaseObject
	{
		Hashtable h = new Hashtable();

		public PlotOptionsRsiSonificationContextTracks()
		{
			ActiveWhen = ActiveWhen_DefaultValue = new PlotOptionsRsiSonificationContextTracksActiveWhen();
			Instrument = Instrument_DefaultValue = null;
			InstrumentString = InstrumentString_DefaultValue = "null";
			Mapping = Mapping_DefaultValue = new PlotOptionsRsiSonificationContextTracksMapping();
			MidiName = MidiName_DefaultValue = "";
			PointGrouping = PointGrouping_DefaultValue = new PlotOptionsRsiSonificationContextTracksPointGrouping();
			...
			Type = Type_DefaultValue = PlotOptionsRsiSonificationContextTracksType.Instrument;
			ValueInterval = ValueInterval_DefaultValue = null;
			ValueMapFunction = ValueMapFunction_DefaultValue = PlotOptionsRsiSonificationContextTracksValueMapFunction.Linear;
		...
		/// </summary>
		public PlotOptionsRsiSonificationContextTracksActiveWhen ActiveWhen { get; set; }
		private PlotOptionsRsiSonificationContextTracksActiveWhen ActiveWhen_DefaultValue { get; set; }
		...
		/// </summary>
		public PlotOptionsRsiSonificationContextTracksMapping Mapping { get; set; }
		private PlotOptionsRsiSonificationContextTracksMapping Mapping_DefaultValue { get; set; }
		...
		/// </summary>
		public PlotOptionsRsiSonificationContextTracksPointGrouping PointGrouping { get; set; }
		private PlotOptionsRsiSonificationContextTracksPointGrouping PointGrouping_DefaultValue { get; set; }
		...
		/// </summary>
		public PlotOptionsRsiSonificationContextTracksType Type { get; set; }
		private PlotOptionsRsiSonificationContextTracksType Type_DefaultValue { get; set; }
		...
		/// </summary>
		public PlotOptionsRsiSonificationContextTracksValueMapFunction ValueMapFunction { get; set; }
		private PlotOptionsRsiSonificationContextTracksValueMapFunction ValueMapFunction_DefaultValue { get; set; }
