...
{
	public partial class PlotOptionsRsiSonificationContextTracksMapping  : BaseObject
	{
		Hashtable h = new Hashtable();

		public PlotOptionsRsiSonificationContextTracksMapping()
		{
			Frequency = Frequency_DefaultValue = new PlotOptionsRsiSonificationContextTracksMappingFrequency();
			GapBetweenNotes = GapBetweenNotes_DefaultValue = new PlotOptionsRsiSonificationContextTracksMappingGapBetweenNotes();
			Highpass = Highpass_DefaultValue = new PlotOptionsRsiSonificationContextTracksMappingHighpass();
			Lowpass = Lowpass_DefaultValue = new PlotOptionsRsiSonificationContextTracksMappingLowpass();
			NoteDuration = NoteDuration_DefaultValue = new PlotOptionsRsiSonificationContextTracksMappingNoteDuration();
			Pan = Pan_DefaultValue = new PlotOptionsRsiSonificationContextTracksMappingPan();
			Pitch = Pitch_DefaultValue = new PlotOptionsRsiSonificationContextTracksMappingPitch();
			PitchString = PitchString_DefaultValue = "null";
			PitchNumber = PitchNumber_DefaultValue = null;
			PlayDelay = PlayDelay_DefaultValue = new PlotOptionsRsiSonificationContextTracksMappingPlayDelay();
			Time = Time_DefaultValue = new PlotOptionsRsiSonificationContextTracksMappingTime();
			TimeString = TimeString_DefaultValue = "null";
			TimeNumber = TimeNumber_DefaultValue = null;
			Tremolo = Tremolo_DefaultValue = new PlotOptionsRsiSonificationContextTracksMappingTremolo();
			Volume = Volume_DefaultValue = new PlotOptionsRsiSonificationContextTracksMappingVolume();
		...
		/// </summary>
		public PlotOptionsRsiSonificationContextTracksMappingFrequency Frequency { get; set; }
		private PlotOptionsRsiSonificationContextTracksMappingFrequency Frequency_DefaultValue { get; set; }
		...
		/// </summary>
		public PlotOptionsRsiSonificationContextTracksMappingGapBetweenNotes GapBetweenNotes { get; set; }
		private PlotOptionsRsiSonificationContextTracksMappingGapBetweenNotes GapBetweenNotes_DefaultValue { get; set; }
		...
		/// </summary>
		public PlotOptionsRsiSonificationContextTracksMappingHighpass Highpass { get; set; }
		private PlotOptionsRsiSonificationContextTracksMappingHighpass Highpass_DefaultValue { get; set; }
		...
		/// </summary>
		public PlotOptionsRsiSonificationContextTracksMappingLowpass Lowpass { get; set; }
		private PlotOptionsRsiSonificationContextTracksMappingLowpass Lowpass_DefaultValue { get; set; }
		...
		/// </summary>
		public PlotOptionsRsiSonificationContextTracksMappingNoteDuration NoteDuration { get; set; }
		private PlotOptionsRsiSonificationContextTracksMappingNoteDuration NoteDuration_DefaultValue { get; set; }
		...
		/// </summary>
		public PlotOptionsRsiSonificationContextTracksMappingPan Pan { get; set; }
		private PlotOptionsRsiSonificationContextTracksMappingPan Pan_DefaultValue { get; set; }
		...
		/// </summary>
		public PlotOptionsRsiSonificationContextTracksMappingPitch Pitch { get; set; }
		private PlotOptionsRsiSonificationContextTracksMappingPitch Pitch_DefaultValue { get; set; }
		...
		/// </summary>
		public PlotOptionsRsiSonificationContextTracksMappingPlayDelay PlayDelay { get; set; }
		private PlotOptionsRsiSonificationContextTracksMappingPlayDelay PlayDelay_DefaultValue { get; set; }
		...
		/// </summary>
		public PlotOptionsRsiSonificationContextTracksMappingTime Time { get; set; }
		private PlotOptionsRsiSonificationContextTracksMappingTime Time_DefaultValue { get; set; }
		...
		/// </summary>
		public PlotOptionsRsiSonificationContextTracksMappingTremolo Tremolo { get; set; }
		private PlotOptionsRsiSonificationContextTracksMappingTremolo Tremolo_DefaultValue { get; set; }
		 

		/// <summary>
		/// The volume of notes, from 0 to 1.
		/// </summary>
		public PlotOptionsRsiSonificationContextTracksMappingVolume Volume { get; set; }
		private PlotOptionsRsiSonificationContextTracksMappingVolume Volume_DefaultValue { get; set; }
