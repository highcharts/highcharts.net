...
{
	public partial class PlotOptionsRsiSonificationContextTracksMappingPitch  : BaseObject
	{
		Hashtable h = new Hashtable();

		public PlotOptionsRsiSonificationContextTracksMappingPitch()
		{
			MapFunction = MapFunction_DefaultValue = PlotOptionsRsiSonificationContextTracksMappingPitchMapFunction.Linear;
		...
		/// </summary>
		public PlotOptionsRsiSonificationContextTracksMappingPitchMapFunction MapFunction { get; set; }
		private PlotOptionsRsiSonificationContextTracksMappingPitchMapFunction MapFunction_DefaultValue { get; set; }
