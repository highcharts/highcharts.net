...
{
	public partial class PlotOptionsRsiSonificationDefaultInstrumentOptionsMapping  : BaseObject
	{
		Hashtable h = new Hashtable();

		public PlotOptionsRsiSonificationDefaultInstrumentOptionsMapping()
		{
			Frequency = Frequency_DefaultValue = new PlotOptionsRsiSonificationDefaultInstrumentOptionsMappingFrequency();
			GapBetweenNotes = GapBetweenNotes_DefaultValue = new PlotOptionsRsiSonificationDefaultInstrumentOptionsMappingGapBetweenNotes();
			Highpass = Highpass_DefaultValue = new PlotOptionsRsiSonificationDefaultInstrumentOptionsMappingHighpass();
			Lowpass = Lowpass_DefaultValue = new PlotOptionsRsiSonificationDefaultInstrumentOptionsMappingLowpass();
			NoteDuration = NoteDuration_DefaultValue = new PlotOptionsRsiSonificationDefaultInstrumentOptionsMappingNoteDuration();
			Pan = Pan_DefaultValue = new PlotOptionsRsiSonificationDefaultInstrumentOptionsMappingPan();
			Pitch = Pitch_DefaultValue = new PlotOptionsRsiSonificationDefaultInstrumentOptionsMappingPitch();
			PitchString = PitchString_DefaultValue = "null";
			PitchNumber = PitchNumber_DefaultValue = null;
			PlayDelay = PlayDelay_DefaultValue = new PlotOptionsRsiSonificationDefaultInstrumentOptionsMappingPlayDelay();
			Time = Time_DefaultValue = new PlotOptionsRsiSonificationDefaultInstrumentOptionsMappingTime();
			TimeString = TimeString_DefaultValue = "null";
			TimeNumber = TimeNumber_DefaultValue = null;
			Tremolo = Tremolo_DefaultValue = new PlotOptionsRsiSonificationDefaultInstrumentOptionsMappingTremolo();
			Volume = Volume_DefaultValue = new PlotOptionsRsiSonificationDefaultInstrumentOptionsMappingVolume();
		...
		/// </summary>
		public PlotOptionsRsiSonificationDefaultInstrumentOptionsMappingFrequency Frequency { get; set; }
		private PlotOptionsRsiSonificationDefaultInstrumentOptionsMappingFrequency Frequency_DefaultValue { get; set; }
		...
		/// </summary>
		public PlotOptionsRsiSonificationDefaultInstrumentOptionsMappingGapBetweenNotes GapBetweenNotes { get; set; }
		private PlotOptionsRsiSonificationDefaultInstrumentOptionsMappingGapBetweenNotes GapBetweenNotes_DefaultValue { get; set; }
		...
		/// </summary>
		public PlotOptionsRsiSonificationDefaultInstrumentOptionsMappingHighpass Highpass { get; set; }
		private PlotOptionsRsiSonificationDefaultInstrumentOptionsMappingHighpass Highpass_DefaultValue { get; set; }
		...
		/// </summary>
		public PlotOptionsRsiSonificationDefaultInstrumentOptionsMappingLowpass Lowpass { get; set; }
		private PlotOptionsRsiSonificationDefaultInstrumentOptionsMappingLowpass Lowpass_DefaultValue { get; set; }
		...
		/// </summary>
		public PlotOptionsRsiSonificationDefaultInstrumentOptionsMappingNoteDuration NoteDuration { get; set; }
		private PlotOptionsRsiSonificationDefaultInstrumentOptionsMappingNoteDuration NoteDuration_DefaultValue { get; set; }
		...
		/// </summary>
		public PlotOptionsRsiSonificationDefaultInstrumentOptionsMappingPan Pan { get; set; }
		private PlotOptionsRsiSonificationDefaultInstrumentOptionsMappingPan Pan_DefaultValue { get; set; }
		...
		/// </summary>
		public PlotOptionsRsiSonificationDefaultInstrumentOptionsMappingPitch Pitch { get; set; }
		private PlotOptionsRsiSonificationDefaultInstrumentOptionsMappingPitch Pitch_DefaultValue { get; set; }
		...
		/// </summary>
		public PlotOptionsRsiSonificationDefaultInstrumentOptionsMappingPlayDelay PlayDelay { get; set; }
		private PlotOptionsRsiSonificationDefaultInstrumentOptionsMappingPlayDelay PlayDelay_DefaultValue { get; set; }
		...
		/// </summary>
		public PlotOptionsRsiSonificationDefaultInstrumentOptionsMappingTime Time { get; set; }
		private PlotOptionsRsiSonificationDefaultInstrumentOptionsMappingTime Time_DefaultValue { get; set; }
		...
		/// </summary>
		public PlotOptionsRsiSonificationDefaultInstrumentOptionsMappingTremolo Tremolo { get; set; }
		private PlotOptionsRsiSonificationDefaultInstrumentOptionsMappingTremolo Tremolo_DefaultValue { get; set; }
		 

		/// <summary>
		/// The volume of notes, from 0 to 1.
		/// </summary>
		public PlotOptionsRsiSonificationDefaultInstrumentOptionsMappingVolume Volume { get; set; }
		private PlotOptionsRsiSonificationDefaultInstrumentOptionsMappingVolume Volume_DefaultValue { get; set; }
