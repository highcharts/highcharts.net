...
{
	public partial class PlotOptionsRsiSonificationTracksMappingFrequency  : BaseObject
	{
		Hashtable h = new Hashtable();

		public PlotOptionsRsiSonificationTracksMappingFrequency()
		{
			MapFunction = MapFunction_DefaultValue = PlotOptionsRsiSonificationTracksMappingFrequencyMapFunction.Linear;
			MapTo = MapTo_DefaultValue = "";
			Max = Max_DefaultValue = null;
			Min = Min_DefaultValue = null;
			Value = Value_DefaultValue = null;
			Within = Within_DefaultValue = PlotOptionsRsiSonificationTracksMappingFrequencyWithin.Chart;
		...
		/// </summary>
		public PlotOptionsRsiSonificationTracksMappingFrequencyMapFunction MapFunction { get; set; }
		private PlotOptionsRsiSonificationTracksMappingFrequencyMapFunction MapFunction_DefaultValue { get; set; }
		...
		/// </summary>
		public PlotOptionsRsiSonificationTracksMappingFrequencyWithin Within { get; set; }
		private PlotOptionsRsiSonificationTracksMappingFrequencyWithin Within_DefaultValue { get; set; }
