...
{
	public partial class PlotOptionsRsiSonificationTracksMappingPan  : BaseObject
	{
		Hashtable h = new Hashtable();

		public PlotOptionsRsiSonificationTracksMappingPan()
		{
			MapFunction = MapFunction_DefaultValue = PlotOptionsRsiSonificationTracksMappingPanMapFunction.Linear;
			MapTo = MapTo_DefaultValue = "";
			Max = Max_DefaultValue = null;
			Min = Min_DefaultValue = null;
			Value = Value_DefaultValue = null;
			Within = Within_DefaultValue = PlotOptionsRsiSonificationTracksMappingPanWithin.Chart;
		...
		/// </summary>
		public PlotOptionsRsiSonificationTracksMappingPanMapFunction MapFunction { get; set; }
		private PlotOptionsRsiSonificationTracksMappingPanMapFunction MapFunction_DefaultValue { get; set; }
		...
		/// </summary>
		public PlotOptionsRsiSonificationTracksMappingPanWithin Within { get; set; }
		private PlotOptionsRsiSonificationTracksMappingPanWithin Within_DefaultValue { get; set; }
