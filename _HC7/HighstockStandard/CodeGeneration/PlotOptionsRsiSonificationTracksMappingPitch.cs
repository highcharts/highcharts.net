...
{
	public partial class PlotOptionsRsiSonificationTracksMappingPitch  : BaseObject
	{
		Hashtable h = new Hashtable();

		public PlotOptionsRsiSonificationTracksMappingPitch()
		{
			MapFunction = MapFunction_DefaultValue = PlotOptionsRsiSonificationTracksMappingPitchMapFunction.Linear;
		...
		/// </summary>
		public PlotOptionsRsiSonificationTracksMappingPitchMapFunction MapFunction { get; set; }
		private PlotOptionsRsiSonificationTracksMappingPitchMapFunction MapFunction_DefaultValue { get; set; }
