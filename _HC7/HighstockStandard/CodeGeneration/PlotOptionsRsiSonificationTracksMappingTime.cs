...
{
	public partial class PlotOptionsRsiSonificationTracksMappingTime  : BaseObject
	{
		Hashtable h = new Hashtable();

		public PlotOptionsRsiSonificationTracksMappingTime()
		{
			MapFunction = MapFunction_DefaultValue = PlotOptionsRsiSonificationTracksMappingTimeMapFunction.Linear;
			MapTo = MapTo_DefaultValue = "";
			Max = Max_DefaultValue = null;
			Min = Min_DefaultValue = null;
			Value = Value_DefaultValue = null;
			Within = Within_DefaultValue = PlotOptionsRsiSonificationTracksMappingTimeWithin.Chart;
		...
		/// </summary>
		public PlotOptionsRsiSonificationTracksMappingTimeMapFunction MapFunction { get; set; }
		private PlotOptionsRsiSonificationTracksMappingTimeMapFunction MapFunction_DefaultValue { get; set; }
		...
		/// </summary>
		public PlotOptionsRsiSonificationTracksMappingTimeWithin Within { get; set; }
		private PlotOptionsRsiSonificationTracksMappingTimeWithin Within_DefaultValue { get; set; }
