...
{
	public partial class PlotOptionsRsiSonificationTracksMappingVolume  : BaseObject
	{
		Hashtable h = new Hashtable();

		public PlotOptionsRsiSonificationTracksMappingVolume()
		{
			MapFunction = MapFunction_DefaultValue = PlotOptionsRsiSonificationTracksMappingVolumeMapFunction.Linear;
			MapTo = MapTo_DefaultValue = "";
			Max = Max_DefaultValue = null;
			Min = Min_DefaultValue = null;
			Value = Value_DefaultValue = null;
			Within = Within_DefaultValue = PlotOptionsRsiSonificationTracksMappingVolumeWithin.Chart;
		...
		/// </summary>
		public PlotOptionsRsiSonificationTracksMappingVolumeMapFunction MapFunction { get; set; }
		private PlotOptionsRsiSonificationTracksMappingVolumeMapFunction MapFunction_DefaultValue { get; set; }
		...
		/// </summary>
		public PlotOptionsRsiSonificationTracksMappingVolumeWithin Within { get; set; }
		private PlotOptionsRsiSonificationTracksMappingVolumeWithin Within_DefaultValue { get; set; }
