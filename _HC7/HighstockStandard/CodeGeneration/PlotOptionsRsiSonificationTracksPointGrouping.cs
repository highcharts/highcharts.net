...
{
	public partial class PlotOptionsRsiSonificationTracksPointGrouping  : BaseObject
	{
		Hashtable h = new Hashtable();

		public PlotOptionsRsiSonificationTracksPointGrouping()
		{
			Algorithm = Algorithm_DefaultValue = PlotOptionsRsiSonificationTracksPointGroupingAlgorithm.Minimax;
		...
		/// </summary>
		public PlotOptionsRsiSonificationTracksPointGroupingAlgorithm Algorithm { get; set; }
		private PlotOptionsRsiSonificationTracksPointGroupingAlgorithm Algorithm_DefaultValue { get; set; }
