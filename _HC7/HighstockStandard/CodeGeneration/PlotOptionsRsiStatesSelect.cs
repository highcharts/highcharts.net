...
{
	public partial class PlotOptionsRsiStatesSelect  : BaseObject
	{
		Hashtable h = new Hashtable();

		public PlotOptionsRsiStatesSelect()
		{
			Animation = Animation_DefaultValue = new Animation() { Enabled = true };
			AnimationBool = AnimationBool_DefaultValue = null;
			Enabled = Enabled_DefaultValue = true;
			Halo = Halo_DefaultValue = new PlotOptionsRsiStatesSelectHalo();
			LineWidth = LineWidth_DefaultValue = null;
			LineWidthPlus = LineWidthPlus_DefaultValue = 1;
			Marker = Marker_DefaultValue = new PlotOptionsRsiStatesSelectMarker();
		...
		/// </summary>
		public PlotOptionsRsiStatesSelectHalo Halo { get; set; }
		private PlotOptionsRsiStatesSelectHalo Halo_DefaultValue { get; set; }
		...
		/// </summary>
		public PlotOptionsRsiStatesSelectMarker Marker { get; set; }
		private PlotOptionsRsiStatesSelectMarker Marker_DefaultValue { get; set; }
