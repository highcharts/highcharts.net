...
{
	public partial class PlotOptionsRsiTooltip  : BaseObject
	{
		public PlotOptionsRsiTooltip()
		{
			...
			HeaderShape = HeaderShape_DefaultValue = PlotOptionsRsiTooltipHeaderShape.Callout;
		...
		/// </summary>
		public PlotOptionsRsiTooltipHeaderShape HeaderShape { get; set; }
		private PlotOptionsRsiTooltipHeaderShape HeaderShape_DefaultValue { get; set; }
		...
		internal override Hashtable ToHashtable()
		{
			...
			if (NullFormatter != NullFormatter_DefaultValue) { h.Add("nullFormatter",NullFormatter); Highstock.AddFunction("PlotOptionsRsiTooltipNullFormatter.nullFormatter", NullFormatter); }  
			if (Outside != Outside_DefaultValue) h.Add("outside",Outside);
			if (Padding != Padding_DefaultValue) h.Add("padding",Padding);
			if (PointFormat != PointFormat_DefaultValue) h.Add("pointFormat",PointFormat);
			if (PointFormatter != PointFormatter_DefaultValue) { h.Add("pointFormatter",PointFormatter); Highstock.AddFunction("PlotOptionsRsiTooltipPointFormatter.pointFormatter", PointFormatter); }  
