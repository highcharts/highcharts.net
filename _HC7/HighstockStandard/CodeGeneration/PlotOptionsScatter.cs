...
namespace Highsoft.Web.Mvc.Stocks
{
	public partial class PlotOptionsScatter  : BaseObject
	{
		...
		{
			Accessibility = Accessibility_DefaultValue = new PlotOptionsScatterAccessibility();
			AllowPointSelect = AllowPointSelect_DefaultValue = false;
			Animation = Animation_DefaultValue = new Animation() { Enabled = true };
			AnimationBool = AnimationBool_DefaultValue = true;
			AnimationLimit = AnimationLimit_DefaultValue = null;
			BoostBlending = BoostBlending_DefaultValue = PlotOptionsScatterBoostBlending.Undefined;
			BoostThreshold = BoostThreshold_DefaultValue = 5000;
			ClassName = ClassName_DefaultValue = "";
			Clip = Clip_DefaultValue = true;
			Cluster = Cluster_DefaultValue = new PlotOptionsScatterCluster();
			...
			Compare = Compare_DefaultValue = PlotOptionsScatterCompare.Percent;
			...
			DashStyle = DashStyle_DefaultValue = PlotOptionsScatterDashStyle.Null;
			DataGrouping = DataGrouping_DefaultValue = new PlotOptionsScatterDataGrouping();
			DataLabels = DataLabels_DefaultValue = new PlotOptionsScatterDataLabels();
			DataSorting = DataSorting_DefaultValue = new PlotOptionsScatterDataSorting();
			Description = Description_DefaultValue = "";
			DragDrop = DragDrop_DefaultValue = new PlotOptionsScatterDragDrop();
			...
			GapUnit = GapUnit_DefaultValue = PlotOptionsScatterGapUnit.Relative;
			...
			LastPrice = LastPrice_DefaultValue = new PlotOptionsScatterLastPrice();
			LastVisiblePrice = LastVisiblePrice_DefaultValue = new PlotOptionsScatterLastVisiblePrice();
			LegendSymbol = LegendSymbol_DefaultValue = PlotOptionsScatterLegendSymbol.Rectangle;
			...
			OnPoint = OnPoint_DefaultValue = new PlotOptionsScatterOnPoint();
			...
			PointIntervalUnit = PointIntervalUnit_DefaultValue = PlotOptionsScatterPointIntervalUnit.Null;
			...
			Sonification = Sonification_DefaultValue = new PlotOptionsScatterSonification();
			Stacking = Stacking_DefaultValue = PlotOptionsScatterStacking.Null;
			States = States_DefaultValue = new PlotOptionsScatterStates();
			Step = Step_DefaultValue = PlotOptionsScatterStep.Null;
			StickyTracking = StickyTracking_DefaultValue = false;
			Threshold = Threshold_DefaultValue = 0;
			TurboThreshold = TurboThreshold_DefaultValue = 1000;
			Visible = Visible_DefaultValue = true;
			ZoneAxis = ZoneAxis_DefaultValue = "y";
			Zones = Zones_DefaultValue = new List<PlotOptionsScatterZones>();
		...
		/// </summary>
		public PlotOptionsScatterAccessibility Accessibility { get; set; }
		private PlotOptionsScatterAccessibility Accessibility_DefaultValue { get; set; }
		...
		/// </summary>
		public PlotOptionsScatterBoostBlending BoostBlending { get; set; }
		private PlotOptionsScatterBoostBlending BoostBlending_DefaultValue { get; set; }
		...
		/// </summary>
		public PlotOptionsScatterCluster Cluster { get; set; }
		private PlotOptionsScatterCluster Cluster_DefaultValue { get; set; }
		...
		/// </summary>
		public PlotOptionsScatterCompare Compare { get; set; }
		private PlotOptionsScatterCompare Compare_DefaultValue { get; set; }
		...
		/// </summary>
		public PlotOptionsScatterDataSorting DataSorting { get; set; }
		private PlotOptionsScatterDataSorting DataSorting_DefaultValue { get; set; }
		...
		/// </summary>
		public PlotOptionsScatterDragDrop DragDrop { get; set; }
		private PlotOptionsScatterDragDrop DragDrop_DefaultValue { get; set; }
		...
		/// </summary>
		public PlotOptionsScatterGapUnit GapUnit { get; set; }
		private PlotOptionsScatterGapUnit GapUnit_DefaultValue { get; set; }
		...
		/// </summary>
		public PlotOptionsScatterJitter Jitter { get; set; }
		private PlotOptionsScatterJitter Jitter_DefaultValue { get; set; }
		...
		/// </summary>
		public PlotOptionsScatterLastPrice LastPrice { get; set; }
		private PlotOptionsScatterLastPrice LastPrice_DefaultValue { get; set; }
		 

		/// <summary>
		/// The line marks the last price from visible range of points.
		/// </summary>
		public PlotOptionsScatterLastVisiblePrice LastVisiblePrice { get; set; }
		private PlotOptionsScatterLastVisiblePrice LastVisiblePrice_DefaultValue { get; set; }
		 

		/// <summary>
		/// What type of legend symbol to render for this series. Can be one of`areaMarker`, `lineMarker` or `rectangle`.
		/// </summary>
		public PlotOptionsScatterLegendSymbol LegendSymbol { get; set; }
		private PlotOptionsScatterLegendSymbol LegendSymbol_DefaultValue { get; set; }
		 

		/// <summary>
		/// The line cap used for line ends and line joins on the graph.
		/// </summary>
		public PlotOptionsScatterLinecap Linecap { get; set; }
		private PlotOptionsScatterLinecap Linecap_DefaultValue { get; set; }
		...
		/// </summary>
		public PlotOptionsScatterOnPoint OnPoint { get; set; }
		private PlotOptionsScatterOnPoint OnPoint_DefaultValue { get; set; }
		...
		/// </summary>
		public PlotOptionsScatterSonification Sonification { get; set; }
		private PlotOptionsScatterSonification Sonification_DefaultValue { get; set; }
		...
		/// </summary>
		public PlotOptionsScatterStep Step { get; set; }
		private PlotOptionsScatterStep Step_DefaultValue { get; set; }
