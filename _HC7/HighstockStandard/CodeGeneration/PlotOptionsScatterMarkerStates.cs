...
namespace Highsoft.Web.Mvc.Stocks
{
	public partial class PlotOptionsScatterMarkerStates  : BaseObject
	{
		public PlotOptionsScatterMarkerStates()
		{
			...
			Inactive = Inactive_DefaultValue = new PlotOptionsScatterMarkerStatesInactive();
			Normal = Normal_DefaultValue = new PlotOptionsScatterMarkerStatesNormal();
		...
		/// 
		/// </summary>
		public PlotOptionsScatterMarkerStatesInactive Inactive { get; set; }
		private PlotOptionsScatterMarkerStatesInactive Inactive_DefaultValue { get; set; }
		 

		/// <summary>
		/// The normal state of a single point marker. Currently onlyused for setting animation when returning to normal statefrom hover.
		/// </summary>
		public PlotOptionsScatterMarkerStatesNormal Normal { get; set; }
		private PlotOptionsScatterMarkerStatesNormal Normal_DefaultValue { get; set; }
