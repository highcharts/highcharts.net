...
{
	public partial class PlotOptionsScatterSonificationContextTracksMapping  : BaseObject
	{
		Hashtable h = new Hashtable();

		public PlotOptionsScatterSonificationContextTracksMapping()
		{
			Frequency = Frequency_DefaultValue = new PlotOptionsScatterSonificationContextTracksMappingFrequency();
			GapBetweenNotes = GapBetweenNotes_DefaultValue = new PlotOptionsScatterSonificationContextTracksMappingGapBetweenNotes();
			Highpass = Highpass_DefaultValue = new PlotOptionsScatterSonificationContextTracksMappingHighpass();
			Lowpass = Lowpass_DefaultValue = new PlotOptionsScatterSonificationContextTracksMappingLowpass();
			NoteDuration = NoteDuration_DefaultValue = new PlotOptionsScatterSonificationContextTracksMappingNoteDuration();
			Pan = Pan_DefaultValue = new PlotOptionsScatterSonificationContextTracksMappingPan();
			Pitch = Pitch_DefaultValue = new PlotOptionsScatterSonificationContextTracksMappingPitch();
			PitchString = PitchString_DefaultValue = "null";
			PitchNumber = PitchNumber_DefaultValue = null;
			PlayDelay = PlayDelay_DefaultValue = new PlotOptionsScatterSonificationContextTracksMappingPlayDelay();
			Time = Time_DefaultValue = new PlotOptionsScatterSonificationContextTracksMappingTime();
			TimeString = TimeString_DefaultValue = "null";
			TimeNumber = TimeNumber_DefaultValue = null;
			Tremolo = Tremolo_DefaultValue = new PlotOptionsScatterSonificationContextTracksMappingTremolo();
			Volume = Volume_DefaultValue = new PlotOptionsScatterSonificationContextTracksMappingVolume();
		...
		/// </summary>
		public PlotOptionsScatterSonificationContextTracksMappingFrequency Frequency { get; set; }
		private PlotOptionsScatterSonificationContextTracksMappingFrequency Frequency_DefaultValue { get; set; }
		...
		/// </summary>
		public PlotOptionsScatterSonificationContextTracksMappingGapBetweenNotes GapBetweenNotes { get; set; }
		private PlotOptionsScatterSonificationContextTracksMappingGapBetweenNotes GapBetweenNotes_DefaultValue { get; set; }
		...
		/// </summary>
		public PlotOptionsScatterSonificationContextTracksMappingHighpass Highpass { get; set; }
		private PlotOptionsScatterSonificationContextTracksMappingHighpass Highpass_DefaultValue { get; set; }
		...
		/// </summary>
		public PlotOptionsScatterSonificationContextTracksMappingLowpass Lowpass { get; set; }
		private PlotOptionsScatterSonificationContextTracksMappingLowpass Lowpass_DefaultValue { get; set; }
		...
		/// </summary>
		public PlotOptionsScatterSonificationContextTracksMappingNoteDuration NoteDuration { get; set; }
		private PlotOptionsScatterSonificationContextTracksMappingNoteDuration NoteDuration_DefaultValue { get; set; }
		...
		/// </summary>
		public PlotOptionsScatterSonificationContextTracksMappingPan Pan { get; set; }
		private PlotOptionsScatterSonificationContextTracksMappingPan Pan_DefaultValue { get; set; }
		...
		/// </summary>
		public PlotOptionsScatterSonificationContextTracksMappingPitch Pitch { get; set; }
		private PlotOptionsScatterSonificationContextTracksMappingPitch Pitch_DefaultValue { get; set; }
		...
		/// </summary>
		public PlotOptionsScatterSonificationContextTracksMappingPlayDelay PlayDelay { get; set; }
		private PlotOptionsScatterSonificationContextTracksMappingPlayDelay PlayDelay_DefaultValue { get; set; }
		...
		/// </summary>
		public PlotOptionsScatterSonificationContextTracksMappingTime Time { get; set; }
		private PlotOptionsScatterSonificationContextTracksMappingTime Time_DefaultValue { get; set; }
		...
		/// </summary>
		public PlotOptionsScatterSonificationContextTracksMappingTremolo Tremolo { get; set; }
		private PlotOptionsScatterSonificationContextTracksMappingTremolo Tremolo_DefaultValue { get; set; }
		 

		/// <summary>
		/// The volume of notes, from 0 to 1.
		/// </summary>
		public PlotOptionsScatterSonificationContextTracksMappingVolume Volume { get; set; }
		private PlotOptionsScatterSonificationContextTracksMappingVolume Volume_DefaultValue { get; set; }
