...
namespace Highsoft.Web.Mvc.Stocks
{
	public partial class PlotOptionsSeries  : BaseObject
	{
		...
		{
			Accessibility = Accessibility_DefaultValue = new PlotOptionsSeriesAccessibility();
			AllowPointSelect = AllowPointSelect_DefaultValue = false;
			Animation = Animation_DefaultValue = new Animation() { Enabled = true };
			AnimationBool = AnimationBool_DefaultValue = true;
			AnimationLimit = AnimationLimit_DefaultValue = null;
			BoostBlending = BoostBlending_DefaultValue = PlotOptionsSeriesBoostBlending.Undefined;
			...
			Compare = Compare_DefaultValue = PlotOptionsSeriesCompare.Percent;
			...
			DashStyle = DashStyle_DefaultValue = PlotOptionsSeriesDashStyle.Null;
			...
			DataSorting = DataSorting_DefaultValue = new PlotOptionsSeriesDataSorting();
			Description = Description_DefaultValue = "";
			DragDrop = DragDrop_DefaultValue = new PlotOptionsSeriesDragDrop();
			...
			LastPrice = LastPrice_DefaultValue = new PlotOptionsSeriesLastPrice();
			LastVisiblePrice = LastVisiblePrice_DefaultValue = new PlotOptionsSeriesLastVisiblePrice();
			LegendSymbol = LegendSymbol_DefaultValue = PlotOptionsSeriesLegendSymbol.Rectangle;
			...
			OnPoint = OnPoint_DefaultValue = new PlotOptionsSeriesOnPoint();
			...
			Sonification = Sonification_DefaultValue = new PlotOptionsSeriesSonification();
			...
			Zones = Zones_DefaultValue = new List<PlotOptionsSeriesZones>();
		...
		private PlotOptionsSeriesCompare Compare_DefaultValue { get; set; }
		...
		private PlotOptionsSeriesLastPrice LastPrice_DefaultValue { get; set; }
		...
		private PlotOptionsSeriesLastVisiblePrice LastVisiblePrice_DefaultValue { get; set; }
		...
		private List<PlotOptionsSeriesZones> Zones_DefaultValue { get; set; }
