...
{
	public partial class PlotOptionsSeriesSonificationTracks  : BaseObject
	{
		Hashtable h = new Hashtable();

		public PlotOptionsSeriesSonificationTracks()
		{
			ActiveWhen = ActiveWhen_DefaultValue = new PlotOptionsSeriesSonificationTracksActiveWhen();
			Instrument = Instrument_DefaultValue = null;
			InstrumentString = InstrumentString_DefaultValue = "null";
			Mapping = Mapping_DefaultValue = new PlotOptionsSeriesSonificationTracksMapping();
			MidiName = MidiName_DefaultValue = "";
			PointGrouping = PointGrouping_DefaultValue = new PlotOptionsSeriesSonificationTracksPointGrouping();
			RoundToMusicalNotes = RoundToMusicalNotes_DefaultValue = true;
			ShowPlayMarker = ShowPlayMarker_DefaultValue = true;
			Type = Type_DefaultValue = PlotOptionsSeriesSonificationTracksType.Instrument;
		...
		/// </summary>
		public PlotOptionsSeriesSonificationTracksActiveWhen ActiveWhen { get; set; }
		private PlotOptionsSeriesSonificationTracksActiveWhen ActiveWhen_DefaultValue { get; set; }
		...
		/// </summary>
		public PlotOptionsSeriesSonificationTracksMapping Mapping { get; set; }
		private PlotOptionsSeriesSonificationTracksMapping Mapping_DefaultValue { get; set; }
		...
		/// </summary>
		public PlotOptionsSeriesSonificationTracksPointGrouping PointGrouping { get; set; }
		private PlotOptionsSeriesSonificationTracksPointGrouping PointGrouping_DefaultValue { get; set; }
		...
		/// </summary>
		public PlotOptionsSeriesSonificationTracksType Type { get; set; }
		private PlotOptionsSeriesSonificationTracksType Type_DefaultValue { get; set; }
