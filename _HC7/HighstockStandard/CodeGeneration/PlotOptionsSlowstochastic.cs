...
namespace Highsoft.Web.Mvc.Stocks
{
	public partial class PlotOptionsSlowstochastic  : BaseObject
	{
		...
		public PlotOptionsSlowstochastic()
		{
			...
			Zones = Zones_DefaultValue = new List<PlotOptionsSlowstochasticZone>();
		...
		/// </summary>
		public List<PlotOptionsSlowstochasticZone> Zones { get; set; }
		private List<PlotOptionsSlowstochasticZone> Zones_DefaultValue { get; set; }
