...
{
	public partial class PlotOptionsSlowstochastic  : BaseObject
	{
		Hashtable h = new Hashtable();

		public PlotOptionsSlowstochastic()
		{
			Accessibility = Accessibility_DefaultValue = new PlotOptionsSlowstochasticAccessibility();
			AllowPointSelect = AllowPointSelect_DefaultValue = false;
			Animation = Animation_DefaultValue = new Animation() { Enabled = true };
			AnimationBool = AnimationBool_DefaultValue = true;
			AnimationLimit = AnimationLimit_DefaultValue = null;
			BoostBlending = BoostBlending_DefaultValue = PlotOptionsSlowstochasticBoostBlending.Undefined;
			...
			Compare = Compare_DefaultValue = PlotOptionsSlowstochasticCompare.Percent;
			CompareBase = CompareBase_DefaultValue = PlotOptionsSlowstochasticCompareBase.Min;
			...
			Cursor = Cursor_DefaultValue = PlotOptionsSlowstochasticCursor.Null;
			Custom = Custom_DefaultValue = new Hashtable();
			DashStyle = DashStyle_DefaultValue = PlotOptionsSlowstochasticDashStyle.Null;
			DataGrouping = DataGrouping_DefaultValue = new PlotOptionsSlowstochasticDataGrouping();
			DataLabels = DataLabels_DefaultValue = new PlotOptionsSlowstochasticDataLabels();
			DataSorting = DataSorting_DefaultValue = new PlotOptionsSlowstochasticDataSorting();
			Description = Description_DefaultValue = "";
			EnableMouseTracking = EnableMouseTracking_DefaultValue = true;
			Events = Events_DefaultValue = new PlotOptionsSlowstochasticEvents();
			FindNearestPointBy = FindNearestPointBy_DefaultValue = PlotOptionsSlowstochasticFindNearestPointBy.X;
			GapSize = GapSize_DefaultValue = 0;
			GapUnit = GapUnit_DefaultValue = PlotOptionsSlowstochasticGapUnit.Relative;
			GetExtremesFromAll = GetExtremesFromAll_DefaultValue = false;
			InactiveOtherPoints = InactiveOtherPoints_DefaultValue = false;
			IncludeInDataExport = IncludeInDataExport_DefaultValue = null;
			Label = Label_DefaultValue = new PlotOptionsSlowstochasticLabel();
			LastPrice = LastPrice_DefaultValue = new PlotOptionsSlowstochasticLastPrice();
			LastVisiblePrice = LastVisiblePrice_DefaultValue = new PlotOptionsSlowstochasticLastVisiblePrice();
			LegendSymbol = LegendSymbol_DefaultValue = PlotOptionsSlowstochasticLegendSymbol.Rectangle;
			Linecap = Linecap_DefaultValue = PlotOptionsSlowstochasticLinecap.Round;
			LineWidth = LineWidth_DefaultValue = 2;
			LinkedTo = LinkedTo_DefaultValue = "";
			Marker = Marker_DefaultValue = new PlotOptionsSlowstochasticMarker();
			NegativeColor = NegativeColor_DefaultValue = "";
			OnPoint = OnPoint_DefaultValue = new PlotOptionsSlowstochasticOnPoint();
			Opacity = Opacity_DefaultValue = 1;
			Params = Params_DefaultValue = new PlotOptionsSlowstochasticParams();
			Point = Point_DefaultValue = new PlotOptionsSlowstochasticPoint();
			...
			SmoothedLine = SmoothedLine_DefaultValue = new PlotOptionsSlowstochasticSmoothedLine();
			SoftThreshold = SoftThreshold_DefaultValue = true;
			Sonification = Sonification_DefaultValue = new PlotOptionsSlowstochasticSonification();
			States = States_DefaultValue = new PlotOptionsSlowstochasticStates();
			Step = Step_DefaultValue = PlotOptionsSlowstochasticStep.Null;
			StickyTracking = StickyTracking_DefaultValue = true;
			Threshold = Threshold_DefaultValue = 0;
			Tooltip = Tooltip_DefaultValue = new PlotOptionsSlowstochasticTooltip();
			TurboThreshold = TurboThreshold_DefaultValue = 1000;
			Visible = Visible_DefaultValue = true;
			ZoneAxis = ZoneAxis_DefaultValue = "y";
			Zones = Zones_DefaultValue = new List<PlotOptionsSlowstochasticZones>();
		...
		/// </summary>
		public PlotOptionsSlowstochasticAccessibility Accessibility { get; set; }
		private PlotOptionsSlowstochasticAccessibility Accessibility_DefaultValue { get; set; }
		...
		/// </summary>
		public PlotOptionsSlowstochasticBoostBlending BoostBlending { get; set; }
		private PlotOptionsSlowstochasticBoostBlending BoostBlending_DefaultValue { get; set; }
		...
		/// </summary>
		public PlotOptionsSlowstochasticCompare Compare { get; set; }
		private PlotOptionsSlowstochasticCompare Compare_DefaultValue { get; set; }
		 

		/// <summary>
		/// When [compare](#plotOptions.series.compare) is `percent`, this optiondictates whether to use 0 or 100 as the base of comparison.
		/// </summary>
		public PlotOptionsSlowstochasticCompareBase CompareBase { get; set; }
		private PlotOptionsSlowstochasticCompareBase CompareBase_DefaultValue { get; set; }
		...
		/// </summary>
		public PlotOptionsSlowstochasticCursor Cursor { get; set; }
		private PlotOptionsSlowstochasticCursor Cursor_DefaultValue { get; set; }
		...
		/// </summary>
		public PlotOptionsSlowstochasticDashStyle DashStyle { get; set; }
		private PlotOptionsSlowstochasticDashStyle DashStyle_DefaultValue { get; set; }
		...
		/// </summary>
		public PlotOptionsSlowstochasticDataGrouping DataGrouping { get; set; }
		private PlotOptionsSlowstochasticDataGrouping DataGrouping_DefaultValue { get; set; }
		...
		/// </summary>
		public PlotOptionsSlowstochasticDataLabels DataLabels { get; set; }
		private PlotOptionsSlowstochasticDataLabels DataLabels_DefaultValue { get; set; }
		 

		/// <summary>
		/// Options for the series data sorting.
		/// </summary>
		public PlotOptionsSlowstochasticDataSorting DataSorting { get; set; }
		private PlotOptionsSlowstochasticDataSorting DataSorting_DefaultValue { get; set; }
		...
		/// </summary>
		public PlotOptionsSlowstochasticEvents Events { get; set; }
		private PlotOptionsSlowstochasticEvents Events_DefaultValue { get; set; }
		...
		/// </summary>
		public PlotOptionsSlowstochasticFindNearestPointBy FindNearestPointBy { get; set; }
		private PlotOptionsSlowstochasticFindNearestPointBy FindNearestPointBy_DefaultValue { get; set; }
		...
		/// </summary>
		public PlotOptionsSlowstochasticGapUnit GapUnit { get; set; }
		private PlotOptionsSlowstochasticGapUnit GapUnit_DefaultValue { get; set; }
		...
		/// </summary>
		public PlotOptionsSlowstochasticLabel Label { get; set; }
		private PlotOptionsSlowstochasticLabel Label_DefaultValue { get; set; }
		 

		/// <summary>
		/// The line marks the last price from all points.
		/// </summary>
		public PlotOptionsSlowstochasticLastPrice LastPrice { get; set; }
		private PlotOptionsSlowstochasticLastPrice LastPrice_DefaultValue { get; set; }
		 

		/// <summary>
		/// The line marks the last price from visible range of points.
		/// </summary>
		public PlotOptionsSlowstochasticLastVisiblePrice LastVisiblePrice { get; set; }
		private PlotOptionsSlowstochasticLastVisiblePrice LastVisiblePrice_DefaultValue { get; set; }
		 

		/// <summary>
		/// What type of legend symbol to render for this series. Can be one of`areaMarker`, `lineMarker` or `rectangle`.
		/// </summary>
		public PlotOptionsSlowstochasticLegendSymbol LegendSymbol { get; set; }
		private PlotOptionsSlowstochasticLegendSymbol LegendSymbol_DefaultValue { get; set; }
		 

		/// <summary>
		/// The line cap used for line ends and line joins on the graph.
		/// </summary>
		public PlotOptionsSlowstochasticLinecap Linecap { get; set; }
		private PlotOptionsSlowstochasticLinecap Linecap_DefaultValue { get; set; }
		...
		/// </summary>
		public PlotOptionsSlowstochasticMarker Marker { get; set; }
		private PlotOptionsSlowstochasticMarker Marker_DefaultValue { get; set; }
		...
		/// </summary>
		public PlotOptionsSlowstochasticOnPoint OnPoint { get; set; }
		private PlotOptionsSlowstochasticOnPoint OnPoint_DefaultValue { get; set; }
		...
		/// 
		/// </summary>
		public PlotOptionsSlowstochasticParams Params { get; set; }
		private PlotOptionsSlowstochasticParams Params_DefaultValue { get; set; }
		 

		/// <summary>
		/// Properties for each single point.
		/// </summary>
		public PlotOptionsSlowstochasticPoint Point { get; set; }
		private PlotOptionsSlowstochasticPoint Point_DefaultValue { get; set; }
		...
		/// </summary>
		public PlotOptionsSlowstochasticSmoothedLine SmoothedLine { get; set; }
		private PlotOptionsSlowstochasticSmoothedLine SmoothedLine_DefaultValue { get; set; }
		...
		/// </summary>
		public PlotOptionsSlowstochasticSonification Sonification { get; set; }
		private PlotOptionsSlowstochasticSonification Sonification_DefaultValue { get; set; }
		 

		/// <summary>
		/// 
		/// </summary>
		public PlotOptionsSlowstochasticStates States { get; set; }
		private PlotOptionsSlowstochasticStates States_DefaultValue { get; set; }
		 

		/// <summary>
		/// Whether to apply steps to the line. Possible values are `left`,`center` and `right`.
		/// </summary>
		public PlotOptionsSlowstochasticStep Step { get; set; }
		private PlotOptionsSlowstochasticStep Step_DefaultValue { get; set; }
		...
		/// </summary>
		public PlotOptionsSlowstochasticTooltip Tooltip { get; set; }
		private PlotOptionsSlowstochasticTooltip Tooltip_DefaultValue { get; set; }
		...
		/// </summary>
		public List<PlotOptionsSlowstochasticZones> Zones { get; set; }
		private List<PlotOptionsSlowstochasticZones> Zones_DefaultValue { get; set; }
		...
		internal override Hashtable ToHashtable(Highstock highstock)
		{
			...
			if (SmoothedLine.IsDirty(highstock)) h.Add("smoothedLine",SmoothedLine.ToHashtable(highstock));
