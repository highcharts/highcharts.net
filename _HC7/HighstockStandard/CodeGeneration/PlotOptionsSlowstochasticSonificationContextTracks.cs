...
{
	public partial class PlotOptionsSlowstochasticSonificationContextTracks  : BaseObject
	{
		Hashtable h = new Hashtable();

		public PlotOptionsSlowstochasticSonificationContextTracks()
		{
			ActiveWhen = ActiveWhen_DefaultValue = new PlotOptionsSlowstochasticSonificationContextTracksActiveWhen();
			Instrument = Instrument_DefaultValue = null;
			InstrumentString = InstrumentString_DefaultValue = "null";
			Mapping = Mapping_DefaultValue = new PlotOptionsSlowstochasticSonificationContextTracksMapping();
			MidiName = MidiName_DefaultValue = "";
			PointGrouping = PointGrouping_DefaultValue = new PlotOptionsSlowstochasticSonificationContextTracksPointGrouping();
			...
			Type = Type_DefaultValue = PlotOptionsSlowstochasticSonificationContextTracksType.Instrument;
			ValueInterval = ValueInterval_DefaultValue = null;
			ValueMapFunction = ValueMapFunction_DefaultValue = PlotOptionsSlowstochasticSonificationContextTracksValueMapFunction.Linear;
		...
		/// </summary>
		public PlotOptionsSlowstochasticSonificationContextTracksActiveWhen ActiveWhen { get; set; }
		private PlotOptionsSlowstochasticSonificationContextTracksActiveWhen ActiveWhen_DefaultValue { get; set; }
		...
		/// </summary>
		public PlotOptionsSlowstochasticSonificationContextTracksMapping Mapping { get; set; }
		private PlotOptionsSlowstochasticSonificationContextTracksMapping Mapping_DefaultValue { get; set; }
		...
		/// </summary>
		public PlotOptionsSlowstochasticSonificationContextTracksPointGrouping PointGrouping { get; set; }
		private PlotOptionsSlowstochasticSonificationContextTracksPointGrouping PointGrouping_DefaultValue { get; set; }
		...
		/// </summary>
		public PlotOptionsSlowstochasticSonificationContextTracksType Type { get; set; }
		private PlotOptionsSlowstochasticSonificationContextTracksType Type_DefaultValue { get; set; }
		...
		/// </summary>
		public PlotOptionsSlowstochasticSonificationContextTracksValueMapFunction ValueMapFunction { get; set; }
		private PlotOptionsSlowstochasticSonificationContextTracksValueMapFunction ValueMapFunction_DefaultValue { get; set; }
