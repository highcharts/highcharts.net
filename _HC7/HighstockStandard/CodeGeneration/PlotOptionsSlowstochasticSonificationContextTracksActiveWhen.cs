...
{
	public partial class PlotOptionsSlowstochasticSonificationContextTracksActiveWhen  : BaseObject
	{
		Hashtable h = new Hashtable();

		public PlotOptionsSlowstochasticSonificationContextTracksActiveWhen()
		{
		}	
