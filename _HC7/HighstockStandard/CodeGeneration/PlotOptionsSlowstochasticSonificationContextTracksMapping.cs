...
{
	public partial class PlotOptionsSlowstochasticSonificationContextTracksMapping  : BaseObject
	{
		Hashtable h = new Hashtable();

		public PlotOptionsSlowstochasticSonificationContextTracksMapping()
		{
			Frequency = Frequency_DefaultValue = new PlotOptionsSlowstochasticSonificationContextTracksMappingFrequency();
			GapBetweenNotes = GapBetweenNotes_DefaultValue = new PlotOptionsSlowstochasticSonificationContextTracksMappingGapBetweenNotes();
			Highpass = Highpass_DefaultValue = new PlotOptionsSlowstochasticSonificationContextTracksMappingHighpass();
			Lowpass = Lowpass_DefaultValue = new PlotOptionsSlowstochasticSonificationContextTracksMappingLowpass();
			NoteDuration = NoteDuration_DefaultValue = new PlotOptionsSlowstochasticSonificationContextTracksMappingNoteDuration();
			Pan = Pan_DefaultValue = new PlotOptionsSlowstochasticSonificationContextTracksMappingPan();
			Pitch = Pitch_DefaultValue = new PlotOptionsSlowstochasticSonificationContextTracksMappingPitch();
			PitchString = PitchString_DefaultValue = "null";
			PitchNumber = PitchNumber_DefaultValue = null;
			PlayDelay = PlayDelay_DefaultValue = new PlotOptionsSlowstochasticSonificationContextTracksMappingPlayDelay();
			Time = Time_DefaultValue = new PlotOptionsSlowstochasticSonificationContextTracksMappingTime();
			TimeString = TimeString_DefaultValue = "null";
			TimeNumber = TimeNumber_DefaultValue = null;
			Tremolo = Tremolo_DefaultValue = new PlotOptionsSlowstochasticSonificationContextTracksMappingTremolo();
			Volume = Volume_DefaultValue = new PlotOptionsSlowstochasticSonificationContextTracksMappingVolume();
		...
		/// </summary>
		public PlotOptionsSlowstochasticSonificationContextTracksMappingFrequency Frequency { get; set; }
		private PlotOptionsSlowstochasticSonificationContextTracksMappingFrequency Frequency_DefaultValue { get; set; }
		...
		/// </summary>
		public PlotOptionsSlowstochasticSonificationContextTracksMappingGapBetweenNotes GapBetweenNotes { get; set; }
		private PlotOptionsSlowstochasticSonificationContextTracksMappingGapBetweenNotes GapBetweenNotes_DefaultValue { get; set; }
		...
		/// </summary>
		public PlotOptionsSlowstochasticSonificationContextTracksMappingHighpass Highpass { get; set; }
		private PlotOptionsSlowstochasticSonificationContextTracksMappingHighpass Highpass_DefaultValue { get; set; }
		...
		/// </summary>
		public PlotOptionsSlowstochasticSonificationContextTracksMappingLowpass Lowpass { get; set; }
		private PlotOptionsSlowstochasticSonificationContextTracksMappingLowpass Lowpass_DefaultValue { get; set; }
		...
		/// </summary>
		public PlotOptionsSlowstochasticSonificationContextTracksMappingNoteDuration NoteDuration { get; set; }
		private PlotOptionsSlowstochasticSonificationContextTracksMappingNoteDuration NoteDuration_DefaultValue { get; set; }
		...
		/// </summary>
		public PlotOptionsSlowstochasticSonificationContextTracksMappingPan Pan { get; set; }
		private PlotOptionsSlowstochasticSonificationContextTracksMappingPan Pan_DefaultValue { get; set; }
		...
		/// </summary>
		public PlotOptionsSlowstochasticSonificationContextTracksMappingPitch Pitch { get; set; }
		private PlotOptionsSlowstochasticSonificationContextTracksMappingPitch Pitch_DefaultValue { get; set; }
		...
		/// </summary>
		public PlotOptionsSlowstochasticSonificationContextTracksMappingPlayDelay PlayDelay { get; set; }
		private PlotOptionsSlowstochasticSonificationContextTracksMappingPlayDelay PlayDelay_DefaultValue { get; set; }
		...
		/// </summary>
		public PlotOptionsSlowstochasticSonificationContextTracksMappingTime Time { get; set; }
		private PlotOptionsSlowstochasticSonificationContextTracksMappingTime Time_DefaultValue { get; set; }
		...
		/// </summary>
		public PlotOptionsSlowstochasticSonificationContextTracksMappingTremolo Tremolo { get; set; }
		private PlotOptionsSlowstochasticSonificationContextTracksMappingTremolo Tremolo_DefaultValue { get; set; }
		 

		/// <summary>
		/// The volume of notes, from 0 to 1.
		/// </summary>
		public PlotOptionsSlowstochasticSonificationContextTracksMappingVolume Volume { get; set; }
		private PlotOptionsSlowstochasticSonificationContextTracksMappingVolume Volume_DefaultValue { get; set; }
