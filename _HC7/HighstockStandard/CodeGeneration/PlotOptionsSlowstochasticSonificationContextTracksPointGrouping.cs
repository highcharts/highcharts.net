...
{
	public partial class PlotOptionsSlowstochasticSonificationContextTracksPointGrouping  : BaseObject
	{
		Hashtable h = new Hashtable();

		public PlotOptionsSlowstochasticSonificationContextTracksPointGrouping()
		{
			Algorithm = Algorithm_DefaultValue = PlotOptionsSlowstochasticSonificationContextTracksPointGroupingAlgorithm.Minimax;
		...
		/// </summary>
		public PlotOptionsSlowstochasticSonificationContextTracksPointGroupingAlgorithm Algorithm { get; set; }
		private PlotOptionsSlowstochasticSonificationContextTracksPointGroupingAlgorithm Algorithm_DefaultValue { get; set; }
