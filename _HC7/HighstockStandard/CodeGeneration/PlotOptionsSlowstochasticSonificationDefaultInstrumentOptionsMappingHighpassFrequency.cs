...
{
	public partial class PlotOptionsSlowstochasticSonificationDefaultInstrumentOptionsMappingHighpassFrequency  : BaseObject
	{
		Hashtable h = new Hashtable();

		public PlotOptionsSlowstochasticSonificationDefaultInstrumentOptionsMappingHighpassFrequency()
		{
			MapFunction = MapFunction_DefaultValue = PlotOptionsSlowstochasticSonificationDefaultInstrumentOptionsMappingHighpassFrequencyMapFunction.Linear;
			MapTo = MapTo_DefaultValue = "";
			Max = Max_DefaultValue = null;
			Min = Min_DefaultValue = null;
			Value = Value_DefaultValue = null;
			Within = Within_DefaultValue = PlotOptionsSlowstochasticSonificationDefaultInstrumentOptionsMappingHighpassFrequencyWithin.Chart;
		...
		/// </summary>
		public PlotOptionsSlowstochasticSonificationDefaultInstrumentOptionsMappingHighpassFrequencyMapFunction MapFunction { get; set; }
		private PlotOptionsSlowstochasticSonificationDefaultInstrumentOptionsMappingHighpassFrequencyMapFunction MapFunction_DefaultValue { get; set; }
		...
		/// </summary>
		public PlotOptionsSlowstochasticSonificationDefaultInstrumentOptionsMappingHighpassFrequencyWithin Within { get; set; }
		private PlotOptionsSlowstochasticSonificationDefaultInstrumentOptionsMappingHighpassFrequencyWithin Within_DefaultValue { get; set; }
