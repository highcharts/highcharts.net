...
{
	public partial class PlotOptionsSlowstochasticSonificationDefaultSpeechOptionsMappingGapBetweenNotes  : BaseObject
	{
		Hashtable h = new Hashtable();

		public PlotOptionsSlowstochasticSonificationDefaultSpeechOptionsMappingGapBetweenNotes()
		{
			MapFunction = MapFunction_DefaultValue = PlotOptionsSlowstochasticSonificationDefaultSpeechOptionsMappingGapBetweenNotesMapFunction.Linear;
			MapTo = MapTo_DefaultValue = "";
			Max = Max_DefaultValue = null;
			Min = Min_DefaultValue = null;
			Value = Value_DefaultValue = null;
			Within = Within_DefaultValue = PlotOptionsSlowstochasticSonificationDefaultSpeechOptionsMappingGapBetweenNotesWithin.Chart;
		...
		/// </summary>
		public PlotOptionsSlowstochasticSonificationDefaultSpeechOptionsMappingGapBetweenNotesMapFunction MapFunction { get; set; }
		private PlotOptionsSlowstochasticSonificationDefaultSpeechOptionsMappingGapBetweenNotesMapFunction MapFunction_DefaultValue { get; set; }
		...
		/// </summary>
		public PlotOptionsSlowstochasticSonificationDefaultSpeechOptionsMappingGapBetweenNotesWithin Within { get; set; }
		private PlotOptionsSlowstochasticSonificationDefaultSpeechOptionsMappingGapBetweenNotesWithin Within_DefaultValue { get; set; }
