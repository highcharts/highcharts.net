...
{
	public partial class PlotOptionsSlowstochasticSonificationPointGrouping  : BaseObject
	{
		Hashtable h = new Hashtable();

		public PlotOptionsSlowstochasticSonificationPointGrouping()
		{
			Algorithm = Algorithm_DefaultValue = PlotOptionsSlowstochasticSonificationPointGroupingAlgorithm.Minimax;
		...
		/// </summary>
		public PlotOptionsSlowstochasticSonificationPointGroupingAlgorithm Algorithm { get; set; }
		private PlotOptionsSlowstochasticSonificationPointGroupingAlgorithm Algorithm_DefaultValue { get; set; }
