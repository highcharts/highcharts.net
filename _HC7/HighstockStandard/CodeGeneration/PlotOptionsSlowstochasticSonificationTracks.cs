...
{
	public partial class PlotOptionsSlowstochasticSonificationTracks  : BaseObject
	{
		Hashtable h = new Hashtable();

		public PlotOptionsSlowstochasticSonificationTracks()
		{
			ActiveWhen = ActiveWhen_DefaultValue = new PlotOptionsSlowstochasticSonificationTracksActiveWhen();
			Instrument = Instrument_DefaultValue = null;
			InstrumentString = InstrumentString_DefaultValue = "null";
			Mapping = Mapping_DefaultValue = new PlotOptionsSlowstochasticSonificationTracksMapping();
			MidiName = MidiName_DefaultValue = "";
			PointGrouping = PointGrouping_DefaultValue = new PlotOptionsSlowstochasticSonificationTracksPointGrouping();
			RoundToMusicalNotes = RoundToMusicalNotes_DefaultValue = true;
			ShowPlayMarker = ShowPlayMarker_DefaultValue = true;
			Type = Type_DefaultValue = PlotOptionsSlowstochasticSonificationTracksType.Instrument;
		...
		/// </summary>
		public PlotOptionsSlowstochasticSonificationTracksActiveWhen ActiveWhen { get; set; }
		private PlotOptionsSlowstochasticSonificationTracksActiveWhen ActiveWhen_DefaultValue { get; set; }
		...
		/// </summary>
		public PlotOptionsSlowstochasticSonificationTracksMapping Mapping { get; set; }
		private PlotOptionsSlowstochasticSonificationTracksMapping Mapping_DefaultValue { get; set; }
		...
		/// </summary>
		public PlotOptionsSlowstochasticSonificationTracksPointGrouping PointGrouping { get; set; }
		private PlotOptionsSlowstochasticSonificationTracksPointGrouping PointGrouping_DefaultValue { get; set; }
		...
		/// </summary>
		public PlotOptionsSlowstochasticSonificationTracksType Type { get; set; }
		private PlotOptionsSlowstochasticSonificationTracksType Type_DefaultValue { get; set; }
