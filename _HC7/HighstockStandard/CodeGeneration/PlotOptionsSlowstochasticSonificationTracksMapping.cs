...
{
	public partial class PlotOptionsSlowstochasticSonificationTracksMapping  : BaseObject
	{
		Hashtable h = new Hashtable();

		public PlotOptionsSlowstochasticSonificationTracksMapping()
		{
			Frequency = Frequency_DefaultValue = new PlotOptionsSlowstochasticSonificationTracksMappingFrequency();
			GapBetweenNotes = GapBetweenNotes_DefaultValue = new PlotOptionsSlowstochasticSonificationTracksMappingGapBetweenNotes();
			Highpass = Highpass_DefaultValue = new PlotOptionsSlowstochasticSonificationTracksMappingHighpass();
			Lowpass = Lowpass_DefaultValue = new PlotOptionsSlowstochasticSonificationTracksMappingLowpass();
			NoteDuration = NoteDuration_DefaultValue = new PlotOptionsSlowstochasticSonificationTracksMappingNoteDuration();
			Pan = Pan_DefaultValue = new PlotOptionsSlowstochasticSonificationTracksMappingPan();
			Pitch = Pitch_DefaultValue = new PlotOptionsSlowstochasticSonificationTracksMappingPitch();
			PitchString = PitchString_DefaultValue = "null";
			PitchNumber = PitchNumber_DefaultValue = null;
			PlayDelay = PlayDelay_DefaultValue = new PlotOptionsSlowstochasticSonificationTracksMappingPlayDelay();
			Time = Time_DefaultValue = new PlotOptionsSlowstochasticSonificationTracksMappingTime();
			TimeString = TimeString_DefaultValue = "null";
			TimeNumber = TimeNumber_DefaultValue = null;
			Tremolo = Tremolo_DefaultValue = new PlotOptionsSlowstochasticSonificationTracksMappingTremolo();
			Volume = Volume_DefaultValue = new PlotOptionsSlowstochasticSonificationTracksMappingVolume();
		...
		/// </summary>
		public PlotOptionsSlowstochasticSonificationTracksMappingFrequency Frequency { get; set; }
		private PlotOptionsSlowstochasticSonificationTracksMappingFrequency Frequency_DefaultValue { get; set; }
		...
		/// </summary>
		public PlotOptionsSlowstochasticSonificationTracksMappingGapBetweenNotes GapBetweenNotes { get; set; }
		private PlotOptionsSlowstochasticSonificationTracksMappingGapBetweenNotes GapBetweenNotes_DefaultValue { get; set; }
		...
		/// </summary>
		public PlotOptionsSlowstochasticSonificationTracksMappingHighpass Highpass { get; set; }
		private PlotOptionsSlowstochasticSonificationTracksMappingHighpass Highpass_DefaultValue { get; set; }
		...
		/// </summary>
		public PlotOptionsSlowstochasticSonificationTracksMappingLowpass Lowpass { get; set; }
		private PlotOptionsSlowstochasticSonificationTracksMappingLowpass Lowpass_DefaultValue { get; set; }
		...
		/// </summary>
		public PlotOptionsSlowstochasticSonificationTracksMappingNoteDuration NoteDuration { get; set; }
		private PlotOptionsSlowstochasticSonificationTracksMappingNoteDuration NoteDuration_DefaultValue { get; set; }
		...
		/// </summary>
		public PlotOptionsSlowstochasticSonificationTracksMappingPan Pan { get; set; }
		private PlotOptionsSlowstochasticSonificationTracksMappingPan Pan_DefaultValue { get; set; }
		...
		/// </summary>
		public PlotOptionsSlowstochasticSonificationTracksMappingPitch Pitch { get; set; }
		private PlotOptionsSlowstochasticSonificationTracksMappingPitch Pitch_DefaultValue { get; set; }
		...
		/// </summary>
		public PlotOptionsSlowstochasticSonificationTracksMappingPlayDelay PlayDelay { get; set; }
		private PlotOptionsSlowstochasticSonificationTracksMappingPlayDelay PlayDelay_DefaultValue { get; set; }
		...
		/// </summary>
		public PlotOptionsSlowstochasticSonificationTracksMappingTime Time { get; set; }
		private PlotOptionsSlowstochasticSonificationTracksMappingTime Time_DefaultValue { get; set; }
		...
		/// </summary>
		public PlotOptionsSlowstochasticSonificationTracksMappingTremolo Tremolo { get; set; }
		private PlotOptionsSlowstochasticSonificationTracksMappingTremolo Tremolo_DefaultValue { get; set; }
		 

		/// <summary>
		/// The volume of notes, from 0 to 1.
		/// </summary>
		public PlotOptionsSlowstochasticSonificationTracksMappingVolume Volume { get; set; }
		private PlotOptionsSlowstochasticSonificationTracksMappingVolume Volume_DefaultValue { get; set; }
