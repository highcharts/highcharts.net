...
{
	public partial class PlotOptionsSlowstochasticSonificationTracksMappingPitch  : BaseObject
	{
		Hashtable h = new Hashtable();

		public PlotOptionsSlowstochasticSonificationTracksMappingPitch()
		{
			MapFunction = MapFunction_DefaultValue = PlotOptionsSlowstochasticSonificationTracksMappingPitchMapFunction.Linear;
		...
		/// </summary>
		public PlotOptionsSlowstochasticSonificationTracksMappingPitchMapFunction MapFunction { get; set; }
		private PlotOptionsSlowstochasticSonificationTracksMappingPitchMapFunction MapFunction_DefaultValue { get; set; }
