...
{
	public partial class PlotOptionsSlowstochasticSonificationTracksMappingVolume  : BaseObject
	{
		Hashtable h = new Hashtable();

		public PlotOptionsSlowstochasticSonificationTracksMappingVolume()
		{
			MapFunction = MapFunction_DefaultValue = PlotOptionsSlowstochasticSonificationTracksMappingVolumeMapFunction.Linear;
			MapTo = MapTo_DefaultValue = "";
			Max = Max_DefaultValue = null;
			Min = Min_DefaultValue = null;
			Value = Value_DefaultValue = null;
			Within = Within_DefaultValue = PlotOptionsSlowstochasticSonificationTracksMappingVolumeWithin.Chart;
		...
		/// </summary>
		public PlotOptionsSlowstochasticSonificationTracksMappingVolumeMapFunction MapFunction { get; set; }
		private PlotOptionsSlowstochasticSonificationTracksMappingVolumeMapFunction MapFunction_DefaultValue { get; set; }
		...
		/// </summary>
		public PlotOptionsSlowstochasticSonificationTracksMappingVolumeWithin Within { get; set; }
		private PlotOptionsSlowstochasticSonificationTracksMappingVolumeWithin Within_DefaultValue { get; set; }
