...
{
	public partial class PlotOptionsSlowstochasticSonificationTracksPointGrouping  : BaseObject
	{
		Hashtable h = new Hashtable();

		public PlotOptionsSlowstochasticSonificationTracksPointGrouping()
		{
			Algorithm = Algorithm_DefaultValue = PlotOptionsSlowstochasticSonificationTracksPointGroupingAlgorithm.Minimax;
		...
		/// </summary>
		public PlotOptionsSlowstochasticSonificationTracksPointGroupingAlgorithm Algorithm { get; set; }
		private PlotOptionsSlowstochasticSonificationTracksPointGroupingAlgorithm Algorithm_DefaultValue { get; set; }
