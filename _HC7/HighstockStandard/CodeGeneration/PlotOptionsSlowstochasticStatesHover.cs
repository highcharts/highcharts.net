...
{
	public partial class PlotOptionsSlowstochasticStatesHover  : BaseObject
	{
		Hashtable h = new Hashtable();

		public PlotOptionsSlowstochasticStatesHover()
		{
			Animation = Animation_DefaultValue = new Animation() { Enabled = true };
			Enabled = Enabled_DefaultValue = null;
			Halo = Halo_DefaultValue = new PlotOptionsSlowstochasticStatesHoverHalo();
			LineWidth = LineWidth_DefaultValue = null;
			LineWidthPlus = LineWidthPlus_DefaultValue = null;
			Marker = Marker_DefaultValue = new PlotOptionsSlowstochasticStatesHoverMarker();
		...
		/// </summary>
		public PlotOptionsSlowstochasticStatesHoverHalo Halo { get; set; }
		private PlotOptionsSlowstochasticStatesHoverHalo Halo_DefaultValue { get; set; }
		...
		/// </summary>
		public PlotOptionsSlowstochasticStatesHoverMarker Marker { get; set; }
		private PlotOptionsSlowstochasticStatesHoverMarker Marker_DefaultValue { get; set; }
