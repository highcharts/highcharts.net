...
{
	public partial class PlotOptionsSlowstochasticStatesSelect  : BaseObject
	{
		Hashtable h = new Hashtable();

		public PlotOptionsSlowstochasticStatesSelect()
		{
			Animation = Animation_DefaultValue = new Animation() { Enabled = true };
			AnimationBool = AnimationBool_DefaultValue = null;
			Enabled = Enabled_DefaultValue = true;
			Halo = Halo_DefaultValue = new PlotOptionsSlowstochasticStatesSelectHalo();
			LineWidth = LineWidth_DefaultValue = null;
			LineWidthPlus = LineWidthPlus_DefaultValue = 1;
			Marker = Marker_DefaultValue = new PlotOptionsSlowstochasticStatesSelectMarker();
		...
		/// </summary>
		public PlotOptionsSlowstochasticStatesSelectHalo Halo { get; set; }
		private PlotOptionsSlowstochasticStatesSelectHalo Halo_DefaultValue { get; set; }
		...
		/// </summary>
		public PlotOptionsSlowstochasticStatesSelectMarker Marker { get; set; }
		private PlotOptionsSlowstochasticStatesSelectMarker Marker_DefaultValue { get; set; }
