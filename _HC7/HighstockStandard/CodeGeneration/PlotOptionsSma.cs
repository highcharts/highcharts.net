...
{
	public partial class PlotOptionsSma  : BaseObject
	{
		Hashtable h = new Hashtable();

		public PlotOptionsSma()
		{
			Accessibility = Accessibility_DefaultValue = new PlotOptionsSmaAccessibility();
			AllowPointSelect = AllowPointSelect_DefaultValue = false;
			Animation = Animation_DefaultValue = new Animation() { Enabled = true };
			AnimationBool = AnimationBool_DefaultValue = true;
			AnimationLimit = AnimationLimit_DefaultValue = null;
			BoostBlending = BoostBlending_DefaultValue = PlotOptionsSmaBoostBlending.Undefined;
			...
			Compare = Compare_DefaultValue = PlotOptionsSmaCompare.Percent;
			CompareBase = CompareBase_DefaultValue = PlotOptionsSmaCompareBase.Min;
			...
			Cursor = Cursor_DefaultValue = PlotOptionsSmaCursor.Null;
			Custom = Custom_DefaultValue = new Hashtable();
			DashStyle = DashStyle_DefaultValue = PlotOptionsSmaDashStyle.Null;
			DataGrouping = DataGrouping_DefaultValue = new PlotOptionsSmaDataGrouping();
			DataLabels = DataLabels_DefaultValue = new PlotOptionsSmaDataLabels();
			DataSorting = DataSorting_DefaultValue = new PlotOptionsSmaDataSorting();
			Description = Description_DefaultValue = "";
			EnableMouseTracking = EnableMouseTracking_DefaultValue = true;
			Events = Events_DefaultValue = new PlotOptionsSmaEvents();
			FindNearestPointBy = FindNearestPointBy_DefaultValue = PlotOptionsSmaFindNearestPointBy.X;
			GapSize = GapSize_DefaultValue = 0;
			GapUnit = GapUnit_DefaultValue = PlotOptionsSmaGapUnit.Relative;
			GetExtremesFromAll = GetExtremesFromAll_DefaultValue = false;
			InactiveOtherPoints = InactiveOtherPoints_DefaultValue = false;
			IncludeInDataExport = IncludeInDataExport_DefaultValue = null;
			Label = Label_DefaultValue = new PlotOptionsSmaLabel();
			LastPrice = LastPrice_DefaultValue = new PlotOptionsSmaLastPrice();
			LastVisiblePrice = LastVisiblePrice_DefaultValue = new PlotOptionsSmaLastVisiblePrice();
			LegendSymbol = LegendSymbol_DefaultValue = PlotOptionsSmaLegendSymbol.Rectangle;
			Linecap = Linecap_DefaultValue = PlotOptionsSmaLinecap.Round;
			LineWidth = LineWidth_DefaultValue = 2;
			LinkedTo = LinkedTo_DefaultValue = "undefined";
			Marker = Marker_DefaultValue = new PlotOptionsSmaMarker();
			NegativeColor = NegativeColor_DefaultValue = "";
			OnPoint = OnPoint_DefaultValue = new PlotOptionsSmaOnPoint();
			Opacity = Opacity_DefaultValue = 1;
			Params = Params_DefaultValue = new PlotOptionsSmaParams();
			Point = Point_DefaultValue = new PlotOptionsSmaPoint();
			...
			Sonification = Sonification_DefaultValue = new PlotOptionsSmaSonification();
			States = States_DefaultValue = new PlotOptionsSmaStates();
			Step = Step_DefaultValue = PlotOptionsSmaStep.Null;
			StickyTracking = StickyTracking_DefaultValue = true;
			Threshold = Threshold_DefaultValue = 0;
			Tooltip = Tooltip_DefaultValue = new PlotOptionsSmaTooltip();
			TurboThreshold = TurboThreshold_DefaultValue = 1000;
			Visible = Visible_DefaultValue = true;
			ZoneAxis = ZoneAxis_DefaultValue = "y";
			Zones = Zones_DefaultValue = new List<PlotOptionsSmaZones>();
		...
		/// </summary>
		public PlotOptionsSmaAccessibility Accessibility { get; set; }
		private PlotOptionsSmaAccessibility Accessibility_DefaultValue { get; set; }
		...
		/// </summary>
		public PlotOptionsSmaBoostBlending BoostBlending { get; set; }
		private PlotOptionsSmaBoostBlending BoostBlending_DefaultValue { get; set; }
		...
		/// </summary>
		public PlotOptionsSmaCompare Compare { get; set; }
		private PlotOptionsSmaCompare Compare_DefaultValue { get; set; }
		 

		/// <summary>
		/// When [compare](#plotOptions.series.compare) is `percent`, this optiondictates whether to use 0 or 100 as the base of comparison.
		/// </summary>
		public PlotOptionsSmaCompareBase CompareBase { get; set; }
		private PlotOptionsSmaCompareBase CompareBase_DefaultValue { get; set; }
		...
		/// </summary>
		public PlotOptionsSmaCursor Cursor { get; set; }
		private PlotOptionsSmaCursor Cursor_DefaultValue { get; set; }
		...
		/// </summary>
		public PlotOptionsSmaDashStyle DashStyle { get; set; }
		private PlotOptionsSmaDashStyle DashStyle_DefaultValue { get; set; }
		...
		/// </summary>
		public PlotOptionsSmaDataGrouping DataGrouping { get; set; }
		private PlotOptionsSmaDataGrouping DataGrouping_DefaultValue { get; set; }
		...
		/// </summary>
		public PlotOptionsSmaDataLabels DataLabels { get; set; }
		private PlotOptionsSmaDataLabels DataLabels_DefaultValue { get; set; }
		 

		/// <summary>
		/// Options for the series data sorting.
		/// </summary>
		public PlotOptionsSmaDataSorting DataSorting { get; set; }
		private PlotOptionsSmaDataSorting DataSorting_DefaultValue { get; set; }
		...
		/// </summary>
		public PlotOptionsSmaEvents Events { get; set; }
		private PlotOptionsSmaEvents Events_DefaultValue { get; set; }
		...
		/// </summary>
		public PlotOptionsSmaFindNearestPointBy FindNearestPointBy { get; set; }
		private PlotOptionsSmaFindNearestPointBy FindNearestPointBy_DefaultValue { get; set; }
		...
		/// </summary>
		public PlotOptionsSmaGapUnit GapUnit { get; set; }
		private PlotOptionsSmaGapUnit GapUnit_DefaultValue { get; set; }
		...
		/// </summary>
		public PlotOptionsSmaLabel Label { get; set; }
		private PlotOptionsSmaLabel Label_DefaultValue { get; set; }
		 

		/// <summary>
		/// The line marks the last price from all points.
		/// </summary>
		public PlotOptionsSmaLastPrice LastPrice { get; set; }
		private PlotOptionsSmaLastPrice LastPrice_DefaultValue { get; set; }
		 

		/// <summary>
		/// The line marks the last price from visible range of points.
		/// </summary>
		public PlotOptionsSmaLastVisiblePrice LastVisiblePrice { get; set; }
		private PlotOptionsSmaLastVisiblePrice LastVisiblePrice_DefaultValue { get; set; }
		 

		/// <summary>
		/// What type of legend symbol to render for this series. Can be one of`lineMarker` or `rectangle`.
		/// </summary>
		public PlotOptionsSmaLegendSymbol LegendSymbol { get; set; }
		private PlotOptionsSmaLegendSymbol LegendSymbol_DefaultValue { get; set; }
		 

		/// <summary>
		/// The line cap used for line ends and line joins on the graph.
		/// </summary>
		public PlotOptionsSmaLinecap Linecap { get; set; }
		private PlotOptionsSmaLinecap Linecap_DefaultValue { get; set; }
		...
		/// <summary>
		/// The main series ID that indicator will be based on. Required for thisindicator.
		/// </summary>
		...
		/// </summary>
		public PlotOptionsSmaMarker Marker { get; set; }
		private PlotOptionsSmaMarker Marker_DefaultValue { get; set; }
		...
		/// </summary>
		public PlotOptionsSmaOnPoint OnPoint { get; set; }
		private PlotOptionsSmaOnPoint OnPoint_DefaultValue { get; set; }
		...
		/// </summary>
		public PlotOptionsSmaParams Params { get; set; }
		private PlotOptionsSmaParams Params_DefaultValue { get; set; }
		 

		/// <summary>
		/// Properties for each single point.
		/// </summary>
		public PlotOptionsSmaPoint Point { get; set; }
		private PlotOptionsSmaPoint Point_DefaultValue { get; set; }
		...
		/// </summary>
		public PlotOptionsSmaSonification Sonification { get; set; }
		private PlotOptionsSmaSonification Sonification_DefaultValue { get; set; }
		 

		/// <summary>
		/// 
		/// </summary>
		public PlotOptionsSmaStates States { get; set; }
		private PlotOptionsSmaStates States_DefaultValue { get; set; }
		 

		/// <summary>
		/// Whether to apply steps to the line. Possible values are `left`,`center` and `right`.
		/// </summary>
		public PlotOptionsSmaStep Step { get; set; }
		private PlotOptionsSmaStep Step_DefaultValue { get; set; }
		...
		/// 
		/// </summary>
		public PlotOptionsSmaTooltip Tooltip { get; set; }
		private PlotOptionsSmaTooltip Tooltip_DefaultValue { get; set; }
		...
		/// </summary>
		public List<PlotOptionsSmaZones> Zones { get; set; }
		private List<PlotOptionsSmaZones> Zones_DefaultValue { get; set; }
