...
namespace Highsoft.Web.Mvc.Stocks
{
	public partial class PlotOptionsSmaDataGrouping  : BaseObject
	{
		...
		internal override Hashtable ToHashtable()
		{
			...
			if (Approximation != Approximation_DefaultValue) { h.Add("approximation",Approximation); Highstock.AddFunction("PlotOptionsSmaDataGroupingApproximation.approximation", Approximation); }  
