...
{
	public partial class PlotOptionsSmaDragDropDragHandle  : BaseObject
	{
		public PlotOptionsSmaDragDropDragHandle()
		{
		...
		internal override Hashtable ToHashtable()
		{
			...
			if (PathFormatter != PathFormatter_DefaultValue) { h.Add("pathFormatter",PathFormatter); Highstock.AddFunction("PlotOptionsSmaDragDropDragHandlePathFormatter.pathFormatter", PathFormatter); }  
