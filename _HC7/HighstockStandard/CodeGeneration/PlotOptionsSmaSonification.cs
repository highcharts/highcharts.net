...
namespace Highsoft.Web.Mvc.Stocks
{
	public partial class PlotOptionsSmaSonification  : BaseObject
	{
		...
		{
			ContextTracks = ContextTracks_DefaultValue = new PlotOptionsSmaSonificationContextTracks();
			DefaultInstrumentOptions = DefaultInstrumentOptions_DefaultValue = new PlotOptionsSmaSonificationDefaultInstrumentOptions();
			DefaultSpeechOptions = DefaultSpeechOptions_DefaultValue = new PlotOptionsSmaSonificationDefaultSpeechOptions();
			Enabled = Enabled_DefaultValue = true;
			PointGrouping = PointGrouping_DefaultValue = new PlotOptionsSmaSonificationPointGrouping();
			Tracks = Tracks_DefaultValue = new PlotOptionsSmaSonificationTracks();
		...
		private PlotOptionsSmaSonificationContextTracks ContextTracks_DefaultValue { get; set; }
		...
		private PlotOptionsSmaSonificationDefaultInstrumentOptions DefaultInstrumentOptions_DefaultValue { get; set; }
		...
		private PlotOptionsSmaSonificationDefaultSpeechOptions DefaultSpeechOptions_DefaultValue { get; set; }
		...
		private PlotOptionsSmaSonificationPointGrouping PointGrouping_DefaultValue { get; set; }
		...
		private PlotOptionsSmaSonificationTracks Tracks_DefaultValue { get; set; }
