...
{
	public partial class PlotOptionsSmaSonificationContextTracksMapping  : BaseObject
	{
		Hashtable h = new Hashtable();

		public PlotOptionsSmaSonificationContextTracksMapping()
		{
			Frequency = Frequency_DefaultValue = new PlotOptionsSmaSonificationContextTracksMappingFrequency();
			GapBetweenNotes = GapBetweenNotes_DefaultValue = new PlotOptionsSmaSonificationContextTracksMappingGapBetweenNotes();
			Highpass = Highpass_DefaultValue = new PlotOptionsSmaSonificationContextTracksMappingHighpass();
			Lowpass = Lowpass_DefaultValue = new PlotOptionsSmaSonificationContextTracksMappingLowpass();
			NoteDuration = NoteDuration_DefaultValue = new PlotOptionsSmaSonificationContextTracksMappingNoteDuration();
			Pan = Pan_DefaultValue = new PlotOptionsSmaSonificationContextTracksMappingPan();
			Pitch = Pitch_DefaultValue = new PlotOptionsSmaSonificationContextTracksMappingPitch();
			PitchString = PitchString_DefaultValue = "null";
			PitchNumber = PitchNumber_DefaultValue = null;
			PlayDelay = PlayDelay_DefaultValue = new PlotOptionsSmaSonificationContextTracksMappingPlayDelay();
			Time = Time_DefaultValue = new PlotOptionsSmaSonificationContextTracksMappingTime();
			TimeString = TimeString_DefaultValue = "null";
			TimeNumber = TimeNumber_DefaultValue = null;
			Tremolo = Tremolo_DefaultValue = new PlotOptionsSmaSonificationContextTracksMappingTremolo();
			Volume = Volume_DefaultValue = new PlotOptionsSmaSonificationContextTracksMappingVolume();
		...
		/// </summary>
		public PlotOptionsSmaSonificationContextTracksMappingFrequency Frequency { get; set; }
		private PlotOptionsSmaSonificationContextTracksMappingFrequency Frequency_DefaultValue { get; set; }
		...
		/// </summary>
		public PlotOptionsSmaSonificationContextTracksMappingGapBetweenNotes GapBetweenNotes { get; set; }
		private PlotOptionsSmaSonificationContextTracksMappingGapBetweenNotes GapBetweenNotes_DefaultValue { get; set; }
		...
		/// </summary>
		public PlotOptionsSmaSonificationContextTracksMappingHighpass Highpass { get; set; }
		private PlotOptionsSmaSonificationContextTracksMappingHighpass Highpass_DefaultValue { get; set; }
		...
		/// </summary>
		public PlotOptionsSmaSonificationContextTracksMappingLowpass Lowpass { get; set; }
		private PlotOptionsSmaSonificationContextTracksMappingLowpass Lowpass_DefaultValue { get; set; }
		...
		/// </summary>
		public PlotOptionsSmaSonificationContextTracksMappingNoteDuration NoteDuration { get; set; }
		private PlotOptionsSmaSonificationContextTracksMappingNoteDuration NoteDuration_DefaultValue { get; set; }
		...
		/// </summary>
		public PlotOptionsSmaSonificationContextTracksMappingPan Pan { get; set; }
		private PlotOptionsSmaSonificationContextTracksMappingPan Pan_DefaultValue { get; set; }
		...
		/// </summary>
		public PlotOptionsSmaSonificationContextTracksMappingPitch Pitch { get; set; }
		private PlotOptionsSmaSonificationContextTracksMappingPitch Pitch_DefaultValue { get; set; }
		...
		/// </summary>
		public PlotOptionsSmaSonificationContextTracksMappingPlayDelay PlayDelay { get; set; }
		private PlotOptionsSmaSonificationContextTracksMappingPlayDelay PlayDelay_DefaultValue { get; set; }
		...
		/// </summary>
		public PlotOptionsSmaSonificationContextTracksMappingTime Time { get; set; }
		private PlotOptionsSmaSonificationContextTracksMappingTime Time_DefaultValue { get; set; }
		...
		/// </summary>
		public PlotOptionsSmaSonificationContextTracksMappingTremolo Tremolo { get; set; }
		private PlotOptionsSmaSonificationContextTracksMappingTremolo Tremolo_DefaultValue { get; set; }
		 

		/// <summary>
		/// The volume of notes, from 0 to 1.
		/// </summary>
		public PlotOptionsSmaSonificationContextTracksMappingVolume Volume { get; set; }
		private PlotOptionsSmaSonificationContextTracksMappingVolume Volume_DefaultValue { get; set; }
