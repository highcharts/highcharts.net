...
{
	public partial class PlotOptionsSmaSonificationContextTracksMappingPan  : BaseObject
	{
		Hashtable h = new Hashtable();

		public PlotOptionsSmaSonificationContextTracksMappingPan()
		{
			MapFunction = MapFunction_DefaultValue = PlotOptionsSmaSonificationContextTracksMappingPanMapFunction.Linear;
			MapTo = MapTo_DefaultValue = "";
			Max = Max_DefaultValue = null;
			Min = Min_DefaultValue = null;
			Value = Value_DefaultValue = null;
			Within = Within_DefaultValue = PlotOptionsSmaSonificationContextTracksMappingPanWithin.Chart;
		...
		/// </summary>
		public PlotOptionsSmaSonificationContextTracksMappingPanMapFunction MapFunction { get; set; }
		private PlotOptionsSmaSonificationContextTracksMappingPanMapFunction MapFunction_DefaultValue { get; set; }
		...
		/// </summary>
		public PlotOptionsSmaSonificationContextTracksMappingPanWithin Within { get; set; }
		private PlotOptionsSmaSonificationContextTracksMappingPanWithin Within_DefaultValue { get; set; }
