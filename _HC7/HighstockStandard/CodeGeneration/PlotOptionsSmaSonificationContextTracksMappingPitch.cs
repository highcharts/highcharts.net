...
{
	public partial class PlotOptionsSmaSonificationContextTracksMappingPitch  : BaseObject
	{
		Hashtable h = new Hashtable();

		public PlotOptionsSmaSonificationContextTracksMappingPitch()
		{
			MapFunction = MapFunction_DefaultValue = PlotOptionsSmaSonificationContextTracksMappingPitchMapFunction.Linear;
		...
		/// </summary>
		public PlotOptionsSmaSonificationContextTracksMappingPitchMapFunction MapFunction { get; set; }
		private PlotOptionsSmaSonificationContextTracksMappingPitchMapFunction MapFunction_DefaultValue { get; set; }
