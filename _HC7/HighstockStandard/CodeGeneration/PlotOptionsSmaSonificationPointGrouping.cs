...
{
	public partial class PlotOptionsSmaSonificationPointGrouping  : BaseObject
	{
		Hashtable h = new Hashtable();

		public PlotOptionsSmaSonificationPointGrouping()
		{
			Algorithm = Algorithm_DefaultValue = PlotOptionsSmaSonificationPointGroupingAlgorithm.Minimax;
		...
		/// </summary>
		public PlotOptionsSmaSonificationPointGroupingAlgorithm Algorithm { get; set; }
		private PlotOptionsSmaSonificationPointGroupingAlgorithm Algorithm_DefaultValue { get; set; }
