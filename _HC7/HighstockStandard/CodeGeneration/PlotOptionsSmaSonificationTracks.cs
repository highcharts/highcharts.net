...
{
	public partial class PlotOptionsSmaSonificationTracks  : BaseObject
	{
		Hashtable h = new Hashtable();

		public PlotOptionsSmaSonificationTracks()
		{
			ActiveWhen = ActiveWhen_DefaultValue = new PlotOptionsSmaSonificationTracksActiveWhen();
			Instrument = Instrument_DefaultValue = null;
			InstrumentString = InstrumentString_DefaultValue = "null";
			Mapping = Mapping_DefaultValue = new PlotOptionsSmaSonificationTracksMapping();
			MidiName = MidiName_DefaultValue = "";
			PointGrouping = PointGrouping_DefaultValue = new PlotOptionsSmaSonificationTracksPointGrouping();
			RoundToMusicalNotes = RoundToMusicalNotes_DefaultValue = true;
			ShowPlayMarker = ShowPlayMarker_DefaultValue = true;
			Type = Type_DefaultValue = PlotOptionsSmaSonificationTracksType.Instrument;
		...
		/// </summary>
		public PlotOptionsSmaSonificationTracksActiveWhen ActiveWhen { get; set; }
		private PlotOptionsSmaSonificationTracksActiveWhen ActiveWhen_DefaultValue { get; set; }
		...
		/// </summary>
		public PlotOptionsSmaSonificationTracksMapping Mapping { get; set; }
		private PlotOptionsSmaSonificationTracksMapping Mapping_DefaultValue { get; set; }
		...
		/// </summary>
		public PlotOptionsSmaSonificationTracksPointGrouping PointGrouping { get; set; }
		private PlotOptionsSmaSonificationTracksPointGrouping PointGrouping_DefaultValue { get; set; }
		...
		/// </summary>
		public PlotOptionsSmaSonificationTracksType Type { get; set; }
		private PlotOptionsSmaSonificationTracksType Type_DefaultValue { get; set; }
