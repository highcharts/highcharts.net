...
{
	public partial class PlotOptionsSmaSonificationTracksMappingNoteDuration  : BaseObject
	{
		Hashtable h = new Hashtable();

		public PlotOptionsSmaSonificationTracksMappingNoteDuration()
		{
			MapFunction = MapFunction_DefaultValue = PlotOptionsSmaSonificationTracksMappingNoteDurationMapFunction.Linear;
			MapTo = MapTo_DefaultValue = "";
			Max = Max_DefaultValue = null;
			Min = Min_DefaultValue = null;
			Value = Value_DefaultValue = null;
			Within = Within_DefaultValue = PlotOptionsSmaSonificationTracksMappingNoteDurationWithin.Chart;
		...
		/// </summary>
		public PlotOptionsSmaSonificationTracksMappingNoteDurationMapFunction MapFunction { get; set; }
		private PlotOptionsSmaSonificationTracksMappingNoteDurationMapFunction MapFunction_DefaultValue { get; set; }
		...
		/// </summary>
		public PlotOptionsSmaSonificationTracksMappingNoteDurationWithin Within { get; set; }
		private PlotOptionsSmaSonificationTracksMappingNoteDurationWithin Within_DefaultValue { get; set; }
