...
{
	public partial class PlotOptionsSmaSonificationTracksMappingPitch  : BaseObject
	{
		Hashtable h = new Hashtable();

		public PlotOptionsSmaSonificationTracksMappingPitch()
		{
			MapFunction = MapFunction_DefaultValue = PlotOptionsSmaSonificationTracksMappingPitchMapFunction.Linear;
		...
		/// </summary>
		public PlotOptionsSmaSonificationTracksMappingPitchMapFunction MapFunction { get; set; }
		private PlotOptionsSmaSonificationTracksMappingPitchMapFunction MapFunction_DefaultValue { get; set; }
