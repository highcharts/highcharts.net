...
{
	public partial class PlotOptionsSmaSonificationTracksMappingTime  : BaseObject
	{
		Hashtable h = new Hashtable();

		public PlotOptionsSmaSonificationTracksMappingTime()
		{
			MapFunction = MapFunction_DefaultValue = PlotOptionsSmaSonificationTracksMappingTimeMapFunction.Linear;
			MapTo = MapTo_DefaultValue = "";
			Max = Max_DefaultValue = null;
			Min = Min_DefaultValue = null;
			Value = Value_DefaultValue = null;
			Within = Within_DefaultValue = PlotOptionsSmaSonificationTracksMappingTimeWithin.Chart;
		...
		/// </summary>
		public PlotOptionsSmaSonificationTracksMappingTimeMapFunction MapFunction { get; set; }
		private PlotOptionsSmaSonificationTracksMappingTimeMapFunction MapFunction_DefaultValue { get; set; }
		...
		/// </summary>
		public PlotOptionsSmaSonificationTracksMappingTimeWithin Within { get; set; }
		private PlotOptionsSmaSonificationTracksMappingTimeWithin Within_DefaultValue { get; set; }
