...
{
	public partial class PlotOptionsSmaSonificationTracksMappingVolume  : BaseObject
	{
		Hashtable h = new Hashtable();

		public PlotOptionsSmaSonificationTracksMappingVolume()
		{
			MapFunction = MapFunction_DefaultValue = PlotOptionsSmaSonificationTracksMappingVolumeMapFunction.Linear;
			MapTo = MapTo_DefaultValue = "";
			Max = Max_DefaultValue = null;
			Min = Min_DefaultValue = null;
			Value = Value_DefaultValue = null;
			Within = Within_DefaultValue = PlotOptionsSmaSonificationTracksMappingVolumeWithin.Chart;
		...
		/// </summary>
		public PlotOptionsSmaSonificationTracksMappingVolumeMapFunction MapFunction { get; set; }
		private PlotOptionsSmaSonificationTracksMappingVolumeMapFunction MapFunction_DefaultValue { get; set; }
		...
		/// </summary>
		public PlotOptionsSmaSonificationTracksMappingVolumeWithin Within { get; set; }
		private PlotOptionsSmaSonificationTracksMappingVolumeWithin Within_DefaultValue { get; set; }
