...
{
	public partial class PlotOptionsSmaSonificationTracksPointGrouping  : BaseObject
	{
		Hashtable h = new Hashtable();

		public PlotOptionsSmaSonificationTracksPointGrouping()
		{
			Algorithm = Algorithm_DefaultValue = PlotOptionsSmaSonificationTracksPointGroupingAlgorithm.Minimax;
		...
		/// </summary>
		public PlotOptionsSmaSonificationTracksPointGroupingAlgorithm Algorithm { get; set; }
		private PlotOptionsSmaSonificationTracksPointGroupingAlgorithm Algorithm_DefaultValue { get; set; }
