...
namespace Highsoft.Web.Mvc.Stocks
{
	public partial class PlotOptionsSpline  : BaseObject
	{
		...
		{
			Accessibility = Accessibility_DefaultValue = new PlotOptionsSplineAccessibility();
			...
			Compare = Compare_DefaultValue = PlotOptionsSplineCompare.Percent;
			...
			DashStyle = DashStyle_DefaultValue = PlotOptionsSplineDashStyle.Null;
			DataGrouping = DataGrouping_DefaultValue = new PlotOptionsSplineDataGrouping();
			DataLabels = DataLabels_DefaultValue = new PlotOptionsSplineDataLabels();
			DataSorting = DataSorting_DefaultValue = new PlotOptionsSplineDataSorting();
			Description = Description_DefaultValue = "";
			DragDrop = DragDrop_DefaultValue = new PlotOptionsSplineDragDrop();
			...
			GapUnit = GapUnit_DefaultValue = PlotOptionsSplineGapUnit.Relative;
			...
			LastPrice = LastPrice_DefaultValue = new PlotOptionsSplineLastPrice();
			LastVisiblePrice = LastVisiblePrice_DefaultValue = new PlotOptionsSplineLastVisiblePrice();
			LegendSymbol = LegendSymbol_DefaultValue = PlotOptionsSplineLegendSymbol.Rectangle;
			...
			OnPoint = OnPoint_DefaultValue = new PlotOptionsSplineOnPoint();
			...
			Sonification = Sonification_DefaultValue = new PlotOptionsSplineSonification();
			...
			Zones = Zones_DefaultValue = new List<PlotOptionsSplineZones>();
		...
		/// </summary>
		public PlotOptionsSplineAccessibility Accessibility { get; set; }
		private PlotOptionsSplineAccessibility Accessibility_DefaultValue { get; set; }
		...
		/// </summary>
		public PlotOptionsSplineCompare Compare { get; set; }
		private PlotOptionsSplineCompare Compare_DefaultValue { get; set; }
		 

		/// <summary>
		/// When [compare](#plotOptions.series.compare) is `percent`, this optiondictates whether to use 0 or 100 as the base of comparison.
		/// </summary>
		public PlotOptionsSplineCompareBase CompareBase { get; set; }
		private PlotOptionsSplineCompareBase CompareBase_DefaultValue { get; set; }
		...
		/// </summary>
		public PlotOptionsSplineDataSorting DataSorting { get; set; }
		private PlotOptionsSplineDataSorting DataSorting_DefaultValue { get; set; }
		...
		/// </summary>
		public PlotOptionsSplineDragDrop DragDrop { get; set; }
		private PlotOptionsSplineDragDrop DragDrop_DefaultValue { get; set; }
		...
		/// </summary>
		public PlotOptionsSplineGapUnit GapUnit { get; set; }
		private PlotOptionsSplineGapUnit GapUnit_DefaultValue { get; set; }
		...
		/// </summary>
		public PlotOptionsSplineLastPrice LastPrice { get; set; }
		private PlotOptionsSplineLastPrice LastPrice_DefaultValue { get; set; }
		 

		/// <summary>
		/// The line marks the last price from visible range of points.
		/// </summary>
		public PlotOptionsSplineLastVisiblePrice LastVisiblePrice { get; set; }
		private PlotOptionsSplineLastVisiblePrice LastVisiblePrice_DefaultValue { get; set; }
		 

		/// <summary>
		/// What type of legend symbol to render for this series. Can be one of`areaMarker`, `lineMarker` or `rectangle`.
		/// </summary>
		public PlotOptionsSplineLegendSymbol LegendSymbol { get; set; }
		private PlotOptionsSplineLegendSymbol LegendSymbol_DefaultValue { get; set; }
		...
		/// </summary>
		public PlotOptionsSplineOnPoint OnPoint { get; set; }
		private PlotOptionsSplineOnPoint OnPoint_DefaultValue { get; set; }
		...
		/// </summary>
		public PlotOptionsSplineSonification Sonification { get; set; }
		private PlotOptionsSplineSonification Sonification_DefaultValue { get; set; }
		...
		/// </summary>
		public List<PlotOptionsSplineZones> Zones { get; set; }
		private List<PlotOptionsSplineZones> Zones_DefaultValue { get; set; }
