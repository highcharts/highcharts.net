...
{
	public partial class PlotOptionsSplineSonificationContextTracksMapping  : BaseObject
	{
		Hashtable h = new Hashtable();

		public PlotOptionsSplineSonificationContextTracksMapping()
		{
			Frequency = Frequency_DefaultValue = new PlotOptionsSplineSonificationContextTracksMappingFrequency();
			GapBetweenNotes = GapBetweenNotes_DefaultValue = new PlotOptionsSplineSonificationContextTracksMappingGapBetweenNotes();
			Highpass = Highpass_DefaultValue = new PlotOptionsSplineSonificationContextTracksMappingHighpass();
			Lowpass = Lowpass_DefaultValue = new PlotOptionsSplineSonificationContextTracksMappingLowpass();
			NoteDuration = NoteDuration_DefaultValue = new PlotOptionsSplineSonificationContextTracksMappingNoteDuration();
			Pan = Pan_DefaultValue = new PlotOptionsSplineSonificationContextTracksMappingPan();
			Pitch = Pitch_DefaultValue = new PlotOptionsSplineSonificationContextTracksMappingPitch();
			PitchString = PitchString_DefaultValue = "null";
			PitchNumber = PitchNumber_DefaultValue = null;
			PlayDelay = PlayDelay_DefaultValue = new PlotOptionsSplineSonificationContextTracksMappingPlayDelay();
			Time = Time_DefaultValue = new PlotOptionsSplineSonificationContextTracksMappingTime();
			TimeString = TimeString_DefaultValue = "null";
			TimeNumber = TimeNumber_DefaultValue = null;
			Tremolo = Tremolo_DefaultValue = new PlotOptionsSplineSonificationContextTracksMappingTremolo();
			Volume = Volume_DefaultValue = new PlotOptionsSplineSonificationContextTracksMappingVolume();
		...
		/// </summary>
		public PlotOptionsSplineSonificationContextTracksMappingFrequency Frequency { get; set; }
		private PlotOptionsSplineSonificationContextTracksMappingFrequency Frequency_DefaultValue { get; set; }
		...
		/// </summary>
		public PlotOptionsSplineSonificationContextTracksMappingGapBetweenNotes GapBetweenNotes { get; set; }
		private PlotOptionsSplineSonificationContextTracksMappingGapBetweenNotes GapBetweenNotes_DefaultValue { get; set; }
		...
		/// </summary>
		public PlotOptionsSplineSonificationContextTracksMappingHighpass Highpass { get; set; }
		private PlotOptionsSplineSonificationContextTracksMappingHighpass Highpass_DefaultValue { get; set; }
		...
		/// </summary>
		public PlotOptionsSplineSonificationContextTracksMappingLowpass Lowpass { get; set; }
		private PlotOptionsSplineSonificationContextTracksMappingLowpass Lowpass_DefaultValue { get; set; }
		...
		/// </summary>
		public PlotOptionsSplineSonificationContextTracksMappingNoteDuration NoteDuration { get; set; }
		private PlotOptionsSplineSonificationContextTracksMappingNoteDuration NoteDuration_DefaultValue { get; set; }
		...
		/// </summary>
		public PlotOptionsSplineSonificationContextTracksMappingPan Pan { get; set; }
		private PlotOptionsSplineSonificationContextTracksMappingPan Pan_DefaultValue { get; set; }
		...
		/// </summary>
		public PlotOptionsSplineSonificationContextTracksMappingPitch Pitch { get; set; }
		private PlotOptionsSplineSonificationContextTracksMappingPitch Pitch_DefaultValue { get; set; }
		...
		/// </summary>
		public PlotOptionsSplineSonificationContextTracksMappingPlayDelay PlayDelay { get; set; }
		private PlotOptionsSplineSonificationContextTracksMappingPlayDelay PlayDelay_DefaultValue { get; set; }
		...
		/// </summary>
		public PlotOptionsSplineSonificationContextTracksMappingTime Time { get; set; }
		private PlotOptionsSplineSonificationContextTracksMappingTime Time_DefaultValue { get; set; }
		...
		/// </summary>
		public PlotOptionsSplineSonificationContextTracksMappingTremolo Tremolo { get; set; }
		private PlotOptionsSplineSonificationContextTracksMappingTremolo Tremolo_DefaultValue { get; set; }
		 

		/// <summary>
		/// The volume of notes, from 0 to 1.
		/// </summary>
		public PlotOptionsSplineSonificationContextTracksMappingVolume Volume { get; set; }
		private PlotOptionsSplineSonificationContextTracksMappingVolume Volume_DefaultValue { get; set; }
