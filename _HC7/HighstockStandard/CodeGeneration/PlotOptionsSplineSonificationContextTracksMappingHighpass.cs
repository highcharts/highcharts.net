...
namespace Highsoft.Web.Mvc.Stocks
{
	public partial class PlotOptionsSplineSonificationContextTracksMappingHighpass  : BaseObject
	{
		...
		{
			Frequency = Frequency_DefaultValue = new PlotOptionsSplineSonificationContextTracksMappingHighpassFrequency();
			Resonance = Resonance_DefaultValue = new PlotOptionsSplineSonificationContextTracksMappingHighpassResonance();
		...
		private PlotOptionsSplineSonificationContextTracksMappingHighpassFrequency Frequency_DefaultValue { get; set; }
		...
		private PlotOptionsSplineSonificationContextTracksMappingHighpassResonance Resonance_DefaultValue { get; set; }
