...
{
	public partial class PlotOptionsSplineSonificationTracksMapping  : BaseObject
	{
		Hashtable h = new Hashtable();

		public PlotOptionsSplineSonificationTracksMapping()
		{
			Frequency = Frequency_DefaultValue = new PlotOptionsSplineSonificationTracksMappingFrequency();
			GapBetweenNotes = GapBetweenNotes_DefaultValue = new PlotOptionsSplineSonificationTracksMappingGapBetweenNotes();
			Highpass = Highpass_DefaultValue = new PlotOptionsSplineSonificationTracksMappingHighpass();
			Lowpass = Lowpass_DefaultValue = new PlotOptionsSplineSonificationTracksMappingLowpass();
			NoteDuration = NoteDuration_DefaultValue = new PlotOptionsSplineSonificationTracksMappingNoteDuration();
			Pan = Pan_DefaultValue = new PlotOptionsSplineSonificationTracksMappingPan();
			Pitch = Pitch_DefaultValue = new PlotOptionsSplineSonificationTracksMappingPitch();
			PitchString = PitchString_DefaultValue = "null";
			PitchNumber = PitchNumber_DefaultValue = null;
			PlayDelay = PlayDelay_DefaultValue = new PlotOptionsSplineSonificationTracksMappingPlayDelay();
			Time = Time_DefaultValue = new PlotOptionsSplineSonificationTracksMappingTime();
			TimeString = TimeString_DefaultValue = "null";
			TimeNumber = TimeNumber_DefaultValue = null;
			Tremolo = Tremolo_DefaultValue = new PlotOptionsSplineSonificationTracksMappingTremolo();
			Volume = Volume_DefaultValue = new PlotOptionsSplineSonificationTracksMappingVolume();
		...
		/// </summary>
		public PlotOptionsSplineSonificationTracksMappingFrequency Frequency { get; set; }
		private PlotOptionsSplineSonificationTracksMappingFrequency Frequency_DefaultValue { get; set; }
		...
		/// </summary>
		public PlotOptionsSplineSonificationTracksMappingGapBetweenNotes GapBetweenNotes { get; set; }
		private PlotOptionsSplineSonificationTracksMappingGapBetweenNotes GapBetweenNotes_DefaultValue { get; set; }
		...
		/// </summary>
		public PlotOptionsSplineSonificationTracksMappingHighpass Highpass { get; set; }
		private PlotOptionsSplineSonificationTracksMappingHighpass Highpass_DefaultValue { get; set; }
		...
		/// </summary>
		public PlotOptionsSplineSonificationTracksMappingLowpass Lowpass { get; set; }
		private PlotOptionsSplineSonificationTracksMappingLowpass Lowpass_DefaultValue { get; set; }
		...
		/// </summary>
		public PlotOptionsSplineSonificationTracksMappingNoteDuration NoteDuration { get; set; }
		private PlotOptionsSplineSonificationTracksMappingNoteDuration NoteDuration_DefaultValue { get; set; }
		...
		/// </summary>
		public PlotOptionsSplineSonificationTracksMappingPan Pan { get; set; }
		private PlotOptionsSplineSonificationTracksMappingPan Pan_DefaultValue { get; set; }
		...
		/// </summary>
		public PlotOptionsSplineSonificationTracksMappingPitch Pitch { get; set; }
		private PlotOptionsSplineSonificationTracksMappingPitch Pitch_DefaultValue { get; set; }
		...
		/// </summary>
		public PlotOptionsSplineSonificationTracksMappingPlayDelay PlayDelay { get; set; }
		private PlotOptionsSplineSonificationTracksMappingPlayDelay PlayDelay_DefaultValue { get; set; }
		...
		/// </summary>
		public PlotOptionsSplineSonificationTracksMappingTime Time { get; set; }
		private PlotOptionsSplineSonificationTracksMappingTime Time_DefaultValue { get; set; }
		...
		/// </summary>
		public PlotOptionsSplineSonificationTracksMappingTremolo Tremolo { get; set; }
		private PlotOptionsSplineSonificationTracksMappingTremolo Tremolo_DefaultValue { get; set; }
		 

		/// <summary>
		/// The volume of notes, from 0 to 1.
		/// </summary>
		public PlotOptionsSplineSonificationTracksMappingVolume Volume { get; set; }
		private PlotOptionsSplineSonificationTracksMappingVolume Volume_DefaultValue { get; set; }
