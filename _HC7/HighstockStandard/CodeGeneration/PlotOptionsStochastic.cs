...
{
	public partial class PlotOptionsStochastic  : BaseObject
	{
		Hashtable h = new Hashtable();

		public PlotOptionsStochastic()
		{
			Accessibility = Accessibility_DefaultValue = new PlotOptionsStochasticAccessibility();
			AllowPointSelect = AllowPointSelect_DefaultValue = false;
			Animation = Animation_DefaultValue = new Animation() { Enabled = true };
			AnimationBool = AnimationBool_DefaultValue = true;
			AnimationLimit = AnimationLimit_DefaultValue = null;
			BoostBlending = BoostBlending_DefaultValue = PlotOptionsStochasticBoostBlending.Undefined;
			...
			Compare = Compare_DefaultValue = PlotOptionsStochasticCompare.Percent;
			CompareBase = CompareBase_DefaultValue = PlotOptionsStochasticCompareBase.Min;
			...
			Cursor = Cursor_DefaultValue = PlotOptionsStochasticCursor.Null;
			Custom = Custom_DefaultValue = new Hashtable();
			DashStyle = DashStyle_DefaultValue = PlotOptionsStochasticDashStyle.Null;
			DataGrouping = DataGrouping_DefaultValue = new PlotOptionsStochasticDataGrouping();
			DataLabels = DataLabels_DefaultValue = new PlotOptionsStochasticDataLabels();
			DataSorting = DataSorting_DefaultValue = new PlotOptionsStochasticDataSorting();
			Description = Description_DefaultValue = "";
			EnableMouseTracking = EnableMouseTracking_DefaultValue = true;
			Events = Events_DefaultValue = new PlotOptionsStochasticEvents();
			FindNearestPointBy = FindNearestPointBy_DefaultValue = PlotOptionsStochasticFindNearestPointBy.X;
			...
			LegendSymbol = LegendSymbol_DefaultValue = PlotOptionsStochasticLegendSymbol.Rectangle;
			...
			OnPoint = OnPoint_DefaultValue = new PlotOptionsStochasticOnPoint();
			...
			Sonification = Sonification_DefaultValue = new PlotOptionsStochasticSonification();
			States = States_DefaultValue = new PlotOptionsStochasticStates();
			Step = Step_DefaultValue = PlotOptionsStochasticStep.Null;
			...
			Zones = Zones_DefaultValue = new List<PlotOptionsStochasticZones>();
		...
		/// </summary>
		public PlotOptionsStochasticAccessibility Accessibility { get; set; }
		private PlotOptionsStochasticAccessibility Accessibility_DefaultValue { get; set; }
		...
		/// </summary>
		public PlotOptionsStochasticBoostBlending BoostBlending { get; set; }
		private PlotOptionsStochasticBoostBlending BoostBlending_DefaultValue { get; set; }
		...
		/// </summary>
		public PlotOptionsStochasticCompare Compare { get; set; }
		private PlotOptionsStochasticCompare Compare_DefaultValue { get; set; }
		 

		/// <summary>
		/// When [compare](#plotOptions.series.compare) is `percent`, this optiondictates whether to use 0 or 100 as the base of comparison.
		/// </summary>
		public PlotOptionsStochasticCompareBase CompareBase { get; set; }
		private PlotOptionsStochasticCompareBase CompareBase_DefaultValue { get; set; }
		...
		/// </summary>
		public PlotOptionsStochasticCursor Cursor { get; set; }
		private PlotOptionsStochasticCursor Cursor_DefaultValue { get; set; }
		...
		/// </summary>
		public PlotOptionsStochasticDashStyle DashStyle { get; set; }
		private PlotOptionsStochasticDashStyle DashStyle_DefaultValue { get; set; }
		 

		/// <summary>
		/// 
		/// </summary>
		public PlotOptionsStochasticDataGrouping DataGrouping { get; set; }
		private PlotOptionsStochasticDataGrouping DataGrouping_DefaultValue { get; set; }
		...
		/// </summary>
		public PlotOptionsStochasticDataLabels DataLabels { get; set; }
		private PlotOptionsStochasticDataLabels DataLabels_DefaultValue { get; set; }
		 

		/// <summary>
		/// Options for the series data sorting.
		/// </summary>
		public PlotOptionsStochasticDataSorting DataSorting { get; set; }
		private PlotOptionsStochasticDataSorting DataSorting_DefaultValue { get; set; }
		...
		/// </summary>
		public PlotOptionsStochasticEvents Events { get; set; }
		private PlotOptionsStochasticEvents Events_DefaultValue { get; set; }
		...
		/// </summary>
		public PlotOptionsStochasticFindNearestPointBy FindNearestPointBy { get; set; }
		private PlotOptionsStochasticFindNearestPointBy FindNearestPointBy_DefaultValue { get; set; }
		...
		/// </summary>
		public PlotOptionsStochasticGapUnit GapUnit { get; set; }
		private PlotOptionsStochasticGapUnit GapUnit_DefaultValue { get; set; }
		...
		/// </summary>
		public PlotOptionsStochasticLabel Label { get; set; }
		private PlotOptionsStochasticLabel Label_DefaultValue { get; set; }
		...
		/// </summary>
		public PlotOptionsStochasticLegendSymbol LegendSymbol { get; set; }
		private PlotOptionsStochasticLegendSymbol LegendSymbol_DefaultValue { get; set; }
		...
		private PlotOptionsStochasticLinecap Linecap_DefaultValue { get; set; }
		...
		/// </summary>
		public PlotOptionsStochasticOnPoint OnPoint { get; set; }
		private PlotOptionsStochasticOnPoint OnPoint_DefaultValue { get; set; }
		...
		private PlotOptionsStochasticParams Params_DefaultValue { get; set; }
		 

		/// <summary>
		/// Properties for each single point.
		/// </summary>
		public PlotOptionsStochasticPoint Point { get; set; }
		private PlotOptionsStochasticPoint Point_DefaultValue { get; set; }
		...
		/// </summary>
		public PlotOptionsStochasticSmoothedLine SmoothedLine { get; set; }
		private PlotOptionsStochasticSmoothedLine SmoothedLine_DefaultValue { get; set; }
		...
		/// </summary>
		public PlotOptionsStochasticSonification Sonification { get; set; }
		private PlotOptionsStochasticSonification Sonification_DefaultValue { get; set; }
		 

		/// <summary>
		/// 
		/// </summary>
		public PlotOptionsStochasticStates States { get; set; }
		private PlotOptionsStochasticStates States_DefaultValue { get; set; }
		 

		/// <summary>
		/// Whether to apply steps to the line. Possible values are `left`,`center` and `right`.
		/// </summary>
		public PlotOptionsStochasticStep Step { get; set; }
		private PlotOptionsStochasticStep Step_DefaultValue { get; set; }
		...
		/// 
		/// </summary>
		public PlotOptionsStochasticTooltip Tooltip { get; set; }
		private PlotOptionsStochasticTooltip Tooltip_DefaultValue { get; set; }
		...
		/// </summary>
		public List<PlotOptionsStochasticZones> Zones { get; set; }
		private List<PlotOptionsStochasticZones> Zones_DefaultValue { get; set; }
