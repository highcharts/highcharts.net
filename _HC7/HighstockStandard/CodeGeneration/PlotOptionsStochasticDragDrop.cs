...
{
	public partial class PlotOptionsStochasticDragDrop  : BaseObject
	{
		public PlotOptionsStochasticDragDrop()
		{
			DraggableX = DraggableX_DefaultValue = null;
			DraggableY = DraggableY_DefaultValue = null;
			DragHandle = DragHandle_DefaultValue = new PlotOptionsStochasticDragDropDragHandle();
			...
			GuideBox = GuideBox_DefaultValue = new PlotOptionsStochasticDragDropGuideBox();
		...
		/// </summary>
		public PlotOptionsStochasticDragDropDragHandle DragHandle { get; set; }
		private PlotOptionsStochasticDragDropDragHandle DragHandle_DefaultValue { get; set; }
		...
		/// </summary>
		public PlotOptionsStochasticDragDropGuideBox GuideBox { get; set; }
		private PlotOptionsStochasticDragDropGuideBox GuideBox_DefaultValue { get; set; }
