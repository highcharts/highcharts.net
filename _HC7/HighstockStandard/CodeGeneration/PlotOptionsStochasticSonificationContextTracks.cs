...
{
	public partial class PlotOptionsStochasticSonificationContextTracks  : BaseObject
	{
		Hashtable h = new Hashtable();

		public PlotOptionsStochasticSonificationContextTracks()
		{
			ActiveWhen = ActiveWhen_DefaultValue = new PlotOptionsStochasticSonificationContextTracksActiveWhen();
			Instrument = Instrument_DefaultValue = null;
			InstrumentString = InstrumentString_DefaultValue = "null";
			Mapping = Mapping_DefaultValue = new PlotOptionsStochasticSonificationContextTracksMapping();
			MidiName = MidiName_DefaultValue = "";
			PointGrouping = PointGrouping_DefaultValue = new PlotOptionsStochasticSonificationContextTracksPointGrouping();
			...
			Type = Type_DefaultValue = PlotOptionsStochasticSonificationContextTracksType.Instrument;
			ValueInterval = ValueInterval_DefaultValue = null;
			ValueMapFunction = ValueMapFunction_DefaultValue = PlotOptionsStochasticSonificationContextTracksValueMapFunction.Linear;
		...
		/// </summary>
		public PlotOptionsStochasticSonificationContextTracksActiveWhen ActiveWhen { get; set; }
		private PlotOptionsStochasticSonificationContextTracksActiveWhen ActiveWhen_DefaultValue { get; set; }
		...
		/// </summary>
		public PlotOptionsStochasticSonificationContextTracksMapping Mapping { get; set; }
		private PlotOptionsStochasticSonificationContextTracksMapping Mapping_DefaultValue { get; set; }
		...
		/// </summary>
		public PlotOptionsStochasticSonificationContextTracksPointGrouping PointGrouping { get; set; }
		private PlotOptionsStochasticSonificationContextTracksPointGrouping PointGrouping_DefaultValue { get; set; }
		...
		/// </summary>
		public PlotOptionsStochasticSonificationContextTracksType Type { get; set; }
		private PlotOptionsStochasticSonificationContextTracksType Type_DefaultValue { get; set; }
		...
		/// </summary>
		public PlotOptionsStochasticSonificationContextTracksValueMapFunction ValueMapFunction { get; set; }
		private PlotOptionsStochasticSonificationContextTracksValueMapFunction ValueMapFunction_DefaultValue { get; set; }
