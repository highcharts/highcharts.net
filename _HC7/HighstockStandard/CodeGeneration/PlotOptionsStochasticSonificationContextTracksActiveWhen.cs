...
{
	public partial class PlotOptionsStochasticSonificationContextTracksActiveWhen  : BaseObject
	{
		Hashtable h = new Hashtable();

		public PlotOptionsStochasticSonificationContextTracksActiveWhen()
		{
		}	
