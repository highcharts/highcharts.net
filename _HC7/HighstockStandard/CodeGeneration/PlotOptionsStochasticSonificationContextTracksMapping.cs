...
{
	public partial class PlotOptionsStochasticSonificationContextTracksMapping  : BaseObject
	{
		Hashtable h = new Hashtable();

		public PlotOptionsStochasticSonificationContextTracksMapping()
		{
			Frequency = Frequency_DefaultValue = new PlotOptionsStochasticSonificationContextTracksMappingFrequency();
			GapBetweenNotes = GapBetweenNotes_DefaultValue = new PlotOptionsStochasticSonificationContextTracksMappingGapBetweenNotes();
			Highpass = Highpass_DefaultValue = new PlotOptionsStochasticSonificationContextTracksMappingHighpass();
			Lowpass = Lowpass_DefaultValue = new PlotOptionsStochasticSonificationContextTracksMappingLowpass();
			NoteDuration = NoteDuration_DefaultValue = new PlotOptionsStochasticSonificationContextTracksMappingNoteDuration();
			Pan = Pan_DefaultValue = new PlotOptionsStochasticSonificationContextTracksMappingPan();
			Pitch = Pitch_DefaultValue = new PlotOptionsStochasticSonificationContextTracksMappingPitch();
			PitchString = PitchString_DefaultValue = "null";
			PitchNumber = PitchNumber_DefaultValue = null;
			PlayDelay = PlayDelay_DefaultValue = new PlotOptionsStochasticSonificationContextTracksMappingPlayDelay();
			Time = Time_DefaultValue = new PlotOptionsStochasticSonificationContextTracksMappingTime();
			TimeString = TimeString_DefaultValue = "null";
			TimeNumber = TimeNumber_DefaultValue = null;
			Tremolo = Tremolo_DefaultValue = new PlotOptionsStochasticSonificationContextTracksMappingTremolo();
			Volume = Volume_DefaultValue = new PlotOptionsStochasticSonificationContextTracksMappingVolume();
		...
		/// </summary>
		public PlotOptionsStochasticSonificationContextTracksMappingFrequency Frequency { get; set; }
		private PlotOptionsStochasticSonificationContextTracksMappingFrequency Frequency_DefaultValue { get; set; }
		...
		/// </summary>
		public PlotOptionsStochasticSonificationContextTracksMappingGapBetweenNotes GapBetweenNotes { get; set; }
		private PlotOptionsStochasticSonificationContextTracksMappingGapBetweenNotes GapBetweenNotes_DefaultValue { get; set; }
		...
		/// </summary>
		public PlotOptionsStochasticSonificationContextTracksMappingHighpass Highpass { get; set; }
		private PlotOptionsStochasticSonificationContextTracksMappingHighpass Highpass_DefaultValue { get; set; }
		...
		/// </summary>
		public PlotOptionsStochasticSonificationContextTracksMappingLowpass Lowpass { get; set; }
		private PlotOptionsStochasticSonificationContextTracksMappingLowpass Lowpass_DefaultValue { get; set; }
		...
		/// </summary>
		public PlotOptionsStochasticSonificationContextTracksMappingNoteDuration NoteDuration { get; set; }
		private PlotOptionsStochasticSonificationContextTracksMappingNoteDuration NoteDuration_DefaultValue { get; set; }
		...
		/// </summary>
		public PlotOptionsStochasticSonificationContextTracksMappingPan Pan { get; set; }
		private PlotOptionsStochasticSonificationContextTracksMappingPan Pan_DefaultValue { get; set; }
		...
		/// </summary>
		public PlotOptionsStochasticSonificationContextTracksMappingPitch Pitch { get; set; }
		private PlotOptionsStochasticSonificationContextTracksMappingPitch Pitch_DefaultValue { get; set; }
		...
		/// </summary>
		public PlotOptionsStochasticSonificationContextTracksMappingPlayDelay PlayDelay { get; set; }
		private PlotOptionsStochasticSonificationContextTracksMappingPlayDelay PlayDelay_DefaultValue { get; set; }
		...
		/// </summary>
		public PlotOptionsStochasticSonificationContextTracksMappingTime Time { get; set; }
		private PlotOptionsStochasticSonificationContextTracksMappingTime Time_DefaultValue { get; set; }
		...
		/// </summary>
		public PlotOptionsStochasticSonificationContextTracksMappingTremolo Tremolo { get; set; }
		private PlotOptionsStochasticSonificationContextTracksMappingTremolo Tremolo_DefaultValue { get; set; }
		 

		/// <summary>
		/// The volume of notes, from 0 to 1.
		/// </summary>
		public PlotOptionsStochasticSonificationContextTracksMappingVolume Volume { get; set; }
		private PlotOptionsStochasticSonificationContextTracksMappingVolume Volume_DefaultValue { get; set; }
