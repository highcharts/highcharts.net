...
{
	public partial class PlotOptionsStochasticSonificationContextTracksMappingPitch  : BaseObject
	{
		Hashtable h = new Hashtable();

		public PlotOptionsStochasticSonificationContextTracksMappingPitch()
		{
			MapFunction = MapFunction_DefaultValue = PlotOptionsStochasticSonificationContextTracksMappingPitchMapFunction.Linear;
		...
		/// </summary>
		public PlotOptionsStochasticSonificationContextTracksMappingPitchMapFunction MapFunction { get; set; }
		private PlotOptionsStochasticSonificationContextTracksMappingPitchMapFunction MapFunction_DefaultValue { get; set; }
