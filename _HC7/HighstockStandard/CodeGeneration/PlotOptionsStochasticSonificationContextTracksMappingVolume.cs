...
{
	public partial class PlotOptionsStochasticSonificationContextTracksMappingVolume  : BaseObject
	{
		Hashtable h = new Hashtable();

		public PlotOptionsStochasticSonificationContextTracksMappingVolume()
		{
			MapFunction = MapFunction_DefaultValue = PlotOptionsStochasticSonificationContextTracksMappingVolumeMapFunction.Linear;
			MapTo = MapTo_DefaultValue = "";
			Max = Max_DefaultValue = null;
			Min = Min_DefaultValue = null;
			Value = Value_DefaultValue = null;
			Within = Within_DefaultValue = PlotOptionsStochasticSonificationContextTracksMappingVolumeWithin.Chart;
		...
		/// </summary>
		public PlotOptionsStochasticSonificationContextTracksMappingVolumeMapFunction MapFunction { get; set; }
		private PlotOptionsStochasticSonificationContextTracksMappingVolumeMapFunction MapFunction_DefaultValue { get; set; }
		...
		/// </summary>
		public PlotOptionsStochasticSonificationContextTracksMappingVolumeWithin Within { get; set; }
		private PlotOptionsStochasticSonificationContextTracksMappingVolumeWithin Within_DefaultValue { get; set; }
