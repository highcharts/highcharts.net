...
{
	public partial class PlotOptionsStochasticSonificationDefaultInstrumentOptionsMappingTime  : BaseObject
	{
		Hashtable h = new Hashtable();

		public PlotOptionsStochasticSonificationDefaultInstrumentOptionsMappingTime()
		{
			MapFunction = MapFunction_DefaultValue = PlotOptionsStochasticSonificationDefaultInstrumentOptionsMappingTimeMapFunction.Linear;
			MapTo = MapTo_DefaultValue = "";
			Max = Max_DefaultValue = null;
			Min = Min_DefaultValue = null;
			Value = Value_DefaultValue = null;
			Within = Within_DefaultValue = PlotOptionsStochasticSonificationDefaultInstrumentOptionsMappingTimeWithin.Chart;
		...
		/// </summary>
		public PlotOptionsStochasticSonificationDefaultInstrumentOptionsMappingTimeMapFunction MapFunction { get; set; }
		private PlotOptionsStochasticSonificationDefaultInstrumentOptionsMappingTimeMapFunction MapFunction_DefaultValue { get; set; }
		...
		/// </summary>
		public PlotOptionsStochasticSonificationDefaultInstrumentOptionsMappingTimeWithin Within { get; set; }
		private PlotOptionsStochasticSonificationDefaultInstrumentOptionsMappingTimeWithin Within_DefaultValue { get; set; }
