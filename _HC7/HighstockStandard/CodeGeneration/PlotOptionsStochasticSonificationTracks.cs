...
{
	public partial class PlotOptionsStochasticSonificationTracks  : BaseObject
	{
		Hashtable h = new Hashtable();

		public PlotOptionsStochasticSonificationTracks()
		{
			ActiveWhen = ActiveWhen_DefaultValue = new PlotOptionsStochasticSonificationTracksActiveWhen();
			Instrument = Instrument_DefaultValue = null;
			InstrumentString = InstrumentString_DefaultValue = "null";
			Mapping = Mapping_DefaultValue = new PlotOptionsStochasticSonificationTracksMapping();
			MidiName = MidiName_DefaultValue = "";
			PointGrouping = PointGrouping_DefaultValue = new PlotOptionsStochasticSonificationTracksPointGrouping();
			RoundToMusicalNotes = RoundToMusicalNotes_DefaultValue = true;
			ShowPlayMarker = ShowPlayMarker_DefaultValue = true;
			Type = Type_DefaultValue = PlotOptionsStochasticSonificationTracksType.Instrument;
		...
		/// </summary>
		public PlotOptionsStochasticSonificationTracksActiveWhen ActiveWhen { get; set; }
		private PlotOptionsStochasticSonificationTracksActiveWhen ActiveWhen_DefaultValue { get; set; }
		...
		/// </summary>
		public PlotOptionsStochasticSonificationTracksMapping Mapping { get; set; }
		private PlotOptionsStochasticSonificationTracksMapping Mapping_DefaultValue { get; set; }
		...
		/// </summary>
		public PlotOptionsStochasticSonificationTracksPointGrouping PointGrouping { get; set; }
		private PlotOptionsStochasticSonificationTracksPointGrouping PointGrouping_DefaultValue { get; set; }
		...
		/// </summary>
		public PlotOptionsStochasticSonificationTracksType Type { get; set; }
		private PlotOptionsStochasticSonificationTracksType Type_DefaultValue { get; set; }
