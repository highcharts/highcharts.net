...
{
	public partial class PlotOptionsStochasticSonificationTracksMapping  : BaseObject
	{
		Hashtable h = new Hashtable();

		public PlotOptionsStochasticSonificationTracksMapping()
		{
			Frequency = Frequency_DefaultValue = new PlotOptionsStochasticSonificationTracksMappingFrequency();
			GapBetweenNotes = GapBetweenNotes_DefaultValue = new PlotOptionsStochasticSonificationTracksMappingGapBetweenNotes();
			Highpass = Highpass_DefaultValue = new PlotOptionsStochasticSonificationTracksMappingHighpass();
			Lowpass = Lowpass_DefaultValue = new PlotOptionsStochasticSonificationTracksMappingLowpass();
			NoteDuration = NoteDuration_DefaultValue = new PlotOptionsStochasticSonificationTracksMappingNoteDuration();
			Pan = Pan_DefaultValue = new PlotOptionsStochasticSonificationTracksMappingPan();
			Pitch = Pitch_DefaultValue = new PlotOptionsStochasticSonificationTracksMappingPitch();
			PitchString = PitchString_DefaultValue = "null";
			PitchNumber = PitchNumber_DefaultValue = null;
			PlayDelay = PlayDelay_DefaultValue = new PlotOptionsStochasticSonificationTracksMappingPlayDelay();
			Time = Time_DefaultValue = new PlotOptionsStochasticSonificationTracksMappingTime();
			TimeString = TimeString_DefaultValue = "null";
			TimeNumber = TimeNumber_DefaultValue = null;
			Tremolo = Tremolo_DefaultValue = new PlotOptionsStochasticSonificationTracksMappingTremolo();
			Volume = Volume_DefaultValue = new PlotOptionsStochasticSonificationTracksMappingVolume();
		...
		/// </summary>
		public PlotOptionsStochasticSonificationTracksMappingFrequency Frequency { get; set; }
		private PlotOptionsStochasticSonificationTracksMappingFrequency Frequency_DefaultValue { get; set; }
		...
		/// </summary>
		public PlotOptionsStochasticSonificationTracksMappingGapBetweenNotes GapBetweenNotes { get; set; }
		private PlotOptionsStochasticSonificationTracksMappingGapBetweenNotes GapBetweenNotes_DefaultValue { get; set; }
		...
		/// </summary>
		public PlotOptionsStochasticSonificationTracksMappingHighpass Highpass { get; set; }
		private PlotOptionsStochasticSonificationTracksMappingHighpass Highpass_DefaultValue { get; set; }
		...
		/// </summary>
		public PlotOptionsStochasticSonificationTracksMappingLowpass Lowpass { get; set; }
		private PlotOptionsStochasticSonificationTracksMappingLowpass Lowpass_DefaultValue { get; set; }
		...
		/// </summary>
		public PlotOptionsStochasticSonificationTracksMappingNoteDuration NoteDuration { get; set; }
		private PlotOptionsStochasticSonificationTracksMappingNoteDuration NoteDuration_DefaultValue { get; set; }
		...
		/// </summary>
		public PlotOptionsStochasticSonificationTracksMappingPan Pan { get; set; }
		private PlotOptionsStochasticSonificationTracksMappingPan Pan_DefaultValue { get; set; }
		...
		/// </summary>
		public PlotOptionsStochasticSonificationTracksMappingPitch Pitch { get; set; }
		private PlotOptionsStochasticSonificationTracksMappingPitch Pitch_DefaultValue { get; set; }
		...
		/// </summary>
		public PlotOptionsStochasticSonificationTracksMappingPlayDelay PlayDelay { get; set; }
		private PlotOptionsStochasticSonificationTracksMappingPlayDelay PlayDelay_DefaultValue { get; set; }
		...
		/// </summary>
		public PlotOptionsStochasticSonificationTracksMappingTime Time { get; set; }
		private PlotOptionsStochasticSonificationTracksMappingTime Time_DefaultValue { get; set; }
		...
		/// </summary>
		public PlotOptionsStochasticSonificationTracksMappingTremolo Tremolo { get; set; }
		private PlotOptionsStochasticSonificationTracksMappingTremolo Tremolo_DefaultValue { get; set; }
		 

		/// <summary>
		/// The volume of notes, from 0 to 1.
		/// </summary>
		public PlotOptionsStochasticSonificationTracksMappingVolume Volume { get; set; }
		private PlotOptionsStochasticSonificationTracksMappingVolume Volume_DefaultValue { get; set; }
