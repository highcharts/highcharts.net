...
{
	public partial class PlotOptionsStochasticSonificationTracksMappingFrequency  : BaseObject
	{
		Hashtable h = new Hashtable();

		public PlotOptionsStochasticSonificationTracksMappingFrequency()
		{
			MapFunction = MapFunction_DefaultValue = PlotOptionsStochasticSonificationTracksMappingFrequencyMapFunction.Linear;
			MapTo = MapTo_DefaultValue = "";
			Max = Max_DefaultValue = null;
			Min = Min_DefaultValue = null;
			Value = Value_DefaultValue = null;
			Within = Within_DefaultValue = PlotOptionsStochasticSonificationTracksMappingFrequencyWithin.Chart;
		...
		/// </summary>
		public PlotOptionsStochasticSonificationTracksMappingFrequencyMapFunction MapFunction { get; set; }
		private PlotOptionsStochasticSonificationTracksMappingFrequencyMapFunction MapFunction_DefaultValue { get; set; }
		...
		/// </summary>
		public PlotOptionsStochasticSonificationTracksMappingFrequencyWithin Within { get; set; }
		private PlotOptionsStochasticSonificationTracksMappingFrequencyWithin Within_DefaultValue { get; set; }
