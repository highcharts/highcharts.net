...
{
	public partial class PlotOptionsStochasticSonificationTracksMappingPan  : BaseObject
	{
		Hashtable h = new Hashtable();

		public PlotOptionsStochasticSonificationTracksMappingPan()
		{
			MapFunction = MapFunction_DefaultValue = PlotOptionsStochasticSonificationTracksMappingPanMapFunction.Linear;
			MapTo = MapTo_DefaultValue = "";
			Max = Max_DefaultValue = null;
			Min = Min_DefaultValue = null;
			Value = Value_DefaultValue = null;
			Within = Within_DefaultValue = PlotOptionsStochasticSonificationTracksMappingPanWithin.Chart;
		...
		/// </summary>
		public PlotOptionsStochasticSonificationTracksMappingPanMapFunction MapFunction { get; set; }
		private PlotOptionsStochasticSonificationTracksMappingPanMapFunction MapFunction_DefaultValue { get; set; }
		...
		/// </summary>
		public PlotOptionsStochasticSonificationTracksMappingPanWithin Within { get; set; }
		private PlotOptionsStochasticSonificationTracksMappingPanWithin Within_DefaultValue { get; set; }
