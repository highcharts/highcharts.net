...
{
	public partial class PlotOptionsStochasticSonificationTracksMappingPitch  : BaseObject
	{
		Hashtable h = new Hashtable();

		public PlotOptionsStochasticSonificationTracksMappingPitch()
		{
			MapFunction = MapFunction_DefaultValue = PlotOptionsStochasticSonificationTracksMappingPitchMapFunction.Linear;
		...
		/// </summary>
		public PlotOptionsStochasticSonificationTracksMappingPitchMapFunction MapFunction { get; set; }
		private PlotOptionsStochasticSonificationTracksMappingPitchMapFunction MapFunction_DefaultValue { get; set; }
