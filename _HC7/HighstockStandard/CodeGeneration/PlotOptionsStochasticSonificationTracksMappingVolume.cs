...
{
	public partial class PlotOptionsStochasticSonificationTracksMappingVolume  : BaseObject
	{
		Hashtable h = new Hashtable();

		public PlotOptionsStochasticSonificationTracksMappingVolume()
		{
			MapFunction = MapFunction_DefaultValue = PlotOptionsStochasticSonificationTracksMappingVolumeMapFunction.Linear;
			MapTo = MapTo_DefaultValue = "";
			Max = Max_DefaultValue = null;
			Min = Min_DefaultValue = null;
			Value = Value_DefaultValue = null;
			Within = Within_DefaultValue = PlotOptionsStochasticSonificationTracksMappingVolumeWithin.Chart;
		...
		/// </summary>
		public PlotOptionsStochasticSonificationTracksMappingVolumeMapFunction MapFunction { get; set; }
		private PlotOptionsStochasticSonificationTracksMappingVolumeMapFunction MapFunction_DefaultValue { get; set; }
		...
		/// </summary>
		public PlotOptionsStochasticSonificationTracksMappingVolumeWithin Within { get; set; }
		private PlotOptionsStochasticSonificationTracksMappingVolumeWithin Within_DefaultValue { get; set; }
