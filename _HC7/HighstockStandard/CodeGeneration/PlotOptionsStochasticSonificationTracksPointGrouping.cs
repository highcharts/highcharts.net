...
{
	public partial class PlotOptionsStochasticSonificationTracksPointGrouping  : BaseObject
	{
		Hashtable h = new Hashtable();

		public PlotOptionsStochasticSonificationTracksPointGrouping()
		{
			Algorithm = Algorithm_DefaultValue = PlotOptionsStochasticSonificationTracksPointGroupingAlgorithm.Minimax;
		...
		/// </summary>
		public PlotOptionsStochasticSonificationTracksPointGroupingAlgorithm Algorithm { get; set; }
		private PlotOptionsStochasticSonificationTracksPointGroupingAlgorithm Algorithm_DefaultValue { get; set; }
