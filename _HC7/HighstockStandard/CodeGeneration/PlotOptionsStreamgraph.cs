...
namespace Highsoft.Web.Mvc.Stocks
{
	public partial class PlotOptionsStreamgraph  : BaseObject
	{
		...
		public PlotOptionsStreamgraph()
		{
			...
			Compare = Compare_DefaultValue = PlotOptionsStreamgraphCompare.Percent;
			...
			LegendSymbol = LegendSymbol_DefaultValue = PlotOptionsStreamgraphLegendSymbol.Rectangle;
			...
			Sonification = Sonification_DefaultValue = new PlotOptionsStreamgraphSonification();
			...
			Zones = Zones_DefaultValue = new List<PlotOptionsStreamgraphZones>();
		...
		/// </summary>
		public PlotOptionsStreamgraphCompare Compare { get; set; }
		private PlotOptionsStreamgraphCompare Compare_DefaultValue { get; set; }
		...
		/// </summary>
		public PlotOptionsStreamgraphLegendSymbol LegendSymbol { get; set; }
		private PlotOptionsStreamgraphLegendSymbol LegendSymbol_DefaultValue { get; set; }
		...
		/// </summary>
		public PlotOptionsStreamgraphSonification Sonification { get; set; }
		private PlotOptionsStreamgraphSonification Sonification_DefaultValue { get; set; }
