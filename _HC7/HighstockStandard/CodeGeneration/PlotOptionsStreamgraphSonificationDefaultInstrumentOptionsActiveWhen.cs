...
{
	public partial class PlotOptionsStreamgraphSonificationDefaultInstrumentOptionsActiveWhen  : BaseObject
	{
		Hashtable h = new Hashtable();

		public PlotOptionsStreamgraphSonificationDefaultInstrumentOptionsActiveWhen()
		{
