...
{
	public partial class PlotOptionsStreamgraphStatesHoverMarkerStates  : BaseObject
	{
		public PlotOptionsStreamgraphStatesHoverMarkerStates()
		{
			...
			Inactive = Inactive_DefaultValue = new PlotOptionsStreamgraphStatesHoverMarkerStatesInactive();
		...
		/// 
		/// </summary>
		public PlotOptionsStreamgraphStatesHoverMarkerStatesInactive Inactive { get; set; }
		private PlotOptionsStreamgraphStatesHoverMarkerStatesInactive Inactive_DefaultValue { get; set; }
		...
		/// </summary>
		public PlotOptionsStreamgraphStatesHoverMarkerStatesSelect Select { get; set; }
		private PlotOptionsStreamgraphStatesHoverMarkerStatesSelect Select_DefaultValue { get; set; }
