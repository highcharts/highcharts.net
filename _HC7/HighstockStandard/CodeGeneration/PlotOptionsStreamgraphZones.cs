...
{
	public partial class PlotOptionsStreamgraphZones  : BaseObject
	{
		Hashtable h = new Hashtable();

		public PlotOptionsStreamgraphZones()
		{
		}	
		...
		internal override Hashtable ToHashtable(Highstock highstock)
		{
			...
			if (DashStyle != PlotOptionsStreamgraphZonesDashStyle.Null) h.Add("dashStyle", highstock.FirstCharacterToLower(DashStyle.ToString()));
