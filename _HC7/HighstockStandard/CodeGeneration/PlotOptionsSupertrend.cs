...
namespace Highsoft.Web.Mvc.Stocks
{
	public partial class PlotOptionsSupertrend  : BaseObject
	{
		...
		public PlotOptionsSupertrend()
		{
			...
			Zones = Zones_DefaultValue = new List<PlotOptionsSupertrendZone>();
		...
		/// </summary>
		public List<PlotOptionsSupertrendZone> Zones { get; set; }
		private List<PlotOptionsSupertrendZone> Zones_DefaultValue { get; set; }
