...
namespace Highsoft.Web.Mvc.Stocks
{
	public partial class PlotOptionsSupertrend  : BaseObject
	{
		...
		internal override Hashtable ToHashtable(Highstock highstock)
		{
			...
			if (BoostBlending != PlotOptionsSupertrendBoostBlending.Null) h.Add("boostBlending", highstock.FirstCharacterToLower(BoostBlending.ToString()));
			if (BoostThreshold != null) h.Add("boostThreshold",BoostThreshold);
			if (ChangeTrendLine != null) h.Add("changeTrendLine",ChangeTrendLine.ToHashtable(highstock));
			...
			if (Compare != PlotOptionsSupertrendCompare.Null) h.Add("compare", highstock.FirstCharacterToLower(Compare.ToString()));
			if (CompareBase != PlotOptionsSupertrendCompareBase.Null) h.Add("compareBase", highstock.FirstCharacterToLower(CompareBase.ToString()));
			...
			if (Cursor != PlotOptionsSupertrendCursor.Null) h.Add("cursor", highstock.FirstCharacterToLower(Cursor.ToString()));
			if (Custom != null) h.Add("custom",Custom);
			if (DashStyle != PlotOptionsSupertrendDashStyle.Null) h.Add("dashStyle", highstock.FirstCharacterToLower(DashStyle.ToString()));
			...
			if (FallingTrendColor != null) h.Add("fallingTrendColor",FallingTrendColor);
			if (FindNearestPointBy != PlotOptionsSupertrendFindNearestPointBy.Null) h.Add("findNearestPointBy", highstock.FirstCharacterToLower(FindNearestPointBy.ToString()));
			if (GapSize != null) h.Add("gapSize",GapSize);
			if (GapUnit != PlotOptionsSupertrendGapUnit.Null) h.Add("gapUnit", highstock.FirstCharacterToLower(GapUnit.ToString()));
			...
			if (LegendSymbol != PlotOptionsSupertrendLegendSymbol.Null) h.Add("legendSymbol", highstock.FirstCharacterToLower(LegendSymbol.ToString()));
			if (Linecap != PlotOptionsSupertrendLinecap.Null) h.Add("linecap", highstock.FirstCharacterToLower(Linecap.ToString()));
			...
			if (RisingTrendColor != null) h.Add("risingTrendColor",RisingTrendColor);
			...
			if (Step != PlotOptionsSupertrendStep.Null) h.Add("step", highstock.FirstCharacterToLower(Step.ToString()));
