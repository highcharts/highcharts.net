...
{
	public partial class PlotOptionsSupertrend  : BaseObject
	{
		Hashtable h = new Hashtable();

		public PlotOptionsSupertrend()
		{
			Accessibility = Accessibility_DefaultValue = new PlotOptionsSupertrendAccessibility();
			AllowPointSelect = AllowPointSelect_DefaultValue = false;
			Animation = Animation_DefaultValue = new Animation() { Enabled = true };
			AnimationBool = AnimationBool_DefaultValue = true;
			AnimationLimit = AnimationLimit_DefaultValue = null;
			BoostBlending = BoostBlending_DefaultValue = PlotOptionsSupertrendBoostBlending.Undefined;
			BoostThreshold = BoostThreshold_DefaultValue = 5000;
			ChangeTrendLine = ChangeTrendLine_DefaultValue = new PlotOptionsSupertrendChangeTrendLine();
			ClassName = ClassName_DefaultValue = "";
			Clip = Clip_DefaultValue = true;
			Color = Color_DefaultValue = "";
			ColorIndex = ColorIndex_DefaultValue = null;
			ColorKey = ColorKey_DefaultValue = "y";
			Compare = Compare_DefaultValue = PlotOptionsSupertrendCompare.Percent;
			CompareBase = CompareBase_DefaultValue = PlotOptionsSupertrendCompareBase.Min;
			...
			Cursor = Cursor_DefaultValue = PlotOptionsSupertrendCursor.Null;
			Custom = Custom_DefaultValue = new Hashtable();
			DashStyle = DashStyle_DefaultValue = PlotOptionsSupertrendDashStyle.Null;
			DataGrouping = DataGrouping_DefaultValue = new PlotOptionsSupertrendDataGrouping();
			DataLabels = DataLabels_DefaultValue = new PlotOptionsSupertrendDataLabels();
			DataSorting = DataSorting_DefaultValue = new PlotOptionsSupertrendDataSorting();
			Description = Description_DefaultValue = "";
			EnableMouseTracking = EnableMouseTracking_DefaultValue = true;
			Events = Events_DefaultValue = new PlotOptionsSupertrendEvents();
			FallingTrendColor = FallingTrendColor_DefaultValue = "#f21313";
			FindNearestPointBy = FindNearestPointBy_DefaultValue = PlotOptionsSupertrendFindNearestPointBy.X;
			GapSize = GapSize_DefaultValue = 0;
			GapUnit = GapUnit_DefaultValue = PlotOptionsSupertrendGapUnit.Relative;
			GetExtremesFromAll = GetExtremesFromAll_DefaultValue = false;
			InactiveOtherPoints = InactiveOtherPoints_DefaultValue = false;
			IncludeInDataExport = IncludeInDataExport_DefaultValue = null;
			Label = Label_DefaultValue = new PlotOptionsSupertrendLabel();
			LastPrice = LastPrice_DefaultValue = new PlotOptionsSupertrendLastPrice();
			LastVisiblePrice = LastVisiblePrice_DefaultValue = new PlotOptionsSupertrendLastVisiblePrice();
			LegendSymbol = LegendSymbol_DefaultValue = PlotOptionsSupertrendLegendSymbol.Rectangle;
			Linecap = Linecap_DefaultValue = PlotOptionsSupertrendLinecap.Round;
			LineWidth = LineWidth_DefaultValue = 2;
			LinkedTo = LinkedTo_DefaultValue = "";
			Marker = Marker_DefaultValue = new PlotOptionsSupertrendMarker();
			OnPoint = OnPoint_DefaultValue = new PlotOptionsSupertrendOnPoint();
			...
			Sonification = Sonification_DefaultValue = new PlotOptionsSupertrendSonification();
			States = States_DefaultValue = new PlotOptionsSupertrendStates();
			Step = Step_DefaultValue = PlotOptionsSupertrendStep.Null;
			StickyTracking = StickyTracking_DefaultValue = true;
			Tooltip = Tooltip_DefaultValue = new PlotOptionsSupertrendTooltip();
			TurboThreshold = TurboThreshold_DefaultValue = 1000;
			Visible = Visible_DefaultValue = true;
			ZoneAxis = ZoneAxis_DefaultValue = "y";
			Zones = Zones_DefaultValue = new List<PlotOptionsSupertrendZones>();
		...
		/// </summary>
		public PlotOptionsSupertrendAccessibility Accessibility { get; set; }
		private PlotOptionsSupertrendAccessibility Accessibility_DefaultValue { get; set; }
		...
		/// </summary>
		public PlotOptionsSupertrendBoostBlending BoostBlending { get; set; }
		private PlotOptionsSupertrendBoostBlending BoostBlending_DefaultValue { get; set; }
		...
		/// </summary>
		public PlotOptionsSupertrendChangeTrendLine ChangeTrendLine { get; set; }
		private PlotOptionsSupertrendChangeTrendLine ChangeTrendLine_DefaultValue { get; set; }
		...
		/// </summary>
		public PlotOptionsSupertrendCompare Compare { get; set; }
		private PlotOptionsSupertrendCompare Compare_DefaultValue { get; set; }
		 

		/// <summary>
		/// When [compare](#plotOptions.series.compare) is `percent`, this optiondictates whether to use 0 or 100 as the base of comparison.
		/// </summary>
		public PlotOptionsSupertrendCompareBase CompareBase { get; set; }
		private PlotOptionsSupertrendCompareBase CompareBase_DefaultValue { get; set; }
		...
		/// </summary>
		public PlotOptionsSupertrendCursor Cursor { get; set; }
		private PlotOptionsSupertrendCursor Cursor_DefaultValue { get; set; }
		...
		/// </summary>
		public PlotOptionsSupertrendDashStyle DashStyle { get; set; }
		private PlotOptionsSupertrendDashStyle DashStyle_DefaultValue { get; set; }
		...
		/// </summary>
		public PlotOptionsSupertrendDataGrouping DataGrouping { get; set; }
		private PlotOptionsSupertrendDataGrouping DataGrouping_DefaultValue { get; set; }
		...
		/// </summary>
		public PlotOptionsSupertrendDataLabels DataLabels { get; set; }
		private PlotOptionsSupertrendDataLabels DataLabels_DefaultValue { get; set; }
		 

		/// <summary>
		/// Options for the series data sorting.
		/// </summary>
		public PlotOptionsSupertrendDataSorting DataSorting { get; set; }
		private PlotOptionsSupertrendDataSorting DataSorting_DefaultValue { get; set; }
		...
		/// </summary>
		public PlotOptionsSupertrendEvents Events { get; set; }
		private PlotOptionsSupertrendEvents Events_DefaultValue { get; set; }
		 

		/// <summary>
		/// Color of the Supertrend series line that is above the main series.
		/// </summary>
		public string FallingTrendColor { get; set; }
		private string FallingTrendColor_DefaultValue { get; set; }
		...
		/// </summary>
		public PlotOptionsSupertrendFindNearestPointBy FindNearestPointBy { get; set; }
		private PlotOptionsSupertrendFindNearestPointBy FindNearestPointBy_DefaultValue { get; set; }
		...
		/// </summary>
		public PlotOptionsSupertrendGapUnit GapUnit { get; set; }
		private PlotOptionsSupertrendGapUnit GapUnit_DefaultValue { get; set; }
		...
		/// </summary>
		public PlotOptionsSupertrendLabel Label { get; set; }
		private PlotOptionsSupertrendLabel Label_DefaultValue { get; set; }
		 

		/// <summary>
		/// The line marks the last price from all points.
		/// </summary>
		public PlotOptionsSupertrendLastPrice LastPrice { get; set; }
		private PlotOptionsSupertrendLastPrice LastPrice_DefaultValue { get; set; }
		 

		/// <summary>
		/// The line marks the last price from visible range of points.
		/// </summary>
		public PlotOptionsSupertrendLastVisiblePrice LastVisiblePrice { get; set; }
		private PlotOptionsSupertrendLastVisiblePrice LastVisiblePrice_DefaultValue { get; set; }
		 

		/// <summary>
		/// What type of legend symbol to render for this series. Can be one of`areaMarker`, `lineMarker` or `rectangle`.
		/// </summary>
		public PlotOptionsSupertrendLegendSymbol LegendSymbol { get; set; }
		private PlotOptionsSupertrendLegendSymbol LegendSymbol_DefaultValue { get; set; }
		 

		/// <summary>
		/// The line cap used for line ends and line joins on the graph.
		/// </summary>
		public PlotOptionsSupertrendLinecap Linecap { get; set; }
		private PlotOptionsSupertrendLinecap Linecap_DefaultValue { get; set; }
		...
		/// </summary>
		public PlotOptionsSupertrendMarker Marker { get; set; }
		private PlotOptionsSupertrendMarker Marker_DefaultValue { get; set; }
		 

		/// <summary>
		/// Options for the _Series on point_ feature. Only `pie` and `sunburst` seriesare supported at this moment.
		/// </summary>
		public PlotOptionsSupertrendOnPoint OnPoint { get; set; }
		private PlotOptionsSupertrendOnPoint OnPoint_DefaultValue { get; set; }
		...
		/// </summary>
		public PlotOptionsSupertrendParams Params { get; set; }
		private PlotOptionsSupertrendParams Params_DefaultValue { get; set; }
		 

		/// <summary>
		/// Properties for each single point.
		/// </summary>
		public PlotOptionsSupertrendPoint Point { get; set; }
		private PlotOptionsSupertrendPoint Point_DefaultValue { get; set; }
		...
		private string RisingTrendColor_DefaultValue { get; set; }
		...
		/// </summary>
		public PlotOptionsSupertrendSonification Sonification { get; set; }
		private PlotOptionsSupertrendSonification Sonification_DefaultValue { get; set; }
		 

		/// <summary>
		/// 
		/// </summary>
		public PlotOptionsSupertrendStates States { get; set; }
		private PlotOptionsSupertrendStates States_DefaultValue { get; set; }
		 

		/// <summary>
		/// Whether to apply steps to the line. Possible values are `left`,`center` and `right`.
		/// </summary>
		public PlotOptionsSupertrendStep Step { get; set; }
		private PlotOptionsSupertrendStep Step_DefaultValue { get; set; }
		...
		/// </summary>
		public PlotOptionsSupertrendTooltip Tooltip { get; set; }
		private PlotOptionsSupertrendTooltip Tooltip_DefaultValue { get; set; }
		...
		/// </summary>
		public List<PlotOptionsSupertrendZones> Zones { get; set; }
		private List<PlotOptionsSupertrendZones> Zones_DefaultValue { get; set; }
