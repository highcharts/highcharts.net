...
namespace Highsoft.Web.Mvc.Stocks
{
	public partial class PlotOptionsSupertrendDataGrouping  : BaseObject
	{
		...
		internal override Hashtable ToHashtable()
		{
			...
			if (Approximation != Approximation_DefaultValue) { h.Add("approximation",Approximation); Highstock.AddFunction("PlotOptionsSupertrendDataGroupingApproximation.approximation", Approximation); }  
