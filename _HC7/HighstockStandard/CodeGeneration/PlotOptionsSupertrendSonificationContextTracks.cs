...
{
	public partial class PlotOptionsSupertrendSonificationContextTracks  : BaseObject
	{
		Hashtable h = new Hashtable();

		public PlotOptionsSupertrendSonificationContextTracks()
		{
			ActiveWhen = ActiveWhen_DefaultValue = new PlotOptionsSupertrendSonificationContextTracksActiveWhen();
			Instrument = Instrument_DefaultValue = null;
			InstrumentString = InstrumentString_DefaultValue = "null";
			Mapping = Mapping_DefaultValue = new PlotOptionsSupertrendSonificationContextTracksMapping();
			MidiName = MidiName_DefaultValue = "";
			PointGrouping = PointGrouping_DefaultValue = new PlotOptionsSupertrendSonificationContextTracksPointGrouping();
			...
			Type = Type_DefaultValue = PlotOptionsSupertrendSonificationContextTracksType.Instrument;
			ValueInterval = ValueInterval_DefaultValue = null;
			ValueMapFunction = ValueMapFunction_DefaultValue = PlotOptionsSupertrendSonificationContextTracksValueMapFunction.Linear;
		...
		/// </summary>
		public PlotOptionsSupertrendSonificationContextTracksActiveWhen ActiveWhen { get; set; }
		private PlotOptionsSupertrendSonificationContextTracksActiveWhen ActiveWhen_DefaultValue { get; set; }
		...
		/// </summary>
		public PlotOptionsSupertrendSonificationContextTracksMapping Mapping { get; set; }
		private PlotOptionsSupertrendSonificationContextTracksMapping Mapping_DefaultValue { get; set; }
		...
		/// </summary>
		public PlotOptionsSupertrendSonificationContextTracksPointGrouping PointGrouping { get; set; }
		private PlotOptionsSupertrendSonificationContextTracksPointGrouping PointGrouping_DefaultValue { get; set; }
		...
		/// </summary>
		public PlotOptionsSupertrendSonificationContextTracksType Type { get; set; }
		private PlotOptionsSupertrendSonificationContextTracksType Type_DefaultValue { get; set; }
		...
		/// </summary>
		public PlotOptionsSupertrendSonificationContextTracksValueMapFunction ValueMapFunction { get; set; }
		private PlotOptionsSupertrendSonificationContextTracksValueMapFunction ValueMapFunction_DefaultValue { get; set; }
