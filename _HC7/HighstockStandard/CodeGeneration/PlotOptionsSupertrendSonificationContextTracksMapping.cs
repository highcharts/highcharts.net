...
{
	public partial class PlotOptionsSupertrendSonificationContextTracksMapping  : BaseObject
	{
		Hashtable h = new Hashtable();

		public PlotOptionsSupertrendSonificationContextTracksMapping()
		{
			Frequency = Frequency_DefaultValue = new PlotOptionsSupertrendSonificationContextTracksMappingFrequency();
			GapBetweenNotes = GapBetweenNotes_DefaultValue = new PlotOptionsSupertrendSonificationContextTracksMappingGapBetweenNotes();
			Highpass = Highpass_DefaultValue = new PlotOptionsSupertrendSonificationContextTracksMappingHighpass();
			Lowpass = Lowpass_DefaultValue = new PlotOptionsSupertrendSonificationContextTracksMappingLowpass();
			NoteDuration = NoteDuration_DefaultValue = new PlotOptionsSupertrendSonificationContextTracksMappingNoteDuration();
			Pan = Pan_DefaultValue = new PlotOptionsSupertrendSonificationContextTracksMappingPan();
			Pitch = Pitch_DefaultValue = new PlotOptionsSupertrendSonificationContextTracksMappingPitch();
			PitchString = PitchString_DefaultValue = "null";
			PitchNumber = PitchNumber_DefaultValue = null;
			PlayDelay = PlayDelay_DefaultValue = new PlotOptionsSupertrendSonificationContextTracksMappingPlayDelay();
			Time = Time_DefaultValue = new PlotOptionsSupertrendSonificationContextTracksMappingTime();
			TimeString = TimeString_DefaultValue = "null";
			TimeNumber = TimeNumber_DefaultValue = null;
			Tremolo = Tremolo_DefaultValue = new PlotOptionsSupertrendSonificationContextTracksMappingTremolo();
			Volume = Volume_DefaultValue = new PlotOptionsSupertrendSonificationContextTracksMappingVolume();
		...
		/// </summary>
		public PlotOptionsSupertrendSonificationContextTracksMappingFrequency Frequency { get; set; }
		private PlotOptionsSupertrendSonificationContextTracksMappingFrequency Frequency_DefaultValue { get; set; }
		...
		/// </summary>
		public PlotOptionsSupertrendSonificationContextTracksMappingGapBetweenNotes GapBetweenNotes { get; set; }
		private PlotOptionsSupertrendSonificationContextTracksMappingGapBetweenNotes GapBetweenNotes_DefaultValue { get; set; }
		...
		/// </summary>
		public PlotOptionsSupertrendSonificationContextTracksMappingHighpass Highpass { get; set; }
		private PlotOptionsSupertrendSonificationContextTracksMappingHighpass Highpass_DefaultValue { get; set; }
		...
		/// </summary>
		public PlotOptionsSupertrendSonificationContextTracksMappingLowpass Lowpass { get; set; }
		private PlotOptionsSupertrendSonificationContextTracksMappingLowpass Lowpass_DefaultValue { get; set; }
		...
		/// </summary>
		public PlotOptionsSupertrendSonificationContextTracksMappingNoteDuration NoteDuration { get; set; }
		private PlotOptionsSupertrendSonificationContextTracksMappingNoteDuration NoteDuration_DefaultValue { get; set; }
		...
		/// </summary>
		public PlotOptionsSupertrendSonificationContextTracksMappingPan Pan { get; set; }
		private PlotOptionsSupertrendSonificationContextTracksMappingPan Pan_DefaultValue { get; set; }
		...
		/// </summary>
		public PlotOptionsSupertrendSonificationContextTracksMappingPitch Pitch { get; set; }
		private PlotOptionsSupertrendSonificationContextTracksMappingPitch Pitch_DefaultValue { get; set; }
		...
		/// </summary>
		public PlotOptionsSupertrendSonificationContextTracksMappingPlayDelay PlayDelay { get; set; }
		private PlotOptionsSupertrendSonificationContextTracksMappingPlayDelay PlayDelay_DefaultValue { get; set; }
		...
		/// </summary>
		public PlotOptionsSupertrendSonificationContextTracksMappingTime Time { get; set; }
		private PlotOptionsSupertrendSonificationContextTracksMappingTime Time_DefaultValue { get; set; }
		...
		/// </summary>
		public PlotOptionsSupertrendSonificationContextTracksMappingTremolo Tremolo { get; set; }
		private PlotOptionsSupertrendSonificationContextTracksMappingTremolo Tremolo_DefaultValue { get; set; }
		 

		/// <summary>
		/// The volume of notes, from 0 to 1.
		/// </summary>
		public PlotOptionsSupertrendSonificationContextTracksMappingVolume Volume { get; set; }
		private PlotOptionsSupertrendSonificationContextTracksMappingVolume Volume_DefaultValue { get; set; }
