...
{
	public partial class PlotOptionsSupertrendSonificationContextTracksMappingPitch  : BaseObject
	{
		Hashtable h = new Hashtable();

		public PlotOptionsSupertrendSonificationContextTracksMappingPitch()
		{
			MapFunction = MapFunction_DefaultValue = PlotOptionsSupertrendSonificationContextTracksMappingPitchMapFunction.Linear;
		...
		/// </summary>
		public PlotOptionsSupertrendSonificationContextTracksMappingPitchMapFunction MapFunction { get; set; }
		private PlotOptionsSupertrendSonificationContextTracksMappingPitchMapFunction MapFunction_DefaultValue { get; set; }
