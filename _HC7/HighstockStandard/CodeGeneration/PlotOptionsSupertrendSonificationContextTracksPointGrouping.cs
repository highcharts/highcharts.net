...
{
	public partial class PlotOptionsSupertrendSonificationContextTracksPointGrouping  : BaseObject
	{
		Hashtable h = new Hashtable();

		public PlotOptionsSupertrendSonificationContextTracksPointGrouping()
		{
			Algorithm = Algorithm_DefaultValue = PlotOptionsSupertrendSonificationContextTracksPointGroupingAlgorithm.Minimax;
		...
		/// </summary>
		public PlotOptionsSupertrendSonificationContextTracksPointGroupingAlgorithm Algorithm { get; set; }
		private PlotOptionsSupertrendSonificationContextTracksPointGroupingAlgorithm Algorithm_DefaultValue { get; set; }
