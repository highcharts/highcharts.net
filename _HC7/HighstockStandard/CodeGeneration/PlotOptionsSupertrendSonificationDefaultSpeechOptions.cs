...
{
	public partial class PlotOptionsSupertrendSonificationDefaultSpeechOptions  : BaseObject
	{
		Hashtable h = new Hashtable();

		public PlotOptionsSupertrendSonificationDefaultSpeechOptions()
		{
			ActiveWhen = ActiveWhen_DefaultValue = new PlotOptionsSupertrendSonificationDefaultSpeechOptionsActiveWhen();
			Language = Language_DefaultValue = "en-US";
			Mapping = Mapping_DefaultValue = new PlotOptionsSupertrendSonificationDefaultSpeechOptionsMapping();
			PointGrouping = PointGrouping_DefaultValue = new PlotOptionsSupertrendSonificationDefaultSpeechOptionsPointGrouping();
			PreferredVoice = PreferredVoice_DefaultValue = "";
			ShowPlayMarker = ShowPlayMarker_DefaultValue = true;
			Type = Type_DefaultValue = PlotOptionsSupertrendSonificationDefaultSpeechOptionsType.Instrument;
		...
		/// </summary>
		public PlotOptionsSupertrendSonificationDefaultSpeechOptionsActiveWhen ActiveWhen { get; set; }
		private PlotOptionsSupertrendSonificationDefaultSpeechOptionsActiveWhen ActiveWhen_DefaultValue { get; set; }
		...
		/// </summary>
		public PlotOptionsSupertrendSonificationDefaultSpeechOptionsMapping Mapping { get; set; }
		private PlotOptionsSupertrendSonificationDefaultSpeechOptionsMapping Mapping_DefaultValue { get; set; }
		 

		/// <summary>
		/// Options for point grouping, specifically for instrument tracks.
		/// </summary>
		public PlotOptionsSupertrendSonificationDefaultSpeechOptionsPointGrouping PointGrouping { get; set; }
		private PlotOptionsSupertrendSonificationDefaultSpeechOptionsPointGrouping PointGrouping_DefaultValue { get; set; }
		...
		/// </summary>
		public PlotOptionsSupertrendSonificationDefaultSpeechOptionsType Type { get; set; }
		private PlotOptionsSupertrendSonificationDefaultSpeechOptionsType Type_DefaultValue { get; set; }
