...
{
	public partial class PlotOptionsSupertrendSonificationTracks  : BaseObject
	{
		Hashtable h = new Hashtable();

		public PlotOptionsSupertrendSonificationTracks()
		{
			ActiveWhen = ActiveWhen_DefaultValue = new PlotOptionsSupertrendSonificationTracksActiveWhen();
			Instrument = Instrument_DefaultValue = null;
			InstrumentString = InstrumentString_DefaultValue = "null";
			Mapping = Mapping_DefaultValue = new PlotOptionsSupertrendSonificationTracksMapping();
			MidiName = MidiName_DefaultValue = "";
			PointGrouping = PointGrouping_DefaultValue = new PlotOptionsSupertrendSonificationTracksPointGrouping();
			RoundToMusicalNotes = RoundToMusicalNotes_DefaultValue = true;
			ShowPlayMarker = ShowPlayMarker_DefaultValue = true;
			Type = Type_DefaultValue = PlotOptionsSupertrendSonificationTracksType.Instrument;
		...
		/// </summary>
		public PlotOptionsSupertrendSonificationTracksActiveWhen ActiveWhen { get; set; }
		private PlotOptionsSupertrendSonificationTracksActiveWhen ActiveWhen_DefaultValue { get; set; }
		...
		/// </summary>
		public PlotOptionsSupertrendSonificationTracksMapping Mapping { get; set; }
		private PlotOptionsSupertrendSonificationTracksMapping Mapping_DefaultValue { get; set; }
		...
		/// </summary>
		public PlotOptionsSupertrendSonificationTracksPointGrouping PointGrouping { get; set; }
		private PlotOptionsSupertrendSonificationTracksPointGrouping PointGrouping_DefaultValue { get; set; }
		...
		/// </summary>
		public PlotOptionsSupertrendSonificationTracksType Type { get; set; }
		private PlotOptionsSupertrendSonificationTracksType Type_DefaultValue { get; set; }
