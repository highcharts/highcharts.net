...
{
	public partial class PlotOptionsSupertrendSonificationTracksMapping  : BaseObject
	{
		Hashtable h = new Hashtable();

		public PlotOptionsSupertrendSonificationTracksMapping()
		{
			Frequency = Frequency_DefaultValue = new PlotOptionsSupertrendSonificationTracksMappingFrequency();
			GapBetweenNotes = GapBetweenNotes_DefaultValue = new PlotOptionsSupertrendSonificationTracksMappingGapBetweenNotes();
			Highpass = Highpass_DefaultValue = new PlotOptionsSupertrendSonificationTracksMappingHighpass();
			Lowpass = Lowpass_DefaultValue = new PlotOptionsSupertrendSonificationTracksMappingLowpass();
			NoteDuration = NoteDuration_DefaultValue = new PlotOptionsSupertrendSonificationTracksMappingNoteDuration();
			Pan = Pan_DefaultValue = new PlotOptionsSupertrendSonificationTracksMappingPan();
			Pitch = Pitch_DefaultValue = new PlotOptionsSupertrendSonificationTracksMappingPitch();
			PitchString = PitchString_DefaultValue = "null";
			PitchNumber = PitchNumber_DefaultValue = null;
			PlayDelay = PlayDelay_DefaultValue = new PlotOptionsSupertrendSonificationTracksMappingPlayDelay();
			Time = Time_DefaultValue = new PlotOptionsSupertrendSonificationTracksMappingTime();
			TimeString = TimeString_DefaultValue = "null";
			TimeNumber = TimeNumber_DefaultValue = null;
			Tremolo = Tremolo_DefaultValue = new PlotOptionsSupertrendSonificationTracksMappingTremolo();
			Volume = Volume_DefaultValue = new PlotOptionsSupertrendSonificationTracksMappingVolume();
		...
		/// </summary>
		public PlotOptionsSupertrendSonificationTracksMappingFrequency Frequency { get; set; }
		private PlotOptionsSupertrendSonificationTracksMappingFrequency Frequency_DefaultValue { get; set; }
		...
		/// </summary>
		public PlotOptionsSupertrendSonificationTracksMappingGapBetweenNotes GapBetweenNotes { get; set; }
		private PlotOptionsSupertrendSonificationTracksMappingGapBetweenNotes GapBetweenNotes_DefaultValue { get; set; }
		...
		/// </summary>
		public PlotOptionsSupertrendSonificationTracksMappingHighpass Highpass { get; set; }
		private PlotOptionsSupertrendSonificationTracksMappingHighpass Highpass_DefaultValue { get; set; }
		...
		/// </summary>
		public PlotOptionsSupertrendSonificationTracksMappingLowpass Lowpass { get; set; }
		private PlotOptionsSupertrendSonificationTracksMappingLowpass Lowpass_DefaultValue { get; set; }
		...
		/// </summary>
		public PlotOptionsSupertrendSonificationTracksMappingNoteDuration NoteDuration { get; set; }
		private PlotOptionsSupertrendSonificationTracksMappingNoteDuration NoteDuration_DefaultValue { get; set; }
		...
		/// </summary>
		public PlotOptionsSupertrendSonificationTracksMappingPan Pan { get; set; }
		private PlotOptionsSupertrendSonificationTracksMappingPan Pan_DefaultValue { get; set; }
		...
		/// </summary>
		public PlotOptionsSupertrendSonificationTracksMappingPitch Pitch { get; set; }
		private PlotOptionsSupertrendSonificationTracksMappingPitch Pitch_DefaultValue { get; set; }
		...
		/// </summary>
		public PlotOptionsSupertrendSonificationTracksMappingPlayDelay PlayDelay { get; set; }
		private PlotOptionsSupertrendSonificationTracksMappingPlayDelay PlayDelay_DefaultValue { get; set; }
		...
		/// </summary>
		public PlotOptionsSupertrendSonificationTracksMappingTime Time { get; set; }
		private PlotOptionsSupertrendSonificationTracksMappingTime Time_DefaultValue { get; set; }
		...
		/// </summary>
		public PlotOptionsSupertrendSonificationTracksMappingTremolo Tremolo { get; set; }
		private PlotOptionsSupertrendSonificationTracksMappingTremolo Tremolo_DefaultValue { get; set; }
		 

		/// <summary>
		/// The volume of notes, from 0 to 1.
		/// </summary>
		public PlotOptionsSupertrendSonificationTracksMappingVolume Volume { get; set; }
		private PlotOptionsSupertrendSonificationTracksMappingVolume Volume_DefaultValue { get; set; }
