...
{
	public partial class PlotOptionsSupertrendSonificationTracksMappingPan  : BaseObject
	{
		Hashtable h = new Hashtable();

		public PlotOptionsSupertrendSonificationTracksMappingPan()
		{
			MapFunction = MapFunction_DefaultValue = PlotOptionsSupertrendSonificationTracksMappingPanMapFunction.Linear;
			MapTo = MapTo_DefaultValue = "";
			Max = Max_DefaultValue = null;
			Min = Min_DefaultValue = null;
			Value = Value_DefaultValue = null;
			Within = Within_DefaultValue = PlotOptionsSupertrendSonificationTracksMappingPanWithin.Chart;
		...
		/// </summary>
		public PlotOptionsSupertrendSonificationTracksMappingPanMapFunction MapFunction { get; set; }
		private PlotOptionsSupertrendSonificationTracksMappingPanMapFunction MapFunction_DefaultValue { get; set; }
		...
		/// </summary>
		public PlotOptionsSupertrendSonificationTracksMappingPanWithin Within { get; set; }
		private PlotOptionsSupertrendSonificationTracksMappingPanWithin Within_DefaultValue { get; set; }
