...
{
	public partial class PlotOptionsSupertrendSonificationTracksMappingPitch  : BaseObject
	{
		Hashtable h = new Hashtable();

		public PlotOptionsSupertrendSonificationTracksMappingPitch()
		{
			MapFunction = MapFunction_DefaultValue = PlotOptionsSupertrendSonificationTracksMappingPitchMapFunction.Linear;
		...
		/// </summary>
		public PlotOptionsSupertrendSonificationTracksMappingPitchMapFunction MapFunction { get; set; }
		private PlotOptionsSupertrendSonificationTracksMappingPitchMapFunction MapFunction_DefaultValue { get; set; }
