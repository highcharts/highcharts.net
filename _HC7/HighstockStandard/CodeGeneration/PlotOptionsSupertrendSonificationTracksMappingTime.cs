...
{
	public partial class PlotOptionsSupertrendSonificationTracksMappingTime  : BaseObject
	{
		Hashtable h = new Hashtable();

		public PlotOptionsSupertrendSonificationTracksMappingTime()
		{
			MapFunction = MapFunction_DefaultValue = PlotOptionsSupertrendSonificationTracksMappingTimeMapFunction.Linear;
			MapTo = MapTo_DefaultValue = "";
			Max = Max_DefaultValue = null;
			Min = Min_DefaultValue = null;
			Value = Value_DefaultValue = null;
			Within = Within_DefaultValue = PlotOptionsSupertrendSonificationTracksMappingTimeWithin.Chart;
		...
		/// </summary>
		public PlotOptionsSupertrendSonificationTracksMappingTimeMapFunction MapFunction { get; set; }
		private PlotOptionsSupertrendSonificationTracksMappingTimeMapFunction MapFunction_DefaultValue { get; set; }
		...
		/// </summary>
		public PlotOptionsSupertrendSonificationTracksMappingTimeWithin Within { get; set; }
		private PlotOptionsSupertrendSonificationTracksMappingTimeWithin Within_DefaultValue { get; set; }
