...
{
	public partial class PlotOptionsSupertrendTooltip  : BaseObject
	{
		public PlotOptionsSupertrendTooltip()
		{
			...
			HeaderShape = HeaderShape_DefaultValue = PlotOptionsSupertrendTooltipHeaderShape.Callout;
		...
		/// </summary>
		public PlotOptionsSupertrendTooltipHeaderShape HeaderShape { get; set; }
		private PlotOptionsSupertrendTooltipHeaderShape HeaderShape_DefaultValue { get; set; }
		...
		internal override Hashtable ToHashtable()
		{
			...
			if (NullFormatter != NullFormatter_DefaultValue) { h.Add("nullFormatter",NullFormatter); Highstock.AddFunction("PlotOptionsSupertrendTooltipNullFormatter.nullFormatter", NullFormatter); }  
			if (Outside != Outside_DefaultValue) h.Add("outside",Outside);
			if (Padding != Padding_DefaultValue) h.Add("padding",Padding);
			if (PointFormat != PointFormat_DefaultValue) h.Add("pointFormat",PointFormat);
			if (PointFormatter != PointFormatter_DefaultValue) { h.Add("pointFormatter",PointFormatter); Highstock.AddFunction("PlotOptionsSupertrendTooltipPointFormatter.pointFormatter", PointFormatter); }  
