...
{
	public partial class PlotOptionsTema  : BaseObject
	{
		Hashtable h = new Hashtable();

		public PlotOptionsTema()
		{
			Accessibility = Accessibility_DefaultValue = new PlotOptionsTemaAccessibility();
			AllowPointSelect = AllowPointSelect_DefaultValue = false;
			Animation = Animation_DefaultValue = new Animation() { Enabled = true };
			AnimationBool = AnimationBool_DefaultValue = true;
			AnimationLimit = AnimationLimit_DefaultValue = null;
			BoostBlending = BoostBlending_DefaultValue = PlotOptionsTemaBoostBlending.Undefined;
			...
			Cursor = Cursor_DefaultValue = PlotOptionsTemaCursor.Null;
			Custom = Custom_DefaultValue = new Hashtable();
			DashStyle = DashStyle_DefaultValue = PlotOptionsTemaDashStyle.Null;
			DataGrouping = DataGrouping_DefaultValue = new PlotOptionsTemaDataGrouping();
			DataLabels = DataLabels_DefaultValue = new PlotOptionsTemaDataLabels();
			DataSorting = DataSorting_DefaultValue = new PlotOptionsTemaDataSorting();
			Description = Description_DefaultValue = "";
			EnableMouseTracking = EnableMouseTracking_DefaultValue = true;
			Events = Events_DefaultValue = new PlotOptionsTemaEvents();
			FindNearestPointBy = FindNearestPointBy_DefaultValue = PlotOptionsTemaFindNearestPointBy.X;
			GapSize = GapSize_DefaultValue = 0;
			GapUnit = GapUnit_DefaultValue = PlotOptionsTemaGapUnit.Relative;
			GetExtremesFromAll = GetExtremesFromAll_DefaultValue = false;
			InactiveOtherPoints = InactiveOtherPoints_DefaultValue = false;
			IncludeInDataExport = IncludeInDataExport_DefaultValue = null;
			Label = Label_DefaultValue = new PlotOptionsTemaLabel();
			LastPrice = LastPrice_DefaultValue = new PlotOptionsTemaLastPrice();
			LastVisiblePrice = LastVisiblePrice_DefaultValue = new PlotOptionsTemaLastVisiblePrice();
			LegendSymbol = LegendSymbol_DefaultValue = PlotOptionsTemaLegendSymbol.Rectangle;
			Linecap = Linecap_DefaultValue = PlotOptionsTemaLinecap.Round;
			LineWidth = LineWidth_DefaultValue = 2;
			LinkedTo = LinkedTo_DefaultValue = "";
			Marker = Marker_DefaultValue = new PlotOptionsTemaMarker();
			NegativeColor = NegativeColor_DefaultValue = "";
			OnPoint = OnPoint_DefaultValue = new PlotOptionsTemaOnPoint();
			Opacity = Opacity_DefaultValue = 1;
			Params = Params_DefaultValue = new PlotOptionsTemaParams();
			Point = Point_DefaultValue = new PlotOptionsTemaPoint();
			...
			Sonification = Sonification_DefaultValue = new PlotOptionsTemaSonification();
			States = States_DefaultValue = new PlotOptionsTemaStates();
			Step = Step_DefaultValue = PlotOptionsTemaStep.Null;
			StickyTracking = StickyTracking_DefaultValue = true;
			Threshold = Threshold_DefaultValue = 0;
			Tooltip = Tooltip_DefaultValue = new PlotOptionsTemaTooltip();
			TurboThreshold = TurboThreshold_DefaultValue = 1000;
			Visible = Visible_DefaultValue = true;
			ZoneAxis = ZoneAxis_DefaultValue = "y";
			Zones = Zones_DefaultValue = new List<PlotOptionsTemaZones>();
		...
		/// </summary>
		public PlotOptionsTemaAccessibility Accessibility { get; set; }
		private PlotOptionsTemaAccessibility Accessibility_DefaultValue { get; set; }
		...
		/// </summary>
		public PlotOptionsTemaBoostBlending BoostBlending { get; set; }
		private PlotOptionsTemaBoostBlending BoostBlending_DefaultValue { get; set; }
		...
		/// </summary>
		public PlotOptionsTemaCursor Cursor { get; set; }
		private PlotOptionsTemaCursor Cursor_DefaultValue { get; set; }
		...
		/// </summary>
		public PlotOptionsTemaDashStyle DashStyle { get; set; }
		private PlotOptionsTemaDashStyle DashStyle_DefaultValue { get; set; }
		...
		/// </summary>
		public PlotOptionsTemaDataGrouping DataGrouping { get; set; }
		private PlotOptionsTemaDataGrouping DataGrouping_DefaultValue { get; set; }
		...
		/// </summary>
		public PlotOptionsTemaDataLabels DataLabels { get; set; }
		private PlotOptionsTemaDataLabels DataLabels_DefaultValue { get; set; }
		 

		/// <summary>
		/// Options for the series data sorting.
		/// </summary>
		public PlotOptionsTemaDataSorting DataSorting { get; set; }
		private PlotOptionsTemaDataSorting DataSorting_DefaultValue { get; set; }
		...
		/// </summary>
		public PlotOptionsTemaEvents Events { get; set; }
		private PlotOptionsTemaEvents Events_DefaultValue { get; set; }
		...
		/// </summary>
		public PlotOptionsTemaFindNearestPointBy FindNearestPointBy { get; set; }
		private PlotOptionsTemaFindNearestPointBy FindNearestPointBy_DefaultValue { get; set; }
		...
		/// </summary>
		public PlotOptionsTemaGapUnit GapUnit { get; set; }
		private PlotOptionsTemaGapUnit GapUnit_DefaultValue { get; set; }
		...
		/// </summary>
		public PlotOptionsTemaLabel Label { get; set; }
		private PlotOptionsTemaLabel Label_DefaultValue { get; set; }
		 

		/// <summary>
		/// The line marks the last price from all points.
		/// </summary>
		public PlotOptionsTemaLastPrice LastPrice { get; set; }
		private PlotOptionsTemaLastPrice LastPrice_DefaultValue { get; set; }
		 

		/// <summary>
		/// The line marks the last price from visible range of points.
		/// </summary>
		public PlotOptionsTemaLastVisiblePrice LastVisiblePrice { get; set; }
		private PlotOptionsTemaLastVisiblePrice LastVisiblePrice_DefaultValue { get; set; }
		 

		/// <summary>
		/// What type of legend symbol to render for this series. Can be one of`areaMarker`, `lineMarker` or `rectangle`.
		/// </summary>
		public PlotOptionsTemaLegendSymbol LegendSymbol { get; set; }
		private PlotOptionsTemaLegendSymbol LegendSymbol_DefaultValue { get; set; }
		 

		/// <summary>
		/// The line cap used for line ends and line joins on the graph.
		/// </summary>
		public PlotOptionsTemaLinecap Linecap { get; set; }
		private PlotOptionsTemaLinecap Linecap_DefaultValue { get; set; }
		...
		/// </summary>
		public PlotOptionsTemaMarker Marker { get; set; }
		private PlotOptionsTemaMarker Marker_DefaultValue { get; set; }
		...
		/// </summary>
		public PlotOptionsTemaOnPoint OnPoint { get; set; }
		private PlotOptionsTemaOnPoint OnPoint_DefaultValue { get; set; }
		...
		/// </summary>
		public PlotOptionsTemaParams Params { get; set; }
		private PlotOptionsTemaParams Params_DefaultValue { get; set; }
		 

		/// <summary>
		/// Properties for each single point.
		/// </summary>
		public PlotOptionsTemaPoint Point { get; set; }
		private PlotOptionsTemaPoint Point_DefaultValue { get; set; }
		...
		/// </summary>
		public PlotOptionsTemaSonification Sonification { get; set; }
		private PlotOptionsTemaSonification Sonification_DefaultValue { get; set; }
		 

		/// <summary>
		/// 
		/// </summary>
		public PlotOptionsTemaStates States { get; set; }
		private PlotOptionsTemaStates States_DefaultValue { get; set; }
		 

		/// <summary>
		/// Whether to apply steps to the line. Possible values are `left`,`center` and `right`.
		/// </summary>
		public PlotOptionsTemaStep Step { get; set; }
		private PlotOptionsTemaStep Step_DefaultValue { get; set; }
		...
		/// </summary>
		public PlotOptionsTemaTooltip Tooltip { get; set; }
		private PlotOptionsTemaTooltip Tooltip_DefaultValue { get; set; }
		...
		/// </summary>
		public List<PlotOptionsTemaZones> Zones { get; set; }
		private List<PlotOptionsTemaZones> Zones_DefaultValue { get; set; }
