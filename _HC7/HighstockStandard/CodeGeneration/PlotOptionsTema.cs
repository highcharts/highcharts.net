...
namespace Highsoft.Web.Mvc.Stocks
{
	public partial class PlotOptionsTema  : BaseObject
	{
		...
		public PlotOptionsTema()
		{
			...
			Zones = Zones_DefaultValue = new List<PlotOptionsTemaZone>();
		...
		/// </summary>
		public List<PlotOptionsTemaZone> Zones { get; set; }
		private List<PlotOptionsTemaZone> Zones_DefaultValue { get; set; }
