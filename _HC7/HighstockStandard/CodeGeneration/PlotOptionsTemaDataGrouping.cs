...
namespace Highsoft.Web.Mvc.Stocks
{
	public partial class PlotOptionsTemaDataGrouping  : BaseObject
	{
		...
		internal override Hashtable ToHashtable()
		{
			...
			if (Approximation != Approximation_DefaultValue) { h.Add("approximation",Approximation); Highstock.AddFunction("PlotOptionsTemaDataGroupingApproximation.approximation", Approximation); }  
