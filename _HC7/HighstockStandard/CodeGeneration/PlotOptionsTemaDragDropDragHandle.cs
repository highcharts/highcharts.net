...
{
	public partial class PlotOptionsTemaDragDropDragHandle  : BaseObject
	{
		public PlotOptionsTemaDragDropDragHandle()
		{
		...
		internal override Hashtable ToHashtable()
		{
			...
			if (PathFormatter != PathFormatter_DefaultValue) { h.Add("pathFormatter",PathFormatter); Highstock.AddFunction("PlotOptionsTemaDragDropDragHandlePathFormatter.pathFormatter", PathFormatter); }  
