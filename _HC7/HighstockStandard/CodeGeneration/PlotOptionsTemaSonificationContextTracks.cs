...
{
	public partial class PlotOptionsTemaSonificationContextTracks  : BaseObject
	{
		Hashtable h = new Hashtable();

		public PlotOptionsTemaSonificationContextTracks()
		{
			ActiveWhen = ActiveWhen_DefaultValue = new PlotOptionsTemaSonificationContextTracksActiveWhen();
			Instrument = Instrument_DefaultValue = null;
			InstrumentString = InstrumentString_DefaultValue = "null";
			Mapping = Mapping_DefaultValue = new PlotOptionsTemaSonificationContextTracksMapping();
			MidiName = MidiName_DefaultValue = "";
			PointGrouping = PointGrouping_DefaultValue = new PlotOptionsTemaSonificationContextTracksPointGrouping();
			...
			Type = Type_DefaultValue = PlotOptionsTemaSonificationContextTracksType.Instrument;
			ValueInterval = ValueInterval_DefaultValue = null;
			ValueMapFunction = ValueMapFunction_DefaultValue = PlotOptionsTemaSonificationContextTracksValueMapFunction.Linear;
		...
		/// </summary>
		public PlotOptionsTemaSonificationContextTracksActiveWhen ActiveWhen { get; set; }
		private PlotOptionsTemaSonificationContextTracksActiveWhen ActiveWhen_DefaultValue { get; set; }
		...
		/// </summary>
		public PlotOptionsTemaSonificationContextTracksMapping Mapping { get; set; }
		private PlotOptionsTemaSonificationContextTracksMapping Mapping_DefaultValue { get; set; }
		...
		/// </summary>
		public PlotOptionsTemaSonificationContextTracksPointGrouping PointGrouping { get; set; }
		private PlotOptionsTemaSonificationContextTracksPointGrouping PointGrouping_DefaultValue { get; set; }
		...
		/// </summary>
		public PlotOptionsTemaSonificationContextTracksType Type { get; set; }
		private PlotOptionsTemaSonificationContextTracksType Type_DefaultValue { get; set; }
		...
		/// </summary>
		public PlotOptionsTemaSonificationContextTracksValueMapFunction ValueMapFunction { get; set; }
		private PlotOptionsTemaSonificationContextTracksValueMapFunction ValueMapFunction_DefaultValue { get; set; }
