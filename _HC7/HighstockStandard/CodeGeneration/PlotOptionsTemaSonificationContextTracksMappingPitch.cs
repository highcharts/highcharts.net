...
{
	public partial class PlotOptionsTemaSonificationContextTracksMappingPitch  : BaseObject
	{
		Hashtable h = new Hashtable();

		public PlotOptionsTemaSonificationContextTracksMappingPitch()
		{
			MapFunction = MapFunction_DefaultValue = PlotOptionsTemaSonificationContextTracksMappingPitchMapFunction.Linear;
		...
		/// </summary>
		public PlotOptionsTemaSonificationContextTracksMappingPitchMapFunction MapFunction { get; set; }
		private PlotOptionsTemaSonificationContextTracksMappingPitchMapFunction MapFunction_DefaultValue { get; set; }
