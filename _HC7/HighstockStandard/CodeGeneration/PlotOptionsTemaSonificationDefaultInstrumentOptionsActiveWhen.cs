...
{
	public partial class PlotOptionsTemaSonificationDefaultInstrumentOptionsActiveWhen  : BaseObject
	{
		Hashtable h = new Hashtable();

		public PlotOptionsTemaSonificationDefaultInstrumentOptionsActiveWhen()
		{
