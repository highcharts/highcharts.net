...
{
	public partial class PlotOptionsTemaSonificationDefaultSpeechOptionsMappingTremoloDepth  : BaseObject
	{
		Hashtable h = new Hashtable();

		public PlotOptionsTemaSonificationDefaultSpeechOptionsMappingTremoloDepth()
		{
			MapFunction = MapFunction_DefaultValue = PlotOptionsTemaSonificationDefaultSpeechOptionsMappingTremoloDepthMapFunction.Linear;
			MapTo = MapTo_DefaultValue = "";
			Max = Max_DefaultValue = null;
			Min = Min_DefaultValue = null;
			Value = Value_DefaultValue = null;
			Within = Within_DefaultValue = PlotOptionsTemaSonificationDefaultSpeechOptionsMappingTremoloDepthWithin.Chart;
		...
		/// </summary>
		public PlotOptionsTemaSonificationDefaultSpeechOptionsMappingTremoloDepthMapFunction MapFunction { get; set; }
		private PlotOptionsTemaSonificationDefaultSpeechOptionsMappingTremoloDepthMapFunction MapFunction_DefaultValue { get; set; }
		...
		/// </summary>
		public PlotOptionsTemaSonificationDefaultSpeechOptionsMappingTremoloDepthWithin Within { get; set; }
		private PlotOptionsTemaSonificationDefaultSpeechOptionsMappingTremoloDepthWithin Within_DefaultValue { get; set; }
