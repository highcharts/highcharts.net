...
{
	public partial class PlotOptionsTemaSonificationDefaultSpeechOptionsMappingVolume  : BaseObject
	{
		Hashtable h = new Hashtable();

		public PlotOptionsTemaSonificationDefaultSpeechOptionsMappingVolume()
		{
			MapFunction = MapFunction_DefaultValue = PlotOptionsTemaSonificationDefaultSpeechOptionsMappingVolumeMapFunction.Linear;
			MapTo = MapTo_DefaultValue = "";
			Max = Max_DefaultValue = null;
			Min = Min_DefaultValue = null;
			Value = Value_DefaultValue = null;
			Within = Within_DefaultValue = PlotOptionsTemaSonificationDefaultSpeechOptionsMappingVolumeWithin.Chart;
		...
		/// </summary>
		public PlotOptionsTemaSonificationDefaultSpeechOptionsMappingVolumeMapFunction MapFunction { get; set; }
		private PlotOptionsTemaSonificationDefaultSpeechOptionsMappingVolumeMapFunction MapFunction_DefaultValue { get; set; }
		...
		/// </summary>
		public PlotOptionsTemaSonificationDefaultSpeechOptionsMappingVolumeWithin Within { get; set; }
		private PlotOptionsTemaSonificationDefaultSpeechOptionsMappingVolumeWithin Within_DefaultValue { get; set; }
