...
{
	public partial class PlotOptionsTemaSonificationTracks  : BaseObject
	{
		Hashtable h = new Hashtable();

		public PlotOptionsTemaSonificationTracks()
		{
			ActiveWhen = ActiveWhen_DefaultValue = new PlotOptionsTemaSonificationTracksActiveWhen();
			Instrument = Instrument_DefaultValue = null;
			InstrumentString = InstrumentString_DefaultValue = "null";
			Mapping = Mapping_DefaultValue = new PlotOptionsTemaSonificationTracksMapping();
			MidiName = MidiName_DefaultValue = "";
			PointGrouping = PointGrouping_DefaultValue = new PlotOptionsTemaSonificationTracksPointGrouping();
			RoundToMusicalNotes = RoundToMusicalNotes_DefaultValue = true;
			ShowPlayMarker = ShowPlayMarker_DefaultValue = true;
			Type = Type_DefaultValue = PlotOptionsTemaSonificationTracksType.Instrument;
		...
		/// </summary>
		public PlotOptionsTemaSonificationTracksActiveWhen ActiveWhen { get; set; }
		private PlotOptionsTemaSonificationTracksActiveWhen ActiveWhen_DefaultValue { get; set; }
		...
		/// </summary>
		public PlotOptionsTemaSonificationTracksMapping Mapping { get; set; }
		private PlotOptionsTemaSonificationTracksMapping Mapping_DefaultValue { get; set; }
		...
		/// </summary>
		public PlotOptionsTemaSonificationTracksPointGrouping PointGrouping { get; set; }
		private PlotOptionsTemaSonificationTracksPointGrouping PointGrouping_DefaultValue { get; set; }
		...
		/// </summary>
		public PlotOptionsTemaSonificationTracksType Type { get; set; }
		private PlotOptionsTemaSonificationTracksType Type_DefaultValue { get; set; }
