...
{
	public partial class PlotOptionsTemaSonificationTracksMapping  : BaseObject
	{
		Hashtable h = new Hashtable();

		public PlotOptionsTemaSonificationTracksMapping()
		{
			Frequency = Frequency_DefaultValue = new PlotOptionsTemaSonificationTracksMappingFrequency();
			GapBetweenNotes = GapBetweenNotes_DefaultValue = new PlotOptionsTemaSonificationTracksMappingGapBetweenNotes();
			Highpass = Highpass_DefaultValue = new PlotOptionsTemaSonificationTracksMappingHighpass();
			Lowpass = Lowpass_DefaultValue = new PlotOptionsTemaSonificationTracksMappingLowpass();
			NoteDuration = NoteDuration_DefaultValue = new PlotOptionsTemaSonificationTracksMappingNoteDuration();
			Pan = Pan_DefaultValue = new PlotOptionsTemaSonificationTracksMappingPan();
			Pitch = Pitch_DefaultValue = new PlotOptionsTemaSonificationTracksMappingPitch();
			PitchString = PitchString_DefaultValue = "null";
			PitchNumber = PitchNumber_DefaultValue = null;
			PlayDelay = PlayDelay_DefaultValue = new PlotOptionsTemaSonificationTracksMappingPlayDelay();
			Time = Time_DefaultValue = new PlotOptionsTemaSonificationTracksMappingTime();
			TimeString = TimeString_DefaultValue = "null";
			TimeNumber = TimeNumber_DefaultValue = null;
			Tremolo = Tremolo_DefaultValue = new PlotOptionsTemaSonificationTracksMappingTremolo();
			Volume = Volume_DefaultValue = new PlotOptionsTemaSonificationTracksMappingVolume();
		...
		/// </summary>
		public PlotOptionsTemaSonificationTracksMappingFrequency Frequency { get; set; }
		private PlotOptionsTemaSonificationTracksMappingFrequency Frequency_DefaultValue { get; set; }
		...
		/// </summary>
		public PlotOptionsTemaSonificationTracksMappingGapBetweenNotes GapBetweenNotes { get; set; }
		private PlotOptionsTemaSonificationTracksMappingGapBetweenNotes GapBetweenNotes_DefaultValue { get; set; }
		...
		/// </summary>
		public PlotOptionsTemaSonificationTracksMappingHighpass Highpass { get; set; }
		private PlotOptionsTemaSonificationTracksMappingHighpass Highpass_DefaultValue { get; set; }
		...
		/// </summary>
		public PlotOptionsTemaSonificationTracksMappingLowpass Lowpass { get; set; }
		private PlotOptionsTemaSonificationTracksMappingLowpass Lowpass_DefaultValue { get; set; }
		...
		/// </summary>
		public PlotOptionsTemaSonificationTracksMappingNoteDuration NoteDuration { get; set; }
		private PlotOptionsTemaSonificationTracksMappingNoteDuration NoteDuration_DefaultValue { get; set; }
		...
		/// </summary>
		public PlotOptionsTemaSonificationTracksMappingPan Pan { get; set; }
		private PlotOptionsTemaSonificationTracksMappingPan Pan_DefaultValue { get; set; }
		...
		/// </summary>
		public PlotOptionsTemaSonificationTracksMappingPitch Pitch { get; set; }
		private PlotOptionsTemaSonificationTracksMappingPitch Pitch_DefaultValue { get; set; }
		...
		/// </summary>
		public PlotOptionsTemaSonificationTracksMappingPlayDelay PlayDelay { get; set; }
		private PlotOptionsTemaSonificationTracksMappingPlayDelay PlayDelay_DefaultValue { get; set; }
		...
		/// </summary>
		public PlotOptionsTemaSonificationTracksMappingTime Time { get; set; }
		private PlotOptionsTemaSonificationTracksMappingTime Time_DefaultValue { get; set; }
		...
		/// </summary>
		public PlotOptionsTemaSonificationTracksMappingTremolo Tremolo { get; set; }
		private PlotOptionsTemaSonificationTracksMappingTremolo Tremolo_DefaultValue { get; set; }
		 

		/// <summary>
		/// The volume of notes, from 0 to 1.
		/// </summary>
		public PlotOptionsTemaSonificationTracksMappingVolume Volume { get; set; }
		private PlotOptionsTemaSonificationTracksMappingVolume Volume_DefaultValue { get; set; }
