...
{
	public partial class PlotOptionsTemaSonificationTracksMappingFrequency  : BaseObject
	{
		Hashtable h = new Hashtable();

		public PlotOptionsTemaSonificationTracksMappingFrequency()
		{
			MapFunction = MapFunction_DefaultValue = PlotOptionsTemaSonificationTracksMappingFrequencyMapFunction.Linear;
			MapTo = MapTo_DefaultValue = "";
			Max = Max_DefaultValue = null;
			Min = Min_DefaultValue = null;
			Value = Value_DefaultValue = null;
			Within = Within_DefaultValue = PlotOptionsTemaSonificationTracksMappingFrequencyWithin.Chart;
		...
		/// </summary>
		public PlotOptionsTemaSonificationTracksMappingFrequencyMapFunction MapFunction { get; set; }
		private PlotOptionsTemaSonificationTracksMappingFrequencyMapFunction MapFunction_DefaultValue { get; set; }
		...
		/// </summary>
		public PlotOptionsTemaSonificationTracksMappingFrequencyWithin Within { get; set; }
		private PlotOptionsTemaSonificationTracksMappingFrequencyWithin Within_DefaultValue { get; set; }
