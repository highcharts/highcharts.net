...
{
	public partial class PlotOptionsTemaSonificationTracksMappingNoteDuration  : BaseObject
	{
		Hashtable h = new Hashtable();

		public PlotOptionsTemaSonificationTracksMappingNoteDuration()
		{
			MapFunction = MapFunction_DefaultValue = PlotOptionsTemaSonificationTracksMappingNoteDurationMapFunction.Linear;
			MapTo = MapTo_DefaultValue = "";
			Max = Max_DefaultValue = null;
			Min = Min_DefaultValue = null;
			Value = Value_DefaultValue = null;
			Within = Within_DefaultValue = PlotOptionsTemaSonificationTracksMappingNoteDurationWithin.Chart;
		...
		/// </summary>
		public PlotOptionsTemaSonificationTracksMappingNoteDurationMapFunction MapFunction { get; set; }
		private PlotOptionsTemaSonificationTracksMappingNoteDurationMapFunction MapFunction_DefaultValue { get; set; }
		...
		/// </summary>
		public PlotOptionsTemaSonificationTracksMappingNoteDurationWithin Within { get; set; }
		private PlotOptionsTemaSonificationTracksMappingNoteDurationWithin Within_DefaultValue { get; set; }
