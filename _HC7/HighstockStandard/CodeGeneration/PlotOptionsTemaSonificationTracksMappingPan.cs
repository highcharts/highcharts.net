...
{
	public partial class PlotOptionsTemaSonificationTracksMappingPan  : BaseObject
	{
		Hashtable h = new Hashtable();

		public PlotOptionsTemaSonificationTracksMappingPan()
		{
			MapFunction = MapFunction_DefaultValue = PlotOptionsTemaSonificationTracksMappingPanMapFunction.Linear;
			MapTo = MapTo_DefaultValue = "";
			Max = Max_DefaultValue = null;
			Min = Min_DefaultValue = null;
			Value = Value_DefaultValue = null;
			Within = Within_DefaultValue = PlotOptionsTemaSonificationTracksMappingPanWithin.Chart;
		...
		/// </summary>
		public PlotOptionsTemaSonificationTracksMappingPanMapFunction MapFunction { get; set; }
		private PlotOptionsTemaSonificationTracksMappingPanMapFunction MapFunction_DefaultValue { get; set; }
		...
		/// </summary>
		public PlotOptionsTemaSonificationTracksMappingPanWithin Within { get; set; }
		private PlotOptionsTemaSonificationTracksMappingPanWithin Within_DefaultValue { get; set; }
