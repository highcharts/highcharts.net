...
{
	public partial class PlotOptionsTemaSonificationTracksMappingPitch  : BaseObject
	{
		Hashtable h = new Hashtable();

		public PlotOptionsTemaSonificationTracksMappingPitch()
		{
			MapFunction = MapFunction_DefaultValue = PlotOptionsTemaSonificationTracksMappingPitchMapFunction.Linear;
		...
		/// </summary>
		public PlotOptionsTemaSonificationTracksMappingPitchMapFunction MapFunction { get; set; }
		private PlotOptionsTemaSonificationTracksMappingPitchMapFunction MapFunction_DefaultValue { get; set; }
