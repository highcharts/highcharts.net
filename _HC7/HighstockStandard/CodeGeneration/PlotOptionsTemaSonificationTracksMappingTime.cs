...
{
	public partial class PlotOptionsTemaSonificationTracksMappingTime  : BaseObject
	{
		Hashtable h = new Hashtable();

		public PlotOptionsTemaSonificationTracksMappingTime()
		{
			MapFunction = MapFunction_DefaultValue = PlotOptionsTemaSonificationTracksMappingTimeMapFunction.Linear;
			MapTo = MapTo_DefaultValue = "";
			Max = Max_DefaultValue = null;
			Min = Min_DefaultValue = null;
			Value = Value_DefaultValue = null;
			Within = Within_DefaultValue = PlotOptionsTemaSonificationTracksMappingTimeWithin.Chart;
		...
		/// </summary>
		public PlotOptionsTemaSonificationTracksMappingTimeMapFunction MapFunction { get; set; }
		private PlotOptionsTemaSonificationTracksMappingTimeMapFunction MapFunction_DefaultValue { get; set; }
		...
		/// </summary>
		public PlotOptionsTemaSonificationTracksMappingTimeWithin Within { get; set; }
		private PlotOptionsTemaSonificationTracksMappingTimeWithin Within_DefaultValue { get; set; }
