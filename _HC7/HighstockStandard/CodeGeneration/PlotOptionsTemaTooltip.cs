...
{
	public partial class PlotOptionsTemaTooltip  : BaseObject
	{
		public PlotOptionsTemaTooltip()
		{
			...
			HeaderShape = HeaderShape_DefaultValue = PlotOptionsTemaTooltipHeaderShape.Callout;
		...
		/// </summary>
		public PlotOptionsTemaTooltipHeaderShape HeaderShape { get; set; }
		private PlotOptionsTemaTooltipHeaderShape HeaderShape_DefaultValue { get; set; }
		...
		internal override Hashtable ToHashtable()
		{
			...
			if (NullFormatter != NullFormatter_DefaultValue) { h.Add("nullFormatter",NullFormatter); Highstock.AddFunction("PlotOptionsTemaTooltipNullFormatter.nullFormatter", NullFormatter); }  
			if (Outside != Outside_DefaultValue) h.Add("outside",Outside);
			if (Padding != Padding_DefaultValue) h.Add("padding",Padding);
			if (PointFormat != PointFormat_DefaultValue) h.Add("pointFormat",PointFormat);
			if (PointFormatter != PointFormatter_DefaultValue) { h.Add("pointFormatter",PointFormatter); Highstock.AddFunction("PlotOptionsTemaTooltipPointFormatter.pointFormatter", PointFormatter); }  
