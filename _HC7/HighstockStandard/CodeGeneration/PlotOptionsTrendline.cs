...
namespace Highsoft.Web.Mvc.Stocks
{
	public partial class PlotOptionsTrendline  : BaseObject
	{
		...
		public PlotOptionsTrendline()
		{
			...
			Zones = Zones_DefaultValue = new List<PlotOptionsTrendlineZone>();
		...
		/// </summary>
		public List<PlotOptionsTrendlineZone> Zones { get; set; }
		private List<PlotOptionsTrendlineZone> Zones_DefaultValue { get; set; }
