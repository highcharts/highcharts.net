...
{
	public partial class PlotOptionsTrendline  : BaseObject
	{
		Hashtable h = new Hashtable();

		public PlotOptionsTrendline()
		{
			Accessibility = Accessibility_DefaultValue = new PlotOptionsTrendlineAccessibility();
			AllowPointSelect = AllowPointSelect_DefaultValue = false;
			Animation = Animation_DefaultValue = new Animation() { Enabled = true };
			AnimationBool = AnimationBool_DefaultValue = true;
			AnimationLimit = AnimationLimit_DefaultValue = null;
			BoostBlending = BoostBlending_DefaultValue = PlotOptionsTrendlineBoostBlending.Undefined;
			...
			Compare = Compare_DefaultValue = PlotOptionsTrendlineCompare.Percent;
			CompareBase = CompareBase_DefaultValue = PlotOptionsTrendlineCompareBase.Min;
			...
			Cursor = Cursor_DefaultValue = PlotOptionsTrendlineCursor.Null;
			Custom = Custom_DefaultValue = new Hashtable();
			DashStyle = DashStyle_DefaultValue = PlotOptionsTrendlineDashStyle.Null;
			DataGrouping = DataGrouping_DefaultValue = new PlotOptionsTrendlineDataGrouping();
			DataLabels = DataLabels_DefaultValue = new PlotOptionsTrendlineDataLabels();
			DataSorting = DataSorting_DefaultValue = new PlotOptionsTrendlineDataSorting();
			Description = Description_DefaultValue = "";
			EnableMouseTracking = EnableMouseTracking_DefaultValue = true;
			Events = Events_DefaultValue = new PlotOptionsTrendlineEvents();
			FindNearestPointBy = FindNearestPointBy_DefaultValue = PlotOptionsTrendlineFindNearestPointBy.X;
			GapSize = GapSize_DefaultValue = 0;
			GapUnit = GapUnit_DefaultValue = PlotOptionsTrendlineGapUnit.Relative;
			GetExtremesFromAll = GetExtremesFromAll_DefaultValue = false;
			InactiveOtherPoints = InactiveOtherPoints_DefaultValue = false;
			IncludeInDataExport = IncludeInDataExport_DefaultValue = null;
			Label = Label_DefaultValue = new PlotOptionsTrendlineLabel();
			LastPrice = LastPrice_DefaultValue = new PlotOptionsTrendlineLastPrice();
			LastVisiblePrice = LastVisiblePrice_DefaultValue = new PlotOptionsTrendlineLastVisiblePrice();
			LegendSymbol = LegendSymbol_DefaultValue = PlotOptionsTrendlineLegendSymbol.Rectangle;
			Linecap = Linecap_DefaultValue = PlotOptionsTrendlineLinecap.Round;
			LineWidth = LineWidth_DefaultValue = 2;
			LinkedTo = LinkedTo_DefaultValue = "";
			Marker = Marker_DefaultValue = new PlotOptionsTrendlineMarker();
			NegativeColor = NegativeColor_DefaultValue = "";
			OnPoint = OnPoint_DefaultValue = new PlotOptionsTrendlineOnPoint();
			Opacity = Opacity_DefaultValue = 1;
			Params = Params_DefaultValue = new PlotOptionsTrendlineParams();
			Point = Point_DefaultValue = new PlotOptionsTrendlinePoint();
			...
			Sonification = Sonification_DefaultValue = new PlotOptionsTrendlineSonification();
			States = States_DefaultValue = new PlotOptionsTrendlineStates();
			Step = Step_DefaultValue = PlotOptionsTrendlineStep.Null;
			StickyTracking = StickyTracking_DefaultValue = true;
			Threshold = Threshold_DefaultValue = 0;
			Tooltip = Tooltip_DefaultValue = new PlotOptionsTrendlineTooltip();
			TurboThreshold = TurboThreshold_DefaultValue = 1000;
			Visible = Visible_DefaultValue = true;
			ZoneAxis = ZoneAxis_DefaultValue = "y";
			Zones = Zones_DefaultValue = new List<PlotOptionsTrendlineZones>();
		...
		/// </summary>
		public PlotOptionsTrendlineAccessibility Accessibility { get; set; }
		private PlotOptionsTrendlineAccessibility Accessibility_DefaultValue { get; set; }
		...
		/// </summary>
		public PlotOptionsTrendlineBoostBlending BoostBlending { get; set; }
		private PlotOptionsTrendlineBoostBlending BoostBlending_DefaultValue { get; set; }
		...
		/// </summary>
		public PlotOptionsTrendlineCompare Compare { get; set; }
		private PlotOptionsTrendlineCompare Compare_DefaultValue { get; set; }
		 

		/// <summary>
		/// When [compare](#plotOptions.series.compare) is `percent`, this optiondictates whether to use 0 or 100 as the base of comparison.
		/// </summary>
		public PlotOptionsTrendlineCompareBase CompareBase { get; set; }
		private PlotOptionsTrendlineCompareBase CompareBase_DefaultValue { get; set; }
		...
		/// </summary>
		public PlotOptionsTrendlineCursor Cursor { get; set; }
		private PlotOptionsTrendlineCursor Cursor_DefaultValue { get; set; }
		...
		/// </summary>
		public PlotOptionsTrendlineDashStyle DashStyle { get; set; }
		private PlotOptionsTrendlineDashStyle DashStyle_DefaultValue { get; set; }
		...
		/// </summary>
		public PlotOptionsTrendlineDataGrouping DataGrouping { get; set; }
		private PlotOptionsTrendlineDataGrouping DataGrouping_DefaultValue { get; set; }
		...
		/// </summary>
		public PlotOptionsTrendlineDataLabels DataLabels { get; set; }
		private PlotOptionsTrendlineDataLabels DataLabels_DefaultValue { get; set; }
		 

		/// <summary>
		/// Options for the series data sorting.
		/// </summary>
		public PlotOptionsTrendlineDataSorting DataSorting { get; set; }
		private PlotOptionsTrendlineDataSorting DataSorting_DefaultValue { get; set; }
		...
		/// </summary>
		public PlotOptionsTrendlineEvents Events { get; set; }
		private PlotOptionsTrendlineEvents Events_DefaultValue { get; set; }
		...
		/// </summary>
		public PlotOptionsTrendlineFindNearestPointBy FindNearestPointBy { get; set; }
		private PlotOptionsTrendlineFindNearestPointBy FindNearestPointBy_DefaultValue { get; set; }
		...
		/// </summary>
		public PlotOptionsTrendlineGapUnit GapUnit { get; set; }
		private PlotOptionsTrendlineGapUnit GapUnit_DefaultValue { get; set; }
		...
		/// </summary>
		public PlotOptionsTrendlineLabel Label { get; set; }
		private PlotOptionsTrendlineLabel Label_DefaultValue { get; set; }
		 

		/// <summary>
		/// The line marks the last price from all points.
		/// </summary>
		public PlotOptionsTrendlineLastPrice LastPrice { get; set; }
		private PlotOptionsTrendlineLastPrice LastPrice_DefaultValue { get; set; }
		 

		/// <summary>
		/// The line marks the last price from visible range of points.
		/// </summary>
		public PlotOptionsTrendlineLastVisiblePrice LastVisiblePrice { get; set; }
		private PlotOptionsTrendlineLastVisiblePrice LastVisiblePrice_DefaultValue { get; set; }
		 

		/// <summary>
		/// What type of legend symbol to render for this series. Can be one of`lineMarker` or `rectangle`.
		/// </summary>
		public PlotOptionsTrendlineLegendSymbol LegendSymbol { get; set; }
		private PlotOptionsTrendlineLegendSymbol LegendSymbol_DefaultValue { get; set; }
		 

		/// <summary>
		/// The line cap used for line ends and line joins on the graph.
		/// </summary>
		public PlotOptionsTrendlineLinecap Linecap { get; set; }
		private PlotOptionsTrendlineLinecap Linecap_DefaultValue { get; set; }
		...
		/// </summary>
		public PlotOptionsTrendlineMarker Marker { get; set; }
		private PlotOptionsTrendlineMarker Marker_DefaultValue { get; set; }
		...
		/// </summary>
		public PlotOptionsTrendlineOnPoint OnPoint { get; set; }
		private PlotOptionsTrendlineOnPoint OnPoint_DefaultValue { get; set; }
		...
		/// 
		/// </summary>
		public PlotOptionsTrendlineParams Params { get; set; }
		private PlotOptionsTrendlineParams Params_DefaultValue { get; set; }
		 

		/// <summary>
		/// Properties for each single point.
		/// </summary>
		public PlotOptionsTrendlinePoint Point { get; set; }
		private PlotOptionsTrendlinePoint Point_DefaultValue { get; set; }
		...
		/// </summary>
		public PlotOptionsTrendlineSonification Sonification { get; set; }
		private PlotOptionsTrendlineSonification Sonification_DefaultValue { get; set; }
		 

		/// <summary>
		/// 
		/// </summary>
		public PlotOptionsTrendlineStates States { get; set; }
		private PlotOptionsTrendlineStates States_DefaultValue { get; set; }
		 

		/// <summary>
		/// Whether to apply steps to the line. Possible values are `left`,`center` and `right`.
		/// </summary>
		public PlotOptionsTrendlineStep Step { get; set; }
		private PlotOptionsTrendlineStep Step_DefaultValue { get; set; }
		...
		/// </summary>
		public PlotOptionsTrendlineTooltip Tooltip { get; set; }
		private PlotOptionsTrendlineTooltip Tooltip_DefaultValue { get; set; }
		...
		/// </summary>
		public List<PlotOptionsTrendlineZones> Zones { get; set; }
		private List<PlotOptionsTrendlineZones> Zones_DefaultValue { get; set; }
