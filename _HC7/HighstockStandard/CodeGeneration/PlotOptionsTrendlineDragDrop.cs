...
{
	public partial class PlotOptionsTrendlineDragDrop  : BaseObject
	{
		public PlotOptionsTrendlineDragDrop()
		{
			DraggableX = DraggableX_DefaultValue = null;
			DraggableY = DraggableY_DefaultValue = null;
			DragHandle = DragHandle_DefaultValue = new PlotOptionsTrendlineDragDropDragHandle();
			...
			GuideBox = GuideBox_DefaultValue = new PlotOptionsTrendlineDragDropGuideBox();
		...
		/// </summary>
		public PlotOptionsTrendlineDragDropDragHandle DragHandle { get; set; }
		private PlotOptionsTrendlineDragDropDragHandle DragHandle_DefaultValue { get; set; }
		...
		/// </summary>
		public PlotOptionsTrendlineDragDropGuideBox GuideBox { get; set; }
		private PlotOptionsTrendlineDragDropGuideBox GuideBox_DefaultValue { get; set; }
