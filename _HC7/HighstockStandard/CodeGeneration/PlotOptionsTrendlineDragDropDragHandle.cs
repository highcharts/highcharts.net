...
{
	public partial class PlotOptionsTrendlineDragDropDragHandle  : BaseObject
	{
		public PlotOptionsTrendlineDragDropDragHandle()
		{
		...
		internal override Hashtable ToHashtable()
		{
			...
			if (PathFormatter != PathFormatter_DefaultValue) { h.Add("pathFormatter",PathFormatter); Highstock.AddFunction("PlotOptionsTrendlineDragDropDragHandlePathFormatter.pathFormatter", PathFormatter); }  
