...
{
	public partial class PlotOptionsTrendlineSonificationContextTracksMapping  : BaseObject
	{
		Hashtable h = new Hashtable();

		public PlotOptionsTrendlineSonificationContextTracksMapping()
		{
			Frequency = Frequency_DefaultValue = new PlotOptionsTrendlineSonificationContextTracksMappingFrequency();
			GapBetweenNotes = GapBetweenNotes_DefaultValue = new PlotOptionsTrendlineSonificationContextTracksMappingGapBetweenNotes();
			Highpass = Highpass_DefaultValue = new PlotOptionsTrendlineSonificationContextTracksMappingHighpass();
			Lowpass = Lowpass_DefaultValue = new PlotOptionsTrendlineSonificationContextTracksMappingLowpass();
			NoteDuration = NoteDuration_DefaultValue = new PlotOptionsTrendlineSonificationContextTracksMappingNoteDuration();
			Pan = Pan_DefaultValue = new PlotOptionsTrendlineSonificationContextTracksMappingPan();
			Pitch = Pitch_DefaultValue = new PlotOptionsTrendlineSonificationContextTracksMappingPitch();
			PitchString = PitchString_DefaultValue = "null";
			PitchNumber = PitchNumber_DefaultValue = null;
			PlayDelay = PlayDelay_DefaultValue = new PlotOptionsTrendlineSonificationContextTracksMappingPlayDelay();
			Time = Time_DefaultValue = new PlotOptionsTrendlineSonificationContextTracksMappingTime();
			TimeString = TimeString_DefaultValue = "null";
			TimeNumber = TimeNumber_DefaultValue = null;
			Tremolo = Tremolo_DefaultValue = new PlotOptionsTrendlineSonificationContextTracksMappingTremolo();
			Volume = Volume_DefaultValue = new PlotOptionsTrendlineSonificationContextTracksMappingVolume();
		...
		/// </summary>
		public PlotOptionsTrendlineSonificationContextTracksMappingFrequency Frequency { get; set; }
		private PlotOptionsTrendlineSonificationContextTracksMappingFrequency Frequency_DefaultValue { get; set; }
		...
		/// </summary>
		public PlotOptionsTrendlineSonificationContextTracksMappingGapBetweenNotes GapBetweenNotes { get; set; }
		private PlotOptionsTrendlineSonificationContextTracksMappingGapBetweenNotes GapBetweenNotes_DefaultValue { get; set; }
		...
		/// </summary>
		public PlotOptionsTrendlineSonificationContextTracksMappingHighpass Highpass { get; set; }
		private PlotOptionsTrendlineSonificationContextTracksMappingHighpass Highpass_DefaultValue { get; set; }
		...
		/// </summary>
		public PlotOptionsTrendlineSonificationContextTracksMappingLowpass Lowpass { get; set; }
		private PlotOptionsTrendlineSonificationContextTracksMappingLowpass Lowpass_DefaultValue { get; set; }
		...
		/// </summary>
		public PlotOptionsTrendlineSonificationContextTracksMappingNoteDuration NoteDuration { get; set; }
		private PlotOptionsTrendlineSonificationContextTracksMappingNoteDuration NoteDuration_DefaultValue { get; set; }
		...
		/// </summary>
		public PlotOptionsTrendlineSonificationContextTracksMappingPan Pan { get; set; }
		private PlotOptionsTrendlineSonificationContextTracksMappingPan Pan_DefaultValue { get; set; }
		...
		/// </summary>
		public PlotOptionsTrendlineSonificationContextTracksMappingPitch Pitch { get; set; }
		private PlotOptionsTrendlineSonificationContextTracksMappingPitch Pitch_DefaultValue { get; set; }
		...
		/// </summary>
		public PlotOptionsTrendlineSonificationContextTracksMappingPlayDelay PlayDelay { get; set; }
		private PlotOptionsTrendlineSonificationContextTracksMappingPlayDelay PlayDelay_DefaultValue { get; set; }
		...
		/// </summary>
		public PlotOptionsTrendlineSonificationContextTracksMappingTime Time { get; set; }
		private PlotOptionsTrendlineSonificationContextTracksMappingTime Time_DefaultValue { get; set; }
		...
		/// </summary>
		public PlotOptionsTrendlineSonificationContextTracksMappingTremolo Tremolo { get; set; }
		private PlotOptionsTrendlineSonificationContextTracksMappingTremolo Tremolo_DefaultValue { get; set; }
		 

		/// <summary>
		/// The volume of notes, from 0 to 1.
		/// </summary>
		public PlotOptionsTrendlineSonificationContextTracksMappingVolume Volume { get; set; }
		private PlotOptionsTrendlineSonificationContextTracksMappingVolume Volume_DefaultValue { get; set; }
