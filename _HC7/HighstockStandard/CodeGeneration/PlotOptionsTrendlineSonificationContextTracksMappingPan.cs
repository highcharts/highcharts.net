...
{
	public partial class PlotOptionsTrendlineSonificationContextTracksMappingPan  : BaseObject
	{
		Hashtable h = new Hashtable();

		public PlotOptionsTrendlineSonificationContextTracksMappingPan()
		{
			MapFunction = MapFunction_DefaultValue = PlotOptionsTrendlineSonificationContextTracksMappingPanMapFunction.Linear;
			MapTo = MapTo_DefaultValue = "";
			Max = Max_DefaultValue = null;
			Min = Min_DefaultValue = null;
			Value = Value_DefaultValue = null;
			Within = Within_DefaultValue = PlotOptionsTrendlineSonificationContextTracksMappingPanWithin.Chart;
		...
		/// </summary>
		public PlotOptionsTrendlineSonificationContextTracksMappingPanMapFunction MapFunction { get; set; }
		private PlotOptionsTrendlineSonificationContextTracksMappingPanMapFunction MapFunction_DefaultValue { get; set; }
		...
		/// </summary>
		public PlotOptionsTrendlineSonificationContextTracksMappingPanWithin Within { get; set; }
		private PlotOptionsTrendlineSonificationContextTracksMappingPanWithin Within_DefaultValue { get; set; }
