...
{
	public partial class PlotOptionsTrendlineSonificationContextTracksMappingTime  : BaseObject
	{
		Hashtable h = new Hashtable();

		public PlotOptionsTrendlineSonificationContextTracksMappingTime()
		{
			MapFunction = MapFunction_DefaultValue = PlotOptionsTrendlineSonificationContextTracksMappingTimeMapFunction.Linear;
			MapTo = MapTo_DefaultValue = "";
			Max = Max_DefaultValue = null;
			Min = Min_DefaultValue = null;
			Value = Value_DefaultValue = null;
			Within = Within_DefaultValue = PlotOptionsTrendlineSonificationContextTracksMappingTimeWithin.Chart;
		...
		/// </summary>
		public PlotOptionsTrendlineSonificationContextTracksMappingTimeMapFunction MapFunction { get; set; }
		private PlotOptionsTrendlineSonificationContextTracksMappingTimeMapFunction MapFunction_DefaultValue { get; set; }
		...
		/// </summary>
		public PlotOptionsTrendlineSonificationContextTracksMappingTimeWithin Within { get; set; }
		private PlotOptionsTrendlineSonificationContextTracksMappingTimeWithin Within_DefaultValue { get; set; }
