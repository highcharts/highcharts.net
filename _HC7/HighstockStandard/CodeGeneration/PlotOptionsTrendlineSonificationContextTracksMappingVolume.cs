...
{
	public partial class PlotOptionsTrendlineSonificationContextTracksMappingVolume  : BaseObject
	{
		Hashtable h = new Hashtable();

		public PlotOptionsTrendlineSonificationContextTracksMappingVolume()
		{
			MapFunction = MapFunction_DefaultValue = PlotOptionsTrendlineSonificationContextTracksMappingVolumeMapFunction.Linear;
			MapTo = MapTo_DefaultValue = "";
			Max = Max_DefaultValue = null;
			Min = Min_DefaultValue = null;
			Value = Value_DefaultValue = null;
			Within = Within_DefaultValue = PlotOptionsTrendlineSonificationContextTracksMappingVolumeWithin.Chart;
		...
		/// </summary>
		public PlotOptionsTrendlineSonificationContextTracksMappingVolumeMapFunction MapFunction { get; set; }
		private PlotOptionsTrendlineSonificationContextTracksMappingVolumeMapFunction MapFunction_DefaultValue { get; set; }
		...
		/// </summary>
		public PlotOptionsTrendlineSonificationContextTracksMappingVolumeWithin Within { get; set; }
		private PlotOptionsTrendlineSonificationContextTracksMappingVolumeWithin Within_DefaultValue { get; set; }
