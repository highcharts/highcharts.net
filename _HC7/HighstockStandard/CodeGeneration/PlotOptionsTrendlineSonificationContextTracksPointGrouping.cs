...
{
	public partial class PlotOptionsTrendlineSonificationContextTracksPointGrouping  : BaseObject
	{
		Hashtable h = new Hashtable();

		public PlotOptionsTrendlineSonificationContextTracksPointGrouping()
		{
			Algorithm = Algorithm_DefaultValue = PlotOptionsTrendlineSonificationContextTracksPointGroupingAlgorithm.Minimax;
		...
		/// </summary>
		public PlotOptionsTrendlineSonificationContextTracksPointGroupingAlgorithm Algorithm { get; set; }
		private PlotOptionsTrendlineSonificationContextTracksPointGroupingAlgorithm Algorithm_DefaultValue { get; set; }
