...
{
	public partial class PlotOptionsTrendlineSonificationDefaultInstrumentOptionsMappingHighpassFrequency  : BaseObject
	{
		Hashtable h = new Hashtable();

		public PlotOptionsTrendlineSonificationDefaultInstrumentOptionsMappingHighpassFrequency()
		{
			MapFunction = MapFunction_DefaultValue = PlotOptionsTrendlineSonificationDefaultInstrumentOptionsMappingHighpassFrequencyMapFunction.Linear;
			MapTo = MapTo_DefaultValue = "";
			Max = Max_DefaultValue = null;
			Min = Min_DefaultValue = null;
			Value = Value_DefaultValue = null;
			Within = Within_DefaultValue = PlotOptionsTrendlineSonificationDefaultInstrumentOptionsMappingHighpassFrequencyWithin.Chart;
		...
		/// </summary>
		public PlotOptionsTrendlineSonificationDefaultInstrumentOptionsMappingHighpassFrequencyMapFunction MapFunction { get; set; }
		private PlotOptionsTrendlineSonificationDefaultInstrumentOptionsMappingHighpassFrequencyMapFunction MapFunction_DefaultValue { get; set; }
		...
		/// </summary>
		public PlotOptionsTrendlineSonificationDefaultInstrumentOptionsMappingHighpassFrequencyWithin Within { get; set; }
		private PlotOptionsTrendlineSonificationDefaultInstrumentOptionsMappingHighpassFrequencyWithin Within_DefaultValue { get; set; }
