...
{
	public partial class PlotOptionsTrendlineSonificationDefaultSpeechOptionsMappingNoteDuration  : BaseObject
	{
		Hashtable h = new Hashtable();

		public PlotOptionsTrendlineSonificationDefaultSpeechOptionsMappingNoteDuration()
		{
			MapFunction = MapFunction_DefaultValue = PlotOptionsTrendlineSonificationDefaultSpeechOptionsMappingNoteDurationMapFunction.Linear;
			MapTo = MapTo_DefaultValue = "";
			Max = Max_DefaultValue = null;
			Min = Min_DefaultValue = null;
			Value = Value_DefaultValue = null;
			Within = Within_DefaultValue = PlotOptionsTrendlineSonificationDefaultSpeechOptionsMappingNoteDurationWithin.Chart;
		...
		/// </summary>
		public PlotOptionsTrendlineSonificationDefaultSpeechOptionsMappingNoteDurationMapFunction MapFunction { get; set; }
		private PlotOptionsTrendlineSonificationDefaultSpeechOptionsMappingNoteDurationMapFunction MapFunction_DefaultValue { get; set; }
		...
		/// </summary>
		public PlotOptionsTrendlineSonificationDefaultSpeechOptionsMappingNoteDurationWithin Within { get; set; }
		private PlotOptionsTrendlineSonificationDefaultSpeechOptionsMappingNoteDurationWithin Within_DefaultValue { get; set; }
