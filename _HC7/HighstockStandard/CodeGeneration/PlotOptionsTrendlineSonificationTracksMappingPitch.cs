...
{
	public partial class PlotOptionsTrendlineSonificationTracksMappingPitch  : BaseObject
	{
		Hashtable h = new Hashtable();

		public PlotOptionsTrendlineSonificationTracksMappingPitch()
		{
			MapFunction = MapFunction_DefaultValue = PlotOptionsTrendlineSonificationTracksMappingPitchMapFunction.Linear;
		...
		/// </summary>
		public PlotOptionsTrendlineSonificationTracksMappingPitchMapFunction MapFunction { get; set; }
		private PlotOptionsTrendlineSonificationTracksMappingPitchMapFunction MapFunction_DefaultValue { get; set; }
