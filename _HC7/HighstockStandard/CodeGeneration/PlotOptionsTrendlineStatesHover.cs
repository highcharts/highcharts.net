...
{
	public partial class PlotOptionsTrendlineStatesHover  : BaseObject
	{
		public PlotOptionsTrendlineStatesHover()
		{
			Animation = Animation_DefaultValue = new Animation() { Enabled = true };
			AnimationBool = AnimationBool_DefaultValue = null;
			Enabled = Enabled_DefaultValue = true;
			Halo = Halo_DefaultValue = new PlotOptionsTrendlineStatesHoverHalo();
			LineWidth = LineWidth_DefaultValue = null;
			LineWidthPlus = LineWidthPlus_DefaultValue = 1;
			Marker = Marker_DefaultValue = new PlotOptionsTrendlineStatesHoverMarker();
		...
		/// </summary>
		public PlotOptionsTrendlineStatesHoverHalo Halo { get; set; }
		private PlotOptionsTrendlineStatesHoverHalo Halo_DefaultValue { get; set; }
		...
		/// </summary>
		public PlotOptionsTrendlineStatesHoverMarker Marker { get; set; }
		private PlotOptionsTrendlineStatesHoverMarker Marker_DefaultValue { get; set; }
