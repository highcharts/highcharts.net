...
{
	public partial class PlotOptionsTrendlineStatesSelect  : BaseObject
	{
		public PlotOptionsTrendlineStatesSelect()
		{
			Animation = Animation_DefaultValue = new Animation() { Enabled = true };
			Enabled = Enabled_DefaultValue = true;
			Halo = Halo_DefaultValue = new PlotOptionsTrendlineStatesSelectHalo();
			LineWidth = LineWidth_DefaultValue = null;
			LineWidthPlus = LineWidthPlus_DefaultValue = 1;
			Marker = Marker_DefaultValue = new PlotOptionsTrendlineStatesSelectMarker();
		...
		/// </summary>
		public PlotOptionsTrendlineStatesSelectHalo Halo { get; set; }
		private PlotOptionsTrendlineStatesSelectHalo Halo_DefaultValue { get; set; }
		...
		/// </summary>
		public PlotOptionsTrendlineStatesSelectMarker Marker { get; set; }
		private PlotOptionsTrendlineStatesSelectMarker Marker_DefaultValue { get; set; }
