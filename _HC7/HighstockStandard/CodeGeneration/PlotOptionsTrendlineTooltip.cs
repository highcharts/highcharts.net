...
{
	public partial class PlotOptionsTrendlineTooltip  : BaseObject
	{
		public PlotOptionsTrendlineTooltip()
		{
			...
			HeaderShape = HeaderShape_DefaultValue = PlotOptionsTrendlineTooltipHeaderShape.Callout;
		...
		/// </summary>
		public PlotOptionsTrendlineTooltipHeaderShape HeaderShape { get; set; }
		private PlotOptionsTrendlineTooltipHeaderShape HeaderShape_DefaultValue { get; set; }
		...
		internal override Hashtable ToHashtable()
		{
			...
			if (NullFormatter != NullFormatter_DefaultValue) { h.Add("nullFormatter",NullFormatter); Highstock.AddFunction("PlotOptionsTrendlineTooltipNullFormatter.nullFormatter", NullFormatter); }  
			if (Outside != Outside_DefaultValue) h.Add("outside",Outside);
			if (Padding != Padding_DefaultValue) h.Add("padding",Padding);
			if (PointFormat != PointFormat_DefaultValue) h.Add("pointFormat",PointFormat);
			if (PointFormatter != PointFormatter_DefaultValue) { h.Add("pointFormatter",PointFormatter); Highstock.AddFunction("PlotOptionsTrendlineTooltipPointFormatter.pointFormatter", PointFormatter); }  
