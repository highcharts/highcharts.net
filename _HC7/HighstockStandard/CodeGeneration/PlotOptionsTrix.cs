...
namespace Highsoft.Web.Mvc.Stocks
{
	public partial class PlotOptionsTrix  : BaseObject
	{
		...
		public PlotOptionsTrix()
		{
			...
			Zones = Zones_DefaultValue = new List<PlotOptionsTrixZone>();
		...
		/// </summary>
		public List<PlotOptionsTrixZone> Zones { get; set; }
		private List<PlotOptionsTrixZone> Zones_DefaultValue { get; set; }
