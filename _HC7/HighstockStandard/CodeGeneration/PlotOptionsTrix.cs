...
{
	public partial class PlotOptionsTrix  : BaseObject
	{
		Hashtable h = new Hashtable();

		public PlotOptionsTrix()
		{
			Accessibility = Accessibility_DefaultValue = new PlotOptionsTrixAccessibility();
			AllowPointSelect = AllowPointSelect_DefaultValue = false;
			Animation = Animation_DefaultValue = new Animation() { Enabled = true };
			AnimationBool = AnimationBool_DefaultValue = true;
			AnimationLimit = AnimationLimit_DefaultValue = null;
			BoostBlending = BoostBlending_DefaultValue = PlotOptionsTrixBoostBlending.Undefined;
			...
			Cursor = Cursor_DefaultValue = PlotOptionsTrixCursor.Null;
			Custom = Custom_DefaultValue = new Hashtable();
			DashStyle = DashStyle_DefaultValue = PlotOptionsTrixDashStyle.Null;
			DataGrouping = DataGrouping_DefaultValue = new PlotOptionsTrixDataGrouping();
			DataLabels = DataLabels_DefaultValue = new PlotOptionsTrixDataLabels();
			DataSorting = DataSorting_DefaultValue = new PlotOptionsTrixDataSorting();
			Description = Description_DefaultValue = "";
			EnableMouseTracking = EnableMouseTracking_DefaultValue = true;
			Events = Events_DefaultValue = new PlotOptionsTrixEvents();
			FindNearestPointBy = FindNearestPointBy_DefaultValue = PlotOptionsTrixFindNearestPointBy.X;
			GapSize = GapSize_DefaultValue = 0;
			GapUnit = GapUnit_DefaultValue = PlotOptionsTrixGapUnit.Relative;
			GetExtremesFromAll = GetExtremesFromAll_DefaultValue = false;
			InactiveOtherPoints = InactiveOtherPoints_DefaultValue = false;
			IncludeInDataExport = IncludeInDataExport_DefaultValue = null;
			Label = Label_DefaultValue = new PlotOptionsTrixLabel();
			LastPrice = LastPrice_DefaultValue = new PlotOptionsTrixLastPrice();
			LastVisiblePrice = LastVisiblePrice_DefaultValue = new PlotOptionsTrixLastVisiblePrice();
			LegendSymbol = LegendSymbol_DefaultValue = PlotOptionsTrixLegendSymbol.Rectangle;
			Linecap = Linecap_DefaultValue = PlotOptionsTrixLinecap.Round;
			LineWidth = LineWidth_DefaultValue = 2;
			LinkedTo = LinkedTo_DefaultValue = "";
			Marker = Marker_DefaultValue = new PlotOptionsTrixMarker();
			NegativeColor = NegativeColor_DefaultValue = "";
			OnPoint = OnPoint_DefaultValue = new PlotOptionsTrixOnPoint();
			Opacity = Opacity_DefaultValue = 1;
			Params = Params_DefaultValue = new PlotOptionsTrixParams();
			Point = Point_DefaultValue = new PlotOptionsTrixPoint();
			...
			Sonification = Sonification_DefaultValue = new PlotOptionsTrixSonification();
			States = States_DefaultValue = new PlotOptionsTrixStates();
			Step = Step_DefaultValue = PlotOptionsTrixStep.Null;
			StickyTracking = StickyTracking_DefaultValue = true;
			Threshold = Threshold_DefaultValue = 0;
			Tooltip = Tooltip_DefaultValue = new PlotOptionsTrixTooltip();
			TurboThreshold = TurboThreshold_DefaultValue = 1000;
			Visible = Visible_DefaultValue = true;
			ZoneAxis = ZoneAxis_DefaultValue = "y";
			Zones = Zones_DefaultValue = new List<PlotOptionsTrixZones>();
		...
		/// </summary>
		public PlotOptionsTrixAccessibility Accessibility { get; set; }
		private PlotOptionsTrixAccessibility Accessibility_DefaultValue { get; set; }
		...
		/// </summary>
		public PlotOptionsTrixBoostBlending BoostBlending { get; set; }
		private PlotOptionsTrixBoostBlending BoostBlending_DefaultValue { get; set; }
		...
		/// </summary>
		public PlotOptionsTrixCursor Cursor { get; set; }
		private PlotOptionsTrixCursor Cursor_DefaultValue { get; set; }
		...
		/// </summary>
		public PlotOptionsTrixDashStyle DashStyle { get; set; }
		private PlotOptionsTrixDashStyle DashStyle_DefaultValue { get; set; }
		...
		/// </summary>
		public PlotOptionsTrixDataGrouping DataGrouping { get; set; }
		private PlotOptionsTrixDataGrouping DataGrouping_DefaultValue { get; set; }
		...
		/// </summary>
		public PlotOptionsTrixDataLabels DataLabels { get; set; }
		private PlotOptionsTrixDataLabels DataLabels_DefaultValue { get; set; }
		 

		/// <summary>
		/// Options for the series data sorting.
		/// </summary>
		public PlotOptionsTrixDataSorting DataSorting { get; set; }
		private PlotOptionsTrixDataSorting DataSorting_DefaultValue { get; set; }
		...
		/// </summary>
		public PlotOptionsTrixEvents Events { get; set; }
		private PlotOptionsTrixEvents Events_DefaultValue { get; set; }
		...
		/// </summary>
		public PlotOptionsTrixFindNearestPointBy FindNearestPointBy { get; set; }
		private PlotOptionsTrixFindNearestPointBy FindNearestPointBy_DefaultValue { get; set; }
		...
		/// </summary>
		public PlotOptionsTrixGapUnit GapUnit { get; set; }
		private PlotOptionsTrixGapUnit GapUnit_DefaultValue { get; set; }
		...
		/// </summary>
		public PlotOptionsTrixLabel Label { get; set; }
		private PlotOptionsTrixLabel Label_DefaultValue { get; set; }
		 

		/// <summary>
		/// The line marks the last price from all points.
		/// </summary>
		public PlotOptionsTrixLastPrice LastPrice { get; set; }
		private PlotOptionsTrixLastPrice LastPrice_DefaultValue { get; set; }
		 

		/// <summary>
		/// The line marks the last price from visible range of points.
		/// </summary>
		public PlotOptionsTrixLastVisiblePrice LastVisiblePrice { get; set; }
		private PlotOptionsTrixLastVisiblePrice LastVisiblePrice_DefaultValue { get; set; }
		 

		/// <summary>
		/// What type of legend symbol to render for this series. Can be one of`areaMarker`, `lineMarker` or `rectangle`.
		/// </summary>
		public PlotOptionsTrixLegendSymbol LegendSymbol { get; set; }
		private PlotOptionsTrixLegendSymbol LegendSymbol_DefaultValue { get; set; }
		 

		/// <summary>
		/// The line cap used for line ends and line joins on the graph.
		/// </summary>
		public PlotOptionsTrixLinecap Linecap { get; set; }
		private PlotOptionsTrixLinecap Linecap_DefaultValue { get; set; }
		...
		/// </summary>
		public PlotOptionsTrixMarker Marker { get; set; }
		private PlotOptionsTrixMarker Marker_DefaultValue { get; set; }
		...
		/// </summary>
		public PlotOptionsTrixOnPoint OnPoint { get; set; }
		private PlotOptionsTrixOnPoint OnPoint_DefaultValue { get; set; }
		...
		/// </summary>
		public PlotOptionsTrixParams Params { get; set; }
		private PlotOptionsTrixParams Params_DefaultValue { get; set; }
		 

		/// <summary>
		/// Properties for each single point.
		/// </summary>
		public PlotOptionsTrixPoint Point { get; set; }
		private PlotOptionsTrixPoint Point_DefaultValue { get; set; }
		...
		/// </summary>
		public PlotOptionsTrixSonification Sonification { get; set; }
		private PlotOptionsTrixSonification Sonification_DefaultValue { get; set; }
		 

		/// <summary>
		/// 
		/// </summary>
		public PlotOptionsTrixStates States { get; set; }
		private PlotOptionsTrixStates States_DefaultValue { get; set; }
		 

		/// <summary>
		/// Whether to apply steps to the line. Possible values are `left`,`center` and `right`.
		/// </summary>
		public PlotOptionsTrixStep Step { get; set; }
		private PlotOptionsTrixStep Step_DefaultValue { get; set; }
		...
		/// </summary>
		public PlotOptionsTrixTooltip Tooltip { get; set; }
		private PlotOptionsTrixTooltip Tooltip_DefaultValue { get; set; }
		...
		/// </summary>
		public List<PlotOptionsTrixZones> Zones { get; set; }
		private List<PlotOptionsTrixZones> Zones_DefaultValue { get; set; }
