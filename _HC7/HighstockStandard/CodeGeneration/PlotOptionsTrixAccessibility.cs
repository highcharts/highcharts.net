...
namespace Highsoft.Web.Mvc.Stocks
{
	public partial class PlotOptionsTrixAccessibility  : BaseObject
	{
		...
		public PlotOptionsTrixAccessibility()
		{
			...
			Point = Point_DefaultValue = new PlotOptionsTrixAccessibilityPoint();
		...
		/// </summary>
		public PlotOptionsTrixAccessibilityPoint Point { get; set; }
		private PlotOptionsTrixAccessibilityPoint Point_DefaultValue { get; set; }
