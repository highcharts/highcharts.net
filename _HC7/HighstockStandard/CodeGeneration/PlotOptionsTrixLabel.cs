...
{
	public partial class PlotOptionsTrixLabel  : BaseObject
	{
		public PlotOptionsTrixLabel()
		{
			...
			Style = Style_DefaultValue = new PlotOptionsTrixLabelStyle();
		...
		/// </summary>
		public PlotOptionsTrixLabelStyle Style { get; set; }
		private PlotOptionsTrixLabelStyle Style_DefaultValue { get; set; }
