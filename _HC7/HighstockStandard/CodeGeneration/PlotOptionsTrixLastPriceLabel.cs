...
{
	public partial class PlotOptionsTrixLastPriceLabel  : BaseObject
	{
		Hashtable h = new Hashtable();

		public PlotOptionsTrixLastPriceLabel()
		{
			Align = Align_DefaultValue = PlotOptionsTrixLastPriceLabelAlign.Null;
		...
		/// 
		/// </summary>
		public PlotOptionsTrixLastPriceLabelAlign Align { get; set; }
		private PlotOptionsTrixLastPriceLabelAlign Align_DefaultValue { get; set; }
