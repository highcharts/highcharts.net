...
{
	public partial class PlotOptionsTrixSonificationContextTracksMapping  : BaseObject
	{
		Hashtable h = new Hashtable();

		public PlotOptionsTrixSonificationContextTracksMapping()
		{
			Frequency = Frequency_DefaultValue = new PlotOptionsTrixSonificationContextTracksMappingFrequency();
			GapBetweenNotes = GapBetweenNotes_DefaultValue = new PlotOptionsTrixSonificationContextTracksMappingGapBetweenNotes();
			Highpass = Highpass_DefaultValue = new PlotOptionsTrixSonificationContextTracksMappingHighpass();
			Lowpass = Lowpass_DefaultValue = new PlotOptionsTrixSonificationContextTracksMappingLowpass();
			NoteDuration = NoteDuration_DefaultValue = new PlotOptionsTrixSonificationContextTracksMappingNoteDuration();
			Pan = Pan_DefaultValue = new PlotOptionsTrixSonificationContextTracksMappingPan();
			Pitch = Pitch_DefaultValue = new PlotOptionsTrixSonificationContextTracksMappingPitch();
			PitchString = PitchString_DefaultValue = "null";
			PitchNumber = PitchNumber_DefaultValue = null;
			PlayDelay = PlayDelay_DefaultValue = new PlotOptionsTrixSonificationContextTracksMappingPlayDelay();
			Time = Time_DefaultValue = new PlotOptionsTrixSonificationContextTracksMappingTime();
			TimeString = TimeString_DefaultValue = "null";
			TimeNumber = TimeNumber_DefaultValue = null;
			Tremolo = Tremolo_DefaultValue = new PlotOptionsTrixSonificationContextTracksMappingTremolo();
			Volume = Volume_DefaultValue = new PlotOptionsTrixSonificationContextTracksMappingVolume();
		...
		/// </summary>
		public PlotOptionsTrixSonificationContextTracksMappingFrequency Frequency { get; set; }
		private PlotOptionsTrixSonificationContextTracksMappingFrequency Frequency_DefaultValue { get; set; }
		...
		/// </summary>
		public PlotOptionsTrixSonificationContextTracksMappingGapBetweenNotes GapBetweenNotes { get; set; }
		private PlotOptionsTrixSonificationContextTracksMappingGapBetweenNotes GapBetweenNotes_DefaultValue { get; set; }
		...
		/// </summary>
		public PlotOptionsTrixSonificationContextTracksMappingHighpass Highpass { get; set; }
		private PlotOptionsTrixSonificationContextTracksMappingHighpass Highpass_DefaultValue { get; set; }
		...
		/// </summary>
		public PlotOptionsTrixSonificationContextTracksMappingLowpass Lowpass { get; set; }
		private PlotOptionsTrixSonificationContextTracksMappingLowpass Lowpass_DefaultValue { get; set; }
		...
		/// </summary>
		public PlotOptionsTrixSonificationContextTracksMappingNoteDuration NoteDuration { get; set; }
		private PlotOptionsTrixSonificationContextTracksMappingNoteDuration NoteDuration_DefaultValue { get; set; }
		...
		/// </summary>
		public PlotOptionsTrixSonificationContextTracksMappingPan Pan { get; set; }
		private PlotOptionsTrixSonificationContextTracksMappingPan Pan_DefaultValue { get; set; }
		...
		/// </summary>
		public PlotOptionsTrixSonificationContextTracksMappingPitch Pitch { get; set; }
		private PlotOptionsTrixSonificationContextTracksMappingPitch Pitch_DefaultValue { get; set; }
		...
		/// </summary>
		public PlotOptionsTrixSonificationContextTracksMappingPlayDelay PlayDelay { get; set; }
		private PlotOptionsTrixSonificationContextTracksMappingPlayDelay PlayDelay_DefaultValue { get; set; }
		...
		/// </summary>
		public PlotOptionsTrixSonificationContextTracksMappingTime Time { get; set; }
		private PlotOptionsTrixSonificationContextTracksMappingTime Time_DefaultValue { get; set; }
		...
		/// </summary>
		public PlotOptionsTrixSonificationContextTracksMappingTremolo Tremolo { get; set; }
		private PlotOptionsTrixSonificationContextTracksMappingTremolo Tremolo_DefaultValue { get; set; }
		 

		/// <summary>
		/// The volume of notes, from 0 to 1.
		/// </summary>
		public PlotOptionsTrixSonificationContextTracksMappingVolume Volume { get; set; }
		private PlotOptionsTrixSonificationContextTracksMappingVolume Volume_DefaultValue { get; set; }
