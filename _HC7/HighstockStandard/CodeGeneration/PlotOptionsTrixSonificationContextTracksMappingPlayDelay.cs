...
{
	public partial class PlotOptionsTrixSonificationContextTracksMappingPlayDelay  : BaseObject
	{
		Hashtable h = new Hashtable();

		public PlotOptionsTrixSonificationContextTracksMappingPlayDelay()
		{
			MapFunction = MapFunction_DefaultValue = PlotOptionsTrixSonificationContextTracksMappingPlayDelayMapFunction.Linear;
			MapTo = MapTo_DefaultValue = "";
			Max = Max_DefaultValue = null;
			Min = Min_DefaultValue = null;
			Value = Value_DefaultValue = null;
			Within = Within_DefaultValue = PlotOptionsTrixSonificationContextTracksMappingPlayDelayWithin.Chart;
		...
		/// </summary>
		public PlotOptionsTrixSonificationContextTracksMappingPlayDelayMapFunction MapFunction { get; set; }
		private PlotOptionsTrixSonificationContextTracksMappingPlayDelayMapFunction MapFunction_DefaultValue { get; set; }
		...
		/// </summary>
		public PlotOptionsTrixSonificationContextTracksMappingPlayDelayWithin Within { get; set; }
		private PlotOptionsTrixSonificationContextTracksMappingPlayDelayWithin Within_DefaultValue { get; set; }
