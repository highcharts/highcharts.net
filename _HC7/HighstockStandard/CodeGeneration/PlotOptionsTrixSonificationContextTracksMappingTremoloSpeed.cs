...
{
	public partial class PlotOptionsTrixSonificationContextTracksMappingTremoloSpeed  : BaseObject
	{
		Hashtable h = new Hashtable();

		public PlotOptionsTrixSonificationContextTracksMappingTremoloSpeed()
		{
			MapFunction = MapFunction_DefaultValue = PlotOptionsTrixSonificationContextTracksMappingTremoloSpeedMapFunction.Linear;
			MapTo = MapTo_DefaultValue = "";
			Max = Max_DefaultValue = null;
			Min = Min_DefaultValue = null;
			Value = Value_DefaultValue = null;
			Within = Within_DefaultValue = PlotOptionsTrixSonificationContextTracksMappingTremoloSpeedWithin.Chart;
		...
		/// </summary>
		public PlotOptionsTrixSonificationContextTracksMappingTremoloSpeedMapFunction MapFunction { get; set; }
		private PlotOptionsTrixSonificationContextTracksMappingTremoloSpeedMapFunction MapFunction_DefaultValue { get; set; }
		...
		/// </summary>
		public PlotOptionsTrixSonificationContextTracksMappingTremoloSpeedWithin Within { get; set; }
		private PlotOptionsTrixSonificationContextTracksMappingTremoloSpeedWithin Within_DefaultValue { get; set; }
