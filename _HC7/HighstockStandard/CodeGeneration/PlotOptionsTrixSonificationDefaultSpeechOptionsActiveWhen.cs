...
{
	public partial class PlotOptionsTrixSonificationDefaultSpeechOptionsActiveWhen  : BaseObject
	{
		Hashtable h = new Hashtable();

		public PlotOptionsTrixSonificationDefaultSpeechOptionsActiveWhen()
		{
		}	
