...
{
	public partial class PlotOptionsTrixSonificationTracks  : BaseObject
	{
		Hashtable h = new Hashtable();

		public PlotOptionsTrixSonificationTracks()
		{
			ActiveWhen = ActiveWhen_DefaultValue = new PlotOptionsTrixSonificationTracksActiveWhen();
			Instrument = Instrument_DefaultValue = null;
			InstrumentString = InstrumentString_DefaultValue = "null";
			Mapping = Mapping_DefaultValue = new PlotOptionsTrixSonificationTracksMapping();
			MidiName = MidiName_DefaultValue = "";
			PointGrouping = PointGrouping_DefaultValue = new PlotOptionsTrixSonificationTracksPointGrouping();
			RoundToMusicalNotes = RoundToMusicalNotes_DefaultValue = true;
			ShowPlayMarker = ShowPlayMarker_DefaultValue = true;
			Type = Type_DefaultValue = PlotOptionsTrixSonificationTracksType.Instrument;
		...
		/// </summary>
		public PlotOptionsTrixSonificationTracksActiveWhen ActiveWhen { get; set; }
		private PlotOptionsTrixSonificationTracksActiveWhen ActiveWhen_DefaultValue { get; set; }
		...
		/// </summary>
		public PlotOptionsTrixSonificationTracksMapping Mapping { get; set; }
		private PlotOptionsTrixSonificationTracksMapping Mapping_DefaultValue { get; set; }
		...
		/// </summary>
		public PlotOptionsTrixSonificationTracksPointGrouping PointGrouping { get; set; }
		private PlotOptionsTrixSonificationTracksPointGrouping PointGrouping_DefaultValue { get; set; }
		...
		/// </summary>
		public PlotOptionsTrixSonificationTracksType Type { get; set; }
		private PlotOptionsTrixSonificationTracksType Type_DefaultValue { get; set; }
