...
{
	public partial class PlotOptionsTrixSonificationTracksMappingFrequency  : BaseObject
	{
		Hashtable h = new Hashtable();

		public PlotOptionsTrixSonificationTracksMappingFrequency()
		{
			MapFunction = MapFunction_DefaultValue = PlotOptionsTrixSonificationTracksMappingFrequencyMapFunction.Linear;
			MapTo = MapTo_DefaultValue = "";
			Max = Max_DefaultValue = null;
			Min = Min_DefaultValue = null;
			Value = Value_DefaultValue = null;
			Within = Within_DefaultValue = PlotOptionsTrixSonificationTracksMappingFrequencyWithin.Chart;
		...
		/// </summary>
		public PlotOptionsTrixSonificationTracksMappingFrequencyMapFunction MapFunction { get; set; }
		private PlotOptionsTrixSonificationTracksMappingFrequencyMapFunction MapFunction_DefaultValue { get; set; }
		...
		/// </summary>
		public PlotOptionsTrixSonificationTracksMappingFrequencyWithin Within { get; set; }
		private PlotOptionsTrixSonificationTracksMappingFrequencyWithin Within_DefaultValue { get; set; }
