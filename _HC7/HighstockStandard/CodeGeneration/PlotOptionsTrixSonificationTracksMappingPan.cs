...
{
	public partial class PlotOptionsTrixSonificationTracksMappingPan  : BaseObject
	{
		Hashtable h = new Hashtable();

		public PlotOptionsTrixSonificationTracksMappingPan()
		{
			MapFunction = MapFunction_DefaultValue = PlotOptionsTrixSonificationTracksMappingPanMapFunction.Linear;
			MapTo = MapTo_DefaultValue = "";
			Max = Max_DefaultValue = null;
			Min = Min_DefaultValue = null;
			Value = Value_DefaultValue = null;
			Within = Within_DefaultValue = PlotOptionsTrixSonificationTracksMappingPanWithin.Chart;
		...
		/// </summary>
		public PlotOptionsTrixSonificationTracksMappingPanMapFunction MapFunction { get; set; }
		private PlotOptionsTrixSonificationTracksMappingPanMapFunction MapFunction_DefaultValue { get; set; }
		...
		/// </summary>
		public PlotOptionsTrixSonificationTracksMappingPanWithin Within { get; set; }
		private PlotOptionsTrixSonificationTracksMappingPanWithin Within_DefaultValue { get; set; }
