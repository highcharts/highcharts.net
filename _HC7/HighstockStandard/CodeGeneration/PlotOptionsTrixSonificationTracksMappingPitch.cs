...
{
	public partial class PlotOptionsTrixSonificationTracksMappingPitch  : BaseObject
	{
		Hashtable h = new Hashtable();

		public PlotOptionsTrixSonificationTracksMappingPitch()
		{
			MapFunction = MapFunction_DefaultValue = PlotOptionsTrixSonificationTracksMappingPitchMapFunction.Linear;
		...
		/// </summary>
		public PlotOptionsTrixSonificationTracksMappingPitchMapFunction MapFunction { get; set; }
		private PlotOptionsTrixSonificationTracksMappingPitchMapFunction MapFunction_DefaultValue { get; set; }
