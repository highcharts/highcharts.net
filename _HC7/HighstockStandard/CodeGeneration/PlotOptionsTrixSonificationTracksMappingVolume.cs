...
{
	public partial class PlotOptionsTrixSonificationTracksMappingVolume  : BaseObject
	{
		Hashtable h = new Hashtable();

		public PlotOptionsTrixSonificationTracksMappingVolume()
		{
			MapFunction = MapFunction_DefaultValue = PlotOptionsTrixSonificationTracksMappingVolumeMapFunction.Linear;
			MapTo = MapTo_DefaultValue = "";
			Max = Max_DefaultValue = null;
			Min = Min_DefaultValue = null;
			Value = Value_DefaultValue = null;
			Within = Within_DefaultValue = PlotOptionsTrixSonificationTracksMappingVolumeWithin.Chart;
		...
		/// </summary>
		public PlotOptionsTrixSonificationTracksMappingVolumeMapFunction MapFunction { get; set; }
		private PlotOptionsTrixSonificationTracksMappingVolumeMapFunction MapFunction_DefaultValue { get; set; }
		...
		/// </summary>
		public PlotOptionsTrixSonificationTracksMappingVolumeWithin Within { get; set; }
		private PlotOptionsTrixSonificationTracksMappingVolumeWithin Within_DefaultValue { get; set; }
