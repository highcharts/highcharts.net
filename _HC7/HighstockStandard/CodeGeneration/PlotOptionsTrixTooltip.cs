...
{
	public partial class PlotOptionsTrixTooltip  : BaseObject
	{
		public PlotOptionsTrixTooltip()
		{
			...
			HeaderShape = HeaderShape_DefaultValue = PlotOptionsTrixTooltipHeaderShape.Callout;
		...
		/// </summary>
		public PlotOptionsTrixTooltipHeaderShape HeaderShape { get; set; }
		private PlotOptionsTrixTooltipHeaderShape HeaderShape_DefaultValue { get; set; }
		...
		internal override Hashtable ToHashtable()
		{
			...
			if (NullFormatter != NullFormatter_DefaultValue) { h.Add("nullFormatter",NullFormatter); Highstock.AddFunction("PlotOptionsTrixTooltipNullFormatter.nullFormatter", NullFormatter); }  
			if (Outside != Outside_DefaultValue) h.Add("outside",Outside);
			if (Padding != Padding_DefaultValue) h.Add("padding",Padding);
			if (PointFormat != PointFormat_DefaultValue) h.Add("pointFormat",PointFormat);
			if (PointFormatter != PointFormatter_DefaultValue) { h.Add("pointFormatter",PointFormatter); Highstock.AddFunction("PlotOptionsTrixTooltipPointFormatter.pointFormatter", PointFormatter); }  
