...
{
	public partial class PlotOptionsVbpDataLabels  : BaseObject
	{
		...
		/// </summary>
		public PlotOptionsVbpDataLabelsFilter Filter { get; set; }
		...
		/// </summary>
		public PlotOptionsVbpDataLabelsOverflow Overflow { get; set; }
		...
		/// </summary>
		public PlotOptionsVbpDataLabelsPosition Position { get; set; }
		...
		/// </summary>
		public PlotOptionsVbpDataLabelsTextPath TextPath { get; set; }
		...
		{
			if (Align != PlotOptionsVbpDataLabelsAlign.Null) h.Add("align", highstock.FirstCharacterToLower(Align.ToString()));
			...
			if (Overflow != PlotOptionsVbpDataLabelsOverflow.Null) h.Add("overflow", highstock.FirstCharacterToLower(Overflow.ToString()));
			if (Padding != null) h.Add("padding",Padding);
			if (Position != PlotOptionsVbpDataLabelsPosition.Null) h.Add("position", highstock.FirstCharacterToLower(Position.ToString()));
			...
			if (VerticalAlign != PlotOptionsVbpDataLabelsVerticalAlign.Null) h.Add("verticalAlign", highstock.FirstCharacterToLower(VerticalAlign.ToString()));
			if (X != null) h.Add("x",X);
			if (Y != null) h.Add("y",Y);
