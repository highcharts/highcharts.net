...
{
	public partial class PlotOptionsVbpDragDrop  : BaseObject
	{
		public PlotOptionsVbpDragDrop()
		{
			DraggableX = DraggableX_DefaultValue = null;
			DraggableY = DraggableY_DefaultValue = null;
			DragHandle = DragHandle_DefaultValue = new PlotOptionsVbpDragDropDragHandle();
			...
			GuideBox = GuideBox_DefaultValue = new PlotOptionsVbpDragDropGuideBox();
		...
		/// </summary>
		public PlotOptionsVbpDragDropDragHandle DragHandle { get; set; }
		private PlotOptionsVbpDragDropDragHandle DragHandle_DefaultValue { get; set; }
		...
		/// </summary>
		public PlotOptionsVbpDragDropGuideBox GuideBox { get; set; }
		private PlotOptionsVbpDragDropGuideBox GuideBox_DefaultValue { get; set; }
