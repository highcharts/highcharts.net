...
{
	public partial class PlotOptionsVbpLastPriceLabel  : BaseObject
	{
		Hashtable h = new Hashtable();

		public PlotOptionsVbpLastPriceLabel()
		{
			Align = Align_DefaultValue = PlotOptionsVbpLastPriceLabelAlign.Null;
		...
		/// 
		/// </summary>
		public PlotOptionsVbpLastPriceLabelAlign Align { get; set; }
		private PlotOptionsVbpLastPriceLabelAlign Align_DefaultValue { get; set; }
