...
{
	public partial class PlotOptionsVbpOnPoint  : BaseObject
	{
		Hashtable h = new Hashtable();

		public PlotOptionsVbpOnPoint()
		{
			ConnectorOptions = ConnectorOptions_DefaultValue = new PlotOptionsVbpOnPointConnectorOptions();
			Id = Id_DefaultValue = "";
			Position = Position_DefaultValue = new PlotOptionsVbpOnPointPosition();
		...
		/// </summary>
		public PlotOptionsVbpOnPointConnectorOptions ConnectorOptions { get; set; }
		private PlotOptionsVbpOnPointConnectorOptions ConnectorOptions_DefaultValue { get; set; }
		...
		/// </summary>
		public PlotOptionsVbpOnPointPosition Position { get; set; }
		private PlotOptionsVbpOnPointPosition Position_DefaultValue { get; set; }
