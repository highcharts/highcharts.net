...
{
	public partial class PlotOptionsVbpSonificationContextTracksMapping  : BaseObject
	{
		Hashtable h = new Hashtable();

		public PlotOptionsVbpSonificationContextTracksMapping()
		{
			Frequency = Frequency_DefaultValue = new PlotOptionsVbpSonificationContextTracksMappingFrequency();
			GapBetweenNotes = GapBetweenNotes_DefaultValue = new PlotOptionsVbpSonificationContextTracksMappingGapBetweenNotes();
			Highpass = Highpass_DefaultValue = new PlotOptionsVbpSonificationContextTracksMappingHighpass();
			Lowpass = Lowpass_DefaultValue = new PlotOptionsVbpSonificationContextTracksMappingLowpass();
			NoteDuration = NoteDuration_DefaultValue = new PlotOptionsVbpSonificationContextTracksMappingNoteDuration();
			Pan = Pan_DefaultValue = new PlotOptionsVbpSonificationContextTracksMappingPan();
			Pitch = Pitch_DefaultValue = new PlotOptionsVbpSonificationContextTracksMappingPitch();
			PitchString = PitchString_DefaultValue = "null";
			PitchNumber = PitchNumber_DefaultValue = null;
			PlayDelay = PlayDelay_DefaultValue = new PlotOptionsVbpSonificationContextTracksMappingPlayDelay();
			Time = Time_DefaultValue = new PlotOptionsVbpSonificationContextTracksMappingTime();
			TimeString = TimeString_DefaultValue = "null";
			TimeNumber = TimeNumber_DefaultValue = null;
			Tremolo = Tremolo_DefaultValue = new PlotOptionsVbpSonificationContextTracksMappingTremolo();
			Volume = Volume_DefaultValue = new PlotOptionsVbpSonificationContextTracksMappingVolume();
		...
		/// </summary>
		public PlotOptionsVbpSonificationContextTracksMappingFrequency Frequency { get; set; }
		private PlotOptionsVbpSonificationContextTracksMappingFrequency Frequency_DefaultValue { get; set; }
		...
		/// </summary>
		public PlotOptionsVbpSonificationContextTracksMappingGapBetweenNotes GapBetweenNotes { get; set; }
		private PlotOptionsVbpSonificationContextTracksMappingGapBetweenNotes GapBetweenNotes_DefaultValue { get; set; }
		...
		/// </summary>
		public PlotOptionsVbpSonificationContextTracksMappingHighpass Highpass { get; set; }
		private PlotOptionsVbpSonificationContextTracksMappingHighpass Highpass_DefaultValue { get; set; }
		...
		/// </summary>
		public PlotOptionsVbpSonificationContextTracksMappingLowpass Lowpass { get; set; }
		private PlotOptionsVbpSonificationContextTracksMappingLowpass Lowpass_DefaultValue { get; set; }
		...
		/// </summary>
		public PlotOptionsVbpSonificationContextTracksMappingNoteDuration NoteDuration { get; set; }
		private PlotOptionsVbpSonificationContextTracksMappingNoteDuration NoteDuration_DefaultValue { get; set; }
		...
		/// </summary>
		public PlotOptionsVbpSonificationContextTracksMappingPan Pan { get; set; }
		private PlotOptionsVbpSonificationContextTracksMappingPan Pan_DefaultValue { get; set; }
		...
		/// </summary>
		public PlotOptionsVbpSonificationContextTracksMappingPitch Pitch { get; set; }
		private PlotOptionsVbpSonificationContextTracksMappingPitch Pitch_DefaultValue { get; set; }
		...
		/// </summary>
		public PlotOptionsVbpSonificationContextTracksMappingPlayDelay PlayDelay { get; set; }
		private PlotOptionsVbpSonificationContextTracksMappingPlayDelay PlayDelay_DefaultValue { get; set; }
		...
		/// </summary>
		public PlotOptionsVbpSonificationContextTracksMappingTime Time { get; set; }
		private PlotOptionsVbpSonificationContextTracksMappingTime Time_DefaultValue { get; set; }
		...
		/// </summary>
		public PlotOptionsVbpSonificationContextTracksMappingTremolo Tremolo { get; set; }
		private PlotOptionsVbpSonificationContextTracksMappingTremolo Tremolo_DefaultValue { get; set; }
		 

		/// <summary>
		/// The volume of notes, from 0 to 1.
		/// </summary>
		public PlotOptionsVbpSonificationContextTracksMappingVolume Volume { get; set; }
		private PlotOptionsVbpSonificationContextTracksMappingVolume Volume_DefaultValue { get; set; }
