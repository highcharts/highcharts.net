...
{
	public partial class PlotOptionsVbpSonificationContextTracksMappingPitch  : BaseObject
	{
		Hashtable h = new Hashtable();

		public PlotOptionsVbpSonificationContextTracksMappingPitch()
		{
			MapFunction = MapFunction_DefaultValue = PlotOptionsVbpSonificationContextTracksMappingPitchMapFunction.Linear;
		...
		/// </summary>
		public PlotOptionsVbpSonificationContextTracksMappingPitchMapFunction MapFunction { get; set; }
		private PlotOptionsVbpSonificationContextTracksMappingPitchMapFunction MapFunction_DefaultValue { get; set; }
