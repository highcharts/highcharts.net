...
{
	public partial class PlotOptionsVbpSonificationContextTracksMappingVolume  : BaseObject
	{
		Hashtable h = new Hashtable();

		public PlotOptionsVbpSonificationContextTracksMappingVolume()
		{
			MapFunction = MapFunction_DefaultValue = PlotOptionsVbpSonificationContextTracksMappingVolumeMapFunction.Linear;
			MapTo = MapTo_DefaultValue = "";
			Max = Max_DefaultValue = null;
			Min = Min_DefaultValue = null;
			Value = Value_DefaultValue = null;
			Within = Within_DefaultValue = PlotOptionsVbpSonificationContextTracksMappingVolumeWithin.Chart;
		...
		/// </summary>
		public PlotOptionsVbpSonificationContextTracksMappingVolumeMapFunction MapFunction { get; set; }
		private PlotOptionsVbpSonificationContextTracksMappingVolumeMapFunction MapFunction_DefaultValue { get; set; }
		...
		/// </summary>
		public PlotOptionsVbpSonificationContextTracksMappingVolumeWithin Within { get; set; }
		private PlotOptionsVbpSonificationContextTracksMappingVolumeWithin Within_DefaultValue { get; set; }
