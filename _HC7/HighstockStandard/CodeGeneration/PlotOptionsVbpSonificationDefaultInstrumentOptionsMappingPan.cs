...
{
	public partial class PlotOptionsVbpSonificationDefaultInstrumentOptionsMappingPan  : BaseObject
	{
		Hashtable h = new Hashtable();

		public PlotOptionsVbpSonificationDefaultInstrumentOptionsMappingPan()
		{
			MapFunction = MapFunction_DefaultValue = PlotOptionsVbpSonificationDefaultInstrumentOptionsMappingPanMapFunction.Linear;
			MapTo = MapTo_DefaultValue = "";
			Max = Max_DefaultValue = null;
			Min = Min_DefaultValue = null;
			Value = Value_DefaultValue = null;
			Within = Within_DefaultValue = PlotOptionsVbpSonificationDefaultInstrumentOptionsMappingPanWithin.Chart;
		...
		/// </summary>
		public PlotOptionsVbpSonificationDefaultInstrumentOptionsMappingPanMapFunction MapFunction { get; set; }
		private PlotOptionsVbpSonificationDefaultInstrumentOptionsMappingPanMapFunction MapFunction_DefaultValue { get; set; }
		...
		/// </summary>
		public PlotOptionsVbpSonificationDefaultInstrumentOptionsMappingPanWithin Within { get; set; }
		private PlotOptionsVbpSonificationDefaultInstrumentOptionsMappingPanWithin Within_DefaultValue { get; set; }
