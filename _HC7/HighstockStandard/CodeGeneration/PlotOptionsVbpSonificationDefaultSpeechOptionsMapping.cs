...
{
	public partial class PlotOptionsVbpSonificationDefaultSpeechOptionsMapping  : BaseObject
	{
		Hashtable h = new Hashtable();

		public PlotOptionsVbpSonificationDefaultSpeechOptionsMapping()
		{
			Frequency = Frequency_DefaultValue = new PlotOptionsVbpSonificationDefaultSpeechOptionsMappingFrequency();
			GapBetweenNotes = GapBetweenNotes_DefaultValue = new PlotOptionsVbpSonificationDefaultSpeechOptionsMappingGapBetweenNotes();
			Highpass = Highpass_DefaultValue = new PlotOptionsVbpSonificationDefaultSpeechOptionsMappingHighpass();
			Lowpass = Lowpass_DefaultValue = new PlotOptionsVbpSonificationDefaultSpeechOptionsMappingLowpass();
			NoteDuration = NoteDuration_DefaultValue = new PlotOptionsVbpSonificationDefaultSpeechOptionsMappingNoteDuration();
			Pan = Pan_DefaultValue = new PlotOptionsVbpSonificationDefaultSpeechOptionsMappingPan();
			Pitch = Pitch_DefaultValue = new PlotOptionsVbpSonificationDefaultSpeechOptionsMappingPitch();
			PitchString = PitchString_DefaultValue = "null";
			PitchNumber = PitchNumber_DefaultValue = null;
			PlayDelay = PlayDelay_DefaultValue = new PlotOptionsVbpSonificationDefaultSpeechOptionsMappingPlayDelay();
			Time = Time_DefaultValue = new PlotOptionsVbpSonificationDefaultSpeechOptionsMappingTime();
			TimeString = TimeString_DefaultValue = "null";
			TimeNumber = TimeNumber_DefaultValue = null;
			Tremolo = Tremolo_DefaultValue = new PlotOptionsVbpSonificationDefaultSpeechOptionsMappingTremolo();
			Volume = Volume_DefaultValue = new PlotOptionsVbpSonificationDefaultSpeechOptionsMappingVolume();
		...
		/// </summary>
		public PlotOptionsVbpSonificationDefaultSpeechOptionsMappingFrequency Frequency { get; set; }
		private PlotOptionsVbpSonificationDefaultSpeechOptionsMappingFrequency Frequency_DefaultValue { get; set; }
		...
		/// </summary>
		public PlotOptionsVbpSonificationDefaultSpeechOptionsMappingGapBetweenNotes GapBetweenNotes { get; set; }
		private PlotOptionsVbpSonificationDefaultSpeechOptionsMappingGapBetweenNotes GapBetweenNotes_DefaultValue { get; set; }
		...
		/// </summary>
		public PlotOptionsVbpSonificationDefaultSpeechOptionsMappingHighpass Highpass { get; set; }
		private PlotOptionsVbpSonificationDefaultSpeechOptionsMappingHighpass Highpass_DefaultValue { get; set; }
		...
		/// </summary>
		public PlotOptionsVbpSonificationDefaultSpeechOptionsMappingLowpass Lowpass { get; set; }
		private PlotOptionsVbpSonificationDefaultSpeechOptionsMappingLowpass Lowpass_DefaultValue { get; set; }
		...
		/// </summary>
		public PlotOptionsVbpSonificationDefaultSpeechOptionsMappingNoteDuration NoteDuration { get; set; }
		private PlotOptionsVbpSonificationDefaultSpeechOptionsMappingNoteDuration NoteDuration_DefaultValue { get; set; }
		...
		/// </summary>
		public PlotOptionsVbpSonificationDefaultSpeechOptionsMappingPan Pan { get; set; }
		private PlotOptionsVbpSonificationDefaultSpeechOptionsMappingPan Pan_DefaultValue { get; set; }
		...
		/// </summary>
		public PlotOptionsVbpSonificationDefaultSpeechOptionsMappingPitch Pitch { get; set; }
		private PlotOptionsVbpSonificationDefaultSpeechOptionsMappingPitch Pitch_DefaultValue { get; set; }
		...
		/// </summary>
		public PlotOptionsVbpSonificationDefaultSpeechOptionsMappingPlayDelay PlayDelay { get; set; }
		private PlotOptionsVbpSonificationDefaultSpeechOptionsMappingPlayDelay PlayDelay_DefaultValue { get; set; }
		...
		/// </summary>
		public PlotOptionsVbpSonificationDefaultSpeechOptionsMappingTime Time { get; set; }
		private PlotOptionsVbpSonificationDefaultSpeechOptionsMappingTime Time_DefaultValue { get; set; }
		...
		/// </summary>
		public PlotOptionsVbpSonificationDefaultSpeechOptionsMappingTremolo Tremolo { get; set; }
		private PlotOptionsVbpSonificationDefaultSpeechOptionsMappingTremolo Tremolo_DefaultValue { get; set; }
		 

		/// <summary>
		/// The volume of notes, from 0 to 1.
		/// </summary>
		public PlotOptionsVbpSonificationDefaultSpeechOptionsMappingVolume Volume { get; set; }
		private PlotOptionsVbpSonificationDefaultSpeechOptionsMappingVolume Volume_DefaultValue { get; set; }
