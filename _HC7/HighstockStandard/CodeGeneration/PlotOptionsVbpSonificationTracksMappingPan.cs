...
{
	public partial class PlotOptionsVbpSonificationTracksMappingPan  : BaseObject
	{
		Hashtable h = new Hashtable();

		public PlotOptionsVbpSonificationTracksMappingPan()
		{
			MapFunction = MapFunction_DefaultValue = PlotOptionsVbpSonificationTracksMappingPanMapFunction.Linear;
			MapTo = MapTo_DefaultValue = "";
			Max = Max_DefaultValue = null;
			Min = Min_DefaultValue = null;
			Value = Value_DefaultValue = null;
			Within = Within_DefaultValue = PlotOptionsVbpSonificationTracksMappingPanWithin.Chart;
		...
		/// </summary>
		public PlotOptionsVbpSonificationTracksMappingPanMapFunction MapFunction { get; set; }
		private PlotOptionsVbpSonificationTracksMappingPanMapFunction MapFunction_DefaultValue { get; set; }
		...
		/// </summary>
		public PlotOptionsVbpSonificationTracksMappingPanWithin Within { get; set; }
		private PlotOptionsVbpSonificationTracksMappingPanWithin Within_DefaultValue { get; set; }
