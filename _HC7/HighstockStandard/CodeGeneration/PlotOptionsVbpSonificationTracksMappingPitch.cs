...
{
	public partial class PlotOptionsVbpSonificationTracksMappingPitch  : BaseObject
	{
		Hashtable h = new Hashtable();

		public PlotOptionsVbpSonificationTracksMappingPitch()
		{
			MapFunction = MapFunction_DefaultValue = PlotOptionsVbpSonificationTracksMappingPitchMapFunction.Linear;
		...
		/// </summary>
		public PlotOptionsVbpSonificationTracksMappingPitchMapFunction MapFunction { get; set; }
		private PlotOptionsVbpSonificationTracksMappingPitchMapFunction MapFunction_DefaultValue { get; set; }
