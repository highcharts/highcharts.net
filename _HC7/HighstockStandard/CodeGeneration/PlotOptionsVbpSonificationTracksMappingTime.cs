...
{
	public partial class PlotOptionsVbpSonificationTracksMappingTime  : BaseObject
	{
		Hashtable h = new Hashtable();

		public PlotOptionsVbpSonificationTracksMappingTime()
		{
			MapFunction = MapFunction_DefaultValue = PlotOptionsVbpSonificationTracksMappingTimeMapFunction.Linear;
			MapTo = MapTo_DefaultValue = "";
			Max = Max_DefaultValue = null;
			Min = Min_DefaultValue = null;
			Value = Value_DefaultValue = null;
			Within = Within_DefaultValue = PlotOptionsVbpSonificationTracksMappingTimeWithin.Chart;
		...
		/// </summary>
		public PlotOptionsVbpSonificationTracksMappingTimeMapFunction MapFunction { get; set; }
		private PlotOptionsVbpSonificationTracksMappingTimeMapFunction MapFunction_DefaultValue { get; set; }
		...
		/// </summary>
		public PlotOptionsVbpSonificationTracksMappingTimeWithin Within { get; set; }
		private PlotOptionsVbpSonificationTracksMappingTimeWithin Within_DefaultValue { get; set; }
