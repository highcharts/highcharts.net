...
{
	public partial class PlotOptionsVbpTooltip  : BaseObject
	{
		public PlotOptionsVbpTooltip()
		{
			...
			HeaderShape = HeaderShape_DefaultValue = PlotOptionsVbpTooltipHeaderShape.Callout;
		...
		/// </summary>
		public PlotOptionsVbpTooltipHeaderShape HeaderShape { get; set; }
		private PlotOptionsVbpTooltipHeaderShape HeaderShape_DefaultValue { get; set; }
		...
		internal override Hashtable ToHashtable()
		{
			...
			if (NullFormatter != NullFormatter_DefaultValue) { h.Add("nullFormatter",NullFormatter); Highstock.AddFunction("PlotOptionsVbpTooltipNullFormatter.nullFormatter", NullFormatter); }  
			if (Outside != Outside_DefaultValue) h.Add("outside",Outside);
			if (Padding != Padding_DefaultValue) h.Add("padding",Padding);
			if (PointFormat != PointFormat_DefaultValue) h.Add("pointFormat",PointFormat);
			if (PointFormatter != PointFormatter_DefaultValue) { h.Add("pointFormatter",PointFormatter); Highstock.AddFunction("PlotOptionsVbpTooltipPointFormatter.pointFormatter", PointFormatter); }  
