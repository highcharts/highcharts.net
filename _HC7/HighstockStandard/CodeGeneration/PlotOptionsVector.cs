...
namespace Highsoft.Web.Mvc.Stocks
{
	public partial class PlotOptionsVector  : BaseObject
	{
		...
		{
			Accessibility = Accessibility_DefaultValue = new PlotOptionsVectorAccessibility();
			...
			Cluster = Cluster_DefaultValue = new PlotOptionsVectorCluster();
			...
			Compare = Compare_DefaultValue = PlotOptionsVectorCompare.Percent;
			...
			DataSorting = DataSorting_DefaultValue = new PlotOptionsVectorDataSorting();
			...
			Sonification = Sonification_DefaultValue = new PlotOptionsVectorSonification();
		...
		private PlotOptionsVectorCompare Compare_DefaultValue { get; set; }
		...
		private PlotOptionsVectorLastPrice LastPrice_DefaultValue { get; set; }
		...
		private PlotOptionsVectorLastVisiblePrice LastVisiblePrice_DefaultValue { get; set; }
