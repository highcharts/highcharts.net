...
namespace Highsoft.Web.Mvc.Stocks
{
	public partial class PlotOptionsVector  : BaseObject
	{
		...
		/// </summary>
		public PlotOptionsVectorAccessibility Accessibility { get; set; }
		...
		/// </summary>
		public PlotOptionsVectorCluster Cluster { get; set; }
		...
		/// </summary>
		public PlotOptionsVectorCompare Compare { get; set; }
		...
		/// </summary>
		public PlotOptionsVectorDataSorting DataSorting { get; set; }
		...
		/// </summary>
		public PlotOptionsVectorLastPrice LastPrice { get; set; }
		 

		/// <summary>
		/// The line marks the last price from visible range of points.
		/// </summary>
		public PlotOptionsVectorLastVisiblePrice LastVisiblePrice { get; set; }
		 

		/// <summary>
		/// What type of legend symbol to render for this series. Can be one of`areaMarker`, `lineMarker` or `rectangle`.
		/// </summary>
		public PlotOptionsVectorLegendSymbol LegendSymbol { get; set; }
		...
		/// </summary>
		public PlotOptionsVectorOnPoint OnPoint { get; set; }
		...
		/// </summary>
		public PlotOptionsVectorSonification Sonification { get; set; }
		...
		internal override Hashtable ToHashtable(Highstock highstock)
		{
			...
			if (Compare != PlotOptionsVectorCompare.Null) h.Add("compare", highstock.FirstCharacterToLower(Compare.ToString()));
			if (CompareBase != PlotOptionsVectorCompareBase.Null) h.Add("compareBase", highstock.FirstCharacterToLower(CompareBase.ToString()));
			...
			if (Cursor != PlotOptionsVectorCursor.Null) h.Add("cursor", highstock.FirstCharacterToLower(Cursor.ToString()));
			...
			if (FindNearestPointBy != PlotOptionsVectorFindNearestPointBy.Null) h.Add("findNearestPointBy", highstock.FirstCharacterToLower(FindNearestPointBy.ToString()));
			...
			if (LegendSymbol != PlotOptionsVectorLegendSymbol.Null) h.Add("legendSymbol", highstock.FirstCharacterToLower(LegendSymbol.ToString()));
			...
			if (PointIntervalUnit != PlotOptionsVectorPointIntervalUnit.Null) h.Add("pointIntervalUnit", highstock.FirstCharacterToLower(PointIntervalUnit.ToString()));
			...
			if (RotationOrigin != PlotOptionsVectorRotationOrigin.Null) h.Add("rotationOrigin", highstock.FirstCharacterToLower(RotationOrigin.ToString()));
