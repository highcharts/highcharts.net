...
{
	public partial class PlotOptionsVectorDragDrop  : BaseObject
	{
		public PlotOptionsVectorDragDrop()
		{
			DraggableX = DraggableX_DefaultValue = null;
			DraggableY = DraggableY_DefaultValue = null;
			DragHandle = DragHandle_DefaultValue = new PlotOptionsVectorDragDropDragHandle();
			...
			GuideBox = GuideBox_DefaultValue = new PlotOptionsVectorDragDropGuideBox();
		...
		/// </summary>
		public PlotOptionsVectorDragDropDragHandle DragHandle { get; set; }
		private PlotOptionsVectorDragDropDragHandle DragHandle_DefaultValue { get; set; }
		...
		/// </summary>
		public PlotOptionsVectorDragDropGuideBox GuideBox { get; set; }
		private PlotOptionsVectorDragDropGuideBox GuideBox_DefaultValue { get; set; }
