...
namespace Highsoft.Web.Mvc.Stocks
{
	public partial class PlotOptionsVectorSonificationContextTracksMappingTremolo  : BaseObject
	{
		...
		{
			Depth = Depth_DefaultValue = new PlotOptionsVectorSonificationContextTracksMappingTremoloDepth();
			Speed = Speed_DefaultValue = new PlotOptionsVectorSonificationContextTracksMappingTremoloSpeed();
