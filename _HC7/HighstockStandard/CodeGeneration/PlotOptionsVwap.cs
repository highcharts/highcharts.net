...
namespace Highsoft.Web.Mvc.Stocks
{
	public partial class PlotOptionsVwap  : BaseObject
	{
		...
		public PlotOptionsVwap()
		{
			...
			Zones = Zones_DefaultValue = new List<PlotOptionsVwapZone>();
		...
		/// </summary>
		public List<PlotOptionsVwapZone> Zones { get; set; }
		private List<PlotOptionsVwapZone> Zones_DefaultValue { get; set; }
