...
{
	public partial class PlotOptionsVwap  : BaseObject
	{
		Hashtable h = new Hashtable();

		public PlotOptionsVwap()
		{
			Accessibility = Accessibility_DefaultValue = new PlotOptionsVwapAccessibility();
			AllowPointSelect = AllowPointSelect_DefaultValue = false;
			Animation = Animation_DefaultValue = new Animation() { Enabled = true };
			AnimationBool = AnimationBool_DefaultValue = true;
			AnimationLimit = AnimationLimit_DefaultValue = null;
			BoostBlending = BoostBlending_DefaultValue = PlotOptionsVwapBoostBlending.Undefined;
			...
			Compare = Compare_DefaultValue = PlotOptionsVwapCompare.Percent;
			CompareBase = CompareBase_DefaultValue = PlotOptionsVwapCompareBase.Min;
			...
			Cursor = Cursor_DefaultValue = PlotOptionsVwapCursor.Null;
			Custom = Custom_DefaultValue = new Hashtable();
			DashStyle = DashStyle_DefaultValue = PlotOptionsVwapDashStyle.Null;
			DataGrouping = DataGrouping_DefaultValue = new PlotOptionsVwapDataGrouping();
			DataLabels = DataLabels_DefaultValue = new PlotOptionsVwapDataLabels();
			DataSorting = DataSorting_DefaultValue = new PlotOptionsVwapDataSorting();
			Description = Description_DefaultValue = "";
			EnableMouseTracking = EnableMouseTracking_DefaultValue = true;
			Events = Events_DefaultValue = new PlotOptionsVwapEvents();
			FindNearestPointBy = FindNearestPointBy_DefaultValue = PlotOptionsVwapFindNearestPointBy.X;
			GapSize = GapSize_DefaultValue = 0;
			GapUnit = GapUnit_DefaultValue = PlotOptionsVwapGapUnit.Relative;
			GetExtremesFromAll = GetExtremesFromAll_DefaultValue = false;
			InactiveOtherPoints = InactiveOtherPoints_DefaultValue = false;
			IncludeInDataExport = IncludeInDataExport_DefaultValue = null;
			Label = Label_DefaultValue = new PlotOptionsVwapLabel();
			LastPrice = LastPrice_DefaultValue = new PlotOptionsVwapLastPrice();
			LastVisiblePrice = LastVisiblePrice_DefaultValue = new PlotOptionsVwapLastVisiblePrice();
			LegendSymbol = LegendSymbol_DefaultValue = PlotOptionsVwapLegendSymbol.Rectangle;
			Linecap = Linecap_DefaultValue = PlotOptionsVwapLinecap.Round;
			LineWidth = LineWidth_DefaultValue = 2;
			LinkedTo = LinkedTo_DefaultValue = "";
			Marker = Marker_DefaultValue = new PlotOptionsVwapMarker();
			NegativeColor = NegativeColor_DefaultValue = "";
			OnPoint = OnPoint_DefaultValue = new PlotOptionsVwapOnPoint();
			Opacity = Opacity_DefaultValue = 1;
			Params = Params_DefaultValue = new PlotOptionsVwapParams();
			Point = Point_DefaultValue = new PlotOptionsVwapPoint();
			...
			Sonification = Sonification_DefaultValue = new PlotOptionsVwapSonification();
			States = States_DefaultValue = new PlotOptionsVwapStates();
			Step = Step_DefaultValue = PlotOptionsVwapStep.Null;
			StickyTracking = StickyTracking_DefaultValue = true;
			Threshold = Threshold_DefaultValue = 0;
			Tooltip = Tooltip_DefaultValue = new PlotOptionsVwapTooltip();
			TurboThreshold = TurboThreshold_DefaultValue = 1000;
			Visible = Visible_DefaultValue = true;
			ZoneAxis = ZoneAxis_DefaultValue = "y";
			Zones = Zones_DefaultValue = new List<PlotOptionsVwapZones>();
		...
		/// </summary>
		public PlotOptionsVwapAccessibility Accessibility { get; set; }
		private PlotOptionsVwapAccessibility Accessibility_DefaultValue { get; set; }
		...
		/// </summary>
		public PlotOptionsVwapBoostBlending BoostBlending { get; set; }
		private PlotOptionsVwapBoostBlending BoostBlending_DefaultValue { get; set; }
		...
		/// </summary>
		public PlotOptionsVwapCompare Compare { get; set; }
		private PlotOptionsVwapCompare Compare_DefaultValue { get; set; }
		 

		/// <summary>
		/// When [compare](#plotOptions.series.compare) is `percent`, this optiondictates whether to use 0 or 100 as the base of comparison.
		/// </summary>
		public PlotOptionsVwapCompareBase CompareBase { get; set; }
		private PlotOptionsVwapCompareBase CompareBase_DefaultValue { get; set; }
		...
		/// </summary>
		public PlotOptionsVwapCursor Cursor { get; set; }
		private PlotOptionsVwapCursor Cursor_DefaultValue { get; set; }
		...
		/// </summary>
		public PlotOptionsVwapDashStyle DashStyle { get; set; }
		private PlotOptionsVwapDashStyle DashStyle_DefaultValue { get; set; }
		...
		/// </summary>
		public PlotOptionsVwapDataGrouping DataGrouping { get; set; }
		private PlotOptionsVwapDataGrouping DataGrouping_DefaultValue { get; set; }
		...
		/// </summary>
		public PlotOptionsVwapDataLabels DataLabels { get; set; }
		private PlotOptionsVwapDataLabels DataLabels_DefaultValue { get; set; }
		 

		/// <summary>
		/// Options for the series data sorting.
		/// </summary>
		public PlotOptionsVwapDataSorting DataSorting { get; set; }
		private PlotOptionsVwapDataSorting DataSorting_DefaultValue { get; set; }
		...
		/// </summary>
		public PlotOptionsVwapEvents Events { get; set; }
		private PlotOptionsVwapEvents Events_DefaultValue { get; set; }
		...
		/// </summary>
		public PlotOptionsVwapFindNearestPointBy FindNearestPointBy { get; set; }
		private PlotOptionsVwapFindNearestPointBy FindNearestPointBy_DefaultValue { get; set; }
		...
		/// </summary>
		public PlotOptionsVwapGapUnit GapUnit { get; set; }
		private PlotOptionsVwapGapUnit GapUnit_DefaultValue { get; set; }
		...
		/// </summary>
		public PlotOptionsVwapLabel Label { get; set; }
		private PlotOptionsVwapLabel Label_DefaultValue { get; set; }
		 

		/// <summary>
		/// The line marks the last price from all points.
		/// </summary>
		public PlotOptionsVwapLastPrice LastPrice { get; set; }
		private PlotOptionsVwapLastPrice LastPrice_DefaultValue { get; set; }
		 

		/// <summary>
		/// The line marks the last price from visible range of points.
		/// </summary>
		public PlotOptionsVwapLastVisiblePrice LastVisiblePrice { get; set; }
		private PlotOptionsVwapLastVisiblePrice LastVisiblePrice_DefaultValue { get; set; }
		 

		/// <summary>
		/// What type of legend symbol to render for this series. Can be one of`areaMarker`, `lineMarker` or `rectangle`.
		/// </summary>
		public PlotOptionsVwapLegendSymbol LegendSymbol { get; set; }
		private PlotOptionsVwapLegendSymbol LegendSymbol_DefaultValue { get; set; }
		 

		/// <summary>
		/// The line cap used for line ends and line joins on the graph.
		/// </summary>
		public PlotOptionsVwapLinecap Linecap { get; set; }
		private PlotOptionsVwapLinecap Linecap_DefaultValue { get; set; }
		...
		/// </summary>
		public PlotOptionsVwapMarker Marker { get; set; }
		private PlotOptionsVwapMarker Marker_DefaultValue { get; set; }
		...
		/// </summary>
		public PlotOptionsVwapOnPoint OnPoint { get; set; }
		private PlotOptionsVwapOnPoint OnPoint_DefaultValue { get; set; }
		...
		/// 
		/// </summary>
		public PlotOptionsVwapParams Params { get; set; }
		private PlotOptionsVwapParams Params_DefaultValue { get; set; }
		 

		/// <summary>
		/// Properties for each single point.
		/// </summary>
		public PlotOptionsVwapPoint Point { get; set; }
		private PlotOptionsVwapPoint Point_DefaultValue { get; set; }
		...
		/// </summary>
		public PlotOptionsVwapSonification Sonification { get; set; }
		private PlotOptionsVwapSonification Sonification_DefaultValue { get; set; }
		 

		/// <summary>
		/// 
		/// </summary>
		public PlotOptionsVwapStates States { get; set; }
		private PlotOptionsVwapStates States_DefaultValue { get; set; }
		 

		/// <summary>
		/// Whether to apply steps to the line. Possible values are `left`,`center` and `right`.
		/// </summary>
		public PlotOptionsVwapStep Step { get; set; }
		private PlotOptionsVwapStep Step_DefaultValue { get; set; }
		...
		/// </summary>
		public PlotOptionsVwapTooltip Tooltip { get; set; }
		private PlotOptionsVwapTooltip Tooltip_DefaultValue { get; set; }
		...
		/// </summary>
		public List<PlotOptionsVwapZones> Zones { get; set; }
		private List<PlotOptionsVwapZones> Zones_DefaultValue { get; set; }
