...
namespace Highsoft.Web.Mvc.Stocks
{
	public partial class PlotOptionsVwapDataGrouping  : BaseObject
	{
		...
		internal override Hashtable ToHashtable()
		{
			...
			if (Approximation != Approximation_DefaultValue) { h.Add("approximation",Approximation); Highstock.AddFunction("PlotOptionsVwapDataGroupingApproximation.approximation", Approximation); }  
