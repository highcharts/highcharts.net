...
{
	public partial class PlotOptionsVwapMarker  : BaseObject
	{
		public PlotOptionsVwapMarker()
		{
			...
			States = States_DefaultValue = new PlotOptionsVwapMarkerStates();
		...
		/// </summary>
		public PlotOptionsVwapMarkerStates States { get; set; }
		private PlotOptionsVwapMarkerStates States_DefaultValue { get; set; }
