...
namespace Highsoft.Web.Mvc.Stocks
{
	public partial class PlotOptionsVwapMarkerStates  : BaseObject
	{
		public PlotOptionsVwapMarkerStates()
		{
			...
			Inactive = Inactive_DefaultValue = new PlotOptionsVwapMarkerStatesInactive();
		...
		/// 
		/// </summary>
		public PlotOptionsVwapMarkerStatesInactive Inactive { get; set; }
		private PlotOptionsVwapMarkerStatesInactive Inactive_DefaultValue { get; set; }
