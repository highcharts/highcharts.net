...
{
	public partial class PlotOptionsVwapSonificationContextTracksMappingPitch  : BaseObject
	{
		Hashtable h = new Hashtable();

		public PlotOptionsVwapSonificationContextTracksMappingPitch()
		{
			MapFunction = MapFunction_DefaultValue = PlotOptionsVwapSonificationContextTracksMappingPitchMapFunction.Linear;
		...
		/// </summary>
		public PlotOptionsVwapSonificationContextTracksMappingPitchMapFunction MapFunction { get; set; }
		private PlotOptionsVwapSonificationContextTracksMappingPitchMapFunction MapFunction_DefaultValue { get; set; }
