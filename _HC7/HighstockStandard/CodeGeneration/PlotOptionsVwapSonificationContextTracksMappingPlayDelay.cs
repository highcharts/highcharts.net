...
{
	public partial class PlotOptionsVwapSonificationContextTracksMappingPlayDelay  : BaseObject
	{
		Hashtable h = new Hashtable();

		public PlotOptionsVwapSonificationContextTracksMappingPlayDelay()
		{
			MapFunction = MapFunction_DefaultValue = PlotOptionsVwapSonificationContextTracksMappingPlayDelayMapFunction.Linear;
			MapTo = MapTo_DefaultValue = "";
			Max = Max_DefaultValue = null;
			Min = Min_DefaultValue = null;
			Value = Value_DefaultValue = null;
			Within = Within_DefaultValue = PlotOptionsVwapSonificationContextTracksMappingPlayDelayWithin.Chart;
		...
		/// </summary>
		public PlotOptionsVwapSonificationContextTracksMappingPlayDelayMapFunction MapFunction { get; set; }
		private PlotOptionsVwapSonificationContextTracksMappingPlayDelayMapFunction MapFunction_DefaultValue { get; set; }
		...
		/// </summary>
		public PlotOptionsVwapSonificationContextTracksMappingPlayDelayWithin Within { get; set; }
		private PlotOptionsVwapSonificationContextTracksMappingPlayDelayWithin Within_DefaultValue { get; set; }
