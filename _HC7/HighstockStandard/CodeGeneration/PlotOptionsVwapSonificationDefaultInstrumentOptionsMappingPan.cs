...
{
	public partial class PlotOptionsVwapSonificationDefaultInstrumentOptionsMappingPan  : BaseObject
	{
		Hashtable h = new Hashtable();

		public PlotOptionsVwapSonificationDefaultInstrumentOptionsMappingPan()
		{
			MapFunction = MapFunction_DefaultValue = PlotOptionsVwapSonificationDefaultInstrumentOptionsMappingPanMapFunction.Linear;
			MapTo = MapTo_DefaultValue = "";
			Max = Max_DefaultValue = null;
			Min = Min_DefaultValue = null;
			Value = Value_DefaultValue = null;
			Within = Within_DefaultValue = PlotOptionsVwapSonificationDefaultInstrumentOptionsMappingPanWithin.Chart;
		...
		/// </summary>
		public PlotOptionsVwapSonificationDefaultInstrumentOptionsMappingPanMapFunction MapFunction { get; set; }
		private PlotOptionsVwapSonificationDefaultInstrumentOptionsMappingPanMapFunction MapFunction_DefaultValue { get; set; }
		...
		/// </summary>
		public PlotOptionsVwapSonificationDefaultInstrumentOptionsMappingPanWithin Within { get; set; }
		private PlotOptionsVwapSonificationDefaultInstrumentOptionsMappingPanWithin Within_DefaultValue { get; set; }
