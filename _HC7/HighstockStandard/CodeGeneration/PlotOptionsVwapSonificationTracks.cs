...
{
	public partial class PlotOptionsVwapSonificationTracks  : BaseObject
	{
		Hashtable h = new Hashtable();

		public PlotOptionsVwapSonificationTracks()
		{
			ActiveWhen = ActiveWhen_DefaultValue = new PlotOptionsVwapSonificationTracksActiveWhen();
			Instrument = Instrument_DefaultValue = null;
			InstrumentString = InstrumentString_DefaultValue = "null";
			Mapping = Mapping_DefaultValue = new PlotOptionsVwapSonificationTracksMapping();
			MidiName = MidiName_DefaultValue = "";
			PointGrouping = PointGrouping_DefaultValue = new PlotOptionsVwapSonificationTracksPointGrouping();
			RoundToMusicalNotes = RoundToMusicalNotes_DefaultValue = true;
			ShowPlayMarker = ShowPlayMarker_DefaultValue = true;
			Type = Type_DefaultValue = PlotOptionsVwapSonificationTracksType.Instrument;
		...
		/// </summary>
		public PlotOptionsVwapSonificationTracksActiveWhen ActiveWhen { get; set; }
		private PlotOptionsVwapSonificationTracksActiveWhen ActiveWhen_DefaultValue { get; set; }
		...
		/// </summary>
		public PlotOptionsVwapSonificationTracksMapping Mapping { get; set; }
		private PlotOptionsVwapSonificationTracksMapping Mapping_DefaultValue { get; set; }
		...
		/// </summary>
		public PlotOptionsVwapSonificationTracksPointGrouping PointGrouping { get; set; }
		private PlotOptionsVwapSonificationTracksPointGrouping PointGrouping_DefaultValue { get; set; }
		...
		/// </summary>
		public PlotOptionsVwapSonificationTracksType Type { get; set; }
		private PlotOptionsVwapSonificationTracksType Type_DefaultValue { get; set; }
