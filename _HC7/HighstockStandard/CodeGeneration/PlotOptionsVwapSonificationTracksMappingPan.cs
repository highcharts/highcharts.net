...
{
	public partial class PlotOptionsVwapSonificationTracksMappingPan  : BaseObject
	{
		Hashtable h = new Hashtable();

		public PlotOptionsVwapSonificationTracksMappingPan()
		{
			MapFunction = MapFunction_DefaultValue = PlotOptionsVwapSonificationTracksMappingPanMapFunction.Linear;
			MapTo = MapTo_DefaultValue = "";
			Max = Max_DefaultValue = null;
			Min = Min_DefaultValue = null;
			Value = Value_DefaultValue = null;
			Within = Within_DefaultValue = PlotOptionsVwapSonificationTracksMappingPanWithin.Chart;
		...
		/// </summary>
		public PlotOptionsVwapSonificationTracksMappingPanMapFunction MapFunction { get; set; }
		private PlotOptionsVwapSonificationTracksMappingPanMapFunction MapFunction_DefaultValue { get; set; }
		...
		/// </summary>
		public PlotOptionsVwapSonificationTracksMappingPanWithin Within { get; set; }
		private PlotOptionsVwapSonificationTracksMappingPanWithin Within_DefaultValue { get; set; }
