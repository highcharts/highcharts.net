...
{
	public partial class PlotOptionsVwapSonificationTracksMappingPitch  : BaseObject
	{
		Hashtable h = new Hashtable();

		public PlotOptionsVwapSonificationTracksMappingPitch()
		{
			MapFunction = MapFunction_DefaultValue = PlotOptionsVwapSonificationTracksMappingPitchMapFunction.Linear;
		...
		/// </summary>
		public PlotOptionsVwapSonificationTracksMappingPitchMapFunction MapFunction { get; set; }
		private PlotOptionsVwapSonificationTracksMappingPitchMapFunction MapFunction_DefaultValue { get; set; }
