...
{
	public partial class PlotOptionsVwapTooltip  : BaseObject
	{
		public PlotOptionsVwapTooltip()
		{
			...
			HeaderShape = HeaderShape_DefaultValue = PlotOptionsVwapTooltipHeaderShape.Callout;
		...
		/// </summary>
		public PlotOptionsVwapTooltipHeaderShape HeaderShape { get; set; }
		private PlotOptionsVwapTooltipHeaderShape HeaderShape_DefaultValue { get; set; }
		...
		internal override Hashtable ToHashtable()
		{
			...
			if (NullFormatter != NullFormatter_DefaultValue) { h.Add("nullFormatter",NullFormatter); Highstock.AddFunction("PlotOptionsVwapTooltipNullFormatter.nullFormatter", NullFormatter); }  
			if (Outside != Outside_DefaultValue) h.Add("outside",Outside);
			if (Padding != Padding_DefaultValue) h.Add("padding",Padding);
			if (PointFormat != PointFormat_DefaultValue) h.Add("pointFormat",PointFormat);
			if (PointFormatter != PointFormatter_DefaultValue) { h.Add("pointFormatter",PointFormatter); Highstock.AddFunction("PlotOptionsVwapTooltipPointFormatter.pointFormatter", PointFormatter); }  
