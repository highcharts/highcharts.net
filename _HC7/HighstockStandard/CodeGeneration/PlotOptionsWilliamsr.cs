...
{
	public partial class PlotOptionsWilliamsr  : BaseObject
	{
		Hashtable h = new Hashtable();

		public PlotOptionsWilliamsr()
		{
			Accessibility = Accessibility_DefaultValue = new PlotOptionsWilliamsrAccessibility();
			AllowPointSelect = AllowPointSelect_DefaultValue = false;
			Animation = Animation_DefaultValue = new Animation() { Enabled = true };
			AnimationBool = AnimationBool_DefaultValue = true;
			AnimationLimit = AnimationLimit_DefaultValue = null;
			BoostBlending = BoostBlending_DefaultValue = PlotOptionsWilliamsrBoostBlending.Undefined;
			...
			Compare = Compare_DefaultValue = PlotOptionsWilliamsrCompare.Percent;
			CompareBase = CompareBase_DefaultValue = PlotOptionsWilliamsrCompareBase.Min;
			...
			Cursor = Cursor_DefaultValue = PlotOptionsWilliamsrCursor.Null;
			Custom = Custom_DefaultValue = new Hashtable();
			DashStyle = DashStyle_DefaultValue = PlotOptionsWilliamsrDashStyle.Null;
			DataGrouping = DataGrouping_DefaultValue = new PlotOptionsWilliamsrDataGrouping();
			DataLabels = DataLabels_DefaultValue = new PlotOptionsWilliamsrDataLabels();
			DataSorting = DataSorting_DefaultValue = new PlotOptionsWilliamsrDataSorting();
			Description = Description_DefaultValue = "";
			EnableMouseTracking = EnableMouseTracking_DefaultValue = true;
			Events = Events_DefaultValue = new PlotOptionsWilliamsrEvents();
			FindNearestPointBy = FindNearestPointBy_DefaultValue = PlotOptionsWilliamsrFindNearestPointBy.X;
			GapSize = GapSize_DefaultValue = 0;
			GapUnit = GapUnit_DefaultValue = PlotOptionsWilliamsrGapUnit.Relative;
			GetExtremesFromAll = GetExtremesFromAll_DefaultValue = false;
			IncludeInDataExport = IncludeInDataExport_DefaultValue = null;
			Label = Label_DefaultValue = new PlotOptionsWilliamsrLabel();
			LastPrice = LastPrice_DefaultValue = new PlotOptionsWilliamsrLastPrice();
			LastVisiblePrice = LastVisiblePrice_DefaultValue = new PlotOptionsWilliamsrLastVisiblePrice();
			LegendSymbol = LegendSymbol_DefaultValue = PlotOptionsWilliamsrLegendSymbol.Rectangle;
			Linecap = Linecap_DefaultValue = PlotOptionsWilliamsrLinecap.Round;
			LineWidth = LineWidth_DefaultValue = 1;
			LinkedTo = LinkedTo_DefaultValue = "";
			Marker = Marker_DefaultValue = new PlotOptionsWilliamsrMarker();
			NegativeColor = NegativeColor_DefaultValue = "";
			OnPoint = OnPoint_DefaultValue = new PlotOptionsWilliamsrOnPoint();
			Opacity = Opacity_DefaultValue = 1;
			Params = Params_DefaultValue = new PlotOptionsWilliamsrParams();
			Point = Point_DefaultValue = new PlotOptionsWilliamsrPoint();
			...
			Sonification = Sonification_DefaultValue = new PlotOptionsWilliamsrSonification();
			States = States_DefaultValue = new PlotOptionsWilliamsrStates();
			Step = Step_DefaultValue = PlotOptionsWilliamsrStep.Null;
			StickyTracking = StickyTracking_DefaultValue = true;
			Threshold = Threshold_DefaultValue = 0;
			Tooltip = Tooltip_DefaultValue = new PlotOptionsWilliamsrTooltip();
			TurboThreshold = TurboThreshold_DefaultValue = 1000;
			Visible = Visible_DefaultValue = true;
			ZoneAxis = ZoneAxis_DefaultValue = "y";
			Zones = Zones_DefaultValue = new List<PlotOptionsWilliamsrZones>();
		...
		/// </summary>
		public PlotOptionsWilliamsrAccessibility Accessibility { get; set; }
		private PlotOptionsWilliamsrAccessibility Accessibility_DefaultValue { get; set; }
		...
		/// </summary>
		public PlotOptionsWilliamsrBoostBlending BoostBlending { get; set; }
		private PlotOptionsWilliamsrBoostBlending BoostBlending_DefaultValue { get; set; }
		...
		/// </summary>
		public PlotOptionsWilliamsrCompare Compare { get; set; }
		private PlotOptionsWilliamsrCompare Compare_DefaultValue { get; set; }
		 

		/// <summary>
		/// When [compare](#plotOptions.series.compare) is `percent`, this optiondictates whether to use 0 or 100 as the base of comparison.
		/// </summary>
		public PlotOptionsWilliamsrCompareBase CompareBase { get; set; }
		private PlotOptionsWilliamsrCompareBase CompareBase_DefaultValue { get; set; }
		...
		/// </summary>
		public PlotOptionsWilliamsrCursor Cursor { get; set; }
		private PlotOptionsWilliamsrCursor Cursor_DefaultValue { get; set; }
		...
		/// </summary>
		public PlotOptionsWilliamsrDashStyle DashStyle { get; set; }
		private PlotOptionsWilliamsrDashStyle DashStyle_DefaultValue { get; set; }
		...
		/// </summary>
		public PlotOptionsWilliamsrDataGrouping DataGrouping { get; set; }
		private PlotOptionsWilliamsrDataGrouping DataGrouping_DefaultValue { get; set; }
		...
		/// </summary>
		public PlotOptionsWilliamsrDataLabels DataLabels { get; set; }
		private PlotOptionsWilliamsrDataLabels DataLabels_DefaultValue { get; set; }
		 

		/// <summary>
		/// Options for the series data sorting.
		/// </summary>
		public PlotOptionsWilliamsrDataSorting DataSorting { get; set; }
		private PlotOptionsWilliamsrDataSorting DataSorting_DefaultValue { get; set; }
		...
		/// </summary>
		public PlotOptionsWilliamsrEvents Events { get; set; }
		private PlotOptionsWilliamsrEvents Events_DefaultValue { get; set; }
		...
		/// </summary>
		public PlotOptionsWilliamsrFindNearestPointBy FindNearestPointBy { get; set; }
		private PlotOptionsWilliamsrFindNearestPointBy FindNearestPointBy_DefaultValue { get; set; }
		...
		/// </summary>
		public PlotOptionsWilliamsrGapUnit GapUnit { get; set; }
		private PlotOptionsWilliamsrGapUnit GapUnit_DefaultValue { get; set; }
		...
		/// </summary>
		public PlotOptionsWilliamsrLabel Label { get; set; }
		private PlotOptionsWilliamsrLabel Label_DefaultValue { get; set; }
		 

		/// <summary>
		/// The line marks the last price from all points.
		/// </summary>
		public PlotOptionsWilliamsrLastPrice LastPrice { get; set; }
		private PlotOptionsWilliamsrLastPrice LastPrice_DefaultValue { get; set; }
		 

		/// <summary>
		/// The line marks the last price from visible range of points.
		/// </summary>
		public PlotOptionsWilliamsrLastVisiblePrice LastVisiblePrice { get; set; }
		private PlotOptionsWilliamsrLastVisiblePrice LastVisiblePrice_DefaultValue { get; set; }
		 

		/// <summary>
		/// What type of legend symbol to render for this series. Can be one of`lineMarker` or `rectangle`.
		/// </summary>
		public PlotOptionsWilliamsrLegendSymbol LegendSymbol { get; set; }
		private PlotOptionsWilliamsrLegendSymbol LegendSymbol_DefaultValue { get; set; }
		 

		/// <summary>
		/// The line cap used for line ends and line joins on the graph.
		/// </summary>
		public PlotOptionsWilliamsrLinecap Linecap { get; set; }
		private PlotOptionsWilliamsrLinecap Linecap_DefaultValue { get; set; }
		...
		/// </summary>
		public PlotOptionsWilliamsrMarker Marker { get; set; }
		private PlotOptionsWilliamsrMarker Marker_DefaultValue { get; set; }
		...
		/// </summary>
		public PlotOptionsWilliamsrOnPoint OnPoint { get; set; }
		private PlotOptionsWilliamsrOnPoint OnPoint_DefaultValue { get; set; }
		...
		/// </summary>
		public PlotOptionsWilliamsrPoint Point { get; set; }
		private PlotOptionsWilliamsrPoint Point_DefaultValue { get; set; }
		...
		/// </summary>
		public PlotOptionsWilliamsrSonification Sonification { get; set; }
		private PlotOptionsWilliamsrSonification Sonification_DefaultValue { get; set; }
		 

		/// <summary>
		/// 
		/// </summary>
		public PlotOptionsWilliamsrStates States { get; set; }
		private PlotOptionsWilliamsrStates States_DefaultValue { get; set; }
		 

		/// <summary>
		/// Whether to apply steps to the line. Possible values are `left`,`center` and `right`.
		/// </summary>
		public PlotOptionsWilliamsrStep Step { get; set; }
		private PlotOptionsWilliamsrStep Step_DefaultValue { get; set; }
		...
		/// </summary>
		public PlotOptionsWilliamsrTooltip Tooltip { get; set; }
		private PlotOptionsWilliamsrTooltip Tooltip_DefaultValue { get; set; }
		...
		/// </summary>
		public List<PlotOptionsWilliamsrZones> Zones { get; set; }
		private List<PlotOptionsWilliamsrZones> Zones_DefaultValue { get; set; }
