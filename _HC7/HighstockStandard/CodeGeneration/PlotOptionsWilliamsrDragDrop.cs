...
{
	public partial class PlotOptionsWilliamsrDragDrop  : BaseObject
	{
		public PlotOptionsWilliamsrDragDrop()
		{
			DraggableX = DraggableX_DefaultValue = null;
			DraggableY = DraggableY_DefaultValue = null;
			DragHandle = DragHandle_DefaultValue = new PlotOptionsWilliamsrDragDropDragHandle();
			...
			GuideBox = GuideBox_DefaultValue = new PlotOptionsWilliamsrDragDropGuideBox();
		...
		/// </summary>
		public PlotOptionsWilliamsrDragDropDragHandle DragHandle { get; set; }
		private PlotOptionsWilliamsrDragDropDragHandle DragHandle_DefaultValue { get; set; }
		...
		/// </summary>
		public PlotOptionsWilliamsrDragDropGuideBox GuideBox { get; set; }
		private PlotOptionsWilliamsrDragDropGuideBox GuideBox_DefaultValue { get; set; }
