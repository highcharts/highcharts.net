...
{
	public partial class PlotOptionsWilliamsrDragDropDragHandle  : BaseObject
	{
		public PlotOptionsWilliamsrDragDropDragHandle()
		{
		...
		internal override Hashtable ToHashtable()
		{
			...
			if (PathFormatter != PathFormatter_DefaultValue) { h.Add("pathFormatter",PathFormatter); Highstock.AddFunction("PlotOptionsWilliamsrDragDropDragHandlePathFormatter.pathFormatter", PathFormatter); }  
