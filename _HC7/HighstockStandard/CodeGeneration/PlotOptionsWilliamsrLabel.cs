...
{
	public partial class PlotOptionsWilliamsrLabel  : BaseObject
	{
		public PlotOptionsWilliamsrLabel()
		{
			...
			Style = Style_DefaultValue = new PlotOptionsWilliamsrLabelStyle();
		...
		/// </summary>
		public PlotOptionsWilliamsrLabelStyle Style { get; set; }
		private PlotOptionsWilliamsrLabelStyle Style_DefaultValue { get; set; }
