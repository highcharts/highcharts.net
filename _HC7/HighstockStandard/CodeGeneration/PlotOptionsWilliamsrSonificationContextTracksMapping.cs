...
{
	public partial class PlotOptionsWilliamsrSonificationContextTracksMapping  : BaseObject
	{
		Hashtable h = new Hashtable();

		public PlotOptionsWilliamsrSonificationContextTracksMapping()
		{
			Frequency = Frequency_DefaultValue = new PlotOptionsWilliamsrSonificationContextTracksMappingFrequency();
			GapBetweenNotes = GapBetweenNotes_DefaultValue = new PlotOptionsWilliamsrSonificationContextTracksMappingGapBetweenNotes();
			Highpass = Highpass_DefaultValue = new PlotOptionsWilliamsrSonificationContextTracksMappingHighpass();
			Lowpass = Lowpass_DefaultValue = new PlotOptionsWilliamsrSonificationContextTracksMappingLowpass();
			NoteDuration = NoteDuration_DefaultValue = new PlotOptionsWilliamsrSonificationContextTracksMappingNoteDuration();
			Pan = Pan_DefaultValue = new PlotOptionsWilliamsrSonificationContextTracksMappingPan();
			Pitch = Pitch_DefaultValue = new PlotOptionsWilliamsrSonificationContextTracksMappingPitch();
			PitchString = PitchString_DefaultValue = "null";
			PitchNumber = PitchNumber_DefaultValue = null;
			PlayDelay = PlayDelay_DefaultValue = new PlotOptionsWilliamsrSonificationContextTracksMappingPlayDelay();
			Time = Time_DefaultValue = new PlotOptionsWilliamsrSonificationContextTracksMappingTime();
			TimeString = TimeString_DefaultValue = "null";
			TimeNumber = TimeNumber_DefaultValue = null;
			Tremolo = Tremolo_DefaultValue = new PlotOptionsWilliamsrSonificationContextTracksMappingTremolo();
			Volume = Volume_DefaultValue = new PlotOptionsWilliamsrSonificationContextTracksMappingVolume();
		...
		/// </summary>
		public PlotOptionsWilliamsrSonificationContextTracksMappingFrequency Frequency { get; set; }
		private PlotOptionsWilliamsrSonificationContextTracksMappingFrequency Frequency_DefaultValue { get; set; }
		...
		/// </summary>
		public PlotOptionsWilliamsrSonificationContextTracksMappingGapBetweenNotes GapBetweenNotes { get; set; }
		private PlotOptionsWilliamsrSonificationContextTracksMappingGapBetweenNotes GapBetweenNotes_DefaultValue { get; set; }
		...
		/// </summary>
		public PlotOptionsWilliamsrSonificationContextTracksMappingHighpass Highpass { get; set; }
		private PlotOptionsWilliamsrSonificationContextTracksMappingHighpass Highpass_DefaultValue { get; set; }
		...
		/// </summary>
		public PlotOptionsWilliamsrSonificationContextTracksMappingLowpass Lowpass { get; set; }
		private PlotOptionsWilliamsrSonificationContextTracksMappingLowpass Lowpass_DefaultValue { get; set; }
		...
		/// </summary>
		public PlotOptionsWilliamsrSonificationContextTracksMappingNoteDuration NoteDuration { get; set; }
		private PlotOptionsWilliamsrSonificationContextTracksMappingNoteDuration NoteDuration_DefaultValue { get; set; }
		...
		/// </summary>
		public PlotOptionsWilliamsrSonificationContextTracksMappingPan Pan { get; set; }
		private PlotOptionsWilliamsrSonificationContextTracksMappingPan Pan_DefaultValue { get; set; }
		...
		/// </summary>
		public PlotOptionsWilliamsrSonificationContextTracksMappingPitch Pitch { get; set; }
		private PlotOptionsWilliamsrSonificationContextTracksMappingPitch Pitch_DefaultValue { get; set; }
		...
		/// </summary>
		public PlotOptionsWilliamsrSonificationContextTracksMappingPlayDelay PlayDelay { get; set; }
		private PlotOptionsWilliamsrSonificationContextTracksMappingPlayDelay PlayDelay_DefaultValue { get; set; }
		...
		/// </summary>
		public PlotOptionsWilliamsrSonificationContextTracksMappingTime Time { get; set; }
		private PlotOptionsWilliamsrSonificationContextTracksMappingTime Time_DefaultValue { get; set; }
		...
		/// </summary>
		public PlotOptionsWilliamsrSonificationContextTracksMappingTremolo Tremolo { get; set; }
		private PlotOptionsWilliamsrSonificationContextTracksMappingTremolo Tremolo_DefaultValue { get; set; }
		 

		/// <summary>
		/// The volume of notes, from 0 to 1.
		/// </summary>
		public PlotOptionsWilliamsrSonificationContextTracksMappingVolume Volume { get; set; }
		private PlotOptionsWilliamsrSonificationContextTracksMappingVolume Volume_DefaultValue { get; set; }
