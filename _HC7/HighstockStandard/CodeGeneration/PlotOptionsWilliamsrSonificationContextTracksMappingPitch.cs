...
{
	public partial class PlotOptionsWilliamsrSonificationContextTracksMappingPitch  : BaseObject
	{
		Hashtable h = new Hashtable();

		public PlotOptionsWilliamsrSonificationContextTracksMappingPitch()
		{
			MapFunction = MapFunction_DefaultValue = PlotOptionsWilliamsrSonificationContextTracksMappingPitchMapFunction.Linear;
		...
		/// </summary>
		public PlotOptionsWilliamsrSonificationContextTracksMappingPitchMapFunction MapFunction { get; set; }
		private PlotOptionsWilliamsrSonificationContextTracksMappingPitchMapFunction MapFunction_DefaultValue { get; set; }
