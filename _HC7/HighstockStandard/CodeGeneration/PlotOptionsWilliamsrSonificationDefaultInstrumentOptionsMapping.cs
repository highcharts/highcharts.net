...
{
	public partial class PlotOptionsWilliamsrSonificationDefaultInstrumentOptionsMapping  : BaseObject
	{
		Hashtable h = new Hashtable();

		public PlotOptionsWilliamsrSonificationDefaultInstrumentOptionsMapping()
		{
			Frequency = Frequency_DefaultValue = new PlotOptionsWilliamsrSonificationDefaultInstrumentOptionsMappingFrequency();
			GapBetweenNotes = GapBetweenNotes_DefaultValue = new PlotOptionsWilliamsrSonificationDefaultInstrumentOptionsMappingGapBetweenNotes();
			Highpass = Highpass_DefaultValue = new PlotOptionsWilliamsrSonificationDefaultInstrumentOptionsMappingHighpass();
			Lowpass = Lowpass_DefaultValue = new PlotOptionsWilliamsrSonificationDefaultInstrumentOptionsMappingLowpass();
			NoteDuration = NoteDuration_DefaultValue = new PlotOptionsWilliamsrSonificationDefaultInstrumentOptionsMappingNoteDuration();
			Pan = Pan_DefaultValue = new PlotOptionsWilliamsrSonificationDefaultInstrumentOptionsMappingPan();
			Pitch = Pitch_DefaultValue = new PlotOptionsWilliamsrSonificationDefaultInstrumentOptionsMappingPitch();
			PitchString = PitchString_DefaultValue = "null";
			PitchNumber = PitchNumber_DefaultValue = null;
			PlayDelay = PlayDelay_DefaultValue = new PlotOptionsWilliamsrSonificationDefaultInstrumentOptionsMappingPlayDelay();
			Time = Time_DefaultValue = new PlotOptionsWilliamsrSonificationDefaultInstrumentOptionsMappingTime();
			TimeString = TimeString_DefaultValue = "null";
			TimeNumber = TimeNumber_DefaultValue = null;
			Tremolo = Tremolo_DefaultValue = new PlotOptionsWilliamsrSonificationDefaultInstrumentOptionsMappingTremolo();
			Volume = Volume_DefaultValue = new PlotOptionsWilliamsrSonificationDefaultInstrumentOptionsMappingVolume();
		...
		/// </summary>
		public PlotOptionsWilliamsrSonificationDefaultInstrumentOptionsMappingFrequency Frequency { get; set; }
		private PlotOptionsWilliamsrSonificationDefaultInstrumentOptionsMappingFrequency Frequency_DefaultValue { get; set; }
		...
		/// </summary>
		public PlotOptionsWilliamsrSonificationDefaultInstrumentOptionsMappingGapBetweenNotes GapBetweenNotes { get; set; }
		private PlotOptionsWilliamsrSonificationDefaultInstrumentOptionsMappingGapBetweenNotes GapBetweenNotes_DefaultValue { get; set; }
		...
		/// </summary>
		public PlotOptionsWilliamsrSonificationDefaultInstrumentOptionsMappingHighpass Highpass { get; set; }
		private PlotOptionsWilliamsrSonificationDefaultInstrumentOptionsMappingHighpass Highpass_DefaultValue { get; set; }
		...
		/// </summary>
		public PlotOptionsWilliamsrSonificationDefaultInstrumentOptionsMappingLowpass Lowpass { get; set; }
		private PlotOptionsWilliamsrSonificationDefaultInstrumentOptionsMappingLowpass Lowpass_DefaultValue { get; set; }
		...
		/// </summary>
		public PlotOptionsWilliamsrSonificationDefaultInstrumentOptionsMappingNoteDuration NoteDuration { get; set; }
		private PlotOptionsWilliamsrSonificationDefaultInstrumentOptionsMappingNoteDuration NoteDuration_DefaultValue { get; set; }
		...
		/// </summary>
		public PlotOptionsWilliamsrSonificationDefaultInstrumentOptionsMappingPan Pan { get; set; }
		private PlotOptionsWilliamsrSonificationDefaultInstrumentOptionsMappingPan Pan_DefaultValue { get; set; }
		...
		/// </summary>
		public PlotOptionsWilliamsrSonificationDefaultInstrumentOptionsMappingPitch Pitch { get; set; }
		private PlotOptionsWilliamsrSonificationDefaultInstrumentOptionsMappingPitch Pitch_DefaultValue { get; set; }
		...
		/// </summary>
		public PlotOptionsWilliamsrSonificationDefaultInstrumentOptionsMappingPlayDelay PlayDelay { get; set; }
		private PlotOptionsWilliamsrSonificationDefaultInstrumentOptionsMappingPlayDelay PlayDelay_DefaultValue { get; set; }
		...
		/// </summary>
		public PlotOptionsWilliamsrSonificationDefaultInstrumentOptionsMappingTime Time { get; set; }
		private PlotOptionsWilliamsrSonificationDefaultInstrumentOptionsMappingTime Time_DefaultValue { get; set; }
		...
		/// </summary>
		public PlotOptionsWilliamsrSonificationDefaultInstrumentOptionsMappingTremolo Tremolo { get; set; }
		private PlotOptionsWilliamsrSonificationDefaultInstrumentOptionsMappingTremolo Tremolo_DefaultValue { get; set; }
		 

		/// <summary>
		/// The volume of notes, from 0 to 1.
		/// </summary>
		public PlotOptionsWilliamsrSonificationDefaultInstrumentOptionsMappingVolume Volume { get; set; }
		private PlotOptionsWilliamsrSonificationDefaultInstrumentOptionsMappingVolume Volume_DefaultValue { get; set; }
