...
{
	public partial class PlotOptionsWilliamsrSonificationDefaultSpeechOptionsMappingTime  : BaseObject
	{
		Hashtable h = new Hashtable();

		public PlotOptionsWilliamsrSonificationDefaultSpeechOptionsMappingTime()
		{
			MapFunction = MapFunction_DefaultValue = PlotOptionsWilliamsrSonificationDefaultSpeechOptionsMappingTimeMapFunction.Linear;
			MapTo = MapTo_DefaultValue = "";
			Max = Max_DefaultValue = null;
			Min = Min_DefaultValue = null;
			Value = Value_DefaultValue = null;
			Within = Within_DefaultValue = PlotOptionsWilliamsrSonificationDefaultSpeechOptionsMappingTimeWithin.Chart;
		...
		/// </summary>
		public PlotOptionsWilliamsrSonificationDefaultSpeechOptionsMappingTimeMapFunction MapFunction { get; set; }
		private PlotOptionsWilliamsrSonificationDefaultSpeechOptionsMappingTimeMapFunction MapFunction_DefaultValue { get; set; }
		...
		/// </summary>
		public PlotOptionsWilliamsrSonificationDefaultSpeechOptionsMappingTimeWithin Within { get; set; }
		private PlotOptionsWilliamsrSonificationDefaultSpeechOptionsMappingTimeWithin Within_DefaultValue { get; set; }
