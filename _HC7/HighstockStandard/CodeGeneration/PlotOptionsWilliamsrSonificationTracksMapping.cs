...
{
	public partial class PlotOptionsWilliamsrSonificationTracksMapping  : BaseObject
	{
		Hashtable h = new Hashtable();

		public PlotOptionsWilliamsrSonificationTracksMapping()
		{
			Frequency = Frequency_DefaultValue = new PlotOptionsWilliamsrSonificationTracksMappingFrequency();
			GapBetweenNotes = GapBetweenNotes_DefaultValue = new PlotOptionsWilliamsrSonificationTracksMappingGapBetweenNotes();
			Highpass = Highpass_DefaultValue = new PlotOptionsWilliamsrSonificationTracksMappingHighpass();
			Lowpass = Lowpass_DefaultValue = new PlotOptionsWilliamsrSonificationTracksMappingLowpass();
			NoteDuration = NoteDuration_DefaultValue = new PlotOptionsWilliamsrSonificationTracksMappingNoteDuration();
			Pan = Pan_DefaultValue = new PlotOptionsWilliamsrSonificationTracksMappingPan();
			Pitch = Pitch_DefaultValue = new PlotOptionsWilliamsrSonificationTracksMappingPitch();
			PitchString = PitchString_DefaultValue = "null";
			PitchNumber = PitchNumber_DefaultValue = null;
			PlayDelay = PlayDelay_DefaultValue = new PlotOptionsWilliamsrSonificationTracksMappingPlayDelay();
			Time = Time_DefaultValue = new PlotOptionsWilliamsrSonificationTracksMappingTime();
			TimeString = TimeString_DefaultValue = "null";
			TimeNumber = TimeNumber_DefaultValue = null;
			Tremolo = Tremolo_DefaultValue = new PlotOptionsWilliamsrSonificationTracksMappingTremolo();
			Volume = Volume_DefaultValue = new PlotOptionsWilliamsrSonificationTracksMappingVolume();
		...
		/// </summary>
		public PlotOptionsWilliamsrSonificationTracksMappingFrequency Frequency { get; set; }
		private PlotOptionsWilliamsrSonificationTracksMappingFrequency Frequency_DefaultValue { get; set; }
		...
		/// </summary>
		public PlotOptionsWilliamsrSonificationTracksMappingGapBetweenNotes GapBetweenNotes { get; set; }
		private PlotOptionsWilliamsrSonificationTracksMappingGapBetweenNotes GapBetweenNotes_DefaultValue { get; set; }
		...
		/// </summary>
		public PlotOptionsWilliamsrSonificationTracksMappingHighpass Highpass { get; set; }
		private PlotOptionsWilliamsrSonificationTracksMappingHighpass Highpass_DefaultValue { get; set; }
		...
		/// </summary>
		public PlotOptionsWilliamsrSonificationTracksMappingLowpass Lowpass { get; set; }
		private PlotOptionsWilliamsrSonificationTracksMappingLowpass Lowpass_DefaultValue { get; set; }
		...
		/// </summary>
		public PlotOptionsWilliamsrSonificationTracksMappingNoteDuration NoteDuration { get; set; }
		private PlotOptionsWilliamsrSonificationTracksMappingNoteDuration NoteDuration_DefaultValue { get; set; }
		...
		/// </summary>
		public PlotOptionsWilliamsrSonificationTracksMappingPan Pan { get; set; }
		private PlotOptionsWilliamsrSonificationTracksMappingPan Pan_DefaultValue { get; set; }
		...
		/// </summary>
		public PlotOptionsWilliamsrSonificationTracksMappingPitch Pitch { get; set; }
		private PlotOptionsWilliamsrSonificationTracksMappingPitch Pitch_DefaultValue { get; set; }
		...
		/// </summary>
		public PlotOptionsWilliamsrSonificationTracksMappingPlayDelay PlayDelay { get; set; }
		private PlotOptionsWilliamsrSonificationTracksMappingPlayDelay PlayDelay_DefaultValue { get; set; }
		...
		/// </summary>
		public PlotOptionsWilliamsrSonificationTracksMappingTime Time { get; set; }
		private PlotOptionsWilliamsrSonificationTracksMappingTime Time_DefaultValue { get; set; }
		...
		/// </summary>
		public PlotOptionsWilliamsrSonificationTracksMappingTremolo Tremolo { get; set; }
		private PlotOptionsWilliamsrSonificationTracksMappingTremolo Tremolo_DefaultValue { get; set; }
		 

		/// <summary>
		/// The volume of notes, from 0 to 1.
		/// </summary>
		public PlotOptionsWilliamsrSonificationTracksMappingVolume Volume { get; set; }
		private PlotOptionsWilliamsrSonificationTracksMappingVolume Volume_DefaultValue { get; set; }
