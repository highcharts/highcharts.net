...
{
	public partial class PlotOptionsWilliamsrSonificationTracksMappingNoteDuration  : BaseObject
	{
		Hashtable h = new Hashtable();

		public PlotOptionsWilliamsrSonificationTracksMappingNoteDuration()
		{
			MapFunction = MapFunction_DefaultValue = PlotOptionsWilliamsrSonificationTracksMappingNoteDurationMapFunction.Linear;
			MapTo = MapTo_DefaultValue = "";
			Max = Max_DefaultValue = null;
			Min = Min_DefaultValue = null;
			Value = Value_DefaultValue = null;
			Within = Within_DefaultValue = PlotOptionsWilliamsrSonificationTracksMappingNoteDurationWithin.Chart;
		...
		/// </summary>
		public PlotOptionsWilliamsrSonificationTracksMappingNoteDurationMapFunction MapFunction { get; set; }
		private PlotOptionsWilliamsrSonificationTracksMappingNoteDurationMapFunction MapFunction_DefaultValue { get; set; }
		...
		/// </summary>
		public PlotOptionsWilliamsrSonificationTracksMappingNoteDurationWithin Within { get; set; }
		private PlotOptionsWilliamsrSonificationTracksMappingNoteDurationWithin Within_DefaultValue { get; set; }
