...
{
	public partial class PlotOptionsWilliamsrSonificationTracksMappingPan  : BaseObject
	{
		Hashtable h = new Hashtable();

		public PlotOptionsWilliamsrSonificationTracksMappingPan()
		{
			MapFunction = MapFunction_DefaultValue = PlotOptionsWilliamsrSonificationTracksMappingPanMapFunction.Linear;
			MapTo = MapTo_DefaultValue = "";
			Max = Max_DefaultValue = null;
			Min = Min_DefaultValue = null;
			Value = Value_DefaultValue = null;
			Within = Within_DefaultValue = PlotOptionsWilliamsrSonificationTracksMappingPanWithin.Chart;
		...
		/// </summary>
		public PlotOptionsWilliamsrSonificationTracksMappingPanMapFunction MapFunction { get; set; }
		private PlotOptionsWilliamsrSonificationTracksMappingPanMapFunction MapFunction_DefaultValue { get; set; }
		...
		/// </summary>
		public PlotOptionsWilliamsrSonificationTracksMappingPanWithin Within { get; set; }
		private PlotOptionsWilliamsrSonificationTracksMappingPanWithin Within_DefaultValue { get; set; }
