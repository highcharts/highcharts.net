...
{
	public partial class PlotOptionsWilliamsrSonificationTracksMappingPitch  : BaseObject
	{
		Hashtable h = new Hashtable();

		public PlotOptionsWilliamsrSonificationTracksMappingPitch()
		{
			MapFunction = MapFunction_DefaultValue = PlotOptionsWilliamsrSonificationTracksMappingPitchMapFunction.Linear;
		...
		/// </summary>
		public PlotOptionsWilliamsrSonificationTracksMappingPitchMapFunction MapFunction { get; set; }
		private PlotOptionsWilliamsrSonificationTracksMappingPitchMapFunction MapFunction_DefaultValue { get; set; }
