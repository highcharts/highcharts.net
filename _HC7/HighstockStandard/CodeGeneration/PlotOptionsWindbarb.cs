...
namespace Highsoft.Web.Mvc.Stocks
{
	public partial class PlotOptionsWindbarb  : BaseObject
	{
		...
		public PlotOptionsWindbarb()
		{
			...
			Compare = Compare_DefaultValue = PlotOptionsWindbarbCompare.Percent;
			...
			LegendSymbol = LegendSymbol_DefaultValue = PlotOptionsWindbarbLegendSymbol.Rectangle;
			...
			Sonification = Sonification_DefaultValue = new PlotOptionsWindbarbSonification();
			...
			Zones = Zones_DefaultValue = new List<PlotOptionsWindbarbZones>();
