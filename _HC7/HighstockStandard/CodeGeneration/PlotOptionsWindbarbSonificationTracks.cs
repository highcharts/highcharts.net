...
{
	public partial class PlotOptionsWindbarbSonificationTracks  : BaseObject
	{
		Hashtable h = new Hashtable();

		public PlotOptionsWindbarbSonificationTracks()
		{
			ActiveWhen = ActiveWhen_DefaultValue = new PlotOptionsWindbarbSonificationTracksActiveWhen();
			Instrument = Instrument_DefaultValue = null;
			InstrumentString = InstrumentString_DefaultValue = "null";
			Mapping = Mapping_DefaultValue = new PlotOptionsWindbarbSonificationTracksMapping();
			MidiName = MidiName_DefaultValue = "";
			PointGrouping = PointGrouping_DefaultValue = new PlotOptionsWindbarbSonificationTracksPointGrouping();
			RoundToMusicalNotes = RoundToMusicalNotes_DefaultValue = true;
			ShowPlayMarker = ShowPlayMarker_DefaultValue = true;
			Type = Type_DefaultValue = PlotOptionsWindbarbSonificationTracksType.Instrument;
		...
		/// </summary>
		public PlotOptionsWindbarbSonificationTracksActiveWhen ActiveWhen { get; set; }
		private PlotOptionsWindbarbSonificationTracksActiveWhen ActiveWhen_DefaultValue { get; set; }
		...
		/// </summary>
		public PlotOptionsWindbarbSonificationTracksMapping Mapping { get; set; }
		private PlotOptionsWindbarbSonificationTracksMapping Mapping_DefaultValue { get; set; }
		...
		/// </summary>
		public PlotOptionsWindbarbSonificationTracksPointGrouping PointGrouping { get; set; }
		private PlotOptionsWindbarbSonificationTracksPointGrouping PointGrouping_DefaultValue { get; set; }
		...
		/// </summary>
		public PlotOptionsWindbarbSonificationTracksType Type { get; set; }
		private PlotOptionsWindbarbSonificationTracksType Type_DefaultValue { get; set; }
