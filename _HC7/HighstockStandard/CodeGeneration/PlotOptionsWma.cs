...
{
	public partial class PlotOptionsWma  : BaseObject
	{
		Hashtable h = new Hashtable();

		public PlotOptionsWma()
		{
			Accessibility = Accessibility_DefaultValue = new PlotOptionsWmaAccessibility();
			AllowPointSelect = AllowPointSelect_DefaultValue = false;
			Animation = Animation_DefaultValue = new Animation() { Enabled = true };
			AnimationBool = AnimationBool_DefaultValue = true;
			AnimationLimit = AnimationLimit_DefaultValue = null;
			BoostBlending = BoostBlending_DefaultValue = PlotOptionsWmaBoostBlending.Undefined;
			...
			Compare = Compare_DefaultValue = PlotOptionsWmaCompare.Percent;
			CompareBase = CompareBase_DefaultValue = PlotOptionsWmaCompareBase.Min;
			...
			Cursor = Cursor_DefaultValue = PlotOptionsWmaCursor.Null;
			Custom = Custom_DefaultValue = new Hashtable();
			DashStyle = DashStyle_DefaultValue = PlotOptionsWmaDashStyle.Null;
			DataGrouping = DataGrouping_DefaultValue = new PlotOptionsWmaDataGrouping();
			DataLabels = DataLabels_DefaultValue = new PlotOptionsWmaDataLabels();
			DataSorting = DataSorting_DefaultValue = new PlotOptionsWmaDataSorting();
			Description = Description_DefaultValue = "";
			EnableMouseTracking = EnableMouseTracking_DefaultValue = true;
			Events = Events_DefaultValue = new PlotOptionsWmaEvents();
			FindNearestPointBy = FindNearestPointBy_DefaultValue = PlotOptionsWmaFindNearestPointBy.X;
			GapSize = GapSize_DefaultValue = 0;
			GapUnit = GapUnit_DefaultValue = PlotOptionsWmaGapUnit.Relative;
			GetExtremesFromAll = GetExtremesFromAll_DefaultValue = false;
			InactiveOtherPoints = InactiveOtherPoints_DefaultValue = false;
			IncludeInDataExport = IncludeInDataExport_DefaultValue = null;
			Label = Label_DefaultValue = new PlotOptionsWmaLabel();
			LastPrice = LastPrice_DefaultValue = new PlotOptionsWmaLastPrice();
			LastVisiblePrice = LastVisiblePrice_DefaultValue = new PlotOptionsWmaLastVisiblePrice();
			LegendSymbol = LegendSymbol_DefaultValue = PlotOptionsWmaLegendSymbol.Rectangle;
			Linecap = Linecap_DefaultValue = PlotOptionsWmaLinecap.Round;
			LineWidth = LineWidth_DefaultValue = 2;
			LinkedTo = LinkedTo_DefaultValue = "";
			Marker = Marker_DefaultValue = new PlotOptionsWmaMarker();
			NegativeColor = NegativeColor_DefaultValue = "";
			OnPoint = OnPoint_DefaultValue = new PlotOptionsWmaOnPoint();
			Opacity = Opacity_DefaultValue = 1;
			Params = Params_DefaultValue = new PlotOptionsWmaParams();
			Point = Point_DefaultValue = new PlotOptionsWmaPoint();
			...
			Sonification = Sonification_DefaultValue = new PlotOptionsWmaSonification();
			States = States_DefaultValue = new PlotOptionsWmaStates();
			Step = Step_DefaultValue = PlotOptionsWmaStep.Null;
			StickyTracking = StickyTracking_DefaultValue = true;
			Threshold = Threshold_DefaultValue = 0;
			Tooltip = Tooltip_DefaultValue = new PlotOptionsWmaTooltip();
			TurboThreshold = TurboThreshold_DefaultValue = 1000;
			Visible = Visible_DefaultValue = true;
			ZoneAxis = ZoneAxis_DefaultValue = "y";
			Zones = Zones_DefaultValue = new List<PlotOptionsWmaZones>();
		...
		/// </summary>
		public PlotOptionsWmaAccessibility Accessibility { get; set; }
		private PlotOptionsWmaAccessibility Accessibility_DefaultValue { get; set; }
		...
		/// </summary>
		public PlotOptionsWmaBoostBlending BoostBlending { get; set; }
		private PlotOptionsWmaBoostBlending BoostBlending_DefaultValue { get; set; }
		...
		/// </summary>
		public PlotOptionsWmaCompare Compare { get; set; }
		private PlotOptionsWmaCompare Compare_DefaultValue { get; set; }
		 

		/// <summary>
		/// When [compare](#plotOptions.series.compare) is `percent`, this optiondictates whether to use 0 or 100 as the base of comparison.
		/// </summary>
		public PlotOptionsWmaCompareBase CompareBase { get; set; }
		private PlotOptionsWmaCompareBase CompareBase_DefaultValue { get; set; }
		...
		/// </summary>
		public PlotOptionsWmaCursor Cursor { get; set; }
		private PlotOptionsWmaCursor Cursor_DefaultValue { get; set; }
		...
		/// </summary>
		public PlotOptionsWmaDashStyle DashStyle { get; set; }
		private PlotOptionsWmaDashStyle DashStyle_DefaultValue { get; set; }
		...
		/// </summary>
		public PlotOptionsWmaDataGrouping DataGrouping { get; set; }
		private PlotOptionsWmaDataGrouping DataGrouping_DefaultValue { get; set; }
		...
		/// </summary>
		public PlotOptionsWmaDataLabels DataLabels { get; set; }
		private PlotOptionsWmaDataLabels DataLabels_DefaultValue { get; set; }
		 

		/// <summary>
		/// Options for the series data sorting.
		/// </summary>
		public PlotOptionsWmaDataSorting DataSorting { get; set; }
		private PlotOptionsWmaDataSorting DataSorting_DefaultValue { get; set; }
		...
		/// </summary>
		public PlotOptionsWmaEvents Events { get; set; }
		private PlotOptionsWmaEvents Events_DefaultValue { get; set; }
		...
		/// </summary>
		public PlotOptionsWmaFindNearestPointBy FindNearestPointBy { get; set; }
		private PlotOptionsWmaFindNearestPointBy FindNearestPointBy_DefaultValue { get; set; }
		...
		/// </summary>
		public PlotOptionsWmaGapUnit GapUnit { get; set; }
		private PlotOptionsWmaGapUnit GapUnit_DefaultValue { get; set; }
		...
		/// </summary>
		public PlotOptionsWmaLabel Label { get; set; }
		private PlotOptionsWmaLabel Label_DefaultValue { get; set; }
		 

		/// <summary>
		/// The line marks the last price from all points.
		/// </summary>
		public PlotOptionsWmaLastPrice LastPrice { get; set; }
		private PlotOptionsWmaLastPrice LastPrice_DefaultValue { get; set; }
		 

		/// <summary>
		/// The line marks the last price from visible range of points.
		/// </summary>
		public PlotOptionsWmaLastVisiblePrice LastVisiblePrice { get; set; }
		private PlotOptionsWmaLastVisiblePrice LastVisiblePrice_DefaultValue { get; set; }
		 

		/// <summary>
		/// What type of legend symbol to render for this series. Can be one of`areaMarker`, `lineMarker` or `rectangle`.
		/// </summary>
		public PlotOptionsWmaLegendSymbol LegendSymbol { get; set; }
		private PlotOptionsWmaLegendSymbol LegendSymbol_DefaultValue { get; set; }
		 

		/// <summary>
		/// The line cap used for line ends and line joins on the graph.
		/// </summary>
		public PlotOptionsWmaLinecap Linecap { get; set; }
		private PlotOptionsWmaLinecap Linecap_DefaultValue { get; set; }
		...
		/// </summary>
		public PlotOptionsWmaMarker Marker { get; set; }
		private PlotOptionsWmaMarker Marker_DefaultValue { get; set; }
		...
		/// </summary>
		public PlotOptionsWmaOnPoint OnPoint { get; set; }
		private PlotOptionsWmaOnPoint OnPoint_DefaultValue { get; set; }
		...
		/// 
		/// </summary>
		public PlotOptionsWmaParams Params { get; set; }
		private PlotOptionsWmaParams Params_DefaultValue { get; set; }
		 

		/// <summary>
		/// Properties for each single point.
		/// </summary>
		public PlotOptionsWmaPoint Point { get; set; }
		private PlotOptionsWmaPoint Point_DefaultValue { get; set; }
		...
		/// </summary>
		public PlotOptionsWmaSonification Sonification { get; set; }
		private PlotOptionsWmaSonification Sonification_DefaultValue { get; set; }
		 

		/// <summary>
		/// 
		/// </summary>
		public PlotOptionsWmaStates States { get; set; }
		private PlotOptionsWmaStates States_DefaultValue { get; set; }
		 

		/// <summary>
		/// Whether to apply steps to the line. Possible values are `left`,`center` and `right`.
		/// </summary>
		public PlotOptionsWmaStep Step { get; set; }
		private PlotOptionsWmaStep Step_DefaultValue { get; set; }
		...
		/// </summary>
		public PlotOptionsWmaTooltip Tooltip { get; set; }
		private PlotOptionsWmaTooltip Tooltip_DefaultValue { get; set; }
		...
		/// </summary>
		public List<PlotOptionsWmaZones> Zones { get; set; }
		private List<PlotOptionsWmaZones> Zones_DefaultValue { get; set; }
