...
namespace Highsoft.Web.Mvc.Stocks
{
	public partial class PlotOptionsWma  : BaseObject
	{
		...
		public PlotOptionsWma()
		{
			...
			Zones = Zones_DefaultValue = new List<PlotOptionsWmaZone>();
		...
		/// </summary>
		public List<PlotOptionsWmaZone> Zones { get; set; }
		private List<PlotOptionsWmaZone> Zones_DefaultValue { get; set; }
