...
{
	public partial class PlotOptionsWmaOnPoint  : BaseObject
	{
		Hashtable h = new Hashtable();

		public PlotOptionsWmaOnPoint()
		{
			ConnectorOptions = ConnectorOptions_DefaultValue = new PlotOptionsWmaOnPointConnectorOptions();
			Id = Id_DefaultValue = "";
			Position = Position_DefaultValue = new PlotOptionsWmaOnPointPosition();
		...
		/// </summary>
		public PlotOptionsWmaOnPointConnectorOptions ConnectorOptions { get; set; }
		private PlotOptionsWmaOnPointConnectorOptions ConnectorOptions_DefaultValue { get; set; }
		...
		/// </summary>
		public PlotOptionsWmaOnPointPosition Position { get; set; }
		private PlotOptionsWmaOnPointPosition Position_DefaultValue { get; set; }
