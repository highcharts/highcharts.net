...
{
	public partial class PlotOptionsWmaSonificationContextTracksMapping  : BaseObject
	{
		Hashtable h = new Hashtable();

		public PlotOptionsWmaSonificationContextTracksMapping()
		{
			Frequency = Frequency_DefaultValue = new PlotOptionsWmaSonificationContextTracksMappingFrequency();
			GapBetweenNotes = GapBetweenNotes_DefaultValue = new PlotOptionsWmaSonificationContextTracksMappingGapBetweenNotes();
			Highpass = Highpass_DefaultValue = new PlotOptionsWmaSonificationContextTracksMappingHighpass();
			Lowpass = Lowpass_DefaultValue = new PlotOptionsWmaSonificationContextTracksMappingLowpass();
			NoteDuration = NoteDuration_DefaultValue = new PlotOptionsWmaSonificationContextTracksMappingNoteDuration();
			Pan = Pan_DefaultValue = new PlotOptionsWmaSonificationContextTracksMappingPan();
			Pitch = Pitch_DefaultValue = new PlotOptionsWmaSonificationContextTracksMappingPitch();
			PitchString = PitchString_DefaultValue = "null";
			PitchNumber = PitchNumber_DefaultValue = null;
			PlayDelay = PlayDelay_DefaultValue = new PlotOptionsWmaSonificationContextTracksMappingPlayDelay();
			Time = Time_DefaultValue = new PlotOptionsWmaSonificationContextTracksMappingTime();
			TimeString = TimeString_DefaultValue = "null";
			TimeNumber = TimeNumber_DefaultValue = null;
			Tremolo = Tremolo_DefaultValue = new PlotOptionsWmaSonificationContextTracksMappingTremolo();
			Volume = Volume_DefaultValue = new PlotOptionsWmaSonificationContextTracksMappingVolume();
		...
		/// </summary>
		public PlotOptionsWmaSonificationContextTracksMappingFrequency Frequency { get; set; }
		private PlotOptionsWmaSonificationContextTracksMappingFrequency Frequency_DefaultValue { get; set; }
		...
		/// </summary>
		public PlotOptionsWmaSonificationContextTracksMappingGapBetweenNotes GapBetweenNotes { get; set; }
		private PlotOptionsWmaSonificationContextTracksMappingGapBetweenNotes GapBetweenNotes_DefaultValue { get; set; }
		...
		/// </summary>
		public PlotOptionsWmaSonificationContextTracksMappingHighpass Highpass { get; set; }
		private PlotOptionsWmaSonificationContextTracksMappingHighpass Highpass_DefaultValue { get; set; }
		...
		/// </summary>
		public PlotOptionsWmaSonificationContextTracksMappingLowpass Lowpass { get; set; }
		private PlotOptionsWmaSonificationContextTracksMappingLowpass Lowpass_DefaultValue { get; set; }
		...
		/// </summary>
		public PlotOptionsWmaSonificationContextTracksMappingNoteDuration NoteDuration { get; set; }
		private PlotOptionsWmaSonificationContextTracksMappingNoteDuration NoteDuration_DefaultValue { get; set; }
		...
		/// </summary>
		public PlotOptionsWmaSonificationContextTracksMappingPan Pan { get; set; }
		private PlotOptionsWmaSonificationContextTracksMappingPan Pan_DefaultValue { get; set; }
		...
		/// </summary>
		public PlotOptionsWmaSonificationContextTracksMappingPitch Pitch { get; set; }
		private PlotOptionsWmaSonificationContextTracksMappingPitch Pitch_DefaultValue { get; set; }
		...
		/// </summary>
		public PlotOptionsWmaSonificationContextTracksMappingPlayDelay PlayDelay { get; set; }
		private PlotOptionsWmaSonificationContextTracksMappingPlayDelay PlayDelay_DefaultValue { get; set; }
		...
		/// </summary>
		public PlotOptionsWmaSonificationContextTracksMappingTime Time { get; set; }
		private PlotOptionsWmaSonificationContextTracksMappingTime Time_DefaultValue { get; set; }
		...
		/// </summary>
		public PlotOptionsWmaSonificationContextTracksMappingTremolo Tremolo { get; set; }
		private PlotOptionsWmaSonificationContextTracksMappingTremolo Tremolo_DefaultValue { get; set; }
		 

		/// <summary>
		/// The volume of notes, from 0 to 1.
		/// </summary>
		public PlotOptionsWmaSonificationContextTracksMappingVolume Volume { get; set; }
		private PlotOptionsWmaSonificationContextTracksMappingVolume Volume_DefaultValue { get; set; }
