...
{
	public partial class PlotOptionsWmaSonificationContextTracksMappingPan  : BaseObject
	{
		Hashtable h = new Hashtable();

		public PlotOptionsWmaSonificationContextTracksMappingPan()
		{
			MapFunction = MapFunction_DefaultValue = PlotOptionsWmaSonificationContextTracksMappingPanMapFunction.Linear;
			MapTo = MapTo_DefaultValue = "";
			Max = Max_DefaultValue = null;
			Min = Min_DefaultValue = null;
			Value = Value_DefaultValue = null;
			Within = Within_DefaultValue = PlotOptionsWmaSonificationContextTracksMappingPanWithin.Chart;
		...
		/// </summary>
		public PlotOptionsWmaSonificationContextTracksMappingPanMapFunction MapFunction { get; set; }
		private PlotOptionsWmaSonificationContextTracksMappingPanMapFunction MapFunction_DefaultValue { get; set; }
		...
		/// </summary>
		public PlotOptionsWmaSonificationContextTracksMappingPanWithin Within { get; set; }
		private PlotOptionsWmaSonificationContextTracksMappingPanWithin Within_DefaultValue { get; set; }
