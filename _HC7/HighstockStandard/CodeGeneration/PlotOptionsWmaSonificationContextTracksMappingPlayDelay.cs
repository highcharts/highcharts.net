...
{
	public partial class PlotOptionsWmaSonificationContextTracksMappingPlayDelay  : BaseObject
	{
		Hashtable h = new Hashtable();

		public PlotOptionsWmaSonificationContextTracksMappingPlayDelay()
		{
			MapFunction = MapFunction_DefaultValue = PlotOptionsWmaSonificationContextTracksMappingPlayDelayMapFunction.Linear;
			MapTo = MapTo_DefaultValue = "";
			Max = Max_DefaultValue = null;
			Min = Min_DefaultValue = null;
			Value = Value_DefaultValue = null;
			Within = Within_DefaultValue = PlotOptionsWmaSonificationContextTracksMappingPlayDelayWithin.Chart;
		...
		/// </summary>
		public PlotOptionsWmaSonificationContextTracksMappingPlayDelayMapFunction MapFunction { get; set; }
		private PlotOptionsWmaSonificationContextTracksMappingPlayDelayMapFunction MapFunction_DefaultValue { get; set; }
		...
		/// </summary>
		public PlotOptionsWmaSonificationContextTracksMappingPlayDelayWithin Within { get; set; }
		private PlotOptionsWmaSonificationContextTracksMappingPlayDelayWithin Within_DefaultValue { get; set; }
