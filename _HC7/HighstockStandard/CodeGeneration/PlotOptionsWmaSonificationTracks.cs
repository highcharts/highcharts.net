...
{
	public partial class PlotOptionsWmaSonificationTracks  : BaseObject
	{
		Hashtable h = new Hashtable();

		public PlotOptionsWmaSonificationTracks()
		{
			ActiveWhen = ActiveWhen_DefaultValue = new PlotOptionsWmaSonificationTracksActiveWhen();
			Instrument = Instrument_DefaultValue = null;
			InstrumentString = InstrumentString_DefaultValue = "null";
			Mapping = Mapping_DefaultValue = new PlotOptionsWmaSonificationTracksMapping();
			MidiName = MidiName_DefaultValue = "";
			PointGrouping = PointGrouping_DefaultValue = new PlotOptionsWmaSonificationTracksPointGrouping();
			RoundToMusicalNotes = RoundToMusicalNotes_DefaultValue = true;
			ShowPlayMarker = ShowPlayMarker_DefaultValue = true;
			Type = Type_DefaultValue = PlotOptionsWmaSonificationTracksType.Instrument;
		...
		/// </summary>
		public PlotOptionsWmaSonificationTracksActiveWhen ActiveWhen { get; set; }
		private PlotOptionsWmaSonificationTracksActiveWhen ActiveWhen_DefaultValue { get; set; }
		...
		/// </summary>
		public PlotOptionsWmaSonificationTracksMapping Mapping { get; set; }
		private PlotOptionsWmaSonificationTracksMapping Mapping_DefaultValue { get; set; }
		...
		/// </summary>
		public PlotOptionsWmaSonificationTracksPointGrouping PointGrouping { get; set; }
		private PlotOptionsWmaSonificationTracksPointGrouping PointGrouping_DefaultValue { get; set; }
		...
		/// </summary>
		public PlotOptionsWmaSonificationTracksType Type { get; set; }
		private PlotOptionsWmaSonificationTracksType Type_DefaultValue { get; set; }
