...
{
	public partial class PlotOptionsWmaSonificationTracksMappingFrequency  : BaseObject
	{
		Hashtable h = new Hashtable();

		public PlotOptionsWmaSonificationTracksMappingFrequency()
		{
			MapFunction = MapFunction_DefaultValue = PlotOptionsWmaSonificationTracksMappingFrequencyMapFunction.Linear;
			MapTo = MapTo_DefaultValue = "";
			Max = Max_DefaultValue = null;
			Min = Min_DefaultValue = null;
			Value = Value_DefaultValue = null;
			Within = Within_DefaultValue = PlotOptionsWmaSonificationTracksMappingFrequencyWithin.Chart;
		...
		/// </summary>
		public PlotOptionsWmaSonificationTracksMappingFrequencyMapFunction MapFunction { get; set; }
		private PlotOptionsWmaSonificationTracksMappingFrequencyMapFunction MapFunction_DefaultValue { get; set; }
		...
		/// </summary>
		public PlotOptionsWmaSonificationTracksMappingFrequencyWithin Within { get; set; }
		private PlotOptionsWmaSonificationTracksMappingFrequencyWithin Within_DefaultValue { get; set; }
