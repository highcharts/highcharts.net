...
{
	public partial class PlotOptionsWmaSonificationTracksMappingPan  : BaseObject
	{
		Hashtable h = new Hashtable();

		public PlotOptionsWmaSonificationTracksMappingPan()
		{
			MapFunction = MapFunction_DefaultValue = PlotOptionsWmaSonificationTracksMappingPanMapFunction.Linear;
			MapTo = MapTo_DefaultValue = "";
			Max = Max_DefaultValue = null;
			Min = Min_DefaultValue = null;
			Value = Value_DefaultValue = null;
			Within = Within_DefaultValue = PlotOptionsWmaSonificationTracksMappingPanWithin.Chart;
		...
		/// </summary>
		public PlotOptionsWmaSonificationTracksMappingPanMapFunction MapFunction { get; set; }
		private PlotOptionsWmaSonificationTracksMappingPanMapFunction MapFunction_DefaultValue { get; set; }
		...
		/// </summary>
		public PlotOptionsWmaSonificationTracksMappingPanWithin Within { get; set; }
		private PlotOptionsWmaSonificationTracksMappingPanWithin Within_DefaultValue { get; set; }
