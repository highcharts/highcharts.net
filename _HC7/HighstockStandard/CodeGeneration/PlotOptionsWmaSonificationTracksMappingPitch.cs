...
{
	public partial class PlotOptionsWmaSonificationTracksMappingPitch  : BaseObject
	{
		Hashtable h = new Hashtable();

		public PlotOptionsWmaSonificationTracksMappingPitch()
		{
			MapFunction = MapFunction_DefaultValue = PlotOptionsWmaSonificationTracksMappingPitchMapFunction.Linear;
		...
		/// </summary>
		public PlotOptionsWmaSonificationTracksMappingPitchMapFunction MapFunction { get; set; }
		private PlotOptionsWmaSonificationTracksMappingPitchMapFunction MapFunction_DefaultValue { get; set; }
