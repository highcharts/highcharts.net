...
{
	public partial class PlotOptionsWmaSonificationTracksMappingTime  : BaseObject
	{
		Hashtable h = new Hashtable();

		public PlotOptionsWmaSonificationTracksMappingTime()
		{
			MapFunction = MapFunction_DefaultValue = PlotOptionsWmaSonificationTracksMappingTimeMapFunction.Linear;
			MapTo = MapTo_DefaultValue = "";
			Max = Max_DefaultValue = null;
			Min = Min_DefaultValue = null;
			Value = Value_DefaultValue = null;
			Within = Within_DefaultValue = PlotOptionsWmaSonificationTracksMappingTimeWithin.Chart;
		...
		/// </summary>
		public PlotOptionsWmaSonificationTracksMappingTimeMapFunction MapFunction { get; set; }
		private PlotOptionsWmaSonificationTracksMappingTimeMapFunction MapFunction_DefaultValue { get; set; }
		...
		/// </summary>
		public PlotOptionsWmaSonificationTracksMappingTimeWithin Within { get; set; }
		private PlotOptionsWmaSonificationTracksMappingTimeWithin Within_DefaultValue { get; set; }
