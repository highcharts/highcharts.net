...
{
	public partial class PlotOptionsWmaSonificationTracksPointGrouping  : BaseObject
	{
		Hashtable h = new Hashtable();

		public PlotOptionsWmaSonificationTracksPointGrouping()
		{
			Algorithm = Algorithm_DefaultValue = PlotOptionsWmaSonificationTracksPointGroupingAlgorithm.Minimax;
		...
		/// </summary>
		public PlotOptionsWmaSonificationTracksPointGroupingAlgorithm Algorithm { get; set; }
		private PlotOptionsWmaSonificationTracksPointGroupingAlgorithm Algorithm_DefaultValue { get; set; }
