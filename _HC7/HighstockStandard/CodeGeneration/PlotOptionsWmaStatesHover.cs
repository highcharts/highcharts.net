...
{
	public partial class PlotOptionsWmaStatesHover  : BaseObject
	{
		public PlotOptionsWmaStatesHover()
		{
			Animation = Animation_DefaultValue = new Animation() { Enabled = true };
			AnimationBool = AnimationBool_DefaultValue = null;
			Enabled = Enabled_DefaultValue = true;
			Halo = Halo_DefaultValue = new PlotOptionsWmaStatesHoverHalo();
			LineWidth = LineWidth_DefaultValue = null;
			LineWidthPlus = LineWidthPlus_DefaultValue = 1;
			Marker = Marker_DefaultValue = new PlotOptionsWmaStatesHoverMarker();
		...
		/// </summary>
		public PlotOptionsWmaStatesHoverHalo Halo { get; set; }
		private PlotOptionsWmaStatesHoverHalo Halo_DefaultValue { get; set; }
		...
		/// </summary>
		public PlotOptionsWmaStatesHoverMarker Marker { get; set; }
		private PlotOptionsWmaStatesHoverMarker Marker_DefaultValue { get; set; }
