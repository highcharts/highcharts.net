...
namespace Highsoft.Web.Mvc.Stocks
{
	public partial class PlotOptionsWmaStatesHoverMarkerStates  : BaseObject
	{
		public PlotOptionsWmaStatesHoverMarkerStates()
		{
			...
			Inactive = Inactive_DefaultValue = new PlotOptionsWmaStatesHoverMarkerStatesInactive();
		...
		/// 
		/// </summary>
		public PlotOptionsWmaStatesHoverMarkerStatesInactive Inactive { get; set; }
		private PlotOptionsWmaStatesHoverMarkerStatesInactive Inactive_DefaultValue { get; set; }
