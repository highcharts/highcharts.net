...
{
	public partial class PlotOptionsWmaTooltip  : BaseObject
	{
		public PlotOptionsWmaTooltip()
		{
			...
			HeaderShape = HeaderShape_DefaultValue = PlotOptionsWmaTooltipHeaderShape.Callout;
		...
		/// </summary>
		public PlotOptionsWmaTooltipHeaderShape HeaderShape { get; set; }
		private PlotOptionsWmaTooltipHeaderShape HeaderShape_DefaultValue { get; set; }
		...
		internal override Hashtable ToHashtable()
		{
			...
			if (NullFormatter != NullFormatter_DefaultValue) { h.Add("nullFormatter",NullFormatter); Highstock.AddFunction("PlotOptionsWmaTooltipNullFormatter.nullFormatter", NullFormatter); }  
			if (Outside != Outside_DefaultValue) h.Add("outside",Outside);
			if (Padding != Padding_DefaultValue) h.Add("padding",Padding);
			if (PointFormat != PointFormat_DefaultValue) h.Add("pointFormat",PointFormat);
			if (PointFormatter != PointFormatter_DefaultValue) { h.Add("pointFormatter",PointFormatter); Highstock.AddFunction("PlotOptionsWmaTooltipPointFormatter.pointFormatter", PointFormatter); }  
