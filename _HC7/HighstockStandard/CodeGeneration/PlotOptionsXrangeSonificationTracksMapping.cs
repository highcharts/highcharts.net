...
{
	public partial class PlotOptionsXrangeSonificationTracksMapping  : BaseObject
	{
		Hashtable h = new Hashtable();

		public PlotOptionsXrangeSonificationTracksMapping()
		{
			Frequency = Frequency_DefaultValue = new PlotOptionsXrangeSonificationTracksMappingFrequency();
			GapBetweenNotes = GapBetweenNotes_DefaultValue = new PlotOptionsXrangeSonificationTracksMappingGapBetweenNotes();
			Highpass = Highpass_DefaultValue = new PlotOptionsXrangeSonificationTracksMappingHighpass();
			Lowpass = Lowpass_DefaultValue = new PlotOptionsXrangeSonificationTracksMappingLowpass();
			NoteDuration = NoteDuration_DefaultValue = new PlotOptionsXrangeSonificationTracksMappingNoteDuration();
			Pan = Pan_DefaultValue = new PlotOptionsXrangeSonificationTracksMappingPan();
			Pitch = Pitch_DefaultValue = new PlotOptionsXrangeSonificationTracksMappingPitch();
			PitchString = PitchString_DefaultValue = "null";
			PitchNumber = PitchNumber_DefaultValue = null;
			PlayDelay = PlayDelay_DefaultValue = new PlotOptionsXrangeSonificationTracksMappingPlayDelay();
			Time = Time_DefaultValue = new PlotOptionsXrangeSonificationTracksMappingTime();
			TimeString = TimeString_DefaultValue = "null";
			TimeNumber = TimeNumber_DefaultValue = null;
			Tremolo = Tremolo_DefaultValue = new PlotOptionsXrangeSonificationTracksMappingTremolo();
			Volume = Volume_DefaultValue = new PlotOptionsXrangeSonificationTracksMappingVolume();
		...
		/// </summary>
		public PlotOptionsXrangeSonificationTracksMappingFrequency Frequency { get; set; }
		private PlotOptionsXrangeSonificationTracksMappingFrequency Frequency_DefaultValue { get; set; }
		...
		/// </summary>
		public PlotOptionsXrangeSonificationTracksMappingGapBetweenNotes GapBetweenNotes { get; set; }
		private PlotOptionsXrangeSonificationTracksMappingGapBetweenNotes GapBetweenNotes_DefaultValue { get; set; }
		...
		/// </summary>
		public PlotOptionsXrangeSonificationTracksMappingHighpass Highpass { get; set; }
		private PlotOptionsXrangeSonificationTracksMappingHighpass Highpass_DefaultValue { get; set; }
		...
		/// </summary>
		public PlotOptionsXrangeSonificationTracksMappingLowpass Lowpass { get; set; }
		private PlotOptionsXrangeSonificationTracksMappingLowpass Lowpass_DefaultValue { get; set; }
		...
		/// </summary>
		public PlotOptionsXrangeSonificationTracksMappingNoteDuration NoteDuration { get; set; }
		private PlotOptionsXrangeSonificationTracksMappingNoteDuration NoteDuration_DefaultValue { get; set; }
		...
		/// </summary>
		public PlotOptionsXrangeSonificationTracksMappingPan Pan { get; set; }
		private PlotOptionsXrangeSonificationTracksMappingPan Pan_DefaultValue { get; set; }
		...
		/// </summary>
		public PlotOptionsXrangeSonificationTracksMappingPitch Pitch { get; set; }
		private PlotOptionsXrangeSonificationTracksMappingPitch Pitch_DefaultValue { get; set; }
		...
		/// </summary>
		public PlotOptionsXrangeSonificationTracksMappingPlayDelay PlayDelay { get; set; }
		private PlotOptionsXrangeSonificationTracksMappingPlayDelay PlayDelay_DefaultValue { get; set; }
		...
		/// </summary>
		public PlotOptionsXrangeSonificationTracksMappingTime Time { get; set; }
		private PlotOptionsXrangeSonificationTracksMappingTime Time_DefaultValue { get; set; }
		...
		/// </summary>
		public PlotOptionsXrangeSonificationTracksMappingTremolo Tremolo { get; set; }
		private PlotOptionsXrangeSonificationTracksMappingTremolo Tremolo_DefaultValue { get; set; }
		 

		/// <summary>
		/// The volume of notes, from 0 to 1.
		/// </summary>
		public PlotOptionsXrangeSonificationTracksMappingVolume Volume { get; set; }
		private PlotOptionsXrangeSonificationTracksMappingVolume Volume_DefaultValue { get; set; }
