...
{
	public partial class PlotOptionsZigzag  : BaseObject
	{
		Hashtable h = new Hashtable();

		public PlotOptionsZigzag()
		{
			Accessibility = Accessibility_DefaultValue = new PlotOptionsZigzagAccessibility();
			AllowPointSelect = AllowPointSelect_DefaultValue = false;
			Animation = Animation_DefaultValue = new Animation() { Enabled = true };
			AnimationBool = AnimationBool_DefaultValue = true;
			AnimationLimit = AnimationLimit_DefaultValue = null;
			BoostBlending = BoostBlending_DefaultValue = PlotOptionsZigzagBoostBlending.Undefined;
			...
			Compare = Compare_DefaultValue = PlotOptionsZigzagCompare.Percent;
			CompareBase = CompareBase_DefaultValue = PlotOptionsZigzagCompareBase.Min;
			...
			Cursor = Cursor_DefaultValue = PlotOptionsZigzagCursor.Null;
			Custom = Custom_DefaultValue = new Hashtable();
			DashStyle = DashStyle_DefaultValue = PlotOptionsZigzagDashStyle.Null;
			DataGrouping = DataGrouping_DefaultValue = new PlotOptionsZigzagDataGrouping();
			DataLabels = DataLabels_DefaultValue = new PlotOptionsZigzagDataLabels();
			DataSorting = DataSorting_DefaultValue = new PlotOptionsZigzagDataSorting();
			Description = Description_DefaultValue = "";
			EnableMouseTracking = EnableMouseTracking_DefaultValue = true;
			Events = Events_DefaultValue = new PlotOptionsZigzagEvents();
			FindNearestPointBy = FindNearestPointBy_DefaultValue = PlotOptionsZigzagFindNearestPointBy.X;
			GapSize = GapSize_DefaultValue = 0;
			GapUnit = GapUnit_DefaultValue = PlotOptionsZigzagGapUnit.Relative;
			GetExtremesFromAll = GetExtremesFromAll_DefaultValue = false;
			IncludeInDataExport = IncludeInDataExport_DefaultValue = null;
			Label = Label_DefaultValue = new PlotOptionsZigzagLabel();
			LastPrice = LastPrice_DefaultValue = new PlotOptionsZigzagLastPrice();
			LastVisiblePrice = LastVisiblePrice_DefaultValue = new PlotOptionsZigzagLastVisiblePrice();
			LegendSymbol = LegendSymbol_DefaultValue = PlotOptionsZigzagLegendSymbol.Rectangle;
			Linecap = Linecap_DefaultValue = PlotOptionsZigzagLinecap.Round;
			LineWidth = LineWidth_DefaultValue = 1;
			LinkedTo = LinkedTo_DefaultValue = "";
			Marker = Marker_DefaultValue = new PlotOptionsZigzagMarker();
			NegativeColor = NegativeColor_DefaultValue = "";
			OnPoint = OnPoint_DefaultValue = new PlotOptionsZigzagOnPoint();
			Opacity = Opacity_DefaultValue = 1;
			Params = Params_DefaultValue = new PlotOptionsZigzagParams();
			Point = Point_DefaultValue = new PlotOptionsZigzagPoint();
			...
			Sonification = Sonification_DefaultValue = new PlotOptionsZigzagSonification();
			States = States_DefaultValue = new PlotOptionsZigzagStates();
			Step = Step_DefaultValue = PlotOptionsZigzagStep.Null;
			StickyTracking = StickyTracking_DefaultValue = true;
			Threshold = Threshold_DefaultValue = 0;
			Tooltip = Tooltip_DefaultValue = new PlotOptionsZigzagTooltip();
			TurboThreshold = TurboThreshold_DefaultValue = 1000;
			Visible = Visible_DefaultValue = true;
			ZoneAxis = ZoneAxis_DefaultValue = "y";
			Zones = Zones_DefaultValue = new List<PlotOptionsZigzagZones>();
		...
		/// </summary>
		public PlotOptionsZigzagAccessibility Accessibility { get; set; }
		private PlotOptionsZigzagAccessibility Accessibility_DefaultValue { get; set; }
		...
		/// </summary>
		public PlotOptionsZigzagBoostBlending BoostBlending { get; set; }
		private PlotOptionsZigzagBoostBlending BoostBlending_DefaultValue { get; set; }
		...
		/// </summary>
		public PlotOptionsZigzagCompare Compare { get; set; }
		private PlotOptionsZigzagCompare Compare_DefaultValue { get; set; }
		 

		/// <summary>
		/// When [compare](#plotOptions.series.compare) is `percent`, this optiondictates whether to use 0 or 100 as the base of comparison.
		/// </summary>
		public PlotOptionsZigzagCompareBase CompareBase { get; set; }
		private PlotOptionsZigzagCompareBase CompareBase_DefaultValue { get; set; }
		...
		/// </summary>
		public PlotOptionsZigzagCursor Cursor { get; set; }
		private PlotOptionsZigzagCursor Cursor_DefaultValue { get; set; }
		...
		/// </summary>
		public PlotOptionsZigzagDashStyle DashStyle { get; set; }
		private PlotOptionsZigzagDashStyle DashStyle_DefaultValue { get; set; }
		...
		/// </summary>
		public PlotOptionsZigzagDataGrouping DataGrouping { get; set; }
		private PlotOptionsZigzagDataGrouping DataGrouping_DefaultValue { get; set; }
		...
		/// </summary>
		public PlotOptionsZigzagDataLabels DataLabels { get; set; }
		private PlotOptionsZigzagDataLabels DataLabels_DefaultValue { get; set; }
		 

		/// <summary>
		/// Options for the series data sorting.
		/// </summary>
		public PlotOptionsZigzagDataSorting DataSorting { get; set; }
		private PlotOptionsZigzagDataSorting DataSorting_DefaultValue { get; set; }
		...
		/// </summary>
		public PlotOptionsZigzagEvents Events { get; set; }
		private PlotOptionsZigzagEvents Events_DefaultValue { get; set; }
		...
		/// </summary>
		public PlotOptionsZigzagFindNearestPointBy FindNearestPointBy { get; set; }
		private PlotOptionsZigzagFindNearestPointBy FindNearestPointBy_DefaultValue { get; set; }
		...
		/// </summary>
		public PlotOptionsZigzagGapUnit GapUnit { get; set; }
		private PlotOptionsZigzagGapUnit GapUnit_DefaultValue { get; set; }
		...
		/// </summary>
		public PlotOptionsZigzagLabel Label { get; set; }
		private PlotOptionsZigzagLabel Label_DefaultValue { get; set; }
		 

		/// <summary>
		/// The line marks the last price from all points.
		/// </summary>
		public PlotOptionsZigzagLastPrice LastPrice { get; set; }
		private PlotOptionsZigzagLastPrice LastPrice_DefaultValue { get; set; }
		 

		/// <summary>
		/// The line marks the last price from visible range of points.
		/// </summary>
		public PlotOptionsZigzagLastVisiblePrice LastVisiblePrice { get; set; }
		private PlotOptionsZigzagLastVisiblePrice LastVisiblePrice_DefaultValue { get; set; }
		 

		/// <summary>
		/// What type of legend symbol to render for this series. Can be one of`lineMarker` or `rectangle`.
		/// </summary>
		public PlotOptionsZigzagLegendSymbol LegendSymbol { get; set; }
		private PlotOptionsZigzagLegendSymbol LegendSymbol_DefaultValue { get; set; }
		 

		/// <summary>
		/// The line cap used for line ends and line joins on the graph.
		/// </summary>
		public PlotOptionsZigzagLinecap Linecap { get; set; }
		private PlotOptionsZigzagLinecap Linecap_DefaultValue { get; set; }
		...
		/// </summary>
		public PlotOptionsZigzagMarker Marker { get; set; }
		private PlotOptionsZigzagMarker Marker_DefaultValue { get; set; }
		...
		/// </summary>
		public PlotOptionsZigzagOnPoint OnPoint { get; set; }
		private PlotOptionsZigzagOnPoint OnPoint_DefaultValue { get; set; }
		...
		/// 
		/// </summary>
		public PlotOptionsZigzagParams Params { get; set; }
		private PlotOptionsZigzagParams Params_DefaultValue { get; set; }
		 

		/// <summary>
		/// Properties for each single point.
		/// </summary>
		public PlotOptionsZigzagPoint Point { get; set; }
		private PlotOptionsZigzagPoint Point_DefaultValue { get; set; }
		...
		/// </summary>
		public PlotOptionsZigzagSonification Sonification { get; set; }
		private PlotOptionsZigzagSonification Sonification_DefaultValue { get; set; }
		 

		/// <summary>
		/// 
		/// </summary>
		public PlotOptionsZigzagStates States { get; set; }
		private PlotOptionsZigzagStates States_DefaultValue { get; set; }
		 

		/// <summary>
		/// Whether to apply steps to the line. Possible values are `left`,`center` and `right`.
		/// </summary>
		public PlotOptionsZigzagStep Step { get; set; }
		private PlotOptionsZigzagStep Step_DefaultValue { get; set; }
		...
		/// </summary>
		public PlotOptionsZigzagTooltip Tooltip { get; set; }
		private PlotOptionsZigzagTooltip Tooltip_DefaultValue { get; set; }
		...
		/// </summary>
		public List<PlotOptionsZigzagZones> Zones { get; set; }
		private List<PlotOptionsZigzagZones> Zones_DefaultValue { get; set; }
