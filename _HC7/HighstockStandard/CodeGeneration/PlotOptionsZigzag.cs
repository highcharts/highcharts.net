...
namespace Highsoft.Web.Mvc.Stocks
{
	public partial class PlotOptionsZigzag  : BaseObject
	{
		...
		public PlotOptionsZigzag()
		{
			...
			Zones = Zones_DefaultValue = new List<PlotOptionsZigzagZone>();
		...
		/// </summary>
		public List<PlotOptionsZigzagZone> Zones { get; set; }
		private List<PlotOptionsZigzagZone> Zones_DefaultValue { get; set; }
