...
namespace Highsoft.Web.Mvc.Stocks
{
	public partial class PlotOptionsZigzagAccessibility  : BaseObject
	{
		...
		public PlotOptionsZigzagAccessibility()
		{
			...
			Point = Point_DefaultValue = new PlotOptionsZigzagAccessibilityPoint();
		...
		/// </summary>
		public PlotOptionsZigzagAccessibilityPoint Point { get; set; }
		private PlotOptionsZigzagAccessibilityPoint Point_DefaultValue { get; set; }
