...
namespace Highsoft.Web.Mvc.Stocks
{
	public partial class PlotOptionsZigzagDataGrouping  : BaseObject
	{
		...
		internal override Hashtable ToHashtable()
		{
			...
			if (Approximation != Approximation_DefaultValue) { h.Add("approximation",Approximation); Highstock.AddFunction("PlotOptionsZigzagDataGroupingApproximation.approximation", Approximation); }  
