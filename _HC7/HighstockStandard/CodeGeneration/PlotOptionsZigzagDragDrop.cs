...
{
	public partial class PlotOptionsZigzagDragDrop  : BaseObject
	{
		public PlotOptionsZigzagDragDrop()
		{
			DraggableX = DraggableX_DefaultValue = null;
			DraggableY = DraggableY_DefaultValue = null;
			DragHandle = DragHandle_DefaultValue = new PlotOptionsZigzagDragDropDragHandle();
			...
			GuideBox = GuideBox_DefaultValue = new PlotOptionsZigzagDragDropGuideBox();
		...
		/// </summary>
		public PlotOptionsZigzagDragDropDragHandle DragHandle { get; set; }
		private PlotOptionsZigzagDragDropDragHandle DragHandle_DefaultValue { get; set; }
		...
		/// </summary>
		public PlotOptionsZigzagDragDropGuideBox GuideBox { get; set; }
		private PlotOptionsZigzagDragDropGuideBox GuideBox_DefaultValue { get; set; }
