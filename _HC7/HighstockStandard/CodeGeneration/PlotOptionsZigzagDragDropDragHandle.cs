...
{
	public partial class PlotOptionsZigzagDragDropDragHandle  : BaseObject
	{
		public PlotOptionsZigzagDragDropDragHandle()
		{
		...
		internal override Hashtable ToHashtable()
		{
			...
			if (PathFormatter != PathFormatter_DefaultValue) { h.Add("pathFormatter",PathFormatter); Highstock.AddFunction("PlotOptionsZigzagDragDropDragHandlePathFormatter.pathFormatter", PathFormatter); }  
