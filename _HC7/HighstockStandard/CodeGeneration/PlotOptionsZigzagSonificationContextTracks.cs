...
{
	public partial class PlotOptionsZigzagSonificationContextTracks  : BaseObject
	{
		Hashtable h = new Hashtable();

		public PlotOptionsZigzagSonificationContextTracks()
		{
			ActiveWhen = ActiveWhen_DefaultValue = new PlotOptionsZigzagSonificationContextTracksActiveWhen();
			Instrument = Instrument_DefaultValue = null;
			InstrumentString = InstrumentString_DefaultValue = "null";
			Mapping = Mapping_DefaultValue = new PlotOptionsZigzagSonificationContextTracksMapping();
			MidiName = MidiName_DefaultValue = "";
			PointGrouping = PointGrouping_DefaultValue = new PlotOptionsZigzagSonificationContextTracksPointGrouping();
			...
			Type = Type_DefaultValue = PlotOptionsZigzagSonificationContextTracksType.Instrument;
			ValueInterval = ValueInterval_DefaultValue = null;
			ValueMapFunction = ValueMapFunction_DefaultValue = PlotOptionsZigzagSonificationContextTracksValueMapFunction.Linear;
		...
		/// </summary>
		public PlotOptionsZigzagSonificationContextTracksActiveWhen ActiveWhen { get; set; }
		private PlotOptionsZigzagSonificationContextTracksActiveWhen ActiveWhen_DefaultValue { get; set; }
		...
		/// </summary>
		public PlotOptionsZigzagSonificationContextTracksMapping Mapping { get; set; }
		private PlotOptionsZigzagSonificationContextTracksMapping Mapping_DefaultValue { get; set; }
		...
		/// </summary>
		public PlotOptionsZigzagSonificationContextTracksPointGrouping PointGrouping { get; set; }
		private PlotOptionsZigzagSonificationContextTracksPointGrouping PointGrouping_DefaultValue { get; set; }
		...
		/// </summary>
		public PlotOptionsZigzagSonificationContextTracksType Type { get; set; }
		private PlotOptionsZigzagSonificationContextTracksType Type_DefaultValue { get; set; }
		...
		/// </summary>
		public PlotOptionsZigzagSonificationContextTracksValueMapFunction ValueMapFunction { get; set; }
		private PlotOptionsZigzagSonificationContextTracksValueMapFunction ValueMapFunction_DefaultValue { get; set; }
