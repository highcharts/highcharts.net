...
{
	public partial class PlotOptionsZigzagSonificationContextTracksMapping  : BaseObject
	{
		Hashtable h = new Hashtable();

		public PlotOptionsZigzagSonificationContextTracksMapping()
		{
			Frequency = Frequency_DefaultValue = new PlotOptionsZigzagSonificationContextTracksMappingFrequency();
			GapBetweenNotes = GapBetweenNotes_DefaultValue = new PlotOptionsZigzagSonificationContextTracksMappingGapBetweenNotes();
			Highpass = Highpass_DefaultValue = new PlotOptionsZigzagSonificationContextTracksMappingHighpass();
			Lowpass = Lowpass_DefaultValue = new PlotOptionsZigzagSonificationContextTracksMappingLowpass();
			NoteDuration = NoteDuration_DefaultValue = new PlotOptionsZigzagSonificationContextTracksMappingNoteDuration();
			Pan = Pan_DefaultValue = new PlotOptionsZigzagSonificationContextTracksMappingPan();
			Pitch = Pitch_DefaultValue = new PlotOptionsZigzagSonificationContextTracksMappingPitch();
			PitchString = PitchString_DefaultValue = "null";
			PitchNumber = PitchNumber_DefaultValue = null;
			PlayDelay = PlayDelay_DefaultValue = new PlotOptionsZigzagSonificationContextTracksMappingPlayDelay();
			Time = Time_DefaultValue = new PlotOptionsZigzagSonificationContextTracksMappingTime();
			TimeString = TimeString_DefaultValue = "null";
			TimeNumber = TimeNumber_DefaultValue = null;
			Tremolo = Tremolo_DefaultValue = new PlotOptionsZigzagSonificationContextTracksMappingTremolo();
			Volume = Volume_DefaultValue = new PlotOptionsZigzagSonificationContextTracksMappingVolume();
		...
		/// </summary>
		public PlotOptionsZigzagSonificationContextTracksMappingFrequency Frequency { get; set; }
		private PlotOptionsZigzagSonificationContextTracksMappingFrequency Frequency_DefaultValue { get; set; }
		...
		/// </summary>
		public PlotOptionsZigzagSonificationContextTracksMappingGapBetweenNotes GapBetweenNotes { get; set; }
		private PlotOptionsZigzagSonificationContextTracksMappingGapBetweenNotes GapBetweenNotes_DefaultValue { get; set; }
		...
		/// </summary>
		public PlotOptionsZigzagSonificationContextTracksMappingHighpass Highpass { get; set; }
		private PlotOptionsZigzagSonificationContextTracksMappingHighpass Highpass_DefaultValue { get; set; }
		...
		/// </summary>
		public PlotOptionsZigzagSonificationContextTracksMappingLowpass Lowpass { get; set; }
		private PlotOptionsZigzagSonificationContextTracksMappingLowpass Lowpass_DefaultValue { get; set; }
		...
		/// </summary>
		public PlotOptionsZigzagSonificationContextTracksMappingNoteDuration NoteDuration { get; set; }
		private PlotOptionsZigzagSonificationContextTracksMappingNoteDuration NoteDuration_DefaultValue { get; set; }
		...
		/// </summary>
		public PlotOptionsZigzagSonificationContextTracksMappingPan Pan { get; set; }
		private PlotOptionsZigzagSonificationContextTracksMappingPan Pan_DefaultValue { get; set; }
		...
		/// </summary>
		public PlotOptionsZigzagSonificationContextTracksMappingPitch Pitch { get; set; }
		private PlotOptionsZigzagSonificationContextTracksMappingPitch Pitch_DefaultValue { get; set; }
		...
		/// </summary>
		public PlotOptionsZigzagSonificationContextTracksMappingPlayDelay PlayDelay { get; set; }
		private PlotOptionsZigzagSonificationContextTracksMappingPlayDelay PlayDelay_DefaultValue { get; set; }
		...
		/// </summary>
		public PlotOptionsZigzagSonificationContextTracksMappingTime Time { get; set; }
		private PlotOptionsZigzagSonificationContextTracksMappingTime Time_DefaultValue { get; set; }
		...
		/// </summary>
		public PlotOptionsZigzagSonificationContextTracksMappingTremolo Tremolo { get; set; }
		private PlotOptionsZigzagSonificationContextTracksMappingTremolo Tremolo_DefaultValue { get; set; }
		 

		/// <summary>
		/// The volume of notes, from 0 to 1.
		/// </summary>
		public PlotOptionsZigzagSonificationContextTracksMappingVolume Volume { get; set; }
		private PlotOptionsZigzagSonificationContextTracksMappingVolume Volume_DefaultValue { get; set; }
