...
{
	public partial class PlotOptionsZigzagSonificationContextTracksMappingVolume  : BaseObject
	{
		Hashtable h = new Hashtable();

		public PlotOptionsZigzagSonificationContextTracksMappingVolume()
		{
			MapFunction = MapFunction_DefaultValue = PlotOptionsZigzagSonificationContextTracksMappingVolumeMapFunction.Linear;
			MapTo = MapTo_DefaultValue = "";
			Max = Max_DefaultValue = null;
			Min = Min_DefaultValue = null;
			Value = Value_DefaultValue = null;
			Within = Within_DefaultValue = PlotOptionsZigzagSonificationContextTracksMappingVolumeWithin.Chart;
		...
		/// </summary>
		public PlotOptionsZigzagSonificationContextTracksMappingVolumeMapFunction MapFunction { get; set; }
		private PlotOptionsZigzagSonificationContextTracksMappingVolumeMapFunction MapFunction_DefaultValue { get; set; }
		...
		/// </summary>
		public PlotOptionsZigzagSonificationContextTracksMappingVolumeWithin Within { get; set; }
		private PlotOptionsZigzagSonificationContextTracksMappingVolumeWithin Within_DefaultValue { get; set; }
