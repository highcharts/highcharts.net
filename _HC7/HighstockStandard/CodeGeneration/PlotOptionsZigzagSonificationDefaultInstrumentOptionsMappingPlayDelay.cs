...
{
	public partial class PlotOptionsZigzagSonificationDefaultInstrumentOptionsMappingPlayDelay  : BaseObject
	{
		Hashtable h = new Hashtable();

		public PlotOptionsZigzagSonificationDefaultInstrumentOptionsMappingPlayDelay()
		{
			MapFunction = MapFunction_DefaultValue = PlotOptionsZigzagSonificationDefaultInstrumentOptionsMappingPlayDelayMapFunction.Linear;
			MapTo = MapTo_DefaultValue = "";
			Max = Max_DefaultValue = null;
			Min = Min_DefaultValue = null;
			Value = Value_DefaultValue = null;
			Within = Within_DefaultValue = PlotOptionsZigzagSonificationDefaultInstrumentOptionsMappingPlayDelayWithin.Chart;
		...
		/// </summary>
		public PlotOptionsZigzagSonificationDefaultInstrumentOptionsMappingPlayDelayMapFunction MapFunction { get; set; }
		private PlotOptionsZigzagSonificationDefaultInstrumentOptionsMappingPlayDelayMapFunction MapFunction_DefaultValue { get; set; }
		...
		/// </summary>
		public PlotOptionsZigzagSonificationDefaultInstrumentOptionsMappingPlayDelayWithin Within { get; set; }
		private PlotOptionsZigzagSonificationDefaultInstrumentOptionsMappingPlayDelayWithin Within_DefaultValue { get; set; }
