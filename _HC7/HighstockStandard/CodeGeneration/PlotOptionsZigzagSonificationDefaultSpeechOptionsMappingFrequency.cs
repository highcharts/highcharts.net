...
{
	public partial class PlotOptionsZigzagSonificationDefaultSpeechOptionsMappingFrequency  : BaseObject
	{
		Hashtable h = new Hashtable();

		public PlotOptionsZigzagSonificationDefaultSpeechOptionsMappingFrequency()
		{
			MapFunction = MapFunction_DefaultValue = PlotOptionsZigzagSonificationDefaultSpeechOptionsMappingFrequencyMapFunction.Linear;
			MapTo = MapTo_DefaultValue = "";
			Max = Max_DefaultValue = null;
			Min = Min_DefaultValue = null;
			Value = Value_DefaultValue = null;
			Within = Within_DefaultValue = PlotOptionsZigzagSonificationDefaultSpeechOptionsMappingFrequencyWithin.Chart;
		...
		/// </summary>
		public PlotOptionsZigzagSonificationDefaultSpeechOptionsMappingFrequencyMapFunction MapFunction { get; set; }
		private PlotOptionsZigzagSonificationDefaultSpeechOptionsMappingFrequencyMapFunction MapFunction_DefaultValue { get; set; }
		...
		/// </summary>
		public PlotOptionsZigzagSonificationDefaultSpeechOptionsMappingFrequencyWithin Within { get; set; }
		private PlotOptionsZigzagSonificationDefaultSpeechOptionsMappingFrequencyWithin Within_DefaultValue { get; set; }
