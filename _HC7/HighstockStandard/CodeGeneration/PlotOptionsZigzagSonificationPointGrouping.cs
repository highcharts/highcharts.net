...
{
	public partial class PlotOptionsZigzagSonificationPointGrouping  : BaseObject
	{
		Hashtable h = new Hashtable();

		public PlotOptionsZigzagSonificationPointGrouping()
		{
			Algorithm = Algorithm_DefaultValue = PlotOptionsZigzagSonificationPointGroupingAlgorithm.Minimax;
		...
		/// </summary>
		public PlotOptionsZigzagSonificationPointGroupingAlgorithm Algorithm { get; set; }
		private PlotOptionsZigzagSonificationPointGroupingAlgorithm Algorithm_DefaultValue { get; set; }
