...
{
	public partial class PlotOptionsZigzagSonificationTracks  : BaseObject
	{
		Hashtable h = new Hashtable();

		public PlotOptionsZigzagSonificationTracks()
		{
			ActiveWhen = ActiveWhen_DefaultValue = new PlotOptionsZigzagSonificationTracksActiveWhen();
			Instrument = Instrument_DefaultValue = null;
			InstrumentString = InstrumentString_DefaultValue = "null";
			Mapping = Mapping_DefaultValue = new PlotOptionsZigzagSonificationTracksMapping();
			MidiName = MidiName_DefaultValue = "";
			PointGrouping = PointGrouping_DefaultValue = new PlotOptionsZigzagSonificationTracksPointGrouping();
			RoundToMusicalNotes = RoundToMusicalNotes_DefaultValue = true;
			ShowPlayMarker = ShowPlayMarker_DefaultValue = true;
			Type = Type_DefaultValue = PlotOptionsZigzagSonificationTracksType.Instrument;
		...
		/// </summary>
		public PlotOptionsZigzagSonificationTracksActiveWhen ActiveWhen { get; set; }
		private PlotOptionsZigzagSonificationTracksActiveWhen ActiveWhen_DefaultValue { get; set; }
		...
		/// </summary>
		public PlotOptionsZigzagSonificationTracksMapping Mapping { get; set; }
		private PlotOptionsZigzagSonificationTracksMapping Mapping_DefaultValue { get; set; }
		...
		/// </summary>
		public PlotOptionsZigzagSonificationTracksPointGrouping PointGrouping { get; set; }
		private PlotOptionsZigzagSonificationTracksPointGrouping PointGrouping_DefaultValue { get; set; }
		...
		/// </summary>
		public PlotOptionsZigzagSonificationTracksType Type { get; set; }
		private PlotOptionsZigzagSonificationTracksType Type_DefaultValue { get; set; }
