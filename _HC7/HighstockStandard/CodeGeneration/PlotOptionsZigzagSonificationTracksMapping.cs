...
{
	public partial class PlotOptionsZigzagSonificationTracksMapping  : BaseObject
	{
		Hashtable h = new Hashtable();

		public PlotOptionsZigzagSonificationTracksMapping()
		{
			Frequency = Frequency_DefaultValue = new PlotOptionsZigzagSonificationTracksMappingFrequency();
			GapBetweenNotes = GapBetweenNotes_DefaultValue = new PlotOptionsZigzagSonificationTracksMappingGapBetweenNotes();
			Highpass = Highpass_DefaultValue = new PlotOptionsZigzagSonificationTracksMappingHighpass();
			Lowpass = Lowpass_DefaultValue = new PlotOptionsZigzagSonificationTracksMappingLowpass();
			NoteDuration = NoteDuration_DefaultValue = new PlotOptionsZigzagSonificationTracksMappingNoteDuration();
			Pan = Pan_DefaultValue = new PlotOptionsZigzagSonificationTracksMappingPan();
			Pitch = Pitch_DefaultValue = new PlotOptionsZigzagSonificationTracksMappingPitch();
			PitchString = PitchString_DefaultValue = "null";
			PitchNumber = PitchNumber_DefaultValue = null;
			PlayDelay = PlayDelay_DefaultValue = new PlotOptionsZigzagSonificationTracksMappingPlayDelay();
			Time = Time_DefaultValue = new PlotOptionsZigzagSonificationTracksMappingTime();
			TimeString = TimeString_DefaultValue = "null";
			TimeNumber = TimeNumber_DefaultValue = null;
			Tremolo = Tremolo_DefaultValue = new PlotOptionsZigzagSonificationTracksMappingTremolo();
			Volume = Volume_DefaultValue = new PlotOptionsZigzagSonificationTracksMappingVolume();
		...
		/// </summary>
		public PlotOptionsZigzagSonificationTracksMappingFrequency Frequency { get; set; }
		private PlotOptionsZigzagSonificationTracksMappingFrequency Frequency_DefaultValue { get; set; }
		...
		/// </summary>
		public PlotOptionsZigzagSonificationTracksMappingGapBetweenNotes GapBetweenNotes { get; set; }
		private PlotOptionsZigzagSonificationTracksMappingGapBetweenNotes GapBetweenNotes_DefaultValue { get; set; }
		...
		/// </summary>
		public PlotOptionsZigzagSonificationTracksMappingHighpass Highpass { get; set; }
		private PlotOptionsZigzagSonificationTracksMappingHighpass Highpass_DefaultValue { get; set; }
		...
		/// </summary>
		public PlotOptionsZigzagSonificationTracksMappingLowpass Lowpass { get; set; }
		private PlotOptionsZigzagSonificationTracksMappingLowpass Lowpass_DefaultValue { get; set; }
		...
		/// </summary>
		public PlotOptionsZigzagSonificationTracksMappingNoteDuration NoteDuration { get; set; }
		private PlotOptionsZigzagSonificationTracksMappingNoteDuration NoteDuration_DefaultValue { get; set; }
		...
		/// </summary>
		public PlotOptionsZigzagSonificationTracksMappingPan Pan { get; set; }
		private PlotOptionsZigzagSonificationTracksMappingPan Pan_DefaultValue { get; set; }
		...
		/// </summary>
		public PlotOptionsZigzagSonificationTracksMappingPitch Pitch { get; set; }
		private PlotOptionsZigzagSonificationTracksMappingPitch Pitch_DefaultValue { get; set; }
		...
		/// </summary>
		public PlotOptionsZigzagSonificationTracksMappingPlayDelay PlayDelay { get; set; }
		private PlotOptionsZigzagSonificationTracksMappingPlayDelay PlayDelay_DefaultValue { get; set; }
		...
		/// </summary>
		public PlotOptionsZigzagSonificationTracksMappingTime Time { get; set; }
		private PlotOptionsZigzagSonificationTracksMappingTime Time_DefaultValue { get; set; }
		...
		/// </summary>
		public PlotOptionsZigzagSonificationTracksMappingTremolo Tremolo { get; set; }
		private PlotOptionsZigzagSonificationTracksMappingTremolo Tremolo_DefaultValue { get; set; }
		 

		/// <summary>
		/// The volume of notes, from 0 to 1.
		/// </summary>
		public PlotOptionsZigzagSonificationTracksMappingVolume Volume { get; set; }
		private PlotOptionsZigzagSonificationTracksMappingVolume Volume_DefaultValue { get; set; }
