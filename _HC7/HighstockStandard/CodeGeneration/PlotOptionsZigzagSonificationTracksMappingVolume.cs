...
{
	public partial class PlotOptionsZigzagSonificationTracksMappingVolume  : BaseObject
	{
		Hashtable h = new Hashtable();

		public PlotOptionsZigzagSonificationTracksMappingVolume()
		{
			MapFunction = MapFunction_DefaultValue = PlotOptionsZigzagSonificationTracksMappingVolumeMapFunction.Linear;
			MapTo = MapTo_DefaultValue = "";
			Max = Max_DefaultValue = null;
			Min = Min_DefaultValue = null;
			Value = Value_DefaultValue = null;
			Within = Within_DefaultValue = PlotOptionsZigzagSonificationTracksMappingVolumeWithin.Chart;
		...
		/// </summary>
		public PlotOptionsZigzagSonificationTracksMappingVolumeMapFunction MapFunction { get; set; }
		private PlotOptionsZigzagSonificationTracksMappingVolumeMapFunction MapFunction_DefaultValue { get; set; }
		...
		/// </summary>
		public PlotOptionsZigzagSonificationTracksMappingVolumeWithin Within { get; set; }
		private PlotOptionsZigzagSonificationTracksMappingVolumeWithin Within_DefaultValue { get; set; }
