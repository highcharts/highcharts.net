...
namespace Highsoft.Web.Mvc.Stocks
{
	public partial class PolygonSeriesPointEvents  : BaseObject
	{
		...
		internal override Hashtable ToHashtable()
		{
			...
			if (Drag != Drag_DefaultValue) { h.Add("drag",Drag); Highstock.AddFunction("PolygonSeriesPointEventsDrag.drag", Drag); }  
			if (DragStart != DragStart_DefaultValue) { h.Add("dragStart",DragStart); Highstock.AddFunction("PolygonSeriesPointEventsDragStart.dragStart", DragStart); }  
			if (Drop != Drop_DefaultValue) { h.Add("drop",Drop); Highstock.AddFunction("PolygonSeriesPointEventsDrop.drop", Drop); }  
