...
{
	public partial class PolygonSeriesSonificationContextTracks  : BaseObject
	{
		Hashtable h = new Hashtable();

		public PolygonSeriesSonificationContextTracks()
		{
			ActiveWhen = ActiveWhen_DefaultValue = new PolygonSeriesSonificationContextTracksActiveWhen();
			Instrument = Instrument_DefaultValue = null;
			InstrumentString = InstrumentString_DefaultValue = "null";
			Mapping = Mapping_DefaultValue = new PolygonSeriesSonificationContextTracksMapping();
			MidiName = MidiName_DefaultValue = "";
			PointGrouping = PointGrouping_DefaultValue = new PolygonSeriesSonificationContextTracksPointGrouping();
			...
			Type = Type_DefaultValue = PolygonSeriesSonificationContextTracksType.Instrument;
			ValueInterval = ValueInterval_DefaultValue = null;
			ValueMapFunction = ValueMapFunction_DefaultValue = PolygonSeriesSonificationContextTracksValueMapFunction.Linear;
		...
		/// </summary>
		public PolygonSeriesSonificationContextTracksActiveWhen ActiveWhen { get; set; }
		private PolygonSeriesSonificationContextTracksActiveWhen ActiveWhen_DefaultValue { get; set; }
		...
		/// </summary>
		public PolygonSeriesSonificationContextTracksMapping Mapping { get; set; }
		private PolygonSeriesSonificationContextTracksMapping Mapping_DefaultValue { get; set; }
		...
		/// </summary>
		public PolygonSeriesSonificationContextTracksPointGrouping PointGrouping { get; set; }
		private PolygonSeriesSonificationContextTracksPointGrouping PointGrouping_DefaultValue { get; set; }
		...
		/// </summary>
		public PolygonSeriesSonificationContextTracksType Type { get; set; }
		private PolygonSeriesSonificationContextTracksType Type_DefaultValue { get; set; }
		...
		/// </summary>
		public PolygonSeriesSonificationContextTracksValueMapFunction ValueMapFunction { get; set; }
		private PolygonSeriesSonificationContextTracksValueMapFunction ValueMapFunction_DefaultValue { get; set; }
