...
{
	public partial class PolygonSeriesSonificationTracks  : BaseObject
	{
		Hashtable h = new Hashtable();

		public PolygonSeriesSonificationTracks()
		{
			ActiveWhen = ActiveWhen_DefaultValue = new PolygonSeriesSonificationTracksActiveWhen();
			Instrument = Instrument_DefaultValue = null;
			InstrumentString = InstrumentString_DefaultValue = "null";
			Mapping = Mapping_DefaultValue = new PolygonSeriesSonificationTracksMapping();
			MidiName = MidiName_DefaultValue = "";
			PointGrouping = PointGrouping_DefaultValue = new PolygonSeriesSonificationTracksPointGrouping();
			RoundToMusicalNotes = RoundToMusicalNotes_DefaultValue = true;
			ShowPlayMarker = ShowPlayMarker_DefaultValue = true;
			Type = Type_DefaultValue = PolygonSeriesSonificationTracksType.Instrument;
		...
		/// </summary>
		public PolygonSeriesSonificationTracksActiveWhen ActiveWhen { get; set; }
		private PolygonSeriesSonificationTracksActiveWhen ActiveWhen_DefaultValue { get; set; }
		...
		/// </summary>
		public PolygonSeriesSonificationTracksMapping Mapping { get; set; }
		private PolygonSeriesSonificationTracksMapping Mapping_DefaultValue { get; set; }
		...
		/// </summary>
		public PolygonSeriesSonificationTracksPointGrouping PointGrouping { get; set; }
		private PolygonSeriesSonificationTracksPointGrouping PointGrouping_DefaultValue { get; set; }
		...
		/// </summary>
		public PolygonSeriesSonificationTracksType Type { get; set; }
		private PolygonSeriesSonificationTracksType Type_DefaultValue { get; set; }
