...
{
	public partial class PolygonSeriesStatesSelect  : BaseObject
	{
		Hashtable h = new Hashtable();

		public PolygonSeriesStatesSelect()
		{
			Animation = Animation_DefaultValue = new Animation() { Enabled = true };
			AnimationBool = AnimationBool_DefaultValue = null;
			Enabled = Enabled_DefaultValue = true;
			Halo = Halo_DefaultValue = new PolygonSeriesStatesSelectHalo();
			LineWidth = LineWidth_DefaultValue = null;
			LineWidthPlus = LineWidthPlus_DefaultValue = 1;
			Marker = Marker_DefaultValue = new PolygonSeriesStatesSelectMarker();
		...
		/// </summary>
		public PolygonSeriesStatesSelectHalo Halo { get; set; }
		private PolygonSeriesStatesSelectHalo Halo_DefaultValue { get; set; }
		...
		/// </summary>
		public PolygonSeriesStatesSelectMarker Marker { get; set; }
		private PolygonSeriesStatesSelectMarker Marker_DefaultValue { get; set; }
