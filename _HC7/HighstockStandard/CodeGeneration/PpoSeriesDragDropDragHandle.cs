...
{
	public partial class PpoSeriesDragDropDragHandle  : BaseObject
	{
		public PpoSeriesDragDropDragHandle()
		{
		...
		internal override Hashtable ToHashtable()
		{
			...
			if (PathFormatter != PathFormatter_DefaultValue) { h.Add("pathFormatter",PathFormatter); Highstock.AddFunction("PpoSeriesDragDropDragHandlePathFormatter.pathFormatter", PathFormatter); }  
