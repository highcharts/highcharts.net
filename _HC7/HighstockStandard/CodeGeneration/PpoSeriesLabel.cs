...
{
	public partial class PpoSeriesLabel  : BaseObject
	{
		public PpoSeriesLabel()
		{
			...
			Style = Style_DefaultValue = new PpoSeriesLabelStyle();
		...
		/// </summary>
		public PpoSeriesLabelStyle Style { get; set; }
		private PpoSeriesLabelStyle Style_DefaultValue { get; set; }
