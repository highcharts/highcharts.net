...
{
	public partial class PpoSeriesSonificationContextTracks  : BaseObject
	{
		Hashtable h = new Hashtable();

		public PpoSeriesSonificationContextTracks()
		{
			ActiveWhen = ActiveWhen_DefaultValue = new PpoSeriesSonificationContextTracksActiveWhen();
			Instrument = Instrument_DefaultValue = null;
			InstrumentString = InstrumentString_DefaultValue = "null";
			Mapping = Mapping_DefaultValue = new PpoSeriesSonificationContextTracksMapping();
			MidiName = MidiName_DefaultValue = "";
			PointGrouping = PointGrouping_DefaultValue = new PpoSeriesSonificationContextTracksPointGrouping();
			...
			Type = Type_DefaultValue = PpoSeriesSonificationContextTracksType.Instrument;
			ValueInterval = ValueInterval_DefaultValue = null;
			ValueMapFunction = ValueMapFunction_DefaultValue = PpoSeriesSonificationContextTracksValueMapFunction.Linear;
		...
		/// </summary>
		public PpoSeriesSonificationContextTracksActiveWhen ActiveWhen { get; set; }
		private PpoSeriesSonificationContextTracksActiveWhen ActiveWhen_DefaultValue { get; set; }
		...
		/// </summary>
		public PpoSeriesSonificationContextTracksMapping Mapping { get; set; }
		private PpoSeriesSonificationContextTracksMapping Mapping_DefaultValue { get; set; }
		...
		/// </summary>
		public PpoSeriesSonificationContextTracksPointGrouping PointGrouping { get; set; }
		private PpoSeriesSonificationContextTracksPointGrouping PointGrouping_DefaultValue { get; set; }
		...
		/// </summary>
		public PpoSeriesSonificationContextTracksType Type { get; set; }
		private PpoSeriesSonificationContextTracksType Type_DefaultValue { get; set; }
		...
		/// </summary>
		public PpoSeriesSonificationContextTracksValueMapFunction ValueMapFunction { get; set; }
		private PpoSeriesSonificationContextTracksValueMapFunction ValueMapFunction_DefaultValue { get; set; }
