...
{
	public partial class PpoSeriesSonificationContextTracksMappingPan  : BaseObject
	{
		Hashtable h = new Hashtable();

		public PpoSeriesSonificationContextTracksMappingPan()
		{
			MapFunction = MapFunction_DefaultValue = PpoSeriesSonificationContextTracksMappingPanMapFunction.Linear;
			MapTo = MapTo_DefaultValue = "";
			Max = Max_DefaultValue = null;
			Min = Min_DefaultValue = null;
			Value = Value_DefaultValue = null;
			Within = Within_DefaultValue = PpoSeriesSonificationContextTracksMappingPanWithin.Chart;
		...
		/// </summary>
		public PpoSeriesSonificationContextTracksMappingPanMapFunction MapFunction { get; set; }
		private PpoSeriesSonificationContextTracksMappingPanMapFunction MapFunction_DefaultValue { get; set; }
		...
		/// </summary>
		public PpoSeriesSonificationContextTracksMappingPanWithin Within { get; set; }
		private PpoSeriesSonificationContextTracksMappingPanWithin Within_DefaultValue { get; set; }
