...
{
	public partial class PpoSeriesSonificationContextTracksMappingPitch  : BaseObject
	{
		Hashtable h = new Hashtable();

		public PpoSeriesSonificationContextTracksMappingPitch()
		{
			MapFunction = MapFunction_DefaultValue = PpoSeriesSonificationContextTracksMappingPitchMapFunction.Linear;
		...
		/// </summary>
		public PpoSeriesSonificationContextTracksMappingPitchMapFunction MapFunction { get; set; }
		private PpoSeriesSonificationContextTracksMappingPitchMapFunction MapFunction_DefaultValue { get; set; }
