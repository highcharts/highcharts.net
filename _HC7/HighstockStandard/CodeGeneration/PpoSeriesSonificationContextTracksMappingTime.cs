...
{
	public partial class PpoSeriesSonificationContextTracksMappingTime  : BaseObject
	{
		Hashtable h = new Hashtable();

		public PpoSeriesSonificationContextTracksMappingTime()
		{
			MapFunction = MapFunction_DefaultValue = PpoSeriesSonificationContextTracksMappingTimeMapFunction.Linear;
			MapTo = MapTo_DefaultValue = "";
			Max = Max_DefaultValue = null;
			Min = Min_DefaultValue = null;
			Value = Value_DefaultValue = null;
			Within = Within_DefaultValue = PpoSeriesSonificationContextTracksMappingTimeWithin.Chart;
		...
		/// </summary>
		public PpoSeriesSonificationContextTracksMappingTimeMapFunction MapFunction { get; set; }
		private PpoSeriesSonificationContextTracksMappingTimeMapFunction MapFunction_DefaultValue { get; set; }
		...
		/// </summary>
		public PpoSeriesSonificationContextTracksMappingTimeWithin Within { get; set; }
		private PpoSeriesSonificationContextTracksMappingTimeWithin Within_DefaultValue { get; set; }
