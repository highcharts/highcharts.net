...
{
	public partial class PpoSeriesSonificationContextTracksPointGrouping  : BaseObject
	{
		Hashtable h = new Hashtable();

		public PpoSeriesSonificationContextTracksPointGrouping()
		{
			Algorithm = Algorithm_DefaultValue = PpoSeriesSonificationContextTracksPointGroupingAlgorithm.Minimax;
		...
		/// </summary>
		public PpoSeriesSonificationContextTracksPointGroupingAlgorithm Algorithm { get; set; }
		private PpoSeriesSonificationContextTracksPointGroupingAlgorithm Algorithm_DefaultValue { get; set; }
