...
{
	public partial class PpoSeriesSonificationDefaultInstrumentOptionsMappingGapBetweenNotes  : BaseObject
	{
		Hashtable h = new Hashtable();

		public PpoSeriesSonificationDefaultInstrumentOptionsMappingGapBetweenNotes()
		{
			MapFunction = MapFunction_DefaultValue = PpoSeriesSonificationDefaultInstrumentOptionsMappingGapBetweenNotesMapFunction.Linear;
			MapTo = MapTo_DefaultValue = "";
			Max = Max_DefaultValue = null;
			Min = Min_DefaultValue = null;
			Value = Value_DefaultValue = null;
			Within = Within_DefaultValue = PpoSeriesSonificationDefaultInstrumentOptionsMappingGapBetweenNotesWithin.Chart;
		...
		/// </summary>
		public PpoSeriesSonificationDefaultInstrumentOptionsMappingGapBetweenNotesMapFunction MapFunction { get; set; }
		private PpoSeriesSonificationDefaultInstrumentOptionsMappingGapBetweenNotesMapFunction MapFunction_DefaultValue { get; set; }
		...
		/// </summary>
		public PpoSeriesSonificationDefaultInstrumentOptionsMappingGapBetweenNotesWithin Within { get; set; }
		private PpoSeriesSonificationDefaultInstrumentOptionsMappingGapBetweenNotesWithin Within_DefaultValue { get; set; }
