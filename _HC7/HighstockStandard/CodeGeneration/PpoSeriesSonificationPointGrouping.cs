...
{
	public partial class PpoSeriesSonificationPointGrouping  : BaseObject
	{
		Hashtable h = new Hashtable();

		public PpoSeriesSonificationPointGrouping()
		{
			Algorithm = Algorithm_DefaultValue = PpoSeriesSonificationPointGroupingAlgorithm.Minimax;
		...
		/// </summary>
		public PpoSeriesSonificationPointGroupingAlgorithm Algorithm { get; set; }
		private PpoSeriesSonificationPointGroupingAlgorithm Algorithm_DefaultValue { get; set; }
