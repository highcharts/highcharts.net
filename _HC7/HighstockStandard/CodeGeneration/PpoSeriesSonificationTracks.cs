...
{
	public partial class PpoSeriesSonificationTracks  : BaseObject
	{
		Hashtable h = new Hashtable();

		public PpoSeriesSonificationTracks()
		{
			ActiveWhen = ActiveWhen_DefaultValue = new PpoSeriesSonificationTracksActiveWhen();
			Instrument = Instrument_DefaultValue = null;
			InstrumentString = InstrumentString_DefaultValue = "null";
			Mapping = Mapping_DefaultValue = new PpoSeriesSonificationTracksMapping();
			MidiName = MidiName_DefaultValue = "";
			PointGrouping = PointGrouping_DefaultValue = new PpoSeriesSonificationTracksPointGrouping();
			RoundToMusicalNotes = RoundToMusicalNotes_DefaultValue = true;
			ShowPlayMarker = ShowPlayMarker_DefaultValue = true;
			Type = Type_DefaultValue = PpoSeriesSonificationTracksType.Instrument;
		...
		/// </summary>
		public PpoSeriesSonificationTracksActiveWhen ActiveWhen { get; set; }
		private PpoSeriesSonificationTracksActiveWhen ActiveWhen_DefaultValue { get; set; }
		...
		/// </summary>
		public PpoSeriesSonificationTracksMapping Mapping { get; set; }
		private PpoSeriesSonificationTracksMapping Mapping_DefaultValue { get; set; }
		...
		/// </summary>
		public PpoSeriesSonificationTracksPointGrouping PointGrouping { get; set; }
		private PpoSeriesSonificationTracksPointGrouping PointGrouping_DefaultValue { get; set; }
		...
		/// </summary>
		public PpoSeriesSonificationTracksType Type { get; set; }
		private PpoSeriesSonificationTracksType Type_DefaultValue { get; set; }
