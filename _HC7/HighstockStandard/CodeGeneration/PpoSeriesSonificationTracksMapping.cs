...
{
	public partial class PpoSeriesSonificationTracksMapping  : BaseObject
	{
		Hashtable h = new Hashtable();

		public PpoSeriesSonificationTracksMapping()
		{
			Frequency = Frequency_DefaultValue = new PpoSeriesSonificationTracksMappingFrequency();
			GapBetweenNotes = GapBetweenNotes_DefaultValue = new PpoSeriesSonificationTracksMappingGapBetweenNotes();
			Highpass = Highpass_DefaultValue = new PpoSeriesSonificationTracksMappingHighpass();
			Lowpass = Lowpass_DefaultValue = new PpoSeriesSonificationTracksMappingLowpass();
			NoteDuration = NoteDuration_DefaultValue = new PpoSeriesSonificationTracksMappingNoteDuration();
			Pan = Pan_DefaultValue = new PpoSeriesSonificationTracksMappingPan();
			Pitch = Pitch_DefaultValue = new PpoSeriesSonificationTracksMappingPitch();
			PitchString = PitchString_DefaultValue = "null";
			PitchNumber = PitchNumber_DefaultValue = null;
			PlayDelay = PlayDelay_DefaultValue = new PpoSeriesSonificationTracksMappingPlayDelay();
			Time = Time_DefaultValue = new PpoSeriesSonificationTracksMappingTime();
			TimeString = TimeString_DefaultValue = "null";
			TimeNumber = TimeNumber_DefaultValue = null;
			Tremolo = Tremolo_DefaultValue = new PpoSeriesSonificationTracksMappingTremolo();
			Volume = Volume_DefaultValue = new PpoSeriesSonificationTracksMappingVolume();
		...
		/// </summary>
		public PpoSeriesSonificationTracksMappingFrequency Frequency { get; set; }
		private PpoSeriesSonificationTracksMappingFrequency Frequency_DefaultValue { get; set; }
		...
		/// </summary>
		public PpoSeriesSonificationTracksMappingGapBetweenNotes GapBetweenNotes { get; set; }
		private PpoSeriesSonificationTracksMappingGapBetweenNotes GapBetweenNotes_DefaultValue { get; set; }
		...
		/// </summary>
		public PpoSeriesSonificationTracksMappingHighpass Highpass { get; set; }
		private PpoSeriesSonificationTracksMappingHighpass Highpass_DefaultValue { get; set; }
		...
		/// </summary>
		public PpoSeriesSonificationTracksMappingLowpass Lowpass { get; set; }
		private PpoSeriesSonificationTracksMappingLowpass Lowpass_DefaultValue { get; set; }
		...
		/// </summary>
		public PpoSeriesSonificationTracksMappingNoteDuration NoteDuration { get; set; }
		private PpoSeriesSonificationTracksMappingNoteDuration NoteDuration_DefaultValue { get; set; }
		...
		/// </summary>
		public PpoSeriesSonificationTracksMappingPan Pan { get; set; }
		private PpoSeriesSonificationTracksMappingPan Pan_DefaultValue { get; set; }
		...
		/// </summary>
		public PpoSeriesSonificationTracksMappingPitch Pitch { get; set; }
		private PpoSeriesSonificationTracksMappingPitch Pitch_DefaultValue { get; set; }
		...
		/// </summary>
		public PpoSeriesSonificationTracksMappingPlayDelay PlayDelay { get; set; }
		private PpoSeriesSonificationTracksMappingPlayDelay PlayDelay_DefaultValue { get; set; }
		...
		/// </summary>
		public PpoSeriesSonificationTracksMappingTime Time { get; set; }
		private PpoSeriesSonificationTracksMappingTime Time_DefaultValue { get; set; }
		...
		/// </summary>
		public PpoSeriesSonificationTracksMappingTremolo Tremolo { get; set; }
		private PpoSeriesSonificationTracksMappingTremolo Tremolo_DefaultValue { get; set; }
		 

		/// <summary>
		/// The volume of notes, from 0 to 1.
		/// </summary>
		public PpoSeriesSonificationTracksMappingVolume Volume { get; set; }
		private PpoSeriesSonificationTracksMappingVolume Volume_DefaultValue { get; set; }
