...
{
	public partial class PpoSeriesSonificationTracksMappingFrequency  : BaseObject
	{
		Hashtable h = new Hashtable();

		public PpoSeriesSonificationTracksMappingFrequency()
		{
			MapFunction = MapFunction_DefaultValue = PpoSeriesSonificationTracksMappingFrequencyMapFunction.Linear;
			MapTo = MapTo_DefaultValue = "";
			Max = Max_DefaultValue = null;
			Min = Min_DefaultValue = null;
			Value = Value_DefaultValue = null;
			Within = Within_DefaultValue = PpoSeriesSonificationTracksMappingFrequencyWithin.Chart;
		...
		/// </summary>
		public PpoSeriesSonificationTracksMappingFrequencyMapFunction MapFunction { get; set; }
		private PpoSeriesSonificationTracksMappingFrequencyMapFunction MapFunction_DefaultValue { get; set; }
		...
		/// </summary>
		public PpoSeriesSonificationTracksMappingFrequencyWithin Within { get; set; }
		private PpoSeriesSonificationTracksMappingFrequencyWithin Within_DefaultValue { get; set; }
