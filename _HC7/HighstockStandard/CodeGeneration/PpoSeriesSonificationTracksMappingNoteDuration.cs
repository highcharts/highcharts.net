...
{
	public partial class PpoSeriesSonificationTracksMappingNoteDuration  : BaseObject
	{
		Hashtable h = new Hashtable();

		public PpoSeriesSonificationTracksMappingNoteDuration()
		{
			MapFunction = MapFunction_DefaultValue = PpoSeriesSonificationTracksMappingNoteDurationMapFunction.Linear;
			MapTo = MapTo_DefaultValue = "";
			Max = Max_DefaultValue = null;
			Min = Min_DefaultValue = null;
			Value = Value_DefaultValue = null;
			Within = Within_DefaultValue = PpoSeriesSonificationTracksMappingNoteDurationWithin.Chart;
		...
		/// </summary>
		public PpoSeriesSonificationTracksMappingNoteDurationMapFunction MapFunction { get; set; }
		private PpoSeriesSonificationTracksMappingNoteDurationMapFunction MapFunction_DefaultValue { get; set; }
		...
		/// </summary>
		public PpoSeriesSonificationTracksMappingNoteDurationWithin Within { get; set; }
		private PpoSeriesSonificationTracksMappingNoteDurationWithin Within_DefaultValue { get; set; }
