...
{
	public partial class PpoSeriesSonificationTracksMappingPan  : BaseObject
	{
		Hashtable h = new Hashtable();

		public PpoSeriesSonificationTracksMappingPan()
		{
			MapFunction = MapFunction_DefaultValue = PpoSeriesSonificationTracksMappingPanMapFunction.Linear;
			MapTo = MapTo_DefaultValue = "";
			Max = Max_DefaultValue = null;
			Min = Min_DefaultValue = null;
			Value = Value_DefaultValue = null;
			Within = Within_DefaultValue = PpoSeriesSonificationTracksMappingPanWithin.Chart;
		...
		/// </summary>
		public PpoSeriesSonificationTracksMappingPanMapFunction MapFunction { get; set; }
		private PpoSeriesSonificationTracksMappingPanMapFunction MapFunction_DefaultValue { get; set; }
		...
		/// </summary>
		public PpoSeriesSonificationTracksMappingPanWithin Within { get; set; }
		private PpoSeriesSonificationTracksMappingPanWithin Within_DefaultValue { get; set; }
