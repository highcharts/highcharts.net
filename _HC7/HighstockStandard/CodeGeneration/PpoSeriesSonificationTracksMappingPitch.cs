...
{
	public partial class PpoSeriesSonificationTracksMappingPitch  : BaseObject
	{
		Hashtable h = new Hashtable();

		public PpoSeriesSonificationTracksMappingPitch()
		{
			MapFunction = MapFunction_DefaultValue = PpoSeriesSonificationTracksMappingPitchMapFunction.Linear;
		...
		/// </summary>
		public PpoSeriesSonificationTracksMappingPitchMapFunction MapFunction { get; set; }
		private PpoSeriesSonificationTracksMappingPitchMapFunction MapFunction_DefaultValue { get; set; }
