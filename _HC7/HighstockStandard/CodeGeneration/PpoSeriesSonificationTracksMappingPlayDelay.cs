...
{
	public partial class PpoSeriesSonificationTracksMappingPlayDelay  : BaseObject
	{
		Hashtable h = new Hashtable();

		public PpoSeriesSonificationTracksMappingPlayDelay()
		{
			MapFunction = MapFunction_DefaultValue = PpoSeriesSonificationTracksMappingPlayDelayMapFunction.Linear;
			MapTo = MapTo_DefaultValue = "";
			Max = Max_DefaultValue = null;
			Min = Min_DefaultValue = null;
			Value = Value_DefaultValue = null;
			Within = Within_DefaultValue = PpoSeriesSonificationTracksMappingPlayDelayWithin.Chart;
		...
		/// </summary>
		public PpoSeriesSonificationTracksMappingPlayDelayMapFunction MapFunction { get; set; }
		private PpoSeriesSonificationTracksMappingPlayDelayMapFunction MapFunction_DefaultValue { get; set; }
		...
		/// </summary>
		public PpoSeriesSonificationTracksMappingPlayDelayWithin Within { get; set; }
		private PpoSeriesSonificationTracksMappingPlayDelayWithin Within_DefaultValue { get; set; }
