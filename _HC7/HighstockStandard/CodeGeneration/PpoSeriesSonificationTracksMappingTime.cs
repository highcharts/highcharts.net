...
{
	public partial class PpoSeriesSonificationTracksMappingTime  : BaseObject
	{
		Hashtable h = new Hashtable();

		public PpoSeriesSonificationTracksMappingTime()
		{
			MapFunction = MapFunction_DefaultValue = PpoSeriesSonificationTracksMappingTimeMapFunction.Linear;
			MapTo = MapTo_DefaultValue = "";
			Max = Max_DefaultValue = null;
			Min = Min_DefaultValue = null;
			Value = Value_DefaultValue = null;
			Within = Within_DefaultValue = PpoSeriesSonificationTracksMappingTimeWithin.Chart;
		...
		/// </summary>
		public PpoSeriesSonificationTracksMappingTimeMapFunction MapFunction { get; set; }
		private PpoSeriesSonificationTracksMappingTimeMapFunction MapFunction_DefaultValue { get; set; }
		...
		/// </summary>
		public PpoSeriesSonificationTracksMappingTimeWithin Within { get; set; }
		private PpoSeriesSonificationTracksMappingTimeWithin Within_DefaultValue { get; set; }
