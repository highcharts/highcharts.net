...
{
	public partial class PpoSeriesSonificationTracksMappingVolume  : BaseObject
	{
		Hashtable h = new Hashtable();

		public PpoSeriesSonificationTracksMappingVolume()
		{
			MapFunction = MapFunction_DefaultValue = PpoSeriesSonificationTracksMappingVolumeMapFunction.Linear;
			MapTo = MapTo_DefaultValue = "";
			Max = Max_DefaultValue = null;
			Min = Min_DefaultValue = null;
			Value = Value_DefaultValue = null;
			Within = Within_DefaultValue = PpoSeriesSonificationTracksMappingVolumeWithin.Chart;
		...
		/// </summary>
		public PpoSeriesSonificationTracksMappingVolumeMapFunction MapFunction { get; set; }
		private PpoSeriesSonificationTracksMappingVolumeMapFunction MapFunction_DefaultValue { get; set; }
		...
		/// </summary>
		public PpoSeriesSonificationTracksMappingVolumeWithin Within { get; set; }
		private PpoSeriesSonificationTracksMappingVolumeWithin Within_DefaultValue { get; set; }
