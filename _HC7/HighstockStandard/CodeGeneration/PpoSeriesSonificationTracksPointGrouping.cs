...
{
	public partial class PpoSeriesSonificationTracksPointGrouping  : BaseObject
	{
		Hashtable h = new Hashtable();

		public PpoSeriesSonificationTracksPointGrouping()
		{
			Algorithm = Algorithm_DefaultValue = PpoSeriesSonificationTracksPointGroupingAlgorithm.Minimax;
		...
		/// </summary>
		public PpoSeriesSonificationTracksPointGroupingAlgorithm Algorithm { get; set; }
		private PpoSeriesSonificationTracksPointGroupingAlgorithm Algorithm_DefaultValue { get; set; }
