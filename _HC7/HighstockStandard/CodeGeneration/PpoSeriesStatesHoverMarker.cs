...
{
	public partial class PpoSeriesStatesHoverMarker  : BaseObject
	{
		public PpoSeriesStatesHoverMarker()
		{
			...
			States = States_DefaultValue = new PpoSeriesStatesHoverMarkerStates();
		...
		/// </summary>
		public PpoSeriesStatesHoverMarkerStates States { get; set; }
		private PpoSeriesStatesHoverMarkerStates States_DefaultValue { get; set; }
