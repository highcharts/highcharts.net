...
{
	public partial class PpoSeriesTooltip  : BaseObject
	{
		public PpoSeriesTooltip()
		{
			...
			HeaderShape = HeaderShape_DefaultValue = PpoSeriesTooltipHeaderShape.Callout;
		...
		/// </summary>
		public PpoSeriesTooltipHeaderShape HeaderShape { get; set; }
		private PpoSeriesTooltipHeaderShape HeaderShape_DefaultValue { get; set; }
		...
		internal override Hashtable ToHashtable()
		{
			...
			if (NullFormatter != NullFormatter_DefaultValue) { h.Add("nullFormatter",NullFormatter); Highstock.AddFunction("PpoSeriesTooltipNullFormatter.nullFormatter", NullFormatter); }  
			if (Outside != Outside_DefaultValue) h.Add("outside",Outside);
			if (Padding != Padding_DefaultValue) h.Add("padding",Padding);
			if (PointFormat != PointFormat_DefaultValue) h.Add("pointFormat",PointFormat);
			if (PointFormatter != PointFormatter_DefaultValue) { h.Add("pointFormatter",PointFormatter); Highstock.AddFunction("PpoSeriesTooltipPointFormatter.pointFormatter", PointFormatter); }  
