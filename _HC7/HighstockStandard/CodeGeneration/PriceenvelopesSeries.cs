...
namespace Highsoft.Web.Mvc.Stocks
{
	public partial class PriceenvelopesSeries  : Series
	{
		...
		public PriceenvelopesSeries()
		{
			...
			Zones = Zones_DefaultValue = new List<PriceenvelopesSeriesZone>();
		...
		/// </summary>
		public List<PriceenvelopesSeriesZone> Zones { get; set; }
		private List<PriceenvelopesSeriesZone> Zones_DefaultValue { get; set; }
