...
{
	public partial class PriceenvelopesSeries  : Series
	{
		Hashtable h = new Hashtable();

		public PriceenvelopesSeries()
		{
			Accessibility = Accessibility_DefaultValue = new PriceenvelopesSeriesAccessibility();
			AllowPointSelect = AllowPointSelect_DefaultValue = false;
			Animation = Animation_DefaultValue = new Animation() { Enabled = true };
			AnimationBool = AnimationBool_DefaultValue = true;
			AnimationLimit = AnimationLimit_DefaultValue = null;
			BoostBlending = BoostBlending_DefaultValue = PriceenvelopesSeriesBoostBlending.Undefined;
			BoostThreshold = BoostThreshold_DefaultValue = 5000;
			BottomLine = BottomLine_DefaultValue = new PriceenvelopesSeriesBottomLine();
			ClassName = ClassName_DefaultValue = "";
			Clip = Clip_DefaultValue = true;
			Color = Color_DefaultValue = "";
			ColorIndex = ColorIndex_DefaultValue = null;
			ColorKey = ColorKey_DefaultValue = "y";
			Compare = Compare_DefaultValue = PriceenvelopesSeriesCompare.Percent;
			CompareBase = CompareBase_DefaultValue = PriceenvelopesSeriesCompareBase.Min;
			...
			Cursor = Cursor_DefaultValue = PriceenvelopesSeriesCursor.Null;
			Custom = Custom_DefaultValue = new Hashtable();
			DashStyle = DashStyle_DefaultValue = PriceenvelopesSeriesDashStyle.Null;
			DataGrouping = DataGrouping_DefaultValue = new PriceenvelopesSeriesDataGrouping();
			DataLabels = DataLabels_DefaultValue = new PriceenvelopesSeriesDataLabels();
			DataSorting = DataSorting_DefaultValue = new PriceenvelopesSeriesDataSorting();
			Description = Description_DefaultValue = "";
			Dumbell = Dumbell_DefaultValue = new PriceenvelopesSeriesDumbell();
			EnableMouseTracking = EnableMouseTracking_DefaultValue = true;
			Events = Events_DefaultValue = new PriceenvelopesSeriesEvents();
			FindNearestPointBy = FindNearestPointBy_DefaultValue = PriceenvelopesSeriesFindNearestPointBy.X;
			...
			LastPrice = LastPrice_DefaultValue = new PriceenvelopesSeriesLastPrice();
			LastVisiblePrice = LastVisiblePrice_DefaultValue = new PriceenvelopesSeriesLastVisiblePrice();
			...
			OnPoint = OnPoint_DefaultValue = new PriceenvelopesSeriesOnPoint();
			Opacity = Opacity_DefaultValue = 1;
			Params = Params_DefaultValue = new PriceenvelopesSeriesParams();
			Point = Point_DefaultValue = new PriceenvelopesSeriesPoint();
			...
			Sonification = Sonification_DefaultValue = new PriceenvelopesSeriesSonification();
			Stack = Stack_DefaultValue = "";
			StackNumber = StackNumber_DefaultValue = null;
			States = States_DefaultValue = new PriceenvelopesSeriesStates();
			Step = Step_DefaultValue = PriceenvelopesSeriesStep.Null;
			StickyTracking = StickyTracking_DefaultValue = true;
			Threshold = Threshold_DefaultValue = 0;
			Tooltip = Tooltip_DefaultValue = new PriceenvelopesSeriesTooltip();
			TopLine = TopLine_DefaultValue = new PriceenvelopesSeriesTopLine();
			...
			Zones = Zones_DefaultValue = new List<PriceenvelopesSeriesZones>();
		...
		/// </summary>
		public PriceenvelopesSeriesAccessibility Accessibility { get; set; }
		private PriceenvelopesSeriesAccessibility Accessibility_DefaultValue { get; set; }
		...
		/// </summary>
		public PriceenvelopesSeriesBoostBlending BoostBlending { get; set; }
		private PriceenvelopesSeriesBoostBlending BoostBlending_DefaultValue { get; set; }
		...
		/// Bottom line options.
		/// </summary>
		public PriceenvelopesSeriesBottomLine BottomLine { get; set; }
		private PriceenvelopesSeriesBottomLine BottomLine_DefaultValue { get; set; }
		...
		/// </summary>
		public PriceenvelopesSeriesCompare Compare { get; set; }
		private PriceenvelopesSeriesCompare Compare_DefaultValue { get; set; }
		 

		/// <summary>
		/// When [compare](#plotOptions.series.compare) is `percent`, this optiondictates whether to use 0 or 100 as the base of comparison.
		/// </summary>
		public PriceenvelopesSeriesCompareBase CompareBase { get; set; }
		private PriceenvelopesSeriesCompareBase CompareBase_DefaultValue { get; set; }
		...
		/// </summary>
		public PriceenvelopesSeriesCursor Cursor { get; set; }
		private PriceenvelopesSeriesCursor Cursor_DefaultValue { get; set; }
		...
		/// </summary>
		public PriceenvelopesSeriesDashStyle DashStyle { get; set; }
		private PriceenvelopesSeriesDashStyle DashStyle_DefaultValue { get; set; }
		...
		/// </summary>
		public PriceenvelopesSeriesDataGrouping DataGrouping { get; set; }
		private PriceenvelopesSeriesDataGrouping DataGrouping_DefaultValue { get; set; }
		...
		/// </summary>
		public PriceenvelopesSeriesDataLabels DataLabels { get; set; }
		private PriceenvelopesSeriesDataLabels DataLabels_DefaultValue { get; set; }
		 

		/// <summary>
		/// Options for the series data sorting.
		/// </summary>
		public PriceenvelopesSeriesDataSorting DataSorting { get; set; }
		private PriceenvelopesSeriesDataSorting DataSorting_DefaultValue { get; set; }
		...
		/// 
		/// </summary>
		public PriceenvelopesSeriesDumbell Dumbell { get; set; }
		private PriceenvelopesSeriesDumbell Dumbell_DefaultValue { get; set; }
		...
		/// </summary>
		public PriceenvelopesSeriesEvents Events { get; set; }
		private PriceenvelopesSeriesEvents Events_DefaultValue { get; set; }
		...
		/// </summary>
		public PriceenvelopesSeriesFindNearestPointBy FindNearestPointBy { get; set; }
		private PriceenvelopesSeriesFindNearestPointBy FindNearestPointBy_DefaultValue { get; set; }
		...
		/// </summary>
		public PriceenvelopesSeriesGapUnit GapUnit { get; set; }
		private PriceenvelopesSeriesGapUnit GapUnit_DefaultValue { get; set; }
		...
		/// </summary>
		public PriceenvelopesSeriesLabel Label { get; set; }
		private PriceenvelopesSeriesLabel Label_DefaultValue { get; set; }
		 

		/// <summary>
		/// The line marks the last price from all points.
		/// </summary>
		public PriceenvelopesSeriesLastPrice LastPrice { get; set; }
		private PriceenvelopesSeriesLastPrice LastPrice_DefaultValue { get; set; }
		 

		/// <summary>
		/// The line marks the last price from visible range of points.
		/// </summary>
		public PriceenvelopesSeriesLastVisiblePrice LastVisiblePrice { get; set; }
		private PriceenvelopesSeriesLastVisiblePrice LastVisiblePrice_DefaultValue { get; set; }
		...
		/// </summary>
		public PriceenvelopesSeriesLegendSymbol LegendSymbol { get; set; }
		private PriceenvelopesSeriesLegendSymbol LegendSymbol_DefaultValue { get; set; }
		 

		/// <summary>
		/// The line cap used for line ends and line joins on the graph.
		/// </summary>
		public PriceenvelopesSeriesLinecap Linecap { get; set; }
		private PriceenvelopesSeriesLinecap Linecap_DefaultValue { get; set; }
		...
		/// </summary>
		public PriceenvelopesSeriesMarker Marker { get; set; }
		private PriceenvelopesSeriesMarker Marker_DefaultValue { get; set; }
		...
		/// </summary>
		public PriceenvelopesSeriesOnPoint OnPoint { get; set; }
		private PriceenvelopesSeriesOnPoint OnPoint_DefaultValue { get; set; }
		...
		/// </summary>
		public PriceenvelopesSeriesParams Params { get; set; }
		private PriceenvelopesSeriesParams Params_DefaultValue { get; set; }
		 

		/// <summary>
		/// Properties for each single point.
		/// </summary>
		public PriceenvelopesSeriesPoint Point { get; set; }
		private PriceenvelopesSeriesPoint Point_DefaultValue { get; set; }
		...
		/// </summary>
		public PriceenvelopesSeriesSonification Sonification { get; set; }
		private PriceenvelopesSeriesSonification Sonification_DefaultValue { get; set; }
		...
		/// 
		/// </summary>
		public PriceenvelopesSeriesStates States { get; set; }
		private PriceenvelopesSeriesStates States_DefaultValue { get; set; }
		 

		/// <summary>
		/// Whether to apply steps to the line. Possible values are `left`,`center` and `right`.
		/// </summary>
		public PriceenvelopesSeriesStep Step { get; set; }
		private PriceenvelopesSeriesStep Step_DefaultValue { get; set; }
		...
		/// </summary>
		public PriceenvelopesSeriesTooltip Tooltip { get; set; }
		private PriceenvelopesSeriesTooltip Tooltip_DefaultValue { get; set; }
		 

		/// <summary>
		/// Top line options.
		/// </summary>
		public PriceenvelopesSeriesTopLine TopLine { get; set; }
		private PriceenvelopesSeriesTopLine TopLine_DefaultValue { get; set; }
		...
		/// </summary>
		public List<PriceenvelopesSeriesZones> Zones { get; set; }
		private List<PriceenvelopesSeriesZones> Zones_DefaultValue { get; set; }
