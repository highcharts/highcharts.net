...
namespace Highsoft.Web.Mvc.Stocks
{
	public partial class PriceenvelopesSeriesMarkerStates  : BaseObject
	{
		public PriceenvelopesSeriesMarkerStates()
		{
			...
			Inactive = Inactive_DefaultValue = new PriceenvelopesSeriesMarkerStatesInactive();
			Normal = Normal_DefaultValue = new PriceenvelopesSeriesMarkerStatesNormal();
		...
		/// 
		/// </summary>
		public PriceenvelopesSeriesMarkerStatesInactive Inactive { get; set; }
		private PriceenvelopesSeriesMarkerStatesInactive Inactive_DefaultValue { get; set; }
		 

		/// <summary>
		/// The normal state of a single point marker. Currently onlyused for setting animation when returning to normal statefrom hover.
		/// </summary>
		public PriceenvelopesSeriesMarkerStatesNormal Normal { get; set; }
		private PriceenvelopesSeriesMarkerStatesNormal Normal_DefaultValue { get; set; }
