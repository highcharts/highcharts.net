...
{
	public partial class PriceenvelopesSeriesSonificationContextTracks  : BaseObject
	{
		Hashtable h = new Hashtable();

		public PriceenvelopesSeriesSonificationContextTracks()
		{
			ActiveWhen = ActiveWhen_DefaultValue = new PriceenvelopesSeriesSonificationContextTracksActiveWhen();
			Instrument = Instrument_DefaultValue = null;
			InstrumentString = InstrumentString_DefaultValue = "null";
			Mapping = Mapping_DefaultValue = new PriceenvelopesSeriesSonificationContextTracksMapping();
			MidiName = MidiName_DefaultValue = "";
			PointGrouping = PointGrouping_DefaultValue = new PriceenvelopesSeriesSonificationContextTracksPointGrouping();
			...
			Type = Type_DefaultValue = PriceenvelopesSeriesSonificationContextTracksType.Instrument;
			ValueInterval = ValueInterval_DefaultValue = null;
			ValueMapFunction = ValueMapFunction_DefaultValue = PriceenvelopesSeriesSonificationContextTracksValueMapFunction.Linear;
		...
		/// </summary>
		public PriceenvelopesSeriesSonificationContextTracksActiveWhen ActiveWhen { get; set; }
		private PriceenvelopesSeriesSonificationContextTracksActiveWhen ActiveWhen_DefaultValue { get; set; }
		...
		/// </summary>
		public PriceenvelopesSeriesSonificationContextTracksMapping Mapping { get; set; }
		private PriceenvelopesSeriesSonificationContextTracksMapping Mapping_DefaultValue { get; set; }
		...
		/// </summary>
		public PriceenvelopesSeriesSonificationContextTracksPointGrouping PointGrouping { get; set; }
		private PriceenvelopesSeriesSonificationContextTracksPointGrouping PointGrouping_DefaultValue { get; set; }
		...
		/// </summary>
		public PriceenvelopesSeriesSonificationContextTracksType Type { get; set; }
		private PriceenvelopesSeriesSonificationContextTracksType Type_DefaultValue { get; set; }
		...
		/// </summary>
		public PriceenvelopesSeriesSonificationContextTracksValueMapFunction ValueMapFunction { get; set; }
		private PriceenvelopesSeriesSonificationContextTracksValueMapFunction ValueMapFunction_DefaultValue { get; set; }
