...
{
	public partial class PriceenvelopesSeriesSonificationContextTracksMapping  : BaseObject
	{
		Hashtable h = new Hashtable();

		public PriceenvelopesSeriesSonificationContextTracksMapping()
		{
			Frequency = Frequency_DefaultValue = new PriceenvelopesSeriesSonificationContextTracksMappingFrequency();
			GapBetweenNotes = GapBetweenNotes_DefaultValue = new PriceenvelopesSeriesSonificationContextTracksMappingGapBetweenNotes();
			Highpass = Highpass_DefaultValue = new PriceenvelopesSeriesSonificationContextTracksMappingHighpass();
			Lowpass = Lowpass_DefaultValue = new PriceenvelopesSeriesSonificationContextTracksMappingLowpass();
			NoteDuration = NoteDuration_DefaultValue = new PriceenvelopesSeriesSonificationContextTracksMappingNoteDuration();
			Pan = Pan_DefaultValue = new PriceenvelopesSeriesSonificationContextTracksMappingPan();
			Pitch = Pitch_DefaultValue = new PriceenvelopesSeriesSonificationContextTracksMappingPitch();
			PitchString = PitchString_DefaultValue = "null";
			PitchNumber = PitchNumber_DefaultValue = null;
			PlayDelay = PlayDelay_DefaultValue = new PriceenvelopesSeriesSonificationContextTracksMappingPlayDelay();
			Time = Time_DefaultValue = new PriceenvelopesSeriesSonificationContextTracksMappingTime();
			TimeString = TimeString_DefaultValue = "null";
			TimeNumber = TimeNumber_DefaultValue = null;
			Tremolo = Tremolo_DefaultValue = new PriceenvelopesSeriesSonificationContextTracksMappingTremolo();
			Volume = Volume_DefaultValue = new PriceenvelopesSeriesSonificationContextTracksMappingVolume();
		...
		/// </summary>
		public PriceenvelopesSeriesSonificationContextTracksMappingFrequency Frequency { get; set; }
		private PriceenvelopesSeriesSonificationContextTracksMappingFrequency Frequency_DefaultValue { get; set; }
		...
		/// </summary>
		public PriceenvelopesSeriesSonificationContextTracksMappingGapBetweenNotes GapBetweenNotes { get; set; }
		private PriceenvelopesSeriesSonificationContextTracksMappingGapBetweenNotes GapBetweenNotes_DefaultValue { get; set; }
		...
		/// </summary>
		public PriceenvelopesSeriesSonificationContextTracksMappingHighpass Highpass { get; set; }
		private PriceenvelopesSeriesSonificationContextTracksMappingHighpass Highpass_DefaultValue { get; set; }
		...
		/// </summary>
		public PriceenvelopesSeriesSonificationContextTracksMappingLowpass Lowpass { get; set; }
		private PriceenvelopesSeriesSonificationContextTracksMappingLowpass Lowpass_DefaultValue { get; set; }
		...
		/// </summary>
		public PriceenvelopesSeriesSonificationContextTracksMappingNoteDuration NoteDuration { get; set; }
		private PriceenvelopesSeriesSonificationContextTracksMappingNoteDuration NoteDuration_DefaultValue { get; set; }
		...
		/// </summary>
		public PriceenvelopesSeriesSonificationContextTracksMappingPan Pan { get; set; }
		private PriceenvelopesSeriesSonificationContextTracksMappingPan Pan_DefaultValue { get; set; }
		...
		/// </summary>
		public PriceenvelopesSeriesSonificationContextTracksMappingPitch Pitch { get; set; }
		private PriceenvelopesSeriesSonificationContextTracksMappingPitch Pitch_DefaultValue { get; set; }
		...
		/// </summary>
		public PriceenvelopesSeriesSonificationContextTracksMappingPlayDelay PlayDelay { get; set; }
		private PriceenvelopesSeriesSonificationContextTracksMappingPlayDelay PlayDelay_DefaultValue { get; set; }
		...
		/// </summary>
		public PriceenvelopesSeriesSonificationContextTracksMappingTime Time { get; set; }
		private PriceenvelopesSeriesSonificationContextTracksMappingTime Time_DefaultValue { get; set; }
		...
		/// </summary>
		public PriceenvelopesSeriesSonificationContextTracksMappingTremolo Tremolo { get; set; }
		private PriceenvelopesSeriesSonificationContextTracksMappingTremolo Tremolo_DefaultValue { get; set; }
		 

		/// <summary>
		/// The volume of notes, from 0 to 1.
		/// </summary>
		public PriceenvelopesSeriesSonificationContextTracksMappingVolume Volume { get; set; }
		private PriceenvelopesSeriesSonificationContextTracksMappingVolume Volume_DefaultValue { get; set; }
