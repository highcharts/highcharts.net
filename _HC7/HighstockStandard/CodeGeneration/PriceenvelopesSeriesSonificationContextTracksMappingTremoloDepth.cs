...
{
	public partial class PriceenvelopesSeriesSonificationContextTracksMappingTremoloDepth  : BaseObject
	{
		Hashtable h = new Hashtable();

		public PriceenvelopesSeriesSonificationContextTracksMappingTremoloDepth()
		{
			MapFunction = MapFunction_DefaultValue = PriceenvelopesSeriesSonificationContextTracksMappingTremoloDepthMapFunction.Linear;
			MapTo = MapTo_DefaultValue = "";
			Max = Max_DefaultValue = null;
			Min = Min_DefaultValue = null;
			Value = Value_DefaultValue = null;
			Within = Within_DefaultValue = PriceenvelopesSeriesSonificationContextTracksMappingTremoloDepthWithin.Chart;
		...
		/// </summary>
		public PriceenvelopesSeriesSonificationContextTracksMappingTremoloDepthMapFunction MapFunction { get; set; }
		private PriceenvelopesSeriesSonificationContextTracksMappingTremoloDepthMapFunction MapFunction_DefaultValue { get; set; }
		...
		/// </summary>
		public PriceenvelopesSeriesSonificationContextTracksMappingTremoloDepthWithin Within { get; set; }
		private PriceenvelopesSeriesSonificationContextTracksMappingTremoloDepthWithin Within_DefaultValue { get; set; }
