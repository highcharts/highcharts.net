...
{
	public partial class PriceenvelopesSeriesSonificationContextTracksMappingVolume  : BaseObject
	{
		Hashtable h = new Hashtable();

		public PriceenvelopesSeriesSonificationContextTracksMappingVolume()
		{
			MapFunction = MapFunction_DefaultValue = PriceenvelopesSeriesSonificationContextTracksMappingVolumeMapFunction.Linear;
			MapTo = MapTo_DefaultValue = "";
			Max = Max_DefaultValue = null;
			Min = Min_DefaultValue = null;
			Value = Value_DefaultValue = null;
			Within = Within_DefaultValue = PriceenvelopesSeriesSonificationContextTracksMappingVolumeWithin.Chart;
		...
		/// </summary>
		public PriceenvelopesSeriesSonificationContextTracksMappingVolumeMapFunction MapFunction { get; set; }
		private PriceenvelopesSeriesSonificationContextTracksMappingVolumeMapFunction MapFunction_DefaultValue { get; set; }
		...
		/// </summary>
		public PriceenvelopesSeriesSonificationContextTracksMappingVolumeWithin Within { get; set; }
		private PriceenvelopesSeriesSonificationContextTracksMappingVolumeWithin Within_DefaultValue { get; set; }
