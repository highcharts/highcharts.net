...
{
	public partial class PriceenvelopesSeriesSonificationContextTracksPointGrouping  : BaseObject
	{
		Hashtable h = new Hashtable();

		public PriceenvelopesSeriesSonificationContextTracksPointGrouping()
		{
			Algorithm = Algorithm_DefaultValue = PriceenvelopesSeriesSonificationContextTracksPointGroupingAlgorithm.Minimax;
		...
		/// </summary>
		public PriceenvelopesSeriesSonificationContextTracksPointGroupingAlgorithm Algorithm { get; set; }
		private PriceenvelopesSeriesSonificationContextTracksPointGroupingAlgorithm Algorithm_DefaultValue { get; set; }
