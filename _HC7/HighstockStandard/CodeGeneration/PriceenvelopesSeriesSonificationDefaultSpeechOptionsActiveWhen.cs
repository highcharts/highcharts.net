...
{
	public partial class PriceenvelopesSeriesSonificationDefaultSpeechOptionsActiveWhen  : BaseObject
	{
		Hashtable h = new Hashtable();

		public PriceenvelopesSeriesSonificationDefaultSpeechOptionsActiveWhen()
		{
