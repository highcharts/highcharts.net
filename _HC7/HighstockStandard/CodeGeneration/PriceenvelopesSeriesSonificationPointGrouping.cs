...
{
	public partial class PriceenvelopesSeriesSonificationPointGrouping  : BaseObject
	{
		Hashtable h = new Hashtable();

		public PriceenvelopesSeriesSonificationPointGrouping()
		{
			Algorithm = Algorithm_DefaultValue = PriceenvelopesSeriesSonificationPointGroupingAlgorithm.Minimax;
		...
		/// </summary>
		public PriceenvelopesSeriesSonificationPointGroupingAlgorithm Algorithm { get; set; }
		private PriceenvelopesSeriesSonificationPointGroupingAlgorithm Algorithm_DefaultValue { get; set; }
