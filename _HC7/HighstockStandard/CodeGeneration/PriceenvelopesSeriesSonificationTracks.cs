...
{
	public partial class PriceenvelopesSeriesSonificationTracks  : BaseObject
	{
		Hashtable h = new Hashtable();

		public PriceenvelopesSeriesSonificationTracks()
		{
			ActiveWhen = ActiveWhen_DefaultValue = new PriceenvelopesSeriesSonificationTracksActiveWhen();
			Instrument = Instrument_DefaultValue = null;
			InstrumentString = InstrumentString_DefaultValue = "null";
			Mapping = Mapping_DefaultValue = new PriceenvelopesSeriesSonificationTracksMapping();
			MidiName = MidiName_DefaultValue = "";
			PointGrouping = PointGrouping_DefaultValue = new PriceenvelopesSeriesSonificationTracksPointGrouping();
			RoundToMusicalNotes = RoundToMusicalNotes_DefaultValue = true;
			ShowPlayMarker = ShowPlayMarker_DefaultValue = true;
			Type = Type_DefaultValue = PriceenvelopesSeriesSonificationTracksType.Instrument;
		...
		/// </summary>
		public PriceenvelopesSeriesSonificationTracksActiveWhen ActiveWhen { get; set; }
		private PriceenvelopesSeriesSonificationTracksActiveWhen ActiveWhen_DefaultValue { get; set; }
		...
		/// </summary>
		public PriceenvelopesSeriesSonificationTracksMapping Mapping { get; set; }
		private PriceenvelopesSeriesSonificationTracksMapping Mapping_DefaultValue { get; set; }
		...
		/// </summary>
		public PriceenvelopesSeriesSonificationTracksPointGrouping PointGrouping { get; set; }
		private PriceenvelopesSeriesSonificationTracksPointGrouping PointGrouping_DefaultValue { get; set; }
		...
		/// </summary>
		public PriceenvelopesSeriesSonificationTracksType Type { get; set; }
		private PriceenvelopesSeriesSonificationTracksType Type_DefaultValue { get; set; }
