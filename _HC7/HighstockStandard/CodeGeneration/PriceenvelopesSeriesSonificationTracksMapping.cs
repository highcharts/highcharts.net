...
{
	public partial class PriceenvelopesSeriesSonificationTracksMapping  : BaseObject
	{
		Hashtable h = new Hashtable();

		public PriceenvelopesSeriesSonificationTracksMapping()
		{
			Frequency = Frequency_DefaultValue = new PriceenvelopesSeriesSonificationTracksMappingFrequency();
			GapBetweenNotes = GapBetweenNotes_DefaultValue = new PriceenvelopesSeriesSonificationTracksMappingGapBetweenNotes();
			Highpass = Highpass_DefaultValue = new PriceenvelopesSeriesSonificationTracksMappingHighpass();
			Lowpass = Lowpass_DefaultValue = new PriceenvelopesSeriesSonificationTracksMappingLowpass();
			NoteDuration = NoteDuration_DefaultValue = new PriceenvelopesSeriesSonificationTracksMappingNoteDuration();
			Pan = Pan_DefaultValue = new PriceenvelopesSeriesSonificationTracksMappingPan();
			Pitch = Pitch_DefaultValue = new PriceenvelopesSeriesSonificationTracksMappingPitch();
			PitchString = PitchString_DefaultValue = "null";
			PitchNumber = PitchNumber_DefaultValue = null;
			PlayDelay = PlayDelay_DefaultValue = new PriceenvelopesSeriesSonificationTracksMappingPlayDelay();
			Time = Time_DefaultValue = new PriceenvelopesSeriesSonificationTracksMappingTime();
			TimeString = TimeString_DefaultValue = "null";
			TimeNumber = TimeNumber_DefaultValue = null;
			Tremolo = Tremolo_DefaultValue = new PriceenvelopesSeriesSonificationTracksMappingTremolo();
			Volume = Volume_DefaultValue = new PriceenvelopesSeriesSonificationTracksMappingVolume();
		...
		/// </summary>
		public PriceenvelopesSeriesSonificationTracksMappingFrequency Frequency { get; set; }
		private PriceenvelopesSeriesSonificationTracksMappingFrequency Frequency_DefaultValue { get; set; }
		...
		/// </summary>
		public PriceenvelopesSeriesSonificationTracksMappingGapBetweenNotes GapBetweenNotes { get; set; }
		private PriceenvelopesSeriesSonificationTracksMappingGapBetweenNotes GapBetweenNotes_DefaultValue { get; set; }
		...
		/// </summary>
		public PriceenvelopesSeriesSonificationTracksMappingHighpass Highpass { get; set; }
		private PriceenvelopesSeriesSonificationTracksMappingHighpass Highpass_DefaultValue { get; set; }
		...
		/// </summary>
		public PriceenvelopesSeriesSonificationTracksMappingLowpass Lowpass { get; set; }
		private PriceenvelopesSeriesSonificationTracksMappingLowpass Lowpass_DefaultValue { get; set; }
		...
		/// </summary>
		public PriceenvelopesSeriesSonificationTracksMappingNoteDuration NoteDuration { get; set; }
		private PriceenvelopesSeriesSonificationTracksMappingNoteDuration NoteDuration_DefaultValue { get; set; }
		...
		/// </summary>
		public PriceenvelopesSeriesSonificationTracksMappingPan Pan { get; set; }
		private PriceenvelopesSeriesSonificationTracksMappingPan Pan_DefaultValue { get; set; }
		...
		/// </summary>
		public PriceenvelopesSeriesSonificationTracksMappingPitch Pitch { get; set; }
		private PriceenvelopesSeriesSonificationTracksMappingPitch Pitch_DefaultValue { get; set; }
		...
		/// </summary>
		public PriceenvelopesSeriesSonificationTracksMappingPlayDelay PlayDelay { get; set; }
		private PriceenvelopesSeriesSonificationTracksMappingPlayDelay PlayDelay_DefaultValue { get; set; }
		...
		/// </summary>
		public PriceenvelopesSeriesSonificationTracksMappingTime Time { get; set; }
		private PriceenvelopesSeriesSonificationTracksMappingTime Time_DefaultValue { get; set; }
		...
		/// </summary>
		public PriceenvelopesSeriesSonificationTracksMappingTremolo Tremolo { get; set; }
		private PriceenvelopesSeriesSonificationTracksMappingTremolo Tremolo_DefaultValue { get; set; }
		 

		/// <summary>
		/// The volume of notes, from 0 to 1.
		/// </summary>
		public PriceenvelopesSeriesSonificationTracksMappingVolume Volume { get; set; }
		private PriceenvelopesSeriesSonificationTracksMappingVolume Volume_DefaultValue { get; set; }
