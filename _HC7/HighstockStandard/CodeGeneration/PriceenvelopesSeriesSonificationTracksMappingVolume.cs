...
{
	public partial class PriceenvelopesSeriesSonificationTracksMappingVolume  : BaseObject
	{
		Hashtable h = new Hashtable();

		public PriceenvelopesSeriesSonificationTracksMappingVolume()
		{
			MapFunction = MapFunction_DefaultValue = PriceenvelopesSeriesSonificationTracksMappingVolumeMapFunction.Linear;
			MapTo = MapTo_DefaultValue = "";
			Max = Max_DefaultValue = null;
			Min = Min_DefaultValue = null;
			Value = Value_DefaultValue = null;
			Within = Within_DefaultValue = PriceenvelopesSeriesSonificationTracksMappingVolumeWithin.Chart;
		...
		/// </summary>
		public PriceenvelopesSeriesSonificationTracksMappingVolumeMapFunction MapFunction { get; set; }
		private PriceenvelopesSeriesSonificationTracksMappingVolumeMapFunction MapFunction_DefaultValue { get; set; }
		...
		/// </summary>
		public PriceenvelopesSeriesSonificationTracksMappingVolumeWithin Within { get; set; }
		private PriceenvelopesSeriesSonificationTracksMappingVolumeWithin Within_DefaultValue { get; set; }
