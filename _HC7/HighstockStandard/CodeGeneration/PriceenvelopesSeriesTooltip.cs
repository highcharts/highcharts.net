...
namespace Highsoft.Web.Mvc.Stocks
{
	public partial class PriceenvelopesSeriesTooltip  : BaseObject
	{
		public PriceenvelopesSeriesTooltip()
		{
			...
			HeaderShape = HeaderShape_DefaultValue = PriceenvelopesSeriesTooltipHeaderShape.Callout;
		...
		/// </summary>
		public PriceenvelopesSeriesTooltipHeaderShape HeaderShape { get; set; }
		private PriceenvelopesSeriesTooltipHeaderShape HeaderShape_DefaultValue { get; set; }
		...
		internal override Hashtable ToHashtable()
		{
			...
			if (NullFormatter != NullFormatter_DefaultValue) { h.Add("nullFormatter",NullFormatter); Highstock.AddFunction("PriceenvelopesSeriesTooltipNullFormatter.nullFormatter", NullFormatter); }  
