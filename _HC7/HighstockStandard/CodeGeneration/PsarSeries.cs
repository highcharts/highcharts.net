...
namespace Highsoft.Web.Mvc.Stocks
{
	public partial class PsarSeries  : Series
	{
		public PsarSeries()
		{
			...
			DragDrop = DragDrop_DefaultValue = new PsarSeriesDragDrop();
		...
		/// </summary>
		public PsarSeriesDragDrop DragDrop { get; set; }
		private PsarSeriesDragDrop DragDrop_DefaultValue { get; set; }
