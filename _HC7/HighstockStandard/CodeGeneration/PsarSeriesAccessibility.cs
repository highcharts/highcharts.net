...
namespace Highsoft.Web.Mvc.Stocks
{
	public partial class PsarSeriesAccessibility  : BaseObject
	{
		...
		public PsarSeriesAccessibility()
		{
			...
			Point = Point_DefaultValue = new PsarSeriesAccessibilityPoint();
		...
		/// </summary>
		public PsarSeriesAccessibilityPoint Point { get; set; }
		private PsarSeriesAccessibilityPoint Point_DefaultValue { get; set; }
