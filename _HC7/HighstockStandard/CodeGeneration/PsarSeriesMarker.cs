...
{
	public partial class PsarSeriesMarker  : BaseObject
	{
		public PsarSeriesMarker()
		{
			...
			States = States_DefaultValue = new PsarSeriesMarkerStates();
		...
		/// </summary>
		public PsarSeriesMarkerStates States { get; set; }
		private PsarSeriesMarkerStates States_DefaultValue { get; set; }
