...
{
	public partial class PsarSeriesSonificationContextTracks  : BaseObject
	{
		Hashtable h = new Hashtable();

		public PsarSeriesSonificationContextTracks()
		{
			ActiveWhen = ActiveWhen_DefaultValue = new PsarSeriesSonificationContextTracksActiveWhen();
			Instrument = Instrument_DefaultValue = null;
			InstrumentString = InstrumentString_DefaultValue = "null";
			Mapping = Mapping_DefaultValue = new PsarSeriesSonificationContextTracksMapping();
			MidiName = MidiName_DefaultValue = "";
			PointGrouping = PointGrouping_DefaultValue = new PsarSeriesSonificationContextTracksPointGrouping();
			...
			Type = Type_DefaultValue = PsarSeriesSonificationContextTracksType.Instrument;
			ValueInterval = ValueInterval_DefaultValue = null;
			ValueMapFunction = ValueMapFunction_DefaultValue = PsarSeriesSonificationContextTracksValueMapFunction.Linear;
		...
		/// </summary>
		public PsarSeriesSonificationContextTracksActiveWhen ActiveWhen { get; set; }
		private PsarSeriesSonificationContextTracksActiveWhen ActiveWhen_DefaultValue { get; set; }
		...
		/// </summary>
		public PsarSeriesSonificationContextTracksMapping Mapping { get; set; }
		private PsarSeriesSonificationContextTracksMapping Mapping_DefaultValue { get; set; }
		...
		/// </summary>
		public PsarSeriesSonificationContextTracksPointGrouping PointGrouping { get; set; }
		private PsarSeriesSonificationContextTracksPointGrouping PointGrouping_DefaultValue { get; set; }
		...
		/// </summary>
		public PsarSeriesSonificationContextTracksType Type { get; set; }
		private PsarSeriesSonificationContextTracksType Type_DefaultValue { get; set; }
		...
		/// </summary>
		public PsarSeriesSonificationContextTracksValueMapFunction ValueMapFunction { get; set; }
		private PsarSeriesSonificationContextTracksValueMapFunction ValueMapFunction_DefaultValue { get; set; }
