...
{
	public partial class PsarSeriesSonificationContextTracksMapping  : BaseObject
	{
		Hashtable h = new Hashtable();

		public PsarSeriesSonificationContextTracksMapping()
		{
			Frequency = Frequency_DefaultValue = new PsarSeriesSonificationContextTracksMappingFrequency();
			GapBetweenNotes = GapBetweenNotes_DefaultValue = new PsarSeriesSonificationContextTracksMappingGapBetweenNotes();
			Highpass = Highpass_DefaultValue = new PsarSeriesSonificationContextTracksMappingHighpass();
			Lowpass = Lowpass_DefaultValue = new PsarSeriesSonificationContextTracksMappingLowpass();
			NoteDuration = NoteDuration_DefaultValue = new PsarSeriesSonificationContextTracksMappingNoteDuration();
			Pan = Pan_DefaultValue = new PsarSeriesSonificationContextTracksMappingPan();
			Pitch = Pitch_DefaultValue = new PsarSeriesSonificationContextTracksMappingPitch();
			PitchString = PitchString_DefaultValue = "null";
			PitchNumber = PitchNumber_DefaultValue = null;
			PlayDelay = PlayDelay_DefaultValue = new PsarSeriesSonificationContextTracksMappingPlayDelay();
			Time = Time_DefaultValue = new PsarSeriesSonificationContextTracksMappingTime();
			TimeString = TimeString_DefaultValue = "null";
			TimeNumber = TimeNumber_DefaultValue = null;
			Tremolo = Tremolo_DefaultValue = new PsarSeriesSonificationContextTracksMappingTremolo();
			Volume = Volume_DefaultValue = new PsarSeriesSonificationContextTracksMappingVolume();
		...
		/// </summary>
		public PsarSeriesSonificationContextTracksMappingFrequency Frequency { get; set; }
		private PsarSeriesSonificationContextTracksMappingFrequency Frequency_DefaultValue { get; set; }
		...
		/// </summary>
		public PsarSeriesSonificationContextTracksMappingGapBetweenNotes GapBetweenNotes { get; set; }
		private PsarSeriesSonificationContextTracksMappingGapBetweenNotes GapBetweenNotes_DefaultValue { get; set; }
		...
		/// </summary>
		public PsarSeriesSonificationContextTracksMappingHighpass Highpass { get; set; }
		private PsarSeriesSonificationContextTracksMappingHighpass Highpass_DefaultValue { get; set; }
		...
		/// </summary>
		public PsarSeriesSonificationContextTracksMappingLowpass Lowpass { get; set; }
		private PsarSeriesSonificationContextTracksMappingLowpass Lowpass_DefaultValue { get; set; }
		...
		/// </summary>
		public PsarSeriesSonificationContextTracksMappingNoteDuration NoteDuration { get; set; }
		private PsarSeriesSonificationContextTracksMappingNoteDuration NoteDuration_DefaultValue { get; set; }
		...
		/// </summary>
		public PsarSeriesSonificationContextTracksMappingPan Pan { get; set; }
		private PsarSeriesSonificationContextTracksMappingPan Pan_DefaultValue { get; set; }
		...
		/// </summary>
		public PsarSeriesSonificationContextTracksMappingPitch Pitch { get; set; }
		private PsarSeriesSonificationContextTracksMappingPitch Pitch_DefaultValue { get; set; }
		...
		/// </summary>
		public PsarSeriesSonificationContextTracksMappingPlayDelay PlayDelay { get; set; }
		private PsarSeriesSonificationContextTracksMappingPlayDelay PlayDelay_DefaultValue { get; set; }
		...
		/// </summary>
		public PsarSeriesSonificationContextTracksMappingTime Time { get; set; }
		private PsarSeriesSonificationContextTracksMappingTime Time_DefaultValue { get; set; }
		...
		/// </summary>
		public PsarSeriesSonificationContextTracksMappingTremolo Tremolo { get; set; }
		private PsarSeriesSonificationContextTracksMappingTremolo Tremolo_DefaultValue { get; set; }
		 

		/// <summary>
		/// The volume of notes, from 0 to 1.
		/// </summary>
		public PsarSeriesSonificationContextTracksMappingVolume Volume { get; set; }
		private PsarSeriesSonificationContextTracksMappingVolume Volume_DefaultValue { get; set; }
