...
{
	public partial class PsarSeriesSonificationContextTracksMappingFrequency  : BaseObject
	{
		Hashtable h = new Hashtable();

		public PsarSeriesSonificationContextTracksMappingFrequency()
		{
			MapFunction = MapFunction_DefaultValue = PsarSeriesSonificationContextTracksMappingFrequencyMapFunction.Linear;
			MapTo = MapTo_DefaultValue = "";
			Max = Max_DefaultValue = null;
			Min = Min_DefaultValue = null;
			Value = Value_DefaultValue = null;
			Within = Within_DefaultValue = PsarSeriesSonificationContextTracksMappingFrequencyWithin.Chart;
		...
		/// </summary>
		public PsarSeriesSonificationContextTracksMappingFrequencyMapFunction MapFunction { get; set; }
		private PsarSeriesSonificationContextTracksMappingFrequencyMapFunction MapFunction_DefaultValue { get; set; }
		...
		/// </summary>
		public PsarSeriesSonificationContextTracksMappingFrequencyWithin Within { get; set; }
		private PsarSeriesSonificationContextTracksMappingFrequencyWithin Within_DefaultValue { get; set; }
