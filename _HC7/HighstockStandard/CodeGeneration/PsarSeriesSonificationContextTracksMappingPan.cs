...
{
	public partial class PsarSeriesSonificationContextTracksMappingPan  : BaseObject
	{
		Hashtable h = new Hashtable();

		public PsarSeriesSonificationContextTracksMappingPan()
		{
			MapFunction = MapFunction_DefaultValue = PsarSeriesSonificationContextTracksMappingPanMapFunction.Linear;
			MapTo = MapTo_DefaultValue = "";
			Max = Max_DefaultValue = null;
			Min = Min_DefaultValue = null;
			Value = Value_DefaultValue = null;
			Within = Within_DefaultValue = PsarSeriesSonificationContextTracksMappingPanWithin.Chart;
		...
		/// </summary>
		public PsarSeriesSonificationContextTracksMappingPanMapFunction MapFunction { get; set; }
		private PsarSeriesSonificationContextTracksMappingPanMapFunction MapFunction_DefaultValue { get; set; }
		...
		/// </summary>
		public PsarSeriesSonificationContextTracksMappingPanWithin Within { get; set; }
		private PsarSeriesSonificationContextTracksMappingPanWithin Within_DefaultValue { get; set; }
