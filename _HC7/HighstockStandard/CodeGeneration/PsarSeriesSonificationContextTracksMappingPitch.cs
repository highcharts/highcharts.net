...
{
	public partial class PsarSeriesSonificationContextTracksMappingPitch  : BaseObject
	{
		Hashtable h = new Hashtable();

		public PsarSeriesSonificationContextTracksMappingPitch()
		{
			MapFunction = MapFunction_DefaultValue = PsarSeriesSonificationContextTracksMappingPitchMapFunction.Linear;
		...
		/// </summary>
		public PsarSeriesSonificationContextTracksMappingPitchMapFunction MapFunction { get; set; }
		private PsarSeriesSonificationContextTracksMappingPitchMapFunction MapFunction_DefaultValue { get; set; }
