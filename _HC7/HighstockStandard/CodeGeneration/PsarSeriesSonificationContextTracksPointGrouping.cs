...
{
	public partial class PsarSeriesSonificationContextTracksPointGrouping  : BaseObject
	{
		Hashtable h = new Hashtable();

		public PsarSeriesSonificationContextTracksPointGrouping()
		{
			Algorithm = Algorithm_DefaultValue = PsarSeriesSonificationContextTracksPointGroupingAlgorithm.Minimax;
		...
		/// </summary>
		public PsarSeriesSonificationContextTracksPointGroupingAlgorithm Algorithm { get; set; }
		private PsarSeriesSonificationContextTracksPointGroupingAlgorithm Algorithm_DefaultValue { get; set; }
