...
{
	public partial class PsarSeriesSonificationDefaultInstrumentOptions  : BaseObject
	{
		Hashtable h = new Hashtable();

		public PsarSeriesSonificationDefaultInstrumentOptions()
		{
			ActiveWhen = ActiveWhen_DefaultValue = new PsarSeriesSonificationDefaultInstrumentOptionsActiveWhen();
			Instrument = Instrument_DefaultValue = null;
			InstrumentString = InstrumentString_DefaultValue = "null";
			Mapping = Mapping_DefaultValue = new PsarSeriesSonificationDefaultInstrumentOptionsMapping();
			MidiName = MidiName_DefaultValue = "";
			PointGrouping = PointGrouping_DefaultValue = new PsarSeriesSonificationDefaultInstrumentOptionsPointGrouping();
			RoundToMusicalNotes = RoundToMusicalNotes_DefaultValue = true;
			ShowPlayMarker = ShowPlayMarker_DefaultValue = true;
			Type = Type_DefaultValue = PsarSeriesSonificationDefaultInstrumentOptionsType.Instrument;
		...
		/// </summary>
		public PsarSeriesSonificationDefaultInstrumentOptionsActiveWhen ActiveWhen { get; set; }
		private PsarSeriesSonificationDefaultInstrumentOptionsActiveWhen ActiveWhen_DefaultValue { get; set; }
		...
		/// </summary>
		public PsarSeriesSonificationDefaultInstrumentOptionsMapping Mapping { get; set; }
		private PsarSeriesSonificationDefaultInstrumentOptionsMapping Mapping_DefaultValue { get; set; }
		...
		/// </summary>
		public PsarSeriesSonificationDefaultInstrumentOptionsPointGrouping PointGrouping { get; set; }
		private PsarSeriesSonificationDefaultInstrumentOptionsPointGrouping PointGrouping_DefaultValue { get; set; }
		...
		/// </summary>
		public PsarSeriesSonificationDefaultInstrumentOptionsType Type { get; set; }
		private PsarSeriesSonificationDefaultInstrumentOptionsType Type_DefaultValue { get; set; }
