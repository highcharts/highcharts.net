...
{
	public partial class PsarSeriesSonificationDefaultInstrumentOptionsMappingNoteDuration  : BaseObject
	{
		Hashtable h = new Hashtable();

		public PsarSeriesSonificationDefaultInstrumentOptionsMappingNoteDuration()
		{
			MapFunction = MapFunction_DefaultValue = PsarSeriesSonificationDefaultInstrumentOptionsMappingNoteDurationMapFunction.Linear;
			MapTo = MapTo_DefaultValue = "";
			Max = Max_DefaultValue = null;
			Min = Min_DefaultValue = null;
			Value = Value_DefaultValue = null;
			Within = Within_DefaultValue = PsarSeriesSonificationDefaultInstrumentOptionsMappingNoteDurationWithin.Chart;
		...
		/// </summary>
		public PsarSeriesSonificationDefaultInstrumentOptionsMappingNoteDurationMapFunction MapFunction { get; set; }
		private PsarSeriesSonificationDefaultInstrumentOptionsMappingNoteDurationMapFunction MapFunction_DefaultValue { get; set; }
		...
		/// </summary>
		public PsarSeriesSonificationDefaultInstrumentOptionsMappingNoteDurationWithin Within { get; set; }
		private PsarSeriesSonificationDefaultInstrumentOptionsMappingNoteDurationWithin Within_DefaultValue { get; set; }
