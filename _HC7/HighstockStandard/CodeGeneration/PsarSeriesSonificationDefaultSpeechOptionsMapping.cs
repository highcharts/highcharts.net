...
{
	public partial class PsarSeriesSonificationDefaultSpeechOptionsMapping  : BaseObject
	{
		Hashtable h = new Hashtable();

		public PsarSeriesSonificationDefaultSpeechOptionsMapping()
		{
			Frequency = Frequency_DefaultValue = new PsarSeriesSonificationDefaultSpeechOptionsMappingFrequency();
			GapBetweenNotes = GapBetweenNotes_DefaultValue = new PsarSeriesSonificationDefaultSpeechOptionsMappingGapBetweenNotes();
			Highpass = Highpass_DefaultValue = new PsarSeriesSonificationDefaultSpeechOptionsMappingHighpass();
			Lowpass = Lowpass_DefaultValue = new PsarSeriesSonificationDefaultSpeechOptionsMappingLowpass();
			NoteDuration = NoteDuration_DefaultValue = new PsarSeriesSonificationDefaultSpeechOptionsMappingNoteDuration();
			Pan = Pan_DefaultValue = new PsarSeriesSonificationDefaultSpeechOptionsMappingPan();
			Pitch = Pitch_DefaultValue = new PsarSeriesSonificationDefaultSpeechOptionsMappingPitch();
			PitchString = PitchString_DefaultValue = "null";
			PitchNumber = PitchNumber_DefaultValue = null;
			PlayDelay = PlayDelay_DefaultValue = new PsarSeriesSonificationDefaultSpeechOptionsMappingPlayDelay();
			Time = Time_DefaultValue = new PsarSeriesSonificationDefaultSpeechOptionsMappingTime();
			TimeString = TimeString_DefaultValue = "null";
			TimeNumber = TimeNumber_DefaultValue = null;
			Tremolo = Tremolo_DefaultValue = new PsarSeriesSonificationDefaultSpeechOptionsMappingTremolo();
			Volume = Volume_DefaultValue = new PsarSeriesSonificationDefaultSpeechOptionsMappingVolume();
		...
		/// </summary>
		public PsarSeriesSonificationDefaultSpeechOptionsMappingFrequency Frequency { get; set; }
		private PsarSeriesSonificationDefaultSpeechOptionsMappingFrequency Frequency_DefaultValue { get; set; }
		...
		/// </summary>
		public PsarSeriesSonificationDefaultSpeechOptionsMappingGapBetweenNotes GapBetweenNotes { get; set; }
		private PsarSeriesSonificationDefaultSpeechOptionsMappingGapBetweenNotes GapBetweenNotes_DefaultValue { get; set; }
		...
		/// </summary>
		public PsarSeriesSonificationDefaultSpeechOptionsMappingHighpass Highpass { get; set; }
		private PsarSeriesSonificationDefaultSpeechOptionsMappingHighpass Highpass_DefaultValue { get; set; }
		...
		/// </summary>
		public PsarSeriesSonificationDefaultSpeechOptionsMappingLowpass Lowpass { get; set; }
		private PsarSeriesSonificationDefaultSpeechOptionsMappingLowpass Lowpass_DefaultValue { get; set; }
		...
		/// </summary>
		public PsarSeriesSonificationDefaultSpeechOptionsMappingNoteDuration NoteDuration { get; set; }
		private PsarSeriesSonificationDefaultSpeechOptionsMappingNoteDuration NoteDuration_DefaultValue { get; set; }
		...
		/// </summary>
		public PsarSeriesSonificationDefaultSpeechOptionsMappingPan Pan { get; set; }
		private PsarSeriesSonificationDefaultSpeechOptionsMappingPan Pan_DefaultValue { get; set; }
		...
		/// </summary>
		public PsarSeriesSonificationDefaultSpeechOptionsMappingPitch Pitch { get; set; }
		private PsarSeriesSonificationDefaultSpeechOptionsMappingPitch Pitch_DefaultValue { get; set; }
		...
		/// </summary>
		public PsarSeriesSonificationDefaultSpeechOptionsMappingPlayDelay PlayDelay { get; set; }
		private PsarSeriesSonificationDefaultSpeechOptionsMappingPlayDelay PlayDelay_DefaultValue { get; set; }
		...
		/// </summary>
		public PsarSeriesSonificationDefaultSpeechOptionsMappingTime Time { get; set; }
		private PsarSeriesSonificationDefaultSpeechOptionsMappingTime Time_DefaultValue { get; set; }
		...
		/// </summary>
		public PsarSeriesSonificationDefaultSpeechOptionsMappingTremolo Tremolo { get; set; }
		private PsarSeriesSonificationDefaultSpeechOptionsMappingTremolo Tremolo_DefaultValue { get; set; }
		 

		/// <summary>
		/// The volume of notes, from 0 to 1.
		/// </summary>
		public PsarSeriesSonificationDefaultSpeechOptionsMappingVolume Volume { get; set; }
		private PsarSeriesSonificationDefaultSpeechOptionsMappingVolume Volume_DefaultValue { get; set; }
