...
{
	public partial class PsarSeriesSonificationDefaultSpeechOptionsMappingGapBetweenNotes  : BaseObject
	{
		Hashtable h = new Hashtable();

		public PsarSeriesSonificationDefaultSpeechOptionsMappingGapBetweenNotes()
		{
			MapFunction = MapFunction_DefaultValue = PsarSeriesSonificationDefaultSpeechOptionsMappingGapBetweenNotesMapFunction.Linear;
			MapTo = MapTo_DefaultValue = "";
			Max = Max_DefaultValue = null;
			Min = Min_DefaultValue = null;
			Value = Value_DefaultValue = null;
			Within = Within_DefaultValue = PsarSeriesSonificationDefaultSpeechOptionsMappingGapBetweenNotesWithin.Chart;
		...
		/// </summary>
		public PsarSeriesSonificationDefaultSpeechOptionsMappingGapBetweenNotesMapFunction MapFunction { get; set; }
		private PsarSeriesSonificationDefaultSpeechOptionsMappingGapBetweenNotesMapFunction MapFunction_DefaultValue { get; set; }
		...
		/// </summary>
		public PsarSeriesSonificationDefaultSpeechOptionsMappingGapBetweenNotesWithin Within { get; set; }
		private PsarSeriesSonificationDefaultSpeechOptionsMappingGapBetweenNotesWithin Within_DefaultValue { get; set; }
