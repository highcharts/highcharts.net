...
{
	public partial class PsarSeriesSonificationTracks  : BaseObject
	{
		Hashtable h = new Hashtable();

		public PsarSeriesSonificationTracks()
		{
			ActiveWhen = ActiveWhen_DefaultValue = new PsarSeriesSonificationTracksActiveWhen();
			Instrument = Instrument_DefaultValue = null;
			InstrumentString = InstrumentString_DefaultValue = "null";
			Mapping = Mapping_DefaultValue = new PsarSeriesSonificationTracksMapping();
			MidiName = MidiName_DefaultValue = "";
			PointGrouping = PointGrouping_DefaultValue = new PsarSeriesSonificationTracksPointGrouping();
			RoundToMusicalNotes = RoundToMusicalNotes_DefaultValue = true;
			ShowPlayMarker = ShowPlayMarker_DefaultValue = true;
			Type = Type_DefaultValue = PsarSeriesSonificationTracksType.Instrument;
		...
		/// </summary>
		public PsarSeriesSonificationTracksActiveWhen ActiveWhen { get; set; }
		private PsarSeriesSonificationTracksActiveWhen ActiveWhen_DefaultValue { get; set; }
		...
		/// </summary>
		public PsarSeriesSonificationTracksMapping Mapping { get; set; }
		private PsarSeriesSonificationTracksMapping Mapping_DefaultValue { get; set; }
		...
		/// </summary>
		public PsarSeriesSonificationTracksPointGrouping PointGrouping { get; set; }
		private PsarSeriesSonificationTracksPointGrouping PointGrouping_DefaultValue { get; set; }
		...
		/// </summary>
		public PsarSeriesSonificationTracksType Type { get; set; }
		private PsarSeriesSonificationTracksType Type_DefaultValue { get; set; }
