...
{
	public partial class PsarSeriesSonificationTracksMapping  : BaseObject
	{
		Hashtable h = new Hashtable();

		public PsarSeriesSonificationTracksMapping()
		{
			Frequency = Frequency_DefaultValue = new PsarSeriesSonificationTracksMappingFrequency();
			GapBetweenNotes = GapBetweenNotes_DefaultValue = new PsarSeriesSonificationTracksMappingGapBetweenNotes();
			Highpass = Highpass_DefaultValue = new PsarSeriesSonificationTracksMappingHighpass();
			Lowpass = Lowpass_DefaultValue = new PsarSeriesSonificationTracksMappingLowpass();
			NoteDuration = NoteDuration_DefaultValue = new PsarSeriesSonificationTracksMappingNoteDuration();
			Pan = Pan_DefaultValue = new PsarSeriesSonificationTracksMappingPan();
			Pitch = Pitch_DefaultValue = new PsarSeriesSonificationTracksMappingPitch();
			PitchString = PitchString_DefaultValue = "null";
			PitchNumber = PitchNumber_DefaultValue = null;
			PlayDelay = PlayDelay_DefaultValue = new PsarSeriesSonificationTracksMappingPlayDelay();
			Time = Time_DefaultValue = new PsarSeriesSonificationTracksMappingTime();
			TimeString = TimeString_DefaultValue = "null";
			TimeNumber = TimeNumber_DefaultValue = null;
			Tremolo = Tremolo_DefaultValue = new PsarSeriesSonificationTracksMappingTremolo();
			Volume = Volume_DefaultValue = new PsarSeriesSonificationTracksMappingVolume();
		...
		/// </summary>
		public PsarSeriesSonificationTracksMappingFrequency Frequency { get; set; }
		private PsarSeriesSonificationTracksMappingFrequency Frequency_DefaultValue { get; set; }
		...
		/// </summary>
		public PsarSeriesSonificationTracksMappingGapBetweenNotes GapBetweenNotes { get; set; }
		private PsarSeriesSonificationTracksMappingGapBetweenNotes GapBetweenNotes_DefaultValue { get; set; }
		...
		/// </summary>
		public PsarSeriesSonificationTracksMappingHighpass Highpass { get; set; }
		private PsarSeriesSonificationTracksMappingHighpass Highpass_DefaultValue { get; set; }
		...
		/// </summary>
		public PsarSeriesSonificationTracksMappingLowpass Lowpass { get; set; }
		private PsarSeriesSonificationTracksMappingLowpass Lowpass_DefaultValue { get; set; }
		...
		/// </summary>
		public PsarSeriesSonificationTracksMappingNoteDuration NoteDuration { get; set; }
		private PsarSeriesSonificationTracksMappingNoteDuration NoteDuration_DefaultValue { get; set; }
		...
		/// </summary>
		public PsarSeriesSonificationTracksMappingPan Pan { get; set; }
		private PsarSeriesSonificationTracksMappingPan Pan_DefaultValue { get; set; }
		...
		/// </summary>
		public PsarSeriesSonificationTracksMappingPitch Pitch { get; set; }
		private PsarSeriesSonificationTracksMappingPitch Pitch_DefaultValue { get; set; }
		...
		/// </summary>
		public PsarSeriesSonificationTracksMappingPlayDelay PlayDelay { get; set; }
		private PsarSeriesSonificationTracksMappingPlayDelay PlayDelay_DefaultValue { get; set; }
		...
		/// </summary>
		public PsarSeriesSonificationTracksMappingTime Time { get; set; }
		private PsarSeriesSonificationTracksMappingTime Time_DefaultValue { get; set; }
		...
		/// </summary>
		public PsarSeriesSonificationTracksMappingTremolo Tremolo { get; set; }
		private PsarSeriesSonificationTracksMappingTremolo Tremolo_DefaultValue { get; set; }
		 

		/// <summary>
		/// The volume of notes, from 0 to 1.
		/// </summary>
		public PsarSeriesSonificationTracksMappingVolume Volume { get; set; }
		private PsarSeriesSonificationTracksMappingVolume Volume_DefaultValue { get; set; }
