...
{
	public partial class PsarSeriesSonificationTracksMappingFrequency  : BaseObject
	{
		Hashtable h = new Hashtable();

		public PsarSeriesSonificationTracksMappingFrequency()
		{
			MapFunction = MapFunction_DefaultValue = PsarSeriesSonificationTracksMappingFrequencyMapFunction.Linear;
			MapTo = MapTo_DefaultValue = "";
			Max = Max_DefaultValue = null;
			Min = Min_DefaultValue = null;
			Value = Value_DefaultValue = null;
			Within = Within_DefaultValue = PsarSeriesSonificationTracksMappingFrequencyWithin.Chart;
		...
		/// </summary>
		public PsarSeriesSonificationTracksMappingFrequencyMapFunction MapFunction { get; set; }
		private PsarSeriesSonificationTracksMappingFrequencyMapFunction MapFunction_DefaultValue { get; set; }
		...
		/// </summary>
		public PsarSeriesSonificationTracksMappingFrequencyWithin Within { get; set; }
		private PsarSeriesSonificationTracksMappingFrequencyWithin Within_DefaultValue { get; set; }
