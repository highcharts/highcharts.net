...
{
	public partial class PsarSeriesSonificationTracksMappingLowpassResonance  : BaseObject
	{
		Hashtable h = new Hashtable();

		public PsarSeriesSonificationTracksMappingLowpassResonance()
		{
			MapFunction = MapFunction_DefaultValue = PsarSeriesSonificationTracksMappingLowpassResonanceMapFunction.Linear;
			MapTo = MapTo_DefaultValue = "";
			Max = Max_DefaultValue = null;
			Min = Min_DefaultValue = null;
			Value = Value_DefaultValue = null;
			Within = Within_DefaultValue = PsarSeriesSonificationTracksMappingLowpassResonanceWithin.Chart;
		...
		/// </summary>
		public PsarSeriesSonificationTracksMappingLowpassResonanceMapFunction MapFunction { get; set; }
		private PsarSeriesSonificationTracksMappingLowpassResonanceMapFunction MapFunction_DefaultValue { get; set; }
		...
		/// </summary>
		public PsarSeriesSonificationTracksMappingLowpassResonanceWithin Within { get; set; }
		private PsarSeriesSonificationTracksMappingLowpassResonanceWithin Within_DefaultValue { get; set; }
