...
{
	public partial class PsarSeriesSonificationTracksMappingPan  : BaseObject
	{
		Hashtable h = new Hashtable();

		public PsarSeriesSonificationTracksMappingPan()
		{
			MapFunction = MapFunction_DefaultValue = PsarSeriesSonificationTracksMappingPanMapFunction.Linear;
			MapTo = MapTo_DefaultValue = "";
			Max = Max_DefaultValue = null;
			Min = Min_DefaultValue = null;
			Value = Value_DefaultValue = null;
			Within = Within_DefaultValue = PsarSeriesSonificationTracksMappingPanWithin.Chart;
		...
		/// </summary>
		public PsarSeriesSonificationTracksMappingPanMapFunction MapFunction { get; set; }
		private PsarSeriesSonificationTracksMappingPanMapFunction MapFunction_DefaultValue { get; set; }
		...
		/// </summary>
		public PsarSeriesSonificationTracksMappingPanWithin Within { get; set; }
		private PsarSeriesSonificationTracksMappingPanWithin Within_DefaultValue { get; set; }
