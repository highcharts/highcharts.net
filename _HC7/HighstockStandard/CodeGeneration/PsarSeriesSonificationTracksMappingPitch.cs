...
{
	public partial class PsarSeriesSonificationTracksMappingPitch  : BaseObject
	{
		Hashtable h = new Hashtable();

		public PsarSeriesSonificationTracksMappingPitch()
		{
			MapFunction = MapFunction_DefaultValue = PsarSeriesSonificationTracksMappingPitchMapFunction.Linear;
		...
		/// </summary>
		public PsarSeriesSonificationTracksMappingPitchMapFunction MapFunction { get; set; }
		private PsarSeriesSonificationTracksMappingPitchMapFunction MapFunction_DefaultValue { get; set; }
