...
{
	public partial class PsarSeriesSonificationTracksMappingPlayDelay  : BaseObject
	{
		Hashtable h = new Hashtable();

		public PsarSeriesSonificationTracksMappingPlayDelay()
		{
			MapFunction = MapFunction_DefaultValue = PsarSeriesSonificationTracksMappingPlayDelayMapFunction.Linear;
			MapTo = MapTo_DefaultValue = "";
			Max = Max_DefaultValue = null;
			Min = Min_DefaultValue = null;
			Value = Value_DefaultValue = null;
			Within = Within_DefaultValue = PsarSeriesSonificationTracksMappingPlayDelayWithin.Chart;
		...
		/// </summary>
		public PsarSeriesSonificationTracksMappingPlayDelayMapFunction MapFunction { get; set; }
		private PsarSeriesSonificationTracksMappingPlayDelayMapFunction MapFunction_DefaultValue { get; set; }
		...
		/// </summary>
		public PsarSeriesSonificationTracksMappingPlayDelayWithin Within { get; set; }
		private PsarSeriesSonificationTracksMappingPlayDelayWithin Within_DefaultValue { get; set; }
