...
{
	public partial class PsarSeriesSonificationTracksMappingTime  : BaseObject
	{
		Hashtable h = new Hashtable();

		public PsarSeriesSonificationTracksMappingTime()
		{
			MapFunction = MapFunction_DefaultValue = PsarSeriesSonificationTracksMappingTimeMapFunction.Linear;
			MapTo = MapTo_DefaultValue = "";
			Max = Max_DefaultValue = null;
			Min = Min_DefaultValue = null;
			Value = Value_DefaultValue = null;
			Within = Within_DefaultValue = PsarSeriesSonificationTracksMappingTimeWithin.Chart;
		...
		/// </summary>
		public PsarSeriesSonificationTracksMappingTimeMapFunction MapFunction { get; set; }
		private PsarSeriesSonificationTracksMappingTimeMapFunction MapFunction_DefaultValue { get; set; }
		...
		/// </summary>
		public PsarSeriesSonificationTracksMappingTimeWithin Within { get; set; }
		private PsarSeriesSonificationTracksMappingTimeWithin Within_DefaultValue { get; set; }
