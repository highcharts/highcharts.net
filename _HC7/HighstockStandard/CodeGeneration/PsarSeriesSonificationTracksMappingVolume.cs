...
{
	public partial class PsarSeriesSonificationTracksMappingVolume  : BaseObject
	{
		Hashtable h = new Hashtable();

		public PsarSeriesSonificationTracksMappingVolume()
		{
			MapFunction = MapFunction_DefaultValue = PsarSeriesSonificationTracksMappingVolumeMapFunction.Linear;
			MapTo = MapTo_DefaultValue = "";
			Max = Max_DefaultValue = null;
			Min = Min_DefaultValue = null;
			Value = Value_DefaultValue = null;
			Within = Within_DefaultValue = PsarSeriesSonificationTracksMappingVolumeWithin.Chart;
		...
		/// </summary>
		public PsarSeriesSonificationTracksMappingVolumeMapFunction MapFunction { get; set; }
		private PsarSeriesSonificationTracksMappingVolumeMapFunction MapFunction_DefaultValue { get; set; }
		...
		/// </summary>
		public PsarSeriesSonificationTracksMappingVolumeWithin Within { get; set; }
		private PsarSeriesSonificationTracksMappingVolumeWithin Within_DefaultValue { get; set; }
