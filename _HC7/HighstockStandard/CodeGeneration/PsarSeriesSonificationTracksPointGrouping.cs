...
{
	public partial class PsarSeriesSonificationTracksPointGrouping  : BaseObject
	{
		Hashtable h = new Hashtable();

		public PsarSeriesSonificationTracksPointGrouping()
		{
			Algorithm = Algorithm_DefaultValue = PsarSeriesSonificationTracksPointGroupingAlgorithm.Minimax;
		...
		/// </summary>
		public PsarSeriesSonificationTracksPointGroupingAlgorithm Algorithm { get; set; }
		private PsarSeriesSonificationTracksPointGroupingAlgorithm Algorithm_DefaultValue { get; set; }
