...
{
	public partial class PsarSeriesTooltip  : BaseObject
	{
		public PsarSeriesTooltip()
		{
			...
			HeaderShape = HeaderShape_DefaultValue = PsarSeriesTooltipHeaderShape.Callout;
		...
		/// </summary>
		public PsarSeriesTooltipHeaderShape HeaderShape { get; set; }
		private PsarSeriesTooltipHeaderShape HeaderShape_DefaultValue { get; set; }
		...
		internal override Hashtable ToHashtable()
		{
			...
			if (NullFormatter != NullFormatter_DefaultValue) { h.Add("nullFormatter",NullFormatter); Highstock.AddFunction("PsarSeriesTooltipNullFormatter.nullFormatter", NullFormatter); }  
			if (Outside != Outside_DefaultValue) h.Add("outside",Outside);
			if (Padding != Padding_DefaultValue) h.Add("padding",Padding);
			if (PointFormat != PointFormat_DefaultValue) h.Add("pointFormat",PointFormat);
			if (PointFormatter != PointFormatter_DefaultValue) { h.Add("pointFormatter",PointFormatter); Highstock.AddFunction("PsarSeriesTooltipPointFormatter.pointFormatter", PointFormatter); }  
