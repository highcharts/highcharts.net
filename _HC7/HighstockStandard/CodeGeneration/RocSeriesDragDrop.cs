...
{
	public partial class RocSeriesDragDrop  : BaseObject
	{
		public RocSeriesDragDrop()
		{
			DraggableX = DraggableX_DefaultValue = null;
			DraggableY = DraggableY_DefaultValue = null;
			DragHandle = DragHandle_DefaultValue = new RocSeriesDragDropDragHandle();
			...
			GuideBox = GuideBox_DefaultValue = new RocSeriesDragDropGuideBox();
		...
		/// </summary>
		public RocSeriesDragDropDragHandle DragHandle { get; set; }
		private RocSeriesDragDropDragHandle DragHandle_DefaultValue { get; set; }
		...
		/// </summary>
		public RocSeriesDragDropGuideBox GuideBox { get; set; }
		private RocSeriesDragDropGuideBox GuideBox_DefaultValue { get; set; }
