...
{
	public partial class RocSeriesLastVisiblePriceLabel  : BaseObject
	{
		Hashtable h = new Hashtable();

		public RocSeriesLastVisiblePriceLabel()
		{
			Align = Align_DefaultValue = RocSeriesLastVisiblePriceLabelAlign.Null;
		...
		/// 
		/// </summary>
		public RocSeriesLastVisiblePriceLabelAlign Align { get; set; }
		private RocSeriesLastVisiblePriceLabelAlign Align_DefaultValue { get; set; }
