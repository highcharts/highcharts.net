...
{
	public partial class RocSeriesSonificationContextTracks  : BaseObject
	{
		Hashtable h = new Hashtable();

		public RocSeriesSonificationContextTracks()
		{
			ActiveWhen = ActiveWhen_DefaultValue = new RocSeriesSonificationContextTracksActiveWhen();
			Instrument = Instrument_DefaultValue = null;
			InstrumentString = InstrumentString_DefaultValue = "null";
			Mapping = Mapping_DefaultValue = new RocSeriesSonificationContextTracksMapping();
			MidiName = MidiName_DefaultValue = "";
			PointGrouping = PointGrouping_DefaultValue = new RocSeriesSonificationContextTracksPointGrouping();
			...
			Type = Type_DefaultValue = RocSeriesSonificationContextTracksType.Instrument;
			ValueInterval = ValueInterval_DefaultValue = null;
			ValueMapFunction = ValueMapFunction_DefaultValue = RocSeriesSonificationContextTracksValueMapFunction.Linear;
		...
		/// </summary>
		public RocSeriesSonificationContextTracksActiveWhen ActiveWhen { get; set; }
		private RocSeriesSonificationContextTracksActiveWhen ActiveWhen_DefaultValue { get; set; }
		...
		/// </summary>
		public RocSeriesSonificationContextTracksMapping Mapping { get; set; }
		private RocSeriesSonificationContextTracksMapping Mapping_DefaultValue { get; set; }
		...
		/// </summary>
		public RocSeriesSonificationContextTracksPointGrouping PointGrouping { get; set; }
		private RocSeriesSonificationContextTracksPointGrouping PointGrouping_DefaultValue { get; set; }
		...
		/// </summary>
		public RocSeriesSonificationContextTracksType Type { get; set; }
		private RocSeriesSonificationContextTracksType Type_DefaultValue { get; set; }
		...
		/// </summary>
		public RocSeriesSonificationContextTracksValueMapFunction ValueMapFunction { get; set; }
		private RocSeriesSonificationContextTracksValueMapFunction ValueMapFunction_DefaultValue { get; set; }
