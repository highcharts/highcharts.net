...
{
	public partial class RocSeriesSonificationContextTracksMapping  : BaseObject
	{
		Hashtable h = new Hashtable();

		public RocSeriesSonificationContextTracksMapping()
		{
			Frequency = Frequency_DefaultValue = new RocSeriesSonificationContextTracksMappingFrequency();
			GapBetweenNotes = GapBetweenNotes_DefaultValue = new RocSeriesSonificationContextTracksMappingGapBetweenNotes();
			Highpass = Highpass_DefaultValue = new RocSeriesSonificationContextTracksMappingHighpass();
			Lowpass = Lowpass_DefaultValue = new RocSeriesSonificationContextTracksMappingLowpass();
			NoteDuration = NoteDuration_DefaultValue = new RocSeriesSonificationContextTracksMappingNoteDuration();
			Pan = Pan_DefaultValue = new RocSeriesSonificationContextTracksMappingPan();
			Pitch = Pitch_DefaultValue = new RocSeriesSonificationContextTracksMappingPitch();
			PitchString = PitchString_DefaultValue = "null";
			PitchNumber = PitchNumber_DefaultValue = null;
			PlayDelay = PlayDelay_DefaultValue = new RocSeriesSonificationContextTracksMappingPlayDelay();
			Time = Time_DefaultValue = new RocSeriesSonificationContextTracksMappingTime();
			TimeString = TimeString_DefaultValue = "null";
			TimeNumber = TimeNumber_DefaultValue = null;
			Tremolo = Tremolo_DefaultValue = new RocSeriesSonificationContextTracksMappingTremolo();
			Volume = Volume_DefaultValue = new RocSeriesSonificationContextTracksMappingVolume();
		...
		/// </summary>
		public RocSeriesSonificationContextTracksMappingFrequency Frequency { get; set; }
		private RocSeriesSonificationContextTracksMappingFrequency Frequency_DefaultValue { get; set; }
		...
		/// </summary>
		public RocSeriesSonificationContextTracksMappingGapBetweenNotes GapBetweenNotes { get; set; }
		private RocSeriesSonificationContextTracksMappingGapBetweenNotes GapBetweenNotes_DefaultValue { get; set; }
		...
		/// </summary>
		public RocSeriesSonificationContextTracksMappingHighpass Highpass { get; set; }
		private RocSeriesSonificationContextTracksMappingHighpass Highpass_DefaultValue { get; set; }
		...
		/// </summary>
		public RocSeriesSonificationContextTracksMappingLowpass Lowpass { get; set; }
		private RocSeriesSonificationContextTracksMappingLowpass Lowpass_DefaultValue { get; set; }
		...
		/// </summary>
		public RocSeriesSonificationContextTracksMappingNoteDuration NoteDuration { get; set; }
		private RocSeriesSonificationContextTracksMappingNoteDuration NoteDuration_DefaultValue { get; set; }
		...
		/// </summary>
		public RocSeriesSonificationContextTracksMappingPan Pan { get; set; }
		private RocSeriesSonificationContextTracksMappingPan Pan_DefaultValue { get; set; }
		...
		/// </summary>
		public RocSeriesSonificationContextTracksMappingPitch Pitch { get; set; }
		private RocSeriesSonificationContextTracksMappingPitch Pitch_DefaultValue { get; set; }
		...
		/// </summary>
		public RocSeriesSonificationContextTracksMappingPlayDelay PlayDelay { get; set; }
		private RocSeriesSonificationContextTracksMappingPlayDelay PlayDelay_DefaultValue { get; set; }
		...
		/// </summary>
		public RocSeriesSonificationContextTracksMappingTime Time { get; set; }
		private RocSeriesSonificationContextTracksMappingTime Time_DefaultValue { get; set; }
		...
		/// </summary>
		public RocSeriesSonificationContextTracksMappingTremolo Tremolo { get; set; }
		private RocSeriesSonificationContextTracksMappingTremolo Tremolo_DefaultValue { get; set; }
		 

		/// <summary>
		/// The volume of notes, from 0 to 1.
		/// </summary>
		public RocSeriesSonificationContextTracksMappingVolume Volume { get; set; }
		private RocSeriesSonificationContextTracksMappingVolume Volume_DefaultValue { get; set; }
