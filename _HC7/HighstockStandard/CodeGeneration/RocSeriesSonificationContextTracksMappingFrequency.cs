...
{
	public partial class RocSeriesSonificationContextTracksMappingFrequency  : BaseObject
	{
		Hashtable h = new Hashtable();

		public RocSeriesSonificationContextTracksMappingFrequency()
		{
			MapFunction = MapFunction_DefaultValue = RocSeriesSonificationContextTracksMappingFrequencyMapFunction.Linear;
			MapTo = MapTo_DefaultValue = "";
			Max = Max_DefaultValue = null;
			Min = Min_DefaultValue = null;
			Value = Value_DefaultValue = null;
			Within = Within_DefaultValue = RocSeriesSonificationContextTracksMappingFrequencyWithin.Chart;
		...
		/// </summary>
		public RocSeriesSonificationContextTracksMappingFrequencyMapFunction MapFunction { get; set; }
		private RocSeriesSonificationContextTracksMappingFrequencyMapFunction MapFunction_DefaultValue { get; set; }
		...
		/// </summary>
		public RocSeriesSonificationContextTracksMappingFrequencyWithin Within { get; set; }
		private RocSeriesSonificationContextTracksMappingFrequencyWithin Within_DefaultValue { get; set; }
