...
{
	public partial class RocSeriesSonificationContextTracksMappingPan  : BaseObject
	{
		Hashtable h = new Hashtable();

		public RocSeriesSonificationContextTracksMappingPan()
		{
			MapFunction = MapFunction_DefaultValue = RocSeriesSonificationContextTracksMappingPanMapFunction.Linear;
			MapTo = MapTo_DefaultValue = "";
			Max = Max_DefaultValue = null;
			Min = Min_DefaultValue = null;
			Value = Value_DefaultValue = null;
			Within = Within_DefaultValue = RocSeriesSonificationContextTracksMappingPanWithin.Chart;
		...
		/// </summary>
		public RocSeriesSonificationContextTracksMappingPanMapFunction MapFunction { get; set; }
		private RocSeriesSonificationContextTracksMappingPanMapFunction MapFunction_DefaultValue { get; set; }
		...
		/// </summary>
		public RocSeriesSonificationContextTracksMappingPanWithin Within { get; set; }
		private RocSeriesSonificationContextTracksMappingPanWithin Within_DefaultValue { get; set; }
