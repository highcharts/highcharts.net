...
{
	public partial class RocSeriesSonificationContextTracksMappingPitch  : BaseObject
	{
		Hashtable h = new Hashtable();

		public RocSeriesSonificationContextTracksMappingPitch()
		{
			MapFunction = MapFunction_DefaultValue = RocSeriesSonificationContextTracksMappingPitchMapFunction.Linear;
		...
		/// </summary>
		public RocSeriesSonificationContextTracksMappingPitchMapFunction MapFunction { get; set; }
		private RocSeriesSonificationContextTracksMappingPitchMapFunction MapFunction_DefaultValue { get; set; }
