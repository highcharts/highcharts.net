...
{
	public partial class RocSeriesSonificationContextTracksMappingTime  : BaseObject
	{
		Hashtable h = new Hashtable();

		public RocSeriesSonificationContextTracksMappingTime()
		{
			MapFunction = MapFunction_DefaultValue = RocSeriesSonificationContextTracksMappingTimeMapFunction.Linear;
			MapTo = MapTo_DefaultValue = "";
			Max = Max_DefaultValue = null;
			Min = Min_DefaultValue = null;
			Value = Value_DefaultValue = null;
			Within = Within_DefaultValue = RocSeriesSonificationContextTracksMappingTimeWithin.Chart;
		...
		/// </summary>
		public RocSeriesSonificationContextTracksMappingTimeMapFunction MapFunction { get; set; }
		private RocSeriesSonificationContextTracksMappingTimeMapFunction MapFunction_DefaultValue { get; set; }
		...
		/// </summary>
		public RocSeriesSonificationContextTracksMappingTimeWithin Within { get; set; }
		private RocSeriesSonificationContextTracksMappingTimeWithin Within_DefaultValue { get; set; }
