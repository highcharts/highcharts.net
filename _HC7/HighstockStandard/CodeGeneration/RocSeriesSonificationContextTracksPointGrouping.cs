...
{
	public partial class RocSeriesSonificationContextTracksPointGrouping  : BaseObject
	{
		Hashtable h = new Hashtable();

		public RocSeriesSonificationContextTracksPointGrouping()
		{
			Algorithm = Algorithm_DefaultValue = RocSeriesSonificationContextTracksPointGroupingAlgorithm.Minimax;
		...
		/// </summary>
		public RocSeriesSonificationContextTracksPointGroupingAlgorithm Algorithm { get; set; }
		private RocSeriesSonificationContextTracksPointGroupingAlgorithm Algorithm_DefaultValue { get; set; }
