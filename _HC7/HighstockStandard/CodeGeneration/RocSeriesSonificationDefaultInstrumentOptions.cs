...
{
	public partial class RocSeriesSonificationDefaultInstrumentOptions  : BaseObject
	{
		Hashtable h = new Hashtable();

		public RocSeriesSonificationDefaultInstrumentOptions()
		{
			ActiveWhen = ActiveWhen_DefaultValue = new RocSeriesSonificationDefaultInstrumentOptionsActiveWhen();
			Instrument = Instrument_DefaultValue = null;
			InstrumentString = InstrumentString_DefaultValue = "null";
			Mapping = Mapping_DefaultValue = new RocSeriesSonificationDefaultInstrumentOptionsMapping();
			MidiName = MidiName_DefaultValue = "";
			PointGrouping = PointGrouping_DefaultValue = new RocSeriesSonificationDefaultInstrumentOptionsPointGrouping();
			RoundToMusicalNotes = RoundToMusicalNotes_DefaultValue = true;
			ShowPlayMarker = ShowPlayMarker_DefaultValue = true;
			Type = Type_DefaultValue = RocSeriesSonificationDefaultInstrumentOptionsType.Instrument;
		...
		/// </summary>
		public RocSeriesSonificationDefaultInstrumentOptionsActiveWhen ActiveWhen { get; set; }
		private RocSeriesSonificationDefaultInstrumentOptionsActiveWhen ActiveWhen_DefaultValue { get; set; }
		...
		/// </summary>
		public RocSeriesSonificationDefaultInstrumentOptionsMapping Mapping { get; set; }
		private RocSeriesSonificationDefaultInstrumentOptionsMapping Mapping_DefaultValue { get; set; }
		...
		/// </summary>
		public RocSeriesSonificationDefaultInstrumentOptionsPointGrouping PointGrouping { get; set; }
		private RocSeriesSonificationDefaultInstrumentOptionsPointGrouping PointGrouping_DefaultValue { get; set; }
		...
		/// </summary>
		public RocSeriesSonificationDefaultInstrumentOptionsType Type { get; set; }
		private RocSeriesSonificationDefaultInstrumentOptionsType Type_DefaultValue { get; set; }
