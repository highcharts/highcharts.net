...
{
	public partial class RocSeriesSonificationDefaultSpeechOptions  : BaseObject
	{
		Hashtable h = new Hashtable();

		public RocSeriesSonificationDefaultSpeechOptions()
		{
			ActiveWhen = ActiveWhen_DefaultValue = new RocSeriesSonificationDefaultSpeechOptionsActiveWhen();
			Language = Language_DefaultValue = "en-US";
			Mapping = Mapping_DefaultValue = new RocSeriesSonificationDefaultSpeechOptionsMapping();
			PointGrouping = PointGrouping_DefaultValue = new RocSeriesSonificationDefaultSpeechOptionsPointGrouping();
			PreferredVoice = PreferredVoice_DefaultValue = "";
			ShowPlayMarker = ShowPlayMarker_DefaultValue = true;
			Type = Type_DefaultValue = RocSeriesSonificationDefaultSpeechOptionsType.Instrument;
		...
		/// </summary>
		public RocSeriesSonificationDefaultSpeechOptionsActiveWhen ActiveWhen { get; set; }
		private RocSeriesSonificationDefaultSpeechOptionsActiveWhen ActiveWhen_DefaultValue { get; set; }
		...
		/// </summary>
		public RocSeriesSonificationDefaultSpeechOptionsMapping Mapping { get; set; }
		private RocSeriesSonificationDefaultSpeechOptionsMapping Mapping_DefaultValue { get; set; }
		 

		/// <summary>
		/// Options for point grouping, specifically for instrument tracks.
		/// </summary>
		public RocSeriesSonificationDefaultSpeechOptionsPointGrouping PointGrouping { get; set; }
		private RocSeriesSonificationDefaultSpeechOptionsPointGrouping PointGrouping_DefaultValue { get; set; }
		...
		/// </summary>
		public RocSeriesSonificationDefaultSpeechOptionsType Type { get; set; }
		private RocSeriesSonificationDefaultSpeechOptionsType Type_DefaultValue { get; set; }
