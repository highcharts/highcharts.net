...
{
	public partial class RocSeriesSonificationTracks  : BaseObject
	{
		Hashtable h = new Hashtable();

		public RocSeriesSonificationTracks()
		{
			ActiveWhen = ActiveWhen_DefaultValue = new RocSeriesSonificationTracksActiveWhen();
			Instrument = Instrument_DefaultValue = null;
			InstrumentString = InstrumentString_DefaultValue = "null";
			Mapping = Mapping_DefaultValue = new RocSeriesSonificationTracksMapping();
			MidiName = MidiName_DefaultValue = "";
			PointGrouping = PointGrouping_DefaultValue = new RocSeriesSonificationTracksPointGrouping();
			RoundToMusicalNotes = RoundToMusicalNotes_DefaultValue = true;
			ShowPlayMarker = ShowPlayMarker_DefaultValue = true;
			Type = Type_DefaultValue = RocSeriesSonificationTracksType.Instrument;
		...
		/// </summary>
		public RocSeriesSonificationTracksActiveWhen ActiveWhen { get; set; }
		private RocSeriesSonificationTracksActiveWhen ActiveWhen_DefaultValue { get; set; }
		...
		/// </summary>
		public RocSeriesSonificationTracksMapping Mapping { get; set; }
		private RocSeriesSonificationTracksMapping Mapping_DefaultValue { get; set; }
		...
		/// </summary>
		public RocSeriesSonificationTracksPointGrouping PointGrouping { get; set; }
		private RocSeriesSonificationTracksPointGrouping PointGrouping_DefaultValue { get; set; }
		...
		/// </summary>
		public RocSeriesSonificationTracksType Type { get; set; }
		private RocSeriesSonificationTracksType Type_DefaultValue { get; set; }
