...
{
	public partial class RocSeriesSonificationTracksMapping  : BaseObject
	{
		Hashtable h = new Hashtable();

		public RocSeriesSonificationTracksMapping()
		{
			Frequency = Frequency_DefaultValue = new RocSeriesSonificationTracksMappingFrequency();
			GapBetweenNotes = GapBetweenNotes_DefaultValue = new RocSeriesSonificationTracksMappingGapBetweenNotes();
			Highpass = Highpass_DefaultValue = new RocSeriesSonificationTracksMappingHighpass();
			Lowpass = Lowpass_DefaultValue = new RocSeriesSonificationTracksMappingLowpass();
			NoteDuration = NoteDuration_DefaultValue = new RocSeriesSonificationTracksMappingNoteDuration();
			Pan = Pan_DefaultValue = new RocSeriesSonificationTracksMappingPan();
			Pitch = Pitch_DefaultValue = new RocSeriesSonificationTracksMappingPitch();
			PitchString = PitchString_DefaultValue = "null";
			PitchNumber = PitchNumber_DefaultValue = null;
			PlayDelay = PlayDelay_DefaultValue = new RocSeriesSonificationTracksMappingPlayDelay();
			Time = Time_DefaultValue = new RocSeriesSonificationTracksMappingTime();
			TimeString = TimeString_DefaultValue = "null";
			TimeNumber = TimeNumber_DefaultValue = null;
			Tremolo = Tremolo_DefaultValue = new RocSeriesSonificationTracksMappingTremolo();
			Volume = Volume_DefaultValue = new RocSeriesSonificationTracksMappingVolume();
		...
		/// </summary>
		public RocSeriesSonificationTracksMappingFrequency Frequency { get; set; }
		private RocSeriesSonificationTracksMappingFrequency Frequency_DefaultValue { get; set; }
		...
		/// </summary>
		public RocSeriesSonificationTracksMappingGapBetweenNotes GapBetweenNotes { get; set; }
		private RocSeriesSonificationTracksMappingGapBetweenNotes GapBetweenNotes_DefaultValue { get; set; }
		...
		/// </summary>
		public RocSeriesSonificationTracksMappingHighpass Highpass { get; set; }
		private RocSeriesSonificationTracksMappingHighpass Highpass_DefaultValue { get; set; }
		...
		/// </summary>
		public RocSeriesSonificationTracksMappingLowpass Lowpass { get; set; }
		private RocSeriesSonificationTracksMappingLowpass Lowpass_DefaultValue { get; set; }
		...
		/// </summary>
		public RocSeriesSonificationTracksMappingNoteDuration NoteDuration { get; set; }
		private RocSeriesSonificationTracksMappingNoteDuration NoteDuration_DefaultValue { get; set; }
		...
		/// </summary>
		public RocSeriesSonificationTracksMappingPan Pan { get; set; }
		private RocSeriesSonificationTracksMappingPan Pan_DefaultValue { get; set; }
		...
		/// </summary>
		public RocSeriesSonificationTracksMappingPitch Pitch { get; set; }
		private RocSeriesSonificationTracksMappingPitch Pitch_DefaultValue { get; set; }
		...
		/// </summary>
		public RocSeriesSonificationTracksMappingPlayDelay PlayDelay { get; set; }
		private RocSeriesSonificationTracksMappingPlayDelay PlayDelay_DefaultValue { get; set; }
		...
		/// </summary>
		public RocSeriesSonificationTracksMappingTime Time { get; set; }
		private RocSeriesSonificationTracksMappingTime Time_DefaultValue { get; set; }
		...
		/// </summary>
		public RocSeriesSonificationTracksMappingTremolo Tremolo { get; set; }
		private RocSeriesSonificationTracksMappingTremolo Tremolo_DefaultValue { get; set; }
		 

		/// <summary>
		/// The volume of notes, from 0 to 1.
		/// </summary>
		public RocSeriesSonificationTracksMappingVolume Volume { get; set; }
		private RocSeriesSonificationTracksMappingVolume Volume_DefaultValue { get; set; }
