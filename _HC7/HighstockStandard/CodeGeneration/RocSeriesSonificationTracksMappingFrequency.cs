...
{
	public partial class RocSeriesSonificationTracksMappingFrequency  : BaseObject
	{
		Hashtable h = new Hashtable();

		public RocSeriesSonificationTracksMappingFrequency()
		{
			MapFunction = MapFunction_DefaultValue = RocSeriesSonificationTracksMappingFrequencyMapFunction.Linear;
			MapTo = MapTo_DefaultValue = "";
			Max = Max_DefaultValue = null;
			Min = Min_DefaultValue = null;
			Value = Value_DefaultValue = null;
			Within = Within_DefaultValue = RocSeriesSonificationTracksMappingFrequencyWithin.Chart;
		...
		/// </summary>
		public RocSeriesSonificationTracksMappingFrequencyMapFunction MapFunction { get; set; }
		private RocSeriesSonificationTracksMappingFrequencyMapFunction MapFunction_DefaultValue { get; set; }
		...
		/// </summary>
		public RocSeriesSonificationTracksMappingFrequencyWithin Within { get; set; }
		private RocSeriesSonificationTracksMappingFrequencyWithin Within_DefaultValue { get; set; }
