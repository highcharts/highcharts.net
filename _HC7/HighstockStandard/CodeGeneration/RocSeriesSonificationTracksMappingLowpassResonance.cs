...
{
	public partial class RocSeriesSonificationTracksMappingLowpassResonance  : BaseObject
	{
		Hashtable h = new Hashtable();

		public RocSeriesSonificationTracksMappingLowpassResonance()
		{
			MapFunction = MapFunction_DefaultValue = RocSeriesSonificationTracksMappingLowpassResonanceMapFunction.Linear;
			MapTo = MapTo_DefaultValue = "";
			Max = Max_DefaultValue = null;
			Min = Min_DefaultValue = null;
			Value = Value_DefaultValue = null;
			Within = Within_DefaultValue = RocSeriesSonificationTracksMappingLowpassResonanceWithin.Chart;
		...
		/// </summary>
		public RocSeriesSonificationTracksMappingLowpassResonanceMapFunction MapFunction { get; set; }
		private RocSeriesSonificationTracksMappingLowpassResonanceMapFunction MapFunction_DefaultValue { get; set; }
		...
		/// </summary>
		public RocSeriesSonificationTracksMappingLowpassResonanceWithin Within { get; set; }
		private RocSeriesSonificationTracksMappingLowpassResonanceWithin Within_DefaultValue { get; set; }
