...
{
	public partial class RocSeriesSonificationTracksMappingNoteDuration  : BaseObject
	{
		Hashtable h = new Hashtable();

		public RocSeriesSonificationTracksMappingNoteDuration()
		{
			MapFunction = MapFunction_DefaultValue = RocSeriesSonificationTracksMappingNoteDurationMapFunction.Linear;
			MapTo = MapTo_DefaultValue = "";
			Max = Max_DefaultValue = null;
			Min = Min_DefaultValue = null;
			Value = Value_DefaultValue = null;
			Within = Within_DefaultValue = RocSeriesSonificationTracksMappingNoteDurationWithin.Chart;
		...
		/// </summary>
		public RocSeriesSonificationTracksMappingNoteDurationMapFunction MapFunction { get; set; }
		private RocSeriesSonificationTracksMappingNoteDurationMapFunction MapFunction_DefaultValue { get; set; }
		...
		/// </summary>
		public RocSeriesSonificationTracksMappingNoteDurationWithin Within { get; set; }
		private RocSeriesSonificationTracksMappingNoteDurationWithin Within_DefaultValue { get; set; }
