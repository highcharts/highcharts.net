...
{
	public partial class RocSeriesSonificationTracksMappingPan  : BaseObject
	{
		Hashtable h = new Hashtable();

		public RocSeriesSonificationTracksMappingPan()
		{
			MapFunction = MapFunction_DefaultValue = RocSeriesSonificationTracksMappingPanMapFunction.Linear;
			MapTo = MapTo_DefaultValue = "";
			Max = Max_DefaultValue = null;
			Min = Min_DefaultValue = null;
			Value = Value_DefaultValue = null;
			Within = Within_DefaultValue = RocSeriesSonificationTracksMappingPanWithin.Chart;
		...
		/// </summary>
		public RocSeriesSonificationTracksMappingPanMapFunction MapFunction { get; set; }
		private RocSeriesSonificationTracksMappingPanMapFunction MapFunction_DefaultValue { get; set; }
		...
		/// </summary>
		public RocSeriesSonificationTracksMappingPanWithin Within { get; set; }
		private RocSeriesSonificationTracksMappingPanWithin Within_DefaultValue { get; set; }
