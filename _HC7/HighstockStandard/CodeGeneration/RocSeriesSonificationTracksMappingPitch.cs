...
{
	public partial class RocSeriesSonificationTracksMappingPitch  : BaseObject
	{
		Hashtable h = new Hashtable();

		public RocSeriesSonificationTracksMappingPitch()
		{
			MapFunction = MapFunction_DefaultValue = RocSeriesSonificationTracksMappingPitchMapFunction.Linear;
		...
		/// </summary>
		public RocSeriesSonificationTracksMappingPitchMapFunction MapFunction { get; set; }
		private RocSeriesSonificationTracksMappingPitchMapFunction MapFunction_DefaultValue { get; set; }
