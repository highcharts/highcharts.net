...
{
	public partial class RocSeriesSonificationTracksMappingPlayDelay  : BaseObject
	{
		Hashtable h = new Hashtable();

		public RocSeriesSonificationTracksMappingPlayDelay()
		{
			MapFunction = MapFunction_DefaultValue = RocSeriesSonificationTracksMappingPlayDelayMapFunction.Linear;
			MapTo = MapTo_DefaultValue = "";
			Max = Max_DefaultValue = null;
			Min = Min_DefaultValue = null;
			Value = Value_DefaultValue = null;
			Within = Within_DefaultValue = RocSeriesSonificationTracksMappingPlayDelayWithin.Chart;
		...
		/// </summary>
		public RocSeriesSonificationTracksMappingPlayDelayMapFunction MapFunction { get; set; }
		private RocSeriesSonificationTracksMappingPlayDelayMapFunction MapFunction_DefaultValue { get; set; }
		...
		/// </summary>
		public RocSeriesSonificationTracksMappingPlayDelayWithin Within { get; set; }
		private RocSeriesSonificationTracksMappingPlayDelayWithin Within_DefaultValue { get; set; }
