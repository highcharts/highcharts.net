...
{
	public partial class RocSeriesSonificationTracksMappingTime  : BaseObject
	{
		Hashtable h = new Hashtable();

		public RocSeriesSonificationTracksMappingTime()
		{
			MapFunction = MapFunction_DefaultValue = RocSeriesSonificationTracksMappingTimeMapFunction.Linear;
			MapTo = MapTo_DefaultValue = "";
			Max = Max_DefaultValue = null;
			Min = Min_DefaultValue = null;
			Value = Value_DefaultValue = null;
			Within = Within_DefaultValue = RocSeriesSonificationTracksMappingTimeWithin.Chart;
		...
		/// </summary>
		public RocSeriesSonificationTracksMappingTimeMapFunction MapFunction { get; set; }
		private RocSeriesSonificationTracksMappingTimeMapFunction MapFunction_DefaultValue { get; set; }
		...
		/// </summary>
		public RocSeriesSonificationTracksMappingTimeWithin Within { get; set; }
		private RocSeriesSonificationTracksMappingTimeWithin Within_DefaultValue { get; set; }
