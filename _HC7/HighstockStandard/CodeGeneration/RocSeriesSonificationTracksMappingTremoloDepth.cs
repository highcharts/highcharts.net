...
{
	public partial class RocSeriesSonificationTracksMappingTremoloDepth  : BaseObject
	{
		Hashtable h = new Hashtable();

		public RocSeriesSonificationTracksMappingTremoloDepth()
		{
			MapFunction = MapFunction_DefaultValue = RocSeriesSonificationTracksMappingTremoloDepthMapFunction.Linear;
			MapTo = MapTo_DefaultValue = "";
			Max = Max_DefaultValue = null;
			Min = Min_DefaultValue = null;
			Value = Value_DefaultValue = null;
			Within = Within_DefaultValue = RocSeriesSonificationTracksMappingTremoloDepthWithin.Chart;
		...
		/// </summary>
		public RocSeriesSonificationTracksMappingTremoloDepthMapFunction MapFunction { get; set; }
		private RocSeriesSonificationTracksMappingTremoloDepthMapFunction MapFunction_DefaultValue { get; set; }
		...
		/// </summary>
		public RocSeriesSonificationTracksMappingTremoloDepthWithin Within { get; set; }
		private RocSeriesSonificationTracksMappingTremoloDepthWithin Within_DefaultValue { get; set; }
