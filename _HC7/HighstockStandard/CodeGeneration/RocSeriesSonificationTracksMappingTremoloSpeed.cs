...
{
	public partial class RocSeriesSonificationTracksMappingTremoloSpeed  : BaseObject
	{
		Hashtable h = new Hashtable();

		public RocSeriesSonificationTracksMappingTremoloSpeed()
		{
			MapFunction = MapFunction_DefaultValue = RocSeriesSonificationTracksMappingTremoloSpeedMapFunction.Linear;
			MapTo = MapTo_DefaultValue = "";
			Max = Max_DefaultValue = null;
			Min = Min_DefaultValue = null;
			Value = Value_DefaultValue = null;
			Within = Within_DefaultValue = RocSeriesSonificationTracksMappingTremoloSpeedWithin.Chart;
		...
		/// </summary>
		public RocSeriesSonificationTracksMappingTremoloSpeedMapFunction MapFunction { get; set; }
		private RocSeriesSonificationTracksMappingTremoloSpeedMapFunction MapFunction_DefaultValue { get; set; }
		...
		/// </summary>
		public RocSeriesSonificationTracksMappingTremoloSpeedWithin Within { get; set; }
		private RocSeriesSonificationTracksMappingTremoloSpeedWithin Within_DefaultValue { get; set; }
