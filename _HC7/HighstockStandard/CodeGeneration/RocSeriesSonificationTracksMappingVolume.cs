...
{
	public partial class RocSeriesSonificationTracksMappingVolume  : BaseObject
	{
		Hashtable h = new Hashtable();

		public RocSeriesSonificationTracksMappingVolume()
		{
			MapFunction = MapFunction_DefaultValue = RocSeriesSonificationTracksMappingVolumeMapFunction.Linear;
			MapTo = MapTo_DefaultValue = "";
			Max = Max_DefaultValue = null;
			Min = Min_DefaultValue = null;
			Value = Value_DefaultValue = null;
			Within = Within_DefaultValue = RocSeriesSonificationTracksMappingVolumeWithin.Chart;
		...
		/// </summary>
		public RocSeriesSonificationTracksMappingVolumeMapFunction MapFunction { get; set; }
		private RocSeriesSonificationTracksMappingVolumeMapFunction MapFunction_DefaultValue { get; set; }
		...
		/// </summary>
		public RocSeriesSonificationTracksMappingVolumeWithin Within { get; set; }
		private RocSeriesSonificationTracksMappingVolumeWithin Within_DefaultValue { get; set; }
