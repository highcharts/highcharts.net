...
{
	public partial class RocSeriesSonificationTracksPointGrouping  : BaseObject
	{
		Hashtable h = new Hashtable();

		public RocSeriesSonificationTracksPointGrouping()
		{
			Algorithm = Algorithm_DefaultValue = RocSeriesSonificationTracksPointGroupingAlgorithm.Minimax;
		...
		/// </summary>
		public RocSeriesSonificationTracksPointGroupingAlgorithm Algorithm { get; set; }
		private RocSeriesSonificationTracksPointGroupingAlgorithm Algorithm_DefaultValue { get; set; }
