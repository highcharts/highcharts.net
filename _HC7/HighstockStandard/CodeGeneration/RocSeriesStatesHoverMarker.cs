...
{
	public partial class RocSeriesStatesHoverMarker  : BaseObject
	{
		public RocSeriesStatesHoverMarker()
		{
			...
			States = States_DefaultValue = new RocSeriesStatesHoverMarkerStates();
		...
		/// </summary>
		public RocSeriesStatesHoverMarkerStates States { get; set; }
		private RocSeriesStatesHoverMarkerStates States_DefaultValue { get; set; }
