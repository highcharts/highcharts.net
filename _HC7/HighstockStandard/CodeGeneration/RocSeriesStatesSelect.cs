...
{
	public partial class RocSeriesStatesSelect  : BaseObject
	{
		Hashtable h = new Hashtable();

		public RocSeriesStatesSelect()
		{
			Animation = Animation_DefaultValue = new Animation() { Enabled = true };
			AnimationBool = AnimationBool_DefaultValue = null;
			Enabled = Enabled_DefaultValue = true;
			Halo = Halo_DefaultValue = new RocSeriesStatesSelectHalo();
			LineWidth = LineWidth_DefaultValue = null;
			LineWidthPlus = LineWidthPlus_DefaultValue = 1;
			Marker = Marker_DefaultValue = new RocSeriesStatesSelectMarker();
		...
		/// </summary>
		public RocSeriesStatesSelectHalo Halo { get; set; }
		private RocSeriesStatesSelectHalo Halo_DefaultValue { get; set; }
		...
		/// </summary>
		public RocSeriesStatesSelectMarker Marker { get; set; }
		private RocSeriesStatesSelectMarker Marker_DefaultValue { get; set; }
