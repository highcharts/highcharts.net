...
namespace Highsoft.Web.Mvc.Stocks
{
	public partial class RsiSeriesDataGrouping  : BaseObject
	{
		...
		internal override Hashtable ToHashtable()
		{
			...
			if (Approximation != Approximation_DefaultValue) { h.Add("approximation",Approximation); Highstock.AddFunction("RsiSeriesDataGroupingApproximation.approximation", Approximation); }  
