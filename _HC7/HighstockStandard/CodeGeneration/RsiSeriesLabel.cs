...
{
	public partial class RsiSeriesLabel  : BaseObject
	{
		public RsiSeriesLabel()
		{
			...
			Style = Style_DefaultValue = new RsiSeriesLabelStyle();
		...
		/// </summary>
		public RsiSeriesLabelStyle Style { get; set; }
		private RsiSeriesLabelStyle Style_DefaultValue { get; set; }
