...
{
	public partial class RsiSeriesLastPriceLabel  : BaseObject
	{
		Hashtable h = new Hashtable();

		public RsiSeriesLastPriceLabel()
		{
			Align = Align_DefaultValue = RsiSeriesLastPriceLabelAlign.Null;
		...
		/// 
		/// </summary>
		public RsiSeriesLastPriceLabelAlign Align { get; set; }
		private RsiSeriesLastPriceLabelAlign Align_DefaultValue { get; set; }
