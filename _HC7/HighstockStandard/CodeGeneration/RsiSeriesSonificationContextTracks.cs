...
{
	public partial class RsiSeriesSonificationContextTracks  : BaseObject
	{
		Hashtable h = new Hashtable();

		public RsiSeriesSonificationContextTracks()
		{
			ActiveWhen = ActiveWhen_DefaultValue = new RsiSeriesSonificationContextTracksActiveWhen();
			Instrument = Instrument_DefaultValue = null;
			InstrumentString = InstrumentString_DefaultValue = "null";
			Mapping = Mapping_DefaultValue = new RsiSeriesSonificationContextTracksMapping();
			MidiName = MidiName_DefaultValue = "";
			PointGrouping = PointGrouping_DefaultValue = new RsiSeriesSonificationContextTracksPointGrouping();
			...
			Type = Type_DefaultValue = RsiSeriesSonificationContextTracksType.Instrument;
			ValueInterval = ValueInterval_DefaultValue = null;
			ValueMapFunction = ValueMapFunction_DefaultValue = RsiSeriesSonificationContextTracksValueMapFunction.Linear;
		...
		/// </summary>
		public RsiSeriesSonificationContextTracksActiveWhen ActiveWhen { get; set; }
		private RsiSeriesSonificationContextTracksActiveWhen ActiveWhen_DefaultValue { get; set; }
		...
		/// </summary>
		public RsiSeriesSonificationContextTracksMapping Mapping { get; set; }
		private RsiSeriesSonificationContextTracksMapping Mapping_DefaultValue { get; set; }
		...
		/// </summary>
		public RsiSeriesSonificationContextTracksPointGrouping PointGrouping { get; set; }
		private RsiSeriesSonificationContextTracksPointGrouping PointGrouping_DefaultValue { get; set; }
		...
		/// </summary>
		public RsiSeriesSonificationContextTracksType Type { get; set; }
		private RsiSeriesSonificationContextTracksType Type_DefaultValue { get; set; }
		...
		/// </summary>
		public RsiSeriesSonificationContextTracksValueMapFunction ValueMapFunction { get; set; }
		private RsiSeriesSonificationContextTracksValueMapFunction ValueMapFunction_DefaultValue { get; set; }
