...
{
	public partial class RsiSeriesSonificationContextTracksMapping  : BaseObject
	{
		Hashtable h = new Hashtable();

		public RsiSeriesSonificationContextTracksMapping()
		{
			Frequency = Frequency_DefaultValue = new RsiSeriesSonificationContextTracksMappingFrequency();
			GapBetweenNotes = GapBetweenNotes_DefaultValue = new RsiSeriesSonificationContextTracksMappingGapBetweenNotes();
			Highpass = Highpass_DefaultValue = new RsiSeriesSonificationContextTracksMappingHighpass();
			Lowpass = Lowpass_DefaultValue = new RsiSeriesSonificationContextTracksMappingLowpass();
			NoteDuration = NoteDuration_DefaultValue = new RsiSeriesSonificationContextTracksMappingNoteDuration();
			Pan = Pan_DefaultValue = new RsiSeriesSonificationContextTracksMappingPan();
			Pitch = Pitch_DefaultValue = new RsiSeriesSonificationContextTracksMappingPitch();
			PitchString = PitchString_DefaultValue = "null";
			PitchNumber = PitchNumber_DefaultValue = null;
			PlayDelay = PlayDelay_DefaultValue = new RsiSeriesSonificationContextTracksMappingPlayDelay();
			Time = Time_DefaultValue = new RsiSeriesSonificationContextTracksMappingTime();
			TimeString = TimeString_DefaultValue = "null";
			TimeNumber = TimeNumber_DefaultValue = null;
			Tremolo = Tremolo_DefaultValue = new RsiSeriesSonificationContextTracksMappingTremolo();
			Volume = Volume_DefaultValue = new RsiSeriesSonificationContextTracksMappingVolume();
		...
		/// </summary>
		public RsiSeriesSonificationContextTracksMappingFrequency Frequency { get; set; }
		private RsiSeriesSonificationContextTracksMappingFrequency Frequency_DefaultValue { get; set; }
		...
		/// </summary>
		public RsiSeriesSonificationContextTracksMappingGapBetweenNotes GapBetweenNotes { get; set; }
		private RsiSeriesSonificationContextTracksMappingGapBetweenNotes GapBetweenNotes_DefaultValue { get; set; }
		...
		/// </summary>
		public RsiSeriesSonificationContextTracksMappingHighpass Highpass { get; set; }
		private RsiSeriesSonificationContextTracksMappingHighpass Highpass_DefaultValue { get; set; }
		...
		/// </summary>
		public RsiSeriesSonificationContextTracksMappingLowpass Lowpass { get; set; }
		private RsiSeriesSonificationContextTracksMappingLowpass Lowpass_DefaultValue { get; set; }
		...
		/// </summary>
		public RsiSeriesSonificationContextTracksMappingNoteDuration NoteDuration { get; set; }
		private RsiSeriesSonificationContextTracksMappingNoteDuration NoteDuration_DefaultValue { get; set; }
		...
		/// </summary>
		public RsiSeriesSonificationContextTracksMappingPan Pan { get; set; }
		private RsiSeriesSonificationContextTracksMappingPan Pan_DefaultValue { get; set; }
		...
		/// </summary>
		public RsiSeriesSonificationContextTracksMappingPitch Pitch { get; set; }
		private RsiSeriesSonificationContextTracksMappingPitch Pitch_DefaultValue { get; set; }
		...
		/// </summary>
		public RsiSeriesSonificationContextTracksMappingPlayDelay PlayDelay { get; set; }
		private RsiSeriesSonificationContextTracksMappingPlayDelay PlayDelay_DefaultValue { get; set; }
		...
		/// </summary>
		public RsiSeriesSonificationContextTracksMappingTime Time { get; set; }
		private RsiSeriesSonificationContextTracksMappingTime Time_DefaultValue { get; set; }
		...
		/// </summary>
		public RsiSeriesSonificationContextTracksMappingTremolo Tremolo { get; set; }
		private RsiSeriesSonificationContextTracksMappingTremolo Tremolo_DefaultValue { get; set; }
		 

		/// <summary>
		/// The volume of notes, from 0 to 1.
		/// </summary>
		public RsiSeriesSonificationContextTracksMappingVolume Volume { get; set; }
		private RsiSeriesSonificationContextTracksMappingVolume Volume_DefaultValue { get; set; }
