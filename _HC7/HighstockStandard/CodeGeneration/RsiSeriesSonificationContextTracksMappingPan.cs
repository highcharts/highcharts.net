...
{
	public partial class RsiSeriesSonificationContextTracksMappingPan  : BaseObject
	{
		Hashtable h = new Hashtable();

		public RsiSeriesSonificationContextTracksMappingPan()
		{
			MapFunction = MapFunction_DefaultValue = RsiSeriesSonificationContextTracksMappingPanMapFunction.Linear;
			MapTo = MapTo_DefaultValue = "";
			Max = Max_DefaultValue = null;
			Min = Min_DefaultValue = null;
			Value = Value_DefaultValue = null;
			Within = Within_DefaultValue = RsiSeriesSonificationContextTracksMappingPanWithin.Chart;
		...
		/// </summary>
		public RsiSeriesSonificationContextTracksMappingPanMapFunction MapFunction { get; set; }
		private RsiSeriesSonificationContextTracksMappingPanMapFunction MapFunction_DefaultValue { get; set; }
		...
		/// </summary>
		public RsiSeriesSonificationContextTracksMappingPanWithin Within { get; set; }
		private RsiSeriesSonificationContextTracksMappingPanWithin Within_DefaultValue { get; set; }
