...
{
	public partial class RsiSeriesSonificationContextTracksMappingTime  : BaseObject
	{
		Hashtable h = new Hashtable();

		public RsiSeriesSonificationContextTracksMappingTime()
		{
			MapFunction = MapFunction_DefaultValue = RsiSeriesSonificationContextTracksMappingTimeMapFunction.Linear;
			MapTo = MapTo_DefaultValue = "";
			Max = Max_DefaultValue = null;
			Min = Min_DefaultValue = null;
			Value = Value_DefaultValue = null;
			Within = Within_DefaultValue = RsiSeriesSonificationContextTracksMappingTimeWithin.Chart;
		...
		/// </summary>
		public RsiSeriesSonificationContextTracksMappingTimeMapFunction MapFunction { get; set; }
		private RsiSeriesSonificationContextTracksMappingTimeMapFunction MapFunction_DefaultValue { get; set; }
		...
		/// </summary>
		public RsiSeriesSonificationContextTracksMappingTimeWithin Within { get; set; }
		private RsiSeriesSonificationContextTracksMappingTimeWithin Within_DefaultValue { get; set; }
