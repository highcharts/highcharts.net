...
{
	public partial class RsiSeriesSonificationContextTracksPointGrouping  : BaseObject
	{
		Hashtable h = new Hashtable();

		public RsiSeriesSonificationContextTracksPointGrouping()
		{
			Algorithm = Algorithm_DefaultValue = RsiSeriesSonificationContextTracksPointGroupingAlgorithm.Minimax;
		...
		/// </summary>
		public RsiSeriesSonificationContextTracksPointGroupingAlgorithm Algorithm { get; set; }
		private RsiSeriesSonificationContextTracksPointGroupingAlgorithm Algorithm_DefaultValue { get; set; }
