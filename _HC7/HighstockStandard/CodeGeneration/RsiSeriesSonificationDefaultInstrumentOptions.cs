...
{
	public partial class RsiSeriesSonificationDefaultInstrumentOptions  : BaseObject
	{
		Hashtable h = new Hashtable();

		public RsiSeriesSonificationDefaultInstrumentOptions()
		{
			ActiveWhen = ActiveWhen_DefaultValue = new RsiSeriesSonificationDefaultInstrumentOptionsActiveWhen();
			Instrument = Instrument_DefaultValue = null;
			InstrumentString = InstrumentString_DefaultValue = "null";
			Mapping = Mapping_DefaultValue = new RsiSeriesSonificationDefaultInstrumentOptionsMapping();
			MidiName = MidiName_DefaultValue = "";
			PointGrouping = PointGrouping_DefaultValue = new RsiSeriesSonificationDefaultInstrumentOptionsPointGrouping();
			RoundToMusicalNotes = RoundToMusicalNotes_DefaultValue = true;
			ShowPlayMarker = ShowPlayMarker_DefaultValue = true;
			Type = Type_DefaultValue = RsiSeriesSonificationDefaultInstrumentOptionsType.Instrument;
		...
		/// </summary>
		public RsiSeriesSonificationDefaultInstrumentOptionsActiveWhen ActiveWhen { get; set; }
		private RsiSeriesSonificationDefaultInstrumentOptionsActiveWhen ActiveWhen_DefaultValue { get; set; }
		...
		/// </summary>
		public RsiSeriesSonificationDefaultInstrumentOptionsMapping Mapping { get; set; }
		private RsiSeriesSonificationDefaultInstrumentOptionsMapping Mapping_DefaultValue { get; set; }
		...
		/// </summary>
		public RsiSeriesSonificationDefaultInstrumentOptionsPointGrouping PointGrouping { get; set; }
		private RsiSeriesSonificationDefaultInstrumentOptionsPointGrouping PointGrouping_DefaultValue { get; set; }
		...
		/// </summary>
		public RsiSeriesSonificationDefaultInstrumentOptionsType Type { get; set; }
		private RsiSeriesSonificationDefaultInstrumentOptionsType Type_DefaultValue { get; set; }
