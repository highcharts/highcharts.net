...
{
	public partial class RsiSeriesSonificationDefaultInstrumentOptionsMappingHighpassResonance  : BaseObject
	{
		Hashtable h = new Hashtable();

		public RsiSeriesSonificationDefaultInstrumentOptionsMappingHighpassResonance()
		{
			MapFunction = MapFunction_DefaultValue = RsiSeriesSonificationDefaultInstrumentOptionsMappingHighpassResonanceMapFunction.Linear;
			MapTo = MapTo_DefaultValue = "";
			Max = Max_DefaultValue = null;
			Min = Min_DefaultValue = null;
			Value = Value_DefaultValue = null;
			Within = Within_DefaultValue = RsiSeriesSonificationDefaultInstrumentOptionsMappingHighpassResonanceWithin.Chart;
		...
		/// </summary>
		public RsiSeriesSonificationDefaultInstrumentOptionsMappingHighpassResonanceMapFunction MapFunction { get; set; }
		private RsiSeriesSonificationDefaultInstrumentOptionsMappingHighpassResonanceMapFunction MapFunction_DefaultValue { get; set; }
		...
		/// </summary>
		public RsiSeriesSonificationDefaultInstrumentOptionsMappingHighpassResonanceWithin Within { get; set; }
		private RsiSeriesSonificationDefaultInstrumentOptionsMappingHighpassResonanceWithin Within_DefaultValue { get; set; }
