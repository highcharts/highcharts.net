...
{
	public partial class RsiSeriesSonificationDefaultSpeechOptions  : BaseObject
	{
		Hashtable h = new Hashtable();

		public RsiSeriesSonificationDefaultSpeechOptions()
		{
			ActiveWhen = ActiveWhen_DefaultValue = new RsiSeriesSonificationDefaultSpeechOptionsActiveWhen();
			Language = Language_DefaultValue = "en-US";
			Mapping = Mapping_DefaultValue = new RsiSeriesSonificationDefaultSpeechOptionsMapping();
			PointGrouping = PointGrouping_DefaultValue = new RsiSeriesSonificationDefaultSpeechOptionsPointGrouping();
			PreferredVoice = PreferredVoice_DefaultValue = "";
			ShowPlayMarker = ShowPlayMarker_DefaultValue = true;
			Type = Type_DefaultValue = RsiSeriesSonificationDefaultSpeechOptionsType.Instrument;
		...
		/// </summary>
		public RsiSeriesSonificationDefaultSpeechOptionsActiveWhen ActiveWhen { get; set; }
		private RsiSeriesSonificationDefaultSpeechOptionsActiveWhen ActiveWhen_DefaultValue { get; set; }
		...
		/// </summary>
		public RsiSeriesSonificationDefaultSpeechOptionsMapping Mapping { get; set; }
		private RsiSeriesSonificationDefaultSpeechOptionsMapping Mapping_DefaultValue { get; set; }
		 

		/// <summary>
		/// Options for point grouping, specifically for instrument tracks.
		/// </summary>
		public RsiSeriesSonificationDefaultSpeechOptionsPointGrouping PointGrouping { get; set; }
		private RsiSeriesSonificationDefaultSpeechOptionsPointGrouping PointGrouping_DefaultValue { get; set; }
		...
		/// </summary>
		public RsiSeriesSonificationDefaultSpeechOptionsType Type { get; set; }
		private RsiSeriesSonificationDefaultSpeechOptionsType Type_DefaultValue { get; set; }
