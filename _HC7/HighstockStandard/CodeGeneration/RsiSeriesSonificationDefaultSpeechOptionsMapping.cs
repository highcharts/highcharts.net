...
{
	public partial class RsiSeriesSonificationDefaultSpeechOptionsMapping  : BaseObject
	{
		Hashtable h = new Hashtable();

		public RsiSeriesSonificationDefaultSpeechOptionsMapping()
		{
			Frequency = Frequency_DefaultValue = new RsiSeriesSonificationDefaultSpeechOptionsMappingFrequency();
			GapBetweenNotes = GapBetweenNotes_DefaultValue = new RsiSeriesSonificationDefaultSpeechOptionsMappingGapBetweenNotes();
			Highpass = Highpass_DefaultValue = new RsiSeriesSonificationDefaultSpeechOptionsMappingHighpass();
			Lowpass = Lowpass_DefaultValue = new RsiSeriesSonificationDefaultSpeechOptionsMappingLowpass();
			NoteDuration = NoteDuration_DefaultValue = new RsiSeriesSonificationDefaultSpeechOptionsMappingNoteDuration();
			Pan = Pan_DefaultValue = new RsiSeriesSonificationDefaultSpeechOptionsMappingPan();
			Pitch = Pitch_DefaultValue = new RsiSeriesSonificationDefaultSpeechOptionsMappingPitch();
			PitchString = PitchString_DefaultValue = "null";
			PitchNumber = PitchNumber_DefaultValue = null;
			PlayDelay = PlayDelay_DefaultValue = new RsiSeriesSonificationDefaultSpeechOptionsMappingPlayDelay();
			Time = Time_DefaultValue = new RsiSeriesSonificationDefaultSpeechOptionsMappingTime();
			TimeString = TimeString_DefaultValue = "null";
			TimeNumber = TimeNumber_DefaultValue = null;
			Tremolo = Tremolo_DefaultValue = new RsiSeriesSonificationDefaultSpeechOptionsMappingTremolo();
			Volume = Volume_DefaultValue = new RsiSeriesSonificationDefaultSpeechOptionsMappingVolume();
		...
		/// </summary>
		public RsiSeriesSonificationDefaultSpeechOptionsMappingFrequency Frequency { get; set; }
		private RsiSeriesSonificationDefaultSpeechOptionsMappingFrequency Frequency_DefaultValue { get; set; }
		...
		/// </summary>
		public RsiSeriesSonificationDefaultSpeechOptionsMappingGapBetweenNotes GapBetweenNotes { get; set; }
		private RsiSeriesSonificationDefaultSpeechOptionsMappingGapBetweenNotes GapBetweenNotes_DefaultValue { get; set; }
		...
		/// </summary>
		public RsiSeriesSonificationDefaultSpeechOptionsMappingHighpass Highpass { get; set; }
		private RsiSeriesSonificationDefaultSpeechOptionsMappingHighpass Highpass_DefaultValue { get; set; }
		...
		/// </summary>
		public RsiSeriesSonificationDefaultSpeechOptionsMappingLowpass Lowpass { get; set; }
		private RsiSeriesSonificationDefaultSpeechOptionsMappingLowpass Lowpass_DefaultValue { get; set; }
		...
		/// </summary>
		public RsiSeriesSonificationDefaultSpeechOptionsMappingNoteDuration NoteDuration { get; set; }
		private RsiSeriesSonificationDefaultSpeechOptionsMappingNoteDuration NoteDuration_DefaultValue { get; set; }
		...
		/// </summary>
		public RsiSeriesSonificationDefaultSpeechOptionsMappingPan Pan { get; set; }
		private RsiSeriesSonificationDefaultSpeechOptionsMappingPan Pan_DefaultValue { get; set; }
		...
		/// </summary>
		public RsiSeriesSonificationDefaultSpeechOptionsMappingPitch Pitch { get; set; }
		private RsiSeriesSonificationDefaultSpeechOptionsMappingPitch Pitch_DefaultValue { get; set; }
		...
		/// </summary>
		public RsiSeriesSonificationDefaultSpeechOptionsMappingPlayDelay PlayDelay { get; set; }
		private RsiSeriesSonificationDefaultSpeechOptionsMappingPlayDelay PlayDelay_DefaultValue { get; set; }
		...
		/// </summary>
		public RsiSeriesSonificationDefaultSpeechOptionsMappingTime Time { get; set; }
		private RsiSeriesSonificationDefaultSpeechOptionsMappingTime Time_DefaultValue { get; set; }
		...
		/// </summary>
		public RsiSeriesSonificationDefaultSpeechOptionsMappingTremolo Tremolo { get; set; }
		private RsiSeriesSonificationDefaultSpeechOptionsMappingTremolo Tremolo_DefaultValue { get; set; }
		 

		/// <summary>
		/// The volume of notes, from 0 to 1.
		/// </summary>
		public RsiSeriesSonificationDefaultSpeechOptionsMappingVolume Volume { get; set; }
		private RsiSeriesSonificationDefaultSpeechOptionsMappingVolume Volume_DefaultValue { get; set; }
