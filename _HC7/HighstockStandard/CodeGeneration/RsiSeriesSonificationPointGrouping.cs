...
{
	public partial class RsiSeriesSonificationPointGrouping  : BaseObject
	{
		Hashtable h = new Hashtable();

		public RsiSeriesSonificationPointGrouping()
		{
			Algorithm = Algorithm_DefaultValue = RsiSeriesSonificationPointGroupingAlgorithm.Minimax;
		...
		/// </summary>
		public RsiSeriesSonificationPointGroupingAlgorithm Algorithm { get; set; }
		private RsiSeriesSonificationPointGroupingAlgorithm Algorithm_DefaultValue { get; set; }
