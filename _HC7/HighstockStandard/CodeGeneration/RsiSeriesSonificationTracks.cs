...
{
	public partial class RsiSeriesSonificationTracks  : BaseObject
	{
		Hashtable h = new Hashtable();

		public RsiSeriesSonificationTracks()
		{
			ActiveWhen = ActiveWhen_DefaultValue = new RsiSeriesSonificationTracksActiveWhen();
			Instrument = Instrument_DefaultValue = null;
			InstrumentString = InstrumentString_DefaultValue = "null";
			Mapping = Mapping_DefaultValue = new RsiSeriesSonificationTracksMapping();
			MidiName = MidiName_DefaultValue = "";
			PointGrouping = PointGrouping_DefaultValue = new RsiSeriesSonificationTracksPointGrouping();
			RoundToMusicalNotes = RoundToMusicalNotes_DefaultValue = true;
			ShowPlayMarker = ShowPlayMarker_DefaultValue = true;
			Type = Type_DefaultValue = RsiSeriesSonificationTracksType.Instrument;
		...
		/// </summary>
		public RsiSeriesSonificationTracksActiveWhen ActiveWhen { get; set; }
		private RsiSeriesSonificationTracksActiveWhen ActiveWhen_DefaultValue { get; set; }
		...
		/// </summary>
		public RsiSeriesSonificationTracksMapping Mapping { get; set; }
		private RsiSeriesSonificationTracksMapping Mapping_DefaultValue { get; set; }
		...
		/// </summary>
		public RsiSeriesSonificationTracksPointGrouping PointGrouping { get; set; }
		private RsiSeriesSonificationTracksPointGrouping PointGrouping_DefaultValue { get; set; }
		...
		/// </summary>
		public RsiSeriesSonificationTracksType Type { get; set; }
		private RsiSeriesSonificationTracksType Type_DefaultValue { get; set; }
