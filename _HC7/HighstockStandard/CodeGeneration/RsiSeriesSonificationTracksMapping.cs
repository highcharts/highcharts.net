...
{
	public partial class RsiSeriesSonificationTracksMapping  : BaseObject
	{
		Hashtable h = new Hashtable();

		public RsiSeriesSonificationTracksMapping()
		{
			Frequency = Frequency_DefaultValue = new RsiSeriesSonificationTracksMappingFrequency();
			GapBetweenNotes = GapBetweenNotes_DefaultValue = new RsiSeriesSonificationTracksMappingGapBetweenNotes();
			Highpass = Highpass_DefaultValue = new RsiSeriesSonificationTracksMappingHighpass();
			Lowpass = Lowpass_DefaultValue = new RsiSeriesSonificationTracksMappingLowpass();
			NoteDuration = NoteDuration_DefaultValue = new RsiSeriesSonificationTracksMappingNoteDuration();
			Pan = Pan_DefaultValue = new RsiSeriesSonificationTracksMappingPan();
			Pitch = Pitch_DefaultValue = new RsiSeriesSonificationTracksMappingPitch();
			PitchString = PitchString_DefaultValue = "null";
			PitchNumber = PitchNumber_DefaultValue = null;
			PlayDelay = PlayDelay_DefaultValue = new RsiSeriesSonificationTracksMappingPlayDelay();
			Time = Time_DefaultValue = new RsiSeriesSonificationTracksMappingTime();
			TimeString = TimeString_DefaultValue = "null";
			TimeNumber = TimeNumber_DefaultValue = null;
			Tremolo = Tremolo_DefaultValue = new RsiSeriesSonificationTracksMappingTremolo();
			Volume = Volume_DefaultValue = new RsiSeriesSonificationTracksMappingVolume();
		...
		/// </summary>
		public RsiSeriesSonificationTracksMappingFrequency Frequency { get; set; }
		private RsiSeriesSonificationTracksMappingFrequency Frequency_DefaultValue { get; set; }
		...
		/// </summary>
		public RsiSeriesSonificationTracksMappingGapBetweenNotes GapBetweenNotes { get; set; }
		private RsiSeriesSonificationTracksMappingGapBetweenNotes GapBetweenNotes_DefaultValue { get; set; }
		...
		/// </summary>
		public RsiSeriesSonificationTracksMappingHighpass Highpass { get; set; }
		private RsiSeriesSonificationTracksMappingHighpass Highpass_DefaultValue { get; set; }
		...
		/// </summary>
		public RsiSeriesSonificationTracksMappingLowpass Lowpass { get; set; }
		private RsiSeriesSonificationTracksMappingLowpass Lowpass_DefaultValue { get; set; }
		...
		/// </summary>
		public RsiSeriesSonificationTracksMappingNoteDuration NoteDuration { get; set; }
		private RsiSeriesSonificationTracksMappingNoteDuration NoteDuration_DefaultValue { get; set; }
		...
		/// </summary>
		public RsiSeriesSonificationTracksMappingPan Pan { get; set; }
		private RsiSeriesSonificationTracksMappingPan Pan_DefaultValue { get; set; }
		...
		/// </summary>
		public RsiSeriesSonificationTracksMappingPitch Pitch { get; set; }
		private RsiSeriesSonificationTracksMappingPitch Pitch_DefaultValue { get; set; }
		...
		/// </summary>
		public RsiSeriesSonificationTracksMappingPlayDelay PlayDelay { get; set; }
		private RsiSeriesSonificationTracksMappingPlayDelay PlayDelay_DefaultValue { get; set; }
		...
		/// </summary>
		public RsiSeriesSonificationTracksMappingTime Time { get; set; }
		private RsiSeriesSonificationTracksMappingTime Time_DefaultValue { get; set; }
		...
		/// </summary>
		public RsiSeriesSonificationTracksMappingTremolo Tremolo { get; set; }
		private RsiSeriesSonificationTracksMappingTremolo Tremolo_DefaultValue { get; set; }
		 

		/// <summary>
		/// The volume of notes, from 0 to 1.
		/// </summary>
		public RsiSeriesSonificationTracksMappingVolume Volume { get; set; }
		private RsiSeriesSonificationTracksMappingVolume Volume_DefaultValue { get; set; }
