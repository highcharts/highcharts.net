...
{
	public partial class RsiSeriesSonificationTracksMappingFrequency  : BaseObject
	{
		Hashtable h = new Hashtable();

		public RsiSeriesSonificationTracksMappingFrequency()
		{
			MapFunction = MapFunction_DefaultValue = RsiSeriesSonificationTracksMappingFrequencyMapFunction.Linear;
			MapTo = MapTo_DefaultValue = "";
			Max = Max_DefaultValue = null;
			Min = Min_DefaultValue = null;
			Value = Value_DefaultValue = null;
			Within = Within_DefaultValue = RsiSeriesSonificationTracksMappingFrequencyWithin.Chart;
		...
		/// </summary>
		public RsiSeriesSonificationTracksMappingFrequencyMapFunction MapFunction { get; set; }
		private RsiSeriesSonificationTracksMappingFrequencyMapFunction MapFunction_DefaultValue { get; set; }
		...
		/// </summary>
		public RsiSeriesSonificationTracksMappingFrequencyWithin Within { get; set; }
		private RsiSeriesSonificationTracksMappingFrequencyWithin Within_DefaultValue { get; set; }
