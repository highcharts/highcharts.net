...
{
	public partial class RsiSeriesSonificationTracksMappingLowpassResonance  : BaseObject
	{
		Hashtable h = new Hashtable();

		public RsiSeriesSonificationTracksMappingLowpassResonance()
		{
			MapFunction = MapFunction_DefaultValue = RsiSeriesSonificationTracksMappingLowpassResonanceMapFunction.Linear;
			MapTo = MapTo_DefaultValue = "";
			Max = Max_DefaultValue = null;
			Min = Min_DefaultValue = null;
			Value = Value_DefaultValue = null;
			Within = Within_DefaultValue = RsiSeriesSonificationTracksMappingLowpassResonanceWithin.Chart;
		...
		/// </summary>
		public RsiSeriesSonificationTracksMappingLowpassResonanceMapFunction MapFunction { get; set; }
		private RsiSeriesSonificationTracksMappingLowpassResonanceMapFunction MapFunction_DefaultValue { get; set; }
		...
		/// </summary>
		public RsiSeriesSonificationTracksMappingLowpassResonanceWithin Within { get; set; }
		private RsiSeriesSonificationTracksMappingLowpassResonanceWithin Within_DefaultValue { get; set; }
