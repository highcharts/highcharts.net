...
{
	public partial class RsiSeriesSonificationTracksMappingNoteDuration  : BaseObject
	{
		Hashtable h = new Hashtable();

		public RsiSeriesSonificationTracksMappingNoteDuration()
		{
			MapFunction = MapFunction_DefaultValue = RsiSeriesSonificationTracksMappingNoteDurationMapFunction.Linear;
			MapTo = MapTo_DefaultValue = "";
			Max = Max_DefaultValue = null;
			Min = Min_DefaultValue = null;
			Value = Value_DefaultValue = null;
			Within = Within_DefaultValue = RsiSeriesSonificationTracksMappingNoteDurationWithin.Chart;
		...
		/// </summary>
		public RsiSeriesSonificationTracksMappingNoteDurationMapFunction MapFunction { get; set; }
		private RsiSeriesSonificationTracksMappingNoteDurationMapFunction MapFunction_DefaultValue { get; set; }
		...
		/// </summary>
		public RsiSeriesSonificationTracksMappingNoteDurationWithin Within { get; set; }
		private RsiSeriesSonificationTracksMappingNoteDurationWithin Within_DefaultValue { get; set; }
