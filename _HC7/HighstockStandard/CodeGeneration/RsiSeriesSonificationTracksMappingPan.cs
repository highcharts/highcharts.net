...
{
	public partial class RsiSeriesSonificationTracksMappingPan  : BaseObject
	{
		Hashtable h = new Hashtable();

		public RsiSeriesSonificationTracksMappingPan()
		{
			MapFunction = MapFunction_DefaultValue = RsiSeriesSonificationTracksMappingPanMapFunction.Linear;
			MapTo = MapTo_DefaultValue = "";
			Max = Max_DefaultValue = null;
			Min = Min_DefaultValue = null;
			Value = Value_DefaultValue = null;
			Within = Within_DefaultValue = RsiSeriesSonificationTracksMappingPanWithin.Chart;
		...
		/// </summary>
		public RsiSeriesSonificationTracksMappingPanMapFunction MapFunction { get; set; }
		private RsiSeriesSonificationTracksMappingPanMapFunction MapFunction_DefaultValue { get; set; }
		...
		/// </summary>
		public RsiSeriesSonificationTracksMappingPanWithin Within { get; set; }
		private RsiSeriesSonificationTracksMappingPanWithin Within_DefaultValue { get; set; }
