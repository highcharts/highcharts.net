...
{
	public partial class RsiSeriesSonificationTracksMappingPitch  : BaseObject
	{
		Hashtable h = new Hashtable();

		public RsiSeriesSonificationTracksMappingPitch()
		{
			MapFunction = MapFunction_DefaultValue = RsiSeriesSonificationTracksMappingPitchMapFunction.Linear;
		...
		/// </summary>
		public RsiSeriesSonificationTracksMappingPitchMapFunction MapFunction { get; set; }
		private RsiSeriesSonificationTracksMappingPitchMapFunction MapFunction_DefaultValue { get; set; }
