...
{
	public partial class RsiSeriesSonificationTracksMappingPlayDelay  : BaseObject
	{
		Hashtable h = new Hashtable();

		public RsiSeriesSonificationTracksMappingPlayDelay()
		{
			MapFunction = MapFunction_DefaultValue = RsiSeriesSonificationTracksMappingPlayDelayMapFunction.Linear;
			MapTo = MapTo_DefaultValue = "";
			Max = Max_DefaultValue = null;
			Min = Min_DefaultValue = null;
			Value = Value_DefaultValue = null;
			Within = Within_DefaultValue = RsiSeriesSonificationTracksMappingPlayDelayWithin.Chart;
		...
		/// </summary>
		public RsiSeriesSonificationTracksMappingPlayDelayMapFunction MapFunction { get; set; }
		private RsiSeriesSonificationTracksMappingPlayDelayMapFunction MapFunction_DefaultValue { get; set; }
		...
		/// </summary>
		public RsiSeriesSonificationTracksMappingPlayDelayWithin Within { get; set; }
		private RsiSeriesSonificationTracksMappingPlayDelayWithin Within_DefaultValue { get; set; }
