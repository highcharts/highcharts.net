...
{
	public partial class RsiSeriesSonificationTracksMappingTime  : BaseObject
	{
		Hashtable h = new Hashtable();

		public RsiSeriesSonificationTracksMappingTime()
		{
			MapFunction = MapFunction_DefaultValue = RsiSeriesSonificationTracksMappingTimeMapFunction.Linear;
			MapTo = MapTo_DefaultValue = "";
			Max = Max_DefaultValue = null;
			Min = Min_DefaultValue = null;
			Value = Value_DefaultValue = null;
			Within = Within_DefaultValue = RsiSeriesSonificationTracksMappingTimeWithin.Chart;
		...
		/// </summary>
		public RsiSeriesSonificationTracksMappingTimeMapFunction MapFunction { get; set; }
		private RsiSeriesSonificationTracksMappingTimeMapFunction MapFunction_DefaultValue { get; set; }
		...
		/// </summary>
		public RsiSeriesSonificationTracksMappingTimeWithin Within { get; set; }
		private RsiSeriesSonificationTracksMappingTimeWithin Within_DefaultValue { get; set; }
