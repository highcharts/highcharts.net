...
{
	public partial class RsiSeriesSonificationTracksMappingTremoloDepth  : BaseObject
	{
		Hashtable h = new Hashtable();

		public RsiSeriesSonificationTracksMappingTremoloDepth()
		{
			MapFunction = MapFunction_DefaultValue = RsiSeriesSonificationTracksMappingTremoloDepthMapFunction.Linear;
			MapTo = MapTo_DefaultValue = "";
			Max = Max_DefaultValue = null;
			Min = Min_DefaultValue = null;
			Value = Value_DefaultValue = null;
			Within = Within_DefaultValue = RsiSeriesSonificationTracksMappingTremoloDepthWithin.Chart;
		...
		/// </summary>
		public RsiSeriesSonificationTracksMappingTremoloDepthMapFunction MapFunction { get; set; }
		private RsiSeriesSonificationTracksMappingTremoloDepthMapFunction MapFunction_DefaultValue { get; set; }
		...
		/// </summary>
		public RsiSeriesSonificationTracksMappingTremoloDepthWithin Within { get; set; }
		private RsiSeriesSonificationTracksMappingTremoloDepthWithin Within_DefaultValue { get; set; }
