...
{
	public partial class RsiSeriesSonificationTracksMappingTremoloSpeed  : BaseObject
	{
		Hashtable h = new Hashtable();

		public RsiSeriesSonificationTracksMappingTremoloSpeed()
		{
			MapFunction = MapFunction_DefaultValue = RsiSeriesSonificationTracksMappingTremoloSpeedMapFunction.Linear;
			MapTo = MapTo_DefaultValue = "";
			Max = Max_DefaultValue = null;
			Min = Min_DefaultValue = null;
			Value = Value_DefaultValue = null;
			Within = Within_DefaultValue = RsiSeriesSonificationTracksMappingTremoloSpeedWithin.Chart;
		...
		/// </summary>
		public RsiSeriesSonificationTracksMappingTremoloSpeedMapFunction MapFunction { get; set; }
		private RsiSeriesSonificationTracksMappingTremoloSpeedMapFunction MapFunction_DefaultValue { get; set; }
		...
		/// </summary>
		public RsiSeriesSonificationTracksMappingTremoloSpeedWithin Within { get; set; }
		private RsiSeriesSonificationTracksMappingTremoloSpeedWithin Within_DefaultValue { get; set; }
