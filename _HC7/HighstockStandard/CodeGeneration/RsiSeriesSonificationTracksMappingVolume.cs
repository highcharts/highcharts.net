...
{
	public partial class RsiSeriesSonificationTracksMappingVolume  : BaseObject
	{
		Hashtable h = new Hashtable();

		public RsiSeriesSonificationTracksMappingVolume()
		{
			MapFunction = MapFunction_DefaultValue = RsiSeriesSonificationTracksMappingVolumeMapFunction.Linear;
			MapTo = MapTo_DefaultValue = "";
			Max = Max_DefaultValue = null;
			Min = Min_DefaultValue = null;
			Value = Value_DefaultValue = null;
			Within = Within_DefaultValue = RsiSeriesSonificationTracksMappingVolumeWithin.Chart;
		...
		/// </summary>
		public RsiSeriesSonificationTracksMappingVolumeMapFunction MapFunction { get; set; }
		private RsiSeriesSonificationTracksMappingVolumeMapFunction MapFunction_DefaultValue { get; set; }
		...
		/// </summary>
		public RsiSeriesSonificationTracksMappingVolumeWithin Within { get; set; }
		private RsiSeriesSonificationTracksMappingVolumeWithin Within_DefaultValue { get; set; }
