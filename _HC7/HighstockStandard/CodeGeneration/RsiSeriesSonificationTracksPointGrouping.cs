...
{
	public partial class RsiSeriesSonificationTracksPointGrouping  : BaseObject
	{
		Hashtable h = new Hashtable();

		public RsiSeriesSonificationTracksPointGrouping()
		{
			Algorithm = Algorithm_DefaultValue = RsiSeriesSonificationTracksPointGroupingAlgorithm.Minimax;
		...
		/// </summary>
		public RsiSeriesSonificationTracksPointGroupingAlgorithm Algorithm { get; set; }
		private RsiSeriesSonificationTracksPointGroupingAlgorithm Algorithm_DefaultValue { get; set; }
