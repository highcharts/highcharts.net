...
{
	public partial class RsiSeriesTooltip  : BaseObject
	{
		public RsiSeriesTooltip()
		{
			...
			HeaderShape = HeaderShape_DefaultValue = RsiSeriesTooltipHeaderShape.Callout;
		...
		/// </summary>
		public RsiSeriesTooltipHeaderShape HeaderShape { get; set; }
		private RsiSeriesTooltipHeaderShape HeaderShape_DefaultValue { get; set; }
		...
		internal override Hashtable ToHashtable()
		{
			...
			if (NullFormatter != NullFormatter_DefaultValue) { h.Add("nullFormatter",NullFormatter); Highstock.AddFunction("RsiSeriesTooltipNullFormatter.nullFormatter", NullFormatter); }  
			if (Outside != Outside_DefaultValue) h.Add("outside",Outside);
			if (Padding != Padding_DefaultValue) h.Add("padding",Padding);
			if (PointFormat != PointFormat_DefaultValue) h.Add("pointFormat",PointFormat);
			if (PointFormatter != PointFormatter_DefaultValue) { h.Add("pointFormatter",PointFormatter); Highstock.AddFunction("RsiSeriesTooltipPointFormatter.pointFormatter", PointFormatter); }  
