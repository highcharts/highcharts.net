...
{
	public partial class ScatterSeriesSonificationContextTracks  : BaseObject
	{
		Hashtable h = new Hashtable();

		public ScatterSeriesSonificationContextTracks()
		{
			ActiveWhen = ActiveWhen_DefaultValue = new ScatterSeriesSonificationContextTracksActiveWhen();
			Instrument = Instrument_DefaultValue = null;
			InstrumentString = InstrumentString_DefaultValue = "null";
			Mapping = Mapping_DefaultValue = new ScatterSeriesSonificationContextTracksMapping();
			MidiName = MidiName_DefaultValue = "";
			PointGrouping = PointGrouping_DefaultValue = new ScatterSeriesSonificationContextTracksPointGrouping();
			...
			Type = Type_DefaultValue = ScatterSeriesSonificationContextTracksType.Instrument;
			ValueInterval = ValueInterval_DefaultValue = null;
			ValueMapFunction = ValueMapFunction_DefaultValue = ScatterSeriesSonificationContextTracksValueMapFunction.Linear;
		...
		/// </summary>
		public ScatterSeriesSonificationContextTracksActiveWhen ActiveWhen { get; set; }
		private ScatterSeriesSonificationContextTracksActiveWhen ActiveWhen_DefaultValue { get; set; }
		...
		/// </summary>
		public ScatterSeriesSonificationContextTracksMapping Mapping { get; set; }
		private ScatterSeriesSonificationContextTracksMapping Mapping_DefaultValue { get; set; }
		...
		/// </summary>
		public ScatterSeriesSonificationContextTracksPointGrouping PointGrouping { get; set; }
		private ScatterSeriesSonificationContextTracksPointGrouping PointGrouping_DefaultValue { get; set; }
		...
		/// </summary>
		public ScatterSeriesSonificationContextTracksType Type { get; set; }
		private ScatterSeriesSonificationContextTracksType Type_DefaultValue { get; set; }
		...
		/// </summary>
		public ScatterSeriesSonificationContextTracksValueMapFunction ValueMapFunction { get; set; }
		private ScatterSeriesSonificationContextTracksValueMapFunction ValueMapFunction_DefaultValue { get; set; }
