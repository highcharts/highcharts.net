...
{
	public partial class ScatterSeriesSonificationTracks  : BaseObject
	{
		Hashtable h = new Hashtable();

		public ScatterSeriesSonificationTracks()
		{
			ActiveWhen = ActiveWhen_DefaultValue = new ScatterSeriesSonificationTracksActiveWhen();
			Instrument = Instrument_DefaultValue = null;
			InstrumentString = InstrumentString_DefaultValue = "null";
			Mapping = Mapping_DefaultValue = new ScatterSeriesSonificationTracksMapping();
			MidiName = MidiName_DefaultValue = "";
			PointGrouping = PointGrouping_DefaultValue = new ScatterSeriesSonificationTracksPointGrouping();
			RoundToMusicalNotes = RoundToMusicalNotes_DefaultValue = true;
			ShowPlayMarker = ShowPlayMarker_DefaultValue = true;
			Type = Type_DefaultValue = ScatterSeriesSonificationTracksType.Instrument;
		...
		/// </summary>
		public ScatterSeriesSonificationTracksActiveWhen ActiveWhen { get; set; }
		private ScatterSeriesSonificationTracksActiveWhen ActiveWhen_DefaultValue { get; set; }
		...
		/// </summary>
		public ScatterSeriesSonificationTracksMapping Mapping { get; set; }
		private ScatterSeriesSonificationTracksMapping Mapping_DefaultValue { get; set; }
		...
		/// </summary>
		public ScatterSeriesSonificationTracksPointGrouping PointGrouping { get; set; }
		private ScatterSeriesSonificationTracksPointGrouping PointGrouping_DefaultValue { get; set; }
		...
		/// </summary>
		public ScatterSeriesSonificationTracksType Type { get; set; }
		private ScatterSeriesSonificationTracksType Type_DefaultValue { get; set; }
