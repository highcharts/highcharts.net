...
{
	public partial class ScatterSeriesSonificationTracksMapping  : BaseObject
	{
		Hashtable h = new Hashtable();

		public ScatterSeriesSonificationTracksMapping()
		{
			Frequency = Frequency_DefaultValue = new ScatterSeriesSonificationTracksMappingFrequency();
			GapBetweenNotes = GapBetweenNotes_DefaultValue = new ScatterSeriesSonificationTracksMappingGapBetweenNotes();
			Highpass = Highpass_DefaultValue = new ScatterSeriesSonificationTracksMappingHighpass();
			Lowpass = Lowpass_DefaultValue = new ScatterSeriesSonificationTracksMappingLowpass();
			NoteDuration = NoteDuration_DefaultValue = new ScatterSeriesSonificationTracksMappingNoteDuration();
			Pan = Pan_DefaultValue = new ScatterSeriesSonificationTracksMappingPan();
			Pitch = Pitch_DefaultValue = new ScatterSeriesSonificationTracksMappingPitch();
			PitchString = PitchString_DefaultValue = "null";
			PitchNumber = PitchNumber_DefaultValue = null;
			PlayDelay = PlayDelay_DefaultValue = new ScatterSeriesSonificationTracksMappingPlayDelay();
			Time = Time_DefaultValue = new ScatterSeriesSonificationTracksMappingTime();
			TimeString = TimeString_DefaultValue = "null";
			TimeNumber = TimeNumber_DefaultValue = null;
			Tremolo = Tremolo_DefaultValue = new ScatterSeriesSonificationTracksMappingTremolo();
			Volume = Volume_DefaultValue = new ScatterSeriesSonificationTracksMappingVolume();
		...
		/// </summary>
		public ScatterSeriesSonificationTracksMappingFrequency Frequency { get; set; }
		private ScatterSeriesSonificationTracksMappingFrequency Frequency_DefaultValue { get; set; }
		...
		/// </summary>
		public ScatterSeriesSonificationTracksMappingGapBetweenNotes GapBetweenNotes { get; set; }
		private ScatterSeriesSonificationTracksMappingGapBetweenNotes GapBetweenNotes_DefaultValue { get; set; }
		...
		/// </summary>
		public ScatterSeriesSonificationTracksMappingHighpass Highpass { get; set; }
		private ScatterSeriesSonificationTracksMappingHighpass Highpass_DefaultValue { get; set; }
		...
		/// </summary>
		public ScatterSeriesSonificationTracksMappingLowpass Lowpass { get; set; }
		private ScatterSeriesSonificationTracksMappingLowpass Lowpass_DefaultValue { get; set; }
		...
		/// </summary>
		public ScatterSeriesSonificationTracksMappingNoteDuration NoteDuration { get; set; }
		private ScatterSeriesSonificationTracksMappingNoteDuration NoteDuration_DefaultValue { get; set; }
		...
		/// </summary>
		public ScatterSeriesSonificationTracksMappingPan Pan { get; set; }
		private ScatterSeriesSonificationTracksMappingPan Pan_DefaultValue { get; set; }
		...
		/// </summary>
		public ScatterSeriesSonificationTracksMappingPitch Pitch { get; set; }
		private ScatterSeriesSonificationTracksMappingPitch Pitch_DefaultValue { get; set; }
		...
		/// </summary>
		public ScatterSeriesSonificationTracksMappingPlayDelay PlayDelay { get; set; }
		private ScatterSeriesSonificationTracksMappingPlayDelay PlayDelay_DefaultValue { get; set; }
		...
		/// </summary>
		public ScatterSeriesSonificationTracksMappingTime Time { get; set; }
		private ScatterSeriesSonificationTracksMappingTime Time_DefaultValue { get; set; }
		...
		/// </summary>
		public ScatterSeriesSonificationTracksMappingTremolo Tremolo { get; set; }
		private ScatterSeriesSonificationTracksMappingTremolo Tremolo_DefaultValue { get; set; }
		 

		/// <summary>
		/// The volume of notes, from 0 to 1.
		/// </summary>
		public ScatterSeriesSonificationTracksMappingVolume Volume { get; set; }
		private ScatterSeriesSonificationTracksMappingVolume Volume_DefaultValue { get; set; }
