...
namespace Highsoft.Web.Mvc.Stocks
{
	public partial class SlowstochasticSeries  : Series
	{
		...
		public SlowstochasticSeries()
		{
			...
			Zones = Zones_DefaultValue = new List<SlowstochasticSeriesZone>();
		...
		/// </summary>
		public List<SlowstochasticSeriesZone> Zones { get; set; }
		private List<SlowstochasticSeriesZone> Zones_DefaultValue { get; set; }
