...
{
	public partial class SlowstochasticSeries  : Series
	{
		Hashtable h = new Hashtable();

		public SlowstochasticSeries()
		{
			Accessibility = Accessibility_DefaultValue = new SlowstochasticSeriesAccessibility();
			AllowPointSelect = AllowPointSelect_DefaultValue = false;
			Animation = Animation_DefaultValue = new Animation() { Enabled = true };
			AnimationBool = AnimationBool_DefaultValue = true;
			AnimationLimit = AnimationLimit_DefaultValue = null;
			BoostBlending = BoostBlending_DefaultValue = SlowstochasticSeriesBoostBlending.Undefined;
			...
			Compare = Compare_DefaultValue = SlowstochasticSeriesCompare.Percent;
			CompareBase = CompareBase_DefaultValue = SlowstochasticSeriesCompareBase.Min;
			...
			Cursor = Cursor_DefaultValue = SlowstochasticSeriesCursor.Null;
			Custom = Custom_DefaultValue = new Hashtable();
			DashStyle = DashStyle_DefaultValue = SlowstochasticSeriesDashStyle.Null;
			DataGrouping = DataGrouping_DefaultValue = new SlowstochasticSeriesDataGrouping();
			DataLabels = DataLabels_DefaultValue = new SlowstochasticSeriesDataLabels();
			DataSorting = DataSorting_DefaultValue = new SlowstochasticSeriesDataSorting();
			Description = Description_DefaultValue = "";
			Dumbell = Dumbell_DefaultValue = new SlowstochasticSeriesDumbell();
			EnableMouseTracking = EnableMouseTracking_DefaultValue = true;
			Events = Events_DefaultValue = new SlowstochasticSeriesEvents();
			FindNearestPointBy = FindNearestPointBy_DefaultValue = SlowstochasticSeriesFindNearestPointBy.X;
			GapSize = GapSize_DefaultValue = 0;
			GapUnit = GapUnit_DefaultValue = SlowstochasticSeriesGapUnit.Relative;
			GetExtremesFromAll = GetExtremesFromAll_DefaultValue = false;
			Id = Id_DefaultValue = "";
			InactiveOtherPoints = InactiveOtherPoints_DefaultValue = false;
			IncludeInDataExport = IncludeInDataExport_DefaultValue = null;
			Index = Index_DefaultValue = null;
			Label = Label_DefaultValue = new SlowstochasticSeriesLabel();
			LastPrice = LastPrice_DefaultValue = new SlowstochasticSeriesLastPrice();
			LastVisiblePrice = LastVisiblePrice_DefaultValue = new SlowstochasticSeriesLastVisiblePrice();
			LegendIndex = LegendIndex_DefaultValue = null;
			LegendSymbol = LegendSymbol_DefaultValue = SlowstochasticSeriesLegendSymbol.Rectangle;
			Linecap = Linecap_DefaultValue = SlowstochasticSeriesLinecap.Round;
			LineWidth = LineWidth_DefaultValue = 2;
			LinkedTo = LinkedTo_DefaultValue = "";
			Marker = Marker_DefaultValue = new SlowstochasticSeriesMarker();
			Name = Name_DefaultValue = "";
			NegativeColor = NegativeColor_DefaultValue = "";
			OnPoint = OnPoint_DefaultValue = new SlowstochasticSeriesOnPoint();
			Opacity = Opacity_DefaultValue = 1;
			Params = Params_DefaultValue = new SlowstochasticSeriesParams();
			Point = Point_DefaultValue = new SlowstochasticSeriesPoint();
			...
			SmoothedLine = SmoothedLine_DefaultValue = new SlowstochasticSeriesSmoothedLine();
			SoftThreshold = SoftThreshold_DefaultValue = true;
			Sonification = Sonification_DefaultValue = new SlowstochasticSeriesSonification();
			Stack = Stack_DefaultValue = "";
			StackNumber = StackNumber_DefaultValue = null;
			States = States_DefaultValue = new SlowstochasticSeriesStates();
			Step = Step_DefaultValue = SlowstochasticSeriesStep.Null;
			StickyTracking = StickyTracking_DefaultValue = true;
			Threshold = Threshold_DefaultValue = 0;
			Tooltip = Tooltip_DefaultValue = new SlowstochasticSeriesTooltip();
			...
			Zones = Zones_DefaultValue = new List<SlowstochasticSeriesZones>();
		...
		/// </summary>
		public SlowstochasticSeriesAccessibility Accessibility { get; set; }
		private SlowstochasticSeriesAccessibility Accessibility_DefaultValue { get; set; }
		...
		/// </summary>
		public SlowstochasticSeriesBoostBlending BoostBlending { get; set; }
		private SlowstochasticSeriesBoostBlending BoostBlending_DefaultValue { get; set; }
		...
		/// </summary>
		public SlowstochasticSeriesCompare Compare { get; set; }
		private SlowstochasticSeriesCompare Compare_DefaultValue { get; set; }
		 

		/// <summary>
		/// When [compare](#plotOptions.series.compare) is `percent`, this optiondictates whether to use 0 or 100 as the base of comparison.
		/// </summary>
		public SlowstochasticSeriesCompareBase CompareBase { get; set; }
		private SlowstochasticSeriesCompareBase CompareBase_DefaultValue { get; set; }
		...
		/// </summary>
		public SlowstochasticSeriesCursor Cursor { get; set; }
		private SlowstochasticSeriesCursor Cursor_DefaultValue { get; set; }
		...
		/// </summary>
		public SlowstochasticSeriesDashStyle DashStyle { get; set; }
		private SlowstochasticSeriesDashStyle DashStyle_DefaultValue { get; set; }
		...
		/// </summary>
		public SlowstochasticSeriesDataGrouping DataGrouping { get; set; }
		private SlowstochasticSeriesDataGrouping DataGrouping_DefaultValue { get; set; }
		...
		/// </summary>
		public SlowstochasticSeriesDataLabels DataLabels { get; set; }
		private SlowstochasticSeriesDataLabels DataLabels_DefaultValue { get; set; }
		 

		/// <summary>
		/// Options for the series data sorting.
		/// </summary>
		public SlowstochasticSeriesDataSorting DataSorting { get; set; }
		private SlowstochasticSeriesDataSorting DataSorting_DefaultValue { get; set; }
		...
		/// 
		/// </summary>
		public SlowstochasticSeriesDumbell Dumbell { get; set; }
		private SlowstochasticSeriesDumbell Dumbell_DefaultValue { get; set; }
		...
		/// </summary>
		public SlowstochasticSeriesEvents Events { get; set; }
		private SlowstochasticSeriesEvents Events_DefaultValue { get; set; }
		...
		/// </summary>
		public SlowstochasticSeriesFindNearestPointBy FindNearestPointBy { get; set; }
		private SlowstochasticSeriesFindNearestPointBy FindNearestPointBy_DefaultValue { get; set; }
		...
		/// </summary>
		public SlowstochasticSeriesGapUnit GapUnit { get; set; }
		private SlowstochasticSeriesGapUnit GapUnit_DefaultValue { get; set; }
		...
		/// </summary>
		public SlowstochasticSeriesLabel Label { get; set; }
		private SlowstochasticSeriesLabel Label_DefaultValue { get; set; }
		 

		/// <summary>
		/// The line marks the last price from all points.
		/// </summary>
		public SlowstochasticSeriesLastPrice LastPrice { get; set; }
		private SlowstochasticSeriesLastPrice LastPrice_DefaultValue { get; set; }
		 

		/// <summary>
		/// The line marks the last price from visible range of points.
		/// </summary>
		public SlowstochasticSeriesLastVisiblePrice LastVisiblePrice { get; set; }
		private SlowstochasticSeriesLastVisiblePrice LastVisiblePrice_DefaultValue { get; set; }
		...
		/// </summary>
		public SlowstochasticSeriesLegendSymbol LegendSymbol { get; set; }
		private SlowstochasticSeriesLegendSymbol LegendSymbol_DefaultValue { get; set; }
		 

		/// <summary>
		/// The line cap used for line ends and line joins on the graph.
		/// </summary>
		public SlowstochasticSeriesLinecap Linecap { get; set; }
		private SlowstochasticSeriesLinecap Linecap_DefaultValue { get; set; }
		...
		/// </summary>
		public SlowstochasticSeriesMarker Marker { get; set; }
		private SlowstochasticSeriesMarker Marker_DefaultValue { get; set; }
		...
		/// </summary>
		public SlowstochasticSeriesOnPoint OnPoint { get; set; }
		private SlowstochasticSeriesOnPoint OnPoint_DefaultValue { get; set; }
		...
		/// </summary>
		public SlowstochasticSeriesParams Params { get; set; }
		private SlowstochasticSeriesParams Params_DefaultValue { get; set; }
		 

		/// <summary>
		/// Properties for each single point.
		/// </summary>
		public SlowstochasticSeriesPoint Point { get; set; }
		private SlowstochasticSeriesPoint Point_DefaultValue { get; set; }
		...
		/// </summary>
		public SlowstochasticSeriesSmoothedLine SmoothedLine { get; set; }
		private SlowstochasticSeriesSmoothedLine SmoothedLine_DefaultValue { get; set; }
		...
		/// </summary>
		public SlowstochasticSeriesSonification Sonification { get; set; }
		private SlowstochasticSeriesSonification Sonification_DefaultValue { get; set; }
		...
		/// 
		/// </summary>
		public SlowstochasticSeriesStates States { get; set; }
		private SlowstochasticSeriesStates States_DefaultValue { get; set; }
		 

		/// <summary>
		/// Whether to apply steps to the line. Possible values are `left`,`center` and `right`.
		/// </summary>
		public SlowstochasticSeriesStep Step { get; set; }
		private SlowstochasticSeriesStep Step_DefaultValue { get; set; }
		...
		/// </summary>
		public SlowstochasticSeriesTooltip Tooltip { get; set; }
		private SlowstochasticSeriesTooltip Tooltip_DefaultValue { get; set; }
		...
		/// </summary>
		public List<SlowstochasticSeriesZones> Zones { get; set; }
		private List<SlowstochasticSeriesZones> Zones_DefaultValue { get; set; }
