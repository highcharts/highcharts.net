...
{
	public partial class SlowstochasticSeriesSonificationContextTracks  : BaseObject
	{
		Hashtable h = new Hashtable();

		public SlowstochasticSeriesSonificationContextTracks()
		{
			ActiveWhen = ActiveWhen_DefaultValue = new SlowstochasticSeriesSonificationContextTracksActiveWhen();
			Instrument = Instrument_DefaultValue = null;
			InstrumentString = InstrumentString_DefaultValue = "null";
			Mapping = Mapping_DefaultValue = new SlowstochasticSeriesSonificationContextTracksMapping();
			MidiName = MidiName_DefaultValue = "";
			PointGrouping = PointGrouping_DefaultValue = new SlowstochasticSeriesSonificationContextTracksPointGrouping();
			...
			Type = Type_DefaultValue = SlowstochasticSeriesSonificationContextTracksType.Instrument;
			ValueInterval = ValueInterval_DefaultValue = null;
			ValueMapFunction = ValueMapFunction_DefaultValue = SlowstochasticSeriesSonificationContextTracksValueMapFunction.Linear;
		...
		/// </summary>
		public SlowstochasticSeriesSonificationContextTracksActiveWhen ActiveWhen { get; set; }
		private SlowstochasticSeriesSonificationContextTracksActiveWhen ActiveWhen_DefaultValue { get; set; }
		...
		/// </summary>
		public SlowstochasticSeriesSonificationContextTracksMapping Mapping { get; set; }
		private SlowstochasticSeriesSonificationContextTracksMapping Mapping_DefaultValue { get; set; }
		...
		/// </summary>
		public SlowstochasticSeriesSonificationContextTracksPointGrouping PointGrouping { get; set; }
		private SlowstochasticSeriesSonificationContextTracksPointGrouping PointGrouping_DefaultValue { get; set; }
		...
		/// </summary>
		public SlowstochasticSeriesSonificationContextTracksType Type { get; set; }
		private SlowstochasticSeriesSonificationContextTracksType Type_DefaultValue { get; set; }
		...
		/// </summary>
		public SlowstochasticSeriesSonificationContextTracksValueMapFunction ValueMapFunction { get; set; }
		private SlowstochasticSeriesSonificationContextTracksValueMapFunction ValueMapFunction_DefaultValue { get; set; }
