...
{
	public partial class SlowstochasticSeriesSonificationContextTracksMapping  : BaseObject
	{
		Hashtable h = new Hashtable();

		public SlowstochasticSeriesSonificationContextTracksMapping()
		{
			Frequency = Frequency_DefaultValue = new SlowstochasticSeriesSonificationContextTracksMappingFrequency();
			GapBetweenNotes = GapBetweenNotes_DefaultValue = new SlowstochasticSeriesSonificationContextTracksMappingGapBetweenNotes();
			Highpass = Highpass_DefaultValue = new SlowstochasticSeriesSonificationContextTracksMappingHighpass();
			Lowpass = Lowpass_DefaultValue = new SlowstochasticSeriesSonificationContextTracksMappingLowpass();
			NoteDuration = NoteDuration_DefaultValue = new SlowstochasticSeriesSonificationContextTracksMappingNoteDuration();
			Pan = Pan_DefaultValue = new SlowstochasticSeriesSonificationContextTracksMappingPan();
			Pitch = Pitch_DefaultValue = new SlowstochasticSeriesSonificationContextTracksMappingPitch();
			PitchString = PitchString_DefaultValue = "null";
			PitchNumber = PitchNumber_DefaultValue = null;
			PlayDelay = PlayDelay_DefaultValue = new SlowstochasticSeriesSonificationContextTracksMappingPlayDelay();
			Time = Time_DefaultValue = new SlowstochasticSeriesSonificationContextTracksMappingTime();
			TimeString = TimeString_DefaultValue = "null";
			TimeNumber = TimeNumber_DefaultValue = null;
			Tremolo = Tremolo_DefaultValue = new SlowstochasticSeriesSonificationContextTracksMappingTremolo();
			Volume = Volume_DefaultValue = new SlowstochasticSeriesSonificationContextTracksMappingVolume();
		...
		/// </summary>
		public SlowstochasticSeriesSonificationContextTracksMappingFrequency Frequency { get; set; }
		private SlowstochasticSeriesSonificationContextTracksMappingFrequency Frequency_DefaultValue { get; set; }
		...
		/// </summary>
		public SlowstochasticSeriesSonificationContextTracksMappingGapBetweenNotes GapBetweenNotes { get; set; }
		private SlowstochasticSeriesSonificationContextTracksMappingGapBetweenNotes GapBetweenNotes_DefaultValue { get; set; }
		...
		/// </summary>
		public SlowstochasticSeriesSonificationContextTracksMappingHighpass Highpass { get; set; }
		private SlowstochasticSeriesSonificationContextTracksMappingHighpass Highpass_DefaultValue { get; set; }
		...
		/// </summary>
		public SlowstochasticSeriesSonificationContextTracksMappingLowpass Lowpass { get; set; }
		private SlowstochasticSeriesSonificationContextTracksMappingLowpass Lowpass_DefaultValue { get; set; }
		...
		/// </summary>
		public SlowstochasticSeriesSonificationContextTracksMappingNoteDuration NoteDuration { get; set; }
		private SlowstochasticSeriesSonificationContextTracksMappingNoteDuration NoteDuration_DefaultValue { get; set; }
		...
		/// </summary>
		public SlowstochasticSeriesSonificationContextTracksMappingPan Pan { get; set; }
		private SlowstochasticSeriesSonificationContextTracksMappingPan Pan_DefaultValue { get; set; }
		...
		/// </summary>
		public SlowstochasticSeriesSonificationContextTracksMappingPitch Pitch { get; set; }
		private SlowstochasticSeriesSonificationContextTracksMappingPitch Pitch_DefaultValue { get; set; }
		...
		/// </summary>
		public SlowstochasticSeriesSonificationContextTracksMappingPlayDelay PlayDelay { get; set; }
		private SlowstochasticSeriesSonificationContextTracksMappingPlayDelay PlayDelay_DefaultValue { get; set; }
		...
		/// </summary>
		public SlowstochasticSeriesSonificationContextTracksMappingTime Time { get; set; }
		private SlowstochasticSeriesSonificationContextTracksMappingTime Time_DefaultValue { get; set; }
		...
		/// </summary>
		public SlowstochasticSeriesSonificationContextTracksMappingTremolo Tremolo { get; set; }
		private SlowstochasticSeriesSonificationContextTracksMappingTremolo Tremolo_DefaultValue { get; set; }
		 

		/// <summary>
		/// The volume of notes, from 0 to 1.
		/// </summary>
		public SlowstochasticSeriesSonificationContextTracksMappingVolume Volume { get; set; }
		private SlowstochasticSeriesSonificationContextTracksMappingVolume Volume_DefaultValue { get; set; }
