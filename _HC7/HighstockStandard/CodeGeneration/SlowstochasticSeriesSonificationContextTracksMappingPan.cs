...
{
	public partial class SlowstochasticSeriesSonificationContextTracksMappingPan  : BaseObject
	{
		Hashtable h = new Hashtable();

		public SlowstochasticSeriesSonificationContextTracksMappingPan()
		{
			MapFunction = MapFunction_DefaultValue = SlowstochasticSeriesSonificationContextTracksMappingPanMapFunction.Linear;
			MapTo = MapTo_DefaultValue = "";
			Max = Max_DefaultValue = null;
			Min = Min_DefaultValue = null;
			Value = Value_DefaultValue = null;
			Within = Within_DefaultValue = SlowstochasticSeriesSonificationContextTracksMappingPanWithin.Chart;
		...
		/// </summary>
		public SlowstochasticSeriesSonificationContextTracksMappingPanMapFunction MapFunction { get; set; }
		private SlowstochasticSeriesSonificationContextTracksMappingPanMapFunction MapFunction_DefaultValue { get; set; }
		...
		/// </summary>
		public SlowstochasticSeriesSonificationContextTracksMappingPanWithin Within { get; set; }
		private SlowstochasticSeriesSonificationContextTracksMappingPanWithin Within_DefaultValue { get; set; }
