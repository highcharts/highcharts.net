...
{
	public partial class SlowstochasticSeriesSonificationContextTracksMappingVolume  : BaseObject
	{
		Hashtable h = new Hashtable();

		public SlowstochasticSeriesSonificationContextTracksMappingVolume()
		{
			MapFunction = MapFunction_DefaultValue = SlowstochasticSeriesSonificationContextTracksMappingVolumeMapFunction.Linear;
			MapTo = MapTo_DefaultValue = "";
			Max = Max_DefaultValue = null;
			Min = Min_DefaultValue = null;
			Value = Value_DefaultValue = null;
			Within = Within_DefaultValue = SlowstochasticSeriesSonificationContextTracksMappingVolumeWithin.Chart;
		...
		/// </summary>
		public SlowstochasticSeriesSonificationContextTracksMappingVolumeMapFunction MapFunction { get; set; }
		private SlowstochasticSeriesSonificationContextTracksMappingVolumeMapFunction MapFunction_DefaultValue { get; set; }
		...
		/// </summary>
		public SlowstochasticSeriesSonificationContextTracksMappingVolumeWithin Within { get; set; }
		private SlowstochasticSeriesSonificationContextTracksMappingVolumeWithin Within_DefaultValue { get; set; }
