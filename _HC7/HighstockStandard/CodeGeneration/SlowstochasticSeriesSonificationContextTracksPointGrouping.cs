...
namespace Highsoft.Web.Mvc.Stocks
{
	public partial class SlowstochasticSeriesSonificationContextTracksPointGrouping  : BaseObject
	{
		...
		{
			if (Algorithm != SlowstochasticSeriesSonificationContextTracksPointGroupingAlgorithm.Null) h.Add("algorithm", highstock.FirstCharacterToLower(Algorithm.ToString()));
