...
{
	public partial class SlowstochasticSeriesSonificationContextTracksPointGrouping  : BaseObject
	{
		Hashtable h = new Hashtable();

		public SlowstochasticSeriesSonificationContextTracksPointGrouping()
		{
			Algorithm = Algorithm_DefaultValue = SlowstochasticSeriesSonificationContextTracksPointGroupingAlgorithm.Minimax;
		...
		/// </summary>
		public SlowstochasticSeriesSonificationContextTracksPointGroupingAlgorithm Algorithm { get; set; }
		private SlowstochasticSeriesSonificationContextTracksPointGroupingAlgorithm Algorithm_DefaultValue { get; set; }
