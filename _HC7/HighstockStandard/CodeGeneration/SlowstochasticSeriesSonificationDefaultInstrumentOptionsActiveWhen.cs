...
{
	public partial class SlowstochasticSeriesSonificationDefaultInstrumentOptionsActiveWhen  : BaseObject
	{
		Hashtable h = new Hashtable();

		public SlowstochasticSeriesSonificationDefaultInstrumentOptionsActiveWhen()
		{
