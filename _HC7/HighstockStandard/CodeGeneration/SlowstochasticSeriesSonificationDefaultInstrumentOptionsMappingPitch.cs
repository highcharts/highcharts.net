...
{
	public partial class SlowstochasticSeriesSonificationDefaultInstrumentOptionsMappingPitch  : BaseObject
	{
		Hashtable h = new Hashtable();

		public SlowstochasticSeriesSonificationDefaultInstrumentOptionsMappingPitch()
		{
			MapFunction = MapFunction_DefaultValue = SlowstochasticSeriesSonificationDefaultInstrumentOptionsMappingPitchMapFunction.Linear;
		...
		/// </summary>
		public SlowstochasticSeriesSonificationDefaultInstrumentOptionsMappingPitchMapFunction MapFunction { get; set; }
		private SlowstochasticSeriesSonificationDefaultInstrumentOptionsMappingPitchMapFunction MapFunction_DefaultValue { get; set; }
