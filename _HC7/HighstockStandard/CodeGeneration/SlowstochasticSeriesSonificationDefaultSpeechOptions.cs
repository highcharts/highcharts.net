...
{
	public partial class SlowstochasticSeriesSonificationDefaultSpeechOptions  : BaseObject
	{
		Hashtable h = new Hashtable();

		public SlowstochasticSeriesSonificationDefaultSpeechOptions()
		{
			ActiveWhen = ActiveWhen_DefaultValue = new SlowstochasticSeriesSonificationDefaultSpeechOptionsActiveWhen();
			Language = Language_DefaultValue = "en-US";
			Mapping = Mapping_DefaultValue = new SlowstochasticSeriesSonificationDefaultSpeechOptionsMapping();
			PointGrouping = PointGrouping_DefaultValue = new SlowstochasticSeriesSonificationDefaultSpeechOptionsPointGrouping();
			PreferredVoice = PreferredVoice_DefaultValue = "";
			ShowPlayMarker = ShowPlayMarker_DefaultValue = true;
			Type = Type_DefaultValue = SlowstochasticSeriesSonificationDefaultSpeechOptionsType.Instrument;
		...
		/// </summary>
		public SlowstochasticSeriesSonificationDefaultSpeechOptionsActiveWhen ActiveWhen { get; set; }
		private SlowstochasticSeriesSonificationDefaultSpeechOptionsActiveWhen ActiveWhen_DefaultValue { get; set; }
		...
		/// </summary>
		public SlowstochasticSeriesSonificationDefaultSpeechOptionsMapping Mapping { get; set; }
		private SlowstochasticSeriesSonificationDefaultSpeechOptionsMapping Mapping_DefaultValue { get; set; }
		 

		/// <summary>
		/// Options for point grouping, specifically for instrument tracks.
		/// </summary>
		public SlowstochasticSeriesSonificationDefaultSpeechOptionsPointGrouping PointGrouping { get; set; }
		private SlowstochasticSeriesSonificationDefaultSpeechOptionsPointGrouping PointGrouping_DefaultValue { get; set; }
		...
		/// </summary>
		public SlowstochasticSeriesSonificationDefaultSpeechOptionsType Type { get; set; }
		private SlowstochasticSeriesSonificationDefaultSpeechOptionsType Type_DefaultValue { get; set; }
