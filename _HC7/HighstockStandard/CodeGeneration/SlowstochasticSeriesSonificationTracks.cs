...
{
	public partial class SlowstochasticSeriesSonificationTracks  : BaseObject
	{
		Hashtable h = new Hashtable();

		public SlowstochasticSeriesSonificationTracks()
		{
			ActiveWhen = ActiveWhen_DefaultValue = new SlowstochasticSeriesSonificationTracksActiveWhen();
			Instrument = Instrument_DefaultValue = null;
			InstrumentString = InstrumentString_DefaultValue = "null";
			Mapping = Mapping_DefaultValue = new SlowstochasticSeriesSonificationTracksMapping();
			MidiName = MidiName_DefaultValue = "";
			PointGrouping = PointGrouping_DefaultValue = new SlowstochasticSeriesSonificationTracksPointGrouping();
			RoundToMusicalNotes = RoundToMusicalNotes_DefaultValue = true;
			ShowPlayMarker = ShowPlayMarker_DefaultValue = true;
			Type = Type_DefaultValue = SlowstochasticSeriesSonificationTracksType.Instrument;
		...
		/// </summary>
		public SlowstochasticSeriesSonificationTracksActiveWhen ActiveWhen { get; set; }
		private SlowstochasticSeriesSonificationTracksActiveWhen ActiveWhen_DefaultValue { get; set; }
		...
		/// </summary>
		public SlowstochasticSeriesSonificationTracksMapping Mapping { get; set; }
		private SlowstochasticSeriesSonificationTracksMapping Mapping_DefaultValue { get; set; }
		...
		/// </summary>
		public SlowstochasticSeriesSonificationTracksPointGrouping PointGrouping { get; set; }
		private SlowstochasticSeriesSonificationTracksPointGrouping PointGrouping_DefaultValue { get; set; }
		...
		/// </summary>
		public SlowstochasticSeriesSonificationTracksType Type { get; set; }
		private SlowstochasticSeriesSonificationTracksType Type_DefaultValue { get; set; }
