...
{
	public partial class SlowstochasticSeriesSonificationTracksMapping  : BaseObject
	{
		Hashtable h = new Hashtable();

		public SlowstochasticSeriesSonificationTracksMapping()
		{
			Frequency = Frequency_DefaultValue = new SlowstochasticSeriesSonificationTracksMappingFrequency();
			GapBetweenNotes = GapBetweenNotes_DefaultValue = new SlowstochasticSeriesSonificationTracksMappingGapBetweenNotes();
			Highpass = Highpass_DefaultValue = new SlowstochasticSeriesSonificationTracksMappingHighpass();
			Lowpass = Lowpass_DefaultValue = new SlowstochasticSeriesSonificationTracksMappingLowpass();
			NoteDuration = NoteDuration_DefaultValue = new SlowstochasticSeriesSonificationTracksMappingNoteDuration();
			Pan = Pan_DefaultValue = new SlowstochasticSeriesSonificationTracksMappingPan();
			Pitch = Pitch_DefaultValue = new SlowstochasticSeriesSonificationTracksMappingPitch();
			PitchString = PitchString_DefaultValue = "null";
			PitchNumber = PitchNumber_DefaultValue = null;
			PlayDelay = PlayDelay_DefaultValue = new SlowstochasticSeriesSonificationTracksMappingPlayDelay();
			Time = Time_DefaultValue = new SlowstochasticSeriesSonificationTracksMappingTime();
			TimeString = TimeString_DefaultValue = "null";
			TimeNumber = TimeNumber_DefaultValue = null;
			Tremolo = Tremolo_DefaultValue = new SlowstochasticSeriesSonificationTracksMappingTremolo();
			Volume = Volume_DefaultValue = new SlowstochasticSeriesSonificationTracksMappingVolume();
		...
		/// </summary>
		public SlowstochasticSeriesSonificationTracksMappingFrequency Frequency { get; set; }
		private SlowstochasticSeriesSonificationTracksMappingFrequency Frequency_DefaultValue { get; set; }
		...
		/// </summary>
		public SlowstochasticSeriesSonificationTracksMappingGapBetweenNotes GapBetweenNotes { get; set; }
		private SlowstochasticSeriesSonificationTracksMappingGapBetweenNotes GapBetweenNotes_DefaultValue { get; set; }
		...
		/// </summary>
		public SlowstochasticSeriesSonificationTracksMappingHighpass Highpass { get; set; }
		private SlowstochasticSeriesSonificationTracksMappingHighpass Highpass_DefaultValue { get; set; }
		...
		/// </summary>
		public SlowstochasticSeriesSonificationTracksMappingLowpass Lowpass { get; set; }
		private SlowstochasticSeriesSonificationTracksMappingLowpass Lowpass_DefaultValue { get; set; }
		...
		/// </summary>
		public SlowstochasticSeriesSonificationTracksMappingNoteDuration NoteDuration { get; set; }
		private SlowstochasticSeriesSonificationTracksMappingNoteDuration NoteDuration_DefaultValue { get; set; }
		...
		/// </summary>
		public SlowstochasticSeriesSonificationTracksMappingPan Pan { get; set; }
		private SlowstochasticSeriesSonificationTracksMappingPan Pan_DefaultValue { get; set; }
		...
		/// </summary>
		public SlowstochasticSeriesSonificationTracksMappingPitch Pitch { get; set; }
		private SlowstochasticSeriesSonificationTracksMappingPitch Pitch_DefaultValue { get; set; }
		...
		/// </summary>
		public SlowstochasticSeriesSonificationTracksMappingPlayDelay PlayDelay { get; set; }
		private SlowstochasticSeriesSonificationTracksMappingPlayDelay PlayDelay_DefaultValue { get; set; }
		...
		/// </summary>
		public SlowstochasticSeriesSonificationTracksMappingTime Time { get; set; }
		private SlowstochasticSeriesSonificationTracksMappingTime Time_DefaultValue { get; set; }
		...
		/// </summary>
		public SlowstochasticSeriesSonificationTracksMappingTremolo Tremolo { get; set; }
		private SlowstochasticSeriesSonificationTracksMappingTremolo Tremolo_DefaultValue { get; set; }
		 

		/// <summary>
		/// The volume of notes, from 0 to 1.
		/// </summary>
		public SlowstochasticSeriesSonificationTracksMappingVolume Volume { get; set; }
		private SlowstochasticSeriesSonificationTracksMappingVolume Volume_DefaultValue { get; set; }
