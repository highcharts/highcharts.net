...
{
	public partial class SlowstochasticSeriesSonificationTracksMappingHighpassResonance  : BaseObject
	{
		Hashtable h = new Hashtable();

		public SlowstochasticSeriesSonificationTracksMappingHighpassResonance()
		{
			MapFunction = MapFunction_DefaultValue = SlowstochasticSeriesSonificationTracksMappingHighpassResonanceMapFunction.Linear;
			MapTo = MapTo_DefaultValue = "";
			Max = Max_DefaultValue = null;
			Min = Min_DefaultValue = null;
			Value = Value_DefaultValue = null;
			Within = Within_DefaultValue = SlowstochasticSeriesSonificationTracksMappingHighpassResonanceWithin.Chart;
		...
		/// </summary>
		public SlowstochasticSeriesSonificationTracksMappingHighpassResonanceMapFunction MapFunction { get; set; }
		private SlowstochasticSeriesSonificationTracksMappingHighpassResonanceMapFunction MapFunction_DefaultValue { get; set; }
		...
		/// </summary>
		public SlowstochasticSeriesSonificationTracksMappingHighpassResonanceWithin Within { get; set; }
		private SlowstochasticSeriesSonificationTracksMappingHighpassResonanceWithin Within_DefaultValue { get; set; }
