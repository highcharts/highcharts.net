...
{
	public partial class SlowstochasticSeriesSonificationTracksMappingLowpassResonance  : BaseObject
	{
		Hashtable h = new Hashtable();

		public SlowstochasticSeriesSonificationTracksMappingLowpassResonance()
		{
			MapFunction = MapFunction_DefaultValue = SlowstochasticSeriesSonificationTracksMappingLowpassResonanceMapFunction.Linear;
			MapTo = MapTo_DefaultValue = "";
			Max = Max_DefaultValue = null;
			Min = Min_DefaultValue = null;
			Value = Value_DefaultValue = null;
			Within = Within_DefaultValue = SlowstochasticSeriesSonificationTracksMappingLowpassResonanceWithin.Chart;
		...
		/// </summary>
		public SlowstochasticSeriesSonificationTracksMappingLowpassResonanceMapFunction MapFunction { get; set; }
		private SlowstochasticSeriesSonificationTracksMappingLowpassResonanceMapFunction MapFunction_DefaultValue { get; set; }
		...
		/// </summary>
		public SlowstochasticSeriesSonificationTracksMappingLowpassResonanceWithin Within { get; set; }
		private SlowstochasticSeriesSonificationTracksMappingLowpassResonanceWithin Within_DefaultValue { get; set; }
