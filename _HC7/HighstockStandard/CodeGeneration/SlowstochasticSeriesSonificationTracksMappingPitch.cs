...
{
	public partial class SlowstochasticSeriesSonificationTracksMappingPitch  : BaseObject
	{
		Hashtable h = new Hashtable();

		public SlowstochasticSeriesSonificationTracksMappingPitch()
		{
			MapFunction = MapFunction_DefaultValue = SlowstochasticSeriesSonificationTracksMappingPitchMapFunction.Linear;
		...
		/// </summary>
		public SlowstochasticSeriesSonificationTracksMappingPitchMapFunction MapFunction { get; set; }
		private SlowstochasticSeriesSonificationTracksMappingPitchMapFunction MapFunction_DefaultValue { get; set; }
