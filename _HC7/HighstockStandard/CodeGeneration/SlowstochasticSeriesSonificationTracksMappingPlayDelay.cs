...
{
	public partial class SlowstochasticSeriesSonificationTracksMappingPlayDelay  : BaseObject
	{
		Hashtable h = new Hashtable();

		public SlowstochasticSeriesSonificationTracksMappingPlayDelay()
		{
			MapFunction = MapFunction_DefaultValue = SlowstochasticSeriesSonificationTracksMappingPlayDelayMapFunction.Linear;
			MapTo = MapTo_DefaultValue = "";
			Max = Max_DefaultValue = null;
			Min = Min_DefaultValue = null;
			Value = Value_DefaultValue = null;
			Within = Within_DefaultValue = SlowstochasticSeriesSonificationTracksMappingPlayDelayWithin.Chart;
		...
		/// </summary>
		public SlowstochasticSeriesSonificationTracksMappingPlayDelayMapFunction MapFunction { get; set; }
		private SlowstochasticSeriesSonificationTracksMappingPlayDelayMapFunction MapFunction_DefaultValue { get; set; }
		...
		/// </summary>
		public SlowstochasticSeriesSonificationTracksMappingPlayDelayWithin Within { get; set; }
		private SlowstochasticSeriesSonificationTracksMappingPlayDelayWithin Within_DefaultValue { get; set; }
