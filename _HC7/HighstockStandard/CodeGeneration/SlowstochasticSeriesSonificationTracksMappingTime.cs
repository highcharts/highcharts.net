...
{
	public partial class SlowstochasticSeriesSonificationTracksMappingTime  : BaseObject
	{
		Hashtable h = new Hashtable();

		public SlowstochasticSeriesSonificationTracksMappingTime()
		{
			MapFunction = MapFunction_DefaultValue = SlowstochasticSeriesSonificationTracksMappingTimeMapFunction.Linear;
			MapTo = MapTo_DefaultValue = "";
			Max = Max_DefaultValue = null;
			Min = Min_DefaultValue = null;
			Value = Value_DefaultValue = null;
			Within = Within_DefaultValue = SlowstochasticSeriesSonificationTracksMappingTimeWithin.Chart;
		...
		/// </summary>
		public SlowstochasticSeriesSonificationTracksMappingTimeMapFunction MapFunction { get; set; }
		private SlowstochasticSeriesSonificationTracksMappingTimeMapFunction MapFunction_DefaultValue { get; set; }
		...
		/// </summary>
		public SlowstochasticSeriesSonificationTracksMappingTimeWithin Within { get; set; }
		private SlowstochasticSeriesSonificationTracksMappingTimeWithin Within_DefaultValue { get; set; }
