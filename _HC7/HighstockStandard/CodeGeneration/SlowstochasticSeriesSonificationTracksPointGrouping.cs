...
{
	public partial class SlowstochasticSeriesSonificationTracksPointGrouping  : BaseObject
	{
		Hashtable h = new Hashtable();

		public SlowstochasticSeriesSonificationTracksPointGrouping()
		{
			Algorithm = Algorithm_DefaultValue = SlowstochasticSeriesSonificationTracksPointGroupingAlgorithm.Minimax;
		...
		/// </summary>
		public SlowstochasticSeriesSonificationTracksPointGroupingAlgorithm Algorithm { get; set; }
		private SlowstochasticSeriesSonificationTracksPointGroupingAlgorithm Algorithm_DefaultValue { get; set; }
