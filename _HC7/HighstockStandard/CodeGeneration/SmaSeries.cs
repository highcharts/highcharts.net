...
{
	public partial class SmaSeries  : Series
	{
		Hashtable h = new Hashtable();

		public SmaSeries()
		{
			Accessibility = Accessibility_DefaultValue = new SmaSeriesAccessibility();
			AllowPointSelect = AllowPointSelect_DefaultValue = false;
			Animation = Animation_DefaultValue = new Animation() { Enabled = true };
			AnimationBool = AnimationBool_DefaultValue = true;
			AnimationLimit = AnimationLimit_DefaultValue = null;
			BoostBlending = BoostBlending_DefaultValue = SmaSeriesBoostBlending.Undefined;
			...
			Compare = Compare_DefaultValue = SmaSeriesCompare.Percent;
			CompareBase = CompareBase_DefaultValue = SmaSeriesCompareBase.Min;
			...
			Cursor = Cursor_DefaultValue = SmaSeriesCursor.Null;
			Custom = Custom_DefaultValue = new Hashtable();
			DashStyle = DashStyle_DefaultValue = SmaSeriesDashStyle.Null;
			DataGrouping = DataGrouping_DefaultValue = new SmaSeriesDataGrouping();
			DataLabels = DataLabels_DefaultValue = new SmaSeriesDataLabels();
			DataSorting = DataSorting_DefaultValue = new SmaSeriesDataSorting();
			Description = Description_DefaultValue = "";
			Dumbell = Dumbell_DefaultValue = new SmaSeriesDumbell();
			EnableMouseTracking = EnableMouseTracking_DefaultValue = true;
			Events = Events_DefaultValue = new SmaSeriesEvents();
			FindNearestPointBy = FindNearestPointBy_DefaultValue = SmaSeriesFindNearestPointBy.X;
			GapSize = GapSize_DefaultValue = 0;
			GapUnit = GapUnit_DefaultValue = SmaSeriesGapUnit.Relative;
			GetExtremesFromAll = GetExtremesFromAll_DefaultValue = false;
			Id = Id_DefaultValue = "";
			InactiveOtherPoints = InactiveOtherPoints_DefaultValue = false;
			IncludeInDataExport = IncludeInDataExport_DefaultValue = null;
			Index = Index_DefaultValue = null;
			Label = Label_DefaultValue = new SmaSeriesLabel();
			LastPrice = LastPrice_DefaultValue = new SmaSeriesLastPrice();
			LastVisiblePrice = LastVisiblePrice_DefaultValue = new SmaSeriesLastVisiblePrice();
			LegendIndex = LegendIndex_DefaultValue = null;
			LegendSymbol = LegendSymbol_DefaultValue = SmaSeriesLegendSymbol.Rectangle;
			Linecap = Linecap_DefaultValue = SmaSeriesLinecap.Round;
			LineWidth = LineWidth_DefaultValue = 2;
			LinkedTo = LinkedTo_DefaultValue = "";
			Marker = Marker_DefaultValue = new SmaSeriesMarker();
			Name = Name_DefaultValue = "";
			NegativeColor = NegativeColor_DefaultValue = "";
			OnPoint = OnPoint_DefaultValue = new SmaSeriesOnPoint();
			Opacity = Opacity_DefaultValue = 1;
			Params = Params_DefaultValue = new SmaSeriesParams();
			Point = Point_DefaultValue = new SmaSeriesPoint();
			...
			Sonification = Sonification_DefaultValue = new SmaSeriesSonification();
			Stack = Stack_DefaultValue = "";
			StackNumber = StackNumber_DefaultValue = null;
			States = States_DefaultValue = new SmaSeriesStates();
			Step = Step_DefaultValue = SmaSeriesStep.Null;
			...
			Zones = Zones_DefaultValue = new List<SmaSeriesZones>();
		...
		/// </summary>
		public SmaSeriesAccessibility Accessibility { get; set; }
		private SmaSeriesAccessibility Accessibility_DefaultValue { get; set; }
		...
		/// </summary>
		public SmaSeriesBoostBlending BoostBlending { get; set; }
		private SmaSeriesBoostBlending BoostBlending_DefaultValue { get; set; }
		...
		/// </summary>
		public SmaSeriesCompare Compare { get; set; }
		private SmaSeriesCompare Compare_DefaultValue { get; set; }
		 

		/// <summary>
		/// When [compare](#plotOptions.series.compare) is `percent`, this optiondictates whether to use 0 or 100 as the base of comparison.
		/// </summary>
		public SmaSeriesCompareBase CompareBase { get; set; }
		private SmaSeriesCompareBase CompareBase_DefaultValue { get; set; }
		...
		/// </summary>
		public SmaSeriesCursor Cursor { get; set; }
		private SmaSeriesCursor Cursor_DefaultValue { get; set; }
		...
		/// </summary>
		public SmaSeriesDashStyle DashStyle { get; set; }
		private SmaSeriesDashStyle DashStyle_DefaultValue { get; set; }
		...
		/// </summary>
		public SmaSeriesDataGrouping DataGrouping { get; set; }
		private SmaSeriesDataGrouping DataGrouping_DefaultValue { get; set; }
		...
		/// </summary>
		public SmaSeriesDataSorting DataSorting { get; set; }
		private SmaSeriesDataSorting DataSorting_DefaultValue { get; set; }
		...
		/// 
		/// </summary>
		public SmaSeriesDumbell Dumbell { get; set; }
		private SmaSeriesDumbell Dumbell_DefaultValue { get; set; }
		...
		/// </summary>
		public SmaSeriesFindNearestPointBy FindNearestPointBy { get; set; }
		private SmaSeriesFindNearestPointBy FindNearestPointBy_DefaultValue { get; set; }
		...
		/// </summary>
		public SmaSeriesLabel Label { get; set; }
		private SmaSeriesLabel Label_DefaultValue { get; set; }
		 

		/// <summary>
		/// The line marks the last price from all points.
		/// </summary>
		public SmaSeriesLastPrice LastPrice { get; set; }
		private SmaSeriesLastPrice LastPrice_DefaultValue { get; set; }
		 

		/// <summary>
		/// The line marks the last price from visible range of points.
		/// </summary>
		public SmaSeriesLastVisiblePrice LastVisiblePrice { get; set; }
		private SmaSeriesLastVisiblePrice LastVisiblePrice_DefaultValue { get; set; }
		...
		/// </summary>
		public SmaSeriesLegendSymbol LegendSymbol { get; set; }
		private SmaSeriesLegendSymbol LegendSymbol_DefaultValue { get; set; }
		 

		/// <summary>
		/// The line cap used for line ends and line joins on the graph.
		/// </summary>
		public SmaSeriesLinecap Linecap { get; set; }
		private SmaSeriesLinecap Linecap_DefaultValue { get; set; }
		...
		/// </summary>
		public SmaSeriesMarker Marker { get; set; }
		private SmaSeriesMarker Marker_DefaultValue { get; set; }
		...
		/// </summary>
		public SmaSeriesOnPoint OnPoint { get; set; }
		private SmaSeriesOnPoint OnPoint_DefaultValue { get; set; }
		...
		/// </summary>
		public SmaSeriesParams Params { get; set; }
		private SmaSeriesParams Params_DefaultValue { get; set; }
		 

		/// <summary>
		/// Properties for each single point.
		/// </summary>
		public SmaSeriesPoint Point { get; set; }
		private SmaSeriesPoint Point_DefaultValue { get; set; }
		...
		/// </summary>
		public SmaSeriesSonification Sonification { get; set; }
		private SmaSeriesSonification Sonification_DefaultValue { get; set; }
		...
		/// 
		/// </summary>
		public SmaSeriesStates States { get; set; }
		private SmaSeriesStates States_DefaultValue { get; set; }
		 

		/// <summary>
		/// Whether to apply steps to the line. Possible values are `left`,`center` and `right`.
		/// </summary>
		public SmaSeriesStep Step { get; set; }
		private SmaSeriesStep Step_DefaultValue { get; set; }
		...
		/// </summary>
		public SmaSeriesTooltip Tooltip { get; set; }
		private SmaSeriesTooltip Tooltip_DefaultValue { get; set; }
		...
		/// </summary>
		public List<SmaSeriesZones> Zones { get; set; }
		private List<SmaSeriesZones> Zones_DefaultValue { get; set; }
