...
namespace Highsoft.Web.Mvc.Stocks
{
	public partial class SmaSeriesAccessibility  : BaseObject
	{
		...
		public SmaSeriesAccessibility()
		{
			...
			Point = Point_DefaultValue = new SmaSeriesAccessibilityPoint();
		...
		/// </summary>
		public SmaSeriesAccessibilityPoint Point { get; set; }
		private SmaSeriesAccessibilityPoint Point_DefaultValue { get; set; }
