...
{
	public partial class SmaSeriesDragDropDragHandle  : BaseObject
	{
		public SmaSeriesDragDropDragHandle()
		{
		...
		internal override Hashtable ToHashtable()
		{
			...
			if (PathFormatter != PathFormatter_DefaultValue) { h.Add("pathFormatter",PathFormatter); Highstock.AddFunction("SmaSeriesDragDropDragHandlePathFormatter.pathFormatter", PathFormatter); }  
