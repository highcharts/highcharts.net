...
{
	public partial class SmaSeriesSonificationContextTracks  : BaseObject
	{
		Hashtable h = new Hashtable();

		public SmaSeriesSonificationContextTracks()
		{
			ActiveWhen = ActiveWhen_DefaultValue = new SmaSeriesSonificationContextTracksActiveWhen();
			Instrument = Instrument_DefaultValue = null;
			InstrumentString = InstrumentString_DefaultValue = "null";
			Mapping = Mapping_DefaultValue = new SmaSeriesSonificationContextTracksMapping();
			MidiName = MidiName_DefaultValue = "";
			PointGrouping = PointGrouping_DefaultValue = new SmaSeriesSonificationContextTracksPointGrouping();
			...
			Type = Type_DefaultValue = SmaSeriesSonificationContextTracksType.Instrument;
			ValueInterval = ValueInterval_DefaultValue = null;
			ValueMapFunction = ValueMapFunction_DefaultValue = SmaSeriesSonificationContextTracksValueMapFunction.Linear;
		...
		/// </summary>
		public SmaSeriesSonificationContextTracksActiveWhen ActiveWhen { get; set; }
		private SmaSeriesSonificationContextTracksActiveWhen ActiveWhen_DefaultValue { get; set; }
		...
		/// </summary>
		public SmaSeriesSonificationContextTracksMapping Mapping { get; set; }
		private SmaSeriesSonificationContextTracksMapping Mapping_DefaultValue { get; set; }
		...
		/// </summary>
		public SmaSeriesSonificationContextTracksPointGrouping PointGrouping { get; set; }
		private SmaSeriesSonificationContextTracksPointGrouping PointGrouping_DefaultValue { get; set; }
		...
		/// </summary>
		public SmaSeriesSonificationContextTracksType Type { get; set; }
		private SmaSeriesSonificationContextTracksType Type_DefaultValue { get; set; }
		...
		/// </summary>
		public SmaSeriesSonificationContextTracksValueMapFunction ValueMapFunction { get; set; }
		private SmaSeriesSonificationContextTracksValueMapFunction ValueMapFunction_DefaultValue { get; set; }
