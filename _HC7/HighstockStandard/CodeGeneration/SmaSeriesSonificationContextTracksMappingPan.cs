...
{
	public partial class SmaSeriesSonificationContextTracksMappingPan  : BaseObject
	{
		Hashtable h = new Hashtable();

		public SmaSeriesSonificationContextTracksMappingPan()
		{
			MapFunction = MapFunction_DefaultValue = SmaSeriesSonificationContextTracksMappingPanMapFunction.Linear;
			MapTo = MapTo_DefaultValue = "";
			Max = Max_DefaultValue = null;
			Min = Min_DefaultValue = null;
			Value = Value_DefaultValue = null;
			Within = Within_DefaultValue = SmaSeriesSonificationContextTracksMappingPanWithin.Chart;
		...
		/// </summary>
		public SmaSeriesSonificationContextTracksMappingPanMapFunction MapFunction { get; set; }
		private SmaSeriesSonificationContextTracksMappingPanMapFunction MapFunction_DefaultValue { get; set; }
		...
		/// </summary>
		public SmaSeriesSonificationContextTracksMappingPanWithin Within { get; set; }
		private SmaSeriesSonificationContextTracksMappingPanWithin Within_DefaultValue { get; set; }
