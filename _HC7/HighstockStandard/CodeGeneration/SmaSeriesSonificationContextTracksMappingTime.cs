...
{
	public partial class SmaSeriesSonificationContextTracksMappingTime  : BaseObject
	{
		Hashtable h = new Hashtable();

		public SmaSeriesSonificationContextTracksMappingTime()
		{
			MapFunction = MapFunction_DefaultValue = SmaSeriesSonificationContextTracksMappingTimeMapFunction.Linear;
			MapTo = MapTo_DefaultValue = "";
			Max = Max_DefaultValue = null;
			Min = Min_DefaultValue = null;
			Value = Value_DefaultValue = null;
			Within = Within_DefaultValue = SmaSeriesSonificationContextTracksMappingTimeWithin.Chart;
		...
		/// </summary>
		public SmaSeriesSonificationContextTracksMappingTimeMapFunction MapFunction { get; set; }
		private SmaSeriesSonificationContextTracksMappingTimeMapFunction MapFunction_DefaultValue { get; set; }
		...
		/// </summary>
		public SmaSeriesSonificationContextTracksMappingTimeWithin Within { get; set; }
		private SmaSeriesSonificationContextTracksMappingTimeWithin Within_DefaultValue { get; set; }
