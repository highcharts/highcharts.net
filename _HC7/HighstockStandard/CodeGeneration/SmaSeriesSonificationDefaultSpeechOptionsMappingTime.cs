...
{
	public partial class SmaSeriesSonificationDefaultSpeechOptionsMappingTime  : BaseObject
	{
		Hashtable h = new Hashtable();

		public SmaSeriesSonificationDefaultSpeechOptionsMappingTime()
		{
			MapFunction = MapFunction_DefaultValue = SmaSeriesSonificationDefaultSpeechOptionsMappingTimeMapFunction.Linear;
			MapTo = MapTo_DefaultValue = "";
			Max = Max_DefaultValue = null;
			Min = Min_DefaultValue = null;
			Value = Value_DefaultValue = null;
			Within = Within_DefaultValue = SmaSeriesSonificationDefaultSpeechOptionsMappingTimeWithin.Chart;
		...
		/// </summary>
		public SmaSeriesSonificationDefaultSpeechOptionsMappingTimeMapFunction MapFunction { get; set; }
		private SmaSeriesSonificationDefaultSpeechOptionsMappingTimeMapFunction MapFunction_DefaultValue { get; set; }
		...
		/// </summary>
		public SmaSeriesSonificationDefaultSpeechOptionsMappingTimeWithin Within { get; set; }
		private SmaSeriesSonificationDefaultSpeechOptionsMappingTimeWithin Within_DefaultValue { get; set; }
