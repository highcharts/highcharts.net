...
{
	public partial class SmaSeriesSonificationPointGrouping  : BaseObject
	{
		Hashtable h = new Hashtable();

		public SmaSeriesSonificationPointGrouping()
		{
			Algorithm = Algorithm_DefaultValue = SmaSeriesSonificationPointGroupingAlgorithm.Minimax;
		...
		/// </summary>
		public SmaSeriesSonificationPointGroupingAlgorithm Algorithm { get; set; }
		private SmaSeriesSonificationPointGroupingAlgorithm Algorithm_DefaultValue { get; set; }
