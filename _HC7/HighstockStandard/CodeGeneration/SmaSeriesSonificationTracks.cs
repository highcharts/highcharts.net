...
{
	public partial class SmaSeriesSonificationTracks  : BaseObject
	{
		Hashtable h = new Hashtable();

		public SmaSeriesSonificationTracks()
		{
			ActiveWhen = ActiveWhen_DefaultValue = new SmaSeriesSonificationTracksActiveWhen();
			Instrument = Instrument_DefaultValue = null;
			InstrumentString = InstrumentString_DefaultValue = "null";
			Mapping = Mapping_DefaultValue = new SmaSeriesSonificationTracksMapping();
			MidiName = MidiName_DefaultValue = "";
			PointGrouping = PointGrouping_DefaultValue = new SmaSeriesSonificationTracksPointGrouping();
			RoundToMusicalNotes = RoundToMusicalNotes_DefaultValue = true;
			ShowPlayMarker = ShowPlayMarker_DefaultValue = true;
			Type = Type_DefaultValue = SmaSeriesSonificationTracksType.Instrument;
		...
		/// </summary>
		public SmaSeriesSonificationTracksActiveWhen ActiveWhen { get; set; }
		private SmaSeriesSonificationTracksActiveWhen ActiveWhen_DefaultValue { get; set; }
		...
		/// </summary>
		public SmaSeriesSonificationTracksMapping Mapping { get; set; }
		private SmaSeriesSonificationTracksMapping Mapping_DefaultValue { get; set; }
		...
		/// </summary>
		public SmaSeriesSonificationTracksPointGrouping PointGrouping { get; set; }
		private SmaSeriesSonificationTracksPointGrouping PointGrouping_DefaultValue { get; set; }
		...
		/// </summary>
		public SmaSeriesSonificationTracksType Type { get; set; }
		private SmaSeriesSonificationTracksType Type_DefaultValue { get; set; }
