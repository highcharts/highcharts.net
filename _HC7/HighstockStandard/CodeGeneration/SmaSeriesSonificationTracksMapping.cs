...
{
	public partial class SmaSeriesSonificationTracksMapping  : BaseObject
	{
		Hashtable h = new Hashtable();

		public SmaSeriesSonificationTracksMapping()
		{
			Frequency = Frequency_DefaultValue = new SmaSeriesSonificationTracksMappingFrequency();
			GapBetweenNotes = GapBetweenNotes_DefaultValue = new SmaSeriesSonificationTracksMappingGapBetweenNotes();
			Highpass = Highpass_DefaultValue = new SmaSeriesSonificationTracksMappingHighpass();
			Lowpass = Lowpass_DefaultValue = new SmaSeriesSonificationTracksMappingLowpass();
			NoteDuration = NoteDuration_DefaultValue = new SmaSeriesSonificationTracksMappingNoteDuration();
			Pan = Pan_DefaultValue = new SmaSeriesSonificationTracksMappingPan();
			Pitch = Pitch_DefaultValue = new SmaSeriesSonificationTracksMappingPitch();
			PitchString = PitchString_DefaultValue = "null";
			PitchNumber = PitchNumber_DefaultValue = null;
			PlayDelay = PlayDelay_DefaultValue = new SmaSeriesSonificationTracksMappingPlayDelay();
			Time = Time_DefaultValue = new SmaSeriesSonificationTracksMappingTime();
			TimeString = TimeString_DefaultValue = "null";
			TimeNumber = TimeNumber_DefaultValue = null;
			Tremolo = Tremolo_DefaultValue = new SmaSeriesSonificationTracksMappingTremolo();
			Volume = Volume_DefaultValue = new SmaSeriesSonificationTracksMappingVolume();
		...
		/// </summary>
		public SmaSeriesSonificationTracksMappingFrequency Frequency { get; set; }
		private SmaSeriesSonificationTracksMappingFrequency Frequency_DefaultValue { get; set; }
		...
		/// </summary>
		public SmaSeriesSonificationTracksMappingGapBetweenNotes GapBetweenNotes { get; set; }
		private SmaSeriesSonificationTracksMappingGapBetweenNotes GapBetweenNotes_DefaultValue { get; set; }
		...
		/// </summary>
		public SmaSeriesSonificationTracksMappingHighpass Highpass { get; set; }
		private SmaSeriesSonificationTracksMappingHighpass Highpass_DefaultValue { get; set; }
		...
		/// </summary>
		public SmaSeriesSonificationTracksMappingLowpass Lowpass { get; set; }
		private SmaSeriesSonificationTracksMappingLowpass Lowpass_DefaultValue { get; set; }
		...
		/// </summary>
		public SmaSeriesSonificationTracksMappingNoteDuration NoteDuration { get; set; }
		private SmaSeriesSonificationTracksMappingNoteDuration NoteDuration_DefaultValue { get; set; }
		...
		/// </summary>
		public SmaSeriesSonificationTracksMappingPan Pan { get; set; }
		private SmaSeriesSonificationTracksMappingPan Pan_DefaultValue { get; set; }
		...
		/// </summary>
		public SmaSeriesSonificationTracksMappingPitch Pitch { get; set; }
		private SmaSeriesSonificationTracksMappingPitch Pitch_DefaultValue { get; set; }
		...
		/// </summary>
		public SmaSeriesSonificationTracksMappingPlayDelay PlayDelay { get; set; }
		private SmaSeriesSonificationTracksMappingPlayDelay PlayDelay_DefaultValue { get; set; }
		...
		/// </summary>
		public SmaSeriesSonificationTracksMappingTime Time { get; set; }
		private SmaSeriesSonificationTracksMappingTime Time_DefaultValue { get; set; }
		...
		/// </summary>
		public SmaSeriesSonificationTracksMappingTremolo Tremolo { get; set; }
		private SmaSeriesSonificationTracksMappingTremolo Tremolo_DefaultValue { get; set; }
		 

		/// <summary>
		/// The volume of notes, from 0 to 1.
		/// </summary>
		public SmaSeriesSonificationTracksMappingVolume Volume { get; set; }
		private SmaSeriesSonificationTracksMappingVolume Volume_DefaultValue { get; set; }
