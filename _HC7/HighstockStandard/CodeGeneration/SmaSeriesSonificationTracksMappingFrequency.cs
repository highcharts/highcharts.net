...
{
	public partial class SmaSeriesSonificationTracksMappingFrequency  : BaseObject
	{
		Hashtable h = new Hashtable();

		public SmaSeriesSonificationTracksMappingFrequency()
		{
			MapFunction = MapFunction_DefaultValue = SmaSeriesSonificationTracksMappingFrequencyMapFunction.Linear;
			MapTo = MapTo_DefaultValue = "";
			Max = Max_DefaultValue = null;
			Min = Min_DefaultValue = null;
			Value = Value_DefaultValue = null;
			Within = Within_DefaultValue = SmaSeriesSonificationTracksMappingFrequencyWithin.Chart;
		...
		/// </summary>
		public SmaSeriesSonificationTracksMappingFrequencyMapFunction MapFunction { get; set; }
		private SmaSeriesSonificationTracksMappingFrequencyMapFunction MapFunction_DefaultValue { get; set; }
		...
		/// </summary>
		public SmaSeriesSonificationTracksMappingFrequencyWithin Within { get; set; }
		private SmaSeriesSonificationTracksMappingFrequencyWithin Within_DefaultValue { get; set; }
