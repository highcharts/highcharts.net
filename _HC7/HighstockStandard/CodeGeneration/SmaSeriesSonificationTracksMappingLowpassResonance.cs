...
{
	public partial class SmaSeriesSonificationTracksMappingLowpassResonance  : BaseObject
	{
		Hashtable h = new Hashtable();

		public SmaSeriesSonificationTracksMappingLowpassResonance()
		{
			MapFunction = MapFunction_DefaultValue = SmaSeriesSonificationTracksMappingLowpassResonanceMapFunction.Linear;
			MapTo = MapTo_DefaultValue = "";
			Max = Max_DefaultValue = null;
			Min = Min_DefaultValue = null;
			Value = Value_DefaultValue = null;
			Within = Within_DefaultValue = SmaSeriesSonificationTracksMappingLowpassResonanceWithin.Chart;
		...
		/// </summary>
		public SmaSeriesSonificationTracksMappingLowpassResonanceMapFunction MapFunction { get; set; }
		private SmaSeriesSonificationTracksMappingLowpassResonanceMapFunction MapFunction_DefaultValue { get; set; }
		...
		/// </summary>
		public SmaSeriesSonificationTracksMappingLowpassResonanceWithin Within { get; set; }
		private SmaSeriesSonificationTracksMappingLowpassResonanceWithin Within_DefaultValue { get; set; }
