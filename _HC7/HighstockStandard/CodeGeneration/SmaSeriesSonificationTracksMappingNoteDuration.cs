...
{
	public partial class SmaSeriesSonificationTracksMappingNoteDuration  : BaseObject
	{
		Hashtable h = new Hashtable();

		public SmaSeriesSonificationTracksMappingNoteDuration()
		{
			MapFunction = MapFunction_DefaultValue = SmaSeriesSonificationTracksMappingNoteDurationMapFunction.Linear;
			MapTo = MapTo_DefaultValue = "";
			Max = Max_DefaultValue = null;
			Min = Min_DefaultValue = null;
			Value = Value_DefaultValue = null;
			Within = Within_DefaultValue = SmaSeriesSonificationTracksMappingNoteDurationWithin.Chart;
		...
		/// </summary>
		public SmaSeriesSonificationTracksMappingNoteDurationMapFunction MapFunction { get; set; }
		private SmaSeriesSonificationTracksMappingNoteDurationMapFunction MapFunction_DefaultValue { get; set; }
		...
		/// </summary>
		public SmaSeriesSonificationTracksMappingNoteDurationWithin Within { get; set; }
		private SmaSeriesSonificationTracksMappingNoteDurationWithin Within_DefaultValue { get; set; }
