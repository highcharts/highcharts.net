...
{
	public partial class SmaSeriesSonificationTracksMappingPlayDelay  : BaseObject
	{
		Hashtable h = new Hashtable();

		public SmaSeriesSonificationTracksMappingPlayDelay()
		{
			MapFunction = MapFunction_DefaultValue = SmaSeriesSonificationTracksMappingPlayDelayMapFunction.Linear;
			MapTo = MapTo_DefaultValue = "";
			Max = Max_DefaultValue = null;
			Min = Min_DefaultValue = null;
			Value = Value_DefaultValue = null;
			Within = Within_DefaultValue = SmaSeriesSonificationTracksMappingPlayDelayWithin.Chart;
		...
		/// </summary>
		public SmaSeriesSonificationTracksMappingPlayDelayMapFunction MapFunction { get; set; }
		private SmaSeriesSonificationTracksMappingPlayDelayMapFunction MapFunction_DefaultValue { get; set; }
		...
		/// </summary>
		public SmaSeriesSonificationTracksMappingPlayDelayWithin Within { get; set; }
		private SmaSeriesSonificationTracksMappingPlayDelayWithin Within_DefaultValue { get; set; }
