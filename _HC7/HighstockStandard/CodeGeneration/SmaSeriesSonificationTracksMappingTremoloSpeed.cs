...
{
	public partial class SmaSeriesSonificationTracksMappingTremoloSpeed  : BaseObject
	{
		Hashtable h = new Hashtable();

		public SmaSeriesSonificationTracksMappingTremoloSpeed()
		{
			MapFunction = MapFunction_DefaultValue = SmaSeriesSonificationTracksMappingTremoloSpeedMapFunction.Linear;
			MapTo = MapTo_DefaultValue = "";
			Max = Max_DefaultValue = null;
			Min = Min_DefaultValue = null;
			Value = Value_DefaultValue = null;
			Within = Within_DefaultValue = SmaSeriesSonificationTracksMappingTremoloSpeedWithin.Chart;
		...
		/// </summary>
		public SmaSeriesSonificationTracksMappingTremoloSpeedMapFunction MapFunction { get; set; }
		private SmaSeriesSonificationTracksMappingTremoloSpeedMapFunction MapFunction_DefaultValue { get; set; }
		...
		/// </summary>
		public SmaSeriesSonificationTracksMappingTremoloSpeedWithin Within { get; set; }
		private SmaSeriesSonificationTracksMappingTremoloSpeedWithin Within_DefaultValue { get; set; }
