...
{
	public partial class SmaSeriesSonificationTracksPointGrouping  : BaseObject
	{
		Hashtable h = new Hashtable();

		public SmaSeriesSonificationTracksPointGrouping()
		{
			Algorithm = Algorithm_DefaultValue = SmaSeriesSonificationTracksPointGroupingAlgorithm.Minimax;
		...
		/// </summary>
		public SmaSeriesSonificationTracksPointGroupingAlgorithm Algorithm { get; set; }
		private SmaSeriesSonificationTracksPointGroupingAlgorithm Algorithm_DefaultValue { get; set; }
