...
{
	public partial class SmaSeriesStatesHoverMarker  : BaseObject
	{
		public SmaSeriesStatesHoverMarker()
		{
			...
			States = States_DefaultValue = new SmaSeriesStatesHoverMarkerStates();
		...
		/// </summary>
		public SmaSeriesStatesHoverMarkerStates States { get; set; }
		private SmaSeriesStatesHoverMarkerStates States_DefaultValue { get; set; }
