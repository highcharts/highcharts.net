...
{
	public partial class SmaSeriesTooltip  : BaseObject
	{
		public SmaSeriesTooltip()
		{
			...
			HeaderShape = HeaderShape_DefaultValue = SmaSeriesTooltipHeaderShape.Callout;
		...
		/// </summary>
		public SmaSeriesTooltipHeaderShape HeaderShape { get; set; }
		private SmaSeriesTooltipHeaderShape HeaderShape_DefaultValue { get; set; }
		...
		internal override Hashtable ToHashtable()
		{
			...
			if (NullFormatter != NullFormatter_DefaultValue) { h.Add("nullFormatter",NullFormatter); Highstock.AddFunction("SmaSeriesTooltipNullFormatter.nullFormatter", NullFormatter); }  
			if (Outside != Outside_DefaultValue) h.Add("outside",Outside);
			if (Padding != Padding_DefaultValue) h.Add("padding",Padding);
			if (PointFormat != PointFormat_DefaultValue) h.Add("pointFormat",PointFormat);
			if (PointFormatter != PointFormatter_DefaultValue) { h.Add("pointFormatter",PointFormatter); Highstock.AddFunction("SmaSeriesTooltipPointFormatter.pointFormatter", PointFormatter); }  
