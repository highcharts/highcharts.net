...
namespace Highsoft.Web.Mvc.Stocks
{
	public partial class Sonification  : BaseObject
	{
		...
		internal override Hashtable ToHashtable(Highstock highstock)
		{
			...
			if (GlobalContextTracks != null) h.Add("globalContextTracks",GlobalContextTracks.ToHashtable(highstock));
			if (GlobalTracks != null) h.Add("globalTracks",GlobalTracks.ToHashtable(highstock));
			if (MasterVolume != null) h.Add("masterVolume",MasterVolume);
			if (Order != SonificationOrder.Null) h.Add("order", highstock.FirstCharacterToLower(Order.ToString()));
