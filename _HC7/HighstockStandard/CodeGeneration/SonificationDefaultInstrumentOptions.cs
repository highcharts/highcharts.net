...
{
	public partial class SonificationDefaultInstrumentOptions  : BaseObject
	{
		Hashtable h = new Hashtable();

		public SonificationDefaultInstrumentOptions()
		{
			ActiveWhen = ActiveWhen_DefaultValue = new SonificationDefaultInstrumentOptionsActiveWhen();
			Instrument = Instrument_DefaultValue = null;
			InstrumentString = InstrumentString_DefaultValue = "null";
			Mapping = Mapping_DefaultValue = new SonificationDefaultInstrumentOptionsMapping();
			MidiName = MidiName_DefaultValue = "";
			PointGrouping = PointGrouping_DefaultValue = new SonificationDefaultInstrumentOptionsPointGrouping();
			RoundToMusicalNotes = RoundToMusicalNotes_DefaultValue = true;
			ShowPlayMarker = ShowPlayMarker_DefaultValue = true;
			Type = Type_DefaultValue = SonificationDefaultInstrumentOptionsType.Instrument;
		...
		/// </summary>
		public SonificationDefaultInstrumentOptionsActiveWhen ActiveWhen { get; set; }
		private SonificationDefaultInstrumentOptionsActiveWhen ActiveWhen_DefaultValue { get; set; }
		...
		/// </summary>
		public SonificationDefaultInstrumentOptionsMapping Mapping { get; set; }
		private SonificationDefaultInstrumentOptionsMapping Mapping_DefaultValue { get; set; }
		...
		/// </summary>
		public SonificationDefaultInstrumentOptionsPointGrouping PointGrouping { get; set; }
		private SonificationDefaultInstrumentOptionsPointGrouping PointGrouping_DefaultValue { get; set; }
		...
		/// </summary>
		public SonificationDefaultInstrumentOptionsType Type { get; set; }
		private SonificationDefaultInstrumentOptionsType Type_DefaultValue { get; set; }
