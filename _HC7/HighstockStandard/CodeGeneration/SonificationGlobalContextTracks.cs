...
{
	public partial class SonificationGlobalContextTracks  : BaseObject
	{
		Hashtable h = new Hashtable();

		public SonificationGlobalContextTracks()
		{
			ActiveWhen = ActiveWhen_DefaultValue = new SonificationGlobalContextTracksActiveWhen();
			Instrument = Instrument_DefaultValue = null;
			InstrumentString = InstrumentString_DefaultValue = "null";
			Mapping = Mapping_DefaultValue = new SonificationGlobalContextTracksMapping();
			MidiName = MidiName_DefaultValue = "";
			PointGrouping = PointGrouping_DefaultValue = new SonificationGlobalContextTracksPointGrouping();
			...
			Type = Type_DefaultValue = SonificationGlobalContextTracksType.Instrument;
			ValueInterval = ValueInterval_DefaultValue = null;
			ValueMapFunction = ValueMapFunction_DefaultValue = SonificationGlobalContextTracksValueMapFunction.Linear;
		...
		/// </summary>
		public SonificationGlobalContextTracksActiveWhen ActiveWhen { get; set; }
		private SonificationGlobalContextTracksActiveWhen ActiveWhen_DefaultValue { get; set; }
		...
		/// </summary>
		public SonificationGlobalContextTracksMapping Mapping { get; set; }
		private SonificationGlobalContextTracksMapping Mapping_DefaultValue { get; set; }
		...
		/// </summary>
		public SonificationGlobalContextTracksPointGrouping PointGrouping { get; set; }
		private SonificationGlobalContextTracksPointGrouping PointGrouping_DefaultValue { get; set; }
		...
		/// </summary>
		public SonificationGlobalContextTracksType Type { get; set; }
		private SonificationGlobalContextTracksType Type_DefaultValue { get; set; }
		...
		/// </summary>
		public SonificationGlobalContextTracksValueMapFunction ValueMapFunction { get; set; }
		private SonificationGlobalContextTracksValueMapFunction ValueMapFunction_DefaultValue { get; set; }
