...
{
	public partial class SonificationGlobalTracks  : BaseObject
	{
		Hashtable h = new Hashtable();

		public SonificationGlobalTracks()
		{
			ActiveWhen = ActiveWhen_DefaultValue = new SonificationGlobalTracksActiveWhen();
			Instrument = Instrument_DefaultValue = null;
			InstrumentString = InstrumentString_DefaultValue = "null";
			Mapping = Mapping_DefaultValue = new SonificationGlobalTracksMapping();
			MidiName = MidiName_DefaultValue = "";
			PointGrouping = PointGrouping_DefaultValue = new SonificationGlobalTracksPointGrouping();
			RoundToMusicalNotes = RoundToMusicalNotes_DefaultValue = true;
			ShowPlayMarker = ShowPlayMarker_DefaultValue = true;
			Type = Type_DefaultValue = SonificationGlobalTracksType.Instrument;
		...
		/// </summary>
		public SonificationGlobalTracksActiveWhen ActiveWhen { get; set; }
		private SonificationGlobalTracksActiveWhen ActiveWhen_DefaultValue { get; set; }
		...
		/// 
		/// </summary>
		public SonificationGlobalTracksMapping Mapping { get; set; }
		private SonificationGlobalTracksMapping Mapping_DefaultValue { get; set; }
		...
		/// </summary>
		public SonificationGlobalTracksPointGrouping PointGrouping { get; set; }
		private SonificationGlobalTracksPointGrouping PointGrouping_DefaultValue { get; set; }
		...
		/// </summary>
		public SonificationGlobalTracksType Type { get; set; }
		private SonificationGlobalTracksType Type_DefaultValue { get; set; }
