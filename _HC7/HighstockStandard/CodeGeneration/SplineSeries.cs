...
{
	public partial class SplineSeries  : Series
	{
		Hashtable h = new Hashtable();

		public SplineSeries()
		{
			Accessibility = Accessibility_DefaultValue = new SplineSeriesAccessibility();
			...
			Compare = Compare_DefaultValue = SplineSeriesCompare.Percent;
			...
			DashStyle = DashStyle_DefaultValue = SplineSeriesDashStyle.Null;
			Data = Data_DefaultValue = new List<SplineSeriesData>();
			DataGrouping = DataGrouping_DefaultValue = new SplineSeriesDataGrouping();
			DataLabels = DataLabels_DefaultValue = new SplineSeriesDataLabels();
			DataSorting = DataSorting_DefaultValue = new SplineSeriesDataSorting();
			Description = Description_DefaultValue = "";
			DragDrop = DragDrop_DefaultValue = new SplineSeriesDragDrop();
			Dumbell = Dumbell_DefaultValue = new SplineSeriesDumbell();
			EnableMouseTracking = EnableMouseTracking_DefaultValue = true;
			Events = Events_DefaultValue = new SplineSeriesEvents();
			FindNearestPointBy = FindNearestPointBy_DefaultValue = SplineSeriesFindNearestPointBy.X;
			GapSize = GapSize_DefaultValue = 0;
			GapUnit = GapUnit_DefaultValue = SplineSeriesGapUnit.Relative;
			...
			Label = Label_DefaultValue = new SplineSeriesLabel();
			LastPrice = LastPrice_DefaultValue = new SplineSeriesLastPrice();
			LastVisiblePrice = LastVisiblePrice_DefaultValue = new SplineSeriesLastVisiblePrice();
			LegendIndex = LegendIndex_DefaultValue = null;
			LegendSymbol = LegendSymbol_DefaultValue = SplineSeriesLegendSymbol.Rectangle;
			Linecap = Linecap_DefaultValue = SplineSeriesLinecap.Round;
			LineWidth = LineWidth_DefaultValue = 2;
			LinkedTo = LinkedTo_DefaultValue = "";
			Marker = Marker_DefaultValue = new SplineSeriesMarker();
			Name = Name_DefaultValue = "";
			NegativeColor = NegativeColor_DefaultValue = "";
			OnPoint = OnPoint_DefaultValue = new SplineSeriesOnPoint();
			Opacity = Opacity_DefaultValue = 1;
			Point = Point_DefaultValue = new SplineSeriesPoint();
			...
			Sonification = Sonification_DefaultValue = new SplineSeriesSonification();
			Stack = Stack_DefaultValue = "";
			StackNumber = StackNumber_DefaultValue = null;
			Stacking = Stacking_DefaultValue = SplineSeriesStacking.Null;
			States = States_DefaultValue = new SplineSeriesStates();
			StickyTracking = StickyTracking_DefaultValue = true;
			Threshold = Threshold_DefaultValue = 0;
			Tooltip = Tooltip_DefaultValue = new SplineSeriesTooltip();
			...
			Zones = Zones_DefaultValue = new List<SplineSeriesZones>();
		...
		/// </summary>
		public SplineSeriesAccessibility Accessibility { get; set; }
		private SplineSeriesAccessibility Accessibility_DefaultValue { get; set; }
		...
		/// </summary>
		public SplineSeriesCompare Compare { get; set; }
		private SplineSeriesCompare Compare_DefaultValue { get; set; }
		...
		/// </summary>
		public SplineSeriesDataSorting DataSorting { get; set; }
		private SplineSeriesDataSorting DataSorting_DefaultValue { get; set; }
		...
		/// </summary>
		public SplineSeriesDragDrop DragDrop { get; set; }
		private SplineSeriesDragDrop DragDrop_DefaultValue { get; set; }
		 

		/// <summary>
		/// 
		/// </summary>
		public SplineSeriesDumbell Dumbell { get; set; }
		private SplineSeriesDumbell Dumbell_DefaultValue { get; set; }
		...
		/// </summary>
		public SplineSeriesFindNearestPointBy FindNearestPointBy { get; set; }
		private SplineSeriesFindNearestPointBy FindNearestPointBy_DefaultValue { get; set; }
		...
		/// </summary>
		public SplineSeriesGapUnit GapUnit { get; set; }
		private SplineSeriesGapUnit GapUnit_DefaultValue { get; set; }
		...
		/// </summary>
		public SplineSeriesLabel Label { get; set; }
		private SplineSeriesLabel Label_DefaultValue { get; set; }
		 

		/// <summary>
		/// The line marks the last price from all points.
		/// </summary>
		public SplineSeriesLastPrice LastPrice { get; set; }
		private SplineSeriesLastPrice LastPrice_DefaultValue { get; set; }
		 

		/// <summary>
		/// The line marks the last price from visible range of points.
		/// </summary>
		public SplineSeriesLastVisiblePrice LastVisiblePrice { get; set; }
		private SplineSeriesLastVisiblePrice LastVisiblePrice_DefaultValue { get; set; }
		...
		/// </summary>
		public SplineSeriesLegendSymbol LegendSymbol { get; set; }
		private SplineSeriesLegendSymbol LegendSymbol_DefaultValue { get; set; }
		...
		/// </summary>
		public SplineSeriesOnPoint OnPoint { get; set; }
		private SplineSeriesOnPoint OnPoint_DefaultValue { get; set; }
		...
		/// </summary>
		public SplineSeriesSonification Sonification { get; set; }
		private SplineSeriesSonification Sonification_DefaultValue { get; set; }
		...
		/// </summary>
		public List<SplineSeriesZones> Zones { get; set; }
		private List<SplineSeriesZones> Zones_DefaultValue { get; set; }
