...
{
	public partial class SplineSeriesSonificationContextTracksMapping  : BaseObject
	{
		Hashtable h = new Hashtable();

		public SplineSeriesSonificationContextTracksMapping()
		{
			Frequency = Frequency_DefaultValue = new SplineSeriesSonificationContextTracksMappingFrequency();
			GapBetweenNotes = GapBetweenNotes_DefaultValue = new SplineSeriesSonificationContextTracksMappingGapBetweenNotes();
			Highpass = Highpass_DefaultValue = new SplineSeriesSonificationContextTracksMappingHighpass();
			Lowpass = Lowpass_DefaultValue = new SplineSeriesSonificationContextTracksMappingLowpass();
			NoteDuration = NoteDuration_DefaultValue = new SplineSeriesSonificationContextTracksMappingNoteDuration();
			Pan = Pan_DefaultValue = new SplineSeriesSonificationContextTracksMappingPan();
			Pitch = Pitch_DefaultValue = new SplineSeriesSonificationContextTracksMappingPitch();
			PitchString = PitchString_DefaultValue = "null";
			PitchNumber = PitchNumber_DefaultValue = null;
			PlayDelay = PlayDelay_DefaultValue = new SplineSeriesSonificationContextTracksMappingPlayDelay();
			Time = Time_DefaultValue = new SplineSeriesSonificationContextTracksMappingTime();
			TimeString = TimeString_DefaultValue = "null";
			TimeNumber = TimeNumber_DefaultValue = null;
			Tremolo = Tremolo_DefaultValue = new SplineSeriesSonificationContextTracksMappingTremolo();
			Volume = Volume_DefaultValue = new SplineSeriesSonificationContextTracksMappingVolume();
		...
		/// </summary>
		public SplineSeriesSonificationContextTracksMappingFrequency Frequency { get; set; }
		private SplineSeriesSonificationContextTracksMappingFrequency Frequency_DefaultValue { get; set; }
		...
		/// </summary>
		public SplineSeriesSonificationContextTracksMappingGapBetweenNotes GapBetweenNotes { get; set; }
		private SplineSeriesSonificationContextTracksMappingGapBetweenNotes GapBetweenNotes_DefaultValue { get; set; }
		...
		/// </summary>
		public SplineSeriesSonificationContextTracksMappingHighpass Highpass { get; set; }
		private SplineSeriesSonificationContextTracksMappingHighpass Highpass_DefaultValue { get; set; }
		...
		/// </summary>
		public SplineSeriesSonificationContextTracksMappingLowpass Lowpass { get; set; }
		private SplineSeriesSonificationContextTracksMappingLowpass Lowpass_DefaultValue { get; set; }
		...
		/// </summary>
		public SplineSeriesSonificationContextTracksMappingNoteDuration NoteDuration { get; set; }
		private SplineSeriesSonificationContextTracksMappingNoteDuration NoteDuration_DefaultValue { get; set; }
		...
		/// </summary>
		public SplineSeriesSonificationContextTracksMappingPan Pan { get; set; }
		private SplineSeriesSonificationContextTracksMappingPan Pan_DefaultValue { get; set; }
		...
		/// </summary>
		public SplineSeriesSonificationContextTracksMappingPitch Pitch { get; set; }
		private SplineSeriesSonificationContextTracksMappingPitch Pitch_DefaultValue { get; set; }
		...
		/// </summary>
		public SplineSeriesSonificationContextTracksMappingPlayDelay PlayDelay { get; set; }
		private SplineSeriesSonificationContextTracksMappingPlayDelay PlayDelay_DefaultValue { get; set; }
		...
		/// </summary>
		public SplineSeriesSonificationContextTracksMappingTime Time { get; set; }
		private SplineSeriesSonificationContextTracksMappingTime Time_DefaultValue { get; set; }
		...
		/// </summary>
		public SplineSeriesSonificationContextTracksMappingTremolo Tremolo { get; set; }
		private SplineSeriesSonificationContextTracksMappingTremolo Tremolo_DefaultValue { get; set; }
		 

		/// <summary>
		/// The volume of notes, from 0 to 1.
		/// </summary>
		public SplineSeriesSonificationContextTracksMappingVolume Volume { get; set; }
		private SplineSeriesSonificationContextTracksMappingVolume Volume_DefaultValue { get; set; }
