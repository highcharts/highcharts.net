...
{
	public partial class SplineSeriesSonificationDefaultSpeechOptionsMapping  : BaseObject
	{
		Hashtable h = new Hashtable();

		public SplineSeriesSonificationDefaultSpeechOptionsMapping()
		{
			Frequency = Frequency_DefaultValue = new SplineSeriesSonificationDefaultSpeechOptionsMappingFrequency();
			GapBetweenNotes = GapBetweenNotes_DefaultValue = new SplineSeriesSonificationDefaultSpeechOptionsMappingGapBetweenNotes();
			Highpass = Highpass_DefaultValue = new SplineSeriesSonificationDefaultSpeechOptionsMappingHighpass();
			Lowpass = Lowpass_DefaultValue = new SplineSeriesSonificationDefaultSpeechOptionsMappingLowpass();
			NoteDuration = NoteDuration_DefaultValue = new SplineSeriesSonificationDefaultSpeechOptionsMappingNoteDuration();
			Pan = Pan_DefaultValue = new SplineSeriesSonificationDefaultSpeechOptionsMappingPan();
			Pitch = Pitch_DefaultValue = new SplineSeriesSonificationDefaultSpeechOptionsMappingPitch();
			PitchString = PitchString_DefaultValue = "null";
			PitchNumber = PitchNumber_DefaultValue = null;
			PlayDelay = PlayDelay_DefaultValue = new SplineSeriesSonificationDefaultSpeechOptionsMappingPlayDelay();
			Time = Time_DefaultValue = new SplineSeriesSonificationDefaultSpeechOptionsMappingTime();
			TimeString = TimeString_DefaultValue = "null";
			TimeNumber = TimeNumber_DefaultValue = null;
			Tremolo = Tremolo_DefaultValue = new SplineSeriesSonificationDefaultSpeechOptionsMappingTremolo();
			Volume = Volume_DefaultValue = new SplineSeriesSonificationDefaultSpeechOptionsMappingVolume();
		...
		/// </summary>
		public SplineSeriesSonificationDefaultSpeechOptionsMappingFrequency Frequency { get; set; }
		private SplineSeriesSonificationDefaultSpeechOptionsMappingFrequency Frequency_DefaultValue { get; set; }
		...
		/// </summary>
		public SplineSeriesSonificationDefaultSpeechOptionsMappingGapBetweenNotes GapBetweenNotes { get; set; }
		private SplineSeriesSonificationDefaultSpeechOptionsMappingGapBetweenNotes GapBetweenNotes_DefaultValue { get; set; }
		...
		/// </summary>
		public SplineSeriesSonificationDefaultSpeechOptionsMappingHighpass Highpass { get; set; }
		private SplineSeriesSonificationDefaultSpeechOptionsMappingHighpass Highpass_DefaultValue { get; set; }
		...
		/// </summary>
		public SplineSeriesSonificationDefaultSpeechOptionsMappingLowpass Lowpass { get; set; }
		private SplineSeriesSonificationDefaultSpeechOptionsMappingLowpass Lowpass_DefaultValue { get; set; }
		...
		/// </summary>
		public SplineSeriesSonificationDefaultSpeechOptionsMappingNoteDuration NoteDuration { get; set; }
		private SplineSeriesSonificationDefaultSpeechOptionsMappingNoteDuration NoteDuration_DefaultValue { get; set; }
		...
		/// </summary>
		public SplineSeriesSonificationDefaultSpeechOptionsMappingPan Pan { get; set; }
		private SplineSeriesSonificationDefaultSpeechOptionsMappingPan Pan_DefaultValue { get; set; }
		...
		/// </summary>
		public SplineSeriesSonificationDefaultSpeechOptionsMappingPitch Pitch { get; set; }
		private SplineSeriesSonificationDefaultSpeechOptionsMappingPitch Pitch_DefaultValue { get; set; }
		...
		/// </summary>
		public SplineSeriesSonificationDefaultSpeechOptionsMappingPlayDelay PlayDelay { get; set; }
		private SplineSeriesSonificationDefaultSpeechOptionsMappingPlayDelay PlayDelay_DefaultValue { get; set; }
		...
		/// </summary>
		public SplineSeriesSonificationDefaultSpeechOptionsMappingTime Time { get; set; }
		private SplineSeriesSonificationDefaultSpeechOptionsMappingTime Time_DefaultValue { get; set; }
		...
		/// </summary>
		public SplineSeriesSonificationDefaultSpeechOptionsMappingTremolo Tremolo { get; set; }
		private SplineSeriesSonificationDefaultSpeechOptionsMappingTremolo Tremolo_DefaultValue { get; set; }
		 

		/// <summary>
		/// The volume of notes, from 0 to 1.
		/// </summary>
		public SplineSeriesSonificationDefaultSpeechOptionsMappingVolume Volume { get; set; }
		private SplineSeriesSonificationDefaultSpeechOptionsMappingVolume Volume_DefaultValue { get; set; }
