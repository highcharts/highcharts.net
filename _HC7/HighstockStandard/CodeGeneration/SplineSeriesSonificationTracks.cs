...
{
	public partial class SplineSeriesSonificationTracks  : BaseObject
	{
		Hashtable h = new Hashtable();

		public SplineSeriesSonificationTracks()
		{
			ActiveWhen = ActiveWhen_DefaultValue = new SplineSeriesSonificationTracksActiveWhen();
			Instrument = Instrument_DefaultValue = null;
			InstrumentString = InstrumentString_DefaultValue = "null";
			Mapping = Mapping_DefaultValue = new SplineSeriesSonificationTracksMapping();
			MidiName = MidiName_DefaultValue = "";
			PointGrouping = PointGrouping_DefaultValue = new SplineSeriesSonificationTracksPointGrouping();
			RoundToMusicalNotes = RoundToMusicalNotes_DefaultValue = true;
			ShowPlayMarker = ShowPlayMarker_DefaultValue = true;
			Type = Type_DefaultValue = SplineSeriesSonificationTracksType.Instrument;
		...
		/// </summary>
		public SplineSeriesSonificationTracksActiveWhen ActiveWhen { get; set; }
		private SplineSeriesSonificationTracksActiveWhen ActiveWhen_DefaultValue { get; set; }
		...
		/// </summary>
		public SplineSeriesSonificationTracksMapping Mapping { get; set; }
		private SplineSeriesSonificationTracksMapping Mapping_DefaultValue { get; set; }
		...
		/// </summary>
		public SplineSeriesSonificationTracksPointGrouping PointGrouping { get; set; }
		private SplineSeriesSonificationTracksPointGrouping PointGrouping_DefaultValue { get; set; }
		...
		/// </summary>
		public SplineSeriesSonificationTracksType Type { get; set; }
		private SplineSeriesSonificationTracksType Type_DefaultValue { get; set; }
