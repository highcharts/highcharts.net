...
{
	public partial class SplineSeriesStatesSelect  : BaseObject
	{
		Hashtable h = new Hashtable();

		public SplineSeriesStatesSelect()
		{
			Animation = Animation_DefaultValue = new Animation() { Enabled = true };
			AnimationBool = AnimationBool_DefaultValue = null;
			Enabled = Enabled_DefaultValue = true;
			Halo = Halo_DefaultValue = new SplineSeriesStatesSelectHalo();
			LineWidth = LineWidth_DefaultValue = null;
			LineWidthPlus = LineWidthPlus_DefaultValue = 1;
			Marker = Marker_DefaultValue = new SplineSeriesStatesSelectMarker();
		...
		/// </summary>
		public SplineSeriesStatesSelectHalo Halo { get; set; }
		private SplineSeriesStatesSelectHalo Halo_DefaultValue { get; set; }
		...
		/// </summary>
		public SplineSeriesStatesSelectMarker Marker { get; set; }
		private SplineSeriesStatesSelectMarker Marker_DefaultValue { get; set; }
