...
{
	public partial class StochasticSeries  : Series
	{
		Hashtable h = new Hashtable();

		public StochasticSeries()
		{
			Accessibility = Accessibility_DefaultValue = new StochasticSeriesAccessibility();
			AllowPointSelect = AllowPointSelect_DefaultValue = false;
			Animation = Animation_DefaultValue = new Animation() { Enabled = true };
			AnimationBool = AnimationBool_DefaultValue = true;
			AnimationLimit = AnimationLimit_DefaultValue = null;
			BoostBlending = BoostBlending_DefaultValue = StochasticSeriesBoostBlending.Undefined;
			...
			Compare = Compare_DefaultValue = StochasticSeriesCompare.Percent;
			CompareBase = CompareBase_DefaultValue = StochasticSeriesCompareBase.Min;
			...
			Cursor = Cursor_DefaultValue = StochasticSeriesCursor.Null;
			Custom = Custom_DefaultValue = new Hashtable();
			DashStyle = DashStyle_DefaultValue = StochasticSeriesDashStyle.Null;
			DataGrouping = DataGrouping_DefaultValue = new StochasticSeriesDataGrouping();
			DataLabels = DataLabels_DefaultValue = new StochasticSeriesDataLabels();
			DataSorting = DataSorting_DefaultValue = new StochasticSeriesDataSorting();
			Description = Description_DefaultValue = "";
			Dumbell = Dumbell_DefaultValue = new StochasticSeriesDumbell();
			EnableMouseTracking = EnableMouseTracking_DefaultValue = true;
			Events = Events_DefaultValue = new StochasticSeriesEvents();
			FindNearestPointBy = FindNearestPointBy_DefaultValue = StochasticSeriesFindNearestPointBy.X;
			GapSize = GapSize_DefaultValue = 0;
			GapUnit = GapUnit_DefaultValue = StochasticSeriesGapUnit.Relative;
			GetExtremesFromAll = GetExtremesFromAll_DefaultValue = false;
			Id = Id_DefaultValue = "";
			InactiveOtherPoints = InactiveOtherPoints_DefaultValue = false;
			IncludeInDataExport = IncludeInDataExport_DefaultValue = null;
			Index = Index_DefaultValue = null;
			Label = Label_DefaultValue = new StochasticSeriesLabel();
			LastPrice = LastPrice_DefaultValue = new StochasticSeriesLastPrice();
			LastVisiblePrice = LastVisiblePrice_DefaultValue = new StochasticSeriesLastVisiblePrice();
			LegendIndex = LegendIndex_DefaultValue = null;
			LegendSymbol = LegendSymbol_DefaultValue = StochasticSeriesLegendSymbol.Rectangle;
			Linecap = Linecap_DefaultValue = StochasticSeriesLinecap.Round;
			LineWidth = LineWidth_DefaultValue = 2;
			LinkedTo = LinkedTo_DefaultValue = "";
			Marker = Marker_DefaultValue = new StochasticSeriesMarker();
			Name = Name_DefaultValue = "";
			NegativeColor = NegativeColor_DefaultValue = "";
			OnPoint = OnPoint_DefaultValue = new StochasticSeriesOnPoint();
			Opacity = Opacity_DefaultValue = 1;
			Params = Params_DefaultValue = new StochasticSeriesParams();
			Point = Point_DefaultValue = new StochasticSeriesPoint();
			...
			SmoothedLine = SmoothedLine_DefaultValue = new StochasticSeriesSmoothedLine();
			SoftThreshold = SoftThreshold_DefaultValue = true;
			Sonification = Sonification_DefaultValue = new StochasticSeriesSonification();
			Stack = Stack_DefaultValue = "";
			StackNumber = StackNumber_DefaultValue = null;
			States = States_DefaultValue = new StochasticSeriesStates();
			Step = Step_DefaultValue = StochasticSeriesStep.Null;
			StickyTracking = StickyTracking_DefaultValue = true;
			Threshold = Threshold_DefaultValue = 0;
			Tooltip = Tooltip_DefaultValue = new StochasticSeriesTooltip();
			...
			Zones = Zones_DefaultValue = new List<StochasticSeriesZones>();
		...
		/// </summary>
		public StochasticSeriesAccessibility Accessibility { get; set; }
		private StochasticSeriesAccessibility Accessibility_DefaultValue { get; set; }
		...
		/// </summary>
		public StochasticSeriesBoostBlending BoostBlending { get; set; }
		private StochasticSeriesBoostBlending BoostBlending_DefaultValue { get; set; }
		...
		/// </summary>
		public StochasticSeriesCompare Compare { get; set; }
		private StochasticSeriesCompare Compare_DefaultValue { get; set; }
		 

		/// <summary>
		/// When [compare](#plotOptions.series.compare) is `percent`, this optiondictates whether to use 0 or 100 as the base of comparison.
		/// </summary>
		public StochasticSeriesCompareBase CompareBase { get; set; }
		private StochasticSeriesCompareBase CompareBase_DefaultValue { get; set; }
		...
		/// </summary>
		public StochasticSeriesCursor Cursor { get; set; }
		private StochasticSeriesCursor Cursor_DefaultValue { get; set; }
		...
		/// </summary>
		public StochasticSeriesDashStyle DashStyle { get; set; }
		private StochasticSeriesDashStyle DashStyle_DefaultValue { get; set; }
		...
		/// </summary>
		public StochasticSeriesDataGrouping DataGrouping { get; set; }
		private StochasticSeriesDataGrouping DataGrouping_DefaultValue { get; set; }
		...
		/// </summary>
		public StochasticSeriesDataLabels DataLabels { get; set; }
		private StochasticSeriesDataLabels DataLabels_DefaultValue { get; set; }
		 

		/// <summary>
		/// Options for the series data sorting.
		/// </summary>
		public StochasticSeriesDataSorting DataSorting { get; set; }
		private StochasticSeriesDataSorting DataSorting_DefaultValue { get; set; }
		...
		/// 
		/// </summary>
		public StochasticSeriesDumbell Dumbell { get; set; }
		private StochasticSeriesDumbell Dumbell_DefaultValue { get; set; }
		...
		/// </summary>
		public StochasticSeriesEvents Events { get; set; }
		private StochasticSeriesEvents Events_DefaultValue { get; set; }
		...
		/// </summary>
		public StochasticSeriesFindNearestPointBy FindNearestPointBy { get; set; }
		private StochasticSeriesFindNearestPointBy FindNearestPointBy_DefaultValue { get; set; }
		...
		/// </summary>
		public StochasticSeriesGapUnit GapUnit { get; set; }
		private StochasticSeriesGapUnit GapUnit_DefaultValue { get; set; }
		...
		/// </summary>
		public StochasticSeriesLabel Label { get; set; }
		private StochasticSeriesLabel Label_DefaultValue { get; set; }
		 

		/// <summary>
		/// The line marks the last price from all points.
		/// </summary>
		public StochasticSeriesLastPrice LastPrice { get; set; }
		private StochasticSeriesLastPrice LastPrice_DefaultValue { get; set; }
		 

		/// <summary>
		/// The line marks the last price from visible range of points.
		/// </summary>
		public StochasticSeriesLastVisiblePrice LastVisiblePrice { get; set; }
		private StochasticSeriesLastVisiblePrice LastVisiblePrice_DefaultValue { get; set; }
		...
		/// </summary>
		public StochasticSeriesLegendSymbol LegendSymbol { get; set; }
		private StochasticSeriesLegendSymbol LegendSymbol_DefaultValue { get; set; }
		 

		/// <summary>
		/// The line cap used for line ends and line joins on the graph.
		/// </summary>
		public StochasticSeriesLinecap Linecap { get; set; }
		private StochasticSeriesLinecap Linecap_DefaultValue { get; set; }
		...
		/// </summary>
		public StochasticSeriesMarker Marker { get; set; }
		private StochasticSeriesMarker Marker_DefaultValue { get; set; }
		...
		/// </summary>
		public StochasticSeriesOnPoint OnPoint { get; set; }
		private StochasticSeriesOnPoint OnPoint_DefaultValue { get; set; }
		...
		/// </summary>
		public StochasticSeriesParams Params { get; set; }
		private StochasticSeriesParams Params_DefaultValue { get; set; }
		 

		/// <summary>
		/// Properties for each single point.
		/// </summary>
		public StochasticSeriesPoint Point { get; set; }
		private StochasticSeriesPoint Point_DefaultValue { get; set; }
		...
		/// </summary>
		public StochasticSeriesSmoothedLine SmoothedLine { get; set; }
		private StochasticSeriesSmoothedLine SmoothedLine_DefaultValue { get; set; }
		...
		/// </summary>
		public StochasticSeriesSonification Sonification { get; set; }
		private StochasticSeriesSonification Sonification_DefaultValue { get; set; }
		...
		/// 
		/// </summary>
		public StochasticSeriesStates States { get; set; }
		private StochasticSeriesStates States_DefaultValue { get; set; }
		 

		/// <summary>
		/// Whether to apply steps to the line. Possible values are `left`,`center` and `right`.
		/// </summary>
		public StochasticSeriesStep Step { get; set; }
		private StochasticSeriesStep Step_DefaultValue { get; set; }
		...
		/// </summary>
		public StochasticSeriesTooltip Tooltip { get; set; }
		private StochasticSeriesTooltip Tooltip_DefaultValue { get; set; }
		...
		/// </summary>
		public List<StochasticSeriesZones> Zones { get; set; }
		private List<StochasticSeriesZones> Zones_DefaultValue { get; set; }
