...
namespace Highsoft.Web.Mvc.Stocks
{
	public partial class StochasticSeries  : Series
	{
		...
		public StochasticSeries()
		{
			...
			Zones = Zones_DefaultValue = new List<StochasticSeriesZone>();
		...
		/// </summary>
		public List<StochasticSeriesZone> Zones { get; set; }
		private List<StochasticSeriesZone> Zones_DefaultValue { get; set; }
