...
{
	public partial class StochasticSeriesLabel  : BaseObject
	{
		public StochasticSeriesLabel()
		{
			...
			Style = Style_DefaultValue = new StochasticSeriesLabelStyle();
		...
		/// </summary>
		public StochasticSeriesLabelStyle Style { get; set; }
		private StochasticSeriesLabelStyle Style_DefaultValue { get; set; }
