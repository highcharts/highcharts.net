...
{
	public partial class StochasticSeriesLastVisiblePriceLabel  : BaseObject
	{
		Hashtable h = new Hashtable();

		public StochasticSeriesLastVisiblePriceLabel()
		{
			Align = Align_DefaultValue = StochasticSeriesLastVisiblePriceLabelAlign.Null;
		...
		/// 
		/// </summary>
		public StochasticSeriesLastVisiblePriceLabelAlign Align { get; set; }
		private StochasticSeriesLastVisiblePriceLabelAlign Align_DefaultValue { get; set; }
