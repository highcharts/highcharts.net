...
namespace Highsoft.Web.Mvc.Stocks
{
	public partial class StochasticSeriesMarkerStates  : BaseObject
	{
		public StochasticSeriesMarkerStates()
		{
			...
			Inactive = Inactive_DefaultValue = new StochasticSeriesMarkerStatesInactive();
		...
		/// 
		/// </summary>
		public StochasticSeriesMarkerStatesInactive Inactive { get; set; }
		private StochasticSeriesMarkerStatesInactive Inactive_DefaultValue { get; set; }
