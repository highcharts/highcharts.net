...
{
	public partial class StochasticSeriesSonificationContextTracks  : BaseObject
	{
		Hashtable h = new Hashtable();

		public StochasticSeriesSonificationContextTracks()
		{
			ActiveWhen = ActiveWhen_DefaultValue = new StochasticSeriesSonificationContextTracksActiveWhen();
			Instrument = Instrument_DefaultValue = null;
			InstrumentString = InstrumentString_DefaultValue = "null";
			Mapping = Mapping_DefaultValue = new StochasticSeriesSonificationContextTracksMapping();
			MidiName = MidiName_DefaultValue = "";
			PointGrouping = PointGrouping_DefaultValue = new StochasticSeriesSonificationContextTracksPointGrouping();
			...
			Type = Type_DefaultValue = StochasticSeriesSonificationContextTracksType.Instrument;
			ValueInterval = ValueInterval_DefaultValue = null;
			ValueMapFunction = ValueMapFunction_DefaultValue = StochasticSeriesSonificationContextTracksValueMapFunction.Linear;
		...
		/// </summary>
		public StochasticSeriesSonificationContextTracksActiveWhen ActiveWhen { get; set; }
		private StochasticSeriesSonificationContextTracksActiveWhen ActiveWhen_DefaultValue { get; set; }
		...
		/// </summary>
		public StochasticSeriesSonificationContextTracksMapping Mapping { get; set; }
		private StochasticSeriesSonificationContextTracksMapping Mapping_DefaultValue { get; set; }
		...
		/// </summary>
		public StochasticSeriesSonificationContextTracksPointGrouping PointGrouping { get; set; }
		private StochasticSeriesSonificationContextTracksPointGrouping PointGrouping_DefaultValue { get; set; }
		...
		/// </summary>
		public StochasticSeriesSonificationContextTracksType Type { get; set; }
		private StochasticSeriesSonificationContextTracksType Type_DefaultValue { get; set; }
		...
		/// </summary>
		public StochasticSeriesSonificationContextTracksValueMapFunction ValueMapFunction { get; set; }
		private StochasticSeriesSonificationContextTracksValueMapFunction ValueMapFunction_DefaultValue { get; set; }
