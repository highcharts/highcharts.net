...
{
	public partial class StochasticSeriesSonificationContextTracksMappingFrequency  : BaseObject
	{
		Hashtable h = new Hashtable();

		public StochasticSeriesSonificationContextTracksMappingFrequency()
		{
			MapFunction = MapFunction_DefaultValue = StochasticSeriesSonificationContextTracksMappingFrequencyMapFunction.Linear;
			MapTo = MapTo_DefaultValue = "";
			Max = Max_DefaultValue = null;
			Min = Min_DefaultValue = null;
			Value = Value_DefaultValue = null;
			Within = Within_DefaultValue = StochasticSeriesSonificationContextTracksMappingFrequencyWithin.Chart;
		...
		/// </summary>
		public StochasticSeriesSonificationContextTracksMappingFrequencyMapFunction MapFunction { get; set; }
		private StochasticSeriesSonificationContextTracksMappingFrequencyMapFunction MapFunction_DefaultValue { get; set; }
		...
		/// </summary>
		public StochasticSeriesSonificationContextTracksMappingFrequencyWithin Within { get; set; }
		private StochasticSeriesSonificationContextTracksMappingFrequencyWithin Within_DefaultValue { get; set; }
