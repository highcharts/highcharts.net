...
{
	public partial class StochasticSeriesSonificationContextTracksMappingPan  : BaseObject
	{
		Hashtable h = new Hashtable();

		public StochasticSeriesSonificationContextTracksMappingPan()
		{
			MapFunction = MapFunction_DefaultValue = StochasticSeriesSonificationContextTracksMappingPanMapFunction.Linear;
			MapTo = MapTo_DefaultValue = "";
			Max = Max_DefaultValue = null;
			Min = Min_DefaultValue = null;
			Value = Value_DefaultValue = null;
			Within = Within_DefaultValue = StochasticSeriesSonificationContextTracksMappingPanWithin.Chart;
		...
		/// </summary>
		public StochasticSeriesSonificationContextTracksMappingPanMapFunction MapFunction { get; set; }
		private StochasticSeriesSonificationContextTracksMappingPanMapFunction MapFunction_DefaultValue { get; set; }
		...
		/// </summary>
		public StochasticSeriesSonificationContextTracksMappingPanWithin Within { get; set; }
		private StochasticSeriesSonificationContextTracksMappingPanWithin Within_DefaultValue { get; set; }
