...
{
	public partial class StochasticSeriesSonificationContextTracksMappingPitch  : BaseObject
	{
		Hashtable h = new Hashtable();

		public StochasticSeriesSonificationContextTracksMappingPitch()
		{
			MapFunction = MapFunction_DefaultValue = StochasticSeriesSonificationContextTracksMappingPitchMapFunction.Linear;
		...
		/// </summary>
		public StochasticSeriesSonificationContextTracksMappingPitchMapFunction MapFunction { get; set; }
		private StochasticSeriesSonificationContextTracksMappingPitchMapFunction MapFunction_DefaultValue { get; set; }
