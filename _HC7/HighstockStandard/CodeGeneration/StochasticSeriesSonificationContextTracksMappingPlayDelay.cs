...
{
	public partial class StochasticSeriesSonificationContextTracksMappingPlayDelay  : BaseObject
	{
		Hashtable h = new Hashtable();

		public StochasticSeriesSonificationContextTracksMappingPlayDelay()
		{
			MapFunction = MapFunction_DefaultValue = StochasticSeriesSonificationContextTracksMappingPlayDelayMapFunction.Linear;
			MapTo = MapTo_DefaultValue = "";
			Max = Max_DefaultValue = null;
			Min = Min_DefaultValue = null;
			Value = Value_DefaultValue = null;
			Within = Within_DefaultValue = StochasticSeriesSonificationContextTracksMappingPlayDelayWithin.Chart;
		...
		/// </summary>
		public StochasticSeriesSonificationContextTracksMappingPlayDelayMapFunction MapFunction { get; set; }
		private StochasticSeriesSonificationContextTracksMappingPlayDelayMapFunction MapFunction_DefaultValue { get; set; }
		...
		/// </summary>
		public StochasticSeriesSonificationContextTracksMappingPlayDelayWithin Within { get; set; }
		private StochasticSeriesSonificationContextTracksMappingPlayDelayWithin Within_DefaultValue { get; set; }
