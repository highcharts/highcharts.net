...
{
	public partial class StochasticSeriesSonificationContextTracksMappingTime  : BaseObject
	{
		Hashtable h = new Hashtable();

		public StochasticSeriesSonificationContextTracksMappingTime()
		{
			MapFunction = MapFunction_DefaultValue = StochasticSeriesSonificationContextTracksMappingTimeMapFunction.Linear;
			MapTo = MapTo_DefaultValue = "";
			Max = Max_DefaultValue = null;
			Min = Min_DefaultValue = null;
			Value = Value_DefaultValue = null;
			Within = Within_DefaultValue = StochasticSeriesSonificationContextTracksMappingTimeWithin.Chart;
		...
		/// </summary>
		public StochasticSeriesSonificationContextTracksMappingTimeMapFunction MapFunction { get; set; }
		private StochasticSeriesSonificationContextTracksMappingTimeMapFunction MapFunction_DefaultValue { get; set; }
		...
		/// </summary>
		public StochasticSeriesSonificationContextTracksMappingTimeWithin Within { get; set; }
		private StochasticSeriesSonificationContextTracksMappingTimeWithin Within_DefaultValue { get; set; }
