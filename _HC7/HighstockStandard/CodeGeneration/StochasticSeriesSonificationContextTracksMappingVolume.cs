...
{
	public partial class StochasticSeriesSonificationContextTracksMappingVolume  : BaseObject
	{
		Hashtable h = new Hashtable();

		public StochasticSeriesSonificationContextTracksMappingVolume()
		{
			MapFunction = MapFunction_DefaultValue = StochasticSeriesSonificationContextTracksMappingVolumeMapFunction.Linear;
			MapTo = MapTo_DefaultValue = "";
			Max = Max_DefaultValue = null;
			Min = Min_DefaultValue = null;
			Value = Value_DefaultValue = null;
			Within = Within_DefaultValue = StochasticSeriesSonificationContextTracksMappingVolumeWithin.Chart;
		...
		/// </summary>
		public StochasticSeriesSonificationContextTracksMappingVolumeMapFunction MapFunction { get; set; }
		private StochasticSeriesSonificationContextTracksMappingVolumeMapFunction MapFunction_DefaultValue { get; set; }
		...
		/// </summary>
		public StochasticSeriesSonificationContextTracksMappingVolumeWithin Within { get; set; }
		private StochasticSeriesSonificationContextTracksMappingVolumeWithin Within_DefaultValue { get; set; }
