...
{
	public partial class StochasticSeriesSonificationDefaultSpeechOptionsMapping  : BaseObject
	{
		Hashtable h = new Hashtable();

		public StochasticSeriesSonificationDefaultSpeechOptionsMapping()
		{
			Frequency = Frequency_DefaultValue = new StochasticSeriesSonificationDefaultSpeechOptionsMappingFrequency();
			GapBetweenNotes = GapBetweenNotes_DefaultValue = new StochasticSeriesSonificationDefaultSpeechOptionsMappingGapBetweenNotes();
			Highpass = Highpass_DefaultValue = new StochasticSeriesSonificationDefaultSpeechOptionsMappingHighpass();
			Lowpass = Lowpass_DefaultValue = new StochasticSeriesSonificationDefaultSpeechOptionsMappingLowpass();
			NoteDuration = NoteDuration_DefaultValue = new StochasticSeriesSonificationDefaultSpeechOptionsMappingNoteDuration();
			Pan = Pan_DefaultValue = new StochasticSeriesSonificationDefaultSpeechOptionsMappingPan();
			Pitch = Pitch_DefaultValue = new StochasticSeriesSonificationDefaultSpeechOptionsMappingPitch();
			PitchString = PitchString_DefaultValue = "null";
			PitchNumber = PitchNumber_DefaultValue = null;
			PlayDelay = PlayDelay_DefaultValue = new StochasticSeriesSonificationDefaultSpeechOptionsMappingPlayDelay();
			Time = Time_DefaultValue = new StochasticSeriesSonificationDefaultSpeechOptionsMappingTime();
			TimeString = TimeString_DefaultValue = "null";
			TimeNumber = TimeNumber_DefaultValue = null;
			Tremolo = Tremolo_DefaultValue = new StochasticSeriesSonificationDefaultSpeechOptionsMappingTremolo();
			Volume = Volume_DefaultValue = new StochasticSeriesSonificationDefaultSpeechOptionsMappingVolume();
		...
		/// </summary>
		public StochasticSeriesSonificationDefaultSpeechOptionsMappingFrequency Frequency { get; set; }
		private StochasticSeriesSonificationDefaultSpeechOptionsMappingFrequency Frequency_DefaultValue { get; set; }
		...
		/// </summary>
		public StochasticSeriesSonificationDefaultSpeechOptionsMappingGapBetweenNotes GapBetweenNotes { get; set; }
		private StochasticSeriesSonificationDefaultSpeechOptionsMappingGapBetweenNotes GapBetweenNotes_DefaultValue { get; set; }
		...
		/// </summary>
		public StochasticSeriesSonificationDefaultSpeechOptionsMappingHighpass Highpass { get; set; }
		private StochasticSeriesSonificationDefaultSpeechOptionsMappingHighpass Highpass_DefaultValue { get; set; }
		...
		/// </summary>
		public StochasticSeriesSonificationDefaultSpeechOptionsMappingLowpass Lowpass { get; set; }
		private StochasticSeriesSonificationDefaultSpeechOptionsMappingLowpass Lowpass_DefaultValue { get; set; }
		...
		/// </summary>
		public StochasticSeriesSonificationDefaultSpeechOptionsMappingNoteDuration NoteDuration { get; set; }
		private StochasticSeriesSonificationDefaultSpeechOptionsMappingNoteDuration NoteDuration_DefaultValue { get; set; }
		...
		/// </summary>
		public StochasticSeriesSonificationDefaultSpeechOptionsMappingPan Pan { get; set; }
		private StochasticSeriesSonificationDefaultSpeechOptionsMappingPan Pan_DefaultValue { get; set; }
		...
		/// </summary>
		public StochasticSeriesSonificationDefaultSpeechOptionsMappingPitch Pitch { get; set; }
		private StochasticSeriesSonificationDefaultSpeechOptionsMappingPitch Pitch_DefaultValue { get; set; }
		...
		/// </summary>
		public StochasticSeriesSonificationDefaultSpeechOptionsMappingPlayDelay PlayDelay { get; set; }
		private StochasticSeriesSonificationDefaultSpeechOptionsMappingPlayDelay PlayDelay_DefaultValue { get; set; }
		...
		/// </summary>
		public StochasticSeriesSonificationDefaultSpeechOptionsMappingTime Time { get; set; }
		private StochasticSeriesSonificationDefaultSpeechOptionsMappingTime Time_DefaultValue { get; set; }
		...
		/// </summary>
		public StochasticSeriesSonificationDefaultSpeechOptionsMappingTremolo Tremolo { get; set; }
		private StochasticSeriesSonificationDefaultSpeechOptionsMappingTremolo Tremolo_DefaultValue { get; set; }
		 

		/// <summary>
		/// The volume of notes, from 0 to 1.
		/// </summary>
		public StochasticSeriesSonificationDefaultSpeechOptionsMappingVolume Volume { get; set; }
		private StochasticSeriesSonificationDefaultSpeechOptionsMappingVolume Volume_DefaultValue { get; set; }
