...
{
	public partial class StochasticSeriesSonificationDefaultSpeechOptionsMappingPitch  : BaseObject
	{
		Hashtable h = new Hashtable();

		public StochasticSeriesSonificationDefaultSpeechOptionsMappingPitch()
		{
			MapFunction = MapFunction_DefaultValue = StochasticSeriesSonificationDefaultSpeechOptionsMappingPitchMapFunction.Linear;
		...
		/// </summary>
		public StochasticSeriesSonificationDefaultSpeechOptionsMappingPitchMapFunction MapFunction { get; set; }
		private StochasticSeriesSonificationDefaultSpeechOptionsMappingPitchMapFunction MapFunction_DefaultValue { get; set; }
