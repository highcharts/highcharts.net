...
{
	public partial class StochasticSeriesSonificationPointGrouping  : BaseObject
	{
		Hashtable h = new Hashtable();

		public StochasticSeriesSonificationPointGrouping()
		{
			Algorithm = Algorithm_DefaultValue = StochasticSeriesSonificationPointGroupingAlgorithm.Minimax;
		...
		/// </summary>
		public StochasticSeriesSonificationPointGroupingAlgorithm Algorithm { get; set; }
		private StochasticSeriesSonificationPointGroupingAlgorithm Algorithm_DefaultValue { get; set; }
