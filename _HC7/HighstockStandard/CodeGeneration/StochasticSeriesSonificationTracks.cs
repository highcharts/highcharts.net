...
{
	public partial class StochasticSeriesSonificationTracks  : BaseObject
	{
		Hashtable h = new Hashtable();

		public StochasticSeriesSonificationTracks()
		{
			ActiveWhen = ActiveWhen_DefaultValue = new StochasticSeriesSonificationTracksActiveWhen();
			Instrument = Instrument_DefaultValue = null;
			InstrumentString = InstrumentString_DefaultValue = "null";
			Mapping = Mapping_DefaultValue = new StochasticSeriesSonificationTracksMapping();
			MidiName = MidiName_DefaultValue = "";
			PointGrouping = PointGrouping_DefaultValue = new StochasticSeriesSonificationTracksPointGrouping();
			RoundToMusicalNotes = RoundToMusicalNotes_DefaultValue = true;
			ShowPlayMarker = ShowPlayMarker_DefaultValue = true;
			Type = Type_DefaultValue = StochasticSeriesSonificationTracksType.Instrument;
		...
		/// </summary>
		public StochasticSeriesSonificationTracksActiveWhen ActiveWhen { get; set; }
		private StochasticSeriesSonificationTracksActiveWhen ActiveWhen_DefaultValue { get; set; }
		...
		/// </summary>
		public StochasticSeriesSonificationTracksMapping Mapping { get; set; }
		private StochasticSeriesSonificationTracksMapping Mapping_DefaultValue { get; set; }
		...
		/// </summary>
		public StochasticSeriesSonificationTracksPointGrouping PointGrouping { get; set; }
		private StochasticSeriesSonificationTracksPointGrouping PointGrouping_DefaultValue { get; set; }
		...
		/// </summary>
		public StochasticSeriesSonificationTracksType Type { get; set; }
		private StochasticSeriesSonificationTracksType Type_DefaultValue { get; set; }
