...
{
	public partial class StochasticSeriesSonificationTracksMapping  : BaseObject
	{
		Hashtable h = new Hashtable();

		public StochasticSeriesSonificationTracksMapping()
		{
			Frequency = Frequency_DefaultValue = new StochasticSeriesSonificationTracksMappingFrequency();
			GapBetweenNotes = GapBetweenNotes_DefaultValue = new StochasticSeriesSonificationTracksMappingGapBetweenNotes();
			Highpass = Highpass_DefaultValue = new StochasticSeriesSonificationTracksMappingHighpass();
			Lowpass = Lowpass_DefaultValue = new StochasticSeriesSonificationTracksMappingLowpass();
			NoteDuration = NoteDuration_DefaultValue = new StochasticSeriesSonificationTracksMappingNoteDuration();
			Pan = Pan_DefaultValue = new StochasticSeriesSonificationTracksMappingPan();
			Pitch = Pitch_DefaultValue = new StochasticSeriesSonificationTracksMappingPitch();
			PitchString = PitchString_DefaultValue = "null";
			PitchNumber = PitchNumber_DefaultValue = null;
			PlayDelay = PlayDelay_DefaultValue = new StochasticSeriesSonificationTracksMappingPlayDelay();
			Time = Time_DefaultValue = new StochasticSeriesSonificationTracksMappingTime();
			TimeString = TimeString_DefaultValue = "null";
			TimeNumber = TimeNumber_DefaultValue = null;
			Tremolo = Tremolo_DefaultValue = new StochasticSeriesSonificationTracksMappingTremolo();
			Volume = Volume_DefaultValue = new StochasticSeriesSonificationTracksMappingVolume();
		...
		/// </summary>
		public StochasticSeriesSonificationTracksMappingFrequency Frequency { get; set; }
		private StochasticSeriesSonificationTracksMappingFrequency Frequency_DefaultValue { get; set; }
		...
		/// </summary>
		public StochasticSeriesSonificationTracksMappingGapBetweenNotes GapBetweenNotes { get; set; }
		private StochasticSeriesSonificationTracksMappingGapBetweenNotes GapBetweenNotes_DefaultValue { get; set; }
		...
		/// </summary>
		public StochasticSeriesSonificationTracksMappingHighpass Highpass { get; set; }
		private StochasticSeriesSonificationTracksMappingHighpass Highpass_DefaultValue { get; set; }
		...
		/// </summary>
		public StochasticSeriesSonificationTracksMappingLowpass Lowpass { get; set; }
		private StochasticSeriesSonificationTracksMappingLowpass Lowpass_DefaultValue { get; set; }
		...
		/// </summary>
		public StochasticSeriesSonificationTracksMappingNoteDuration NoteDuration { get; set; }
		private StochasticSeriesSonificationTracksMappingNoteDuration NoteDuration_DefaultValue { get; set; }
		...
		/// </summary>
		public StochasticSeriesSonificationTracksMappingPan Pan { get; set; }
		private StochasticSeriesSonificationTracksMappingPan Pan_DefaultValue { get; set; }
		...
		/// </summary>
		public StochasticSeriesSonificationTracksMappingPitch Pitch { get; set; }
		private StochasticSeriesSonificationTracksMappingPitch Pitch_DefaultValue { get; set; }
		...
		/// </summary>
		public StochasticSeriesSonificationTracksMappingPlayDelay PlayDelay { get; set; }
		private StochasticSeriesSonificationTracksMappingPlayDelay PlayDelay_DefaultValue { get; set; }
		...
		/// </summary>
		public StochasticSeriesSonificationTracksMappingTime Time { get; set; }
		private StochasticSeriesSonificationTracksMappingTime Time_DefaultValue { get; set; }
		...
		/// </summary>
		public StochasticSeriesSonificationTracksMappingTremolo Tremolo { get; set; }
		private StochasticSeriesSonificationTracksMappingTremolo Tremolo_DefaultValue { get; set; }
		 

		/// <summary>
		/// The volume of notes, from 0 to 1.
		/// </summary>
		public StochasticSeriesSonificationTracksMappingVolume Volume { get; set; }
		private StochasticSeriesSonificationTracksMappingVolume Volume_DefaultValue { get; set; }
