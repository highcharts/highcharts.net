...
{
	public partial class StochasticSeriesSonificationTracksMappingFrequency  : BaseObject
	{
		Hashtable h = new Hashtable();

		public StochasticSeriesSonificationTracksMappingFrequency()
		{
			MapFunction = MapFunction_DefaultValue = StochasticSeriesSonificationTracksMappingFrequencyMapFunction.Linear;
			MapTo = MapTo_DefaultValue = "";
			Max = Max_DefaultValue = null;
			Min = Min_DefaultValue = null;
			Value = Value_DefaultValue = null;
			Within = Within_DefaultValue = StochasticSeriesSonificationTracksMappingFrequencyWithin.Chart;
		...
		/// </summary>
		public StochasticSeriesSonificationTracksMappingFrequencyMapFunction MapFunction { get; set; }
		private StochasticSeriesSonificationTracksMappingFrequencyMapFunction MapFunction_DefaultValue { get; set; }
		...
		/// </summary>
		public StochasticSeriesSonificationTracksMappingFrequencyWithin Within { get; set; }
		private StochasticSeriesSonificationTracksMappingFrequencyWithin Within_DefaultValue { get; set; }
