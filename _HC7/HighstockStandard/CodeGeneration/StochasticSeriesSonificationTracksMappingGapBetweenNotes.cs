...
namespace Highsoft.Web.Mvc.Stocks
{
	public partial class StochasticSeriesSonificationTracksMappingGapBetweenNotes  : BaseObject
	{
		...
		{
			if (MapFunction != StochasticSeriesSonificationTracksMappingGapBetweenNotesMapFunction.Null) h.Add("mapFunction", highstock.FirstCharacterToLower(MapFunction.ToString()));
			if (MapTo != null) h.Add("mapTo",MapTo);
			if (Max != null) h.Add("max",Max);
			if (Min != null) h.Add("min",Min);
			if (Value != null) h.Add("value",Value);
			if (Within != StochasticSeriesSonificationTracksMappingGapBetweenNotesWithin.Null) h.Add("within", highstock.FirstCharacterToLower(Within.ToString()));
