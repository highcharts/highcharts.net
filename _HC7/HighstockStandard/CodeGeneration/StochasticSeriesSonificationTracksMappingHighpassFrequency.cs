...
{
	public partial class StochasticSeriesSonificationTracksMappingHighpassFrequency  : BaseObject
	{
		Hashtable h = new Hashtable();

		public StochasticSeriesSonificationTracksMappingHighpassFrequency()
		{
			MapFunction = MapFunction_DefaultValue = StochasticSeriesSonificationTracksMappingHighpassFrequencyMapFunction.Linear;
			MapTo = MapTo_DefaultValue = "";
			Max = Max_DefaultValue = null;
			Min = Min_DefaultValue = null;
			Value = Value_DefaultValue = null;
			Within = Within_DefaultValue = StochasticSeriesSonificationTracksMappingHighpassFrequencyWithin.Chart;
		...
		/// </summary>
		public StochasticSeriesSonificationTracksMappingHighpassFrequencyMapFunction MapFunction { get; set; }
		private StochasticSeriesSonificationTracksMappingHighpassFrequencyMapFunction MapFunction_DefaultValue { get; set; }
		...
		/// </summary>
		public StochasticSeriesSonificationTracksMappingHighpassFrequencyWithin Within { get; set; }
		private StochasticSeriesSonificationTracksMappingHighpassFrequencyWithin Within_DefaultValue { get; set; }
