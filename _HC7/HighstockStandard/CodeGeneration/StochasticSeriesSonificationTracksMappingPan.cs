...
{
	public partial class StochasticSeriesSonificationTracksMappingPan  : BaseObject
	{
		Hashtable h = new Hashtable();

		public StochasticSeriesSonificationTracksMappingPan()
		{
			MapFunction = MapFunction_DefaultValue = StochasticSeriesSonificationTracksMappingPanMapFunction.Linear;
			MapTo = MapTo_DefaultValue = "";
			Max = Max_DefaultValue = null;
			Min = Min_DefaultValue = null;
			Value = Value_DefaultValue = null;
			Within = Within_DefaultValue = StochasticSeriesSonificationTracksMappingPanWithin.Chart;
		...
		/// </summary>
		public StochasticSeriesSonificationTracksMappingPanMapFunction MapFunction { get; set; }
		private StochasticSeriesSonificationTracksMappingPanMapFunction MapFunction_DefaultValue { get; set; }
		...
		/// </summary>
		public StochasticSeriesSonificationTracksMappingPanWithin Within { get; set; }
		private StochasticSeriesSonificationTracksMappingPanWithin Within_DefaultValue { get; set; }
