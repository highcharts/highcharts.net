...
{
	public partial class StochasticSeriesSonificationTracksMappingPitch  : BaseObject
	{
		Hashtable h = new Hashtable();

		public StochasticSeriesSonificationTracksMappingPitch()
		{
			MapFunction = MapFunction_DefaultValue = StochasticSeriesSonificationTracksMappingPitchMapFunction.Linear;
		...
		/// </summary>
		public StochasticSeriesSonificationTracksMappingPitchMapFunction MapFunction { get; set; }
		private StochasticSeriesSonificationTracksMappingPitchMapFunction MapFunction_DefaultValue { get; set; }
