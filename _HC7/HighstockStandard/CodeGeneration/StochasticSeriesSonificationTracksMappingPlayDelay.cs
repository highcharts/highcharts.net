...
{
	public partial class StochasticSeriesSonificationTracksMappingPlayDelay  : BaseObject
	{
		Hashtable h = new Hashtable();

		public StochasticSeriesSonificationTracksMappingPlayDelay()
		{
			MapFunction = MapFunction_DefaultValue = StochasticSeriesSonificationTracksMappingPlayDelayMapFunction.Linear;
			MapTo = MapTo_DefaultValue = "";
			Max = Max_DefaultValue = null;
			Min = Min_DefaultValue = null;
			Value = Value_DefaultValue = null;
			Within = Within_DefaultValue = StochasticSeriesSonificationTracksMappingPlayDelayWithin.Chart;
		...
		/// </summary>
		public StochasticSeriesSonificationTracksMappingPlayDelayMapFunction MapFunction { get; set; }
		private StochasticSeriesSonificationTracksMappingPlayDelayMapFunction MapFunction_DefaultValue { get; set; }
		...
		/// </summary>
		public StochasticSeriesSonificationTracksMappingPlayDelayWithin Within { get; set; }
		private StochasticSeriesSonificationTracksMappingPlayDelayWithin Within_DefaultValue { get; set; }
