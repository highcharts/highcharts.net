...
{
	public partial class StochasticSeriesSonificationTracksMappingTime  : BaseObject
	{
		Hashtable h = new Hashtable();

		public StochasticSeriesSonificationTracksMappingTime()
		{
			MapFunction = MapFunction_DefaultValue = StochasticSeriesSonificationTracksMappingTimeMapFunction.Linear;
			MapTo = MapTo_DefaultValue = "";
			Max = Max_DefaultValue = null;
			Min = Min_DefaultValue = null;
			Value = Value_DefaultValue = null;
			Within = Within_DefaultValue = StochasticSeriesSonificationTracksMappingTimeWithin.Chart;
		...
		/// </summary>
		public StochasticSeriesSonificationTracksMappingTimeMapFunction MapFunction { get; set; }
		private StochasticSeriesSonificationTracksMappingTimeMapFunction MapFunction_DefaultValue { get; set; }
		...
		/// </summary>
		public StochasticSeriesSonificationTracksMappingTimeWithin Within { get; set; }
		private StochasticSeriesSonificationTracksMappingTimeWithin Within_DefaultValue { get; set; }
