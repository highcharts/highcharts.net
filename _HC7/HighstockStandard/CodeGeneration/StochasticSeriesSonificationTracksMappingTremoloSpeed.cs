...
{
	public partial class StochasticSeriesSonificationTracksMappingTremoloSpeed  : BaseObject
	{
		Hashtable h = new Hashtable();

		public StochasticSeriesSonificationTracksMappingTremoloSpeed()
		{
			MapFunction = MapFunction_DefaultValue = StochasticSeriesSonificationTracksMappingTremoloSpeedMapFunction.Linear;
			MapTo = MapTo_DefaultValue = "";
			Max = Max_DefaultValue = null;
			Min = Min_DefaultValue = null;
			Value = Value_DefaultValue = null;
			Within = Within_DefaultValue = StochasticSeriesSonificationTracksMappingTremoloSpeedWithin.Chart;
		...
		/// </summary>
		public StochasticSeriesSonificationTracksMappingTremoloSpeedMapFunction MapFunction { get; set; }
		private StochasticSeriesSonificationTracksMappingTremoloSpeedMapFunction MapFunction_DefaultValue { get; set; }
		...
		/// </summary>
		public StochasticSeriesSonificationTracksMappingTremoloSpeedWithin Within { get; set; }
		private StochasticSeriesSonificationTracksMappingTremoloSpeedWithin Within_DefaultValue { get; set; }
