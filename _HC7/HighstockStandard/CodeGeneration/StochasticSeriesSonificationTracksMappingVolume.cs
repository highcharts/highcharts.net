...
{
	public partial class StochasticSeriesSonificationTracksMappingVolume  : BaseObject
	{
		Hashtable h = new Hashtable();

		public StochasticSeriesSonificationTracksMappingVolume()
		{
			MapFunction = MapFunction_DefaultValue = StochasticSeriesSonificationTracksMappingVolumeMapFunction.Linear;
			MapTo = MapTo_DefaultValue = "";
			Max = Max_DefaultValue = null;
			Min = Min_DefaultValue = null;
			Value = Value_DefaultValue = null;
			Within = Within_DefaultValue = StochasticSeriesSonificationTracksMappingVolumeWithin.Chart;
		...
		/// </summary>
		public StochasticSeriesSonificationTracksMappingVolumeMapFunction MapFunction { get; set; }
		private StochasticSeriesSonificationTracksMappingVolumeMapFunction MapFunction_DefaultValue { get; set; }
		...
		/// </summary>
		public StochasticSeriesSonificationTracksMappingVolumeWithin Within { get; set; }
		private StochasticSeriesSonificationTracksMappingVolumeWithin Within_DefaultValue { get; set; }
