...
namespace Highsoft.Web.Mvc.Stocks
{
	public partial class StochasticSeriesTooltip  : BaseObject
	{
		public StochasticSeriesTooltip()
		{
			...
			HeaderShape = HeaderShape_DefaultValue = StochasticSeriesTooltipHeaderShape.Callout;
		...
		/// </summary>
		public StochasticSeriesTooltipHeaderShape HeaderShape { get; set; }
		private StochasticSeriesTooltipHeaderShape HeaderShape_DefaultValue { get; set; }
		...
		internal override Hashtable ToHashtable()
		{
			...
			if (NullFormatter != NullFormatter_DefaultValue) { h.Add("nullFormatter",NullFormatter); Highstock.AddFunction("StochasticSeriesTooltipNullFormatter.nullFormatter", NullFormatter); }  
