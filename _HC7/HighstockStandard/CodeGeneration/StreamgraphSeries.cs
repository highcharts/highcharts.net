...
{
	public partial class StreamgraphSeries  : Series
	{
		Hashtable h = new Hashtable();

		public StreamgraphSeries()
		{
			Accessibility = Accessibility_DefaultValue = new StreamgraphSeriesAccessibility();
			...
			Compare = Compare_DefaultValue = StreamgraphSeriesCompare.Percent;
			...
			Cursor = Cursor_DefaultValue = StreamgraphSeriesCursor.Null;
			Custom = Custom_DefaultValue = new Hashtable();
			DashStyle = DashStyle_DefaultValue = StreamgraphSeriesDashStyle.Null;
			Data = Data_DefaultValue = new List<StreamgraphSeriesData>();
			DataGrouping = DataGrouping_DefaultValue = new StreamgraphSeriesDataGrouping();
			DataLabels = DataLabels_DefaultValue = new StreamgraphSeriesDataLabels();
			DataSorting = DataSorting_DefaultValue = new StreamgraphSeriesDataSorting();
			Description = Description_DefaultValue = "";
			DragDrop = DragDrop_DefaultValue = new StreamgraphSeriesDragDrop();
			Dumbell = Dumbell_DefaultValue = new StreamgraphSeriesDumbell();
			EnableMouseTracking = EnableMouseTracking_DefaultValue = true;
			Events = Events_DefaultValue = new StreamgraphSeriesEvents();
			FillColor = FillColor_DefaultValue = "";
			FillOpacity = FillOpacity_DefaultValue = 1;
			FindNearestPointBy = FindNearestPointBy_DefaultValue = StreamgraphSeriesFindNearestPointBy.X;
			...
			Label = Label_DefaultValue = new StreamgraphSeriesLabel();
			LastPrice = LastPrice_DefaultValue = new StreamgraphSeriesLastPrice();
			LastVisiblePrice = LastVisiblePrice_DefaultValue = new StreamgraphSeriesLastVisiblePrice();
			...
			OnPoint = OnPoint_DefaultValue = new StreamgraphSeriesOnPoint();
			Opacity = Opacity_DefaultValue = 1;
			Point = Point_DefaultValue = new StreamgraphSeriesPoint();
			PointDescriptionFormat = PointDescriptionFormat_DefaultValue = "";
			PointDescriptionFormatter = PointDescriptionFormatter_DefaultValue = "";
			PointInterval = PointInterval_DefaultValue = 1;
			PointIntervalUnit = PointIntervalUnit_DefaultValue = StreamgraphSeriesPointIntervalUnit.Null;
			...
			Sonification = Sonification_DefaultValue = new StreamgraphSeriesSonification();
			Stack = Stack_DefaultValue = "";
			StackNumber = StackNumber_DefaultValue = null;
			Stacking = Stacking_DefaultValue = StreamgraphSeriesStacking.Null;
			States = States_DefaultValue = new StreamgraphSeriesStates();
			StickyTracking = StickyTracking_DefaultValue = true;
			Threshold = Threshold_DefaultValue = 0;
			Tooltip = Tooltip_DefaultValue = new StreamgraphSeriesTooltip();
			...
			Zones = Zones_DefaultValue = new List<StreamgraphSeriesZones>();
		...
		/// </summary>
		public StreamgraphSeriesAccessibility Accessibility { get; set; }
		private StreamgraphSeriesAccessibility Accessibility_DefaultValue { get; set; }
		...
		/// </summary>
		public StreamgraphSeriesCompare Compare { get; set; }
		private StreamgraphSeriesCompare Compare_DefaultValue { get; set; }
		 

		/// <summary>
		/// When [compare](#plotOptions.series.compare) is `percent`, this optiondictates whether to use 0 or 100 as the base of comparison.
		/// </summary>
		public StreamgraphSeriesCompareBase CompareBase { get; set; }
		private StreamgraphSeriesCompareBase CompareBase_DefaultValue { get; set; }
		...
		/// </summary>
		public StreamgraphSeriesCursor Cursor { get; set; }
		private StreamgraphSeriesCursor Cursor_DefaultValue { get; set; }
		...
		/// </summary>
		public StreamgraphSeriesDataGrouping DataGrouping { get; set; }
		private StreamgraphSeriesDataGrouping DataGrouping_DefaultValue { get; set; }
		...
		/// </summary>
		public StreamgraphSeriesDataSorting DataSorting { get; set; }
		private StreamgraphSeriesDataSorting DataSorting_DefaultValue { get; set; }
		...
		/// </summary>
		public StreamgraphSeriesDragDrop DragDrop { get; set; }
		private StreamgraphSeriesDragDrop DragDrop_DefaultValue { get; set; }
		 

		/// <summary>
		/// 
		/// </summary>
		public StreamgraphSeriesDumbell Dumbell { get; set; }
		private StreamgraphSeriesDumbell Dumbell_DefaultValue { get; set; }
		...
		/// </summary>
		public StreamgraphSeriesEvents Events { get; set; }
		private StreamgraphSeriesEvents Events_DefaultValue { get; set; }
		...
		/// </summary>
		public StreamgraphSeriesFindNearestPointBy FindNearestPointBy { get; set; }
		private StreamgraphSeriesFindNearestPointBy FindNearestPointBy_DefaultValue { get; set; }
		...
		/// </summary>
		public StreamgraphSeriesGapUnit GapUnit { get; set; }
		private StreamgraphSeriesGapUnit GapUnit_DefaultValue { get; set; }
		...
		/// </summary>
		public StreamgraphSeriesLabel Label { get; set; }
		private StreamgraphSeriesLabel Label_DefaultValue { get; set; }
		 

		/// <summary>
		/// The line marks the last price from all points.
		/// </summary>
		public StreamgraphSeriesLastPrice LastPrice { get; set; }
		private StreamgraphSeriesLastPrice LastPrice_DefaultValue { get; set; }
		 

		/// <summary>
		/// The line marks the last price from visible range of points.
		/// </summary>
		public StreamgraphSeriesLastVisiblePrice LastVisiblePrice { get; set; }
		private StreamgraphSeriesLastVisiblePrice LastVisiblePrice_DefaultValue { get; set; }
		...
		/// </summary>
		public StreamgraphSeriesLegendSymbol LegendSymbol { get; set; }
		private StreamgraphSeriesLegendSymbol LegendSymbol_DefaultValue { get; set; }
		 

		/// <summary>
		/// The line cap used for line ends and line joins on the graph.
		/// </summary>
		public StreamgraphSeriesLinecap Linecap { get; set; }
		private StreamgraphSeriesLinecap Linecap_DefaultValue { get; set; }
		...
		/// </summary>
		public StreamgraphSeriesMarker Marker { get; set; }
		private StreamgraphSeriesMarker Marker_DefaultValue { get; set; }
		...
		/// </summary>
		public StreamgraphSeriesOnPoint OnPoint { get; set; }
		private StreamgraphSeriesOnPoint OnPoint_DefaultValue { get; set; }
		...
		/// </summary>
		public StreamgraphSeriesPoint Point { get; set; }
		private StreamgraphSeriesPoint Point_DefaultValue { get; set; }
		...
		/// </summary>
		public StreamgraphSeriesPointIntervalUnit PointIntervalUnit { get; set; }
		private StreamgraphSeriesPointIntervalUnit PointIntervalUnit_DefaultValue { get; set; }
		...
		/// </summary>
		public StreamgraphSeriesSonification Sonification { get; set; }
		private StreamgraphSeriesSonification Sonification_DefaultValue { get; set; }
		...
		/// </summary>
		public StreamgraphSeriesStacking Stacking { get; set; }
		private StreamgraphSeriesStacking Stacking_DefaultValue { get; set; }
		 

		/// <summary>
		/// 
		/// </summary>
		public StreamgraphSeriesStates States { get; set; }
		private StreamgraphSeriesStates States_DefaultValue { get; set; }
		...
		/// </summary>
		public StreamgraphSeriesTooltip Tooltip { get; set; }
		private StreamgraphSeriesTooltip Tooltip_DefaultValue { get; set; }
		...
		/// </summary>
		public List<StreamgraphSeriesZones> Zones { get; set; }
		private List<StreamgraphSeriesZones> Zones_DefaultValue { get; set; }
