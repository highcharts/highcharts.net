...
{
	public partial class StreamgraphSeriesSonificationContextTracks  : BaseObject
	{
		Hashtable h = new Hashtable();

		public StreamgraphSeriesSonificationContextTracks()
		{
			ActiveWhen = ActiveWhen_DefaultValue = new StreamgraphSeriesSonificationContextTracksActiveWhen();
			Instrument = Instrument_DefaultValue = null;
			InstrumentString = InstrumentString_DefaultValue = "null";
			Mapping = Mapping_DefaultValue = new StreamgraphSeriesSonificationContextTracksMapping();
			MidiName = MidiName_DefaultValue = "";
			PointGrouping = PointGrouping_DefaultValue = new StreamgraphSeriesSonificationContextTracksPointGrouping();
			...
			Type = Type_DefaultValue = StreamgraphSeriesSonificationContextTracksType.Instrument;
			ValueInterval = ValueInterval_DefaultValue = null;
			ValueMapFunction = ValueMapFunction_DefaultValue = StreamgraphSeriesSonificationContextTracksValueMapFunction.Linear;
		...
		/// </summary>
		public StreamgraphSeriesSonificationContextTracksActiveWhen ActiveWhen { get; set; }
		private StreamgraphSeriesSonificationContextTracksActiveWhen ActiveWhen_DefaultValue { get; set; }
		...
		/// </summary>
		public StreamgraphSeriesSonificationContextTracksMapping Mapping { get; set; }
		private StreamgraphSeriesSonificationContextTracksMapping Mapping_DefaultValue { get; set; }
		...
		/// </summary>
		public StreamgraphSeriesSonificationContextTracksPointGrouping PointGrouping { get; set; }
		private StreamgraphSeriesSonificationContextTracksPointGrouping PointGrouping_DefaultValue { get; set; }
		...
		/// </summary>
		public StreamgraphSeriesSonificationContextTracksType Type { get; set; }
		private StreamgraphSeriesSonificationContextTracksType Type_DefaultValue { get; set; }
		...
		/// </summary>
		public StreamgraphSeriesSonificationContextTracksValueMapFunction ValueMapFunction { get; set; }
		private StreamgraphSeriesSonificationContextTracksValueMapFunction ValueMapFunction_DefaultValue { get; set; }
