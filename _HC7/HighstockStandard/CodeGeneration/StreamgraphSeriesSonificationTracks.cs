...
{
	public partial class StreamgraphSeriesSonificationTracks  : BaseObject
	{
		Hashtable h = new Hashtable();

		public StreamgraphSeriesSonificationTracks()
		{
			ActiveWhen = ActiveWhen_DefaultValue = new StreamgraphSeriesSonificationTracksActiveWhen();
			Instrument = Instrument_DefaultValue = null;
			InstrumentString = InstrumentString_DefaultValue = "null";
			Mapping = Mapping_DefaultValue = new StreamgraphSeriesSonificationTracksMapping();
			MidiName = MidiName_DefaultValue = "";
			PointGrouping = PointGrouping_DefaultValue = new StreamgraphSeriesSonificationTracksPointGrouping();
			RoundToMusicalNotes = RoundToMusicalNotes_DefaultValue = true;
			ShowPlayMarker = ShowPlayMarker_DefaultValue = true;
			Type = Type_DefaultValue = StreamgraphSeriesSonificationTracksType.Instrument;
		...
		/// </summary>
		public StreamgraphSeriesSonificationTracksActiveWhen ActiveWhen { get; set; }
		private StreamgraphSeriesSonificationTracksActiveWhen ActiveWhen_DefaultValue { get; set; }
		...
		/// </summary>
		public StreamgraphSeriesSonificationTracksMapping Mapping { get; set; }
		private StreamgraphSeriesSonificationTracksMapping Mapping_DefaultValue { get; set; }
		...
		/// </summary>
		public StreamgraphSeriesSonificationTracksPointGrouping PointGrouping { get; set; }
		private StreamgraphSeriesSonificationTracksPointGrouping PointGrouping_DefaultValue { get; set; }
		...
		/// </summary>
		public StreamgraphSeriesSonificationTracksType Type { get; set; }
		private StreamgraphSeriesSonificationTracksType Type_DefaultValue { get; set; }
