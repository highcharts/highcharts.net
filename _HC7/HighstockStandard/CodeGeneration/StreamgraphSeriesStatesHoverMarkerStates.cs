...
namespace Highsoft.Web.Mvc.Stocks
{
	public partial class StreamgraphSeriesStatesHoverMarkerStates  : BaseObject
	{
		public StreamgraphSeriesStatesHoverMarkerStates()
		{
			...
			Inactive = Inactive_DefaultValue = new StreamgraphSeriesStatesHoverMarkerStatesInactive();
		...
		/// 
		/// </summary>
		public StreamgraphSeriesStatesHoverMarkerStatesInactive Inactive { get; set; }
		private StreamgraphSeriesStatesHoverMarkerStatesInactive Inactive_DefaultValue { get; set; }
