...
{
	public partial class StreamgraphSeriesStatesSelect  : BaseObject
	{
		public StreamgraphSeriesStatesSelect()
		{
			Animation = Animation_DefaultValue = new Animation() { Enabled = true };
			Enabled = Enabled_DefaultValue = true;
			Halo = Halo_DefaultValue = new StreamgraphSeriesStatesSelectHalo();
			LineWidth = LineWidth_DefaultValue = null;
			LineWidthPlus = LineWidthPlus_DefaultValue = 1;
			Marker = Marker_DefaultValue = new StreamgraphSeriesStatesSelectMarker();
		...
		/// </summary>
		public StreamgraphSeriesStatesSelectHalo Halo { get; set; }
		private StreamgraphSeriesStatesSelectHalo Halo_DefaultValue { get; set; }
		...
		/// </summary>
		public StreamgraphSeriesStatesSelectMarker Marker { get; set; }
		private StreamgraphSeriesStatesSelectMarker Marker_DefaultValue { get; set; }
