...
namespace Highsoft.Web.Mvc.Stocks
{
	public partial class Subtitle  : BaseObject
	{
		...
		{
			if (Align != SubtitleAlign.Null) h.Add("align", highstock.FirstCharacterToLower(Align.ToString()));
			if (Floating != null) h.Add("floating",Floating);
			if (Style != null) h.Add("style",Style);
			if (Text != null) h.Add("text",Text);
			if (UseHTML != null) h.Add("useHTML",UseHTML);
			if (VerticalAlign != SubtitleVerticalAlign.Null) h.Add("verticalAlign", highstock.FirstCharacterToLower(VerticalAlign.ToString()));
