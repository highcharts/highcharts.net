...
{
	public partial class SupertrendSeries  : Series
	{
		Hashtable h = new Hashtable();

		public SupertrendSeries()
		{
			...
			Compare = Compare_DefaultValue = SupertrendSeriesCompare.Percent;
			...
			DashStyle = DashStyle_DefaultValue = SupertrendSeriesDashStyle.Null;
			DataGrouping = DataGrouping_DefaultValue = new SupertrendSeriesDataGrouping();
			...
			Dumbell = Dumbell_DefaultValue = new SupertrendSeriesDumbell();
			EnableMouseTracking = EnableMouseTracking_DefaultValue = true;
			Events = Events_DefaultValue = new SupertrendSeriesEvents();
			FallingTrendColor = FallingTrendColor_DefaultValue = "#f21313";
			FindNearestPointBy = FindNearestPointBy_DefaultValue = SupertrendSeriesFindNearestPointBy.X;
			GapSize = GapSize_DefaultValue = 0;
			GapUnit = GapUnit_DefaultValue = SupertrendSeriesGapUnit.Relative;
			GetExtremesFromAll = GetExtremesFromAll_DefaultValue = false;
			Id = Id_DefaultValue = "";
			InactiveOtherPoints = InactiveOtherPoints_DefaultValue = false;
			IncludeInDataExport = IncludeInDataExport_DefaultValue = null;
			Index = Index_DefaultValue = null;
			Label = Label_DefaultValue = new SupertrendSeriesLabel();
			LastPrice = LastPrice_DefaultValue = new SupertrendSeriesLastPrice();
			LastVisiblePrice = LastVisiblePrice_DefaultValue = new SupertrendSeriesLastVisiblePrice();
			LegendIndex = LegendIndex_DefaultValue = null;
			LegendSymbol = LegendSymbol_DefaultValue = SupertrendSeriesLegendSymbol.Rectangle;
			Linecap = Linecap_DefaultValue = SupertrendSeriesLinecap.Round;
			LineWidth = LineWidth_DefaultValue = 2;
			LinkedTo = LinkedTo_DefaultValue = "";
			Marker = Marker_DefaultValue = new SupertrendSeriesMarker();
			Name = Name_DefaultValue = "";
			OnPoint = OnPoint_DefaultValue = new SupertrendSeriesOnPoint();
			Opacity = Opacity_DefaultValue = 1;
			Params = Params_DefaultValue = new SupertrendSeriesParams();
			Point = Point_DefaultValue = new SupertrendSeriesPoint();
			...
			Sonification = Sonification_DefaultValue = new SupertrendSeriesSonification();
			Stack = Stack_DefaultValue = "";
			StackNumber = StackNumber_DefaultValue = null;
			States = States_DefaultValue = new SupertrendSeriesStates();
			Step = Step_DefaultValue = SupertrendSeriesStep.Null;
			StickyTracking = StickyTracking_DefaultValue = true;
			Tooltip = Tooltip_DefaultValue = new SupertrendSeriesTooltip();
			...
			Zones = Zones_DefaultValue = new List<SupertrendSeriesZones>();
		...
		/// </summary>
		public SupertrendSeriesAccessibility Accessibility { get; set; }
		private SupertrendSeriesAccessibility Accessibility_DefaultValue { get; set; }
		...
		/// </summary>
		public SupertrendSeriesBoostBlending BoostBlending { get; set; }
		private SupertrendSeriesBoostBlending BoostBlending_DefaultValue { get; set; }
		...
		/// </summary>
		public SupertrendSeriesChangeTrendLine ChangeTrendLine { get; set; }
		private SupertrendSeriesChangeTrendLine ChangeTrendLine_DefaultValue { get; set; }
		...
		/// </summary>
		public SupertrendSeriesCursor Cursor { get; set; }
		private SupertrendSeriesCursor Cursor_DefaultValue { get; set; }
		...
		/// </summary>
		public SupertrendSeriesDashStyle DashStyle { get; set; }
		private SupertrendSeriesDashStyle DashStyle_DefaultValue { get; set; }
		...
		/// </summary>
		public SupertrendSeriesDataGrouping DataGrouping { get; set; }
		private SupertrendSeriesDataGrouping DataGrouping_DefaultValue { get; set; }
		...
		/// </summary>
		public SupertrendSeriesDataLabels DataLabels { get; set; }
		private SupertrendSeriesDataLabels DataLabels_DefaultValue { get; set; }
		 

		/// <summary>
		/// Options for the series data sorting.
		/// </summary>
		public SupertrendSeriesDataSorting DataSorting { get; set; }
		private SupertrendSeriesDataSorting DataSorting_DefaultValue { get; set; }
		...
		/// 
		/// </summary>
		public SupertrendSeriesDumbell Dumbell { get; set; }
		private SupertrendSeriesDumbell Dumbell_DefaultValue { get; set; }
		...
		/// </summary>
		public SupertrendSeriesEvents Events { get; set; }
		private SupertrendSeriesEvents Events_DefaultValue { get; set; }
		...
		/// </summary>
		public SupertrendSeriesFindNearestPointBy FindNearestPointBy { get; set; }
		private SupertrendSeriesFindNearestPointBy FindNearestPointBy_DefaultValue { get; set; }
		...
		/// </summary>
		public SupertrendSeriesGapUnit GapUnit { get; set; }
		private SupertrendSeriesGapUnit GapUnit_DefaultValue { get; set; }
		...
		/// </summary>
		public SupertrendSeriesLabel Label { get; set; }
		private SupertrendSeriesLabel Label_DefaultValue { get; set; }
		 

		/// <summary>
		/// The line marks the last price from all points.
		/// </summary>
		public SupertrendSeriesLastPrice LastPrice { get; set; }
		private SupertrendSeriesLastPrice LastPrice_DefaultValue { get; set; }
		 

		/// <summary>
		/// The line marks the last price from visible range of points.
		/// </summary>
		public SupertrendSeriesLastVisiblePrice LastVisiblePrice { get; set; }
		private SupertrendSeriesLastVisiblePrice LastVisiblePrice_DefaultValue { get; set; }
		...
		/// </summary>
		public SupertrendSeriesLegendSymbol LegendSymbol { get; set; }
		private SupertrendSeriesLegendSymbol LegendSymbol_DefaultValue { get; set; }
		 

		/// <summary>
		/// The line cap used for line ends and line joins on the graph.
		/// </summary>
		public SupertrendSeriesLinecap Linecap { get; set; }
		private SupertrendSeriesLinecap Linecap_DefaultValue { get; set; }
		...
		/// </summary>
		public SupertrendSeriesMarker Marker { get; set; }
		private SupertrendSeriesMarker Marker_DefaultValue { get; set; }
		...
		/// </summary>
		public SupertrendSeriesParams Params { get; set; }
		private SupertrendSeriesParams Params_DefaultValue { get; set; }
		 

		/// <summary>
		/// Properties for each single point.
		/// </summary>
		public SupertrendSeriesPoint Point { get; set; }
		private SupertrendSeriesPoint Point_DefaultValue { get; set; }
		...
		/// </summary>
		public SupertrendSeriesSonification Sonification { get; set; }
		private SupertrendSeriesSonification Sonification_DefaultValue { get; set; }
		...
		/// 
		/// </summary>
		public SupertrendSeriesStates States { get; set; }
		private SupertrendSeriesStates States_DefaultValue { get; set; }
		 

		/// <summary>
		/// Whether to apply steps to the line. Possible values are `left`,`center` and `right`.
		/// </summary>
		public SupertrendSeriesStep Step { get; set; }
		private SupertrendSeriesStep Step_DefaultValue { get; set; }
		...
		/// </summary>
		public SupertrendSeriesTooltip Tooltip { get; set; }
		private SupertrendSeriesTooltip Tooltip_DefaultValue { get; set; }
		...
		/// </summary>
		public List<SupertrendSeriesZones> Zones { get; set; }
		private List<SupertrendSeriesZones> Zones_DefaultValue { get; set; }
