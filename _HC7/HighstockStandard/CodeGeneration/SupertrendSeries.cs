...
namespace Highsoft.Web.Mvc.Stocks
{
	public partial class SupertrendSeries  : Series
	{
		...
		public SupertrendSeries()
		{
			...
			Zones = Zones_DefaultValue = new List<SupertrendSeriesZone>();
		...
		/// </summary>
		public List<SupertrendSeriesZone> Zones { get; set; }
		private List<SupertrendSeriesZone> Zones_DefaultValue { get; set; }
