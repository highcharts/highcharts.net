...
namespace Highsoft.Web.Mvc.Stocks
{
	public partial class SupertrendSeriesDataGrouping  : BaseObject
	{
		...
		internal override Hashtable ToHashtable()
		{
			...
			if (Approximation != Approximation_DefaultValue) { h.Add("approximation",Approximation); Highstock.AddFunction("SupertrendSeriesDataGroupingApproximation.approximation", Approximation); }  
