...
{
	public partial class SupertrendSeriesDragDropDragHandle  : BaseObject
	{
		public SupertrendSeriesDragDropDragHandle()
		{
		...
		internal override Hashtable ToHashtable()
		{
			...
			if (PathFormatter != PathFormatter_DefaultValue) { h.Add("pathFormatter",PathFormatter); Highstock.AddFunction("SupertrendSeriesDragDropDragHandlePathFormatter.pathFormatter", PathFormatter); }  
