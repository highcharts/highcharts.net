...
{
	public partial class SupertrendSeriesLabel  : BaseObject
	{
		public SupertrendSeriesLabel()
		{
			...
			Style = Style_DefaultValue = new SupertrendSeriesLabelStyle();
		...
		/// </summary>
		public SupertrendSeriesLabelStyle Style { get; set; }
		private SupertrendSeriesLabelStyle Style_DefaultValue { get; set; }
