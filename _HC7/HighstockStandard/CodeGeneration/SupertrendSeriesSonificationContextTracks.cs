...
{
	public partial class SupertrendSeriesSonificationContextTracks  : BaseObject
	{
		Hashtable h = new Hashtable();

		public SupertrendSeriesSonificationContextTracks()
		{
			ActiveWhen = ActiveWhen_DefaultValue = new SupertrendSeriesSonificationContextTracksActiveWhen();
			Instrument = Instrument_DefaultValue = null;
			InstrumentString = InstrumentString_DefaultValue = "null";
			Mapping = Mapping_DefaultValue = new SupertrendSeriesSonificationContextTracksMapping();
			MidiName = MidiName_DefaultValue = "";
			PointGrouping = PointGrouping_DefaultValue = new SupertrendSeriesSonificationContextTracksPointGrouping();
			...
			Type = Type_DefaultValue = SupertrendSeriesSonificationContextTracksType.Instrument;
			ValueInterval = ValueInterval_DefaultValue = null;
			ValueMapFunction = ValueMapFunction_DefaultValue = SupertrendSeriesSonificationContextTracksValueMapFunction.Linear;
		...
		/// </summary>
		public SupertrendSeriesSonificationContextTracksActiveWhen ActiveWhen { get; set; }
		private SupertrendSeriesSonificationContextTracksActiveWhen ActiveWhen_DefaultValue { get; set; }
		...
		/// </summary>
		public SupertrendSeriesSonificationContextTracksMapping Mapping { get; set; }
		private SupertrendSeriesSonificationContextTracksMapping Mapping_DefaultValue { get; set; }
		...
		/// </summary>
		public SupertrendSeriesSonificationContextTracksPointGrouping PointGrouping { get; set; }
		private SupertrendSeriesSonificationContextTracksPointGrouping PointGrouping_DefaultValue { get; set; }
		...
		/// </summary>
		public SupertrendSeriesSonificationContextTracksType Type { get; set; }
		private SupertrendSeriesSonificationContextTracksType Type_DefaultValue { get; set; }
		...
		/// </summary>
		public SupertrendSeriesSonificationContextTracksValueMapFunction ValueMapFunction { get; set; }
		private SupertrendSeriesSonificationContextTracksValueMapFunction ValueMapFunction_DefaultValue { get; set; }
