...
{
	public partial class SupertrendSeriesSonificationContextTracksMapping  : BaseObject
	{
		Hashtable h = new Hashtable();

		public SupertrendSeriesSonificationContextTracksMapping()
		{
			Frequency = Frequency_DefaultValue = new SupertrendSeriesSonificationContextTracksMappingFrequency();
			GapBetweenNotes = GapBetweenNotes_DefaultValue = new SupertrendSeriesSonificationContextTracksMappingGapBetweenNotes();
			Highpass = Highpass_DefaultValue = new SupertrendSeriesSonificationContextTracksMappingHighpass();
			Lowpass = Lowpass_DefaultValue = new SupertrendSeriesSonificationContextTracksMappingLowpass();
			NoteDuration = NoteDuration_DefaultValue = new SupertrendSeriesSonificationContextTracksMappingNoteDuration();
			Pan = Pan_DefaultValue = new SupertrendSeriesSonificationContextTracksMappingPan();
			Pitch = Pitch_DefaultValue = new SupertrendSeriesSonificationContextTracksMappingPitch();
			PitchString = PitchString_DefaultValue = "null";
			PitchNumber = PitchNumber_DefaultValue = null;
			PlayDelay = PlayDelay_DefaultValue = new SupertrendSeriesSonificationContextTracksMappingPlayDelay();
			Time = Time_DefaultValue = new SupertrendSeriesSonificationContextTracksMappingTime();
			TimeString = TimeString_DefaultValue = "null";
			TimeNumber = TimeNumber_DefaultValue = null;
			Tremolo = Tremolo_DefaultValue = new SupertrendSeriesSonificationContextTracksMappingTremolo();
			Volume = Volume_DefaultValue = new SupertrendSeriesSonificationContextTracksMappingVolume();
		...
		/// </summary>
		public SupertrendSeriesSonificationContextTracksMappingFrequency Frequency { get; set; }
		private SupertrendSeriesSonificationContextTracksMappingFrequency Frequency_DefaultValue { get; set; }
		...
		/// </summary>
		public SupertrendSeriesSonificationContextTracksMappingGapBetweenNotes GapBetweenNotes { get; set; }
		private SupertrendSeriesSonificationContextTracksMappingGapBetweenNotes GapBetweenNotes_DefaultValue { get; set; }
		...
		/// </summary>
		public SupertrendSeriesSonificationContextTracksMappingHighpass Highpass { get; set; }
		private SupertrendSeriesSonificationContextTracksMappingHighpass Highpass_DefaultValue { get; set; }
		...
		/// </summary>
		public SupertrendSeriesSonificationContextTracksMappingLowpass Lowpass { get; set; }
		private SupertrendSeriesSonificationContextTracksMappingLowpass Lowpass_DefaultValue { get; set; }
		...
		/// </summary>
		public SupertrendSeriesSonificationContextTracksMappingNoteDuration NoteDuration { get; set; }
		private SupertrendSeriesSonificationContextTracksMappingNoteDuration NoteDuration_DefaultValue { get; set; }
		...
		/// </summary>
		public SupertrendSeriesSonificationContextTracksMappingPan Pan { get; set; }
		private SupertrendSeriesSonificationContextTracksMappingPan Pan_DefaultValue { get; set; }
		...
		/// </summary>
		public SupertrendSeriesSonificationContextTracksMappingPitch Pitch { get; set; }
		private SupertrendSeriesSonificationContextTracksMappingPitch Pitch_DefaultValue { get; set; }
		...
		/// </summary>
		public SupertrendSeriesSonificationContextTracksMappingPlayDelay PlayDelay { get; set; }
		private SupertrendSeriesSonificationContextTracksMappingPlayDelay PlayDelay_DefaultValue { get; set; }
		...
		/// </summary>
		public SupertrendSeriesSonificationContextTracksMappingTime Time { get; set; }
		private SupertrendSeriesSonificationContextTracksMappingTime Time_DefaultValue { get; set; }
		...
		/// </summary>
		public SupertrendSeriesSonificationContextTracksMappingTremolo Tremolo { get; set; }
		private SupertrendSeriesSonificationContextTracksMappingTremolo Tremolo_DefaultValue { get; set; }
		 

		/// <summary>
		/// The volume of notes, from 0 to 1.
		/// </summary>
		public SupertrendSeriesSonificationContextTracksMappingVolume Volume { get; set; }
		private SupertrendSeriesSonificationContextTracksMappingVolume Volume_DefaultValue { get; set; }
