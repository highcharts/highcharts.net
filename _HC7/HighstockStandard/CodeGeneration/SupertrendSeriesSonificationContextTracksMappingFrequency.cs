...
{
	public partial class SupertrendSeriesSonificationContextTracksMappingFrequency  : BaseObject
	{
		Hashtable h = new Hashtable();

		public SupertrendSeriesSonificationContextTracksMappingFrequency()
		{
			MapFunction = MapFunction_DefaultValue = SupertrendSeriesSonificationContextTracksMappingFrequencyMapFunction.Linear;
			MapTo = MapTo_DefaultValue = "";
			Max = Max_DefaultValue = null;
			Min = Min_DefaultValue = null;
			Value = Value_DefaultValue = null;
			Within = Within_DefaultValue = SupertrendSeriesSonificationContextTracksMappingFrequencyWithin.Chart;
		...
		/// </summary>
		public SupertrendSeriesSonificationContextTracksMappingFrequencyMapFunction MapFunction { get; set; }
		private SupertrendSeriesSonificationContextTracksMappingFrequencyMapFunction MapFunction_DefaultValue { get; set; }
		...
		/// </summary>
		public SupertrendSeriesSonificationContextTracksMappingFrequencyWithin Within { get; set; }
		private SupertrendSeriesSonificationContextTracksMappingFrequencyWithin Within_DefaultValue { get; set; }
