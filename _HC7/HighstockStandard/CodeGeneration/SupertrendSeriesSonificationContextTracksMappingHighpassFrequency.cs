...
{
	public partial class SupertrendSeriesSonificationContextTracksMappingHighpassFrequency  : BaseObject
	{
		Hashtable h = new Hashtable();

		public SupertrendSeriesSonificationContextTracksMappingHighpassFrequency()
		{
			MapFunction = MapFunction_DefaultValue = SupertrendSeriesSonificationContextTracksMappingHighpassFrequencyMapFunction.Linear;
			MapTo = MapTo_DefaultValue = "";
			Max = Max_DefaultValue = null;
			Min = Min_DefaultValue = null;
			Value = Value_DefaultValue = null;
			Within = Within_DefaultValue = SupertrendSeriesSonificationContextTracksMappingHighpassFrequencyWithin.Chart;
		...
		/// </summary>
		public SupertrendSeriesSonificationContextTracksMappingHighpassFrequencyMapFunction MapFunction { get; set; }
		private SupertrendSeriesSonificationContextTracksMappingHighpassFrequencyMapFunction MapFunction_DefaultValue { get; set; }
		...
		/// </summary>
		public SupertrendSeriesSonificationContextTracksMappingHighpassFrequencyWithin Within { get; set; }
		private SupertrendSeriesSonificationContextTracksMappingHighpassFrequencyWithin Within_DefaultValue { get; set; }
