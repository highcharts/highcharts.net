...
{
	public partial class SupertrendSeriesSonificationContextTracksMappingPitch  : BaseObject
	{
		Hashtable h = new Hashtable();

		public SupertrendSeriesSonificationContextTracksMappingPitch()
		{
			MapFunction = MapFunction_DefaultValue = SupertrendSeriesSonificationContextTracksMappingPitchMapFunction.Linear;
		...
		/// </summary>
		public SupertrendSeriesSonificationContextTracksMappingPitchMapFunction MapFunction { get; set; }
		private SupertrendSeriesSonificationContextTracksMappingPitchMapFunction MapFunction_DefaultValue { get; set; }
