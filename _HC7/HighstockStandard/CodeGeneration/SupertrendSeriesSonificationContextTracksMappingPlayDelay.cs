...
{
	public partial class SupertrendSeriesSonificationContextTracksMappingPlayDelay  : BaseObject
	{
		Hashtable h = new Hashtable();

		public SupertrendSeriesSonificationContextTracksMappingPlayDelay()
		{
			MapFunction = MapFunction_DefaultValue = SupertrendSeriesSonificationContextTracksMappingPlayDelayMapFunction.Linear;
			MapTo = MapTo_DefaultValue = "";
			Max = Max_DefaultValue = null;
			Min = Min_DefaultValue = null;
			Value = Value_DefaultValue = null;
			Within = Within_DefaultValue = SupertrendSeriesSonificationContextTracksMappingPlayDelayWithin.Chart;
		...
		/// </summary>
		public SupertrendSeriesSonificationContextTracksMappingPlayDelayMapFunction MapFunction { get; set; }
		private SupertrendSeriesSonificationContextTracksMappingPlayDelayMapFunction MapFunction_DefaultValue { get; set; }
		...
		/// </summary>
		public SupertrendSeriesSonificationContextTracksMappingPlayDelayWithin Within { get; set; }
		private SupertrendSeriesSonificationContextTracksMappingPlayDelayWithin Within_DefaultValue { get; set; }
