...
{
	public partial class SupertrendSeriesSonificationDefaultInstrumentOptions  : BaseObject
	{
		Hashtable h = new Hashtable();

		public SupertrendSeriesSonificationDefaultInstrumentOptions()
		{
			ActiveWhen = ActiveWhen_DefaultValue = new SupertrendSeriesSonificationDefaultInstrumentOptionsActiveWhen();
			Instrument = Instrument_DefaultValue = null;
			InstrumentString = InstrumentString_DefaultValue = "null";
			Mapping = Mapping_DefaultValue = new SupertrendSeriesSonificationDefaultInstrumentOptionsMapping();
			MidiName = MidiName_DefaultValue = "";
			PointGrouping = PointGrouping_DefaultValue = new SupertrendSeriesSonificationDefaultInstrumentOptionsPointGrouping();
			RoundToMusicalNotes = RoundToMusicalNotes_DefaultValue = true;
			ShowPlayMarker = ShowPlayMarker_DefaultValue = true;
			Type = Type_DefaultValue = SupertrendSeriesSonificationDefaultInstrumentOptionsType.Instrument;
		...
		/// </summary>
		public SupertrendSeriesSonificationDefaultInstrumentOptionsActiveWhen ActiveWhen { get; set; }
		private SupertrendSeriesSonificationDefaultInstrumentOptionsActiveWhen ActiveWhen_DefaultValue { get; set; }
		...
		/// </summary>
		public SupertrendSeriesSonificationDefaultInstrumentOptionsMapping Mapping { get; set; }
		private SupertrendSeriesSonificationDefaultInstrumentOptionsMapping Mapping_DefaultValue { get; set; }
		...
		/// </summary>
		public SupertrendSeriesSonificationDefaultInstrumentOptionsPointGrouping PointGrouping { get; set; }
		private SupertrendSeriesSonificationDefaultInstrumentOptionsPointGrouping PointGrouping_DefaultValue { get; set; }
		...
		/// </summary>
		public SupertrendSeriesSonificationDefaultInstrumentOptionsType Type { get; set; }
		private SupertrendSeriesSonificationDefaultInstrumentOptionsType Type_DefaultValue { get; set; }
