...
{
	public partial class SupertrendSeriesSonificationDefaultInstrumentOptionsMappingPitch  : BaseObject
	{
		Hashtable h = new Hashtable();

		public SupertrendSeriesSonificationDefaultInstrumentOptionsMappingPitch()
		{
			MapFunction = MapFunction_DefaultValue = SupertrendSeriesSonificationDefaultInstrumentOptionsMappingPitchMapFunction.Linear;
		...
		/// </summary>
		public SupertrendSeriesSonificationDefaultInstrumentOptionsMappingPitchMapFunction MapFunction { get; set; }
		private SupertrendSeriesSonificationDefaultInstrumentOptionsMappingPitchMapFunction MapFunction_DefaultValue { get; set; }
