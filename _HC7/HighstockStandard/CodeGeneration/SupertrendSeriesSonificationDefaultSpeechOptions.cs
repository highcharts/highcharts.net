...
{
	public partial class SupertrendSeriesSonificationDefaultSpeechOptions  : BaseObject
	{
		Hashtable h = new Hashtable();

		public SupertrendSeriesSonificationDefaultSpeechOptions()
		{
			ActiveWhen = ActiveWhen_DefaultValue = new SupertrendSeriesSonificationDefaultSpeechOptionsActiveWhen();
			Language = Language_DefaultValue = "en-US";
			Mapping = Mapping_DefaultValue = new SupertrendSeriesSonificationDefaultSpeechOptionsMapping();
			PointGrouping = PointGrouping_DefaultValue = new SupertrendSeriesSonificationDefaultSpeechOptionsPointGrouping();
			PreferredVoice = PreferredVoice_DefaultValue = "";
			ShowPlayMarker = ShowPlayMarker_DefaultValue = true;
			Type = Type_DefaultValue = SupertrendSeriesSonificationDefaultSpeechOptionsType.Instrument;
		...
		/// </summary>
		public SupertrendSeriesSonificationDefaultSpeechOptionsActiveWhen ActiveWhen { get; set; }
		private SupertrendSeriesSonificationDefaultSpeechOptionsActiveWhen ActiveWhen_DefaultValue { get; set; }
		...
		/// </summary>
		public SupertrendSeriesSonificationDefaultSpeechOptionsMapping Mapping { get; set; }
		private SupertrendSeriesSonificationDefaultSpeechOptionsMapping Mapping_DefaultValue { get; set; }
		 

		/// <summary>
		/// Options for point grouping, specifically for instrument tracks.
		/// </summary>
		public SupertrendSeriesSonificationDefaultSpeechOptionsPointGrouping PointGrouping { get; set; }
		private SupertrendSeriesSonificationDefaultSpeechOptionsPointGrouping PointGrouping_DefaultValue { get; set; }
		...
		/// </summary>
		public SupertrendSeriesSonificationDefaultSpeechOptionsType Type { get; set; }
		private SupertrendSeriesSonificationDefaultSpeechOptionsType Type_DefaultValue { get; set; }
