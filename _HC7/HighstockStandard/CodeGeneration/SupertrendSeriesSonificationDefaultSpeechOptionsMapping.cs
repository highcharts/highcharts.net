...
{
	public partial class SupertrendSeriesSonificationDefaultSpeechOptionsMapping  : BaseObject
	{
		Hashtable h = new Hashtable();

		public SupertrendSeriesSonificationDefaultSpeechOptionsMapping()
		{
			Frequency = Frequency_DefaultValue = new SupertrendSeriesSonificationDefaultSpeechOptionsMappingFrequency();
			GapBetweenNotes = GapBetweenNotes_DefaultValue = new SupertrendSeriesSonificationDefaultSpeechOptionsMappingGapBetweenNotes();
			Highpass = Highpass_DefaultValue = new SupertrendSeriesSonificationDefaultSpeechOptionsMappingHighpass();
			Lowpass = Lowpass_DefaultValue = new SupertrendSeriesSonificationDefaultSpeechOptionsMappingLowpass();
			NoteDuration = NoteDuration_DefaultValue = new SupertrendSeriesSonificationDefaultSpeechOptionsMappingNoteDuration();
			Pan = Pan_DefaultValue = new SupertrendSeriesSonificationDefaultSpeechOptionsMappingPan();
			Pitch = Pitch_DefaultValue = new SupertrendSeriesSonificationDefaultSpeechOptionsMappingPitch();
			PitchString = PitchString_DefaultValue = "null";
			PitchNumber = PitchNumber_DefaultValue = null;
			PlayDelay = PlayDelay_DefaultValue = new SupertrendSeriesSonificationDefaultSpeechOptionsMappingPlayDelay();
			Time = Time_DefaultValue = new SupertrendSeriesSonificationDefaultSpeechOptionsMappingTime();
			TimeString = TimeString_DefaultValue = "null";
			TimeNumber = TimeNumber_DefaultValue = null;
			Tremolo = Tremolo_DefaultValue = new SupertrendSeriesSonificationDefaultSpeechOptionsMappingTremolo();
			Volume = Volume_DefaultValue = new SupertrendSeriesSonificationDefaultSpeechOptionsMappingVolume();
		...
		/// </summary>
		public SupertrendSeriesSonificationDefaultSpeechOptionsMappingFrequency Frequency { get; set; }
		private SupertrendSeriesSonificationDefaultSpeechOptionsMappingFrequency Frequency_DefaultValue { get; set; }
		...
		/// </summary>
		public SupertrendSeriesSonificationDefaultSpeechOptionsMappingGapBetweenNotes GapBetweenNotes { get; set; }
		private SupertrendSeriesSonificationDefaultSpeechOptionsMappingGapBetweenNotes GapBetweenNotes_DefaultValue { get; set; }
		...
		/// </summary>
		public SupertrendSeriesSonificationDefaultSpeechOptionsMappingHighpass Highpass { get; set; }
		private SupertrendSeriesSonificationDefaultSpeechOptionsMappingHighpass Highpass_DefaultValue { get; set; }
		...
		/// </summary>
		public SupertrendSeriesSonificationDefaultSpeechOptionsMappingLowpass Lowpass { get; set; }
		private SupertrendSeriesSonificationDefaultSpeechOptionsMappingLowpass Lowpass_DefaultValue { get; set; }
		...
		/// </summary>
		public SupertrendSeriesSonificationDefaultSpeechOptionsMappingNoteDuration NoteDuration { get; set; }
		private SupertrendSeriesSonificationDefaultSpeechOptionsMappingNoteDuration NoteDuration_DefaultValue { get; set; }
		...
		/// </summary>
		public SupertrendSeriesSonificationDefaultSpeechOptionsMappingPan Pan { get; set; }
		private SupertrendSeriesSonificationDefaultSpeechOptionsMappingPan Pan_DefaultValue { get; set; }
		...
		/// </summary>
		public SupertrendSeriesSonificationDefaultSpeechOptionsMappingPitch Pitch { get; set; }
		private SupertrendSeriesSonificationDefaultSpeechOptionsMappingPitch Pitch_DefaultValue { get; set; }
		...
		/// </summary>
		public SupertrendSeriesSonificationDefaultSpeechOptionsMappingPlayDelay PlayDelay { get; set; }
		private SupertrendSeriesSonificationDefaultSpeechOptionsMappingPlayDelay PlayDelay_DefaultValue { get; set; }
		...
		/// </summary>
		public SupertrendSeriesSonificationDefaultSpeechOptionsMappingTime Time { get; set; }
		private SupertrendSeriesSonificationDefaultSpeechOptionsMappingTime Time_DefaultValue { get; set; }
		...
		/// </summary>
		public SupertrendSeriesSonificationDefaultSpeechOptionsMappingTremolo Tremolo { get; set; }
		private SupertrendSeriesSonificationDefaultSpeechOptionsMappingTremolo Tremolo_DefaultValue { get; set; }
		 

		/// <summary>
		/// The volume of notes, from 0 to 1.
		/// </summary>
		public SupertrendSeriesSonificationDefaultSpeechOptionsMappingVolume Volume { get; set; }
		private SupertrendSeriesSonificationDefaultSpeechOptionsMappingVolume Volume_DefaultValue { get; set; }
