...
{
	public partial class SupertrendSeriesSonificationDefaultSpeechOptionsMappingPan  : BaseObject
	{
		Hashtable h = new Hashtable();

		public SupertrendSeriesSonificationDefaultSpeechOptionsMappingPan()
		{
			MapFunction = MapFunction_DefaultValue = SupertrendSeriesSonificationDefaultSpeechOptionsMappingPanMapFunction.Linear;
			MapTo = MapTo_DefaultValue = "";
			Max = Max_DefaultValue = null;
			Min = Min_DefaultValue = null;
			Value = Value_DefaultValue = null;
			Within = Within_DefaultValue = SupertrendSeriesSonificationDefaultSpeechOptionsMappingPanWithin.Chart;
		...
		/// </summary>
		public SupertrendSeriesSonificationDefaultSpeechOptionsMappingPanMapFunction MapFunction { get; set; }
		private SupertrendSeriesSonificationDefaultSpeechOptionsMappingPanMapFunction MapFunction_DefaultValue { get; set; }
		...
		/// </summary>
		public SupertrendSeriesSonificationDefaultSpeechOptionsMappingPanWithin Within { get; set; }
		private SupertrendSeriesSonificationDefaultSpeechOptionsMappingPanWithin Within_DefaultValue { get; set; }
