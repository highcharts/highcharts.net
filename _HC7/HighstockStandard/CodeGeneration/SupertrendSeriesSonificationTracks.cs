...
{
	public partial class SupertrendSeriesSonificationTracks  : BaseObject
	{
		Hashtable h = new Hashtable();

		public SupertrendSeriesSonificationTracks()
		{
			ActiveWhen = ActiveWhen_DefaultValue = new SupertrendSeriesSonificationTracksActiveWhen();
			Instrument = Instrument_DefaultValue = null;
			InstrumentString = InstrumentString_DefaultValue = "null";
			Mapping = Mapping_DefaultValue = new SupertrendSeriesSonificationTracksMapping();
			MidiName = MidiName_DefaultValue = "";
			PointGrouping = PointGrouping_DefaultValue = new SupertrendSeriesSonificationTracksPointGrouping();
			RoundToMusicalNotes = RoundToMusicalNotes_DefaultValue = true;
			ShowPlayMarker = ShowPlayMarker_DefaultValue = true;
			Type = Type_DefaultValue = SupertrendSeriesSonificationTracksType.Instrument;
		...
		/// </summary>
		public SupertrendSeriesSonificationTracksActiveWhen ActiveWhen { get; set; }
		private SupertrendSeriesSonificationTracksActiveWhen ActiveWhen_DefaultValue { get; set; }
		...
		/// </summary>
		public SupertrendSeriesSonificationTracksMapping Mapping { get; set; }
		private SupertrendSeriesSonificationTracksMapping Mapping_DefaultValue { get; set; }
		...
		/// </summary>
		public SupertrendSeriesSonificationTracksPointGrouping PointGrouping { get; set; }
		private SupertrendSeriesSonificationTracksPointGrouping PointGrouping_DefaultValue { get; set; }
		...
		/// </summary>
		public SupertrendSeriesSonificationTracksType Type { get; set; }
		private SupertrendSeriesSonificationTracksType Type_DefaultValue { get; set; }
