...
{
	public partial class SupertrendSeriesSonificationTracksMapping  : BaseObject
	{
		Hashtable h = new Hashtable();

		public SupertrendSeriesSonificationTracksMapping()
		{
			Frequency = Frequency_DefaultValue = new SupertrendSeriesSonificationTracksMappingFrequency();
			GapBetweenNotes = GapBetweenNotes_DefaultValue = new SupertrendSeriesSonificationTracksMappingGapBetweenNotes();
			Highpass = Highpass_DefaultValue = new SupertrendSeriesSonificationTracksMappingHighpass();
			Lowpass = Lowpass_DefaultValue = new SupertrendSeriesSonificationTracksMappingLowpass();
			NoteDuration = NoteDuration_DefaultValue = new SupertrendSeriesSonificationTracksMappingNoteDuration();
			Pan = Pan_DefaultValue = new SupertrendSeriesSonificationTracksMappingPan();
			Pitch = Pitch_DefaultValue = new SupertrendSeriesSonificationTracksMappingPitch();
			PitchString = PitchString_DefaultValue = "null";
			PitchNumber = PitchNumber_DefaultValue = null;
			PlayDelay = PlayDelay_DefaultValue = new SupertrendSeriesSonificationTracksMappingPlayDelay();
			Time = Time_DefaultValue = new SupertrendSeriesSonificationTracksMappingTime();
			TimeString = TimeString_DefaultValue = "null";
			TimeNumber = TimeNumber_DefaultValue = null;
			Tremolo = Tremolo_DefaultValue = new SupertrendSeriesSonificationTracksMappingTremolo();
			Volume = Volume_DefaultValue = new SupertrendSeriesSonificationTracksMappingVolume();
		...
		/// </summary>
		public SupertrendSeriesSonificationTracksMappingFrequency Frequency { get; set; }
		private SupertrendSeriesSonificationTracksMappingFrequency Frequency_DefaultValue { get; set; }
		...
		/// </summary>
		public SupertrendSeriesSonificationTracksMappingGapBetweenNotes GapBetweenNotes { get; set; }
		private SupertrendSeriesSonificationTracksMappingGapBetweenNotes GapBetweenNotes_DefaultValue { get; set; }
		...
		/// </summary>
		public SupertrendSeriesSonificationTracksMappingHighpass Highpass { get; set; }
		private SupertrendSeriesSonificationTracksMappingHighpass Highpass_DefaultValue { get; set; }
		...
		/// </summary>
		public SupertrendSeriesSonificationTracksMappingLowpass Lowpass { get; set; }
		private SupertrendSeriesSonificationTracksMappingLowpass Lowpass_DefaultValue { get; set; }
		...
		/// </summary>
		public SupertrendSeriesSonificationTracksMappingNoteDuration NoteDuration { get; set; }
		private SupertrendSeriesSonificationTracksMappingNoteDuration NoteDuration_DefaultValue { get; set; }
		...
		/// </summary>
		public SupertrendSeriesSonificationTracksMappingPan Pan { get; set; }
		private SupertrendSeriesSonificationTracksMappingPan Pan_DefaultValue { get; set; }
		...
		/// </summary>
		public SupertrendSeriesSonificationTracksMappingPitch Pitch { get; set; }
		private SupertrendSeriesSonificationTracksMappingPitch Pitch_DefaultValue { get; set; }
		...
		/// </summary>
		public SupertrendSeriesSonificationTracksMappingPlayDelay PlayDelay { get; set; }
		private SupertrendSeriesSonificationTracksMappingPlayDelay PlayDelay_DefaultValue { get; set; }
		...
		/// </summary>
		public SupertrendSeriesSonificationTracksMappingTime Time { get; set; }
		private SupertrendSeriesSonificationTracksMappingTime Time_DefaultValue { get; set; }
		...
		/// </summary>
		public SupertrendSeriesSonificationTracksMappingTremolo Tremolo { get; set; }
		private SupertrendSeriesSonificationTracksMappingTremolo Tremolo_DefaultValue { get; set; }
		 

		/// <summary>
		/// The volume of notes, from 0 to 1.
		/// </summary>
		public SupertrendSeriesSonificationTracksMappingVolume Volume { get; set; }
		private SupertrendSeriesSonificationTracksMappingVolume Volume_DefaultValue { get; set; }
