...
{
	public partial class SupertrendSeriesSonificationTracksMappingFrequency  : BaseObject
	{
		Hashtable h = new Hashtable();

		public SupertrendSeriesSonificationTracksMappingFrequency()
		{
			MapFunction = MapFunction_DefaultValue = SupertrendSeriesSonificationTracksMappingFrequencyMapFunction.Linear;
			MapTo = MapTo_DefaultValue = "";
			Max = Max_DefaultValue = null;
			Min = Min_DefaultValue = null;
			Value = Value_DefaultValue = null;
			Within = Within_DefaultValue = SupertrendSeriesSonificationTracksMappingFrequencyWithin.Chart;
		...
		/// </summary>
		public SupertrendSeriesSonificationTracksMappingFrequencyMapFunction MapFunction { get; set; }
		private SupertrendSeriesSonificationTracksMappingFrequencyMapFunction MapFunction_DefaultValue { get; set; }
		...
		/// </summary>
		public SupertrendSeriesSonificationTracksMappingFrequencyWithin Within { get; set; }
		private SupertrendSeriesSonificationTracksMappingFrequencyWithin Within_DefaultValue { get; set; }
