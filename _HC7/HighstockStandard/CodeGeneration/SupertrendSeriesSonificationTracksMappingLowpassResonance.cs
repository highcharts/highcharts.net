...
{
	public partial class SupertrendSeriesSonificationTracksMappingLowpassResonance  : BaseObject
	{
		Hashtable h = new Hashtable();

		public SupertrendSeriesSonificationTracksMappingLowpassResonance()
		{
			MapFunction = MapFunction_DefaultValue = SupertrendSeriesSonificationTracksMappingLowpassResonanceMapFunction.Linear;
			MapTo = MapTo_DefaultValue = "";
			Max = Max_DefaultValue = null;
			Min = Min_DefaultValue = null;
			Value = Value_DefaultValue = null;
			Within = Within_DefaultValue = SupertrendSeriesSonificationTracksMappingLowpassResonanceWithin.Chart;
		...
		/// </summary>
		public SupertrendSeriesSonificationTracksMappingLowpassResonanceMapFunction MapFunction { get; set; }
		private SupertrendSeriesSonificationTracksMappingLowpassResonanceMapFunction MapFunction_DefaultValue { get; set; }
		...
		/// </summary>
		public SupertrendSeriesSonificationTracksMappingLowpassResonanceWithin Within { get; set; }
		private SupertrendSeriesSonificationTracksMappingLowpassResonanceWithin Within_DefaultValue { get; set; }
