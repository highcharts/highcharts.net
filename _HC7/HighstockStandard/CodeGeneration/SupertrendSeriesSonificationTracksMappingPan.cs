...
{
	public partial class SupertrendSeriesSonificationTracksMappingPan  : BaseObject
	{
		Hashtable h = new Hashtable();

		public SupertrendSeriesSonificationTracksMappingPan()
		{
			MapFunction = MapFunction_DefaultValue = SupertrendSeriesSonificationTracksMappingPanMapFunction.Linear;
			MapTo = MapTo_DefaultValue = "";
			Max = Max_DefaultValue = null;
			Min = Min_DefaultValue = null;
			Value = Value_DefaultValue = null;
			Within = Within_DefaultValue = SupertrendSeriesSonificationTracksMappingPanWithin.Chart;
		...
		/// </summary>
		public SupertrendSeriesSonificationTracksMappingPanMapFunction MapFunction { get; set; }
		private SupertrendSeriesSonificationTracksMappingPanMapFunction MapFunction_DefaultValue { get; set; }
		...
		/// </summary>
		public SupertrendSeriesSonificationTracksMappingPanWithin Within { get; set; }
		private SupertrendSeriesSonificationTracksMappingPanWithin Within_DefaultValue { get; set; }
