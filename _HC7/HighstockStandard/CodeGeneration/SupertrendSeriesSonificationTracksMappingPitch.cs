...
{
	public partial class SupertrendSeriesSonificationTracksMappingPitch  : BaseObject
	{
		Hashtable h = new Hashtable();

		public SupertrendSeriesSonificationTracksMappingPitch()
		{
			MapFunction = MapFunction_DefaultValue = SupertrendSeriesSonificationTracksMappingPitchMapFunction.Linear;
		...
		/// </summary>
		public SupertrendSeriesSonificationTracksMappingPitchMapFunction MapFunction { get; set; }
		private SupertrendSeriesSonificationTracksMappingPitchMapFunction MapFunction_DefaultValue { get; set; }
