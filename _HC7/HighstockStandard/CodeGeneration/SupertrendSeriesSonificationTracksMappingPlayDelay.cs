...
{
	public partial class SupertrendSeriesSonificationTracksMappingPlayDelay  : BaseObject
	{
		Hashtable h = new Hashtable();

		public SupertrendSeriesSonificationTracksMappingPlayDelay()
		{
			MapFunction = MapFunction_DefaultValue = SupertrendSeriesSonificationTracksMappingPlayDelayMapFunction.Linear;
			MapTo = MapTo_DefaultValue = "";
			Max = Max_DefaultValue = null;
			Min = Min_DefaultValue = null;
			Value = Value_DefaultValue = null;
			Within = Within_DefaultValue = SupertrendSeriesSonificationTracksMappingPlayDelayWithin.Chart;
		...
		/// </summary>
		public SupertrendSeriesSonificationTracksMappingPlayDelayMapFunction MapFunction { get; set; }
		private SupertrendSeriesSonificationTracksMappingPlayDelayMapFunction MapFunction_DefaultValue { get; set; }
		...
		/// </summary>
		public SupertrendSeriesSonificationTracksMappingPlayDelayWithin Within { get; set; }
		private SupertrendSeriesSonificationTracksMappingPlayDelayWithin Within_DefaultValue { get; set; }
