...
{
	public partial class SupertrendSeriesSonificationTracksMappingTime  : BaseObject
	{
		Hashtable h = new Hashtable();

		public SupertrendSeriesSonificationTracksMappingTime()
		{
			MapFunction = MapFunction_DefaultValue = SupertrendSeriesSonificationTracksMappingTimeMapFunction.Linear;
			MapTo = MapTo_DefaultValue = "";
			Max = Max_DefaultValue = null;
			Min = Min_DefaultValue = null;
			Value = Value_DefaultValue = null;
			Within = Within_DefaultValue = SupertrendSeriesSonificationTracksMappingTimeWithin.Chart;
		...
		/// </summary>
		public SupertrendSeriesSonificationTracksMappingTimeMapFunction MapFunction { get; set; }
		private SupertrendSeriesSonificationTracksMappingTimeMapFunction MapFunction_DefaultValue { get; set; }
		...
		/// </summary>
		public SupertrendSeriesSonificationTracksMappingTimeWithin Within { get; set; }
		private SupertrendSeriesSonificationTracksMappingTimeWithin Within_DefaultValue { get; set; }
