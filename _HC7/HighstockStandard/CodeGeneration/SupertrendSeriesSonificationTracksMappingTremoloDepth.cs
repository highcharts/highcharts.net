...
{
	public partial class SupertrendSeriesSonificationTracksMappingTremoloDepth  : BaseObject
	{
		Hashtable h = new Hashtable();

		public SupertrendSeriesSonificationTracksMappingTremoloDepth()
		{
			MapFunction = MapFunction_DefaultValue = SupertrendSeriesSonificationTracksMappingTremoloDepthMapFunction.Linear;
			MapTo = MapTo_DefaultValue = "";
			Max = Max_DefaultValue = null;
			Min = Min_DefaultValue = null;
			Value = Value_DefaultValue = null;
			Within = Within_DefaultValue = SupertrendSeriesSonificationTracksMappingTremoloDepthWithin.Chart;
		...
		/// </summary>
		public SupertrendSeriesSonificationTracksMappingTremoloDepthMapFunction MapFunction { get; set; }
		private SupertrendSeriesSonificationTracksMappingTremoloDepthMapFunction MapFunction_DefaultValue { get; set; }
		...
		/// </summary>
		public SupertrendSeriesSonificationTracksMappingTremoloDepthWithin Within { get; set; }
		private SupertrendSeriesSonificationTracksMappingTremoloDepthWithin Within_DefaultValue { get; set; }
