...
{
	public partial class SupertrendSeriesSonificationTracksMappingTremoloSpeed  : BaseObject
	{
		Hashtable h = new Hashtable();

		public SupertrendSeriesSonificationTracksMappingTremoloSpeed()
		{
			MapFunction = MapFunction_DefaultValue = SupertrendSeriesSonificationTracksMappingTremoloSpeedMapFunction.Linear;
			MapTo = MapTo_DefaultValue = "";
			Max = Max_DefaultValue = null;
			Min = Min_DefaultValue = null;
			Value = Value_DefaultValue = null;
			Within = Within_DefaultValue = SupertrendSeriesSonificationTracksMappingTremoloSpeedWithin.Chart;
		...
		/// </summary>
		public SupertrendSeriesSonificationTracksMappingTremoloSpeedMapFunction MapFunction { get; set; }
		private SupertrendSeriesSonificationTracksMappingTremoloSpeedMapFunction MapFunction_DefaultValue { get; set; }
		...
		/// </summary>
		public SupertrendSeriesSonificationTracksMappingTremoloSpeedWithin Within { get; set; }
		private SupertrendSeriesSonificationTracksMappingTremoloSpeedWithin Within_DefaultValue { get; set; }
