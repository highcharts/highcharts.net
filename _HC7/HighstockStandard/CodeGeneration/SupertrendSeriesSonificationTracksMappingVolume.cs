...
{
	public partial class SupertrendSeriesSonificationTracksMappingVolume  : BaseObject
	{
		Hashtable h = new Hashtable();

		public SupertrendSeriesSonificationTracksMappingVolume()
		{
			MapFunction = MapFunction_DefaultValue = SupertrendSeriesSonificationTracksMappingVolumeMapFunction.Linear;
			MapTo = MapTo_DefaultValue = "";
			Max = Max_DefaultValue = null;
			Min = Min_DefaultValue = null;
			Value = Value_DefaultValue = null;
			Within = Within_DefaultValue = SupertrendSeriesSonificationTracksMappingVolumeWithin.Chart;
		...
		/// </summary>
		public SupertrendSeriesSonificationTracksMappingVolumeMapFunction MapFunction { get; set; }
		private SupertrendSeriesSonificationTracksMappingVolumeMapFunction MapFunction_DefaultValue { get; set; }
		...
		/// </summary>
		public SupertrendSeriesSonificationTracksMappingVolumeWithin Within { get; set; }
		private SupertrendSeriesSonificationTracksMappingVolumeWithin Within_DefaultValue { get; set; }
