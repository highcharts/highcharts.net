...
{
	public partial class SupertrendSeriesSonificationTracksPointGrouping  : BaseObject
	{
		Hashtable h = new Hashtable();

		public SupertrendSeriesSonificationTracksPointGrouping()
		{
			Algorithm = Algorithm_DefaultValue = SupertrendSeriesSonificationTracksPointGroupingAlgorithm.Minimax;
		...
		/// </summary>
		public SupertrendSeriesSonificationTracksPointGroupingAlgorithm Algorithm { get; set; }
		private SupertrendSeriesSonificationTracksPointGroupingAlgorithm Algorithm_DefaultValue { get; set; }
