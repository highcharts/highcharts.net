...
{
	public partial class SupertrendSeriesStatesSelect  : BaseObject
	{
		public SupertrendSeriesStatesSelect()
		{
			Animation = Animation_DefaultValue = new Animation() { Enabled = true };
			Enabled = Enabled_DefaultValue = true;
			Halo = Halo_DefaultValue = new SupertrendSeriesStatesSelectHalo();
			LineWidth = LineWidth_DefaultValue = null;
			LineWidthPlus = LineWidthPlus_DefaultValue = 1;
			Marker = Marker_DefaultValue = new SupertrendSeriesStatesSelectMarker();
		...
		/// </summary>
		public SupertrendSeriesStatesSelectHalo Halo { get; set; }
		private SupertrendSeriesStatesSelectHalo Halo_DefaultValue { get; set; }
		...
		/// </summary>
		public SupertrendSeriesStatesSelectMarker Marker { get; set; }
		private SupertrendSeriesStatesSelectMarker Marker_DefaultValue { get; set; }
