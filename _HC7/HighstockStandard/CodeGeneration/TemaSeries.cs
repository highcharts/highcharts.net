...
{
	public partial class TemaSeries  : Series
	{
		Hashtable h = new Hashtable();

		public TemaSeries()
		{
			Accessibility = Accessibility_DefaultValue = new TemaSeriesAccessibility();
			AllowPointSelect = AllowPointSelect_DefaultValue = false;
			Animation = Animation_DefaultValue = new Animation() { Enabled = true };
			AnimationBool = AnimationBool_DefaultValue = true;
			AnimationLimit = AnimationLimit_DefaultValue = null;
			BoostBlending = BoostBlending_DefaultValue = TemaSeriesBoostBlending.Undefined;
			...
			Cursor = Cursor_DefaultValue = TemaSeriesCursor.Null;
			Custom = Custom_DefaultValue = new Hashtable();
			DashStyle = DashStyle_DefaultValue = TemaSeriesDashStyle.Null;
			DataGrouping = DataGrouping_DefaultValue = new TemaSeriesDataGrouping();
			DataLabels = DataLabels_DefaultValue = new TemaSeriesDataLabels();
			DataSorting = DataSorting_DefaultValue = new TemaSeriesDataSorting();
			Description = Description_DefaultValue = "";
			Dumbell = Dumbell_DefaultValue = new TemaSeriesDumbell();
			EnableMouseTracking = EnableMouseTracking_DefaultValue = true;
			Events = Events_DefaultValue = new TemaSeriesEvents();
			FindNearestPointBy = FindNearestPointBy_DefaultValue = TemaSeriesFindNearestPointBy.X;
			GapSize = GapSize_DefaultValue = 0;
			GapUnit = GapUnit_DefaultValue = TemaSeriesGapUnit.Relative;
			GetExtremesFromAll = GetExtremesFromAll_DefaultValue = false;
			Id = Id_DefaultValue = "";
			InactiveOtherPoints = InactiveOtherPoints_DefaultValue = false;
			IncludeInDataExport = IncludeInDataExport_DefaultValue = null;
			Index = Index_DefaultValue = null;
			Label = Label_DefaultValue = new TemaSeriesLabel();
			LastPrice = LastPrice_DefaultValue = new TemaSeriesLastPrice();
			LastVisiblePrice = LastVisiblePrice_DefaultValue = new TemaSeriesLastVisiblePrice();
			LegendIndex = LegendIndex_DefaultValue = null;
			LegendSymbol = LegendSymbol_DefaultValue = TemaSeriesLegendSymbol.Rectangle;
			Linecap = Linecap_DefaultValue = TemaSeriesLinecap.Round;
			LineWidth = LineWidth_DefaultValue = 2;
			LinkedTo = LinkedTo_DefaultValue = "";
			Marker = Marker_DefaultValue = new TemaSeriesMarker();
			Name = Name_DefaultValue = "";
			NegativeColor = NegativeColor_DefaultValue = "";
			OnPoint = OnPoint_DefaultValue = new TemaSeriesOnPoint();
			Opacity = Opacity_DefaultValue = 1;
			Params = Params_DefaultValue = new TemaSeriesParams();
			Point = Point_DefaultValue = new TemaSeriesPoint();
			...
			Sonification = Sonification_DefaultValue = new TemaSeriesSonification();
			Stack = Stack_DefaultValue = "";
			StackNumber = StackNumber_DefaultValue = null;
			States = States_DefaultValue = new TemaSeriesStates();
			Step = Step_DefaultValue = TemaSeriesStep.Null;
			StickyTracking = StickyTracking_DefaultValue = true;
			Threshold = Threshold_DefaultValue = 0;
			Tooltip = Tooltip_DefaultValue = new TemaSeriesTooltip();
			...
			Zones = Zones_DefaultValue = new List<TemaSeriesZones>();
		...
		/// </summary>
		public TemaSeriesAccessibility Accessibility { get; set; }
		private TemaSeriesAccessibility Accessibility_DefaultValue { get; set; }
		...
		/// </summary>
		public TemaSeriesBoostBlending BoostBlending { get; set; }
		private TemaSeriesBoostBlending BoostBlending_DefaultValue { get; set; }
		...
		/// </summary>
		public TemaSeriesCursor Cursor { get; set; }
		private TemaSeriesCursor Cursor_DefaultValue { get; set; }
		...
		/// </summary>
		public TemaSeriesDashStyle DashStyle { get; set; }
		private TemaSeriesDashStyle DashStyle_DefaultValue { get; set; }
		...
		/// </summary>
		public TemaSeriesDataGrouping DataGrouping { get; set; }
		private TemaSeriesDataGrouping DataGrouping_DefaultValue { get; set; }
		...
		/// </summary>
		public TemaSeriesDataLabels DataLabels { get; set; }
		private TemaSeriesDataLabels DataLabels_DefaultValue { get; set; }
		 

		/// <summary>
		/// Options for the series data sorting.
		/// </summary>
		public TemaSeriesDataSorting DataSorting { get; set; }
		private TemaSeriesDataSorting DataSorting_DefaultValue { get; set; }
		...
		/// 
		/// </summary>
		public TemaSeriesDumbell Dumbell { get; set; }
		private TemaSeriesDumbell Dumbell_DefaultValue { get; set; }
		...
		/// </summary>
		public TemaSeriesEvents Events { get; set; }
		private TemaSeriesEvents Events_DefaultValue { get; set; }
		...
		/// </summary>
		public TemaSeriesFindNearestPointBy FindNearestPointBy { get; set; }
		private TemaSeriesFindNearestPointBy FindNearestPointBy_DefaultValue { get; set; }
		...
		/// </summary>
		public TemaSeriesGapUnit GapUnit { get; set; }
		private TemaSeriesGapUnit GapUnit_DefaultValue { get; set; }
		...
		/// </summary>
		public TemaSeriesLabel Label { get; set; }
		private TemaSeriesLabel Label_DefaultValue { get; set; }
		 

		/// <summary>
		/// The line marks the last price from all points.
		/// </summary>
		public TemaSeriesLastPrice LastPrice { get; set; }
		private TemaSeriesLastPrice LastPrice_DefaultValue { get; set; }
		 

		/// <summary>
		/// The line marks the last price from visible range of points.
		/// </summary>
		public TemaSeriesLastVisiblePrice LastVisiblePrice { get; set; }
		private TemaSeriesLastVisiblePrice LastVisiblePrice_DefaultValue { get; set; }
		...
		/// </summary>
		public TemaSeriesLegendSymbol LegendSymbol { get; set; }
		private TemaSeriesLegendSymbol LegendSymbol_DefaultValue { get; set; }
		 

		/// <summary>
		/// The line cap used for line ends and line joins on the graph.
		/// </summary>
		public TemaSeriesLinecap Linecap { get; set; }
		private TemaSeriesLinecap Linecap_DefaultValue { get; set; }
		...
		/// </summary>
		public TemaSeriesMarker Marker { get; set; }
		private TemaSeriesMarker Marker_DefaultValue { get; set; }
		...
		/// </summary>
		public TemaSeriesOnPoint OnPoint { get; set; }
		private TemaSeriesOnPoint OnPoint_DefaultValue { get; set; }
		...
		/// </summary>
		public TemaSeriesParams Params { get; set; }
		private TemaSeriesParams Params_DefaultValue { get; set; }
		 

		/// <summary>
		/// Properties for each single point.
		/// </summary>
		public TemaSeriesPoint Point { get; set; }
		private TemaSeriesPoint Point_DefaultValue { get; set; }
		...
		/// </summary>
		public TemaSeriesSonification Sonification { get; set; }
		private TemaSeriesSonification Sonification_DefaultValue { get; set; }
		...
		/// 
		/// </summary>
		public TemaSeriesStates States { get; set; }
		private TemaSeriesStates States_DefaultValue { get; set; }
		 

		/// <summary>
		/// Whether to apply steps to the line. Possible values are `left`,`center` and `right`.
		/// </summary>
		public TemaSeriesStep Step { get; set; }
		private TemaSeriesStep Step_DefaultValue { get; set; }
		...
		/// </summary>
		public TemaSeriesTooltip Tooltip { get; set; }
		private TemaSeriesTooltip Tooltip_DefaultValue { get; set; }
		...
		/// </summary>
		public List<TemaSeriesZones> Zones { get; set; }
		private List<TemaSeriesZones> Zones_DefaultValue { get; set; }
