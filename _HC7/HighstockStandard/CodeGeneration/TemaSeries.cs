...
namespace Highsoft.Web.Mvc.Stocks
{
	public partial class TemaSeries  : Series
	{
		public TemaSeries()
		{
			...
			DragDrop = DragDrop_DefaultValue = new TemaSeriesDragDrop();
		...
		/// </summary>
		public TemaSeriesDragDrop DragDrop { get; set; }
		private TemaSeriesDragDrop DragDrop_DefaultValue { get; set; }
