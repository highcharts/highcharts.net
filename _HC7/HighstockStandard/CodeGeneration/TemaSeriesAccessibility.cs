...
namespace Highsoft.Web.Mvc.Stocks
{
	public partial class TemaSeriesAccessibility  : BaseObject
	{
		...
		public TemaSeriesAccessibility()
		{
			...
			Point = Point_DefaultValue = new TemaSeriesAccessibilityPoint();
		...
		/// </summary>
		public TemaSeriesAccessibilityPoint Point { get; set; }
		private TemaSeriesAccessibilityPoint Point_DefaultValue { get; set; }
