...
{
	public partial class TemaSeriesDragDrop  : BaseObject
	{
		public TemaSeriesDragDrop()
		{
			DraggableX = DraggableX_DefaultValue = null;
			DraggableY = DraggableY_DefaultValue = null;
			DragHandle = DragHandle_DefaultValue = new TemaSeriesDragDropDragHandle();
			...
			GuideBox = GuideBox_DefaultValue = new TemaSeriesDragDropGuideBox();
		...
		/// </summary>
		public TemaSeriesDragDropDragHandle DragHandle { get; set; }
		private TemaSeriesDragDropDragHandle DragHandle_DefaultValue { get; set; }
		...
		/// </summary>
		public TemaSeriesDragDropGuideBox GuideBox { get; set; }
		private TemaSeriesDragDropGuideBox GuideBox_DefaultValue { get; set; }
