...
{
	public partial class TemaSeriesDragDropDragHandle  : BaseObject
	{
		public TemaSeriesDragDropDragHandle()
		{
		...
		internal override Hashtable ToHashtable()
		{
			...
			if (PathFormatter != PathFormatter_DefaultValue) { h.Add("pathFormatter",PathFormatter); Highstock.AddFunction("TemaSeriesDragDropDragHandlePathFormatter.pathFormatter", PathFormatter); }  
