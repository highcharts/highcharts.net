...
{
	public partial class TemaSeriesSonificationContextTracks  : BaseObject
	{
		Hashtable h = new Hashtable();

		public TemaSeriesSonificationContextTracks()
		{
			ActiveWhen = ActiveWhen_DefaultValue = new TemaSeriesSonificationContextTracksActiveWhen();
			Instrument = Instrument_DefaultValue = null;
			InstrumentString = InstrumentString_DefaultValue = "null";
			Mapping = Mapping_DefaultValue = new TemaSeriesSonificationContextTracksMapping();
			MidiName = MidiName_DefaultValue = "";
			PointGrouping = PointGrouping_DefaultValue = new TemaSeriesSonificationContextTracksPointGrouping();
			...
			Type = Type_DefaultValue = TemaSeriesSonificationContextTracksType.Instrument;
			ValueInterval = ValueInterval_DefaultValue = null;
			ValueMapFunction = ValueMapFunction_DefaultValue = TemaSeriesSonificationContextTracksValueMapFunction.Linear;
		...
		/// </summary>
		public TemaSeriesSonificationContextTracksActiveWhen ActiveWhen { get; set; }
		private TemaSeriesSonificationContextTracksActiveWhen ActiveWhen_DefaultValue { get; set; }
		...
		/// </summary>
		public TemaSeriesSonificationContextTracksMapping Mapping { get; set; }
		private TemaSeriesSonificationContextTracksMapping Mapping_DefaultValue { get; set; }
		...
		/// </summary>
		public TemaSeriesSonificationContextTracksPointGrouping PointGrouping { get; set; }
		private TemaSeriesSonificationContextTracksPointGrouping PointGrouping_DefaultValue { get; set; }
		...
		/// </summary>
		public TemaSeriesSonificationContextTracksType Type { get; set; }
		private TemaSeriesSonificationContextTracksType Type_DefaultValue { get; set; }
		...
		/// </summary>
		public TemaSeriesSonificationContextTracksValueMapFunction ValueMapFunction { get; set; }
		private TemaSeriesSonificationContextTracksValueMapFunction ValueMapFunction_DefaultValue { get; set; }
