...
{
	public partial class TemaSeriesSonificationContextTracksMappingHighpassFrequency  : BaseObject
	{
		Hashtable h = new Hashtable();

		public TemaSeriesSonificationContextTracksMappingHighpassFrequency()
		{
			MapFunction = MapFunction_DefaultValue = TemaSeriesSonificationContextTracksMappingHighpassFrequencyMapFunction.Linear;
			MapTo = MapTo_DefaultValue = "";
			Max = Max_DefaultValue = null;
			Min = Min_DefaultValue = null;
			Value = Value_DefaultValue = null;
			Within = Within_DefaultValue = TemaSeriesSonificationContextTracksMappingHighpassFrequencyWithin.Chart;
		...
		/// </summary>
		public TemaSeriesSonificationContextTracksMappingHighpassFrequencyMapFunction MapFunction { get; set; }
		private TemaSeriesSonificationContextTracksMappingHighpassFrequencyMapFunction MapFunction_DefaultValue { get; set; }
		...
		/// </summary>
		public TemaSeriesSonificationContextTracksMappingHighpassFrequencyWithin Within { get; set; }
		private TemaSeriesSonificationContextTracksMappingHighpassFrequencyWithin Within_DefaultValue { get; set; }
