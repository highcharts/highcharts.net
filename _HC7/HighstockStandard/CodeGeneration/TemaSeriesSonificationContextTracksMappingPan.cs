...
{
	public partial class TemaSeriesSonificationContextTracksMappingPan  : BaseObject
	{
		Hashtable h = new Hashtable();

		public TemaSeriesSonificationContextTracksMappingPan()
		{
			MapFunction = MapFunction_DefaultValue = TemaSeriesSonificationContextTracksMappingPanMapFunction.Linear;
			MapTo = MapTo_DefaultValue = "";
			Max = Max_DefaultValue = null;
			Min = Min_DefaultValue = null;
			Value = Value_DefaultValue = null;
			Within = Within_DefaultValue = TemaSeriesSonificationContextTracksMappingPanWithin.Chart;
		...
		/// </summary>
		public TemaSeriesSonificationContextTracksMappingPanMapFunction MapFunction { get; set; }
		private TemaSeriesSonificationContextTracksMappingPanMapFunction MapFunction_DefaultValue { get; set; }
		...
		/// </summary>
		public TemaSeriesSonificationContextTracksMappingPanWithin Within { get; set; }
		private TemaSeriesSonificationContextTracksMappingPanWithin Within_DefaultValue { get; set; }
