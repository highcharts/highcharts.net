...
{
	public partial class TemaSeriesSonificationContextTracksMappingPitch  : BaseObject
	{
		Hashtable h = new Hashtable();

		public TemaSeriesSonificationContextTracksMappingPitch()
		{
			MapFunction = MapFunction_DefaultValue = TemaSeriesSonificationContextTracksMappingPitchMapFunction.Linear;
		...
		/// </summary>
		public TemaSeriesSonificationContextTracksMappingPitchMapFunction MapFunction { get; set; }
		private TemaSeriesSonificationContextTracksMappingPitchMapFunction MapFunction_DefaultValue { get; set; }
