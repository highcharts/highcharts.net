...
{
	public partial class TemaSeriesSonificationContextTracksPointGrouping  : BaseObject
	{
		Hashtable h = new Hashtable();

		public TemaSeriesSonificationContextTracksPointGrouping()
		{
			Algorithm = Algorithm_DefaultValue = TemaSeriesSonificationContextTracksPointGroupingAlgorithm.Minimax;
		...
		/// </summary>
		public TemaSeriesSonificationContextTracksPointGroupingAlgorithm Algorithm { get; set; }
		private TemaSeriesSonificationContextTracksPointGroupingAlgorithm Algorithm_DefaultValue { get; set; }
