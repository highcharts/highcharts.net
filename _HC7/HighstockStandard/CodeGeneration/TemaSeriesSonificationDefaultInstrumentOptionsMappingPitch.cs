...
namespace Highsoft.Web.Mvc.Stocks
{
	public partial class TemaSeriesSonificationDefaultInstrumentOptionsMappingPitch  : BaseObject
	{
		...
		{
			if (MapFunction != TemaSeriesSonificationDefaultInstrumentOptionsMappingPitchMapFunction.Null) h.Add("mapFunction", highstock.FirstCharacterToLower(MapFunction.ToString()));
