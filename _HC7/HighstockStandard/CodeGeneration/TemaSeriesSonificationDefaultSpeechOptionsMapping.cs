...
{
	public partial class TemaSeriesSonificationDefaultSpeechOptionsMapping  : BaseObject
	{
		Hashtable h = new Hashtable();

		public TemaSeriesSonificationDefaultSpeechOptionsMapping()
		{
			Frequency = Frequency_DefaultValue = new TemaSeriesSonificationDefaultSpeechOptionsMappingFrequency();
			GapBetweenNotes = GapBetweenNotes_DefaultValue = new TemaSeriesSonificationDefaultSpeechOptionsMappingGapBetweenNotes();
			Highpass = Highpass_DefaultValue = new TemaSeriesSonificationDefaultSpeechOptionsMappingHighpass();
			Lowpass = Lowpass_DefaultValue = new TemaSeriesSonificationDefaultSpeechOptionsMappingLowpass();
			NoteDuration = NoteDuration_DefaultValue = new TemaSeriesSonificationDefaultSpeechOptionsMappingNoteDuration();
			Pan = Pan_DefaultValue = new TemaSeriesSonificationDefaultSpeechOptionsMappingPan();
			Pitch = Pitch_DefaultValue = new TemaSeriesSonificationDefaultSpeechOptionsMappingPitch();
			PitchString = PitchString_DefaultValue = "null";
			PitchNumber = PitchNumber_DefaultValue = null;
			PlayDelay = PlayDelay_DefaultValue = new TemaSeriesSonificationDefaultSpeechOptionsMappingPlayDelay();
			Time = Time_DefaultValue = new TemaSeriesSonificationDefaultSpeechOptionsMappingTime();
			TimeString = TimeString_DefaultValue = "null";
			TimeNumber = TimeNumber_DefaultValue = null;
			Tremolo = Tremolo_DefaultValue = new TemaSeriesSonificationDefaultSpeechOptionsMappingTremolo();
			Volume = Volume_DefaultValue = new TemaSeriesSonificationDefaultSpeechOptionsMappingVolume();
		...
		/// </summary>
		public TemaSeriesSonificationDefaultSpeechOptionsMappingFrequency Frequency { get; set; }
		private TemaSeriesSonificationDefaultSpeechOptionsMappingFrequency Frequency_DefaultValue { get; set; }
		...
		/// </summary>
		public TemaSeriesSonificationDefaultSpeechOptionsMappingGapBetweenNotes GapBetweenNotes { get; set; }
		private TemaSeriesSonificationDefaultSpeechOptionsMappingGapBetweenNotes GapBetweenNotes_DefaultValue { get; set; }
		...
		/// </summary>
		public TemaSeriesSonificationDefaultSpeechOptionsMappingHighpass Highpass { get; set; }
		private TemaSeriesSonificationDefaultSpeechOptionsMappingHighpass Highpass_DefaultValue { get; set; }
		...
		/// </summary>
		public TemaSeriesSonificationDefaultSpeechOptionsMappingLowpass Lowpass { get; set; }
		private TemaSeriesSonificationDefaultSpeechOptionsMappingLowpass Lowpass_DefaultValue { get; set; }
		...
		/// </summary>
		public TemaSeriesSonificationDefaultSpeechOptionsMappingNoteDuration NoteDuration { get; set; }
		private TemaSeriesSonificationDefaultSpeechOptionsMappingNoteDuration NoteDuration_DefaultValue { get; set; }
		...
		/// </summary>
		public TemaSeriesSonificationDefaultSpeechOptionsMappingPan Pan { get; set; }
		private TemaSeriesSonificationDefaultSpeechOptionsMappingPan Pan_DefaultValue { get; set; }
		...
		/// </summary>
		public TemaSeriesSonificationDefaultSpeechOptionsMappingPitch Pitch { get; set; }
		private TemaSeriesSonificationDefaultSpeechOptionsMappingPitch Pitch_DefaultValue { get; set; }
		...
		/// </summary>
		public TemaSeriesSonificationDefaultSpeechOptionsMappingPlayDelay PlayDelay { get; set; }
		private TemaSeriesSonificationDefaultSpeechOptionsMappingPlayDelay PlayDelay_DefaultValue { get; set; }
		...
		/// </summary>
		public TemaSeriesSonificationDefaultSpeechOptionsMappingTime Time { get; set; }
		private TemaSeriesSonificationDefaultSpeechOptionsMappingTime Time_DefaultValue { get; set; }
		...
		/// </summary>
		public TemaSeriesSonificationDefaultSpeechOptionsMappingTremolo Tremolo { get; set; }
		private TemaSeriesSonificationDefaultSpeechOptionsMappingTremolo Tremolo_DefaultValue { get; set; }
		 

		/// <summary>
		/// The volume of notes, from 0 to 1.
		/// </summary>
		public TemaSeriesSonificationDefaultSpeechOptionsMappingVolume Volume { get; set; }
		private TemaSeriesSonificationDefaultSpeechOptionsMappingVolume Volume_DefaultValue { get; set; }
