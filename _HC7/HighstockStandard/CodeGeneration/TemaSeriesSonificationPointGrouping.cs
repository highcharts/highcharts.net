...
{
	public partial class TemaSeriesSonificationPointGrouping  : BaseObject
	{
		Hashtable h = new Hashtable();

		public TemaSeriesSonificationPointGrouping()
		{
			Algorithm = Algorithm_DefaultValue = TemaSeriesSonificationPointGroupingAlgorithm.Minimax;
		...
		/// </summary>
		public TemaSeriesSonificationPointGroupingAlgorithm Algorithm { get; set; }
		private TemaSeriesSonificationPointGroupingAlgorithm Algorithm_DefaultValue { get; set; }
