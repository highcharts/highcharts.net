...
{
	public partial class TemaSeriesSonificationTracks  : BaseObject
	{
		Hashtable h = new Hashtable();

		public TemaSeriesSonificationTracks()
		{
			ActiveWhen = ActiveWhen_DefaultValue = new TemaSeriesSonificationTracksActiveWhen();
			Instrument = Instrument_DefaultValue = null;
			InstrumentString = InstrumentString_DefaultValue = "null";
			Mapping = Mapping_DefaultValue = new TemaSeriesSonificationTracksMapping();
			MidiName = MidiName_DefaultValue = "";
			PointGrouping = PointGrouping_DefaultValue = new TemaSeriesSonificationTracksPointGrouping();
			RoundToMusicalNotes = RoundToMusicalNotes_DefaultValue = true;
			ShowPlayMarker = ShowPlayMarker_DefaultValue = true;
			Type = Type_DefaultValue = TemaSeriesSonificationTracksType.Instrument;
		...
		/// </summary>
		public TemaSeriesSonificationTracksActiveWhen ActiveWhen { get; set; }
		private TemaSeriesSonificationTracksActiveWhen ActiveWhen_DefaultValue { get; set; }
		...
		/// </summary>
		public TemaSeriesSonificationTracksMapping Mapping { get; set; }
		private TemaSeriesSonificationTracksMapping Mapping_DefaultValue { get; set; }
		...
		/// </summary>
		public TemaSeriesSonificationTracksPointGrouping PointGrouping { get; set; }
		private TemaSeriesSonificationTracksPointGrouping PointGrouping_DefaultValue { get; set; }
		...
		/// </summary>
		public TemaSeriesSonificationTracksType Type { get; set; }
		private TemaSeriesSonificationTracksType Type_DefaultValue { get; set; }
