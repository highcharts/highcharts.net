...
{
	public partial class TemaSeriesSonificationTracksMapping  : BaseObject
	{
		Hashtable h = new Hashtable();

		public TemaSeriesSonificationTracksMapping()
		{
			Frequency = Frequency_DefaultValue = new TemaSeriesSonificationTracksMappingFrequency();
			GapBetweenNotes = GapBetweenNotes_DefaultValue = new TemaSeriesSonificationTracksMappingGapBetweenNotes();
			Highpass = Highpass_DefaultValue = new TemaSeriesSonificationTracksMappingHighpass();
			Lowpass = Lowpass_DefaultValue = new TemaSeriesSonificationTracksMappingLowpass();
			NoteDuration = NoteDuration_DefaultValue = new TemaSeriesSonificationTracksMappingNoteDuration();
			Pan = Pan_DefaultValue = new TemaSeriesSonificationTracksMappingPan();
			Pitch = Pitch_DefaultValue = new TemaSeriesSonificationTracksMappingPitch();
			PitchString = PitchString_DefaultValue = "null";
			PitchNumber = PitchNumber_DefaultValue = null;
			PlayDelay = PlayDelay_DefaultValue = new TemaSeriesSonificationTracksMappingPlayDelay();
			Time = Time_DefaultValue = new TemaSeriesSonificationTracksMappingTime();
			TimeString = TimeString_DefaultValue = "null";
			TimeNumber = TimeNumber_DefaultValue = null;
			Tremolo = Tremolo_DefaultValue = new TemaSeriesSonificationTracksMappingTremolo();
			Volume = Volume_DefaultValue = new TemaSeriesSonificationTracksMappingVolume();
		...
		/// </summary>
		public TemaSeriesSonificationTracksMappingFrequency Frequency { get; set; }
		private TemaSeriesSonificationTracksMappingFrequency Frequency_DefaultValue { get; set; }
		...
		/// </summary>
		public TemaSeriesSonificationTracksMappingGapBetweenNotes GapBetweenNotes { get; set; }
		private TemaSeriesSonificationTracksMappingGapBetweenNotes GapBetweenNotes_DefaultValue { get; set; }
		...
		/// </summary>
		public TemaSeriesSonificationTracksMappingHighpass Highpass { get; set; }
		private TemaSeriesSonificationTracksMappingHighpass Highpass_DefaultValue { get; set; }
		...
		/// </summary>
		public TemaSeriesSonificationTracksMappingLowpass Lowpass { get; set; }
		private TemaSeriesSonificationTracksMappingLowpass Lowpass_DefaultValue { get; set; }
		...
		/// </summary>
		public TemaSeriesSonificationTracksMappingNoteDuration NoteDuration { get; set; }
		private TemaSeriesSonificationTracksMappingNoteDuration NoteDuration_DefaultValue { get; set; }
		...
		/// </summary>
		public TemaSeriesSonificationTracksMappingPan Pan { get; set; }
		private TemaSeriesSonificationTracksMappingPan Pan_DefaultValue { get; set; }
		...
		/// </summary>
		public TemaSeriesSonificationTracksMappingPitch Pitch { get; set; }
		private TemaSeriesSonificationTracksMappingPitch Pitch_DefaultValue { get; set; }
		...
		/// </summary>
		public TemaSeriesSonificationTracksMappingPlayDelay PlayDelay { get; set; }
		private TemaSeriesSonificationTracksMappingPlayDelay PlayDelay_DefaultValue { get; set; }
		...
		/// </summary>
		public TemaSeriesSonificationTracksMappingTime Time { get; set; }
		private TemaSeriesSonificationTracksMappingTime Time_DefaultValue { get; set; }
		...
		/// </summary>
		public TemaSeriesSonificationTracksMappingTremolo Tremolo { get; set; }
		private TemaSeriesSonificationTracksMappingTremolo Tremolo_DefaultValue { get; set; }
		 

		/// <summary>
		/// The volume of notes, from 0 to 1.
		/// </summary>
		public TemaSeriesSonificationTracksMappingVolume Volume { get; set; }
		private TemaSeriesSonificationTracksMappingVolume Volume_DefaultValue { get; set; }
