...
{
	public partial class TemaSeriesSonificationTracksMappingFrequency  : BaseObject
	{
		Hashtable h = new Hashtable();

		public TemaSeriesSonificationTracksMappingFrequency()
		{
			MapFunction = MapFunction_DefaultValue = TemaSeriesSonificationTracksMappingFrequencyMapFunction.Linear;
			MapTo = MapTo_DefaultValue = "";
			Max = Max_DefaultValue = null;
			Min = Min_DefaultValue = null;
			Value = Value_DefaultValue = null;
			Within = Within_DefaultValue = TemaSeriesSonificationTracksMappingFrequencyWithin.Chart;
		...
		/// </summary>
		public TemaSeriesSonificationTracksMappingFrequencyMapFunction MapFunction { get; set; }
		private TemaSeriesSonificationTracksMappingFrequencyMapFunction MapFunction_DefaultValue { get; set; }
		...
		/// </summary>
		public TemaSeriesSonificationTracksMappingFrequencyWithin Within { get; set; }
		private TemaSeriesSonificationTracksMappingFrequencyWithin Within_DefaultValue { get; set; }
