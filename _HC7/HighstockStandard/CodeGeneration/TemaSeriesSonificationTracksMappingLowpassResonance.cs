...
{
	public partial class TemaSeriesSonificationTracksMappingLowpassResonance  : BaseObject
	{
		Hashtable h = new Hashtable();

		public TemaSeriesSonificationTracksMappingLowpassResonance()
		{
			MapFunction = MapFunction_DefaultValue = TemaSeriesSonificationTracksMappingLowpassResonanceMapFunction.Linear;
			MapTo = MapTo_DefaultValue = "";
			Max = Max_DefaultValue = null;
			Min = Min_DefaultValue = null;
			Value = Value_DefaultValue = null;
			Within = Within_DefaultValue = TemaSeriesSonificationTracksMappingLowpassResonanceWithin.Chart;
		...
		/// </summary>
		public TemaSeriesSonificationTracksMappingLowpassResonanceMapFunction MapFunction { get; set; }
		private TemaSeriesSonificationTracksMappingLowpassResonanceMapFunction MapFunction_DefaultValue { get; set; }
		...
		/// </summary>
		public TemaSeriesSonificationTracksMappingLowpassResonanceWithin Within { get; set; }
		private TemaSeriesSonificationTracksMappingLowpassResonanceWithin Within_DefaultValue { get; set; }
