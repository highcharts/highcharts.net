...
{
	public partial class TemaSeriesSonificationTracksMappingNoteDuration  : BaseObject
	{
		Hashtable h = new Hashtable();

		public TemaSeriesSonificationTracksMappingNoteDuration()
		{
			MapFunction = MapFunction_DefaultValue = TemaSeriesSonificationTracksMappingNoteDurationMapFunction.Linear;
			MapTo = MapTo_DefaultValue = "";
			Max = Max_DefaultValue = null;
			Min = Min_DefaultValue = null;
			Value = Value_DefaultValue = null;
			Within = Within_DefaultValue = TemaSeriesSonificationTracksMappingNoteDurationWithin.Chart;
		...
		/// </summary>
		public TemaSeriesSonificationTracksMappingNoteDurationMapFunction MapFunction { get; set; }
		private TemaSeriesSonificationTracksMappingNoteDurationMapFunction MapFunction_DefaultValue { get; set; }
		...
		/// </summary>
		public TemaSeriesSonificationTracksMappingNoteDurationWithin Within { get; set; }
		private TemaSeriesSonificationTracksMappingNoteDurationWithin Within_DefaultValue { get; set; }
