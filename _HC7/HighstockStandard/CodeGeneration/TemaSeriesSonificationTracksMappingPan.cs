...
{
	public partial class TemaSeriesSonificationTracksMappingPan  : BaseObject
	{
		Hashtable h = new Hashtable();

		public TemaSeriesSonificationTracksMappingPan()
		{
			MapFunction = MapFunction_DefaultValue = TemaSeriesSonificationTracksMappingPanMapFunction.Linear;
			MapTo = MapTo_DefaultValue = "";
			Max = Max_DefaultValue = null;
			Min = Min_DefaultValue = null;
			Value = Value_DefaultValue = null;
			Within = Within_DefaultValue = TemaSeriesSonificationTracksMappingPanWithin.Chart;
		...
		/// </summary>
		public TemaSeriesSonificationTracksMappingPanMapFunction MapFunction { get; set; }
		private TemaSeriesSonificationTracksMappingPanMapFunction MapFunction_DefaultValue { get; set; }
		...
		/// </summary>
		public TemaSeriesSonificationTracksMappingPanWithin Within { get; set; }
		private TemaSeriesSonificationTracksMappingPanWithin Within_DefaultValue { get; set; }
