...
{
	public partial class TemaSeriesSonificationTracksMappingPitch  : BaseObject
	{
		Hashtable h = new Hashtable();

		public TemaSeriesSonificationTracksMappingPitch()
		{
			MapFunction = MapFunction_DefaultValue = TemaSeriesSonificationTracksMappingPitchMapFunction.Linear;
		...
		/// </summary>
		public TemaSeriesSonificationTracksMappingPitchMapFunction MapFunction { get; set; }
		private TemaSeriesSonificationTracksMappingPitchMapFunction MapFunction_DefaultValue { get; set; }
