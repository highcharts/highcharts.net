...
{
	public partial class TemaSeriesSonificationTracksMappingPlayDelay  : BaseObject
	{
		Hashtable h = new Hashtable();

		public TemaSeriesSonificationTracksMappingPlayDelay()
		{
			MapFunction = MapFunction_DefaultValue = TemaSeriesSonificationTracksMappingPlayDelayMapFunction.Linear;
			MapTo = MapTo_DefaultValue = "";
			Max = Max_DefaultValue = null;
			Min = Min_DefaultValue = null;
			Value = Value_DefaultValue = null;
			Within = Within_DefaultValue = TemaSeriesSonificationTracksMappingPlayDelayWithin.Chart;
		...
		/// </summary>
		public TemaSeriesSonificationTracksMappingPlayDelayMapFunction MapFunction { get; set; }
		private TemaSeriesSonificationTracksMappingPlayDelayMapFunction MapFunction_DefaultValue { get; set; }
		...
		/// </summary>
		public TemaSeriesSonificationTracksMappingPlayDelayWithin Within { get; set; }
		private TemaSeriesSonificationTracksMappingPlayDelayWithin Within_DefaultValue { get; set; }
