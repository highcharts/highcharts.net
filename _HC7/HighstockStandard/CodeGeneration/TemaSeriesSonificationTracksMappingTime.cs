...
{
	public partial class TemaSeriesSonificationTracksMappingTime  : BaseObject
	{
		Hashtable h = new Hashtable();

		public TemaSeriesSonificationTracksMappingTime()
		{
			MapFunction = MapFunction_DefaultValue = TemaSeriesSonificationTracksMappingTimeMapFunction.Linear;
			MapTo = MapTo_DefaultValue = "";
			Max = Max_DefaultValue = null;
			Min = Min_DefaultValue = null;
			Value = Value_DefaultValue = null;
			Within = Within_DefaultValue = TemaSeriesSonificationTracksMappingTimeWithin.Chart;
		...
		/// </summary>
		public TemaSeriesSonificationTracksMappingTimeMapFunction MapFunction { get; set; }
		private TemaSeriesSonificationTracksMappingTimeMapFunction MapFunction_DefaultValue { get; set; }
		...
		/// </summary>
		public TemaSeriesSonificationTracksMappingTimeWithin Within { get; set; }
		private TemaSeriesSonificationTracksMappingTimeWithin Within_DefaultValue { get; set; }
