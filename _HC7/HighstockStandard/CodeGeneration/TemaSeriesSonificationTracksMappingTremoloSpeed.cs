...
{
	public partial class TemaSeriesSonificationTracksMappingTremoloSpeed  : BaseObject
	{
		Hashtable h = new Hashtable();

		public TemaSeriesSonificationTracksMappingTremoloSpeed()
		{
			MapFunction = MapFunction_DefaultValue = TemaSeriesSonificationTracksMappingTremoloSpeedMapFunction.Linear;
			MapTo = MapTo_DefaultValue = "";
			Max = Max_DefaultValue = null;
			Min = Min_DefaultValue = null;
			Value = Value_DefaultValue = null;
			Within = Within_DefaultValue = TemaSeriesSonificationTracksMappingTremoloSpeedWithin.Chart;
		...
		/// </summary>
		public TemaSeriesSonificationTracksMappingTremoloSpeedMapFunction MapFunction { get; set; }
		private TemaSeriesSonificationTracksMappingTremoloSpeedMapFunction MapFunction_DefaultValue { get; set; }
		...
		/// </summary>
		public TemaSeriesSonificationTracksMappingTremoloSpeedWithin Within { get; set; }
		private TemaSeriesSonificationTracksMappingTremoloSpeedWithin Within_DefaultValue { get; set; }
