...
{
	public partial class TemaSeriesSonificationTracksMappingVolume  : BaseObject
	{
		Hashtable h = new Hashtable();

		public TemaSeriesSonificationTracksMappingVolume()
		{
			MapFunction = MapFunction_DefaultValue = TemaSeriesSonificationTracksMappingVolumeMapFunction.Linear;
			MapTo = MapTo_DefaultValue = "";
			Max = Max_DefaultValue = null;
			Min = Min_DefaultValue = null;
			Value = Value_DefaultValue = null;
			Within = Within_DefaultValue = TemaSeriesSonificationTracksMappingVolumeWithin.Chart;
		...
		/// </summary>
		public TemaSeriesSonificationTracksMappingVolumeMapFunction MapFunction { get; set; }
		private TemaSeriesSonificationTracksMappingVolumeMapFunction MapFunction_DefaultValue { get; set; }
		...
		/// </summary>
		public TemaSeriesSonificationTracksMappingVolumeWithin Within { get; set; }
		private TemaSeriesSonificationTracksMappingVolumeWithin Within_DefaultValue { get; set; }
