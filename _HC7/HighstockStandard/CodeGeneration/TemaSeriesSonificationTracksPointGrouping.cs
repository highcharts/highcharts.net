...
{
	public partial class TemaSeriesSonificationTracksPointGrouping  : BaseObject
	{
		Hashtable h = new Hashtable();

		public TemaSeriesSonificationTracksPointGrouping()
		{
			Algorithm = Algorithm_DefaultValue = TemaSeriesSonificationTracksPointGroupingAlgorithm.Minimax;
		...
		/// </summary>
		public TemaSeriesSonificationTracksPointGroupingAlgorithm Algorithm { get; set; }
		private TemaSeriesSonificationTracksPointGroupingAlgorithm Algorithm_DefaultValue { get; set; }
