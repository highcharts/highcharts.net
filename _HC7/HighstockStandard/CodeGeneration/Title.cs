...
namespace Highsoft.Web.Mvc.Stocks
{
	public partial class Title  : BaseObject
	{
		...
		{
			if (Align != TitleAlign.Null) h.Add("align", highstock.FirstCharacterToLower(Align.ToString()));
			...
			if (VerticalAlign != TitleVerticalAlign.Null) h.Add("verticalAlign", highstock.FirstCharacterToLower(VerticalAlign.ToString()));
