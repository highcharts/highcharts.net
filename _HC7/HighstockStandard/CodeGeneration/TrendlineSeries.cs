...
{
	public partial class TrendlineSeries  : Series
	{
		Hashtable h = new Hashtable();

		public TrendlineSeries()
		{
			Accessibility = Accessibility_DefaultValue = new TrendlineSeriesAccessibility();
			AllowPointSelect = AllowPointSelect_DefaultValue = false;
			Animation = Animation_DefaultValue = new Animation() { Enabled = true };
			AnimationBool = AnimationBool_DefaultValue = true;
			AnimationLimit = AnimationLimit_DefaultValue = null;
			BoostBlending = BoostBlending_DefaultValue = TrendlineSeriesBoostBlending.Undefined;
			...
			Compare = Compare_DefaultValue = TrendlineSeriesCompare.Percent;
			CompareBase = CompareBase_DefaultValue = TrendlineSeriesCompareBase.Min;
			...
			Cursor = Cursor_DefaultValue = TrendlineSeriesCursor.Null;
			Custom = Custom_DefaultValue = new Hashtable();
			DashStyle = DashStyle_DefaultValue = TrendlineSeriesDashStyle.Null;
			DataGrouping = DataGrouping_DefaultValue = new TrendlineSeriesDataGrouping();
			DataLabels = DataLabels_DefaultValue = new TrendlineSeriesDataLabels();
			DataSorting = DataSorting_DefaultValue = new TrendlineSeriesDataSorting();
			Description = Description_DefaultValue = "";
			Dumbell = Dumbell_DefaultValue = new TrendlineSeriesDumbell();
			EnableMouseTracking = EnableMouseTracking_DefaultValue = true;
			Events = Events_DefaultValue = new TrendlineSeriesEvents();
			FindNearestPointBy = FindNearestPointBy_DefaultValue = TrendlineSeriesFindNearestPointBy.X;
			GapSize = GapSize_DefaultValue = 0;
			GapUnit = GapUnit_DefaultValue = TrendlineSeriesGapUnit.Relative;
			GetExtremesFromAll = GetExtremesFromAll_DefaultValue = false;
			Id = Id_DefaultValue = "";
			InactiveOtherPoints = InactiveOtherPoints_DefaultValue = false;
			IncludeInDataExport = IncludeInDataExport_DefaultValue = null;
			Index = Index_DefaultValue = null;
			Label = Label_DefaultValue = new TrendlineSeriesLabel();
			LastPrice = LastPrice_DefaultValue = new TrendlineSeriesLastPrice();
			LastVisiblePrice = LastVisiblePrice_DefaultValue = new TrendlineSeriesLastVisiblePrice();
			LegendIndex = LegendIndex_DefaultValue = null;
			LegendSymbol = LegendSymbol_DefaultValue = TrendlineSeriesLegendSymbol.Rectangle;
			Linecap = Linecap_DefaultValue = TrendlineSeriesLinecap.Round;
			LineWidth = LineWidth_DefaultValue = 2;
			LinkedTo = LinkedTo_DefaultValue = "";
			Marker = Marker_DefaultValue = new TrendlineSeriesMarker();
			Name = Name_DefaultValue = "";
			NegativeColor = NegativeColor_DefaultValue = "";
			OnPoint = OnPoint_DefaultValue = new TrendlineSeriesOnPoint();
			Opacity = Opacity_DefaultValue = 1;
			Params = Params_DefaultValue = new TrendlineSeriesParams();
			Point = Point_DefaultValue = new TrendlineSeriesPoint();
			...
			Sonification = Sonification_DefaultValue = new TrendlineSeriesSonification();
			Stack = Stack_DefaultValue = "";
			StackNumber = StackNumber_DefaultValue = null;
			States = States_DefaultValue = new TrendlineSeriesStates();
			Step = Step_DefaultValue = TrendlineSeriesStep.Null;
			StickyTracking = StickyTracking_DefaultValue = true;
			Threshold = Threshold_DefaultValue = 0;
			Tooltip = Tooltip_DefaultValue = new TrendlineSeriesTooltip();
			...
			Zones = Zones_DefaultValue = new List<TrendlineSeriesZones>();
		...
		/// </summary>
		public TrendlineSeriesAccessibility Accessibility { get; set; }
		private TrendlineSeriesAccessibility Accessibility_DefaultValue { get; set; }
		...
		/// </summary>
		public TrendlineSeriesBoostBlending BoostBlending { get; set; }
		private TrendlineSeriesBoostBlending BoostBlending_DefaultValue { get; set; }
		...
		/// </summary>
		public TrendlineSeriesCompare Compare { get; set; }
		private TrendlineSeriesCompare Compare_DefaultValue { get; set; }
		 

		/// <summary>
		/// When [compare](#plotOptions.series.compare) is `percent`, this optiondictates whether to use 0 or 100 as the base of comparison.
		/// </summary>
		public TrendlineSeriesCompareBase CompareBase { get; set; }
		private TrendlineSeriesCompareBase CompareBase_DefaultValue { get; set; }
		...
		/// </summary>
		public TrendlineSeriesCursor Cursor { get; set; }
		private TrendlineSeriesCursor Cursor_DefaultValue { get; set; }
		...
		/// </summary>
		public TrendlineSeriesDashStyle DashStyle { get; set; }
		private TrendlineSeriesDashStyle DashStyle_DefaultValue { get; set; }
		...
		/// </summary>
		public TrendlineSeriesDataGrouping DataGrouping { get; set; }
		private TrendlineSeriesDataGrouping DataGrouping_DefaultValue { get; set; }
		...
		/// </summary>
		public TrendlineSeriesDataLabels DataLabels { get; set; }
		private TrendlineSeriesDataLabels DataLabels_DefaultValue { get; set; }
		 

		/// <summary>
		/// Options for the series data sorting.
		/// </summary>
		public TrendlineSeriesDataSorting DataSorting { get; set; }
		private TrendlineSeriesDataSorting DataSorting_DefaultValue { get; set; }
		...
		/// 
		/// </summary>
		public TrendlineSeriesDumbell Dumbell { get; set; }
		private TrendlineSeriesDumbell Dumbell_DefaultValue { get; set; }
		...
		/// </summary>
		public TrendlineSeriesEvents Events { get; set; }
		private TrendlineSeriesEvents Events_DefaultValue { get; set; }
		...
		/// </summary>
		public TrendlineSeriesFindNearestPointBy FindNearestPointBy { get; set; }
		private TrendlineSeriesFindNearestPointBy FindNearestPointBy_DefaultValue { get; set; }
		...
		/// </summary>
		public TrendlineSeriesGapUnit GapUnit { get; set; }
		private TrendlineSeriesGapUnit GapUnit_DefaultValue { get; set; }
		...
		/// </summary>
		public TrendlineSeriesLabel Label { get; set; }
		private TrendlineSeriesLabel Label_DefaultValue { get; set; }
		 

		/// <summary>
		/// The line marks the last price from all points.
		/// </summary>
		public TrendlineSeriesLastPrice LastPrice { get; set; }
		private TrendlineSeriesLastPrice LastPrice_DefaultValue { get; set; }
		 

		/// <summary>
		/// The line marks the last price from visible range of points.
		/// </summary>
		public TrendlineSeriesLastVisiblePrice LastVisiblePrice { get; set; }
		private TrendlineSeriesLastVisiblePrice LastVisiblePrice_DefaultValue { get; set; }
		...
		/// </summary>
		public TrendlineSeriesLegendSymbol LegendSymbol { get; set; }
		private TrendlineSeriesLegendSymbol LegendSymbol_DefaultValue { get; set; }
		 

		/// <summary>
		/// The line cap used for line ends and line joins on the graph.
		/// </summary>
		public TrendlineSeriesLinecap Linecap { get; set; }
		private TrendlineSeriesLinecap Linecap_DefaultValue { get; set; }
		...
		/// </summary>
		public TrendlineSeriesMarker Marker { get; set; }
		private TrendlineSeriesMarker Marker_DefaultValue { get; set; }
		...
		/// </summary>
		public TrendlineSeriesOnPoint OnPoint { get; set; }
		private TrendlineSeriesOnPoint OnPoint_DefaultValue { get; set; }
		...
		/// </summary>
		public TrendlineSeriesParams Params { get; set; }
		private TrendlineSeriesParams Params_DefaultValue { get; set; }
		 

		/// <summary>
		/// Properties for each single point.
		/// </summary>
		public TrendlineSeriesPoint Point { get; set; }
		private TrendlineSeriesPoint Point_DefaultValue { get; set; }
		...
		/// </summary>
		public TrendlineSeriesSonification Sonification { get; set; }
		private TrendlineSeriesSonification Sonification_DefaultValue { get; set; }
		...
		/// 
		/// </summary>
		public TrendlineSeriesStates States { get; set; }
		private TrendlineSeriesStates States_DefaultValue { get; set; }
		 

		/// <summary>
		/// Whether to apply steps to the line. Possible values are `left`,`center` and `right`.
		/// </summary>
		public TrendlineSeriesStep Step { get; set; }
		private TrendlineSeriesStep Step_DefaultValue { get; set; }
		...
		/// </summary>
		public TrendlineSeriesTooltip Tooltip { get; set; }
		private TrendlineSeriesTooltip Tooltip_DefaultValue { get; set; }
		...
		/// </summary>
		public List<TrendlineSeriesZones> Zones { get; set; }
		private List<TrendlineSeriesZones> Zones_DefaultValue { get; set; }
