...
namespace Highsoft.Web.Mvc.Stocks
{
	public partial class TrendlineSeries  : Series
	{
		public TrendlineSeries()
		{
			...
			DragDrop = DragDrop_DefaultValue = new TrendlineSeriesDragDrop();
		...
		/// </summary>
		public TrendlineSeriesDragDrop DragDrop { get; set; }
		private TrendlineSeriesDragDrop DragDrop_DefaultValue { get; set; }
