...
namespace Highsoft.Web.Mvc.Stocks
{
	public partial class TrendlineSeries  : Series
	{
		...
		public TrendlineSeries()
		{
			...
			Zones = Zones_DefaultValue = new List<TrendlineSeriesZone>();
		...
		/// </summary>
		public List<TrendlineSeriesZone> Zones { get; set; }
		private List<TrendlineSeriesZone> Zones_DefaultValue { get; set; }
