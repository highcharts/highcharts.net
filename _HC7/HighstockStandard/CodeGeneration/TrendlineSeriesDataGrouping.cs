...
{
	public partial class TrendlineSeriesDataGrouping  : BaseObject
	{
		public TrendlineSeriesDataGrouping()
		{
		...
		internal override Hashtable ToHashtable()
		{
			...
			if (Approximation != Approximation_DefaultValue) { h.Add("approximation",Approximation); Highstock.AddFunction("TrendlineSeriesDataGroupingApproximation.approximation", Approximation); }  
