...
{
	public partial class TrendlineSeriesDragDrop  : BaseObject
	{
		public TrendlineSeriesDragDrop()
		{
			DraggableX = DraggableX_DefaultValue = null;
			DraggableY = DraggableY_DefaultValue = null;
			DragHandle = DragHandle_DefaultValue = new TrendlineSeriesDragDropDragHandle();
			...
			GuideBox = GuideBox_DefaultValue = new TrendlineSeriesDragDropGuideBox();
		...
		/// </summary>
		public TrendlineSeriesDragDropDragHandle DragHandle { get; set; }
		private TrendlineSeriesDragDropDragHandle DragHandle_DefaultValue { get; set; }
		...
		/// </summary>
		public TrendlineSeriesDragDropGuideBox GuideBox { get; set; }
		private TrendlineSeriesDragDropGuideBox GuideBox_DefaultValue { get; set; }
