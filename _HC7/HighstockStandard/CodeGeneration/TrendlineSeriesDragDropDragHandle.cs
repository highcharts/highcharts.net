...
{
	public partial class TrendlineSeriesDragDropDragHandle  : BaseObject
	{
		public TrendlineSeriesDragDropDragHandle()
		{
		...
		internal override Hashtable ToHashtable()
		{
			...
			if (PathFormatter != PathFormatter_DefaultValue) { h.Add("pathFormatter",PathFormatter); Highstock.AddFunction("TrendlineSeriesDragDropDragHandlePathFormatter.pathFormatter", PathFormatter); }  
