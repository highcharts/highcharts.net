...
{
	public partial class TrendlineSeriesOnPoint  : BaseObject
	{
		Hashtable h = new Hashtable();

		public TrendlineSeriesOnPoint()
		{
			ConnectorOptions = ConnectorOptions_DefaultValue = new TrendlineSeriesOnPointConnectorOptions();
			Id = Id_DefaultValue = "";
			Position = Position_DefaultValue = new TrendlineSeriesOnPointPosition();
		...
		/// </summary>
		public TrendlineSeriesOnPointConnectorOptions ConnectorOptions { get; set; }
		private TrendlineSeriesOnPointConnectorOptions ConnectorOptions_DefaultValue { get; set; }
		...
		/// </summary>
		public TrendlineSeriesOnPointPosition Position { get; set; }
		private TrendlineSeriesOnPointPosition Position_DefaultValue { get; set; }
