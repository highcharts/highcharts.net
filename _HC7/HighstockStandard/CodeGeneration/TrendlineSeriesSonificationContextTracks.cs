...
{
	public partial class TrendlineSeriesSonificationContextTracks  : BaseObject
	{
		Hashtable h = new Hashtable();

		public TrendlineSeriesSonificationContextTracks()
		{
			ActiveWhen = ActiveWhen_DefaultValue = new TrendlineSeriesSonificationContextTracksActiveWhen();
			Instrument = Instrument_DefaultValue = null;
			InstrumentString = InstrumentString_DefaultValue = "null";
			Mapping = Mapping_DefaultValue = new TrendlineSeriesSonificationContextTracksMapping();
			MidiName = MidiName_DefaultValue = "";
			PointGrouping = PointGrouping_DefaultValue = new TrendlineSeriesSonificationContextTracksPointGrouping();
			...
			Type = Type_DefaultValue = TrendlineSeriesSonificationContextTracksType.Instrument;
			ValueInterval = ValueInterval_DefaultValue = null;
			ValueMapFunction = ValueMapFunction_DefaultValue = TrendlineSeriesSonificationContextTracksValueMapFunction.Linear;
		...
		/// </summary>
		public TrendlineSeriesSonificationContextTracksActiveWhen ActiveWhen { get; set; }
		private TrendlineSeriesSonificationContextTracksActiveWhen ActiveWhen_DefaultValue { get; set; }
		...
		/// </summary>
		public TrendlineSeriesSonificationContextTracksMapping Mapping { get; set; }
		private TrendlineSeriesSonificationContextTracksMapping Mapping_DefaultValue { get; set; }
		...
		/// </summary>
		public TrendlineSeriesSonificationContextTracksPointGrouping PointGrouping { get; set; }
		private TrendlineSeriesSonificationContextTracksPointGrouping PointGrouping_DefaultValue { get; set; }
		...
		/// </summary>
		public TrendlineSeriesSonificationContextTracksType Type { get; set; }
		private TrendlineSeriesSonificationContextTracksType Type_DefaultValue { get; set; }
		...
		/// </summary>
		public TrendlineSeriesSonificationContextTracksValueMapFunction ValueMapFunction { get; set; }
		private TrendlineSeriesSonificationContextTracksValueMapFunction ValueMapFunction_DefaultValue { get; set; }
