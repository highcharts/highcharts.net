...
{
	public partial class TrendlineSeriesSonificationContextTracksMappingLowpassResonance  : BaseObject
	{
		Hashtable h = new Hashtable();

		public TrendlineSeriesSonificationContextTracksMappingLowpassResonance()
		{
			MapFunction = MapFunction_DefaultValue = TrendlineSeriesSonificationContextTracksMappingLowpassResonanceMapFunction.Linear;
			MapTo = MapTo_DefaultValue = "";
			Max = Max_DefaultValue = null;
			Min = Min_DefaultValue = null;
			Value = Value_DefaultValue = null;
			Within = Within_DefaultValue = TrendlineSeriesSonificationContextTracksMappingLowpassResonanceWithin.Chart;
		...
		/// </summary>
		public TrendlineSeriesSonificationContextTracksMappingLowpassResonanceMapFunction MapFunction { get; set; }
		private TrendlineSeriesSonificationContextTracksMappingLowpassResonanceMapFunction MapFunction_DefaultValue { get; set; }
		...
		/// </summary>
		public TrendlineSeriesSonificationContextTracksMappingLowpassResonanceWithin Within { get; set; }
		private TrendlineSeriesSonificationContextTracksMappingLowpassResonanceWithin Within_DefaultValue { get; set; }
