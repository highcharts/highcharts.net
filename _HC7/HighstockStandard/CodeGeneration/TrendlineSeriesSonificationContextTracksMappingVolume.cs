...
{
	public partial class TrendlineSeriesSonificationContextTracksMappingVolume  : BaseObject
	{
		Hashtable h = new Hashtable();

		public TrendlineSeriesSonificationContextTracksMappingVolume()
		{
			MapFunction = MapFunction_DefaultValue = TrendlineSeriesSonificationContextTracksMappingVolumeMapFunction.Linear;
			MapTo = MapTo_DefaultValue = "";
			Max = Max_DefaultValue = null;
			Min = Min_DefaultValue = null;
			Value = Value_DefaultValue = null;
			Within = Within_DefaultValue = TrendlineSeriesSonificationContextTracksMappingVolumeWithin.Chart;
		...
		/// </summary>
		public TrendlineSeriesSonificationContextTracksMappingVolumeMapFunction MapFunction { get; set; }
		private TrendlineSeriesSonificationContextTracksMappingVolumeMapFunction MapFunction_DefaultValue { get; set; }
		...
		/// </summary>
		public TrendlineSeriesSonificationContextTracksMappingVolumeWithin Within { get; set; }
		private TrendlineSeriesSonificationContextTracksMappingVolumeWithin Within_DefaultValue { get; set; }
