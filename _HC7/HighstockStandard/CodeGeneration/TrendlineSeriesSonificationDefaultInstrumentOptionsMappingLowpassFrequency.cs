...
{
	public partial class TrendlineSeriesSonificationDefaultInstrumentOptionsMappingLowpassFrequency  : BaseObject
	{
		Hashtable h = new Hashtable();

		public TrendlineSeriesSonificationDefaultInstrumentOptionsMappingLowpassFrequency()
		{
			MapFunction = MapFunction_DefaultValue = TrendlineSeriesSonificationDefaultInstrumentOptionsMappingLowpassFrequencyMapFunction.Linear;
			MapTo = MapTo_DefaultValue = "";
			Max = Max_DefaultValue = null;
			Min = Min_DefaultValue = null;
			Value = Value_DefaultValue = null;
			Within = Within_DefaultValue = TrendlineSeriesSonificationDefaultInstrumentOptionsMappingLowpassFrequencyWithin.Chart;
		...
		/// </summary>
		public TrendlineSeriesSonificationDefaultInstrumentOptionsMappingLowpassFrequencyMapFunction MapFunction { get; set; }
		private TrendlineSeriesSonificationDefaultInstrumentOptionsMappingLowpassFrequencyMapFunction MapFunction_DefaultValue { get; set; }
		...
		/// </summary>
		public TrendlineSeriesSonificationDefaultInstrumentOptionsMappingLowpassFrequencyWithin Within { get; set; }
		private TrendlineSeriesSonificationDefaultInstrumentOptionsMappingLowpassFrequencyWithin Within_DefaultValue { get; set; }
