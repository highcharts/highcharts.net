...
{
	public partial class TrendlineSeriesSonificationDefaultSpeechOptionsMappingTime  : BaseObject
	{
		Hashtable h = new Hashtable();

		public TrendlineSeriesSonificationDefaultSpeechOptionsMappingTime()
		{
			MapFunction = MapFunction_DefaultValue = TrendlineSeriesSonificationDefaultSpeechOptionsMappingTimeMapFunction.Linear;
			MapTo = MapTo_DefaultValue = "";
			Max = Max_DefaultValue = null;
			Min = Min_DefaultValue = null;
			Value = Value_DefaultValue = null;
			Within = Within_DefaultValue = TrendlineSeriesSonificationDefaultSpeechOptionsMappingTimeWithin.Chart;
		...
		/// </summary>
		public TrendlineSeriesSonificationDefaultSpeechOptionsMappingTimeMapFunction MapFunction { get; set; }
		private TrendlineSeriesSonificationDefaultSpeechOptionsMappingTimeMapFunction MapFunction_DefaultValue { get; set; }
		...
		/// </summary>
		public TrendlineSeriesSonificationDefaultSpeechOptionsMappingTimeWithin Within { get; set; }
		private TrendlineSeriesSonificationDefaultSpeechOptionsMappingTimeWithin Within_DefaultValue { get; set; }
