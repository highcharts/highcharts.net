...
{
	public partial class TrendlineSeriesSonificationTracks  : BaseObject
	{
		Hashtable h = new Hashtable();

		public TrendlineSeriesSonificationTracks()
		{
			ActiveWhen = ActiveWhen_DefaultValue = new TrendlineSeriesSonificationTracksActiveWhen();
			Instrument = Instrument_DefaultValue = null;
			InstrumentString = InstrumentString_DefaultValue = "null";
			Mapping = Mapping_DefaultValue = new TrendlineSeriesSonificationTracksMapping();
			MidiName = MidiName_DefaultValue = "";
			PointGrouping = PointGrouping_DefaultValue = new TrendlineSeriesSonificationTracksPointGrouping();
			RoundToMusicalNotes = RoundToMusicalNotes_DefaultValue = true;
			ShowPlayMarker = ShowPlayMarker_DefaultValue = true;
			Type = Type_DefaultValue = TrendlineSeriesSonificationTracksType.Instrument;
		...
		/// </summary>
		public TrendlineSeriesSonificationTracksActiveWhen ActiveWhen { get; set; }
		private TrendlineSeriesSonificationTracksActiveWhen ActiveWhen_DefaultValue { get; set; }
		...
		/// </summary>
		public TrendlineSeriesSonificationTracksMapping Mapping { get; set; }
		private TrendlineSeriesSonificationTracksMapping Mapping_DefaultValue { get; set; }
		...
		/// </summary>
		public TrendlineSeriesSonificationTracksPointGrouping PointGrouping { get; set; }
		private TrendlineSeriesSonificationTracksPointGrouping PointGrouping_DefaultValue { get; set; }
		...
		/// </summary>
		public TrendlineSeriesSonificationTracksType Type { get; set; }
		private TrendlineSeriesSonificationTracksType Type_DefaultValue { get; set; }
