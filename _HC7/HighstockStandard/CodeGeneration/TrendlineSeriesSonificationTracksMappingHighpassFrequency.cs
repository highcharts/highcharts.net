...
{
	public partial class TrendlineSeriesSonificationTracksMappingHighpassFrequency  : BaseObject
	{
		Hashtable h = new Hashtable();

		public TrendlineSeriesSonificationTracksMappingHighpassFrequency()
		{
			MapFunction = MapFunction_DefaultValue = TrendlineSeriesSonificationTracksMappingHighpassFrequencyMapFunction.Linear;
			MapTo = MapTo_DefaultValue = "";
			Max = Max_DefaultValue = null;
			Min = Min_DefaultValue = null;
			Value = Value_DefaultValue = null;
			Within = Within_DefaultValue = TrendlineSeriesSonificationTracksMappingHighpassFrequencyWithin.Chart;
		...
		/// </summary>
		public TrendlineSeriesSonificationTracksMappingHighpassFrequencyMapFunction MapFunction { get; set; }
		private TrendlineSeriesSonificationTracksMappingHighpassFrequencyMapFunction MapFunction_DefaultValue { get; set; }
		...
		/// </summary>
		public TrendlineSeriesSonificationTracksMappingHighpassFrequencyWithin Within { get; set; }
		private TrendlineSeriesSonificationTracksMappingHighpassFrequencyWithin Within_DefaultValue { get; set; }
