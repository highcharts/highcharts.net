...
{
	public partial class TrendlineSeriesSonificationTracksMappingTime  : BaseObject
	{
		Hashtable h = new Hashtable();

		public TrendlineSeriesSonificationTracksMappingTime()
		{
			MapFunction = MapFunction_DefaultValue = TrendlineSeriesSonificationTracksMappingTimeMapFunction.Linear;
			MapTo = MapTo_DefaultValue = "";
			Max = Max_DefaultValue = null;
			Min = Min_DefaultValue = null;
			Value = Value_DefaultValue = null;
			Within = Within_DefaultValue = TrendlineSeriesSonificationTracksMappingTimeWithin.Chart;
		...
		/// </summary>
		public TrendlineSeriesSonificationTracksMappingTimeMapFunction MapFunction { get; set; }
		private TrendlineSeriesSonificationTracksMappingTimeMapFunction MapFunction_DefaultValue { get; set; }
		...
		/// </summary>
		public TrendlineSeriesSonificationTracksMappingTimeWithin Within { get; set; }
		private TrendlineSeriesSonificationTracksMappingTimeWithin Within_DefaultValue { get; set; }
