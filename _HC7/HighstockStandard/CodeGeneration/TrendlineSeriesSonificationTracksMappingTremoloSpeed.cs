...
{
	public partial class TrendlineSeriesSonificationTracksMappingTremoloSpeed  : BaseObject
	{
		Hashtable h = new Hashtable();

		public TrendlineSeriesSonificationTracksMappingTremoloSpeed()
		{
			MapFunction = MapFunction_DefaultValue = TrendlineSeriesSonificationTracksMappingTremoloSpeedMapFunction.Linear;
			MapTo = MapTo_DefaultValue = "";
			Max = Max_DefaultValue = null;
			Min = Min_DefaultValue = null;
			Value = Value_DefaultValue = null;
			Within = Within_DefaultValue = TrendlineSeriesSonificationTracksMappingTremoloSpeedWithin.Chart;
		...
		/// </summary>
		public TrendlineSeriesSonificationTracksMappingTremoloSpeedMapFunction MapFunction { get; set; }
		private TrendlineSeriesSonificationTracksMappingTremoloSpeedMapFunction MapFunction_DefaultValue { get; set; }
		...
		/// </summary>
		public TrendlineSeriesSonificationTracksMappingTremoloSpeedWithin Within { get; set; }
		private TrendlineSeriesSonificationTracksMappingTremoloSpeedWithin Within_DefaultValue { get; set; }
