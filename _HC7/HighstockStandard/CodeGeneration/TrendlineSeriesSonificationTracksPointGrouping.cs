...
{
	public partial class TrendlineSeriesSonificationTracksPointGrouping  : BaseObject
	{
		Hashtable h = new Hashtable();

		public TrendlineSeriesSonificationTracksPointGrouping()
		{
			Algorithm = Algorithm_DefaultValue = TrendlineSeriesSonificationTracksPointGroupingAlgorithm.Minimax;
		...
		/// </summary>
		public TrendlineSeriesSonificationTracksPointGroupingAlgorithm Algorithm { get; set; }
		private TrendlineSeriesSonificationTracksPointGroupingAlgorithm Algorithm_DefaultValue { get; set; }
