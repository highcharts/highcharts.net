...
namespace Highsoft.Web.Mvc.Stocks
{
	public partial class TrixSeries  : Series
	{
		public TrixSeries()
		{
			...
			DragDrop = DragDrop_DefaultValue = new TrixSeriesDragDrop();
		...
		/// </summary>
		public TrixSeriesDragDrop DragDrop { get; set; }
		private TrixSeriesDragDrop DragDrop_DefaultValue { get; set; }
