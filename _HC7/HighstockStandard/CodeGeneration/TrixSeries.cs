...
{
	public partial class TrixSeries  : Series
	{
		Hashtable h = new Hashtable();

		public TrixSeries()
		{
			Accessibility = Accessibility_DefaultValue = new TrixSeriesAccessibility();
			AllowPointSelect = AllowPointSelect_DefaultValue = false;
			Animation = Animation_DefaultValue = new Animation() { Enabled = true };
			AnimationBool = AnimationBool_DefaultValue = true;
			AnimationLimit = AnimationLimit_DefaultValue = null;
			BoostBlending = BoostBlending_DefaultValue = TrixSeriesBoostBlending.Undefined;
			...
			Cursor = Cursor_DefaultValue = TrixSeriesCursor.Null;
			Custom = Custom_DefaultValue = new Hashtable();
			DashStyle = DashStyle_DefaultValue = TrixSeriesDashStyle.Null;
			DataGrouping = DataGrouping_DefaultValue = new TrixSeriesDataGrouping();
			DataLabels = DataLabels_DefaultValue = new TrixSeriesDataLabels();
			DataSorting = DataSorting_DefaultValue = new TrixSeriesDataSorting();
			Description = Description_DefaultValue = "";
			Dumbell = Dumbell_DefaultValue = new TrixSeriesDumbell();
			EnableMouseTracking = EnableMouseTracking_DefaultValue = true;
			Events = Events_DefaultValue = new TrixSeriesEvents();
			FindNearestPointBy = FindNearestPointBy_DefaultValue = TrixSeriesFindNearestPointBy.X;
			GapSize = GapSize_DefaultValue = 0;
			GapUnit = GapUnit_DefaultValue = TrixSeriesGapUnit.Relative;
			GetExtremesFromAll = GetExtremesFromAll_DefaultValue = false;
			Id = Id_DefaultValue = "";
			InactiveOtherPoints = InactiveOtherPoints_DefaultValue = false;
			IncludeInDataExport = IncludeInDataExport_DefaultValue = null;
			Index = Index_DefaultValue = null;
			Label = Label_DefaultValue = new TrixSeriesLabel();
			LastPrice = LastPrice_DefaultValue = new TrixSeriesLastPrice();
			LastVisiblePrice = LastVisiblePrice_DefaultValue = new TrixSeriesLastVisiblePrice();
			LegendIndex = LegendIndex_DefaultValue = null;
			LegendSymbol = LegendSymbol_DefaultValue = TrixSeriesLegendSymbol.Rectangle;
			Linecap = Linecap_DefaultValue = TrixSeriesLinecap.Round;
			LineWidth = LineWidth_DefaultValue = 2;
			LinkedTo = LinkedTo_DefaultValue = "";
			Marker = Marker_DefaultValue = new TrixSeriesMarker();
			Name = Name_DefaultValue = "";
			NegativeColor = NegativeColor_DefaultValue = "";
			OnPoint = OnPoint_DefaultValue = new TrixSeriesOnPoint();
			Opacity = Opacity_DefaultValue = 1;
			Params = Params_DefaultValue = new TrixSeriesParams();
			Point = Point_DefaultValue = new TrixSeriesPoint();
			...
			Sonification = Sonification_DefaultValue = new TrixSeriesSonification();
			Stack = Stack_DefaultValue = "";
			StackNumber = StackNumber_DefaultValue = null;
			States = States_DefaultValue = new TrixSeriesStates();
			Step = Step_DefaultValue = TrixSeriesStep.Null;
			StickyTracking = StickyTracking_DefaultValue = true;
			Threshold = Threshold_DefaultValue = 0;
			Tooltip = Tooltip_DefaultValue = new TrixSeriesTooltip();
			...
			Zones = Zones_DefaultValue = new List<TrixSeriesZones>();
		...
		/// </summary>
		public TrixSeriesAccessibility Accessibility { get; set; }
		private TrixSeriesAccessibility Accessibility_DefaultValue { get; set; }
		...
		/// </summary>
		public TrixSeriesBoostBlending BoostBlending { get; set; }
		private TrixSeriesBoostBlending BoostBlending_DefaultValue { get; set; }
		...
		/// </summary>
		public TrixSeriesCursor Cursor { get; set; }
		private TrixSeriesCursor Cursor_DefaultValue { get; set; }
		...
		/// </summary>
		public TrixSeriesDashStyle DashStyle { get; set; }
		private TrixSeriesDashStyle DashStyle_DefaultValue { get; set; }
		...
		/// </summary>
		public TrixSeriesDataGrouping DataGrouping { get; set; }
		private TrixSeriesDataGrouping DataGrouping_DefaultValue { get; set; }
		...
		/// </summary>
		public TrixSeriesDataLabels DataLabels { get; set; }
		private TrixSeriesDataLabels DataLabels_DefaultValue { get; set; }
		 

		/// <summary>
		/// Options for the series data sorting.
		/// </summary>
		public TrixSeriesDataSorting DataSorting { get; set; }
		private TrixSeriesDataSorting DataSorting_DefaultValue { get; set; }
		...
		/// 
		/// </summary>
		public TrixSeriesDumbell Dumbell { get; set; }
		private TrixSeriesDumbell Dumbell_DefaultValue { get; set; }
		...
		/// </summary>
		public TrixSeriesEvents Events { get; set; }
		private TrixSeriesEvents Events_DefaultValue { get; set; }
		...
		/// </summary>
		public TrixSeriesFindNearestPointBy FindNearestPointBy { get; set; }
		private TrixSeriesFindNearestPointBy FindNearestPointBy_DefaultValue { get; set; }
		...
		/// </summary>
		public TrixSeriesGapUnit GapUnit { get; set; }
		private TrixSeriesGapUnit GapUnit_DefaultValue { get; set; }
		...
		/// </summary>
		public TrixSeriesLabel Label { get; set; }
		private TrixSeriesLabel Label_DefaultValue { get; set; }
		 

		/// <summary>
		/// The line marks the last price from all points.
		/// </summary>
		public TrixSeriesLastPrice LastPrice { get; set; }
		private TrixSeriesLastPrice LastPrice_DefaultValue { get; set; }
		 

		/// <summary>
		/// The line marks the last price from visible range of points.
		/// </summary>
		public TrixSeriesLastVisiblePrice LastVisiblePrice { get; set; }
		private TrixSeriesLastVisiblePrice LastVisiblePrice_DefaultValue { get; set; }
		...
		/// </summary>
		public TrixSeriesLegendSymbol LegendSymbol { get; set; }
		private TrixSeriesLegendSymbol LegendSymbol_DefaultValue { get; set; }
		 

		/// <summary>
		/// The line cap used for line ends and line joins on the graph.
		/// </summary>
		public TrixSeriesLinecap Linecap { get; set; }
		private TrixSeriesLinecap Linecap_DefaultValue { get; set; }
		...
		/// </summary>
		public TrixSeriesMarker Marker { get; set; }
		private TrixSeriesMarker Marker_DefaultValue { get; set; }
		...
		/// </summary>
		public TrixSeriesOnPoint OnPoint { get; set; }
		private TrixSeriesOnPoint OnPoint_DefaultValue { get; set; }
		...
		/// </summary>
		public TrixSeriesParams Params { get; set; }
		private TrixSeriesParams Params_DefaultValue { get; set; }
		 

		/// <summary>
		/// Properties for each single point.
		/// </summary>
		public TrixSeriesPoint Point { get; set; }
		private TrixSeriesPoint Point_DefaultValue { get; set; }
		...
		/// </summary>
		public TrixSeriesSonification Sonification { get; set; }
		private TrixSeriesSonification Sonification_DefaultValue { get; set; }
		...
		/// 
		/// </summary>
		public TrixSeriesStates States { get; set; }
		private TrixSeriesStates States_DefaultValue { get; set; }
		 

		/// <summary>
		/// Whether to apply steps to the line. Possible values are `left`,`center` and `right`.
		/// </summary>
		public TrixSeriesStep Step { get; set; }
		private TrixSeriesStep Step_DefaultValue { get; set; }
		...
		/// </summary>
		public TrixSeriesTooltip Tooltip { get; set; }
		private TrixSeriesTooltip Tooltip_DefaultValue { get; set; }
		...
		/// </summary>
		public List<TrixSeriesZones> Zones { get; set; }
		private List<TrixSeriesZones> Zones_DefaultValue { get; set; }
