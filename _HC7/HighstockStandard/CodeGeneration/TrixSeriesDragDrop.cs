...
{
	public partial class TrixSeriesDragDrop  : BaseObject
	{
		public TrixSeriesDragDrop()
		{
			DraggableX = DraggableX_DefaultValue = null;
			DraggableY = DraggableY_DefaultValue = null;
			DragHandle = DragHandle_DefaultValue = new TrixSeriesDragDropDragHandle();
			...
			GuideBox = GuideBox_DefaultValue = new TrixSeriesDragDropGuideBox();
		...
		/// </summary>
		public TrixSeriesDragDropDragHandle DragHandle { get; set; }
		private TrixSeriesDragDropDragHandle DragHandle_DefaultValue { get; set; }
		...
		/// </summary>
		public TrixSeriesDragDropGuideBox GuideBox { get; set; }
		private TrixSeriesDragDropGuideBox GuideBox_DefaultValue { get; set; }
