...
{
	public partial class TrixSeriesDragDropDragHandle  : BaseObject
	{
		public TrixSeriesDragDropDragHandle()
		{
		...
		internal override Hashtable ToHashtable()
		{
			...
			if (PathFormatter != PathFormatter_DefaultValue) { h.Add("pathFormatter",PathFormatter); Highstock.AddFunction("TrixSeriesDragDropDragHandlePathFormatter.pathFormatter", PathFormatter); }  
