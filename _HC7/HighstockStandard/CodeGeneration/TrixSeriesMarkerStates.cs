...
namespace Highsoft.Web.Mvc.Stocks
{
	public partial class TrixSeriesMarkerStates  : BaseObject
	{
		public TrixSeriesMarkerStates()
		{
			...
			Inactive = Inactive_DefaultValue = new TrixSeriesMarkerStatesInactive();
		...
		/// 
		/// </summary>
		public TrixSeriesMarkerStatesInactive Inactive { get; set; }
		private TrixSeriesMarkerStatesInactive Inactive_DefaultValue { get; set; }
