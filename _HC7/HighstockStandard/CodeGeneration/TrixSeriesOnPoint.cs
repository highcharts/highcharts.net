...
{
	public partial class TrixSeriesOnPoint  : BaseObject
	{
		Hashtable h = new Hashtable();

		public TrixSeriesOnPoint()
		{
			ConnectorOptions = ConnectorOptions_DefaultValue = new TrixSeriesOnPointConnectorOptions();
			Id = Id_DefaultValue = "";
			Position = Position_DefaultValue = new TrixSeriesOnPointPosition();
		...
		/// </summary>
		public TrixSeriesOnPointConnectorOptions ConnectorOptions { get; set; }
		private TrixSeriesOnPointConnectorOptions ConnectorOptions_DefaultValue { get; set; }
		...
		/// </summary>
		public TrixSeriesOnPointPosition Position { get; set; }
		private TrixSeriesOnPointPosition Position_DefaultValue { get; set; }
