...
{
	public partial class TrixSeriesSonificationContextTracks  : BaseObject
	{
		Hashtable h = new Hashtable();

		public TrixSeriesSonificationContextTracks()
		{
			ActiveWhen = ActiveWhen_DefaultValue = new TrixSeriesSonificationContextTracksActiveWhen();
			Instrument = Instrument_DefaultValue = null;
			InstrumentString = InstrumentString_DefaultValue = "null";
			Mapping = Mapping_DefaultValue = new TrixSeriesSonificationContextTracksMapping();
			MidiName = MidiName_DefaultValue = "";
			PointGrouping = PointGrouping_DefaultValue = new TrixSeriesSonificationContextTracksPointGrouping();
			...
			Type = Type_DefaultValue = TrixSeriesSonificationContextTracksType.Instrument;
			ValueInterval = ValueInterval_DefaultValue = null;
			ValueMapFunction = ValueMapFunction_DefaultValue = TrixSeriesSonificationContextTracksValueMapFunction.Linear;
		...
		/// </summary>
		public TrixSeriesSonificationContextTracksActiveWhen ActiveWhen { get; set; }
		private TrixSeriesSonificationContextTracksActiveWhen ActiveWhen_DefaultValue { get; set; }
		...
		/// </summary>
		public TrixSeriesSonificationContextTracksMapping Mapping { get; set; }
		private TrixSeriesSonificationContextTracksMapping Mapping_DefaultValue { get; set; }
		...
		/// </summary>
		public TrixSeriesSonificationContextTracksPointGrouping PointGrouping { get; set; }
		private TrixSeriesSonificationContextTracksPointGrouping PointGrouping_DefaultValue { get; set; }
		...
		/// </summary>
		public TrixSeriesSonificationContextTracksType Type { get; set; }
		private TrixSeriesSonificationContextTracksType Type_DefaultValue { get; set; }
		...
		/// </summary>
		public TrixSeriesSonificationContextTracksValueMapFunction ValueMapFunction { get; set; }
		private TrixSeriesSonificationContextTracksValueMapFunction ValueMapFunction_DefaultValue { get; set; }
