...
{
	public partial class TrixSeriesSonificationContextTracksMapping  : BaseObject
	{
		Hashtable h = new Hashtable();

		public TrixSeriesSonificationContextTracksMapping()
		{
			Frequency = Frequency_DefaultValue = new TrixSeriesSonificationContextTracksMappingFrequency();
			GapBetweenNotes = GapBetweenNotes_DefaultValue = new TrixSeriesSonificationContextTracksMappingGapBetweenNotes();
			Highpass = Highpass_DefaultValue = new TrixSeriesSonificationContextTracksMappingHighpass();
			Lowpass = Lowpass_DefaultValue = new TrixSeriesSonificationContextTracksMappingLowpass();
			NoteDuration = NoteDuration_DefaultValue = new TrixSeriesSonificationContextTracksMappingNoteDuration();
			Pan = Pan_DefaultValue = new TrixSeriesSonificationContextTracksMappingPan();
			Pitch = Pitch_DefaultValue = new TrixSeriesSonificationContextTracksMappingPitch();
			PitchString = PitchString_DefaultValue = "null";
			PitchNumber = PitchNumber_DefaultValue = null;
			PlayDelay = PlayDelay_DefaultValue = new TrixSeriesSonificationContextTracksMappingPlayDelay();
			Time = Time_DefaultValue = new TrixSeriesSonificationContextTracksMappingTime();
			TimeString = TimeString_DefaultValue = "null";
			TimeNumber = TimeNumber_DefaultValue = null;
			Tremolo = Tremolo_DefaultValue = new TrixSeriesSonificationContextTracksMappingTremolo();
			Volume = Volume_DefaultValue = new TrixSeriesSonificationContextTracksMappingVolume();
		...
		/// </summary>
		public TrixSeriesSonificationContextTracksMappingFrequency Frequency { get; set; }
		private TrixSeriesSonificationContextTracksMappingFrequency Frequency_DefaultValue { get; set; }
		...
		/// </summary>
		public TrixSeriesSonificationContextTracksMappingGapBetweenNotes GapBetweenNotes { get; set; }
		private TrixSeriesSonificationContextTracksMappingGapBetweenNotes GapBetweenNotes_DefaultValue { get; set; }
		...
		/// </summary>
		public TrixSeriesSonificationContextTracksMappingHighpass Highpass { get; set; }
		private TrixSeriesSonificationContextTracksMappingHighpass Highpass_DefaultValue { get; set; }
		...
		/// </summary>
		public TrixSeriesSonificationContextTracksMappingLowpass Lowpass { get; set; }
		private TrixSeriesSonificationContextTracksMappingLowpass Lowpass_DefaultValue { get; set; }
		...
		/// </summary>
		public TrixSeriesSonificationContextTracksMappingNoteDuration NoteDuration { get; set; }
		private TrixSeriesSonificationContextTracksMappingNoteDuration NoteDuration_DefaultValue { get; set; }
		...
		/// </summary>
		public TrixSeriesSonificationContextTracksMappingPan Pan { get; set; }
		private TrixSeriesSonificationContextTracksMappingPan Pan_DefaultValue { get; set; }
		...
		/// </summary>
		public TrixSeriesSonificationContextTracksMappingPitch Pitch { get; set; }
		private TrixSeriesSonificationContextTracksMappingPitch Pitch_DefaultValue { get; set; }
		...
		/// </summary>
		public TrixSeriesSonificationContextTracksMappingPlayDelay PlayDelay { get; set; }
		private TrixSeriesSonificationContextTracksMappingPlayDelay PlayDelay_DefaultValue { get; set; }
		...
		/// </summary>
		public TrixSeriesSonificationContextTracksMappingTime Time { get; set; }
		private TrixSeriesSonificationContextTracksMappingTime Time_DefaultValue { get; set; }
		...
		/// </summary>
		public TrixSeriesSonificationContextTracksMappingTremolo Tremolo { get; set; }
		private TrixSeriesSonificationContextTracksMappingTremolo Tremolo_DefaultValue { get; set; }
		 

		/// <summary>
		/// The volume of notes, from 0 to 1.
		/// </summary>
		public TrixSeriesSonificationContextTracksMappingVolume Volume { get; set; }
		private TrixSeriesSonificationContextTracksMappingVolume Volume_DefaultValue { get; set; }
