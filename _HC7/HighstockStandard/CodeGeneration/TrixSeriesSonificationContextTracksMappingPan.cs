...
{
	public partial class TrixSeriesSonificationContextTracksMappingPan  : BaseObject
	{
		Hashtable h = new Hashtable();

		public TrixSeriesSonificationContextTracksMappingPan()
		{
			MapFunction = MapFunction_DefaultValue = TrixSeriesSonificationContextTracksMappingPanMapFunction.Linear;
			MapTo = MapTo_DefaultValue = "";
			Max = Max_DefaultValue = null;
			Min = Min_DefaultValue = null;
			Value = Value_DefaultValue = null;
			Within = Within_DefaultValue = TrixSeriesSonificationContextTracksMappingPanWithin.Chart;
		...
		/// </summary>
		public TrixSeriesSonificationContextTracksMappingPanMapFunction MapFunction { get; set; }
		private TrixSeriesSonificationContextTracksMappingPanMapFunction MapFunction_DefaultValue { get; set; }
		...
		/// </summary>
		public TrixSeriesSonificationContextTracksMappingPanWithin Within { get; set; }
		private TrixSeriesSonificationContextTracksMappingPanWithin Within_DefaultValue { get; set; }
