...
{
	public partial class TrixSeriesSonificationContextTracksMappingPitch  : BaseObject
	{
		Hashtable h = new Hashtable();

		public TrixSeriesSonificationContextTracksMappingPitch()
		{
			MapFunction = MapFunction_DefaultValue = TrixSeriesSonificationContextTracksMappingPitchMapFunction.Linear;
		...
		/// </summary>
		public TrixSeriesSonificationContextTracksMappingPitchMapFunction MapFunction { get; set; }
		private TrixSeriesSonificationContextTracksMappingPitchMapFunction MapFunction_DefaultValue { get; set; }
