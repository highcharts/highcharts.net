...
{
	public partial class TrixSeriesSonificationContextTracksMappingPlayDelay  : BaseObject
	{
		Hashtable h = new Hashtable();

		public TrixSeriesSonificationContextTracksMappingPlayDelay()
		{
			MapFunction = MapFunction_DefaultValue = TrixSeriesSonificationContextTracksMappingPlayDelayMapFunction.Linear;
			MapTo = MapTo_DefaultValue = "";
			Max = Max_DefaultValue = null;
			Min = Min_DefaultValue = null;
			Value = Value_DefaultValue = null;
			Within = Within_DefaultValue = TrixSeriesSonificationContextTracksMappingPlayDelayWithin.Chart;
		...
		/// </summary>
		public TrixSeriesSonificationContextTracksMappingPlayDelayMapFunction MapFunction { get; set; }
		private TrixSeriesSonificationContextTracksMappingPlayDelayMapFunction MapFunction_DefaultValue { get; set; }
		...
		/// </summary>
		public TrixSeriesSonificationContextTracksMappingPlayDelayWithin Within { get; set; }
		private TrixSeriesSonificationContextTracksMappingPlayDelayWithin Within_DefaultValue { get; set; }
