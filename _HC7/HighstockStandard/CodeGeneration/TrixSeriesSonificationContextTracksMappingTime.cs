...
{
	public partial class TrixSeriesSonificationContextTracksMappingTime  : BaseObject
	{
		Hashtable h = new Hashtable();

		public TrixSeriesSonificationContextTracksMappingTime()
		{
			MapFunction = MapFunction_DefaultValue = TrixSeriesSonificationContextTracksMappingTimeMapFunction.Linear;
			MapTo = MapTo_DefaultValue = "";
			Max = Max_DefaultValue = null;
			Min = Min_DefaultValue = null;
			Value = Value_DefaultValue = null;
			Within = Within_DefaultValue = TrixSeriesSonificationContextTracksMappingTimeWithin.Chart;
		...
		/// </summary>
		public TrixSeriesSonificationContextTracksMappingTimeMapFunction MapFunction { get; set; }
		private TrixSeriesSonificationContextTracksMappingTimeMapFunction MapFunction_DefaultValue { get; set; }
		...
		/// </summary>
		public TrixSeriesSonificationContextTracksMappingTimeWithin Within { get; set; }
		private TrixSeriesSonificationContextTracksMappingTimeWithin Within_DefaultValue { get; set; }
