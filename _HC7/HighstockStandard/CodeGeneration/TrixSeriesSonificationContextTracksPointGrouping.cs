...
{
	public partial class TrixSeriesSonificationContextTracksPointGrouping  : BaseObject
	{
		Hashtable h = new Hashtable();

		public TrixSeriesSonificationContextTracksPointGrouping()
		{
			Algorithm = Algorithm_DefaultValue = TrixSeriesSonificationContextTracksPointGroupingAlgorithm.Minimax;
		...
		/// </summary>
		public TrixSeriesSonificationContextTracksPointGroupingAlgorithm Algorithm { get; set; }
		private TrixSeriesSonificationContextTracksPointGroupingAlgorithm Algorithm_DefaultValue { get; set; }
