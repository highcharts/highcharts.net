...
{
	public partial class TrixSeriesSonificationDefaultInstrumentOptionsMappingFrequency  : BaseObject
	{
		Hashtable h = new Hashtable();

		public TrixSeriesSonificationDefaultInstrumentOptionsMappingFrequency()
		{
			MapFunction = MapFunction_DefaultValue = TrixSeriesSonificationDefaultInstrumentOptionsMappingFrequencyMapFunction.Linear;
			MapTo = MapTo_DefaultValue = "";
			Max = Max_DefaultValue = null;
			Min = Min_DefaultValue = null;
			Value = Value_DefaultValue = null;
			Within = Within_DefaultValue = TrixSeriesSonificationDefaultInstrumentOptionsMappingFrequencyWithin.Chart;
		...
		/// </summary>
		public TrixSeriesSonificationDefaultInstrumentOptionsMappingFrequencyMapFunction MapFunction { get; set; }
		private TrixSeriesSonificationDefaultInstrumentOptionsMappingFrequencyMapFunction MapFunction_DefaultValue { get; set; }
		...
		/// </summary>
		public TrixSeriesSonificationDefaultInstrumentOptionsMappingFrequencyWithin Within { get; set; }
		private TrixSeriesSonificationDefaultInstrumentOptionsMappingFrequencyWithin Within_DefaultValue { get; set; }
