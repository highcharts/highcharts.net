...
{
	public partial class TrixSeriesSonificationDefaultInstrumentOptionsMappingLowpassResonance  : BaseObject
	{
		Hashtable h = new Hashtable();

		public TrixSeriesSonificationDefaultInstrumentOptionsMappingLowpassResonance()
		{
			MapFunction = MapFunction_DefaultValue = TrixSeriesSonificationDefaultInstrumentOptionsMappingLowpassResonanceMapFunction.Linear;
			MapTo = MapTo_DefaultValue = "";
			Max = Max_DefaultValue = null;
			Min = Min_DefaultValue = null;
			Value = Value_DefaultValue = null;
			Within = Within_DefaultValue = TrixSeriesSonificationDefaultInstrumentOptionsMappingLowpassResonanceWithin.Chart;
		...
		/// </summary>
		public TrixSeriesSonificationDefaultInstrumentOptionsMappingLowpassResonanceMapFunction MapFunction { get; set; }
		private TrixSeriesSonificationDefaultInstrumentOptionsMappingLowpassResonanceMapFunction MapFunction_DefaultValue { get; set; }
		...
		/// </summary>
		public TrixSeriesSonificationDefaultInstrumentOptionsMappingLowpassResonanceWithin Within { get; set; }
		private TrixSeriesSonificationDefaultInstrumentOptionsMappingLowpassResonanceWithin Within_DefaultValue { get; set; }
