...
{
	public partial class TrixSeriesSonificationPointGrouping  : BaseObject
	{
		Hashtable h = new Hashtable();

		public TrixSeriesSonificationPointGrouping()
		{
			Algorithm = Algorithm_DefaultValue = TrixSeriesSonificationPointGroupingAlgorithm.Minimax;
		...
		/// </summary>
		public TrixSeriesSonificationPointGroupingAlgorithm Algorithm { get; set; }
		private TrixSeriesSonificationPointGroupingAlgorithm Algorithm_DefaultValue { get; set; }
