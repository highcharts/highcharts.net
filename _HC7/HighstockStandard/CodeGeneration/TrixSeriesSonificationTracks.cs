...
{
	public partial class TrixSeriesSonificationTracks  : BaseObject
	{
		Hashtable h = new Hashtable();

		public TrixSeriesSonificationTracks()
		{
			ActiveWhen = ActiveWhen_DefaultValue = new TrixSeriesSonificationTracksActiveWhen();
			Instrument = Instrument_DefaultValue = null;
			InstrumentString = InstrumentString_DefaultValue = "null";
			Mapping = Mapping_DefaultValue = new TrixSeriesSonificationTracksMapping();
			MidiName = MidiName_DefaultValue = "";
			PointGrouping = PointGrouping_DefaultValue = new TrixSeriesSonificationTracksPointGrouping();
			RoundToMusicalNotes = RoundToMusicalNotes_DefaultValue = true;
			ShowPlayMarker = ShowPlayMarker_DefaultValue = true;
			Type = Type_DefaultValue = TrixSeriesSonificationTracksType.Instrument;
		...
		/// </summary>
		public TrixSeriesSonificationTracksActiveWhen ActiveWhen { get; set; }
		private TrixSeriesSonificationTracksActiveWhen ActiveWhen_DefaultValue { get; set; }
		...
		/// </summary>
		public TrixSeriesSonificationTracksMapping Mapping { get; set; }
		private TrixSeriesSonificationTracksMapping Mapping_DefaultValue { get; set; }
		...
		/// </summary>
		public TrixSeriesSonificationTracksPointGrouping PointGrouping { get; set; }
		private TrixSeriesSonificationTracksPointGrouping PointGrouping_DefaultValue { get; set; }
		...
		/// </summary>
		public TrixSeriesSonificationTracksType Type { get; set; }
		private TrixSeriesSonificationTracksType Type_DefaultValue { get; set; }
