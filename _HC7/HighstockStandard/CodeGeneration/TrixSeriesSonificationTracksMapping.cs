...
{
	public partial class TrixSeriesSonificationTracksMapping  : BaseObject
	{
		Hashtable h = new Hashtable();

		public TrixSeriesSonificationTracksMapping()
		{
			Frequency = Frequency_DefaultValue = new TrixSeriesSonificationTracksMappingFrequency();
			GapBetweenNotes = GapBetweenNotes_DefaultValue = new TrixSeriesSonificationTracksMappingGapBetweenNotes();
			Highpass = Highpass_DefaultValue = new TrixSeriesSonificationTracksMappingHighpass();
			Lowpass = Lowpass_DefaultValue = new TrixSeriesSonificationTracksMappingLowpass();
			NoteDuration = NoteDuration_DefaultValue = new TrixSeriesSonificationTracksMappingNoteDuration();
			Pan = Pan_DefaultValue = new TrixSeriesSonificationTracksMappingPan();
			Pitch = Pitch_DefaultValue = new TrixSeriesSonificationTracksMappingPitch();
			PitchString = PitchString_DefaultValue = "null";
			PitchNumber = PitchNumber_DefaultValue = null;
			PlayDelay = PlayDelay_DefaultValue = new TrixSeriesSonificationTracksMappingPlayDelay();
			Time = Time_DefaultValue = new TrixSeriesSonificationTracksMappingTime();
			TimeString = TimeString_DefaultValue = "null";
			TimeNumber = TimeNumber_DefaultValue = null;
			Tremolo = Tremolo_DefaultValue = new TrixSeriesSonificationTracksMappingTremolo();
			Volume = Volume_DefaultValue = new TrixSeriesSonificationTracksMappingVolume();
		...
		/// </summary>
		public TrixSeriesSonificationTracksMappingFrequency Frequency { get; set; }
		private TrixSeriesSonificationTracksMappingFrequency Frequency_DefaultValue { get; set; }
		...
		/// </summary>
		public TrixSeriesSonificationTracksMappingGapBetweenNotes GapBetweenNotes { get; set; }
		private TrixSeriesSonificationTracksMappingGapBetweenNotes GapBetweenNotes_DefaultValue { get; set; }
		...
		/// </summary>
		public TrixSeriesSonificationTracksMappingHighpass Highpass { get; set; }
		private TrixSeriesSonificationTracksMappingHighpass Highpass_DefaultValue { get; set; }
		...
		/// </summary>
		public TrixSeriesSonificationTracksMappingLowpass Lowpass { get; set; }
		private TrixSeriesSonificationTracksMappingLowpass Lowpass_DefaultValue { get; set; }
		...
		/// </summary>
		public TrixSeriesSonificationTracksMappingNoteDuration NoteDuration { get; set; }
		private TrixSeriesSonificationTracksMappingNoteDuration NoteDuration_DefaultValue { get; set; }
		...
		/// </summary>
		public TrixSeriesSonificationTracksMappingPan Pan { get; set; }
		private TrixSeriesSonificationTracksMappingPan Pan_DefaultValue { get; set; }
		...
		/// </summary>
		public TrixSeriesSonificationTracksMappingPitch Pitch { get; set; }
		private TrixSeriesSonificationTracksMappingPitch Pitch_DefaultValue { get; set; }
		...
		/// </summary>
		public TrixSeriesSonificationTracksMappingPlayDelay PlayDelay { get; set; }
		private TrixSeriesSonificationTracksMappingPlayDelay PlayDelay_DefaultValue { get; set; }
		...
		/// </summary>
		public TrixSeriesSonificationTracksMappingTime Time { get; set; }
		private TrixSeriesSonificationTracksMappingTime Time_DefaultValue { get; set; }
		...
		/// </summary>
		public TrixSeriesSonificationTracksMappingTremolo Tremolo { get; set; }
		private TrixSeriesSonificationTracksMappingTremolo Tremolo_DefaultValue { get; set; }
		 

		/// <summary>
		/// The volume of notes, from 0 to 1.
		/// </summary>
		public TrixSeriesSonificationTracksMappingVolume Volume { get; set; }
		private TrixSeriesSonificationTracksMappingVolume Volume_DefaultValue { get; set; }
