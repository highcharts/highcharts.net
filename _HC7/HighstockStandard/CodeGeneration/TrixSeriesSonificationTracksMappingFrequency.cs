...
{
	public partial class TrixSeriesSonificationTracksMappingFrequency  : BaseObject
	{
		Hashtable h = new Hashtable();

		public TrixSeriesSonificationTracksMappingFrequency()
		{
			MapFunction = MapFunction_DefaultValue = TrixSeriesSonificationTracksMappingFrequencyMapFunction.Linear;
			MapTo = MapTo_DefaultValue = "";
			Max = Max_DefaultValue = null;
			Min = Min_DefaultValue = null;
			Value = Value_DefaultValue = null;
			Within = Within_DefaultValue = TrixSeriesSonificationTracksMappingFrequencyWithin.Chart;
		...
		/// </summary>
		public TrixSeriesSonificationTracksMappingFrequencyMapFunction MapFunction { get; set; }
		private TrixSeriesSonificationTracksMappingFrequencyMapFunction MapFunction_DefaultValue { get; set; }
		...
		/// </summary>
		public TrixSeriesSonificationTracksMappingFrequencyWithin Within { get; set; }
		private TrixSeriesSonificationTracksMappingFrequencyWithin Within_DefaultValue { get; set; }
