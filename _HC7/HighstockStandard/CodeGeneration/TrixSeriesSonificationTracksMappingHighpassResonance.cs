...
{
	public partial class TrixSeriesSonificationTracksMappingHighpassResonance  : BaseObject
	{
		Hashtable h = new Hashtable();

		public TrixSeriesSonificationTracksMappingHighpassResonance()
		{
			MapFunction = MapFunction_DefaultValue = TrixSeriesSonificationTracksMappingHighpassResonanceMapFunction.Linear;
			MapTo = MapTo_DefaultValue = "";
			Max = Max_DefaultValue = null;
			Min = Min_DefaultValue = null;
			Value = Value_DefaultValue = null;
			Within = Within_DefaultValue = TrixSeriesSonificationTracksMappingHighpassResonanceWithin.Chart;
		...
		/// </summary>
		public TrixSeriesSonificationTracksMappingHighpassResonanceMapFunction MapFunction { get; set; }
		private TrixSeriesSonificationTracksMappingHighpassResonanceMapFunction MapFunction_DefaultValue { get; set; }
		...
		/// </summary>
		public TrixSeriesSonificationTracksMappingHighpassResonanceWithin Within { get; set; }
		private TrixSeriesSonificationTracksMappingHighpassResonanceWithin Within_DefaultValue { get; set; }
