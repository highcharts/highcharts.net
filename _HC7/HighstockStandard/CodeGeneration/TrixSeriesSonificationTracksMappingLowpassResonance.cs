...
{
	public partial class TrixSeriesSonificationTracksMappingLowpassResonance  : BaseObject
	{
		Hashtable h = new Hashtable();

		public TrixSeriesSonificationTracksMappingLowpassResonance()
		{
			MapFunction = MapFunction_DefaultValue = TrixSeriesSonificationTracksMappingLowpassResonanceMapFunction.Linear;
			MapTo = MapTo_DefaultValue = "";
			Max = Max_DefaultValue = null;
			Min = Min_DefaultValue = null;
			Value = Value_DefaultValue = null;
			Within = Within_DefaultValue = TrixSeriesSonificationTracksMappingLowpassResonanceWithin.Chart;
		...
		/// </summary>
		public TrixSeriesSonificationTracksMappingLowpassResonanceMapFunction MapFunction { get; set; }
		private TrixSeriesSonificationTracksMappingLowpassResonanceMapFunction MapFunction_DefaultValue { get; set; }
		...
		/// </summary>
		public TrixSeriesSonificationTracksMappingLowpassResonanceWithin Within { get; set; }
		private TrixSeriesSonificationTracksMappingLowpassResonanceWithin Within_DefaultValue { get; set; }
