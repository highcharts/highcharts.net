...
{
	public partial class TrixSeriesSonificationTracksMappingNoteDuration  : BaseObject
	{
		Hashtable h = new Hashtable();

		public TrixSeriesSonificationTracksMappingNoteDuration()
		{
			MapFunction = MapFunction_DefaultValue = TrixSeriesSonificationTracksMappingNoteDurationMapFunction.Linear;
			MapTo = MapTo_DefaultValue = "";
			Max = Max_DefaultValue = null;
			Min = Min_DefaultValue = null;
			Value = Value_DefaultValue = null;
			Within = Within_DefaultValue = TrixSeriesSonificationTracksMappingNoteDurationWithin.Chart;
		...
		/// </summary>
		public TrixSeriesSonificationTracksMappingNoteDurationMapFunction MapFunction { get; set; }
		private TrixSeriesSonificationTracksMappingNoteDurationMapFunction MapFunction_DefaultValue { get; set; }
		...
		/// </summary>
		public TrixSeriesSonificationTracksMappingNoteDurationWithin Within { get; set; }
		private TrixSeriesSonificationTracksMappingNoteDurationWithin Within_DefaultValue { get; set; }
