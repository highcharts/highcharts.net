...
{
	public partial class TrixSeriesSonificationTracksMappingPan  : BaseObject
	{
		Hashtable h = new Hashtable();

		public TrixSeriesSonificationTracksMappingPan()
		{
			MapFunction = MapFunction_DefaultValue = TrixSeriesSonificationTracksMappingPanMapFunction.Linear;
			MapTo = MapTo_DefaultValue = "";
			Max = Max_DefaultValue = null;
			Min = Min_DefaultValue = null;
			Value = Value_DefaultValue = null;
			Within = Within_DefaultValue = TrixSeriesSonificationTracksMappingPanWithin.Chart;
		...
		/// </summary>
		public TrixSeriesSonificationTracksMappingPanMapFunction MapFunction { get; set; }
		private TrixSeriesSonificationTracksMappingPanMapFunction MapFunction_DefaultValue { get; set; }
		...
		/// </summary>
		public TrixSeriesSonificationTracksMappingPanWithin Within { get; set; }
		private TrixSeriesSonificationTracksMappingPanWithin Within_DefaultValue { get; set; }
