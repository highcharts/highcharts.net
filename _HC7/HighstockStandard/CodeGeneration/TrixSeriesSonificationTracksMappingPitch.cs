...
{
	public partial class TrixSeriesSonificationTracksMappingPitch  : BaseObject
	{
		Hashtable h = new Hashtable();

		public TrixSeriesSonificationTracksMappingPitch()
		{
			MapFunction = MapFunction_DefaultValue = TrixSeriesSonificationTracksMappingPitchMapFunction.Linear;
		...
		/// </summary>
		public TrixSeriesSonificationTracksMappingPitchMapFunction MapFunction { get; set; }
		private TrixSeriesSonificationTracksMappingPitchMapFunction MapFunction_DefaultValue { get; set; }
