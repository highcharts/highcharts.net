...
{
	public partial class TrixSeriesSonificationTracksMappingPlayDelay  : BaseObject
	{
		Hashtable h = new Hashtable();

		public TrixSeriesSonificationTracksMappingPlayDelay()
		{
			MapFunction = MapFunction_DefaultValue = TrixSeriesSonificationTracksMappingPlayDelayMapFunction.Linear;
			MapTo = MapTo_DefaultValue = "";
			Max = Max_DefaultValue = null;
			Min = Min_DefaultValue = null;
			Value = Value_DefaultValue = null;
			Within = Within_DefaultValue = TrixSeriesSonificationTracksMappingPlayDelayWithin.Chart;
		...
		/// </summary>
		public TrixSeriesSonificationTracksMappingPlayDelayMapFunction MapFunction { get; set; }
		private TrixSeriesSonificationTracksMappingPlayDelayMapFunction MapFunction_DefaultValue { get; set; }
		...
		/// </summary>
		public TrixSeriesSonificationTracksMappingPlayDelayWithin Within { get; set; }
		private TrixSeriesSonificationTracksMappingPlayDelayWithin Within_DefaultValue { get; set; }
