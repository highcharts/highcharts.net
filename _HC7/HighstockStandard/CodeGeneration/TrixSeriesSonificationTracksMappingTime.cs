...
{
	public partial class TrixSeriesSonificationTracksMappingTime  : BaseObject
	{
		Hashtable h = new Hashtable();

		public TrixSeriesSonificationTracksMappingTime()
		{
			MapFunction = MapFunction_DefaultValue = TrixSeriesSonificationTracksMappingTimeMapFunction.Linear;
			MapTo = MapTo_DefaultValue = "";
			Max = Max_DefaultValue = null;
			Min = Min_DefaultValue = null;
			Value = Value_DefaultValue = null;
			Within = Within_DefaultValue = TrixSeriesSonificationTracksMappingTimeWithin.Chart;
		...
		/// </summary>
		public TrixSeriesSonificationTracksMappingTimeMapFunction MapFunction { get; set; }
		private TrixSeriesSonificationTracksMappingTimeMapFunction MapFunction_DefaultValue { get; set; }
		...
		/// </summary>
		public TrixSeriesSonificationTracksMappingTimeWithin Within { get; set; }
		private TrixSeriesSonificationTracksMappingTimeWithin Within_DefaultValue { get; set; }
