...
{
	public partial class TrixSeriesSonificationTracksMappingTremoloDepth  : BaseObject
	{
		Hashtable h = new Hashtable();

		public TrixSeriesSonificationTracksMappingTremoloDepth()
		{
			MapFunction = MapFunction_DefaultValue = TrixSeriesSonificationTracksMappingTremoloDepthMapFunction.Linear;
			MapTo = MapTo_DefaultValue = "";
			Max = Max_DefaultValue = null;
			Min = Min_DefaultValue = null;
			Value = Value_DefaultValue = null;
			Within = Within_DefaultValue = TrixSeriesSonificationTracksMappingTremoloDepthWithin.Chart;
		...
		/// </summary>
		public TrixSeriesSonificationTracksMappingTremoloDepthMapFunction MapFunction { get; set; }
		private TrixSeriesSonificationTracksMappingTremoloDepthMapFunction MapFunction_DefaultValue { get; set; }
		...
		/// </summary>
		public TrixSeriesSonificationTracksMappingTremoloDepthWithin Within { get; set; }
		private TrixSeriesSonificationTracksMappingTremoloDepthWithin Within_DefaultValue { get; set; }
