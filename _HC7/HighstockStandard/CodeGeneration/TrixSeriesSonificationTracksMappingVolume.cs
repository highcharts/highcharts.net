...
{
	public partial class TrixSeriesSonificationTracksMappingVolume  : BaseObject
	{
		Hashtable h = new Hashtable();

		public TrixSeriesSonificationTracksMappingVolume()
		{
			MapFunction = MapFunction_DefaultValue = TrixSeriesSonificationTracksMappingVolumeMapFunction.Linear;
			MapTo = MapTo_DefaultValue = "";
			Max = Max_DefaultValue = null;
			Min = Min_DefaultValue = null;
			Value = Value_DefaultValue = null;
			Within = Within_DefaultValue = TrixSeriesSonificationTracksMappingVolumeWithin.Chart;
		...
		/// </summary>
		public TrixSeriesSonificationTracksMappingVolumeMapFunction MapFunction { get; set; }
		private TrixSeriesSonificationTracksMappingVolumeMapFunction MapFunction_DefaultValue { get; set; }
		...
		/// </summary>
		public TrixSeriesSonificationTracksMappingVolumeWithin Within { get; set; }
		private TrixSeriesSonificationTracksMappingVolumeWithin Within_DefaultValue { get; set; }
