...
namespace Highsoft.Web.Mvc.Stocks
{
	public partial class VbpSeries  : Series
	{
		public VbpSeries()
		{
			...
			DragDrop = DragDrop_DefaultValue = new VbpSeriesDragDrop();
			...
			Type = Type_DefaultValue = VbpSeriesType.Null;
		...
		/// </summary>
		public VbpSeriesDragDrop DragDrop { get; set; }
		private VbpSeriesDragDrop DragDrop_DefaultValue { get; set; }
