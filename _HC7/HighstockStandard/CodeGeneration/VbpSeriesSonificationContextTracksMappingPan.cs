...
{
	public partial class VbpSeriesSonificationContextTracksMappingPan  : BaseObject
	{
		Hashtable h = new Hashtable();

		public VbpSeriesSonificationContextTracksMappingPan()
		{
			MapFunction = MapFunction_DefaultValue = VbpSeriesSonificationContextTracksMappingPanMapFunction.Linear;
			MapTo = MapTo_DefaultValue = "";
			Max = Max_DefaultValue = null;
			Min = Min_DefaultValue = null;
			Value = Value_DefaultValue = null;
			Within = Within_DefaultValue = VbpSeriesSonificationContextTracksMappingPanWithin.Chart;
		...
		/// </summary>
		public VbpSeriesSonificationContextTracksMappingPanMapFunction MapFunction { get; set; }
		private VbpSeriesSonificationContextTracksMappingPanMapFunction MapFunction_DefaultValue { get; set; }
		...
		/// </summary>
		public VbpSeriesSonificationContextTracksMappingPanWithin Within { get; set; }
		private VbpSeriesSonificationContextTracksMappingPanWithin Within_DefaultValue { get; set; }
