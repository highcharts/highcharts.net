...
{
	public partial class VbpSeriesSonificationContextTracksMappingPitch  : BaseObject
	{
		Hashtable h = new Hashtable();

		public VbpSeriesSonificationContextTracksMappingPitch()
		{
			MapFunction = MapFunction_DefaultValue = VbpSeriesSonificationContextTracksMappingPitchMapFunction.Linear;
		...
		/// </summary>
		public VbpSeriesSonificationContextTracksMappingPitchMapFunction MapFunction { get; set; }
		private VbpSeriesSonificationContextTracksMappingPitchMapFunction MapFunction_DefaultValue { get; set; }
