...
{
	public partial class VbpSeriesSonificationContextTracksMappingTime  : BaseObject
	{
		Hashtable h = new Hashtable();

		public VbpSeriesSonificationContextTracksMappingTime()
		{
			MapFunction = MapFunction_DefaultValue = VbpSeriesSonificationContextTracksMappingTimeMapFunction.Linear;
			MapTo = MapTo_DefaultValue = "";
			Max = Max_DefaultValue = null;
			Min = Min_DefaultValue = null;
			Value = Value_DefaultValue = null;
			Within = Within_DefaultValue = VbpSeriesSonificationContextTracksMappingTimeWithin.Chart;
		...
		/// </summary>
		public VbpSeriesSonificationContextTracksMappingTimeMapFunction MapFunction { get; set; }
		private VbpSeriesSonificationContextTracksMappingTimeMapFunction MapFunction_DefaultValue { get; set; }
		...
		/// </summary>
		public VbpSeriesSonificationContextTracksMappingTimeWithin Within { get; set; }
		private VbpSeriesSonificationContextTracksMappingTimeWithin Within_DefaultValue { get; set; }
