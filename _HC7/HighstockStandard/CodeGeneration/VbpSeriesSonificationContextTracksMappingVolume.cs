...
{
	public partial class VbpSeriesSonificationContextTracksMappingVolume  : BaseObject
	{
		Hashtable h = new Hashtable();

		public VbpSeriesSonificationContextTracksMappingVolume()
		{
			MapFunction = MapFunction_DefaultValue = VbpSeriesSonificationContextTracksMappingVolumeMapFunction.Linear;
			MapTo = MapTo_DefaultValue = "";
			Max = Max_DefaultValue = null;
			Min = Min_DefaultValue = null;
			Value = Value_DefaultValue = null;
			Within = Within_DefaultValue = VbpSeriesSonificationContextTracksMappingVolumeWithin.Chart;
		...
		/// </summary>
		public VbpSeriesSonificationContextTracksMappingVolumeMapFunction MapFunction { get; set; }
		private VbpSeriesSonificationContextTracksMappingVolumeMapFunction MapFunction_DefaultValue { get; set; }
		...
		/// </summary>
		public VbpSeriesSonificationContextTracksMappingVolumeWithin Within { get; set; }
		private VbpSeriesSonificationContextTracksMappingVolumeWithin Within_DefaultValue { get; set; }
