...
{
	public partial class VbpSeriesSonificationDefaultSpeechOptionsMappingPitch  : BaseObject
	{
		Hashtable h = new Hashtable();

		public VbpSeriesSonificationDefaultSpeechOptionsMappingPitch()
		{
			MapFunction = MapFunction_DefaultValue = VbpSeriesSonificationDefaultSpeechOptionsMappingPitchMapFunction.Linear;
		...
		/// </summary>
		public VbpSeriesSonificationDefaultSpeechOptionsMappingPitchMapFunction MapFunction { get; set; }
		private VbpSeriesSonificationDefaultSpeechOptionsMappingPitchMapFunction MapFunction_DefaultValue { get; set; }
