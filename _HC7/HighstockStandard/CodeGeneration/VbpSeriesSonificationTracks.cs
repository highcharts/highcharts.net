...
{
	public partial class VbpSeriesSonificationTracks  : BaseObject
	{
		Hashtable h = new Hashtable();

		public VbpSeriesSonificationTracks()
		{
			ActiveWhen = ActiveWhen_DefaultValue = new VbpSeriesSonificationTracksActiveWhen();
			Instrument = Instrument_DefaultValue = null;
			InstrumentString = InstrumentString_DefaultValue = "null";
			Mapping = Mapping_DefaultValue = new VbpSeriesSonificationTracksMapping();
			MidiName = MidiName_DefaultValue = "";
			PointGrouping = PointGrouping_DefaultValue = new VbpSeriesSonificationTracksPointGrouping();
			RoundToMusicalNotes = RoundToMusicalNotes_DefaultValue = true;
			ShowPlayMarker = ShowPlayMarker_DefaultValue = true;
			Type = Type_DefaultValue = VbpSeriesSonificationTracksType.Instrument;
		...
		/// </summary>
		public VbpSeriesSonificationTracksActiveWhen ActiveWhen { get; set; }
		private VbpSeriesSonificationTracksActiveWhen ActiveWhen_DefaultValue { get; set; }
		...
		/// </summary>
		public VbpSeriesSonificationTracksMapping Mapping { get; set; }
		private VbpSeriesSonificationTracksMapping Mapping_DefaultValue { get; set; }
		...
		/// </summary>
		public VbpSeriesSonificationTracksPointGrouping PointGrouping { get; set; }
		private VbpSeriesSonificationTracksPointGrouping PointGrouping_DefaultValue { get; set; }
		...
		/// </summary>
		public VbpSeriesSonificationTracksType Type { get; set; }
		private VbpSeriesSonificationTracksType Type_DefaultValue { get; set; }
