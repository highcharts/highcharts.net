...
{
	public partial class VbpSeriesSonificationTracksMappingFrequency  : BaseObject
	{
		Hashtable h = new Hashtable();

		public VbpSeriesSonificationTracksMappingFrequency()
		{
			MapFunction = MapFunction_DefaultValue = VbpSeriesSonificationTracksMappingFrequencyMapFunction.Linear;
			MapTo = MapTo_DefaultValue = "";
			Max = Max_DefaultValue = null;
			Min = Min_DefaultValue = null;
			Value = Value_DefaultValue = null;
			Within = Within_DefaultValue = VbpSeriesSonificationTracksMappingFrequencyWithin.Chart;
		...
		/// </summary>
		public VbpSeriesSonificationTracksMappingFrequencyMapFunction MapFunction { get; set; }
		private VbpSeriesSonificationTracksMappingFrequencyMapFunction MapFunction_DefaultValue { get; set; }
		...
		/// </summary>
		public VbpSeriesSonificationTracksMappingFrequencyWithin Within { get; set; }
		private VbpSeriesSonificationTracksMappingFrequencyWithin Within_DefaultValue { get; set; }
