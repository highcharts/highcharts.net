...
{
	public partial class VbpSeriesSonificationTracksMappingNoteDuration  : BaseObject
	{
		Hashtable h = new Hashtable();

		public VbpSeriesSonificationTracksMappingNoteDuration()
		{
			MapFunction = MapFunction_DefaultValue = VbpSeriesSonificationTracksMappingNoteDurationMapFunction.Linear;
			MapTo = MapTo_DefaultValue = "";
			Max = Max_DefaultValue = null;
			Min = Min_DefaultValue = null;
			Value = Value_DefaultValue = null;
			Within = Within_DefaultValue = VbpSeriesSonificationTracksMappingNoteDurationWithin.Chart;
		...
		/// </summary>
		public VbpSeriesSonificationTracksMappingNoteDurationMapFunction MapFunction { get; set; }
		private VbpSeriesSonificationTracksMappingNoteDurationMapFunction MapFunction_DefaultValue { get; set; }
		...
		/// </summary>
		public VbpSeriesSonificationTracksMappingNoteDurationWithin Within { get; set; }
		private VbpSeriesSonificationTracksMappingNoteDurationWithin Within_DefaultValue { get; set; }
