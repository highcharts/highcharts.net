...
{
	public partial class VbpSeriesSonificationTracksMappingTime  : BaseObject
	{
		Hashtable h = new Hashtable();

		public VbpSeriesSonificationTracksMappingTime()
		{
			MapFunction = MapFunction_DefaultValue = VbpSeriesSonificationTracksMappingTimeMapFunction.Linear;
			MapTo = MapTo_DefaultValue = "";
			Max = Max_DefaultValue = null;
			Min = Min_DefaultValue = null;
			Value = Value_DefaultValue = null;
			Within = Within_DefaultValue = VbpSeriesSonificationTracksMappingTimeWithin.Chart;
		...
		/// </summary>
		public VbpSeriesSonificationTracksMappingTimeMapFunction MapFunction { get; set; }
		private VbpSeriesSonificationTracksMappingTimeMapFunction MapFunction_DefaultValue { get; set; }
		...
		/// </summary>
		public VbpSeriesSonificationTracksMappingTimeWithin Within { get; set; }
		private VbpSeriesSonificationTracksMappingTimeWithin Within_DefaultValue { get; set; }
