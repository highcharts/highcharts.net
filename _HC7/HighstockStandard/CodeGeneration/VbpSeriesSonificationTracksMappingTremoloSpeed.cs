...
{
	public partial class VbpSeriesSonificationTracksMappingTremoloSpeed  : BaseObject
	{
		Hashtable h = new Hashtable();

		public VbpSeriesSonificationTracksMappingTremoloSpeed()
		{
			MapFunction = MapFunction_DefaultValue = VbpSeriesSonificationTracksMappingTremoloSpeedMapFunction.Linear;
			MapTo = MapTo_DefaultValue = "";
			Max = Max_DefaultValue = null;
			Min = Min_DefaultValue = null;
			Value = Value_DefaultValue = null;
			Within = Within_DefaultValue = VbpSeriesSonificationTracksMappingTremoloSpeedWithin.Chart;
		...
		/// </summary>
		public VbpSeriesSonificationTracksMappingTremoloSpeedMapFunction MapFunction { get; set; }
		private VbpSeriesSonificationTracksMappingTremoloSpeedMapFunction MapFunction_DefaultValue { get; set; }
		...
		/// </summary>
		public VbpSeriesSonificationTracksMappingTremoloSpeedWithin Within { get; set; }
		private VbpSeriesSonificationTracksMappingTremoloSpeedWithin Within_DefaultValue { get; set; }
