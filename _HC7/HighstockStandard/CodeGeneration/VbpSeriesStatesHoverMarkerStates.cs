...
namespace Highsoft.Web.Mvc.Stocks
{
	public partial class VbpSeriesStatesHoverMarkerStates  : BaseObject
	{
		public VbpSeriesStatesHoverMarkerStates()
		{
			...
			Inactive = Inactive_DefaultValue = new VbpSeriesStatesHoverMarkerStatesInactive();
			Normal = Normal_DefaultValue = new VbpSeriesStatesHoverMarkerStatesNormal();
		...
		/// 
		/// </summary>
		public VbpSeriesStatesHoverMarkerStatesInactive Inactive { get; set; }
		private VbpSeriesStatesHoverMarkerStatesInactive Inactive_DefaultValue { get; set; }
		 

		/// <summary>
		/// The normal state of a single point marker. Currently onlyused for setting animation when returning to normal statefrom hover.
		/// </summary>
		public VbpSeriesStatesHoverMarkerStatesNormal Normal { get; set; }
		private VbpSeriesStatesHoverMarkerStatesNormal Normal_DefaultValue { get; set; }
