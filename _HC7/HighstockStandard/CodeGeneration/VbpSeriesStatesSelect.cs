...
{
	public partial class VbpSeriesStatesSelect  : BaseObject
	{
		Hashtable h = new Hashtable();

		public VbpSeriesStatesSelect()
		{
			Animation = Animation_DefaultValue = new Animation() { Enabled = true };
			AnimationBool = AnimationBool_DefaultValue = null;
			Enabled = Enabled_DefaultValue = true;
			Halo = Halo_DefaultValue = new VbpSeriesStatesSelectHalo();
			LineWidth = LineWidth_DefaultValue = null;
			LineWidthPlus = LineWidthPlus_DefaultValue = 1;
			Marker = Marker_DefaultValue = new VbpSeriesStatesSelectMarker();
		...
		/// </summary>
		public VbpSeriesStatesSelectHalo Halo { get; set; }
		private VbpSeriesStatesSelectHalo Halo_DefaultValue { get; set; }
		...
		/// </summary>
		public VbpSeriesStatesSelectMarker Marker { get; set; }
		private VbpSeriesStatesSelectMarker Marker_DefaultValue { get; set; }
