...
{
	public partial class VbpSeriesTooltip  : BaseObject
	{
		public VbpSeriesTooltip()
		{
			...
			HeaderShape = HeaderShape_DefaultValue = VbpSeriesTooltipHeaderShape.Callout;
		...
		/// </summary>
		public VbpSeriesTooltipHeaderShape HeaderShape { get; set; }
		private VbpSeriesTooltipHeaderShape HeaderShape_DefaultValue { get; set; }
		...
		internal override Hashtable ToHashtable()
		{
			...
			if (NullFormatter != NullFormatter_DefaultValue) { h.Add("nullFormatter",NullFormatter); Highstock.AddFunction("VbpSeriesTooltipNullFormatter.nullFormatter", NullFormatter); }  
			if (Outside != Outside_DefaultValue) h.Add("outside",Outside);
			if (Padding != Padding_DefaultValue) h.Add("padding",Padding);
			if (PointFormat != PointFormat_DefaultValue) h.Add("pointFormat",PointFormat);
			if (PointFormatter != PointFormatter_DefaultValue) { h.Add("pointFormatter",PointFormatter); Highstock.AddFunction("VbpSeriesTooltipPointFormatter.pointFormatter", PointFormatter); }  
