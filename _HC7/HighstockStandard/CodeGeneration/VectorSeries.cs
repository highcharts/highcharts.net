...
namespace Highsoft.Web.Mvc.Stocks
{
	public partial class VectorSeries  : Series
	{
		...
		public VectorSeries()
		{
			...
			Compare = Compare_DefaultValue = VectorSeriesCompare.Percent;
			...
			Dumbell = Dumbell_DefaultValue = new VectorSeriesDumbell();
			...
			Sonification = Sonification_DefaultValue = new VectorSeriesSonification();
			...
			Zones = Zones_DefaultValue = new List<VectorSeriesZones>();
		...
		/// </summary>
		public VectorSeriesCompare Compare { get; set; }
		private VectorSeriesCompare Compare_DefaultValue { get; set; }
		...
		/// 
		/// </summary>
		public VectorSeriesDumbell Dumbell { get; set; }
		private VectorSeriesDumbell Dumbell_DefaultValue { get; set; }
		...
		/// </summary>
		public List<VectorSeriesZones> Zones { get; set; }
		private List<VectorSeriesZones> Zones_DefaultValue { get; set; }
