...
namespace Highsoft.Web.Mvc.Stocks
{
	public partial class VectorSeriesDataDragDropDragHandle  : BaseObject
	{
		...
		internal override Hashtable ToHashtable()
		{
			...
			if (PathFormatter != PathFormatter_DefaultValue) { h.Add("pathFormatter",PathFormatter); Highstock.AddFunction("VectorSeriesDataDragDropDragHandlePathFormatter.pathFormatter", PathFormatter); }  
