...
{
	public partial class VectorSeriesSonificationContextTracks  : BaseObject
	{
		Hashtable h = new Hashtable();

		public VectorSeriesSonificationContextTracks()
		{
			ActiveWhen = ActiveWhen_DefaultValue = new VectorSeriesSonificationContextTracksActiveWhen();
			Instrument = Instrument_DefaultValue = null;
			InstrumentString = InstrumentString_DefaultValue = "null";
			Mapping = Mapping_DefaultValue = new VectorSeriesSonificationContextTracksMapping();
			MidiName = MidiName_DefaultValue = "";
			PointGrouping = PointGrouping_DefaultValue = new VectorSeriesSonificationContextTracksPointGrouping();
			...
			Type = Type_DefaultValue = VectorSeriesSonificationContextTracksType.Instrument;
			ValueInterval = ValueInterval_DefaultValue = null;
			ValueMapFunction = ValueMapFunction_DefaultValue = VectorSeriesSonificationContextTracksValueMapFunction.Linear;
		...
		/// </summary>
		public VectorSeriesSonificationContextTracksActiveWhen ActiveWhen { get; set; }
		private VectorSeriesSonificationContextTracksActiveWhen ActiveWhen_DefaultValue { get; set; }
		...
		/// </summary>
		public VectorSeriesSonificationContextTracksMapping Mapping { get; set; }
		private VectorSeriesSonificationContextTracksMapping Mapping_DefaultValue { get; set; }
		...
		/// </summary>
		public VectorSeriesSonificationContextTracksPointGrouping PointGrouping { get; set; }
		private VectorSeriesSonificationContextTracksPointGrouping PointGrouping_DefaultValue { get; set; }
		...
		/// </summary>
		public VectorSeriesSonificationContextTracksType Type { get; set; }
		private VectorSeriesSonificationContextTracksType Type_DefaultValue { get; set; }
		...
		/// </summary>
		public VectorSeriesSonificationContextTracksValueMapFunction ValueMapFunction { get; set; }
		private VectorSeriesSonificationContextTracksValueMapFunction ValueMapFunction_DefaultValue { get; set; }
