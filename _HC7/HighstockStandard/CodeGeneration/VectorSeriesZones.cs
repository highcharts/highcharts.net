...
{
	public partial class VectorSeriesZones  : BaseObject
	{
		Hashtable h = new Hashtable();

		public VectorSeriesZones()
		{
		}	
		...
		internal override Hashtable ToHashtable(Highstock highstock)
		{
			...
			if (DashStyle != VectorSeriesZonesDashStyle.Null) h.Add("dashStyle", highstock.FirstCharacterToLower(DashStyle.ToString()));
