...
namespace Highsoft.Web.Mvc.Stocks
{
	public partial class VwapSeriesAccessibility  : BaseObject
	{
		...
		public VwapSeriesAccessibility()
		{
			...
			Point = Point_DefaultValue = new VwapSeriesAccessibilityPoint();
		...
		/// </summary>
		public VwapSeriesAccessibilityPoint Point { get; set; }
		private VwapSeriesAccessibilityPoint Point_DefaultValue { get; set; }
