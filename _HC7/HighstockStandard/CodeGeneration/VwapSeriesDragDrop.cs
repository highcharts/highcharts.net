...
{
	public partial class VwapSeriesDragDrop  : BaseObject
	{
		public VwapSeriesDragDrop()
		{
			DraggableX = DraggableX_DefaultValue = null;
			DraggableY = DraggableY_DefaultValue = null;
			DragHandle = DragHandle_DefaultValue = new VwapSeriesDragDropDragHandle();
			...
			GuideBox = GuideBox_DefaultValue = new VwapSeriesDragDropGuideBox();
		...
		/// </summary>
		public VwapSeriesDragDropDragHandle DragHandle { get; set; }
		private VwapSeriesDragDropDragHandle DragHandle_DefaultValue { get; set; }
		...
		/// </summary>
		public VwapSeriesDragDropGuideBox GuideBox { get; set; }
		private VwapSeriesDragDropGuideBox GuideBox_DefaultValue { get; set; }
