...
namespace Highsoft.Web.Mvc.Stocks
{
	public partial class VwapSeriesMarkerStates  : BaseObject
	{
		public VwapSeriesMarkerStates()
		{
			...
			Inactive = Inactive_DefaultValue = new VwapSeriesMarkerStatesInactive();
		...
		/// 
		/// </summary>
		public VwapSeriesMarkerStatesInactive Inactive { get; set; }
		private VwapSeriesMarkerStatesInactive Inactive_DefaultValue { get; set; }
