...
{
	public partial class VwapSeriesSonificationContextTracks  : BaseObject
	{
		Hashtable h = new Hashtable();

		public VwapSeriesSonificationContextTracks()
		{
			ActiveWhen = ActiveWhen_DefaultValue = new VwapSeriesSonificationContextTracksActiveWhen();
			Instrument = Instrument_DefaultValue = null;
			InstrumentString = InstrumentString_DefaultValue = "null";
			Mapping = Mapping_DefaultValue = new VwapSeriesSonificationContextTracksMapping();
			MidiName = MidiName_DefaultValue = "";
			PointGrouping = PointGrouping_DefaultValue = new VwapSeriesSonificationContextTracksPointGrouping();
			...
			Type = Type_DefaultValue = VwapSeriesSonificationContextTracksType.Instrument;
			ValueInterval = ValueInterval_DefaultValue = null;
			ValueMapFunction = ValueMapFunction_DefaultValue = VwapSeriesSonificationContextTracksValueMapFunction.Linear;
		...
		/// </summary>
		public VwapSeriesSonificationContextTracksActiveWhen ActiveWhen { get; set; }
		private VwapSeriesSonificationContextTracksActiveWhen ActiveWhen_DefaultValue { get; set; }
		...
		/// </summary>
		public VwapSeriesSonificationContextTracksMapping Mapping { get; set; }
		private VwapSeriesSonificationContextTracksMapping Mapping_DefaultValue { get; set; }
		...
		/// </summary>
		public VwapSeriesSonificationContextTracksPointGrouping PointGrouping { get; set; }
		private VwapSeriesSonificationContextTracksPointGrouping PointGrouping_DefaultValue { get; set; }
		...
		/// </summary>
		public VwapSeriesSonificationContextTracksType Type { get; set; }
		private VwapSeriesSonificationContextTracksType Type_DefaultValue { get; set; }
		...
		/// </summary>
		public VwapSeriesSonificationContextTracksValueMapFunction ValueMapFunction { get; set; }
		private VwapSeriesSonificationContextTracksValueMapFunction ValueMapFunction_DefaultValue { get; set; }
