...
{
	public partial class VwapSeriesSonificationContextTracksMapping  : BaseObject
	{
		Hashtable h = new Hashtable();

		public VwapSeriesSonificationContextTracksMapping()
		{
			Frequency = Frequency_DefaultValue = new VwapSeriesSonificationContextTracksMappingFrequency();
			GapBetweenNotes = GapBetweenNotes_DefaultValue = new VwapSeriesSonificationContextTracksMappingGapBetweenNotes();
			Highpass = Highpass_DefaultValue = new VwapSeriesSonificationContextTracksMappingHighpass();
			Lowpass = Lowpass_DefaultValue = new VwapSeriesSonificationContextTracksMappingLowpass();
			NoteDuration = NoteDuration_DefaultValue = new VwapSeriesSonificationContextTracksMappingNoteDuration();
			Pan = Pan_DefaultValue = new VwapSeriesSonificationContextTracksMappingPan();
			Pitch = Pitch_DefaultValue = new VwapSeriesSonificationContextTracksMappingPitch();
			PitchString = PitchString_DefaultValue = "null";
			PitchNumber = PitchNumber_DefaultValue = null;
			PlayDelay = PlayDelay_DefaultValue = new VwapSeriesSonificationContextTracksMappingPlayDelay();
			Time = Time_DefaultValue = new VwapSeriesSonificationContextTracksMappingTime();
			TimeString = TimeString_DefaultValue = "null";
			TimeNumber = TimeNumber_DefaultValue = null;
			Tremolo = Tremolo_DefaultValue = new VwapSeriesSonificationContextTracksMappingTremolo();
			Volume = Volume_DefaultValue = new VwapSeriesSonificationContextTracksMappingVolume();
		...
		/// </summary>
		public VwapSeriesSonificationContextTracksMappingFrequency Frequency { get; set; }
		private VwapSeriesSonificationContextTracksMappingFrequency Frequency_DefaultValue { get; set; }
		...
		/// </summary>
		public VwapSeriesSonificationContextTracksMappingGapBetweenNotes GapBetweenNotes { get; set; }
		private VwapSeriesSonificationContextTracksMappingGapBetweenNotes GapBetweenNotes_DefaultValue { get; set; }
		...
		/// </summary>
		public VwapSeriesSonificationContextTracksMappingHighpass Highpass { get; set; }
		private VwapSeriesSonificationContextTracksMappingHighpass Highpass_DefaultValue { get; set; }
		...
		/// </summary>
		public VwapSeriesSonificationContextTracksMappingLowpass Lowpass { get; set; }
		private VwapSeriesSonificationContextTracksMappingLowpass Lowpass_DefaultValue { get; set; }
		...
		/// </summary>
		public VwapSeriesSonificationContextTracksMappingNoteDuration NoteDuration { get; set; }
		private VwapSeriesSonificationContextTracksMappingNoteDuration NoteDuration_DefaultValue { get; set; }
		...
		/// </summary>
		public VwapSeriesSonificationContextTracksMappingPan Pan { get; set; }
		private VwapSeriesSonificationContextTracksMappingPan Pan_DefaultValue { get; set; }
		...
		/// </summary>
		public VwapSeriesSonificationContextTracksMappingPitch Pitch { get; set; }
		private VwapSeriesSonificationContextTracksMappingPitch Pitch_DefaultValue { get; set; }
		...
		/// </summary>
		public VwapSeriesSonificationContextTracksMappingPlayDelay PlayDelay { get; set; }
		private VwapSeriesSonificationContextTracksMappingPlayDelay PlayDelay_DefaultValue { get; set; }
		...
		/// </summary>
		public VwapSeriesSonificationContextTracksMappingTime Time { get; set; }
		private VwapSeriesSonificationContextTracksMappingTime Time_DefaultValue { get; set; }
		...
		/// </summary>
		public VwapSeriesSonificationContextTracksMappingTremolo Tremolo { get; set; }
		private VwapSeriesSonificationContextTracksMappingTremolo Tremolo_DefaultValue { get; set; }
		 

		/// <summary>
		/// The volume of notes, from 0 to 1.
		/// </summary>
		public VwapSeriesSonificationContextTracksMappingVolume Volume { get; set; }
		private VwapSeriesSonificationContextTracksMappingVolume Volume_DefaultValue { get; set; }
