...
{
	public partial class VwapSeriesSonificationContextTracksMappingPan  : BaseObject
	{
		Hashtable h = new Hashtable();

		public VwapSeriesSonificationContextTracksMappingPan()
		{
			MapFunction = MapFunction_DefaultValue = VwapSeriesSonificationContextTracksMappingPanMapFunction.Linear;
			MapTo = MapTo_DefaultValue = "";
			Max = Max_DefaultValue = null;
			Min = Min_DefaultValue = null;
			Value = Value_DefaultValue = null;
			Within = Within_DefaultValue = VwapSeriesSonificationContextTracksMappingPanWithin.Chart;
		...
		/// </summary>
		public VwapSeriesSonificationContextTracksMappingPanMapFunction MapFunction { get; set; }
		private VwapSeriesSonificationContextTracksMappingPanMapFunction MapFunction_DefaultValue { get; set; }
		...
		/// </summary>
		public VwapSeriesSonificationContextTracksMappingPanWithin Within { get; set; }
		private VwapSeriesSonificationContextTracksMappingPanWithin Within_DefaultValue { get; set; }
