...
{
	public partial class VwapSeriesSonificationContextTracksMappingPitch  : BaseObject
	{
		Hashtable h = new Hashtable();

		public VwapSeriesSonificationContextTracksMappingPitch()
		{
			MapFunction = MapFunction_DefaultValue = VwapSeriesSonificationContextTracksMappingPitchMapFunction.Linear;
		...
		/// </summary>
		public VwapSeriesSonificationContextTracksMappingPitchMapFunction MapFunction { get; set; }
		private VwapSeriesSonificationContextTracksMappingPitchMapFunction MapFunction_DefaultValue { get; set; }
