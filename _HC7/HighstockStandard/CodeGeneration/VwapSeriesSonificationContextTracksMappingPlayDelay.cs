...
{
	public partial class VwapSeriesSonificationContextTracksMappingPlayDelay  : BaseObject
	{
		Hashtable h = new Hashtable();

		public VwapSeriesSonificationContextTracksMappingPlayDelay()
		{
			MapFunction = MapFunction_DefaultValue = VwapSeriesSonificationContextTracksMappingPlayDelayMapFunction.Linear;
			MapTo = MapTo_DefaultValue = "";
			Max = Max_DefaultValue = null;
			Min = Min_DefaultValue = null;
			Value = Value_DefaultValue = null;
			Within = Within_DefaultValue = VwapSeriesSonificationContextTracksMappingPlayDelayWithin.Chart;
		...
		/// </summary>
		public VwapSeriesSonificationContextTracksMappingPlayDelayMapFunction MapFunction { get; set; }
		private VwapSeriesSonificationContextTracksMappingPlayDelayMapFunction MapFunction_DefaultValue { get; set; }
		...
		/// </summary>
		public VwapSeriesSonificationContextTracksMappingPlayDelayWithin Within { get; set; }
		private VwapSeriesSonificationContextTracksMappingPlayDelayWithin Within_DefaultValue { get; set; }
