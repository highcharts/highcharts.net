...
{
	public partial class VwapSeriesSonificationContextTracksMappingVolume  : BaseObject
	{
		Hashtable h = new Hashtable();

		public VwapSeriesSonificationContextTracksMappingVolume()
		{
			MapFunction = MapFunction_DefaultValue = VwapSeriesSonificationContextTracksMappingVolumeMapFunction.Linear;
			MapTo = MapTo_DefaultValue = "";
			Max = Max_DefaultValue = null;
			Min = Min_DefaultValue = null;
			Value = Value_DefaultValue = null;
			Within = Within_DefaultValue = VwapSeriesSonificationContextTracksMappingVolumeWithin.Chart;
		...
		/// </summary>
		public VwapSeriesSonificationContextTracksMappingVolumeMapFunction MapFunction { get; set; }
		private VwapSeriesSonificationContextTracksMappingVolumeMapFunction MapFunction_DefaultValue { get; set; }
		...
		/// </summary>
		public VwapSeriesSonificationContextTracksMappingVolumeWithin Within { get; set; }
		private VwapSeriesSonificationContextTracksMappingVolumeWithin Within_DefaultValue { get; set; }
