...
{
	public partial class VwapSeriesSonificationContextTracksPointGrouping  : BaseObject
	{
		Hashtable h = new Hashtable();

		public VwapSeriesSonificationContextTracksPointGrouping()
		{
			Algorithm = Algorithm_DefaultValue = VwapSeriesSonificationContextTracksPointGroupingAlgorithm.Minimax;
		...
		/// </summary>
		public VwapSeriesSonificationContextTracksPointGroupingAlgorithm Algorithm { get; set; }
		private VwapSeriesSonificationContextTracksPointGroupingAlgorithm Algorithm_DefaultValue { get; set; }
