...
{
	public partial class VwapSeriesSonificationDefaultInstrumentOptions  : BaseObject
	{
		Hashtable h = new Hashtable();

		public VwapSeriesSonificationDefaultInstrumentOptions()
		{
			ActiveWhen = ActiveWhen_DefaultValue = new VwapSeriesSonificationDefaultInstrumentOptionsActiveWhen();
			Instrument = Instrument_DefaultValue = null;
			InstrumentString = InstrumentString_DefaultValue = "null";
			Mapping = Mapping_DefaultValue = new VwapSeriesSonificationDefaultInstrumentOptionsMapping();
			MidiName = MidiName_DefaultValue = "";
			PointGrouping = PointGrouping_DefaultValue = new VwapSeriesSonificationDefaultInstrumentOptionsPointGrouping();
			RoundToMusicalNotes = RoundToMusicalNotes_DefaultValue = true;
			ShowPlayMarker = ShowPlayMarker_DefaultValue = true;
			Type = Type_DefaultValue = VwapSeriesSonificationDefaultInstrumentOptionsType.Instrument;
		...
		/// </summary>
		public VwapSeriesSonificationDefaultInstrumentOptionsActiveWhen ActiveWhen { get; set; }
		private VwapSeriesSonificationDefaultInstrumentOptionsActiveWhen ActiveWhen_DefaultValue { get; set; }
		...
		/// </summary>
		public VwapSeriesSonificationDefaultInstrumentOptionsMapping Mapping { get; set; }
		private VwapSeriesSonificationDefaultInstrumentOptionsMapping Mapping_DefaultValue { get; set; }
		...
		/// </summary>
		public VwapSeriesSonificationDefaultInstrumentOptionsPointGrouping PointGrouping { get; set; }
		private VwapSeriesSonificationDefaultInstrumentOptionsPointGrouping PointGrouping_DefaultValue { get; set; }
		...
		/// </summary>
		public VwapSeriesSonificationDefaultInstrumentOptionsType Type { get; set; }
		private VwapSeriesSonificationDefaultInstrumentOptionsType Type_DefaultValue { get; set; }
