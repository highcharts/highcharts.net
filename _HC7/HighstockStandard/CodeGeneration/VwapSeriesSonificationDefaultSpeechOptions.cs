...
{
	public partial class VwapSeriesSonificationDefaultSpeechOptions  : BaseObject
	{
		Hashtable h = new Hashtable();

		public VwapSeriesSonificationDefaultSpeechOptions()
		{
			ActiveWhen = ActiveWhen_DefaultValue = new VwapSeriesSonificationDefaultSpeechOptionsActiveWhen();
			Language = Language_DefaultValue = "en-US";
			Mapping = Mapping_DefaultValue = new VwapSeriesSonificationDefaultSpeechOptionsMapping();
			PointGrouping = PointGrouping_DefaultValue = new VwapSeriesSonificationDefaultSpeechOptionsPointGrouping();
			PreferredVoice = PreferredVoice_DefaultValue = "";
			ShowPlayMarker = ShowPlayMarker_DefaultValue = true;
			Type = Type_DefaultValue = VwapSeriesSonificationDefaultSpeechOptionsType.Instrument;
		...
		/// </summary>
		public VwapSeriesSonificationDefaultSpeechOptionsActiveWhen ActiveWhen { get; set; }
		private VwapSeriesSonificationDefaultSpeechOptionsActiveWhen ActiveWhen_DefaultValue { get; set; }
		...
		/// </summary>
		public VwapSeriesSonificationDefaultSpeechOptionsMapping Mapping { get; set; }
		private VwapSeriesSonificationDefaultSpeechOptionsMapping Mapping_DefaultValue { get; set; }
		 

		/// <summary>
		/// Options for point grouping, specifically for instrument tracks.
		/// </summary>
		public VwapSeriesSonificationDefaultSpeechOptionsPointGrouping PointGrouping { get; set; }
		private VwapSeriesSonificationDefaultSpeechOptionsPointGrouping PointGrouping_DefaultValue { get; set; }
		...
		/// </summary>
		public VwapSeriesSonificationDefaultSpeechOptionsType Type { get; set; }
		private VwapSeriesSonificationDefaultSpeechOptionsType Type_DefaultValue { get; set; }
