...
{
	public partial class VwapSeriesSonificationDefaultSpeechOptionsMappingVolume  : BaseObject
	{
		Hashtable h = new Hashtable();

		public VwapSeriesSonificationDefaultSpeechOptionsMappingVolume()
		{
			MapFunction = MapFunction_DefaultValue = VwapSeriesSonificationDefaultSpeechOptionsMappingVolumeMapFunction.Linear;
			MapTo = MapTo_DefaultValue = "";
			Max = Max_DefaultValue = null;
			Min = Min_DefaultValue = null;
			Value = Value_DefaultValue = null;
			Within = Within_DefaultValue = VwapSeriesSonificationDefaultSpeechOptionsMappingVolumeWithin.Chart;
		...
		/// </summary>
		public VwapSeriesSonificationDefaultSpeechOptionsMappingVolumeMapFunction MapFunction { get; set; }
		private VwapSeriesSonificationDefaultSpeechOptionsMappingVolumeMapFunction MapFunction_DefaultValue { get; set; }
		...
		/// </summary>
		public VwapSeriesSonificationDefaultSpeechOptionsMappingVolumeWithin Within { get; set; }
		private VwapSeriesSonificationDefaultSpeechOptionsMappingVolumeWithin Within_DefaultValue { get; set; }
