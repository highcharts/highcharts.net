...
{
	public partial class VwapSeriesSonificationPointGrouping  : BaseObject
	{
		Hashtable h = new Hashtable();

		public VwapSeriesSonificationPointGrouping()
		{
			Algorithm = Algorithm_DefaultValue = VwapSeriesSonificationPointGroupingAlgorithm.Minimax;
		...
		/// </summary>
		public VwapSeriesSonificationPointGroupingAlgorithm Algorithm { get; set; }
		private VwapSeriesSonificationPointGroupingAlgorithm Algorithm_DefaultValue { get; set; }
