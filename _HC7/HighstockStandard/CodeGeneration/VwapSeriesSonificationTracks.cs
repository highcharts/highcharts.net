...
{
	public partial class VwapSeriesSonificationTracks  : BaseObject
	{
		Hashtable h = new Hashtable();

		public VwapSeriesSonificationTracks()
		{
			ActiveWhen = ActiveWhen_DefaultValue = new VwapSeriesSonificationTracksActiveWhen();
			Instrument = Instrument_DefaultValue = null;
			InstrumentString = InstrumentString_DefaultValue = "null";
			Mapping = Mapping_DefaultValue = new VwapSeriesSonificationTracksMapping();
			MidiName = MidiName_DefaultValue = "";
			PointGrouping = PointGrouping_DefaultValue = new VwapSeriesSonificationTracksPointGrouping();
			RoundToMusicalNotes = RoundToMusicalNotes_DefaultValue = true;
			ShowPlayMarker = ShowPlayMarker_DefaultValue = true;
			Type = Type_DefaultValue = VwapSeriesSonificationTracksType.Instrument;
		...
		/// </summary>
		public VwapSeriesSonificationTracksActiveWhen ActiveWhen { get; set; }
		private VwapSeriesSonificationTracksActiveWhen ActiveWhen_DefaultValue { get; set; }
		...
		/// </summary>
		public VwapSeriesSonificationTracksMapping Mapping { get; set; }
		private VwapSeriesSonificationTracksMapping Mapping_DefaultValue { get; set; }
		...
		/// </summary>
		public VwapSeriesSonificationTracksPointGrouping PointGrouping { get; set; }
		private VwapSeriesSonificationTracksPointGrouping PointGrouping_DefaultValue { get; set; }
		...
		/// </summary>
		public VwapSeriesSonificationTracksType Type { get; set; }
		private VwapSeriesSonificationTracksType Type_DefaultValue { get; set; }
