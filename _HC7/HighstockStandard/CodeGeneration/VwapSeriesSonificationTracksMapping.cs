...
{
	public partial class VwapSeriesSonificationTracksMapping  : BaseObject
	{
		Hashtable h = new Hashtable();

		public VwapSeriesSonificationTracksMapping()
		{
			Frequency = Frequency_DefaultValue = new VwapSeriesSonificationTracksMappingFrequency();
			GapBetweenNotes = GapBetweenNotes_DefaultValue = new VwapSeriesSonificationTracksMappingGapBetweenNotes();
			Highpass = Highpass_DefaultValue = new VwapSeriesSonificationTracksMappingHighpass();
			Lowpass = Lowpass_DefaultValue = new VwapSeriesSonificationTracksMappingLowpass();
			NoteDuration = NoteDuration_DefaultValue = new VwapSeriesSonificationTracksMappingNoteDuration();
			Pan = Pan_DefaultValue = new VwapSeriesSonificationTracksMappingPan();
			Pitch = Pitch_DefaultValue = new VwapSeriesSonificationTracksMappingPitch();
			PitchString = PitchString_DefaultValue = "null";
			PitchNumber = PitchNumber_DefaultValue = null;
			PlayDelay = PlayDelay_DefaultValue = new VwapSeriesSonificationTracksMappingPlayDelay();
			Time = Time_DefaultValue = new VwapSeriesSonificationTracksMappingTime();
			TimeString = TimeString_DefaultValue = "null";
			TimeNumber = TimeNumber_DefaultValue = null;
			Tremolo = Tremolo_DefaultValue = new VwapSeriesSonificationTracksMappingTremolo();
			Volume = Volume_DefaultValue = new VwapSeriesSonificationTracksMappingVolume();
		...
		/// </summary>
		public VwapSeriesSonificationTracksMappingFrequency Frequency { get; set; }
		private VwapSeriesSonificationTracksMappingFrequency Frequency_DefaultValue { get; set; }
		...
		/// </summary>
		public VwapSeriesSonificationTracksMappingGapBetweenNotes GapBetweenNotes { get; set; }
		private VwapSeriesSonificationTracksMappingGapBetweenNotes GapBetweenNotes_DefaultValue { get; set; }
		...
		/// </summary>
		public VwapSeriesSonificationTracksMappingHighpass Highpass { get; set; }
		private VwapSeriesSonificationTracksMappingHighpass Highpass_DefaultValue { get; set; }
		...
		/// </summary>
		public VwapSeriesSonificationTracksMappingLowpass Lowpass { get; set; }
		private VwapSeriesSonificationTracksMappingLowpass Lowpass_DefaultValue { get; set; }
		...
		/// </summary>
		public VwapSeriesSonificationTracksMappingNoteDuration NoteDuration { get; set; }
		private VwapSeriesSonificationTracksMappingNoteDuration NoteDuration_DefaultValue { get; set; }
		...
		/// </summary>
		public VwapSeriesSonificationTracksMappingPan Pan { get; set; }
		private VwapSeriesSonificationTracksMappingPan Pan_DefaultValue { get; set; }
		...
		/// </summary>
		public VwapSeriesSonificationTracksMappingPitch Pitch { get; set; }
		private VwapSeriesSonificationTracksMappingPitch Pitch_DefaultValue { get; set; }
		...
		/// </summary>
		public VwapSeriesSonificationTracksMappingPlayDelay PlayDelay { get; set; }
		private VwapSeriesSonificationTracksMappingPlayDelay PlayDelay_DefaultValue { get; set; }
		...
		/// </summary>
		public VwapSeriesSonificationTracksMappingTime Time { get; set; }
		private VwapSeriesSonificationTracksMappingTime Time_DefaultValue { get; set; }
		...
		/// </summary>
		public VwapSeriesSonificationTracksMappingTremolo Tremolo { get; set; }
		private VwapSeriesSonificationTracksMappingTremolo Tremolo_DefaultValue { get; set; }
		 

		/// <summary>
		/// The volume of notes, from 0 to 1.
		/// </summary>
		public VwapSeriesSonificationTracksMappingVolume Volume { get; set; }
		private VwapSeriesSonificationTracksMappingVolume Volume_DefaultValue { get; set; }
