...
{
	public partial class VwapSeriesSonificationTracksMappingFrequency  : BaseObject
	{
		Hashtable h = new Hashtable();

		public VwapSeriesSonificationTracksMappingFrequency()
		{
			MapFunction = MapFunction_DefaultValue = VwapSeriesSonificationTracksMappingFrequencyMapFunction.Linear;
			MapTo = MapTo_DefaultValue = "";
			Max = Max_DefaultValue = null;
			Min = Min_DefaultValue = null;
			Value = Value_DefaultValue = null;
			Within = Within_DefaultValue = VwapSeriesSonificationTracksMappingFrequencyWithin.Chart;
		...
		/// </summary>
		public VwapSeriesSonificationTracksMappingFrequencyMapFunction MapFunction { get; set; }
		private VwapSeriesSonificationTracksMappingFrequencyMapFunction MapFunction_DefaultValue { get; set; }
		...
		/// </summary>
		public VwapSeriesSonificationTracksMappingFrequencyWithin Within { get; set; }
		private VwapSeriesSonificationTracksMappingFrequencyWithin Within_DefaultValue { get; set; }
