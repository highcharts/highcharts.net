...
{
	public partial class VwapSeriesSonificationTracksMappingLowpassResonance  : BaseObject
	{
		Hashtable h = new Hashtable();

		public VwapSeriesSonificationTracksMappingLowpassResonance()
		{
			MapFunction = MapFunction_DefaultValue = VwapSeriesSonificationTracksMappingLowpassResonanceMapFunction.Linear;
			MapTo = MapTo_DefaultValue = "";
			Max = Max_DefaultValue = null;
			Min = Min_DefaultValue = null;
			Value = Value_DefaultValue = null;
			Within = Within_DefaultValue = VwapSeriesSonificationTracksMappingLowpassResonanceWithin.Chart;
		...
		/// </summary>
		public VwapSeriesSonificationTracksMappingLowpassResonanceMapFunction MapFunction { get; set; }
		private VwapSeriesSonificationTracksMappingLowpassResonanceMapFunction MapFunction_DefaultValue { get; set; }
		...
		/// </summary>
		public VwapSeriesSonificationTracksMappingLowpassResonanceWithin Within { get; set; }
		private VwapSeriesSonificationTracksMappingLowpassResonanceWithin Within_DefaultValue { get; set; }
