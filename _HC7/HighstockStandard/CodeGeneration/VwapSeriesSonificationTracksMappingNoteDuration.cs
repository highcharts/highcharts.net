...
{
	public partial class VwapSeriesSonificationTracksMappingNoteDuration  : BaseObject
	{
		Hashtable h = new Hashtable();

		public VwapSeriesSonificationTracksMappingNoteDuration()
		{
			MapFunction = MapFunction_DefaultValue = VwapSeriesSonificationTracksMappingNoteDurationMapFunction.Linear;
			MapTo = MapTo_DefaultValue = "";
			Max = Max_DefaultValue = null;
			Min = Min_DefaultValue = null;
			Value = Value_DefaultValue = null;
			Within = Within_DefaultValue = VwapSeriesSonificationTracksMappingNoteDurationWithin.Chart;
		...
		/// </summary>
		public VwapSeriesSonificationTracksMappingNoteDurationMapFunction MapFunction { get; set; }
		private VwapSeriesSonificationTracksMappingNoteDurationMapFunction MapFunction_DefaultValue { get; set; }
		...
		/// </summary>
		public VwapSeriesSonificationTracksMappingNoteDurationWithin Within { get; set; }
		private VwapSeriesSonificationTracksMappingNoteDurationWithin Within_DefaultValue { get; set; }
