...
{
	public partial class VwapSeriesSonificationTracksMappingPan  : BaseObject
	{
		Hashtable h = new Hashtable();

		public VwapSeriesSonificationTracksMappingPan()
		{
			MapFunction = MapFunction_DefaultValue = VwapSeriesSonificationTracksMappingPanMapFunction.Linear;
			MapTo = MapTo_DefaultValue = "";
			Max = Max_DefaultValue = null;
			Min = Min_DefaultValue = null;
			Value = Value_DefaultValue = null;
			Within = Within_DefaultValue = VwapSeriesSonificationTracksMappingPanWithin.Chart;
		...
		/// </summary>
		public VwapSeriesSonificationTracksMappingPanMapFunction MapFunction { get; set; }
		private VwapSeriesSonificationTracksMappingPanMapFunction MapFunction_DefaultValue { get; set; }
		...
		/// </summary>
		public VwapSeriesSonificationTracksMappingPanWithin Within { get; set; }
		private VwapSeriesSonificationTracksMappingPanWithin Within_DefaultValue { get; set; }
