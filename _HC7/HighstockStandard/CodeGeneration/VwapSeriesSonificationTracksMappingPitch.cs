...
{
	public partial class VwapSeriesSonificationTracksMappingPitch  : BaseObject
	{
		Hashtable h = new Hashtable();

		public VwapSeriesSonificationTracksMappingPitch()
		{
			MapFunction = MapFunction_DefaultValue = VwapSeriesSonificationTracksMappingPitchMapFunction.Linear;
		...
		/// </summary>
		public VwapSeriesSonificationTracksMappingPitchMapFunction MapFunction { get; set; }
		private VwapSeriesSonificationTracksMappingPitchMapFunction MapFunction_DefaultValue { get; set; }
