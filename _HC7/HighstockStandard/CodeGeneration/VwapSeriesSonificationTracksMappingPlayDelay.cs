...
{
	public partial class VwapSeriesSonificationTracksMappingPlayDelay  : BaseObject
	{
		Hashtable h = new Hashtable();

		public VwapSeriesSonificationTracksMappingPlayDelay()
		{
			MapFunction = MapFunction_DefaultValue = VwapSeriesSonificationTracksMappingPlayDelayMapFunction.Linear;
			MapTo = MapTo_DefaultValue = "";
			Max = Max_DefaultValue = null;
			Min = Min_DefaultValue = null;
			Value = Value_DefaultValue = null;
			Within = Within_DefaultValue = VwapSeriesSonificationTracksMappingPlayDelayWithin.Chart;
		...
		/// </summary>
		public VwapSeriesSonificationTracksMappingPlayDelayMapFunction MapFunction { get; set; }
		private VwapSeriesSonificationTracksMappingPlayDelayMapFunction MapFunction_DefaultValue { get; set; }
		...
		/// </summary>
		public VwapSeriesSonificationTracksMappingPlayDelayWithin Within { get; set; }
		private VwapSeriesSonificationTracksMappingPlayDelayWithin Within_DefaultValue { get; set; }
