...
{
	public partial class VwapSeriesSonificationTracksMappingTime  : BaseObject
	{
		Hashtable h = new Hashtable();

		public VwapSeriesSonificationTracksMappingTime()
		{
			MapFunction = MapFunction_DefaultValue = VwapSeriesSonificationTracksMappingTimeMapFunction.Linear;
			MapTo = MapTo_DefaultValue = "";
			Max = Max_DefaultValue = null;
			Min = Min_DefaultValue = null;
			Value = Value_DefaultValue = null;
			Within = Within_DefaultValue = VwapSeriesSonificationTracksMappingTimeWithin.Chart;
		...
		/// </summary>
		public VwapSeriesSonificationTracksMappingTimeMapFunction MapFunction { get; set; }
		private VwapSeriesSonificationTracksMappingTimeMapFunction MapFunction_DefaultValue { get; set; }
		...
		/// </summary>
		public VwapSeriesSonificationTracksMappingTimeWithin Within { get; set; }
		private VwapSeriesSonificationTracksMappingTimeWithin Within_DefaultValue { get; set; }
