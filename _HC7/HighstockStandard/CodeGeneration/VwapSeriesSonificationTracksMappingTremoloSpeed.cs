...
{
	public partial class VwapSeriesSonificationTracksMappingTremoloSpeed  : BaseObject
	{
		Hashtable h = new Hashtable();

		public VwapSeriesSonificationTracksMappingTremoloSpeed()
		{
			MapFunction = MapFunction_DefaultValue = VwapSeriesSonificationTracksMappingTremoloSpeedMapFunction.Linear;
			MapTo = MapTo_DefaultValue = "";
			Max = Max_DefaultValue = null;
			Min = Min_DefaultValue = null;
			Value = Value_DefaultValue = null;
			Within = Within_DefaultValue = VwapSeriesSonificationTracksMappingTremoloSpeedWithin.Chart;
		...
		/// </summary>
		public VwapSeriesSonificationTracksMappingTremoloSpeedMapFunction MapFunction { get; set; }
		private VwapSeriesSonificationTracksMappingTremoloSpeedMapFunction MapFunction_DefaultValue { get; set; }
		...
		/// </summary>
		public VwapSeriesSonificationTracksMappingTremoloSpeedWithin Within { get; set; }
		private VwapSeriesSonificationTracksMappingTremoloSpeedWithin Within_DefaultValue { get; set; }
