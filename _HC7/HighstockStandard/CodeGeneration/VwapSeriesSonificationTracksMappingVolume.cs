...
{
	public partial class VwapSeriesSonificationTracksMappingVolume  : BaseObject
	{
		Hashtable h = new Hashtable();

		public VwapSeriesSonificationTracksMappingVolume()
		{
			MapFunction = MapFunction_DefaultValue = VwapSeriesSonificationTracksMappingVolumeMapFunction.Linear;
			MapTo = MapTo_DefaultValue = "";
			Max = Max_DefaultValue = null;
			Min = Min_DefaultValue = null;
			Value = Value_DefaultValue = null;
			Within = Within_DefaultValue = VwapSeriesSonificationTracksMappingVolumeWithin.Chart;
		...
		/// </summary>
		public VwapSeriesSonificationTracksMappingVolumeMapFunction MapFunction { get; set; }
		private VwapSeriesSonificationTracksMappingVolumeMapFunction MapFunction_DefaultValue { get; set; }
		...
		/// </summary>
		public VwapSeriesSonificationTracksMappingVolumeWithin Within { get; set; }
		private VwapSeriesSonificationTracksMappingVolumeWithin Within_DefaultValue { get; set; }
