...
{
	public partial class WilliamsrSeries  : Series
	{
		Hashtable h = new Hashtable();

		public WilliamsrSeries()
		{
			Accessibility = Accessibility_DefaultValue = new WilliamsrSeriesAccessibility();
			AllowPointSelect = AllowPointSelect_DefaultValue = false;
			Animation = Animation_DefaultValue = new Animation() { Enabled = true };
			AnimationBool = AnimationBool_DefaultValue = true;
			AnimationLimit = AnimationLimit_DefaultValue = null;
			BoostBlending = BoostBlending_DefaultValue = WilliamsrSeriesBoostBlending.Undefined;
			...
			Compare = Compare_DefaultValue = WilliamsrSeriesCompare.Percent;
			CompareBase = CompareBase_DefaultValue = WilliamsrSeriesCompareBase.Min;
			...
			Cursor = Cursor_DefaultValue = WilliamsrSeriesCursor.Null;
			Custom = Custom_DefaultValue = new Hashtable();
			DashStyle = DashStyle_DefaultValue = WilliamsrSeriesDashStyle.Null;
			DataGrouping = DataGrouping_DefaultValue = new WilliamsrSeriesDataGrouping();
			DataLabels = DataLabels_DefaultValue = new WilliamsrSeriesDataLabels();
			DataSorting = DataSorting_DefaultValue = new WilliamsrSeriesDataSorting();
			Description = Description_DefaultValue = "";
			Dumbell = Dumbell_DefaultValue = new WilliamsrSeriesDumbell();
			EnableMouseTracking = EnableMouseTracking_DefaultValue = true;
			Events = Events_DefaultValue = new WilliamsrSeriesEvents();
			FindNearestPointBy = FindNearestPointBy_DefaultValue = WilliamsrSeriesFindNearestPointBy.X;
			GapSize = GapSize_DefaultValue = 0;
			GapUnit = GapUnit_DefaultValue = WilliamsrSeriesGapUnit.Relative;
			GetExtremesFromAll = GetExtremesFromAll_DefaultValue = false;
			Id = Id_DefaultValue = "";
			InactiveOtherPoints = InactiveOtherPoints_DefaultValue = false;
			IncludeInDataExport = IncludeInDataExport_DefaultValue = null;
			Index = Index_DefaultValue = null;
			Label = Label_DefaultValue = new WilliamsrSeriesLabel();
			LastPrice = LastPrice_DefaultValue = new WilliamsrSeriesLastPrice();
			LastVisiblePrice = LastVisiblePrice_DefaultValue = new WilliamsrSeriesLastVisiblePrice();
			LegendIndex = LegendIndex_DefaultValue = null;
			LegendSymbol = LegendSymbol_DefaultValue = WilliamsrSeriesLegendSymbol.Rectangle;
			Linecap = Linecap_DefaultValue = WilliamsrSeriesLinecap.Round;
			LineWidth = LineWidth_DefaultValue = 2;
			LinkedTo = LinkedTo_DefaultValue = "";
			Marker = Marker_DefaultValue = new WilliamsrSeriesMarker();
			Name = Name_DefaultValue = "";
			NegativeColor = NegativeColor_DefaultValue = "";
			OnPoint = OnPoint_DefaultValue = new WilliamsrSeriesOnPoint();
			Opacity = Opacity_DefaultValue = 1;
			Params = Params_DefaultValue = new WilliamsrSeriesParams();
			Point = Point_DefaultValue = new WilliamsrSeriesPoint();
			...
			Sonification = Sonification_DefaultValue = new WilliamsrSeriesSonification();
			Stack = Stack_DefaultValue = "";
			StackNumber = StackNumber_DefaultValue = null;
			States = States_DefaultValue = new WilliamsrSeriesStates();
			Step = Step_DefaultValue = WilliamsrSeriesStep.Null;
			StickyTracking = StickyTracking_DefaultValue = true;
			Threshold = Threshold_DefaultValue = 0;
			Tooltip = Tooltip_DefaultValue = new WilliamsrSeriesTooltip();
			...
			Zones = Zones_DefaultValue = new List<WilliamsrSeriesZones>();
		...
		/// </summary>
		public WilliamsrSeriesAccessibility Accessibility { get; set; }
		private WilliamsrSeriesAccessibility Accessibility_DefaultValue { get; set; }
		...
		/// </summary>
		public WilliamsrSeriesBoostBlending BoostBlending { get; set; }
		private WilliamsrSeriesBoostBlending BoostBlending_DefaultValue { get; set; }
		...
		/// </summary>
		public WilliamsrSeriesCompare Compare { get; set; }
		private WilliamsrSeriesCompare Compare_DefaultValue { get; set; }
		 

		/// <summary>
		/// When [compare](#plotOptions.series.compare) is `percent`, this optiondictates whether to use 0 or 100 as the base of comparison.
		/// </summary>
		public WilliamsrSeriesCompareBase CompareBase { get; set; }
		private WilliamsrSeriesCompareBase CompareBase_DefaultValue { get; set; }
		...
		/// </summary>
		public WilliamsrSeriesCursor Cursor { get; set; }
		private WilliamsrSeriesCursor Cursor_DefaultValue { get; set; }
		...
		/// </summary>
		public WilliamsrSeriesDashStyle DashStyle { get; set; }
		private WilliamsrSeriesDashStyle DashStyle_DefaultValue { get; set; }
		...
		/// </summary>
		public WilliamsrSeriesDataGrouping DataGrouping { get; set; }
		private WilliamsrSeriesDataGrouping DataGrouping_DefaultValue { get; set; }
		...
		/// </summary>
		public WilliamsrSeriesDataLabels DataLabels { get; set; }
		private WilliamsrSeriesDataLabels DataLabels_DefaultValue { get; set; }
		 

		/// <summary>
		/// Options for the series data sorting.
		/// </summary>
		public WilliamsrSeriesDataSorting DataSorting { get; set; }
		private WilliamsrSeriesDataSorting DataSorting_DefaultValue { get; set; }
		...
		/// 
		/// </summary>
		public WilliamsrSeriesDumbell Dumbell { get; set; }
		private WilliamsrSeriesDumbell Dumbell_DefaultValue { get; set; }
		...
		/// </summary>
		public WilliamsrSeriesEvents Events { get; set; }
		private WilliamsrSeriesEvents Events_DefaultValue { get; set; }
		...
		/// </summary>
		public WilliamsrSeriesFindNearestPointBy FindNearestPointBy { get; set; }
		private WilliamsrSeriesFindNearestPointBy FindNearestPointBy_DefaultValue { get; set; }
		...
		/// </summary>
		public WilliamsrSeriesGapUnit GapUnit { get; set; }
		private WilliamsrSeriesGapUnit GapUnit_DefaultValue { get; set; }
		...
		/// </summary>
		public WilliamsrSeriesLabel Label { get; set; }
		private WilliamsrSeriesLabel Label_DefaultValue { get; set; }
		 

		/// <summary>
		/// The line marks the last price from all points.
		/// </summary>
		public WilliamsrSeriesLastPrice LastPrice { get; set; }
		private WilliamsrSeriesLastPrice LastPrice_DefaultValue { get; set; }
		 

		/// <summary>
		/// The line marks the last price from visible range of points.
		/// </summary>
		public WilliamsrSeriesLastVisiblePrice LastVisiblePrice { get; set; }
		private WilliamsrSeriesLastVisiblePrice LastVisiblePrice_DefaultValue { get; set; }
		...
		/// </summary>
		public WilliamsrSeriesLegendSymbol LegendSymbol { get; set; }
		private WilliamsrSeriesLegendSymbol LegendSymbol_DefaultValue { get; set; }
		 

		/// <summary>
		/// The line cap used for line ends and line joins on the graph.
		/// </summary>
		public WilliamsrSeriesLinecap Linecap { get; set; }
		private WilliamsrSeriesLinecap Linecap_DefaultValue { get; set; }
		...
		/// </summary>
		public WilliamsrSeriesMarker Marker { get; set; }
		private WilliamsrSeriesMarker Marker_DefaultValue { get; set; }
		...
		/// </summary>
		public WilliamsrSeriesOnPoint OnPoint { get; set; }
		private WilliamsrSeriesOnPoint OnPoint_DefaultValue { get; set; }
		...
		/// </summary>
		public WilliamsrSeriesParams Params { get; set; }
		private WilliamsrSeriesParams Params_DefaultValue { get; set; }
		 

		/// <summary>
		/// Properties for each single point.
		/// </summary>
		public WilliamsrSeriesPoint Point { get; set; }
		private WilliamsrSeriesPoint Point_DefaultValue { get; set; }
		...
		/// </summary>
		public WilliamsrSeriesSonification Sonification { get; set; }
		private WilliamsrSeriesSonification Sonification_DefaultValue { get; set; }
		...
		/// 
		/// </summary>
		public WilliamsrSeriesStates States { get; set; }
		private WilliamsrSeriesStates States_DefaultValue { get; set; }
		 

		/// <summary>
		/// Whether to apply steps to the line. Possible values are `left`,`center` and `right`.
		/// </summary>
		public WilliamsrSeriesStep Step { get; set; }
		private WilliamsrSeriesStep Step_DefaultValue { get; set; }
		...
		/// </summary>
		public WilliamsrSeriesTooltip Tooltip { get; set; }
		private WilliamsrSeriesTooltip Tooltip_DefaultValue { get; set; }
		...
		/// </summary>
		public List<WilliamsrSeriesZones> Zones { get; set; }
		private List<WilliamsrSeriesZones> Zones_DefaultValue { get; set; }
