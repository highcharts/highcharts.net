...
namespace Highsoft.Web.Mvc.Stocks
{
	public partial class WilliamsrSeries  : Series
	{
		...
		public WilliamsrSeries()
		{
			...
			Zones = Zones_DefaultValue = new List<WilliamsrSeriesZone>();
		...
		/// </summary>
		public List<WilliamsrSeriesZone> Zones { get; set; }
		private List<WilliamsrSeriesZone> Zones_DefaultValue { get; set; }
