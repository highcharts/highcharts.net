...
namespace Highsoft.Web.Mvc.Stocks
{
	public partial class WilliamsrSeries  : Series
	{
		public WilliamsrSeries()
		{
			...
			DragDrop = DragDrop_DefaultValue = new WilliamsrSeriesDragDrop();
		...
		/// </summary>
		public WilliamsrSeriesDragDrop DragDrop { get; set; }
		private WilliamsrSeriesDragDrop DragDrop_DefaultValue { get; set; }
