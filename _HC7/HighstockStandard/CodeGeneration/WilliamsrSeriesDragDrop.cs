...
{
	public partial class WilliamsrSeriesDragDrop  : BaseObject
	{
		public WilliamsrSeriesDragDrop()
		{
			DraggableX = DraggableX_DefaultValue = null;
			DraggableY = DraggableY_DefaultValue = null;
			DragHandle = DragHandle_DefaultValue = new WilliamsrSeriesDragDropDragHandle();
			...
			GuideBox = GuideBox_DefaultValue = new WilliamsrSeriesDragDropGuideBox();
		...
		/// </summary>
		public WilliamsrSeriesDragDropDragHandle DragHandle { get; set; }
		private WilliamsrSeriesDragDropDragHandle DragHandle_DefaultValue { get; set; }
		...
		/// </summary>
		public WilliamsrSeriesDragDropGuideBox GuideBox { get; set; }
		private WilliamsrSeriesDragDropGuideBox GuideBox_DefaultValue { get; set; }
