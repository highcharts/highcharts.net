...
{
	public partial class WilliamsrSeriesDragDropDragHandle  : BaseObject
	{
		public WilliamsrSeriesDragDropDragHandle()
		{
		...
		internal override Hashtable ToHashtable()
		{
			...
			if (PathFormatter != PathFormatter_DefaultValue) { h.Add("pathFormatter",PathFormatter); Highstock.AddFunction("WilliamsrSeriesDragDropDragHandlePathFormatter.pathFormatter", PathFormatter); }  
