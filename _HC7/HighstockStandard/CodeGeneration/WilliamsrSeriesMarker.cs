...
{
	public partial class WilliamsrSeriesMarker  : BaseObject
	{
		public WilliamsrSeriesMarker()
		{
			...
			States = States_DefaultValue = new WilliamsrSeriesMarkerStates();
		...
		/// </summary>
		public WilliamsrSeriesMarkerStates States { get; set; }
		private WilliamsrSeriesMarkerStates States_DefaultValue { get; set; }
