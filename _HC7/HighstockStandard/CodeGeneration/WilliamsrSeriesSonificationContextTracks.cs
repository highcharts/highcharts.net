...
{
	public partial class WilliamsrSeriesSonificationContextTracks  : BaseObject
	{
		Hashtable h = new Hashtable();

		public WilliamsrSeriesSonificationContextTracks()
		{
			ActiveWhen = ActiveWhen_DefaultValue = new WilliamsrSeriesSonificationContextTracksActiveWhen();
			Instrument = Instrument_DefaultValue = null;
			InstrumentString = InstrumentString_DefaultValue = "null";
			Mapping = Mapping_DefaultValue = new WilliamsrSeriesSonificationContextTracksMapping();
			MidiName = MidiName_DefaultValue = "";
			PointGrouping = PointGrouping_DefaultValue = new WilliamsrSeriesSonificationContextTracksPointGrouping();
			...
			Type = Type_DefaultValue = WilliamsrSeriesSonificationContextTracksType.Instrument;
			ValueInterval = ValueInterval_DefaultValue = null;
			ValueMapFunction = ValueMapFunction_DefaultValue = WilliamsrSeriesSonificationContextTracksValueMapFunction.Linear;
		...
		/// </summary>
		public WilliamsrSeriesSonificationContextTracksActiveWhen ActiveWhen { get; set; }
		private WilliamsrSeriesSonificationContextTracksActiveWhen ActiveWhen_DefaultValue { get; set; }
		...
		/// </summary>
		public WilliamsrSeriesSonificationContextTracksMapping Mapping { get; set; }
		private WilliamsrSeriesSonificationContextTracksMapping Mapping_DefaultValue { get; set; }
		...
		/// </summary>
		public WilliamsrSeriesSonificationContextTracksPointGrouping PointGrouping { get; set; }
		private WilliamsrSeriesSonificationContextTracksPointGrouping PointGrouping_DefaultValue { get; set; }
		...
		/// </summary>
		public WilliamsrSeriesSonificationContextTracksType Type { get; set; }
		private WilliamsrSeriesSonificationContextTracksType Type_DefaultValue { get; set; }
		...
		/// </summary>
		public WilliamsrSeriesSonificationContextTracksValueMapFunction ValueMapFunction { get; set; }
		private WilliamsrSeriesSonificationContextTracksValueMapFunction ValueMapFunction_DefaultValue { get; set; }
