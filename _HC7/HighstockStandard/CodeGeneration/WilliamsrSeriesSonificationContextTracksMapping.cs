...
{
	public partial class WilliamsrSeriesSonificationContextTracksMapping  : BaseObject
	{
		Hashtable h = new Hashtable();

		public WilliamsrSeriesSonificationContextTracksMapping()
		{
			Frequency = Frequency_DefaultValue = new WilliamsrSeriesSonificationContextTracksMappingFrequency();
			GapBetweenNotes = GapBetweenNotes_DefaultValue = new WilliamsrSeriesSonificationContextTracksMappingGapBetweenNotes();
			Highpass = Highpass_DefaultValue = new WilliamsrSeriesSonificationContextTracksMappingHighpass();
			Lowpass = Lowpass_DefaultValue = new WilliamsrSeriesSonificationContextTracksMappingLowpass();
			NoteDuration = NoteDuration_DefaultValue = new WilliamsrSeriesSonificationContextTracksMappingNoteDuration();
			Pan = Pan_DefaultValue = new WilliamsrSeriesSonificationContextTracksMappingPan();
			Pitch = Pitch_DefaultValue = new WilliamsrSeriesSonificationContextTracksMappingPitch();
			PitchString = PitchString_DefaultValue = "null";
			PitchNumber = PitchNumber_DefaultValue = null;
			PlayDelay = PlayDelay_DefaultValue = new WilliamsrSeriesSonificationContextTracksMappingPlayDelay();
			Time = Time_DefaultValue = new WilliamsrSeriesSonificationContextTracksMappingTime();
			TimeString = TimeString_DefaultValue = "null";
			TimeNumber = TimeNumber_DefaultValue = null;
			Tremolo = Tremolo_DefaultValue = new WilliamsrSeriesSonificationContextTracksMappingTremolo();
			Volume = Volume_DefaultValue = new WilliamsrSeriesSonificationContextTracksMappingVolume();
		...
		/// </summary>
		public WilliamsrSeriesSonificationContextTracksMappingFrequency Frequency { get; set; }
		private WilliamsrSeriesSonificationContextTracksMappingFrequency Frequency_DefaultValue { get; set; }
		...
		/// </summary>
		public WilliamsrSeriesSonificationContextTracksMappingGapBetweenNotes GapBetweenNotes { get; set; }
		private WilliamsrSeriesSonificationContextTracksMappingGapBetweenNotes GapBetweenNotes_DefaultValue { get; set; }
		...
		/// </summary>
		public WilliamsrSeriesSonificationContextTracksMappingHighpass Highpass { get; set; }
		private WilliamsrSeriesSonificationContextTracksMappingHighpass Highpass_DefaultValue { get; set; }
		...
		/// </summary>
		public WilliamsrSeriesSonificationContextTracksMappingLowpass Lowpass { get; set; }
		private WilliamsrSeriesSonificationContextTracksMappingLowpass Lowpass_DefaultValue { get; set; }
		...
		/// </summary>
		public WilliamsrSeriesSonificationContextTracksMappingNoteDuration NoteDuration { get; set; }
		private WilliamsrSeriesSonificationContextTracksMappingNoteDuration NoteDuration_DefaultValue { get; set; }
		...
		/// </summary>
		public WilliamsrSeriesSonificationContextTracksMappingPan Pan { get; set; }
		private WilliamsrSeriesSonificationContextTracksMappingPan Pan_DefaultValue { get; set; }
		...
		/// </summary>
		public WilliamsrSeriesSonificationContextTracksMappingPitch Pitch { get; set; }
		private WilliamsrSeriesSonificationContextTracksMappingPitch Pitch_DefaultValue { get; set; }
		...
		/// </summary>
		public WilliamsrSeriesSonificationContextTracksMappingPlayDelay PlayDelay { get; set; }
		private WilliamsrSeriesSonificationContextTracksMappingPlayDelay PlayDelay_DefaultValue { get; set; }
		...
		/// </summary>
		public WilliamsrSeriesSonificationContextTracksMappingTime Time { get; set; }
		private WilliamsrSeriesSonificationContextTracksMappingTime Time_DefaultValue { get; set; }
		...
		/// </summary>
		public WilliamsrSeriesSonificationContextTracksMappingTremolo Tremolo { get; set; }
		private WilliamsrSeriesSonificationContextTracksMappingTremolo Tremolo_DefaultValue { get; set; }
		 

		/// <summary>
		/// The volume of notes, from 0 to 1.
		/// </summary>
		public WilliamsrSeriesSonificationContextTracksMappingVolume Volume { get; set; }
		private WilliamsrSeriesSonificationContextTracksMappingVolume Volume_DefaultValue { get; set; }
