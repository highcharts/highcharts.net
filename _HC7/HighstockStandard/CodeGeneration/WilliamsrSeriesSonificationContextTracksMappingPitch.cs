...
{
	public partial class WilliamsrSeriesSonificationContextTracksMappingPitch  : BaseObject
	{
		Hashtable h = new Hashtable();

		public WilliamsrSeriesSonificationContextTracksMappingPitch()
		{
			MapFunction = MapFunction_DefaultValue = WilliamsrSeriesSonificationContextTracksMappingPitchMapFunction.Linear;
		...
		/// </summary>
		public WilliamsrSeriesSonificationContextTracksMappingPitchMapFunction MapFunction { get; set; }
		private WilliamsrSeriesSonificationContextTracksMappingPitchMapFunction MapFunction_DefaultValue { get; set; }
