...
{
	public partial class WilliamsrSeriesSonificationTracks  : BaseObject
	{
		Hashtable h = new Hashtable();

		public WilliamsrSeriesSonificationTracks()
		{
			ActiveWhen = ActiveWhen_DefaultValue = new WilliamsrSeriesSonificationTracksActiveWhen();
			Instrument = Instrument_DefaultValue = null;
			InstrumentString = InstrumentString_DefaultValue = "null";
			Mapping = Mapping_DefaultValue = new WilliamsrSeriesSonificationTracksMapping();
			MidiName = MidiName_DefaultValue = "";
			PointGrouping = PointGrouping_DefaultValue = new WilliamsrSeriesSonificationTracksPointGrouping();
			RoundToMusicalNotes = RoundToMusicalNotes_DefaultValue = true;
			ShowPlayMarker = ShowPlayMarker_DefaultValue = true;
			Type = Type_DefaultValue = WilliamsrSeriesSonificationTracksType.Instrument;
		...
		/// </summary>
		public WilliamsrSeriesSonificationTracksActiveWhen ActiveWhen { get; set; }
		private WilliamsrSeriesSonificationTracksActiveWhen ActiveWhen_DefaultValue { get; set; }
		...
		/// </summary>
		public WilliamsrSeriesSonificationTracksMapping Mapping { get; set; }
		private WilliamsrSeriesSonificationTracksMapping Mapping_DefaultValue { get; set; }
		...
		/// </summary>
		public WilliamsrSeriesSonificationTracksPointGrouping PointGrouping { get; set; }
		private WilliamsrSeriesSonificationTracksPointGrouping PointGrouping_DefaultValue { get; set; }
		...
		/// </summary>
		public WilliamsrSeriesSonificationTracksType Type { get; set; }
		private WilliamsrSeriesSonificationTracksType Type_DefaultValue { get; set; }
