...
{
	public partial class WilliamsrSeriesSonificationTracksMappingLowpassResonance  : BaseObject
	{
		Hashtable h = new Hashtable();

		public WilliamsrSeriesSonificationTracksMappingLowpassResonance()
		{
			MapFunction = MapFunction_DefaultValue = WilliamsrSeriesSonificationTracksMappingLowpassResonanceMapFunction.Linear;
			MapTo = MapTo_DefaultValue = "";
			Max = Max_DefaultValue = null;
			Min = Min_DefaultValue = null;
			Value = Value_DefaultValue = null;
			Within = Within_DefaultValue = WilliamsrSeriesSonificationTracksMappingLowpassResonanceWithin.Chart;
		...
		/// </summary>
		public WilliamsrSeriesSonificationTracksMappingLowpassResonanceMapFunction MapFunction { get; set; }
		private WilliamsrSeriesSonificationTracksMappingLowpassResonanceMapFunction MapFunction_DefaultValue { get; set; }
		...
		/// </summary>
		public WilliamsrSeriesSonificationTracksMappingLowpassResonanceWithin Within { get; set; }
		private WilliamsrSeriesSonificationTracksMappingLowpassResonanceWithin Within_DefaultValue { get; set; }
