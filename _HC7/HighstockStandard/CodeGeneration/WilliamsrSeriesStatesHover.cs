...
{
	public partial class WilliamsrSeriesStatesHover  : BaseObject
	{
		Hashtable h = new Hashtable();

		public WilliamsrSeriesStatesHover()
		{
			Animation = Animation_DefaultValue = new Animation() { Enabled = true };
			AnimationBool = AnimationBool_DefaultValue = null;
			Enabled = Enabled_DefaultValue = true;
			Halo = Halo_DefaultValue = new WilliamsrSeriesStatesHoverHalo();
			LineWidth = LineWidth_DefaultValue = null;
			LineWidthPlus = LineWidthPlus_DefaultValue = 1;
			Marker = Marker_DefaultValue = new WilliamsrSeriesStatesHoverMarker();
		...
		/// </summary>
		public WilliamsrSeriesStatesHoverHalo Halo { get; set; }
		private WilliamsrSeriesStatesHoverHalo Halo_DefaultValue { get; set; }
		...
		/// </summary>
		public WilliamsrSeriesStatesHoverMarker Marker { get; set; }
		private WilliamsrSeriesStatesHoverMarker Marker_DefaultValue { get; set; }
