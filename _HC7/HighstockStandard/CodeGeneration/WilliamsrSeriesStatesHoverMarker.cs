...
{
	public partial class WilliamsrSeriesStatesHoverMarker  : BaseObject
	{
		public WilliamsrSeriesStatesHoverMarker()
		{
			...
			States = States_DefaultValue = new WilliamsrSeriesStatesHoverMarkerStates();
		...
		/// </summary>
		public WilliamsrSeriesStatesHoverMarkerStates States { get; set; }
		private WilliamsrSeriesStatesHoverMarkerStates States_DefaultValue { get; set; }
