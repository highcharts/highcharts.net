...
namespace Highsoft.Web.Mvc.Stocks
{
	public partial class WindbarbSeriesData  : BaseObject
	{
		...
		{
			Accessibility = Accessibility_DefaultValue = new WindbarbSeriesDataAccessibility();
			...
			DragDrop = DragDrop_DefaultValue = new WindbarbSeriesDataDragDrop();
		...
		/// 
		/// </summary>
		public WindbarbSeriesDataAccessibility Accessibility { get; set; }
		private WindbarbSeriesDataAccessibility Accessibility_DefaultValue { get; set; }
		...
		/// </summary>
		public WindbarbSeriesDataDragDrop DragDrop { get; set; }
		private WindbarbSeriesDataDragDrop DragDrop_DefaultValue { get; set; }
