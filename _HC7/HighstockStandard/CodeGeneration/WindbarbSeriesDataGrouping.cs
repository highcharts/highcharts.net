...
namespace Highsoft.Web.Mvc.Stocks
{
	public partial class WindbarbSeriesDataGrouping  : BaseObject
	{
		...
		internal override Hashtable ToHashtable()
		{
			...
			if (Approximation != Approximation_DefaultValue) { h.Add("approximation",Approximation); Highstock.AddFunction("WindbarbSeriesDataGroupingApproximation.approximation", Approximation); }  
