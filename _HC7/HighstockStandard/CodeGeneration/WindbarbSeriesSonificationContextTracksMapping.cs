...
{
	public partial class WindbarbSeriesSonificationContextTracksMapping  : BaseObject
	{
		Hashtable h = new Hashtable();

		public WindbarbSeriesSonificationContextTracksMapping()
		{
			Frequency = Frequency_DefaultValue = new WindbarbSeriesSonificationContextTracksMappingFrequency();
			GapBetweenNotes = GapBetweenNotes_DefaultValue = new WindbarbSeriesSonificationContextTracksMappingGapBetweenNotes();
			Highpass = Highpass_DefaultValue = new WindbarbSeriesSonificationContextTracksMappingHighpass();
			Lowpass = Lowpass_DefaultValue = new WindbarbSeriesSonificationContextTracksMappingLowpass();
			NoteDuration = NoteDuration_DefaultValue = new WindbarbSeriesSonificationContextTracksMappingNoteDuration();
			Pan = Pan_DefaultValue = new WindbarbSeriesSonificationContextTracksMappingPan();
			Pitch = Pitch_DefaultValue = new WindbarbSeriesSonificationContextTracksMappingPitch();
			PitchString = PitchString_DefaultValue = "null";
			PitchNumber = PitchNumber_DefaultValue = null;
			PlayDelay = PlayDelay_DefaultValue = new WindbarbSeriesSonificationContextTracksMappingPlayDelay();
			Time = Time_DefaultValue = new WindbarbSeriesSonificationContextTracksMappingTime();
			TimeString = TimeString_DefaultValue = "null";
			TimeNumber = TimeNumber_DefaultValue = null;
			Tremolo = Tremolo_DefaultValue = new WindbarbSeriesSonificationContextTracksMappingTremolo();
			Volume = Volume_DefaultValue = new WindbarbSeriesSonificationContextTracksMappingVolume();
		...
		/// </summary>
		public WindbarbSeriesSonificationContextTracksMappingFrequency Frequency { get; set; }
		private WindbarbSeriesSonificationContextTracksMappingFrequency Frequency_DefaultValue { get; set; }
		...
		/// </summary>
		public WindbarbSeriesSonificationContextTracksMappingGapBetweenNotes GapBetweenNotes { get; set; }
		private WindbarbSeriesSonificationContextTracksMappingGapBetweenNotes GapBetweenNotes_DefaultValue { get; set; }
		...
		/// </summary>
		public WindbarbSeriesSonificationContextTracksMappingHighpass Highpass { get; set; }
		private WindbarbSeriesSonificationContextTracksMappingHighpass Highpass_DefaultValue { get; set; }
		...
		/// </summary>
		public WindbarbSeriesSonificationContextTracksMappingLowpass Lowpass { get; set; }
		private WindbarbSeriesSonificationContextTracksMappingLowpass Lowpass_DefaultValue { get; set; }
		...
		/// </summary>
		public WindbarbSeriesSonificationContextTracksMappingNoteDuration NoteDuration { get; set; }
		private WindbarbSeriesSonificationContextTracksMappingNoteDuration NoteDuration_DefaultValue { get; set; }
		...
		/// </summary>
		public WindbarbSeriesSonificationContextTracksMappingPan Pan { get; set; }
		private WindbarbSeriesSonificationContextTracksMappingPan Pan_DefaultValue { get; set; }
		...
		/// </summary>
		public WindbarbSeriesSonificationContextTracksMappingPitch Pitch { get; set; }
		private WindbarbSeriesSonificationContextTracksMappingPitch Pitch_DefaultValue { get; set; }
		...
		/// </summary>
		public WindbarbSeriesSonificationContextTracksMappingPlayDelay PlayDelay { get; set; }
		private WindbarbSeriesSonificationContextTracksMappingPlayDelay PlayDelay_DefaultValue { get; set; }
		...
		/// </summary>
		public WindbarbSeriesSonificationContextTracksMappingTime Time { get; set; }
		private WindbarbSeriesSonificationContextTracksMappingTime Time_DefaultValue { get; set; }
		...
		/// </summary>
		public WindbarbSeriesSonificationContextTracksMappingTremolo Tremolo { get; set; }
		private WindbarbSeriesSonificationContextTracksMappingTremolo Tremolo_DefaultValue { get; set; }
		 

		/// <summary>
		/// The volume of notes, from 0 to 1.
		/// </summary>
		public WindbarbSeriesSonificationContextTracksMappingVolume Volume { get; set; }
		private WindbarbSeriesSonificationContextTracksMappingVolume Volume_DefaultValue { get; set; }
