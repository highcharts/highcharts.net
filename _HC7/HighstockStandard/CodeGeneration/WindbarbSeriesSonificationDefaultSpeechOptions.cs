...
{
	public partial class WindbarbSeriesSonificationDefaultSpeechOptions  : BaseObject
	{
		Hashtable h = new Hashtable();

		public WindbarbSeriesSonificationDefaultSpeechOptions()
		{
			ActiveWhen = ActiveWhen_DefaultValue = new WindbarbSeriesSonificationDefaultSpeechOptionsActiveWhen();
			Language = Language_DefaultValue = "en-US";
			Mapping = Mapping_DefaultValue = new WindbarbSeriesSonificationDefaultSpeechOptionsMapping();
			PointGrouping = PointGrouping_DefaultValue = new WindbarbSeriesSonificationDefaultSpeechOptionsPointGrouping();
			PreferredVoice = PreferredVoice_DefaultValue = "";
			ShowPlayMarker = ShowPlayMarker_DefaultValue = true;
			Type = Type_DefaultValue = WindbarbSeriesSonificationDefaultSpeechOptionsType.Instrument;
		...
		/// </summary>
		public WindbarbSeriesSonificationDefaultSpeechOptionsActiveWhen ActiveWhen { get; set; }
		private WindbarbSeriesSonificationDefaultSpeechOptionsActiveWhen ActiveWhen_DefaultValue { get; set; }
		...
		/// </summary>
		public WindbarbSeriesSonificationDefaultSpeechOptionsMapping Mapping { get; set; }
		private WindbarbSeriesSonificationDefaultSpeechOptionsMapping Mapping_DefaultValue { get; set; }
		 

		/// <summary>
		/// Options for point grouping, specifically for instrument tracks.
		/// </summary>
		public WindbarbSeriesSonificationDefaultSpeechOptionsPointGrouping PointGrouping { get; set; }
		private WindbarbSeriesSonificationDefaultSpeechOptionsPointGrouping PointGrouping_DefaultValue { get; set; }
		...
		/// </summary>
		public WindbarbSeriesSonificationDefaultSpeechOptionsType Type { get; set; }
		private WindbarbSeriesSonificationDefaultSpeechOptionsType Type_DefaultValue { get; set; }
