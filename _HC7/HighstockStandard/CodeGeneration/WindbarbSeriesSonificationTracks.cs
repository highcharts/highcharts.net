...
{
	public partial class WindbarbSeriesSonificationTracks  : BaseObject
	{
		Hashtable h = new Hashtable();

		public WindbarbSeriesSonificationTracks()
		{
			ActiveWhen = ActiveWhen_DefaultValue = new WindbarbSeriesSonificationTracksActiveWhen();
			Instrument = Instrument_DefaultValue = null;
			InstrumentString = InstrumentString_DefaultValue = "null";
			Mapping = Mapping_DefaultValue = new WindbarbSeriesSonificationTracksMapping();
			MidiName = MidiName_DefaultValue = "";
			PointGrouping = PointGrouping_DefaultValue = new WindbarbSeriesSonificationTracksPointGrouping();
			RoundToMusicalNotes = RoundToMusicalNotes_DefaultValue = true;
			ShowPlayMarker = ShowPlayMarker_DefaultValue = true;
			Type = Type_DefaultValue = WindbarbSeriesSonificationTracksType.Instrument;
		...
		/// </summary>
		public WindbarbSeriesSonificationTracksActiveWhen ActiveWhen { get; set; }
		private WindbarbSeriesSonificationTracksActiveWhen ActiveWhen_DefaultValue { get; set; }
		...
		/// </summary>
		public WindbarbSeriesSonificationTracksMapping Mapping { get; set; }
		private WindbarbSeriesSonificationTracksMapping Mapping_DefaultValue { get; set; }
		...
		/// </summary>
		public WindbarbSeriesSonificationTracksPointGrouping PointGrouping { get; set; }
		private WindbarbSeriesSonificationTracksPointGrouping PointGrouping_DefaultValue { get; set; }
		...
		/// </summary>
		public WindbarbSeriesSonificationTracksType Type { get; set; }
		private WindbarbSeriesSonificationTracksType Type_DefaultValue { get; set; }
