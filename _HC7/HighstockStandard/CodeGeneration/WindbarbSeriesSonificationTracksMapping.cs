...
{
	public partial class WindbarbSeriesSonificationTracksMapping  : BaseObject
	{
		Hashtable h = new Hashtable();

		public WindbarbSeriesSonificationTracksMapping()
		{
			Frequency = Frequency_DefaultValue = new WindbarbSeriesSonificationTracksMappingFrequency();
			GapBetweenNotes = GapBetweenNotes_DefaultValue = new WindbarbSeriesSonificationTracksMappingGapBetweenNotes();
			Highpass = Highpass_DefaultValue = new WindbarbSeriesSonificationTracksMappingHighpass();
			Lowpass = Lowpass_DefaultValue = new WindbarbSeriesSonificationTracksMappingLowpass();
			NoteDuration = NoteDuration_DefaultValue = new WindbarbSeriesSonificationTracksMappingNoteDuration();
			Pan = Pan_DefaultValue = new WindbarbSeriesSonificationTracksMappingPan();
			Pitch = Pitch_DefaultValue = new WindbarbSeriesSonificationTracksMappingPitch();
			PitchString = PitchString_DefaultValue = "null";
			PitchNumber = PitchNumber_DefaultValue = null;
			PlayDelay = PlayDelay_DefaultValue = new WindbarbSeriesSonificationTracksMappingPlayDelay();
			Time = Time_DefaultValue = new WindbarbSeriesSonificationTracksMappingTime();
			TimeString = TimeString_DefaultValue = "null";
			TimeNumber = TimeNumber_DefaultValue = null;
			Tremolo = Tremolo_DefaultValue = new WindbarbSeriesSonificationTracksMappingTremolo();
			Volume = Volume_DefaultValue = new WindbarbSeriesSonificationTracksMappingVolume();
		...
		/// </summary>
		public WindbarbSeriesSonificationTracksMappingFrequency Frequency { get; set; }
		private WindbarbSeriesSonificationTracksMappingFrequency Frequency_DefaultValue { get; set; }
		...
		/// </summary>
		public WindbarbSeriesSonificationTracksMappingGapBetweenNotes GapBetweenNotes { get; set; }
		private WindbarbSeriesSonificationTracksMappingGapBetweenNotes GapBetweenNotes_DefaultValue { get; set; }
		...
		/// </summary>
		public WindbarbSeriesSonificationTracksMappingHighpass Highpass { get; set; }
		private WindbarbSeriesSonificationTracksMappingHighpass Highpass_DefaultValue { get; set; }
		...
		/// </summary>
		public WindbarbSeriesSonificationTracksMappingLowpass Lowpass { get; set; }
		private WindbarbSeriesSonificationTracksMappingLowpass Lowpass_DefaultValue { get; set; }
		...
		/// </summary>
		public WindbarbSeriesSonificationTracksMappingNoteDuration NoteDuration { get; set; }
		private WindbarbSeriesSonificationTracksMappingNoteDuration NoteDuration_DefaultValue { get; set; }
		...
		/// </summary>
		public WindbarbSeriesSonificationTracksMappingPan Pan { get; set; }
		private WindbarbSeriesSonificationTracksMappingPan Pan_DefaultValue { get; set; }
		...
		/// </summary>
		public WindbarbSeriesSonificationTracksMappingPitch Pitch { get; set; }
		private WindbarbSeriesSonificationTracksMappingPitch Pitch_DefaultValue { get; set; }
		...
		/// </summary>
		public WindbarbSeriesSonificationTracksMappingPlayDelay PlayDelay { get; set; }
		private WindbarbSeriesSonificationTracksMappingPlayDelay PlayDelay_DefaultValue { get; set; }
		...
		/// </summary>
		public WindbarbSeriesSonificationTracksMappingTime Time { get; set; }
		private WindbarbSeriesSonificationTracksMappingTime Time_DefaultValue { get; set; }
		...
		/// </summary>
		public WindbarbSeriesSonificationTracksMappingTremolo Tremolo { get; set; }
		private WindbarbSeriesSonificationTracksMappingTremolo Tremolo_DefaultValue { get; set; }
		 

		/// <summary>
		/// The volume of notes, from 0 to 1.
		/// </summary>
		public WindbarbSeriesSonificationTracksMappingVolume Volume { get; set; }
		private WindbarbSeriesSonificationTracksMappingVolume Volume_DefaultValue { get; set; }
