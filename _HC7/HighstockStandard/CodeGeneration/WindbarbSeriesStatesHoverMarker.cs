...
{
	public partial class WindbarbSeriesStatesHoverMarker  : BaseObject
	{
		public WindbarbSeriesStatesHoverMarker()
		{
			...
			States = States_DefaultValue = new WindbarbSeriesStatesHoverMarkerStates();
		...
		/// </summary>
		public WindbarbSeriesStatesHoverMarkerStates States { get; set; }
		private WindbarbSeriesStatesHoverMarkerStates States_DefaultValue { get; set; }
