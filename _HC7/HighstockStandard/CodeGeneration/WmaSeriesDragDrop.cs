...
{
	public partial class WmaSeriesDragDrop  : BaseObject
	{
		public WmaSeriesDragDrop()
		{
			DraggableX = DraggableX_DefaultValue = null;
			DraggableY = DraggableY_DefaultValue = null;
			DragHandle = DragHandle_DefaultValue = new WmaSeriesDragDropDragHandle();
			...
			GuideBox = GuideBox_DefaultValue = new WmaSeriesDragDropGuideBox();
		...
		/// </summary>
		public WmaSeriesDragDropDragHandle DragHandle { get; set; }
		private WmaSeriesDragDropDragHandle DragHandle_DefaultValue { get; set; }
		...
		/// </summary>
		public WmaSeriesDragDropGuideBox GuideBox { get; set; }
		private WmaSeriesDragDropGuideBox GuideBox_DefaultValue { get; set; }
