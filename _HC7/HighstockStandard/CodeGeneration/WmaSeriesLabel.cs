...
{
	public partial class WmaSeriesLabel  : BaseObject
	{
		public WmaSeriesLabel()
		{
			...
			Style = Style_DefaultValue = new WmaSeriesLabelStyle();
		...
		/// </summary>
		public WmaSeriesLabelStyle Style { get; set; }
		private WmaSeriesLabelStyle Style_DefaultValue { get; set; }
