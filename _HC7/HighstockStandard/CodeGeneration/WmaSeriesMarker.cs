...
{
	public partial class WmaSeriesMarker  : BaseObject
	{
		Hashtable h = new Hashtable();

		public WmaSeriesMarker()
		{
			...
			States = States_DefaultValue = new WmaSeriesMarkerStates();
		...
		/// </summary>
		public WmaSeriesMarkerStates States { get; set; }
		private WmaSeriesMarkerStates States_DefaultValue { get; set; }
