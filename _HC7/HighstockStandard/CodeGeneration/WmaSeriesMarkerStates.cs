...
{
	public partial class WmaSeriesMarkerStates  : BaseObject
	{
		public WmaSeriesMarkerStates()
		{
			Hover = Hover_DefaultValue = new WmaSeriesMarkerStatesHover();
			Inactive = Inactive_DefaultValue = new WmaSeriesMarkerStatesInactive();
		...
		/// 
		/// </summary>
		public WmaSeriesMarkerStatesInactive Inactive { get; set; }
		private WmaSeriesMarkerStatesInactive Inactive_DefaultValue { get; set; }
		...
		/// </summary>
		public WmaSeriesMarkerStatesSelect Select { get; set; }
		private WmaSeriesMarkerStatesSelect Select_DefaultValue { get; set; }
