...
{
	public partial class WmaSeriesSonificationContextTracks  : BaseObject
	{
		Hashtable h = new Hashtable();

		public WmaSeriesSonificationContextTracks()
		{
			ActiveWhen = ActiveWhen_DefaultValue = new WmaSeriesSonificationContextTracksActiveWhen();
			Instrument = Instrument_DefaultValue = null;
			InstrumentString = InstrumentString_DefaultValue = "null";
			Mapping = Mapping_DefaultValue = new WmaSeriesSonificationContextTracksMapping();
			MidiName = MidiName_DefaultValue = "";
			PointGrouping = PointGrouping_DefaultValue = new WmaSeriesSonificationContextTracksPointGrouping();
			...
			Type = Type_DefaultValue = WmaSeriesSonificationContextTracksType.Instrument;
			ValueInterval = ValueInterval_DefaultValue = null;
			ValueMapFunction = ValueMapFunction_DefaultValue = WmaSeriesSonificationContextTracksValueMapFunction.Linear;
		...
		/// </summary>
		public WmaSeriesSonificationContextTracksActiveWhen ActiveWhen { get; set; }
		private WmaSeriesSonificationContextTracksActiveWhen ActiveWhen_DefaultValue { get; set; }
		...
		/// </summary>
		public WmaSeriesSonificationContextTracksMapping Mapping { get; set; }
		private WmaSeriesSonificationContextTracksMapping Mapping_DefaultValue { get; set; }
		...
		/// </summary>
		public WmaSeriesSonificationContextTracksPointGrouping PointGrouping { get; set; }
		private WmaSeriesSonificationContextTracksPointGrouping PointGrouping_DefaultValue { get; set; }
		...
		/// </summary>
		public WmaSeriesSonificationContextTracksType Type { get; set; }
		private WmaSeriesSonificationContextTracksType Type_DefaultValue { get; set; }
		...
		/// </summary>
		public WmaSeriesSonificationContextTracksValueMapFunction ValueMapFunction { get; set; }
		private WmaSeriesSonificationContextTracksValueMapFunction ValueMapFunction_DefaultValue { get; set; }
