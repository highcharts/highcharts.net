...
{
	public partial class WmaSeriesSonificationContextTracksMapping  : BaseObject
	{
		Hashtable h = new Hashtable();

		public WmaSeriesSonificationContextTracksMapping()
		{
			Frequency = Frequency_DefaultValue = new WmaSeriesSonificationContextTracksMappingFrequency();
			GapBetweenNotes = GapBetweenNotes_DefaultValue = new WmaSeriesSonificationContextTracksMappingGapBetweenNotes();
			Highpass = Highpass_DefaultValue = new WmaSeriesSonificationContextTracksMappingHighpass();
			Lowpass = Lowpass_DefaultValue = new WmaSeriesSonificationContextTracksMappingLowpass();
			NoteDuration = NoteDuration_DefaultValue = new WmaSeriesSonificationContextTracksMappingNoteDuration();
			Pan = Pan_DefaultValue = new WmaSeriesSonificationContextTracksMappingPan();
			Pitch = Pitch_DefaultValue = new WmaSeriesSonificationContextTracksMappingPitch();
			PitchString = PitchString_DefaultValue = "null";
			PitchNumber = PitchNumber_DefaultValue = null;
			PlayDelay = PlayDelay_DefaultValue = new WmaSeriesSonificationContextTracksMappingPlayDelay();
			Time = Time_DefaultValue = new WmaSeriesSonificationContextTracksMappingTime();
			TimeString = TimeString_DefaultValue = "null";
			TimeNumber = TimeNumber_DefaultValue = null;
			Tremolo = Tremolo_DefaultValue = new WmaSeriesSonificationContextTracksMappingTremolo();
			Volume = Volume_DefaultValue = new WmaSeriesSonificationContextTracksMappingVolume();
		...
		/// </summary>
		public WmaSeriesSonificationContextTracksMappingFrequency Frequency { get; set; }
		private WmaSeriesSonificationContextTracksMappingFrequency Frequency_DefaultValue { get; set; }
		...
		/// </summary>
		public WmaSeriesSonificationContextTracksMappingGapBetweenNotes GapBetweenNotes { get; set; }
		private WmaSeriesSonificationContextTracksMappingGapBetweenNotes GapBetweenNotes_DefaultValue { get; set; }
		...
		/// </summary>
		public WmaSeriesSonificationContextTracksMappingHighpass Highpass { get; set; }
		private WmaSeriesSonificationContextTracksMappingHighpass Highpass_DefaultValue { get; set; }
		...
		/// </summary>
		public WmaSeriesSonificationContextTracksMappingLowpass Lowpass { get; set; }
		private WmaSeriesSonificationContextTracksMappingLowpass Lowpass_DefaultValue { get; set; }
		...
		/// </summary>
		public WmaSeriesSonificationContextTracksMappingNoteDuration NoteDuration { get; set; }
		private WmaSeriesSonificationContextTracksMappingNoteDuration NoteDuration_DefaultValue { get; set; }
		...
		/// </summary>
		public WmaSeriesSonificationContextTracksMappingPan Pan { get; set; }
		private WmaSeriesSonificationContextTracksMappingPan Pan_DefaultValue { get; set; }
		...
		/// </summary>
		public WmaSeriesSonificationContextTracksMappingPitch Pitch { get; set; }
		private WmaSeriesSonificationContextTracksMappingPitch Pitch_DefaultValue { get; set; }
		...
		/// </summary>
		public WmaSeriesSonificationContextTracksMappingPlayDelay PlayDelay { get; set; }
		private WmaSeriesSonificationContextTracksMappingPlayDelay PlayDelay_DefaultValue { get; set; }
		...
		/// </summary>
		public WmaSeriesSonificationContextTracksMappingTime Time { get; set; }
		private WmaSeriesSonificationContextTracksMappingTime Time_DefaultValue { get; set; }
		...
		/// </summary>
		public WmaSeriesSonificationContextTracksMappingTremolo Tremolo { get; set; }
		private WmaSeriesSonificationContextTracksMappingTremolo Tremolo_DefaultValue { get; set; }
		 

		/// <summary>
		/// The volume of notes, from 0 to 1.
		/// </summary>
		public WmaSeriesSonificationContextTracksMappingVolume Volume { get; set; }
		private WmaSeriesSonificationContextTracksMappingVolume Volume_DefaultValue { get; set; }
