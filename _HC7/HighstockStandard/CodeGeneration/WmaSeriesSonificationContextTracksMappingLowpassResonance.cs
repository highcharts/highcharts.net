...
{
	public partial class WmaSeriesSonificationContextTracksMappingLowpassResonance  : BaseObject
	{
		Hashtable h = new Hashtable();

		public WmaSeriesSonificationContextTracksMappingLowpassResonance()
		{
			MapFunction = MapFunction_DefaultValue = WmaSeriesSonificationContextTracksMappingLowpassResonanceMapFunction.Linear;
			MapTo = MapTo_DefaultValue = "";
			Max = Max_DefaultValue = null;
			Min = Min_DefaultValue = null;
			Value = Value_DefaultValue = null;
			Within = Within_DefaultValue = WmaSeriesSonificationContextTracksMappingLowpassResonanceWithin.Chart;
		...
		/// </summary>
		public WmaSeriesSonificationContextTracksMappingLowpassResonanceMapFunction MapFunction { get; set; }
		private WmaSeriesSonificationContextTracksMappingLowpassResonanceMapFunction MapFunction_DefaultValue { get; set; }
		...
		/// </summary>
		public WmaSeriesSonificationContextTracksMappingLowpassResonanceWithin Within { get; set; }
		private WmaSeriesSonificationContextTracksMappingLowpassResonanceWithin Within_DefaultValue { get; set; }
