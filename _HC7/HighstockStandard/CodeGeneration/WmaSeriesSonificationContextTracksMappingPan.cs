...
{
	public partial class WmaSeriesSonificationContextTracksMappingPan  : BaseObject
	{
		Hashtable h = new Hashtable();

		public WmaSeriesSonificationContextTracksMappingPan()
		{
			MapFunction = MapFunction_DefaultValue = WmaSeriesSonificationContextTracksMappingPanMapFunction.Linear;
			MapTo = MapTo_DefaultValue = "";
			Max = Max_DefaultValue = null;
			Min = Min_DefaultValue = null;
			Value = Value_DefaultValue = null;
			Within = Within_DefaultValue = WmaSeriesSonificationContextTracksMappingPanWithin.Chart;
		...
		/// </summary>
		public WmaSeriesSonificationContextTracksMappingPanMapFunction MapFunction { get; set; }
		private WmaSeriesSonificationContextTracksMappingPanMapFunction MapFunction_DefaultValue { get; set; }
		...
		/// </summary>
		public WmaSeriesSonificationContextTracksMappingPanWithin Within { get; set; }
		private WmaSeriesSonificationContextTracksMappingPanWithin Within_DefaultValue { get; set; }
