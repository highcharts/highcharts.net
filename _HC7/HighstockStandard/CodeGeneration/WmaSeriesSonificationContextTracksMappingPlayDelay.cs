...
{
	public partial class WmaSeriesSonificationContextTracksMappingPlayDelay  : BaseObject
	{
		Hashtable h = new Hashtable();

		public WmaSeriesSonificationContextTracksMappingPlayDelay()
		{
			MapFunction = MapFunction_DefaultValue = WmaSeriesSonificationContextTracksMappingPlayDelayMapFunction.Linear;
			MapTo = MapTo_DefaultValue = "";
			Max = Max_DefaultValue = null;
			Min = Min_DefaultValue = null;
			Value = Value_DefaultValue = null;
			Within = Within_DefaultValue = WmaSeriesSonificationContextTracksMappingPlayDelayWithin.Chart;
		...
		/// </summary>
		public WmaSeriesSonificationContextTracksMappingPlayDelayMapFunction MapFunction { get; set; }
		private WmaSeriesSonificationContextTracksMappingPlayDelayMapFunction MapFunction_DefaultValue { get; set; }
		...
		/// </summary>
		public WmaSeriesSonificationContextTracksMappingPlayDelayWithin Within { get; set; }
		private WmaSeriesSonificationContextTracksMappingPlayDelayWithin Within_DefaultValue { get; set; }
