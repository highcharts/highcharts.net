...
{
	public partial class WmaSeriesSonificationContextTracksMappingTime  : BaseObject
	{
		Hashtable h = new Hashtable();

		public WmaSeriesSonificationContextTracksMappingTime()
		{
			MapFunction = MapFunction_DefaultValue = WmaSeriesSonificationContextTracksMappingTimeMapFunction.Linear;
			MapTo = MapTo_DefaultValue = "";
			Max = Max_DefaultValue = null;
			Min = Min_DefaultValue = null;
			Value = Value_DefaultValue = null;
			Within = Within_DefaultValue = WmaSeriesSonificationContextTracksMappingTimeWithin.Chart;
		...
		/// </summary>
		public WmaSeriesSonificationContextTracksMappingTimeMapFunction MapFunction { get; set; }
		private WmaSeriesSonificationContextTracksMappingTimeMapFunction MapFunction_DefaultValue { get; set; }
		...
		/// </summary>
		public WmaSeriesSonificationContextTracksMappingTimeWithin Within { get; set; }
		private WmaSeriesSonificationContextTracksMappingTimeWithin Within_DefaultValue { get; set; }
