...
{
	public partial class WmaSeriesSonificationContextTracksMappingTremoloDepth  : BaseObject
	{
		Hashtable h = new Hashtable();

		public WmaSeriesSonificationContextTracksMappingTremoloDepth()
		{
			MapFunction = MapFunction_DefaultValue = WmaSeriesSonificationContextTracksMappingTremoloDepthMapFunction.Linear;
			MapTo = MapTo_DefaultValue = "";
			Max = Max_DefaultValue = null;
			Min = Min_DefaultValue = null;
			Value = Value_DefaultValue = null;
			Within = Within_DefaultValue = WmaSeriesSonificationContextTracksMappingTremoloDepthWithin.Chart;
		...
		/// </summary>
		public WmaSeriesSonificationContextTracksMappingTremoloDepthMapFunction MapFunction { get; set; }
		private WmaSeriesSonificationContextTracksMappingTremoloDepthMapFunction MapFunction_DefaultValue { get; set; }
		...
		/// </summary>
		public WmaSeriesSonificationContextTracksMappingTremoloDepthWithin Within { get; set; }
		private WmaSeriesSonificationContextTracksMappingTremoloDepthWithin Within_DefaultValue { get; set; }
