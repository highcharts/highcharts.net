...
{
	public partial class WmaSeriesSonificationDefaultInstrumentOptionsMappingTremoloDepth  : BaseObject
	{
		Hashtable h = new Hashtable();

		public WmaSeriesSonificationDefaultInstrumentOptionsMappingTremoloDepth()
		{
			MapFunction = MapFunction_DefaultValue = WmaSeriesSonificationDefaultInstrumentOptionsMappingTremoloDepthMapFunction.Linear;
			MapTo = MapTo_DefaultValue = "";
			Max = Max_DefaultValue = null;
			Min = Min_DefaultValue = null;
			Value = Value_DefaultValue = null;
			Within = Within_DefaultValue = WmaSeriesSonificationDefaultInstrumentOptionsMappingTremoloDepthWithin.Chart;
		...
		/// </summary>
		public WmaSeriesSonificationDefaultInstrumentOptionsMappingTremoloDepthMapFunction MapFunction { get; set; }
		private WmaSeriesSonificationDefaultInstrumentOptionsMappingTremoloDepthMapFunction MapFunction_DefaultValue { get; set; }
		...
		/// </summary>
		public WmaSeriesSonificationDefaultInstrumentOptionsMappingTremoloDepthWithin Within { get; set; }
		private WmaSeriesSonificationDefaultInstrumentOptionsMappingTremoloDepthWithin Within_DefaultValue { get; set; }
