...
{
	public partial class WmaSeriesSonificationDefaultSpeechOptions  : BaseObject
	{
		Hashtable h = new Hashtable();

		public WmaSeriesSonificationDefaultSpeechOptions()
		{
			ActiveWhen = ActiveWhen_DefaultValue = new WmaSeriesSonificationDefaultSpeechOptionsActiveWhen();
			Language = Language_DefaultValue = "en-US";
			Mapping = Mapping_DefaultValue = new WmaSeriesSonificationDefaultSpeechOptionsMapping();
			PointGrouping = PointGrouping_DefaultValue = new WmaSeriesSonificationDefaultSpeechOptionsPointGrouping();
			PreferredVoice = PreferredVoice_DefaultValue = "";
			ShowPlayMarker = ShowPlayMarker_DefaultValue = true;
			Type = Type_DefaultValue = WmaSeriesSonificationDefaultSpeechOptionsType.Instrument;
		...
		/// </summary>
		public WmaSeriesSonificationDefaultSpeechOptionsActiveWhen ActiveWhen { get; set; }
		private WmaSeriesSonificationDefaultSpeechOptionsActiveWhen ActiveWhen_DefaultValue { get; set; }
		...
		/// </summary>
		public WmaSeriesSonificationDefaultSpeechOptionsMapping Mapping { get; set; }
		private WmaSeriesSonificationDefaultSpeechOptionsMapping Mapping_DefaultValue { get; set; }
		 

		/// <summary>
		/// Options for point grouping, specifically for instrument tracks.
		/// </summary>
		public WmaSeriesSonificationDefaultSpeechOptionsPointGrouping PointGrouping { get; set; }
		private WmaSeriesSonificationDefaultSpeechOptionsPointGrouping PointGrouping_DefaultValue { get; set; }
		...
		/// </summary>
		public WmaSeriesSonificationDefaultSpeechOptionsType Type { get; set; }
		private WmaSeriesSonificationDefaultSpeechOptionsType Type_DefaultValue { get; set; }
