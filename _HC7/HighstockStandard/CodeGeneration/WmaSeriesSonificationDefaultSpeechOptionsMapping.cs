...
{
	public partial class WmaSeriesSonificationDefaultSpeechOptionsMapping  : BaseObject
	{
		Hashtable h = new Hashtable();

		public WmaSeriesSonificationDefaultSpeechOptionsMapping()
		{
			Frequency = Frequency_DefaultValue = new WmaSeriesSonificationDefaultSpeechOptionsMappingFrequency();
			GapBetweenNotes = GapBetweenNotes_DefaultValue = new WmaSeriesSonificationDefaultSpeechOptionsMappingGapBetweenNotes();
			Highpass = Highpass_DefaultValue = new WmaSeriesSonificationDefaultSpeechOptionsMappingHighpass();
			Lowpass = Lowpass_DefaultValue = new WmaSeriesSonificationDefaultSpeechOptionsMappingLowpass();
			NoteDuration = NoteDuration_DefaultValue = new WmaSeriesSonificationDefaultSpeechOptionsMappingNoteDuration();
			Pan = Pan_DefaultValue = new WmaSeriesSonificationDefaultSpeechOptionsMappingPan();
			Pitch = Pitch_DefaultValue = new WmaSeriesSonificationDefaultSpeechOptionsMappingPitch();
			PitchString = PitchString_DefaultValue = "null";
			PitchNumber = PitchNumber_DefaultValue = null;
			PlayDelay = PlayDelay_DefaultValue = new WmaSeriesSonificationDefaultSpeechOptionsMappingPlayDelay();
			Time = Time_DefaultValue = new WmaSeriesSonificationDefaultSpeechOptionsMappingTime();
			TimeString = TimeString_DefaultValue = "null";
			TimeNumber = TimeNumber_DefaultValue = null;
			Tremolo = Tremolo_DefaultValue = new WmaSeriesSonificationDefaultSpeechOptionsMappingTremolo();
			Volume = Volume_DefaultValue = new WmaSeriesSonificationDefaultSpeechOptionsMappingVolume();
		...
		/// </summary>
		public WmaSeriesSonificationDefaultSpeechOptionsMappingFrequency Frequency { get; set; }
		private WmaSeriesSonificationDefaultSpeechOptionsMappingFrequency Frequency_DefaultValue { get; set; }
		...
		/// </summary>
		public WmaSeriesSonificationDefaultSpeechOptionsMappingGapBetweenNotes GapBetweenNotes { get; set; }
		private WmaSeriesSonificationDefaultSpeechOptionsMappingGapBetweenNotes GapBetweenNotes_DefaultValue { get; set; }
		...
		/// </summary>
		public WmaSeriesSonificationDefaultSpeechOptionsMappingHighpass Highpass { get; set; }
		private WmaSeriesSonificationDefaultSpeechOptionsMappingHighpass Highpass_DefaultValue { get; set; }
		...
		/// </summary>
		public WmaSeriesSonificationDefaultSpeechOptionsMappingLowpass Lowpass { get; set; }
		private WmaSeriesSonificationDefaultSpeechOptionsMappingLowpass Lowpass_DefaultValue { get; set; }
		...
		/// </summary>
		public WmaSeriesSonificationDefaultSpeechOptionsMappingNoteDuration NoteDuration { get; set; }
		private WmaSeriesSonificationDefaultSpeechOptionsMappingNoteDuration NoteDuration_DefaultValue { get; set; }
		...
		/// </summary>
		public WmaSeriesSonificationDefaultSpeechOptionsMappingPan Pan { get; set; }
		private WmaSeriesSonificationDefaultSpeechOptionsMappingPan Pan_DefaultValue { get; set; }
		...
		/// </summary>
		public WmaSeriesSonificationDefaultSpeechOptionsMappingPitch Pitch { get; set; }
		private WmaSeriesSonificationDefaultSpeechOptionsMappingPitch Pitch_DefaultValue { get; set; }
		...
		/// </summary>
		public WmaSeriesSonificationDefaultSpeechOptionsMappingPlayDelay PlayDelay { get; set; }
		private WmaSeriesSonificationDefaultSpeechOptionsMappingPlayDelay PlayDelay_DefaultValue { get; set; }
		...
		/// </summary>
		public WmaSeriesSonificationDefaultSpeechOptionsMappingTime Time { get; set; }
		private WmaSeriesSonificationDefaultSpeechOptionsMappingTime Time_DefaultValue { get; set; }
		...
		/// </summary>
		public WmaSeriesSonificationDefaultSpeechOptionsMappingTremolo Tremolo { get; set; }
		private WmaSeriesSonificationDefaultSpeechOptionsMappingTremolo Tremolo_DefaultValue { get; set; }
		 

		/// <summary>
		/// The volume of notes, from 0 to 1.
		/// </summary>
		public WmaSeriesSonificationDefaultSpeechOptionsMappingVolume Volume { get; set; }
		private WmaSeriesSonificationDefaultSpeechOptionsMappingVolume Volume_DefaultValue { get; set; }
