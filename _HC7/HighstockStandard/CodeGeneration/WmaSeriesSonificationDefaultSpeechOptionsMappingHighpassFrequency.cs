...
{
	public partial class WmaSeriesSonificationDefaultSpeechOptionsMappingHighpassFrequency  : BaseObject
	{
		Hashtable h = new Hashtable();

		public WmaSeriesSonificationDefaultSpeechOptionsMappingHighpassFrequency()
		{
			MapFunction = MapFunction_DefaultValue = WmaSeriesSonificationDefaultSpeechOptionsMappingHighpassFrequencyMapFunction.Linear;
			MapTo = MapTo_DefaultValue = "";
			Max = Max_DefaultValue = null;
			Min = Min_DefaultValue = null;
			Value = Value_DefaultValue = null;
			Within = Within_DefaultValue = WmaSeriesSonificationDefaultSpeechOptionsMappingHighpassFrequencyWithin.Chart;
		...
		/// </summary>
		public WmaSeriesSonificationDefaultSpeechOptionsMappingHighpassFrequencyMapFunction MapFunction { get; set; }
		private WmaSeriesSonificationDefaultSpeechOptionsMappingHighpassFrequencyMapFunction MapFunction_DefaultValue { get; set; }
		...
		/// </summary>
		public WmaSeriesSonificationDefaultSpeechOptionsMappingHighpassFrequencyWithin Within { get; set; }
		private WmaSeriesSonificationDefaultSpeechOptionsMappingHighpassFrequencyWithin Within_DefaultValue { get; set; }
