...
{
	public partial class WmaSeriesSonificationPointGrouping  : BaseObject
	{
		Hashtable h = new Hashtable();

		public WmaSeriesSonificationPointGrouping()
		{
			Algorithm = Algorithm_DefaultValue = WmaSeriesSonificationPointGroupingAlgorithm.Minimax;
		...
		/// </summary>
		public WmaSeriesSonificationPointGroupingAlgorithm Algorithm { get; set; }
		private WmaSeriesSonificationPointGroupingAlgorithm Algorithm_DefaultValue { get; set; }
