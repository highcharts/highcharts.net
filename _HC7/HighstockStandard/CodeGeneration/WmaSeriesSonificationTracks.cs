...
{
	public partial class WmaSeriesSonificationTracks  : BaseObject
	{
		Hashtable h = new Hashtable();

		public WmaSeriesSonificationTracks()
		{
			ActiveWhen = ActiveWhen_DefaultValue = new WmaSeriesSonificationTracksActiveWhen();
			Instrument = Instrument_DefaultValue = null;
			InstrumentString = InstrumentString_DefaultValue = "null";
			Mapping = Mapping_DefaultValue = new WmaSeriesSonificationTracksMapping();
			MidiName = MidiName_DefaultValue = "";
			PointGrouping = PointGrouping_DefaultValue = new WmaSeriesSonificationTracksPointGrouping();
			RoundToMusicalNotes = RoundToMusicalNotes_DefaultValue = true;
			ShowPlayMarker = ShowPlayMarker_DefaultValue = true;
			Type = Type_DefaultValue = WmaSeriesSonificationTracksType.Instrument;
		...
		/// </summary>
		public WmaSeriesSonificationTracksActiveWhen ActiveWhen { get; set; }
		private WmaSeriesSonificationTracksActiveWhen ActiveWhen_DefaultValue { get; set; }
		...
		/// </summary>
		public WmaSeriesSonificationTracksMapping Mapping { get; set; }
		private WmaSeriesSonificationTracksMapping Mapping_DefaultValue { get; set; }
		...
		/// </summary>
		public WmaSeriesSonificationTracksPointGrouping PointGrouping { get; set; }
		private WmaSeriesSonificationTracksPointGrouping PointGrouping_DefaultValue { get; set; }
		...
		/// </summary>
		public WmaSeriesSonificationTracksType Type { get; set; }
		private WmaSeriesSonificationTracksType Type_DefaultValue { get; set; }
