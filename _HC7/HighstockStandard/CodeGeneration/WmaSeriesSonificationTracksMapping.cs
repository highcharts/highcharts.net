...
{
	public partial class WmaSeriesSonificationTracksMapping  : BaseObject
	{
		Hashtable h = new Hashtable();

		public WmaSeriesSonificationTracksMapping()
		{
			Frequency = Frequency_DefaultValue = new WmaSeriesSonificationTracksMappingFrequency();
			GapBetweenNotes = GapBetweenNotes_DefaultValue = new WmaSeriesSonificationTracksMappingGapBetweenNotes();
			Highpass = Highpass_DefaultValue = new WmaSeriesSonificationTracksMappingHighpass();
			Lowpass = Lowpass_DefaultValue = new WmaSeriesSonificationTracksMappingLowpass();
			NoteDuration = NoteDuration_DefaultValue = new WmaSeriesSonificationTracksMappingNoteDuration();
			Pan = Pan_DefaultValue = new WmaSeriesSonificationTracksMappingPan();
			Pitch = Pitch_DefaultValue = new WmaSeriesSonificationTracksMappingPitch();
			PitchString = PitchString_DefaultValue = "null";
			PitchNumber = PitchNumber_DefaultValue = null;
			PlayDelay = PlayDelay_DefaultValue = new WmaSeriesSonificationTracksMappingPlayDelay();
			Time = Time_DefaultValue = new WmaSeriesSonificationTracksMappingTime();
			TimeString = TimeString_DefaultValue = "null";
			TimeNumber = TimeNumber_DefaultValue = null;
			Tremolo = Tremolo_DefaultValue = new WmaSeriesSonificationTracksMappingTremolo();
			Volume = Volume_DefaultValue = new WmaSeriesSonificationTracksMappingVolume();
		...
		/// </summary>
		public WmaSeriesSonificationTracksMappingFrequency Frequency { get; set; }
		private WmaSeriesSonificationTracksMappingFrequency Frequency_DefaultValue { get; set; }
		...
		/// </summary>
		public WmaSeriesSonificationTracksMappingGapBetweenNotes GapBetweenNotes { get; set; }
		private WmaSeriesSonificationTracksMappingGapBetweenNotes GapBetweenNotes_DefaultValue { get; set; }
		...
		/// </summary>
		public WmaSeriesSonificationTracksMappingHighpass Highpass { get; set; }
		private WmaSeriesSonificationTracksMappingHighpass Highpass_DefaultValue { get; set; }
		...
		/// </summary>
		public WmaSeriesSonificationTracksMappingLowpass Lowpass { get; set; }
		private WmaSeriesSonificationTracksMappingLowpass Lowpass_DefaultValue { get; set; }
		...
		/// </summary>
		public WmaSeriesSonificationTracksMappingNoteDuration NoteDuration { get; set; }
		private WmaSeriesSonificationTracksMappingNoteDuration NoteDuration_DefaultValue { get; set; }
		...
		/// </summary>
		public WmaSeriesSonificationTracksMappingPan Pan { get; set; }
		private WmaSeriesSonificationTracksMappingPan Pan_DefaultValue { get; set; }
		...
		/// </summary>
		public WmaSeriesSonificationTracksMappingPitch Pitch { get; set; }
		private WmaSeriesSonificationTracksMappingPitch Pitch_DefaultValue { get; set; }
		...
		/// </summary>
		public WmaSeriesSonificationTracksMappingPlayDelay PlayDelay { get; set; }
		private WmaSeriesSonificationTracksMappingPlayDelay PlayDelay_DefaultValue { get; set; }
		...
		/// </summary>
		public WmaSeriesSonificationTracksMappingTime Time { get; set; }
		private WmaSeriesSonificationTracksMappingTime Time_DefaultValue { get; set; }
		...
		/// </summary>
		public WmaSeriesSonificationTracksMappingTremolo Tremolo { get; set; }
		private WmaSeriesSonificationTracksMappingTremolo Tremolo_DefaultValue { get; set; }
		 

		/// <summary>
		/// The volume of notes, from 0 to 1.
		/// </summary>
		public WmaSeriesSonificationTracksMappingVolume Volume { get; set; }
		private WmaSeriesSonificationTracksMappingVolume Volume_DefaultValue { get; set; }
