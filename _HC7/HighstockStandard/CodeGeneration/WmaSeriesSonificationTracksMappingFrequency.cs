...
{
	public partial class WmaSeriesSonificationTracksMappingFrequency  : BaseObject
	{
		Hashtable h = new Hashtable();

		public WmaSeriesSonificationTracksMappingFrequency()
		{
			MapFunction = MapFunction_DefaultValue = WmaSeriesSonificationTracksMappingFrequencyMapFunction.Linear;
			MapTo = MapTo_DefaultValue = "";
			Max = Max_DefaultValue = null;
			Min = Min_DefaultValue = null;
			Value = Value_DefaultValue = null;
			Within = Within_DefaultValue = WmaSeriesSonificationTracksMappingFrequencyWithin.Chart;
		...
		/// </summary>
		public WmaSeriesSonificationTracksMappingFrequencyMapFunction MapFunction { get; set; }
		private WmaSeriesSonificationTracksMappingFrequencyMapFunction MapFunction_DefaultValue { get; set; }
		...
		/// </summary>
		public WmaSeriesSonificationTracksMappingFrequencyWithin Within { get; set; }
		private WmaSeriesSonificationTracksMappingFrequencyWithin Within_DefaultValue { get; set; }
