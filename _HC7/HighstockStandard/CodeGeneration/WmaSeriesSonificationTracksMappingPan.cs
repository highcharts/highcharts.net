...
{
	public partial class WmaSeriesSonificationTracksMappingPan  : BaseObject
	{
		Hashtable h = new Hashtable();

		public WmaSeriesSonificationTracksMappingPan()
		{
			MapFunction = MapFunction_DefaultValue = WmaSeriesSonificationTracksMappingPanMapFunction.Linear;
			MapTo = MapTo_DefaultValue = "";
			Max = Max_DefaultValue = null;
			Min = Min_DefaultValue = null;
			Value = Value_DefaultValue = null;
			Within = Within_DefaultValue = WmaSeriesSonificationTracksMappingPanWithin.Chart;
		...
		/// </summary>
		public WmaSeriesSonificationTracksMappingPanMapFunction MapFunction { get; set; }
		private WmaSeriesSonificationTracksMappingPanMapFunction MapFunction_DefaultValue { get; set; }
		...
		/// </summary>
		public WmaSeriesSonificationTracksMappingPanWithin Within { get; set; }
		private WmaSeriesSonificationTracksMappingPanWithin Within_DefaultValue { get; set; }
