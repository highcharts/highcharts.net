...
{
	public partial class WmaSeriesSonificationTracksMappingPitch  : BaseObject
	{
		Hashtable h = new Hashtable();

		public WmaSeriesSonificationTracksMappingPitch()
		{
			MapFunction = MapFunction_DefaultValue = WmaSeriesSonificationTracksMappingPitchMapFunction.Linear;
		...
		/// </summary>
		public WmaSeriesSonificationTracksMappingPitchMapFunction MapFunction { get; set; }
		private WmaSeriesSonificationTracksMappingPitchMapFunction MapFunction_DefaultValue { get; set; }
