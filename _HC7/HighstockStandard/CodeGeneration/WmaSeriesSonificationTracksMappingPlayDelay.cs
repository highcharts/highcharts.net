...
{
	public partial class WmaSeriesSonificationTracksMappingPlayDelay  : BaseObject
	{
		Hashtable h = new Hashtable();

		public WmaSeriesSonificationTracksMappingPlayDelay()
		{
			MapFunction = MapFunction_DefaultValue = WmaSeriesSonificationTracksMappingPlayDelayMapFunction.Linear;
			MapTo = MapTo_DefaultValue = "";
			Max = Max_DefaultValue = null;
			Min = Min_DefaultValue = null;
			Value = Value_DefaultValue = null;
			Within = Within_DefaultValue = WmaSeriesSonificationTracksMappingPlayDelayWithin.Chart;
		...
		/// </summary>
		public WmaSeriesSonificationTracksMappingPlayDelayMapFunction MapFunction { get; set; }
		private WmaSeriesSonificationTracksMappingPlayDelayMapFunction MapFunction_DefaultValue { get; set; }
		...
		/// </summary>
		public WmaSeriesSonificationTracksMappingPlayDelayWithin Within { get; set; }
		private WmaSeriesSonificationTracksMappingPlayDelayWithin Within_DefaultValue { get; set; }
