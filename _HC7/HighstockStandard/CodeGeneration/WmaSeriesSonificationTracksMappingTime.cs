...
{
	public partial class WmaSeriesSonificationTracksMappingTime  : BaseObject
	{
		Hashtable h = new Hashtable();

		public WmaSeriesSonificationTracksMappingTime()
		{
			MapFunction = MapFunction_DefaultValue = WmaSeriesSonificationTracksMappingTimeMapFunction.Linear;
			MapTo = MapTo_DefaultValue = "";
			Max = Max_DefaultValue = null;
			Min = Min_DefaultValue = null;
			Value = Value_DefaultValue = null;
			Within = Within_DefaultValue = WmaSeriesSonificationTracksMappingTimeWithin.Chart;
		...
		/// </summary>
		public WmaSeriesSonificationTracksMappingTimeMapFunction MapFunction { get; set; }
		private WmaSeriesSonificationTracksMappingTimeMapFunction MapFunction_DefaultValue { get; set; }
		...
		/// </summary>
		public WmaSeriesSonificationTracksMappingTimeWithin Within { get; set; }
		private WmaSeriesSonificationTracksMappingTimeWithin Within_DefaultValue { get; set; }
