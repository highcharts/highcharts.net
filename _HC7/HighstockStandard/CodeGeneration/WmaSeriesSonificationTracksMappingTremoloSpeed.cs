...
{
	public partial class WmaSeriesSonificationTracksMappingTremoloSpeed  : BaseObject
	{
		Hashtable h = new Hashtable();

		public WmaSeriesSonificationTracksMappingTremoloSpeed()
		{
			MapFunction = MapFunction_DefaultValue = WmaSeriesSonificationTracksMappingTremoloSpeedMapFunction.Linear;
			MapTo = MapTo_DefaultValue = "";
			Max = Max_DefaultValue = null;
			Min = Min_DefaultValue = null;
			Value = Value_DefaultValue = null;
			Within = Within_DefaultValue = WmaSeriesSonificationTracksMappingTremoloSpeedWithin.Chart;
		...
		/// </summary>
		public WmaSeriesSonificationTracksMappingTremoloSpeedMapFunction MapFunction { get; set; }
		private WmaSeriesSonificationTracksMappingTremoloSpeedMapFunction MapFunction_DefaultValue { get; set; }
		...
		/// </summary>
		public WmaSeriesSonificationTracksMappingTremoloSpeedWithin Within { get; set; }
		private WmaSeriesSonificationTracksMappingTremoloSpeedWithin Within_DefaultValue { get; set; }
