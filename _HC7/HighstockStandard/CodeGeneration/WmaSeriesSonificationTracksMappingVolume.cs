...
{
	public partial class WmaSeriesSonificationTracksMappingVolume  : BaseObject
	{
		Hashtable h = new Hashtable();

		public WmaSeriesSonificationTracksMappingVolume()
		{
			MapFunction = MapFunction_DefaultValue = WmaSeriesSonificationTracksMappingVolumeMapFunction.Linear;
			MapTo = MapTo_DefaultValue = "";
			Max = Max_DefaultValue = null;
			Min = Min_DefaultValue = null;
			Value = Value_DefaultValue = null;
			Within = Within_DefaultValue = WmaSeriesSonificationTracksMappingVolumeWithin.Chart;
		...
		/// </summary>
		public WmaSeriesSonificationTracksMappingVolumeMapFunction MapFunction { get; set; }
		private WmaSeriesSonificationTracksMappingVolumeMapFunction MapFunction_DefaultValue { get; set; }
		...
		/// </summary>
		public WmaSeriesSonificationTracksMappingVolumeWithin Within { get; set; }
		private WmaSeriesSonificationTracksMappingVolumeWithin Within_DefaultValue { get; set; }
