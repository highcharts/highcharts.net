...
{
	public partial class WmaSeriesTooltip  : BaseObject
	{
		public WmaSeriesTooltip()
		{
			...
			HeaderShape = HeaderShape_DefaultValue = WmaSeriesTooltipHeaderShape.Callout;
		...
		/// </summary>
		public WmaSeriesTooltipHeaderShape HeaderShape { get; set; }
		private WmaSeriesTooltipHeaderShape HeaderShape_DefaultValue { get; set; }
		...
		internal override Hashtable ToHashtable()
		{
			...
			if (NullFormatter != NullFormatter_DefaultValue) { h.Add("nullFormatter",NullFormatter); Highstock.AddFunction("WmaSeriesTooltipNullFormatter.nullFormatter", NullFormatter); }  
			if (Outside != Outside_DefaultValue) h.Add("outside",Outside);
			if (Padding != Padding_DefaultValue) h.Add("padding",Padding);
			if (PointFormat != PointFormat_DefaultValue) h.Add("pointFormat",PointFormat);
			if (PointFormatter != PointFormatter_DefaultValue) { h.Add("pointFormatter",PointFormatter); Highstock.AddFunction("WmaSeriesTooltipPointFormatter.pointFormatter", PointFormatter); }  
