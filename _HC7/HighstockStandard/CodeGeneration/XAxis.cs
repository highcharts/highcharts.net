...
namespace Highsoft.Web.Mvc.Stocks
{
	public partial class XAxis  : BaseObject
	{
		...
		internal override Hashtable ToHashtable(Highstock highstock)
		{
			...
			if (MinorTickPosition != XAxisMinorTickPosition.Null) h.Add("minorTickPosition", highstock.FirstCharacterToLower(MinorTickPosition.ToString()));
			...
			if (TickPosition != XAxisTickPosition.Null) h.Add("tickPosition", highstock.FirstCharacterToLower(TickPosition.ToString()));
