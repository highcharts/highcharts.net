...
namespace Highsoft.Web.Mvc.Stocks
{
	public partial class XAxisCrosshairLabel  : BaseObject
	{
		...
		{
			Align = Align_DefaultValue = XAxisCrosshairLabelAlign.Null;
			...
			Style = Style_DefaultValue = new XAxisCrosshairLabelStyle();
		...
		private XAxisCrosshairLabelAlign Align_DefaultValue { get; set; }
		...
		/// </summary>
		public XAxisCrosshairLabelStyle Style { get; set; }
		private XAxisCrosshairLabelStyle Style_DefaultValue { get; set; }
		...
		internal override Hashtable ToHashtable()
		{
			...
			if (Formatter != Formatter_DefaultValue) { h.Add("formatter",Formatter); Highstock.AddFunction("XAxisCrosshairLabelFormatter.formatter", Formatter); }  
