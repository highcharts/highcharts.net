...
namespace Highsoft.Web.Mvc.Stocks
{
	public partial class XAxisLabels  : BaseObject
	{
		...
		{
			if (Align != XAxisLabelsAlign.Null) h.Add("align", highstock.FirstCharacterToLower(Align.ToString()));
			...
			if (Overflow != XAxisLabelsOverflow.Null) h.Add("overflow", highstock.FirstCharacterToLower(Overflow.ToString()));
