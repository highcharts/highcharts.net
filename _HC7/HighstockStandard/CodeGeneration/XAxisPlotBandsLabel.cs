...
namespace Highsoft.Web.Mvc.Stocks
{
	public partial class XAxisPlotBandsLabel  : BaseObject
	{
		...
		{
			if (Align != XAxisPlotBandsLabelAlign.Null) h.Add("align", highstock.FirstCharacterToLower(Align.ToString()));
			if (Rotation != null) h.Add("rotation",Rotation);
			if (Style != null) h.Add("style",Style);
			if (Text != null) h.Add("text",Text);
			if (TextAlign != XAxisPlotBandsLabelTextAlign.Null) h.Add("textAlign", highstock.FirstCharacterToLower(TextAlign.ToString()));
			if (UseHTML != null) h.Add("useHTML",UseHTML);
			if (VerticalAlign != XAxisPlotBandsLabelVerticalAlign.Null) h.Add("verticalAlign", highstock.FirstCharacterToLower(VerticalAlign.ToString()));
			if (X != null) h.Add("x",X);
			if (Y != null) h.Add("y",Y);
