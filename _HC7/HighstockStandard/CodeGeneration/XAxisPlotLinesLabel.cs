...
namespace Highsoft.Web.Mvc.Stocks
{
	public partial class XAxisPlotLinesLabel  : BaseObject
	{
		...
		{
			if (Align != XAxisPlotLinesLabelAlign.Null) h.Add("align", highstock.FirstCharacterToLower(Align.ToString()));
			...
			if (TextAlign != XAxisPlotLinesLabelTextAlign.Null) h.Add("textAlign", highstock.FirstCharacterToLower(TextAlign.ToString()));
			if (UseHTML != null) h.Add("useHTML",UseHTML);
			if (VerticalAlign != XAxisPlotLinesLabelVerticalAlign.Null) h.Add("verticalAlign", highstock.FirstCharacterToLower(VerticalAlign.ToString()));
			if (X != null) h.Add("x",X);
			if (Y != null) h.Add("y",Y);
