...
namespace Highsoft.Web.Mvc.Stocks
{
	public partial class XAxisTitle  : BaseObject
	{
		...
		{
			if (Align != XAxisTitleAlign.Null) h.Add("align", highstock.FirstCharacterToLower(Align.ToString()));
			...
			if (TextAlign != XAxisTitleTextAlign.Null) h.Add("textAlign", highstock.FirstCharacterToLower(TextAlign.ToString()));
