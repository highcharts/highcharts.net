...
namespace Highsoft.Web.Mvc.Stocks
{
	public partial class XrangeSeries  : Series
	{
		...
		public XrangeSeries()
		{
			Accessibility = Accessibility_DefaultValue = new XrangeSeriesAccessibility();
			...
			Compare = Compare_DefaultValue = XrangeSeriesCompare.Percent;
			...
			DragDrop = DragDrop_DefaultValue = new XrangeSeriesDragDrop();
			Dumbell = Dumbell_DefaultValue = new XrangeSeriesDumbell();
			...
			LegendSymbol = LegendSymbol_DefaultValue = XrangeSeriesLegendSymbol.Rectangle;
			LinkedTo = LinkedTo_DefaultValue = "";
			MaxPointWidth = MaxPointWidth_DefaultValue = null;
			MinPointLength = MinPointLength_DefaultValue = 0;
			Name = Name_DefaultValue = "";
			OnPoint = OnPoint_DefaultValue = new XrangeSeriesOnPoint();
			...
			Sonification = Sonification_DefaultValue = new XrangeSeriesSonification();
			...
			Zones = Zones_DefaultValue = new List<XrangeSeriesZones>();
		...
		/// </summary>
		public XrangeSeriesAccessibility Accessibility { get; set; }
		private XrangeSeriesAccessibility Accessibility_DefaultValue { get; set; }
		...
		/// </summary>
		public XrangeSeriesCompare Compare { get; set; }
		private XrangeSeriesCompare Compare_DefaultValue { get; set; }
		...
		/// 
		/// </summary>
		public XrangeSeriesDumbell Dumbell { get; set; }
		private XrangeSeriesDumbell Dumbell_DefaultValue { get; set; }
		...
		/// </summary>
		public XrangeSeriesLegendSymbol LegendSymbol { get; set; }
		private XrangeSeriesLegendSymbol LegendSymbol_DefaultValue { get; set; }
		...
		/// </summary>
		public XrangeSeriesOnPoint OnPoint { get; set; }
		private XrangeSeriesOnPoint OnPoint_DefaultValue { get; set; }
		...
		/// </summary>
		public XrangeSeriesSonification Sonification { get; set; }
		private XrangeSeriesSonification Sonification_DefaultValue { get; set; }
		...
		/// </summary>
		public List<XrangeSeriesZones> Zones { get; set; }
		private List<XrangeSeriesZones> Zones_DefaultValue { get; set; }
		...
		internal override Hashtable ToHashtable(Highstock highstock)
		{
			...
			if (PartialFill.IsDirty(highstock)) h.Add("partialFill",PartialFill.ToHashtable(highstock));
