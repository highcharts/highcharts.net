...
namespace Highsoft.Web.Mvc.Stocks
{
	public partial class XrangeSeriesDataMarkerStates  : BaseObject
	{
		public XrangeSeriesDataMarkerStates()
		{
			...
			Inactive = Inactive_DefaultValue = new XrangeSeriesDataMarkerStatesInactive();
		...
		/// 
		/// </summary>
		public XrangeSeriesDataMarkerStatesInactive Inactive { get; set; }
		private XrangeSeriesDataMarkerStatesInactive Inactive_DefaultValue { get; set; }
