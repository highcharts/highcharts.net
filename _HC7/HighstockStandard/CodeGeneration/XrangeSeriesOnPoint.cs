...
{
	public partial class XrangeSeriesOnPoint  : BaseObject
	{
		Hashtable h = new Hashtable();

		public XrangeSeriesOnPoint()
		{
			ConnectorOptions = ConnectorOptions_DefaultValue = new XrangeSeriesOnPointConnectorOptions();
			Id = Id_DefaultValue = "";
			Position = Position_DefaultValue = new XrangeSeriesOnPointPosition();
		...
		/// </summary>
		public XrangeSeriesOnPointConnectorOptions ConnectorOptions { get; set; }
		private XrangeSeriesOnPointConnectorOptions ConnectorOptions_DefaultValue { get; set; }
		...
		/// </summary>
		public XrangeSeriesOnPointPosition Position { get; set; }
		private XrangeSeriesOnPointPosition Position_DefaultValue { get; set; }
