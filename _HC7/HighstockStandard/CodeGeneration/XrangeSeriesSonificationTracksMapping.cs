...
{
	public partial class XrangeSeriesSonificationTracksMapping  : BaseObject
	{
		Hashtable h = new Hashtable();

		public XrangeSeriesSonificationTracksMapping()
		{
			Frequency = Frequency_DefaultValue = new XrangeSeriesSonificationTracksMappingFrequency();
			GapBetweenNotes = GapBetweenNotes_DefaultValue = new XrangeSeriesSonificationTracksMappingGapBetweenNotes();
			Highpass = Highpass_DefaultValue = new XrangeSeriesSonificationTracksMappingHighpass();
			Lowpass = Lowpass_DefaultValue = new XrangeSeriesSonificationTracksMappingLowpass();
			NoteDuration = NoteDuration_DefaultValue = new XrangeSeriesSonificationTracksMappingNoteDuration();
			Pan = Pan_DefaultValue = new XrangeSeriesSonificationTracksMappingPan();
			Pitch = Pitch_DefaultValue = new XrangeSeriesSonificationTracksMappingPitch();
			PitchString = PitchString_DefaultValue = "null";
			PitchNumber = PitchNumber_DefaultValue = null;
			PlayDelay = PlayDelay_DefaultValue = new XrangeSeriesSonificationTracksMappingPlayDelay();
			Time = Time_DefaultValue = new XrangeSeriesSonificationTracksMappingTime();
			TimeString = TimeString_DefaultValue = "null";
			TimeNumber = TimeNumber_DefaultValue = null;
			Tremolo = Tremolo_DefaultValue = new XrangeSeriesSonificationTracksMappingTremolo();
			Volume = Volume_DefaultValue = new XrangeSeriesSonificationTracksMappingVolume();
		...
		/// </summary>
		public XrangeSeriesSonificationTracksMappingFrequency Frequency { get; set; }
		private XrangeSeriesSonificationTracksMappingFrequency Frequency_DefaultValue { get; set; }
		...
		/// </summary>
		public XrangeSeriesSonificationTracksMappingGapBetweenNotes GapBetweenNotes { get; set; }
		private XrangeSeriesSonificationTracksMappingGapBetweenNotes GapBetweenNotes_DefaultValue { get; set; }
		...
		/// </summary>
		public XrangeSeriesSonificationTracksMappingHighpass Highpass { get; set; }
		private XrangeSeriesSonificationTracksMappingHighpass Highpass_DefaultValue { get; set; }
		...
		/// </summary>
		public XrangeSeriesSonificationTracksMappingLowpass Lowpass { get; set; }
		private XrangeSeriesSonificationTracksMappingLowpass Lowpass_DefaultValue { get; set; }
		...
		/// </summary>
		public XrangeSeriesSonificationTracksMappingNoteDuration NoteDuration { get; set; }
		private XrangeSeriesSonificationTracksMappingNoteDuration NoteDuration_DefaultValue { get; set; }
		...
		/// </summary>
		public XrangeSeriesSonificationTracksMappingPan Pan { get; set; }
		private XrangeSeriesSonificationTracksMappingPan Pan_DefaultValue { get; set; }
		...
		/// </summary>
		public XrangeSeriesSonificationTracksMappingPitch Pitch { get; set; }
		private XrangeSeriesSonificationTracksMappingPitch Pitch_DefaultValue { get; set; }
		...
		/// </summary>
		public XrangeSeriesSonificationTracksMappingPlayDelay PlayDelay { get; set; }
		private XrangeSeriesSonificationTracksMappingPlayDelay PlayDelay_DefaultValue { get; set; }
		...
		/// </summary>
		public XrangeSeriesSonificationTracksMappingTime Time { get; set; }
		private XrangeSeriesSonificationTracksMappingTime Time_DefaultValue { get; set; }
		...
		/// </summary>
		public XrangeSeriesSonificationTracksMappingTremolo Tremolo { get; set; }
		private XrangeSeriesSonificationTracksMappingTremolo Tremolo_DefaultValue { get; set; }
		 

		/// <summary>
		/// The volume of notes, from 0 to 1.
		/// </summary>
		public XrangeSeriesSonificationTracksMappingVolume Volume { get; set; }
		private XrangeSeriesSonificationTracksMappingVolume Volume_DefaultValue { get; set; }
