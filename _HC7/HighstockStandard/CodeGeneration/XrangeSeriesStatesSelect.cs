...
{
	public partial class XrangeSeriesStatesSelect  : BaseObject
	{
		public XrangeSeriesStatesSelect()
		{
			Animation = Animation_DefaultValue = new Animation() { Enabled = true };
			Enabled = Enabled_DefaultValue = true;
			Halo = Halo_DefaultValue = new XrangeSeriesStatesSelectHalo();
			LineWidth = LineWidth_DefaultValue = null;
			LineWidthPlus = LineWidthPlus_DefaultValue = 1;
			Marker = Marker_DefaultValue = new XrangeSeriesStatesSelectMarker();
		...
		/// </summary>
		public XrangeSeriesStatesSelectHalo Halo { get; set; }
		private XrangeSeriesStatesSelectHalo Halo_DefaultValue { get; set; }
		...
		/// </summary>
		public XrangeSeriesStatesSelectMarker Marker { get; set; }
		private XrangeSeriesStatesSelectMarker Marker_DefaultValue { get; set; }
