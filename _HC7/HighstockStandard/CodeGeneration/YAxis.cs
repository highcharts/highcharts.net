...
namespace Highsoft.Web.Mvc.Stocks
{
	public partial class YAxis  : BaseObject
	{
		...
		internal override Hashtable ToHashtable(Highstock highstock)
		{
			...
			if (Breaks != null) h.Add("breaks",Breaks.ToHashtable(highstock));
			if (Categories != null) h.Add("categories",Categories);
			if (Ceiling != null) h.Add("ceiling",Ceiling);
			if (ClassName != null) h.Add("className",ClassName);
			if (Crosshair != null) h.Add("crosshair",Crosshair.ToHashtable(highstock));
			...
			if (MaxLength != null) h.Add("maxLength",MaxLength);
			if (MaxLengthNumber != null) h.Add("maxLength",MaxLengthNumber);
			...
			if (MinLength != null) h.Add("minLength",MinLength);
			if (MinLengthNumber != null) h.Add("minLength",MinLengthNumber);
			...
			if (MinorTickPosition != YAxisMinorTickPosition.Null) h.Add("minorTickPosition", highstock.FirstCharacterToLower(MinorTickPosition.ToString()));
			...
			if (PlotBands != null) h.Add("plotBands", HashifyList(highstock,PlotBands));
			if (PlotLines != null) h.Add("plotLines", HashifyList(highstock,PlotLines));
			if (Range != null) h.Add("range",Range);
			if (Resize != null) h.Add("resize",Resize.ToHashtable(highstock));
			...
			if (TickPosition != YAxisTickPosition.Null) h.Add("tickPosition", highstock.FirstCharacterToLower(TickPosition.ToString()));
