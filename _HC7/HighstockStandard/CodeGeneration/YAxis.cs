...
namespace Highsoft.Web.Mvc.Stocks
{
	public partial class YAxis  : BaseObject
	{
		...
		/// <summary>
		/// Options for axis resizing. This feature requires the[drag-panes.js](http://code.highcharts.com/stock/modules/drag-panes.js)module. It adds a thick line between panes which the user can dragin order to resize the panes.
		/// </summary>
