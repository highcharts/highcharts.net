...
namespace Highsoft.Web.Mvc.Stocks
{
	public partial class YAxisLabels  : BaseObject
	{
		...
		{
			if (Align != YAxisLabelsAlign.Null) h.Add("align", highstock.FirstCharacterToLower(Align.ToString()));
			...
			if (Overflow != YAxisLabelsOverflow.Null) h.Add("overflow", highstock.FirstCharacterToLower(Overflow.ToString()));
