...
namespace Highsoft.Web.Mvc.Stocks
{
	public partial class YAxisTitle  : BaseObject
	{
		...
		{
			if (Align != YAxisTitleAlign.Null) h.Add("align", highstock.FirstCharacterToLower(Align.ToString()));
			...
			if (TextAlign != YAxisTitleTextAlign.Null) h.Add("textAlign", highstock.FirstCharacterToLower(TextAlign.ToString()));
