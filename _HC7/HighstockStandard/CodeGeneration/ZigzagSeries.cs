...
namespace Highsoft.Web.Mvc.Stocks
{
	public partial class ZigzagSeries  : Series
	{
		public ZigzagSeries()
		{
			...
			DragDrop = DragDrop_DefaultValue = new ZigzagSeriesDragDrop();
		...
		/// </summary>
		public ZigzagSeriesDragDrop DragDrop { get; set; }
		private ZigzagSeriesDragDrop DragDrop_DefaultValue { get; set; }
