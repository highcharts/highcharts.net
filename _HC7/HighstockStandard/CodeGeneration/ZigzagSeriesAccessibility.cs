...
namespace Highsoft.Web.Mvc.Stocks
{
	public partial class ZigzagSeriesAccessibility  : BaseObject
	{
		...
		public ZigzagSeriesAccessibility()
		{
			...
			Point = Point_DefaultValue = new ZigzagSeriesAccessibilityPoint();
		...
		/// </summary>
		public ZigzagSeriesAccessibilityPoint Point { get; set; }
		private ZigzagSeriesAccessibilityPoint Point_DefaultValue { get; set; }
