...
{
	public partial class ZigzagSeriesDragDrop  : BaseObject
	{
		public ZigzagSeriesDragDrop()
		{
			DraggableX = DraggableX_DefaultValue = null;
			DraggableY = DraggableY_DefaultValue = null;
			DragHandle = DragHandle_DefaultValue = new ZigzagSeriesDragDropDragHandle();
			...
			GuideBox = GuideBox_DefaultValue = new ZigzagSeriesDragDropGuideBox();
		...
		/// </summary>
		public ZigzagSeriesDragDropDragHandle DragHandle { get; set; }
		private ZigzagSeriesDragDropDragHandle DragHandle_DefaultValue { get; set; }
		...
		/// </summary>
		public ZigzagSeriesDragDropGuideBox GuideBox { get; set; }
		private ZigzagSeriesDragDropGuideBox GuideBox_DefaultValue { get; set; }
