...
{
	public partial class ZigzagSeriesDragDropDragHandle  : BaseObject
	{
		public ZigzagSeriesDragDropDragHandle()
		{
		...
		internal override Hashtable ToHashtable()
		{
			...
			if (PathFormatter != PathFormatter_DefaultValue) { h.Add("pathFormatter",PathFormatter); Highstock.AddFunction("ZigzagSeriesDragDropDragHandlePathFormatter.pathFormatter", PathFormatter); }  
