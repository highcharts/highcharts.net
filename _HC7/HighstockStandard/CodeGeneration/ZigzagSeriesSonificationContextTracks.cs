...
{
	public partial class ZigzagSeriesSonificationContextTracks  : BaseObject
	{
		Hashtable h = new Hashtable();

		public ZigzagSeriesSonificationContextTracks()
		{
			ActiveWhen = ActiveWhen_DefaultValue = new ZigzagSeriesSonificationContextTracksActiveWhen();
			Instrument = Instrument_DefaultValue = null;
			InstrumentString = InstrumentString_DefaultValue = "null";
			Mapping = Mapping_DefaultValue = new ZigzagSeriesSonificationContextTracksMapping();
			MidiName = MidiName_DefaultValue = "";
			PointGrouping = PointGrouping_DefaultValue = new ZigzagSeriesSonificationContextTracksPointGrouping();
			...
			Type = Type_DefaultValue = ZigzagSeriesSonificationContextTracksType.Instrument;
			ValueInterval = ValueInterval_DefaultValue = null;
			ValueMapFunction = ValueMapFunction_DefaultValue = ZigzagSeriesSonificationContextTracksValueMapFunction.Linear;
		...
		/// </summary>
		public ZigzagSeriesSonificationContextTracksActiveWhen ActiveWhen { get; set; }
		private ZigzagSeriesSonificationContextTracksActiveWhen ActiveWhen_DefaultValue { get; set; }
		...
		/// </summary>
		public ZigzagSeriesSonificationContextTracksMapping Mapping { get; set; }
		private ZigzagSeriesSonificationContextTracksMapping Mapping_DefaultValue { get; set; }
		...
		/// </summary>
		public ZigzagSeriesSonificationContextTracksPointGrouping PointGrouping { get; set; }
		private ZigzagSeriesSonificationContextTracksPointGrouping PointGrouping_DefaultValue { get; set; }
		...
		/// </summary>
		public ZigzagSeriesSonificationContextTracksType Type { get; set; }
		private ZigzagSeriesSonificationContextTracksType Type_DefaultValue { get; set; }
		...
		/// </summary>
		public ZigzagSeriesSonificationContextTracksValueMapFunction ValueMapFunction { get; set; }
		private ZigzagSeriesSonificationContextTracksValueMapFunction ValueMapFunction_DefaultValue { get; set; }
