...
{
	public partial class ZigzagSeriesSonificationContextTracksMapping  : BaseObject
	{
		Hashtable h = new Hashtable();

		public ZigzagSeriesSonificationContextTracksMapping()
		{
			Frequency = Frequency_DefaultValue = new ZigzagSeriesSonificationContextTracksMappingFrequency();
			GapBetweenNotes = GapBetweenNotes_DefaultValue = new ZigzagSeriesSonificationContextTracksMappingGapBetweenNotes();
			Highpass = Highpass_DefaultValue = new ZigzagSeriesSonificationContextTracksMappingHighpass();
			Lowpass = Lowpass_DefaultValue = new ZigzagSeriesSonificationContextTracksMappingLowpass();
			NoteDuration = NoteDuration_DefaultValue = new ZigzagSeriesSonificationContextTracksMappingNoteDuration();
			Pan = Pan_DefaultValue = new ZigzagSeriesSonificationContextTracksMappingPan();
			Pitch = Pitch_DefaultValue = new ZigzagSeriesSonificationContextTracksMappingPitch();
			PitchString = PitchString_DefaultValue = "null";
			PitchNumber = PitchNumber_DefaultValue = null;
			PlayDelay = PlayDelay_DefaultValue = new ZigzagSeriesSonificationContextTracksMappingPlayDelay();
			Time = Time_DefaultValue = new ZigzagSeriesSonificationContextTracksMappingTime();
			TimeString = TimeString_DefaultValue = "null";
			TimeNumber = TimeNumber_DefaultValue = null;
			Tremolo = Tremolo_DefaultValue = new ZigzagSeriesSonificationContextTracksMappingTremolo();
			Volume = Volume_DefaultValue = new ZigzagSeriesSonificationContextTracksMappingVolume();
		...
		/// </summary>
		public ZigzagSeriesSonificationContextTracksMappingFrequency Frequency { get; set; }
		private ZigzagSeriesSonificationContextTracksMappingFrequency Frequency_DefaultValue { get; set; }
		...
		/// </summary>
		public ZigzagSeriesSonificationContextTracksMappingGapBetweenNotes GapBetweenNotes { get; set; }
		private ZigzagSeriesSonificationContextTracksMappingGapBetweenNotes GapBetweenNotes_DefaultValue { get; set; }
		...
		/// </summary>
		public ZigzagSeriesSonificationContextTracksMappingHighpass Highpass { get; set; }
		private ZigzagSeriesSonificationContextTracksMappingHighpass Highpass_DefaultValue { get; set; }
		...
		/// </summary>
		public ZigzagSeriesSonificationContextTracksMappingLowpass Lowpass { get; set; }
		private ZigzagSeriesSonificationContextTracksMappingLowpass Lowpass_DefaultValue { get; set; }
		...
		/// </summary>
		public ZigzagSeriesSonificationContextTracksMappingNoteDuration NoteDuration { get; set; }
		private ZigzagSeriesSonificationContextTracksMappingNoteDuration NoteDuration_DefaultValue { get; set; }
		...
		/// </summary>
		public ZigzagSeriesSonificationContextTracksMappingPan Pan { get; set; }
		private ZigzagSeriesSonificationContextTracksMappingPan Pan_DefaultValue { get; set; }
		...
		/// </summary>
		public ZigzagSeriesSonificationContextTracksMappingPitch Pitch { get; set; }
		private ZigzagSeriesSonificationContextTracksMappingPitch Pitch_DefaultValue { get; set; }
		...
		/// </summary>
		public ZigzagSeriesSonificationContextTracksMappingPlayDelay PlayDelay { get; set; }
		private ZigzagSeriesSonificationContextTracksMappingPlayDelay PlayDelay_DefaultValue { get; set; }
		...
		/// </summary>
		public ZigzagSeriesSonificationContextTracksMappingTime Time { get; set; }
		private ZigzagSeriesSonificationContextTracksMappingTime Time_DefaultValue { get; set; }
		...
		/// </summary>
		public ZigzagSeriesSonificationContextTracksMappingTremolo Tremolo { get; set; }
		private ZigzagSeriesSonificationContextTracksMappingTremolo Tremolo_DefaultValue { get; set; }
		 

		/// <summary>
		/// The volume of notes, from 0 to 1.
		/// </summary>
		public ZigzagSeriesSonificationContextTracksMappingVolume Volume { get; set; }
		private ZigzagSeriesSonificationContextTracksMappingVolume Volume_DefaultValue { get; set; }
