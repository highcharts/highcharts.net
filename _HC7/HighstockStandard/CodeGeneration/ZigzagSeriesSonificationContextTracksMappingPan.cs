...
{
	public partial class ZigzagSeriesSonificationContextTracksMappingPan  : BaseObject
	{
		Hashtable h = new Hashtable();

		public ZigzagSeriesSonificationContextTracksMappingPan()
		{
			MapFunction = MapFunction_DefaultValue = ZigzagSeriesSonificationContextTracksMappingPanMapFunction.Linear;
			MapTo = MapTo_DefaultValue = "";
			Max = Max_DefaultValue = null;
			Min = Min_DefaultValue = null;
			Value = Value_DefaultValue = null;
			Within = Within_DefaultValue = ZigzagSeriesSonificationContextTracksMappingPanWithin.Chart;
		...
		/// </summary>
		public ZigzagSeriesSonificationContextTracksMappingPanMapFunction MapFunction { get; set; }
		private ZigzagSeriesSonificationContextTracksMappingPanMapFunction MapFunction_DefaultValue { get; set; }
		...
		/// </summary>
		public ZigzagSeriesSonificationContextTracksMappingPanWithin Within { get; set; }
		private ZigzagSeriesSonificationContextTracksMappingPanWithin Within_DefaultValue { get; set; }
