...
namespace Highsoft.Web.Mvc.Stocks
{
	public partial class ZigzagSeriesSonificationContextTracksMappingPitch  : BaseObject
	{
		...
		{
			if (MapFunction != ZigzagSeriesSonificationContextTracksMappingPitchMapFunction.Null) h.Add("mapFunction", highstock.FirstCharacterToLower(MapFunction.ToString()));
