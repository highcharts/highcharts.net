...
{
	public partial class ZigzagSeriesSonificationContextTracksMappingTime  : BaseObject
	{
		Hashtable h = new Hashtable();

		public ZigzagSeriesSonificationContextTracksMappingTime()
		{
			MapFunction = MapFunction_DefaultValue = ZigzagSeriesSonificationContextTracksMappingTimeMapFunction.Linear;
			MapTo = MapTo_DefaultValue = "";
			Max = Max_DefaultValue = null;
			Min = Min_DefaultValue = null;
			Value = Value_DefaultValue = null;
			Within = Within_DefaultValue = ZigzagSeriesSonificationContextTracksMappingTimeWithin.Chart;
		...
		/// </summary>
		public ZigzagSeriesSonificationContextTracksMappingTimeMapFunction MapFunction { get; set; }
		private ZigzagSeriesSonificationContextTracksMappingTimeMapFunction MapFunction_DefaultValue { get; set; }
		...
		/// </summary>
		public ZigzagSeriesSonificationContextTracksMappingTimeWithin Within { get; set; }
		private ZigzagSeriesSonificationContextTracksMappingTimeWithin Within_DefaultValue { get; set; }
