...
{
	public partial class ZigzagSeriesSonificationContextTracksMappingVolume  : BaseObject
	{
		Hashtable h = new Hashtable();

		public ZigzagSeriesSonificationContextTracksMappingVolume()
		{
			MapFunction = MapFunction_DefaultValue = ZigzagSeriesSonificationContextTracksMappingVolumeMapFunction.Linear;
			MapTo = MapTo_DefaultValue = "";
			Max = Max_DefaultValue = null;
			Min = Min_DefaultValue = null;
			Value = Value_DefaultValue = null;
			Within = Within_DefaultValue = ZigzagSeriesSonificationContextTracksMappingVolumeWithin.Chart;
		...
		/// </summary>
		public ZigzagSeriesSonificationContextTracksMappingVolumeMapFunction MapFunction { get; set; }
		private ZigzagSeriesSonificationContextTracksMappingVolumeMapFunction MapFunction_DefaultValue { get; set; }
		...
		/// </summary>
		public ZigzagSeriesSonificationContextTracksMappingVolumeWithin Within { get; set; }
		private ZigzagSeriesSonificationContextTracksMappingVolumeWithin Within_DefaultValue { get; set; }
