...
{
	public partial class ZigzagSeriesSonificationContextTracksPointGrouping  : BaseObject
	{
		Hashtable h = new Hashtable();

		public ZigzagSeriesSonificationContextTracksPointGrouping()
		{
			Algorithm = Algorithm_DefaultValue = ZigzagSeriesSonificationContextTracksPointGroupingAlgorithm.Minimax;
		...
		/// </summary>
		public ZigzagSeriesSonificationContextTracksPointGroupingAlgorithm Algorithm { get; set; }
		private ZigzagSeriesSonificationContextTracksPointGroupingAlgorithm Algorithm_DefaultValue { get; set; }
