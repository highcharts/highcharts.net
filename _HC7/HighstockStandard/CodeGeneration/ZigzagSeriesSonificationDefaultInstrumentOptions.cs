...
{
	public partial class ZigzagSeriesSonificationDefaultInstrumentOptions  : BaseObject
	{
		Hashtable h = new Hashtable();

		public ZigzagSeriesSonificationDefaultInstrumentOptions()
		{
			ActiveWhen = ActiveWhen_DefaultValue = new ZigzagSeriesSonificationDefaultInstrumentOptionsActiveWhen();
			Instrument = Instrument_DefaultValue = null;
			InstrumentString = InstrumentString_DefaultValue = "null";
			Mapping = Mapping_DefaultValue = new ZigzagSeriesSonificationDefaultInstrumentOptionsMapping();
			MidiName = MidiName_DefaultValue = "";
			PointGrouping = PointGrouping_DefaultValue = new ZigzagSeriesSonificationDefaultInstrumentOptionsPointGrouping();
			RoundToMusicalNotes = RoundToMusicalNotes_DefaultValue = true;
			ShowPlayMarker = ShowPlayMarker_DefaultValue = true;
			Type = Type_DefaultValue = ZigzagSeriesSonificationDefaultInstrumentOptionsType.Instrument;
		...
		/// </summary>
		public ZigzagSeriesSonificationDefaultInstrumentOptionsActiveWhen ActiveWhen { get; set; }
		private ZigzagSeriesSonificationDefaultInstrumentOptionsActiveWhen ActiveWhen_DefaultValue { get; set; }
		...
		/// </summary>
		public ZigzagSeriesSonificationDefaultInstrumentOptionsMapping Mapping { get; set; }
		private ZigzagSeriesSonificationDefaultInstrumentOptionsMapping Mapping_DefaultValue { get; set; }
		...
		/// </summary>
		public ZigzagSeriesSonificationDefaultInstrumentOptionsPointGrouping PointGrouping { get; set; }
		private ZigzagSeriesSonificationDefaultInstrumentOptionsPointGrouping PointGrouping_DefaultValue { get; set; }
		...
		/// </summary>
		public ZigzagSeriesSonificationDefaultInstrumentOptionsType Type { get; set; }
		private ZigzagSeriesSonificationDefaultInstrumentOptionsType Type_DefaultValue { get; set; }
