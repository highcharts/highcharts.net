...
{
	public partial class ZigzagSeriesSonificationDefaultInstrumentOptionsMappingPitch  : BaseObject
	{
		Hashtable h = new Hashtable();

		public ZigzagSeriesSonificationDefaultInstrumentOptionsMappingPitch()
		{
			MapFunction = MapFunction_DefaultValue = ZigzagSeriesSonificationDefaultInstrumentOptionsMappingPitchMapFunction.Linear;
		...
		/// </summary>
		public ZigzagSeriesSonificationDefaultInstrumentOptionsMappingPitchMapFunction MapFunction { get; set; }
		private ZigzagSeriesSonificationDefaultInstrumentOptionsMappingPitchMapFunction MapFunction_DefaultValue { get; set; }
