...
{
	public partial class ZigzagSeriesSonificationDefaultSpeechOptions  : BaseObject
	{
		Hashtable h = new Hashtable();

		public ZigzagSeriesSonificationDefaultSpeechOptions()
		{
			ActiveWhen = ActiveWhen_DefaultValue = new ZigzagSeriesSonificationDefaultSpeechOptionsActiveWhen();
			Language = Language_DefaultValue = "en-US";
			Mapping = Mapping_DefaultValue = new ZigzagSeriesSonificationDefaultSpeechOptionsMapping();
			PointGrouping = PointGrouping_DefaultValue = new ZigzagSeriesSonificationDefaultSpeechOptionsPointGrouping();
			PreferredVoice = PreferredVoice_DefaultValue = "";
			ShowPlayMarker = ShowPlayMarker_DefaultValue = true;
			Type = Type_DefaultValue = ZigzagSeriesSonificationDefaultSpeechOptionsType.Instrument;
		...
		/// </summary>
		public ZigzagSeriesSonificationDefaultSpeechOptionsActiveWhen ActiveWhen { get; set; }
		private ZigzagSeriesSonificationDefaultSpeechOptionsActiveWhen ActiveWhen_DefaultValue { get; set; }
		...
		/// </summary>
		public ZigzagSeriesSonificationDefaultSpeechOptionsMapping Mapping { get; set; }
		private ZigzagSeriesSonificationDefaultSpeechOptionsMapping Mapping_DefaultValue { get; set; }
		 

		/// <summary>
		/// Options for point grouping, specifically for instrument tracks.
		/// </summary>
		public ZigzagSeriesSonificationDefaultSpeechOptionsPointGrouping PointGrouping { get; set; }
		private ZigzagSeriesSonificationDefaultSpeechOptionsPointGrouping PointGrouping_DefaultValue { get; set; }
		...
		/// </summary>
		public ZigzagSeriesSonificationDefaultSpeechOptionsType Type { get; set; }
		private ZigzagSeriesSonificationDefaultSpeechOptionsType Type_DefaultValue { get; set; }
