...
{
	public partial class ZigzagSeriesSonificationTracks  : BaseObject
	{
		Hashtable h = new Hashtable();

		public ZigzagSeriesSonificationTracks()
		{
			ActiveWhen = ActiveWhen_DefaultValue = new ZigzagSeriesSonificationTracksActiveWhen();
			Instrument = Instrument_DefaultValue = null;
			InstrumentString = InstrumentString_DefaultValue = "null";
			Mapping = Mapping_DefaultValue = new ZigzagSeriesSonificationTracksMapping();
			MidiName = MidiName_DefaultValue = "";
			PointGrouping = PointGrouping_DefaultValue = new ZigzagSeriesSonificationTracksPointGrouping();
			RoundToMusicalNotes = RoundToMusicalNotes_DefaultValue = true;
			ShowPlayMarker = ShowPlayMarker_DefaultValue = true;
			Type = Type_DefaultValue = ZigzagSeriesSonificationTracksType.Instrument;
		...
		/// </summary>
		public ZigzagSeriesSonificationTracksActiveWhen ActiveWhen { get; set; }
		private ZigzagSeriesSonificationTracksActiveWhen ActiveWhen_DefaultValue { get; set; }
		...
		/// </summary>
		public ZigzagSeriesSonificationTracksMapping Mapping { get; set; }
		private ZigzagSeriesSonificationTracksMapping Mapping_DefaultValue { get; set; }
		...
		/// </summary>
		public ZigzagSeriesSonificationTracksPointGrouping PointGrouping { get; set; }
		private ZigzagSeriesSonificationTracksPointGrouping PointGrouping_DefaultValue { get; set; }
		...
		/// </summary>
		public ZigzagSeriesSonificationTracksType Type { get; set; }
		private ZigzagSeriesSonificationTracksType Type_DefaultValue { get; set; }
