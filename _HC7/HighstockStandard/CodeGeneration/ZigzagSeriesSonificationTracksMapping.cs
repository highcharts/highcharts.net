...
{
	public partial class ZigzagSeriesSonificationTracksMapping  : BaseObject
	{
		Hashtable h = new Hashtable();

		public ZigzagSeriesSonificationTracksMapping()
		{
			Frequency = Frequency_DefaultValue = new ZigzagSeriesSonificationTracksMappingFrequency();
			GapBetweenNotes = GapBetweenNotes_DefaultValue = new ZigzagSeriesSonificationTracksMappingGapBetweenNotes();
			Highpass = Highpass_DefaultValue = new ZigzagSeriesSonificationTracksMappingHighpass();
			Lowpass = Lowpass_DefaultValue = new ZigzagSeriesSonificationTracksMappingLowpass();
			NoteDuration = NoteDuration_DefaultValue = new ZigzagSeriesSonificationTracksMappingNoteDuration();
			Pan = Pan_DefaultValue = new ZigzagSeriesSonificationTracksMappingPan();
			Pitch = Pitch_DefaultValue = new ZigzagSeriesSonificationTracksMappingPitch();
			PitchString = PitchString_DefaultValue = "null";
			PitchNumber = PitchNumber_DefaultValue = null;
			PlayDelay = PlayDelay_DefaultValue = new ZigzagSeriesSonificationTracksMappingPlayDelay();
			Time = Time_DefaultValue = new ZigzagSeriesSonificationTracksMappingTime();
			TimeString = TimeString_DefaultValue = "null";
			TimeNumber = TimeNumber_DefaultValue = null;
			Tremolo = Tremolo_DefaultValue = new ZigzagSeriesSonificationTracksMappingTremolo();
			Volume = Volume_DefaultValue = new ZigzagSeriesSonificationTracksMappingVolume();
		...
		/// </summary>
		public ZigzagSeriesSonificationTracksMappingFrequency Frequency { get; set; }
		private ZigzagSeriesSonificationTracksMappingFrequency Frequency_DefaultValue { get; set; }
		...
		/// </summary>
		public ZigzagSeriesSonificationTracksMappingGapBetweenNotes GapBetweenNotes { get; set; }
		private ZigzagSeriesSonificationTracksMappingGapBetweenNotes GapBetweenNotes_DefaultValue { get; set; }
		...
		/// </summary>
		public ZigzagSeriesSonificationTracksMappingHighpass Highpass { get; set; }
		private ZigzagSeriesSonificationTracksMappingHighpass Highpass_DefaultValue { get; set; }
		...
		/// </summary>
		public ZigzagSeriesSonificationTracksMappingLowpass Lowpass { get; set; }
		private ZigzagSeriesSonificationTracksMappingLowpass Lowpass_DefaultValue { get; set; }
		...
		/// </summary>
		public ZigzagSeriesSonificationTracksMappingNoteDuration NoteDuration { get; set; }
		private ZigzagSeriesSonificationTracksMappingNoteDuration NoteDuration_DefaultValue { get; set; }
		...
		/// </summary>
		public ZigzagSeriesSonificationTracksMappingPan Pan { get; set; }
		private ZigzagSeriesSonificationTracksMappingPan Pan_DefaultValue { get; set; }
		...
		/// </summary>
		public ZigzagSeriesSonificationTracksMappingPitch Pitch { get; set; }
		private ZigzagSeriesSonificationTracksMappingPitch Pitch_DefaultValue { get; set; }
		...
		/// </summary>
		public ZigzagSeriesSonificationTracksMappingPlayDelay PlayDelay { get; set; }
		private ZigzagSeriesSonificationTracksMappingPlayDelay PlayDelay_DefaultValue { get; set; }
		...
		/// </summary>
		public ZigzagSeriesSonificationTracksMappingTime Time { get; set; }
		private ZigzagSeriesSonificationTracksMappingTime Time_DefaultValue { get; set; }
		...
		/// </summary>
		public ZigzagSeriesSonificationTracksMappingTremolo Tremolo { get; set; }
		private ZigzagSeriesSonificationTracksMappingTremolo Tremolo_DefaultValue { get; set; }
		 

		/// <summary>
		/// The volume of notes, from 0 to 1.
		/// </summary>
		public ZigzagSeriesSonificationTracksMappingVolume Volume { get; set; }
		private ZigzagSeriesSonificationTracksMappingVolume Volume_DefaultValue { get; set; }
