...
{
	public partial class ZigzagSeriesSonificationTracksMappingFrequency  : BaseObject
	{
		Hashtable h = new Hashtable();

		public ZigzagSeriesSonificationTracksMappingFrequency()
		{
			MapFunction = MapFunction_DefaultValue = ZigzagSeriesSonificationTracksMappingFrequencyMapFunction.Linear;
			MapTo = MapTo_DefaultValue = "";
			Max = Max_DefaultValue = null;
			Min = Min_DefaultValue = null;
			Value = Value_DefaultValue = null;
			Within = Within_DefaultValue = ZigzagSeriesSonificationTracksMappingFrequencyWithin.Chart;
		...
		/// </summary>
		public ZigzagSeriesSonificationTracksMappingFrequencyMapFunction MapFunction { get; set; }
		private ZigzagSeriesSonificationTracksMappingFrequencyMapFunction MapFunction_DefaultValue { get; set; }
		...
		/// </summary>
		public ZigzagSeriesSonificationTracksMappingFrequencyWithin Within { get; set; }
		private ZigzagSeriesSonificationTracksMappingFrequencyWithin Within_DefaultValue { get; set; }
