...
{
	public partial class ZigzagSeriesSonificationTracksMappingNoteDuration  : BaseObject
	{
		Hashtable h = new Hashtable();

		public ZigzagSeriesSonificationTracksMappingNoteDuration()
		{
			MapFunction = MapFunction_DefaultValue = ZigzagSeriesSonificationTracksMappingNoteDurationMapFunction.Linear;
			MapTo = MapTo_DefaultValue = "";
			Max = Max_DefaultValue = null;
			Min = Min_DefaultValue = null;
			Value = Value_DefaultValue = null;
			Within = Within_DefaultValue = ZigzagSeriesSonificationTracksMappingNoteDurationWithin.Chart;
		...
		/// </summary>
		public ZigzagSeriesSonificationTracksMappingNoteDurationMapFunction MapFunction { get; set; }
		private ZigzagSeriesSonificationTracksMappingNoteDurationMapFunction MapFunction_DefaultValue { get; set; }
		...
		/// </summary>
		public ZigzagSeriesSonificationTracksMappingNoteDurationWithin Within { get; set; }
		private ZigzagSeriesSonificationTracksMappingNoteDurationWithin Within_DefaultValue { get; set; }
