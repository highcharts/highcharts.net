...
{
	public partial class ZigzagSeriesSonificationTracksMappingPan  : BaseObject
	{
		Hashtable h = new Hashtable();

		public ZigzagSeriesSonificationTracksMappingPan()
		{
			MapFunction = MapFunction_DefaultValue = ZigzagSeriesSonificationTracksMappingPanMapFunction.Linear;
			MapTo = MapTo_DefaultValue = "";
			Max = Max_DefaultValue = null;
			Min = Min_DefaultValue = null;
			Value = Value_DefaultValue = null;
			Within = Within_DefaultValue = ZigzagSeriesSonificationTracksMappingPanWithin.Chart;
		...
		/// </summary>
		public ZigzagSeriesSonificationTracksMappingPanMapFunction MapFunction { get; set; }
		private ZigzagSeriesSonificationTracksMappingPanMapFunction MapFunction_DefaultValue { get; set; }
		...
		/// </summary>
		public ZigzagSeriesSonificationTracksMappingPanWithin Within { get; set; }
		private ZigzagSeriesSonificationTracksMappingPanWithin Within_DefaultValue { get; set; }
