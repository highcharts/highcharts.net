...
{
	public partial class ZigzagSeriesSonificationTracksMappingPitch  : BaseObject
	{
		Hashtable h = new Hashtable();

		public ZigzagSeriesSonificationTracksMappingPitch()
		{
			MapFunction = MapFunction_DefaultValue = ZigzagSeriesSonificationTracksMappingPitchMapFunction.Linear;
		...
		/// </summary>
		public ZigzagSeriesSonificationTracksMappingPitchMapFunction MapFunction { get; set; }
		private ZigzagSeriesSonificationTracksMappingPitchMapFunction MapFunction_DefaultValue { get; set; }
