...
{
	public partial class ZigzagSeriesSonificationTracksMappingPlayDelay  : BaseObject
	{
		Hashtable h = new Hashtable();

		public ZigzagSeriesSonificationTracksMappingPlayDelay()
		{
			MapFunction = MapFunction_DefaultValue = ZigzagSeriesSonificationTracksMappingPlayDelayMapFunction.Linear;
			MapTo = MapTo_DefaultValue = "";
			Max = Max_DefaultValue = null;
			Min = Min_DefaultValue = null;
			Value = Value_DefaultValue = null;
			Within = Within_DefaultValue = ZigzagSeriesSonificationTracksMappingPlayDelayWithin.Chart;
		...
		/// </summary>
		public ZigzagSeriesSonificationTracksMappingPlayDelayMapFunction MapFunction { get; set; }
		private ZigzagSeriesSonificationTracksMappingPlayDelayMapFunction MapFunction_DefaultValue { get; set; }
		...
		/// </summary>
		public ZigzagSeriesSonificationTracksMappingPlayDelayWithin Within { get; set; }
		private ZigzagSeriesSonificationTracksMappingPlayDelayWithin Within_DefaultValue { get; set; }
