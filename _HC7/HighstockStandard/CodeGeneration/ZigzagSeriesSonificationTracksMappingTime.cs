...
{
	public partial class ZigzagSeriesSonificationTracksMappingTime  : BaseObject
	{
		Hashtable h = new Hashtable();

		public ZigzagSeriesSonificationTracksMappingTime()
		{
			MapFunction = MapFunction_DefaultValue = ZigzagSeriesSonificationTracksMappingTimeMapFunction.Linear;
			MapTo = MapTo_DefaultValue = "";
			Max = Max_DefaultValue = null;
			Min = Min_DefaultValue = null;
			Value = Value_DefaultValue = null;
			Within = Within_DefaultValue = ZigzagSeriesSonificationTracksMappingTimeWithin.Chart;
		...
		/// </summary>
		public ZigzagSeriesSonificationTracksMappingTimeMapFunction MapFunction { get; set; }
		private ZigzagSeriesSonificationTracksMappingTimeMapFunction MapFunction_DefaultValue { get; set; }
		...
		/// </summary>
		public ZigzagSeriesSonificationTracksMappingTimeWithin Within { get; set; }
		private ZigzagSeriesSonificationTracksMappingTimeWithin Within_DefaultValue { get; set; }
