...
{
	public partial class ZigzagSeriesSonificationTracksMappingTremoloDepth  : BaseObject
	{
		Hashtable h = new Hashtable();

		public ZigzagSeriesSonificationTracksMappingTremoloDepth()
		{
			MapFunction = MapFunction_DefaultValue = ZigzagSeriesSonificationTracksMappingTremoloDepthMapFunction.Linear;
			MapTo = MapTo_DefaultValue = "";
			Max = Max_DefaultValue = null;
			Min = Min_DefaultValue = null;
			Value = Value_DefaultValue = null;
			Within = Within_DefaultValue = ZigzagSeriesSonificationTracksMappingTremoloDepthWithin.Chart;
		...
		/// </summary>
		public ZigzagSeriesSonificationTracksMappingTremoloDepthMapFunction MapFunction { get; set; }
		private ZigzagSeriesSonificationTracksMappingTremoloDepthMapFunction MapFunction_DefaultValue { get; set; }
		...
		/// </summary>
		public ZigzagSeriesSonificationTracksMappingTremoloDepthWithin Within { get; set; }
		private ZigzagSeriesSonificationTracksMappingTremoloDepthWithin Within_DefaultValue { get; set; }
