...
{
	public partial class ZigzagSeriesSonificationTracksMappingTremoloSpeed  : BaseObject
	{
		Hashtable h = new Hashtable();

		public ZigzagSeriesSonificationTracksMappingTremoloSpeed()
		{
			MapFunction = MapFunction_DefaultValue = ZigzagSeriesSonificationTracksMappingTremoloSpeedMapFunction.Linear;
			MapTo = MapTo_DefaultValue = "";
			Max = Max_DefaultValue = null;
			Min = Min_DefaultValue = null;
			Value = Value_DefaultValue = null;
			Within = Within_DefaultValue = ZigzagSeriesSonificationTracksMappingTremoloSpeedWithin.Chart;
		...
		/// </summary>
		public ZigzagSeriesSonificationTracksMappingTremoloSpeedMapFunction MapFunction { get; set; }
		private ZigzagSeriesSonificationTracksMappingTremoloSpeedMapFunction MapFunction_DefaultValue { get; set; }
		...
		/// </summary>
		public ZigzagSeriesSonificationTracksMappingTremoloSpeedWithin Within { get; set; }
		private ZigzagSeriesSonificationTracksMappingTremoloSpeedWithin Within_DefaultValue { get; set; }
