...
{
	public partial class ZigzagSeriesSonificationTracksMappingVolume  : BaseObject
	{
		Hashtable h = new Hashtable();

		public ZigzagSeriesSonificationTracksMappingVolume()
		{
			MapFunction = MapFunction_DefaultValue = ZigzagSeriesSonificationTracksMappingVolumeMapFunction.Linear;
			MapTo = MapTo_DefaultValue = "";
			Max = Max_DefaultValue = null;
			Min = Min_DefaultValue = null;
			Value = Value_DefaultValue = null;
			Within = Within_DefaultValue = ZigzagSeriesSonificationTracksMappingVolumeWithin.Chart;
		...
		/// </summary>
		public ZigzagSeriesSonificationTracksMappingVolumeMapFunction MapFunction { get; set; }
		private ZigzagSeriesSonificationTracksMappingVolumeMapFunction MapFunction_DefaultValue { get; set; }
		...
		/// </summary>
		public ZigzagSeriesSonificationTracksMappingVolumeWithin Within { get; set; }
		private ZigzagSeriesSonificationTracksMappingVolumeWithin Within_DefaultValue { get; set; }
