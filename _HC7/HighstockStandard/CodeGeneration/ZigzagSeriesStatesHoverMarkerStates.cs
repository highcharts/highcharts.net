...
namespace Highsoft.Web.Mvc.Stocks
{
	public partial class ZigzagSeriesStatesHoverMarkerStates  : BaseObject
	{
		public ZigzagSeriesStatesHoverMarkerStates()
		{
			...
			Inactive = Inactive_DefaultValue = new ZigzagSeriesStatesHoverMarkerStatesInactive();
		...
		/// 
		/// </summary>
		public ZigzagSeriesStatesHoverMarkerStatesInactive Inactive { get; set; }
		private ZigzagSeriesStatesHoverMarkerStatesInactive Inactive_DefaultValue { get; set; }
