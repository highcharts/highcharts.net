...
{
    public class PlotOptionsAreasplineTests : IClassFixture<HsFixture>
    {
        protected HsFixture _fixture;

        public PlotOptionsAreasplineTests(HsFixture fixture)
        {
            _fixture = fixture;
        ...
        public void Test_IfAnimationEnabledRenders_Correct()
        {
            ...
            chart.PlotOptions.Areaspline.AnimationBool = value;
        ...
        public void Test_IfDataLabelsDeferBoolDoesntRenderForDefault_Correct()
        {
            ...
            chart.PlotOptions.Areaspline.DataLabels.Defer = defaultValue;
        ...
        public void Test_IfDataLabelsZRenders_Correct(double value)
        {
            ...
            chart.PlotOptions.Areaspline.DataLabels.ZIndex = value;
        ...
        public void Test_IfDataLabelsZDoesntRenderForDefault_Correct()
        {
            ...
            chart.PlotOptions.Areaspline.DataLabels.ZIndex = defaultValue;
        ...
        public void Test_IfZonesClassNameRenders_Correct(string value)
        {
            ...
            var zoneDef = new List<PlotOptionsAreasplineZones> { new PlotOptionsAreasplineZones { ClassName = value } };
        ...
        public void Test_IfZonesClassNameDoesntRenderForDefault_Correct()
        {
            ...
            var renderer = new HighstockRenderer(chart);
            var defaultValue = string.Empty;
            var zoneDef = new List<PlotOptionsAreasplineZones> { new PlotOptionsAreasplineZones { ClassName = defaultValue } };
        ...
        public void Test_IfZonesColorRenders_Correct(string value)
        {
            ...
            var renderer = new HighstockRenderer(chart);
            var pathToProperty = new List<string>() { "plotOptions", "areaspline", "zones" };
            var zoneDef = new List<PlotOptionsAreasplineZones> { new PlotOptionsAreasplineZones { Color = value } };
        ...
        public void Test_IfZonesColorDoesntRenderForDefault_Correct()
        {
            ...
            var renderer = new HighstockRenderer(chart);
            var defaultValue = string.Empty;
            var zoneDef = new List<PlotOptionsAreasplineZones> { new PlotOptionsAreasplineZones { Color = defaultValue } };
        ...
        public void Test_IfZonesDashStyleRenders_Correct(PlotOptionsAreasplineZonesDashStyle value)
        {
            ...
            var renderer = new HighstockRenderer(chart);
            var pathToProperty = new List<string>() { "plotOptions", "areaspline", "zones" };
            var zoneDef = new List<PlotOptionsAreasplineZones> { new PlotOptionsAreasplineZones { DashStyle = value } };
        ...
        public void Test_IfZonesDashStyleDoesntRenderForDefault_Correct()
        {
            ...
            var zoneDef = new List<PlotOptionsAreasplineZones> { new PlotOptionsAreasplineZones { DashStyle = defaultValue } };
        ...
        public void Test_IfZonesFillColorRenders_Correct(string value)
        {
            ...
            var renderer = new HighstockRenderer(chart);
            var pathToProperty = new List<string>() { "plotOptions", "areaspline", "zones" };
            var zoneDef = new List<PlotOptionsAreasplineZones> { new PlotOptionsAreasplineZones { FillColor = value } };
        ...
        //    var renderer = new HighstockRenderer(chart);
        //    var defaultValue = string.Empty;
        //    var zoneDef = new List<PlotOptionsAreasplineZones> { new PlotOptionsAreasplineZones { FillColor = defaultValue } };
        ...
        public void Test_IfZonesValueRenders_Correct(double value)
        {
            ...
            var renderer = new HighstockRenderer(chart);
            var pathToProperty = new List<string>() { "plotOptions", "areaspline", "zones" };
            var zoneDef = new List<PlotOptionsAreasplineZones> { new PlotOptionsAreasplineZones { Value = value } };
        ...
        public void Test_IfZonesValueDoesntRenderForDefault_Correct()
        {
            ...
            var renderer = new HighstockRenderer(chart);
            double? defaultValue = null;
            var zoneDef = new List<PlotOptionsAreasplineZones> { new PlotOptionsAreasplineZones { Value = defaultValue } };
