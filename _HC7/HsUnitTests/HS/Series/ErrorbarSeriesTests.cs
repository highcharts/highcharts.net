//clarification required - plotOptions.errorbar exists but series.errorbar doesn't exist in API
...
//namespace HS.Series
//{
//    public class ErrorbarSeriesTests : IClassFixture<HsFixture>
//    {
//        protected HsFixture _fixture;

//        public ErrorbarSeriesTests(HsFixture fixture)
//        {
//            _fixture = fixture;
...
//            ((ErrorbarSeries)chart.Series[0]).Accessibility.Enabled = enabled;
...
//            ((ErrorbarSeries)chart.Series[0]).Accessibility.ExposeAsGroupOnly = exposeAsGroupOnly;
...
//            ((ErrorbarSeries)chart.Series[0]).Accessibility.KeyboardNavigation.Enabled = enabled;
...
//            ((ErrorbarSeries)chart.Series[0]).Accessibility.Point.DateFormat = format;
...
//            ((ErrorbarSeries)chart.Series[0]).Accessibility.Point.DateFormatter = function;
...
//            ((ErrorbarSeries)chart.Series[0]).Accessibility.Point.DescribeNull = describeNull;
...
//            ((ErrorbarSeries)chart.Series[0]).Accessibility.Point.DescriptionFormatter = function;
...
//            ((ErrorbarSeries)chart.Series[0]).Accessibility.Point.ValueDecimals = decimals;
...
//            ((ErrorbarSeries)chart.Series[0]).Accessibility.Point.ValueDescriptionFormat = format;
...
//            ((ErrorbarSeries)chart.Series[0]).Accessibility.Point.ValuePrefix = prefix;
...
//            ((ErrorbarSeries)chart.Series[0]).Accessibility.Point.ValueSuffix = suffix;
...
//            ((ErrorbarSeries)chart.Series[0]).AllowPointSelect = enabled;
...
//            ((ErrorbarSeries)chart.Series[0]).AllowPointSelect = false;
...
//            ((ErrorbarSeries)chart.Series[0]).AnimationBool = enabled;
...
//        //    ((ErrorbarSeries)chart.Series[0]).Animation.Duration = duration;
...
//        //    ((ErrorbarSeries)chart.Series[0]).Animation.Defer = defer;
...
//        //    ((ErrorbarSeries)chart.Series[0]).Animation.Easing = easing;
...
//        [Theory]
//        [InlineData(ErrorbarSeriesBoostBlending.Add)]
//        [InlineData(ErrorbarSeriesBoostBlending.Darken)]
//        [InlineData(ErrorbarSeriesBoostBlending.Multiply)]
//        public void Test_IfBoostBlendingRenders_Correct(ErrorbarSeriesBoostBlending boostBlending)
//        {
//            var chart = new Highstock();
//            var renderer = new HighstockRenderer(chart); var series = new ErrorbarSeries(); chart.Series.Add(series);

//            ((ErrorbarSeries)chart.Series[0]).BoostBlending = boostBlending;
...
//            ((ErrorbarSeries)chart.Series[0]).BoostBlending = ErrorbarSeriesBoostBlending.Undefined;
...
//            ((ErrorbarSeries)chart.Series[0]).BoostThreshold = limit;
...
//            ((ErrorbarSeries)chart.Series[0]).BoostThreshold = defaultValue;
...
//            ((ErrorbarSeries)chart.Series[0]).ClassName = className;
...
//            ((ErrorbarSeries)chart.Series[0]).Clip = value;
...
//            ((ErrorbarSeries)chart.Series[0]).Color = color;
...
//            ((ErrorbarSeries)chart.Series[0]).ColorAxis = id;
...
//            ((ErrorbarSeries)chart.Series[0]).ColorAxisNumber = index;
...
//            var chart = new Highstock();
//            var renderer = new HighstockRenderer(chart); var series = new ErrorbarSeries(); chart.Series.Add(series);
//            ((ErrorbarSeries)chart.Series[0]).ColorAxisBool = value;
...
//            ((ErrorbarSeries)chart.Series[0]).ColorIndex = value;
...
//            ((ErrorbarSeries)chart.Series[0]).ColorKey = value;
...
//            ((ErrorbarSeries)chart.Series[0]).ConnectNulls = value;
...
//            ((ErrorbarSeries)chart.Series[0]).Crisp = value;
...
//            ((ErrorbarSeries)chart.Series[0]).CropThreshold = value;
...
//            ((ErrorbarSeries)chart.Series[0]).CropThreshold = defaultValue;

//            Assert.DoesNotContain($"\"crisp\"", renderer.RenderHtml());
//        }

//        [Theory]
//        [InlineData(ErrorbarSeriesCursor.Default)]
//        [InlineData(ErrorbarSeriesCursor.Help)]
//        [InlineData(ErrorbarSeriesCursor.Pointer)]
//        [InlineData(ErrorbarSeriesCursor.None)]
//        public void Test_IfCursorRenders_Correct(ErrorbarSeriesCursor cursor)
//        {
//            var chart = new Highstock();
//            var renderer = new HighstockRenderer(chart); var series = new ErrorbarSeries(); chart.Series.Add(series);

//            ((ErrorbarSeries)chart.Series[0]).Cursor = cursor;
...
//            ((ErrorbarSeries)chart.Series[0]).Custom = extraData;

//            Assert.Contains($"\"custom\":{{\"{key1}\":\"{value1}\"}}", renderer.RenderHtml());
//        }

//        [Theory]
//        [InlineData(ErrorbarSeriesDashStyle.Dash)]
//        [InlineData(ErrorbarSeriesDashStyle.DashDot)]
//        [InlineData(ErrorbarSeriesDashStyle.Dot)]
//        [InlineData(ErrorbarSeriesDashStyle.LongDash)]
//        [InlineData(ErrorbarSeriesDashStyle.LongDashDot)]
//        [InlineData(ErrorbarSeriesDashStyle.LongDashDotDot)]
//        [InlineData(ErrorbarSeriesDashStyle.ShortDash)]
//        [InlineData(ErrorbarSeriesDashStyle.ShortDashDot)]
//        [InlineData(ErrorbarSeriesDashStyle.ShortDashDotDot)]
//        [InlineData(ErrorbarSeriesDashStyle.ShortDot)]
//        public void Test_IfDashStyleRenders_Correct(ErrorbarSeriesDashStyle style)
//        {
//            var chart = new Highstock();
//            var renderer = new HighstockRenderer(chart); var series = new ErrorbarSeries(); chart.Series.Add(series);
...
//            ((ErrorbarSeries)chart.Series[0]).DashStyle = style;
...
//        [Theory]
//        [InlineData(ErrorbarSeriesDataLabelsAlign.Left)]
//        [InlineData(ErrorbarSeriesDataLabelsAlign.Right)]
//        public void Test_IfDataLabelsAlignRenders_Correct(ErrorbarSeriesDataLabelsAlign align)
//        {
//            var chart = new Highstock();
//            var renderer = new HighstockRenderer(chart); var series = new ErrorbarSeries(); chart.Series.Add(series);

//            ((ErrorbarSeries)chart.Series[0]).DataLabels.Align = align;
...
//            var chart = new Highstock();
//            var renderer = new HighstockRenderer(chart); var series = new ErrorbarSeries(); chart.Series.Add(series);
//            var defaultValue = ErrorbarSeriesDataLabelsAlign.Center;

//            ((ErrorbarSeries)chart.Series[0]).DataLabels.Align = defaultValue;
...
//            ((ErrorbarSeries)chart.Series[0]).DataLabels.AllowOverlap = value;
...
//            ((ErrorbarSeries)chart.Series[0]).DataLabels.AllowOverlap = defaultValue;
...
//        //    ((ErrorbarSeries)chart.Series[0]).DataLabels.Animation.Defer = value;
...
//        //    ((ErrorbarSeries)chart.Series[0]).DataLabels.Animation.Defer = defaultValue;
...
//            ((ErrorbarSeries)chart.Series[0]).DataLabels.BackgroundColor = value;
...
//            ((ErrorbarSeries)chart.Series[0]).DataLabels.BackgroundColor = defaultValue;
...
//            ((ErrorbarSeries)chart.Series[0]).DataLabels.BorderColor = value;
...
//            ((ErrorbarSeries)chart.Series[0]).DataLabels.BorderColor = defaultValue;
...
//            ((ErrorbarSeries)chart.Series[0]).DataLabels.BorderRadius = value;
...
//            ((ErrorbarSeries)chart.Series[0]).DataLabels.BorderRadius = defaultValue;
...
//            ((ErrorbarSeries)chart.Series[0]).DataLabels.BorderWidth = value;
...
//            ((ErrorbarSeries)chart.Series[0]).DataLabels.BorderWidth = defaultValue;
...
//            ((ErrorbarSeries)chart.Series[0]).DataLabels.ClassName = value;
...
//            ((ErrorbarSeries)chart.Series[0]).DataLabels.ClassName = defaultValue;
...
//            ((ErrorbarSeries)chart.Series[0]).DataLabels.Color = value;
...
//            ((ErrorbarSeries)chart.Series[0]).DataLabels.Color = defaultValue;
...
//            ((ErrorbarSeries)chart.Series[0]).DataLabels.Crop = value;
...
//            ((ErrorbarSeries)chart.Series[0]).DataLabels.Crop = defaultValue;
...
//            ((ErrorbarSeries)chart.Series[0]).DataLabels.Enabled = value;
...
//            ((ErrorbarSeries)chart.Series[0]).DataLabels.Enabled = defaultValue;
...
//            ((ErrorbarSeries)chart.Series[0]).DataLabels.Filter.Operator = value;
...
//            ((ErrorbarSeries)chart.Series[0]).DataLabels.Filter.Operator = defaultValue;
...
//            ((ErrorbarSeries)chart.Series[0]).DataLabels.Filter.Property = value;
...
//            ((ErrorbarSeries)chart.Series[0]).DataLabels.Filter.Property = defaultValue;
...
//            ((ErrorbarSeries)chart.Series[0]).DataLabels.Filter.Value = value;
...
//            ((ErrorbarSeries)chart.Series[0]).DataLabels.Filter.Value = defaultValue;
...
//            ((ErrorbarSeries)chart.Series[0]).DataLabels.Format = value;
...
//            ((ErrorbarSeries)chart.Series[0]).DataLabels.Format = defaultValue;
...
//            ((ErrorbarSeries)chart.Series[0]).DataLabels.Formatter = value;
...
//            ((ErrorbarSeries)chart.Series[0]).DataLabels.Formatter = defaultValue;
...
//            ((ErrorbarSeries)chart.Series[0]).DataLabels.Inside = value;
...
//            ((ErrorbarSeries)chart.Series[0]).DataLabels.Inside = defaultValue;
...
//            ((ErrorbarSeries)chart.Series[0]).DataLabels.NullFormatBool = value;
...
//            ((ErrorbarSeries)chart.Series[0]).DataLabels.NullFormatBool = defaultValue;
...
//            ((ErrorbarSeries)chart.Series[0]).DataLabels.NullFormat = value;
...
//            ((ErrorbarSeries)chart.Series[0]).DataLabels.NullFormat = defaultValue;
...
//            ((ErrorbarSeries)chart.Series[0]).DataLabels.NullFormatter = value;
...
//            ((ErrorbarSeries)chart.Series[0]).DataLabels.NullFormatter = defaultValue;

//            Assert.DoesNotContain($"nullFormatter", renderer.RenderHtml());
//        }

//        [Theory]
//        [InlineData(ErrorbarSeriesDataLabelsOverflow.Allow)]
//        public void Test_IfDataLabelsOverflowRenders_Correct(ErrorbarSeriesDataLabelsOverflow align)
//        {
//            var chart = new Highstock();
//            var renderer = new HighstockRenderer(chart); var series = new ErrorbarSeries(); chart.Series.Add(series);

//            ((ErrorbarSeries)chart.Series[0]).DataLabels.Overflow = align;
...
//            var chart = new Highstock();
//            var renderer = new HighstockRenderer(chart); var series = new ErrorbarSeries(); chart.Series.Add(series);
//            var defaultValue = ErrorbarSeriesDataLabelsOverflow.Justify;

//            ((ErrorbarSeries)chart.Series[0]).DataLabels.Overflow = defaultValue;
...
//            ((ErrorbarSeries)chart.Series[0]).DataLabels.Padding = value;
...
//            ((ErrorbarSeries)chart.Series[0]).DataLabels.Padding = defaultValue;

//            Assert.DoesNotContain($"padding", renderer.RenderHtml());
//        }

//        [Theory]
//        [InlineData(ErrorbarSeriesDataLabelsPosition.Left)]
//        [InlineData(ErrorbarSeriesDataLabelsPosition.Right)]
//        public void Test_IfDataLabelsPositionRenders_Correct(ErrorbarSeriesDataLabelsPosition align)
//        {
//            var chart = new Highstock();
//            var renderer = new HighstockRenderer(chart); var series = new ErrorbarSeries(); chart.Series.Add(series);

//            ((ErrorbarSeries)chart.Series[0]).DataLabels.Position = align;
...
//            var chart = new Highstock();
//            var renderer = new HighstockRenderer(chart); var series = new ErrorbarSeries(); chart.Series.Add(series);
//            var defaultValue = ErrorbarSeriesDataLabelsPosition.Center;

//            ((ErrorbarSeries)chart.Series[0]).DataLabels.Position = defaultValue;
...
//            ((ErrorbarSeries)chart.Series[0]).DataLabels.Rotation = value;
...
//            ((ErrorbarSeries)chart.Series[0]).DataLabels.Rotation = defaultValue;
...
//            ((ErrorbarSeries)chart.Series[0]).DataLabels.ShadowBool = value;
...
//            ((ErrorbarSeries)chart.Series[0]).DataLabels.Shadow = new Shadow()
//            {
//                Color = color,
//                OffsetX = offsetX,
//                OffsetY = offsetY,
...
//            ((ErrorbarSeries)chart.Series[0]).DataLabels.ShadowBool = defaultValue;
...
//            ((ErrorbarSeries)chart.Series[0]).DataLabels.Shape = value;
...
//            ((ErrorbarSeries)chart.Series[0]).DataLabels.Shape = defaultValue;
...
//            ((ErrorbarSeries)chart.Series[0]).DataLabels.Style = style;
...
//            ((ErrorbarSeries)chart.Series[0]).DataLabels.TextPath.Enabled = value;
...
//            ((ErrorbarSeries)chart.Series[0]).DataLabels.TextPath.Enabled = defaultValue;
...
//            ((ErrorbarSeries)chart.Series[0]).DataLabels.UseHTML = value;
...
//            ((ErrorbarSeries)chart.Series[0]).DataLabels.UseHTML = defaultValue;

//            Assert.DoesNotContain($"useHTML", renderer.RenderHtml());
//        }

//        [Theory]
//        [InlineData(ErrorbarSeriesDataLabelsVerticalAlign.Middle)]
//        [InlineData(ErrorbarSeriesDataLabelsVerticalAlign.Top)]
//        public void Test_IfDataLabelsVerticalAlignRenders_Correct(ErrorbarSeriesDataLabelsVerticalAlign align)
//        {
//            var chart = new Highstock();
//            var renderer = new HighstockRenderer(chart); var series = new ErrorbarSeries(); chart.Series.Add(series);

//            ((ErrorbarSeries)chart.Series[0]).DataLabels.VerticalAlign = align;
...
//            var chart = new Highstock();
//            var renderer = new HighstockRenderer(chart); var series = new ErrorbarSeries(); chart.Series.Add(series);
//            var defaultValue = ErrorbarSeriesDataLabelsVerticalAlign.Bottom;

//            ((ErrorbarSeries)chart.Series[0]).DataLabels.VerticalAlign = defaultValue;
...
//            ((ErrorbarSeries)chart.Series[0]).DataLabels.X = value;
...
//            ((ErrorbarSeries)chart.Series[0]).DataLabels.X = defaultValue;
...
//            ((ErrorbarSeries)chart.Series[0]).DataLabels.Y = value;
...
//            ((ErrorbarSeries)chart.Series[0]).DataLabels.Y = defaultValue;
...
//            ((ErrorbarSeries)chart.Series[0]).DataLabels.ZIndex = value;
...
//            ((ErrorbarSeries)chart.Series[0]).DataLabels.ZIndex = defaultValue;
...
//            ((ErrorbarSeries)chart.Series[0]).DataSorting.Enabled = value;
...
//            ((ErrorbarSeries)chart.Series[0]).DataSorting.Enabled = defaultValue;
...
//            ((ErrorbarSeries)chart.Series[0]).DataSorting.MatchByName = value;
...
//            ((ErrorbarSeries)chart.Series[0]).DataSorting.MatchByName = defaultValue;
...
//            ((ErrorbarSeries)chart.Series[0]).DataSorting.SortKey = value;
...
//            ((ErrorbarSeries)chart.Series[0]).DataSorting.SortKey = defaultValue;
...
//            ((ErrorbarSeries)chart.Series[0]).Description = description;
...
//            ((ErrorbarSeries)chart.Series[0]).DragDrop.DraggableX = value;
...
//            ((ErrorbarSeries)chart.Series[0]).DragDrop.DraggableX = defaultValue;
...
//            ((ErrorbarSeries)chart.Series[0]).DragDrop.DraggableY = value;
...
//            ((ErrorbarSeries)chart.Series[0]).DragDrop.DraggableY = defaultValue;
...
//            ((ErrorbarSeries)chart.Series[0]).DragDrop.DragMaxX = value;
...
//            ((ErrorbarSeries)chart.Series[0]).DragDrop.DragMaxX = defaultValue;
...
//            ((ErrorbarSeries)chart.Series[0]).DragDrop.DragMaxY = value;
...
//            ((ErrorbarSeries)chart.Series[0]).DragDrop.DragMaxY = defaultValue;
...
//            ((ErrorbarSeries)chart.Series[0]).DragDrop.DragMinX = value;
...
//            ((ErrorbarSeries)chart.Series[0]).DragDrop.DragMinX = defaultValue;
...
//            ((ErrorbarSeries)chart.Series[0]).DragDrop.DragMinY = value;
...
//            ((ErrorbarSeries)chart.Series[0]).DragDrop.DragMinY = defaultValue;
...
//            ((ErrorbarSeries)chart.Series[0]).DragDrop.DragPrecisionX = value;
...
//            ((ErrorbarSeries)chart.Series[0]).DragDrop.DragPrecisionX = defaultValue;
...
//            ((ErrorbarSeries)chart.Series[0]).DragDrop.DragPrecisionY = value;
...
//            ((ErrorbarSeries)chart.Series[0]).DragDrop.DragPrecisionY = defaultValue;
...
//            ((ErrorbarSeries)chart.Series[0]).DragDrop.DragSensitivity = value;
...
//            ((ErrorbarSeries)chart.Series[0]).DragDrop.DragSensitivity = defaultValue;
...
//            ((ErrorbarSeries)chart.Series[0]).DragDrop.GroupBy = value;
...
//            ((ErrorbarSeries)chart.Series[0]).DragDrop.GroupBy = defaultValue;
...
//            ((ErrorbarSeries)chart.Series[0]).DragDrop.GuideBox.Default.ClassName = value;
...
//            ((ErrorbarSeries)chart.Series[0]).DragDrop.GuideBox.Default.ClassName = defaultValue;
...
//            ((ErrorbarSeries)chart.Series[0]).DragDrop.GuideBox.Default.Color = value;
...
//            ((ErrorbarSeries)chart.Series[0]).DragDrop.GuideBox.Default.Color = defaultValue;
...
//            ((ErrorbarSeries)chart.Series[0]).DragDrop.GuideBox.Default.Cursor = value;
...
//            ((ErrorbarSeries)chart.Series[0]).DragDrop.GuideBox.Default.Cursor = defaultValue;
...
//            ((ErrorbarSeries)chart.Series[0]).DragDrop.GuideBox.Default.LineColor = value;
...
//            ((ErrorbarSeries)chart.Series[0]).DragDrop.GuideBox.Default.LineColor = defaultValue;
...
//            ((ErrorbarSeries)chart.Series[0]).DragDrop.GuideBox.Default.LineWidth = value;
...
//            ((ErrorbarSeries)chart.Series[0]).DragDrop.GuideBox.Default.LineWidth = defaultValue;
...
//            ((ErrorbarSeries)chart.Series[0]).DragDrop.GuideBox.Default.ZIndex = value;
...
//            ((ErrorbarSeries)chart.Series[0]).DragDrop.GuideBox.Default.ZIndex = defaultValue;
...
//            ((ErrorbarSeries)chart.Series[0]).DragDrop.LiveRedraw = value;
...
//            ((ErrorbarSeries)chart.Series[0]).DragDrop.LiveRedraw = defaultValue;
...
//            ((ErrorbarSeries)chart.Series[0]).EnableMouseTracking = value;
...
//            ((ErrorbarSeries)chart.Series[0]).Events.AfterAnimate = value;
...
//            ((ErrorbarSeries)chart.Series[0]).Events.AfterAnimate = defaultValue;
...
//            ((ErrorbarSeries)chart.Series[0]).Events.CheckboxClick = value;
...
//            ((ErrorbarSeries)chart.Series[0]).Events.CheckboxClick = defaultValue;
...
//            ((ErrorbarSeries)chart.Series[0]).Events.Click = value;
...
//            ((ErrorbarSeries)chart.Series[0]).Events.Click = defaultValue;
...
//            ((ErrorbarSeries)chart.Series[0]).Events.Hide = value;
...
//            ((ErrorbarSeries)chart.Series[0]).Events.Hide = defaultValue;
...
//            ((ErrorbarSeries)chart.Series[0]).Events.LegendItemClick = value;
...
//            ((ErrorbarSeries)chart.Series[0]).Events.LegendItemClick = defaultValue;
...
//            ((ErrorbarSeries)chart.Series[0]).Events.MouseOut = value;
...
//            ((ErrorbarSeries)chart.Series[0]).Events.MouseOut = defaultValue;
...
//            ((ErrorbarSeries)chart.Series[0]).Events.MouseOver = value;
...
//            ((ErrorbarSeries)chart.Series[0]).Events.MouseOver = defaultValue;
...
//            ((ErrorbarSeries)chart.Series[0]).Events.Show = value;
...
//            ((ErrorbarSeries)chart.Series[0]).Events.Show = defaultValue;
...
//            var chart = new Highstock();
//            var renderer = new HighstockRenderer(chart); var series = new ErrorbarSeries(); chart.Series.Add(series);
//            var value = ErrorbarSeriesFindNearestPointBy.Xy;

//            ((ErrorbarSeries)chart.Series[0]).FindNearestPointBy = value;
...
//            var chart = new Highstock();
//            var renderer = new HighstockRenderer(chart); var series = new ErrorbarSeries(); chart.Series.Add(series);
//            var value = ErrorbarSeriesFindNearestPointBy.X;
...
//            ((ErrorbarSeries)chart.Series[0]).GetExtremesFromAll = value;
...
//            ((ErrorbarSeries)chart.Series[0]).IncludeInDataExport = value;
...
//            ((ErrorbarSeries)chart.Series[0]).Keys = value;
...
//            ((ErrorbarSeries)chart.Series[0]).Label.ConnectorAllowed = value;
...
//            ((ErrorbarSeries)chart.Series[0]).Label.ConnectorAllowed = defaultValue;
...
//            ((ErrorbarSeries)chart.Series[0]).Label.ConnectorNeighbourDistance = value;
...
//            ((ErrorbarSeries)chart.Series[0]).Label.ConnectorNeighbourDistance = defaultValue;
...
//            ((ErrorbarSeries)chart.Series[0]).Label.Enabled = value;
...
//            ((ErrorbarSeries)chart.Series[0]).Label.Enabled = defaultValue;
...
//            ((ErrorbarSeries)chart.Series[0]).Label.Format = value;
...
//        //    ((ErrorbarSeries)chart.Series[0]).Label.Format = defaultValue;
...
//            ((ErrorbarSeries)chart.Series[0]).Label.Formatter = value;
...
//            ((ErrorbarSeries)chart.Series[0]).Label.Formatter = defaultValue;
...
//            ((ErrorbarSeries)chart.Series[0]).Label.MaxFontSize = value;
...
//            ((ErrorbarSeries)chart.Series[0]).Label.MaxFontSize = defaultValue;
...
//            ((ErrorbarSeries)chart.Series[0]).Label.MinFontSize = value;
...
//            ((ErrorbarSeries)chart.Series[0]).Label.MinFontSize = defaultValue;
...
//            ((ErrorbarSeries)chart.Series[0]).Label.OnArea = value;
...
//            ((ErrorbarSeries)chart.Series[0]).Label.OnArea = defaultValue;
...
//            ((ErrorbarSeries)chart.Series[0]).Label.Style = value;
...
//        //    ((ErrorbarSeries)chart.Series[0]).Label.Style = defaultValue;
...
//        //[Theory]
//        //[InlineData(ErrorbarSeriesLinecap.Square)]
//        ////missing ErrorbarSeriesLinecap.Butt ?
//        //public void Test_IfLinecapRenders_Correct(ErrorbarSeriesLinecap value)
//        //{
//        //    var chart = new Highstock();
//        //    var renderer = new HighstockRenderer(chart); var series = new ErrorbarSeries(); chart.Series.Add(series);

//        //    ((ErrorbarSeries)chart.Series[0]).Linecap = value;
...
//        //    var chart = new Highstock();
//        //    var renderer = new HighstockRenderer(chart); var series = new ErrorbarSeries(); chart.Series.Add(series);
//        //    var defaultValue = ErrorbarSeriesLinecap.Round;

//        //    ((ErrorbarSeries)chart.Series[0]).Linecap = defaultValue;
...
//            ((ErrorbarSeries)chart.Series[0]).LineWidth = value;
...
//            ((ErrorbarSeries)chart.Series[0]).LineWidth = defaultValue;
...
//            ((ErrorbarSeries)chart.Series[0]).LinkedTo = value;
...
//            ((ErrorbarSeries)chart.Series[0]).LinkedTo = defaultValue;
...
//            ((ErrorbarSeries)chart.Series[0]).Marker.Enabled = value;
...
//            ((ErrorbarSeries)chart.Series[0]).Marker.EnabledThreshold = value;
...
//            ((ErrorbarSeries)chart.Series[0]).Marker.EnabledThreshold = defaultValue;
...
//            ((ErrorbarSeries)chart.Series[0]).Marker.FillColor = value;
...
//        //    ((ErrorbarSeries)chart.Series[0]).Marker.FillColor = defaultValue;
...
//            ((ErrorbarSeries)chart.Series[0]).Marker.Height = value;
...
//            ((ErrorbarSeries)chart.Series[0]).Marker.Height = defaultValue;
...
//            ((ErrorbarSeries)chart.Series[0]).Marker.LineColor = value;
...
//            ((ErrorbarSeries)chart.Series[0]).Marker.LineColor = defaultValue;
...
//            ((ErrorbarSeries)chart.Series[0]).Marker.LineWidth = value;
...
//            ((ErrorbarSeries)chart.Series[0]).Marker.LineWidth = defaultValue;
...
//            ((ErrorbarSeries)chart.Series[0]).Marker.Radius = value;
...
//            ((ErrorbarSeries)chart.Series[0]).Marker.Radius = defaultValue;
...
//            ((ErrorbarSeries)chart.Series[0]).Marker.Symbol = value;
...
//            ((ErrorbarSeries)chart.Series[0]).Marker.Symbol = defaultValue;
...
//            ((ErrorbarSeries)chart.Series[0]).Marker.Width = value;
...
//            ((ErrorbarSeries)chart.Series[0]).Marker.Width = defaultValue;
...
//            ((ErrorbarSeries)chart.Series[0]).NegativeColor = value;
...
//            ((ErrorbarSeries)chart.Series[0]).NegativeColor = defaultValue;
...
//        //    ((ErrorbarSeries)chart.Series[0]).OnPoint.ConnectorOptions.Dashstyle = value;
...
//            ((ErrorbarSeries)chart.Series[0]).OnPoint.ConnectorOptions.Stroke = value;
...
//            ((ErrorbarSeries)chart.Series[0]).OnPoint.ConnectorOptions.Stroke = defaultValue;
...
//            ((ErrorbarSeries)chart.Series[0]).OnPoint.ConnectorOptions.Width = value;
...
//            ((ErrorbarSeries)chart.Series[0]).OnPoint.ConnectorOptions.Width = defaultValue;
...
//            ((ErrorbarSeries)chart.Series[0]).OnPoint.Id = value;
...
//            ((ErrorbarSeries)chart.Series[0]).OnPoint.Id = defaultValue;
...
//            ((ErrorbarSeries)chart.Series[0]).OnPoint.Position.OffsetX = value;
...
//            ((ErrorbarSeries)chart.Series[0]).OnPoint.Position.OffsetX = defaultValue;
...
//            ((ErrorbarSeries)chart.Series[0]).OnPoint.Position.OffsetY = value;
...
//            ((ErrorbarSeries)chart.Series[0]).OnPoint.Position.OffsetY = defaultValue;
...
//            ((ErrorbarSeries)chart.Series[0]).OnPoint.Position.X = value;
...
//            ((ErrorbarSeries)chart.Series[0]).OnPoint.Position.X = defaultValue;
...
//            ((ErrorbarSeries)chart.Series[0]).OnPoint.Position.Y = value;
...
//            ((ErrorbarSeries)chart.Series[0]).OnPoint.Position.Y = defaultValue;
...
//            ((ErrorbarSeries)chart.Series[0]).Opacity = value;
...
//            ((ErrorbarSeries)chart.Series[0]).Opacity = defaultValue;
...
//            ((ErrorbarSeries)chart.Series[0]).Point.Events.Click = value;
...
//            ((ErrorbarSeries)chart.Series[0]).Point.Events.Click = defaultValue;
...
//            ((ErrorbarSeries)chart.Series[0]).Point.Events.Drag = value;
...
//            ((ErrorbarSeries)chart.Series[0]).Point.Events.Drag = defaultValue;
...
//            ((ErrorbarSeries)chart.Series[0]).Point.Events.DragStart = value;
...
//            ((ErrorbarSeries)chart.Series[0]).Point.Events.DragStart = defaultValue;
...
//            ((ErrorbarSeries)chart.Series[0]).Point.Events.Drop = value;
...
//            ((ErrorbarSeries)chart.Series[0]).Point.Events.Drop = defaultValue;
...
//            ((ErrorbarSeries)chart.Series[0]).Point.Events.MouseOut = value;
...
//            ((ErrorbarSeries)chart.Series[0]).Point.Events.MouseOut = defaultValue;
...
//            ((ErrorbarSeries)chart.Series[0]).Point.Events.MouseOver = value;
...
//            ((ErrorbarSeries)chart.Series[0]).Point.Events.MouseOver = defaultValue;
...
//            ((ErrorbarSeries)chart.Series[0]).Point.Events.Remove = value;
...
//            ((ErrorbarSeries)chart.Series[0]).Point.Events.Remove = defaultValue;
...
//            ((ErrorbarSeries)chart.Series[0]).Point.Events.Select = value;
...
//            ((ErrorbarSeries)chart.Series[0]).Point.Events.Select = defaultValue;
...
//            ((ErrorbarSeries)chart.Series[0]).Point.Events.Unselect = value;
...
//            ((ErrorbarSeries)chart.Series[0]).Point.Events.Unselect = defaultValue;
...
//            ((ErrorbarSeries)chart.Series[0]).Point.Events.Update = value;
...
//            ((ErrorbarSeries)chart.Series[0]).Point.Events.Update = defaultValue;
...
//            ((ErrorbarSeries)chart.Series[0]).PointDescriptionFormatter = value;
...
//            ((ErrorbarSeries)chart.Series[0]).PointDescriptionFormatter = defaultValue;
...
//            ((ErrorbarSeries)chart.Series[0]).PointInterval = value;
...
//            ((ErrorbarSeries)chart.Series[0]).PointInterval = defaultValue;

//            Assert.DoesNotContain($"pointInterval", renderer.RenderHtml());
//        }

//        [Theory]
//        [InlineData(ErrorbarSeriesPointIntervalUnit.Day)]
//        [InlineData(ErrorbarSeriesPointIntervalUnit.Month)]
//        [InlineData(ErrorbarSeriesPointIntervalUnit.Year)]
//        public void Test_IfPointIntervalUnitRenders_Correct(ErrorbarSeriesPointIntervalUnit value)
//        {
//            var chart = new Highstock();
//            var renderer = new HighstockRenderer(chart); var series = new ErrorbarSeries(); chart.Series.Add(series);

//            ((ErrorbarSeries)chart.Series[0]).PointIntervalUnit = value;
...
//            var chart = new Highstock();
//            var renderer = new HighstockRenderer(chart); var series = new ErrorbarSeries(); chart.Series.Add(series);
//            var defaultValue = ErrorbarSeriesPointIntervalUnit.Null;

//            ((ErrorbarSeries)chart.Series[0]).PointIntervalUnit = defaultValue;
...
//            ((ErrorbarSeries)chart.Series[0]).PointPlacement = new PointPlacement() { PointPlacementEnum = value };
...
//            ((ErrorbarSeries)chart.Series[0]).PointPlacement = new PointPlacement() { Value = value };
...
//            ((ErrorbarSeries)chart.Series[0]).PointPlacement = new PointPlacement() { PointPlacementEnum = defaultValue };
...
//            ((ErrorbarSeries)chart.Series[0]).PointStart = value;
...
//            ((ErrorbarSeries)chart.Series[0]).PointStart = defaultValue;
...
//            ((ErrorbarSeries)chart.Series[0]).RelativeXValue = value;
...
//            ((ErrorbarSeries)chart.Series[0]).RelativeXValue = defaultValue;
...
//            ((ErrorbarSeries)chart.Series[0]).Selected = value;
...
//            ((ErrorbarSeries)chart.Series[0]).Selected = defaultValue;
...
//            ((ErrorbarSeries)chart.Series[0]).ShadowBool = value;
...
//            ((ErrorbarSeries)chart.Series[0]).Shadow = new Shadow()
//            {
//                Color = color,
//                OffsetX = offsetX,
//                OffsetY = offsetY,
...
//            ((ErrorbarSeries)chart.Series[0]).ShadowBool = defaultValue;
...
//            ((ErrorbarSeries)chart.Series[0]).ShowCheckbox = value;
...
//            ((ErrorbarSeries)chart.Series[0]).ShowCheckbox = defaultValue;
...
//            ((ErrorbarSeries)chart.Series[0]).ShowInLegend = value;
...
//            ((ErrorbarSeries)chart.Series[0]).ShowInLegend = null;
...
//            ((ErrorbarSeries)chart.Series[0]).SkipKeyboardNavigation = value;
...
//            ((ErrorbarSeries)chart.Series[0]).SkipKeyboardNavigation = null;
...
//            ((ErrorbarSeries)chart.Series[0]).SoftThreshold = value;
...
//            ((ErrorbarSeries)chart.Series[0]).SoftThreshold = defaultValue;

//            Assert.DoesNotContain($"softThreshold", renderer.RenderHtml());
//        }

//        [Theory]
//        [InlineData(ErrorbarSeriesStacking.Overlap)]
//        [InlineData(ErrorbarSeriesStacking.Percent)]
//        [InlineData(ErrorbarSeriesStacking.Normal)]
//        [InlineData(ErrorbarSeriesStacking.Stream)]
//        public void Test_IfStackingRenders_Correct(ErrorbarSeriesStacking value)
//        {
//            var chart = new Highstock();
//            var renderer = new HighstockRenderer(chart); var series = new ErrorbarSeries(); chart.Series.Add(series);

//            ((ErrorbarSeries)chart.Series[0]).Stacking = value;
...
//            var chart = new Highstock();
//            var renderer = new HighstockRenderer(chart); var series = new ErrorbarSeries(); chart.Series.Add(series);
//            var defaultValue = ErrorbarSeriesStacking.Null;

//            ((ErrorbarSeries)chart.Series[0]).Stacking = defaultValue;
...
//        //    ((ErrorbarSeries)chart.Series[0]).States.Hover.Animation.Duration = value;
...
//            ((ErrorbarSeries)chart.Series[0]).States.Hover.Animation.Duration = defaultValue;
...
//            ((ErrorbarSeries)chart.Series[0]).States.Hover.Enabled = false;
...
//        //    ((ErrorbarSeries)chart.Series[0]).States.Hover.Enabled = defaultValue;
...
//        //    ((ErrorbarSeries)chart.Series[0]).States.Hover.Halo.Attributes = value;
...
//            ((ErrorbarSeries)chart.Series[0]).States.Hover.Halo.Opacity = value;
...
//        //    ((ErrorbarSeries)chart.Series[0]).States.Hover.Halo.Opacity = defaultValue;
...
//        //    ((ErrorbarSeries)chart.Series[0]).States.Hover.Halo.Size = value;
...
//            ((ErrorbarSeries)chart.Series[0]).States.Hover.LineWidth = value;
...
//            ((ErrorbarSeries)chart.Series[0]).States.Hover.LineWidth = defaultValue;
...
//            ((ErrorbarSeries)chart.Series[0]).States.Hover.LineWidthPlus = value;
...
//        //    ((ErrorbarSeries)chart.Series[0]).States.Hover.LineWidthPlus = defaultValue;
...
//            ((ErrorbarSeries)chart.Series[0]).States.Hover.Marker.Enabled = value;
...
//            ((ErrorbarSeries)chart.Series[0]).States.Hover.Marker.EnabledThreshold = value;
...
//            ((ErrorbarSeries)chart.Series[0]).States.Hover.Marker.EnabledThreshold = defaultValue;
...
//            ((ErrorbarSeries)chart.Series[0]).States.Hover.Marker.FillColor = value;
...
//        //    ((ErrorbarSeries)chart.Series[0]).States.Hover.Marker.FillColor = defaultValue;
...
//            ((ErrorbarSeries)chart.Series[0]).States.Hover.Marker.Height = value;
...
//            ((ErrorbarSeries)chart.Series[0]).States.Hover.Marker.Height = defaultValue;
...
//            ((ErrorbarSeries)chart.Series[0]).States.Hover.Marker.LineColor = value;
...
//            ((ErrorbarSeries)chart.Series[0]).States.Hover.Marker.LineColor = defaultValue;
...
//            ((ErrorbarSeries)chart.Series[0]).States.Hover.Marker.LineWidth = value;
...
//            ((ErrorbarSeries)chart.Series[0]).States.Hover.Marker.LineWidth = defaultValue;
...
//            ((ErrorbarSeries)chart.Series[0]).States.Hover.Marker.Radius = value;
...
//            ((ErrorbarSeries)chart.Series[0]).States.Hover.Marker.Radius = defaultValue;
...
//            ((ErrorbarSeries)chart.Series[0]).States.Hover.Marker.Width = value;
...
//            ((ErrorbarSeries)chart.Series[0]).States.Hover.Marker.Width = defaultValue;
...
//        //    ((ErrorbarSeries)chart.Series[0]).States.Inactive.Animation.Duration = value;
...
//            ((ErrorbarSeries)chart.Series[0]).States.Inactive.Animation.Duration = defaultValue;
...
//            ((ErrorbarSeries)chart.Series[0]).States.Inactive.Enabled = false;
...
//        //    ((ErrorbarSeries)chart.Series[0]).States.Inactive.Enabled = defaultValue;
...
//            ((ErrorbarSeries)chart.Series[0]).States.Inactive.Opacity = value;
...
//        //    ((ErrorbarSeries)chart.Series[0]).States.Inactive.Opacity = defaultValue;
...
//        //    ((ErrorbarSeries)chart.Series[0]).States.Normal.Animation.Duration = value;
...
//            ((ErrorbarSeries)chart.Series[0]).States.Normal.Animation.Duration = defaultValue;
...
//        //    ((ErrorbarSeries)chart.Series[0]).States.Select.Animation.Duration = value;
...
//            ((ErrorbarSeries)chart.Series[0]).States.Select.Animation.Duration = defaultValue;
...
//            ((ErrorbarSeries)chart.Series[0]).States.Select.Enabled = false;
...
//        //    ((ErrorbarSeries)chart.Series[0]).States.Select.Enabled = defaultValue;
...
//        //    ((ErrorbarSeries)chart.Series[0]).States.Select.Halo.Attributes = value;
...
//            ((ErrorbarSeries)chart.Series[0]).States.Select.Halo.Opacity = value;
...
//        //    ((ErrorbarSeries)chart.Series[0]).States.Select.Halo.Opacity = defaultValue;
...
//        //    ((ErrorbarSeries)chart.Series[0]).States.Select.Halo.Size = value;
...
//            ((ErrorbarSeries)chart.Series[0]).States.Select.LineWidth = value;
...
//            ((ErrorbarSeries)chart.Series[0]).States.Select.LineWidth = defaultValue;
...
//            ((ErrorbarSeries)chart.Series[0]).States.Select.LineWidthPlus = value;
...
//        //    ((ErrorbarSeries)chart.Series[0]).States.Select.LineWidthPlus = defaultValue;
...
//            ((ErrorbarSeries)chart.Series[0]).States.Select.Marker.Enabled = value;
...
//            ((ErrorbarSeries)chart.Series[0]).States.Select.Marker.EnabledThreshold = value;
...
//            ((ErrorbarSeries)chart.Series[0]).States.Select.Marker.EnabledThreshold = defaultValue;
...
//            ((ErrorbarSeries)chart.Series[0]).States.Select.Marker.FillColor = value;
...
//        //    ((ErrorbarSeries)chart.Series[0]).States.Select.Marker.FillColor = defaultValue;
...
//            ((ErrorbarSeries)chart.Series[0]).States.Select.Marker.Height = value;
...
//            ((ErrorbarSeries)chart.Series[0]).States.Select.Marker.Height = defaultValue;
...
//            ((ErrorbarSeries)chart.Series[0]).States.Select.Marker.LineColor = value;
...
//            ((ErrorbarSeries)chart.Series[0]).States.Select.Marker.LineColor = defaultValue;
...
//            ((ErrorbarSeries)chart.Series[0]).States.Select.Marker.LineWidth = value;
...
//            ((ErrorbarSeries)chart.Series[0]).States.Select.Marker.LineWidth = defaultValue;
...
//            ((ErrorbarSeries)chart.Series[0]).States.Select.Marker.Radius = value;
...
//            ((ErrorbarSeries)chart.Series[0]).States.Select.Marker.Width = value;
...
//            ((ErrorbarSeries)chart.Series[0]).States.Select.Marker.Width = defaultValue;
...
//        [Theory]
//        [InlineData(ErrorbarSeriesStep.Center)]
//        [InlineData(ErrorbarSeriesStep.Left)]
//        [InlineData(ErrorbarSeriesStep.Right)]
//        public void Test_IfStepRenders_Correct(ErrorbarSeriesStep value)
//        {
//            var chart = new Highstock();
//            var renderer = new HighstockRenderer(chart); var series = new ErrorbarSeries(); chart.Series.Add(series);

//            ((ErrorbarSeries)chart.Series[0]).Step = value;
...
//            var chart = new Highstock();
//            var renderer = new HighstockRenderer(chart); var series = new ErrorbarSeries(); chart.Series.Add(series);
//            var defaultValue = ErrorbarSeriesStep.Null;

//            ((ErrorbarSeries)chart.Series[0]).Step = defaultValue;
...
//            ((ErrorbarSeries)chart.Series[0]).StickyTracking = value;
...
//            ((ErrorbarSeries)chart.Series[0]).StickyTracking = defaultValue;
...
//            ((ErrorbarSeries)chart.Series[0]).Threshold = value;
...
//            ((ErrorbarSeries)chart.Series[0]).Threshold = defaultValue;
...
//            ((ErrorbarSeries)chart.Series[0]).Tooltip.ClusterFormat = value;
...
//            ((ErrorbarSeries)chart.Series[0]).Tooltip.ClusterFormat = defaultValue;
...
//            ((ErrorbarSeries)chart.Series[0]).Tooltip.DateTimeLabelFormats = value;
...
//        //    ((ErrorbarSeries)chart.Series[0]).Tooltip.DateTimeLabelFormats = defaultValue;
...
//            ((ErrorbarSeries)chart.Series[0]).Tooltip.Distance = value;
...
//            ((ErrorbarSeries)chart.Series[0]).Tooltip.Distance = defaultValue;
...
//            ((ErrorbarSeries)chart.Series[0]).Tooltip.FollowPointer = value;
...
//        //    ((ErrorbarSeries)chart.Series[0]).Tooltip.FollowPointer = defaultValue;
...
//            ((ErrorbarSeries)chart.Series[0]).Tooltip.FollowTouchMove = value;
...
//        //    ((ErrorbarSeries)chart.Series[0]).Tooltip.FollowTouchMove = defaultValue;
...
//            ((ErrorbarSeries)chart.Series[0]).Tooltip.FooterFormat = value;
...
//            ((ErrorbarSeries)chart.Series[0]).Tooltip.FooterFormat = defaultValue;
...
//            ((ErrorbarSeries)chart.Series[0]).Tooltip.HeaderFormat = value;
...
//            ((ErrorbarSeries)chart.Series[0]).Tooltip.HeaderFormat = defaultValue;
...
//            ((ErrorbarSeries)chart.Series[0]).Tooltip.NullFormat = value;
...
//            ((ErrorbarSeries)chart.Series[0]).Tooltip.NullFormat = defaultValue;
...
//            ((ErrorbarSeries)chart.Series[0]).Tooltip.NullFormatter = value;
...
//            ((ErrorbarSeries)chart.Series[0]).Tooltip.NullFormatter = defaultValue;
...
//            ((ErrorbarSeries)chart.Series[0]).Tooltip.PointFormat = value;
...
//            ((ErrorbarSeries)chart.Series[0]).Tooltip.PointFormat = defaultValue;
...
//            ((ErrorbarSeries)chart.Series[0]).Tooltip.PointFormatter = value;
...
//            ((ErrorbarSeries)chart.Series[0]).Tooltip.PointFormatter = defaultValue;
...
//            ((ErrorbarSeries)chart.Series[0]).Tooltip.ValueDecimals = value;
...
//            ((ErrorbarSeries)chart.Series[0]).Tooltip.ValueDecimals = defaultValue;
...
//            ((ErrorbarSeries)chart.Series[0]).Tooltip.ValuePrefix = value;
...
//            ((ErrorbarSeries)chart.Series[0]).Tooltip.ValuePrefix = defaultValue;
...
//            ((ErrorbarSeries)chart.Series[0]).Tooltip.ValueSuffix = value;
...
//            ((ErrorbarSeries)chart.Series[0]).Tooltip.ValueSuffix = defaultValue;
...
//            ((ErrorbarSeries)chart.Series[0]).Tooltip.XDateFormat = value;
...
//            ((ErrorbarSeries)chart.Series[0]).Tooltip.XDateFormat = defaultValue;
...
//            ((ErrorbarSeries)chart.Series[0]).TurboThreshold = value;
...
//            ((ErrorbarSeries)chart.Series[0]).TurboThreshold = defaultValue;
...
//            ((ErrorbarSeries)chart.Series[0]).Visible = value;
...
//            ((ErrorbarSeries)chart.Series[0]).Visible = defaultValue;
...
//            ((ErrorbarSeries)chart.Series[0]).ZoneAxis = value;
...
//            ((ErrorbarSeries)chart.Series[0]).ZoneAxis = defaultValue;
...
//        [Theory]
//        [InlineData(ErrorbarSeriesZonesDashStyle.Dash)]
//        [InlineData(ErrorbarSeriesZonesDashStyle.DashDot)]
//        [InlineData(ErrorbarSeriesZonesDashStyle.Dot)]
//        [InlineData(ErrorbarSeriesZonesDashStyle.LongDash)]
//        [InlineData(ErrorbarSeriesZonesDashStyle.LongDashDot)]
//        [InlineData(ErrorbarSeriesZonesDashStyle.LongDashDotDot)]
//        [InlineData(ErrorbarSeriesZonesDashStyle.ShortDash)]
//        [InlineData(ErrorbarSeriesZonesDashStyle.ShortDashDot)]
//        [InlineData(ErrorbarSeriesZonesDashStyle.ShortDashDotDot)]
//        [InlineData(ErrorbarSeriesZonesDashStyle.ShortDot)]
//        [InlineData(ErrorbarSeriesZonesDashStyle.Solid)]
//        public void Test_IfZonesDashStyleRenders_Correct(ErrorbarSeriesZonesDashStyle value)
//        {
//            var chart = new Highstock();
//            var renderer = new HighstockRenderer(chart); var series = new ErrorbarSeries(); chart.Series.Add(series);
//            var pathToProperty = new List<string>() { "zones" };
