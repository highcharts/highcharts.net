...
namespace HS.Series
{
    public class LineSeriesTests : IClassFixture<HsFixture>
    {
        protected HsFixture _fixture;

        public LineSeriesTests(HsFixture fixture)
        {
            _fixture = fixture;
        ...
        public void Test_IfDataLabelsDeferBoolDoesntRenderForDefault_Correct()
        {
            ...
            ((LineSeries)chart.Series[0]).DataLabels.Defer = defaultValue;
        ...
        public void Test_IfDataLabelsZRenders_Correct(double value)
        {
            ...
            ((LineSeries)chart.Series[0]).DataLabels.ZIndex = value;
        ...
        public void Test_IfDataLabelsZDoesntRenderForDefault_Correct()
        {
            ...
            ((LineSeries)chart.Series[0]).DataLabels.ZIndex = defaultValue;
        ...
        public void Test_IfZonesClassNameRenders_Correct(string value)
        {
            ...
            var zoneDef = new List<LineSeriesZones> { new LineSeriesZones { ClassName = value } };
        ...
        public void Test_IfZonesClassNameDoesntRenderForDefault_Correct()
        {
            ...
            var renderer = new HighstockRenderer(chart); var series = new LineSeries(); chart.Series.Add(series);
            var defaultValue = string.Empty;
            var zoneDef = new List<LineSeriesZones> { new LineSeriesZones { ClassName = defaultValue } };
        ...
        public void Test_IfZonesColorRenders_Correct(string value)
        {
            ...
            var renderer = new HighstockRenderer(chart); var series = new LineSeries(); chart.Series.Add(series);
            var pathToProperty = new List<string>() { "zones" };
            var zoneDef = new List<LineSeriesZones> { new LineSeriesZones { Color = value } };
        ...
        public void Test_IfZonesColorDoesntRenderForDefault_Correct()
        {
            ...
            var renderer = new HighstockRenderer(chart); var series = new LineSeries(); chart.Series.Add(series);
            var defaultValue = string.Empty;
            var zoneDef = new List<LineSeriesZones> { new LineSeriesZones { Color = defaultValue } };
        ...
        public void Test_IfZonesDashStyleRenders_Correct(LineSeriesZonesDashStyle value)
        {
            ...
            var renderer = new HighstockRenderer(chart); var series = new LineSeries(); chart.Series.Add(series);
            var pathToProperty = new List<string>() { "zones" };
            var zoneDef = new List<LineSeriesZones> { new LineSeriesZones { DashStyle = value } };
        ...
        public void Test_IfZonesDashStyleDoesntRenderForDefault_Correct()
        {
            ...
            var zoneDef = new List<LineSeriesZones> { new LineSeriesZones { DashStyle = defaultValue } };
        ...
        public void Test_IfZonesFillColorRenders_Correct(string value)
        {
            ...
            var renderer = new HighstockRenderer(chart); var series = new LineSeries(); chart.Series.Add(series);
            var pathToProperty = new List<string>() { "zones" };
            var zoneDef = new List<LineSeriesZones> { new LineSeriesZones { FillColor = value } };
        ...
        //    var renderer = new HighstockRenderer(chart); var series = new LineSeries(); chart.Series.Add(series);
        //    var defaultValue = string.Empty;
        //    var zoneDef = new List<LineSeriesZones> { new LineSeriesZones { FillColor = defaultValue } };
        ...
        public void Test_IfZonesValueRenders_Correct(double value)
        {
            ...
            var renderer = new HighstockRenderer(chart); var series = new LineSeries(); chart.Series.Add(series);
            var pathToProperty = new List<string>() { "zones" };
            var zoneDef = new List<LineSeriesZones> { new LineSeriesZones { Value = value } };
        ...
        public void Test_IfZonesValueDoesntRenderForDefault_Correct()
        {
            ...
            var renderer = new HighstockRenderer(chart); var series = new LineSeries(); chart.Series.Add(series);
            double? defaultValue = null;
            var zoneDef = new List<LineSeriesZones> { new LineSeriesZones { Value = defaultValue } };
