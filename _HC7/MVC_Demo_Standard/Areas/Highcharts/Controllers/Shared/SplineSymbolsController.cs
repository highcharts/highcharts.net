    ...
    public partial class SharedController : Controller
    {
        public ActionResult SplineSymbols()
        {
            ...
            foreach (double value in tokyoValues)
            {
                ...
                if (value == 26.5)
                {
                    data.Marker = new SplineSeriesDataMarker{ Symbol = "url(https://www.highcharts.com/demo/gfx/sun.png)" };
                }
            ...
            foreach (double value in londonValues)
            {
                ...
                if (value == 3.9)
                {
                    data.Marker = new SplineSeriesDataMarker{ Symbol = "url(https://www.highcharts.com/demo/gfx/snow.png)" };
                }
