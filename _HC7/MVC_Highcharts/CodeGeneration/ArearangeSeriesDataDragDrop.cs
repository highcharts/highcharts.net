...
{
	public partial class ArearangeSeriesDataDragDrop  : BaseObject
	{
		public ArearangeSeriesDataDragDrop()
		{
			DraggableX = DraggableX_DefaultValue = null;
			DraggableY = DraggableY_DefaultValue = null;
			DragHandle = DragHandle_DefaultValue = new ArearangeSeriesDataDragDropDragHandle();
			...
			GuideBox = GuideBox_DefaultValue = new ArearangeSeriesDataDragDropGuideBox();
		...
		/// </summary>
		public ArearangeSeriesDataDragDropDragHandle DragHandle { get; set; }
		private ArearangeSeriesDataDragDropDragHandle DragHandle_DefaultValue { get; set; }
		...
		/// </summary>
		public ArearangeSeriesDataDragDropGuideBox GuideBox { get; set; }
		private ArearangeSeriesDataDragDropGuideBox GuideBox_DefaultValue { get; set; }
