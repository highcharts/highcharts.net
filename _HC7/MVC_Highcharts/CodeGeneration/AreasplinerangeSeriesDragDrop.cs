...
{
	public partial class AreasplinerangeSeriesDragDrop  : BaseObject
	{
		public AreasplinerangeSeriesDragDrop()
		{
			DraggableX = DraggableX_DefaultValue = null;
			DraggableY = DraggableY_DefaultValue = null;
			DragHandle = DragHandle_DefaultValue = new AreasplinerangeSeriesDragDropDragHandle();
			...
			GuideBox = GuideBox_DefaultValue = new AreasplinerangeSeriesDragDropGuideBox();
		...
		/// </summary>
		public AreasplinerangeSeriesDragDropDragHandle DragHandle { get; set; }
		private AreasplinerangeSeriesDragDropDragHandle DragHandle_DefaultValue { get; set; }
		...
		/// </summary>
		public AreasplinerangeSeriesDragDropGuideBox GuideBox { get; set; }
		private AreasplinerangeSeriesDragDropGuideBox GuideBox_DefaultValue { get; set; }
