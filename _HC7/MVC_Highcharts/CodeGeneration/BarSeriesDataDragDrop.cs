...
{
	public partial class BarSeriesDataDragDrop  : BaseObject
	{
		public BarSeriesDataDragDrop()
		{
			DraggableX = DraggableX_DefaultValue = null;
			DraggableY = DraggableY_DefaultValue = null;
			DragHandle = DragHandle_DefaultValue = new BarSeriesDataDragDropDragHandle();
			...
			GuideBox = GuideBox_DefaultValue = new BarSeriesDataDragDropGuideBox();
		...
		/// </summary>
		public BarSeriesDataDragDropDragHandle DragHandle { get; set; }
		private BarSeriesDataDragDropDragHandle DragHandle_DefaultValue { get; set; }
		...
		/// </summary>
		public BarSeriesDataDragDropGuideBox GuideBox { get; set; }
		private BarSeriesDataDragDropGuideBox GuideBox_DefaultValue { get; set; }
