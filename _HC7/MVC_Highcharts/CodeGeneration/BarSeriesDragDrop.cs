...
{
	public partial class BarSeriesDragDrop  : BaseObject
	{
		public BarSeriesDragDrop()
		{
			DraggableX = DraggableX_DefaultValue = null;
			DraggableY = DraggableY_DefaultValue = null;
			DragHandle = DragHandle_DefaultValue = new BarSeriesDragDropDragHandle();
			...
			GuideBox = GuideBox_DefaultValue = new BarSeriesDragDropGuideBox();
		...
		/// </summary>
		public BarSeriesDragDropDragHandle DragHandle { get; set; }
		private BarSeriesDragDropDragHandle DragHandle_DefaultValue { get; set; }
		...
		/// </summary>
		public BarSeriesDragDropGuideBox GuideBox { get; set; }
		private BarSeriesDragDropGuideBox GuideBox_DefaultValue { get; set; }
