...
{
	public partial class BoxplotSeriesDragDrop  : BaseObject
	{
		public BoxplotSeriesDragDrop()
		{
			DraggableX = DraggableX_DefaultValue = null;
			DraggableY = DraggableY_DefaultValue = null;
			DragHandle = DragHandle_DefaultValue = new BoxplotSeriesDragDropDragHandle();
			...
			GuideBox = GuideBox_DefaultValue = new BoxplotSeriesDragDropGuideBox();
		...
		/// </summary>
		public BoxplotSeriesDragDropDragHandle DragHandle { get; set; }
		private BoxplotSeriesDragDropDragHandle DragHandle_DefaultValue { get; set; }
		...
		/// </summary>
		public BoxplotSeriesDragDropGuideBox GuideBox { get; set; }
		private BoxplotSeriesDragDropGuideBox GuideBox_DefaultValue { get; set; }
