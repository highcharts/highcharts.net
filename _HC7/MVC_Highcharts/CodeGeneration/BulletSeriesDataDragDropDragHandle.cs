...
{
	public partial class BulletSeriesDataDragDropDragHandle  : BaseObject
	{
		public BulletSeriesDataDragDropDragHandle()
		{
		...
		internal override Hashtable ToHashtable()
		{
			...
			if (PathFormatter != PathFormatter_DefaultValue) { h.Add("pathFormatter",PathFormatter); Highcharts.AddFunction("BulletSeriesDataDragDropDragHandlePathFormatter.pathFormatter", PathFormatter); }  
