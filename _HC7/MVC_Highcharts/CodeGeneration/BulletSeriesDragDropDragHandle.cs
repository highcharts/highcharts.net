...
{
	public partial class BulletSeriesDragDropDragHandle  : BaseObject
	{
		public BulletSeriesDragDropDragHandle()
		{
		...
		internal override Hashtable ToHashtable()
		{
			...
			if (PathFormatter != PathFormatter_DefaultValue) { h.Add("pathFormatter",PathFormatter); Highcharts.AddFunction("BulletSeriesDragDropDragHandlePathFormatter.pathFormatter", PathFormatter); }  
