...
{
	public partial class ColumnSeriesDragDropDragHandle  : BaseObject
	{
		public ColumnSeriesDragDropDragHandle()
		{
		...
		internal override Hashtable ToHashtable()
		{
			...
			if (PathFormatter != PathFormatter_DefaultValue) { h.Add("pathFormatter",PathFormatter); Highcharts.AddFunction("ColumnSeriesDragDropDragHandlePathFormatter.pathFormatter", PathFormatter); }  
