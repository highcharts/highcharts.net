...
{
	public partial class CylinderSeriesDragDrop  : BaseObject
	{
		public CylinderSeriesDragDrop()
		{
			DraggableX = DraggableX_DefaultValue = null;
			DraggableY = DraggableY_DefaultValue = null;
			DragHandle = DragHandle_DefaultValue = new CylinderSeriesDragDropDragHandle();
			...
			GuideBox = GuideBox_DefaultValue = new CylinderSeriesDragDropGuideBox();
		...
		/// </summary>
		public CylinderSeriesDragDropDragHandle DragHandle { get; set; }
		private CylinderSeriesDragDropDragHandle DragHandle_DefaultValue { get; set; }
		...
		/// </summary>
		public CylinderSeriesDragDropGuideBox GuideBox { get; set; }
		private CylinderSeriesDragDropGuideBox GuideBox_DefaultValue { get; set; }
