...
{
	public partial class CylinderSeriesDragDropDragHandle  : BaseObject
	{
		public CylinderSeriesDragDropDragHandle()
		{
		...
		internal override Hashtable ToHashtable()
		{
			...
			if (PathFormatter != PathFormatter_DefaultValue) { h.Add("pathFormatter",PathFormatter); Highcharts.AddFunction("CylinderSeriesDragDropDragHandlePathFormatter.pathFormatter", PathFormatter); }  
