...
namespace Highsoft.Web.Mvc.Charts
{
	public partial class CylinderSeriesStatesHoverMarker  : BaseObject
	{
		public CylinderSeriesStatesHoverMarker()
		{
			...
			States = States_DefaultValue = new CylinderSeriesStatesHoverMarkerStates();
		...
		/// </summary>
		public CylinderSeriesStatesHoverMarkerStates States { get; set; }
		private CylinderSeriesStatesHoverMarkerStates States_DefaultValue { get; set; }
