...
{
	public partial class HistogramSeriesStatesHoverMarker  : BaseObject
	{
		public HistogramSeriesStatesHoverMarker()
		{
			...
			States = States_DefaultValue = new HistogramSeriesStatesHoverMarkerStates();
		...
		/// </summary>
		public HistogramSeriesStatesHoverMarkerStates States { get; set; }
		private HistogramSeriesStatesHoverMarkerStates States_DefaultValue { get; set; }
