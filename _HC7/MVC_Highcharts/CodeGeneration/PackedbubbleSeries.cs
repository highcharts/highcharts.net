...
namespace Highsoft.Web.Mvc.Charts
{
	public partial class PackedbubbleSeries  : Series
	{
		public PackedbubbleSeries()
		{
			...
			DashStyle = DashStyle_DefaultValue = PackedbubbleSeriesDashStyle.Solid;
			...
			DragDrop = DragDrop_DefaultValue = new PackedbubbleSeriesDragDrop();
			...
			SizeBy = SizeBy_DefaultValue = PackedbubbleSeriesSizeBy.Area;
			...
			Type = Type_DefaultValue = PackedbubbleSeriesType.Null;
		...
		/// </summary>
		public PackedbubbleSeriesDragDrop DragDrop { get; set; }
		private PackedbubbleSeriesDragDrop DragDrop_DefaultValue { get; set; }
		...
		/// </summary>
		public PackedbubbleSeriesSizeBy SizeBy { get; set; }
		private PackedbubbleSeriesSizeBy SizeBy_DefaultValue { get; set; }
		...
		/// </summary>
		public PackedbubbleSeriesType Type { get; set; }
		private PackedbubbleSeriesType Type_DefaultValue { get; set; }
		...
		internal override Hashtable ToHashtable()
		{
			...
			if (PointDescriptionFormatter != PointDescriptionFormatter_DefaultValue) { h.Add("pointDescriptionFormatter",PointDescriptionFormatter); Highcharts.AddFunction("PackedbubbleSeriesPointDescriptionFormatter.pointDescriptionFormatter", PointDescriptionFormatter); }  
