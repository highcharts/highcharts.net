...
{
	public partial class ParetoSeriesDragDrop  : BaseObject
	{
		public ParetoSeriesDragDrop()
		{
			DraggableX = DraggableX_DefaultValue = null;
			DraggableY = DraggableY_DefaultValue = null;
			DragHandle = DragHandle_DefaultValue = new ParetoSeriesDragDropDragHandle();
			...
			GuideBox = GuideBox_DefaultValue = new ParetoSeriesDragDropGuideBox();
		...
		/// </summary>
		public ParetoSeriesDragDropDragHandle DragHandle { get; set; }
		private ParetoSeriesDragDropDragHandle DragHandle_DefaultValue { get; set; }
		...
		/// </summary>
		public ParetoSeriesDragDropGuideBox GuideBox { get; set; }
		private ParetoSeriesDragDropGuideBox GuideBox_DefaultValue { get; set; }
