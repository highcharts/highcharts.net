...
{
	public partial class PieSeriesDataDragDrop  : BaseObject
	{
		public PieSeriesDataDragDrop()
		{
			DraggableX = DraggableX_DefaultValue = null;
			DraggableY = DraggableY_DefaultValue = null;
			DragHandle = DragHandle_DefaultValue = new PieSeriesDataDragDropDragHandle();
			...
			GuideBox = GuideBox_DefaultValue = new PieSeriesDataDragDropGuideBox();
		...
		/// </summary>
		public PieSeriesDataDragDropDragHandle DragHandle { get; set; }
		private PieSeriesDataDragDropDragHandle DragHandle_DefaultValue { get; set; }
		...
		/// </summary>
		public PieSeriesDataDragDropGuideBox GuideBox { get; set; }
		private PieSeriesDataDragDropGuideBox GuideBox_DefaultValue { get; set; }
