...
{
	public partial class PlotOptionsAreasplineDragDropDragHandle  : BaseObject
	{
		public PlotOptionsAreasplineDragDropDragHandle()
		{
		...
		internal override Hashtable ToHashtable()
		{
			...
			if (PathFormatter != PathFormatter_DefaultValue) { h.Add("pathFormatter",PathFormatter); Highcharts.AddFunction("PlotOptionsAreasplineDragDropDragHandlePathFormatter.pathFormatter", PathFormatter); }  
