...
{
	public partial class PlotOptionsAreasplinerangeDragDropDragHandle  : BaseObject
	{
		public PlotOptionsAreasplinerangeDragDropDragHandle()
		{
		...
		internal override Hashtable ToHashtable()
		{
			...
			if (PathFormatter != PathFormatter_DefaultValue) { h.Add("pathFormatter",PathFormatter); Highcharts.AddFunction("PlotOptionsAreasplinerangeDragDropDragHandlePathFormatter.pathFormatter", PathFormatter); }  
