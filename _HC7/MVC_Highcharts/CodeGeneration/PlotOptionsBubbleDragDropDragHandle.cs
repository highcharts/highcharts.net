...
{
	public partial class PlotOptionsBubbleDragDropDragHandle  : BaseObject
	{
		public PlotOptionsBubbleDragDropDragHandle()
		{
		...
		internal override Hashtable ToHashtable()
		{
			...
			if (PathFormatter != PathFormatter_DefaultValue) { h.Add("pathFormatter",PathFormatter); Highcharts.AddFunction("PlotOptionsBubbleDragDropDragHandlePathFormatter.pathFormatter", PathFormatter); }  
