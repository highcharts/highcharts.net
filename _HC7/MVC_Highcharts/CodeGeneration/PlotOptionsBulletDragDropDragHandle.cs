...
{
	public partial class PlotOptionsBulletDragDropDragHandle  : BaseObject
	{
		public PlotOptionsBulletDragDropDragHandle()
		{
		...
		internal override Hashtable ToHashtable()
		{
			...
			if (PathFormatter != PathFormatter_DefaultValue) { h.Add("pathFormatter",PathFormatter); Highcharts.AddFunction("PlotOptionsBulletDragDropDragHandlePathFormatter.pathFormatter", PathFormatter); }  
