...
{
	public partial class PlotOptionsColumnpyramidDragDropDragHandle  : BaseObject
	{
		public PlotOptionsColumnpyramidDragDropDragHandle()
		{
		...
		internal override Hashtable ToHashtable()
		{
			...
			if (PathFormatter != PathFormatter_DefaultValue) { h.Add("pathFormatter",PathFormatter); Highcharts.AddFunction("PlotOptionsColumnpyramidDragDropDragHandlePathFormatter.pathFormatter", PathFormatter); }  
