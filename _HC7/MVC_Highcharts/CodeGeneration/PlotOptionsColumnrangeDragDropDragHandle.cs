...
{
	public partial class PlotOptionsColumnrangeDragDropDragHandle  : BaseObject
	{
		public PlotOptionsColumnrangeDragDropDragHandle()
		{
		...
		internal override Hashtable ToHashtable()
		{
			...
			if (PathFormatter != PathFormatter_DefaultValue) { h.Add("pathFormatter",PathFormatter); Highcharts.AddFunction("PlotOptionsColumnrangeDragDropDragHandlePathFormatter.pathFormatter", PathFormatter); }  
