...
{
	public partial class PlotOptionsFunnelDragDrop  : BaseObject
	{
		public PlotOptionsFunnelDragDrop()
		{
			DraggableX = DraggableX_DefaultValue = null;
			DraggableY = DraggableY_DefaultValue = null;
			DragHandle = DragHandle_DefaultValue = new PlotOptionsFunnelDragDropDragHandle();
			...
			GuideBox = GuideBox_DefaultValue = new PlotOptionsFunnelDragDropGuideBox();
		...
		/// </summary>
		public PlotOptionsFunnelDragDropDragHandle DragHandle { get; set; }
		private PlotOptionsFunnelDragDropDragHandle DragHandle_DefaultValue { get; set; }
		...
		/// </summary>
		public PlotOptionsFunnelDragDropGuideBox GuideBox { get; set; }
		private PlotOptionsFunnelDragDropGuideBox GuideBox_DefaultValue { get; set; }
