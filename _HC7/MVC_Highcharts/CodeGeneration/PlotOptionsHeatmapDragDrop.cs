...
{
	public partial class PlotOptionsHeatmapDragDrop  : BaseObject
	{
		public PlotOptionsHeatmapDragDrop()
		{
			DraggableX = DraggableX_DefaultValue = null;
			DraggableY = DraggableY_DefaultValue = null;
			DragHandle = DragHandle_DefaultValue = new PlotOptionsHeatmapDragDropDragHandle();
			...
			GuideBox = GuideBox_DefaultValue = new PlotOptionsHeatmapDragDropGuideBox();
		...
		/// </summary>
		public PlotOptionsHeatmapDragDropDragHandle DragHandle { get; set; }
		private PlotOptionsHeatmapDragDropDragHandle DragHandle_DefaultValue { get; set; }
		...
		/// </summary>
		public PlotOptionsHeatmapDragDropGuideBox GuideBox { get; set; }
		private PlotOptionsHeatmapDragDropGuideBox GuideBox_DefaultValue { get; set; }
