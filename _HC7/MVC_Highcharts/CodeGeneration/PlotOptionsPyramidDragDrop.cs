...
{
	public partial class PlotOptionsPyramidDragDrop  : BaseObject
	{
		public PlotOptionsPyramidDragDrop()
		{
			DraggableX = DraggableX_DefaultValue = null;
			DraggableY = DraggableY_DefaultValue = null;
			DragHandle = DragHandle_DefaultValue = new PlotOptionsPyramidDragDropDragHandle();
			...
			GuideBox = GuideBox_DefaultValue = new PlotOptionsPyramidDragDropGuideBox();
		...
		/// </summary>
		public PlotOptionsPyramidDragDropDragHandle DragHandle { get; set; }
		private PlotOptionsPyramidDragDropDragHandle DragHandle_DefaultValue { get; set; }
		...
		/// </summary>
		public PlotOptionsPyramidDragDropGuideBox GuideBox { get; set; }
		private PlotOptionsPyramidDragDropGuideBox GuideBox_DefaultValue { get; set; }
