...
{
	public partial class PlotOptionsSankeyDragDrop  : BaseObject
	{
		public PlotOptionsSankeyDragDrop()
		{
			DraggableX = DraggableX_DefaultValue = null;
			DraggableY = DraggableY_DefaultValue = null;
			DragHandle = DragHandle_DefaultValue = new PlotOptionsSankeyDragDropDragHandle();
			...
			GuideBox = GuideBox_DefaultValue = new PlotOptionsSankeyDragDropGuideBox();
		...
		/// </summary>
		public PlotOptionsSankeyDragDropDragHandle DragHandle { get; set; }
		private PlotOptionsSankeyDragDropDragHandle DragHandle_DefaultValue { get; set; }
		...
		/// </summary>
		public PlotOptionsSankeyDragDropGuideBox GuideBox { get; set; }
		private PlotOptionsSankeyDragDropGuideBox GuideBox_DefaultValue { get; set; }
