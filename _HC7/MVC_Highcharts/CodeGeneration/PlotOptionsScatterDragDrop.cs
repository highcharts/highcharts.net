...
{
	public partial class PlotOptionsScatterDragDrop  : BaseObject
	{
		public PlotOptionsScatterDragDrop()
		{
			DraggableX = DraggableX_DefaultValue = null;
			DraggableY = DraggableY_DefaultValue = null;
			DragHandle = DragHandle_DefaultValue = new PlotOptionsScatterDragDropDragHandle();
			...
			GuideBox = GuideBox_DefaultValue = new PlotOptionsScatterDragDropGuideBox();
		...
		/// </summary>
		public PlotOptionsScatterDragDropDragHandle DragHandle { get; set; }
		private PlotOptionsScatterDragDropDragHandle DragHandle_DefaultValue { get; set; }
		...
		/// </summary>
		public PlotOptionsScatterDragDropGuideBox GuideBox { get; set; }
		private PlotOptionsScatterDragDropGuideBox GuideBox_DefaultValue { get; set; }
