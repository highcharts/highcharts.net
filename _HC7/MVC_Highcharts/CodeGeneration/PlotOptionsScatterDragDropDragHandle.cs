...
{
	public partial class PlotOptionsScatterDragDropDragHandle  : BaseObject
	{
		public PlotOptionsScatterDragDropDragHandle()
		{
		...
		internal override Hashtable ToHashtable()
		{
			...
			if (PathFormatter != PathFormatter_DefaultValue) { h.Add("pathFormatter",PathFormatter); Highcharts.AddFunction("PlotOptionsScatterDragDropDragHandlePathFormatter.pathFormatter", PathFormatter); }  
