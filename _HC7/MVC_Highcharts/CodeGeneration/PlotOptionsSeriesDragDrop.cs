...
{
	public partial class PlotOptionsSeriesDragDrop  : BaseObject
	{
		public PlotOptionsSeriesDragDrop()
		{
			DraggableX = DraggableX_DefaultValue = null;
			DraggableY = DraggableY_DefaultValue = null;
			DragHandle = DragHandle_DefaultValue = new PlotOptionsSeriesDragDropDragHandle();
			...
			GuideBox = GuideBox_DefaultValue = new PlotOptionsSeriesDragDropGuideBox();
		...
		/// </summary>
		public PlotOptionsSeriesDragDropDragHandle DragHandle { get; set; }
		private PlotOptionsSeriesDragDropDragHandle DragHandle_DefaultValue { get; set; }
		...
		/// </summary>
		public PlotOptionsSeriesDragDropGuideBox GuideBox { get; set; }
		private PlotOptionsSeriesDragDropGuideBox GuideBox_DefaultValue { get; set; }
