...
{
	public partial class PlotOptionsSeriesDragDropDragHandle  : BaseObject
	{
		public PlotOptionsSeriesDragDropDragHandle()
		{
		...
		internal override Hashtable ToHashtable()
		{
			...
			if (PathFormatter != PathFormatter_DefaultValue) { h.Add("pathFormatter",PathFormatter); Highcharts.AddFunction("PlotOptionsSeriesDragDropDragHandlePathFormatter.pathFormatter", PathFormatter); }  
