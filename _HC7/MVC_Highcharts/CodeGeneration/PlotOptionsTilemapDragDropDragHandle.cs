...
{
	public partial class PlotOptionsTilemapDragDropDragHandle  : BaseObject
	{
		public PlotOptionsTilemapDragDropDragHandle()
		{
		...
		internal override Hashtable ToHashtable()
		{
			...
			if (PathFormatter != PathFormatter_DefaultValue) { h.Add("pathFormatter",PathFormatter); Highcharts.AddFunction("PlotOptionsTilemapDragDropDragHandlePathFormatter.pathFormatter", PathFormatter); }  
