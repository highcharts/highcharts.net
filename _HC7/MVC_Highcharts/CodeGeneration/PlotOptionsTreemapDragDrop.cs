...
{
	public partial class PlotOptionsTreemapDragDrop  : BaseObject
	{
		public PlotOptionsTreemapDragDrop()
		{
			DraggableX = DraggableX_DefaultValue = null;
			DraggableY = DraggableY_DefaultValue = null;
			DragHandle = DragHandle_DefaultValue = new PlotOptionsTreemapDragDropDragHandle();
			...
			GuideBox = GuideBox_DefaultValue = new PlotOptionsTreemapDragDropGuideBox();
		...
		/// </summary>
		public PlotOptionsTreemapDragDropDragHandle DragHandle { get; set; }
		private PlotOptionsTreemapDragDropDragHandle DragHandle_DefaultValue { get; set; }
		...
		/// </summary>
		public PlotOptionsTreemapDragDropGuideBox GuideBox { get; set; }
		private PlotOptionsTreemapDragDropGuideBox GuideBox_DefaultValue { get; set; }
