...
{
	public partial class PlotOptionsVariablepieDragDrop  : BaseObject
	{
		public PlotOptionsVariablepieDragDrop()
		{
			DraggableX = DraggableX_DefaultValue = null;
			DraggableY = DraggableY_DefaultValue = null;
			DragHandle = DragHandle_DefaultValue = new PlotOptionsVariablepieDragDropDragHandle();
			...
			GuideBox = GuideBox_DefaultValue = new PlotOptionsVariablepieDragDropGuideBox();
		...
		/// </summary>
		public PlotOptionsVariablepieDragDropDragHandle DragHandle { get; set; }
		private PlotOptionsVariablepieDragDropDragHandle DragHandle_DefaultValue { get; set; }
		...
		/// </summary>
		public PlotOptionsVariablepieDragDropGuideBox GuideBox { get; set; }
		private PlotOptionsVariablepieDragDropGuideBox GuideBox_DefaultValue { get; set; }
