...
{
	public partial class PlotOptionsVectorDragDropDragHandle  : BaseObject
	{
		public PlotOptionsVectorDragDropDragHandle()
		{
		...
		internal override Hashtable ToHashtable()
		{
			...
			if (PathFormatter != PathFormatter_DefaultValue) { h.Add("pathFormatter",PathFormatter); Highcharts.AddFunction("PlotOptionsVectorDragDropDragHandlePathFormatter.pathFormatter", PathFormatter); }  
