...
{
	public partial class PlotOptionsWordcloudDragDrop  : BaseObject
	{
		public PlotOptionsWordcloudDragDrop()
		{
			DraggableX = DraggableX_DefaultValue = null;
			DraggableY = DraggableY_DefaultValue = null;
			DragHandle = DragHandle_DefaultValue = new PlotOptionsWordcloudDragDropDragHandle();
			...
			GuideBox = GuideBox_DefaultValue = new PlotOptionsWordcloudDragDropGuideBox();
		...
		/// </summary>
		public PlotOptionsWordcloudDragDropDragHandle DragHandle { get; set; }
		private PlotOptionsWordcloudDragDropDragHandle DragHandle_DefaultValue { get; set; }
		...
		/// </summary>
		public PlotOptionsWordcloudDragDropGuideBox GuideBox { get; set; }
		private PlotOptionsWordcloudDragDropGuideBox GuideBox_DefaultValue { get; set; }
