...
{
	public partial class PlotOptionsWordcloudDragDropDragHandle  : BaseObject
	{
		public PlotOptionsWordcloudDragDropDragHandle()
		{
		...
		internal override Hashtable ToHashtable()
		{
			...
			if (PathFormatter != PathFormatter_DefaultValue) { h.Add("pathFormatter",PathFormatter); Highcharts.AddFunction("PlotOptionsWordcloudDragDropDragHandlePathFormatter.pathFormatter", PathFormatter); }  
