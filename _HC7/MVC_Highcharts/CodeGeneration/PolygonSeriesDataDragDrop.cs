...
{
	public partial class PolygonSeriesDataDragDrop  : BaseObject
	{
		public PolygonSeriesDataDragDrop()
		{
			DraggableX = DraggableX_DefaultValue = null;
			DraggableY = DraggableY_DefaultValue = null;
			DragHandle = DragHandle_DefaultValue = new PolygonSeriesDataDragDropDragHandle();
			...
			GuideBox = GuideBox_DefaultValue = new PolygonSeriesDataDragDropGuideBox();
		...
		/// </summary>
		public PolygonSeriesDataDragDropDragHandle DragHandle { get; set; }
		private PolygonSeriesDataDragDropDragHandle DragHandle_DefaultValue { get; set; }
		...
		/// </summary>
		public PolygonSeriesDataDragDropGuideBox GuideBox { get; set; }
		private PolygonSeriesDataDragDropGuideBox GuideBox_DefaultValue { get; set; }
