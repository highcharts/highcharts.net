...
{
	public partial class PolygonSeriesDragDrop  : BaseObject
	{
		public PolygonSeriesDragDrop()
		{
			DraggableX = DraggableX_DefaultValue = null;
			DraggableY = DraggableY_DefaultValue = null;
			DragHandle = DragHandle_DefaultValue = new PolygonSeriesDragDropDragHandle();
			...
			GuideBox = GuideBox_DefaultValue = new PolygonSeriesDragDropGuideBox();
		...
		/// </summary>
		public PolygonSeriesDragDropDragHandle DragHandle { get; set; }
		private PolygonSeriesDragDropDragHandle DragHandle_DefaultValue { get; set; }
		...
		/// </summary>
		public PolygonSeriesDragDropGuideBox GuideBox { get; set; }
		private PolygonSeriesDragDropGuideBox GuideBox_DefaultValue { get; set; }
