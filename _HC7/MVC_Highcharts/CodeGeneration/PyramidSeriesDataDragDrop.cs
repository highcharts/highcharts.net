...
{
	public partial class PyramidSeriesDataDragDrop  : BaseObject
	{
		public PyramidSeriesDataDragDrop()
		{
			DraggableX = DraggableX_DefaultValue = null;
			DraggableY = DraggableY_DefaultValue = null;
			DragHandle = DragHandle_DefaultValue = new PyramidSeriesDataDragDropDragHandle();
			...
			GuideBox = GuideBox_DefaultValue = new PyramidSeriesDataDragDropGuideBox();
		...
		/// </summary>
		public PyramidSeriesDataDragDropDragHandle DragHandle { get; set; }
		private PyramidSeriesDataDragDropDragHandle DragHandle_DefaultValue { get; set; }
		...
		/// </summary>
		public PyramidSeriesDataDragDropGuideBox GuideBox { get; set; }
		private PyramidSeriesDataDragDropGuideBox GuideBox_DefaultValue { get; set; }
