...
{
	public partial class PyramidSeriesDragDropDragHandle  : BaseObject
	{
		public PyramidSeriesDragDropDragHandle()
		{
		...
		internal override Hashtable ToHashtable()
		{
			...
			if (PathFormatter != PathFormatter_DefaultValue) { h.Add("pathFormatter",PathFormatter); Highcharts.AddFunction("PyramidSeriesDragDropDragHandlePathFormatter.pathFormatter", PathFormatter); }  
