...
{
	public partial class SankeySeriesDataDragDrop  : BaseObject
	{
		public SankeySeriesDataDragDrop()
		{
			DraggableX = DraggableX_DefaultValue = null;
			DraggableY = DraggableY_DefaultValue = null;
			DragHandle = DragHandle_DefaultValue = new SankeySeriesDataDragDropDragHandle();
			...
			GuideBox = GuideBox_DefaultValue = new SankeySeriesDataDragDropGuideBox();
		...
		/// </summary>
		public SankeySeriesDataDragDropDragHandle DragHandle { get; set; }
		private SankeySeriesDataDragDropDragHandle DragHandle_DefaultValue { get; set; }
		...
		/// </summary>
		public SankeySeriesDataDragDropGuideBox GuideBox { get; set; }
		private SankeySeriesDataDragDropGuideBox GuideBox_DefaultValue { get; set; }
