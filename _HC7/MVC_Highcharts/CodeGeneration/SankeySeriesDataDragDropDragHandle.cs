...
{
	public partial class SankeySeriesDataDragDropDragHandle  : BaseObject
	{
		public SankeySeriesDataDragDropDragHandle()
		{
		...
		internal override Hashtable ToHashtable()
		{
			...
			if (PathFormatter != PathFormatter_DefaultValue) { h.Add("pathFormatter",PathFormatter); Highcharts.AddFunction("SankeySeriesDataDragDropDragHandlePathFormatter.pathFormatter", PathFormatter); }  
