...
{
	public partial class SankeySeriesDragDrop  : BaseObject
	{
		public SankeySeriesDragDrop()
		{
			DraggableX = DraggableX_DefaultValue = null;
			DraggableY = DraggableY_DefaultValue = null;
			DragHandle = DragHandle_DefaultValue = new SankeySeriesDragDropDragHandle();
			...
			GuideBox = GuideBox_DefaultValue = new SankeySeriesDragDropGuideBox();
		...
		/// </summary>
		public SankeySeriesDragDropDragHandle DragHandle { get; set; }
		private SankeySeriesDragDropDragHandle DragHandle_DefaultValue { get; set; }
		...
		/// </summary>
		public SankeySeriesDragDropGuideBox GuideBox { get; set; }
		private SankeySeriesDragDropGuideBox GuideBox_DefaultValue { get; set; }
