...
{
	public partial class Scatter3dSeriesDataDragDrop  : BaseObject
	{
		public Scatter3dSeriesDataDragDrop()
		{
			DraggableX = DraggableX_DefaultValue = null;
			DraggableY = DraggableY_DefaultValue = null;
			DragHandle = DragHandle_DefaultValue = new Scatter3dSeriesDataDragDropDragHandle();
			...
			GuideBox = GuideBox_DefaultValue = new Scatter3dSeriesDataDragDropGuideBox();
		...
		/// </summary>
		public Scatter3dSeriesDataDragDropDragHandle DragHandle { get; set; }
		private Scatter3dSeriesDataDragDropDragHandle DragHandle_DefaultValue { get; set; }
		...
		/// </summary>
		public Scatter3dSeriesDataDragDropGuideBox GuideBox { get; set; }
		private Scatter3dSeriesDataDragDropGuideBox GuideBox_DefaultValue { get; set; }
