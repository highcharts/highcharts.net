...
{
	public partial class Scatter3dSeriesDragDrop  : BaseObject
	{
		public Scatter3dSeriesDragDrop()
		{
			DraggableX = DraggableX_DefaultValue = null;
			DraggableY = DraggableY_DefaultValue = null;
			DragHandle = DragHandle_DefaultValue = new Scatter3dSeriesDragDropDragHandle();
			...
			GuideBox = GuideBox_DefaultValue = new Scatter3dSeriesDragDropGuideBox();
		...
		/// </summary>
		public Scatter3dSeriesDragDropDragHandle DragHandle { get; set; }
		private Scatter3dSeriesDragDropDragHandle DragHandle_DefaultValue { get; set; }
		...
		/// </summary>
		public Scatter3dSeriesDragDropGuideBox GuideBox { get; set; }
		private Scatter3dSeriesDragDropGuideBox GuideBox_DefaultValue { get; set; }
