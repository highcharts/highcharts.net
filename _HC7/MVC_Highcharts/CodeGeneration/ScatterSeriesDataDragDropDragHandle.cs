...
{
	public partial class ScatterSeriesDataDragDropDragHandle  : BaseObject
	{
		public ScatterSeriesDataDragDropDragHandle()
		{
		...
		internal override Hashtable ToHashtable()
		{
			...
			if (PathFormatter != PathFormatter_DefaultValue) { h.Add("pathFormatter",PathFormatter); Highcharts.AddFunction("ScatterSeriesDataDragDropDragHandlePathFormatter.pathFormatter", PathFormatter); }  
