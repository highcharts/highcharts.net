...
{
	public partial class ScatterSeriesDragDropDragHandle  : BaseObject
	{
		public ScatterSeriesDragDropDragHandle()
		{
		...
		internal override Hashtable ToHashtable()
		{
			...
			if (PathFormatter != PathFormatter_DefaultValue) { h.Add("pathFormatter",PathFormatter); Highcharts.AddFunction("ScatterSeriesDragDropDragHandlePathFormatter.pathFormatter", PathFormatter); }  
