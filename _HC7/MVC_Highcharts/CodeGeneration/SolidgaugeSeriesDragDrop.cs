...
{
	public partial class SolidgaugeSeriesDragDrop  : BaseObject
	{
		public SolidgaugeSeriesDragDrop()
		{
			DraggableX = DraggableX_DefaultValue = null;
			DraggableY = DraggableY_DefaultValue = null;
			DragHandle = DragHandle_DefaultValue = new SolidgaugeSeriesDragDropDragHandle();
			...
			GuideBox = GuideBox_DefaultValue = new SolidgaugeSeriesDragDropGuideBox();
		...
		/// </summary>
		public SolidgaugeSeriesDragDropDragHandle DragHandle { get; set; }
		private SolidgaugeSeriesDragDropDragHandle DragHandle_DefaultValue { get; set; }
		...
		/// </summary>
		public SolidgaugeSeriesDragDropGuideBox GuideBox { get; set; }
		private SolidgaugeSeriesDragDropGuideBox GuideBox_DefaultValue { get; set; }
