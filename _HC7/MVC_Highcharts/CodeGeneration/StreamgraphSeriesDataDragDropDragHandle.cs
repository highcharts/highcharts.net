...
{
	public partial class StreamgraphSeriesDataDragDropDragHandle  : BaseObject
	{
		public StreamgraphSeriesDataDragDropDragHandle()
		{
		...
		internal override Hashtable ToHashtable()
		{
			...
			if (PathFormatter != PathFormatter_DefaultValue) { h.Add("pathFormatter",PathFormatter); Highcharts.AddFunction("StreamgraphSeriesDataDragDropDragHandlePathFormatter.pathFormatter", PathFormatter); }  
