...
{
	public partial class StreamgraphSeriesMarker  : BaseObject
	{
		public StreamgraphSeriesMarker()
		{
			...
			States = States_DefaultValue = new StreamgraphSeriesMarkerStates();
		...
		/// </summary>
		public StreamgraphSeriesMarkerStates States { get; set; }
		private StreamgraphSeriesMarkerStates States_DefaultValue { get; set; }
