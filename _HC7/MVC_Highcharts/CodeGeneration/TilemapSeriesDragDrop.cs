...
{
	public partial class TilemapSeriesDragDrop  : BaseObject
	{
		public TilemapSeriesDragDrop()
		{
			DraggableX = DraggableX_DefaultValue = null;
			DraggableY = DraggableY_DefaultValue = null;
			DragHandle = DragHandle_DefaultValue = new TilemapSeriesDragDropDragHandle();
			...
			GuideBox = GuideBox_DefaultValue = new TilemapSeriesDragDropGuideBox();
		...
		/// </summary>
		public TilemapSeriesDragDropDragHandle DragHandle { get; set; }
		private TilemapSeriesDragDropDragHandle DragHandle_DefaultValue { get; set; }
		...
		/// </summary>
		public TilemapSeriesDragDropGuideBox GuideBox { get; set; }
		private TilemapSeriesDragDropGuideBox GuideBox_DefaultValue { get; set; }
