...
{
	public partial class TilemapSeriesDragDropDragHandle  : BaseObject
	{
		public TilemapSeriesDragDropDragHandle()
		{
		...
		internal override Hashtable ToHashtable()
		{
			...
			if (PathFormatter != PathFormatter_DefaultValue) { h.Add("pathFormatter",PathFormatter); Highcharts.AddFunction("TilemapSeriesDragDropDragHandlePathFormatter.pathFormatter", PathFormatter); }  
