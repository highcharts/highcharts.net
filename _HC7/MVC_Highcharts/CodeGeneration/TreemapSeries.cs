...
namespace Highsoft.Web.Mvc.Charts
{
	public partial class TreemapSeries  : Series
	{
		...
		/// <summary>
		/// An array of data points for the series. For the `treemap` seriestype, points can be given in the following ways:1.  An array of numerical values. In this case, the numerical valueswill be interpreted as `value` options. Example: ```js data: [0, 5, 3, 5] ```2.  An array of objects with named values. The following snippet shows only afew settings, see the complete options set below. If the total number of datapoints exceeds the series' [turboThreshold](#series.treemap.turboThreshold),this option is not available. ```js    data: [{        value: 9,        name: "Point2",        color: "#00FF00"    }, {        value: 6,        name: "Point1",        color: "#FF00FF"    }] ```
		/// </summary>
