...
{
	public partial class TreemapSeriesDragDrop  : BaseObject
	{
		public TreemapSeriesDragDrop()
		{
			DraggableX = DraggableX_DefaultValue = null;
			DraggableY = DraggableY_DefaultValue = null;
			DragHandle = DragHandle_DefaultValue = new TreemapSeriesDragDropDragHandle();
			...
			GuideBox = GuideBox_DefaultValue = new TreemapSeriesDragDropGuideBox();
		...
		/// </summary>
		public TreemapSeriesDragDropDragHandle DragHandle { get; set; }
		private TreemapSeriesDragDropDragHandle DragHandle_DefaultValue { get; set; }
		...
		/// </summary>
		public TreemapSeriesDragDropGuideBox GuideBox { get; set; }
		private TreemapSeriesDragDropGuideBox GuideBox_DefaultValue { get; set; }
