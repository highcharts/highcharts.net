...
{
	public partial class VariablepieSeriesDataDragDrop  : BaseObject
	{
		public VariablepieSeriesDataDragDrop()
		{
			DraggableX = DraggableX_DefaultValue = null;
			DraggableY = DraggableY_DefaultValue = null;
			DragHandle = DragHandle_DefaultValue = new VariablepieSeriesDataDragDropDragHandle();
			...
			GuideBox = GuideBox_DefaultValue = new VariablepieSeriesDataDragDropGuideBox();
		...
		/// </summary>
		public VariablepieSeriesDataDragDropDragHandle DragHandle { get; set; }
		private VariablepieSeriesDataDragDropDragHandle DragHandle_DefaultValue { get; set; }
		...
		/// </summary>
		public VariablepieSeriesDataDragDropGuideBox GuideBox { get; set; }
		private VariablepieSeriesDataDragDropGuideBox GuideBox_DefaultValue { get; set; }
