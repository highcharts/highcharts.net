...
{
	public partial class VariablepieSeriesDragDrop  : BaseObject
	{
		public VariablepieSeriesDragDrop()
		{
			DraggableX = DraggableX_DefaultValue = null;
			DraggableY = DraggableY_DefaultValue = null;
			DragHandle = DragHandle_DefaultValue = new VariablepieSeriesDragDropDragHandle();
			...
			GuideBox = GuideBox_DefaultValue = new VariablepieSeriesDragDropGuideBox();
		...
		/// </summary>
		public VariablepieSeriesDragDropDragHandle DragHandle { get; set; }
		private VariablepieSeriesDragDropDragHandle DragHandle_DefaultValue { get; set; }
		...
		/// </summary>
		public VariablepieSeriesDragDropGuideBox GuideBox { get; set; }
		private VariablepieSeriesDragDropGuideBox GuideBox_DefaultValue { get; set; }
