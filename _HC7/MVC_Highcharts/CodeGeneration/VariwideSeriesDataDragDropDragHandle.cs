...
{
	public partial class VariwideSeriesDataDragDropDragHandle  : BaseObject
	{
		public VariwideSeriesDataDragDropDragHandle()
		{
		...
		internal override Hashtable ToHashtable()
		{
			...
			if (PathFormatter != PathFormatter_DefaultValue) { h.Add("pathFormatter",PathFormatter); Highcharts.AddFunction("VariwideSeriesDataDragDropDragHandlePathFormatter.pathFormatter", PathFormatter); }  
