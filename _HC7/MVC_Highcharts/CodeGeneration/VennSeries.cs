...
namespace Highsoft.Web.Mvc.Charts
{
	public partial class VennSeries  : Series
	{
		public VennSeries()
		{
			...
			DashStyle = DashStyle_DefaultValue = VennSeriesDashStyle.Solid;
			...
			Type = Type_DefaultValue = VennSeriesType.Null;
		...
		/// </summary>
		public VennSeriesType Type { get; set; }
		private VennSeriesType Type_DefaultValue { get; set; }
		...
		internal override Hashtable ToHashtable()
		{
			...
			if (PointDescriptionFormatter != PointDescriptionFormatter_DefaultValue) { h.Add("pointDescriptionFormatter",PointDescriptionFormatter); Highcharts.AddFunction("VennSeriesPointDescriptionFormatter.pointDescriptionFormatter", PointDescriptionFormatter); }  
