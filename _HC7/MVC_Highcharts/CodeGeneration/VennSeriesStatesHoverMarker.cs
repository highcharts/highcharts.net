...
{
	public partial class VennSeriesStatesHoverMarker  : BaseObject
	{
		public VennSeriesStatesHoverMarker()
		{
			...
			States = States_DefaultValue = new VennSeriesStatesHoverMarkerStates();
		...
		/// </summary>
		public VennSeriesStatesHoverMarkerStates States { get; set; }
		private VennSeriesStatesHoverMarkerStates States_DefaultValue { get; set; }
