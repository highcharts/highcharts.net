...
{
	public partial class MapSeriesDataLabels  : BaseObject
	{
		public MapSeriesDataLabels()
		{
			Align = Align_DefaultValue = MapSeriesDataLabelsAlign.Center;
			...
			Overflow = Overflow_DefaultValue = MapSeriesDataLabelsOverflow.Justify;
			...
			VerticalAlign = VerticalAlign_DefaultValue = MapSeriesDataLabelsVerticalAlign.Null;
			X = X_DefaultValue = 0;
			Y = Y_DefaultValue = -6;
		...
		/// </summary>
		public MapSeriesDataLabelsAlign Align { get; set; }
		private MapSeriesDataLabelsAlign Align_DefaultValue { get; set; }
		...
		/// </summary>
		public MapSeriesDataLabelsOverflow Overflow { get; set; }
		private MapSeriesDataLabelsOverflow Overflow_DefaultValue { get; set; }
		...
		/// </summary>
		public MapSeriesDataLabelsVerticalAlign VerticalAlign { get; set; }
		private MapSeriesDataLabelsVerticalAlign VerticalAlign_DefaultValue { get; set; }
		...
		internal override Hashtable ToHashtable()
		{
			...
			if (Formatter != Formatter_DefaultValue) { h.Add("formatter",Formatter); Highmaps.AddFunction("MapSeriesDataLabelsFormatter.formatter", Formatter); }  
