...
namespace Highsoft.Web.Mvc.Maps
{
	public partial class PlotOptionsMapTooltip  : BaseObject
	{
		...
		internal override Hashtable ToHashtable()
		{
			...
			if (PointFormatter != PointFormatter_DefaultValue) { h.Add("pointFormatter",PointFormatter); Highmaps.AddFunction("PlotOptionsMapTooltipPointFormatter.pointFormatter", PointFormatter); }  
