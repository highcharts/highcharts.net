...
{
	public partial class PlotOptionsMapbubbleDataLabels  : BaseObject
	{
		public PlotOptionsMapbubbleDataLabels()
		{
			Align = Align_DefaultValue = PlotOptionsMapbubbleDataLabelsAlign.Center;
			...
			Overflow = Overflow_DefaultValue = PlotOptionsMapbubbleDataLabelsOverflow.Justify;
			...
			VerticalAlign = VerticalAlign_DefaultValue = PlotOptionsMapbubbleDataLabelsVerticalAlign.Null;
			X = X_DefaultValue = 0;
			Y = Y_DefaultValue = -6;
		...
		/// </summary>
		public PlotOptionsMapbubbleDataLabelsAlign Align { get; set; }
		private PlotOptionsMapbubbleDataLabelsAlign Align_DefaultValue { get; set; }
		...
		/// </summary>
		public PlotOptionsMapbubbleDataLabelsOverflow Overflow { get; set; }
		private PlotOptionsMapbubbleDataLabelsOverflow Overflow_DefaultValue { get; set; }
		...
		/// </summary>
		public PlotOptionsMapbubbleDataLabelsVerticalAlign VerticalAlign { get; set; }
		private PlotOptionsMapbubbleDataLabelsVerticalAlign VerticalAlign_DefaultValue { get; set; }
		...
		internal override Hashtable ToHashtable()
		{
			...
			if (Formatter != Formatter_DefaultValue) { h.Add("formatter",Formatter); Highmaps.AddFunction("PlotOptionsMapbubbleDataLabelsFormatter.formatter", Formatter); }  
