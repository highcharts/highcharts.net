...
{
	public partial class AbandsSeriesDataGrouping  : BaseObject
	{
		public AbandsSeriesDataGrouping()
		{
			Approximation = Approximation_DefaultValue = AbandsSeriesDataGroupingApproximation.Null;
		...
		/// </summary>
		public AbandsSeriesDataGroupingApproximation Approximation { get; set; }
		private AbandsSeriesDataGroupingApproximation Approximation_DefaultValue { get; set; }
