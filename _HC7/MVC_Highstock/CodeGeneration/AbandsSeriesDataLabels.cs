...
namespace Highsoft.Web.Mvc.Stocks
{
	public partial class AbandsSeriesDataLabels  : BaseObject
	{
		public AbandsSeriesDataLabels()
		{
			...
			Style = Style_DefaultValue = new AbandsSeriesDataLabelsStyle();
		...
		/// </summary>
		public AbandsSeriesDataLabelsStyle Style { get; set; }
		private AbandsSeriesDataLabelsStyle Style_DefaultValue { get; set; }
