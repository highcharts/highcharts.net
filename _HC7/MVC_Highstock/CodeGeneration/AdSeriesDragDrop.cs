...
{
	public partial class AdSeriesDragDrop  : BaseObject
	{
		public AdSeriesDragDrop()
		{
			DraggableX = DraggableX_DefaultValue = null;
			DraggableY = DraggableY_DefaultValue = null;
			DragHandle = DragHandle_DefaultValue = new AdSeriesDragDropDragHandle();
			...
			GuideBox = GuideBox_DefaultValue = new AdSeriesDragDropGuideBox();
		...
		/// </summary>
		public AdSeriesDragDropDragHandle DragHandle { get; set; }
		private AdSeriesDragDropDragHandle DragHandle_DefaultValue { get; set; }
		...
		/// </summary>
		public AdSeriesDragDropGuideBox GuideBox { get; set; }
		private AdSeriesDragDropGuideBox GuideBox_DefaultValue { get; set; }
