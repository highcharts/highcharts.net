...
{
	public partial class AdSeriesDragDropDragHandle  : BaseObject
	{
		public AdSeriesDragDropDragHandle()
		{
		...
		internal override Hashtable ToHashtable()
		{
			...
			if (PathFormatter != PathFormatter_DefaultValue) { h.Add("pathFormatter",PathFormatter); Highstock.AddFunction("AdSeriesDragDropDragHandlePathFormatter.pathFormatter", PathFormatter); }  
