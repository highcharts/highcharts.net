...
{
	public partial class AnnotationsElliottWaveLabels  : BaseObject
	{
		public AnnotationsElliottWaveLabels()
		{
			Align = Align_DefaultValue = AnnotationsElliottWaveLabelsAlign.Center;
			...
			Overflow = Overflow_DefaultValue = AnnotationsElliottWaveLabelsOverflow.Justify;
			Padding = Padding_DefaultValue = "5";
			Point = Point_DefaultValue = new AnnotationsElliottWaveLabelsPoint();
			...
			Style = Style_DefaultValue = new AnnotationsElliottWaveLabelsStyle();
			Text = Text_DefaultValue = "undefined";
			UseHTML = UseHTML_DefaultValue = false;
			VerticalAlign = VerticalAlign_DefaultValue = AnnotationsElliottWaveLabelsVerticalAlign.Bottom;
			X = X_DefaultValue = 0;
			Y = Y_DefaultValue = -16;
		...
		/// </summary>
		public AnnotationsElliottWaveLabelsAlign Align { get; set; }
		private AnnotationsElliottWaveLabelsAlign Align_DefaultValue { get; set; }
		...
		/// </summary>
		public AnnotationsElliottWaveLabelsOverflow Overflow { get; set; }
		private AnnotationsElliottWaveLabelsOverflow Overflow_DefaultValue { get; set; }
		...
		/// </summary>
		public AnnotationsElliottWaveLabelsPoint Point { get; set; }
		private AnnotationsElliottWaveLabelsPoint Point_DefaultValue { get; set; }
		...
		/// </summary>
		public AnnotationsElliottWaveLabelsStyle Style { get; set; }
		private AnnotationsElliottWaveLabelsStyle Style_DefaultValue { get; set; }
		...
		/// </summary>
		public AnnotationsElliottWaveLabelsVerticalAlign VerticalAlign { get; set; }
		private AnnotationsElliottWaveLabelsVerticalAlign VerticalAlign_DefaultValue { get; set; }
		...
		internal override Hashtable ToHashtable()
		{
			...
			if (Formatter != Formatter_DefaultValue) { h.Add("formatter",Formatter); Highstock.AddFunction("AnnotationsElliottWaveLabelsFormatter.formatter", Formatter); }  
