...
{
	public partial class AnnotationsElliottWaveShapes  : BaseObject
	{
		public AnnotationsElliottWaveShapes()
		{
			Fill = Fill_DefaultValue = "rgba(0, 0, 0, 0.75)";
			Height = Height_DefaultValue = null;
			MarkerEnd = MarkerEnd_DefaultValue = "";
			MarkerStart = MarkerStart_DefaultValue = "";
			Point = Point_DefaultValue = new AnnotationsElliottWaveShapesPoint();
		...
		/// </summary>
		public AnnotationsElliottWaveShapesPoint Point { get; set; }
		private AnnotationsElliottWaveShapesPoint Point_DefaultValue { get; set; }
