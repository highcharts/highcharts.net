...
namespace Highsoft.Web.Mvc.Stocks
{
	public partial class AnnotationsElliottWaveTypeOptionsPointsLabel  : BaseObject
	{
		public AnnotationsElliottWaveTypeOptionsPointsLabel()
		{
			...
			Style = Style_DefaultValue = new AnnotationsElliottWaveTypeOptionsPointsLabelStyle();
		...
		/// </summary>
		public AnnotationsElliottWaveTypeOptionsPointsLabelStyle Style { get; set; }
		private AnnotationsElliottWaveTypeOptionsPointsLabelStyle Style_DefaultValue { get; set; }
