...
namespace Highsoft.Web.Mvc.Stocks
{
	public partial class AnnotationsFibonacciTypeOptionsLabels  : BaseObject
	{
		public AnnotationsFibonacciTypeOptionsLabels()
		{
			...
			Style = Style_DefaultValue = new AnnotationsFibonacciTypeOptionsLabelsStyle();
		...
		/// </summary>
		public AnnotationsFibonacciTypeOptionsLabelsStyle Style { get; set; }
		private AnnotationsFibonacciTypeOptionsLabelsStyle Style_DefaultValue { get; set; }
