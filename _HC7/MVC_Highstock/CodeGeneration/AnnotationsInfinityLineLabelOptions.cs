...
namespace Highsoft.Web.Mvc.Stocks
{
	public partial class AnnotationsInfinityLineLabelOptions  : BaseObject
	{
		public AnnotationsInfinityLineLabelOptions()
		{
			...
			Style = Style_DefaultValue = new AnnotationsInfinityLineLabelOptionsStyle();
		...
		/// </summary>
		public AnnotationsInfinityLineLabelOptionsStyle Style { get; set; }
		private AnnotationsInfinityLineLabelOptionsStyle Style_DefaultValue { get; set; }
