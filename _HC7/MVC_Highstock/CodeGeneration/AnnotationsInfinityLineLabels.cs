...
{
	public partial class AnnotationsInfinityLineLabels  : BaseObject
	{
		public AnnotationsInfinityLineLabels()
		{
			Align = Align_DefaultValue = AnnotationsInfinityLineLabelsAlign.Center;
			...
			Overflow = Overflow_DefaultValue = AnnotationsInfinityLineLabelsOverflow.Justify;
			Padding = Padding_DefaultValue = "5";
			Point = Point_DefaultValue = new AnnotationsInfinityLineLabelsPoint();
			...
			Style = Style_DefaultValue = new AnnotationsInfinityLineLabelsStyle();
			Text = Text_DefaultValue = "undefined";
			UseHTML = UseHTML_DefaultValue = false;
			VerticalAlign = VerticalAlign_DefaultValue = AnnotationsInfinityLineLabelsVerticalAlign.Bottom;
			X = X_DefaultValue = 0;
			Y = Y_DefaultValue = -16;
		...
		/// </summary>
		public AnnotationsInfinityLineLabelsAlign Align { get; set; }
		private AnnotationsInfinityLineLabelsAlign Align_DefaultValue { get; set; }
		...
		/// </summary>
		public AnnotationsInfinityLineLabelsOverflow Overflow { get; set; }
		private AnnotationsInfinityLineLabelsOverflow Overflow_DefaultValue { get; set; }
		...
		/// <summary>
		/// This option defines the point to which the labelwill be connected.It can be either the point which exists in the series - it isreferenced by the point's id - or a new point with defined x, yproperies and optionally axes.
		/// </summary>
		public AnnotationsInfinityLineLabelsPoint Point { get; set; }
		private AnnotationsInfinityLineLabelsPoint Point_DefaultValue { get; set; }
		...
		/// </summary>
		public AnnotationsInfinityLineLabelsStyle Style { get; set; }
		private AnnotationsInfinityLineLabelsStyle Style_DefaultValue { get; set; }
		...
		/// </summary>
		public AnnotationsInfinityLineLabelsVerticalAlign VerticalAlign { get; set; }
		private AnnotationsInfinityLineLabelsVerticalAlign VerticalAlign_DefaultValue { get; set; }
		...
		internal override Hashtable ToHashtable()
		{
			...
			if (Formatter != Formatter_DefaultValue) { h.Add("formatter",Formatter); Highstock.AddFunction("AnnotationsInfinityLineLabelsFormatter.formatter", Formatter); }  
