...
{
	public partial class AnnotationsInfinityLineShapes  : BaseObject
	{
		public AnnotationsInfinityLineShapes()
		{
			Fill = Fill_DefaultValue = "rgba(0, 0, 0, 0.75)";
			Height = Height_DefaultValue = null;
			MarkerEnd = MarkerEnd_DefaultValue = "";
			MarkerStart = MarkerStart_DefaultValue = "";
			Point = Point_DefaultValue = new AnnotationsInfinityLineShapesPoint();
		...
		/// </summary>
		public AnnotationsInfinityLineShapesPoint Point { get; set; }
		private AnnotationsInfinityLineShapesPoint Point_DefaultValue { get; set; }
