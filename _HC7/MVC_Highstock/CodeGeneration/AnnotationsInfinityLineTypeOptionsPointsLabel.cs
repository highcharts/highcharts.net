...
{
	public partial class AnnotationsInfinityLineTypeOptionsPointsLabel  : BaseObject
	{
		public AnnotationsInfinityLineTypeOptionsPointsLabel()
		{
			Align = Align_DefaultValue = AnnotationsInfinityLineTypeOptionsPointsLabelAlign.Center;
			...
			Overflow = Overflow_DefaultValue = AnnotationsInfinityLineTypeOptionsPointsLabelOverflow.Justify;
			Padding = Padding_DefaultValue = "5";
			Shadow = Shadow_DefaultValue = new Shadow() { Enabled = false };
			ShadowBool = ShadowBool_DefaultValue = null;
			Shape = Shape_DefaultValue = "callout";
			Style = Style_DefaultValue = new AnnotationsInfinityLineTypeOptionsPointsLabelStyle();
			Text = Text_DefaultValue = "undefined";
			UseHTML = UseHTML_DefaultValue = false;
			VerticalAlign = VerticalAlign_DefaultValue = AnnotationsInfinityLineTypeOptionsPointsLabelVerticalAlign.Bottom;
			X = X_DefaultValue = 0;
			Y = Y_DefaultValue = -16;
		...
		/// </summary>
		public AnnotationsInfinityLineTypeOptionsPointsLabelAlign Align { get; set; }
		private AnnotationsInfinityLineTypeOptionsPointsLabelAlign Align_DefaultValue { get; set; }
		...
		/// </summary>
		public AnnotationsInfinityLineTypeOptionsPointsLabelOverflow Overflow { get; set; }
		private AnnotationsInfinityLineTypeOptionsPointsLabelOverflow Overflow_DefaultValue { get; set; }
		...
		/// </summary>
		public AnnotationsInfinityLineTypeOptionsPointsLabelStyle Style { get; set; }
		private AnnotationsInfinityLineTypeOptionsPointsLabelStyle Style_DefaultValue { get; set; }
		...
		/// </summary>
		public AnnotationsInfinityLineTypeOptionsPointsLabelVerticalAlign VerticalAlign { get; set; }
		private AnnotationsInfinityLineTypeOptionsPointsLabelVerticalAlign VerticalAlign_DefaultValue { get; set; }
		...
		internal override Hashtable ToHashtable()
		{
			...
			if (Formatter != Formatter_DefaultValue) { h.Add("formatter",Formatter); Highstock.AddFunction("AnnotationsInfinityLineTypeOptionsPointsLabelFormatter.formatter", Formatter); }  
