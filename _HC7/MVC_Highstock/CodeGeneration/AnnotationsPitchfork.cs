...
namespace Highsoft.Web.Mvc.Stocks
{
	public partial class AnnotationsPitchfork  : BaseObject
	{
		public AnnotationsPitchfork()
		{
			...
			Labels = Labels_DefaultValue = new List<AnnotationsPitchforkLabels>();
			ShapeOptions = ShapeOptions_DefaultValue = new AnnotationsPitchforkShapeOptions();
			Shapes = Shapes_DefaultValue = new List<AnnotationsPitchforkShapes>();
		...
		/// </summary>
		public List<AnnotationsPitchforkLabels> Labels { get; set; }
		private List<AnnotationsPitchforkLabels> Labels_DefaultValue { get; set; }
		...
		/// </summary>
		public List<AnnotationsPitchforkShapes> Shapes { get; set; }
		private List<AnnotationsPitchforkShapes> Shapes_DefaultValue { get; set; }
