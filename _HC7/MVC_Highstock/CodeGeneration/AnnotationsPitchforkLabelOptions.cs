...
namespace Highsoft.Web.Mvc.Stocks
{
	public partial class AnnotationsPitchforkLabelOptions  : BaseObject
	{
		public AnnotationsPitchforkLabelOptions()
		{
			...
			Style = Style_DefaultValue = new AnnotationsPitchforkLabelOptionsStyle();
		...
		/// </summary>
		public AnnotationsPitchforkLabelOptionsStyle Style { get; set; }
		private AnnotationsPitchforkLabelOptionsStyle Style_DefaultValue { get; set; }
