...
{
	public partial class AnnotationsPitchforkTypeOptionsPointsLabel  : BaseObject
	{
		public AnnotationsPitchforkTypeOptionsPointsLabel()
		{
			Align = Align_DefaultValue = AnnotationsPitchforkTypeOptionsPointsLabelAlign.Center;
			...
			Overflow = Overflow_DefaultValue = AnnotationsPitchforkTypeOptionsPointsLabelOverflow.Justify;
			Padding = Padding_DefaultValue = "5";
			Shadow = Shadow_DefaultValue = new Shadow() { Enabled = false };
			ShadowBool = ShadowBool_DefaultValue = null;
			Shape = Shape_DefaultValue = "callout";
			Style = Style_DefaultValue = new AnnotationsPitchforkTypeOptionsPointsLabelStyle();
			Text = Text_DefaultValue = "undefined";
			UseHTML = UseHTML_DefaultValue = false;
			VerticalAlign = VerticalAlign_DefaultValue = AnnotationsPitchforkTypeOptionsPointsLabelVerticalAlign.Bottom;
			X = X_DefaultValue = 0;
			Y = Y_DefaultValue = -16;
		...
		/// </summary>
		public AnnotationsPitchforkTypeOptionsPointsLabelAlign Align { get; set; }
		private AnnotationsPitchforkTypeOptionsPointsLabelAlign Align_DefaultValue { get; set; }
		...
		/// </summary>
		public AnnotationsPitchforkTypeOptionsPointsLabelOverflow Overflow { get; set; }
		private AnnotationsPitchforkTypeOptionsPointsLabelOverflow Overflow_DefaultValue { get; set; }
		...
		/// </summary>
		public AnnotationsPitchforkTypeOptionsPointsLabelStyle Style { get; set; }
		private AnnotationsPitchforkTypeOptionsPointsLabelStyle Style_DefaultValue { get; set; }
		...
		/// </summary>
		public AnnotationsPitchforkTypeOptionsPointsLabelVerticalAlign VerticalAlign { get; set; }
		private AnnotationsPitchforkTypeOptionsPointsLabelVerticalAlign VerticalAlign_DefaultValue { get; set; }
		...
		internal override Hashtable ToHashtable()
		{
			...
			if (Formatter != Formatter_DefaultValue) { h.Add("formatter",Formatter); Highstock.AddFunction("AnnotationsPitchforkTypeOptionsPointsLabelFormatter.formatter", Formatter); }  
