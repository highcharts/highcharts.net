...
namespace Highsoft.Web.Mvc.Stocks
{
	public partial class AnnotationsTunnelLabelOptions  : BaseObject
	{
		public AnnotationsTunnelLabelOptions()
		{
			...
			Style = Style_DefaultValue = new AnnotationsTunnelLabelOptionsStyle();
		...
		/// </summary>
		public AnnotationsTunnelLabelOptionsStyle Style { get; set; }
		private AnnotationsTunnelLabelOptionsStyle Style_DefaultValue { get; set; }
