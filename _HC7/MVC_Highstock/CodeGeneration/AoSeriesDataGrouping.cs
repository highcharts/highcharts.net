...
{
	public partial class AoSeriesDataGrouping  : BaseObject
	{
		public AoSeriesDataGrouping()
		{
			Approximation = Approximation_DefaultValue = AoSeriesDataGroupingApproximation.Null;
		...
		/// </summary>
		public AoSeriesDataGroupingApproximation Approximation { get; set; }
		private AoSeriesDataGroupingApproximation Approximation_DefaultValue { get; set; }
