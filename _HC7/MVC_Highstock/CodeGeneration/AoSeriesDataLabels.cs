...
namespace Highsoft.Web.Mvc.Stocks
{
	public partial class AoSeriesDataLabels  : BaseObject
	{
		public AoSeriesDataLabels()
		{
			...
			Style = Style_DefaultValue = new AoSeriesDataLabelsStyle();
		...
		/// </summary>
		public AoSeriesDataLabelsStyle Style { get; set; }
		private AoSeriesDataLabelsStyle Style_DefaultValue { get; set; }
