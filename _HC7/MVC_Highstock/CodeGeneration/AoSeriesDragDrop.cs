...
{
	public partial class AoSeriesDragDrop  : BaseObject
	{
		public AoSeriesDragDrop()
		{
			DraggableX = DraggableX_DefaultValue = null;
			DraggableY = DraggableY_DefaultValue = null;
			DragHandle = DragHandle_DefaultValue = new AoSeriesDragDropDragHandle();
			...
			GuideBox = GuideBox_DefaultValue = new AoSeriesDragDropGuideBox();
		...
		/// </summary>
		public AoSeriesDragDropDragHandle DragHandle { get; set; }
		private AoSeriesDragDropDragHandle DragHandle_DefaultValue { get; set; }
		...
		/// </summary>
		public AoSeriesDragDropGuideBox GuideBox { get; set; }
		private AoSeriesDragDropGuideBox GuideBox_DefaultValue { get; set; }
