...
{
	public partial class AoSeriesDragDropDragHandle  : BaseObject
	{
		public AoSeriesDragDropDragHandle()
		{
		...
		internal override Hashtable ToHashtable()
		{
			...
			if (PathFormatter != PathFormatter_DefaultValue) { h.Add("pathFormatter",PathFormatter); Highstock.AddFunction("AoSeriesDragDropDragHandlePathFormatter.pathFormatter", PathFormatter); }  
