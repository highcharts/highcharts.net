...
{
	public partial class ApoSeriesDataGrouping  : BaseObject
	{
		public ApoSeriesDataGrouping()
		{
			Approximation = Approximation_DefaultValue = ApoSeriesDataGroupingApproximation.Null;
		...
		/// </summary>
		public ApoSeriesDataGroupingApproximation Approximation { get; set; }
		private ApoSeriesDataGroupingApproximation Approximation_DefaultValue { get; set; }
