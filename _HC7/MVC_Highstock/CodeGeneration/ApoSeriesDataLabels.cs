...
namespace Highsoft.Web.Mvc.Stocks
{
	public partial class ApoSeriesDataLabels  : BaseObject
	{
		public ApoSeriesDataLabels()
		{
			...
			Style = Style_DefaultValue = new ApoSeriesDataLabelsStyle();
		...
		/// </summary>
		public ApoSeriesDataLabelsStyle Style { get; set; }
		private ApoSeriesDataLabelsStyle Style_DefaultValue { get; set; }
