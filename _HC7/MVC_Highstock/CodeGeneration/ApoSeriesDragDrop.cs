...
{
	public partial class ApoSeriesDragDrop  : BaseObject
	{
		public ApoSeriesDragDrop()
		{
			DraggableX = DraggableX_DefaultValue = null;
			DraggableY = DraggableY_DefaultValue = null;
			DragHandle = DragHandle_DefaultValue = new ApoSeriesDragDropDragHandle();
			...
			GuideBox = GuideBox_DefaultValue = new ApoSeriesDragDropGuideBox();
		...
		/// </summary>
		public ApoSeriesDragDropDragHandle DragHandle { get; set; }
		private ApoSeriesDragDropDragHandle DragHandle_DefaultValue { get; set; }
		...
		/// </summary>
		public ApoSeriesDragDropGuideBox GuideBox { get; set; }
		private ApoSeriesDragDropGuideBox GuideBox_DefaultValue { get; set; }
