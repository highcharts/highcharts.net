...
{
	public partial class ArearangeSeriesDragDrop  : BaseObject
	{
		public ArearangeSeriesDragDrop()
		{
			DraggableX = DraggableX_DefaultValue = null;
			DraggableY = DraggableY_DefaultValue = null;
			DragHandle = DragHandle_DefaultValue = new ArearangeSeriesDragDropDragHandle();
			...
			GuideBox = GuideBox_DefaultValue = new ArearangeSeriesDragDropGuideBox();
		...
		/// </summary>
		public ArearangeSeriesDragDropDragHandle DragHandle { get; set; }
		private ArearangeSeriesDragDropDragHandle DragHandle_DefaultValue { get; set; }
		...
		/// </summary>
		public ArearangeSeriesDragDropGuideBox GuideBox { get; set; }
		private ArearangeSeriesDragDropGuideBox GuideBox_DefaultValue { get; set; }
