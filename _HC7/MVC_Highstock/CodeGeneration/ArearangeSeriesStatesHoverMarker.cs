...
namespace Highsoft.Web.Mvc.Stocks
{
	public partial class ArearangeSeriesStatesHoverMarker  : BaseObject
	{
		public ArearangeSeriesStatesHoverMarker()
		{
			...
			States = States_DefaultValue = new ArearangeSeriesStatesHoverMarkerStates();
		...
		/// </summary>
		public ArearangeSeriesStatesHoverMarkerStates States { get; set; }
		private ArearangeSeriesStatesHoverMarkerStates States_DefaultValue { get; set; }
