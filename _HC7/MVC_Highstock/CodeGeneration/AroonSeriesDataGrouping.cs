...
{
	public partial class AroonSeriesDataGrouping  : BaseObject
	{
		public AroonSeriesDataGrouping()
		{
			Approximation = Approximation_DefaultValue = AroonSeriesDataGroupingApproximation.Null;
		...
		/// </summary>
		public AroonSeriesDataGroupingApproximation Approximation { get; set; }
		private AroonSeriesDataGroupingApproximation Approximation_DefaultValue { get; set; }
