...
namespace Highsoft.Web.Mvc.Stocks
{
	public partial class AroonSeriesDataLabels  : BaseObject
	{
		public AroonSeriesDataLabels()
		{
			...
			Style = Style_DefaultValue = new AroonSeriesDataLabelsStyle();
		...
		/// </summary>
		public AroonSeriesDataLabelsStyle Style { get; set; }
		private AroonSeriesDataLabelsStyle Style_DefaultValue { get; set; }
