...
{
	public partial class AroonSeriesDragDrop  : BaseObject
	{
		public AroonSeriesDragDrop()
		{
			DraggableX = DraggableX_DefaultValue = null;
			DraggableY = DraggableY_DefaultValue = null;
			DragHandle = DragHandle_DefaultValue = new AroonSeriesDragDropDragHandle();
			...
			GuideBox = GuideBox_DefaultValue = new AroonSeriesDragDropGuideBox();
		...
		/// </summary>
		public AroonSeriesDragDropDragHandle DragHandle { get; set; }
		private AroonSeriesDragDropDragHandle DragHandle_DefaultValue { get; set; }
		...
		/// </summary>
		public AroonSeriesDragDropGuideBox GuideBox { get; set; }
		private AroonSeriesDragDropGuideBox GuideBox_DefaultValue { get; set; }
