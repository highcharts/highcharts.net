...
{
	public partial class AroonSeriesDragDropDragHandle  : BaseObject
	{
		public AroonSeriesDragDropDragHandle()
		{
		...
		internal override Hashtable ToHashtable()
		{
			...
			if (PathFormatter != PathFormatter_DefaultValue) { h.Add("pathFormatter",PathFormatter); Highstock.AddFunction("AroonSeriesDragDropDragHandlePathFormatter.pathFormatter", PathFormatter); }  
