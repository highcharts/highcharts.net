...
{
	public partial class AroonoscillatorSeriesDataGrouping  : BaseObject
	{
		public AroonoscillatorSeriesDataGrouping()
		{
			Approximation = Approximation_DefaultValue = AroonoscillatorSeriesDataGroupingApproximation.Null;
		...
		/// </summary>
		public AroonoscillatorSeriesDataGroupingApproximation Approximation { get; set; }
		private AroonoscillatorSeriesDataGroupingApproximation Approximation_DefaultValue { get; set; }
