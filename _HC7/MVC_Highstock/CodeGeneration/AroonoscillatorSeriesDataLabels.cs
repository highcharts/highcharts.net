...
namespace Highsoft.Web.Mvc.Stocks
{
	public partial class AroonoscillatorSeriesDataLabels  : BaseObject
	{
		public AroonoscillatorSeriesDataLabels()
		{
			...
			Style = Style_DefaultValue = new AroonoscillatorSeriesDataLabelsStyle();
		...
		/// </summary>
		public AroonoscillatorSeriesDataLabelsStyle Style { get; set; }
		private AroonoscillatorSeriesDataLabelsStyle Style_DefaultValue { get; set; }
