...
{
	public partial class AroonoscillatorSeriesDragDrop  : BaseObject
	{
		public AroonoscillatorSeriesDragDrop()
		{
			DraggableX = DraggableX_DefaultValue = null;
			DraggableY = DraggableY_DefaultValue = null;
			DragHandle = DragHandle_DefaultValue = new AroonoscillatorSeriesDragDropDragHandle();
			...
			GuideBox = GuideBox_DefaultValue = new AroonoscillatorSeriesDragDropGuideBox();
		...
		/// </summary>
		public AroonoscillatorSeriesDragDropDragHandle DragHandle { get; set; }
		private AroonoscillatorSeriesDragDropDragHandle DragHandle_DefaultValue { get; set; }
		...
		/// </summary>
		public AroonoscillatorSeriesDragDropGuideBox GuideBox { get; set; }
		private AroonoscillatorSeriesDragDropGuideBox GuideBox_DefaultValue { get; set; }
