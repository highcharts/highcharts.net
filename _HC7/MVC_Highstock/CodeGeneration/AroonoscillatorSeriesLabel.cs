...
{
	public partial class AroonoscillatorSeriesLabel  : BaseObject
	{
		public AroonoscillatorSeriesLabel()
		{
			...
			Style = Style_DefaultValue = new AroonoscillatorSeriesLabelStyle();
		...
		/// </summary>
		public AroonoscillatorSeriesLabelStyle Style { get; set; }
		private AroonoscillatorSeriesLabelStyle Style_DefaultValue { get; set; }
