...
{
	public partial class AroonoscillatorSeriesStatesHover  : BaseObject
	{
		public AroonoscillatorSeriesStatesHover()
		{
			Enabled = Enabled_DefaultValue = true;
			Halo = Halo_DefaultValue = new AroonoscillatorSeriesStatesHoverHalo();
			LineWidth = LineWidth_DefaultValue = null;
			LineWidthPlus = LineWidthPlus_DefaultValue = 1;
			Marker = Marker_DefaultValue = new AroonoscillatorSeriesStatesHoverMarker();
		...
		/// </summary>
		public AroonoscillatorSeriesStatesHoverHalo Halo { get; set; }
		private AroonoscillatorSeriesStatesHoverHalo Halo_DefaultValue { get; set; }
		...
		/// </summary>
		public AroonoscillatorSeriesStatesHoverMarker Marker { get; set; }
		private AroonoscillatorSeriesStatesHoverMarker Marker_DefaultValue { get; set; }
