...
{
	public partial class AtrSeriesDataDragDrop  : BaseObject
	{
		public AtrSeriesDataDragDrop()
		{
			DraggableX = DraggableX_DefaultValue = null;
			DraggableY = DraggableY_DefaultValue = null;
			DragHandle = DragHandle_DefaultValue = new AtrSeriesDataDragDropDragHandle();
			...
			GuideBox = GuideBox_DefaultValue = new AtrSeriesDataDragDropGuideBox();
		...
		/// </summary>
		public AtrSeriesDataDragDropDragHandle DragHandle { get; set; }
		private AtrSeriesDataDragDropDragHandle DragHandle_DefaultValue { get; set; }
		...
		/// </summary>
		public AtrSeriesDataDragDropGuideBox GuideBox { get; set; }
		private AtrSeriesDataDragDropGuideBox GuideBox_DefaultValue { get; set; }
