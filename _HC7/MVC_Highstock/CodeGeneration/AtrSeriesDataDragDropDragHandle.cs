...
{
	public partial class AtrSeriesDataDragDropDragHandle  : BaseObject
	{
		public AtrSeriesDataDragDropDragHandle()
		{
		...
		internal override Hashtable ToHashtable()
		{
			...
			if (PathFormatter != PathFormatter_DefaultValue) { h.Add("pathFormatter",PathFormatter); Highstock.AddFunction("AtrSeriesDataDragDropDragHandlePathFormatter.pathFormatter", PathFormatter); }  
