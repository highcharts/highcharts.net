...
namespace Highsoft.Web.Mvc.Stocks
{
	public partial class AtrSeriesDataLabels  : BaseObject
	{
		public AtrSeriesDataLabels()
		{
			...
			Style = Style_DefaultValue = new AtrSeriesDataLabelsStyle();
		...
		/// </summary>
		public AtrSeriesDataLabelsStyle Style { get; set; }
		private AtrSeriesDataLabelsStyle Style_DefaultValue { get; set; }
