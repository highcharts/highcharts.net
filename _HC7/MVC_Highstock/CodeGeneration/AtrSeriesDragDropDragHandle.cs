...
{
	public partial class AtrSeriesDragDropDragHandle  : BaseObject
	{
		public AtrSeriesDragDropDragHandle()
		{
		...
		internal override Hashtable ToHashtable()
		{
			...
			if (PathFormatter != PathFormatter_DefaultValue) { h.Add("pathFormatter",PathFormatter); Highstock.AddFunction("AtrSeriesDragDropDragHandlePathFormatter.pathFormatter", PathFormatter); }  
