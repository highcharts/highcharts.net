...
namespace Highsoft.Web.Mvc.Stocks
{
	public partial class BbSeries  : Series
	{
		public BbSeries()
		{
			...
			DashStyle = DashStyle_DefaultValue = BbSeriesDashStyle.Solid;
			Data = Data_DefaultValue = new List<BbSeriesData>();
			...
			DragDrop = DragDrop_DefaultValue = new BbSeriesDragDrop();
			...
			Type = Type_DefaultValue = BbSeriesType.Null;
		...
		/// <summary>
		/// An array of data points for the series. For the `bb` series type,points are calculated dynamically.
		/// </summary>
		public List<BbSeriesData> Data { get; set; }
		private List<BbSeriesData> Data_DefaultValue { get; set; }
		...
		/// </summary>
		public BbSeriesDragDrop DragDrop { get; set; }
		private BbSeriesDragDrop DragDrop_DefaultValue { get; set; }
		...
		/// </summary>
		public BbSeriesType Type { get; set; }
		private BbSeriesType Type_DefaultValue { get; set; }
		...
		/// </summary>
		public List<BbSeriesZone> Zones { get; set; }
		private List<BbSeriesZone> Zones_DefaultValue { get; set; }
		...
		internal override Hashtable ToHashtable()
		{
			...
			if (PointDescriptionFormatter != PointDescriptionFormatter_DefaultValue) { h.Add("pointDescriptionFormatter",PointDescriptionFormatter); Highstock.AddFunction("BbSeriesPointDescriptionFormatter.pointDescriptionFormatter", PointDescriptionFormatter); }  
