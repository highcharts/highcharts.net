...
namespace Highsoft.Web.Mvc.Stocks
{
	public partial class BubbleSeries  : Series
	{
		public BubbleSeries()
		{
			...
			GapUnit = GapUnit_DefaultValue = BubbleSeriesGapUnit.Relative;
		...
		private BubbleSeriesCompareBase CompareBase_DefaultValue { get; set; }
		...
		private BubbleSeriesDataGrouping DataGrouping_DefaultValue { get; set; }
		...
		private BubbleSeriesGapUnit GapUnit_DefaultValue { get; set; }
		...
		internal override Hashtable ToHashtable()
		{
			...
			if (PointDescriptionFormatter != PointDescriptionFormatter_DefaultValue) { h.Add("pointDescriptionFormatter",PointDescriptionFormatter); Highstock.AddFunction("BubbleSeriesPointDescriptionFormatter.pointDescriptionFormatter", PointDescriptionFormatter); }  
			...
			if (SizeBy != SizeBy_DefaultValue) h.Add("sizeBy", Highstock.FirstCharacterToLower(SizeBy.ToString()));
