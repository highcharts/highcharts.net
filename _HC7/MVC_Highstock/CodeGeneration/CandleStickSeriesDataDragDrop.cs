...
{
	public partial class CandleStickSeriesDataDragDrop  : BaseObject
	{
		public CandleStickSeriesDataDragDrop()
		{
			DraggableX = DraggableX_DefaultValue = null;
			DraggableY = DraggableY_DefaultValue = null;
			DragHandle = DragHandle_DefaultValue = new CandleStickSeriesDataDragDropDragHandle();
			...
			GuideBox = GuideBox_DefaultValue = new CandleStickSeriesDataDragDropGuideBox();
		...
		/// </summary>
		public CandleStickSeriesDataDragDropDragHandle DragHandle { get; set; }
		private CandleStickSeriesDataDragDropDragHandle DragHandle_DefaultValue { get; set; }
		...
		/// </summary>
		public CandleStickSeriesDataDragDropGuideBox GuideBox { get; set; }
		private CandleStickSeriesDataDragDropGuideBox GuideBox_DefaultValue { get; set; }
