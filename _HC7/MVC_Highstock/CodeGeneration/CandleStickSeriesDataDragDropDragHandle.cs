...
{
	public partial class CandleStickSeriesDataDragDropDragHandle  : BaseObject
	{
		public CandleStickSeriesDataDragDropDragHandle()
		{
		...
		internal override Hashtable ToHashtable()
		{
			...
			if (PathFormatter != PathFormatter_DefaultValue) { h.Add("pathFormatter",PathFormatter); Highstock.AddFunction("CandleStickSeriesDataDragDropDragHandlePathFormatter.pathFormatter", PathFormatter); }  
