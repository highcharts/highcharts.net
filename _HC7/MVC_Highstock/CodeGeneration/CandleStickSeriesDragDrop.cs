...
{
	public partial class CandleStickSeriesDragDrop  : BaseObject
	{
		public CandleStickSeriesDragDrop()
		{
			DraggableX = DraggableX_DefaultValue = null;
			DraggableY = DraggableY_DefaultValue = null;
			DragHandle = DragHandle_DefaultValue = new CandleStickSeriesDragDropDragHandle();
			...
			GuideBox = GuideBox_DefaultValue = new CandleStickSeriesDragDropGuideBox();
		...
		/// </summary>
		public CandleStickSeriesDragDropDragHandle DragHandle { get; set; }
		private CandleStickSeriesDragDropDragHandle DragHandle_DefaultValue { get; set; }
		...
		/// </summary>
		public CandleStickSeriesDragDropGuideBox GuideBox { get; set; }
		private CandleStickSeriesDragDropGuideBox GuideBox_DefaultValue { get; set; }
