...
{
	public partial class CandleStickSeriesDragDropDragHandle  : BaseObject
	{
		public CandleStickSeriesDragDropDragHandle()
		{
		...
		internal override Hashtable ToHashtable()
		{
			...
			if (PathFormatter != PathFormatter_DefaultValue) { h.Add("pathFormatter",PathFormatter); Highstock.AddFunction("CandleStickSeriesDragDropDragHandlePathFormatter.pathFormatter", PathFormatter); }  
