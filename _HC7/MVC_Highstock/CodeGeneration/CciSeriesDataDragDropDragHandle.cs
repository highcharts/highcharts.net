...
{
	public partial class CciSeriesDataDragDropDragHandle  : BaseObject
	{
		public CciSeriesDataDragDropDragHandle()
		{
		...
		internal override Hashtable ToHashtable()
		{
			...
			if (PathFormatter != PathFormatter_DefaultValue) { h.Add("pathFormatter",PathFormatter); Highstock.AddFunction("CciSeriesDataDragDropDragHandlePathFormatter.pathFormatter", PathFormatter); }  
