...
{
	public partial class CciSeriesDragDrop  : BaseObject
	{
		public CciSeriesDragDrop()
		{
			DraggableX = DraggableX_DefaultValue = null;
			DraggableY = DraggableY_DefaultValue = null;
			DragHandle = DragHandle_DefaultValue = new CciSeriesDragDropDragHandle();
			...
			GuideBox = GuideBox_DefaultValue = new CciSeriesDragDropGuideBox();
		...
		/// </summary>
		public CciSeriesDragDropDragHandle DragHandle { get; set; }
		private CciSeriesDragDropDragHandle DragHandle_DefaultValue { get; set; }
		...
		/// </summary>
		public CciSeriesDragDropGuideBox GuideBox { get; set; }
		private CciSeriesDragDropGuideBox GuideBox_DefaultValue { get; set; }
