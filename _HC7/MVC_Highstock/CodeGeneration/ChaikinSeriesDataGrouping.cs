...
{
	public partial class ChaikinSeriesDataGrouping  : BaseObject
	{
		public ChaikinSeriesDataGrouping()
		{
			Approximation = Approximation_DefaultValue = ChaikinSeriesDataGroupingApproximation.Null;
		...
		/// </summary>
		public ChaikinSeriesDataGroupingApproximation Approximation { get; set; }
		private ChaikinSeriesDataGroupingApproximation Approximation_DefaultValue { get; set; }
