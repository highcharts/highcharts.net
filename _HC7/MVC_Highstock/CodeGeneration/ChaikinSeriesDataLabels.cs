...
namespace Highsoft.Web.Mvc.Stocks
{
	public partial class ChaikinSeriesDataLabels  : BaseObject
	{
		public ChaikinSeriesDataLabels()
		{
			...
			Style = Style_DefaultValue = new ChaikinSeriesDataLabelsStyle();
		...
		/// </summary>
		public ChaikinSeriesDataLabelsStyle Style { get; set; }
		private ChaikinSeriesDataLabelsStyle Style_DefaultValue { get; set; }
