...
{
	public partial class ChaikinSeriesDragDrop  : BaseObject
	{
		public ChaikinSeriesDragDrop()
		{
			DraggableX = DraggableX_DefaultValue = null;
			DraggableY = DraggableY_DefaultValue = null;
			DragHandle = DragHandle_DefaultValue = new ChaikinSeriesDragDropDragHandle();
			...
			GuideBox = GuideBox_DefaultValue = new ChaikinSeriesDragDropGuideBox();
		...
		/// </summary>
		public ChaikinSeriesDragDropDragHandle DragHandle { get; set; }
		private ChaikinSeriesDragDropDragHandle DragHandle_DefaultValue { get; set; }
		...
		/// </summary>
		public ChaikinSeriesDragDropGuideBox GuideBox { get; set; }
		private ChaikinSeriesDragDropGuideBox GuideBox_DefaultValue { get; set; }
