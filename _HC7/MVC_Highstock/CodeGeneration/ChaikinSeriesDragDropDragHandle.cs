...
{
	public partial class ChaikinSeriesDragDropDragHandle  : BaseObject
	{
		public ChaikinSeriesDragDropDragHandle()
		{
		...
		internal override Hashtable ToHashtable()
		{
			...
			if (PathFormatter != PathFormatter_DefaultValue) { h.Add("pathFormatter",PathFormatter); Highstock.AddFunction("ChaikinSeriesDragDropDragHandlePathFormatter.pathFormatter", PathFormatter); }  
