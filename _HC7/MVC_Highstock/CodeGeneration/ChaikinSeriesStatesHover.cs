...
{
	public partial class ChaikinSeriesStatesHover  : BaseObject
	{
		public ChaikinSeriesStatesHover()
		{
			Enabled = Enabled_DefaultValue = true;
			Halo = Halo_DefaultValue = new ChaikinSeriesStatesHoverHalo();
			LineWidth = LineWidth_DefaultValue = null;
			LineWidthPlus = LineWidthPlus_DefaultValue = 1;
			Marker = Marker_DefaultValue = new ChaikinSeriesStatesHoverMarker();
		...
		/// </summary>
		public ChaikinSeriesStatesHoverHalo Halo { get; set; }
		private ChaikinSeriesStatesHoverHalo Halo_DefaultValue { get; set; }
		...
		/// </summary>
		public ChaikinSeriesStatesHoverMarker Marker { get; set; }
		private ChaikinSeriesStatesHoverMarker Marker_DefaultValue { get; set; }
