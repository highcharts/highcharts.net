...
{
	public partial class CmfSeriesDataDragDrop  : BaseObject
	{
		public CmfSeriesDataDragDrop()
		{
			DraggableX = DraggableX_DefaultValue = null;
			DraggableY = DraggableY_DefaultValue = null;
			DragHandle = DragHandle_DefaultValue = new CmfSeriesDataDragDropDragHandle();
			...
			GuideBox = GuideBox_DefaultValue = new CmfSeriesDataDragDropGuideBox();
		...
		/// </summary>
		public CmfSeriesDataDragDropDragHandle DragHandle { get; set; }
		private CmfSeriesDataDragDropDragHandle DragHandle_DefaultValue { get; set; }
		...
		/// </summary>
		public CmfSeriesDataDragDropGuideBox GuideBox { get; set; }
		private CmfSeriesDataDragDropGuideBox GuideBox_DefaultValue { get; set; }
