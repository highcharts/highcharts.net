...
{
	public partial class ColumnSeriesDragDrop  : BaseObject
	{
		public ColumnSeriesDragDrop()
		{
			DraggableX = DraggableX_DefaultValue = null;
			DraggableY = DraggableY_DefaultValue = null;
			DragHandle = DragHandle_DefaultValue = new ColumnSeriesDragDropDragHandle();
			...
			GuideBox = GuideBox_DefaultValue = new ColumnSeriesDragDropGuideBox();
		...
		/// </summary>
		public ColumnSeriesDragDropDragHandle DragHandle { get; set; }
		private ColumnSeriesDragDropDragHandle DragHandle_DefaultValue { get; set; }
