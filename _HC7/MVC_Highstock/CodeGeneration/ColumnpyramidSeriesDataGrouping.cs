...
{
	public partial class ColumnpyramidSeriesDataGrouping  : BaseObject
	{
		public ColumnpyramidSeriesDataGrouping()
		{
			Approximation = Approximation_DefaultValue = ColumnpyramidSeriesDataGroupingApproximation.Null;
		...
		/// </summary>
		public ColumnpyramidSeriesDataGroupingApproximation Approximation { get; set; }
		private ColumnpyramidSeriesDataGroupingApproximation Approximation_DefaultValue { get; set; }
