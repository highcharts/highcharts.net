...
namespace Highsoft.Web.Mvc.Stocks
{
	public partial class ColumnrangeSeriesDragDropDragHandle  : BaseObject
	{
		...
		internal override Hashtable ToHashtable()
		{
			...
			if (PathFormatter != PathFormatter_DefaultValue) { h.Add("pathFormatter",PathFormatter); Highstock.AddFunction("ColumnrangeSeriesDragDropDragHandlePathFormatter.pathFormatter", PathFormatter); }  
