...
{
	public partial class DemaSeriesDataGrouping  : BaseObject
	{
		public DemaSeriesDataGrouping()
		{
			Approximation = Approximation_DefaultValue = DemaSeriesDataGroupingApproximation.Null;
		...
		/// </summary>
		public DemaSeriesDataGroupingApproximation Approximation { get; set; }
		private DemaSeriesDataGroupingApproximation Approximation_DefaultValue { get; set; }
