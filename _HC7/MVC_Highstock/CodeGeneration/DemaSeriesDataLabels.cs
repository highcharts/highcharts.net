...
namespace Highsoft.Web.Mvc.Stocks
{
	public partial class DemaSeriesDataLabels  : BaseObject
	{
		public DemaSeriesDataLabels()
		{
			...
			Style = Style_DefaultValue = new DemaSeriesDataLabelsStyle();
		...
		/// </summary>
		public DemaSeriesDataLabelsStyle Style { get; set; }
		private DemaSeriesDataLabelsStyle Style_DefaultValue { get; set; }
