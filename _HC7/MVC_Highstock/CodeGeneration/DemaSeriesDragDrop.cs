...
{
	public partial class DemaSeriesDragDrop  : BaseObject
	{
		public DemaSeriesDragDrop()
		{
			DraggableX = DraggableX_DefaultValue = null;
			DraggableY = DraggableY_DefaultValue = null;
			DragHandle = DragHandle_DefaultValue = new DemaSeriesDragDropDragHandle();
			...
			GuideBox = GuideBox_DefaultValue = new DemaSeriesDragDropGuideBox();
		...
		/// </summary>
		public DemaSeriesDragDropDragHandle DragHandle { get; set; }
		private DemaSeriesDragDropDragHandle DragHandle_DefaultValue { get; set; }
		...
		/// </summary>
		public DemaSeriesDragDropGuideBox GuideBox { get; set; }
		private DemaSeriesDragDropGuideBox GuideBox_DefaultValue { get; set; }
