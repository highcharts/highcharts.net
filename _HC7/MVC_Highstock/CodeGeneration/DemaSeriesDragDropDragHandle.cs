...
{
	public partial class DemaSeriesDragDropDragHandle  : BaseObject
	{
		public DemaSeriesDragDropDragHandle()
		{
		...
		internal override Hashtable ToHashtable()
		{
			...
			if (PathFormatter != PathFormatter_DefaultValue) { h.Add("pathFormatter",PathFormatter); Highstock.AddFunction("DemaSeriesDragDropDragHandlePathFormatter.pathFormatter", PathFormatter); }  
