...
{
	public partial class DemaSeriesLabel  : BaseObject
	{
		public DemaSeriesLabel()
		{
			...
			Style = Style_DefaultValue = new DemaSeriesLabelStyle();
		...
		/// </summary>
		public DemaSeriesLabelStyle Style { get; set; }
		private DemaSeriesLabelStyle Style_DefaultValue { get; set; }
