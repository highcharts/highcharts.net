...
{
	public partial class DpoSeriesDataGrouping  : BaseObject
	{
		public DpoSeriesDataGrouping()
		{
			Approximation = Approximation_DefaultValue = DpoSeriesDataGroupingApproximation.Null;
		...
		/// </summary>
		public DpoSeriesDataGroupingApproximation Approximation { get; set; }
		private DpoSeriesDataGroupingApproximation Approximation_DefaultValue { get; set; }
