...
namespace Highsoft.Web.Mvc.Stocks
{
	public partial class DpoSeriesDataLabels  : BaseObject
	{
		public DpoSeriesDataLabels()
		{
			...
			Style = Style_DefaultValue = new DpoSeriesDataLabelsStyle();
		...
		/// </summary>
		public DpoSeriesDataLabelsStyle Style { get; set; }
		private DpoSeriesDataLabelsStyle Style_DefaultValue { get; set; }
