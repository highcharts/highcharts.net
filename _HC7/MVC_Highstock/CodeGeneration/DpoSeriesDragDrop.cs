...
{
	public partial class DpoSeriesDragDrop  : BaseObject
	{
		public DpoSeriesDragDrop()
		{
			DraggableX = DraggableX_DefaultValue = null;
			DraggableY = DraggableY_DefaultValue = null;
			DragHandle = DragHandle_DefaultValue = new DpoSeriesDragDropDragHandle();
			...
			GuideBox = GuideBox_DefaultValue = new DpoSeriesDragDropGuideBox();
		...
		/// </summary>
		public DpoSeriesDragDropDragHandle DragHandle { get; set; }
		private DpoSeriesDragDropDragHandle DragHandle_DefaultValue { get; set; }
		...
		/// </summary>
		public DpoSeriesDragDropGuideBox GuideBox { get; set; }
		private DpoSeriesDragDropGuideBox GuideBox_DefaultValue { get; set; }
