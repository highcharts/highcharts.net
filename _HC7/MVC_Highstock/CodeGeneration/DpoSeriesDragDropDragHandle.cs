...
{
	public partial class DpoSeriesDragDropDragHandle  : BaseObject
	{
		public DpoSeriesDragDropDragHandle()
		{
		...
		internal override Hashtable ToHashtable()
		{
			...
			if (PathFormatter != PathFormatter_DefaultValue) { h.Add("pathFormatter",PathFormatter); Highstock.AddFunction("DpoSeriesDragDropDragHandlePathFormatter.pathFormatter", PathFormatter); }  
