...
{
	public partial class DpoSeriesMarker  : BaseObject
	{
		public DpoSeriesMarker()
		{
			...
			States = States_DefaultValue = new DpoSeriesMarkerStates();
		...
		/// </summary>
		public DpoSeriesMarkerStates States { get; set; }
		private DpoSeriesMarkerStates States_DefaultValue { get; set; }
