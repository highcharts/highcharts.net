...
{
	public partial class EmaSeriesData  : BaseObject
	{
		public EmaSeriesData()
		{
			...
			DragDrop = DragDrop_DefaultValue = new EmaSeriesDataDragDrop();
			Drilldown = Drilldown_DefaultValue = "";
			Events = Events_DefaultValue = new EmaSeriesDataEvents();
			Id = Id_DefaultValue = "";
			Labelrank = Labelrank_DefaultValue = null;
			Marker = Marker_DefaultValue = new EmaSeriesDataMarker();
		...
		/// </summary>
		public EmaSeriesDataDragDrop DragDrop { get; set; }
		private EmaSeriesDataDragDrop DragDrop_DefaultValue { get; set; }
		...
		/// </summary>
		public EmaSeriesDataEvents Events { get; set; }
		private EmaSeriesDataEvents Events_DefaultValue { get; set; }
		...
		/// 
		/// </summary>
		public EmaSeriesDataMarker Marker { get; set; }
		private EmaSeriesDataMarker Marker_DefaultValue { get; set; }
