...
{
	public partial class EmaSeriesDataDragDropDragHandle  : BaseObject
	{
		public EmaSeriesDataDragDropDragHandle()
		{
		...
		internal override Hashtable ToHashtable()
		{
			...
			if (PathFormatter != PathFormatter_DefaultValue) { h.Add("pathFormatter",PathFormatter); Highstock.AddFunction("EmaSeriesDataDragDropDragHandlePathFormatter.pathFormatter", PathFormatter); }  
