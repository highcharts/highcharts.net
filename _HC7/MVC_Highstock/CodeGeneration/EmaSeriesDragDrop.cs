...
{
	public partial class EmaSeriesDragDrop  : BaseObject
	{
		public EmaSeriesDragDrop()
		{
			DraggableX = DraggableX_DefaultValue = null;
			DraggableY = DraggableY_DefaultValue = null;
			DragHandle = DragHandle_DefaultValue = new EmaSeriesDragDropDragHandle();
			...
			GuideBox = GuideBox_DefaultValue = new EmaSeriesDragDropGuideBox();
		...
		/// </summary>
		public EmaSeriesDragDropDragHandle DragHandle { get; set; }
		private EmaSeriesDragDropDragHandle DragHandle_DefaultValue { get; set; }
		...
		/// </summary>
		public EmaSeriesDragDropGuideBox GuideBox { get; set; }
		private EmaSeriesDragDropGuideBox GuideBox_DefaultValue { get; set; }
