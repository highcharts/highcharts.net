...
{
	public partial class FlagsSeriesDataDragDropDragHandle  : BaseObject
	{
		public FlagsSeriesDataDragDropDragHandle()
		{
		...
		internal override Hashtable ToHashtable()
		{
			...
			if (PathFormatter != PathFormatter_DefaultValue) { h.Add("pathFormatter",PathFormatter); Highstock.AddFunction("FlagsSeriesDataDragDropDragHandlePathFormatter.pathFormatter", PathFormatter); }  
