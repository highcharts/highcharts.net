...
{
	public partial class FlagsSeriesDragDrop  : BaseObject
	{
		public FlagsSeriesDragDrop()
		{
			DraggableX = DraggableX_DefaultValue = null;
			DraggableY = DraggableY_DefaultValue = null;
			DragHandle = DragHandle_DefaultValue = new FlagsSeriesDragDropDragHandle();
			...
			GuideBox = GuideBox_DefaultValue = new FlagsSeriesDragDropGuideBox();
		...
		/// </summary>
		public FlagsSeriesDragDropDragHandle DragHandle { get; set; }
		private FlagsSeriesDragDropDragHandle DragHandle_DefaultValue { get; set; }
		...
		/// </summary>
		public FlagsSeriesDragDropGuideBox GuideBox { get; set; }
		private FlagsSeriesDragDropGuideBox GuideBox_DefaultValue { get; set; }
