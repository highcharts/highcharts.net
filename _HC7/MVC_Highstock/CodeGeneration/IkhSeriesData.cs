...
{
	public partial class IkhSeriesData  : BaseObject
	{
		public IkhSeriesData()
		{
			...
			DragDrop = DragDrop_DefaultValue = new IkhSeriesDataDragDrop();
			Drilldown = Drilldown_DefaultValue = "";
			Events = Events_DefaultValue = new IkhSeriesDataEvents();
			Id = Id_DefaultValue = "";
			Labelrank = Labelrank_DefaultValue = null;
			Marker = Marker_DefaultValue = new IkhSeriesDataMarker();
		...
		/// </summary>
		public IkhSeriesDataDragDrop DragDrop { get; set; }
		private IkhSeriesDataDragDrop DragDrop_DefaultValue { get; set; }
		...
		/// </summary>
		public IkhSeriesDataEvents Events { get; set; }
		private IkhSeriesDataEvents Events_DefaultValue { get; set; }
		...
		/// 
		/// </summary>
		public IkhSeriesDataMarker Marker { get; set; }
		private IkhSeriesDataMarker Marker_DefaultValue { get; set; }
