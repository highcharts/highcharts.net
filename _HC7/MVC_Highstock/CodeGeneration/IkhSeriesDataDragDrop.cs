...
{
	public partial class IkhSeriesDataDragDrop  : BaseObject
	{
		public IkhSeriesDataDragDrop()
		{
			DraggableX = DraggableX_DefaultValue = null;
			DraggableY = DraggableY_DefaultValue = null;
			DragHandle = DragHandle_DefaultValue = new IkhSeriesDataDragDropDragHandle();
			...
			GuideBox = GuideBox_DefaultValue = new IkhSeriesDataDragDropGuideBox();
		...
		/// </summary>
		public IkhSeriesDataDragDropDragHandle DragHandle { get; set; }
		private IkhSeriesDataDragDropDragHandle DragHandle_DefaultValue { get; set; }
		...
		/// </summary>
		public IkhSeriesDataDragDropGuideBox GuideBox { get; set; }
		private IkhSeriesDataDragDropGuideBox GuideBox_DefaultValue { get; set; }
