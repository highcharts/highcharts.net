...
{
	public partial class KeltnerchannelsSeriesDataGrouping  : BaseObject
	{
		public KeltnerchannelsSeriesDataGrouping()
		{
			Approximation = Approximation_DefaultValue = KeltnerchannelsSeriesDataGroupingApproximation.Null;
		...
		/// </summary>
		public KeltnerchannelsSeriesDataGroupingApproximation Approximation { get; set; }
		private KeltnerchannelsSeriesDataGroupingApproximation Approximation_DefaultValue { get; set; }
