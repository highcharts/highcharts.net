...
namespace Highsoft.Web.Mvc.Stocks
{
	public partial class KeltnerchannelsSeriesDataLabels  : BaseObject
	{
		public KeltnerchannelsSeriesDataLabels()
		{
			...
			Style = Style_DefaultValue = new KeltnerchannelsSeriesDataLabelsStyle();
		...
		/// </summary>
		public KeltnerchannelsSeriesDataLabelsStyle Style { get; set; }
		private KeltnerchannelsSeriesDataLabelsStyle Style_DefaultValue { get; set; }
