...
{
	public partial class KeltnerchannelsSeriesDragDropDragHandle  : BaseObject
	{
		public KeltnerchannelsSeriesDragDropDragHandle()
		{
		...
		internal override Hashtable ToHashtable()
		{
			...
			if (PathFormatter != PathFormatter_DefaultValue) { h.Add("pathFormatter",PathFormatter); Highstock.AddFunction("KeltnerchannelsSeriesDragDropDragHandlePathFormatter.pathFormatter", PathFormatter); }  
