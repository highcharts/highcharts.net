...
namespace Highsoft.Web.Mvc.Stocks
{
	public partial class LegendBubbleLegend  : BaseObject
	{
		public LegendBubbleLegend()
		{
			...
			ConnectorClassName = ConnectorClassName_DefaultValue = "";
			...
			SizeBy = SizeBy_DefaultValue = LegendBubbleLegendSizeBy.Area;
		...
		/// <summary>
		/// The width of the ranges borders in pixels, can be also definedfor an individual range.
		/// </summary>
		...
		/// <summary>
		/// An additional class name to apply to the bubble legend' circlegraphical elements. This option does not replace default classnames of the graphical element.
		/// </summary>
		...
		/// <summary>
		/// Miximum bubble legend range size. If values for ranges are notspecified, the `minSize` and the `maxSize` are calculated frombubble series.
		/// </summary>
		...
		/// <summary>
		/// Minimum bubble legend range size. If values for ranges are notspecified, the `minSize` and the `maxSize` are calculated frombubble series.
		/// </summary>
		...
		/// <summary>
		/// Options for specific range. One range consists of bubble, labeland connector.
		/// </summary>
		...
		/// <summary>
		/// Whether the bubble legend range value should be represented bythe area or the width of the bubble. The default, area,corresponds best to the human perception of the size of eachbubble.
		/// </summary>
		public LegendBubbleLegendSizeBy SizeBy { get; set; }
		private LegendBubbleLegendSizeBy SizeBy_DefaultValue { get; set; }
		 

		/// <summary>
		/// When this is true, the absolute value of z determines the size ofthe bubble. This means that with the default zThreshold of 0, abubble of value -1 will have the same size as a bubble of value1, while a bubble of value 0 will have a smaller size accordingto minSize.
		/// </summary>
