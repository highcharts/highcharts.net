...
{
	public partial class LinearregressionSeriesDataGrouping  : BaseObject
	{
		public LinearregressionSeriesDataGrouping()
		{
			Approximation = Approximation_DefaultValue = LinearregressionSeriesDataGroupingApproximation.Null;
		...
		/// </summary>
		public LinearregressionSeriesDataGroupingApproximation Approximation { get; set; }
		private LinearregressionSeriesDataGroupingApproximation Approximation_DefaultValue { get; set; }
