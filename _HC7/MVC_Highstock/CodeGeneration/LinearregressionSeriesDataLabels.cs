...
namespace Highsoft.Web.Mvc.Stocks
{
	public partial class LinearregressionSeriesDataLabels  : BaseObject
	{
		public LinearregressionSeriesDataLabels()
		{
			...
			Style = Style_DefaultValue = new LinearregressionSeriesDataLabelsStyle();
		...
		/// </summary>
		public LinearregressionSeriesDataLabelsStyle Style { get; set; }
		private LinearregressionSeriesDataLabelsStyle Style_DefaultValue { get; set; }
