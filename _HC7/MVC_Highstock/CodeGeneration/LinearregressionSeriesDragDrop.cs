...
{
	public partial class LinearregressionSeriesDragDrop  : BaseObject
	{
		public LinearregressionSeriesDragDrop()
		{
			DraggableX = DraggableX_DefaultValue = null;
			DraggableY = DraggableY_DefaultValue = null;
			DragHandle = DragHandle_DefaultValue = new LinearregressionSeriesDragDropDragHandle();
			...
			GuideBox = GuideBox_DefaultValue = new LinearregressionSeriesDragDropGuideBox();
		...
		/// </summary>
		public LinearregressionSeriesDragDropDragHandle DragHandle { get; set; }
		private LinearregressionSeriesDragDropDragHandle DragHandle_DefaultValue { get; set; }
		...
		/// </summary>
		public LinearregressionSeriesDragDropGuideBox GuideBox { get; set; }
		private LinearregressionSeriesDragDropGuideBox GuideBox_DefaultValue { get; set; }
