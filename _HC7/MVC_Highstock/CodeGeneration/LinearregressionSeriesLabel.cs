...
{
	public partial class LinearregressionSeriesLabel  : BaseObject
	{
		public LinearregressionSeriesLabel()
		{
			...
			Style = Style_DefaultValue = new LinearregressionSeriesLabelStyle();
		...
		/// </summary>
		public LinearregressionSeriesLabelStyle Style { get; set; }
		private LinearregressionSeriesLabelStyle Style_DefaultValue { get; set; }
