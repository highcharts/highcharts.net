...
{
	public partial class LinearregressionangleSeriesDataGrouping  : BaseObject
	{
		public LinearregressionangleSeriesDataGrouping()
		{
			Approximation = Approximation_DefaultValue = LinearregressionangleSeriesDataGroupingApproximation.Null;
		...
		/// </summary>
		public LinearregressionangleSeriesDataGroupingApproximation Approximation { get; set; }
		private LinearregressionangleSeriesDataGroupingApproximation Approximation_DefaultValue { get; set; }
