...
namespace Highsoft.Web.Mvc.Stocks
{
	public partial class LinearregressionangleSeriesDataLabels  : BaseObject
	{
		public LinearregressionangleSeriesDataLabels()
		{
			...
			Style = Style_DefaultValue = new LinearregressionangleSeriesDataLabelsStyle();
		...
		/// </summary>
		public LinearregressionangleSeriesDataLabelsStyle Style { get; set; }
		private LinearregressionangleSeriesDataLabelsStyle Style_DefaultValue { get; set; }
