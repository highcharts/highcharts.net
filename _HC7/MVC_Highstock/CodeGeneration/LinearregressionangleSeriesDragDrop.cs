...
{
	public partial class LinearregressionangleSeriesDragDrop  : BaseObject
	{
		public LinearregressionangleSeriesDragDrop()
		{
			DraggableX = DraggableX_DefaultValue = null;
			DraggableY = DraggableY_DefaultValue = null;
			DragHandle = DragHandle_DefaultValue = new LinearregressionangleSeriesDragDropDragHandle();
			...
			GuideBox = GuideBox_DefaultValue = new LinearregressionangleSeriesDragDropGuideBox();
		...
		/// </summary>
		public LinearregressionangleSeriesDragDropDragHandle DragHandle { get; set; }
		private LinearregressionangleSeriesDragDropDragHandle DragHandle_DefaultValue { get; set; }
		...
		/// </summary>
		public LinearregressionangleSeriesDragDropGuideBox GuideBox { get; set; }
		private LinearregressionangleSeriesDragDropGuideBox GuideBox_DefaultValue { get; set; }
