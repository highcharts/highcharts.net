...
{
	public partial class LinearregressionangleSeriesDragDropDragHandle  : BaseObject
	{
		public LinearregressionangleSeriesDragDropDragHandle()
		{
		...
		internal override Hashtable ToHashtable()
		{
			...
			if (PathFormatter != PathFormatter_DefaultValue) { h.Add("pathFormatter",PathFormatter); Highstock.AddFunction("LinearregressionangleSeriesDragDropDragHandlePathFormatter.pathFormatter", PathFormatter); }  
