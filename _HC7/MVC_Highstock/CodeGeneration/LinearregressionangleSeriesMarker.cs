...
{
	public partial class LinearregressionangleSeriesMarker  : BaseObject
	{
		public LinearregressionangleSeriesMarker()
		{
			...
			States = States_DefaultValue = new LinearregressionangleSeriesMarkerStates();
		...
		/// </summary>
		public LinearregressionangleSeriesMarkerStates States { get; set; }
		private LinearregressionangleSeriesMarkerStates States_DefaultValue { get; set; }
