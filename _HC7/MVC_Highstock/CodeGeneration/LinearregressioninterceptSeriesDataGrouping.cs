...
{
	public partial class LinearregressioninterceptSeriesDataGrouping  : BaseObject
	{
		public LinearregressioninterceptSeriesDataGrouping()
		{
			Approximation = Approximation_DefaultValue = LinearregressioninterceptSeriesDataGroupingApproximation.Null;
		...
		/// </summary>
		public LinearregressioninterceptSeriesDataGroupingApproximation Approximation { get; set; }
		private LinearregressioninterceptSeriesDataGroupingApproximation Approximation_DefaultValue { get; set; }
