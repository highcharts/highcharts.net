...
namespace Highsoft.Web.Mvc.Stocks
{
	public partial class LinearregressioninterceptSeriesDataLabels  : BaseObject
	{
		public LinearregressioninterceptSeriesDataLabels()
		{
			...
			Style = Style_DefaultValue = new LinearregressioninterceptSeriesDataLabelsStyle();
		...
		/// </summary>
		public LinearregressioninterceptSeriesDataLabelsStyle Style { get; set; }
		private LinearregressioninterceptSeriesDataLabelsStyle Style_DefaultValue { get; set; }
