...
{
	public partial class LinearregressioninterceptSeriesDragDrop  : BaseObject
	{
		public LinearregressioninterceptSeriesDragDrop()
		{
			DraggableX = DraggableX_DefaultValue = null;
			DraggableY = DraggableY_DefaultValue = null;
			DragHandle = DragHandle_DefaultValue = new LinearregressioninterceptSeriesDragDropDragHandle();
			...
			GuideBox = GuideBox_DefaultValue = new LinearregressioninterceptSeriesDragDropGuideBox();
		...
		/// </summary>
		public LinearregressioninterceptSeriesDragDropDragHandle DragHandle { get; set; }
		private LinearregressioninterceptSeriesDragDropDragHandle DragHandle_DefaultValue { get; set; }
		...
		/// </summary>
		public LinearregressioninterceptSeriesDragDropGuideBox GuideBox { get; set; }
		private LinearregressioninterceptSeriesDragDropGuideBox GuideBox_DefaultValue { get; set; }
