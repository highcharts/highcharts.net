...
{
	public partial class LinearregressioninterceptSeriesLabel  : BaseObject
	{
		public LinearregressioninterceptSeriesLabel()
		{
			...
			Style = Style_DefaultValue = new LinearregressioninterceptSeriesLabelStyle();
		...
		/// </summary>
		public LinearregressioninterceptSeriesLabelStyle Style { get; set; }
		private LinearregressioninterceptSeriesLabelStyle Style_DefaultValue { get; set; }
