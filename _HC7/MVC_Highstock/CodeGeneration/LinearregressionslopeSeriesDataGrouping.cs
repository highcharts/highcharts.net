...
{
	public partial class LinearregressionslopeSeriesDataGrouping  : BaseObject
	{
		public LinearregressionslopeSeriesDataGrouping()
		{
			Approximation = Approximation_DefaultValue = LinearregressionslopeSeriesDataGroupingApproximation.Null;
		...
		/// </summary>
		public LinearregressionslopeSeriesDataGroupingApproximation Approximation { get; set; }
		private LinearregressionslopeSeriesDataGroupingApproximation Approximation_DefaultValue { get; set; }
