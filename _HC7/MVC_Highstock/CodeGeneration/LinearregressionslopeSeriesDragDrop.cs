...
{
	public partial class LinearregressionslopeSeriesDragDrop  : BaseObject
	{
		public LinearregressionslopeSeriesDragDrop()
		{
			DraggableX = DraggableX_DefaultValue = null;
			DraggableY = DraggableY_DefaultValue = null;
			DragHandle = DragHandle_DefaultValue = new LinearregressionslopeSeriesDragDropDragHandle();
			...
			GuideBox = GuideBox_DefaultValue = new LinearregressionslopeSeriesDragDropGuideBox();
		...
		/// </summary>
		public LinearregressionslopeSeriesDragDropDragHandle DragHandle { get; set; }
		private LinearregressionslopeSeriesDragDropDragHandle DragHandle_DefaultValue { get; set; }
		...
		/// </summary>
		public LinearregressionslopeSeriesDragDropGuideBox GuideBox { get; set; }
		private LinearregressionslopeSeriesDragDropGuideBox GuideBox_DefaultValue { get; set; }
