...
{
	public partial class LinearregressionslopeSeriesDragDropDragHandle  : BaseObject
	{
		public LinearregressionslopeSeriesDragDropDragHandle()
		{
		...
		internal override Hashtable ToHashtable()
		{
			...
			if (PathFormatter != PathFormatter_DefaultValue) { h.Add("pathFormatter",PathFormatter); Highstock.AddFunction("LinearregressionslopeSeriesDragDropDragHandlePathFormatter.pathFormatter", PathFormatter); }  
