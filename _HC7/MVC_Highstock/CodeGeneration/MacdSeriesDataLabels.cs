...
namespace Highsoft.Web.Mvc.Stocks
{
	public partial class MacdSeriesDataLabels  : BaseObject
	{
		public MacdSeriesDataLabels()
		{
			...
			Style = Style_DefaultValue = new MacdSeriesDataLabelsStyle();
		...
		/// </summary>
		public MacdSeriesDataLabelsStyle Style { get; set; }
		private MacdSeriesDataLabelsStyle Style_DefaultValue { get; set; }
