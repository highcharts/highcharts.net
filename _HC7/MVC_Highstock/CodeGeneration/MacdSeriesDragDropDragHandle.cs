...
{
	public partial class MacdSeriesDragDropDragHandle  : BaseObject
	{
		public MacdSeriesDragDropDragHandle()
		{
		...
		internal override Hashtable ToHashtable()
		{
			...
			if (PathFormatter != PathFormatter_DefaultValue) { h.Add("pathFormatter",PathFormatter); Highstock.AddFunction("MacdSeriesDragDropDragHandlePathFormatter.pathFormatter", PathFormatter); }  
