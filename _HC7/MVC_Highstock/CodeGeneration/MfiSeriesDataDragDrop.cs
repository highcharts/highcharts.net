...
{
	public partial class MfiSeriesDataDragDrop  : BaseObject
	{
		public MfiSeriesDataDragDrop()
		{
			DraggableX = DraggableX_DefaultValue = null;
			DraggableY = DraggableY_DefaultValue = null;
			DragHandle = DragHandle_DefaultValue = new MfiSeriesDataDragDropDragHandle();
			...
			GuideBox = GuideBox_DefaultValue = new MfiSeriesDataDragDropGuideBox();
		...
		/// </summary>
		public MfiSeriesDataDragDropDragHandle DragHandle { get; set; }
		private MfiSeriesDataDragDropDragHandle DragHandle_DefaultValue { get; set; }
		...
		/// </summary>
		public MfiSeriesDataDragDropGuideBox GuideBox { get; set; }
		private MfiSeriesDataDragDropGuideBox GuideBox_DefaultValue { get; set; }
