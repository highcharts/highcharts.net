...
{
	public partial class MfiSeriesDataMarker  : BaseObject
	{
		public MfiSeriesDataMarker()
		{
			...
			States = States_DefaultValue = new MfiSeriesDataMarkerStates();
		...
		/// </summary>
		public MfiSeriesDataMarkerStates States { get; set; }
		private MfiSeriesDataMarkerStates States_DefaultValue { get; set; }
