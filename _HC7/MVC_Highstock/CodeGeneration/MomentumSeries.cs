...
namespace Highsoft.Web.Mvc.Stocks
{
	public partial class MomentumSeries  : Series
	{
		public MomentumSeries()
		{
			...
			Data = Data_DefaultValue = new List<MomentumSeriesData>();
		...
		/// 
		/// </summary>
		public List<MomentumSeriesData> Data { get; set; }
		private List<MomentumSeriesData> Data_DefaultValue { get; set; }
