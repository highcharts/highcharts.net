...
{
	public partial class MomentumSeriesDataDragDrop  : BaseObject
	{
		public MomentumSeriesDataDragDrop()
		{
			DraggableX = DraggableX_DefaultValue = null;
			DraggableY = DraggableY_DefaultValue = null;
			DragHandle = DragHandle_DefaultValue = new MomentumSeriesDataDragDropDragHandle();
			...
			GuideBox = GuideBox_DefaultValue = new MomentumSeriesDataDragDropGuideBox();
		...
		/// </summary>
		public MomentumSeriesDataDragDropDragHandle DragHandle { get; set; }
		private MomentumSeriesDataDragDropDragHandle DragHandle_DefaultValue { get; set; }
		...
		/// </summary>
		public MomentumSeriesDataDragDropGuideBox GuideBox { get; set; }
		private MomentumSeriesDataDragDropGuideBox GuideBox_DefaultValue { get; set; }
