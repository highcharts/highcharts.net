...
{
	public partial class MomentumSeriesDragDropDragHandle  : BaseObject
	{
		public MomentumSeriesDragDropDragHandle()
		{
		...
		internal override Hashtable ToHashtable()
		{
			...
			if (PathFormatter != PathFormatter_DefaultValue) { h.Add("pathFormatter",PathFormatter); Highstock.AddFunction("MomentumSeriesDragDropDragHandlePathFormatter.pathFormatter", PathFormatter); }  
