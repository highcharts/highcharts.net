...
{
	public partial class MomentumSeriesLabel  : BaseObject
	{
		public MomentumSeriesLabel()
		{
			...
			Style = Style_DefaultValue = new MomentumSeriesLabelStyle();
		...
		/// </summary>
		public MomentumSeriesLabelStyle Style { get; set; }
		private MomentumSeriesLabelStyle Style_DefaultValue { get; set; }
