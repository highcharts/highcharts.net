...
{
	public partial class NatrSeriesDataGrouping  : BaseObject
	{
		public NatrSeriesDataGrouping()
		{
			Approximation = Approximation_DefaultValue = NatrSeriesDataGroupingApproximation.Null;
		...
		/// </summary>
		public NatrSeriesDataGroupingApproximation Approximation { get; set; }
		private NatrSeriesDataGroupingApproximation Approximation_DefaultValue { get; set; }
