...
namespace Highsoft.Web.Mvc.Stocks
{
	public partial class NatrSeriesDataLabels  : BaseObject
	{
		public NatrSeriesDataLabels()
		{
			...
			Style = Style_DefaultValue = new NatrSeriesDataLabelsStyle();
		...
		/// </summary>
		public NatrSeriesDataLabelsStyle Style { get; set; }
		private NatrSeriesDataLabelsStyle Style_DefaultValue { get; set; }
