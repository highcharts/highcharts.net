...
{
	public partial class NatrSeriesDragDrop  : BaseObject
	{
		public NatrSeriesDragDrop()
		{
			DraggableX = DraggableX_DefaultValue = null;
			DraggableY = DraggableY_DefaultValue = null;
			DragHandle = DragHandle_DefaultValue = new NatrSeriesDragDropDragHandle();
			...
			GuideBox = GuideBox_DefaultValue = new NatrSeriesDragDropGuideBox();
		...
		/// </summary>
		public NatrSeriesDragDropDragHandle DragHandle { get; set; }
		private NatrSeriesDragDropDragHandle DragHandle_DefaultValue { get; set; }
		...
		/// </summary>
		public NatrSeriesDragDropGuideBox GuideBox { get; set; }
		private NatrSeriesDragDropGuideBox GuideBox_DefaultValue { get; set; }
