...
{
	public partial class OhlcSeriesDataDragDropDragHandle  : BaseObject
	{
		public OhlcSeriesDataDragDropDragHandle()
		{
		...
		internal override Hashtable ToHashtable()
		{
			...
			if (PathFormatter != PathFormatter_DefaultValue) { h.Add("pathFormatter",PathFormatter); Highstock.AddFunction("OhlcSeriesDataDragDropDragHandlePathFormatter.pathFormatter", PathFormatter); }  
