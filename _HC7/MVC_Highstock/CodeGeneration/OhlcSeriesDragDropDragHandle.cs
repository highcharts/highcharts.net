...
{
	public partial class OhlcSeriesDragDropDragHandle  : BaseObject
	{
		public OhlcSeriesDragDropDragHandle()
		{
		...
		internal override Hashtable ToHashtable()
		{
			...
			if (PathFormatter != PathFormatter_DefaultValue) { h.Add("pathFormatter",PathFormatter); Highstock.AddFunction("OhlcSeriesDragDropDragHandlePathFormatter.pathFormatter", PathFormatter); }  
