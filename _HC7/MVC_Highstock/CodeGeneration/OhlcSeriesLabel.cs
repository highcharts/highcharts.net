...
{
	public partial class OhlcSeriesLabel  : BaseObject
	{
		public OhlcSeriesLabel()
		{
			...
			Style = Style_DefaultValue = new OhlcSeriesLabelStyle();
		...
		/// </summary>
		public OhlcSeriesLabelStyle Style { get; set; }
		private OhlcSeriesLabelStyle Style_DefaultValue { get; set; }
