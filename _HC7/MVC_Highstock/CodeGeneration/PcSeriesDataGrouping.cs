...
{
	public partial class PcSeriesDataGrouping  : BaseObject
	{
		public PcSeriesDataGrouping()
		{
			Approximation = Approximation_DefaultValue = PcSeriesDataGroupingApproximation.Null;
		...
		/// </summary>
		public PcSeriesDataGroupingApproximation Approximation { get; set; }
		private PcSeriesDataGroupingApproximation Approximation_DefaultValue { get; set; }
