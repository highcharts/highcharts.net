...
namespace Highsoft.Web.Mvc.Stocks
{
	public partial class PcSeriesDataLabels  : BaseObject
	{
		public PcSeriesDataLabels()
		{
			...
			Style = Style_DefaultValue = new PcSeriesDataLabelsStyle();
		...
		/// </summary>
		public PcSeriesDataLabelsStyle Style { get; set; }
		private PcSeriesDataLabelsStyle Style_DefaultValue { get; set; }
