...
{
	public partial class PcSeriesDragDrop  : BaseObject
	{
		public PcSeriesDragDrop()
		{
			DraggableX = DraggableX_DefaultValue = null;
			DraggableY = DraggableY_DefaultValue = null;
			DragHandle = DragHandle_DefaultValue = new PcSeriesDragDropDragHandle();
			...
			GuideBox = GuideBox_DefaultValue = new PcSeriesDragDropGuideBox();
		...
		/// </summary>
		public PcSeriesDragDropDragHandle DragHandle { get; set; }
		private PcSeriesDragDropDragHandle DragHandle_DefaultValue { get; set; }
		...
		/// </summary>
		public PcSeriesDragDropGuideBox GuideBox { get; set; }
		private PcSeriesDragDropGuideBox GuideBox_DefaultValue { get; set; }
