...
{
	public partial class PcSeriesLabel  : BaseObject
	{
		public PcSeriesLabel()
		{
			...
			Style = Style_DefaultValue = new PcSeriesLabelStyle();
		...
		/// </summary>
		public PcSeriesLabelStyle Style { get; set; }
		private PcSeriesLabelStyle Style_DefaultValue { get; set; }
