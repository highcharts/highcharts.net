...
{
	public partial class PcSeriesStatesHoverMarker  : BaseObject
	{
		public PcSeriesStatesHoverMarker()
		{
			...
			States = States_DefaultValue = new PcSeriesStatesHoverMarkerStates();
		...
		/// </summary>
		public PcSeriesStatesHoverMarkerStates States { get; set; }
		private PcSeriesStatesHoverMarkerStates States_DefaultValue { get; set; }
