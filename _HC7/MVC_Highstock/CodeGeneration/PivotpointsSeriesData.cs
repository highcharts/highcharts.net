...
{
	public partial class PivotpointsSeriesData  : BaseObject
	{
		public PivotpointsSeriesData()
		{
			...
			DragDrop = DragDrop_DefaultValue = new PivotpointsSeriesDataDragDrop();
			Drilldown = Drilldown_DefaultValue = "";
			Events = Events_DefaultValue = new PivotpointsSeriesDataEvents();
			Id = Id_DefaultValue = "";
			Labelrank = Labelrank_DefaultValue = null;
			Marker = Marker_DefaultValue = new PivotpointsSeriesDataMarker();
		...
		/// </summary>
		public PivotpointsSeriesDataDragDrop DragDrop { get; set; }
		private PivotpointsSeriesDataDragDrop DragDrop_DefaultValue { get; set; }
		...
		/// </summary>
		public PivotpointsSeriesDataEvents Events { get; set; }
		private PivotpointsSeriesDataEvents Events_DefaultValue { get; set; }
		...
		/// 
		/// </summary>
		public PivotpointsSeriesDataMarker Marker { get; set; }
		private PivotpointsSeriesDataMarker Marker_DefaultValue { get; set; }
