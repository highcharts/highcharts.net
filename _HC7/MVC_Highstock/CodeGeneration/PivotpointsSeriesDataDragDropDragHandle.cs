...
{
	public partial class PivotpointsSeriesDataDragDropDragHandle  : BaseObject
	{
		public PivotpointsSeriesDataDragDropDragHandle()
		{
		...
		internal override Hashtable ToHashtable()
		{
			...
			if (PathFormatter != PathFormatter_DefaultValue) { h.Add("pathFormatter",PathFormatter); Highstock.AddFunction("PivotpointsSeriesDataDragDropDragHandlePathFormatter.pathFormatter", PathFormatter); }  
