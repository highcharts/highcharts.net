...
{
	public partial class PivotpointsSeriesDragDropDragHandle  : BaseObject
	{
		public PivotpointsSeriesDragDropDragHandle()
		{
		...
		internal override Hashtable ToHashtable()
		{
			...
			if (PathFormatter != PathFormatter_DefaultValue) { h.Add("pathFormatter",PathFormatter); Highstock.AddFunction("PivotpointsSeriesDragDropDragHandlePathFormatter.pathFormatter", PathFormatter); }  
