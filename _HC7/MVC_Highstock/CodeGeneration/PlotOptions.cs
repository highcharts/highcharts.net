...
namespace Highsoft.Web.Mvc.Stocks
{
	public partial class PlotOptions  : BaseObject
	{
		...
		/// <summary>
		/// Acceleration bands (ABANDS). This series requires the `linkedTo` optionto be set and should be loaded after the`stock/indicators/indicators.js`.Configuration options for the series are given in three levels:1. Options for all series in a chart are defined in the   [plotOptions.series](plotOptions.series) object.2. Options for all `abands` series are defined in   [plotOptions.abands](plotOptions.abands).3. Options for one single series are given in   [the series instance array](series.abands).<pre>Highcharts.chart('container', {    plotOptions: {        series: {            // general options for all series        },        abands: {            // shared options for all abands series        }    },    series: [{        // specific options for this series instance        type: 'abands'    }]});</pre>            
		/// </summary>
		...
		/// <summary>
		/// Awesome Oscillator. This series requires the `linkedTo` option tobe set and should be loaded after the `stock/indicators/indicators.js`Configuration options for the series are given in three levels:1. Options for all series in a chart are defined in the   [plotOptions.series](plotOptions.series) object.2. Options for all `ao` series are defined in   [plotOptions.ao](plotOptions.ao).3. Options for one single series are given in   [the series instance array](series.ao).<pre>Highcharts.chart('container', {    plotOptions: {        series: {            // general options for all series        },        ao: {            // shared options for all ao series        }    },    series: [{        // specific options for this series instance        type: 'ao'    }]});</pre>            
		/// </summary>
		...
		/// <summary>
		/// Absolute Price Oscillator. This series requires the `linkedTo` option tobe set and should be loaded after the `stock/indicators/indicators.js`and `stock/indicators/ema.js`.Configuration options for the series are given in three levels:1. Options for all series in a chart are defined in the   [plotOptions.series](plotOptions.series) object.2. Options for all `apo` series are defined in   [plotOptions.apo](plotOptions.apo).3. Options for one single series are given in   [the series instance array](series.apo).<pre>Highcharts.chart('container', {    plotOptions: {        series: {            // general options for all series        },        apo: {            // shared options for all apo series        }    },    series: [{        // specific options for this series instance        type: 'apo'    }]});</pre>            
		/// </summary>
		...
		/// <summary>
		/// Aroon. This series requires the `linkedTo` option to beset and should be loaded after the `stock/indicators/indicators.js`.Configuration options for the series are given in three levels:1. Options for all series in a chart are defined in the   [plotOptions.series](plotOptions.series) object.2. Options for all `aroon` series are defined in   [plotOptions.aroon](plotOptions.aroon).3. Options for one single series are given in   [the series instance array](series.aroon).<pre>Highcharts.chart('container', {    plotOptions: {        series: {            // general options for all series        },        aroon: {            // shared options for all aroon series        }    },    series: [{        // specific options for this series instance        type: 'aroon'    }]});</pre>            
		/// </summary>
		...
		/// <summary>
		/// Normalized average true range indicator (NATR). This series requires`linkedTo` option to be set and should be loaded after the`stock/indicators/indicators.js` and `stock/indicators/ema.js`.Configuration options for the series are given in three levels:1. Options for all series in a chart are defined in the   [plotOptions.series](plotOptions.series) object.2. Options for all `dema` series are defined in   [plotOptions.dema](plotOptions.dema).3. Options for one single series are given in   [the series instance array](series.dema).<pre>Highcharts.chart('container', {    plotOptions: {        series: {            // general options for all series        },        dema: {            // shared options for all dema series        }    },    series: [{        // specific options for this series instance        type: 'dema'    }]});</pre>            
		/// </summary>
		...
		/// <summary>
		/// Detrended Price Oscillator. This series requires the `linkedTo` option tobe set and should be loaded after the `stock/indicators/indicators.js`.Configuration options for the series are given in three levels:1. Options for all series in a chart are defined in the   [plotOptions.series](plotOptions.series) object.2. Options for all `dpo` series are defined in   [plotOptions.dpo](plotOptions.dpo).3. Options for one single series are given in   [the series instance array](series.dpo).<pre>Highcharts.chart('container', {    plotOptions: {        series: {            // general options for all series        },        dpo: {            // shared options for all dpo series        }    },    series: [{        // specific options for this series instance        type: 'dpo'    }]});</pre>            
		/// </summary>
		...
		/// <summary>
		/// Keltner Channels. This series requires the `linkedTo` option to be setand should be loaded after the `stock/indicators/indicators.js`,`stock/indicators/atr.js`, and `stock/ema/.js`.Configuration options for the series are given in three levels:1. Options for all series in a chart are defined in the   [plotOptions.series](plotOptions.series) object.2. Options for all `keltnerchannels` series are defined in   [plotOptions.keltnerchannels](plotOptions.keltnerchannels).3. Options for one single series are given in   [the series instance array](series.keltnerchannels).<pre>Highcharts.chart('container', {    plotOptions: {        series: {            // general options for all series        },        keltnerchannels: {            // shared options for all keltnerchannels series        }    },    series: [{        // specific options for this series instance        type: 'keltnerchannels'    }]});</pre>            
		/// </summary>
		...
		/// <summary>
		/// Linear regression indicator. This series requires `linkedTo` option to beset.Configuration options for the series are given in three levels:1. Options for all series in a chart are defined in the   [plotOptions.series](plotOptions.series) object.2. Options for all `linearregression` series are defined in   [plotOptions.linearregression](plotOptions.linearregression).3. Options for one single series are given in   [the series instance array](series.linearregression).<pre>Highcharts.chart('container', {    plotOptions: {        series: {            // general options for all series        },        linearregression: {            // shared options for all linearregression series        }    },    series: [{        // specific options for this series instance        type: 'linearregression'    }]});</pre>            
		/// </summary>
		...
		/// <summary>
		/// Linear regression angle indicator. This series requires `linkedTo`option to be set.Configuration options for the series are given in three levels:1. Options for all series in a chart are defined in the   [plotOptions.series](plotOptions.series) object.2. Options for all `linearregressionangle` series are defined in   [plotOptions.linearregressionangle](plotOptions.linearregressionangle).3. Options for one single series are given in   [the series instance array](series.linearregressionangle).<pre>Highcharts.chart('container', {    plotOptions: {        series: {            // general options for all series        },        linearregressionangle: {            // shared options for all linearregressionangle series        }    },    series: [{        // specific options for this series instance        type: 'linearregressionangle'    }]});</pre>            
		/// </summary>
		...
		/// <summary>
		/// Linear regression intercept indicator. This series requires `linkedTo`option to be set.Configuration options for the series are given in three levels:1. Options for all series in a chart are defined in the   [plotOptions.series](plotOptions.series) object.2. Options for all `linearregressionintercept` series are defined in   [plotOptions.linearregressionintercept](plotOptions.linearregressionintercept).3. Options for one single series are given in   [the series instance array](series.linearregressionintercept).<pre>Highcharts.chart('container', {    plotOptions: {        series: {            // general options for all series        },        linearregressionintercept: {            // shared options for all linearregressionintercept series        }    },    series: [{        // specific options for this series instance        type: 'linearregressionintercept'    }]});</pre>            
		/// </summary>
		...
		/// <summary>
		/// Linear regression slope indicator. This series requires `linkedTo`option to be set.Configuration options for the series are given in three levels:1. Options for all series in a chart are defined in the   [plotOptions.series](plotOptions.series) object.2. Options for all `linearregressionslope` series are defined in   [plotOptions.linearregressionslope](plotOptions.linearregressionslope).3. Options for one single series are given in   [the series instance array](series.linearregressionslope).<pre>Highcharts.chart('container', {    plotOptions: {        series: {            // general options for all series        },        linearregressionslope: {            // shared options for all linearregressionslope series        }    },    series: [{        // specific options for this series instance        type: 'linearregressionslope'    }]});</pre>            
		/// </summary>
		...
		/// <summary>
		/// Normalized average true range indicator (NATR). This series requires`linkedTo` option to be set and should be loaded after the`stock/indicators/indicators.js` and `stock/indicators/atr.js`.Configuration options for the series are given in three levels:1. Options for all series in a chart are defined in the   [plotOptions.series](plotOptions.series) object.2. Options for all `natr` series are defined in   [plotOptions.natr](plotOptions.natr).3. Options for one single series are given in   [the series instance array](series.natr).<pre>Highcharts.chart('container', {    plotOptions: {        series: {            // general options for all series        },        natr: {            // shared options for all natr series        }    },    series: [{        // specific options for this series instance        type: 'natr'    }]});</pre>            
		/// </summary>
		...
		/// <summary>
		/// Price channel (PC). This series requires the `linkedTo` option to beset and should be loaded after the `stock/indicators/indicators.js`.Configuration options for the series are given in three levels:1. Options for all series in a chart are defined in the   [plotOptions.series](plotOptions.series) object.2. Options for all `pc` series are defined in   [plotOptions.pc](plotOptions.pc).3. Options for one single series are given in   [the series instance array](series.pc).<pre>Highcharts.chart('container', {    plotOptions: {        series: {            // general options for all series        },        pc: {            // shared options for all pc series        }    },    series: [{        // specific options for this series instance        type: 'pc'    }]});</pre>            
		/// </summary>
		...
		/// <summary>
		/// Percentage Price Oscillator. This series requires the`linkedTo` option to be set and should be loaded after the`stock/indicators/indicators.js` and `stock/indicators/ema.js`.Configuration options for the series are given in three levels:1. Options for all series in a chart are defined in the   [plotOptions.series](plotOptions.series) object.2. Options for all `ppo` series are defined in   [plotOptions.ppo](plotOptions.ppo).3. Options for one single series are given in   [the series instance array](series.ppo).<pre>Highcharts.chart('container', {    plotOptions: {        series: {            // general options for all series        },        ppo: {            // shared options for all ppo series        }    },    series: [{        // specific options for this series instance        type: 'ppo'    }]});</pre>            
		/// </summary>
		...
		/// <summary>
		/// Normalized average true range indicator (NATR). This series requires`linkedTo` option to be set and should be loaded after the`stock/indicators/indicators.js` and `stock/indicators/ema.js`.Requires `https://code.highcharts.com/stock/indicators/ema.js`.Configuration options for the series are given in three levels:1. Options for all series in a chart are defined in the   [plotOptions.series](plotOptions.series) object.2. Options for all `tema` series are defined in   [plotOptions.tema](plotOptions.tema).3. Options for one single series are given in   [the series instance array](series.tema).<pre>Highcharts.chart('container', {    plotOptions: {        series: {            // general options for all series        },        tema: {            // shared options for all tema series        }    },    series: [{        // specific options for this series instance        type: 'tema'    }]});</pre>            
		/// </summary>
		...
		/// <summary>
		/// Normalized average true range indicator (NATR). This series requires`linkedTo` option to be set.Requires https://code.highcharts.com/stock/indicators/ema.jsand https://code.highcharts.com/stock/indicators/tema.js.Configuration options for the series are given in three levels:1. Options for all series in a chart are defined in the   [plotOptions.series](plotOptions.series) object.2. Options for all `trix` series are defined in   [plotOptions.trix](plotOptions.trix).3. Options for one single series are given in   [the series instance array](series.trix).<pre>Highcharts.chart('container', {    plotOptions: {        series: {            // general options for all series        },        trix: {            // shared options for all trix series        }    },    series: [{        // specific options for this series instance        type: 'trix'    }]});</pre>            
		/// </summary>
		...
		/// <summary>
		/// Williams %R. This series requires the `linkedTo` option to beset and should be loaded after the `stock/indicators/indicators.js`.Configuration options for the series are given in three levels:1. Options for all series in a chart are defined in the   [plotOptions.series](plotOptions.series) object.2. Options for all `williamsr` series are defined in   [plotOptions.williamsr](plotOptions.williamsr).3. Options for one single series are given in   [the series instance array](series.williamsr).<pre>Highcharts.chart('container', {    plotOptions: {        series: {            // general options for all series        },        williamsr: {            // shared options for all williamsr series        }    },    series: [{        // specific options for this series instance        type: 'williamsr'    }]});</pre>            
		/// </summary>
