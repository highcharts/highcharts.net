...
namespace Highsoft.Web.Mvc.Stocks
{
	public partial class PlotOptionsAbands  : BaseObject
	{
		public PlotOptionsAbands()
		{
			...
			DashStyle = DashStyle_DefaultValue = PlotOptionsAbandsDashStyle.Solid;
			...
			DragDrop = DragDrop_DefaultValue = new PlotOptionsAbandsDragDrop();
		...
		/// </summary>
		public PlotOptionsAbandsDragDrop DragDrop { get; set; }
		private PlotOptionsAbandsDragDrop DragDrop_DefaultValue { get; set; }
		...
		internal override Hashtable ToHashtable()
		{
			...
			if (PointDescriptionFormatter != PointDescriptionFormatter_DefaultValue) { h.Add("pointDescriptionFormatter",PointDescriptionFormatter); Highstock.AddFunction("PlotOptionsAbandsPointDescriptionFormatter.pointDescriptionFormatter", PointDescriptionFormatter); }  
