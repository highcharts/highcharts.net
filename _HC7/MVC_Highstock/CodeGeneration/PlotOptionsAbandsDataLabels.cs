...
namespace Highsoft.Web.Mvc.Stocks
{
	public partial class PlotOptionsAbandsDataLabels  : BaseObject
	{
		public PlotOptionsAbandsDataLabels()
		{
			...
			Style = Style_DefaultValue = new PlotOptionsAbandsDataLabelsStyle();
		...
		/// </summary>
		public PlotOptionsAbandsDataLabelsStyle Style { get; set; }
		private PlotOptionsAbandsDataLabelsStyle Style_DefaultValue { get; set; }
