...
{
	public partial class PlotOptionsAbandsDragDrop  : BaseObject
	{
		public PlotOptionsAbandsDragDrop()
		{
			DraggableX = DraggableX_DefaultValue = null;
			DraggableY = DraggableY_DefaultValue = null;
			DragHandle = DragHandle_DefaultValue = new PlotOptionsAbandsDragDropDragHandle();
			...
			GuideBox = GuideBox_DefaultValue = new PlotOptionsAbandsDragDropGuideBox();
		...
		/// </summary>
		public PlotOptionsAbandsDragDropDragHandle DragHandle { get; set; }
		private PlotOptionsAbandsDragDropDragHandle DragHandle_DefaultValue { get; set; }
		...
		/// </summary>
		public PlotOptionsAbandsDragDropGuideBox GuideBox { get; set; }
		private PlotOptionsAbandsDragDropGuideBox GuideBox_DefaultValue { get; set; }
