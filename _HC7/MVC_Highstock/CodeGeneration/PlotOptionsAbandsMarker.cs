...
{
	public partial class PlotOptionsAbandsMarker  : BaseObject
	{
		public PlotOptionsAbandsMarker()
		{
			...
			States = States_DefaultValue = new PlotOptionsAbandsMarkerStates();
		...
		/// </summary>
		public PlotOptionsAbandsMarkerStates States { get; set; }
		private PlotOptionsAbandsMarkerStates States_DefaultValue { get; set; }
