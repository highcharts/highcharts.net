...
{
	public partial class PlotOptionsAdDragDrop  : BaseObject
	{
		public PlotOptionsAdDragDrop()
		{
			DraggableX = DraggableX_DefaultValue = null;
			DraggableY = DraggableY_DefaultValue = null;
			DragHandle = DragHandle_DefaultValue = new PlotOptionsAdDragDropDragHandle();
			...
			GuideBox = GuideBox_DefaultValue = new PlotOptionsAdDragDropGuideBox();
		...
		/// </summary>
		public PlotOptionsAdDragDropDragHandle DragHandle { get; set; }
		private PlotOptionsAdDragDropDragHandle DragHandle_DefaultValue { get; set; }
		...
		/// </summary>
		public PlotOptionsAdDragDropGuideBox GuideBox { get; set; }
		private PlotOptionsAdDragDropGuideBox GuideBox_DefaultValue { get; set; }
