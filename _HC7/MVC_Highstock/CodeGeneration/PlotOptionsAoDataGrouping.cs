...
{
	public partial class PlotOptionsAoDataGrouping  : BaseObject
	{
		public PlotOptionsAoDataGrouping()
		{
			Approximation = Approximation_DefaultValue = PlotOptionsAoDataGroupingApproximation.Null;
		...
		/// </summary>
		public PlotOptionsAoDataGroupingApproximation Approximation { get; set; }
		private PlotOptionsAoDataGroupingApproximation Approximation_DefaultValue { get; set; }
