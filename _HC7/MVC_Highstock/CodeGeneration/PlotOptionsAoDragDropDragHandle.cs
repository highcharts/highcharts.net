...
{
	public partial class PlotOptionsAoDragDropDragHandle  : BaseObject
	{
		public PlotOptionsAoDragDropDragHandle()
		{
		...
		internal override Hashtable ToHashtable()
		{
			...
			if (PathFormatter != PathFormatter_DefaultValue) { h.Add("pathFormatter",PathFormatter); Highstock.AddFunction("PlotOptionsAoDragDropDragHandlePathFormatter.pathFormatter", PathFormatter); }  
