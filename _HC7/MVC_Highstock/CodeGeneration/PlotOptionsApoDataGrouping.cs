...
{
	public partial class PlotOptionsApoDataGrouping  : BaseObject
	{
		public PlotOptionsApoDataGrouping()
		{
			Approximation = Approximation_DefaultValue = PlotOptionsApoDataGroupingApproximation.Null;
		...
		/// </summary>
		public PlotOptionsApoDataGroupingApproximation Approximation { get; set; }
		private PlotOptionsApoDataGroupingApproximation Approximation_DefaultValue { get; set; }
