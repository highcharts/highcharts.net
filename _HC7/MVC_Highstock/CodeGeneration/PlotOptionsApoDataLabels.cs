...
namespace Highsoft.Web.Mvc.Stocks
{
	public partial class PlotOptionsApoDataLabels  : BaseObject
	{
		public PlotOptionsApoDataLabels()
		{
			...
			Style = Style_DefaultValue = new PlotOptionsApoDataLabelsStyle();
		...
		/// </summary>
		public PlotOptionsApoDataLabelsStyle Style { get; set; }
		private PlotOptionsApoDataLabelsStyle Style_DefaultValue { get; set; }
