...
{
	public partial class PlotOptionsApoDragDropDragHandle  : BaseObject
	{
		public PlotOptionsApoDragDropDragHandle()
		{
		...
		internal override Hashtable ToHashtable()
		{
			...
			if (PathFormatter != PathFormatter_DefaultValue) { h.Add("pathFormatter",PathFormatter); Highstock.AddFunction("PlotOptionsApoDragDropDragHandlePathFormatter.pathFormatter", PathFormatter); }  
