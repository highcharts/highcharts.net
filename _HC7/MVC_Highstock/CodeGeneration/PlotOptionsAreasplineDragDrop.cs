...
{
	public partial class PlotOptionsAreasplineDragDrop  : BaseObject
	{
		public PlotOptionsAreasplineDragDrop()
		{
			DraggableX = DraggableX_DefaultValue = null;
			DraggableY = DraggableY_DefaultValue = null;
			DragHandle = DragHandle_DefaultValue = new PlotOptionsAreasplineDragDropDragHandle();
			...
			GuideBox = GuideBox_DefaultValue = new PlotOptionsAreasplineDragDropGuideBox();
		...
		/// </summary>
		public PlotOptionsAreasplineDragDropDragHandle DragHandle { get; set; }
		private PlotOptionsAreasplineDragDropDragHandle DragHandle_DefaultValue { get; set; }
		...
		/// </summary>
		public PlotOptionsAreasplineDragDropGuideBox GuideBox { get; set; }
		private PlotOptionsAreasplineDragDropGuideBox GuideBox_DefaultValue { get; set; }
