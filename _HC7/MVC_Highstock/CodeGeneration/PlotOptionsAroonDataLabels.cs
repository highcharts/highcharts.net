...
namespace Highsoft.Web.Mvc.Stocks
{
	public partial class PlotOptionsAroonDataLabels  : BaseObject
	{
		public PlotOptionsAroonDataLabels()
		{
			...
			Style = Style_DefaultValue = new PlotOptionsAroonDataLabelsStyle();
		...
		/// </summary>
		public PlotOptionsAroonDataLabelsStyle Style { get; set; }
		private PlotOptionsAroonDataLabelsStyle Style_DefaultValue { get; set; }
