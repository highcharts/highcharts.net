...
{
	public partial class PlotOptionsAroonDragDropDragHandle  : BaseObject
	{
		public PlotOptionsAroonDragDropDragHandle()
		{
		...
		internal override Hashtable ToHashtable()
		{
			...
			if (PathFormatter != PathFormatter_DefaultValue) { h.Add("pathFormatter",PathFormatter); Highstock.AddFunction("PlotOptionsAroonDragDropDragHandlePathFormatter.pathFormatter", PathFormatter); }  
