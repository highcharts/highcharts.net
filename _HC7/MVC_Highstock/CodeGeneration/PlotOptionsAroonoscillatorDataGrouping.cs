...
{
	public partial class PlotOptionsAroonoscillatorDataGrouping  : BaseObject
	{
		public PlotOptionsAroonoscillatorDataGrouping()
		{
			Approximation = Approximation_DefaultValue = PlotOptionsAroonoscillatorDataGroupingApproximation.Null;
		...
		/// </summary>
		public PlotOptionsAroonoscillatorDataGroupingApproximation Approximation { get; set; }
		private PlotOptionsAroonoscillatorDataGroupingApproximation Approximation_DefaultValue { get; set; }
