...
namespace Highsoft.Web.Mvc.Stocks
{
	public partial class PlotOptionsAroonoscillatorDataLabels  : BaseObject
	{
		public PlotOptionsAroonoscillatorDataLabels()
		{
			...
			Style = Style_DefaultValue = new PlotOptionsAroonoscillatorDataLabelsStyle();
		...
		/// </summary>
		public PlotOptionsAroonoscillatorDataLabelsStyle Style { get; set; }
		private PlotOptionsAroonoscillatorDataLabelsStyle Style_DefaultValue { get; set; }
