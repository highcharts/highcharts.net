...
{
	public partial class PlotOptionsAroonoscillatorDragDrop  : BaseObject
	{
		public PlotOptionsAroonoscillatorDragDrop()
		{
			DraggableX = DraggableX_DefaultValue = null;
			DraggableY = DraggableY_DefaultValue = null;
			DragHandle = DragHandle_DefaultValue = new PlotOptionsAroonoscillatorDragDropDragHandle();
			...
			GuideBox = GuideBox_DefaultValue = new PlotOptionsAroonoscillatorDragDropGuideBox();
		...
		/// </summary>
		public PlotOptionsAroonoscillatorDragDropDragHandle DragHandle { get; set; }
		private PlotOptionsAroonoscillatorDragDropDragHandle DragHandle_DefaultValue { get; set; }
		...
		/// </summary>
		public PlotOptionsAroonoscillatorDragDropGuideBox GuideBox { get; set; }
		private PlotOptionsAroonoscillatorDragDropGuideBox GuideBox_DefaultValue { get; set; }
