...
{
	public partial class PlotOptionsAroonoscillatorDragDropDragHandle  : BaseObject
	{
		public PlotOptionsAroonoscillatorDragDropDragHandle()
		{
		...
		internal override Hashtable ToHashtable()
		{
			...
			if (PathFormatter != PathFormatter_DefaultValue) { h.Add("pathFormatter",PathFormatter); Highstock.AddFunction("PlotOptionsAroonoscillatorDragDropDragHandlePathFormatter.pathFormatter", PathFormatter); }  
