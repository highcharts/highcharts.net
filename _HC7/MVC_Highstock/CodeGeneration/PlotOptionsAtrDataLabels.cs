...
namespace Highsoft.Web.Mvc.Stocks
{
	public partial class PlotOptionsAtrDataLabels  : BaseObject
	{
		public PlotOptionsAtrDataLabels()
		{
			...
			Style = Style_DefaultValue = new PlotOptionsAtrDataLabelsStyle();
		...
		/// </summary>
		public PlotOptionsAtrDataLabelsStyle Style { get; set; }
		private PlotOptionsAtrDataLabelsStyle Style_DefaultValue { get; set; }
