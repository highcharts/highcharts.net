...
{
	public partial class PlotOptionsAtrDragDrop  : BaseObject
	{
		public PlotOptionsAtrDragDrop()
		{
			DraggableX = DraggableX_DefaultValue = null;
			DraggableY = DraggableY_DefaultValue = null;
			DragHandle = DragHandle_DefaultValue = new PlotOptionsAtrDragDropDragHandle();
			...
			GuideBox = GuideBox_DefaultValue = new PlotOptionsAtrDragDropGuideBox();
		...
		/// </summary>
		public PlotOptionsAtrDragDropDragHandle DragHandle { get; set; }
		private PlotOptionsAtrDragDropDragHandle DragHandle_DefaultValue { get; set; }
		...
		/// </summary>
		public PlotOptionsAtrDragDropGuideBox GuideBox { get; set; }
		private PlotOptionsAtrDragDropGuideBox GuideBox_DefaultValue { get; set; }
