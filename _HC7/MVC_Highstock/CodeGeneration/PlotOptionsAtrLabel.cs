...
{
	public partial class PlotOptionsAtrLabel  : BaseObject
	{
		public PlotOptionsAtrLabel()
		{
			...
			Style = Style_DefaultValue = new PlotOptionsAtrLabelStyle();
		...
		/// </summary>
		public PlotOptionsAtrLabelStyle Style { get; set; }
		private PlotOptionsAtrLabelStyle Style_DefaultValue { get; set; }
