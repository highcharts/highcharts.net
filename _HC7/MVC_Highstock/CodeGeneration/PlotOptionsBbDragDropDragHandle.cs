...
{
	public partial class PlotOptionsBbDragDropDragHandle  : BaseObject
	{
		public PlotOptionsBbDragDropDragHandle()
		{
		...
		internal override Hashtable ToHashtable()
		{
			...
			if (PathFormatter != PathFormatter_DefaultValue) { h.Add("pathFormatter",PathFormatter); Highstock.AddFunction("PlotOptionsBbDragDropDragHandlePathFormatter.pathFormatter", PathFormatter); }  
