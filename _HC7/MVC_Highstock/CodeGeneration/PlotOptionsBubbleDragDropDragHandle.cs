...
namespace Highsoft.Web.Mvc.Stocks
{
	public partial class PlotOptionsBubbleDragDropDragHandle  : BaseObject
	{
		...
		internal override Hashtable ToHashtable()
		{
			...
			if (PathFormatter != PathFormatter_DefaultValue) { h.Add("pathFormatter",PathFormatter); Highstock.AddFunction("PlotOptionsBubbleDragDropDragHandlePathFormatter.pathFormatter", PathFormatter); }  
