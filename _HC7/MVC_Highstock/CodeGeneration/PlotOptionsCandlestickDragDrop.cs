...
{
	public partial class PlotOptionsCandlestickDragDrop  : BaseObject
	{
		public PlotOptionsCandlestickDragDrop()
		{
			DraggableX = DraggableX_DefaultValue = null;
			DraggableY = DraggableY_DefaultValue = null;
			DragHandle = DragHandle_DefaultValue = new PlotOptionsCandlestickDragDropDragHandle();
			...
			GuideBox = GuideBox_DefaultValue = new PlotOptionsCandlestickDragDropGuideBox();
		...
		/// </summary>
		public PlotOptionsCandlestickDragDropDragHandle DragHandle { get; set; }
		private PlotOptionsCandlestickDragDropDragHandle DragHandle_DefaultValue { get; set; }
		...
		/// </summary>
		public PlotOptionsCandlestickDragDropGuideBox GuideBox { get; set; }
		private PlotOptionsCandlestickDragDropGuideBox GuideBox_DefaultValue { get; set; }
