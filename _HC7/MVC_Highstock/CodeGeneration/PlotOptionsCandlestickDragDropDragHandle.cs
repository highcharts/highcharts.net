...
{
	public partial class PlotOptionsCandlestickDragDropDragHandle  : BaseObject
	{
		public PlotOptionsCandlestickDragDropDragHandle()
		{
		...
		internal override Hashtable ToHashtable()
		{
			...
			if (PathFormatter != PathFormatter_DefaultValue) { h.Add("pathFormatter",PathFormatter); Highstock.AddFunction("PlotOptionsCandlestickDragDropDragHandlePathFormatter.pathFormatter", PathFormatter); }  
