...
{
	public partial class PlotOptionsChaikinDataGrouping  : BaseObject
	{
		public PlotOptionsChaikinDataGrouping()
		{
			Approximation = Approximation_DefaultValue = PlotOptionsChaikinDataGroupingApproximation.Null;
		...
		/// </summary>
		public PlotOptionsChaikinDataGroupingApproximation Approximation { get; set; }
		private PlotOptionsChaikinDataGroupingApproximation Approximation_DefaultValue { get; set; }
