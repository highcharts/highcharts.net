...
namespace Highsoft.Web.Mvc.Stocks
{
	public partial class PlotOptionsChaikinDataLabels  : BaseObject
	{
		public PlotOptionsChaikinDataLabels()
		{
			...
			Style = Style_DefaultValue = new PlotOptionsChaikinDataLabelsStyle();
		...
		/// </summary>
		public PlotOptionsChaikinDataLabelsStyle Style { get; set; }
		private PlotOptionsChaikinDataLabelsStyle Style_DefaultValue { get; set; }
