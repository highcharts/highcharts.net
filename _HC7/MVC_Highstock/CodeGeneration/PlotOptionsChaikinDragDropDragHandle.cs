...
{
	public partial class PlotOptionsChaikinDragDropDragHandle  : BaseObject
	{
		public PlotOptionsChaikinDragDropDragHandle()
		{
		...
		internal override Hashtable ToHashtable()
		{
			...
			if (PathFormatter != PathFormatter_DefaultValue) { h.Add("pathFormatter",PathFormatter); Highstock.AddFunction("PlotOptionsChaikinDragDropDragHandlePathFormatter.pathFormatter", PathFormatter); }  
