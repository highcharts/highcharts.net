...
{
	public partial class PlotOptionsCmfDragDropDragHandle  : BaseObject
	{
		public PlotOptionsCmfDragDropDragHandle()
		{
		...
		internal override Hashtable ToHashtable()
		{
			...
			if (PathFormatter != PathFormatter_DefaultValue) { h.Add("pathFormatter",PathFormatter); Highstock.AddFunction("PlotOptionsCmfDragDropDragHandlePathFormatter.pathFormatter", PathFormatter); }  
