...
{
	public partial class PlotOptionsColumnpyramidDataGrouping  : BaseObject
	{
		public PlotOptionsColumnpyramidDataGrouping()
		{
			Approximation = Approximation_DefaultValue = PlotOptionsColumnpyramidDataGroupingApproximation.Null;
		...
		/// </summary>
		public PlotOptionsColumnpyramidDataGroupingApproximation Approximation { get; set; }
		private PlotOptionsColumnpyramidDataGroupingApproximation Approximation_DefaultValue { get; set; }
