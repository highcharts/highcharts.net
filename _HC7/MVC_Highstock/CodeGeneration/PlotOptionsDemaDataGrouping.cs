...
{
	public partial class PlotOptionsDemaDataGrouping  : BaseObject
	{
		public PlotOptionsDemaDataGrouping()
		{
			Approximation = Approximation_DefaultValue = PlotOptionsDemaDataGroupingApproximation.Null;
		...
		/// </summary>
		public PlotOptionsDemaDataGroupingApproximation Approximation { get; set; }
		private PlotOptionsDemaDataGroupingApproximation Approximation_DefaultValue { get; set; }
