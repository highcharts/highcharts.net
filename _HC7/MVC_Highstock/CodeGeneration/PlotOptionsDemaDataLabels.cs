...
namespace Highsoft.Web.Mvc.Stocks
{
	public partial class PlotOptionsDemaDataLabels  : BaseObject
	{
		public PlotOptionsDemaDataLabels()
		{
			...
			Style = Style_DefaultValue = new PlotOptionsDemaDataLabelsStyle();
		...
		/// </summary>
		public PlotOptionsDemaDataLabelsStyle Style { get; set; }
		private PlotOptionsDemaDataLabelsStyle Style_DefaultValue { get; set; }
