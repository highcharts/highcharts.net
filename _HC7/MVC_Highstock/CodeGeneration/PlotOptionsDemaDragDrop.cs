...
{
	public partial class PlotOptionsDemaDragDrop  : BaseObject
	{
		public PlotOptionsDemaDragDrop()
		{
			DraggableX = DraggableX_DefaultValue = null;
			DraggableY = DraggableY_DefaultValue = null;
			DragHandle = DragHandle_DefaultValue = new PlotOptionsDemaDragDropDragHandle();
			...
			GuideBox = GuideBox_DefaultValue = new PlotOptionsDemaDragDropGuideBox();
		...
		/// </summary>
		public PlotOptionsDemaDragDropDragHandle DragHandle { get; set; }
		private PlotOptionsDemaDragDropDragHandle DragHandle_DefaultValue { get; set; }
		...
		/// </summary>
		public PlotOptionsDemaDragDropGuideBox GuideBox { get; set; }
		private PlotOptionsDemaDragDropGuideBox GuideBox_DefaultValue { get; set; }
