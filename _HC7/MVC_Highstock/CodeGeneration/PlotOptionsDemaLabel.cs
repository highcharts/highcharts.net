...
{
	public partial class PlotOptionsDemaLabel  : BaseObject
	{
		public PlotOptionsDemaLabel()
		{
			...
			Style = Style_DefaultValue = new PlotOptionsDemaLabelStyle();
		...
		/// </summary>
		public PlotOptionsDemaLabelStyle Style { get; set; }
		private PlotOptionsDemaLabelStyle Style_DefaultValue { get; set; }
