...
{
	public partial class PlotOptionsDemaMarker  : BaseObject
	{
		public PlotOptionsDemaMarker()
		{
			...
			States = States_DefaultValue = new PlotOptionsDemaMarkerStates();
		...
		/// </summary>
		public PlotOptionsDemaMarkerStates States { get; set; }
		private PlotOptionsDemaMarkerStates States_DefaultValue { get; set; }
