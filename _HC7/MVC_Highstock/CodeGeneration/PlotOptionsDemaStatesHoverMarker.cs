...
{
	public partial class PlotOptionsDemaStatesHoverMarker  : BaseObject
	{
		public PlotOptionsDemaStatesHoverMarker()
		{
			...
			States = States_DefaultValue = new PlotOptionsDemaStatesHoverMarkerStates();
		...
		/// </summary>
		public PlotOptionsDemaStatesHoverMarkerStates States { get; set; }
		private PlotOptionsDemaStatesHoverMarkerStates States_DefaultValue { get; set; }
