...
{
	public partial class PlotOptionsDpoDataGrouping  : BaseObject
	{
		public PlotOptionsDpoDataGrouping()
		{
			Approximation = Approximation_DefaultValue = PlotOptionsDpoDataGroupingApproximation.Null;
		...
		/// </summary>
		public PlotOptionsDpoDataGroupingApproximation Approximation { get; set; }
		private PlotOptionsDpoDataGroupingApproximation Approximation_DefaultValue { get; set; }
