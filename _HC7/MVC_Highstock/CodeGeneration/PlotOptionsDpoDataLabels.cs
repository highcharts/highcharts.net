...
namespace Highsoft.Web.Mvc.Stocks
{
	public partial class PlotOptionsDpoDataLabels  : BaseObject
	{
		public PlotOptionsDpoDataLabels()
		{
			...
			Style = Style_DefaultValue = new PlotOptionsDpoDataLabelsStyle();
		...
		/// </summary>
		public PlotOptionsDpoDataLabelsStyle Style { get; set; }
		private PlotOptionsDpoDataLabelsStyle Style_DefaultValue { get; set; }
