...
{
	public partial class PlotOptionsDpoDragDrop  : BaseObject
	{
		public PlotOptionsDpoDragDrop()
		{
			DraggableX = DraggableX_DefaultValue = null;
			DraggableY = DraggableY_DefaultValue = null;
			DragHandle = DragHandle_DefaultValue = new PlotOptionsDpoDragDropDragHandle();
			...
			GuideBox = GuideBox_DefaultValue = new PlotOptionsDpoDragDropGuideBox();
		...
		/// </summary>
		public PlotOptionsDpoDragDropDragHandle DragHandle { get; set; }
		private PlotOptionsDpoDragDropDragHandle DragHandle_DefaultValue { get; set; }
		...
		/// </summary>
		public PlotOptionsDpoDragDropGuideBox GuideBox { get; set; }
		private PlotOptionsDpoDragDropGuideBox GuideBox_DefaultValue { get; set; }
