...
{
	public partial class PlotOptionsDpoLabel  : BaseObject
	{
		public PlotOptionsDpoLabel()
		{
			...
			Style = Style_DefaultValue = new PlotOptionsDpoLabelStyle();
		...
		/// </summary>
		public PlotOptionsDpoLabelStyle Style { get; set; }
		private PlotOptionsDpoLabelStyle Style_DefaultValue { get; set; }
