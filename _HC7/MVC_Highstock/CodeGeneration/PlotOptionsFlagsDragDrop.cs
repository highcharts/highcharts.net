...
{
	public partial class PlotOptionsFlagsDragDrop  : BaseObject
	{
		public PlotOptionsFlagsDragDrop()
		{
			DraggableX = DraggableX_DefaultValue = null;
			DraggableY = DraggableY_DefaultValue = null;
			DragHandle = DragHandle_DefaultValue = new PlotOptionsFlagsDragDropDragHandle();
			...
			GuideBox = GuideBox_DefaultValue = new PlotOptionsFlagsDragDropGuideBox();
		...
		/// </summary>
		public PlotOptionsFlagsDragDropDragHandle DragHandle { get; set; }
		private PlotOptionsFlagsDragDropDragHandle DragHandle_DefaultValue { get; set; }
		...
		/// </summary>
		public PlotOptionsFlagsDragDropGuideBox GuideBox { get; set; }
		private PlotOptionsFlagsDragDropGuideBox GuideBox_DefaultValue { get; set; }
