...
{
	public partial class PlotOptionsIkhDragDrop  : BaseObject
	{
		public PlotOptionsIkhDragDrop()
		{
			DraggableX = DraggableX_DefaultValue = null;
			DraggableY = DraggableY_DefaultValue = null;
			DragHandle = DragHandle_DefaultValue = new PlotOptionsIkhDragDropDragHandle();
			...
			GuideBox = GuideBox_DefaultValue = new PlotOptionsIkhDragDropGuideBox();
		...
		/// </summary>
		public PlotOptionsIkhDragDropDragHandle DragHandle { get; set; }
		private PlotOptionsIkhDragDropDragHandle DragHandle_DefaultValue { get; set; }
		...
		/// </summary>
		public PlotOptionsIkhDragDropGuideBox GuideBox { get; set; }
		private PlotOptionsIkhDragDropGuideBox GuideBox_DefaultValue { get; set; }
