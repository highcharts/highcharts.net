...
namespace Highsoft.Web.Mvc.Stocks
{
	public partial class PlotOptionsKeltnerchannelsDataLabels  : BaseObject
	{
		public PlotOptionsKeltnerchannelsDataLabels()
		{
			...
			Style = Style_DefaultValue = new PlotOptionsKeltnerchannelsDataLabelsStyle();
		...
		/// </summary>
		public PlotOptionsKeltnerchannelsDataLabelsStyle Style { get; set; }
		private PlotOptionsKeltnerchannelsDataLabelsStyle Style_DefaultValue { get; set; }
