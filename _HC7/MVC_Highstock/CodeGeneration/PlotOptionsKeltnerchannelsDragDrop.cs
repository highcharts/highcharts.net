...
{
	public partial class PlotOptionsKeltnerchannelsDragDrop  : BaseObject
	{
		public PlotOptionsKeltnerchannelsDragDrop()
		{
			DraggableX = DraggableX_DefaultValue = null;
			DraggableY = DraggableY_DefaultValue = null;
			DragHandle = DragHandle_DefaultValue = new PlotOptionsKeltnerchannelsDragDropDragHandle();
			...
			GuideBox = GuideBox_DefaultValue = new PlotOptionsKeltnerchannelsDragDropGuideBox();
		...
		/// </summary>
		public PlotOptionsKeltnerchannelsDragDropDragHandle DragHandle { get; set; }
		private PlotOptionsKeltnerchannelsDragDropDragHandle DragHandle_DefaultValue { get; set; }
		...
		/// </summary>
		public PlotOptionsKeltnerchannelsDragDropGuideBox GuideBox { get; set; }
		private PlotOptionsKeltnerchannelsDragDropGuideBox GuideBox_DefaultValue { get; set; }
