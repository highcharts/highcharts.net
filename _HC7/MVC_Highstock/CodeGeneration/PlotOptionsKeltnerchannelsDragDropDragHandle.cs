...
{
	public partial class PlotOptionsKeltnerchannelsDragDropDragHandle  : BaseObject
	{
		public PlotOptionsKeltnerchannelsDragDropDragHandle()
		{
		...
		internal override Hashtable ToHashtable()
		{
			...
			if (PathFormatter != PathFormatter_DefaultValue) { h.Add("pathFormatter",PathFormatter); Highstock.AddFunction("PlotOptionsKeltnerchannelsDragDropDragHandlePathFormatter.pathFormatter", PathFormatter); }  
