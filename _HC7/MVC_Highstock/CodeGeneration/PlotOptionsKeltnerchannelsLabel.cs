...
{
	public partial class PlotOptionsKeltnerchannelsLabel  : BaseObject
	{
		public PlotOptionsKeltnerchannelsLabel()
		{
			...
			Style = Style_DefaultValue = new PlotOptionsKeltnerchannelsLabelStyle();
		...
		/// </summary>
		public PlotOptionsKeltnerchannelsLabelStyle Style { get; set; }
		private PlotOptionsKeltnerchannelsLabelStyle Style_DefaultValue { get; set; }
