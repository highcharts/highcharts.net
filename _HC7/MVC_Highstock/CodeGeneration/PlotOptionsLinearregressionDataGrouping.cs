...
{
	public partial class PlotOptionsLinearregressionDataGrouping  : BaseObject
	{
		public PlotOptionsLinearregressionDataGrouping()
		{
			Approximation = Approximation_DefaultValue = PlotOptionsLinearregressionDataGroupingApproximation.Null;
		...
		/// </summary>
		public PlotOptionsLinearregressionDataGroupingApproximation Approximation { get; set; }
		private PlotOptionsLinearregressionDataGroupingApproximation Approximation_DefaultValue { get; set; }
