...
namespace Highsoft.Web.Mvc.Stocks
{
	public partial class PlotOptionsLinearregressionDataLabels  : BaseObject
	{
		public PlotOptionsLinearregressionDataLabels()
		{
			...
			Style = Style_DefaultValue = new PlotOptionsLinearregressionDataLabelsStyle();
		...
		/// </summary>
		public PlotOptionsLinearregressionDataLabelsStyle Style { get; set; }
		private PlotOptionsLinearregressionDataLabelsStyle Style_DefaultValue { get; set; }
