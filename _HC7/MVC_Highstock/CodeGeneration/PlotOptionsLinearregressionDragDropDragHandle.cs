...
{
	public partial class PlotOptionsLinearregressionDragDropDragHandle  : BaseObject
	{
		public PlotOptionsLinearregressionDragDropDragHandle()
		{
		...
		internal override Hashtable ToHashtable()
		{
			...
			if (PathFormatter != PathFormatter_DefaultValue) { h.Add("pathFormatter",PathFormatter); Highstock.AddFunction("PlotOptionsLinearregressionDragDropDragHandlePathFormatter.pathFormatter", PathFormatter); }  
