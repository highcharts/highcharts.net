...
{
	public partial class PlotOptionsLinearregressionLabel  : BaseObject
	{
		public PlotOptionsLinearregressionLabel()
		{
			...
			Style = Style_DefaultValue = new PlotOptionsLinearregressionLabelStyle();
		...
		/// </summary>
		public PlotOptionsLinearregressionLabelStyle Style { get; set; }
		private PlotOptionsLinearregressionLabelStyle Style_DefaultValue { get; set; }
