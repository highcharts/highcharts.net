...
{
	public partial class PlotOptionsLinearregressionangleDataGrouping  : BaseObject
	{
		public PlotOptionsLinearregressionangleDataGrouping()
		{
			Approximation = Approximation_DefaultValue = PlotOptionsLinearregressionangleDataGroupingApproximation.Null;
		...
		/// </summary>
		public PlotOptionsLinearregressionangleDataGroupingApproximation Approximation { get; set; }
		private PlotOptionsLinearregressionangleDataGroupingApproximation Approximation_DefaultValue { get; set; }
