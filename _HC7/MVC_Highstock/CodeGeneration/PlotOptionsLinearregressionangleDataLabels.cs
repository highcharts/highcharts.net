...
namespace Highsoft.Web.Mvc.Stocks
{
	public partial class PlotOptionsLinearregressionangleDataLabels  : BaseObject
	{
		public PlotOptionsLinearregressionangleDataLabels()
		{
			...
			Style = Style_DefaultValue = new PlotOptionsLinearregressionangleDataLabelsStyle();
		...
		/// </summary>
		public PlotOptionsLinearregressionangleDataLabelsStyle Style { get; set; }
		private PlotOptionsLinearregressionangleDataLabelsStyle Style_DefaultValue { get; set; }
