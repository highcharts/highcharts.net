...
{
	public partial class PlotOptionsLinearregressionangleDragDropDragHandle  : BaseObject
	{
		public PlotOptionsLinearregressionangleDragDropDragHandle()
		{
		...
		internal override Hashtable ToHashtable()
		{
			...
			if (PathFormatter != PathFormatter_DefaultValue) { h.Add("pathFormatter",PathFormatter); Highstock.AddFunction("PlotOptionsLinearregressionangleDragDropDragHandlePathFormatter.pathFormatter", PathFormatter); }  
