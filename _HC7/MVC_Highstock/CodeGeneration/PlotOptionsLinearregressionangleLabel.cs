...
{
	public partial class PlotOptionsLinearregressionangleLabel  : BaseObject
	{
		public PlotOptionsLinearregressionangleLabel()
		{
			...
			Style = Style_DefaultValue = new PlotOptionsLinearregressionangleLabelStyle();
		...
		/// </summary>
		public PlotOptionsLinearregressionangleLabelStyle Style { get; set; }
		private PlotOptionsLinearregressionangleLabelStyle Style_DefaultValue { get; set; }
