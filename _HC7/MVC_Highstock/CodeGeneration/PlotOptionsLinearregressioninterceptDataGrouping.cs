...
{
	public partial class PlotOptionsLinearregressioninterceptDataGrouping  : BaseObject
	{
		public PlotOptionsLinearregressioninterceptDataGrouping()
		{
			Approximation = Approximation_DefaultValue = PlotOptionsLinearregressioninterceptDataGroupingApproximation.Null;
		...
		/// </summary>
		public PlotOptionsLinearregressioninterceptDataGroupingApproximation Approximation { get; set; }
		private PlotOptionsLinearregressioninterceptDataGroupingApproximation Approximation_DefaultValue { get; set; }
