...
namespace Highsoft.Web.Mvc.Stocks
{
	public partial class PlotOptionsLinearregressioninterceptDataLabels  : BaseObject
	{
		public PlotOptionsLinearregressioninterceptDataLabels()
		{
			...
			Style = Style_DefaultValue = new PlotOptionsLinearregressioninterceptDataLabelsStyle();
		...
		/// </summary>
		public PlotOptionsLinearregressioninterceptDataLabelsStyle Style { get; set; }
		private PlotOptionsLinearregressioninterceptDataLabelsStyle Style_DefaultValue { get; set; }
