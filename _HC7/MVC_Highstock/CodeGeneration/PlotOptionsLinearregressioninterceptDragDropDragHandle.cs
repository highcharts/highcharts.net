...
{
	public partial class PlotOptionsLinearregressioninterceptDragDropDragHandle  : BaseObject
	{
		public PlotOptionsLinearregressioninterceptDragDropDragHandle()
		{
		...
		internal override Hashtable ToHashtable()
		{
			...
			if (PathFormatter != PathFormatter_DefaultValue) { h.Add("pathFormatter",PathFormatter); Highstock.AddFunction("PlotOptionsLinearregressioninterceptDragDropDragHandlePathFormatter.pathFormatter", PathFormatter); }  
