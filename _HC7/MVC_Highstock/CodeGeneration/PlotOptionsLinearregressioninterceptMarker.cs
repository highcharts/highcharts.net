...
{
	public partial class PlotOptionsLinearregressioninterceptMarker  : BaseObject
	{
		public PlotOptionsLinearregressioninterceptMarker()
		{
			...
			States = States_DefaultValue = new PlotOptionsLinearregressioninterceptMarkerStates();
		...
		/// </summary>
		public PlotOptionsLinearregressioninterceptMarkerStates States { get; set; }
		private PlotOptionsLinearregressioninterceptMarkerStates States_DefaultValue { get; set; }
