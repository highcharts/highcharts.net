...
{
	public partial class PlotOptionsLinearregressionslopeDataGrouping  : BaseObject
	{
		public PlotOptionsLinearregressionslopeDataGrouping()
		{
			Approximation = Approximation_DefaultValue = PlotOptionsLinearregressionslopeDataGroupingApproximation.Null;
		...
		/// </summary>
		public PlotOptionsLinearregressionslopeDataGroupingApproximation Approximation { get; set; }
		private PlotOptionsLinearregressionslopeDataGroupingApproximation Approximation_DefaultValue { get; set; }
