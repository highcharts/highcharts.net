...
namespace Highsoft.Web.Mvc.Stocks
{
	public partial class PlotOptionsLinearregressionslopeDataLabels  : BaseObject
	{
		public PlotOptionsLinearregressionslopeDataLabels()
		{
			...
			Style = Style_DefaultValue = new PlotOptionsLinearregressionslopeDataLabelsStyle();
		...
		/// </summary>
		public PlotOptionsLinearregressionslopeDataLabelsStyle Style { get; set; }
		private PlotOptionsLinearregressionslopeDataLabelsStyle Style_DefaultValue { get; set; }
