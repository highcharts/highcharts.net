...
{
	public partial class PlotOptionsLinearregressionslopeDragDrop  : BaseObject
	{
		public PlotOptionsLinearregressionslopeDragDrop()
		{
			DraggableX = DraggableX_DefaultValue = null;
			DraggableY = DraggableY_DefaultValue = null;
			DragHandle = DragHandle_DefaultValue = new PlotOptionsLinearregressionslopeDragDropDragHandle();
			...
			GuideBox = GuideBox_DefaultValue = new PlotOptionsLinearregressionslopeDragDropGuideBox();
		...
		/// </summary>
		public PlotOptionsLinearregressionslopeDragDropDragHandle DragHandle { get; set; }
		private PlotOptionsLinearregressionslopeDragDropDragHandle DragHandle_DefaultValue { get; set; }
		...
		/// </summary>
		public PlotOptionsLinearregressionslopeDragDropGuideBox GuideBox { get; set; }
		private PlotOptionsLinearregressionslopeDragDropGuideBox GuideBox_DefaultValue { get; set; }
