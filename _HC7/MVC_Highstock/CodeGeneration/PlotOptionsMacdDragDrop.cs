...
{
	public partial class PlotOptionsMacdDragDrop  : BaseObject
	{
		public PlotOptionsMacdDragDrop()
		{
			DraggableX = DraggableX_DefaultValue = null;
			DraggableY = DraggableY_DefaultValue = null;
			DragHandle = DragHandle_DefaultValue = new PlotOptionsMacdDragDropDragHandle();
			...
			GuideBox = GuideBox_DefaultValue = new PlotOptionsMacdDragDropGuideBox();
		...
		/// </summary>
		public PlotOptionsMacdDragDropDragHandle DragHandle { get; set; }
		private PlotOptionsMacdDragDropDragHandle DragHandle_DefaultValue { get; set; }
		...
		/// </summary>
		public PlotOptionsMacdDragDropGuideBox GuideBox { get; set; }
		private PlotOptionsMacdDragDropGuideBox GuideBox_DefaultValue { get; set; }
