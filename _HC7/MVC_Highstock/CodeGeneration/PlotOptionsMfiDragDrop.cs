...
{
	public partial class PlotOptionsMfiDragDrop  : BaseObject
	{
		public PlotOptionsMfiDragDrop()
		{
			DraggableX = DraggableX_DefaultValue = null;
			DraggableY = DraggableY_DefaultValue = null;
			DragHandle = DragHandle_DefaultValue = new PlotOptionsMfiDragDropDragHandle();
			...
			GuideBox = GuideBox_DefaultValue = new PlotOptionsMfiDragDropGuideBox();
		...
		/// </summary>
		public PlotOptionsMfiDragDropDragHandle DragHandle { get; set; }
		private PlotOptionsMfiDragDropDragHandle DragHandle_DefaultValue { get; set; }
		...
		/// </summary>
		public PlotOptionsMfiDragDropGuideBox GuideBox { get; set; }
		private PlotOptionsMfiDragDropGuideBox GuideBox_DefaultValue { get; set; }
