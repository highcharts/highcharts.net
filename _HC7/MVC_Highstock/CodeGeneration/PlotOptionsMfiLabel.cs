...
{
	public partial class PlotOptionsMfiLabel  : BaseObject
	{
		public PlotOptionsMfiLabel()
		{
			...
			Style = Style_DefaultValue = new PlotOptionsMfiLabelStyle();
		...
		/// </summary>
		public PlotOptionsMfiLabelStyle Style { get; set; }
		private PlotOptionsMfiLabelStyle Style_DefaultValue { get; set; }
