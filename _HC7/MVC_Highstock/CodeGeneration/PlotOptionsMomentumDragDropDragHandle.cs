...
{
	public partial class PlotOptionsMomentumDragDropDragHandle  : BaseObject
	{
		public PlotOptionsMomentumDragDropDragHandle()
		{
		...
		internal override Hashtable ToHashtable()
		{
			...
			if (PathFormatter != PathFormatter_DefaultValue) { h.Add("pathFormatter",PathFormatter); Highstock.AddFunction("PlotOptionsMomentumDragDropDragHandlePathFormatter.pathFormatter", PathFormatter); }  
