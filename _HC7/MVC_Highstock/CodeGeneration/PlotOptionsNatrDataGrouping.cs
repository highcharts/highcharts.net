...
{
	public partial class PlotOptionsNatrDataGrouping  : BaseObject
	{
		public PlotOptionsNatrDataGrouping()
		{
			Approximation = Approximation_DefaultValue = PlotOptionsNatrDataGroupingApproximation.Null;
		...
		/// </summary>
		public PlotOptionsNatrDataGroupingApproximation Approximation { get; set; }
		private PlotOptionsNatrDataGroupingApproximation Approximation_DefaultValue { get; set; }
