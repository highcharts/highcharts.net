...
namespace Highsoft.Web.Mvc.Stocks
{
	public partial class PlotOptionsNatrDataLabels  : BaseObject
	{
		public PlotOptionsNatrDataLabels()
		{
			...
			Style = Style_DefaultValue = new PlotOptionsNatrDataLabelsStyle();
		...
		/// </summary>
		public PlotOptionsNatrDataLabelsStyle Style { get; set; }
		private PlotOptionsNatrDataLabelsStyle Style_DefaultValue { get; set; }
