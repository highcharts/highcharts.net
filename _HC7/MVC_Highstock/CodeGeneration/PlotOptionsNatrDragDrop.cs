...
{
	public partial class PlotOptionsNatrDragDrop  : BaseObject
	{
		public PlotOptionsNatrDragDrop()
		{
			DraggableX = DraggableX_DefaultValue = null;
			DraggableY = DraggableY_DefaultValue = null;
			DragHandle = DragHandle_DefaultValue = new PlotOptionsNatrDragDropDragHandle();
			...
			GuideBox = GuideBox_DefaultValue = new PlotOptionsNatrDragDropGuideBox();
		...
		/// </summary>
		public PlotOptionsNatrDragDropDragHandle DragHandle { get; set; }
		private PlotOptionsNatrDragDropDragHandle DragHandle_DefaultValue { get; set; }
		...
		/// </summary>
		public PlotOptionsNatrDragDropGuideBox GuideBox { get; set; }
		private PlotOptionsNatrDragDropGuideBox GuideBox_DefaultValue { get; set; }
