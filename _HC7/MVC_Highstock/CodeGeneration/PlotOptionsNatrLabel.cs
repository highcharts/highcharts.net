...
{
	public partial class PlotOptionsNatrLabel  : BaseObject
	{
		public PlotOptionsNatrLabel()
		{
			...
			Style = Style_DefaultValue = new PlotOptionsNatrLabelStyle();
		...
		/// </summary>
		public PlotOptionsNatrLabelStyle Style { get; set; }
		private PlotOptionsNatrLabelStyle Style_DefaultValue { get; set; }
