...
{
	public partial class PlotOptionsOhlcDragDrop  : BaseObject
	{
		public PlotOptionsOhlcDragDrop()
		{
			DraggableClose = DraggableClose_DefaultValue = true;
			DraggableHigh = DraggableHigh_DefaultValue = true;
			DraggableLow = DraggableLow_DefaultValue = true;
			DraggableOpen = DraggableOpen_DefaultValue = true;
			DraggableX = DraggableX_DefaultValue = null;
			DraggableY = DraggableY_DefaultValue = null;
			DragHandle = DragHandle_DefaultValue = new PlotOptionsOhlcDragDropDragHandle();
		...
		/// <summary>
		/// Allow close value to be dragged individually. Requires`draggable-points` module.
		/// </summary>
		public bool? DraggableClose { get; set; }
		private bool? DraggableClose_DefaultValue { get; set; }
		...
		/// <summary>
		/// Allow open value to be dragged individually. Requires`draggable-points` module.
		/// </summary>
		public bool? DraggableOpen { get; set; }
		private bool? DraggableOpen_DefaultValue { get; set; }
		...
		/// </summary>
		public PlotOptionsOhlcDragDropDragHandle DragHandle { get; set; }
		private PlotOptionsOhlcDragDropDragHandle DragHandle_DefaultValue { get; set; }
		...
		/// </summary>
		public PlotOptionsOhlcDragDropGuideBox GuideBox { get; set; }
		private PlotOptionsOhlcDragDropGuideBox GuideBox_DefaultValue { get; set; }
		...
		internal override Hashtable ToHashtable()
		{
			...
			if (DraggableClose != DraggableClose_DefaultValue) h.Add("draggableClose",DraggableClose);
			...
			if (DraggableOpen != DraggableOpen_DefaultValue) h.Add("draggableOpen",DraggableOpen);
			...
			if (GuideBox.IsDirty()) h.Add("guideBox",GuideBox.ToHashtable());
