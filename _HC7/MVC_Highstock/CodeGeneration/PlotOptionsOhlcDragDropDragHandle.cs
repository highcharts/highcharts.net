...
{
	public partial class PlotOptionsOhlcDragDropDragHandle  : BaseObject
	{
		public PlotOptionsOhlcDragDropDragHandle()
		{
		...
		internal override Hashtable ToHashtable()
		{
			...
			if (PathFormatter != PathFormatter_DefaultValue) { h.Add("pathFormatter",PathFormatter); Highstock.AddFunction("PlotOptionsOhlcDragDropDragHandlePathFormatter.pathFormatter", PathFormatter); }  
