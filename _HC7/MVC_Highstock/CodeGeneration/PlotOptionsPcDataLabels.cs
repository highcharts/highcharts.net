...
namespace Highsoft.Web.Mvc.Stocks
{
	public partial class PlotOptionsPcDataLabels  : BaseObject
	{
		public PlotOptionsPcDataLabels()
		{
			...
			Style = Style_DefaultValue = new PlotOptionsPcDataLabelsStyle();
		...
		/// </summary>
		public PlotOptionsPcDataLabelsStyle Style { get; set; }
		private PlotOptionsPcDataLabelsStyle Style_DefaultValue { get; set; }
