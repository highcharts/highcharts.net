...
{
	public partial class PlotOptionsPcDragDrop  : BaseObject
	{
		public PlotOptionsPcDragDrop()
		{
			DraggableX = DraggableX_DefaultValue = null;
			DraggableY = DraggableY_DefaultValue = null;
			DragHandle = DragHandle_DefaultValue = new PlotOptionsPcDragDropDragHandle();
			...
			GuideBox = GuideBox_DefaultValue = new PlotOptionsPcDragDropGuideBox();
		...
		/// </summary>
		public PlotOptionsPcDragDropDragHandle DragHandle { get; set; }
		private PlotOptionsPcDragDropDragHandle DragHandle_DefaultValue { get; set; }
		...
		/// </summary>
		public PlotOptionsPcDragDropGuideBox GuideBox { get; set; }
		private PlotOptionsPcDragDropGuideBox GuideBox_DefaultValue { get; set; }
