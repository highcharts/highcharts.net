...
{
	public partial class PlotOptionsPcDragDropDragHandle  : BaseObject
	{
		public PlotOptionsPcDragDropDragHandle()
		{
		...
		internal override Hashtable ToHashtable()
		{
			...
			if (PathFormatter != PathFormatter_DefaultValue) { h.Add("pathFormatter",PathFormatter); Highstock.AddFunction("PlotOptionsPcDragDropDragHandlePathFormatter.pathFormatter", PathFormatter); }  
