...
{
	public partial class PlotOptionsPcLabel  : BaseObject
	{
		public PlotOptionsPcLabel()
		{
			...
			Style = Style_DefaultValue = new PlotOptionsPcLabelStyle();
		...
		/// </summary>
		public PlotOptionsPcLabelStyle Style { get; set; }
		private PlotOptionsPcLabelStyle Style_DefaultValue { get; set; }
