...
{
	public partial class PlotOptionsPcStatesHoverMarker  : BaseObject
	{
		public PlotOptionsPcStatesHoverMarker()
		{
			...
			States = States_DefaultValue = new PlotOptionsPcStatesHoverMarkerStates();
		...
		/// </summary>
		public PlotOptionsPcStatesHoverMarkerStates States { get; set; }
		private PlotOptionsPcStatesHoverMarkerStates States_DefaultValue { get; set; }
