...
{
	public partial class PlotOptionsPivotpointsDragDropDragHandle  : BaseObject
	{
		public PlotOptionsPivotpointsDragDropDragHandle()
		{
		...
		internal override Hashtable ToHashtable()
		{
			...
			if (PathFormatter != PathFormatter_DefaultValue) { h.Add("pathFormatter",PathFormatter); Highstock.AddFunction("PlotOptionsPivotpointsDragDropDragHandlePathFormatter.pathFormatter", PathFormatter); }  
