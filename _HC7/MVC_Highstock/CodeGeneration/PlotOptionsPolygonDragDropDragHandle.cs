...
namespace Highsoft.Web.Mvc.Stocks
{
	public partial class PlotOptionsPolygonDragDropDragHandle  : BaseObject
	{
		...
		internal override Hashtable ToHashtable()
		{
			...
			if (PathFormatter != PathFormatter_DefaultValue) { h.Add("pathFormatter",PathFormatter); Highstock.AddFunction("PlotOptionsPolygonDragDropDragHandlePathFormatter.pathFormatter", PathFormatter); }  
