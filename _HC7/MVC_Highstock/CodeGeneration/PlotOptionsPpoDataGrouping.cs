...
{
	public partial class PlotOptionsPpoDataGrouping  : BaseObject
	{
		public PlotOptionsPpoDataGrouping()
		{
			Approximation = Approximation_DefaultValue = PlotOptionsPpoDataGroupingApproximation.Null;
		...
		/// </summary>
		public PlotOptionsPpoDataGroupingApproximation Approximation { get; set; }
		private PlotOptionsPpoDataGroupingApproximation Approximation_DefaultValue { get; set; }
