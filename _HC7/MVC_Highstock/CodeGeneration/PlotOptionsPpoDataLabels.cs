...
namespace Highsoft.Web.Mvc.Stocks
{
	public partial class PlotOptionsPpoDataLabels  : BaseObject
	{
		public PlotOptionsPpoDataLabels()
		{
			...
			Style = Style_DefaultValue = new PlotOptionsPpoDataLabelsStyle();
		...
		/// </summary>
		public PlotOptionsPpoDataLabelsStyle Style { get; set; }
		private PlotOptionsPpoDataLabelsStyle Style_DefaultValue { get; set; }
