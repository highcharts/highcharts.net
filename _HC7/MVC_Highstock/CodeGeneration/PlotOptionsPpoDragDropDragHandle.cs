...
{
	public partial class PlotOptionsPpoDragDropDragHandle  : BaseObject
	{
		public PlotOptionsPpoDragDropDragHandle()
		{
		...
		internal override Hashtable ToHashtable()
		{
			...
			if (PathFormatter != PathFormatter_DefaultValue) { h.Add("pathFormatter",PathFormatter); Highstock.AddFunction("PlotOptionsPpoDragDropDragHandlePathFormatter.pathFormatter", PathFormatter); }  
