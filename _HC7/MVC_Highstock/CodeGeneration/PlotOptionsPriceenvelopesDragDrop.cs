...
{
	public partial class PlotOptionsPriceenvelopesDragDrop  : BaseObject
	{
		public PlotOptionsPriceenvelopesDragDrop()
		{
			DraggableX = DraggableX_DefaultValue = null;
			DraggableY = DraggableY_DefaultValue = null;
			DragHandle = DragHandle_DefaultValue = new PlotOptionsPriceenvelopesDragDropDragHandle();
			...
			GuideBox = GuideBox_DefaultValue = new PlotOptionsPriceenvelopesDragDropGuideBox();
		...
		/// </summary>
		public PlotOptionsPriceenvelopesDragDropDragHandle DragHandle { get; set; }
		private PlotOptionsPriceenvelopesDragDropDragHandle DragHandle_DefaultValue { get; set; }
		...
		/// </summary>
		public PlotOptionsPriceenvelopesDragDropGuideBox GuideBox { get; set; }
		private PlotOptionsPriceenvelopesDragDropGuideBox GuideBox_DefaultValue { get; set; }
