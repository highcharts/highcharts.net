...
{
	public partial class PlotOptionsRocDragDrop  : BaseObject
	{
		public PlotOptionsRocDragDrop()
		{
			DraggableX = DraggableX_DefaultValue = null;
			DraggableY = DraggableY_DefaultValue = null;
			DragHandle = DragHandle_DefaultValue = new PlotOptionsRocDragDropDragHandle();
			...
			GuideBox = GuideBox_DefaultValue = new PlotOptionsRocDragDropGuideBox();
		...
		/// </summary>
		public PlotOptionsRocDragDropDragHandle DragHandle { get; set; }
		private PlotOptionsRocDragDropDragHandle DragHandle_DefaultValue { get; set; }
		...
		/// </summary>
		public PlotOptionsRocDragDropGuideBox GuideBox { get; set; }
		private PlotOptionsRocDragDropGuideBox GuideBox_DefaultValue { get; set; }
