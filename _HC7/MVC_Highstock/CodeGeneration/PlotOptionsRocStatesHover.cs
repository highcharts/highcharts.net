...
{
	public partial class PlotOptionsRocStatesHover  : BaseObject
	{
		public PlotOptionsRocStatesHover()
		{
			Enabled = Enabled_DefaultValue = true;
			Halo = Halo_DefaultValue = new PlotOptionsRocStatesHoverHalo();
			LineWidth = LineWidth_DefaultValue = null;
			LineWidthPlus = LineWidthPlus_DefaultValue = 1;
			Marker = Marker_DefaultValue = new PlotOptionsRocStatesHoverMarker();
		...
		/// </summary>
		public PlotOptionsRocStatesHoverHalo Halo { get; set; }
		private PlotOptionsRocStatesHoverHalo Halo_DefaultValue { get; set; }
		...
		/// </summary>
		public PlotOptionsRocStatesHoverMarker Marker { get; set; }
		private PlotOptionsRocStatesHoverMarker Marker_DefaultValue { get; set; }
