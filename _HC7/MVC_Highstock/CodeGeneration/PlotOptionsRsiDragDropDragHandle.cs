...
{
	public partial class PlotOptionsRsiDragDropDragHandle  : BaseObject
	{
		public PlotOptionsRsiDragDropDragHandle()
		{
		...
		internal override Hashtable ToHashtable()
		{
			...
			if (PathFormatter != PathFormatter_DefaultValue) { h.Add("pathFormatter",PathFormatter); Highstock.AddFunction("PlotOptionsRsiDragDropDragHandlePathFormatter.pathFormatter", PathFormatter); }  
