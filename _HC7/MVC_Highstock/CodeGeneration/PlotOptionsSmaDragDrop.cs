...
{
	public partial class PlotOptionsSmaDragDrop  : BaseObject
	{
		public PlotOptionsSmaDragDrop()
		{
			DraggableX = DraggableX_DefaultValue = null;
			DraggableY = DraggableY_DefaultValue = null;
			DragHandle = DragHandle_DefaultValue = new PlotOptionsSmaDragDropDragHandle();
			...
			GuideBox = GuideBox_DefaultValue = new PlotOptionsSmaDragDropGuideBox();
		...
		/// </summary>
		public PlotOptionsSmaDragDropDragHandle DragHandle { get; set; }
		private PlotOptionsSmaDragDropDragHandle DragHandle_DefaultValue { get; set; }
		...
		/// </summary>
		public PlotOptionsSmaDragDropGuideBox GuideBox { get; set; }
		private PlotOptionsSmaDragDropGuideBox GuideBox_DefaultValue { get; set; }
