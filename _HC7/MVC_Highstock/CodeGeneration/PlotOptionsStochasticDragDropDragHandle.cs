...
{
	public partial class PlotOptionsStochasticDragDropDragHandle  : BaseObject
	{
		public PlotOptionsStochasticDragDropDragHandle()
		{
		...
		internal override Hashtable ToHashtable()
		{
			...
			if (PathFormatter != PathFormatter_DefaultValue) { h.Add("pathFormatter",PathFormatter); Highstock.AddFunction("PlotOptionsStochasticDragDropDragHandlePathFormatter.pathFormatter", PathFormatter); }  
