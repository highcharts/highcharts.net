...
{
	public partial class PlotOptionsSupertrendDataGrouping  : BaseObject
	{
		public PlotOptionsSupertrendDataGrouping()
		{
			Approximation = Approximation_DefaultValue = PlotOptionsSupertrendDataGroupingApproximation.Null;
		...
		/// </summary>
		public PlotOptionsSupertrendDataGroupingApproximation Approximation { get; set; }
		private PlotOptionsSupertrendDataGroupingApproximation Approximation_DefaultValue { get; set; }
