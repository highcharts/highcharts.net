...
namespace Highsoft.Web.Mvc.Stocks
{
	public partial class PlotOptionsSupertrendDataLabels  : BaseObject
	{
		public PlotOptionsSupertrendDataLabels()
		{
			...
			Style = Style_DefaultValue = new PlotOptionsSupertrendDataLabelsStyle();
		...
		/// </summary>
		public PlotOptionsSupertrendDataLabelsStyle Style { get; set; }
		private PlotOptionsSupertrendDataLabelsStyle Style_DefaultValue { get; set; }
