...
{
	public partial class PlotOptionsSupertrendDragDrop  : BaseObject
	{
		public PlotOptionsSupertrendDragDrop()
		{
			DraggableX = DraggableX_DefaultValue = null;
			DraggableY = DraggableY_DefaultValue = null;
			DragHandle = DragHandle_DefaultValue = new PlotOptionsSupertrendDragDropDragHandle();
			...
			GuideBox = GuideBox_DefaultValue = new PlotOptionsSupertrendDragDropGuideBox();
		...
		/// </summary>
		public PlotOptionsSupertrendDragDropDragHandle DragHandle { get; set; }
		private PlotOptionsSupertrendDragDropDragHandle DragHandle_DefaultValue { get; set; }
		...
		/// </summary>
		public PlotOptionsSupertrendDragDropGuideBox GuideBox { get; set; }
		private PlotOptionsSupertrendDragDropGuideBox GuideBox_DefaultValue { get; set; }
