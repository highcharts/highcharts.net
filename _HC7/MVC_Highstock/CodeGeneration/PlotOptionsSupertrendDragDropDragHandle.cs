...
{
	public partial class PlotOptionsSupertrendDragDropDragHandle  : BaseObject
	{
		public PlotOptionsSupertrendDragDropDragHandle()
		{
		...
		internal override Hashtable ToHashtable()
		{
			...
			if (PathFormatter != PathFormatter_DefaultValue) { h.Add("pathFormatter",PathFormatter); Highstock.AddFunction("PlotOptionsSupertrendDragDropDragHandlePathFormatter.pathFormatter", PathFormatter); }  
