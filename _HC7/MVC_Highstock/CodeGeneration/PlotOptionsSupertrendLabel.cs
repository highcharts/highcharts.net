...
{
	public partial class PlotOptionsSupertrendLabel  : BaseObject
	{
		public PlotOptionsSupertrendLabel()
		{
			...
			Style = Style_DefaultValue = new PlotOptionsSupertrendLabelStyle();
		...
		/// </summary>
		public PlotOptionsSupertrendLabelStyle Style { get; set; }
		private PlotOptionsSupertrendLabelStyle Style_DefaultValue { get; set; }
