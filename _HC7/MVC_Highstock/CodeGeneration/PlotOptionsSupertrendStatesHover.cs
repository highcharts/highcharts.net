...
{
	public partial class PlotOptionsSupertrendStatesHover  : BaseObject
	{
		public PlotOptionsSupertrendStatesHover()
		{
			Enabled = Enabled_DefaultValue = true;
			Halo = Halo_DefaultValue = new PlotOptionsSupertrendStatesHoverHalo();
			LineWidth = LineWidth_DefaultValue = null;
			LineWidthPlus = LineWidthPlus_DefaultValue = 1;
			Marker = Marker_DefaultValue = new PlotOptionsSupertrendStatesHoverMarker();
		...
		/// </summary>
		public PlotOptionsSupertrendStatesHoverHalo Halo { get; set; }
		private PlotOptionsSupertrendStatesHoverHalo Halo_DefaultValue { get; set; }
		...
		/// </summary>
		public PlotOptionsSupertrendStatesHoverMarker Marker { get; set; }
		private PlotOptionsSupertrendStatesHoverMarker Marker_DefaultValue { get; set; }
