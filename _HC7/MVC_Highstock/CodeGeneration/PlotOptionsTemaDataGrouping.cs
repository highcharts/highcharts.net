...
{
	public partial class PlotOptionsTemaDataGrouping  : BaseObject
	{
		public PlotOptionsTemaDataGrouping()
		{
			Approximation = Approximation_DefaultValue = PlotOptionsTemaDataGroupingApproximation.Null;
		...
		/// </summary>
		public PlotOptionsTemaDataGroupingApproximation Approximation { get; set; }
		private PlotOptionsTemaDataGroupingApproximation Approximation_DefaultValue { get; set; }
