...
namespace Highsoft.Web.Mvc.Stocks
{
	public partial class PlotOptionsTemaDataLabels  : BaseObject
	{
		public PlotOptionsTemaDataLabels()
		{
			...
			Style = Style_DefaultValue = new PlotOptionsTemaDataLabelsStyle();
		...
		/// </summary>
		public PlotOptionsTemaDataLabelsStyle Style { get; set; }
		private PlotOptionsTemaDataLabelsStyle Style_DefaultValue { get; set; }
