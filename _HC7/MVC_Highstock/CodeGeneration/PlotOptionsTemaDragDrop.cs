...
{
	public partial class PlotOptionsTemaDragDrop  : BaseObject
	{
		public PlotOptionsTemaDragDrop()
		{
			DraggableX = DraggableX_DefaultValue = null;
			DraggableY = DraggableY_DefaultValue = null;
			DragHandle = DragHandle_DefaultValue = new PlotOptionsTemaDragDropDragHandle();
			...
			GuideBox = GuideBox_DefaultValue = new PlotOptionsTemaDragDropGuideBox();
		...
		/// </summary>
		public PlotOptionsTemaDragDropDragHandle DragHandle { get; set; }
		private PlotOptionsTemaDragDropDragHandle DragHandle_DefaultValue { get; set; }
		...
		/// </summary>
		public PlotOptionsTemaDragDropGuideBox GuideBox { get; set; }
		private PlotOptionsTemaDragDropGuideBox GuideBox_DefaultValue { get; set; }
