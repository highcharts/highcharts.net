...
{
	public partial class PlotOptionsTemaLabel  : BaseObject
	{
		public PlotOptionsTemaLabel()
		{
			...
			Style = Style_DefaultValue = new PlotOptionsTemaLabelStyle();
		...
		/// </summary>
		public PlotOptionsTemaLabelStyle Style { get; set; }
		private PlotOptionsTemaLabelStyle Style_DefaultValue { get; set; }
