...
{
	public partial class PlotOptionsTrixDataGrouping  : BaseObject
	{
		public PlotOptionsTrixDataGrouping()
		{
			Approximation = Approximation_DefaultValue = PlotOptionsTrixDataGroupingApproximation.Null;
		...
		/// </summary>
		public PlotOptionsTrixDataGroupingApproximation Approximation { get; set; }
		private PlotOptionsTrixDataGroupingApproximation Approximation_DefaultValue { get; set; }
