...
namespace Highsoft.Web.Mvc.Stocks
{
	public partial class PlotOptionsTrixDataLabels  : BaseObject
	{
		public PlotOptionsTrixDataLabels()
		{
			...
			Style = Style_DefaultValue = new PlotOptionsTrixDataLabelsStyle();
		...
		/// </summary>
		public PlotOptionsTrixDataLabelsStyle Style { get; set; }
		private PlotOptionsTrixDataLabelsStyle Style_DefaultValue { get; set; }
