...
{
	public partial class PlotOptionsTrixDragDrop  : BaseObject
	{
		public PlotOptionsTrixDragDrop()
		{
			DraggableX = DraggableX_DefaultValue = null;
			DraggableY = DraggableY_DefaultValue = null;
			DragHandle = DragHandle_DefaultValue = new PlotOptionsTrixDragDropDragHandle();
			...
			GuideBox = GuideBox_DefaultValue = new PlotOptionsTrixDragDropGuideBox();
		...
		/// </summary>
		public PlotOptionsTrixDragDropDragHandle DragHandle { get; set; }
		private PlotOptionsTrixDragDropDragHandle DragHandle_DefaultValue { get; set; }
		...
		/// </summary>
		public PlotOptionsTrixDragDropGuideBox GuideBox { get; set; }
		private PlotOptionsTrixDragDropGuideBox GuideBox_DefaultValue { get; set; }
