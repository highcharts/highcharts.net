...
{
	public partial class PlotOptionsTrixDragDropDragHandle  : BaseObject
	{
		public PlotOptionsTrixDragDropDragHandle()
		{
		...
		internal override Hashtable ToHashtable()
		{
			...
			if (PathFormatter != PathFormatter_DefaultValue) { h.Add("pathFormatter",PathFormatter); Highstock.AddFunction("PlotOptionsTrixDragDropDragHandlePathFormatter.pathFormatter", PathFormatter); }  
