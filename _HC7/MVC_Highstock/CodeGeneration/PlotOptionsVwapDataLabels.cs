...
namespace Highsoft.Web.Mvc.Stocks
{
	public partial class PlotOptionsVwapDataLabels  : BaseObject
	{
		public PlotOptionsVwapDataLabels()
		{
			...
			Style = Style_DefaultValue = new PlotOptionsVwapDataLabelsStyle();
		...
		/// </summary>
		public PlotOptionsVwapDataLabelsStyle Style { get; set; }
		private PlotOptionsVwapDataLabelsStyle Style_DefaultValue { get; set; }
