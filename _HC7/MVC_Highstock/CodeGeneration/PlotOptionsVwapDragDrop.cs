...
{
	public partial class PlotOptionsVwapDragDrop  : BaseObject
	{
		public PlotOptionsVwapDragDrop()
		{
			DraggableX = DraggableX_DefaultValue = null;
			DraggableY = DraggableY_DefaultValue = null;
			DragHandle = DragHandle_DefaultValue = new PlotOptionsVwapDragDropDragHandle();
			...
			GuideBox = GuideBox_DefaultValue = new PlotOptionsVwapDragDropGuideBox();
		...
		/// </summary>
		public PlotOptionsVwapDragDropDragHandle DragHandle { get; set; }
		private PlotOptionsVwapDragDropDragHandle DragHandle_DefaultValue { get; set; }
		...
		/// </summary>
		public PlotOptionsVwapDragDropGuideBox GuideBox { get; set; }
		private PlotOptionsVwapDragDropGuideBox GuideBox_DefaultValue { get; set; }
