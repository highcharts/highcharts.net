...
{
	public partial class PlotOptionsVwapDragDropDragHandle  : BaseObject
	{
		public PlotOptionsVwapDragDropDragHandle()
		{
		...
		internal override Hashtable ToHashtable()
		{
			...
			if (PathFormatter != PathFormatter_DefaultValue) { h.Add("pathFormatter",PathFormatter); Highstock.AddFunction("PlotOptionsVwapDragDropDragHandlePathFormatter.pathFormatter", PathFormatter); }  
