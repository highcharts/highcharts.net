...
{
	public partial class PlotOptionsVwapLabel  : BaseObject
	{
		public PlotOptionsVwapLabel()
		{
			...
			Style = Style_DefaultValue = new PlotOptionsVwapLabelStyle();
		...
		/// </summary>
		public PlotOptionsVwapLabelStyle Style { get; set; }
		private PlotOptionsVwapLabelStyle Style_DefaultValue { get; set; }
