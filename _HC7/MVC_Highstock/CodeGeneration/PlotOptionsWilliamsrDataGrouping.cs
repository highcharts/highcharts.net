...
{
	public partial class PlotOptionsWilliamsrDataGrouping  : BaseObject
	{
		public PlotOptionsWilliamsrDataGrouping()
		{
			Approximation = Approximation_DefaultValue = PlotOptionsWilliamsrDataGroupingApproximation.Null;
		...
		/// </summary>
		public PlotOptionsWilliamsrDataGroupingApproximation Approximation { get; set; }
		private PlotOptionsWilliamsrDataGroupingApproximation Approximation_DefaultValue { get; set; }
