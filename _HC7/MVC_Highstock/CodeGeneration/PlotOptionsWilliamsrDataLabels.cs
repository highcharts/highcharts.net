...
namespace Highsoft.Web.Mvc.Stocks
{
	public partial class PlotOptionsWilliamsrDataLabels  : BaseObject
	{
		public PlotOptionsWilliamsrDataLabels()
		{
			...
			Style = Style_DefaultValue = new PlotOptionsWilliamsrDataLabelsStyle();
		...
		/// </summary>
		public PlotOptionsWilliamsrDataLabelsStyle Style { get; set; }
		private PlotOptionsWilliamsrDataLabelsStyle Style_DefaultValue { get; set; }
