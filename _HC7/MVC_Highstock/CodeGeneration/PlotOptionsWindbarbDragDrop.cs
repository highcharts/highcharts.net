...
{
	public partial class PlotOptionsWindbarbDragDrop  : BaseObject
	{
		public PlotOptionsWindbarbDragDrop()
		{
			DraggableX = DraggableX_DefaultValue = null;
			DraggableY = DraggableY_DefaultValue = null;
			DragHandle = DragHandle_DefaultValue = new PlotOptionsWindbarbDragDropDragHandle();
			...
			GuideBox = GuideBox_DefaultValue = new PlotOptionsWindbarbDragDropGuideBox();
		...
		/// </summary>
		public PlotOptionsWindbarbDragDropDragHandle DragHandle { get; set; }
		private PlotOptionsWindbarbDragDropDragHandle DragHandle_DefaultValue { get; set; }
		...
		/// </summary>
		public PlotOptionsWindbarbDragDropGuideBox GuideBox { get; set; }
		private PlotOptionsWindbarbDragDropGuideBox GuideBox_DefaultValue { get; set; }
