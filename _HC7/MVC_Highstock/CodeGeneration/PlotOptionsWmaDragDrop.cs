...
{
	public partial class PlotOptionsWmaDragDrop  : BaseObject
	{
		public PlotOptionsWmaDragDrop()
		{
			DraggableX = DraggableX_DefaultValue = null;
			DraggableY = DraggableY_DefaultValue = null;
			DragHandle = DragHandle_DefaultValue = new PlotOptionsWmaDragDropDragHandle();
			...
			GuideBox = GuideBox_DefaultValue = new PlotOptionsWmaDragDropGuideBox();
		...
		/// </summary>
		public PlotOptionsWmaDragDropDragHandle DragHandle { get; set; }
		private PlotOptionsWmaDragDropDragHandle DragHandle_DefaultValue { get; set; }
		...
		/// </summary>
		public PlotOptionsWmaDragDropGuideBox GuideBox { get; set; }
		private PlotOptionsWmaDragDropGuideBox GuideBox_DefaultValue { get; set; }
