...
{
	public partial class PlotOptionsWmaDragDropDragHandle  : BaseObject
	{
		public PlotOptionsWmaDragDropDragHandle()
		{
		...
		internal override Hashtable ToHashtable()
		{
			...
			if (PathFormatter != PathFormatter_DefaultValue) { h.Add("pathFormatter",PathFormatter); Highstock.AddFunction("PlotOptionsWmaDragDropDragHandlePathFormatter.pathFormatter", PathFormatter); }  
