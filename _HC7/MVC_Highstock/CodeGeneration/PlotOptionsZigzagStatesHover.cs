...
{
	public partial class PlotOptionsZigzagStatesHover  : BaseObject
	{
		public PlotOptionsZigzagStatesHover()
		{
			Enabled = Enabled_DefaultValue = true;
			Halo = Halo_DefaultValue = new PlotOptionsZigzagStatesHoverHalo();
			LineWidth = LineWidth_DefaultValue = null;
			LineWidthPlus = LineWidthPlus_DefaultValue = 1;
			Marker = Marker_DefaultValue = new PlotOptionsZigzagStatesHoverMarker();
		...
		/// </summary>
		public PlotOptionsZigzagStatesHoverHalo Halo { get; set; }
		private PlotOptionsZigzagStatesHoverHalo Halo_DefaultValue { get; set; }
		...
		/// </summary>
		public PlotOptionsZigzagStatesHoverMarker Marker { get; set; }
		private PlotOptionsZigzagStatesHoverMarker Marker_DefaultValue { get; set; }
