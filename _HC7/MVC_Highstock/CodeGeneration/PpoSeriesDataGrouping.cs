...
{
	public partial class PpoSeriesDataGrouping  : BaseObject
	{
		public PpoSeriesDataGrouping()
		{
			Approximation = Approximation_DefaultValue = PpoSeriesDataGroupingApproximation.Null;
		...
		/// </summary>
		public PpoSeriesDataGroupingApproximation Approximation { get; set; }
		private PpoSeriesDataGroupingApproximation Approximation_DefaultValue { get; set; }
