...
namespace Highsoft.Web.Mvc.Stocks
{
	public partial class PpoSeriesDataLabels  : BaseObject
	{
		public PpoSeriesDataLabels()
		{
			...
			Style = Style_DefaultValue = new PpoSeriesDataLabelsStyle();
		...
		/// </summary>
		public PpoSeriesDataLabelsStyle Style { get; set; }
		private PpoSeriesDataLabelsStyle Style_DefaultValue { get; set; }
