...
{
	public partial class PpoSeriesDragDrop  : BaseObject
	{
		public PpoSeriesDragDrop()
		{
			DraggableX = DraggableX_DefaultValue = null;
			DraggableY = DraggableY_DefaultValue = null;
			DragHandle = DragHandle_DefaultValue = new PpoSeriesDragDropDragHandle();
			...
			GuideBox = GuideBox_DefaultValue = new PpoSeriesDragDropGuideBox();
		...
		/// </summary>
		public PpoSeriesDragDropDragHandle DragHandle { get; set; }
		private PpoSeriesDragDropDragHandle DragHandle_DefaultValue { get; set; }
		...
		/// </summary>
		public PpoSeriesDragDropGuideBox GuideBox { get; set; }
		private PpoSeriesDragDropGuideBox GuideBox_DefaultValue { get; set; }
