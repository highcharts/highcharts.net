...
{
	public partial class PpoSeriesMarker  : BaseObject
	{
		public PpoSeriesMarker()
		{
			...
			States = States_DefaultValue = new PpoSeriesMarkerStates();
		...
		/// </summary>
		public PpoSeriesMarkerStates States { get; set; }
		private PpoSeriesMarkerStates States_DefaultValue { get; set; }
