...
{
	public partial class PriceenvelopesSeriesDragDrop  : BaseObject
	{
		public PriceenvelopesSeriesDragDrop()
		{
			DraggableX = DraggableX_DefaultValue = null;
			DraggableY = DraggableY_DefaultValue = null;
			DragHandle = DragHandle_DefaultValue = new PriceenvelopesSeriesDragDropDragHandle();
			...
			GuideBox = GuideBox_DefaultValue = new PriceenvelopesSeriesDragDropGuideBox();
		...
		/// </summary>
		public PriceenvelopesSeriesDragDropDragHandle DragHandle { get; set; }
		private PriceenvelopesSeriesDragDropDragHandle DragHandle_DefaultValue { get; set; }
		...
		/// </summary>
		public PriceenvelopesSeriesDragDropGuideBox GuideBox { get; set; }
		private PriceenvelopesSeriesDragDropGuideBox GuideBox_DefaultValue { get; set; }
