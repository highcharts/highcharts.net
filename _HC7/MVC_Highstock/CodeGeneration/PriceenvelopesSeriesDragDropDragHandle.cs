...
{
	public partial class PriceenvelopesSeriesDragDropDragHandle  : BaseObject
	{
		public PriceenvelopesSeriesDragDropDragHandle()
		{
		...
		internal override Hashtable ToHashtable()
		{
			...
			if (PathFormatter != PathFormatter_DefaultValue) { h.Add("pathFormatter",PathFormatter); Highstock.AddFunction("PriceenvelopesSeriesDragDropDragHandlePathFormatter.pathFormatter", PathFormatter); }  
