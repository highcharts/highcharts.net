...
{
	public partial class PsarSeriesDragDropDragHandle  : BaseObject
	{
		public PsarSeriesDragDropDragHandle()
		{
		...
		internal override Hashtable ToHashtable()
		{
			...
			if (PathFormatter != PathFormatter_DefaultValue) { h.Add("pathFormatter",PathFormatter); Highstock.AddFunction("PsarSeriesDragDropDragHandlePathFormatter.pathFormatter", PathFormatter); }  
