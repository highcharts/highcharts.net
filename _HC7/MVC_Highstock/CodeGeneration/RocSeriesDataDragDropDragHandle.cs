...
{
	public partial class RocSeriesDataDragDropDragHandle  : BaseObject
	{
		public RocSeriesDataDragDropDragHandle()
		{
		...
		internal override Hashtable ToHashtable()
		{
			...
			if (PathFormatter != PathFormatter_DefaultValue) { h.Add("pathFormatter",PathFormatter); Highstock.AddFunction("RocSeriesDataDragDropDragHandlePathFormatter.pathFormatter", PathFormatter); }  
