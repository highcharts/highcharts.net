...
{
	public partial class RocSeriesDragDropDragHandle  : BaseObject
	{
		public RocSeriesDragDropDragHandle()
		{
		...
		internal override Hashtable ToHashtable()
		{
			...
			if (PathFormatter != PathFormatter_DefaultValue) { h.Add("pathFormatter",PathFormatter); Highstock.AddFunction("RocSeriesDragDropDragHandlePathFormatter.pathFormatter", PathFormatter); }  
