...
{
	public partial class RocSeriesMarker  : BaseObject
	{
		public RocSeriesMarker()
		{
			...
			States = States_DefaultValue = new RocSeriesMarkerStates();
		...
		/// </summary>
		public RocSeriesMarkerStates States { get; set; }
		private RocSeriesMarkerStates States_DefaultValue { get; set; }
