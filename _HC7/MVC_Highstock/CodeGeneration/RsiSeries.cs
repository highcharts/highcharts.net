...
namespace Highsoft.Web.Mvc.Stocks
{
	public partial class RsiSeries  : Series
	{
		public RsiSeries()
		{
			...
			Data = Data_DefaultValue = new List<RsiSeriesData>();
		...
		/// <summary>
		/// An array of data points for the series. For the `rsi` series type,points are calculated dynamically.
		/// </summary>
		public List<RsiSeriesData> Data { get; set; }
		private List<RsiSeriesData> Data_DefaultValue { get; set; }
