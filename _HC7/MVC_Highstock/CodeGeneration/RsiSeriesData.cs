...
{
	public partial class RsiSeriesData  : BaseObject
	{
		public RsiSeriesData()
		{
			...
			DragDrop = DragDrop_DefaultValue = new RsiSeriesDataDragDrop();
			Drilldown = Drilldown_DefaultValue = "";
			Events = Events_DefaultValue = new RsiSeriesDataEvents();
			Id = Id_DefaultValue = "";
			Labelrank = Labelrank_DefaultValue = null;
			Marker = Marker_DefaultValue = new RsiSeriesDataMarker();
		...
		/// </summary>
		public RsiSeriesDataDragDrop DragDrop { get; set; }
		private RsiSeriesDataDragDrop DragDrop_DefaultValue { get; set; }
		...
		/// </summary>
		public RsiSeriesDataEvents Events { get; set; }
		private RsiSeriesDataEvents Events_DefaultValue { get; set; }
		...
		/// 
		/// </summary>
		public RsiSeriesDataMarker Marker { get; set; }
		private RsiSeriesDataMarker Marker_DefaultValue { get; set; }
