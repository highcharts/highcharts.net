...
{
	public partial class RsiSeriesDataDragDrop  : BaseObject
	{
		public RsiSeriesDataDragDrop()
		{
			DraggableX = DraggableX_DefaultValue = null;
			DraggableY = DraggableY_DefaultValue = null;
			DragHandle = DragHandle_DefaultValue = new RsiSeriesDataDragDropDragHandle();
			...
			GuideBox = GuideBox_DefaultValue = new RsiSeriesDataDragDropGuideBox();
		...
		/// </summary>
		public RsiSeriesDataDragDropDragHandle DragHandle { get; set; }
		private RsiSeriesDataDragDropDragHandle DragHandle_DefaultValue { get; set; }
		...
		/// </summary>
		public RsiSeriesDataDragDropGuideBox GuideBox { get; set; }
		private RsiSeriesDataDragDropGuideBox GuideBox_DefaultValue { get; set; }
