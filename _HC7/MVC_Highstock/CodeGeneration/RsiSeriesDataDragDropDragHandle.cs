...
{
	public partial class RsiSeriesDataDragDropDragHandle  : BaseObject
	{
		public RsiSeriesDataDragDropDragHandle()
		{
		...
		internal override Hashtable ToHashtable()
		{
			...
			if (PathFormatter != PathFormatter_DefaultValue) { h.Add("pathFormatter",PathFormatter); Highstock.AddFunction("RsiSeriesDataDragDropDragHandlePathFormatter.pathFormatter", PathFormatter); }  
