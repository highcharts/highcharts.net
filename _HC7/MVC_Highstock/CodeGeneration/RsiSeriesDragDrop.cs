...
{
	public partial class RsiSeriesDragDrop  : BaseObject
	{
		public RsiSeriesDragDrop()
		{
			DraggableX = DraggableX_DefaultValue = null;
			DraggableY = DraggableY_DefaultValue = null;
			DragHandle = DragHandle_DefaultValue = new RsiSeriesDragDropDragHandle();
			...
			GuideBox = GuideBox_DefaultValue = new RsiSeriesDragDropGuideBox();
		...
		/// </summary>
		public RsiSeriesDragDropDragHandle DragHandle { get; set; }
		private RsiSeriesDragDropDragHandle DragHandle_DefaultValue { get; set; }
		...
		/// </summary>
		public RsiSeriesDragDropGuideBox GuideBox { get; set; }
		private RsiSeriesDragDropGuideBox GuideBox_DefaultValue { get; set; }
