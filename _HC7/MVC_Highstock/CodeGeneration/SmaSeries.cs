...
namespace Highsoft.Web.Mvc.Stocks
{
	public partial class SmaSeries  : Series
	{
		public SmaSeries()
		{
			...
			Data = Data_DefaultValue = new List<SmaSeriesData>();
		...
		/// <summary>
		/// An array of data points for the series. For the `SMA` series type,points are calculated dynamically.
		/// </summary>
		public List<SmaSeriesData> Data { get; set; }
		private List<SmaSeriesData> Data_DefaultValue { get; set; }
