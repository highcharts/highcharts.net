...
{
	public partial class SmaSeriesDataDragDrop  : BaseObject
	{
		public SmaSeriesDataDragDrop()
		{
			DraggableX = DraggableX_DefaultValue = null;
			DraggableY = DraggableY_DefaultValue = null;
			DragHandle = DragHandle_DefaultValue = new SmaSeriesDataDragDropDragHandle();
			...
			GuideBox = GuideBox_DefaultValue = new SmaSeriesDataDragDropGuideBox();
		...
		/// </summary>
		public SmaSeriesDataDragDropDragHandle DragHandle { get; set; }
		private SmaSeriesDataDragDropDragHandle DragHandle_DefaultValue { get; set; }
		...
		/// </summary>
		public SmaSeriesDataDragDropGuideBox GuideBox { get; set; }
		private SmaSeriesDataDragDropGuideBox GuideBox_DefaultValue { get; set; }
