...
namespace Highsoft.Web.Mvc.Stocks
{
	public partial class SmaSeriesDataLabels  : BaseObject
	{
		public SmaSeriesDataLabels()
		{
			...
			Style = Style_DefaultValue = new SmaSeriesDataLabelsStyle();
		...
		/// </summary>
		public SmaSeriesDataLabelsStyle Style { get; set; }
		private SmaSeriesDataLabelsStyle Style_DefaultValue { get; set; }
