...
{
	public partial class SmaSeriesDragDrop  : BaseObject
	{
		public SmaSeriesDragDrop()
		{
			DraggableX = DraggableX_DefaultValue = null;
			DraggableY = DraggableY_DefaultValue = null;
			DragHandle = DragHandle_DefaultValue = new SmaSeriesDragDropDragHandle();
			...
			GuideBox = GuideBox_DefaultValue = new SmaSeriesDragDropGuideBox();
		...
		/// </summary>
		public SmaSeriesDragDropDragHandle DragHandle { get; set; }
		private SmaSeriesDragDropDragHandle DragHandle_DefaultValue { get; set; }
		...
		/// </summary>
		public SmaSeriesDragDropGuideBox GuideBox { get; set; }
		private SmaSeriesDragDropGuideBox GuideBox_DefaultValue { get; set; }
