...
{
	public partial class SplineSeriesDataDragDrop  : BaseObject
	{
		public SplineSeriesDataDragDrop()
		{
			DraggableX = DraggableX_DefaultValue = null;
			DraggableY = DraggableY_DefaultValue = null;
			DragHandle = DragHandle_DefaultValue = new SplineSeriesDataDragDropDragHandle();
			...
			GuideBox = GuideBox_DefaultValue = new SplineSeriesDataDragDropGuideBox();
		...
		/// </summary>
		public SplineSeriesDataDragDropDragHandle DragHandle { get; set; }
		private SplineSeriesDataDragDropDragHandle DragHandle_DefaultValue { get; set; }
		...
		/// </summary>
		public SplineSeriesDataDragDropGuideBox GuideBox { get; set; }
		private SplineSeriesDataDragDropGuideBox GuideBox_DefaultValue { get; set; }
