...
namespace Highsoft.Web.Mvc.Stocks
{
	public partial class SplineSeriesDataDragDropDragHandle  : BaseObject
	{
		...
		internal override Hashtable ToHashtable()
		{
			...
			if (PathFormatter != PathFormatter_DefaultValue) { h.Add("pathFormatter",PathFormatter); Highstock.AddFunction("SplineSeriesDataDragDropDragHandlePathFormatter.pathFormatter", PathFormatter); }  
