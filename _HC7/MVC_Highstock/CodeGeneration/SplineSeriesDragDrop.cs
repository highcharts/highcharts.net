...
{
	public partial class SplineSeriesDragDrop  : BaseObject
	{
		public SplineSeriesDragDrop()
		{
			DraggableX = DraggableX_DefaultValue = null;
			DraggableY = DraggableY_DefaultValue = null;
			DragHandle = DragHandle_DefaultValue = new SplineSeriesDragDropDragHandle();
			...
			GuideBox = GuideBox_DefaultValue = new SplineSeriesDragDropGuideBox();
		...
		/// </summary>
		public SplineSeriesDragDropDragHandle DragHandle { get; set; }
		private SplineSeriesDragDropDragHandle DragHandle_DefaultValue { get; set; }
		...
		/// </summary>
		public SplineSeriesDragDropGuideBox GuideBox { get; set; }
		private SplineSeriesDragDropGuideBox GuideBox_DefaultValue { get; set; }
