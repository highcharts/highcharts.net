...
namespace Highsoft.Web.Mvc.Stocks
{
	public partial class SplineSeriesDragDropDragHandle  : BaseObject
	{
		...
		internal override Hashtable ToHashtable()
		{
			...
			if (PathFormatter != PathFormatter_DefaultValue) { h.Add("pathFormatter",PathFormatter); Highstock.AddFunction("SplineSeriesDragDropDragHandlePathFormatter.pathFormatter", PathFormatter); }  
