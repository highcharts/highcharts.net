...
namespace Highsoft.Web.Mvc.Stocks
{
	public partial class StochasticSeries  : Series
	{
		public StochasticSeries()
		{
			...
			Data = Data_DefaultValue = new List<StochasticSeriesData>();
		...
		/// <summary>
		/// An array of data points for the series. For the `stochastic` series type,points are calculated dynamically.
		/// </summary>
		public List<StochasticSeriesData> Data { get; set; }
		private List<StochasticSeriesData> Data_DefaultValue { get; set; }
