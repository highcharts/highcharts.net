...
{
	public partial class StochasticSeriesDataDragDrop  : BaseObject
	{
		public StochasticSeriesDataDragDrop()
		{
			DraggableX = DraggableX_DefaultValue = null;
			DraggableY = DraggableY_DefaultValue = null;
			DragHandle = DragHandle_DefaultValue = new StochasticSeriesDataDragDropDragHandle();
			...
			GuideBox = GuideBox_DefaultValue = new StochasticSeriesDataDragDropGuideBox();
		...
		/// </summary>
		public StochasticSeriesDataDragDropDragHandle DragHandle { get; set; }
		private StochasticSeriesDataDragDropDragHandle DragHandle_DefaultValue { get; set; }
		...
		/// </summary>
		public StochasticSeriesDataDragDropGuideBox GuideBox { get; set; }
		private StochasticSeriesDataDragDropGuideBox GuideBox_DefaultValue { get; set; }
