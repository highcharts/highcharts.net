...
namespace Highsoft.Web.Mvc.Stocks
{
	public partial class StochasticSeriesDataLabels  : BaseObject
	{
		public StochasticSeriesDataLabels()
		{
			...
			Style = Style_DefaultValue = new StochasticSeriesDataLabelsStyle();
		...
		/// </summary>
		public StochasticSeriesDataLabelsStyle Style { get; set; }
		private StochasticSeriesDataLabelsStyle Style_DefaultValue { get; set; }
