...
{
	public partial class StochasticSeriesDragDrop  : BaseObject
	{
		public StochasticSeriesDragDrop()
		{
			DraggableX = DraggableX_DefaultValue = null;
			DraggableY = DraggableY_DefaultValue = null;
			DragHandle = DragHandle_DefaultValue = new StochasticSeriesDragDropDragHandle();
			...
			GuideBox = GuideBox_DefaultValue = new StochasticSeriesDragDropGuideBox();
		...
		/// </summary>
		public StochasticSeriesDragDropDragHandle DragHandle { get; set; }
		private StochasticSeriesDragDropDragHandle DragHandle_DefaultValue { get; set; }
		...
		/// </summary>
		public StochasticSeriesDragDropGuideBox GuideBox { get; set; }
		private StochasticSeriesDragDropGuideBox GuideBox_DefaultValue { get; set; }
