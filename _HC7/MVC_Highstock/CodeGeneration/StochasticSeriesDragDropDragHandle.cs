...
{
	public partial class StochasticSeriesDragDropDragHandle  : BaseObject
	{
		public StochasticSeriesDragDropDragHandle()
		{
		...
		internal override Hashtable ToHashtable()
		{
			...
			if (PathFormatter != PathFormatter_DefaultValue) { h.Add("pathFormatter",PathFormatter); Highstock.AddFunction("StochasticSeriesDragDropDragHandlePathFormatter.pathFormatter", PathFormatter); }  
