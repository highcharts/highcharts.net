...
{
	public partial class StreamgraphSeriesDataDragDrop  : BaseObject
	{
		public StreamgraphSeriesDataDragDrop()
		{
			DraggableX = DraggableX_DefaultValue = null;
			DraggableY = DraggableY_DefaultValue = null;
			DragHandle = DragHandle_DefaultValue = new StreamgraphSeriesDataDragDropDragHandle();
			...
			GuideBox = GuideBox_DefaultValue = new StreamgraphSeriesDataDragDropGuideBox();
		...
		/// </summary>
		public StreamgraphSeriesDataDragDropDragHandle DragHandle { get; set; }
		private StreamgraphSeriesDataDragDropDragHandle DragHandle_DefaultValue { get; set; }
		...
		/// </summary>
		public StreamgraphSeriesDataDragDropGuideBox GuideBox { get; set; }
		private StreamgraphSeriesDataDragDropGuideBox GuideBox_DefaultValue { get; set; }
