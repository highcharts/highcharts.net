...
{
	public partial class SupertrendSeriesDataGrouping  : BaseObject
	{
		public SupertrendSeriesDataGrouping()
		{
			Approximation = Approximation_DefaultValue = SupertrendSeriesDataGroupingApproximation.Null;
		...
		/// </summary>
		public SupertrendSeriesDataGroupingApproximation Approximation { get; set; }
		private SupertrendSeriesDataGroupingApproximation Approximation_DefaultValue { get; set; }
