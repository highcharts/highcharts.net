...
namespace Highsoft.Web.Mvc.Stocks
{
	public partial class SupertrendSeriesDataLabels  : BaseObject
	{
		public SupertrendSeriesDataLabels()
		{
			...
			Style = Style_DefaultValue = new SupertrendSeriesDataLabelsStyle();
		...
		/// </summary>
		public SupertrendSeriesDataLabelsStyle Style { get; set; }
		private SupertrendSeriesDataLabelsStyle Style_DefaultValue { get; set; }
