...
{
	public partial class SupertrendSeriesDragDrop  : BaseObject
	{
		public SupertrendSeriesDragDrop()
		{
			DraggableX = DraggableX_DefaultValue = null;
			DraggableY = DraggableY_DefaultValue = null;
			DragHandle = DragHandle_DefaultValue = new SupertrendSeriesDragDropDragHandle();
			...
			GuideBox = GuideBox_DefaultValue = new SupertrendSeriesDragDropGuideBox();
		...
		/// </summary>
		public SupertrendSeriesDragDropDragHandle DragHandle { get; set; }
		private SupertrendSeriesDragDropDragHandle DragHandle_DefaultValue { get; set; }
		...
		/// </summary>
		public SupertrendSeriesDragDropGuideBox GuideBox { get; set; }
		private SupertrendSeriesDragDropGuideBox GuideBox_DefaultValue { get; set; }
