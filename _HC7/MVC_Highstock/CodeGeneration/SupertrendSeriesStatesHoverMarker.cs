...
{
	public partial class SupertrendSeriesStatesHoverMarker  : BaseObject
	{
		public SupertrendSeriesStatesHoverMarker()
		{
			...
			States = States_DefaultValue = new SupertrendSeriesStatesHoverMarkerStates();
		...
		/// </summary>
		public SupertrendSeriesStatesHoverMarkerStates States { get; set; }
		private SupertrendSeriesStatesHoverMarkerStates States_DefaultValue { get; set; }
