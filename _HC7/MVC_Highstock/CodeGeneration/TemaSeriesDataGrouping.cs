...
{
	public partial class TemaSeriesDataGrouping  : BaseObject
	{
		public TemaSeriesDataGrouping()
		{
			Approximation = Approximation_DefaultValue = TemaSeriesDataGroupingApproximation.Null;
		...
		/// </summary>
		public TemaSeriesDataGroupingApproximation Approximation { get; set; }
		private TemaSeriesDataGroupingApproximation Approximation_DefaultValue { get; set; }
