...
namespace Highsoft.Web.Mvc.Stocks
{
	public partial class TemaSeriesDataLabels  : BaseObject
	{
		public TemaSeriesDataLabels()
		{
			...
			Style = Style_DefaultValue = new TemaSeriesDataLabelsStyle();
		...
		/// </summary>
		public TemaSeriesDataLabelsStyle Style { get; set; }
		private TemaSeriesDataLabelsStyle Style_DefaultValue { get; set; }
