...
{
	public partial class TemaSeriesLabel  : BaseObject
	{
		public TemaSeriesLabel()
		{
			...
			Style = Style_DefaultValue = new TemaSeriesLabelStyle();
		...
		/// </summary>
		public TemaSeriesLabelStyle Style { get; set; }
		private TemaSeriesLabelStyle Style_DefaultValue { get; set; }
