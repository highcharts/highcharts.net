...
{
	public partial class TrixSeriesDataGrouping  : BaseObject
	{
		public TrixSeriesDataGrouping()
		{
			Approximation = Approximation_DefaultValue = TrixSeriesDataGroupingApproximation.Null;
		...
		/// </summary>
		public TrixSeriesDataGroupingApproximation Approximation { get; set; }
		private TrixSeriesDataGroupingApproximation Approximation_DefaultValue { get; set; }
