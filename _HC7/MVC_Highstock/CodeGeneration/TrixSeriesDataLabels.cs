...
namespace Highsoft.Web.Mvc.Stocks
{
	public partial class TrixSeriesDataLabels  : BaseObject
	{
		public TrixSeriesDataLabels()
		{
			...
			Style = Style_DefaultValue = new TrixSeriesDataLabelsStyle();
		...
		/// </summary>
		public TrixSeriesDataLabelsStyle Style { get; set; }
		private TrixSeriesDataLabelsStyle Style_DefaultValue { get; set; }
