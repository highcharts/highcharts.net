...
{
	public partial class TrixSeriesMarker  : BaseObject
	{
		public TrixSeriesMarker()
		{
			...
			States = States_DefaultValue = new TrixSeriesMarkerStates();
		...
		/// </summary>
		public TrixSeriesMarkerStates States { get; set; }
		private TrixSeriesMarkerStates States_DefaultValue { get; set; }
