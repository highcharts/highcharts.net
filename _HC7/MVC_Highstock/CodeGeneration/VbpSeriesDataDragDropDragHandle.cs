...
{
	public partial class VbpSeriesDataDragDropDragHandle  : BaseObject
	{
		public VbpSeriesDataDragDropDragHandle()
		{
		...
		internal override Hashtable ToHashtable()
		{
			...
			if (PathFormatter != PathFormatter_DefaultValue) { h.Add("pathFormatter",PathFormatter); Highstock.AddFunction("VbpSeriesDataDragDropDragHandlePathFormatter.pathFormatter", PathFormatter); }  
