...
{
	public partial class VbpSeriesDragDrop  : BaseObject
	{
		public VbpSeriesDragDrop()
		{
			DraggableX = DraggableX_DefaultValue = null;
			DraggableY = DraggableY_DefaultValue = null;
			DragHandle = DragHandle_DefaultValue = new VbpSeriesDragDropDragHandle();
			...
			GuideBox = GuideBox_DefaultValue = new VbpSeriesDragDropGuideBox();
		...
		/// </summary>
		public VbpSeriesDragDropDragHandle DragHandle { get; set; }
		private VbpSeriesDragDropDragHandle DragHandle_DefaultValue { get; set; }
		...
		/// </summary>
		public VbpSeriesDragDropGuideBox GuideBox { get; set; }
		private VbpSeriesDragDropGuideBox GuideBox_DefaultValue { get; set; }
