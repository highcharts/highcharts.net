...
{
	public partial class WilliamsrSeriesDataGrouping  : BaseObject
	{
		public WilliamsrSeriesDataGrouping()
		{
			Approximation = Approximation_DefaultValue = WilliamsrSeriesDataGroupingApproximation.Null;
		...
		/// </summary>
		public WilliamsrSeriesDataGroupingApproximation Approximation { get; set; }
		private WilliamsrSeriesDataGroupingApproximation Approximation_DefaultValue { get; set; }
