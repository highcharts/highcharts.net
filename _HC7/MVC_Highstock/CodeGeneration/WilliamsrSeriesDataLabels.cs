...
namespace Highsoft.Web.Mvc.Stocks
{
	public partial class WilliamsrSeriesDataLabels  : BaseObject
	{
		public WilliamsrSeriesDataLabels()
		{
			...
			Style = Style_DefaultValue = new WilliamsrSeriesDataLabelsStyle();
		...
		/// </summary>
		public WilliamsrSeriesDataLabelsStyle Style { get; set; }
		private WilliamsrSeriesDataLabelsStyle Style_DefaultValue { get; set; }
