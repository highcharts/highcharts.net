...
{
	public partial class WilliamsrSeriesLabel  : BaseObject
	{
		public WilliamsrSeriesLabel()
		{
			...
			Style = Style_DefaultValue = new WilliamsrSeriesLabelStyle();
		...
		/// </summary>
		public WilliamsrSeriesLabelStyle Style { get; set; }
		private WilliamsrSeriesLabelStyle Style_DefaultValue { get; set; }
