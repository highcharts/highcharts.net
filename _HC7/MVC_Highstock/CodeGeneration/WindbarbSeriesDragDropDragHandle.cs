...
namespace Highsoft.Web.Mvc.Stocks
{
	public partial class WindbarbSeriesDragDropDragHandle  : BaseObject
	{
		...
		internal override Hashtable ToHashtable()
		{
			...
			if (PathFormatter != PathFormatter_DefaultValue) { h.Add("pathFormatter",PathFormatter); Highstock.AddFunction("WindbarbSeriesDragDropDragHandlePathFormatter.pathFormatter", PathFormatter); }  
