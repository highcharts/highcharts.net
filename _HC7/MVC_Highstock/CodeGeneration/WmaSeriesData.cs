...
{
	public partial class WmaSeriesData  : BaseObject
	{
		public WmaSeriesData()
		{
			...
			DragDrop = DragDrop_DefaultValue = new WmaSeriesDataDragDrop();
			Drilldown = Drilldown_DefaultValue = "";
			Events = Events_DefaultValue = new WmaSeriesDataEvents();
			Id = Id_DefaultValue = "";
			Labelrank = Labelrank_DefaultValue = null;
			Marker = Marker_DefaultValue = new WmaSeriesDataMarker();
		...
		/// </summary>
		public WmaSeriesDataDragDrop DragDrop { get; set; }
		private WmaSeriesDataDragDrop DragDrop_DefaultValue { get; set; }
		...
		/// </summary>
		public WmaSeriesDataEvents Events { get; set; }
		private WmaSeriesDataEvents Events_DefaultValue { get; set; }
		...
		/// 
		/// </summary>
		public WmaSeriesDataMarker Marker { get; set; }
		private WmaSeriesDataMarker Marker_DefaultValue { get; set; }
