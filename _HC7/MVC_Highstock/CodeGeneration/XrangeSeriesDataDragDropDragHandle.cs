...
namespace Highsoft.Web.Mvc.Stocks
{
	public partial class XrangeSeriesDataDragDropDragHandle  : BaseObject
	{
		...
		internal override Hashtable ToHashtable()
		{
			...
			if (PathFormatter != PathFormatter_DefaultValue) { h.Add("pathFormatter",PathFormatter); Highstock.AddFunction("XrangeSeriesDataDragDropDragHandlePathFormatter.pathFormatter", PathFormatter); }  
