...
{
	public partial class ZigzagSeriesData  : BaseObject
	{
		public ZigzagSeriesData()
		{
			...
			DragDrop = DragDrop_DefaultValue = new ZigzagSeriesDataDragDrop();
			Drilldown = Drilldown_DefaultValue = "";
			Events = Events_DefaultValue = new ZigzagSeriesDataEvents();
			Id = Id_DefaultValue = "";
			Labelrank = Labelrank_DefaultValue = null;
			Marker = Marker_DefaultValue = new ZigzagSeriesDataMarker();
		...
		/// </summary>
		public ZigzagSeriesDataDragDrop DragDrop { get; set; }
		private ZigzagSeriesDataDragDrop DragDrop_DefaultValue { get; set; }
		...
		/// </summary>
		public ZigzagSeriesDataEvents Events { get; set; }
		private ZigzagSeriesDataEvents Events_DefaultValue { get; set; }
		...
		/// 
		/// </summary>
		public ZigzagSeriesDataMarker Marker { get; set; }
		private ZigzagSeriesDataMarker Marker_DefaultValue { get; set; }
