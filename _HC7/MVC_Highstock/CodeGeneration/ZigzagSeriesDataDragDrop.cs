...
{
	public partial class ZigzagSeriesDataDragDrop  : BaseObject
	{
		public ZigzagSeriesDataDragDrop()
		{
			DraggableX = DraggableX_DefaultValue = null;
			DraggableY = DraggableY_DefaultValue = null;
			DragHandle = DragHandle_DefaultValue = new ZigzagSeriesDataDragDropDragHandle();
			...
			GuideBox = GuideBox_DefaultValue = new ZigzagSeriesDataDragDropGuideBox();
		...
		/// </summary>
		public ZigzagSeriesDataDragDropDragHandle DragHandle { get; set; }
		private ZigzagSeriesDataDragDropDragHandle DragHandle_DefaultValue { get; set; }
		...
		/// </summary>
		public ZigzagSeriesDataDragDropGuideBox GuideBox { get; set; }
		private ZigzagSeriesDataDragDropGuideBox GuideBox_DefaultValue { get; set; }
