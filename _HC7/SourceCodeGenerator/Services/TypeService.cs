...
namespace SourceCodeGenerator.Services
{
    public class TypeService : ITypeService
    {
        ...
        "Highcharts.SeriesLinecapValue", "Highcharts.AxisTitleAlignValue", "Highcharts.RangeSelectorButtonTypeValue", "Highcharts.DataLabelsOverflowValue", "Highcharts.AnnotationDraggableValue", "Highcharts.FlagsShapeValue", "Highcharts.DataGroupingAnchor","Highcharts.DataGroupingAnchorExtremes"};//, "Highcharts.HTMLDOMElement" 
