...
{
    public class PlotOptionsBulletTests : IClassFixture<HcFixture>
    {
        protected HcFixture _fixture;

        public PlotOptionsBulletTests(HcFixture fixture)
        {
            _fixture = fixture;
        ...
        public void Test_IfAccessibilityDescriptionRenders_Correct(string description)
        {
            ...
            chart.PlotOptions.Bullet.Accessibility.Description = description;
        ...
        public void Test_IfAccessibilityEnabledRenders_Correct(bool enabled)
        {
            ...
            chart.PlotOptions.Bullet.Accessibility.Enabled = enabled;
        ...
        public void Test_IfAccessibilityExposeAsGroupOnlyRenders_Correct(bool exposeAsGroupOnly)
        {
            ...
            chart.PlotOptions.Bullet.Accessibility.ExposeAsGroupOnly = exposeAsGroupOnly;
        ...
        public void Test_IfAccessibilityKeyboardNavigationEnabledRenders_Correct(bool enabled)
        {
            ...
            chart.PlotOptions.Bullet.Accessibility.KeyboardNavigation.Enabled = enabled;
        ...
        public void Test_IfAccessibilityPointDateFormatRenders_Correct(string format)
        {
            ...
            chart.PlotOptions.Bullet.Accessibility.Point.DateFormat = format;
        ...
        public void Test_IfAccessibilityPointDateFormatterRenders_Correct(string function)
        {
            ...
            chart.PlotOptions.Bullet.Accessibility.Point.DateFormatter = function;
        ...
        public void Test_IfAccessibilityPointDescribeNullSetOnFalseRenders_Correct(bool describeNull)
        {
            ...
            chart.PlotOptions.Bullet.Accessibility.Point.DescribeNull = describeNull;
        ...
        public void Test_IfAccessibilityPointDescriptionFormatterRenders_Correct(string function)
        {
            ...
            chart.PlotOptions.Bullet.Accessibility.Point.DescriptionFormatter = function;
        ...
        public void Test_IfAccessibilityPointValueDecimalsRenders_Correct(int decimals)
        {
            ...
            chart.PlotOptions.Bullet.Accessibility.Point.ValueDecimals = decimals;
        ...
        public void Test_IfAccessibilityPointValueDescriptionFormatRenders_Correct(string format)
        {
            ...
            chart.PlotOptions.Bullet.Accessibility.Point.ValueDescriptionFormat = format;
        ...
        public void Test_IfAccessibilityPointValuePrefixRenders_Correct(string prefix)
        {
            ...
            chart.PlotOptions.Bullet.Accessibility.Point.ValuePrefix = prefix;
        ...
        public void Test_IfAccessibilityPointValueSufixRenders_Correct(string suffix)
        {
            ...
            chart.PlotOptions.Bullet.Accessibility.Point.ValueSuffix = suffix;
        ...
        public void Test_IfAllowPointSelectRenders_Correct()
        {
            ...
            chart.PlotOptions.Bullet.AllowPointSelect = enabled;
        ...
        public void Test_IfAllowPointSelectDoesntRenderForDefault_Correct()
        {
            ...
            chart.PlotOptions.Bullet.AllowPointSelect = false;
        ...
        public void Test_IfAnimationEnabledRenders_Correct(bool enabled)
        {
            ...
            chart.PlotOptions.Bullet.AnimationBool = enabled;
        ...
        public void Test_IfAnimationDurationRenders_Correct(int duration)
        {
            ...
            chart.PlotOptions.Bullet.Animation.Duration = duration;
        ...
        public void Test_IfAnimationDeferRenders_Correct(int defer)
        {
            ...
            chart.PlotOptions.Bullet.Animation.Defer = defer;
        ...
        public void Test_IfAnimationEasingRenders_Correct(string easing)
        {
            ...
            chart.PlotOptions.Bullet.Animation.Easing = easing;
        ...
        public void Test_IfAnimationLimitRenders_Correct(int limit)
        {
            ...
            chart.PlotOptions.Bullet.AnimationLimit = limit;
        ...
        public void Test_IfClassNameRenders_Correct(string className)
        {
            ...
            chart.PlotOptions.Bullet.ClassName = className;
        ...
        public void Test_IfClipRenders_Correct()
        {
            ...
            chart.PlotOptions.Bullet.Clip = value;
        ...
        public void Test_IfColorRenders_Correct(string color)
        {
            ...
            chart.PlotOptions.Bullet.Color = color;
        ...
        public void Test_IfColorIndexRenders_Correct(int value)
        {
            ...
            chart.PlotOptions.Bullet.ColorIndex = value;
        ...
        public void Test_IfColorKeyRenders_Correct(string value)
        {
            ...
            chart.PlotOptions.Bullet.ColorKey = value;
        ...
        public void Test_IfCrispRenders_Correct()
        {
            ...
            chart.PlotOptions.Bullet.Crisp = value;
        ...
        public void Test_IfCropThresholdRenders_Correct(int value)
        {
            ...
            chart.PlotOptions.Bullet.CropThreshold = value;
        ...
        public void Test_IfCropThresholdDoesntRenderForDefault_Correct()
        {
            ...
            chart.PlotOptions.Bullet.CropThreshold = defaultValue;

            Assert.DoesNotContain($"\"crisp\"", renderer.RenderHtml());
        }

        [Theory]
        [InlineData(PlotOptionsBulletCursor.Default)]
        [InlineData(PlotOptionsBulletCursor.Help)]
        [InlineData(PlotOptionsBulletCursor.Pointer)]
        [InlineData(PlotOptionsBulletCursor.None)]
        public void Test_IfCursorRenders_Correct(PlotOptionsBulletCursor cursor)
        {
            var chart = new Highcharts();
            chart.Chart.Type = _fixture.ChartType;
            var renderer = new HighchartsRenderer(chart);

            chart.PlotOptions.Bullet.Cursor = cursor;
        ...
        public void Test_IfCustomRenders_Correct(string key1, string value1)
        {
            ...
            chart.PlotOptions.Bullet.Custom = extraData;

            Assert.Contains($"\"plotOptions\":{{\"{_fixture.ChartType.ToString().ToLower()}\":{{\"custom\":{{\"{key1}\":\"{value1}\"}}}}}}", renderer.RenderHtml());
        }

        [Theory]
        [InlineData(PlotOptionsBulletDashStyle.Dash)]
        [InlineData(PlotOptionsBulletDashStyle.DashDot)]
        [InlineData(PlotOptionsBulletDashStyle.Dot)]
        [InlineData(PlotOptionsBulletDashStyle.LongDash)]
        [InlineData(PlotOptionsBulletDashStyle.LongDashDot)]
        [InlineData(PlotOptionsBulletDashStyle.LongDashDotDot)]
        [InlineData(PlotOptionsBulletDashStyle.ShortDash)]
        [InlineData(PlotOptionsBulletDashStyle.ShortDashDot)]
        [InlineData(PlotOptionsBulletDashStyle.ShortDashDotDot)]
        [InlineData(PlotOptionsBulletDashStyle.ShortDot)]
        public void Test_IfDashStyleRenders_Correct(PlotOptionsBulletDashStyle style)
        {
            var chart = new Highcharts();
            chart.Chart.Type = _fixture.ChartType;
            var renderer = new HighchartsRenderer(chart);
            ...
            chart.PlotOptions.Bullet.DashStyle = style;
        ...
        [Theory]
        [InlineData(PlotOptionsBulletDataLabelsAlign.Left)]
        [InlineData(PlotOptionsBulletDataLabelsAlign.Right)]
        public void Test_IfDataLabelsAlignRenders_Correct(PlotOptionsBulletDataLabelsAlign align)
        {
            var chart = new Highcharts();
            var renderer = new HighchartsRenderer(chart);

            chart.PlotOptions.Bullet.DataLabels.Align = align;
        ...
        public void Test_IfDataLabelsAlignDoesntRenderForDefault_Correct()
        {
            var chart = new Highcharts();
            var renderer = new HighchartsRenderer(chart);
            var defaultValue = PlotOptionsBulletDataLabelsAlign.Center;

            chart.PlotOptions.Bullet.DataLabels.Align = defaultValue;
        ...
        public void Test_IfDataLabelsAllowOverlapRenders_Correct()
        {
            ...
            chart.PlotOptions.Bullet.DataLabels.AllowOverlap = value;
        ...
        public void Test_IfDataLabelsAllowOverlapDoesntRenderForDefault_Correct()
        {
            ...
            chart.PlotOptions.Bullet.DataLabels.AllowOverlap = defaultValue;
        ...
        public void Test_IfDataLabelsAnimationDeferRenders_Correct(int value)
        {
            ...
            chart.PlotOptions.Bullet.DataLabels.Animation.Defer = value;
        ...
        public void Test_IfDataLabelsAnimationDeferDoesntRenderForDefault_Correct()
        {
            ...
            chart.PlotOptions.Bullet.DataLabels.Animation.Defer = defaultValue;
        ...
        public void Test_IfDataLabelsBackgroundColorRenders_Correct(string value)
        {
            ...
            chart.PlotOptions.Bullet.DataLabels.BackgroundColor = value;
        ...
        public void Test_IfDataLabelsBackgroundColorDoesntRenderForDefault_Correct()
        {
            ...
            chart.PlotOptions.Bullet.DataLabels.BackgroundColor = defaultValue;
        ...
        public void Test_IfDataLabelsBorderColorRenders_Correct(string value)
        {
            ...
            chart.PlotOptions.Bullet.DataLabels.BorderColor = value;
        ...
        public void Test_IfDataLabelsBorderColorDoesntRenderForDefault_Correct()
        {
            ...
            chart.PlotOptions.Bullet.DataLabels.BorderColor = defaultValue;
        ...
        public void Test_IfDataLabelsBorderRadiusRenders_Correct(double value)
        {
            ...
            chart.PlotOptions.Bullet.DataLabels.BorderRadius = value;
        ...
        public void Test_IfDataLabelsBorderRadiusDoesntRenderForDefault_Correct()
        {
            ...
            chart.PlotOptions.Bullet.DataLabels.BorderRadius = defaultValue;
        ...
        public void Test_IfDataLabelsBorderWidthRenders_Correct(double value)
        {
            ...
            chart.PlotOptions.Bullet.DataLabels.BorderWidth = value;
        ...
        public void Test_IfDataLabelsBorderWidthDoesntRenderForDefault_Correct()
        {
            ...
            chart.PlotOptions.Bullet.DataLabels.BorderWidth = defaultValue;
        ...
        public void Test_IfDataLabelsClassNameRenders_Correct(string value)
        {
            ...
            chart.PlotOptions.Bullet.DataLabels.ClassName = value;
        ...
        public void Test_IfDataLabelsClassNameDoesntRenderForDefault_Correct()
        {
            ...
            chart.PlotOptions.Bullet.DataLabels.ClassName = defaultValue;
        ...
        public void Test_IfDataLabelsColorRenders_Correct(string value)
        {
            ...
            chart.PlotOptions.Bullet.DataLabels.Color = value;
        ...
        public void Test_IfDataLabelsColorDoesntRenderForDefault_Correct()
        {
            ...
            chart.PlotOptions.Bullet.DataLabels.Color = defaultValue;
        ...
        public void Test_IfDataLabelsCropRenders_Correct()
        {
            ...
            chart.PlotOptions.Bullet.DataLabels.Crop = value;
        ...
        public void Test_IfDataLabelsCropDoesntRenderForDefault_Correct()
        {
            ...
            chart.PlotOptions.Bullet.DataLabels.Crop = defaultValue;
        ...
        public void Test_IfDataLabelsDeferBoolRenders_Correct()
        {
            ...
            chart.PlotOptions.Bullet.DataLabels.DeferBool = value;
        ...
        public void Test_IfDataLabelsDeferBoolDoesntRenderForDefault_Correct()
        {
            ...
            chart.PlotOptions.Bullet.DataLabels.DeferBool = defaultValue;
        ...
        public void Test_IfDataLabelsDeferRenders_Correct(double value)
        {
            ...
            chart.PlotOptions.Bullet.DataLabels.Defer = value;
        ...
        public void Test_IfDataLabelsEnabledBoolRenders_Correct()
        {
            ...
            chart.PlotOptions.Bullet.DataLabels.Enabled = value;
        ...
        public void Test_IfDataLabelsEnabledBoolDoesntRenderForDefault_Correct()
        {
            ...
            chart.PlotOptions.Bullet.DataLabels.Enabled = defaultValue;
        ...
        public void Test_IfDataLabelsFilterOperatorRenders_Correct(string value)
        {
            ...
            chart.PlotOptions.Bullet.DataLabels.Filter.Operator = value;
        ...
        public void Test_IfDataLabelsFilterOperatorDoesntRenderForDefault_Correct()
        {
            ...
            chart.PlotOptions.Bullet.DataLabels.Filter.Operator = defaultValue;
        ...
        public void Test_IfDataLabelsFilterPropertyRenders_Correct(string value)
        {
            ...
            chart.PlotOptions.Bullet.DataLabels.Filter.Property = value;
        ...
        public void Test_IfDataLabelsFilterPropertyDoesntRenderForDefault_Correct()
        {
            ...
            chart.PlotOptions.Bullet.DataLabels.Filter.Property = defaultValue;
        ...
        public void Test_IfDataLabelsFilterValueRenders_Correct(double value)
        {
            ...
            chart.PlotOptions.Bullet.DataLabels.Filter.Value = value;
        ...
        public void Test_IfDataLabelsFilterValueDoesntRenderForDefault_Correct()
        {
            ...
            chart.PlotOptions.Bullet.DataLabels.Filter.Value = defaultValue;
        ...
        public void Test_IfDataLabelsFormatRenders_Correct(string value)
        {
            ...
            chart.PlotOptions.Bullet.DataLabels.Format = value;
        ...
        public void Test_IfDataLabelsFormatDoesntRenderForDefault_Correct()
        {
            ...
            chart.PlotOptions.Bullet.DataLabels.Format = defaultValue;
        ...
        public void Test_IfDataLabelsFormatterRenders_Correct(string value)
        {
            ...
            chart.PlotOptions.Bullet.DataLabels.Formatter = value;
        ...
        public void Test_IfDataLabelsFormatterDoesntRenderForDefault_Correct()
        {
            ...
            chart.PlotOptions.Bullet.DataLabels.Formatter = defaultValue;
        ...
        public void Test_IfDataLabelsInsideRenders_Correct(bool value)
        {
            ...
            chart.PlotOptions.Bullet.DataLabels.Inside = value;
        ...
        public void Test_IfDataLabelsInsideDoesntRenderForDefault_Correct()
        {
            ...
            chart.PlotOptions.Bullet.DataLabels.Inside = defaultValue;
        ...
        public void Test_IfDataLabelsNullFormatBoolRenders_Correct(bool value)
        {
            ...
            chart.PlotOptions.Bullet.DataLabels.NullFormatBool = value;
        ...
        public void Test_IfDataLabelsNullFormatBoolDoesntRenderForDefault_Correct()
        {
            ...
            chart.PlotOptions.Bullet.DataLabels.NullFormatBool = defaultValue;
        ...
        public void Test_IfDataLabelsNullFormatRenders_Correct(string value)
        {
            ...
            chart.PlotOptions.Bullet.DataLabels.NullFormat = value;
        ...
        public void Test_IfDataLabelsNullFormatDoesntRenderForDefault_Correct()
        {
            ...
            chart.PlotOptions.Bullet.DataLabels.NullFormat = defaultValue;
        ...
        public void Test_IfDataLabelsNullFormatterRenders_Correct(string value)
        {
            ...
            chart.PlotOptions.Bullet.DataLabels.NullFormatter = value;
        ...
        public void Test_IfDataLabelsNullFormatterDoesntRenderForDefault_Correct()
        {
            ...
            chart.PlotOptions.Bullet.DataLabels.NullFormatter = defaultValue;

            Assert.DoesNotContain($"nullFormatter", renderer.RenderHtml());
        }

        [Theory]
        [InlineData(PlotOptionsBulletDataLabelsOverflow.Allow)]
        public void Test_IfDataLabelsOverflowRenders_Correct(PlotOptionsBulletDataLabelsOverflow align)
        {
            var chart = new Highcharts();
            var renderer = new HighchartsRenderer(chart);

            chart.PlotOptions.Bullet.DataLabels.Overflow = align;
        ...
        public void Test_IfDataLabelsOverflowDoesntRenderForDefault_Correct()
        {
            var chart = new Highcharts();
            var renderer = new HighchartsRenderer(chart);
            var defaultValue = PlotOptionsBulletDataLabelsOverflow.Justify;

            chart.PlotOptions.Bullet.DataLabels.Overflow = defaultValue;
        ...
        public void Test_IfDataLabelsPaddingRenders_Correct(double value)
        {
            ...
            chart.PlotOptions.Bullet.DataLabels.Padding = value;
        ...
        public void Test_IfDataLabelsPaddingDoesntRenderForDefault_Correct()
        {
            ...
            chart.PlotOptions.Bullet.DataLabels.Padding = defaultValue;

            Assert.DoesNotContain($"padding", renderer.RenderHtml());
        }

        [Theory]
        [InlineData(PlotOptionsBulletDataLabelsPosition.Left)]
        [InlineData(PlotOptionsBulletDataLabelsPosition.Right)]
        public void Test_IfDataLabelsPositionRenders_Correct(PlotOptionsBulletDataLabelsPosition align)
        {
            var chart = new Highcharts();
            var renderer = new HighchartsRenderer(chart);

            chart.PlotOptions.Bullet.DataLabels.Position = align;
        ...
        public void Test_IfDataLabelsPositionDoesntRenderForDefault_Correct()
        {
            var chart = new Highcharts();
            var renderer = new HighchartsRenderer(chart);
            var defaultValue = PlotOptionsBulletDataLabelsPosition.Center;

            chart.PlotOptions.Bullet.DataLabels.Position = defaultValue;
        ...
        public void Test_IfDataLabelsRotationRenders_Correct(double value)
        {
            ...
            chart.PlotOptions.Bullet.DataLabels.Rotation = value;
        ...
        public void Test_IfDataLabelsRotationDoesntRenderForDefault_Correct()
        {
            ...
            chart.PlotOptions.Bullet.DataLabels.Rotation = defaultValue;
        ...
        public void Test_IfDataLabelsShadowBoolRenders_Correct()
        {
            ...
            chart.PlotOptions.Bullet.DataLabels.ShadowBool = value;
        ...
        public void Test_IfDataLabelsShadowRenders_Correct(string color, int offsetX, int offsetY, double opacity, int width)
        {
            ...
            chart.PlotOptions.Bullet.DataLabels.Shadow = new Shadow()
            {
                Color = color,
                OffsetX = offsetX,
                OffsetY = offsetY,
        ...
        public void Test_IfDataLabelsShadowBoolDoesntRenderForDefault_Correct()
        {
            ...
            chart.PlotOptions.Bullet.DataLabels.ShadowBool = defaultValue;
        ...
        public void Test_IfDataLabelsShapeRenders_Correct(string value)
        {
            ...
            chart.PlotOptions.Bullet.DataLabels.Shape = value;
        ...
        public void Test_IfDataLabelsShapeDoesntRenderForDefault_Correct()
        {
            ...
            chart.PlotOptions.Bullet.DataLabels.Shape = defaultValue;
        ...
        public void Test_IfDataLabelsStyleStringRenders_Correct(string param1, string param1_value)
        {
            var chart = new Highcharts();
            var renderer = new HighchartsRenderer(chart);
            var pathToProperty = new List<string>() { "plotOptions", "bullet", "dataLabels", "style" };
            var style = new Hashtable();
            style.Add(param1, param1_value);

            chart.PlotOptions.Bullet.DataLabels.Style = style;
        ...
        public void Test_IfDataLabelsTextPathEnabledRenders_Correct(bool value)
        {
            var chart = new Highcharts();
            var renderer = new HighchartsRenderer(chart);
            var pathToProperty = new List<string> { "plotOptions", "bullet", "dataLabels", "textPath" };

            chart.PlotOptions.Bullet.DataLabels.TextPath.Enabled = value;
        ...
        public void Test_IfDataLabelsTextPathEnabledDoesntRenderForDefault_Correct()
        {
            ...
            chart.PlotOptions.Bullet.DataLabels.TextPath.Enabled = defaultValue;
        ...
        public void Test_IfDataLabelsUseHTMLRenders_Correct()
        {
            ...
            chart.PlotOptions.Bullet.DataLabels.UseHTML = value;
        ...
        public void Test_IfDataLabelsUseHTMLDoesntRenderForDefault_Correct()
        {
            ...
            chart.PlotOptions.Bullet.DataLabels.UseHTML = defaultValue;

            Assert.DoesNotContain($"useHTML", renderer.RenderHtml());
        }

        [Theory]
        [InlineData(PlotOptionsBulletDataLabelsVerticalAlign.Middle)]
        [InlineData(PlotOptionsBulletDataLabelsVerticalAlign.Top)]
        public void Test_IfDataLabelsVerticalAlignRenders_Correct(PlotOptionsBulletDataLabelsVerticalAlign align)
        {
            var chart = new Highcharts();
            var renderer = new HighchartsRenderer(chart);

            chart.PlotOptions.Bullet.DataLabels.VerticalAlign = align;
        ...
        public void Test_IfDataLabelsVerticalAlignDoesntRenderForDefault_Correct()
        {
            var chart = new Highcharts();
            var renderer = new HighchartsRenderer(chart);
            var defaultValue = PlotOptionsBulletDataLabelsVerticalAlign.Bottom;

            chart.PlotOptions.Bullet.DataLabels.VerticalAlign = defaultValue;
        ...
        public void Test_IfDataLabelsXRenders_Correct(double value)
        {
            ...
            chart.PlotOptions.Bullet.DataLabels.X = value;
        ...
        public void Test_IfDataLabelsXDoesntRenderForDefault_Correct()
        {
            ...
            chart.PlotOptions.Bullet.DataLabels.X = defaultValue;
        ...
        public void Test_IfDataLabelsYRenders_Correct(double value)
        {
            ...
            chart.PlotOptions.Bullet.DataLabels.Y = value;
        ...
        public void Test_IfDataLabelsYDoesntRenderForDefault_Correct()
        {
            ...
            chart.PlotOptions.Bullet.DataLabels.Y = defaultValue;
        ...
        public void Test_IfDataLabelsZRenders_Correct(double value)
        {
            ...
            chart.PlotOptions.Bullet.DataLabels.ZIndex = value;
        ...
        public void Test_IfDataLabelsZDoesntRenderForDefault_Correct()
        {
            ...
            chart.PlotOptions.Bullet.DataLabels.ZIndex = defaultValue;
        ...
        public void Test_IfDescriptionRenders_Correct(string description)
        {
            ...
            chart.PlotOptions.Bullet.Description = description;
        ...
        public void Test_IfDragDropDraggableXRenders_Correct(bool value)
        {
            var chart = new Highcharts();
            var renderer = new HighchartsRenderer(chart);
            var pathToProperty = new List<string> { "plotOptions", "bullet", "dragDrop" };

            chart.PlotOptions.Bullet.DragDrop.DraggableX = value;
        ...
        public void Test_IfDragDropDraggableXDoesntRenderForDefault_Correct()
        {
            ...
            chart.PlotOptions.Bullet.DragDrop.DraggableX = defaultValue;
        ...
        public void Test_IfDragDropDraggableYRenders_Correct(bool value)
        {
            ...
            chart.PlotOptions.Bullet.DragDrop.DraggableY = value;
        ...
        public void Test_IfDragDropDraggableYDoesntRenderForDefault_Correct()
        {
            ...
            chart.PlotOptions.Bullet.DragDrop.DraggableY = defaultValue;
        ...
        public void Test_IfDragDropDragMaxXRenders_Correct(double value)
        {
            ...
            chart.PlotOptions.Bullet.DragDrop.DragMaxX = value;
        ...
        public void Test_IfDragDropDragMaxXDoesntRenderForDefault_Correct()
        {
            ...
            chart.PlotOptions.Bullet.DragDrop.DragMaxX = defaultValue;
        ...
        public void Test_IfDragDropDragMaxYRenders_Correct(double value)
        {
            ...
            chart.PlotOptions.Bullet.DragDrop.DragMaxY = value;
        ...
        public void Test_IfDragDropDragMaxYDoesntRenderForDefault_Correct()
        {
            ...
            chart.PlotOptions.Bullet.DragDrop.DragMaxY = defaultValue;
        ...
        public void Test_IfDragDropDragMinXRenders_Correct(double value)
        {
            ...
            chart.PlotOptions.Bullet.DragDrop.DragMinX = value;
        ...
        public void Test_IfDragDropDragMinXDoesntRenderForDefault_Correct()
        {
            ...
            chart.PlotOptions.Bullet.DragDrop.DragMinX = defaultValue;
        ...
        public void Test_IfDragDropDragMinYRenders_Correct(double value)
        {
            ...
            chart.PlotOptions.Bullet.DragDrop.DragMinY = value;
        ...
        public void Test_IfDragDropDragMinYDoesntRenderForDefault_Correct()
        {
            ...
            chart.PlotOptions.Bullet.DragDrop.DragMinY = defaultValue;
        ...
        public void Test_IfDragDropDragPrecisionXRenders_Correct(double value)
        {
            ...
            chart.PlotOptions.Bullet.DragDrop.DragPrecisionX = value;
        ...
        public void Test_IfDragDropDragPrecisionXDoesntRenderForDefault_Correct()
        {
            ...
            chart.PlotOptions.Bullet.DragDrop.DragPrecisionX = defaultValue;
        ...
        public void Test_IfDragDropDragPrecisionYRenders_Correct(double value)
        {
            ...
            chart.PlotOptions.Bullet.DragDrop.DragPrecisionY = value;
        ...
        public void Test_IfDragDropDragPrecisionYDoesntRenderForDefault_Correct()
        {
            ...
            chart.PlotOptions.Bullet.DragDrop.DragPrecisionY = defaultValue;
        ...
        public void Test_IfDragDropDragSensitivityRenders_Correct(double value)
        {
            ...
            chart.PlotOptions.Bullet.DragDrop.DragSensitivity = value;
        ...
        public void Test_IfDragDropDragSensitivityDoesntRenderForDefault_Correct()
        {
            ...
            chart.PlotOptions.Bullet.DragDrop.DragSensitivity = defaultValue;
        ...
        public void Test_IfDragDropGroupByRenders_Correct(string value)
        {
            ...
            chart.PlotOptions.Bullet.DragDrop.GroupBy = value;
        ...
        public void Test_IfDragDropGroupByDoesntRenderForDefault_Correct()
        {
            ...
            chart.PlotOptions.Bullet.DragDrop.GroupBy = defaultValue;
        ...
        public void Test_IfDragDropGuideBoxDefaultClassNameRenders_Correct(string value)
        {
            var chart = new Highcharts();
            var renderer = new HighchartsRenderer(chart);
            var pathToProperty = new List<string>() { "plotOptions", "bullet", "dragDrop", "guideBox", "default" };


            chart.PlotOptions.Bullet.DragDrop.GuideBox.Default.ClassName = value;
        ...
        public void Test_IfDragDropGuideBoxDefaultDoesntRenderForDefault_Correct()
        {
            ...
            chart.PlotOptions.Bullet.DragDrop.GuideBox.Default.ClassName = defaultValue;
        ...
        public void Test_IfDragDropGuideBoxDefaultColorRenders_Correct(string value)
        {
            ...
            chart.PlotOptions.Bullet.DragDrop.GuideBox.Default.Color = value;
        ...
        public void Test_IfDragDropGuideBoxDefaultColorDoesntRenderForDefault_Correct()
        {
            ...
            chart.PlotOptions.Bullet.DragDrop.GuideBox.Default.Color = defaultValue;
        ...
        public void Test_IfDragDropGuideBoxDefaultCursorRenders_Correct(string value)
        {
            ...
            chart.PlotOptions.Bullet.DragDrop.GuideBox.Default.Cursor = value;
        ...
        public void Test_IfDragDropGuideBoxDefaultCursorDoesntRenderForDefault_Correct()
        {
            ...
            chart.PlotOptions.Bullet.DragDrop.GuideBox.Default.Cursor = defaultValue;
        ...
        public void Test_IfDragDropGuideBoxDefaultLineColorRenders_Correct(string value)
        {
            ...
            chart.PlotOptions.Bullet.DragDrop.GuideBox.Default.LineColor = value;
        ...
        public void Test_IfDragDropGuideBoxDefaultLineColorDoesntRenderForDefault_Correct()
        {
            ...
            chart.PlotOptions.Bullet.DragDrop.GuideBox.Default.LineColor = defaultValue;
        ...
        public void Test_IfDragDropGuideBoxDefaultLineWidthRenders_Correct(double value)
        {
            ...
            chart.PlotOptions.Bullet.DragDrop.GuideBox.Default.LineWidth = value;
        ...
        public void Test_IfDragDropGuideBoxDefaultLineWidthDoesntRenderForDefault_Correct()
        {
            ...
            chart.PlotOptions.Bullet.DragDrop.GuideBox.Default.LineWidth = defaultValue;
        ...
        public void Test_IfDragDropGuideBoxDefaultZIndexRenders_Correct(double value)
        {
            ...
            chart.PlotOptions.Bullet.DragDrop.GuideBox.Default.ZIndex = value;
        ...
        public void Test_IfDragDropGuideBoxDefaultZIndexDoesntRenderForDefault_Correct()
        {
            ...
            chart.PlotOptions.Bullet.DragDrop.GuideBox.Default.ZIndex = defaultValue;
        ...
        public void Test_IfDragDropLiveRedrawRenders_Correct()
        {
            ...
            chart.PlotOptions.Bullet.DragDrop.LiveRedraw = value;
        ...
        public void Test_IfDragDropLiveRedrawDoesntRenderForDefault_Correct()
        {
            ...
            chart.PlotOptions.Bullet.DragDrop.LiveRedraw = defaultValue;
        ...
        public void Test_IfEnableMouseTrackingRenders_Correct()
        {
            ...
            chart.PlotOptions.Bullet.EnableMouseTracking = value;
        ...
        public void Test_IfEventsAfterAnimateRenders_Correct(string value)
        {
            var chart = new Highcharts();
            var renderer = new HighchartsRenderer(chart);
            var pathToProperty = new List<string> { "plotOptions", "bullet", "events" };

            chart.PlotOptions.Bullet.Events.AfterAnimate = value;
        ...
        public void Test_IfEventsAfterAnimateDoesntRenderForDefault_Correct()
        {
            ...
            chart.PlotOptions.Bullet.Events.AfterAnimate = defaultValue;
        ...
        public void Test_IfEventsCheckboxClickRenders_Correct(string value)
        {
            ...
            chart.PlotOptions.Bullet.Events.CheckboxClick = value;
        ...
        public void Test_IfEventsCheckboxClickDoesntRenderForDefault_Correct()
        {
            ...
            chart.PlotOptions.Bullet.Events.CheckboxClick = defaultValue;
        ...
        public void Test_IfEventsClickRenders_Correct(string value)
        {
            ...
            chart.PlotOptions.Bullet.Events.Click = value;
        ...
        public void Test_IfEventsclickDoesntRenderForDefault_Correct()
        {
            ...
            chart.PlotOptions.Bullet.Events.Click = defaultValue;
        ...
        public void Test_IfEventsHideRenders_Correct(string value)
        {
            ...
            chart.PlotOptions.Bullet.Events.Hide = value;
        ...
        public void Test_IfEventsHideDoesntRenderForDefault_Correct()
        {
            ...
            chart.PlotOptions.Bullet.Events.Hide = defaultValue;
        ...
        public void Test_IfEventsLegendItemClickRenders_Correct(string value)
        {
            ...
            chart.PlotOptions.Bullet.Events.LegendItemClick = value;
        ...
        public void Test_IfEventsLegendItemClickDoesntRenderForDefault_Correct()
        {
            ...
            chart.PlotOptions.Bullet.Events.LegendItemClick = defaultValue;
        ...
        public void Test_IfEventsMouseOutRenders_Correct(string value)
        {
            ...
            chart.PlotOptions.Bullet.Events.MouseOut = value;
        ...
        public void Test_IfEventsMouseOutDoesntRenderForDefault_Correct()
        {
            ...
            chart.PlotOptions.Bullet.Events.MouseOut = defaultValue;
        ...
        public void Test_IfEventsMouseOverRenders_Correct(string value)
        {
            ...
            chart.PlotOptions.Bullet.Events.MouseOver = value;
        ...
        public void Test_IfEventsMouseOverDoesntRenderForDefault_Correct()
        {
            ...
            chart.PlotOptions.Bullet.Events.MouseOver = defaultValue;
        ...
        public void Test_IfEventsShowRenders_Correct(string value)
        {
            ...
            chart.PlotOptions.Bullet.Events.Show = value;
        ...
        public void Test_IfEventsShowDoesntRenderForDefault_Correct()
        {
            ...
            chart.PlotOptions.Bullet.Events.Show = defaultValue;
        ...
        public void Test_IfFindNearestPointByRenders_Correct()
        {
            var chart = new Highcharts();
            var renderer = new HighchartsRenderer(chart);
            var value = PlotOptionsBulletFindNearestPointBy.Xy;

            chart.PlotOptions.Bullet.FindNearestPointBy = value;
        ...
        public void Test_IfFindNearestPointByDoesntRenderForDefault_Correct()
        {
            var chart = new Highcharts();
            var renderer = new HighchartsRenderer(chart);
            var value = PlotOptionsBulletFindNearestPointBy.X;
        ...
        public void Test_IfGetExtremesFromAllRenders_Correct()
        {
            ...
            chart.PlotOptions.Bullet.GetExtremesFromAll = value;
        ...
        public void Test_IfIncludeInDataExportFromAllRenders_Correct(bool value)
        {
            ...
            chart.PlotOptions.Bullet.IncludeInDataExport = value;
        ...
        public void Test_IfKeysRenders_Correct(string arg1, string arg2, string arg3, string arg4)
        {
            ...
            chart.PlotOptions.Bullet.Keys = value;
        ...
        public void Test_IfLabelConnectorAllowedRenders_Correct()
        {
            var chart = new Highcharts();
            var renderer = new HighchartsRenderer(chart);
            var pathToProperty = new List<string> { "plotOptions", "bullet", "label" };
            var value = true;

            chart.PlotOptions.Bullet.Label.ConnectorAllowed = value;
        ...
        public void Test_IfLabelConnectorAllowedDoesntRenderForDefault_Correct()
        {
            ...
            chart.PlotOptions.Bullet.Label.ConnectorAllowed = defaultValue;
        ...
        public void Test_IfLabelConnectorNeighbourDistanceRenders_Correct(double value)
        {
            ...
            chart.PlotOptions.Bullet.Label.ConnectorNeighbourDistance = value;
        ...
        public void Test_IfLabelConnectorNeighbourDistanceDoesntRenderForDefault_Correct()
        {
            ...
            chart.PlotOptions.Bullet.Label.ConnectorNeighbourDistance = defaultValue;
        ...
        public void Test_IfLabelEnabledRenders_Correct()
        {
            ...
            chart.PlotOptions.Bullet.Label.Enabled = value;
        ...
        public void Test_IfLabelEnabledDoesntRenderForDefault_Correct()
        {
            ...
            chart.PlotOptions.Bullet.Label.Enabled = defaultValue;
        ...
        public void Test_IfLabelFormatRenders_Correct(string value)
        {
            ...
            chart.PlotOptions.Bullet.Label.Format = value;
        ...
        //    chart.PlotOptions.Bullet.Label.Format = defaultValue;
        ...
        public void Test_IfLabelFormatterRenders_Correct(string value)
        {
            ...
            chart.PlotOptions.Bullet.Label.Formatter = value;
        ...
        public void Test_IfLabelFormatterDoesntRenderForDefault_Correct()
        {
            ...
            chart.PlotOptions.Bullet.Label.Formatter = defaultValue;
        ...
        public void Test_IfLabelMaxFontSizeRenders_Correct(double value)
        {
            ...
            chart.PlotOptions.Bullet.Label.MaxFontSize = value;
        ...
        public void Test_IfLabelMaxFontSizeDoesntRenderForDefault_Correct()
        {
            ...
            chart.PlotOptions.Bullet.Label.MaxFontSize = defaultValue;
        ...
        public void Test_IfLabelMinFontSizeRenders_Correct(double value)
        {
            ...
            chart.PlotOptions.Bullet.Label.MinFontSize = value;
        ...
        public void Test_IfLabelMinFontSizeDoesntRenderForDefault_Correct()
        {
            ...
            chart.PlotOptions.Bullet.Label.MinFontSize = defaultValue;
        ...
        public void Test_IfLabelOnAreaRenders_Correct(bool value)
        {
            ...
            chart.PlotOptions.Bullet.Label.OnArea = value;
        ...
        public void Test_IfLabelOnAreaDoesntRenderForDefault_Correct()
        {
            ...
            chart.PlotOptions.Bullet.Label.OnArea = defaultValue;
        ...
        public void Test_IfLabelStyleRenders_Correct(string paramName, string paramValue)
        {
            ...
            chart.PlotOptions.Bullet.Label.Style = value;
        ...
        //    chart.PlotOptions.Bullet.Label.Style = defaultValue;
        ...
        //[Theory]
        //[InlineData(PlotOptionsBulletLinecap.Square)]
        ////missing PlotOptionsBulletLinecap.Butt ?
        //public void Test_IfLinecapRenders_Correct(PlotOptionsBulletLinecap value)
        //{
        //    var chart = new Highcharts();
        //    var renderer = new HighchartsRenderer(chart);

        //    chart.PlotOptions.Bullet.Linecap = value;
        ...
        //    var chart = new Highcharts();
        //    var renderer = new HighchartsRenderer(chart);
        //    var defaultValue = PlotOptionsBulletLinecap.Round;

        //    chart.PlotOptions.Bullet.Linecap = defaultValue;
        ...
        public void Test_IfLinkedToRenders_Correct(string value)
        {
            ...
            chart.PlotOptions.Bullet.LinkedTo = value;
        ...
        public void Test_IfLinkedToDoesntRenderForDefault_Correct()
        {
            ...
            chart.PlotOptions.Bullet.LinkedTo = defaultValue;
        ...
        public void Test_IfNegativeColorRenders_Correct(string value)
        {
            ...
            chart.PlotOptions.Bullet.NegativeColor = value;
        ...
        public void Test_IfNegativeColorDoesntRenderForDefault_Correct()
        {
            ...
            chart.PlotOptions.Bullet.NegativeColor = defaultValue;
        ...
        //    var chart = new Highcharts();
        //    var renderer = new HighchartsRenderer(chart);
        //    var pathToProperty = new List<string>() { "plotOptions", "bullet", "onPoint", "connectorOptions" };

        //    chart.PlotOptions.Bullet.OnPoint.ConnectorOptions.Dashstyle = value;
        ...
        public void Test_IfOnPointConnectorOptionsStrokeRenders_Correct(string value)
        {
            ...
            chart.PlotOptions.Bullet.OnPoint.ConnectorOptions.Stroke = value;
        ...
        public void Test_IfOnPointConnectorOptionsStrokeDoesntRenderForDefault_Correct()
        {
            ...
            chart.PlotOptions.Bullet.OnPoint.ConnectorOptions.Stroke = defaultValue;
        ...
        public void Test_IfOnPointConnectorOptionsWidthRenders_Correct(double value)
        {
            ...
            chart.PlotOptions.Bullet.OnPoint.ConnectorOptions.Width = value;
        ...
        public void Test_IfOnPointConnectorOptionsWidthDoesntRenderForDefault_Correct()
        {
            ...
            chart.PlotOptions.Bullet.OnPoint.ConnectorOptions.Width = defaultValue;
        ...
        public void Test_IfOnPointIdRenders_Correct(string value)
        {
            var chart = new Highcharts();
            var renderer = new HighchartsRenderer(chart);
            var pathToProperty = new List<string>() { "plotOptions", "bullet", "onPoint" };

            chart.PlotOptions.Bullet.OnPoint.Id = value;
        ...
        public void Test_IfOnPointIdDoesntRenderForDefault_Correct()
        {
            ...
            chart.PlotOptions.Bullet.OnPoint.Id = defaultValue;
        ...
        public void Test_IfOnPointPositionOffsetXRenders_Correct(double value)
        {
            var chart = new Highcharts();
            var renderer = new HighchartsRenderer(chart);
            var pathToProperty = new List<string>() { "plotOptions", "bullet", "onPoint", "position" };

            chart.PlotOptions.Bullet.OnPoint.Position.OffsetX = value;
        ...
        public void Test_IfOnPointOffsetXDoesntRenderForDefault_Correct()
        {
            ...
            chart.PlotOptions.Bullet.OnPoint.Position.OffsetX = defaultValue;
        ...
        public void Test_IfOnPointPositionOffsetYRenders_Correct(double value)
        {
            ...
            chart.PlotOptions.Bullet.OnPoint.Position.OffsetY = value;
        ...
        public void Test_IfOnPointOffsetYDoesntRenderForDefault_Correct()
        {
            ...
            chart.PlotOptions.Bullet.OnPoint.Position.OffsetY = defaultValue;
        ...
        public void Test_IfOnPointPositionXRenders_Correct(double value)
        {
            ...
            chart.PlotOptions.Bullet.OnPoint.Position.X = value;
        ...
        public void Test_IfOnPointXDoesntRenderForDefault_Correct()
        {
            ...
            chart.PlotOptions.Bullet.OnPoint.Position.X = defaultValue;
        ...
        public void Test_IfOnPointPositionYRenders_Correct(double value)
        {
            ...
            chart.PlotOptions.Bullet.OnPoint.Position.Y = value;
        ...
        public void Test_IfOnPointYDoesntRenderForDefault_Correct()
        {
            ...
            chart.PlotOptions.Bullet.OnPoint.Position.Y = defaultValue;
        ...
        public void Test_IfOpacityRenders_Correct(double value)
        {
            ...
            chart.PlotOptions.Bullet.Opacity = value;
        ...
        public void Test_IfOpacityDoesntRenderForDefault_Correct()
        {
            ...
            chart.PlotOptions.Bullet.Opacity = defaultValue;
        ...
        public void Test_IfPointEventsClickRenders_Correct(string value)
        {
            var chart = new Highcharts();
            var renderer = new HighchartsRenderer(chart);
            var pathToProperty = new List<string>() { "plotOptions", "bullet", "point", "events" };

            chart.PlotOptions.Bullet.Point.Events.Click = value;
        ...
        public void Test_IfPointEventsClickDoesntRenderForDefault_Correct()
        {
            ...
            chart.PlotOptions.Bullet.Point.Events.Click = defaultValue;
        ...
        public void Test_IfPointEventsDragRenders_Correct(string value)
        {
            ...
            chart.PlotOptions.Bullet.Point.Events.Drag = value;
        ...
        public void Test_IfPointEventsDragDoesntRenderForDefault_Correct()
        {
            ...
            chart.PlotOptions.Bullet.Point.Events.Drag = defaultValue;
        ...
        public void Test_IfPointEventsDragStartRenders_Correct(string value)
        {
            ...
            chart.PlotOptions.Bullet.Point.Events.DragStart = value;
        ...
        public void Test_IfPointEventsDragStartDoesntRenderForDefault_Correct()
        {
            ...
            chart.PlotOptions.Bullet.Point.Events.DragStart = defaultValue;
        ...
        public void Test_IfPointEventsDropRenders_Correct(string value)
        {
            ...
            chart.PlotOptions.Bullet.Point.Events.Drop = value;
        ...
        public void Test_IfPointEventsDropDoesntRenderForDefault_Correct()
        {
            ...
            chart.PlotOptions.Bullet.Point.Events.Drop = defaultValue;
        ...
        public void Test_IfPointEventsMouseOutRenders_Correct(string value)
        {
            ...
            chart.PlotOptions.Bullet.Point.Events.MouseOut = value;
        ...
        public void Test_IfPointEventsMouseOutDoesntRenderForDefault_Correct()
        {
            ...
            chart.PlotOptions.Bullet.Point.Events.MouseOut = defaultValue;
        ...
        public void Test_IfPointEventsMouseOverRenders_Correct(string value)
        {
            ...
            chart.PlotOptions.Bullet.Point.Events.MouseOver = value;
        ...
        public void Test_IfPointEventsMouseOverDoesntRenderForDefault_Correct()
        {
            ...
            chart.PlotOptions.Bullet.Point.Events.MouseOver = defaultValue;
        ...
        public void Test_IfPointEventsRemoveRenders_Correct(string value)
        {
            ...
            chart.PlotOptions.Bullet.Point.Events.Remove = value;
        ...
        public void Test_IfPointEventsRemoveDoesntRenderForDefault_Correct()
        {
            ...
            chart.PlotOptions.Bullet.Point.Events.Remove = defaultValue;
        ...
        public void Test_IfPointEventsSelectRenders_Correct(string value)
        {
            ...
            chart.PlotOptions.Bullet.Point.Events.Select = value;
        ...
        public void Test_IfPointEventsSelectDoesntRenderForDefault_Correct()
        {
            ...
            chart.PlotOptions.Bullet.Point.Events.Select = defaultValue;
        ...
        public void Test_IfPointEventsUnselectRenders_Correct(string value)
        {
            ...
            chart.PlotOptions.Bullet.Point.Events.Unselect = value;
        ...
        public void Test_IfPointEventsUnselectDoesntRenderForDefault_Correct()
        {
            ...
            chart.PlotOptions.Bullet.Point.Events.Unselect = defaultValue;
        ...
        public void Test_IfPointEventsUpdateRenders_Correct(string value)
        {
            ...
            chart.PlotOptions.Bullet.Point.Events.Update = value;
        ...
        public void Test_IfPointEventsUpdateDoesntRenderForDefault_Correct()
        {
            ...
            chart.PlotOptions.Bullet.Point.Events.Update = defaultValue;
        ...
        public void Test_IfPointDescriptionFormatterRenders_Correct(string value)
        {
            ...
            chart.PlotOptions.Bullet.PointDescriptionFormatter = value;
        ...
        public void Test_IfPointDescriptionFormatterDoesntRenderForDefault_Correct()
        {
            ...
            chart.PlotOptions.Bullet.PointDescriptionFormatter = defaultValue;
        ...
        public void Test_IfPointIntervalRenders_Correct(double value)
        {
            ...
            chart.PlotOptions.Bullet.PointInterval = value;
        ...
        public void Test_IfPointIntervalDoesntRenderForDefault_Correct()
        {
            ...
            chart.PlotOptions.Bullet.PointInterval = defaultValue;

            Assert.DoesNotContain($"pointInterval", renderer.RenderHtml());
        }

        [Theory]
        [InlineData(PlotOptionsBulletPointIntervalUnit.Day)]
        [InlineData(PlotOptionsBulletPointIntervalUnit.Month)]
        [InlineData(PlotOptionsBulletPointIntervalUnit.Year)]
        public void Test_IfPointIntervalUnitRenders_Correct(PlotOptionsBulletPointIntervalUnit value)
        {
            var chart = new Highcharts();
            var renderer = new HighchartsRenderer(chart);

            chart.PlotOptions.Bullet.PointIntervalUnit = value;
        ...
        public void Test_IfPointIntervalUnitDoesntRenderForDefault_Correct()
        {
            var chart = new Highcharts();
            var renderer = new HighchartsRenderer(chart);
            var defaultValue = PlotOptionsBulletPointIntervalUnit.Null;

            chart.PlotOptions.Bullet.PointIntervalUnit = defaultValue;
        ...
        public void Test_IfPointPlacementEnumRenders_Correct(PointPlacementEnum value)
        {
            ...
            chart.PlotOptions.Bullet.PointPlacement = new PointPlacement() { PointPlacementEnum = value };
        ...
        public void Test_IfPointPlacementNumberRenders_Correct(double value)
        {
            ...
            chart.PlotOptions.Bullet.PointPlacement = new PointPlacement() { Value = value };
        ...
        public void Test_IfPointPlacementDoesntRenderForDefault_Correct()
        {
            ...
            chart.PlotOptions.Bullet.PointPlacement = new PointPlacement() { PointPlacementEnum = defaultValue };
        ...
        public void Test_IfPointStartRenders_Correct(double value)
        {
            ...
            chart.PlotOptions.Bullet.PointStart = value;
        ...
        public void Test_IfPointStartDoesntRenderForDefault_Correct()
        {
            ...
            chart.PlotOptions.Bullet.PointStart = defaultValue;
        ...
        public void Test_IfRelativeXValueRenders_Correct()
        {
            ...
            chart.PlotOptions.Bullet.RelativeXValue = value;
        ...
        public void Test_IfRelativeXValueDoesntRenderForDefault_Correct()
        {
            ...
            chart.PlotOptions.Bullet.RelativeXValue = defaultValue;
        ...
        public void Test_IfSelectedRenders_Correct()
        {
            ...
            chart.PlotOptions.Bullet.Selected = value;
        ...
        public void Test_IfSelectedDoesntRenderForDefault_Correct()
        {
            ...
            chart.PlotOptions.Bullet.Selected = defaultValue;
        ...
        public void Test_IfShadowBoolRenders_Correct()
        {
            ...
            chart.PlotOptions.Bullet.ShadowBool = value;
        ...
        public void Test_IfShadowRenders_Correct(string color, int offsetX, int offsetY, double opacity, int width)
        {
            ...
            chart.PlotOptions.Bullet.Shadow = new Shadow()
            {
                Color = color,
                OffsetX = offsetX,
                OffsetY = offsetY,
        ...
        public void Test_IfShadowBoolDoesntRenderForDefault_Correct()
        {
            ...
            chart.PlotOptions.Bullet.ShadowBool = defaultValue;
        ...
        public void Test_IfShowCheckboxRenders_Correct()
        {
            ...
            chart.PlotOptions.Bullet.ShowCheckbox = value;
        ...
        public void Test_IfShowCheckboxDoesntRenderForDefault_Correct()
        {
            ...
            chart.PlotOptions.Bullet.ShowCheckbox = defaultValue;
        ...
        public void Test_IfShowInLegendRenders_Correct(bool value)
        {
            ...
            chart.PlotOptions.Bullet.ShowInLegend = value;
        ...
        public void Test_IfShowInLegendDoesntRenderForDefault_Correct()
        {
            ...
            chart.PlotOptions.Bullet.ShowInLegend = null;
        ...
        public void Test_IfSkipKeyboardNavigationRenders_Correct(bool value)
        {
            ...
            chart.PlotOptions.Bullet.SkipKeyboardNavigation = value;
        ...
        public void Test_IfSkipKeyboardNavigationDoesntRenderForDefault_Correct()
        {
            ...
            chart.PlotOptions.Bullet.SkipKeyboardNavigation = null;
        ...
        public void Test_IfSoftThresholdRenders_Correct()
        {
            ...
            chart.PlotOptions.Bullet.SoftThreshold = value;
        ...
        public void Test_IfSoftThresholdDoesntRenderForDefault_Correct()
        {
            ...
            chart.PlotOptions.Bullet.SoftThreshold = defaultValue;

            Assert.DoesNotContain($"softThreshold", renderer.RenderHtml());
        }

        [Theory]
        [InlineData(PlotOptionsBulletStacking.Overlap)]
        [InlineData(PlotOptionsBulletStacking.Percent)]
        [InlineData(PlotOptionsBulletStacking.Normal)]
        [InlineData(PlotOptionsBulletStacking.Stream)]
        public void Test_IfStackingRenders_Correct(PlotOptionsBulletStacking value)
        {
            var chart = new Highcharts();
            var renderer = new HighchartsRenderer(chart);

            chart.PlotOptions.Bullet.Stacking = value;
        ...
        public void Test_IfStackingDoesntRenderForDefault_Correct()
        {
            var chart = new Highcharts();
            var renderer = new HighchartsRenderer(chart);
            var defaultValue = PlotOptionsBulletStacking.Null;

            chart.PlotOptions.Bullet.Stacking = defaultValue;
        ...
        public void Test_IfStatesHoverAnimationDurationRenders_Correct(int value)
        {
            var chart = new Highcharts();
            var renderer = new HighchartsRenderer(chart);
            var pathToProperty = new List<string>() { "plotOptions", "bullet", "states", "hover", "animation" };

            chart.PlotOptions.Bullet.States.Hover.Animation.Duration = value;
        ...
        public void Test_IfStatesHoverAnimationDurationDoesntRenderForDefault_Correct()
        {
            ...
            chart.PlotOptions.Bullet.States.Hover.Animation.Duration = defaultValue;
        ...
        public void Test_IfStatesHoverEnabledRenders_Correct()
        {
            var chart = new Highcharts();
            var renderer = new HighchartsRenderer(chart);
            var pathToProperty = new List<string>() { "plotOptions", "bullet", "states", "hover" };
            var value = false;

            chart.PlotOptions.Bullet.States.Hover.Enabled = false;
        ...
        //    chart.PlotOptions.Bullet.States.Hover.Enabled = defaultValue;
        ...
        //    var chart = new Highcharts();
        //    var renderer = new HighchartsRenderer(chart);
        //    var pathToProperty = new List<string>() { "plotOptions", "bullet", "states", "hover", "halo" };

        //    chart.PlotOptions.Bullet.States.Hover.Halo.Attributes = value;
        ...
        public void Test_IfStatesHoverHaloOpacityRenders_Correct(double value)
        {
            ...
            chart.PlotOptions.Bullet.States.Hover.Halo.Opacity = value;
        ...
        //    chart.PlotOptions.Bullet.States.Hover.Halo.Opacity = defaultValue;
        ...
        //    chart.PlotOptions.Bullet.States.Hover.Halo.Size = value;
        ...
        public void Test_IfStatesHoverLineWidthRenders_Correct(double value)
        {
            ...
            chart.PlotOptions.Bullet.States.Hover.LineWidth = value;
        ...
        public void Test_IfStatesHoverLineWidthDoesntRenderForDefault_Correct()
        {
            ...
            chart.PlotOptions.Bullet.States.Hover.LineWidth = defaultValue;
        ...
        public void Test_IfStatesHoverLineWidthPlusRenders_Correct(double value)
        {
            ...
            chart.PlotOptions.Bullet.States.Hover.LineWidthPlus = value;
        ...
        //    chart.PlotOptions.Bullet.States.Hover.LineWidthPlus = defaultValue;
        ...
        public void Test_IfStatesHoverMarkerEnabledRenders_Correct(bool value)
        {
            var chart = new Highcharts();
            var renderer = new HighchartsRenderer(chart);
            var pathToProperty = new List<string> { "plotOptions", "bullet", "states", "hover", "marker" };

            chart.PlotOptions.Bullet.States.Hover.Marker.Enabled = value;
        ...
        public void Test_IfStatesHoverMarkerEnabledDoesntRenderForDefault_Correct()
        {
            ...
            chart.PlotOptions.Bullet.States.Hover.Marker.Enabled = defaultValue;
        ...
        public void Test_IfStatesHoverMarkerEnabledThresholdRenders_Correct(double value)
        {
            ...
            chart.PlotOptions.Bullet.States.Hover.Marker.EnabledThreshold = value;
        ...
        public void Test_IfStatesHoverMarkerEnabledThresholdDoesntRenderForDefault_Correct()
        {
            ...
            chart.PlotOptions.Bullet.States.Hover.Marker.EnabledThreshold = defaultValue;
        ...
        public void Test_IfStatesHoverMarkerFillColorRenders_Correct(string value)
        {
            ...
            chart.PlotOptions.Bullet.States.Hover.Marker.FillColor = value;
        ...
        //    chart.PlotOptions.Bullet.States.Hover.Marker.FillColor = defaultValue;
        ...
        public void Test_IfStatesHoverMarkerHeightRenders_Correct(double value)
        {
            ...
            chart.PlotOptions.Bullet.States.Hover.Marker.Height = value;
        ...
        public void Test_IfStatesHoverMarkerHeightDoesntRenderForDefault_Correct()
        {
            ...
            chart.PlotOptions.Bullet.States.Hover.Marker.Height = defaultValue;
        ...
        public void Test_IfStatesHoverMarkerLineColorRenders_Correct(string value)
        {
            ...
            chart.PlotOptions.Bullet.States.Hover.Marker.LineColor = value;
        ...
        public void Test_IfStatesHoverMarkerLineColorDoesntRenderForDefault_Correct()
        {
            ...
            chart.PlotOptions.Bullet.States.Hover.Marker.LineColor = defaultValue;
        ...
        public void Test_IfStatesHoverMarkerLineWidthRenders_Correct(double value)
        {
            ...
            chart.PlotOptions.Bullet.States.Hover.Marker.LineWidth = value;
        ...
        public void Test_IfStatesHoverMarkerLineWidthDoesntRenderForDefault_Correct()
        {
            ...
            chart.PlotOptions.Bullet.States.Hover.Marker.LineWidth = defaultValue;
        ...
        public void Test_IfStatesHoverMarkerRadiusRenders_Correct(double value)
        {
            ...
            chart.PlotOptions.Bullet.States.Hover.Marker.Radius = value;
        ...
        public void Test_IfStatesHoverMarkerRadiusDoesntRenderForDefault_Correct()
        {
            ...
            chart.PlotOptions.Bullet.States.Hover.Marker.Radius = defaultValue;
        ...
        public void Test_IfStatesHoverMarkerWidthRenders_Correct(double value)
        {
            ...
            chart.PlotOptions.Bullet.States.Hover.Marker.Width = value;
        ...
        public void Test_IfStatesHoverMarkerWidthDoesntRenderForDefault_Correct()
        {
            ...
            chart.PlotOptions.Bullet.States.Hover.Marker.Width = defaultValue;
        ...
        public void Test_IfStatesInactiveAnimationDurationRenders_Correct(int value)
        {
            var chart = new Highcharts();
            var renderer = new HighchartsRenderer(chart);
            var pathToProperty = new List<string>() { "plotOptions", "bullet", "states", "inactive", "animation" };

            chart.PlotOptions.Bullet.States.Inactive.Animation.Duration = value;
        ...
        public void Test_IfStatesInactiveAnimationDurationDoesntRenderForDefault_Correct()
        {
            ...
            chart.PlotOptions.Bullet.States.Inactive.Animation.Duration = defaultValue;
        ...
        public void Test_IfStatesInactiveEnabledRenders_Correct()
        {
            var chart = new Highcharts();
            var renderer = new HighchartsRenderer(chart);
            var pathToProperty = new List<string>() { "plotOptions", "bullet", "states", "inactive" };
            var value = false;

            chart.PlotOptions.Bullet.States.Inactive.Enabled = false;
        ...
        //    chart.PlotOptions.Bullet.States.Inactive.Enabled = defaultValue;
        ...
        public void Test_IfStatesInactiveOpacityRenders_Correct(double value)
        {
            ...
            chart.PlotOptions.Bullet.States.Inactive.Opacity = value;
        ...
        //    chart.PlotOptions.Bullet.States.Inactive.Opacity = defaultValue;
        ...
        public void Test_IfStatesNormalAnimationDurationRenders_Correct(int value)
        {
            var chart = new Highcharts();
            var renderer = new HighchartsRenderer(chart);
            var pathToProperty = new List<string>() { "plotOptions", "bullet", "states", "normal", "animation" };

            chart.PlotOptions.Bullet.States.Normal.Animation.Duration = value;
        ...
        public void Test_IfStatesNormalAnimationDurationDoesntRenderForDefault_Correct()
        {
            ...
            chart.PlotOptions.Bullet.States.Normal.Animation.Duration = defaultValue;
        ...
        public void Test_IfStatesSelectAnimationDurationRenders_Correct(int value)
        {
            var chart = new Highcharts();
            var renderer = new HighchartsRenderer(chart);
            var pathToProperty = new List<string>() { "plotOptions", "bullet", "states", "select", "animation" };

            chart.PlotOptions.Bullet.States.Select.Animation.Duration = value;
        ...
        public void Test_IfStatesSelectAnimationDurationDoesntRenderForDefault_Correct()
        {
            ...
            chart.PlotOptions.Bullet.States.Select.Animation.Duration = defaultValue;
        ...
        public void Test_IfStatesSelectEnabledRenders_Correct()
        {
            var chart = new Highcharts();
            var renderer = new HighchartsRenderer(chart);
            var pathToProperty = new List<string>() { "plotOptions", "bullet", "states", "select" };
            var value = false;

            chart.PlotOptions.Bullet.States.Select.Enabled = false;
        ...
        //    chart.PlotOptions.Bullet.States.Select.Enabled = defaultValue;
        ...
        //    var chart = new Highcharts();
        //    var renderer = new HighchartsRenderer(chart);
        //    var pathToProperty = new List<string>() { "plotOptions", "bullet", "states", "select", "halo" };

        //    chart.PlotOptions.Bullet.States.Select.Halo.Attributes = value;
        ...
        public void Test_IfStatesSelectHaloOpacityRenders_Correct(double value)
        {
            ...
            chart.PlotOptions.Bullet.States.Select.Halo.Opacity = value;
        ...
        //    chart.PlotOptions.Bullet.States.Select.Halo.Opacity = defaultValue;
        ...
        //    chart.PlotOptions.Bullet.States.Select.Halo.Size = value;
        ...
        public void Test_IfStatesSelectLineWidthRenders_Correct(double value)
        {
            ...
            chart.PlotOptions.Bullet.States.Select.LineWidth = value;
        ...
        public void Test_IfStatesSelectLineWidthDoesntRenderForDefault_Correct()
        {
            ...
            chart.PlotOptions.Bullet.States.Select.LineWidth = defaultValue;
        ...
        public void Test_IfStatesSelectLineWidthPlusRenders_Correct(double value)
        {
            ...
            chart.PlotOptions.Bullet.States.Select.LineWidthPlus = value;
        ...
        //    chart.PlotOptions.Bullet.States.Select.LineWidthPlus = defaultValue;
        ...
        public void Test_IfStatesSelectMarkerEnabledRenders_Correct(bool value)
        {
            var chart = new Highcharts();
            var renderer = new HighchartsRenderer(chart);
            var pathToProperty = new List<string> { "plotOptions", "bullet", "states", "select", "marker" };

            chart.PlotOptions.Bullet.States.Select.Marker.Enabled = value;
        ...
        public void Test_IfStatesSelectMarkerEnabledDoesntRenderForDefault_Correct()
        {
            ...
            chart.PlotOptions.Bullet.States.Select.Marker.Enabled = defaultValue;
        ...
        public void Test_IfStatesSelectMarkerEnabledThresholdRenders_Correct(double value)
        {
            ...
            chart.PlotOptions.Bullet.States.Select.Marker.EnabledThreshold = value;
        ...
        public void Test_IfStatesSelectMarkerEnabledThresholdDoesntRenderForDefault_Correct()
        {
            ...
            chart.PlotOptions.Bullet.States.Select.Marker.EnabledThreshold = defaultValue;
        ...
        public void Test_IfStatesSelectMarkerFillColorRenders_Correct(string value)
        {
            ...
            chart.PlotOptions.Bullet.States.Select.Marker.FillColor = value;
        ...
        //    chart.PlotOptions.Bullet.States.Select.Marker.FillColor = defaultValue;
        ...
        public void Test_IfStatesSelectMarkerHeightRenders_Correct(double value)
        {
            ...
            chart.PlotOptions.Bullet.States.Select.Marker.Height = value;
        ...
        public void Test_IfStatesSelectMarkerHeightDoesntRenderForDefault_Correct()
        {
            ...
            chart.PlotOptions.Bullet.States.Select.Marker.Height = defaultValue;
        ...
        public void Test_IfStatesSelectMarkerLineColorRenders_Correct(string value)
        {
            ...
            chart.PlotOptions.Bullet.States.Select.Marker.LineColor = value;
        ...
        public void Test_IfStatesSelectMarkerLineColorDoesntRenderForDefault_Correct()
        {
            ...
            chart.PlotOptions.Bullet.States.Select.Marker.LineColor = defaultValue;
        ...
        public void Test_IfStatesSelectMarkerLineWidthRenders_Correct(double value)
        {
            ...
            chart.PlotOptions.Bullet.States.Select.Marker.LineWidth = value;
        ...
        public void Test_IfStatesSelectMarkerLineWidthDoesntRenderForDefault_Correct()
        {
            ...
            chart.PlotOptions.Bullet.States.Select.Marker.LineWidth = defaultValue;
        ...
        public void Test_IfStatesSelectMarkerRadiusRenders_Correct(double value)
        {
            ...
            chart.PlotOptions.Bullet.States.Select.Marker.Radius = value;
        ...
        public void Test_IfStatesSelectMarkerRadiusDoesntRenderForDefault_Correct()
        {
            ...
            chart.PlotOptions.Bullet.States.Select.Marker.Radius = defaultValue;
        ...
        public void Test_IfStatesSelectMarkerWidthRenders_Correct(double value)
        {
            ...
            chart.PlotOptions.Bullet.States.Select.Marker.Width = value;
        ...
        public void Test_IfStatesSelectMarkerWidthDoesntRenderForDefault_Correct()
        {
            ...
            chart.PlotOptions.Bullet.States.Select.Marker.Width = defaultValue;
        ...
        public void Test_IfStickyTrackingRenders_Correct()
        {
            ...
            chart.PlotOptions.Bullet.StickyTracking = value;
        ...
        public void Test_IfStickyTrackingDoesntRenderForDefault_Correct()
        {
            ...
            chart.PlotOptions.Bullet.StickyTracking = defaultValue;
        ...
        public void Test_IfThresholdRenders_Correct(double value)
        {
            ...
            chart.PlotOptions.Bullet.Threshold = value;
        ...
        public void Test_IfThresholdDoesntRenderForDefault_Correct()
        {
            ...
            chart.PlotOptions.Bullet.Threshold = defaultValue;
        ...
        public void Test_IfTooltipPointFormatRenders_Correct(string value)
        {
            var chart = new Highcharts();
            var renderer = new HighchartsRenderer(chart);
            var pathToProperty = new List<string>() { "plotOptions", "bullet", "tooltip" };

            chart.PlotOptions.Bullet.Tooltip.PointFormat = value;
        ...
        public void Test_IfTooltipPointFormatDoesntRenderForDefault_Correct()
        {
            var chart = new Highcharts();
            var renderer = new HighchartsRenderer(chart);
            var defaultValue = "<span style='color:{series.color}'>●</span> {series.name}: <b>{point.y}</b>. Target: <b>{point.target}</b><br/>";

            chart.PlotOptions.Bullet.Tooltip.PointFormat = defaultValue;
        ...
        public void Test_IfTurboThresholdTrackingRenders_Correct(double value)
        {
            ...
            chart.PlotOptions.Bullet.TurboThreshold = value;
        ...
        public void Test_IfTurboThresholdDoesntRenderForDefault_Correct()
        {
            ...
            chart.PlotOptions.Bullet.TurboThreshold = defaultValue;
        ...
        public void Test_IfVisibleRenders_Correct()
        {
            ...
            chart.PlotOptions.Bullet.Visible = value;
        ...
        public void Test_IfVisibleDoesntRenderForDefault_Correct()
        {
            ...
            chart.PlotOptions.Bullet.Visible = defaultValue;
        ...
        public void Test_IfZoneAxisRenders_Correct()
        {
            ...
            chart.PlotOptions.Bullet.ZoneAxis = value;
        ...
        public void Test_IfZoneAxisDoesntRenderForDefault_Correct()
        {
            ...
            chart.PlotOptions.Bullet.ZoneAxis = defaultValue;
        ...
        public void Test_IfZonesClassNameRenders_Correct(string value)
        {
            var chart = new Highcharts();
            var renderer = new HighchartsRenderer(chart);
            var pathToProperty = new List<string>() { "plotOptions", "bullet", "zones" };
            var zoneDef = new List<PlotOptionsBulletZone> { new PlotOptionsBulletZone { ClassName = value } };

            chart.PlotOptions.Bullet.Zones = zoneDef;
        ...
        public void Test_IfZonesClassNameDoesntRenderForDefault_Correct()
        {
            ...
            var renderer = new HighchartsRenderer(chart);
            var defaultValue = string.Empty;
            var zoneDef = new List<PlotOptionsBulletZone> { new PlotOptionsBulletZone { ClassName = defaultValue } };
        ...
        public void Test_IfZonesColorRenders_Correct(string value)
        {
            ...
            var renderer = new HighchartsRenderer(chart);
            var pathToProperty = new List<string>() { "plotOptions", "bullet", "zones" };
            var zoneDef = new List<PlotOptionsBulletZone> { new PlotOptionsBulletZone { Color = value } };
        ...
        public void Test_IfZonesColorDoesntRenderForDefault_Correct()
        {
            ...
            var renderer = new HighchartsRenderer(chart);
            var defaultValue = string.Empty;
            var zoneDef = new List<PlotOptionsBulletZone> { new PlotOptionsBulletZone { Color = defaultValue } };
        ...
        [Theory]
        [InlineData(PlotOptionsBulletZonesDashStyle.Dash)]
        [InlineData(PlotOptionsBulletZonesDashStyle.DashDot)]
        [InlineData(PlotOptionsBulletZonesDashStyle.Dot)]
        [InlineData(PlotOptionsBulletZonesDashStyle.LongDash)]
        [InlineData(PlotOptionsBulletZonesDashStyle.LongDashDot)]
        [InlineData(PlotOptionsBulletZonesDashStyle.LongDashDotDot)]
        [InlineData(PlotOptionsBulletZonesDashStyle.ShortDash)]
        [InlineData(PlotOptionsBulletZonesDashStyle.ShortDashDot)]
        [InlineData(PlotOptionsBulletZonesDashStyle.ShortDashDotDot)]
        [InlineData(PlotOptionsBulletZonesDashStyle.ShortDot)]
        [InlineData(PlotOptionsBulletZonesDashStyle.Solid)]
        public void Test_IfZonesDashStyleRenders_Correct(PlotOptionsBulletZonesDashStyle value)
        {
            var chart = new Highcharts();
            var renderer = new HighchartsRenderer(chart);
            var pathToProperty = new List<string>() { "plotOptions", "bullet", "zones" };
            var zoneDef = new List<PlotOptionsBulletZone> { new PlotOptionsBulletZone { DashStyle = value } };
        ...
        public void Test_IfZonesDashStyleDoesntRenderForDefault_Correct()
        {
            var chart = new Highcharts();
            var renderer = new HighchartsRenderer(chart);
            var defaultValue = PlotOptionsBulletZonesDashStyle.Null;
            var zoneDef = new List<PlotOptionsBulletZone> { new PlotOptionsBulletZone { DashStyle = defaultValue } };
        ...
        public void Test_IfZonesFillColorRenders_Correct(string value)
        {
            ...
            var renderer = new HighchartsRenderer(chart);
            var pathToProperty = new List<string>() { "plotOptions", "bullet", "zones" };
            var zoneDef = new List<PlotOptionsBulletZone> { new PlotOptionsBulletZone { FillColor = value } };
        ...
        //    var renderer = new HighchartsRenderer(chart);
        //    var defaultValue = string.Empty;
        //    var zoneDef = new List<PlotOptionsBulletZone> { new PlotOptionsBulletZone { FillColor = defaultValue } };
        ...
        public void Test_IfZonesValueRenders_Correct(double value)
        {
            ...
            var renderer = new HighchartsRenderer(chart);
            var pathToProperty = new List<string>() { "plotOptions", "bullet", "zones" };
            var zoneDef = new List<PlotOptionsBulletZone> { new PlotOptionsBulletZone { Value = value } };
        ...
        public void Test_IfZonesValueDoesntRenderForDefault_Correct()
        {
            ...
            var renderer = new HighchartsRenderer(chart);
            double? defaultValue = null;
            var zoneDef = new List<PlotOptionsBulletZone> { new PlotOptionsBulletZone { Value = defaultValue } };
