...
{
    public class PlotOptionsCylinderTests : IClassFixture<HcFixture>
    {
        protected HcFixture _fixture;

        public PlotOptionsCylinderTests(HcFixture fixture)
        {
            _fixture = fixture;
            _fixture.ChartType = ChartType.Cylinder;
        }
        ...
        public void Test_IfAccessibilityDescriptionRenders_Correct(string description)
        {
            ...
            chart.PlotOptions.Cylinder.Accessibility.Description = description;
        ...
        public void Test_IfAccessibilityEnabledRenders_Correct(bool enabled)
        {
            ...
            chart.PlotOptions.Cylinder.Accessibility.Enabled = enabled;
        ...
        public void Test_IfAccessibilityExposeAsGroupOnlyRenders_Correct(bool exposeAsGroupOnly)
        {
            ...
            chart.PlotOptions.Cylinder.Accessibility.ExposeAsGroupOnly = exposeAsGroupOnly;
        ...
        public void Test_IfAccessibilityKeyboardNavigationEnabledRenders_Correct(bool enabled)
        {
            ...
            chart.PlotOptions.Cylinder.Accessibility.KeyboardNavigation.Enabled = enabled;
        ...
        public void Test_IfAccessibilityPointDateFormatRenders_Correct(string format)
        {
            ...
            chart.PlotOptions.Cylinder.Accessibility.Point.DateFormat = format;
        ...
        public void Test_IfAccessibilityPointDateFormatterRenders_Correct(string function)
        {
            ...
            chart.PlotOptions.Cylinder.Accessibility.Point.DateFormatter = function;
        ...
        public void Test_IfAccessibilityPointDescribeNullSetOnFalseRenders_Correct(bool describeNull)
        {
            ...
            chart.PlotOptions.Cylinder.Accessibility.Point.DescribeNull = describeNull;
        ...
        public void Test_IfAccessibilityPointDescriptionFormatterRenders_Correct(string function)
        {
            ...
            chart.PlotOptions.Cylinder.Accessibility.Point.DescriptionFormatter = function;
        ...
        public void Test_IfAccessibilityPointValueDecimalsRenders_Correct(int decimals)
        {
            ...
            chart.PlotOptions.Cylinder.Accessibility.Point.ValueDecimals = decimals;
        ...
        public void Test_IfAccessibilityPointValueDescriptionFormatRenders_Correct(string format)
        {
            ...
            chart.PlotOptions.Cylinder.Accessibility.Point.ValueDescriptionFormat = format;
        ...
        public void Test_IfAccessibilityPointValuePrefixRenders_Correct(string prefix)
        {
            ...
            chart.PlotOptions.Cylinder.Accessibility.Point.ValuePrefix = prefix;
        ...
        public void Test_IfAccessibilityPointValueSufixRenders_Correct(string suffix)
        {
            ...
            chart.PlotOptions.Cylinder.Accessibility.Point.ValueSuffix = suffix;
        ...
        public void Test_IfAllowPointSelectRenders_Correct()
        {
            ...
            chart.PlotOptions.Cylinder.AllowPointSelect = enabled;
        ...
        public void Test_IfAllowPointSelectDoesntRenderForDefault_Correct()
        {
            ...
            chart.PlotOptions.Cylinder.AllowPointSelect = false;
        ...
        public void Test_IfAnimationEnabledRenders_Correct(bool enabled)
        {
            ...
            chart.PlotOptions.Cylinder.AnimationBool = enabled;
        ...
        public void Test_IfAnimationDurationRenders_Correct(int duration)
        {
            ...
            chart.PlotOptions.Cylinder.Animation.Duration = duration;
        ...
        public void Test_IfAnimationDeferRenders_Correct(int defer)
        {
            ...
            chart.PlotOptions.Cylinder.Animation.Defer = defer;
        ...
        public void Test_IfAnimationEasingRenders_Correct(string easing)
        {
            ...
            chart.PlotOptions.Cylinder.Animation.Easing = easing;
        ...
        public void Test_IfAnimationLimitRenders_Correct(int limit)
        {
            ...
            chart.PlotOptions.Cylinder.AnimationLimit = limit;
        ...
        public void Test_IfClassNameRenders_Correct(string className)
        {
            ...
            chart.PlotOptions.Cylinder.ClassName = className;
        ...
        public void Test_IfClipRenders_Correct()
        {
            ...
            chart.PlotOptions.Cylinder.Clip = value;
        ...
        public void Test_IfColorRenders_Correct(string color)
        {
            ...
            chart.PlotOptions.Cylinder.Color = color;
        ...
        public void Test_IfColorIndexRenders_Correct(int value)
        {
            ...
            chart.PlotOptions.Cylinder.ColorIndex = value;
        ...
        public void Test_IfColorKeyRenders_Correct(string value)
        {
            ...
            chart.PlotOptions.Cylinder.ColorKey = value;
        ...
        public void Test_IfCrispRenders_Correct()
        {
            ...
            chart.PlotOptions.Cylinder.Crisp = value;
        ...
        public void Test_IfCropThresholdRenders_Correct(int value)
        {
            ...
            chart.PlotOptions.Cylinder.CropThreshold = value;
        ...
        public void Test_IfCropThresholdDoesntRenderForDefault_Correct()
        {
            ...
            chart.PlotOptions.Cylinder.CropThreshold = defaultValue;

            Assert.DoesNotContain($"\"crisp\"", renderer.RenderHtml());
        }

        [Theory]
        [InlineData(PlotOptionsCylinderCursor.Default)]
        [InlineData(PlotOptionsCylinderCursor.Help)]
        [InlineData(PlotOptionsCylinderCursor.Pointer)]
        [InlineData(PlotOptionsCylinderCursor.None)]
        public void Test_IfCursorRenders_Correct(PlotOptionsCylinderCursor cursor)
        {
            var chart = new Highcharts();
            chart.Chart.Type = _fixture.ChartType;
            var renderer = new HighchartsRenderer(chart);

            chart.PlotOptions.Cylinder.Cursor = cursor;
        ...
        public void Test_IfCustomRenders_Correct(string key1, string value1)
        {
            ...
            chart.PlotOptions.Cylinder.Custom = extraData;

            Assert.Contains($"\"plotOptions\":{{\"{_fixture.ChartType.ToString().ToLower()}\":{{\"custom\":{{\"{key1}\":\"{value1}\"}}}}}}", renderer.RenderHtml());
        }

        [Theory]
        [InlineData(PlotOptionsCylinderDashStyle.Dash)]
        [InlineData(PlotOptionsCylinderDashStyle.DashDot)]
        [InlineData(PlotOptionsCylinderDashStyle.Dot)]
        [InlineData(PlotOptionsCylinderDashStyle.LongDash)]
        [InlineData(PlotOptionsCylinderDashStyle.LongDashDot)]
        [InlineData(PlotOptionsCylinderDashStyle.LongDashDotDot)]
        [InlineData(PlotOptionsCylinderDashStyle.ShortDash)]
        [InlineData(PlotOptionsCylinderDashStyle.ShortDashDot)]
        [InlineData(PlotOptionsCylinderDashStyle.ShortDashDotDot)]
        [InlineData(PlotOptionsCylinderDashStyle.ShortDot)]
        public void Test_IfDashStyleRenders_Correct(PlotOptionsCylinderDashStyle style)
        {
            var chart = new Highcharts();
            chart.Chart.Type = _fixture.ChartType;
            var renderer = new HighchartsRenderer(chart);
            ...
            chart.PlotOptions.Cylinder.DashStyle = style;
        ...
        [Theory]
        [InlineData(PlotOptionsCylinderDataLabelsAlign.Left)]
        [InlineData(PlotOptionsCylinderDataLabelsAlign.Right)]
        public void Test_IfDataLabelsAlignRenders_Correct(PlotOptionsCylinderDataLabelsAlign align)
        {
            var chart = new Highcharts();
            var renderer = new HighchartsRenderer(chart);

            chart.PlotOptions.Cylinder.DataLabels.Align = align;
        ...
        public void Test_IfDataLabelsAlignDoesntRenderForDefault_Correct()
        {
            var chart = new Highcharts();
            var renderer = new HighchartsRenderer(chart);
            var defaultValue = PlotOptionsCylinderDataLabelsAlign.Center;

            chart.PlotOptions.Cylinder.DataLabels.Align = defaultValue;
        ...
        public void Test_IfDataLabelsAllowOverlapRenders_Correct()
        {
            ...
            chart.PlotOptions.Cylinder.DataLabels.AllowOverlap = value;
        ...
        public void Test_IfDataLabelsAllowOverlapDoesntRenderForDefault_Correct()
        {
            ...
            chart.PlotOptions.Cylinder.DataLabels.AllowOverlap = defaultValue;
        ...
        public void Test_IfDataLabelsAnimationDeferRenders_Correct(int value)
        {
            ...
            chart.PlotOptions.Cylinder.DataLabels.Animation.Defer = value;
        ...
        public void Test_IfDataLabelsAnimationDeferDoesntRenderForDefault_Correct()
        {
            ...
            chart.PlotOptions.Cylinder.DataLabels.Animation.Defer = defaultValue;
        ...
        public void Test_IfDataLabelsBackgroundColorRenders_Correct(string value)
        {
            ...
            chart.PlotOptions.Cylinder.DataLabels.BackgroundColor = value;
        ...
        public void Test_IfDataLabelsBackgroundColorDoesntRenderForDefault_Correct()
        {
            ...
            chart.PlotOptions.Cylinder.DataLabels.BackgroundColor = defaultValue;
        ...
        public void Test_IfDataLabelsBorderColorRenders_Correct(string value)
        {
            ...
            chart.PlotOptions.Cylinder.DataLabels.BorderColor = value;
        ...
        public void Test_IfDataLabelsBorderColorDoesntRenderForDefault_Correct()
        {
            ...
            chart.PlotOptions.Cylinder.DataLabels.BorderColor = defaultValue;
        ...
        public void Test_IfDataLabelsBorderRadiusRenders_Correct(double value)
        {
            ...
            chart.PlotOptions.Cylinder.DataLabels.BorderRadius = value;
        ...
        public void Test_IfDataLabelsBorderRadiusDoesntRenderForDefault_Correct()
        {
            ...
            chart.PlotOptions.Cylinder.DataLabels.BorderRadius = defaultValue;
        ...
        public void Test_IfDataLabelsBorderWidthRenders_Correct(double value)
        {
            ...
            chart.PlotOptions.Cylinder.DataLabels.BorderWidth = value;
        ...
        public void Test_IfDataLabelsBorderWidthDoesntRenderForDefault_Correct()
        {
            ...
            chart.PlotOptions.Cylinder.DataLabels.BorderWidth = defaultValue;
        ...
        public void Test_IfDataLabelsClassNameRenders_Correct(string value)
        {
            ...
            chart.PlotOptions.Cylinder.DataLabels.ClassName = value;
        ...
        public void Test_IfDataLabelsClassNameDoesntRenderForDefault_Correct()
        {
            ...
            chart.PlotOptions.Cylinder.DataLabels.ClassName = defaultValue;
        ...
        public void Test_IfDataLabelsColorRenders_Correct(string value)
        {
            ...
            chart.PlotOptions.Cylinder.DataLabels.Color = value;
        ...
        public void Test_IfDataLabelsColorDoesntRenderForDefault_Correct()
        {
            ...
            chart.PlotOptions.Cylinder.DataLabels.Color = defaultValue;
        ...
        public void Test_IfDataLabelsCropRenders_Correct()
        {
            ...
            chart.PlotOptions.Cylinder.DataLabels.Crop = value;
        ...
        public void Test_IfDataLabelsCropDoesntRenderForDefault_Correct()
        {
            ...
            chart.PlotOptions.Cylinder.DataLabels.Crop = defaultValue;
        ...
        public void Test_IfDataLabelsDeferBoolRenders_Correct()
        {
            ...
            chart.PlotOptions.Cylinder.DataLabels.DeferBool = value;
        ...
        public void Test_IfDataLabelsDeferBoolDoesntRenderForDefault_Correct()
        {
            ...
            chart.PlotOptions.Cylinder.DataLabels.DeferBool = defaultValue;
        ...
        public void Test_IfDataLabelsDeferRenders_Correct(double value)
        {
            ...
            chart.PlotOptions.Cylinder.DataLabels.Defer = value;
        ...
        public void Test_IfDataLabelsEnabledBoolRenders_Correct()
        {
            ...
            chart.PlotOptions.Cylinder.DataLabels.Enabled = value;
        ...
        public void Test_IfDataLabelsEnabledBoolDoesntRenderForDefault_Correct()
        {
            ...
            chart.PlotOptions.Cylinder.DataLabels.Enabled = defaultValue;
        ...
        public void Test_IfDataLabelsFilterOperatorRenders_Correct(string value)
        {
            ...
            chart.PlotOptions.Cylinder.DataLabels.Filter.Operator = value;
        ...
        public void Test_IfDataLabelsFilterOperatorDoesntRenderForDefault_Correct()
        {
            ...
            chart.PlotOptions.Cylinder.DataLabels.Filter.Operator = defaultValue;
        ...
        public void Test_IfDataLabelsFilterPropertyRenders_Correct(string value)
        {
            ...
            chart.PlotOptions.Cylinder.DataLabels.Filter.Property = value;
        ...
        public void Test_IfDataLabelsFilterPropertyDoesntRenderForDefault_Correct()
        {
            ...
            chart.PlotOptions.Cylinder.DataLabels.Filter.Property = defaultValue;
        ...
        public void Test_IfDataLabelsFilterValueRenders_Correct(double value)
        {
            ...
            chart.PlotOptions.Cylinder.DataLabels.Filter.Value = value;
        ...
        public void Test_IfDataLabelsFilterValueDoesntRenderForDefault_Correct()
        {
            ...
            chart.PlotOptions.Cylinder.DataLabels.Filter.Value = defaultValue;
        ...
        public void Test_IfDataLabelsFormatRenders_Correct(string value)
        {
            ...
            chart.PlotOptions.Cylinder.DataLabels.Format = value;
        ...
        public void Test_IfDataLabelsFormatDoesntRenderForDefault_Correct()
        {
            ...
            chart.PlotOptions.Cylinder.DataLabels.Format = defaultValue;
        ...
        public void Test_IfDataLabelsFormatterRenders_Correct(string value)
        {
            ...
            chart.PlotOptions.Cylinder.DataLabels.Formatter = value;
        ...
        public void Test_IfDataLabelsFormatterDoesntRenderForDefault_Correct()
        {
            ...
            chart.PlotOptions.Cylinder.DataLabels.Formatter = defaultValue;
        ...
        public void Test_IfDataLabelsInsideRenders_Correct(bool value)
        {
            ...
            chart.PlotOptions.Cylinder.DataLabels.Inside = value;
        ...
        public void Test_IfDataLabelsInsideDoesntRenderForDefault_Correct()
        {
            ...
            chart.PlotOptions.Cylinder.DataLabels.Inside = defaultValue;
        ...
        public void Test_IfDataLabelsNullFormatBoolRenders_Correct(bool value)
        {
            ...
            chart.PlotOptions.Cylinder.DataLabels.NullFormatBool = value;
        ...
        public void Test_IfDataLabelsNullFormatBoolDoesntRenderForDefault_Correct()
        {
            ...
            chart.PlotOptions.Cylinder.DataLabels.NullFormatBool = defaultValue;
        ...
        public void Test_IfDataLabelsNullFormatRenders_Correct(string value)
        {
            ...
            chart.PlotOptions.Cylinder.DataLabels.NullFormat = value;
        ...
        public void Test_IfDataLabelsNullFormatDoesntRenderForDefault_Correct()
        {
            ...
            chart.PlotOptions.Cylinder.DataLabels.NullFormat = defaultValue;
        ...
        public void Test_IfDataLabelsNullFormatterRenders_Correct(string value)
        {
            ...
            chart.PlotOptions.Cylinder.DataLabels.NullFormatter = value;
        ...
        public void Test_IfDataLabelsNullFormatterDoesntRenderForDefault_Correct()
        {
            ...
            chart.PlotOptions.Cylinder.DataLabels.NullFormatter = defaultValue;

            Assert.DoesNotContain($"nullFormatter", renderer.RenderHtml());
        }

        [Theory]
        [InlineData(PlotOptionsCylinderDataLabelsOverflow.Allow)]
        public void Test_IfDataLabelsOverflowRenders_Correct(PlotOptionsCylinderDataLabelsOverflow align)
        {
            var chart = new Highcharts();
            var renderer = new HighchartsRenderer(chart);

            chart.PlotOptions.Cylinder.DataLabels.Overflow = align;
        ...
        public void Test_IfDataLabelsOverflowDoesntRenderForDefault_Correct()
        {
            var chart = new Highcharts();
            var renderer = new HighchartsRenderer(chart);
            var defaultValue = PlotOptionsCylinderDataLabelsOverflow.Justify;

            chart.PlotOptions.Cylinder.DataLabels.Overflow = defaultValue;
        ...
        public void Test_IfDataLabelsPaddingRenders_Correct(double value)
        {
            ...
            chart.PlotOptions.Cylinder.DataLabels.Padding = value;
        ...
        public void Test_IfDataLabelsPaddingDoesntRenderForDefault_Correct()
        {
            ...
            chart.PlotOptions.Cylinder.DataLabels.Padding = defaultValue;

            Assert.DoesNotContain($"padding", renderer.RenderHtml());
        }

        [Theory]
        [InlineData(PlotOptionsCylinderDataLabelsPosition.Left)]
        [InlineData(PlotOptionsCylinderDataLabelsPosition.Right)]
        public void Test_IfDataLabelsPositionRenders_Correct(PlotOptionsCylinderDataLabelsPosition align)
        {
            var chart = new Highcharts();
            var renderer = new HighchartsRenderer(chart);

            chart.PlotOptions.Cylinder.DataLabels.Position = align;
        ...
        public void Test_IfDataLabelsPositionDoesntRenderForDefault_Correct()
        {
            var chart = new Highcharts();
            var renderer = new HighchartsRenderer(chart);
            var defaultValue = PlotOptionsCylinderDataLabelsPosition.Center;

            chart.PlotOptions.Cylinder.DataLabels.Position = defaultValue;
        ...
        public void Test_IfDataLabelsRotationRenders_Correct(double value)
        {
            ...
            chart.PlotOptions.Cylinder.DataLabels.Rotation = value;
        ...
        public void Test_IfDataLabelsRotationDoesntRenderForDefault_Correct()
        {
            ...
            chart.PlotOptions.Cylinder.DataLabels.Rotation = defaultValue;
        ...
        public void Test_IfDataLabelsShadowBoolRenders_Correct()
        {
            ...
            chart.PlotOptions.Cylinder.DataLabels.ShadowBool = value;
        ...
        public void Test_IfDataLabelsShadowRenders_Correct(string color, int offsetX, int offsetY, double opacity, int width)
        {
            ...
            chart.PlotOptions.Cylinder.DataLabels.Shadow = new Shadow()
            {
                Color = color,
                OffsetX = offsetX,
                OffsetY = offsetY,
        ...
        public void Test_IfDataLabelsShadowBoolDoesntRenderForDefault_Correct()
        {
            ...
            chart.PlotOptions.Cylinder.DataLabels.ShadowBool = defaultValue;
        ...
        public void Test_IfDataLabelsShapeRenders_Correct(string value)
        {
            ...
            chart.PlotOptions.Cylinder.DataLabels.Shape = value;
        ...
        public void Test_IfDataLabelsShapeDoesntRenderForDefault_Correct()
        {
            ...
            chart.PlotOptions.Cylinder.DataLabels.Shape = defaultValue;
        ...
        public void Test_IfDataLabelsStyleStringRenders_Correct(string param1, string param1_value)
        {
            var chart = new Highcharts();
            var renderer = new HighchartsRenderer(chart);
            var pathToProperty = new List<string>() { "plotOptions", "cylinder", "dataLabels", "style" };
            var style = new Hashtable();
            style.Add(param1, param1_value);

            chart.PlotOptions.Cylinder.DataLabels.Style = style;
        ...
        public void Test_IfDataLabelsTextPathEnabledRenders_Correct(bool value)
        {
            var chart = new Highcharts();
            var renderer = new HighchartsRenderer(chart);
            var pathToProperty = new List<string> { "plotOptions", "cylinder", "dataLabels", "textPath" };

            chart.PlotOptions.Cylinder.DataLabels.TextPath.Enabled = value;
        ...
        public void Test_IfDataLabelsTextPathEnabledDoesntRenderForDefault_Correct()
        {
            ...
            chart.PlotOptions.Cylinder.DataLabels.TextPath.Enabled = defaultValue;
        ...
        public void Test_IfDataLabelsUseHTMLRenders_Correct()
        {
            ...
            chart.PlotOptions.Cylinder.DataLabels.UseHTML = value;
        ...
        public void Test_IfDataLabelsUseHTMLDoesntRenderForDefault_Correct()
        {
            ...
            chart.PlotOptions.Cylinder.DataLabels.UseHTML = defaultValue;

            Assert.DoesNotContain($"useHTML", renderer.RenderHtml());
        }

        [Theory]
        [InlineData(PlotOptionsCylinderDataLabelsVerticalAlign.Middle)]
        [InlineData(PlotOptionsCylinderDataLabelsVerticalAlign.Top)]
        public void Test_IfDataLabelsVerticalAlignRenders_Correct(PlotOptionsCylinderDataLabelsVerticalAlign align)
        {
            var chart = new Highcharts();
            var renderer = new HighchartsRenderer(chart);

            chart.PlotOptions.Cylinder.DataLabels.VerticalAlign = align;
        ...
        public void Test_IfDataLabelsVerticalAlignDoesntRenderForDefault_Correct()
        {
            var chart = new Highcharts();
            var renderer = new HighchartsRenderer(chart);
            var defaultValue = PlotOptionsCylinderDataLabelsVerticalAlign.Bottom;

            chart.PlotOptions.Cylinder.DataLabels.VerticalAlign = defaultValue;
        ...
        public void Test_IfDataLabelsXRenders_Correct(double value)
        {
            ...
            chart.PlotOptions.Cylinder.DataLabels.X = value;
        ...
        public void Test_IfDataLabelsXDoesntRenderForDefault_Correct()
        {
            ...
            chart.PlotOptions.Cylinder.DataLabels.X = defaultValue;
        ...
        public void Test_IfDataLabelsYRenders_Correct(double value)
        {
            ...
            chart.PlotOptions.Cylinder.DataLabels.Y = value;
        ...
        public void Test_IfDataLabelsYDoesntRenderForDefault_Correct()
        {
            ...
            chart.PlotOptions.Cylinder.DataLabels.Y = defaultValue;
        ...
        public void Test_IfDataLabelsZRenders_Correct(double value)
        {
            ...
            chart.PlotOptions.Cylinder.DataLabels.ZIndex = value;
        ...
        public void Test_IfDataLabelsZDoesntRenderForDefault_Correct()
        {
            ...
            chart.PlotOptions.Cylinder.DataLabels.ZIndex = defaultValue;
        ...
        public void Test_IfDataSortingEnabledRenders_Correct(bool value)
        {
            var chart = new Highcharts();
            var renderer = new HighchartsRenderer(chart);
            var pathToProperty = new List<string> { "plotOptions", "cylinder", "dataSorting" };

            chart.PlotOptions.Cylinder.DataSorting.Enabled = value;
        ...
        public void Test_IfDataSortingEnabledDoesntRenderForDefault_Correct()
        {
            ...
            chart.PlotOptions.Cylinder.DataSorting.Enabled = defaultValue;
        ...
        public void Test_IfDataSortingMatchByNameRenders_Correct(bool value)
        {
            ...
            chart.PlotOptions.Cylinder.DataSorting.MatchByName = value;
        ...
        public void Test_IfDataSortingMatchByNameDoesntRenderForDefault_Correct()
        {
            ...
            chart.PlotOptions.Cylinder.DataSorting.MatchByName = defaultValue;
        ...
        public void Test_IfDataSortingSortKeyRenders_Correct(string value)
        {
            ...
            chart.PlotOptions.Cylinder.DataSorting.SortKey = value;
        ...
        public void Test_IfDataSortingSortKeyDoesntRenderForDefault_Correct()
        {
            ...
            chart.PlotOptions.Cylinder.DataSorting.SortKey = defaultValue;
        ...
        public void Test_IfDescriptionRenders_Correct(string description)
        {
            ...
            chart.PlotOptions.Cylinder.Description = description;
        ...
        public void Test_IfEnableMouseTrackingRenders_Correct()
        {
            ...
            chart.PlotOptions.Cylinder.EnableMouseTracking = value;
        ...
        public void Test_IfEventsAfterAnimateRenders_Correct(string value)
        {
            var chart = new Highcharts();
            var renderer = new HighchartsRenderer(chart);
            var pathToProperty = new List<string> { "plotOptions", "cylinder", "events" };

            chart.PlotOptions.Cylinder.Events.AfterAnimate = value;
        ...
        public void Test_IfEventsAfterAnimateDoesntRenderForDefault_Correct()
        {
            ...
            chart.PlotOptions.Cylinder.Events.AfterAnimate = defaultValue;
        ...
        public void Test_IfEventsCheckboxClickRenders_Correct(string value)
        {
            ...
            chart.PlotOptions.Cylinder.Events.CheckboxClick = value;
        ...
        public void Test_IfEventsCheckboxClickDoesntRenderForDefault_Correct()
        {
            ...
            chart.PlotOptions.Cylinder.Events.CheckboxClick = defaultValue;
        ...
        public void Test_IfEventsClickRenders_Correct(string value)
        {
            ...
            chart.PlotOptions.Cylinder.Events.Click = value;
        ...
        public void Test_IfEventsclickDoesntRenderForDefault_Correct()
        {
            ...
            chart.PlotOptions.Cylinder.Events.Click = defaultValue;
        ...
        public void Test_IfEventsHideRenders_Correct(string value)
        {
            ...
            chart.PlotOptions.Cylinder.Events.Hide = value;
        ...
        public void Test_IfEventsHideDoesntRenderForDefault_Correct()
        {
            ...
            chart.PlotOptions.Cylinder.Events.Hide = defaultValue;
        ...
        public void Test_IfEventsLegendItemClickRenders_Correct(string value)
        {
            ...
            chart.PlotOptions.Cylinder.Events.LegendItemClick = value;
        ...
        public void Test_IfEventsLegendItemClickDoesntRenderForDefault_Correct()
        {
            ...
            chart.PlotOptions.Cylinder.Events.LegendItemClick = defaultValue;
        ...
        public void Test_IfEventsMouseOutRenders_Correct(string value)
        {
            ...
            chart.PlotOptions.Cylinder.Events.MouseOut = value;
        ...
        public void Test_IfEventsMouseOutDoesntRenderForDefault_Correct()
        {
            ...
            chart.PlotOptions.Cylinder.Events.MouseOut = defaultValue;
        ...
        public void Test_IfEventsMouseOverRenders_Correct(string value)
        {
            ...
            chart.PlotOptions.Cylinder.Events.MouseOver = value;
        ...
        public void Test_IfEventsMouseOverDoesntRenderForDefault_Correct()
        {
            ...
            chart.PlotOptions.Cylinder.Events.MouseOver = defaultValue;
        ...
        public void Test_IfEventsShowRenders_Correct(string value)
        {
            ...
            chart.PlotOptions.Cylinder.Events.Show = value;
        ...
        public void Test_IfEventsShowDoesntRenderForDefault_Correct()
        {
            ...
            chart.PlotOptions.Cylinder.Events.Show = defaultValue;
        ...
        public void Test_IfFindNearestPointByRenders_Correct()
        {
            var chart = new Highcharts();
            var renderer = new HighchartsRenderer(chart);
            var value = PlotOptionsCylinderFindNearestPointBy.Xy;

            chart.PlotOptions.Cylinder.FindNearestPointBy = value;
        ...
        public void Test_IfFindNearestPointByDoesntRenderForDefault_Correct()
        {
            var chart = new Highcharts();
            var renderer = new HighchartsRenderer(chart);
            var value = PlotOptionsCylinderFindNearestPointBy.X;
        ...
        public void Test_IfGetExtremesFromAllRenders_Correct()
        {
            ...
            chart.PlotOptions.Cylinder.GetExtremesFromAll = value;
        ...
        public void Test_IfIncludeInDataExportFromAllRenders_Correct(bool value)
        {
            ...
            chart.PlotOptions.Cylinder.IncludeInDataExport = value;
        ...
        public void Test_IfKeysRenders_Correct(string arg1, string arg2, string arg3, string arg4)
        {
            ...
            chart.PlotOptions.Cylinder.Keys = value;
        ...
        public void Test_IfLabelConnectorAllowedRenders_Correct()
        {
            var chart = new Highcharts();
            var renderer = new HighchartsRenderer(chart);
            var pathToProperty = new List<string> { "plotOptions", "cylinder", "label" };
            var value = true;

            chart.PlotOptions.Cylinder.Label.ConnectorAllowed = value;
        ...
        public void Test_IfLabelConnectorAllowedDoesntRenderForDefault_Correct()
        {
            ...
            chart.PlotOptions.Cylinder.Label.ConnectorAllowed = defaultValue;
        ...
        public void Test_IfLabelConnectorNeighbourDistanceRenders_Correct(double value)
        {
            ...
            chart.PlotOptions.Cylinder.Label.ConnectorNeighbourDistance = value;
        ...
        public void Test_IfLabelConnectorNeighbourDistanceDoesntRenderForDefault_Correct()
        {
            ...
            chart.PlotOptions.Cylinder.Label.ConnectorNeighbourDistance = defaultValue;
        ...
        public void Test_IfLabelEnabledRenders_Correct()
        {
            ...
            chart.PlotOptions.Cylinder.Label.Enabled = value;
        ...
        public void Test_IfLabelEnabledDoesntRenderForDefault_Correct()
        {
            ...
            chart.PlotOptions.Cylinder.Label.Enabled = defaultValue;
        ...
        public void Test_IfLabelFormatRenders_Correct(string value)
        {
            ...
            chart.PlotOptions.Cylinder.Label.Format = value;
        ...
        //    chart.PlotOptions.Cylinder.Label.Format = defaultValue;
        ...
        public void Test_IfLabelFormatterRenders_Correct(string value)
        {
            ...
            chart.PlotOptions.Cylinder.Label.Formatter = value;
        ...
        public void Test_IfLabelFormatterDoesntRenderForDefault_Correct()
        {
            ...
            chart.PlotOptions.Cylinder.Label.Formatter = defaultValue;
        ...
        public void Test_IfLabelMaxFontSizeRenders_Correct(double value)
        {
            ...
            chart.PlotOptions.Cylinder.Label.MaxFontSize = value;
        ...
        public void Test_IfLabelMaxFontSizeDoesntRenderForDefault_Correct()
        {
            ...
            chart.PlotOptions.Cylinder.Label.MaxFontSize = defaultValue;
        ...
        public void Test_IfLabelMinFontSizeRenders_Correct(double value)
        {
            ...
            chart.PlotOptions.Cylinder.Label.MinFontSize = value;
        ...
        public void Test_IfLabelMinFontSizeDoesntRenderForDefault_Correct()
        {
            ...
            chart.PlotOptions.Cylinder.Label.MinFontSize = defaultValue;
        ...
        public void Test_IfLabelOnAreaRenders_Correct(bool value)
        {
            ...
            chart.PlotOptions.Cylinder.Label.OnArea = value;
        ...
        public void Test_IfLabelOnAreaDoesntRenderForDefault_Correct()
        {
            ...
            chart.PlotOptions.Cylinder.Label.OnArea = defaultValue;
        ...
        public void Test_IfLabelStyleRenders_Correct(string paramName, string paramValue)
        {
            ...
            chart.PlotOptions.Cylinder.Label.Style = value;
        ...
        //    chart.PlotOptions.Cylinder.Label.Style = defaultValue;
        ...
        //[Theory]
        //[InlineData(PlotOptionsCylinderLinecap.Square)]
        ////missing PlotOptionsCylinderLinecap.Butt ?
        //public void Test_IfLinecapRenders_Correct(PlotOptionsCylinderLinecap value)
        //{
        //    var chart = new Highcharts();
        //    var renderer = new HighchartsRenderer(chart);

        //    chart.PlotOptions.Cylinder.Linecap = value;
        ...
        //    var chart = new Highcharts();
        //    var renderer = new HighchartsRenderer(chart);
        //    var defaultValue = PlotOptionsCylinderLinecap.Round;

        //    chart.PlotOptions.Cylinder.Linecap = defaultValue;
        ...
        public void Test_IfLinkedToRenders_Correct(string value)
        {
            ...
            chart.PlotOptions.Cylinder.LinkedTo = value;
        ...
        public void Test_IfLinkedToDoesntRenderForDefault_Correct()
        {
            ...
            chart.PlotOptions.Cylinder.LinkedTo = defaultValue;
        ...
        public void Test_IfNegativeColorRenders_Correct(string value)
        {
            ...
            chart.PlotOptions.Cylinder.NegativeColor = value;
        ...
        public void Test_IfNegativeColorDoesntRenderForDefault_Correct()
        {
            ...
            chart.PlotOptions.Cylinder.NegativeColor = defaultValue;
        ...
        //    var chart = new Highcharts();
        //    var renderer = new HighchartsRenderer(chart);
        //    var pathToProperty = new List<string>() { "plotOptions", "cylinder", "onPoint", "connectorOptions" };

        //    chart.PlotOptions.Cylinder.OnPoint.ConnectorOptions.Dashstyle = value;
        ...
        public void Test_IfOnPointConnectorOptionsStrokeRenders_Correct(string value)
        {
            ...
            chart.PlotOptions.Cylinder.OnPoint.ConnectorOptions.Stroke = value;
        ...
        public void Test_IfOnPointConnectorOptionsStrokeDoesntRenderForDefault_Correct()
        {
            ...
            chart.PlotOptions.Cylinder.OnPoint.ConnectorOptions.Stroke = defaultValue;
        ...
        public void Test_IfOnPointConnectorOptionsWidthRenders_Correct(double value)
        {
            ...
            chart.PlotOptions.Cylinder.OnPoint.ConnectorOptions.Width = value;
        ...
        public void Test_IfOnPointConnectorOptionsWidthDoesntRenderForDefault_Correct()
        {
            ...
            chart.PlotOptions.Cylinder.OnPoint.ConnectorOptions.Width = defaultValue;
        ...
        public void Test_IfOnPointIdRenders_Correct(string value)
        {
            var chart = new Highcharts();
            var renderer = new HighchartsRenderer(chart);
            var pathToProperty = new List<string>() { "plotOptions", "cylinder", "onPoint" };

            chart.PlotOptions.Cylinder.OnPoint.Id = value;
        ...
        public void Test_IfOnPointIdDoesntRenderForDefault_Correct()
        {
            ...
            chart.PlotOptions.Cylinder.OnPoint.Id = defaultValue;
        ...
        public void Test_IfOnPointPositionOffsetXRenders_Correct(double value)
        {
            var chart = new Highcharts();
            var renderer = new HighchartsRenderer(chart);
            var pathToProperty = new List<string>() { "plotOptions", "cylinder", "onPoint", "position" };

            chart.PlotOptions.Cylinder.OnPoint.Position.OffsetX = value;
        ...
        public void Test_IfOnPointOffsetXDoesntRenderForDefault_Correct()
        {
            ...
            chart.PlotOptions.Cylinder.OnPoint.Position.OffsetX = defaultValue;
        ...
        public void Test_IfOnPointPositionOffsetYRenders_Correct(double value)
        {
            ...
            chart.PlotOptions.Cylinder.OnPoint.Position.OffsetY = value;
        ...
        public void Test_IfOnPointOffsetYDoesntRenderForDefault_Correct()
        {
            ...
            chart.PlotOptions.Cylinder.OnPoint.Position.OffsetY = defaultValue;
        ...
        public void Test_IfOnPointPositionXRenders_Correct(double value)
        {
            ...
            chart.PlotOptions.Cylinder.OnPoint.Position.X = value;
        ...
        public void Test_IfOnPointXDoesntRenderForDefault_Correct()
        {
            ...
            chart.PlotOptions.Cylinder.OnPoint.Position.X = defaultValue;
        ...
        public void Test_IfOnPointPositionYRenders_Correct(double value)
        {
            ...
            chart.PlotOptions.Cylinder.OnPoint.Position.Y = value;
        ...
        public void Test_IfOnPointYDoesntRenderForDefault_Correct()
        {
            ...
            chart.PlotOptions.Cylinder.OnPoint.Position.Y = defaultValue;
        ...
        public void Test_IfOpacityRenders_Correct(double value)
        {
            ...
            chart.PlotOptions.Cylinder.Opacity = value;
        ...
        public void Test_IfOpacityDoesntRenderForDefault_Correct()
        {
            ...
            chart.PlotOptions.Cylinder.Opacity = defaultValue;
        ...
        public void Test_IfPointEventsClickRenders_Correct(string value)
        {
            var chart = new Highcharts();
            var renderer = new HighchartsRenderer(chart);
            var pathToProperty = new List<string>() { "plotOptions", "cylinder", "point", "events" };

            chart.PlotOptions.Cylinder.Point.Events.Click = value;
        ...
        public void Test_IfPointEventsClickDoesntRenderForDefault_Correct()
        {
            ...
            chart.PlotOptions.Cylinder.Point.Events.Click = defaultValue;
        ...
        public void Test_IfPointEventsDragRenders_Correct(string value)
        {
            ...
            chart.PlotOptions.Cylinder.Point.Events.Drag = value;
        ...
        public void Test_IfPointEventsDragDoesntRenderForDefault_Correct()
        {
            ...
            chart.PlotOptions.Cylinder.Point.Events.Drag = defaultValue;
        ...
        public void Test_IfPointEventsDragStartRenders_Correct(string value)
        {
            ...
            chart.PlotOptions.Cylinder.Point.Events.DragStart = value;
        ...
        public void Test_IfPointEventsDragStartDoesntRenderForDefault_Correct()
        {
            ...
            chart.PlotOptions.Cylinder.Point.Events.DragStart = defaultValue;
        ...
        public void Test_IfPointEventsDropRenders_Correct(string value)
        {
            ...
            chart.PlotOptions.Cylinder.Point.Events.Drop = value;
        ...
        public void Test_IfPointEventsDropDoesntRenderForDefault_Correct()
        {
            ...
            chart.PlotOptions.Cylinder.Point.Events.Drop = defaultValue;
        ...
        public void Test_IfPointEventsMouseOutRenders_Correct(string value)
        {
            ...
            chart.PlotOptions.Cylinder.Point.Events.MouseOut = value;
        ...
        public void Test_IfPointEventsMouseOutDoesntRenderForDefault_Correct()
        {
            ...
            chart.PlotOptions.Cylinder.Point.Events.MouseOut = defaultValue;
        ...
        public void Test_IfPointEventsMouseOverRenders_Correct(string value)
        {
            ...
            chart.PlotOptions.Cylinder.Point.Events.MouseOver = value;
        ...
        public void Test_IfPointEventsMouseOverDoesntRenderForDefault_Correct()
        {
            ...
            chart.PlotOptions.Cylinder.Point.Events.MouseOver = defaultValue;
        ...
        public void Test_IfPointEventsRemoveRenders_Correct(string value)
        {
            ...
            chart.PlotOptions.Cylinder.Point.Events.Remove = value;
        ...
        public void Test_IfPointEventsRemoveDoesntRenderForDefault_Correct()
        {
            ...
            chart.PlotOptions.Cylinder.Point.Events.Remove = defaultValue;
        ...
        public void Test_IfPointEventsSelectRenders_Correct(string value)
        {
            ...
            chart.PlotOptions.Cylinder.Point.Events.Select = value;
        ...
        public void Test_IfPointEventsSelectDoesntRenderForDefault_Correct()
        {
            ...
            chart.PlotOptions.Cylinder.Point.Events.Select = defaultValue;
        ...
        public void Test_IfPointEventsUnselectRenders_Correct(string value)
        {
            ...
            chart.PlotOptions.Cylinder.Point.Events.Unselect = value;
        ...
        public void Test_IfPointEventsUnselectDoesntRenderForDefault_Correct()
        {
            ...
            chart.PlotOptions.Cylinder.Point.Events.Unselect = defaultValue;
        ...
        public void Test_IfPointEventsUpdateRenders_Correct(string value)
        {
            ...
            chart.PlotOptions.Cylinder.Point.Events.Update = value;
        ...
        public void Test_IfPointEventsUpdateDoesntRenderForDefault_Correct()
        {
            ...
            chart.PlotOptions.Cylinder.Point.Events.Update = defaultValue;
        ...
        public void Test_IfPointDescriptionFormatterRenders_Correct(string value)
        {
            ...
            chart.PlotOptions.Cylinder.PointDescriptionFormatter = value;
        ...
        public void Test_IfPointDescriptionFormatterDoesntRenderForDefault_Correct()
        {
            ...
            chart.PlotOptions.Cylinder.PointDescriptionFormatter = defaultValue;
        ...
        public void Test_IfPointIntervalRenders_Correct(double value)
        {
            ...
            chart.PlotOptions.Cylinder.PointInterval = value;
        ...
        public void Test_IfPointIntervalDoesntRenderForDefault_Correct()
        {
            ...
            chart.PlotOptions.Cylinder.PointInterval = defaultValue;

            Assert.DoesNotContain($"pointInterval", renderer.RenderHtml());
        }

        [Theory]
        [InlineData(PlotOptionsCylinderPointIntervalUnit.Day)]
        [InlineData(PlotOptionsCylinderPointIntervalUnit.Month)]
        [InlineData(PlotOptionsCylinderPointIntervalUnit.Year)]
        public void Test_IfPointIntervalUnitRenders_Correct(PlotOptionsCylinderPointIntervalUnit value)
        {
            var chart = new Highcharts();
            var renderer = new HighchartsRenderer(chart);

            chart.PlotOptions.Cylinder.PointIntervalUnit = value;
        ...
        public void Test_IfPointIntervalUnitDoesntRenderForDefault_Correct()
        {
            var chart = new Highcharts();
            var renderer = new HighchartsRenderer(chart);
            var defaultValue = PlotOptionsCylinderPointIntervalUnit.Null;

            chart.PlotOptions.Cylinder.PointIntervalUnit = defaultValue;
        ...
        public void Test_IfPointPlacementEnumRenders_Correct(PointPlacementEnum value)
        {
            ...
            chart.PlotOptions.Cylinder.PointPlacement = new PointPlacement() { PointPlacementEnum = value };
        ...
        public void Test_IfPointPlacementNumberRenders_Correct(double value)
        {
            ...
            chart.PlotOptions.Cylinder.PointPlacement = new PointPlacement() { Value = value };
        ...
        public void Test_IfPointPlacementDoesntRenderForDefault_Correct()
        {
            ...
            chart.PlotOptions.Cylinder.PointPlacement = new PointPlacement() { PointPlacementEnum = defaultValue };
        ...
        public void Test_IfPointStartRenders_Correct(double value)
        {
            ...
            chart.PlotOptions.Cylinder.PointStart = value;
        ...
        public void Test_IfPointStartDoesntRenderForDefault_Correct()
        {
            ...
            chart.PlotOptions.Cylinder.PointStart = defaultValue;
        ...
        public void Test_IfRelativeXValueRenders_Correct()
        {
            ...
            chart.PlotOptions.Cylinder.RelativeXValue = value;
        ...
        public void Test_IfRelativeXValueDoesntRenderForDefault_Correct()
        {
            ...
            chart.PlotOptions.Cylinder.RelativeXValue = defaultValue;
        ...
        public void Test_IfSelectedRenders_Correct()
        {
            ...
            chart.PlotOptions.Cylinder.Selected = value;
        ...
        public void Test_IfSelectedDoesntRenderForDefault_Correct()
        {
            ...
            chart.PlotOptions.Cylinder.Selected = defaultValue;
        ...
        public void Test_IfShadowBoolRenders_Correct()
        {
            ...
            chart.PlotOptions.Cylinder.ShadowBool = value;
        ...
        public void Test_IfShadowRenders_Correct(string color, int offsetX, int offsetY, double opacity, int width)
        {
            ...
            chart.PlotOptions.Cylinder.Shadow = new Shadow()
            {
                Color = color,
                OffsetX = offsetX,
                OffsetY = offsetY,
        ...
        public void Test_IfShadowBoolDoesntRenderForDefault_Correct()
        {
            ...
            chart.PlotOptions.Cylinder.ShadowBool = defaultValue;
        ...
        public void Test_IfShowCheckboxRenders_Correct()
        {
            ...
            chart.PlotOptions.Cylinder.ShowCheckbox = value;
        ...
        public void Test_IfShowCheckboxDoesntRenderForDefault_Correct()
        {
            ...
            chart.PlotOptions.Cylinder.ShowCheckbox = defaultValue;
        ...
        public void Test_IfShowInLegendRenders_Correct(bool value)
        {
            ...
            chart.PlotOptions.Cylinder.ShowInLegend = value;
        ...
        public void Test_IfShowInLegendDoesntRenderForDefault_Correct()
        {
            ...
            chart.PlotOptions.Cylinder.ShowInLegend = null;
        ...
        public void Test_IfSkipKeyboardNavigationRenders_Correct(bool value)
        {
            ...
            chart.PlotOptions.Cylinder.SkipKeyboardNavigation = value;
        ...
        public void Test_IfSkipKeyboardNavigationDoesntRenderForDefault_Correct()
        {
            ...
            chart.PlotOptions.Cylinder.SkipKeyboardNavigation = null;
        ...
        public void Test_IfSoftThresholdRenders_Correct()
        {
            ...
            chart.PlotOptions.Cylinder.SoftThreshold = value;
        ...
        public void Test_IfSoftThresholdDoesntRenderForDefault_Correct()
        {
            ...
            chart.PlotOptions.Cylinder.SoftThreshold = defaultValue;

            Assert.DoesNotContain($"softThreshold", renderer.RenderHtml());
        }

        [Theory]
        [InlineData(PlotOptionsCylinderStacking.Overlap)]
        [InlineData(PlotOptionsCylinderStacking.Percent)]
        [InlineData(PlotOptionsCylinderStacking.Normal)]
        [InlineData(PlotOptionsCylinderStacking.Stream)]
        public void Test_IfStackingRenders_Correct(PlotOptionsCylinderStacking value)
        {
            var chart = new Highcharts();
            var renderer = new HighchartsRenderer(chart);

            chart.PlotOptions.Cylinder.Stacking = value;
        ...
        public void Test_IfStackingDoesntRenderForDefault_Correct()
        {
            var chart = new Highcharts();
            var renderer = new HighchartsRenderer(chart);
            var defaultValue = PlotOptionsCylinderStacking.Null;

            chart.PlotOptions.Cylinder.Stacking = defaultValue;
        ...
        public void Test_IfStatesHoverAnimationDurationRenders_Correct(int value)
        {
            var chart = new Highcharts();
            var renderer = new HighchartsRenderer(chart);
            var pathToProperty = new List<string>() { "plotOptions", "cylinder", "states", "hover", "animation" };

            chart.PlotOptions.Cylinder.States.Hover.Animation.Duration = value;
        ...
        public void Test_IfStatesHoverAnimationDurationDoesntRenderForDefault_Correct()
        {
            ...
            chart.PlotOptions.Cylinder.States.Hover.Animation.Duration = defaultValue;
        ...
        public void Test_IfStatesHoverEnabledRenders_Correct()
        {
            var chart = new Highcharts();
            var renderer = new HighchartsRenderer(chart);
            var pathToProperty = new List<string>() { "plotOptions", "cylinder", "states", "hover" };
            var value = false;

            chart.PlotOptions.Cylinder.States.Hover.Enabled = false;
        ...
        //    chart.PlotOptions.Cylinder.States.Hover.Enabled = defaultValue;
        ...
        //    var chart = new Highcharts();
        //    var renderer = new HighchartsRenderer(chart);
        //    var pathToProperty = new List<string>() { "plotOptions", "cylinder", "states", "hover", "halo" };

        //    chart.PlotOptions.Cylinder.States.Hover.Halo.Attributes = value;
        ...
        public void Test_IfStatesHoverHaloOpacityRenders_Correct(double value)
        {
            ...
            chart.PlotOptions.Cylinder.States.Hover.Halo.Opacity = value;
        ...
        //    chart.PlotOptions.Cylinder.States.Hover.Halo.Opacity = defaultValue;
        ...
        //    chart.PlotOptions.Cylinder.States.Hover.Halo.Size = value;
        ...
        public void Test_IfStatesHoverLineWidthRenders_Correct(double value)
        {
            ...
            chart.PlotOptions.Cylinder.States.Hover.LineWidth = value;
        ...
        public void Test_IfStatesHoverLineWidthDoesntRenderForDefault_Correct()
        {
            ...
            chart.PlotOptions.Cylinder.States.Hover.LineWidth = defaultValue;
        ...
        public void Test_IfStatesHoverLineWidthPlusRenders_Correct(double value)
        {
            ...
            chart.PlotOptions.Cylinder.States.Hover.LineWidthPlus = value;
        ...
        //    chart.PlotOptions.Cylinder.States.Hover.LineWidthPlus = defaultValue;
        ...
        public void Test_IfStatesHoverMarkerEnabledRenders_Correct(bool value)
        {
            var chart = new Highcharts();
            var renderer = new HighchartsRenderer(chart);
            var pathToProperty = new List<string> { "plotOptions", "cylinder", "states", "hover", "marker" };

            chart.PlotOptions.Cylinder.States.Hover.Marker.Enabled = value;
        ...
        public void Test_IfStatesHoverMarkerEnabledDoesntRenderForDefault_Correct()
        {
            ...
            chart.PlotOptions.Cylinder.States.Hover.Marker.Enabled = defaultValue;
        ...
        public void Test_IfStatesHoverMarkerEnabledThresholdRenders_Correct(double value)
        {
            ...
            chart.PlotOptions.Cylinder.States.Hover.Marker.EnabledThreshold = value;
        ...
        public void Test_IfStatesHoverMarkerEnabledThresholdDoesntRenderForDefault_Correct()
        {
            ...
            chart.PlotOptions.Cylinder.States.Hover.Marker.EnabledThreshold = defaultValue;
        ...
        public void Test_IfStatesHoverMarkerFillColorRenders_Correct(string value)
        {
            ...
            chart.PlotOptions.Cylinder.States.Hover.Marker.FillColor = value;
        ...
        //    chart.PlotOptions.Cylinder.States.Hover.Marker.FillColor = defaultValue;
        ...
        public void Test_IfStatesHoverMarkerHeightRenders_Correct(double value)
        {
            ...
            chart.PlotOptions.Cylinder.States.Hover.Marker.Height = value;
        ...
        public void Test_IfStatesHoverMarkerHeightDoesntRenderForDefault_Correct()
        {
            ...
            chart.PlotOptions.Cylinder.States.Hover.Marker.Height = defaultValue;
        ...
        public void Test_IfStatesHoverMarkerLineColorRenders_Correct(string value)
        {
            ...
            chart.PlotOptions.Cylinder.States.Hover.Marker.LineColor = value;
        ...
        public void Test_IfStatesHoverMarkerLineColorDoesntRenderForDefault_Correct()
        {
            ...
            chart.PlotOptions.Cylinder.States.Hover.Marker.LineColor = defaultValue;
        ...
        public void Test_IfStatesHoverMarkerLineWidthRenders_Correct(double value)
        {
            ...
            chart.PlotOptions.Cylinder.States.Hover.Marker.LineWidth = value;
        ...
        public void Test_IfStatesHoverMarkerLineWidthDoesntRenderForDefault_Correct()
        {
            ...
            chart.PlotOptions.Cylinder.States.Hover.Marker.LineWidth = defaultValue;
        ...
        public void Test_IfStatesHoverMarkerRadiusRenders_Correct(double value)
        {
            ...
            chart.PlotOptions.Cylinder.States.Hover.Marker.Radius = value;
        ...
        public void Test_IfStatesHoverMarkerRadiusDoesntRenderForDefault_Correct()
        {
            ...
            chart.PlotOptions.Cylinder.States.Hover.Marker.Radius = defaultValue;
        ...
        public void Test_IfStatesHoverMarkerWidthRenders_Correct(double value)
        {
            ...
            chart.PlotOptions.Cylinder.States.Hover.Marker.Width = value;
        ...
        public void Test_IfStatesHoverMarkerWidthDoesntRenderForDefault_Correct()
        {
            ...
            chart.PlotOptions.Cylinder.States.Hover.Marker.Width = defaultValue;
        ...
        public void Test_IfStatesInactiveAnimationDurationRenders_Correct(int value)
        {
            var chart = new Highcharts();
            var renderer = new HighchartsRenderer(chart);
            var pathToProperty = new List<string>() { "plotOptions", "cylinder", "states", "inactive", "animation" };

            chart.PlotOptions.Cylinder.States.Inactive.Animation.Duration = value;
        ...
        public void Test_IfStatesInactiveAnimationDurationDoesntRenderForDefault_Correct()
        {
            ...
            chart.PlotOptions.Cylinder.States.Inactive.Animation.Duration = defaultValue;
        ...
        public void Test_IfStatesInactiveEnabledRenders_Correct()
        {
            var chart = new Highcharts();
            var renderer = new HighchartsRenderer(chart);
            var pathToProperty = new List<string>() { "plotOptions", "cylinder", "states", "inactive" };
            var value = false;

            chart.PlotOptions.Cylinder.States.Inactive.Enabled = false;
        ...
        //    chart.PlotOptions.Cylinder.States.Inactive.Enabled = defaultValue;
        ...
        public void Test_IfStatesInactiveOpacityRenders_Correct(double value)
        {
            ...
            chart.PlotOptions.Cylinder.States.Inactive.Opacity = value;
        ...
        //    chart.PlotOptions.Cylinder.States.Inactive.Opacity = defaultValue;
        ...
        public void Test_IfStatesNormalAnimationDurationRenders_Correct(int value)
        {
            var chart = new Highcharts();
            var renderer = new HighchartsRenderer(chart);
            var pathToProperty = new List<string>() { "plotOptions", "cylinder", "states", "normal", "animation" };

            chart.PlotOptions.Cylinder.States.Normal.Animation.Duration = value;
        ...
        public void Test_IfStatesNormalAnimationDurationDoesntRenderForDefault_Correct()
        {
            ...
            chart.PlotOptions.Cylinder.States.Normal.Animation.Duration = defaultValue;
        ...
        public void Test_IfStatesSelectAnimationDurationRenders_Correct(int value)
        {
            var chart = new Highcharts();
            var renderer = new HighchartsRenderer(chart);
            var pathToProperty = new List<string>() { "plotOptions", "cylinder", "states", "select", "animation" };

            chart.PlotOptions.Cylinder.States.Select.Animation.Duration = value;
        ...
        public void Test_IfStatesSelectAnimationDurationDoesntRenderForDefault_Correct()
        {
            ...
            chart.PlotOptions.Cylinder.States.Select.Animation.Duration = defaultValue;
        ...
        public void Test_IfStatesSelectEnabledRenders_Correct()
        {
            var chart = new Highcharts();
            var renderer = new HighchartsRenderer(chart);
            var pathToProperty = new List<string>() { "plotOptions", "cylinder", "states", "select" };
            var value = false;

            chart.PlotOptions.Cylinder.States.Select.Enabled = false;
        ...
        //    chart.PlotOptions.Cylinder.States.Select.Enabled = defaultValue;
        ...
        //    var chart = new Highcharts();
        //    var renderer = new HighchartsRenderer(chart);
        //    var pathToProperty = new List<string>() { "plotOptions", "cylinder", "states", "select", "halo" };

        //    chart.PlotOptions.Cylinder.States.Select.Halo.Attributes = value;
        ...
        public void Test_IfStatesSelectHaloOpacityRenders_Correct(double value)
        {
            ...
            chart.PlotOptions.Cylinder.States.Select.Halo.Opacity = value;
        ...
        //    chart.PlotOptions.Cylinder.States.Select.Halo.Opacity = defaultValue;
        ...
        //    chart.PlotOptions.Cylinder.States.Select.Halo.Size = value;
        ...
        public void Test_IfStatesSelectLineWidthRenders_Correct(double value)
        {
            ...
            chart.PlotOptions.Cylinder.States.Select.LineWidth = value;
        ...
        public void Test_IfStatesSelectLineWidthDoesntRenderForDefault_Correct()
        {
            ...
            chart.PlotOptions.Cylinder.States.Select.LineWidth = defaultValue;
        ...
        public void Test_IfStatesSelectLineWidthPlusRenders_Correct(double value)
        {
            ...
            chart.PlotOptions.Cylinder.States.Select.LineWidthPlus = value;
        ...
        //    chart.PlotOptions.Cylinder.States.Select.LineWidthPlus = defaultValue;
        ...
        public void Test_IfStatesSelectMarkerEnabledRenders_Correct(bool value)
        {
            var chart = new Highcharts();
            var renderer = new HighchartsRenderer(chart);
            var pathToProperty = new List<string> { "plotOptions", "cylinder", "states", "select", "marker" };

            chart.PlotOptions.Cylinder.States.Select.Marker.Enabled = value;
        ...
        public void Test_IfStatesSelectMarkerEnabledDoesntRenderForDefault_Correct()
        {
            ...
            chart.PlotOptions.Cylinder.States.Select.Marker.Enabled = defaultValue;
        ...
        public void Test_IfStatesSelectMarkerEnabledThresholdRenders_Correct(double value)
        {
            ...
            chart.PlotOptions.Cylinder.States.Select.Marker.EnabledThreshold = value;
        ...
        public void Test_IfStatesSelectMarkerEnabledThresholdDoesntRenderForDefault_Correct()
        {
            ...
            chart.PlotOptions.Cylinder.States.Select.Marker.EnabledThreshold = defaultValue;
        ...
        public void Test_IfStatesSelectMarkerFillColorRenders_Correct(string value)
        {
            ...
            chart.PlotOptions.Cylinder.States.Select.Marker.FillColor = value;
        ...
        //    chart.PlotOptions.Cylinder.States.Select.Marker.FillColor = defaultValue;
        ...
        public void Test_IfStatesSelectMarkerHeightRenders_Correct(double value)
        {
            ...
            chart.PlotOptions.Cylinder.States.Select.Marker.Height = value;
        ...
        public void Test_IfStatesSelectMarkerHeightDoesntRenderForDefault_Correct()
        {
            ...
            chart.PlotOptions.Cylinder.States.Select.Marker.Height = defaultValue;
        ...
        public void Test_IfStatesSelectMarkerLineColorRenders_Correct(string value)
        {
            ...
            chart.PlotOptions.Cylinder.States.Select.Marker.LineColor = value;
        ...
        public void Test_IfStatesSelectMarkerLineColorDoesntRenderForDefault_Correct()
        {
            ...
            chart.PlotOptions.Cylinder.States.Select.Marker.LineColor = defaultValue;
        ...
        public void Test_IfStatesSelectMarkerLineWidthRenders_Correct(double value)
        {
            ...
            chart.PlotOptions.Cylinder.States.Select.Marker.LineWidth = value;
        ...
        public void Test_IfStatesSelectMarkerLineWidthDoesntRenderForDefault_Correct()
        {
            ...
            chart.PlotOptions.Cylinder.States.Select.Marker.LineWidth = defaultValue;
        ...
        public void Test_IfStatesSelectMarkerRadiusRenders_Correct(double value)
        {
            ...
            chart.PlotOptions.Cylinder.States.Select.Marker.Radius = value;
        ...
        public void Test_IfStatesSelectMarkerRadiusDoesntRenderForDefault_Correct()
        {
            ...
            chart.PlotOptions.Cylinder.States.Select.Marker.Radius = defaultValue;
        ...
        public void Test_IfStatesSelectMarkerWidthRenders_Correct(double value)
        {
            ...
            chart.PlotOptions.Cylinder.States.Select.Marker.Width = value;
        ...
        public void Test_IfStatesSelectMarkerWidthDoesntRenderForDefault_Correct()
        {
            ...
            chart.PlotOptions.Cylinder.States.Select.Marker.Width = defaultValue;
        ...
        public void Test_IfStickyTrackingRenders_Correct()
        {
            ...
            chart.PlotOptions.Cylinder.StickyTracking = value;
        ...
        public void Test_IfStickyTrackingDoesntRenderForDefault_Correct()
        {
            ...
            chart.PlotOptions.Cylinder.StickyTracking = defaultValue;
        ...
        public void Test_IfThresholdRenders_Correct(double value)
        {
            ...
            chart.PlotOptions.Cylinder.Threshold = value;
        ...
        public void Test_IfThresholdDoesntRenderForDefault_Correct()
        {
            ...
            chart.PlotOptions.Cylinder.Threshold = defaultValue;
        ...
        public void Test_IfTooltipClusterFormatRenders_Correct(string value)
        {
            var chart = new Highcharts();
            var renderer = new HighchartsRenderer(chart);
            var pathToProperty = new List<string>() { "plotOptions", "cylinder", "tooltip" };

            chart.PlotOptions.Cylinder.Tooltip.ClusterFormat = value;
        ...
        public void Test_IfTooltipClusterFormatDoesntRenderForDefault_Correct()
        {
            ...
            chart.PlotOptions.Cylinder.Tooltip.ClusterFormat = defaultValue;
        ...
        public void Test_IfTooltipDateTimeLabelFormatsRenders_Correct(string param, string paramValue)
        {
            ...
            chart.PlotOptions.Cylinder.Tooltip.DateTimeLabelFormats = value;
        ...
        //    chart.PlotOptions.Cylinder.Tooltip.DateTimeLabelFormats = defaultValue;
        ...
        public void Test_IfTooltipDistanceRenders_Correct(double value)
        {
            ...
            chart.PlotOptions.Cylinder.Tooltip.Distance = value;
        ...
        public void Test_IfTooltipDistanceDoesntRenderForDefault_Correct()
        {
            ...
            chart.PlotOptions.Cylinder.Tooltip.Distance = defaultValue;
        ...
        public void Test_IfTooltipFollowPointerRenders_Correct()
        {
            ...
            chart.PlotOptions.Cylinder.Tooltip.FollowPointer = value;
        ...
        //    chart.PlotOptions.Cylinder.Tooltip.FollowPointer = defaultValue;
        ...
        public void Test_IfTooltipFollowTouchMoveRenders_Correct()
        {
            ...
            chart.PlotOptions.Cylinder.Tooltip.FollowTouchMove = value;
        ...
        //    chart.PlotOptions.Cylinder.Tooltip.FollowTouchMove = defaultValue;
        ...
        public void Test_IfTooltipFooterFormatRenders_Correct(string value)
        {
            ...
            chart.PlotOptions.Cylinder.Tooltip.FooterFormat = value;
        ...
        public void Test_IfTooltipFooterFormatDoesntRenderForDefault_Correct()
        {
            ...
            chart.PlotOptions.Cylinder.Tooltip.FooterFormat = defaultValue;
        ...
        public void Test_IfTooltipHeaderFormatRenders_Correct(string value)
        {
            ...
            chart.PlotOptions.Cylinder.Tooltip.HeaderFormat = value;
        ...
        public void Test_IfTooltipHeaderFormatDoesntRenderForDefault_Correct()
        {
            ...
            chart.PlotOptions.Cylinder.Tooltip.HeaderFormat = defaultValue;
        ...
        public void Test_IfTooltipNullFormatRenders_Correct(string value)
        {
            ...
            chart.PlotOptions.Cylinder.Tooltip.NullFormat = value;
        ...
        public void Test_IfTooltipNullFormatDoesntRenderForDefault_Correct()
        {
            ...
            chart.PlotOptions.Cylinder.Tooltip.NullFormat = defaultValue;
        ...
        public void Test_IfTooltipNullFormatterRenders_Correct(string value)
        {
            ...
            chart.PlotOptions.Cylinder.Tooltip.NullFormatter = value;
        ...
        public void Test_IfTooltipNullFormatterDoesntRenderForDefault_Correct()
        {
            ...
            chart.PlotOptions.Cylinder.Tooltip.NullFormatter = defaultValue;
        ...
        public void Test_IfTooltipPointFormatRenders_Correct(string value)
        {
            ...
            chart.PlotOptions.Cylinder.Tooltip.PointFormat = value;
        ...
        public void Test_IfTooltipPointFormatDoesntRenderForDefault_Correct()
        {
            ...
            chart.PlotOptions.Cylinder.Tooltip.PointFormat = defaultValue;
        ...
        public void Test_IfTooltipPointFormatterRenders_Correct(string value)
        {
            ...
            chart.PlotOptions.Cylinder.Tooltip.PointFormatter = value;
        ...
        public void Test_IfTooltipPointFormatterDoesntRenderForDefault_Correct()
        {
            ...
            chart.PlotOptions.Cylinder.Tooltip.PointFormatter = defaultValue;
        ...
        public void Test_IfTooltipValueDecimalsRenders_Correct(double value)
        {
            ...
            chart.PlotOptions.Cylinder.Tooltip.ValueDecimals = value;
        ...
        public void Test_IfTooltipValueDecimalsDoesntRenderForDefault_Correct()
        {
            ...
            chart.PlotOptions.Cylinder.Tooltip.ValueDecimals = defaultValue;
        ...
        public void Test_IfTooltipValuePrefixRenders_Correct(string value)
        {
            ...
            chart.PlotOptions.Cylinder.Tooltip.ValuePrefix = value;
        ...
        public void Test_IfTooltipValuePrefixDoesntRenderForDefault_Correct()
        {
            ...
            chart.PlotOptions.Cylinder.Tooltip.ValuePrefix = defaultValue;
        ...
        public void Test_IfTooltipValueSuffixRenders_Correct(string value)
        {
            ...
            chart.PlotOptions.Cylinder.Tooltip.ValueSuffix = value;
        ...
        public void Test_IfTooltipValueSuffixDoesntRenderForDefault_Correct()
        {
            ...
            chart.PlotOptions.Cylinder.Tooltip.ValueSuffix = defaultValue;
        ...
        public void Test_IfTooltipXDateFormatRenders_Correct(string value)
        {
            ...
            chart.PlotOptions.Cylinder.Tooltip.XDateFormat = value;
        ...
        public void Test_IfTooltipXDateFormatDoesntRenderForDefault_Correct()
        {
            ...
            chart.PlotOptions.Cylinder.Tooltip.XDateFormat = defaultValue;
        ...
        public void Test_IfTurboThresholdTrackingRenders_Correct(double value)
        {
            ...
            chart.PlotOptions.Cylinder.TurboThreshold = value;
        ...
        public void Test_IfTurboThresholdDoesntRenderForDefault_Correct()
        {
            ...
            chart.PlotOptions.Cylinder.TurboThreshold = defaultValue;
        ...
        public void Test_IfVisibleRenders_Correct()
        {
            ...
            chart.PlotOptions.Cylinder.Visible = value;
        ...
        public void Test_IfVisibleDoesntRenderForDefault_Correct()
        {
            ...
            chart.PlotOptions.Cylinder.Visible = defaultValue;
        ...
        public void Test_IfZoneAxisRenders_Correct()
        {
            ...
            chart.PlotOptions.Cylinder.ZoneAxis = value;
        ...
        public void Test_IfZoneAxisDoesntRenderForDefault_Correct()
        {
            ...
            chart.PlotOptions.Cylinder.ZoneAxis = defaultValue;
        ...
        public void Test_IfZonesClassNameRenders_Correct(string value)
        {
            var chart = new Highcharts();
            var renderer = new HighchartsRenderer(chart);
            var pathToProperty = new List<string>() { "plotOptions", "cylinder", "zones" };
            var zoneDef = new List<PlotOptionsCylinderZone> { new PlotOptionsCylinderZone { ClassName = value } };

            chart.PlotOptions.Cylinder.Zones = zoneDef;
        ...
        public void Test_IfZonesClassNameDoesntRenderForDefault_Correct()
        {
            ...
            var renderer = new HighchartsRenderer(chart);
            var defaultValue = string.Empty;
            var zoneDef = new List<PlotOptionsCylinderZone> { new PlotOptionsCylinderZone { ClassName = defaultValue } };
        ...
        public void Test_IfZonesColorRenders_Correct(string value)
        {
            ...
            var renderer = new HighchartsRenderer(chart);
            var pathToProperty = new List<string>() { "plotOptions", "cylinder", "zones" };
            var zoneDef = new List<PlotOptionsCylinderZone> { new PlotOptionsCylinderZone { Color = value } };
        ...
        public void Test_IfZonesColorDoesntRenderForDefault_Correct()
        {
            ...
            var renderer = new HighchartsRenderer(chart);
            var defaultValue = string.Empty;
            var zoneDef = new List<PlotOptionsCylinderZone> { new PlotOptionsCylinderZone { Color = defaultValue } };
        ...
        [Theory]
        [InlineData(PlotOptionsCylinderZonesDashStyle.Dash)]
        [InlineData(PlotOptionsCylinderZonesDashStyle.DashDot)]
        [InlineData(PlotOptionsCylinderZonesDashStyle.Dot)]
        [InlineData(PlotOptionsCylinderZonesDashStyle.LongDash)]
        [InlineData(PlotOptionsCylinderZonesDashStyle.LongDashDot)]
        [InlineData(PlotOptionsCylinderZonesDashStyle.LongDashDotDot)]
        [InlineData(PlotOptionsCylinderZonesDashStyle.ShortDash)]
        [InlineData(PlotOptionsCylinderZonesDashStyle.ShortDashDot)]
        [InlineData(PlotOptionsCylinderZonesDashStyle.ShortDashDotDot)]
        [InlineData(PlotOptionsCylinderZonesDashStyle.ShortDot)]
        [InlineData(PlotOptionsCylinderZonesDashStyle.Solid)]
        public void Test_IfZonesDashStyleRenders_Correct(PlotOptionsCylinderZonesDashStyle value)
        {
            var chart = new Highcharts();
            var renderer = new HighchartsRenderer(chart);
            var pathToProperty = new List<string>() { "plotOptions", "cylinder", "zones" };
            var zoneDef = new List<PlotOptionsCylinderZone> { new PlotOptionsCylinderZone { DashStyle = value } };
        ...
        public void Test_IfZonesDashStyleDoesntRenderForDefault_Correct()
        {
            var chart = new Highcharts();
            var renderer = new HighchartsRenderer(chart);
            var defaultValue = PlotOptionsCylinderZonesDashStyle.Null;
            var zoneDef = new List<PlotOptionsCylinderZone> { new PlotOptionsCylinderZone { DashStyle = defaultValue } };
        ...
        public void Test_IfZonesFillColorRenders_Correct(string value)
        {
            ...
            var renderer = new HighchartsRenderer(chart);
            var pathToProperty = new List<string>() { "plotOptions", "cylinder", "zones" };
            var zoneDef = new List<PlotOptionsCylinderZone> { new PlotOptionsCylinderZone { FillColor = value } };
        ...
        //    var renderer = new HighchartsRenderer(chart);
        //    var defaultValue = string.Empty;
        //    var zoneDef = new List<PlotOptionsCylinderZone> { new PlotOptionsCylinderZone { FillColor = defaultValue } };
        ...
        public void Test_IfZonesValueRenders_Correct(double value)
        {
            ...
            var renderer = new HighchartsRenderer(chart);
            var pathToProperty = new List<string>() { "plotOptions", "cylinder", "zones" };
            var zoneDef = new List<PlotOptionsCylinderZone> { new PlotOptionsCylinderZone { Value = value } };
        ...
        public void Test_IfZonesValueDoesntRenderForDefault_Correct()
        {
            ...
            var renderer = new HighchartsRenderer(chart);
            double? defaultValue = null;
            var zoneDef = new List<PlotOptionsCylinderZone> { new PlotOptionsCylinderZone { Value = defaultValue } };
