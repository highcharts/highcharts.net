...
namespace HC.PlotOptions
{
    public class PlotOptionsGaugeTests : IClassFixture<HcFixture>
    {
        ...
        public void Test_IfAnimationDeferRenders_Correct(int defer)
        {
            ...
            chart.PlotOptions.Gauge.Animation.Defer = defer;
        ...
        public void Test_IfDataLabelsAnimationDeferRenders_Correct(int value)
        {
            ...
            chart.PlotOptions.Gauge.DataLabels.Animation.Defer = value;
        ...
        public void Test_IfDataLabelsAnimationDeferDoesntRenderForDefault_Correct()
        {
            ...
            chart.PlotOptions.Gauge.DataLabels.Animation.Defer = defaultValue;
        ...
        [Fact]
        public void Test_IfDataLabelsEnabledDoesntRenderForDefault_Correct()
        {
            var chart = new Highcharts();
            var renderer = new HighchartsRenderer(chart);
        ...
        public void Test_IfDataLabelsStyleStringRenders_Correct(string param1, string param1_value)
        {
            var chart = new Highcharts();
            var renderer = new HighchartsRenderer(chart);
            var pathToProperty = new List<string>() { "plotOptions", "gauge", "dataLabels", "style" };
        ...
        public void Test_IfDataLabelsTextPathEnabledRenders_Correct(bool value)
        {
            var chart = new Highcharts();
            var renderer = new HighchartsRenderer(chart);
            var pathToProperty = new List<string> { "plotOptions", "gauge", "dataLabels", "textPath" };
        ...
        [InlineData(PlotOptionsGaugeDataLabelsVerticalAlign.Bottom)]
        ...
        public void Test_IfDataLabelsVerticalAlignDoesntRenderForDefault_Correct()
        {
            var chart = new Highcharts();
            var renderer = new HighchartsRenderer(chart);
            var defaultValue = PlotOptionsGaugeDataLabelsVerticalAlign.Top;
        ...
        public void Test_IfEventsAfterAnimateRenders_Correct(string value)
        {
            var chart = new Highcharts();
            var renderer = new HighchartsRenderer(chart);
            var pathToProperty = new List<string> { "plotOptions", "gauge", "events" };
        ...
        public void Test_IfKeysRenders_Correct(string arg1, string arg2, string arg3, string arg4)
        {
            ...
            chart.PlotOptions.Gauge.Keys = value;
        ...
        public void Test_IfLabelConnectorAllowedRenders_Correct()
        {
            var chart = new Highcharts();
            var renderer = new HighchartsRenderer(chart);
            var pathToProperty = new List<string> { "plotOptions", "gauge", "label" };
            var value = true;
        ...
        //    var chart = new Highcharts();
        //    var renderer = new HighchartsRenderer(chart);
        //    var pathToProperty = new List<string>() { "plotOptions", "gauge", "onPoint", "connectorOptions" };
        ...
        public void Test_IfOnPointIdRenders_Correct(string value)
        {
            var chart = new Highcharts();
            var renderer = new HighchartsRenderer(chart);
            var pathToProperty = new List<string>() { "plotOptions", "gauge", "onPoint" };
        ...
        public void Test_IfOnPointPositionOffsetXRenders_Correct(double value)
        {
            var chart = new Highcharts();
            var renderer = new HighchartsRenderer(chart);
            var pathToProperty = new List<string>() { "plotOptions", "gauge", "onPoint", "position" };
        ...
        public void Test_IfPointEventsClickRenders_Correct(string value)
        {
            var chart = new Highcharts();
            var renderer = new HighchartsRenderer(chart);
            var pathToProperty = new List<string>() { "plotOptions", "gauge", "point", "events" };
        ...
        public void Test_IfPointIntervalRenders_Correct(double value)
        {
            ...
            chart.PlotOptions.Gauge.PointInterval = value;
        ...
        public void Test_IfPointIntervalDoesntRenderForDefault_Correct()
        {
            ...
            chart.PlotOptions.Gauge.PointInterval = defaultValue;

            Assert.DoesNotContain($"pointInterval", renderer.RenderHtml());
        }

        [Theory]
        [InlineData(PlotOptionsGaugePointIntervalUnit.Day)]
        [InlineData(PlotOptionsGaugePointIntervalUnit.Month)]
        [InlineData(PlotOptionsGaugePointIntervalUnit.Year)]
        public void Test_IfPointIntervalUnitRenders_Correct(PlotOptionsGaugePointIntervalUnit value)
        {
            var chart = new Highcharts();
            var renderer = new HighchartsRenderer(chart);

            chart.PlotOptions.Gauge.PointIntervalUnit = value;
        ...
        public void Test_IfPointIntervalUnitDoesntRenderForDefault_Correct()
        {
            var chart = new Highcharts();
            var renderer = new HighchartsRenderer(chart);
            var defaultValue = PlotOptionsGaugePointIntervalUnit.Null;

            chart.PlotOptions.Gauge.PointIntervalUnit = defaultValue;
        ...
        public void Test_IfPointStartRenders_Correct(double value)
        {
            ...
            chart.PlotOptions.Gauge.PointStart = value;
        ...
        public void Test_IfPointStartDoesntRenderForDefault_Correct()
        {
            ...
            chart.PlotOptions.Gauge.PointStart = defaultValue;
        ...
        public void Test_IfShowInLegendDoesntRenderForDefault_Correct()
        {
            ...
            chart.PlotOptions.Gauge.ShowInLegend = defaultValue;
        ...
        //fix required - for tooltip exists only headerFormat - missing all others properties
        //[Fact]
        ...
        //    chart.PlotOptions.Gauge.Tooltip.ClusterFormat = defaultValue;
        ...
        //    var chart = new Highcharts();
        //    var renderer = new HighchartsRenderer(chart);
        //    var pathToProperty = new List<string>() { "plotOptions", "gauge", "tooltip" };
        //    var value = new Hashtable();
        //    value.Add(param, paramValue);

        //    chart.PlotOptions.Gauge.Tooltip.DateTimeLabelFormats = value;
        ...
        //    chart.PlotOptions.Gauge.Tooltip.DateTimeLabelFormats = defaultValue;
        ...
        //    chart.PlotOptions.Gauge.Tooltip.Distance = value;
        ...
        //    chart.PlotOptions.Gauge.Tooltip.Distance = defaultValue;
        ...
        //    chart.PlotOptions.Gauge.Tooltip.FollowPointer = value;
        ...
        ////    chart.PlotOptions.Gauge.Tooltip.FollowPointer = defaultValue;
        ...
        //    chart.PlotOptions.Gauge.Tooltip.FollowTouchMove = value;
        ...
        ////    chart.PlotOptions.Gauge.Tooltip.FollowTouchMove = defaultValue;
        ...
        //    chart.PlotOptions.Gauge.Tooltip.FooterFormat = value;
        ...
        //    chart.PlotOptions.Gauge.Tooltip.FooterFormat = defaultValue;
        ...
        //    chart.PlotOptions.Gauge.Tooltip.HeaderFormat = value;
        ...
        //    chart.PlotOptions.Gauge.Tooltip.HeaderFormat = defaultValue;
        ...
        //    chart.PlotOptions.Gauge.Tooltip.NullFormat = value;
        ...
        //    chart.PlotOptions.Gauge.Tooltip.NullFormat = defaultValue;
        ...
        //    chart.PlotOptions.Gauge.Tooltip.NullFormatter = value;
        ...
        //    chart.PlotOptions.Gauge.Tooltip.NullFormatter = defaultValue;
        ...
        //    chart.PlotOptions.Gauge.Tooltip.PointFormat = value;
        ...
        //    chart.PlotOptions.Gauge.Tooltip.PointFormat = defaultValue;
        ...
        //    chart.PlotOptions.Gauge.Tooltip.PointFormatter = value;
        ...
        //    chart.PlotOptions.Gauge.Tooltip.PointFormatter = defaultValue;
        ...
        //    chart.PlotOptions.Gauge.Tooltip.ValuePrefix = value;
        ...
        //    chart.PlotOptions.Gauge.Tooltip.ValuePrefix = defaultValue;
        ...
        //    chart.PlotOptions.Gauge.Tooltip.ValueSuffix = value;
        ...
        //    chart.PlotOptions.Gauge.Tooltip.ValueSuffix = defaultValue;
        ...
        //    chart.PlotOptions.Gauge.Tooltip.XDateFormat = value;
        ...
        //    chart.PlotOptions.Gauge.Tooltip.XDateFormat = defaultValue;
