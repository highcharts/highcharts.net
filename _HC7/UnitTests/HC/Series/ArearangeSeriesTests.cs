...
namespace HC.Series
{
    public class ArearangeSeriesTests : IClassFixture<HcFixture>
    {
        protected HcFixture _fixture;

        public ArearangeSeriesTests(HcFixture fixture)
        {
            _fixture = fixture;
            _fixture.ChartType = ChartType.Arearange;
        }
        ...
        public void Test_IfSeriesRendersType_Correct()
        {
            ...
            var series = new ArearangeSeries();
        ...
        public void Test_IfAccessibilityDescriptionRenders_Correct(string description)
        {
            ...
            ((ArearangeSeries)chart.Series[0]).Accessibility.Description = description;
            var result = renderer.RenderHtml();
        ...
        public void Test_IfAccessibilityEnabledRenders_Correct(bool enabled)
        {
            ...
            var renderer = new HighchartsRenderer(chart); var series = new ArearangeSeries(); chart.Series = new List<Highsoft.Web.Mvc.Charts.Series>(); chart.Series.Add(series); 

            ((ArearangeSeries)chart.Series[0]).Accessibility.Enabled = enabled;
        ...
        public void Test_IfAccessibilityExposeAsGroupOnlyRenders_Correct(bool exposeAsGroupOnly)
        {
            ...
            ((ArearangeSeries)chart.Series[0]).Accessibility.ExposeAsGroupOnly = exposeAsGroupOnly;
        ...
        public void Test_IfAccessibilityKeyboardNavigationEnabledRenders_Correct(bool enabled)
        {
            ...
            ((ArearangeSeries)chart.Series[0]).Accessibility.KeyboardNavigation.Enabled = enabled;
        ...
        public void Test_IfAccessibilityPointDateFormatRenders_Correct(string format)
        {
            ...
            ((ArearangeSeries)chart.Series[0]).Accessibility.Point.DateFormat = format;
        ...
        public void Test_IfAccessibilityPointDateFormatterRenders_Correct(string function)
        {
            ...
            ((ArearangeSeries)chart.Series[0]).Accessibility.Point.DateFormatter = function;
        ...
        public void Test_IfAccessibilityPointDescribeNullSetOnFalseRenders_Correct(bool describeNull)
        {
            ...
            ((ArearangeSeries)chart.Series[0]).Accessibility.Point.DescribeNull = describeNull;
        ...
        public void Test_IfAccessibilityPointDescriptionFormatterRenders_Correct(string function)
        {
            ...
            ((ArearangeSeries)chart.Series[0]).Accessibility.Point.DescriptionFormatter = function;
        ...
        public void Test_IfAccessibilityPointValueDecimalsRenders_Correct(int decimals)
        {
            ...
            ((ArearangeSeries)chart.Series[0]).Accessibility.Point.ValueDecimals = decimals;
        ...
        public void Test_IfAccessibilityPointValueDescriptionFormatRenders_Correct(string format)
        {
            ...
            ((ArearangeSeries)chart.Series[0]).Accessibility.Point.ValueDescriptionFormat = format;
        ...
        public void Test_IfAccessibilityPointValuePrefixRenders_Correct(string prefix)
        {
            ...
            ((ArearangeSeries)chart.Series[0]).Accessibility.Point.ValuePrefix = prefix;
        ...
        public void Test_IfAccessibilityPointValueSufixRenders_Correct(string suffix)
        {
            ...
            ((ArearangeSeries)chart.Series[0]).Accessibility.Point.ValueSuffix = suffix;
        ...
        public void Test_IfAllowPointSelectRenders_Correct()
        {
            ...
            ((ArearangeSeries)chart.Series[0]).AllowPointSelect = enabled;
        ...
        public void Test_IfAllowPointSelectDoesntRenderForDefault_Correct()
        {
            ...
            ((ArearangeSeries)chart.Series[0]).AllowPointSelect = false;
        ...
        public void Test_IfAnimationEnabledRenders_Correct()
        {
            ...
            ((ArearangeSeries)chart.Series[0]).AnimationBool = enabled;
        ...
        public void Test_IfAnimationDurationRenders_Correct(int duration)
        {
            ...
            ((ArearangeSeries)chart.Series[0]).Animation.Duration = duration;
        ...
        public void Test_IfAnimationDeferRenders_Correct(int defer)
        {
            ...
            ((ArearangeSeries)chart.Series[0]).Animation.Defer = defer;
        ...
        public void Test_IfAnimationEasingRenders_Correct(string easing)
        {
            ...
            ((ArearangeSeries)chart.Series[0]).Animation.Easing = easing;
        ...
        public void Test_IfAnimationLimitRenders_Correct(int limit)
        {
            ...
            ((ArearangeSeries)chart.Series[0]).AnimationLimit = limit;

            Assert.Contains($"\"animationLimit\":{limit}.0", renderer.RenderHtml());
        }

        [Theory]
        [InlineData(ArearangeSeriesBoostBlending.Add)]
        [InlineData(ArearangeSeriesBoostBlending.Darken)]
        [InlineData(ArearangeSeriesBoostBlending.Multiply)]
        public void Test_IfBoostBlendingRenders_Correct(ArearangeSeriesBoostBlending boostBlending)
        {
            var chart = new Highcharts(); chart.Chart = new Chart();
            var renderer = new HighchartsRenderer(chart); var series = new ArearangeSeries(); chart.Series = new List<Highsoft.Web.Mvc.Charts.Series>(); chart.Series.Add(series);

            ((ArearangeSeries)chart.Series[0]).BoostBlending = boostBlending;
        ...
        public void Test_IfBoostBlendingDoesntRenderForDefault_Correct()
        {
            ...
            ((ArearangeSeries)chart.Series[0]).BoostBlending = ArearangeSeriesBoostBlending.Undefined;
        ...
        public void Test_IfBoostThresholdRenders_Correct(int limit)
        {
            ...
            ((ArearangeSeries)chart.Series[0]).BoostThreshold = limit;
        ...
        public void Test_IfBoostThresholdDoesntRenderForDefault_Correct()
        {
            ...
            ((ArearangeSeries)chart.Series[0]).BoostThreshold = defaultValue;
        ...
        public void Test_IfClassNameRenders_Correct(string className)
        {
            ...
            ((ArearangeSeries)chart.Series[0]).ClassName = className;
        ...
        public void Test_IfClipRenders_Correct()
        {
            ...
            ((ArearangeSeries)chart.Series[0]).Clip = value;
        ...
        public void Test_IfColorRenders_Correct(string color)
        {
            ...
            ((ArearangeSeries)chart.Series[0]).Color = color;
        ...
        public void Test_IfColorAxisRendersString_Correct(string id)
        {
            ...
            ((ArearangeSeries)chart.Series[0]).ColorAxis = id;
        ...
        public void Test_IfColorAxisRendersNumber_Correct(int index)
        {
            ...
            ((ArearangeSeries)chart.Series[0]).ColorAxisNumber = index;
        ...
        public void Test_IfColorAxisRendersBool_Correct(bool value)
        {
            var chart = new Highcharts(); chart.Chart = new Chart();
            var renderer = new HighchartsRenderer(chart); var series = new ArearangeSeries(); chart.Series = new List<Highsoft.Web.Mvc.Charts.Series>(); chart.Series.Add(series);
            ((ArearangeSeries)chart.Series[0]).ColorAxisBool = value;
        ...
        public void Test_IfColorIndexRenders_Correct(int value)
        {
            ...
            ((ArearangeSeries)chart.Series[0]).ColorIndex = value;
        ...
        public void Test_IfColorKeyRenders_Correct(string value)
        {
            ...
            ((ArearangeSeries)chart.Series[0]).ColorKey = value;
        ...
        public void Test_IfConnectEndsRenders_Correct(bool value)
        {
            ...
            ((ArearangeSeries)chart.Series[0]).ConnectEnds = value;
        ...
        public void Test_IfConnectNullsRenders_Correct()
        {
            ...
            ((ArearangeSeries)chart.Series[0]).ConnectNulls = value;
        ...
        public void Test_IfCrispRenders_Correct()
        {
            ...
            ((ArearangeSeries)chart.Series[0]).Crisp = value;
        ...
        public void Test_IfCropThresholdRenders_Correct(int value)
        {
            ...
            ((ArearangeSeries)chart.Series[0]).CropThreshold = value;
        ...
        public void Test_IfCropThresholdDoesntRenderForDefault_Correct()
        {
            ...
            ((ArearangeSeries)chart.Series[0]).CropThreshold = defaultValue;

            Assert.DoesNotContain($"\"crisp\"", renderer.RenderHtml());
        }

        [Theory]
        [InlineData(ArearangeSeriesCursor.Default)]
        [InlineData(ArearangeSeriesCursor.Help)]
        [InlineData(ArearangeSeriesCursor.Pointer)]
        [InlineData(ArearangeSeriesCursor.None)]
        public void Test_IfCursorRenders_Correct(ArearangeSeriesCursor cursor)
        {
            var chart = new Highcharts(); chart.Chart = new Chart();
            var renderer = new HighchartsRenderer(chart); var series = new ArearangeSeries(); chart.Series = new List<Highsoft.Web.Mvc.Charts.Series>(); chart.Series.Add(series);

            ((ArearangeSeries)chart.Series[0]).Cursor = cursor;
        ...
        public void Test_IfCustomRenders_Correct(string key1, string value1)
        {
            ...
            ((ArearangeSeries)chart.Series[0]).Custom = extraData;

            Assert.Contains($"\"custom\":{{\"{key1}\":\"{value1}\"}}", renderer.RenderHtml());
        }

        [Theory]
        [InlineData(ArearangeSeriesDashStyle.Dash)]
        [InlineData(ArearangeSeriesDashStyle.DashDot)]
        [InlineData(ArearangeSeriesDashStyle.Dot)]
        [InlineData(ArearangeSeriesDashStyle.LongDash)]
        [InlineData(ArearangeSeriesDashStyle.LongDashDot)]
        [InlineData(ArearangeSeriesDashStyle.LongDashDotDot)]
        [InlineData(ArearangeSeriesDashStyle.ShortDash)]
        [InlineData(ArearangeSeriesDashStyle.ShortDashDot)]
        [InlineData(ArearangeSeriesDashStyle.ShortDashDotDot)]
        [InlineData(ArearangeSeriesDashStyle.ShortDot)]
        public void Test_IfDashStyleRenders_Correct(ArearangeSeriesDashStyle style)
        {
            var chart = new Highcharts(); chart.Chart = new Chart();
            var renderer = new HighchartsRenderer(chart); var series = new ArearangeSeries(); chart.Series = new List<Highsoft.Web.Mvc.Charts.Series>(); chart.Series.Add(series);
            ...
            ((ArearangeSeries)chart.Series[0]).DashStyle = style;
        ...
        [Theory]
        [InlineData(ArearangeSeriesDataLabelsAlign.Left)]
        [InlineData(ArearangeSeriesDataLabelsAlign.Right)]
        public void Test_IfDataLabelsAlignRenders_Correct(ArearangeSeriesDataLabelsAlign align)
        {
            var chart = new Highcharts(); chart.Chart = new Chart();
            var renderer = new HighchartsRenderer(chart); var series = new ArearangeSeries(); chart.Series = new List<Highsoft.Web.Mvc.Charts.Series>(); chart.Series.Add(series);

            ((ArearangeSeries)chart.Series[0]).DataLabels.Align = align;
        ...
        public void Test_IfDataLabelsAlignDoesntRenderForDefault_Correct()
        {
            var chart = new Highcharts(); chart.Chart = new Chart();
            var renderer = new HighchartsRenderer(chart); var series = new ArearangeSeries(); chart.Series = new List<Highsoft.Web.Mvc.Charts.Series>(); chart.Series.Add(series);
            var defaultValue = ArearangeSeriesDataLabelsAlign.Center;

            ((ArearangeSeries)chart.Series[0]).DataLabels.Align = defaultValue;
        ...
        public void Test_IfDataLabelsAllowOverlapRenders_Correct()
        {
            ...
            ((ArearangeSeries)chart.Series[0]).DataLabels.AllowOverlap = value;
        ...
        public void Test_IfDataLabelsAllowOverlapDoesntRenderForDefault_Correct()
        {
            ...
            ((ArearangeSeries)chart.Series[0]).DataLabels.AllowOverlap = defaultValue;
        ...
        public void Test_IfDataLabelsAnimationDeferRenders_Correct(int value)
        {
            ...
            ((ArearangeSeries)chart.Series[0]).DataLabels.Animation.Defer = value;
        ...
        public void Test_IfDataLabelsAnimationDeferDoesntRenderForDefault_Correct()
        {
            ...
            ((ArearangeSeries)chart.Series[0]).DataLabels.Animation.Defer = defaultValue;
        ...
        public void Test_IfDataLabelsBackgroundColorRenders_Correct(string value)
        {
            ...
            ((ArearangeSeries)chart.Series[0]).DataLabels.BackgroundColor = value;
        ...
        public void Test_IfDataLabelsBackgroundColorDoesntRenderForDefault_Correct()
        {
            ...
            ((ArearangeSeries)chart.Series[0]).DataLabels.BackgroundColor = defaultValue;
        ...
        public void Test_IfDataLabelsBorderColorRenders_Correct(string value)
        {
            ...
            ((ArearangeSeries)chart.Series[0]).DataLabels.BorderColor = value;
        ...
        public void Test_IfDataLabelsBorderColorDoesntRenderForDefault_Correct()
        {
            ...
            ((ArearangeSeries)chart.Series[0]).DataLabels.BorderColor = defaultValue;
        ...
        public void Test_IfDataLabelsBorderRadiusRenders_Correct(double value)
        {
            ...
            ((ArearangeSeries)chart.Series[0]).DataLabels.BorderRadius = value;
        ...
        public void Test_IfDataLabelsBorderRadiusDoesntRenderForDefault_Correct()
        {
            ...
            ((ArearangeSeries)chart.Series[0]).DataLabels.BorderRadius = defaultValue;
        ...
        public void Test_IfDataLabelsBorderWidthRenders_Correct(double value)
        {
            ...
            ((ArearangeSeries)chart.Series[0]).DataLabels.BorderWidth = value;
        ...
        public void Test_IfDataLabelsBorderWidthDoesntRenderForDefault_Correct()
        {
            ...
            ((ArearangeSeries)chart.Series[0]).DataLabels.BorderWidth = defaultValue;
        ...
        public void Test_IfDataLabelsClassNameRenders_Correct(string value)
        {
            ...
            ((ArearangeSeries)chart.Series[0]).DataLabels.ClassName = value;
        ...
        public void Test_IfDataLabelsClassNameDoesntRenderForDefault_Correct()
        {
            ...
            ((ArearangeSeries)chart.Series[0]).DataLabels.ClassName = defaultValue;
        ...
        public void Test_IfDataLabelsColorRenders_Correct(string value)
        {
            ...
            ((ArearangeSeries)chart.Series[0]).DataLabels.Color = value;
        ...
        public void Test_IfDataLabelsColorDoesntRenderForDefault_Correct()
        {
            ...
            ((ArearangeSeries)chart.Series[0]).DataLabels.Color = defaultValue;
        ...
        public void Test_IfDataLabelsCropRenders_Correct()
        {
            ...
            ((ArearangeSeries)chart.Series[0]).DataLabels.Crop = value;
        ...
        public void Test_IfDataLabelsCropDoesntRenderForDefault_Correct()
        {
            ...
            ((ArearangeSeries)chart.Series[0]).DataLabels.Crop = defaultValue;
        ...
        public void Test_IfDataLabelsEnabledBoolRenders_Correct()
        {
            ...
            ((ArearangeSeries)chart.Series[0]).DataLabels.Enabled = value;
        ...
        public void Test_IfDataLabelsEnabledBoolDoesntRenderForDefault_Correct()
        {
            ...
            ((ArearangeSeries)chart.Series[0]).DataLabels.Enabled = defaultValue;
        ...
        public void Test_IfDataLabelsFilterOperatorRenders_Correct(string value)
        {
            ...
            ((ArearangeSeries)chart.Series[0]).DataLabels.Filter.Operator = value;
        ...
        public void Test_IfDataLabelsFilterOperatorDoesntRenderForDefault_Correct()
        {
            ...
            ((ArearangeSeries)chart.Series[0]).DataLabels.Filter.Operator = defaultValue;
        ...
        public void Test_IfDataLabelsFilterPropertyRenders_Correct(string value)
        {
            ...
            ((ArearangeSeries)chart.Series[0]).DataLabels.Filter.Property = value;
        ...
        public void Test_IfDataLabelsFilterPropertyDoesntRenderForDefault_Correct()
        {
            ...
            ((ArearangeSeries)chart.Series[0]).DataLabels.Filter.Property = defaultValue;
        ...
        public void Test_IfDataLabelsFilterValueRenders_Correct(double value)
        {
            ...
            ((ArearangeSeries)chart.Series[0]).DataLabels.Filter.Value = value;
        ...
        public void Test_IfDataLabelsFilterValueDoesntRenderForDefault_Correct()
        {
            ...
            ((ArearangeSeries)chart.Series[0]).DataLabels.Filter.Value = defaultValue;
        ...
        public void Test_IfDataLabelsFormatRenders_Correct(string value)
        {
            ...
            ((ArearangeSeries)chart.Series[0]).DataLabels.Format = value;
        ...
        public void Test_IfDataLabelsFormatDoesntRenderForDefault_Correct()
        {
            ...
            ((ArearangeSeries)chart.Series[0]).DataLabels.Format = defaultValue;
        ...
        public void Test_IfDataLabelsFormatterRenders_Correct(string value)
        {
            ...
            ((ArearangeSeries)chart.Series[0]).DataLabels.Formatter = value;
        ...
        public void Test_IfDataLabelsFormatterDoesntRenderForDefault_Correct()
        {
            ...
            ((ArearangeSeries)chart.Series[0]).DataLabels.Formatter = defaultValue;
        ...
        public void Test_IfDataLabelsInsideRenders_Correct(bool value)
        {
            ...
            ((ArearangeSeries)chart.Series[0]).DataLabels.Inside = value;
        ...
        public void Test_IfDataLabelsInsideDoesntRenderForDefault_Correct()
        {
            ...
            ((ArearangeSeries)chart.Series[0]).DataLabels.Inside = defaultValue;
        ...
        public void Test_IfDataLabelsNullFormatBoolRenders_Correct(bool value)
        {
            ...
            ((ArearangeSeries)chart.Series[0]).DataLabels.NullFormatBool = value;
        ...
        public void Test_IfDataLabelsNullFormatBoolDoesntRenderForDefault_Correct()
        {
            ...
            ((ArearangeSeries)chart.Series[0]).DataLabels.NullFormatBool = defaultValue;
        ...
        public void Test_IfDataLabelsNullFormatRenders_Correct(string value)
        {
            ...
            ((ArearangeSeries)chart.Series[0]).DataLabels.NullFormat = value;
        ...
        public void Test_IfDataLabelsNullFormatDoesntRenderForDefault_Correct()
        {
            ...
            ((ArearangeSeries)chart.Series[0]).DataLabels.NullFormat = defaultValue;
        ...
        public void Test_IfDataLabelsNullFormatterRenders_Correct(string value)
        {
            ...
            ((ArearangeSeries)chart.Series[0]).DataLabels.NullFormatter = value;
        ...
        public void Test_IfDataLabelsNullFormatterDoesntRenderForDefault_Correct()
        {
            ...
            ((ArearangeSeries)chart.Series[0]).DataLabels.NullFormatter = defaultValue;

            Assert.DoesNotContain($"nullFormatter", renderer.RenderHtml());
        }

        [Theory]
        [InlineData(ArearangeSeriesDataLabelsOverflow.Allow)]
        public void Test_IfDataLabelsOverflowRenders_Correct(ArearangeSeriesDataLabelsOverflow align)
        {
            var chart = new Highcharts(); chart.Chart = new Chart();
            var renderer = new HighchartsRenderer(chart); var series = new ArearangeSeries(); chart.Series = new List<Highsoft.Web.Mvc.Charts.Series>(); chart.Series.Add(series);

            ((ArearangeSeries)chart.Series[0]).DataLabels.Overflow = align;
        ...
        public void Test_IfDataLabelsOverflowDoesntRenderForDefault_Correct()
        {
            var chart = new Highcharts(); chart.Chart = new Chart();
            var renderer = new HighchartsRenderer(chart); var series = new ArearangeSeries(); chart.Series = new List<Highsoft.Web.Mvc.Charts.Series>(); chart.Series.Add(series);
            var defaultValue = ArearangeSeriesDataLabelsOverflow.Justify;

            ((ArearangeSeries)chart.Series[0]).DataLabels.Overflow = defaultValue;
        ...
        public void Test_IfDataLabelsPaddingRenders_Correct(double value)
        {
            ...
            ((ArearangeSeries)chart.Series[0]).DataLabels.Padding = value;
        ...
        public void Test_IfDataLabelsPaddingDoesntRenderForDefault_Correct()
        {
            ...
            ((ArearangeSeries)chart.Series[0]).DataLabels.Padding = defaultValue;

            Assert.DoesNotContain($"padding", renderer.RenderHtml());
        }

        [Theory]
        [InlineData(ArearangeSeriesDataLabelsPosition.Left)]
        [InlineData(ArearangeSeriesDataLabelsPosition.Right)]
        public void Test_IfDataLabelsPositionRenders_Correct(ArearangeSeriesDataLabelsPosition align)
        {
            var chart = new Highcharts(); chart.Chart = new Chart();
            var renderer = new HighchartsRenderer(chart); var series = new ArearangeSeries(); chart.Series = new List<Highsoft.Web.Mvc.Charts.Series>(); chart.Series.Add(series);

            ((ArearangeSeries)chart.Series[0]).DataLabels.Position = align;
        ...
        public void Test_IfDataLabelsPositionDoesntRenderForDefault_Correct()
        {
            var chart = new Highcharts(); chart.Chart = new Chart();
            var renderer = new HighchartsRenderer(chart); var series = new ArearangeSeries(); chart.Series = new List<Highsoft.Web.Mvc.Charts.Series>(); chart.Series.Add(series);
            var defaultValue = ArearangeSeriesDataLabelsPosition.Center;

            ((ArearangeSeries)chart.Series[0]).DataLabels.Position = defaultValue;
        ...
        public void Test_IfDataLabelsRotationRenders_Correct(double value)
        {
            ...
            ((ArearangeSeries)chart.Series[0]).DataLabels.Rotation = value;
        ...
        public void Test_IfDataLabelsRotationDoesntRenderForDefault_Correct()
        {
            ...
            ((ArearangeSeries)chart.Series[0]).DataLabels.Rotation = defaultValue;
        ...
        public void Test_IfDataLabelsShadowBoolRenders_Correct()
        {
            ...
            ((ArearangeSeries)chart.Series[0]).DataLabels.ShadowBool = value;
        ...
        public void Test_IfDataLabelsShadowRenders_Correct(string color, int offsetX, int offsetY, double opacity, int width)
        {
            ...
            ((ArearangeSeries)chart.Series[0]).DataLabels.Shadow = new Shadow()
            {
                Color = color,
                OffsetX = offsetX,
                OffsetY = offsetY,
        ...
        public void Test_IfDataLabelsShadowBoolDoesntRenderForDefault_Correct()
        {
            ...
            ((ArearangeSeries)chart.Series[0]).DataLabels.ShadowBool = defaultValue;
        ...
        public void Test_IfDataLabelsShapeRenders_Correct(string value)
        {
            ...
            ((ArearangeSeries)chart.Series[0]).DataLabels.Shape = value;
        ...
        public void Test_IfDataLabelsShapeDoesntRenderForDefault_Correct()
        {
            ...
            ((ArearangeSeries)chart.Series[0]).DataLabels.Shape = defaultValue;
        ...
        public void Test_IfDataLabelsStyleStringRenders_Correct(string param1, string param1_value)
        {
            ...
            ((ArearangeSeries)chart.Series[0]).DataLabels.Style = style;
        ...
        public void Test_IfDataLabelsTextPathEnabledRenders_Correct(bool value)
        {
            ...
            ((ArearangeSeries)chart.Series[0]).DataLabels.TextPath.Enabled = value;
        ...
        public void Test_IfDataLabelsTextPathEnabledDoesntRenderForDefault_Correct()
        {
            ...
            ((ArearangeSeries)chart.Series[0]).DataLabels.TextPath.Enabled = defaultValue;
        ...
        public void Test_IfDataLabelsUseHTMLRenders_Correct()
        {
            ...
            ((ArearangeSeries)chart.Series[0]).DataLabels.UseHTML = value;
        ...
        public void Test_IfDataLabelsUseHTMLDoesntRenderForDefault_Correct()
        {
            ...
            ((ArearangeSeries)chart.Series[0]).DataLabels.UseHTML = defaultValue;

            Assert.DoesNotContain($"useHTML", renderer.RenderHtml());
        }

        [Theory]
        [InlineData(ArearangeSeriesDataLabelsVerticalAlign.Middle)]
        [InlineData(ArearangeSeriesDataLabelsVerticalAlign.Top)]
        public void Test_IfDataLabelsVerticalAlignRenders_Correct(ArearangeSeriesDataLabelsVerticalAlign align)
        {
            var chart = new Highcharts(); chart.Chart = new Chart();
            var renderer = new HighchartsRenderer(chart); var series = new ArearangeSeries(); chart.Series = new List<Highsoft.Web.Mvc.Charts.Series>(); chart.Series.Add(series);

            ((ArearangeSeries)chart.Series[0]).DataLabels.VerticalAlign = align;
        ...
        public void Test_IfDataLabelsVerticalAlignDoesntRenderForDefault_Correct()
        {
            var chart = new Highcharts(); chart.Chart = new Chart();
            var renderer = new HighchartsRenderer(chart); var series = new ArearangeSeries(); chart.Series = new List<Highsoft.Web.Mvc.Charts.Series>(); chart.Series.Add(series);
            var defaultValue = ArearangeSeriesDataLabelsVerticalAlign.Bottom;

            ((ArearangeSeries)chart.Series[0]).DataLabels.VerticalAlign = defaultValue;
        ...
        public void Test_IfDataLabelsXRenders_Correct(double value)
        {
            ...
            ((ArearangeSeries)chart.Series[0]).DataLabels.X = value;
        ...
        public void Test_IfDataLabelsXDoesntRenderForDefault_Correct()
        {
            ...
            ((ArearangeSeries)chart.Series[0]).DataLabels.X = defaultValue;
        ...
        public void Test_IfDataLabelsYRenders_Correct(double value)
        {
            ...
            ((ArearangeSeries)chart.Series[0]).DataLabels.Y = value;
        ...
        public void Test_IfDataLabelsYDoesntRenderForDefault_Correct()
        {
            ...
            ((ArearangeSeries)chart.Series[0]).DataLabels.Y = defaultValue;
        ...
        public void Test_IfDataLabelsZRenders_Correct(double value)
        {
            ...
            ((ArearangeSeries)chart.Series[0]).DataLabels.ZIndex = value;
        ...
        public void Test_IfDataLabelsZDoesntRenderForDefault_Correct()
        {
            ...
            ((ArearangeSeries)chart.Series[0]).DataLabels.ZIndex = defaultValue;
        ...
        public void Test_IfDataSortingEnabledRenders_Correct(bool value)
        {
            ...
            ((ArearangeSeries)chart.Series[0]).DataSorting.Enabled = value;
        ...
        public void Test_IfDataSortingEnabledDoesntRenderForDefault_Correct()
        {
            ...
            ((ArearangeSeries)chart.Series[0]).DataSorting.Enabled = defaultValue;
        ...
        public void Test_IfDataSortingMatchByNameRenders_Correct(bool value)
        {
            ...
            ((ArearangeSeries)chart.Series[0]).DataSorting.MatchByName = value;
        ...
        public void Test_IfDataSortingMatchByNameDoesntRenderForDefault_Correct()
        {
            ...
            ((ArearangeSeries)chart.Series[0]).DataSorting.MatchByName = defaultValue;
        ...
        public void Test_IfDataSortingSortKeyRenders_Correct(string value)
        {
            ...
            ((ArearangeSeries)chart.Series[0]).DataSorting.SortKey = value;
        ...
        public void Test_IfDataSortingSortKeyDoesntRenderForDefault_Correct()
        {
            ...
            ((ArearangeSeries)chart.Series[0]).DataSorting.SortKey = defaultValue;
        ...
        public void Test_IfDescriptionRenders_Correct(string description)
        {
            ...
            ((ArearangeSeries)chart.Series[0]).Description = description;
        ...
        public void Test_IfDragDropDraggableXRenders_Correct(bool value)
        {
            ...
            ((ArearangeSeries)chart.Series[0]).DragDrop.DraggableX = value;
        ...
        public void Test_IfDragDropDraggableXDoesntRenderForDefault_Correct()
        {
            ...
            ((ArearangeSeries)chart.Series[0]).DragDrop.DraggableX = defaultValue;
        ...
        public void Test_IfDragDropDraggableYRenders_Correct(bool value)
        {
            ...
            ((ArearangeSeries)chart.Series[0]).DragDrop.DraggableY = value;
        ...
        public void Test_IfDragDropDraggableYDoesntRenderForDefault_Correct()
        {
            ...
            ((ArearangeSeries)chart.Series[0]).DragDrop.DraggableY = defaultValue;
        ...
        public void Test_IfDragDropDragMaxXRenders_Correct(double value)
        {
            ...
            ((ArearangeSeries)chart.Series[0]).DragDrop.DragMaxX = value;
        ...
        public void Test_IfDragDropDragMaxXDoesntRenderForDefault_Correct()
        {
            ...
            ((ArearangeSeries)chart.Series[0]).DragDrop.DragMaxX = defaultValue;
        ...
        public void Test_IfDragDropDragMaxYRenders_Correct(double value)
        {
            ...
            ((ArearangeSeries)chart.Series[0]).DragDrop.DragMaxY = value;
        ...
        public void Test_IfDragDropDragMaxYDoesntRenderForDefault_Correct()
        {
            ...
            ((ArearangeSeries)chart.Series[0]).DragDrop.DragMaxY = defaultValue;
        ...
        public void Test_IfDragDropDragMinXRenders_Correct(double value)
        {
            ...
            ((ArearangeSeries)chart.Series[0]).DragDrop.DragMinX = value;
        ...
        public void Test_IfDragDropDragMinXDoesntRenderForDefault_Correct()
        {
            ...
            ((ArearangeSeries)chart.Series[0]).DragDrop.DragMinX = defaultValue;
        ...
        public void Test_IfDragDropDragMinYRenders_Correct(double value)
        {
            ...
            ((ArearangeSeries)chart.Series[0]).DragDrop.DragMinY = value;
        ...
        public void Test_IfDragDropDragMinYDoesntRenderForDefault_Correct()
        {
            ...
            ((ArearangeSeries)chart.Series[0]).DragDrop.DragMinY = defaultValue;
        ...
        public void Test_IfDragDropDragPrecisionXRenders_Correct(double value)
        {
            ...
            ((ArearangeSeries)chart.Series[0]).DragDrop.DragPrecisionX = value;
        ...
        public void Test_IfDragDropDragPrecisionXDoesntRenderForDefault_Correct()
        {
            ...
            ((ArearangeSeries)chart.Series[0]).DragDrop.DragPrecisionX = defaultValue;
        ...
        public void Test_IfDragDropDragPrecisionYRenders_Correct(double value)
        {
            ...
            ((ArearangeSeries)chart.Series[0]).DragDrop.DragPrecisionY = value;
        ...
        public void Test_IfDragDropDragPrecisionYDoesntRenderForDefault_Correct()
        {
            ...
            ((ArearangeSeries)chart.Series[0]).DragDrop.DragPrecisionY = defaultValue;
        ...
        public void Test_IfDragDropDragSensitivityRenders_Correct(double value)
        {
            ...
            ((ArearangeSeries)chart.Series[0]).DragDrop.DragSensitivity = value;
        ...
        public void Test_IfDragDropDragSensitivityDoesntRenderForDefault_Correct()
        {
            ...
            ((ArearangeSeries)chart.Series[0]).DragDrop.DragSensitivity = defaultValue;
        ...
        public void Test_IfDragDropGroupByRenders_Correct(string value)
        {
            ...
            ((ArearangeSeries)chart.Series[0]).DragDrop.GroupBy = value;
        ...
        public void Test_IfDragDropGroupByDoesntRenderForDefault_Correct()
        {
            ...
            ((ArearangeSeries)chart.Series[0]).DragDrop.GroupBy = defaultValue;
        ...
        public void Test_IfDragDropGuideBoxDefaultClassNameRenders_Correct(string value)
        {
            ...
            ((ArearangeSeries)chart.Series[0]).DragDrop.GuideBox.Default.ClassName = value;
        ...
        public void Test_IfDragDropGuideBoxDefaultDoesntRenderForDefault_Correct()
        {
            ...
            ((ArearangeSeries)chart.Series[0]).DragDrop.GuideBox.Default.ClassName = defaultValue;
        ...
        public void Test_IfDragDropGuideBoxDefaultColorRenders_Correct(string value)
        {
            ...
            ((ArearangeSeries)chart.Series[0]).DragDrop.GuideBox.Default.Color = value;
        ...
        public void Test_IfDragDropGuideBoxDefaultColorDoesntRenderForDefault_Correct()
        {
            ...
            ((ArearangeSeries)chart.Series[0]).DragDrop.GuideBox.Default.Color = defaultValue;
        ...
        public void Test_IfDragDropGuideBoxDefaultCursorRenders_Correct(string value)
        {
            ...
            ((ArearangeSeries)chart.Series[0]).DragDrop.GuideBox.Default.Cursor = value;
        ...
        public void Test_IfDragDropGuideBoxDefaultCursorDoesntRenderForDefault_Correct()
        {
            ...
            ((ArearangeSeries)chart.Series[0]).DragDrop.GuideBox.Default.Cursor = defaultValue;
        ...
        public void Test_IfDragDropGuideBoxDefaultLineColorRenders_Correct(string value)
        {
            ...
            ((ArearangeSeries)chart.Series[0]).DragDrop.GuideBox.Default.LineColor = value;
        ...
        public void Test_IfDragDropGuideBoxDefaultLineColorDoesntRenderForDefault_Correct()
        {
            ...
            ((ArearangeSeries)chart.Series[0]).DragDrop.GuideBox.Default.LineColor = defaultValue;
        ...
        public void Test_IfDragDropGuideBoxDefaultLineWidthRenders_Correct(double value)
        {
            ...
            ((ArearangeSeries)chart.Series[0]).DragDrop.GuideBox.Default.LineWidth = value;
        ...
        public void Test_IfDragDropGuideBoxDefaultLineWidthDoesntRenderForDefault_Correct()
        {
            ...
            ((ArearangeSeries)chart.Series[0]).DragDrop.GuideBox.Default.LineWidth = defaultValue;
        ...
        public void Test_IfDragDropGuideBoxDefaultZIndexRenders_Correct(double value)
        {
            ...
            ((ArearangeSeries)chart.Series[0]).DragDrop.GuideBox.Default.ZIndex = value;
        ...
        public void Test_IfDragDropGuideBoxDefaultZIndexDoesntRenderForDefault_Correct()
        {
            ...
            ((ArearangeSeries)chart.Series[0]).DragDrop.GuideBox.Default.ZIndex = defaultValue;
        ...
        public void Test_IfDragDropLiveRedrawRenders_Correct()
        {
            ...
            ((ArearangeSeries)chart.Series[0]).DragDrop.LiveRedraw = value;
        ...
        public void Test_IfDragDropLiveRedrawDoesntRenderForDefault_Correct()
        {
            ...
            ((ArearangeSeries)chart.Series[0]).DragDrop.LiveRedraw = defaultValue;
        ...
        public void Test_IfEnableMouseTrackingRenders_Correct()
        {
            ...
            ((ArearangeSeries)chart.Series[0]).EnableMouseTracking = value;
        ...
        public void Test_IfEventsAfterAnimateRenders_Correct(string value)
        {
            ...
            ((ArearangeSeries)chart.Series[0]).Events.AfterAnimate = value;
        ...
        public void Test_IfEventsAfterAnimateDoesntRenderForDefault_Correct()
        {
            ...
            ((ArearangeSeries)chart.Series[0]).Events.AfterAnimate = defaultValue;
        ...
        public void Test_IfEventsCheckboxClickRenders_Correct(string value)
        {
            ...
            ((ArearangeSeries)chart.Series[0]).Events.CheckboxClick = value;
        ...
        public void Test_IfEventsCheckboxClickDoesntRenderForDefault_Correct()
        {
            ...
            ((ArearangeSeries)chart.Series[0]).Events.CheckboxClick = defaultValue;
        ...
        public void Test_IfEventsClickRenders_Correct(string value)
        {
            ...
            ((ArearangeSeries)chart.Series[0]).Events.Click = value;
        ...
        public void Test_IfEventsclickDoesntRenderForDefault_Correct()
        {
            ...
            ((ArearangeSeries)chart.Series[0]).Events.Click = defaultValue;
        ...
        public void Test_IfEventsHideRenders_Correct(string value)
        {
            ...
            ((ArearangeSeries)chart.Series[0]).Events.Hide = value;
        ...
        public void Test_IfEventsHideDoesntRenderForDefault_Correct()
        {
            ...
            ((ArearangeSeries)chart.Series[0]).Events.Hide = defaultValue;
        ...
        public void Test_IfEventsLegendItemClickRenders_Correct(string value)
        {
            ...
            ((ArearangeSeries)chart.Series[0]).Events.LegendItemClick = value;
        ...
        public void Test_IfEventsLegendItemClickDoesntRenderForDefault_Correct()
        {
            ...
            ((ArearangeSeries)chart.Series[0]).Events.LegendItemClick = defaultValue;
        ...
        public void Test_IfEventsMouseOutRenders_Correct(string value)
        {
            ...
            ((ArearangeSeries)chart.Series[0]).Events.MouseOut = value;
        ...
        public void Test_IfEventsMouseOutDoesntRenderForDefault_Correct()
        {
            ...
            ((ArearangeSeries)chart.Series[0]).Events.MouseOut = defaultValue;
        ...
        public void Test_IfEventsMouseOverRenders_Correct(string value)
        {
            ...
            ((ArearangeSeries)chart.Series[0]).Events.MouseOver = value;
        ...
        public void Test_IfEventsMouseOverDoesntRenderForDefault_Correct()
        {
            ...
            ((ArearangeSeries)chart.Series[0]).Events.MouseOver = defaultValue;
        ...
        public void Test_IfEventsShowRenders_Correct(string value)
        {
            ...
            ((ArearangeSeries)chart.Series[0]).Events.Show = value;
        ...
        public void Test_IfEventsShowDoesntRenderForDefault_Correct()
        {
            ...
            ((ArearangeSeries)chart.Series[0]).Events.Show = defaultValue;
        ...
        public void Test_IfFindNearestPointByRenders_Correct()
        {
            var chart = new Highcharts(); chart.Chart = new Chart();
            var renderer = new HighchartsRenderer(chart); var series = new ArearangeSeries(); chart.Series = new List<Highsoft.Web.Mvc.Charts.Series>(); chart.Series.Add(series);
            var value = ArearangeSeriesFindNearestPointBy.Xy;

            ((ArearangeSeries)chart.Series[0]).FindNearestPointBy = value;
        ...
        public void Test_IfFindNearestPointByDoesntRenderForDefault_Correct()
        {
            var chart = new Highcharts(); chart.Chart = new Chart();
            var renderer = new HighchartsRenderer(chart); var series = new ArearangeSeries(); chart.Series = new List<Highsoft.Web.Mvc.Charts.Series>(); chart.Series.Add(series);
            var value = ArearangeSeriesFindNearestPointBy.X;
        ...
        public void Test_IfGetExtremesFromAllRenders_Correct()
        {
            ...
            ((ArearangeSeries)chart.Series[0]).GetExtremesFromAll = value;
        ...
        public void Test_IfIncludeInDataExportFromAllRenders_Correct(bool value)
        {
            ...
            ((ArearangeSeries)chart.Series[0]).IncludeInDataExport = value;
        ...
        public void Test_IfKeysRenders_Correct(string arg1, string arg2, string arg3, string arg4)
        {
            ...
            ((ArearangeSeries)chart.Series[0]).Keys = value;
        ...
        public void Test_IfLabelConnectorAllowedRenders_Correct()
        {
            ...
            ((ArearangeSeries)chart.Series[0]).Label.ConnectorAllowed = value;
        ...
        public void Test_IfLabelConnectorAllowedDoesntRenderForDefault_Correct()
        {
            ...
            ((ArearangeSeries)chart.Series[0]).Label.ConnectorAllowed = defaultValue;
        ...
        public void Test_IfLabelConnectorNeighbourDistanceRenders_Correct(double value)
        {
            ...
            ((ArearangeSeries)chart.Series[0]).Label.ConnectorNeighbourDistance = value;
        ...
        public void Test_IfLabelConnectorNeighbourDistanceDoesntRenderForDefault_Correct()
        {
            ...
            ((ArearangeSeries)chart.Series[0]).Label.ConnectorNeighbourDistance = defaultValue;
        ...
        public void Test_IfLabelEnabledRenders_Correct()
        {
            ...
            ((ArearangeSeries)chart.Series[0]).Label.Enabled = value;
        ...
        public void Test_IfLabelEnabledDoesntRenderForDefault_Correct()
        {
            ...
            ((ArearangeSeries)chart.Series[0]).Label.Enabled = defaultValue;
        ...
        public void Test_IfLabelFormatRenders_Correct(string value)
        {
            ...
            ((ArearangeSeries)chart.Series[0]).Label.Format = value;
        ...
        //    ((ArearangeSeries)chart.Series[0]).Label.Format = defaultValue;
        ...
        public void Test_IfLabelFormatterRenders_Correct(string value)
        {
            ...
            ((ArearangeSeries)chart.Series[0]).Label.Formatter = value;
        ...
        public void Test_IfLabelFormatterDoesntRenderForDefault_Correct()
        {
            ...
            ((ArearangeSeries)chart.Series[0]).Label.Formatter = defaultValue;
        ...
        public void Test_IfLabelMaxFontSizeRenders_Correct(double value)
        {
            ...
            ((ArearangeSeries)chart.Series[0]).Label.MaxFontSize = value;
        ...
        public void Test_IfLabelMaxFontSizeDoesntRenderForDefault_Correct()
        {
            ...
            ((ArearangeSeries)chart.Series[0]).Label.MaxFontSize = defaultValue;
        ...
        public void Test_IfLabelMinFontSizeRenders_Correct(double value)
        {
            ...
            ((ArearangeSeries)chart.Series[0]).Label.MinFontSize = value;
        ...
        public void Test_IfLabelMinFontSizeDoesntRenderForDefault_Correct()
        {
            ...
            ((ArearangeSeries)chart.Series[0]).Label.MinFontSize = defaultValue;
        ...
        public void Test_IfLabelOnAreaRenders_Correct(bool value)
        {
            ...
            ((ArearangeSeries)chart.Series[0]).Label.OnArea = value;
        ...
        public void Test_IfLabelOnAreaDoesntRenderForDefault_Correct()
        {
            ...
            ((ArearangeSeries)chart.Series[0]).Label.OnArea = defaultValue;
        ...
        public void Test_IfLabelStyleRenders_Correct(string paramName, string paramValue)
        {
            ...
            ((ArearangeSeries)chart.Series[0]).Label.Style = value;
        ...
        //    ((ArearangeSeries)chart.Series[0]).Label.Style = defaultValue;
        ...
        //[Theory]
        //[InlineData(ArearangeSeriesLinecap.Square)]
        ////missing ArearangeSeriesLinecap.Butt ?
        //public void Test_IfLinecapRenders_Correct(ArearangeSeriesLinecap value)
        //{
        //    var chart = new Highcharts(); chart.Chart = new Chart();
        //    var renderer = new HighchartsRenderer(chart); var series = new ArearangeSeries(); chart.Series = new List<Highsoft.Web.Mvc.Charts.Series>(); chart.Series.Add(series);

        //    ((ArearangeSeries)chart.Series[0]).Linecap = value;
        ...
        //    var chart = new Highcharts(); chart.Chart = new Chart();
        //    var renderer = new HighchartsRenderer(chart); var series = new ArearangeSeries(); chart.Series = new List<Highsoft.Web.Mvc.Charts.Series>(); chart.Series.Add(series);
        //    var defaultValue = ArearangeSeriesLinecap.Round;

        //    ((ArearangeSeries)chart.Series[0]).Linecap = defaultValue;
        ...
        public void Test_IfLineWidthRenders_Correct(double value)
        {
            ...
            ((ArearangeSeries)chart.Series[0]).LineWidth = value;
        ...
        public void Test_IfLineWidthDoesntRenderForDefault_Correct()
        {
            ...
            ((ArearangeSeries)chart.Series[0]).LineWidth = defaultValue;
        ...
        public void Test_IfLinkedToRenders_Correct(string value)
        {
            ...
            ((ArearangeSeries)chart.Series[0]).LinkedTo = value;
        ...
        public void Test_IfLinkedToDoesntRenderForDefault_Correct()
        {
            ...
            ((ArearangeSeries)chart.Series[0]).LinkedTo = defaultValue;
        ...
        public void Test_IfMarkerEnabledRenders_Correct(bool value)
        {
            ...
            ((ArearangeSeries)chart.Series[0]).Marker.Enabled = value;
        ...
        public void Test_IfMarkerEnabledDoesntRenderForDefault_Correct()
        {
            ...
            ((ArearangeSeries)chart.Series[0]).Marker.Enabled = defaultValue;
        ...
        public void Test_IfMarkerEnabledThresholdRenders_Correct(double value)
        {
            ...
            ((ArearangeSeries)chart.Series[0]).Marker.EnabledThreshold = value;
        ...
        public void Test_IfMarkerEnabledThresholdDoesntRenderForDefault_Correct()
        {
            ...
            ((ArearangeSeries)chart.Series[0]).Marker.EnabledThreshold = defaultValue;
        ...
        public void Test_IfMarkerFillColorRenders_Correct(string value)
        {
            ...
            ((ArearangeSeries)chart.Series[0]).Marker.FillColor = value;
        ...
        //    ((ArearangeSeries)chart.Series[0]).Marker.FillColor = defaultValue;
        ...
        public void Test_IfMarkerHeightRenders_Correct(double value)
        {
            ...
            ((ArearangeSeries)chart.Series[0]).Marker.Height = value;
        ...
        public void Test_IfMarkerHeightDoesntRenderForDefault_Correct()
        {
            ...
            ((ArearangeSeries)chart.Series[0]).Marker.Height = defaultValue;
        ...
        public void Test_IfMarkerLineColorRenders_Correct(string value)
        {
            ...
            ((ArearangeSeries)chart.Series[0]).Marker.LineColor = value;
        ...
        public void Test_IfMarkerLineColorDoesntRenderForDefault_Correct()
        {
            ...
            ((ArearangeSeries)chart.Series[0]).Marker.LineColor = defaultValue;
        ...
        public void Test_IfMarkerLineWidthRenders_Correct(double value)
        {
            ...
            ((ArearangeSeries)chart.Series[0]).Marker.LineWidth = value;
        ...
        public void Test_IfMarkerLineWidthDoesntRenderForDefault_Correct()
        {
            ...
            ((ArearangeSeries)chart.Series[0]).Marker.LineWidth = defaultValue;
        ...
        public void Test_IfMarkerRadiusRenders_Correct(double value)
        {
            ...
            ((ArearangeSeries)chart.Series[0]).Marker.Radius = value;
        ...
        public void Test_IfMarkerRadiusDoesntRenderForDefault_Correct()
        {
            ...
            ((ArearangeSeries)chart.Series[0]).Marker.Radius = defaultValue;
        ...
        public void Test_IfMarkerSymbolRenders_Correct(string value)
        {
            ...
            ((ArearangeSeries)chart.Series[0]).Marker.Symbol = value;
        ...
        public void Test_IfMarkerSymbolDoesntRenderForDefault_Correct()
        {
            ...
            ((ArearangeSeries)chart.Series[0]).Marker.Symbol = defaultValue;
        ...
        public void Test_IfMarkerWidthRenders_Correct(double value)
        {
            ...
            ((ArearangeSeries)chart.Series[0]).Marker.Width = value;
        ...
        public void Test_IfMarkerWidthDoesntRenderForDefault_Correct()
        {
            ...
            ((ArearangeSeries)chart.Series[0]).Marker.Width = defaultValue;
        ...
        public void Test_IfNegativeColorRenders_Correct(string value)
        {
            ...
            ((ArearangeSeries)chart.Series[0]).NegativeColor = value;
        ...
        public void Test_IfNegativeColorDoesntRenderForDefault_Correct()
        {
            ...
            ((ArearangeSeries)chart.Series[0]).NegativeColor = defaultValue;
        ...
        //    ((ArearangeSeries)chart.Series[0]).OnPoint.ConnectorOptions.Dashstyle = value;
        ...
        public void Test_IfOnPointConnectorOptionsStrokeRenders_Correct(string value)
        {
            ...
            ((ArearangeSeries)chart.Series[0]).OnPoint.ConnectorOptions.Stroke = value;
        ...
        public void Test_IfOnPointConnectorOptionsStrokeDoesntRenderForDefault_Correct()
        {
            ...
            ((ArearangeSeries)chart.Series[0]).OnPoint.ConnectorOptions.Stroke = defaultValue;
        ...
        public void Test_IfOnPointConnectorOptionsWidthRenders_Correct(double value)
        {
            ...
            ((ArearangeSeries)chart.Series[0]).OnPoint.ConnectorOptions.Width = value;
        ...
        public void Test_IfOnPointConnectorOptionsWidthDoesntRenderForDefault_Correct()
        {
            ...
            ((ArearangeSeries)chart.Series[0]).OnPoint.ConnectorOptions.Width = defaultValue;
        ...
        public void Test_IfOnPointIdRenders_Correct(string value)
        {
            ...
            ((ArearangeSeries)chart.Series[0]).OnPoint.Id = value;
        ...
        public void Test_IfOnPointIdDoesntRenderForDefault_Correct()
        {
            ...
            ((ArearangeSeries)chart.Series[0]).OnPoint.Id = defaultValue;
        ...
        public void Test_IfOnPointPositionOffsetXRenders_Correct(double value)
        {
            ...
            ((ArearangeSeries)chart.Series[0]).OnPoint.Position.OffsetX = value;
        ...
        public void Test_IfOnPointOffsetXDoesntRenderForDefault_Correct()
        {
            ...
            ((ArearangeSeries)chart.Series[0]).OnPoint.Position.OffsetX = defaultValue;
        ...
        public void Test_IfOnPointPositionOffsetYRenders_Correct(double value)
        {
            ...
            ((ArearangeSeries)chart.Series[0]).OnPoint.Position.OffsetY = value;
        ...
        public void Test_IfOnPointOffsetYDoesntRenderForDefault_Correct()
        {
            ...
            ((ArearangeSeries)chart.Series[0]).OnPoint.Position.OffsetY = defaultValue;
        ...
        public void Test_IfOnPointPositionXRenders_Correct(double value)
        {
            ...
            ((ArearangeSeries)chart.Series[0]).OnPoint.Position.X = value;
        ...
        public void Test_IfOnPointXDoesntRenderForDefault_Correct()
        {
            ...
            ((ArearangeSeries)chart.Series[0]).OnPoint.Position.X = defaultValue;
        ...
        public void Test_IfOnPointPositionYRenders_Correct(double value)
        {
            ...
            ((ArearangeSeries)chart.Series[0]).OnPoint.Position.Y = value;
        ...
        public void Test_IfOnPointYDoesntRenderForDefault_Correct()
        {
            ...
            ((ArearangeSeries)chart.Series[0]).OnPoint.Position.Y = defaultValue;
        ...
        public void Test_IfOpacityRenders_Correct(double value)
        {
            ...
            ((ArearangeSeries)chart.Series[0]).Opacity = value;
        ...
        public void Test_IfOpacityDoesntRenderForDefault_Correct()
        {
            ...
            ((ArearangeSeries)chart.Series[0]).Opacity = defaultValue;
        ...
        public void Test_IfPointEventsClickRenders_Correct(string value)
        {
            ...
            ((ArearangeSeries)chart.Series[0]).Point.Events.Click = value;
        ...
        public void Test_IfPointEventsClickDoesntRenderForDefault_Correct()
        {
            ...
            ((ArearangeSeries)chart.Series[0]).Point.Events.Click = defaultValue;
        ...
        public void Test_IfPointEventsDragRenders_Correct(string value)
        {
            ...
            ((ArearangeSeries)chart.Series[0]).Point.Events.Drag = value;
        ...
        public void Test_IfPointEventsDragDoesntRenderForDefault_Correct()
        {
            ...
            ((ArearangeSeries)chart.Series[0]).Point.Events.Drag = defaultValue;
        ...
        public void Test_IfPointEventsDragStartRenders_Correct(string value)
        {
            ...
            ((ArearangeSeries)chart.Series[0]).Point.Events.DragStart = value;
        ...
        public void Test_IfPointEventsDragStartDoesntRenderForDefault_Correct()
        {
            ...
            ((ArearangeSeries)chart.Series[0]).Point.Events.DragStart = defaultValue;
        ...
        public void Test_IfPointEventsDropRenders_Correct(string value)
        {
            ...
            ((ArearangeSeries)chart.Series[0]).Point.Events.Drop = value;
        ...
        public void Test_IfPointEventsDropDoesntRenderForDefault_Correct()
        {
            ...
            ((ArearangeSeries)chart.Series[0]).Point.Events.Drop = defaultValue;
        ...
        public void Test_IfPointEventsMouseOutRenders_Correct(string value)
        {
            ...
            ((ArearangeSeries)chart.Series[0]).Point.Events.MouseOut = value;
        ...
        public void Test_IfPointEventsMouseOutDoesntRenderForDefault_Correct()
        {
            ...
            ((ArearangeSeries)chart.Series[0]).Point.Events.MouseOut = defaultValue;
        ...
        public void Test_IfPointEventsMouseOverRenders_Correct(string value)
        {
            ...
            ((ArearangeSeries)chart.Series[0]).Point.Events.MouseOver = value;
        ...
        public void Test_IfPointEventsMouseOverDoesntRenderForDefault_Correct()
        {
            ...
            ((ArearangeSeries)chart.Series[0]).Point.Events.MouseOver = defaultValue;
        ...
        public void Test_IfPointEventsRemoveRenders_Correct(string value)
        {
            ...
            ((ArearangeSeries)chart.Series[0]).Point.Events.Remove = value;
        ...
        public void Test_IfPointEventsRemoveDoesntRenderForDefault_Correct()
        {
            ...
            ((ArearangeSeries)chart.Series[0]).Point.Events.Remove = defaultValue;
        ...
        public void Test_IfPointEventsSelectRenders_Correct(string value)
        {
            ...
            ((ArearangeSeries)chart.Series[0]).Point.Events.Select = value;
        ...
        public void Test_IfPointEventsSelectDoesntRenderForDefault_Correct()
        {
            ...
            ((ArearangeSeries)chart.Series[0]).Point.Events.Select = defaultValue;
        ...
        public void Test_IfPointEventsUnselectRenders_Correct(string value)
        {
            ...
            ((ArearangeSeries)chart.Series[0]).Point.Events.Unselect = value;
        ...
        public void Test_IfPointEventsUnselectDoesntRenderForDefault_Correct()
        {
            ...
            ((ArearangeSeries)chart.Series[0]).Point.Events.Unselect = defaultValue;
        ...
        public void Test_IfPointEventsUpdateRenders_Correct(string value)
        {
            ...
            ((ArearangeSeries)chart.Series[0]).Point.Events.Update = value;
        ...
        public void Test_IfPointEventsUpdateDoesntRenderForDefault_Correct()
        {
            ...
            ((ArearangeSeries)chart.Series[0]).Point.Events.Update = defaultValue;
        ...
        public void Test_IfPointDescriptionFormatterRenders_Correct(string value)
        {
            ...
            ((ArearangeSeries)chart.Series[0]).PointDescriptionFormatter = value;
        ...
        public void Test_IfPointDescriptionFormatterDoesntRenderForDefault_Correct()
        {
            ...
            ((ArearangeSeries)chart.Series[0]).PointDescriptionFormatter = defaultValue;
        ...
        public void Test_IfPointIntervalRenders_Correct(double value)
        {
            ...
            ((ArearangeSeries)chart.Series[0]).PointInterval = value;
        ...
        public void Test_IfPointIntervalDoesntRenderForDefault_Correct()
        {
            ...
            ((ArearangeSeries)chart.Series[0]).PointInterval = defaultValue;

            Assert.DoesNotContain($"pointInterval", renderer.RenderHtml());
        }

        [Theory]
        [InlineData(ArearangeSeriesPointIntervalUnit.Day)]
        [InlineData(ArearangeSeriesPointIntervalUnit.Month)]
        [InlineData(ArearangeSeriesPointIntervalUnit.Year)]
        public void Test_IfPointIntervalUnitRenders_Correct(ArearangeSeriesPointIntervalUnit value)
        {
            var chart = new Highcharts(); chart.Chart = new Chart();
            var renderer = new HighchartsRenderer(chart); var series = new ArearangeSeries(); chart.Series = new List<Highsoft.Web.Mvc.Charts.Series>(); chart.Series.Add(series);

            ((ArearangeSeries)chart.Series[0]).PointIntervalUnit = value;
        ...
        public void Test_IfPointIntervalUnitDoesntRenderForDefault_Correct()
        {
            var chart = new Highcharts(); chart.Chart = new Chart();
            var renderer = new HighchartsRenderer(chart); var series = new ArearangeSeries(); chart.Series = new List<Highsoft.Web.Mvc.Charts.Series>(); chart.Series.Add(series);
            var defaultValue = ArearangeSeriesPointIntervalUnit.Null;

            ((ArearangeSeries)chart.Series[0]).PointIntervalUnit = defaultValue;
        ...
        //    ((ArearangeSeries)chart.Series[0]).PointPlacement = new PointPlacement() { PointPlacementEnum = value };
        ...
        //    ((ArearangeSeries)chart.Series[0]).PointPlacement = new PointPlacement() { Value = value };
        ...
        //    ((ArearangeSeries)chart.Series[0]).PointPlacement = new PointPlacement() { PointPlacementEnum = defaultValue };
        ...
        public void Test_IfPointStartRenders_Correct(double value)
        {
            ...
            ((ArearangeSeries)chart.Series[0]).PointStart = value;
        ...
        public void Test_IfPointStartDoesntRenderForDefault_Correct()
        {
            ...
            ((ArearangeSeries)chart.Series[0]).PointStart = defaultValue;
        ...
        public void Test_IfRelativeXValueRenders_Correct()
        {
            ...
            ((ArearangeSeries)chart.Series[0]).RelativeXValue = value;
        ...
        public void Test_IfRelativeXValueDoesntRenderForDefault_Correct()
        {
            ...
            ((ArearangeSeries)chart.Series[0]).RelativeXValue = defaultValue;
        ...
        public void Test_IfSelectedRenders_Correct()
        {
            ...
            ((ArearangeSeries)chart.Series[0]).Selected = value;
        ...
        public void Test_IfSelectedDoesntRenderForDefault_Correct()
        {
            ...
            ((ArearangeSeries)chart.Series[0]).Selected = defaultValue;
        ...
        public void Test_IfShadowBoolRenders_Correct()
        {
            ...
            ((ArearangeSeries)chart.Series[0]).ShadowBool = value;
        ...
        public void Test_IfShadowRenders_Correct(string color, int offsetX, int offsetY, double opacity, int width)
        {
            ...
            ((ArearangeSeries)chart.Series[0]).Shadow = new Shadow()
            {
                Color = color,
                OffsetX = offsetX,
                OffsetY = offsetY,
        ...
        public void Test_IfShadowBoolDoesntRenderForDefault_Correct()
        {
            ...
            ((ArearangeSeries)chart.Series[0]).ShadowBool = defaultValue;
        ...
        public void Test_IfShowCheckboxRenders_Correct()
        {
            ...
            ((ArearangeSeries)chart.Series[0]).ShowCheckbox = value;
        ...
        public void Test_IfShowCheckboxDoesntRenderForDefault_Correct()
        {
            ...
            ((ArearangeSeries)chart.Series[0]).ShowCheckbox = defaultValue;
        ...
        public void Test_IfShowInLegendRenders_Correct(bool value)
        {
            ...
            ((ArearangeSeries)chart.Series[0]).ShowInLegend = value;
        ...
        public void Test_IfShowInLegendDoesntRenderForDefault_Correct()
        {
            ...
            ((ArearangeSeries)chart.Series[0]).ShowInLegend = null;
        ...
        public void Test_IfSkipKeyboardNavigationRenders_Correct(bool value)
        {
            ...
            ((ArearangeSeries)chart.Series[0]).SkipKeyboardNavigation = value;
        ...
        public void Test_IfSkipKeyboardNavigationDoesntRenderForDefault_Correct()
        {
            ...
            ((ArearangeSeries)chart.Series[0]).SkipKeyboardNavigation = null;
        ...
        public void Test_IfSoftThresholdRenders_Correct()
        {
            ...
            ((ArearangeSeries)chart.Series[0]).SoftThreshold = value;
        ...
        public void Test_IfSoftThresholdDoesntRenderForDefault_Correct()
        {
            ...
            ((ArearangeSeries)chart.Series[0]).SoftThreshold = defaultValue;
        ...
        public void Test_IfStatesHoverAnimationDurationRenders_Correct(int value)
        {
            ...
            ((ArearangeSeries)chart.Series[0]).States.Hover.Animation.Duration = value;
        ...
        public void Test_IfStatesHoverAnimationDurationDoesntRenderForDefault_Correct()
        {
            ...
            ((ArearangeSeries)chart.Series[0]).States.Hover.Animation.Duration = defaultValue;
        ...
        public void Test_IfStatesHoverEnabledRenders_Correct()
        {
            ...
            ((ArearangeSeries)chart.Series[0]).States.Hover.Enabled = false;
        ...
        //    ((ArearangeSeries)chart.Series[0]).States.Hover.Enabled = defaultValue;
        ...
        //    ((ArearangeSeries)chart.Series[0]).States.Hover.Halo.Attributes = value;
        ...
        public void Test_IfStatesHoverHaloOpacityRenders_Correct(double value)
        {
            ...
            ((ArearangeSeries)chart.Series[0]).States.Hover.Halo.Opacity = value;
        ...
        //    ((ArearangeSeries)chart.Series[0]).States.Hover.Halo.Opacity = defaultValue;
        ...
        //    ((ArearangeSeries)chart.Series[0]).States.Hover.Halo.Size = value;
        ...
        public void Test_IfStatesHoverLineWidthRenders_Correct(double value)
        {
            ...
            ((ArearangeSeries)chart.Series[0]).States.Hover.LineWidth = value;
        ...
        public void Test_IfStatesHoverLineWidthDoesntRenderForDefault_Correct()
        {
            ...
            ((ArearangeSeries)chart.Series[0]).States.Hover.LineWidth = defaultValue;
        ...
        public void Test_IfStatesHoverLineWidthPlusRenders_Correct(double value)
        {
            ...
            ((ArearangeSeries)chart.Series[0]).States.Hover.LineWidthPlus = value;
        ...
        //    ((ArearangeSeries)chart.Series[0]).States.Hover.LineWidthPlus = defaultValue;
        ...
        public void Test_IfStatesHoverMarkerEnabledRenders_Correct(bool value)
        {
            ...
            ((ArearangeSeries)chart.Series[0]).States.Hover.Marker.Enabled = value;
        ...
        public void Test_IfStatesHoverMarkerEnabledDoesntRenderForDefault_Correct()
        {
            ...
            ((ArearangeSeries)chart.Series[0]).States.Hover.Marker.Enabled = defaultValue;
        ...
        public void Test_IfStatesHoverMarkerEnabledThresholdRenders_Correct(double value)
        {
            ...
            ((ArearangeSeries)chart.Series[0]).States.Hover.Marker.EnabledThreshold = value;
        ...
        public void Test_IfStatesHoverMarkerEnabledThresholdDoesntRenderForDefault_Correct()
        {
            ...
            ((ArearangeSeries)chart.Series[0]).States.Hover.Marker.EnabledThreshold = defaultValue;
        ...
        public void Test_IfStatesHoverMarkerFillColorRenders_Correct(string value)
        {
            ...
            ((ArearangeSeries)chart.Series[0]).States.Hover.Marker.FillColor = value;
        ...
        //    ((ArearangeSeries)chart.Series[0]).States.Hover.Marker.FillColor = defaultValue;
        ...
        public void Test_IfStatesHoverMarkerHeightRenders_Correct(double value)
        {
            ...
            ((ArearangeSeries)chart.Series[0]).States.Hover.Marker.Height = value;
        ...
        public void Test_IfStatesHoverMarkerHeightDoesntRenderForDefault_Correct()
        {
            ...
            ((ArearangeSeries)chart.Series[0]).States.Hover.Marker.Height = defaultValue;
        ...
        public void Test_IfStatesHoverMarkerLineColorRenders_Correct(string value)
        {
            ...
            ((ArearangeSeries)chart.Series[0]).States.Hover.Marker.LineColor = value;
        ...
        public void Test_IfStatesHoverMarkerLineColorDoesntRenderForDefault_Correct()
        {
            ...
            ((ArearangeSeries)chart.Series[0]).States.Hover.Marker.LineColor = defaultValue;
        ...
        public void Test_IfStatesHoverMarkerLineWidthRenders_Correct(double value)
        {
            ...
            ((ArearangeSeries)chart.Series[0]).States.Hover.Marker.LineWidth = value;
        ...
        public void Test_IfStatesHoverMarkerLineWidthDoesntRenderForDefault_Correct()
        {
            ...
            ((ArearangeSeries)chart.Series[0]).States.Hover.Marker.LineWidth = defaultValue;
        ...
        public void Test_IfStatesHoverMarkerRadiusRenders_Correct(double value)
        {
            ...
            ((ArearangeSeries)chart.Series[0]).States.Hover.Marker.Radius = value;
        ...
        public void Test_IfStatesHoverMarkerRadiusDoesntRenderForDefault_Correct()
        {
            ...
            ((ArearangeSeries)chart.Series[0]).States.Hover.Marker.Radius = defaultValue;
        ...
        public void Test_IfStatesHoverMarkerWidthRenders_Correct(double value)
        {
            ...
            ((ArearangeSeries)chart.Series[0]).States.Hover.Marker.Width = value;
        ...
        public void Test_IfStatesHoverMarkerWidthDoesntRenderForDefault_Correct()
        {
            ...
            ((ArearangeSeries)chart.Series[0]).States.Hover.Marker.Width = defaultValue;
        ...
        public void Test_IfStatesInactiveAnimationDurationRenders_Correct(int value)
        {
            ...
            ((ArearangeSeries)chart.Series[0]).States.Inactive.Animation.Duration = value;
        ...
        public void Test_IfStatesInactiveAnimationDurationDoesntRenderForDefault_Correct()
        {
            ...
            ((ArearangeSeries)chart.Series[0]).States.Inactive.Animation.Duration = defaultValue;
        ...
        public void Test_IfStatesInactiveEnabledRenders_Correct()
        {
            ...
            ((ArearangeSeries)chart.Series[0]).States.Inactive.Enabled = false;
        ...
        //    ((ArearangeSeries)chart.Series[0]).States.Inactive.Enabled = defaultValue;
        ...
        public void Test_IfStatesInactiveOpacityRenders_Correct(double value)
        {
            ...
            ((ArearangeSeries)chart.Series[0]).States.Inactive.Opacity = value;
        ...
        //    ((ArearangeSeries)chart.Series[0]).States.Inactive.Opacity = defaultValue;
        ...
        public void Test_IfStatesNormalAnimationDurationRenders_Correct(int value)
        {
            ...
            ((ArearangeSeries)chart.Series[0]).States.Normal.Animation.Duration = value;
        ...
        public void Test_IfStatesNormalAnimationDurationDoesntRenderForDefault_Correct()
        {
            ...
            ((ArearangeSeries)chart.Series[0]).States.Normal.Animation.Duration = defaultValue;
        ...
        public void Test_IfStatesSelectAnimationDurationRenders_Correct(int value)
        {
            ...
            ((ArearangeSeries)chart.Series[0]).States.Select.Animation.Duration = value;
        ...
        public void Test_IfStatesSelectAnimationDurationDoesntRenderForDefault_Correct()
        {
            ...
            ((ArearangeSeries)chart.Series[0]).States.Select.Animation.Duration = defaultValue;
        ...
        public void Test_IfStatesSelectEnabledRenders_Correct()
        {
            ...
            ((ArearangeSeries)chart.Series[0]).States.Select.Enabled = false;
        ...
        //    ((ArearangeSeries)chart.Series[0]).States.Select.Enabled = defaultValue;
        ...
        //    ((ArearangeSeries)chart.Series[0]).States.Select.Halo.Attributes = value;
        ...
        public void Test_IfStatesSelectHaloOpacityRenders_Correct(double value)
        {
            ...
            ((ArearangeSeries)chart.Series[0]).States.Select.Halo.Opacity = value;
        ...
        //    ((ArearangeSeries)chart.Series[0]).States.Select.Halo.Opacity = defaultValue;
        ...
        //    ((ArearangeSeries)chart.Series[0]).States.Select.Halo.Size = value;
        ...
        public void Test_IfStatesSelectLineWidthRenders_Correct(double value)
        {
            ...
            ((ArearangeSeries)chart.Series[0]).States.Select.LineWidth = value;
        ...
        public void Test_IfStatesSelectLineWidthDoesntRenderForDefault_Correct()
        {
            ...
            ((ArearangeSeries)chart.Series[0]).States.Select.LineWidth = defaultValue;
        ...
        public void Test_IfStatesSelectLineWidthPlusRenders_Correct(double value)
        {
            ...
            ((ArearangeSeries)chart.Series[0]).States.Select.LineWidthPlus = value;
        ...
        //    ((ArearangeSeries)chart.Series[0]).States.Select.LineWidthPlus = defaultValue;
        ...
        public void Test_IfStatesSelectMarkerEnabledRenders_Correct(bool value)
        {
            ...
            ((ArearangeSeries)chart.Series[0]).States.Select.Marker.Enabled = value;
        ...
        public void Test_IfStatesSelectMarkerEnabledDoesntRenderForDefault_Correct()
        {
            ...
            ((ArearangeSeries)chart.Series[0]).States.Select.Marker.Enabled = defaultValue;
        ...
        public void Test_IfStatesSelectMarkerEnabledThresholdRenders_Correct(double value)
        {
            ...
            ((ArearangeSeries)chart.Series[0]).States.Select.Marker.EnabledThreshold = value;
        ...
        public void Test_IfStatesSelectMarkerEnabledThresholdDoesntRenderForDefault_Correct()
        {
            ...
            ((ArearangeSeries)chart.Series[0]).States.Select.Marker.EnabledThreshold = defaultValue;
        ...
        public void Test_IfStatesSelectMarkerFillColorRenders_Correct(string value)
        {
            ...
            ((ArearangeSeries)chart.Series[0]).States.Select.Marker.FillColor = value;
        ...
        //    ((ArearangeSeries)chart.Series[0]).States.Select.Marker.FillColor = defaultValue;
        ...
        public void Test_IfStatesSelectMarkerHeightRenders_Correct(double value)
        {
            ...
            ((ArearangeSeries)chart.Series[0]).States.Select.Marker.Height = value;
        ...
        public void Test_IfStatesSelectMarkerHeightDoesntRenderForDefault_Correct()
        {
            ...
            ((ArearangeSeries)chart.Series[0]).States.Select.Marker.Height = defaultValue;
        ...
        public void Test_IfStatesSelectMarkerLineColorRenders_Correct(string value)
        {
            ...
            ((ArearangeSeries)chart.Series[0]).States.Select.Marker.LineColor = value;
        ...
        public void Test_IfStatesSelectMarkerLineColorDoesntRenderForDefault_Correct()
        {
            ...
            ((ArearangeSeries)chart.Series[0]).States.Select.Marker.LineColor = defaultValue;
        ...
        public void Test_IfStatesSelectMarkerLineWidthRenders_Correct(double value)
        {
            ...
            ((ArearangeSeries)chart.Series[0]).States.Select.Marker.LineWidth = value;
        ...
        public void Test_IfStatesSelectMarkerLineWidthDoesntRenderForDefault_Correct()
        {
            ...
            ((ArearangeSeries)chart.Series[0]).States.Select.Marker.LineWidth = defaultValue;
        ...
        public void Test_IfStatesSelectMarkerRadiusRenders_Correct(double value)
        {
            ...
            ((ArearangeSeries)chart.Series[0]).States.Select.Marker.Radius = value;
        ...
        public void Test_IfStatesSelectMarkerRadiusDoesntRenderForDefault_Correct()
        {
            ...
            ((ArearangeSeries)chart.Series[0]).States.Select.Marker.Radius = defaultValue;
        ...
        public void Test_IfStatesSelectMarkerWidthRenders_Correct(double value)
        {
            ...
            ((ArearangeSeries)chart.Series[0]).States.Select.Marker.Width = value;
        ...
        public void Test_IfStatesSelectMarkerWidthDoesntRenderForDefault_Correct()
        {
            ...
            ((ArearangeSeries)chart.Series[0]).States.Select.Marker.Width = defaultValue;
        ...
        [Theory]
        [InlineData(ArearangeSeriesStep.Center)]
        [InlineData(ArearangeSeriesStep.Left)]
        [InlineData(ArearangeSeriesStep.Right)]
        public void Test_IfStepRenders_Correct(ArearangeSeriesStep value)
        {
            var chart = new Highcharts(); chart.Chart = new Chart();
            var renderer = new HighchartsRenderer(chart); var series = new ArearangeSeries(); chart.Series = new List<Highsoft.Web.Mvc.Charts.Series>(); chart.Series.Add(series);

            ((ArearangeSeries)chart.Series[0]).Step = value;
        ...
        public void Test_IfStepDoesntRenderForDefault_Correct()
        {
            var chart = new Highcharts(); chart.Chart = new Chart();
            var renderer = new HighchartsRenderer(chart); var series = new ArearangeSeries(); chart.Series = new List<Highsoft.Web.Mvc.Charts.Series>(); chart.Series.Add(series);
            var defaultValue = ArearangeSeriesStep.Null;

            ((ArearangeSeries)chart.Series[0]).Step = defaultValue;
        ...
        public void Test_IfStickyTrackingRenders_Correct()
        {
            ...
            ((ArearangeSeries)chart.Series[0]).StickyTracking = value;
        ...
        public void Test_IfStickyTrackingDoesntRenderForDefault_Correct()
        {
            ...
            ((ArearangeSeries)chart.Series[0]).StickyTracking = defaultValue;
        ...
        public void Test_IfThresholdRenders_Correct(double value)
        {
            ...
            ((ArearangeSeries)chart.Series[0]).Threshold = value;
        ...
        public void Test_IfThresholdDoesntRenderForDefault_Correct()
        {
            ...
            ((ArearangeSeries)chart.Series[0]).Threshold = defaultValue;
        ...
        public void Test_IfTooltipClusterFormatRenders_Correct(string value)
        {
            ...
            ((ArearangeSeries)chart.Series[0]).Tooltip.ClusterFormat = value;
        ...
        public void Test_IfTooltipClusterFormatDoesntRenderForDefault_Correct()
        {
            ...
            ((ArearangeSeries)chart.Series[0]).Tooltip.ClusterFormat = defaultValue;
        ...
        public void Test_IfTooltipDateTimeLabelFormatsRenders_Correct(string param, string paramValue)
        {
            ...
            ((ArearangeSeries)chart.Series[0]).Tooltip.DateTimeLabelFormats = value;
        ...
        //    ((ArearangeSeries)chart.Series[0]).Tooltip.DateTimeLabelFormats = defaultValue;
        ...
        public void Test_IfTooltipDistanceRenders_Correct(double value)
        {
            ...
            ((ArearangeSeries)chart.Series[0]).Tooltip.Distance = value;
        ...
        public void Test_IfTooltipDistanceDoesntRenderForDefault_Correct()
        {
            ...
            ((ArearangeSeries)chart.Series[0]).Tooltip.Distance = defaultValue;
        ...
        public void Test_IfTooltipFollowPointerRenders_Correct()
        {
            ...
            ((ArearangeSeries)chart.Series[0]).Tooltip.FollowPointer = value;
        ...
        //    ((ArearangeSeries)chart.Series[0]).Tooltip.FollowPointer = defaultValue;
        ...
        public void Test_IfTooltipFollowTouchMoveRenders_Correct()
        {
            ...
            ((ArearangeSeries)chart.Series[0]).Tooltip.FollowTouchMove = value;
        ...
        //    ((ArearangeSeries)chart.Series[0]).Tooltip.FollowTouchMove = defaultValue;
        ...
        public void Test_IfTooltipFooterFormatRenders_Correct(string value)
        {
            ...
            ((ArearangeSeries)chart.Series[0]).Tooltip.FooterFormat = value;
        ...
        public void Test_IfTooltipFooterFormatDoesntRenderForDefault_Correct()
        {
            ...
            ((ArearangeSeries)chart.Series[0]).Tooltip.FooterFormat = defaultValue;
        ...
        public void Test_IfTooltipHeaderFormatRenders_Correct(string value)
        {
            ...
            ((ArearangeSeries)chart.Series[0]).Tooltip.HeaderFormat = value;
        ...
        public void Test_IfTooltipHeaderFormatDoesntRenderForDefault_Correct()
        {
            ...
            ((ArearangeSeries)chart.Series[0]).Tooltip.HeaderFormat = defaultValue;
        ...
        public void Test_IfTooltipNullFormatRenders_Correct(string value)
        {
            ...
            ((ArearangeSeries)chart.Series[0]).Tooltip.NullFormat = value;
        ...
        public void Test_IfTooltipNullFormatDoesntRenderForDefault_Correct()
        {
            ...
            ((ArearangeSeries)chart.Series[0]).Tooltip.NullFormat = defaultValue;
        ...
        public void Test_IfTooltipNullFormatterRenders_Correct(string value)
        {
            ...
            ((ArearangeSeries)chart.Series[0]).Tooltip.NullFormatter = value;
        ...
        public void Test_IfTooltipNullFormatterDoesntRenderForDefault_Correct()
        {
            ...
            ((ArearangeSeries)chart.Series[0]).Tooltip.NullFormatter = defaultValue;
        ...
        public void Test_IfTooltipPointFormatRenders_Correct(string value)
        {
            ...
            ((ArearangeSeries)chart.Series[0]).Tooltip.PointFormat = value;
        ...
        public void Test_IfTooltipPointFormatDoesntRenderForDefault_Correct()
        {
            ...
            ((ArearangeSeries)chart.Series[0]).Tooltip.PointFormat = defaultValue;
        ...
        public void Test_IfTooltipPointFormatterRenders_Correct(string value)
        {
            ...
            ((ArearangeSeries)chart.Series[0]).Tooltip.PointFormatter = value;
        ...
        public void Test_IfTooltipPointFormatterDoesntRenderForDefault_Correct()
        {
            ...
            ((ArearangeSeries)chart.Series[0]).Tooltip.PointFormatter = defaultValue;
        ...
        public void Test_IfTooltipValueDecimalsRenders_Correct(double value)
        {
            ...
            ((ArearangeSeries)chart.Series[0]).Tooltip.ValueDecimals = value;
        ...
        public void Test_IfTooltipValueDecimalsDoesntRenderForDefault_Correct()
        {
            ...
            ((ArearangeSeries)chart.Series[0]).Tooltip.ValueDecimals = defaultValue;
        ...
        public void Test_IfTooltipValuePrefixRenders_Correct(string value)
        {
            ...
            ((ArearangeSeries)chart.Series[0]).Tooltip.ValuePrefix = value;
        ...
        public void Test_IfTooltipValuePrefixDoesntRenderForDefault_Correct()
        {
            ...
            ((ArearangeSeries)chart.Series[0]).Tooltip.ValuePrefix = defaultValue;
        ...
        public void Test_IfTooltipValueSuffixRenders_Correct(string value)
        {
            ...
            ((ArearangeSeries)chart.Series[0]).Tooltip.ValueSuffix = value;
        ...
        public void Test_IfTooltipValueSuffixDoesntRenderForDefault_Correct()
        {
            ...
            ((ArearangeSeries)chart.Series[0]).Tooltip.ValueSuffix = defaultValue;
        ...
        public void Test_IfTooltipXDateFormatRenders_Correct(string value)
        {
            ...
            ((ArearangeSeries)chart.Series[0]).Tooltip.XDateFormat = value;
        ...
        public void Test_IfTooltipXDateFormatDoesntRenderForDefault_Correct()
        {
            ...
            ((ArearangeSeries)chart.Series[0]).Tooltip.XDateFormat = defaultValue;
        ...
        public void Test_IfTurboThresholdTrackingRenders_Correct(double value)
        {
            ...
            ((ArearangeSeries)chart.Series[0]).TurboThreshold = value;
        ...
        public void Test_IfTurboThresholdDoesntRenderForDefault_Correct()
        {
            ...
            ((ArearangeSeries)chart.Series[0]).TurboThreshold = defaultValue;
        ...
        public void Test_IfVisibleRenders_Correct()
        {
            ...
            ((ArearangeSeries)chart.Series[0]).Visible = value;
        ...
        public void Test_IfVisibleDoesntRenderForDefault_Correct()
        {
            ...
            ((ArearangeSeries)chart.Series[0]).Visible = defaultValue;
        ...
        public void Test_IfZoneAxisRenders_Correct()
        {
            ...
            ((ArearangeSeries)chart.Series[0]).ZoneAxis = value;
        ...
        public void Test_IfZoneAxisDoesntRenderForDefault_Correct()
        {
            ...
            ((ArearangeSeries)chart.Series[0]).ZoneAxis = defaultValue;
        ...
        public void Test_IfZonesClassNameRenders_Correct(string value)
        {
            ...
            var zoneDef = new List<ArearangeSeriesZone> { new ArearangeSeriesZone { ClassName = value } };

            ((ArearangeSeries)chart.Series[0]).Zones = zoneDef;
        ...
        public void Test_IfZonesClassNameDoesntRenderForDefault_Correct()
        {
            ...
            var renderer = new HighchartsRenderer(chart); var series = new ArearangeSeries(); chart.Series = new List<Highsoft.Web.Mvc.Charts.Series>(); chart.Series.Add(series);
            var defaultValue = string.Empty;
            var zoneDef = new List<ArearangeSeriesZone> { new ArearangeSeriesZone { ClassName = defaultValue } };
        ...
        public void Test_IfZonesColorRenders_Correct(string value)
        {
            ...
            var renderer = new HighchartsRenderer(chart); var series = new ArearangeSeries(); chart.Series = new List<Highsoft.Web.Mvc.Charts.Series>(); chart.Series.Add(series);
            var pathToProperty = new List<string>() { "zones" };
            var zoneDef = new List<ArearangeSeriesZone> { new ArearangeSeriesZone { Color = value } };
        ...
        public void Test_IfZonesColorDoesntRenderForDefault_Correct()
        {
            ...
            var renderer = new HighchartsRenderer(chart); var series = new ArearangeSeries(); chart.Series = new List<Highsoft.Web.Mvc.Charts.Series>(); chart.Series.Add(series);
            var defaultValue = string.Empty;
            var zoneDef = new List<ArearangeSeriesZone> { new ArearangeSeriesZone { Color = defaultValue } };
        ...
        [Theory]
        [InlineData(ArearangeSeriesZonesDashStyle.Dash)]
        [InlineData(ArearangeSeriesZonesDashStyle.DashDot)]
        [InlineData(ArearangeSeriesZonesDashStyle.Dot)]
        [InlineData(ArearangeSeriesZonesDashStyle.LongDash)]
        [InlineData(ArearangeSeriesZonesDashStyle.LongDashDot)]
        [InlineData(ArearangeSeriesZonesDashStyle.LongDashDotDot)]
        [InlineData(ArearangeSeriesZonesDashStyle.ShortDash)]
        [InlineData(ArearangeSeriesZonesDashStyle.ShortDashDot)]
        [InlineData(ArearangeSeriesZonesDashStyle.ShortDashDotDot)]
        [InlineData(ArearangeSeriesZonesDashStyle.ShortDot)]
        [InlineData(ArearangeSeriesZonesDashStyle.Solid)]
        public void Test_IfZonesDashStyleRenders_Correct(ArearangeSeriesZonesDashStyle value)
        {
            var chart = new Highcharts(); chart.Chart = new Chart();
            var renderer = new HighchartsRenderer(chart); var series = new ArearangeSeries(); chart.Series = new List<Highsoft.Web.Mvc.Charts.Series>(); chart.Series.Add(series);
            var pathToProperty = new List<string>() { "zones" };
            var zoneDef = new List<ArearangeSeriesZone> { new ArearangeSeriesZone { DashStyle = value } };
        ...
        public void Test_IfZonesDashStyleDoesntRenderForDefault_Correct()
        {
            var chart = new Highcharts(); chart.Chart = new Chart();
            var renderer = new HighchartsRenderer(chart); var series = new ArearangeSeries(); chart.Series = new List<Highsoft.Web.Mvc.Charts.Series>(); chart.Series.Add(series);
            var defaultValue = ArearangeSeriesZonesDashStyle.Null;
            var zoneDef = new List<ArearangeSeriesZone> { new ArearangeSeriesZone { DashStyle = defaultValue } };
        ...
        public void Test_IfZonesFillColorRenders_Correct(string value)
        {
            ...
            var renderer = new HighchartsRenderer(chart); var series = new ArearangeSeries(); chart.Series = new List<Highsoft.Web.Mvc.Charts.Series>(); chart.Series.Add(series);
            var pathToProperty = new List<string>() { "zones" };
            var zoneDef = new List<ArearangeSeriesZone> { new ArearangeSeriesZone { FillColor = value } };
        ...
        //    var renderer = new HighchartsRenderer(chart); var series = new ArearangeSeries(); chart.Series = new List<Highsoft.Web.Mvc.Charts.Series>(); chart.Series.Add(series);
        //    var defaultValue = string.Empty;
        //    var zoneDef = new List<ArearangeSeriesZone> { new ArearangeSeriesZone { FillColor = defaultValue } };
        ...
        public void Test_IfZonesValueRenders_Correct(double value)
        {
            ...
            var renderer = new HighchartsRenderer(chart); var series = new ArearangeSeries(); chart.Series = new List<Highsoft.Web.Mvc.Charts.Series>(); chart.Series.Add(series);
            var pathToProperty = new List<string>() { "zones" };
            var zoneDef = new List<ArearangeSeriesZone> { new ArearangeSeriesZone { Value = value } };
        ...
        public void Test_IfZonesValueDoesntRenderForDefault_Correct()
        {
            ...
            var renderer = new HighchartsRenderer(chart); var series = new ArearangeSeries(); chart.Series = new List<Highsoft.Web.Mvc.Charts.Series>(); chart.Series.Add(series);
            double? defaultValue = null;
            var zoneDef = new List<ArearangeSeriesZone> { new ArearangeSeriesZone { Value = defaultValue } };
