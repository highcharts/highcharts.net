...
namespace HC.Series
{
    public class BoxplotSeriesTests : IClassFixture<HcFixture>
    {
        ...
        public void Test_IfAccessibilityEnabledRenders_Correct(bool enabled)
        {
            ...
            var renderer = new HighchartsRenderer(chart); var series = new BoxplotSeries(); chart.Series = new List<Highsoft.Web.Mvc.Charts.Series>(); chart.Series.Add(series); 
        ...
        public void Test_IfDataLabelsDeferBoolDoesntRenderForDefault_Correct()
        {
            ...
            ((BoxplotSeries)chart.Series[0]).DataLabels.Defer = defaultValue;
