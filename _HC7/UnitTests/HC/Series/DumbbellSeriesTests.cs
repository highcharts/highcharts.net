...
namespace HC.Series
{
    public class DumbbellSeriesTests : IClassFixture<HcFixture>
    {
        ...
        public void Test_IfAccessibilityEnabledRenders_Correct(bool enabled)
        {
            ...
            var renderer = new HighchartsRenderer(chart); var series = new DumbbellSeries(); chart.Series = new List<Highsoft.Web.Mvc.Charts.Series>(); chart.Series.Add(series); 
        ...
        public void Test_IfDataLabelsDeferBoolDoesntRenderForDefault_Correct()
        {
            ...
            ((DumbbellSeries)chart.Series[0]).DataLabels.Defer = defaultValue;
