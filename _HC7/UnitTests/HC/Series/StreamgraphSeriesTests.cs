...
namespace HC.Series
{
    public class StreamgraphSeriesTests : IClassFixture<HcFixture>
    {
        ...
        {
            var chart = new Highcharts(); chart.Chart = new Chart();
            var renderer = new HighchartsRenderer(chart); var series = new StreamgraphSeries(); chart.Series = new List<Highsoft.Web.Mvc.Charts.Series>(); chart.Series.Add(series);
            var enabled = true;
