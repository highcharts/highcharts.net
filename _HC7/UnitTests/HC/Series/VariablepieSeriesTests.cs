...
namespace HC.Series
{
    public class VariablepieSeriesTests : IClassFixture<HcFixture>
    {
        protected HcFixture _fixture;

        public VariablepieSeriesTests(HcFixture fixture)
        {
            _fixture = fixture;
        ...
        [Theory]
        [InlineData(VariablepieSeriesCursor.Default)]
        [InlineData(VariablepieSeriesCursor.Help)]
        [InlineData(VariablepieSeriesCursor.Pointer)]
        ...
        //[Theory]
        //[InlineData(VariablepieSeriesLinecap.Square)]
        ...
        public void Test_IfTooltipDateTimeLabelFormatsRenders_Correct(string param, string paramValue)
        {
            ...
            ((VariablepieSeries)chart.Series[0]).Tooltip.DateTimeLabelFormats = value;
        ...
        public void Test_IfTooltipFollowPointerRenders_Correct()
        {
            ...
            ((VariablepieSeries)chart.Series[0]).Tooltip.FollowPointer = value;
        ...
        public void Test_IfTooltipFollowTouchMoveRenders_Correct()
        {
            ...
            ((VariablepieSeries)chart.Series[0]).Tooltip.FollowTouchMove = value;
