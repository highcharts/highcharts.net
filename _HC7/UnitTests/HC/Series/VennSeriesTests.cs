...
namespace HC.Series
{
    public class VennSeriesTests : IClassFixture<HcFixture>
    {
        ...
        public void Test_IfAccessibilityEnabledRenders_Correct(bool enabled)
        {
            ...
            var renderer = new HighchartsRenderer(chart); var series = new VennSeries(); chart.Series = new List<Highsoft.Web.Mvc.Charts.Series>(); chart.Series.Add(series); 
        ...
        public void Test_IfDataLabelsDeferBoolDoesntRenderForDefault_Correct()
        {
            ...
            ((VennSeries)chart.Series[0]).DataLabels.Defer = defaultValue;
