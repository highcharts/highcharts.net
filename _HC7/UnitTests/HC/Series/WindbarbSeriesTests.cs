...
namespace HC.Series
{
    public class WindbarbSeriesTests : IClassFixture<HcFixture>
    {
        ...
        public void Test_IfAccessibilityEnabledRenders_Correct(bool enabled)
        {
            ...
            var renderer = new HighchartsRenderer(chart); var series = new WindbarbSeries(); chart.Series = new List<Highsoft.Web.Mvc.Charts.Series>(); chart.Series.Add(series); 
        ...
        public void Test_IfDataLabelsDeferBoolDoesntRenderForDefault_Correct()
        {
            ...
            ((WindbarbSeries)chart.Series[0]).DataLabels.Defer = defaultValue;
