...
{
    public class PlotOptionsArearangeTests : IClassFixture<HsFixture>
    {
        protected HsFixture _fixture;

        public PlotOptionsArearangeTests(HsFixture fixture)
        {
            _fixture = fixture;
        ...
        public void Test_IfThresholdRenders_Correct(double value)
        {
            ...
            chart.PlotOptions.Arearange.Threshold = value;
