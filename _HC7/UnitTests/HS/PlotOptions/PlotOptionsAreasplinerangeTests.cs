...
{
    public class PlotOptionsAreasplinerangeTests : IClassFixture<HsFixture>
    {
        protected HsFixture _fixture;

        public PlotOptionsAreasplinerangeTests(HsFixture fixture)
        {
            _fixture = fixture;
        ...
        //Fix required - incerrect default value
        //[Fact]
