...
{
    public class PlotOptionsBubbleTests : IClassFixture<HsFixture>
    {
        protected HsFixture _fixture;

        public PlotOptionsBubbleTests(HsFixture fixture)
        {
            _fixture = fixture;
        ...
        //clarification required - softThreshold doesn't exist in API
        //[Fact]
        ...
        public void Test_IfStatesSelectMarkerEnabledThresholdDoesntRenderForDefault_Correct()
        {
            ...
            chart.PlotOptions.Bubble.States.Select.Marker.EnabledThreshold = defaultValue;
