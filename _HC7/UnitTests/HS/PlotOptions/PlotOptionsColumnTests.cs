...
{
    public class PlotOptionsColumnTests : IClassFixture<HsFixture>
    {
        protected HsFixture _fixture;

        public PlotOptionsColumnTests(HsFixture fixture)
        {
            _fixture = fixture;
        ...
        //    chart.PlotOptions.Column.States.Hover.LineWidthPlus = defaultValue;
        ...
        //    chart.PlotOptions.Column.States.Select.LineWidthPlus = defaultValue;
