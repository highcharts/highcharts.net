...
{
    public class PlotOptionsColumnpyramidTests : IClassFixture<HsFixture>
    {
        protected HsFixture _fixture;

        public PlotOptionsColumnpyramidTests(HsFixture fixture)
        {
            _fixture = fixture;
        ...
        //fix requird - incorrect default value
        //[Fact]
