...
{
    public class PlotOptionsOhlcTests : IClassFixture<HsFixture>
    {
        protected HsFixture _fixture;

        public PlotOptionsOhlcTests(HsFixture fixture)
        {
            _fixture = fixture;
        ...
        public void Test_IfAccessibilityDescriptionRenders_Correct(string description)
        {
            ...
            chart.PlotOptions.Ohlc.Accessibility.Description = description;
        ...
        public void Test_IfAccessibilityEnabledRenders_Correct(bool enabled)
        {
            ...
            chart.PlotOptions.Ohlc.Accessibility.Enabled = enabled;
        ...
        public void Test_IfAccessibilityExposeAsGroupOnlyRenders_Correct(bool exposeAsGroupOnly)
        {
            ...
            chart.PlotOptions.Ohlc.Accessibility.ExposeAsGroupOnly = exposeAsGroupOnly;
        ...
        public void Test_IfAccessibilityKeyboardNavigationEnabledRenders_Correct(bool enabled)
        {
            ...
            chart.PlotOptions.Ohlc.Accessibility.KeyboardNavigation.Enabled = enabled;
        ...
        public void Test_IfAccessibilityPointDateFormatRenders_Correct(string format)
        {
            ...
            chart.PlotOptions.Ohlc.Accessibility.Point.DateFormat = format;
        ...
        public void Test_IfAccessibilityPointDateFormatterRenders_Correct(string function)
        {
            ...
            chart.PlotOptions.Ohlc.Accessibility.Point.DateFormatter = function;
        ...
        public void Test_IfAccessibilityPointDescribeNullSetOnFalseRenders_Correct(bool describeNull)
        {
            ...
            chart.PlotOptions.Ohlc.Accessibility.Point.DescribeNull = describeNull;
        ...
        public void Test_IfAccessibilityPointDescriptionFormatterRenders_Correct(string function)
        {
            ...
            chart.PlotOptions.Ohlc.Accessibility.Point.DescriptionFormatter = function;
        ...
        public void Test_IfAccessibilityPointValueDecimalsRenders_Correct(int decimals)
        {
            ...
            chart.PlotOptions.Ohlc.Accessibility.Point.ValueDecimals = decimals;
        ...
        public void Test_IfAccessibilityPointValueDescriptionFormatRenders_Correct(string format)
        {
            ...
            chart.PlotOptions.Ohlc.Accessibility.Point.ValueDescriptionFormat = format;
        ...
        public void Test_IfAccessibilityPointValuePrefixRenders_Correct(string prefix)
        {
            ...
            chart.PlotOptions.Ohlc.Accessibility.Point.ValuePrefix = prefix;
        ...
        public void Test_IfAccessibilityPointValueSufixRenders_Correct(string suffix)
        {
            ...
            chart.PlotOptions.Ohlc.Accessibility.Point.ValueSuffix = suffix;
        ...
        public void Test_IfAllowPointSelectRenders_Correct()
        {
            ...
            chart.PlotOptions.Ohlc.AllowPointSelect = enabled;
        ...
        public void Test_IfAllowPointSelectDoesntRenderForDefault_Correct()
        {
            ...
            chart.PlotOptions.Ohlc.AllowPointSelect = false;
        ...
        public void Test_IfAnimationEnabledRenders_Correct(bool enabled)
        {
            ...
            chart.PlotOptions.Ohlc.AnimationBool = enabled;
        ...
        //    chart.PlotOptions.Ohlc.Animation.Duration = duration;
        ...
        //    chart.PlotOptions.Ohlc.Animation.Easing = easing;
        ...
        public void Test_IfAnimationLimitRenders_Correct(int limit)
        {
            ...
            chart.PlotOptions.Ohlc.AnimationLimit = limit;

            Assert.Contains($"\"plotOptions\":{{\"{_fixture.ChartType.ToString().ToLower()}\":{{\"animationLimit\":{limit}.0}}}}", renderer.RenderHtml());
        }

        [Theory]
        [InlineData(PlotOptionsOhlcBoostBlending.Add)]
        [InlineData(PlotOptionsOhlcBoostBlending.Darken)]
        [InlineData(PlotOptionsOhlcBoostBlending.Multiply)]
        public void Test_IfBoostBlendingRenders_Correct(PlotOptionsOhlcBoostBlending boostBlending)
        {
            var chart = new Highstock();
            chart.Chart.Type = _fixture.ChartType;
            var renderer = new HighstockRenderer(chart);

            chart.PlotOptions.Ohlc.BoostBlending = boostBlending;
        ...
        public void Test_IfBoostBlendingDoesntRenderForDefault_Correct()
        {
            ...
            chart.PlotOptions.Ohlc.BoostBlending = PlotOptionsOhlcBoostBlending.Undefined;
        ...
        public void Test_IfBoostThresholdRenders_Correct(int limit)
        {
            ...
            chart.PlotOptions.Ohlc.BoostThreshold = limit;
        ...
        public void Test_IfBoostThresholdDoesntRenderForDefault_Correct()
        {
            ...
            chart.PlotOptions.Ohlc.BoostThreshold = defaultValue;
        ...
        public void Test_IfClassNameRenders_Correct(string className)
        {
            ...
            chart.PlotOptions.Ohlc.ClassName = className;
        ...
        public void Test_IfClipRenders_Correct()
        {
            ...
            chart.PlotOptions.Ohlc.Clip = value;
        ...
        public void Test_IfColorRenders_Correct(string color)
        {
            ...
            chart.PlotOptions.Ohlc.Color = color;
        ...
        public void Test_IfColorIndexRenders_Correct(int value)
        {
            ...
            chart.PlotOptions.Ohlc.ColorIndex = value;
        ...
        public void Test_IfColorKeyRenders_Correct(string value)
        {
            ...
            chart.PlotOptions.Ohlc.ColorKey = value;
        ...
        public void Test_IfCropThresholdRenders_Correct(int value)
        {
            ...
            chart.PlotOptions.Ohlc.CropThreshold = value;
        ...
        public void Test_IfCropThresholdDoesntRenderForDefault_Correct()
        {
            ...
            chart.PlotOptions.Ohlc.CropThreshold = defaultValue;

            Assert.DoesNotContain($"\"crisp\"", renderer.RenderHtml());
        }

        [Theory]
        [InlineData(PlotOptionsOhlcCursor.Default)]
        [InlineData(PlotOptionsOhlcCursor.Help)]
        [InlineData(PlotOptionsOhlcCursor.Pointer)]
        [InlineData(PlotOptionsOhlcCursor.None)]
        public void Test_IfCursorRenders_Correct(PlotOptionsOhlcCursor cursor)
        {
            var chart = new Highstock();
            chart.Chart.Type = _fixture.ChartType;
            var renderer = new HighstockRenderer(chart);

            chart.PlotOptions.Ohlc.Cursor = cursor;
        ...
        public void Test_IfCustomRenders_Correct(string key1, string value1)
        {
            ...
            chart.PlotOptions.Ohlc.Custom = extraData;

            Assert.Contains($"\"plotOptions\":{{\"{_fixture.ChartType.ToString().ToLower()}\":{{\"custom\":{{\"{key1}\":\"{value1}\"}}}}}}", renderer.RenderHtml());
        }

        [Theory]
        [InlineData(PlotOptionsOhlcDashStyle.Dash)]
        [InlineData(PlotOptionsOhlcDashStyle.DashDot)]
        [InlineData(PlotOptionsOhlcDashStyle.Dot)]
        [InlineData(PlotOptionsOhlcDashStyle.LongDash)]
        [InlineData(PlotOptionsOhlcDashStyle.LongDashDot)]
        [InlineData(PlotOptionsOhlcDashStyle.LongDashDotDot)]
        [InlineData(PlotOptionsOhlcDashStyle.ShortDash)]
        [InlineData(PlotOptionsOhlcDashStyle.ShortDashDot)]
        [InlineData(PlotOptionsOhlcDashStyle.ShortDashDotDot)]
        [InlineData(PlotOptionsOhlcDashStyle.ShortDot)]
        public void Test_IfDashStyleRenders_Correct(PlotOptionsOhlcDashStyle style)
        {
            var chart = new Highstock();
            chart.Chart.Type = _fixture.ChartType;
            var renderer = new HighstockRenderer(chart);
            ...
            chart.PlotOptions.Ohlc.DashStyle = style;
        ...
        [Theory]
        [InlineData(PlotOptionsOhlcDataLabelsAlign.Left)]
        [InlineData(PlotOptionsOhlcDataLabelsAlign.Right)]
        public void Test_IfDataLabelsAlignRenders_Correct(PlotOptionsOhlcDataLabelsAlign align)
        {
            var chart = new Highstock();
            var renderer = new HighstockRenderer(chart);

            chart.PlotOptions.Ohlc.DataLabels.Align = align;
        ...
        public void Test_IfDataLabelsAlignDoesntRenderForDefault_Correct()
        {
            var chart = new Highstock();
            var renderer = new HighstockRenderer(chart);
            var defaultValue = PlotOptionsOhlcDataLabelsAlign.Center;

            chart.PlotOptions.Ohlc.DataLabels.Align = defaultValue;
        ...
        public void Test_IfDataLabelsAllowOverlapRenders_Correct()
        {
            ...
            chart.PlotOptions.Ohlc.DataLabels.AllowOverlap = value;
        ...
        public void Test_IfDataLabelsAllowOverlapDoesntRenderForDefault_Correct()
        {
            ...
            chart.PlotOptions.Ohlc.DataLabels.AllowOverlap = defaultValue;
        ...
        public void Test_IfDataLabelsBackgroundColorRenders_Correct(string value)
        {
            ...
            chart.PlotOptions.Ohlc.DataLabels.BackgroundColor = value;
        ...
        public void Test_IfDataLabelsBackgroundColorDoesntRenderForDefault_Correct()
        {
            ...
            chart.PlotOptions.Ohlc.DataLabels.BackgroundColor = defaultValue;
        ...
        public void Test_IfDataLabelsBorderColorRenders_Correct(string value)
        {
            ...
            chart.PlotOptions.Ohlc.DataLabels.BorderColor = value;
        ...
        public void Test_IfDataLabelsBorderColorDoesntRenderForDefault_Correct()
        {
            ...
            chart.PlotOptions.Ohlc.DataLabels.BorderColor = defaultValue;
        ...
        public void Test_IfDataLabelsBorderRadiusRenders_Correct(double value)
        {
            ...
            chart.PlotOptions.Ohlc.DataLabels.BorderRadius = value;
        ...
        public void Test_IfDataLabelsBorderRadiusDoesntRenderForDefault_Correct()
        {
            ...
            chart.PlotOptions.Ohlc.DataLabels.BorderRadius = defaultValue;
        ...
        public void Test_IfDataLabelsBorderWidthRenders_Correct(double value)
        {
            ...
            chart.PlotOptions.Ohlc.DataLabels.BorderWidth = value;
        ...
        public void Test_IfDataLabelsBorderWidthDoesntRenderForDefault_Correct()
        {
            ...
            chart.PlotOptions.Ohlc.DataLabels.BorderWidth = defaultValue;
        ...
        public void Test_IfDataLabelsClassNameRenders_Correct(string value)
        {
            ...
            chart.PlotOptions.Ohlc.DataLabels.ClassName = value;
        ...
        public void Test_IfDataLabelsClassNameDoesntRenderForDefault_Correct()
        {
            ...
            chart.PlotOptions.Ohlc.DataLabels.ClassName = defaultValue;
        ...
        public void Test_IfDataLabelsColorRenders_Correct(string value)
        {
            ...
            chart.PlotOptions.Ohlc.DataLabels.Color = value;
        ...
        public void Test_IfDataLabelsColorDoesntRenderForDefault_Correct()
        {
            ...
            chart.PlotOptions.Ohlc.DataLabels.Color = defaultValue;
        ...
        public void Test_IfDataLabelsCropRenders_Correct()
        {
            ...
            chart.PlotOptions.Ohlc.DataLabels.Crop = value;
        ...
        public void Test_IfDataLabelsCropDoesntRenderForDefault_Correct()
        {
            ...
            chart.PlotOptions.Ohlc.DataLabels.Crop = defaultValue;
        ...
        public void Test_IfDataLabelsDeferBoolRenders_Correct()
        {
            ...
            chart.PlotOptions.Ohlc.DataLabels.DeferBool = value;
        ...
        public void Test_IfDataLabelsDeferBoolDoesntRenderForDefault_Correct()
        {
            ...
            chart.PlotOptions.Ohlc.DataLabels.DeferBool = defaultValue;
        ...
        public void Test_IfDataLabelsDeferRenders_Correct(double value)
        {
            ...
            chart.PlotOptions.Ohlc.DataLabels.Defer = value;
        ...
        public void Test_IfDataLabelsEnabledBoolRenders_Correct()
        {
            ...
            chart.PlotOptions.Ohlc.DataLabels.Enabled = value;
        ...
        public void Test_IfDataLabelsEnabledBoolDoesntRenderForDefault_Correct()
        {
            ...
            chart.PlotOptions.Ohlc.DataLabels.Enabled = defaultValue;
        ...
        public void Test_IfDataLabelsFilterOperatorRenders_Correct(string value)
        {
            ...
            chart.PlotOptions.Ohlc.DataLabels.Filter.Operator = value;
        ...
        public void Test_IfDataLabelsFilterOperatorDoesntRenderForDefault_Correct()
        {
            ...
            chart.PlotOptions.Ohlc.DataLabels.Filter.Operator = defaultValue;
        ...
        public void Test_IfDataLabelsFilterPropertyRenders_Correct(string value)
        {
            ...
            chart.PlotOptions.Ohlc.DataLabels.Filter.Property = value;
        ...
        public void Test_IfDataLabelsFilterPropertyDoesntRenderForDefault_Correct()
        {
            ...
            chart.PlotOptions.Ohlc.DataLabels.Filter.Property = defaultValue;
        ...
        public void Test_IfDataLabelsFilterValueRenders_Correct(double value)
        {
            ...
            chart.PlotOptions.Ohlc.DataLabels.Filter.Value = value;
        ...
        public void Test_IfDataLabelsFilterValueDoesntRenderForDefault_Correct()
        {
            ...
            chart.PlotOptions.Ohlc.DataLabels.Filter.Value = defaultValue;
        ...
        public void Test_IfDataLabelsFormatRenders_Correct(string value)
        {
            ...
            chart.PlotOptions.Ohlc.DataLabels.Format = value;
        ...
        public void Test_IfDataLabelsFormatDoesntRenderForDefault_Correct()
        {
            ...
            chart.PlotOptions.Ohlc.DataLabels.Format = defaultValue;
        ...
        public void Test_IfDataLabelsFormatterRenders_Correct(string value)
        {
            ...
            chart.PlotOptions.Ohlc.DataLabels.Formatter = value;
        ...
        public void Test_IfDataLabelsFormatterDoesntRenderForDefault_Correct()
        {
            ...
            chart.PlotOptions.Ohlc.DataLabels.Formatter = defaultValue;
        ...
        public void Test_IfDataLabelsInsideRenders_Correct(bool value)
        {
            ...
            chart.PlotOptions.Ohlc.DataLabels.Inside = value;
        ...
        public void Test_IfDataLabelsInsideDoesntRenderForDefault_Correct()
        {
            ...
            chart.PlotOptions.Ohlc.DataLabels.Inside = defaultValue;
        ...
        public void Test_IfDataLabelsNullFormatBoolRenders_Correct(bool value)
        {
            ...
            chart.PlotOptions.Ohlc.DataLabels.NullFormatBool = value;
        ...
        public void Test_IfDataLabelsNullFormatBoolDoesntRenderForDefault_Correct()
        {
            ...
            chart.PlotOptions.Ohlc.DataLabels.NullFormatBool = defaultValue;
        ...
        public void Test_IfDataLabelsNullFormatRenders_Correct(string value)
        {
            ...
            chart.PlotOptions.Ohlc.DataLabels.NullFormat = value;
        ...
        public void Test_IfDataLabelsNullFormatDoesntRenderForDefault_Correct()
        {
            ...
            chart.PlotOptions.Ohlc.DataLabels.NullFormat = defaultValue;
        ...
        public void Test_IfDataLabelsNullFormatterRenders_Correct(string value)
        {
            ...
            chart.PlotOptions.Ohlc.DataLabels.NullFormatter = value;
        ...
        public void Test_IfDataLabelsNullFormatterDoesntRenderForDefault_Correct()
        {
            ...
            chart.PlotOptions.Ohlc.DataLabels.NullFormatter = defaultValue;

            Assert.DoesNotContain($"nullFormatter", renderer.RenderHtml());
        }

        [Theory]
        [InlineData(PlotOptionsOhlcDataLabelsOverflow.Allow)]
        public void Test_IfDataLabelsOverflowRenders_Correct(PlotOptionsOhlcDataLabelsOverflow align)
        {
            var chart = new Highstock();
            var renderer = new HighstockRenderer(chart);

            chart.PlotOptions.Ohlc.DataLabels.Overflow = align;
        ...
        public void Test_IfDataLabelsOverflowDoesntRenderForDefault_Correct()
        {
            var chart = new Highstock();
            var renderer = new HighstockRenderer(chart);
            var defaultValue = PlotOptionsOhlcDataLabelsOverflow.Justify;

            chart.PlotOptions.Ohlc.DataLabels.Overflow = defaultValue;
        ...
        public void Test_IfDataLabelsPaddingRenders_Correct(double value)
        {
            ...
            chart.PlotOptions.Ohlc.DataLabels.Padding = value;
        ...
        public void Test_IfDataLabelsPaddingDoesntRenderForDefault_Correct()
        {
            ...
            chart.PlotOptions.Ohlc.DataLabels.Padding = defaultValue;

            Assert.DoesNotContain($"padding", renderer.RenderHtml());
        }

        [Theory]
        [InlineData(PlotOptionsOhlcDataLabelsPosition.Left)]
        [InlineData(PlotOptionsOhlcDataLabelsPosition.Right)]
        public void Test_IfDataLabelsPositionRenders_Correct(PlotOptionsOhlcDataLabelsPosition align)
        {
            var chart = new Highstock();
            var renderer = new HighstockRenderer(chart);

            chart.PlotOptions.Ohlc.DataLabels.Position = align;
        ...
        public void Test_IfDataLabelsPositionDoesntRenderForDefault_Correct()
        {
            var chart = new Highstock();
            var renderer = new HighstockRenderer(chart);
            var defaultValue = PlotOptionsOhlcDataLabelsPosition.Center;

            chart.PlotOptions.Ohlc.DataLabels.Position = defaultValue;
        ...
        public void Test_IfDataLabelsRotationRenders_Correct(double value)
        {
            ...
            chart.PlotOptions.Ohlc.DataLabels.Rotation = value;
        ...
        public void Test_IfDataLabelsRotationDoesntRenderForDefault_Correct()
        {
            ...
            chart.PlotOptions.Ohlc.DataLabels.Rotation = defaultValue;
        ...
        public void Test_IfDataLabelsShadowBoolRenders_Correct()
        {
            ...
            chart.PlotOptions.Ohlc.DataLabels.ShadowBool = value;
        ...
        public void Test_IfDataLabelsShadowRenders_Correct(string color, int offsetX, int offsetY, double opacity, int width)
        {
            ...
            chart.PlotOptions.Ohlc.DataLabels.Shadow = new Shadow()
            {
                Color = color,
                OffsetX = offsetX,
                OffsetY = offsetY,
        ...
        public void Test_IfDataLabelsShadowBoolDoesntRenderForDefault_Correct()
        {
            ...
            chart.PlotOptions.Ohlc.DataLabels.ShadowBool = defaultValue;
        ...
        public void Test_IfDataLabelsShapeRenders_Correct(string value)
        {
            ...
            chart.PlotOptions.Ohlc.DataLabels.Shape = value;
        ...
        public void Test_IfDataLabelsShapeDoesntRenderForDefault_Correct()
        {
            ...
            chart.PlotOptions.Ohlc.DataLabels.Shape = defaultValue;
        ...
        public void Test_IfDataLabelsStyleStringRenders_Correct(string param1, string param1_value)
        {
            var chart = new Highstock();
            var renderer = new HighstockRenderer(chart);
            var pathToProperty = new List<string>() { "plotOptions", "ohlc", "dataLabels", "style" };
            var style = new Hashtable();
            style.Add(param1, param1_value);

            chart.PlotOptions.Ohlc.DataLabels.Style = style;
        ...
        public void Test_IfDataLabelsTextPathEnabledRenders_Correct(bool value)
        {
            var chart = new Highstock();
            var renderer = new HighstockRenderer(chart);
            var pathToProperty = new List<string> { "plotOptions", "ohlc", "dataLabels", "textPath" };

            chart.PlotOptions.Ohlc.DataLabels.TextPath.Enabled = value;
        ...
        public void Test_IfDataLabelsTextPathEnabledDoesntRenderForDefault_Correct()
        {
            ...
            chart.PlotOptions.Ohlc.DataLabels.TextPath.Enabled = defaultValue;
        ...
        public void Test_IfDataLabelsUseHTMLRenders_Correct()
        {
            ...
            chart.PlotOptions.Ohlc.DataLabels.UseHTML = value;
        ...
        public void Test_IfDataLabelsUseHTMLDoesntRenderForDefault_Correct()
        {
            ...
            chart.PlotOptions.Ohlc.DataLabels.UseHTML = defaultValue;

            Assert.DoesNotContain($"useHTML", renderer.RenderHtml());
        }

        [Theory]
        [InlineData(PlotOptionsOhlcDataLabelsVerticalAlign.Middle)]
        [InlineData(PlotOptionsOhlcDataLabelsVerticalAlign.Top)]
        public void Test_IfDataLabelsVerticalAlignRenders_Correct(PlotOptionsOhlcDataLabelsVerticalAlign align)
        {
            var chart = new Highstock();
            var renderer = new HighstockRenderer(chart);

            chart.PlotOptions.Ohlc.DataLabels.VerticalAlign = align;
        ...
        public void Test_IfDataLabelsVerticalAlignDoesntRenderForDefault_Correct()
        {
            var chart = new Highstock();
            var renderer = new HighstockRenderer(chart);
            var defaultValue = PlotOptionsOhlcDataLabelsVerticalAlign.Bottom;

            chart.PlotOptions.Ohlc.DataLabels.VerticalAlign = defaultValue;
        ...
        public void Test_IfDataLabelsXRenders_Correct(double value)
        {
            ...
            chart.PlotOptions.Ohlc.DataLabels.X = value;
        ...
        public void Test_IfDataLabelsXDoesntRenderForDefault_Correct()
        {
            ...
            chart.PlotOptions.Ohlc.DataLabels.X = defaultValue;
        ...
        public void Test_IfDataLabelsYRenders_Correct(double value)
        {
            ...
            chart.PlotOptions.Ohlc.DataLabels.Y = value;
        ...
        public void Test_IfDataLabelsYDoesntRenderForDefault_Correct()
        {
            ...
            chart.PlotOptions.Ohlc.DataLabels.Y = defaultValue;
        ...
        public void Test_IfDataLabelsZRenders_Correct(double value)
        {
            ...
            chart.PlotOptions.Ohlc.DataLabels.ZIndex = value;
        ...
        public void Test_IfDataLabelsZDoesntRenderForDefault_Correct()
        {
            ...
            chart.PlotOptions.Ohlc.DataLabels.ZIndex = defaultValue;
        ...
        public void Test_IfDataSortingEnabledRenders_Correct(bool value)
        {
            var chart = new Highstock();
            var renderer = new HighstockRenderer(chart);
            var pathToProperty = new List<string> { "plotOptions", "ohlc", "dataSorting" };

            chart.PlotOptions.Ohlc.DataSorting.Enabled = value;
        ...
        public void Test_IfDataSortingEnabledDoesntRenderForDefault_Correct()
        {
            ...
            chart.PlotOptions.Ohlc.DataSorting.Enabled = defaultValue;
        ...
        public void Test_IfDataSortingMatchByNameRenders_Correct(bool value)
        {
            ...
            chart.PlotOptions.Ohlc.DataSorting.MatchByName = value;
        ...
        public void Test_IfDataSortingMatchByNameDoesntRenderForDefault_Correct()
        {
            ...
            chart.PlotOptions.Ohlc.DataSorting.MatchByName = defaultValue;
        ...
        public void Test_IfDataSortingSortKeyRenders_Correct(string value)
        {
            ...
            chart.PlotOptions.Ohlc.DataSorting.SortKey = value;
        ...
        public void Test_IfDataSortingSortKeyDoesntRenderForDefault_Correct()
        {
            ...
            chart.PlotOptions.Ohlc.DataSorting.SortKey = defaultValue;
        ...
        public void Test_IfDescriptionRenders_Correct(string description)
        {
            ...
            chart.PlotOptions.Ohlc.Description = description;
        ...
        public void Test_IfEnableMouseTrackingRenders_Correct()
        {
            ...
            chart.PlotOptions.Ohlc.EnableMouseTracking = value;
        ...
        public void Test_IfEventsAfterAnimateRenders_Correct(string value)
        {
            var chart = new Highstock();
            var renderer = new HighstockRenderer(chart);
            var pathToProperty = new List<string> { "plotOptions", "ohlc", "events" };

            chart.PlotOptions.Ohlc.Events.AfterAnimate = value;
        ...
        public void Test_IfEventsAfterAnimateDoesntRenderForDefault_Correct()
        {
            ...
            chart.PlotOptions.Ohlc.Events.AfterAnimate = defaultValue;
        ...
        public void Test_IfEventsCheckboxClickRenders_Correct(string value)
        {
            ...
            chart.PlotOptions.Ohlc.Events.CheckboxClick = value;
        ...
        public void Test_IfEventsCheckboxClickDoesntRenderForDefault_Correct()
        {
            ...
            chart.PlotOptions.Ohlc.Events.CheckboxClick = defaultValue;
        ...
        public void Test_IfEventsClickRenders_Correct(string value)
        {
            ...
            chart.PlotOptions.Ohlc.Events.Click = value;
        ...
        public void Test_IfEventsclickDoesntRenderForDefault_Correct()
        {
            ...
            chart.PlotOptions.Ohlc.Events.Click = defaultValue;
        ...
        public void Test_IfEventsHideRenders_Correct(string value)
        {
            ...
            chart.PlotOptions.Ohlc.Events.Hide = value;
        ...
        public void Test_IfEventsHideDoesntRenderForDefault_Correct()
        {
            ...
            chart.PlotOptions.Ohlc.Events.Hide = defaultValue;
        ...
        public void Test_IfEventsLegendItemClickRenders_Correct(string value)
        {
            ...
            chart.PlotOptions.Ohlc.Events.LegendItemClick = value;
        ...
        public void Test_IfEventsLegendItemClickDoesntRenderForDefault_Correct()
        {
            ...
            chart.PlotOptions.Ohlc.Events.LegendItemClick = defaultValue;
        ...
        public void Test_IfEventsMouseOutRenders_Correct(string value)
        {
            ...
            chart.PlotOptions.Ohlc.Events.MouseOut = value;
        ...
        public void Test_IfEventsMouseOutDoesntRenderForDefault_Correct()
        {
            ...
            chart.PlotOptions.Ohlc.Events.MouseOut = defaultValue;
        ...
        public void Test_IfEventsMouseOverRenders_Correct(string value)
        {
            ...
            chart.PlotOptions.Ohlc.Events.MouseOver = value;
        ...
        public void Test_IfEventsMouseOverDoesntRenderForDefault_Correct()
        {
            ...
            chart.PlotOptions.Ohlc.Events.MouseOver = defaultValue;
        ...
        public void Test_IfEventsShowRenders_Correct(string value)
        {
            ...
            chart.PlotOptions.Ohlc.Events.Show = value;
        ...
        public void Test_IfEventsShowDoesntRenderForDefault_Correct()
        {
            ...
            chart.PlotOptions.Ohlc.Events.Show = defaultValue;
        ...
        public void Test_IfFindNearestPointByRenders_Correct()
        {
            var chart = new Highstock();
            var renderer = new HighstockRenderer(chart);
            var value = PlotOptionsOhlcFindNearestPointBy.Xy;

            chart.PlotOptions.Ohlc.FindNearestPointBy = value;
        ...
        public void Test_IfFindNearestPointByDoesntRenderForDefault_Correct()
        {
            var chart = new Highstock();
            var renderer = new HighstockRenderer(chart);
            var value = PlotOptionsOhlcFindNearestPointBy.X;
        ...
        public void Test_IfGetExtremesFromAllRenders_Correct()
        {
            ...
            chart.PlotOptions.Ohlc.GetExtremesFromAll = value;
        ...
        public void Test_IfIncludeInDataExportFromAllRenders_Correct(bool value)
        {
            ...
            chart.PlotOptions.Ohlc.IncludeInDataExport = value;
        ...
        public void Test_IfLabelConnectorAllowedRenders_Correct()
        {
            var chart = new Highstock();
            var renderer = new HighstockRenderer(chart);
            var pathToProperty = new List<string> { "plotOptions", "ohlc", "label" };
            var value = true;

            chart.PlotOptions.Ohlc.Label.ConnectorAllowed = value;
        ...
        public void Test_IfLabelConnectorAllowedDoesntRenderForDefault_Correct()
        {
            ...
            chart.PlotOptions.Ohlc.Label.ConnectorAllowed = defaultValue;
        ...
        public void Test_IfLabelConnectorNeighbourDistanceRenders_Correct(double value)
        {
            ...
            chart.PlotOptions.Ohlc.Label.ConnectorNeighbourDistance = value;
        ...
        public void Test_IfLabelConnectorNeighbourDistanceDoesntRenderForDefault_Correct()
        {
            ...
            chart.PlotOptions.Ohlc.Label.ConnectorNeighbourDistance = defaultValue;
        ...
        public void Test_IfLabelEnabledRenders_Correct()
        {
            ...
            chart.PlotOptions.Ohlc.Label.Enabled = value;
        ...
        public void Test_IfLabelEnabledDoesntRenderForDefault_Correct()
        {
            ...
            chart.PlotOptions.Ohlc.Label.Enabled = defaultValue;
        ...
        public void Test_IfLabelFormatRenders_Correct(string value)
        {
            ...
            chart.PlotOptions.Ohlc.Label.Format = value;
        ...
        //    chart.PlotOptions.Ohlc.Label.Format = defaultValue;
        ...
        public void Test_IfLabelFormatterRenders_Correct(string value)
        {
            ...
            chart.PlotOptions.Ohlc.Label.Formatter = value;
        ...
        public void Test_IfLabelFormatterDoesntRenderForDefault_Correct()
        {
            ...
            chart.PlotOptions.Ohlc.Label.Formatter = defaultValue;
        ...
        public void Test_IfLabelMaxFontSizeRenders_Correct(double value)
        {
            ...
            chart.PlotOptions.Ohlc.Label.MaxFontSize = value;
        ...
        public void Test_IfLabelMaxFontSizeDoesntRenderForDefault_Correct()
        {
            ...
            chart.PlotOptions.Ohlc.Label.MaxFontSize = defaultValue;
        ...
        public void Test_IfLabelMinFontSizeRenders_Correct(double value)
        {
            ...
            chart.PlotOptions.Ohlc.Label.MinFontSize = value;
        ...
        public void Test_IfLabelMinFontSizeDoesntRenderForDefault_Correct()
        {
            ...
            chart.PlotOptions.Ohlc.Label.MinFontSize = defaultValue;
        ...
        public void Test_IfLabelOnAreaRenders_Correct(bool value)
        {
            ...
            chart.PlotOptions.Ohlc.Label.OnArea = value;
        ...
        public void Test_IfLabelOnAreaDoesntRenderForDefault_Correct()
        {
            ...
            chart.PlotOptions.Ohlc.Label.OnArea = defaultValue;
        ...
        public void Test_IfLabelStyleRenders_Correct(string paramName, string paramValue)
        {
            ...
            chart.PlotOptions.Ohlc.Label.Style = value;
        ...
        //    chart.PlotOptions.Ohlc.Label.Style = defaultValue;
        ...
        //[Theory]
        //[InlineData(PlotOptionsOhlcLinecap.Square)]
        ////missing PlotOptionsOhlcLinecap.Butt ?
        //public void Test_IfLinecapRenders_Correct(PlotOptionsOhlcLinecap value)
        //{
        //    var chart = new Highstock();
        //    var renderer = new HighstockRenderer(chart);

        //    chart.PlotOptions.Ohlc.Linecap = value;
        ...
        //    var chart = new Highstock();
        //    var renderer = new HighstockRenderer(chart);
        //    var defaultValue = PlotOptionsOhlcLinecap.Round;

        //    chart.PlotOptions.Ohlc.Linecap = defaultValue;
        ...
        public void Test_IfLineWidthRenders_Correct(double value)
        {
            ...
            chart.PlotOptions.Ohlc.LineWidth = value;
        ...
        public void Test_IfLineWidthDoesntRenderForDefault_Correct()
        {
            ...
            chart.PlotOptions.Ohlc.LineWidth = defaultValue;
        ...
        public void Test_IfLinkedToRenders_Correct(string value)
        {
            ...
            chart.PlotOptions.Ohlc.LinkedTo = value;
        ...
        public void Test_IfLinkedToDoesntRenderForDefault_Correct()
        {
            ...
            chart.PlotOptions.Ohlc.LinkedTo = defaultValue;
        ...
        public void Test_IfNegativeColorRenders_Correct(string value)
        {
            ...
            chart.PlotOptions.Ohlc.NegativeColor = value;
        ...
        public void Test_IfNegativeColorDoesntRenderForDefault_Correct()
        {
            ...
            chart.PlotOptions.Ohlc.NegativeColor = defaultValue;
        ...
        //    var chart = new Highstock();
        //    var renderer = new HighstockRenderer(chart);
        //    var pathToProperty = new List<string>() { "plotOptions", "ohlc", "onPoint", "connectorOptions" };

        //    chart.PlotOptions.Ohlc.OnPoint.ConnectorOptions.Dashstyle = value;
        ...
        public void Test_IfOnPointConnectorOptionsStrokeRenders_Correct(string value)
        {
            ...
            chart.PlotOptions.Ohlc.OnPoint.ConnectorOptions.Stroke = value;
        ...
        public void Test_IfOnPointConnectorOptionsStrokeDoesntRenderForDefault_Correct()
        {
            ...
            chart.PlotOptions.Ohlc.OnPoint.ConnectorOptions.Stroke = defaultValue;
        ...
        public void Test_IfOnPointConnectorOptionsWidthRenders_Correct(double value)
        {
            ...
            chart.PlotOptions.Ohlc.OnPoint.ConnectorOptions.Width = value;
        ...
        public void Test_IfOnPointConnectorOptionsWidthDoesntRenderForDefault_Correct()
        {
            ...
            chart.PlotOptions.Ohlc.OnPoint.ConnectorOptions.Width = defaultValue;
        ...
        public void Test_IfOnPointIdRenders_Correct(string value)
        {
            var chart = new Highstock();
            var renderer = new HighstockRenderer(chart);
            var pathToProperty = new List<string>() { "plotOptions", "ohlc", "onPoint" };

            chart.PlotOptions.Ohlc.OnPoint.Id = value;
        ...
        public void Test_IfOnPointIdDoesntRenderForDefault_Correct()
        {
            ...
            chart.PlotOptions.Ohlc.OnPoint.Id = defaultValue;
        ...
        public void Test_IfOnPointPositionOffsetXRenders_Correct(double value)
        {
            var chart = new Highstock();
            var renderer = new HighstockRenderer(chart);
            var pathToProperty = new List<string>() { "plotOptions", "ohlc", "onPoint", "position" };

            chart.PlotOptions.Ohlc.OnPoint.Position.OffsetX = value;
        ...
        public void Test_IfOnPointOffsetXDoesntRenderForDefault_Correct()
        {
            ...
            chart.PlotOptions.Ohlc.OnPoint.Position.OffsetX = defaultValue;
        ...
        public void Test_IfOnPointPositionOffsetYRenders_Correct(double value)
        {
            ...
            chart.PlotOptions.Ohlc.OnPoint.Position.OffsetY = value;
        ...
        public void Test_IfOnPointOffsetYDoesntRenderForDefault_Correct()
        {
            ...
            chart.PlotOptions.Ohlc.OnPoint.Position.OffsetY = defaultValue;
        ...
        public void Test_IfOnPointPositionXRenders_Correct(double value)
        {
            ...
            chart.PlotOptions.Ohlc.OnPoint.Position.X = value;
        ...
        public void Test_IfOnPointXDoesntRenderForDefault_Correct()
        {
            ...
            chart.PlotOptions.Ohlc.OnPoint.Position.X = defaultValue;
        ...
        public void Test_IfOnPointPositionYRenders_Correct(double value)
        {
            ...
            chart.PlotOptions.Ohlc.OnPoint.Position.Y = value;
        ...
        public void Test_IfOnPointYDoesntRenderForDefault_Correct()
        {
            ...
            chart.PlotOptions.Ohlc.OnPoint.Position.Y = defaultValue;
        ...
        public void Test_IfOpacityRenders_Correct(double value)
        {
            ...
            chart.PlotOptions.Ohlc.Opacity = value;
        ...
        public void Test_IfOpacityDoesntRenderForDefault_Correct()
        {
            ...
            chart.PlotOptions.Ohlc.Opacity = defaultValue;
        ...
        public void Test_IfPointEventsClickRenders_Correct(string value)
        {
            var chart = new Highstock();
            var renderer = new HighstockRenderer(chart);
            var pathToProperty = new List<string>() { "plotOptions", "ohlc", "point", "events" };

            chart.PlotOptions.Ohlc.Point.Events.Click = value;
        ...
        public void Test_IfPointEventsClickDoesntRenderForDefault_Correct()
        {
            ...
            chart.PlotOptions.Ohlc.Point.Events.Click = defaultValue;
        ...
        public void Test_IfPointEventsDragRenders_Correct(string value)
        {
            ...
            chart.PlotOptions.Ohlc.Point.Events.Drag = value;
        ...
        public void Test_IfPointEventsDragDoesntRenderForDefault_Correct()
        {
            ...
            chart.PlotOptions.Ohlc.Point.Events.Drag = defaultValue;
        ...
        public void Test_IfPointEventsDragStartRenders_Correct(string value)
        {
            ...
            chart.PlotOptions.Ohlc.Point.Events.DragStart = value;
        ...
        public void Test_IfPointEventsDragStartDoesntRenderForDefault_Correct()
        {
            ...
            chart.PlotOptions.Ohlc.Point.Events.DragStart = defaultValue;
        ...
        public void Test_IfPointEventsDropRenders_Correct(string value)
        {
            ...
            chart.PlotOptions.Ohlc.Point.Events.Drop = value;
        ...
        public void Test_IfPointEventsDropDoesntRenderForDefault_Correct()
        {
            ...
            chart.PlotOptions.Ohlc.Point.Events.Drop = defaultValue;
        ...
        public void Test_IfPointEventsMouseOutRenders_Correct(string value)
        {
            ...
            chart.PlotOptions.Ohlc.Point.Events.MouseOut = value;
        ...
        public void Test_IfPointEventsMouseOutDoesntRenderForDefault_Correct()
        {
            ...
            chart.PlotOptions.Ohlc.Point.Events.MouseOut = defaultValue;
        ...
        public void Test_IfPointEventsMouseOverRenders_Correct(string value)
        {
            ...
            chart.PlotOptions.Ohlc.Point.Events.MouseOver = value;
        ...
        public void Test_IfPointEventsMouseOverDoesntRenderForDefault_Correct()
        {
            ...
            chart.PlotOptions.Ohlc.Point.Events.MouseOver = defaultValue;
        ...
        public void Test_IfPointEventsRemoveRenders_Correct(string value)
        {
            ...
            chart.PlotOptions.Ohlc.Point.Events.Remove = value;
        ...
        public void Test_IfPointEventsRemoveDoesntRenderForDefault_Correct()
        {
            ...
            chart.PlotOptions.Ohlc.Point.Events.Remove = defaultValue;
        ...
        public void Test_IfPointEventsSelectRenders_Correct(string value)
        {
            ...
            chart.PlotOptions.Ohlc.Point.Events.Select = value;
        ...
        public void Test_IfPointEventsSelectDoesntRenderForDefault_Correct()
        {
            ...
            chart.PlotOptions.Ohlc.Point.Events.Select = defaultValue;
        ...
        public void Test_IfPointEventsUnselectRenders_Correct(string value)
        {
            ...
            chart.PlotOptions.Ohlc.Point.Events.Unselect = value;
        ...
        public void Test_IfPointEventsUnselectDoesntRenderForDefault_Correct()
        {
            ...
            chart.PlotOptions.Ohlc.Point.Events.Unselect = defaultValue;
        ...
        public void Test_IfPointEventsUpdateRenders_Correct(string value)
        {
            ...
            chart.PlotOptions.Ohlc.Point.Events.Update = value;
        ...
        public void Test_IfPointEventsUpdateDoesntRenderForDefault_Correct()
        {
            ...
            chart.PlotOptions.Ohlc.Point.Events.Update = defaultValue;
        ...
        public void Test_IfPointDescriptionFormatterRenders_Correct(string value)
        {
            ...
            chart.PlotOptions.Ohlc.PointDescriptionFormatter = value;
        ...
        public void Test_IfPointDescriptionFormatterDoesntRenderForDefault_Correct()
        {
            ...
            chart.PlotOptions.Ohlc.PointDescriptionFormatter = defaultValue;
        ...
        public void Test_IfRelativeXValueRenders_Correct()
        {
            ...
            chart.PlotOptions.Ohlc.RelativeXValue = value;
        ...
        public void Test_IfRelativeXValueDoesntRenderForDefault_Correct()
        {
            ...
            chart.PlotOptions.Ohlc.RelativeXValue = defaultValue;
        ...
        public void Test_IfSelectedRenders_Correct()
        {
            ...
            chart.PlotOptions.Ohlc.Selected = value;
        ...
        public void Test_IfSelectedDoesntRenderForDefault_Correct()
        {
            ...
            chart.PlotOptions.Ohlc.Selected = defaultValue;
        ...
        public void Test_IfShadowBoolRenders_Correct()
        {
            ...
            chart.PlotOptions.Ohlc.ShadowBool = value;
        ...
        public void Test_IfShadowRenders_Correct(string color, int offsetX, int offsetY, double opacity, int width)
        {
            ...
            chart.PlotOptions.Ohlc.Shadow = new Shadow()
            {
                Color = color,
                OffsetX = offsetX,
                OffsetY = offsetY,
        ...
        public void Test_IfShadowBoolDoesntRenderForDefault_Correct()
        {
            ...
            chart.PlotOptions.Ohlc.ShadowBool = defaultValue;
        ...
        public void Test_IfShowCheckboxRenders_Correct()
        {
            ...
            chart.PlotOptions.Ohlc.ShowCheckbox = value;
        ...
        public void Test_IfShowCheckboxDoesntRenderForDefault_Correct()
        {
            ...
            chart.PlotOptions.Ohlc.ShowCheckbox = defaultValue;
        ...
        public void Test_IfShowInLegendRenders_Correct(bool value)
        {
            ...
            chart.PlotOptions.Ohlc.ShowInLegend = value;
        ...
        public void Test_IfShowInLegendDoesntRenderForDefault_Correct()
        {
            ...
            chart.PlotOptions.Ohlc.ShowInLegend = null;
        ...
        public void Test_IfSkipKeyboardNavigationRenders_Correct(bool value)
        {
            ...
            chart.PlotOptions.Ohlc.SkipKeyboardNavigation = value;
        ...
        public void Test_IfSkipKeyboardNavigationDoesntRenderForDefault_Correct()
        {
            ...
            chart.PlotOptions.Ohlc.SkipKeyboardNavigation = null;
        ...
        public void Test_IfSoftThresholdRenders_Correct()
        {
            ...
            chart.PlotOptions.Ohlc.SoftThreshold = value;
        ...
        public void Test_IfSoftThresholdDoesntRenderForDefault_Correct()
        {
            ...
            chart.PlotOptions.Ohlc.SoftThreshold = defaultValue;
        ...
        //    var chart = new Highstock();
        //    var renderer = new HighstockRenderer(chart);
        //    var pathToProperty = new List<string>() { "plotOptions", "ohlc", "states", "hover", "animation" };

        //    chart.PlotOptions.Ohlc.States.Hover.Animation.Duration = value;
        ...
        public void Test_IfStatesHoverAnimationDurationDoesntRenderForDefault_Correct()
        {
            ...
            chart.PlotOptions.Ohlc.States.Hover.Animation.Duration = defaultValue;
        ...
        public void Test_IfStatesHoverEnabledRenders_Correct()
        {
            var chart = new Highstock();
            var renderer = new HighstockRenderer(chart);
            var pathToProperty = new List<string>() { "plotOptions", "ohlc", "states", "hover" };
            var value = false;

            chart.PlotOptions.Ohlc.States.Hover.Enabled = false;
        ...
        //    chart.PlotOptions.Ohlc.States.Hover.Enabled = defaultValue;
        ...
        //    var chart = new Highstock();
        //    var renderer = new HighstockRenderer(chart);
        //    var pathToProperty = new List<string>() { "plotOptions", "ohlc", "states", "hover", "halo" };

        //    chart.PlotOptions.Ohlc.States.Hover.Halo.Attributes = value;
        ...
        public void Test_IfStatesHoverHaloOpacityRenders_Correct(double value)
        {
            ...
            chart.PlotOptions.Ohlc.States.Hover.Halo.Opacity = value;
        ...
        //    chart.PlotOptions.Ohlc.States.Hover.Halo.Opacity = defaultValue;
        ...
        //    chart.PlotOptions.Ohlc.States.Hover.Halo.Size = value;
        ...
        public void Test_IfStatesHoverLineWidthRenders_Correct(double value)
        {
            ...
            chart.PlotOptions.Ohlc.States.Hover.LineWidth = value;
        ...
        public void Test_IfStatesHoverLineWidthDoesntRenderForDefault_Correct()
        {
            ...
            chart.PlotOptions.Ohlc.States.Hover.LineWidth = defaultValue;
        ...
        public void Test_IfStatesHoverLineWidthPlusRenders_Correct(double value)
        {
            ...
            chart.PlotOptions.Ohlc.States.Hover.LineWidthPlus = value;
        ...
        //    chart.PlotOptions.Ohlc.States.Hover.LineWidthPlus = defaultValue;
        ...
        public void Test_IfStatesHoverMarkerEnabledRenders_Correct(bool value)
        {
            var chart = new Highstock();
            var renderer = new HighstockRenderer(chart);
            var pathToProperty = new List<string> { "plotOptions", "ohlc", "states", "hover", "marker" };

            chart.PlotOptions.Ohlc.States.Hover.Marker.Enabled = value;
        ...
        public void Test_IfStatesHoverMarkerEnabledDoesntRenderForDefault_Correct()
        {
            ...
            chart.PlotOptions.Ohlc.States.Hover.Marker.Enabled = defaultValue;
        ...
        public void Test_IfStatesHoverMarkerEnabledThresholdRenders_Correct(double value)
        {
            ...
            chart.PlotOptions.Ohlc.States.Hover.Marker.EnabledThreshold = value;
        ...
        public void Test_IfStatesHoverMarkerEnabledThresholdDoesntRenderForDefault_Correct()
        {
            ...
            chart.PlotOptions.Ohlc.States.Hover.Marker.EnabledThreshold = defaultValue;
        ...
        public void Test_IfStatesHoverMarkerFillColorRenders_Correct(string value)
        {
            ...
            chart.PlotOptions.Ohlc.States.Hover.Marker.FillColor = value;
        ...
        //    chart.PlotOptions.Ohlc.States.Hover.Marker.FillColor = defaultValue;
        ...
        public void Test_IfStatesHoverMarkerHeightRenders_Correct(double value)
        {
            ...
            chart.PlotOptions.Ohlc.States.Hover.Marker.Height = value;
        ...
        public void Test_IfStatesHoverMarkerHeightDoesntRenderForDefault_Correct()
        {
            ...
            chart.PlotOptions.Ohlc.States.Hover.Marker.Height = defaultValue;
        ...
        public void Test_IfStatesHoverMarkerLineColorRenders_Correct(string value)
        {
            ...
            chart.PlotOptions.Ohlc.States.Hover.Marker.LineColor = value;
        ...
        public void Test_IfStatesHoverMarkerLineColorDoesntRenderForDefault_Correct()
        {
            ...
            chart.PlotOptions.Ohlc.States.Hover.Marker.LineColor = defaultValue;
        ...
        public void Test_IfStatesHoverMarkerLineWidthRenders_Correct(double value)
        {
            ...
            chart.PlotOptions.Ohlc.States.Hover.Marker.LineWidth = value;
        ...
        public void Test_IfStatesHoverMarkerLineWidthDoesntRenderForDefault_Correct()
        {
            ...
            chart.PlotOptions.Ohlc.States.Hover.Marker.LineWidth = defaultValue;
        ...
        public void Test_IfStatesHoverMarkerRadiusRenders_Correct(double value)
        {
            ...
            chart.PlotOptions.Ohlc.States.Hover.Marker.Radius = value;
        ...
        public void Test_IfStatesHoverMarkerRadiusDoesntRenderForDefault_Correct()
        {
            ...
            chart.PlotOptions.Ohlc.States.Hover.Marker.Radius = defaultValue;
        ...
        public void Test_IfStatesHoverMarkerWidthRenders_Correct(double value)
        {
            ...
            chart.PlotOptions.Ohlc.States.Hover.Marker.Width = value;
        ...
        public void Test_IfStatesHoverMarkerWidthDoesntRenderForDefault_Correct()
        {
            ...
            chart.PlotOptions.Ohlc.States.Hover.Marker.Width = defaultValue;
        ...
        //    var chart = new Highstock();
        //    var renderer = new HighstockRenderer(chart);
        //    var pathToProperty = new List<string>() { "plotOptions", "ohlc", "states", "inactive", "animation" };

        //    chart.PlotOptions.Ohlc.States.Inactive.Animation.Duration = value;
        ...
        public void Test_IfStatesInactiveAnimationDurationDoesntRenderForDefault_Correct()
        {
            ...
            chart.PlotOptions.Ohlc.States.Inactive.Animation.Duration = defaultValue;
        ...
        public void Test_IfStatesInactiveEnabledRenders_Correct()
        {
            var chart = new Highstock();
            var renderer = new HighstockRenderer(chart);
            var pathToProperty = new List<string>() { "plotOptions", "ohlc", "states", "inactive" };
            var value = false;

            chart.PlotOptions.Ohlc.States.Inactive.Enabled = false;
        ...
        //    chart.PlotOptions.Ohlc.States.Inactive.Enabled = defaultValue;
        ...
        public void Test_IfStatesInactiveOpacityRenders_Correct(double value)
        {
            ...
            chart.PlotOptions.Ohlc.States.Inactive.Opacity = value;
        ...
        //    chart.PlotOptions.Ohlc.States.Inactive.Opacity = defaultValue;
        ...
        //    var chart = new Highstock();
        //    var renderer = new HighstockRenderer(chart);
        //    var pathToProperty = new List<string>() { "plotOptions", "ohlc", "states", "normal", "animation" };

        //    chart.PlotOptions.Ohlc.States.Normal.Animation.Duration = value;
        ...
        public void Test_IfStatesNormalAnimationDurationDoesntRenderForDefault_Correct()
        {
            ...
            chart.PlotOptions.Ohlc.States.Normal.Animation.Duration = defaultValue;
        ...
        //    var chart = new Highstock();
        //    var renderer = new HighstockRenderer(chart);
        //    var pathToProperty = new List<string>() { "plotOptions", "ohlc", "states", "select", "animation" };

        //    chart.PlotOptions.Ohlc.States.Select.Animation.Duration = value;
        ...
        public void Test_IfStatesSelectAnimationDurationDoesntRenderForDefault_Correct()
        {
            ...
            chart.PlotOptions.Ohlc.States.Select.Animation.Duration = defaultValue;
        ...
        public void Test_IfStatesSelectEnabledRenders_Correct()
        {
            var chart = new Highstock();
            var renderer = new HighstockRenderer(chart);
            var pathToProperty = new List<string>() { "plotOptions", "ohlc", "states", "select" };
            var value = false;

            chart.PlotOptions.Ohlc.States.Select.Enabled = false;
        ...
        //    chart.PlotOptions.Ohlc.States.Select.Enabled = defaultValue;
        ...
        //    var chart = new Highstock();
        //    var renderer = new HighstockRenderer(chart);
        //    var pathToProperty = new List<string>() { "plotOptions", "ohlc", "states", "select", "halo" };

        //    chart.PlotOptions.Ohlc.States.Select.Halo.Attributes = value;
        ...
        public void Test_IfStatesSelectHaloOpacityRenders_Correct(double value)
        {
            ...
            chart.PlotOptions.Ohlc.States.Select.Halo.Opacity = value;
        ...
        //    chart.PlotOptions.Ohlc.States.Select.Halo.Opacity = defaultValue;
        ...
        //    chart.PlotOptions.Ohlc.States.Select.Halo.Size = value;
        ...
        public void Test_IfStatesSelectLineWidthRenders_Correct(double value)
        {
            ...
            chart.PlotOptions.Ohlc.States.Select.LineWidth = value;
        ...
        public void Test_IfStatesSelectLineWidthDoesntRenderForDefault_Correct()
        {
            ...
            chart.PlotOptions.Ohlc.States.Select.LineWidth = defaultValue;
        ...
        public void Test_IfStatesSelectLineWidthPlusRenders_Correct(double value)
        {
            ...
            chart.PlotOptions.Ohlc.States.Select.LineWidthPlus = value;
        ...
        //    chart.PlotOptions.Ohlc.States.Select.LineWidthPlus = defaultValue;
        ...
        public void Test_IfStatesSelectMarkerEnabledRenders_Correct(bool value)
        {
            var chart = new Highstock();
            var renderer = new HighstockRenderer(chart);
            var pathToProperty = new List<string> { "plotOptions", "ohlc", "states", "select", "marker" };

            chart.PlotOptions.Ohlc.States.Select.Marker.Enabled = value;
        ...
        public void Test_IfStatesSelectMarkerEnabledDoesntRenderForDefault_Correct()
        {
            ...
            chart.PlotOptions.Ohlc.States.Select.Marker.Enabled = defaultValue;
        ...
        public void Test_IfStatesSelectMarkerEnabledThresholdRenders_Correct(double value)
        {
            ...
            chart.PlotOptions.Ohlc.States.Select.Marker.EnabledThreshold = value;
        ...
        public void Test_IfStatesSelectMarkerEnabledThresholdDoesntRenderForDefault_Correct()
        {
            ...
            chart.PlotOptions.Ohlc.States.Select.Marker.EnabledThreshold = defaultValue;
        ...
        public void Test_IfStatesSelectMarkerFillColorRenders_Correct(string value)
        {
            ...
            chart.PlotOptions.Ohlc.States.Select.Marker.FillColor = value;
        ...
        //    chart.PlotOptions.Ohlc.States.Select.Marker.FillColor = defaultValue;
        ...
        public void Test_IfStatesSelectMarkerHeightRenders_Correct(double value)
        {
            ...
            chart.PlotOptions.Ohlc.States.Select.Marker.Height = value;
        ...
        public void Test_IfStatesSelectMarkerHeightDoesntRenderForDefault_Correct()
        {
            ...
            chart.PlotOptions.Ohlc.States.Select.Marker.Height = defaultValue;
        ...
        public void Test_IfStatesSelectMarkerLineColorRenders_Correct(string value)
        {
            ...
            chart.PlotOptions.Ohlc.States.Select.Marker.LineColor = value;
        ...
        public void Test_IfStatesSelectMarkerLineColorDoesntRenderForDefault_Correct()
        {
            ...
            chart.PlotOptions.Ohlc.States.Select.Marker.LineColor = defaultValue;
        ...
        public void Test_IfStatesSelectMarkerLineWidthRenders_Correct(double value)
        {
            ...
            chart.PlotOptions.Ohlc.States.Select.Marker.LineWidth = value;
        ...
        public void Test_IfStatesSelectMarkerLineWidthDoesntRenderForDefault_Correct()
        {
            ...
            chart.PlotOptions.Ohlc.States.Select.Marker.LineWidth = defaultValue;
        ...
        public void Test_IfStatesSelectMarkerRadiusRenders_Correct(double value)
        {
            ...
            chart.PlotOptions.Ohlc.States.Select.Marker.Radius = value;
        ...
        public void Test_IfStatesSelectMarkerRadiusDoesntRenderForDefault_Correct()
        {
            ...
            chart.PlotOptions.Ohlc.States.Select.Marker.Radius = defaultValue;
        ...
        public void Test_IfStatesSelectMarkerWidthRenders_Correct(double value)
        {
            ...
            chart.PlotOptions.Ohlc.States.Select.Marker.Width = value;
        ...
        public void Test_IfStatesSelectMarkerWidthDoesntRenderForDefault_Correct()
        {
            ...
            chart.PlotOptions.Ohlc.States.Select.Marker.Width = defaultValue;
        ...
        public void Test_IfStickyTrackingRenders_Correct()
        {
            ...
            chart.PlotOptions.Ohlc.StickyTracking = value;
        ...
        public void Test_IfStickyTrackingDoesntRenderForDefault_Correct()
        {
            ...
            chart.PlotOptions.Ohlc.StickyTracking = defaultValue;
        ...
        public void Test_IfThresholdRenders_Correct(double value)
        {
            ...
            chart.PlotOptions.Ohlc.Threshold = value;
        ...
        public void Test_IfThresholdDoesntRenderForDefault_Correct()
        {
            ...
            chart.PlotOptions.Ohlc.Threshold = defaultValue;
        ...
        public void Test_IfTooltipValueDecimalsRenders_Correct(double value)
        {
            var chart = new Highstock();
            var renderer = new HighstockRenderer(chart);
            var pathToProperty = new List<string>() { "plotOptions", "ohlc", "tooltip" };

            chart.PlotOptions.Ohlc.Tooltip.ValueDecimals = value;
        ...
        public void Test_IfTooltipValueDecimalsDoesntRenderForDefault_Correct()
        {
            ...
            chart.PlotOptions.Ohlc.Tooltip.ValueDecimals = defaultValue;
        ...
        public void Test_IfTurboThresholdTrackingRenders_Correct(double value)
        {
            ...
            chart.PlotOptions.Ohlc.TurboThreshold = value;
        ...
        public void Test_IfTurboThresholdDoesntRenderForDefault_Correct()
        {
            ...
            chart.PlotOptions.Ohlc.TurboThreshold = defaultValue;
        ...
        public void Test_IfVisibleRenders_Correct()
        {
            ...
            chart.PlotOptions.Ohlc.Visible = value;
        ...
        public void Test_IfVisibleDoesntRenderForDefault_Correct()
        {
            ...
            chart.PlotOptions.Ohlc.Visible = defaultValue;
        ...
        public void Test_IfZoneAxisRenders_Correct()
        {
            ...
            chart.PlotOptions.Ohlc.ZoneAxis = value;
        ...
        public void Test_IfZoneAxisDoesntRenderForDefault_Correct()
        {
            ...
            chart.PlotOptions.Ohlc.ZoneAxis = defaultValue;
        ...
        public void Test_IfZonesClassNameRenders_Correct(string value)
        {
            var chart = new Highstock();
            var renderer = new HighstockRenderer(chart);
            var pathToProperty = new List<string>() { "plotOptions", "ohlc", "zones" };
            var zoneDef = new List<PlotOptionsOhlcZone> { new PlotOptionsOhlcZone { ClassName = value } };

            chart.PlotOptions.Ohlc.Zones = zoneDef;
        ...
        public void Test_IfZonesClassNameDoesntRenderForDefault_Correct()
        {
            ...
            var renderer = new HighstockRenderer(chart);
            var defaultValue = string.Empty;
            var zoneDef = new List<PlotOptionsOhlcZone> { new PlotOptionsOhlcZone { ClassName = defaultValue } };
        ...
        public void Test_IfZonesColorRenders_Correct(string value)
        {
            ...
            var renderer = new HighstockRenderer(chart);
            var pathToProperty = new List<string>() { "plotOptions", "ohlc", "zones" };
            var zoneDef = new List<PlotOptionsOhlcZone> { new PlotOptionsOhlcZone { Color = value } };
        ...
        public void Test_IfZonesColorDoesntRenderForDefault_Correct()
        {
            ...
            var renderer = new HighstockRenderer(chart);
            var defaultValue = string.Empty;
            var zoneDef = new List<PlotOptionsOhlcZone> { new PlotOptionsOhlcZone { Color = defaultValue } };
        ...
        [Theory]
        [InlineData(PlotOptionsOhlcZonesDashStyle.Dash)]
        [InlineData(PlotOptionsOhlcZonesDashStyle.DashDot)]
        [InlineData(PlotOptionsOhlcZonesDashStyle.Dot)]
        [InlineData(PlotOptionsOhlcZonesDashStyle.LongDash)]
        [InlineData(PlotOptionsOhlcZonesDashStyle.LongDashDot)]
        [InlineData(PlotOptionsOhlcZonesDashStyle.LongDashDotDot)]
        [InlineData(PlotOptionsOhlcZonesDashStyle.ShortDash)]
        [InlineData(PlotOptionsOhlcZonesDashStyle.ShortDashDot)]
        [InlineData(PlotOptionsOhlcZonesDashStyle.ShortDashDotDot)]
        [InlineData(PlotOptionsOhlcZonesDashStyle.ShortDot)]
        [InlineData(PlotOptionsOhlcZonesDashStyle.Solid)]
        public void Test_IfZonesDashStyleRenders_Correct(PlotOptionsOhlcZonesDashStyle value)
        {
            var chart = new Highstock();
            var renderer = new HighstockRenderer(chart);
            var pathToProperty = new List<string>() { "plotOptions", "ohlc", "zones" };
            var zoneDef = new List<PlotOptionsOhlcZone> { new PlotOptionsOhlcZone { DashStyle = value } };
        ...
        public void Test_IfZonesDashStyleDoesntRenderForDefault_Correct()
        {
            var chart = new Highstock();
            var renderer = new HighstockRenderer(chart);
            var defaultValue = PlotOptionsOhlcZonesDashStyle.Null;
            var zoneDef = new List<PlotOptionsOhlcZone> { new PlotOptionsOhlcZone { DashStyle = defaultValue } };
        ...
        public void Test_IfZonesFillColorRenders_Correct(string value)
        {
            ...
            var renderer = new HighstockRenderer(chart);
            var pathToProperty = new List<string>() { "plotOptions", "ohlc", "zones" };
            var zoneDef = new List<PlotOptionsOhlcZone> { new PlotOptionsOhlcZone { FillColor = value } };
        ...
        //    var renderer = new HighstockRenderer(chart);
        //    var defaultValue = string.Empty;
        //    var zoneDef = new List<PlotOptionsOhlcZone> { new PlotOptionsOhlcZone { FillColor = defaultValue } };
        ...
        public void Test_IfZonesValueRenders_Correct(double value)
        {
            ...
            var renderer = new HighstockRenderer(chart);
            var pathToProperty = new List<string>() { "plotOptions", "ohlc", "zones" };
            var zoneDef = new List<PlotOptionsOhlcZone> { new PlotOptionsOhlcZone { Value = value } };
        ...
        public void Test_IfZonesValueDoesntRenderForDefault_Correct()
        {
            ...
            var renderer = new HighstockRenderer(chart);
            double? defaultValue = null;
            var zoneDef = new List<PlotOptionsOhlcZone> { new PlotOptionsOhlcZone { Value = defaultValue } };
