...
{
    public class PlotOptionsVectorTests : IClassFixture<HsFixture>
    {
        protected HsFixture _fixture;

        public PlotOptionsVectorTests(HsFixture fixture)
        {
            _fixture = fixture;
        ...
        //    chart.PlotOptions.Vector.States.Hover.Enabled = defaultValue;
