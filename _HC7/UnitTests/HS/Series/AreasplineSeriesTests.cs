...
namespace HS.Series
{
    public class AreasplineSeriesTests : IClassFixture<HsFixture>
    {
        protected HsFixture _fixture;

        public AreasplineSeriesTests(HsFixture fixture)
        {
            _fixture = fixture;
        ...
        public void Test_IfAccessibilityEnabledRenders_Correct(bool enabled)
        {
            ...
            var renderer = new HighstockRenderer(chart); var series = new AreasplineSeries(); chart.Series.Add(series);
