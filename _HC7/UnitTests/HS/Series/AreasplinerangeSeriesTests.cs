...
namespace HS.Series
{
    public class AreasplinerangeSeriesTests : IClassFixture<HsFixture>
    {
        protected HsFixture _fixture;

        public AreasplinerangeSeriesTests(HsFixture fixture)
        {
            _fixture = fixture;
        ...
        public void Test_IfAccessibilityEnabledRenders_Correct(bool enabled)
        {
            ...
            var renderer = new HighstockRenderer(chart); var series = new AreasplinerangeSeries(); chart.Series.Add(series);
