...
namespace HS.Series
{
    public class DumbbellSeriesTests : IClassFixture<HsFixture>
    {
        protected HsFixture _fixture;

        public DumbbellSeriesTests(HsFixture fixture)
        {
            _fixture = fixture;
        ...
        public void Test_IfAccessibilityEnabledRenders_Correct(bool enabled)
        {
            ...
            var renderer = new HighstockRenderer(chart); var series = new DumbbellSeries(); chart.Series.Add(series);
