...
namespace HS.Series
{
    public class MfiSeriesTests : IClassFixture<HsFixture>
    {
        ...
        public void Test_IfZonesClassNameRenders_Correct(string value)
        {
            ...
            var zoneDef = new List<MfiSeriesZone> { new MfiSeriesZone { ClassName = value } };
        ...
        public void Test_IfZonesClassNameDoesntRenderForDefault_Correct()
        {
            ...
            var renderer = new HighstockRenderer(chart); var series = new MfiSeries(); chart.Series.Add(series);
            var defaultValue = string.Empty;
            var zoneDef = new List<MfiSeriesZone> { new MfiSeriesZone { ClassName = defaultValue } };
        ...
        public void Test_IfZonesColorRenders_Correct(string value)
        {
            ...
            var renderer = new HighstockRenderer(chart); var series = new MfiSeries(); chart.Series.Add(series);
            var pathToProperty = new List<string>() { "zones" };
            var zoneDef = new List<MfiSeriesZone> { new MfiSeriesZone { Color = value } };
        ...
        public void Test_IfZonesColorDoesntRenderForDefault_Correct()
        {
            ...
            var renderer = new HighstockRenderer(chart); var series = new MfiSeries(); chart.Series.Add(series);
            var defaultValue = string.Empty;
            var zoneDef = new List<MfiSeriesZone> { new MfiSeriesZone { Color = defaultValue } };
        ...
        public void Test_IfZonesDashStyleRenders_Correct(MfiSeriesZonesDashStyle value)
        {
            ...
            var renderer = new HighstockRenderer(chart); var series = new MfiSeries(); chart.Series.Add(series);
            var pathToProperty = new List<string>() { "zones" };
            var zoneDef = new List<MfiSeriesZone> { new MfiSeriesZone { DashStyle = value } };
        ...
        public void Test_IfZonesDashStyleDoesntRenderForDefault_Correct()
        {
            ...
            var zoneDef = new List<MfiSeriesZone> { new MfiSeriesZone { DashStyle = defaultValue } };
        ...
        public void Test_IfZonesFillColorRenders_Correct(string value)
        {
            ...
            var renderer = new HighstockRenderer(chart); var series = new MfiSeries(); chart.Series.Add(series);
            var pathToProperty = new List<string>() { "zones" };
            var zoneDef = new List<MfiSeriesZone> { new MfiSeriesZone { FillColor = value } };
        ...
        //    var renderer = new HighstockRenderer(chart); var series = new MfiSeries(); chart.Series.Add(series);
        //    var defaultValue = string.Empty;
        //    var zoneDef = new List<MfiSeriesZone> { new MfiSeriesZone { FillColor = defaultValue } };
        ...
        public void Test_IfZonesValueRenders_Correct(double value)
        {
            ...
            var renderer = new HighstockRenderer(chart); var series = new MfiSeries(); chart.Series.Add(series);
            var pathToProperty = new List<string>() { "zones" };
            var zoneDef = new List<MfiSeriesZone> { new MfiSeriesZone { Value = value } };
        ...
        public void Test_IfZonesValueDoesntRenderForDefault_Correct()
        {
            ...
            var renderer = new HighstockRenderer(chart); var series = new MfiSeries(); chart.Series.Add(series);
            double? defaultValue = null;
            var zoneDef = new List<MfiSeriesZone> { new MfiSeriesZone { Value = defaultValue } };
