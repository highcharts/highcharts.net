...
namespace HS.Series
{
    public class VectorSeriesTests : IClassFixture<HsFixture>
    {
        protected HsFixture _fixture;

        public VectorSeriesTests(HsFixture fixture)
        {
            _fixture = fixture;
        ...
        public void Test_IfAccessibilityEnabledRenders_Correct(bool enabled)
        {
            ...
            var renderer = new HighstockRenderer(chart); var series = new VectorSeries(); chart.Series.Add(series);
