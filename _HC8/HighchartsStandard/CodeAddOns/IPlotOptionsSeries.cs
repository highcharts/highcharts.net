...
{
	public interface IPlotOptionsSeries
	{

		/// <summary>
		/// Accessibility options for a series.
		/// </summary>
		PlotOptionsSeriesAccessibility Accessibility { get; set; }
		...
		/// </summary>
		PlotOptionsSeriesBoostBlending BoostBlending { get; set; }
		...
		/// </summary>
		PlotOptionsSeriesCursor Cursor { get; set; }
		...
		/// </summary>
		PlotOptionsSeriesDashStyle DashStyle { get; set; }
		...
		/// </summary>
		PlotOptionsSeriesDataLabels DataLabels { get; set; }
		
		/// <summary>
		/// Options for the series data sorting.
		/// </summary>
		PlotOptionsSeriesDataSorting DataSorting { get; set; }
		...
		/// </summary>
		PlotOptionsSeriesDragDrop DragDrop { get; set; }
		...
		/// </summary>
		PlotOptionsSeriesEvents Events { get; set; }
		...
		/// </summary>
		PlotOptionsSeriesFindNearestPointBy FindNearestPointBy { get; set; }
		...
		/// </summary>
		PlotOptionsSeriesLabel Label { get; set; }

		/// <summary>
		/// The line cap used for line ends and line joins on the graph.
		/// </summary>
		PlotOptionsSeriesLinecap Linecap { get; set; }
		...
		/// </summary>
		PlotOptionsSeriesMarker Marker { get; set; }
		...
		/// </summary>
		PlotOptionsSeriesPoint Point { get; set; }
		...
		/// </summary>
		 PlotOptionsSeriesPointIntervalUnit PointIntervalUnit { get; set; }
		...
		/// </summary>
		 PlotOptionsSeriesStacking Stacking { get; set; }

		/// <summary>
		/// 
		/// </summary>
		 PlotOptionsSeriesStates States { get; set; }

		/// <summary>
		/// Whether to apply steps to the line. Possible values are `left`,`center` and `right`.
		/// </summary>
		 PlotOptionsSeriesStep Step { get; set; }
		...
		/// </summary>
		 PlotOptionsSeriesTooltip Tooltip { get; set; }
		...
		/// </summary>
		 List<PlotOptionsSeriesZone> Zones { get; set; }
