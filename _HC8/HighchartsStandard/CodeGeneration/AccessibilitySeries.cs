...
namespace Highsoft.Web.Mvc.Charts
{
	public partial class AccessibilitySeries  : BaseObject
	{
		...
		internal override Hashtable ToHashtable()
		{
			...
			if (DescriptionFormatter != DescriptionFormatter_DefaultValue) { h.Add("descriptionFormatter",DescriptionFormatter); Highcharts.AddFunction("223a5a55-bdba-4139-acd1-a5804e2a041f.descriptionFormatter", DescriptionFormatter); }  
