...
namespace Highsoft.Web.Mvc.Charts
{
	public partial class AnnotationsLabelOptions  : BaseObject
	{
		...
		{
			Accessibility = Accessibility_DefaultValue = new AnnotationsLabelOptionsAccessibility();
		...
		internal override Hashtable ToHashtable()
		{
			...
			if (Formatter != Formatter_DefaultValue) { h.Add("formatter",Formatter); Highcharts.AddFunction("82deb3bf-21fa-4b56-9e53-73ac4ebdc398.formatter", Formatter); }  
