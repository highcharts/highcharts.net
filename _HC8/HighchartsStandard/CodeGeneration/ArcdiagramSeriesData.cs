...
namespace Highsoft.Web.Mvc.Charts
{
	public partial class ArcdiagramSeriesData  : BaseObject
	{
		...
		{
			Accessibility = Accessibility_DefaultValue = new ArcdiagramSeriesDataAccessibility();
			ClassName = ClassName_DefaultValue = "";
			Color = Color_DefaultValue = "";
			ColorIndex = ColorIndex_DefaultValue = null;
			Custom = Custom_DefaultValue = new Hashtable();
			Description = Description_DefaultValue = "";
			DragDrop = DragDrop_DefaultValue = new ArcdiagramSeriesDataDragDrop();
			Drilldown = Drilldown_DefaultValue = "";
			Events = Events_DefaultValue = new ArcdiagramSeriesDataEvents();
			From = From_DefaultValue = "";
			Id = Id_DefaultValue = "";
			Labelrank = Labelrank_DefaultValue = null;
			Marker = Marker_DefaultValue = new ArcdiagramSeriesDataMarker();
		...
		private ArcdiagramSeriesDataAccessibility Accessibility_DefaultValue { get; set; }
		...
		/// </summary>
		public ArcdiagramSeriesDataDragDrop DragDrop { get; set; }
		private ArcdiagramSeriesDataDragDrop DragDrop_DefaultValue { get; set; }
		...
		private ArcdiagramSeriesDataEvents Events_DefaultValue { get; set; }
		...
		/// </summary>
		public ArcdiagramSeriesDataMarker Marker { get; set; }
		private ArcdiagramSeriesDataMarker Marker_DefaultValue { get; set; }
