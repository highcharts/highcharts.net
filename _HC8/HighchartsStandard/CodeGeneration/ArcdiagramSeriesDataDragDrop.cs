...
{
	public partial class ArcdiagramSeriesDataDragDrop  : BaseObject
	{
		Hashtable h = new Hashtable();

		public ArcdiagramSeriesDataDragDrop()
		{
			...
			GuideBox = GuideBox_DefaultValue = new ArcdiagramSeriesDataDragDropGuideBox();
		...
		/// </summary>
		public ArcdiagramSeriesDataDragDropGuideBox GuideBox { get; set; }
		private ArcdiagramSeriesDataDragDropGuideBox GuideBox_DefaultValue { get; set; }
