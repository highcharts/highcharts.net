...
{
	public partial class ArcdiagramSeriesDataMarker  : BaseObject
	{
		Hashtable h = new Hashtable();

		public ArcdiagramSeriesDataMarker()
		{
			...
			States = States_DefaultValue = new ArcdiagramSeriesDataMarkerStates();
		...
		/// </summary>
		public ArcdiagramSeriesDataMarkerStates States { get; set; }
		private ArcdiagramSeriesDataMarkerStates States_DefaultValue { get; set; }
