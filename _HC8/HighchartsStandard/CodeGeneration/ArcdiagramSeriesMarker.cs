...
{
	public partial class ArcdiagramSeriesMarker  : BaseObject
	{
		Hashtable h = new Hashtable();

		public ArcdiagramSeriesMarker()
		{
			...
			States = States_DefaultValue = new ArcdiagramSeriesMarkerStates();
		...
		/// </summary>
		public ArcdiagramSeriesMarkerStates States { get; set; }
		private ArcdiagramSeriesMarkerStates States_DefaultValue { get; set; }
