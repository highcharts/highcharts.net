...
{
	public partial class ArcdiagramSeriesOnPoint  : BaseObject
	{
		Hashtable h = new Hashtable();

		public ArcdiagramSeriesOnPoint()
		{
			ConnectorOptions = ConnectorOptions_DefaultValue = new ArcdiagramSeriesOnPointConnectorOptions();
			Id = Id_DefaultValue = "";
			Position = Position_DefaultValue = new ArcdiagramSeriesOnPointPosition();
		...
		/// </summary>
		public ArcdiagramSeriesOnPointConnectorOptions ConnectorOptions { get; set; }
		private ArcdiagramSeriesOnPointConnectorOptions ConnectorOptions_DefaultValue { get; set; }
		...
		/// </summary>
		public ArcdiagramSeriesOnPointPosition Position { get; set; }
		private ArcdiagramSeriesOnPointPosition Position_DefaultValue { get; set; }
