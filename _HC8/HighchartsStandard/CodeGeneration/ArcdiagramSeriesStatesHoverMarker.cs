...
{
	public partial class ArcdiagramSeriesStatesHoverMarker  : BaseObject
	{
		Hashtable h = new Hashtable();

		public ArcdiagramSeriesStatesHoverMarker()
		{
			...
			States = States_DefaultValue = new ArcdiagramSeriesStatesHoverMarkerStates();
		...
		/// </summary>
		public ArcdiagramSeriesStatesHoverMarkerStates States { get; set; }
		private ArcdiagramSeriesStatesHoverMarkerStates States_DefaultValue { get; set; }
