...
{
	public partial class ArcdiagramSeriesStatesSelectMarker  : BaseObject
	{
		Hashtable h = new Hashtable();

		public ArcdiagramSeriesStatesSelectMarker()
		{
			...
			States = States_DefaultValue = new ArcdiagramSeriesStatesSelectMarkerStates();
		...
		/// </summary>
		public ArcdiagramSeriesStatesSelectMarkerStates States { get; set; }
		private ArcdiagramSeriesStatesSelectMarkerStates States_DefaultValue { get; set; }
