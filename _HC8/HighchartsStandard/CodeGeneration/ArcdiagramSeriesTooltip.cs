...
{
	public partial class ArcdiagramSeriesTooltip  : BaseObject
	{
		Hashtable h = new Hashtable();

		public ArcdiagramSeriesTooltip()
		{
			...
			HeaderShape = HeaderShape_DefaultValue = ArcdiagramSeriesTooltipHeaderShape.Callout;
		...
		/// </summary>
		public ArcdiagramSeriesTooltipHeaderShape HeaderShape { get; set; }
		private ArcdiagramSeriesTooltipHeaderShape HeaderShape_DefaultValue { get; set; }
