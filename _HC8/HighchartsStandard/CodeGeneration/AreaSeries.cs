...
namespace Highsoft.Web.Mvc.Charts
{
	public partial class AreaSeries  : Series
	{
		...
		internal override Hashtable ToHashtable()
		{
			...
			if (PointDescriptionFormatter != PointDescriptionFormatter_DefaultValue) { h.Add("pointDescriptionFormatter",PointDescriptionFormatter); Highcharts.AddFunction("e21c1806-d187-46ed-a990-cdd6c847de09.pointDescriptionFormatter", PointDescriptionFormatter); }  
