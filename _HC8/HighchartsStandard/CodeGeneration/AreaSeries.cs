...
namespace Highsoft.Web.Mvc.Charts
{
	public partial class AreaSeries  : Series
	{
		...
		internal override Hashtable ToHashtable()
		{
			...
			if (PointDescriptionFormatter != PointDescriptionFormatter_DefaultValue) { h.Add("pointDescriptionFormatter",PointDescriptionFormatter); Highcharts.AddFunction("eba0215f-ba4f-4635-acab-8c8b7900511b.pointDescriptionFormatter", PointDescriptionFormatter); }  
