...
{
	public partial class AreaSeriesDataDragDrop  : BaseObject
	{
		Hashtable h = new Hashtable();

		public AreaSeriesDataDragDrop()
		{
			DraggableX = DraggableX_DefaultValue = null;
			DraggableY = DraggableY_DefaultValue = null;
			DragHandle = DragHandle_DefaultValue = new AreaSeriesDataDragDropDragHandle();
			...
			GuideBox = GuideBox_DefaultValue = new AreaSeriesDataDragDropGuideBox();
		...
		/// </summary>
		public AreaSeriesDataDragDropDragHandle DragHandle { get; set; }
		private AreaSeriesDataDragDropDragHandle DragHandle_DefaultValue { get; set; }
		...
		/// </summary>
		public AreaSeriesDataDragDropGuideBox GuideBox { get; set; }
		private AreaSeriesDataDragDropGuideBox GuideBox_DefaultValue { get; set; }
