...
namespace Highsoft.Web.Mvc.Charts
{
	public partial class AreaSeriesDataDragDropDragHandle  : BaseObject
	{
		...
		internal override Hashtable ToHashtable()
		{
			...
			if (PathFormatter != PathFormatter_DefaultValue) { h.Add("pathFormatter",PathFormatter); Highcharts.AddFunction("ec32fc90-d858-4c54-a737-4429ddc6b5a6.pathFormatter", PathFormatter); }  
