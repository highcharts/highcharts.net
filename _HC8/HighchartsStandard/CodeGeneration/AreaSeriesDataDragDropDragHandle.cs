...
namespace Highsoft.Web.Mvc.Charts
{
	public partial class AreaSeriesDataDragDropDragHandle  : BaseObject
	{
		...
		internal override Hashtable ToHashtable()
		{
			...
			if (PathFormatter != PathFormatter_DefaultValue) { h.Add("pathFormatter",PathFormatter); Highcharts.AddFunction("2bd16942-9722-43c7-bbdf-0ca7ee51bd41.pathFormatter", PathFormatter); }  
