...
namespace Highsoft.Web.Mvc.Charts
{
	public partial class AreaSeriesDataLabels  : BaseObject
	{
		...
		public AreaSeriesDataLabels()
		{
			...
			Filter = Filter_DefaultValue = new AreaSeriesDataLabelsFilter();
			...
			Style = Style_DefaultValue = new AreaSeriesDataLabelsStyle();
			TextPath = TextPath_DefaultValue = new AreaSeriesDataLabelsTextPath();
			UseHTML = UseHTML_DefaultValue = false;
			VerticalAlign = VerticalAlign_DefaultValue = AreaSeriesDataLabelsVerticalAlign.Bottom;
			X = X_DefaultValue = 0;
			Y = Y_DefaultValue = 0;
			Z = Z_DefaultValue = 6;
		...
		/// </summary>
		public AreaSeriesDataLabelsFilter Filter { get; set; }
		private AreaSeriesDataLabelsFilter Filter_DefaultValue { get; set; }
		...
		/// </summary>
		public AreaSeriesDataLabelsStyle Style { get; set; }
		private AreaSeriesDataLabelsStyle Style_DefaultValue { get; set; }
		...
		/// </summary>
		public AreaSeriesDataLabelsTextPath TextPath { get; set; }
		private AreaSeriesDataLabelsTextPath TextPath_DefaultValue { get; set; }
		...
		internal override Hashtable ToHashtable()
		{
			...
			if (Formatter != Formatter_DefaultValue) { h.Add("formatter",Formatter); Highcharts.AddFunction("0b81a2cf-a314-40d0-aa66-c6856467e2e1.formatter", Formatter); }  
			...
			if (NullFormatter != NullFormatter_DefaultValue) { h.Add("nullFormatter",NullFormatter); Highcharts.AddFunction("9ec522a2-7c34-4a5b-bb86-cd08661e66d3.nullFormatter", NullFormatter); }  
