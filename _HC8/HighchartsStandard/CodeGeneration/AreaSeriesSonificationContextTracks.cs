...
{
	public partial class AreaSeriesSonificationContextTracks  : BaseObject
	{
		Hashtable h = new Hashtable();

		public AreaSeriesSonificationContextTracks()
		{
			ActiveWhen = ActiveWhen_DefaultValue = new AreaSeriesSonificationContextTracksActiveWhen();
			Instrument = Instrument_DefaultValue = null;
			InstrumentString = InstrumentString_DefaultValue = "null";
			Mapping = Mapping_DefaultValue = new AreaSeriesSonificationContextTracksMapping();
			MidiName = MidiName_DefaultValue = "";
			PointGrouping = PointGrouping_DefaultValue = new AreaSeriesSonificationContextTracksPointGrouping();
			...
			Type = Type_DefaultValue = AreaSeriesSonificationContextTracksType.Instrument;
			ValueInterval = ValueInterval_DefaultValue = null;
			ValueMapFunction = ValueMapFunction_DefaultValue = AreaSeriesSonificationContextTracksValueMapFunction.Linear;
		...
		/// </summary>
		public AreaSeriesSonificationContextTracksActiveWhen ActiveWhen { get; set; }
		private AreaSeriesSonificationContextTracksActiveWhen ActiveWhen_DefaultValue { get; set; }
		...
		/// </summary>
		public AreaSeriesSonificationContextTracksMapping Mapping { get; set; }
		private AreaSeriesSonificationContextTracksMapping Mapping_DefaultValue { get; set; }
		...
		/// </summary>
		public AreaSeriesSonificationContextTracksPointGrouping PointGrouping { get; set; }
		private AreaSeriesSonificationContextTracksPointGrouping PointGrouping_DefaultValue { get; set; }
		...
		/// </summary>
		public AreaSeriesSonificationContextTracksType Type { get; set; }
		private AreaSeriesSonificationContextTracksType Type_DefaultValue { get; set; }
		...
		/// </summary>
		public AreaSeriesSonificationContextTracksValueMapFunction ValueMapFunction { get; set; }
		private AreaSeriesSonificationContextTracksValueMapFunction ValueMapFunction_DefaultValue { get; set; }
