...
{
	public partial class AreaSeriesStatesSelectMarker  : BaseObject
	{
		Hashtable h = new Hashtable();

		public AreaSeriesStatesSelectMarker()
		{
			...
			States = States_DefaultValue = new AreaSeriesStatesSelectMarkerStates();
		...
		/// </summary>
		public AreaSeriesStatesSelectMarkerStates States { get; set; }
		private AreaSeriesStatesSelectMarkerStates States_DefaultValue { get; set; }
