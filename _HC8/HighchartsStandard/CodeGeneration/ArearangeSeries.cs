...
namespace Highsoft.Web.Mvc.Charts
{
	public partial class ArearangeSeries  : Series
	{
		...
		internal override Hashtable ToHashtable()
		{
			...
			if (PointDescriptionFormatter != PointDescriptionFormatter_DefaultValue) { h.Add("pointDescriptionFormatter",PointDescriptionFormatter); Highcharts.AddFunction("a4baeb0f-33f6-402f-921f-f610c50fd5ad.pointDescriptionFormatter", PointDescriptionFormatter); }  
