...
namespace Highsoft.Web.Mvc.Charts
{
	public partial class ArearangeSeries  : Series
	{
		...
		internal override Hashtable ToHashtable()
		{
			...
			if (PointDescriptionFormatter != PointDescriptionFormatter_DefaultValue) { h.Add("pointDescriptionFormatter",PointDescriptionFormatter); Highcharts.AddFunction("829cc62e-ad22-4951-87b2-4938e9f1f540.pointDescriptionFormatter", PointDescriptionFormatter); }  
