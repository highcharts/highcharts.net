...
namespace Highsoft.Web.Mvc.Charts
{
	public partial class ArearangeSeries  : Series
	{
		...
		internal override Hashtable ToHashtable()
		{
			...
			if (PointDescriptionFormatter != PointDescriptionFormatter_DefaultValue) { h.Add("pointDescriptionFormatter",PointDescriptionFormatter); Highcharts.AddFunction("6fb786e5-a198-410b-ab7a-ee81503bb9d9.pointDescriptionFormatter", PointDescriptionFormatter); }  
