...
namespace Highsoft.Web.Mvc.Charts
{
	public partial class ArearangeSeriesDataDragDropDragHandle  : BaseObject
	{
		...
		internal override Hashtable ToHashtable()
		{
			...
			if (PathFormatter != PathFormatter_DefaultValue) { h.Add("pathFormatter",PathFormatter); Highcharts.AddFunction("ecd78ea2-aa2d-4fbf-a396-ff1ab3fb187a.pathFormatter", PathFormatter); }  
