...
namespace Highsoft.Web.Mvc.Charts
{
	public partial class ArearangeSeriesDataDragDropDragHandle  : BaseObject
	{
		...
		internal override Hashtable ToHashtable()
		{
			...
			if (PathFormatter != PathFormatter_DefaultValue) { h.Add("pathFormatter",PathFormatter); Highcharts.AddFunction("e2e7b58e-95b0-4db9-871a-3cf25754a8d4.pathFormatter", PathFormatter); }  
