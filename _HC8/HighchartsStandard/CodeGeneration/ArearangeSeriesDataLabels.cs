...
namespace Highsoft.Web.Mvc.Charts
{
	public partial class ArearangeSeriesDataLabels  : BaseObject
	{
		...
		internal override Hashtable ToHashtable()
		{
			...
			if (Formatter != Formatter_DefaultValue) { h.Add("formatter",Formatter); Highcharts.AddFunction("9f634769-7ed3-4183-bd97-76257fe2ef6c.formatter", Formatter); }  
			...
			if (NullFormatter != NullFormatter_DefaultValue) { h.Add("nullFormatter",NullFormatter); Highcharts.AddFunction("a85ab02f-626c-40ff-a557-fba3dab7bea9.nullFormatter", NullFormatter); }  
