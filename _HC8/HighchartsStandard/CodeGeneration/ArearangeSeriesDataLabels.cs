...
{
	public partial class ArearangeSeriesDataLabels  : BaseObject
	{
		...
		public ArearangeSeriesDataLabels()
		{
			...
			Filter = Filter_DefaultValue = new ArearangeSeriesDataLabelsFilter();
			...
			Style = Style_DefaultValue = new ArearangeSeriesDataLabelsStyle();
			TextPath = TextPath_DefaultValue = new ArearangeSeriesDataLabelsTextPath();
		...
		private ArearangeSeriesDataLabelsAlign Align_DefaultValue { get; set; }
		...
		/// </summary>
		public ArearangeSeriesDataLabelsFilter Filter { get; set; }
		private ArearangeSeriesDataLabelsFilter Filter_DefaultValue { get; set; }
		...
		/// </summary>
		public ArearangeSeriesDataLabelsStyle Style { get; set; }
		private ArearangeSeriesDataLabelsStyle Style_DefaultValue { get; set; }
		...
		/// </summary>
		public ArearangeSeriesDataLabelsTextPath TextPath { get; set; }
		private ArearangeSeriesDataLabelsTextPath TextPath_DefaultValue { get; set; }
		...
		internal override Hashtable ToHashtable()
		{
			...
			if (Formatter != Formatter_DefaultValue) { h.Add("formatter",Formatter); Highcharts.AddFunction("365e3d33-1c66-4de8-bd65-fd67c38a87a1.formatter", Formatter); }  
			...
			if (NullFormatter != NullFormatter_DefaultValue) { h.Add("nullFormatter",NullFormatter); Highcharts.AddFunction("ade670e1-1d4e-4935-b477-9d2e5d49a82f.nullFormatter", NullFormatter); }  
