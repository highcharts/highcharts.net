...
{
	public partial class ArearangeSeriesSonificationContextTracks  : BaseObject
	{
		Hashtable h = new Hashtable();

		public ArearangeSeriesSonificationContextTracks()
		{
			ActiveWhen = ActiveWhen_DefaultValue = new ArearangeSeriesSonificationContextTracksActiveWhen();
			Instrument = Instrument_DefaultValue = null;
			InstrumentString = InstrumentString_DefaultValue = "null";
			Mapping = Mapping_DefaultValue = new ArearangeSeriesSonificationContextTracksMapping();
			MidiName = MidiName_DefaultValue = "";
			PointGrouping = PointGrouping_DefaultValue = new ArearangeSeriesSonificationContextTracksPointGrouping();
			...
			Type = Type_DefaultValue = ArearangeSeriesSonificationContextTracksType.Instrument;
			ValueInterval = ValueInterval_DefaultValue = null;
			ValueMapFunction = ValueMapFunction_DefaultValue = ArearangeSeriesSonificationContextTracksValueMapFunction.Linear;
		...
		/// </summary>
		public ArearangeSeriesSonificationContextTracksActiveWhen ActiveWhen { get; set; }
		private ArearangeSeriesSonificationContextTracksActiveWhen ActiveWhen_DefaultValue { get; set; }
		...
		/// </summary>
		public ArearangeSeriesSonificationContextTracksMapping Mapping { get; set; }
		private ArearangeSeriesSonificationContextTracksMapping Mapping_DefaultValue { get; set; }
		...
		/// </summary>
		public ArearangeSeriesSonificationContextTracksPointGrouping PointGrouping { get; set; }
		private ArearangeSeriesSonificationContextTracksPointGrouping PointGrouping_DefaultValue { get; set; }
		...
		/// </summary>
		public ArearangeSeriesSonificationContextTracksType Type { get; set; }
		private ArearangeSeriesSonificationContextTracksType Type_DefaultValue { get; set; }
		...
		/// </summary>
		public ArearangeSeriesSonificationContextTracksValueMapFunction ValueMapFunction { get; set; }
		private ArearangeSeriesSonificationContextTracksValueMapFunction ValueMapFunction_DefaultValue { get; set; }
