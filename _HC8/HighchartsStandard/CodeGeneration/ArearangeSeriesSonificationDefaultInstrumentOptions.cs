...
{
	public partial class ArearangeSeriesSonificationDefaultInstrumentOptions  : BaseObject
	{
		Hashtable h = new Hashtable();

		public ArearangeSeriesSonificationDefaultInstrumentOptions()
		{
			ActiveWhen = ActiveWhen_DefaultValue = new ArearangeSeriesSonificationDefaultInstrumentOptionsActiveWhen();
			Instrument = Instrument_DefaultValue = null;
			InstrumentString = InstrumentString_DefaultValue = "null";
			Mapping = Mapping_DefaultValue = new ArearangeSeriesSonificationDefaultInstrumentOptionsMapping();
			MidiName = MidiName_DefaultValue = "";
			PointGrouping = PointGrouping_DefaultValue = new ArearangeSeriesSonificationDefaultInstrumentOptionsPointGrouping();
			RoundToMusicalNotes = RoundToMusicalNotes_DefaultValue = true;
			ShowPlayMarker = ShowPlayMarker_DefaultValue = true;
			Type = Type_DefaultValue = ArearangeSeriesSonificationDefaultInstrumentOptionsType.Instrument;
		...
		/// </summary>
		public ArearangeSeriesSonificationDefaultInstrumentOptionsActiveWhen ActiveWhen { get; set; }
		private ArearangeSeriesSonificationDefaultInstrumentOptionsActiveWhen ActiveWhen_DefaultValue { get; set; }
		...
		/// </summary>
		public ArearangeSeriesSonificationDefaultInstrumentOptionsMapping Mapping { get; set; }
		private ArearangeSeriesSonificationDefaultInstrumentOptionsMapping Mapping_DefaultValue { get; set; }
		...
		/// </summary>
		public ArearangeSeriesSonificationDefaultInstrumentOptionsPointGrouping PointGrouping { get; set; }
		private ArearangeSeriesSonificationDefaultInstrumentOptionsPointGrouping PointGrouping_DefaultValue { get; set; }
		...
		/// </summary>
		public ArearangeSeriesSonificationDefaultInstrumentOptionsType Type { get; set; }
		private ArearangeSeriesSonificationDefaultInstrumentOptionsType Type_DefaultValue { get; set; }
