...
namespace Highsoft.Web.Mvc.Charts
{
	public partial class AreasplineSeriesAccessibility  : BaseObject
	{
		...
		internal override Hashtable ToHashtable()
		{
			...
			if (PointDescriptionFormatter != PointDescriptionFormatter_DefaultValue) { h.Add("pointDescriptionFormatter",PointDescriptionFormatter); Highcharts.AddFunction("5eb26773-ff6e-4441-bd98-082e891c74c0.pointDescriptionFormatter", PointDescriptionFormatter); }  
