...
namespace Highsoft.Web.Mvc.Charts
{
	public partial class AreasplineSeriesAccessibility  : BaseObject
	{
		...
		internal override Hashtable ToHashtable()
		{
			...
			if (PointDescriptionFormatter != PointDescriptionFormatter_DefaultValue) { h.Add("pointDescriptionFormatter",PointDescriptionFormatter); Highcharts.AddFunction("f61263a5-9fb7-4632-bf0e-09eddf850015.pointDescriptionFormatter", PointDescriptionFormatter); }  
