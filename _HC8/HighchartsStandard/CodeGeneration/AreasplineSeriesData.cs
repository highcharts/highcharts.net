...
namespace Highsoft.Web.Mvc.Charts
{
	public partial class AreasplineSeriesData  : BaseObject
	{
		...
		{
			Accessibility = Accessibility_DefaultValue = new AreasplineSeriesDataAccessibility();
			...
			DragDrop = DragDrop_DefaultValue = new AreasplineSeriesDataDragDrop();
		...
		/// </summary>
		public AreasplineSeriesDataAccessibility Accessibility { get; set; }
		private AreasplineSeriesDataAccessibility Accessibility_DefaultValue { get; set; }
		...
		/// </summary>
		public AreasplineSeriesDataDragDrop DragDrop { get; set; }
		private AreasplineSeriesDataDragDrop DragDrop_DefaultValue { get; set; }
