...
namespace Highsoft.Web.Mvc.Charts
{
	public partial class AreasplineSeriesDataDragDropDragHandle  : BaseObject
	{
		...
		internal override Hashtable ToHashtable()
		{
			...
			if (PathFormatter != PathFormatter_DefaultValue) { h.Add("pathFormatter",PathFormatter); Highcharts.AddFunction("3ebdf7bf-cf65-498e-b2e7-f6ea653dcf60.pathFormatter", PathFormatter); }  
