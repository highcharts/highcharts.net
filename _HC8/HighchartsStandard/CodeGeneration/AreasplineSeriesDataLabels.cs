...
namespace Highsoft.Web.Mvc.Charts
{
	public partial class AreasplineSeriesDataLabels  : BaseObject
	{
		...
		public AreasplineSeriesDataLabels()
		{
			...
			TextPath = TextPath_DefaultValue = new AreasplineSeriesDataLabelsTextPath();
		...
		internal override Hashtable ToHashtable()
		{
			...
			if (Formatter != Formatter_DefaultValue) { h.Add("formatter",Formatter); Highcharts.AddFunction("a8f3113f-b220-4545-98ed-028f949ce923.formatter", Formatter); }  
			...
			if (NullFormatter != NullFormatter_DefaultValue) { h.Add("nullFormatter",NullFormatter); Highcharts.AddFunction("0393132b-ba0d-4135-b6be-aeb4c32110a9.nullFormatter", NullFormatter); }  
