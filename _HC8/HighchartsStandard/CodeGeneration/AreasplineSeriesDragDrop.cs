...
{
	public partial class AreasplineSeriesDragDrop  : BaseObject
	{
		Hashtable h = new Hashtable();

		public AreasplineSeriesDragDrop()
		{
			DraggableX = DraggableX_DefaultValue = null;
			DraggableY = DraggableY_DefaultValue = null;
			DragHandle = DragHandle_DefaultValue = new AreasplineSeriesDragDropDragHandle();
			...
			GuideBox = GuideBox_DefaultValue = new AreasplineSeriesDragDropGuideBox();
		...
		/// </summary>
		public AreasplineSeriesDragDropDragHandle DragHandle { get; set; }
		private AreasplineSeriesDragDropDragHandle DragHandle_DefaultValue { get; set; }
		...
		/// </summary>
		public AreasplineSeriesDragDropGuideBox GuideBox { get; set; }
		private AreasplineSeriesDragDropGuideBox GuideBox_DefaultValue { get; set; }
