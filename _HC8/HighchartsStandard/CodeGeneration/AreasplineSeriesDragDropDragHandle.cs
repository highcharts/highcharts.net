...
namespace Highsoft.Web.Mvc.Charts
{
	public partial class AreasplineSeriesDragDropDragHandle  : BaseObject
	{
		...
		internal override Hashtable ToHashtable()
		{
			...
			if (PathFormatter != PathFormatter_DefaultValue) { h.Add("pathFormatter",PathFormatter); Highcharts.AddFunction("cd7ed9ee-9c31-4d34-91ca-4f8a8f942141.pathFormatter", PathFormatter); }  
