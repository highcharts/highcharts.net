...
namespace Highsoft.Web.Mvc.Charts
{
	public partial class AreasplineSeriesDragDropDragHandle  : BaseObject
	{
		...
		internal override Hashtable ToHashtable()
		{
			...
			if (PathFormatter != PathFormatter_DefaultValue) { h.Add("pathFormatter",PathFormatter); Highcharts.AddFunction("539c1b43-52c3-4d11-ac31-669ff5870bf5.pathFormatter", PathFormatter); }  
