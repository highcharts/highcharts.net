...
namespace Highsoft.Web.Mvc.Charts
{
	public partial class AreasplineSeriesDragDropDragHandle  : BaseObject
	{
		...
		internal override Hashtable ToHashtable()
		{
			...
			if (PathFormatter != PathFormatter_DefaultValue) { h.Add("pathFormatter",PathFormatter); Highcharts.AddFunction("068d35a5-b19f-4e26-838d-1541b93286cc.pathFormatter", PathFormatter); }  
