...
{
	public partial class AreasplineSeriesStatesHover  : BaseObject
	{
		...
		public AreasplineSeriesStatesHover()
		{
			...
			Halo = Halo_DefaultValue = new AreasplineSeriesStatesHoverHalo();
			LineWidth = LineWidth_DefaultValue = null;
			LineWidthPlus = LineWidthPlus_DefaultValue = null;
			Marker = Marker_DefaultValue = new AreasplineSeriesStatesHoverMarker();
		...
		/// </summary>
		public AreasplineSeriesStatesHoverHalo Halo { get; set; }
		private AreasplineSeriesStatesHoverHalo Halo_DefaultValue { get; set; }
		...
		/// </summary>
		public AreasplineSeriesStatesHoverMarker Marker { get; set; }
		private AreasplineSeriesStatesHoverMarker Marker_DefaultValue { get; set; }
