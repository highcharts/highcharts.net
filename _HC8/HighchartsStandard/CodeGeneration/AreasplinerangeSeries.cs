...
namespace Highsoft.Web.Mvc.Charts
{
	public partial class AreasplinerangeSeries  : Series
	{
		...
		internal override Hashtable ToHashtable()
		{
			...
			if (PointDescriptionFormatter != PointDescriptionFormatter_DefaultValue) { h.Add("pointDescriptionFormatter",PointDescriptionFormatter); Highcharts.AddFunction("c8b77b38-dd01-431d-ad22-028db2eefc88.pointDescriptionFormatter", PointDescriptionFormatter); }  
