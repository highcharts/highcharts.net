...
namespace Highsoft.Web.Mvc.Charts
{
	public partial class AreasplinerangeSeries  : Series
	{
		...
		internal override Hashtable ToHashtable()
		{
			...
			if (PointDescriptionFormatter != PointDescriptionFormatter_DefaultValue) { h.Add("pointDescriptionFormatter",PointDescriptionFormatter); Highcharts.AddFunction("0a8ca0bb-c310-4a0e-bbc8-741dc365ac65.pointDescriptionFormatter", PointDescriptionFormatter); }  
