...
{
	public partial class AreasplinerangeSeriesData  : BaseObject
	{
		Hashtable h = new Hashtable();

		public AreasplinerangeSeriesData()
		{
			Accessibility = Accessibility_DefaultValue = new AreasplinerangeSeriesDataAccessibility();
			...
			DragDrop = DragDrop_DefaultValue = new AreasplinerangeSeriesDataDragDrop();
			...
			Marker = Marker_DefaultValue = new AreasplinerangeSeriesDataMarker();
		...
		/// </summary>
		public AreasplinerangeSeriesDataAccessibility Accessibility { get; set; }
		private AreasplinerangeSeriesDataAccessibility Accessibility_DefaultValue { get; set; }
		...
		/// </summary>
		public AreasplinerangeSeriesDataDragDrop DragDrop { get; set; }
		private AreasplinerangeSeriesDataDragDrop DragDrop_DefaultValue { get; set; }
		...
		/// </summary>
		public AreasplinerangeSeriesDataMarker Marker { get; set; }
		private AreasplinerangeSeriesDataMarker Marker_DefaultValue { get; set; }
