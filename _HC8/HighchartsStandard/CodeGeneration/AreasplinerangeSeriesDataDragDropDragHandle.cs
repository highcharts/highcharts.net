...
namespace Highsoft.Web.Mvc.Charts
{
	public partial class AreasplinerangeSeriesDataDragDropDragHandle  : BaseObject
	{
		...
		internal override Hashtable ToHashtable()
		{
			...
			if (PathFormatter != PathFormatter_DefaultValue) { h.Add("pathFormatter",PathFormatter); Highcharts.AddFunction("575dfe51-4f75-4e84-b1c3-4bdae8ceaf32.pathFormatter", PathFormatter); }  
