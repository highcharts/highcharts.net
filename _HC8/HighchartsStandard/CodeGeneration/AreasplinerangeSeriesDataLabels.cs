...
namespace Highsoft.Web.Mvc.Charts
{
	public partial class AreasplinerangeSeriesDataLabels  : BaseObject
	{
		...
		public AreasplinerangeSeriesDataLabels()
		{
			...
			Style = Style_DefaultValue = new AreasplinerangeSeriesDataLabelsStyle();
		...
		/// </summary>
		public AreasplinerangeSeriesDataLabelsStyle Style { get; set; }
		private AreasplinerangeSeriesDataLabelsStyle Style_DefaultValue { get; set; }
		...
		internal override Hashtable ToHashtable()
		{
			...
			if (Formatter != Formatter_DefaultValue) { h.Add("formatter",Formatter); Highcharts.AddFunction("68a21678-0c2c-408e-9756-a361b8adb641.formatter", Formatter); }  
			...
			if (NullFormatter != NullFormatter_DefaultValue) { h.Add("nullFormatter",NullFormatter); Highcharts.AddFunction("48d25a75-74c1-4e24-b288-3eb1dc1bd0b5.nullFormatter", NullFormatter); }  
