...
{
	public partial class AreasplinerangeSeriesDataMarker  : BaseObject
	{
		Hashtable h = new Hashtable();

		public AreasplinerangeSeriesDataMarker()
		{
			...
			States = States_DefaultValue = new AreasplinerangeSeriesDataMarkerStates();
		...
		/// </summary>
		public AreasplinerangeSeriesDataMarkerStates States { get; set; }
		private AreasplinerangeSeriesDataMarkerStates States_DefaultValue { get; set; }
