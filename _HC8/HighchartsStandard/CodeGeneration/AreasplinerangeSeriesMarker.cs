...
{
	public partial class AreasplinerangeSeriesMarker  : BaseObject
	{
		Hashtable h = new Hashtable();

		public AreasplinerangeSeriesMarker()
		{
			...
			States = States_DefaultValue = new AreasplinerangeSeriesMarkerStates();
		...
		/// </summary>
		public AreasplinerangeSeriesMarkerStates States { get; set; }
		private AreasplinerangeSeriesMarkerStates States_DefaultValue { get; set; }
