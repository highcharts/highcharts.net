...
{
	public partial class AreasplinerangeSeriesSonificationTracks  : BaseObject
	{
		Hashtable h = new Hashtable();

		public AreasplinerangeSeriesSonificationTracks()
		{
			ActiveWhen = ActiveWhen_DefaultValue = new AreasplinerangeSeriesSonificationTracksActiveWhen();
			Instrument = Instrument_DefaultValue = null;
			InstrumentString = InstrumentString_DefaultValue = "null";
			Mapping = Mapping_DefaultValue = new AreasplinerangeSeriesSonificationTracksMapping();
			MidiName = MidiName_DefaultValue = "";
			PointGrouping = PointGrouping_DefaultValue = new AreasplinerangeSeriesSonificationTracksPointGrouping();
			RoundToMusicalNotes = RoundToMusicalNotes_DefaultValue = true;
			ShowPlayMarker = ShowPlayMarker_DefaultValue = true;
			Type = Type_DefaultValue = AreasplinerangeSeriesSonificationTracksType.Instrument;
		...
		/// </summary>
		public AreasplinerangeSeriesSonificationTracksActiveWhen ActiveWhen { get; set; }
		private AreasplinerangeSeriesSonificationTracksActiveWhen ActiveWhen_DefaultValue { get; set; }
		...
		/// </summary>
		public AreasplinerangeSeriesSonificationTracksMapping Mapping { get; set; }
		private AreasplinerangeSeriesSonificationTracksMapping Mapping_DefaultValue { get; set; }
		...
		/// </summary>
		public AreasplinerangeSeriesSonificationTracksPointGrouping PointGrouping { get; set; }
		private AreasplinerangeSeriesSonificationTracksPointGrouping PointGrouping_DefaultValue { get; set; }
		...
		/// </summary>
		public AreasplinerangeSeriesSonificationTracksType Type { get; set; }
		private AreasplinerangeSeriesSonificationTracksType Type_DefaultValue { get; set; }
