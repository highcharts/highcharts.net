...
{
	public partial class AreasplinerangeSeriesStatesSelectMarkerStatesHoverAnimation  : BaseObject
	{
		Hashtable h = new Hashtable();

		public AreasplinerangeSeriesStatesSelectMarkerStatesHoverAnimation()
		{
