...
namespace Highsoft.Web.Mvc.Charts
{
	public partial class BarSeries  : Series
	{
		...
		internal override Hashtable ToHashtable()
		{
			...
			if (PointDescriptionFormatter != PointDescriptionFormatter_DefaultValue) { h.Add("pointDescriptionFormatter",PointDescriptionFormatter); Highcharts.AddFunction("a2dc8480-9e0e-451f-bfbe-5ecf4140e203.pointDescriptionFormatter", PointDescriptionFormatter); }  
