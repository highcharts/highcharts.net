...
namespace Highsoft.Web.Mvc.Charts
{
	public partial class BarSeries  : Series
	{
		...
		public BarSeries()
		{
			...
			Type = Type_DefaultValue = BarSeriesType.Bar;
		...
		internal override Hashtable ToHashtable()
		{
			...
			if (PointDescriptionFormatter != PointDescriptionFormatter_DefaultValue) { h.Add("pointDescriptionFormatter",PointDescriptionFormatter); Highcharts.AddFunction("c6da6ad2-5ddb-4f14-88e1-2c4c452aa38c.pointDescriptionFormatter", PointDescriptionFormatter); }  
