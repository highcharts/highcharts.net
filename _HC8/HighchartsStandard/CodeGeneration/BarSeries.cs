...
namespace Highsoft.Web.Mvc.Charts
{
	public partial class BarSeries  : Series
	{
		...
		internal override Hashtable ToHashtable()
		{
			...
			if (PointDescriptionFormatter != PointDescriptionFormatter_DefaultValue) { h.Add("pointDescriptionFormatter",PointDescriptionFormatter); Highcharts.AddFunction("cd128825-7d07-48fe-a798-099a4c5e22ba.pointDescriptionFormatter", PointDescriptionFormatter); }  
