...
namespace Highsoft.Web.Mvc.Charts
{
	public partial class BarSeries  : Series
	{
		...
		internal override Hashtable ToHashtable()
		{
			...
			if (PointDescriptionFormatter != PointDescriptionFormatter_DefaultValue) { h.Add("pointDescriptionFormatter",PointDescriptionFormatter); Highcharts.AddFunction("e411498f-f4f2-4edd-bfaf-63bb64a39d43.pointDescriptionFormatter", PointDescriptionFormatter); }  
