...
namespace Highsoft.Web.Mvc.Charts
{
	public partial class BarSeriesAccessibility  : BaseObject
	{
		...
		public BarSeriesAccessibility()
		{
			...
			Point = Point_DefaultValue = new BarSeriesAccessibilityPoint();
		...
		/// </summary>
		public BarSeriesAccessibilityPoint Point { get; set; }
		private BarSeriesAccessibilityPoint Point_DefaultValue { get; set; }
