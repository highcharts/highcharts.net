...
{
	public partial class BarSeriesData  : BaseObject
	{
		Hashtable h = new Hashtable();

		public BarSeriesData()
		{
			Accessibility = Accessibility_DefaultValue = new BarSeriesDataAccessibility();
			...
			DashStyle = DashStyle_DefaultValue = BarSeriesDataDashStyle.Null;
			DataLabels = DataLabels_DefaultValue = new BarSeriesDataLabels();
			Description = Description_DefaultValue = "";
			DragDrop = DragDrop_DefaultValue = new BarSeriesDataDragDrop();
			Drilldown = Drilldown_DefaultValue = "";
			Events = Events_DefaultValue = new BarSeriesDataEvents();
			Id = Id_DefaultValue = "";
			Labelrank = Labelrank_DefaultValue = null;
			Marker = Marker_DefaultValue = new BarSeriesDataMarker();
		...
		/// </summary>
		public BarSeriesDataAccessibility Accessibility { get; set; }
		private BarSeriesDataAccessibility Accessibility_DefaultValue { get; set; }
		...
		/// </summary>
		public BarSeriesDataDashStyle DashStyle { get; set; }
		private BarSeriesDataDashStyle DashStyle_DefaultValue { get; set; }
		...
		/// </summary>
		public BarSeriesDataMarker Marker { get; set; }
		private BarSeriesDataMarker Marker_DefaultValue { get; set; }
