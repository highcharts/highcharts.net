...
namespace Highsoft.Web.Mvc.Charts
{
	public partial class BarSeriesDataDragDropDragHandle  : BaseObject
	{
		...
		internal override Hashtable ToHashtable()
		{
			...
			if (PathFormatter != PathFormatter_DefaultValue) { h.Add("pathFormatter",PathFormatter); Highcharts.AddFunction("32549448-994d-44b4-bf48-b768363a3e4e.pathFormatter", PathFormatter); }  
