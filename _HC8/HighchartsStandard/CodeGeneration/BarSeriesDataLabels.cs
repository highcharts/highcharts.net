...
{
	public partial class BarSeriesDataLabels  : BaseObject
	{
		Hashtable h = new Hashtable();

		public BarSeriesDataLabels()
		{
			Align = Align_DefaultValue = BarSeriesDataLabelsAlign.Center;
			...
			Filter = Filter_DefaultValue = new BarSeriesDataLabelsFilter();
			...
			Style = Style_DefaultValue = new BarSeriesDataLabelsStyle();
			TextPath = TextPath_DefaultValue = new BarSeriesDataLabelsTextPath();
			UseHTML = UseHTML_DefaultValue = false;
			VerticalAlign = VerticalAlign_DefaultValue = BarSeriesDataLabelsVerticalAlign.Bottom;
			X = X_DefaultValue = 0;
			Y = Y_DefaultValue = 0;
			Z = Z_DefaultValue = 6;
		...
		/// </summary>
		public BarSeriesDataLabelsAlign Align { get; set; }
		private BarSeriesDataLabelsAlign Align_DefaultValue { get; set; }
		...
		/// </summary>
		public BarSeriesDataLabelsFilter Filter { get; set; }
		private BarSeriesDataLabelsFilter Filter_DefaultValue { get; set; }
		...
		/// </summary>
		public BarSeriesDataLabelsStyle Style { get; set; }
		private BarSeriesDataLabelsStyle Style_DefaultValue { get; set; }
		...
		/// </summary>
		public BarSeriesDataLabelsTextPath TextPath { get; set; }
		private BarSeriesDataLabelsTextPath TextPath_DefaultValue { get; set; }
		...
		/// </summary>
		public BarSeriesDataLabelsVerticalAlign VerticalAlign { get; set; }
		private BarSeriesDataLabelsVerticalAlign VerticalAlign_DefaultValue { get; set; }
		...
		internal override Hashtable ToHashtable()
		{
			...
			if (Formatter != Formatter_DefaultValue) { h.Add("formatter",Formatter); Highcharts.AddFunction("79f90a7f-239e-4784-9df8-bffbb331a666.formatter", Formatter); }  
			if (Inside != Inside_DefaultValue) h.Add("inside",Inside);
			if (NullFormat != NullFormat_DefaultValue) h.Add("nullFormat",NullFormat);
			if (NullFormatter != NullFormatter_DefaultValue) { h.Add("nullFormatter",NullFormatter); Highcharts.AddFunction("43119eff-cf29-40a7-8f62-6cc5dfa05a16.nullFormatter", NullFormatter); }  
