...
{
	public partial class BarSeriesDataMarker  : BaseObject
	{
		Hashtable h = new Hashtable();

		public BarSeriesDataMarker()
		{
			...
			States = States_DefaultValue = new BarSeriesDataMarkerStates();
		...
		/// </summary>
		public BarSeriesDataMarkerStates States { get; set; }
		private BarSeriesDataMarkerStates States_DefaultValue { get; set; }
