...
{
	public partial class BarSeriesOnPoint  : BaseObject
	{
		Hashtable h = new Hashtable();

		public BarSeriesOnPoint()
		{
			ConnectorOptions = ConnectorOptions_DefaultValue = new BarSeriesOnPointConnectorOptions();
			Id = Id_DefaultValue = "";
			Position = Position_DefaultValue = new BarSeriesOnPointPosition();
		...
		/// </summary>
		public BarSeriesOnPointConnectorOptions ConnectorOptions { get; set; }
		private BarSeriesOnPointConnectorOptions ConnectorOptions_DefaultValue { get; set; }
		...
		/// </summary>
		public BarSeriesOnPointPosition Position { get; set; }
		private BarSeriesOnPointPosition Position_DefaultValue { get; set; }
