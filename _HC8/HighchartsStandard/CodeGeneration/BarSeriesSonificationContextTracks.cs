...
{
	public partial class BarSeriesSonificationContextTracks  : BaseObject
	{
		Hashtable h = new Hashtable();

		public BarSeriesSonificationContextTracks()
		{
			ActiveWhen = ActiveWhen_DefaultValue = new BarSeriesSonificationContextTracksActiveWhen();
			Instrument = Instrument_DefaultValue = null;
			InstrumentString = InstrumentString_DefaultValue = "null";
			Mapping = Mapping_DefaultValue = new BarSeriesSonificationContextTracksMapping();
			MidiName = MidiName_DefaultValue = "";
			PointGrouping = PointGrouping_DefaultValue = new BarSeriesSonificationContextTracksPointGrouping();
			...
			Type = Type_DefaultValue = BarSeriesSonificationContextTracksType.Instrument;
			ValueInterval = ValueInterval_DefaultValue = null;
			ValueMapFunction = ValueMapFunction_DefaultValue = BarSeriesSonificationContextTracksValueMapFunction.Linear;
		...
		/// </summary>
		public BarSeriesSonificationContextTracksActiveWhen ActiveWhen { get; set; }
		private BarSeriesSonificationContextTracksActiveWhen ActiveWhen_DefaultValue { get; set; }
		...
		/// </summary>
		public BarSeriesSonificationContextTracksMapping Mapping { get; set; }
		private BarSeriesSonificationContextTracksMapping Mapping_DefaultValue { get; set; }
		...
		/// </summary>
		public BarSeriesSonificationContextTracksPointGrouping PointGrouping { get; set; }
		private BarSeriesSonificationContextTracksPointGrouping PointGrouping_DefaultValue { get; set; }
		...
		/// </summary>
		public BarSeriesSonificationContextTracksType Type { get; set; }
		private BarSeriesSonificationContextTracksType Type_DefaultValue { get; set; }
		...
		/// </summary>
		public BarSeriesSonificationContextTracksValueMapFunction ValueMapFunction { get; set; }
		private BarSeriesSonificationContextTracksValueMapFunction ValueMapFunction_DefaultValue { get; set; }
