...
{
	public partial class BarSeriesSonificationDefaultInstrumentOptions  : BaseObject
	{
		Hashtable h = new Hashtable();

		public BarSeriesSonificationDefaultInstrumentOptions()
		{
			ActiveWhen = ActiveWhen_DefaultValue = new BarSeriesSonificationDefaultInstrumentOptionsActiveWhen();
			Instrument = Instrument_DefaultValue = null;
			InstrumentString = InstrumentString_DefaultValue = "null";
			Mapping = Mapping_DefaultValue = new BarSeriesSonificationDefaultInstrumentOptionsMapping();
			MidiName = MidiName_DefaultValue = "";
			PointGrouping = PointGrouping_DefaultValue = new BarSeriesSonificationDefaultInstrumentOptionsPointGrouping();
			RoundToMusicalNotes = RoundToMusicalNotes_DefaultValue = true;
			ShowPlayMarker = ShowPlayMarker_DefaultValue = true;
			Type = Type_DefaultValue = BarSeriesSonificationDefaultInstrumentOptionsType.Instrument;
		...
		/// </summary>
		public BarSeriesSonificationDefaultInstrumentOptionsActiveWhen ActiveWhen { get; set; }
		private BarSeriesSonificationDefaultInstrumentOptionsActiveWhen ActiveWhen_DefaultValue { get; set; }
		...
		/// </summary>
		public BarSeriesSonificationDefaultInstrumentOptionsMapping Mapping { get; set; }
		private BarSeriesSonificationDefaultInstrumentOptionsMapping Mapping_DefaultValue { get; set; }
		...
		/// </summary>
		public BarSeriesSonificationDefaultInstrumentOptionsPointGrouping PointGrouping { get; set; }
		private BarSeriesSonificationDefaultInstrumentOptionsPointGrouping PointGrouping_DefaultValue { get; set; }
		...
		/// </summary>
		public BarSeriesSonificationDefaultInstrumentOptionsType Type { get; set; }
		private BarSeriesSonificationDefaultInstrumentOptionsType Type_DefaultValue { get; set; }
