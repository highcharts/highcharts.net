...
{
	public partial class BarSeriesSonificationTracks  : BaseObject
	{
		Hashtable h = new Hashtable();

		public BarSeriesSonificationTracks()
		{
			ActiveWhen = ActiveWhen_DefaultValue = new BarSeriesSonificationTracksActiveWhen();
			Instrument = Instrument_DefaultValue = null;
			InstrumentString = InstrumentString_DefaultValue = "null";
			Mapping = Mapping_DefaultValue = new BarSeriesSonificationTracksMapping();
			MidiName = MidiName_DefaultValue = "";
			PointGrouping = PointGrouping_DefaultValue = new BarSeriesSonificationTracksPointGrouping();
			RoundToMusicalNotes = RoundToMusicalNotes_DefaultValue = true;
			ShowPlayMarker = ShowPlayMarker_DefaultValue = true;
			Type = Type_DefaultValue = BarSeriesSonificationTracksType.Instrument;
		...
		/// </summary>
		public BarSeriesSonificationTracksActiveWhen ActiveWhen { get; set; }
		private BarSeriesSonificationTracksActiveWhen ActiveWhen_DefaultValue { get; set; }
		...
		/// </summary>
		public BarSeriesSonificationTracksMapping Mapping { get; set; }
		private BarSeriesSonificationTracksMapping Mapping_DefaultValue { get; set; }
		...
		/// </summary>
		public BarSeriesSonificationTracksPointGrouping PointGrouping { get; set; }
		private BarSeriesSonificationTracksPointGrouping PointGrouping_DefaultValue { get; set; }
		...
		/// </summary>
		public BarSeriesSonificationTracksType Type { get; set; }
		private BarSeriesSonificationTracksType Type_DefaultValue { get; set; }
