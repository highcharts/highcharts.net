...
{
	public partial class BarSeriesStatesHover  : BaseObject
	{
		...
		public BarSeriesStatesHover()
		{
			...
			Halo = Halo_DefaultValue = new BarSeriesStatesHoverHalo();
			LineWidth = LineWidth_DefaultValue = null;
			LineWidthPlus = LineWidthPlus_DefaultValue = null;
			Marker = Marker_DefaultValue = new BarSeriesStatesHoverMarker();
		...
		/// </summary>
		public BarSeriesStatesHoverHalo Halo { get; set; }
		private BarSeriesStatesHoverHalo Halo_DefaultValue { get; set; }
		...
		/// </summary>
		public BarSeriesStatesHoverMarker Marker { get; set; }
		private BarSeriesStatesHoverMarker Marker_DefaultValue { get; set; }
