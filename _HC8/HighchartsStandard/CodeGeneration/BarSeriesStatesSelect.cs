...
{
	public partial class BarSeriesStatesSelect  : BaseObject
	{
		Hashtable h = new Hashtable();

		public BarSeriesStatesSelect()
		{
			Animation = Animation_DefaultValue = new Animation();
			Enabled = Enabled_DefaultValue = null;
			Halo = Halo_DefaultValue = new BarSeriesStatesSelectHalo();
			LineWidth = LineWidth_DefaultValue = null;
			LineWidthPlus = LineWidthPlus_DefaultValue = null;
			Marker = Marker_DefaultValue = new BarSeriesStatesSelectMarker();
		...
		/// </summary>
		public BarSeriesStatesSelectHalo Halo { get; set; }
		private BarSeriesStatesSelectHalo Halo_DefaultValue { get; set; }
		...
		/// </summary>
		public BarSeriesStatesSelectMarker Marker { get; set; }
		private BarSeriesStatesSelectMarker Marker_DefaultValue { get; set; }
