...
namespace Highsoft.Web.Mvc.Charts
{
	public partial class BarSeriesTooltip  : BaseObject
	{
		...
		internal override Hashtable ToHashtable()
		{
			...
			if (NullFormatter != NullFormatter_DefaultValue) { h.Add("nullFormatter",NullFormatter); Highcharts.AddFunction("13f87be6-7ba0-47e6-ba1c-de561723ae73.nullFormatter", NullFormatter); }  
			if (PointFormat != PointFormat_DefaultValue) h.Add("pointFormat",PointFormat);
			if (PointFormatter != PointFormatter_DefaultValue) { h.Add("pointFormatter",PointFormatter); Highcharts.AddFunction("86569651-991a-4719-b8eb-b3270b54838d.pointFormatter", PointFormatter); }  
