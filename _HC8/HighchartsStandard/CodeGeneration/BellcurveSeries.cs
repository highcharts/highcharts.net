...
namespace Highsoft.Web.Mvc.Charts
{
	public partial class BellcurveSeries  : Series
	{
		...
		public BellcurveSeries()
		{
			...
			Type = Type_DefaultValue = BellcurveSeriesType.Bellcurve;
		...
		internal override Hashtable ToHashtable()
		{
			...
			if (PointDescriptionFormatter != PointDescriptionFormatter_DefaultValue) { h.Add("pointDescriptionFormatter",PointDescriptionFormatter); Highcharts.AddFunction("a3886d28-1833-478f-9d77-d0554b4c7d0e.pointDescriptionFormatter", PointDescriptionFormatter); }  
