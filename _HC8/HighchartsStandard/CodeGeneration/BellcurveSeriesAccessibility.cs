...
namespace Highsoft.Web.Mvc.Charts
{
	public partial class BellcurveSeriesAccessibility  : BaseObject
	{
		...
		public BellcurveSeriesAccessibility()
		{
			...
			Point = Point_DefaultValue = new BellcurveSeriesAccessibilityPoint();
		...
		/// </summary>
		public BellcurveSeriesAccessibilityPoint Point { get; set; }
		private BellcurveSeriesAccessibilityPoint Point_DefaultValue { get; set; }
