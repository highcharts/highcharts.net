...
{
	public partial class BellcurveSeriesDataLabels  : BaseObject
	{
		Hashtable h = new Hashtable();

		public BellcurveSeriesDataLabels()
		{
			Align = Align_DefaultValue = BellcurveSeriesDataLabelsAlign.Center;
			...
			Filter = Filter_DefaultValue = new BellcurveSeriesDataLabelsFilter();
			...
			Style = Style_DefaultValue = new BellcurveSeriesDataLabelsStyle();
			TextPath = TextPath_DefaultValue = new BellcurveSeriesDataLabelsTextPath();
			UseHTML = UseHTML_DefaultValue = false;
			VerticalAlign = VerticalAlign_DefaultValue = BellcurveSeriesDataLabelsVerticalAlign.Bottom;
			X = X_DefaultValue = 0;
			Y = Y_DefaultValue = 0;
			Z = Z_DefaultValue = 6;
		...
		/// </summary>
		public BellcurveSeriesDataLabelsAlign Align { get; set; }
		private BellcurveSeriesDataLabelsAlign Align_DefaultValue { get; set; }
		...
		/// </summary>
		public BellcurveSeriesDataLabelsFilter Filter { get; set; }
		private BellcurveSeriesDataLabelsFilter Filter_DefaultValue { get; set; }
		...
		/// </summary>
		public BellcurveSeriesDataLabelsStyle Style { get; set; }
		private BellcurveSeriesDataLabelsStyle Style_DefaultValue { get; set; }
		...
		/// </summary>
		public BellcurveSeriesDataLabelsTextPath TextPath { get; set; }
		private BellcurveSeriesDataLabelsTextPath TextPath_DefaultValue { get; set; }
		...
		/// </summary>
		public BellcurveSeriesDataLabelsVerticalAlign VerticalAlign { get; set; }
		private BellcurveSeriesDataLabelsVerticalAlign VerticalAlign_DefaultValue { get; set; }
		...
		internal override Hashtable ToHashtable()
		{
			...
			if (Formatter != Formatter_DefaultValue) { h.Add("formatter",Formatter); Highcharts.AddFunction("5ef9dc63-9566-4bc5-85af-499bf619a6b3.formatter", Formatter); }  
			if (Inside != Inside_DefaultValue) h.Add("inside",Inside);
			if (NullFormat != NullFormat_DefaultValue) h.Add("nullFormat",NullFormat);
			if (NullFormatter != NullFormatter_DefaultValue) { h.Add("nullFormatter",NullFormatter); Highcharts.AddFunction("834d8782-7450-436c-afff-efc7b23bedc6.nullFormatter", NullFormatter); }  
