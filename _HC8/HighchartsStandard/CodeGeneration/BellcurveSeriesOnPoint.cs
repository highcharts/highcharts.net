...
{
	public partial class BellcurveSeriesOnPoint  : BaseObject
	{
		Hashtable h = new Hashtable();

		public BellcurveSeriesOnPoint()
		{
			ConnectorOptions = ConnectorOptions_DefaultValue = new BellcurveSeriesOnPointConnectorOptions();
			Id = Id_DefaultValue = "";
			Position = Position_DefaultValue = new BellcurveSeriesOnPointPosition();
		...
		/// </summary>
		public BellcurveSeriesOnPointConnectorOptions ConnectorOptions { get; set; }
		private BellcurveSeriesOnPointConnectorOptions ConnectorOptions_DefaultValue { get; set; }
		...
		/// </summary>
		public BellcurveSeriesOnPointPosition Position { get; set; }
		private BellcurveSeriesOnPointPosition Position_DefaultValue { get; set; }
