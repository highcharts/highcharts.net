...
{
	public partial class BellcurveSeriesSonificationContextTracks  : BaseObject
	{
		Hashtable h = new Hashtable();

		public BellcurveSeriesSonificationContextTracks()
		{
			ActiveWhen = ActiveWhen_DefaultValue = new BellcurveSeriesSonificationContextTracksActiveWhen();
			Instrument = Instrument_DefaultValue = null;
			InstrumentString = InstrumentString_DefaultValue = "null";
			Mapping = Mapping_DefaultValue = new BellcurveSeriesSonificationContextTracksMapping();
			MidiName = MidiName_DefaultValue = "";
			PointGrouping = PointGrouping_DefaultValue = new BellcurveSeriesSonificationContextTracksPointGrouping();
			...
			Type = Type_DefaultValue = BellcurveSeriesSonificationContextTracksType.Instrument;
			ValueInterval = ValueInterval_DefaultValue = null;
			ValueMapFunction = ValueMapFunction_DefaultValue = BellcurveSeriesSonificationContextTracksValueMapFunction.Linear;
		...
		/// </summary>
		public BellcurveSeriesSonificationContextTracksActiveWhen ActiveWhen { get; set; }
		private BellcurveSeriesSonificationContextTracksActiveWhen ActiveWhen_DefaultValue { get; set; }
		...
		/// </summary>
		public BellcurveSeriesSonificationContextTracksMapping Mapping { get; set; }
		private BellcurveSeriesSonificationContextTracksMapping Mapping_DefaultValue { get; set; }
		...
		/// </summary>
		public BellcurveSeriesSonificationContextTracksPointGrouping PointGrouping { get; set; }
		private BellcurveSeriesSonificationContextTracksPointGrouping PointGrouping_DefaultValue { get; set; }
		...
		/// </summary>
		public BellcurveSeriesSonificationContextTracksType Type { get; set; }
		private BellcurveSeriesSonificationContextTracksType Type_DefaultValue { get; set; }
		...
		/// </summary>
		public BellcurveSeriesSonificationContextTracksValueMapFunction ValueMapFunction { get; set; }
		private BellcurveSeriesSonificationContextTracksValueMapFunction ValueMapFunction_DefaultValue { get; set; }
