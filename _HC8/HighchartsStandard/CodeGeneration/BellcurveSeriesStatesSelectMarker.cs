...
{
	public partial class BellcurveSeriesStatesSelectMarker  : BaseObject
	{
		Hashtable h = new Hashtable();

		public BellcurveSeriesStatesSelectMarker()
		{
			...
			States = States_DefaultValue = new BellcurveSeriesStatesSelectMarkerStates();
		...
		/// </summary>
		public BellcurveSeriesStatesSelectMarkerStates States { get; set; }
		private BellcurveSeriesStatesSelectMarkerStates States_DefaultValue { get; set; }
