...
namespace Highsoft.Web.Mvc.Charts
{
	public partial class BoxplotSeries  : Series
	{
		...
		public BoxplotSeries()
		{
			...
			Type = Type_DefaultValue = BoxplotSeriesType.Boxplot;
		...
		internal override Hashtable ToHashtable()
		{
			...
			if (PointDescriptionFormatter != PointDescriptionFormatter_DefaultValue) { h.Add("pointDescriptionFormatter",PointDescriptionFormatter); Highcharts.AddFunction("5c119fcc-8a73-4b90-b98c-2b0c94947553.pointDescriptionFormatter", PointDescriptionFormatter); }  
