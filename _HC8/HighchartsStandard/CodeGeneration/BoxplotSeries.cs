...
namespace Highsoft.Web.Mvc.Charts
{
	public partial class BoxplotSeries  : Series
	{
		...
		internal override Hashtable ToHashtable()
		{
			...
			if (PointDescriptionFormatter != PointDescriptionFormatter_DefaultValue) { h.Add("pointDescriptionFormatter",PointDescriptionFormatter); Highcharts.AddFunction("159944f4-4930-48b9-b9df-aeee2561c08a.pointDescriptionFormatter", PointDescriptionFormatter); }  
