...
namespace Highsoft.Web.Mvc.Charts
{
	public partial class BoxplotSeries  : Series
	{
		...
		public BoxplotSeries()
		{
			...
			BoostBlending = BoostBlending_DefaultValue = BoxplotSeriesBoostBlending.Undefined;
		...
		/// </summary>
		public BoxplotSeriesBoostBlending BoostBlending { get; set; }
		private BoxplotSeriesBoostBlending BoostBlending_DefaultValue { get; set; }
		...
		internal override Hashtable ToHashtable()
		{
			...
			if (PointDescriptionFormatter != PointDescriptionFormatter_DefaultValue) { h.Add("pointDescriptionFormatter",PointDescriptionFormatter); Highcharts.AddFunction("d527727d-1fd3-4acc-9d85-17532ddfd1d5.pointDescriptionFormatter", PointDescriptionFormatter); }  
