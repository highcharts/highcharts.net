...
namespace Highsoft.Web.Mvc.Charts
{
	public partial class BoxplotSeriesAccessibility  : BaseObject
	{
		...
		public BoxplotSeriesAccessibility()
		{
			...
			Point = Point_DefaultValue = new BoxplotSeriesAccessibilityPoint();
		...
		/// </summary>
		public BoxplotSeriesAccessibilityPoint Point { get; set; }
		private BoxplotSeriesAccessibilityPoint Point_DefaultValue { get; set; }
