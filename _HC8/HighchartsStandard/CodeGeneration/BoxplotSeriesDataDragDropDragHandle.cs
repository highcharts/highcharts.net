...
namespace Highsoft.Web.Mvc.Charts
{
	public partial class BoxplotSeriesDataDragDropDragHandle  : BaseObject
	{
		...
		internal override Hashtable ToHashtable()
		{
			...
			if (PathFormatter != PathFormatter_DefaultValue) { h.Add("pathFormatter",PathFormatter); Highcharts.AddFunction("9eda67c8-7883-4af7-8d58-7b23c1d8974a.pathFormatter", PathFormatter); }  
