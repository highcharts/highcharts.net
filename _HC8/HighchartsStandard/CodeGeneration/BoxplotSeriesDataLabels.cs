...
{
	public partial class BoxplotSeriesDataLabels  : BaseObject
	{
		Hashtable h = new Hashtable();

		public BoxplotSeriesDataLabels()
		{
			Align = Align_DefaultValue = BoxplotSeriesDataLabelsAlign.Center;
			...
			Filter = Filter_DefaultValue = new BoxplotSeriesDataLabelsFilter();
			...
			Style = Style_DefaultValue = new BoxplotSeriesDataLabelsStyle();
			TextPath = TextPath_DefaultValue = new BoxplotSeriesDataLabelsTextPath();
			UseHTML = UseHTML_DefaultValue = false;
			VerticalAlign = VerticalAlign_DefaultValue = BoxplotSeriesDataLabelsVerticalAlign.Bottom;
			X = X_DefaultValue = 0;
			Y = Y_DefaultValue = 0;
			Z = Z_DefaultValue = 6;
		...
		/// </summary>
		public BoxplotSeriesDataLabelsAlign Align { get; set; }
		private BoxplotSeriesDataLabelsAlign Align_DefaultValue { get; set; }
		...
		/// </summary>
		public BoxplotSeriesDataLabelsFilter Filter { get; set; }
		private BoxplotSeriesDataLabelsFilter Filter_DefaultValue { get; set; }
		...
		/// </summary>
		public BoxplotSeriesDataLabelsStyle Style { get; set; }
		private BoxplotSeriesDataLabelsStyle Style_DefaultValue { get; set; }
		...
		/// </summary>
		public BoxplotSeriesDataLabelsTextPath TextPath { get; set; }
		private BoxplotSeriesDataLabelsTextPath TextPath_DefaultValue { get; set; }
		...
		/// </summary>
		public BoxplotSeriesDataLabelsVerticalAlign VerticalAlign { get; set; }
		private BoxplotSeriesDataLabelsVerticalAlign VerticalAlign_DefaultValue { get; set; }
		...
		internal override Hashtable ToHashtable()
		{
			...
			if (Formatter != Formatter_DefaultValue) { h.Add("formatter",Formatter); Highcharts.AddFunction("de42b88b-0cb9-447e-a5e8-6f33c7cb8025.formatter", Formatter); }  
			...
			if (NullFormatter != NullFormatter_DefaultValue) { h.Add("nullFormatter",NullFormatter); Highcharts.AddFunction("9fd2aa79-df54-4d34-9e96-62cd81c721ec.nullFormatter", NullFormatter); }  
