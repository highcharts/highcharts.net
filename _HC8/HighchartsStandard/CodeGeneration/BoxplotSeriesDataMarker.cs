...
{
	public partial class BoxplotSeriesDataMarker  : BaseObject
	{
		Hashtable h = new Hashtable();

		public BoxplotSeriesDataMarker()
		{
			...
			States = States_DefaultValue = new BoxplotSeriesDataMarkerStates();
		...
		/// </summary>
		public BoxplotSeriesDataMarkerStates States { get; set; }
		private BoxplotSeriesDataMarkerStates States_DefaultValue { get; set; }
