...
namespace Highsoft.Web.Mvc.Charts
{
	public partial class BoxplotSeriesDragDropDragHandle  : BaseObject
	{
		...
		internal override Hashtable ToHashtable()
		{
			...
			if (PathFormatter != PathFormatter_DefaultValue) { h.Add("pathFormatter",PathFormatter); Highcharts.AddFunction("7869a75c-553c-48bc-95c5-538cd9e1fe54.pathFormatter", PathFormatter); }  
