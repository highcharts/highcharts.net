...
{
	public partial class BoxplotSeriesOnPoint  : BaseObject
	{
		Hashtable h = new Hashtable();

		public BoxplotSeriesOnPoint()
		{
			ConnectorOptions = ConnectorOptions_DefaultValue = new BoxplotSeriesOnPointConnectorOptions();
			Id = Id_DefaultValue = "";
			Position = Position_DefaultValue = new BoxplotSeriesOnPointPosition();
		...
		/// </summary>
		public BoxplotSeriesOnPointConnectorOptions ConnectorOptions { get; set; }
		private BoxplotSeriesOnPointConnectorOptions ConnectorOptions_DefaultValue { get; set; }
		...
		/// </summary>
		public BoxplotSeriesOnPointPosition Position { get; set; }
		private BoxplotSeriesOnPointPosition Position_DefaultValue { get; set; }
