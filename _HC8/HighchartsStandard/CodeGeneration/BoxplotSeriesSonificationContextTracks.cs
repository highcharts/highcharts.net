...
{
	public partial class BoxplotSeriesSonificationContextTracks  : BaseObject
	{
		Hashtable h = new Hashtable();

		public BoxplotSeriesSonificationContextTracks()
		{
			ActiveWhen = ActiveWhen_DefaultValue = new BoxplotSeriesSonificationContextTracksActiveWhen();
			Instrument = Instrument_DefaultValue = null;
			InstrumentString = InstrumentString_DefaultValue = "null";
			Mapping = Mapping_DefaultValue = new BoxplotSeriesSonificationContextTracksMapping();
			MidiName = MidiName_DefaultValue = "";
			PointGrouping = PointGrouping_DefaultValue = new BoxplotSeriesSonificationContextTracksPointGrouping();
			...
			Type = Type_DefaultValue = BoxplotSeriesSonificationContextTracksType.Instrument;
			ValueInterval = ValueInterval_DefaultValue = null;
			ValueMapFunction = ValueMapFunction_DefaultValue = BoxplotSeriesSonificationContextTracksValueMapFunction.Linear;
		...
		/// </summary>
		public BoxplotSeriesSonificationContextTracksActiveWhen ActiveWhen { get; set; }
		private BoxplotSeriesSonificationContextTracksActiveWhen ActiveWhen_DefaultValue { get; set; }
		...
		/// </summary>
		public BoxplotSeriesSonificationContextTracksMapping Mapping { get; set; }
		private BoxplotSeriesSonificationContextTracksMapping Mapping_DefaultValue { get; set; }
		...
		/// </summary>
		public BoxplotSeriesSonificationContextTracksPointGrouping PointGrouping { get; set; }
		private BoxplotSeriesSonificationContextTracksPointGrouping PointGrouping_DefaultValue { get; set; }
		...
		/// </summary>
		public BoxplotSeriesSonificationContextTracksType Type { get; set; }
		private BoxplotSeriesSonificationContextTracksType Type_DefaultValue { get; set; }
		...
		/// </summary>
		public BoxplotSeriesSonificationContextTracksValueMapFunction ValueMapFunction { get; set; }
		private BoxplotSeriesSonificationContextTracksValueMapFunction ValueMapFunction_DefaultValue { get; set; }
