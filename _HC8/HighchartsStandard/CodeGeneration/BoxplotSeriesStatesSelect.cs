...
{
	public partial class BoxplotSeriesStatesSelect  : BaseObject
	{
		Hashtable h = new Hashtable();

		public BoxplotSeriesStatesSelect()
		{
			Animation = Animation_DefaultValue = new Animation() { Enabled = true };
			Enabled = Enabled_DefaultValue = null;
			Halo = Halo_DefaultValue = new BoxplotSeriesStatesSelectHalo();
			LineWidth = LineWidth_DefaultValue = null;
			LineWidthPlus = LineWidthPlus_DefaultValue = null;
			Marker = Marker_DefaultValue = new BoxplotSeriesStatesSelectMarker();
		...
		/// </summary>
		public BoxplotSeriesStatesSelectHalo Halo { get; set; }
		private BoxplotSeriesStatesSelectHalo Halo_DefaultValue { get; set; }
		...
		/// </summary>
		public BoxplotSeriesStatesSelectMarker Marker { get; set; }
		private BoxplotSeriesStatesSelectMarker Marker_DefaultValue { get; set; }
