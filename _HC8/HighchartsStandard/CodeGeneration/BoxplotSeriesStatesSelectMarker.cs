...
{
	public partial class BoxplotSeriesStatesSelectMarker  : BaseObject
	{
		Hashtable h = new Hashtable();

		public BoxplotSeriesStatesSelectMarker()
		{
			...
			States = States_DefaultValue = new BoxplotSeriesStatesSelectMarkerStates();
		...
		/// </summary>
		public BoxplotSeriesStatesSelectMarkerStates States { get; set; }
		private BoxplotSeriesStatesSelectMarkerStates States_DefaultValue { get; set; }
