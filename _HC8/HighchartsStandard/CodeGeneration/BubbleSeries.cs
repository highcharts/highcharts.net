...
namespace Highsoft.Web.Mvc.Charts
{
	public partial class BubbleSeries  : Series
	{
		...
		internal override Hashtable ToHashtable()
		{
			...
			if (PointDescriptionFormatter != PointDescriptionFormatter_DefaultValue) { h.Add("pointDescriptionFormatter",PointDescriptionFormatter); Highcharts.AddFunction("1d12466a-6c24-411c-95e9-b6a9febedcd5.pointDescriptionFormatter", PointDescriptionFormatter); }  
