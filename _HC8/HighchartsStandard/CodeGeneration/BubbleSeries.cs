...
namespace Highsoft.Web.Mvc.Charts
{
	public partial class BubbleSeries  : Series
	{
		...
		internal override Hashtable ToHashtable()
		{
			...
			if (PointDescriptionFormatter != PointDescriptionFormatter_DefaultValue) { h.Add("pointDescriptionFormatter",PointDescriptionFormatter); Highcharts.AddFunction("045d6a2d-08ee-41a0-b9b4-a9939e931ff9.pointDescriptionFormatter", PointDescriptionFormatter); }  
