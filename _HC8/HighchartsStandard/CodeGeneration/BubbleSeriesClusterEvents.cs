...
namespace Highsoft.Web.Mvc.Charts
{
	public partial class BubbleSeriesClusterEvents  : BaseObject
	{
		...
		internal override Hashtable ToHashtable()
		{
			...
			if (DrillToCluster != DrillToCluster_DefaultValue) { h.Add("drillToCluster",DrillToCluster); Highcharts.AddFunction("604bf148-3802-4d2e-ae38-f28cc0f4ae83.drillToCluster", DrillToCluster); }  
