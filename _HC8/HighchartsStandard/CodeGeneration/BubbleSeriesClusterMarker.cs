...
{
	public partial class BubbleSeriesClusterMarker  : BaseObject
	{
		Hashtable h = new Hashtable();

		public BubbleSeriesClusterMarker()
		{
			...
			States = States_DefaultValue = new BubbleSeriesClusterMarkerStates();
		...
		/// </summary>
		public BubbleSeriesClusterMarkerStates States { get; set; }
		private BubbleSeriesClusterMarkerStates States_DefaultValue { get; set; }
