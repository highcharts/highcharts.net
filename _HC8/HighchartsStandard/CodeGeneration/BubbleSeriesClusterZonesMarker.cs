...
{
	public partial class BubbleSeriesClusterZonesMarker  : BaseObject
	{
		Hashtable h = new Hashtable();

		public BubbleSeriesClusterZonesMarker()
		{
			...
			States = States_DefaultValue = new BubbleSeriesClusterZonesMarkerStates();
		...
		/// </summary>
		public BubbleSeriesClusterZonesMarkerStates States { get; set; }
		private BubbleSeriesClusterZonesMarkerStates States_DefaultValue { get; set; }
