...
namespace Highsoft.Web.Mvc.Charts
{
	public partial class BubbleSeriesDataDragDropDragHandle  : BaseObject
	{
		...
		internal override Hashtable ToHashtable()
		{
			...
			if (PathFormatter != PathFormatter_DefaultValue) { h.Add("pathFormatter",PathFormatter); Highcharts.AddFunction("1d0e3b87-2e03-4d5e-96d4-2ee58a8782f9.pathFormatter", PathFormatter); }  
