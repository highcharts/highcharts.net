...
namespace Highsoft.Web.Mvc.Charts
{
	public partial class BubbleSeriesDataDragDropDragHandle  : BaseObject
	{
		...
		internal override Hashtable ToHashtable()
		{
			...
			if (PathFormatter != PathFormatter_DefaultValue) { h.Add("pathFormatter",PathFormatter); Highcharts.AddFunction("28c73f7f-79bf-4ce7-88bf-1229a87cda8f.pathFormatter", PathFormatter); }  
