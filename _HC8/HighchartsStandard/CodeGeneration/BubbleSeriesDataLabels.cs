...
namespace Highsoft.Web.Mvc.Charts
{
	public partial class BubbleSeriesDataLabels  : BaseObject
	{
		...
		{
			Align = Align_DefaultValue = BubbleSeriesDataLabelsAlign.Center;
			...
			Filter = Filter_DefaultValue = new BubbleSeriesDataLabelsFilter();
			...
			Style = Style_DefaultValue = new BubbleSeriesDataLabelsStyle();
			TextPath = TextPath_DefaultValue = new BubbleSeriesDataLabelsTextPath();
			UseHTML = UseHTML_DefaultValue = false;
			VerticalAlign = VerticalAlign_DefaultValue = BubbleSeriesDataLabelsVerticalAlign.Bottom;
			X = X_DefaultValue = 0;
			Y = Y_DefaultValue = 0;
			Z = Z_DefaultValue = 6;
		...
		/// </summary>
		public BubbleSeriesDataLabelsAlign Align { get; set; }
		private BubbleSeriesDataLabelsAlign Align_DefaultValue { get; set; }
		...
		/// </summary>
		public BubbleSeriesDataLabelsFilter Filter { get; set; }
		private BubbleSeriesDataLabelsFilter Filter_DefaultValue { get; set; }
		...
		/// </summary>
		public BubbleSeriesDataLabelsStyle Style { get; set; }
		private BubbleSeriesDataLabelsStyle Style_DefaultValue { get; set; }
		...
		/// </summary>
		public BubbleSeriesDataLabelsTextPath TextPath { get; set; }
		private BubbleSeriesDataLabelsTextPath TextPath_DefaultValue { get; set; }
		...
		internal override Hashtable ToHashtable()
		{
			...
			if (Formatter != Formatter_DefaultValue) { h.Add("formatter",Formatter); Highcharts.AddFunction("ab0190e0-a8c8-479a-b702-0ce30bc0b6df.formatter", Formatter); }  
			if (Inside != Inside_DefaultValue) h.Add("inside",Inside);
			if (NullFormat != NullFormat_DefaultValue) h.Add("nullFormat",NullFormat);
			if (NullFormatter != NullFormatter_DefaultValue) { h.Add("nullFormatter",NullFormatter); Highcharts.AddFunction("8f1544bf-9502-4db0-8f96-f19f6381c0d2.nullFormatter", NullFormatter); }  
