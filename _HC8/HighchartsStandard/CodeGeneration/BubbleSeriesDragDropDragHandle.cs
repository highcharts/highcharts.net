...
namespace Highsoft.Web.Mvc.Charts
{
	public partial class BubbleSeriesDragDropDragHandle  : BaseObject
	{
		...
		internal override Hashtable ToHashtable()
		{
			...
			if (PathFormatter != PathFormatter_DefaultValue) { h.Add("pathFormatter",PathFormatter); Highcharts.AddFunction("a3784415-b5c0-436e-9104-b459115762d2.pathFormatter", PathFormatter); }  
