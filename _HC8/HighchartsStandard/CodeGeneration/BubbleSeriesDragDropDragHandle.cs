...
namespace Highsoft.Web.Mvc.Charts
{
	public partial class BubbleSeriesDragDropDragHandle  : BaseObject
	{
		...
		internal override Hashtable ToHashtable()
		{
			...
			if (PathFormatter != PathFormatter_DefaultValue) { h.Add("pathFormatter",PathFormatter); Highcharts.AddFunction("c15194cf-8083-462d-9751-4f83708b5f5a.pathFormatter", PathFormatter); }  
