...
{
	public partial class BubbleSeriesSonificationContextTracks  : BaseObject
	{
		Hashtable h = new Hashtable();

		public BubbleSeriesSonificationContextTracks()
		{
			ActiveWhen = ActiveWhen_DefaultValue = new BubbleSeriesSonificationContextTracksActiveWhen();
			Instrument = Instrument_DefaultValue = null;
			InstrumentString = InstrumentString_DefaultValue = "null";
			Mapping = Mapping_DefaultValue = new BubbleSeriesSonificationContextTracksMapping();
			MidiName = MidiName_DefaultValue = "";
			PointGrouping = PointGrouping_DefaultValue = new BubbleSeriesSonificationContextTracksPointGrouping();
			...
			Type = Type_DefaultValue = BubbleSeriesSonificationContextTracksType.Instrument;
			ValueInterval = ValueInterval_DefaultValue = null;
			ValueMapFunction = ValueMapFunction_DefaultValue = BubbleSeriesSonificationContextTracksValueMapFunction.Linear;
		...
		/// </summary>
		public BubbleSeriesSonificationContextTracksActiveWhen ActiveWhen { get; set; }
		private BubbleSeriesSonificationContextTracksActiveWhen ActiveWhen_DefaultValue { get; set; }
		...
		/// </summary>
		public BubbleSeriesSonificationContextTracksMapping Mapping { get; set; }
		private BubbleSeriesSonificationContextTracksMapping Mapping_DefaultValue { get; set; }
		...
		/// </summary>
		public BubbleSeriesSonificationContextTracksPointGrouping PointGrouping { get; set; }
		private BubbleSeriesSonificationContextTracksPointGrouping PointGrouping_DefaultValue { get; set; }
		...
		/// </summary>
		public BubbleSeriesSonificationContextTracksType Type { get; set; }
		private BubbleSeriesSonificationContextTracksType Type_DefaultValue { get; set; }
		...
		/// </summary>
		public BubbleSeriesSonificationContextTracksValueMapFunction ValueMapFunction { get; set; }
		private BubbleSeriesSonificationContextTracksValueMapFunction ValueMapFunction_DefaultValue { get; set; }
