...
namespace Highsoft.Web.Mvc.Charts
{
	public partial class BubbleSeriesSonificationTracksMappingTremolo  : BaseObject
	{
		...
		{
			Depth = Depth_DefaultValue = new BubbleSeriesSonificationTracksMappingTremoloDepth();
			Speed = Speed_DefaultValue = new BubbleSeriesSonificationTracksMappingTremoloSpeed();
		...
		private BubbleSeriesSonificationTracksMappingTremoloDepth Depth_DefaultValue { get; set; }
		...
		private BubbleSeriesSonificationTracksMappingTremoloSpeed Speed_DefaultValue { get; set; }
