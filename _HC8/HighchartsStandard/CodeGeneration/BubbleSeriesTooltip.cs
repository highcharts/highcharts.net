...
{
	public partial class BubbleSeriesTooltip  : BaseObject
	{
		...
		public BubbleSeriesTooltip()
		{
			...
			HeaderShape = HeaderShape_DefaultValue = BubbleSeriesTooltipHeaderShape.Callout;
		...
		/// </summary>
		public BubbleSeriesTooltipHeaderShape HeaderShape { get; set; }
		private BubbleSeriesTooltipHeaderShape HeaderShape_DefaultValue { get; set; }
		...
		internal override Hashtable ToHashtable()
		{
			...
			if (NullFormatter != NullFormatter_DefaultValue) { h.Add("nullFormatter",NullFormatter); Highcharts.AddFunction("af41ab1f-4f55-44fb-9d60-a02867a2598e.nullFormatter", NullFormatter); }  
			if (Outside != Outside_DefaultValue) h.Add("outside",Outside);
			if (Padding != Padding_DefaultValue) h.Add("padding",Padding);
			if (PointFormat != PointFormat_DefaultValue) h.Add("pointFormat",PointFormat);
			if (PointFormatter != PointFormatter_DefaultValue) { h.Add("pointFormatter",PointFormatter); Highcharts.AddFunction("7ef8c61a-6697-4a93-9710-8b0e60043ca6.pointFormatter", PointFormatter); }  
