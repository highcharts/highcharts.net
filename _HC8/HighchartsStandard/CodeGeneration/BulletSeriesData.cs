...
{
	public partial class BulletSeriesData  : BaseObject
	{
		...
		public BulletSeriesData()
		{
			...
			DashStyle = DashStyle_DefaultValue = BulletSeriesDataDashStyle.Null;
			...
			Marker = Marker_DefaultValue = new BulletSeriesDataMarker();
		...
		/// </summary>
		public BulletSeriesDataDashStyle DashStyle { get; set; }
		private BulletSeriesDataDashStyle DashStyle_DefaultValue { get; set; }
		...
		/// </summary>
		public BulletSeriesDataDragDrop DragDrop { get; set; }
		private BulletSeriesDataDragDrop DragDrop_DefaultValue { get; set; }
		...
		/// </summary>
		public BulletSeriesDataMarker Marker { get; set; }
		private BulletSeriesDataMarker Marker_DefaultValue { get; set; }
