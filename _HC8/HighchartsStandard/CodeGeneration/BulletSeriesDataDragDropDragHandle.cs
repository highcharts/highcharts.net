...
namespace Highsoft.Web.Mvc.Charts
{
	public partial class BulletSeriesDataDragDropDragHandle  : BaseObject
	{
		...
		internal override Hashtable ToHashtable()
		{
			...
			if (PathFormatter != PathFormatter_DefaultValue) { h.Add("pathFormatter",PathFormatter); Highcharts.AddFunction("affb2d97-0767-4d1f-974b-6f19a8912502.pathFormatter", PathFormatter); }  
