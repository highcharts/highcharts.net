...
{
	public partial class BulletSeriesDataLabels  : BaseObject
	{
		Hashtable h = new Hashtable();

		public BulletSeriesDataLabels()
		{
			Align = Align_DefaultValue = BulletSeriesDataLabelsAlign.Center;
			...
			Filter = Filter_DefaultValue = new BulletSeriesDataLabelsFilter();
			...
			Style = Style_DefaultValue = new BulletSeriesDataLabelsStyle();
			TextPath = TextPath_DefaultValue = new BulletSeriesDataLabelsTextPath();
			UseHTML = UseHTML_DefaultValue = false;
			VerticalAlign = VerticalAlign_DefaultValue = BulletSeriesDataLabelsVerticalAlign.Bottom;
			X = X_DefaultValue = 0;
			Y = Y_DefaultValue = 0;
			Z = Z_DefaultValue = 6;
		...
		/// </summary>
		public BulletSeriesDataLabelsAlign Align { get; set; }
		private BulletSeriesDataLabelsAlign Align_DefaultValue { get; set; }
		...
		/// </summary>
		public BulletSeriesDataLabelsFilter Filter { get; set; }
		private BulletSeriesDataLabelsFilter Filter_DefaultValue { get; set; }
		...
		/// </summary>
		public BulletSeriesDataLabelsStyle Style { get; set; }
		private BulletSeriesDataLabelsStyle Style_DefaultValue { get; set; }
		...
		/// </summary>
		public BulletSeriesDataLabelsTextPath TextPath { get; set; }
		private BulletSeriesDataLabelsTextPath TextPath_DefaultValue { get; set; }
		...
		/// </summary>
		public BulletSeriesDataLabelsVerticalAlign VerticalAlign { get; set; }
		private BulletSeriesDataLabelsVerticalAlign VerticalAlign_DefaultValue { get; set; }
		...
		internal override Hashtable ToHashtable()
		{
			...
			if (Formatter != Formatter_DefaultValue) { h.Add("formatter",Formatter); Highcharts.AddFunction("7ba5c39e-d3d1-4994-b8b5-b8614d7be650.formatter", Formatter); }  
			if (Inside != Inside_DefaultValue) h.Add("inside",Inside);
			if (NullFormat != NullFormat_DefaultValue) h.Add("nullFormat",NullFormat);
			if (NullFormatter != NullFormatter_DefaultValue) { h.Add("nullFormatter",NullFormatter); Highcharts.AddFunction("c103756c-84dd-4e13-8864-f4a60f955b3a.nullFormatter", NullFormatter); }  
