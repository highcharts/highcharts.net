...
{
	public partial class BulletSeriesDataMarker  : BaseObject
	{
		Hashtable h = new Hashtable();

		public BulletSeriesDataMarker()
		{
			...
			States = States_DefaultValue = new BulletSeriesDataMarkerStates();
		...
		/// </summary>
		public BulletSeriesDataMarkerStates States { get; set; }
		private BulletSeriesDataMarkerStates States_DefaultValue { get; set; }
