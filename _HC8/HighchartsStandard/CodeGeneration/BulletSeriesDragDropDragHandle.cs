...
namespace Highsoft.Web.Mvc.Charts
{
	public partial class BulletSeriesDragDropDragHandle  : BaseObject
	{
		...
		internal override Hashtable ToHashtable()
		{
			...
			if (PathFormatter != PathFormatter_DefaultValue) { h.Add("pathFormatter",PathFormatter); Highcharts.AddFunction("f0a902c1-82ed-4e02-b52f-96c902725056.pathFormatter", PathFormatter); }  
