...
{
	public partial class BulletSeriesOnPoint  : BaseObject
	{
		Hashtable h = new Hashtable();

		public BulletSeriesOnPoint()
		{
			ConnectorOptions = ConnectorOptions_DefaultValue = new BulletSeriesOnPointConnectorOptions();
			Id = Id_DefaultValue = "";
			Position = Position_DefaultValue = new BulletSeriesOnPointPosition();
		...
		/// </summary>
		public BulletSeriesOnPointConnectorOptions ConnectorOptions { get; set; }
		private BulletSeriesOnPointConnectorOptions ConnectorOptions_DefaultValue { get; set; }
		...
		/// </summary>
		public BulletSeriesOnPointPosition Position { get; set; }
		private BulletSeriesOnPointPosition Position_DefaultValue { get; set; }
