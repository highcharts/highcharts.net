...
{
	public partial class BulletSeriesStatesSelect  : BaseObject
	{
		...
		public BulletSeriesStatesSelect()
		{
			...
			Halo = Halo_DefaultValue = new BulletSeriesStatesSelectHalo();
			LineWidth = LineWidth_DefaultValue = null;
			LineWidthPlus = LineWidthPlus_DefaultValue = null;
			Marker = Marker_DefaultValue = new BulletSeriesStatesSelectMarker();
		...
		/// </summary>
		public BulletSeriesStatesSelectHalo Halo { get; set; }
		private BulletSeriesStatesSelectHalo Halo_DefaultValue { get; set; }
		...
		/// </summary>
		public BulletSeriesStatesSelectMarker Marker { get; set; }
		private BulletSeriesStatesSelectMarker Marker_DefaultValue { get; set; }
