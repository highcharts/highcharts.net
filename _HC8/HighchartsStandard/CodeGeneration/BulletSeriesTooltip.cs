...
{
	public partial class BulletSeriesTooltip  : BaseObject
	{
		Hashtable h = new Hashtable();

		public BulletSeriesTooltip()
		{
			...
			HeaderShape = HeaderShape_DefaultValue = BulletSeriesTooltipHeaderShape.Callout;
		...
		/// </summary>
		public BulletSeriesTooltipHeaderShape HeaderShape { get; set; }
		private BulletSeriesTooltipHeaderShape HeaderShape_DefaultValue { get; set; }
		...
		internal override Hashtable ToHashtable()
		{
			...
			if (NullFormatter != NullFormatter_DefaultValue) { h.Add("nullFormatter",NullFormatter); Highcharts.AddFunction("52a6234e-6e91-4be5-980a-a5ff9cbfce18.nullFormatter", NullFormatter); }  
			if (Outside != Outside_DefaultValue) h.Add("outside",Outside);
			if (Padding != Padding_DefaultValue) h.Add("padding",Padding);
			if (PointFormat != PointFormat_DefaultValue) h.Add("pointFormat",PointFormat);
			if (PointFormatter != PointFormatter_DefaultValue) { h.Add("pointFormatter",PointFormatter); Highcharts.AddFunction("d4c2aace-0ee2-4518-97b0-98287fb276e7.pointFormatter", PointFormatter); }  
