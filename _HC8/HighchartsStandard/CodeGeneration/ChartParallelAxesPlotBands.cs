...
{
	public partial class ChartParallelAxesPlotBands  : BaseObject
	{
		Hashtable h = new Hashtable();

		public ChartParallelAxesPlotBands()
		{
			...
			Events = Events_DefaultValue = new ChartParallelAxesPlotBandsEvents();
			From = From_DefaultValue = null;
			Id = Id_DefaultValue = "";
			Label = Label_DefaultValue = new ChartParallelAxesPlotBandsLabel();
		...
		/// </summary>
		public ChartParallelAxesPlotBandsEvents Events { get; set; }
		private ChartParallelAxesPlotBandsEvents Events_DefaultValue { get; set; }
		...
		/// </summary>
		public ChartParallelAxesPlotBandsLabel Label { get; set; }
		private ChartParallelAxesPlotBandsLabel Label_DefaultValue { get; set; }
