...
{
	public partial class ChartParallelAxesPlotLinesLabel  : BaseObject
	{
		Hashtable h = new Hashtable();

		public ChartParallelAxesPlotLinesLabel()
		{
			Align = Align_DefaultValue = ChartParallelAxesPlotLinesLabelAlign.Left;
			Formatter = Formatter_DefaultValue = "";
			Rotation = Rotation_DefaultValue = null;
			Style = Style_DefaultValue = new Hashtable();
			Text = Text_DefaultValue = "";
			TextAlign = TextAlign_DefaultValue = ChartParallelAxesPlotLinesLabelTextAlign.Null;
			UseHTML = UseHTML_DefaultValue = false;
			VerticalAlign = VerticalAlign_DefaultValue = ChartParallelAxesPlotLinesLabelVerticalAlign.Null;
		...
		/// </summary>
		public ChartParallelAxesPlotLinesLabelAlign Align { get; set; }
		private ChartParallelAxesPlotLinesLabelAlign Align_DefaultValue { get; set; }
		...
		/// </summary>
		public ChartParallelAxesPlotLinesLabelTextAlign TextAlign { get; set; }
		private ChartParallelAxesPlotLinesLabelTextAlign TextAlign_DefaultValue { get; set; }
		...
		/// </summary>
		public ChartParallelAxesPlotLinesLabelVerticalAlign VerticalAlign { get; set; }
		private ChartParallelAxesPlotLinesLabelVerticalAlign VerticalAlign_DefaultValue { get; set; }
