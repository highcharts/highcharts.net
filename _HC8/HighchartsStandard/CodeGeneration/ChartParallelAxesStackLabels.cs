...
{
	public partial class ChartParallelAxesStackLabels  : BaseObject
	{
		Hashtable h = new Hashtable();

		public ChartParallelAxesStackLabels()
		{
			Align = Align_DefaultValue = ChartParallelAxesStackLabelsAlign.Null;
			...
			Overflow = Overflow_DefaultValue = ChartParallelAxesStackLabelsOverflow.Justify;
			Rotation = Rotation_DefaultValue = 0;
			Style = Style_DefaultValue = new Hashtable();
			TextAlign = TextAlign_DefaultValue = ChartParallelAxesStackLabelsTextAlign.Null;
			UseHTML = UseHTML_DefaultValue = false;
			VerticalAlign = VerticalAlign_DefaultValue = ChartParallelAxesStackLabelsVerticalAlign.Null;
		...
		/// </summary>
		public ChartParallelAxesStackLabelsAlign Align { get; set; }
		private ChartParallelAxesStackLabelsAlign Align_DefaultValue { get; set; }
		...
		/// </summary>
		public ChartParallelAxesStackLabelsOverflow Overflow { get; set; }
		private ChartParallelAxesStackLabelsOverflow Overflow_DefaultValue { get; set; }
		...
		/// </summary>
		public ChartParallelAxesStackLabelsTextAlign TextAlign { get; set; }
		private ChartParallelAxesStackLabelsTextAlign TextAlign_DefaultValue { get; set; }
		...
		/// </summary>
		public ChartParallelAxesStackLabelsVerticalAlign VerticalAlign { get; set; }
		private ChartParallelAxesStackLabelsVerticalAlign VerticalAlign_DefaultValue { get; set; }
