...
{
	public partial class ColorAxisPlotLinesLabel  : BaseObject
	{
		Hashtable h = new Hashtable();

		public ColorAxisPlotLinesLabel()
		{
			Align = Align_DefaultValue = ColorAxisPlotLinesLabelAlign.Left;
			Formatter = Formatter_DefaultValue = "";
			Rotation = Rotation_DefaultValue = null;
			Style = Style_DefaultValue = new Hashtable();
			Text = Text_DefaultValue = "";
			TextAlign = TextAlign_DefaultValue = ColorAxisPlotLinesLabelTextAlign.Null;
			UseHTML = UseHTML_DefaultValue = false;
			VerticalAlign = VerticalAlign_DefaultValue = ColorAxisPlotLinesLabelVerticalAlign.Null;
		...
		/// </summary>
		public ColorAxisPlotLinesLabelAlign Align { get; set; }
		private ColorAxisPlotLinesLabelAlign Align_DefaultValue { get; set; }
		...
		/// </summary>
		public ColorAxisPlotLinesLabelTextAlign TextAlign { get; set; }
		private ColorAxisPlotLinesLabelTextAlign TextAlign_DefaultValue { get; set; }
		...
		/// </summary>
		public ColorAxisPlotLinesLabelVerticalAlign VerticalAlign { get; set; }
		private ColorAxisPlotLinesLabelVerticalAlign VerticalAlign_DefaultValue { get; set; }
