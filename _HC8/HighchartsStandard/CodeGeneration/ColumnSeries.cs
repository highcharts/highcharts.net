...
namespace Highsoft.Web.Mvc.Charts
{
	public partial class ColumnSeries  : Series
	{
		...
		internal override Hashtable ToHashtable()
		{
			...
			if (PointDescriptionFormatter != PointDescriptionFormatter_DefaultValue) { h.Add("pointDescriptionFormatter",PointDescriptionFormatter); Highcharts.AddFunction("319c4bcd-11bb-4adc-bfdf-a11910495357.pointDescriptionFormatter", PointDescriptionFormatter); }  
