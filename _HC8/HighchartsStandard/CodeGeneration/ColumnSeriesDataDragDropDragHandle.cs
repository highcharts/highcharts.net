...
namespace Highsoft.Web.Mvc.Charts
{
	public partial class ColumnSeriesDataDragDropDragHandle  : BaseObject
	{
		...
		internal override Hashtable ToHashtable()
		{
			...
			if (PathFormatter != PathFormatter_DefaultValue) { h.Add("pathFormatter",PathFormatter); Highcharts.AddFunction("dab97c9f-24fc-496a-8e72-a63534205c4b.pathFormatter", PathFormatter); }  
