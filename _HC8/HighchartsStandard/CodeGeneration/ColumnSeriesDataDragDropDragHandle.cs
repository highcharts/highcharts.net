...
namespace Highsoft.Web.Mvc.Charts
{
	public partial class ColumnSeriesDataDragDropDragHandle  : BaseObject
	{
		...
		internal override Hashtable ToHashtable()
		{
			...
			if (PathFormatter != PathFormatter_DefaultValue) { h.Add("pathFormatter",PathFormatter); Highcharts.AddFunction("eee53f02-61b1-425d-9b21-4caed0ea6738.pathFormatter", PathFormatter); }  
