...
namespace Highsoft.Web.Mvc.Charts
{
	public partial class ColumnSeriesDataDragDropDragHandle  : BaseObject
	{
		...
		internal override Hashtable ToHashtable()
		{
			...
			if (PathFormatter != PathFormatter_DefaultValue) { h.Add("pathFormatter",PathFormatter); Highcharts.AddFunction("edcaa860-66e8-4596-a7df-5e10317b4c35.pathFormatter", PathFormatter); }  
