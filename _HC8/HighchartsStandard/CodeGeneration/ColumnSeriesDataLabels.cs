...
{
	public partial class ColumnSeriesDataLabels  : BaseObject
	{
		...
		public ColumnSeriesDataLabels()
		{
			...
			Filter = Filter_DefaultValue = new ColumnSeriesDataLabelsFilter();
			...
			Style = Style_DefaultValue = new ColumnSeriesDataLabelsStyle();
			TextPath = TextPath_DefaultValue = new ColumnSeriesDataLabelsTextPath();
			UseHTML = UseHTML_DefaultValue = false;
			VerticalAlign = VerticalAlign_DefaultValue = ColumnSeriesDataLabelsVerticalAlign.Bottom;
			X = X_DefaultValue = 0;
			Y = Y_DefaultValue = 0;
			Z = Z_DefaultValue = 6;
		...
		/// </summary>
		public ColumnSeriesDataLabelsFilter Filter { get; set; }
		private ColumnSeriesDataLabelsFilter Filter_DefaultValue { get; set; }
		...
		/// </summary>
		public ColumnSeriesDataLabelsStyle Style { get; set; }
		private ColumnSeriesDataLabelsStyle Style_DefaultValue { get; set; }
		...
		/// </summary>
		public ColumnSeriesDataLabelsTextPath TextPath { get; set; }
		private ColumnSeriesDataLabelsTextPath TextPath_DefaultValue { get; set; }
		...
		internal override Hashtable ToHashtable()
		{
			...
			if (Formatter != Formatter_DefaultValue) { h.Add("formatter",Formatter); Highcharts.AddFunction("d18f9c28-abce-4c40-8ee6-379face9a969.formatter", Formatter); }  
			if (Inside != Inside_DefaultValue) h.Add("inside",Inside);
			if (NullFormat != NullFormat_DefaultValue) h.Add("nullFormat",NullFormat);
			if (NullFormatter != NullFormatter_DefaultValue) { h.Add("nullFormatter",NullFormatter); Highcharts.AddFunction("fb7e3d9f-8278-4a88-8c18-1aaeb90b2713.nullFormatter", NullFormatter); }  
