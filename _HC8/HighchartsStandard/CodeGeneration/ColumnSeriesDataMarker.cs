...
{
	public partial class ColumnSeriesDataMarker  : BaseObject
	{
		Hashtable h = new Hashtable();

		public ColumnSeriesDataMarker()
		{
			...
			States = States_DefaultValue = new ColumnSeriesDataMarkerStates();
		...
		/// </summary>
		public ColumnSeriesDataMarkerStates States { get; set; }
		private ColumnSeriesDataMarkerStates States_DefaultValue { get; set; }
