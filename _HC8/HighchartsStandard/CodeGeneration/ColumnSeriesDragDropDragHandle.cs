...
namespace Highsoft.Web.Mvc.Charts
{
	public partial class ColumnSeriesDragDropDragHandle  : BaseObject
	{
		...
		internal override Hashtable ToHashtable()
		{
			...
			if (PathFormatter != PathFormatter_DefaultValue) { h.Add("pathFormatter",PathFormatter); Highcharts.AddFunction("ff4d96ab-6281-4cc0-909c-9d848dcf39e9.pathFormatter", PathFormatter); }  
