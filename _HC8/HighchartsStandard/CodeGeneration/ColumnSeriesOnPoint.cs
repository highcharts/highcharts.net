...
{
	public partial class ColumnSeriesOnPoint  : BaseObject
	{
		Hashtable h = new Hashtable();

		public ColumnSeriesOnPoint()
		{
			ConnectorOptions = ConnectorOptions_DefaultValue = new ColumnSeriesOnPointConnectorOptions();
			Id = Id_DefaultValue = "";
			Position = Position_DefaultValue = new ColumnSeriesOnPointPosition();
		...
		/// </summary>
		public ColumnSeriesOnPointConnectorOptions ConnectorOptions { get; set; }
		private ColumnSeriesOnPointConnectorOptions ConnectorOptions_DefaultValue { get; set; }
		...
		/// </summary>
		public ColumnSeriesOnPointPosition Position { get; set; }
		private ColumnSeriesOnPointPosition Position_DefaultValue { get; set; }
