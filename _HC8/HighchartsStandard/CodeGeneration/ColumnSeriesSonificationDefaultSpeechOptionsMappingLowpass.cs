...
namespace Highsoft.Web.Mvc.Charts
{
	public partial class ColumnSeriesSonificationDefaultSpeechOptionsMappingLowpass  : BaseObject
	{
		...
		{
			Frequency = Frequency_DefaultValue = new ColumnSeriesSonificationDefaultSpeechOptionsMappingLowpassFrequency();
			Resonance = Resonance_DefaultValue = new ColumnSeriesSonificationDefaultSpeechOptionsMappingLowpassResonance();
