...
namespace Highsoft.Web.Mvc.Charts
{
	public partial class ColumnSeriesStatesSelect  : BaseObject
	{
		...
		public ColumnSeriesStatesSelect()
		{
			...
			Halo = Halo_DefaultValue = new ColumnSeriesStatesSelectHalo();
			LineWidth = LineWidth_DefaultValue = null;
			LineWidthPlus = LineWidthPlus_DefaultValue = null;
			Marker = Marker_DefaultValue = new ColumnSeriesStatesSelectMarker();
		...
		/// </summary>
		public ColumnSeriesStatesSelectHalo Halo { get; set; }
		private ColumnSeriesStatesSelectHalo Halo_DefaultValue { get; set; }
		...
		/// </summary>
		public ColumnSeriesStatesSelectMarker Marker { get; set; }
		private ColumnSeriesStatesSelectMarker Marker_DefaultValue { get; set; }
