...
namespace Highsoft.Web.Mvc.Charts
{
	public partial class ColumnpyramidSeries  : Series
	{
		...
		internal override Hashtable ToHashtable()
		{
			...
			if (PointDescriptionFormatter != PointDescriptionFormatter_DefaultValue) { h.Add("pointDescriptionFormatter",PointDescriptionFormatter); Highcharts.AddFunction("0bc33869-30ca-4e3a-aec3-f6d9ae549ddb.pointDescriptionFormatter", PointDescriptionFormatter); }  
