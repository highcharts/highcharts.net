...
namespace Highsoft.Web.Mvc.Charts
{
	public partial class ColumnpyramidSeries  : Series
	{
		...
		internal override Hashtable ToHashtable()
		{
			...
			if (PointDescriptionFormatter != PointDescriptionFormatter_DefaultValue) { h.Add("pointDescriptionFormatter",PointDescriptionFormatter); Highcharts.AddFunction("823ace17-861a-419c-80b9-8fc44fa375aa.pointDescriptionFormatter", PointDescriptionFormatter); }  
