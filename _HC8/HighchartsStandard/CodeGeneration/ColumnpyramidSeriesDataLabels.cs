...
{
	public partial class ColumnpyramidSeriesDataLabels  : BaseObject
	{
		Hashtable h = new Hashtable();

		public ColumnpyramidSeriesDataLabels()
		{
			Align = Align_DefaultValue = ColumnpyramidSeriesDataLabelsAlign.Center;
			...
			Filter = Filter_DefaultValue = new ColumnpyramidSeriesDataLabelsFilter();
			...
			Style = Style_DefaultValue = new ColumnpyramidSeriesDataLabelsStyle();
			TextPath = TextPath_DefaultValue = new ColumnpyramidSeriesDataLabelsTextPath();
			UseHTML = UseHTML_DefaultValue = false;
			VerticalAlign = VerticalAlign_DefaultValue = ColumnpyramidSeriesDataLabelsVerticalAlign.Bottom;
			X = X_DefaultValue = 0;
			Y = Y_DefaultValue = 0;
			Z = Z_DefaultValue = 6;
		...
		/// </summary>
		public ColumnpyramidSeriesDataLabelsAlign Align { get; set; }
		private ColumnpyramidSeriesDataLabelsAlign Align_DefaultValue { get; set; }
		...
		/// </summary>
		public ColumnpyramidSeriesDataLabelsFilter Filter { get; set; }
		private ColumnpyramidSeriesDataLabelsFilter Filter_DefaultValue { get; set; }
		...
		/// </summary>
		public ColumnpyramidSeriesDataLabelsStyle Style { get; set; }
		private ColumnpyramidSeriesDataLabelsStyle Style_DefaultValue { get; set; }
		...
		/// </summary>
		public ColumnpyramidSeriesDataLabelsTextPath TextPath { get; set; }
		private ColumnpyramidSeriesDataLabelsTextPath TextPath_DefaultValue { get; set; }
		...
		/// </summary>
		public ColumnpyramidSeriesDataLabelsVerticalAlign VerticalAlign { get; set; }
		private ColumnpyramidSeriesDataLabelsVerticalAlign VerticalAlign_DefaultValue { get; set; }
		...
		internal override Hashtable ToHashtable()
		{
			...
			if (Formatter != Formatter_DefaultValue) { h.Add("formatter",Formatter); Highcharts.AddFunction("213afb3e-4a96-487d-a8ca-7cce72481d30.formatter", Formatter); }  
			if (Inside != Inside_DefaultValue) h.Add("inside",Inside);
			if (NullFormat != NullFormat_DefaultValue) h.Add("nullFormat",NullFormat);
			if (NullFormatter != NullFormatter_DefaultValue) { h.Add("nullFormatter",NullFormatter); Highcharts.AddFunction("893df7df-ca64-4901-aff0-f5195a6e6c1a.nullFormatter", NullFormatter); }  
