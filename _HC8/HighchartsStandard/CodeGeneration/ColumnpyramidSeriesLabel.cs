...
{
	public partial class ColumnpyramidSeriesLabel  : BaseObject
	{
		Hashtable h = new Hashtable();

		public ColumnpyramidSeriesLabel()
		{
		...
		internal override Hashtable ToHashtable()
		{
			...
			if (Formatter != Formatter_DefaultValue) { h.Add("formatter",Formatter); Highcharts.AddFunction("2521af45-75a2-4df2-9405-9e6e06e26a30.formatter", Formatter); }  
