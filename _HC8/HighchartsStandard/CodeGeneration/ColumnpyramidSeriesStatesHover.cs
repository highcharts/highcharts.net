...
{
	public partial class ColumnpyramidSeriesStatesHover  : BaseObject
	{
		Hashtable h = new Hashtable();

		public ColumnpyramidSeriesStatesHover()
		{
			Animation = Animation_DefaultValue = new Animation();
			Enabled = Enabled_DefaultValue = null;
			Halo = Halo_DefaultValue = new ColumnpyramidSeriesStatesHoverHalo();
			LineWidth = LineWidth_DefaultValue = null;
			LineWidthPlus = LineWidthPlus_DefaultValue = null;
			Marker = Marker_DefaultValue = new ColumnpyramidSeriesStatesHoverMarker();
		...
		/// </summary>
		public ColumnpyramidSeriesStatesHoverHalo Halo { get; set; }
		private ColumnpyramidSeriesStatesHoverHalo Halo_DefaultValue { get; set; }
		...
		/// </summary>
		public ColumnpyramidSeriesStatesHoverMarker Marker { get; set; }
		private ColumnpyramidSeriesStatesHoverMarker Marker_DefaultValue { get; set; }
