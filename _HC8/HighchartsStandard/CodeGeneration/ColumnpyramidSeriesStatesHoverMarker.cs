...
{
	public partial class ColumnpyramidSeriesStatesHoverMarker  : BaseObject
	{
		Hashtable h = new Hashtable();

		public ColumnpyramidSeriesStatesHoverMarker()
		{
			...
			States = States_DefaultValue = new ColumnpyramidSeriesStatesHoverMarkerStates();
		...
		/// </summary>
		public ColumnpyramidSeriesStatesHoverMarkerStates States { get; set; }
		private ColumnpyramidSeriesStatesHoverMarkerStates States_DefaultValue { get; set; }
