...
{
	public partial class ColumnpyramidSeriesStatesSelect  : BaseObject
	{
		Hashtable h = new Hashtable();

		public ColumnpyramidSeriesStatesSelect()
		{
			Animation = Animation_DefaultValue = new Animation() { Enabled = true };
			Enabled = Enabled_DefaultValue = null;
			Halo = Halo_DefaultValue = new ColumnpyramidSeriesStatesSelectHalo();
			LineWidth = LineWidth_DefaultValue = null;
			LineWidthPlus = LineWidthPlus_DefaultValue = null;
			Marker = Marker_DefaultValue = new ColumnpyramidSeriesStatesSelectMarker();
		...
		/// </summary>
		public ColumnpyramidSeriesStatesSelectHalo Halo { get; set; }
		private ColumnpyramidSeriesStatesSelectHalo Halo_DefaultValue { get; set; }
		...
		/// </summary>
		public ColumnpyramidSeriesStatesSelectMarker Marker { get; set; }
		private ColumnpyramidSeriesStatesSelectMarker Marker_DefaultValue { get; set; }
