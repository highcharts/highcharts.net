...
{
	public partial class ColumnpyramidSeriesStatesSelectMarker  : BaseObject
	{
		Hashtable h = new Hashtable();

		public ColumnpyramidSeriesStatesSelectMarker()
		{
			...
			States = States_DefaultValue = new ColumnpyramidSeriesStatesSelectMarkerStates();
		...
		/// </summary>
		public ColumnpyramidSeriesStatesSelectMarkerStates States { get; set; }
		private ColumnpyramidSeriesStatesSelectMarkerStates States_DefaultValue { get; set; }
