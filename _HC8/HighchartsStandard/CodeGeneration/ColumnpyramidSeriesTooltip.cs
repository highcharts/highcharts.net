...
namespace Highsoft.Web.Mvc.Charts
{
	public partial class ColumnpyramidSeriesTooltip  : BaseObject
	{
		...
		internal override Hashtable ToHashtable()
		{
			...
			if (NullFormatter != NullFormatter_DefaultValue) { h.Add("nullFormatter",NullFormatter); Highcharts.AddFunction("fc40a2b1-7fbf-4faf-8e30-9c51689989dc.nullFormatter", NullFormatter); }  
			if (PointFormat != PointFormat_DefaultValue) h.Add("pointFormat",PointFormat);
			if (PointFormatter != PointFormatter_DefaultValue) { h.Add("pointFormatter",PointFormatter); Highcharts.AddFunction("70474a53-78db-4e20-a665-54ad36ccdfae.pointFormatter", PointFormatter); }  
