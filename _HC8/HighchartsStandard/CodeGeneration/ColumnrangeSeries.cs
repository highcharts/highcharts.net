...
namespace Highsoft.Web.Mvc.Charts
{
	public partial class ColumnrangeSeries  : Series
	{
		...
		internal override Hashtable ToHashtable()
		{
			...
			if (PointDescriptionFormatter != PointDescriptionFormatter_DefaultValue) { h.Add("pointDescriptionFormatter",PointDescriptionFormatter); Highcharts.AddFunction("3cc6dd6d-c734-44e4-9346-6378c3fac063.pointDescriptionFormatter", PointDescriptionFormatter); }  
