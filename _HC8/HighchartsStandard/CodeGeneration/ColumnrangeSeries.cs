...
namespace Highsoft.Web.Mvc.Charts
{
	public partial class ColumnrangeSeries  : Series
	{
		...
		internal override Hashtable ToHashtable()
		{
			...
			if (PointDescriptionFormatter != PointDescriptionFormatter_DefaultValue) { h.Add("pointDescriptionFormatter",PointDescriptionFormatter); Highcharts.AddFunction("ac443436-d632-41d7-ac35-d042f7bc91e6.pointDescriptionFormatter", PointDescriptionFormatter); }  
