...
namespace Highsoft.Web.Mvc.Charts
{
	public partial class ColumnrangeSeriesDataDragDropDragHandle  : BaseObject
	{
		...
		internal override Hashtable ToHashtable()
		{
			...
			if (PathFormatter != PathFormatter_DefaultValue) { h.Add("pathFormatter",PathFormatter); Highcharts.AddFunction("1562e185-4644-45ad-8310-a43853613b0d.pathFormatter", PathFormatter); }  
