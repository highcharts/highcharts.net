...
namespace Highsoft.Web.Mvc.Charts
{
	public partial class ColumnrangeSeriesDataDragDropDragHandle  : BaseObject
	{
		...
		internal override Hashtable ToHashtable()
		{
			...
			if (PathFormatter != PathFormatter_DefaultValue) { h.Add("pathFormatter",PathFormatter); Highcharts.AddFunction("ff9c77ab-6bbd-4408-8ccc-f49e9b0d3dfd.pathFormatter", PathFormatter); }  
