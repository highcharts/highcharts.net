...
namespace Highsoft.Web.Mvc.Charts
{
	public partial class ColumnrangeSeriesDataLabels  : BaseObject
	{
		...
		public ColumnrangeSeriesDataLabels()
		{
			...
			Style = Style_DefaultValue = new ColumnrangeSeriesDataLabelsStyle();
			TextPath = TextPath_DefaultValue = new ColumnrangeSeriesDataLabelsTextPath();
		...
		/// </summary>
		public ColumnrangeSeriesDataLabelsStyle Style { get; set; }
		private ColumnrangeSeriesDataLabelsStyle Style_DefaultValue { get; set; }
		...
		/// </summary>
		public ColumnrangeSeriesDataLabelsTextPath TextPath { get; set; }
		private ColumnrangeSeriesDataLabelsTextPath TextPath_DefaultValue { get; set; }
		...
		internal override Hashtable ToHashtable()
		{
			...
			if (Formatter != Formatter_DefaultValue) { h.Add("formatter",Formatter); Highcharts.AddFunction("ed25e2ee-0e64-49c3-b2bc-28fe324cfede.formatter", Formatter); }  
			...
			if (NullFormatter != NullFormatter_DefaultValue) { h.Add("nullFormatter",NullFormatter); Highcharts.AddFunction("3400b8d4-9b6a-4741-b970-4231690bd2b9.nullFormatter", NullFormatter); }  
