...
{
	public partial class ColumnrangeSeriesDataMarker  : BaseObject
	{
		Hashtable h = new Hashtable();

		public ColumnrangeSeriesDataMarker()
		{
			...
			States = States_DefaultValue = new ColumnrangeSeriesDataMarkerStates();
		...
		/// </summary>
		public ColumnrangeSeriesDataMarkerStates States { get; set; }
		private ColumnrangeSeriesDataMarkerStates States_DefaultValue { get; set; }
