...
namespace Highsoft.Web.Mvc.Charts
{
	public partial class ColumnrangeSeriesDragDropDragHandle  : BaseObject
	{
		...
		internal override Hashtable ToHashtable()
		{
			...
			if (PathFormatter != PathFormatter_DefaultValue) { h.Add("pathFormatter",PathFormatter); Highcharts.AddFunction("d78d02c3-2643-437b-b634-bded6270f204.pathFormatter", PathFormatter); }  
