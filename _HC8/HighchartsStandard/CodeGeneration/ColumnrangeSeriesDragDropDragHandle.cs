...
namespace Highsoft.Web.Mvc.Charts
{
	public partial class ColumnrangeSeriesDragDropDragHandle  : BaseObject
	{
		...
		internal override Hashtable ToHashtable()
		{
			...
			if (PathFormatter != PathFormatter_DefaultValue) { h.Add("pathFormatter",PathFormatter); Highcharts.AddFunction("0cfdf787-26e1-452f-a4de-2750572e8393.pathFormatter", PathFormatter); }  
