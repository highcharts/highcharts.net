...
{
	public partial class ColumnrangeSeriesSonificationTracks  : BaseObject
	{
		Hashtable h = new Hashtable();

		public ColumnrangeSeriesSonificationTracks()
		{
			ActiveWhen = ActiveWhen_DefaultValue = new ColumnrangeSeriesSonificationTracksActiveWhen();
			Instrument = Instrument_DefaultValue = null;
			InstrumentString = InstrumentString_DefaultValue = "null";
			Mapping = Mapping_DefaultValue = new ColumnrangeSeriesSonificationTracksMapping();
			MidiName = MidiName_DefaultValue = "";
			PointGrouping = PointGrouping_DefaultValue = new ColumnrangeSeriesSonificationTracksPointGrouping();
			RoundToMusicalNotes = RoundToMusicalNotes_DefaultValue = true;
			ShowPlayMarker = ShowPlayMarker_DefaultValue = true;
			Type = Type_DefaultValue = ColumnrangeSeriesSonificationTracksType.Instrument;
		...
		/// </summary>
		public ColumnrangeSeriesSonificationTracksActiveWhen ActiveWhen { get; set; }
		private ColumnrangeSeriesSonificationTracksActiveWhen ActiveWhen_DefaultValue { get; set; }
		...
		/// </summary>
		public ColumnrangeSeriesSonificationTracksMapping Mapping { get; set; }
		private ColumnrangeSeriesSonificationTracksMapping Mapping_DefaultValue { get; set; }
		...
		/// </summary>
		public ColumnrangeSeriesSonificationTracksPointGrouping PointGrouping { get; set; }
		private ColumnrangeSeriesSonificationTracksPointGrouping PointGrouping_DefaultValue { get; set; }
		...
		/// </summary>
		public ColumnrangeSeriesSonificationTracksType Type { get; set; }
		private ColumnrangeSeriesSonificationTracksType Type_DefaultValue { get; set; }
