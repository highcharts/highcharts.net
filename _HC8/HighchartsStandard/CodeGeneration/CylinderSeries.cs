...
namespace Highsoft.Web.Mvc.Charts
{
	public partial class CylinderSeries  : Series
	{
		...
		public CylinderSeries()
		{
			...
			Type = Type_DefaultValue = CylinderSeriesType.Cylinder;
		...
		internal override Hashtable ToHashtable()
		{
			...
			if (PointDescriptionFormatter != PointDescriptionFormatter_DefaultValue) { h.Add("pointDescriptionFormatter",PointDescriptionFormatter); Highcharts.AddFunction("bbb6f482-6028-4166-82cd-e291e4d4e17b.pointDescriptionFormatter", PointDescriptionFormatter); }  
