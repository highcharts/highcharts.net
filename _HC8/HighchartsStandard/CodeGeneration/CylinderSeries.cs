...
{
	public partial class CylinderSeries  : Series
	{
		Hashtable h = new Hashtable();

		public CylinderSeries()
		{
			Accessibility = Accessibility_DefaultValue = new CylinderSeriesAccessibility();
			AllowPointSelect = AllowPointSelect_DefaultValue = false;
			Animation = Animation_DefaultValue = new Animation() { Enabled = true };
			AnimationLimit = AnimationLimit_DefaultValue = null;
			BoostBlending = BoostBlending_DefaultValue = CylinderSeriesBoostBlending.Undefined;
			...
			Cursor = Cursor_DefaultValue = CylinderSeriesCursor.Null;
			Custom = Custom_DefaultValue = new Hashtable();
			DashStyle = DashStyle_DefaultValue = CylinderSeriesDashStyle.Null;
			Data = Data_DefaultValue = new List<CylinderSeriesData>();
			...
			DragDrop = DragDrop_DefaultValue = new CylinderSeriesDragDrop();
			EdgeColor = EdgeColor_DefaultValue = "";
			EdgeWidth = EdgeWidth_DefaultValue = 1;
			EnableMouseTracking = EnableMouseTracking_DefaultValue = true;
			Events = Events_DefaultValue = new CylinderSeriesEvents();
			FindNearestPointBy = FindNearestPointBy_DefaultValue = CylinderSeriesFindNearestPointBy.X;
			...
			Label = Label_DefaultValue = new CylinderSeriesLabel();
			...
			Point = Point_DefaultValue = new CylinderSeriesPoint();
			PointDescriptionFormatter = PointDescriptionFormatter_DefaultValue = "";
			PointInterval = PointInterval_DefaultValue = 1;
			PointIntervalUnit = PointIntervalUnit_DefaultValue = CylinderSeriesPointIntervalUnit.Null;
			...
			Stacking = Stacking_DefaultValue = CylinderSeriesStacking.Null;
			States = States_DefaultValue = new CylinderSeriesStates();
			StickyTracking = StickyTracking_DefaultValue = true;
			Threshold = Threshold_DefaultValue = 0;
			Tooltip = Tooltip_DefaultValue = new CylinderSeriesTooltip();
			...
			Zones = Zones_DefaultValue = new List<CylinderSeriesZone>();
		...
		/// </summary>
		public CylinderSeriesAccessibility Accessibility { get; set; }
		private CylinderSeriesAccessibility Accessibility_DefaultValue { get; set; }
		...
		/// </summary>
		public CylinderSeriesBoostBlending BoostBlending { get; set; }
		private CylinderSeriesBoostBlending BoostBlending_DefaultValue { get; set; }
		...
		/// </summary>
		public CylinderSeriesCursor Cursor { get; set; }
		private CylinderSeriesCursor Cursor_DefaultValue { get; set; }
		...
		/// </summary>
		public CylinderSeriesDataLabels DataLabels { get; set; }
		private CylinderSeriesDataLabels DataLabels_DefaultValue { get; set; }
		 

		/// <summary>
		/// Options for the series data sorting.
		/// </summary>
		public CylinderSeriesDataSorting DataSorting { get; set; }
		private CylinderSeriesDataSorting DataSorting_DefaultValue { get; set; }
		...
		/// </summary>
		public CylinderSeriesDragDrop DragDrop { get; set; }
		private CylinderSeriesDragDrop DragDrop_DefaultValue { get; set; }
		...
		/// </summary>
		public CylinderSeriesEvents Events { get; set; }
		private CylinderSeriesEvents Events_DefaultValue { get; set; }
		...
		/// </summary>
		public CylinderSeriesFindNearestPointBy FindNearestPointBy { get; set; }
		private CylinderSeriesFindNearestPointBy FindNearestPointBy_DefaultValue { get; set; }
		...
		/// </summary>
		public CylinderSeriesLabel Label { get; set; }
		private CylinderSeriesLabel Label_DefaultValue { get; set; }
		...
		/// </summary>
		public CylinderSeriesPoint Point { get; set; }
		private CylinderSeriesPoint Point_DefaultValue { get; set; }
		...
		/// </summary>
		public CylinderSeriesPointIntervalUnit PointIntervalUnit { get; set; }
		private CylinderSeriesPointIntervalUnit PointIntervalUnit_DefaultValue { get; set; }
		...
		/// </summary>
		public CylinderSeriesStacking Stacking { get; set; }
		private CylinderSeriesStacking Stacking_DefaultValue { get; set; }
		 

		/// <summary>
		/// 
		/// </summary>
		public CylinderSeriesStates States { get; set; }
		private CylinderSeriesStates States_DefaultValue { get; set; }
		...
		/// </summary>
		public CylinderSeriesTooltip Tooltip { get; set; }
		private CylinderSeriesTooltip Tooltip_DefaultValue { get; set; }
		...
		/// </summary>
		public List<CylinderSeriesZone> Zones { get; set; }
		private List<CylinderSeriesZone> Zones_DefaultValue { get; set; }
		...
		internal override Hashtable ToHashtable()
		{
			...
			if (PointDescriptionFormatter != PointDescriptionFormatter_DefaultValue) { h.Add("pointDescriptionFormatter",PointDescriptionFormatter); Highcharts.AddFunction("53457190-c87f-4e21-8d2f-c15861a06a45.pointDescriptionFormatter", PointDescriptionFormatter); }  
