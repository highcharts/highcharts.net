...
{
	public partial class CylinderSeriesData  : BaseObject
	{
		Hashtable h = new Hashtable();

		public CylinderSeriesData()
		{
			Accessibility = Accessibility_DefaultValue = new CylinderSeriesDataAccessibility();
			...
			Events = Events_DefaultValue = new CylinderSeriesDataEvents();
			Id = Id_DefaultValue = "";
			Labelrank = Labelrank_DefaultValue = null;
			Marker = Marker_DefaultValue = new CylinderSeriesDataMarker();
		...
		/// </summary>
		public CylinderSeriesDataAccessibility Accessibility { get; set; }
		private CylinderSeriesDataAccessibility Accessibility_DefaultValue { get; set; }
		...
		/// </summary>
		public CylinderSeriesDataDragDrop DragDrop { get; set; }
		private CylinderSeriesDataDragDrop DragDrop_DefaultValue { get; set; }
		...
		/// </summary>
		public CylinderSeriesDataEvents Events { get; set; }
		private CylinderSeriesDataEvents Events_DefaultValue { get; set; }
		...
		/// </summary>
		public CylinderSeriesDataMarker Marker { get; set; }
		private CylinderSeriesDataMarker Marker_DefaultValue { get; set; }
