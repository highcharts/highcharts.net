...
{
	public partial class CylinderSeriesDataDragDrop  : BaseObject
	{
		Hashtable h = new Hashtable();

		public CylinderSeriesDataDragDrop()
		{
			DraggableX = DraggableX_DefaultValue = null;
			DraggableY = DraggableY_DefaultValue = null;
			DragHandle = DragHandle_DefaultValue = new CylinderSeriesDataDragDropDragHandle();
			...
			GuideBox = GuideBox_DefaultValue = new CylinderSeriesDataDragDropGuideBox();
		...
		/// </summary>
		public CylinderSeriesDataDragDropDragHandle DragHandle { get; set; }
		private CylinderSeriesDataDragDropDragHandle DragHandle_DefaultValue { get; set; }
		...
		/// </summary>
		public CylinderSeriesDataDragDropGuideBox GuideBox { get; set; }
		private CylinderSeriesDataDragDropGuideBox GuideBox_DefaultValue { get; set; }
