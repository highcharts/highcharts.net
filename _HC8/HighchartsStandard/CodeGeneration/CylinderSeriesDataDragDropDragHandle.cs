...
namespace Highsoft.Web.Mvc.Charts
{
	public partial class CylinderSeriesDataDragDropDragHandle  : BaseObject
	{
		...
		internal override Hashtable ToHashtable()
		{
			...
			if (PathFormatter != PathFormatter_DefaultValue) { h.Add("pathFormatter",PathFormatter); Highcharts.AddFunction("15e4b371-175b-4106-b4ec-b2d631bbd4a5.pathFormatter", PathFormatter); }  
