...
namespace Highsoft.Web.Mvc.Charts
{
	public partial class CylinderSeriesDataDragDropDragHandle  : BaseObject
	{
		...
		internal override Hashtable ToHashtable()
		{
			...
			if (PathFormatter != PathFormatter_DefaultValue) { h.Add("pathFormatter",PathFormatter); Highcharts.AddFunction("c71ff3d4-12d4-4e20-b63f-445fc82a59d7.pathFormatter", PathFormatter); }  
