...
namespace Highsoft.Web.Mvc.Charts
{
	public partial class CylinderSeriesDataDragDropDragHandle  : BaseObject
	{
		...
		internal override Hashtable ToHashtable()
		{
			...
			if (PathFormatter != PathFormatter_DefaultValue) { h.Add("pathFormatter",PathFormatter); Highcharts.AddFunction("6090b829-c741-470c-9af2-ccdfbedd7b40.pathFormatter", PathFormatter); }  
