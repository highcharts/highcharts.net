...
{
	public partial class CylinderSeriesDataLabels  : BaseObject
	{
		Hashtable h = new Hashtable();

		public CylinderSeriesDataLabels()
		{
			Align = Align_DefaultValue = CylinderSeriesDataLabelsAlign.Center;
			...
			Filter = Filter_DefaultValue = new CylinderSeriesDataLabelsFilter();
			...
			Style = Style_DefaultValue = new CylinderSeriesDataLabelsStyle();
			TextPath = TextPath_DefaultValue = new CylinderSeriesDataLabelsTextPath();
			UseHTML = UseHTML_DefaultValue = false;
			VerticalAlign = VerticalAlign_DefaultValue = CylinderSeriesDataLabelsVerticalAlign.Bottom;
			X = X_DefaultValue = 0;
			Y = Y_DefaultValue = 0;
			Z = Z_DefaultValue = 6;
		...
		/// </summary>
		public CylinderSeriesDataLabelsAlign Align { get; set; }
		private CylinderSeriesDataLabelsAlign Align_DefaultValue { get; set; }
		...
		/// </summary>
		public CylinderSeriesDataLabelsFilter Filter { get; set; }
		private CylinderSeriesDataLabelsFilter Filter_DefaultValue { get; set; }
		...
		/// </summary>
		public CylinderSeriesDataLabelsStyle Style { get; set; }
		private CylinderSeriesDataLabelsStyle Style_DefaultValue { get; set; }
		...
		/// </summary>
		public CylinderSeriesDataLabelsTextPath TextPath { get; set; }
		private CylinderSeriesDataLabelsTextPath TextPath_DefaultValue { get; set; }
		...
		/// </summary>
		public CylinderSeriesDataLabelsVerticalAlign VerticalAlign { get; set; }
		private CylinderSeriesDataLabelsVerticalAlign VerticalAlign_DefaultValue { get; set; }
		...
		internal override Hashtable ToHashtable()
		{
			...
			if (Formatter != Formatter_DefaultValue) { h.Add("formatter",Formatter); Highcharts.AddFunction("2fa8f461-6dc2-4210-9c7b-bab86a04ba92.formatter", Formatter); }  
			...
			if (NullFormatter != NullFormatter_DefaultValue) { h.Add("nullFormatter",NullFormatter); Highcharts.AddFunction("ca2c60a2-494e-465e-a061-2af902bd250b.nullFormatter", NullFormatter); }  
