...
{
	public partial class CylinderSeriesDataMarker  : BaseObject
	{
		Hashtable h = new Hashtable();

		public CylinderSeriesDataMarker()
		{
			...
			States = States_DefaultValue = new CylinderSeriesDataMarkerStates();
		...
		/// </summary>
		public CylinderSeriesDataMarkerStates States { get; set; }
		private CylinderSeriesDataMarkerStates States_DefaultValue { get; set; }
