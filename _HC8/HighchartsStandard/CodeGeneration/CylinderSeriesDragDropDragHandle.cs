...
namespace Highsoft.Web.Mvc.Charts
{
	public partial class CylinderSeriesDragDropDragHandle  : BaseObject
	{
		...
		internal override Hashtable ToHashtable()
		{
			...
			if (PathFormatter != PathFormatter_DefaultValue) { h.Add("pathFormatter",PathFormatter); Highcharts.AddFunction("d1d40ddb-0804-43a9-9da4-24297a162579.pathFormatter", PathFormatter); }  
