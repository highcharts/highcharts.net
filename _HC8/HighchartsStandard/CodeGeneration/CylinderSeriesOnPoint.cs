...
{
	public partial class CylinderSeriesOnPoint  : BaseObject
	{
		Hashtable h = new Hashtable();

		public CylinderSeriesOnPoint()
		{
			ConnectorOptions = ConnectorOptions_DefaultValue = new CylinderSeriesOnPointConnectorOptions();
			Id = Id_DefaultValue = "";
			Position = Position_DefaultValue = new CylinderSeriesOnPointPosition();
		...
		/// </summary>
		public CylinderSeriesOnPointConnectorOptions ConnectorOptions { get; set; }
		private CylinderSeriesOnPointConnectorOptions ConnectorOptions_DefaultValue { get; set; }
		...
		/// </summary>
		public CylinderSeriesOnPointPosition Position { get; set; }
		private CylinderSeriesOnPointPosition Position_DefaultValue { get; set; }
