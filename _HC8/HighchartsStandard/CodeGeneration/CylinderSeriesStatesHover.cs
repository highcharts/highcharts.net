...
{
	public partial class CylinderSeriesStatesHover  : BaseObject
	{
		Hashtable h = new Hashtable();

		public CylinderSeriesStatesHover()
		{
			Animation = Animation_DefaultValue = new Animation();
			Enabled = Enabled_DefaultValue = null;
			Halo = Halo_DefaultValue = new CylinderSeriesStatesHoverHalo();
			LineWidth = LineWidth_DefaultValue = null;
			LineWidthPlus = LineWidthPlus_DefaultValue = null;
			Marker = Marker_DefaultValue = new CylinderSeriesStatesHoverMarker();
		...
		/// </summary>
		public CylinderSeriesStatesHoverHalo Halo { get; set; }
		private CylinderSeriesStatesHoverHalo Halo_DefaultValue { get; set; }
		...
		/// </summary>
		public CylinderSeriesStatesHoverMarker Marker { get; set; }
		private CylinderSeriesStatesHoverMarker Marker_DefaultValue { get; set; }
