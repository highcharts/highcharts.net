...
{
	public partial class CylinderSeriesStatesSelect  : BaseObject
	{
		Hashtable h = new Hashtable();

		public CylinderSeriesStatesSelect()
		{
			Animation = Animation_DefaultValue = new Animation();
			Enabled = Enabled_DefaultValue = null;
			Halo = Halo_DefaultValue = new CylinderSeriesStatesSelectHalo();
			LineWidth = LineWidth_DefaultValue = null;
			LineWidthPlus = LineWidthPlus_DefaultValue = null;
			Marker = Marker_DefaultValue = new CylinderSeriesStatesSelectMarker();
		...
		/// </summary>
		public CylinderSeriesStatesSelectHalo Halo { get; set; }
		private CylinderSeriesStatesSelectHalo Halo_DefaultValue { get; set; }
		...
		/// </summary>
		public CylinderSeriesStatesSelectMarker Marker { get; set; }
		private CylinderSeriesStatesSelectMarker Marker_DefaultValue { get; set; }
