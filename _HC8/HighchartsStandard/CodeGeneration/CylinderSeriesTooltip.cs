...
namespace Highsoft.Web.Mvc.Charts
{
	public partial class CylinderSeriesTooltip  : BaseObject
	{
		...
		internal override Hashtable ToHashtable()
		{
			...
			if (NullFormatter != NullFormatter_DefaultValue) { h.Add("nullFormatter",NullFormatter); Highcharts.AddFunction("ed66d551-13f7-43e4-8303-0191a455fd7e.nullFormatter", NullFormatter); }  
			if (PointFormat != PointFormat_DefaultValue) h.Add("pointFormat",PointFormat);
			if (PointFormatter != PointFormatter_DefaultValue) { h.Add("pointFormatter",PointFormatter); Highcharts.AddFunction("23a02910-49a9-4e3b-95da-a684730d6af8.pointFormatter", PointFormatter); }  
