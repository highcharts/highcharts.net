...
{
	public partial class CylinderSeriesTooltip  : BaseObject
	{
		Hashtable h = new Hashtable();

		public CylinderSeriesTooltip()
		{
			...
			HeaderShape = HeaderShape_DefaultValue = CylinderSeriesTooltipHeaderShape.Callout;
		...
		/// </summary>
		public CylinderSeriesTooltipHeaderShape HeaderShape { get; set; }
		private CylinderSeriesTooltipHeaderShape HeaderShape_DefaultValue { get; set; }
		...
		internal override Hashtable ToHashtable()
		{
			...
			if (NullFormatter != NullFormatter_DefaultValue) { h.Add("nullFormatter",NullFormatter); Highcharts.AddFunction("12ac32c1-def6-4048-ad46-6f976a416079.nullFormatter", NullFormatter); }  
			if (Outside != Outside_DefaultValue) h.Add("outside",Outside);
			if (Padding != Padding_DefaultValue) h.Add("padding",Padding);
			if (PointFormat != PointFormat_DefaultValue) h.Add("pointFormat",PointFormat);
			if (PointFormatter != PointFormatter_DefaultValue) { h.Add("pointFormatter",PointFormatter); Highcharts.AddFunction("84631aa7-6c84-4d87-bcaf-f263df7d0100.pointFormatter", PointFormatter); }  
