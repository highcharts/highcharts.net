...
namespace Highsoft.Web.Mvc.Charts
{
	public partial class DependencywheelSeries  : Series
	{
		...
		internal override Hashtable ToHashtable()
		{
			...
			if (PointDescriptionFormatter != PointDescriptionFormatter_DefaultValue) { h.Add("pointDescriptionFormatter",PointDescriptionFormatter); Highcharts.AddFunction("18d42669-6086-48cc-8694-b836bc93e88f.pointDescriptionFormatter", PointDescriptionFormatter); }  
