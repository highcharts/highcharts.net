...
namespace Highsoft.Web.Mvc.Charts
{
	public partial class DependencywheelSeries  : Series
	{
		...
		public DependencywheelSeries()
		{
			...
			DashStyle = DashStyle_DefaultValue = DependencywheelSeriesDashStyle.Null;
		...
		/// </summary>
		public DependencywheelSeriesDashStyle DashStyle { get; set; }
		private DependencywheelSeriesDashStyle DashStyle_DefaultValue { get; set; }
		...
		internal override Hashtable ToHashtable()
		{
			...
			if (PointDescriptionFormatter != PointDescriptionFormatter_DefaultValue) { h.Add("pointDescriptionFormatter",PointDescriptionFormatter); Highcharts.AddFunction("5f678c94-9bd0-4317-ace1-da23180adf63.pointDescriptionFormatter", PointDescriptionFormatter); }  
