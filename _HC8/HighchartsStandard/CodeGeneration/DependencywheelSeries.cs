...
namespace Highsoft.Web.Mvc.Charts
{
	public partial class DependencywheelSeries  : Series
	{
		...
		internal override Hashtable ToHashtable()
		{
			...
			if (PointDescriptionFormatter != PointDescriptionFormatter_DefaultValue) { h.Add("pointDescriptionFormatter",PointDescriptionFormatter); Highcharts.AddFunction("d2e1e217-d98a-4f63-b1b1-d694517fe8a0.pointDescriptionFormatter", PointDescriptionFormatter); }  
