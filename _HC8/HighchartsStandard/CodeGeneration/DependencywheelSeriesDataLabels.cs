...
namespace Highsoft.Web.Mvc.Charts
{
	public partial class DependencywheelSeriesDataLabels  : BaseObject
	{
		...
		public DependencywheelSeriesDataLabels()
		{
			...
			Overflow = Overflow_DefaultValue = DependencywheelSeriesDataLabelsOverflow.Justify;
			Padding = Padding_DefaultValue = 5;
			Position = Position_DefaultValue = DependencywheelSeriesDataLabelsPosition.Center;
