...
{
	public partial class DependencywheelSeriesDataLabels  : BaseObject
	{
		Hashtable h = new Hashtable();

		public DependencywheelSeriesDataLabels()
		{
			Align = Align_DefaultValue = DependencywheelSeriesDataLabelsAlign.Center;
			...
			Filter = Filter_DefaultValue = new DependencywheelSeriesDataLabelsFilter();
			...
			Style = Style_DefaultValue = new DependencywheelSeriesDataLabelsStyle();
			TextPath = TextPath_DefaultValue = new DependencywheelSeriesDataLabelsTextPath();
			UseHTML = UseHTML_DefaultValue = false;
			VerticalAlign = VerticalAlign_DefaultValue = DependencywheelSeriesDataLabelsVerticalAlign.Bottom;
			X = X_DefaultValue = 0;
			Y = Y_DefaultValue = 0;
			Z = Z_DefaultValue = 6;
		...
		/// </summary>
		public DependencywheelSeriesDataLabelsAlign Align { get; set; }
		private DependencywheelSeriesDataLabelsAlign Align_DefaultValue { get; set; }
		...
		/// </summary>
		public DependencywheelSeriesDataLabelsFilter Filter { get; set; }
		private DependencywheelSeriesDataLabelsFilter Filter_DefaultValue { get; set; }
		...
		/// </summary>
		public DependencywheelSeriesDataLabelsStyle Style { get; set; }
		private DependencywheelSeriesDataLabelsStyle Style_DefaultValue { get; set; }
		...
		/// </summary>
		public DependencywheelSeriesDataLabelsTextPath TextPath { get; set; }
		private DependencywheelSeriesDataLabelsTextPath TextPath_DefaultValue { get; set; }
		...
		/// </summary>
		public DependencywheelSeriesDataLabelsVerticalAlign VerticalAlign { get; set; }
		private DependencywheelSeriesDataLabelsVerticalAlign VerticalAlign_DefaultValue { get; set; }
		...
		internal override Hashtable ToHashtable()
		{
			...
			if (Formatter != Formatter_DefaultValue) { h.Add("formatter",Formatter); Highcharts.AddFunction("93116e8b-17b2-4ca1-a7a6-ce1520392340.formatter", Formatter); }  
			if (Inside != Inside_DefaultValue) h.Add("inside",Inside);
			if (NullFormat != NullFormat_DefaultValue) h.Add("nullFormat",NullFormat);
			if (NullFormatter != NullFormatter_DefaultValue) { h.Add("nullFormatter",NullFormatter); Highcharts.AddFunction("4a483ed8-447d-452c-8db3-375ca1211355.nullFormatter", NullFormatter); }  
