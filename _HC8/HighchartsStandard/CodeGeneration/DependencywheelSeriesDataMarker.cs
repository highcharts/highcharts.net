...
{
	public partial class DependencywheelSeriesDataMarker  : BaseObject
	{
		Hashtable h = new Hashtable();

		public DependencywheelSeriesDataMarker()
		{
			...
			States = States_DefaultValue = new DependencywheelSeriesDataMarkerStates();
		...
		/// </summary>
		public DependencywheelSeriesDataMarkerStates States { get; set; }
		private DependencywheelSeriesDataMarkerStates States_DefaultValue { get; set; }
