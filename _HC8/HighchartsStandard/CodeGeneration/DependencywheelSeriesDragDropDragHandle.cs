...
namespace Highsoft.Web.Mvc.Charts
{
	public partial class DependencywheelSeriesDragDropDragHandle  : BaseObject
	{
		...
		internal override Hashtable ToHashtable()
		{
			...
			if (PathFormatter != PathFormatter_DefaultValue) { h.Add("pathFormatter",PathFormatter); Highcharts.AddFunction("51694848-f4d3-4ca7-88be-fa2d647a1dd7.pathFormatter", PathFormatter); }  
