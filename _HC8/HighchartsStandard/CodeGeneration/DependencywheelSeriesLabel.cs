...
{
	public partial class DependencywheelSeriesLabel  : BaseObject
	{
		Hashtable h = new Hashtable();

		public DependencywheelSeriesLabel()
		{
			...
			Style = Style_DefaultValue = new DependencywheelSeriesLabelStyle();
		...
		/// </summary>
		public DependencywheelSeriesLabelStyle Style { get; set; }
		private DependencywheelSeriesLabelStyle Style_DefaultValue { get; set; }
		...
		internal override Hashtable ToHashtable()
		{
			...
			if (Formatter != Formatter_DefaultValue) { h.Add("formatter",Formatter); Highcharts.AddFunction("082d9b2f-029c-414e-90da-8c7b158fafdb.formatter", Formatter); }  
