...
{
	public partial class DependencywheelSeriesOnPoint  : BaseObject
	{
		Hashtable h = new Hashtable();

		public DependencywheelSeriesOnPoint()
		{
			ConnectorOptions = ConnectorOptions_DefaultValue = new DependencywheelSeriesOnPointConnectorOptions();
			Id = Id_DefaultValue = "";
			Position = Position_DefaultValue = new DependencywheelSeriesOnPointPosition();
		...
		/// </summary>
		public DependencywheelSeriesOnPointConnectorOptions ConnectorOptions { get; set; }
		private DependencywheelSeriesOnPointConnectorOptions ConnectorOptions_DefaultValue { get; set; }
		...
		/// </summary>
		public DependencywheelSeriesOnPointPosition Position { get; set; }
		private DependencywheelSeriesOnPointPosition Position_DefaultValue { get; set; }
