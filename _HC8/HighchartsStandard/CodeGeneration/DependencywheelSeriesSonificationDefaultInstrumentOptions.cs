...
{
	public partial class DependencywheelSeriesSonificationDefaultInstrumentOptions  : BaseObject
	{
		Hashtable h = new Hashtable();

		public DependencywheelSeriesSonificationDefaultInstrumentOptions()
		{
			ActiveWhen = ActiveWhen_DefaultValue = new DependencywheelSeriesSonificationDefaultInstrumentOptionsActiveWhen();
			Instrument = Instrument_DefaultValue = null;
			InstrumentString = InstrumentString_DefaultValue = "null";
			Mapping = Mapping_DefaultValue = new DependencywheelSeriesSonificationDefaultInstrumentOptionsMapping();
			MidiName = MidiName_DefaultValue = "";
			PointGrouping = PointGrouping_DefaultValue = new DependencywheelSeriesSonificationDefaultInstrumentOptionsPointGrouping();
			RoundToMusicalNotes = RoundToMusicalNotes_DefaultValue = true;
			ShowPlayMarker = ShowPlayMarker_DefaultValue = true;
			Type = Type_DefaultValue = DependencywheelSeriesSonificationDefaultInstrumentOptionsType.Instrument;
		...
		/// </summary>
		public DependencywheelSeriesSonificationDefaultInstrumentOptionsActiveWhen ActiveWhen { get; set; }
		private DependencywheelSeriesSonificationDefaultInstrumentOptionsActiveWhen ActiveWhen_DefaultValue { get; set; }
		...
		/// </summary>
		public DependencywheelSeriesSonificationDefaultInstrumentOptionsMapping Mapping { get; set; }
		private DependencywheelSeriesSonificationDefaultInstrumentOptionsMapping Mapping_DefaultValue { get; set; }
		...
		/// </summary>
		public DependencywheelSeriesSonificationDefaultInstrumentOptionsPointGrouping PointGrouping { get; set; }
		private DependencywheelSeriesSonificationDefaultInstrumentOptionsPointGrouping PointGrouping_DefaultValue { get; set; }
		...
		/// </summary>
		public DependencywheelSeriesSonificationDefaultInstrumentOptionsType Type { get; set; }
		private DependencywheelSeriesSonificationDefaultInstrumentOptionsType Type_DefaultValue { get; set; }
