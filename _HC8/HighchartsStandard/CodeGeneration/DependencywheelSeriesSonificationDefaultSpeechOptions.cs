...
{
	public partial class DependencywheelSeriesSonificationDefaultSpeechOptions  : BaseObject
	{
		Hashtable h = new Hashtable();

		public DependencywheelSeriesSonificationDefaultSpeechOptions()
		{
			ActiveWhen = ActiveWhen_DefaultValue = new DependencywheelSeriesSonificationDefaultSpeechOptionsActiveWhen();
			Language = Language_DefaultValue = "en-US";
			Mapping = Mapping_DefaultValue = new DependencywheelSeriesSonificationDefaultSpeechOptionsMapping();
			PointGrouping = PointGrouping_DefaultValue = new DependencywheelSeriesSonificationDefaultSpeechOptionsPointGrouping();
			PreferredVoice = PreferredVoice_DefaultValue = "";
			ShowPlayMarker = ShowPlayMarker_DefaultValue = true;
			Type = Type_DefaultValue = DependencywheelSeriesSonificationDefaultSpeechOptionsType.Instrument;
		...
		/// </summary>
		public DependencywheelSeriesSonificationDefaultSpeechOptionsActiveWhen ActiveWhen { get; set; }
		private DependencywheelSeriesSonificationDefaultSpeechOptionsActiveWhen ActiveWhen_DefaultValue { get; set; }
		...
		/// </summary>
		public DependencywheelSeriesSonificationDefaultSpeechOptionsMapping Mapping { get; set; }
		private DependencywheelSeriesSonificationDefaultSpeechOptionsMapping Mapping_DefaultValue { get; set; }
		 

		/// <summary>
		/// Options for point grouping, specifically for instrument tracks.
		/// </summary>
		public DependencywheelSeriesSonificationDefaultSpeechOptionsPointGrouping PointGrouping { get; set; }
		private DependencywheelSeriesSonificationDefaultSpeechOptionsPointGrouping PointGrouping_DefaultValue { get; set; }
		...
		/// </summary>
		public DependencywheelSeriesSonificationDefaultSpeechOptionsType Type { get; set; }
		private DependencywheelSeriesSonificationDefaultSpeechOptionsType Type_DefaultValue { get; set; }
