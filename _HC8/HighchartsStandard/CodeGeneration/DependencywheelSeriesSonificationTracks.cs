...
{
	public partial class DependencywheelSeriesSonificationTracks  : BaseObject
	{
		Hashtable h = new Hashtable();

		public DependencywheelSeriesSonificationTracks()
		{
			ActiveWhen = ActiveWhen_DefaultValue = new DependencywheelSeriesSonificationTracksActiveWhen();
			Instrument = Instrument_DefaultValue = null;
			InstrumentString = InstrumentString_DefaultValue = "null";
			Mapping = Mapping_DefaultValue = new DependencywheelSeriesSonificationTracksMapping();
			MidiName = MidiName_DefaultValue = "";
			PointGrouping = PointGrouping_DefaultValue = new DependencywheelSeriesSonificationTracksPointGrouping();
			RoundToMusicalNotes = RoundToMusicalNotes_DefaultValue = true;
			ShowPlayMarker = ShowPlayMarker_DefaultValue = true;
			Type = Type_DefaultValue = DependencywheelSeriesSonificationTracksType.Instrument;
		...
		/// </summary>
		public DependencywheelSeriesSonificationTracksActiveWhen ActiveWhen { get; set; }
		private DependencywheelSeriesSonificationTracksActiveWhen ActiveWhen_DefaultValue { get; set; }
		...
		/// </summary>
		public DependencywheelSeriesSonificationTracksMapping Mapping { get; set; }
		private DependencywheelSeriesSonificationTracksMapping Mapping_DefaultValue { get; set; }
		...
		/// </summary>
		public DependencywheelSeriesSonificationTracksPointGrouping PointGrouping { get; set; }
		private DependencywheelSeriesSonificationTracksPointGrouping PointGrouping_DefaultValue { get; set; }
		...
		/// </summary>
		public DependencywheelSeriesSonificationTracksType Type { get; set; }
		private DependencywheelSeriesSonificationTracksType Type_DefaultValue { get; set; }
