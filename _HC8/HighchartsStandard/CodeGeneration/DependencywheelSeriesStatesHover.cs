...
{
	public partial class DependencywheelSeriesStatesHover  : BaseObject
	{
		Hashtable h = new Hashtable();

		public DependencywheelSeriesStatesHover()
		{
			Animation = Animation_DefaultValue = new Animation() { Enabled = true };
			Enabled = Enabled_DefaultValue = null;
			Halo = Halo_DefaultValue = new DependencywheelSeriesStatesHoverHalo();
			LineWidth = LineWidth_DefaultValue = null;
			LineWidthPlus = LineWidthPlus_DefaultValue = null;
			Marker = Marker_DefaultValue = new DependencywheelSeriesStatesHoverMarker();
		...
		/// </summary>
		public DependencywheelSeriesStatesHoverHalo Halo { get; set; }
		private DependencywheelSeriesStatesHoverHalo Halo_DefaultValue { get; set; }
		...
		/// </summary>
		public DependencywheelSeriesStatesHoverMarker Marker { get; set; }
		private DependencywheelSeriesStatesHoverMarker Marker_DefaultValue { get; set; }
