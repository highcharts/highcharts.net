...
{
	public partial class DependencywheelSeriesStatesSelect  : BaseObject
	{
		Hashtable h = new Hashtable();

		public DependencywheelSeriesStatesSelect()
		{
			Animation = Animation_DefaultValue = new Animation();
			Enabled = Enabled_DefaultValue = null;
			Halo = Halo_DefaultValue = new DependencywheelSeriesStatesSelectHalo();
			LineWidth = LineWidth_DefaultValue = null;
			LineWidthPlus = LineWidthPlus_DefaultValue = null;
			Marker = Marker_DefaultValue = new DependencywheelSeriesStatesSelectMarker();
		...
		/// </summary>
		public DependencywheelSeriesStatesSelectHalo Halo { get; set; }
		private DependencywheelSeriesStatesSelectHalo Halo_DefaultValue { get; set; }
		...
		/// </summary>
		public DependencywheelSeriesStatesSelectMarker Marker { get; set; }
		private DependencywheelSeriesStatesSelectMarker Marker_DefaultValue { get; set; }
