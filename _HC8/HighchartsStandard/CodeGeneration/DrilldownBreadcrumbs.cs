...
namespace Highsoft.Web.Mvc.Charts
{
	public partial class DrilldownBreadcrumbs  : BaseObject
	{
		...
		public DrilldownBreadcrumbs()
		{
			...
			ButtonTheme = ButtonTheme_DefaultValue = new DrilldownBreadcrumbsButtonTheme();
			Events = Events_DefaultValue = new DrilldownBreadcrumbsEvents();
			Floating = Floating_DefaultValue = false;
			Format = Format_DefaultValue = "undefined";
			Formatter = Formatter_DefaultValue = "";
			Position = Position_DefaultValue = new DrilldownBreadcrumbsPosition();
		...
		private DrilldownBreadcrumbsButtonTheme ButtonTheme_DefaultValue { get; set; }
		...
		private DrilldownBreadcrumbsEvents Events_DefaultValue { get; set; }
		...
		private DrilldownBreadcrumbsPosition Position_DefaultValue { get; set; }
		...
		private DrilldownBreadcrumbsSeparator Separator_DefaultValue { get; set; }
