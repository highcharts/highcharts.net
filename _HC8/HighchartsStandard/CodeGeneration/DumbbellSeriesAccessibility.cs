...
namespace Highsoft.Web.Mvc.Charts
{
	public partial class DumbbellSeriesAccessibility  : BaseObject
	{
		...
		internal override Hashtable ToHashtable()
		{
			...
			if (PointDescriptionFormatter != PointDescriptionFormatter_DefaultValue) { h.Add("pointDescriptionFormatter",PointDescriptionFormatter); Highcharts.AddFunction("49991e00-cead-4157-83f4-558ee4223368.pointDescriptionFormatter", PointDescriptionFormatter); }  
