...
{
	public partial class DumbbellSeriesData  : BaseObject
	{
		Hashtable h = new Hashtable();

		public DumbbellSeriesData()
		{
			Accessibility = Accessibility_DefaultValue = new DumbbellSeriesDataAccessibility();
			...
			DragDrop = DragDrop_DefaultValue = new DumbbellSeriesDataDragDrop();
			Drilldown = Drilldown_DefaultValue = "";
			Events = Events_DefaultValue = new DumbbellSeriesDataEvents();
			High = High_DefaultValue = null;
			Id = Id_DefaultValue = "";
			Labelrank = Labelrank_DefaultValue = null;
			Low = Low_DefaultValue = null;
			LowColor = LowColor_DefaultValue = "#333333";
			Marker = Marker_DefaultValue = new DumbbellSeriesDataMarker();
		...
		/// </summary>
		public DumbbellSeriesDataAccessibility Accessibility { get; set; }
		private DumbbellSeriesDataAccessibility Accessibility_DefaultValue { get; set; }
		...
		/// </summary>
		public DumbbellSeriesDataEvents Events { get; set; }
		private DumbbellSeriesDataEvents Events_DefaultValue { get; set; }
		...
		/// </summary>
		public DumbbellSeriesDataMarker Marker { get; set; }
		private DumbbellSeriesDataMarker Marker_DefaultValue { get; set; }
