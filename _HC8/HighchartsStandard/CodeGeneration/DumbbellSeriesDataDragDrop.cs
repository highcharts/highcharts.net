...
{
	public partial class DumbbellSeriesDataDragDrop  : BaseObject
	{
		Hashtable h = new Hashtable();

		public DumbbellSeriesDataDragDrop()
		{
			DraggableX = DraggableX_DefaultValue = null;
			DraggableY = DraggableY_DefaultValue = null;
			DragHandle = DragHandle_DefaultValue = new DumbbellSeriesDataDragDropDragHandle();
			...
			GuideBox = GuideBox_DefaultValue = new DumbbellSeriesDataDragDropGuideBox();
		...
		/// </summary>
		public DumbbellSeriesDataDragDropDragHandle DragHandle { get; set; }
		private DumbbellSeriesDataDragDropDragHandle DragHandle_DefaultValue { get; set; }
		...
		/// </summary>
		public DumbbellSeriesDataDragDropGuideBox GuideBox { get; set; }
		private DumbbellSeriesDataDragDropGuideBox GuideBox_DefaultValue { get; set; }
