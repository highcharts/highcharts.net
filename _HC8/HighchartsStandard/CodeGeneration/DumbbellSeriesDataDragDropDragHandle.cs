...
namespace Highsoft.Web.Mvc.Charts
{
	public partial class DumbbellSeriesDataDragDropDragHandle  : BaseObject
	{
		...
		internal override Hashtable ToHashtable()
		{
			...
			if (PathFormatter != PathFormatter_DefaultValue) { h.Add("pathFormatter",PathFormatter); Highcharts.AddFunction("c0ae64be-5da5-41c7-aa9d-f90409434676.pathFormatter", PathFormatter); }  
