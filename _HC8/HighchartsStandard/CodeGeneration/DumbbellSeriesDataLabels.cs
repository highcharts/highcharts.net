...
{
	public partial class DumbbellSeriesDataLabels  : BaseObject
	{
		Hashtable h = new Hashtable();

		public DumbbellSeriesDataLabels()
		{
			Align = Align_DefaultValue = DumbbellSeriesDataLabelsAlign.Center;
			...
			Filter = Filter_DefaultValue = new DumbbellSeriesDataLabelsFilter();
			...
			Style = Style_DefaultValue = new DumbbellSeriesDataLabelsStyle();
			TextPath = TextPath_DefaultValue = new DumbbellSeriesDataLabelsTextPath();
			UseHTML = UseHTML_DefaultValue = false;
			VerticalAlign = VerticalAlign_DefaultValue = DumbbellSeriesDataLabelsVerticalAlign.Bottom;
			X = X_DefaultValue = 0;
			Y = Y_DefaultValue = 0;
			Z = Z_DefaultValue = 6;
		...
		/// </summary>
		public DumbbellSeriesDataLabelsAlign Align { get; set; }
		private DumbbellSeriesDataLabelsAlign Align_DefaultValue { get; set; }
		...
		/// </summary>
		public DumbbellSeriesDataLabelsFilter Filter { get; set; }
		private DumbbellSeriesDataLabelsFilter Filter_DefaultValue { get; set; }
		...
		/// </summary>
		public DumbbellSeriesDataLabelsStyle Style { get; set; }
		private DumbbellSeriesDataLabelsStyle Style_DefaultValue { get; set; }
		...
		/// </summary>
		public DumbbellSeriesDataLabelsTextPath TextPath { get; set; }
		private DumbbellSeriesDataLabelsTextPath TextPath_DefaultValue { get; set; }
		...
		/// </summary>
		public DumbbellSeriesDataLabelsVerticalAlign VerticalAlign { get; set; }
		private DumbbellSeriesDataLabelsVerticalAlign VerticalAlign_DefaultValue { get; set; }
		...
		internal override Hashtable ToHashtable()
		{
			...
			if (Formatter != Formatter_DefaultValue) { h.Add("formatter",Formatter); Highcharts.AddFunction("eb65ad21-dbfe-418a-b457-bae528b2ebf2.formatter", Formatter); }  
			...
			if (NullFormatter != NullFormatter_DefaultValue) { h.Add("nullFormatter",NullFormatter); Highcharts.AddFunction("fd0cfa72-6241-4320-a42d-0df0ed1866cd.nullFormatter", NullFormatter); }  
