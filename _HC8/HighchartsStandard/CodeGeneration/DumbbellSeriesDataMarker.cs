...
{
	public partial class DumbbellSeriesDataMarker  : BaseObject
	{
		Hashtable h = new Hashtable();

		public DumbbellSeriesDataMarker()
		{
			...
			States = States_DefaultValue = new DumbbellSeriesDataMarkerStates();
		...
		/// </summary>
		public DumbbellSeriesDataMarkerStates States { get; set; }
		private DumbbellSeriesDataMarkerStates States_DefaultValue { get; set; }
