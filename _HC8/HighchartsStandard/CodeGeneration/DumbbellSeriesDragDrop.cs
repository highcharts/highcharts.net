...
{
	public partial class DumbbellSeriesDragDrop  : BaseObject
	{
		Hashtable h = new Hashtable();

		public DumbbellSeriesDragDrop()
		{
			DraggableX = DraggableX_DefaultValue = null;
			DraggableY = DraggableY_DefaultValue = null;
			DragHandle = DragHandle_DefaultValue = new DumbbellSeriesDragDropDragHandle();
			...
			GuideBox = GuideBox_DefaultValue = new DumbbellSeriesDragDropGuideBox();
		...
		/// </summary>
		public DumbbellSeriesDragDropDragHandle DragHandle { get; set; }
		private DumbbellSeriesDragDropDragHandle DragHandle_DefaultValue { get; set; }
		...
		/// </summary>
		public DumbbellSeriesDragDropGuideBox GuideBox { get; set; }
		private DumbbellSeriesDragDropGuideBox GuideBox_DefaultValue { get; set; }
