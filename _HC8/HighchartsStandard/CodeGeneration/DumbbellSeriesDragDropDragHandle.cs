...
namespace Highsoft.Web.Mvc.Charts
{
	public partial class DumbbellSeriesDragDropDragHandle  : BaseObject
	{
		...
		internal override Hashtable ToHashtable()
		{
			...
			if (PathFormatter != PathFormatter_DefaultValue) { h.Add("pathFormatter",PathFormatter); Highcharts.AddFunction("26f4c4b8-8d8f-41af-8d61-d3be22db1795.pathFormatter", PathFormatter); }  
