...
{
	public partial class DumbbellSeriesOnPoint  : BaseObject
	{
		Hashtable h = new Hashtable();

		public DumbbellSeriesOnPoint()
		{
			ConnectorOptions = ConnectorOptions_DefaultValue = new DumbbellSeriesOnPointConnectorOptions();
			Id = Id_DefaultValue = "";
			Position = Position_DefaultValue = new DumbbellSeriesOnPointPosition();
		...
		/// </summary>
		public DumbbellSeriesOnPointConnectorOptions ConnectorOptions { get; set; }
		private DumbbellSeriesOnPointConnectorOptions ConnectorOptions_DefaultValue { get; set; }
		...
		/// </summary>
		public DumbbellSeriesOnPointPosition Position { get; set; }
		private DumbbellSeriesOnPointPosition Position_DefaultValue { get; set; }
