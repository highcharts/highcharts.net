...
{
	public partial class DumbbellSeriesSonificationDefaultInstrumentOptions  : BaseObject
	{
		Hashtable h = new Hashtable();

		public DumbbellSeriesSonificationDefaultInstrumentOptions()
		{
			ActiveWhen = ActiveWhen_DefaultValue = new DumbbellSeriesSonificationDefaultInstrumentOptionsActiveWhen();
			Instrument = Instrument_DefaultValue = null;
			InstrumentString = InstrumentString_DefaultValue = "null";
			Mapping = Mapping_DefaultValue = new DumbbellSeriesSonificationDefaultInstrumentOptionsMapping();
			MidiName = MidiName_DefaultValue = "";
			PointGrouping = PointGrouping_DefaultValue = new DumbbellSeriesSonificationDefaultInstrumentOptionsPointGrouping();
			RoundToMusicalNotes = RoundToMusicalNotes_DefaultValue = true;
			ShowPlayMarker = ShowPlayMarker_DefaultValue = true;
			Type = Type_DefaultValue = DumbbellSeriesSonificationDefaultInstrumentOptionsType.Instrument;
		...
		/// </summary>
		public DumbbellSeriesSonificationDefaultInstrumentOptionsActiveWhen ActiveWhen { get; set; }
		private DumbbellSeriesSonificationDefaultInstrumentOptionsActiveWhen ActiveWhen_DefaultValue { get; set; }
		...
		/// </summary>
		public DumbbellSeriesSonificationDefaultInstrumentOptionsMapping Mapping { get; set; }
		private DumbbellSeriesSonificationDefaultInstrumentOptionsMapping Mapping_DefaultValue { get; set; }
		...
		/// </summary>
		public DumbbellSeriesSonificationDefaultInstrumentOptionsPointGrouping PointGrouping { get; set; }
		private DumbbellSeriesSonificationDefaultInstrumentOptionsPointGrouping PointGrouping_DefaultValue { get; set; }
		...
		/// </summary>
		public DumbbellSeriesSonificationDefaultInstrumentOptionsType Type { get; set; }
		private DumbbellSeriesSonificationDefaultInstrumentOptionsType Type_DefaultValue { get; set; }
