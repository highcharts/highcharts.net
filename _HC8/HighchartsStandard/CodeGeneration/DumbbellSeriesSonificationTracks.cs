...
{
	public partial class DumbbellSeriesSonificationTracks  : BaseObject
	{
		Hashtable h = new Hashtable();

		public DumbbellSeriesSonificationTracks()
		{
			ActiveWhen = ActiveWhen_DefaultValue = new DumbbellSeriesSonificationTracksActiveWhen();
			Instrument = Instrument_DefaultValue = null;
			InstrumentString = InstrumentString_DefaultValue = "null";
			Mapping = Mapping_DefaultValue = new DumbbellSeriesSonificationTracksMapping();
			MidiName = MidiName_DefaultValue = "";
			PointGrouping = PointGrouping_DefaultValue = new DumbbellSeriesSonificationTracksPointGrouping();
			RoundToMusicalNotes = RoundToMusicalNotes_DefaultValue = true;
			ShowPlayMarker = ShowPlayMarker_DefaultValue = true;
			Type = Type_DefaultValue = DumbbellSeriesSonificationTracksType.Instrument;
		...
		/// </summary>
		public DumbbellSeriesSonificationTracksActiveWhen ActiveWhen { get; set; }
		private DumbbellSeriesSonificationTracksActiveWhen ActiveWhen_DefaultValue { get; set; }
		...
		/// </summary>
		public DumbbellSeriesSonificationTracksMapping Mapping { get; set; }
		private DumbbellSeriesSonificationTracksMapping Mapping_DefaultValue { get; set; }
		...
		/// </summary>
		public DumbbellSeriesSonificationTracksPointGrouping PointGrouping { get; set; }
		private DumbbellSeriesSonificationTracksPointGrouping PointGrouping_DefaultValue { get; set; }
		...
		/// </summary>
		public DumbbellSeriesSonificationTracksType Type { get; set; }
		private DumbbellSeriesSonificationTracksType Type_DefaultValue { get; set; }
