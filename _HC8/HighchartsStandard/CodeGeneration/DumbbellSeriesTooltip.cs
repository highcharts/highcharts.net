...
{
	public partial class DumbbellSeriesTooltip  : BaseObject
	{
		Hashtable h = new Hashtable();

		public DumbbellSeriesTooltip()
		{
			...
			HeaderShape = HeaderShape_DefaultValue = DumbbellSeriesTooltipHeaderShape.Callout;
		...
		/// </summary>
		public DumbbellSeriesTooltipHeaderShape HeaderShape { get; set; }
		private DumbbellSeriesTooltipHeaderShape HeaderShape_DefaultValue { get; set; }
		...
		internal override Hashtable ToHashtable()
		{
			...
			if (NullFormatter != NullFormatter_DefaultValue) { h.Add("nullFormatter",NullFormatter); Highcharts.AddFunction("7944b92b-fbf2-465c-8b25-139aab6ad145.nullFormatter", NullFormatter); }  
			if (Outside != Outside_DefaultValue) h.Add("outside",Outside);
			if (Padding != Padding_DefaultValue) h.Add("padding",Padding);
			if (PointFormat != PointFormat_DefaultValue) h.Add("pointFormat",PointFormat);
			if (PointFormatter != PointFormatter_DefaultValue) { h.Add("pointFormatter",PointFormatter); Highcharts.AddFunction("f3af8dbc-c07f-4125-a99a-b7129759f87d.pointFormatter", PointFormatter); }  
