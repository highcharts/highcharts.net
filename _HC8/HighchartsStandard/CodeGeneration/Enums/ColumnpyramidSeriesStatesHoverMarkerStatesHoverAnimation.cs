...
{
	public partial class ColumnpyramidSeriesStatesHoverMarkerStatesHoverAnimation  : BaseObject
	{
		Hashtable h = new Hashtable();

		public ColumnpyramidSeriesStatesHoverMarkerStatesHoverAnimation()
		{
