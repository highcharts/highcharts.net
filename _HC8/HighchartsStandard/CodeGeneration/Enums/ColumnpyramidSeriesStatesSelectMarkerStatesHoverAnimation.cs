...
{
	public partial class ColumnpyramidSeriesStatesSelectMarkerStatesHoverAnimation  : BaseObject
	{
		Hashtable h = new Hashtable();

		public ColumnpyramidSeriesStatesSelectMarkerStatesHoverAnimation()
		{
