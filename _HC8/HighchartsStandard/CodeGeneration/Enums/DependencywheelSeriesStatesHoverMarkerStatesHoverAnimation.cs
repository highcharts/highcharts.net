...
{
	public partial class DependencywheelSeriesStatesHoverMarkerStatesHoverAnimation  : BaseObject
	{
		Hashtable h = new Hashtable();

		public DependencywheelSeriesStatesHoverMarkerStatesHoverAnimation()
		{
