...
{
	public partial class DumbbellSeriesStatesHoverMarker  : BaseObject
	{
		Hashtable h = new Hashtable();

		public DumbbellSeriesStatesHoverMarker()
		{
			...
			States = States_DefaultValue = new DumbbellSeriesStatesHoverMarkerStates();
		...
		/// </summary>
		public DumbbellSeriesStatesHoverMarkerStates States { get; set; }
		private DumbbellSeriesStatesHoverMarkerStates States_DefaultValue { get; set; }
