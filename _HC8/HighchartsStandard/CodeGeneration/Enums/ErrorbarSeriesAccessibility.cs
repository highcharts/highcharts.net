...
namespace Highsoft.Web.Mvc.Charts
{
	public partial class ErrorbarSeriesAccessibility  : BaseObject
	{
		...
		public ErrorbarSeriesAccessibility()
		{
			...
			Point = Point_DefaultValue = new ErrorbarSeriesAccessibilityPoint();
		...
		/// </summary>
		public ErrorbarSeriesAccessibilityPoint Point { get; set; }
		private ErrorbarSeriesAccessibilityPoint Point_DefaultValue { get; set; }
