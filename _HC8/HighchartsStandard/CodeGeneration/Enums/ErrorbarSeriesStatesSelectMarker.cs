...
{
	public partial class ErrorbarSeriesStatesSelectMarker  : BaseObject
	{
		Hashtable h = new Hashtable();

		public ErrorbarSeriesStatesSelectMarker()
		{
			...
			States = States_DefaultValue = new ErrorbarSeriesStatesSelectMarkerStates();
		...
		/// </summary>
		public ErrorbarSeriesStatesSelectMarkerStates States { get; set; }
		private ErrorbarSeriesStatesSelectMarkerStates States_DefaultValue { get; set; }
