...
{
	public partial class ItemSeriesStatesSelectMarker  : BaseObject
	{
		Hashtable h = new Hashtable();

		public ItemSeriesStatesSelectMarker()
		{
			...
			States = States_DefaultValue = new ItemSeriesStatesSelectMarkerStates();
		...
		/// </summary>
		public ItemSeriesStatesSelectMarkerStates States { get; set; }
		private ItemSeriesStatesSelectMarkerStates States_DefaultValue { get; set; }
