...
{
	public partial class PackedbubbleSeriesStatesHoverMarker  : BaseObject
	{
		Hashtable h = new Hashtable();

		public PackedbubbleSeriesStatesHoverMarker()
		{
			...
			States = States_DefaultValue = new PackedbubbleSeriesStatesHoverMarkerStates();
		...
		/// </summary>
		public PackedbubbleSeriesStatesHoverMarkerStates States { get; set; }
		private PackedbubbleSeriesStatesHoverMarkerStates States_DefaultValue { get; set; }
