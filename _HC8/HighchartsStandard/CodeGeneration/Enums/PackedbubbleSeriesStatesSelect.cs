...
{
	public partial class PackedbubbleSeriesStatesSelect  : BaseObject
	{
		Hashtable h = new Hashtable();

		public PackedbubbleSeriesStatesSelect()
		{
			Animation = Animation_DefaultValue = new Animation() { Enabled = true };
			Enabled = Enabled_DefaultValue = null;
			Halo = Halo_DefaultValue = new PackedbubbleSeriesStatesSelectHalo();
			LineWidth = LineWidth_DefaultValue = null;
			LineWidthPlus = LineWidthPlus_DefaultValue = null;
			Marker = Marker_DefaultValue = new PackedbubbleSeriesStatesSelectMarker();
		...
		/// </summary>
		public PackedbubbleSeriesStatesSelectHalo Halo { get; set; }
		private PackedbubbleSeriesStatesSelectHalo Halo_DefaultValue { get; set; }
		...
		/// </summary>
		public PackedbubbleSeriesStatesSelectMarker Marker { get; set; }
		private PackedbubbleSeriesStatesSelectMarker Marker_DefaultValue { get; set; }
