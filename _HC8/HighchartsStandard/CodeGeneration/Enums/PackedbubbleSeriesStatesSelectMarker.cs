...
{
	public partial class PackedbubbleSeriesStatesSelectMarker  : BaseObject
	{
		Hashtable h = new Hashtable();

		public PackedbubbleSeriesStatesSelectMarker()
		{
			...
			States = States_DefaultValue = new PackedbubbleSeriesStatesSelectMarkerStates();
		...
		/// </summary>
		public PackedbubbleSeriesStatesSelectMarkerStates States { get; set; }
		private PackedbubbleSeriesStatesSelectMarkerStates States_DefaultValue { get; set; }
