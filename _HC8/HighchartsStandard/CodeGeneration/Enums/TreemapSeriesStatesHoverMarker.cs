...
namespace Highsoft.Web.Mvc.Charts
{
	public partial class TreemapSeriesStatesHoverMarker  : BaseObject
	{
		...
		public TreemapSeriesStatesHoverMarker()
		{
			...
			States = States_DefaultValue = new TreemapSeriesStatesHoverMarkerStates();
		...
		/// </summary>
		public TreemapSeriesStatesHoverMarkerStates States { get; set; }
		private TreemapSeriesStatesHoverMarkerStates States_DefaultValue { get; set; }
