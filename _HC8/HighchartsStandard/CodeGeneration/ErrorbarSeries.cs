...
namespace Highsoft.Web.Mvc.Charts
{
	public partial class ErrorbarSeries  : Series
	{
		...
		public ErrorbarSeries()
		{
			...
			Type = Type_DefaultValue = ErrorbarSeriesType.Errorbar;
		...
		internal override Hashtable ToHashtable()
		{
			...
			if (PointDescriptionFormatter != PointDescriptionFormatter_DefaultValue) { h.Add("pointDescriptionFormatter",PointDescriptionFormatter); Highcharts.AddFunction("171793ad-351c-4ea2-9d21-2a3e8d9a5ac8.pointDescriptionFormatter", PointDescriptionFormatter); }  
