...
namespace Highsoft.Web.Mvc.Charts
{
	public partial class ErrorbarSeriesAccessibility  : BaseObject
	{
		...
		internal override Hashtable ToHashtable()
		{
			...
			if (PointDescriptionFormatter != PointDescriptionFormatter_DefaultValue) { h.Add("pointDescriptionFormatter",PointDescriptionFormatter); Highcharts.AddFunction("244a7e81-be4e-4be4-b6d0-381407d8970f.pointDescriptionFormatter", PointDescriptionFormatter); }  
