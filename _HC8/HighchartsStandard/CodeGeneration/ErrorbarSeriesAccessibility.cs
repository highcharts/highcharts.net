...
namespace Highsoft.Web.Mvc.Charts
{
	public partial class ErrorbarSeriesAccessibility  : BaseObject
	{
		...
		internal override Hashtable ToHashtable()
		{
			...
			if (PointDescriptionFormatter != PointDescriptionFormatter_DefaultValue) { h.Add("pointDescriptionFormatter",PointDescriptionFormatter); Highcharts.AddFunction("0aa821ce-35dd-481d-8e9a-55e7ccaa7734.pointDescriptionFormatter", PointDescriptionFormatter); }  
