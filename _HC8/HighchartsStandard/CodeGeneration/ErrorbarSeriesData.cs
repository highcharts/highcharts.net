...
{
	public partial class ErrorbarSeriesData  : BaseObject
	{
		...
		public ErrorbarSeriesData()
		{
			...
			Marker = Marker_DefaultValue = new ErrorbarSeriesDataMarker();
		...
		/// </summary>
		public ErrorbarSeriesDataDragDrop DragDrop { get; set; }
		private ErrorbarSeriesDataDragDrop DragDrop_DefaultValue { get; set; }
		...
		/// </summary>
		public ErrorbarSeriesDataMarker Marker { get; set; }
		private ErrorbarSeriesDataMarker Marker_DefaultValue { get; set; }
