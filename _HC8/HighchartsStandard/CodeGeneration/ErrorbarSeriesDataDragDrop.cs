...
{
	public partial class ErrorbarSeriesDataDragDrop  : BaseObject
	{
		Hashtable h = new Hashtable();

		public ErrorbarSeriesDataDragDrop()
		{
			DraggableX = DraggableX_DefaultValue = null;
			DraggableY = DraggableY_DefaultValue = null;
			DragHandle = DragHandle_DefaultValue = new ErrorbarSeriesDataDragDropDragHandle();
			...
			GuideBox = GuideBox_DefaultValue = new ErrorbarSeriesDataDragDropGuideBox();
		...
		/// </summary>
		public ErrorbarSeriesDataDragDropDragHandle DragHandle { get; set; }
		private ErrorbarSeriesDataDragDropDragHandle DragHandle_DefaultValue { get; set; }
		...
		/// </summary>
		public ErrorbarSeriesDataDragDropGuideBox GuideBox { get; set; }
		private ErrorbarSeriesDataDragDropGuideBox GuideBox_DefaultValue { get; set; }
