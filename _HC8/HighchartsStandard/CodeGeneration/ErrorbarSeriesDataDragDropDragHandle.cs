...
namespace Highsoft.Web.Mvc.Charts
{
	public partial class ErrorbarSeriesDataDragDropDragHandle  : BaseObject
	{
		...
		internal override Hashtable ToHashtable()
		{
			...
			if (PathFormatter != PathFormatter_DefaultValue) { h.Add("pathFormatter",PathFormatter); Highcharts.AddFunction("b6fa42f9-8872-4eaa-9781-40ed3bb6d91c.pathFormatter", PathFormatter); }  
