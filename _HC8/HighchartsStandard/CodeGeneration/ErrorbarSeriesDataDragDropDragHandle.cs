...
namespace Highsoft.Web.Mvc.Charts
{
	public partial class ErrorbarSeriesDataDragDropDragHandle  : BaseObject
	{
		...
		internal override Hashtable ToHashtable()
		{
			...
			if (PathFormatter != PathFormatter_DefaultValue) { h.Add("pathFormatter",PathFormatter); Highcharts.AddFunction("e7504264-6302-4f52-b7a7-48a966d8cbf7.pathFormatter", PathFormatter); }  
