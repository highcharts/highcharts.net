...
namespace Highsoft.Web.Mvc.Charts
{
	public partial class ErrorbarSeriesDataDragDropDragHandle  : BaseObject
	{
		...
		internal override Hashtable ToHashtable()
		{
			...
			if (PathFormatter != PathFormatter_DefaultValue) { h.Add("pathFormatter",PathFormatter); Highcharts.AddFunction("ac2b7330-f46f-4e36-a35a-e1914937c28e.pathFormatter", PathFormatter); }  
