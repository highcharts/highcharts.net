...
namespace Highsoft.Web.Mvc.Charts
{
	public partial class ErrorbarSeriesDataLabels  : BaseObject
	{
		...
		{
			Align = Align_DefaultValue = ErrorbarSeriesDataLabelsAlign.Center;
			...
			Filter = Filter_DefaultValue = new ErrorbarSeriesDataLabelsFilter();
			...
			Style = Style_DefaultValue = new ErrorbarSeriesDataLabelsStyle();
			TextPath = TextPath_DefaultValue = new ErrorbarSeriesDataLabelsTextPath();
			UseHTML = UseHTML_DefaultValue = false;
			VerticalAlign = VerticalAlign_DefaultValue = ErrorbarSeriesDataLabelsVerticalAlign.Bottom;
			X = X_DefaultValue = 0;
			Y = Y_DefaultValue = 0;
			Z = Z_DefaultValue = 6;
		...
		/// </summary>
		public ErrorbarSeriesDataLabelsFilter Filter { get; set; }
		private ErrorbarSeriesDataLabelsFilter Filter_DefaultValue { get; set; }
		...
		/// </summary>
		public ErrorbarSeriesDataLabelsStyle Style { get; set; }
		private ErrorbarSeriesDataLabelsStyle Style_DefaultValue { get; set; }
		...
		/// </summary>
		public ErrorbarSeriesDataLabelsTextPath TextPath { get; set; }
		private ErrorbarSeriesDataLabelsTextPath TextPath_DefaultValue { get; set; }
		...
		internal override Hashtable ToHashtable()
		{
			...
			if (Formatter != Formatter_DefaultValue) { h.Add("formatter",Formatter); Highcharts.AddFunction("39de3c6e-33f0-4c75-b368-86c70a2b587f.formatter", Formatter); }  
			...
			if (NullFormatter != NullFormatter_DefaultValue) { h.Add("nullFormatter",NullFormatter); Highcharts.AddFunction("0ebb6323-43d3-4753-a7ae-4fab8bb5f0d7.nullFormatter", NullFormatter); }  
