...
{
	public partial class ErrorbarSeriesDataMarker  : BaseObject
	{
		Hashtable h = new Hashtable();

		public ErrorbarSeriesDataMarker()
		{
			...
			States = States_DefaultValue = new ErrorbarSeriesDataMarkerStates();
		...
		/// </summary>
		public ErrorbarSeriesDataMarkerStates States { get; set; }
		private ErrorbarSeriesDataMarkerStates States_DefaultValue { get; set; }
