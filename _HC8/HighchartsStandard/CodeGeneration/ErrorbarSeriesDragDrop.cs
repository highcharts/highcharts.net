...
{
	public partial class ErrorbarSeriesDragDrop  : BaseObject
	{
		Hashtable h = new Hashtable();

		public ErrorbarSeriesDragDrop()
		{
			DraggableX = DraggableX_DefaultValue = null;
			DraggableY = DraggableY_DefaultValue = null;
			DragHandle = DragHandle_DefaultValue = new ErrorbarSeriesDragDropDragHandle();
			...
			GuideBox = GuideBox_DefaultValue = new ErrorbarSeriesDragDropGuideBox();
		...
		/// </summary>
		public ErrorbarSeriesDragDropDragHandle DragHandle { get; set; }
		private ErrorbarSeriesDragDropDragHandle DragHandle_DefaultValue { get; set; }
		...
		/// </summary>
		public ErrorbarSeriesDragDropGuideBox GuideBox { get; set; }
		private ErrorbarSeriesDragDropGuideBox GuideBox_DefaultValue { get; set; }
