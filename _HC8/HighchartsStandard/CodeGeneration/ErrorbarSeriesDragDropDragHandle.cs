...
namespace Highsoft.Web.Mvc.Charts
{
	public partial class ErrorbarSeriesDragDropDragHandle  : BaseObject
	{
		...
		internal override Hashtable ToHashtable()
		{
			...
			if (PathFormatter != PathFormatter_DefaultValue) { h.Add("pathFormatter",PathFormatter); Highcharts.AddFunction("bd2bddbb-a9b5-4d51-b8ab-6661a402377a.pathFormatter", PathFormatter); }  
