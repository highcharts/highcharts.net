...
namespace Highsoft.Web.Mvc.Charts
{
	public partial class ErrorbarSeriesDragDropDragHandle  : BaseObject
	{
		...
		internal override Hashtable ToHashtable()
		{
			...
			if (PathFormatter != PathFormatter_DefaultValue) { h.Add("pathFormatter",PathFormatter); Highcharts.AddFunction("25bf251e-3bf2-4887-b4d0-f60f2d24983f.pathFormatter", PathFormatter); }  
