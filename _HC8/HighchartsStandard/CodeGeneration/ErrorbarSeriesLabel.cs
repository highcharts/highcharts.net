...
{
	public partial class ErrorbarSeriesLabel  : BaseObject
	{
		Hashtable h = new Hashtable();

		public ErrorbarSeriesLabel()
		{
			...
			Style = Style_DefaultValue = new ErrorbarSeriesLabelStyle();
		...
		/// </summary>
		public ErrorbarSeriesLabelStyle Style { get; set; }
		private ErrorbarSeriesLabelStyle Style_DefaultValue { get; set; }
		...
		internal override Hashtable ToHashtable()
		{
			...
			if (Formatter != Formatter_DefaultValue) { h.Add("formatter",Formatter); Highcharts.AddFunction("29bfe238-b8c4-4c97-8448-233bfeb53903.formatter", Formatter); }  
