...
{
	public partial class ErrorbarSeriesOnPoint  : BaseObject
	{
		Hashtable h = new Hashtable();

		public ErrorbarSeriesOnPoint()
		{
			ConnectorOptions = ConnectorOptions_DefaultValue = new ErrorbarSeriesOnPointConnectorOptions();
			Id = Id_DefaultValue = "";
			Position = Position_DefaultValue = new ErrorbarSeriesOnPointPosition();
		...
		/// </summary>
		public ErrorbarSeriesOnPointConnectorOptions ConnectorOptions { get; set; }
		private ErrorbarSeriesOnPointConnectorOptions ConnectorOptions_DefaultValue { get; set; }
		...
		/// </summary>
		public ErrorbarSeriesOnPointPosition Position { get; set; }
		private ErrorbarSeriesOnPointPosition Position_DefaultValue { get; set; }
