...
{
	public partial class ErrorbarSeriesSonificationContextTracks  : BaseObject
	{
		Hashtable h = new Hashtable();

		public ErrorbarSeriesSonificationContextTracks()
		{
			ActiveWhen = ActiveWhen_DefaultValue = new ErrorbarSeriesSonificationContextTracksActiveWhen();
			Instrument = Instrument_DefaultValue = null;
			InstrumentString = InstrumentString_DefaultValue = "null";
			Mapping = Mapping_DefaultValue = new ErrorbarSeriesSonificationContextTracksMapping();
			MidiName = MidiName_DefaultValue = "";
			PointGrouping = PointGrouping_DefaultValue = new ErrorbarSeriesSonificationContextTracksPointGrouping();
			...
			Type = Type_DefaultValue = ErrorbarSeriesSonificationContextTracksType.Instrument;
			ValueInterval = ValueInterval_DefaultValue = null;
			ValueMapFunction = ValueMapFunction_DefaultValue = ErrorbarSeriesSonificationContextTracksValueMapFunction.Linear;
		...
		/// </summary>
		public ErrorbarSeriesSonificationContextTracksActiveWhen ActiveWhen { get; set; }
		private ErrorbarSeriesSonificationContextTracksActiveWhen ActiveWhen_DefaultValue { get; set; }
		...
		/// </summary>
		public ErrorbarSeriesSonificationContextTracksMapping Mapping { get; set; }
		private ErrorbarSeriesSonificationContextTracksMapping Mapping_DefaultValue { get; set; }
		...
		/// </summary>
		public ErrorbarSeriesSonificationContextTracksPointGrouping PointGrouping { get; set; }
		private ErrorbarSeriesSonificationContextTracksPointGrouping PointGrouping_DefaultValue { get; set; }
		...
		/// </summary>
		public ErrorbarSeriesSonificationContextTracksType Type { get; set; }
		private ErrorbarSeriesSonificationContextTracksType Type_DefaultValue { get; set; }
		...
		/// </summary>
		public ErrorbarSeriesSonificationContextTracksValueMapFunction ValueMapFunction { get; set; }
		private ErrorbarSeriesSonificationContextTracksValueMapFunction ValueMapFunction_DefaultValue { get; set; }
