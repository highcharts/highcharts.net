...
{
	public partial class ErrorbarSeriesSonificationDefaultSpeechOptions  : BaseObject
	{
		Hashtable h = new Hashtable();

		public ErrorbarSeriesSonificationDefaultSpeechOptions()
		{
			ActiveWhen = ActiveWhen_DefaultValue = new ErrorbarSeriesSonificationDefaultSpeechOptionsActiveWhen();
			Language = Language_DefaultValue = "en-US";
			Mapping = Mapping_DefaultValue = new ErrorbarSeriesSonificationDefaultSpeechOptionsMapping();
			PointGrouping = PointGrouping_DefaultValue = new ErrorbarSeriesSonificationDefaultSpeechOptionsPointGrouping();
			PreferredVoice = PreferredVoice_DefaultValue = "";
			ShowPlayMarker = ShowPlayMarker_DefaultValue = true;
			Type = Type_DefaultValue = ErrorbarSeriesSonificationDefaultSpeechOptionsType.Instrument;
		...
		/// </summary>
		public ErrorbarSeriesSonificationDefaultSpeechOptionsActiveWhen ActiveWhen { get; set; }
		private ErrorbarSeriesSonificationDefaultSpeechOptionsActiveWhen ActiveWhen_DefaultValue { get; set; }
		...
		/// </summary>
		public ErrorbarSeriesSonificationDefaultSpeechOptionsMapping Mapping { get; set; }
		private ErrorbarSeriesSonificationDefaultSpeechOptionsMapping Mapping_DefaultValue { get; set; }
		 

		/// <summary>
		/// Options for point grouping, specifically for instrument tracks.
		/// </summary>
		public ErrorbarSeriesSonificationDefaultSpeechOptionsPointGrouping PointGrouping { get; set; }
		private ErrorbarSeriesSonificationDefaultSpeechOptionsPointGrouping PointGrouping_DefaultValue { get; set; }
		...
		/// </summary>
		public ErrorbarSeriesSonificationDefaultSpeechOptionsType Type { get; set; }
		private ErrorbarSeriesSonificationDefaultSpeechOptionsType Type_DefaultValue { get; set; }
