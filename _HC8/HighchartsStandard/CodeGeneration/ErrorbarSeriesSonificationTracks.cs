...
{
	public partial class ErrorbarSeriesSonificationTracks  : BaseObject
	{
		Hashtable h = new Hashtable();

		public ErrorbarSeriesSonificationTracks()
		{
			ActiveWhen = ActiveWhen_DefaultValue = new ErrorbarSeriesSonificationTracksActiveWhen();
			Instrument = Instrument_DefaultValue = null;
			InstrumentString = InstrumentString_DefaultValue = "null";
			Mapping = Mapping_DefaultValue = new ErrorbarSeriesSonificationTracksMapping();
			MidiName = MidiName_DefaultValue = "";
			PointGrouping = PointGrouping_DefaultValue = new ErrorbarSeriesSonificationTracksPointGrouping();
			RoundToMusicalNotes = RoundToMusicalNotes_DefaultValue = true;
			ShowPlayMarker = ShowPlayMarker_DefaultValue = true;
			Type = Type_DefaultValue = ErrorbarSeriesSonificationTracksType.Instrument;
		...
		/// </summary>
		public ErrorbarSeriesSonificationTracksActiveWhen ActiveWhen { get; set; }
		private ErrorbarSeriesSonificationTracksActiveWhen ActiveWhen_DefaultValue { get; set; }
		...
		/// </summary>
		public ErrorbarSeriesSonificationTracksMapping Mapping { get; set; }
		private ErrorbarSeriesSonificationTracksMapping Mapping_DefaultValue { get; set; }
		...
		/// </summary>
		public ErrorbarSeriesSonificationTracksPointGrouping PointGrouping { get; set; }
		private ErrorbarSeriesSonificationTracksPointGrouping PointGrouping_DefaultValue { get; set; }
		...
		/// </summary>
		public ErrorbarSeriesSonificationTracksType Type { get; set; }
		private ErrorbarSeriesSonificationTracksType Type_DefaultValue { get; set; }
