...
{
	public partial class ErrorbarSeriesStatesSelect  : BaseObject
	{
		Hashtable h = new Hashtable();

		public ErrorbarSeriesStatesSelect()
		{
			Animation = Animation_DefaultValue = new Animation() { Enabled = true };
			Enabled = Enabled_DefaultValue = null;
			Halo = Halo_DefaultValue = new ErrorbarSeriesStatesSelectHalo();
			LineWidth = LineWidth_DefaultValue = null;
			LineWidthPlus = LineWidthPlus_DefaultValue = null;
			Marker = Marker_DefaultValue = new ErrorbarSeriesStatesSelectMarker();
		...
		/// </summary>
		public ErrorbarSeriesStatesSelectHalo Halo { get; set; }
		private ErrorbarSeriesStatesSelectHalo Halo_DefaultValue { get; set; }
		...
		/// </summary>
		public ErrorbarSeriesStatesSelectMarker Marker { get; set; }
		private ErrorbarSeriesStatesSelectMarker Marker_DefaultValue { get; set; }
