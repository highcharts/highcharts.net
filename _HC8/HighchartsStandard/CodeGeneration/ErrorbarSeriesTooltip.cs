...
namespace Highsoft.Web.Mvc.Charts
{
	public partial class ErrorbarSeriesTooltip  : BaseObject
	{
		...
		internal override Hashtable ToHashtable()
		{
			...
			if (NullFormatter != NullFormatter_DefaultValue) { h.Add("nullFormatter",NullFormatter); Highcharts.AddFunction("29a9b603-419c-49be-8bdc-a1380d67b58c.nullFormatter", NullFormatter); }  
			if (PointFormat != PointFormat_DefaultValue) h.Add("pointFormat",PointFormat);
			if (PointFormatter != PointFormatter_DefaultValue) { h.Add("pointFormatter",PointFormatter); Highcharts.AddFunction("2a02dd1d-bbfb-4d07-815d-adfeea603a17.pointFormatter", PointFormatter); }  
