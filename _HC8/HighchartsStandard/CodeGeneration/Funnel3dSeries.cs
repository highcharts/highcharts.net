...
namespace Highsoft.Web.Mvc.Charts
{
	public partial class Funnel3dSeries  : Series
	{
		...
		public Funnel3dSeries()
		{
			...
			Type = Type_DefaultValue = Funnel3dSeriesType.Funnel3d;
		...
		/// </summary>
		public Funnel3dSeriesType Type { get; set; }
		private Funnel3dSeriesType Type_DefaultValue { get; set; }
		...
		internal override Hashtable ToHashtable()
		{
			...
			if (PointDescriptionFormatter != PointDescriptionFormatter_DefaultValue) { h.Add("pointDescriptionFormatter",PointDescriptionFormatter); Highcharts.AddFunction("6ab9b5c3-3200-4209-b40d-593378717337.pointDescriptionFormatter", PointDescriptionFormatter); }  
