...
{
	public partial class Funnel3dSeriesDataDragDrop  : BaseObject
	{
		Hashtable h = new Hashtable();

		public Funnel3dSeriesDataDragDrop()
		{
			DraggableX = DraggableX_DefaultValue = null;
			DraggableY = DraggableY_DefaultValue = null;
			DragHandle = DragHandle_DefaultValue = new Funnel3dSeriesDataDragDropDragHandle();
			...
			GuideBox = GuideBox_DefaultValue = new Funnel3dSeriesDataDragDropGuideBox();
		...
		/// </summary>
		public Funnel3dSeriesDataDragDropDragHandle DragHandle { get; set; }
		private Funnel3dSeriesDataDragDropDragHandle DragHandle_DefaultValue { get; set; }
		...
		/// </summary>
		public Funnel3dSeriesDataDragDropGuideBox GuideBox { get; set; }
		private Funnel3dSeriesDataDragDropGuideBox GuideBox_DefaultValue { get; set; }
