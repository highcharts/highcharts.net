...
namespace Highsoft.Web.Mvc.Charts
{
	public partial class Funnel3dSeriesDataDragDropDragHandle  : BaseObject
	{
		...
		internal override Hashtable ToHashtable()
		{
			...
			if (PathFormatter != PathFormatter_DefaultValue) { h.Add("pathFormatter",PathFormatter); Highcharts.AddFunction("9cd5af3d-8f13-4bf6-afa5-9a1cfbd933c7.pathFormatter", PathFormatter); }  
