...
namespace Highsoft.Web.Mvc.Charts
{
	public partial class Funnel3dSeriesDataLabels  : BaseObject
	{
		...
		{
			Align = Align_DefaultValue = Funnel3dSeriesDataLabelsAlign.Center;
			...
			Filter = Filter_DefaultValue = new Funnel3dSeriesDataLabelsFilter();
			...
			Style = Style_DefaultValue = new Funnel3dSeriesDataLabelsStyle();
			TextPath = TextPath_DefaultValue = new Funnel3dSeriesDataLabelsTextPath();
			UseHTML = UseHTML_DefaultValue = false;
			VerticalAlign = VerticalAlign_DefaultValue = Funnel3dSeriesDataLabelsVerticalAlign.Bottom;
			X = X_DefaultValue = 0;
			Y = Y_DefaultValue = 0;
			Z = Z_DefaultValue = 6;
		...
		/// </summary>
		public Funnel3dSeriesDataLabelsAlign Align { get; set; }
		private Funnel3dSeriesDataLabelsAlign Align_DefaultValue { get; set; }
		...
		/// </summary>
		public Funnel3dSeriesDataLabelsFilter Filter { get; set; }
		private Funnel3dSeriesDataLabelsFilter Filter_DefaultValue { get; set; }
		...
		/// </summary>
		public Funnel3dSeriesDataLabelsStyle Style { get; set; }
		private Funnel3dSeriesDataLabelsStyle Style_DefaultValue { get; set; }
		...
		/// </summary>
		public Funnel3dSeriesDataLabelsTextPath TextPath { get; set; }
		private Funnel3dSeriesDataLabelsTextPath TextPath_DefaultValue { get; set; }
		...
		internal override Hashtable ToHashtable()
		{
			...
			if (Formatter != Formatter_DefaultValue) { h.Add("formatter",Formatter); Highcharts.AddFunction("3f5dbdf8-bebe-4c63-9b43-44df0bea68ad.formatter", Formatter); }  
			if (Inside != Inside_DefaultValue) h.Add("inside",Inside);
			if (NullFormat != NullFormat_DefaultValue) h.Add("nullFormat",NullFormat);
			if (NullFormatter != NullFormatter_DefaultValue) { h.Add("nullFormatter",NullFormatter); Highcharts.AddFunction("1497580c-893a-4eaf-a2e1-74412adfb700.nullFormatter", NullFormatter); }  
