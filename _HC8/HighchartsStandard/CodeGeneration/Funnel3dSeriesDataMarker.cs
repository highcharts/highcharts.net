...
{
	public partial class Funnel3dSeriesDataMarker  : BaseObject
	{
		Hashtable h = new Hashtable();

		public Funnel3dSeriesDataMarker()
		{
			...
			States = States_DefaultValue = new Funnel3dSeriesDataMarkerStates();
		...
		/// </summary>
		public Funnel3dSeriesDataMarkerStates States { get; set; }
		private Funnel3dSeriesDataMarkerStates States_DefaultValue { get; set; }
