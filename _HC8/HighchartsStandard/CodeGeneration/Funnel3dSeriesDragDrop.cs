...
{
	public partial class Funnel3dSeriesDragDrop  : BaseObject
	{
		Hashtable h = new Hashtable();

		public Funnel3dSeriesDragDrop()
		{
			DraggableX = DraggableX_DefaultValue = null;
			DraggableY = DraggableY_DefaultValue = null;
			DragHandle = DragHandle_DefaultValue = new Funnel3dSeriesDragDropDragHandle();
			...
			GuideBox = GuideBox_DefaultValue = new Funnel3dSeriesDragDropGuideBox();
		...
		/// </summary>
		public Funnel3dSeriesDragDropDragHandle DragHandle { get; set; }
		private Funnel3dSeriesDragDropDragHandle DragHandle_DefaultValue { get; set; }
		...
		/// </summary>
		public Funnel3dSeriesDragDropGuideBox GuideBox { get; set; }
		private Funnel3dSeriesDragDropGuideBox GuideBox_DefaultValue { get; set; }
