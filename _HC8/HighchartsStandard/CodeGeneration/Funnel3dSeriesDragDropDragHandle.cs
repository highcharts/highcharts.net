...
namespace Highsoft.Web.Mvc.Charts
{
	public partial class Funnel3dSeriesDragDropDragHandle  : BaseObject
	{
		...
		internal override Hashtable ToHashtable()
		{
			...
			if (PathFormatter != PathFormatter_DefaultValue) { h.Add("pathFormatter",PathFormatter); Highcharts.AddFunction("50731827-f41d-4142-99ba-d61b4c2b878f.pathFormatter", PathFormatter); }  
