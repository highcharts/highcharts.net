...
namespace Highsoft.Web.Mvc.Charts
{
	public partial class Funnel3dSeriesDragDropDragHandle  : BaseObject
	{
		...
		internal override Hashtable ToHashtable()
		{
			...
			if (PathFormatter != PathFormatter_DefaultValue) { h.Add("pathFormatter",PathFormatter); Highcharts.AddFunction("6154ad1e-a20e-48e8-bd0e-09214fdb18fe.pathFormatter", PathFormatter); }  
