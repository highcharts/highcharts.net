...
namespace Highsoft.Web.Mvc.Charts
{
	public partial class Funnel3dSeriesDragDropDragHandle  : BaseObject
	{
		...
		internal override Hashtable ToHashtable()
		{
			...
			if (PathFormatter != PathFormatter_DefaultValue) { h.Add("pathFormatter",PathFormatter); Highcharts.AddFunction("9b5a9ffd-852c-4d2b-9d5a-20b51da09b12.pathFormatter", PathFormatter); }  
