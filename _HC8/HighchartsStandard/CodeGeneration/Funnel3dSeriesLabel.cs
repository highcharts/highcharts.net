...
{
	public partial class Funnel3dSeriesLabel  : BaseObject
	{
		Hashtable h = new Hashtable();

		public Funnel3dSeriesLabel()
		{
			...
			Style = Style_DefaultValue = new Funnel3dSeriesLabelStyle();
		...
		/// </summary>
		public Funnel3dSeriesLabelStyle Style { get; set; }
		private Funnel3dSeriesLabelStyle Style_DefaultValue { get; set; }
		...
		internal override Hashtable ToHashtable()
		{
			...
			if (Formatter != Formatter_DefaultValue) { h.Add("formatter",Formatter); Highcharts.AddFunction("46b9ffae-d9c9-47d1-8a26-5faf89cc5470.formatter", Formatter); }  
