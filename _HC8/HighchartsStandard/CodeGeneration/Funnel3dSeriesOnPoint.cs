...
{
	public partial class Funnel3dSeriesOnPoint  : BaseObject
	{
		Hashtable h = new Hashtable();

		public Funnel3dSeriesOnPoint()
		{
			ConnectorOptions = ConnectorOptions_DefaultValue = new Funnel3dSeriesOnPointConnectorOptions();
			Id = Id_DefaultValue = "";
			Position = Position_DefaultValue = new Funnel3dSeriesOnPointPosition();
		...
		/// </summary>
		public Funnel3dSeriesOnPointConnectorOptions ConnectorOptions { get; set; }
		private Funnel3dSeriesOnPointConnectorOptions ConnectorOptions_DefaultValue { get; set; }
		...
		/// </summary>
		public Funnel3dSeriesOnPointPosition Position { get; set; }
		private Funnel3dSeriesOnPointPosition Position_DefaultValue { get; set; }
