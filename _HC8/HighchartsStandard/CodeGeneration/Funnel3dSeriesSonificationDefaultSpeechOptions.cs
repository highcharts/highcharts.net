...
{
	public partial class Funnel3dSeriesSonificationDefaultSpeechOptions  : BaseObject
	{
		Hashtable h = new Hashtable();

		public Funnel3dSeriesSonificationDefaultSpeechOptions()
		{
			ActiveWhen = ActiveWhen_DefaultValue = new Funnel3dSeriesSonificationDefaultSpeechOptionsActiveWhen();
			Language = Language_DefaultValue = "en-US";
			Mapping = Mapping_DefaultValue = new Funnel3dSeriesSonificationDefaultSpeechOptionsMapping();
			PointGrouping = PointGrouping_DefaultValue = new Funnel3dSeriesSonificationDefaultSpeechOptionsPointGrouping();
			PreferredVoice = PreferredVoice_DefaultValue = "";
			ShowPlayMarker = ShowPlayMarker_DefaultValue = true;
			Type = Type_DefaultValue = Funnel3dSeriesSonificationDefaultSpeechOptionsType.Instrument;
		...
		/// </summary>
		public Funnel3dSeriesSonificationDefaultSpeechOptionsActiveWhen ActiveWhen { get; set; }
		private Funnel3dSeriesSonificationDefaultSpeechOptionsActiveWhen ActiveWhen_DefaultValue { get; set; }
		...
		/// </summary>
		public Funnel3dSeriesSonificationDefaultSpeechOptionsMapping Mapping { get; set; }
		private Funnel3dSeriesSonificationDefaultSpeechOptionsMapping Mapping_DefaultValue { get; set; }
		 

		/// <summary>
		/// Options for point grouping, specifically for instrument tracks.
		/// </summary>
		public Funnel3dSeriesSonificationDefaultSpeechOptionsPointGrouping PointGrouping { get; set; }
		private Funnel3dSeriesSonificationDefaultSpeechOptionsPointGrouping PointGrouping_DefaultValue { get; set; }
		...
		/// </summary>
		public Funnel3dSeriesSonificationDefaultSpeechOptionsType Type { get; set; }
		private Funnel3dSeriesSonificationDefaultSpeechOptionsType Type_DefaultValue { get; set; }
