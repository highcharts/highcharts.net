...
{
	public partial class Funnel3dSeriesSonificationTracks  : BaseObject
	{
		Hashtable h = new Hashtable();

		public Funnel3dSeriesSonificationTracks()
		{
			ActiveWhen = ActiveWhen_DefaultValue = new Funnel3dSeriesSonificationTracksActiveWhen();
			Instrument = Instrument_DefaultValue = null;
			InstrumentString = InstrumentString_DefaultValue = "null";
			Mapping = Mapping_DefaultValue = new Funnel3dSeriesSonificationTracksMapping();
			MidiName = MidiName_DefaultValue = "";
			PointGrouping = PointGrouping_DefaultValue = new Funnel3dSeriesSonificationTracksPointGrouping();
			RoundToMusicalNotes = RoundToMusicalNotes_DefaultValue = true;
			ShowPlayMarker = ShowPlayMarker_DefaultValue = true;
			Type = Type_DefaultValue = Funnel3dSeriesSonificationTracksType.Instrument;
		...
		/// </summary>
		public Funnel3dSeriesSonificationTracksActiveWhen ActiveWhen { get; set; }
		private Funnel3dSeriesSonificationTracksActiveWhen ActiveWhen_DefaultValue { get; set; }
		...
		/// </summary>
		public Funnel3dSeriesSonificationTracksMapping Mapping { get; set; }
		private Funnel3dSeriesSonificationTracksMapping Mapping_DefaultValue { get; set; }
		...
		/// </summary>
		public Funnel3dSeriesSonificationTracksPointGrouping PointGrouping { get; set; }
		private Funnel3dSeriesSonificationTracksPointGrouping PointGrouping_DefaultValue { get; set; }
		...
		/// </summary>
		public Funnel3dSeriesSonificationTracksType Type { get; set; }
		private Funnel3dSeriesSonificationTracksType Type_DefaultValue { get; set; }
