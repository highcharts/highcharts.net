...
{
	public partial class Funnel3dSeriesStatesSelect  : BaseObject
	{
		Hashtable h = new Hashtable();

		public Funnel3dSeriesStatesSelect()
		{
			Animation = Animation_DefaultValue = new Animation() { Enabled = true };
			Enabled = Enabled_DefaultValue = null;
			Halo = Halo_DefaultValue = new Funnel3dSeriesStatesSelectHalo();
			LineWidth = LineWidth_DefaultValue = null;
			LineWidthPlus = LineWidthPlus_DefaultValue = null;
			Marker = Marker_DefaultValue = new Funnel3dSeriesStatesSelectMarker();
		...
		/// </summary>
		public Funnel3dSeriesStatesSelectHalo Halo { get; set; }
		private Funnel3dSeriesStatesSelectHalo Halo_DefaultValue { get; set; }
		...
		/// </summary>
		public Funnel3dSeriesStatesSelectMarker Marker { get; set; }
		private Funnel3dSeriesStatesSelectMarker Marker_DefaultValue { get; set; }
