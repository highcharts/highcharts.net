...
{
	public partial class Funnel3dSeriesStatesSelectMarker  : BaseObject
	{
		Hashtable h = new Hashtable();

		public Funnel3dSeriesStatesSelectMarker()
		{
			...
			States = States_DefaultValue = new Funnel3dSeriesStatesSelectMarkerStates();
		...
		/// </summary>
		public Funnel3dSeriesStatesSelectMarkerStates States { get; set; }
		private Funnel3dSeriesStatesSelectMarkerStates States_DefaultValue { get; set; }
