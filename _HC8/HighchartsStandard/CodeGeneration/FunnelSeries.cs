...
namespace Highsoft.Web.Mvc.Charts
{
	public partial class FunnelSeries  : Series
	{
		...
		public FunnelSeries()
		{
			Accessibility = Accessibility_DefaultValue = new FunnelSeriesAccessibility();
			AllowPointSelect = AllowPointSelect_DefaultValue = false;
			Animation = Animation_DefaultValue = new Animation() { Enabled = true };
			BoostBlending = BoostBlending_DefaultValue = FunnelSeriesBoostBlending.Undefined;
			...
			DataSorting = DataSorting_DefaultValue = new FunnelSeriesDataSorting();
			Depth = Depth_DefaultValue = 0;
			Description = Description_DefaultValue = "";
			DragDrop = DragDrop_DefaultValue = new FunnelSeriesDragDrop();
			...
			Type = Type_DefaultValue = FunnelSeriesType.Funnel;
		...
		/// </summary>
		public FunnelSeriesAccessibility Accessibility { get; set; }
		private FunnelSeriesAccessibility Accessibility_DefaultValue { get; set; }
		...
		/// </summary>
		public FunnelSeriesBoostBlending BoostBlending { get; set; }
		private FunnelSeriesBoostBlending BoostBlending_DefaultValue { get; set; }
		...
		/// <summary>
		/// An array of data points for the series. For the `funnel` series type,points can be given in the following ways:1.  An array of numerical values. In this case, the numerical valueswill be interpreted as `y` options. Example: ```js data: [0, 5, 3, 5] ```2.  An array of objects with named values. The following snippet shows only afew settings, see the complete options set below. If the total number of datapoints exceeds the series' [turboThreshold](#series.funnel.turboThreshold),this option is not available. ```js    data: [{        y: 3,        name: "Point2",        color: "#00FF00"    }, {        y: 1,        name: "Point1",        color: "#FF00FF"    }] ```
		/// </summary>
		...
		/// </summary>
		public FunnelSeriesDataSorting DataSorting { get; set; }
		private FunnelSeriesDataSorting DataSorting_DefaultValue { get; set; }
		...
		/// </summary>
		public FunnelSeriesDragDrop DragDrop { get; set; }
		private FunnelSeriesDragDrop DragDrop_DefaultValue { get; set; }
		...
		internal override Hashtable ToHashtable()
		{
			...
			if (PointDescriptionFormatter != PointDescriptionFormatter_DefaultValue) { h.Add("pointDescriptionFormatter",PointDescriptionFormatter); Highcharts.AddFunction("cc955cd9-7f74-42d0-bcf4-8eb8c97074ba.pointDescriptionFormatter", PointDescriptionFormatter); }  
