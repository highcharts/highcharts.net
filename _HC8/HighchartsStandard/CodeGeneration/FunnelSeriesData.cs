...
namespace Highsoft.Web.Mvc.Charts
{
	public partial class FunnelSeriesData  : BaseObject
	{
		...
		{
			Accessibility = Accessibility_DefaultValue = new FunnelSeriesDataAccessibility();
			...
			DragDrop = DragDrop_DefaultValue = new FunnelSeriesDataDragDrop();
		...
		private FunnelSeriesDataAccessibility Accessibility_DefaultValue { get; set; }
		...
		private FunnelSeriesDataDragDrop DragDrop_DefaultValue { get; set; }
