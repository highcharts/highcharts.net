...
{
	public partial class FunnelSeriesDataDragDrop  : BaseObject
	{
		Hashtable h = new Hashtable();

		public FunnelSeriesDataDragDrop()
		{
			DraggableX = DraggableX_DefaultValue = null;
			DraggableY = DraggableY_DefaultValue = null;
			DragHandle = DragHandle_DefaultValue = new FunnelSeriesDataDragDropDragHandle();
			...
			GuideBox = GuideBox_DefaultValue = new FunnelSeriesDataDragDropGuideBox();
		...
		/// </summary>
		public FunnelSeriesDataDragDropDragHandle DragHandle { get; set; }
		private FunnelSeriesDataDragDropDragHandle DragHandle_DefaultValue { get; set; }
		...
		/// </summary>
		public FunnelSeriesDataDragDropGuideBox GuideBox { get; set; }
		private FunnelSeriesDataDragDropGuideBox GuideBox_DefaultValue { get; set; }
