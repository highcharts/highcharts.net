...
namespace Highsoft.Web.Mvc.Charts
{
	public partial class FunnelSeriesDataDragDropDragHandle  : BaseObject
	{
		...
		internal override Hashtable ToHashtable()
		{
			...
			if (PathFormatter != PathFormatter_DefaultValue) { h.Add("pathFormatter",PathFormatter); Highcharts.AddFunction("dbf7a6bd-05d0-4a57-9cbe-0c6d1fd3e411.pathFormatter", PathFormatter); }  
