...
{
	public partial class FunnelSeriesDataMarker  : BaseObject
	{
		Hashtable h = new Hashtable();

		public FunnelSeriesDataMarker()
		{
			...
			States = States_DefaultValue = new FunnelSeriesDataMarkerStates();
		...
		/// </summary>
		public FunnelSeriesDataMarkerStates States { get; set; }
		private FunnelSeriesDataMarkerStates States_DefaultValue { get; set; }
