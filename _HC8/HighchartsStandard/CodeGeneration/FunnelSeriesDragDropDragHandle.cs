...
namespace Highsoft.Web.Mvc.Charts
{
	public partial class FunnelSeriesDragDropDragHandle  : BaseObject
	{
		...
		internal override Hashtable ToHashtable()
		{
			...
			if (PathFormatter != PathFormatter_DefaultValue) { h.Add("pathFormatter",PathFormatter); Highcharts.AddFunction("66acec2e-5f51-4d9a-ada7-475992ddbcf8.pathFormatter", PathFormatter); }  
