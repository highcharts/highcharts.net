...
namespace Highsoft.Web.Mvc.Charts
{
	public partial class FunnelSeriesDragDropDragHandle  : BaseObject
	{
		...
		internal override Hashtable ToHashtable()
		{
			...
			if (PathFormatter != PathFormatter_DefaultValue) { h.Add("pathFormatter",PathFormatter); Highcharts.AddFunction("e5f6e2e1-3a47-430e-ab01-8c9edae31292.pathFormatter", PathFormatter); }  
