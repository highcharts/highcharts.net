...
{
	public partial class FunnelSeriesOnPoint  : BaseObject
	{
		Hashtable h = new Hashtable();

		public FunnelSeriesOnPoint()
		{
			ConnectorOptions = ConnectorOptions_DefaultValue = new FunnelSeriesOnPointConnectorOptions();
			Id = Id_DefaultValue = "";
			Position = Position_DefaultValue = new FunnelSeriesOnPointPosition();
		...
		/// </summary>
		public FunnelSeriesOnPointConnectorOptions ConnectorOptions { get; set; }
		private FunnelSeriesOnPointConnectorOptions ConnectorOptions_DefaultValue { get; set; }
		...
		/// </summary>
		public FunnelSeriesOnPointPosition Position { get; set; }
		private FunnelSeriesOnPointPosition Position_DefaultValue { get; set; }
