...
{
	public partial class FunnelSeriesSonificationContextTracks  : BaseObject
	{
		Hashtable h = new Hashtable();

		public FunnelSeriesSonificationContextTracks()
		{
			ActiveWhen = ActiveWhen_DefaultValue = new FunnelSeriesSonificationContextTracksActiveWhen();
			Instrument = Instrument_DefaultValue = null;
			InstrumentString = InstrumentString_DefaultValue = "null";
			Mapping = Mapping_DefaultValue = new FunnelSeriesSonificationContextTracksMapping();
			MidiName = MidiName_DefaultValue = "";
			PointGrouping = PointGrouping_DefaultValue = new FunnelSeriesSonificationContextTracksPointGrouping();
			...
			Type = Type_DefaultValue = FunnelSeriesSonificationContextTracksType.Instrument;
			ValueInterval = ValueInterval_DefaultValue = null;
			ValueMapFunction = ValueMapFunction_DefaultValue = FunnelSeriesSonificationContextTracksValueMapFunction.Linear;
		...
		/// </summary>
		public FunnelSeriesSonificationContextTracksActiveWhen ActiveWhen { get; set; }
		private FunnelSeriesSonificationContextTracksActiveWhen ActiveWhen_DefaultValue { get; set; }
		...
		/// </summary>
		public FunnelSeriesSonificationContextTracksMapping Mapping { get; set; }
		private FunnelSeriesSonificationContextTracksMapping Mapping_DefaultValue { get; set; }
		...
		/// </summary>
		public FunnelSeriesSonificationContextTracksPointGrouping PointGrouping { get; set; }
		private FunnelSeriesSonificationContextTracksPointGrouping PointGrouping_DefaultValue { get; set; }
		...
		/// </summary>
		public FunnelSeriesSonificationContextTracksType Type { get; set; }
		private FunnelSeriesSonificationContextTracksType Type_DefaultValue { get; set; }
		...
		/// </summary>
		public FunnelSeriesSonificationContextTracksValueMapFunction ValueMapFunction { get; set; }
		private FunnelSeriesSonificationContextTracksValueMapFunction ValueMapFunction_DefaultValue { get; set; }
