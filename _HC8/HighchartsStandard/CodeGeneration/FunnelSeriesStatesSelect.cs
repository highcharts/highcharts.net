...
{
	public partial class FunnelSeriesStatesSelect  : BaseObject
	{
		Hashtable h = new Hashtable();

		public FunnelSeriesStatesSelect()
		{
			Animation = Animation_DefaultValue = new Animation() { Enabled = true };
			Enabled = Enabled_DefaultValue = true;
			Halo = Halo_DefaultValue = new FunnelSeriesStatesSelectHalo();
			LineWidth = LineWidth_DefaultValue = null;
			LineWidthPlus = LineWidthPlus_DefaultValue = 1;
			Marker = Marker_DefaultValue = new FunnelSeriesStatesSelectMarker();
		...
		/// </summary>
		public FunnelSeriesStatesSelectHalo Halo { get; set; }
		private FunnelSeriesStatesSelectHalo Halo_DefaultValue { get; set; }
		...
		/// </summary>
		public FunnelSeriesStatesSelectMarker Marker { get; set; }
		private FunnelSeriesStatesSelectMarker Marker_DefaultValue { get; set; }
