...
{
	public partial class FunnelSeriesStatesSelectMarker  : BaseObject
	{
		Hashtable h = new Hashtable();

		public FunnelSeriesStatesSelectMarker()
		{
			...
			States = States_DefaultValue = new FunnelSeriesStatesSelectMarkerStates();
		...
		/// </summary>
		public FunnelSeriesStatesSelectMarkerStates States { get; set; }
		private FunnelSeriesStatesSelectMarkerStates States_DefaultValue { get; set; }
