...
namespace Highsoft.Web.Mvc.Charts
{
	public partial class GaugeSeries  : Series
	{
		...
		public GaugeSeries()
		{
			...
			Type = Type_DefaultValue = GaugeSeriesType.Gauge;
		...
		internal override Hashtable ToHashtable()
		{
			...
			if (PointDescriptionFormatter != PointDescriptionFormatter_DefaultValue) { h.Add("pointDescriptionFormatter",PointDescriptionFormatter); Highcharts.AddFunction("c99dcae9-f01c-4d5e-9b4d-b4bfce27d972.pointDescriptionFormatter", PointDescriptionFormatter); }  
