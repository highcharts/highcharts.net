...
namespace Highsoft.Web.Mvc.Charts
{
	public partial class GaugeSeries  : Series
	{
		...
		public GaugeSeries()
		{
			Accessibility = Accessibility_DefaultValue = new GaugeSeriesAccessibility();
			AllowPointSelect = AllowPointSelect_DefaultValue = false;
			Animation = Animation_DefaultValue = new Animation() { Enabled = true };
			BoostBlending = BoostBlending_DefaultValue = GaugeSeriesBoostBlending.Undefined;
			...
			DataSorting = DataSorting_DefaultValue = new GaugeSeriesDataSorting();
			Description = Description_DefaultValue = "";
			Dial = Dial_DefaultValue = new GaugeSeriesDial();
			DragDrop = DragDrop_DefaultValue = new GaugeSeriesDragDrop();
		...
		/// </summary>
		public GaugeSeriesAccessibility Accessibility { get; set; }
		private GaugeSeriesAccessibility Accessibility_DefaultValue { get; set; }
		...
		/// </summary>
		public GaugeSeriesBoostBlending BoostBlending { get; set; }
		private GaugeSeriesBoostBlending BoostBlending_DefaultValue { get; set; }
		...
		/// </summary>
		public GaugeSeriesDataSorting DataSorting { get; set; }
		private GaugeSeriesDataSorting DataSorting_DefaultValue { get; set; }
		...
		internal override Hashtable ToHashtable()
		{
			...
			if (PointDescriptionFormatter != PointDescriptionFormatter_DefaultValue) { h.Add("pointDescriptionFormatter",PointDescriptionFormatter); Highcharts.AddFunction("6a0b9b7f-7aed-4c00-89f3-b0ce39757f77.pointDescriptionFormatter", PointDescriptionFormatter); }  
