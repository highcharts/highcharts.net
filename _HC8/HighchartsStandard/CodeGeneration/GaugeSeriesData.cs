...
{
	public partial class GaugeSeriesData  : BaseObject
	{
		Hashtable h = new Hashtable();

		public GaugeSeriesData()
		{
			Accessibility = Accessibility_DefaultValue = new GaugeSeriesDataAccessibility();
			...
			DragDrop = DragDrop_DefaultValue = new GaugeSeriesDataDragDrop();
			Drilldown = Drilldown_DefaultValue = "";
			Events = Events_DefaultValue = new GaugeSeriesDataEvents();
			Id = Id_DefaultValue = "";
			Labelrank = Labelrank_DefaultValue = null;
			Marker = Marker_DefaultValue = new GaugeSeriesDataMarker();
		...
		/// </summary>
		public GaugeSeriesDataAccessibility Accessibility { get; set; }
		private GaugeSeriesDataAccessibility Accessibility_DefaultValue { get; set; }
		...
		/// </summary>
		public GaugeSeriesDataDragDrop DragDrop { get; set; }
		private GaugeSeriesDataDragDrop DragDrop_DefaultValue { get; set; }
		...
		/// </summary>
		public GaugeSeriesDataMarker Marker { get; set; }
		private GaugeSeriesDataMarker Marker_DefaultValue { get; set; }
