...
namespace Highsoft.Web.Mvc.Charts
{
	public partial class GaugeSeriesDataDragDropDragHandle  : BaseObject
	{
		...
		internal override Hashtable ToHashtable()
		{
			...
			if (PathFormatter != PathFormatter_DefaultValue) { h.Add("pathFormatter",PathFormatter); Highcharts.AddFunction("9955a62f-6853-467b-8007-46b73bf22322.pathFormatter", PathFormatter); }  
