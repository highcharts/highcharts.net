...
{
	public partial class GaugeSeriesDataMarker  : BaseObject
	{
		Hashtable h = new Hashtable();

		public GaugeSeriesDataMarker()
		{
			...
			States = States_DefaultValue = new GaugeSeriesDataMarkerStates();
		...
		/// </summary>
		public GaugeSeriesDataMarkerStates States { get; set; }
		private GaugeSeriesDataMarkerStates States_DefaultValue { get; set; }
