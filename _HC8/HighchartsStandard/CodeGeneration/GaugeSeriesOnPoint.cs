...
{
	public partial class GaugeSeriesOnPoint  : BaseObject
	{
		Hashtable h = new Hashtable();

		public GaugeSeriesOnPoint()
		{
			ConnectorOptions = ConnectorOptions_DefaultValue = new GaugeSeriesOnPointConnectorOptions();
			Id = Id_DefaultValue = "";
			Position = Position_DefaultValue = new GaugeSeriesOnPointPosition();
		...
		/// </summary>
		public GaugeSeriesOnPointConnectorOptions ConnectorOptions { get; set; }
		private GaugeSeriesOnPointConnectorOptions ConnectorOptions_DefaultValue { get; set; }
		...
		/// </summary>
		public GaugeSeriesOnPointPosition Position { get; set; }
		private GaugeSeriesOnPointPosition Position_DefaultValue { get; set; }
