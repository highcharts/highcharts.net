...
{
	public partial class GaugeSeriesSonificationContextTracks  : BaseObject
	{
		Hashtable h = new Hashtable();

		public GaugeSeriesSonificationContextTracks()
		{
			ActiveWhen = ActiveWhen_DefaultValue = new GaugeSeriesSonificationContextTracksActiveWhen();
			Instrument = Instrument_DefaultValue = null;
			InstrumentString = InstrumentString_DefaultValue = "null";
			Mapping = Mapping_DefaultValue = new GaugeSeriesSonificationContextTracksMapping();
			MidiName = MidiName_DefaultValue = "";
			PointGrouping = PointGrouping_DefaultValue = new GaugeSeriesSonificationContextTracksPointGrouping();
			...
			Type = Type_DefaultValue = GaugeSeriesSonificationContextTracksType.Instrument;
			ValueInterval = ValueInterval_DefaultValue = null;
			ValueMapFunction = ValueMapFunction_DefaultValue = GaugeSeriesSonificationContextTracksValueMapFunction.Linear;
		...
		/// </summary>
		public GaugeSeriesSonificationContextTracksActiveWhen ActiveWhen { get; set; }
		private GaugeSeriesSonificationContextTracksActiveWhen ActiveWhen_DefaultValue { get; set; }
		...
		/// </summary>
		public GaugeSeriesSonificationContextTracksMapping Mapping { get; set; }
		private GaugeSeriesSonificationContextTracksMapping Mapping_DefaultValue { get; set; }
		...
		/// </summary>
		public GaugeSeriesSonificationContextTracksPointGrouping PointGrouping { get; set; }
		private GaugeSeriesSonificationContextTracksPointGrouping PointGrouping_DefaultValue { get; set; }
		...
		/// </summary>
		public GaugeSeriesSonificationContextTracksType Type { get; set; }
		private GaugeSeriesSonificationContextTracksType Type_DefaultValue { get; set; }
		...
		/// </summary>
		public GaugeSeriesSonificationContextTracksValueMapFunction ValueMapFunction { get; set; }
		private GaugeSeriesSonificationContextTracksValueMapFunction ValueMapFunction_DefaultValue { get; set; }
