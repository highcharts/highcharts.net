...
{
	public partial class GaugeSeriesSonificationTracks  : BaseObject
	{
		Hashtable h = new Hashtable();

		public GaugeSeriesSonificationTracks()
		{
			ActiveWhen = ActiveWhen_DefaultValue = new GaugeSeriesSonificationTracksActiveWhen();
			Instrument = Instrument_DefaultValue = null;
			InstrumentString = InstrumentString_DefaultValue = "null";
			Mapping = Mapping_DefaultValue = new GaugeSeriesSonificationTracksMapping();
			MidiName = MidiName_DefaultValue = "";
			PointGrouping = PointGrouping_DefaultValue = new GaugeSeriesSonificationTracksPointGrouping();
			RoundToMusicalNotes = RoundToMusicalNotes_DefaultValue = true;
			ShowPlayMarker = ShowPlayMarker_DefaultValue = true;
			Type = Type_DefaultValue = GaugeSeriesSonificationTracksType.Instrument;
		...
		/// </summary>
		public GaugeSeriesSonificationTracksActiveWhen ActiveWhen { get; set; }
		private GaugeSeriesSonificationTracksActiveWhen ActiveWhen_DefaultValue { get; set; }
		...
		/// </summary>
		public GaugeSeriesSonificationTracksMapping Mapping { get; set; }
		private GaugeSeriesSonificationTracksMapping Mapping_DefaultValue { get; set; }
		...
		/// </summary>
		public GaugeSeriesSonificationTracksPointGrouping PointGrouping { get; set; }
		private GaugeSeriesSonificationTracksPointGrouping PointGrouping_DefaultValue { get; set; }
		...
		/// </summary>
		public GaugeSeriesSonificationTracksType Type { get; set; }
		private GaugeSeriesSonificationTracksType Type_DefaultValue { get; set; }
