...
{
	public partial class GaugeSeriesTooltip  : BaseObject
	{
		...
		public GaugeSeriesTooltip()
		{
			...
			HeaderShape = HeaderShape_DefaultValue = GaugeSeriesTooltipHeaderShape.Callout;
		...
		/// </summary>
		public GaugeSeriesTooltipHeaderShape HeaderShape { get; set; }
		private GaugeSeriesTooltipHeaderShape HeaderShape_DefaultValue { get; set; }
		...
		internal override Hashtable ToHashtable()
		{
			...
			if (NullFormatter != NullFormatter_DefaultValue) { h.Add("nullFormatter",NullFormatter); Highcharts.AddFunction("ac805b27-83d7-4743-9464-fba63a16a9d1.nullFormatter", NullFormatter); }  
			if (Outside != Outside_DefaultValue) h.Add("outside",Outside);
			if (Padding != Padding_DefaultValue) h.Add("padding",Padding);
			if (PointFormat != PointFormat_DefaultValue) h.Add("pointFormat",PointFormat);
			if (PointFormatter != PointFormatter_DefaultValue) { h.Add("pointFormatter",PointFormatter); Highcharts.AddFunction("957c136b-cb0d-478c-9465-0deed4b7e998.pointFormatter", PointFormatter); }  
