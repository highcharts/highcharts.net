...
namespace Highsoft.Web.Mvc.Charts
{
	public partial class HeatmapSeries  : Series
	{
		...
		public HeatmapSeries()
		{
			...
			Type = Type_DefaultValue = HeatmapSeriesType.Heatmap;
		...
		internal override Hashtable ToHashtable()
		{
			...
			if (PointDescriptionFormatter != PointDescriptionFormatter_DefaultValue) { h.Add("pointDescriptionFormatter",PointDescriptionFormatter); Highcharts.AddFunction("8b827cd3-f851-4212-a6cc-8870b9eefdfe.pointDescriptionFormatter", PointDescriptionFormatter); }  
