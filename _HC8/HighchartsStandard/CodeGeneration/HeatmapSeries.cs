...
namespace Highsoft.Web.Mvc.Charts
{
	public partial class HeatmapSeries  : Series
	{
		...
		{
			Accessibility = Accessibility_DefaultValue = new HeatmapSeriesAccessibility();
			AllowPointSelect = AllowPointSelect_DefaultValue = false;
			Animation = Animation_DefaultValue = new Animation();
			AnimationBool = AnimationBool_DefaultValue = true;
			BoostBlending = BoostBlending_DefaultValue = HeatmapSeriesBoostBlending.Undefined;
			BoostThreshold = BoostThreshold_DefaultValue = 5000;
			BorderRadius = BorderRadius_DefaultValue = 0;
			BorderWidth = BorderWidth_DefaultValue = 0;
			ClassName = ClassName_DefaultValue = "";
			Clip = Clip_DefaultValue = true;
			Cluster = Cluster_DefaultValue = new HeatmapSeriesCluster();
			...
			DataSorting = DataSorting_DefaultValue = new HeatmapSeriesDataSorting();
			Description = Description_DefaultValue = "";
			DragDrop = DragDrop_DefaultValue = new HeatmapSeriesDragDrop();
			EnableMouseTracking = EnableMouseTracking_DefaultValue = true;
			Events = Events_DefaultValue = new HeatmapSeriesEvents();
			Id = Id_DefaultValue = "";
			IncludeInDataExport = IncludeInDataExport_DefaultValue = null;
			Index = Index_DefaultValue = null;
			Jitter = Jitter_DefaultValue = new HeatmapSeriesJitter();
			Keys = Keys_DefaultValue = new List<string>();
			Label = Label_DefaultValue = new HeatmapSeriesLabel();
			LegendIndex = LegendIndex_DefaultValue = null;
			LegendSymbol = LegendSymbol_DefaultValue = HeatmapSeriesLegendSymbol.Rectangle;
			LinkedTo = LinkedTo_DefaultValue = "";
			Marker = Marker_DefaultValue = new HeatmapSeriesMarker();
			Name = Name_DefaultValue = "";
			NegativeColor = NegativeColor_DefaultValue = "";
			NullColor = NullColor_DefaultValue = "#f7f7f7";
			OnPoint = OnPoint_DefaultValue = new HeatmapSeriesOnPoint();
			...
			Sonification = Sonification_DefaultValue = new HeatmapSeriesSonification();
		...
		/// </summary>
		public HeatmapSeriesAccessibility Accessibility { get; set; }
		private HeatmapSeriesAccessibility Accessibility_DefaultValue { get; set; }
		...
		/// </summary>
		public HeatmapSeriesBoostBlending BoostBlending { get; set; }
		private HeatmapSeriesBoostBlending BoostBlending_DefaultValue { get; set; }
		...
		/// </summary>
		public HeatmapSeriesCluster Cluster { get; set; }
		private HeatmapSeriesCluster Cluster_DefaultValue { get; set; }
		...
		/// <summary>
		/// An array of data points for the series. For the `heatmap` seriestype, points can be given in the following ways:1.  An array of arrays with 3 or 2 values. In this case, the valuescorrespond to `x,y,value`. If the first value is a string, it isapplied as the name of the point, and the `x` value is inferred.The `x` value can also be omitted, in which case the inner arraysshould be of length 2\. Then the `x` value is automatically calculated,either starting at 0 and incremented by 1, or from `pointStart`and `pointInterval` given in the series options. ```js    data: [        [0, 9, 7],        [1, 10, 4],        [2, 6, 3]    ] ```2.  An array of objects with named values. The following snippet shows only afew settings, see the complete options set below. If the total number of datapoints exceeds the series' [turboThreshold](#series.heatmap.turboThreshold),this option is not available. ```js    data: [{        x: 1,        y: 3,        value: 10,        name: "Point2",        color: "#00FF00"    }, {        x: 1,        y: 7,        value: 10,        name: "Point1",        color: "#FF00FF"    }] ```
		/// </summary>
		...
		/// </summary>
		public HeatmapSeriesDataSorting DataSorting { get; set; }
		private HeatmapSeriesDataSorting DataSorting_DefaultValue { get; set; }
		...
		/// </summary>
		public HeatmapSeriesDragDrop DragDrop { get; set; }
		private HeatmapSeriesDragDrop DragDrop_DefaultValue { get; set; }
		...
		/// </summary>
		public HeatmapSeriesJitter Jitter { get; set; }
		private HeatmapSeriesJitter Jitter_DefaultValue { get; set; }
		...
		/// </summary>
		public HeatmapSeriesLabel Label { get; set; }
		private HeatmapSeriesLabel Label_DefaultValue { get; set; }
		...
		/// </summary>
		public HeatmapSeriesLegendSymbol LegendSymbol { get; set; }
		private HeatmapSeriesLegendSymbol LegendSymbol_DefaultValue { get; set; }
		...
		/// 
		/// </summary>
		public HeatmapSeriesMarker Marker { get; set; }
		private HeatmapSeriesMarker Marker_DefaultValue { get; set; }
		...
		/// </summary>
		public HeatmapSeriesOnPoint OnPoint { get; set; }
		private HeatmapSeriesOnPoint OnPoint_DefaultValue { get; set; }
		...
		/// </summary>
		public HeatmapSeriesSonification Sonification { get; set; }
		private HeatmapSeriesSonification Sonification_DefaultValue { get; set; }
