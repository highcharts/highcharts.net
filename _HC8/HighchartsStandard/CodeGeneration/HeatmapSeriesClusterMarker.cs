...
{
	public partial class HeatmapSeriesClusterMarker  : BaseObject
	{
		Hashtable h = new Hashtable();

		public HeatmapSeriesClusterMarker()
		{
			...
			States = States_DefaultValue = new HeatmapSeriesClusterMarkerStates();
		...
		/// </summary>
		public HeatmapSeriesClusterMarkerStates States { get; set; }
		private HeatmapSeriesClusterMarkerStates States_DefaultValue { get; set; }
