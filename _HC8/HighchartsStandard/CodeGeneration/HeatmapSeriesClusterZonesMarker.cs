...
{
	public partial class HeatmapSeriesClusterZonesMarker  : BaseObject
	{
		Hashtable h = new Hashtable();

		public HeatmapSeriesClusterZonesMarker()
		{
			...
			States = States_DefaultValue = new HeatmapSeriesClusterZonesMarkerStates();
		...
		/// </summary>
		public HeatmapSeriesClusterZonesMarkerStates States { get; set; }
		private HeatmapSeriesClusterZonesMarkerStates States_DefaultValue { get; set; }
