...
namespace Highsoft.Web.Mvc.Charts
{
	public partial class HeatmapSeriesData  : BaseObject
	{
		...
		{
			Accessibility = Accessibility_DefaultValue = new HeatmapSeriesDataAccessibility();
			...
			DragDrop = DragDrop_DefaultValue = new HeatmapSeriesDataDragDrop();
			Drilldown = Drilldown_DefaultValue = "";
			Events = Events_DefaultValue = new HeatmapSeriesDataEvents();
			Id = Id_DefaultValue = "";
			Labelrank = Labelrank_DefaultValue = null;
			Marker = Marker_DefaultValue = new HeatmapSeriesDataMarker();
		...
		/// </summary>
		public HeatmapSeriesDataAccessibility Accessibility { get; set; }
		private HeatmapSeriesDataAccessibility Accessibility_DefaultValue { get; set; }
		...
		/// </summary>
		public HeatmapSeriesDataDragDrop DragDrop { get; set; }
		private HeatmapSeriesDataDragDrop DragDrop_DefaultValue { get; set; }
		...
		/// 
		/// </summary>
		public HeatmapSeriesDataMarker Marker { get; set; }
		private HeatmapSeriesDataMarker Marker_DefaultValue { get; set; }
