...
namespace Highsoft.Web.Mvc.Charts
{
	public partial class HeatmapSeriesDataDragDropDragHandle  : BaseObject
	{
		...
		internal override Hashtable ToHashtable()
		{
			...
			if (PathFormatter != PathFormatter_DefaultValue) { h.Add("pathFormatter",PathFormatter); Highcharts.AddFunction("ca1f8705-85ac-466a-b6b4-aa9092104055.pathFormatter", PathFormatter); }  
