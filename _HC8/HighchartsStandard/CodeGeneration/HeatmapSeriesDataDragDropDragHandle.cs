...
namespace Highsoft.Web.Mvc.Charts
{
	public partial class HeatmapSeriesDataDragDropDragHandle  : BaseObject
	{
		...
		internal override Hashtable ToHashtable()
		{
			...
			if (PathFormatter != PathFormatter_DefaultValue) { h.Add("pathFormatter",PathFormatter); Highcharts.AddFunction("13e1fb10-b8a1-4b38-ad10-deb30ae14f69.pathFormatter", PathFormatter); }  
