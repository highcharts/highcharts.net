...
namespace Highsoft.Web.Mvc.Charts
{
	public partial class HeatmapSeriesDataLabels  : BaseObject
	{
		...
		public HeatmapSeriesDataLabels()
		{
			...
			Filter = Filter_DefaultValue = new HeatmapSeriesDataLabelsFilter();
			...
			Style = Style_DefaultValue = new HeatmapSeriesDataLabelsStyle();
			TextPath = TextPath_DefaultValue = new HeatmapSeriesDataLabelsTextPath();
		...
		internal override Hashtable ToHashtable()
		{
			...
			if (Formatter != Formatter_DefaultValue) { h.Add("formatter",Formatter); Highcharts.AddFunction("c815dc0c-9d6f-4bb4-bfa4-cd8983f29604.formatter", Formatter); }  
			if (Inside != Inside_DefaultValue) h.Add("inside",Inside);
			if (NullFormat != NullFormat_DefaultValue) h.Add("nullFormat",NullFormat);
			if (NullFormatter != NullFormatter_DefaultValue) { h.Add("nullFormatter",NullFormatter); Highcharts.AddFunction("10c694ef-fa7d-484f-ae75-68be0641d1b6.nullFormatter", NullFormatter); }  
