...
{
	public partial class HeatmapSeriesMarker  : BaseObject
	{
		Hashtable h = new Hashtable();

		public HeatmapSeriesMarker()
		{
			...
			States = States_DefaultValue = new HeatmapSeriesMarkerStates();
		...
		/// 
		/// </summary>
		public HeatmapSeriesMarkerStates States { get; set; }
		private HeatmapSeriesMarkerStates States_DefaultValue { get; set; }
