...
{
	public partial class HeatmapSeriesOnPoint  : BaseObject
	{
		Hashtable h = new Hashtable();

		public HeatmapSeriesOnPoint()
		{
		...
		/// </summary>
		public HeatmapSeriesOnPointConnectorOptions ConnectorOptions { get; set; }
		private HeatmapSeriesOnPointConnectorOptions ConnectorOptions_DefaultValue { get; set; }
