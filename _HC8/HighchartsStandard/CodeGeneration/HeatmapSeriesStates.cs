...
{
	public partial class HeatmapSeriesStates  : BaseObject
	{
		...
		public HeatmapSeriesStates()
		{
			...
			Inactive = Inactive_DefaultValue = new HeatmapSeriesStatesInactive();
			Normal = Normal_DefaultValue = new HeatmapSeriesStatesNormal();
			Select = Select_DefaultValue = new HeatmapSeriesStatesSelect();
		...
		/// </summary>
		public HeatmapSeriesStatesInactive Inactive { get; set; }
		private HeatmapSeriesStatesInactive Inactive_DefaultValue { get; set; }
		...
		/// </summary>
		public HeatmapSeriesStatesSelect Select { get; set; }
		private HeatmapSeriesStatesSelect Select_DefaultValue { get; set; }
