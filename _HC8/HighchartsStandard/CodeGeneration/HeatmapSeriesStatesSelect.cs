...
{
	public partial class HeatmapSeriesStatesSelect  : BaseObject
	{
		Hashtable h = new Hashtable();

		public HeatmapSeriesStatesSelect()
		{
			Animation = Animation_DefaultValue = new Animation() { Enabled = true };
			Enabled = Enabled_DefaultValue = new Hashtable();
			Halo = Halo_DefaultValue = new HeatmapSeriesStatesSelectHalo();
			LineWidth = LineWidth_DefaultValue = new Hashtable();
			LineWidthPlus = LineWidthPlus_DefaultValue = new Hashtable();
			Marker = Marker_DefaultValue = new HeatmapSeriesStatesSelectMarker();
		...
		/// </summary>
		public HeatmapSeriesStatesSelectHalo Halo { get; set; }
		private HeatmapSeriesStatesSelectHalo Halo_DefaultValue { get; set; }
		...
		/// </summary>
		public HeatmapSeriesStatesSelectMarker Marker { get; set; }
		private HeatmapSeriesStatesSelectMarker Marker_DefaultValue { get; set; }
