...
{
	public partial class HeatmapSeriesStatesSelectMarker  : BaseObject
	{
		Hashtable h = new Hashtable();

		public HeatmapSeriesStatesSelectMarker()
		{
			...
			States = States_DefaultValue = new HeatmapSeriesStatesSelectMarkerStates();
		...
		/// </summary>
		public HeatmapSeriesStatesSelectMarkerStates States { get; set; }
		private HeatmapSeriesStatesSelectMarkerStates States_DefaultValue { get; set; }
