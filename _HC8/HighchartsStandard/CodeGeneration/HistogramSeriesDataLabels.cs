...
{
	public partial class HistogramSeriesDataLabels  : BaseObject
	{
		Hashtable h = new Hashtable();

		public HistogramSeriesDataLabels()
		{
			Align = Align_DefaultValue = HistogramSeriesDataLabelsAlign.Center;
			...
			Filter = Filter_DefaultValue = new HistogramSeriesDataLabelsFilter();
			...
			Style = Style_DefaultValue = new HistogramSeriesDataLabelsStyle();
			TextPath = TextPath_DefaultValue = new HistogramSeriesDataLabelsTextPath();
			UseHTML = UseHTML_DefaultValue = false;
			VerticalAlign = VerticalAlign_DefaultValue = HistogramSeriesDataLabelsVerticalAlign.Bottom;
			X = X_DefaultValue = 0;
			Y = Y_DefaultValue = 0;
			Z = Z_DefaultValue = 6;
		...
		/// </summary>
		public HistogramSeriesDataLabelsAlign Align { get; set; }
		private HistogramSeriesDataLabelsAlign Align_DefaultValue { get; set; }
		...
		/// </summary>
		public HistogramSeriesDataLabelsFilter Filter { get; set; }
		private HistogramSeriesDataLabelsFilter Filter_DefaultValue { get; set; }
		...
		/// </summary>
		public HistogramSeriesDataLabelsStyle Style { get; set; }
		private HistogramSeriesDataLabelsStyle Style_DefaultValue { get; set; }
		...
		/// </summary>
		public HistogramSeriesDataLabelsTextPath TextPath { get; set; }
		private HistogramSeriesDataLabelsTextPath TextPath_DefaultValue { get; set; }
		...
		/// </summary>
		public HistogramSeriesDataLabelsVerticalAlign VerticalAlign { get; set; }
		private HistogramSeriesDataLabelsVerticalAlign VerticalAlign_DefaultValue { get; set; }
		...
		internal override Hashtable ToHashtable()
		{
			...
			if (Formatter != Formatter_DefaultValue) { h.Add("formatter",Formatter); Highcharts.AddFunction("f6f7f32b-77ec-4d29-b22c-dc82e577d150.formatter", Formatter); }  
			if (Inside != Inside_DefaultValue) h.Add("inside",Inside);
			if (NullFormat != NullFormat_DefaultValue) h.Add("nullFormat",NullFormat);
			if (NullFormatter != NullFormatter_DefaultValue) { h.Add("nullFormatter",NullFormatter); Highcharts.AddFunction("ddf103c3-afb2-40ef-b450-d3b90f8cc49b.nullFormatter", NullFormatter); }  
