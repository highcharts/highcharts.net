...
{
	public partial class HistogramSeriesOnPoint  : BaseObject
	{
		Hashtable h = new Hashtable();

		public HistogramSeriesOnPoint()
		{
			ConnectorOptions = ConnectorOptions_DefaultValue = new HistogramSeriesOnPointConnectorOptions();
			Id = Id_DefaultValue = "";
			Position = Position_DefaultValue = new HistogramSeriesOnPointPosition();
		...
		/// </summary>
		public HistogramSeriesOnPointConnectorOptions ConnectorOptions { get; set; }
		private HistogramSeriesOnPointConnectorOptions ConnectorOptions_DefaultValue { get; set; }
		...
		/// </summary>
		public HistogramSeriesOnPointPosition Position { get; set; }
		private HistogramSeriesOnPointPosition Position_DefaultValue { get; set; }
