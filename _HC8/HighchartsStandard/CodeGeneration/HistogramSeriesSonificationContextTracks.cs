...
{
	public partial class HistogramSeriesSonificationContextTracks  : BaseObject
	{
		Hashtable h = new Hashtable();

		public HistogramSeriesSonificationContextTracks()
		{
			ActiveWhen = ActiveWhen_DefaultValue = new HistogramSeriesSonificationContextTracksActiveWhen();
			Instrument = Instrument_DefaultValue = null;
			InstrumentString = InstrumentString_DefaultValue = "null";
			Mapping = Mapping_DefaultValue = new HistogramSeriesSonificationContextTracksMapping();
			MidiName = MidiName_DefaultValue = "";
			PointGrouping = PointGrouping_DefaultValue = new HistogramSeriesSonificationContextTracksPointGrouping();
			...
			Type = Type_DefaultValue = HistogramSeriesSonificationContextTracksType.Instrument;
			ValueInterval = ValueInterval_DefaultValue = null;
			ValueMapFunction = ValueMapFunction_DefaultValue = HistogramSeriesSonificationContextTracksValueMapFunction.Linear;
		...
		/// </summary>
		public HistogramSeriesSonificationContextTracksActiveWhen ActiveWhen { get; set; }
		private HistogramSeriesSonificationContextTracksActiveWhen ActiveWhen_DefaultValue { get; set; }
		...
		/// </summary>
		public HistogramSeriesSonificationContextTracksMapping Mapping { get; set; }
		private HistogramSeriesSonificationContextTracksMapping Mapping_DefaultValue { get; set; }
		...
		/// </summary>
		public HistogramSeriesSonificationContextTracksPointGrouping PointGrouping { get; set; }
		private HistogramSeriesSonificationContextTracksPointGrouping PointGrouping_DefaultValue { get; set; }
		...
		/// </summary>
		public HistogramSeriesSonificationContextTracksType Type { get; set; }
		private HistogramSeriesSonificationContextTracksType Type_DefaultValue { get; set; }
		...
		/// </summary>
		public HistogramSeriesSonificationContextTracksValueMapFunction ValueMapFunction { get; set; }
		private HistogramSeriesSonificationContextTracksValueMapFunction ValueMapFunction_DefaultValue { get; set; }
