...
{
	public partial class HistogramSeriesSonificationDefaultInstrumentOptionsActiveWhen  : BaseObject
	{
		Hashtable h = new Hashtable();

		public HistogramSeriesSonificationDefaultInstrumentOptionsActiveWhen()
		{
