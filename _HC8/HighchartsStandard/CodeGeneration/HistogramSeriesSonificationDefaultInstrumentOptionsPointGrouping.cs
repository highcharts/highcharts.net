...
namespace Highsoft.Web.Mvc.Charts
{
	public partial class HistogramSeriesSonificationDefaultInstrumentOptionsPointGrouping  : BaseObject
	{
		...
		{
			Algorithm = Algorithm_DefaultValue = HistogramSeriesSonificationDefaultInstrumentOptionsPointGroupingAlgorithm.Minimax;
		...
		private HistogramSeriesSonificationDefaultInstrumentOptionsPointGroupingAlgorithm Algorithm_DefaultValue { get; set; }
