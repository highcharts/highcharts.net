...
{
	public partial class HistogramSeriesStatesSelect  : BaseObject
	{
		Hashtable h = new Hashtable();

		public HistogramSeriesStatesSelect()
		{
			Animation = Animation_DefaultValue = new Animation();
			Enabled = Enabled_DefaultValue = null;
			Halo = Halo_DefaultValue = new HistogramSeriesStatesSelectHalo();
			LineWidth = LineWidth_DefaultValue = null;
			LineWidthPlus = LineWidthPlus_DefaultValue = null;
			Marker = Marker_DefaultValue = new HistogramSeriesStatesSelectMarker();
		...
		/// </summary>
		public HistogramSeriesStatesSelectHalo Halo { get; set; }
		private HistogramSeriesStatesSelectHalo Halo_DefaultValue { get; set; }
		...
		/// </summary>
		public HistogramSeriesStatesSelectMarker Marker { get; set; }
		private HistogramSeriesStatesSelectMarker Marker_DefaultValue { get; set; }
