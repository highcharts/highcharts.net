...
namespace Highsoft.Web.Mvc.Charts
{
	public partial class ItemSeries  : Series
	{
		...
		internal override Hashtable ToHashtable()
		{
			...
			if (PointDescriptionFormatter != PointDescriptionFormatter_DefaultValue) { h.Add("pointDescriptionFormatter",PointDescriptionFormatter); Highcharts.AddFunction("9d7da7b8-33d7-4b99-bb64-83ab89a73613.pointDescriptionFormatter", PointDescriptionFormatter); }  
