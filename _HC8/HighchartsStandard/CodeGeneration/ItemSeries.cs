...
namespace Highsoft.Web.Mvc.Charts
{
	public partial class ItemSeries  : Series
	{
		...
		public ItemSeries()
		{
			...
			DataSorting = DataSorting_DefaultValue = new ItemSeriesDataSorting();
			Description = Description_DefaultValue = "";
			DragDrop = DragDrop_DefaultValue = new ItemSeriesDragDrop();
			...
			Type = Type_DefaultValue = ItemSeriesType.Item;
		...
		/// </summary>
		public ItemSeriesBoostBlending BoostBlending { get; set; }
		private ItemSeriesBoostBlending BoostBlending_DefaultValue { get; set; }
		...
		/// </summary>
		public ItemSeriesDataSorting DataSorting { get; set; }
		private ItemSeriesDataSorting DataSorting_DefaultValue { get; set; }
		...
		/// </summary>
		public ItemSeriesDragDrop DragDrop { get; set; }
		private ItemSeriesDragDrop DragDrop_DefaultValue { get; set; }
		...
		/// </summary>
		public ItemSeriesType Type { get; set; }
		private ItemSeriesType Type_DefaultValue { get; set; }
		...
		internal override Hashtable ToHashtable()
		{
			...
			if (PointDescriptionFormatter != PointDescriptionFormatter_DefaultValue) { h.Add("pointDescriptionFormatter",PointDescriptionFormatter); Highcharts.AddFunction("4e03e31b-69d7-4535-a45d-beca43f89efd.pointDescriptionFormatter", PointDescriptionFormatter); }  
