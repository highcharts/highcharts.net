...
{
	public partial class ItemSeriesData  : BaseObject
	{
		Hashtable h = new Hashtable();

		public ItemSeriesData()
		{
			Accessibility = Accessibility_DefaultValue = new ItemSeriesDataAccessibility();
			...
			DragDrop = DragDrop_DefaultValue = new ItemSeriesDataDragDrop();
			Drilldown = Drilldown_DefaultValue = "";
			Events = Events_DefaultValue = new ItemSeriesDataEvents();
			Id = Id_DefaultValue = "";
			Labelrank = Labelrank_DefaultValue = null;
			LegendIndex = LegendIndex_DefaultValue = null;
			Marker = Marker_DefaultValue = new ItemSeriesDataMarker();
		...
		/// </summary>
		public ItemSeriesDataAccessibility Accessibility { get; set; }
		private ItemSeriesDataAccessibility Accessibility_DefaultValue { get; set; }
		...
		/// </summary>
		public ItemSeriesDataDragDrop DragDrop { get; set; }
		private ItemSeriesDataDragDrop DragDrop_DefaultValue { get; set; }
		...
		/// </summary>
		public ItemSeriesDataEvents Events { get; set; }
		private ItemSeriesDataEvents Events_DefaultValue { get; set; }
		...
		/// </summary>
		public ItemSeriesDataMarker Marker { get; set; }
		private ItemSeriesDataMarker Marker_DefaultValue { get; set; }
