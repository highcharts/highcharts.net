...
{
	public partial class ItemSeriesDataDragDrop  : BaseObject
	{
		Hashtable h = new Hashtable();

		public ItemSeriesDataDragDrop()
		{
			DraggableX = DraggableX_DefaultValue = null;
			DraggableY = DraggableY_DefaultValue = null;
			DragHandle = DragHandle_DefaultValue = new ItemSeriesDataDragDropDragHandle();
			...
			GuideBox = GuideBox_DefaultValue = new ItemSeriesDataDragDropGuideBox();
		...
		/// </summary>
		public ItemSeriesDataDragDropDragHandle DragHandle { get; set; }
		private ItemSeriesDataDragDropDragHandle DragHandle_DefaultValue { get; set; }
		...
		/// </summary>
		public ItemSeriesDataDragDropGuideBox GuideBox { get; set; }
		private ItemSeriesDataDragDropGuideBox GuideBox_DefaultValue { get; set; }
