...
namespace Highsoft.Web.Mvc.Charts
{
	public partial class ItemSeriesDataDragDropDragHandle  : BaseObject
	{
		...
		internal override Hashtable ToHashtable()
		{
			...
			if (PathFormatter != PathFormatter_DefaultValue) { h.Add("pathFormatter",PathFormatter); Highcharts.AddFunction("c1911de3-6df0-44f4-ac65-13b686f53d5a.pathFormatter", PathFormatter); }  
