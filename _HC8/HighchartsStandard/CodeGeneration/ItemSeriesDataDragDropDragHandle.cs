...
namespace Highsoft.Web.Mvc.Charts
{
	public partial class ItemSeriesDataDragDropDragHandle  : BaseObject
	{
		...
		internal override Hashtable ToHashtable()
		{
			...
			if (PathFormatter != PathFormatter_DefaultValue) { h.Add("pathFormatter",PathFormatter); Highcharts.AddFunction("f963e75f-6de3-4f30-a0a2-63baf0eae655.pathFormatter", PathFormatter); }  
