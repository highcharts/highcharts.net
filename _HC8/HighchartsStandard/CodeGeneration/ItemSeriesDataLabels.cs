...
{
	public partial class ItemSeriesDataLabels  : BaseObject
	{
		Hashtable h = new Hashtable();

		public ItemSeriesDataLabels()
		{
			Align = Align_DefaultValue = ItemSeriesDataLabelsAlign.Center;
			...
			Filter = Filter_DefaultValue = new ItemSeriesDataLabelsFilter();
			...
			Style = Style_DefaultValue = new ItemSeriesDataLabelsStyle();
			TextPath = TextPath_DefaultValue = new ItemSeriesDataLabelsTextPath();
			UseHTML = UseHTML_DefaultValue = false;
			VerticalAlign = VerticalAlign_DefaultValue = ItemSeriesDataLabelsVerticalAlign.Bottom;
			X = X_DefaultValue = 0;
			Y = Y_DefaultValue = 0;
			Z = Z_DefaultValue = 6;
		...
		/// </summary>
		public ItemSeriesDataLabelsAlign Align { get; set; }
		private ItemSeriesDataLabelsAlign Align_DefaultValue { get; set; }
		...
		/// </summary>
		public ItemSeriesDataLabelsFilter Filter { get; set; }
		private ItemSeriesDataLabelsFilter Filter_DefaultValue { get; set; }
		...
		/// </summary>
		public ItemSeriesDataLabelsStyle Style { get; set; }
		private ItemSeriesDataLabelsStyle Style_DefaultValue { get; set; }
		...
		/// </summary>
		public ItemSeriesDataLabelsTextPath TextPath { get; set; }
		private ItemSeriesDataLabelsTextPath TextPath_DefaultValue { get; set; }
		...
		/// </summary>
		public ItemSeriesDataLabelsVerticalAlign VerticalAlign { get; set; }
		private ItemSeriesDataLabelsVerticalAlign VerticalAlign_DefaultValue { get; set; }
		...
		internal override Hashtable ToHashtable()
		{
			...
			if (Formatter != Formatter_DefaultValue) { h.Add("formatter",Formatter); Highcharts.AddFunction("b9f93aaf-9799-4afb-9fdd-c9f5a640d8d6.formatter", Formatter); }  
			if (Inside != Inside_DefaultValue) h.Add("inside",Inside);
			if (NullFormat != NullFormat_DefaultValue) h.Add("nullFormat",NullFormat);
			if (NullFormatter != NullFormatter_DefaultValue) { h.Add("nullFormatter",NullFormatter); Highcharts.AddFunction("5517775d-f09d-4a19-9516-7f4cd8305ecb.nullFormatter", NullFormatter); }  
