...
{
	public partial class ItemSeriesDataMarker  : BaseObject
	{
		Hashtable h = new Hashtable();

		public ItemSeriesDataMarker()
		{
			...
			States = States_DefaultValue = new ItemSeriesDataMarkerStates();
		...
		/// </summary>
		public ItemSeriesDataMarkerStates States { get; set; }
		private ItemSeriesDataMarkerStates States_DefaultValue { get; set; }
