...
{
	public partial class ItemSeriesDragDrop  : BaseObject
	{
		Hashtable h = new Hashtable();

		public ItemSeriesDragDrop()
		{
			DraggableX = DraggableX_DefaultValue = null;
			DraggableY = DraggableY_DefaultValue = null;
			DragHandle = DragHandle_DefaultValue = new ItemSeriesDragDropDragHandle();
			...
			GuideBox = GuideBox_DefaultValue = new ItemSeriesDragDropGuideBox();
		...
		/// </summary>
		public ItemSeriesDragDropDragHandle DragHandle { get; set; }
		private ItemSeriesDragDropDragHandle DragHandle_DefaultValue { get; set; }
		...
		/// </summary>
		public ItemSeriesDragDropGuideBox GuideBox { get; set; }
		private ItemSeriesDragDropGuideBox GuideBox_DefaultValue { get; set; }
