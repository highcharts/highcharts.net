...
{
	public partial class ItemSeriesLabel  : BaseObject
	{
		Hashtable h = new Hashtable();

		public ItemSeriesLabel()
		{
			...
			Style = Style_DefaultValue = new ItemSeriesLabelStyle();
		...
		/// </summary>
		public ItemSeriesLabelStyle Style { get; set; }
		private ItemSeriesLabelStyle Style_DefaultValue { get; set; }
