...
{
	public partial class ItemSeriesMarker  : BaseObject
	{
		Hashtable h = new Hashtable();

		public ItemSeriesMarker()
		{
			...
			States = States_DefaultValue = new ItemSeriesMarkerStates();
		...
		/// </summary>
		public ItemSeriesMarkerStates States { get; set; }
		private ItemSeriesMarkerStates States_DefaultValue { get; set; }
