...
{
	public partial class ItemSeriesOnPoint  : BaseObject
	{
		Hashtable h = new Hashtable();

		public ItemSeriesOnPoint()
		{
			ConnectorOptions = ConnectorOptions_DefaultValue = new ItemSeriesOnPointConnectorOptions();
			Id = Id_DefaultValue = "";
			Position = Position_DefaultValue = new ItemSeriesOnPointPosition();
		...
		/// </summary>
		public ItemSeriesOnPointConnectorOptions ConnectorOptions { get; set; }
		private ItemSeriesOnPointConnectorOptions ConnectorOptions_DefaultValue { get; set; }
		...
		/// </summary>
		public ItemSeriesOnPointPosition Position { get; set; }
		private ItemSeriesOnPointPosition Position_DefaultValue { get; set; }
