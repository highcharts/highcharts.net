...
{
	public partial class ItemSeriesSonificationTracks  : BaseObject
	{
		Hashtable h = new Hashtable();

		public ItemSeriesSonificationTracks()
		{
			ActiveWhen = ActiveWhen_DefaultValue = new ItemSeriesSonificationTracksActiveWhen();
			Instrument = Instrument_DefaultValue = null;
			InstrumentString = InstrumentString_DefaultValue = "null";
			Mapping = Mapping_DefaultValue = new ItemSeriesSonificationTracksMapping();
			MidiName = MidiName_DefaultValue = "";
			PointGrouping = PointGrouping_DefaultValue = new ItemSeriesSonificationTracksPointGrouping();
			RoundToMusicalNotes = RoundToMusicalNotes_DefaultValue = true;
			ShowPlayMarker = ShowPlayMarker_DefaultValue = true;
			Type = Type_DefaultValue = ItemSeriesSonificationTracksType.Instrument;
		...
		/// </summary>
		public ItemSeriesSonificationTracksActiveWhen ActiveWhen { get; set; }
		private ItemSeriesSonificationTracksActiveWhen ActiveWhen_DefaultValue { get; set; }
		...
		/// </summary>
		public ItemSeriesSonificationTracksMapping Mapping { get; set; }
		private ItemSeriesSonificationTracksMapping Mapping_DefaultValue { get; set; }
		...
		/// </summary>
		public ItemSeriesSonificationTracksPointGrouping PointGrouping { get; set; }
		private ItemSeriesSonificationTracksPointGrouping PointGrouping_DefaultValue { get; set; }
		...
		/// </summary>
		public ItemSeriesSonificationTracksType Type { get; set; }
		private ItemSeriesSonificationTracksType Type_DefaultValue { get; set; }
