...
namespace Highsoft.Web.Mvc.Charts
{
	public partial class LineSeries  : Series
	{
		...
		internal override Hashtable ToHashtable()
		{
			...
			if (PointDescriptionFormatter != PointDescriptionFormatter_DefaultValue) { h.Add("pointDescriptionFormatter",PointDescriptionFormatter); Highcharts.AddFunction("4245136a-29d4-43f3-a1e2-a0389899dab4.pointDescriptionFormatter", PointDescriptionFormatter); }  
