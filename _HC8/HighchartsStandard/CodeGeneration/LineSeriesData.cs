...
{
	public partial class LineSeriesData  : BaseObject
	{
		Hashtable h = new Hashtable();

		public LineSeriesData()
		{
			Accessibility = Accessibility_DefaultValue = new LineSeriesDataAccessibility();
			...
			DragDrop = DragDrop_DefaultValue = new LineSeriesDataDragDrop();
			Drilldown = Drilldown_DefaultValue = "";
			Events = Events_DefaultValue = new LineSeriesDataEvents();
			Id = Id_DefaultValue = "";
			Labelrank = Labelrank_DefaultValue = null;
			Marker = Marker_DefaultValue = new LineSeriesDataMarker();
		...
		/// </summary>
		public LineSeriesDataAccessibility Accessibility { get; set; }
		private LineSeriesDataAccessibility Accessibility_DefaultValue { get; set; }
		...
		/// </summary>
		public LineSeriesDataDragDrop DragDrop { get; set; }
		private LineSeriesDataDragDrop DragDrop_DefaultValue { get; set; }
