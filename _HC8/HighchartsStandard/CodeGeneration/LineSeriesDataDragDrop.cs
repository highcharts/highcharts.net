...
{
	public partial class LineSeriesDataDragDrop  : BaseObject
	{
		Hashtable h = new Hashtable();

		public LineSeriesDataDragDrop()
		{
			DraggableX = DraggableX_DefaultValue = null;
			DraggableY = DraggableY_DefaultValue = null;
			DragHandle = DragHandle_DefaultValue = new LineSeriesDataDragDropDragHandle();
			...
			GuideBox = GuideBox_DefaultValue = new LineSeriesDataDragDropGuideBox();
		...
		/// </summary>
		public LineSeriesDataDragDropDragHandle DragHandle { get; set; }
		private LineSeriesDataDragDropDragHandle DragHandle_DefaultValue { get; set; }
		...
		/// </summary>
		public LineSeriesDataDragDropGuideBox GuideBox { get; set; }
		private LineSeriesDataDragDropGuideBox GuideBox_DefaultValue { get; set; }
