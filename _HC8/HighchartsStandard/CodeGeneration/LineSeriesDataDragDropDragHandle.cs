...
namespace Highsoft.Web.Mvc.Charts
{
	public partial class LineSeriesDataDragDropDragHandle  : BaseObject
	{
		...
		internal override Hashtable ToHashtable()
		{
			...
			if (PathFormatter != PathFormatter_DefaultValue) { h.Add("pathFormatter",PathFormatter); Highcharts.AddFunction("7be4c98e-600d-43e0-ac34-3d0067c13dd1.pathFormatter", PathFormatter); }  
