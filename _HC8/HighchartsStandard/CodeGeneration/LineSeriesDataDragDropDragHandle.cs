...
namespace Highsoft.Web.Mvc.Charts
{
	public partial class LineSeriesDataDragDropDragHandle  : BaseObject
	{
		...
		internal override Hashtable ToHashtable()
		{
			...
			if (PathFormatter != PathFormatter_DefaultValue) { h.Add("pathFormatter",PathFormatter); Highcharts.AddFunction("f2c36dcb-44b9-455f-8517-9dda1e0c1b7e.pathFormatter", PathFormatter); }  
