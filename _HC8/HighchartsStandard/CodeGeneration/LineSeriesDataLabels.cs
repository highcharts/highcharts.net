...
{
	public partial class LineSeriesDataLabels  : BaseObject
	{
		...
		public LineSeriesDataLabels()
		{
			...
			Style = Style_DefaultValue = new LineSeriesDataLabelsStyle();
			TextPath = TextPath_DefaultValue = new LineSeriesDataLabelsTextPath();
		...
		/// </summary>
		public LineSeriesDataLabelsAlign Align { get; set; }
		private LineSeriesDataLabelsAlign Align_DefaultValue { get; set; }
		...
		/// </summary>
		public LineSeriesDataLabelsStyle Style { get; set; }
		private LineSeriesDataLabelsStyle Style_DefaultValue { get; set; }
		...
		/// </summary>
		public LineSeriesDataLabelsTextPath TextPath { get; set; }
		private LineSeriesDataLabelsTextPath TextPath_DefaultValue { get; set; }
		...
		internal override Hashtable ToHashtable()
		{
			...
			if (Formatter != Formatter_DefaultValue) { h.Add("formatter",Formatter); Highcharts.AddFunction("d53b066d-502e-431e-b13f-35d34e94fd48.formatter", Formatter); }  
			...
			if (NullFormatter != NullFormatter_DefaultValue) { h.Add("nullFormatter",NullFormatter); Highcharts.AddFunction("a4436d86-996f-461b-a629-b453da4f89ea.nullFormatter", NullFormatter); }  
