...
namespace Highsoft.Web.Mvc.Charts
{
	public partial class LineSeriesDragDropDragHandle  : BaseObject
	{
		...
		internal override Hashtable ToHashtable()
		{
			...
			if (PathFormatter != PathFormatter_DefaultValue) { h.Add("pathFormatter",PathFormatter); Highcharts.AddFunction("f7aa80ba-610c-4c66-82f2-75dd65b3dd89.pathFormatter", PathFormatter); }  
