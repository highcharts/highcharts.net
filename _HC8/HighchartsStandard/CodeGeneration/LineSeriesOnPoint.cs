...
{
	public partial class LineSeriesOnPoint  : BaseObject
	{
		Hashtable h = new Hashtable();

		public LineSeriesOnPoint()
		{
			ConnectorOptions = ConnectorOptions_DefaultValue = new LineSeriesOnPointConnectorOptions();
			Id = Id_DefaultValue = "";
			Position = Position_DefaultValue = new LineSeriesOnPointPosition();
		...
		/// </summary>
		public LineSeriesOnPointConnectorOptions ConnectorOptions { get; set; }
		private LineSeriesOnPointConnectorOptions ConnectorOptions_DefaultValue { get; set; }
		...
		/// </summary>
		public LineSeriesOnPointPosition Position { get; set; }
		private LineSeriesOnPointPosition Position_DefaultValue { get; set; }
