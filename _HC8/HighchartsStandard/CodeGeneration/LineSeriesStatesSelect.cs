...
{
	public partial class LineSeriesStatesSelect  : BaseObject
	{
		Hashtable h = new Hashtable();

		public LineSeriesStatesSelect()
		{
			Animation = Animation_DefaultValue = new Animation() { Enabled = true };
			Enabled = Enabled_DefaultValue = new Hashtable();
			Halo = Halo_DefaultValue = new LineSeriesStatesSelectHalo();
			LineWidth = LineWidth_DefaultValue = new Hashtable();
			LineWidthPlus = LineWidthPlus_DefaultValue = new Hashtable();
			Marker = Marker_DefaultValue = new LineSeriesStatesSelectMarker();
		...
		/// </summary>
		public LineSeriesStatesSelectHalo Halo { get; set; }
		private LineSeriesStatesSelectHalo Halo_DefaultValue { get; set; }
		...
		/// </summary>
		public LineSeriesStatesSelectMarker Marker { get; set; }
		private LineSeriesStatesSelectMarker Marker_DefaultValue { get; set; }
