...
namespace Highsoft.Web.Mvc.Charts
{
	public partial class LineSeriesTooltip  : BaseObject
	{
		...
		internal override Hashtable ToHashtable()
		{
			...
			if (NullFormatter != NullFormatter_DefaultValue) { h.Add("nullFormatter",NullFormatter); Highcharts.AddFunction("27e469d8-b077-487a-b34c-3d7474559250.nullFormatter", NullFormatter); }  
			if (PointFormat != PointFormat_DefaultValue) h.Add("pointFormat",PointFormat);
			if (PointFormatter != PointFormatter_DefaultValue) { h.Add("pointFormatter",PointFormatter); Highcharts.AddFunction("fb0406f1-6036-40fa-b2d0-7d5fe0f2b07b.pointFormatter", PointFormatter); }  
