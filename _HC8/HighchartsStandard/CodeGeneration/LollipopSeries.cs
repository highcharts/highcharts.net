...
namespace Highsoft.Web.Mvc.Charts
{
	public partial class LollipopSeries  : Series
	{
		...
		internal override Hashtable ToHashtable()
		{
			...
			if (PointDescriptionFormatter != PointDescriptionFormatter_DefaultValue) { h.Add("pointDescriptionFormatter",PointDescriptionFormatter); Highcharts.AddFunction("04d40eab-5e95-4817-b72c-adcecadc551d.pointDescriptionFormatter", PointDescriptionFormatter); }  
