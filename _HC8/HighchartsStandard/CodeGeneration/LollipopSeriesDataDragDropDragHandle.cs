...
namespace Highsoft.Web.Mvc.Charts
{
	public partial class LollipopSeriesDataDragDropDragHandle  : BaseObject
	{
		...
		internal override Hashtable ToHashtable()
		{
			...
			if (PathFormatter != PathFormatter_DefaultValue) { h.Add("pathFormatter",PathFormatter); Highcharts.AddFunction("80da0be2-a362-4900-bb1f-887d3096699c.pathFormatter", PathFormatter); }  
