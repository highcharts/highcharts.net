...
{
	public partial class LollipopSeriesDataLabels  : BaseObject
	{
		Hashtable h = new Hashtable();

		public LollipopSeriesDataLabels()
		{
			Align = Align_DefaultValue = LollipopSeriesDataLabelsAlign.Center;
			...
			Filter = Filter_DefaultValue = new LollipopSeriesDataLabelsFilter();
			...
			Style = Style_DefaultValue = new LollipopSeriesDataLabelsStyle();
			TextPath = TextPath_DefaultValue = new LollipopSeriesDataLabelsTextPath();
			UseHTML = UseHTML_DefaultValue = false;
			VerticalAlign = VerticalAlign_DefaultValue = LollipopSeriesDataLabelsVerticalAlign.Bottom;
			X = X_DefaultValue = 0;
			Y = Y_DefaultValue = 0;
			Z = Z_DefaultValue = 6;
		...
		/// </summary>
		public LollipopSeriesDataLabelsAlign Align { get; set; }
		private LollipopSeriesDataLabelsAlign Align_DefaultValue { get; set; }
		...
		/// </summary>
		public LollipopSeriesDataLabelsFilter Filter { get; set; }
		private LollipopSeriesDataLabelsFilter Filter_DefaultValue { get; set; }
		...
		/// </summary>
		public LollipopSeriesDataLabelsStyle Style { get; set; }
		private LollipopSeriesDataLabelsStyle Style_DefaultValue { get; set; }
		...
		/// </summary>
		public LollipopSeriesDataLabelsTextPath TextPath { get; set; }
		private LollipopSeriesDataLabelsTextPath TextPath_DefaultValue { get; set; }
		...
		/// </summary>
		public LollipopSeriesDataLabelsVerticalAlign VerticalAlign { get; set; }
		private LollipopSeriesDataLabelsVerticalAlign VerticalAlign_DefaultValue { get; set; }
		...
		internal override Hashtable ToHashtable()
		{
			...
			if (Formatter != Formatter_DefaultValue) { h.Add("formatter",Formatter); Highcharts.AddFunction("b7b11e8c-a6c4-4366-8bbf-22718ec988e0.formatter", Formatter); }  
			...
			if (NullFormatter != NullFormatter_DefaultValue) { h.Add("nullFormatter",NullFormatter); Highcharts.AddFunction("45af784e-b07c-4896-8180-c72127cc9e4a.nullFormatter", NullFormatter); }  
