...
{
	public partial class LollipopSeriesDragDrop  : BaseObject
	{
		Hashtable h = new Hashtable();

		public LollipopSeriesDragDrop()
		{
			DraggableX = DraggableX_DefaultValue = null;
			DraggableY = DraggableY_DefaultValue = null;
			DragHandle = DragHandle_DefaultValue = new LollipopSeriesDragDropDragHandle();
			...
			GuideBox = GuideBox_DefaultValue = new LollipopSeriesDragDropGuideBox();
		...
		/// </summary>
		public LollipopSeriesDragDropDragHandle DragHandle { get; set; }
		private LollipopSeriesDragDropDragHandle DragHandle_DefaultValue { get; set; }
		...
		/// </summary>
		public LollipopSeriesDragDropGuideBox GuideBox { get; set; }
		private LollipopSeriesDragDropGuideBox GuideBox_DefaultValue { get; set; }
