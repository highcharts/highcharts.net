...
namespace Highsoft.Web.Mvc.Charts
{
	public partial class LollipopSeriesDragDropDragHandle  : BaseObject
	{
		...
		internal override Hashtable ToHashtable()
		{
			...
			if (PathFormatter != PathFormatter_DefaultValue) { h.Add("pathFormatter",PathFormatter); Highcharts.AddFunction("98cd00b0-7ddc-442c-8efc-9ee4f0e0826f.pathFormatter", PathFormatter); }  
