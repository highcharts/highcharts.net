...
namespace Highsoft.Web.Mvc.Charts
{
	public partial class LollipopSeriesDragDropDragHandle  : BaseObject
	{
		...
		internal override Hashtable ToHashtable()
		{
			...
			if (PathFormatter != PathFormatter_DefaultValue) { h.Add("pathFormatter",PathFormatter); Highcharts.AddFunction("bd866fe5-12d7-4f26-8677-70daee7a0767.pathFormatter", PathFormatter); }  
