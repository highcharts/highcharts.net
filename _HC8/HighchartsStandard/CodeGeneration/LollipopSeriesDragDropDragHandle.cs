...
namespace Highsoft.Web.Mvc.Charts
{
	public partial class LollipopSeriesDragDropDragHandle  : BaseObject
	{
		...
		internal override Hashtable ToHashtable()
		{
			...
			if (PathFormatter != PathFormatter_DefaultValue) { h.Add("pathFormatter",PathFormatter); Highcharts.AddFunction("725356a2-0e6a-44e4-9d0f-4d1bdd4657f1.pathFormatter", PathFormatter); }  
