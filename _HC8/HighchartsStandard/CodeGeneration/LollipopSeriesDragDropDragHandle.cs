...
namespace Highsoft.Web.Mvc.Charts
{
	public partial class LollipopSeriesDragDropDragHandle  : BaseObject
	{
		...
		internal override Hashtable ToHashtable()
		{
			...
			if (PathFormatter != PathFormatter_DefaultValue) { h.Add("pathFormatter",PathFormatter); Highcharts.AddFunction("819d7a91-1927-402e-a312-6a4bc4244594.pathFormatter", PathFormatter); }  
