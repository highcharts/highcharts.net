...
{
	public partial class LollipopSeriesMarker  : BaseObject
	{
		Hashtable h = new Hashtable();

		public LollipopSeriesMarker()
		{
			...
			States = States_DefaultValue = new LollipopSeriesMarkerStates();
		...
		/// </summary>
		public LollipopSeriesMarkerStates States { get; set; }
		private LollipopSeriesMarkerStates States_DefaultValue { get; set; }
