...
{
	public partial class LollipopSeriesOnPoint  : BaseObject
	{
		Hashtable h = new Hashtable();

		public LollipopSeriesOnPoint()
		{
			ConnectorOptions = ConnectorOptions_DefaultValue = new LollipopSeriesOnPointConnectorOptions();
			Id = Id_DefaultValue = "";
			Position = Position_DefaultValue = new LollipopSeriesOnPointPosition();
		...
		/// </summary>
		public LollipopSeriesOnPointConnectorOptions ConnectorOptions { get; set; }
		private LollipopSeriesOnPointConnectorOptions ConnectorOptions_DefaultValue { get; set; }
		...
		/// </summary>
		public LollipopSeriesOnPointPosition Position { get; set; }
		private LollipopSeriesOnPointPosition Position_DefaultValue { get; set; }
