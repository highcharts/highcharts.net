...
{
	public partial class LollipopSeriesStatesSelectMarker  : BaseObject
	{
		Hashtable h = new Hashtable();

		public LollipopSeriesStatesSelectMarker()
		{
			...
			States = States_DefaultValue = new LollipopSeriesStatesSelectMarkerStates();
		...
		/// </summary>
		public LollipopSeriesStatesSelectMarkerStates States { get; set; }
		private LollipopSeriesStatesSelectMarkerStates States_DefaultValue { get; set; }
