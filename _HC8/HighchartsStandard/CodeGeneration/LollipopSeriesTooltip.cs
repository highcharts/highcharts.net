...
{
	public partial class LollipopSeriesTooltip  : BaseObject
	{
		Hashtable h = new Hashtable();

		public LollipopSeriesTooltip()
		{
			...
			HeaderShape = HeaderShape_DefaultValue = LollipopSeriesTooltipHeaderShape.Callout;
		...
		/// </summary>
		public LollipopSeriesTooltipHeaderShape HeaderShape { get; set; }
		private LollipopSeriesTooltipHeaderShape HeaderShape_DefaultValue { get; set; }
		...
		internal override Hashtable ToHashtable()
		{
			...
			if (NullFormatter != NullFormatter_DefaultValue) { h.Add("nullFormatter",NullFormatter); Highcharts.AddFunction("4363b63c-5133-4207-ac0b-93bd58336d55.nullFormatter", NullFormatter); }  
			if (Outside != Outside_DefaultValue) h.Add("outside",Outside);
			if (Padding != Padding_DefaultValue) h.Add("padding",Padding);
			if (PointFormat != PointFormat_DefaultValue) h.Add("pointFormat",PointFormat);
			if (PointFormatter != PointFormatter_DefaultValue) { h.Add("pointFormatter",PointFormatter); Highcharts.AddFunction("57edf6a8-af7f-4e6e-ad46-3181ab9bce86.pointFormatter", PointFormatter); }  
