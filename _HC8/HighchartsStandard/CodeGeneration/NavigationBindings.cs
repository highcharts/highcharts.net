...
namespace Highsoft.Web.Mvc.Charts
{
	public partial class NavigationBindings  : BaseObject
	{
		...
		internal override Hashtable ToHashtable(Highcharts highcharts)
		{
			...
			if (FullScreen.IsDirty(highcharts)) h.Add("fullScreen",FullScreen.ToHashtable(highcharts));
			...
			if (SaveChart.IsDirty(highcharts)) h.Add("saveChart",SaveChart.ToHashtable(highcharts));
			...
			if (SeriesTypeHLC.IsDirty(highcharts)) h.Add("seriesTypeHLC",SeriesTypeHLC.ToHashtable(highcharts));
			...
			if (TimeCycles.IsDirty(highcharts)) h.Add("timeCycles",TimeCycles.ToHashtable(highcharts));
