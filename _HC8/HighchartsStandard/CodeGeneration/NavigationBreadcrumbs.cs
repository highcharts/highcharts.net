...
{
	public partial class NavigationBreadcrumbs  : BaseObject
	{
		...
		public NavigationBreadcrumbs()
		{
			...
			ButtonTheme = ButtonTheme_DefaultValue = new NavigationBreadcrumbsButtonTheme();
			Events = Events_DefaultValue = new NavigationBreadcrumbsEvents();
			Floating = Floating_DefaultValue = false;
			Format = Format_DefaultValue = "undefined";
			Formatter = Formatter_DefaultValue = "";
			Position = Position_DefaultValue = new NavigationBreadcrumbsPosition();
			RelativeTo = RelativeTo_DefaultValue = "plotBox";
			Rtl = Rtl_DefaultValue = false;
			Separator = Separator_DefaultValue = new NavigationBreadcrumbsSeparator();
		...
		/// </summary>
		public NavigationBreadcrumbsButtonTheme ButtonTheme { get; set; }
		private NavigationBreadcrumbsButtonTheme ButtonTheme_DefaultValue { get; set; }
		 

		/// <summary>
		/// 
		/// </summary>
		public NavigationBreadcrumbsEvents Events { get; set; }
		private NavigationBreadcrumbsEvents Events_DefaultValue { get; set; }
		...
		/// </summary>
		public NavigationBreadcrumbsPosition Position { get; set; }
		private NavigationBreadcrumbsPosition Position_DefaultValue { get; set; }
		...
		/// </summary>
		public NavigationBreadcrumbsSeparator Separator { get; set; }
		private NavigationBreadcrumbsSeparator Separator_DefaultValue { get; set; }
