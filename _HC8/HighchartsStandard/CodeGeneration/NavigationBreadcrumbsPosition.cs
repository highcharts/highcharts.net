...
namespace Highsoft.Web.Mvc.Charts
{
	public partial class NavigationBreadcrumbsPosition  : BaseObject
	{
		...
		{
			Align = Align_DefaultValue = NavigationBreadcrumbsPositionAlign.Left;
			VerticalAlign = VerticalAlign_DefaultValue = NavigationBreadcrumbsPositionVerticalAlign.Top;
			X = X_DefaultValue = 0;
