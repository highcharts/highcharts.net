...
namespace Highsoft.Web.Mvc.Charts
{
	public partial class NetworkgraphSeries  : Series
	{
		...
		{
			Accessibility = Accessibility_DefaultValue = new NetworkgraphSeriesAccessibility();
			AllowPointSelect = AllowPointSelect_DefaultValue = false;
			BoostBlending = BoostBlending_DefaultValue = NetworkgraphSeriesBoostBlending.Undefined;
			ClassName = ClassName_DefaultValue = "";
			Clip = Clip_DefaultValue = true;
			Color = Color_DefaultValue = "";
			ColorIndex = ColorIndex_DefaultValue = null;
			CropThreshold = CropThreshold_DefaultValue = 300;
			Cursor = Cursor_DefaultValue = NetworkgraphSeriesCursor.Null;
			DashStyle = DashStyle_DefaultValue = NetworkgraphSeriesDashStyle.Solid;
			Data = Data_DefaultValue = new List<NetworkgraphSeriesData>();
			DataLabels = DataLabels_DefaultValue = new NetworkgraphSeriesDataLabels();
			DataSorting = DataSorting_DefaultValue = new NetworkgraphSeriesDataSorting();
			Description = Description_DefaultValue = "";
			Draggable = Draggable_DefaultValue = true;
			EnableMouseTracking = EnableMouseTracking_DefaultValue = true;
			Events = Events_DefaultValue = new NetworkgraphSeriesEvents();
			FindNearestPointBy = FindNearestPointBy_DefaultValue = NetworkgraphSeriesFindNearestPointBy.X;
			Id = Id_DefaultValue = "";
			IncludeInDataExport = IncludeInDataExport_DefaultValue = null;
			Index = Index_DefaultValue = null;
			Keys = Keys_DefaultValue = new List<string>();
			LayoutAlgorithm = LayoutAlgorithm_DefaultValue = new NetworkgraphSeriesLayoutAlgorithm();
			LegendIndex = LegendIndex_DefaultValue = null;
			LineWidth = LineWidth_DefaultValue = 2;
			Link = Link_DefaultValue = new NetworkgraphSeriesLink();
			LinkedTo = LinkedTo_DefaultValue = "";
			Marker = Marker_DefaultValue = new NetworkgraphSeriesMarker();
			Name = Name_DefaultValue = "";
			Nodes = Nodes_DefaultValue = new NetworkgraphSeriesNodes();
			Opacity = Opacity_DefaultValue = 1;
			Point = Point_DefaultValue = new NetworkgraphSeriesPoint();
			...
			States = States_DefaultValue = new NetworkgraphSeriesStates();
			StickyTracking = StickyTracking_DefaultValue = true;
			Tooltip = Tooltip_DefaultValue = new NetworkgraphSeriesTooltip();
			TurboThreshold = TurboThreshold_DefaultValue = 1000;
			Type = Type_DefaultValue = NetworkgraphSeriesType.Networkgraph;
			UseOhlcData = UseOhlcData_DefaultValue = null;
			Visible = Visible_DefaultValue = true;
			ZIndex = ZIndex_DefaultValue = null;
			Zones = Zones_DefaultValue = new List<NetworkgraphSeriesZone>();
		...
		private NetworkgraphSeriesAccessibility Accessibility_DefaultValue { get; set; }
		...
		/// </summary>
		public NetworkgraphSeriesBoostBlending BoostBlending { get; set; }
		private NetworkgraphSeriesBoostBlending BoostBlending_DefaultValue { get; set; }
		...
		private NetworkgraphSeriesCursor Cursor_DefaultValue { get; set; }
		...
		private NetworkgraphSeriesDashStyle DashStyle_DefaultValue { get; set; }
		...
		private List<NetworkgraphSeriesData> Data_DefaultValue { get; set; }
		...
		private NetworkgraphSeriesDataLabels DataLabels_DefaultValue { get; set; }
		 

		/// <summary>
		/// Options for the series data sorting.
		/// </summary>
		public NetworkgraphSeriesDataSorting DataSorting { get; set; }
		private NetworkgraphSeriesDataSorting DataSorting_DefaultValue { get; set; }
		...
		private NetworkgraphSeriesEvents Events_DefaultValue { get; set; }
		...
		private NetworkgraphSeriesFindNearestPointBy FindNearestPointBy_DefaultValue { get; set; }
		...
		private NetworkgraphSeriesLayoutAlgorithm LayoutAlgorithm_DefaultValue { get; set; }
		...
		private NetworkgraphSeriesLink Link_DefaultValue { get; set; }
		...
		private NetworkgraphSeriesMarker Marker_DefaultValue { get; set; }
		...
		private NetworkgraphSeriesNodes Nodes_DefaultValue { get; set; }
		...
		private NetworkgraphSeriesPoint Point_DefaultValue { get; set; }
		...
		private NetworkgraphSeriesStates States_DefaultValue { get; set; }
		...
		private NetworkgraphSeriesTooltip Tooltip_DefaultValue { get; set; }
		...
		/// </summary>
		public NetworkgraphSeriesType Type { get; set; }
		private NetworkgraphSeriesType Type_DefaultValue { get; set; }
		...
		private List<NetworkgraphSeriesZone> Zones_DefaultValue { get; set; }
		...
		internal override Hashtable ToHashtable()
		{
			...
			if (Link.IsDirty()) h.Add("link",Link.ToHashtable());
			...
			if (PointDescriptionFormatter != PointDescriptionFormatter_DefaultValue) { h.Add("pointDescriptionFormatter",PointDescriptionFormatter); Highcharts.AddFunction("7d9fe5e3-862f-4233-9fc3-0dde65542e88.pointDescriptionFormatter", PointDescriptionFormatter); }  
