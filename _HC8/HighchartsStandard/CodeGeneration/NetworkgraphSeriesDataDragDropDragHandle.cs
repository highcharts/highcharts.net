...
namespace Highsoft.Web.Mvc.Charts
{
	public partial class NetworkgraphSeriesDataDragDropDragHandle  : BaseObject
	{
		...
		internal override Hashtable ToHashtable()
		{
			...
			if (PathFormatter != PathFormatter_DefaultValue) { h.Add("pathFormatter",PathFormatter); Highcharts.AddFunction("30dd6f30-b0db-4970-85c0-3e79c40dc402.pathFormatter", PathFormatter); }  
