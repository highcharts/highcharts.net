...
{
	public partial class NetworkgraphSeriesDataLabels  : BaseObject
	{
		Hashtable h = new Hashtable();

		public NetworkgraphSeriesDataLabels()
		{
			Align = Align_DefaultValue = NetworkgraphSeriesDataLabelsAlign.Center;
			...
			Filter = Filter_DefaultValue = new NetworkgraphSeriesDataLabelsFilter();
			...
			Style = Style_DefaultValue = new NetworkgraphSeriesDataLabelsStyle();
			TextPath = TextPath_DefaultValue = new NetworkgraphSeriesDataLabelsTextPath();
			UseHTML = UseHTML_DefaultValue = false;
			VerticalAlign = VerticalAlign_DefaultValue = NetworkgraphSeriesDataLabelsVerticalAlign.Bottom;
			X = X_DefaultValue = 0;
			Y = Y_DefaultValue = 0;
			Z = Z_DefaultValue = 6;
		...
		/// </summary>
		public NetworkgraphSeriesDataLabelsAlign Align { get; set; }
		private NetworkgraphSeriesDataLabelsAlign Align_DefaultValue { get; set; }
		...
		/// </summary>
		public NetworkgraphSeriesDataLabelsFilter Filter { get; set; }
		private NetworkgraphSeriesDataLabelsFilter Filter_DefaultValue { get; set; }
		...
		/// </summary>
		public NetworkgraphSeriesDataLabelsStyle Style { get; set; }
		private NetworkgraphSeriesDataLabelsStyle Style_DefaultValue { get; set; }
		...
		/// </summary>
		public NetworkgraphSeriesDataLabelsTextPath TextPath { get; set; }
		private NetworkgraphSeriesDataLabelsTextPath TextPath_DefaultValue { get; set; }
		...
		/// </summary>
		public NetworkgraphSeriesDataLabelsVerticalAlign VerticalAlign { get; set; }
		private NetworkgraphSeriesDataLabelsVerticalAlign VerticalAlign_DefaultValue { get; set; }
		...
		internal override Hashtable ToHashtable()
		{
			...
			if (Formatter != Formatter_DefaultValue) { h.Add("formatter",Formatter); Highcharts.AddFunction("a74312e5-d31d-42ca-8c02-ba0152728806.formatter", Formatter); }  
			...
			if (NullFormatter != NullFormatter_DefaultValue) { h.Add("nullFormatter",NullFormatter); Highcharts.AddFunction("215d2148-db9a-45a9-a4ce-138b22003ab6.nullFormatter", NullFormatter); }  
