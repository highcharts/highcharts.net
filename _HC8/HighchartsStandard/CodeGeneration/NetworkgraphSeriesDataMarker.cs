...
{
	public partial class NetworkgraphSeriesDataMarker  : BaseObject
	{
		Hashtable h = new Hashtable();

		public NetworkgraphSeriesDataMarker()
		{
			...
			States = States_DefaultValue = new NetworkgraphSeriesDataMarkerStates();
		...
		/// </summary>
		public NetworkgraphSeriesDataMarkerStates States { get; set; }
		private NetworkgraphSeriesDataMarkerStates States_DefaultValue { get; set; }
