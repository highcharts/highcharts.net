...
namespace Highsoft.Web.Mvc.Charts
{
	public partial class NetworkgraphSeriesLayoutAlgorithm  : BaseObject
	{
		...
		internal override Hashtable ToHashtable()
		{
			...
			if (AttractiveForce != AttractiveForce_DefaultValue) { h.Add("attractiveForce",AttractiveForce); Highcharts.AddFunction("22bc4a40-3d3a-4142-a5da-37cdb8d848d4.attractiveForce", AttractiveForce); }  
			...
			if (RepulsiveForce != RepulsiveForce_DefaultValue) { h.Add("repulsiveForce",RepulsiveForce); Highcharts.AddFunction("3fbabf15-289a-40b2-a7e6-5d3116f08ad9.repulsiveForce", RepulsiveForce); }  
