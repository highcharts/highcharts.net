...
{
	public partial class NetworkgraphSeriesNodesDataLabels  : BaseObject
	{
		Hashtable h = new Hashtable();

		public NetworkgraphSeriesNodesDataLabels()
		{
			Align = Align_DefaultValue = NetworkgraphSeriesNodesDataLabelsAlign.Center;
			...
			Filter = Filter_DefaultValue = new NetworkgraphSeriesNodesDataLabelsFilter();
			...
			Style = Style_DefaultValue = new NetworkgraphSeriesNodesDataLabelsStyle();
			TextPath = TextPath_DefaultValue = new NetworkgraphSeriesNodesDataLabelsTextPath();
			UseHTML = UseHTML_DefaultValue = false;
			VerticalAlign = VerticalAlign_DefaultValue = NetworkgraphSeriesNodesDataLabelsVerticalAlign.Bottom;
			X = X_DefaultValue = 0;
			Y = Y_DefaultValue = 0;
			Z = Z_DefaultValue = 6;
		...
		/// </summary>
		public NetworkgraphSeriesNodesDataLabelsAlign Align { get; set; }
		private NetworkgraphSeriesNodesDataLabelsAlign Align_DefaultValue { get; set; }
		...
		/// </summary>
		public NetworkgraphSeriesNodesDataLabelsFilter Filter { get; set; }
		private NetworkgraphSeriesNodesDataLabelsFilter Filter_DefaultValue { get; set; }
		...
		/// </summary>
		public NetworkgraphSeriesNodesDataLabelsStyle Style { get; set; }
		private NetworkgraphSeriesNodesDataLabelsStyle Style_DefaultValue { get; set; }
		...
		/// </summary>
		public NetworkgraphSeriesNodesDataLabelsTextPath TextPath { get; set; }
		private NetworkgraphSeriesNodesDataLabelsTextPath TextPath_DefaultValue { get; set; }
		...
		/// </summary>
		public NetworkgraphSeriesNodesDataLabelsVerticalAlign VerticalAlign { get; set; }
		private NetworkgraphSeriesNodesDataLabelsVerticalAlign VerticalAlign_DefaultValue { get; set; }
		...
		internal override Hashtable ToHashtable()
		{
			...
			if (Formatter != Formatter_DefaultValue) { h.Add("formatter",Formatter); Highcharts.AddFunction("b890a668-301f-46a4-982a-be08ccdc370e.formatter", Formatter); }  
			...
			if (NullFormatter != NullFormatter_DefaultValue) { h.Add("nullFormatter",NullFormatter); Highcharts.AddFunction("b3a2ec2d-ffcb-47d0-9449-15bbb468e973.nullFormatter", NullFormatter); }  
