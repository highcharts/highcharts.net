...
namespace Highsoft.Web.Mvc.Charts
{
	public partial class NetworkgraphSeriesNodesDataLabels  : BaseObject
	{
		...
		public NetworkgraphSeriesNodesDataLabels()
		{
			...
			Overflow = Overflow_DefaultValue = NetworkgraphSeriesNodesDataLabelsOverflow.Justify;
			Padding = Padding_DefaultValue = 5;
			Position = Position_DefaultValue = NetworkgraphSeriesNodesDataLabelsPosition.Center;
