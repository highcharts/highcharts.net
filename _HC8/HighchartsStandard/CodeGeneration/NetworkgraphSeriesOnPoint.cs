...
{
	public partial class NetworkgraphSeriesOnPoint  : BaseObject
	{
		Hashtable h = new Hashtable();

		public NetworkgraphSeriesOnPoint()
		{
			ConnectorOptions = ConnectorOptions_DefaultValue = new NetworkgraphSeriesOnPointConnectorOptions();
			Id = Id_DefaultValue = "";
			Position = Position_DefaultValue = new NetworkgraphSeriesOnPointPosition();
		...
		/// </summary>
		public NetworkgraphSeriesOnPointConnectorOptions ConnectorOptions { get; set; }
		private NetworkgraphSeriesOnPointConnectorOptions ConnectorOptions_DefaultValue { get; set; }
		...
		/// </summary>
		public NetworkgraphSeriesOnPointPosition Position { get; set; }
		private NetworkgraphSeriesOnPointPosition Position_DefaultValue { get; set; }
