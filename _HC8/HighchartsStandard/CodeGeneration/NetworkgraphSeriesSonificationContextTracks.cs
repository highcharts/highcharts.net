...
{
	public partial class NetworkgraphSeriesSonificationContextTracks  : BaseObject
	{
		Hashtable h = new Hashtable();

		public NetworkgraphSeriesSonificationContextTracks()
		{
			ActiveWhen = ActiveWhen_DefaultValue = new NetworkgraphSeriesSonificationContextTracksActiveWhen();
			Instrument = Instrument_DefaultValue = null;
			InstrumentString = InstrumentString_DefaultValue = "null";
			Mapping = Mapping_DefaultValue = new NetworkgraphSeriesSonificationContextTracksMapping();
			MidiName = MidiName_DefaultValue = "";
			PointGrouping = PointGrouping_DefaultValue = new NetworkgraphSeriesSonificationContextTracksPointGrouping();
			...
			Type = Type_DefaultValue = NetworkgraphSeriesSonificationContextTracksType.Instrument;
			ValueInterval = ValueInterval_DefaultValue = null;
			ValueMapFunction = ValueMapFunction_DefaultValue = NetworkgraphSeriesSonificationContextTracksValueMapFunction.Linear;
		...
		/// </summary>
		public NetworkgraphSeriesSonificationContextTracksActiveWhen ActiveWhen { get; set; }
		private NetworkgraphSeriesSonificationContextTracksActiveWhen ActiveWhen_DefaultValue { get; set; }
		...
		/// </summary>
		public NetworkgraphSeriesSonificationContextTracksMapping Mapping { get; set; }
		private NetworkgraphSeriesSonificationContextTracksMapping Mapping_DefaultValue { get; set; }
		...
		/// </summary>
		public NetworkgraphSeriesSonificationContextTracksPointGrouping PointGrouping { get; set; }
		private NetworkgraphSeriesSonificationContextTracksPointGrouping PointGrouping_DefaultValue { get; set; }
		...
		/// </summary>
		public NetworkgraphSeriesSonificationContextTracksType Type { get; set; }
		private NetworkgraphSeriesSonificationContextTracksType Type_DefaultValue { get; set; }
		...
		/// </summary>
		public NetworkgraphSeriesSonificationContextTracksValueMapFunction ValueMapFunction { get; set; }
		private NetworkgraphSeriesSonificationContextTracksValueMapFunction ValueMapFunction_DefaultValue { get; set; }
