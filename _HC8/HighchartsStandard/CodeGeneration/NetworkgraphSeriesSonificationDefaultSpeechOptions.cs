...
{
	public partial class NetworkgraphSeriesSonificationDefaultSpeechOptions  : BaseObject
	{
		Hashtable h = new Hashtable();

		public NetworkgraphSeriesSonificationDefaultSpeechOptions()
		{
			ActiveWhen = ActiveWhen_DefaultValue = new NetworkgraphSeriesSonificationDefaultSpeechOptionsActiveWhen();
			Language = Language_DefaultValue = "en-US";
			Mapping = Mapping_DefaultValue = new NetworkgraphSeriesSonificationDefaultSpeechOptionsMapping();
			PointGrouping = PointGrouping_DefaultValue = new NetworkgraphSeriesSonificationDefaultSpeechOptionsPointGrouping();
			PreferredVoice = PreferredVoice_DefaultValue = "";
			ShowPlayMarker = ShowPlayMarker_DefaultValue = true;
			Type = Type_DefaultValue = NetworkgraphSeriesSonificationDefaultSpeechOptionsType.Instrument;
		...
		/// </summary>
		public NetworkgraphSeriesSonificationDefaultSpeechOptionsActiveWhen ActiveWhen { get; set; }
		private NetworkgraphSeriesSonificationDefaultSpeechOptionsActiveWhen ActiveWhen_DefaultValue { get; set; }
		...
		/// </summary>
		public NetworkgraphSeriesSonificationDefaultSpeechOptionsMapping Mapping { get; set; }
		private NetworkgraphSeriesSonificationDefaultSpeechOptionsMapping Mapping_DefaultValue { get; set; }
		 

		/// <summary>
		/// Options for point grouping, specifically for instrument tracks.
		/// </summary>
		public NetworkgraphSeriesSonificationDefaultSpeechOptionsPointGrouping PointGrouping { get; set; }
		private NetworkgraphSeriesSonificationDefaultSpeechOptionsPointGrouping PointGrouping_DefaultValue { get; set; }
		...
		/// </summary>
		public NetworkgraphSeriesSonificationDefaultSpeechOptionsType Type { get; set; }
		private NetworkgraphSeriesSonificationDefaultSpeechOptionsType Type_DefaultValue { get; set; }
