...
{
	public partial class NetworkgraphSeriesStatesHover  : BaseObject
	{
		Hashtable h = new Hashtable();

		public NetworkgraphSeriesStatesHover()
		{
			Animation = Animation_DefaultValue = new Animation() { Enabled = true };
			Enabled = Enabled_DefaultValue = null;
			Halo = Halo_DefaultValue = new NetworkgraphSeriesStatesHoverHalo();
			LineWidth = LineWidth_DefaultValue = null;
			LineWidthPlus = LineWidthPlus_DefaultValue = null;
			Marker = Marker_DefaultValue = new NetworkgraphSeriesStatesHoverMarker();
		...
		/// </summary>
		public NetworkgraphSeriesStatesHoverHalo Halo { get; set; }
		private NetworkgraphSeriesStatesHoverHalo Halo_DefaultValue { get; set; }
		...
		/// </summary>
		public NetworkgraphSeriesStatesHoverMarker Marker { get; set; }
		private NetworkgraphSeriesStatesHoverMarker Marker_DefaultValue { get; set; }
