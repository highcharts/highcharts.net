...
{
	public partial class NetworkgraphSeriesStatesHoverMarker  : BaseObject
	{
		Hashtable h = new Hashtable();

		public NetworkgraphSeriesStatesHoverMarker()
		{
			...
			States = States_DefaultValue = new NetworkgraphSeriesStatesHoverMarkerStates();
		...
		/// </summary>
		public NetworkgraphSeriesStatesHoverMarkerStates States { get; set; }
		private NetworkgraphSeriesStatesHoverMarkerStates States_DefaultValue { get; set; }
