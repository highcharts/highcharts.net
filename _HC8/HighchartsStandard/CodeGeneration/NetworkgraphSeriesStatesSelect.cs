...
{
	public partial class NetworkgraphSeriesStatesSelect  : BaseObject
	{
		Hashtable h = new Hashtable();

		public NetworkgraphSeriesStatesSelect()
		{
			Animation = Animation_DefaultValue = new Animation();
			Enabled = Enabled_DefaultValue = null;
			Halo = Halo_DefaultValue = new NetworkgraphSeriesStatesSelectHalo();
			LineWidth = LineWidth_DefaultValue = null;
			LineWidthPlus = LineWidthPlus_DefaultValue = null;
			Marker = Marker_DefaultValue = new NetworkgraphSeriesStatesSelectMarker();
		...
		/// </summary>
		public NetworkgraphSeriesStatesSelectHalo Halo { get; set; }
		private NetworkgraphSeriesStatesSelectHalo Halo_DefaultValue { get; set; }
		...
		/// </summary>
		public NetworkgraphSeriesStatesSelectMarker Marker { get; set; }
		private NetworkgraphSeriesStatesSelectMarker Marker_DefaultValue { get; set; }
