...
{
	public partial class NetworkgraphSeriesStatesSelectMarkerStatesHoverAnimation  : BaseObject
	{
		Hashtable h = new Hashtable();

		public NetworkgraphSeriesStatesSelectMarkerStatesHoverAnimation()
		{
