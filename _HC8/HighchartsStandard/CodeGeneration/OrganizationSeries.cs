...
namespace Highsoft.Web.Mvc.Charts
{
	public partial class OrganizationSeries  : Series
	{
		...
		public OrganizationSeries()
		{
			...
			BoostBlending = BoostBlending_DefaultValue = OrganizationSeriesBoostBlending.Undefined;
			...
			DataSorting = DataSorting_DefaultValue = new OrganizationSeriesDataSorting();
			...
			Type = Type_DefaultValue = OrganizationSeriesType.Organization;
		...
		/// </summary>
		public OrganizationSeriesBoostBlending BoostBlending { get; set; }
		private OrganizationSeriesBoostBlending BoostBlending_DefaultValue { get; set; }
		...
		/// </summary>
		public OrganizationSeriesDataSorting DataSorting { get; set; }
		private OrganizationSeriesDataSorting DataSorting_DefaultValue { get; set; }
		...
		/// </summary>
		public OrganizationSeriesType Type { get; set; }
		private OrganizationSeriesType Type_DefaultValue { get; set; }
		...
		internal override Hashtable ToHashtable()
		{
			...
			if (PointDescriptionFormatter != PointDescriptionFormatter_DefaultValue) { h.Add("pointDescriptionFormatter",PointDescriptionFormatter); Highcharts.AddFunction("ae4b948e-eed6-4b26-bc97-1a84aabb72b1.pointDescriptionFormatter", PointDescriptionFormatter); }  
