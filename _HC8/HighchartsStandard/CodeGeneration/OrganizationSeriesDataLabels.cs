...
{
	public partial class OrganizationSeriesDataLabels  : BaseObject
	{
		Hashtable h = new Hashtable();

		public OrganizationSeriesDataLabels()
		{
			Align = Align_DefaultValue = OrganizationSeriesDataLabelsAlign.Center;
			...
			Filter = Filter_DefaultValue = new OrganizationSeriesDataLabelsFilter();
			...
			Style = Style_DefaultValue = new OrganizationSeriesDataLabelsStyle();
			TextPath = TextPath_DefaultValue = new OrganizationSeriesDataLabelsTextPath();
			UseHTML = UseHTML_DefaultValue = false;
			VerticalAlign = VerticalAlign_DefaultValue = OrganizationSeriesDataLabelsVerticalAlign.Bottom;
			X = X_DefaultValue = 0;
			Y = Y_DefaultValue = 0;
			Z = Z_DefaultValue = 6;
		...
		/// </summary>
		public OrganizationSeriesDataLabelsAlign Align { get; set; }
		private OrganizationSeriesDataLabelsAlign Align_DefaultValue { get; set; }
		...
		/// </summary>
		public OrganizationSeriesDataLabelsFilter Filter { get; set; }
		private OrganizationSeriesDataLabelsFilter Filter_DefaultValue { get; set; }
		...
		/// </summary>
		public OrganizationSeriesDataLabelsStyle Style { get; set; }
		private OrganizationSeriesDataLabelsStyle Style_DefaultValue { get; set; }
		...
		/// </summary>
		public OrganizationSeriesDataLabelsTextPath TextPath { get; set; }
		private OrganizationSeriesDataLabelsTextPath TextPath_DefaultValue { get; set; }
		...
		/// </summary>
		public OrganizationSeriesDataLabelsVerticalAlign VerticalAlign { get; set; }
		private OrganizationSeriesDataLabelsVerticalAlign VerticalAlign_DefaultValue { get; set; }
		...
		internal override Hashtable ToHashtable()
		{
			...
			if (Formatter != Formatter_DefaultValue) { h.Add("formatter",Formatter); Highcharts.AddFunction("2f4d9694-cd09-4697-8bff-a4828b8cd3ab.formatter", Formatter); }  
			...
			if (NullFormatter != NullFormatter_DefaultValue) { h.Add("nullFormatter",NullFormatter); Highcharts.AddFunction("7cdf6181-8310-46dc-b6d1-779257021723.nullFormatter", NullFormatter); }  
