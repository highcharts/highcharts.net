...
{
	public partial class OrganizationSeriesDataMarker  : BaseObject
	{
		Hashtable h = new Hashtable();

		public OrganizationSeriesDataMarker()
		{
			...
			States = States_DefaultValue = new OrganizationSeriesDataMarkerStates();
		...
		/// </summary>
		public OrganizationSeriesDataMarkerStates States { get; set; }
		private OrganizationSeriesDataMarkerStates States_DefaultValue { get; set; }
