...
{
	public partial class OrganizationSeriesDragDrop  : BaseObject
	{
		Hashtable h = new Hashtable();

		public OrganizationSeriesDragDrop()
		{
			DraggableX = DraggableX_DefaultValue = null;
			DraggableY = DraggableY_DefaultValue = null;
			DragHandle = DragHandle_DefaultValue = new OrganizationSeriesDragDropDragHandle();
			...
			GuideBox = GuideBox_DefaultValue = new OrganizationSeriesDragDropGuideBox();
		...
		/// </summary>
		public OrganizationSeriesDragDropDragHandle DragHandle { get; set; }
		private OrganizationSeriesDragDropDragHandle DragHandle_DefaultValue { get; set; }
		...
		/// </summary>
		public OrganizationSeriesDragDropGuideBox GuideBox { get; set; }
		private OrganizationSeriesDragDropGuideBox GuideBox_DefaultValue { get; set; }
