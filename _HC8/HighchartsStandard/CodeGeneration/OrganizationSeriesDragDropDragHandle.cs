...
namespace Highsoft.Web.Mvc.Charts
{
	public partial class OrganizationSeriesDragDropDragHandle  : BaseObject
	{
		...
		internal override Hashtable ToHashtable()
		{
			...
			if (PathFormatter != PathFormatter_DefaultValue) { h.Add("pathFormatter",PathFormatter); Highcharts.AddFunction("8cd669c9-180d-4309-bbfe-f3bc209d7ce3.pathFormatter", PathFormatter); }  
