...
{
	public partial class OrganizationSeriesLabel  : BaseObject
	{
		Hashtable h = new Hashtable();

		public OrganizationSeriesLabel()
		{
			...
			Style = Style_DefaultValue = new OrganizationSeriesLabelStyle();
		...
		/// </summary>
		public OrganizationSeriesLabelStyle Style { get; set; }
		private OrganizationSeriesLabelStyle Style_DefaultValue { get; set; }
		...
		internal override Hashtable ToHashtable()
		{
			...
			if (Formatter != Formatter_DefaultValue) { h.Add("formatter",Formatter); Highcharts.AddFunction("a591d80f-308f-4863-8083-325fb8936dd3.formatter", Formatter); }  
