...
namespace Highsoft.Web.Mvc.Charts
{
	public partial class OrganizationSeriesNodesDataLabels  : BaseObject
	{
		...
		{
			Align = Align_DefaultValue = OrganizationSeriesNodesDataLabelsAlign.Center;
			...
			Filter = Filter_DefaultValue = new OrganizationSeriesNodesDataLabelsFilter();
			...
			Style = Style_DefaultValue = new OrganizationSeriesNodesDataLabelsStyle();
			TextPath = TextPath_DefaultValue = new OrganizationSeriesNodesDataLabelsTextPath();
			UseHTML = UseHTML_DefaultValue = false;
			VerticalAlign = VerticalAlign_DefaultValue = OrganizationSeriesNodesDataLabelsVerticalAlign.Bottom;
			X = X_DefaultValue = 0;
			Y = Y_DefaultValue = 0;
			Z = Z_DefaultValue = 6;
		...
		/// </summary>
		public OrganizationSeriesNodesDataLabelsAlign Align { get; set; }
		private OrganizationSeriesNodesDataLabelsAlign Align_DefaultValue { get; set; }
		...
		/// </summary>
		public OrganizationSeriesNodesDataLabelsFilter Filter { get; set; }
		private OrganizationSeriesNodesDataLabelsFilter Filter_DefaultValue { get; set; }
		...
		/// </summary>
		public OrganizationSeriesNodesDataLabelsStyle Style { get; set; }
		private OrganizationSeriesNodesDataLabelsStyle Style_DefaultValue { get; set; }
		...
		/// </summary>
		public OrganizationSeriesNodesDataLabelsTextPath TextPath { get; set; }
		private OrganizationSeriesNodesDataLabelsTextPath TextPath_DefaultValue { get; set; }
		...
		/// </summary>
		public OrganizationSeriesNodesDataLabelsVerticalAlign VerticalAlign { get; set; }
		private OrganizationSeriesNodesDataLabelsVerticalAlign VerticalAlign_DefaultValue { get; set; }
		...
		internal override Hashtable ToHashtable()
		{
			...
			if (Formatter != Formatter_DefaultValue) { h.Add("formatter",Formatter); Highcharts.AddFunction("43ee7f2e-ccb1-4431-bc7e-55083f7afbcb.formatter", Formatter); }  
			...
			if (NullFormatter != NullFormatter_DefaultValue) { h.Add("nullFormatter",NullFormatter); Highcharts.AddFunction("b6898631-320f-4121-b41b-e409ead3624a.nullFormatter", NullFormatter); }  
