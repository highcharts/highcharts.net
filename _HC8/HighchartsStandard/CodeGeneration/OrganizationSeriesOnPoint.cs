...
{
	public partial class OrganizationSeriesOnPoint  : BaseObject
	{
		Hashtable h = new Hashtable();

		public OrganizationSeriesOnPoint()
		{
			ConnectorOptions = ConnectorOptions_DefaultValue = new OrganizationSeriesOnPointConnectorOptions();
			Id = Id_DefaultValue = "";
			Position = Position_DefaultValue = new OrganizationSeriesOnPointPosition();
		...
		/// </summary>
		public OrganizationSeriesOnPointConnectorOptions ConnectorOptions { get; set; }
		private OrganizationSeriesOnPointConnectorOptions ConnectorOptions_DefaultValue { get; set; }
		...
		/// </summary>
		public OrganizationSeriesOnPointPosition Position { get; set; }
		private OrganizationSeriesOnPointPosition Position_DefaultValue { get; set; }
