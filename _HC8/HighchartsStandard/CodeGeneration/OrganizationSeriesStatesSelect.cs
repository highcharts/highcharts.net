...
{
	public partial class OrganizationSeriesStatesSelect  : BaseObject
	{
		Hashtable h = new Hashtable();

		public OrganizationSeriesStatesSelect()
		{
			Animation = Animation_DefaultValue = new Animation() { Enabled = true };
			Enabled = Enabled_DefaultValue = null;
			Halo = Halo_DefaultValue = new OrganizationSeriesStatesSelectHalo();
			LineWidth = LineWidth_DefaultValue = null;
			LineWidthPlus = LineWidthPlus_DefaultValue = null;
			Marker = Marker_DefaultValue = new OrganizationSeriesStatesSelectMarker();
		...
		/// </summary>
		public OrganizationSeriesStatesSelectHalo Halo { get; set; }
		private OrganizationSeriesStatesSelectHalo Halo_DefaultValue { get; set; }
		...
		/// </summary>
		public OrganizationSeriesStatesSelectMarker Marker { get; set; }
		private OrganizationSeriesStatesSelectMarker Marker_DefaultValue { get; set; }
