...
{
	public partial class OrganizationSeriesStatesSelectMarker  : BaseObject
	{
		Hashtable h = new Hashtable();

		public OrganizationSeriesStatesSelectMarker()
		{
			...
			States = States_DefaultValue = new OrganizationSeriesStatesSelectMarkerStates();
		...
		/// </summary>
		public OrganizationSeriesStatesSelectMarkerStates States { get; set; }
		private OrganizationSeriesStatesSelectMarkerStates States_DefaultValue { get; set; }
