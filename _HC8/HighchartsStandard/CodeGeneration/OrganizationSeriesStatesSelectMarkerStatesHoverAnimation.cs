...
{
	public partial class OrganizationSeriesStatesSelectMarkerStatesHoverAnimation  : BaseObject
	{
		Hashtable h = new Hashtable();

		public OrganizationSeriesStatesSelectMarkerStatesHoverAnimation()
		{
