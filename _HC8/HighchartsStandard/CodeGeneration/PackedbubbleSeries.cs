...
namespace Highsoft.Web.Mvc.Charts
{
	public partial class PackedbubbleSeries  : Series
	{
		...
		internal override Hashtable ToHashtable()
		{
			...
			if (PointDescriptionFormatter != PointDescriptionFormatter_DefaultValue) { h.Add("pointDescriptionFormatter",PointDescriptionFormatter); Highcharts.AddFunction("b193ab17-dfb9-4a02-9edb-6c826a5822a0.pointDescriptionFormatter", PointDescriptionFormatter); }  
