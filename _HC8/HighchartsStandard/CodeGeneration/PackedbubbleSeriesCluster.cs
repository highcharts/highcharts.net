...
{
	public partial class PackedbubbleSeriesCluster  : BaseObject
	{
		Hashtable h = new Hashtable();

		public PackedbubbleSeriesCluster()
		{
			AllowOverlap = AllowOverlap_DefaultValue = true;
			Animation = Animation_DefaultValue = new Animation();
			AnimationBool = AnimationBool_DefaultValue = null;
			DataLabels = DataLabels_DefaultValue = new PackedbubbleSeriesClusterDataLabels();
			DrillToCluster = DrillToCluster_DefaultValue = true;
			Enabled = Enabled_DefaultValue = false;
			Events = Events_DefaultValue = new PackedbubbleSeriesClusterEvents();
			LayoutAlgorithm = LayoutAlgorithm_DefaultValue = new PackedbubbleSeriesClusterLayoutAlgorithm();
			Marker = Marker_DefaultValue = new PackedbubbleSeriesClusterMarker();
			MinimumClusterSize = MinimumClusterSize_DefaultValue = 2;
			States = States_DefaultValue = new PackedbubbleSeriesClusterStates();
			Zones = Zones_DefaultValue = new List<PackedbubbleSeriesClusterZone>();
		...
		/// </summary>
		public PackedbubbleSeriesClusterDataLabels DataLabels { get; set; }
		private PackedbubbleSeriesClusterDataLabels DataLabels_DefaultValue { get; set; }
		...
		/// 
		/// </summary>
		public PackedbubbleSeriesClusterEvents Events { get; set; }
		private PackedbubbleSeriesClusterEvents Events_DefaultValue { get; set; }
		 

		/// <summary>
		/// Options for layout algorithm. Inside thereare options to change the type of the algorithm, gridSize,distance or iterations.
		/// </summary>
		public PackedbubbleSeriesClusterLayoutAlgorithm LayoutAlgorithm { get; set; }
		private PackedbubbleSeriesClusterLayoutAlgorithm LayoutAlgorithm_DefaultValue { get; set; }
		 

		/// <summary>
		/// Options for the cluster marker.
		/// </summary>
		public PackedbubbleSeriesClusterMarker Marker { get; set; }
		private PackedbubbleSeriesClusterMarker Marker_DefaultValue { get; set; }
		...
		/// 
		/// </summary>
		public PackedbubbleSeriesClusterStates States { get; set; }
		private PackedbubbleSeriesClusterStates States_DefaultValue { get; set; }
		...
		/// </summary>
		public List<PackedbubbleSeriesClusterZone> Zones { get; set; }
		private List<PackedbubbleSeriesClusterZone> Zones_DefaultValue { get; set; }
