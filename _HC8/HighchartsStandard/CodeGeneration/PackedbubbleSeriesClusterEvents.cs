...
{
	public partial class PackedbubbleSeriesClusterEvents  : BaseObject
	{
		Hashtable h = new Hashtable();

		public PackedbubbleSeriesClusterEvents()
		{
		...
		internal override Hashtable ToHashtable()
		{
			...
			if (DrillToCluster != DrillToCluster_DefaultValue) { h.Add("drillToCluster",DrillToCluster); Highcharts.AddFunction("fc4b29ec-6ea5-451e-8900-384d7ed45cff.drillToCluster", DrillToCluster); }  
