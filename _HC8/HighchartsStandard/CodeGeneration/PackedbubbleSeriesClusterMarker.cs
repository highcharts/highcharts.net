...
{
	public partial class PackedbubbleSeriesClusterMarker  : BaseObject
	{
		Hashtable h = new Hashtable();

		public PackedbubbleSeriesClusterMarker()
		{
			...
			States = States_DefaultValue = new PackedbubbleSeriesClusterMarkerStates();
		...
		/// </summary>
		public PackedbubbleSeriesClusterMarkerStates States { get; set; }
		private PackedbubbleSeriesClusterMarkerStates States_DefaultValue { get; set; }
