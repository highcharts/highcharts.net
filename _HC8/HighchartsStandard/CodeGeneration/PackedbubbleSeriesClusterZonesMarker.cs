...
{
	public partial class PackedbubbleSeriesClusterZonesMarker  : BaseObject
	{
		Hashtable h = new Hashtable();

		public PackedbubbleSeriesClusterZonesMarker()
		{
			...
			States = States_DefaultValue = new PackedbubbleSeriesClusterZonesMarkerStates();
		...
		/// </summary>
		public PackedbubbleSeriesClusterZonesMarkerStates States { get; set; }
		private PackedbubbleSeriesClusterZonesMarkerStates States_DefaultValue { get; set; }
