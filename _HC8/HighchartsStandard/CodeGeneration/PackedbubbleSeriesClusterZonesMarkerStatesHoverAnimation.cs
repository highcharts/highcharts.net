...
{
	public partial class PackedbubbleSeriesClusterZonesMarkerStatesHoverAnimation  : BaseObject
	{
		Hashtable h = new Hashtable();

		public PackedbubbleSeriesClusterZonesMarkerStatesHoverAnimation()
		{
