...
{
	public partial class PackedbubbleSeriesData  : BaseObject
	{
		Hashtable h = new Hashtable();

		public PackedbubbleSeriesData()
		{
			Accessibility = Accessibility_DefaultValue = new PackedbubbleSeriesDataAccessibility();
			ClassName = ClassName_DefaultValue = "";
			Color = Color_DefaultValue = "";
			ColorIndex = ColorIndex_DefaultValue = null;
			Custom = Custom_DefaultValue = new Hashtable();
			Description = Description_DefaultValue = "";
			DragDrop = DragDrop_DefaultValue = new PackedbubbleSeriesDataDragDrop();
			Drilldown = Drilldown_DefaultValue = "";
			Events = Events_DefaultValue = new PackedbubbleSeriesDataEvents();
			Id = Id_DefaultValue = "";
			Labelrank = Labelrank_DefaultValue = null;
			Marker = Marker_DefaultValue = new PackedbubbleSeriesDataMarker();
		...
		/// </summary>
		public PackedbubbleSeriesDataAccessibility Accessibility { get; set; }
		private PackedbubbleSeriesDataAccessibility Accessibility_DefaultValue { get; set; }
		...
		/// </summary>
		public PackedbubbleSeriesDataDragDrop DragDrop { get; set; }
		private PackedbubbleSeriesDataDragDrop DragDrop_DefaultValue { get; set; }
		...
		/// </summary>
		public PackedbubbleSeriesDataEvents Events { get; set; }
		private PackedbubbleSeriesDataEvents Events_DefaultValue { get; set; }
		...
		/// </summary>
		public PackedbubbleSeriesDataMarker Marker { get; set; }
		private PackedbubbleSeriesDataMarker Marker_DefaultValue { get; set; }
