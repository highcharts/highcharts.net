...
namespace Highsoft.Web.Mvc.Charts
{
	public partial class PackedbubbleSeriesDataDragDropDragHandle  : BaseObject
	{
		...
		internal override Hashtable ToHashtable()
		{
			...
			if (PathFormatter != PathFormatter_DefaultValue) { h.Add("pathFormatter",PathFormatter); Highcharts.AddFunction("40c33492-ef14-430e-bf27-a2a9e984ec3d.pathFormatter", PathFormatter); }  
