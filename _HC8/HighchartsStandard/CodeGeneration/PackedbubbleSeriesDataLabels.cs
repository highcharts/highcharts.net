...
{
	public partial class PackedbubbleSeriesDataLabels  : BaseObject
	{
		Hashtable h = new Hashtable();

		public PackedbubbleSeriesDataLabels()
		{
			Align = Align_DefaultValue = PackedbubbleSeriesDataLabelsAlign.Center;
			...
			Filter = Filter_DefaultValue = new PackedbubbleSeriesDataLabelsFilter();
			...
			Style = Style_DefaultValue = new PackedbubbleSeriesDataLabelsStyle();
			TextPath = TextPath_DefaultValue = new PackedbubbleSeriesDataLabelsTextPath();
			UseHTML = UseHTML_DefaultValue = false;
			VerticalAlign = VerticalAlign_DefaultValue = PackedbubbleSeriesDataLabelsVerticalAlign.Bottom;
			X = X_DefaultValue = 0;
			Y = Y_DefaultValue = 0;
			Z = Z_DefaultValue = 6;
		...
		/// </summary>
		public PackedbubbleSeriesDataLabelsAlign Align { get; set; }
		private PackedbubbleSeriesDataLabelsAlign Align_DefaultValue { get; set; }
		...
		/// </summary>
		public PackedbubbleSeriesDataLabelsFilter Filter { get; set; }
		private PackedbubbleSeriesDataLabelsFilter Filter_DefaultValue { get; set; }
		...
		/// </summary>
		public PackedbubbleSeriesDataLabelsStyle Style { get; set; }
		private PackedbubbleSeriesDataLabelsStyle Style_DefaultValue { get; set; }
		...
		/// </summary>
		public PackedbubbleSeriesDataLabelsTextPath TextPath { get; set; }
		private PackedbubbleSeriesDataLabelsTextPath TextPath_DefaultValue { get; set; }
		...
		/// </summary>
		public PackedbubbleSeriesDataLabelsVerticalAlign VerticalAlign { get; set; }
		private PackedbubbleSeriesDataLabelsVerticalAlign VerticalAlign_DefaultValue { get; set; }
		...
		internal override Hashtable ToHashtable()
		{
			...
			if (Formatter != Formatter_DefaultValue) { h.Add("formatter",Formatter); Highcharts.AddFunction("b1e2568f-8cbe-4936-9058-6d5987dbaba6.formatter", Formatter); }  
			if (Inside != Inside_DefaultValue) h.Add("inside",Inside);
			if (NullFormat != NullFormat_DefaultValue) h.Add("nullFormat",NullFormat);
			if (NullFormatter != NullFormatter_DefaultValue) { h.Add("nullFormatter",NullFormatter); Highcharts.AddFunction("145ab79b-1952-4693-aab2-366af6bbb63e.nullFormatter", NullFormatter); }  
