...
{
	public partial class PackedbubbleSeriesDataMarker  : BaseObject
	{
		Hashtable h = new Hashtable();

		public PackedbubbleSeriesDataMarker()
		{
			...
			States = States_DefaultValue = new PackedbubbleSeriesDataMarkerStates();
		...
		/// </summary>
		public PackedbubbleSeriesDataMarkerStates States { get; set; }
		private PackedbubbleSeriesDataMarkerStates States_DefaultValue { get; set; }
