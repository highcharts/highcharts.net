...
{
	public partial class PackedbubbleSeriesDragDrop  : BaseObject
	{
		Hashtable h = new Hashtable();

		public PackedbubbleSeriesDragDrop()
		{
			DraggableX = DraggableX_DefaultValue = null;
			DraggableY = DraggableY_DefaultValue = null;
			DragHandle = DragHandle_DefaultValue = new PackedbubbleSeriesDragDropDragHandle();
			...
			GuideBox = GuideBox_DefaultValue = new PackedbubbleSeriesDragDropGuideBox();
		...
		/// </summary>
		public PackedbubbleSeriesDragDropDragHandle DragHandle { get; set; }
		private PackedbubbleSeriesDragDropDragHandle DragHandle_DefaultValue { get; set; }
		...
		/// </summary>
		public PackedbubbleSeriesDragDropGuideBox GuideBox { get; set; }
		private PackedbubbleSeriesDragDropGuideBox GuideBox_DefaultValue { get; set; }
