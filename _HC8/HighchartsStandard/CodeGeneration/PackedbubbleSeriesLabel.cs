...
{
	public partial class PackedbubbleSeriesLabel  : BaseObject
	{
		Hashtable h = new Hashtable();

		public PackedbubbleSeriesLabel()
		{
			...
			Style = Style_DefaultValue = new PackedbubbleSeriesLabelStyle();
		...
		/// </summary>
		public PackedbubbleSeriesLabelStyle Style { get; set; }
		private PackedbubbleSeriesLabelStyle Style_DefaultValue { get; set; }
		...
		internal override Hashtable ToHashtable()
		{
			...
			if (Formatter != Formatter_DefaultValue) { h.Add("formatter",Formatter); Highcharts.AddFunction("f783423d-890e-4d98-92a0-c70add0ec10a.formatter", Formatter); }  
