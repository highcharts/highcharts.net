...
{
	public partial class PackedbubbleSeriesLayoutAlgorithmParentNodeOptionsMarkerStatesHover  : BaseObject
	{
		Hashtable h = new Hashtable();

		public PackedbubbleSeriesLayoutAlgorithmParentNodeOptionsMarkerStatesHover()
		{
