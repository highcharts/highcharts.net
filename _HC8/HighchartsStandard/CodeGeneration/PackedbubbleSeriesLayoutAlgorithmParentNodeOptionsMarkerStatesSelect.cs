...
{
	public partial class PackedbubbleSeriesLayoutAlgorithmParentNodeOptionsMarkerStatesSelect  : BaseObject
	{
		Hashtable h = new Hashtable();

		public PackedbubbleSeriesLayoutAlgorithmParentNodeOptionsMarkerStatesSelect()
		{
