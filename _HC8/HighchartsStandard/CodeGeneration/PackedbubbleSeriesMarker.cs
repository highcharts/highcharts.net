...
{
	public partial class PackedbubbleSeriesMarker  : BaseObject
	{
		Hashtable h = new Hashtable();

		public PackedbubbleSeriesMarker()
		{
			...
			States = States_DefaultValue = new PackedbubbleSeriesMarkerStates();
		...
		/// </summary>
		public PackedbubbleSeriesMarkerStates States { get; set; }
		private PackedbubbleSeriesMarkerStates States_DefaultValue { get; set; }
