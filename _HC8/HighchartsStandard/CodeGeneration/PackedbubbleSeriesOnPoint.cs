...
{
	public partial class PackedbubbleSeriesOnPoint  : BaseObject
	{
		Hashtable h = new Hashtable();

		public PackedbubbleSeriesOnPoint()
		{
			ConnectorOptions = ConnectorOptions_DefaultValue = new PackedbubbleSeriesOnPointConnectorOptions();
			Id = Id_DefaultValue = "";
			Position = Position_DefaultValue = new PackedbubbleSeriesOnPointPosition();
		...
		/// </summary>
		public PackedbubbleSeriesOnPointConnectorOptions ConnectorOptions { get; set; }
		private PackedbubbleSeriesOnPointConnectorOptions ConnectorOptions_DefaultValue { get; set; }
		...
		/// </summary>
		public PackedbubbleSeriesOnPointPosition Position { get; set; }
		private PackedbubbleSeriesOnPointPosition Position_DefaultValue { get; set; }
