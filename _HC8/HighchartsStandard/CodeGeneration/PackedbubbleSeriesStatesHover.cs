...
{
	public partial class PackedbubbleSeriesStatesHover  : BaseObject
	{
		Hashtable h = new Hashtable();

		public PackedbubbleSeriesStatesHover()
		{
			Animation = Animation_DefaultValue = new Animation() { Enabled = true };
			Enabled = Enabled_DefaultValue = null;
			Halo = Halo_DefaultValue = new PackedbubbleSeriesStatesHoverHalo();
			LineWidth = LineWidth_DefaultValue = null;
			LineWidthPlus = LineWidthPlus_DefaultValue = null;
			Marker = Marker_DefaultValue = new PackedbubbleSeriesStatesHoverMarker();
		...
		/// </summary>
		public PackedbubbleSeriesStatesHoverHalo Halo { get; set; }
		private PackedbubbleSeriesStatesHoverHalo Halo_DefaultValue { get; set; }
		...
		/// </summary>
		public PackedbubbleSeriesStatesHoverMarker Marker { get; set; }
		private PackedbubbleSeriesStatesHoverMarker Marker_DefaultValue { get; set; }
