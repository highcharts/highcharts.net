...
namespace Highsoft.Web.Mvc.Charts
{
	public partial class ParetoSeries  : Series
	{
		...
		public ParetoSeries()
		{
			...
			Type = Type_DefaultValue = ParetoSeriesType.Pareto;
		...
		internal override Hashtable ToHashtable()
		{
			...
			if (PointDescriptionFormatter != PointDescriptionFormatter_DefaultValue) { h.Add("pointDescriptionFormatter",PointDescriptionFormatter); Highcharts.AddFunction("564217fe-71d5-436f-ab9f-b90bd94d9953.pointDescriptionFormatter", PointDescriptionFormatter); }  
