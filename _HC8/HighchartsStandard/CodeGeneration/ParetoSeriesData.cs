...
namespace Highsoft.Web.Mvc.Charts
{
	public partial class ParetoSeriesData  : BaseObject
	{
		...
		{
			Accessibility = Accessibility_DefaultValue = new ParetoSeriesDataAccessibility();
			...
			DashStyle = DashStyle_DefaultValue = ParetoSeriesDataDashStyle.Null;
			DataLabels = DataLabels_DefaultValue = new ParetoSeriesDataLabels();
			Description = Description_DefaultValue = "";
			DragDrop = DragDrop_DefaultValue = new ParetoSeriesDataDragDrop();
			Drilldown = Drilldown_DefaultValue = "";
			Events = Events_DefaultValue = new ParetoSeriesDataEvents();
			Id = Id_DefaultValue = "";
			Labelrank = Labelrank_DefaultValue = null;
			Marker = Marker_DefaultValue = new ParetoSeriesDataMarker();
		...
		/// </summary>
		public ParetoSeriesDataAccessibility Accessibility { get; set; }
		private ParetoSeriesDataAccessibility Accessibility_DefaultValue { get; set; }
		...
		/// </summary>
		public ParetoSeriesDataDashStyle DashStyle { get; set; }
		private ParetoSeriesDataDashStyle DashStyle_DefaultValue { get; set; }
		...
		/// </summary>
		public ParetoSeriesDataDragDrop DragDrop { get; set; }
		private ParetoSeriesDataDragDrop DragDrop_DefaultValue { get; set; }
		...
		/// </summary>
		public ParetoSeriesDataMarker Marker { get; set; }
		private ParetoSeriesDataMarker Marker_DefaultValue { get; set; }
