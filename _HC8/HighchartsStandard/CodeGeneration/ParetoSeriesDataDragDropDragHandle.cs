...
namespace Highsoft.Web.Mvc.Charts
{
	public partial class ParetoSeriesDataDragDropDragHandle  : BaseObject
	{
		...
		internal override Hashtable ToHashtable()
		{
			...
			if (PathFormatter != PathFormatter_DefaultValue) { h.Add("pathFormatter",PathFormatter); Highcharts.AddFunction("04816885-c2fe-4306-8a1d-18020d0e8875.pathFormatter", PathFormatter); }  
