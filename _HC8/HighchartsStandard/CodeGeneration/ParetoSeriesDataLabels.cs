...
{
	public partial class ParetoSeriesDataLabels  : BaseObject
	{
		Hashtable h = new Hashtable();

		public ParetoSeriesDataLabels()
		{
			Align = Align_DefaultValue = ParetoSeriesDataLabelsAlign.Center;
			...
			Filter = Filter_DefaultValue = new ParetoSeriesDataLabelsFilter();
			...
			Style = Style_DefaultValue = new ParetoSeriesDataLabelsStyle();
			TextPath = TextPath_DefaultValue = new ParetoSeriesDataLabelsTextPath();
			UseHTML = UseHTML_DefaultValue = false;
			VerticalAlign = VerticalAlign_DefaultValue = ParetoSeriesDataLabelsVerticalAlign.Bottom;
			X = X_DefaultValue = 0;
			Y = Y_DefaultValue = 0;
			Z = Z_DefaultValue = 6;
		...
		/// </summary>
		public ParetoSeriesDataLabelsAlign Align { get; set; }
		private ParetoSeriesDataLabelsAlign Align_DefaultValue { get; set; }
		...
		/// </summary>
		public ParetoSeriesDataLabelsFilter Filter { get; set; }
		private ParetoSeriesDataLabelsFilter Filter_DefaultValue { get; set; }
		...
		/// </summary>
		public ParetoSeriesDataLabelsStyle Style { get; set; }
		private ParetoSeriesDataLabelsStyle Style_DefaultValue { get; set; }
		...
		/// </summary>
		public ParetoSeriesDataLabelsTextPath TextPath { get; set; }
		private ParetoSeriesDataLabelsTextPath TextPath_DefaultValue { get; set; }
		...
		/// </summary>
		public ParetoSeriesDataLabelsVerticalAlign VerticalAlign { get; set; }
		private ParetoSeriesDataLabelsVerticalAlign VerticalAlign_DefaultValue { get; set; }
		...
		internal override Hashtable ToHashtable()
		{
			...
			if (Formatter != Formatter_DefaultValue) { h.Add("formatter",Formatter); Highcharts.AddFunction("2649f410-0b3d-4478-a5e8-f3ef9c6305a8.formatter", Formatter); }  
			if (Inside != Inside_DefaultValue) h.Add("inside",Inside);
			if (NullFormat != NullFormat_DefaultValue) h.Add("nullFormat",NullFormat);
			if (NullFormatter != NullFormatter_DefaultValue) { h.Add("nullFormatter",NullFormatter); Highcharts.AddFunction("530c37b0-d8b2-4fdf-9a55-1a5211048857.nullFormatter", NullFormatter); }  
