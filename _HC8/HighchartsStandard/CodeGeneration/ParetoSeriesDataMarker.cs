...
{
	public partial class ParetoSeriesDataMarker  : BaseObject
	{
		Hashtable h = new Hashtable();

		public ParetoSeriesDataMarker()
		{
			...
			States = States_DefaultValue = new ParetoSeriesDataMarkerStates();
		...
		/// </summary>
		public ParetoSeriesDataMarkerStates States { get; set; }
		private ParetoSeriesDataMarkerStates States_DefaultValue { get; set; }
