...
namespace Highsoft.Web.Mvc.Charts
{
	public partial class ParetoSeriesDragDropDragHandle  : BaseObject
	{
		...
		internal override Hashtable ToHashtable()
		{
			...
			if (PathFormatter != PathFormatter_DefaultValue) { h.Add("pathFormatter",PathFormatter); Highcharts.AddFunction("fb613861-e4f4-42cc-a626-271022b67f65.pathFormatter", PathFormatter); }  
