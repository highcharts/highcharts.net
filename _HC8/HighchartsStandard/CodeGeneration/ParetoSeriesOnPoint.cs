...
{
	public partial class ParetoSeriesOnPoint  : BaseObject
	{
		Hashtable h = new Hashtable();

		public ParetoSeriesOnPoint()
		{
			ConnectorOptions = ConnectorOptions_DefaultValue = new ParetoSeriesOnPointConnectorOptions();
			Id = Id_DefaultValue = "";
			Position = Position_DefaultValue = new ParetoSeriesOnPointPosition();
		...
		/// </summary>
		public ParetoSeriesOnPointConnectorOptions ConnectorOptions { get; set; }
		private ParetoSeriesOnPointConnectorOptions ConnectorOptions_DefaultValue { get; set; }
		...
		/// </summary>
		public ParetoSeriesOnPointPosition Position { get; set; }
		private ParetoSeriesOnPointPosition Position_DefaultValue { get; set; }
