...
{
	public partial class ParetoSeriesSonificationTracks  : BaseObject
	{
		Hashtable h = new Hashtable();

		public ParetoSeriesSonificationTracks()
		{
			ActiveWhen = ActiveWhen_DefaultValue = new ParetoSeriesSonificationTracksActiveWhen();
			Instrument = Instrument_DefaultValue = null;
			InstrumentString = InstrumentString_DefaultValue = "null";
			Mapping = Mapping_DefaultValue = new ParetoSeriesSonificationTracksMapping();
			MidiName = MidiName_DefaultValue = "";
			PointGrouping = PointGrouping_DefaultValue = new ParetoSeriesSonificationTracksPointGrouping();
			RoundToMusicalNotes = RoundToMusicalNotes_DefaultValue = true;
			ShowPlayMarker = ShowPlayMarker_DefaultValue = true;
			Type = Type_DefaultValue = ParetoSeriesSonificationTracksType.Instrument;
		...
		/// </summary>
		public ParetoSeriesSonificationTracksActiveWhen ActiveWhen { get; set; }
		private ParetoSeriesSonificationTracksActiveWhen ActiveWhen_DefaultValue { get; set; }
		...
		/// </summary>
		public ParetoSeriesSonificationTracksMapping Mapping { get; set; }
		private ParetoSeriesSonificationTracksMapping Mapping_DefaultValue { get; set; }
		...
		/// </summary>
		public ParetoSeriesSonificationTracksPointGrouping PointGrouping { get; set; }
		private ParetoSeriesSonificationTracksPointGrouping PointGrouping_DefaultValue { get; set; }
		...
		/// </summary>
		public ParetoSeriesSonificationTracksType Type { get; set; }
		private ParetoSeriesSonificationTracksType Type_DefaultValue { get; set; }
