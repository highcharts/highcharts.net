...
{
	public partial class ParetoSeriesStatesHover  : BaseObject
	{
		Hashtable h = new Hashtable();

		public ParetoSeriesStatesHover()
		{
			Animation = Animation_DefaultValue = new Animation() { Enabled = true };
			Enabled = Enabled_DefaultValue = null;
			Halo = Halo_DefaultValue = new ParetoSeriesStatesHoverHalo();
			LineWidth = LineWidth_DefaultValue = null;
			LineWidthPlus = LineWidthPlus_DefaultValue = null;
			Marker = Marker_DefaultValue = new ParetoSeriesStatesHoverMarker();
		...
		/// </summary>
		public ParetoSeriesStatesHoverHalo Halo { get; set; }
		private ParetoSeriesStatesHoverHalo Halo_DefaultValue { get; set; }
		...
		/// </summary>
		public ParetoSeriesStatesHoverMarker Marker { get; set; }
		private ParetoSeriesStatesHoverMarker Marker_DefaultValue { get; set; }
