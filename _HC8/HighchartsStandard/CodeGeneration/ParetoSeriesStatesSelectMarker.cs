...
{
	public partial class ParetoSeriesStatesSelectMarker  : BaseObject
	{
		Hashtable h = new Hashtable();

		public ParetoSeriesStatesSelectMarker()
		{
			...
			States = States_DefaultValue = new ParetoSeriesStatesSelectMarkerStates();
		...
		/// </summary>
		public ParetoSeriesStatesSelectMarkerStates States { get; set; }
		private ParetoSeriesStatesSelectMarkerStates States_DefaultValue { get; set; }
