...
{
	public partial class PictorialSeriesData  : BaseObject
	{
		Hashtable h = new Hashtable();

		public PictorialSeriesData()
		{
			Accessibility = Accessibility_DefaultValue = new PictorialSeriesDataAccessibility();
			...
			Events = Events_DefaultValue = new PictorialSeriesDataEvents();
			Id = Id_DefaultValue = "";
		...
		/// </summary>
		public PictorialSeriesDataAccessibility Accessibility { get; set; }
		private PictorialSeriesDataAccessibility Accessibility_DefaultValue { get; set; }
		...
		/// </summary>
		public PictorialSeriesDataEvents Events { get; set; }
		private PictorialSeriesDataEvents Events_DefaultValue { get; set; }
