...
{
	public partial class PictorialSeriesStatesHover  : BaseObject
	{
		Hashtable h = new Hashtable();

		public PictorialSeriesStatesHover()
		{
			Animation = Animation_DefaultValue = new Animation();
			Enabled = Enabled_DefaultValue = null;
			Halo = Halo_DefaultValue = new PictorialSeriesStatesHoverHalo();
			LineWidth = LineWidth_DefaultValue = null;
			LineWidthPlus = LineWidthPlus_DefaultValue = null;
			Marker = Marker_DefaultValue = new PictorialSeriesStatesHoverMarker();
		...
		/// </summary>
		public PictorialSeriesStatesHoverHalo Halo { get; set; }
		private PictorialSeriesStatesHoverHalo Halo_DefaultValue { get; set; }
		...
		/// </summary>
		public PictorialSeriesStatesHoverMarker Marker { get; set; }
		private PictorialSeriesStatesHoverMarker Marker_DefaultValue { get; set; }
