...
{
	public partial class PieSeriesData  : BaseObject
	{
		Hashtable h = new Hashtable();

		public PieSeriesData()
		{
			Accessibility = Accessibility_DefaultValue = new PieSeriesDataAccessibility();
			...
			Marker = Marker_DefaultValue = new PieSeriesDataMarker();
		...
		/// </summary>
		public PieSeriesDataAccessibility Accessibility { get; set; }
		private PieSeriesDataAccessibility Accessibility_DefaultValue { get; set; }
		...
		private PieSeriesDataDragDrop DragDrop_DefaultValue { get; set; }
		...
		/// </summary>
		public PieSeriesDataMarker Marker { get; set; }
		private PieSeriesDataMarker Marker_DefaultValue { get; set; }
