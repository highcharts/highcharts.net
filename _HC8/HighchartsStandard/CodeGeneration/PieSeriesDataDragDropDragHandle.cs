...
namespace Highsoft.Web.Mvc.Charts
{
	public partial class PieSeriesDataDragDropDragHandle  : BaseObject
	{
		...
		internal override Hashtable ToHashtable()
		{
			...
			if (PathFormatter != PathFormatter_DefaultValue) { h.Add("pathFormatter",PathFormatter); Highcharts.AddFunction("451752a4-5486-4118-ae68-633d33eb6d3f.pathFormatter", PathFormatter); }  
