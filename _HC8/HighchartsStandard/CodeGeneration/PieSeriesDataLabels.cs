...
namespace Highsoft.Web.Mvc.Charts
{
	public partial class PieSeriesDataLabels  : BaseObject
	{
		...
		public PieSeriesDataLabels()
		{
			...
			Style = Style_DefaultValue = new PieSeriesDataLabelsStyle();
			TextPath = TextPath_DefaultValue = new PieSeriesDataLabelsTextPath();
			UseHTML = UseHTML_DefaultValue = false;
			VerticalAlign = VerticalAlign_DefaultValue = PieSeriesDataLabelsVerticalAlign.Bottom;
			X = X_DefaultValue = 0;
			Y = Y_DefaultValue = 0;
			Z = Z_DefaultValue = 6;
		...
		/// </summary>
		public PieSeriesDataLabelsStyle Style { get; set; }
		private PieSeriesDataLabelsStyle Style_DefaultValue { get; set; }
		...
		internal override Hashtable ToHashtable()
		{
			...
			if (Formatter != Formatter_DefaultValue) { h.Add("formatter",Formatter); Highcharts.AddFunction("3b5bc35c-21a9-45b4-ae68-cd1d4c30c818.formatter", Formatter); }  
			...
			if (NullFormatter != NullFormatter_DefaultValue) { h.Add("nullFormatter",NullFormatter); Highcharts.AddFunction("34f42d79-7011-4b64-a2f9-9908d0ca120f.nullFormatter", NullFormatter); }  
