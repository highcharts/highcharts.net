...
{
	public partial class PieSeriesDataMarker  : BaseObject
	{
		Hashtable h = new Hashtable();

		public PieSeriesDataMarker()
		{
			...
			States = States_DefaultValue = new PieSeriesDataMarkerStates();
		...
		/// </summary>
		public PieSeriesDataMarkerStates States { get; set; }
		private PieSeriesDataMarkerStates States_DefaultValue { get; set; }
