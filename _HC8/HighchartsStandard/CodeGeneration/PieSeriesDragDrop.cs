...
{
	public partial class PieSeriesDragDrop  : BaseObject
	{
		Hashtable h = new Hashtable();

		public PieSeriesDragDrop()
		{
			DraggableX = DraggableX_DefaultValue = null;
			DraggableY = DraggableY_DefaultValue = null;
			DragHandle = DragHandle_DefaultValue = new PieSeriesDragDropDragHandle();
			...
			GuideBox = GuideBox_DefaultValue = new PieSeriesDragDropGuideBox();
		...
		/// </summary>
		public PieSeriesDragDropDragHandle DragHandle { get; set; }
		private PieSeriesDragDropDragHandle DragHandle_DefaultValue { get; set; }
		...
		/// </summary>
		public PieSeriesDragDropGuideBox GuideBox { get; set; }
		private PieSeriesDragDropGuideBox GuideBox_DefaultValue { get; set; }
