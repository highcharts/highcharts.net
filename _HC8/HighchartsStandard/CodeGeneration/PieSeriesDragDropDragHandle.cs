...
namespace Highsoft.Web.Mvc.Charts
{
	public partial class PieSeriesDragDropDragHandle  : BaseObject
	{
		...
		internal override Hashtable ToHashtable()
		{
			...
			if (PathFormatter != PathFormatter_DefaultValue) { h.Add("pathFormatter",PathFormatter); Highcharts.AddFunction("67f4265b-dd22-41b8-8b6a-29b7c584d18e.pathFormatter", PathFormatter); }  
