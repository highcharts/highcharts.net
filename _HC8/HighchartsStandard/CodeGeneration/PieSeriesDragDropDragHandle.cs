...
namespace Highsoft.Web.Mvc.Charts
{
	public partial class PieSeriesDragDropDragHandle  : BaseObject
	{
		...
		internal override Hashtable ToHashtable()
		{
			...
			if (PathFormatter != PathFormatter_DefaultValue) { h.Add("pathFormatter",PathFormatter); Highcharts.AddFunction("092e80e9-86f6-4ec4-88a0-6baa3f82426c.pathFormatter", PathFormatter); }  
