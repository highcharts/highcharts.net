...
{
	public partial class PieSeriesOnPoint  : BaseObject
	{
		Hashtable h = new Hashtable();

		public PieSeriesOnPoint()
		{
			ConnectorOptions = ConnectorOptions_DefaultValue = new PieSeriesOnPointConnectorOptions();
			Id = Id_DefaultValue = "";
			Position = Position_DefaultValue = new PieSeriesOnPointPosition();
		...
		/// </summary>
		public PieSeriesOnPointConnectorOptions ConnectorOptions { get; set; }
		private PieSeriesOnPointConnectorOptions ConnectorOptions_DefaultValue { get; set; }
		...
		/// </summary>
		public PieSeriesOnPointPosition Position { get; set; }
		private PieSeriesOnPointPosition Position_DefaultValue { get; set; }
