...
{
	public partial class PieSeriesStates  : BaseObject
	{
		...
		/// </summary>
		public PieSeriesStatesInactive Inactive { get; set; }
		private PieSeriesStatesInactive Inactive_DefaultValue { get; set; }
