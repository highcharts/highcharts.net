...
{
	public partial class PieSeriesStatesHover  : BaseObject
	{
		...
		public PieSeriesStatesHover()
		{
			...
			Halo = Halo_DefaultValue = new PieSeriesStatesHoverHalo();
			LineWidth = LineWidth_DefaultValue = null;
			LineWidthPlus = LineWidthPlus_DefaultValue = null;
			Marker = Marker_DefaultValue = new PieSeriesStatesHoverMarker();
		...
		/// </summary>
		public PieSeriesStatesHoverHalo Halo { get; set; }
		private PieSeriesStatesHoverHalo Halo_DefaultValue { get; set; }
		...
		/// </summary>
		public PieSeriesStatesHoverMarker Marker { get; set; }
		private PieSeriesStatesHoverMarker Marker_DefaultValue { get; set; }
