...
{
	public partial class PieSeriesStatesSelect  : BaseObject
	{
		Hashtable h = new Hashtable();

		public PieSeriesStatesSelect()
		{
			Animation = Animation_DefaultValue = new Animation() { Enabled = true };
			Enabled = Enabled_DefaultValue = null;
			Halo = Halo_DefaultValue = new PieSeriesStatesSelectHalo();
			LineWidth = LineWidth_DefaultValue = null;
			LineWidthPlus = LineWidthPlus_DefaultValue = null;
			Marker = Marker_DefaultValue = new PieSeriesStatesSelectMarker();
		...
		/// </summary>
		public PieSeriesStatesSelectHalo Halo { get; set; }
		private PieSeriesStatesSelectHalo Halo_DefaultValue { get; set; }
		...
		/// </summary>
		public PieSeriesStatesSelectMarker Marker { get; set; }
		private PieSeriesStatesSelectMarker Marker_DefaultValue { get; set; }
