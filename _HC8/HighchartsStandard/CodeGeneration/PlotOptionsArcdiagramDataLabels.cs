...
{
	public partial class PlotOptionsArcdiagramDataLabels  : BaseObject
	{
		Hashtable h = new Hashtable();

		public PlotOptionsArcdiagramDataLabels()
		{
			Align = Align_DefaultValue = PlotOptionsArcdiagramDataLabelsAlign.Center;
			...
			Filter = Filter_DefaultValue = new PlotOptionsArcdiagramDataLabelsFilter();
			...
			Overflow = Overflow_DefaultValue = PlotOptionsArcdiagramDataLabelsOverflow.Justify;
			Padding = Padding_DefaultValue = 5;
			Position = Position_DefaultValue = PlotOptionsArcdiagramDataLabelsPosition.Center;
			...
			TextPath = TextPath_DefaultValue = new PlotOptionsArcdiagramDataLabelsTextPath();
			UseHTML = UseHTML_DefaultValue = false;
			VerticalAlign = VerticalAlign_DefaultValue = PlotOptionsArcdiagramDataLabelsVerticalAlign.Bottom;
			X = X_DefaultValue = 0;
			Y = Y_DefaultValue = 0;
			Z = Z_DefaultValue = 6;
		...
		/// </summary>
		public PlotOptionsArcdiagramDataLabelsAlign Align { get; set; }
		private PlotOptionsArcdiagramDataLabelsAlign Align_DefaultValue { get; set; }
		...
		/// </summary>
		public PlotOptionsArcdiagramDataLabelsFilter Filter { get; set; }
		private PlotOptionsArcdiagramDataLabelsFilter Filter_DefaultValue { get; set; }
		...
		/// </summary>
		public PlotOptionsArcdiagramDataLabelsOverflow Overflow { get; set; }
		private PlotOptionsArcdiagramDataLabelsOverflow Overflow_DefaultValue { get; set; }
		...
		/// </summary>
		public PlotOptionsArcdiagramDataLabelsPosition Position { get; set; }
		private PlotOptionsArcdiagramDataLabelsPosition Position_DefaultValue { get; set; }
		...
		/// </summary>
		public PlotOptionsArcdiagramDataLabelsTextPath TextPath { get; set; }
		private PlotOptionsArcdiagramDataLabelsTextPath TextPath_DefaultValue { get; set; }
		...
		/// </summary>
		public PlotOptionsArcdiagramDataLabelsVerticalAlign VerticalAlign { get; set; }
		private PlotOptionsArcdiagramDataLabelsVerticalAlign VerticalAlign_DefaultValue { get; set; }
		...
		internal override Hashtable ToHashtable(Highcharts highcharts)
		{
			...
			if (LinkTextPath.IsDirty(ref highcharts)) h.Add("linkTextPath",LinkTextPath.ToHashtable(ref highcharts));
