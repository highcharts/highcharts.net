...
{
	public partial class PlotOptionsArcdiagramSonificationContextTracks  : BaseObject
	{
		Hashtable h = new Hashtable();

		public PlotOptionsArcdiagramSonificationContextTracks()
		{
			ActiveWhen = ActiveWhen_DefaultValue = new PlotOptionsArcdiagramSonificationContextTracksActiveWhen();
			Instrument = Instrument_DefaultValue = null;
			InstrumentString = InstrumentString_DefaultValue = "null";
			Mapping = Mapping_DefaultValue = new PlotOptionsArcdiagramSonificationContextTracksMapping();
			MidiName = MidiName_DefaultValue = "";
			PointGrouping = PointGrouping_DefaultValue = new PlotOptionsArcdiagramSonificationContextTracksPointGrouping();
			...
			Type = Type_DefaultValue = PlotOptionsArcdiagramSonificationContextTracksType.Instrument;
			ValueInterval = ValueInterval_DefaultValue = null;
			ValueMapFunction = ValueMapFunction_DefaultValue = PlotOptionsArcdiagramSonificationContextTracksValueMapFunction.Linear;
		...
		/// </summary>
		public PlotOptionsArcdiagramSonificationContextTracksActiveWhen ActiveWhen { get; set; }
		private PlotOptionsArcdiagramSonificationContextTracksActiveWhen ActiveWhen_DefaultValue { get; set; }
		...
		/// </summary>
		public PlotOptionsArcdiagramSonificationContextTracksMapping Mapping { get; set; }
		private PlotOptionsArcdiagramSonificationContextTracksMapping Mapping_DefaultValue { get; set; }
		...
		/// </summary>
		public PlotOptionsArcdiagramSonificationContextTracksPointGrouping PointGrouping { get; set; }
		private PlotOptionsArcdiagramSonificationContextTracksPointGrouping PointGrouping_DefaultValue { get; set; }
		...
		/// </summary>
		public PlotOptionsArcdiagramSonificationContextTracksType Type { get; set; }
		private PlotOptionsArcdiagramSonificationContextTracksType Type_DefaultValue { get; set; }
		...
		/// </summary>
		public PlotOptionsArcdiagramSonificationContextTracksValueMapFunction ValueMapFunction { get; set; }
		private PlotOptionsArcdiagramSonificationContextTracksValueMapFunction ValueMapFunction_DefaultValue { get; set; }
