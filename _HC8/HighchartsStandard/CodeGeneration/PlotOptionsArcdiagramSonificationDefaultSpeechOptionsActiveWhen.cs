...
{
	public partial class PlotOptionsArcdiagramSonificationDefaultSpeechOptionsActiveWhen  : BaseObject
	{
		Hashtable h = new Hashtable();

		public PlotOptionsArcdiagramSonificationDefaultSpeechOptionsActiveWhen()
		{
