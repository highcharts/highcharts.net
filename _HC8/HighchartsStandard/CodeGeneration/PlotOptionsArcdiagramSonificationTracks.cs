...
{
	public partial class PlotOptionsArcdiagramSonificationTracks  : BaseObject
	{
		Hashtable h = new Hashtable();

		public PlotOptionsArcdiagramSonificationTracks()
		{
			ActiveWhen = ActiveWhen_DefaultValue = new PlotOptionsArcdiagramSonificationTracksActiveWhen();
			Instrument = Instrument_DefaultValue = null;
			InstrumentString = InstrumentString_DefaultValue = "null";
			Mapping = Mapping_DefaultValue = new PlotOptionsArcdiagramSonificationTracksMapping();
			MidiName = MidiName_DefaultValue = "";
			PointGrouping = PointGrouping_DefaultValue = new PlotOptionsArcdiagramSonificationTracksPointGrouping();
			RoundToMusicalNotes = RoundToMusicalNotes_DefaultValue = true;
			ShowPlayMarker = ShowPlayMarker_DefaultValue = true;
			Type = Type_DefaultValue = PlotOptionsArcdiagramSonificationTracksType.Instrument;
		...
		/// </summary>
		public PlotOptionsArcdiagramSonificationTracksActiveWhen ActiveWhen { get; set; }
		private PlotOptionsArcdiagramSonificationTracksActiveWhen ActiveWhen_DefaultValue { get; set; }
		...
		/// </summary>
		public PlotOptionsArcdiagramSonificationTracksMapping Mapping { get; set; }
		private PlotOptionsArcdiagramSonificationTracksMapping Mapping_DefaultValue { get; set; }
		...
		/// </summary>
		public PlotOptionsArcdiagramSonificationTracksPointGrouping PointGrouping { get; set; }
		private PlotOptionsArcdiagramSonificationTracksPointGrouping PointGrouping_DefaultValue { get; set; }
		...
		/// </summary>
		public PlotOptionsArcdiagramSonificationTracksType Type { get; set; }
		private PlotOptionsArcdiagramSonificationTracksType Type_DefaultValue { get; set; }
