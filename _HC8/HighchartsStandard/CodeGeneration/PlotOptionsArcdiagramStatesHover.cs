...
{
	public partial class PlotOptionsArcdiagramStatesHover  : PlotOptionsSeries
	{
		Hashtable h = new Hashtable();

		public PlotOptionsArcdiagramStatesHover()
		{
			Animation = Animation_DefaultValue = new Animation();
			Enabled = Enabled_DefaultValue = null;
			Halo = Halo_DefaultValue = new PlotOptionsArcdiagramStatesHoverHalo();
			LineWidth = LineWidth_DefaultValue = null;
			LineWidthPlus = LineWidthPlus_DefaultValue = null;
			Marker = Marker_DefaultValue = new PlotOptionsArcdiagramStatesHoverMarker();
		...
		/// </summary>
		public PlotOptionsArcdiagramStatesHoverHalo Halo { get; set; }
		private PlotOptionsArcdiagramStatesHoverHalo Halo_DefaultValue { get; set; }
		...
		/// </summary>
		public PlotOptionsArcdiagramStatesHoverMarker Marker { get; set; }
		private PlotOptionsArcdiagramStatesHoverMarker Marker_DefaultValue { get; set; }
