...
{
	public partial class PlotOptionsArcdiagramStatesHoverMarker  : PlotOptionsSeries
	{
		Hashtable h = new Hashtable();

		public PlotOptionsArcdiagramStatesHoverMarker()
		{
			...
			States = States_DefaultValue = new PlotOptionsArcdiagramStatesHoverMarkerStates();
		...
		/// </summary>
		public PlotOptionsArcdiagramStatesHoverMarkerStates States { get; set; }
		private PlotOptionsArcdiagramStatesHoverMarkerStates States_DefaultValue { get; set; }
