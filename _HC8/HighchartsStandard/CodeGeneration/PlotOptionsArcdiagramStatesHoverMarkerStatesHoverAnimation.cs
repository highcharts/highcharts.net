...
{
	public partial class PlotOptionsArcdiagramStatesHoverMarkerStatesHoverAnimation  : PlotOptionsSeries
	{
		Hashtable h = new Hashtable();

		public PlotOptionsArcdiagramStatesHoverMarkerStatesHoverAnimation()
		{
