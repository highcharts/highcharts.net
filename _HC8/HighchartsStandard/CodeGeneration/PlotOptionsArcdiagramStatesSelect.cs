...
{
	public partial class PlotOptionsArcdiagramStatesSelect  : PlotOptionsSeries
	{
		Hashtable h = new Hashtable();

		public PlotOptionsArcdiagramStatesSelect()
		{
			Animation = Animation_DefaultValue = new Animation();
			Enabled = Enabled_DefaultValue = null;
			Halo = Halo_DefaultValue = new PlotOptionsArcdiagramStatesSelectHalo();
			LineWidth = LineWidth_DefaultValue = null;
			LineWidthPlus = LineWidthPlus_DefaultValue = null;
			Marker = Marker_DefaultValue = new PlotOptionsArcdiagramStatesSelectMarker();
		...
		/// </summary>
		public PlotOptionsArcdiagramStatesSelectHalo Halo { get; set; }
		private PlotOptionsArcdiagramStatesSelectHalo Halo_DefaultValue { get; set; }
		...
		/// </summary>
		public PlotOptionsArcdiagramStatesSelectMarker Marker { get; set; }
		private PlotOptionsArcdiagramStatesSelectMarker Marker_DefaultValue { get; set; }
