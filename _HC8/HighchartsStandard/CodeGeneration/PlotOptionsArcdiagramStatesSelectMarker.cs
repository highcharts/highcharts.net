...
{
	public partial class PlotOptionsArcdiagramStatesSelectMarker  : PlotOptionsSeries
	{
		Hashtable h = new Hashtable();

		public PlotOptionsArcdiagramStatesSelectMarker()
		{
			...
			States = States_DefaultValue = new PlotOptionsArcdiagramStatesSelectMarkerStates();
		...
		/// </summary>
		public PlotOptionsArcdiagramStatesSelectMarkerStates States { get; set; }
		private PlotOptionsArcdiagramStatesSelectMarkerStates States_DefaultValue { get; set; }
