...
{
	public partial class PlotOptionsArcdiagramTooltip  : BaseObject
	{
		Hashtable h = new Hashtable();

		public PlotOptionsArcdiagramTooltip()
		{
			...
			HeaderShape = HeaderShape_DefaultValue = PlotOptionsArcdiagramTooltipHeaderShape.Callout;
		...
		/// </summary>
		public PlotOptionsArcdiagramTooltipHeaderShape HeaderShape { get; set; }
		private PlotOptionsArcdiagramTooltipHeaderShape HeaderShape_DefaultValue { get; set; }
