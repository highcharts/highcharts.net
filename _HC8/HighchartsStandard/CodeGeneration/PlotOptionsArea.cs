...
namespace Highsoft.Web.Mvc.Charts
{
	public partial class PlotOptionsArea  : BaseObject
	{
		...
		internal override Hashtable ToHashtable()
		{
			...
			if (PointDescriptionFormatter != PointDescriptionFormatter_DefaultValue) { h.Add("pointDescriptionFormatter",PointDescriptionFormatter); Highcharts.AddFunction("f5f10487-c341-45b7-91b1-070c2fdd1fa9.pointDescriptionFormatter", PointDescriptionFormatter); }  
