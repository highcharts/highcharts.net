...
namespace Highsoft.Web.Mvc.Charts
{
	public partial class PlotOptionsArea  : BaseObject
	{
		...
		internal override Hashtable ToHashtable()
		{
			...
			if (PointDescriptionFormatter != PointDescriptionFormatter_DefaultValue) { h.Add("pointDescriptionFormatter",PointDescriptionFormatter); Highcharts.AddFunction("3f931dec-6553-4cec-8598-f342f6fb42cf.pointDescriptionFormatter", PointDescriptionFormatter); }  
