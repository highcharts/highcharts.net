...
namespace Highsoft.Web.Mvc.Charts
{
	public partial class PlotOptionsAreaDataLabels  : BaseObject
	{
		...
		public PlotOptionsAreaDataLabels()
		{
			...
			Style = Style_DefaultValue = new PlotOptionsAreaDataLabelsStyle();
		...
		/// </summary>
		public PlotOptionsAreaDataLabelsStyle Style { get; set; }
		private PlotOptionsAreaDataLabelsStyle Style_DefaultValue { get; set; }
		...
		internal override Hashtable ToHashtable()
		{
			...
			if (Formatter != Formatter_DefaultValue) { h.Add("formatter",Formatter); Highcharts.AddFunction("10a29cf1-fd4a-4017-bd3f-8a76e742c172.formatter", Formatter); }  
			if (Inside != Inside_DefaultValue) h.Add("inside",Inside);
			if (NullFormat != NullFormat_DefaultValue) h.Add("nullFormat",NullFormat);
			if (NullFormatter != NullFormatter_DefaultValue) { h.Add("nullFormatter",NullFormatter); Highcharts.AddFunction("8fe706df-7591-4607-bf00-f66710e1b0ff.nullFormatter", NullFormatter); }  
