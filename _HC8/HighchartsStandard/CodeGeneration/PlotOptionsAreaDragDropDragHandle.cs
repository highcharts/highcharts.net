...
namespace Highsoft.Web.Mvc.Charts
{
	public partial class PlotOptionsAreaDragDropDragHandle  : BaseObject
	{
		...
		internal override Hashtable ToHashtable()
		{
			...
			if (PathFormatter != PathFormatter_DefaultValue) { h.Add("pathFormatter",PathFormatter); Highcharts.AddFunction("33609bcc-c3b7-43f7-bedb-0e4d5f3bee8b.pathFormatter", PathFormatter); }  
