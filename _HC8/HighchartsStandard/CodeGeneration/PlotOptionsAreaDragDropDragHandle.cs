...
namespace Highsoft.Web.Mvc.Charts
{
	public partial class PlotOptionsAreaDragDropDragHandle  : BaseObject
	{
		...
		internal override Hashtable ToHashtable()
		{
			...
			if (PathFormatter != PathFormatter_DefaultValue) { h.Add("pathFormatter",PathFormatter); Highcharts.AddFunction("a251931b-57df-4bdc-9001-3b198fdbd4e2.pathFormatter", PathFormatter); }  
