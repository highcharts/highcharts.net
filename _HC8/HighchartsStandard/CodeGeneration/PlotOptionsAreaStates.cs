...
{
	public partial class PlotOptionsAreaStates  : PlotOptionsSeries
	{
		...
		public PlotOptionsAreaStates()
		{
			...
			Select = Select_DefaultValue = new PlotOptionsAreaStatesSelect();
		...
		/// </summary>
		public PlotOptionsAreaStatesSelect Select { get; set; }
		private PlotOptionsAreaStatesSelect Select_DefaultValue { get; set; }
