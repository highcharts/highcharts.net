...
{
	public partial class PlotOptionsAreaStatesHover  : PlotOptionsSeries
	{
		...
		public PlotOptionsAreaStatesHover()
		{
			...
			Halo = Halo_DefaultValue = new PlotOptionsAreaStatesHoverHalo();
			LineWidth = LineWidth_DefaultValue = null;
			LineWidthPlus = LineWidthPlus_DefaultValue = null;
			Marker = Marker_DefaultValue = new PlotOptionsAreaStatesHoverMarker();
		...
		private PlotOptionsAreaStatesHoverHalo Halo_DefaultValue { get; set; }
		...
		private PlotOptionsAreaStatesHoverMarker Marker_DefaultValue { get; set; }
