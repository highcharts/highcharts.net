...
{
	public partial class PlotOptionsAreaStatesHoverMarker  : PlotOptionsSeries
	{
		...
		public PlotOptionsAreaStatesHoverMarker()
		{
			...
			States = States_DefaultValue = new PlotOptionsAreaStatesHoverMarkerStates();
		...
		/// </summary>
		public PlotOptionsAreaStatesHoverMarkerStates States { get; set; }
		private PlotOptionsAreaStatesHoverMarkerStates States_DefaultValue { get; set; }
