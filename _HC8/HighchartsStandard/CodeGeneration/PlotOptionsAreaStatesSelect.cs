...
{
	public partial class PlotOptionsAreaStatesSelect  : PlotOptionsSeries
	{
		Hashtable h = new Hashtable();

		public PlotOptionsAreaStatesSelect()
		{
			Animation = Animation_DefaultValue = new Animation();
			Enabled = Enabled_DefaultValue = null;
			Halo = Halo_DefaultValue = new PlotOptionsAreaStatesSelectHalo();
			LineWidth = LineWidth_DefaultValue = null;
			LineWidthPlus = LineWidthPlus_DefaultValue = null;
			Marker = Marker_DefaultValue = new PlotOptionsAreaStatesSelectMarker();
		...
		/// </summary>
		public PlotOptionsAreaStatesSelectHalo Halo { get; set; }
		private PlotOptionsAreaStatesSelectHalo Halo_DefaultValue { get; set; }
		...
		/// </summary>
		public PlotOptionsAreaStatesSelectMarker Marker { get; set; }
		private PlotOptionsAreaStatesSelectMarker Marker_DefaultValue { get; set; }
