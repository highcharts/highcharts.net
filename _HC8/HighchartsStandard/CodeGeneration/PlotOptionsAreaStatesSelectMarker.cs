...
{
	public partial class PlotOptionsAreaStatesSelectMarker  : PlotOptionsSeries
	{
		Hashtable h = new Hashtable();

		public PlotOptionsAreaStatesSelectMarker()
		{
			...
			States = States_DefaultValue = new PlotOptionsAreaStatesSelectMarkerStates();
		...
		/// </summary>
		public PlotOptionsAreaStatesSelectMarkerStates States { get; set; }
		private PlotOptionsAreaStatesSelectMarkerStates States_DefaultValue { get; set; }
