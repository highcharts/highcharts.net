...
{
	public partial class PlotOptionsAreaStatesSelectMarkerStatesHoverAnimation  : PlotOptionsSeries
	{
		Hashtable h = new Hashtable();

		public PlotOptionsAreaStatesSelectMarkerStatesHoverAnimation()
		{
