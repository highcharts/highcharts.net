...
namespace Highsoft.Web.Mvc.Charts
{
	public partial class PlotOptionsAreaTooltip  : BaseObject
	{
		...
		public PlotOptionsAreaTooltip()
		{
			...
			HeaderShape = HeaderShape_DefaultValue = PlotOptionsAreaTooltipHeaderShape.Callout;
		...
		/// </summary>
		public PlotOptionsAreaTooltipHeaderShape HeaderShape { get; set; }
		private PlotOptionsAreaTooltipHeaderShape HeaderShape_DefaultValue { get; set; }
		...
		internal override Hashtable ToHashtable()
		{
			...
			if (NullFormatter != NullFormatter_DefaultValue) { h.Add("nullFormatter",NullFormatter); Highcharts.AddFunction("43c5c911-be85-494d-86ef-a6bf492b385c.nullFormatter", NullFormatter); }  
			if (Outside != Outside_DefaultValue) h.Add("outside",Outside);
			if (Padding != Padding_DefaultValue) h.Add("padding",Padding);
			if (PointFormat != PointFormat_DefaultValue) h.Add("pointFormat",PointFormat);
			if (PointFormatter != PointFormatter_DefaultValue) { h.Add("pointFormatter",PointFormatter); Highcharts.AddFunction("06c467a2-9510-4374-8781-7f1973f0398c.pointFormatter", PointFormatter); }  
