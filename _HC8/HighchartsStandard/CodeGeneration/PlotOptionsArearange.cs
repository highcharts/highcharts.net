...
namespace Highsoft.Web.Mvc.Charts
{
	public partial class PlotOptionsArearange  : BaseObject
	{
		...
		internal override Hashtable ToHashtable()
		{
			...
			if (PointDescriptionFormatter != PointDescriptionFormatter_DefaultValue) { h.Add("pointDescriptionFormatter",PointDescriptionFormatter); Highcharts.AddFunction("ea6cbf4f-b50e-415b-be76-5cb324d21a3e.pointDescriptionFormatter", PointDescriptionFormatter); }  
