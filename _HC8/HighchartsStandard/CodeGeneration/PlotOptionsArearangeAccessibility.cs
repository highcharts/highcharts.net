...
namespace Highsoft.Web.Mvc.Charts
{
	public partial class PlotOptionsArearangeAccessibility  : BaseObject
	{
		...
		internal override Hashtable ToHashtable()
		{
			...
			if (PointDescriptionFormatter != PointDescriptionFormatter_DefaultValue) { h.Add("pointDescriptionFormatter",PointDescriptionFormatter); Highcharts.AddFunction("868e9775-edd4-4c10-8c61-625d759663ba.pointDescriptionFormatter", PointDescriptionFormatter); }  
