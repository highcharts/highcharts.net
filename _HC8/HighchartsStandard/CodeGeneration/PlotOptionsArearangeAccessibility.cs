...
namespace Highsoft.Web.Mvc.Charts
{
	public partial class PlotOptionsArearangeAccessibility  : BaseObject
	{
		...
		internal override Hashtable ToHashtable()
		{
			...
			if (PointDescriptionFormatter != PointDescriptionFormatter_DefaultValue) { h.Add("pointDescriptionFormatter",PointDescriptionFormatter); Highcharts.AddFunction("1bc38707-cc97-4a32-b993-fb70281033f2.pointDescriptionFormatter", PointDescriptionFormatter); }  
