...
namespace Highsoft.Web.Mvc.Charts
{
	public partial class PlotOptionsArearangeAccessibility  : BaseObject
	{
		...
		internal override Hashtable ToHashtable()
		{
			...
			if (PointDescriptionFormatter != PointDescriptionFormatter_DefaultValue) { h.Add("pointDescriptionFormatter",PointDescriptionFormatter); Highcharts.AddFunction("7abf0940-c01d-4998-9854-128d1d60cb15.pointDescriptionFormatter", PointDescriptionFormatter); }  
