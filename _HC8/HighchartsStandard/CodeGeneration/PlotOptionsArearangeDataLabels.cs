...
namespace Highsoft.Web.Mvc.Charts
{
	public partial class PlotOptionsArearangeDataLabels  : BaseObject
	{
		...
		public PlotOptionsArearangeDataLabels()
		{
			...
			Filter = Filter_DefaultValue = new PlotOptionsArearangeDataLabelsFilter();
			...
			TextPath = TextPath_DefaultValue = new PlotOptionsArearangeDataLabelsTextPath();
		...
		/// </summary>
		public PlotOptionsArearangeDataLabelsStyle Style { get; set; }
		private PlotOptionsArearangeDataLabelsStyle Style_DefaultValue { get; set; }
		...
		internal override Hashtable ToHashtable()
		{
			...
			if (Formatter != Formatter_DefaultValue) { h.Add("formatter",Formatter); Highcharts.AddFunction("8989f8df-3520-4a31-bbec-6bf29e77d4bc.formatter", Formatter); }  
			if (Inside != Inside_DefaultValue) h.Add("inside",Inside);
			if (NullFormat != NullFormat_DefaultValue) h.Add("nullFormat",NullFormat);
			if (NullFormatter != NullFormatter_DefaultValue) { h.Add("nullFormatter",NullFormatter); Highcharts.AddFunction("46afa474-bb42-4262-a7b2-d29d48a56258.nullFormatter", NullFormatter); }  
