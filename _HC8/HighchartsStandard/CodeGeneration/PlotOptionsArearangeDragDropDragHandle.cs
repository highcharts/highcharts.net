...
namespace Highsoft.Web.Mvc.Charts
{
	public partial class PlotOptionsArearangeDragDropDragHandle  : BaseObject
	{
		...
		internal override Hashtable ToHashtable()
		{
			...
			if (PathFormatter != PathFormatter_DefaultValue) { h.Add("pathFormatter",PathFormatter); Highcharts.AddFunction("d9f806c8-6874-44b6-b216-1b30fd68106b.pathFormatter", PathFormatter); }  
