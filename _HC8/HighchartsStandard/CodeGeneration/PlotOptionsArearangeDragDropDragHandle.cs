...
namespace Highsoft.Web.Mvc.Charts
{
	public partial class PlotOptionsArearangeDragDropDragHandle  : BaseObject
	{
		...
		internal override Hashtable ToHashtable()
		{
			...
			if (PathFormatter != PathFormatter_DefaultValue) { h.Add("pathFormatter",PathFormatter); Highcharts.AddFunction("fd78cb09-3695-4f3a-8cb4-c266587282c5.pathFormatter", PathFormatter); }  
