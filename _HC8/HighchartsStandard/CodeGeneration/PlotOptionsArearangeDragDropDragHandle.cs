...
namespace Highsoft.Web.Mvc.Charts
{
	public partial class PlotOptionsArearangeDragDropDragHandle  : BaseObject
	{
		...
		internal override Hashtable ToHashtable()
		{
			...
			if (PathFormatter != PathFormatter_DefaultValue) { h.Add("pathFormatter",PathFormatter); Highcharts.AddFunction("e9de2e49-1d4b-47cd-af37-d7eeba021171.pathFormatter", PathFormatter); }  
