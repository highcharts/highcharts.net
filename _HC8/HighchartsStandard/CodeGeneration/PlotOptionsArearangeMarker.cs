...
{
	public partial class PlotOptionsArearangeMarker  : PlotOptionsSeries
	{
		Hashtable h = new Hashtable();

		public PlotOptionsArearangeMarker()
		{
			...
			States = States_DefaultValue = new PlotOptionsArearangeMarkerStates();
		...
		private PlotOptionsArearangeMarkerStates States_DefaultValue { get; set; }
