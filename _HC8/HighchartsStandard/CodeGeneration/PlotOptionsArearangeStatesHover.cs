...
{
	public partial class PlotOptionsArearangeStatesHover  : PlotOptionsSeries
	{
		...
		public PlotOptionsArearangeStatesHover()
		{
			...
			Halo = Halo_DefaultValue = new PlotOptionsArearangeStatesHoverHalo();
			LineWidth = LineWidth_DefaultValue = null;
			LineWidthPlus = LineWidthPlus_DefaultValue = null;
			Marker = Marker_DefaultValue = new PlotOptionsArearangeStatesHoverMarker();
		...
		private PlotOptionsArearangeStatesHoverHalo Halo_DefaultValue { get; set; }
		...
		private PlotOptionsArearangeStatesHoverMarker Marker_DefaultValue { get; set; }
