...
{
	public partial class PlotOptionsArearangeStatesSelect  : PlotOptionsSeries
	{
		Hashtable h = new Hashtable();

		public PlotOptionsArearangeStatesSelect()
		{
			Animation = Animation_DefaultValue = new Animation();
			Enabled = Enabled_DefaultValue = null;
			Halo = Halo_DefaultValue = new PlotOptionsArearangeStatesSelectHalo();
			LineWidth = LineWidth_DefaultValue = null;
			LineWidthPlus = LineWidthPlus_DefaultValue = null;
			Marker = Marker_DefaultValue = new PlotOptionsArearangeStatesSelectMarker();
		...
		/// </summary>
		public PlotOptionsArearangeStatesSelectHalo Halo { get; set; }
		private PlotOptionsArearangeStatesSelectHalo Halo_DefaultValue { get; set; }
		...
		/// </summary>
		public PlotOptionsArearangeStatesSelectMarker Marker { get; set; }
		private PlotOptionsArearangeStatesSelectMarker Marker_DefaultValue { get; set; }
