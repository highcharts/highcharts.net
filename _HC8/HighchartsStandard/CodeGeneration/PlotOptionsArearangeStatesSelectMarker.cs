...
{
	public partial class PlotOptionsArearangeStatesSelectMarker  : PlotOptionsSeries
	{
		Hashtable h = new Hashtable();

		public PlotOptionsArearangeStatesSelectMarker()
		{
			...
			States = States_DefaultValue = new PlotOptionsArearangeStatesSelectMarkerStates();
		...
		/// </summary>
		public PlotOptionsArearangeStatesSelectMarkerStates States { get; set; }
		private PlotOptionsArearangeStatesSelectMarkerStates States_DefaultValue { get; set; }
