...
namespace Highsoft.Web.Mvc.Charts
{
	public partial class PlotOptionsAreaspline  : BaseObject
	{
		...
		internal override Hashtable ToHashtable()
		{
			...
			if (PointDescriptionFormatter != PointDescriptionFormatter_DefaultValue) { h.Add("pointDescriptionFormatter",PointDescriptionFormatter); Highcharts.AddFunction("63bb0ae2-0161-441a-9840-399e5b43f56d.pointDescriptionFormatter", PointDescriptionFormatter); }  
