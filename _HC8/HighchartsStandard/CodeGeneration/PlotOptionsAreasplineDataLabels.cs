...
namespace Highsoft.Web.Mvc.Charts
{
	public partial class PlotOptionsAreasplineDataLabels  : BaseObject
	{
		...
		public PlotOptionsAreasplineDataLabels()
		{
			...
			Style = Style_DefaultValue = new PlotOptionsAreasplineDataLabelsStyle();
		...
		/// </summary>
		public PlotOptionsAreasplineDataLabelsStyle Style { get; set; }
		private PlotOptionsAreasplineDataLabelsStyle Style_DefaultValue { get; set; }
		...
		internal override Hashtable ToHashtable()
		{
			...
			if (Formatter != Formatter_DefaultValue) { h.Add("formatter",Formatter); Highcharts.AddFunction("ad91ef0f-ef14-4068-89e0-8fa37d2233c9.formatter", Formatter); }  
			...
			if (NullFormatter != NullFormatter_DefaultValue) { h.Add("nullFormatter",NullFormatter); Highcharts.AddFunction("0604fa39-fc34-46e8-9ace-2e01873e22e2.nullFormatter", NullFormatter); }  
