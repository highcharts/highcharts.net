...
namespace Highsoft.Web.Mvc.Charts
{
	public partial class PlotOptionsAreasplineDragDropDragHandle  : BaseObject
	{
		...
		internal override Hashtable ToHashtable()
		{
			...
			if (PathFormatter != PathFormatter_DefaultValue) { h.Add("pathFormatter",PathFormatter); Highcharts.AddFunction("bec9388a-9028-47c1-a414-97f373065bd5.pathFormatter", PathFormatter); }  
