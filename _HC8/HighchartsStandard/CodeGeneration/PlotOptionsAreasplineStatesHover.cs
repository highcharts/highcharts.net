...
{
	public partial class PlotOptionsAreasplineStatesHover  : PlotOptionsSeries
	{
		...
		public PlotOptionsAreasplineStatesHover()
		{
			...
			Halo = Halo_DefaultValue = new PlotOptionsAreasplineStatesHoverHalo();
			LineWidth = LineWidth_DefaultValue = null;
			LineWidthPlus = LineWidthPlus_DefaultValue = null;
			Marker = Marker_DefaultValue = new PlotOptionsAreasplineStatesHoverMarker();
		...
		private PlotOptionsAreasplineStatesHoverHalo Halo_DefaultValue { get; set; }
		...
		private PlotOptionsAreasplineStatesHoverMarker Marker_DefaultValue { get; set; }
