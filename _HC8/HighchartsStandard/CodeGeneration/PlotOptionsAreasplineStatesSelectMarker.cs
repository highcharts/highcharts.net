...
{
	public partial class PlotOptionsAreasplineStatesSelectMarker  : PlotOptionsSeries
	{
		Hashtable h = new Hashtable();

		public PlotOptionsAreasplineStatesSelectMarker()
		{
			...
			States = States_DefaultValue = new PlotOptionsAreasplineStatesSelectMarkerStates();
		...
		/// </summary>
		public PlotOptionsAreasplineStatesSelectMarkerStates States { get; set; }
		private PlotOptionsAreasplineStatesSelectMarkerStates States_DefaultValue { get; set; }
