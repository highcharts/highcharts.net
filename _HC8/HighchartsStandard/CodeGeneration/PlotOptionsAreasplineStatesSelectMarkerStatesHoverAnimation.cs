...
{
	public partial class PlotOptionsAreasplineStatesSelectMarkerStatesHoverAnimation  : PlotOptionsSeries
	{
		Hashtable h = new Hashtable();

		public PlotOptionsAreasplineStatesSelectMarkerStatesHoverAnimation()
		{
