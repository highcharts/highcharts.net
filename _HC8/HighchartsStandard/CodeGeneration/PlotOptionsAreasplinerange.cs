...
namespace Highsoft.Web.Mvc.Charts
{
	public partial class PlotOptionsAreasplinerange  : BaseObject
	{
		...
		internal override Hashtable ToHashtable()
		{
			...
			if (PointDescriptionFormatter != PointDescriptionFormatter_DefaultValue) { h.Add("pointDescriptionFormatter",PointDescriptionFormatter); Highcharts.AddFunction("0085cabc-135c-4c1f-a8eb-a0b6414dea13.pointDescriptionFormatter", PointDescriptionFormatter); }  
