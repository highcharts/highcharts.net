...
namespace Highsoft.Web.Mvc.Charts
{
	public partial class PlotOptionsAreasplinerangeDataLabels  : BaseObject
	{
		...
		public PlotOptionsAreasplinerangeDataLabels()
		{
			...
			Style = Style_DefaultValue = new PlotOptionsAreasplinerangeDataLabelsStyle();
		...
		/// </summary>
		public PlotOptionsAreasplinerangeDataLabelsStyle Style { get; set; }
		private PlotOptionsAreasplinerangeDataLabelsStyle Style_DefaultValue { get; set; }
		...
		internal override Hashtable ToHashtable()
		{
			...
			if (Formatter != Formatter_DefaultValue) { h.Add("formatter",Formatter); Highcharts.AddFunction("7ae56185-7bfe-4456-a615-7a83a690aa30.formatter", Formatter); }  
			...
			if (NullFormatter != NullFormatter_DefaultValue) { h.Add("nullFormatter",NullFormatter); Highcharts.AddFunction("19524039-ecbb-4c22-90cc-604a792a4354.nullFormatter", NullFormatter); }  
