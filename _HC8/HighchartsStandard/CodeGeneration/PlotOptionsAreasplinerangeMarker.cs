...
{
	public partial class PlotOptionsAreasplinerangeMarker  : PlotOptionsSeries
	{
		Hashtable h = new Hashtable();

		public PlotOptionsAreasplinerangeMarker()
		{
			...
			States = States_DefaultValue = new PlotOptionsAreasplinerangeMarkerStates();
		...
		/// </summary>
		public PlotOptionsAreasplinerangeMarkerStates States { get; set; }
		private PlotOptionsAreasplinerangeMarkerStates States_DefaultValue { get; set; }
