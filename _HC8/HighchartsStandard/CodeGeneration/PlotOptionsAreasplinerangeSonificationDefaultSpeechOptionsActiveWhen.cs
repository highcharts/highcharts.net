...
{
	public partial class PlotOptionsAreasplinerangeSonificationDefaultSpeechOptionsActiveWhen  : BaseObject
	{
		Hashtable h = new Hashtable();

		public PlotOptionsAreasplinerangeSonificationDefaultSpeechOptionsActiveWhen()
		{
