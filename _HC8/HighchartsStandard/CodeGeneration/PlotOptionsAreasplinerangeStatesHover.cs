...
{
	public partial class PlotOptionsAreasplinerangeStatesHover  : PlotOptionsSeries
	{
		...
		public PlotOptionsAreasplinerangeStatesHover()
		{
			...
			Halo = Halo_DefaultValue = new PlotOptionsAreasplinerangeStatesHoverHalo();
			LineWidth = LineWidth_DefaultValue = null;
			LineWidthPlus = LineWidthPlus_DefaultValue = null;
			Marker = Marker_DefaultValue = new PlotOptionsAreasplinerangeStatesHoverMarker();
		...
		private PlotOptionsAreasplinerangeStatesHoverHalo Halo_DefaultValue { get; set; }
		...
		private PlotOptionsAreasplinerangeStatesHoverMarker Marker_DefaultValue { get; set; }
