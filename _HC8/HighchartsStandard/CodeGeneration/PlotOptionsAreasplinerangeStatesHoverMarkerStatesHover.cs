...
{
	public partial class PlotOptionsAreasplinerangeStatesHoverMarkerStatesHover  : PlotOptionsSeries
	{
		Hashtable h = new Hashtable();

		public PlotOptionsAreasplinerangeStatesHoverMarkerStatesHover()
		{
