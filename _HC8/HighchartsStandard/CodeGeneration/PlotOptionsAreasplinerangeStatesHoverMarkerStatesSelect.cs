...
{
	public partial class PlotOptionsAreasplinerangeStatesHoverMarkerStatesSelect  : PlotOptionsSeries
	{
		Hashtable h = new Hashtable();

		public PlotOptionsAreasplinerangeStatesHoverMarkerStatesSelect()
		{
