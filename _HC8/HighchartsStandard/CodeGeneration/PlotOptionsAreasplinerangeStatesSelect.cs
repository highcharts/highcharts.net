...
{
	public partial class PlotOptionsAreasplinerangeStatesSelect  : PlotOptionsSeries
	{
		Hashtable h = new Hashtable();

		public PlotOptionsAreasplinerangeStatesSelect()
		{
			Animation = Animation_DefaultValue = new Animation();
			Enabled = Enabled_DefaultValue = null;
			Halo = Halo_DefaultValue = new PlotOptionsAreasplinerangeStatesSelectHalo();
			LineWidth = LineWidth_DefaultValue = null;
			LineWidthPlus = LineWidthPlus_DefaultValue = null;
			Marker = Marker_DefaultValue = new PlotOptionsAreasplinerangeStatesSelectMarker();
		...
		/// </summary>
		public PlotOptionsAreasplinerangeStatesSelectHalo Halo { get; set; }
		private PlotOptionsAreasplinerangeStatesSelectHalo Halo_DefaultValue { get; set; }
		...
		/// </summary>
		public PlotOptionsAreasplinerangeStatesSelectMarker Marker { get; set; }
		private PlotOptionsAreasplinerangeStatesSelectMarker Marker_DefaultValue { get; set; }
