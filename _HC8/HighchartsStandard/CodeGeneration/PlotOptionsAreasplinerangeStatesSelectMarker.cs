...
{
	public partial class PlotOptionsAreasplinerangeStatesSelectMarker  : PlotOptionsSeries
	{
		Hashtable h = new Hashtable();

		public PlotOptionsAreasplinerangeStatesSelectMarker()
		{
			...
			States = States_DefaultValue = new PlotOptionsAreasplinerangeStatesSelectMarkerStates();
		...
		/// </summary>
		public PlotOptionsAreasplinerangeStatesSelectMarkerStates States { get; set; }
		private PlotOptionsAreasplinerangeStatesSelectMarkerStates States_DefaultValue { get; set; }
