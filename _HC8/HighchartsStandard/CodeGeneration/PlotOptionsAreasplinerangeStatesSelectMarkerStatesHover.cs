...
{
	public partial class PlotOptionsAreasplinerangeStatesSelectMarkerStatesHover  : PlotOptionsSeries
	{
		Hashtable h = new Hashtable();

		public PlotOptionsAreasplinerangeStatesSelectMarkerStatesHover()
		{
