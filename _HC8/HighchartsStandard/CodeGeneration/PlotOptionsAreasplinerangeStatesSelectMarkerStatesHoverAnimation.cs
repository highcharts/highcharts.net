...
{
	public partial class PlotOptionsAreasplinerangeStatesSelectMarkerStatesHoverAnimation  : PlotOptionsSeries
	{
		Hashtable h = new Hashtable();

		public PlotOptionsAreasplinerangeStatesSelectMarkerStatesHoverAnimation()
		{
