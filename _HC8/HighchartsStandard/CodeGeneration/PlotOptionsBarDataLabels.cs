...
namespace Highsoft.Web.Mvc.Charts
{
	public partial class PlotOptionsBarDataLabels  : BaseObject
	{
		...
		{
			Align = Align_DefaultValue = PlotOptionsBarDataLabelsAlign.Center;
			...
			Filter = Filter_DefaultValue = new PlotOptionsBarDataLabelsFilter();
			...
			Style = Style_DefaultValue = new PlotOptionsBarDataLabelsStyle();
			TextPath = TextPath_DefaultValue = new PlotOptionsBarDataLabelsTextPath();
			UseHTML = UseHTML_DefaultValue = false;
			VerticalAlign = VerticalAlign_DefaultValue = PlotOptionsBarDataLabelsVerticalAlign.Bottom;
			X = X_DefaultValue = 0;
			Y = Y_DefaultValue = 0;
			Z = Z_DefaultValue = 6;
		...
		/// </summary>
		public PlotOptionsBarDataLabelsFilter Filter { get; set; }
		private PlotOptionsBarDataLabelsFilter Filter_DefaultValue { get; set; }
		...
		/// </summary>
		public PlotOptionsBarDataLabelsStyle Style { get; set; }
		private PlotOptionsBarDataLabelsStyle Style_DefaultValue { get; set; }
		...
		/// </summary>
		public PlotOptionsBarDataLabelsTextPath TextPath { get; set; }
		private PlotOptionsBarDataLabelsTextPath TextPath_DefaultValue { get; set; }
		...
		internal override Hashtable ToHashtable()
		{
			...
			if (Formatter != Formatter_DefaultValue) { h.Add("formatter",Formatter); Highcharts.AddFunction("0fcde71a-1645-4d31-a57f-ffc1bf246e62.formatter", Formatter); }  
			...
			if (NullFormatter != NullFormatter_DefaultValue) { h.Add("nullFormatter",NullFormatter); Highcharts.AddFunction("784a82c8-7328-4af3-9ea5-16559e19ce6e.nullFormatter", NullFormatter); }  
