...
namespace Highsoft.Web.Mvc.Charts
{
	public partial class PlotOptionsBarDragDropDragHandle  : BaseObject
	{
		...
		internal override Hashtable ToHashtable()
		{
			...
			if (PathFormatter != PathFormatter_DefaultValue) { h.Add("pathFormatter",PathFormatter); Highcharts.AddFunction("068b953f-cbc7-45e5-9cd2-79c637840774.pathFormatter", PathFormatter); }  
