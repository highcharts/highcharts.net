...
namespace Highsoft.Web.Mvc.Charts
{
	public partial class PlotOptionsBarDragDropDragHandle  : BaseObject
	{
		...
		internal override Hashtable ToHashtable()
		{
			...
			if (PathFormatter != PathFormatter_DefaultValue) { h.Add("pathFormatter",PathFormatter); Highcharts.AddFunction("6011d6a1-2521-46bf-b1cc-97063712d35b.pathFormatter", PathFormatter); }  
