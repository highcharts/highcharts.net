...
{
	public partial class PlotOptionsBarOnPoint  : BaseObject
	{
		Hashtable h = new Hashtable();

		public PlotOptionsBarOnPoint()
		{
			ConnectorOptions = ConnectorOptions_DefaultValue = new PlotOptionsBarOnPointConnectorOptions();
			Id = Id_DefaultValue = "";
			Position = Position_DefaultValue = new PlotOptionsBarOnPointPosition();
		...
		/// </summary>
		public PlotOptionsBarOnPointConnectorOptions ConnectorOptions { get; set; }
		private PlotOptionsBarOnPointConnectorOptions ConnectorOptions_DefaultValue { get; set; }
		...
		/// </summary>
		public PlotOptionsBarOnPointPosition Position { get; set; }
		private PlotOptionsBarOnPointPosition Position_DefaultValue { get; set; }
