...
namespace Highsoft.Web.Mvc.Charts
{
	public partial class PlotOptionsBarSonification  : BaseObject
	{
		...
		{
			ContextTracks = ContextTracks_DefaultValue = new PlotOptionsBarSonificationContextTracks();
			DefaultInstrumentOptions = DefaultInstrumentOptions_DefaultValue = new PlotOptionsBarSonificationDefaultInstrumentOptions();
			DefaultSpeechOptions = DefaultSpeechOptions_DefaultValue = new PlotOptionsBarSonificationDefaultSpeechOptions();
			Enabled = Enabled_DefaultValue = true;
			PointGrouping = PointGrouping_DefaultValue = new PlotOptionsBarSonificationPointGrouping();
			Tracks = Tracks_DefaultValue = new PlotOptionsBarSonificationTracks();
		...
		private PlotOptionsBarSonificationContextTracks ContextTracks_DefaultValue { get; set; }
		...
		private PlotOptionsBarSonificationDefaultInstrumentOptions DefaultInstrumentOptions_DefaultValue { get; set; }
		...
		private PlotOptionsBarSonificationDefaultSpeechOptions DefaultSpeechOptions_DefaultValue { get; set; }
		...
		private PlotOptionsBarSonificationPointGrouping PointGrouping_DefaultValue { get; set; }
		...
		private PlotOptionsBarSonificationTracks Tracks_DefaultValue { get; set; }
