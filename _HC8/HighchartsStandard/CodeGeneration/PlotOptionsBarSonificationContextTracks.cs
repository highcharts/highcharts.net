...
{
	public partial class PlotOptionsBarSonificationContextTracks  : BaseObject
	{
		Hashtable h = new Hashtable();

		public PlotOptionsBarSonificationContextTracks()
		{
			ActiveWhen = ActiveWhen_DefaultValue = new PlotOptionsBarSonificationContextTracksActiveWhen();
			Instrument = Instrument_DefaultValue = null;
			InstrumentString = InstrumentString_DefaultValue = "null";
			Mapping = Mapping_DefaultValue = new PlotOptionsBarSonificationContextTracksMapping();
			MidiName = MidiName_DefaultValue = "";
			PointGrouping = PointGrouping_DefaultValue = new PlotOptionsBarSonificationContextTracksPointGrouping();
			...
			Type = Type_DefaultValue = PlotOptionsBarSonificationContextTracksType.Instrument;
			ValueInterval = ValueInterval_DefaultValue = null;
			ValueMapFunction = ValueMapFunction_DefaultValue = PlotOptionsBarSonificationContextTracksValueMapFunction.Linear;
		...
		/// </summary>
		public PlotOptionsBarSonificationContextTracksActiveWhen ActiveWhen { get; set; }
		private PlotOptionsBarSonificationContextTracksActiveWhen ActiveWhen_DefaultValue { get; set; }
		...
		/// </summary>
		public PlotOptionsBarSonificationContextTracksMapping Mapping { get; set; }
		private PlotOptionsBarSonificationContextTracksMapping Mapping_DefaultValue { get; set; }
		...
		/// </summary>
		public PlotOptionsBarSonificationContextTracksPointGrouping PointGrouping { get; set; }
		private PlotOptionsBarSonificationContextTracksPointGrouping PointGrouping_DefaultValue { get; set; }
		...
		/// </summary>
		public PlotOptionsBarSonificationContextTracksType Type { get; set; }
		private PlotOptionsBarSonificationContextTracksType Type_DefaultValue { get; set; }
		...
		/// </summary>
		public PlotOptionsBarSonificationContextTracksValueMapFunction ValueMapFunction { get; set; }
		private PlotOptionsBarSonificationContextTracksValueMapFunction ValueMapFunction_DefaultValue { get; set; }
