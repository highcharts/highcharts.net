...
{
	public partial class PlotOptionsBarStatesHoverMarker  : PlotOptionsSeries
	{
		...
		public PlotOptionsBarStatesHoverMarker()
		{
			...
			States = States_DefaultValue = new PlotOptionsBarStatesHoverMarkerStates();
		...
		/// </summary>
		public PlotOptionsBarStatesHoverMarkerStates States { get; set; }
		private PlotOptionsBarStatesHoverMarkerStates States_DefaultValue { get; set; }
