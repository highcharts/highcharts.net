...
{
	public partial class PlotOptionsBarStatesSelect  : PlotOptionsSeries
	{
		Hashtable h = new Hashtable();

		public PlotOptionsBarStatesSelect()
		{
			Animation = Animation_DefaultValue = new Animation();
			Enabled = Enabled_DefaultValue = null;
			Halo = Halo_DefaultValue = new PlotOptionsBarStatesSelectHalo();
			LineWidth = LineWidth_DefaultValue = null;
			LineWidthPlus = LineWidthPlus_DefaultValue = null;
			Marker = Marker_DefaultValue = new PlotOptionsBarStatesSelectMarker();
		...
		/// </summary>
		public PlotOptionsBarStatesSelectHalo Halo { get; set; }
		private PlotOptionsBarStatesSelectHalo Halo_DefaultValue { get; set; }
		...
		/// </summary>
		public PlotOptionsBarStatesSelectMarker Marker { get; set; }
		private PlotOptionsBarStatesSelectMarker Marker_DefaultValue { get; set; }
