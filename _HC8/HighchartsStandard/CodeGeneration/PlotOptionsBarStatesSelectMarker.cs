...
{
	public partial class PlotOptionsBarStatesSelectMarker  : PlotOptionsSeries
	{
		Hashtable h = new Hashtable();

		public PlotOptionsBarStatesSelectMarker()
		{
			...
			States = States_DefaultValue = new PlotOptionsBarStatesSelectMarkerStates();
		...
		/// </summary>
		public PlotOptionsBarStatesSelectMarkerStates States { get; set; }
		private PlotOptionsBarStatesSelectMarkerStates States_DefaultValue { get; set; }
