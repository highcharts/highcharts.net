...
{
	public partial class PlotOptionsBarStatesSelectMarkerStatesHoverAnimation  : PlotOptionsSeries
	{
		Hashtable h = new Hashtable();

		public PlotOptionsBarStatesSelectMarkerStatesHoverAnimation()
		{
