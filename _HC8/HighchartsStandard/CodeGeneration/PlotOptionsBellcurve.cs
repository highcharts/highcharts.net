...
namespace Highsoft.Web.Mvc.Charts
{
	public partial class PlotOptionsBellcurve  : BaseObject
	{
		...
		{
			Accessibility = Accessibility_DefaultValue = new PlotOptionsBellcurveAccessibility();
			AllowPointSelect = AllowPointSelect_DefaultValue = false;
			Animation = Animation_DefaultValue = new Animation() { Enabled = true };
			AnimationLimit = AnimationLimit_DefaultValue = null;
			BoostBlending = BoostBlending_DefaultValue = PlotOptionsBellcurveBoostBlending.Undefined;
			...
			Cursor = Cursor_DefaultValue = PlotOptionsBellcurveCursor.Null;
			Custom = Custom_DefaultValue = new Hashtable();
			DashStyle = DashStyle_DefaultValue = PlotOptionsBellcurveDashStyle.Null;
			DataLabels = DataLabels_DefaultValue = new PlotOptionsBellcurveDataLabels();
			DataSorting = DataSorting_DefaultValue = new PlotOptionsBellcurveDataSorting();
			Description = Description_DefaultValue = "";
			EnableMouseTracking = EnableMouseTracking_DefaultValue = true;
			Events = Events_DefaultValue = new PlotOptionsBellcurveEvents();
			...
			States = States_DefaultValue = new PlotOptionsBellcurveStates();
			Step = Step_DefaultValue = PlotOptionsBellcurveStep.Null;
		...
		private PlotOptionsBellcurveAccessibility Accessibility_DefaultValue { get; set; }
		...
		/// </summary>
		public PlotOptionsBellcurveBoostBlending BoostBlending { get; set; }
		private PlotOptionsBellcurveBoostBlending BoostBlending_DefaultValue { get; set; }
		...
		private PlotOptionsBellcurveCursor Cursor_DefaultValue { get; set; }
		...
		private PlotOptionsBellcurveDashStyle DashStyle_DefaultValue { get; set; }
		...
		private PlotOptionsBellcurveDataLabels DataLabels_DefaultValue { get; set; }
		...
		private PlotOptionsBellcurveDataSorting DataSorting_DefaultValue { get; set; }
		...
		private PlotOptionsBellcurveEvents Events_DefaultValue { get; set; }
		...
		private PlotOptionsBellcurveFindNearestPointBy FindNearestPointBy_DefaultValue { get; set; }
		...
		private PlotOptionsBellcurveLabel Label_DefaultValue { get; set; }
		...
		private PlotOptionsBellcurveLinecap Linecap_DefaultValue { get; set; }
		...
		private PlotOptionsBellcurvePoint Point_DefaultValue { get; set; }
		...
		private PlotOptionsBellcurveStates States_DefaultValue { get; set; }
		 

		/// <summary>
		/// Whether to apply steps to the line. Possible values are `left`,`center` and `right`.
		/// </summary>
		public PlotOptionsBellcurveStep Step { get; set; }
		private PlotOptionsBellcurveStep Step_DefaultValue { get; set; }
		...
		private PlotOptionsBellcurveTooltip Tooltip_DefaultValue { get; set; }
		...
		private List<PlotOptionsBellcurveZone> Zones_DefaultValue { get; set; }
		...
		internal override Hashtable ToHashtable()
		{
			...
			if (PointDescriptionFormatter != PointDescriptionFormatter_DefaultValue) { h.Add("pointDescriptionFormatter",PointDescriptionFormatter); Highcharts.AddFunction("9de8052f-f3fa-4c75-b76f-9a4da99d2e3c.pointDescriptionFormatter", PointDescriptionFormatter); }  
