...
namespace Highsoft.Web.Mvc.Charts
{
	public partial class PlotOptionsBellcurve  : BaseObject
	{
		...
		internal override Hashtable ToHashtable()
		{
			...
			if (PointDescriptionFormatter != PointDescriptionFormatter_DefaultValue) { h.Add("pointDescriptionFormatter",PointDescriptionFormatter); Highcharts.AddFunction("2b33006a-8201-4a84-8816-6e9ff22cf6ae.pointDescriptionFormatter", PointDescriptionFormatter); }  
