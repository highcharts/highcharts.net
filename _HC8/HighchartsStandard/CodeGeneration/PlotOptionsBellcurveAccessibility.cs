...
namespace Highsoft.Web.Mvc.Charts
{
	public partial class PlotOptionsBellcurveAccessibility  : BaseObject
	{
		...
		internal override Hashtable ToHashtable()
		{
			...
			if (PointDescriptionFormatter != PointDescriptionFormatter_DefaultValue) { h.Add("pointDescriptionFormatter",PointDescriptionFormatter); Highcharts.AddFunction("dbcd88c1-1a1d-4a24-8b9f-c201e4067737.pointDescriptionFormatter", PointDescriptionFormatter); }  
