...
{
	public partial class PlotOptionsBellcurveAccessibility  : PlotOptionsSeries
	{
		...
		public PlotOptionsBellcurveAccessibility()
		{
			...
			Point = Point_DefaultValue = new PlotOptionsBellcurveAccessibilityPoint();
		...
		private PlotOptionsBellcurveAccessibilityPoint Point_DefaultValue { get; set; }
