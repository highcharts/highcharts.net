...
namespace Highsoft.Web.Mvc.Charts
{
	public partial class PlotOptionsBellcurveDataLabels  : BaseObject
	{
		...
		public PlotOptionsBellcurveDataLabels()
		{
			...
			Overflow = Overflow_DefaultValue = PlotOptionsBellcurveDataLabelsOverflow.Justify;
			Padding = Padding_DefaultValue = 5;
			Position = Position_DefaultValue = PlotOptionsBellcurveDataLabelsPosition.Center;
