...
{
	public partial class PlotOptionsBellcurveDataLabels  : BaseObject
	{
		Hashtable h = new Hashtable();

		public PlotOptionsBellcurveDataLabels()
		{
			Align = Align_DefaultValue = PlotOptionsBellcurveDataLabelsAlign.Center;
			...
			Filter = Filter_DefaultValue = new PlotOptionsBellcurveDataLabelsFilter();
			...
			Style = Style_DefaultValue = new PlotOptionsBellcurveDataLabelsStyle();
			TextPath = TextPath_DefaultValue = new PlotOptionsBellcurveDataLabelsTextPath();
			UseHTML = UseHTML_DefaultValue = false;
			VerticalAlign = VerticalAlign_DefaultValue = PlotOptionsBellcurveDataLabelsVerticalAlign.Bottom;
			X = X_DefaultValue = 0;
			Y = Y_DefaultValue = 0;
			Z = Z_DefaultValue = 6;
		...
		/// </summary>
		public PlotOptionsBellcurveDataLabelsAlign Align { get; set; }
		private PlotOptionsBellcurveDataLabelsAlign Align_DefaultValue { get; set; }
		...
		/// </summary>
		public PlotOptionsBellcurveDataLabelsFilter Filter { get; set; }
		private PlotOptionsBellcurveDataLabelsFilter Filter_DefaultValue { get; set; }
		...
		/// </summary>
		public PlotOptionsBellcurveDataLabelsStyle Style { get; set; }
		private PlotOptionsBellcurveDataLabelsStyle Style_DefaultValue { get; set; }
		...
		/// </summary>
		public PlotOptionsBellcurveDataLabelsTextPath TextPath { get; set; }
		private PlotOptionsBellcurveDataLabelsTextPath TextPath_DefaultValue { get; set; }
		...
		/// </summary>
		public PlotOptionsBellcurveDataLabelsVerticalAlign VerticalAlign { get; set; }
		private PlotOptionsBellcurveDataLabelsVerticalAlign VerticalAlign_DefaultValue { get; set; }
		...
		internal override Hashtable ToHashtable()
		{
			...
			if (Formatter != Formatter_DefaultValue) { h.Add("formatter",Formatter); Highcharts.AddFunction("aa75defd-d93b-4b8e-989e-2f2bd90396ba.formatter", Formatter); }  
			if (Inside != Inside_DefaultValue) h.Add("inside",Inside);
			if (NullFormat != NullFormat_DefaultValue) h.Add("nullFormat",NullFormat);
			if (NullFormatter != NullFormatter_DefaultValue) { h.Add("nullFormatter",NullFormatter); Highcharts.AddFunction("feeee51e-0e4a-4702-a3d3-29881a57e3aa.nullFormatter", NullFormatter); }  
