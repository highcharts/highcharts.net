...
{
	public partial class PlotOptionsBellcurveMarker  : PlotOptionsSeries
	{
		...
		/// </summary>
		public PlotOptionsBellcurveMarkerStates States { get; set; }
		private PlotOptionsBellcurveMarkerStates States_DefaultValue { get; set; }
