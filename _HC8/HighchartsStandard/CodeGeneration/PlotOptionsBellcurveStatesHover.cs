...
{
	public partial class PlotOptionsBellcurveStatesHover  : PlotOptionsSeries
	{
		Hashtable h = new Hashtable();

		public PlotOptionsBellcurveStatesHover()
		{
			Animation = Animation_DefaultValue = new Animation();
			Enabled = Enabled_DefaultValue = null;
			Halo = Halo_DefaultValue = new PlotOptionsBellcurveStatesHoverHalo();
			LineWidth = LineWidth_DefaultValue = null;
			LineWidthPlus = LineWidthPlus_DefaultValue = null;
			Marker = Marker_DefaultValue = new PlotOptionsBellcurveStatesHoverMarker();
		...
		/// </summary>
		public PlotOptionsBellcurveStatesHoverHalo Halo { get; set; }
		private PlotOptionsBellcurveStatesHoverHalo Halo_DefaultValue { get; set; }
		...
		/// </summary>
		public PlotOptionsBellcurveStatesHoverMarker Marker { get; set; }
		private PlotOptionsBellcurveStatesHoverMarker Marker_DefaultValue { get; set; }
