...
{
	public partial class PlotOptionsBellcurveStatesHoverMarker  : PlotOptionsSeries
	{
		Hashtable h = new Hashtable();

		public PlotOptionsBellcurveStatesHoverMarker()
		{
			...
			States = States_DefaultValue = new PlotOptionsBellcurveStatesHoverMarkerStates();
		...
		/// </summary>
		public PlotOptionsBellcurveStatesHoverMarkerStates States { get; set; }
		private PlotOptionsBellcurveStatesHoverMarkerStates States_DefaultValue { get; set; }
