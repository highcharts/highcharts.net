...
{
	public partial class PlotOptionsBellcurveStatesSelect  : PlotOptionsSeries
	{
		Hashtable h = new Hashtable();

		public PlotOptionsBellcurveStatesSelect()
		{
			Animation = Animation_DefaultValue = new Animation();
			Enabled = Enabled_DefaultValue = null;
			Halo = Halo_DefaultValue = new PlotOptionsBellcurveStatesSelectHalo();
			LineWidth = LineWidth_DefaultValue = null;
			LineWidthPlus = LineWidthPlus_DefaultValue = null;
			Marker = Marker_DefaultValue = new PlotOptionsBellcurveStatesSelectMarker();
		...
		/// </summary>
		public PlotOptionsBellcurveStatesSelectHalo Halo { get; set; }
		private PlotOptionsBellcurveStatesSelectHalo Halo_DefaultValue { get; set; }
		...
		/// </summary>
		public PlotOptionsBellcurveStatesSelectMarker Marker { get; set; }
		private PlotOptionsBellcurveStatesSelectMarker Marker_DefaultValue { get; set; }
