...
{
	public partial class PlotOptionsBellcurveStatesSelectMarker  : PlotOptionsSeries
	{
		Hashtable h = new Hashtable();

		public PlotOptionsBellcurveStatesSelectMarker()
		{
			...
			States = States_DefaultValue = new PlotOptionsBellcurveStatesSelectMarkerStates();
		...
		/// </summary>
		public PlotOptionsBellcurveStatesSelectMarkerStates States { get; set; }
		private PlotOptionsBellcurveStatesSelectMarkerStates States_DefaultValue { get; set; }
