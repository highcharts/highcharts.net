...
{
	public partial class PlotOptionsBellcurveStatesSelectMarkerStatesHoverAnimation  : PlotOptionsSeries
	{
		Hashtable h = new Hashtable();

		public PlotOptionsBellcurveStatesSelectMarkerStatesHoverAnimation()
		{
