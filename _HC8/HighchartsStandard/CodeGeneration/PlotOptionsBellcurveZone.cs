...
{
	public partial class PlotOptionsBellcurveZone  : PlotOptionsSeries
	{
		...
		/// </summary>
		public PlotOptionsBellcurveZonesDashStyle DashStyle { get; set; }
		private PlotOptionsBellcurveZonesDashStyle DashStyle_DefaultValue { get; set; }
