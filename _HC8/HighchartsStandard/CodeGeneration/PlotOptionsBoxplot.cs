...
namespace Highsoft.Web.Mvc.Charts
{
	public partial class PlotOptionsBoxplot  : BaseObject
	{
		...
		internal override Hashtable ToHashtable()
		{
			...
			if (PointDescriptionFormatter != PointDescriptionFormatter_DefaultValue) { h.Add("pointDescriptionFormatter",PointDescriptionFormatter); Highcharts.AddFunction("c494fa28-fc32-4648-a420-0ec58dc8cce8.pointDescriptionFormatter", PointDescriptionFormatter); }  
