...
namespace Highsoft.Web.Mvc.Charts
{
	public partial class PlotOptionsBoxplot  : BaseObject
	{
		...
		public PlotOptionsBoxplot()
		{
			...
			BoostBlending = BoostBlending_DefaultValue = PlotOptionsBoxplotBoostBlending.Undefined;
		...
		/// </summary>
		public PlotOptionsBoxplotBoostBlending BoostBlending { get; set; }
		private PlotOptionsBoxplotBoostBlending BoostBlending_DefaultValue { get; set; }
		...
		internal override Hashtable ToHashtable()
		{
			...
			if (PointDescriptionFormatter != PointDescriptionFormatter_DefaultValue) { h.Add("pointDescriptionFormatter",PointDescriptionFormatter); Highcharts.AddFunction("bd214e6d-a9b6-40a0-9ada-4fc61b233bc2.pointDescriptionFormatter", PointDescriptionFormatter); }  
			...
			if (Threshold.IsDirty()) h.Add("threshold",Threshold.ToHashtable());
