...
namespace Highsoft.Web.Mvc.Charts
{
	public partial class PlotOptionsBoxplot  : BaseObject
	{
		...
		internal override Hashtable ToHashtable()
		{
			...
			if (PointDescriptionFormatter != PointDescriptionFormatter_DefaultValue) { h.Add("pointDescriptionFormatter",PointDescriptionFormatter); Highcharts.AddFunction("57837f35-22a8-4bb2-95c4-5152ad03aa59.pointDescriptionFormatter", PointDescriptionFormatter); }  
