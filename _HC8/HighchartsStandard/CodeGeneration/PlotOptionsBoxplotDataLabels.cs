...
namespace Highsoft.Web.Mvc.Charts
{
	public partial class PlotOptionsBoxplotDataLabels  : BaseObject
	{
		...
		public PlotOptionsBoxplotDataLabels()
		{
			...
			Style = Style_DefaultValue = new PlotOptionsBoxplotDataLabelsStyle();
			TextPath = TextPath_DefaultValue = new PlotOptionsBoxplotDataLabelsTextPath();
		...
		/// </summary>
		public PlotOptionsBoxplotDataLabelsStyle Style { get; set; }
		private PlotOptionsBoxplotDataLabelsStyle Style_DefaultValue { get; set; }
		...
		/// </summary>
		public PlotOptionsBoxplotDataLabelsTextPath TextPath { get; set; }
		private PlotOptionsBoxplotDataLabelsTextPath TextPath_DefaultValue { get; set; }
		...
		internal override Hashtable ToHashtable()
		{
			...
			if (Formatter != Formatter_DefaultValue) { h.Add("formatter",Formatter); Highcharts.AddFunction("7de35c6b-a193-44e4-97a9-391b7338e26e.formatter", Formatter); }  
			if (Inside != Inside_DefaultValue) h.Add("inside",Inside);
			if (NullFormat != NullFormat_DefaultValue) h.Add("nullFormat",NullFormat);
			if (NullFormatter != NullFormatter_DefaultValue) { h.Add("nullFormatter",NullFormatter); Highcharts.AddFunction("e46e6809-876b-4dd3-b85b-0df712c95226.nullFormatter", NullFormatter); }  
