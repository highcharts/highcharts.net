...
namespace Highsoft.Web.Mvc.Charts
{
	public partial class PlotOptionsBoxplotDragDropDragHandle  : BaseObject
	{
		...
		internal override Hashtable ToHashtable()
		{
			...
			if (PathFormatter != PathFormatter_DefaultValue) { h.Add("pathFormatter",PathFormatter); Highcharts.AddFunction("12415915-1406-4b37-91c1-62d5ca4114d0.pathFormatter", PathFormatter); }  
