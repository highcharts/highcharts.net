...
namespace Highsoft.Web.Mvc.Charts
{
	public partial class PlotOptionsBoxplotDragDropDragHandle  : BaseObject
	{
		...
		internal override Hashtable ToHashtable()
		{
			...
			if (PathFormatter != PathFormatter_DefaultValue) { h.Add("pathFormatter",PathFormatter); Highcharts.AddFunction("be7b0c7c-6ca2-4677-8a30-3e52cad187fd.pathFormatter", PathFormatter); }  
