...
{
	public partial class PlotOptionsBoxplotOnPoint  : BaseObject
	{
		Hashtable h = new Hashtable();

		public PlotOptionsBoxplotOnPoint()
		{
			ConnectorOptions = ConnectorOptions_DefaultValue = new PlotOptionsBoxplotOnPointConnectorOptions();
			Id = Id_DefaultValue = "";
			Position = Position_DefaultValue = new PlotOptionsBoxplotOnPointPosition();
		...
		/// </summary>
		public PlotOptionsBoxplotOnPointConnectorOptions ConnectorOptions { get; set; }
		private PlotOptionsBoxplotOnPointConnectorOptions ConnectorOptions_DefaultValue { get; set; }
		...
		/// </summary>
		public PlotOptionsBoxplotOnPointPosition Position { get; set; }
		private PlotOptionsBoxplotOnPointPosition Position_DefaultValue { get; set; }
