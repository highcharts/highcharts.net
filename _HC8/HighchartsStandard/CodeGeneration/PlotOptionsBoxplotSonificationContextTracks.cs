...
{
	public partial class PlotOptionsBoxplotSonificationContextTracks  : BaseObject
	{
		Hashtable h = new Hashtable();

		public PlotOptionsBoxplotSonificationContextTracks()
		{
			ActiveWhen = ActiveWhen_DefaultValue = new PlotOptionsBoxplotSonificationContextTracksActiveWhen();
			Instrument = Instrument_DefaultValue = null;
			InstrumentString = InstrumentString_DefaultValue = "null";
			Mapping = Mapping_DefaultValue = new PlotOptionsBoxplotSonificationContextTracksMapping();
			MidiName = MidiName_DefaultValue = "";
			PointGrouping = PointGrouping_DefaultValue = new PlotOptionsBoxplotSonificationContextTracksPointGrouping();
			...
			Type = Type_DefaultValue = PlotOptionsBoxplotSonificationContextTracksType.Instrument;
			ValueInterval = ValueInterval_DefaultValue = null;
			ValueMapFunction = ValueMapFunction_DefaultValue = PlotOptionsBoxplotSonificationContextTracksValueMapFunction.Linear;
		...
		/// </summary>
		public PlotOptionsBoxplotSonificationContextTracksActiveWhen ActiveWhen { get; set; }
		private PlotOptionsBoxplotSonificationContextTracksActiveWhen ActiveWhen_DefaultValue { get; set; }
		...
		/// </summary>
		public PlotOptionsBoxplotSonificationContextTracksMapping Mapping { get; set; }
		private PlotOptionsBoxplotSonificationContextTracksMapping Mapping_DefaultValue { get; set; }
		...
		/// </summary>
		public PlotOptionsBoxplotSonificationContextTracksPointGrouping PointGrouping { get; set; }
		private PlotOptionsBoxplotSonificationContextTracksPointGrouping PointGrouping_DefaultValue { get; set; }
		...
		/// </summary>
		public PlotOptionsBoxplotSonificationContextTracksType Type { get; set; }
		private PlotOptionsBoxplotSonificationContextTracksType Type_DefaultValue { get; set; }
		...
		/// </summary>
		public PlotOptionsBoxplotSonificationContextTracksValueMapFunction ValueMapFunction { get; set; }
		private PlotOptionsBoxplotSonificationContextTracksValueMapFunction ValueMapFunction_DefaultValue { get; set; }
