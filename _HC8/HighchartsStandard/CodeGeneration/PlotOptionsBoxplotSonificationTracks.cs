...
{
	public partial class PlotOptionsBoxplotSonificationTracks  : BaseObject
	{
		Hashtable h = new Hashtable();

		public PlotOptionsBoxplotSonificationTracks()
		{
			ActiveWhen = ActiveWhen_DefaultValue = new PlotOptionsBoxplotSonificationTracksActiveWhen();
			Instrument = Instrument_DefaultValue = null;
			InstrumentString = InstrumentString_DefaultValue = "null";
			Mapping = Mapping_DefaultValue = new PlotOptionsBoxplotSonificationTracksMapping();
			MidiName = MidiName_DefaultValue = "";
			PointGrouping = PointGrouping_DefaultValue = new PlotOptionsBoxplotSonificationTracksPointGrouping();
			RoundToMusicalNotes = RoundToMusicalNotes_DefaultValue = true;
			ShowPlayMarker = ShowPlayMarker_DefaultValue = true;
			Type = Type_DefaultValue = PlotOptionsBoxplotSonificationTracksType.Instrument;
		...
		/// </summary>
		public PlotOptionsBoxplotSonificationTracksActiveWhen ActiveWhen { get; set; }
		private PlotOptionsBoxplotSonificationTracksActiveWhen ActiveWhen_DefaultValue { get; set; }
		...
		/// </summary>
		public PlotOptionsBoxplotSonificationTracksMapping Mapping { get; set; }
		private PlotOptionsBoxplotSonificationTracksMapping Mapping_DefaultValue { get; set; }
		...
		/// </summary>
		public PlotOptionsBoxplotSonificationTracksPointGrouping PointGrouping { get; set; }
		private PlotOptionsBoxplotSonificationTracksPointGrouping PointGrouping_DefaultValue { get; set; }
		...
		/// </summary>
		public PlotOptionsBoxplotSonificationTracksType Type { get; set; }
		private PlotOptionsBoxplotSonificationTracksType Type_DefaultValue { get; set; }
