...
{
	public partial class PlotOptionsBoxplotStatesHover  : PlotOptionsSeries
	{
		...
		public PlotOptionsBoxplotStatesHover()
		{
			...
			Halo = Halo_DefaultValue = new PlotOptionsBoxplotStatesHoverHalo();
			LineWidth = LineWidth_DefaultValue = null;
			LineWidthPlus = LineWidthPlus_DefaultValue = null;
			Marker = Marker_DefaultValue = new PlotOptionsBoxplotStatesHoverMarker();
		...
		private PlotOptionsBoxplotStatesHoverMarker Marker_DefaultValue { get; set; }
