...
{
	public partial class PlotOptionsBoxplotStatesSelect  : PlotOptionsSeries
	{
		Hashtable h = new Hashtable();

		public PlotOptionsBoxplotStatesSelect()
		{
			Animation = Animation_DefaultValue = new Animation();
			Enabled = Enabled_DefaultValue = null;
			Halo = Halo_DefaultValue = new PlotOptionsBoxplotStatesSelectHalo();
			LineWidth = LineWidth_DefaultValue = null;
			LineWidthPlus = LineWidthPlus_DefaultValue = null;
			Marker = Marker_DefaultValue = new PlotOptionsBoxplotStatesSelectMarker();
		...
		/// </summary>
		public PlotOptionsBoxplotStatesSelectHalo Halo { get; set; }
		private PlotOptionsBoxplotStatesSelectHalo Halo_DefaultValue { get; set; }
		...
		/// </summary>
		public PlotOptionsBoxplotStatesSelectMarker Marker { get; set; }
		private PlotOptionsBoxplotStatesSelectMarker Marker_DefaultValue { get; set; }
