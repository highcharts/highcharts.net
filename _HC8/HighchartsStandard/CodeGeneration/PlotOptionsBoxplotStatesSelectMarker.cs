...
{
	public partial class PlotOptionsBoxplotStatesSelectMarker  : PlotOptionsSeries
	{
		Hashtable h = new Hashtable();

		public PlotOptionsBoxplotStatesSelectMarker()
		{
			...
			States = States_DefaultValue = new PlotOptionsBoxplotStatesSelectMarkerStates();
		...
		/// </summary>
		public PlotOptionsBoxplotStatesSelectMarkerStates States { get; set; }
		private PlotOptionsBoxplotStatesSelectMarkerStates States_DefaultValue { get; set; }
