...
{
	public partial class PlotOptionsBoxplotStatesSelectMarkerStatesHoverAnimation  : PlotOptionsSeries
	{
		Hashtable h = new Hashtable();

		public PlotOptionsBoxplotStatesSelectMarkerStatesHoverAnimation()
		{
