...
namespace Highsoft.Web.Mvc.Charts
{
	public partial class PlotOptionsBubble  : BaseObject
	{
		...
		internal override Hashtable ToHashtable()
		{
			...
			if (PointDescriptionFormatter != PointDescriptionFormatter_DefaultValue) { h.Add("pointDescriptionFormatter",PointDescriptionFormatter); Highcharts.AddFunction("93f396b5-7d46-42d9-8059-263224ef84ee.pointDescriptionFormatter", PointDescriptionFormatter); }  
