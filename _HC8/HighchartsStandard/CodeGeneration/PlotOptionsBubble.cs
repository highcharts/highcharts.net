...
namespace Highsoft.Web.Mvc.Charts
{
	public partial class PlotOptionsBubble  : BaseObject
	{
		...
		internal override Hashtable ToHashtable()
		{
			...
			if (PointDescriptionFormatter != PointDescriptionFormatter_DefaultValue) { h.Add("pointDescriptionFormatter",PointDescriptionFormatter); Highcharts.AddFunction("35e6799c-e52b-4785-9eb1-1dab0cc95bba.pointDescriptionFormatter", PointDescriptionFormatter); }  
