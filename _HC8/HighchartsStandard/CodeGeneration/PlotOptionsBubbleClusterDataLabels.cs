...
namespace Highsoft.Web.Mvc.Charts
{
	public partial class PlotOptionsBubbleClusterDataLabels  : BaseObject
	{
		...
		public PlotOptionsBubbleClusterDataLabels()
		{
			...
			Style = Style_DefaultValue = new PlotOptionsBubbleClusterDataLabelsStyle();
		...
		/// 
		/// </summary>
		public PlotOptionsBubbleClusterDataLabelsStyle Style { get; set; }
		private PlotOptionsBubbleClusterDataLabelsStyle Style_DefaultValue { get; set; }
