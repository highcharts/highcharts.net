...
namespace Highsoft.Web.Mvc.Charts
{
	public partial class PlotOptionsBubbleDragDropDragHandle  : BaseObject
	{
		...
		internal override Hashtable ToHashtable()
		{
			...
			if (PathFormatter != PathFormatter_DefaultValue) { h.Add("pathFormatter",PathFormatter); Highcharts.AddFunction("d0e0ef4f-6d72-4501-9dc1-22d9df16a4f2.pathFormatter", PathFormatter); }  
