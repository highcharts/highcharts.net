...
{
	public partial class PlotOptionsBubbleStatesSelect  : PlotOptionsSeries
	{
		Hashtable h = new Hashtable();

		public PlotOptionsBubbleStatesSelect()
		{
			Animation = Animation_DefaultValue = new Animation();
			Enabled = Enabled_DefaultValue = null;
			Halo = Halo_DefaultValue = new PlotOptionsBubbleStatesSelectHalo();
			LineWidth = LineWidth_DefaultValue = null;
			LineWidthPlus = LineWidthPlus_DefaultValue = null;
			Marker = Marker_DefaultValue = new PlotOptionsBubbleStatesSelectMarker();
		...
		/// </summary>
		public PlotOptionsBubbleStatesSelectHalo Halo { get; set; }
		private PlotOptionsBubbleStatesSelectHalo Halo_DefaultValue { get; set; }
		...
		/// </summary>
		public PlotOptionsBubbleStatesSelectMarker Marker { get; set; }
		private PlotOptionsBubbleStatesSelectMarker Marker_DefaultValue { get; set; }
