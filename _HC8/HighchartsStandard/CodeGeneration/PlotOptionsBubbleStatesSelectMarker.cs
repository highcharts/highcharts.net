...
{
	public partial class PlotOptionsBubbleStatesSelectMarker  : PlotOptionsSeries
	{
		Hashtable h = new Hashtable();

		public PlotOptionsBubbleStatesSelectMarker()
		{
			...
			States = States_DefaultValue = new PlotOptionsBubbleStatesSelectMarkerStates();
		...
		/// </summary>
		public PlotOptionsBubbleStatesSelectMarkerStates States { get; set; }
		private PlotOptionsBubbleStatesSelectMarkerStates States_DefaultValue { get; set; }
