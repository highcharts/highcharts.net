...
{
	public partial class PlotOptionsBubbleStatesSelectMarkerStatesHoverAnimation  : PlotOptionsSeries
	{
		Hashtable h = new Hashtable();

		public PlotOptionsBubbleStatesSelectMarkerStatesHoverAnimation()
		{
