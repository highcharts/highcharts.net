...
namespace Highsoft.Web.Mvc.Charts
{
	public partial class PlotOptionsBullet  : BaseObject
	{
		...
		public PlotOptionsBullet()
		{
			...
			BoostBlending = BoostBlending_DefaultValue = PlotOptionsBulletBoostBlending.Undefined;
			...
			DataSorting = DataSorting_DefaultValue = new PlotOptionsBulletDataSorting();
		...
		/// </summary>
		public PlotOptionsBulletAccessibility Accessibility { get; set; }
		private PlotOptionsBulletAccessibility Accessibility_DefaultValue { get; set; }
		...
		/// </summary>
		public PlotOptionsBulletBoostBlending BoostBlending { get; set; }
		private PlotOptionsBulletBoostBlending BoostBlending_DefaultValue { get; set; }
		...
		/// </summary>
		public PlotOptionsBulletCursor Cursor { get; set; }
		private PlotOptionsBulletCursor Cursor_DefaultValue { get; set; }
		...
		/// </summary>
		public PlotOptionsBulletDashStyle DashStyle { get; set; }
		private PlotOptionsBulletDashStyle DashStyle_DefaultValue { get; set; }
		...
		/// </summary>
		public PlotOptionsBulletDataLabels DataLabels { get; set; }
		private PlotOptionsBulletDataLabels DataLabels_DefaultValue { get; set; }
		 

		/// <summary>
		/// Options for the series data sorting.
		/// </summary>
		public PlotOptionsBulletDataSorting DataSorting { get; set; }
		private PlotOptionsBulletDataSorting DataSorting_DefaultValue { get; set; }
		...
		/// 
		/// </summary>
		public PlotOptionsBulletDragDrop DragDrop { get; set; }
		private PlotOptionsBulletDragDrop DragDrop_DefaultValue { get; set; }
		...
		/// </summary>
		public PlotOptionsBulletEvents Events { get; set; }
		private PlotOptionsBulletEvents Events_DefaultValue { get; set; }
		...
		/// </summary>
		public PlotOptionsBulletFindNearestPointBy FindNearestPointBy { get; set; }
		private PlotOptionsBulletFindNearestPointBy FindNearestPointBy_DefaultValue { get; set; }
		...
		/// </summary>
		public PlotOptionsBulletLabel Label { get; set; }
		private PlotOptionsBulletLabel Label_DefaultValue { get; set; }
		...
		/// </summary>
		public PlotOptionsBulletPoint Point { get; set; }
		private PlotOptionsBulletPoint Point_DefaultValue { get; set; }
		...
		/// </summary>
		public PlotOptionsBulletPointIntervalUnit PointIntervalUnit { get; set; }
		private PlotOptionsBulletPointIntervalUnit PointIntervalUnit_DefaultValue { get; set; }
		...
		/// </summary>
		public PlotOptionsBulletStacking Stacking { get; set; }
		private PlotOptionsBulletStacking Stacking_DefaultValue { get; set; }
		 

		/// <summary>
		/// 
		/// </summary>
		public PlotOptionsBulletStates States { get; set; }
		private PlotOptionsBulletStates States_DefaultValue { get; set; }
		...
		/// </summary>
		public List<PlotOptionsBulletZone> Zones { get; set; }
		private List<PlotOptionsBulletZone> Zones_DefaultValue { get; set; }
		...
		internal override Hashtable ToHashtable()
		{
			...
			if (PointDescriptionFormatter != PointDescriptionFormatter_DefaultValue) { h.Add("pointDescriptionFormatter",PointDescriptionFormatter); Highcharts.AddFunction("3e2680f6-10f7-4d29-be49-45c32ad6396a.pointDescriptionFormatter", PointDescriptionFormatter); }  
