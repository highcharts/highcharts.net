...
namespace Highsoft.Web.Mvc.Charts
{
	public partial class PlotOptionsBullet  : BaseObject
	{
		...
		internal override Hashtable ToHashtable()
		{
			...
			if (PointDescriptionFormatter != PointDescriptionFormatter_DefaultValue) { h.Add("pointDescriptionFormatter",PointDescriptionFormatter); Highcharts.AddFunction("e3b2b186-56bf-4327-9b4e-c51eee3ff568.pointDescriptionFormatter", PointDescriptionFormatter); }  
