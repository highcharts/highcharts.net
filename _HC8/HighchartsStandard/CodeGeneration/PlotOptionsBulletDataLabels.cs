...
namespace Highsoft.Web.Mvc.Charts
{
	public partial class PlotOptionsBulletDataLabels  : BaseObject
	{
		...
		internal override Hashtable ToHashtable()
		{
			...
			if (Formatter != Formatter_DefaultValue) { h.Add("formatter",Formatter); Highcharts.AddFunction("269d255a-bf4d-4dcd-ab88-cad3f90deed7.formatter", Formatter); }  
			...
			if (NullFormatter != NullFormatter_DefaultValue) { h.Add("nullFormatter",NullFormatter); Highcharts.AddFunction("884deb44-cfdb-497b-8cef-9fedabb76bf1.nullFormatter", NullFormatter); }  
