...
{
	public partial class PlotOptionsBulletDataLabels  : BaseObject
	{
		Hashtable h = new Hashtable();

		public PlotOptionsBulletDataLabels()
		{
			Align = Align_DefaultValue = PlotOptionsBulletDataLabelsAlign.Center;
			...
			Filter = Filter_DefaultValue = new PlotOptionsBulletDataLabelsFilter();
			...
			Style = Style_DefaultValue = new PlotOptionsBulletDataLabelsStyle();
			TextPath = TextPath_DefaultValue = new PlotOptionsBulletDataLabelsTextPath();
			UseHTML = UseHTML_DefaultValue = false;
			VerticalAlign = VerticalAlign_DefaultValue = PlotOptionsBulletDataLabelsVerticalAlign.Bottom;
			X = X_DefaultValue = 0;
			Y = Y_DefaultValue = 0;
			Z = Z_DefaultValue = 6;
		...
		/// </summary>
		public PlotOptionsBulletDataLabelsAlign Align { get; set; }
		private PlotOptionsBulletDataLabelsAlign Align_DefaultValue { get; set; }
		...
		/// </summary>
		public PlotOptionsBulletDataLabelsFilter Filter { get; set; }
		private PlotOptionsBulletDataLabelsFilter Filter_DefaultValue { get; set; }
		...
		/// </summary>
		public PlotOptionsBulletDataLabelsStyle Style { get; set; }
		private PlotOptionsBulletDataLabelsStyle Style_DefaultValue { get; set; }
		...
		/// </summary>
		public PlotOptionsBulletDataLabelsTextPath TextPath { get; set; }
		private PlotOptionsBulletDataLabelsTextPath TextPath_DefaultValue { get; set; }
		...
		/// </summary>
		public PlotOptionsBulletDataLabelsVerticalAlign VerticalAlign { get; set; }
		private PlotOptionsBulletDataLabelsVerticalAlign VerticalAlign_DefaultValue { get; set; }
		...
		internal override Hashtable ToHashtable()
		{
			...
			if (Formatter != Formatter_DefaultValue) { h.Add("formatter",Formatter); Highcharts.AddFunction("259f5896-1548-4fec-8bf6-7e9d9812ca7f.formatter", Formatter); }  
			if (Inside != Inside_DefaultValue) h.Add("inside",Inside);
			if (NullFormat != NullFormat_DefaultValue) h.Add("nullFormat",NullFormat);
			if (NullFormatter != NullFormatter_DefaultValue) { h.Add("nullFormatter",NullFormatter); Highcharts.AddFunction("090433e9-c544-4de7-a7e6-ccfe3ccc789b.nullFormatter", NullFormatter); }  
