...
namespace Highsoft.Web.Mvc.Charts
{
	public partial class PlotOptionsBulletDragDropDragHandle  : BaseObject
	{
		...
		internal override Hashtable ToHashtable()
		{
			...
			if (PathFormatter != PathFormatter_DefaultValue) { h.Add("pathFormatter",PathFormatter); Highcharts.AddFunction("f017de46-bef9-425e-84b7-adc163403fe9.pathFormatter", PathFormatter); }  
