...
{
	public partial class PlotOptionsBulletOnPoint  : BaseObject
	{
		Hashtable h = new Hashtable();

		public PlotOptionsBulletOnPoint()
		{
			ConnectorOptions = ConnectorOptions_DefaultValue = new PlotOptionsBulletOnPointConnectorOptions();
			Id = Id_DefaultValue = "";
			Position = Position_DefaultValue = new PlotOptionsBulletOnPointPosition();
		...
		/// </summary>
		public PlotOptionsBulletOnPointConnectorOptions ConnectorOptions { get; set; }
		private PlotOptionsBulletOnPointConnectorOptions ConnectorOptions_DefaultValue { get; set; }
		...
		/// </summary>
		public PlotOptionsBulletOnPointPosition Position { get; set; }
		private PlotOptionsBulletOnPointPosition Position_DefaultValue { get; set; }
