...
{
	public partial class PlotOptionsBulletSonificationTracks  : BaseObject
	{
		Hashtable h = new Hashtable();

		public PlotOptionsBulletSonificationTracks()
		{
			ActiveWhen = ActiveWhen_DefaultValue = new PlotOptionsBulletSonificationTracksActiveWhen();
			Instrument = Instrument_DefaultValue = null;
			InstrumentString = InstrumentString_DefaultValue = "null";
			Mapping = Mapping_DefaultValue = new PlotOptionsBulletSonificationTracksMapping();
			MidiName = MidiName_DefaultValue = "";
			PointGrouping = PointGrouping_DefaultValue = new PlotOptionsBulletSonificationTracksPointGrouping();
			RoundToMusicalNotes = RoundToMusicalNotes_DefaultValue = true;
			ShowPlayMarker = ShowPlayMarker_DefaultValue = true;
			Type = Type_DefaultValue = PlotOptionsBulletSonificationTracksType.Instrument;
		...
		/// </summary>
		public PlotOptionsBulletSonificationTracksActiveWhen ActiveWhen { get; set; }
		private PlotOptionsBulletSonificationTracksActiveWhen ActiveWhen_DefaultValue { get; set; }
		...
		/// </summary>
		public PlotOptionsBulletSonificationTracksMapping Mapping { get; set; }
		private PlotOptionsBulletSonificationTracksMapping Mapping_DefaultValue { get; set; }
		...
		/// </summary>
		public PlotOptionsBulletSonificationTracksPointGrouping PointGrouping { get; set; }
		private PlotOptionsBulletSonificationTracksPointGrouping PointGrouping_DefaultValue { get; set; }
		...
		/// </summary>
		public PlotOptionsBulletSonificationTracksType Type { get; set; }
		private PlotOptionsBulletSonificationTracksType Type_DefaultValue { get; set; }
