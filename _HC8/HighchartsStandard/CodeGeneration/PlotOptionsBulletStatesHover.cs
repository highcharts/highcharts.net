...
{
	public partial class PlotOptionsBulletStatesHover  : PlotOptionsSeries
	{
		Hashtable h = new Hashtable();

		public PlotOptionsBulletStatesHover()
		{
			Animation = Animation_DefaultValue = new Animation();
			Enabled = Enabled_DefaultValue = null;
			Halo = Halo_DefaultValue = new PlotOptionsBulletStatesHoverHalo();
			LineWidth = LineWidth_DefaultValue = null;
			LineWidthPlus = LineWidthPlus_DefaultValue = null;
			Marker = Marker_DefaultValue = new PlotOptionsBulletStatesHoverMarker();
		...
		/// </summary>
		public PlotOptionsBulletStatesHoverHalo Halo { get; set; }
		private PlotOptionsBulletStatesHoverHalo Halo_DefaultValue { get; set; }
		...
		/// </summary>
		public PlotOptionsBulletStatesHoverMarker Marker { get; set; }
		private PlotOptionsBulletStatesHoverMarker Marker_DefaultValue { get; set; }
