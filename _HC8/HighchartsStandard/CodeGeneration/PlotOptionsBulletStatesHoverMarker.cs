...
{
	public partial class PlotOptionsBulletStatesHoverMarker  : PlotOptionsSeries
	{
		Hashtable h = new Hashtable();

		public PlotOptionsBulletStatesHoverMarker()
		{
			...
			States = States_DefaultValue = new PlotOptionsBulletStatesHoverMarkerStates();
		...
		/// </summary>
		public PlotOptionsBulletStatesHoverMarkerStates States { get; set; }
		private PlotOptionsBulletStatesHoverMarkerStates States_DefaultValue { get; set; }
