...
{
	public partial class PlotOptionsBulletStatesSelect  : PlotOptionsSeries
	{
		Hashtable h = new Hashtable();

		public PlotOptionsBulletStatesSelect()
		{
			Animation = Animation_DefaultValue = new Animation();
			Enabled = Enabled_DefaultValue = null;
			Halo = Halo_DefaultValue = new PlotOptionsBulletStatesSelectHalo();
			LineWidth = LineWidth_DefaultValue = null;
			LineWidthPlus = LineWidthPlus_DefaultValue = null;
			Marker = Marker_DefaultValue = new PlotOptionsBulletStatesSelectMarker();
		...
		/// </summary>
		public PlotOptionsBulletStatesSelectHalo Halo { get; set; }
		private PlotOptionsBulletStatesSelectHalo Halo_DefaultValue { get; set; }
		...
		/// </summary>
		public PlotOptionsBulletStatesSelectMarker Marker { get; set; }
		private PlotOptionsBulletStatesSelectMarker Marker_DefaultValue { get; set; }
