...
{
	public partial class PlotOptionsBulletStatesSelectMarker  : PlotOptionsSeries
	{
		Hashtable h = new Hashtable();

		public PlotOptionsBulletStatesSelectMarker()
		{
			...
			States = States_DefaultValue = new PlotOptionsBulletStatesSelectMarkerStates();
		...
		/// </summary>
		public PlotOptionsBulletStatesSelectMarkerStates States { get; set; }
		private PlotOptionsBulletStatesSelectMarkerStates States_DefaultValue { get; set; }
