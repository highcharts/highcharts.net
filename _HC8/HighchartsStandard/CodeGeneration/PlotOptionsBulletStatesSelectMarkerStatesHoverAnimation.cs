...
{
	public partial class PlotOptionsBulletStatesSelectMarkerStatesHoverAnimation  : PlotOptionsSeries
	{
		Hashtable h = new Hashtable();

		public PlotOptionsBulletStatesSelectMarkerStatesHoverAnimation()
		{
