...
namespace Highsoft.Web.Mvc.Charts
{
	public partial class PlotOptionsColumn  : BaseObject
	{
		...
		internal override Hashtable ToHashtable()
		{
			...
			if (PointDescriptionFormatter != PointDescriptionFormatter_DefaultValue) { h.Add("pointDescriptionFormatter",PointDescriptionFormatter); Highcharts.AddFunction("9174b16c-fa3b-493a-9ccb-656b21636821.pointDescriptionFormatter", PointDescriptionFormatter); }  
