...
namespace Highsoft.Web.Mvc.Charts
{
	public partial class PlotOptionsColumnDragDropDragHandle  : BaseObject
	{
		...
		internal override Hashtable ToHashtable()
		{
			...
			if (PathFormatter != PathFormatter_DefaultValue) { h.Add("pathFormatter",PathFormatter); Highcharts.AddFunction("fd292c10-0943-4eea-98be-9b7015e47419.pathFormatter", PathFormatter); }  
