...
namespace Highsoft.Web.Mvc.Charts
{
	public partial class PlotOptionsColumnDragDropDragHandle  : BaseObject
	{
		...
		internal override Hashtable ToHashtable()
		{
			...
			if (PathFormatter != PathFormatter_DefaultValue) { h.Add("pathFormatter",PathFormatter); Highcharts.AddFunction("40ac7154-f77e-4dd3-bd5b-3e6cb08ddda9.pathFormatter", PathFormatter); }  
