...
{
	public partial class PlotOptionsColumnOnPoint  : BaseObject
	{
		Hashtable h = new Hashtable();

		public PlotOptionsColumnOnPoint()
		{
			ConnectorOptions = ConnectorOptions_DefaultValue = new PlotOptionsColumnOnPointConnectorOptions();
			Id = Id_DefaultValue = "";
			Position = Position_DefaultValue = new PlotOptionsColumnOnPointPosition();
		...
		/// </summary>
		public PlotOptionsColumnOnPointConnectorOptions ConnectorOptions { get; set; }
		private PlotOptionsColumnOnPointConnectorOptions ConnectorOptions_DefaultValue { get; set; }
		...
		/// </summary>
		public PlotOptionsColumnOnPointPosition Position { get; set; }
		private PlotOptionsColumnOnPointPosition Position_DefaultValue { get; set; }
