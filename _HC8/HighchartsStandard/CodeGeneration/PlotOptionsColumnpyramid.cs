...
namespace Highsoft.Web.Mvc.Charts
{
	public partial class PlotOptionsColumnpyramid  : BaseObject
	{
		...
		internal override Hashtable ToHashtable()
		{
			...
			if (PointDescriptionFormatter != PointDescriptionFormatter_DefaultValue) { h.Add("pointDescriptionFormatter",PointDescriptionFormatter); Highcharts.AddFunction("a692f8b1-36da-4b36-b489-e1cd0b0b5796.pointDescriptionFormatter", PointDescriptionFormatter); }  
