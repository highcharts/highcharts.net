...
namespace Highsoft.Web.Mvc.Charts
{
	public partial class PlotOptionsColumnpyramidDataLabels  : BaseObject
	{
		...
		public PlotOptionsColumnpyramidDataLabels()
		{
			...
			Style = Style_DefaultValue = new PlotOptionsColumnpyramidDataLabelsStyle();
		...
		/// </summary>
		public PlotOptionsColumnpyramidDataLabelsStyle Style { get; set; }
		private PlotOptionsColumnpyramidDataLabelsStyle Style_DefaultValue { get; set; }
		...
		internal override Hashtable ToHashtable()
		{
			...
			if (Formatter != Formatter_DefaultValue) { h.Add("formatter",Formatter); Highcharts.AddFunction("e4968333-f95f-4537-8842-0efbc12000cc.formatter", Formatter); }  
			...
			if (NullFormatter != NullFormatter_DefaultValue) { h.Add("nullFormatter",NullFormatter); Highcharts.AddFunction("1914256a-bba0-4eda-a880-a53a9f33abd1.nullFormatter", NullFormatter); }  
