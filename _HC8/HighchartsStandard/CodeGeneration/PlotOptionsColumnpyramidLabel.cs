...
{
	public partial class PlotOptionsColumnpyramidLabel  : BaseObject
	{
		Hashtable h = new Hashtable();

		public PlotOptionsColumnpyramidLabel()
		{
			...
			Style = Style_DefaultValue = new PlotOptionsColumnpyramidLabelStyle();
		...
		/// </summary>
		public PlotOptionsColumnpyramidLabelStyle Style { get; set; }
		private PlotOptionsColumnpyramidLabelStyle Style_DefaultValue { get; set; }
		...
		internal override Hashtable ToHashtable()
		{
			...
			if (Formatter != Formatter_DefaultValue) { h.Add("formatter",Formatter); Highcharts.AddFunction("e1498700-9f1b-4662-b948-38750b575d96.formatter", Formatter); }  
