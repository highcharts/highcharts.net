...
namespace Highsoft.Web.Mvc.Charts
{
	public partial class PlotOptionsColumnpyramidSonificationTracksMappingTremolo  : BaseObject
	{
		...
		{
			Depth = Depth_DefaultValue = new PlotOptionsColumnpyramidSonificationTracksMappingTremoloDepth();
			Speed = Speed_DefaultValue = new PlotOptionsColumnpyramidSonificationTracksMappingTremoloSpeed();
		...
		private PlotOptionsColumnpyramidSonificationTracksMappingTremoloDepth Depth_DefaultValue { get; set; }
		...
		private PlotOptionsColumnpyramidSonificationTracksMappingTremoloSpeed Speed_DefaultValue { get; set; }
