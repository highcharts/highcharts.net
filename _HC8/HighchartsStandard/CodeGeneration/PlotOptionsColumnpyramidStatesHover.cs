...
{
	public partial class PlotOptionsColumnpyramidStatesHover  : PlotOptionsSeries
	{
		Hashtable h = new Hashtable();

		public PlotOptionsColumnpyramidStatesHover()
		{
			Animation = Animation_DefaultValue = new Animation();
			Enabled = Enabled_DefaultValue = null;
			Halo = Halo_DefaultValue = new PlotOptionsColumnpyramidStatesHoverHalo();
			LineWidth = LineWidth_DefaultValue = null;
			LineWidthPlus = LineWidthPlus_DefaultValue = null;
			Marker = Marker_DefaultValue = new PlotOptionsColumnpyramidStatesHoverMarker();
		...
		/// </summary>
		public PlotOptionsColumnpyramidStatesHoverHalo Halo { get; set; }
		private PlotOptionsColumnpyramidStatesHoverHalo Halo_DefaultValue { get; set; }
		...
		/// </summary>
		public PlotOptionsColumnpyramidStatesHoverMarker Marker { get; set; }
		private PlotOptionsColumnpyramidStatesHoverMarker Marker_DefaultValue { get; set; }
