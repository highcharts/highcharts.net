...
{
	public partial class PlotOptionsColumnpyramidStatesHoverMarker  : PlotOptionsSeries
	{
		Hashtable h = new Hashtable();

		public PlotOptionsColumnpyramidStatesHoverMarker()
		{
			...
			States = States_DefaultValue = new PlotOptionsColumnpyramidStatesHoverMarkerStates();
		...
		/// </summary>
		public PlotOptionsColumnpyramidStatesHoverMarkerStates States { get; set; }
		private PlotOptionsColumnpyramidStatesHoverMarkerStates States_DefaultValue { get; set; }
