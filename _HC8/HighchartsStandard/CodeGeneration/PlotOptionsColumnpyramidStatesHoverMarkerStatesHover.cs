...
{
	public partial class PlotOptionsColumnpyramidStatesHoverMarkerStatesHover  : PlotOptionsSeries
	{
		Hashtable h = new Hashtable();

		public PlotOptionsColumnpyramidStatesHoverMarkerStatesHover()
		{
