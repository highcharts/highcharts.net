...
{
	public partial class PlotOptionsColumnpyramidStatesHoverMarkerStatesSelect  : PlotOptionsSeries
	{
		Hashtable h = new Hashtable();

		public PlotOptionsColumnpyramidStatesHoverMarkerStatesSelect()
		{
