...
{
	public partial class PlotOptionsColumnpyramidStatesSelectMarker  : PlotOptionsSeries
	{
		Hashtable h = new Hashtable();

		public PlotOptionsColumnpyramidStatesSelectMarker()
		{
			...
			States = States_DefaultValue = new PlotOptionsColumnpyramidStatesSelectMarkerStates();
		...
		/// </summary>
		public PlotOptionsColumnpyramidStatesSelectMarkerStates States { get; set; }
		private PlotOptionsColumnpyramidStatesSelectMarkerStates States_DefaultValue { get; set; }
