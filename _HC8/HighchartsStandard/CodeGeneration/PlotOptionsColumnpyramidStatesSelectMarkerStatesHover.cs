...
{
	public partial class PlotOptionsColumnpyramidStatesSelectMarkerStatesHover  : PlotOptionsSeries
	{
		Hashtable h = new Hashtable();

		public PlotOptionsColumnpyramidStatesSelectMarkerStatesHover()
		{
