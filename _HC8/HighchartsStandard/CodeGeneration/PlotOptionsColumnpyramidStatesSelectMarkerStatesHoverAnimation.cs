...
{
	public partial class PlotOptionsColumnpyramidStatesSelectMarkerStatesHoverAnimation  : PlotOptionsSeries
	{
		Hashtable h = new Hashtable();

		public PlotOptionsColumnpyramidStatesSelectMarkerStatesHoverAnimation()
		{
