...
{
	public partial class PlotOptionsColumnpyramidStatesSelectMarkerStatesSelect  : PlotOptionsSeries
	{
		Hashtable h = new Hashtable();

		public PlotOptionsColumnpyramidStatesSelectMarkerStatesSelect()
		{
