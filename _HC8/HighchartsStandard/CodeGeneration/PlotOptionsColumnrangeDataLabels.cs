...
{
	public partial class PlotOptionsColumnrangeDataLabels  : BaseObject
	{
		Hashtable h = new Hashtable();

		public PlotOptionsColumnrangeDataLabels()
		{
			Align = Align_DefaultValue = PlotOptionsColumnrangeDataLabelsAlign.Center;
			...
			Filter = Filter_DefaultValue = new PlotOptionsColumnrangeDataLabelsFilter();
			...
			Style = Style_DefaultValue = new PlotOptionsColumnrangeDataLabelsStyle();
			TextPath = TextPath_DefaultValue = new PlotOptionsColumnrangeDataLabelsTextPath();
			UseHTML = UseHTML_DefaultValue = false;
			VerticalAlign = VerticalAlign_DefaultValue = PlotOptionsColumnrangeDataLabelsVerticalAlign.Bottom;
			X = X_DefaultValue = 0;
		...
		/// </summary>
		public PlotOptionsColumnrangeDataLabelsAlign Align { get; set; }
		private PlotOptionsColumnrangeDataLabelsAlign Align_DefaultValue { get; set; }
		...
		/// </summary>
		public PlotOptionsColumnrangeDataLabelsFilter Filter { get; set; }
		private PlotOptionsColumnrangeDataLabelsFilter Filter_DefaultValue { get; set; }
		...
		/// </summary>
		public PlotOptionsColumnrangeDataLabelsStyle Style { get; set; }
		private PlotOptionsColumnrangeDataLabelsStyle Style_DefaultValue { get; set; }
		...
		/// </summary>
		public PlotOptionsColumnrangeDataLabelsTextPath TextPath { get; set; }
		private PlotOptionsColumnrangeDataLabelsTextPath TextPath_DefaultValue { get; set; }
		...
		/// </summary>
		public PlotOptionsColumnrangeDataLabelsVerticalAlign VerticalAlign { get; set; }
		private PlotOptionsColumnrangeDataLabelsVerticalAlign VerticalAlign_DefaultValue { get; set; }
		...
		internal override Hashtable ToHashtable()
		{
			...
			if (Formatter != Formatter_DefaultValue) { h.Add("formatter",Formatter); Highcharts.AddFunction("3ed28ed3-f0ec-4d10-b227-883a8ff30861.formatter", Formatter); }  
			...
			if (NullFormatter != NullFormatter_DefaultValue) { h.Add("nullFormatter",NullFormatter); Highcharts.AddFunction("bd115d69-fdf9-45ff-a475-e31024b338b5.nullFormatter", NullFormatter); }  
