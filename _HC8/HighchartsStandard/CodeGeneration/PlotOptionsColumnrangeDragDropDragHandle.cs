...
namespace Highsoft.Web.Mvc.Charts
{
	public partial class PlotOptionsColumnrangeDragDropDragHandle  : BaseObject
	{
		...
		internal override Hashtable ToHashtable()
		{
			...
			if (PathFormatter != PathFormatter_DefaultValue) { h.Add("pathFormatter",PathFormatter); Highcharts.AddFunction("f3b647db-ce4e-42de-863d-9824c905e265.pathFormatter", PathFormatter); }  
