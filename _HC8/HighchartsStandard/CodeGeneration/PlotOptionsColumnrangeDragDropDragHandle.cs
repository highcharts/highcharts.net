...
namespace Highsoft.Web.Mvc.Charts
{
	public partial class PlotOptionsColumnrangeDragDropDragHandle  : BaseObject
	{
		...
		internal override Hashtable ToHashtable()
		{
			...
			if (PathFormatter != PathFormatter_DefaultValue) { h.Add("pathFormatter",PathFormatter); Highcharts.AddFunction("6c7f171d-efd8-4dda-afd0-77bc7279c232.pathFormatter", PathFormatter); }  
