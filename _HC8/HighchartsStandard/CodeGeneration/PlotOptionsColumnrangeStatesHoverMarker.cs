...
{
	public partial class PlotOptionsColumnrangeStatesHoverMarker  : PlotOptionsSeries
	{
		...
		public PlotOptionsColumnrangeStatesHoverMarker()
		{
			...
			States = States_DefaultValue = new PlotOptionsColumnrangeStatesHoverMarkerStates();
		...
		/// </summary>
		public PlotOptionsColumnrangeStatesHoverMarkerStates States { get; set; }
		private PlotOptionsColumnrangeStatesHoverMarkerStates States_DefaultValue { get; set; }
