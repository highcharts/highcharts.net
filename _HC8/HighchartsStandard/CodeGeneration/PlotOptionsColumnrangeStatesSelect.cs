...
{
	public partial class PlotOptionsColumnrangeStatesSelect  : PlotOptionsSeries
	{
		Hashtable h = new Hashtable();

		public PlotOptionsColumnrangeStatesSelect()
		{
			Animation = Animation_DefaultValue = new Animation();
			Enabled = Enabled_DefaultValue = null;
			Halo = Halo_DefaultValue = new PlotOptionsColumnrangeStatesSelectHalo();
			LineWidth = LineWidth_DefaultValue = null;
			LineWidthPlus = LineWidthPlus_DefaultValue = null;
			Marker = Marker_DefaultValue = new PlotOptionsColumnrangeStatesSelectMarker();
		...
		/// </summary>
		public PlotOptionsColumnrangeStatesSelectHalo Halo { get; set; }
		private PlotOptionsColumnrangeStatesSelectHalo Halo_DefaultValue { get; set; }
		...
		/// </summary>
		public PlotOptionsColumnrangeStatesSelectMarker Marker { get; set; }
		private PlotOptionsColumnrangeStatesSelectMarker Marker_DefaultValue { get; set; }
