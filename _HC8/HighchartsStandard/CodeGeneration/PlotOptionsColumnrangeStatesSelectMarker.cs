...
{
	public partial class PlotOptionsColumnrangeStatesSelectMarker  : PlotOptionsSeries
	{
		Hashtable h = new Hashtable();

		public PlotOptionsColumnrangeStatesSelectMarker()
		{
			...
			States = States_DefaultValue = new PlotOptionsColumnrangeStatesSelectMarkerStates();
		...
		/// </summary>
		public PlotOptionsColumnrangeStatesSelectMarkerStates States { get; set; }
		private PlotOptionsColumnrangeStatesSelectMarkerStates States_DefaultValue { get; set; }
