...
{
	public partial class PlotOptionsColumnrangeStatesSelectMarkerStatesHoverAnimation  : PlotOptionsSeries
	{
		Hashtable h = new Hashtable();

		public PlotOptionsColumnrangeStatesSelectMarkerStatesHoverAnimation()
		{
