...
{
	public partial class PlotOptionsColumnrangeStatesSelectMarkerStatesSelect  : PlotOptionsSeries
	{
		Hashtable h = new Hashtable();

		public PlotOptionsColumnrangeStatesSelectMarkerStatesSelect()
		{
