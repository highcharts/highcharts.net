...
namespace Highsoft.Web.Mvc.Charts
{
	public partial class PlotOptionsCylinder  : BaseObject
	{
		...
		internal override Hashtable ToHashtable()
		{
			...
			if (PointDescriptionFormatter != PointDescriptionFormatter_DefaultValue) { h.Add("pointDescriptionFormatter",PointDescriptionFormatter); Highcharts.AddFunction("61565e30-81a0-4bd3-90b3-d2cb84fc82aa.pointDescriptionFormatter", PointDescriptionFormatter); }  
