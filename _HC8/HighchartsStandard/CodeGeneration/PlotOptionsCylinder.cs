...
namespace Highsoft.Web.Mvc.Charts
{
	public partial class PlotOptionsCylinder  : BaseObject
	{
		...
		internal override Hashtable ToHashtable()
		{
			...
			if (PointDescriptionFormatter != PointDescriptionFormatter_DefaultValue) { h.Add("pointDescriptionFormatter",PointDescriptionFormatter); Highcharts.AddFunction("ac510d75-e34e-4c81-aae0-3636db3a3a5b.pointDescriptionFormatter", PointDescriptionFormatter); }  
