...
{
	public partial class PlotOptionsCylinder  : BaseObject
	{
		Hashtable h = new Hashtable();

		public PlotOptionsCylinder()
		{
			Accessibility = Accessibility_DefaultValue = new PlotOptionsCylinderAccessibility();
			AllowPointSelect = AllowPointSelect_DefaultValue = false;
			Animation = Animation_DefaultValue = new Animation() { Enabled = true };
			AnimationLimit = AnimationLimit_DefaultValue = null;
			BoostBlending = BoostBlending_DefaultValue = PlotOptionsCylinderBoostBlending.Undefined;
			...
			Cursor = Cursor_DefaultValue = PlotOptionsCylinderCursor.Null;
			Custom = Custom_DefaultValue = new Hashtable();
			DashStyle = DashStyle_DefaultValue = PlotOptionsCylinderDashStyle.Null;
			DataLabels = DataLabels_DefaultValue = new PlotOptionsCylinderDataLabels();
			DataSorting = DataSorting_DefaultValue = new PlotOptionsCylinderDataSorting();
			Depth = Depth_DefaultValue = 25;
			Description = Description_DefaultValue = "";
			DragDrop = DragDrop_DefaultValue = new PlotOptionsCylinderDragDrop();
			EdgeColor = EdgeColor_DefaultValue = "";
			EdgeWidth = EdgeWidth_DefaultValue = 1;
			EnableMouseTracking = EnableMouseTracking_DefaultValue = true;
			Events = Events_DefaultValue = new PlotOptionsCylinderEvents();
			FindNearestPointBy = FindNearestPointBy_DefaultValue = PlotOptionsCylinderFindNearestPointBy.X;
			...
			Label = Label_DefaultValue = new PlotOptionsCylinderLabel();
			LinkedTo = LinkedTo_DefaultValue = "";
			MaxPointWidth = MaxPointWidth_DefaultValue = null;
			MinPointLength = MinPointLength_DefaultValue = 0;
			NegativeColor = NegativeColor_DefaultValue = "";
			Opacity = Opacity_DefaultValue = 1;
			Point = Point_DefaultValue = new PlotOptionsCylinderPoint();
			PointDescriptionFormatter = PointDescriptionFormatter_DefaultValue = "";
			PointInterval = PointInterval_DefaultValue = 1;
			PointIntervalUnit = PointIntervalUnit_DefaultValue = PlotOptionsCylinderPointIntervalUnit.Null;
			...
			Stacking = Stacking_DefaultValue = PlotOptionsCylinderStacking.Null;
			States = States_DefaultValue = new PlotOptionsCylinderStates();
			StickyTracking = StickyTracking_DefaultValue = true;
			Threshold = Threshold_DefaultValue = 0;
			Tooltip = Tooltip_DefaultValue = new PlotOptionsCylinderTooltip();
			TurboThreshold = TurboThreshold_DefaultValue = 1000;
			Visible = Visible_DefaultValue = true;
			ZoneAxis = ZoneAxis_DefaultValue = "y";
			Zones = Zones_DefaultValue = new List<PlotOptionsCylinderZone>();
		...
		/// </summary>
		public PlotOptionsCylinderAccessibility Accessibility { get; set; }
		private PlotOptionsCylinderAccessibility Accessibility_DefaultValue { get; set; }
		...
		/// </summary>
		public PlotOptionsCylinderBoostBlending BoostBlending { get; set; }
		private PlotOptionsCylinderBoostBlending BoostBlending_DefaultValue { get; set; }
		...
		/// </summary>
		public PlotOptionsCylinderCursor Cursor { get; set; }
		private PlotOptionsCylinderCursor Cursor_DefaultValue { get; set; }
		...
		/// </summary>
		public PlotOptionsCylinderDashStyle DashStyle { get; set; }
		private PlotOptionsCylinderDashStyle DashStyle_DefaultValue { get; set; }
		...
		/// </summary>
		public PlotOptionsCylinderDataLabels DataLabels { get; set; }
		private PlotOptionsCylinderDataLabels DataLabels_DefaultValue { get; set; }
		 

		/// <summary>
		/// Options for the series data sorting.
		/// </summary>
		public PlotOptionsCylinderDataSorting DataSorting { get; set; }
		private PlotOptionsCylinderDataSorting DataSorting_DefaultValue { get; set; }
		...
		/// </summary>
		public PlotOptionsCylinderDragDrop DragDrop { get; set; }
		private PlotOptionsCylinderDragDrop DragDrop_DefaultValue { get; set; }
		...
		/// </summary>
		public PlotOptionsCylinderEvents Events { get; set; }
		private PlotOptionsCylinderEvents Events_DefaultValue { get; set; }
		...
		/// </summary>
		public PlotOptionsCylinderFindNearestPointBy FindNearestPointBy { get; set; }
		private PlotOptionsCylinderFindNearestPointBy FindNearestPointBy_DefaultValue { get; set; }
		...
		/// </summary>
		public PlotOptionsCylinderLabel Label { get; set; }
		private PlotOptionsCylinderLabel Label_DefaultValue { get; set; }
		...
		/// </summary>
		public PlotOptionsCylinderPoint Point { get; set; }
		private PlotOptionsCylinderPoint Point_DefaultValue { get; set; }
		...
		/// </summary>
		public PlotOptionsCylinderPointIntervalUnit PointIntervalUnit { get; set; }
		private PlotOptionsCylinderPointIntervalUnit PointIntervalUnit_DefaultValue { get; set; }
		...
		/// </summary>
		public PlotOptionsCylinderStacking Stacking { get; set; }
		private PlotOptionsCylinderStacking Stacking_DefaultValue { get; set; }
		 

		/// <summary>
		/// 
		/// </summary>
		public PlotOptionsCylinderStates States { get; set; }
		private PlotOptionsCylinderStates States_DefaultValue { get; set; }
		...
		/// </summary>
		public PlotOptionsCylinderTooltip Tooltip { get; set; }
		private PlotOptionsCylinderTooltip Tooltip_DefaultValue { get; set; }
		...
		/// </summary>
		public List<PlotOptionsCylinderZone> Zones { get; set; }
		private List<PlotOptionsCylinderZone> Zones_DefaultValue { get; set; }
		...
		internal override Hashtable ToHashtable()
		{
			...
			if (PointDescriptionFormatter != PointDescriptionFormatter_DefaultValue) { h.Add("pointDescriptionFormatter",PointDescriptionFormatter); Highcharts.AddFunction("54f084ed-99a5-46b7-9ba1-faecc651d1e8.pointDescriptionFormatter", PointDescriptionFormatter); }  
