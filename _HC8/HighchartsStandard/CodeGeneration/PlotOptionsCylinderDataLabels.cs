...
{
	public partial class PlotOptionsCylinderDataLabels  : BaseObject
	{
		Hashtable h = new Hashtable();

		public PlotOptionsCylinderDataLabels()
		{
			Align = Align_DefaultValue = PlotOptionsCylinderDataLabelsAlign.Center;
			...
			Filter = Filter_DefaultValue = new PlotOptionsCylinderDataLabelsFilter();
			...
			Style = Style_DefaultValue = new PlotOptionsCylinderDataLabelsStyle();
			TextPath = TextPath_DefaultValue = new PlotOptionsCylinderDataLabelsTextPath();
			UseHTML = UseHTML_DefaultValue = false;
			VerticalAlign = VerticalAlign_DefaultValue = PlotOptionsCylinderDataLabelsVerticalAlign.Bottom;
			X = X_DefaultValue = 0;
			Y = Y_DefaultValue = 0;
			Z = Z_DefaultValue = 6;
		...
		/// </summary>
		public PlotOptionsCylinderDataLabelsAlign Align { get; set; }
		private PlotOptionsCylinderDataLabelsAlign Align_DefaultValue { get; set; }
		...
		/// </summary>
		public PlotOptionsCylinderDataLabelsFilter Filter { get; set; }
		private PlotOptionsCylinderDataLabelsFilter Filter_DefaultValue { get; set; }
		...
		/// </summary>
		public PlotOptionsCylinderDataLabelsStyle Style { get; set; }
		private PlotOptionsCylinderDataLabelsStyle Style_DefaultValue { get; set; }
		...
		/// </summary>
		public PlotOptionsCylinderDataLabelsTextPath TextPath { get; set; }
		private PlotOptionsCylinderDataLabelsTextPath TextPath_DefaultValue { get; set; }
		...
		/// </summary>
		public PlotOptionsCylinderDataLabelsVerticalAlign VerticalAlign { get; set; }
		private PlotOptionsCylinderDataLabelsVerticalAlign VerticalAlign_DefaultValue { get; set; }
		...
		internal override Hashtable ToHashtable()
		{
			...
			if (Formatter != Formatter_DefaultValue) { h.Add("formatter",Formatter); Highcharts.AddFunction("f7038e0e-a8bb-4cec-805f-27f099e091db.formatter", Formatter); }  
			...
			if (NullFormatter != NullFormatter_DefaultValue) { h.Add("nullFormatter",NullFormatter); Highcharts.AddFunction("f734d8cb-21d6-4d9c-aa27-01eec77a8295.nullFormatter", NullFormatter); }  
