...
namespace Highsoft.Web.Mvc.Charts
{
	public partial class PlotOptionsCylinderDragDropDragHandle  : BaseObject
	{
		...
		internal override Hashtable ToHashtable()
		{
			...
			if (PathFormatter != PathFormatter_DefaultValue) { h.Add("pathFormatter",PathFormatter); Highcharts.AddFunction("bfb4436d-8139-4cf3-a850-f05f93f74533.pathFormatter", PathFormatter); }  
