...
{
	public partial class PlotOptionsCylinderOnPoint  : BaseObject
	{
		Hashtable h = new Hashtable();

		public PlotOptionsCylinderOnPoint()
		{
			ConnectorOptions = ConnectorOptions_DefaultValue = new PlotOptionsCylinderOnPointConnectorOptions();
			Id = Id_DefaultValue = "";
			Position = Position_DefaultValue = new PlotOptionsCylinderOnPointPosition();
		...
		/// </summary>
		public PlotOptionsCylinderOnPointConnectorOptions ConnectorOptions { get; set; }
		private PlotOptionsCylinderOnPointConnectorOptions ConnectorOptions_DefaultValue { get; set; }
		...
		/// </summary>
		public PlotOptionsCylinderOnPointPosition Position { get; set; }
		private PlotOptionsCylinderOnPointPosition Position_DefaultValue { get; set; }
