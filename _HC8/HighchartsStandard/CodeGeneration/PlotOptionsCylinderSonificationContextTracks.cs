...
{
	public partial class PlotOptionsCylinderSonificationContextTracks  : BaseObject
	{
		Hashtable h = new Hashtable();

		public PlotOptionsCylinderSonificationContextTracks()
		{
			ActiveWhen = ActiveWhen_DefaultValue = new PlotOptionsCylinderSonificationContextTracksActiveWhen();
			Instrument = Instrument_DefaultValue = null;
			InstrumentString = InstrumentString_DefaultValue = "null";
			Mapping = Mapping_DefaultValue = new PlotOptionsCylinderSonificationContextTracksMapping();
			MidiName = MidiName_DefaultValue = "";
			PointGrouping = PointGrouping_DefaultValue = new PlotOptionsCylinderSonificationContextTracksPointGrouping();
			...
			Type = Type_DefaultValue = PlotOptionsCylinderSonificationContextTracksType.Instrument;
			ValueInterval = ValueInterval_DefaultValue = null;
			ValueMapFunction = ValueMapFunction_DefaultValue = PlotOptionsCylinderSonificationContextTracksValueMapFunction.Linear;
		...
		/// </summary>
		public PlotOptionsCylinderSonificationContextTracksActiveWhen ActiveWhen { get; set; }
		private PlotOptionsCylinderSonificationContextTracksActiveWhen ActiveWhen_DefaultValue { get; set; }
		...
		/// </summary>
		public PlotOptionsCylinderSonificationContextTracksMapping Mapping { get; set; }
		private PlotOptionsCylinderSonificationContextTracksMapping Mapping_DefaultValue { get; set; }
		...
		/// </summary>
		public PlotOptionsCylinderSonificationContextTracksPointGrouping PointGrouping { get; set; }
		private PlotOptionsCylinderSonificationContextTracksPointGrouping PointGrouping_DefaultValue { get; set; }
		...
		/// </summary>
		public PlotOptionsCylinderSonificationContextTracksType Type { get; set; }
		private PlotOptionsCylinderSonificationContextTracksType Type_DefaultValue { get; set; }
		...
		/// </summary>
		public PlotOptionsCylinderSonificationContextTracksValueMapFunction ValueMapFunction { get; set; }
		private PlotOptionsCylinderSonificationContextTracksValueMapFunction ValueMapFunction_DefaultValue { get; set; }
