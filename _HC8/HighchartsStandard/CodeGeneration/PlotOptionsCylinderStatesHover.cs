...
{
	public partial class PlotOptionsCylinderStatesHover  : PlotOptionsSeries
	{
		Hashtable h = new Hashtable();

		public PlotOptionsCylinderStatesHover()
		{
			Animation = Animation_DefaultValue = new Animation();
			Enabled = Enabled_DefaultValue = null;
			Halo = Halo_DefaultValue = new PlotOptionsCylinderStatesHoverHalo();
			LineWidth = LineWidth_DefaultValue = null;
			LineWidthPlus = LineWidthPlus_DefaultValue = null;
			Marker = Marker_DefaultValue = new PlotOptionsCylinderStatesHoverMarker();
		...
		/// </summary>
		public PlotOptionsCylinderStatesHoverHalo Halo { get; set; }
		private PlotOptionsCylinderStatesHoverHalo Halo_DefaultValue { get; set; }
		...
		/// </summary>
		public PlotOptionsCylinderStatesHoverMarker Marker { get; set; }
		private PlotOptionsCylinderStatesHoverMarker Marker_DefaultValue { get; set; }
