...
{
	public partial class PlotOptionsCylinderStatesHoverMarker  : PlotOptionsSeries
	{
		Hashtable h = new Hashtable();

		public PlotOptionsCylinderStatesHoverMarker()
		{
			...
			States = States_DefaultValue = new PlotOptionsCylinderStatesHoverMarkerStates();
		...
		/// </summary>
		public PlotOptionsCylinderStatesHoverMarkerStates States { get; set; }
		private PlotOptionsCylinderStatesHoverMarkerStates States_DefaultValue { get; set; }
