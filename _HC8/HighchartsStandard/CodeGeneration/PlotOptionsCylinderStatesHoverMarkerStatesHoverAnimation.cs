...
{
	public partial class PlotOptionsCylinderStatesHoverMarkerStatesHoverAnimation  : PlotOptionsSeries
	{
		Hashtable h = new Hashtable();

		public PlotOptionsCylinderStatesHoverMarkerStatesHoverAnimation()
		{
