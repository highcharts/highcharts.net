...
{
	public partial class PlotOptionsCylinderStatesSelect  : PlotOptionsSeries
	{
		Hashtable h = new Hashtable();

		public PlotOptionsCylinderStatesSelect()
		{
			Animation = Animation_DefaultValue = new Animation();
			Enabled = Enabled_DefaultValue = null;
			Halo = Halo_DefaultValue = new PlotOptionsCylinderStatesSelectHalo();
			LineWidth = LineWidth_DefaultValue = null;
			LineWidthPlus = LineWidthPlus_DefaultValue = null;
			Marker = Marker_DefaultValue = new PlotOptionsCylinderStatesSelectMarker();
		...
		/// </summary>
		public PlotOptionsCylinderStatesSelectHalo Halo { get; set; }
		private PlotOptionsCylinderStatesSelectHalo Halo_DefaultValue { get; set; }
		...
		/// </summary>
		public PlotOptionsCylinderStatesSelectMarker Marker { get; set; }
		private PlotOptionsCylinderStatesSelectMarker Marker_DefaultValue { get; set; }
