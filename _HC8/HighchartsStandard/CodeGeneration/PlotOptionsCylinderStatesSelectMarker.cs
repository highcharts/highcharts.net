...
{
	public partial class PlotOptionsCylinderStatesSelectMarker  : PlotOptionsSeries
	{
		Hashtable h = new Hashtable();

		public PlotOptionsCylinderStatesSelectMarker()
		{
			...
			States = States_DefaultValue = new PlotOptionsCylinderStatesSelectMarkerStates();
		...
		/// </summary>
		public PlotOptionsCylinderStatesSelectMarkerStates States { get; set; }
		private PlotOptionsCylinderStatesSelectMarkerStates States_DefaultValue { get; set; }
