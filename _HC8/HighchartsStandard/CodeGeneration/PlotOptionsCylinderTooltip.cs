...
namespace Highsoft.Web.Mvc.Charts
{
	public partial class PlotOptionsCylinderTooltip  : BaseObject
	{
		...
		internal override Hashtable ToHashtable()
		{
			...
			if (NullFormatter != NullFormatter_DefaultValue) { h.Add("nullFormatter",NullFormatter); Highcharts.AddFunction("ee5a12d1-8917-4d88-a662-b909f18ede5a.nullFormatter", NullFormatter); }  
			if (PointFormat != PointFormat_DefaultValue) h.Add("pointFormat",PointFormat);
			if (PointFormatter != PointFormatter_DefaultValue) { h.Add("pointFormatter",PointFormatter); Highcharts.AddFunction("0b79d1b7-f04f-467c-829a-b3c45f1fe80c.pointFormatter", PointFormatter); }  
