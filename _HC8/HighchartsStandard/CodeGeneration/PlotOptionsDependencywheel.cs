...
namespace Highsoft.Web.Mvc.Charts
{
	public partial class PlotOptionsDependencywheel  : BaseObject
	{
		...
		internal override Hashtable ToHashtable()
		{
			...
			if (PointDescriptionFormatter != PointDescriptionFormatter_DefaultValue) { h.Add("pointDescriptionFormatter",PointDescriptionFormatter); Highcharts.AddFunction("fe38ccae-004b-473a-bc6d-b9a031442934.pointDescriptionFormatter", PointDescriptionFormatter); }  
