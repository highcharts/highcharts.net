...
namespace Highsoft.Web.Mvc.Charts
{
	public partial class PlotOptionsDependencywheel  : BaseObject
	{
		...
		public PlotOptionsDependencywheel()
		{
			...
			DataSorting = DataSorting_DefaultValue = new PlotOptionsDependencywheelDataSorting();
		...
		/// </summary>
		public PlotOptionsDependencywheelDataSorting DataSorting { get; set; }
		private PlotOptionsDependencywheelDataSorting DataSorting_DefaultValue { get; set; }
		...
		internal override Hashtable ToHashtable()
		{
			...
			if (PointDescriptionFormatter != PointDescriptionFormatter_DefaultValue) { h.Add("pointDescriptionFormatter",PointDescriptionFormatter); Highcharts.AddFunction("1829fd4f-e6a2-418e-9d29-57163ba8102c.pointDescriptionFormatter", PointDescriptionFormatter); }  
