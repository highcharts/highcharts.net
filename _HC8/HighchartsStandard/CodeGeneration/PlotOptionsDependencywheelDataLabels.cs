...
namespace Highsoft.Web.Mvc.Charts
{
	public partial class PlotOptionsDependencywheelDataLabels  : BaseObject
	{
		...
		{
			Align = Align_DefaultValue = PlotOptionsDependencywheelDataLabelsAlign.Center;
			...
			Style = Style_DefaultValue = new PlotOptionsDependencywheelDataLabelsStyle();
			TextPath = TextPath_DefaultValue = new PlotOptionsDependencywheelDataLabelsTextPath();
			UseHTML = UseHTML_DefaultValue = false;
			VerticalAlign = VerticalAlign_DefaultValue = PlotOptionsDependencywheelDataLabelsVerticalAlign.Bottom;
			X = X_DefaultValue = 0;
			Y = Y_DefaultValue = 0;
			Z = Z_DefaultValue = 6;
		...
		/// </summary>
		public PlotOptionsDependencywheelDataLabelsStyle Style { get; set; }
		private PlotOptionsDependencywheelDataLabelsStyle Style_DefaultValue { get; set; }
		...
		internal override Hashtable ToHashtable()
		{
			...
			if (Formatter != Formatter_DefaultValue) { h.Add("formatter",Formatter); Highcharts.AddFunction("6736e5fe-9a92-4b11-b258-c2de54d95717.formatter", Formatter); }  
			if (Inside != Inside_DefaultValue) h.Add("inside",Inside);
			if (NullFormat != NullFormat_DefaultValue) h.Add("nullFormat",NullFormat);
			if (NullFormatter != NullFormatter_DefaultValue) { h.Add("nullFormatter",NullFormatter); Highcharts.AddFunction("3092a3df-5aed-4ef5-a180-80d2ba128a5c.nullFormatter", NullFormatter); }  
