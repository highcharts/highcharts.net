...
namespace Highsoft.Web.Mvc.Charts
{
	public partial class PlotOptionsDependencywheelDataLabels  : BaseObject
	{
		...
		internal override Hashtable ToHashtable()
		{
			...
			if (Formatter != Formatter_DefaultValue) { h.Add("formatter",Formatter); Highcharts.AddFunction("641fb436-959c-4c7d-804c-12ce3fecdf48.formatter", Formatter); }  
			...
			if (NullFormatter != NullFormatter_DefaultValue) { h.Add("nullFormatter",NullFormatter); Highcharts.AddFunction("3f44780e-3a55-4677-a93d-abaa4ec729ed.nullFormatter", NullFormatter); }  
