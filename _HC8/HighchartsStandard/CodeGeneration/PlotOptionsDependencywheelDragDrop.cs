...
{
	public partial class PlotOptionsDependencywheelDragDrop  : BaseObject
	{
		Hashtable h = new Hashtable();

		public PlotOptionsDependencywheelDragDrop()
		{
			DraggableX = DraggableX_DefaultValue = null;
			DraggableY = DraggableY_DefaultValue = null;
			DragHandle = DragHandle_DefaultValue = new PlotOptionsDependencywheelDragDropDragHandle();
			...
			GuideBox = GuideBox_DefaultValue = new PlotOptionsDependencywheelDragDropGuideBox();
		...
		/// </summary>
		public PlotOptionsDependencywheelDragDropDragHandle DragHandle { get; set; }
		private PlotOptionsDependencywheelDragDropDragHandle DragHandle_DefaultValue { get; set; }
		...
		/// </summary>
		public PlotOptionsDependencywheelDragDropGuideBox GuideBox { get; set; }
		private PlotOptionsDependencywheelDragDropGuideBox GuideBox_DefaultValue { get; set; }
