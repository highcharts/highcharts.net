...
{
	public partial class PlotOptionsDependencywheelSonificationContextTracksActiveWhen  : BaseObject
	{
		Hashtable h = new Hashtable();

		public PlotOptionsDependencywheelSonificationContextTracksActiveWhen()
		{
