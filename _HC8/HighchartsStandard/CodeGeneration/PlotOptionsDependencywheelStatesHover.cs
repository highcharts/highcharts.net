...
{
	public partial class PlotOptionsDependencywheelStatesHover  : PlotOptionsSeries
	{
		Hashtable h = new Hashtable();

		public PlotOptionsDependencywheelStatesHover()
		{
			Animation = Animation_DefaultValue = new Animation();
			Enabled = Enabled_DefaultValue = null;
			Halo = Halo_DefaultValue = new PlotOptionsDependencywheelStatesHoverHalo();
			LineWidth = LineWidth_DefaultValue = null;
			LineWidthPlus = LineWidthPlus_DefaultValue = null;
			Marker = Marker_DefaultValue = new PlotOptionsDependencywheelStatesHoverMarker();
		...
		/// </summary>
		public PlotOptionsDependencywheelStatesHoverHalo Halo { get; set; }
		private PlotOptionsDependencywheelStatesHoverHalo Halo_DefaultValue { get; set; }
		...
		/// </summary>
		public PlotOptionsDependencywheelStatesHoverMarker Marker { get; set; }
		private PlotOptionsDependencywheelStatesHoverMarker Marker_DefaultValue { get; set; }
