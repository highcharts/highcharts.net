...
{
	public partial class PlotOptionsDependencywheelStatesHoverMarkerStatesHover  : PlotOptionsSeries
	{
		Hashtable h = new Hashtable();

		public PlotOptionsDependencywheelStatesHoverMarkerStatesHover()
		{
