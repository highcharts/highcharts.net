...
{
	public partial class PlotOptionsDependencywheelStatesHoverMarkerStatesSelect  : PlotOptionsSeries
	{
		Hashtable h = new Hashtable();

		public PlotOptionsDependencywheelStatesHoverMarkerStatesSelect()
		{
