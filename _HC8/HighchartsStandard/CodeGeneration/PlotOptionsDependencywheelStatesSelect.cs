...
{
	public partial class PlotOptionsDependencywheelStatesSelect  : PlotOptionsSeries
	{
		Hashtable h = new Hashtable();

		public PlotOptionsDependencywheelStatesSelect()
		{
			Animation = Animation_DefaultValue = new Animation();
			Enabled = Enabled_DefaultValue = null;
			Halo = Halo_DefaultValue = new PlotOptionsDependencywheelStatesSelectHalo();
			LineWidth = LineWidth_DefaultValue = null;
			LineWidthPlus = LineWidthPlus_DefaultValue = null;
			Marker = Marker_DefaultValue = new PlotOptionsDependencywheelStatesSelectMarker();
		...
		/// </summary>
		public PlotOptionsDependencywheelStatesSelectHalo Halo { get; set; }
		private PlotOptionsDependencywheelStatesSelectHalo Halo_DefaultValue { get; set; }
		...
		/// </summary>
		public PlotOptionsDependencywheelStatesSelectMarker Marker { get; set; }
		private PlotOptionsDependencywheelStatesSelectMarker Marker_DefaultValue { get; set; }
