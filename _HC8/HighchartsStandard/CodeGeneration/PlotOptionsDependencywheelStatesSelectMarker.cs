...
{
	public partial class PlotOptionsDependencywheelStatesSelectMarker  : PlotOptionsSeries
	{
		Hashtable h = new Hashtable();

		public PlotOptionsDependencywheelStatesSelectMarker()
		{
			...
			States = States_DefaultValue = new PlotOptionsDependencywheelStatesSelectMarkerStates();
		...
		/// </summary>
		public PlotOptionsDependencywheelStatesSelectMarkerStates States { get; set; }
		private PlotOptionsDependencywheelStatesSelectMarkerStates States_DefaultValue { get; set; }
