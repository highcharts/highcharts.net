...
{
	public partial class PlotOptionsDependencywheelStatesSelectMarkerStatesHover  : PlotOptionsSeries
	{
		Hashtable h = new Hashtable();

		public PlotOptionsDependencywheelStatesSelectMarkerStatesHover()
		{
