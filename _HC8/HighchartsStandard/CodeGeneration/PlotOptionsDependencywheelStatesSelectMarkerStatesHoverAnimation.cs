...
{
	public partial class PlotOptionsDependencywheelStatesSelectMarkerStatesHoverAnimation  : PlotOptionsSeries
	{
		Hashtable h = new Hashtable();

		public PlotOptionsDependencywheelStatesSelectMarkerStatesHoverAnimation()
		{
