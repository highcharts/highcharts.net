...
{
	public partial class PlotOptionsDependencywheelTooltipDateTimeLabelFormats  : PlotOptionsSeries
	{
		Hashtable h = new Hashtable();

		public PlotOptionsDependencywheelTooltipDateTimeLabelFormats()
		{
