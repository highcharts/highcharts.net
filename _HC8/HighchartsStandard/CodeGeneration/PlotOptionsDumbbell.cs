...
namespace Highsoft.Web.Mvc.Charts
{
	public partial class PlotOptionsDumbbell  : BaseObject
	{
		...
		internal override Hashtable ToHashtable()
		{
			...
			if (PointDescriptionFormatter != PointDescriptionFormatter_DefaultValue) { h.Add("pointDescriptionFormatter",PointDescriptionFormatter); Highcharts.AddFunction("a11d59c4-baad-4513-9243-2bf3ffa9b3a3.pointDescriptionFormatter", PointDescriptionFormatter); }  
