...
namespace Highsoft.Web.Mvc.Charts
{
	public partial class PlotOptionsDumbbell  : BaseObject
	{
		...
		internal override Hashtable ToHashtable()
		{
			...
			if (PointDescriptionFormatter != PointDescriptionFormatter_DefaultValue) { h.Add("pointDescriptionFormatter",PointDescriptionFormatter); Highcharts.AddFunction("07362619-54ab-413c-8d5b-d28ff6334fa6.pointDescriptionFormatter", PointDescriptionFormatter); }  
