...
namespace Highsoft.Web.Mvc.Charts
{
	public partial class PlotOptionsDumbbellDataLabels  : BaseObject
	{
		...
		public PlotOptionsDumbbellDataLabels()
		{
			...
			Style = Style_DefaultValue = new PlotOptionsDumbbellDataLabelsStyle();
		...
		/// </summary>
		public PlotOptionsDumbbellDataLabelsStyle Style { get; set; }
		private PlotOptionsDumbbellDataLabelsStyle Style_DefaultValue { get; set; }
		...
		internal override Hashtable ToHashtable()
		{
			...
			if (Formatter != Formatter_DefaultValue) { h.Add("formatter",Formatter); Highcharts.AddFunction("b8986c9f-5c70-4674-acd2-612b963640a7.formatter", Formatter); }  
			...
			if (NullFormatter != NullFormatter_DefaultValue) { h.Add("nullFormatter",NullFormatter); Highcharts.AddFunction("01a2c6e9-356d-4be1-9ea7-dfad845173f5.nullFormatter", NullFormatter); }  
