...
{
	public partial class PlotOptionsDumbbellDragDrop  : BaseObject
	{
		Hashtable h = new Hashtable();

		public PlotOptionsDumbbellDragDrop()
		{
			DraggableX = DraggableX_DefaultValue = null;
			DraggableY = DraggableY_DefaultValue = null;
			DragHandle = DragHandle_DefaultValue = new PlotOptionsDumbbellDragDropDragHandle();
			...
			GuideBox = GuideBox_DefaultValue = new PlotOptionsDumbbellDragDropGuideBox();
		...
		/// </summary>
		public PlotOptionsDumbbellDragDropDragHandle DragHandle { get; set; }
		private PlotOptionsDumbbellDragDropDragHandle DragHandle_DefaultValue { get; set; }
		...
		/// </summary>
		public PlotOptionsDumbbellDragDropGuideBox GuideBox { get; set; }
		private PlotOptionsDumbbellDragDropGuideBox GuideBox_DefaultValue { get; set; }
