...
namespace Highsoft.Web.Mvc.Charts
{
	public partial class PlotOptionsDumbbellDragDropDragHandle  : BaseObject
	{
		...
		internal override Hashtable ToHashtable()
		{
			...
			if (PathFormatter != PathFormatter_DefaultValue) { h.Add("pathFormatter",PathFormatter); Highcharts.AddFunction("c3342693-1930-42e4-aa2e-b0d1dc903352.pathFormatter", PathFormatter); }  
