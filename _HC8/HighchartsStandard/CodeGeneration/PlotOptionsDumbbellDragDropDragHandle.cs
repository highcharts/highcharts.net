...
namespace Highsoft.Web.Mvc.Charts
{
	public partial class PlotOptionsDumbbellDragDropDragHandle  : BaseObject
	{
		...
		internal override Hashtable ToHashtable()
		{
			...
			if (PathFormatter != PathFormatter_DefaultValue) { h.Add("pathFormatter",PathFormatter); Highcharts.AddFunction("9d52cd96-99c0-4b9e-a9f4-e423072774b9.pathFormatter", PathFormatter); }  
