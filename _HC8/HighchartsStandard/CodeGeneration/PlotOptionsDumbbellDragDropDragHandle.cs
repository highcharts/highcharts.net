...
namespace Highsoft.Web.Mvc.Charts
{
	public partial class PlotOptionsDumbbellDragDropDragHandle  : BaseObject
	{
		...
		internal override Hashtable ToHashtable()
		{
			...
			if (PathFormatter != PathFormatter_DefaultValue) { h.Add("pathFormatter",PathFormatter); Highcharts.AddFunction("2e338974-88ca-4e29-ba8b-8f5fc7d3c01a.pathFormatter", PathFormatter); }  
