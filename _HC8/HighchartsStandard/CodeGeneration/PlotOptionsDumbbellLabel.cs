...
{
	public partial class PlotOptionsDumbbellLabel  : BaseObject
	{
		Hashtable h = new Hashtable();

		public PlotOptionsDumbbellLabel()
		{
			...
			Style = Style_DefaultValue = new PlotOptionsDumbbellLabelStyle();
		...
		/// </summary>
		public PlotOptionsDumbbellLabelStyle Style { get; set; }
		private PlotOptionsDumbbellLabelStyle Style_DefaultValue { get; set; }
		...
		internal override Hashtable ToHashtable()
		{
			...
			if (Formatter != Formatter_DefaultValue) { h.Add("formatter",Formatter); Highcharts.AddFunction("aa7789a5-7b2a-484e-99cb-05d3c85d0fb4.formatter", Formatter); }  
