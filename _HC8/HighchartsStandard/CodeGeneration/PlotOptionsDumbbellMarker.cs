...
{
	public partial class PlotOptionsDumbbellMarker  : PlotOptionsSeries
	{
		Hashtable h = new Hashtable();

		public PlotOptionsDumbbellMarker()
		{
			...
			States = States_DefaultValue = new PlotOptionsDumbbellMarkerStates();
		...
		/// </summary>
		public PlotOptionsDumbbellMarkerStates States { get; set; }
		private PlotOptionsDumbbellMarkerStates States_DefaultValue { get; set; }
