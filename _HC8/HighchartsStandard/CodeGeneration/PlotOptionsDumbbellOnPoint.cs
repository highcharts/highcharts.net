...
{
	public partial class PlotOptionsDumbbellOnPoint  : BaseObject
	{
		Hashtable h = new Hashtable();

		public PlotOptionsDumbbellOnPoint()
		{
		...
		/// </summary>
		public PlotOptionsDumbbellOnPointConnectorOptions ConnectorOptions { get; set; }
		private PlotOptionsDumbbellOnPointConnectorOptions ConnectorOptions_DefaultValue { get; set; }
