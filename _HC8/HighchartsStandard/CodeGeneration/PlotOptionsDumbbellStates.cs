...
{
	public partial class PlotOptionsDumbbellStates  : PlotOptionsSeries
	{
		Hashtable h = new Hashtable();

		public PlotOptionsDumbbellStates()
		{
			Hover = Hover_DefaultValue = new PlotOptionsDumbbellStatesHover();
			Inactive = Inactive_DefaultValue = new PlotOptionsDumbbellStatesInactive();
			Normal = Normal_DefaultValue = new PlotOptionsDumbbellStatesNormal();
			Select = Select_DefaultValue = new PlotOptionsDumbbellStatesSelect();
		...
		/// </summary>
		public PlotOptionsDumbbellStatesSelect Select { get; set; }
		private PlotOptionsDumbbellStatesSelect Select_DefaultValue { get; set; }
