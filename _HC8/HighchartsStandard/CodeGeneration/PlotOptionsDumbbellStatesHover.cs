...
{
	public partial class PlotOptionsDumbbellStatesHover  : PlotOptionsSeries
	{
		...
		public PlotOptionsDumbbellStatesHover()
		{
			...
			Marker = Marker_DefaultValue = new PlotOptionsDumbbellStatesHoverMarker();
		...
		/// </summary>
		public PlotOptionsDumbbellStatesHoverHalo Halo { get; set; }
		private PlotOptionsDumbbellStatesHoverHalo Halo_DefaultValue { get; set; }
		...
		/// </summary>
		public PlotOptionsDumbbellStatesHoverMarker Marker { get; set; }
		private PlotOptionsDumbbellStatesHoverMarker Marker_DefaultValue { get; set; }
