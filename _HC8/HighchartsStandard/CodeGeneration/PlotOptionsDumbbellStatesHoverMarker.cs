...
{
	public partial class PlotOptionsDumbbellStatesHoverMarker  : PlotOptionsSeries
	{
		Hashtable h = new Hashtable();

		public PlotOptionsDumbbellStatesHoverMarker()
		{
			...
			States = States_DefaultValue = new PlotOptionsDumbbellStatesHoverMarkerStates();
		...
		/// </summary>
		public PlotOptionsDumbbellStatesHoverMarkerStates States { get; set; }
		private PlotOptionsDumbbellStatesHoverMarkerStates States_DefaultValue { get; set; }
