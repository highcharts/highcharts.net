...
{
	public partial class PlotOptionsDumbbellStatesSelect  : PlotOptionsSeries
	{
		Hashtable h = new Hashtable();

		public PlotOptionsDumbbellStatesSelect()
		{
			Animation = Animation_DefaultValue = new Animation();
			Enabled = Enabled_DefaultValue = null;
			Halo = Halo_DefaultValue = new PlotOptionsDumbbellStatesSelectHalo();
			LineWidth = LineWidth_DefaultValue = null;
			LineWidthPlus = LineWidthPlus_DefaultValue = null;
			Marker = Marker_DefaultValue = new PlotOptionsDumbbellStatesSelectMarker();
		...
		/// </summary>
		public PlotOptionsDumbbellStatesSelectHalo Halo { get; set; }
		private PlotOptionsDumbbellStatesSelectHalo Halo_DefaultValue { get; set; }
		...
		/// </summary>
		public PlotOptionsDumbbellStatesSelectMarker Marker { get; set; }
		private PlotOptionsDumbbellStatesSelectMarker Marker_DefaultValue { get; set; }
