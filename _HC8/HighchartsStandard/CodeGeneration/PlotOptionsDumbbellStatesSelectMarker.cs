...
{
	public partial class PlotOptionsDumbbellStatesSelectMarker  : PlotOptionsSeries
	{
		Hashtable h = new Hashtable();

		public PlotOptionsDumbbellStatesSelectMarker()
		{
			...
			States = States_DefaultValue = new PlotOptionsDumbbellStatesSelectMarkerStates();
		...
		/// </summary>
		public PlotOptionsDumbbellStatesSelectMarkerStates States { get; set; }
		private PlotOptionsDumbbellStatesSelectMarkerStates States_DefaultValue { get; set; }
