...
{
	public partial class PlotOptionsDumbbellStatesSelectMarkerStatesHoverAnimation  : PlotOptionsSeries
	{
		Hashtable h = new Hashtable();

		public PlotOptionsDumbbellStatesSelectMarkerStatesHoverAnimation()
		{
