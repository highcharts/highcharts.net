...
namespace Highsoft.Web.Mvc.Charts
{
	public partial class PlotOptionsErrorbar  : BaseObject
	{
		...
		internal override Hashtable ToHashtable()
		{
			...
			if (PointDescriptionFormatter != PointDescriptionFormatter_DefaultValue) { h.Add("pointDescriptionFormatter",PointDescriptionFormatter); Highcharts.AddFunction("3e924b33-d33f-4013-84fe-be30e356eb21.pointDescriptionFormatter", PointDescriptionFormatter); }  
