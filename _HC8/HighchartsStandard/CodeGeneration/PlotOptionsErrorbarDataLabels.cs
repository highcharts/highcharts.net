...
namespace Highsoft.Web.Mvc.Charts
{
	public partial class PlotOptionsErrorbarDataLabels  : BaseObject
	{
		...
		public PlotOptionsErrorbarDataLabels()
		{
			Align = Align_DefaultValue = PlotOptionsErrorbarDataLabelsAlign.Center;
			...
			Filter = Filter_DefaultValue = new PlotOptionsErrorbarDataLabelsFilter();
			...
			Style = Style_DefaultValue = new PlotOptionsErrorbarDataLabelsStyle();
			TextPath = TextPath_DefaultValue = new PlotOptionsErrorbarDataLabelsTextPath();
			UseHTML = UseHTML_DefaultValue = false;
			VerticalAlign = VerticalAlign_DefaultValue = PlotOptionsErrorbarDataLabelsVerticalAlign.Bottom;
			X = X_DefaultValue = 0;
			Y = Y_DefaultValue = 0;
			Z = Z_DefaultValue = 6;
		...
		/// </summary>
		public PlotOptionsErrorbarDataLabelsAlign Align { get; set; }
		private PlotOptionsErrorbarDataLabelsAlign Align_DefaultValue { get; set; }
		...
		/// </summary>
		public PlotOptionsErrorbarDataLabelsFilter Filter { get; set; }
		private PlotOptionsErrorbarDataLabelsFilter Filter_DefaultValue { get; set; }
		...
		/// </summary>
		public PlotOptionsErrorbarDataLabelsStyle Style { get; set; }
		private PlotOptionsErrorbarDataLabelsStyle Style_DefaultValue { get; set; }
		...
		/// </summary>
		public PlotOptionsErrorbarDataLabelsTextPath TextPath { get; set; }
		private PlotOptionsErrorbarDataLabelsTextPath TextPath_DefaultValue { get; set; }
		...
		/// </summary>
		public PlotOptionsErrorbarDataLabelsVerticalAlign VerticalAlign { get; set; }
		private PlotOptionsErrorbarDataLabelsVerticalAlign VerticalAlign_DefaultValue { get; set; }
		...
		internal override Hashtable ToHashtable()
		{
			...
			if (Formatter != Formatter_DefaultValue) { h.Add("formatter",Formatter); Highcharts.AddFunction("44e3e0bc-da11-43bb-b6bf-beeab16e3242.formatter", Formatter); }  
			if (Inside != Inside_DefaultValue) h.Add("inside",Inside);
			if (NullFormat != NullFormat_DefaultValue) h.Add("nullFormat",NullFormat);
			if (NullFormatter != NullFormatter_DefaultValue) { h.Add("nullFormatter",NullFormatter); Highcharts.AddFunction("7e2f790e-847c-444f-82d7-4f97fd816c0f.nullFormatter", NullFormatter); }  
