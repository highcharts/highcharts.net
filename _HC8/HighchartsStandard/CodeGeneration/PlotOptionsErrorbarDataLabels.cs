...
namespace Highsoft.Web.Mvc.Charts
{
	public partial class PlotOptionsErrorbarDataLabels  : BaseObject
	{
		...
		public PlotOptionsErrorbarDataLabels()
		{
			...
			Overflow = Overflow_DefaultValue = PlotOptionsErrorbarDataLabelsOverflow.Justify;
			Padding = Padding_DefaultValue = 5;
			Position = Position_DefaultValue = PlotOptionsErrorbarDataLabelsPosition.Center;
