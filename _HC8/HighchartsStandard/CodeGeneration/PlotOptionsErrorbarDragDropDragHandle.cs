...
namespace Highsoft.Web.Mvc.Charts
{
	public partial class PlotOptionsErrorbarDragDropDragHandle  : BaseObject
	{
		...
		internal override Hashtable ToHashtable()
		{
			...
			if (PathFormatter != PathFormatter_DefaultValue) { h.Add("pathFormatter",PathFormatter); Highcharts.AddFunction("3c59cf1c-6696-41a1-8ddb-9758165d88bc.pathFormatter", PathFormatter); }  
