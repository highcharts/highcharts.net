...
namespace Highsoft.Web.Mvc.Charts
{
	public partial class PlotOptionsErrorbarDragDropDragHandle  : BaseObject
	{
		...
		internal override Hashtable ToHashtable()
		{
			...
			if (PathFormatter != PathFormatter_DefaultValue) { h.Add("pathFormatter",PathFormatter); Highcharts.AddFunction("46f7aaa3-822d-4277-a036-1a8aeb040fcf.pathFormatter", PathFormatter); }  
