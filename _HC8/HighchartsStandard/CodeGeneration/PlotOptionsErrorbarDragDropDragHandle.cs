...
namespace Highsoft.Web.Mvc.Charts
{
	public partial class PlotOptionsErrorbarDragDropDragHandle  : BaseObject
	{
		...
		internal override Hashtable ToHashtable()
		{
			...
			if (PathFormatter != PathFormatter_DefaultValue) { h.Add("pathFormatter",PathFormatter); Highcharts.AddFunction("1b04e558-25e0-4794-b9ee-435683165cec.pathFormatter", PathFormatter); }  
