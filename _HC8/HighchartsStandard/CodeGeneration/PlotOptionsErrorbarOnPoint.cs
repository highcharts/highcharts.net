...
{
	public partial class PlotOptionsErrorbarOnPoint  : BaseObject
	{
		Hashtable h = new Hashtable();

		public PlotOptionsErrorbarOnPoint()
		{
			ConnectorOptions = ConnectorOptions_DefaultValue = new PlotOptionsErrorbarOnPointConnectorOptions();
			Id = Id_DefaultValue = "";
			Position = Position_DefaultValue = new PlotOptionsErrorbarOnPointPosition();
		...
		/// </summary>
		public PlotOptionsErrorbarOnPointConnectorOptions ConnectorOptions { get; set; }
		private PlotOptionsErrorbarOnPointConnectorOptions ConnectorOptions_DefaultValue { get; set; }
		...
		/// </summary>
		public PlotOptionsErrorbarOnPointPosition Position { get; set; }
		private PlotOptionsErrorbarOnPointPosition Position_DefaultValue { get; set; }
