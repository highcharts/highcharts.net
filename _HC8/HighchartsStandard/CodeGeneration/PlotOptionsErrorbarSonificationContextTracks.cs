...
{
	public partial class PlotOptionsErrorbarSonificationContextTracks  : BaseObject
	{
		Hashtable h = new Hashtable();

		public PlotOptionsErrorbarSonificationContextTracks()
		{
			ActiveWhen = ActiveWhen_DefaultValue = new PlotOptionsErrorbarSonificationContextTracksActiveWhen();
			Instrument = Instrument_DefaultValue = null;
			InstrumentString = InstrumentString_DefaultValue = "null";
			Mapping = Mapping_DefaultValue = new PlotOptionsErrorbarSonificationContextTracksMapping();
			MidiName = MidiName_DefaultValue = "";
			PointGrouping = PointGrouping_DefaultValue = new PlotOptionsErrorbarSonificationContextTracksPointGrouping();
			...
			Type = Type_DefaultValue = PlotOptionsErrorbarSonificationContextTracksType.Instrument;
			ValueInterval = ValueInterval_DefaultValue = null;
			ValueMapFunction = ValueMapFunction_DefaultValue = PlotOptionsErrorbarSonificationContextTracksValueMapFunction.Linear;
		...
		/// </summary>
		public PlotOptionsErrorbarSonificationContextTracksActiveWhen ActiveWhen { get; set; }
		private PlotOptionsErrorbarSonificationContextTracksActiveWhen ActiveWhen_DefaultValue { get; set; }
		...
		/// </summary>
		public PlotOptionsErrorbarSonificationContextTracksMapping Mapping { get; set; }
		private PlotOptionsErrorbarSonificationContextTracksMapping Mapping_DefaultValue { get; set; }
		...
		/// </summary>
		public PlotOptionsErrorbarSonificationContextTracksPointGrouping PointGrouping { get; set; }
		private PlotOptionsErrorbarSonificationContextTracksPointGrouping PointGrouping_DefaultValue { get; set; }
		...
		/// </summary>
		public PlotOptionsErrorbarSonificationContextTracksType Type { get; set; }
		private PlotOptionsErrorbarSonificationContextTracksType Type_DefaultValue { get; set; }
		...
		/// </summary>
		public PlotOptionsErrorbarSonificationContextTracksValueMapFunction ValueMapFunction { get; set; }
		private PlotOptionsErrorbarSonificationContextTracksValueMapFunction ValueMapFunction_DefaultValue { get; set; }
