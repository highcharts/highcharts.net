...
{
	public partial class PlotOptionsErrorbarStatesHover  : PlotOptionsSeries
	{
		...
		public PlotOptionsErrorbarStatesHover()
		{
			...
			Halo = Halo_DefaultValue = new PlotOptionsErrorbarStatesHoverHalo();
			LineWidth = LineWidth_DefaultValue = null;
			LineWidthPlus = LineWidthPlus_DefaultValue = null;
			Marker = Marker_DefaultValue = new PlotOptionsErrorbarStatesHoverMarker();
		...
		private PlotOptionsErrorbarStatesHoverHalo Halo_DefaultValue { get; set; }
		...
		private PlotOptionsErrorbarStatesHoverMarker Marker_DefaultValue { get; set; }
