...
{
	public partial class PlotOptionsErrorbarStatesSelect  : PlotOptionsSeries
	{
		Hashtable h = new Hashtable();

		public PlotOptionsErrorbarStatesSelect()
		{
			Animation = Animation_DefaultValue = new Animation();
			Enabled = Enabled_DefaultValue = null;
			Halo = Halo_DefaultValue = new PlotOptionsErrorbarStatesSelectHalo();
			LineWidth = LineWidth_DefaultValue = null;
			LineWidthPlus = LineWidthPlus_DefaultValue = null;
			Marker = Marker_DefaultValue = new PlotOptionsErrorbarStatesSelectMarker();
		...
		/// </summary>
		public PlotOptionsErrorbarStatesSelectHalo Halo { get; set; }
		private PlotOptionsErrorbarStatesSelectHalo Halo_DefaultValue { get; set; }
		...
		/// </summary>
		public PlotOptionsErrorbarStatesSelectMarker Marker { get; set; }
		private PlotOptionsErrorbarStatesSelectMarker Marker_DefaultValue { get; set; }
