...
{
	public partial class PlotOptionsErrorbarStatesSelectMarker  : PlotOptionsSeries
	{
		Hashtable h = new Hashtable();

		public PlotOptionsErrorbarStatesSelectMarker()
		{
			...
			States = States_DefaultValue = new PlotOptionsErrorbarStatesSelectMarkerStates();
		...
		/// </summary>
		public PlotOptionsErrorbarStatesSelectMarkerStates States { get; set; }
		private PlotOptionsErrorbarStatesSelectMarkerStates States_DefaultValue { get; set; }
