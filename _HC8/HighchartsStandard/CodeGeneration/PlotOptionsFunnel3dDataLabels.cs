...
namespace Highsoft.Web.Mvc.Charts
{
	public partial class PlotOptionsFunnel3dDataLabels  : BaseObject
	{
		...
		public PlotOptionsFunnel3dDataLabels()
		{
			...
			Style = Style_DefaultValue = new PlotOptionsFunnel3dDataLabelsStyle();
			TextPath = TextPath_DefaultValue = new PlotOptionsFunnel3dDataLabelsTextPath();
			UseHTML = UseHTML_DefaultValue = false;
			VerticalAlign = VerticalAlign_DefaultValue = PlotOptionsFunnel3dDataLabelsVerticalAlign.Bottom;
			X = X_DefaultValue = 0;
			Y = Y_DefaultValue = 0;
			Z = Z_DefaultValue = 6;
		...
		/// </summary>
		public PlotOptionsFunnel3dDataLabelsFilter Filter { get; set; }
		private PlotOptionsFunnel3dDataLabelsFilter Filter_DefaultValue { get; set; }
		...
		/// </summary>
		public PlotOptionsFunnel3dDataLabelsStyle Style { get; set; }
		private PlotOptionsFunnel3dDataLabelsStyle Style_DefaultValue { get; set; }
		...
		/// </summary>
		public PlotOptionsFunnel3dDataLabelsTextPath TextPath { get; set; }
		private PlotOptionsFunnel3dDataLabelsTextPath TextPath_DefaultValue { get; set; }
		...
		/// </summary>
		public PlotOptionsFunnel3dDataLabelsVerticalAlign VerticalAlign { get; set; }
		private PlotOptionsFunnel3dDataLabelsVerticalAlign VerticalAlign_DefaultValue { get; set; }
		...
		internal override Hashtable ToHashtable()
		{
			...
			if (Formatter != Formatter_DefaultValue) { h.Add("formatter",Formatter); Highcharts.AddFunction("899f66fc-8245-4330-af4c-392dc8b0af88.formatter", Formatter); }  
			...
			if (NullFormatter != NullFormatter_DefaultValue) { h.Add("nullFormatter",NullFormatter); Highcharts.AddFunction("2101b0a0-b4ad-4b06-ad12-c408e4027670.nullFormatter", NullFormatter); }  
