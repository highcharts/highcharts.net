...
{
	public partial class PlotOptionsFunnel3dLabel  : BaseObject
	{
		Hashtable h = new Hashtable();

		public PlotOptionsFunnel3dLabel()
		{
			...
			Style = Style_DefaultValue = new PlotOptionsFunnel3dLabelStyle();
		...
		/// </summary>
		public PlotOptionsFunnel3dLabelStyle Style { get; set; }
		private PlotOptionsFunnel3dLabelStyle Style_DefaultValue { get; set; }
		...
		internal override Hashtable ToHashtable()
		{
			...
			if (Formatter != Formatter_DefaultValue) { h.Add("formatter",Formatter); Highcharts.AddFunction("9b207208-888e-4bf2-90f1-3d1c7110c2a4.formatter", Formatter); }  
