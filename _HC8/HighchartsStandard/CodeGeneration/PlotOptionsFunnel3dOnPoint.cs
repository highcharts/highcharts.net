...
{
	public partial class PlotOptionsFunnel3dOnPoint  : BaseObject
	{
		...
		/// </summary>
		public PlotOptionsFunnel3dOnPointConnectorOptions ConnectorOptions { get; set; }
		private PlotOptionsFunnel3dOnPointConnectorOptions ConnectorOptions_DefaultValue { get; set; }
		...
		/// </summary>
		public PlotOptionsFunnel3dOnPointPosition Position { get; set; }
		private PlotOptionsFunnel3dOnPointPosition Position_DefaultValue { get; set; }
