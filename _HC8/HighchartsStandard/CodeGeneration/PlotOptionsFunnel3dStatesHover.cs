...
{
	public partial class PlotOptionsFunnel3dStatesHover  : PlotOptionsSeries
	{
		Hashtable h = new Hashtable();

		public PlotOptionsFunnel3dStatesHover()
		{
			Animation = Animation_DefaultValue = new Animation();
			Enabled = Enabled_DefaultValue = null;
			Halo = Halo_DefaultValue = new PlotOptionsFunnel3dStatesHoverHalo();
			LineWidth = LineWidth_DefaultValue = null;
			LineWidthPlus = LineWidthPlus_DefaultValue = null;
			Marker = Marker_DefaultValue = new PlotOptionsFunnel3dStatesHoverMarker();
		...
		/// </summary>
		public PlotOptionsFunnel3dStatesHoverHalo Halo { get; set; }
		private PlotOptionsFunnel3dStatesHoverHalo Halo_DefaultValue { get; set; }
		...
		/// </summary>
		public PlotOptionsFunnel3dStatesHoverMarker Marker { get; set; }
		private PlotOptionsFunnel3dStatesHoverMarker Marker_DefaultValue { get; set; }
