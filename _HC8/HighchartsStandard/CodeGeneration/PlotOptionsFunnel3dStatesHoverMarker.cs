...
{
	public partial class PlotOptionsFunnel3dStatesHoverMarker  : PlotOptionsSeries
	{
		Hashtable h = new Hashtable();

		public PlotOptionsFunnel3dStatesHoverMarker()
		{
			...
			States = States_DefaultValue = new PlotOptionsFunnel3dStatesHoverMarkerStates();
		...
		/// </summary>
		public PlotOptionsFunnel3dStatesHoverMarkerStates States { get; set; }
		private PlotOptionsFunnel3dStatesHoverMarkerStates States_DefaultValue { get; set; }
