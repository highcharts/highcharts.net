...
{
	public partial class PlotOptionsFunnel3dStatesHoverMarkerStatesHoverAnimation  : PlotOptionsSeries
	{
		Hashtable h = new Hashtable();

		public PlotOptionsFunnel3dStatesHoverMarkerStatesHoverAnimation()
		{
