...
{
	public partial class PlotOptionsFunnel3dStatesSelect  : PlotOptionsSeries
	{
		Hashtable h = new Hashtable();

		public PlotOptionsFunnel3dStatesSelect()
		{
			Animation = Animation_DefaultValue = new Animation();
			Enabled = Enabled_DefaultValue = null;
			Halo = Halo_DefaultValue = new PlotOptionsFunnel3dStatesSelectHalo();
			LineWidth = LineWidth_DefaultValue = null;
			LineWidthPlus = LineWidthPlus_DefaultValue = null;
			Marker = Marker_DefaultValue = new PlotOptionsFunnel3dStatesSelectMarker();
		...
		/// </summary>
		public PlotOptionsFunnel3dStatesSelectHalo Halo { get; set; }
		private PlotOptionsFunnel3dStatesSelectHalo Halo_DefaultValue { get; set; }
		...
		/// </summary>
		public PlotOptionsFunnel3dStatesSelectMarker Marker { get; set; }
		private PlotOptionsFunnel3dStatesSelectMarker Marker_DefaultValue { get; set; }
