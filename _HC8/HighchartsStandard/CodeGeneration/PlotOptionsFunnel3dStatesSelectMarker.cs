...
{
	public partial class PlotOptionsFunnel3dStatesSelectMarker  : PlotOptionsSeries
	{
		Hashtable h = new Hashtable();

		public PlotOptionsFunnel3dStatesSelectMarker()
		{
			...
			States = States_DefaultValue = new PlotOptionsFunnel3dStatesSelectMarkerStates();
		...
		/// </summary>
		public PlotOptionsFunnel3dStatesSelectMarkerStates States { get; set; }
		private PlotOptionsFunnel3dStatesSelectMarkerStates States_DefaultValue { get; set; }
