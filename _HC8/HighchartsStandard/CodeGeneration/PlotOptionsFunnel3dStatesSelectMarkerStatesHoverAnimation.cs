...
{
	public partial class PlotOptionsFunnel3dStatesSelectMarkerStatesHoverAnimation  : PlotOptionsSeries
	{
		Hashtable h = new Hashtable();

		public PlotOptionsFunnel3dStatesSelectMarkerStatesHoverAnimation()
		{
