...
namespace Highsoft.Web.Mvc.Charts
{
	public partial class PlotOptionsFunnelDragDropDragHandle  : BaseObject
	{
		...
		internal override Hashtable ToHashtable()
		{
			...
			if (PathFormatter != PathFormatter_DefaultValue) { h.Add("pathFormatter",PathFormatter); Highcharts.AddFunction("26f23297-5006-455b-926d-dd1b474827ad.pathFormatter", PathFormatter); }  
