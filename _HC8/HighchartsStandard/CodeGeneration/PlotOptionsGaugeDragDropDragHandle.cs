...
namespace Highsoft.Web.Mvc.Charts
{
	public partial class PlotOptionsGaugeDragDropDragHandle  : BaseObject
	{
		...
		internal override Hashtable ToHashtable()
		{
			...
			if (PathFormatter != PathFormatter_DefaultValue) { h.Add("pathFormatter",PathFormatter); Highcharts.AddFunction("17cccc76-f166-41b4-8159-f30f2ddce1bc.pathFormatter", PathFormatter); }  
