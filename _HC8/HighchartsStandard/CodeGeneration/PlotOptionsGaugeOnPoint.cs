...
{
	public partial class PlotOptionsGaugeOnPoint  : BaseObject
	{
		Hashtable h = new Hashtable();

		public PlotOptionsGaugeOnPoint()
		{
			ConnectorOptions = ConnectorOptions_DefaultValue = new PlotOptionsGaugeOnPointConnectorOptions();
			Id = Id_DefaultValue = "";
			Position = Position_DefaultValue = new PlotOptionsGaugeOnPointPosition();
		...
		/// </summary>
		public PlotOptionsGaugeOnPointConnectorOptions ConnectorOptions { get; set; }
		private PlotOptionsGaugeOnPointConnectorOptions ConnectorOptions_DefaultValue { get; set; }
		...
		/// </summary>
		public PlotOptionsGaugeOnPointPosition Position { get; set; }
		private PlotOptionsGaugeOnPointPosition Position_DefaultValue { get; set; }
