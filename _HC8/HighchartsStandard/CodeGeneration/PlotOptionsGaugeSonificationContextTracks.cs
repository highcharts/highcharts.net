...
{
	public partial class PlotOptionsGaugeSonificationContextTracks  : BaseObject
	{
		Hashtable h = new Hashtable();

		public PlotOptionsGaugeSonificationContextTracks()
		{
			ActiveWhen = ActiveWhen_DefaultValue = new PlotOptionsGaugeSonificationContextTracksActiveWhen();
			Instrument = Instrument_DefaultValue = null;
			InstrumentString = InstrumentString_DefaultValue = "null";
			Mapping = Mapping_DefaultValue = new PlotOptionsGaugeSonificationContextTracksMapping();
			MidiName = MidiName_DefaultValue = "";
			PointGrouping = PointGrouping_DefaultValue = new PlotOptionsGaugeSonificationContextTracksPointGrouping();
			...
			Type = Type_DefaultValue = PlotOptionsGaugeSonificationContextTracksType.Instrument;
			ValueInterval = ValueInterval_DefaultValue = null;
			ValueMapFunction = ValueMapFunction_DefaultValue = PlotOptionsGaugeSonificationContextTracksValueMapFunction.Linear;
		...
		/// </summary>
		public PlotOptionsGaugeSonificationContextTracksActiveWhen ActiveWhen { get; set; }
		private PlotOptionsGaugeSonificationContextTracksActiveWhen ActiveWhen_DefaultValue { get; set; }
		...
		/// </summary>
		public PlotOptionsGaugeSonificationContextTracksMapping Mapping { get; set; }
		private PlotOptionsGaugeSonificationContextTracksMapping Mapping_DefaultValue { get; set; }
		...
		/// </summary>
		public PlotOptionsGaugeSonificationContextTracksPointGrouping PointGrouping { get; set; }
		private PlotOptionsGaugeSonificationContextTracksPointGrouping PointGrouping_DefaultValue { get; set; }
		...
		/// </summary>
		public PlotOptionsGaugeSonificationContextTracksType Type { get; set; }
		private PlotOptionsGaugeSonificationContextTracksType Type_DefaultValue { get; set; }
		...
		/// </summary>
		public PlotOptionsGaugeSonificationContextTracksValueMapFunction ValueMapFunction { get; set; }
		private PlotOptionsGaugeSonificationContextTracksValueMapFunction ValueMapFunction_DefaultValue { get; set; }
