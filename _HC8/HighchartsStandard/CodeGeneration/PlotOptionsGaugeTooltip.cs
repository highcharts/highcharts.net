...
{
	public partial class PlotOptionsGaugeTooltip  : BaseObject
	{
		...
		public PlotOptionsGaugeTooltip()
		{
			...
			HeaderShape = HeaderShape_DefaultValue = PlotOptionsGaugeTooltipHeaderShape.Callout;
		...
		/// </summary>
		public PlotOptionsGaugeTooltipHeaderShape HeaderShape { get; set; }
		private PlotOptionsGaugeTooltipHeaderShape HeaderShape_DefaultValue { get; set; }
		...
		internal override Hashtable ToHashtable()
		{
			...
			if (NullFormatter != NullFormatter_DefaultValue) { h.Add("nullFormatter",NullFormatter); Highcharts.AddFunction("a9c6d8fc-07d4-4423-8e58-4b39f45233ce.nullFormatter", NullFormatter); }  
			if (Outside != Outside_DefaultValue) h.Add("outside",Outside);
			if (Padding != Padding_DefaultValue) h.Add("padding",Padding);
			if (PointFormat != PointFormat_DefaultValue) h.Add("pointFormat",PointFormat);
			if (PointFormatter != PointFormatter_DefaultValue) { h.Add("pointFormatter",PointFormatter); Highcharts.AddFunction("70e3da4e-1bee-4e94-be24-39f11da64720.pointFormatter", PointFormatter); }  
