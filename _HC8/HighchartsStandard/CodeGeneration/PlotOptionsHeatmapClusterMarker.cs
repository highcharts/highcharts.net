...
{
	public partial class PlotOptionsHeatmapClusterMarker  : BaseObject
	{
		Hashtable h = new Hashtable();

		public PlotOptionsHeatmapClusterMarker()
		{
			...
			States = States_DefaultValue = new PlotOptionsHeatmapClusterMarkerStates();
		...
		/// </summary>
		public PlotOptionsHeatmapClusterMarkerStates States { get; set; }
		private PlotOptionsHeatmapClusterMarkerStates States_DefaultValue { get; set; }
