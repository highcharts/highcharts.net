...
{
	public partial class PlotOptionsHeatmapClusterZonesMarker  : BaseObject
	{
		Hashtable h = new Hashtable();

		public PlotOptionsHeatmapClusterZonesMarker()
		{
			...
			States = States_DefaultValue = new PlotOptionsHeatmapClusterZonesMarkerStates();
		...
		/// </summary>
		public PlotOptionsHeatmapClusterZonesMarkerStates States { get; set; }
		private PlotOptionsHeatmapClusterZonesMarkerStates States_DefaultValue { get; set; }
