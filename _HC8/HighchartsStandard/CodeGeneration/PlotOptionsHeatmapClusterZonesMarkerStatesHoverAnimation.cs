...
{
	public partial class PlotOptionsHeatmapClusterZonesMarkerStatesHoverAnimation  : BaseObject
	{
		Hashtable h = new Hashtable();

		public PlotOptionsHeatmapClusterZonesMarkerStatesHoverAnimation()
		{
