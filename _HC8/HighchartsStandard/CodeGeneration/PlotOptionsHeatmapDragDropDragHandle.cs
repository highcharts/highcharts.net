...
namespace Highsoft.Web.Mvc.Charts
{
	public partial class PlotOptionsHeatmapDragDropDragHandle  : BaseObject
	{
		...
		internal override Hashtable ToHashtable()
		{
			...
			if (PathFormatter != PathFormatter_DefaultValue) { h.Add("pathFormatter",PathFormatter); Highcharts.AddFunction("9c6dcb81-58f6-4269-9b4b-5a632c0d2774.pathFormatter", PathFormatter); }  
