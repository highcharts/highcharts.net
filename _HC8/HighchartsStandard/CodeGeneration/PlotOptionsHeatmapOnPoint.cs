...
{
	public partial class PlotOptionsHeatmapOnPoint  : BaseObject
	{
		Hashtable h = new Hashtable();

		public PlotOptionsHeatmapOnPoint()
		{
			ConnectorOptions = ConnectorOptions_DefaultValue = new PlotOptionsHeatmapOnPointConnectorOptions();
			Id = Id_DefaultValue = "";
			Position = Position_DefaultValue = new PlotOptionsHeatmapOnPointPosition();
		...
		/// </summary>
		public PlotOptionsHeatmapOnPointConnectorOptions ConnectorOptions { get; set; }
		private PlotOptionsHeatmapOnPointConnectorOptions ConnectorOptions_DefaultValue { get; set; }
		...
		/// </summary>
		public PlotOptionsHeatmapOnPointPosition Position { get; set; }
		private PlotOptionsHeatmapOnPointPosition Position_DefaultValue { get; set; }
