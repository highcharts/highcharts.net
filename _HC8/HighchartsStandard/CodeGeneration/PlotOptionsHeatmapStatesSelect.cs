...
{
	public partial class PlotOptionsHeatmapStatesSelect  : PlotOptionsSeries
	{
		Hashtable h = new Hashtable();

		public PlotOptionsHeatmapStatesSelect()
		{
			Animation = Animation_DefaultValue = new Animation();
			Enabled = Enabled_DefaultValue = null;
			Halo = Halo_DefaultValue = new PlotOptionsHeatmapStatesSelectHalo();
			LineWidth = LineWidth_DefaultValue = null;
			LineWidthPlus = LineWidthPlus_DefaultValue = null;
			Marker = Marker_DefaultValue = new PlotOptionsHeatmapStatesSelectMarker();
		...
		/// </summary>
		public PlotOptionsHeatmapStatesSelectHalo Halo { get; set; }
		private PlotOptionsHeatmapStatesSelectHalo Halo_DefaultValue { get; set; }
		...
		/// </summary>
		public PlotOptionsHeatmapStatesSelectMarker Marker { get; set; }
		private PlotOptionsHeatmapStatesSelectMarker Marker_DefaultValue { get; set; }
