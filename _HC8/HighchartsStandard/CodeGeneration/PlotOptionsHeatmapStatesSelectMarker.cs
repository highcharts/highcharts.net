...
{
	public partial class PlotOptionsHeatmapStatesSelectMarker  : PlotOptionsSeries
	{
		Hashtable h = new Hashtable();

		public PlotOptionsHeatmapStatesSelectMarker()
		{
			...
			States = States_DefaultValue = new PlotOptionsHeatmapStatesSelectMarkerStates();
		...
		/// </summary>
		public PlotOptionsHeatmapStatesSelectMarkerStates States { get; set; }
		private PlotOptionsHeatmapStatesSelectMarkerStates States_DefaultValue { get; set; }
