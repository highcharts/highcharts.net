...
namespace Highsoft.Web.Mvc.Charts
{
	public partial class PlotOptionsHistogram  : BaseObject
	{
		...
		public PlotOptionsHistogram()
		{
			...
			Cursor = Cursor_DefaultValue = PlotOptionsHistogramCursor.Null;
			Custom = Custom_DefaultValue = new Hashtable();
			DashStyle = DashStyle_DefaultValue = PlotOptionsHistogramDashStyle.Null;
			DataLabels = DataLabels_DefaultValue = new PlotOptionsHistogramDataLabels();
			...
			Events = Events_DefaultValue = new PlotOptionsHistogramEvents();
			FindNearestPointBy = FindNearestPointBy_DefaultValue = PlotOptionsHistogramFindNearestPointBy.X;
			...
			LegendSymbol = LegendSymbol_DefaultValue = PlotOptionsHistogramLegendSymbol.Rectangle;
			LinkedTo = LinkedTo_DefaultValue = "";
			MaxPointWidth = MaxPointWidth_DefaultValue = null;
			MinPointLength = MinPointLength_DefaultValue = 0;
			NegativeColor = NegativeColor_DefaultValue = "";
			OnPoint = OnPoint_DefaultValue = new PlotOptionsHistogramOnPoint();
			Opacity = Opacity_DefaultValue = 1;
			Point = Point_DefaultValue = new PlotOptionsHistogramPoint();
			...
			Sonification = Sonification_DefaultValue = new PlotOptionsHistogramSonification();
			States = States_DefaultValue = new PlotOptionsHistogramStates();
			...
			Zones = Zones_DefaultValue = new List<PlotOptionsHistogramZone>();
		...
		/// </summary>
		public double? BinsNumber { get; set; }
		private double? BinsNumber_DefaultValue { get; set; }
