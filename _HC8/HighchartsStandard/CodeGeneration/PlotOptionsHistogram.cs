...
namespace Highsoft.Web.Mvc.Charts
{
	public partial class PlotOptionsHistogram  : BaseObject
	{
		...
		internal override Hashtable ToHashtable()
		{
			...
			if (PointDescriptionFormatter != PointDescriptionFormatter_DefaultValue) { h.Add("pointDescriptionFormatter",PointDescriptionFormatter); Highcharts.AddFunction("5e94d6e9-09b9-4455-8e91-63c8984aa795.pointDescriptionFormatter", PointDescriptionFormatter); }  
