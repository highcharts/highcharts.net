...
namespace Highsoft.Web.Mvc.Charts
{
	public partial class PlotOptionsHistogram  : BaseObject
	{
		...
		internal override Hashtable ToHashtable()
		{
			...
			if (PointDescriptionFormatter != PointDescriptionFormatter_DefaultValue) { h.Add("pointDescriptionFormatter",PointDescriptionFormatter); Highcharts.AddFunction("c2fbcfb8-8fb0-440d-99bb-9f94df5a6bd3.pointDescriptionFormatter", PointDescriptionFormatter); }  
