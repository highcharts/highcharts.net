...
namespace Highsoft.Web.Mvc.Charts
{
	public partial class PlotOptionsHistogramDataLabels  : BaseObject
	{
		...
		public PlotOptionsHistogramDataLabels()
		{
			...
			Overflow = Overflow_DefaultValue = PlotOptionsHistogramDataLabelsOverflow.Justify;
			Padding = Padding_DefaultValue = 5;
			Position = Position_DefaultValue = PlotOptionsHistogramDataLabelsPosition.Center;
