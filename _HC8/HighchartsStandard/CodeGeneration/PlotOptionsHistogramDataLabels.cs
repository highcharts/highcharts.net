...
{
	public partial class PlotOptionsHistogramDataLabels  : BaseObject
	{
		Hashtable h = new Hashtable();

		public PlotOptionsHistogramDataLabels()
		{
			Align = Align_DefaultValue = PlotOptionsHistogramDataLabelsAlign.Center;
			...
			Filter = Filter_DefaultValue = new PlotOptionsHistogramDataLabelsFilter();
			...
			Style = Style_DefaultValue = new PlotOptionsHistogramDataLabelsStyle();
			TextPath = TextPath_DefaultValue = new PlotOptionsHistogramDataLabelsTextPath();
			UseHTML = UseHTML_DefaultValue = false;
			VerticalAlign = VerticalAlign_DefaultValue = PlotOptionsHistogramDataLabelsVerticalAlign.Bottom;
			X = X_DefaultValue = 0;
			Y = Y_DefaultValue = 0;
			Z = Z_DefaultValue = 6;
		...
		/// </summary>
		public PlotOptionsHistogramDataLabelsAlign Align { get; set; }
		private PlotOptionsHistogramDataLabelsAlign Align_DefaultValue { get; set; }
		...
		/// </summary>
		public PlotOptionsHistogramDataLabelsFilter Filter { get; set; }
		private PlotOptionsHistogramDataLabelsFilter Filter_DefaultValue { get; set; }
		...
		/// </summary>
		public PlotOptionsHistogramDataLabelsStyle Style { get; set; }
		private PlotOptionsHistogramDataLabelsStyle Style_DefaultValue { get; set; }
		...
		/// </summary>
		public PlotOptionsHistogramDataLabelsTextPath TextPath { get; set; }
		private PlotOptionsHistogramDataLabelsTextPath TextPath_DefaultValue { get; set; }
		...
		/// </summary>
		public PlotOptionsHistogramDataLabelsVerticalAlign VerticalAlign { get; set; }
		private PlotOptionsHistogramDataLabelsVerticalAlign VerticalAlign_DefaultValue { get; set; }
		...
		internal override Hashtable ToHashtable()
		{
			...
			if (Formatter != Formatter_DefaultValue) { h.Add("formatter",Formatter); Highcharts.AddFunction("24f84d6e-ffc9-47dc-b0e2-8a38a82530e4.formatter", Formatter); }  
			...
			if (NullFormatter != NullFormatter_DefaultValue) { h.Add("nullFormatter",NullFormatter); Highcharts.AddFunction("006f9107-2da0-401c-9c65-e4aeb1670879.nullFormatter", NullFormatter); }  
