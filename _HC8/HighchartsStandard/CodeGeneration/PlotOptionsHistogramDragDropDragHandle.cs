...
namespace Highsoft.Web.Mvc.Charts
{
	public partial class PlotOptionsHistogramDragDropDragHandle  : BaseObject
	{
		...
		internal override Hashtable ToHashtable()
		{
			...
			if (PathFormatter != PathFormatter_DefaultValue) { h.Add("pathFormatter",PathFormatter); Highcharts.AddFunction("4fabaa07-7ffc-4291-b89f-445c0584e7ae.pathFormatter", PathFormatter); }  
