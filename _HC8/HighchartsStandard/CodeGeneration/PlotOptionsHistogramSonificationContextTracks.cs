...
{
	public partial class PlotOptionsHistogramSonificationContextTracks  : BaseObject
	{
		Hashtable h = new Hashtable();

		public PlotOptionsHistogramSonificationContextTracks()
		{
			ActiveWhen = ActiveWhen_DefaultValue = new PlotOptionsHistogramSonificationContextTracksActiveWhen();
			Instrument = Instrument_DefaultValue = null;
			InstrumentString = InstrumentString_DefaultValue = "null";
			Mapping = Mapping_DefaultValue = new PlotOptionsHistogramSonificationContextTracksMapping();
			MidiName = MidiName_DefaultValue = "";
			PointGrouping = PointGrouping_DefaultValue = new PlotOptionsHistogramSonificationContextTracksPointGrouping();
			...
			Type = Type_DefaultValue = PlotOptionsHistogramSonificationContextTracksType.Instrument;
			ValueInterval = ValueInterval_DefaultValue = null;
			ValueMapFunction = ValueMapFunction_DefaultValue = PlotOptionsHistogramSonificationContextTracksValueMapFunction.Linear;
		...
		/// </summary>
		public PlotOptionsHistogramSonificationContextTracksActiveWhen ActiveWhen { get; set; }
		private PlotOptionsHistogramSonificationContextTracksActiveWhen ActiveWhen_DefaultValue { get; set; }
		...
		/// </summary>
		public PlotOptionsHistogramSonificationContextTracksMapping Mapping { get; set; }
		private PlotOptionsHistogramSonificationContextTracksMapping Mapping_DefaultValue { get; set; }
		...
		/// </summary>
		public PlotOptionsHistogramSonificationContextTracksPointGrouping PointGrouping { get; set; }
		private PlotOptionsHistogramSonificationContextTracksPointGrouping PointGrouping_DefaultValue { get; set; }
		...
		/// </summary>
		public PlotOptionsHistogramSonificationContextTracksType Type { get; set; }
		private PlotOptionsHistogramSonificationContextTracksType Type_DefaultValue { get; set; }
		...
		/// </summary>
		public PlotOptionsHistogramSonificationContextTracksValueMapFunction ValueMapFunction { get; set; }
		private PlotOptionsHistogramSonificationContextTracksValueMapFunction ValueMapFunction_DefaultValue { get; set; }
