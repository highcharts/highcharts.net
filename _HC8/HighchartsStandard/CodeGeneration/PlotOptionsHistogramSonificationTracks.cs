...
{
	public partial class PlotOptionsHistogramSonificationTracks  : BaseObject
	{
		Hashtable h = new Hashtable();

		public PlotOptionsHistogramSonificationTracks()
		{
			ActiveWhen = ActiveWhen_DefaultValue = new PlotOptionsHistogramSonificationTracksActiveWhen();
			Instrument = Instrument_DefaultValue = null;
			InstrumentString = InstrumentString_DefaultValue = "null";
			Mapping = Mapping_DefaultValue = new PlotOptionsHistogramSonificationTracksMapping();
			MidiName = MidiName_DefaultValue = "";
			PointGrouping = PointGrouping_DefaultValue = new PlotOptionsHistogramSonificationTracksPointGrouping();
			RoundToMusicalNotes = RoundToMusicalNotes_DefaultValue = true;
			ShowPlayMarker = ShowPlayMarker_DefaultValue = true;
			Type = Type_DefaultValue = PlotOptionsHistogramSonificationTracksType.Instrument;
		...
		/// </summary>
		public PlotOptionsHistogramSonificationTracksActiveWhen ActiveWhen { get; set; }
		private PlotOptionsHistogramSonificationTracksActiveWhen ActiveWhen_DefaultValue { get; set; }
		...
		/// </summary>
		public PlotOptionsHistogramSonificationTracksMapping Mapping { get; set; }
		private PlotOptionsHistogramSonificationTracksMapping Mapping_DefaultValue { get; set; }
		...
		/// </summary>
		public PlotOptionsHistogramSonificationTracksPointGrouping PointGrouping { get; set; }
		private PlotOptionsHistogramSonificationTracksPointGrouping PointGrouping_DefaultValue { get; set; }
		...
		/// </summary>
		public PlotOptionsHistogramSonificationTracksType Type { get; set; }
		private PlotOptionsHistogramSonificationTracksType Type_DefaultValue { get; set; }
