...
{
	public partial class PlotOptionsHistogramStatesHover  : PlotOptionsSeries
	{
		Hashtable h = new Hashtable();

		public PlotOptionsHistogramStatesHover()
		{
			Animation = Animation_DefaultValue = new Animation();
			Enabled = Enabled_DefaultValue = null;
			Halo = Halo_DefaultValue = new PlotOptionsHistogramStatesHoverHalo();
			LineWidth = LineWidth_DefaultValue = null;
			LineWidthPlus = LineWidthPlus_DefaultValue = null;
			Marker = Marker_DefaultValue = new PlotOptionsHistogramStatesHoverMarker();
		...
		/// </summary>
		public PlotOptionsHistogramStatesHoverHalo Halo { get; set; }
		private PlotOptionsHistogramStatesHoverHalo Halo_DefaultValue { get; set; }
		...
		/// </summary>
		public PlotOptionsHistogramStatesHoverMarker Marker { get; set; }
		private PlotOptionsHistogramStatesHoverMarker Marker_DefaultValue { get; set; }
