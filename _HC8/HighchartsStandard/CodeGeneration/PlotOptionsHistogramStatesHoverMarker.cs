...
{
	public partial class PlotOptionsHistogramStatesHoverMarker  : PlotOptionsSeries
	{
		Hashtable h = new Hashtable();

		public PlotOptionsHistogramStatesHoverMarker()
		{
			...
			States = States_DefaultValue = new PlotOptionsHistogramStatesHoverMarkerStates();
		...
		/// </summary>
		public PlotOptionsHistogramStatesHoverMarkerStates States { get; set; }
		private PlotOptionsHistogramStatesHoverMarkerStates States_DefaultValue { get; set; }
