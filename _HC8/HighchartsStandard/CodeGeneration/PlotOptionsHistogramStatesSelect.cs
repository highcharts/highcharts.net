...
{
	public partial class PlotOptionsHistogramStatesSelect  : PlotOptionsSeries
	{
		...
		public PlotOptionsHistogramStatesSelect()
		{
			...
			Halo = Halo_DefaultValue = new PlotOptionsHistogramStatesSelectHalo();
			LineWidth = LineWidth_DefaultValue = null;
			LineWidthPlus = LineWidthPlus_DefaultValue = null;
			Marker = Marker_DefaultValue = new PlotOptionsHistogramStatesSelectMarker();
		...
		/// </summary>
		public PlotOptionsHistogramStatesSelectHalo Halo { get; set; }
		private PlotOptionsHistogramStatesSelectHalo Halo_DefaultValue { get; set; }
		...
		/// </summary>
		public PlotOptionsHistogramStatesSelectMarker Marker { get; set; }
		private PlotOptionsHistogramStatesSelectMarker Marker_DefaultValue { get; set; }
