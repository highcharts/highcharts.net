...
{
	public partial class PlotOptionsHistogramStatesSelectMarker  : PlotOptionsSeries
	{
		Hashtable h = new Hashtable();

		public PlotOptionsHistogramStatesSelectMarker()
		{
			...
			States = States_DefaultValue = new PlotOptionsHistogramStatesSelectMarkerStates();
		...
		/// </summary>
		public PlotOptionsHistogramStatesSelectMarkerStates States { get; set; }
		private PlotOptionsHistogramStatesSelectMarkerStates States_DefaultValue { get; set; }
