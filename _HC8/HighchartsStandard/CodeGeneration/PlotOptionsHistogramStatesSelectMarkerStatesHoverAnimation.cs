...
{
	public partial class PlotOptionsHistogramStatesSelectMarkerStatesHoverAnimation  : PlotOptionsSeries
	{
		Hashtable h = new Hashtable();

		public PlotOptionsHistogramStatesSelectMarkerStatesHoverAnimation()
		{
