...
{
	public partial class PlotOptionsItemDragDrop  : BaseObject
	{
		Hashtable h = new Hashtable();

		public PlotOptionsItemDragDrop()
		{
			DraggableX = DraggableX_DefaultValue = null;
			DraggableY = DraggableY_DefaultValue = null;
			DragHandle = DragHandle_DefaultValue = new PlotOptionsItemDragDropDragHandle();
			...
			GuideBox = GuideBox_DefaultValue = new PlotOptionsItemDragDropGuideBox();
		...
		/// </summary>
		public PlotOptionsItemDragDropDragHandle DragHandle { get; set; }
		private PlotOptionsItemDragDropDragHandle DragHandle_DefaultValue { get; set; }
		...
		/// </summary>
		public PlotOptionsItemDragDropGuideBox GuideBox { get; set; }
		private PlotOptionsItemDragDropGuideBox GuideBox_DefaultValue { get; set; }
