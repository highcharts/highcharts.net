...
namespace Highsoft.Web.Mvc.Charts
{
	public partial class PlotOptionsItemDragDropDragHandle  : BaseObject
	{
		...
		internal override Hashtable ToHashtable()
		{
			...
			if (PathFormatter != PathFormatter_DefaultValue) { h.Add("pathFormatter",PathFormatter); Highcharts.AddFunction("69ff25cb-ac17-4074-bf44-516b6a3b52ef.pathFormatter", PathFormatter); }  
