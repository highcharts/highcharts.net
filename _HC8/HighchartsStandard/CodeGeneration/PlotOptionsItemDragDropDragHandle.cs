...
{
	public partial class PlotOptionsItemDragDropDragHandle  : BaseObject
	{
		Hashtable h = new Hashtable();

		public PlotOptionsItemDragDropDragHandle()
		{
		...
		internal override Hashtable ToHashtable()
		{
			...
			if (PathFormatter != PathFormatter_DefaultValue) { h.Add("pathFormatter",PathFormatter); Highcharts.AddFunction("a13901b2-247c-4615-9835-325b92531c63.pathFormatter", PathFormatter); }  
