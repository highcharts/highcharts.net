...
{
	public partial class PlotOptionsItemLabel  : BaseObject
	{
		Hashtable h = new Hashtable();

		public PlotOptionsItemLabel()
		{
			...
			Style = Style_DefaultValue = new PlotOptionsItemLabelStyle();
		...
		/// </summary>
		public PlotOptionsItemLabelStyle Style { get; set; }
		private PlotOptionsItemLabelStyle Style_DefaultValue { get; set; }
