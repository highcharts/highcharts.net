...
{
	public partial class PlotOptionsItemMarker  : PlotOptionsSeries
	{
		Hashtable h = new Hashtable();

		public PlotOptionsItemMarker()
		{
			...
			States = States_DefaultValue = new PlotOptionsItemMarkerStates();
		...
		/// </summary>
		public PlotOptionsItemMarkerStates States { get; set; }
		private PlotOptionsItemMarkerStates States_DefaultValue { get; set; }
