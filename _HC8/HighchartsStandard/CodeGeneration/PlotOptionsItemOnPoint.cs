...
{
	public partial class PlotOptionsItemOnPoint  : BaseObject
	{
		Hashtable h = new Hashtable();

		public PlotOptionsItemOnPoint()
		{
			ConnectorOptions = ConnectorOptions_DefaultValue = new PlotOptionsItemOnPointConnectorOptions();
			Id = Id_DefaultValue = "";
			Position = Position_DefaultValue = new PlotOptionsItemOnPointPosition();
		...
		/// </summary>
		public PlotOptionsItemOnPointConnectorOptions ConnectorOptions { get; set; }
		private PlotOptionsItemOnPointConnectorOptions ConnectorOptions_DefaultValue { get; set; }
		...
		/// </summary>
		public PlotOptionsItemOnPointPosition Position { get; set; }
		private PlotOptionsItemOnPointPosition Position_DefaultValue { get; set; }
