...
{
	public partial class PlotOptionsItemSonificationContextTracks  : BaseObject
	{
		Hashtable h = new Hashtable();

		public PlotOptionsItemSonificationContextTracks()
		{
			ActiveWhen = ActiveWhen_DefaultValue = new PlotOptionsItemSonificationContextTracksActiveWhen();
			Instrument = Instrument_DefaultValue = null;
			InstrumentString = InstrumentString_DefaultValue = "null";
			Mapping = Mapping_DefaultValue = new PlotOptionsItemSonificationContextTracksMapping();
			MidiName = MidiName_DefaultValue = "";
			PointGrouping = PointGrouping_DefaultValue = new PlotOptionsItemSonificationContextTracksPointGrouping();
			...
			Type = Type_DefaultValue = PlotOptionsItemSonificationContextTracksType.Instrument;
			ValueInterval = ValueInterval_DefaultValue = null;
			ValueMapFunction = ValueMapFunction_DefaultValue = PlotOptionsItemSonificationContextTracksValueMapFunction.Linear;
		...
		/// </summary>
		public PlotOptionsItemSonificationContextTracksActiveWhen ActiveWhen { get; set; }
		private PlotOptionsItemSonificationContextTracksActiveWhen ActiveWhen_DefaultValue { get; set; }
		...
		/// </summary>
		public PlotOptionsItemSonificationContextTracksMapping Mapping { get; set; }
		private PlotOptionsItemSonificationContextTracksMapping Mapping_DefaultValue { get; set; }
		...
		/// </summary>
		public PlotOptionsItemSonificationContextTracksPointGrouping PointGrouping { get; set; }
		private PlotOptionsItemSonificationContextTracksPointGrouping PointGrouping_DefaultValue { get; set; }
		...
		/// </summary>
		public PlotOptionsItemSonificationContextTracksType Type { get; set; }
		private PlotOptionsItemSonificationContextTracksType Type_DefaultValue { get; set; }
		...
		/// </summary>
		public PlotOptionsItemSonificationContextTracksValueMapFunction ValueMapFunction { get; set; }
		private PlotOptionsItemSonificationContextTracksValueMapFunction ValueMapFunction_DefaultValue { get; set; }
