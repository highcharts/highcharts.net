...
{
	public partial class PlotOptionsItemStatesHover  : PlotOptionsSeries
	{
		Hashtable h = new Hashtable();

		public PlotOptionsItemStatesHover()
		{
			Animation = Animation_DefaultValue = new Animation();
			Enabled = Enabled_DefaultValue = null;
			Halo = Halo_DefaultValue = new PlotOptionsItemStatesHoverHalo();
			LineWidth = LineWidth_DefaultValue = null;
			LineWidthPlus = LineWidthPlus_DefaultValue = null;
			Marker = Marker_DefaultValue = new PlotOptionsItemStatesHoverMarker();
		...
		/// </summary>
		public PlotOptionsItemStatesHoverHalo Halo { get; set; }
		private PlotOptionsItemStatesHoverHalo Halo_DefaultValue { get; set; }
		...
		/// </summary>
		public PlotOptionsItemStatesHoverMarker Marker { get; set; }
		private PlotOptionsItemStatesHoverMarker Marker_DefaultValue { get; set; }
