...
{
	public partial class PlotOptionsItemStatesHoverMarker  : PlotOptionsSeries
	{
		Hashtable h = new Hashtable();

		public PlotOptionsItemStatesHoverMarker()
		{
			...
			States = States_DefaultValue = new PlotOptionsItemStatesHoverMarkerStates();
		...
		/// </summary>
		public PlotOptionsItemStatesHoverMarkerStates States { get; set; }
		private PlotOptionsItemStatesHoverMarkerStates States_DefaultValue { get; set; }
