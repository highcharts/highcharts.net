...
{
	public partial class PlotOptionsItemStatesSelect  : PlotOptionsSeries
	{
		Hashtable h = new Hashtable();

		public PlotOptionsItemStatesSelect()
		{
			Animation = Animation_DefaultValue = new Animation();
			Enabled = Enabled_DefaultValue = null;
			Halo = Halo_DefaultValue = new PlotOptionsItemStatesSelectHalo();
			LineWidth = LineWidth_DefaultValue = null;
			LineWidthPlus = LineWidthPlus_DefaultValue = null;
			Marker = Marker_DefaultValue = new PlotOptionsItemStatesSelectMarker();
		...
		/// </summary>
		public PlotOptionsItemStatesSelectHalo Halo { get; set; }
		private PlotOptionsItemStatesSelectHalo Halo_DefaultValue { get; set; }
		...
		/// </summary>
		public PlotOptionsItemStatesSelectMarker Marker { get; set; }
		private PlotOptionsItemStatesSelectMarker Marker_DefaultValue { get; set; }
