...
{
	public partial class PlotOptionsItemStatesSelectMarker  : PlotOptionsSeries
	{
		Hashtable h = new Hashtable();

		public PlotOptionsItemStatesSelectMarker()
		{
			...
			States = States_DefaultValue = new PlotOptionsItemStatesSelectMarkerStates();
		...
		/// </summary>
		public PlotOptionsItemStatesSelectMarkerStates States { get; set; }
		private PlotOptionsItemStatesSelectMarkerStates States_DefaultValue { get; set; }
