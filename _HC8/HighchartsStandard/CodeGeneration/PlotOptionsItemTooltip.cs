...
namespace Highsoft.Web.Mvc.Charts
{
	public partial class PlotOptionsItemTooltip  : BaseObject
	{
		...
		internal override Hashtable ToHashtable()
		{
			...
			if (NullFormatter != NullFormatter_DefaultValue) { h.Add("nullFormatter",NullFormatter); Highcharts.AddFunction("6fc9e89f-1999-4a5f-a0c7-32a34242616e.nullFormatter", NullFormatter); }  
			if (PointFormat != PointFormat_DefaultValue) h.Add("pointFormat",PointFormat);
			if (PointFormatter != PointFormatter_DefaultValue) { h.Add("pointFormatter",PointFormatter); Highcharts.AddFunction("864db228-42ce-4ef9-a162-7e68ef4d961d.pointFormatter", PointFormatter); }  
