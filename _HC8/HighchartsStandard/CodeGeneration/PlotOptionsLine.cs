...
namespace Highsoft.Web.Mvc.Charts
{
	public partial class PlotOptionsLine  : BaseObject
	{
		...
		internal override Hashtable ToHashtable()
		{
			...
			if (PointDescriptionFormatter != PointDescriptionFormatter_DefaultValue) { h.Add("pointDescriptionFormatter",PointDescriptionFormatter); Highcharts.AddFunction("a11b3b3a-dc2c-4254-8d4a-115b3a573be9.pointDescriptionFormatter", PointDescriptionFormatter); }  
