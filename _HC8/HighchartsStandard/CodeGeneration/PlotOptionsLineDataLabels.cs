...
{
	public partial class PlotOptionsLineDataLabels  : BaseObject
	{
		Hashtable h = new Hashtable();

		public PlotOptionsLineDataLabels()
		{
			Align = Align_DefaultValue = PlotOptionsLineDataLabelsAlign.Center;
			...
			Filter = Filter_DefaultValue = new PlotOptionsLineDataLabelsFilter();
			...
			Style = Style_DefaultValue = new PlotOptionsLineDataLabelsStyle();
			TextPath = TextPath_DefaultValue = new PlotOptionsLineDataLabelsTextPath();
			UseHTML = UseHTML_DefaultValue = false;
			VerticalAlign = VerticalAlign_DefaultValue = PlotOptionsLineDataLabelsVerticalAlign.Bottom;
			X = X_DefaultValue = 0;
			Y = Y_DefaultValue = 0;
			Z = Z_DefaultValue = 6;
		...
		/// </summary>
		public PlotOptionsLineDataLabelsAlign Align { get; set; }
		private PlotOptionsLineDataLabelsAlign Align_DefaultValue { get; set; }
		...
		/// </summary>
		public PlotOptionsLineDataLabelsFilter Filter { get; set; }
		private PlotOptionsLineDataLabelsFilter Filter_DefaultValue { get; set; }
		...
		/// </summary>
		public PlotOptionsLineDataLabelsStyle Style { get; set; }
		private PlotOptionsLineDataLabelsStyle Style_DefaultValue { get; set; }
		...
		/// </summary>
		public PlotOptionsLineDataLabelsTextPath TextPath { get; set; }
		private PlotOptionsLineDataLabelsTextPath TextPath_DefaultValue { get; set; }
		...
		/// </summary>
		public PlotOptionsLineDataLabelsVerticalAlign VerticalAlign { get; set; }
		private PlotOptionsLineDataLabelsVerticalAlign VerticalAlign_DefaultValue { get; set; }
		...
		internal override Hashtable ToHashtable()
		{
			...
			if (Formatter != Formatter_DefaultValue) { h.Add("formatter",Formatter); Highcharts.AddFunction("5f5ef4af-e065-4be9-aa30-75514622b66c.formatter", Formatter); }  
			...
			if (NullFormatter != NullFormatter_DefaultValue) { h.Add("nullFormatter",NullFormatter); Highcharts.AddFunction("d42651bc-3893-4a85-92b5-8a374ba78dcb.nullFormatter", NullFormatter); }  
