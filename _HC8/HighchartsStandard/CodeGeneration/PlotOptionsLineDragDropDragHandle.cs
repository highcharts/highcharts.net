...
namespace Highsoft.Web.Mvc.Charts
{
	public partial class PlotOptionsLineDragDropDragHandle  : BaseObject
	{
		...
		internal override Hashtable ToHashtable()
		{
			...
			if (PathFormatter != PathFormatter_DefaultValue) { h.Add("pathFormatter",PathFormatter); Highcharts.AddFunction("bfef331d-52e4-468f-b716-b16d9e7d6783.pathFormatter", PathFormatter); }  
