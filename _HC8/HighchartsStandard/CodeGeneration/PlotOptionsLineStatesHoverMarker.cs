...
{
	public partial class PlotOptionsLineStatesHoverMarker  : PlotOptionsSeries
	{
		...
		public PlotOptionsLineStatesHoverMarker()
		{
			...
			States = States_DefaultValue = new PlotOptionsLineStatesHoverMarkerStates();
		...
		/// </summary>
		public PlotOptionsLineStatesHoverMarkerStates States { get; set; }
		private PlotOptionsLineStatesHoverMarkerStates States_DefaultValue { get; set; }
