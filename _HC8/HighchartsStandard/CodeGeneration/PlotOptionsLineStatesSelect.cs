...
{
	public partial class PlotOptionsLineStatesSelect  : PlotOptionsSeries
	{
		Hashtable h = new Hashtable();

		public PlotOptionsLineStatesSelect()
		{
			Animation = Animation_DefaultValue = new Animation();
			Enabled = Enabled_DefaultValue = null;
			Halo = Halo_DefaultValue = new PlotOptionsLineStatesSelectHalo();
			LineWidth = LineWidth_DefaultValue = null;
			LineWidthPlus = LineWidthPlus_DefaultValue = null;
			Marker = Marker_DefaultValue = new PlotOptionsLineStatesSelectMarker();
		...
		/// </summary>
		public PlotOptionsLineStatesSelectHalo Halo { get; set; }
		private PlotOptionsLineStatesSelectHalo Halo_DefaultValue { get; set; }
		...
		/// </summary>
		public PlotOptionsLineStatesSelectMarker Marker { get; set; }
		private PlotOptionsLineStatesSelectMarker Marker_DefaultValue { get; set; }
