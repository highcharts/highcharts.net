...
{
	public partial class PlotOptionsLineStatesSelectMarker  : PlotOptionsSeries
	{
		...
		public PlotOptionsLineStatesSelectMarker()
		{
			...
			States = States_DefaultValue = new PlotOptionsLineStatesSelectMarkerStates();
		...
		/// </summary>
		public PlotOptionsLineStatesSelectMarkerStates States { get; set; }
		private PlotOptionsLineStatesSelectMarkerStates States_DefaultValue { get; set; }
