...
namespace Highsoft.Web.Mvc.Charts
{
	public partial class PlotOptionsLollipop  : BaseObject
	{
		...
		internal override Hashtable ToHashtable()
		{
			...
			if (PointDescriptionFormatter != PointDescriptionFormatter_DefaultValue) { h.Add("pointDescriptionFormatter",PointDescriptionFormatter); Highcharts.AddFunction("786a5ccd-67ae-4d8b-aed2-fcf596465ca1.pointDescriptionFormatter", PointDescriptionFormatter); }  
