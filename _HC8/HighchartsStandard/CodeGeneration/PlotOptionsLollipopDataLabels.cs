...
namespace Highsoft.Web.Mvc.Charts
{
	public partial class PlotOptionsLollipopDataLabels  : BaseObject
	{
		...
		public PlotOptionsLollipopDataLabels()
		{
			...
			Style = Style_DefaultValue = new PlotOptionsLollipopDataLabelsStyle();
		...
		/// </summary>
		public PlotOptionsLollipopDataLabelsStyle Style { get; set; }
		private PlotOptionsLollipopDataLabelsStyle Style_DefaultValue { get; set; }
		...
		internal override Hashtable ToHashtable()
		{
			...
			if (Formatter != Formatter_DefaultValue) { h.Add("formatter",Formatter); Highcharts.AddFunction("7fa06ed7-af94-4e5e-89ca-ca6f4084b209.formatter", Formatter); }  
			...
			if (NullFormatter != NullFormatter_DefaultValue) { h.Add("nullFormatter",NullFormatter); Highcharts.AddFunction("a682c068-03f0-4786-9038-112fedb49bc5.nullFormatter", NullFormatter); }  
