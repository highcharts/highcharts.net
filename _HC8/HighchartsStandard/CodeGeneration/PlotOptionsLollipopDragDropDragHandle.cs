...
namespace Highsoft.Web.Mvc.Charts
{
	public partial class PlotOptionsLollipopDragDropDragHandle  : BaseObject
	{
		...
		internal override Hashtable ToHashtable()
		{
			...
			if (PathFormatter != PathFormatter_DefaultValue) { h.Add("pathFormatter",PathFormatter); Highcharts.AddFunction("314b258d-7d15-4b3c-a599-52176638b71f.pathFormatter", PathFormatter); }  
