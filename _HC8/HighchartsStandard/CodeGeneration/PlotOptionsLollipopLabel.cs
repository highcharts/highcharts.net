...
{
	public partial class PlotOptionsLollipopLabel  : BaseObject
	{
		Hashtable h = new Hashtable();

		public PlotOptionsLollipopLabel()
		{
			...
			Style = Style_DefaultValue = new PlotOptionsLollipopLabelStyle();
		...
		/// </summary>
		public PlotOptionsLollipopLabelStyle Style { get; set; }
		private PlotOptionsLollipopLabelStyle Style_DefaultValue { get; set; }
		...
		internal override Hashtable ToHashtable()
		{
			...
			if (Formatter != Formatter_DefaultValue) { h.Add("formatter",Formatter); Highcharts.AddFunction("6cf7459e-18a1-47dd-bb13-1934b0fd753d.formatter", Formatter); }  
