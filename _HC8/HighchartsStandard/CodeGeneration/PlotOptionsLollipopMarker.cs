...
{
	public partial class PlotOptionsLollipopMarker  : PlotOptionsSeries
	{
		Hashtable h = new Hashtable();

		public PlotOptionsLollipopMarker()
		{
			...
			States = States_DefaultValue = new PlotOptionsLollipopMarkerStates();
		...
		/// </summary>
		public PlotOptionsLollipopMarkerStates States { get; set; }
		private PlotOptionsLollipopMarkerStates States_DefaultValue { get; set; }
