...
{
	public partial class PlotOptionsLollipopOnPoint  : BaseObject
	{
		Hashtable h = new Hashtable();

		public PlotOptionsLollipopOnPoint()
		{
			ConnectorOptions = ConnectorOptions_DefaultValue = new PlotOptionsLollipopOnPointConnectorOptions();
			Id = Id_DefaultValue = "";
			Position = Position_DefaultValue = new PlotOptionsLollipopOnPointPosition();
		...
		/// </summary>
		public PlotOptionsLollipopOnPointConnectorOptions ConnectorOptions { get; set; }
		private PlotOptionsLollipopOnPointConnectorOptions ConnectorOptions_DefaultValue { get; set; }
		...
		/// </summary>
		public PlotOptionsLollipopOnPointPosition Position { get; set; }
		private PlotOptionsLollipopOnPointPosition Position_DefaultValue { get; set; }
