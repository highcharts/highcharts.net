...
{
	public partial class PlotOptionsLollipopSonificationContextTracks  : BaseObject
	{
		Hashtable h = new Hashtable();

		public PlotOptionsLollipopSonificationContextTracks()
		{
			ActiveWhen = ActiveWhen_DefaultValue = new PlotOptionsLollipopSonificationContextTracksActiveWhen();
			Instrument = Instrument_DefaultValue = null;
			InstrumentString = InstrumentString_DefaultValue = "null";
			Mapping = Mapping_DefaultValue = new PlotOptionsLollipopSonificationContextTracksMapping();
			MidiName = MidiName_DefaultValue = "";
			PointGrouping = PointGrouping_DefaultValue = new PlotOptionsLollipopSonificationContextTracksPointGrouping();
			...
			Type = Type_DefaultValue = PlotOptionsLollipopSonificationContextTracksType.Instrument;
			ValueInterval = ValueInterval_DefaultValue = null;
			ValueMapFunction = ValueMapFunction_DefaultValue = PlotOptionsLollipopSonificationContextTracksValueMapFunction.Linear;
		...
		/// </summary>
		public PlotOptionsLollipopSonificationContextTracksActiveWhen ActiveWhen { get; set; }
		private PlotOptionsLollipopSonificationContextTracksActiveWhen ActiveWhen_DefaultValue { get; set; }
		...
		/// </summary>
		public PlotOptionsLollipopSonificationContextTracksMapping Mapping { get; set; }
		private PlotOptionsLollipopSonificationContextTracksMapping Mapping_DefaultValue { get; set; }
		...
		/// </summary>
		public PlotOptionsLollipopSonificationContextTracksPointGrouping PointGrouping { get; set; }
		private PlotOptionsLollipopSonificationContextTracksPointGrouping PointGrouping_DefaultValue { get; set; }
		...
		/// </summary>
		public PlotOptionsLollipopSonificationContextTracksType Type { get; set; }
		private PlotOptionsLollipopSonificationContextTracksType Type_DefaultValue { get; set; }
		...
		/// </summary>
		public PlotOptionsLollipopSonificationContextTracksValueMapFunction ValueMapFunction { get; set; }
		private PlotOptionsLollipopSonificationContextTracksValueMapFunction ValueMapFunction_DefaultValue { get; set; }
