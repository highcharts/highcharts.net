...
{
	public partial class PlotOptionsLollipopSonificationTracks  : BaseObject
	{
		Hashtable h = new Hashtable();

		public PlotOptionsLollipopSonificationTracks()
		{
			ActiveWhen = ActiveWhen_DefaultValue = new PlotOptionsLollipopSonificationTracksActiveWhen();
			Instrument = Instrument_DefaultValue = null;
			InstrumentString = InstrumentString_DefaultValue = "null";
			Mapping = Mapping_DefaultValue = new PlotOptionsLollipopSonificationTracksMapping();
			MidiName = MidiName_DefaultValue = "";
			PointGrouping = PointGrouping_DefaultValue = new PlotOptionsLollipopSonificationTracksPointGrouping();
			RoundToMusicalNotes = RoundToMusicalNotes_DefaultValue = true;
			ShowPlayMarker = ShowPlayMarker_DefaultValue = true;
			Type = Type_DefaultValue = PlotOptionsLollipopSonificationTracksType.Instrument;
		...
		/// </summary>
		public PlotOptionsLollipopSonificationTracksActiveWhen ActiveWhen { get; set; }
		private PlotOptionsLollipopSonificationTracksActiveWhen ActiveWhen_DefaultValue { get; set; }
		...
		/// </summary>
		public PlotOptionsLollipopSonificationTracksMapping Mapping { get; set; }
		private PlotOptionsLollipopSonificationTracksMapping Mapping_DefaultValue { get; set; }
		...
		/// </summary>
		public PlotOptionsLollipopSonificationTracksPointGrouping PointGrouping { get; set; }
		private PlotOptionsLollipopSonificationTracksPointGrouping PointGrouping_DefaultValue { get; set; }
		...
		/// </summary>
		public PlotOptionsLollipopSonificationTracksType Type { get; set; }
		private PlotOptionsLollipopSonificationTracksType Type_DefaultValue { get; set; }
