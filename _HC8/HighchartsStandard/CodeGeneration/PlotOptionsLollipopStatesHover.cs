...
{
	public partial class PlotOptionsLollipopStatesHover  : PlotOptionsSeries
	{
		Hashtable h = new Hashtable();

		public PlotOptionsLollipopStatesHover()
		{
			Animation = Animation_DefaultValue = new Animation();
			Enabled = Enabled_DefaultValue = null;
			Halo = Halo_DefaultValue = new PlotOptionsLollipopStatesHoverHalo();
			LineWidth = LineWidth_DefaultValue = null;
			LineWidthPlus = LineWidthPlus_DefaultValue = null;
			Marker = Marker_DefaultValue = new PlotOptionsLollipopStatesHoverMarker();
		...
		/// </summary>
		public PlotOptionsLollipopStatesHoverHalo Halo { get; set; }
		private PlotOptionsLollipopStatesHoverHalo Halo_DefaultValue { get; set; }
		...
		/// </summary>
		public PlotOptionsLollipopStatesHoverMarker Marker { get; set; }
		private PlotOptionsLollipopStatesHoverMarker Marker_DefaultValue { get; set; }
