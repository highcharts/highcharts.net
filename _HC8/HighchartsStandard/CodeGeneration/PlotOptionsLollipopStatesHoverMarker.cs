...
{
	public partial class PlotOptionsLollipopStatesHoverMarker  : PlotOptionsSeries
	{
		Hashtable h = new Hashtable();

		public PlotOptionsLollipopStatesHoverMarker()
		{
			...
			States = States_DefaultValue = new PlotOptionsLollipopStatesHoverMarkerStates();
		...
		/// </summary>
		public PlotOptionsLollipopStatesHoverMarkerStates States { get; set; }
		private PlotOptionsLollipopStatesHoverMarkerStates States_DefaultValue { get; set; }
