...
{
	public partial class PlotOptionsLollipopStatesHoverMarkerStatesHoverAnimation  : PlotOptionsSeries
	{
		Hashtable h = new Hashtable();

		public PlotOptionsLollipopStatesHoverMarkerStatesHoverAnimation()
		{
