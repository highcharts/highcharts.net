...
{
	public partial class PlotOptionsLollipopStatesSelect  : PlotOptionsSeries
	{
		Hashtable h = new Hashtable();

		public PlotOptionsLollipopStatesSelect()
		{
			Animation = Animation_DefaultValue = new Animation();
			Enabled = Enabled_DefaultValue = null;
			Halo = Halo_DefaultValue = new PlotOptionsLollipopStatesSelectHalo();
			LineWidth = LineWidth_DefaultValue = null;
			LineWidthPlus = LineWidthPlus_DefaultValue = null;
			Marker = Marker_DefaultValue = new PlotOptionsLollipopStatesSelectMarker();
		...
		/// </summary>
		public PlotOptionsLollipopStatesSelectHalo Halo { get; set; }
		private PlotOptionsLollipopStatesSelectHalo Halo_DefaultValue { get; set; }
		...
		/// </summary>
		public PlotOptionsLollipopStatesSelectMarker Marker { get; set; }
		private PlotOptionsLollipopStatesSelectMarker Marker_DefaultValue { get; set; }
