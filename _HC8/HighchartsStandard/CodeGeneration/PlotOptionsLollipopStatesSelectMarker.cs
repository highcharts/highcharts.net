...
{
	public partial class PlotOptionsLollipopStatesSelectMarker  : PlotOptionsSeries
	{
		Hashtable h = new Hashtable();

		public PlotOptionsLollipopStatesSelectMarker()
		{
			...
			States = States_DefaultValue = new PlotOptionsLollipopStatesSelectMarkerStates();
		...
		/// </summary>
		public PlotOptionsLollipopStatesSelectMarkerStates States { get; set; }
		private PlotOptionsLollipopStatesSelectMarkerStates States_DefaultValue { get; set; }
