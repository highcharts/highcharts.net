...
namespace Highsoft.Web.Mvc.Charts
{
	public partial class PlotOptionsNetworkgraph  : BaseObject
	{
		...
		internal override Hashtable ToHashtable()
		{
			...
			if (PointDescriptionFormatter != PointDescriptionFormatter_DefaultValue) { h.Add("pointDescriptionFormatter",PointDescriptionFormatter); Highcharts.AddFunction("a652d395-d617-45ec-8580-1a8ef7751f5d.pointDescriptionFormatter", PointDescriptionFormatter); }  
