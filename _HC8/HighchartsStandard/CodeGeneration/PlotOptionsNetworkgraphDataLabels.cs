...
namespace Highsoft.Web.Mvc.Charts
{
	public partial class PlotOptionsNetworkgraphDataLabels  : BaseObject
	{
		...
		internal override Hashtable ToHashtable()
		{
			...
			if (Formatter != Formatter_DefaultValue) { h.Add("formatter",Formatter); Highcharts.AddFunction("ef292332-736c-498f-8c0b-85de5891b851.formatter", Formatter); }  
			if (Inside != Inside_DefaultValue) h.Add("inside",Inside);
			if (LinkFormat != LinkFormat_DefaultValue) h.Add("linkFormat",LinkFormat);
			if (LinkFormatter != LinkFormatter_DefaultValue) { h.Add("linkFormatter",LinkFormatter); Highcharts.AddFunction("f6cd013c-532b-46f0-9865-e19057c62198.linkFormatter", LinkFormatter); }  
			...
			if (NullFormatter != NullFormatter_DefaultValue) { h.Add("nullFormatter",NullFormatter); Highcharts.AddFunction("0d7dd0a8-19fb-4c53-b887-99ae4afb66f5.nullFormatter", NullFormatter); }  
