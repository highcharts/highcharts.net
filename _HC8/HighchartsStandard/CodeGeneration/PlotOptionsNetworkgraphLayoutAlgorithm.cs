...
namespace Highsoft.Web.Mvc.Charts
{
	public partial class PlotOptionsNetworkgraphLayoutAlgorithm  : BaseObject
	{
		...
		internal override Hashtable ToHashtable()
		{
			...
			if (AttractiveForce != AttractiveForce_DefaultValue) { h.Add("attractiveForce",AttractiveForce); Highcharts.AddFunction("8cecd12b-433f-419b-bc5e-a3da283457a6.attractiveForce", AttractiveForce); }  
			...
			if (RepulsiveForce != RepulsiveForce_DefaultValue) { h.Add("repulsiveForce",RepulsiveForce); Highcharts.AddFunction("7de89a1c-e078-4803-a6bf-4f29ffc4d8bc.repulsiveForce", RepulsiveForce); }  
