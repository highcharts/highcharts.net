...
{
	public partial class PlotOptionsNetworkgraphMarker  : PlotOptionsSeries
	{
		Hashtable h = new Hashtable();

		public PlotOptionsNetworkgraphMarker()
		{
			...
			States = States_DefaultValue = new PlotOptionsNetworkgraphMarkerStates();
		...
		/// 
		/// </summary>
		public PlotOptionsNetworkgraphMarkerStates States { get; set; }
		private PlotOptionsNetworkgraphMarkerStates States_DefaultValue { get; set; }
