...
{
	public partial class PlotOptionsNetworkgraphMarkerStatesInactiveAnimation  : PlotOptionsSeries
	{
		Hashtable h = new Hashtable();

		public PlotOptionsNetworkgraphMarkerStatesInactiveAnimation()
		{
