...
{
	public partial class PlotOptionsNetworkgraphStatesHover  : PlotOptionsSeries
	{
		Hashtable h = new Hashtable();

		public PlotOptionsNetworkgraphStatesHover()
		{
			Animation = Animation_DefaultValue = new Animation();
			Enabled = Enabled_DefaultValue = null;
			Halo = Halo_DefaultValue = new PlotOptionsNetworkgraphStatesHoverHalo();
			LineWidth = LineWidth_DefaultValue = null;
			LineWidthPlus = LineWidthPlus_DefaultValue = null;
			Marker = Marker_DefaultValue = new PlotOptionsNetworkgraphStatesHoverMarker();
		...
		/// </summary>
		public PlotOptionsNetworkgraphStatesHoverHalo Halo { get; set; }
		private PlotOptionsNetworkgraphStatesHoverHalo Halo_DefaultValue { get; set; }
		...
		/// </summary>
		public PlotOptionsNetworkgraphStatesHoverMarker Marker { get; set; }
		private PlotOptionsNetworkgraphStatesHoverMarker Marker_DefaultValue { get; set; }
