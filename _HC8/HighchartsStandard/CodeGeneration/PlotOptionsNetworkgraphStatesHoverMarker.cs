...
{
	public partial class PlotOptionsNetworkgraphStatesHoverMarker  : PlotOptionsSeries
	{
		Hashtable h = new Hashtable();

		public PlotOptionsNetworkgraphStatesHoverMarker()
		{
			...
			States = States_DefaultValue = new PlotOptionsNetworkgraphStatesHoverMarkerStates();
		...
		/// </summary>
		public PlotOptionsNetworkgraphStatesHoverMarkerStates States { get; set; }
		private PlotOptionsNetworkgraphStatesHoverMarkerStates States_DefaultValue { get; set; }
