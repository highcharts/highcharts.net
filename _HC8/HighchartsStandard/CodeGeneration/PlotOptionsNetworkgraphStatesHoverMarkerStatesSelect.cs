...
{
	public partial class PlotOptionsNetworkgraphStatesHoverMarkerStatesSelect  : PlotOptionsSeries
	{
		Hashtable h = new Hashtable();

		public PlotOptionsNetworkgraphStatesHoverMarkerStatesSelect()
		{
