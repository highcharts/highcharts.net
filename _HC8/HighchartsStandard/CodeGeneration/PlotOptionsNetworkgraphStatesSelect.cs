...
{
	public partial class PlotOptionsNetworkgraphStatesSelect  : PlotOptionsSeries
	{
		Hashtable h = new Hashtable();

		public PlotOptionsNetworkgraphStatesSelect()
		{
			Animation = Animation_DefaultValue = new Animation();
			Enabled = Enabled_DefaultValue = null;
			Halo = Halo_DefaultValue = new PlotOptionsNetworkgraphStatesSelectHalo();
			LineWidth = LineWidth_DefaultValue = null;
			LineWidthPlus = LineWidthPlus_DefaultValue = null;
			Marker = Marker_DefaultValue = new PlotOptionsNetworkgraphStatesSelectMarker();
		...
		/// </summary>
		public PlotOptionsNetworkgraphStatesSelectHalo Halo { get; set; }
		private PlotOptionsNetworkgraphStatesSelectHalo Halo_DefaultValue { get; set; }
		...
		/// </summary>
		public PlotOptionsNetworkgraphStatesSelectMarker Marker { get; set; }
		private PlotOptionsNetworkgraphStatesSelectMarker Marker_DefaultValue { get; set; }
