...
{
	public partial class PlotOptionsNetworkgraphStatesSelectMarker  : PlotOptionsSeries
	{
		Hashtable h = new Hashtable();

		public PlotOptionsNetworkgraphStatesSelectMarker()
		{
			...
			States = States_DefaultValue = new PlotOptionsNetworkgraphStatesSelectMarkerStates();
		...
		/// </summary>
		public PlotOptionsNetworkgraphStatesSelectMarkerStates States { get; set; }
		private PlotOptionsNetworkgraphStatesSelectMarkerStates States_DefaultValue { get; set; }
