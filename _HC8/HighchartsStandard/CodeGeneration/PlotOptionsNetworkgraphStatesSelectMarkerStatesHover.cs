...
{
	public partial class PlotOptionsNetworkgraphStatesSelectMarkerStatesHover  : PlotOptionsSeries
	{
		Hashtable h = new Hashtable();

		public PlotOptionsNetworkgraphStatesSelectMarkerStatesHover()
		{
