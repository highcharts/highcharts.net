...
{
	public partial class PlotOptionsNetworkgraphStatesSelectMarkerStatesHoverAnimation  : PlotOptionsSeries
	{
		Hashtable h = new Hashtable();

		public PlotOptionsNetworkgraphStatesSelectMarkerStatesHoverAnimation()
		{
