...
namespace Highsoft.Web.Mvc.Charts
{
	public partial class PlotOptionsOrganization  : BaseObject
	{
		...
		internal override Hashtable ToHashtable()
		{
			...
			if (PointDescriptionFormatter != PointDescriptionFormatter_DefaultValue) { h.Add("pointDescriptionFormatter",PointDescriptionFormatter); Highcharts.AddFunction("defc0c54-b357-49d4-82ed-7b4dd95fe401.pointDescriptionFormatter", PointDescriptionFormatter); }  
