...
{
	public partial class PlotOptionsOrganizationDragDrop  : BaseObject
	{
		Hashtable h = new Hashtable();

		public PlotOptionsOrganizationDragDrop()
		{
			DraggableX = DraggableX_DefaultValue = null;
			DraggableY = DraggableY_DefaultValue = null;
			DragHandle = DragHandle_DefaultValue = new PlotOptionsOrganizationDragDropDragHandle();
			...
			GuideBox = GuideBox_DefaultValue = new PlotOptionsOrganizationDragDropGuideBox();
		...
		/// </summary>
		public PlotOptionsOrganizationDragDropDragHandle DragHandle { get; set; }
		private PlotOptionsOrganizationDragDropDragHandle DragHandle_DefaultValue { get; set; }
		...
		/// </summary>
		public PlotOptionsOrganizationDragDropGuideBox GuideBox { get; set; }
		private PlotOptionsOrganizationDragDropGuideBox GuideBox_DefaultValue { get; set; }
