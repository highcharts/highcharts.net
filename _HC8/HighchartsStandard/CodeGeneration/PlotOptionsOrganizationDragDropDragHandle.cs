...
namespace Highsoft.Web.Mvc.Charts
{
	public partial class PlotOptionsOrganizationDragDropDragHandle  : BaseObject
	{
		...
		internal override Hashtable ToHashtable()
		{
			...
			if (PathFormatter != PathFormatter_DefaultValue) { h.Add("pathFormatter",PathFormatter); Highcharts.AddFunction("911ef74c-188a-4956-ad73-b2da2e149111.pathFormatter", PathFormatter); }  
