...
{
	public partial class PlotOptionsOrganizationLabel  : BaseObject
	{
		Hashtable h = new Hashtable();

		public PlotOptionsOrganizationLabel()
		{
			...
			Style = Style_DefaultValue = new PlotOptionsOrganizationLabelStyle();
		...
		/// </summary>
		public PlotOptionsOrganizationLabelStyle Style { get; set; }
		private PlotOptionsOrganizationLabelStyle Style_DefaultValue { get; set; }
		...
		internal override Hashtable ToHashtable()
		{
			...
			if (Formatter != Formatter_DefaultValue) { h.Add("formatter",Formatter); Highcharts.AddFunction("13c96036-73a5-4af5-9ff8-83a22e9ddbb3.formatter", Formatter); }  
