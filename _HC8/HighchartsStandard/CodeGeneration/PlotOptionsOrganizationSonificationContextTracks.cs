...
{
	public partial class PlotOptionsOrganizationSonificationContextTracks  : BaseObject
	{
		Hashtable h = new Hashtable();

		public PlotOptionsOrganizationSonificationContextTracks()
		{
			ActiveWhen = ActiveWhen_DefaultValue = new PlotOptionsOrganizationSonificationContextTracksActiveWhen();
			Instrument = Instrument_DefaultValue = null;
			InstrumentString = InstrumentString_DefaultValue = "null";
			Mapping = Mapping_DefaultValue = new PlotOptionsOrganizationSonificationContextTracksMapping();
			MidiName = MidiName_DefaultValue = "";
			PointGrouping = PointGrouping_DefaultValue = new PlotOptionsOrganizationSonificationContextTracksPointGrouping();
			...
			Type = Type_DefaultValue = PlotOptionsOrganizationSonificationContextTracksType.Instrument;
			ValueInterval = ValueInterval_DefaultValue = null;
			ValueMapFunction = ValueMapFunction_DefaultValue = PlotOptionsOrganizationSonificationContextTracksValueMapFunction.Linear;
		...
		/// </summary>
		public PlotOptionsOrganizationSonificationContextTracksActiveWhen ActiveWhen { get; set; }
		private PlotOptionsOrganizationSonificationContextTracksActiveWhen ActiveWhen_DefaultValue { get; set; }
		...
		/// </summary>
		public PlotOptionsOrganizationSonificationContextTracksMapping Mapping { get; set; }
		private PlotOptionsOrganizationSonificationContextTracksMapping Mapping_DefaultValue { get; set; }
		...
		/// </summary>
		public PlotOptionsOrganizationSonificationContextTracksPointGrouping PointGrouping { get; set; }
		private PlotOptionsOrganizationSonificationContextTracksPointGrouping PointGrouping_DefaultValue { get; set; }
		...
		/// </summary>
		public PlotOptionsOrganizationSonificationContextTracksType Type { get; set; }
		private PlotOptionsOrganizationSonificationContextTracksType Type_DefaultValue { get; set; }
		...
		/// </summary>
		public PlotOptionsOrganizationSonificationContextTracksValueMapFunction ValueMapFunction { get; set; }
		private PlotOptionsOrganizationSonificationContextTracksValueMapFunction ValueMapFunction_DefaultValue { get; set; }
