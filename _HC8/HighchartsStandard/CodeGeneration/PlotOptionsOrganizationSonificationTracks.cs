...
{
	public partial class PlotOptionsOrganizationSonificationTracks  : BaseObject
	{
		Hashtable h = new Hashtable();

		public PlotOptionsOrganizationSonificationTracks()
		{
			ActiveWhen = ActiveWhen_DefaultValue = new PlotOptionsOrganizationSonificationTracksActiveWhen();
			Instrument = Instrument_DefaultValue = null;
			InstrumentString = InstrumentString_DefaultValue = "null";
			Mapping = Mapping_DefaultValue = new PlotOptionsOrganizationSonificationTracksMapping();
			MidiName = MidiName_DefaultValue = "";
			PointGrouping = PointGrouping_DefaultValue = new PlotOptionsOrganizationSonificationTracksPointGrouping();
			RoundToMusicalNotes = RoundToMusicalNotes_DefaultValue = true;
			ShowPlayMarker = ShowPlayMarker_DefaultValue = true;
			Type = Type_DefaultValue = PlotOptionsOrganizationSonificationTracksType.Instrument;
		...
		/// </summary>
		public PlotOptionsOrganizationSonificationTracksActiveWhen ActiveWhen { get; set; }
		private PlotOptionsOrganizationSonificationTracksActiveWhen ActiveWhen_DefaultValue { get; set; }
		...
		/// </summary>
		public PlotOptionsOrganizationSonificationTracksMapping Mapping { get; set; }
		private PlotOptionsOrganizationSonificationTracksMapping Mapping_DefaultValue { get; set; }
		...
		/// </summary>
		public PlotOptionsOrganizationSonificationTracksPointGrouping PointGrouping { get; set; }
		private PlotOptionsOrganizationSonificationTracksPointGrouping PointGrouping_DefaultValue { get; set; }
		...
		/// </summary>
		public PlotOptionsOrganizationSonificationTracksType Type { get; set; }
		private PlotOptionsOrganizationSonificationTracksType Type_DefaultValue { get; set; }
