...
{
	public partial class PlotOptionsOrganizationStatesHover  : PlotOptionsSeries
	{
		Hashtable h = new Hashtable();

		public PlotOptionsOrganizationStatesHover()
		{
			Animation = Animation_DefaultValue = new Animation();
			Enabled = Enabled_DefaultValue = null;
			Halo = Halo_DefaultValue = new PlotOptionsOrganizationStatesHoverHalo();
			LineWidth = LineWidth_DefaultValue = null;
			LineWidthPlus = LineWidthPlus_DefaultValue = null;
			Marker = Marker_DefaultValue = new PlotOptionsOrganizationStatesHoverMarker();
		...
		/// </summary>
		public PlotOptionsOrganizationStatesHoverHalo Halo { get; set; }
		private PlotOptionsOrganizationStatesHoverHalo Halo_DefaultValue { get; set; }
		...
		/// </summary>
		public PlotOptionsOrganizationStatesHoverMarker Marker { get; set; }
		private PlotOptionsOrganizationStatesHoverMarker Marker_DefaultValue { get; set; }
