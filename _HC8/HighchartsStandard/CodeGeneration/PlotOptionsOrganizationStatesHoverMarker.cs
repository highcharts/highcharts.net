...
{
	public partial class PlotOptionsOrganizationStatesHoverMarker  : PlotOptionsSeries
	{
		Hashtable h = new Hashtable();

		public PlotOptionsOrganizationStatesHoverMarker()
		{
			...
			States = States_DefaultValue = new PlotOptionsOrganizationStatesHoverMarkerStates();
		...
		/// </summary>
		public PlotOptionsOrganizationStatesHoverMarkerStates States { get; set; }
		private PlotOptionsOrganizationStatesHoverMarkerStates States_DefaultValue { get; set; }
