...
{
	public partial class PlotOptionsOrganizationStatesHoverMarkerStatesHoverAnimation  : PlotOptionsSeries
	{
		Hashtable h = new Hashtable();

		public PlotOptionsOrganizationStatesHoverMarkerStatesHoverAnimation()
		{
