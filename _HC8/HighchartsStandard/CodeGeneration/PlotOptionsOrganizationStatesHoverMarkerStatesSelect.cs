...
{
	public partial class PlotOptionsOrganizationStatesHoverMarkerStatesSelect  : PlotOptionsSeries
	{
		Hashtable h = new Hashtable();

		public PlotOptionsOrganizationStatesHoverMarkerStatesSelect()
		{
