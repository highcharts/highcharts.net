...
{
	public partial class PlotOptionsOrganizationStatesSelect  : PlotOptionsSeries
	{
		Hashtable h = new Hashtable();

		public PlotOptionsOrganizationStatesSelect()
		{
			Animation = Animation_DefaultValue = new Animation();
			Enabled = Enabled_DefaultValue = null;
			Halo = Halo_DefaultValue = new PlotOptionsOrganizationStatesSelectHalo();
			LineWidth = LineWidth_DefaultValue = null;
			LineWidthPlus = LineWidthPlus_DefaultValue = null;
			Marker = Marker_DefaultValue = new PlotOptionsOrganizationStatesSelectMarker();
		...
		/// </summary>
		public PlotOptionsOrganizationStatesSelectHalo Halo { get; set; }
		private PlotOptionsOrganizationStatesSelectHalo Halo_DefaultValue { get; set; }
		...
		/// </summary>
		public PlotOptionsOrganizationStatesSelectMarker Marker { get; set; }
		private PlotOptionsOrganizationStatesSelectMarker Marker_DefaultValue { get; set; }
