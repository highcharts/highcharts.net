...
{
	public partial class PlotOptionsOrganizationStatesSelectMarker  : PlotOptionsSeries
	{
		Hashtable h = new Hashtable();

		public PlotOptionsOrganizationStatesSelectMarker()
		{
			...
			States = States_DefaultValue = new PlotOptionsOrganizationStatesSelectMarkerStates();
		...
		/// </summary>
		public PlotOptionsOrganizationStatesSelectMarkerStates States { get; set; }
		private PlotOptionsOrganizationStatesSelectMarkerStates States_DefaultValue { get; set; }
