...
{
	public partial class PlotOptionsOrganizationStatesSelectMarkerStatesHover  : PlotOptionsSeries
	{
		Hashtable h = new Hashtable();

		public PlotOptionsOrganizationStatesSelectMarkerStatesHover()
		{
