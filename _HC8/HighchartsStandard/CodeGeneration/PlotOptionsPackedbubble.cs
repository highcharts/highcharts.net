...
namespace Highsoft.Web.Mvc.Charts
{
	public partial class PlotOptionsPackedbubble  : BaseObject
	{
		...
		public PlotOptionsPackedbubble()
		{
			...
			DataSorting = DataSorting_DefaultValue = new PlotOptionsPackedbubbleDataSorting();
		...
		/// </summary>
		public PlotOptionsPackedbubbleDataSorting DataSorting { get; set; }
		private PlotOptionsPackedbubbleDataSorting DataSorting_DefaultValue { get; set; }
		...
		internal override Hashtable ToHashtable()
		{
			...
			if (PointDescriptionFormatter != PointDescriptionFormatter_DefaultValue) { h.Add("pointDescriptionFormatter",PointDescriptionFormatter); Highcharts.AddFunction("b387ef83-71dc-4533-8719-b1fffd4798ee.pointDescriptionFormatter", PointDescriptionFormatter); }  
