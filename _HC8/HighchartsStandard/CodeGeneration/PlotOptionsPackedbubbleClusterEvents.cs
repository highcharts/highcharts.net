...
{
	public partial class PlotOptionsPackedbubbleClusterEvents  : BaseObject
	{
		Hashtable h = new Hashtable();

		public PlotOptionsPackedbubbleClusterEvents()
		{
		...
		internal override Hashtable ToHashtable()
		{
			...
			if (DrillToCluster != DrillToCluster_DefaultValue) { h.Add("drillToCluster",DrillToCluster); Highcharts.AddFunction("193d08cf-7a55-4bbb-939e-9dcb30d6eeac.drillToCluster", DrillToCluster); }  
