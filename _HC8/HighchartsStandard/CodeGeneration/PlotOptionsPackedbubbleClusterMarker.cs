...
{
	public partial class PlotOptionsPackedbubbleClusterMarker  : BaseObject
	{
		Hashtable h = new Hashtable();

		public PlotOptionsPackedbubbleClusterMarker()
		{
			...
			States = States_DefaultValue = new PlotOptionsPackedbubbleClusterMarkerStates();
		...
		/// </summary>
		public PlotOptionsPackedbubbleClusterMarkerStates States { get; set; }
		private PlotOptionsPackedbubbleClusterMarkerStates States_DefaultValue { get; set; }
