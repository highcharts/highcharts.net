...
{
	public partial class PlotOptionsPackedbubbleClusterMarkerStatesHoverAnimation  : BaseObject
	{
		Hashtable h = new Hashtable();

		public PlotOptionsPackedbubbleClusterMarkerStatesHoverAnimation()
		{
