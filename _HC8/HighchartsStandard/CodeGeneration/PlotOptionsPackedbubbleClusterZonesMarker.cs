...
{
	public partial class PlotOptionsPackedbubbleClusterZonesMarker  : BaseObject
	{
		Hashtable h = new Hashtable();

		public PlotOptionsPackedbubbleClusterZonesMarker()
		{
			...
			States = States_DefaultValue = new PlotOptionsPackedbubbleClusterZonesMarkerStates();
		...
		/// </summary>
		public PlotOptionsPackedbubbleClusterZonesMarkerStates States { get; set; }
		private PlotOptionsPackedbubbleClusterZonesMarkerStates States_DefaultValue { get; set; }
