...
{
	public partial class PlotOptionsPackedbubbleClusterZonesMarkerStatesHoverAnimation  : BaseObject
	{
		Hashtable h = new Hashtable();

		public PlotOptionsPackedbubbleClusterZonesMarkerStatesHoverAnimation()
		{
