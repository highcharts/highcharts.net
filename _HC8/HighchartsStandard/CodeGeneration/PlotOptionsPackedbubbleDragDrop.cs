...
{
	public partial class PlotOptionsPackedbubbleDragDrop  : BaseObject
	{
		Hashtable h = new Hashtable();

		public PlotOptionsPackedbubbleDragDrop()
		{
			DraggableX = DraggableX_DefaultValue = null;
			DraggableY = DraggableY_DefaultValue = null;
			DragHandle = DragHandle_DefaultValue = new PlotOptionsPackedbubbleDragDropDragHandle();
			...
			GuideBox = GuideBox_DefaultValue = new PlotOptionsPackedbubbleDragDropGuideBox();
		...
		/// </summary>
		public PlotOptionsPackedbubbleDragDropDragHandle DragHandle { get; set; }
		private PlotOptionsPackedbubbleDragDropDragHandle DragHandle_DefaultValue { get; set; }
		...
		/// </summary>
		public PlotOptionsPackedbubbleDragDropGuideBox GuideBox { get; set; }
		private PlotOptionsPackedbubbleDragDropGuideBox GuideBox_DefaultValue { get; set; }
