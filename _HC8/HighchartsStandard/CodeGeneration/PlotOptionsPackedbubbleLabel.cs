...
{
	public partial class PlotOptionsPackedbubbleLabel  : BaseObject
	{
		Hashtable h = new Hashtable();

		public PlotOptionsPackedbubbleLabel()
		{
			...
			Style = Style_DefaultValue = new PlotOptionsPackedbubbleLabelStyle();
		...
		/// </summary>
		public PlotOptionsPackedbubbleLabelStyle Style { get; set; }
		private PlotOptionsPackedbubbleLabelStyle Style_DefaultValue { get; set; }
		...
		internal override Hashtable ToHashtable()
		{
			...
			if (Formatter != Formatter_DefaultValue) { h.Add("formatter",Formatter); Highcharts.AddFunction("4137366b-4b2b-4cd6-87f4-0483ca4e4f56.formatter", Formatter); }  
