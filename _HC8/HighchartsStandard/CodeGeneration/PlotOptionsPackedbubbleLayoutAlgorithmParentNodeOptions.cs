...
namespace Highsoft.Web.Mvc.Charts
{
	public partial class PlotOptionsPackedbubbleLayoutAlgorithmParentNodeOptions  : BaseObject
	{
		...
		{
			Approximation = Approximation_DefaultValue = PlotOptionsPackedbubbleLayoutAlgorithmParentNodeOptionsApproximation.None;
		...
		/// </summary>
		public PlotOptionsPackedbubbleLayoutAlgorithmParentNodeOptionsApproximation Approximation { get; set; }
		private PlotOptionsPackedbubbleLayoutAlgorithmParentNodeOptionsApproximation Approximation_DefaultValue { get; set; }
