...
{
	public partial class PlotOptionsPackedbubbleStatesHover  : PlotOptionsSeries
	{
		Hashtable h = new Hashtable();

		public PlotOptionsPackedbubbleStatesHover()
		{
			Animation = Animation_DefaultValue = new Animation();
			Enabled = Enabled_DefaultValue = null;
			Halo = Halo_DefaultValue = new PlotOptionsPackedbubbleStatesHoverHalo();
			LineWidth = LineWidth_DefaultValue = null;
			LineWidthPlus = LineWidthPlus_DefaultValue = null;
			Marker = Marker_DefaultValue = new PlotOptionsPackedbubbleStatesHoverMarker();
		...
		/// </summary>
		public PlotOptionsPackedbubbleStatesHoverHalo Halo { get; set; }
		private PlotOptionsPackedbubbleStatesHoverHalo Halo_DefaultValue { get; set; }
		...
		/// </summary>
		public PlotOptionsPackedbubbleStatesHoverMarker Marker { get; set; }
		private PlotOptionsPackedbubbleStatesHoverMarker Marker_DefaultValue { get; set; }
