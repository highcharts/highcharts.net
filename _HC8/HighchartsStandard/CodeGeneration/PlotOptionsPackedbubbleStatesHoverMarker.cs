...
{
	public partial class PlotOptionsPackedbubbleStatesHoverMarker  : PlotOptionsSeries
	{
		...
		public PlotOptionsPackedbubbleStatesHoverMarker()
		{
			...
			States = States_DefaultValue = new PlotOptionsPackedbubbleStatesHoverMarkerStates();
		...
		/// </summary>
		public PlotOptionsPackedbubbleStatesHoverMarkerStates States { get; set; }
		private PlotOptionsPackedbubbleStatesHoverMarkerStates States_DefaultValue { get; set; }
