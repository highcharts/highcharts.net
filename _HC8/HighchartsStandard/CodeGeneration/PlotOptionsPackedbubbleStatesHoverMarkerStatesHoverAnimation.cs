...
{
	public partial class PlotOptionsPackedbubbleStatesHoverMarkerStatesHoverAnimation  : PlotOptionsSeries
	{
		Hashtable h = new Hashtable();

		public PlotOptionsPackedbubbleStatesHoverMarkerStatesHoverAnimation()
		{
