...
{
	public partial class PlotOptionsPackedbubbleStatesHoverMarkerStatesSelect  : PlotOptionsSeries
	{
		Hashtable h = new Hashtable();

		public PlotOptionsPackedbubbleStatesHoverMarkerStatesSelect()
		{
