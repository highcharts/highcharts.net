...
{
	public partial class PlotOptionsPackedbubbleStatesSelect  : PlotOptionsSeries
	{
		Hashtable h = new Hashtable();

		public PlotOptionsPackedbubbleStatesSelect()
		{
			Animation = Animation_DefaultValue = new Animation();
			Enabled = Enabled_DefaultValue = null;
			Halo = Halo_DefaultValue = new PlotOptionsPackedbubbleStatesSelectHalo();
			LineWidth = LineWidth_DefaultValue = null;
			LineWidthPlus = LineWidthPlus_DefaultValue = null;
			Marker = Marker_DefaultValue = new PlotOptionsPackedbubbleStatesSelectMarker();
		...
		/// </summary>
		public PlotOptionsPackedbubbleStatesSelectHalo Halo { get; set; }
		private PlotOptionsPackedbubbleStatesSelectHalo Halo_DefaultValue { get; set; }
		...
		/// </summary>
		public PlotOptionsPackedbubbleStatesSelectMarker Marker { get; set; }
		private PlotOptionsPackedbubbleStatesSelectMarker Marker_DefaultValue { get; set; }
