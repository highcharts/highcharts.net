...
{
	public partial class PlotOptionsPackedbubbleStatesSelectMarker  : PlotOptionsSeries
	{
		Hashtable h = new Hashtable();

		public PlotOptionsPackedbubbleStatesSelectMarker()
		{
			...
			States = States_DefaultValue = new PlotOptionsPackedbubbleStatesSelectMarkerStates();
		...
		/// </summary>
		public PlotOptionsPackedbubbleStatesSelectMarkerStates States { get; set; }
		private PlotOptionsPackedbubbleStatesSelectMarkerStates States_DefaultValue { get; set; }
