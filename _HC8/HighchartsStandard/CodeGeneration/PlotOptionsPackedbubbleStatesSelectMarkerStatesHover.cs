...
{
	public partial class PlotOptionsPackedbubbleStatesSelectMarkerStatesHover  : PlotOptionsSeries
	{
		Hashtable h = new Hashtable();

		public PlotOptionsPackedbubbleStatesSelectMarkerStatesHover()
		{
