...
namespace Highsoft.Web.Mvc.Charts
{
	public partial class PlotOptionsPareto  : BaseObject
	{
		...
		{
			Accessibility = Accessibility_DefaultValue = new PlotOptionsParetoAccessibility();
			AllowPointSelect = AllowPointSelect_DefaultValue = false;
			Animation = Animation_DefaultValue = new Animation() { Enabled = true };
			AnimationLimit = AnimationLimit_DefaultValue = null;
			BoostBlending = BoostBlending_DefaultValue = PlotOptionsParetoBoostBlending.Undefined;
			...
			DashStyle = DashStyle_DefaultValue = PlotOptionsParetoDashStyle.Null;
			DataLabels = DataLabels_DefaultValue = new PlotOptionsParetoDataLabels();
			DataSorting = DataSorting_DefaultValue = new PlotOptionsParetoDataSorting();
			Description = Description_DefaultValue = "";
			DragDrop = DragDrop_DefaultValue = new PlotOptionsParetoDragDrop();
		...
		/// </summary>
		public PlotOptionsParetoAccessibility Accessibility { get; set; }
		private PlotOptionsParetoAccessibility Accessibility_DefaultValue { get; set; }
		...
		/// </summary>
		public PlotOptionsParetoBoostBlending BoostBlending { get; set; }
		private PlotOptionsParetoBoostBlending BoostBlending_DefaultValue { get; set; }
		...
		/// </summary>
		public PlotOptionsParetoDataSorting DataSorting { get; set; }
		private PlotOptionsParetoDataSorting DataSorting_DefaultValue { get; set; }
		...
		/// </summary>
		public PlotOptionsParetoDragDrop DragDrop { get; set; }
		private PlotOptionsParetoDragDrop DragDrop_DefaultValue { get; set; }
		...
		internal override Hashtable ToHashtable()
		{
			...
			if (PointDescriptionFormatter != PointDescriptionFormatter_DefaultValue) { h.Add("pointDescriptionFormatter",PointDescriptionFormatter); Highcharts.AddFunction("a29a5bde-e0fb-406c-b536-9b8c08516804.pointDescriptionFormatter", PointDescriptionFormatter); }  
