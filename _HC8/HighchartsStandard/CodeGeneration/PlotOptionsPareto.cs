...
namespace Highsoft.Web.Mvc.Charts
{
	public partial class PlotOptionsPareto  : BaseObject
	{
		...
		internal override Hashtable ToHashtable()
		{
			...
			if (PointDescriptionFormatter != PointDescriptionFormatter_DefaultValue) { h.Add("pointDescriptionFormatter",PointDescriptionFormatter); Highcharts.AddFunction("3f87d695-ed11-4575-8dad-cf9d000c3bd3.pointDescriptionFormatter", PointDescriptionFormatter); }  
