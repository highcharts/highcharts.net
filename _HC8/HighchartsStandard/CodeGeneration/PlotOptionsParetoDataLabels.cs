...
{
	public partial class PlotOptionsParetoDataLabels  : BaseObject
	{
		Hashtable h = new Hashtable();

		public PlotOptionsParetoDataLabels()
		{
			Align = Align_DefaultValue = PlotOptionsParetoDataLabelsAlign.Center;
			...
			Filter = Filter_DefaultValue = new PlotOptionsParetoDataLabelsFilter();
			...
			Style = Style_DefaultValue = new PlotOptionsParetoDataLabelsStyle();
			TextPath = TextPath_DefaultValue = new PlotOptionsParetoDataLabelsTextPath();
			UseHTML = UseHTML_DefaultValue = false;
			VerticalAlign = VerticalAlign_DefaultValue = PlotOptionsParetoDataLabelsVerticalAlign.Bottom;
			X = X_DefaultValue = 0;
			Y = Y_DefaultValue = 0;
			Z = Z_DefaultValue = 6;
		...
		/// </summary>
		public PlotOptionsParetoDataLabelsAlign Align { get; set; }
		private PlotOptionsParetoDataLabelsAlign Align_DefaultValue { get; set; }
		...
		/// </summary>
		public PlotOptionsParetoDataLabelsFilter Filter { get; set; }
		private PlotOptionsParetoDataLabelsFilter Filter_DefaultValue { get; set; }
		...
		/// </summary>
		public PlotOptionsParetoDataLabelsStyle Style { get; set; }
		private PlotOptionsParetoDataLabelsStyle Style_DefaultValue { get; set; }
		...
		/// </summary>
		public PlotOptionsParetoDataLabelsTextPath TextPath { get; set; }
		private PlotOptionsParetoDataLabelsTextPath TextPath_DefaultValue { get; set; }
		...
		/// </summary>
		public PlotOptionsParetoDataLabelsVerticalAlign VerticalAlign { get; set; }
		private PlotOptionsParetoDataLabelsVerticalAlign VerticalAlign_DefaultValue { get; set; }
		...
		internal override Hashtable ToHashtable()
		{
			...
			if (Formatter != Formatter_DefaultValue) { h.Add("formatter",Formatter); Highcharts.AddFunction("8312a833-3565-4415-b3e6-ab09a9bfa240.formatter", Formatter); }  
			...
			if (NullFormatter != NullFormatter_DefaultValue) { h.Add("nullFormatter",NullFormatter); Highcharts.AddFunction("d36196cf-cc00-45b9-b4f2-f1e72380319a.nullFormatter", NullFormatter); }  
