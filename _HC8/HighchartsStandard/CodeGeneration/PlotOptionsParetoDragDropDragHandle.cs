...
namespace Highsoft.Web.Mvc.Charts
{
	public partial class PlotOptionsParetoDragDropDragHandle  : BaseObject
	{
		...
		internal override Hashtable ToHashtable()
		{
			...
			if (PathFormatter != PathFormatter_DefaultValue) { h.Add("pathFormatter",PathFormatter); Highcharts.AddFunction("07e69638-45f2-40e6-8690-64331e4aa552.pathFormatter", PathFormatter); }  
