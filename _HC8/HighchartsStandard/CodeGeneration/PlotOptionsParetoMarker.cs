...
{
	public partial class PlotOptionsParetoMarker  : PlotOptionsSeries
	{
		Hashtable h = new Hashtable();

		public PlotOptionsParetoMarker()
		{
			...
			States = States_DefaultValue = new PlotOptionsParetoMarkerStates();
		...
		/// </summary>
		public PlotOptionsParetoMarkerStates States { get; set; }
		private PlotOptionsParetoMarkerStates States_DefaultValue { get; set; }
