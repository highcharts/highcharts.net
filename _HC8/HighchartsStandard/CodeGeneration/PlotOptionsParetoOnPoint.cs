...
{
	public partial class PlotOptionsParetoOnPoint  : BaseObject
	{
		Hashtable h = new Hashtable();

		public PlotOptionsParetoOnPoint()
		{
			ConnectorOptions = ConnectorOptions_DefaultValue = new PlotOptionsParetoOnPointConnectorOptions();
			Id = Id_DefaultValue = "";
			Position = Position_DefaultValue = new PlotOptionsParetoOnPointPosition();
		...
		/// </summary>
		public PlotOptionsParetoOnPointConnectorOptions ConnectorOptions { get; set; }
		private PlotOptionsParetoOnPointConnectorOptions ConnectorOptions_DefaultValue { get; set; }
		...
		/// </summary>
		public PlotOptionsParetoOnPointPosition Position { get; set; }
		private PlotOptionsParetoOnPointPosition Position_DefaultValue { get; set; }
