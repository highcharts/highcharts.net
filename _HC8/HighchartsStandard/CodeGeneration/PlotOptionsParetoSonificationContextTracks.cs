...
{
	public partial class PlotOptionsParetoSonificationContextTracks  : BaseObject
	{
		Hashtable h = new Hashtable();

		public PlotOptionsParetoSonificationContextTracks()
		{
			ActiveWhen = ActiveWhen_DefaultValue = new PlotOptionsParetoSonificationContextTracksActiveWhen();
			Instrument = Instrument_DefaultValue = null;
			InstrumentString = InstrumentString_DefaultValue = "null";
			Mapping = Mapping_DefaultValue = new PlotOptionsParetoSonificationContextTracksMapping();
			MidiName = MidiName_DefaultValue = "";
			PointGrouping = PointGrouping_DefaultValue = new PlotOptionsParetoSonificationContextTracksPointGrouping();
			...
			Type = Type_DefaultValue = PlotOptionsParetoSonificationContextTracksType.Instrument;
			ValueInterval = ValueInterval_DefaultValue = null;
			ValueMapFunction = ValueMapFunction_DefaultValue = PlotOptionsParetoSonificationContextTracksValueMapFunction.Linear;
		...
		/// </summary>
		public PlotOptionsParetoSonificationContextTracksActiveWhen ActiveWhen { get; set; }
		private PlotOptionsParetoSonificationContextTracksActiveWhen ActiveWhen_DefaultValue { get; set; }
		...
		/// </summary>
		public PlotOptionsParetoSonificationContextTracksMapping Mapping { get; set; }
		private PlotOptionsParetoSonificationContextTracksMapping Mapping_DefaultValue { get; set; }
		...
		/// </summary>
		public PlotOptionsParetoSonificationContextTracksPointGrouping PointGrouping { get; set; }
		private PlotOptionsParetoSonificationContextTracksPointGrouping PointGrouping_DefaultValue { get; set; }
		...
		/// </summary>
		public PlotOptionsParetoSonificationContextTracksType Type { get; set; }
		private PlotOptionsParetoSonificationContextTracksType Type_DefaultValue { get; set; }
		...
		/// </summary>
		public PlotOptionsParetoSonificationContextTracksValueMapFunction ValueMapFunction { get; set; }
		private PlotOptionsParetoSonificationContextTracksValueMapFunction ValueMapFunction_DefaultValue { get; set; }
