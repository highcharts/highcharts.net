...
{
	public partial class PlotOptionsParetoSonificationTracks  : BaseObject
	{
		Hashtable h = new Hashtable();

		public PlotOptionsParetoSonificationTracks()
		{
			ActiveWhen = ActiveWhen_DefaultValue = new PlotOptionsParetoSonificationTracksActiveWhen();
			Instrument = Instrument_DefaultValue = null;
			InstrumentString = InstrumentString_DefaultValue = "null";
			Mapping = Mapping_DefaultValue = new PlotOptionsParetoSonificationTracksMapping();
			MidiName = MidiName_DefaultValue = "";
			PointGrouping = PointGrouping_DefaultValue = new PlotOptionsParetoSonificationTracksPointGrouping();
			RoundToMusicalNotes = RoundToMusicalNotes_DefaultValue = true;
			ShowPlayMarker = ShowPlayMarker_DefaultValue = true;
			Type = Type_DefaultValue = PlotOptionsParetoSonificationTracksType.Instrument;
		...
		/// </summary>
		public PlotOptionsParetoSonificationTracksActiveWhen ActiveWhen { get; set; }
		private PlotOptionsParetoSonificationTracksActiveWhen ActiveWhen_DefaultValue { get; set; }
		...
		/// </summary>
		public PlotOptionsParetoSonificationTracksMapping Mapping { get; set; }
		private PlotOptionsParetoSonificationTracksMapping Mapping_DefaultValue { get; set; }
		...
		/// </summary>
		public PlotOptionsParetoSonificationTracksPointGrouping PointGrouping { get; set; }
		private PlotOptionsParetoSonificationTracksPointGrouping PointGrouping_DefaultValue { get; set; }
		...
		/// </summary>
		public PlotOptionsParetoSonificationTracksType Type { get; set; }
		private PlotOptionsParetoSonificationTracksType Type_DefaultValue { get; set; }
