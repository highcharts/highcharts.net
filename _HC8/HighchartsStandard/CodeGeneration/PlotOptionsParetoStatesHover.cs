...
{
	public partial class PlotOptionsParetoStatesHover  : PlotOptionsSeries
	{
		Hashtable h = new Hashtable();

		public PlotOptionsParetoStatesHover()
		{
			Animation = Animation_DefaultValue = new Animation();
			Enabled = Enabled_DefaultValue = null;
			Halo = Halo_DefaultValue = new PlotOptionsParetoStatesHoverHalo();
			LineWidth = LineWidth_DefaultValue = null;
			LineWidthPlus = LineWidthPlus_DefaultValue = null;
			Marker = Marker_DefaultValue = new PlotOptionsParetoStatesHoverMarker();
		...
		/// </summary>
		public PlotOptionsParetoStatesHoverHalo Halo { get; set; }
		private PlotOptionsParetoStatesHoverHalo Halo_DefaultValue { get; set; }
		...
		/// </summary>
		public PlotOptionsParetoStatesHoverMarker Marker { get; set; }
		private PlotOptionsParetoStatesHoverMarker Marker_DefaultValue { get; set; }
