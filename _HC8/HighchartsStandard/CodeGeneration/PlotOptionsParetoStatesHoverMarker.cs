...
{
	public partial class PlotOptionsParetoStatesHoverMarker  : PlotOptionsSeries
	{
		Hashtable h = new Hashtable();

		public PlotOptionsParetoStatesHoverMarker()
		{
			...
			States = States_DefaultValue = new PlotOptionsParetoStatesHoverMarkerStates();
		...
		/// </summary>
		public PlotOptionsParetoStatesHoverMarkerStates States { get; set; }
		private PlotOptionsParetoStatesHoverMarkerStates States_DefaultValue { get; set; }
