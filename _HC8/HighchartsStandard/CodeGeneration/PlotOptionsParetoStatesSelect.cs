...
{
	public partial class PlotOptionsParetoStatesSelect  : PlotOptionsSeries
	{
		Hashtable h = new Hashtable();

		public PlotOptionsParetoStatesSelect()
		{
			Animation = Animation_DefaultValue = new Animation();
			Enabled = Enabled_DefaultValue = null;
			Halo = Halo_DefaultValue = new PlotOptionsParetoStatesSelectHalo();
			LineWidth = LineWidth_DefaultValue = null;
			LineWidthPlus = LineWidthPlus_DefaultValue = null;
			Marker = Marker_DefaultValue = new PlotOptionsParetoStatesSelectMarker();
		...
		/// </summary>
		public PlotOptionsParetoStatesSelectHalo Halo { get; set; }
		private PlotOptionsParetoStatesSelectHalo Halo_DefaultValue { get; set; }
		...
		/// </summary>
		public PlotOptionsParetoStatesSelectMarker Marker { get; set; }
		private PlotOptionsParetoStatesSelectMarker Marker_DefaultValue { get; set; }
