...
{
	public partial class PlotOptionsParetoStatesSelectMarker  : PlotOptionsSeries
	{
		Hashtable h = new Hashtable();

		public PlotOptionsParetoStatesSelectMarker()
		{
			...
			States = States_DefaultValue = new PlotOptionsParetoStatesSelectMarkerStates();
		...
		/// </summary>
		public PlotOptionsParetoStatesSelectMarkerStates States { get; set; }
		private PlotOptionsParetoStatesSelectMarkerStates States_DefaultValue { get; set; }
