...
{
	public partial class PlotOptionsParetoStatesSelectMarkerStatesHoverAnimation  : PlotOptionsSeries
	{
		Hashtable h = new Hashtable();

		public PlotOptionsParetoStatesSelectMarkerStatesHoverAnimation()
		{
