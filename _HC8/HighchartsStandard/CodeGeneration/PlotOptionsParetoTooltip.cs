...
namespace Highsoft.Web.Mvc.Charts
{
	public partial class PlotOptionsParetoTooltip  : BaseObject
	{
		...
		internal override Hashtable ToHashtable()
		{
			...
			if (NullFormatter != NullFormatter_DefaultValue) { h.Add("nullFormatter",NullFormatter); Highcharts.AddFunction("beb1988d-9f86-4692-a215-f9a291cf8464.nullFormatter", NullFormatter); }  
			if (PointFormat != PointFormat_DefaultValue) h.Add("pointFormat",PointFormat);
			if (PointFormatter != PointFormatter_DefaultValue) { h.Add("pointFormatter",PointFormatter); Highcharts.AddFunction("eece95bb-e17a-44a2-afd1-1a3ca8992754.pointFormatter", PointFormatter); }  
