...
namespace Highsoft.Web.Mvc.Charts
{
	public partial class PlotOptionsParetoTooltip  : BaseObject
	{
		...
		internal override Hashtable ToHashtable()
		{
			...
			if (NullFormatter != NullFormatter_DefaultValue) { h.Add("nullFormatter",NullFormatter); Highcharts.AddFunction("d61746b2-b6f6-4eb4-b571-0eab143787af.nullFormatter", NullFormatter); }  
			if (PointFormat != PointFormat_DefaultValue) h.Add("pointFormat",PointFormat);
			if (PointFormatter != PointFormatter_DefaultValue) { h.Add("pointFormatter",PointFormatter); Highcharts.AddFunction("3a054d58-a20f-4585-9d8d-29976aca8197.pointFormatter", PointFormatter); }  
