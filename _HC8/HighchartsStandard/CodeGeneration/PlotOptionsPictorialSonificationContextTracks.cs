...
{
	public partial class PlotOptionsPictorialSonificationContextTracks  : BaseObject
	{
		Hashtable h = new Hashtable();

		public PlotOptionsPictorialSonificationContextTracks()
		{
			ActiveWhen = ActiveWhen_DefaultValue = new PlotOptionsPictorialSonificationContextTracksActiveWhen();
			Instrument = Instrument_DefaultValue = null;
			InstrumentString = InstrumentString_DefaultValue = "null";
			Mapping = Mapping_DefaultValue = new PlotOptionsPictorialSonificationContextTracksMapping();
			MidiName = MidiName_DefaultValue = "";
			PointGrouping = PointGrouping_DefaultValue = new PlotOptionsPictorialSonificationContextTracksPointGrouping();
			...
			Type = Type_DefaultValue = PlotOptionsPictorialSonificationContextTracksType.Instrument;
			ValueInterval = ValueInterval_DefaultValue = null;
			ValueMapFunction = ValueMapFunction_DefaultValue = PlotOptionsPictorialSonificationContextTracksValueMapFunction.Linear;
		...
		/// </summary>
		public PlotOptionsPictorialSonificationContextTracksActiveWhen ActiveWhen { get; set; }
		private PlotOptionsPictorialSonificationContextTracksActiveWhen ActiveWhen_DefaultValue { get; set; }
		...
		/// </summary>
		public PlotOptionsPictorialSonificationContextTracksMapping Mapping { get; set; }
		private PlotOptionsPictorialSonificationContextTracksMapping Mapping_DefaultValue { get; set; }
		...
		/// </summary>
		public PlotOptionsPictorialSonificationContextTracksPointGrouping PointGrouping { get; set; }
		private PlotOptionsPictorialSonificationContextTracksPointGrouping PointGrouping_DefaultValue { get; set; }
		...
		/// </summary>
		public PlotOptionsPictorialSonificationContextTracksType Type { get; set; }
		private PlotOptionsPictorialSonificationContextTracksType Type_DefaultValue { get; set; }
		...
		/// </summary>
		public PlotOptionsPictorialSonificationContextTracksValueMapFunction ValueMapFunction { get; set; }
		private PlotOptionsPictorialSonificationContextTracksValueMapFunction ValueMapFunction_DefaultValue { get; set; }
