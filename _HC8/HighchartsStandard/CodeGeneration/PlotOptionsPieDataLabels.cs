...
namespace Highsoft.Web.Mvc.Charts
{
	public partial class PlotOptionsPieDataLabels  : BaseObject
	{
		...
		{
			Align = Align_DefaultValue = PlotOptionsPieDataLabelsAlign.Center;
			...
			Filter = Filter_DefaultValue = new PlotOptionsPieDataLabelsFilter();
			...
			TextPath = TextPath_DefaultValue = new PlotOptionsPieDataLabelsTextPath();
			UseHTML = UseHTML_DefaultValue = false;
			VerticalAlign = VerticalAlign_DefaultValue = PlotOptionsPieDataLabelsVerticalAlign.Bottom;
			X = X_DefaultValue = 0;
			Y = Y_DefaultValue = 0;
			Z = Z_DefaultValue = 6;
		...
		internal override Hashtable ToHashtable()
		{
			...
			if (Formatter != Formatter_DefaultValue) { h.Add("formatter",Formatter); Highcharts.AddFunction("109a170d-59ca-4c7e-b473-d354bb49ee3a.formatter", Formatter); }  
			...
			if (NullFormatter != NullFormatter_DefaultValue) { h.Add("nullFormatter",NullFormatter); Highcharts.AddFunction("2061392c-55d0-410e-8c42-c72bab194a21.nullFormatter", NullFormatter); }  
