...
namespace Highsoft.Web.Mvc.Charts
{
	public partial class PlotOptionsPieDragDropDragHandle  : BaseObject
	{
		...
		internal override Hashtable ToHashtable()
		{
			...
			if (PathFormatter != PathFormatter_DefaultValue) { h.Add("pathFormatter",PathFormatter); Highcharts.AddFunction("c682e0f7-3d52-42d5-88ef-edc752e82a68.pathFormatter", PathFormatter); }  
