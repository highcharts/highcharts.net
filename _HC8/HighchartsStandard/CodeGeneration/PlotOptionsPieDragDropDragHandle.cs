...
namespace Highsoft.Web.Mvc.Charts
{
	public partial class PlotOptionsPieDragDropDragHandle  : BaseObject
	{
		...
		internal override Hashtable ToHashtable()
		{
			...
			if (PathFormatter != PathFormatter_DefaultValue) { h.Add("pathFormatter",PathFormatter); Highcharts.AddFunction("4b17c73f-8c5d-4386-b652-53ee5423b7c4.pathFormatter", PathFormatter); }  
