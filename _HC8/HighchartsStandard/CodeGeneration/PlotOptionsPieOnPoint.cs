...
{
	public partial class PlotOptionsPieOnPoint  : BaseObject
	{
		Hashtable h = new Hashtable();

		public PlotOptionsPieOnPoint()
		{
			ConnectorOptions = ConnectorOptions_DefaultValue = new PlotOptionsPieOnPointConnectorOptions();
			Id = Id_DefaultValue = "";
			Position = Position_DefaultValue = new PlotOptionsPieOnPointPosition();
		...
		/// </summary>
		public PlotOptionsPieOnPointConnectorOptions ConnectorOptions { get; set; }
		private PlotOptionsPieOnPointConnectorOptions ConnectorOptions_DefaultValue { get; set; }
		...
		/// </summary>
		public PlotOptionsPieOnPointPosition Position { get; set; }
		private PlotOptionsPieOnPointPosition Position_DefaultValue { get; set; }
