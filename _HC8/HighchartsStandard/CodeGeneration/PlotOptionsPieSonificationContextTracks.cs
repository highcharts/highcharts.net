...
{
	public partial class PlotOptionsPieSonificationContextTracks  : BaseObject
	{
		Hashtable h = new Hashtable();

		public PlotOptionsPieSonificationContextTracks()
		{
			ActiveWhen = ActiveWhen_DefaultValue = new PlotOptionsPieSonificationContextTracksActiveWhen();
			Instrument = Instrument_DefaultValue = null;
			InstrumentString = InstrumentString_DefaultValue = "null";
			Mapping = Mapping_DefaultValue = new PlotOptionsPieSonificationContextTracksMapping();
			MidiName = MidiName_DefaultValue = "";
			PointGrouping = PointGrouping_DefaultValue = new PlotOptionsPieSonificationContextTracksPointGrouping();
			...
			Type = Type_DefaultValue = PlotOptionsPieSonificationContextTracksType.Instrument;
			ValueInterval = ValueInterval_DefaultValue = null;
			ValueMapFunction = ValueMapFunction_DefaultValue = PlotOptionsPieSonificationContextTracksValueMapFunction.Linear;
		...
		/// </summary>
		public PlotOptionsPieSonificationContextTracksActiveWhen ActiveWhen { get; set; }
		private PlotOptionsPieSonificationContextTracksActiveWhen ActiveWhen_DefaultValue { get; set; }
		...
		/// </summary>
		public PlotOptionsPieSonificationContextTracksMapping Mapping { get; set; }
		private PlotOptionsPieSonificationContextTracksMapping Mapping_DefaultValue { get; set; }
		...
		/// </summary>
		public PlotOptionsPieSonificationContextTracksPointGrouping PointGrouping { get; set; }
		private PlotOptionsPieSonificationContextTracksPointGrouping PointGrouping_DefaultValue { get; set; }
		...
		/// </summary>
		public PlotOptionsPieSonificationContextTracksType Type { get; set; }
		private PlotOptionsPieSonificationContextTracksType Type_DefaultValue { get; set; }
		...
		/// </summary>
		public PlotOptionsPieSonificationContextTracksValueMapFunction ValueMapFunction { get; set; }
		private PlotOptionsPieSonificationContextTracksValueMapFunction ValueMapFunction_DefaultValue { get; set; }
