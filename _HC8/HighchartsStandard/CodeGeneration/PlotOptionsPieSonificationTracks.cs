...
{
	public partial class PlotOptionsPieSonificationTracks  : BaseObject
	{
		Hashtable h = new Hashtable();

		public PlotOptionsPieSonificationTracks()
		{
			ActiveWhen = ActiveWhen_DefaultValue = new PlotOptionsPieSonificationTracksActiveWhen();
			Instrument = Instrument_DefaultValue = null;
			InstrumentString = InstrumentString_DefaultValue = "null";
			Mapping = Mapping_DefaultValue = new PlotOptionsPieSonificationTracksMapping();
			MidiName = MidiName_DefaultValue = "";
			PointGrouping = PointGrouping_DefaultValue = new PlotOptionsPieSonificationTracksPointGrouping();
			RoundToMusicalNotes = RoundToMusicalNotes_DefaultValue = true;
			ShowPlayMarker = ShowPlayMarker_DefaultValue = true;
			Type = Type_DefaultValue = PlotOptionsPieSonificationTracksType.Instrument;
		...
		/// </summary>
		public PlotOptionsPieSonificationTracksActiveWhen ActiveWhen { get; set; }
		private PlotOptionsPieSonificationTracksActiveWhen ActiveWhen_DefaultValue { get; set; }
		...
		/// </summary>
		public PlotOptionsPieSonificationTracksMapping Mapping { get; set; }
		private PlotOptionsPieSonificationTracksMapping Mapping_DefaultValue { get; set; }
		...
		/// </summary>
		public PlotOptionsPieSonificationTracksPointGrouping PointGrouping { get; set; }
		private PlotOptionsPieSonificationTracksPointGrouping PointGrouping_DefaultValue { get; set; }
		...
		/// </summary>
		public PlotOptionsPieSonificationTracksType Type { get; set; }
		private PlotOptionsPieSonificationTracksType Type_DefaultValue { get; set; }
