...
{
	public partial class PlotOptionsPieStatesSelect  : PlotOptionsSeries
	{
		Hashtable h = new Hashtable();

		public PlotOptionsPieStatesSelect()
		{
			Animation = Animation_DefaultValue = new Animation();
			Enabled = Enabled_DefaultValue = null;
			Halo = Halo_DefaultValue = new PlotOptionsPieStatesSelectHalo();
			LineWidth = LineWidth_DefaultValue = null;
			LineWidthPlus = LineWidthPlus_DefaultValue = null;
			Marker = Marker_DefaultValue = new PlotOptionsPieStatesSelectMarker();
		...
		/// </summary>
		public PlotOptionsPieStatesSelectHalo Halo { get; set; }
		private PlotOptionsPieStatesSelectHalo Halo_DefaultValue { get; set; }
		...
		private PlotOptionsPieStatesSelectMarker Marker_DefaultValue { get; set; }
