...
{
	public partial class PlotOptionsPieStatesSelectMarker  : PlotOptionsSeries
	{
		Hashtable h = new Hashtable();

		public PlotOptionsPieStatesSelectMarker()
		{
			...
			States = States_DefaultValue = new PlotOptionsPieStatesSelectMarkerStates();
		...
		/// </summary>
		public PlotOptionsPieStatesSelectMarkerStates States { get; set; }
		private PlotOptionsPieStatesSelectMarkerStates States_DefaultValue { get; set; }
