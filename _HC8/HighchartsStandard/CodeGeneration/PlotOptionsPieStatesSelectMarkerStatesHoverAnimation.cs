...
{
	public partial class PlotOptionsPieStatesSelectMarkerStatesHoverAnimation  : PlotOptionsSeries
	{
		Hashtable h = new Hashtable();

		public PlotOptionsPieStatesSelectMarkerStatesHoverAnimation()
		{
