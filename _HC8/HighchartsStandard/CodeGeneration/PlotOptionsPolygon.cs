...
namespace Highsoft.Web.Mvc.Charts
{
	public partial class PlotOptionsPolygon  : BaseObject
	{
		...
		internal override Hashtable ToHashtable()
		{
			...
			if (PointDescriptionFormatter != PointDescriptionFormatter_DefaultValue) { h.Add("pointDescriptionFormatter",PointDescriptionFormatter); Highcharts.AddFunction("3deee097-3ea7-4cc0-a19f-7e2f858ac9e7.pointDescriptionFormatter", PointDescriptionFormatter); }  
