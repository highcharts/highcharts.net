...
namespace Highsoft.Web.Mvc.Charts
{
	public partial class PlotOptionsPolygonClusterEvents  : BaseObject
	{
		...
		internal override Hashtable ToHashtable()
		{
			...
			if (DrillToCluster != DrillToCluster_DefaultValue) { h.Add("drillToCluster",DrillToCluster); Highcharts.AddFunction("b7ae8081-25d6-4fd9-80c4-fa7ffa9e9ba4.drillToCluster", DrillToCluster); }  
