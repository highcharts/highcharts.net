...
{
	public partial class PlotOptionsPolygonClusterZonesMarkerStatesHoverAnimation  : BaseObject
	{
		Hashtable h = new Hashtable();

		public PlotOptionsPolygonClusterZonesMarkerStatesHoverAnimation()
		{
