...
{
	public partial class PlotOptionsPolygonDataLabels  : BaseObject
	{
		Hashtable h = new Hashtable();

		public PlotOptionsPolygonDataLabels()
		{
			Align = Align_DefaultValue = PlotOptionsPolygonDataLabelsAlign.Center;
			...
			Filter = Filter_DefaultValue = new PlotOptionsPolygonDataLabelsFilter();
			...
			Style = Style_DefaultValue = new PlotOptionsPolygonDataLabelsStyle();
			TextPath = TextPath_DefaultValue = new PlotOptionsPolygonDataLabelsTextPath();
			UseHTML = UseHTML_DefaultValue = false;
			VerticalAlign = VerticalAlign_DefaultValue = PlotOptionsPolygonDataLabelsVerticalAlign.Bottom;
			X = X_DefaultValue = 0;
			Y = Y_DefaultValue = 0;
			Z = Z_DefaultValue = 6;
		...
		/// </summary>
		public PlotOptionsPolygonDataLabelsFilter Filter { get; set; }
		private PlotOptionsPolygonDataLabelsFilter Filter_DefaultValue { get; set; }
		...
		/// </summary>
		public PlotOptionsPolygonDataLabelsStyle Style { get; set; }
		private PlotOptionsPolygonDataLabelsStyle Style_DefaultValue { get; set; }
		...
		/// </summary>
		public PlotOptionsPolygonDataLabelsTextPath TextPath { get; set; }
		private PlotOptionsPolygonDataLabelsTextPath TextPath_DefaultValue { get; set; }
		...
		/// </summary>
		public PlotOptionsPolygonDataLabelsVerticalAlign VerticalAlign { get; set; }
		private PlotOptionsPolygonDataLabelsVerticalAlign VerticalAlign_DefaultValue { get; set; }
		...
		internal override Hashtable ToHashtable()
		{
			...
			if (Formatter != Formatter_DefaultValue) { h.Add("formatter",Formatter); Highcharts.AddFunction("f5e2ca91-11df-4aab-876d-08f571ac42f2.formatter", Formatter); }  
			if (Inside != Inside_DefaultValue) h.Add("inside",Inside);
			if (NullFormat != NullFormat_DefaultValue) h.Add("nullFormat",NullFormat);
			if (NullFormatter != NullFormatter_DefaultValue) { h.Add("nullFormatter",NullFormatter); Highcharts.AddFunction("d26e104a-7893-4669-a92e-3e285eec7208.nullFormatter", NullFormatter); }  
