...
{
	public partial class PlotOptionsPolygonSonificationContextTracks  : BaseObject
	{
		Hashtable h = new Hashtable();

		public PlotOptionsPolygonSonificationContextTracks()
		{
			ActiveWhen = ActiveWhen_DefaultValue = new PlotOptionsPolygonSonificationContextTracksActiveWhen();
			Instrument = Instrument_DefaultValue = null;
			InstrumentString = InstrumentString_DefaultValue = "null";
			Mapping = Mapping_DefaultValue = new PlotOptionsPolygonSonificationContextTracksMapping();
			MidiName = MidiName_DefaultValue = "";
			PointGrouping = PointGrouping_DefaultValue = new PlotOptionsPolygonSonificationContextTracksPointGrouping();
			...
			Type = Type_DefaultValue = PlotOptionsPolygonSonificationContextTracksType.Instrument;
			ValueInterval = ValueInterval_DefaultValue = null;
			ValueMapFunction = ValueMapFunction_DefaultValue = PlotOptionsPolygonSonificationContextTracksValueMapFunction.Linear;
		...
		/// </summary>
		public PlotOptionsPolygonSonificationContextTracksActiveWhen ActiveWhen { get; set; }
		private PlotOptionsPolygonSonificationContextTracksActiveWhen ActiveWhen_DefaultValue { get; set; }
		...
		/// </summary>
		public PlotOptionsPolygonSonificationContextTracksMapping Mapping { get; set; }
		private PlotOptionsPolygonSonificationContextTracksMapping Mapping_DefaultValue { get; set; }
		...
		/// </summary>
		public PlotOptionsPolygonSonificationContextTracksPointGrouping PointGrouping { get; set; }
		private PlotOptionsPolygonSonificationContextTracksPointGrouping PointGrouping_DefaultValue { get; set; }
		...
		/// </summary>
		public PlotOptionsPolygonSonificationContextTracksType Type { get; set; }
		private PlotOptionsPolygonSonificationContextTracksType Type_DefaultValue { get; set; }
		...
		/// </summary>
		public PlotOptionsPolygonSonificationContextTracksValueMapFunction ValueMapFunction { get; set; }
		private PlotOptionsPolygonSonificationContextTracksValueMapFunction ValueMapFunction_DefaultValue { get; set; }
