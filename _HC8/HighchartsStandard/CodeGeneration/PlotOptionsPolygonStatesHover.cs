...
{
	public partial class PlotOptionsPolygonStatesHover  : PlotOptionsSeries
	{
		...
		public PlotOptionsPolygonStatesHover()
		{
			...
			Halo = Halo_DefaultValue = new PlotOptionsPolygonStatesHoverHalo();
			LineWidth = LineWidth_DefaultValue = null;
			LineWidthPlus = LineWidthPlus_DefaultValue = null;
			Marker = Marker_DefaultValue = new PlotOptionsPolygonStatesHoverMarker();
		...
		private PlotOptionsPolygonStatesHoverMarker Marker_DefaultValue { get; set; }
