...
{
	public partial class PlotOptionsPolygonStatesHoverMarker  : PlotOptionsSeries
	{
		Hashtable h = new Hashtable();

		public PlotOptionsPolygonStatesHoverMarker()
		{
			...
			States = States_DefaultValue = new PlotOptionsPolygonStatesHoverMarkerStates();
		...
		/// </summary>
		public PlotOptionsPolygonStatesHoverMarkerStates States { get; set; }
		private PlotOptionsPolygonStatesHoverMarkerStates States_DefaultValue { get; set; }
