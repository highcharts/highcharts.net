...
{
	public partial class PlotOptionsPolygonStatesSelect  : PlotOptionsSeries
	{
		Hashtable h = new Hashtable();

		public PlotOptionsPolygonStatesSelect()
		{
			Animation = Animation_DefaultValue = new Animation();
			Enabled = Enabled_DefaultValue = null;
			Halo = Halo_DefaultValue = new PlotOptionsPolygonStatesSelectHalo();
			LineWidth = LineWidth_DefaultValue = null;
			LineWidthPlus = LineWidthPlus_DefaultValue = null;
			Marker = Marker_DefaultValue = new PlotOptionsPolygonStatesSelectMarker();
		...
		/// </summary>
		public PlotOptionsPolygonStatesSelectHalo Halo { get; set; }
		private PlotOptionsPolygonStatesSelectHalo Halo_DefaultValue { get; set; }
		...
		/// </summary>
		public PlotOptionsPolygonStatesSelectMarker Marker { get; set; }
		private PlotOptionsPolygonStatesSelectMarker Marker_DefaultValue { get; set; }
