...
{
	public partial class PlotOptionsPolygonStatesSelectMarker  : PlotOptionsSeries
	{
		Hashtable h = new Hashtable();

		public PlotOptionsPolygonStatesSelectMarker()
		{
			...
			States = States_DefaultValue = new PlotOptionsPolygonStatesSelectMarkerStates();
		...
		/// </summary>
		public PlotOptionsPolygonStatesSelectMarkerStates States { get; set; }
		private PlotOptionsPolygonStatesSelectMarkerStates States_DefaultValue { get; set; }
