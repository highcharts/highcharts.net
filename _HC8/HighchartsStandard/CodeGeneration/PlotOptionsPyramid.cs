...
namespace Highsoft.Web.Mvc.Charts
{
	public partial class PlotOptionsPyramid  : BaseObject
	{
		...
		{
			Accessibility = Accessibility_DefaultValue = new PlotOptionsPyramidAccessibility();
			AllowPointSelect = AllowPointSelect_DefaultValue = false;
			Animation = Animation_DefaultValue = new Animation() { Enabled = true };
			BoostBlending = BoostBlending_DefaultValue = PlotOptionsPyramidBoostBlending.Undefined;
			...
			DataSorting = DataSorting_DefaultValue = new PlotOptionsPyramidDataSorting();
			Depth = Depth_DefaultValue = 0;
			Description = Description_DefaultValue = "";
			DragDrop = DragDrop_DefaultValue = new PlotOptionsPyramidDragDrop();
		...
		/// </summary>
		public PlotOptionsPyramidBoostBlending BoostBlending { get; set; }
		private PlotOptionsPyramidBoostBlending BoostBlending_DefaultValue { get; set; }
		...
		/// </summary>
		public PlotOptionsPyramidDataSorting DataSorting { get; set; }
		private PlotOptionsPyramidDataSorting DataSorting_DefaultValue { get; set; }
		...
		/// </summary>
		public PlotOptionsPyramidDragDrop DragDrop { get; set; }
		private PlotOptionsPyramidDragDrop DragDrop_DefaultValue { get; set; }
		...
		internal override Hashtable ToHashtable()
		{
			...
			if (PointDescriptionFormatter != PointDescriptionFormatter_DefaultValue) { h.Add("pointDescriptionFormatter",PointDescriptionFormatter); Highcharts.AddFunction("2234363f-e128-486f-9772-b24700e6a783.pointDescriptionFormatter", PointDescriptionFormatter); }  
