...
namespace Highsoft.Web.Mvc.Charts
{
	public partial class PlotOptionsPyramid3d  : BaseObject
	{
		...
		internal override Hashtable ToHashtable()
		{
			...
			if (PointDescriptionFormatter != PointDescriptionFormatter_DefaultValue) { h.Add("pointDescriptionFormatter",PointDescriptionFormatter); Highcharts.AddFunction("a7ec9228-6fca-4962-bfd7-f40b303a6e96.pointDescriptionFormatter", PointDescriptionFormatter); }  
