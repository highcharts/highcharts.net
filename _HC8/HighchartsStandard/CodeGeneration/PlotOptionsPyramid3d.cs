...
namespace Highsoft.Web.Mvc.Charts
{
	public partial class PlotOptionsPyramid3d  : BaseObject
	{
		...
		internal override Hashtable ToHashtable()
		{
			...
			if (PointDescriptionFormatter != PointDescriptionFormatter_DefaultValue) { h.Add("pointDescriptionFormatter",PointDescriptionFormatter); Highcharts.AddFunction("cea6c4fc-088d-4833-9a50-680aef074d3a.pointDescriptionFormatter", PointDescriptionFormatter); }  
