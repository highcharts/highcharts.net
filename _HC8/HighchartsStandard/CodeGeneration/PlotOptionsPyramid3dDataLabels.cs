...
namespace Highsoft.Web.Mvc.Charts
{
	public partial class PlotOptionsPyramid3dDataLabels  : BaseObject
	{
		...
		{
			Align = Align_DefaultValue = PlotOptionsPyramid3dDataLabelsAlign.Center;
			...
			Filter = Filter_DefaultValue = new PlotOptionsPyramid3dDataLabelsFilter();
			...
			Style = Style_DefaultValue = new PlotOptionsPyramid3dDataLabelsStyle();
		...
		/// </summary>
		public PlotOptionsPyramid3dDataLabelsStyle Style { get; set; }
		private PlotOptionsPyramid3dDataLabelsStyle Style_DefaultValue { get; set; }
		...
		internal override Hashtable ToHashtable()
		{
			...
			if (Formatter != Formatter_DefaultValue) { h.Add("formatter",Formatter); Highcharts.AddFunction("e5e1354a-ac53-4ae2-b985-d1a7ed6f2bfd.formatter", Formatter); }  
			...
			if (NullFormatter != NullFormatter_DefaultValue) { h.Add("nullFormatter",NullFormatter); Highcharts.AddFunction("39b5e5d8-6cd5-4144-8e25-157bf3feb3eb.nullFormatter", NullFormatter); }  
