...
namespace Highsoft.Web.Mvc.Charts
{
	public partial class PlotOptionsPyramid3dDataLabels  : BaseObject
	{
		...
		public PlotOptionsPyramid3dDataLabels()
		{
			...
			Overflow = Overflow_DefaultValue = PlotOptionsPyramid3dDataLabelsOverflow.Justify;
			Padding = Padding_DefaultValue = 5;
			Position = Position_DefaultValue = PlotOptionsPyramid3dDataLabelsPosition.Center;
