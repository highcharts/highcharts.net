...
{
	public partial class PlotOptionsPyramid3dDragDrop  : BaseObject
	{
		Hashtable h = new Hashtable();

		public PlotOptionsPyramid3dDragDrop()
		{
			DraggableX = DraggableX_DefaultValue = null;
			DraggableY = DraggableY_DefaultValue = null;
			DragHandle = DragHandle_DefaultValue = new PlotOptionsPyramid3dDragDropDragHandle();
			...
			GuideBox = GuideBox_DefaultValue = new PlotOptionsPyramid3dDragDropGuideBox();
		...
		/// </summary>
		public PlotOptionsPyramid3dDragDropDragHandle DragHandle { get; set; }
		private PlotOptionsPyramid3dDragDropDragHandle DragHandle_DefaultValue { get; set; }
		...
		/// </summary>
		public PlotOptionsPyramid3dDragDropGuideBox GuideBox { get; set; }
		private PlotOptionsPyramid3dDragDropGuideBox GuideBox_DefaultValue { get; set; }
