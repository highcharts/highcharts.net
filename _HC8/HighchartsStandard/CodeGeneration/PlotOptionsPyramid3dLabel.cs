...
namespace Highsoft.Web.Mvc.Charts
{
	public partial class PlotOptionsPyramid3dLabel  : BaseObject
	{
		...
		public PlotOptionsPyramid3dLabel()
		{
			...
			Style = Style_DefaultValue = new PlotOptionsPyramid3dLabelStyle();
		...
		/// </summary>
		public PlotOptionsPyramid3dLabelStyle Style { get; set; }
		private PlotOptionsPyramid3dLabelStyle Style_DefaultValue { get; set; }
		...
		internal override Hashtable ToHashtable()
		{
			...
			if (Formatter != Formatter_DefaultValue) { h.Add("formatter",Formatter); Highcharts.AddFunction("8e54d621-6ca3-4c7f-96ab-98ea116619bb.formatter", Formatter); }  
