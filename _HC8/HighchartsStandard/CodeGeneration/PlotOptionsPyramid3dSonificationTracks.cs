...
{
	public partial class PlotOptionsPyramid3dSonificationTracks  : BaseObject
	{
		Hashtable h = new Hashtable();

		public PlotOptionsPyramid3dSonificationTracks()
		{
			ActiveWhen = ActiveWhen_DefaultValue = new PlotOptionsPyramid3dSonificationTracksActiveWhen();
			Instrument = Instrument_DefaultValue = null;
			InstrumentString = InstrumentString_DefaultValue = "null";
			Mapping = Mapping_DefaultValue = new PlotOptionsPyramid3dSonificationTracksMapping();
			MidiName = MidiName_DefaultValue = "";
			PointGrouping = PointGrouping_DefaultValue = new PlotOptionsPyramid3dSonificationTracksPointGrouping();
			RoundToMusicalNotes = RoundToMusicalNotes_DefaultValue = true;
			ShowPlayMarker = ShowPlayMarker_DefaultValue = true;
			Type = Type_DefaultValue = PlotOptionsPyramid3dSonificationTracksType.Instrument;
		...
		/// </summary>
		public PlotOptionsPyramid3dSonificationTracksActiveWhen ActiveWhen { get; set; }
		private PlotOptionsPyramid3dSonificationTracksActiveWhen ActiveWhen_DefaultValue { get; set; }
		...
		/// </summary>
		public PlotOptionsPyramid3dSonificationTracksMapping Mapping { get; set; }
		private PlotOptionsPyramid3dSonificationTracksMapping Mapping_DefaultValue { get; set; }
		...
		/// </summary>
		public PlotOptionsPyramid3dSonificationTracksPointGrouping PointGrouping { get; set; }
		private PlotOptionsPyramid3dSonificationTracksPointGrouping PointGrouping_DefaultValue { get; set; }
		...
		private PlotOptionsPyramid3dSonificationTracksType Type_DefaultValue { get; set; }
