...
{
	public partial class PlotOptionsPyramid3dStatesHover  : PlotOptionsSeries
	{
		Hashtable h = new Hashtable();

		public PlotOptionsPyramid3dStatesHover()
		{
			Animation = Animation_DefaultValue = new Animation();
			Enabled = Enabled_DefaultValue = null;
			Halo = Halo_DefaultValue = new PlotOptionsPyramid3dStatesHoverHalo();
			LineWidth = LineWidth_DefaultValue = null;
			LineWidthPlus = LineWidthPlus_DefaultValue = null;
			Marker = Marker_DefaultValue = new PlotOptionsPyramid3dStatesHoverMarker();
		...
		/// </summary>
		public PlotOptionsPyramid3dStatesHoverHalo Halo { get; set; }
		private PlotOptionsPyramid3dStatesHoverHalo Halo_DefaultValue { get; set; }
		...
		/// </summary>
		public PlotOptionsPyramid3dStatesHoverMarker Marker { get; set; }
		private PlotOptionsPyramid3dStatesHoverMarker Marker_DefaultValue { get; set; }
