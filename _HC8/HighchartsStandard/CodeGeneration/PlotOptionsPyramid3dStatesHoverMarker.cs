...
{
	public partial class PlotOptionsPyramid3dStatesHoverMarker  : PlotOptionsSeries
	{
		Hashtable h = new Hashtable();

		public PlotOptionsPyramid3dStatesHoverMarker()
		{
			...
			States = States_DefaultValue = new PlotOptionsPyramid3dStatesHoverMarkerStates();
		...
		/// </summary>
		public PlotOptionsPyramid3dStatesHoverMarkerStates States { get; set; }
		private PlotOptionsPyramid3dStatesHoverMarkerStates States_DefaultValue { get; set; }
