...
{
	public partial class PlotOptionsPyramid3dStatesHoverMarkerStatesHoverAnimation  : PlotOptionsSeries
	{
		Hashtable h = new Hashtable();

		public PlotOptionsPyramid3dStatesHoverMarkerStatesHoverAnimation()
		{
