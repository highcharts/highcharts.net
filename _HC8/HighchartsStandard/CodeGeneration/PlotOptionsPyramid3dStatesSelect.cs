...
{
	public partial class PlotOptionsPyramid3dStatesSelect  : PlotOptionsSeries
	{
		Hashtable h = new Hashtable();

		public PlotOptionsPyramid3dStatesSelect()
		{
			Animation = Animation_DefaultValue = new Animation();
			Enabled = Enabled_DefaultValue = null;
			Halo = Halo_DefaultValue = new PlotOptionsPyramid3dStatesSelectHalo();
			LineWidth = LineWidth_DefaultValue = null;
			LineWidthPlus = LineWidthPlus_DefaultValue = null;
			Marker = Marker_DefaultValue = new PlotOptionsPyramid3dStatesSelectMarker();
		...
		/// </summary>
		public PlotOptionsPyramid3dStatesSelectHalo Halo { get; set; }
		private PlotOptionsPyramid3dStatesSelectHalo Halo_DefaultValue { get; set; }
		...
		/// </summary>
		public PlotOptionsPyramid3dStatesSelectMarker Marker { get; set; }
		private PlotOptionsPyramid3dStatesSelectMarker Marker_DefaultValue { get; set; }
