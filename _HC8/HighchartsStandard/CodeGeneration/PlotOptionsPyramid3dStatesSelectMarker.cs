...
{
	public partial class PlotOptionsPyramid3dStatesSelectMarker  : PlotOptionsSeries
	{
		Hashtable h = new Hashtable();

		public PlotOptionsPyramid3dStatesSelectMarker()
		{
			...
			States = States_DefaultValue = new PlotOptionsPyramid3dStatesSelectMarkerStates();
		...
		/// </summary>
		public PlotOptionsPyramid3dStatesSelectMarkerStates States { get; set; }
		private PlotOptionsPyramid3dStatesSelectMarkerStates States_DefaultValue { get; set; }
