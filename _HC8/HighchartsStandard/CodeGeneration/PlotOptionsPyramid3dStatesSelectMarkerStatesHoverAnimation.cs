...
{
	public partial class PlotOptionsPyramid3dStatesSelectMarkerStatesHoverAnimation  : PlotOptionsSeries
	{
		Hashtable h = new Hashtable();

		public PlotOptionsPyramid3dStatesSelectMarkerStatesHoverAnimation()
		{
