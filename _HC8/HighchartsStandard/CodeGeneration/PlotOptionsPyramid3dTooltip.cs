...
namespace Highsoft.Web.Mvc.Charts
{
	public partial class PlotOptionsPyramid3dTooltip  : BaseObject
	{
		...
		internal override Hashtable ToHashtable()
		{
			...
			if (NullFormatter != NullFormatter_DefaultValue) { h.Add("nullFormatter",NullFormatter); Highcharts.AddFunction("fe700aca-ac76-4dfa-ac96-9f2d4b060769.nullFormatter", NullFormatter); }  
			if (PointFormat != PointFormat_DefaultValue) h.Add("pointFormat",PointFormat);
			if (PointFormatter != PointFormatter_DefaultValue) { h.Add("pointFormatter",PointFormatter); Highcharts.AddFunction("a0e1c534-ae1a-4e0c-bb05-5043de8f3345.pointFormatter", PointFormatter); }  
