...
namespace Highsoft.Web.Mvc.Charts
{
	public partial class PlotOptionsPyramidDragDropDragHandle  : BaseObject
	{
		...
		internal override Hashtable ToHashtable()
		{
			...
			if (PathFormatter != PathFormatter_DefaultValue) { h.Add("pathFormatter",PathFormatter); Highcharts.AddFunction("5dcd68b1-98ca-479b-8da2-1cc10c84e4b1.pathFormatter", PathFormatter); }  
