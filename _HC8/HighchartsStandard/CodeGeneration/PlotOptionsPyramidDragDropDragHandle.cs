...
namespace Highsoft.Web.Mvc.Charts
{
	public partial class PlotOptionsPyramidDragDropDragHandle  : BaseObject
	{
		...
		internal override Hashtable ToHashtable()
		{
			...
			if (PathFormatter != PathFormatter_DefaultValue) { h.Add("pathFormatter",PathFormatter); Highcharts.AddFunction("163eb9bc-8d10-4670-b85f-efb9e49ce7f6.pathFormatter", PathFormatter); }  
