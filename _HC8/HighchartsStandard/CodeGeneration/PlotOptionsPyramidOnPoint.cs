...
{
	public partial class PlotOptionsPyramidOnPoint  : BaseObject
	{
		Hashtable h = new Hashtable();

		public PlotOptionsPyramidOnPoint()
		{
			ConnectorOptions = ConnectorOptions_DefaultValue = new PlotOptionsPyramidOnPointConnectorOptions();
			Id = Id_DefaultValue = "";
			Position = Position_DefaultValue = new PlotOptionsPyramidOnPointPosition();
		...
		/// </summary>
		public PlotOptionsPyramidOnPointConnectorOptions ConnectorOptions { get; set; }
		private PlotOptionsPyramidOnPointConnectorOptions ConnectorOptions_DefaultValue { get; set; }
		...
		/// </summary>
		public PlotOptionsPyramidOnPointPosition Position { get; set; }
		private PlotOptionsPyramidOnPointPosition Position_DefaultValue { get; set; }
