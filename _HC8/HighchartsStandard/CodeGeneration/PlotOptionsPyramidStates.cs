...
{
	public partial class PlotOptionsPyramidStates  : PlotOptionsSeries
	{
		...
		public PlotOptionsPyramidStates()
		{
			...
			Inactive = Inactive_DefaultValue = new PlotOptionsPyramidStatesInactive();
			Normal = Normal_DefaultValue = new PlotOptionsPyramidStatesNormal();
		...
		/// </summary>
		public PlotOptionsPyramidStatesInactive Inactive { get; set; }
		private PlotOptionsPyramidStatesInactive Inactive_DefaultValue { get; set; }
		 

		/// <summary>
		/// The normal state of a series, or for point items in column, pieand similar series. Currently only used for setting animationwhen returning to normal state from hover.
		/// </summary>
		public PlotOptionsPyramidStatesNormal Normal { get; set; }
		private PlotOptionsPyramidStatesNormal Normal_DefaultValue { get; set; }
