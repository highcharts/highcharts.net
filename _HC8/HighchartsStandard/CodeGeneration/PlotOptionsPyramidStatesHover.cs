...
{
	public partial class PlotOptionsPyramidStatesHover  : PlotOptionsSeries
	{
		...
		public PlotOptionsPyramidStatesHover()
		{
			...
			Halo = Halo_DefaultValue = new PlotOptionsPyramidStatesHoverHalo();
			LineWidth = LineWidth_DefaultValue = null;
			LineWidthPlus = LineWidthPlus_DefaultValue = null;
			Marker = Marker_DefaultValue = new PlotOptionsPyramidStatesHoverMarker();
		...
		private PlotOptionsPyramidStatesHoverHalo Halo_DefaultValue { get; set; }
		...
		private PlotOptionsPyramidStatesHoverMarker Marker_DefaultValue { get; set; }
