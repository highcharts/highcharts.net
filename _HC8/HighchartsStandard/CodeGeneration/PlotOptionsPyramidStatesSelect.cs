...
{
	public partial class PlotOptionsPyramidStatesSelect  : PlotOptionsSeries
	{
		...
		public PlotOptionsPyramidStatesSelect()
		{
			...
			Halo = Halo_DefaultValue = new PlotOptionsPyramidStatesSelectHalo();
			LineWidth = LineWidth_DefaultValue = null;
			LineWidthPlus = LineWidthPlus_DefaultValue = null;
			Marker = Marker_DefaultValue = new PlotOptionsPyramidStatesSelectMarker();
		...
		/// </summary>
		public PlotOptionsPyramidStatesSelectHalo Halo { get; set; }
		private PlotOptionsPyramidStatesSelectHalo Halo_DefaultValue { get; set; }
		...
		/// </summary>
		public PlotOptionsPyramidStatesSelectMarker Marker { get; set; }
		private PlotOptionsPyramidStatesSelectMarker Marker_DefaultValue { get; set; }
