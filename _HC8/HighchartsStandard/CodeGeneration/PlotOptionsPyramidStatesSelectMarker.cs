...
{
	public partial class PlotOptionsPyramidStatesSelectMarker  : PlotOptionsSeries
	{
		Hashtable h = new Hashtable();

		public PlotOptionsPyramidStatesSelectMarker()
		{
			...
			States = States_DefaultValue = new PlotOptionsPyramidStatesSelectMarkerStates();
		...
		/// </summary>
		public PlotOptionsPyramidStatesSelectMarkerStates States { get; set; }
		private PlotOptionsPyramidStatesSelectMarkerStates States_DefaultValue { get; set; }
