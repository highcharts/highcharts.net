...
{
	public partial class PlotOptionsSankeyOnPoint  : BaseObject
	{
		Hashtable h = new Hashtable();

		public PlotOptionsSankeyOnPoint()
		{
			ConnectorOptions = ConnectorOptions_DefaultValue = new PlotOptionsSankeyOnPointConnectorOptions();
			Id = Id_DefaultValue = "";
			Position = Position_DefaultValue = new PlotOptionsSankeyOnPointPosition();
