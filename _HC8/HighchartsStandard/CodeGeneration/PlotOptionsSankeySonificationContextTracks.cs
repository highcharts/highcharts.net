...
{
	public partial class PlotOptionsSankeySonificationContextTracks  : BaseObject
	{
		Hashtable h = new Hashtable();

		public PlotOptionsSankeySonificationContextTracks()
		{
			ActiveWhen = ActiveWhen_DefaultValue = new PlotOptionsSankeySonificationContextTracksActiveWhen();
			Instrument = Instrument_DefaultValue = null;
			InstrumentString = InstrumentString_DefaultValue = "null";
			Mapping = Mapping_DefaultValue = new PlotOptionsSankeySonificationContextTracksMapping();
			MidiName = MidiName_DefaultValue = "";
			PointGrouping = PointGrouping_DefaultValue = new PlotOptionsSankeySonificationContextTracksPointGrouping();
			...
			Type = Type_DefaultValue = PlotOptionsSankeySonificationContextTracksType.Instrument;
			ValueInterval = ValueInterval_DefaultValue = null;
			ValueMapFunction = ValueMapFunction_DefaultValue = PlotOptionsSankeySonificationContextTracksValueMapFunction.Linear;
		...
		/// </summary>
		public PlotOptionsSankeySonificationContextTracksActiveWhen ActiveWhen { get; set; }
		private PlotOptionsSankeySonificationContextTracksActiveWhen ActiveWhen_DefaultValue { get; set; }
		...
		/// </summary>
		public PlotOptionsSankeySonificationContextTracksMapping Mapping { get; set; }
		private PlotOptionsSankeySonificationContextTracksMapping Mapping_DefaultValue { get; set; }
		...
		/// </summary>
		public PlotOptionsSankeySonificationContextTracksPointGrouping PointGrouping { get; set; }
		private PlotOptionsSankeySonificationContextTracksPointGrouping PointGrouping_DefaultValue { get; set; }
		...
		/// </summary>
		public PlotOptionsSankeySonificationContextTracksType Type { get; set; }
		private PlotOptionsSankeySonificationContextTracksType Type_DefaultValue { get; set; }
		...
		/// </summary>
		public PlotOptionsSankeySonificationContextTracksValueMapFunction ValueMapFunction { get; set; }
		private PlotOptionsSankeySonificationContextTracksValueMapFunction ValueMapFunction_DefaultValue { get; set; }
