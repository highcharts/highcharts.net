...
{
	public partial class PlotOptionsSankeyStatesSelect  : PlotOptionsSeries
	{
		Hashtable h = new Hashtable();

		public PlotOptionsSankeyStatesSelect()
		{
			Animation = Animation_DefaultValue = new Animation();
			Enabled = Enabled_DefaultValue = null;
			Halo = Halo_DefaultValue = new PlotOptionsSankeyStatesSelectHalo();
			LineWidth = LineWidth_DefaultValue = null;
			LineWidthPlus = LineWidthPlus_DefaultValue = null;
			Marker = Marker_DefaultValue = new PlotOptionsSankeyStatesSelectMarker();
		...
		/// </summary>
		public PlotOptionsSankeyStatesSelectHalo Halo { get; set; }
		private PlotOptionsSankeyStatesSelectHalo Halo_DefaultValue { get; set; }
		...
		/// </summary>
		public PlotOptionsSankeyStatesSelectMarker Marker { get; set; }
		private PlotOptionsSankeyStatesSelectMarker Marker_DefaultValue { get; set; }
