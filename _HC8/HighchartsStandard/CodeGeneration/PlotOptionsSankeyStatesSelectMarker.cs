...
{
	public partial class PlotOptionsSankeyStatesSelectMarker  : PlotOptionsSeries
	{
		Hashtable h = new Hashtable();

		public PlotOptionsSankeyStatesSelectMarker()
		{
			...
			States = States_DefaultValue = new PlotOptionsSankeyStatesSelectMarkerStates();
		...
		/// </summary>
		public PlotOptionsSankeyStatesSelectMarkerStates States { get; set; }
		private PlotOptionsSankeyStatesSelectMarkerStates States_DefaultValue { get; set; }
