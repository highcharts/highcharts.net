...
{
	public partial class PlotOptionsSankeyStatesSelectMarkerStatesHoverAnimation  : PlotOptionsSeries
	{
		Hashtable h = new Hashtable();

		public PlotOptionsSankeyStatesSelectMarkerStatesHoverAnimation()
		{
