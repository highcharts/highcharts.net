...
namespace Highsoft.Web.Mvc.Charts
{
	public partial class PlotOptionsScatter3d  : BaseObject
	{
		...
		{
			Accessibility = Accessibility_DefaultValue = new PlotOptionsScatter3dAccessibility();
			AllowPointSelect = AllowPointSelect_DefaultValue = false;
			Animation = Animation_DefaultValue = new Animation() { Enabled = true };
			AnimationLimit = AnimationLimit_DefaultValue = null;
			BoostBlending = BoostBlending_DefaultValue = PlotOptionsScatter3dBoostBlending.Undefined;
			BoostThreshold = BoostThreshold_DefaultValue = 5000;
			ClassName = ClassName_DefaultValue = "";
			Clip = Clip_DefaultValue = true;
			Cluster = Cluster_DefaultValue = new PlotOptionsScatter3dCluster();
			...
			DashStyle = DashStyle_DefaultValue = PlotOptionsScatter3dDashStyle.Null;
			DataLabels = DataLabels_DefaultValue = new PlotOptionsScatter3dDataLabels();
			DataSorting = DataSorting_DefaultValue = new PlotOptionsScatter3dDataSorting();
			Description = Description_DefaultValue = "";
			DragDrop = DragDrop_DefaultValue = new PlotOptionsScatter3dDragDrop();
			EnableMouseTracking = EnableMouseTracking_DefaultValue = true;
			Events = Events_DefaultValue = new PlotOptionsScatter3dEvents();
			FindNearestPointBy = FindNearestPointBy_DefaultValue = PlotOptionsScatter3dFindNearestPointBy.X;
			GetExtremesFromAll = GetExtremesFromAll_DefaultValue = false;
			IncludeInDataExport = IncludeInDataExport_DefaultValue = null;
			Jitter = Jitter_DefaultValue = new PlotOptionsScatter3dJitter();
			...
			Marker = Marker_DefaultValue = new PlotOptionsScatter3dMarker();
			NegativeColor = NegativeColor_DefaultValue = "";
			Opacity = Opacity_DefaultValue = 1;
			Point = Point_DefaultValue = new PlotOptionsScatter3dPoint();
			...
			States = States_DefaultValue = new PlotOptionsScatter3dStates();
		...
		/// </summary>
		public PlotOptionsScatter3dAccessibility Accessibility { get; set; }
		private PlotOptionsScatter3dAccessibility Accessibility_DefaultValue { get; set; }
		...
		/// </summary>
		public PlotOptionsScatter3dBoostBlending BoostBlending { get; set; }
		private PlotOptionsScatter3dBoostBlending BoostBlending_DefaultValue { get; set; }
		...
		/// </summary>
		public PlotOptionsScatter3dCluster Cluster { get; set; }
		private PlotOptionsScatter3dCluster Cluster_DefaultValue { get; set; }
		...
		/// </summary>
		public PlotOptionsScatter3dDataSorting DataSorting { get; set; }
		private PlotOptionsScatter3dDataSorting DataSorting_DefaultValue { get; set; }
		...
		/// </summary>
		public PlotOptionsScatter3dDragDrop DragDrop { get; set; }
		private PlotOptionsScatter3dDragDrop DragDrop_DefaultValue { get; set; }
		...
		/// </summary>
		public PlotOptionsScatter3dJitter Jitter { get; set; }
		private PlotOptionsScatter3dJitter Jitter_DefaultValue { get; set; }
		...
		internal override Hashtable ToHashtable()
		{
			...
			if (PointDescriptionFormatter != PointDescriptionFormatter_DefaultValue) { h.Add("pointDescriptionFormatter",PointDescriptionFormatter); Highcharts.AddFunction("ad35c52c-b99f-4f33-9ff2-f49fb9c67e99.pointDescriptionFormatter", PointDescriptionFormatter); }  
