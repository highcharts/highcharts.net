...
{
	public partial class PlotOptionsScatter3dClusterMarker  : BaseObject
	{
		Hashtable h = new Hashtable();

		public PlotOptionsScatter3dClusterMarker()
		{
			...
			States = States_DefaultValue = new PlotOptionsScatter3dClusterMarkerStates();
		...
		/// </summary>
		public PlotOptionsScatter3dClusterMarkerStates States { get; set; }
		private PlotOptionsScatter3dClusterMarkerStates States_DefaultValue { get; set; }
