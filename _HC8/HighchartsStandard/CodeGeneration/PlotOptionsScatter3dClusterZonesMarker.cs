...
{
	public partial class PlotOptionsScatter3dClusterZonesMarker  : BaseObject
	{
		Hashtable h = new Hashtable();

		public PlotOptionsScatter3dClusterZonesMarker()
		{
			...
			States = States_DefaultValue = new PlotOptionsScatter3dClusterZonesMarkerStates();
		...
		/// </summary>
		public PlotOptionsScatter3dClusterZonesMarkerStates States { get; set; }
		private PlotOptionsScatter3dClusterZonesMarkerStates States_DefaultValue { get; set; }
