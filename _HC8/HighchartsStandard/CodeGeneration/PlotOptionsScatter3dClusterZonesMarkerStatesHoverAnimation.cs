...
{
	public partial class PlotOptionsScatter3dClusterZonesMarkerStatesHoverAnimation  : BaseObject
	{
		Hashtable h = new Hashtable();

		public PlotOptionsScatter3dClusterZonesMarkerStatesHoverAnimation()
		{
