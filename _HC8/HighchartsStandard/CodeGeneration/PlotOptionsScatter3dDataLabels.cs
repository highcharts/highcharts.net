...
namespace Highsoft.Web.Mvc.Charts
{
	public partial class PlotOptionsScatter3dDataLabels  : BaseObject
	{
		...
		{
			Align = Align_DefaultValue = PlotOptionsScatter3dDataLabelsAlign.Center;
			...
			Filter = Filter_DefaultValue = new PlotOptionsScatter3dDataLabelsFilter();
			...
			Style = Style_DefaultValue = new PlotOptionsScatter3dDataLabelsStyle();
			TextPath = TextPath_DefaultValue = new PlotOptionsScatter3dDataLabelsTextPath();
			UseHTML = UseHTML_DefaultValue = false;
			VerticalAlign = VerticalAlign_DefaultValue = PlotOptionsScatter3dDataLabelsVerticalAlign.Bottom;
			X = X_DefaultValue = 0;
			Y = Y_DefaultValue = 0;
			Z = Z_DefaultValue = 6;
		...
		/// </summary>
		public PlotOptionsScatter3dDataLabelsAlign Align { get; set; }
		private PlotOptionsScatter3dDataLabelsAlign Align_DefaultValue { get; set; }
		...
		/// </summary>
		public PlotOptionsScatter3dDataLabelsFilter Filter { get; set; }
		private PlotOptionsScatter3dDataLabelsFilter Filter_DefaultValue { get; set; }
		...
		/// </summary>
		public PlotOptionsScatter3dDataLabelsStyle Style { get; set; }
		private PlotOptionsScatter3dDataLabelsStyle Style_DefaultValue { get; set; }
		...
		/// </summary>
		public PlotOptionsScatter3dDataLabelsTextPath TextPath { get; set; }
		private PlotOptionsScatter3dDataLabelsTextPath TextPath_DefaultValue { get; set; }
		...
		/// </summary>
		public PlotOptionsScatter3dDataLabelsVerticalAlign VerticalAlign { get; set; }
		private PlotOptionsScatter3dDataLabelsVerticalAlign VerticalAlign_DefaultValue { get; set; }
		...
		internal override Hashtable ToHashtable()
		{
			...
			if (Formatter != Formatter_DefaultValue) { h.Add("formatter",Formatter); Highcharts.AddFunction("089aceb1-86c5-42ca-8946-7b9d64495949.formatter", Formatter); }  
			if (Inside != Inside_DefaultValue) h.Add("inside",Inside);
			if (NullFormat != NullFormat_DefaultValue) h.Add("nullFormat",NullFormat);
			if (NullFormatter != NullFormatter_DefaultValue) { h.Add("nullFormatter",NullFormatter); Highcharts.AddFunction("a9346573-f1fd-4d17-be50-daf394eac516.nullFormatter", NullFormatter); }  
