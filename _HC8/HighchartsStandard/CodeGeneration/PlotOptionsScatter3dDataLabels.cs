...
namespace Highsoft.Web.Mvc.Charts
{
	public partial class PlotOptionsScatter3dDataLabels  : BaseObject
	{
		...
		public PlotOptionsScatter3dDataLabels()
		{
			...
			Overflow = Overflow_DefaultValue = PlotOptionsScatter3dDataLabelsOverflow.Justify;
			Padding = Padding_DefaultValue = 5;
			Position = Position_DefaultValue = PlotOptionsScatter3dDataLabelsPosition.Center;
