...
namespace Highsoft.Web.Mvc.Charts
{
	public partial class PlotOptionsScatter3dDragDropDragHandle  : BaseObject
	{
		...
		internal override Hashtable ToHashtable()
		{
			...
			if (PathFormatter != PathFormatter_DefaultValue) { h.Add("pathFormatter",PathFormatter); Highcharts.AddFunction("3dc318ba-6a94-49e7-8074-572ae1743814.pathFormatter", PathFormatter); }  
