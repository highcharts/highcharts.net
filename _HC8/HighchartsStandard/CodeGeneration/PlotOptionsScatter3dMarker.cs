...
{
	public partial class PlotOptionsScatter3dMarker  : PlotOptionsSeries
	{
		Hashtable h = new Hashtable();

		public PlotOptionsScatter3dMarker()
		{
			...
			States = States_DefaultValue = new PlotOptionsScatter3dMarkerStates();
		...
		/// </summary>
		public PlotOptionsScatter3dMarkerStates States { get; set; }
		private PlotOptionsScatter3dMarkerStates States_DefaultValue { get; set; }
