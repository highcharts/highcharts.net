...
namespace Highsoft.Web.Mvc.Charts
{
	public partial class PlotOptionsScatter3dSonification  : BaseObject
	{
		...
		{
			ContextTracks = ContextTracks_DefaultValue = new PlotOptionsScatter3dSonificationContextTracks();
			DefaultInstrumentOptions = DefaultInstrumentOptions_DefaultValue = new PlotOptionsScatter3dSonificationDefaultInstrumentOptions();
			DefaultSpeechOptions = DefaultSpeechOptions_DefaultValue = new PlotOptionsScatter3dSonificationDefaultSpeechOptions();
			Enabled = Enabled_DefaultValue = true;
			PointGrouping = PointGrouping_DefaultValue = new PlotOptionsScatter3dSonificationPointGrouping();
			Tracks = Tracks_DefaultValue = new PlotOptionsScatter3dSonificationTracks();
		...
		private PlotOptionsScatter3dSonificationContextTracks ContextTracks_DefaultValue { get; set; }
		...
		private PlotOptionsScatter3dSonificationDefaultInstrumentOptions DefaultInstrumentOptions_DefaultValue { get; set; }
		...
		private PlotOptionsScatter3dSonificationDefaultSpeechOptions DefaultSpeechOptions_DefaultValue { get; set; }
		...
		private PlotOptionsScatter3dSonificationPointGrouping PointGrouping_DefaultValue { get; set; }
		...
		private PlotOptionsScatter3dSonificationTracks Tracks_DefaultValue { get; set; }
