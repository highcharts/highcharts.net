...
{
	public partial class PlotOptionsScatter3dSonificationContextTracks  : BaseObject
	{
		Hashtable h = new Hashtable();

		public PlotOptionsScatter3dSonificationContextTracks()
		{
			ActiveWhen = ActiveWhen_DefaultValue = new PlotOptionsScatter3dSonificationContextTracksActiveWhen();
			Instrument = Instrument_DefaultValue = null;
			InstrumentString = InstrumentString_DefaultValue = "null";
			Mapping = Mapping_DefaultValue = new PlotOptionsScatter3dSonificationContextTracksMapping();
			MidiName = MidiName_DefaultValue = "";
			PointGrouping = PointGrouping_DefaultValue = new PlotOptionsScatter3dSonificationContextTracksPointGrouping();
			...
			Type = Type_DefaultValue = PlotOptionsScatter3dSonificationContextTracksType.Instrument;
			ValueInterval = ValueInterval_DefaultValue = null;
			ValueMapFunction = ValueMapFunction_DefaultValue = PlotOptionsScatter3dSonificationContextTracksValueMapFunction.Linear;
		...
		/// </summary>
		public PlotOptionsScatter3dSonificationContextTracksActiveWhen ActiveWhen { get; set; }
		private PlotOptionsScatter3dSonificationContextTracksActiveWhen ActiveWhen_DefaultValue { get; set; }
		...
		/// </summary>
		public PlotOptionsScatter3dSonificationContextTracksMapping Mapping { get; set; }
		private PlotOptionsScatter3dSonificationContextTracksMapping Mapping_DefaultValue { get; set; }
		...
		/// </summary>
		public PlotOptionsScatter3dSonificationContextTracksPointGrouping PointGrouping { get; set; }
		private PlotOptionsScatter3dSonificationContextTracksPointGrouping PointGrouping_DefaultValue { get; set; }
		...
		/// </summary>
		public PlotOptionsScatter3dSonificationContextTracksType Type { get; set; }
		private PlotOptionsScatter3dSonificationContextTracksType Type_DefaultValue { get; set; }
		...
		/// </summary>
		public PlotOptionsScatter3dSonificationContextTracksValueMapFunction ValueMapFunction { get; set; }
		private PlotOptionsScatter3dSonificationContextTracksValueMapFunction ValueMapFunction_DefaultValue { get; set; }
