...
namespace Highsoft.Web.Mvc.Charts
{
	public partial class PlotOptionsScatter3dSonificationContextTracksMappingHighpass  : BaseObject
	{
		...
		{
			Frequency = Frequency_DefaultValue = new PlotOptionsScatter3dSonificationContextTracksMappingHighpassFrequency();
			Resonance = Resonance_DefaultValue = new PlotOptionsScatter3dSonificationContextTracksMappingHighpassResonance();
		...
		private PlotOptionsScatter3dSonificationContextTracksMappingHighpassFrequency Frequency_DefaultValue { get; set; }
		...
		private PlotOptionsScatter3dSonificationContextTracksMappingHighpassResonance Resonance_DefaultValue { get; set; }
