...
{
	public partial class PlotOptionsScatter3dSonificationTracks  : BaseObject
	{
		Hashtable h = new Hashtable();

		public PlotOptionsScatter3dSonificationTracks()
		{
			ActiveWhen = ActiveWhen_DefaultValue = new PlotOptionsScatter3dSonificationTracksActiveWhen();
			Instrument = Instrument_DefaultValue = null;
			InstrumentString = InstrumentString_DefaultValue = "null";
			Mapping = Mapping_DefaultValue = new PlotOptionsScatter3dSonificationTracksMapping();
			MidiName = MidiName_DefaultValue = "";
			PointGrouping = PointGrouping_DefaultValue = new PlotOptionsScatter3dSonificationTracksPointGrouping();
			RoundToMusicalNotes = RoundToMusicalNotes_DefaultValue = true;
			ShowPlayMarker = ShowPlayMarker_DefaultValue = true;
			Type = Type_DefaultValue = PlotOptionsScatter3dSonificationTracksType.Instrument;
		...
		/// </summary>
		public PlotOptionsScatter3dSonificationTracksActiveWhen ActiveWhen { get; set; }
		private PlotOptionsScatter3dSonificationTracksActiveWhen ActiveWhen_DefaultValue { get; set; }
		...
		/// </summary>
		public PlotOptionsScatter3dSonificationTracksMapping Mapping { get; set; }
		private PlotOptionsScatter3dSonificationTracksMapping Mapping_DefaultValue { get; set; }
		...
		/// </summary>
		public PlotOptionsScatter3dSonificationTracksPointGrouping PointGrouping { get; set; }
		private PlotOptionsScatter3dSonificationTracksPointGrouping PointGrouping_DefaultValue { get; set; }
		...
		/// </summary>
		public PlotOptionsScatter3dSonificationTracksType Type { get; set; }
		private PlotOptionsScatter3dSonificationTracksType Type_DefaultValue { get; set; }
