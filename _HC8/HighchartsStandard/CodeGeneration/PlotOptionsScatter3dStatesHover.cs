...
{
	public partial class PlotOptionsScatter3dStatesHover  : PlotOptionsSeries
	{
		Hashtable h = new Hashtable();

		public PlotOptionsScatter3dStatesHover()
		{
			Animation = Animation_DefaultValue = new Animation();
			Enabled = Enabled_DefaultValue = null;
			Halo = Halo_DefaultValue = new PlotOptionsScatter3dStatesHoverHalo();
			LineWidth = LineWidth_DefaultValue = null;
			LineWidthPlus = LineWidthPlus_DefaultValue = null;
			Marker = Marker_DefaultValue = new PlotOptionsScatter3dStatesHoverMarker();
		...
		/// </summary>
		public PlotOptionsScatter3dStatesHoverHalo Halo { get; set; }
		private PlotOptionsScatter3dStatesHoverHalo Halo_DefaultValue { get; set; }
		...
		/// </summary>
		public PlotOptionsScatter3dStatesHoverMarker Marker { get; set; }
		private PlotOptionsScatter3dStatesHoverMarker Marker_DefaultValue { get; set; }
