...
{
	public partial class PlotOptionsScatter3dStatesHoverMarker  : PlotOptionsSeries
	{
		Hashtable h = new Hashtable();

		public PlotOptionsScatter3dStatesHoverMarker()
		{
			...
			States = States_DefaultValue = new PlotOptionsScatter3dStatesHoverMarkerStates();
		...
		/// </summary>
		public PlotOptionsScatter3dStatesHoverMarkerStates States { get; set; }
		private PlotOptionsScatter3dStatesHoverMarkerStates States_DefaultValue { get; set; }
