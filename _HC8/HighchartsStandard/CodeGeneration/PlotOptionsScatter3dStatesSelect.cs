...
{
	public partial class PlotOptionsScatter3dStatesSelect  : PlotOptionsSeries
	{
		Hashtable h = new Hashtable();

		public PlotOptionsScatter3dStatesSelect()
		{
			Animation = Animation_DefaultValue = new Animation();
			Enabled = Enabled_DefaultValue = null;
			Halo = Halo_DefaultValue = new PlotOptionsScatter3dStatesSelectHalo();
			LineWidth = LineWidth_DefaultValue = null;
			LineWidthPlus = LineWidthPlus_DefaultValue = null;
			Marker = Marker_DefaultValue = new PlotOptionsScatter3dStatesSelectMarker();
		...
		/// </summary>
		public PlotOptionsScatter3dStatesSelectHalo Halo { get; set; }
		private PlotOptionsScatter3dStatesSelectHalo Halo_DefaultValue { get; set; }
		...
		/// </summary>
		public PlotOptionsScatter3dStatesSelectMarker Marker { get; set; }
		private PlotOptionsScatter3dStatesSelectMarker Marker_DefaultValue { get; set; }
