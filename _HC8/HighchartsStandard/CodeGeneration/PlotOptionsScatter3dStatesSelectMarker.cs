...
{
	public partial class PlotOptionsScatter3dStatesSelectMarker  : PlotOptionsSeries
	{
		Hashtable h = new Hashtable();

		public PlotOptionsScatter3dStatesSelectMarker()
		{
			...
			States = States_DefaultValue = new PlotOptionsScatter3dStatesSelectMarkerStates();
		...
		/// </summary>
		public PlotOptionsScatter3dStatesSelectMarkerStates States { get; set; }
		private PlotOptionsScatter3dStatesSelectMarkerStates States_DefaultValue { get; set; }
