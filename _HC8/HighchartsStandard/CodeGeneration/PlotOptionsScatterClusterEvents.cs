...
namespace Highsoft.Web.Mvc.Charts
{
	public partial class PlotOptionsScatterClusterEvents  : BaseObject
	{
		...
		internal override Hashtable ToHashtable()
		{
			...
			if (DrillToCluster != DrillToCluster_DefaultValue) { h.Add("drillToCluster",DrillToCluster); Highcharts.AddFunction("02af583d-76ca-4028-9b7a-61e9dc5d2ec1.drillToCluster", DrillToCluster); }  
