...
{
	public partial class PlotOptionsScatterClusterZone  : PlotOptionsSeries
	{
		Hashtable h = new Hashtable();

		public PlotOptionsScatterClusterZone()
		{
			ClassName = ClassName_DefaultValue = "";
			From = From_DefaultValue = null;
			Marker = Marker_DefaultValue = new PlotOptionsScatterClusterZonesMarker();
