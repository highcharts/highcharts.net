...
namespace Highsoft.Web.Mvc.Charts
{
	public partial class PlotOptionsScatterDataLabels  : BaseObject
	{
		...
		internal override Hashtable ToHashtable()
		{
			...
			if (Formatter != Formatter_DefaultValue) { h.Add("formatter",Formatter); Highcharts.AddFunction("f8bebedf-14de-4654-91dd-d62deac7e3b7.formatter", Formatter); }  
			...
			if (NullFormatter != NullFormatter_DefaultValue) { h.Add("nullFormatter",NullFormatter); Highcharts.AddFunction("62c7a6de-462c-41ae-8eed-101ba5067513.nullFormatter", NullFormatter); }  
