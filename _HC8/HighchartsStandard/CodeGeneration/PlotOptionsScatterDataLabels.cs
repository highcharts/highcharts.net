...
namespace Highsoft.Web.Mvc.Charts
{
	public partial class PlotOptionsScatterDataLabels  : BaseObject
	{
		...
		public PlotOptionsScatterDataLabels()
		{
			...
			Filter = Filter_DefaultValue = new PlotOptionsScatterDataLabelsFilter();
			...
			Style = Style_DefaultValue = new PlotOptionsScatterDataLabelsStyle();
			TextPath = TextPath_DefaultValue = new PlotOptionsScatterDataLabelsTextPath();
		...
		/// </summary>
		public PlotOptionsScatterDataLabelsFilter Filter { get; set; }
		private PlotOptionsScatterDataLabelsFilter Filter_DefaultValue { get; set; }
		...
		/// </summary>
		public PlotOptionsScatterDataLabelsStyle Style { get; set; }
		private PlotOptionsScatterDataLabelsStyle Style_DefaultValue { get; set; }
		...
		/// </summary>
		public PlotOptionsScatterDataLabelsTextPath TextPath { get; set; }
		private PlotOptionsScatterDataLabelsTextPath TextPath_DefaultValue { get; set; }
		...
		internal override Hashtable ToHashtable()
		{
			...
			if (Formatter != Formatter_DefaultValue) { h.Add("formatter",Formatter); Highcharts.AddFunction("cae5e9a3-f660-4ac8-b1ed-5e2947b660b6.formatter", Formatter); }  
			if (Inside != Inside_DefaultValue) h.Add("inside",Inside);
			if (NullFormat != NullFormat_DefaultValue) h.Add("nullFormat",NullFormat);
			if (NullFormatter != NullFormatter_DefaultValue) { h.Add("nullFormatter",NullFormatter); Highcharts.AddFunction("cf084d52-f9b9-49fd-9dc6-63a3370f11d1.nullFormatter", NullFormatter); }  
