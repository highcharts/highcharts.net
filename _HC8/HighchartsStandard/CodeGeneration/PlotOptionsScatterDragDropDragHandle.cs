...
namespace Highsoft.Web.Mvc.Charts
{
	public partial class PlotOptionsScatterDragDropDragHandle  : BaseObject
	{
		...
		internal override Hashtable ToHashtable()
		{
			...
			if (PathFormatter != PathFormatter_DefaultValue) { h.Add("pathFormatter",PathFormatter); Highcharts.AddFunction("0db9c8f8-d532-4aac-ba91-cf152c1e3e1a.pathFormatter", PathFormatter); }  
