...
{
	public partial class PlotOptionsScatterStatesSelect  : PlotOptionsSeries
	{
		Hashtable h = new Hashtable();

		public PlotOptionsScatterStatesSelect()
		{
			Animation = Animation_DefaultValue = new Animation();
			Enabled = Enabled_DefaultValue = null;
			Halo = Halo_DefaultValue = new PlotOptionsScatterStatesSelectHalo();
			LineWidth = LineWidth_DefaultValue = null;
			LineWidthPlus = LineWidthPlus_DefaultValue = null;
			Marker = Marker_DefaultValue = new PlotOptionsScatterStatesSelectMarker();
		...
		/// </summary>
		public PlotOptionsScatterStatesSelectHalo Halo { get; set; }
		private PlotOptionsScatterStatesSelectHalo Halo_DefaultValue { get; set; }
		...
		/// </summary>
		public PlotOptionsScatterStatesSelectMarker Marker { get; set; }
		private PlotOptionsScatterStatesSelectMarker Marker_DefaultValue { get; set; }
