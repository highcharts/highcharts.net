...
{
	public partial class PlotOptionsScatterStatesSelectMarker  : PlotOptionsSeries
	{
		Hashtable h = new Hashtable();

		public PlotOptionsScatterStatesSelectMarker()
		{
			...
			States = States_DefaultValue = new PlotOptionsScatterStatesSelectMarkerStates();
		...
		/// </summary>
		public PlotOptionsScatterStatesSelectMarkerStates States { get; set; }
		private PlotOptionsScatterStatesSelectMarkerStates States_DefaultValue { get; set; }
