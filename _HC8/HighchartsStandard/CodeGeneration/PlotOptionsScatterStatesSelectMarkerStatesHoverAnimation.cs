...
{
	public partial class PlotOptionsScatterStatesSelectMarkerStatesHoverAnimation  : PlotOptionsSeries
	{
		Hashtable h = new Hashtable();

		public PlotOptionsScatterStatesSelectMarkerStatesHoverAnimation()
		{
