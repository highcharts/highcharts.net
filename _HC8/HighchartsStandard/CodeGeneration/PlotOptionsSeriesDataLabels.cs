...
{
	public partial class PlotOptionsSeriesDataLabels  : BaseObject
	{
		Hashtable h = new Hashtable();

		public PlotOptionsSeriesDataLabels()
		{
			Align = Align_DefaultValue = PlotOptionsSeriesDataLabelsAlign.Center;
			...
			Filter = Filter_DefaultValue = new PlotOptionsSeriesDataLabelsFilter();
			...
			Style = Style_DefaultValue = new PlotOptionsSeriesDataLabelsStyle();
			TextPath = TextPath_DefaultValue = new PlotOptionsSeriesDataLabelsTextPath();
			UseHTML = UseHTML_DefaultValue = false;
			VerticalAlign = VerticalAlign_DefaultValue = PlotOptionsSeriesDataLabelsVerticalAlign.Bottom;
			X = X_DefaultValue = 0;
			Y = Y_DefaultValue = 0;
			Z = Z_DefaultValue = 6;
		...
		/// </summary>
		public PlotOptionsSeriesDataLabelsAlign Align { get; set; }
		private PlotOptionsSeriesDataLabelsAlign Align_DefaultValue { get; set; }
		...
		/// </summary>
		public PlotOptionsSeriesDataLabelsFilter Filter { get; set; }
		private PlotOptionsSeriesDataLabelsFilter Filter_DefaultValue { get; set; }
		...
		/// </summary>
		public PlotOptionsSeriesDataLabelsStyle Style { get; set; }
		private PlotOptionsSeriesDataLabelsStyle Style_DefaultValue { get; set; }
		...
		/// </summary>
		public PlotOptionsSeriesDataLabelsTextPath TextPath { get; set; }
		private PlotOptionsSeriesDataLabelsTextPath TextPath_DefaultValue { get; set; }
		...
		/// </summary>
		public PlotOptionsSeriesDataLabelsVerticalAlign VerticalAlign { get; set; }
		private PlotOptionsSeriesDataLabelsVerticalAlign VerticalAlign_DefaultValue { get; set; }
		...
		internal override Hashtable ToHashtable()
		{
			...
			if (Formatter != Formatter_DefaultValue) { h.Add("formatter",Formatter); Highcharts.AddFunction("e1b9fe39-0f57-46d7-a05d-d468cdd2101d.formatter", Formatter); }  
			...
			if (NullFormatter != NullFormatter_DefaultValue) { h.Add("nullFormatter",NullFormatter); Highcharts.AddFunction("23539ebf-46e8-458a-8001-bbd80678c88b.nullFormatter", NullFormatter); }  
