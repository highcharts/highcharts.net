...
namespace Highsoft.Web.Mvc.Charts
{
	public partial class PlotOptionsSeriesDataLabels  : BaseObject
	{
		...
		internal override Hashtable ToHashtable()
		{
			...
			if (Formatter != Formatter_DefaultValue) { h.Add("formatter",Formatter); Highcharts.AddFunction("dc3b973f-e70a-4f5e-ad8c-baa930765471.formatter", Formatter); }  
			...
			if (NullFormatter != NullFormatter_DefaultValue) { h.Add("nullFormatter",NullFormatter); Highcharts.AddFunction("083776f6-c7b3-43c2-b1db-fb944d119112.nullFormatter", NullFormatter); }  
