...
namespace Highsoft.Web.Mvc.Charts
{
	public partial class PlotOptionsSeriesDragDropDragHandle  : BaseObject
	{
		...
		internal override Hashtable ToHashtable()
		{
			...
			if (PathFormatter != PathFormatter_DefaultValue) { h.Add("pathFormatter",PathFormatter); Highcharts.AddFunction("c83fce76-7f47-4f11-9eb5-53516c5f3bf9.pathFormatter", PathFormatter); }  
