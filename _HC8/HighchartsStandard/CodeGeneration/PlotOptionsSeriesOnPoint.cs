...
{
	public partial class PlotOptionsSeriesOnPoint  : BaseObject
	{
		Hashtable h = new Hashtable();

		public PlotOptionsSeriesOnPoint()
		{
			ConnectorOptions = ConnectorOptions_DefaultValue = new PlotOptionsSeriesOnPointConnectorOptions();
			Id = Id_DefaultValue = "";
			Position = Position_DefaultValue = new PlotOptionsSeriesOnPointPosition();
		...
		/// </summary>
		public PlotOptionsSeriesOnPointConnectorOptions ConnectorOptions { get; set; }
		private PlotOptionsSeriesOnPointConnectorOptions ConnectorOptions_DefaultValue { get; set; }
		...
		/// </summary>
		public PlotOptionsSeriesOnPointPosition Position { get; set; }
		private PlotOptionsSeriesOnPointPosition Position_DefaultValue { get; set; }
