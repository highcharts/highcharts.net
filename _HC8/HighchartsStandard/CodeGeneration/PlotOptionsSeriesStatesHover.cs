...
{
	public partial class PlotOptionsSeriesStatesHover  : PlotOptionsSeries
	{
		...
		public PlotOptionsSeriesStatesHover()
		{
			...
			Halo = Halo_DefaultValue = new PlotOptionsSeriesStatesHoverHalo();
			LineWidth = LineWidth_DefaultValue = null;
			LineWidthPlus = LineWidthPlus_DefaultValue = null;
			Marker = Marker_DefaultValue = new PlotOptionsSeriesStatesHoverMarker();
		...
		private PlotOptionsSeriesStatesHoverHalo Halo_DefaultValue { get; set; }
		...
		private PlotOptionsSeriesStatesHoverMarker Marker_DefaultValue { get; set; }
