...
{
	public partial class PlotOptionsSeriesStatesSelect  : PlotOptionsSeries
	{
		Hashtable h = new Hashtable();

		public PlotOptionsSeriesStatesSelect()
		{
			Animation = Animation_DefaultValue = new Animation();
			Enabled = Enabled_DefaultValue = null;
			Halo = Halo_DefaultValue = new PlotOptionsSeriesStatesSelectHalo();
			LineWidth = LineWidth_DefaultValue = null;
			LineWidthPlus = LineWidthPlus_DefaultValue = null;
			Marker = Marker_DefaultValue = new PlotOptionsSeriesStatesSelectMarker();
		...
		/// </summary>
		public PlotOptionsSeriesStatesSelectHalo Halo { get; set; }
		private PlotOptionsSeriesStatesSelectHalo Halo_DefaultValue { get; set; }
		...
		/// </summary>
		public PlotOptionsSeriesStatesSelectMarker Marker { get; set; }
		private PlotOptionsSeriesStatesSelectMarker Marker_DefaultValue { get; set; }
