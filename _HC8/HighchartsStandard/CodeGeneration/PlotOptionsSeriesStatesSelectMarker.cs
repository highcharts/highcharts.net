...
{
	public partial class PlotOptionsSeriesStatesSelectMarker  : PlotOptionsSeries
	{
		Hashtable h = new Hashtable();

		public PlotOptionsSeriesStatesSelectMarker()
		{
			...
			States = States_DefaultValue = new PlotOptionsSeriesStatesSelectMarkerStates();
		...
		/// </summary>
		public PlotOptionsSeriesStatesSelectMarkerStates States { get; set; }
		private PlotOptionsSeriesStatesSelectMarkerStates States_DefaultValue { get; set; }
