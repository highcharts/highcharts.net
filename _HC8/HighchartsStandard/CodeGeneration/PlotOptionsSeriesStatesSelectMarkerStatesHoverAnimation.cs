...
{
	public partial class PlotOptionsSeriesStatesSelectMarkerStatesHoverAnimation  : PlotOptionsSeries
	{
		Hashtable h = new Hashtable();

		public PlotOptionsSeriesStatesSelectMarkerStatesHoverAnimation()
		{
