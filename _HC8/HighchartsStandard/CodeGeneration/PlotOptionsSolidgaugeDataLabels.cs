...
namespace Highsoft.Web.Mvc.Charts
{
	public partial class PlotOptionsSolidgaugeDataLabels  : BaseObject
	{
		...
		public PlotOptionsSolidgaugeDataLabels()
		{
			...
			Style = Style_DefaultValue = new PlotOptionsSolidgaugeDataLabelsStyle();
			TextPath = TextPath_DefaultValue = new PlotOptionsSolidgaugeDataLabelsTextPath();
			UseHTML = UseHTML_DefaultValue = false;
			VerticalAlign = VerticalAlign_DefaultValue = PlotOptionsSolidgaugeDataLabelsVerticalAlign.Bottom;
			X = X_DefaultValue = 0;
			Y = Y_DefaultValue = 0;
			Z = Z_DefaultValue = 6;
		...
		/// </summary>
		public PlotOptionsSolidgaugeDataLabelsFilter Filter { get; set; }
		private PlotOptionsSolidgaugeDataLabelsFilter Filter_DefaultValue { get; set; }
		...
		/// </summary>
		public PlotOptionsSolidgaugeDataLabelsStyle Style { get; set; }
		private PlotOptionsSolidgaugeDataLabelsStyle Style_DefaultValue { get; set; }
		...
		/// </summary>
		public PlotOptionsSolidgaugeDataLabelsTextPath TextPath { get; set; }
		private PlotOptionsSolidgaugeDataLabelsTextPath TextPath_DefaultValue { get; set; }
		...
		/// </summary>
		public PlotOptionsSolidgaugeDataLabelsVerticalAlign VerticalAlign { get; set; }
		private PlotOptionsSolidgaugeDataLabelsVerticalAlign VerticalAlign_DefaultValue { get; set; }
		...
		internal override Hashtable ToHashtable()
		{
			...
			if (Formatter != Formatter_DefaultValue) { h.Add("formatter",Formatter); Highcharts.AddFunction("c9a915ae-c5fe-4997-bb6e-c4f22fb5c6a2.formatter", Formatter); }  
			if (Inside != Inside_DefaultValue) h.Add("inside",Inside);
			if (NullFormat != NullFormat_DefaultValue) h.Add("nullFormat",NullFormat);
			if (NullFormatter != NullFormatter_DefaultValue) { h.Add("nullFormatter",NullFormatter); Highcharts.AddFunction("94f94e45-2a23-4961-ac9e-536386789264.nullFormatter", NullFormatter); }  
