...
{
	public partial class PlotOptionsSolidgaugeOnPoint  : BaseObject
	{
		Hashtable h = new Hashtable();

		public PlotOptionsSolidgaugeOnPoint()
		{
			ConnectorOptions = ConnectorOptions_DefaultValue = new PlotOptionsSolidgaugeOnPointConnectorOptions();
			Id = Id_DefaultValue = "";
			Position = Position_DefaultValue = new PlotOptionsSolidgaugeOnPointPosition();
		...
		/// </summary>
		public PlotOptionsSolidgaugeOnPointConnectorOptions ConnectorOptions { get; set; }
		private PlotOptionsSolidgaugeOnPointConnectorOptions ConnectorOptions_DefaultValue { get; set; }
		...
		/// </summary>
		public PlotOptionsSolidgaugeOnPointPosition Position { get; set; }
		private PlotOptionsSolidgaugeOnPointPosition Position_DefaultValue { get; set; }
