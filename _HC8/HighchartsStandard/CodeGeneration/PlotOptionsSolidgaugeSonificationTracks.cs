...
{
	public partial class PlotOptionsSolidgaugeSonificationTracks  : BaseObject
	{
		Hashtable h = new Hashtable();

		public PlotOptionsSolidgaugeSonificationTracks()
		{
			ActiveWhen = ActiveWhen_DefaultValue = new PlotOptionsSolidgaugeSonificationTracksActiveWhen();
			Instrument = Instrument_DefaultValue = null;
			InstrumentString = InstrumentString_DefaultValue = "null";
			Mapping = Mapping_DefaultValue = new PlotOptionsSolidgaugeSonificationTracksMapping();
			MidiName = MidiName_DefaultValue = "";
			PointGrouping = PointGrouping_DefaultValue = new PlotOptionsSolidgaugeSonificationTracksPointGrouping();
			RoundToMusicalNotes = RoundToMusicalNotes_DefaultValue = true;
			ShowPlayMarker = ShowPlayMarker_DefaultValue = true;
			Type = Type_DefaultValue = PlotOptionsSolidgaugeSonificationTracksType.Instrument;
		...
		/// </summary>
		public PlotOptionsSolidgaugeSonificationTracksActiveWhen ActiveWhen { get; set; }
		private PlotOptionsSolidgaugeSonificationTracksActiveWhen ActiveWhen_DefaultValue { get; set; }
		...
		/// </summary>
		public PlotOptionsSolidgaugeSonificationTracksMapping Mapping { get; set; }
		private PlotOptionsSolidgaugeSonificationTracksMapping Mapping_DefaultValue { get; set; }
		...
		/// </summary>
		public PlotOptionsSolidgaugeSonificationTracksPointGrouping PointGrouping { get; set; }
		private PlotOptionsSolidgaugeSonificationTracksPointGrouping PointGrouping_DefaultValue { get; set; }
		...
		/// </summary>
		public PlotOptionsSolidgaugeSonificationTracksType Type { get; set; }
		private PlotOptionsSolidgaugeSonificationTracksType Type_DefaultValue { get; set; }
