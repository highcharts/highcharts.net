...
{
	public partial class PlotOptionsSplineDataLabels  : BaseObject
	{
		Hashtable h = new Hashtable();

		public PlotOptionsSplineDataLabels()
		{
			Align = Align_DefaultValue = PlotOptionsSplineDataLabelsAlign.Center;
			...
			Filter = Filter_DefaultValue = new PlotOptionsSplineDataLabelsFilter();
			...
			Style = Style_DefaultValue = new PlotOptionsSplineDataLabelsStyle();
			TextPath = TextPath_DefaultValue = new PlotOptionsSplineDataLabelsTextPath();
			UseHTML = UseHTML_DefaultValue = false;
			VerticalAlign = VerticalAlign_DefaultValue = PlotOptionsSplineDataLabelsVerticalAlign.Bottom;
			X = X_DefaultValue = 0;
			Y = Y_DefaultValue = 0;
			Z = Z_DefaultValue = 6;
		...
		/// </summary>
		public PlotOptionsSplineDataLabelsAlign Align { get; set; }
		private PlotOptionsSplineDataLabelsAlign Align_DefaultValue { get; set; }
		...
		/// </summary>
		public PlotOptionsSplineDataLabelsFilter Filter { get; set; }
		private PlotOptionsSplineDataLabelsFilter Filter_DefaultValue { get; set; }
		...
		/// </summary>
		public PlotOptionsSplineDataLabelsStyle Style { get; set; }
		private PlotOptionsSplineDataLabelsStyle Style_DefaultValue { get; set; }
		...
		/// </summary>
		public PlotOptionsSplineDataLabelsTextPath TextPath { get; set; }
		private PlotOptionsSplineDataLabelsTextPath TextPath_DefaultValue { get; set; }
		...
		/// </summary>
		public PlotOptionsSplineDataLabelsVerticalAlign VerticalAlign { get; set; }
		private PlotOptionsSplineDataLabelsVerticalAlign VerticalAlign_DefaultValue { get; set; }
		...
		internal override Hashtable ToHashtable()
		{
			...
			if (Formatter != Formatter_DefaultValue) { h.Add("formatter",Formatter); Highcharts.AddFunction("c29b93ef-4629-496c-9806-9243af9af622.formatter", Formatter); }  
			if (Inside != Inside_DefaultValue) h.Add("inside",Inside);
			if (NullFormat != NullFormat_DefaultValue) h.Add("nullFormat",NullFormat);
			if (NullFormatter != NullFormatter_DefaultValue) { h.Add("nullFormatter",NullFormatter); Highcharts.AddFunction("6b05f26a-3563-4a75-b4b0-3a3f0360d7b5.nullFormatter", NullFormatter); }  
