...
namespace Highsoft.Web.Mvc.Charts
{
	public partial class PlotOptionsSplineDragDropDragHandle  : BaseObject
	{
		...
		internal override Hashtable ToHashtable()
		{
			...
			if (PathFormatter != PathFormatter_DefaultValue) { h.Add("pathFormatter",PathFormatter); Highcharts.AddFunction("cb4a9aae-eaa7-4584-b960-a32df0617e69.pathFormatter", PathFormatter); }  
