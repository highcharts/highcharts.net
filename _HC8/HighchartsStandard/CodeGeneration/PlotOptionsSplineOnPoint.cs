...
{
	public partial class PlotOptionsSplineOnPoint  : BaseObject
	{
		Hashtable h = new Hashtable();

		public PlotOptionsSplineOnPoint()
		{
			ConnectorOptions = ConnectorOptions_DefaultValue = new PlotOptionsSplineOnPointConnectorOptions();
			Id = Id_DefaultValue = "";
			Position = Position_DefaultValue = new PlotOptionsSplineOnPointPosition();
		...
		/// </summary>
		public PlotOptionsSplineOnPointConnectorOptions ConnectorOptions { get; set; }
		private PlotOptionsSplineOnPointConnectorOptions ConnectorOptions_DefaultValue { get; set; }
		...
		/// </summary>
		public PlotOptionsSplineOnPointPosition Position { get; set; }
		private PlotOptionsSplineOnPointPosition Position_DefaultValue { get; set; }
