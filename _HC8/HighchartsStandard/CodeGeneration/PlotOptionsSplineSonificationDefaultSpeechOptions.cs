...
{
	public partial class PlotOptionsSplineSonificationDefaultSpeechOptions  : BaseObject
	{
		Hashtable h = new Hashtable();

		public PlotOptionsSplineSonificationDefaultSpeechOptions()
		{
			ActiveWhen = ActiveWhen_DefaultValue = new PlotOptionsSplineSonificationDefaultSpeechOptionsActiveWhen();
			Language = Language_DefaultValue = "en-US";
			Mapping = Mapping_DefaultValue = new PlotOptionsSplineSonificationDefaultSpeechOptionsMapping();
			PointGrouping = PointGrouping_DefaultValue = new PlotOptionsSplineSonificationDefaultSpeechOptionsPointGrouping();
			PreferredVoice = PreferredVoice_DefaultValue = "";
			ShowPlayMarker = ShowPlayMarker_DefaultValue = true;
			Type = Type_DefaultValue = PlotOptionsSplineSonificationDefaultSpeechOptionsType.Instrument;
		...
		/// </summary>
		public PlotOptionsSplineSonificationDefaultSpeechOptionsActiveWhen ActiveWhen { get; set; }
		private PlotOptionsSplineSonificationDefaultSpeechOptionsActiveWhen ActiveWhen_DefaultValue { get; set; }
		...
		/// </summary>
		public PlotOptionsSplineSonificationDefaultSpeechOptionsMapping Mapping { get; set; }
		private PlotOptionsSplineSonificationDefaultSpeechOptionsMapping Mapping_DefaultValue { get; set; }
		 

		/// <summary>
		/// Options for point grouping, specifically for instrument tracks.
		/// </summary>
		public PlotOptionsSplineSonificationDefaultSpeechOptionsPointGrouping PointGrouping { get; set; }
		private PlotOptionsSplineSonificationDefaultSpeechOptionsPointGrouping PointGrouping_DefaultValue { get; set; }
		...
		/// </summary>
		public PlotOptionsSplineSonificationDefaultSpeechOptionsType Type { get; set; }
		private PlotOptionsSplineSonificationDefaultSpeechOptionsType Type_DefaultValue { get; set; }
