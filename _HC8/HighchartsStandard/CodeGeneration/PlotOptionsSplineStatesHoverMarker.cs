...
{
	public partial class PlotOptionsSplineStatesHoverMarker  : PlotOptionsSeries
	{
		...
		public PlotOptionsSplineStatesHoverMarker()
		{
			...
			States = States_DefaultValue = new PlotOptionsSplineStatesHoverMarkerStates();
		...
		/// </summary>
		public PlotOptionsSplineStatesHoverMarkerStates States { get; set; }
		private PlotOptionsSplineStatesHoverMarkerStates States_DefaultValue { get; set; }
