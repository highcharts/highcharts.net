...
{
	public partial class PlotOptionsSplineStatesSelect  : PlotOptionsSeries
	{
		Hashtable h = new Hashtable();

		public PlotOptionsSplineStatesSelect()
		{
			Animation = Animation_DefaultValue = new Animation();
			Enabled = Enabled_DefaultValue = null;
			Halo = Halo_DefaultValue = new PlotOptionsSplineStatesSelectHalo();
			LineWidth = LineWidth_DefaultValue = null;
			LineWidthPlus = LineWidthPlus_DefaultValue = null;
			Marker = Marker_DefaultValue = new PlotOptionsSplineStatesSelectMarker();
		...
		/// </summary>
		public PlotOptionsSplineStatesSelectHalo Halo { get; set; }
		private PlotOptionsSplineStatesSelectHalo Halo_DefaultValue { get; set; }
		...
		/// </summary>
		public PlotOptionsSplineStatesSelectMarker Marker { get; set; }
		private PlotOptionsSplineStatesSelectMarker Marker_DefaultValue { get; set; }
