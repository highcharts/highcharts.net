...
{
	public partial class PlotOptionsSplineStatesSelectMarker  : PlotOptionsSeries
	{
		Hashtable h = new Hashtable();

		public PlotOptionsSplineStatesSelectMarker()
		{
			...
			States = States_DefaultValue = new PlotOptionsSplineStatesSelectMarkerStates();
		...
		/// </summary>
		public PlotOptionsSplineStatesSelectMarkerStates States { get; set; }
		private PlotOptionsSplineStatesSelectMarkerStates States_DefaultValue { get; set; }
