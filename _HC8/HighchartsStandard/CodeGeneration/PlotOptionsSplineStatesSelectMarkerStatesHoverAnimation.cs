...
{
	public partial class PlotOptionsSplineStatesSelectMarkerStatesHoverAnimation  : PlotOptionsSeries
	{
		Hashtable h = new Hashtable();

		public PlotOptionsSplineStatesSelectMarkerStatesHoverAnimation()
		{
