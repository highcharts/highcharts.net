...
namespace Highsoft.Web.Mvc.Charts
{
	public partial class PlotOptionsStreamgraph  : BaseObject
	{
		...
		internal override Hashtable ToHashtable()
		{
			...
			if (PointDescriptionFormatter != PointDescriptionFormatter_DefaultValue) { h.Add("pointDescriptionFormatter",PointDescriptionFormatter); Highcharts.AddFunction("81b2bbc2-2cc0-4239-a1cf-e8ea7b76e235.pointDescriptionFormatter", PointDescriptionFormatter); }  
