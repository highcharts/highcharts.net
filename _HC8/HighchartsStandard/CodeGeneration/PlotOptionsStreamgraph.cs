...
namespace Highsoft.Web.Mvc.Charts
{
	public partial class PlotOptionsStreamgraph  : BaseObject
	{
		...
		internal override Hashtable ToHashtable()
		{
			...
			if (PointDescriptionFormatter != PointDescriptionFormatter_DefaultValue) { h.Add("pointDescriptionFormatter",PointDescriptionFormatter); Highcharts.AddFunction("aa46a8b2-a753-4dd6-a80e-5e75907eb597.pointDescriptionFormatter", PointDescriptionFormatter); }  
