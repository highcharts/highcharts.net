...
namespace Highsoft.Web.Mvc.Charts
{
	public partial class PlotOptionsStreamgraph  : BaseObject
	{
		...
		internal override Hashtable ToHashtable()
		{
			...
			if (PointDescriptionFormatter != PointDescriptionFormatter_DefaultValue) { h.Add("pointDescriptionFormatter",PointDescriptionFormatter); Highcharts.AddFunction("d83529d4-7c0e-4c3d-a861-56377dbbd7a4.pointDescriptionFormatter", PointDescriptionFormatter); }  
