...
{
	public partial class PlotOptionsStreamgraphDataLabels  : BaseObject
	{
		Hashtable h = new Hashtable();

		public PlotOptionsStreamgraphDataLabels()
		{
			Align = Align_DefaultValue = PlotOptionsStreamgraphDataLabelsAlign.Center;
			...
			Filter = Filter_DefaultValue = new PlotOptionsStreamgraphDataLabelsFilter();
			...
			Style = Style_DefaultValue = new PlotOptionsStreamgraphDataLabelsStyle();
			TextPath = TextPath_DefaultValue = new PlotOptionsStreamgraphDataLabelsTextPath();
			UseHTML = UseHTML_DefaultValue = false;
			VerticalAlign = VerticalAlign_DefaultValue = PlotOptionsStreamgraphDataLabelsVerticalAlign.Bottom;
			X = X_DefaultValue = 0;
			Y = Y_DefaultValue = 0;
			Z = Z_DefaultValue = 6;
		...
		/// </summary>
		public PlotOptionsStreamgraphDataLabelsAlign Align { get; set; }
		private PlotOptionsStreamgraphDataLabelsAlign Align_DefaultValue { get; set; }
		...
		/// </summary>
		public PlotOptionsStreamgraphDataLabelsFilter Filter { get; set; }
		private PlotOptionsStreamgraphDataLabelsFilter Filter_DefaultValue { get; set; }
		...
		/// </summary>
		public PlotOptionsStreamgraphDataLabelsStyle Style { get; set; }
		private PlotOptionsStreamgraphDataLabelsStyle Style_DefaultValue { get; set; }
		...
		/// </summary>
		public PlotOptionsStreamgraphDataLabelsTextPath TextPath { get; set; }
		private PlotOptionsStreamgraphDataLabelsTextPath TextPath_DefaultValue { get; set; }
		...
		/// </summary>
		public PlotOptionsStreamgraphDataLabelsVerticalAlign VerticalAlign { get; set; }
		private PlotOptionsStreamgraphDataLabelsVerticalAlign VerticalAlign_DefaultValue { get; set; }
		...
		internal override Hashtable ToHashtable()
		{
			...
			if (Formatter != Formatter_DefaultValue) { h.Add("formatter",Formatter); Highcharts.AddFunction("b65120d8-4197-4caf-9df1-4e0277ef6801.formatter", Formatter); }  
			...
			if (NullFormatter != NullFormatter_DefaultValue) { h.Add("nullFormatter",NullFormatter); Highcharts.AddFunction("ccf1ce7b-ecb2-435a-ab6b-7a143c03fbb4.nullFormatter", NullFormatter); }  
