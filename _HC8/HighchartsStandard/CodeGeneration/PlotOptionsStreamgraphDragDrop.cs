...
{
	public partial class PlotOptionsStreamgraphDragDrop  : BaseObject
	{
		Hashtable h = new Hashtable();

		public PlotOptionsStreamgraphDragDrop()
		{
			DraggableX = DraggableX_DefaultValue = null;
			DraggableY = DraggableY_DefaultValue = null;
			DragHandle = DragHandle_DefaultValue = new PlotOptionsStreamgraphDragDropDragHandle();
			...
			GuideBox = GuideBox_DefaultValue = new PlotOptionsStreamgraphDragDropGuideBox();
		...
		/// </summary>
		public PlotOptionsStreamgraphDragDropDragHandle DragHandle { get; set; }
		private PlotOptionsStreamgraphDragDropDragHandle DragHandle_DefaultValue { get; set; }
		...
		/// </summary>
		public PlotOptionsStreamgraphDragDropGuideBox GuideBox { get; set; }
		private PlotOptionsStreamgraphDragDropGuideBox GuideBox_DefaultValue { get; set; }
