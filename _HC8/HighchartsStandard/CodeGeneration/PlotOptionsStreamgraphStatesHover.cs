...
{
	public partial class PlotOptionsStreamgraphStatesHover  : PlotOptionsSeries
	{
		Hashtable h = new Hashtable();

		public PlotOptionsStreamgraphStatesHover()
		{
			Animation = Animation_DefaultValue = new Animation();
			Enabled = Enabled_DefaultValue = null;
			Halo = Halo_DefaultValue = new PlotOptionsStreamgraphStatesHoverHalo();
			LineWidth = LineWidth_DefaultValue = null;
			LineWidthPlus = LineWidthPlus_DefaultValue = null;
			Marker = Marker_DefaultValue = new PlotOptionsStreamgraphStatesHoverMarker();
		...
		/// </summary>
		public PlotOptionsStreamgraphStatesHoverHalo Halo { get; set; }
		private PlotOptionsStreamgraphStatesHoverHalo Halo_DefaultValue { get; set; }
		...
		/// </summary>
		public PlotOptionsStreamgraphStatesHoverMarker Marker { get; set; }
		private PlotOptionsStreamgraphStatesHoverMarker Marker_DefaultValue { get; set; }
