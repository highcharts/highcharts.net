...
{
	public partial class PlotOptionsStreamgraphStatesHoverMarker  : PlotOptionsSeries
	{
		Hashtable h = new Hashtable();

		public PlotOptionsStreamgraphStatesHoverMarker()
		{
			...
			States = States_DefaultValue = new PlotOptionsStreamgraphStatesHoverMarkerStates();
		...
		/// </summary>
		public PlotOptionsStreamgraphStatesHoverMarkerStates States { get; set; }
		private PlotOptionsStreamgraphStatesHoverMarkerStates States_DefaultValue { get; set; }
