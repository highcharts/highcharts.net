...
{
	public partial class PlotOptionsStreamgraphStatesSelect  : PlotOptionsSeries
	{
		Hashtable h = new Hashtable();

		public PlotOptionsStreamgraphStatesSelect()
		{
			Animation = Animation_DefaultValue = new Animation();
			Enabled = Enabled_DefaultValue = null;
			Halo = Halo_DefaultValue = new PlotOptionsStreamgraphStatesSelectHalo();
			LineWidth = LineWidth_DefaultValue = null;
			LineWidthPlus = LineWidthPlus_DefaultValue = null;
			Marker = Marker_DefaultValue = new PlotOptionsStreamgraphStatesSelectMarker();
		...
		/// </summary>
		public PlotOptionsStreamgraphStatesSelectHalo Halo { get; set; }
		private PlotOptionsStreamgraphStatesSelectHalo Halo_DefaultValue { get; set; }
		...
		/// </summary>
		public PlotOptionsStreamgraphStatesSelectMarker Marker { get; set; }
		private PlotOptionsStreamgraphStatesSelectMarker Marker_DefaultValue { get; set; }
