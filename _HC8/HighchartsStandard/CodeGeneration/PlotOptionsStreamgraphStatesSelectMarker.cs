...
{
	public partial class PlotOptionsStreamgraphStatesSelectMarker  : PlotOptionsSeries
	{
		Hashtable h = new Hashtable();

		public PlotOptionsStreamgraphStatesSelectMarker()
		{
			...
			States = States_DefaultValue = new PlotOptionsStreamgraphStatesSelectMarkerStates();
		...
		/// </summary>
		public PlotOptionsStreamgraphStatesSelectMarkerStates States { get; set; }
		private PlotOptionsStreamgraphStatesSelectMarkerStates States_DefaultValue { get; set; }
