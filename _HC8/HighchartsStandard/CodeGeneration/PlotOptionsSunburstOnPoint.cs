...
{
	public partial class PlotOptionsSunburstOnPoint  : BaseObject
	{
		Hashtable h = new Hashtable();

		public PlotOptionsSunburstOnPoint()
		{
			ConnectorOptions = ConnectorOptions_DefaultValue = new PlotOptionsSunburstOnPointConnectorOptions();
			Id = Id_DefaultValue = "";
			Position = Position_DefaultValue = new PlotOptionsSunburstOnPointPosition();
		...
		/// </summary>
		public PlotOptionsSunburstOnPointConnectorOptions ConnectorOptions { get; set; }
		private PlotOptionsSunburstOnPointConnectorOptions ConnectorOptions_DefaultValue { get; set; }
		...
		/// </summary>
		public PlotOptionsSunburstOnPointPosition Position { get; set; }
		private PlotOptionsSunburstOnPointPosition Position_DefaultValue { get; set; }
