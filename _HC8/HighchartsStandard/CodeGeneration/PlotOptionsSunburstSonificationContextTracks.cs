...
{
	public partial class PlotOptionsSunburstSonificationContextTracks  : BaseObject
	{
		Hashtable h = new Hashtable();

		public PlotOptionsSunburstSonificationContextTracks()
		{
			ActiveWhen = ActiveWhen_DefaultValue = new PlotOptionsSunburstSonificationContextTracksActiveWhen();
			Instrument = Instrument_DefaultValue = null;
			InstrumentString = InstrumentString_DefaultValue = "null";
			Mapping = Mapping_DefaultValue = new PlotOptionsSunburstSonificationContextTracksMapping();
			MidiName = MidiName_DefaultValue = "";
			PointGrouping = PointGrouping_DefaultValue = new PlotOptionsSunburstSonificationContextTracksPointGrouping();
			...
			Type = Type_DefaultValue = PlotOptionsSunburstSonificationContextTracksType.Instrument;
			ValueInterval = ValueInterval_DefaultValue = null;
			ValueMapFunction = ValueMapFunction_DefaultValue = PlotOptionsSunburstSonificationContextTracksValueMapFunction.Linear;
		...
		/// </summary>
		public PlotOptionsSunburstSonificationContextTracksActiveWhen ActiveWhen { get; set; }
		private PlotOptionsSunburstSonificationContextTracksActiveWhen ActiveWhen_DefaultValue { get; set; }
		...
		/// </summary>
		public PlotOptionsSunburstSonificationContextTracksMapping Mapping { get; set; }
		private PlotOptionsSunburstSonificationContextTracksMapping Mapping_DefaultValue { get; set; }
		...
		/// </summary>
		public PlotOptionsSunburstSonificationContextTracksPointGrouping PointGrouping { get; set; }
		private PlotOptionsSunburstSonificationContextTracksPointGrouping PointGrouping_DefaultValue { get; set; }
		...
		/// </summary>
		public PlotOptionsSunburstSonificationContextTracksType Type { get; set; }
		private PlotOptionsSunburstSonificationContextTracksType Type_DefaultValue { get; set; }
		...
		/// </summary>
		public PlotOptionsSunburstSonificationContextTracksValueMapFunction ValueMapFunction { get; set; }
		private PlotOptionsSunburstSonificationContextTracksValueMapFunction ValueMapFunction_DefaultValue { get; set; }
