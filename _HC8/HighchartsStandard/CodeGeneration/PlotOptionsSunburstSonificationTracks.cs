...
{
	public partial class PlotOptionsSunburstSonificationTracks  : BaseObject
	{
		Hashtable h = new Hashtable();

		public PlotOptionsSunburstSonificationTracks()
		{
			ActiveWhen = ActiveWhen_DefaultValue = new PlotOptionsSunburstSonificationTracksActiveWhen();
			Instrument = Instrument_DefaultValue = null;
			InstrumentString = InstrumentString_DefaultValue = "null";
			Mapping = Mapping_DefaultValue = new PlotOptionsSunburstSonificationTracksMapping();
			MidiName = MidiName_DefaultValue = "";
			PointGrouping = PointGrouping_DefaultValue = new PlotOptionsSunburstSonificationTracksPointGrouping();
			RoundToMusicalNotes = RoundToMusicalNotes_DefaultValue = true;
			ShowPlayMarker = ShowPlayMarker_DefaultValue = true;
			Type = Type_DefaultValue = PlotOptionsSunburstSonificationTracksType.Instrument;
		...
		/// </summary>
		public PlotOptionsSunburstSonificationTracksActiveWhen ActiveWhen { get; set; }
		private PlotOptionsSunburstSonificationTracksActiveWhen ActiveWhen_DefaultValue { get; set; }
		...
		/// </summary>
		public PlotOptionsSunburstSonificationTracksMapping Mapping { get; set; }
		private PlotOptionsSunburstSonificationTracksMapping Mapping_DefaultValue { get; set; }
		...
		/// </summary>
		public PlotOptionsSunburstSonificationTracksPointGrouping PointGrouping { get; set; }
		private PlotOptionsSunburstSonificationTracksPointGrouping PointGrouping_DefaultValue { get; set; }
		...
		/// </summary>
		public PlotOptionsSunburstSonificationTracksType Type { get; set; }
		private PlotOptionsSunburstSonificationTracksType Type_DefaultValue { get; set; }
