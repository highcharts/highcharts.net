...
{
	public partial class PlotOptionsSunburstStates  : PlotOptionsSeries
	{
		...
		/// </summary>
		public PlotOptionsSunburstStatesInactive Inactive { get; set; }
		private PlotOptionsSunburstStatesInactive Inactive_DefaultValue { get; set; }
