...
{
	public partial class PlotOptionsSunburstStatesHover  : PlotOptionsSeries
	{
		...
		public PlotOptionsSunburstStatesHover()
		{
			...
			Halo = Halo_DefaultValue = new PlotOptionsSunburstStatesHoverHalo();
			LineWidth = LineWidth_DefaultValue = null;
			LineWidthPlus = LineWidthPlus_DefaultValue = null;
			Marker = Marker_DefaultValue = new PlotOptionsSunburstStatesHoverMarker();
		...
		/// </summary>
		public PlotOptionsSunburstStatesHoverHalo Halo { get; set; }
		private PlotOptionsSunburstStatesHoverHalo Halo_DefaultValue { get; set; }
		...
		/// </summary>
		public PlotOptionsSunburstStatesHoverMarker Marker { get; set; }
		private PlotOptionsSunburstStatesHoverMarker Marker_DefaultValue { get; set; }
