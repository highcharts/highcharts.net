...
{
	public partial class PlotOptionsSunburstStatesHoverMarker  : PlotOptionsSeries
	{
		Hashtable h = new Hashtable();

		public PlotOptionsSunburstStatesHoverMarker()
		{
			...
			States = States_DefaultValue = new PlotOptionsSunburstStatesHoverMarkerStates();
		...
		/// </summary>
		public PlotOptionsSunburstStatesHoverMarkerStates States { get; set; }
		private PlotOptionsSunburstStatesHoverMarkerStates States_DefaultValue { get; set; }
