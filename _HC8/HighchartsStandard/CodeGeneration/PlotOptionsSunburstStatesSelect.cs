...
{
	public partial class PlotOptionsSunburstStatesSelect  : PlotOptionsSeries
	{
		Hashtable h = new Hashtable();

		public PlotOptionsSunburstStatesSelect()
		{
			Animation = Animation_DefaultValue = new Animation();
			Enabled = Enabled_DefaultValue = null;
			Halo = Halo_DefaultValue = new PlotOptionsSunburstStatesSelectHalo();
			LineWidth = LineWidth_DefaultValue = null;
			LineWidthPlus = LineWidthPlus_DefaultValue = null;
			Marker = Marker_DefaultValue = new PlotOptionsSunburstStatesSelectMarker();
		...
		/// </summary>
		public PlotOptionsSunburstStatesSelectHalo Halo { get; set; }
		private PlotOptionsSunburstStatesSelectHalo Halo_DefaultValue { get; set; }
		...
		/// </summary>
		public PlotOptionsSunburstStatesSelectMarker Marker { get; set; }
		private PlotOptionsSunburstStatesSelectMarker Marker_DefaultValue { get; set; }
