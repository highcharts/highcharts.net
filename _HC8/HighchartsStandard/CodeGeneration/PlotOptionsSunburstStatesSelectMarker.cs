...
{
	public partial class PlotOptionsSunburstStatesSelectMarker  : PlotOptionsSeries
	{
		Hashtable h = new Hashtable();

		public PlotOptionsSunburstStatesSelectMarker()
		{
			...
			States = States_DefaultValue = new PlotOptionsSunburstStatesSelectMarkerStates();
		...
		/// </summary>
		public PlotOptionsSunburstStatesSelectMarkerStates States { get; set; }
		private PlotOptionsSunburstStatesSelectMarkerStates States_DefaultValue { get; set; }
