...
namespace Highsoft.Web.Mvc.Charts
{
	public partial class PlotOptionsSunburstTooltip  : BaseObject
	{
		...
		internal override Hashtable ToHashtable()
		{
			...
			if (NullFormatter != NullFormatter_DefaultValue) { h.Add("nullFormatter",NullFormatter); Highcharts.AddFunction("bf7e91dc-5384-46c5-a89d-53a7d9a33a99.nullFormatter", NullFormatter); }  
			if (PointFormat != PointFormat_DefaultValue) h.Add("pointFormat",PointFormat);
			if (PointFormatter != PointFormatter_DefaultValue) { h.Add("pointFormatter",PointFormatter); Highcharts.AddFunction("fbe9c783-a507-4173-bf78-55734eb2d34e.pointFormatter", PointFormatter); }  
