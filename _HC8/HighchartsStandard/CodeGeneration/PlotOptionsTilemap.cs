...
namespace Highsoft.Web.Mvc.Charts
{
	public partial class PlotOptionsTilemap  : BaseObject
	{
		...
		public PlotOptionsTilemap()
		{
			...
			Cluster = Cluster_DefaultValue = new PlotOptionsTilemapCluster();
			...
			DataSorting = DataSorting_DefaultValue = new PlotOptionsTilemapDataSorting();
			...
			Marker = Marker_DefaultValue = new PlotOptionsTilemapMarker();
		...
		/// </summary>
		public PlotOptionsTilemapCluster Cluster { get; set; }
		private PlotOptionsTilemapCluster Cluster_DefaultValue { get; set; }
		...
		/// </summary>
		public PlotOptionsTilemapDataSorting DataSorting { get; set; }
		private PlotOptionsTilemapDataSorting DataSorting_DefaultValue { get; set; }
		...
		/// 
		/// </summary>
		public PlotOptionsTilemapMarker Marker { get; set; }
		private PlotOptionsTilemapMarker Marker_DefaultValue { get; set; }
		...
		internal override Hashtable ToHashtable()
		{
			...
			if (PointDescriptionFormatter != PointDescriptionFormatter_DefaultValue) { h.Add("pointDescriptionFormatter",PointDescriptionFormatter); Highcharts.AddFunction("afd00223-a3a8-4ada-802d-fe2afa1d0864.pointDescriptionFormatter", PointDescriptionFormatter); }  
