...
namespace Highsoft.Web.Mvc.Charts
{
	public partial class PlotOptionsTilemapClusterEvents  : BaseObject
	{
		...
		internal override Hashtable ToHashtable()
		{
			...
			if (DrillToCluster != DrillToCluster_DefaultValue) { h.Add("drillToCluster",DrillToCluster); Highcharts.AddFunction("de29b283-535a-484d-a14d-1ccc10c73c46.drillToCluster", DrillToCluster); }  
