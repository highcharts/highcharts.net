...
{
	public partial class PlotOptionsTilemapClusterEvents  : BaseObject
	{
		Hashtable h = new Hashtable();

		public PlotOptionsTilemapClusterEvents()
		{
		...
		internal override Hashtable ToHashtable()
		{
			...
			if (DrillToCluster != DrillToCluster_DefaultValue) { h.Add("drillToCluster",DrillToCluster); Highcharts.AddFunction("a303a224-cf7a-483a-8a21-008cfd67f709.drillToCluster", DrillToCluster); }  
