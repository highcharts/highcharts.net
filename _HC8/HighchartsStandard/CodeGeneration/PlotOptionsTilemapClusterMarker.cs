...
{
	public partial class PlotOptionsTilemapClusterMarker  : BaseObject
	{
		Hashtable h = new Hashtable();

		public PlotOptionsTilemapClusterMarker()
		{
			...
			States = States_DefaultValue = new PlotOptionsTilemapClusterMarkerStates();
		...
		/// </summary>
		public PlotOptionsTilemapClusterMarkerStates States { get; set; }
		private PlotOptionsTilemapClusterMarkerStates States_DefaultValue { get; set; }
