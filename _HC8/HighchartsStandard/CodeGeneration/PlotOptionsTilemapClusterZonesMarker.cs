...
{
	public partial class PlotOptionsTilemapClusterZonesMarker  : BaseObject
	{
		Hashtable h = new Hashtable();

		public PlotOptionsTilemapClusterZonesMarker()
		{
			...
			States = States_DefaultValue = new PlotOptionsTilemapClusterZonesMarkerStates();
		...
		/// </summary>
		public PlotOptionsTilemapClusterZonesMarkerStates States { get; set; }
		private PlotOptionsTilemapClusterZonesMarkerStates States_DefaultValue { get; set; }
