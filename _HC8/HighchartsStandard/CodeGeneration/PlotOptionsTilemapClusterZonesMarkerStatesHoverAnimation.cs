...
{
	public partial class PlotOptionsTilemapClusterZonesMarkerStatesHoverAnimation  : BaseObject
	{
		Hashtable h = new Hashtable();

		public PlotOptionsTilemapClusterZonesMarkerStatesHoverAnimation()
		{
