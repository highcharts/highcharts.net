...
namespace Highsoft.Web.Mvc.Charts
{
	public partial class PlotOptionsTilemapDataLabels  : BaseObject
	{
		...
		{
			Align = Align_DefaultValue = PlotOptionsTilemapDataLabelsAlign.Center;
			...
			Filter = Filter_DefaultValue = new PlotOptionsTilemapDataLabelsFilter();
			...
			Style = Style_DefaultValue = new PlotOptionsTilemapDataLabelsStyle();
			TextPath = TextPath_DefaultValue = new PlotOptionsTilemapDataLabelsTextPath();
			UseHTML = UseHTML_DefaultValue = false;
			VerticalAlign = VerticalAlign_DefaultValue = PlotOptionsTilemapDataLabelsVerticalAlign.Bottom;
			X = X_DefaultValue = 0;
			Y = Y_DefaultValue = 0;
			Z = Z_DefaultValue = 6;
		...
		/// </summary>
		public PlotOptionsTilemapDataLabelsAlign Align { get; set; }
		private PlotOptionsTilemapDataLabelsAlign Align_DefaultValue { get; set; }
		...
		/// </summary>
		public PlotOptionsTilemapDataLabelsFilter Filter { get; set; }
		private PlotOptionsTilemapDataLabelsFilter Filter_DefaultValue { get; set; }
		...
		/// </summary>
		public PlotOptionsTilemapDataLabelsStyle Style { get; set; }
		private PlotOptionsTilemapDataLabelsStyle Style_DefaultValue { get; set; }
		...
		/// </summary>
		public PlotOptionsTilemapDataLabelsTextPath TextPath { get; set; }
		private PlotOptionsTilemapDataLabelsTextPath TextPath_DefaultValue { get; set; }
		...
		internal override Hashtable ToHashtable()
		{
			...
			if (Formatter != Formatter_DefaultValue) { h.Add("formatter",Formatter); Highcharts.AddFunction("78add3c4-f629-4d71-bf9b-e33b65f71661.formatter", Formatter); }  
			...
			if (NullFormatter != NullFormatter_DefaultValue) { h.Add("nullFormatter",NullFormatter); Highcharts.AddFunction("b63da230-f7b4-4b0d-b49d-320b88e6087b.nullFormatter", NullFormatter); }  
