...
namespace Highsoft.Web.Mvc.Charts
{
	public partial class PlotOptionsTilemapDragDropDragHandle  : BaseObject
	{
		...
		internal override Hashtable ToHashtable()
		{
			...
			if (PathFormatter != PathFormatter_DefaultValue) { h.Add("pathFormatter",PathFormatter); Highcharts.AddFunction("08596b88-efb9-409b-bca9-32151f97888e.pathFormatter", PathFormatter); }  
