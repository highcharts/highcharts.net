...
namespace Highsoft.Web.Mvc.Charts
{
	public partial class PlotOptionsTilemapDragDropDragHandle  : BaseObject
	{
		...
		internal override Hashtable ToHashtable()
		{
			...
			if (PathFormatter != PathFormatter_DefaultValue) { h.Add("pathFormatter",PathFormatter); Highcharts.AddFunction("7ce0e915-f5eb-46a3-8257-2ca36ff877de.pathFormatter", PathFormatter); }  
