...
{
	public partial class PlotOptionsTilemapOnPoint  : BaseObject
	{
		Hashtable h = new Hashtable();

		public PlotOptionsTilemapOnPoint()
		{
			ConnectorOptions = ConnectorOptions_DefaultValue = new PlotOptionsTilemapOnPointConnectorOptions();
			Id = Id_DefaultValue = "";
			Position = Position_DefaultValue = new PlotOptionsTilemapOnPointPosition();
		...
		/// </summary>
		public PlotOptionsTilemapOnPointConnectorOptions ConnectorOptions { get; set; }
		private PlotOptionsTilemapOnPointConnectorOptions ConnectorOptions_DefaultValue { get; set; }
		...
		/// </summary>
		public PlotOptionsTilemapOnPointPosition Position { get; set; }
		private PlotOptionsTilemapOnPointPosition Position_DefaultValue { get; set; }
