...
{
	public partial class PlotOptionsTilemapSonificationContextTracks  : BaseObject
	{
		Hashtable h = new Hashtable();

		public PlotOptionsTilemapSonificationContextTracks()
		{
			ActiveWhen = ActiveWhen_DefaultValue = new PlotOptionsTilemapSonificationContextTracksActiveWhen();
			Instrument = Instrument_DefaultValue = null;
			InstrumentString = InstrumentString_DefaultValue = "null";
			Mapping = Mapping_DefaultValue = new PlotOptionsTilemapSonificationContextTracksMapping();
			MidiName = MidiName_DefaultValue = "";
			PointGrouping = PointGrouping_DefaultValue = new PlotOptionsTilemapSonificationContextTracksPointGrouping();
			...
			Type = Type_DefaultValue = PlotOptionsTilemapSonificationContextTracksType.Instrument;
			ValueInterval = ValueInterval_DefaultValue = null;
			ValueMapFunction = ValueMapFunction_DefaultValue = PlotOptionsTilemapSonificationContextTracksValueMapFunction.Linear;
		...
		/// </summary>
		public PlotOptionsTilemapSonificationContextTracksActiveWhen ActiveWhen { get; set; }
		private PlotOptionsTilemapSonificationContextTracksActiveWhen ActiveWhen_DefaultValue { get; set; }
		...
		/// </summary>
		public PlotOptionsTilemapSonificationContextTracksMapping Mapping { get; set; }
		private PlotOptionsTilemapSonificationContextTracksMapping Mapping_DefaultValue { get; set; }
		...
		/// </summary>
		public PlotOptionsTilemapSonificationContextTracksPointGrouping PointGrouping { get; set; }
		private PlotOptionsTilemapSonificationContextTracksPointGrouping PointGrouping_DefaultValue { get; set; }
		...
		/// </summary>
		public PlotOptionsTilemapSonificationContextTracksType Type { get; set; }
		private PlotOptionsTilemapSonificationContextTracksType Type_DefaultValue { get; set; }
		...
		/// </summary>
		public PlotOptionsTilemapSonificationContextTracksValueMapFunction ValueMapFunction { get; set; }
		private PlotOptionsTilemapSonificationContextTracksValueMapFunction ValueMapFunction_DefaultValue { get; set; }
