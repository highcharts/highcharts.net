...
{
	public partial class PlotOptionsTilemapSonificationTracks  : BaseObject
	{
		Hashtable h = new Hashtable();

		public PlotOptionsTilemapSonificationTracks()
		{
			ActiveWhen = ActiveWhen_DefaultValue = new PlotOptionsTilemapSonificationTracksActiveWhen();
			Instrument = Instrument_DefaultValue = null;
			InstrumentString = InstrumentString_DefaultValue = "null";
			Mapping = Mapping_DefaultValue = new PlotOptionsTilemapSonificationTracksMapping();
			MidiName = MidiName_DefaultValue = "";
			PointGrouping = PointGrouping_DefaultValue = new PlotOptionsTilemapSonificationTracksPointGrouping();
			RoundToMusicalNotes = RoundToMusicalNotes_DefaultValue = true;
			ShowPlayMarker = ShowPlayMarker_DefaultValue = true;
			Type = Type_DefaultValue = PlotOptionsTilemapSonificationTracksType.Instrument;
		...
		/// </summary>
		public PlotOptionsTilemapSonificationTracksActiveWhen ActiveWhen { get; set; }
		private PlotOptionsTilemapSonificationTracksActiveWhen ActiveWhen_DefaultValue { get; set; }
		...
		/// </summary>
		public PlotOptionsTilemapSonificationTracksMapping Mapping { get; set; }
		private PlotOptionsTilemapSonificationTracksMapping Mapping_DefaultValue { get; set; }
		...
		/// </summary>
		public PlotOptionsTilemapSonificationTracksPointGrouping PointGrouping { get; set; }
		private PlotOptionsTilemapSonificationTracksPointGrouping PointGrouping_DefaultValue { get; set; }
		...
		/// </summary>
		public PlotOptionsTilemapSonificationTracksType Type { get; set; }
		private PlotOptionsTilemapSonificationTracksType Type_DefaultValue { get; set; }
