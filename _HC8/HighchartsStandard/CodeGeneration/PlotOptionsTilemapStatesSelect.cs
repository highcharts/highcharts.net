...
{
	public partial class PlotOptionsTilemapStatesSelect  : PlotOptionsSeries
	{
		Hashtable h = new Hashtable();

		public PlotOptionsTilemapStatesSelect()
		{
			Animation = Animation_DefaultValue = new Animation();
			Enabled = Enabled_DefaultValue = null;
			Halo = Halo_DefaultValue = new PlotOptionsTilemapStatesSelectHalo();
			LineWidth = LineWidth_DefaultValue = null;
			LineWidthPlus = LineWidthPlus_DefaultValue = null;
			Marker = Marker_DefaultValue = new PlotOptionsTilemapStatesSelectMarker();
		...
		/// </summary>
		public PlotOptionsTilemapStatesSelectHalo Halo { get; set; }
		private PlotOptionsTilemapStatesSelectHalo Halo_DefaultValue { get; set; }
		...
		/// </summary>
		public PlotOptionsTilemapStatesSelectMarker Marker { get; set; }
		private PlotOptionsTilemapStatesSelectMarker Marker_DefaultValue { get; set; }
