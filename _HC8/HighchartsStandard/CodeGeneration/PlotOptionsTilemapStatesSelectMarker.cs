...
{
	public partial class PlotOptionsTilemapStatesSelectMarker  : PlotOptionsSeries
	{
		Hashtable h = new Hashtable();

		public PlotOptionsTilemapStatesSelectMarker()
		{
			...
			States = States_DefaultValue = new PlotOptionsTilemapStatesSelectMarkerStates();
		...
		/// </summary>
		public PlotOptionsTilemapStatesSelectMarkerStates States { get; set; }
		private PlotOptionsTilemapStatesSelectMarkerStates States_DefaultValue { get; set; }
