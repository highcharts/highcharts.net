...
{
	public partial class PlotOptionsTilemapStatesSelectMarkerStatesHoverAnimation  : PlotOptionsSeries
	{
		Hashtable h = new Hashtable();

		public PlotOptionsTilemapStatesSelectMarkerStatesHoverAnimation()
		{
