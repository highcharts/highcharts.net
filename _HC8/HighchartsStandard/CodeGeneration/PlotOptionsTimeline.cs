...
namespace Highsoft.Web.Mvc.Charts
{
	public partial class PlotOptionsTimeline  : BaseObject
	{
		...
		internal override Hashtable ToHashtable()
		{
			...
			if (PointDescriptionFormatter != PointDescriptionFormatter_DefaultValue) { h.Add("pointDescriptionFormatter",PointDescriptionFormatter); Highcharts.AddFunction("647332c0-5bbc-42e7-9eac-e50a06ad7550.pointDescriptionFormatter", PointDescriptionFormatter); }  
