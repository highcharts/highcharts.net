...
{
	public partial class PlotOptionsTimelineDragDrop  : BaseObject
	{
		Hashtable h = new Hashtable();

		public PlotOptionsTimelineDragDrop()
		{
			DraggableX = DraggableX_DefaultValue = null;
			DraggableY = DraggableY_DefaultValue = null;
			DragHandle = DragHandle_DefaultValue = new PlotOptionsTimelineDragDropDragHandle();
			...
			GuideBox = GuideBox_DefaultValue = new PlotOptionsTimelineDragDropGuideBox();
		...
		/// </summary>
		public PlotOptionsTimelineDragDropDragHandle DragHandle { get; set; }
		private PlotOptionsTimelineDragDropDragHandle DragHandle_DefaultValue { get; set; }
		...
		/// </summary>
		public PlotOptionsTimelineDragDropGuideBox GuideBox { get; set; }
		private PlotOptionsTimelineDragDropGuideBox GuideBox_DefaultValue { get; set; }
