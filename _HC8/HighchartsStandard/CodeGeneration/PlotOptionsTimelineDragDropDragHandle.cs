...
namespace Highsoft.Web.Mvc.Charts
{
	public partial class PlotOptionsTimelineDragDropDragHandle  : BaseObject
	{
		...
		internal override Hashtable ToHashtable()
		{
			...
			if (PathFormatter != PathFormatter_DefaultValue) { h.Add("pathFormatter",PathFormatter); Highcharts.AddFunction("64f9243d-12d7-4aab-9ae4-f82a28464d74.pathFormatter", PathFormatter); }  
