...
namespace Highsoft.Web.Mvc.Charts
{
	public partial class PlotOptionsTimelineDragDropDragHandle  : BaseObject
	{
		...
		internal override Hashtable ToHashtable()
		{
			...
			if (PathFormatter != PathFormatter_DefaultValue) { h.Add("pathFormatter",PathFormatter); Highcharts.AddFunction("1138fac2-7c9b-467f-9e0a-55bc1939c84d.pathFormatter", PathFormatter); }  
