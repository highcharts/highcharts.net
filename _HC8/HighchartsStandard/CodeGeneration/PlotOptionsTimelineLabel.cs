...
{
	public partial class PlotOptionsTimelineLabel  : BaseObject
	{
		Hashtable h = new Hashtable();

		public PlotOptionsTimelineLabel()
		{
			...
			Style = Style_DefaultValue = new PlotOptionsTimelineLabelStyle();
		...
		/// </summary>
		public PlotOptionsTimelineLabelStyle Style { get; set; }
		private PlotOptionsTimelineLabelStyle Style_DefaultValue { get; set; }
		...
		internal override Hashtable ToHashtable()
		{
			...
			if (Formatter != Formatter_DefaultValue) { h.Add("formatter",Formatter); Highcharts.AddFunction("2332db96-d96a-4e69-b133-fe8d6f6e7d44.formatter", Formatter); }  
