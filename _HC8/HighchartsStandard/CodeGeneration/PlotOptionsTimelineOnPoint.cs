...
{
	public partial class PlotOptionsTimelineOnPoint  : BaseObject
	{
		Hashtable h = new Hashtable();

		public PlotOptionsTimelineOnPoint()
		{
			ConnectorOptions = ConnectorOptions_DefaultValue = new PlotOptionsTimelineOnPointConnectorOptions();
			Id = Id_DefaultValue = "";
			Position = Position_DefaultValue = new PlotOptionsTimelineOnPointPosition();
		...
		/// </summary>
		public PlotOptionsTimelineOnPointConnectorOptions ConnectorOptions { get; set; }
		private PlotOptionsTimelineOnPointConnectorOptions ConnectorOptions_DefaultValue { get; set; }
		...
		/// </summary>
		public PlotOptionsTimelineOnPointPosition Position { get; set; }
		private PlotOptionsTimelineOnPointPosition Position_DefaultValue { get; set; }
