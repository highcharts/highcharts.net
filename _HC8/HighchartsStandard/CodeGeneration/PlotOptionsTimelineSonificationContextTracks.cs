...
{
	public partial class PlotOptionsTimelineSonificationContextTracks  : BaseObject
	{
		Hashtable h = new Hashtable();

		public PlotOptionsTimelineSonificationContextTracks()
		{
			ActiveWhen = ActiveWhen_DefaultValue = new PlotOptionsTimelineSonificationContextTracksActiveWhen();
			Instrument = Instrument_DefaultValue = null;
			InstrumentString = InstrumentString_DefaultValue = "null";
			Mapping = Mapping_DefaultValue = new PlotOptionsTimelineSonificationContextTracksMapping();
			MidiName = MidiName_DefaultValue = "";
			PointGrouping = PointGrouping_DefaultValue = new PlotOptionsTimelineSonificationContextTracksPointGrouping();
			...
			Type = Type_DefaultValue = PlotOptionsTimelineSonificationContextTracksType.Instrument;
			ValueInterval = ValueInterval_DefaultValue = null;
			ValueMapFunction = ValueMapFunction_DefaultValue = PlotOptionsTimelineSonificationContextTracksValueMapFunction.Linear;
		...
		/// </summary>
		public PlotOptionsTimelineSonificationContextTracksActiveWhen ActiveWhen { get; set; }
		private PlotOptionsTimelineSonificationContextTracksActiveWhen ActiveWhen_DefaultValue { get; set; }
		...
		/// </summary>
		public PlotOptionsTimelineSonificationContextTracksMapping Mapping { get; set; }
		private PlotOptionsTimelineSonificationContextTracksMapping Mapping_DefaultValue { get; set; }
		...
		/// </summary>
		public PlotOptionsTimelineSonificationContextTracksPointGrouping PointGrouping { get; set; }
		private PlotOptionsTimelineSonificationContextTracksPointGrouping PointGrouping_DefaultValue { get; set; }
		...
		/// </summary>
		public PlotOptionsTimelineSonificationContextTracksType Type { get; set; }
		private PlotOptionsTimelineSonificationContextTracksType Type_DefaultValue { get; set; }
		...
		/// </summary>
		public PlotOptionsTimelineSonificationContextTracksValueMapFunction ValueMapFunction { get; set; }
		private PlotOptionsTimelineSonificationContextTracksValueMapFunction ValueMapFunction_DefaultValue { get; set; }
