...
{
	public partial class PlotOptionsTimelineStatesSelect  : PlotOptionsSeries
	{
		Hashtable h = new Hashtable();

		public PlotOptionsTimelineStatesSelect()
		{
			Animation = Animation_DefaultValue = new Animation();
			Enabled = Enabled_DefaultValue = null;
			Halo = Halo_DefaultValue = new PlotOptionsTimelineStatesSelectHalo();
			LineWidth = LineWidth_DefaultValue = null;
			LineWidthPlus = LineWidthPlus_DefaultValue = null;
			Marker = Marker_DefaultValue = new PlotOptionsTimelineStatesSelectMarker();
		...
		/// </summary>
		public PlotOptionsTimelineStatesSelectHalo Halo { get; set; }
		private PlotOptionsTimelineStatesSelectHalo Halo_DefaultValue { get; set; }
		...
		/// </summary>
		public PlotOptionsTimelineStatesSelectMarker Marker { get; set; }
		private PlotOptionsTimelineStatesSelectMarker Marker_DefaultValue { get; set; }
