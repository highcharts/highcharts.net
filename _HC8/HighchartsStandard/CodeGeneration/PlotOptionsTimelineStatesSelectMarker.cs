...
{
	public partial class PlotOptionsTimelineStatesSelectMarker  : PlotOptionsSeries
	{
		Hashtable h = new Hashtable();

		public PlotOptionsTimelineStatesSelectMarker()
		{
			...
			States = States_DefaultValue = new PlotOptionsTimelineStatesSelectMarkerStates();
		...
		/// </summary>
		public PlotOptionsTimelineStatesSelectMarkerStates States { get; set; }
		private PlotOptionsTimelineStatesSelectMarkerStates States_DefaultValue { get; set; }
