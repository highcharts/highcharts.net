...
{
	public partial class PlotOptionsTimelineStatesSelectMarkerStatesHoverAnimation  : PlotOptionsSeries
	{
		Hashtable h = new Hashtable();

		public PlotOptionsTimelineStatesSelectMarkerStatesHoverAnimation()
		{
