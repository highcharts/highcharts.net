...
{
	public partial class PlotOptionsTreegraphAccessibility  : BaseObject
	{
		Hashtable h = new Hashtable();

		public PlotOptionsTreegraphAccessibility()
		{
			Description = Description_DefaultValue = "";
			DescriptionFormat = DescriptionFormat_DefaultValue = "";
			Enabled = Enabled_DefaultValue = null;
			ExposeAsGroupOnly = ExposeAsGroupOnly_DefaultValue = null;
			KeyboardNavigation = KeyboardNavigation_DefaultValue = new PlotOptionsTreegraphAccessibilityKeyboardNavigation();
			Point = Point_DefaultValue = new PlotOptionsTreegraphAccessibilityPoint();
		...
		/// </summary>
		public PlotOptionsTreegraphAccessibilityKeyboardNavigation KeyboardNavigation { get; set; }
		private PlotOptionsTreegraphAccessibilityKeyboardNavigation KeyboardNavigation_DefaultValue { get; set; }
		 

		/// <summary>
		/// Point accessibility options for a series.
		/// </summary>
		public PlotOptionsTreegraphAccessibilityPoint Point { get; set; }
		private PlotOptionsTreegraphAccessibilityPoint Point_DefaultValue { get; set; }
