...
{
	public partial class PlotOptionsTreegraphBreadcrumbs  : BaseObject
	{
		Hashtable h = new Hashtable();

		public PlotOptionsTreegraphBreadcrumbs()
		{
			ButtonSpacing = ButtonSpacing_DefaultValue = 5;
			ButtonTheme = ButtonTheme_DefaultValue = new PlotOptionsTreegraphBreadcrumbsButtonTheme();
			Events = Events_DefaultValue = new PlotOptionsTreegraphBreadcrumbsEvents();
			Floating = Floating_DefaultValue = false;
			Format = Format_DefaultValue = "undefined";
			Formatter = Formatter_DefaultValue = "";
			Position = Position_DefaultValue = new PlotOptionsTreegraphBreadcrumbsPosition();
			RelativeTo = RelativeTo_DefaultValue = "plotBox";
			Rtl = Rtl_DefaultValue = false;
			Separator = Separator_DefaultValue = new PlotOptionsTreegraphBreadcrumbsSeparator();
		...
		/// </summary>
		public PlotOptionsTreegraphBreadcrumbsButtonTheme ButtonTheme { get; set; }
		private PlotOptionsTreegraphBreadcrumbsButtonTheme ButtonTheme_DefaultValue { get; set; }
		 

		/// <summary>
		/// 
		/// </summary>
		public PlotOptionsTreegraphBreadcrumbsEvents Events { get; set; }
		private PlotOptionsTreegraphBreadcrumbsEvents Events_DefaultValue { get; set; }
		...
		/// </summary>
		public PlotOptionsTreegraphBreadcrumbsPosition Position { get; set; }
		private PlotOptionsTreegraphBreadcrumbsPosition Position_DefaultValue { get; set; }
		...
		/// </summary>
		public PlotOptionsTreegraphBreadcrumbsSeparator Separator { get; set; }
		private PlotOptionsTreegraphBreadcrumbsSeparator Separator_DefaultValue { get; set; }
