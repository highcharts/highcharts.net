...
{
	public partial class PlotOptionsTreegraphCluster  : BaseObject
	{
		Hashtable h = new Hashtable();

		public PlotOptionsTreegraphCluster()
		{
			AllowOverlap = AllowOverlap_DefaultValue = true;
			Animation = Animation_DefaultValue = new Animation();
			AnimationBool = AnimationBool_DefaultValue = null;
			DataLabels = DataLabels_DefaultValue = new PlotOptionsTreegraphClusterDataLabels();
			DrillToCluster = DrillToCluster_DefaultValue = true;
			Enabled = Enabled_DefaultValue = false;
			Events = Events_DefaultValue = new PlotOptionsTreegraphClusterEvents();
			LayoutAlgorithm = LayoutAlgorithm_DefaultValue = new PlotOptionsTreegraphClusterLayoutAlgorithm();
			Marker = Marker_DefaultValue = new PlotOptionsTreegraphClusterMarker();
			MinimumClusterSize = MinimumClusterSize_DefaultValue = 2;
			States = States_DefaultValue = new PlotOptionsTreegraphClusterStates();
			Zones = Zones_DefaultValue = new List<PlotOptionsTreegraphClusterZone>();
		...
		/// </summary>
		public PlotOptionsTreegraphClusterDataLabels DataLabels { get; set; }
		private PlotOptionsTreegraphClusterDataLabels DataLabels_DefaultValue { get; set; }
		...
		/// 
		/// </summary>
		public PlotOptionsTreegraphClusterEvents Events { get; set; }
		private PlotOptionsTreegraphClusterEvents Events_DefaultValue { get; set; }
		 

		/// <summary>
		/// Options for layout algorithm. Inside thereare options to change the type of the algorithm, gridSize,distance or iterations.
		/// </summary>
		public PlotOptionsTreegraphClusterLayoutAlgorithm LayoutAlgorithm { get; set; }
		private PlotOptionsTreegraphClusterLayoutAlgorithm LayoutAlgorithm_DefaultValue { get; set; }
		 

		/// <summary>
		/// Options for the cluster marker.
		/// </summary>
		public PlotOptionsTreegraphClusterMarker Marker { get; set; }
		private PlotOptionsTreegraphClusterMarker Marker_DefaultValue { get; set; }
		...
		/// 
		/// </summary>
		public PlotOptionsTreegraphClusterStates States { get; set; }
		private PlotOptionsTreegraphClusterStates States_DefaultValue { get; set; }
		...
		/// </summary>
		public List<PlotOptionsTreegraphClusterZone> Zones { get; set; }
		private List<PlotOptionsTreegraphClusterZone> Zones_DefaultValue { get; set; }
