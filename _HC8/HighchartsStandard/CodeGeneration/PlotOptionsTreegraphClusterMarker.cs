...
{
	public partial class PlotOptionsTreegraphClusterMarker  : BaseObject
	{
		Hashtable h = new Hashtable();

		public PlotOptionsTreegraphClusterMarker()
		{
			...
			States = States_DefaultValue = new PlotOptionsTreegraphClusterMarkerStates();
		...
		/// </summary>
		public PlotOptionsTreegraphClusterMarkerStates States { get; set; }
		private PlotOptionsTreegraphClusterMarkerStates States_DefaultValue { get; set; }
