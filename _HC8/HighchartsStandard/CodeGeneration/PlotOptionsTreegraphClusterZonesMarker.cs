...
{
	public partial class PlotOptionsTreegraphClusterZonesMarker  : BaseObject
	{
		Hashtable h = new Hashtable();

		public PlotOptionsTreegraphClusterZonesMarker()
		{
			...
			States = States_DefaultValue = new PlotOptionsTreegraphClusterZonesMarkerStates();
		...
		/// </summary>
		public PlotOptionsTreegraphClusterZonesMarkerStates States { get; set; }
		private PlotOptionsTreegraphClusterZonesMarkerStates States_DefaultValue { get; set; }
