...
{
	public partial class PlotOptionsTreegraphClusterZonesMarkerStatesHoverAnimation  : BaseObject
	{
		Hashtable h = new Hashtable();

		public PlotOptionsTreegraphClusterZonesMarkerStatesHoverAnimation()
		{
