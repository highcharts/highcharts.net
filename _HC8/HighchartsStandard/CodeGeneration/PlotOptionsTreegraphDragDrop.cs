...
{
	public partial class PlotOptionsTreegraphDragDrop  : BaseObject
	{
		Hashtable h = new Hashtable();

		public PlotOptionsTreegraphDragDrop()
		{
			...
			GuideBox = GuideBox_DefaultValue = new PlotOptionsTreegraphDragDropGuideBox();
		...
		/// </summary>
		public PlotOptionsTreegraphDragDropGuideBox GuideBox { get; set; }
		private PlotOptionsTreegraphDragDropGuideBox GuideBox_DefaultValue { get; set; }
