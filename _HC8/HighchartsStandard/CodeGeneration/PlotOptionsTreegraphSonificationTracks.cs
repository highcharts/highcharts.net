...
{
	public partial class PlotOptionsTreegraphSonificationTracks  : BaseObject
	{
		Hashtable h = new Hashtable();

		public PlotOptionsTreegraphSonificationTracks()
		{
			ActiveWhen = ActiveWhen_DefaultValue = new PlotOptionsTreegraphSonificationTracksActiveWhen();
			Instrument = Instrument_DefaultValue = null;
			InstrumentString = InstrumentString_DefaultValue = "null";
			Mapping = Mapping_DefaultValue = new PlotOptionsTreegraphSonificationTracksMapping();
			MidiName = MidiName_DefaultValue = "";
			PointGrouping = PointGrouping_DefaultValue = new PlotOptionsTreegraphSonificationTracksPointGrouping();
			RoundToMusicalNotes = RoundToMusicalNotes_DefaultValue = true;
			ShowPlayMarker = ShowPlayMarker_DefaultValue = true;
			Type = Type_DefaultValue = PlotOptionsTreegraphSonificationTracksType.Instrument;
		...
		/// </summary>
		public PlotOptionsTreegraphSonificationTracksActiveWhen ActiveWhen { get; set; }
		private PlotOptionsTreegraphSonificationTracksActiveWhen ActiveWhen_DefaultValue { get; set; }
		...
		/// </summary>
		public PlotOptionsTreegraphSonificationTracksMapping Mapping { get; set; }
		private PlotOptionsTreegraphSonificationTracksMapping Mapping_DefaultValue { get; set; }
		...
		/// </summary>
		public PlotOptionsTreegraphSonificationTracksPointGrouping PointGrouping { get; set; }
		private PlotOptionsTreegraphSonificationTracksPointGrouping PointGrouping_DefaultValue { get; set; }
		...
		/// </summary>
		public PlotOptionsTreegraphSonificationTracksType Type { get; set; }
		private PlotOptionsTreegraphSonificationTracksType Type_DefaultValue { get; set; }
