...
{
	public partial class PlotOptionsTreegraphStatesHoverMarker  : BaseObject
	{
		Hashtable h = new Hashtable();

		public PlotOptionsTreegraphStatesHoverMarker()
		{
			...
			States = States_DefaultValue = new PlotOptionsTreegraphStatesHoverMarkerStates();
		...
		/// </summary>
		public PlotOptionsTreegraphStatesHoverMarkerStates States { get; set; }
		private PlotOptionsTreegraphStatesHoverMarkerStates States_DefaultValue { get; set; }
