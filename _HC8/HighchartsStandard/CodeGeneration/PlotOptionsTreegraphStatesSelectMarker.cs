...
{
	public partial class PlotOptionsTreegraphStatesSelectMarker  : BaseObject
	{
		Hashtable h = new Hashtable();

		public PlotOptionsTreegraphStatesSelectMarker()
		{
			...
			States = States_DefaultValue = new PlotOptionsTreegraphStatesSelectMarkerStates();
		...
		/// </summary>
		public PlotOptionsTreegraphStatesSelectMarkerStates States { get; set; }
		private PlotOptionsTreegraphStatesSelectMarkerStates States_DefaultValue { get; set; }
