...
{
	public partial class PlotOptionsTreegraphStatesSelectMarkerStatesHoverAnimation  : BaseObject
	{
		Hashtable h = new Hashtable();

		public PlotOptionsTreegraphStatesSelectMarkerStatesHoverAnimation()
		{
