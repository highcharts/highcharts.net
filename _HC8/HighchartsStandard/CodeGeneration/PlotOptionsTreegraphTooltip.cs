...
{
	public partial class PlotOptionsTreegraphTooltip  : BaseObject
	{
		Hashtable h = new Hashtable();

		public PlotOptionsTreegraphTooltip()
		{
			...
			HeaderShape = HeaderShape_DefaultValue = PlotOptionsTreegraphTooltipHeaderShape.Callout;
			...
			PointFormat = PointFormat_DefaultValue = "{point.id}";
		...
		/// </summary>
		public PlotOptionsTreegraphTooltipHeaderShape HeaderShape { get; set; }
		private PlotOptionsTreegraphTooltipHeaderShape HeaderShape_DefaultValue { get; set; }
		...
		/// <summary>
		/// The HTML of the point's line in the tooltip. Variables areenclosed by curly brackets. Available variables are`point.id`,  `point.fromNode.id`, `point.toNode.id`,`series.name`, `series.color` and other properties on thesame form. Furthermore, This can also be overridden for eachseries, which makes it a good hook for displaying units. Instyled mode, the dot is colored by a class name rather thanthe point color.
		/// </summary>
