...
namespace Highsoft.Web.Mvc.Charts
{
	public partial class PlotOptionsTreemap  : BaseObject
	{
		...
		internal override Hashtable ToHashtable()
		{
			...
			if (PointDescriptionFormatter != PointDescriptionFormatter_DefaultValue) { h.Add("pointDescriptionFormatter",PointDescriptionFormatter); Highcharts.AddFunction("8bb335d5-6cd3-408c-be2c-89cffdb703a9.pointDescriptionFormatter", PointDescriptionFormatter); }  
