...
namespace Highsoft.Web.Mvc.Charts
{
	public partial class PlotOptionsTreemap  : BaseObject
	{
		...
		internal override Hashtable ToHashtable()
		{
			...
			if (PointDescriptionFormatter != PointDescriptionFormatter_DefaultValue) { h.Add("pointDescriptionFormatter",PointDescriptionFormatter); Highcharts.AddFunction("5a607671-f234-4490-a350-f333955e100a.pointDescriptionFormatter", PointDescriptionFormatter); }  
