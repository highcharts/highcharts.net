...
{
	public partial class PlotOptionsTreemapBreadcrumbs  : BaseObject
	{
		...
		public PlotOptionsTreemapBreadcrumbs()
		{
			...
			Position = Position_DefaultValue = new PlotOptionsTreemapBreadcrumbsPosition();
		...
		/// </summary>
		public PlotOptionsTreemapBreadcrumbsPosition Position { get; set; }
		private PlotOptionsTreemapBreadcrumbsPosition Position_DefaultValue { get; set; }
