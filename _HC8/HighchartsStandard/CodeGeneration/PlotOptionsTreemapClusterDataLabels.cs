...
{
	public partial class PlotOptionsTreemapClusterDataLabels  : PlotOptionsSeries
	{
		Hashtable h = new Hashtable();

		public PlotOptionsTreemapClusterDataLabels()
		{
			Align = Align_DefaultValue = PlotOptionsTreemapClusterDataLabelsAlign.Center;
		...
		/// 
		/// </summary>
		public PlotOptionsTreemapClusterDataLabelsAlign Align { get; set; }
		private PlotOptionsTreemapClusterDataLabelsAlign Align_DefaultValue { get; set; }
