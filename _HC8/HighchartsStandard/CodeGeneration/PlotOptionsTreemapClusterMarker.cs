...
{
	public partial class PlotOptionsTreemapClusterMarker  : BaseObject
	{
		Hashtable h = new Hashtable();

		public PlotOptionsTreemapClusterMarker()
		{
			...
			States = States_DefaultValue = new PlotOptionsTreemapClusterMarkerStates();
		...
		/// </summary>
		public PlotOptionsTreemapClusterMarkerStates States { get; set; }
		private PlotOptionsTreemapClusterMarkerStates States_DefaultValue { get; set; }
