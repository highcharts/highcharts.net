...
{
	public partial class PlotOptionsTreemapClusterZonesMarker  : BaseObject
	{
		Hashtable h = new Hashtable();

		public PlotOptionsTreemapClusterZonesMarker()
		{
			...
			States = States_DefaultValue = new PlotOptionsTreemapClusterZonesMarkerStates();
		...
		/// </summary>
		public PlotOptionsTreemapClusterZonesMarkerStates States { get; set; }
		private PlotOptionsTreemapClusterZonesMarkerStates States_DefaultValue { get; set; }
