...
{
	public partial class PlotOptionsTreemapClusterZonesMarkerStatesHoverAnimation  : BaseObject
	{
		Hashtable h = new Hashtable();

		public PlotOptionsTreemapClusterZonesMarkerStatesHoverAnimation()
		{
