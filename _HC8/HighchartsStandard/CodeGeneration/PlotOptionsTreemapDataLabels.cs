...
namespace Highsoft.Web.Mvc.Charts
{
	public partial class PlotOptionsTreemapDataLabels  : BaseObject
	{
		...
		{
			Align = Align_DefaultValue = PlotOptionsTreemapDataLabelsAlign.Center;
			...
			Style = Style_DefaultValue = new PlotOptionsTreemapDataLabelsStyle();
		...
		/// </summary>
		public PlotOptionsTreemapDataLabelsStyle Style { get; set; }
		private PlotOptionsTreemapDataLabelsStyle Style_DefaultValue { get; set; }
		...
		internal override Hashtable ToHashtable()
		{
			...
			if (Formatter != Formatter_DefaultValue) { h.Add("formatter",Formatter); Highcharts.AddFunction("f8af7c65-b6cc-495a-bef7-2b8700584d1a.formatter", Formatter); }  
			...
			if (NullFormatter != NullFormatter_DefaultValue) { h.Add("nullFormatter",NullFormatter); Highcharts.AddFunction("4c2fb2da-96e1-400c-a7ab-120bde18c05d.nullFormatter", NullFormatter); }  
