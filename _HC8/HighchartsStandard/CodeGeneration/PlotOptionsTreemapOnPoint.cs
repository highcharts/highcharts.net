...
{
	public partial class PlotOptionsTreemapOnPoint  : BaseObject
	{
		Hashtable h = new Hashtable();

		public PlotOptionsTreemapOnPoint()
		{
			ConnectorOptions = ConnectorOptions_DefaultValue = new PlotOptionsTreemapOnPointConnectorOptions();
			Id = Id_DefaultValue = "";
			Position = Position_DefaultValue = new PlotOptionsTreemapOnPointPosition();
		...
		/// </summary>
		public PlotOptionsTreemapOnPointConnectorOptions ConnectorOptions { get; set; }
		private PlotOptionsTreemapOnPointConnectorOptions ConnectorOptions_DefaultValue { get; set; }
		...
		/// </summary>
		public PlotOptionsTreemapOnPointPosition Position { get; set; }
		private PlotOptionsTreemapOnPointPosition Position_DefaultValue { get; set; }
