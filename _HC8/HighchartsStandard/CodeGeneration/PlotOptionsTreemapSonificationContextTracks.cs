...
{
	public partial class PlotOptionsTreemapSonificationContextTracks  : BaseObject
	{
		Hashtable h = new Hashtable();

		public PlotOptionsTreemapSonificationContextTracks()
		{
			ActiveWhen = ActiveWhen_DefaultValue = new PlotOptionsTreemapSonificationContextTracksActiveWhen();
			Instrument = Instrument_DefaultValue = null;
			InstrumentString = InstrumentString_DefaultValue = "null";
			Mapping = Mapping_DefaultValue = new PlotOptionsTreemapSonificationContextTracksMapping();
			MidiName = MidiName_DefaultValue = "";
			PointGrouping = PointGrouping_DefaultValue = new PlotOptionsTreemapSonificationContextTracksPointGrouping();
			...
			Type = Type_DefaultValue = PlotOptionsTreemapSonificationContextTracksType.Instrument;
			ValueInterval = ValueInterval_DefaultValue = null;
			ValueMapFunction = ValueMapFunction_DefaultValue = PlotOptionsTreemapSonificationContextTracksValueMapFunction.Linear;
		...
		/// </summary>
		public PlotOptionsTreemapSonificationContextTracksActiveWhen ActiveWhen { get; set; }
		private PlotOptionsTreemapSonificationContextTracksActiveWhen ActiveWhen_DefaultValue { get; set; }
		...
		/// </summary>
		public PlotOptionsTreemapSonificationContextTracksMapping Mapping { get; set; }
		private PlotOptionsTreemapSonificationContextTracksMapping Mapping_DefaultValue { get; set; }
		...
		/// </summary>
		public PlotOptionsTreemapSonificationContextTracksPointGrouping PointGrouping { get; set; }
		private PlotOptionsTreemapSonificationContextTracksPointGrouping PointGrouping_DefaultValue { get; set; }
		...
		/// </summary>
		public PlotOptionsTreemapSonificationContextTracksType Type { get; set; }
		private PlotOptionsTreemapSonificationContextTracksType Type_DefaultValue { get; set; }
		...
		/// </summary>
		public PlotOptionsTreemapSonificationContextTracksValueMapFunction ValueMapFunction { get; set; }
		private PlotOptionsTreemapSonificationContextTracksValueMapFunction ValueMapFunction_DefaultValue { get; set; }
