...
{
	public partial class PlotOptionsTreemapStatesSelect  : PlotOptionsSeries
	{
		Hashtable h = new Hashtable();

		public PlotOptionsTreemapStatesSelect()
		{
			Animation = Animation_DefaultValue = new Animation();
			Enabled = Enabled_DefaultValue = null;
			Halo = Halo_DefaultValue = new PlotOptionsTreemapStatesSelectHalo();
			LineWidth = LineWidth_DefaultValue = null;
			LineWidthPlus = LineWidthPlus_DefaultValue = null;
			Marker = Marker_DefaultValue = new PlotOptionsTreemapStatesSelectMarker();
		...
		/// </summary>
		public PlotOptionsTreemapStatesSelectHalo Halo { get; set; }
		private PlotOptionsTreemapStatesSelectHalo Halo_DefaultValue { get; set; }
		...
		/// </summary>
		public PlotOptionsTreemapStatesSelectMarker Marker { get; set; }
		private PlotOptionsTreemapStatesSelectMarker Marker_DefaultValue { get; set; }
