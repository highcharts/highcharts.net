...
{
	public partial class PlotOptionsTreemapStatesSelectMarker  : PlotOptionsSeries
	{
		Hashtable h = new Hashtable();

		public PlotOptionsTreemapStatesSelectMarker()
		{
			...
			States = States_DefaultValue = new PlotOptionsTreemapStatesSelectMarkerStates();
		...
		/// </summary>
		public PlotOptionsTreemapStatesSelectMarkerStates States { get; set; }
		private PlotOptionsTreemapStatesSelectMarkerStates States_DefaultValue { get; set; }
