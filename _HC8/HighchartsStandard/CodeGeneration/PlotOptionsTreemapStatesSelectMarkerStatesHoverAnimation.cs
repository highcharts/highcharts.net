...
{
	public partial class PlotOptionsTreemapStatesSelectMarkerStatesHoverAnimation  : PlotOptionsSeries
	{
		Hashtable h = new Hashtable();

		public PlotOptionsTreemapStatesSelectMarkerStatesHoverAnimation()
		{
