...
{
	public partial class PlotOptionsVariablepieSonificationContextTracks  : BaseObject
	{
		Hashtable h = new Hashtable();

		public PlotOptionsVariablepieSonificationContextTracks()
		{
			ActiveWhen = ActiveWhen_DefaultValue = new PlotOptionsVariablepieSonificationContextTracksActiveWhen();
			Instrument = Instrument_DefaultValue = null;
			InstrumentString = InstrumentString_DefaultValue = "null";
			Mapping = Mapping_DefaultValue = new PlotOptionsVariablepieSonificationContextTracksMapping();
			MidiName = MidiName_DefaultValue = "";
			PointGrouping = PointGrouping_DefaultValue = new PlotOptionsVariablepieSonificationContextTracksPointGrouping();
			...
			Type = Type_DefaultValue = PlotOptionsVariablepieSonificationContextTracksType.Instrument;
			ValueInterval = ValueInterval_DefaultValue = null;
			ValueMapFunction = ValueMapFunction_DefaultValue = PlotOptionsVariablepieSonificationContextTracksValueMapFunction.Linear;
		...
		/// </summary>
		public PlotOptionsVariablepieSonificationContextTracksActiveWhen ActiveWhen { get; set; }
		private PlotOptionsVariablepieSonificationContextTracksActiveWhen ActiveWhen_DefaultValue { get; set; }
		...
		/// </summary>
		public PlotOptionsVariablepieSonificationContextTracksMapping Mapping { get; set; }
		private PlotOptionsVariablepieSonificationContextTracksMapping Mapping_DefaultValue { get; set; }
		...
		/// </summary>
		public PlotOptionsVariablepieSonificationContextTracksPointGrouping PointGrouping { get; set; }
		private PlotOptionsVariablepieSonificationContextTracksPointGrouping PointGrouping_DefaultValue { get; set; }
		...
		/// </summary>
		public PlotOptionsVariablepieSonificationContextTracksType Type { get; set; }
		private PlotOptionsVariablepieSonificationContextTracksType Type_DefaultValue { get; set; }
		...
		/// </summary>
		public PlotOptionsVariablepieSonificationContextTracksValueMapFunction ValueMapFunction { get; set; }
		private PlotOptionsVariablepieSonificationContextTracksValueMapFunction ValueMapFunction_DefaultValue { get; set; }
