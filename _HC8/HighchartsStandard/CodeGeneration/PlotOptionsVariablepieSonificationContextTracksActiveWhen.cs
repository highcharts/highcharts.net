...
{
	public partial class PlotOptionsVariablepieSonificationContextTracksActiveWhen  : BaseObject
	{
		Hashtable h = new Hashtable();

		public PlotOptionsVariablepieSonificationContextTracksActiveWhen()
		{
