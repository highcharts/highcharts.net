...
{
	public partial class PlotOptionsVariablepieSonificationTracks  : BaseObject
	{
		Hashtable h = new Hashtable();

		public PlotOptionsVariablepieSonificationTracks()
		{
			ActiveWhen = ActiveWhen_DefaultValue = new PlotOptionsVariablepieSonificationTracksActiveWhen();
			Instrument = Instrument_DefaultValue = null;
			InstrumentString = InstrumentString_DefaultValue = "null";
			Mapping = Mapping_DefaultValue = new PlotOptionsVariablepieSonificationTracksMapping();
			MidiName = MidiName_DefaultValue = "";
			PointGrouping = PointGrouping_DefaultValue = new PlotOptionsVariablepieSonificationTracksPointGrouping();
			RoundToMusicalNotes = RoundToMusicalNotes_DefaultValue = true;
			ShowPlayMarker = ShowPlayMarker_DefaultValue = true;
			Type = Type_DefaultValue = PlotOptionsVariablepieSonificationTracksType.Instrument;
		...
		/// </summary>
		public PlotOptionsVariablepieSonificationTracksActiveWhen ActiveWhen { get; set; }
		private PlotOptionsVariablepieSonificationTracksActiveWhen ActiveWhen_DefaultValue { get; set; }
		...
		/// </summary>
		public PlotOptionsVariablepieSonificationTracksMapping Mapping { get; set; }
		private PlotOptionsVariablepieSonificationTracksMapping Mapping_DefaultValue { get; set; }
		...
		/// </summary>
		public PlotOptionsVariablepieSonificationTracksPointGrouping PointGrouping { get; set; }
		private PlotOptionsVariablepieSonificationTracksPointGrouping PointGrouping_DefaultValue { get; set; }
		...
		/// </summary>
		public PlotOptionsVariablepieSonificationTracksType Type { get; set; }
		private PlotOptionsVariablepieSonificationTracksType Type_DefaultValue { get; set; }
