...
{
	public partial class PlotOptionsVariablepieStatesHoverMarker  : PlotOptionsSeries
	{
		Hashtable h = new Hashtable();

		public PlotOptionsVariablepieStatesHoverMarker()
		{
			...
			States = States_DefaultValue = new PlotOptionsVariablepieStatesHoverMarkerStates();
		...
		/// </summary>
		public PlotOptionsVariablepieStatesHoverMarkerStates States { get; set; }
		private PlotOptionsVariablepieStatesHoverMarkerStates States_DefaultValue { get; set; }
