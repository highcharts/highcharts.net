...
{
	public partial class PlotOptionsVariablepieStatesSelect  : PlotOptionsSeries
	{
		Hashtable h = new Hashtable();

		public PlotOptionsVariablepieStatesSelect()
		{
			Animation = Animation_DefaultValue = new Animation();
			Enabled = Enabled_DefaultValue = null;
			Halo = Halo_DefaultValue = new PlotOptionsVariablepieStatesSelectHalo();
			LineWidth = LineWidth_DefaultValue = null;
			LineWidthPlus = LineWidthPlus_DefaultValue = null;
			Marker = Marker_DefaultValue = new PlotOptionsVariablepieStatesSelectMarker();
		...
		/// </summary>
		public PlotOptionsVariablepieStatesSelectHalo Halo { get; set; }
		private PlotOptionsVariablepieStatesSelectHalo Halo_DefaultValue { get; set; }
		...
		/// </summary>
		public PlotOptionsVariablepieStatesSelectMarker Marker { get; set; }
		private PlotOptionsVariablepieStatesSelectMarker Marker_DefaultValue { get; set; }
