...
{
	public partial class PlotOptionsVariablepieStatesSelectMarker  : PlotOptionsSeries
	{
		Hashtable h = new Hashtable();

		public PlotOptionsVariablepieStatesSelectMarker()
		{
			...
			States = States_DefaultValue = new PlotOptionsVariablepieStatesSelectMarkerStates();
		...
		/// </summary>
		public PlotOptionsVariablepieStatesSelectMarkerStates States { get; set; }
		private PlotOptionsVariablepieStatesSelectMarkerStates States_DefaultValue { get; set; }
