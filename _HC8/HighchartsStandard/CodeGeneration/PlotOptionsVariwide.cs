...
namespace Highsoft.Web.Mvc.Charts
{
	public partial class PlotOptionsVariwide  : BaseObject
	{
		...
		public PlotOptionsVariwide()
		{
			...
			BoostBlending = BoostBlending_DefaultValue = PlotOptionsVariwideBoostBlending.Undefined;
		...
		/// </summary>
		public PlotOptionsVariwideBoostBlending BoostBlending { get; set; }
		private PlotOptionsVariwideBoostBlending BoostBlending_DefaultValue { get; set; }
		...
		internal override Hashtable ToHashtable()
		{
			...
			if (PointDescriptionFormatter != PointDescriptionFormatter_DefaultValue) { h.Add("pointDescriptionFormatter",PointDescriptionFormatter); Highcharts.AddFunction("6e173183-b311-477c-b86d-6e9b07b4eb0c.pointDescriptionFormatter", PointDescriptionFormatter); }  
