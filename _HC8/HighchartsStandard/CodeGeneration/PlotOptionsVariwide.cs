...
namespace Highsoft.Web.Mvc.Charts
{
	public partial class PlotOptionsVariwide  : BaseObject
	{
		...
		internal override Hashtable ToHashtable()
		{
			...
			if (PointDescriptionFormatter != PointDescriptionFormatter_DefaultValue) { h.Add("pointDescriptionFormatter",PointDescriptionFormatter); Highcharts.AddFunction("5dd8293f-5a6f-4fce-9cf9-d65175648b54.pointDescriptionFormatter", PointDescriptionFormatter); }  
