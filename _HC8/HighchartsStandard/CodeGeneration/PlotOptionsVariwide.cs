...
namespace Highsoft.Web.Mvc.Charts
{
	public partial class PlotOptionsVariwide  : BaseObject
	{
		...
		internal override Hashtable ToHashtable()
		{
			...
			if (PointDescriptionFormatter != PointDescriptionFormatter_DefaultValue) { h.Add("pointDescriptionFormatter",PointDescriptionFormatter); Highcharts.AddFunction("725a9d83-7339-4a56-922b-ed2230fc4f41.pointDescriptionFormatter", PointDescriptionFormatter); }  
