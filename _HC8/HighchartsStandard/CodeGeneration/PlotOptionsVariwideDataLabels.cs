...
{
	public partial class PlotOptionsVariwideDataLabels  : BaseObject
	{
		Hashtable h = new Hashtable();

		public PlotOptionsVariwideDataLabels()
		{
			Align = Align_DefaultValue = PlotOptionsVariwideDataLabelsAlign.Center;
			...
			Filter = Filter_DefaultValue = new PlotOptionsVariwideDataLabelsFilter();
			...
			Style = Style_DefaultValue = new PlotOptionsVariwideDataLabelsStyle();
			TextPath = TextPath_DefaultValue = new PlotOptionsVariwideDataLabelsTextPath();
			UseHTML = UseHTML_DefaultValue = false;
			VerticalAlign = VerticalAlign_DefaultValue = PlotOptionsVariwideDataLabelsVerticalAlign.Bottom;
			X = X_DefaultValue = 0;
			Y = Y_DefaultValue = 0;
			Z = Z_DefaultValue = 6;
		...
		/// </summary>
		public PlotOptionsVariwideDataLabelsAlign Align { get; set; }
		private PlotOptionsVariwideDataLabelsAlign Align_DefaultValue { get; set; }
		...
		/// </summary>
		public PlotOptionsVariwideDataLabelsFilter Filter { get; set; }
		private PlotOptionsVariwideDataLabelsFilter Filter_DefaultValue { get; set; }
		...
		/// </summary>
		public PlotOptionsVariwideDataLabelsStyle Style { get; set; }
		private PlotOptionsVariwideDataLabelsStyle Style_DefaultValue { get; set; }
		...
		/// </summary>
		public PlotOptionsVariwideDataLabelsTextPath TextPath { get; set; }
		private PlotOptionsVariwideDataLabelsTextPath TextPath_DefaultValue { get; set; }
		...
		/// </summary>
		public PlotOptionsVariwideDataLabelsVerticalAlign VerticalAlign { get; set; }
		private PlotOptionsVariwideDataLabelsVerticalAlign VerticalAlign_DefaultValue { get; set; }
		...
		internal override Hashtable ToHashtable()
		{
			...
			if (Formatter != Formatter_DefaultValue) { h.Add("formatter",Formatter); Highcharts.AddFunction("cda6c232-ca1f-45c8-819f-da16e70ae734.formatter", Formatter); }  
			...
			if (NullFormatter != NullFormatter_DefaultValue) { h.Add("nullFormatter",NullFormatter); Highcharts.AddFunction("d3827132-ed02-4219-b992-de7c3d43130a.nullFormatter", NullFormatter); }  
