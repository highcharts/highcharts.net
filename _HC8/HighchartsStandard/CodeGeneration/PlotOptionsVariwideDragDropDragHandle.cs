...
namespace Highsoft.Web.Mvc.Charts
{
	public partial class PlotOptionsVariwideDragDropDragHandle  : BaseObject
	{
		...
		internal override Hashtable ToHashtable()
		{
			...
			if (PathFormatter != PathFormatter_DefaultValue) { h.Add("pathFormatter",PathFormatter); Highcharts.AddFunction("11401e58-91e4-4c2f-abcb-1b0c0e483a2b.pathFormatter", PathFormatter); }  
