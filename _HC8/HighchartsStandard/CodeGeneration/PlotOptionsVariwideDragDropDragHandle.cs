...
namespace Highsoft.Web.Mvc.Charts
{
	public partial class PlotOptionsVariwideDragDropDragHandle  : BaseObject
	{
		...
		internal override Hashtable ToHashtable()
		{
			...
			if (PathFormatter != PathFormatter_DefaultValue) { h.Add("pathFormatter",PathFormatter); Highcharts.AddFunction("9d48907e-86d2-4fc9-ac53-e618c11940c6.pathFormatter", PathFormatter); }  
