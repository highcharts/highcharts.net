...
namespace Highsoft.Web.Mvc.Charts
{
	public partial class PlotOptionsVariwideDragDropDragHandle  : BaseObject
	{
		...
		internal override Hashtable ToHashtable()
		{
			...
			if (PathFormatter != PathFormatter_DefaultValue) { h.Add("pathFormatter",PathFormatter); Highcharts.AddFunction("a09054f6-15f7-4b44-affe-1cf2e600c85a.pathFormatter", PathFormatter); }  
