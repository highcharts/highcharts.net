...
{
	public partial class PlotOptionsVariwideOnPoint  : BaseObject
	{
		Hashtable h = new Hashtable();

		public PlotOptionsVariwideOnPoint()
		{
			ConnectorOptions = ConnectorOptions_DefaultValue = new PlotOptionsVariwideOnPointConnectorOptions();
			Id = Id_DefaultValue = "";
			Position = Position_DefaultValue = new PlotOptionsVariwideOnPointPosition();
		...
		/// </summary>
		public PlotOptionsVariwideOnPointConnectorOptions ConnectorOptions { get; set; }
		private PlotOptionsVariwideOnPointConnectorOptions ConnectorOptions_DefaultValue { get; set; }
		...
		/// </summary>
		public PlotOptionsVariwideOnPointPosition Position { get; set; }
		private PlotOptionsVariwideOnPointPosition Position_DefaultValue { get; set; }
