...
{
	public partial class PlotOptionsVariwideSonificationTracks  : BaseObject
	{
		Hashtable h = new Hashtable();

		public PlotOptionsVariwideSonificationTracks()
		{
			ActiveWhen = ActiveWhen_DefaultValue = new PlotOptionsVariwideSonificationTracksActiveWhen();
			Instrument = Instrument_DefaultValue = null;
			InstrumentString = InstrumentString_DefaultValue = "null";
			Mapping = Mapping_DefaultValue = new PlotOptionsVariwideSonificationTracksMapping();
			MidiName = MidiName_DefaultValue = "";
			PointGrouping = PointGrouping_DefaultValue = new PlotOptionsVariwideSonificationTracksPointGrouping();
			RoundToMusicalNotes = RoundToMusicalNotes_DefaultValue = true;
			ShowPlayMarker = ShowPlayMarker_DefaultValue = true;
			Type = Type_DefaultValue = PlotOptionsVariwideSonificationTracksType.Instrument;
		...
		/// </summary>
		public PlotOptionsVariwideSonificationTracksActiveWhen ActiveWhen { get; set; }
		private PlotOptionsVariwideSonificationTracksActiveWhen ActiveWhen_DefaultValue { get; set; }
		...
		/// </summary>
		public PlotOptionsVariwideSonificationTracksMapping Mapping { get; set; }
		private PlotOptionsVariwideSonificationTracksMapping Mapping_DefaultValue { get; set; }
		...
		/// </summary>
		public PlotOptionsVariwideSonificationTracksPointGrouping PointGrouping { get; set; }
		private PlotOptionsVariwideSonificationTracksPointGrouping PointGrouping_DefaultValue { get; set; }
		...
		/// </summary>
		public PlotOptionsVariwideSonificationTracksType Type { get; set; }
		private PlotOptionsVariwideSonificationTracksType Type_DefaultValue { get; set; }
