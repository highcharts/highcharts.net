...
{
	public partial class PlotOptionsVariwideStatesHover  : PlotOptionsSeries
	{
		Hashtable h = new Hashtable();

		public PlotOptionsVariwideStatesHover()
		{
			Animation = Animation_DefaultValue = new Animation();
			Enabled = Enabled_DefaultValue = null;
			Halo = Halo_DefaultValue = new PlotOptionsVariwideStatesHoverHalo();
			LineWidth = LineWidth_DefaultValue = null;
			LineWidthPlus = LineWidthPlus_DefaultValue = null;
			Marker = Marker_DefaultValue = new PlotOptionsVariwideStatesHoverMarker();
		...
		/// </summary>
		public PlotOptionsVariwideStatesHoverHalo Halo { get; set; }
		private PlotOptionsVariwideStatesHoverHalo Halo_DefaultValue { get; set; }
		...
		/// </summary>
		public PlotOptionsVariwideStatesHoverMarker Marker { get; set; }
		private PlotOptionsVariwideStatesHoverMarker Marker_DefaultValue { get; set; }
