...
{
	public partial class PlotOptionsVariwideStatesHoverMarker  : PlotOptionsSeries
	{
		Hashtable h = new Hashtable();

		public PlotOptionsVariwideStatesHoverMarker()
		{
			...
			States = States_DefaultValue = new PlotOptionsVariwideStatesHoverMarkerStates();
		...
		/// </summary>
		public PlotOptionsVariwideStatesHoverMarkerStates States { get; set; }
		private PlotOptionsVariwideStatesHoverMarkerStates States_DefaultValue { get; set; }
