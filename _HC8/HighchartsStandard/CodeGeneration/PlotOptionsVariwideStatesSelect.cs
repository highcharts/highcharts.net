...
{
	public partial class PlotOptionsVariwideStatesSelect  : PlotOptionsSeries
	{
		Hashtable h = new Hashtable();

		public PlotOptionsVariwideStatesSelect()
		{
			Animation = Animation_DefaultValue = new Animation();
			Enabled = Enabled_DefaultValue = null;
			Halo = Halo_DefaultValue = new PlotOptionsVariwideStatesSelectHalo();
			LineWidth = LineWidth_DefaultValue = null;
			LineWidthPlus = LineWidthPlus_DefaultValue = null;
			Marker = Marker_DefaultValue = new PlotOptionsVariwideStatesSelectMarker();
		...
		/// </summary>
		public PlotOptionsVariwideStatesSelectHalo Halo { get; set; }
		private PlotOptionsVariwideStatesSelectHalo Halo_DefaultValue { get; set; }
		...
		/// </summary>
		public PlotOptionsVariwideStatesSelectMarker Marker { get; set; }
		private PlotOptionsVariwideStatesSelectMarker Marker_DefaultValue { get; set; }
