...
{
	public partial class PlotOptionsVariwideStatesSelectMarker  : PlotOptionsSeries
	{
		Hashtable h = new Hashtable();

		public PlotOptionsVariwideStatesSelectMarker()
		{
			...
			States = States_DefaultValue = new PlotOptionsVariwideStatesSelectMarkerStates();
		...
		/// </summary>
		public PlotOptionsVariwideStatesSelectMarkerStates States { get; set; }
		private PlotOptionsVariwideStatesSelectMarkerStates States_DefaultValue { get; set; }
