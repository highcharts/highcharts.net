...
{
	public partial class PlotOptionsVariwideStatesSelectMarkerStatesHoverAnimation  : PlotOptionsSeries
	{
		Hashtable h = new Hashtable();

		public PlotOptionsVariwideStatesSelectMarkerStatesHoverAnimation()
		{
