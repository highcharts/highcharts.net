...
namespace Highsoft.Web.Mvc.Charts
{
	public partial class PlotOptionsVectorClusterEvents  : BaseObject
	{
		...
		internal override Hashtable ToHashtable()
		{
			...
			if (DrillToCluster != DrillToCluster_DefaultValue) { h.Add("drillToCluster",DrillToCluster); Highcharts.AddFunction("0886a1d4-415e-4642-970e-f7405961ae3e.drillToCluster", DrillToCluster); }  
