...
namespace Highsoft.Web.Mvc.Charts
{
	public partial class PlotOptionsVectorClusterEvents  : BaseObject
	{
		...
		internal override Hashtable ToHashtable()
		{
			...
			if (DrillToCluster != DrillToCluster_DefaultValue) { h.Add("drillToCluster",DrillToCluster); Highcharts.AddFunction("13c37fdc-b338-4791-8bb4-a48fb92b0a64.drillToCluster", DrillToCluster); }  
