...
{
	public partial class PlotOptionsVectorDataLabels  : BaseObject
	{
		Hashtable h = new Hashtable();

		public PlotOptionsVectorDataLabels()
		{
			Align = Align_DefaultValue = PlotOptionsVectorDataLabelsAlign.Center;
			...
			Filter = Filter_DefaultValue = new PlotOptionsVectorDataLabelsFilter();
			...
			Style = Style_DefaultValue = new PlotOptionsVectorDataLabelsStyle();
			TextPath = TextPath_DefaultValue = new PlotOptionsVectorDataLabelsTextPath();
			UseHTML = UseHTML_DefaultValue = false;
			VerticalAlign = VerticalAlign_DefaultValue = PlotOptionsVectorDataLabelsVerticalAlign.Bottom;
			X = X_DefaultValue = 0;
			Y = Y_DefaultValue = 0;
			Z = Z_DefaultValue = 6;
		...
		/// </summary>
		public PlotOptionsVectorDataLabelsAlign Align { get; set; }
		private PlotOptionsVectorDataLabelsAlign Align_DefaultValue { get; set; }
		...
		/// </summary>
		public PlotOptionsVectorDataLabelsFilter Filter { get; set; }
		private PlotOptionsVectorDataLabelsFilter Filter_DefaultValue { get; set; }
		...
		/// </summary>
		public PlotOptionsVectorDataLabelsStyle Style { get; set; }
		private PlotOptionsVectorDataLabelsStyle Style_DefaultValue { get; set; }
		...
		/// </summary>
		public PlotOptionsVectorDataLabelsTextPath TextPath { get; set; }
		private PlotOptionsVectorDataLabelsTextPath TextPath_DefaultValue { get; set; }
		...
		/// </summary>
		public PlotOptionsVectorDataLabelsVerticalAlign VerticalAlign { get; set; }
		private PlotOptionsVectorDataLabelsVerticalAlign VerticalAlign_DefaultValue { get; set; }
		...
		internal override Hashtable ToHashtable()
		{
			...
			if (Formatter != Formatter_DefaultValue) { h.Add("formatter",Formatter); Highcharts.AddFunction("d5d7832d-b6ec-433e-a6d4-383d802eeae5.formatter", Formatter); }  
			if (Inside != Inside_DefaultValue) h.Add("inside",Inside);
			if (NullFormat != NullFormat_DefaultValue) h.Add("nullFormat",NullFormat);
			if (NullFormatter != NullFormatter_DefaultValue) { h.Add("nullFormatter",NullFormatter); Highcharts.AddFunction("7a31c075-b39c-4e2c-a252-186996f8b800.nullFormatter", NullFormatter); }  
