...
namespace Highsoft.Web.Mvc.Charts
{
	public partial class PlotOptionsVectorDragDropDragHandle  : BaseObject
	{
		...
		internal override Hashtable ToHashtable()
		{
			...
			if (PathFormatter != PathFormatter_DefaultValue) { h.Add("pathFormatter",PathFormatter); Highcharts.AddFunction("76899505-d9cc-49ae-897a-8fd2386f6324.pathFormatter", PathFormatter); }  
