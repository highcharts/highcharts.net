...
{
	public partial class PlotOptionsVectorStatesSelect  : PlotOptionsSeries
	{
		Hashtable h = new Hashtable();

		public PlotOptionsVectorStatesSelect()
		{
			Animation = Animation_DefaultValue = new Animation();
			Enabled = Enabled_DefaultValue = null;
			Halo = Halo_DefaultValue = new PlotOptionsVectorStatesSelectHalo();
			LineWidth = LineWidth_DefaultValue = null;
			LineWidthPlus = LineWidthPlus_DefaultValue = null;
			Marker = Marker_DefaultValue = new PlotOptionsVectorStatesSelectMarker();
		...
		/// </summary>
		public PlotOptionsVectorStatesSelectHalo Halo { get; set; }
		private PlotOptionsVectorStatesSelectHalo Halo_DefaultValue { get; set; }
		...
		/// </summary>
		public PlotOptionsVectorStatesSelectMarker Marker { get; set; }
		private PlotOptionsVectorStatesSelectMarker Marker_DefaultValue { get; set; }
