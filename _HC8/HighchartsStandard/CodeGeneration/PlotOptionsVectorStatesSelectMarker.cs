...
{
	public partial class PlotOptionsVectorStatesSelectMarker  : PlotOptionsSeries
	{
		Hashtable h = new Hashtable();

		public PlotOptionsVectorStatesSelectMarker()
		{
			...
			States = States_DefaultValue = new PlotOptionsVectorStatesSelectMarkerStates();
		...
		/// </summary>
		public PlotOptionsVectorStatesSelectMarkerStates States { get; set; }
		private PlotOptionsVectorStatesSelectMarkerStates States_DefaultValue { get; set; }
