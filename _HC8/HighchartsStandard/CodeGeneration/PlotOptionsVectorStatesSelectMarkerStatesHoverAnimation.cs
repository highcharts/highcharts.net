...
{
	public partial class PlotOptionsVectorStatesSelectMarkerStatesHoverAnimation  : PlotOptionsSeries
	{
		Hashtable h = new Hashtable();

		public PlotOptionsVectorStatesSelectMarkerStatesHoverAnimation()
		{
