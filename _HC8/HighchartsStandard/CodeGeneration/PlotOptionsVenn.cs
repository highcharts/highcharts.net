...
namespace Highsoft.Web.Mvc.Charts
{
	public partial class PlotOptionsVenn  : BaseObject
	{
		...
		public PlotOptionsVenn()
		{
			...
			DataSorting = DataSorting_DefaultValue = new PlotOptionsVennDataSorting();
		...
		/// </summary>
		public PlotOptionsVennDataSorting DataSorting { get; set; }
		private PlotOptionsVennDataSorting DataSorting_DefaultValue { get; set; }
		...
		internal override Hashtable ToHashtable()
		{
			...
			if (PointDescriptionFormatter != PointDescriptionFormatter_DefaultValue) { h.Add("pointDescriptionFormatter",PointDescriptionFormatter); Highcharts.AddFunction("b300db56-353e-47b7-988c-d147e18f09fa.pointDescriptionFormatter", PointDescriptionFormatter); }  
