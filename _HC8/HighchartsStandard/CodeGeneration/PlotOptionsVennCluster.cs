...
{
	public partial class PlotOptionsVennCluster  : PlotOptionsSeries
	{
		Hashtable h = new Hashtable();

		public PlotOptionsVennCluster()
		{
			AllowOverlap = AllowOverlap_DefaultValue = true;
			Animation = Animation_DefaultValue = new Animation();
			AnimationBool = AnimationBool_DefaultValue = null;
			DataLabels = DataLabels_DefaultValue = new PlotOptionsVennClusterDataLabels();
			DrillToCluster = DrillToCluster_DefaultValue = true;
			Enabled = Enabled_DefaultValue = false;
			Events = Events_DefaultValue = new PlotOptionsVennClusterEvents();
			LayoutAlgorithm = LayoutAlgorithm_DefaultValue = new PlotOptionsVennClusterLayoutAlgorithm();
			Marker = Marker_DefaultValue = new PlotOptionsVennClusterMarker();
			MinimumClusterSize = MinimumClusterSize_DefaultValue = 2;
			States = States_DefaultValue = new PlotOptionsVennClusterStates();
			Zones = Zones_DefaultValue = new List<PlotOptionsVennClusterZone>();
		...
		/// </summary>
		public PlotOptionsVennClusterDataLabels DataLabels { get; set; }
		private PlotOptionsVennClusterDataLabels DataLabels_DefaultValue { get; set; }
		...
		/// 
		/// </summary>
		public PlotOptionsVennClusterEvents Events { get; set; }
		private PlotOptionsVennClusterEvents Events_DefaultValue { get; set; }
		 

		/// <summary>
		/// Options for layout algorithm. Inside thereare options to change the type of the algorithm, gridSize,distance or iterations.
		/// </summary>
		public PlotOptionsVennClusterLayoutAlgorithm LayoutAlgorithm { get; set; }
		private PlotOptionsVennClusterLayoutAlgorithm LayoutAlgorithm_DefaultValue { get; set; }
		 

		/// <summary>
		/// Options for the cluster marker.
		/// </summary>
		public PlotOptionsVennClusterMarker Marker { get; set; }
		private PlotOptionsVennClusterMarker Marker_DefaultValue { get; set; }
		...
		/// 
		/// </summary>
		public PlotOptionsVennClusterStates States { get; set; }
		private PlotOptionsVennClusterStates States_DefaultValue { get; set; }
		...
		/// </summary>
		public List<PlotOptionsVennClusterZone> Zones { get; set; }
		private List<PlotOptionsVennClusterZone> Zones_DefaultValue { get; set; }
