...
{
	public partial class PlotOptionsVennClusterMarker  : BaseObject
	{
		Hashtable h = new Hashtable();

		public PlotOptionsVennClusterMarker()
		{
			...
			States = States_DefaultValue = new PlotOptionsVennClusterMarkerStates();
		...
		/// </summary>
		public PlotOptionsVennClusterMarkerStates States { get; set; }
		private PlotOptionsVennClusterMarkerStates States_DefaultValue { get; set; }
