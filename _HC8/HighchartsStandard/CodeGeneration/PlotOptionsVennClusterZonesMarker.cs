...
{
	public partial class PlotOptionsVennClusterZonesMarker  : BaseObject
	{
		Hashtable h = new Hashtable();

		public PlotOptionsVennClusterZonesMarker()
		{
			...
			States = States_DefaultValue = new PlotOptionsVennClusterZonesMarkerStates();
		...
		/// </summary>
		public PlotOptionsVennClusterZonesMarkerStates States { get; set; }
		private PlotOptionsVennClusterZonesMarkerStates States_DefaultValue { get; set; }
