...
{
	public partial class PlotOptionsVennDataLabels  : BaseObject
	{
		Hashtable h = new Hashtable();

		public PlotOptionsVennDataLabels()
		{
			Align = Align_DefaultValue = PlotOptionsVennDataLabelsAlign.Center;
			...
			Filter = Filter_DefaultValue = new PlotOptionsVennDataLabelsFilter();
			...
			Style = Style_DefaultValue = new PlotOptionsVennDataLabelsStyle();
			TextPath = TextPath_DefaultValue = new PlotOptionsVennDataLabelsTextPath();
			UseHTML = UseHTML_DefaultValue = false;
			VerticalAlign = VerticalAlign_DefaultValue = PlotOptionsVennDataLabelsVerticalAlign.Middle;
			X = X_DefaultValue = 0;
			Y = Y_DefaultValue = 0;
			Z = Z_DefaultValue = 6;
		...
		/// </summary>
		public PlotOptionsVennDataLabelsAlign Align { get; set; }
		private PlotOptionsVennDataLabelsAlign Align_DefaultValue { get; set; }
		...
		/// </summary>
		public PlotOptionsVennDataLabelsFilter Filter { get; set; }
		private PlotOptionsVennDataLabelsFilter Filter_DefaultValue { get; set; }
		...
		/// </summary>
		public PlotOptionsVennDataLabelsStyle Style { get; set; }
		private PlotOptionsVennDataLabelsStyle Style_DefaultValue { get; set; }
		...
		/// </summary>
		public PlotOptionsVennDataLabelsTextPath TextPath { get; set; }
		private PlotOptionsVennDataLabelsTextPath TextPath_DefaultValue { get; set; }
		...
		/// 
		/// </summary>
		public PlotOptionsVennDataLabelsVerticalAlign VerticalAlign { get; set; }
		private PlotOptionsVennDataLabelsVerticalAlign VerticalAlign_DefaultValue { get; set; }
		...
		internal override Hashtable ToHashtable()
		{
			...
			if (Formatter != Formatter_DefaultValue) { h.Add("formatter",Formatter); Highcharts.AddFunction("7768f7a7-af35-4ea6-b6e6-d732ad2b1136.formatter", Formatter); }  
			if (Inside != Inside_DefaultValue) h.Add("inside",Inside);
			if (NullFormat != NullFormat_DefaultValue) h.Add("nullFormat",NullFormat);
			if (NullFormatter != NullFormatter_DefaultValue) { h.Add("nullFormatter",NullFormatter); Highcharts.AddFunction("2ff7e09b-d203-4354-a790-9fea4bdfde5a.nullFormatter", NullFormatter); }  
