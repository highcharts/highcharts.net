...
namespace Highsoft.Web.Mvc.Charts
{
	public partial class PlotOptionsVennDragDropDragHandle  : BaseObject
	{
		...
		internal override Hashtable ToHashtable()
		{
			...
			if (PathFormatter != PathFormatter_DefaultValue) { h.Add("pathFormatter",PathFormatter); Highcharts.AddFunction("17b4bc6f-8c90-4701-bdfd-aca224c0079f.pathFormatter", PathFormatter); }  
