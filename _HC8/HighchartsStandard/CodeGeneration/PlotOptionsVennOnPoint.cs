...
namespace Highsoft.Web.Mvc.Charts
{
	public partial class PlotOptionsVennOnPoint  : BaseObject
	{
		...
		{
			ConnectorOptions = ConnectorOptions_DefaultValue = new PlotOptionsVennOnPointConnectorOptions();
			Id = Id_DefaultValue = "";
			Position = Position_DefaultValue = new PlotOptionsVennOnPointPosition();
