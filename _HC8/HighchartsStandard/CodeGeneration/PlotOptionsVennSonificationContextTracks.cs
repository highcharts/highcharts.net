...
{
	public partial class PlotOptionsVennSonificationContextTracks  : BaseObject
	{
		Hashtable h = new Hashtable();

		public PlotOptionsVennSonificationContextTracks()
		{
			ActiveWhen = ActiveWhen_DefaultValue = new PlotOptionsVennSonificationContextTracksActiveWhen();
			Instrument = Instrument_DefaultValue = null;
			InstrumentString = InstrumentString_DefaultValue = "null";
			Mapping = Mapping_DefaultValue = new PlotOptionsVennSonificationContextTracksMapping();
			MidiName = MidiName_DefaultValue = "";
			PointGrouping = PointGrouping_DefaultValue = new PlotOptionsVennSonificationContextTracksPointGrouping();
			...
			Type = Type_DefaultValue = PlotOptionsVennSonificationContextTracksType.Instrument;
			ValueInterval = ValueInterval_DefaultValue = null;
			ValueMapFunction = ValueMapFunction_DefaultValue = PlotOptionsVennSonificationContextTracksValueMapFunction.Linear;
		...
		/// </summary>
		public PlotOptionsVennSonificationContextTracksActiveWhen ActiveWhen { get; set; }
		private PlotOptionsVennSonificationContextTracksActiveWhen ActiveWhen_DefaultValue { get; set; }
		...
		/// </summary>
		public PlotOptionsVennSonificationContextTracksMapping Mapping { get; set; }
		private PlotOptionsVennSonificationContextTracksMapping Mapping_DefaultValue { get; set; }
		...
		/// </summary>
		public PlotOptionsVennSonificationContextTracksPointGrouping PointGrouping { get; set; }
		private PlotOptionsVennSonificationContextTracksPointGrouping PointGrouping_DefaultValue { get; set; }
		...
		/// </summary>
		public PlotOptionsVennSonificationContextTracksType Type { get; set; }
		private PlotOptionsVennSonificationContextTracksType Type_DefaultValue { get; set; }
		...
		/// </summary>
		public PlotOptionsVennSonificationContextTracksValueMapFunction ValueMapFunction { get; set; }
		private PlotOptionsVennSonificationContextTracksValueMapFunction ValueMapFunction_DefaultValue { get; set; }
