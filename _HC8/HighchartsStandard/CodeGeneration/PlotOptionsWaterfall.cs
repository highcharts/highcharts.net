...
namespace Highsoft.Web.Mvc.Charts
{
	public partial class PlotOptionsWaterfall  : BaseObject
	{
		...
		internal override Hashtable ToHashtable()
		{
			...
			if (PointDescriptionFormatter != PointDescriptionFormatter_DefaultValue) { h.Add("pointDescriptionFormatter",PointDescriptionFormatter); Highcharts.AddFunction("67efc725-eee7-4f68-b31a-bb7b2bf986b2.pointDescriptionFormatter", PointDescriptionFormatter); }  
