...
namespace Highsoft.Web.Mvc.Charts
{
	public partial class PlotOptionsWaterfall  : BaseObject
	{
		...
		public PlotOptionsWaterfall()
		{
			...
			BoostBlending = BoostBlending_DefaultValue = PlotOptionsWaterfallBoostBlending.Undefined;
		...
		/// </summary>
		public PlotOptionsWaterfallBoostBlending BoostBlending { get; set; }
		private PlotOptionsWaterfallBoostBlending BoostBlending_DefaultValue { get; set; }
		...
		internal override Hashtable ToHashtable()
		{
			...
			if (PointDescriptionFormatter != PointDescriptionFormatter_DefaultValue) { h.Add("pointDescriptionFormatter",PointDescriptionFormatter); Highcharts.AddFunction("afa429b3-f323-4e2a-b76a-84d94328acee.pointDescriptionFormatter", PointDescriptionFormatter); }  
