...
namespace Highsoft.Web.Mvc.Charts
{
	public partial class PlotOptionsWaterfallDataLabels  : BaseObject
	{
		...
		{
			Align = Align_DefaultValue = PlotOptionsWaterfallDataLabelsAlign.Center;
			...
			Filter = Filter_DefaultValue = new PlotOptionsWaterfallDataLabelsFilter();
			...
			Style = Style_DefaultValue = new PlotOptionsWaterfallDataLabelsStyle();
			TextPath = TextPath_DefaultValue = new PlotOptionsWaterfallDataLabelsTextPath();
			UseHTML = UseHTML_DefaultValue = false;
			VerticalAlign = VerticalAlign_DefaultValue = PlotOptionsWaterfallDataLabelsVerticalAlign.Bottom;
			X = X_DefaultValue = 0;
			Y = Y_DefaultValue = 0;
			Z = Z_DefaultValue = 6;
		...
		/// </summary>
		public PlotOptionsWaterfallDataLabelsFilter Filter { get; set; }
		private PlotOptionsWaterfallDataLabelsFilter Filter_DefaultValue { get; set; }
		...
		/// </summary>
		public PlotOptionsWaterfallDataLabelsStyle Style { get; set; }
		private PlotOptionsWaterfallDataLabelsStyle Style_DefaultValue { get; set; }
		...
		/// </summary>
		public PlotOptionsWaterfallDataLabelsTextPath TextPath { get; set; }
		private PlotOptionsWaterfallDataLabelsTextPath TextPath_DefaultValue { get; set; }
		...
		internal override Hashtable ToHashtable()
		{
			...
			if (Formatter != Formatter_DefaultValue) { h.Add("formatter",Formatter); Highcharts.AddFunction("fca8ab4e-c2d7-44b9-b48b-c213525be194.formatter", Formatter); }  
			if (Inside != Inside_DefaultValue) h.Add("inside",Inside);
			if (NullFormat != NullFormat_DefaultValue) h.Add("nullFormat",NullFormat);
			if (NullFormatter != NullFormatter_DefaultValue) { h.Add("nullFormatter",NullFormatter); Highcharts.AddFunction("f0918983-93ac-437f-9175-dbc1f87b375a.nullFormatter", NullFormatter); }  
