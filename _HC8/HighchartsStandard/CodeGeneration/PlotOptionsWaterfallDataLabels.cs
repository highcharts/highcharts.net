...
namespace Highsoft.Web.Mvc.Charts
{
	public partial class PlotOptionsWaterfallDataLabels  : BaseObject
	{
		...
		public PlotOptionsWaterfallDataLabels()
		{
			...
			Overflow = Overflow_DefaultValue = PlotOptionsWaterfallDataLabelsOverflow.Justify;
			Padding = Padding_DefaultValue = 5;
			Position = Position_DefaultValue = PlotOptionsWaterfallDataLabelsPosition.Center;
