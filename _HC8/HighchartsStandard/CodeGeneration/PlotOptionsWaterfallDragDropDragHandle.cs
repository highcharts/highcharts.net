...
namespace Highsoft.Web.Mvc.Charts
{
	public partial class PlotOptionsWaterfallDragDropDragHandle  : BaseObject
	{
		...
		internal override Hashtable ToHashtable()
		{
			...
			if (PathFormatter != PathFormatter_DefaultValue) { h.Add("pathFormatter",PathFormatter); Highcharts.AddFunction("66138e82-1924-4243-8dd5-8dda4facad3d.pathFormatter", PathFormatter); }  
