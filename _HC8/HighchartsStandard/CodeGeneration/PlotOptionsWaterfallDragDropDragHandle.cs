...
namespace Highsoft.Web.Mvc.Charts
{
	public partial class PlotOptionsWaterfallDragDropDragHandle  : BaseObject
	{
		...
		internal override Hashtable ToHashtable()
		{
			...
			if (PathFormatter != PathFormatter_DefaultValue) { h.Add("pathFormatter",PathFormatter); Highcharts.AddFunction("2bbb8c99-42d8-46d1-bbc6-c77e17badfbc.pathFormatter", PathFormatter); }  
