...
{
	public partial class PlotOptionsWaterfallOnPoint  : BaseObject
	{
		Hashtable h = new Hashtable();

		public PlotOptionsWaterfallOnPoint()
		{
			ConnectorOptions = ConnectorOptions_DefaultValue = new PlotOptionsWaterfallOnPointConnectorOptions();
			Id = Id_DefaultValue = "";
			Position = Position_DefaultValue = new PlotOptionsWaterfallOnPointPosition();
		...
		/// </summary>
		public PlotOptionsWaterfallOnPointConnectorOptions ConnectorOptions { get; set; }
		private PlotOptionsWaterfallOnPointConnectorOptions ConnectorOptions_DefaultValue { get; set; }
		...
		/// </summary>
		public PlotOptionsWaterfallOnPointPosition Position { get; set; }
		private PlotOptionsWaterfallOnPointPosition Position_DefaultValue { get; set; }
