...
{
	public partial class PlotOptionsWaterfallSonificationTracks  : BaseObject
	{
		Hashtable h = new Hashtable();

		public PlotOptionsWaterfallSonificationTracks()
		{
			ActiveWhen = ActiveWhen_DefaultValue = new PlotOptionsWaterfallSonificationTracksActiveWhen();
			Instrument = Instrument_DefaultValue = null;
			InstrumentString = InstrumentString_DefaultValue = "null";
			Mapping = Mapping_DefaultValue = new PlotOptionsWaterfallSonificationTracksMapping();
			MidiName = MidiName_DefaultValue = "";
			PointGrouping = PointGrouping_DefaultValue = new PlotOptionsWaterfallSonificationTracksPointGrouping();
			RoundToMusicalNotes = RoundToMusicalNotes_DefaultValue = true;
			ShowPlayMarker = ShowPlayMarker_DefaultValue = true;
			Type = Type_DefaultValue = PlotOptionsWaterfallSonificationTracksType.Instrument;
		...
		/// </summary>
		public PlotOptionsWaterfallSonificationTracksActiveWhen ActiveWhen { get; set; }
		private PlotOptionsWaterfallSonificationTracksActiveWhen ActiveWhen_DefaultValue { get; set; }
		...
		/// </summary>
		public PlotOptionsWaterfallSonificationTracksMapping Mapping { get; set; }
		private PlotOptionsWaterfallSonificationTracksMapping Mapping_DefaultValue { get; set; }
		...
		/// </summary>
		public PlotOptionsWaterfallSonificationTracksPointGrouping PointGrouping { get; set; }
		private PlotOptionsWaterfallSonificationTracksPointGrouping PointGrouping_DefaultValue { get; set; }
		...
		/// </summary>
		public PlotOptionsWaterfallSonificationTracksType Type { get; set; }
		private PlotOptionsWaterfallSonificationTracksType Type_DefaultValue { get; set; }
