...
{
	public partial class PlotOptionsWaterfallStatesSelect  : PlotOptionsSeries
	{
		Hashtable h = new Hashtable();

		public PlotOptionsWaterfallStatesSelect()
		{
			Animation = Animation_DefaultValue = new Animation();
			Enabled = Enabled_DefaultValue = null;
			Halo = Halo_DefaultValue = new PlotOptionsWaterfallStatesSelectHalo();
			LineWidth = LineWidth_DefaultValue = null;
			LineWidthPlus = LineWidthPlus_DefaultValue = null;
			Marker = Marker_DefaultValue = new PlotOptionsWaterfallStatesSelectMarker();
		...
		/// </summary>
		public PlotOptionsWaterfallStatesSelectHalo Halo { get; set; }
		private PlotOptionsWaterfallStatesSelectHalo Halo_DefaultValue { get; set; }
		...
		/// </summary>
		public PlotOptionsWaterfallStatesSelectMarker Marker { get; set; }
		private PlotOptionsWaterfallStatesSelectMarker Marker_DefaultValue { get; set; }
