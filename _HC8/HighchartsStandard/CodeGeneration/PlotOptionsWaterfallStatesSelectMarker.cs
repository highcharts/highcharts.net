...
{
	public partial class PlotOptionsWaterfallStatesSelectMarker  : PlotOptionsSeries
	{
		Hashtable h = new Hashtable();

		public PlotOptionsWaterfallStatesSelectMarker()
		{
			...
			States = States_DefaultValue = new PlotOptionsWaterfallStatesSelectMarkerStates();
		...
		/// </summary>
		public PlotOptionsWaterfallStatesSelectMarkerStates States { get; set; }
		private PlotOptionsWaterfallStatesSelectMarkerStates States_DefaultValue { get; set; }
