...
namespace Highsoft.Web.Mvc.Charts
{
	public partial class PlotOptionsWindbarbAccessibility  : BaseObject
	{
		...
		internal override Hashtable ToHashtable()
		{
			...
			if (PointDescriptionFormatter != PointDescriptionFormatter_DefaultValue) { h.Add("pointDescriptionFormatter",PointDescriptionFormatter); Highcharts.AddFunction("0d4eefd0-b756-4989-80c8-cbf825b2d000.pointDescriptionFormatter", PointDescriptionFormatter); }  
