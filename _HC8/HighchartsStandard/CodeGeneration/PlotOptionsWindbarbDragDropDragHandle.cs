...
namespace Highsoft.Web.Mvc.Charts
{
	public partial class PlotOptionsWindbarbDragDropDragHandle  : BaseObject
	{
		...
		internal override Hashtable ToHashtable()
		{
			...
			if (PathFormatter != PathFormatter_DefaultValue) { h.Add("pathFormatter",PathFormatter); Highcharts.AddFunction("739e0a5e-d6ea-4d02-a740-5cb3008d7cb2.pathFormatter", PathFormatter); }  
