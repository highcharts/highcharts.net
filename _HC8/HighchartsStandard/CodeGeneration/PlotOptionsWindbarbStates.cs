...
{
	public partial class PlotOptionsWindbarbStates  : PlotOptionsSeries
	{
		...
		/// </summary>
		public PlotOptionsWindbarbStatesSelect Select { get; set; }
		private PlotOptionsWindbarbStatesSelect Select_DefaultValue { get; set; }
