...
{
	public partial class PlotOptionsWindbarbStatesSelect  : PlotOptionsSeries
	{
		Hashtable h = new Hashtable();

		public PlotOptionsWindbarbStatesSelect()
		{
			Animation = Animation_DefaultValue = new Animation();
			Enabled = Enabled_DefaultValue = null;
			Halo = Halo_DefaultValue = new PlotOptionsWindbarbStatesSelectHalo();
			LineWidth = LineWidth_DefaultValue = null;
			LineWidthPlus = LineWidthPlus_DefaultValue = null;
			Marker = Marker_DefaultValue = new PlotOptionsWindbarbStatesSelectMarker();
		...
		/// </summary>
		public PlotOptionsWindbarbStatesSelectHalo Halo { get; set; }
		private PlotOptionsWindbarbStatesSelectHalo Halo_DefaultValue { get; set; }
		...
		/// </summary>
		public PlotOptionsWindbarbStatesSelectMarker Marker { get; set; }
		private PlotOptionsWindbarbStatesSelectMarker Marker_DefaultValue { get; set; }
