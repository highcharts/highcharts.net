...
{
	public partial class PlotOptionsWindbarbStatesSelectMarker  : PlotOptionsSeries
	{
		Hashtable h = new Hashtable();

		public PlotOptionsWindbarbStatesSelectMarker()
		{
			...
			States = States_DefaultValue = new PlotOptionsWindbarbStatesSelectMarkerStates();
		...
		/// </summary>
		public PlotOptionsWindbarbStatesSelectMarkerStates States { get; set; }
		private PlotOptionsWindbarbStatesSelectMarkerStates States_DefaultValue { get; set; }
