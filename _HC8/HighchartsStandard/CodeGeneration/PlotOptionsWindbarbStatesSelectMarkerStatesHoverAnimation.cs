...
{
	public partial class PlotOptionsWindbarbStatesSelectMarkerStatesHoverAnimation  : PlotOptionsSeries
	{
		Hashtable h = new Hashtable();

		public PlotOptionsWindbarbStatesSelectMarkerStatesHoverAnimation()
		{
