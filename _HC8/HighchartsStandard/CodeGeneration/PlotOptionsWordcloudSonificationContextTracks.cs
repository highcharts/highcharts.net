...
{
	public partial class PlotOptionsWordcloudSonificationContextTracks  : BaseObject
	{
		Hashtable h = new Hashtable();

		public PlotOptionsWordcloudSonificationContextTracks()
		{
			ActiveWhen = ActiveWhen_DefaultValue = new PlotOptionsWordcloudSonificationContextTracksActiveWhen();
			Instrument = Instrument_DefaultValue = null;
			InstrumentString = InstrumentString_DefaultValue = "null";
			Mapping = Mapping_DefaultValue = new PlotOptionsWordcloudSonificationContextTracksMapping();
			MidiName = MidiName_DefaultValue = "";
			PointGrouping = PointGrouping_DefaultValue = new PlotOptionsWordcloudSonificationContextTracksPointGrouping();
			...
			Type = Type_DefaultValue = PlotOptionsWordcloudSonificationContextTracksType.Instrument;
			ValueInterval = ValueInterval_DefaultValue = null;
			ValueMapFunction = ValueMapFunction_DefaultValue = PlotOptionsWordcloudSonificationContextTracksValueMapFunction.Linear;
		...
		/// </summary>
		public PlotOptionsWordcloudSonificationContextTracksActiveWhen ActiveWhen { get; set; }
		private PlotOptionsWordcloudSonificationContextTracksActiveWhen ActiveWhen_DefaultValue { get; set; }
		...
		/// </summary>
		public PlotOptionsWordcloudSonificationContextTracksMapping Mapping { get; set; }
		private PlotOptionsWordcloudSonificationContextTracksMapping Mapping_DefaultValue { get; set; }
		...
		/// </summary>
		public PlotOptionsWordcloudSonificationContextTracksPointGrouping PointGrouping { get; set; }
		private PlotOptionsWordcloudSonificationContextTracksPointGrouping PointGrouping_DefaultValue { get; set; }
		...
		/// </summary>
		public PlotOptionsWordcloudSonificationContextTracksType Type { get; set; }
		private PlotOptionsWordcloudSonificationContextTracksType Type_DefaultValue { get; set; }
		...
		/// </summary>
		public PlotOptionsWordcloudSonificationContextTracksValueMapFunction ValueMapFunction { get; set; }
		private PlotOptionsWordcloudSonificationContextTracksValueMapFunction ValueMapFunction_DefaultValue { get; set; }
