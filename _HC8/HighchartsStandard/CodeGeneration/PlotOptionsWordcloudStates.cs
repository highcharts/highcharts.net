...
{
	public partial class PlotOptionsWordcloudStates  : PlotOptionsSeries
	{
		...
		/// </summary>
		public PlotOptionsWordcloudStatesHover Hover { get; set; }
		private PlotOptionsWordcloudStatesHover Hover_DefaultValue { get; set; }
		 

		/// <summary>
		/// The opposite state of a hover for series.
		/// </summary>
		public PlotOptionsWordcloudStatesInactive Inactive { get; set; }
		private PlotOptionsWordcloudStatesInactive Inactive_DefaultValue { get; set; }
