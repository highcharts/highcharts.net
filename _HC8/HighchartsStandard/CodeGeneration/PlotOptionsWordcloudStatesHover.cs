...
{
	public partial class PlotOptionsWordcloudStatesHover  : PlotOptionsSeries
	{
		Hashtable h = new Hashtable();

		public PlotOptionsWordcloudStatesHover()
		{
			Animation = Animation_DefaultValue = new Animation();
			Enabled = Enabled_DefaultValue = null;
			Halo = Halo_DefaultValue = new PlotOptionsWordcloudStatesHoverHalo();
			LineWidth = LineWidth_DefaultValue = null;
			LineWidthPlus = LineWidthPlus_DefaultValue = null;
			Marker = Marker_DefaultValue = new PlotOptionsWordcloudStatesHoverMarker();
		...
		/// </summary>
		public PlotOptionsWordcloudStatesHoverHalo Halo { get; set; }
		private PlotOptionsWordcloudStatesHoverHalo Halo_DefaultValue { get; set; }
		...
		/// </summary>
		public PlotOptionsWordcloudStatesHoverMarker Marker { get; set; }
		private PlotOptionsWordcloudStatesHoverMarker Marker_DefaultValue { get; set; }
