...
{
	public partial class PlotOptionsWordcloudStatesHoverMarker  : PlotOptionsSeries
	{
		Hashtable h = new Hashtable();

		public PlotOptionsWordcloudStatesHoverMarker()
		{
			...
			States = States_DefaultValue = new PlotOptionsWordcloudStatesHoverMarkerStates();
		...
		/// </summary>
		public PlotOptionsWordcloudStatesHoverMarkerStates States { get; set; }
		private PlotOptionsWordcloudStatesHoverMarkerStates States_DefaultValue { get; set; }
