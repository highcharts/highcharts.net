...
{
	public partial class PlotOptionsWordcloudStatesSelect  : PlotOptionsSeries
	{
		...
		public PlotOptionsWordcloudStatesSelect()
		{
			...
			Halo = Halo_DefaultValue = new PlotOptionsWordcloudStatesSelectHalo();
			LineWidth = LineWidth_DefaultValue = null;
			LineWidthPlus = LineWidthPlus_DefaultValue = null;
			Marker = Marker_DefaultValue = new PlotOptionsWordcloudStatesSelectMarker();
		...
		/// </summary>
		public PlotOptionsWordcloudStatesSelectHalo Halo { get; set; }
		private PlotOptionsWordcloudStatesSelectHalo Halo_DefaultValue { get; set; }
		...
		/// </summary>
		public PlotOptionsWordcloudStatesSelectMarker Marker { get; set; }
		private PlotOptionsWordcloudStatesSelectMarker Marker_DefaultValue { get; set; }
