...
{
	public partial class PlotOptionsWordcloudStatesSelectMarker  : PlotOptionsSeries
	{
		Hashtable h = new Hashtable();

		public PlotOptionsWordcloudStatesSelectMarker()
		{
			...
			States = States_DefaultValue = new PlotOptionsWordcloudStatesSelectMarkerStates();
		...
		/// </summary>
		public PlotOptionsWordcloudStatesSelectMarkerStates States { get; set; }
		private PlotOptionsWordcloudStatesSelectMarkerStates States_DefaultValue { get; set; }
