...
{
	public partial class PlotOptionsWordcloudStatesSelectMarkerStatesHoverAnimation  : PlotOptionsSeries
	{
		Hashtable h = new Hashtable();

		public PlotOptionsWordcloudStatesSelectMarkerStatesHoverAnimation()
		{
