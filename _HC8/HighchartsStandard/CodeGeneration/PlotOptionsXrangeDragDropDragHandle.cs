...
namespace Highsoft.Web.Mvc.Charts
{
	public partial class PlotOptionsXrangeDragDropDragHandle  : BaseObject
	{
		...
		internal override Hashtable ToHashtable()
		{
			...
			if (PathFormatter != PathFormatter_DefaultValue) { h.Add("pathFormatter",PathFormatter); Highcharts.AddFunction("3c950ddc-e591-4bec-b369-124046add9d0.pathFormatter", PathFormatter); }  
