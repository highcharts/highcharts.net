...
{
	public partial class PlotOptionsXrangeOnPoint  : BaseObject
	{
		Hashtable h = new Hashtable();

		public PlotOptionsXrangeOnPoint()
		{
			ConnectorOptions = ConnectorOptions_DefaultValue = new PlotOptionsXrangeOnPointConnectorOptions();
			Id = Id_DefaultValue = "";
			Position = Position_DefaultValue = new PlotOptionsXrangeOnPointPosition();
		...
		/// </summary>
		public PlotOptionsXrangeOnPointConnectorOptions ConnectorOptions { get; set; }
		private PlotOptionsXrangeOnPointConnectorOptions ConnectorOptions_DefaultValue { get; set; }
		...
		/// </summary>
		public PlotOptionsXrangeOnPointPosition Position { get; set; }
		private PlotOptionsXrangeOnPointPosition Position_DefaultValue { get; set; }
