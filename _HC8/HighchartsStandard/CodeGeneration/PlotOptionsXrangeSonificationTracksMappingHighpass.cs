...
{
	public partial class PlotOptionsXrangeSonificationTracksMappingHighpass  : BaseObject
	{
		...
		/// </summary>
		public PlotOptionsXrangeSonificationTracksMappingHighpassFrequency Frequency { get; set; }
		private PlotOptionsXrangeSonificationTracksMappingHighpassFrequency Frequency_DefaultValue { get; set; }
		 

		/// <summary>
		/// Map to filter resonance in dB. Can be negative to cause adip, or positive to cause a bump.
		/// </summary>
		public PlotOptionsXrangeSonificationTracksMappingHighpassResonance Resonance { get; set; }
		private PlotOptionsXrangeSonificationTracksMappingHighpassResonance Resonance_DefaultValue { get; set; }
