...
{
	public partial class PlotOptionsXrangeStatesHover  : PlotOptionsSeries
	{
		...
		public PlotOptionsXrangeStatesHover()
		{
			...
			Halo = Halo_DefaultValue = new PlotOptionsXrangeStatesHoverHalo();
			LineWidth = LineWidth_DefaultValue = null;
			LineWidthPlus = LineWidthPlus_DefaultValue = null;
			Marker = Marker_DefaultValue = new PlotOptionsXrangeStatesHoverMarker();
		...
		/// </summary>
		public PlotOptionsXrangeStatesHoverHalo Halo { get; set; }
		private PlotOptionsXrangeStatesHoverHalo Halo_DefaultValue { get; set; }
		...
		/// </summary>
		public PlotOptionsXrangeStatesHoverMarker Marker { get; set; }
		private PlotOptionsXrangeStatesHoverMarker Marker_DefaultValue { get; set; }
