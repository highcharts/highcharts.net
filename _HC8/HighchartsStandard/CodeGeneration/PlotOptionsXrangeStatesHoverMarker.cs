...
{
	public partial class PlotOptionsXrangeStatesHoverMarker  : PlotOptionsSeries
	{
		Hashtable h = new Hashtable();

		public PlotOptionsXrangeStatesHoverMarker()
		{
			...
			States = States_DefaultValue = new PlotOptionsXrangeStatesHoverMarkerStates();
		...
		/// </summary>
		public PlotOptionsXrangeStatesHoverMarkerStates States { get; set; }
		private PlotOptionsXrangeStatesHoverMarkerStates States_DefaultValue { get; set; }
