...
{
	public partial class PlotOptionsXrangeStatesSelect  : PlotOptionsSeries
	{
		Hashtable h = new Hashtable();

		public PlotOptionsXrangeStatesSelect()
		{
			Animation = Animation_DefaultValue = new Animation();
			Enabled = Enabled_DefaultValue = null;
			Halo = Halo_DefaultValue = new PlotOptionsXrangeStatesSelectHalo();
			LineWidth = LineWidth_DefaultValue = null;
			LineWidthPlus = LineWidthPlus_DefaultValue = null;
			Marker = Marker_DefaultValue = new PlotOptionsXrangeStatesSelectMarker();
		...
		/// </summary>
		public PlotOptionsXrangeStatesSelectHalo Halo { get; set; }
		private PlotOptionsXrangeStatesSelectHalo Halo_DefaultValue { get; set; }
		...
		/// </summary>
		public PlotOptionsXrangeStatesSelectMarker Marker { get; set; }
		private PlotOptionsXrangeStatesSelectMarker Marker_DefaultValue { get; set; }
