...
{
	public partial class PlotOptionsXrangeStatesSelectMarker  : PlotOptionsSeries
	{
		Hashtable h = new Hashtable();

		public PlotOptionsXrangeStatesSelectMarker()
		{
			...
			States = States_DefaultValue = new PlotOptionsXrangeStatesSelectMarkerStates();
		...
		/// </summary>
		public PlotOptionsXrangeStatesSelectMarkerStates States { get; set; }
		private PlotOptionsXrangeStatesSelectMarkerStates States_DefaultValue { get; set; }
