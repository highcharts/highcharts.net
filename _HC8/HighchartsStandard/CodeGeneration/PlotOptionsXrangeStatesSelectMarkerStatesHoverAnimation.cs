...
{
	public partial class PlotOptionsXrangeStatesSelectMarkerStatesHoverAnimation  : PlotOptionsSeries
	{
		Hashtable h = new Hashtable();

		public PlotOptionsXrangeStatesSelectMarkerStatesHoverAnimation()
		{
