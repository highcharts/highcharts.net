...
namespace Highsoft.Web.Mvc.Charts
{
	public partial class PolygonSeries  : Series
	{
		...
		internal override Hashtable ToHashtable()
		{
			...
			if (PointDescriptionFormatter != PointDescriptionFormatter_DefaultValue) { h.Add("pointDescriptionFormatter",PointDescriptionFormatter); Highcharts.AddFunction("8167f3a8-f399-434f-9f3f-ec7f5e265aae.pointDescriptionFormatter", PointDescriptionFormatter); }  
