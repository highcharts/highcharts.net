...
namespace Highsoft.Web.Mvc.Charts
{
	public partial class PolygonSeries  : Series
	{
		...
		internal override Hashtable ToHashtable()
		{
			...
			if (PointDescriptionFormatter != PointDescriptionFormatter_DefaultValue) { h.Add("pointDescriptionFormatter",PointDescriptionFormatter); Highcharts.AddFunction("a9f051c3-65eb-46e2-b2cb-4e49afc27215.pointDescriptionFormatter", PointDescriptionFormatter); }  
