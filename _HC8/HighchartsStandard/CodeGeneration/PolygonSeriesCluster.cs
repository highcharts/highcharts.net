...
{
	public partial class PolygonSeriesCluster  : BaseObject
	{
		Hashtable h = new Hashtable();

		public PolygonSeriesCluster()
		{
			AllowOverlap = AllowOverlap_DefaultValue = true;
			Animation = Animation_DefaultValue = new Animation();
			AnimationBool = AnimationBool_DefaultValue = null;
			DataLabels = DataLabels_DefaultValue = new PolygonSeriesClusterDataLabels();
			DrillToCluster = DrillToCluster_DefaultValue = true;
			Enabled = Enabled_DefaultValue = false;
			Events = Events_DefaultValue = new PolygonSeriesClusterEvents();
			LayoutAlgorithm = LayoutAlgorithm_DefaultValue = new PolygonSeriesClusterLayoutAlgorithm();
			Marker = Marker_DefaultValue = new PolygonSeriesClusterMarker();
		...
		/// </summary>
		public PolygonSeriesClusterDataLabels DataLabels { get; set; }
		private PolygonSeriesClusterDataLabels DataLabels_DefaultValue { get; set; }
		...
		/// 
		/// </summary>
		public PolygonSeriesClusterEvents Events { get; set; }
		private PolygonSeriesClusterEvents Events_DefaultValue { get; set; }
		 

		/// <summary>
		/// Options for layout algorithm. Inside thereare options to change the type of the algorithm, gridSize,distance or iterations.
		/// </summary>
		public PolygonSeriesClusterLayoutAlgorithm LayoutAlgorithm { get; set; }
		private PolygonSeriesClusterLayoutAlgorithm LayoutAlgorithm_DefaultValue { get; set; }
		 

		/// <summary>
		/// Options for the cluster marker.
		/// </summary>
		public PolygonSeriesClusterMarker Marker { get; set; }
		private PolygonSeriesClusterMarker Marker_DefaultValue { get; set; }
		...
		/// 
		/// </summary>
		public PolygonSeriesClusterStates States { get; set; }
		private PolygonSeriesClusterStates States_DefaultValue { get; set; }
