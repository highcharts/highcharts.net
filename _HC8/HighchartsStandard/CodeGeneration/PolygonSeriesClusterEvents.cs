...
namespace Highsoft.Web.Mvc.Charts
{
	public partial class PolygonSeriesClusterEvents  : BaseObject
	{
		...
		internal override Hashtable ToHashtable()
		{
			...
			if (DrillToCluster != DrillToCluster_DefaultValue) { h.Add("drillToCluster",DrillToCluster); Highcharts.AddFunction("315a8474-cbb3-4903-ba1b-8927bd0c7a0d.drillToCluster", DrillToCluster); }  
