...
{
	public partial class PolygonSeriesClusterZonesMarker  : BaseObject
	{
		Hashtable h = new Hashtable();

		public PolygonSeriesClusterZonesMarker()
		{
			...
			States = States_DefaultValue = new PolygonSeriesClusterZonesMarkerStates();
		...
		/// </summary>
		public PolygonSeriesClusterZonesMarkerStates States { get; set; }
		private PolygonSeriesClusterZonesMarkerStates States_DefaultValue { get; set; }
