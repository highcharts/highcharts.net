...
namespace Highsoft.Web.Mvc.Charts
{
	public partial class PolygonSeriesDataDragDropDragHandle  : BaseObject
	{
		...
		internal override Hashtable ToHashtable()
		{
			...
			if (PathFormatter != PathFormatter_DefaultValue) { h.Add("pathFormatter",PathFormatter); Highcharts.AddFunction("81850b2b-3f34-4c4a-bd24-4087bbb89521.pathFormatter", PathFormatter); }  
