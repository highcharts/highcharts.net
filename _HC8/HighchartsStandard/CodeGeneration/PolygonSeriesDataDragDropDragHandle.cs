...
namespace Highsoft.Web.Mvc.Charts
{
	public partial class PolygonSeriesDataDragDropDragHandle  : BaseObject
	{
		...
		internal override Hashtable ToHashtable()
		{
			...
			if (PathFormatter != PathFormatter_DefaultValue) { h.Add("pathFormatter",PathFormatter); Highcharts.AddFunction("531f6ff9-40f1-429e-b9e4-e2c816bd767d.pathFormatter", PathFormatter); }  
