...
{
	public partial class PolygonSeriesOnPoint  : BaseObject
	{
		Hashtable h = new Hashtable();

		public PolygonSeriesOnPoint()
		{
			ConnectorOptions = ConnectorOptions_DefaultValue = new PolygonSeriesOnPointConnectorOptions();
			Id = Id_DefaultValue = "";
			Position = Position_DefaultValue = new PolygonSeriesOnPointPosition();
		...
		/// </summary>
		public PolygonSeriesOnPointConnectorOptions ConnectorOptions { get; set; }
		private PolygonSeriesOnPointConnectorOptions ConnectorOptions_DefaultValue { get; set; }
		...
		/// </summary>
		public PolygonSeriesOnPointPosition Position { get; set; }
		private PolygonSeriesOnPointPosition Position_DefaultValue { get; set; }
