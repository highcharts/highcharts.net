...
{
	public partial class PolygonSeriesSonificationDefaultInstrumentOptions  : BaseObject
	{
		Hashtable h = new Hashtable();

		public PolygonSeriesSonificationDefaultInstrumentOptions()
		{
			ActiveWhen = ActiveWhen_DefaultValue = new PolygonSeriesSonificationDefaultInstrumentOptionsActiveWhen();
			Instrument = Instrument_DefaultValue = null;
			InstrumentString = InstrumentString_DefaultValue = "null";
			Mapping = Mapping_DefaultValue = new PolygonSeriesSonificationDefaultInstrumentOptionsMapping();
			MidiName = MidiName_DefaultValue = "";
			PointGrouping = PointGrouping_DefaultValue = new PolygonSeriesSonificationDefaultInstrumentOptionsPointGrouping();
			RoundToMusicalNotes = RoundToMusicalNotes_DefaultValue = true;
			ShowPlayMarker = ShowPlayMarker_DefaultValue = true;
			Type = Type_DefaultValue = PolygonSeriesSonificationDefaultInstrumentOptionsType.Instrument;
		...
		/// </summary>
		public PolygonSeriesSonificationDefaultInstrumentOptionsActiveWhen ActiveWhen { get; set; }
		private PolygonSeriesSonificationDefaultInstrumentOptionsActiveWhen ActiveWhen_DefaultValue { get; set; }
		...
		/// </summary>
		public PolygonSeriesSonificationDefaultInstrumentOptionsMapping Mapping { get; set; }
		private PolygonSeriesSonificationDefaultInstrumentOptionsMapping Mapping_DefaultValue { get; set; }
		...
		/// </summary>
		public PolygonSeriesSonificationDefaultInstrumentOptionsPointGrouping PointGrouping { get; set; }
		private PolygonSeriesSonificationDefaultInstrumentOptionsPointGrouping PointGrouping_DefaultValue { get; set; }
		...
		/// </summary>
		public PolygonSeriesSonificationDefaultInstrumentOptionsType Type { get; set; }
		private PolygonSeriesSonificationDefaultInstrumentOptionsType Type_DefaultValue { get; set; }
