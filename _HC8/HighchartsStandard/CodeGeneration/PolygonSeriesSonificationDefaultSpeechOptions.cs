...
{
	public partial class PolygonSeriesSonificationDefaultSpeechOptions  : BaseObject
	{
		Hashtable h = new Hashtable();

		public PolygonSeriesSonificationDefaultSpeechOptions()
		{
			ActiveWhen = ActiveWhen_DefaultValue = new PolygonSeriesSonificationDefaultSpeechOptionsActiveWhen();
			Language = Language_DefaultValue = "en-US";
			Mapping = Mapping_DefaultValue = new PolygonSeriesSonificationDefaultSpeechOptionsMapping();
			PointGrouping = PointGrouping_DefaultValue = new PolygonSeriesSonificationDefaultSpeechOptionsPointGrouping();
			PreferredVoice = PreferredVoice_DefaultValue = "";
			ShowPlayMarker = ShowPlayMarker_DefaultValue = true;
			Type = Type_DefaultValue = PolygonSeriesSonificationDefaultSpeechOptionsType.Instrument;
		...
		/// </summary>
		public PolygonSeriesSonificationDefaultSpeechOptionsActiveWhen ActiveWhen { get; set; }
		private PolygonSeriesSonificationDefaultSpeechOptionsActiveWhen ActiveWhen_DefaultValue { get; set; }
		...
		/// </summary>
		public PolygonSeriesSonificationDefaultSpeechOptionsMapping Mapping { get; set; }
		private PolygonSeriesSonificationDefaultSpeechOptionsMapping Mapping_DefaultValue { get; set; }
		 

		/// <summary>
		/// Options for point grouping, specifically for instrument tracks.
		/// </summary>
		public PolygonSeriesSonificationDefaultSpeechOptionsPointGrouping PointGrouping { get; set; }
		private PolygonSeriesSonificationDefaultSpeechOptionsPointGrouping PointGrouping_DefaultValue { get; set; }
		...
		/// </summary>
		public PolygonSeriesSonificationDefaultSpeechOptionsType Type { get; set; }
		private PolygonSeriesSonificationDefaultSpeechOptionsType Type_DefaultValue { get; set; }
