...
{
	public partial class PolygonSeriesStatesHover  : BaseObject
	{
		...
		public PolygonSeriesStatesHover()
		{
			...
			Halo = Halo_DefaultValue = new PolygonSeriesStatesHoverHalo();
			LineWidth = LineWidth_DefaultValue = null;
			LineWidthPlus = LineWidthPlus_DefaultValue = null;
			Marker = Marker_DefaultValue = new PolygonSeriesStatesHoverMarker();
		...
		/// </summary>
		public PolygonSeriesStatesHoverHalo Halo { get; set; }
		private PolygonSeriesStatesHoverHalo Halo_DefaultValue { get; set; }
		...
		/// </summary>
		public PolygonSeriesStatesHoverMarker Marker { get; set; }
		private PolygonSeriesStatesHoverMarker Marker_DefaultValue { get; set; }
