...
namespace Highsoft.Web.Mvc.Charts
{
	public partial class Pyramid3dSeries  : Series
	{
		...
		internal override Hashtable ToHashtable()
		{
			...
			if (PointDescriptionFormatter != PointDescriptionFormatter_DefaultValue) { h.Add("pointDescriptionFormatter",PointDescriptionFormatter); Highcharts.AddFunction("adbb6c9c-2872-48c4-b6e4-20936b9c3935.pointDescriptionFormatter", PointDescriptionFormatter); }  
