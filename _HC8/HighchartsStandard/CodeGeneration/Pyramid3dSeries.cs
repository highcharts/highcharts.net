...
namespace Highsoft.Web.Mvc.Charts
{
	public partial class Pyramid3dSeries  : Series
	{
		...
		public Pyramid3dSeries()
		{
			...
			Data = Data_DefaultValue = new List<object>();
			...
			Type = Type_DefaultValue = Pyramid3dSeriesType.Pyramid;
		...
		private List<object> Data_DefaultValue { get; set; }
		...
		/// </summary>
		public Pyramid3dSeriesType Type { get; set; }
		private Pyramid3dSeriesType Type_DefaultValue { get; set; }
		...
		internal override Hashtable ToHashtable()
		{
			...
			if (PointDescriptionFormatter != PointDescriptionFormatter_DefaultValue) { h.Add("pointDescriptionFormatter",PointDescriptionFormatter); Highcharts.AddFunction("baa121ce-62ee-49bc-b577-662a248cb13a.pointDescriptionFormatter", PointDescriptionFormatter); }  
