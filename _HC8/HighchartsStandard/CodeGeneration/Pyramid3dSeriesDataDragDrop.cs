...
{
	public partial class Pyramid3dSeriesDataDragDrop  : BaseObject
	{
		Hashtable h = new Hashtable();

		public Pyramid3dSeriesDataDragDrop()
		{
			DraggableX = DraggableX_DefaultValue = null;
			DraggableY = DraggableY_DefaultValue = null;
			DragHandle = DragHandle_DefaultValue = new Pyramid3dSeriesDataDragDropDragHandle();
			...
			GuideBox = GuideBox_DefaultValue = new Pyramid3dSeriesDataDragDropGuideBox();
		...
		/// </summary>
		public Pyramid3dSeriesDataDragDropDragHandle DragHandle { get; set; }
		private Pyramid3dSeriesDataDragDropDragHandle DragHandle_DefaultValue { get; set; }
		...
		/// </summary>
		public Pyramid3dSeriesDataDragDropGuideBox GuideBox { get; set; }
		private Pyramid3dSeriesDataDragDropGuideBox GuideBox_DefaultValue { get; set; }
