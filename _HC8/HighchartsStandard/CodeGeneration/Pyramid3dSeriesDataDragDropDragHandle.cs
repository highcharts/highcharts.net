...
{
	public partial class Pyramid3dSeriesDataDragDropDragHandle  : BaseObject
	{
		Hashtable h = new Hashtable();

		public Pyramid3dSeriesDataDragDropDragHandle()
		{
		...
		internal override Hashtable ToHashtable()
		{
			...
			if (PathFormatter != PathFormatter_DefaultValue) { h.Add("pathFormatter",PathFormatter); Highcharts.AddFunction("937b40b8-0e19-4bf7-a116-fed6387724aa.pathFormatter", PathFormatter); }  
