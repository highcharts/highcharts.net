...
namespace Highsoft.Web.Mvc.Charts
{
	public partial class Pyramid3dSeriesDataDragDropDragHandle  : BaseObject
	{
		...
		internal override Hashtable ToHashtable()
		{
			...
			if (PathFormatter != PathFormatter_DefaultValue) { h.Add("pathFormatter",PathFormatter); Highcharts.AddFunction("30bc2a0e-a4a6-4b5f-9b1c-8185cec30d7f.pathFormatter", PathFormatter); }  
