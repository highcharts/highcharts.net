...
namespace Highsoft.Web.Mvc.Charts
{
	public partial class Pyramid3dSeriesDataLabels  : BaseObject
	{
		...
		{
			Align = Align_DefaultValue = Pyramid3dSeriesDataLabelsAlign.Center;
			...
			Filter = Filter_DefaultValue = new Pyramid3dSeriesDataLabelsFilter();
			...
			Style = Style_DefaultValue = new Pyramid3dSeriesDataLabelsStyle();
			TextPath = TextPath_DefaultValue = new Pyramid3dSeriesDataLabelsTextPath();
			UseHTML = UseHTML_DefaultValue = false;
			VerticalAlign = VerticalAlign_DefaultValue = Pyramid3dSeriesDataLabelsVerticalAlign.Bottom;
			X = X_DefaultValue = 0;
			Y = Y_DefaultValue = 0;
			Z = Z_DefaultValue = 6;
		...
		/// </summary>
		public Pyramid3dSeriesDataLabelsAlign Align { get; set; }
		private Pyramid3dSeriesDataLabelsAlign Align_DefaultValue { get; set; }
		...
		/// </summary>
		public Pyramid3dSeriesDataLabelsFilter Filter { get; set; }
		private Pyramid3dSeriesDataLabelsFilter Filter_DefaultValue { get; set; }
		...
		/// </summary>
		public Pyramid3dSeriesDataLabelsStyle Style { get; set; }
		private Pyramid3dSeriesDataLabelsStyle Style_DefaultValue { get; set; }
		...
		/// </summary>
		public Pyramid3dSeriesDataLabelsTextPath TextPath { get; set; }
		private Pyramid3dSeriesDataLabelsTextPath TextPath_DefaultValue { get; set; }
		...
		internal override Hashtable ToHashtable()
		{
			...
			if (Formatter != Formatter_DefaultValue) { h.Add("formatter",Formatter); Highcharts.AddFunction("d3aa0d4e-0526-45cb-b83d-b3e7e09d1404.formatter", Formatter); }  
			if (Inside != Inside_DefaultValue) h.Add("inside",Inside);
			if (NullFormat != NullFormat_DefaultValue) h.Add("nullFormat",NullFormat);
			if (NullFormatter != NullFormatter_DefaultValue) { h.Add("nullFormatter",NullFormatter); Highcharts.AddFunction("18d7a861-06cc-4cb1-b7a8-d74c55904df4.nullFormatter", NullFormatter); }  
