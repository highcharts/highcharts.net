...
{
	public partial class Pyramid3dSeriesDataMarker  : BaseObject
	{
		Hashtable h = new Hashtable();

		public Pyramid3dSeriesDataMarker()
		{
			...
			States = States_DefaultValue = new Pyramid3dSeriesDataMarkerStates();
		...
		/// </summary>
		public Pyramid3dSeriesDataMarkerStates States { get; set; }
		private Pyramid3dSeriesDataMarkerStates States_DefaultValue { get; set; }
