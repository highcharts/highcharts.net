...
namespace Highsoft.Web.Mvc.Charts
{
	public partial class Pyramid3dSeriesDragDropDragHandle  : BaseObject
	{
		...
		internal override Hashtable ToHashtable()
		{
			...
			if (PathFormatter != PathFormatter_DefaultValue) { h.Add("pathFormatter",PathFormatter); Highcharts.AddFunction("efc8ab2c-a1ca-469c-b783-450d8306c293.pathFormatter", PathFormatter); }  
