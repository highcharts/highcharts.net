...
namespace Highsoft.Web.Mvc.Charts
{
	public partial class Pyramid3dSeriesDragDropDragHandle  : BaseObject
	{
		...
		internal override Hashtable ToHashtable()
		{
			...
			if (PathFormatter != PathFormatter_DefaultValue) { h.Add("pathFormatter",PathFormatter); Highcharts.AddFunction("1cd56684-10e1-493d-bee1-fe0825faac45.pathFormatter", PathFormatter); }  
