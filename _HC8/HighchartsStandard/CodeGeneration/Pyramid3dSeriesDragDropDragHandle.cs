...
namespace Highsoft.Web.Mvc.Charts
{
	public partial class Pyramid3dSeriesDragDropDragHandle  : BaseObject
	{
		...
		internal override Hashtable ToHashtable()
		{
			...
			if (PathFormatter != PathFormatter_DefaultValue) { h.Add("pathFormatter",PathFormatter); Highcharts.AddFunction("93fc2a0e-509d-42ed-9520-d53f827bef6f.pathFormatter", PathFormatter); }  
