...
{
	public partial class Pyramid3dSeriesLabel  : BaseObject
	{
		Hashtable h = new Hashtable();

		public Pyramid3dSeriesLabel()
		{
			...
			Style = Style_DefaultValue = new Pyramid3dSeriesLabelStyle();
		...
		/// </summary>
		public Pyramid3dSeriesLabelStyle Style { get; set; }
		private Pyramid3dSeriesLabelStyle Style_DefaultValue { get; set; }
		...
		internal override Hashtable ToHashtable()
		{
			...
			if (Formatter != Formatter_DefaultValue) { h.Add("formatter",Formatter); Highcharts.AddFunction("f5aaad20-7b49-4972-8b60-ee280387afe5.formatter", Formatter); }  
