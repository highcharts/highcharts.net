...
{
	public partial class Pyramid3dSeriesOnPoint  : BaseObject
	{
		Hashtable h = new Hashtable();

		public Pyramid3dSeriesOnPoint()
		{
			ConnectorOptions = ConnectorOptions_DefaultValue = new Pyramid3dSeriesOnPointConnectorOptions();
			Id = Id_DefaultValue = "";
			Position = Position_DefaultValue = new Pyramid3dSeriesOnPointPosition();
		...
		/// </summary>
		public Pyramid3dSeriesOnPointConnectorOptions ConnectorOptions { get; set; }
		private Pyramid3dSeriesOnPointConnectorOptions ConnectorOptions_DefaultValue { get; set; }
		...
		/// </summary>
		public Pyramid3dSeriesOnPointPosition Position { get; set; }
		private Pyramid3dSeriesOnPointPosition Position_DefaultValue { get; set; }
