...
{
	public partial class Pyramid3dSeriesStatesHover  : BaseObject
	{
		Hashtable h = new Hashtable();

		public Pyramid3dSeriesStatesHover()
		{
			Animation = Animation_DefaultValue = new Animation() { Enabled = true };
			Enabled = Enabled_DefaultValue = new Hashtable();
			Halo = Halo_DefaultValue = new Pyramid3dSeriesStatesHoverHalo();
			LineWidth = LineWidth_DefaultValue = new Hashtable();
			LineWidthPlus = LineWidthPlus_DefaultValue = new Hashtable();
			Marker = Marker_DefaultValue = new Pyramid3dSeriesStatesHoverMarker();
		...
		/// </summary>
		public Pyramid3dSeriesStatesHoverHalo Halo { get; set; }
		private Pyramid3dSeriesStatesHoverHalo Halo_DefaultValue { get; set; }
		...
		/// </summary>
		public Pyramid3dSeriesStatesHoverMarker Marker { get; set; }
		private Pyramid3dSeriesStatesHoverMarker Marker_DefaultValue { get; set; }
