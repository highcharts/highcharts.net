...
{
	public partial class Pyramid3dSeriesStatesSelectMarker  : BaseObject
	{
		Hashtable h = new Hashtable();

		public Pyramid3dSeriesStatesSelectMarker()
		{
			...
			States = States_DefaultValue = new Pyramid3dSeriesStatesSelectMarkerStates();
		...
		/// </summary>
		public Pyramid3dSeriesStatesSelectMarkerStates States { get; set; }
		private Pyramid3dSeriesStatesSelectMarkerStates States_DefaultValue { get; set; }
