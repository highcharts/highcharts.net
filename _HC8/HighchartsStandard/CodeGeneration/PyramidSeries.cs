...
namespace Highsoft.Web.Mvc.Charts
{
	public partial class PyramidSeries  : Series
	{
		...
		internal override Hashtable ToHashtable()
		{
			...
			if (PointDescriptionFormatter != PointDescriptionFormatter_DefaultValue) { h.Add("pointDescriptionFormatter",PointDescriptionFormatter); Highcharts.AddFunction("37f2d256-7d63-45c6-aba8-7ad51300943f.pointDescriptionFormatter", PointDescriptionFormatter); }  
