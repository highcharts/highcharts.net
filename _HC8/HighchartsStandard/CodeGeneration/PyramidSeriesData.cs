...
{
	public partial class PyramidSeriesData  : BaseObject
	{
		Hashtable h = new Hashtable();

		public PyramidSeriesData()
		{
			Accessibility = Accessibility_DefaultValue = new PyramidSeriesDataAccessibility();
			...
			DragDrop = DragDrop_DefaultValue = new PyramidSeriesDataDragDrop();
			Drilldown = Drilldown_DefaultValue = "";
			Events = Events_DefaultValue = new PyramidSeriesDataEvents();
			Id = Id_DefaultValue = "";
			Labelrank = Labelrank_DefaultValue = null;
			LegendIndex = LegendIndex_DefaultValue = null;
			Marker = Marker_DefaultValue = new PyramidSeriesDataMarker();
		...
		/// </summary>
		public PyramidSeriesDataAccessibility Accessibility { get; set; }
		private PyramidSeriesDataAccessibility Accessibility_DefaultValue { get; set; }
		...
		/// </summary>
		public PyramidSeriesDataDragDrop DragDrop { get; set; }
		private PyramidSeriesDataDragDrop DragDrop_DefaultValue { get; set; }
		...
		/// </summary>
		public PyramidSeriesDataMarker Marker { get; set; }
		private PyramidSeriesDataMarker Marker_DefaultValue { get; set; }
