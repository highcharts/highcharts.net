...
{
	public partial class PyramidSeriesDataMarker  : BaseObject
	{
		Hashtable h = new Hashtable();

		public PyramidSeriesDataMarker()
		{
			...
			States = States_DefaultValue = new PyramidSeriesDataMarkerStates();
		...
		/// </summary>
		public PyramidSeriesDataMarkerStates States { get; set; }
		private PyramidSeriesDataMarkerStates States_DefaultValue { get; set; }
