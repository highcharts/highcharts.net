...
namespace Highsoft.Web.Mvc.Charts
{
	public partial class PyramidSeriesDragDropDragHandle  : BaseObject
	{
		...
		internal override Hashtable ToHashtable()
		{
			...
			if (PathFormatter != PathFormatter_DefaultValue) { h.Add("pathFormatter",PathFormatter); Highcharts.AddFunction("c87eb119-cd52-48b3-927b-f85596eeb3d9.pathFormatter", PathFormatter); }  
