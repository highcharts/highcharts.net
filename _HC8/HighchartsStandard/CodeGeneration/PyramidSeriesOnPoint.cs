...
{
	public partial class PyramidSeriesOnPoint  : BaseObject
	{
		Hashtable h = new Hashtable();

		public PyramidSeriesOnPoint()
		{
			ConnectorOptions = ConnectorOptions_DefaultValue = new PyramidSeriesOnPointConnectorOptions();
			Id = Id_DefaultValue = "";
			Position = Position_DefaultValue = new PyramidSeriesOnPointPosition();
		...
		/// </summary>
		public PyramidSeriesOnPointConnectorOptions ConnectorOptions { get; set; }
		private PyramidSeriesOnPointConnectorOptions ConnectorOptions_DefaultValue { get; set; }
		...
		/// </summary>
		public PyramidSeriesOnPointPosition Position { get; set; }
		private PyramidSeriesOnPointPosition Position_DefaultValue { get; set; }
