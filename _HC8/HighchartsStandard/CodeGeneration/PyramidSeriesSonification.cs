...
{
	public partial class PyramidSeriesSonification  : BaseObject
	{
		Hashtable h = new Hashtable();

		public PyramidSeriesSonification()
		{
			ContextTracks = ContextTracks_DefaultValue = new PyramidSeriesSonificationContextTracks();
			DefaultInstrumentOptions = DefaultInstrumentOptions_DefaultValue = new PyramidSeriesSonificationDefaultInstrumentOptions();
			DefaultSpeechOptions = DefaultSpeechOptions_DefaultValue = new PyramidSeriesSonificationDefaultSpeechOptions();
			Enabled = Enabled_DefaultValue = true;
			PointGrouping = PointGrouping_DefaultValue = new PyramidSeriesSonificationPointGrouping();
			Tracks = Tracks_DefaultValue = new PyramidSeriesSonificationTracks();
