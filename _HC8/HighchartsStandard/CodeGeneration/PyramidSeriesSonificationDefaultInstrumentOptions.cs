...
{
	public partial class PyramidSeriesSonificationDefaultInstrumentOptions  : BaseObject
	{
		Hashtable h = new Hashtable();

		public PyramidSeriesSonificationDefaultInstrumentOptions()
		{
			ActiveWhen = ActiveWhen_DefaultValue = new PyramidSeriesSonificationDefaultInstrumentOptionsActiveWhen();
			Instrument = Instrument_DefaultValue = null;
			InstrumentString = InstrumentString_DefaultValue = "null";
			Mapping = Mapping_DefaultValue = new PyramidSeriesSonificationDefaultInstrumentOptionsMapping();
			MidiName = MidiName_DefaultValue = "";
			PointGrouping = PointGrouping_DefaultValue = new PyramidSeriesSonificationDefaultInstrumentOptionsPointGrouping();
			RoundToMusicalNotes = RoundToMusicalNotes_DefaultValue = true;
			ShowPlayMarker = ShowPlayMarker_DefaultValue = true;
			Type = Type_DefaultValue = PyramidSeriesSonificationDefaultInstrumentOptionsType.Instrument;
		...
		/// </summary>
		public PyramidSeriesSonificationDefaultInstrumentOptionsActiveWhen ActiveWhen { get; set; }
		private PyramidSeriesSonificationDefaultInstrumentOptionsActiveWhen ActiveWhen_DefaultValue { get; set; }
		...
		/// </summary>
		public PyramidSeriesSonificationDefaultInstrumentOptionsMapping Mapping { get; set; }
		private PyramidSeriesSonificationDefaultInstrumentOptionsMapping Mapping_DefaultValue { get; set; }
		...
		/// </summary>
		public PyramidSeriesSonificationDefaultInstrumentOptionsPointGrouping PointGrouping { get; set; }
		private PyramidSeriesSonificationDefaultInstrumentOptionsPointGrouping PointGrouping_DefaultValue { get; set; }
		...
		/// </summary>
		public PyramidSeriesSonificationDefaultInstrumentOptionsType Type { get; set; }
		private PyramidSeriesSonificationDefaultInstrumentOptionsType Type_DefaultValue { get; set; }
