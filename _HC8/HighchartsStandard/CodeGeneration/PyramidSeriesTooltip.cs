...
namespace Highsoft.Web.Mvc.Charts
{
	public partial class PyramidSeriesTooltip  : BaseObject
	{
		...
		internal override Hashtable ToHashtable()
		{
			...
			if (NullFormatter != NullFormatter_DefaultValue) { h.Add("nullFormatter",NullFormatter); Highcharts.AddFunction("36dfc6d7-df08-494a-a7ce-c1fabd989b8f.nullFormatter", NullFormatter); }  
			if (PointFormat != PointFormat_DefaultValue) h.Add("pointFormat",PointFormat);
			if (PointFormatter != PointFormatter_DefaultValue) { h.Add("pointFormatter",PointFormatter); Highcharts.AddFunction("4cd3ef82-57a6-4a82-b707-6fa2160eef5c.pointFormatter", PointFormatter); }  
