...
namespace Highsoft.Web.Mvc.Charts
{
	public partial class SankeySeriesData  : BaseObject
	{
		...
		public SankeySeriesData()
		{
			...
			Marker = Marker_DefaultValue = new SankeySeriesDataMarker();
		...
		/// </summary>
		public SankeySeriesDataMarker Marker { get; set; }
		private SankeySeriesDataMarker Marker_DefaultValue { get; set; }
