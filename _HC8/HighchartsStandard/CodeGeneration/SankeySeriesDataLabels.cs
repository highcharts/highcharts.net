...
namespace Highsoft.Web.Mvc.Charts
{
	public partial class SankeySeriesDataLabels  : BaseObject
	{
		...
		{
			Align = Align_DefaultValue = SankeySeriesDataLabelsAlign.Center;
			...
			Filter = Filter_DefaultValue = new SankeySeriesDataLabelsFilter();
			...
			Style = Style_DefaultValue = new SankeySeriesDataLabelsStyle();
			TextPath = TextPath_DefaultValue = new SankeySeriesDataLabelsTextPath();
			UseHTML = UseHTML_DefaultValue = false;
			VerticalAlign = VerticalAlign_DefaultValue = SankeySeriesDataLabelsVerticalAlign.Bottom;
			X = X_DefaultValue = 0;
			Y = Y_DefaultValue = 0;
			Z = Z_DefaultValue = 6;
		...
		/// </summary>
		public SankeySeriesDataLabelsAlign Align { get; set; }
		private SankeySeriesDataLabelsAlign Align_DefaultValue { get; set; }
		...
		/// </summary>
		public SankeySeriesDataLabelsFilter Filter { get; set; }
		private SankeySeriesDataLabelsFilter Filter_DefaultValue { get; set; }
		...
		/// </summary>
		public SankeySeriesDataLabelsStyle Style { get; set; }
		private SankeySeriesDataLabelsStyle Style_DefaultValue { get; set; }
		...
		/// </summary>
		public SankeySeriesDataLabelsTextPath TextPath { get; set; }
		private SankeySeriesDataLabelsTextPath TextPath_DefaultValue { get; set; }
		...
		/// </summary>
		public SankeySeriesDataLabelsVerticalAlign VerticalAlign { get; set; }
		private SankeySeriesDataLabelsVerticalAlign VerticalAlign_DefaultValue { get; set; }
		...
		internal override Hashtable ToHashtable()
		{
			...
			if (Formatter != Formatter_DefaultValue) { h.Add("formatter",Formatter); Highcharts.AddFunction("ce2d8dbc-2087-40cf-992f-024a33885b91.formatter", Formatter); }  
			...
			if (NullFormatter != NullFormatter_DefaultValue) { h.Add("nullFormatter",NullFormatter); Highcharts.AddFunction("2ea6bdd4-2576-4733-94c3-e554e18e6f96.nullFormatter", NullFormatter); }  
