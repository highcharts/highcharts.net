...
{
	public partial class SankeySeriesDataMarker  : BaseObject
	{
		Hashtable h = new Hashtable();

		public SankeySeriesDataMarker()
		{
			...
			States = States_DefaultValue = new SankeySeriesDataMarkerStates();
		...
		/// </summary>
		public SankeySeriesDataMarkerStates States { get; set; }
		private SankeySeriesDataMarkerStates States_DefaultValue { get; set; }
