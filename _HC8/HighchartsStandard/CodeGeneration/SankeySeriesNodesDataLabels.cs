...
namespace Highsoft.Web.Mvc.Charts
{
	public partial class SankeySeriesNodesDataLabels  : BaseObject
	{
		...
		internal override Hashtable ToHashtable()
		{
			...
			if (Formatter != Formatter_DefaultValue) { h.Add("formatter",Formatter); Highcharts.AddFunction("3ed6a887-6e32-4e35-b6e1-4cc1bdd9faa6.formatter", Formatter); }  
			if (Inside != Inside_DefaultValue) h.Add("inside",Inside);
			if (NodeFormat != NodeFormat_DefaultValue) h.Add("nodeFormat",NodeFormat);
			if (NodeFormatter != NodeFormatter_DefaultValue) { h.Add("nodeFormatter",NodeFormatter); Highcharts.AddFunction("bac8f447-cd0b-4861-86de-83d14ec64770.nodeFormatter", NodeFormatter); }  
