...
{
	public partial class SankeySeriesOnPoint  : BaseObject
	{
		Hashtable h = new Hashtable();

		public SankeySeriesOnPoint()
		{
			ConnectorOptions = ConnectorOptions_DefaultValue = new SankeySeriesOnPointConnectorOptions();
			Id = Id_DefaultValue = "";
			Position = Position_DefaultValue = new SankeySeriesOnPointPosition();
		...
		/// </summary>
		public SankeySeriesOnPointConnectorOptions ConnectorOptions { get; set; }
		private SankeySeriesOnPointConnectorOptions ConnectorOptions_DefaultValue { get; set; }
		...
		/// </summary>
		public SankeySeriesOnPointPosition Position { get; set; }
		private SankeySeriesOnPointPosition Position_DefaultValue { get; set; }
