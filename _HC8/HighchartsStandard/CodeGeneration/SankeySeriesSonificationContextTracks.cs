...
{
	public partial class SankeySeriesSonificationContextTracks  : BaseObject
	{
		Hashtable h = new Hashtable();

		public SankeySeriesSonificationContextTracks()
		{
			ActiveWhen = ActiveWhen_DefaultValue = new SankeySeriesSonificationContextTracksActiveWhen();
			Instrument = Instrument_DefaultValue = null;
			InstrumentString = InstrumentString_DefaultValue = "null";
			Mapping = Mapping_DefaultValue = new SankeySeriesSonificationContextTracksMapping();
			MidiName = MidiName_DefaultValue = "";
			PointGrouping = PointGrouping_DefaultValue = new SankeySeriesSonificationContextTracksPointGrouping();
			...
			Type = Type_DefaultValue = SankeySeriesSonificationContextTracksType.Instrument;
			ValueInterval = ValueInterval_DefaultValue = null;
			ValueMapFunction = ValueMapFunction_DefaultValue = SankeySeriesSonificationContextTracksValueMapFunction.Linear;
		...
		/// </summary>
		public SankeySeriesSonificationContextTracksActiveWhen ActiveWhen { get; set; }
		private SankeySeriesSonificationContextTracksActiveWhen ActiveWhen_DefaultValue { get; set; }
		...
		/// </summary>
		public SankeySeriesSonificationContextTracksMapping Mapping { get; set; }
		private SankeySeriesSonificationContextTracksMapping Mapping_DefaultValue { get; set; }
		...
		/// </summary>
		public SankeySeriesSonificationContextTracksPointGrouping PointGrouping { get; set; }
		private SankeySeriesSonificationContextTracksPointGrouping PointGrouping_DefaultValue { get; set; }
		...
		/// </summary>
		public SankeySeriesSonificationContextTracksType Type { get; set; }
		private SankeySeriesSonificationContextTracksType Type_DefaultValue { get; set; }
		...
		/// </summary>
		public SankeySeriesSonificationContextTracksValueMapFunction ValueMapFunction { get; set; }
		private SankeySeriesSonificationContextTracksValueMapFunction ValueMapFunction_DefaultValue { get; set; }
