...
{
	public partial class SankeySeriesStatesSelectMarker  : BaseObject
	{
		Hashtable h = new Hashtable();

		public SankeySeriesStatesSelectMarker()
		{
			...
			States = States_DefaultValue = new SankeySeriesStatesSelectMarkerStates();
		...
		/// </summary>
		public SankeySeriesStatesSelectMarkerStates States { get; set; }
		private SankeySeriesStatesSelectMarkerStates States_DefaultValue { get; set; }
