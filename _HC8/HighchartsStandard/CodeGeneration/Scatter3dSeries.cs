...
{
	public partial class Scatter3dSeries  : Series
	{
		Hashtable h = new Hashtable();

		public Scatter3dSeries()
		{
			Accessibility = Accessibility_DefaultValue = new Scatter3dSeriesAccessibility();
			AllowPointSelect = AllowPointSelect_DefaultValue = false;
			Animation = Animation_DefaultValue = new Animation() { Enabled = true };
			AnimationLimit = AnimationLimit_DefaultValue = null;
			BoostBlending = BoostBlending_DefaultValue = Scatter3dSeriesBoostBlending.Undefined;
			BoostThreshold = BoostThreshold_DefaultValue = 5000;
			ClassName = ClassName_DefaultValue = "";
			Clip = Clip_DefaultValue = true;
			Cluster = Cluster_DefaultValue = new Scatter3dSeriesCluster();
			...
			Cursor = Cursor_DefaultValue = Scatter3dSeriesCursor.Null;
			DashStyle = DashStyle_DefaultValue = Scatter3dSeriesDashStyle.Solid;
			Data = Data_DefaultValue = new List<Scatter3dSeriesData>();
			DataLabels = DataLabels_DefaultValue = new Scatter3dSeriesDataLabels();
			DataSorting = DataSorting_DefaultValue = new Scatter3dSeriesDataSorting();
			Description = Description_DefaultValue = "";
			DragDrop = DragDrop_DefaultValue = new Scatter3dSeriesDragDrop();
			EnableMouseTracking = EnableMouseTracking_DefaultValue = true;
			Events = Events_DefaultValue = new Scatter3dSeriesEvents();
			FindNearestPointBy = FindNearestPointBy_DefaultValue = Scatter3dSeriesFindNearestPointBy.X;
			GetExtremesFromAll = GetExtremesFromAll_DefaultValue = false;
			Id = Id_DefaultValue = "";
			IncludeInDataExport = IncludeInDataExport_DefaultValue = null;
			Index = Index_DefaultValue = null;
			Jitter = Jitter_DefaultValue = new Scatter3dSeriesJitter();
			Keys = Keys_DefaultValue = new List<string>();
			Label = Label_DefaultValue = new Scatter3dSeriesLabel();
			LegendIndex = LegendIndex_DefaultValue = null;
			Linecap = Linecap_DefaultValue = Scatter3dSeriesLinecap.Round;
			LineWidth = LineWidth_DefaultValue = 2;
			LinkedTo = LinkedTo_DefaultValue = "";
			Marker = Marker_DefaultValue = new Scatter3dSeriesMarker();
			Name = Name_DefaultValue = "";
			NegativeColor = NegativeColor_DefaultValue = "";
			Opacity = Opacity_DefaultValue = 1;
			Point = Point_DefaultValue = new Scatter3dSeriesPoint();
			PointDescriptionFormatter = PointDescriptionFormatter_DefaultValue = "";
			PointInterval = PointInterval_DefaultValue = 1;
			PointIntervalUnit = PointIntervalUnit_DefaultValue = Scatter3dSeriesPointIntervalUnit.Null;
			...
			Stacking = Stacking_DefaultValue = Scatter3dSeriesStacking.Null;
			States = States_DefaultValue = new Scatter3dSeriesStates();
			Step = Step_DefaultValue = Scatter3dSeriesStep.Null;
			StickyTracking = StickyTracking_DefaultValue = true;
			Threshold = Threshold_DefaultValue = 0;
			Tooltip = Tooltip_DefaultValue = new Scatter3dSeriesTooltip();
			TurboThreshold = TurboThreshold_DefaultValue = 1000;
			Type = Type_DefaultValue = Scatter3dSeriesType.Scatter3d;
			Visible = Visible_DefaultValue = true;
			XAxis = XAxis_DefaultValue = "";
			YAxis = YAxis_DefaultValue = "";
			ZIndex = ZIndex_DefaultValue = null;
			ZoneAxis = ZoneAxis_DefaultValue = "y";
			Zones = Zones_DefaultValue = new List<Scatter3dSeriesZone>();
		...
		/// </summary>
		public Scatter3dSeriesAccessibility Accessibility { get; set; }
		private Scatter3dSeriesAccessibility Accessibility_DefaultValue { get; set; }
		...
		/// </summary>
		public Scatter3dSeriesBoostBlending BoostBlending { get; set; }
		private Scatter3dSeriesBoostBlending BoostBlending_DefaultValue { get; set; }
		...
		/// </summary>
		public Scatter3dSeriesCluster Cluster { get; set; }
		private Scatter3dSeriesCluster Cluster_DefaultValue { get; set; }
		...
		/// </summary>
		public Scatter3dSeriesCursor Cursor { get; set; }
		private Scatter3dSeriesCursor Cursor_DefaultValue { get; set; }
		...
		/// </summary>
		public Scatter3dSeriesDashStyle DashStyle { get; set; }
		private Scatter3dSeriesDashStyle DashStyle_DefaultValue { get; set; }
		 

		/// <summary>
		/// An array of data points for the series. For the `scatter3d` seriestype, points can be given in the following ways:1.  An array of arrays with 3 values. In this case, the values correspondto `x,y,z`. If the first value is a string, it is applied as the nameof the point, and the `x` value is inferred. ```js    data: [        [0, 0, 1],        [1, 8, 7],        [2, 9, 2]    ] ```3.  An array of objects with named values. The following snippet shows only afew settings, see the complete options set below. If the total number of datapoints exceeds the series'[turboThreshold](#series.scatter3d.turboThreshold), this option is notavailable. ```js    data: [{        x: 1,        y: 2,        z: 24,        name: "Point2",        color: "#00FF00"    }, {        x: 1,        y: 4,        z: 12,        name: "Point1",        color: "#FF00FF"    }] ```
		/// </summary>
		...
		/// </summary>
		public Scatter3dSeriesDataSorting DataSorting { get; set; }
		private Scatter3dSeriesDataSorting DataSorting_DefaultValue { get; set; }
		...
		/// </summary>
		public Scatter3dSeriesDragDrop DragDrop { get; set; }
		private Scatter3dSeriesDragDrop DragDrop_DefaultValue { get; set; }
		...
		/// </summary>
		public Scatter3dSeriesEvents Events { get; set; }
		private Scatter3dSeriesEvents Events_DefaultValue { get; set; }
		...
		/// </summary>
		public Scatter3dSeriesFindNearestPointBy FindNearestPointBy { get; set; }
		private Scatter3dSeriesFindNearestPointBy FindNearestPointBy_DefaultValue { get; set; }
		...
		/// </summary>
		public Scatter3dSeriesJitter Jitter { get; set; }
		private Scatter3dSeriesJitter Jitter_DefaultValue { get; set; }
		...
		/// </summary>
		public Scatter3dSeriesLabel Label { get; set; }
		private Scatter3dSeriesLabel Label_DefaultValue { get; set; }
		...
		/// </summary>
		public Scatter3dSeriesLinecap Linecap { get; set; }
		private Scatter3dSeriesLinecap Linecap_DefaultValue { get; set; }
		...
		/// </summary>
		public Scatter3dSeriesMarker Marker { get; set; }
		private Scatter3dSeriesMarker Marker_DefaultValue { get; set; }
		...
		/// </summary>
		public Scatter3dSeriesPoint Point { get; set; }
		private Scatter3dSeriesPoint Point_DefaultValue { get; set; }
		...
		/// </summary>
		public Scatter3dSeriesPointIntervalUnit PointIntervalUnit { get; set; }
		private Scatter3dSeriesPointIntervalUnit PointIntervalUnit_DefaultValue { get; set; }
		...
		/// </summary>
		public Scatter3dSeriesStacking Stacking { get; set; }
		private Scatter3dSeriesStacking Stacking_DefaultValue { get; set; }
		 

		/// <summary>
		/// 
		/// </summary>
		public Scatter3dSeriesStates States { get; set; }
		private Scatter3dSeriesStates States_DefaultValue { get; set; }
		 

		/// <summary>
		/// Whether to apply steps to the line. Possible values are `left`,`center` and `right`.
		/// </summary>
		public Scatter3dSeriesStep Step { get; set; }
		private Scatter3dSeriesStep Step_DefaultValue { get; set; }
		...
		/// </summary>
		public Scatter3dSeriesTooltip Tooltip { get; set; }
		private Scatter3dSeriesTooltip Tooltip_DefaultValue { get; set; }
		...
		/// </summary>
		public Scatter3dSeriesType Type { get; set; }
		private Scatter3dSeriesType Type_DefaultValue { get; set; }
		...
		/// </summary>
		public List<Scatter3dSeriesZone> Zones { get; set; }
		private List<Scatter3dSeriesZone> Zones_DefaultValue { get; set; }
		...
		internal override Hashtable ToHashtable()
		{
			...
			if (PointDescriptionFormatter != PointDescriptionFormatter_DefaultValue) { h.Add("pointDescriptionFormatter",PointDescriptionFormatter); Highcharts.AddFunction("5a8b4452-b7fc-43c1-abd9-29483116cc75.pointDescriptionFormatter", PointDescriptionFormatter); }  
