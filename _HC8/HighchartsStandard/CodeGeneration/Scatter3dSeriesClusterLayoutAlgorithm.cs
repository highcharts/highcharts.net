...
{
	public partial class Scatter3dSeriesClusterLayoutAlgorithm  : BaseObject
	{
		Hashtable h = new Hashtable();

		public Scatter3dSeriesClusterLayoutAlgorithm()
		{
		...
		internal override Hashtable ToHashtable()
		{
			...
			h.Add("type","scatter3dclusterlayoutalgorithm");
