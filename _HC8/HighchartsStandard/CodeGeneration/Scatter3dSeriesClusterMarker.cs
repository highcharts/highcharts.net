...
{
	public partial class Scatter3dSeriesClusterMarker  : BaseObject
	{
		Hashtable h = new Hashtable();

		public Scatter3dSeriesClusterMarker()
		{
			...
			States = States_DefaultValue = new Scatter3dSeriesClusterMarkerStates();
		...
		/// </summary>
		public Scatter3dSeriesClusterMarkerStates States { get; set; }
		private Scatter3dSeriesClusterMarkerStates States_DefaultValue { get; set; }
