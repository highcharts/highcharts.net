...
{
	public partial class Scatter3dSeriesClusterZonesMarker  : BaseObject
	{
		Hashtable h = new Hashtable();

		public Scatter3dSeriesClusterZonesMarker()
		{
			...
			States = States_DefaultValue = new Scatter3dSeriesClusterZonesMarkerStates();
		...
		/// </summary>
		public Scatter3dSeriesClusterZonesMarkerStates States { get; set; }
		private Scatter3dSeriesClusterZonesMarkerStates States_DefaultValue { get; set; }
