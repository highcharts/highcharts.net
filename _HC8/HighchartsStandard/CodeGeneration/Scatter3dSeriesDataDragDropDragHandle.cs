...
namespace Highsoft.Web.Mvc.Charts
{
	public partial class Scatter3dSeriesDataDragDropDragHandle  : BaseObject
	{
		...
		internal override Hashtable ToHashtable()
		{
			...
			if (PathFormatter != PathFormatter_DefaultValue) { h.Add("pathFormatter",PathFormatter); Highcharts.AddFunction("7409241f-3ad6-4738-a18d-4762d7660d6d.pathFormatter", PathFormatter); }  
