...
namespace Highsoft.Web.Mvc.Charts
{
	public partial class Scatter3dSeriesDataDragDropDragHandle  : BaseObject
	{
		...
		internal override Hashtable ToHashtable()
		{
			...
			if (PathFormatter != PathFormatter_DefaultValue) { h.Add("pathFormatter",PathFormatter); Highcharts.AddFunction("7ab5a783-3446-4e80-b4c3-af76bb9a5dd5.pathFormatter", PathFormatter); }  
