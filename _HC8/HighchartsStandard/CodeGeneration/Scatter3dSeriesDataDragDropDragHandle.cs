...
namespace Highsoft.Web.Mvc.Charts
{
	public partial class Scatter3dSeriesDataDragDropDragHandle  : BaseObject
	{
		...
		internal override Hashtable ToHashtable()
		{
			...
			if (PathFormatter != PathFormatter_DefaultValue) { h.Add("pathFormatter",PathFormatter); Highcharts.AddFunction("75dce7aa-2480-49bb-8b58-92f23e6c6c68.pathFormatter", PathFormatter); }  
