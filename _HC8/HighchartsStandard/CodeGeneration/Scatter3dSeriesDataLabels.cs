...
namespace Highsoft.Web.Mvc.Charts
{
	public partial class Scatter3dSeriesDataLabels  : BaseObject
	{
		...
		internal override Hashtable ToHashtable()
		{
			...
			if (Formatter != Formatter_DefaultValue) { h.Add("formatter",Formatter); Highcharts.AddFunction("d78e3bc5-e07e-4b91-9f04-4c882a16e1c1.formatter", Formatter); }  
			...
			if (NullFormatter != NullFormatter_DefaultValue) { h.Add("nullFormatter",NullFormatter); Highcharts.AddFunction("23b25b10-70f6-4429-8849-f50d526ef56e.nullFormatter", NullFormatter); }  
