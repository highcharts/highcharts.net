...
{
	public partial class Scatter3dSeriesDataLabels  : BaseObject
	{
		Hashtable h = new Hashtable();

		public Scatter3dSeriesDataLabels()
		{
			Align = Align_DefaultValue = Scatter3dSeriesDataLabelsAlign.Center;
			...
			Filter = Filter_DefaultValue = new Scatter3dSeriesDataLabelsFilter();
			...
			Style = Style_DefaultValue = new Scatter3dSeriesDataLabelsStyle();
			TextPath = TextPath_DefaultValue = new Scatter3dSeriesDataLabelsTextPath();
			UseHTML = UseHTML_DefaultValue = false;
			VerticalAlign = VerticalAlign_DefaultValue = Scatter3dSeriesDataLabelsVerticalAlign.Bottom;
			X = X_DefaultValue = 0;
			Y = Y_DefaultValue = 0;
			Z = Z_DefaultValue = 6;
		...
		/// </summary>
		public Scatter3dSeriesDataLabelsAlign Align { get; set; }
		private Scatter3dSeriesDataLabelsAlign Align_DefaultValue { get; set; }
		...
		/// </summary>
		public Scatter3dSeriesDataLabelsFilter Filter { get; set; }
		private Scatter3dSeriesDataLabelsFilter Filter_DefaultValue { get; set; }
		...
		/// </summary>
		public Scatter3dSeriesDataLabelsStyle Style { get; set; }
		private Scatter3dSeriesDataLabelsStyle Style_DefaultValue { get; set; }
		...
		/// </summary>
		public Scatter3dSeriesDataLabelsTextPath TextPath { get; set; }
		private Scatter3dSeriesDataLabelsTextPath TextPath_DefaultValue { get; set; }
		...
		/// </summary>
		public Scatter3dSeriesDataLabelsVerticalAlign VerticalAlign { get; set; }
		private Scatter3dSeriesDataLabelsVerticalAlign VerticalAlign_DefaultValue { get; set; }
		...
		internal override Hashtable ToHashtable()
		{
			...
			if (Formatter != Formatter_DefaultValue) { h.Add("formatter",Formatter); Highcharts.AddFunction("93dbbe9d-b179-4edb-bb59-6292056397d9.formatter", Formatter); }  
			if (Inside != Inside_DefaultValue) h.Add("inside",Inside);
			if (NullFormat != NullFormat_DefaultValue) h.Add("nullFormat",NullFormat);
			if (NullFormatter != NullFormatter_DefaultValue) { h.Add("nullFormatter",NullFormatter); Highcharts.AddFunction("0b06d24c-b4c9-4078-9aa4-dc619e439f44.nullFormatter", NullFormatter); }  
