...
namespace Highsoft.Web.Mvc.Charts
{
	public partial class Scatter3dSeriesDragDropDragHandle  : BaseObject
	{
		...
		internal override Hashtable ToHashtable()
		{
			...
			if (PathFormatter != PathFormatter_DefaultValue) { h.Add("pathFormatter",PathFormatter); Highcharts.AddFunction("25c2ae4b-3e61-4f3c-a6d1-fc0911752f7a.pathFormatter", PathFormatter); }  
