...
{
	public partial class Scatter3dSeriesLabel  : BaseObject
	{
		Hashtable h = new Hashtable();

		public Scatter3dSeriesLabel()
		{
			...
			Style = Style_DefaultValue = new Scatter3dSeriesLabelStyle();
		...
		/// </summary>
		public Scatter3dSeriesLabelStyle Style { get; set; }
		private Scatter3dSeriesLabelStyle Style_DefaultValue { get; set; }
		...
		internal override Hashtable ToHashtable()
		{
			...
			if (Formatter != Formatter_DefaultValue) { h.Add("formatter",Formatter); Highcharts.AddFunction("23d550a7-62bc-4740-ad9d-e434ce207f9d.formatter", Formatter); }  
