...
{
	public partial class Scatter3dSeriesOnPoint  : BaseObject
	{
		Hashtable h = new Hashtable();

		public Scatter3dSeriesOnPoint()
		{
			ConnectorOptions = ConnectorOptions_DefaultValue = new Scatter3dSeriesOnPointConnectorOptions();
			Id = Id_DefaultValue = "";
			Position = Position_DefaultValue = new Scatter3dSeriesOnPointPosition();
		...
		/// </summary>
		public Scatter3dSeriesOnPointConnectorOptions ConnectorOptions { get; set; }
		private Scatter3dSeriesOnPointConnectorOptions ConnectorOptions_DefaultValue { get; set; }
		...
		/// </summary>
		public Scatter3dSeriesOnPointPosition Position { get; set; }
		private Scatter3dSeriesOnPointPosition Position_DefaultValue { get; set; }
