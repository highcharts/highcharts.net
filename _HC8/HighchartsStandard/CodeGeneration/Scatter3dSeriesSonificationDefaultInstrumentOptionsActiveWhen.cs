...
{
	public partial class Scatter3dSeriesSonificationDefaultInstrumentOptionsActiveWhen  : BaseObject
	{
		Hashtable h = new Hashtable();

		public Scatter3dSeriesSonificationDefaultInstrumentOptionsActiveWhen()
		{
