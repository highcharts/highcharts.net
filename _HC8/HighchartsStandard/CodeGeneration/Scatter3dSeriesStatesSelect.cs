...
{
	public partial class Scatter3dSeriesStatesSelect  : BaseObject
	{
		Hashtable h = new Hashtable();

		public Scatter3dSeriesStatesSelect()
		{
			Animation = Animation_DefaultValue = new Animation() { Enabled = true };
			Enabled = Enabled_DefaultValue = true;
			Halo = Halo_DefaultValue = new Scatter3dSeriesStatesSelectHalo();
			LineWidth = LineWidth_DefaultValue = null;
			LineWidthPlus = LineWidthPlus_DefaultValue = 1;
			Marker = Marker_DefaultValue = new Scatter3dSeriesStatesSelectMarker();
		...
		/// </summary>
		public Scatter3dSeriesStatesSelectHalo Halo { get; set; }
		private Scatter3dSeriesStatesSelectHalo Halo_DefaultValue { get; set; }
		...
		/// </summary>
		public Scatter3dSeriesStatesSelectMarker Marker { get; set; }
		private Scatter3dSeriesStatesSelectMarker Marker_DefaultValue { get; set; }
