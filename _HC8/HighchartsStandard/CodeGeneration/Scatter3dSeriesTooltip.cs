...
{
	public partial class Scatter3dSeriesTooltip  : BaseObject
	{
		Hashtable h = new Hashtable();

		public Scatter3dSeriesTooltip()
		{
			...
			HeaderShape = HeaderShape_DefaultValue = Scatter3dSeriesTooltipHeaderShape.Callout;
		...
		/// </summary>
		public Scatter3dSeriesTooltipHeaderShape HeaderShape { get; set; }
		private Scatter3dSeriesTooltipHeaderShape HeaderShape_DefaultValue { get; set; }
		...
		internal override Hashtable ToHashtable()
		{
			...
			if (NullFormatter != NullFormatter_DefaultValue) { h.Add("nullFormatter",NullFormatter); Highcharts.AddFunction("0e23742f-123e-4660-8e11-1db83ad36dc9.nullFormatter", NullFormatter); }  
			if (Outside != Outside_DefaultValue) h.Add("outside",Outside);
			if (Padding != Padding_DefaultValue) h.Add("padding",Padding);
			if (PointFormat != PointFormat_DefaultValue) h.Add("pointFormat",PointFormat);
			if (PointFormatter != PointFormatter_DefaultValue) { h.Add("pointFormatter",PointFormatter); Highcharts.AddFunction("eb82a8fb-3c31-4313-97b9-b4e4b12cc356.pointFormatter", PointFormatter); }  
