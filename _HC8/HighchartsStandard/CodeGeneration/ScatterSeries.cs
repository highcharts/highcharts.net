...
namespace Highsoft.Web.Mvc.Charts
{
	public partial class ScatterSeries  : Series
	{
		...
		internal override Hashtable ToHashtable()
		{
			...
			if (PointDescriptionFormatter != PointDescriptionFormatter_DefaultValue) { h.Add("pointDescriptionFormatter",PointDescriptionFormatter); Highcharts.AddFunction("8e578234-835d-446e-9b5d-170499178546.pointDescriptionFormatter", PointDescriptionFormatter); }  
