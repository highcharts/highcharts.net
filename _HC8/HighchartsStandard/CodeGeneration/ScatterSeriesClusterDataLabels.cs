...
namespace Highsoft.Web.Mvc.Charts
{
	public partial class ScatterSeriesClusterDataLabels  : BaseObject
	{
		...
		{
			Align = Align_DefaultValue = ScatterSeriesClusterDataLabelsAlign.Center;
		...
		private ScatterSeriesClusterDataLabelsAlign Align_DefaultValue { get; set; }
		...
		private ScatterSeriesClusterDataLabelsVerticalAlign VerticalAlign_DefaultValue { get; set; }
