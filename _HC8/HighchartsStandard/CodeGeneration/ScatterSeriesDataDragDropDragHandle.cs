...
namespace Highsoft.Web.Mvc.Charts
{
	public partial class ScatterSeriesDataDragDropDragHandle  : BaseObject
	{
		...
		internal override Hashtable ToHashtable()
		{
			...
			if (PathFormatter != PathFormatter_DefaultValue) { h.Add("pathFormatter",PathFormatter); Highcharts.AddFunction("4e0f46bb-2d3a-49ac-ae85-0985304bf02f.pathFormatter", PathFormatter); }  
