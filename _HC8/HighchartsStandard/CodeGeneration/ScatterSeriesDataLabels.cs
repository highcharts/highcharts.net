...
{
	public partial class ScatterSeriesDataLabels  : BaseObject
	{
		Hashtable h = new Hashtable();

		public ScatterSeriesDataLabels()
		{
			Align = Align_DefaultValue = ScatterSeriesDataLabelsAlign.Center;
			...
			Filter = Filter_DefaultValue = new ScatterSeriesDataLabelsFilter();
			...
			Style = Style_DefaultValue = new ScatterSeriesDataLabelsStyle();
			TextPath = TextPath_DefaultValue = new ScatterSeriesDataLabelsTextPath();
			UseHTML = UseHTML_DefaultValue = false;
			VerticalAlign = VerticalAlign_DefaultValue = ScatterSeriesDataLabelsVerticalAlign.Bottom;
			X = X_DefaultValue = 0;
			Y = Y_DefaultValue = 0;
			Z = Z_DefaultValue = 6;
		...
		/// </summary>
		public ScatterSeriesDataLabelsFilter Filter { get; set; }
		private ScatterSeriesDataLabelsFilter Filter_DefaultValue { get; set; }
		...
		/// </summary>
		public ScatterSeriesDataLabelsStyle Style { get; set; }
		private ScatterSeriesDataLabelsStyle Style_DefaultValue { get; set; }
		...
		/// </summary>
		public ScatterSeriesDataLabelsTextPath TextPath { get; set; }
		private ScatterSeriesDataLabelsTextPath TextPath_DefaultValue { get; set; }
		...
		internal override Hashtable ToHashtable()
		{
			...
			if (Formatter != Formatter_DefaultValue) { h.Add("formatter",Formatter); Highcharts.AddFunction("d448b0a9-4c0d-496c-abd9-1b890de8414b.formatter", Formatter); }  
			...
			if (NullFormatter != NullFormatter_DefaultValue) { h.Add("nullFormatter",NullFormatter); Highcharts.AddFunction("40582575-ae9c-4cd3-bd47-a762143dd968.nullFormatter", NullFormatter); }  
