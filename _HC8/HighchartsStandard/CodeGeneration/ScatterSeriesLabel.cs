...
{
	public partial class ScatterSeriesLabel  : BaseObject
	{
		...
		public ScatterSeriesLabel()
		{
			...
			Style = Style_DefaultValue = new ScatterSeriesLabelStyle();
		...
		internal override Hashtable ToHashtable()
		{
			...
			if (Formatter != Formatter_DefaultValue) { h.Add("formatter",Formatter); Highcharts.AddFunction("3d4b4365-8f49-4dcd-b4e9-72e9fbd9ef40.formatter", Formatter); }  
