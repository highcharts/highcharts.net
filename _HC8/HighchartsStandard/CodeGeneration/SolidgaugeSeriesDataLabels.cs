...
namespace Highsoft.Web.Mvc.Charts
{
	public partial class SolidgaugeSeriesDataLabels  : BaseObject
	{
		...
		internal override Hashtable ToHashtable()
		{
			...
			if (Formatter != Formatter_DefaultValue) { h.Add("formatter",Formatter); Highcharts.AddFunction("890b39b1-56a1-4cda-ae95-3ebbec99d011.formatter", Formatter); }  
			...
			if (NullFormatter != NullFormatter_DefaultValue) { h.Add("nullFormatter",NullFormatter); Highcharts.AddFunction("49889a11-b637-46d0-8ab8-9c3515c3b154.nullFormatter", NullFormatter); }  
