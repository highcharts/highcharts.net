...
{
	public partial class SolidgaugeSeriesDataMarker  : BaseObject
	{
		Hashtable h = new Hashtable();

		public SolidgaugeSeriesDataMarker()
		{
			...
			States = States_DefaultValue = new SolidgaugeSeriesDataMarkerStates();
		...
		/// </summary>
		public SolidgaugeSeriesDataMarkerStates States { get; set; }
		private SolidgaugeSeriesDataMarkerStates States_DefaultValue { get; set; }
