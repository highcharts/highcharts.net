...
namespace Highsoft.Web.Mvc.Charts
{
	public partial class SolidgaugeSeriesOnPoint  : BaseObject
	{
		...
		{
			ConnectorOptions = ConnectorOptions_DefaultValue = new SolidgaugeSeriesOnPointConnectorOptions();
			Id = Id_DefaultValue = "";
			Position = Position_DefaultValue = new SolidgaugeSeriesOnPointPosition();
		...
		private SolidgaugeSeriesOnPointConnectorOptions ConnectorOptions_DefaultValue { get; set; }
		...
		private SolidgaugeSeriesOnPointPosition Position_DefaultValue { get; set; }
