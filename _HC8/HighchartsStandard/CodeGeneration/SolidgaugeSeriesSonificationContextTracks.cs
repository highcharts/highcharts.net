...
{
	public partial class SolidgaugeSeriesSonificationContextTracks  : BaseObject
	{
		Hashtable h = new Hashtable();

		public SolidgaugeSeriesSonificationContextTracks()
		{
			ActiveWhen = ActiveWhen_DefaultValue = new SolidgaugeSeriesSonificationContextTracksActiveWhen();
			Instrument = Instrument_DefaultValue = null;
			InstrumentString = InstrumentString_DefaultValue = "null";
			Mapping = Mapping_DefaultValue = new SolidgaugeSeriesSonificationContextTracksMapping();
			MidiName = MidiName_DefaultValue = "";
			PointGrouping = PointGrouping_DefaultValue = new SolidgaugeSeriesSonificationContextTracksPointGrouping();
			...
			Type = Type_DefaultValue = SolidgaugeSeriesSonificationContextTracksType.Instrument;
			ValueInterval = ValueInterval_DefaultValue = null;
			ValueMapFunction = ValueMapFunction_DefaultValue = SolidgaugeSeriesSonificationContextTracksValueMapFunction.Linear;
		...
		/// </summary>
		public SolidgaugeSeriesSonificationContextTracksActiveWhen ActiveWhen { get; set; }
		private SolidgaugeSeriesSonificationContextTracksActiveWhen ActiveWhen_DefaultValue { get; set; }
		...
		/// </summary>
		public SolidgaugeSeriesSonificationContextTracksMapping Mapping { get; set; }
		private SolidgaugeSeriesSonificationContextTracksMapping Mapping_DefaultValue { get; set; }
		...
		/// </summary>
		public SolidgaugeSeriesSonificationContextTracksPointGrouping PointGrouping { get; set; }
		private SolidgaugeSeriesSonificationContextTracksPointGrouping PointGrouping_DefaultValue { get; set; }
		...
		/// </summary>
		public SolidgaugeSeriesSonificationContextTracksType Type { get; set; }
		private SolidgaugeSeriesSonificationContextTracksType Type_DefaultValue { get; set; }
		...
		/// </summary>
		public SolidgaugeSeriesSonificationContextTracksValueMapFunction ValueMapFunction { get; set; }
		private SolidgaugeSeriesSonificationContextTracksValueMapFunction ValueMapFunction_DefaultValue { get; set; }
