...
{
	public partial class SolidgaugeSeriesSonificationDefaultSpeechOptions  : BaseObject
	{
		Hashtable h = new Hashtable();

		public SolidgaugeSeriesSonificationDefaultSpeechOptions()
		{
			ActiveWhen = ActiveWhen_DefaultValue = new SolidgaugeSeriesSonificationDefaultSpeechOptionsActiveWhen();
			Language = Language_DefaultValue = "en-US";
			Mapping = Mapping_DefaultValue = new SolidgaugeSeriesSonificationDefaultSpeechOptionsMapping();
			PointGrouping = PointGrouping_DefaultValue = new SolidgaugeSeriesSonificationDefaultSpeechOptionsPointGrouping();
			PreferredVoice = PreferredVoice_DefaultValue = "";
			ShowPlayMarker = ShowPlayMarker_DefaultValue = true;
			Type = Type_DefaultValue = SolidgaugeSeriesSonificationDefaultSpeechOptionsType.Instrument;
		...
		/// </summary>
		public SolidgaugeSeriesSonificationDefaultSpeechOptionsActiveWhen ActiveWhen { get; set; }
		private SolidgaugeSeriesSonificationDefaultSpeechOptionsActiveWhen ActiveWhen_DefaultValue { get; set; }
		...
		/// </summary>
		public SolidgaugeSeriesSonificationDefaultSpeechOptionsMapping Mapping { get; set; }
		private SolidgaugeSeriesSonificationDefaultSpeechOptionsMapping Mapping_DefaultValue { get; set; }
		 

		/// <summary>
		/// Options for point grouping, specifically for instrument tracks.
		/// </summary>
		public SolidgaugeSeriesSonificationDefaultSpeechOptionsPointGrouping PointGrouping { get; set; }
		private SolidgaugeSeriesSonificationDefaultSpeechOptionsPointGrouping PointGrouping_DefaultValue { get; set; }
		...
		/// </summary>
		public SolidgaugeSeriesSonificationDefaultSpeechOptionsType Type { get; set; }
		private SolidgaugeSeriesSonificationDefaultSpeechOptionsType Type_DefaultValue { get; set; }
