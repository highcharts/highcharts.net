...
{
	public partial class SolidgaugeSeriesSonificationTracks  : BaseObject
	{
		Hashtable h = new Hashtable();

		public SolidgaugeSeriesSonificationTracks()
		{
			ActiveWhen = ActiveWhen_DefaultValue = new SolidgaugeSeriesSonificationTracksActiveWhen();
			Instrument = Instrument_DefaultValue = null;
			InstrumentString = InstrumentString_DefaultValue = "null";
			Mapping = Mapping_DefaultValue = new SolidgaugeSeriesSonificationTracksMapping();
			MidiName = MidiName_DefaultValue = "";
			PointGrouping = PointGrouping_DefaultValue = new SolidgaugeSeriesSonificationTracksPointGrouping();
			RoundToMusicalNotes = RoundToMusicalNotes_DefaultValue = true;
			ShowPlayMarker = ShowPlayMarker_DefaultValue = true;
			Type = Type_DefaultValue = SolidgaugeSeriesSonificationTracksType.Instrument;
		...
		/// </summary>
		public SolidgaugeSeriesSonificationTracksActiveWhen ActiveWhen { get; set; }
		private SolidgaugeSeriesSonificationTracksActiveWhen ActiveWhen_DefaultValue { get; set; }
		...
		/// </summary>
		public SolidgaugeSeriesSonificationTracksMapping Mapping { get; set; }
		private SolidgaugeSeriesSonificationTracksMapping Mapping_DefaultValue { get; set; }
		...
		/// </summary>
		public SolidgaugeSeriesSonificationTracksPointGrouping PointGrouping { get; set; }
		private SolidgaugeSeriesSonificationTracksPointGrouping PointGrouping_DefaultValue { get; set; }
		...
		/// </summary>
		public SolidgaugeSeriesSonificationTracksType Type { get; set; }
		private SolidgaugeSeriesSonificationTracksType Type_DefaultValue { get; set; }
