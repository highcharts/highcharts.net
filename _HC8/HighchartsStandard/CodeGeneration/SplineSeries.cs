...
namespace Highsoft.Web.Mvc.Charts
{
	public partial class SplineSeries  : Series
	{
		...
		internal override Hashtable ToHashtable()
		{
			...
			if (PointDescriptionFormatter != PointDescriptionFormatter_DefaultValue) { h.Add("pointDescriptionFormatter",PointDescriptionFormatter); Highcharts.AddFunction("ab4ebdd4-12c9-4b8f-82e8-7e7ba206d7c1.pointDescriptionFormatter", PointDescriptionFormatter); }  
