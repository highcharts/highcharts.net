...
namespace Highsoft.Web.Mvc.Charts
{
	public partial class SplineSeries  : Series
	{
		...
		internal override Hashtable ToHashtable()
		{
			...
			if (PointDescriptionFormatter != PointDescriptionFormatter_DefaultValue) { h.Add("pointDescriptionFormatter",PointDescriptionFormatter); Highcharts.AddFunction("3219e816-3437-41ac-917a-4acb8b52b64b.pointDescriptionFormatter", PointDescriptionFormatter); }  
