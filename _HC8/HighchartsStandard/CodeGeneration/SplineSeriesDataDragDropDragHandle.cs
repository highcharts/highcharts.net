...
namespace Highsoft.Web.Mvc.Charts
{
	public partial class SplineSeriesDataDragDropDragHandle  : BaseObject
	{
		...
		internal override Hashtable ToHashtable()
		{
			...
			if (PathFormatter != PathFormatter_DefaultValue) { h.Add("pathFormatter",PathFormatter); Highcharts.AddFunction("37774329-1a9a-4276-a065-7335b8f3321a.pathFormatter", PathFormatter); }  
