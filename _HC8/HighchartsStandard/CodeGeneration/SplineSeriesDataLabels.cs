...
namespace Highsoft.Web.Mvc.Charts
{
	public partial class SplineSeriesDataLabels  : BaseObject
	{
		...
		public SplineSeriesDataLabels()
		{
			...
			Style = Style_DefaultValue = new SplineSeriesDataLabelsStyle();
		...
		/// </summary>
		public SplineSeriesDataLabelsStyle Style { get; set; }
		private SplineSeriesDataLabelsStyle Style_DefaultValue { get; set; }
		...
		internal override Hashtable ToHashtable()
		{
			...
			if (Formatter != Formatter_DefaultValue) { h.Add("formatter",Formatter); Highcharts.AddFunction("d8cf5c87-458d-45be-a8ba-9ee1cd90a9bf.formatter", Formatter); }  
			if (Inside != Inside_DefaultValue) h.Add("inside",Inside);
			if (NullFormat != NullFormat_DefaultValue) h.Add("nullFormat",NullFormat);
			if (NullFormatter != NullFormatter_DefaultValue) { h.Add("nullFormatter",NullFormatter); Highcharts.AddFunction("b1c66d77-7a01-4164-b005-0ac00db4aa0f.nullFormatter", NullFormatter); }  
