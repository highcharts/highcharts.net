...
namespace Highsoft.Web.Mvc.Charts
{
	public partial class SplineSeriesDragDropDragHandle  : BaseObject
	{
		...
		internal override Hashtable ToHashtable()
		{
			...
			if (PathFormatter != PathFormatter_DefaultValue) { h.Add("pathFormatter",PathFormatter); Highcharts.AddFunction("6493f341-fc77-4129-abfe-f90d6257389b.pathFormatter", PathFormatter); }  
