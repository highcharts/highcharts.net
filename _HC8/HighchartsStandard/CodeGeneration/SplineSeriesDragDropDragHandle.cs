...
namespace Highsoft.Web.Mvc.Charts
{
	public partial class SplineSeriesDragDropDragHandle  : BaseObject
	{
		...
		internal override Hashtable ToHashtable()
		{
			...
			if (PathFormatter != PathFormatter_DefaultValue) { h.Add("pathFormatter",PathFormatter); Highcharts.AddFunction("7db0903c-8cbf-4d3b-bfd9-a3f3c38c77af.pathFormatter", PathFormatter); }  
