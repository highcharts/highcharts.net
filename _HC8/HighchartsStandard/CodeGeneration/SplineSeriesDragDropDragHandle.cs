...
namespace Highsoft.Web.Mvc.Charts
{
	public partial class SplineSeriesDragDropDragHandle  : BaseObject
	{
		...
		internal override Hashtable ToHashtable()
		{
			...
			if (PathFormatter != PathFormatter_DefaultValue) { h.Add("pathFormatter",PathFormatter); Highcharts.AddFunction("ee1f663b-66d9-46d6-b77b-f8a5bc275b1b.pathFormatter", PathFormatter); }  
