...
{
	public partial class SplineSeriesSonificationContextTracks  : BaseObject
	{
		Hashtable h = new Hashtable();

		public SplineSeriesSonificationContextTracks()
		{
			ActiveWhen = ActiveWhen_DefaultValue = new SplineSeriesSonificationContextTracksActiveWhen();
			Instrument = Instrument_DefaultValue = null;
			InstrumentString = InstrumentString_DefaultValue = "null";
			Mapping = Mapping_DefaultValue = new SplineSeriesSonificationContextTracksMapping();
			MidiName = MidiName_DefaultValue = "";
			PointGrouping = PointGrouping_DefaultValue = new SplineSeriesSonificationContextTracksPointGrouping();
			...
			Type = Type_DefaultValue = SplineSeriesSonificationContextTracksType.Instrument;
			ValueInterval = ValueInterval_DefaultValue = null;
			ValueMapFunction = ValueMapFunction_DefaultValue = SplineSeriesSonificationContextTracksValueMapFunction.Linear;
		...
		/// </summary>
		public SplineSeriesSonificationContextTracksActiveWhen ActiveWhen { get; set; }
		private SplineSeriesSonificationContextTracksActiveWhen ActiveWhen_DefaultValue { get; set; }
		...
		/// </summary>
		public SplineSeriesSonificationContextTracksMapping Mapping { get; set; }
		private SplineSeriesSonificationContextTracksMapping Mapping_DefaultValue { get; set; }
		...
		/// </summary>
		public SplineSeriesSonificationContextTracksPointGrouping PointGrouping { get; set; }
		private SplineSeriesSonificationContextTracksPointGrouping PointGrouping_DefaultValue { get; set; }
		...
		/// </summary>
		public SplineSeriesSonificationContextTracksType Type { get; set; }
		private SplineSeriesSonificationContextTracksType Type_DefaultValue { get; set; }
		...
		/// </summary>
		public SplineSeriesSonificationContextTracksValueMapFunction ValueMapFunction { get; set; }
		private SplineSeriesSonificationContextTracksValueMapFunction ValueMapFunction_DefaultValue { get; set; }
