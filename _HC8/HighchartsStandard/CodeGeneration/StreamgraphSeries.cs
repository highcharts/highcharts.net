...
namespace Highsoft.Web.Mvc.Charts
{
	public partial class StreamgraphSeries  : Series
	{
		...
		internal override Hashtable ToHashtable()
		{
			...
			if (PointDescriptionFormatter != PointDescriptionFormatter_DefaultValue) { h.Add("pointDescriptionFormatter",PointDescriptionFormatter); Highcharts.AddFunction("f552e514-b538-4dfe-b0b1-f3e9f9f8fd54.pointDescriptionFormatter", PointDescriptionFormatter); }  
