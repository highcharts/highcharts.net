...
namespace Highsoft.Web.Mvc.Charts
{
	public partial class StreamgraphSeriesDataDragDropDragHandle  : BaseObject
	{
		...
		internal override Hashtable ToHashtable()
		{
			...
			if (PathFormatter != PathFormatter_DefaultValue) { h.Add("pathFormatter",PathFormatter); Highcharts.AddFunction("af2cb4e9-52d0-4aa2-b3ee-0a5897d15d73.pathFormatter", PathFormatter); }  
