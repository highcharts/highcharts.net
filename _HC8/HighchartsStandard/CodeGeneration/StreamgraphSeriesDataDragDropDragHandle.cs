...
namespace Highsoft.Web.Mvc.Charts
{
	public partial class StreamgraphSeriesDataDragDropDragHandle  : BaseObject
	{
		...
		internal override Hashtable ToHashtable()
		{
			...
			if (PathFormatter != PathFormatter_DefaultValue) { h.Add("pathFormatter",PathFormatter); Highcharts.AddFunction("771925e0-83c8-4c1d-96a3-b3b82ea69bb5.pathFormatter", PathFormatter); }  
