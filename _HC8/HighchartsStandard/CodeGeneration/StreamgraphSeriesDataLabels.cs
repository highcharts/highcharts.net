...
{
	public partial class StreamgraphSeriesDataLabels  : BaseObject
	{
		Hashtable h = new Hashtable();

		public StreamgraphSeriesDataLabels()
		{
			Align = Align_DefaultValue = StreamgraphSeriesDataLabelsAlign.Center;
			...
			Filter = Filter_DefaultValue = new StreamgraphSeriesDataLabelsFilter();
			...
			Style = Style_DefaultValue = new StreamgraphSeriesDataLabelsStyle();
			TextPath = TextPath_DefaultValue = new StreamgraphSeriesDataLabelsTextPath();
			UseHTML = UseHTML_DefaultValue = false;
			VerticalAlign = VerticalAlign_DefaultValue = StreamgraphSeriesDataLabelsVerticalAlign.Bottom;
			X = X_DefaultValue = 0;
			Y = Y_DefaultValue = 0;
			Z = Z_DefaultValue = 6;
		...
		/// </summary>
		public StreamgraphSeriesDataLabelsAlign Align { get; set; }
		private StreamgraphSeriesDataLabelsAlign Align_DefaultValue { get; set; }
		...
		/// </summary>
		public StreamgraphSeriesDataLabelsFilter Filter { get; set; }
		private StreamgraphSeriesDataLabelsFilter Filter_DefaultValue { get; set; }
		...
		/// </summary>
		public StreamgraphSeriesDataLabelsStyle Style { get; set; }
		private StreamgraphSeriesDataLabelsStyle Style_DefaultValue { get; set; }
		...
		/// </summary>
		public StreamgraphSeriesDataLabelsTextPath TextPath { get; set; }
		private StreamgraphSeriesDataLabelsTextPath TextPath_DefaultValue { get; set; }
		...
		/// </summary>
		public StreamgraphSeriesDataLabelsVerticalAlign VerticalAlign { get; set; }
		private StreamgraphSeriesDataLabelsVerticalAlign VerticalAlign_DefaultValue { get; set; }
		...
		internal override Hashtable ToHashtable()
		{
			...
			if (Formatter != Formatter_DefaultValue) { h.Add("formatter",Formatter); Highcharts.AddFunction("2fe60320-7704-409a-85a6-eb8cb0773427.formatter", Formatter); }  
			if (Inside != Inside_DefaultValue) h.Add("inside",Inside);
			if (NullFormat != NullFormat_DefaultValue) h.Add("nullFormat",NullFormat);
			if (NullFormatter != NullFormatter_DefaultValue) { h.Add("nullFormatter",NullFormatter); Highcharts.AddFunction("8417b5fa-5f57-411b-8090-4a893968c122.nullFormatter", NullFormatter); }  
