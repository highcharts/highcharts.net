...
{
	public partial class StreamgraphSeriesOnPoint  : BaseObject
	{
		Hashtable h = new Hashtable();

		public StreamgraphSeriesOnPoint()
		{
			ConnectorOptions = ConnectorOptions_DefaultValue = new StreamgraphSeriesOnPointConnectorOptions();
			Id = Id_DefaultValue = "";
			Position = Position_DefaultValue = new StreamgraphSeriesOnPointPosition();
		...
		/// </summary>
		public StreamgraphSeriesOnPointConnectorOptions ConnectorOptions { get; set; }
		private StreamgraphSeriesOnPointConnectorOptions ConnectorOptions_DefaultValue { get; set; }
		...
		/// </summary>
		public StreamgraphSeriesOnPointPosition Position { get; set; }
		private StreamgraphSeriesOnPointPosition Position_DefaultValue { get; set; }
