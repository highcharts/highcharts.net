...
{
	public partial class StreamgraphSeriesSonificationDefaultSpeechOptions  : BaseObject
	{
		Hashtable h = new Hashtable();

		public StreamgraphSeriesSonificationDefaultSpeechOptions()
		{
			ActiveWhen = ActiveWhen_DefaultValue = new StreamgraphSeriesSonificationDefaultSpeechOptionsActiveWhen();
			Language = Language_DefaultValue = "en-US";
			Mapping = Mapping_DefaultValue = new StreamgraphSeriesSonificationDefaultSpeechOptionsMapping();
			PointGrouping = PointGrouping_DefaultValue = new StreamgraphSeriesSonificationDefaultSpeechOptionsPointGrouping();
			PreferredVoice = PreferredVoice_DefaultValue = "";
			ShowPlayMarker = ShowPlayMarker_DefaultValue = true;
			Type = Type_DefaultValue = StreamgraphSeriesSonificationDefaultSpeechOptionsType.Instrument;
		...
		/// </summary>
		public StreamgraphSeriesSonificationDefaultSpeechOptionsActiveWhen ActiveWhen { get; set; }
		private StreamgraphSeriesSonificationDefaultSpeechOptionsActiveWhen ActiveWhen_DefaultValue { get; set; }
		...
		/// </summary>
		public StreamgraphSeriesSonificationDefaultSpeechOptionsMapping Mapping { get; set; }
		private StreamgraphSeriesSonificationDefaultSpeechOptionsMapping Mapping_DefaultValue { get; set; }
		 

		/// <summary>
		/// Options for point grouping, specifically for instrument tracks.
		/// </summary>
		public StreamgraphSeriesSonificationDefaultSpeechOptionsPointGrouping PointGrouping { get; set; }
		private StreamgraphSeriesSonificationDefaultSpeechOptionsPointGrouping PointGrouping_DefaultValue { get; set; }
		...
		/// </summary>
		public StreamgraphSeriesSonificationDefaultSpeechOptionsType Type { get; set; }
		private StreamgraphSeriesSonificationDefaultSpeechOptionsType Type_DefaultValue { get; set; }
