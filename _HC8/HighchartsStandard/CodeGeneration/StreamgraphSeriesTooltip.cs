...
namespace Highsoft.Web.Mvc.Charts
{
	public partial class StreamgraphSeriesTooltip  : BaseObject
	{
		...
		internal override Hashtable ToHashtable()
		{
			...
			if (NullFormatter != NullFormatter_DefaultValue) { h.Add("nullFormatter",NullFormatter); Highcharts.AddFunction("4ddb430c-f791-4097-b666-4b698a27ee64.nullFormatter", NullFormatter); }  
			if (PointFormat != PointFormat_DefaultValue) h.Add("pointFormat",PointFormat);
			if (PointFormatter != PointFormatter_DefaultValue) { h.Add("pointFormatter",PointFormatter); Highcharts.AddFunction("bf5d144e-4a76-4411-b7cf-819e0f863e05.pointFormatter", PointFormatter); }  
