...
namespace Highsoft.Web.Mvc.Charts
{
	public partial class SunburstSeriesDataDragDropDragHandle  : BaseObject
	{
		...
		internal override Hashtable ToHashtable()
		{
			...
			if (PathFormatter != PathFormatter_DefaultValue) { h.Add("pathFormatter",PathFormatter); Highcharts.AddFunction("2c0dcc42-9961-40f7-9037-9fb8e461b368.pathFormatter", PathFormatter); }  
