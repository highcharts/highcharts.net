...
{
	public partial class SunburstSeriesDataMarker  : BaseObject
	{
		Hashtable h = new Hashtable();

		public SunburstSeriesDataMarker()
		{
			...
			States = States_DefaultValue = new SunburstSeriesDataMarkerStates();
		...
		/// </summary>
		public SunburstSeriesDataMarkerStates States { get; set; }
		private SunburstSeriesDataMarkerStates States_DefaultValue { get; set; }
