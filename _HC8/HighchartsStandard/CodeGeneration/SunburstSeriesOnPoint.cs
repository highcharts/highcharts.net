...
{
	public partial class SunburstSeriesOnPoint  : BaseObject
	{
		Hashtable h = new Hashtable();

		public SunburstSeriesOnPoint()
		{
			ConnectorOptions = ConnectorOptions_DefaultValue = new SunburstSeriesOnPointConnectorOptions();
			Id = Id_DefaultValue = "";
			Position = Position_DefaultValue = new SunburstSeriesOnPointPosition();
		...
		/// </summary>
		public SunburstSeriesOnPointConnectorOptions ConnectorOptions { get; set; }
		private SunburstSeriesOnPointConnectorOptions ConnectorOptions_DefaultValue { get; set; }
		...
		/// </summary>
		public SunburstSeriesOnPointPosition Position { get; set; }
		private SunburstSeriesOnPointPosition Position_DefaultValue { get; set; }
