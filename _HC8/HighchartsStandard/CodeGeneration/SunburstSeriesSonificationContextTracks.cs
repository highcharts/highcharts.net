...
{
	public partial class SunburstSeriesSonificationContextTracks  : BaseObject
	{
		Hashtable h = new Hashtable();

		public SunburstSeriesSonificationContextTracks()
		{
			ActiveWhen = ActiveWhen_DefaultValue = new SunburstSeriesSonificationContextTracksActiveWhen();
			Instrument = Instrument_DefaultValue = null;
			InstrumentString = InstrumentString_DefaultValue = "null";
			Mapping = Mapping_DefaultValue = new SunburstSeriesSonificationContextTracksMapping();
			MidiName = MidiName_DefaultValue = "";
			PointGrouping = PointGrouping_DefaultValue = new SunburstSeriesSonificationContextTracksPointGrouping();
			...
			Type = Type_DefaultValue = SunburstSeriesSonificationContextTracksType.Instrument;
			ValueInterval = ValueInterval_DefaultValue = null;
			ValueMapFunction = ValueMapFunction_DefaultValue = SunburstSeriesSonificationContextTracksValueMapFunction.Linear;
		...
		/// </summary>
		public SunburstSeriesSonificationContextTracksActiveWhen ActiveWhen { get; set; }
		private SunburstSeriesSonificationContextTracksActiveWhen ActiveWhen_DefaultValue { get; set; }
		...
		/// </summary>
		public SunburstSeriesSonificationContextTracksMapping Mapping { get; set; }
		private SunburstSeriesSonificationContextTracksMapping Mapping_DefaultValue { get; set; }
		...
		/// </summary>
		public SunburstSeriesSonificationContextTracksPointGrouping PointGrouping { get; set; }
		private SunburstSeriesSonificationContextTracksPointGrouping PointGrouping_DefaultValue { get; set; }
		...
		/// </summary>
		public SunburstSeriesSonificationContextTracksType Type { get; set; }
		private SunburstSeriesSonificationContextTracksType Type_DefaultValue { get; set; }
		...
		/// </summary>
		public SunburstSeriesSonificationContextTracksValueMapFunction ValueMapFunction { get; set; }
		private SunburstSeriesSonificationContextTracksValueMapFunction ValueMapFunction_DefaultValue { get; set; }
