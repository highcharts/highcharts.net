...
{
	public partial class SunburstSeriesSonificationDefaultInstrumentOptions  : BaseObject
	{
		Hashtable h = new Hashtable();

		public SunburstSeriesSonificationDefaultInstrumentOptions()
		{
			ActiveWhen = ActiveWhen_DefaultValue = new SunburstSeriesSonificationDefaultInstrumentOptionsActiveWhen();
			Instrument = Instrument_DefaultValue = null;
			InstrumentString = InstrumentString_DefaultValue = "null";
			Mapping = Mapping_DefaultValue = new SunburstSeriesSonificationDefaultInstrumentOptionsMapping();
			MidiName = MidiName_DefaultValue = "";
			PointGrouping = PointGrouping_DefaultValue = new SunburstSeriesSonificationDefaultInstrumentOptionsPointGrouping();
			RoundToMusicalNotes = RoundToMusicalNotes_DefaultValue = true;
			ShowPlayMarker = ShowPlayMarker_DefaultValue = true;
			Type = Type_DefaultValue = SunburstSeriesSonificationDefaultInstrumentOptionsType.Instrument;
		...
		/// </summary>
		public SunburstSeriesSonificationDefaultInstrumentOptionsActiveWhen ActiveWhen { get; set; }
		private SunburstSeriesSonificationDefaultInstrumentOptionsActiveWhen ActiveWhen_DefaultValue { get; set; }
		...
		/// </summary>
		public SunburstSeriesSonificationDefaultInstrumentOptionsMapping Mapping { get; set; }
		private SunburstSeriesSonificationDefaultInstrumentOptionsMapping Mapping_DefaultValue { get; set; }
		...
		/// </summary>
		public SunburstSeriesSonificationDefaultInstrumentOptionsPointGrouping PointGrouping { get; set; }
		private SunburstSeriesSonificationDefaultInstrumentOptionsPointGrouping PointGrouping_DefaultValue { get; set; }
		...
		/// </summary>
		public SunburstSeriesSonificationDefaultInstrumentOptionsType Type { get; set; }
		private SunburstSeriesSonificationDefaultInstrumentOptionsType Type_DefaultValue { get; set; }
