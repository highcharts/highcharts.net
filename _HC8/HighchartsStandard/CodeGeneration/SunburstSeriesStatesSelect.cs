...
{
	public partial class SunburstSeriesStatesSelect  : BaseObject
	{
		Hashtable h = new Hashtable();

		public SunburstSeriesStatesSelect()
		{
			Animation = Animation_DefaultValue = new Animation() { Enabled = true };
			Enabled = Enabled_DefaultValue = null;
			Halo = Halo_DefaultValue = new SunburstSeriesStatesSelectHalo();
			LineWidth = LineWidth_DefaultValue = null;
			LineWidthPlus = LineWidthPlus_DefaultValue = null;
			Marker = Marker_DefaultValue = new SunburstSeriesStatesSelectMarker();
		...
		/// </summary>
		public SunburstSeriesStatesSelectHalo Halo { get; set; }
		private SunburstSeriesStatesSelectHalo Halo_DefaultValue { get; set; }
		...
		/// </summary>
		public SunburstSeriesStatesSelectMarker Marker { get; set; }
		private SunburstSeriesStatesSelectMarker Marker_DefaultValue { get; set; }
