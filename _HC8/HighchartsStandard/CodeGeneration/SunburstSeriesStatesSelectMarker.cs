...
{
	public partial class SunburstSeriesStatesSelectMarker  : BaseObject
	{
		Hashtable h = new Hashtable();

		public SunburstSeriesStatesSelectMarker()
		{
			...
			States = States_DefaultValue = new SunburstSeriesStatesSelectMarkerStates();
		...
		/// </summary>
		public SunburstSeriesStatesSelectMarkerStates States { get; set; }
		private SunburstSeriesStatesSelectMarkerStates States_DefaultValue { get; set; }
