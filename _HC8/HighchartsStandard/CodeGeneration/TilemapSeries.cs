...
namespace Highsoft.Web.Mvc.Charts
{
	public partial class TilemapSeries  : Series
	{
		...
		public TilemapSeries()
		{
			...
			Type = Type_DefaultValue = TilemapSeriesType.Tilemap;
		...
		internal override Hashtable ToHashtable()
		{
			...
			if (PointDescriptionFormatter != PointDescriptionFormatter_DefaultValue) { h.Add("pointDescriptionFormatter",PointDescriptionFormatter); Highcharts.AddFunction("6de20820-2718-4923-9f9f-fc78517294f2.pointDescriptionFormatter", PointDescriptionFormatter); }  
