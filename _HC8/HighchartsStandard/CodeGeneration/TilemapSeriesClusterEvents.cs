...
{
	public partial class TilemapSeriesClusterEvents  : BaseObject
	{
		Hashtable h = new Hashtable();

		public TilemapSeriesClusterEvents()
		{
		...
		internal override Hashtable ToHashtable()
		{
			...
			if (DrillToCluster != DrillToCluster_DefaultValue) { h.Add("drillToCluster",DrillToCluster); Highcharts.AddFunction("3326b339-62c8-4fd9-8c24-96940a917dea.drillToCluster", DrillToCluster); }  
