...
{
	public partial class TilemapSeriesClusterMarker  : BaseObject
	{
		Hashtable h = new Hashtable();

		public TilemapSeriesClusterMarker()
		{
			...
			States = States_DefaultValue = new TilemapSeriesClusterMarkerStates();
		...
		/// </summary>
		public TilemapSeriesClusterMarkerStates States { get; set; }
		private TilemapSeriesClusterMarkerStates States_DefaultValue { get; set; }
