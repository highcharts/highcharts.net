...
{
	public partial class TilemapSeriesClusterZonesMarker  : BaseObject
	{
		Hashtable h = new Hashtable();

		public TilemapSeriesClusterZonesMarker()
		{
			...
			States = States_DefaultValue = new TilemapSeriesClusterZonesMarkerStates();
		...
		/// </summary>
		public TilemapSeriesClusterZonesMarkerStates States { get; set; }
		private TilemapSeriesClusterZonesMarkerStates States_DefaultValue { get; set; }
