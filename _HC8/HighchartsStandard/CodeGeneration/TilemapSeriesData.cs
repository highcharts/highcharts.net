...
namespace Highsoft.Web.Mvc.Charts
{
	public partial class TilemapSeriesData  : BaseObject
	{
		...
		{
			Accessibility = Accessibility_DefaultValue = new TilemapSeriesDataAccessibility();
			...
			DragDrop = DragDrop_DefaultValue = new TilemapSeriesDataDragDrop();
		...
		private TilemapSeriesDataAccessibility Accessibility_DefaultValue { get; set; }
		...
		private TilemapSeriesDataDragDrop DragDrop_DefaultValue { get; set; }
