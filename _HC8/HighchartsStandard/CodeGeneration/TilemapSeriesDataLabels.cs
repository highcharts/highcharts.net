...
namespace Highsoft.Web.Mvc.Charts
{
	public partial class TilemapSeriesDataLabels  : BaseObject
	{
		...
		{
			Align = Align_DefaultValue = TilemapSeriesDataLabelsAlign.Center;
			...
			Filter = Filter_DefaultValue = new TilemapSeriesDataLabelsFilter();
			...
			Style = Style_DefaultValue = new TilemapSeriesDataLabelsStyle();
			TextPath = TextPath_DefaultValue = new TilemapSeriesDataLabelsTextPath();
			UseHTML = UseHTML_DefaultValue = false;
			VerticalAlign = VerticalAlign_DefaultValue = TilemapSeriesDataLabelsVerticalAlign.Bottom;
			X = X_DefaultValue = 0;
			Y = Y_DefaultValue = 0;
			Z = Z_DefaultValue = 6;
		...
		/// </summary>
		public TilemapSeriesDataLabelsAlign Align { get; set; }
		private TilemapSeriesDataLabelsAlign Align_DefaultValue { get; set; }
		...
		/// </summary>
		public TilemapSeriesDataLabelsFilter Filter { get; set; }
		private TilemapSeriesDataLabelsFilter Filter_DefaultValue { get; set; }
		...
		/// </summary>
		public TilemapSeriesDataLabelsStyle Style { get; set; }
		private TilemapSeriesDataLabelsStyle Style_DefaultValue { get; set; }
		...
		/// </summary>
		public TilemapSeriesDataLabelsTextPath TextPath { get; set; }
		private TilemapSeriesDataLabelsTextPath TextPath_DefaultValue { get; set; }
		...
		internal override Hashtable ToHashtable()
		{
			...
			if (Formatter != Formatter_DefaultValue) { h.Add("formatter",Formatter); Highcharts.AddFunction("0e1ad1cd-6f6d-4a88-8e76-89ae4054926c.formatter", Formatter); }  
			if (Inside != Inside_DefaultValue) h.Add("inside",Inside);
			if (NullFormat != NullFormat_DefaultValue) h.Add("nullFormat",NullFormat);
			if (NullFormatter != NullFormatter_DefaultValue) { h.Add("nullFormatter",NullFormatter); Highcharts.AddFunction("e1f1e938-149b-4fd9-a49f-67af19357387.nullFormatter", NullFormatter); }  
