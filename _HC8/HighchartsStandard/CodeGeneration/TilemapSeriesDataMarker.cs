...
{
	public partial class TilemapSeriesDataMarker  : BaseObject
	{
		Hashtable h = new Hashtable();

		public TilemapSeriesDataMarker()
		{
			...
			States = States_DefaultValue = new TilemapSeriesDataMarkerStates();
		...
		/// </summary>
		public TilemapSeriesDataMarkerStates States { get; set; }
		private TilemapSeriesDataMarkerStates States_DefaultValue { get; set; }
