...
namespace Highsoft.Web.Mvc.Charts
{
	public partial class TilemapSeriesDragDropDragHandle  : BaseObject
	{
		...
		internal override Hashtable ToHashtable()
		{
			...
			if (PathFormatter != PathFormatter_DefaultValue) { h.Add("pathFormatter",PathFormatter); Highcharts.AddFunction("cedc3b65-3d5d-4ac4-a22d-2e36247cd2d5.pathFormatter", PathFormatter); }  
