...
namespace Highsoft.Web.Mvc.Charts
{
	public partial class TilemapSeriesDragDropDragHandle  : BaseObject
	{
		...
		internal override Hashtable ToHashtable()
		{
			...
			if (PathFormatter != PathFormatter_DefaultValue) { h.Add("pathFormatter",PathFormatter); Highcharts.AddFunction("1ef05f3a-d62d-49f1-b2da-92b0f3078ec7.pathFormatter", PathFormatter); }  
