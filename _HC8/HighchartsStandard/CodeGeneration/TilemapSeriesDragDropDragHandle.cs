...
namespace Highsoft.Web.Mvc.Charts
{
	public partial class TilemapSeriesDragDropDragHandle  : BaseObject
	{
		...
		internal override Hashtable ToHashtable()
		{
			...
			if (PathFormatter != PathFormatter_DefaultValue) { h.Add("pathFormatter",PathFormatter); Highcharts.AddFunction("d5197b7d-1de2-4e8d-bb82-83a35b9b9dcc.pathFormatter", PathFormatter); }  
