...
{
	public partial class TilemapSeriesOnPoint  : BaseObject
	{
		Hashtable h = new Hashtable();

		public TilemapSeriesOnPoint()
		{
			ConnectorOptions = ConnectorOptions_DefaultValue = new TilemapSeriesOnPointConnectorOptions();
			Id = Id_DefaultValue = "";
			Position = Position_DefaultValue = new TilemapSeriesOnPointPosition();
		...
		/// </summary>
		public TilemapSeriesOnPointConnectorOptions ConnectorOptions { get; set; }
		private TilemapSeriesOnPointConnectorOptions ConnectorOptions_DefaultValue { get; set; }
		...
		/// </summary>
		public TilemapSeriesOnPointPosition Position { get; set; }
		private TilemapSeriesOnPointPosition Position_DefaultValue { get; set; }
