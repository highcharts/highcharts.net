...
{
	public partial class TilemapSeriesSonificationContextTracks  : BaseObject
	{
		Hashtable h = new Hashtable();

		public TilemapSeriesSonificationContextTracks()
		{
			ActiveWhen = ActiveWhen_DefaultValue = new TilemapSeriesSonificationContextTracksActiveWhen();
			Instrument = Instrument_DefaultValue = null;
			InstrumentString = InstrumentString_DefaultValue = "null";
			Mapping = Mapping_DefaultValue = new TilemapSeriesSonificationContextTracksMapping();
			MidiName = MidiName_DefaultValue = "";
			PointGrouping = PointGrouping_DefaultValue = new TilemapSeriesSonificationContextTracksPointGrouping();
			...
			Type = Type_DefaultValue = TilemapSeriesSonificationContextTracksType.Instrument;
			ValueInterval = ValueInterval_DefaultValue = null;
			ValueMapFunction = ValueMapFunction_DefaultValue = TilemapSeriesSonificationContextTracksValueMapFunction.Linear;
		...
		/// </summary>
		public TilemapSeriesSonificationContextTracksActiveWhen ActiveWhen { get; set; }
		private TilemapSeriesSonificationContextTracksActiveWhen ActiveWhen_DefaultValue { get; set; }
		...
		/// </summary>
		public TilemapSeriesSonificationContextTracksMapping Mapping { get; set; }
		private TilemapSeriesSonificationContextTracksMapping Mapping_DefaultValue { get; set; }
		...
		/// </summary>
		public TilemapSeriesSonificationContextTracksPointGrouping PointGrouping { get; set; }
		private TilemapSeriesSonificationContextTracksPointGrouping PointGrouping_DefaultValue { get; set; }
		...
		/// </summary>
		public TilemapSeriesSonificationContextTracksType Type { get; set; }
		private TilemapSeriesSonificationContextTracksType Type_DefaultValue { get; set; }
		...
		/// </summary>
		public TilemapSeriesSonificationContextTracksValueMapFunction ValueMapFunction { get; set; }
		private TilemapSeriesSonificationContextTracksValueMapFunction ValueMapFunction_DefaultValue { get; set; }
