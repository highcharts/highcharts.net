...
{
	public partial class TilemapSeriesSonificationDefaultInstrumentOptions  : BaseObject
	{
		Hashtable h = new Hashtable();

		public TilemapSeriesSonificationDefaultInstrumentOptions()
		{
			ActiveWhen = ActiveWhen_DefaultValue = new TilemapSeriesSonificationDefaultInstrumentOptionsActiveWhen();
			Instrument = Instrument_DefaultValue = null;
			InstrumentString = InstrumentString_DefaultValue = "null";
			Mapping = Mapping_DefaultValue = new TilemapSeriesSonificationDefaultInstrumentOptionsMapping();
			MidiName = MidiName_DefaultValue = "";
			PointGrouping = PointGrouping_DefaultValue = new TilemapSeriesSonificationDefaultInstrumentOptionsPointGrouping();
			RoundToMusicalNotes = RoundToMusicalNotes_DefaultValue = true;
			ShowPlayMarker = ShowPlayMarker_DefaultValue = true;
			Type = Type_DefaultValue = TilemapSeriesSonificationDefaultInstrumentOptionsType.Instrument;
		...
		/// </summary>
		public TilemapSeriesSonificationDefaultInstrumentOptionsActiveWhen ActiveWhen { get; set; }
		private TilemapSeriesSonificationDefaultInstrumentOptionsActiveWhen ActiveWhen_DefaultValue { get; set; }
		...
		/// </summary>
		public TilemapSeriesSonificationDefaultInstrumentOptionsMapping Mapping { get; set; }
		private TilemapSeriesSonificationDefaultInstrumentOptionsMapping Mapping_DefaultValue { get; set; }
		...
		/// </summary>
		public TilemapSeriesSonificationDefaultInstrumentOptionsPointGrouping PointGrouping { get; set; }
		private TilemapSeriesSonificationDefaultInstrumentOptionsPointGrouping PointGrouping_DefaultValue { get; set; }
		...
		/// </summary>
		public TilemapSeriesSonificationDefaultInstrumentOptionsType Type { get; set; }
		private TilemapSeriesSonificationDefaultInstrumentOptionsType Type_DefaultValue { get; set; }
