...
{
	public partial class TilemapSeriesSonificationDefaultSpeechOptions  : BaseObject
	{
		Hashtable h = new Hashtable();

		public TilemapSeriesSonificationDefaultSpeechOptions()
		{
			ActiveWhen = ActiveWhen_DefaultValue = new TilemapSeriesSonificationDefaultSpeechOptionsActiveWhen();
			Language = Language_DefaultValue = "en-US";
			Mapping = Mapping_DefaultValue = new TilemapSeriesSonificationDefaultSpeechOptionsMapping();
			PointGrouping = PointGrouping_DefaultValue = new TilemapSeriesSonificationDefaultSpeechOptionsPointGrouping();
			PreferredVoice = PreferredVoice_DefaultValue = "";
			ShowPlayMarker = ShowPlayMarker_DefaultValue = true;
			Type = Type_DefaultValue = TilemapSeriesSonificationDefaultSpeechOptionsType.Instrument;
		...
		/// </summary>
		public TilemapSeriesSonificationDefaultSpeechOptionsActiveWhen ActiveWhen { get; set; }
		private TilemapSeriesSonificationDefaultSpeechOptionsActiveWhen ActiveWhen_DefaultValue { get; set; }
		...
		/// </summary>
		public TilemapSeriesSonificationDefaultSpeechOptionsMapping Mapping { get; set; }
		private TilemapSeriesSonificationDefaultSpeechOptionsMapping Mapping_DefaultValue { get; set; }
		 

		/// <summary>
		/// Options for point grouping, specifically for instrument tracks.
		/// </summary>
		public TilemapSeriesSonificationDefaultSpeechOptionsPointGrouping PointGrouping { get; set; }
		private TilemapSeriesSonificationDefaultSpeechOptionsPointGrouping PointGrouping_DefaultValue { get; set; }
		...
		/// </summary>
		public TilemapSeriesSonificationDefaultSpeechOptionsType Type { get; set; }
		private TilemapSeriesSonificationDefaultSpeechOptionsType Type_DefaultValue { get; set; }
