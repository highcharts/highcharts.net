...
{
	public partial class TilemapSeriesStatesSelect  : BaseObject
	{
		Hashtable h = new Hashtable();

		public TilemapSeriesStatesSelect()
		{
			Animation = Animation_DefaultValue = new Animation() { Enabled = true };
			Enabled = Enabled_DefaultValue = null;
			Halo = Halo_DefaultValue = new TilemapSeriesStatesSelectHalo();
			LineWidth = LineWidth_DefaultValue = null;
			LineWidthPlus = LineWidthPlus_DefaultValue = null;
			Marker = Marker_DefaultValue = new TilemapSeriesStatesSelectMarker();
		...
		/// </summary>
		public TilemapSeriesStatesSelectHalo Halo { get; set; }
		private TilemapSeriesStatesSelectHalo Halo_DefaultValue { get; set; }
		...
		/// </summary>
		public TilemapSeriesStatesSelectMarker Marker { get; set; }
		private TilemapSeriesStatesSelectMarker Marker_DefaultValue { get; set; }
