...
{
	public partial class TilemapSeriesStatesSelectMarker  : BaseObject
	{
		Hashtable h = new Hashtable();

		public TilemapSeriesStatesSelectMarker()
		{
			...
			States = States_DefaultValue = new TilemapSeriesStatesSelectMarkerStates();
		...
		/// </summary>
		public TilemapSeriesStatesSelectMarkerStates States { get; set; }
		private TilemapSeriesStatesSelectMarkerStates States_DefaultValue { get; set; }
