...
{
	public partial class TilemapSeriesTooltip  : BaseObject
	{
		Hashtable h = new Hashtable();

		public TilemapSeriesTooltip()
		{
			...
			HeaderShape = HeaderShape_DefaultValue = TilemapSeriesTooltipHeaderShape.Callout;
		...
		/// </summary>
		public TilemapSeriesTooltipHeaderShape HeaderShape { get; set; }
		private TilemapSeriesTooltipHeaderShape HeaderShape_DefaultValue { get; set; }
		...
		internal override Hashtable ToHashtable()
		{
			...
			if (NullFormatter != NullFormatter_DefaultValue) { h.Add("nullFormatter",NullFormatter); Highcharts.AddFunction("5d0bbbdf-039d-4c1f-920d-ba75bbfc0e0c.nullFormatter", NullFormatter); }  
			if (Outside != Outside_DefaultValue) h.Add("outside",Outside);
			if (Padding != Padding_DefaultValue) h.Add("padding",Padding);
			if (PointFormat != PointFormat_DefaultValue) h.Add("pointFormat",PointFormat);
			if (PointFormatter != PointFormatter_DefaultValue) { h.Add("pointFormatter",PointFormatter); Highcharts.AddFunction("868ee9f2-f801-40ff-a534-2eeddd37b7c8.pointFormatter", PointFormatter); }  
