...
namespace Highsoft.Web.Mvc.Charts
{
	public partial class TimelineSeries  : Series
	{
		...
		internal override Hashtable ToHashtable()
		{
			...
			if (PointDescriptionFormatter != PointDescriptionFormatter_DefaultValue) { h.Add("pointDescriptionFormatter",PointDescriptionFormatter); Highcharts.AddFunction("e4cbe865-dca2-4012-abba-3ac37d132637.pointDescriptionFormatter", PointDescriptionFormatter); }  
