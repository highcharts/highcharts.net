...
namespace Highsoft.Web.Mvc.Charts
{
	public partial class TimelineSeries  : Series
	{
		...
		{
			Accessibility = Accessibility_DefaultValue = new TimelineSeriesAccessibility();
			AllowPointSelect = AllowPointSelect_DefaultValue = false;
			Animation = Animation_DefaultValue = new Animation() { Enabled = true };
			BoostBlending = BoostBlending_DefaultValue = TimelineSeriesBoostBlending.Undefined;
			...
			Cursor = Cursor_DefaultValue = TimelineSeriesCursor.Null;
			Data = Data_DefaultValue = new List<TimelineSeriesData>();
			DataLabels = DataLabels_DefaultValue = new TimelineSeriesDataLabels();
			DataSorting = DataSorting_DefaultValue = new TimelineSeriesDataSorting();
			Description = Description_DefaultValue = "";
			DragDrop = DragDrop_DefaultValue = new TimelineSeriesDragDrop();
			EnableMouseTracking = EnableMouseTracking_DefaultValue = true;
			Events = Events_DefaultValue = new TimelineSeriesEvents();
			Id = Id_DefaultValue = "";
			IgnoreHiddenPoint = IgnoreHiddenPoint_DefaultValue = true;
			IncludeInDataExport = IncludeInDataExport_DefaultValue = null;
			Index = Index_DefaultValue = null;
			Keys = Keys_DefaultValue = new List<string>();
			Label = Label_DefaultValue = new TimelineSeriesLabel();
			LegendIndex = LegendIndex_DefaultValue = null;
			LegendType = LegendType_DefaultValue = "point";
			Linecap = Linecap_DefaultValue = TimelineSeriesLinecap.Round;
			LinkedTo = LinkedTo_DefaultValue = "";
			Marker = Marker_DefaultValue = new TimelineSeriesMarker();
			Name = Name_DefaultValue = "";
			Opacity = Opacity_DefaultValue = 1;
			Point = Point_DefaultValue = new TimelineSeriesPoint();
			...
			States = States_DefaultValue = new TimelineSeriesStates();
			StickyTracking = StickyTracking_DefaultValue = true;
			Tooltip = Tooltip_DefaultValue = new TimelineSeriesTooltip();
			Type = Type_DefaultValue = TimelineSeriesType.Timeline;
		...
		private TimelineSeriesAccessibility Accessibility_DefaultValue { get; set; }
		...
		/// </summary>
		public TimelineSeriesBoostBlending BoostBlending { get; set; }
		private TimelineSeriesBoostBlending BoostBlending_DefaultValue { get; set; }
		...
		private TimelineSeriesCursor Cursor_DefaultValue { get; set; }
		...
		private List<TimelineSeriesData> Data_DefaultValue { get; set; }
		...
		private TimelineSeriesDataLabels DataLabels_DefaultValue { get; set; }
		 

		/// <summary>
		/// Options for the series data sorting.
		/// </summary>
		public TimelineSeriesDataSorting DataSorting { get; set; }
		private TimelineSeriesDataSorting DataSorting_DefaultValue { get; set; }
		...
		private TimelineSeriesDragDrop DragDrop_DefaultValue { get; set; }
		...
		private TimelineSeriesEvents Events_DefaultValue { get; set; }
		...
		private TimelineSeriesLabel Label_DefaultValue { get; set; }
		...
		private TimelineSeriesLinecap Linecap_DefaultValue { get; set; }
		...
		private TimelineSeriesMarker Marker_DefaultValue { get; set; }
		...
		private TimelineSeriesPoint Point_DefaultValue { get; set; }
		...
		private TimelineSeriesStates States_DefaultValue { get; set; }
		...
		private TimelineSeriesTooltip Tooltip_DefaultValue { get; set; }
		...
		/// </summary>
		public TimelineSeriesType Type { get; set; }
		private TimelineSeriesType Type_DefaultValue { get; set; }
		...
		internal override Hashtable ToHashtable()
		{
			...
			if (PointDescriptionFormatter != PointDescriptionFormatter_DefaultValue) { h.Add("pointDescriptionFormatter",PointDescriptionFormatter); Highcharts.AddFunction("0fe1a3e0-dd89-405b-a832-381e843b2755.pointDescriptionFormatter", PointDescriptionFormatter); }  
