...
{
	public partial class TimelineSeriesData  : BaseObject
	{
		Hashtable h = new Hashtable();

		public TimelineSeriesData()
		{
			Accessibility = Accessibility_DefaultValue = new TimelineSeriesDataAccessibility();
			...
			DragDrop = DragDrop_DefaultValue = new TimelineSeriesDataDragDrop();
			Drilldown = Drilldown_DefaultValue = "";
			Events = Events_DefaultValue = new TimelineSeriesDataEvents();
			Id = Id_DefaultValue = "";
			Label = Label_DefaultValue = "";
			Labelrank = Labelrank_DefaultValue = null;
			Marker = Marker_DefaultValue = new TimelineSeriesDataMarker();
		...
		/// </summary>
		public TimelineSeriesDataAccessibility Accessibility { get; set; }
		private TimelineSeriesDataAccessibility Accessibility_DefaultValue { get; set; }
		...
		/// </summary>
		public TimelineSeriesDataDragDrop DragDrop { get; set; }
		private TimelineSeriesDataDragDrop DragDrop_DefaultValue { get; set; }
		...
		/// </summary>
		public TimelineSeriesDataEvents Events { get; set; }
		private TimelineSeriesDataEvents Events_DefaultValue { get; set; }
		...
		/// </summary>
		public TimelineSeriesDataMarker Marker { get; set; }
		private TimelineSeriesDataMarker Marker_DefaultValue { get; set; }
