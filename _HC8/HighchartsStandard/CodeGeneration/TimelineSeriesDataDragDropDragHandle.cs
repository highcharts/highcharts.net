...
namespace Highsoft.Web.Mvc.Charts
{
	public partial class TimelineSeriesDataDragDropDragHandle  : BaseObject
	{
		...
		internal override Hashtable ToHashtable()
		{
			...
			if (PathFormatter != PathFormatter_DefaultValue) { h.Add("pathFormatter",PathFormatter); Highcharts.AddFunction("aabbce9a-5e66-48d2-a49c-1dcd9ec70d2e.pathFormatter", PathFormatter); }  
