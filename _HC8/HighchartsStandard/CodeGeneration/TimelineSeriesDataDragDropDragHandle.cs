...
namespace Highsoft.Web.Mvc.Charts
{
	public partial class TimelineSeriesDataDragDropDragHandle  : BaseObject
	{
		...
		internal override Hashtable ToHashtable()
		{
			...
			if (PathFormatter != PathFormatter_DefaultValue) { h.Add("pathFormatter",PathFormatter); Highcharts.AddFunction("3c77c0fb-2355-4c13-822c-beaa13fd7936.pathFormatter", PathFormatter); }  
