...
{
	public partial class TimelineSeriesDataLabels  : BaseObject
	{
		Hashtable h = new Hashtable();

		public TimelineSeriesDataLabels()
		{
			Align = Align_DefaultValue = TimelineSeriesDataLabelsAlign.Center;
			...
			Filter = Filter_DefaultValue = new TimelineSeriesDataLabelsFilter();
			...
			Style = Style_DefaultValue = new TimelineSeriesDataLabelsStyle();
			TextPath = TextPath_DefaultValue = new TimelineSeriesDataLabelsTextPath();
			UseHTML = UseHTML_DefaultValue = false;
			VerticalAlign = VerticalAlign_DefaultValue = TimelineSeriesDataLabelsVerticalAlign.Bottom;
			X = X_DefaultValue = 0;
			Y = Y_DefaultValue = 0;
			Z = Z_DefaultValue = 6;
		...
		/// </summary>
		public TimelineSeriesDataLabelsAlign Align { get; set; }
		private TimelineSeriesDataLabelsAlign Align_DefaultValue { get; set; }
		...
		/// </summary>
		public TimelineSeriesDataLabelsFilter Filter { get; set; }
		private TimelineSeriesDataLabelsFilter Filter_DefaultValue { get; set; }
		...
		/// </summary>
		public TimelineSeriesDataLabelsStyle Style { get; set; }
		private TimelineSeriesDataLabelsStyle Style_DefaultValue { get; set; }
		...
		/// </summary>
		public TimelineSeriesDataLabelsTextPath TextPath { get; set; }
		private TimelineSeriesDataLabelsTextPath TextPath_DefaultValue { get; set; }
		...
		/// </summary>
		public TimelineSeriesDataLabelsVerticalAlign VerticalAlign { get; set; }
		private TimelineSeriesDataLabelsVerticalAlign VerticalAlign_DefaultValue { get; set; }
		...
		internal override Hashtable ToHashtable()
		{
			...
			if (Formatter != Formatter_DefaultValue) { h.Add("formatter",Formatter); Highcharts.AddFunction("31803033-6e67-4b6c-8f7a-6e956a0fb897.formatter", Formatter); }  
			...
			if (NullFormatter != NullFormatter_DefaultValue) { h.Add("nullFormatter",NullFormatter); Highcharts.AddFunction("345a51cc-963c-4048-b372-215506ed8781.nullFormatter", NullFormatter); }  
