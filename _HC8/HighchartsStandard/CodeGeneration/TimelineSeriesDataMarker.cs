...
{
	public partial class TimelineSeriesDataMarker  : BaseObject
	{
		Hashtable h = new Hashtable();

		public TimelineSeriesDataMarker()
		{
			...
			States = States_DefaultValue = new TimelineSeriesDataMarkerStates();
		...
		/// </summary>
		public TimelineSeriesDataMarkerStates States { get; set; }
		private TimelineSeriesDataMarkerStates States_DefaultValue { get; set; }
