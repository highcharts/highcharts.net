...
{
	public partial class TimelineSeriesDragDrop  : BaseObject
	{
		Hashtable h = new Hashtable();

		public TimelineSeriesDragDrop()
		{
			DraggableX = DraggableX_DefaultValue = null;
			DraggableY = DraggableY_DefaultValue = null;
			DragHandle = DragHandle_DefaultValue = new TimelineSeriesDragDropDragHandle();
			...
			GuideBox = GuideBox_DefaultValue = new TimelineSeriesDragDropGuideBox();
		...
		/// </summary>
		public TimelineSeriesDragDropDragHandle DragHandle { get; set; }
		private TimelineSeriesDragDropDragHandle DragHandle_DefaultValue { get; set; }
		...
		/// </summary>
		public TimelineSeriesDragDropGuideBox GuideBox { get; set; }
		private TimelineSeriesDragDropGuideBox GuideBox_DefaultValue { get; set; }
