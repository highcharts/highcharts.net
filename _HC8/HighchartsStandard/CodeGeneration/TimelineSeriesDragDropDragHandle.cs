...
namespace Highsoft.Web.Mvc.Charts
{
	public partial class TimelineSeriesDragDropDragHandle  : BaseObject
	{
		...
		internal override Hashtable ToHashtable()
		{
			...
			if (PathFormatter != PathFormatter_DefaultValue) { h.Add("pathFormatter",PathFormatter); Highcharts.AddFunction("1544cebd-5113-4c0f-9c3f-7b872d5c12cb.pathFormatter", PathFormatter); }  
