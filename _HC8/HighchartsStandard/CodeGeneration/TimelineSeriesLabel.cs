...
{
	public partial class TimelineSeriesLabel  : BaseObject
	{
		Hashtable h = new Hashtable();

		public TimelineSeriesLabel()
		{
			...
			Style = Style_DefaultValue = new TimelineSeriesLabelStyle();
		...
		/// </summary>
		public TimelineSeriesLabelStyle Style { get; set; }
		private TimelineSeriesLabelStyle Style_DefaultValue { get; set; }
		...
		internal override Hashtable ToHashtable()
		{
			...
			if (Formatter != Formatter_DefaultValue) { h.Add("formatter",Formatter); Highcharts.AddFunction("1f8db998-35c7-45e9-8aec-560eaaef5aba.formatter", Formatter); }  
