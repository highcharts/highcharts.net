...
{
	public partial class TimelineSeriesMarker  : BaseObject
	{
		Hashtable h = new Hashtable();

		public TimelineSeriesMarker()
		{
			...
			States = States_DefaultValue = new TimelineSeriesMarkerStates();
		...
		/// </summary>
		public TimelineSeriesMarkerStates States { get; set; }
		private TimelineSeriesMarkerStates States_DefaultValue { get; set; }
