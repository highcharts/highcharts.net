...
{
	public partial class TimelineSeriesOnPoint  : BaseObject
	{
		Hashtable h = new Hashtable();

		public TimelineSeriesOnPoint()
		{
			ConnectorOptions = ConnectorOptions_DefaultValue = new TimelineSeriesOnPointConnectorOptions();
			Id = Id_DefaultValue = "";
			Position = Position_DefaultValue = new TimelineSeriesOnPointPosition();
		...
		/// </summary>
		public TimelineSeriesOnPointConnectorOptions ConnectorOptions { get; set; }
		private TimelineSeriesOnPointConnectorOptions ConnectorOptions_DefaultValue { get; set; }
		...
		/// </summary>
		public TimelineSeriesOnPointPosition Position { get; set; }
		private TimelineSeriesOnPointPosition Position_DefaultValue { get; set; }
