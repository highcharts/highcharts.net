...
{
	public partial class TimelineSeriesSonificationDefaultInstrumentOptions  : BaseObject
	{
		Hashtable h = new Hashtable();

		public TimelineSeriesSonificationDefaultInstrumentOptions()
		{
			ActiveWhen = ActiveWhen_DefaultValue = new TimelineSeriesSonificationDefaultInstrumentOptionsActiveWhen();
			Instrument = Instrument_DefaultValue = null;
			InstrumentString = InstrumentString_DefaultValue = "null";
			Mapping = Mapping_DefaultValue = new TimelineSeriesSonificationDefaultInstrumentOptionsMapping();
			MidiName = MidiName_DefaultValue = "";
			PointGrouping = PointGrouping_DefaultValue = new TimelineSeriesSonificationDefaultInstrumentOptionsPointGrouping();
			RoundToMusicalNotes = RoundToMusicalNotes_DefaultValue = true;
			ShowPlayMarker = ShowPlayMarker_DefaultValue = true;
			Type = Type_DefaultValue = TimelineSeriesSonificationDefaultInstrumentOptionsType.Instrument;
		...
		/// </summary>
		public TimelineSeriesSonificationDefaultInstrumentOptionsActiveWhen ActiveWhen { get; set; }
		private TimelineSeriesSonificationDefaultInstrumentOptionsActiveWhen ActiveWhen_DefaultValue { get; set; }
		...
		/// </summary>
		public TimelineSeriesSonificationDefaultInstrumentOptionsMapping Mapping { get; set; }
		private TimelineSeriesSonificationDefaultInstrumentOptionsMapping Mapping_DefaultValue { get; set; }
		...
		/// </summary>
		public TimelineSeriesSonificationDefaultInstrumentOptionsPointGrouping PointGrouping { get; set; }
		private TimelineSeriesSonificationDefaultInstrumentOptionsPointGrouping PointGrouping_DefaultValue { get; set; }
		...
		/// </summary>
		public TimelineSeriesSonificationDefaultInstrumentOptionsType Type { get; set; }
		private TimelineSeriesSonificationDefaultInstrumentOptionsType Type_DefaultValue { get; set; }
