...
{
	public partial class TimelineSeriesStatesSelect  : BaseObject
	{
		Hashtable h = new Hashtable();

		public TimelineSeriesStatesSelect()
		{
			Animation = Animation_DefaultValue = new Animation() { Enabled = true };
			Enabled = Enabled_DefaultValue = null;
			Halo = Halo_DefaultValue = new TimelineSeriesStatesSelectHalo();
			LineWidth = LineWidth_DefaultValue = null;
			LineWidthPlus = LineWidthPlus_DefaultValue = null;
			Marker = Marker_DefaultValue = new TimelineSeriesStatesSelectMarker();
		...
		/// </summary>
		public TimelineSeriesStatesSelectHalo Halo { get; set; }
		private TimelineSeriesStatesSelectHalo Halo_DefaultValue { get; set; }
		...
		/// </summary>
		public TimelineSeriesStatesSelectMarker Marker { get; set; }
		private TimelineSeriesStatesSelectMarker Marker_DefaultValue { get; set; }
