...
{
	public partial class TreegraphSeriesBreadcrumbs  : BaseObject
	{
		Hashtable h = new Hashtable();

		public TreegraphSeriesBreadcrumbs()
		{
			ButtonSpacing = ButtonSpacing_DefaultValue = 5;
			ButtonTheme = ButtonTheme_DefaultValue = new TreegraphSeriesBreadcrumbsButtonTheme();
			Events = Events_DefaultValue = new TreegraphSeriesBreadcrumbsEvents();
			Floating = Floating_DefaultValue = false;
			Format = Format_DefaultValue = "undefined";
			Formatter = Formatter_DefaultValue = "";
			Position = Position_DefaultValue = new TreegraphSeriesBreadcrumbsPosition();
			RelativeTo = RelativeTo_DefaultValue = "plotBox";
			Rtl = Rtl_DefaultValue = false;
			Separator = Separator_DefaultValue = new TreegraphSeriesBreadcrumbsSeparator();
		...
		/// </summary>
		public TreegraphSeriesBreadcrumbsButtonTheme ButtonTheme { get; set; }
		private TreegraphSeriesBreadcrumbsButtonTheme ButtonTheme_DefaultValue { get; set; }
		 

		/// <summary>
		/// 
		/// </summary>
		public TreegraphSeriesBreadcrumbsEvents Events { get; set; }
		private TreegraphSeriesBreadcrumbsEvents Events_DefaultValue { get; set; }
		...
		/// </summary>
		public TreegraphSeriesBreadcrumbsPosition Position { get; set; }
		private TreegraphSeriesBreadcrumbsPosition Position_DefaultValue { get; set; }
		...
		/// </summary>
		public TreegraphSeriesBreadcrumbsSeparator Separator { get; set; }
		private TreegraphSeriesBreadcrumbsSeparator Separator_DefaultValue { get; set; }
