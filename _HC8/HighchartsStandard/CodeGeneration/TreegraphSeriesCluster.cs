...
{
	public partial class TreegraphSeriesCluster  : BaseObject
	{
		Hashtable h = new Hashtable();

		public TreegraphSeriesCluster()
		{
			AllowOverlap = AllowOverlap_DefaultValue = true;
			Animation = Animation_DefaultValue = new Animation();
			AnimationBool = AnimationBool_DefaultValue = null;
			DataLabels = DataLabels_DefaultValue = new TreegraphSeriesClusterDataLabels();
			DrillToCluster = DrillToCluster_DefaultValue = true;
			Enabled = Enabled_DefaultValue = false;
			Events = Events_DefaultValue = new TreegraphSeriesClusterEvents();
			LayoutAlgorithm = LayoutAlgorithm_DefaultValue = new TreegraphSeriesClusterLayoutAlgorithm();
			Marker = Marker_DefaultValue = new TreegraphSeriesClusterMarker();
			MinimumClusterSize = MinimumClusterSize_DefaultValue = 2;
			States = States_DefaultValue = new TreegraphSeriesClusterStates();
			Zones = Zones_DefaultValue = new List<TreegraphSeriesClusterZone>();
		...
		/// </summary>
		public TreegraphSeriesClusterDataLabels DataLabels { get; set; }
		private TreegraphSeriesClusterDataLabels DataLabels_DefaultValue { get; set; }
		...
		/// 
		/// </summary>
		public TreegraphSeriesClusterEvents Events { get; set; }
		private TreegraphSeriesClusterEvents Events_DefaultValue { get; set; }
		 

		/// <summary>
		/// Options for layout algorithm. Inside thereare options to change the type of the algorithm, gridSize,distance or iterations.
		/// </summary>
		public TreegraphSeriesClusterLayoutAlgorithm LayoutAlgorithm { get; set; }
		private TreegraphSeriesClusterLayoutAlgorithm LayoutAlgorithm_DefaultValue { get; set; }
		 

		/// <summary>
		/// Options for the cluster marker.
		/// </summary>
		public TreegraphSeriesClusterMarker Marker { get; set; }
		private TreegraphSeriesClusterMarker Marker_DefaultValue { get; set; }
		...
		/// 
		/// </summary>
		public TreegraphSeriesClusterStates States { get; set; }
		private TreegraphSeriesClusterStates States_DefaultValue { get; set; }
		...
		/// </summary>
		public List<TreegraphSeriesClusterZone> Zones { get; set; }
		private List<TreegraphSeriesClusterZone> Zones_DefaultValue { get; set; }
