...
{
	public partial class TreegraphSeriesClusterMarker  : BaseObject
	{
		Hashtable h = new Hashtable();

		public TreegraphSeriesClusterMarker()
		{
			...
			States = States_DefaultValue = new TreegraphSeriesClusterMarkerStates();
		...
		/// </summary>
		public TreegraphSeriesClusterMarkerStates States { get; set; }
		private TreegraphSeriesClusterMarkerStates States_DefaultValue { get; set; }
