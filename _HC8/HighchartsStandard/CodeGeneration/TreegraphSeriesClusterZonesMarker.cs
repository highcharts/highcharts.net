...
{
	public partial class TreegraphSeriesClusterZonesMarker  : BaseObject
	{
		Hashtable h = new Hashtable();

		public TreegraphSeriesClusterZonesMarker()
		{
			...
			States = States_DefaultValue = new TreegraphSeriesClusterZonesMarkerStates();
		...
		/// </summary>
		public TreegraphSeriesClusterZonesMarkerStates States { get; set; }
		private TreegraphSeriesClusterZonesMarkerStates States_DefaultValue { get; set; }
