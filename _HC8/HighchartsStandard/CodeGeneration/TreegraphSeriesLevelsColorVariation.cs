...
namespace Highsoft.Web.Mvc.Charts
{
	public partial class TreegraphSeriesLevelsColorVariation  : BaseObject
	{
		...
		{
			Key = Key_DefaultValue = TreegraphSeriesLevelsColorVariationKey.Null;
		...
		/// </summary>
		public TreegraphSeriesLevelsColorVariationKey Key { get; set; }
		private TreegraphSeriesLevelsColorVariationKey Key_DefaultValue { get; set; }
