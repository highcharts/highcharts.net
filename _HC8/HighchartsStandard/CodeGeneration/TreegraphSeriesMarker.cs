...
{
	public partial class TreegraphSeriesMarker  : BaseObject
	{
		Hashtable h = new Hashtable();

		public TreegraphSeriesMarker()
		{
			...
			States = States_DefaultValue = new TreegraphSeriesMarkerStates();
		...
		/// </summary>
		public TreegraphSeriesMarkerStates States { get; set; }
		private TreegraphSeriesMarkerStates States_DefaultValue { get; set; }
