...
{
	public partial class TreegraphSeriesOnPoint  : BaseObject
	{
		Hashtable h = new Hashtable();

		public TreegraphSeriesOnPoint()
		{
			ConnectorOptions = ConnectorOptions_DefaultValue = new TreegraphSeriesOnPointConnectorOptions();
			Id = Id_DefaultValue = "";
			Position = Position_DefaultValue = new TreegraphSeriesOnPointPosition();
		...
		/// </summary>
		public TreegraphSeriesOnPointConnectorOptions ConnectorOptions { get; set; }
		private TreegraphSeriesOnPointConnectorOptions ConnectorOptions_DefaultValue { get; set; }
		...
		/// </summary>
		public TreegraphSeriesOnPointPosition Position { get; set; }
		private TreegraphSeriesOnPointPosition Position_DefaultValue { get; set; }
