...
{
	public partial class TreegraphSeriesSonification  : BaseObject
	{
		...
		/// </summary>
		public TreegraphSeriesSonificationContextTracks ContextTracks { get; set; }
		private TreegraphSeriesSonificationContextTracks ContextTracks_DefaultValue { get; set; }
		 

		/// <summary>
		/// Default options for all this series' instrument tracks.
		/// </summary>
		public TreegraphSeriesSonificationDefaultInstrumentOptions DefaultInstrumentOptions { get; set; }
		private TreegraphSeriesSonificationDefaultInstrumentOptions DefaultInstrumentOptions_DefaultValue { get; set; }
		 

		/// <summary>
		/// Default options for all this series' speech tracks.
		/// </summary>
		public TreegraphSeriesSonificationDefaultSpeechOptions DefaultSpeechOptions { get; set; }
		private TreegraphSeriesSonificationDefaultSpeechOptions DefaultSpeechOptions_DefaultValue { get; set; }
		...
		/// </summary>
		public TreegraphSeriesSonificationPointGrouping PointGrouping { get; set; }
		private TreegraphSeriesSonificationPointGrouping PointGrouping_DefaultValue { get; set; }
		 

		/// <summary>
		/// Tracks for this series.Given as an array of instrument tracks, speech tracks, or a mix of both.
		/// </summary>
		public TreegraphSeriesSonificationTracks Tracks { get; set; }
		private TreegraphSeriesSonificationTracks Tracks_DefaultValue { get; set; }
