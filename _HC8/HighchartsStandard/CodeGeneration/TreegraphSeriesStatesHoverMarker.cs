...
{
	public partial class TreegraphSeriesStatesHoverMarker  : BaseObject
	{
		Hashtable h = new Hashtable();

		public TreegraphSeriesStatesHoverMarker()
		{
			...
			States = States_DefaultValue = new TreegraphSeriesStatesHoverMarkerStates();
		...
		/// </summary>
		public TreegraphSeriesStatesHoverMarkerStates States { get; set; }
		private TreegraphSeriesStatesHoverMarkerStates States_DefaultValue { get; set; }
