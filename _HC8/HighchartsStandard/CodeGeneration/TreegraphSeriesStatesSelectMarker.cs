...
{
	public partial class TreegraphSeriesStatesSelectMarker  : BaseObject
	{
		Hashtable h = new Hashtable();

		public TreegraphSeriesStatesSelectMarker()
		{
			...
			States = States_DefaultValue = new TreegraphSeriesStatesSelectMarkerStates();
		...
		/// </summary>
		public TreegraphSeriesStatesSelectMarkerStates States { get; set; }
		private TreegraphSeriesStatesSelectMarkerStates States_DefaultValue { get; set; }
