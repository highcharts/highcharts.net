...
{
	public partial class TreegraphSeriesTooltip  : BaseObject
	{
		Hashtable h = new Hashtable();

		public TreegraphSeriesTooltip()
		{
			...
			HeaderShape = HeaderShape_DefaultValue = TreegraphSeriesTooltipHeaderShape.Callout;
		...
		/// </summary>
		public TreegraphSeriesTooltipHeaderShape HeaderShape { get; set; }
		private TreegraphSeriesTooltipHeaderShape HeaderShape_DefaultValue { get; set; }
