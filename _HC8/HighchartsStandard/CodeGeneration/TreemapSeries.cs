...
namespace Highsoft.Web.Mvc.Charts
{
	public partial class TreemapSeries  : Series
	{
		...
		public TreemapSeries()
		{
			...
			Type = Type_DefaultValue = TreemapSeriesType.Treemap;
		...
		internal override Hashtable ToHashtable()
		{
			...
			if (PointDescriptionFormatter != PointDescriptionFormatter_DefaultValue) { h.Add("pointDescriptionFormatter",PointDescriptionFormatter); Highcharts.AddFunction("84035ace-fe8d-415c-a981-eb636a803bc8.pointDescriptionFormatter", PointDescriptionFormatter); }  
