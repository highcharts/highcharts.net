...
namespace Highsoft.Web.Mvc.Charts
{
	public partial class TreemapSeries  : Series
	{
		...
		internal override Hashtable ToHashtable()
		{
			...
			if (PointDescriptionFormatter != PointDescriptionFormatter_DefaultValue) { h.Add("pointDescriptionFormatter",PointDescriptionFormatter); Highcharts.AddFunction("afe3c2a6-c3f2-4f51-ba6a-ebbfffed3229.pointDescriptionFormatter", PointDescriptionFormatter); }  
