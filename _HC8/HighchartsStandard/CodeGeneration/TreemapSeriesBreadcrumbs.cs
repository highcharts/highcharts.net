...
{
	public partial class TreemapSeriesBreadcrumbs  : BaseObject
	{
		Hashtable h = new Hashtable();

		public TreemapSeriesBreadcrumbs()
		{
			ButtonSpacing = ButtonSpacing_DefaultValue = 5;
			ButtonTheme = ButtonTheme_DefaultValue = new TreemapSeriesBreadcrumbsButtonTheme();
			Events = Events_DefaultValue = new TreemapSeriesBreadcrumbsEvents();
			Floating = Floating_DefaultValue = false;
			Format = Format_DefaultValue = "undefined";
			Formatter = Formatter_DefaultValue = "";
			Position = Position_DefaultValue = new TreemapSeriesBreadcrumbsPosition();
			RelativeTo = RelativeTo_DefaultValue = "plotBox";
			Rtl = Rtl_DefaultValue = false;
			Separator = Separator_DefaultValue = new TreemapSeriesBreadcrumbsSeparator();
		...
		/// </summary>
		public TreemapSeriesBreadcrumbsButtonTheme ButtonTheme { get; set; }
		private TreemapSeriesBreadcrumbsButtonTheme ButtonTheme_DefaultValue { get; set; }
		 

		/// <summary>
		/// 
		/// </summary>
		public TreemapSeriesBreadcrumbsEvents Events { get; set; }
		private TreemapSeriesBreadcrumbsEvents Events_DefaultValue { get; set; }
		...
		/// </summary>
		public TreemapSeriesBreadcrumbsPosition Position { get; set; }
		private TreemapSeriesBreadcrumbsPosition Position_DefaultValue { get; set; }
		...
		/// </summary>
		public TreemapSeriesBreadcrumbsSeparator Separator { get; set; }
		private TreemapSeriesBreadcrumbsSeparator Separator_DefaultValue { get; set; }
