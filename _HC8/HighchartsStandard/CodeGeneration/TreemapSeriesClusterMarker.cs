...
{
	public partial class TreemapSeriesClusterMarker  : BaseObject
	{
		Hashtable h = new Hashtable();

		public TreemapSeriesClusterMarker()
		{
			...
			States = States_DefaultValue = new TreemapSeriesClusterMarkerStates();
		...
		/// </summary>
		public TreemapSeriesClusterMarkerStates States { get; set; }
		private TreemapSeriesClusterMarkerStates States_DefaultValue { get; set; }
