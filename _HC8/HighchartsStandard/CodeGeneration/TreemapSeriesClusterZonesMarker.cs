...
{
	public partial class TreemapSeriesClusterZonesMarker  : BaseObject
	{
		Hashtable h = new Hashtable();

		public TreemapSeriesClusterZonesMarker()
		{
			...
			States = States_DefaultValue = new TreemapSeriesClusterZonesMarkerStates();
		...
		/// </summary>
		public TreemapSeriesClusterZonesMarkerStates States { get; set; }
		private TreemapSeriesClusterZonesMarkerStates States_DefaultValue { get; set; }
