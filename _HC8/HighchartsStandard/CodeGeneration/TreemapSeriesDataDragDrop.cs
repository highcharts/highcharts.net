...
{
	public partial class TreemapSeriesDataDragDrop  : BaseObject
	{
		Hashtable h = new Hashtable();

		public TreemapSeriesDataDragDrop()
		{
			DraggableX = DraggableX_DefaultValue = null;
			DraggableY = DraggableY_DefaultValue = null;
			DragHandle = DragHandle_DefaultValue = new TreemapSeriesDataDragDropDragHandle();
			...
			GuideBox = GuideBox_DefaultValue = new TreemapSeriesDataDragDropGuideBox();
		...
		/// </summary>
		public TreemapSeriesDataDragDropDragHandle DragHandle { get; set; }
		private TreemapSeriesDataDragDropDragHandle DragHandle_DefaultValue { get; set; }
		...
		/// </summary>
		public TreemapSeriesDataDragDropGuideBox GuideBox { get; set; }
		private TreemapSeriesDataDragDropGuideBox GuideBox_DefaultValue { get; set; }
