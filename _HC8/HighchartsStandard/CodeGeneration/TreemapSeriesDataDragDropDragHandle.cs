...
namespace Highsoft.Web.Mvc.Charts
{
	public partial class TreemapSeriesDataDragDropDragHandle  : BaseObject
	{
		...
		internal override Hashtable ToHashtable()
		{
			...
			if (PathFormatter != PathFormatter_DefaultValue) { h.Add("pathFormatter",PathFormatter); Highcharts.AddFunction("f886a87c-a3cb-4245-b571-8acaf371ad42.pathFormatter", PathFormatter); }  
