...
namespace Highsoft.Web.Mvc.Charts
{
	public partial class TreemapSeriesDataDragDropDragHandle  : BaseObject
	{
		...
		internal override Hashtable ToHashtable()
		{
			...
			if (PathFormatter != PathFormatter_DefaultValue) { h.Add("pathFormatter",PathFormatter); Highcharts.AddFunction("545d510d-f490-472b-9ac8-9ccb76a0ce64.pathFormatter", PathFormatter); }  
