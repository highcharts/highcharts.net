...
namespace Highsoft.Web.Mvc.Charts
{
	public partial class TreemapSeriesDataDragDropDragHandle  : BaseObject
	{
		...
		internal override Hashtable ToHashtable()
		{
			...
			if (PathFormatter != PathFormatter_DefaultValue) { h.Add("pathFormatter",PathFormatter); Highcharts.AddFunction("2c7a0c02-de3f-45e7-88a3-5633852eeb66.pathFormatter", PathFormatter); }  
