...
namespace Highsoft.Web.Mvc.Charts
{
	public partial class TreemapSeriesDataLabels  : BaseObject
	{
		...
		{
			Align = Align_DefaultValue = TreemapSeriesDataLabelsAlign.Center;
			...
			Filter = Filter_DefaultValue = new TreemapSeriesDataLabelsFilter();
			...
			Style = Style_DefaultValue = new TreemapSeriesDataLabelsStyle();
			TextPath = TextPath_DefaultValue = new TreemapSeriesDataLabelsTextPath();
			UseHTML = UseHTML_DefaultValue = false;
			VerticalAlign = VerticalAlign_DefaultValue = TreemapSeriesDataLabelsVerticalAlign.Bottom;
			X = X_DefaultValue = 0;
			Y = Y_DefaultValue = 0;
			Z = Z_DefaultValue = 6;
		...
		/// </summary>
		public TreemapSeriesDataLabelsAlign Align { get; set; }
		private TreemapSeriesDataLabelsAlign Align_DefaultValue { get; set; }
		...
		/// </summary>
		public TreemapSeriesDataLabelsFilter Filter { get; set; }
		private TreemapSeriesDataLabelsFilter Filter_DefaultValue { get; set; }
		...
		/// </summary>
		public TreemapSeriesDataLabelsStyle Style { get; set; }
		private TreemapSeriesDataLabelsStyle Style_DefaultValue { get; set; }
		...
		/// </summary>
		public TreemapSeriesDataLabelsTextPath TextPath { get; set; }
		private TreemapSeriesDataLabelsTextPath TextPath_DefaultValue { get; set; }
		...
		internal override Hashtable ToHashtable()
		{
			...
			if (Formatter != Formatter_DefaultValue) { h.Add("formatter",Formatter); Highcharts.AddFunction("c598ff72-64af-44f1-8bb7-824dafc65917.formatter", Formatter); }  
			...
			if (NullFormatter != NullFormatter_DefaultValue) { h.Add("nullFormatter",NullFormatter); Highcharts.AddFunction("c46ea3aa-72b5-456d-9c93-b7cd28079a04.nullFormatter", NullFormatter); }  
