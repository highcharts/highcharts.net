...
{
	public partial class TreemapSeriesOnPoint  : BaseObject
	{
		Hashtable h = new Hashtable();

		public TreemapSeriesOnPoint()
		{
			ConnectorOptions = ConnectorOptions_DefaultValue = new TreemapSeriesOnPointConnectorOptions();
			Id = Id_DefaultValue = "";
			Position = Position_DefaultValue = new TreemapSeriesOnPointPosition();
		...
		/// </summary>
		public TreemapSeriesOnPointConnectorOptions ConnectorOptions { get; set; }
		private TreemapSeriesOnPointConnectorOptions ConnectorOptions_DefaultValue { get; set; }
		...
		/// </summary>
		public TreemapSeriesOnPointPosition Position { get; set; }
		private TreemapSeriesOnPointPosition Position_DefaultValue { get; set; }
