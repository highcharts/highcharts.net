...
{
	public partial class TreemapSeriesStates  : BaseObject
	{
		...
		public TreemapSeriesStates()
		{
			...
			Inactive = Inactive_DefaultValue = new TreemapSeriesStatesInactive();
			Normal = Normal_DefaultValue = new TreemapSeriesStatesNormal();
			Select = Select_DefaultValue = new TreemapSeriesStatesSelect();
		...
		/// </summary>
		public TreemapSeriesStatesInactive Inactive { get; set; }
		private TreemapSeriesStatesInactive Inactive_DefaultValue { get; set; }
		...
		/// </summary>
		public TreemapSeriesStatesSelect Select { get; set; }
		private TreemapSeriesStatesSelect Select_DefaultValue { get; set; }
