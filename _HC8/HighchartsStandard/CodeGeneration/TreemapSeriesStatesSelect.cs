...
{
	public partial class TreemapSeriesStatesSelect  : BaseObject
	{
		Hashtable h = new Hashtable();

		public TreemapSeriesStatesSelect()
		{
			Animation = Animation_DefaultValue = new Animation();
			Enabled = Enabled_DefaultValue = null;
			Halo = Halo_DefaultValue = new TreemapSeriesStatesSelectHalo();
			LineWidth = LineWidth_DefaultValue = null;
			LineWidthPlus = LineWidthPlus_DefaultValue = null;
			Marker = Marker_DefaultValue = new TreemapSeriesStatesSelectMarker();
		...
		/// </summary>
		public TreemapSeriesStatesSelectHalo Halo { get; set; }
		private TreemapSeriesStatesSelectHalo Halo_DefaultValue { get; set; }
		...
		/// </summary>
		public TreemapSeriesStatesSelectMarker Marker { get; set; }
		private TreemapSeriesStatesSelectMarker Marker_DefaultValue { get; set; }
