...
namespace Highsoft.Web.Mvc.Charts
{
	public partial class VariablepieSeriesData  : BaseObject
	{
		...
		public VariablepieSeriesData()
		{
			...
			Marker = Marker_DefaultValue = new VariablepieSeriesDataMarker();
		...
		/// </summary>
		public VariablepieSeriesDataMarker Marker { get; set; }
		private VariablepieSeriesDataMarker Marker_DefaultValue { get; set; }
