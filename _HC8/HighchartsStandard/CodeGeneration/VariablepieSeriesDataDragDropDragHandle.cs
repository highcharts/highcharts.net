...
namespace Highsoft.Web.Mvc.Charts
{
	public partial class VariablepieSeriesDataDragDropDragHandle  : BaseObject
	{
		...
		internal override Hashtable ToHashtable()
		{
			...
			if (PathFormatter != PathFormatter_DefaultValue) { h.Add("pathFormatter",PathFormatter); Highcharts.AddFunction("30583c95-4a09-4b76-a30a-6112c6dbafe7.pathFormatter", PathFormatter); }  
