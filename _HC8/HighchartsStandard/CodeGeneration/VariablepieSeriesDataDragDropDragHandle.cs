...
namespace Highsoft.Web.Mvc.Charts
{
	public partial class VariablepieSeriesDataDragDropDragHandle  : BaseObject
	{
		...
		internal override Hashtable ToHashtable()
		{
			...
			if (PathFormatter != PathFormatter_DefaultValue) { h.Add("pathFormatter",PathFormatter); Highcharts.AddFunction("66febb52-0b3c-47fb-a853-3e598cc39068.pathFormatter", PathFormatter); }  
