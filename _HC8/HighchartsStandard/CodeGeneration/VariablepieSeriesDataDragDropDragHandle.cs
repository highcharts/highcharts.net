...
namespace Highsoft.Web.Mvc.Charts
{
	public partial class VariablepieSeriesDataDragDropDragHandle  : BaseObject
	{
		...
		internal override Hashtable ToHashtable()
		{
			...
			if (PathFormatter != PathFormatter_DefaultValue) { h.Add("pathFormatter",PathFormatter); Highcharts.AddFunction("751b5639-85dd-479e-8ea4-2e23b59d05b7.pathFormatter", PathFormatter); }  
