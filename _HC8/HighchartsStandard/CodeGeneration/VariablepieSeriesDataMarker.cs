...
{
	public partial class VariablepieSeriesDataMarker  : BaseObject
	{
		Hashtable h = new Hashtable();

		public VariablepieSeriesDataMarker()
		{
			...
			States = States_DefaultValue = new VariablepieSeriesDataMarkerStates();
		...
		/// </summary>
		public VariablepieSeriesDataMarkerStates States { get; set; }
		private VariablepieSeriesDataMarkerStates States_DefaultValue { get; set; }
