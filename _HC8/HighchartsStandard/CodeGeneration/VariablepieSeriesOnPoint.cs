...
{
	public partial class VariablepieSeriesOnPoint  : BaseObject
	{
		Hashtable h = new Hashtable();

		public VariablepieSeriesOnPoint()
		{
			ConnectorOptions = ConnectorOptions_DefaultValue = new VariablepieSeriesOnPointConnectorOptions();
			Id = Id_DefaultValue = "";
			Position = Position_DefaultValue = new VariablepieSeriesOnPointPosition();
		...
		/// </summary>
		public VariablepieSeriesOnPointConnectorOptions ConnectorOptions { get; set; }
		private VariablepieSeriesOnPointConnectorOptions ConnectorOptions_DefaultValue { get; set; }
		...
		/// </summary>
		public VariablepieSeriesOnPointPosition Position { get; set; }
		private VariablepieSeriesOnPointPosition Position_DefaultValue { get; set; }
