...
{
	public partial class VariablepieSeriesSonificationTracks  : BaseObject
	{
		Hashtable h = new Hashtable();

		public VariablepieSeriesSonificationTracks()
		{
			ActiveWhen = ActiveWhen_DefaultValue = new VariablepieSeriesSonificationTracksActiveWhen();
			Instrument = Instrument_DefaultValue = null;
			InstrumentString = InstrumentString_DefaultValue = "null";
			Mapping = Mapping_DefaultValue = new VariablepieSeriesSonificationTracksMapping();
			MidiName = MidiName_DefaultValue = "";
			PointGrouping = PointGrouping_DefaultValue = new VariablepieSeriesSonificationTracksPointGrouping();
			RoundToMusicalNotes = RoundToMusicalNotes_DefaultValue = true;
			ShowPlayMarker = ShowPlayMarker_DefaultValue = true;
			Type = Type_DefaultValue = VariablepieSeriesSonificationTracksType.Instrument;
		...
		/// </summary>
		public VariablepieSeriesSonificationTracksActiveWhen ActiveWhen { get; set; }
		private VariablepieSeriesSonificationTracksActiveWhen ActiveWhen_DefaultValue { get; set; }
		...
		/// </summary>
		public VariablepieSeriesSonificationTracksMapping Mapping { get; set; }
		private VariablepieSeriesSonificationTracksMapping Mapping_DefaultValue { get; set; }
		...
		/// </summary>
		public VariablepieSeriesSonificationTracksPointGrouping PointGrouping { get; set; }
		private VariablepieSeriesSonificationTracksPointGrouping PointGrouping_DefaultValue { get; set; }
		...
		/// </summary>
		public VariablepieSeriesSonificationTracksType Type { get; set; }
		private VariablepieSeriesSonificationTracksType Type_DefaultValue { get; set; }
