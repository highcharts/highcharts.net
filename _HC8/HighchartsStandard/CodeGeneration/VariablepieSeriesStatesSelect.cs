...
{
	public partial class VariablepieSeriesStatesSelect  : BaseObject
	{
		Hashtable h = new Hashtable();

		public VariablepieSeriesStatesSelect()
		{
			Animation = Animation_DefaultValue = new Animation() { Enabled = true };
			Enabled = Enabled_DefaultValue = null;
			Halo = Halo_DefaultValue = new VariablepieSeriesStatesSelectHalo();
			LineWidth = LineWidth_DefaultValue = null;
			LineWidthPlus = LineWidthPlus_DefaultValue = null;
			Marker = Marker_DefaultValue = new VariablepieSeriesStatesSelectMarker();
		...
		/// </summary>
		public VariablepieSeriesStatesSelectHalo Halo { get; set; }
		private VariablepieSeriesStatesSelectHalo Halo_DefaultValue { get; set; }
		...
		/// </summary>
		public VariablepieSeriesStatesSelectMarker Marker { get; set; }
		private VariablepieSeriesStatesSelectMarker Marker_DefaultValue { get; set; }
