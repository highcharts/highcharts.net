...
namespace Highsoft.Web.Mvc.Charts
{
	public partial class VariwideSeries  : Series
	{
		...
		public VariwideSeries()
		{
			...
			Type = Type_DefaultValue = VariwideSeriesType.Variwide;
		...
		internal override Hashtable ToHashtable()
		{
			...
			if (PointDescriptionFormatter != PointDescriptionFormatter_DefaultValue) { h.Add("pointDescriptionFormatter",PointDescriptionFormatter); Highcharts.AddFunction("1820469a-9290-40f8-98ee-0f58ae44b7e2.pointDescriptionFormatter", PointDescriptionFormatter); }  
