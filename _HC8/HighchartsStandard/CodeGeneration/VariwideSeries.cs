...
namespace Highsoft.Web.Mvc.Charts
{
	public partial class VariwideSeries  : Series
	{
		...
		internal override Hashtable ToHashtable()
		{
			...
			if (PointDescriptionFormatter != PointDescriptionFormatter_DefaultValue) { h.Add("pointDescriptionFormatter",PointDescriptionFormatter); Highcharts.AddFunction("7a878e99-6026-4416-b7d7-f844e64b0774.pointDescriptionFormatter", PointDescriptionFormatter); }  
