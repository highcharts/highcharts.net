...
namespace Highsoft.Web.Mvc.Charts
{
	public partial class VariwideSeries  : Series
	{
		...
		public VariwideSeries()
		{
			...
			BoostBlending = BoostBlending_DefaultValue = VariwideSeriesBoostBlending.Undefined;
		...
		/// </summary>
		public VariwideSeriesBoostBlending BoostBlending { get; set; }
		private VariwideSeriesBoostBlending BoostBlending_DefaultValue { get; set; }
		...
		internal override Hashtable ToHashtable()
		{
			...
			if (PointDescriptionFormatter != PointDescriptionFormatter_DefaultValue) { h.Add("pointDescriptionFormatter",PointDescriptionFormatter); Highcharts.AddFunction("aac7a27e-8cea-4ccf-8e52-7a7dcd078f6c.pointDescriptionFormatter", PointDescriptionFormatter); }  
