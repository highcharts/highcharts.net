...
{
	public partial class VariwideSeriesData  : BaseObject
	{
		Hashtable h = new Hashtable();

		public VariwideSeriesData()
		{
			Accessibility = Accessibility_DefaultValue = new VariwideSeriesDataAccessibility();
			...
			DragDrop = DragDrop_DefaultValue = new VariwideSeriesDataDragDrop();
			Drilldown = Drilldown_DefaultValue = "";
			Events = Events_DefaultValue = new VariwideSeriesDataEvents();
			Id = Id_DefaultValue = "";
			Labelrank = Labelrank_DefaultValue = null;
			Marker = Marker_DefaultValue = new VariwideSeriesDataMarker();
		...
		/// </summary>
		public VariwideSeriesDataAccessibility Accessibility { get; set; }
		private VariwideSeriesDataAccessibility Accessibility_DefaultValue { get; set; }
		...
		/// </summary>
		public VariwideSeriesDataDragDrop DragDrop { get; set; }
		private VariwideSeriesDataDragDrop DragDrop_DefaultValue { get; set; }
		...
		/// </summary>
		public VariwideSeriesDataEvents Events { get; set; }
		private VariwideSeriesDataEvents Events_DefaultValue { get; set; }
		...
		/// </summary>
		public VariwideSeriesDataMarker Marker { get; set; }
		private VariwideSeriesDataMarker Marker_DefaultValue { get; set; }
