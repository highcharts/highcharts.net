...
namespace Highsoft.Web.Mvc.Charts
{
	public partial class VariwideSeriesDataDragDropDragHandle  : BaseObject
	{
		...
		internal override Hashtable ToHashtable()
		{
			...
			if (PathFormatter != PathFormatter_DefaultValue) { h.Add("pathFormatter",PathFormatter); Highcharts.AddFunction("5dedf6f7-b048-4a08-b190-780488760cf1.pathFormatter", PathFormatter); }  
