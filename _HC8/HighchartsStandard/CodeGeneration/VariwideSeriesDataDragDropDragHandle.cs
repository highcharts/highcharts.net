...
namespace Highsoft.Web.Mvc.Charts
{
	public partial class VariwideSeriesDataDragDropDragHandle  : BaseObject
	{
		...
		internal override Hashtable ToHashtable()
		{
			...
			if (PathFormatter != PathFormatter_DefaultValue) { h.Add("pathFormatter",PathFormatter); Highcharts.AddFunction("0a5192d5-e445-41ed-a854-0feb9e77f1a3.pathFormatter", PathFormatter); }  
