...
namespace Highsoft.Web.Mvc.Charts
{
	public partial class VariwideSeriesDataDragDropDragHandle  : BaseObject
	{
		...
		internal override Hashtable ToHashtable()
		{
			...
			if (PathFormatter != PathFormatter_DefaultValue) { h.Add("pathFormatter",PathFormatter); Highcharts.AddFunction("c7b6f920-39d8-4c9b-afd4-021d850ef86f.pathFormatter", PathFormatter); }  
