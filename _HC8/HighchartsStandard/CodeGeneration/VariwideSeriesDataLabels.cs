...
namespace Highsoft.Web.Mvc.Charts
{
	public partial class VariwideSeriesDataLabels  : BaseObject
	{
		...
		{
			Align = Align_DefaultValue = VariwideSeriesDataLabelsAlign.Center;
			...
			Filter = Filter_DefaultValue = new VariwideSeriesDataLabelsFilter();
			...
			Style = Style_DefaultValue = new VariwideSeriesDataLabelsStyle();
			TextPath = TextPath_DefaultValue = new VariwideSeriesDataLabelsTextPath();
			UseHTML = UseHTML_DefaultValue = false;
			VerticalAlign = VerticalAlign_DefaultValue = VariwideSeriesDataLabelsVerticalAlign.Bottom;
			X = X_DefaultValue = 0;
			Y = Y_DefaultValue = 0;
			Z = Z_DefaultValue = 6;
		...
		/// </summary>
		public VariwideSeriesDataLabelsFilter Filter { get; set; }
		private VariwideSeriesDataLabelsFilter Filter_DefaultValue { get; set; }
		...
		/// </summary>
		public VariwideSeriesDataLabelsStyle Style { get; set; }
		private VariwideSeriesDataLabelsStyle Style_DefaultValue { get; set; }
		...
		/// </summary>
		public VariwideSeriesDataLabelsTextPath TextPath { get; set; }
		private VariwideSeriesDataLabelsTextPath TextPath_DefaultValue { get; set; }
		...
		internal override Hashtable ToHashtable()
		{
			...
			if (Formatter != Formatter_DefaultValue) { h.Add("formatter",Formatter); Highcharts.AddFunction("0bf6adbb-a56e-41f7-80a4-789697850ece.formatter", Formatter); }  
			if (Inside != Inside_DefaultValue) h.Add("inside",Inside);
			if (NullFormat != NullFormat_DefaultValue) h.Add("nullFormat",NullFormat);
			if (NullFormatter != NullFormatter_DefaultValue) { h.Add("nullFormatter",NullFormatter); Highcharts.AddFunction("31c3f8d4-fbd8-4ce5-b1e4-93545b3fb297.nullFormatter", NullFormatter); }  
