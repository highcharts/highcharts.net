...
{
	public partial class VariwideSeriesDataMarker  : BaseObject
	{
		Hashtable h = new Hashtable();

		public VariwideSeriesDataMarker()
		{
			...
			States = States_DefaultValue = new VariwideSeriesDataMarkerStates();
		...
		/// </summary>
		public VariwideSeriesDataMarkerStates States { get; set; }
		private VariwideSeriesDataMarkerStates States_DefaultValue { get; set; }
