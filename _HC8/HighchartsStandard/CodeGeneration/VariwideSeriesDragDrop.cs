...
{
	public partial class VariwideSeriesDragDrop  : BaseObject
	{
		Hashtable h = new Hashtable();

		public VariwideSeriesDragDrop()
		{
			DraggableX = DraggableX_DefaultValue = null;
			DraggableY = DraggableY_DefaultValue = null;
			DragHandle = DragHandle_DefaultValue = new VariwideSeriesDragDropDragHandle();
			...
			GuideBox = GuideBox_DefaultValue = new VariwideSeriesDragDropGuideBox();
		...
		/// </summary>
		public VariwideSeriesDragDropDragHandle DragHandle { get; set; }
		private VariwideSeriesDragDropDragHandle DragHandle_DefaultValue { get; set; }
		...
		/// </summary>
		public VariwideSeriesDragDropGuideBox GuideBox { get; set; }
		private VariwideSeriesDragDropGuideBox GuideBox_DefaultValue { get; set; }
