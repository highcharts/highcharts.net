...
namespace Highsoft.Web.Mvc.Charts
{
	public partial class VariwideSeriesDragDropDragHandle  : BaseObject
	{
		...
		internal override Hashtable ToHashtable()
		{
			...
			if (PathFormatter != PathFormatter_DefaultValue) { h.Add("pathFormatter",PathFormatter); Highcharts.AddFunction("8982d101-1cd8-40a9-8db6-1567e48a88b8.pathFormatter", PathFormatter); }  
