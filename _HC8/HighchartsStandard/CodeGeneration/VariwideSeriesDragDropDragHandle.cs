...
namespace Highsoft.Web.Mvc.Charts
{
	public partial class VariwideSeriesDragDropDragHandle  : BaseObject
	{
		...
		internal override Hashtable ToHashtable()
		{
			...
			if (PathFormatter != PathFormatter_DefaultValue) { h.Add("pathFormatter",PathFormatter); Highcharts.AddFunction("49813f62-f7d5-4d90-999d-68e43313818c.pathFormatter", PathFormatter); }  
