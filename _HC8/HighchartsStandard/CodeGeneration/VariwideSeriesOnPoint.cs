...
{
	public partial class VariwideSeriesOnPoint  : BaseObject
	{
		Hashtable h = new Hashtable();

		public VariwideSeriesOnPoint()
		{
			ConnectorOptions = ConnectorOptions_DefaultValue = new VariwideSeriesOnPointConnectorOptions();
			Id = Id_DefaultValue = "";
			Position = Position_DefaultValue = new VariwideSeriesOnPointPosition();
		...
		/// </summary>
		public VariwideSeriesOnPointConnectorOptions ConnectorOptions { get; set; }
		private VariwideSeriesOnPointConnectorOptions ConnectorOptions_DefaultValue { get; set; }
		...
		/// </summary>
		public VariwideSeriesOnPointPosition Position { get; set; }
		private VariwideSeriesOnPointPosition Position_DefaultValue { get; set; }
