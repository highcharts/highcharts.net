...
{
	public partial class VariwideSeriesSonificationTracks  : BaseObject
	{
		Hashtable h = new Hashtable();

		public VariwideSeriesSonificationTracks()
		{
			ActiveWhen = ActiveWhen_DefaultValue = new VariwideSeriesSonificationTracksActiveWhen();
			Instrument = Instrument_DefaultValue = null;
			InstrumentString = InstrumentString_DefaultValue = "null";
			Mapping = Mapping_DefaultValue = new VariwideSeriesSonificationTracksMapping();
			MidiName = MidiName_DefaultValue = "";
			PointGrouping = PointGrouping_DefaultValue = new VariwideSeriesSonificationTracksPointGrouping();
			RoundToMusicalNotes = RoundToMusicalNotes_DefaultValue = true;
			ShowPlayMarker = ShowPlayMarker_DefaultValue = true;
			Type = Type_DefaultValue = VariwideSeriesSonificationTracksType.Instrument;
		...
		/// </summary>
		public VariwideSeriesSonificationTracksActiveWhen ActiveWhen { get; set; }
		private VariwideSeriesSonificationTracksActiveWhen ActiveWhen_DefaultValue { get; set; }
		...
		/// </summary>
		public VariwideSeriesSonificationTracksMapping Mapping { get; set; }
		private VariwideSeriesSonificationTracksMapping Mapping_DefaultValue { get; set; }
		...
		/// </summary>
		public VariwideSeriesSonificationTracksPointGrouping PointGrouping { get; set; }
		private VariwideSeriesSonificationTracksPointGrouping PointGrouping_DefaultValue { get; set; }
		...
		/// </summary>
		public VariwideSeriesSonificationTracksType Type { get; set; }
		private VariwideSeriesSonificationTracksType Type_DefaultValue { get; set; }
