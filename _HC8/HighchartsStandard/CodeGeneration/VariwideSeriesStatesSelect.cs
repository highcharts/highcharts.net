...
namespace Highsoft.Web.Mvc.Charts
{
	public partial class VariwideSeriesStatesSelect  : BaseObject
	{
		...
		public VariwideSeriesStatesSelect()
		{
			...
			Halo = Halo_DefaultValue = new VariwideSeriesStatesSelectHalo();
			LineWidth = LineWidth_DefaultValue = null;
			LineWidthPlus = LineWidthPlus_DefaultValue = 1;
			Marker = Marker_DefaultValue = new VariwideSeriesStatesSelectMarker();
		...
		/// </summary>
		public VariwideSeriesStatesSelectHalo Halo { get; set; }
		private VariwideSeriesStatesSelectHalo Halo_DefaultValue { get; set; }
		...
		/// </summary>
		public VariwideSeriesStatesSelectMarker Marker { get; set; }
		private VariwideSeriesStatesSelectMarker Marker_DefaultValue { get; set; }
