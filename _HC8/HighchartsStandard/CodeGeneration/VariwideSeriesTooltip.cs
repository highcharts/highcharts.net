...
{
	public partial class VariwideSeriesTooltip  : BaseObject
	{
		...
		public VariwideSeriesTooltip()
		{
			...
			HeaderShape = HeaderShape_DefaultValue = VariwideSeriesTooltipHeaderShape.Callout;
		...
		/// </summary>
		public VariwideSeriesTooltipHeaderShape HeaderShape { get; set; }
		private VariwideSeriesTooltipHeaderShape HeaderShape_DefaultValue { get; set; }
		...
		internal override Hashtable ToHashtable()
		{
			...
			if (NullFormatter != NullFormatter_DefaultValue) { h.Add("nullFormatter",NullFormatter); Highcharts.AddFunction("1879248d-4c55-43b3-bc37-34475f59dad2.nullFormatter", NullFormatter); }  
			if (Outside != Outside_DefaultValue) h.Add("outside",Outside);
			if (Padding != Padding_DefaultValue) h.Add("padding",Padding);
			if (PointFormat != PointFormat_DefaultValue) h.Add("pointFormat",PointFormat);
			if (PointFormatter != PointFormatter_DefaultValue) { h.Add("pointFormatter",PointFormatter); Highcharts.AddFunction("e882b255-d1f8-4b58-8b7e-ed6b9660b230.pointFormatter", PointFormatter); }  
