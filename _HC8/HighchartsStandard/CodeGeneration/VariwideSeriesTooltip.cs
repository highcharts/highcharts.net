...
namespace Highsoft.Web.Mvc.Charts
{
	public partial class VariwideSeriesTooltip  : BaseObject
	{
		...
		internal override Hashtable ToHashtable()
		{
			...
			if (NullFormatter != NullFormatter_DefaultValue) { h.Add("nullFormatter",NullFormatter); Highcharts.AddFunction("951bb7f6-b8ae-4fc2-9f32-f760893b6c99.nullFormatter", NullFormatter); }  
			if (PointFormat != PointFormat_DefaultValue) h.Add("pointFormat",PointFormat);
			if (PointFormatter != PointFormatter_DefaultValue) { h.Add("pointFormatter",PointFormatter); Highcharts.AddFunction("72c6b25c-f284-4b92-ad3c-61a603e51d28.pointFormatter", PointFormatter); }  
