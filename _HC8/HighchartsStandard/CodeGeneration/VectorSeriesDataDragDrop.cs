...
{
	public partial class VectorSeriesDataDragDrop  : BaseObject
	{
		Hashtable h = new Hashtable();

		public VectorSeriesDataDragDrop()
		{
			DraggableX = DraggableX_DefaultValue = null;
			DraggableY = DraggableY_DefaultValue = null;
			DragHandle = DragHandle_DefaultValue = new VectorSeriesDataDragDropDragHandle();
			...
			GuideBox = GuideBox_DefaultValue = new VectorSeriesDataDragDropGuideBox();
		...
		/// </summary>
		public VectorSeriesDataDragDropDragHandle DragHandle { get; set; }
		private VectorSeriesDataDragDropDragHandle DragHandle_DefaultValue { get; set; }
		...
		/// </summary>
		public VectorSeriesDataDragDropGuideBox GuideBox { get; set; }
		private VectorSeriesDataDragDropGuideBox GuideBox_DefaultValue { get; set; }
