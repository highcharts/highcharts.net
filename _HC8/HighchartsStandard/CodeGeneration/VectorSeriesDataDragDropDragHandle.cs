...
namespace Highsoft.Web.Mvc.Charts
{
	public partial class VectorSeriesDataDragDropDragHandle  : BaseObject
	{
		...
		internal override Hashtable ToHashtable()
		{
			...
			if (PathFormatter != PathFormatter_DefaultValue) { h.Add("pathFormatter",PathFormatter); Highcharts.AddFunction("15cb61b5-e8b2-465a-a821-0551b02fe525.pathFormatter", PathFormatter); }  
