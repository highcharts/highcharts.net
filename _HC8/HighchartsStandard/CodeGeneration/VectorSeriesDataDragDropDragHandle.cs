...
namespace Highsoft.Web.Mvc.Charts
{
	public partial class VectorSeriesDataDragDropDragHandle  : BaseObject
	{
		...
		internal override Hashtable ToHashtable()
		{
			...
			if (PathFormatter != PathFormatter_DefaultValue) { h.Add("pathFormatter",PathFormatter); Highcharts.AddFunction("4b8ee469-6b3a-4056-86a2-fa992f45359b.pathFormatter", PathFormatter); }  
