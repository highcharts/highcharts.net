...
{
	public partial class VectorSeriesDataLabels  : BaseObject
	{
		Hashtable h = new Hashtable();

		public VectorSeriesDataLabels()
		{
			Align = Align_DefaultValue = VectorSeriesDataLabelsAlign.Center;
			...
			Filter = Filter_DefaultValue = new VectorSeriesDataLabelsFilter();
			...
			Style = Style_DefaultValue = new VectorSeriesDataLabelsStyle();
			TextPath = TextPath_DefaultValue = new VectorSeriesDataLabelsTextPath();
			UseHTML = UseHTML_DefaultValue = false;
			VerticalAlign = VerticalAlign_DefaultValue = VectorSeriesDataLabelsVerticalAlign.Bottom;
			X = X_DefaultValue = 0;
			Y = Y_DefaultValue = 0;
			Z = Z_DefaultValue = 6;
		...
		/// </summary>
		public VectorSeriesDataLabelsAlign Align { get; set; }
		private VectorSeriesDataLabelsAlign Align_DefaultValue { get; set; }
		...
		/// </summary>
		public VectorSeriesDataLabelsFilter Filter { get; set; }
		private VectorSeriesDataLabelsFilter Filter_DefaultValue { get; set; }
		...
		/// </summary>
		public VectorSeriesDataLabelsStyle Style { get; set; }
		private VectorSeriesDataLabelsStyle Style_DefaultValue { get; set; }
		...
		/// </summary>
		public VectorSeriesDataLabelsTextPath TextPath { get; set; }
		private VectorSeriesDataLabelsTextPath TextPath_DefaultValue { get; set; }
		...
		/// </summary>
		public VectorSeriesDataLabelsVerticalAlign VerticalAlign { get; set; }
		private VectorSeriesDataLabelsVerticalAlign VerticalAlign_DefaultValue { get; set; }
		...
		internal override Hashtable ToHashtable()
		{
			...
			if (Formatter != Formatter_DefaultValue) { h.Add("formatter",Formatter); Highcharts.AddFunction("278d3dab-4344-4f80-a823-5c26a9132518.formatter", Formatter); }  
			if (Inside != Inside_DefaultValue) h.Add("inside",Inside);
			if (NullFormat != NullFormat_DefaultValue) h.Add("nullFormat",NullFormat);
			if (NullFormatter != NullFormatter_DefaultValue) { h.Add("nullFormatter",NullFormatter); Highcharts.AddFunction("07cfa309-1bd8-4637-825d-106d4ab7d683.nullFormatter", NullFormatter); }  
