...
{
	public partial class VectorSeriesDragDrop  : BaseObject
	{
		Hashtable h = new Hashtable();

		public VectorSeriesDragDrop()
		{
			DraggableX = DraggableX_DefaultValue = null;
			DraggableY = DraggableY_DefaultValue = null;
			DragHandle = DragHandle_DefaultValue = new VectorSeriesDragDropDragHandle();
			...
			GuideBox = GuideBox_DefaultValue = new VectorSeriesDragDropGuideBox();
		...
		/// </summary>
		public VectorSeriesDragDropDragHandle DragHandle { get; set; }
		private VectorSeriesDragDropDragHandle DragHandle_DefaultValue { get; set; }
		...
		/// </summary>
		public VectorSeriesDragDropGuideBox GuideBox { get; set; }
		private VectorSeriesDragDropGuideBox GuideBox_DefaultValue { get; set; }
