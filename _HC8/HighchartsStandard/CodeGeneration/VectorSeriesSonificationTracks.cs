...
{
	public partial class VectorSeriesSonificationTracks  : BaseObject
	{
		Hashtable h = new Hashtable();

		public VectorSeriesSonificationTracks()
		{
			ActiveWhen = ActiveWhen_DefaultValue = new VectorSeriesSonificationTracksActiveWhen();
			Instrument = Instrument_DefaultValue = null;
			InstrumentString = InstrumentString_DefaultValue = "null";
			Mapping = Mapping_DefaultValue = new VectorSeriesSonificationTracksMapping();
			MidiName = MidiName_DefaultValue = "";
			PointGrouping = PointGrouping_DefaultValue = new VectorSeriesSonificationTracksPointGrouping();
			RoundToMusicalNotes = RoundToMusicalNotes_DefaultValue = true;
			ShowPlayMarker = ShowPlayMarker_DefaultValue = true;
			Type = Type_DefaultValue = VectorSeriesSonificationTracksType.Instrument;
		...
		/// </summary>
		public VectorSeriesSonificationTracksActiveWhen ActiveWhen { get; set; }
		private VectorSeriesSonificationTracksActiveWhen ActiveWhen_DefaultValue { get; set; }
		...
		/// </summary>
		public VectorSeriesSonificationTracksMapping Mapping { get; set; }
		private VectorSeriesSonificationTracksMapping Mapping_DefaultValue { get; set; }
		...
		/// </summary>
		public VectorSeriesSonificationTracksPointGrouping PointGrouping { get; set; }
		private VectorSeriesSonificationTracksPointGrouping PointGrouping_DefaultValue { get; set; }
		...
		/// </summary>
		public VectorSeriesSonificationTracksType Type { get; set; }
		private VectorSeriesSonificationTracksType Type_DefaultValue { get; set; }
