...
namespace Highsoft.Web.Mvc.Charts
{
	public partial class VennSeries  : Series
	{
		...
		public VennSeries()
		{
			...
			Type = Type_DefaultValue = VennSeriesType.Venn;
		...
		internal override Hashtable ToHashtable()
		{
			...
			if (PointDescriptionFormatter != PointDescriptionFormatter_DefaultValue) { h.Add("pointDescriptionFormatter",PointDescriptionFormatter); Highcharts.AddFunction("f5e022f9-2091-45f7-8e90-d3064a919dc2.pointDescriptionFormatter", PointDescriptionFormatter); }  
