...
namespace Highsoft.Web.Mvc.Charts
{
	public partial class VennSeriesCluster  : BaseObject
	{
		...
		public VennSeriesCluster()
		{
			...
			DataLabels = DataLabels_DefaultValue = new VennSeriesClusterDataLabels();
			DrillToCluster = DrillToCluster_DefaultValue = true;
			Enabled = Enabled_DefaultValue = false;
			Events = Events_DefaultValue = new VennSeriesClusterEvents();
			LayoutAlgorithm = LayoutAlgorithm_DefaultValue = new VennSeriesClusterLayoutAlgorithm();
			Marker = Marker_DefaultValue = new VennSeriesClusterMarker();
			MinimumClusterSize = MinimumClusterSize_DefaultValue = 2;
			States = States_DefaultValue = new VennSeriesClusterStates();
			Zones = Zones_DefaultValue = new List<VennSeriesClusterZone>();
		...
		private VennSeriesClusterDataLabels DataLabels_DefaultValue { get; set; }
		...
		private VennSeriesClusterEvents Events_DefaultValue { get; set; }
		...
		private VennSeriesClusterLayoutAlgorithm LayoutAlgorithm_DefaultValue { get; set; }
		...
		private VennSeriesClusterMarker Marker_DefaultValue { get; set; }
		...
		private VennSeriesClusterStates States_DefaultValue { get; set; }
		...
		private List<VennSeriesClusterZone> Zones_DefaultValue { get; set; }
