...
{
	public partial class VennSeriesClusterZonesMarker  : BaseObject
	{
		Hashtable h = new Hashtable();

		public VennSeriesClusterZonesMarker()
		{
			...
			States = States_DefaultValue = new VennSeriesClusterZonesMarkerStates();
		...
		/// </summary>
		public VennSeriesClusterZonesMarkerStates States { get; set; }
		private VennSeriesClusterZonesMarkerStates States_DefaultValue { get; set; }
