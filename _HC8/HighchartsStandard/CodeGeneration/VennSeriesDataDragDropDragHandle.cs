...
namespace Highsoft.Web.Mvc.Charts
{
	public partial class VennSeriesDataDragDropDragHandle  : BaseObject
	{
		...
		internal override Hashtable ToHashtable()
		{
			...
			if (PathFormatter != PathFormatter_DefaultValue) { h.Add("pathFormatter",PathFormatter); Highcharts.AddFunction("91e18a80-66d7-40e6-b0c0-80900ced9966.pathFormatter", PathFormatter); }  
