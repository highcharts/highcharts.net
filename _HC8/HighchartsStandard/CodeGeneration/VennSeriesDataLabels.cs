...
{
	public partial class VennSeriesDataLabels  : BaseObject
	{
		Hashtable h = new Hashtable();

		public VennSeriesDataLabels()
		{
			Align = Align_DefaultValue = VennSeriesDataLabelsAlign.Center;
			...
			Filter = Filter_DefaultValue = new VennSeriesDataLabelsFilter();
			...
			Style = Style_DefaultValue = new VennSeriesDataLabelsStyle();
			TextPath = TextPath_DefaultValue = new VennSeriesDataLabelsTextPath();
			UseHTML = UseHTML_DefaultValue = false;
			VerticalAlign = VerticalAlign_DefaultValue = VennSeriesDataLabelsVerticalAlign.Bottom;
			X = X_DefaultValue = 0;
			Y = Y_DefaultValue = 0;
			Z = Z_DefaultValue = 6;
		...
		/// </summary>
		public VennSeriesDataLabelsAlign Align { get; set; }
		private VennSeriesDataLabelsAlign Align_DefaultValue { get; set; }
		...
		/// </summary>
		public VennSeriesDataLabelsFilter Filter { get; set; }
		private VennSeriesDataLabelsFilter Filter_DefaultValue { get; set; }
		...
		/// </summary>
		public VennSeriesDataLabelsStyle Style { get; set; }
		private VennSeriesDataLabelsStyle Style_DefaultValue { get; set; }
		...
		/// </summary>
		public VennSeriesDataLabelsTextPath TextPath { get; set; }
		private VennSeriesDataLabelsTextPath TextPath_DefaultValue { get; set; }
		...
		/// </summary>
		public VennSeriesDataLabelsVerticalAlign VerticalAlign { get; set; }
		private VennSeriesDataLabelsVerticalAlign VerticalAlign_DefaultValue { get; set; }
		...
		internal override Hashtable ToHashtable()
		{
			...
			if (Formatter != Formatter_DefaultValue) { h.Add("formatter",Formatter); Highcharts.AddFunction("998e35fa-d1e4-4b77-9f02-be9237957859.formatter", Formatter); }  
			...
			if (NullFormatter != NullFormatter_DefaultValue) { h.Add("nullFormatter",NullFormatter); Highcharts.AddFunction("655acd9a-58a8-4786-94b7-d4a5d88c60c9.nullFormatter", NullFormatter); }  
