...
{
	public partial class VennSeriesDataMarker  : BaseObject
	{
		Hashtable h = new Hashtable();

		public VennSeriesDataMarker()
		{
			...
			States = States_DefaultValue = new VennSeriesDataMarkerStates();
		...
		/// </summary>
		public VennSeriesDataMarkerStates States { get; set; }
		private VennSeriesDataMarkerStates States_DefaultValue { get; set; }
