...
{
	public partial class VennSeriesDragDrop  : BaseObject
	{
		Hashtable h = new Hashtable();

		public VennSeriesDragDrop()
		{
			DraggableX = DraggableX_DefaultValue = null;
			DraggableY = DraggableY_DefaultValue = null;
			DragHandle = DragHandle_DefaultValue = new VennSeriesDragDropDragHandle();
			...
			GuideBox = GuideBox_DefaultValue = new VennSeriesDragDropGuideBox();
		...
		/// </summary>
		public VennSeriesDragDropDragHandle DragHandle { get; set; }
		private VennSeriesDragDropDragHandle DragHandle_DefaultValue { get; set; }
		...
		/// </summary>
		public VennSeriesDragDropGuideBox GuideBox { get; set; }
		private VennSeriesDragDropGuideBox GuideBox_DefaultValue { get; set; }
