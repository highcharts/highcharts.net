...
{
	public partial class VennSeriesOnPoint  : BaseObject
	{
		Hashtable h = new Hashtable();

		public VennSeriesOnPoint()
		{
			ConnectorOptions = ConnectorOptions_DefaultValue = new VennSeriesOnPointConnectorOptions();
			Id = Id_DefaultValue = "";
			Position = Position_DefaultValue = new VennSeriesOnPointPosition();
		...
		/// </summary>
		public VennSeriesOnPointConnectorOptions ConnectorOptions { get; set; }
		private VennSeriesOnPointConnectorOptions ConnectorOptions_DefaultValue { get; set; }
		...
		/// </summary>
		public VennSeriesOnPointPosition Position { get; set; }
		private VennSeriesOnPointPosition Position_DefaultValue { get; set; }
