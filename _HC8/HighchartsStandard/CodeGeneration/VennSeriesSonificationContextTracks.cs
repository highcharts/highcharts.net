...
{
	public partial class VennSeriesSonificationContextTracks  : BaseObject
	{
		Hashtable h = new Hashtable();

		public VennSeriesSonificationContextTracks()
		{
			ActiveWhen = ActiveWhen_DefaultValue = new VennSeriesSonificationContextTracksActiveWhen();
			Instrument = Instrument_DefaultValue = null;
			InstrumentString = InstrumentString_DefaultValue = "null";
			Mapping = Mapping_DefaultValue = new VennSeriesSonificationContextTracksMapping();
			MidiName = MidiName_DefaultValue = "";
			PointGrouping = PointGrouping_DefaultValue = new VennSeriesSonificationContextTracksPointGrouping();
			...
			Type = Type_DefaultValue = VennSeriesSonificationContextTracksType.Instrument;
			ValueInterval = ValueInterval_DefaultValue = null;
			ValueMapFunction = ValueMapFunction_DefaultValue = VennSeriesSonificationContextTracksValueMapFunction.Linear;
		...
		/// </summary>
		public VennSeriesSonificationContextTracksActiveWhen ActiveWhen { get; set; }
		private VennSeriesSonificationContextTracksActiveWhen ActiveWhen_DefaultValue { get; set; }
		...
		/// </summary>
		public VennSeriesSonificationContextTracksMapping Mapping { get; set; }
		private VennSeriesSonificationContextTracksMapping Mapping_DefaultValue { get; set; }
		...
		/// </summary>
		public VennSeriesSonificationContextTracksPointGrouping PointGrouping { get; set; }
		private VennSeriesSonificationContextTracksPointGrouping PointGrouping_DefaultValue { get; set; }
		...
		/// </summary>
		public VennSeriesSonificationContextTracksType Type { get; set; }
		private VennSeriesSonificationContextTracksType Type_DefaultValue { get; set; }
		...
		/// </summary>
		public VennSeriesSonificationContextTracksValueMapFunction ValueMapFunction { get; set; }
		private VennSeriesSonificationContextTracksValueMapFunction ValueMapFunction_DefaultValue { get; set; }
