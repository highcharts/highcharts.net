...
{
	public partial class VennSeriesSonificationTracks  : BaseObject
	{
		Hashtable h = new Hashtable();

		public VennSeriesSonificationTracks()
		{
			ActiveWhen = ActiveWhen_DefaultValue = new VennSeriesSonificationTracksActiveWhen();
			Instrument = Instrument_DefaultValue = null;
			InstrumentString = InstrumentString_DefaultValue = "null";
			Mapping = Mapping_DefaultValue = new VennSeriesSonificationTracksMapping();
			MidiName = MidiName_DefaultValue = "";
			PointGrouping = PointGrouping_DefaultValue = new VennSeriesSonificationTracksPointGrouping();
			RoundToMusicalNotes = RoundToMusicalNotes_DefaultValue = true;
			ShowPlayMarker = ShowPlayMarker_DefaultValue = true;
			Type = Type_DefaultValue = VennSeriesSonificationTracksType.Instrument;
		...
		/// </summary>
		public VennSeriesSonificationTracksActiveWhen ActiveWhen { get; set; }
		private VennSeriesSonificationTracksActiveWhen ActiveWhen_DefaultValue { get; set; }
		...
		/// </summary>
		public VennSeriesSonificationTracksMapping Mapping { get; set; }
		private VennSeriesSonificationTracksMapping Mapping_DefaultValue { get; set; }
		...
		/// </summary>
		public VennSeriesSonificationTracksPointGrouping PointGrouping { get; set; }
		private VennSeriesSonificationTracksPointGrouping PointGrouping_DefaultValue { get; set; }
		...
		/// </summary>
		public VennSeriesSonificationTracksType Type { get; set; }
		private VennSeriesSonificationTracksType Type_DefaultValue { get; set; }
