...
{
	public partial class VennSeriesStatesHover  : BaseObject
	{
		Hashtable h = new Hashtable();

		public VennSeriesStatesHover()
		{
			Animation = Animation_DefaultValue = new Animation() { Enabled = true };
			Enabled = Enabled_DefaultValue = null;
			Halo = Halo_DefaultValue = new VennSeriesStatesHoverHalo();
			LineWidth = LineWidth_DefaultValue = null;
			LineWidthPlus = LineWidthPlus_DefaultValue = null;
			Marker = Marker_DefaultValue = new VennSeriesStatesHoverMarker();
		...
		/// </summary>
		public VennSeriesStatesHoverHalo Halo { get; set; }
		private VennSeriesStatesHoverHalo Halo_DefaultValue { get; set; }
		...
		/// </summary>
		public VennSeriesStatesHoverMarker Marker { get; set; }
		private VennSeriesStatesHoverMarker Marker_DefaultValue { get; set; }
