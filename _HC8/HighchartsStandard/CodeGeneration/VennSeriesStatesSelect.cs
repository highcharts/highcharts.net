...
{
	public partial class VennSeriesStatesSelect  : BaseObject
	{
		Hashtable h = new Hashtable();

		public VennSeriesStatesSelect()
		{
			Animation = Animation_DefaultValue = new Animation();
			Enabled = Enabled_DefaultValue = null;
			Halo = Halo_DefaultValue = new VennSeriesStatesSelectHalo();
			LineWidth = LineWidth_DefaultValue = null;
			LineWidthPlus = LineWidthPlus_DefaultValue = null;
			Marker = Marker_DefaultValue = new VennSeriesStatesSelectMarker();
		...
		/// </summary>
		public VennSeriesStatesSelectHalo Halo { get; set; }
		private VennSeriesStatesSelectHalo Halo_DefaultValue { get; set; }
		...
		/// </summary>
		public VennSeriesStatesSelectMarker Marker { get; set; }
		private VennSeriesStatesSelectMarker Marker_DefaultValue { get; set; }
