...
{
	public partial class VennSeriesStatesSelectMarker  : BaseObject
	{
		Hashtable h = new Hashtable();

		public VennSeriesStatesSelectMarker()
		{
			...
			States = States_DefaultValue = new VennSeriesStatesSelectMarkerStates();
		...
		/// </summary>
		public VennSeriesStatesSelectMarkerStates States { get; set; }
		private VennSeriesStatesSelectMarkerStates States_DefaultValue { get; set; }
