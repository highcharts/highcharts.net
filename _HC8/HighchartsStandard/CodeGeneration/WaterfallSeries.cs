...
namespace Highsoft.Web.Mvc.Charts
{
	public partial class WaterfallSeries  : Series
	{
		...
		internal override Hashtable ToHashtable()
		{
			...
			if (PointDescriptionFormatter != PointDescriptionFormatter_DefaultValue) { h.Add("pointDescriptionFormatter",PointDescriptionFormatter); Highcharts.AddFunction("bffd4e71-7d9f-4997-9a6b-02e9c578be08.pointDescriptionFormatter", PointDescriptionFormatter); }  
