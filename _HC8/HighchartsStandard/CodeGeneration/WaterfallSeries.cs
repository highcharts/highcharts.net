...
namespace Highsoft.Web.Mvc.Charts
{
	public partial class WaterfallSeries  : Series
	{
		...
		public WaterfallSeries()
		{
			...
			BoostBlending = BoostBlending_DefaultValue = WaterfallSeriesBoostBlending.Undefined;
		...
		/// </summary>
		public WaterfallSeriesBoostBlending BoostBlending { get; set; }
		private WaterfallSeriesBoostBlending BoostBlending_DefaultValue { get; set; }
		...
		internal override Hashtable ToHashtable()
		{
			...
			if (PointDescriptionFormatter != PointDescriptionFormatter_DefaultValue) { h.Add("pointDescriptionFormatter",PointDescriptionFormatter); Highcharts.AddFunction("82b23425-03af-4454-b43c-0f4fb4fcfd01.pointDescriptionFormatter", PointDescriptionFormatter); }  
