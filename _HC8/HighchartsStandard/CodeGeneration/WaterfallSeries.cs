...
namespace Highsoft.Web.Mvc.Charts
{
	public partial class WaterfallSeries  : Series
	{
		...
		public WaterfallSeries()
		{
			...
			Type = Type_DefaultValue = WaterfallSeriesType.Waterfall;
		...
		internal override Hashtable ToHashtable()
		{
			...
			if (PointDescriptionFormatter != PointDescriptionFormatter_DefaultValue) { h.Add("pointDescriptionFormatter",PointDescriptionFormatter); Highcharts.AddFunction("0ca99203-752e-4242-a72a-6b39d6db5f29.pointDescriptionFormatter", PointDescriptionFormatter); }  
