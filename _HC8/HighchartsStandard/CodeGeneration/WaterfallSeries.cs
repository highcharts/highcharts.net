...
namespace Highsoft.Web.Mvc.Charts
{
	public partial class WaterfallSeries  : Series
	{
		...
		internal override Hashtable ToHashtable()
		{
			...
			if (PointDescriptionFormatter != PointDescriptionFormatter_DefaultValue) { h.Add("pointDescriptionFormatter",PointDescriptionFormatter); Highcharts.AddFunction("240feab0-0b76-4cb6-b685-a739ee4ac0c2.pointDescriptionFormatter", PointDescriptionFormatter); }  
