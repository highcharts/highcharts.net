...
{
	public partial class WaterfallSeriesData  : BaseObject
	{
		Hashtable h = new Hashtable();

		public WaterfallSeriesData()
		{
			Accessibility = Accessibility_DefaultValue = new WaterfallSeriesDataAccessibility();
			ClassName = ClassName_DefaultValue = "";
			Color = Color_DefaultValue = "";
			ColorIndex = ColorIndex_DefaultValue = null;
			DataLabels = DataLabels_DefaultValue = new WaterfallSeriesDataLabels();
			Description = Description_DefaultValue = "";
			DragDrop = DragDrop_DefaultValue = new WaterfallSeriesDataDragDrop();
		...
		/// </summary>
		public WaterfallSeriesDataAccessibility Accessibility { get; set; }
		private WaterfallSeriesDataAccessibility Accessibility_DefaultValue { get; set; }
		...
		/// </summary>
		public WaterfallSeriesDataDragDrop DragDrop { get; set; }
		private WaterfallSeriesDataDragDrop DragDrop_DefaultValue { get; set; }
