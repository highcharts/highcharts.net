...
{
	public partial class WaterfallSeriesDataDragDrop  : BaseObject
	{
		Hashtable h = new Hashtable();

		public WaterfallSeriesDataDragDrop()
		{
			DraggableX = DraggableX_DefaultValue = null;
			DraggableY = DraggableY_DefaultValue = null;
			DragHandle = DragHandle_DefaultValue = new WaterfallSeriesDataDragDropDragHandle();
			...
			GuideBox = GuideBox_DefaultValue = new WaterfallSeriesDataDragDropGuideBox();
		...
		/// </summary>
		public WaterfallSeriesDataDragDropDragHandle DragHandle { get; set; }
		private WaterfallSeriesDataDragDropDragHandle DragHandle_DefaultValue { get; set; }
		...
		/// </summary>
		public WaterfallSeriesDataDragDropGuideBox GuideBox { get; set; }
		private WaterfallSeriesDataDragDropGuideBox GuideBox_DefaultValue { get; set; }
