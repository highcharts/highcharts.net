...
namespace Highsoft.Web.Mvc.Charts
{
	public partial class WaterfallSeriesDataDragDropDragHandle  : BaseObject
	{
		...
		internal override Hashtable ToHashtable()
		{
			...
			if (PathFormatter != PathFormatter_DefaultValue) { h.Add("pathFormatter",PathFormatter); Highcharts.AddFunction("55fba067-52fe-4bbe-9340-7005d8330c5e.pathFormatter", PathFormatter); }  
