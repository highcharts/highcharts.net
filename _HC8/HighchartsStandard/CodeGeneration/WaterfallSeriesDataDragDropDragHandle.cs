...
namespace Highsoft.Web.Mvc.Charts
{
	public partial class WaterfallSeriesDataDragDropDragHandle  : BaseObject
	{
		...
		internal override Hashtable ToHashtable()
		{
			...
			if (PathFormatter != PathFormatter_DefaultValue) { h.Add("pathFormatter",PathFormatter); Highcharts.AddFunction("ebf27124-5902-4f2b-8632-502dfe856c42.pathFormatter", PathFormatter); }  
