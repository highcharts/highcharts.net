...
namespace Highsoft.Web.Mvc.Charts
{
	public partial class WaterfallSeriesDataDragDropDragHandle  : BaseObject
	{
		...
		internal override Hashtable ToHashtable()
		{
			...
			if (PathFormatter != PathFormatter_DefaultValue) { h.Add("pathFormatter",PathFormatter); Highcharts.AddFunction("c11994b8-1a3a-44ef-ba3b-6578632bcb2c.pathFormatter", PathFormatter); }  
