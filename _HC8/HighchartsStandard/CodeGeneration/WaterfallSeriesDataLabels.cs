...
namespace Highsoft.Web.Mvc.Charts
{
	public partial class WaterfallSeriesDataLabels  : BaseObject
	{
		...
		{
			Align = Align_DefaultValue = WaterfallSeriesDataLabelsAlign.Center;
			...
			Filter = Filter_DefaultValue = new WaterfallSeriesDataLabelsFilter();
			...
			Style = Style_DefaultValue = new WaterfallSeriesDataLabelsStyle();
			TextPath = TextPath_DefaultValue = new WaterfallSeriesDataLabelsTextPath();
			UseHTML = UseHTML_DefaultValue = false;
			VerticalAlign = VerticalAlign_DefaultValue = WaterfallSeriesDataLabelsVerticalAlign.Bottom;
			X = X_DefaultValue = 0;
			Y = Y_DefaultValue = 0;
			Z = Z_DefaultValue = 6;
		...
		/// </summary>
		public WaterfallSeriesDataLabelsAlign Align { get; set; }
		private WaterfallSeriesDataLabelsAlign Align_DefaultValue { get; set; }
		...
		/// </summary>
		public WaterfallSeriesDataLabelsFilter Filter { get; set; }
		private WaterfallSeriesDataLabelsFilter Filter_DefaultValue { get; set; }
		...
		/// </summary>
		public WaterfallSeriesDataLabelsStyle Style { get; set; }
		private WaterfallSeriesDataLabelsStyle Style_DefaultValue { get; set; }
		...
		/// </summary>
		public WaterfallSeriesDataLabelsTextPath TextPath { get; set; }
		private WaterfallSeriesDataLabelsTextPath TextPath_DefaultValue { get; set; }
		...
		/// </summary>
		public WaterfallSeriesDataLabelsVerticalAlign VerticalAlign { get; set; }
		private WaterfallSeriesDataLabelsVerticalAlign VerticalAlign_DefaultValue { get; set; }
		...
		internal override Hashtable ToHashtable()
		{
			...
			if (Formatter != Formatter_DefaultValue) { h.Add("formatter",Formatter); Highcharts.AddFunction("c5bb7c58-d79c-4eba-a393-0406095f6745.formatter", Formatter); }  
			if (Inside != Inside_DefaultValue) h.Add("inside",Inside);
			if (NullFormat != NullFormat_DefaultValue) h.Add("nullFormat",NullFormat);
			if (NullFormatter != NullFormatter_DefaultValue) { h.Add("nullFormatter",NullFormatter); Highcharts.AddFunction("4e6d3c4f-afde-4fcd-b419-03f07a0a3d56.nullFormatter", NullFormatter); }  
