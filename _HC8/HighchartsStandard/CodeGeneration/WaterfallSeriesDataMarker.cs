...
{
	public partial class WaterfallSeriesDataMarker  : BaseObject
	{
		Hashtable h = new Hashtable();

		public WaterfallSeriesDataMarker()
		{
			...
			States = States_DefaultValue = new WaterfallSeriesDataMarkerStates();
		...
		/// </summary>
		public WaterfallSeriesDataMarkerStates States { get; set; }
		private WaterfallSeriesDataMarkerStates States_DefaultValue { get; set; }
