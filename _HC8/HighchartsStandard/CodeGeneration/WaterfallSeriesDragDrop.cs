...
{
	public partial class WaterfallSeriesDragDrop  : BaseObject
	{
		Hashtable h = new Hashtable();

		public WaterfallSeriesDragDrop()
		{
			DraggableX = DraggableX_DefaultValue = null;
			DraggableY = DraggableY_DefaultValue = null;
			DragHandle = DragHandle_DefaultValue = new WaterfallSeriesDragDropDragHandle();
			...
			GuideBox = GuideBox_DefaultValue = new WaterfallSeriesDragDropGuideBox();
		...
		/// </summary>
		public WaterfallSeriesDragDropDragHandle DragHandle { get; set; }
		private WaterfallSeriesDragDropDragHandle DragHandle_DefaultValue { get; set; }
		...
		/// </summary>
		public WaterfallSeriesDragDropGuideBox GuideBox { get; set; }
		private WaterfallSeriesDragDropGuideBox GuideBox_DefaultValue { get; set; }
