...
{
	public partial class WaterfallSeriesOnPoint  : BaseObject
	{
		Hashtable h = new Hashtable();

		public WaterfallSeriesOnPoint()
		{
			ConnectorOptions = ConnectorOptions_DefaultValue = new WaterfallSeriesOnPointConnectorOptions();
			Id = Id_DefaultValue = "";
			Position = Position_DefaultValue = new WaterfallSeriesOnPointPosition();
		...
		/// </summary>
		public WaterfallSeriesOnPointConnectorOptions ConnectorOptions { get; set; }
		private WaterfallSeriesOnPointConnectorOptions ConnectorOptions_DefaultValue { get; set; }
		...
		/// </summary>
		public WaterfallSeriesOnPointPosition Position { get; set; }
		private WaterfallSeriesOnPointPosition Position_DefaultValue { get; set; }
