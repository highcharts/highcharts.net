...
{
	public partial class WaterfallSeriesSonificationDefaultSpeechOptions  : BaseObject
	{
		Hashtable h = new Hashtable();

		public WaterfallSeriesSonificationDefaultSpeechOptions()
		{
			ActiveWhen = ActiveWhen_DefaultValue = new WaterfallSeriesSonificationDefaultSpeechOptionsActiveWhen();
			Language = Language_DefaultValue = "en-US";
			Mapping = Mapping_DefaultValue = new WaterfallSeriesSonificationDefaultSpeechOptionsMapping();
			PointGrouping = PointGrouping_DefaultValue = new WaterfallSeriesSonificationDefaultSpeechOptionsPointGrouping();
			PreferredVoice = PreferredVoice_DefaultValue = "";
			ShowPlayMarker = ShowPlayMarker_DefaultValue = true;
			Type = Type_DefaultValue = WaterfallSeriesSonificationDefaultSpeechOptionsType.Instrument;
		...
		/// </summary>
		public WaterfallSeriesSonificationDefaultSpeechOptionsActiveWhen ActiveWhen { get; set; }
		private WaterfallSeriesSonificationDefaultSpeechOptionsActiveWhen ActiveWhen_DefaultValue { get; set; }
		...
		/// </summary>
		public WaterfallSeriesSonificationDefaultSpeechOptionsMapping Mapping { get; set; }
		private WaterfallSeriesSonificationDefaultSpeechOptionsMapping Mapping_DefaultValue { get; set; }
		 

		/// <summary>
		/// Options for point grouping, specifically for instrument tracks.
		/// </summary>
		public WaterfallSeriesSonificationDefaultSpeechOptionsPointGrouping PointGrouping { get; set; }
		private WaterfallSeriesSonificationDefaultSpeechOptionsPointGrouping PointGrouping_DefaultValue { get; set; }
		...
		/// </summary>
		public WaterfallSeriesSonificationDefaultSpeechOptionsType Type { get; set; }
		private WaterfallSeriesSonificationDefaultSpeechOptionsType Type_DefaultValue { get; set; }
