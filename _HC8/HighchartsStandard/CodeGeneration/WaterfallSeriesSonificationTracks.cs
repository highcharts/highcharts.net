...
{
	public partial class WaterfallSeriesSonificationTracks  : BaseObject
	{
		Hashtable h = new Hashtable();

		public WaterfallSeriesSonificationTracks()
		{
			ActiveWhen = ActiveWhen_DefaultValue = new WaterfallSeriesSonificationTracksActiveWhen();
			Instrument = Instrument_DefaultValue = null;
			InstrumentString = InstrumentString_DefaultValue = "null";
			Mapping = Mapping_DefaultValue = new WaterfallSeriesSonificationTracksMapping();
			MidiName = MidiName_DefaultValue = "";
			PointGrouping = PointGrouping_DefaultValue = new WaterfallSeriesSonificationTracksPointGrouping();
			RoundToMusicalNotes = RoundToMusicalNotes_DefaultValue = true;
			ShowPlayMarker = ShowPlayMarker_DefaultValue = true;
			Type = Type_DefaultValue = WaterfallSeriesSonificationTracksType.Instrument;
		...
		/// </summary>
		public WaterfallSeriesSonificationTracksActiveWhen ActiveWhen { get; set; }
		private WaterfallSeriesSonificationTracksActiveWhen ActiveWhen_DefaultValue { get; set; }
		...
		/// </summary>
		public WaterfallSeriesSonificationTracksMapping Mapping { get; set; }
		private WaterfallSeriesSonificationTracksMapping Mapping_DefaultValue { get; set; }
		...
		/// </summary>
		public WaterfallSeriesSonificationTracksPointGrouping PointGrouping { get; set; }
		private WaterfallSeriesSonificationTracksPointGrouping PointGrouping_DefaultValue { get; set; }
		...
		/// </summary>
		public WaterfallSeriesSonificationTracksType Type { get; set; }
		private WaterfallSeriesSonificationTracksType Type_DefaultValue { get; set; }
