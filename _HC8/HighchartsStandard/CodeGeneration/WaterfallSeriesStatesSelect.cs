...
{
	public partial class WaterfallSeriesStatesSelect  : BaseObject
	{
		Hashtable h = new Hashtable();

		public WaterfallSeriesStatesSelect()
		{
			Animation = Animation_DefaultValue = new Animation();
			Enabled = Enabled_DefaultValue = null;
			Halo = Halo_DefaultValue = new WaterfallSeriesStatesSelectHalo();
			LineWidth = LineWidth_DefaultValue = null;
			LineWidthPlus = LineWidthPlus_DefaultValue = null;
			Marker = Marker_DefaultValue = new WaterfallSeriesStatesSelectMarker();
		...
		/// </summary>
		public WaterfallSeriesStatesSelectHalo Halo { get; set; }
		private WaterfallSeriesStatesSelectHalo Halo_DefaultValue { get; set; }
		...
		/// </summary>
		public WaterfallSeriesStatesSelectMarker Marker { get; set; }
		private WaterfallSeriesStatesSelectMarker Marker_DefaultValue { get; set; }
