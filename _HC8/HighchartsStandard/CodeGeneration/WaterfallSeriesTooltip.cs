...
{
	public partial class WaterfallSeriesTooltip  : BaseObject
	{
		...
		public WaterfallSeriesTooltip()
		{
			...
			HeaderShape = HeaderShape_DefaultValue = WaterfallSeriesTooltipHeaderShape.Callout;
		...
		/// </summary>
		public WaterfallSeriesTooltipHeaderShape HeaderShape { get; set; }
		private WaterfallSeriesTooltipHeaderShape HeaderShape_DefaultValue { get; set; }
		...
		internal override Hashtable ToHashtable()
		{
			...
			if (NullFormatter != NullFormatter_DefaultValue) { h.Add("nullFormatter",NullFormatter); Highcharts.AddFunction("8258a760-e47e-4bf1-ba45-5afd9e87726d.nullFormatter", NullFormatter); }  
			if (Outside != Outside_DefaultValue) h.Add("outside",Outside);
			if (Padding != Padding_DefaultValue) h.Add("padding",Padding);
			if (PointFormat != PointFormat_DefaultValue) h.Add("pointFormat",PointFormat);
			if (PointFormatter != PointFormatter_DefaultValue) { h.Add("pointFormatter",PointFormatter); Highcharts.AddFunction("1431c15e-477f-4005-b141-b0bb5accdca5.pointFormatter", PointFormatter); }  
