...
namespace Highsoft.Web.Mvc.Charts
{
	public partial class WindbarbSeries  : Series
	{
		...
		internal override Hashtable ToHashtable()
		{
			...
			if (PointDescriptionFormatter != PointDescriptionFormatter_DefaultValue) { h.Add("pointDescriptionFormatter",PointDescriptionFormatter); Highcharts.AddFunction("cb7353e3-98f8-49cf-93df-f5c0b05cd0dc.pointDescriptionFormatter", PointDescriptionFormatter); }  
