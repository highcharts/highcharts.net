...
namespace Highsoft.Web.Mvc.Charts
{
	public partial class WindbarbSeriesDataDragDropDragHandle  : BaseObject
	{
		...
		internal override Hashtable ToHashtable()
		{
			...
			if (PathFormatter != PathFormatter_DefaultValue) { h.Add("pathFormatter",PathFormatter); Highcharts.AddFunction("47155d5a-fb09-48bf-a8b3-9e7afb03d871.pathFormatter", PathFormatter); }  
