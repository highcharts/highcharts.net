...
namespace Highsoft.Web.Mvc.Charts
{
	public partial class WindbarbSeriesDataDragDropDragHandle  : BaseObject
	{
		...
		internal override Hashtable ToHashtable()
		{
			...
			if (PathFormatter != PathFormatter_DefaultValue) { h.Add("pathFormatter",PathFormatter); Highcharts.AddFunction("938971fd-cdac-4326-a1fb-40e620546db8.pathFormatter", PathFormatter); }  
