...
namespace Highsoft.Web.Mvc.Charts
{
	public partial class WindbarbSeriesDataDragDropDragHandle  : BaseObject
	{
		...
		internal override Hashtable ToHashtable()
		{
			...
			if (PathFormatter != PathFormatter_DefaultValue) { h.Add("pathFormatter",PathFormatter); Highcharts.AddFunction("a02b5db3-8519-47c1-8afe-606a3ab299ba.pathFormatter", PathFormatter); }  
