...
{
	public partial class WindbarbSeriesDataLabels  : BaseObject
	{
		Hashtable h = new Hashtable();

		public WindbarbSeriesDataLabels()
		{
			Align = Align_DefaultValue = WindbarbSeriesDataLabelsAlign.Center;
			...
			Filter = Filter_DefaultValue = new WindbarbSeriesDataLabelsFilter();
			...
			Style = Style_DefaultValue = new WindbarbSeriesDataLabelsStyle();
			TextPath = TextPath_DefaultValue = new WindbarbSeriesDataLabelsTextPath();
			UseHTML = UseHTML_DefaultValue = false;
			VerticalAlign = VerticalAlign_DefaultValue = WindbarbSeriesDataLabelsVerticalAlign.Bottom;
			X = X_DefaultValue = 0;
			Y = Y_DefaultValue = 0;
			Z = Z_DefaultValue = 6;
		...
		/// </summary>
		public WindbarbSeriesDataLabelsFilter Filter { get; set; }
		private WindbarbSeriesDataLabelsFilter Filter_DefaultValue { get; set; }
		...
		/// </summary>
		public WindbarbSeriesDataLabelsStyle Style { get; set; }
		private WindbarbSeriesDataLabelsStyle Style_DefaultValue { get; set; }
		...
		/// </summary>
		public WindbarbSeriesDataLabelsTextPath TextPath { get; set; }
		private WindbarbSeriesDataLabelsTextPath TextPath_DefaultValue { get; set; }
		...
		internal override Hashtable ToHashtable()
		{
			...
			if (Formatter != Formatter_DefaultValue) { h.Add("formatter",Formatter); Highcharts.AddFunction("0357b61b-d680-4c79-aacf-1ea763993f16.formatter", Formatter); }  
			if (Inside != Inside_DefaultValue) h.Add("inside",Inside);
			if (NullFormat != NullFormat_DefaultValue) h.Add("nullFormat",NullFormat);
			if (NullFormatter != NullFormatter_DefaultValue) { h.Add("nullFormatter",NullFormatter); Highcharts.AddFunction("e24de677-b2aa-4ddc-81fd-74b6b1ea28f3.nullFormatter", NullFormatter); }  
