...
namespace Highsoft.Web.Mvc.Charts
{
	public partial class WindbarbSeriesTooltip  : BaseObject
	{
		...
		public WindbarbSeriesTooltip()
		{
			...
			HeaderShape = HeaderShape_DefaultValue = WindbarbSeriesTooltipHeaderShape.Callout;
		...
		/// </summary>
		public WindbarbSeriesTooltipHeaderShape HeaderShape { get; set; }
		private WindbarbSeriesTooltipHeaderShape HeaderShape_DefaultValue { get; set; }
		...
		internal override Hashtable ToHashtable()
		{
			...
			if (NullFormatter != NullFormatter_DefaultValue) { h.Add("nullFormatter",NullFormatter); Highcharts.AddFunction("42a2b34a-7889-4746-b68e-acef7365aca0.nullFormatter", NullFormatter); }  
			if (Outside != Outside_DefaultValue) h.Add("outside",Outside);
			if (Padding != Padding_DefaultValue) h.Add("padding",Padding);
			if (PointFormat != PointFormat_DefaultValue) h.Add("pointFormat",PointFormat);
			if (PointFormatter != PointFormatter_DefaultValue) { h.Add("pointFormatter",PointFormatter); Highcharts.AddFunction("56e03190-c14a-4bdf-aab5-fd300653ee12.pointFormatter", PointFormatter); }  
