...
{
	public partial class WordcloudSeriesData  : BaseObject
	{
		Hashtable h = new Hashtable();

		public WordcloudSeriesData()
		{
			Accessibility = Accessibility_DefaultValue = new WordcloudSeriesDataAccessibility();
			ClassName = ClassName_DefaultValue = "";
			Color = Color_DefaultValue = "";
			ColorIndex = ColorIndex_DefaultValue = null;
			Custom = Custom_DefaultValue = new Hashtable();
			DataLabels = DataLabels_DefaultValue = new WordcloudSeriesDataLabels();
			Description = Description_DefaultValue = "";
			DragDrop = DragDrop_DefaultValue = new WordcloudSeriesDataDragDrop();
			Drilldown = Drilldown_DefaultValue = "";
			Events = Events_DefaultValue = new WordcloudSeriesDataEvents();
			Id = Id_DefaultValue = "";
			Labelrank = Labelrank_DefaultValue = null;
			Marker = Marker_DefaultValue = new WordcloudSeriesDataMarker();
		...
		/// </summary>
		public WordcloudSeriesDataAccessibility Accessibility { get; set; }
		private WordcloudSeriesDataAccessibility Accessibility_DefaultValue { get; set; }
		...
		/// </summary>
		public WordcloudSeriesDataDragDrop DragDrop { get; set; }
		private WordcloudSeriesDataDragDrop DragDrop_DefaultValue { get; set; }
		...
		/// </summary>
		public WordcloudSeriesDataEvents Events { get; set; }
		private WordcloudSeriesDataEvents Events_DefaultValue { get; set; }
		...
		/// </summary>
		public WordcloudSeriesDataMarker Marker { get; set; }
		private WordcloudSeriesDataMarker Marker_DefaultValue { get; set; }
