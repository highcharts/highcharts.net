...
{
	public partial class WordcloudSeriesDataDragDrop  : BaseObject
	{
		Hashtable h = new Hashtable();

		public WordcloudSeriesDataDragDrop()
		{
			DraggableX = DraggableX_DefaultValue = null;
			DraggableY = DraggableY_DefaultValue = null;
			DragHandle = DragHandle_DefaultValue = new WordcloudSeriesDataDragDropDragHandle();
			...
			GuideBox = GuideBox_DefaultValue = new WordcloudSeriesDataDragDropGuideBox();
		...
		/// </summary>
		public WordcloudSeriesDataDragDropDragHandle DragHandle { get; set; }
		private WordcloudSeriesDataDragDropDragHandle DragHandle_DefaultValue { get; set; }
		...
		/// </summary>
		public WordcloudSeriesDataDragDropGuideBox GuideBox { get; set; }
		private WordcloudSeriesDataDragDropGuideBox GuideBox_DefaultValue { get; set; }
