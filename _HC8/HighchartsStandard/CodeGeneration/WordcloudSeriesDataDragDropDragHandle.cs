...
namespace Highsoft.Web.Mvc.Charts
{
	public partial class WordcloudSeriesDataDragDropDragHandle  : BaseObject
	{
		...
		internal override Hashtable ToHashtable()
		{
			...
			if (PathFormatter != PathFormatter_DefaultValue) { h.Add("pathFormatter",PathFormatter); Highcharts.AddFunction("78b08df5-879d-4020-884d-6acf23837f67.pathFormatter", PathFormatter); }  
