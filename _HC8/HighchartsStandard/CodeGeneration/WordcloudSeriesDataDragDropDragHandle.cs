...
namespace Highsoft.Web.Mvc.Charts
{
	public partial class WordcloudSeriesDataDragDropDragHandle  : BaseObject
	{
		...
		internal override Hashtable ToHashtable()
		{
			...
			if (PathFormatter != PathFormatter_DefaultValue) { h.Add("pathFormatter",PathFormatter); Highcharts.AddFunction("fddfecca-1d2d-4e8c-ae14-ddb86864a9a2.pathFormatter", PathFormatter); }  
