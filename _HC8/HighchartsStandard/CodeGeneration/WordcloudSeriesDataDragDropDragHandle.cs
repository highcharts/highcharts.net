...
namespace Highsoft.Web.Mvc.Charts
{
	public partial class WordcloudSeriesDataDragDropDragHandle  : BaseObject
	{
		...
		internal override Hashtable ToHashtable()
		{
			...
			if (PathFormatter != PathFormatter_DefaultValue) { h.Add("pathFormatter",PathFormatter); Highcharts.AddFunction("96fa5338-2d2e-4236-a3a9-063877008d81.pathFormatter", PathFormatter); }  
