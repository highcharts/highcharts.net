...
namespace Highsoft.Web.Mvc.Charts
{
	public partial class WordcloudSeriesDataDragDropGuideBox  : BaseObject
	{
		...
		{
			Default = Default_DefaultValue = new WordcloudSeriesDataDragDropGuideBoxDefault();
		...
		private WordcloudSeriesDataDragDropGuideBoxDefault Default_DefaultValue { get; set; }
