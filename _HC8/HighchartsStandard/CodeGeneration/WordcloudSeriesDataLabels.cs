...
namespace Highsoft.Web.Mvc.Charts
{
	public partial class WordcloudSeriesDataLabels  : BaseObject
	{
		...
		public WordcloudSeriesDataLabels()
		{
			...
			Filter = Filter_DefaultValue = new WordcloudSeriesDataLabelsFilter();
			...
			TextPath = TextPath_DefaultValue = new WordcloudSeriesDataLabelsTextPath();
		...
		/// </summary>
		public WordcloudSeriesDataLabelsTextPath TextPath { get; set; }
		private WordcloudSeriesDataLabelsTextPath TextPath_DefaultValue { get; set; }
		...
		internal override Hashtable ToHashtable()
		{
			...
			if (Formatter != Formatter_DefaultValue) { h.Add("formatter",Formatter); Highcharts.AddFunction("3609ad85-76ba-4703-a4eb-b559d4f6f753.formatter", Formatter); }  
			...
			if (NullFormatter != NullFormatter_DefaultValue) { h.Add("nullFormatter",NullFormatter); Highcharts.AddFunction("263231eb-bf90-4f5a-bcd5-3d193b78ef8b.nullFormatter", NullFormatter); }  
