...
{
	public partial class WordcloudSeriesDataMarker  : BaseObject
	{
		Hashtable h = new Hashtable();

		public WordcloudSeriesDataMarker()
		{
			...
			States = States_DefaultValue = new WordcloudSeriesDataMarkerStates();
		...
		/// </summary>
		public WordcloudSeriesDataMarkerStates States { get; set; }
		private WordcloudSeriesDataMarkerStates States_DefaultValue { get; set; }
