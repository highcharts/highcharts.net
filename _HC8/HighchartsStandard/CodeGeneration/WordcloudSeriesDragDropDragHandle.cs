...
namespace Highsoft.Web.Mvc.Charts
{
	public partial class WordcloudSeriesDragDropDragHandle  : BaseObject
	{
		...
		internal override Hashtable ToHashtable()
		{
			...
			if (PathFormatter != PathFormatter_DefaultValue) { h.Add("pathFormatter",PathFormatter); Highcharts.AddFunction("65dbb278-c2e5-4f2a-aa71-670eb6dd0c62.pathFormatter", PathFormatter); }  
