...
{
	public partial class WordcloudSeriesOnPoint  : BaseObject
	{
		Hashtable h = new Hashtable();

		public WordcloudSeriesOnPoint()
		{
			ConnectorOptions = ConnectorOptions_DefaultValue = new WordcloudSeriesOnPointConnectorOptions();
			Id = Id_DefaultValue = "";
			Position = Position_DefaultValue = new WordcloudSeriesOnPointPosition();
		...
		/// </summary>
		public WordcloudSeriesOnPointConnectorOptions ConnectorOptions { get; set; }
		private WordcloudSeriesOnPointConnectorOptions ConnectorOptions_DefaultValue { get; set; }
		...
		/// </summary>
		public WordcloudSeriesOnPointPosition Position { get; set; }
		private WordcloudSeriesOnPointPosition Position_DefaultValue { get; set; }
