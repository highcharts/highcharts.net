...
{
	public partial class WordcloudSeriesSonificationDefaultSpeechOptions  : BaseObject
	{
		Hashtable h = new Hashtable();

		public WordcloudSeriesSonificationDefaultSpeechOptions()
		{
			ActiveWhen = ActiveWhen_DefaultValue = new WordcloudSeriesSonificationDefaultSpeechOptionsActiveWhen();
			Language = Language_DefaultValue = "en-US";
			Mapping = Mapping_DefaultValue = new WordcloudSeriesSonificationDefaultSpeechOptionsMapping();
			PointGrouping = PointGrouping_DefaultValue = new WordcloudSeriesSonificationDefaultSpeechOptionsPointGrouping();
			PreferredVoice = PreferredVoice_DefaultValue = "";
			ShowPlayMarker = ShowPlayMarker_DefaultValue = true;
			Type = Type_DefaultValue = WordcloudSeriesSonificationDefaultSpeechOptionsType.Instrument;
		...
		/// </summary>
		public WordcloudSeriesSonificationDefaultSpeechOptionsActiveWhen ActiveWhen { get; set; }
		private WordcloudSeriesSonificationDefaultSpeechOptionsActiveWhen ActiveWhen_DefaultValue { get; set; }
		...
		/// </summary>
		public WordcloudSeriesSonificationDefaultSpeechOptionsMapping Mapping { get; set; }
		private WordcloudSeriesSonificationDefaultSpeechOptionsMapping Mapping_DefaultValue { get; set; }
		 

		/// <summary>
		/// Options for point grouping, specifically for instrument tracks.
		/// </summary>
		public WordcloudSeriesSonificationDefaultSpeechOptionsPointGrouping PointGrouping { get; set; }
		private WordcloudSeriesSonificationDefaultSpeechOptionsPointGrouping PointGrouping_DefaultValue { get; set; }
		...
		/// </summary>
		public WordcloudSeriesSonificationDefaultSpeechOptionsType Type { get; set; }
		private WordcloudSeriesSonificationDefaultSpeechOptionsType Type_DefaultValue { get; set; }
