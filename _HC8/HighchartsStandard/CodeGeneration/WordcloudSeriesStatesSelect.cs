...
{
	public partial class WordcloudSeriesStatesSelect  : BaseObject
	{
		Hashtable h = new Hashtable();

		public WordcloudSeriesStatesSelect()
		{
			Animation = Animation_DefaultValue = new Animation() { Enabled = true };
			Enabled = Enabled_DefaultValue = null;
			Halo = Halo_DefaultValue = new WordcloudSeriesStatesSelectHalo();
			LineWidth = LineWidth_DefaultValue = null;
			LineWidthPlus = LineWidthPlus_DefaultValue = null;
			Marker = Marker_DefaultValue = new WordcloudSeriesStatesSelectMarker();
		...
		/// </summary>
		public WordcloudSeriesStatesSelectHalo Halo { get; set; }
		private WordcloudSeriesStatesSelectHalo Halo_DefaultValue { get; set; }
		...
		/// </summary>
		public WordcloudSeriesStatesSelectMarker Marker { get; set; }
		private WordcloudSeriesStatesSelectMarker Marker_DefaultValue { get; set; }
