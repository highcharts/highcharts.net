...
{
	public partial class WordcloudSeriesStatesSelectMarker  : BaseObject
	{
		Hashtable h = new Hashtable();

		public WordcloudSeriesStatesSelectMarker()
		{
			...
			States = States_DefaultValue = new WordcloudSeriesStatesSelectMarkerStates();
		...
		/// </summary>
		public WordcloudSeriesStatesSelectMarkerStates States { get; set; }
		private WordcloudSeriesStatesSelectMarkerStates States_DefaultValue { get; set; }
