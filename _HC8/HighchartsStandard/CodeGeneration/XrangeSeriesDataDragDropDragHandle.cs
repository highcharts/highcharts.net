...
namespace Highsoft.Web.Mvc.Charts
{
	public partial class XrangeSeriesDataDragDropDragHandle  : BaseObject
	{
		...
		internal override Hashtable ToHashtable()
		{
			...
			if (PathFormatter != PathFormatter_DefaultValue) { h.Add("pathFormatter",PathFormatter); Highcharts.AddFunction("bcb69c4f-3ebd-4302-8e87-3968277d3834.pathFormatter", PathFormatter); }  
