...
namespace Highsoft.Web.Mvc.Charts
{
	public partial class XrangeSeriesDataDragDropDragHandle  : BaseObject
	{
		...
		internal override Hashtable ToHashtable()
		{
			...
			if (PathFormatter != PathFormatter_DefaultValue) { h.Add("pathFormatter",PathFormatter); Highcharts.AddFunction("fb969637-4640-40cb-b3c6-357c028be45f.pathFormatter", PathFormatter); }  
