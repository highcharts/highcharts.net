...
namespace Highsoft.Web.Mvc.Charts
{
	public partial class XrangeSeriesDataLabels  : BaseObject
	{
		...
		public XrangeSeriesDataLabels()
		{
			...
			Filter = Filter_DefaultValue = new XrangeSeriesDataLabelsFilter();
			...
			Style = Style_DefaultValue = new XrangeSeriesDataLabelsStyle();
			TextPath = TextPath_DefaultValue = new XrangeSeriesDataLabelsTextPath();
		...
		/// </summary>
		public XrangeSeriesDataLabelsStyle Style { get; set; }
		private XrangeSeriesDataLabelsStyle Style_DefaultValue { get; set; }
		...
		internal override Hashtable ToHashtable()
		{
			...
			if (Formatter != Formatter_DefaultValue) { h.Add("formatter",Formatter); Highcharts.AddFunction("2f02e264-b055-4ad7-9062-81ac24163b9c.formatter", Formatter); }  
			...
			if (NullFormatter != NullFormatter_DefaultValue) { h.Add("nullFormatter",NullFormatter); Highcharts.AddFunction("68d1c450-a49e-4677-a783-1692bdd4b310.nullFormatter", NullFormatter); }  
