...
{
	public partial class XrangeSeriesDragDrop  : BaseObject
	{
		Hashtable h = new Hashtable();

		public XrangeSeriesDragDrop()
		{
			DraggableX = DraggableX_DefaultValue = null;
			DraggableY = DraggableY_DefaultValue = null;
			DragHandle = DragHandle_DefaultValue = new XrangeSeriesDragDropDragHandle();
			...
			GuideBox = GuideBox_DefaultValue = new XrangeSeriesDragDropGuideBox();
		...
		/// </summary>
		public XrangeSeriesDragDropDragHandle DragHandle { get; set; }
		private XrangeSeriesDragDropDragHandle DragHandle_DefaultValue { get; set; }
		...
		/// </summary>
		public XrangeSeriesDragDropGuideBox GuideBox { get; set; }
		private XrangeSeriesDragDropGuideBox GuideBox_DefaultValue { get; set; }
