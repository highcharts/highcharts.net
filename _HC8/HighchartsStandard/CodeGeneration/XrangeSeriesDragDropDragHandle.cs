...
namespace Highsoft.Web.Mvc.Charts
{
	public partial class XrangeSeriesDragDropDragHandle  : BaseObject
	{
		...
		internal override Hashtable ToHashtable()
		{
			...
			if (PathFormatter != PathFormatter_DefaultValue) { h.Add("pathFormatter",PathFormatter); Highcharts.AddFunction("045a77a8-0cae-4f4e-bf1d-f04c8fca950a.pathFormatter", PathFormatter); }  
