...
{
	public partial class XrangeSeriesSonificationContextTracks  : BaseObject
	{
		Hashtable h = new Hashtable();

		public XrangeSeriesSonificationContextTracks()
		{
			ActiveWhen = ActiveWhen_DefaultValue = new XrangeSeriesSonificationContextTracksActiveWhen();
			Instrument = Instrument_DefaultValue = null;
			InstrumentString = InstrumentString_DefaultValue = "null";
			Mapping = Mapping_DefaultValue = new XrangeSeriesSonificationContextTracksMapping();
			MidiName = MidiName_DefaultValue = "";
			PointGrouping = PointGrouping_DefaultValue = new XrangeSeriesSonificationContextTracksPointGrouping();
			...
			Type = Type_DefaultValue = XrangeSeriesSonificationContextTracksType.Instrument;
			ValueInterval = ValueInterval_DefaultValue = null;
			ValueMapFunction = ValueMapFunction_DefaultValue = XrangeSeriesSonificationContextTracksValueMapFunction.Linear;
		...
		/// </summary>
		public XrangeSeriesSonificationContextTracksActiveWhen ActiveWhen { get; set; }
		private XrangeSeriesSonificationContextTracksActiveWhen ActiveWhen_DefaultValue { get; set; }
		...
		/// </summary>
		public XrangeSeriesSonificationContextTracksMapping Mapping { get; set; }
		private XrangeSeriesSonificationContextTracksMapping Mapping_DefaultValue { get; set; }
		...
		/// </summary>
		public XrangeSeriesSonificationContextTracksPointGrouping PointGrouping { get; set; }
		private XrangeSeriesSonificationContextTracksPointGrouping PointGrouping_DefaultValue { get; set; }
		...
		/// </summary>
		public XrangeSeriesSonificationContextTracksType Type { get; set; }
		private XrangeSeriesSonificationContextTracksType Type_DefaultValue { get; set; }
		...
		/// </summary>
		public XrangeSeriesSonificationContextTracksValueMapFunction ValueMapFunction { get; set; }
		private XrangeSeriesSonificationContextTracksValueMapFunction ValueMapFunction_DefaultValue { get; set; }
