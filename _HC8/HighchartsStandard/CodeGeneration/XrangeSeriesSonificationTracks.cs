...
{
	public partial class XrangeSeriesSonificationTracks  : BaseObject
	{
		Hashtable h = new Hashtable();

		public XrangeSeriesSonificationTracks()
		{
			ActiveWhen = ActiveWhen_DefaultValue = new XrangeSeriesSonificationTracksActiveWhen();
			Instrument = Instrument_DefaultValue = null;
			InstrumentString = InstrumentString_DefaultValue = "null";
			Mapping = Mapping_DefaultValue = new XrangeSeriesSonificationTracksMapping();
			MidiName = MidiName_DefaultValue = "";
			PointGrouping = PointGrouping_DefaultValue = new XrangeSeriesSonificationTracksPointGrouping();
			RoundToMusicalNotes = RoundToMusicalNotes_DefaultValue = true;
			ShowPlayMarker = ShowPlayMarker_DefaultValue = true;
			Type = Type_DefaultValue = XrangeSeriesSonificationTracksType.Instrument;
		...
		/// </summary>
		public XrangeSeriesSonificationTracksActiveWhen ActiveWhen { get; set; }
		private XrangeSeriesSonificationTracksActiveWhen ActiveWhen_DefaultValue { get; set; }
		...
		/// </summary>
		public XrangeSeriesSonificationTracksMapping Mapping { get; set; }
		private XrangeSeriesSonificationTracksMapping Mapping_DefaultValue { get; set; }
		...
		/// </summary>
		public XrangeSeriesSonificationTracksPointGrouping PointGrouping { get; set; }
		private XrangeSeriesSonificationTracksPointGrouping PointGrouping_DefaultValue { get; set; }
		...
		/// </summary>
		public XrangeSeriesSonificationTracksType Type { get; set; }
		private XrangeSeriesSonificationTracksType Type_DefaultValue { get; set; }
