...
namespace Highsoft.Web.Mvc.Charts
{
	public partial class XrangeSeriesTooltip  : BaseObject
	{
		...
		internal override Hashtable ToHashtable()
		{
			...
			if (NullFormatter != NullFormatter_DefaultValue) { h.Add("nullFormatter",NullFormatter); Highcharts.AddFunction("82abc0d5-ff65-451e-8206-71bff5ea2dae.nullFormatter", NullFormatter); }  
			if (PointFormat != PointFormat_DefaultValue) h.Add("pointFormat",PointFormat);
			if (PointFormatter != PointFormatter_DefaultValue) { h.Add("pointFormatter",PointFormatter); Highcharts.AddFunction("a7a118f1-df55-4209-bd4e-a08e22297c88.pointFormatter", PointFormatter); }  
