...
namespace Highsoft.Web.Mvc.Charts
{
	public partial class ZAxis  : BaseObject
	{
		...
		private ZAxisAccessibility Accessibility_DefaultValue { get; set; }
		...
		private ZAxisGridLineInterpolation GridLineInterpolation_DefaultValue { get; set; }
		...
		internal override Hashtable ToHashtable()
		{
			...
			if (TickPositioner != TickPositioner_DefaultValue) { h.Add("tickPositioner",TickPositioner); Highcharts.AddFunction("078c9654-7233-4922-9770-03689fa93a7b.tickPositioner", TickPositioner); }  
