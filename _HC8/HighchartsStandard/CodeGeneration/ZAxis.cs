...
namespace Highsoft.Web.Mvc.Charts
{
	public partial class ZAxis  : BaseObject
	{
		...
		internal override Hashtable ToHashtable()
		{
			...
			if (TickPositioner != TickPositioner_DefaultValue) { h.Add("tickPositioner",TickPositioner); Highcharts.AddFunction("779f0a69-54a9-43c6-9ec6-67c5a3a4aecd.tickPositioner", TickPositioner); }  
