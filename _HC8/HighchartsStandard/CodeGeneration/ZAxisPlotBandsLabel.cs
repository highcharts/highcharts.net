...
namespace Highsoft.Web.Mvc.Charts
{
	public partial class ZAxisPlotBandsLabel  : BaseObject
	{
		...
		{
			Align = Align_DefaultValue = ZAxisPlotBandsLabelAlign.Center;
			Rotation = Rotation_DefaultValue = 0;
			Style = Style_DefaultValue = new Hashtable();
			Text = Text_DefaultValue = "";
			TextAlign = TextAlign_DefaultValue = ZAxisPlotBandsLabelTextAlign.Null;
			UseHTML = UseHTML_DefaultValue = false;
			VerticalAlign = VerticalAlign_DefaultValue = ZAxisPlotBandsLabelVerticalAlign.Top;
