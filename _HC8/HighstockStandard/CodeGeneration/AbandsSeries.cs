...
namespace Highsoft.Web.Mvc.Stocks
{
	public partial class AbandsSeries  : Series
	{
		...
		public AbandsSeries()
		{
			...
			DashStyle = DashStyle_DefaultValue = AbandsSeriesDashStyle.Solid;
			...
			Type = Type_DefaultValue = AbandsSeriesType.Abands;
		...
		internal override Hashtable ToHashtable()
		{
			...
			if (PointDescriptionFormatter != PointDescriptionFormatter_DefaultValue) { h.Add("pointDescriptionFormatter",PointDescriptionFormatter); Highstock.AddFunction("AbandsSeriesPointDescriptionFormatter.pointDescriptionFormatter", PointDescriptionFormatter); }  
