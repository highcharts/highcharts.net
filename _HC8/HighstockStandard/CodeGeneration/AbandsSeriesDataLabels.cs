...
{
	public partial class AbandsSeriesDataLabels  : BaseObject
	{
		Hashtable h = new Hashtable();

		public AbandsSeriesDataLabels()
		{
			Align = Align_DefaultValue = AbandsSeriesDataLabelsAlign.Center;
			...
			Filter = Filter_DefaultValue = new AbandsSeriesDataLabelsFilter();
			...
			Overflow = Overflow_DefaultValue = AbandsSeriesDataLabelsOverflow.Justify;
			Padding = Padding_DefaultValue = 5;
			Position = Position_DefaultValue = AbandsSeriesDataLabelsPosition.Center;
			...
			TextPath = TextPath_DefaultValue = new AbandsSeriesDataLabelsTextPath();
			UseHTML = UseHTML_DefaultValue = false;
			VerticalAlign = VerticalAlign_DefaultValue = AbandsSeriesDataLabelsVerticalAlign.Bottom;
			X = X_DefaultValue = 0;
			Y = Y_DefaultValue = 0;
			Z = Z_DefaultValue = 6;
		...
		/// </summary>
		public AbandsSeriesDataLabelsAlign Align { get; set; }
		private AbandsSeriesDataLabelsAlign Align_DefaultValue { get; set; }
		...
		/// </summary>
		public AbandsSeriesDataLabelsFilter Filter { get; set; }
		private AbandsSeriesDataLabelsFilter Filter_DefaultValue { get; set; }
		...
		/// </summary>
		public AbandsSeriesDataLabelsOverflow Overflow { get; set; }
		private AbandsSeriesDataLabelsOverflow Overflow_DefaultValue { get; set; }
		...
		/// </summary>
		public AbandsSeriesDataLabelsPosition Position { get; set; }
		private AbandsSeriesDataLabelsPosition Position_DefaultValue { get; set; }
		...
		/// </summary>
		public AbandsSeriesDataLabelsTextPath TextPath { get; set; }
		private AbandsSeriesDataLabelsTextPath TextPath_DefaultValue { get; set; }
		...
		/// </summary>
		public AbandsSeriesDataLabelsVerticalAlign VerticalAlign { get; set; }
		private AbandsSeriesDataLabelsVerticalAlign VerticalAlign_DefaultValue { get; set; }
