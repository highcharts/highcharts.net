...
{
	public partial class AbandsSeriesLastPriceLabel  : BaseObject
	{
		Hashtable h = new Hashtable();

		public AbandsSeriesLastPriceLabel()
		{
			Align = Align_DefaultValue = AbandsSeriesLastPriceLabelAlign.Null;
		...
		/// 
		/// </summary>
		public AbandsSeriesLastPriceLabelAlign Align { get; set; }
		private AbandsSeriesLastPriceLabelAlign Align_DefaultValue { get; set; }
