...
{
	public partial class AbandsSeriesOnPoint  : BaseObject
	{
		Hashtable h = new Hashtable();

		public AbandsSeriesOnPoint()
		{
			ConnectorOptions = ConnectorOptions_DefaultValue = new AbandsSeriesOnPointConnectorOptions();
			Id = Id_DefaultValue = "";
			Position = Position_DefaultValue = new AbandsSeriesOnPointPosition();
		...
		/// </summary>
		public AbandsSeriesOnPointConnectorOptions ConnectorOptions { get; set; }
		private AbandsSeriesOnPointConnectorOptions ConnectorOptions_DefaultValue { get; set; }
		...
		/// </summary>
		public AbandsSeriesOnPointPosition Position { get; set; }
		private AbandsSeriesOnPointPosition Position_DefaultValue { get; set; }
