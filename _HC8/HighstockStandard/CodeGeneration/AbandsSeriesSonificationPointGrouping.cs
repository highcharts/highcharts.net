...
{
	public partial class AbandsSeriesSonificationPointGrouping  : BaseObject
	{
		Hashtable h = new Hashtable();

		public AbandsSeriesSonificationPointGrouping()
		{
			Algorithm = Algorithm_DefaultValue = AbandsSeriesSonificationPointGroupingAlgorithm.Minimax;
		...
		/// </summary>
		public AbandsSeriesSonificationPointGroupingAlgorithm Algorithm { get; set; }
		private AbandsSeriesSonificationPointGroupingAlgorithm Algorithm_DefaultValue { get; set; }
