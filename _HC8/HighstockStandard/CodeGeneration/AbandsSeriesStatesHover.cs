...
{
	public partial class AbandsSeriesStatesHover  : BaseObject
	{
		Hashtable h = new Hashtable();

		public AbandsSeriesStatesHover()
		{
			Animation = Animation_DefaultValue = new Animation() { Enabled = true };
			Enabled = Enabled_DefaultValue = null;
			Halo = Halo_DefaultValue = new AbandsSeriesStatesHoverHalo();
			LineWidth = LineWidth_DefaultValue = null;
			LineWidthPlus = LineWidthPlus_DefaultValue = null;
			Marker = Marker_DefaultValue = new AbandsSeriesStatesHoverMarker();
		...
		/// </summary>
		public AbandsSeriesStatesHoverHalo Halo { get; set; }
		private AbandsSeriesStatesHoverHalo Halo_DefaultValue { get; set; }
		...
		/// </summary>
		public AbandsSeriesStatesHoverMarker Marker { get; set; }
		private AbandsSeriesStatesHoverMarker Marker_DefaultValue { get; set; }
