...
{
	public partial class AbandsSeriesStatesHoverMarker  : BaseObject
	{
		Hashtable h = new Hashtable();

		public AbandsSeriesStatesHoverMarker()
		{
			...
			States = States_DefaultValue = new AbandsSeriesStatesHoverMarkerStates();
		...
		/// </summary>
		public AbandsSeriesStatesHoverMarkerStates States { get; set; }
		private AbandsSeriesStatesHoverMarkerStates States_DefaultValue { get; set; }
