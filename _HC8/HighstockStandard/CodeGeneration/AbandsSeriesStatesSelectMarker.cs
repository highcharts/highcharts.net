...
{
	public partial class AbandsSeriesStatesSelectMarker  : BaseObject
	{
		Hashtable h = new Hashtable();

		public AbandsSeriesStatesSelectMarker()
		{
			...
			States = States_DefaultValue = new AbandsSeriesStatesSelectMarkerStates();
		...
		/// </summary>
		public AbandsSeriesStatesSelectMarkerStates States { get; set; }
		private AbandsSeriesStatesSelectMarkerStates States_DefaultValue { get; set; }
