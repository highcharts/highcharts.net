...
namespace Highsoft.Web.Mvc.Stocks
{
	public partial class AccessibilityAnnounceNewData  : BaseObject
	{
		...
		internal override Hashtable ToHashtable(ref Highstock highstock)
		{
			...
			if (AnnouncementFormatter != AnnouncementFormatter_DefaultValue) { h.Add("announcementFormatter",AnnouncementFormatter); highstock.AddFunction("announcementFormatter", AnnouncementFormatter); }  
