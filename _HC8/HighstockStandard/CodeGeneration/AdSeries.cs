...
namespace Highsoft.Web.Mvc.Stocks
{
	public partial class AdSeries  : Series
	{
		...
		public AdSeries()
		{
			...
			DashStyle = DashStyle_DefaultValue = AdSeriesDashStyle.Solid;
			...
			Type = Type_DefaultValue = AdSeriesType.Ad;
		...
		/// </summary>
		public AdSeriesType Type { get; set; }
		private AdSeriesType Type_DefaultValue { get; set; }
		...
		internal override Hashtable ToHashtable()
		{
			...
			if (PointDescriptionFormatter != PointDescriptionFormatter_DefaultValue) { h.Add("pointDescriptionFormatter",PointDescriptionFormatter); Highstock.AddFunction("AdSeriesPointDescriptionFormatter.pointDescriptionFormatter", PointDescriptionFormatter); }  
