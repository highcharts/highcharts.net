...
namespace Highsoft.Web.Mvc.Stocks
{
	public partial class AdSeriesAccessibility  : BaseObject
	{
		...
		public AdSeriesAccessibility()
		{
			...
			Point = Point_DefaultValue = new AdSeriesAccessibilityPoint();
		...
		/// </summary>
		public AdSeriesAccessibilityPoint Point { get; set; }
		private AdSeriesAccessibilityPoint Point_DefaultValue { get; set; }
