...
namespace Highsoft.Web.Mvc.Stocks
{
	public partial class AdSeriesDataLabels  : BaseObject
	{
		...
		internal override Hashtable ToHashtable()
		{
			...
			if (Formatter != Formatter_DefaultValue) { h.Add("formatter",Formatter); Highstock.AddFunction("AdSeriesDataLabelsFormatter.formatter", Formatter); }  
			...
			if (NullFormatter != NullFormatter_DefaultValue) { h.Add("nullFormatter",NullFormatter); Highstock.AddFunction("AdSeriesDataLabelsNullFormatter.nullFormatter", NullFormatter); }  
