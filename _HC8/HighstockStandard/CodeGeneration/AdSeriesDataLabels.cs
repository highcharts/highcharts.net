...
{
	public partial class AdSeriesDataLabels  : BaseObject
	{
		Hashtable h = new Hashtable();

		public AdSeriesDataLabels()
		{
			Align = Align_DefaultValue = AdSeriesDataLabelsAlign.Center;
			...
			Filter = Filter_DefaultValue = new AdSeriesDataLabelsFilter();
			...
			Overflow = Overflow_DefaultValue = AdSeriesDataLabelsOverflow.Justify;
			Padding = Padding_DefaultValue = 5;
			Position = Position_DefaultValue = AdSeriesDataLabelsPosition.Center;
			...
			TextPath = TextPath_DefaultValue = new AdSeriesDataLabelsTextPath();
			UseHTML = UseHTML_DefaultValue = false;
			VerticalAlign = VerticalAlign_DefaultValue = AdSeriesDataLabelsVerticalAlign.Bottom;
			X = X_DefaultValue = 0;
			Y = Y_DefaultValue = 0;
			Z = Z_DefaultValue = 6;
		...
		/// </summary>
		public AdSeriesDataLabelsAlign Align { get; set; }
		private AdSeriesDataLabelsAlign Align_DefaultValue { get; set; }
		...
		/// </summary>
		public AdSeriesDataLabelsFilter Filter { get; set; }
		private AdSeriesDataLabelsFilter Filter_DefaultValue { get; set; }
		...
		/// </summary>
		public AdSeriesDataLabelsOverflow Overflow { get; set; }
		private AdSeriesDataLabelsOverflow Overflow_DefaultValue { get; set; }
		...
		/// </summary>
		public AdSeriesDataLabelsPosition Position { get; set; }
		private AdSeriesDataLabelsPosition Position_DefaultValue { get; set; }
		...
		/// </summary>
		public AdSeriesDataLabelsTextPath TextPath { get; set; }
		private AdSeriesDataLabelsTextPath TextPath_DefaultValue { get; set; }
		...
		/// </summary>
		public AdSeriesDataLabelsVerticalAlign VerticalAlign { get; set; }
		private AdSeriesDataLabelsVerticalAlign VerticalAlign_DefaultValue { get; set; }
