...
{
	public partial class AdSeriesLastPriceLabel  : BaseObject
	{
		Hashtable h = new Hashtable();

		public AdSeriesLastPriceLabel()
		{
			Align = Align_DefaultValue = AdSeriesLastPriceLabelAlign.Null;
		...
		/// 
		/// </summary>
		public AdSeriesLastPriceLabelAlign Align { get; set; }
		private AdSeriesLastPriceLabelAlign Align_DefaultValue { get; set; }
