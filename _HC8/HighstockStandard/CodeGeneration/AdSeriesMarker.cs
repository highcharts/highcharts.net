...
{
	public partial class AdSeriesMarker  : BaseObject
	{
		Hashtable h = new Hashtable();

		public AdSeriesMarker()
		{
			...
			States = States_DefaultValue = new AdSeriesMarkerStates();
		...
		/// </summary>
		public AdSeriesMarkerStates States { get; set; }
		private AdSeriesMarkerStates States_DefaultValue { get; set; }
