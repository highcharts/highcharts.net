...
{
	public partial class AdSeriesOnPoint  : BaseObject
	{
		Hashtable h = new Hashtable();

		public AdSeriesOnPoint()
		{
			ConnectorOptions = ConnectorOptions_DefaultValue = new AdSeriesOnPointConnectorOptions();
			Id = Id_DefaultValue = "";
			Position = Position_DefaultValue = new AdSeriesOnPointPosition();
		...
		/// </summary>
		public AdSeriesOnPointConnectorOptions ConnectorOptions { get; set; }
		private AdSeriesOnPointConnectorOptions ConnectorOptions_DefaultValue { get; set; }
		...
		/// </summary>
		public AdSeriesOnPointPosition Position { get; set; }
		private AdSeriesOnPointPosition Position_DefaultValue { get; set; }
