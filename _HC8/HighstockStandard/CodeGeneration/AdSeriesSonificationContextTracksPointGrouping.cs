...
{
	public partial class AdSeriesSonificationContextTracksPointGrouping  : BaseObject
	{
		Hashtable h = new Hashtable();

		public AdSeriesSonificationContextTracksPointGrouping()
		{
			Algorithm = Algorithm_DefaultValue = AdSeriesSonificationContextTracksPointGroupingAlgorithm.Minimax;
		...
		/// </summary>
		public AdSeriesSonificationContextTracksPointGroupingAlgorithm Algorithm { get; set; }
		private AdSeriesSonificationContextTracksPointGroupingAlgorithm Algorithm_DefaultValue { get; set; }
