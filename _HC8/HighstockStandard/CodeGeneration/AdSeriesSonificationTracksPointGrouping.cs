...
{
	public partial class AdSeriesSonificationTracksPointGrouping  : BaseObject
	{
		Hashtable h = new Hashtable();

		public AdSeriesSonificationTracksPointGrouping()
		{
			Algorithm = Algorithm_DefaultValue = AdSeriesSonificationTracksPointGroupingAlgorithm.Minimax;
		...
		/// </summary>
		public AdSeriesSonificationTracksPointGroupingAlgorithm Algorithm { get; set; }
		private AdSeriesSonificationTracksPointGroupingAlgorithm Algorithm_DefaultValue { get; set; }
