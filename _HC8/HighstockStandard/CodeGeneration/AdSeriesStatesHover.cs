...
{
	public partial class AdSeriesStatesHover  : BaseObject
	{
		Hashtable h = new Hashtable();

		public AdSeriesStatesHover()
		{
			Animation = Animation_DefaultValue = new Animation() { Enabled = true };
			Enabled = Enabled_DefaultValue = null;
			Halo = Halo_DefaultValue = new AdSeriesStatesHoverHalo();
			LineWidth = LineWidth_DefaultValue = null;
			LineWidthPlus = LineWidthPlus_DefaultValue = null;
			Marker = Marker_DefaultValue = new AdSeriesStatesHoverMarker();
		...
		/// </summary>
		public AdSeriesStatesHoverHalo Halo { get; set; }
		private AdSeriesStatesHoverHalo Halo_DefaultValue { get; set; }
		...
		/// </summary>
		public AdSeriesStatesHoverMarker Marker { get; set; }
		private AdSeriesStatesHoverMarker Marker_DefaultValue { get; set; }
