...
{
	public partial class AdSeriesStatesSelect  : BaseObject
	{
		Hashtable h = new Hashtable();

		public AdSeriesStatesSelect()
		{
			Animation = Animation_DefaultValue = new Animation() { Enabled = true };
			Enabled = Enabled_DefaultValue = null;
			Halo = Halo_DefaultValue = new AdSeriesStatesSelectHalo();
			LineWidth = LineWidth_DefaultValue = null;
			LineWidthPlus = LineWidthPlus_DefaultValue = null;
			Marker = Marker_DefaultValue = new AdSeriesStatesSelectMarker();
		...
		/// </summary>
		public AdSeriesStatesSelectHalo Halo { get; set; }
		private AdSeriesStatesSelectHalo Halo_DefaultValue { get; set; }
		...
		/// </summary>
		public AdSeriesStatesSelectMarker Marker { get; set; }
		private AdSeriesStatesSelectMarker Marker_DefaultValue { get; set; }
