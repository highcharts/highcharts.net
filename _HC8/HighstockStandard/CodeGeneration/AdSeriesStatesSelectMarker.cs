...
{
	public partial class AdSeriesStatesSelectMarker  : BaseObject
	{
		Hashtable h = new Hashtable();

		public AdSeriesStatesSelectMarker()
		{
			...
			States = States_DefaultValue = new AdSeriesStatesSelectMarkerStates();
		...
		/// </summary>
		public AdSeriesStatesSelectMarkerStates States { get; set; }
		private AdSeriesStatesSelectMarkerStates States_DefaultValue { get; set; }
