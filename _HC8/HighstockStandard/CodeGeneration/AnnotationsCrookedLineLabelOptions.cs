...
{
	public partial class AnnotationsCrookedLineLabelOptions  : BaseObject
	{
		Hashtable h = new Hashtable();

		public AnnotationsCrookedLineLabelOptions()
		{
			Accessibility = Accessibility_DefaultValue = new AnnotationsCrookedLineLabelOptionsAccessibility();
			Align = Align_DefaultValue = AnnotationsCrookedLineLabelOptionsAlign.Center;
			...
			Overflow = Overflow_DefaultValue = AnnotationsCrookedLineLabelOptionsOverflow.Justify;
		...
		/// </summary>
		public AnnotationsCrookedLineLabelOptionsAccessibility Accessibility { get; set; }
		private AnnotationsCrookedLineLabelOptionsAccessibility Accessibility_DefaultValue { get; set; }
		 

		/// <summary>
		/// The alignment of the annotation's label. If right,the right side of the label should be touching the point.
		/// </summary>
		public AnnotationsCrookedLineLabelOptionsAlign Align { get; set; }
		private AnnotationsCrookedLineLabelOptionsAlign Align_DefaultValue { get; set; }
		...
		/// </summary>
		public AnnotationsCrookedLineLabelOptionsOverflow Overflow { get; set; }
		private AnnotationsCrookedLineLabelOptionsOverflow Overflow_DefaultValue { get; set; }
		...
		/// </summary>
		public AnnotationsCrookedLineLabelOptionsVerticalAlign VerticalAlign { get; set; }
		private AnnotationsCrookedLineLabelOptionsVerticalAlign VerticalAlign_DefaultValue { get; set; }
		...
		internal override Hashtable ToHashtable()
		{
			...
			if (Formatter != Formatter_DefaultValue) { h.Add("formatter",Formatter); Highstock.AddFunction("AnnotationsCrookedLineLabelOptionsFormatter.formatter", Formatter); }  
