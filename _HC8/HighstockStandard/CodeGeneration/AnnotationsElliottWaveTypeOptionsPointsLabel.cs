...
{
	public partial class AnnotationsElliottWaveTypeOptionsPointsLabel  : BaseObject
	{
		Hashtable h = new Hashtable();

		public AnnotationsElliottWaveTypeOptionsPointsLabel()
		{
			Accessibility = Accessibility_DefaultValue = new AnnotationsElliottWaveTypeOptionsPointsLabelAccessibility();
			Align = Align_DefaultValue = AnnotationsElliottWaveTypeOptionsPointsLabelAlign.Center;
			...
			VerticalAlign = VerticalAlign_DefaultValue = AnnotationsElliottWaveTypeOptionsPointsLabelVerticalAlign.Bottom;
			X = X_DefaultValue = 0;
			Y = Y_DefaultValue = -16;
		...
		/// </summary>
		public AnnotationsElliottWaveTypeOptionsPointsLabelAccessibility Accessibility { get; set; }
		private AnnotationsElliottWaveTypeOptionsPointsLabelAccessibility Accessibility_DefaultValue { get; set; }
		 

		/// <summary>
		/// The alignment of the annotation's label. If right,the right side of the label should be touching the point.
		/// </summary>
		public AnnotationsElliottWaveTypeOptionsPointsLabelAlign Align { get; set; }
		private AnnotationsElliottWaveTypeOptionsPointsLabelAlign Align_DefaultValue { get; set; }
		...
		/// </summary>
		public AnnotationsElliottWaveTypeOptionsPointsLabelOverflow Overflow { get; set; }
		private AnnotationsElliottWaveTypeOptionsPointsLabelOverflow Overflow_DefaultValue { get; set; }
		...
		/// </summary>
		public AnnotationsElliottWaveTypeOptionsPointsLabelVerticalAlign VerticalAlign { get; set; }
		private AnnotationsElliottWaveTypeOptionsPointsLabelVerticalAlign VerticalAlign_DefaultValue { get; set; }
		...
		internal override Hashtable ToHashtable()
		{
			...
			if (Formatter != Formatter_DefaultValue) { h.Add("formatter",Formatter); Highstock.AddFunction("AnnotationsElliottWaveTypeOptionsPointsLabelFormatter.formatter", Formatter); }  
