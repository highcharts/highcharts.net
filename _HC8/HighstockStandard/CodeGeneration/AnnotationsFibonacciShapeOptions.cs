...
namespace Highsoft.Web.Mvc.Stocks
{
	public partial class AnnotationsFibonacciShapeOptions  : BaseObject
	{
		...
		{
			DashStyle = DashStyle_DefaultValue = AnnotationsFibonacciShapeOptionsDashStyle.Null;
		...
		private AnnotationsFibonacciShapeOptionsDashStyle DashStyle_DefaultValue { get; set; }
