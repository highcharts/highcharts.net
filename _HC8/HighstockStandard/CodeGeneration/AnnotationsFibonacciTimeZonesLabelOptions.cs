...
{
	public partial class AnnotationsFibonacciTimeZonesLabelOptions  : BaseObject
	{
		Hashtable h = new Hashtable();

		public AnnotationsFibonacciTimeZonesLabelOptions()
		{
			Accessibility = Accessibility_DefaultValue = new AnnotationsFibonacciTimeZonesLabelOptionsAccessibility();
			Align = Align_DefaultValue = AnnotationsFibonacciTimeZonesLabelOptionsAlign.Center;
			...
			Overflow = Overflow_DefaultValue = AnnotationsFibonacciTimeZonesLabelOptionsOverflow.Justify;
			...
			VerticalAlign = VerticalAlign_DefaultValue = AnnotationsFibonacciTimeZonesLabelOptionsVerticalAlign.Bottom;
			X = X_DefaultValue = 0;
			Y = Y_DefaultValue = -16;
		...
		/// </summary>
		public AnnotationsFibonacciTimeZonesLabelOptionsAccessibility Accessibility { get; set; }
		private AnnotationsFibonacciTimeZonesLabelOptionsAccessibility Accessibility_DefaultValue { get; set; }
		 

		/// <summary>
		/// The alignment of the annotation's label. If right,the right side of the label should be touching the point.
		/// </summary>
		public AnnotationsFibonacciTimeZonesLabelOptionsAlign Align { get; set; }
		private AnnotationsFibonacciTimeZonesLabelOptionsAlign Align_DefaultValue { get; set; }
		...
		/// </summary>
		public AnnotationsFibonacciTimeZonesLabelOptionsOverflow Overflow { get; set; }
		private AnnotationsFibonacciTimeZonesLabelOptionsOverflow Overflow_DefaultValue { get; set; }
		...
		/// </summary>
		public AnnotationsFibonacciTimeZonesLabelOptionsVerticalAlign VerticalAlign { get; set; }
		private AnnotationsFibonacciTimeZonesLabelOptionsVerticalAlign VerticalAlign_DefaultValue { get; set; }
