...
{
	public partial class AnnotationsFibonacciTimeZonesShapeOptions  : BaseObject
	{
		Hashtable h = new Hashtable();

		public AnnotationsFibonacciTimeZonesShapeOptions()
		{
			DashStyle = DashStyle_DefaultValue = AnnotationsFibonacciTimeZonesShapeOptionsDashStyle.Null;
		...
		/// </summary>
		public AnnotationsFibonacciTimeZonesShapeOptionsDashStyle DashStyle { get; set; }
		private AnnotationsFibonacciTimeZonesShapeOptionsDashStyle DashStyle_DefaultValue { get; set; }
