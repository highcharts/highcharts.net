...
{
	public partial class AnnotationsFibonacciTypeOptionsLabels  : BaseObject
	{
		Hashtable h = new Hashtable();

		public AnnotationsFibonacciTypeOptionsLabels()
		{
			Accessibility = Accessibility_DefaultValue = new AnnotationsFibonacciTypeOptionsLabelsAccessibility();
			Align = Align_DefaultValue = AnnotationsFibonacciTypeOptionsLabelsAlign.Center;
			...
			Overflow = Overflow_DefaultValue = AnnotationsFibonacciTypeOptionsLabelsOverflow.Justify;
			...
			VerticalAlign = VerticalAlign_DefaultValue = AnnotationsFibonacciTypeOptionsLabelsVerticalAlign.Bottom;
			X = X_DefaultValue = 0;
			Y = Y_DefaultValue = -16;
		...
		/// </summary>
		public AnnotationsFibonacciTypeOptionsLabelsAccessibility Accessibility { get; set; }
		private AnnotationsFibonacciTypeOptionsLabelsAccessibility Accessibility_DefaultValue { get; set; }
		 

		/// <summary>
		/// The alignment of the annotation's label. If right,the right side of the label should be touching the point.
		/// </summary>
		public AnnotationsFibonacciTypeOptionsLabelsAlign Align { get; set; }
		private AnnotationsFibonacciTypeOptionsLabelsAlign Align_DefaultValue { get; set; }
		...
		/// </summary>
		public AnnotationsFibonacciTypeOptionsLabelsOverflow Overflow { get; set; }
		private AnnotationsFibonacciTypeOptionsLabelsOverflow Overflow_DefaultValue { get; set; }
		...
		/// </summary>
		public AnnotationsFibonacciTypeOptionsLabelsVerticalAlign VerticalAlign { get; set; }
		private AnnotationsFibonacciTypeOptionsLabelsVerticalAlign VerticalAlign_DefaultValue { get; set; }
		...
		internal override Hashtable ToHashtable()
		{
			...
			if (Formatter != Formatter_DefaultValue) { h.Add("formatter",Formatter); Highstock.AddFunction("AnnotationsFibonacciTypeOptionsLabelsFormatter.formatter", Formatter); }  
