...
{
	public partial class AnnotationsInfinityLineLabelOptions  : BaseObject
	{
		Hashtable h = new Hashtable();

		public AnnotationsInfinityLineLabelOptions()
		{
			Accessibility = Accessibility_DefaultValue = new AnnotationsInfinityLineLabelOptionsAccessibility();
			Align = Align_DefaultValue = AnnotationsInfinityLineLabelOptionsAlign.Center;
		...
		/// </summary>
		public AnnotationsInfinityLineLabelOptionsAccessibility Accessibility { get; set; }
		private AnnotationsInfinityLineLabelOptionsAccessibility Accessibility_DefaultValue { get; set; }
		 

		/// <summary>
		/// The alignment of the annotation's label. If right,the right side of the label should be touching the point.
		/// </summary>
		public AnnotationsInfinityLineLabelOptionsAlign Align { get; set; }
		private AnnotationsInfinityLineLabelOptionsAlign Align_DefaultValue { get; set; }
		...
		/// </summary>
		public AnnotationsInfinityLineLabelOptionsVerticalAlign VerticalAlign { get; set; }
		private AnnotationsInfinityLineLabelOptionsVerticalAlign VerticalAlign_DefaultValue { get; set; }
