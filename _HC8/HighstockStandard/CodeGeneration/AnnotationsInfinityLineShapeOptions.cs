...
{
	public partial class AnnotationsInfinityLineShapeOptions  : BaseObject
	{
		Hashtable h = new Hashtable();

		public AnnotationsInfinityLineShapeOptions()
		{
			DashStyle = DashStyle_DefaultValue = AnnotationsInfinityLineShapeOptionsDashStyle.Null;
		...
		/// </summary>
		public AnnotationsInfinityLineShapeOptionsDashStyle DashStyle { get; set; }
		private AnnotationsInfinityLineShapeOptionsDashStyle DashStyle_DefaultValue { get; set; }
