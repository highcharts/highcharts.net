...
{
	public partial class AnnotationsMeasureLabelOptions  : BaseObject
	{
		Hashtable h = new Hashtable();

		public AnnotationsMeasureLabelOptions()
		{
			Accessibility = Accessibility_DefaultValue = new AnnotationsMeasureLabelOptionsAccessibility();
			Align = Align_DefaultValue = AnnotationsMeasureLabelOptionsAlign.Center;
			...
			Overflow = Overflow_DefaultValue = AnnotationsMeasureLabelOptionsOverflow.Justify;
			...
			VerticalAlign = VerticalAlign_DefaultValue = AnnotationsMeasureLabelOptionsVerticalAlign.Bottom;
			X = X_DefaultValue = 0;
			Y = Y_DefaultValue = -16;
		...
		/// </summary>
		public AnnotationsMeasureLabelOptionsAccessibility Accessibility { get; set; }
		private AnnotationsMeasureLabelOptionsAccessibility Accessibility_DefaultValue { get; set; }
		 

		/// <summary>
		/// The alignment of the annotation's label. If right,the right side of the label should be touching the point.
		/// </summary>
		public AnnotationsMeasureLabelOptionsAlign Align { get; set; }
		private AnnotationsMeasureLabelOptionsAlign Align_DefaultValue { get; set; }
		...
		/// </summary>
		public AnnotationsMeasureLabelOptionsOverflow Overflow { get; set; }
		private AnnotationsMeasureLabelOptionsOverflow Overflow_DefaultValue { get; set; }
		...
		/// </summary>
		public AnnotationsMeasureLabelOptionsVerticalAlign VerticalAlign { get; set; }
		private AnnotationsMeasureLabelOptionsVerticalAlign VerticalAlign_DefaultValue { get; set; }
