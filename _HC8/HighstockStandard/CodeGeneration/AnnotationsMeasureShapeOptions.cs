...
{
	public partial class AnnotationsMeasureShapeOptions  : BaseObject
	{
		Hashtable h = new Hashtable();

		public AnnotationsMeasureShapeOptions()
		{
			DashStyle = DashStyle_DefaultValue = AnnotationsMeasureShapeOptionsDashStyle.Null;
		...
		/// </summary>
		public AnnotationsMeasureShapeOptionsDashStyle DashStyle { get; set; }
		private AnnotationsMeasureShapeOptionsDashStyle DashStyle_DefaultValue { get; set; }
