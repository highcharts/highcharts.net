...
{
	public partial class AnnotationsPitchforkLabelOptions  : BaseObject
	{
		Hashtable h = new Hashtable();

		public AnnotationsPitchforkLabelOptions()
		{
			Accessibility = Accessibility_DefaultValue = new AnnotationsPitchforkLabelOptionsAccessibility();
			Align = Align_DefaultValue = AnnotationsPitchforkLabelOptionsAlign.Center;
			...
			Overflow = Overflow_DefaultValue = AnnotationsPitchforkLabelOptionsOverflow.Justify;
			...
			VerticalAlign = VerticalAlign_DefaultValue = AnnotationsPitchforkLabelOptionsVerticalAlign.Bottom;
			X = X_DefaultValue = 0;
			Y = Y_DefaultValue = -16;
		...
		/// </summary>
		public AnnotationsPitchforkLabelOptionsAccessibility Accessibility { get; set; }
		private AnnotationsPitchforkLabelOptionsAccessibility Accessibility_DefaultValue { get; set; }
		 

		/// <summary>
		/// The alignment of the annotation's label. If right,the right side of the label should be touching the point.
		/// </summary>
		public AnnotationsPitchforkLabelOptionsAlign Align { get; set; }
		private AnnotationsPitchforkLabelOptionsAlign Align_DefaultValue { get; set; }
		...
		/// </summary>
		public AnnotationsPitchforkLabelOptionsOverflow Overflow { get; set; }
		private AnnotationsPitchforkLabelOptionsOverflow Overflow_DefaultValue { get; set; }
		...
		/// </summary>
		public AnnotationsPitchforkLabelOptionsVerticalAlign VerticalAlign { get; set; }
		private AnnotationsPitchforkLabelOptionsVerticalAlign VerticalAlign_DefaultValue { get; set; }
		...
		internal override Hashtable ToHashtable()
		{
			...
			if (Formatter != Formatter_DefaultValue) { h.Add("formatter",Formatter); Highstock.AddFunction("AnnotationsPitchforkLabelOptionsFormatter.formatter", Formatter); }  
