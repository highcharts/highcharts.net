...
{
	public partial class AnnotationsPitchforkShapeOptions  : BaseObject
	{
		Hashtable h = new Hashtable();

		public AnnotationsPitchforkShapeOptions()
		{
			DashStyle = DashStyle_DefaultValue = AnnotationsPitchforkShapeOptionsDashStyle.Null;
		...
		/// </summary>
		public AnnotationsPitchforkShapeOptionsDashStyle DashStyle { get; set; }
		private AnnotationsPitchforkShapeOptionsDashStyle DashStyle_DefaultValue { get; set; }
