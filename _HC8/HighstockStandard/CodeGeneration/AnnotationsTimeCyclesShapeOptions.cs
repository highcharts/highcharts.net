...
{
	public partial class AnnotationsTimeCyclesShapeOptions  : BaseObject
	{
		Hashtable h = new Hashtable();

		public AnnotationsTimeCyclesShapeOptions()
		{
			DashStyle = DashStyle_DefaultValue = AnnotationsTimeCyclesShapeOptionsDashStyle.Null;
		...
		/// </summary>
		public AnnotationsTimeCyclesShapeOptionsDashStyle DashStyle { get; set; }
		private AnnotationsTimeCyclesShapeOptionsDashStyle DashStyle_DefaultValue { get; set; }
