...
{
	public partial class AnnotationsTunnelLabelOptions  : BaseObject
	{
		Hashtable h = new Hashtable();

		public AnnotationsTunnelLabelOptions()
		{
			Accessibility = Accessibility_DefaultValue = new AnnotationsTunnelLabelOptionsAccessibility();
			Align = Align_DefaultValue = AnnotationsTunnelLabelOptionsAlign.Center;
			...
			Overflow = Overflow_DefaultValue = AnnotationsTunnelLabelOptionsOverflow.Justify;
			...
			VerticalAlign = VerticalAlign_DefaultValue = AnnotationsTunnelLabelOptionsVerticalAlign.Bottom;
			X = X_DefaultValue = 0;
			Y = Y_DefaultValue = -16;
		...
		/// </summary>
		public AnnotationsTunnelLabelOptionsAccessibility Accessibility { get; set; }
		private AnnotationsTunnelLabelOptionsAccessibility Accessibility_DefaultValue { get; set; }
		 

		/// <summary>
		/// The alignment of the annotation's label. If right,the right side of the label should be touching the point.
		/// </summary>
		public AnnotationsTunnelLabelOptionsAlign Align { get; set; }
		private AnnotationsTunnelLabelOptionsAlign Align_DefaultValue { get; set; }
		...
		/// </summary>
		public AnnotationsTunnelLabelOptionsOverflow Overflow { get; set; }
		private AnnotationsTunnelLabelOptionsOverflow Overflow_DefaultValue { get; set; }
		...
		/// </summary>
		public AnnotationsTunnelLabelOptionsVerticalAlign VerticalAlign { get; set; }
		private AnnotationsTunnelLabelOptionsVerticalAlign VerticalAlign_DefaultValue { get; set; }
		...
		internal override Hashtable ToHashtable()
		{
			...
			if (Formatter != Formatter_DefaultValue) { h.Add("formatter",Formatter); Highstock.AddFunction("AnnotationsTunnelLabelOptionsFormatter.formatter", Formatter); }  
