...
{
	public partial class AnnotationsTunnelShapeOptions  : BaseObject
	{
		Hashtable h = new Hashtable();

		public AnnotationsTunnelShapeOptions()
		{
			DashStyle = DashStyle_DefaultValue = AnnotationsTunnelShapeOptionsDashStyle.Null;
		...
		/// </summary>
		public AnnotationsTunnelShapeOptionsDashStyle DashStyle { get; set; }
		private AnnotationsTunnelShapeOptionsDashStyle DashStyle_DefaultValue { get; set; }
