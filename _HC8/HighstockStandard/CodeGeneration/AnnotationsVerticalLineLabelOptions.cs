...
{
	public partial class AnnotationsVerticalLineLabelOptions  : BaseObject
	{
		Hashtable h = new Hashtable();

		public AnnotationsVerticalLineLabelOptions()
		{
			Accessibility = Accessibility_DefaultValue = new AnnotationsVerticalLineLabelOptionsAccessibility();
			Align = Align_DefaultValue = AnnotationsVerticalLineLabelOptionsAlign.Center;
			...
			Overflow = Overflow_DefaultValue = AnnotationsVerticalLineLabelOptionsOverflow.Justify;
			...
			VerticalAlign = VerticalAlign_DefaultValue = AnnotationsVerticalLineLabelOptionsVerticalAlign.Bottom;
			X = X_DefaultValue = 0;
			Y = Y_DefaultValue = -16;
		...
		/// </summary>
		public AnnotationsVerticalLineLabelOptionsAccessibility Accessibility { get; set; }
		private AnnotationsVerticalLineLabelOptionsAccessibility Accessibility_DefaultValue { get; set; }
		 

		/// <summary>
		/// The alignment of the annotation's label. If right,the right side of the label should be touching the point.
		/// </summary>
		public AnnotationsVerticalLineLabelOptionsAlign Align { get; set; }
		private AnnotationsVerticalLineLabelOptionsAlign Align_DefaultValue { get; set; }
		...
		/// </summary>
		public AnnotationsVerticalLineLabelOptionsOverflow Overflow { get; set; }
		private AnnotationsVerticalLineLabelOptionsOverflow Overflow_DefaultValue { get; set; }
		...
		/// </summary>
		public AnnotationsVerticalLineLabelOptionsVerticalAlign VerticalAlign { get; set; }
		private AnnotationsVerticalLineLabelOptionsVerticalAlign VerticalAlign_DefaultValue { get; set; }
		...
		internal override Hashtable ToHashtable()
		{
			...
			if (Formatter != Formatter_DefaultValue) { h.Add("formatter",Formatter); Highstock.AddFunction("AnnotationsVerticalLineLabelOptionsFormatter.formatter", Formatter); }  
