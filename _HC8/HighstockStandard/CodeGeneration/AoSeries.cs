...
namespace Highsoft.Web.Mvc.Stocks
{
	public partial class AoSeries  : Series
	{
		...
		public AoSeries()
		{
			...
			DashStyle = DashStyle_DefaultValue = AoSeriesDashStyle.Solid;
			...
			Type = Type_DefaultValue = AoSeriesType.Ao;
		...
		internal override Hashtable ToHashtable()
		{
			...
			if (PointDescriptionFormatter != PointDescriptionFormatter_DefaultValue) { h.Add("pointDescriptionFormatter",PointDescriptionFormatter); Highstock.AddFunction("AoSeriesPointDescriptionFormatter.pointDescriptionFormatter", PointDescriptionFormatter); }  
