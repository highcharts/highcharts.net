...
{
	public partial class AoSeriesDataLabels  : BaseObject
	{
		Hashtable h = new Hashtable();

		public AoSeriesDataLabels()
		{
			Align = Align_DefaultValue = AoSeriesDataLabelsAlign.Center;
			...
			Filter = Filter_DefaultValue = new AoSeriesDataLabelsFilter();
			...
			Overflow = Overflow_DefaultValue = AoSeriesDataLabelsOverflow.Justify;
			Padding = Padding_DefaultValue = 5;
			Position = Position_DefaultValue = AoSeriesDataLabelsPosition.Center;
			...
			TextPath = TextPath_DefaultValue = new AoSeriesDataLabelsTextPath();
			UseHTML = UseHTML_DefaultValue = false;
			VerticalAlign = VerticalAlign_DefaultValue = AoSeriesDataLabelsVerticalAlign.Bottom;
			X = X_DefaultValue = 0;
			Y = Y_DefaultValue = 0;
			Z = Z_DefaultValue = 6;
		...
		/// </summary>
		public AoSeriesDataLabelsAlign Align { get; set; }
		private AoSeriesDataLabelsAlign Align_DefaultValue { get; set; }
		...
		/// </summary>
		public AoSeriesDataLabelsFilter Filter { get; set; }
		private AoSeriesDataLabelsFilter Filter_DefaultValue { get; set; }
		...
		/// </summary>
		public AoSeriesDataLabelsOverflow Overflow { get; set; }
		private AoSeriesDataLabelsOverflow Overflow_DefaultValue { get; set; }
		...
		/// </summary>
		public AoSeriesDataLabelsPosition Position { get; set; }
		private AoSeriesDataLabelsPosition Position_DefaultValue { get; set; }
		...
		/// </summary>
		public AoSeriesDataLabelsTextPath TextPath { get; set; }
		private AoSeriesDataLabelsTextPath TextPath_DefaultValue { get; set; }
		...
		/// </summary>
		public AoSeriesDataLabelsVerticalAlign VerticalAlign { get; set; }
		private AoSeriesDataLabelsVerticalAlign VerticalAlign_DefaultValue { get; set; }
