...
{
	public partial class AoSeriesLastPriceLabel  : BaseObject
	{
		Hashtable h = new Hashtable();

		public AoSeriesLastPriceLabel()
		{
			Align = Align_DefaultValue = AoSeriesLastPriceLabelAlign.Null;
		...
		/// 
		/// </summary>
		public AoSeriesLastPriceLabelAlign Align { get; set; }
		private AoSeriesLastPriceLabelAlign Align_DefaultValue { get; set; }
