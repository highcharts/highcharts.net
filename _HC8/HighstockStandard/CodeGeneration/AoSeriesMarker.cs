...
{
	public partial class AoSeriesMarker  : BaseObject
	{
		Hashtable h = new Hashtable();

		public AoSeriesMarker()
		{
			...
			States = States_DefaultValue = new AoSeriesMarkerStates();
		...
		/// </summary>
		public AoSeriesMarkerStates States { get; set; }
		private AoSeriesMarkerStates States_DefaultValue { get; set; }
