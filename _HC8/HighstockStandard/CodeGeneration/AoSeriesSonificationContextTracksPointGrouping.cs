...
{
	public partial class AoSeriesSonificationContextTracksPointGrouping  : BaseObject
	{
		Hashtable h = new Hashtable();

		public AoSeriesSonificationContextTracksPointGrouping()
		{
			Algorithm = Algorithm_DefaultValue = AoSeriesSonificationContextTracksPointGroupingAlgorithm.Minimax;
		...
		/// </summary>
		public AoSeriesSonificationContextTracksPointGroupingAlgorithm Algorithm { get; set; }
		private AoSeriesSonificationContextTracksPointGroupingAlgorithm Algorithm_DefaultValue { get; set; }
