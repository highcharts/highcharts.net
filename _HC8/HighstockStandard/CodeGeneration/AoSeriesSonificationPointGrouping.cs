...
{
	public partial class AoSeriesSonificationPointGrouping  : BaseObject
	{
		Hashtable h = new Hashtable();

		public AoSeriesSonificationPointGrouping()
		{
			Algorithm = Algorithm_DefaultValue = AoSeriesSonificationPointGroupingAlgorithm.Minimax;
		...
		/// </summary>
		public AoSeriesSonificationPointGroupingAlgorithm Algorithm { get; set; }
		private AoSeriesSonificationPointGroupingAlgorithm Algorithm_DefaultValue { get; set; }
