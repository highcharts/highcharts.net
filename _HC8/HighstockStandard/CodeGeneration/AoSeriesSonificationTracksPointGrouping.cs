...
{
	public partial class AoSeriesSonificationTracksPointGrouping  : BaseObject
	{
		Hashtable h = new Hashtable();

		public AoSeriesSonificationTracksPointGrouping()
		{
			Algorithm = Algorithm_DefaultValue = AoSeriesSonificationTracksPointGroupingAlgorithm.Minimax;
		...
		/// </summary>
		public AoSeriesSonificationTracksPointGroupingAlgorithm Algorithm { get; set; }
		private AoSeriesSonificationTracksPointGroupingAlgorithm Algorithm_DefaultValue { get; set; }
