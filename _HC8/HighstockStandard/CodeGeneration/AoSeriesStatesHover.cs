...
{
	public partial class AoSeriesStatesHover  : BaseObject
	{
		Hashtable h = new Hashtable();

		public AoSeriesStatesHover()
		{
			Animation = Animation_DefaultValue = new Animation() { Enabled = true };
			Enabled = Enabled_DefaultValue = null;
			Halo = Halo_DefaultValue = new AoSeriesStatesHoverHalo();
			LineWidth = LineWidth_DefaultValue = null;
			LineWidthPlus = LineWidthPlus_DefaultValue = null;
			Marker = Marker_DefaultValue = new AoSeriesStatesHoverMarker();
		...
		/// </summary>
		public AoSeriesStatesHoverHalo Halo { get; set; }
		private AoSeriesStatesHoverHalo Halo_DefaultValue { get; set; }
		...
		/// </summary>
		public AoSeriesStatesHoverMarker Marker { get; set; }
		private AoSeriesStatesHoverMarker Marker_DefaultValue { get; set; }
