...
{
	public partial class AoSeriesStatesHoverMarker  : BaseObject
	{
		Hashtable h = new Hashtable();

		public AoSeriesStatesHoverMarker()
		{
			...
			States = States_DefaultValue = new AoSeriesStatesHoverMarkerStates();
		...
		/// </summary>
		public AoSeriesStatesHoverMarkerStates States { get; set; }
		private AoSeriesStatesHoverMarkerStates States_DefaultValue { get; set; }
