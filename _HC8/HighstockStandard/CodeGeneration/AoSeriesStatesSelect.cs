...
{
	public partial class AoSeriesStatesSelect  : BaseObject
	{
		Hashtable h = new Hashtable();

		public AoSeriesStatesSelect()
		{
			Animation = Animation_DefaultValue = new Animation() { Enabled = true };
			Enabled = Enabled_DefaultValue = true;
			Halo = Halo_DefaultValue = new AoSeriesStatesSelectHalo();
			LineWidth = LineWidth_DefaultValue = null;
			LineWidthPlus = LineWidthPlus_DefaultValue = 1;
			Marker = Marker_DefaultValue = new AoSeriesStatesSelectMarker();
		...
		/// </summary>
		public AoSeriesStatesSelectHalo Halo { get; set; }
		private AoSeriesStatesSelectHalo Halo_DefaultValue { get; set; }
		...
		/// </summary>
		public AoSeriesStatesSelectMarker Marker { get; set; }
		private AoSeriesStatesSelectMarker Marker_DefaultValue { get; set; }
