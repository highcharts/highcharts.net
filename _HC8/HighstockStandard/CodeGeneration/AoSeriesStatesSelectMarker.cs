...
{
	public partial class AoSeriesStatesSelectMarker  : BaseObject
	{
		Hashtable h = new Hashtable();

		public AoSeriesStatesSelectMarker()
		{
			...
			States = States_DefaultValue = new AoSeriesStatesSelectMarkerStates();
		...
		/// </summary>
		public AoSeriesStatesSelectMarkerStates States { get; set; }
		private AoSeriesStatesSelectMarkerStates States_DefaultValue { get; set; }
