...
namespace Highsoft.Web.Mvc.Stocks
{
	public partial class ApoSeries  : Series
	{
		...
		public ApoSeries()
		{
			...
			DashStyle = DashStyle_DefaultValue = ApoSeriesDashStyle.Solid;
			...
			Type = Type_DefaultValue = ApoSeriesType.Apo;
		...
		/// </summary>
		public ApoSeriesType Type { get; set; }
		private ApoSeriesType Type_DefaultValue { get; set; }
		...
		internal override Hashtable ToHashtable()
		{
			...
			if (PointDescriptionFormatter != PointDescriptionFormatter_DefaultValue) { h.Add("pointDescriptionFormatter",PointDescriptionFormatter); Highstock.AddFunction("ApoSeriesPointDescriptionFormatter.pointDescriptionFormatter", PointDescriptionFormatter); }  
