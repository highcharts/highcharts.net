...
{
	public partial class ApoSeriesDataLabels  : BaseObject
	{
		Hashtable h = new Hashtable();

		public ApoSeriesDataLabels()
		{
			Align = Align_DefaultValue = ApoSeriesDataLabelsAlign.Center;
			...
			Filter = Filter_DefaultValue = new ApoSeriesDataLabelsFilter();
			...
			Overflow = Overflow_DefaultValue = ApoSeriesDataLabelsOverflow.Justify;
			Padding = Padding_DefaultValue = 5;
			Position = Position_DefaultValue = ApoSeriesDataLabelsPosition.Center;
			...
			TextPath = TextPath_DefaultValue = new ApoSeriesDataLabelsTextPath();
			UseHTML = UseHTML_DefaultValue = false;
			VerticalAlign = VerticalAlign_DefaultValue = ApoSeriesDataLabelsVerticalAlign.Bottom;
			X = X_DefaultValue = 0;
			Y = Y_DefaultValue = 0;
			Z = Z_DefaultValue = 6;
		...
		/// </summary>
		public ApoSeriesDataLabelsAlign Align { get; set; }
		private ApoSeriesDataLabelsAlign Align_DefaultValue { get; set; }
		...
		/// </summary>
		public ApoSeriesDataLabelsFilter Filter { get; set; }
		private ApoSeriesDataLabelsFilter Filter_DefaultValue { get; set; }
		...
		/// </summary>
		public ApoSeriesDataLabelsOverflow Overflow { get; set; }
		private ApoSeriesDataLabelsOverflow Overflow_DefaultValue { get; set; }
		...
		/// </summary>
		public ApoSeriesDataLabelsPosition Position { get; set; }
		private ApoSeriesDataLabelsPosition Position_DefaultValue { get; set; }
		...
		/// </summary>
		public ApoSeriesDataLabelsTextPath TextPath { get; set; }
		private ApoSeriesDataLabelsTextPath TextPath_DefaultValue { get; set; }
		...
		/// </summary>
		public ApoSeriesDataLabelsVerticalAlign VerticalAlign { get; set; }
		private ApoSeriesDataLabelsVerticalAlign VerticalAlign_DefaultValue { get; set; }
