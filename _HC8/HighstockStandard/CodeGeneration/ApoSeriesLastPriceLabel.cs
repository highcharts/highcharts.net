...
{
	public partial class ApoSeriesLastPriceLabel  : BaseObject
	{
		Hashtable h = new Hashtable();

		public ApoSeriesLastPriceLabel()
		{
			Align = Align_DefaultValue = ApoSeriesLastPriceLabelAlign.Null;
		...
		/// 
		/// </summary>
		public ApoSeriesLastPriceLabelAlign Align { get; set; }
		private ApoSeriesLastPriceLabelAlign Align_DefaultValue { get; set; }
