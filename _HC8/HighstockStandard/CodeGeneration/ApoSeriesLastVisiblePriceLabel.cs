...
{
	public partial class ApoSeriesLastVisiblePriceLabel  : BaseObject
	{
		Hashtable h = new Hashtable();

		public ApoSeriesLastVisiblePriceLabel()
		{
			Align = Align_DefaultValue = ApoSeriesLastVisiblePriceLabelAlign.Null;
		...
		/// 
		/// </summary>
		public ApoSeriesLastVisiblePriceLabelAlign Align { get; set; }
		private ApoSeriesLastVisiblePriceLabelAlign Align_DefaultValue { get; set; }
