...
{
	public partial class ApoSeriesMarker  : BaseObject
	{
		Hashtable h = new Hashtable();

		public ApoSeriesMarker()
		{
			...
			States = States_DefaultValue = new ApoSeriesMarkerStates();
		...
		/// </summary>
		public ApoSeriesMarkerStates States { get; set; }
		private ApoSeriesMarkerStates States_DefaultValue { get; set; }
