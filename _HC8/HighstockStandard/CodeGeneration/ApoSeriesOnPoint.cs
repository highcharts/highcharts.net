...
{
	public partial class ApoSeriesOnPoint  : BaseObject
	{
		Hashtable h = new Hashtable();

		public ApoSeriesOnPoint()
		{
			ConnectorOptions = ConnectorOptions_DefaultValue = new ApoSeriesOnPointConnectorOptions();
			Id = Id_DefaultValue = "";
			Position = Position_DefaultValue = new ApoSeriesOnPointPosition();
		...
		/// </summary>
		public ApoSeriesOnPointConnectorOptions ConnectorOptions { get; set; }
		private ApoSeriesOnPointConnectorOptions ConnectorOptions_DefaultValue { get; set; }
		...
		/// </summary>
		public ApoSeriesOnPointPosition Position { get; set; }
		private ApoSeriesOnPointPosition Position_DefaultValue { get; set; }
