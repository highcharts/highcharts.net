...
{
	public partial class ApoSeriesSonificationPointGrouping  : BaseObject
	{
		Hashtable h = new Hashtable();

		public ApoSeriesSonificationPointGrouping()
		{
			Algorithm = Algorithm_DefaultValue = ApoSeriesSonificationPointGroupingAlgorithm.Minimax;
		...
		/// </summary>
		public ApoSeriesSonificationPointGroupingAlgorithm Algorithm { get; set; }
		private ApoSeriesSonificationPointGroupingAlgorithm Algorithm_DefaultValue { get; set; }
