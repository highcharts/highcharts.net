...
{
	public partial class ApoSeriesStatesHover  : BaseObject
	{
		Hashtable h = new Hashtable();

		public ApoSeriesStatesHover()
		{
			Animation = Animation_DefaultValue = new Animation() { Enabled = true };
			Enabled = Enabled_DefaultValue = null;
			Halo = Halo_DefaultValue = new ApoSeriesStatesHoverHalo();
			LineWidth = LineWidth_DefaultValue = null;
			LineWidthPlus = LineWidthPlus_DefaultValue = null;
			Marker = Marker_DefaultValue = new ApoSeriesStatesHoverMarker();
		...
		/// </summary>
		public ApoSeriesStatesHoverHalo Halo { get; set; }
		private ApoSeriesStatesHoverHalo Halo_DefaultValue { get; set; }
		...
		/// </summary>
		public ApoSeriesStatesHoverMarker Marker { get; set; }
		private ApoSeriesStatesHoverMarker Marker_DefaultValue { get; set; }
