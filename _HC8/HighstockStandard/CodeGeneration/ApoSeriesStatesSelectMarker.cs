...
{
	public partial class ApoSeriesStatesSelectMarker  : BaseObject
	{
		Hashtable h = new Hashtable();

		public ApoSeriesStatesSelectMarker()
		{
			...
			States = States_DefaultValue = new ApoSeriesStatesSelectMarkerStates();
		...
		/// </summary>
		public ApoSeriesStatesSelectMarkerStates States { get; set; }
		private ApoSeriesStatesSelectMarkerStates States_DefaultValue { get; set; }
