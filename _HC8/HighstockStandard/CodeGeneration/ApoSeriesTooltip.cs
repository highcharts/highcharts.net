...
{
	public partial class ApoSeriesTooltip  : BaseObject
	{
		Hashtable h = new Hashtable();

		public ApoSeriesTooltip()
		{
			...
			HeaderShape = HeaderShape_DefaultValue = ApoSeriesTooltipHeaderShape.Callout;
		...
		/// </summary>
		public ApoSeriesTooltipHeaderShape HeaderShape { get; set; }
		private ApoSeriesTooltipHeaderShape HeaderShape_DefaultValue { get; set; }
		...
		internal override Hashtable ToHashtable()
		{
			...
			if (NullFormatter != NullFormatter_DefaultValue) { h.Add("nullFormatter",NullFormatter); Highstock.AddFunction("ApoSeriesTooltipNullFormatter.nullFormatter", NullFormatter); }  
			if (Outside != Outside_DefaultValue) h.Add("outside",Outside);
			if (Padding != Padding_DefaultValue) h.Add("padding",Padding);
			if (PointFormat != PointFormat_DefaultValue) h.Add("pointFormat",PointFormat);
			if (PointFormatter != PointFormatter_DefaultValue) { h.Add("pointFormatter",PointFormatter); Highstock.AddFunction("ApoSeriesTooltipPointFormatter.pointFormatter", PointFormatter); }  
