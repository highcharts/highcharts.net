...
namespace Highsoft.Web.Mvc.Stocks
{
	public partial class AreaSeries  : Series
	{
		...
		public AreaSeries()
		{
			...
			DashStyle = DashStyle_DefaultValue = AreaSeriesDashStyle.Solid;
			...
			Type = Type_DefaultValue = AreaSeriesType.Area;
		...
		internal override Hashtable ToHashtable()
		{
			...
			if (PointDescriptionFormatter != PointDescriptionFormatter_DefaultValue) { h.Add("pointDescriptionFormatter",PointDescriptionFormatter); Highstock.AddFunction("AreaSeriesPointDescriptionFormatter.pointDescriptionFormatter", PointDescriptionFormatter); }  
