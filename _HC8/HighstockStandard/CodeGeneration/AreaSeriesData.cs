...
namespace Highsoft.Web.Mvc.Stocks
{
	public partial class AreaSeriesData  : BaseObject
	{
		...
		{
			Accessibility = Accessibility_DefaultValue = new AreaSeriesDataAccessibility();
			...
			DragDrop = DragDrop_DefaultValue = new AreaSeriesDataDragDrop();
		...
		/// </summary>
		public AreaSeriesDataAccessibility Accessibility { get; set; }
		private AreaSeriesDataAccessibility Accessibility_DefaultValue { get; set; }
		...
		/// </summary>
		public AreaSeriesDataDragDrop DragDrop { get; set; }
		private AreaSeriesDataDragDrop DragDrop_DefaultValue { get; set; }
