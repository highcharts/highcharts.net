...
{
	public partial class AreaSeriesLastPriceLabel  : BaseObject
	{
		Hashtable h = new Hashtable();

		public AreaSeriesLastPriceLabel()
		{
			Align = Align_DefaultValue = AreaSeriesLastPriceLabelAlign.Null;
		...
		/// 
		/// </summary>
		public AreaSeriesLastPriceLabelAlign Align { get; set; }
		private AreaSeriesLastPriceLabelAlign Align_DefaultValue { get; set; }
