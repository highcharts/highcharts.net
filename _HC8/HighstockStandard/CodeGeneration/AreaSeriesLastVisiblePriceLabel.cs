...
{
	public partial class AreaSeriesLastVisiblePriceLabel  : BaseObject
	{
		Hashtable h = new Hashtable();

		public AreaSeriesLastVisiblePriceLabel()
		{
			Align = Align_DefaultValue = AreaSeriesLastVisiblePriceLabelAlign.Null;
		...
		/// 
		/// </summary>
		public AreaSeriesLastVisiblePriceLabelAlign Align { get; set; }
		private AreaSeriesLastVisiblePriceLabelAlign Align_DefaultValue { get; set; }
