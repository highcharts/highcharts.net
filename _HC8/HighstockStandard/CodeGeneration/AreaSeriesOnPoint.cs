...
{
	public partial class AreaSeriesOnPoint  : BaseObject
	{
		Hashtable h = new Hashtable();

		public AreaSeriesOnPoint()
		{
			ConnectorOptions = ConnectorOptions_DefaultValue = new AreaSeriesOnPointConnectorOptions();
			Id = Id_DefaultValue = "";
			Position = Position_DefaultValue = new AreaSeriesOnPointPosition();
		...
		/// </summary>
		public AreaSeriesOnPointConnectorOptions ConnectorOptions { get; set; }
		private AreaSeriesOnPointConnectorOptions ConnectorOptions_DefaultValue { get; set; }
		...
		/// </summary>
		public AreaSeriesOnPointPosition Position { get; set; }
		private AreaSeriesOnPointPosition Position_DefaultValue { get; set; }
