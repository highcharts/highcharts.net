...
{
	public partial class AreaSeriesStatesSelect  : BaseObject
	{
		Hashtable h = new Hashtable();

		public AreaSeriesStatesSelect()
		{
			Animation = Animation_DefaultValue = new Animation() { Enabled = true };
			Enabled = Enabled_DefaultValue = null;
			Halo = Halo_DefaultValue = new AreaSeriesStatesSelectHalo();
			LineWidth = LineWidth_DefaultValue = null;
			LineWidthPlus = LineWidthPlus_DefaultValue = null;
			Marker = Marker_DefaultValue = new AreaSeriesStatesSelectMarker();
		...
		/// </summary>
		public AreaSeriesStatesSelectHalo Halo { get; set; }
		private AreaSeriesStatesSelectHalo Halo_DefaultValue { get; set; }
		...
		/// </summary>
		public AreaSeriesStatesSelectMarker Marker { get; set; }
		private AreaSeriesStatesSelectMarker Marker_DefaultValue { get; set; }
