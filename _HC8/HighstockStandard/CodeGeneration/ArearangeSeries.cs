...
namespace Highsoft.Web.Mvc.Stocks
{
	public partial class ArearangeSeries  : Series
	{
		...
		public ArearangeSeries()
		{
			...
			Type = Type_DefaultValue = ArearangeSeriesType.Arearange;
		...
		internal override Hashtable ToHashtable()
		{
			...
			if (PointDescriptionFormatter != PointDescriptionFormatter_DefaultValue) { h.Add("pointDescriptionFormatter",PointDescriptionFormatter); Highstock.AddFunction("ArearangeSeriesPointDescriptionFormatter.pointDescriptionFormatter", PointDescriptionFormatter); }  
