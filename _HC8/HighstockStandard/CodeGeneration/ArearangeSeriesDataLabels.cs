...
namespace Highsoft.Web.Mvc.Stocks
{
	public partial class ArearangeSeriesDataLabels  : BaseObject
	{
		...
		internal override Hashtable ToHashtable()
		{
			...
			if (NullFormatter != NullFormatter_DefaultValue) { h.Add("nullFormatter",NullFormatter); Highstock.AddFunction("ArearangeSeriesDataLabelsNullFormatter.nullFormatter", NullFormatter); }  
