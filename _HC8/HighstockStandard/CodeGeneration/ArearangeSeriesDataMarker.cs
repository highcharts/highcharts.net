...
{
	public partial class ArearangeSeriesDataMarker  : BaseObject
	{
		Hashtable h = new Hashtable();

		public ArearangeSeriesDataMarker()
		{
			...
			States = States_DefaultValue = new ArearangeSeriesDataMarkerStates();
		...
		/// </summary>
		public ArearangeSeriesDataMarkerStates States { get; set; }
		private ArearangeSeriesDataMarkerStates States_DefaultValue { get; set; }
