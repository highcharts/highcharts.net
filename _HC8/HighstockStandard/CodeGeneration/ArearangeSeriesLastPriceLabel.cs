...
{
	public partial class ArearangeSeriesLastPriceLabel  : BaseObject
	{
		Hashtable h = new Hashtable();

		public ArearangeSeriesLastPriceLabel()
		{
			Align = Align_DefaultValue = ArearangeSeriesLastPriceLabelAlign.Null;
		...
		/// 
		/// </summary>
		public ArearangeSeriesLastPriceLabelAlign Align { get; set; }
		private ArearangeSeriesLastPriceLabelAlign Align_DefaultValue { get; set; }
