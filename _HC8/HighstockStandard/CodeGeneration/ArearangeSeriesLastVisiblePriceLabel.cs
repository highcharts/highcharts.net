...
{
	public partial class ArearangeSeriesLastVisiblePriceLabel  : BaseObject
	{
		Hashtable h = new Hashtable();

		public ArearangeSeriesLastVisiblePriceLabel()
		{
			Align = Align_DefaultValue = ArearangeSeriesLastVisiblePriceLabelAlign.Null;
		...
		/// 
		/// </summary>
		public ArearangeSeriesLastVisiblePriceLabelAlign Align { get; set; }
		private ArearangeSeriesLastVisiblePriceLabelAlign Align_DefaultValue { get; set; }
