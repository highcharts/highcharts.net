...
{
	public partial class ArearangeSeriesOnPoint  : BaseObject
	{
		Hashtable h = new Hashtable();

		public ArearangeSeriesOnPoint()
		{
			ConnectorOptions = ConnectorOptions_DefaultValue = new ArearangeSeriesOnPointConnectorOptions();
			Id = Id_DefaultValue = "";
			Position = Position_DefaultValue = new ArearangeSeriesOnPointPosition();
		...
		/// </summary>
		public ArearangeSeriesOnPointConnectorOptions ConnectorOptions { get; set; }
		private ArearangeSeriesOnPointConnectorOptions ConnectorOptions_DefaultValue { get; set; }
		...
		/// </summary>
		public ArearangeSeriesOnPointPosition Position { get; set; }
		private ArearangeSeriesOnPointPosition Position_DefaultValue { get; set; }
