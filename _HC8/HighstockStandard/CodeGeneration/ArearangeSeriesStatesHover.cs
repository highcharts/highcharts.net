...
{
	public partial class ArearangeSeriesStatesHover  : BaseObject
	{
		...
		public ArearangeSeriesStatesHover()
		{
			...
			Halo = Halo_DefaultValue = new ArearangeSeriesStatesHoverHalo();
			LineWidth = LineWidth_DefaultValue = null;
			LineWidthPlus = LineWidthPlus_DefaultValue = 1;
			Marker = Marker_DefaultValue = new ArearangeSeriesStatesHoverMarker();
		...
		/// </summary>
		public ArearangeSeriesStatesHoverMarker Marker { get; set; }
		private ArearangeSeriesStatesHoverMarker Marker_DefaultValue { get; set; }
