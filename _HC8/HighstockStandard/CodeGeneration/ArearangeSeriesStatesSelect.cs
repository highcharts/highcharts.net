...
{
	public partial class ArearangeSeriesStatesSelect  : BaseObject
	{
		...
		/// </summary>
		public ArearangeSeriesStatesSelectHalo Halo { get; set; }
		private ArearangeSeriesStatesSelectHalo Halo_DefaultValue { get; set; }
		...
		/// </summary>
		public ArearangeSeriesStatesSelectMarker Marker { get; set; }
		private ArearangeSeriesStatesSelectMarker Marker_DefaultValue { get; set; }
