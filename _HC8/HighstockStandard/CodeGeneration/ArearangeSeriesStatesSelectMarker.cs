...
{
	public partial class ArearangeSeriesStatesSelectMarker  : BaseObject
	{
		Hashtable h = new Hashtable();

		public ArearangeSeriesStatesSelectMarker()
		{
			...
			States = States_DefaultValue = new ArearangeSeriesStatesSelectMarkerStates();
		...
		/// </summary>
		public ArearangeSeriesStatesSelectMarkerStates States { get; set; }
		private ArearangeSeriesStatesSelectMarkerStates States_DefaultValue { get; set; }
