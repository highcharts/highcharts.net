...
namespace Highsoft.Web.Mvc.Stocks
{
	public partial class AreasplineSeriesAccessibility  : BaseObject
	{
		...
		public AreasplineSeriesAccessibility()
		{
			...
			Point = Point_DefaultValue = new AreasplineSeriesAccessibilityPoint();
		...
		/// </summary>
		public AreasplineSeriesAccessibilityPoint Point { get; set; }
		private AreasplineSeriesAccessibilityPoint Point_DefaultValue { get; set; }
