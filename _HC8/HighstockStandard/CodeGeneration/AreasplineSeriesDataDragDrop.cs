...
{
	public partial class AreasplineSeriesDataDragDrop  : BaseObject
	{
		Hashtable h = new Hashtable();

		public AreasplineSeriesDataDragDrop()
		{
			DraggableX = DraggableX_DefaultValue = null;
			DraggableY = DraggableY_DefaultValue = null;
			DragHandle = DragHandle_DefaultValue = new AreasplineSeriesDataDragDropDragHandle();
			...
			GuideBox = GuideBox_DefaultValue = new AreasplineSeriesDataDragDropGuideBox();
		...
		/// </summary>
		public AreasplineSeriesDataDragDropDragHandle DragHandle { get; set; }
		private AreasplineSeriesDataDragDropDragHandle DragHandle_DefaultValue { get; set; }
		...
		/// </summary>
		public AreasplineSeriesDataDragDropGuideBox GuideBox { get; set; }
		private AreasplineSeriesDataDragDropGuideBox GuideBox_DefaultValue { get; set; }
