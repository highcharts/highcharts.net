...
{
	public partial class AreasplineSeriesLastVisiblePriceLabel  : BaseObject
	{
		Hashtable h = new Hashtable();

		public AreasplineSeriesLastVisiblePriceLabel()
		{
			Align = Align_DefaultValue = AreasplineSeriesLastVisiblePriceLabelAlign.Null;
		...
		/// 
		/// </summary>
		public AreasplineSeriesLastVisiblePriceLabelAlign Align { get; set; }
		private AreasplineSeriesLastVisiblePriceLabelAlign Align_DefaultValue { get; set; }
