...
namespace Highsoft.Web.Mvc.Stocks
{
	public partial class AreasplineSeriesSonificationContextTracks  : BaseObject
	{
		...
		{
			ActiveWhen = ActiveWhen_DefaultValue = new AreasplineSeriesSonificationContextTracksActiveWhen();
			Instrument = Instrument_DefaultValue = null;
			InstrumentString = InstrumentString_DefaultValue = "null";
			Mapping = Mapping_DefaultValue = new AreasplineSeriesSonificationContextTracksMapping();
			MidiName = MidiName_DefaultValue = "";
			PointGrouping = PointGrouping_DefaultValue = new AreasplineSeriesSonificationContextTracksPointGrouping();
