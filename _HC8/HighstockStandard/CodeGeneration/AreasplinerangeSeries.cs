...
namespace Highsoft.Web.Mvc.Stocks
{
	public partial class AreasplinerangeSeries  : Series
	{
		...
		public AreasplinerangeSeries()
		{
			...
			Type = Type_DefaultValue = AreasplinerangeSeriesType.Null;
		...
		/// </summary>
		public AreasplinerangeSeriesType Type { get; set; }
		private AreasplinerangeSeriesType Type_DefaultValue { get; set; }
		...
		internal override Hashtable ToHashtable()
		{
			...
			if (PointDescriptionFormatter != PointDescriptionFormatter_DefaultValue) { h.Add("pointDescriptionFormatter",PointDescriptionFormatter); Highstock.AddFunction("AreasplinerangeSeriesPointDescriptionFormatter.pointDescriptionFormatter", PointDescriptionFormatter); }  
