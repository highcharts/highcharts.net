...
namespace Highsoft.Web.Mvc.Stocks
{
	public partial class AreasplinerangeSeries  : Series
	{
		...
		public AreasplinerangeSeries()
		{
			...
			BoostBlending = BoostBlending_DefaultValue = AreasplinerangeSeriesBoostBlending.Undefined;
			...
			Compare = Compare_DefaultValue = AreasplinerangeSeriesCompare.Null;
		...
		/// </summary>
		public AreasplinerangeSeriesBoostBlending BoostBlending { get; set; }
		private AreasplinerangeSeriesBoostBlending BoostBlending_DefaultValue { get; set; }
		...
		/// </summary>
		public AreasplinerangeSeriesStacking Stacking { get; set; }
		private AreasplinerangeSeriesStacking Stacking_DefaultValue { get; set; }
