...
{
	public partial class AreasplinerangeSeriesDataDragDrop  : BaseObject
	{
		Hashtable h = new Hashtable();

		public AreasplinerangeSeriesDataDragDrop()
		{
			DraggableX = DraggableX_DefaultValue = null;
			DraggableY = DraggableY_DefaultValue = null;
			DragHandle = DragHandle_DefaultValue = new AreasplinerangeSeriesDataDragDropDragHandle();
			...
			GuideBox = GuideBox_DefaultValue = new AreasplinerangeSeriesDataDragDropGuideBox();
		...
		/// </summary>
		public AreasplinerangeSeriesDataDragDropDragHandle DragHandle { get; set; }
		private AreasplinerangeSeriesDataDragDropDragHandle DragHandle_DefaultValue { get; set; }
		...
		/// </summary>
		public AreasplinerangeSeriesDataDragDropGuideBox GuideBox { get; set; }
		private AreasplinerangeSeriesDataDragDropGuideBox GuideBox_DefaultValue { get; set; }
