...
namespace Highsoft.Web.Mvc.Stocks
{
	public partial class AreasplinerangeSeriesDataLabels  : BaseObject
	{
		...
		public AreasplinerangeSeriesDataLabels()
		{
			...
			Filter = Filter_DefaultValue = new AreasplinerangeSeriesDataLabelsFilter();
			...
			Overflow = Overflow_DefaultValue = AreasplinerangeSeriesDataLabelsOverflow.Justify;
			Padding = Padding_DefaultValue = 5;
			Position = Position_DefaultValue = AreasplinerangeSeriesDataLabelsPosition.Center;
			...
			TextPath = TextPath_DefaultValue = new AreasplinerangeSeriesDataLabelsTextPath();
