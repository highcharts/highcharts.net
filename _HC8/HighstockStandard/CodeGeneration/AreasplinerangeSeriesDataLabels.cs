...
namespace Highsoft.Web.Mvc.Stocks
{
	public partial class AreasplinerangeSeriesDataLabels  : BaseObject
	{
		...
		internal override Hashtable ToHashtable()
		{
			...
			if (NullFormatter != NullFormatter_DefaultValue) { h.Add("nullFormatter",NullFormatter); Highstock.AddFunction("AreasplinerangeSeriesDataLabelsNullFormatter.nullFormatter", NullFormatter); }  
