...
{
	public partial class AreasplinerangeSeriesLastPriceLabel  : BaseObject
	{
		Hashtable h = new Hashtable();

		public AreasplinerangeSeriesLastPriceLabel()
		{
			Align = Align_DefaultValue = AreasplinerangeSeriesLastPriceLabelAlign.Null;
		...
		/// 
		/// </summary>
		public AreasplinerangeSeriesLastPriceLabelAlign Align { get; set; }
		private AreasplinerangeSeriesLastPriceLabelAlign Align_DefaultValue { get; set; }
