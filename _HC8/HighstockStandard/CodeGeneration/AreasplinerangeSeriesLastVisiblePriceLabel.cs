...
{
	public partial class AreasplinerangeSeriesLastVisiblePriceLabel  : BaseObject
	{
		Hashtable h = new Hashtable();

		public AreasplinerangeSeriesLastVisiblePriceLabel()
		{
			Align = Align_DefaultValue = AreasplinerangeSeriesLastVisiblePriceLabelAlign.Null;
		...
		/// 
		/// </summary>
		public AreasplinerangeSeriesLastVisiblePriceLabelAlign Align { get; set; }
		private AreasplinerangeSeriesLastVisiblePriceLabelAlign Align_DefaultValue { get; set; }
