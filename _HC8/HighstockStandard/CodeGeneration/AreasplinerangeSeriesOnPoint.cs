...
{
	public partial class AreasplinerangeSeriesOnPoint  : BaseObject
	{
		Hashtable h = new Hashtable();

		public AreasplinerangeSeriesOnPoint()
		{
			ConnectorOptions = ConnectorOptions_DefaultValue = new AreasplinerangeSeriesOnPointConnectorOptions();
			Id = Id_DefaultValue = "";
			Position = Position_DefaultValue = new AreasplinerangeSeriesOnPointPosition();
		...
		/// </summary>
		public AreasplinerangeSeriesOnPointConnectorOptions ConnectorOptions { get; set; }
		private AreasplinerangeSeriesOnPointConnectorOptions ConnectorOptions_DefaultValue { get; set; }
		...
		/// </summary>
		public AreasplinerangeSeriesOnPointPosition Position { get; set; }
		private AreasplinerangeSeriesOnPointPosition Position_DefaultValue { get; set; }
