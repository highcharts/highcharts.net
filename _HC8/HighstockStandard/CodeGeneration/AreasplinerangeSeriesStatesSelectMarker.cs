...
{
	public partial class AreasplinerangeSeriesStatesSelectMarker  : BaseObject
	{
		Hashtable h = new Hashtable();

		public AreasplinerangeSeriesStatesSelectMarker()
		{
			...
			States = States_DefaultValue = new AreasplinerangeSeriesStatesSelectMarkerStates();
		...
		/// </summary>
		public AreasplinerangeSeriesStatesSelectMarkerStates States { get; set; }
		private AreasplinerangeSeriesStatesSelectMarkerStates States_DefaultValue { get; set; }
