...
namespace Highsoft.Web.Mvc.Stocks
{
	public partial class AroonSeries  : Series
	{
		...
		public AroonSeries()
		{
			...
			Type = Type_DefaultValue = AroonSeriesType.Null;
		...
		/// </summary>
		public AroonSeriesType Type { get; set; }
		private AroonSeriesType Type_DefaultValue { get; set; }
		...
		internal override Hashtable ToHashtable()
		{
			...
			if (PointDescriptionFormatter != PointDescriptionFormatter_DefaultValue) { h.Add("pointDescriptionFormatter",PointDescriptionFormatter); Highstock.AddFunction("AroonSeriesPointDescriptionFormatter.pointDescriptionFormatter", PointDescriptionFormatter); }  
