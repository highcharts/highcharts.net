...
{
	public partial class AroonSeriesDataLabels  : BaseObject
	{
		Hashtable h = new Hashtable();

		public AroonSeriesDataLabels()
		{
			Align = Align_DefaultValue = AroonSeriesDataLabelsAlign.Center;
			...
			Filter = Filter_DefaultValue = new AroonSeriesDataLabelsFilter();
			...
			Overflow = Overflow_DefaultValue = AroonSeriesDataLabelsOverflow.Justify;
			Padding = Padding_DefaultValue = 5;
			Position = Position_DefaultValue = AroonSeriesDataLabelsPosition.Center;
			...
			TextPath = TextPath_DefaultValue = new AroonSeriesDataLabelsTextPath();
			UseHTML = UseHTML_DefaultValue = false;
			VerticalAlign = VerticalAlign_DefaultValue = AroonSeriesDataLabelsVerticalAlign.Bottom;
			X = X_DefaultValue = 0;
			Y = Y_DefaultValue = 0;
			Z = Z_DefaultValue = 6;
		...
		/// </summary>
		public AroonSeriesDataLabelsAlign Align { get; set; }
		private AroonSeriesDataLabelsAlign Align_DefaultValue { get; set; }
		...
		/// </summary>
		public AroonSeriesDataLabelsFilter Filter { get; set; }
		private AroonSeriesDataLabelsFilter Filter_DefaultValue { get; set; }
		...
		/// </summary>
		public AroonSeriesDataLabelsOverflow Overflow { get; set; }
		private AroonSeriesDataLabelsOverflow Overflow_DefaultValue { get; set; }
		...
		/// </summary>
		public AroonSeriesDataLabelsPosition Position { get; set; }
		private AroonSeriesDataLabelsPosition Position_DefaultValue { get; set; }
		...
		/// </summary>
		public AroonSeriesDataLabelsTextPath TextPath { get; set; }
		private AroonSeriesDataLabelsTextPath TextPath_DefaultValue { get; set; }
		...
		/// </summary>
		public AroonSeriesDataLabelsVerticalAlign VerticalAlign { get; set; }
		private AroonSeriesDataLabelsVerticalAlign VerticalAlign_DefaultValue { get; set; }
