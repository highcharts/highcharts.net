...
{
	public partial class AroonSeriesLastPriceLabel  : BaseObject
	{
		Hashtable h = new Hashtable();

		public AroonSeriesLastPriceLabel()
		{
			Align = Align_DefaultValue = AroonSeriesLastPriceLabelAlign.Null;
		...
		/// 
		/// </summary>
		public AroonSeriesLastPriceLabelAlign Align { get; set; }
		private AroonSeriesLastPriceLabelAlign Align_DefaultValue { get; set; }
