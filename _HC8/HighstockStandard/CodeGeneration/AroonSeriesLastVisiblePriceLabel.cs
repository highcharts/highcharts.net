...
{
	public partial class AroonSeriesLastVisiblePriceLabel  : BaseObject
	{
		Hashtable h = new Hashtable();

		public AroonSeriesLastVisiblePriceLabel()
		{
			Align = Align_DefaultValue = AroonSeriesLastVisiblePriceLabelAlign.Null;
		...
		/// 
		/// </summary>
		public AroonSeriesLastVisiblePriceLabelAlign Align { get; set; }
		private AroonSeriesLastVisiblePriceLabelAlign Align_DefaultValue { get; set; }
