...
{
	public partial class AroonSeriesMarker  : BaseObject
	{
		Hashtable h = new Hashtable();

		public AroonSeriesMarker()
		{
			...
			States = States_DefaultValue = new AroonSeriesMarkerStates();
		...
		/// </summary>
		public AroonSeriesMarkerStates States { get; set; }
		private AroonSeriesMarkerStates States_DefaultValue { get; set; }
