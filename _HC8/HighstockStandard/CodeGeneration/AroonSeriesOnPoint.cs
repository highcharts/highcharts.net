...
{
	public partial class AroonSeriesOnPoint  : BaseObject
	{
		Hashtable h = new Hashtable();

		public AroonSeriesOnPoint()
		{
			ConnectorOptions = ConnectorOptions_DefaultValue = new AroonSeriesOnPointConnectorOptions();
			Id = Id_DefaultValue = "";
			Position = Position_DefaultValue = new AroonSeriesOnPointPosition();
		...
		/// </summary>
		public AroonSeriesOnPointConnectorOptions ConnectorOptions { get; set; }
		private AroonSeriesOnPointConnectorOptions ConnectorOptions_DefaultValue { get; set; }
		...
		/// </summary>
		public AroonSeriesOnPointPosition Position { get; set; }
		private AroonSeriesOnPointPosition Position_DefaultValue { get; set; }
