...
{
	public partial class AroonSeriesStatesHoverMarker  : BaseObject
	{
		Hashtable h = new Hashtable();

		public AroonSeriesStatesHoverMarker()
		{
			...
			States = States_DefaultValue = new AroonSeriesStatesHoverMarkerStates();
		...
		/// </summary>
		public AroonSeriesStatesHoverMarkerStates States { get; set; }
		private AroonSeriesStatesHoverMarkerStates States_DefaultValue { get; set; }
