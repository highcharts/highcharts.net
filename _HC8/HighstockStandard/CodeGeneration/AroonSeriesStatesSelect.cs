...
{
	public partial class AroonSeriesStatesSelect  : BaseObject
	{
		Hashtable h = new Hashtable();

		public AroonSeriesStatesSelect()
		{
			Animation = Animation_DefaultValue = new Animation() { Enabled = true };
			Enabled = Enabled_DefaultValue = true;
			Halo = Halo_DefaultValue = new AroonSeriesStatesSelectHalo();
			LineWidth = LineWidth_DefaultValue = null;
			LineWidthPlus = LineWidthPlus_DefaultValue = 1;
			Marker = Marker_DefaultValue = new AroonSeriesStatesSelectMarker();
		...
		/// </summary>
		public AroonSeriesStatesSelectHalo Halo { get; set; }
		private AroonSeriesStatesSelectHalo Halo_DefaultValue { get; set; }
		...
		/// </summary>
		public AroonSeriesStatesSelectMarker Marker { get; set; }
		private AroonSeriesStatesSelectMarker Marker_DefaultValue { get; set; }
