...
{
	public partial class AroonSeriesStatesSelectMarker  : BaseObject
	{
		Hashtable h = new Hashtable();

		public AroonSeriesStatesSelectMarker()
		{
			...
			States = States_DefaultValue = new AroonSeriesStatesSelectMarkerStates();
		...
		/// </summary>
		public AroonSeriesStatesSelectMarkerStates States { get; set; }
		private AroonSeriesStatesSelectMarkerStates States_DefaultValue { get; set; }
