...
namespace Highsoft.Web.Mvc.Stocks
{
	public partial class AroonoscillatorSeries  : Series
	{
		...
		public AroonoscillatorSeries()
		{
			...
			DashStyle = DashStyle_DefaultValue = AroonoscillatorSeriesDashStyle.Solid;
			...
			Type = Type_DefaultValue = AroonoscillatorSeriesType.Aroonoscillator;
		...
		/// </summary>
		public AroonoscillatorSeriesType Type { get; set; }
		private AroonoscillatorSeriesType Type_DefaultValue { get; set; }
		...
		internal override Hashtable ToHashtable()
		{
			...
			if (PointDescriptionFormatter != PointDescriptionFormatter_DefaultValue) { h.Add("pointDescriptionFormatter",PointDescriptionFormatter); Highstock.AddFunction("AroonoscillatorSeriesPointDescriptionFormatter.pointDescriptionFormatter", PointDescriptionFormatter); }  
