...
{
	public partial class AroonoscillatorSeriesDataLabels  : BaseObject
	{
		Hashtable h = new Hashtable();

		public AroonoscillatorSeriesDataLabels()
		{
			Align = Align_DefaultValue = AroonoscillatorSeriesDataLabelsAlign.Center;
			...
			Filter = Filter_DefaultValue = new AroonoscillatorSeriesDataLabelsFilter();
			...
			Overflow = Overflow_DefaultValue = AroonoscillatorSeriesDataLabelsOverflow.Justify;
			Padding = Padding_DefaultValue = 5;
			Position = Position_DefaultValue = AroonoscillatorSeriesDataLabelsPosition.Center;
			...
			TextPath = TextPath_DefaultValue = new AroonoscillatorSeriesDataLabelsTextPath();
			UseHTML = UseHTML_DefaultValue = false;
			VerticalAlign = VerticalAlign_DefaultValue = AroonoscillatorSeriesDataLabelsVerticalAlign.Bottom;
			X = X_DefaultValue = 0;
			Y = Y_DefaultValue = 0;
			Z = Z_DefaultValue = 6;
		...
		/// </summary>
		public AroonoscillatorSeriesDataLabelsAlign Align { get; set; }
		private AroonoscillatorSeriesDataLabelsAlign Align_DefaultValue { get; set; }
		...
		/// </summary>
		public AroonoscillatorSeriesDataLabelsFilter Filter { get; set; }
		private AroonoscillatorSeriesDataLabelsFilter Filter_DefaultValue { get; set; }
		...
		/// </summary>
		public AroonoscillatorSeriesDataLabelsOverflow Overflow { get; set; }
		private AroonoscillatorSeriesDataLabelsOverflow Overflow_DefaultValue { get; set; }
		...
		/// </summary>
		public AroonoscillatorSeriesDataLabelsPosition Position { get; set; }
		private AroonoscillatorSeriesDataLabelsPosition Position_DefaultValue { get; set; }
		...
		/// </summary>
		public AroonoscillatorSeriesDataLabelsTextPath TextPath { get; set; }
		private AroonoscillatorSeriesDataLabelsTextPath TextPath_DefaultValue { get; set; }
		...
		/// </summary>
		public AroonoscillatorSeriesDataLabelsVerticalAlign VerticalAlign { get; set; }
		private AroonoscillatorSeriesDataLabelsVerticalAlign VerticalAlign_DefaultValue { get; set; }
