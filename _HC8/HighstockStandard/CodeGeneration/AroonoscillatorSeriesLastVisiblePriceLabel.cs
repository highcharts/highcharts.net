...
{
	public partial class AroonoscillatorSeriesLastVisiblePriceLabel  : BaseObject
	{
		Hashtable h = new Hashtable();

		public AroonoscillatorSeriesLastVisiblePriceLabel()
		{
			Align = Align_DefaultValue = AroonoscillatorSeriesLastVisiblePriceLabelAlign.Null;
		...
		/// 
		/// </summary>
		public AroonoscillatorSeriesLastVisiblePriceLabelAlign Align { get; set; }
		private AroonoscillatorSeriesLastVisiblePriceLabelAlign Align_DefaultValue { get; set; }
