...
{
	public partial class AroonoscillatorSeriesOnPoint  : BaseObject
	{
		Hashtable h = new Hashtable();

		public AroonoscillatorSeriesOnPoint()
		{
			ConnectorOptions = ConnectorOptions_DefaultValue = new AroonoscillatorSeriesOnPointConnectorOptions();
			Id = Id_DefaultValue = "";
			Position = Position_DefaultValue = new AroonoscillatorSeriesOnPointPosition();
		...
		/// </summary>
		public AroonoscillatorSeriesOnPointConnectorOptions ConnectorOptions { get; set; }
		private AroonoscillatorSeriesOnPointConnectorOptions ConnectorOptions_DefaultValue { get; set; }
		...
		/// </summary>
		public AroonoscillatorSeriesOnPointPosition Position { get; set; }
		private AroonoscillatorSeriesOnPointPosition Position_DefaultValue { get; set; }
