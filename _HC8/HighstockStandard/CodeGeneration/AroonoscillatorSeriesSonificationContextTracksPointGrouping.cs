...
{
	public partial class AroonoscillatorSeriesSonificationContextTracksPointGrouping  : BaseObject
	{
		Hashtable h = new Hashtable();

		public AroonoscillatorSeriesSonificationContextTracksPointGrouping()
		{
			Algorithm = Algorithm_DefaultValue = AroonoscillatorSeriesSonificationContextTracksPointGroupingAlgorithm.Minimax;
		...
		/// </summary>
		public AroonoscillatorSeriesSonificationContextTracksPointGroupingAlgorithm Algorithm { get; set; }
		private AroonoscillatorSeriesSonificationContextTracksPointGroupingAlgorithm Algorithm_DefaultValue { get; set; }
