...
{
	public partial class AroonoscillatorSeriesSonificationTracksPointGrouping  : BaseObject
	{
		Hashtable h = new Hashtable();

		public AroonoscillatorSeriesSonificationTracksPointGrouping()
		{
			Algorithm = Algorithm_DefaultValue = AroonoscillatorSeriesSonificationTracksPointGroupingAlgorithm.Minimax;
		...
		/// </summary>
		public AroonoscillatorSeriesSonificationTracksPointGroupingAlgorithm Algorithm { get; set; }
		private AroonoscillatorSeriesSonificationTracksPointGroupingAlgorithm Algorithm_DefaultValue { get; set; }
