...
{
	public partial class AroonoscillatorSeriesStatesHoverMarkerStatesHoverAnimation  : BaseObject
	{
		Hashtable h = new Hashtable();

		public AroonoscillatorSeriesStatesHoverMarkerStatesHoverAnimation()
		{
