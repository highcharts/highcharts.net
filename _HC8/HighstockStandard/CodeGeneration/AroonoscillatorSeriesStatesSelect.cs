...
{
	public partial class AroonoscillatorSeriesStatesSelect  : BaseObject
	{
		Hashtable h = new Hashtable();

		public AroonoscillatorSeriesStatesSelect()
		{
			Animation = Animation_DefaultValue = new Animation() { Enabled = true };
			Enabled = Enabled_DefaultValue = null;
			Halo = Halo_DefaultValue = new AroonoscillatorSeriesStatesSelectHalo();
			LineWidth = LineWidth_DefaultValue = null;
			LineWidthPlus = LineWidthPlus_DefaultValue = null;
			Marker = Marker_DefaultValue = new AroonoscillatorSeriesStatesSelectMarker();
		...
		/// </summary>
		public AroonoscillatorSeriesStatesSelectHalo Halo { get; set; }
		private AroonoscillatorSeriesStatesSelectHalo Halo_DefaultValue { get; set; }
		...
		/// </summary>
		public AroonoscillatorSeriesStatesSelectMarker Marker { get; set; }
		private AroonoscillatorSeriesStatesSelectMarker Marker_DefaultValue { get; set; }
