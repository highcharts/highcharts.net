...
{
	public partial class AroonoscillatorSeriesStatesSelectMarker  : BaseObject
	{
		Hashtable h = new Hashtable();

		public AroonoscillatorSeriesStatesSelectMarker()
		{
			...
			States = States_DefaultValue = new AroonoscillatorSeriesStatesSelectMarkerStates();
		...
		/// </summary>
		public AroonoscillatorSeriesStatesSelectMarkerStates States { get; set; }
		private AroonoscillatorSeriesStatesSelectMarkerStates States_DefaultValue { get; set; }
