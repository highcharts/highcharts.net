...
{
	public partial class AroonoscillatorSeriesStatesSelectMarkerStatesHoverAnimation  : BaseObject
	{
		Hashtable h = new Hashtable();

		public AroonoscillatorSeriesStatesSelectMarkerStatesHoverAnimation()
		{
