...
namespace Highsoft.Web.Mvc.Stocks
{
	public partial class AtrSeries  : Series
	{
		...
		public AtrSeries()
		{
			...
			DashStyle = DashStyle_DefaultValue = AtrSeriesDashStyle.Solid;
			...
			Type = Type_DefaultValue = AtrSeriesType.Atr;
		...
		/// </summary>
		public AtrSeriesType Type { get; set; }
		private AtrSeriesType Type_DefaultValue { get; set; }
		...
		internal override Hashtable ToHashtable()
		{
			...
			if (PointDescriptionFormatter != PointDescriptionFormatter_DefaultValue) { h.Add("pointDescriptionFormatter",PointDescriptionFormatter); Highstock.AddFunction("AtrSeriesPointDescriptionFormatter.pointDescriptionFormatter", PointDescriptionFormatter); }  
