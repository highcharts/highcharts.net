...
{
	public partial class AtrSeriesDataLabels  : BaseObject
	{
		Hashtable h = new Hashtable();

		public AtrSeriesDataLabels()
		{
			Align = Align_DefaultValue = AtrSeriesDataLabelsAlign.Center;
			...
			Filter = Filter_DefaultValue = new AtrSeriesDataLabelsFilter();
			...
			Overflow = Overflow_DefaultValue = AtrSeriesDataLabelsOverflow.Justify;
			Padding = Padding_DefaultValue = 5;
			Position = Position_DefaultValue = AtrSeriesDataLabelsPosition.Center;
			...
			TextPath = TextPath_DefaultValue = new AtrSeriesDataLabelsTextPath();
			UseHTML = UseHTML_DefaultValue = false;
			VerticalAlign = VerticalAlign_DefaultValue = AtrSeriesDataLabelsVerticalAlign.Bottom;
			X = X_DefaultValue = 0;
			Y = Y_DefaultValue = 0;
			Z = Z_DefaultValue = 6;
		...
		/// </summary>
		public AtrSeriesDataLabelsAlign Align { get; set; }
		private AtrSeriesDataLabelsAlign Align_DefaultValue { get; set; }
		...
		/// </summary>
		public AtrSeriesDataLabelsFilter Filter { get; set; }
		private AtrSeriesDataLabelsFilter Filter_DefaultValue { get; set; }
		...
		/// </summary>
		public AtrSeriesDataLabelsOverflow Overflow { get; set; }
		private AtrSeriesDataLabelsOverflow Overflow_DefaultValue { get; set; }
		...
		/// </summary>
		public AtrSeriesDataLabelsPosition Position { get; set; }
		private AtrSeriesDataLabelsPosition Position_DefaultValue { get; set; }
		...
		/// </summary>
		public AtrSeriesDataLabelsTextPath TextPath { get; set; }
		private AtrSeriesDataLabelsTextPath TextPath_DefaultValue { get; set; }
		...
		/// </summary>
		public AtrSeriesDataLabelsVerticalAlign VerticalAlign { get; set; }
		private AtrSeriesDataLabelsVerticalAlign VerticalAlign_DefaultValue { get; set; }
