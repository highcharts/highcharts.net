...
{
	public partial class AtrSeriesLastPriceLabel  : BaseObject
	{
		Hashtable h = new Hashtable();

		public AtrSeriesLastPriceLabel()
		{
			Align = Align_DefaultValue = AtrSeriesLastPriceLabelAlign.Null;
		...
		/// 
		/// </summary>
		public AtrSeriesLastPriceLabelAlign Align { get; set; }
		private AtrSeriesLastPriceLabelAlign Align_DefaultValue { get; set; }
