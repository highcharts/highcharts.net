...
{
	public partial class AtrSeriesLastVisiblePriceLabel  : BaseObject
	{
		Hashtable h = new Hashtable();

		public AtrSeriesLastVisiblePriceLabel()
		{
			Align = Align_DefaultValue = AtrSeriesLastVisiblePriceLabelAlign.Null;
		...
		/// 
		/// </summary>
		public AtrSeriesLastVisiblePriceLabelAlign Align { get; set; }
		private AtrSeriesLastVisiblePriceLabelAlign Align_DefaultValue { get; set; }
