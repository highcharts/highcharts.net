...
{
	public partial class AtrSeriesOnPoint  : BaseObject
	{
		Hashtable h = new Hashtable();

		public AtrSeriesOnPoint()
		{
			ConnectorOptions = ConnectorOptions_DefaultValue = new AtrSeriesOnPointConnectorOptions();
			Id = Id_DefaultValue = "";
			Position = Position_DefaultValue = new AtrSeriesOnPointPosition();
		...
		/// </summary>
		public AtrSeriesOnPointConnectorOptions ConnectorOptions { get; set; }
		private AtrSeriesOnPointConnectorOptions ConnectorOptions_DefaultValue { get; set; }
		...
		/// </summary>
		public AtrSeriesOnPointPosition Position { get; set; }
		private AtrSeriesOnPointPosition Position_DefaultValue { get; set; }
