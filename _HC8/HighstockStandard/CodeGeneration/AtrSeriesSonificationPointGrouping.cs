...
{
	public partial class AtrSeriesSonificationPointGrouping  : BaseObject
	{
		Hashtable h = new Hashtable();

		public AtrSeriesSonificationPointGrouping()
		{
			Algorithm = Algorithm_DefaultValue = AtrSeriesSonificationPointGroupingAlgorithm.Minimax;
		...
		/// </summary>
		public AtrSeriesSonificationPointGroupingAlgorithm Algorithm { get; set; }
		private AtrSeriesSonificationPointGroupingAlgorithm Algorithm_DefaultValue { get; set; }
