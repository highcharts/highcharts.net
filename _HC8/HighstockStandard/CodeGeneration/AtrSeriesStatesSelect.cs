...
{
	public partial class AtrSeriesStatesSelect  : BaseObject
	{
		Hashtable h = new Hashtable();

		public AtrSeriesStatesSelect()
		{
			Animation = Animation_DefaultValue = new Animation() { Enabled = true };
			Enabled = Enabled_DefaultValue = true;
			Halo = Halo_DefaultValue = new AtrSeriesStatesSelectHalo();
			LineWidth = LineWidth_DefaultValue = null;
			LineWidthPlus = LineWidthPlus_DefaultValue = 1;
			Marker = Marker_DefaultValue = new AtrSeriesStatesSelectMarker();
		...
		/// </summary>
		public AtrSeriesStatesSelectHalo Halo { get; set; }
		private AtrSeriesStatesSelectHalo Halo_DefaultValue { get; set; }
		...
		/// </summary>
		public AtrSeriesStatesSelectMarker Marker { get; set; }
		private AtrSeriesStatesSelectMarker Marker_DefaultValue { get; set; }
