...
namespace Highsoft.Web.Mvc.Stocks
{
	public partial class BbSeriesDataGrouping  : BaseObject
	{
		...
		internal override Hashtable ToHashtable()
		{
			...
			if (Approximation != Approximation_DefaultValue) { h.Add("approximation",Approximation); Highstock.AddFunction("BbSeriesDataGroupingApproximation.approximation", Approximation); }  
