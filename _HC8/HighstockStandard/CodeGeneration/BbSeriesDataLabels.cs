...
{
	public partial class BbSeriesDataLabels  : BaseObject
	{
		Hashtable h = new Hashtable();

		public BbSeriesDataLabels()
		{
			Align = Align_DefaultValue = BbSeriesDataLabelsAlign.Center;
			...
			Filter = Filter_DefaultValue = new BbSeriesDataLabelsFilter();
			...
			Overflow = Overflow_DefaultValue = BbSeriesDataLabelsOverflow.Justify;
			Padding = Padding_DefaultValue = 5;
			Position = Position_DefaultValue = BbSeriesDataLabelsPosition.Center;
			...
			TextPath = TextPath_DefaultValue = new BbSeriesDataLabelsTextPath();
			UseHTML = UseHTML_DefaultValue = false;
			VerticalAlign = VerticalAlign_DefaultValue = BbSeriesDataLabelsVerticalAlign.Bottom;
			X = X_DefaultValue = 0;
			Y = Y_DefaultValue = 0;
			Z = Z_DefaultValue = 6;
		...
		/// </summary>
		public BbSeriesDataLabelsAlign Align { get; set; }
		private BbSeriesDataLabelsAlign Align_DefaultValue { get; set; }
		...
		/// </summary>
		public BbSeriesDataLabelsFilter Filter { get; set; }
		private BbSeriesDataLabelsFilter Filter_DefaultValue { get; set; }
		...
		/// </summary>
		public BbSeriesDataLabelsOverflow Overflow { get; set; }
		private BbSeriesDataLabelsOverflow Overflow_DefaultValue { get; set; }
		...
		/// </summary>
		public BbSeriesDataLabelsPosition Position { get; set; }
		private BbSeriesDataLabelsPosition Position_DefaultValue { get; set; }
		...
		/// </summary>
		public BbSeriesDataLabelsTextPath TextPath { get; set; }
		private BbSeriesDataLabelsTextPath TextPath_DefaultValue { get; set; }
		...
		/// </summary>
		public BbSeriesDataLabelsVerticalAlign VerticalAlign { get; set; }
		private BbSeriesDataLabelsVerticalAlign VerticalAlign_DefaultValue { get; set; }
