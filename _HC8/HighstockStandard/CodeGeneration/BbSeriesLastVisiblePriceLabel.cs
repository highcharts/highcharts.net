...
{
	public partial class BbSeriesLastVisiblePriceLabel  : BaseObject
	{
		Hashtable h = new Hashtable();

		public BbSeriesLastVisiblePriceLabel()
		{
			Align = Align_DefaultValue = BbSeriesLastVisiblePriceLabelAlign.Null;
		...
		/// 
		/// </summary>
		public BbSeriesLastVisiblePriceLabelAlign Align { get; set; }
		private BbSeriesLastVisiblePriceLabelAlign Align_DefaultValue { get; set; }
