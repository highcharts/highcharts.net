...
{
	public partial class BbSeriesMarker  : BaseObject
	{
		Hashtable h = new Hashtable();

		public BbSeriesMarker()
		{
			...
			States = States_DefaultValue = new BbSeriesMarkerStates();
		...
		/// </summary>
		public BbSeriesMarkerStates States { get; set; }
		private BbSeriesMarkerStates States_DefaultValue { get; set; }
