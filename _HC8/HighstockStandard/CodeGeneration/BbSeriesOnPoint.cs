...
{
	public partial class BbSeriesOnPoint  : BaseObject
	{
		Hashtable h = new Hashtable();

		public BbSeriesOnPoint()
		{
			ConnectorOptions = ConnectorOptions_DefaultValue = new BbSeriesOnPointConnectorOptions();
			Id = Id_DefaultValue = "";
			Position = Position_DefaultValue = new BbSeriesOnPointPosition();
		...
		/// </summary>
		public BbSeriesOnPointConnectorOptions ConnectorOptions { get; set; }
		private BbSeriesOnPointConnectorOptions ConnectorOptions_DefaultValue { get; set; }
		...
		/// </summary>
		public BbSeriesOnPointPosition Position { get; set; }
		private BbSeriesOnPointPosition Position_DefaultValue { get; set; }
