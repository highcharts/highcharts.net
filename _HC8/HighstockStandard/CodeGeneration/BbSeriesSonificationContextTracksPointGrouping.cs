...
{
	public partial class BbSeriesSonificationContextTracksPointGrouping  : BaseObject
	{
		Hashtable h = new Hashtable();

		public BbSeriesSonificationContextTracksPointGrouping()
		{
			Algorithm = Algorithm_DefaultValue = BbSeriesSonificationContextTracksPointGroupingAlgorithm.Minimax;
		...
		/// </summary>
		public BbSeriesSonificationContextTracksPointGroupingAlgorithm Algorithm { get; set; }
		private BbSeriesSonificationContextTracksPointGroupingAlgorithm Algorithm_DefaultValue { get; set; }
