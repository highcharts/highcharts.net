...
{
	public partial class BbSeriesSonificationPointGrouping  : BaseObject
	{
		Hashtable h = new Hashtable();

		public BbSeriesSonificationPointGrouping()
		{
			Algorithm = Algorithm_DefaultValue = BbSeriesSonificationPointGroupingAlgorithm.Minimax;
		...
		/// </summary>
		public BbSeriesSonificationPointGroupingAlgorithm Algorithm { get; set; }
		private BbSeriesSonificationPointGroupingAlgorithm Algorithm_DefaultValue { get; set; }
