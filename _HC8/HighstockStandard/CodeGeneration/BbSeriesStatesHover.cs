...
{
	public partial class BbSeriesStatesHover  : BaseObject
	{
		Hashtable h = new Hashtable();

		public BbSeriesStatesHover()
		{
			Animation = Animation_DefaultValue = new Animation() { Enabled = true };
			AnimationBool = AnimationBool_DefaultValue = null;
			Enabled = Enabled_DefaultValue = true;
			Halo = Halo_DefaultValue = new BbSeriesStatesHoverHalo();
			LineWidth = LineWidth_DefaultValue = null;
			LineWidthPlus = LineWidthPlus_DefaultValue = 1;
			Marker = Marker_DefaultValue = new BbSeriesStatesHoverMarker();
		...
		/// </summary>
		public BbSeriesStatesHoverHalo Halo { get; set; }
		private BbSeriesStatesHoverHalo Halo_DefaultValue { get; set; }
		...
		/// </summary>
		public BbSeriesStatesHoverMarker Marker { get; set; }
		private BbSeriesStatesHoverMarker Marker_DefaultValue { get; set; }
