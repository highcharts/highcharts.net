...
{
	public partial class BbSeriesStatesSelect  : BaseObject
	{
		Hashtable h = new Hashtable();

		public BbSeriesStatesSelect()
		{
			Animation = Animation_DefaultValue = new Animation() { Enabled = true };
			Enabled = Enabled_DefaultValue = null;
			Halo = Halo_DefaultValue = new BbSeriesStatesSelectHalo();
			LineWidth = LineWidth_DefaultValue = null;
			LineWidthPlus = LineWidthPlus_DefaultValue = null;
			Marker = Marker_DefaultValue = new BbSeriesStatesSelectMarker();
		...
		/// </summary>
		public BbSeriesStatesSelectHalo Halo { get; set; }
		private BbSeriesStatesSelectHalo Halo_DefaultValue { get; set; }
		...
		/// </summary>
		public BbSeriesStatesSelectMarker Marker { get; set; }
		private BbSeriesStatesSelectMarker Marker_DefaultValue { get; set; }
