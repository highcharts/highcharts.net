...
{
	public partial class BubbleSeriesClusterEvents  : BaseObject
	{
		Hashtable h = new Hashtable();

		public BubbleSeriesClusterEvents()
		{
		...
		internal override Hashtable ToHashtable()
		{
			...
			if (DrillToCluster != DrillToCluster_DefaultValue) { h.Add("drillToCluster",DrillToCluster); Highstock.AddFunction("BubbleSeriesClusterEventsDrillToCluster.drillToCluster", DrillToCluster); }  
