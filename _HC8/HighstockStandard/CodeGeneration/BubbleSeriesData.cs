...
{
	public partial class BubbleSeriesData  : BaseObject
	{
		Hashtable h = new Hashtable();

		public BubbleSeriesData()
		{
			Accessibility = Accessibility_DefaultValue = new BubbleSeriesDataAccessibility();
			...
			DragDrop = DragDrop_DefaultValue = new BubbleSeriesDataDragDrop();
			Drilldown = Drilldown_DefaultValue = "";
			Events = Events_DefaultValue = new BubbleSeriesDataEvents();
			Id = Id_DefaultValue = "";
			Labelrank = Labelrank_DefaultValue = null;
			Marker = Marker_DefaultValue = new BubbleSeriesDataMarker();
		...
		/// </summary>
		public BubbleSeriesDataAccessibility Accessibility { get; set; }
		private BubbleSeriesDataAccessibility Accessibility_DefaultValue { get; set; }
		...
		/// </summary>
		public BubbleSeriesDataDragDrop DragDrop { get; set; }
		private BubbleSeriesDataDragDrop DragDrop_DefaultValue { get; set; }
		...
		/// 
		/// </summary>
		public BubbleSeriesDataMarker Marker { get; set; }
		private BubbleSeriesDataMarker Marker_DefaultValue { get; set; }
