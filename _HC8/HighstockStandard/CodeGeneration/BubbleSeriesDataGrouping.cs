...
namespace Highsoft.Web.Mvc.Stocks
{
	public partial class BubbleSeriesDataGrouping  : BaseObject
	{
		...
		internal override Hashtable ToHashtable()
		{
			...
			if (Approximation != Approximation_DefaultValue) { h.Add("approximation",Approximation); Highstock.AddFunction("BubbleSeriesDataGroupingApproximation.approximation", Approximation); }  
