...
namespace Highsoft.Web.Mvc.Stocks
{
	public partial class BubbleSeriesDataLabels  : BaseObject
	{
		...
		public BubbleSeriesDataLabels()
		{
			...
			Overflow = Overflow_DefaultValue = BubbleSeriesDataLabelsOverflow.Justify;
			Padding = Padding_DefaultValue = 5;
			Position = Position_DefaultValue = BubbleSeriesDataLabelsPosition.Center;
		...
		/// </summary>
		public BubbleSeriesDataLabelsOverflow Overflow { get; set; }
		private BubbleSeriesDataLabelsOverflow Overflow_DefaultValue { get; set; }
		...
		/// </summary>
		public BubbleSeriesDataLabelsPosition Position { get; set; }
		private BubbleSeriesDataLabelsPosition Position_DefaultValue { get; set; }
