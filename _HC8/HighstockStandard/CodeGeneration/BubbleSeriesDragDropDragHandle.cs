...
namespace Highsoft.Web.Mvc.Stocks
{
	public partial class BubbleSeriesDragDropDragHandle  : BaseObject
	{
		...
		internal override Hashtable ToHashtable()
		{
			...
			if (PathFormatter != PathFormatter_DefaultValue) { h.Add("pathFormatter",PathFormatter); Highstock.AddFunction("BubbleSeriesDragDropDragHandlePathFormatter.pathFormatter", PathFormatter); }  
