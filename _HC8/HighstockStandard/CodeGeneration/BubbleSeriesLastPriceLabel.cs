...
{
	public partial class BubbleSeriesLastPriceLabel  : BaseObject
	{
		Hashtable h = new Hashtable();

		public BubbleSeriesLastPriceLabel()
		{
			Align = Align_DefaultValue = BubbleSeriesLastPriceLabelAlign.Null;
		...
		/// 
		/// </summary>
		public BubbleSeriesLastPriceLabelAlign Align { get; set; }
		private BubbleSeriesLastPriceLabelAlign Align_DefaultValue { get; set; }
