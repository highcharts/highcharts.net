...
{
	public partial class BubbleSeriesLastVisiblePriceLabel  : BaseObject
	{
		Hashtable h = new Hashtable();

		public BubbleSeriesLastVisiblePriceLabel()
		{
			Align = Align_DefaultValue = BubbleSeriesLastVisiblePriceLabelAlign.Null;
		...
		/// 
		/// </summary>
		public BubbleSeriesLastVisiblePriceLabelAlign Align { get; set; }
		private BubbleSeriesLastVisiblePriceLabelAlign Align_DefaultValue { get; set; }
