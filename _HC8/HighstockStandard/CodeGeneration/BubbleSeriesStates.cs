...
{
	public partial class BubbleSeriesStates  : BaseObject
	{
		...
		/// </summary>
		public BubbleSeriesStatesInactive Inactive { get; set; }
		private BubbleSeriesStatesInactive Inactive_DefaultValue { get; set; }
