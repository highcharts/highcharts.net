...
{
	public partial class BubbleSeriesStatesSelect  : BaseObject
	{
		Hashtable h = new Hashtable();

		public BubbleSeriesStatesSelect()
		{
			Animation = Animation_DefaultValue = new Animation() { Enabled = true };
			Enabled = Enabled_DefaultValue = null;
			Halo = Halo_DefaultValue = new BubbleSeriesStatesSelectHalo();
			LineWidth = LineWidth_DefaultValue = null;
			LineWidthPlus = LineWidthPlus_DefaultValue = null;
			Marker = Marker_DefaultValue = new BubbleSeriesStatesSelectMarker();
		...
		/// </summary>
		public BubbleSeriesStatesSelectHalo Halo { get; set; }
		private BubbleSeriesStatesSelectHalo Halo_DefaultValue { get; set; }
		...
		/// </summary>
		public BubbleSeriesStatesSelectMarker Marker { get; set; }
		private BubbleSeriesStatesSelectMarker Marker_DefaultValue { get; set; }
