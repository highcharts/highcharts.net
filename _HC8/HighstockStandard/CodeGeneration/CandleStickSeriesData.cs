...
namespace Highsoft.Web.Mvc.Stocks
{
	public partial class CandleStickSeriesData  : BaseObject
	{
		...
		{
			Accessibility = Accessibility_DefaultValue = new CandleStickSeriesDataAccessibility();
			...
			Marker = Marker_DefaultValue = new CandleStickSeriesDataMarker();
		...
		/// </summary>
		public CandleStickSeriesDataAccessibility Accessibility { get; set; }
		private CandleStickSeriesDataAccessibility Accessibility_DefaultValue { get; set; }
		...
		/// </summary>
		public CandleStickSeriesDataMarker Marker { get; set; }
		private CandleStickSeriesDataMarker Marker_DefaultValue { get; set; }
