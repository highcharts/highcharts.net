...
{
	public partial class CandleStickSeriesDataMarker  : BaseObject
	{
		Hashtable h = new Hashtable();

		public CandleStickSeriesDataMarker()
		{
			...
			States = States_DefaultValue = new CandleStickSeriesDataMarkerStates();
		...
		/// </summary>
		public CandleStickSeriesDataMarkerStates States { get; set; }
		private CandleStickSeriesDataMarkerStates States_DefaultValue { get; set; }
