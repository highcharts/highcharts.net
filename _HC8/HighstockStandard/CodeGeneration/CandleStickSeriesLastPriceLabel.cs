...
{
	public partial class CandleStickSeriesLastPriceLabel  : BaseObject
	{
		Hashtable h = new Hashtable();

		public CandleStickSeriesLastPriceLabel()
		{
			Align = Align_DefaultValue = CandleStickSeriesLastPriceLabelAlign.Null;
		...
		/// 
		/// </summary>
		public CandleStickSeriesLastPriceLabelAlign Align { get; set; }
		private CandleStickSeriesLastPriceLabelAlign Align_DefaultValue { get; set; }
