...
{
	public partial class CandleStickSeriesLastVisiblePriceLabel  : BaseObject
	{
		Hashtable h = new Hashtable();

		public CandleStickSeriesLastVisiblePriceLabel()
		{
			Align = Align_DefaultValue = CandleStickSeriesLastVisiblePriceLabelAlign.Null;
		...
		/// 
		/// </summary>
		public CandleStickSeriesLastVisiblePriceLabelAlign Align { get; set; }
		private CandleStickSeriesLastVisiblePriceLabelAlign Align_DefaultValue { get; set; }
