...
{
	public partial class CandleStickSeriesOnPoint  : BaseObject
	{
		Hashtable h = new Hashtable();

		public CandleStickSeriesOnPoint()
		{
			ConnectorOptions = ConnectorOptions_DefaultValue = new CandleStickSeriesOnPointConnectorOptions();
			Id = Id_DefaultValue = "";
			Position = Position_DefaultValue = new CandleStickSeriesOnPointPosition();
		...
		/// </summary>
		public CandleStickSeriesOnPointConnectorOptions ConnectorOptions { get; set; }
		private CandleStickSeriesOnPointConnectorOptions ConnectorOptions_DefaultValue { get; set; }
		...
		/// </summary>
		public CandleStickSeriesOnPointPosition Position { get; set; }
		private CandleStickSeriesOnPointPosition Position_DefaultValue { get; set; }
