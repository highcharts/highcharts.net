...
{
	public partial class CandleStickSeriesSonificationContextTracksPointGrouping  : BaseObject
	{
		Hashtable h = new Hashtable();

		public CandleStickSeriesSonificationContextTracksPointGrouping()
		{
			Algorithm = Algorithm_DefaultValue = CandleStickSeriesSonificationContextTracksPointGroupingAlgorithm.Minimax;
		...
		/// </summary>
		public CandleStickSeriesSonificationContextTracksPointGroupingAlgorithm Algorithm { get; set; }
		private CandleStickSeriesSonificationContextTracksPointGroupingAlgorithm Algorithm_DefaultValue { get; set; }
