...
{
	public partial class CandleStickSeriesSonificationTracksPointGrouping  : BaseObject
	{
		Hashtable h = new Hashtable();

		public CandleStickSeriesSonificationTracksPointGrouping()
		{
			Algorithm = Algorithm_DefaultValue = CandleStickSeriesSonificationTracksPointGroupingAlgorithm.Minimax;
		...
		/// </summary>
		public CandleStickSeriesSonificationTracksPointGroupingAlgorithm Algorithm { get; set; }
		private CandleStickSeriesSonificationTracksPointGroupingAlgorithm Algorithm_DefaultValue { get; set; }
