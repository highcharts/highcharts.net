...
{
	public partial class CandleStickSeriesStatesSelect  : BaseObject
	{
		Hashtable h = new Hashtable();

		public CandleStickSeriesStatesSelect()
		{
			Animation = Animation_DefaultValue = new Animation() { Enabled = true };
			Enabled = Enabled_DefaultValue = null;
			Halo = Halo_DefaultValue = new CandleStickSeriesStatesSelectHalo();
			LineWidth = LineWidth_DefaultValue = null;
			LineWidthPlus = LineWidthPlus_DefaultValue = null;
			Marker = Marker_DefaultValue = new CandleStickSeriesStatesSelectMarker();
		...
		/// </summary>
		public CandleStickSeriesStatesSelectHalo Halo { get; set; }
		private CandleStickSeriesStatesSelectHalo Halo_DefaultValue { get; set; }
		...
		/// </summary>
		public CandleStickSeriesStatesSelectMarker Marker { get; set; }
		private CandleStickSeriesStatesSelectMarker Marker_DefaultValue { get; set; }
