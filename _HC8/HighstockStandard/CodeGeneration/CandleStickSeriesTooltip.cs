...
namespace Highsoft.Web.Mvc.Stocks
{
	public partial class CandleStickSeriesTooltip  : BaseObject
	{
		...
		public CandleStickSeriesTooltip()
		{
			...
			HeaderShape = HeaderShape_DefaultValue = CandleStickSeriesTooltipHeaderShape.Callout;
		...
		/// </summary>
		public CandleStickSeriesTooltipHeaderShape HeaderShape { get; set; }
		private CandleStickSeriesTooltipHeaderShape HeaderShape_DefaultValue { get; set; }
		...
		internal override Hashtable ToHashtable()
		{
			...
			if (NullFormatter != NullFormatter_DefaultValue) { h.Add("nullFormatter",NullFormatter); Highstock.AddFunction("CandleStickSeriesTooltipNullFormatter.nullFormatter", NullFormatter); }  
