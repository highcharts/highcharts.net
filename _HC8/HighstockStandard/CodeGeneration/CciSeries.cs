...
namespace Highsoft.Web.Mvc.Stocks
{
	public partial class CciSeries  : Series
	{
		...
		public CciSeries()
		{
			...
			DashStyle = DashStyle_DefaultValue = CciSeriesDashStyle.Solid;
			...
			Type = Type_DefaultValue = CciSeriesType.Cci;
		...
		/// </summary>
		public CciSeriesType Type { get; set; }
		private CciSeriesType Type_DefaultValue { get; set; }
		...
		internal override Hashtable ToHashtable()
		{
			...
			if (PointDescriptionFormatter != PointDescriptionFormatter_DefaultValue) { h.Add("pointDescriptionFormatter",PointDescriptionFormatter); Highstock.AddFunction("CciSeriesPointDescriptionFormatter.pointDescriptionFormatter", PointDescriptionFormatter); }  
