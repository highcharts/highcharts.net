...
{
	public partial class CciSeriesDataLabels  : BaseObject
	{
		Hashtable h = new Hashtable();

		public CciSeriesDataLabels()
		{
			Align = Align_DefaultValue = CciSeriesDataLabelsAlign.Center;
			...
			Filter = Filter_DefaultValue = new CciSeriesDataLabelsFilter();
			...
			Overflow = Overflow_DefaultValue = CciSeriesDataLabelsOverflow.Justify;
			Padding = Padding_DefaultValue = 5;
			Position = Position_DefaultValue = CciSeriesDataLabelsPosition.Center;
			...
			TextPath = TextPath_DefaultValue = new CciSeriesDataLabelsTextPath();
			UseHTML = UseHTML_DefaultValue = false;
			VerticalAlign = VerticalAlign_DefaultValue = CciSeriesDataLabelsVerticalAlign.Bottom;
			X = X_DefaultValue = 0;
			Y = Y_DefaultValue = 0;
			Z = Z_DefaultValue = 6;
		...
		/// </summary>
		public CciSeriesDataLabelsAlign Align { get; set; }
		private CciSeriesDataLabelsAlign Align_DefaultValue { get; set; }
		...
		/// </summary>
		public CciSeriesDataLabelsFilter Filter { get; set; }
		private CciSeriesDataLabelsFilter Filter_DefaultValue { get; set; }
		...
		/// </summary>
		public CciSeriesDataLabelsOverflow Overflow { get; set; }
		private CciSeriesDataLabelsOverflow Overflow_DefaultValue { get; set; }
		...
		/// </summary>
		public CciSeriesDataLabelsPosition Position { get; set; }
		private CciSeriesDataLabelsPosition Position_DefaultValue { get; set; }
		...
		/// </summary>
		public CciSeriesDataLabelsTextPath TextPath { get; set; }
		private CciSeriesDataLabelsTextPath TextPath_DefaultValue { get; set; }
		...
		/// </summary>
		public CciSeriesDataLabelsVerticalAlign VerticalAlign { get; set; }
		private CciSeriesDataLabelsVerticalAlign VerticalAlign_DefaultValue { get; set; }
