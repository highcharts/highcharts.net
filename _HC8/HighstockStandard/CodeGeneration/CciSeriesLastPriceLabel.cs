...
{
	public partial class CciSeriesLastPriceLabel  : BaseObject
	{
		Hashtable h = new Hashtable();

		public CciSeriesLastPriceLabel()
		{
			Align = Align_DefaultValue = CciSeriesLastPriceLabelAlign.Null;
		...
		/// 
		/// </summary>
		public CciSeriesLastPriceLabelAlign Align { get; set; }
		private CciSeriesLastPriceLabelAlign Align_DefaultValue { get; set; }
