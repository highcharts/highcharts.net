...
{
	public partial class CciSeriesLastVisiblePriceLabel  : BaseObject
	{
		Hashtable h = new Hashtable();

		public CciSeriesLastVisiblePriceLabel()
		{
			Align = Align_DefaultValue = CciSeriesLastVisiblePriceLabelAlign.Null;
		...
		/// 
		/// </summary>
		public CciSeriesLastVisiblePriceLabelAlign Align { get; set; }
		private CciSeriesLastVisiblePriceLabelAlign Align_DefaultValue { get; set; }
