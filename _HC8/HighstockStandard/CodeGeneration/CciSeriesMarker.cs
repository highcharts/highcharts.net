...
{
	public partial class CciSeriesMarker  : BaseObject
	{
		Hashtable h = new Hashtable();

		public CciSeriesMarker()
		{
			...
			States = States_DefaultValue = new CciSeriesMarkerStates();
		...
		/// </summary>
		public CciSeriesMarkerStates States { get; set; }
		private CciSeriesMarkerStates States_DefaultValue { get; set; }
