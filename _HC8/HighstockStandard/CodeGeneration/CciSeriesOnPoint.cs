...
{
	public partial class CciSeriesOnPoint  : BaseObject
	{
		Hashtable h = new Hashtable();

		public CciSeriesOnPoint()
		{
			ConnectorOptions = ConnectorOptions_DefaultValue = new CciSeriesOnPointConnectorOptions();
			Id = Id_DefaultValue = "";
			Position = Position_DefaultValue = new CciSeriesOnPointPosition();
		...
		/// </summary>
		public CciSeriesOnPointConnectorOptions ConnectorOptions { get; set; }
		private CciSeriesOnPointConnectorOptions ConnectorOptions_DefaultValue { get; set; }
		...
		/// </summary>
		public CciSeriesOnPointPosition Position { get; set; }
		private CciSeriesOnPointPosition Position_DefaultValue { get; set; }
