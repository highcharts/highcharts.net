...
{
	public partial class CciSeriesSonificationPointGrouping  : BaseObject
	{
		Hashtable h = new Hashtable();

		public CciSeriesSonificationPointGrouping()
		{
			Algorithm = Algorithm_DefaultValue = CciSeriesSonificationPointGroupingAlgorithm.Minimax;
		...
		/// </summary>
		public CciSeriesSonificationPointGroupingAlgorithm Algorithm { get; set; }
		private CciSeriesSonificationPointGroupingAlgorithm Algorithm_DefaultValue { get; set; }
