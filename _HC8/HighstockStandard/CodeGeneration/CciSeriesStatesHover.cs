...
{
	public partial class CciSeriesStatesHover  : BaseObject
	{
		Hashtable h = new Hashtable();

		public CciSeriesStatesHover()
		{
			Animation = Animation_DefaultValue = new Animation() { Enabled = true };
			Enabled = Enabled_DefaultValue = null;
			Halo = Halo_DefaultValue = new CciSeriesStatesHoverHalo();
			LineWidth = LineWidth_DefaultValue = null;
			LineWidthPlus = LineWidthPlus_DefaultValue = null;
			Marker = Marker_DefaultValue = new CciSeriesStatesHoverMarker();
		...
		/// </summary>
		public CciSeriesStatesHoverHalo Halo { get; set; }
		private CciSeriesStatesHoverHalo Halo_DefaultValue { get; set; }
		...
		/// </summary>
		public CciSeriesStatesHoverMarker Marker { get; set; }
		private CciSeriesStatesHoverMarker Marker_DefaultValue { get; set; }
