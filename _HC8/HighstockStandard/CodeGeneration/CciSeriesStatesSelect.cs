...
{
	public partial class CciSeriesStatesSelect  : BaseObject
	{
		Hashtable h = new Hashtable();

		public CciSeriesStatesSelect()
		{
			Animation = Animation_DefaultValue = new Animation() { Enabled = true };
			Enabled = Enabled_DefaultValue = new Hashtable();
			Halo = Halo_DefaultValue = new CciSeriesStatesSelectHalo();
			LineWidth = LineWidth_DefaultValue = new Hashtable();
			LineWidthPlus = LineWidthPlus_DefaultValue = new Hashtable();
			Marker = Marker_DefaultValue = new CciSeriesStatesSelectMarker();
		...
		/// </summary>
		public CciSeriesStatesSelectHalo Halo { get; set; }
		private CciSeriesStatesSelectHalo Halo_DefaultValue { get; set; }
		...
		/// </summary>
		public CciSeriesStatesSelectMarker Marker { get; set; }
		private CciSeriesStatesSelectMarker Marker_DefaultValue { get; set; }
