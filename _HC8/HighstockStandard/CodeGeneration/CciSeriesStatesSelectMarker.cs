...
{
	public partial class CciSeriesStatesSelectMarker  : BaseObject
	{
		Hashtable h = new Hashtable();

		public CciSeriesStatesSelectMarker()
		{
			...
			States = States_DefaultValue = new CciSeriesStatesSelectMarkerStates();
		...
		/// </summary>
		public CciSeriesStatesSelectMarkerStates States { get; set; }
		private CciSeriesStatesSelectMarkerStates States_DefaultValue { get; set; }
