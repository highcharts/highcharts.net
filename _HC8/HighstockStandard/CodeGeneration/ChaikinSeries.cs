...
namespace Highsoft.Web.Mvc.Stocks
{
	public partial class ChaikinSeries  : Series
	{
		...
		public ChaikinSeries()
		{
			...
			DashStyle = DashStyle_DefaultValue = ChaikinSeriesDashStyle.Solid;
			...
			Type = Type_DefaultValue = ChaikinSeriesType.Chaikin;
		...
		internal override Hashtable ToHashtable()
		{
			...
			if (PointDescriptionFormatter != PointDescriptionFormatter_DefaultValue) { h.Add("pointDescriptionFormatter",PointDescriptionFormatter); Highstock.AddFunction("ChaikinSeriesPointDescriptionFormatter.pointDescriptionFormatter", PointDescriptionFormatter); }  
