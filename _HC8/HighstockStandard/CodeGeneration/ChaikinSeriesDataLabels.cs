...
{
	public partial class ChaikinSeriesDataLabels  : BaseObject
	{
		Hashtable h = new Hashtable();

		public ChaikinSeriesDataLabels()
		{
			Align = Align_DefaultValue = ChaikinSeriesDataLabelsAlign.Center;
			...
			Filter = Filter_DefaultValue = new ChaikinSeriesDataLabelsFilter();
			...
			Overflow = Overflow_DefaultValue = ChaikinSeriesDataLabelsOverflow.Justify;
			Padding = Padding_DefaultValue = 5;
			Position = Position_DefaultValue = ChaikinSeriesDataLabelsPosition.Center;
			...
			TextPath = TextPath_DefaultValue = new ChaikinSeriesDataLabelsTextPath();
			UseHTML = UseHTML_DefaultValue = false;
			VerticalAlign = VerticalAlign_DefaultValue = ChaikinSeriesDataLabelsVerticalAlign.Bottom;
			X = X_DefaultValue = 0;
			Y = Y_DefaultValue = 0;
			Z = Z_DefaultValue = 6;
		...
		/// </summary>
		public ChaikinSeriesDataLabelsAlign Align { get; set; }
		private ChaikinSeriesDataLabelsAlign Align_DefaultValue { get; set; }
		...
		/// </summary>
		public ChaikinSeriesDataLabelsFilter Filter { get; set; }
		private ChaikinSeriesDataLabelsFilter Filter_DefaultValue { get; set; }
		...
		/// </summary>
		public ChaikinSeriesDataLabelsOverflow Overflow { get; set; }
		private ChaikinSeriesDataLabelsOverflow Overflow_DefaultValue { get; set; }
		...
		/// </summary>
		public ChaikinSeriesDataLabelsPosition Position { get; set; }
		private ChaikinSeriesDataLabelsPosition Position_DefaultValue { get; set; }
		...
		/// </summary>
		public ChaikinSeriesDataLabelsTextPath TextPath { get; set; }
		private ChaikinSeriesDataLabelsTextPath TextPath_DefaultValue { get; set; }
		...
		/// </summary>
		public ChaikinSeriesDataLabelsVerticalAlign VerticalAlign { get; set; }
		private ChaikinSeriesDataLabelsVerticalAlign VerticalAlign_DefaultValue { get; set; }
