...
{
	public partial class ChaikinSeriesLastPriceLabel  : BaseObject
	{
		Hashtable h = new Hashtable();

		public ChaikinSeriesLastPriceLabel()
		{
			Align = Align_DefaultValue = ChaikinSeriesLastPriceLabelAlign.Null;
		...
		/// 
		/// </summary>
		public ChaikinSeriesLastPriceLabelAlign Align { get; set; }
		private ChaikinSeriesLastPriceLabelAlign Align_DefaultValue { get; set; }
