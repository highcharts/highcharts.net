...
{
	public partial class ChaikinSeriesLastVisiblePriceLabel  : BaseObject
	{
		Hashtable h = new Hashtable();

		public ChaikinSeriesLastVisiblePriceLabel()
		{
			Align = Align_DefaultValue = ChaikinSeriesLastVisiblePriceLabelAlign.Null;
		...
		/// 
		/// </summary>
		public ChaikinSeriesLastVisiblePriceLabelAlign Align { get; set; }
		private ChaikinSeriesLastVisiblePriceLabelAlign Align_DefaultValue { get; set; }
