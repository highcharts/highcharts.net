...
{
	public partial class ChaikinSeriesMarker  : BaseObject
	{
		Hashtable h = new Hashtable();

		public ChaikinSeriesMarker()
		{
			...
			States = States_DefaultValue = new ChaikinSeriesMarkerStates();
		...
		/// </summary>
		public ChaikinSeriesMarkerStates States { get; set; }
		private ChaikinSeriesMarkerStates States_DefaultValue { get; set; }
