...
{
	public partial class ChaikinSeriesOnPoint  : BaseObject
	{
		Hashtable h = new Hashtable();

		public ChaikinSeriesOnPoint()
		{
			ConnectorOptions = ConnectorOptions_DefaultValue = new ChaikinSeriesOnPointConnectorOptions();
			Id = Id_DefaultValue = "";
			Position = Position_DefaultValue = new ChaikinSeriesOnPointPosition();
		...
		/// </summary>
		public ChaikinSeriesOnPointConnectorOptions ConnectorOptions { get; set; }
		private ChaikinSeriesOnPointConnectorOptions ConnectorOptions_DefaultValue { get; set; }
		...
		/// </summary>
		public ChaikinSeriesOnPointPosition Position { get; set; }
		private ChaikinSeriesOnPointPosition Position_DefaultValue { get; set; }
