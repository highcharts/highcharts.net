...
{
	public partial class ChaikinSeriesSonificationPointGrouping  : BaseObject
	{
		Hashtable h = new Hashtable();

		public ChaikinSeriesSonificationPointGrouping()
		{
			Algorithm = Algorithm_DefaultValue = ChaikinSeriesSonificationPointGroupingAlgorithm.Minimax;
		...
		/// </summary>
		public ChaikinSeriesSonificationPointGroupingAlgorithm Algorithm { get; set; }
		private ChaikinSeriesSonificationPointGroupingAlgorithm Algorithm_DefaultValue { get; set; }
