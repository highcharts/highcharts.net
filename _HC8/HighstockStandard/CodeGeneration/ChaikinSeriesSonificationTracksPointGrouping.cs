...
{
	public partial class ChaikinSeriesSonificationTracksPointGrouping  : BaseObject
	{
		Hashtable h = new Hashtable();

		public ChaikinSeriesSonificationTracksPointGrouping()
		{
			Algorithm = Algorithm_DefaultValue = ChaikinSeriesSonificationTracksPointGroupingAlgorithm.Minimax;
		...
		/// </summary>
		public ChaikinSeriesSonificationTracksPointGroupingAlgorithm Algorithm { get; set; }
		private ChaikinSeriesSonificationTracksPointGroupingAlgorithm Algorithm_DefaultValue { get; set; }
