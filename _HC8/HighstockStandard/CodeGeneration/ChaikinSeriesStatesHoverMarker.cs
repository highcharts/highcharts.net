...
{
	public partial class ChaikinSeriesStatesHoverMarker  : BaseObject
	{
		Hashtable h = new Hashtable();

		public ChaikinSeriesStatesHoverMarker()
		{
			...
			States = States_DefaultValue = new ChaikinSeriesStatesHoverMarkerStates();
		...
		/// </summary>
		public ChaikinSeriesStatesHoverMarkerStates States { get; set; }
		private ChaikinSeriesStatesHoverMarkerStates States_DefaultValue { get; set; }
