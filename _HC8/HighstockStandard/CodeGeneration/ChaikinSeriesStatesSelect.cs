...
{
	public partial class ChaikinSeriesStatesSelect  : BaseObject
	{
		Hashtable h = new Hashtable();

		public ChaikinSeriesStatesSelect()
		{
			Animation = Animation_DefaultValue = new Animation() { Enabled = true };
			Enabled = Enabled_DefaultValue = true;
			Halo = Halo_DefaultValue = new ChaikinSeriesStatesSelectHalo();
			LineWidth = LineWidth_DefaultValue = null;
			LineWidthPlus = LineWidthPlus_DefaultValue = 1;
			Marker = Marker_DefaultValue = new ChaikinSeriesStatesSelectMarker();
		...
		/// </summary>
		public ChaikinSeriesStatesSelectHalo Halo { get; set; }
		private ChaikinSeriesStatesSelectHalo Halo_DefaultValue { get; set; }
		...
		/// </summary>
		public ChaikinSeriesStatesSelectMarker Marker { get; set; }
		private ChaikinSeriesStatesSelectMarker Marker_DefaultValue { get; set; }
