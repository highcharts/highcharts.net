...
{
	public partial class ChaikinSeriesStatesSelectMarker  : BaseObject
	{
		Hashtable h = new Hashtable();

		public ChaikinSeriesStatesSelectMarker()
		{
			...
			States = States_DefaultValue = new ChaikinSeriesStatesSelectMarkerStates();
		...
		/// </summary>
		public ChaikinSeriesStatesSelectMarkerStates States { get; set; }
		private ChaikinSeriesStatesSelectMarkerStates States_DefaultValue { get; set; }
