...
namespace Highsoft.Web.Mvc.Stocks
{
	public partial class CmfSeriesAccessibility  : BaseObject
	{
		...
		public CmfSeriesAccessibility()
		{
			...
			Point = Point_DefaultValue = new CmfSeriesAccessibilityPoint();
		...
		/// </summary>
		public CmfSeriesAccessibilityPoint Point { get; set; }
		private CmfSeriesAccessibilityPoint Point_DefaultValue { get; set; }
