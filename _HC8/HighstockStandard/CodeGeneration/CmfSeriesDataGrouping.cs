...
namespace Highsoft.Web.Mvc.Stocks
{
	public partial class CmfSeriesDataGrouping  : BaseObject
	{
		...
		internal override Hashtable ToHashtable()
		{
			...
			if (Approximation != Approximation_DefaultValue) { h.Add("approximation",Approximation); Highstock.AddFunction("CmfSeriesDataGroupingApproximation.approximation", Approximation); }  
