...
{
	public partial class CmfSeriesDataLabels  : BaseObject
	{
		Hashtable h = new Hashtable();

		public CmfSeriesDataLabels()
		{
			Align = Align_DefaultValue = CmfSeriesDataLabelsAlign.Center;
			...
			Filter = Filter_DefaultValue = new CmfSeriesDataLabelsFilter();
			...
			Overflow = Overflow_DefaultValue = CmfSeriesDataLabelsOverflow.Justify;
			Padding = Padding_DefaultValue = 5;
			Position = Position_DefaultValue = CmfSeriesDataLabelsPosition.Center;
			...
			TextPath = TextPath_DefaultValue = new CmfSeriesDataLabelsTextPath();
			UseHTML = UseHTML_DefaultValue = false;
			VerticalAlign = VerticalAlign_DefaultValue = CmfSeriesDataLabelsVerticalAlign.Bottom;
			X = X_DefaultValue = 0;
			Y = Y_DefaultValue = 0;
			Z = Z_DefaultValue = 6;
		...
		/// </summary>
		public CmfSeriesDataLabelsAlign Align { get; set; }
		private CmfSeriesDataLabelsAlign Align_DefaultValue { get; set; }
		...
		/// </summary>
		public CmfSeriesDataLabelsFilter Filter { get; set; }
		private CmfSeriesDataLabelsFilter Filter_DefaultValue { get; set; }
		...
		/// </summary>
		public CmfSeriesDataLabelsOverflow Overflow { get; set; }
		private CmfSeriesDataLabelsOverflow Overflow_DefaultValue { get; set; }
		...
		/// </summary>
		public CmfSeriesDataLabelsPosition Position { get; set; }
		private CmfSeriesDataLabelsPosition Position_DefaultValue { get; set; }
		...
		/// </summary>
		public CmfSeriesDataLabelsTextPath TextPath { get; set; }
		private CmfSeriesDataLabelsTextPath TextPath_DefaultValue { get; set; }
		...
		/// </summary>
		public CmfSeriesDataLabelsVerticalAlign VerticalAlign { get; set; }
		private CmfSeriesDataLabelsVerticalAlign VerticalAlign_DefaultValue { get; set; }
