...
{
	public partial class CmfSeriesLastPriceLabel  : BaseObject
	{
		Hashtable h = new Hashtable();

		public CmfSeriesLastPriceLabel()
		{
			Align = Align_DefaultValue = CmfSeriesLastPriceLabelAlign.Null;
		...
		/// 
		/// </summary>
		public CmfSeriesLastPriceLabelAlign Align { get; set; }
		private CmfSeriesLastPriceLabelAlign Align_DefaultValue { get; set; }
