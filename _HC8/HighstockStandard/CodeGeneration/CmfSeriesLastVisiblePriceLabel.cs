...
{
	public partial class CmfSeriesLastVisiblePriceLabel  : BaseObject
	{
		Hashtable h = new Hashtable();

		public CmfSeriesLastVisiblePriceLabel()
		{
			Align = Align_DefaultValue = CmfSeriesLastVisiblePriceLabelAlign.Null;
		...
		/// 
		/// </summary>
		public CmfSeriesLastVisiblePriceLabelAlign Align { get; set; }
		private CmfSeriesLastVisiblePriceLabelAlign Align_DefaultValue { get; set; }
