...
{
	public partial class CmfSeriesMarker  : BaseObject
	{
		Hashtable h = new Hashtable();

		public CmfSeriesMarker()
		{
			...
			States = States_DefaultValue = new CmfSeriesMarkerStates();
		...
		/// </summary>
		public CmfSeriesMarkerStates States { get; set; }
		private CmfSeriesMarkerStates States_DefaultValue { get; set; }
