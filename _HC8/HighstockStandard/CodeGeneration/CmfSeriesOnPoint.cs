...
{
	public partial class CmfSeriesOnPoint  : BaseObject
	{
		Hashtable h = new Hashtable();

		public CmfSeriesOnPoint()
		{
			ConnectorOptions = ConnectorOptions_DefaultValue = new CmfSeriesOnPointConnectorOptions();
			Id = Id_DefaultValue = "";
			Position = Position_DefaultValue = new CmfSeriesOnPointPosition();
		...
		/// </summary>
		public CmfSeriesOnPointConnectorOptions ConnectorOptions { get; set; }
		private CmfSeriesOnPointConnectorOptions ConnectorOptions_DefaultValue { get; set; }
		...
		/// </summary>
		public CmfSeriesOnPointPosition Position { get; set; }
		private CmfSeriesOnPointPosition Position_DefaultValue { get; set; }
