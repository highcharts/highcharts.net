...
{
	public partial class CmfSeriesSonificationPointGrouping  : BaseObject
	{
		Hashtable h = new Hashtable();

		public CmfSeriesSonificationPointGrouping()
		{
			Algorithm = Algorithm_DefaultValue = CmfSeriesSonificationPointGroupingAlgorithm.Minimax;
		...
		/// </summary>
		public CmfSeriesSonificationPointGroupingAlgorithm Algorithm { get; set; }
		private CmfSeriesSonificationPointGroupingAlgorithm Algorithm_DefaultValue { get; set; }
