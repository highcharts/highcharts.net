...
{
	public partial class CmfSeriesStatesHover  : BaseObject
	{
		Hashtable h = new Hashtable();

		public CmfSeriesStatesHover()
		{
			Animation = Animation_DefaultValue = new Animation() { Enabled = true };
			AnimationBool = AnimationBool_DefaultValue = null;
			Enabled = Enabled_DefaultValue = true;
			Halo = Halo_DefaultValue = new CmfSeriesStatesHoverHalo();
			LineWidth = LineWidth_DefaultValue = null;
			LineWidthPlus = LineWidthPlus_DefaultValue = 1;
			Marker = Marker_DefaultValue = new CmfSeriesStatesHoverMarker();
		...
		/// </summary>
		public CmfSeriesStatesHoverHalo Halo { get; set; }
		private CmfSeriesStatesHoverHalo Halo_DefaultValue { get; set; }
		...
		/// </summary>
		public CmfSeriesStatesHoverMarker Marker { get; set; }
		private CmfSeriesStatesHoverMarker Marker_DefaultValue { get; set; }
