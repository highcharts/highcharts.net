...
{
	public partial class CmfSeriesStatesHoverMarker  : BaseObject
	{
		Hashtable h = new Hashtable();

		public CmfSeriesStatesHoverMarker()
		{
			...
			States = States_DefaultValue = new CmfSeriesStatesHoverMarkerStates();
		...
		/// </summary>
		public CmfSeriesStatesHoverMarkerStates States { get; set; }
		private CmfSeriesStatesHoverMarkerStates States_DefaultValue { get; set; }
