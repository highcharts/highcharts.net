...
{
	public partial class CmfSeriesStatesSelect  : BaseObject
	{
		Hashtable h = new Hashtable();

		public CmfSeriesStatesSelect()
		{
			Animation = Animation_DefaultValue = new Animation() { Enabled = true };
			Enabled = Enabled_DefaultValue = null;
			Halo = Halo_DefaultValue = new CmfSeriesStatesSelectHalo();
			LineWidth = LineWidth_DefaultValue = null;
			LineWidthPlus = LineWidthPlus_DefaultValue = null;
			Marker = Marker_DefaultValue = new CmfSeriesStatesSelectMarker();
		...
		/// </summary>
		public CmfSeriesStatesSelectHalo Halo { get; set; }
		private CmfSeriesStatesSelectHalo Halo_DefaultValue { get; set; }
		...
		/// </summary>
		public CmfSeriesStatesSelectMarker Marker { get; set; }
		private CmfSeriesStatesSelectMarker Marker_DefaultValue { get; set; }
