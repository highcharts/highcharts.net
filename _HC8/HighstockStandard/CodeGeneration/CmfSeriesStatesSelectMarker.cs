...
{
	public partial class CmfSeriesStatesSelectMarker  : BaseObject
	{
		Hashtable h = new Hashtable();

		public CmfSeriesStatesSelectMarker()
		{
			...
			States = States_DefaultValue = new CmfSeriesStatesSelectMarkerStates();
		...
		/// </summary>
		public CmfSeriesStatesSelectMarkerStates States { get; set; }
		private CmfSeriesStatesSelectMarkerStates States_DefaultValue { get; set; }
