...
{
	public partial class CmfSeriesTooltip  : BaseObject
	{
		Hashtable h = new Hashtable();

		public CmfSeriesTooltip()
		{
			...
			HeaderShape = HeaderShape_DefaultValue = CmfSeriesTooltipHeaderShape.Callout;
		...
		/// </summary>
		public CmfSeriesTooltipHeaderShape HeaderShape { get; set; }
		private CmfSeriesTooltipHeaderShape HeaderShape_DefaultValue { get; set; }
		...
		internal override Hashtable ToHashtable()
		{
			...
			if (NullFormatter != NullFormatter_DefaultValue) { h.Add("nullFormatter",NullFormatter); Highstock.AddFunction("CmfSeriesTooltipNullFormatter.nullFormatter", NullFormatter); }  
			if (Outside != Outside_DefaultValue) h.Add("outside",Outside);
			if (Padding != Padding_DefaultValue) h.Add("padding",Padding);
			if (PointFormat != PointFormat_DefaultValue) h.Add("pointFormat",PointFormat);
			if (PointFormatter != PointFormatter_DefaultValue) { h.Add("pointFormatter",PointFormatter); Highstock.AddFunction("CmfSeriesTooltipPointFormatter.pointFormatter", PointFormatter); }  
