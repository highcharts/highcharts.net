...
{
	public partial class CmoSeriesDataLabels  : BaseObject
	{
		Hashtable h = new Hashtable();

		public CmoSeriesDataLabels()
		{
			Align = Align_DefaultValue = CmoSeriesDataLabelsAlign.Center;
			...
			Filter = Filter_DefaultValue = new CmoSeriesDataLabelsFilter();
			...
			Overflow = Overflow_DefaultValue = CmoSeriesDataLabelsOverflow.Justify;
			Padding = Padding_DefaultValue = 5;
			Position = Position_DefaultValue = CmoSeriesDataLabelsPosition.Center;
			...
			TextPath = TextPath_DefaultValue = new CmoSeriesDataLabelsTextPath();
			UseHTML = UseHTML_DefaultValue = false;
			VerticalAlign = VerticalAlign_DefaultValue = CmoSeriesDataLabelsVerticalAlign.Bottom;
			X = X_DefaultValue = 0;
			Y = Y_DefaultValue = 0;
			Z = Z_DefaultValue = 6;
		...
		/// </summary>
		public CmoSeriesDataLabelsAlign Align { get; set; }
		private CmoSeriesDataLabelsAlign Align_DefaultValue { get; set; }
		...
		/// </summary>
		public CmoSeriesDataLabelsFilter Filter { get; set; }
		private CmoSeriesDataLabelsFilter Filter_DefaultValue { get; set; }
		...
		/// </summary>
		public CmoSeriesDataLabelsOverflow Overflow { get; set; }
		private CmoSeriesDataLabelsOverflow Overflow_DefaultValue { get; set; }
		...
		/// </summary>
		public CmoSeriesDataLabelsPosition Position { get; set; }
		private CmoSeriesDataLabelsPosition Position_DefaultValue { get; set; }
		...
		/// </summary>
		public CmoSeriesDataLabelsTextPath TextPath { get; set; }
		private CmoSeriesDataLabelsTextPath TextPath_DefaultValue { get; set; }
		...
		/// </summary>
		public CmoSeriesDataLabelsVerticalAlign VerticalAlign { get; set; }
		private CmoSeriesDataLabelsVerticalAlign VerticalAlign_DefaultValue { get; set; }
