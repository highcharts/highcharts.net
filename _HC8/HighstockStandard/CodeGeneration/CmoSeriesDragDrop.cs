...
{
	public partial class CmoSeriesDragDrop  : BaseObject
	{
		Hashtable h = new Hashtable();

		public CmoSeriesDragDrop()
		{
			...
			GuideBox = GuideBox_DefaultValue = new CmoSeriesDragDropGuideBox();
		...
		/// </summary>
		public CmoSeriesDragDropGuideBox GuideBox { get; set; }
		private CmoSeriesDragDropGuideBox GuideBox_DefaultValue { get; set; }
