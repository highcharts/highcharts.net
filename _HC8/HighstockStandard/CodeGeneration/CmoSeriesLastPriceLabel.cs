...
{
	public partial class CmoSeriesLastPriceLabel  : BaseObject
	{
		Hashtable h = new Hashtable();

		public CmoSeriesLastPriceLabel()
		{
			Align = Align_DefaultValue = CmoSeriesLastPriceLabelAlign.Null;
		...
		/// 
		/// </summary>
		public CmoSeriesLastPriceLabelAlign Align { get; set; }
		private CmoSeriesLastPriceLabelAlign Align_DefaultValue { get; set; }
