...
{
	public partial class CmoSeriesLastVisiblePriceLabel  : BaseObject
	{
		Hashtable h = new Hashtable();

		public CmoSeriesLastVisiblePriceLabel()
		{
			Align = Align_DefaultValue = CmoSeriesLastVisiblePriceLabelAlign.Null;
		...
		/// 
		/// </summary>
		public CmoSeriesLastVisiblePriceLabelAlign Align { get; set; }
		private CmoSeriesLastVisiblePriceLabelAlign Align_DefaultValue { get; set; }
