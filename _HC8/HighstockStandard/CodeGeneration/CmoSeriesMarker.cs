...
{
	public partial class CmoSeriesMarker  : BaseObject
	{
		Hashtable h = new Hashtable();

		public CmoSeriesMarker()
		{
			...
			States = States_DefaultValue = new CmoSeriesMarkerStates();
		...
		/// </summary>
		public CmoSeriesMarkerStates States { get; set; }
		private CmoSeriesMarkerStates States_DefaultValue { get; set; }
