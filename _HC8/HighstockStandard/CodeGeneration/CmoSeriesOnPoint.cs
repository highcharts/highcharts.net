...
{
	public partial class CmoSeriesOnPoint  : BaseObject
	{
		Hashtable h = new Hashtable();

		public CmoSeriesOnPoint()
		{
			ConnectorOptions = ConnectorOptions_DefaultValue = new CmoSeriesOnPointConnectorOptions();
			Id = Id_DefaultValue = "";
			Position = Position_DefaultValue = new CmoSeriesOnPointPosition();
		...
		/// </summary>
		public CmoSeriesOnPointConnectorOptions ConnectorOptions { get; set; }
		private CmoSeriesOnPointConnectorOptions ConnectorOptions_DefaultValue { get; set; }
		...
		/// </summary>
		public CmoSeriesOnPointPosition Position { get; set; }
		private CmoSeriesOnPointPosition Position_DefaultValue { get; set; }
