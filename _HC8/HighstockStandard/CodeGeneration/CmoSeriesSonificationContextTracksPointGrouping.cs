...
{
	public partial class CmoSeriesSonificationContextTracksPointGrouping  : BaseObject
	{
		Hashtable h = new Hashtable();

		public CmoSeriesSonificationContextTracksPointGrouping()
		{
			Algorithm = Algorithm_DefaultValue = CmoSeriesSonificationContextTracksPointGroupingAlgorithm.Minimax;
		...
		/// </summary>
		public CmoSeriesSonificationContextTracksPointGroupingAlgorithm Algorithm { get; set; }
		private CmoSeriesSonificationContextTracksPointGroupingAlgorithm Algorithm_DefaultValue { get; set; }
