...
{
	public partial class CmoSeriesStatesHover  : BaseObject
	{
		Hashtable h = new Hashtable();

		public CmoSeriesStatesHover()
		{
			Animation = Animation_DefaultValue = new Animation() { Enabled = true };
			Enabled = Enabled_DefaultValue = null;
			Halo = Halo_DefaultValue = new CmoSeriesStatesHoverHalo();
			LineWidth = LineWidth_DefaultValue = null;
			LineWidthPlus = LineWidthPlus_DefaultValue = null;
			Marker = Marker_DefaultValue = new CmoSeriesStatesHoverMarker();
		...
		/// </summary>
		public CmoSeriesStatesHoverHalo Halo { get; set; }
		private CmoSeriesStatesHoverHalo Halo_DefaultValue { get; set; }
		...
		/// </summary>
		public CmoSeriesStatesHoverMarker Marker { get; set; }
		private CmoSeriesStatesHoverMarker Marker_DefaultValue { get; set; }
