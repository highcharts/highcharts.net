...
{
	public partial class CmoSeriesStatesHoverMarker  : BaseObject
	{
		Hashtable h = new Hashtable();

		public CmoSeriesStatesHoverMarker()
		{
			...
			States = States_DefaultValue = new CmoSeriesStatesHoverMarkerStates();
		...
		/// </summary>
		public CmoSeriesStatesHoverMarkerStates States { get; set; }
		private CmoSeriesStatesHoverMarkerStates States_DefaultValue { get; set; }
