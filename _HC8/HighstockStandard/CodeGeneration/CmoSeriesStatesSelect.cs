...
{
	public partial class CmoSeriesStatesSelect  : BaseObject
	{
		Hashtable h = new Hashtable();

		public CmoSeriesStatesSelect()
		{
			Animation = Animation_DefaultValue = new Animation() { Enabled = true };
			Enabled = Enabled_DefaultValue = null;
			Halo = Halo_DefaultValue = new CmoSeriesStatesSelectHalo();
			LineWidth = LineWidth_DefaultValue = null;
			LineWidthPlus = LineWidthPlus_DefaultValue = null;
			Marker = Marker_DefaultValue = new CmoSeriesStatesSelectMarker();
		...
		/// </summary>
		public CmoSeriesStatesSelectHalo Halo { get; set; }
		private CmoSeriesStatesSelectHalo Halo_DefaultValue { get; set; }
		...
		/// </summary>
		public CmoSeriesStatesSelectMarker Marker { get; set; }
		private CmoSeriesStatesSelectMarker Marker_DefaultValue { get; set; }
