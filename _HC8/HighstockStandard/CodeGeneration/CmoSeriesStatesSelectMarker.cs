...
{
	public partial class CmoSeriesStatesSelectMarker  : BaseObject
	{
		Hashtable h = new Hashtable();

		public CmoSeriesStatesSelectMarker()
		{
			...
			States = States_DefaultValue = new CmoSeriesStatesSelectMarkerStates();
		...
		/// </summary>
		public CmoSeriesStatesSelectMarkerStates States { get; set; }
		private CmoSeriesStatesSelectMarkerStates States_DefaultValue { get; set; }
