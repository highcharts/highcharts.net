...
{
	public partial class CmoSeriesTooltip  : BaseObject
	{
		Hashtable h = new Hashtable();

		public CmoSeriesTooltip()
		{
			...
			HeaderShape = HeaderShape_DefaultValue = CmoSeriesTooltipHeaderShape.Callout;
		...
		/// </summary>
		public CmoSeriesTooltipHeaderShape HeaderShape { get; set; }
		private CmoSeriesTooltipHeaderShape HeaderShape_DefaultValue { get; set; }
