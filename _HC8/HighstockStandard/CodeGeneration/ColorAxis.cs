...
namespace Highsoft.Web.Mvc.Stocks
{
	public partial class ColorAxis  : BaseObject
	{
		...
		internal override Hashtable ToHashtable(ref Highstock highstock)
		{
			...
			if (PlotBands.IsDirty(ref highstock)) h.Add("plotBands",PlotBands.ToHashtable(ref highstock));
			if (PlotLines.IsDirty(ref highstock)) h.Add("plotLines",PlotLines.ToHashtable(ref highstock));
