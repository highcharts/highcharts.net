...
namespace Highsoft.Web.Mvc.Stocks
{
	public partial class ColorAxis  : BaseObject
	{
		...
		internal override Hashtable ToHashtable(Highstock highstock)
		{
			...
			if (PlotBands.IsDirty(highstock)) h.Add("plotBands",PlotBands.ToHashtable(highstock));
			if (PlotLines.IsDirty(highstock)) h.Add("plotLines",PlotLines.ToHashtable(highstock));
