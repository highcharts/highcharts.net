...
namespace Highsoft.Web.Mvc.Stocks
{
	public partial class ColorAxis  : BaseObject
	{
		...
		/// </summary>
		public ColorAxisScrollbar Scrollbar { get; set; }
		private ColorAxisScrollbar Scrollbar_DefaultValue { get; set; }
		...
		internal override Hashtable ToHashtable()
		{
			...
			if (Stops.Any()) h.Add("stops", HashifyList(Stops));
			...
			if (TickPositioner != TickPositioner_DefaultValue) { h.Add("tickPositioner",TickPositioner); Highstock.AddFunction("ColorAxisTickPositioner.tickPositioner", TickPositioner); }  
