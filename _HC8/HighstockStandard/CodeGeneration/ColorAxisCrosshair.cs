...
{
	public partial class ColorAxisCrosshair  : BaseObject
	{
		Hashtable h = new Hashtable();

		public ColorAxisCrosshair()
		{
			ClassName = ClassName_DefaultValue = "";
			Color = Color_DefaultValue = "#cccccc";
			DashStyle = DashStyle_DefaultValue = ColorAxisCrosshairDashStyle.Null;
			Label = Label_DefaultValue = new ColorAxisCrosshairLabel();
		...
		/// </summary>
		public ColorAxisCrosshairDashStyle DashStyle { get; set; }
		private ColorAxisCrosshairDashStyle DashStyle_DefaultValue { get; set; }
		 

		/// <summary>
		/// A label on the axis next to the crosshair.In styled mode, the label is styled with the`.highcharts-crosshair-label` class.
		/// </summary>
		public ColorAxisCrosshairLabel Label { get; set; }
		private ColorAxisCrosshairLabel Label_DefaultValue { get; set; }
