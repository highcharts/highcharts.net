...
{
	public partial class ColorAxisCrosshairLabel  : BaseObject
	{
		Hashtable h = new Hashtable();

		public ColorAxisCrosshairLabel()
		{
			Align = Align_DefaultValue = ColorAxisCrosshairLabelAlign.Null;
		...
		/// </summary>
		public ColorAxisCrosshairLabelAlign Align { get; set; }
		private ColorAxisCrosshairLabelAlign Align_DefaultValue { get; set; }
		...
		internal override Hashtable ToHashtable()
		{
			...
			if (Formatter != Formatter_DefaultValue) { h.Add("formatter",Formatter); Highstock.AddFunction("ColorAxisCrosshairLabelFormatter.formatter", Formatter); }  
