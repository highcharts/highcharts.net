...
{
	public partial class ColorAxisPlotLines  : BaseObject
	{
		Hashtable h = new Hashtable();

		public ColorAxisPlotLines()
		{
			AcrossPanes = AcrossPanes_DefaultValue = true;
			ClassName = ClassName_DefaultValue = "";
			Color = Color_DefaultValue = "#999999";
			DashStyle = DashStyle_DefaultValue = ColorAxisPlotLinesDashStyle.Null;
		...
		/// </summary>
		public ColorAxisPlotLinesDashStyle DashStyle { get; set; }
		private ColorAxisPlotLinesDashStyle DashStyle_DefaultValue { get; set; }
		 

		/// <summary>
		/// An object defining mouse events for the plot line. Supportedproperties are `click`, `mouseover`, `mouseout`, `mousemove`.
		/// </summary>
		public ColorAxisPlotLinesEvents Events { get; set; }
		private ColorAxisPlotLinesEvents Events_DefaultValue { get; set; }
		...
		/// </summary>
		public ColorAxisPlotLinesLabel Label { get; set; }
		private ColorAxisPlotLinesLabel Label_DefaultValue { get; set; }
