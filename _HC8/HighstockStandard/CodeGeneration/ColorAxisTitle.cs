...
{
	public partial class ColorAxisTitle  : BaseObject
	{
		Hashtable h = new Hashtable();

		public ColorAxisTitle()
		{
			Align = Align_DefaultValue = ColorAxisTitleAlign.Middle;
			...
			TextAlign = TextAlign_DefaultValue = ColorAxisTitleTextAlign.Null;
		...
		/// </summary>
		public ColorAxisTitleAlign Align { get; set; }
		private ColorAxisTitleAlign Align_DefaultValue { get; set; }
		...
		/// </summary>
		public ColorAxisTitleTextAlign TextAlign { get; set; }
		private ColorAxisTitleTextAlign TextAlign_DefaultValue { get; set; }
