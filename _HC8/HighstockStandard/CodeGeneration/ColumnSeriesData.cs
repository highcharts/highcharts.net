...
namespace Highsoft.Web.Mvc.Stocks
{
	public partial class ColumnSeriesData  : BaseObject
	{
		...
		{
			Accessibility = Accessibility_DefaultValue = new ColumnSeriesDataAccessibility();
			...
			DashStyle = DashStyle_DefaultValue = ColumnSeriesDataDashStyle.Null;
			...
			Marker = Marker_DefaultValue = new ColumnSeriesDataMarker();
		...
		/// </summary>
		public ColumnSeriesDataAccessibility Accessibility { get; set; }
		private ColumnSeriesDataAccessibility Accessibility_DefaultValue { get; set; }
		...
		/// </summary>
		public ColumnSeriesDataDashStyle DashStyle { get; set; }
		private ColumnSeriesDataDashStyle DashStyle_DefaultValue { get; set; }
		...
		/// </summary>
		public ColumnSeriesDataMarker Marker { get; set; }
		private ColumnSeriesDataMarker Marker_DefaultValue { get; set; }
