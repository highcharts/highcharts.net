...
namespace Highsoft.Web.Mvc.Stocks
{
	public partial class ColumnSeriesDataLabels  : BaseObject
	{
		...
		internal override Hashtable ToHashtable()
		{
			...
			if (Formatter != Formatter_DefaultValue) { h.Add("formatter",Formatter); Highstock.AddFunction("ColumnSeriesDataLabelsFormatter.formatter", Formatter); }  
			...
			if (NullFormatter != NullFormatter_DefaultValue) { h.Add("nullFormatter",NullFormatter); Highstock.AddFunction("ColumnSeriesDataLabelsNullFormatter.nullFormatter", NullFormatter); }  
