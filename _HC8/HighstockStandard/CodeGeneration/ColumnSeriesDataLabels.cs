...
namespace Highsoft.Web.Mvc.Stocks
{
	public partial class ColumnSeriesDataLabels  : BaseObject
	{
		...
		public ColumnSeriesDataLabels()
		{
			...
			Overflow = Overflow_DefaultValue = ColumnSeriesDataLabelsOverflow.Justify;
			Padding = Padding_DefaultValue = 5;
			Position = Position_DefaultValue = ColumnSeriesDataLabelsPosition.Center;
		...
		/// </summary>
		public ColumnSeriesDataLabelsOverflow Overflow { get; set; }
		private ColumnSeriesDataLabelsOverflow Overflow_DefaultValue { get; set; }
		...
		/// </summary>
		public ColumnSeriesDataLabelsPosition Position { get; set; }
		private ColumnSeriesDataLabelsPosition Position_DefaultValue { get; set; }
