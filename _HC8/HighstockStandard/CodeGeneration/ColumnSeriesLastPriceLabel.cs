...
{
	public partial class ColumnSeriesLastPriceLabel  : BaseObject
	{
		Hashtable h = new Hashtable();

		public ColumnSeriesLastPriceLabel()
		{
			Align = Align_DefaultValue = ColumnSeriesLastPriceLabelAlign.Null;
		...
		/// 
		/// </summary>
		public ColumnSeriesLastPriceLabelAlign Align { get; set; }
		private ColumnSeriesLastPriceLabelAlign Align_DefaultValue { get; set; }
