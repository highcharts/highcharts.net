...
{
	public partial class ColumnSeriesLastVisiblePriceLabel  : BaseObject
	{
		Hashtable h = new Hashtable();

		public ColumnSeriesLastVisiblePriceLabel()
		{
			Align = Align_DefaultValue = ColumnSeriesLastVisiblePriceLabelAlign.Null;
		...
		/// 
		/// </summary>
		public ColumnSeriesLastVisiblePriceLabelAlign Align { get; set; }
		private ColumnSeriesLastVisiblePriceLabelAlign Align_DefaultValue { get; set; }
