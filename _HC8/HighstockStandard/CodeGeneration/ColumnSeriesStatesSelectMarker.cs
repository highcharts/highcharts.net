...
{
	public partial class ColumnSeriesStatesSelectMarker  : BaseObject
	{
		Hashtable h = new Hashtable();

		public ColumnSeriesStatesSelectMarker()
		{
			...
			States = States_DefaultValue = new ColumnSeriesStatesSelectMarkerStates();
		...
		/// </summary>
		public ColumnSeriesStatesSelectMarkerStates States { get; set; }
		private ColumnSeriesStatesSelectMarkerStates States_DefaultValue { get; set; }
