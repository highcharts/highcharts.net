...
namespace Highsoft.Web.Mvc.Stocks
{
	public partial class ColumnpyramidSeries  : Series
	{
		...
		public ColumnpyramidSeries()
		{
			...
			DashStyle = DashStyle_DefaultValue = ColumnpyramidSeriesDashStyle.Null;
			...
			Type = Type_DefaultValue = ColumnpyramidSeriesType.Null;
		...
		/// </summary>
		public ColumnpyramidSeriesDashStyle DashStyle { get; set; }
		private ColumnpyramidSeriesDashStyle DashStyle_DefaultValue { get; set; }
		...
		/// </summary>
		public ColumnpyramidSeriesType Type { get; set; }
		private ColumnpyramidSeriesType Type_DefaultValue { get; set; }
		...
		internal override Hashtable ToHashtable()
		{
			...
			if (PointDescriptionFormatter != PointDescriptionFormatter_DefaultValue) { h.Add("pointDescriptionFormatter",PointDescriptionFormatter); Highstock.AddFunction("ColumnpyramidSeriesPointDescriptionFormatter.pointDescriptionFormatter", PointDescriptionFormatter); }  
