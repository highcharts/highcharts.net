...
namespace Highsoft.Web.Mvc.Stocks
{
	public partial class ColumnpyramidSeriesDataLabels  : BaseObject
	{
		...
		public ColumnpyramidSeriesDataLabels()
		{
			...
			Overflow = Overflow_DefaultValue = ColumnpyramidSeriesDataLabelsOverflow.Justify;
			Padding = Padding_DefaultValue = 5;
			Position = Position_DefaultValue = ColumnpyramidSeriesDataLabelsPosition.Center;
		...
		/// </summary>
		public ColumnpyramidSeriesDataLabelsOverflow Overflow { get; set; }
		private ColumnpyramidSeriesDataLabelsOverflow Overflow_DefaultValue { get; set; }
		...
		/// </summary>
		public ColumnpyramidSeriesDataLabelsPosition Position { get; set; }
		private ColumnpyramidSeriesDataLabelsPosition Position_DefaultValue { get; set; }
