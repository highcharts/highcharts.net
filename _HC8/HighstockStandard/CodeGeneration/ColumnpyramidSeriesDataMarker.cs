...
{
	public partial class ColumnpyramidSeriesDataMarker  : BaseObject
	{
		Hashtable h = new Hashtable();

		public ColumnpyramidSeriesDataMarker()
		{
			...
			States = States_DefaultValue = new ColumnpyramidSeriesDataMarkerStates();
		...
		/// </summary>
		public ColumnpyramidSeriesDataMarkerStates States { get; set; }
		private ColumnpyramidSeriesDataMarkerStates States_DefaultValue { get; set; }
