...
{
	public partial class ColumnpyramidSeriesLastPriceLabel  : BaseObject
	{
		Hashtable h = new Hashtable();

		public ColumnpyramidSeriesLastPriceLabel()
		{
			Align = Align_DefaultValue = ColumnpyramidSeriesLastPriceLabelAlign.Null;
		...
		/// 
		/// </summary>
		public ColumnpyramidSeriesLastPriceLabelAlign Align { get; set; }
		private ColumnpyramidSeriesLastPriceLabelAlign Align_DefaultValue { get; set; }
