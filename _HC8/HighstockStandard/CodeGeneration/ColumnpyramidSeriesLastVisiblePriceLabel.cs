...
{
	public partial class ColumnpyramidSeriesLastVisiblePriceLabel  : BaseObject
	{
		Hashtable h = new Hashtable();

		public ColumnpyramidSeriesLastVisiblePriceLabel()
		{
			Align = Align_DefaultValue = ColumnpyramidSeriesLastVisiblePriceLabelAlign.Null;
		...
		/// 
		/// </summary>
		public ColumnpyramidSeriesLastVisiblePriceLabelAlign Align { get; set; }
		private ColumnpyramidSeriesLastVisiblePriceLabelAlign Align_DefaultValue { get; set; }
