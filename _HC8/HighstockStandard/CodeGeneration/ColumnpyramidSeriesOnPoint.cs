...
{
	public partial class ColumnpyramidSeriesOnPoint  : BaseObject
	{
		Hashtable h = new Hashtable();

		public ColumnpyramidSeriesOnPoint()
		{
			ConnectorOptions = ConnectorOptions_DefaultValue = new ColumnpyramidSeriesOnPointConnectorOptions();
			Id = Id_DefaultValue = "";
			Position = Position_DefaultValue = new ColumnpyramidSeriesOnPointPosition();
		...
		/// </summary>
		public ColumnpyramidSeriesOnPointConnectorOptions ConnectorOptions { get; set; }
		private ColumnpyramidSeriesOnPointConnectorOptions ConnectorOptions_DefaultValue { get; set; }
		...
		/// </summary>
		public ColumnpyramidSeriesOnPointPosition Position { get; set; }
		private ColumnpyramidSeriesOnPointPosition Position_DefaultValue { get; set; }
