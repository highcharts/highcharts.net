...
namespace Highsoft.Web.Mvc.Stocks
{
	public partial class ColumnpyramidSeriesSonification  : BaseObject
	{
		...
		{
			ContextTracks = ContextTracks_DefaultValue = new ColumnpyramidSeriesSonificationContextTracks();
			DefaultInstrumentOptions = DefaultInstrumentOptions_DefaultValue = new ColumnpyramidSeriesSonificationDefaultInstrumentOptions();
			DefaultSpeechOptions = DefaultSpeechOptions_DefaultValue = new ColumnpyramidSeriesSonificationDefaultSpeechOptions();
			Enabled = Enabled_DefaultValue = true;
			PointGrouping = PointGrouping_DefaultValue = new ColumnpyramidSeriesSonificationPointGrouping();
			Tracks = Tracks_DefaultValue = new ColumnpyramidSeriesSonificationTracks();
		...
		private ColumnpyramidSeriesSonificationContextTracks ContextTracks_DefaultValue { get; set; }
		...
		private ColumnpyramidSeriesSonificationDefaultInstrumentOptions DefaultInstrumentOptions_DefaultValue { get; set; }
		...
		private ColumnpyramidSeriesSonificationDefaultSpeechOptions DefaultSpeechOptions_DefaultValue { get; set; }
		...
		private ColumnpyramidSeriesSonificationPointGrouping PointGrouping_DefaultValue { get; set; }
		...
		private ColumnpyramidSeriesSonificationTracks Tracks_DefaultValue { get; set; }
