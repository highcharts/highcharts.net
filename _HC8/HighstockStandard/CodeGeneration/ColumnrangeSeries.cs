...
namespace Highsoft.Web.Mvc.Stocks
{
	public partial class ColumnrangeSeries  : Series
	{
		...
		public ColumnrangeSeries()
		{
			...
			Type = Type_DefaultValue = ColumnrangeSeriesType.Columnrange;
		...
		internal override Hashtable ToHashtable()
		{
			...
			if (PointDescriptionFormatter != PointDescriptionFormatter_DefaultValue) { h.Add("pointDescriptionFormatter",PointDescriptionFormatter); Highstock.AddFunction("ColumnrangeSeriesPointDescriptionFormatter.pointDescriptionFormatter", PointDescriptionFormatter); }  
