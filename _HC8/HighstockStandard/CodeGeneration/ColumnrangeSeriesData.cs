...
namespace Highsoft.Web.Mvc.Stocks
{
	public partial class ColumnrangeSeriesData  : BaseObject
	{
		...
		{
			Accessibility = Accessibility_DefaultValue = new ColumnrangeSeriesDataAccessibility();
			...
			DragDrop = DragDrop_DefaultValue = new ColumnrangeSeriesDataDragDrop();
			...
			Marker = Marker_DefaultValue = new ColumnrangeSeriesDataMarker();
		...
		/// </summary>
		public ColumnrangeSeriesDataAccessibility Accessibility { get; set; }
		private ColumnrangeSeriesDataAccessibility Accessibility_DefaultValue { get; set; }
		...
		/// </summary>
		public ColumnrangeSeriesDataDragDrop DragDrop { get; set; }
		private ColumnrangeSeriesDataDragDrop DragDrop_DefaultValue { get; set; }
		...
		/// </summary>
		public ColumnrangeSeriesDataMarker Marker { get; set; }
		private ColumnrangeSeriesDataMarker Marker_DefaultValue { get; set; }
