...
{
	public partial class ColumnrangeSeriesDragDrop  : BaseObject
	{
		Hashtable h = new Hashtable();

		public ColumnrangeSeriesDragDrop()
		{
			DraggableX = DraggableX_DefaultValue = null;
			DraggableY = DraggableY_DefaultValue = null;
			DragHandle = DragHandle_DefaultValue = new ColumnrangeSeriesDragDropDragHandle();
			...
			GuideBox = GuideBox_DefaultValue = new ColumnrangeSeriesDragDropGuideBox();
		...
		/// </summary>
		public ColumnrangeSeriesDragDropDragHandle DragHandle { get; set; }
		private ColumnrangeSeriesDragDropDragHandle DragHandle_DefaultValue { get; set; }
		...
		/// </summary>
		public ColumnrangeSeriesDragDropGuideBox GuideBox { get; set; }
		private ColumnrangeSeriesDragDropGuideBox GuideBox_DefaultValue { get; set; }
