...
{
	public partial class ColumnrangeSeriesLastPriceLabel  : BaseObject
	{
		Hashtable h = new Hashtable();

		public ColumnrangeSeriesLastPriceLabel()
		{
			Align = Align_DefaultValue = ColumnrangeSeriesLastPriceLabelAlign.Null;
		...
		/// 
		/// </summary>
		public ColumnrangeSeriesLastPriceLabelAlign Align { get; set; }
		private ColumnrangeSeriesLastPriceLabelAlign Align_DefaultValue { get; set; }
