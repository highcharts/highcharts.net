...
{
	public partial class ColumnrangeSeriesLastVisiblePriceLabel  : BaseObject
	{
		Hashtable h = new Hashtable();

		public ColumnrangeSeriesLastVisiblePriceLabel()
		{
			Align = Align_DefaultValue = ColumnrangeSeriesLastVisiblePriceLabelAlign.Null;
		...
		/// 
		/// </summary>
		public ColumnrangeSeriesLastVisiblePriceLabelAlign Align { get; set; }
		private ColumnrangeSeriesLastVisiblePriceLabelAlign Align_DefaultValue { get; set; }
