...
{
	public partial class ColumnrangeSeriesOnPoint  : BaseObject
	{
		Hashtable h = new Hashtable();

		public ColumnrangeSeriesOnPoint()
		{
			ConnectorOptions = ConnectorOptions_DefaultValue = new ColumnrangeSeriesOnPointConnectorOptions();
			Id = Id_DefaultValue = "";
			Position = Position_DefaultValue = new ColumnrangeSeriesOnPointPosition();
		...
		/// </summary>
		public ColumnrangeSeriesOnPointConnectorOptions ConnectorOptions { get; set; }
		private ColumnrangeSeriesOnPointConnectorOptions ConnectorOptions_DefaultValue { get; set; }
		...
		/// </summary>
		public ColumnrangeSeriesOnPointPosition Position { get; set; }
		private ColumnrangeSeriesOnPointPosition Position_DefaultValue { get; set; }
