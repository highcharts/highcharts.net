...
namespace Highsoft.Web.Mvc.Stocks
{
	public partial class ColumnrangeSeriesStatesSelect  : BaseObject
	{
		...
		public ColumnrangeSeriesStatesSelect()
		{
			...
			Halo = Halo_DefaultValue = new ColumnrangeSeriesStatesSelectHalo();
			LineWidth = LineWidth_DefaultValue = null;
			LineWidthPlus = LineWidthPlus_DefaultValue = null;
			Marker = Marker_DefaultValue = new ColumnrangeSeriesStatesSelectMarker();
		...
		/// </summary>
		public ColumnrangeSeriesStatesSelectHalo Halo { get; set; }
		private ColumnrangeSeriesStatesSelectHalo Halo_DefaultValue { get; set; }
		...
		/// </summary>
		public ColumnrangeSeriesStatesSelectMarker Marker { get; set; }
		private ColumnrangeSeriesStatesSelectMarker Marker_DefaultValue { get; set; }
