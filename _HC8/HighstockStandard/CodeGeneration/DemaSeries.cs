...
namespace Highsoft.Web.Mvc.Stocks
{
	public partial class DemaSeries  : Series
	{
		...
		public DemaSeries()
		{
			...
			DashStyle = DashStyle_DefaultValue = DemaSeriesDashStyle.Solid;
			...
			Type = Type_DefaultValue = DemaSeriesType.Dema;
		...
		/// </summary>
		public DemaSeriesType Type { get; set; }
		private DemaSeriesType Type_DefaultValue { get; set; }
		...
		internal override Hashtable ToHashtable()
		{
			...
			if (PointDescriptionFormatter != PointDescriptionFormatter_DefaultValue) { h.Add("pointDescriptionFormatter",PointDescriptionFormatter); Highstock.AddFunction("DemaSeriesPointDescriptionFormatter.pointDescriptionFormatter", PointDescriptionFormatter); }  
