...
{
	public partial class DemaSeriesDataLabels  : BaseObject
	{
		Hashtable h = new Hashtable();

		public DemaSeriesDataLabels()
		{
			Align = Align_DefaultValue = DemaSeriesDataLabelsAlign.Center;
			...
			Filter = Filter_DefaultValue = new DemaSeriesDataLabelsFilter();
			...
			Overflow = Overflow_DefaultValue = DemaSeriesDataLabelsOverflow.Justify;
			Padding = Padding_DefaultValue = 5;
			Position = Position_DefaultValue = DemaSeriesDataLabelsPosition.Center;
			...
			TextPath = TextPath_DefaultValue = new DemaSeriesDataLabelsTextPath();
			UseHTML = UseHTML_DefaultValue = false;
			VerticalAlign = VerticalAlign_DefaultValue = DemaSeriesDataLabelsVerticalAlign.Bottom;
			X = X_DefaultValue = 0;
			Y = Y_DefaultValue = 0;
			Z = Z_DefaultValue = 6;
		...
		/// </summary>
		public DemaSeriesDataLabelsAlign Align { get; set; }
		private DemaSeriesDataLabelsAlign Align_DefaultValue { get; set; }
		...
		/// </summary>
		public DemaSeriesDataLabelsFilter Filter { get; set; }
		private DemaSeriesDataLabelsFilter Filter_DefaultValue { get; set; }
		...
		/// </summary>
		public DemaSeriesDataLabelsOverflow Overflow { get; set; }
		private DemaSeriesDataLabelsOverflow Overflow_DefaultValue { get; set; }
		...
		/// </summary>
		public DemaSeriesDataLabelsPosition Position { get; set; }
		private DemaSeriesDataLabelsPosition Position_DefaultValue { get; set; }
		...
		/// </summary>
		public DemaSeriesDataLabelsTextPath TextPath { get; set; }
		private DemaSeriesDataLabelsTextPath TextPath_DefaultValue { get; set; }
		...
		/// </summary>
		public DemaSeriesDataLabelsVerticalAlign VerticalAlign { get; set; }
		private DemaSeriesDataLabelsVerticalAlign VerticalAlign_DefaultValue { get; set; }
