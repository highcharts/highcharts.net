...
{
	public partial class DemaSeriesLastPriceLabel  : BaseObject
	{
		Hashtable h = new Hashtable();

		public DemaSeriesLastPriceLabel()
		{
			Align = Align_DefaultValue = DemaSeriesLastPriceLabelAlign.Null;
		...
		/// 
		/// </summary>
		public DemaSeriesLastPriceLabelAlign Align { get; set; }
		private DemaSeriesLastPriceLabelAlign Align_DefaultValue { get; set; }
