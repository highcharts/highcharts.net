...
{
	public partial class DemaSeriesLastVisiblePriceLabel  : BaseObject
	{
		Hashtable h = new Hashtable();

		public DemaSeriesLastVisiblePriceLabel()
		{
			Align = Align_DefaultValue = DemaSeriesLastVisiblePriceLabelAlign.Null;
		...
		/// 
		/// </summary>
		public DemaSeriesLastVisiblePriceLabelAlign Align { get; set; }
		private DemaSeriesLastVisiblePriceLabelAlign Align_DefaultValue { get; set; }
