...
{
	public partial class DemaSeriesMarker  : BaseObject
	{
		Hashtable h = new Hashtable();

		public DemaSeriesMarker()
		{
			...
			States = States_DefaultValue = new DemaSeriesMarkerStates();
		...
		/// </summary>
		public DemaSeriesMarkerStates States { get; set; }
		private DemaSeriesMarkerStates States_DefaultValue { get; set; }
