...
{
	public partial class DemaSeriesOnPoint  : BaseObject
	{
		Hashtable h = new Hashtable();

		public DemaSeriesOnPoint()
		{
			ConnectorOptions = ConnectorOptions_DefaultValue = new DemaSeriesOnPointConnectorOptions();
			Id = Id_DefaultValue = "";
			Position = Position_DefaultValue = new DemaSeriesOnPointPosition();
		...
		/// </summary>
		public DemaSeriesOnPointConnectorOptions ConnectorOptions { get; set; }
		private DemaSeriesOnPointConnectorOptions ConnectorOptions_DefaultValue { get; set; }
		...
		/// </summary>
		public DemaSeriesOnPointPosition Position { get; set; }
		private DemaSeriesOnPointPosition Position_DefaultValue { get; set; }
