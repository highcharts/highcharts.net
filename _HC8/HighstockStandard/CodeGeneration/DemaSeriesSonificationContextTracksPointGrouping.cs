...
{
	public partial class DemaSeriesSonificationContextTracksPointGrouping  : BaseObject
	{
		Hashtable h = new Hashtable();

		public DemaSeriesSonificationContextTracksPointGrouping()
		{
			Algorithm = Algorithm_DefaultValue = DemaSeriesSonificationContextTracksPointGroupingAlgorithm.Minimax;
		...
		/// </summary>
		public DemaSeriesSonificationContextTracksPointGroupingAlgorithm Algorithm { get; set; }
		private DemaSeriesSonificationContextTracksPointGroupingAlgorithm Algorithm_DefaultValue { get; set; }
