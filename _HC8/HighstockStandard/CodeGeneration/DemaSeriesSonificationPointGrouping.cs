...
{
	public partial class DemaSeriesSonificationPointGrouping  : BaseObject
	{
		Hashtable h = new Hashtable();

		public DemaSeriesSonificationPointGrouping()
		{
			Algorithm = Algorithm_DefaultValue = DemaSeriesSonificationPointGroupingAlgorithm.Minimax;
		...
		/// </summary>
		public DemaSeriesSonificationPointGroupingAlgorithm Algorithm { get; set; }
		private DemaSeriesSonificationPointGroupingAlgorithm Algorithm_DefaultValue { get; set; }
