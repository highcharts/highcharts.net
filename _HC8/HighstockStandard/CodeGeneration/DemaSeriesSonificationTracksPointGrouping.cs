...
{
	public partial class DemaSeriesSonificationTracksPointGrouping  : BaseObject
	{
		Hashtable h = new Hashtable();

		public DemaSeriesSonificationTracksPointGrouping()
		{
			Algorithm = Algorithm_DefaultValue = DemaSeriesSonificationTracksPointGroupingAlgorithm.Minimax;
		...
		/// </summary>
		public DemaSeriesSonificationTracksPointGroupingAlgorithm Algorithm { get; set; }
		private DemaSeriesSonificationTracksPointGroupingAlgorithm Algorithm_DefaultValue { get; set; }
