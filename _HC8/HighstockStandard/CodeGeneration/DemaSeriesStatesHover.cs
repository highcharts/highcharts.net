...
{
	public partial class DemaSeriesStatesHover  : BaseObject
	{
		Hashtable h = new Hashtable();

		public DemaSeriesStatesHover()
		{
			Animation = Animation_DefaultValue = new Animation() { Enabled = true };
			Enabled = Enabled_DefaultValue = null;
			Halo = Halo_DefaultValue = new DemaSeriesStatesHoverHalo();
			LineWidth = LineWidth_DefaultValue = null;
			LineWidthPlus = LineWidthPlus_DefaultValue = null;
			Marker = Marker_DefaultValue = new DemaSeriesStatesHoverMarker();
		...
		/// </summary>
		public DemaSeriesStatesHoverHalo Halo { get; set; }
		private DemaSeriesStatesHoverHalo Halo_DefaultValue { get; set; }
		...
		/// </summary>
		public DemaSeriesStatesHoverMarker Marker { get; set; }
		private DemaSeriesStatesHoverMarker Marker_DefaultValue { get; set; }
