...
{
	public partial class DemaSeriesStatesSelect  : BaseObject
	{
		Hashtable h = new Hashtable();

		public DemaSeriesStatesSelect()
		{
			Animation = Animation_DefaultValue = new Animation() { Enabled = true };
			Enabled = Enabled_DefaultValue = null;
			Halo = Halo_DefaultValue = new DemaSeriesStatesSelectHalo();
			LineWidth = LineWidth_DefaultValue = null;
			LineWidthPlus = LineWidthPlus_DefaultValue = null;
			Marker = Marker_DefaultValue = new DemaSeriesStatesSelectMarker();
		...
		/// </summary>
		public DemaSeriesStatesSelectHalo Halo { get; set; }
		private DemaSeriesStatesSelectHalo Halo_DefaultValue { get; set; }
		...
		/// </summary>
		public DemaSeriesStatesSelectMarker Marker { get; set; }
		private DemaSeriesStatesSelectMarker Marker_DefaultValue { get; set; }
