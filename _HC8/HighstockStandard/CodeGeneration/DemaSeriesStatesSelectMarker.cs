...
{
	public partial class DemaSeriesStatesSelectMarker  : BaseObject
	{
		Hashtable h = new Hashtable();

		public DemaSeriesStatesSelectMarker()
		{
			...
			States = States_DefaultValue = new DemaSeriesStatesSelectMarkerStates();
		...
		/// </summary>
		public DemaSeriesStatesSelectMarkerStates States { get; set; }
		private DemaSeriesStatesSelectMarkerStates States_DefaultValue { get; set; }
