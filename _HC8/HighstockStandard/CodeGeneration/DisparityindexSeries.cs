...
namespace Highsoft.Web.Mvc.Stocks
{
	public partial class DisparityindexSeries  : Series
	{
		...
		public DisparityindexSeries()
		{
			...
			Type = Type_DefaultValue = DisparityindexSeriesType.Null;
		...
		/// </summary>
		public DisparityindexSeriesType Type { get; set; }
		private DisparityindexSeriesType Type_DefaultValue { get; set; }
