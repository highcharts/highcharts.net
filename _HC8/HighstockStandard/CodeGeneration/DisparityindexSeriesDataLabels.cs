...
{
	public partial class DisparityindexSeriesDataLabels  : BaseObject
	{
		Hashtable h = new Hashtable();

		public DisparityindexSeriesDataLabels()
		{
			Align = Align_DefaultValue = DisparityindexSeriesDataLabelsAlign.Center;
			...
			Filter = Filter_DefaultValue = new DisparityindexSeriesDataLabelsFilter();
			...
			Overflow = Overflow_DefaultValue = DisparityindexSeriesDataLabelsOverflow.Justify;
			Padding = Padding_DefaultValue = 5;
			Position = Position_DefaultValue = DisparityindexSeriesDataLabelsPosition.Center;
			...
			TextPath = TextPath_DefaultValue = new DisparityindexSeriesDataLabelsTextPath();
			UseHTML = UseHTML_DefaultValue = false;
			VerticalAlign = VerticalAlign_DefaultValue = DisparityindexSeriesDataLabelsVerticalAlign.Bottom;
			X = X_DefaultValue = 0;
			Y = Y_DefaultValue = 0;
			Z = Z_DefaultValue = 6;
		...
		/// </summary>
		public DisparityindexSeriesDataLabelsAlign Align { get; set; }
		private DisparityindexSeriesDataLabelsAlign Align_DefaultValue { get; set; }
		...
		/// </summary>
		public DisparityindexSeriesDataLabelsFilter Filter { get; set; }
		private DisparityindexSeriesDataLabelsFilter Filter_DefaultValue { get; set; }
		...
		/// </summary>
		public DisparityindexSeriesDataLabelsOverflow Overflow { get; set; }
		private DisparityindexSeriesDataLabelsOverflow Overflow_DefaultValue { get; set; }
		...
		/// </summary>
		public DisparityindexSeriesDataLabelsPosition Position { get; set; }
		private DisparityindexSeriesDataLabelsPosition Position_DefaultValue { get; set; }
		...
		/// </summary>
		public DisparityindexSeriesDataLabelsTextPath TextPath { get; set; }
		private DisparityindexSeriesDataLabelsTextPath TextPath_DefaultValue { get; set; }
		...
		/// </summary>
		public DisparityindexSeriesDataLabelsVerticalAlign VerticalAlign { get; set; }
		private DisparityindexSeriesDataLabelsVerticalAlign VerticalAlign_DefaultValue { get; set; }
