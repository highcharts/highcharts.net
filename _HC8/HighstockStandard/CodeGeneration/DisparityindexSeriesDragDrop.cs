...
{
	public partial class DisparityindexSeriesDragDrop  : BaseObject
	{
		Hashtable h = new Hashtable();

		public DisparityindexSeriesDragDrop()
		{
			...
			GuideBox = GuideBox_DefaultValue = new DisparityindexSeriesDragDropGuideBox();
		...
		/// </summary>
		public DisparityindexSeriesDragDropGuideBox GuideBox { get; set; }
		private DisparityindexSeriesDragDropGuideBox GuideBox_DefaultValue { get; set; }
