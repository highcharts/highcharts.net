...
{
	public partial class DisparityindexSeriesLastPriceLabel  : BaseObject
	{
		Hashtable h = new Hashtable();

		public DisparityindexSeriesLastPriceLabel()
		{
			Align = Align_DefaultValue = DisparityindexSeriesLastPriceLabelAlign.Null;
		...
		/// 
		/// </summary>
		public DisparityindexSeriesLastPriceLabelAlign Align { get; set; }
		private DisparityindexSeriesLastPriceLabelAlign Align_DefaultValue { get; set; }
