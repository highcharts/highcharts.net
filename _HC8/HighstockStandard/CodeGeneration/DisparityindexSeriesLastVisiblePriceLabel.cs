...
{
	public partial class DisparityindexSeriesLastVisiblePriceLabel  : BaseObject
	{
		Hashtable h = new Hashtable();

		public DisparityindexSeriesLastVisiblePriceLabel()
		{
			Align = Align_DefaultValue = DisparityindexSeriesLastVisiblePriceLabelAlign.Null;
		...
		/// 
		/// </summary>
		public DisparityindexSeriesLastVisiblePriceLabelAlign Align { get; set; }
		private DisparityindexSeriesLastVisiblePriceLabelAlign Align_DefaultValue { get; set; }
