...
{
	public partial class DisparityindexSeriesMarker  : BaseObject
	{
		Hashtable h = new Hashtable();

		public DisparityindexSeriesMarker()
		{
			...
			States = States_DefaultValue = new DisparityindexSeriesMarkerStates();
		...
		/// </summary>
		public DisparityindexSeriesMarkerStates States { get; set; }
		private DisparityindexSeriesMarkerStates States_DefaultValue { get; set; }
