...
{
	public partial class DisparityindexSeriesOnPoint  : BaseObject
	{
		Hashtable h = new Hashtable();

		public DisparityindexSeriesOnPoint()
		{
			ConnectorOptions = ConnectorOptions_DefaultValue = new DisparityindexSeriesOnPointConnectorOptions();
			Id = Id_DefaultValue = "";
			Position = Position_DefaultValue = new DisparityindexSeriesOnPointPosition();
		...
		/// </summary>
		public DisparityindexSeriesOnPointConnectorOptions ConnectorOptions { get; set; }
		private DisparityindexSeriesOnPointConnectorOptions ConnectorOptions_DefaultValue { get; set; }
		...
		/// </summary>
		public DisparityindexSeriesOnPointPosition Position { get; set; }
		private DisparityindexSeriesOnPointPosition Position_DefaultValue { get; set; }
