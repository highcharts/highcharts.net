...
{
	public partial class DisparityindexSeriesSonificationContextTracksPointGrouping  : BaseObject
	{
		Hashtable h = new Hashtable();

		public DisparityindexSeriesSonificationContextTracksPointGrouping()
		{
			Algorithm = Algorithm_DefaultValue = DisparityindexSeriesSonificationContextTracksPointGroupingAlgorithm.Minimax;
		...
		/// </summary>
		public DisparityindexSeriesSonificationContextTracksPointGroupingAlgorithm Algorithm { get; set; }
		private DisparityindexSeriesSonificationContextTracksPointGroupingAlgorithm Algorithm_DefaultValue { get; set; }
