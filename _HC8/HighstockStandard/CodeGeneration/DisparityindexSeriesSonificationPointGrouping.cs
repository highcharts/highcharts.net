...
{
	public partial class DisparityindexSeriesSonificationPointGrouping  : BaseObject
	{
		Hashtable h = new Hashtable();

		public DisparityindexSeriesSonificationPointGrouping()
		{
			Algorithm = Algorithm_DefaultValue = DisparityindexSeriesSonificationPointGroupingAlgorithm.Minimax;
		...
		/// </summary>
		public DisparityindexSeriesSonificationPointGroupingAlgorithm Algorithm { get; set; }
		private DisparityindexSeriesSonificationPointGroupingAlgorithm Algorithm_DefaultValue { get; set; }
