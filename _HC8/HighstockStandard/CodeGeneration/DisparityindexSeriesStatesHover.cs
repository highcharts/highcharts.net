...
{
	public partial class DisparityindexSeriesStatesHover  : BaseObject
	{
		Hashtable h = new Hashtable();

		public DisparityindexSeriesStatesHover()
		{
			Animation = Animation_DefaultValue = new Animation() { Enabled = true };
			Enabled = Enabled_DefaultValue = null;
			Halo = Halo_DefaultValue = new DisparityindexSeriesStatesHoverHalo();
			LineWidth = LineWidth_DefaultValue = null;
			LineWidthPlus = LineWidthPlus_DefaultValue = null;
			Marker = Marker_DefaultValue = new DisparityindexSeriesStatesHoverMarker();
		...
		/// </summary>
		public DisparityindexSeriesStatesHoverHalo Halo { get; set; }
		private DisparityindexSeriesStatesHoverHalo Halo_DefaultValue { get; set; }
		...
		/// </summary>
		public DisparityindexSeriesStatesHoverMarker Marker { get; set; }
		private DisparityindexSeriesStatesHoverMarker Marker_DefaultValue { get; set; }
