...
{
	public partial class DisparityindexSeriesStatesHoverMarker  : BaseObject
	{
		Hashtable h = new Hashtable();

		public DisparityindexSeriesStatesHoverMarker()
		{
			...
			States = States_DefaultValue = new DisparityindexSeriesStatesHoverMarkerStates();
		...
		/// </summary>
		public DisparityindexSeriesStatesHoverMarkerStates States { get; set; }
		private DisparityindexSeriesStatesHoverMarkerStates States_DefaultValue { get; set; }
