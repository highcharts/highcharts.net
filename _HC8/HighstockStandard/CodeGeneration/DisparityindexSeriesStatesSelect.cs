...
{
	public partial class DisparityindexSeriesStatesSelect  : BaseObject
	{
		Hashtable h = new Hashtable();

		public DisparityindexSeriesStatesSelect()
		{
			Animation = Animation_DefaultValue = new Animation() { Enabled = true };
			Enabled = Enabled_DefaultValue = null;
			Halo = Halo_DefaultValue = new DisparityindexSeriesStatesSelectHalo();
			LineWidth = LineWidth_DefaultValue = null;
			LineWidthPlus = LineWidthPlus_DefaultValue = null;
			Marker = Marker_DefaultValue = new DisparityindexSeriesStatesSelectMarker();
		...
		/// </summary>
		public DisparityindexSeriesStatesSelectHalo Halo { get; set; }
		private DisparityindexSeriesStatesSelectHalo Halo_DefaultValue { get; set; }
		...
		/// </summary>
		public DisparityindexSeriesStatesSelectMarker Marker { get; set; }
		private DisparityindexSeriesStatesSelectMarker Marker_DefaultValue { get; set; }
