...
{
	public partial class DisparityindexSeriesStatesSelectMarker  : BaseObject
	{
		Hashtable h = new Hashtable();

		public DisparityindexSeriesStatesSelectMarker()
		{
			...
			States = States_DefaultValue = new DisparityindexSeriesStatesSelectMarkerStates();
		...
		/// </summary>
		public DisparityindexSeriesStatesSelectMarkerStates States { get; set; }
		private DisparityindexSeriesStatesSelectMarkerStates States_DefaultValue { get; set; }
