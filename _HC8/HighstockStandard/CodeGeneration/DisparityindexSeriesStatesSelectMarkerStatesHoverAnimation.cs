...
{
	public partial class DisparityindexSeriesStatesSelectMarkerStatesHoverAnimation  : BaseObject
	{
		Hashtable h = new Hashtable();

		public DisparityindexSeriesStatesSelectMarkerStatesHoverAnimation()
		{
