...
{
	public partial class DisparityindexSeriesTooltip  : BaseObject
	{
		Hashtable h = new Hashtable();

		public DisparityindexSeriesTooltip()
		{
			...
			HeaderShape = HeaderShape_DefaultValue = DisparityindexSeriesTooltipHeaderShape.Callout;
		...
		/// </summary>
		public DisparityindexSeriesTooltipHeaderShape HeaderShape { get; set; }
		private DisparityindexSeriesTooltipHeaderShape HeaderShape_DefaultValue { get; set; }
