...
{
	public partial class DmiSeriesDataLabels  : BaseObject
	{
		Hashtable h = new Hashtable();

		public DmiSeriesDataLabels()
		{
			Align = Align_DefaultValue = DmiSeriesDataLabelsAlign.Center;
			...
			Filter = Filter_DefaultValue = new DmiSeriesDataLabelsFilter();
			...
			Overflow = Overflow_DefaultValue = DmiSeriesDataLabelsOverflow.Justify;
			Padding = Padding_DefaultValue = 5;
			Position = Position_DefaultValue = DmiSeriesDataLabelsPosition.Center;
			...
			TextPath = TextPath_DefaultValue = new DmiSeriesDataLabelsTextPath();
			UseHTML = UseHTML_DefaultValue = false;
			VerticalAlign = VerticalAlign_DefaultValue = DmiSeriesDataLabelsVerticalAlign.Bottom;
			X = X_DefaultValue = 0;
			Y = Y_DefaultValue = 0;
			Z = Z_DefaultValue = 6;
		...
		/// </summary>
		public DmiSeriesDataLabelsAlign Align { get; set; }
		private DmiSeriesDataLabelsAlign Align_DefaultValue { get; set; }
		...
		/// </summary>
		public DmiSeriesDataLabelsFilter Filter { get; set; }
		private DmiSeriesDataLabelsFilter Filter_DefaultValue { get; set; }
		...
		/// </summary>
		public DmiSeriesDataLabelsOverflow Overflow { get; set; }
		private DmiSeriesDataLabelsOverflow Overflow_DefaultValue { get; set; }
		...
		/// </summary>
		public DmiSeriesDataLabelsPosition Position { get; set; }
		private DmiSeriesDataLabelsPosition Position_DefaultValue { get; set; }
		...
		/// </summary>
		public DmiSeriesDataLabelsTextPath TextPath { get; set; }
		private DmiSeriesDataLabelsTextPath TextPath_DefaultValue { get; set; }
		...
		/// </summary>
		public DmiSeriesDataLabelsVerticalAlign VerticalAlign { get; set; }
		private DmiSeriesDataLabelsVerticalAlign VerticalAlign_DefaultValue { get; set; }
