...
{
	public partial class DmiSeriesDragDrop  : BaseObject
	{
		Hashtable h = new Hashtable();

		public DmiSeriesDragDrop()
		{
			...
			GuideBox = GuideBox_DefaultValue = new DmiSeriesDragDropGuideBox();
		...
		/// </summary>
		public DmiSeriesDragDropGuideBox GuideBox { get; set; }
		private DmiSeriesDragDropGuideBox GuideBox_DefaultValue { get; set; }
