...
{
	public partial class DmiSeriesLastPriceLabel  : BaseObject
	{
		Hashtable h = new Hashtable();

		public DmiSeriesLastPriceLabel()
		{
			Align = Align_DefaultValue = DmiSeriesLastPriceLabelAlign.Null;
		...
		/// 
		/// </summary>
		public DmiSeriesLastPriceLabelAlign Align { get; set; }
		private DmiSeriesLastPriceLabelAlign Align_DefaultValue { get; set; }
