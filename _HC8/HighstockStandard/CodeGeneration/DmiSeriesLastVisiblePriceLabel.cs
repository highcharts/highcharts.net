...
{
	public partial class DmiSeriesLastVisiblePriceLabel  : BaseObject
	{
		Hashtable h = new Hashtable();

		public DmiSeriesLastVisiblePriceLabel()
		{
			Align = Align_DefaultValue = DmiSeriesLastVisiblePriceLabelAlign.Null;
		...
		/// 
		/// </summary>
		public DmiSeriesLastVisiblePriceLabelAlign Align { get; set; }
		private DmiSeriesLastVisiblePriceLabelAlign Align_DefaultValue { get; set; }
