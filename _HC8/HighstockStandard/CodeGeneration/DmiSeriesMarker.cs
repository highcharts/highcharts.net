...
{
	public partial class DmiSeriesMarker  : BaseObject
	{
		Hashtable h = new Hashtable();

		public DmiSeriesMarker()
		{
			...
			States = States_DefaultValue = new DmiSeriesMarkerStates();
		...
		/// </summary>
		public DmiSeriesMarkerStates States { get; set; }
		private DmiSeriesMarkerStates States_DefaultValue { get; set; }
