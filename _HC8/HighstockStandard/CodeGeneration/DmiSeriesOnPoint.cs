...
{
	public partial class DmiSeriesOnPoint  : BaseObject
	{
		Hashtable h = new Hashtable();

		public DmiSeriesOnPoint()
		{
			ConnectorOptions = ConnectorOptions_DefaultValue = new DmiSeriesOnPointConnectorOptions();
			Id = Id_DefaultValue = "";
			Position = Position_DefaultValue = new DmiSeriesOnPointPosition();
		...
		/// </summary>
		public DmiSeriesOnPointConnectorOptions ConnectorOptions { get; set; }
		private DmiSeriesOnPointConnectorOptions ConnectorOptions_DefaultValue { get; set; }
		...
		/// </summary>
		public DmiSeriesOnPointPosition Position { get; set; }
		private DmiSeriesOnPointPosition Position_DefaultValue { get; set; }
