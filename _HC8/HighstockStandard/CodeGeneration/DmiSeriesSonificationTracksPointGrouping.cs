...
{
	public partial class DmiSeriesSonificationTracksPointGrouping  : BaseObject
	{
		Hashtable h = new Hashtable();

		public DmiSeriesSonificationTracksPointGrouping()
		{
			Algorithm = Algorithm_DefaultValue = DmiSeriesSonificationTracksPointGroupingAlgorithm.Minimax;
		...
		/// </summary>
		public DmiSeriesSonificationTracksPointGroupingAlgorithm Algorithm { get; set; }
		private DmiSeriesSonificationTracksPointGroupingAlgorithm Algorithm_DefaultValue { get; set; }
