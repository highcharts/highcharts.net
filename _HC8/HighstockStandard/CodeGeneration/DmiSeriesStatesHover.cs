...
{
	public partial class DmiSeriesStatesHover  : BaseObject
	{
		Hashtable h = new Hashtable();

		public DmiSeriesStatesHover()
		{
			Animation = Animation_DefaultValue = new Animation() { Enabled = true };
			Enabled = Enabled_DefaultValue = null;
			Halo = Halo_DefaultValue = new DmiSeriesStatesHoverHalo();
			LineWidth = LineWidth_DefaultValue = null;
			LineWidthPlus = LineWidthPlus_DefaultValue = null;
			Marker = Marker_DefaultValue = new DmiSeriesStatesHoverMarker();
		...
		/// </summary>
		public DmiSeriesStatesHoverHalo Halo { get; set; }
		private DmiSeriesStatesHoverHalo Halo_DefaultValue { get; set; }
		...
		/// </summary>
		public DmiSeriesStatesHoverMarker Marker { get; set; }
		private DmiSeriesStatesHoverMarker Marker_DefaultValue { get; set; }
