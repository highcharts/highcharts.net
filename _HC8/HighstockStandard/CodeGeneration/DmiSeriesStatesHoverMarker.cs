...
{
	public partial class DmiSeriesStatesHoverMarker  : BaseObject
	{
		Hashtable h = new Hashtable();

		public DmiSeriesStatesHoverMarker()
		{
			...
			States = States_DefaultValue = new DmiSeriesStatesHoverMarkerStates();
		...
		/// </summary>
		public DmiSeriesStatesHoverMarkerStates States { get; set; }
		private DmiSeriesStatesHoverMarkerStates States_DefaultValue { get; set; }
