...
{
	public partial class DmiSeriesStatesSelect  : BaseObject
	{
		Hashtable h = new Hashtable();

		public DmiSeriesStatesSelect()
		{
			Animation = Animation_DefaultValue = new Animation() { Enabled = true };
			Enabled = Enabled_DefaultValue = null;
			Halo = Halo_DefaultValue = new DmiSeriesStatesSelectHalo();
			LineWidth = LineWidth_DefaultValue = null;
			LineWidthPlus = LineWidthPlus_DefaultValue = null;
			Marker = Marker_DefaultValue = new DmiSeriesStatesSelectMarker();
		...
		/// </summary>
		public DmiSeriesStatesSelectHalo Halo { get; set; }
		private DmiSeriesStatesSelectHalo Halo_DefaultValue { get; set; }
		...
		/// </summary>
		public DmiSeriesStatesSelectMarker Marker { get; set; }
		private DmiSeriesStatesSelectMarker Marker_DefaultValue { get; set; }
