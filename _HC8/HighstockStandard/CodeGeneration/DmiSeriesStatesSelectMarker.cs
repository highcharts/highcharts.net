...
{
	public partial class DmiSeriesStatesSelectMarker  : BaseObject
	{
		Hashtable h = new Hashtable();

		public DmiSeriesStatesSelectMarker()
		{
			...
			States = States_DefaultValue = new DmiSeriesStatesSelectMarkerStates();
		...
		/// </summary>
		public DmiSeriesStatesSelectMarkerStates States { get; set; }
		private DmiSeriesStatesSelectMarkerStates States_DefaultValue { get; set; }
