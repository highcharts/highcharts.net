...
{
	public partial class DmiSeriesTooltip  : BaseObject
	{
		Hashtable h = new Hashtable();

		public DmiSeriesTooltip()
		{
			...
			HeaderShape = HeaderShape_DefaultValue = DmiSeriesTooltipHeaderShape.Callout;
		...
		/// </summary>
		public DmiSeriesTooltipHeaderShape HeaderShape { get; set; }
		private DmiSeriesTooltipHeaderShape HeaderShape_DefaultValue { get; set; }
