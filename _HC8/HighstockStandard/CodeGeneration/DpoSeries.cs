...
namespace Highsoft.Web.Mvc.Stocks
{
	public partial class DpoSeries  : Series
	{
		...
		public DpoSeries()
		{
			...
			DashStyle = DashStyle_DefaultValue = DpoSeriesDashStyle.Solid;
			...
			Type = Type_DefaultValue = DpoSeriesType.Dpo;
		...
		/// </summary>
		public DpoSeriesType Type { get; set; }
		private DpoSeriesType Type_DefaultValue { get; set; }
		...
		internal override Hashtable ToHashtable()
		{
			...
			if (PointDescriptionFormatter != PointDescriptionFormatter_DefaultValue) { h.Add("pointDescriptionFormatter",PointDescriptionFormatter); Highstock.AddFunction("DpoSeriesPointDescriptionFormatter.pointDescriptionFormatter", PointDescriptionFormatter); }  
