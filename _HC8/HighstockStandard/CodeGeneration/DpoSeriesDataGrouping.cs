...
namespace Highsoft.Web.Mvc.Stocks
{
	public partial class DpoSeriesDataGrouping  : BaseObject
	{
		...
		internal override Hashtable ToHashtable()
		{
			...
			if (Approximation != Approximation_DefaultValue) { h.Add("approximation",Approximation); Highstock.AddFunction("DpoSeriesDataGroupingApproximation.approximation", Approximation); }  
