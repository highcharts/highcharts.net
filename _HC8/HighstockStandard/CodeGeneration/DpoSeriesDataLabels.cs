...
{
	public partial class DpoSeriesDataLabels  : BaseObject
	{
		Hashtable h = new Hashtable();

		public DpoSeriesDataLabels()
		{
			Align = Align_DefaultValue = DpoSeriesDataLabelsAlign.Center;
			...
			Filter = Filter_DefaultValue = new DpoSeriesDataLabelsFilter();
			...
			Overflow = Overflow_DefaultValue = DpoSeriesDataLabelsOverflow.Justify;
			Padding = Padding_DefaultValue = 5;
			Position = Position_DefaultValue = DpoSeriesDataLabelsPosition.Center;
			...
			TextPath = TextPath_DefaultValue = new DpoSeriesDataLabelsTextPath();
			UseHTML = UseHTML_DefaultValue = false;
			VerticalAlign = VerticalAlign_DefaultValue = DpoSeriesDataLabelsVerticalAlign.Bottom;
			X = X_DefaultValue = 0;
			Y = Y_DefaultValue = 0;
			Z = Z_DefaultValue = 6;
		...
		/// </summary>
		public DpoSeriesDataLabelsAlign Align { get; set; }
		private DpoSeriesDataLabelsAlign Align_DefaultValue { get; set; }
		...
		/// </summary>
		public DpoSeriesDataLabelsFilter Filter { get; set; }
		private DpoSeriesDataLabelsFilter Filter_DefaultValue { get; set; }
		...
		/// </summary>
		public DpoSeriesDataLabelsOverflow Overflow { get; set; }
		private DpoSeriesDataLabelsOverflow Overflow_DefaultValue { get; set; }
		...
		/// </summary>
		public DpoSeriesDataLabelsPosition Position { get; set; }
		private DpoSeriesDataLabelsPosition Position_DefaultValue { get; set; }
		...
		/// </summary>
		public DpoSeriesDataLabelsTextPath TextPath { get; set; }
		private DpoSeriesDataLabelsTextPath TextPath_DefaultValue { get; set; }
		...
		/// </summary>
		public DpoSeriesDataLabelsVerticalAlign VerticalAlign { get; set; }
		private DpoSeriesDataLabelsVerticalAlign VerticalAlign_DefaultValue { get; set; }
