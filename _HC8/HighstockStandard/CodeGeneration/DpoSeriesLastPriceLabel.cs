...
{
	public partial class DpoSeriesLastPriceLabel  : BaseObject
	{
		Hashtable h = new Hashtable();

		public DpoSeriesLastPriceLabel()
		{
			Align = Align_DefaultValue = DpoSeriesLastPriceLabelAlign.Null;
		...
		/// 
		/// </summary>
		public DpoSeriesLastPriceLabelAlign Align { get; set; }
		private DpoSeriesLastPriceLabelAlign Align_DefaultValue { get; set; }
