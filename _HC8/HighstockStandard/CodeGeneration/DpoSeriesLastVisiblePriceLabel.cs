...
{
	public partial class DpoSeriesLastVisiblePriceLabel  : BaseObject
	{
		Hashtable h = new Hashtable();

		public DpoSeriesLastVisiblePriceLabel()
		{
			Align = Align_DefaultValue = DpoSeriesLastVisiblePriceLabelAlign.Null;
		...
		/// 
		/// </summary>
		public DpoSeriesLastVisiblePriceLabelAlign Align { get; set; }
		private DpoSeriesLastVisiblePriceLabelAlign Align_DefaultValue { get; set; }
