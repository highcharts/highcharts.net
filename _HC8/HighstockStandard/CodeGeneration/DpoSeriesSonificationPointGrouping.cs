...
{
	public partial class DpoSeriesSonificationPointGrouping  : BaseObject
	{
		Hashtable h = new Hashtable();

		public DpoSeriesSonificationPointGrouping()
		{
			Algorithm = Algorithm_DefaultValue = DpoSeriesSonificationPointGroupingAlgorithm.Minimax;
		...
		/// </summary>
		public DpoSeriesSonificationPointGroupingAlgorithm Algorithm { get; set; }
		private DpoSeriesSonificationPointGroupingAlgorithm Algorithm_DefaultValue { get; set; }
