...
{
	public partial class DpoSeriesStatesHover  : BaseObject
	{
		Hashtable h = new Hashtable();

		public DpoSeriesStatesHover()
		{
			Animation = Animation_DefaultValue = new Animation() { Enabled = true };
			Enabled = Enabled_DefaultValue = new Hashtable();
			Halo = Halo_DefaultValue = new DpoSeriesStatesHoverHalo();
			LineWidth = LineWidth_DefaultValue = new Hashtable();
			LineWidthPlus = LineWidthPlus_DefaultValue = new Hashtable();
			Marker = Marker_DefaultValue = new DpoSeriesStatesHoverMarker();
		...
		/// </summary>
		public DpoSeriesStatesHoverHalo Halo { get; set; }
		private DpoSeriesStatesHoverHalo Halo_DefaultValue { get; set; }
		...
		/// </summary>
		public DpoSeriesStatesHoverMarker Marker { get; set; }
		private DpoSeriesStatesHoverMarker Marker_DefaultValue { get; set; }
