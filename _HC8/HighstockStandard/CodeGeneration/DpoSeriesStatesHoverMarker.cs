...
{
	public partial class DpoSeriesStatesHoverMarker  : BaseObject
	{
		Hashtable h = new Hashtable();

		public DpoSeriesStatesHoverMarker()
		{
			...
			States = States_DefaultValue = new DpoSeriesStatesHoverMarkerStates();
		...
		/// </summary>
		public DpoSeriesStatesHoverMarkerStates States { get; set; }
		private DpoSeriesStatesHoverMarkerStates States_DefaultValue { get; set; }
