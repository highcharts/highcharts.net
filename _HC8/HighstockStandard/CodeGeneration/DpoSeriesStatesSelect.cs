...
{
	public partial class DpoSeriesStatesSelect  : BaseObject
	{
		Hashtable h = new Hashtable();

		public DpoSeriesStatesSelect()
		{
			Animation = Animation_DefaultValue = new Animation() { Enabled = true };
			Enabled = Enabled_DefaultValue = null;
			Halo = Halo_DefaultValue = new DpoSeriesStatesSelectHalo();
			LineWidth = LineWidth_DefaultValue = null;
			LineWidthPlus = LineWidthPlus_DefaultValue = null;
			Marker = Marker_DefaultValue = new DpoSeriesStatesSelectMarker();
		...
		/// </summary>
		public DpoSeriesStatesSelectHalo Halo { get; set; }
		private DpoSeriesStatesSelectHalo Halo_DefaultValue { get; set; }
		...
		/// </summary>
		public DpoSeriesStatesSelectMarker Marker { get; set; }
		private DpoSeriesStatesSelectMarker Marker_DefaultValue { get; set; }
