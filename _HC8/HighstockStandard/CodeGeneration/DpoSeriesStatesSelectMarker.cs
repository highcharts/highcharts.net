...
{
	public partial class DpoSeriesStatesSelectMarker  : BaseObject
	{
		Hashtable h = new Hashtable();

		public DpoSeriesStatesSelectMarker()
		{
			...
			States = States_DefaultValue = new DpoSeriesStatesSelectMarkerStates();
		...
		/// </summary>
		public DpoSeriesStatesSelectMarkerStates States { get; set; }
		private DpoSeriesStatesSelectMarkerStates States_DefaultValue { get; set; }
