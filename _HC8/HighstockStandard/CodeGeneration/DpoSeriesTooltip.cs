...
{
	public partial class DpoSeriesTooltip  : BaseObject
	{
		Hashtable h = new Hashtable();

		public DpoSeriesTooltip()
		{
			...
			HeaderShape = HeaderShape_DefaultValue = DpoSeriesTooltipHeaderShape.Callout;
		...
		/// </summary>
		public DpoSeriesTooltipHeaderShape HeaderShape { get; set; }
		private DpoSeriesTooltipHeaderShape HeaderShape_DefaultValue { get; set; }
		...
		internal override Hashtable ToHashtable()
		{
			...
			if (NullFormatter != NullFormatter_DefaultValue) { h.Add("nullFormatter",NullFormatter); Highstock.AddFunction("DpoSeriesTooltipNullFormatter.nullFormatter", NullFormatter); }  
			if (Outside != Outside_DefaultValue) h.Add("outside",Outside);
			if (Padding != Padding_DefaultValue) h.Add("padding",Padding);
			if (PointFormat != PointFormat_DefaultValue) h.Add("pointFormat",PointFormat);
			if (PointFormatter != PointFormatter_DefaultValue) { h.Add("pointFormatter",PointFormatter); Highstock.AddFunction("DpoSeriesTooltipPointFormatter.pointFormatter", PointFormatter); }  
