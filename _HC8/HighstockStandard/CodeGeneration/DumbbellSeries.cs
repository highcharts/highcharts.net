...
namespace Highsoft.Web.Mvc.Stocks
{
	public partial class DumbbellSeries  : Series
	{
		...
		public DumbbellSeries()
		{
			...
			Type = Type_DefaultValue = DumbbellSeriesType.Null;
		...
		/// </summary>
		public DumbbellSeriesType Type { get; set; }
		private DumbbellSeriesType Type_DefaultValue { get; set; }
		...
		internal override Hashtable ToHashtable()
		{
			...
			if (PointDescriptionFormatter != PointDescriptionFormatter_DefaultValue) { h.Add("pointDescriptionFormatter",PointDescriptionFormatter); Highstock.AddFunction("DumbbellSeriesPointDescriptionFormatter.pointDescriptionFormatter", PointDescriptionFormatter); }  
