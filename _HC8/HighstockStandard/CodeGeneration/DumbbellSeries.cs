...
namespace Highsoft.Web.Mvc.Stocks
{
	public partial class DumbbellSeries  : Series
	{
		...
		public DumbbellSeries()
		{
			...
			BoostBlending = BoostBlending_DefaultValue = DumbbellSeriesBoostBlending.Undefined;
			...
			Compare = Compare_DefaultValue = DumbbellSeriesCompare.Null;
			...
			Stacking = Stacking_DefaultValue = DumbbellSeriesStacking.Null;
			...
			Zones = Zones_DefaultValue = new List<DumbbellSeriesZone>();
		...
		/// </summary>
		public DumbbellSeriesBoostBlending BoostBlending { get; set; }
		private DumbbellSeriesBoostBlending BoostBlending_DefaultValue { get; set; }
		...
		/// </summary>
		public DumbbellSeriesStacking Stacking { get; set; }
		private DumbbellSeriesStacking Stacking_DefaultValue { get; set; }
		...
		/// </summary>
		public List<DumbbellSeriesZone> Zones { get; set; }
		private List<DumbbellSeriesZone> Zones_DefaultValue { get; set; }
