...
{
	public partial class DumbbellSeriesAccessibility  : BaseObject
	{
		...
		/// </summary>
		public DumbbellSeriesAccessibilityKeyboardNavigation KeyboardNavigation { get; set; }
		private DumbbellSeriesAccessibilityKeyboardNavigation KeyboardNavigation_DefaultValue { get; set; }
		...
		internal override Hashtable ToHashtable()
		{
			...
			if (PointDescriptionFormatter != PointDescriptionFormatter_DefaultValue) { h.Add("pointDescriptionFormatter",PointDescriptionFormatter); Highstock.AddFunction("DumbbellSeriesAccessibilityPointDescriptionFormatter.pointDescriptionFormatter", PointDescriptionFormatter); }  
