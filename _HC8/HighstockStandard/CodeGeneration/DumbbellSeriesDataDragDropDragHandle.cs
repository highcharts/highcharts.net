...
{
	public partial class DumbbellSeriesDataDragDropDragHandle  : BaseObject
	{
		Hashtable h = new Hashtable();

		public DumbbellSeriesDataDragDropDragHandle()
		{
		...
		internal override Hashtable ToHashtable()
		{
			...
			if (PathFormatter != PathFormatter_DefaultValue) { h.Add("pathFormatter",PathFormatter); Highstock.AddFunction("DumbbellSeriesDataDragDropDragHandlePathFormatter.pathFormatter", PathFormatter); }  
