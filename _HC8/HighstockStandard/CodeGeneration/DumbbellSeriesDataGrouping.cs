...
{
	public partial class DumbbellSeriesDataGrouping  : BaseObject
	{
		Hashtable h = new Hashtable();

		public DumbbellSeriesDataGrouping()
		{
		...
		internal override Hashtable ToHashtable()
		{
			...
			if (Approximation != Approximation_DefaultValue) { h.Add("approximation",Approximation); Highstock.AddFunction("DumbbellSeriesDataGroupingApproximation.approximation", Approximation); }  
