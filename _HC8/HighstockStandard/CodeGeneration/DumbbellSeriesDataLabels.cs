...
namespace Highsoft.Web.Mvc.Stocks
{
	public partial class DumbbellSeriesDataLabels  : BaseObject
	{
		...
		public DumbbellSeriesDataLabels()
		{
			...
			Overflow = Overflow_DefaultValue = DumbbellSeriesDataLabelsOverflow.Justify;
			Padding = Padding_DefaultValue = 5;
			Position = Position_DefaultValue = DumbbellSeriesDataLabelsPosition.Center;
		...
		/// </summary>
		public DumbbellSeriesDataLabelsOverflow Overflow { get; set; }
		private DumbbellSeriesDataLabelsOverflow Overflow_DefaultValue { get; set; }
		...
		/// </summary>
		public DumbbellSeriesDataLabelsPosition Position { get; set; }
		private DumbbellSeriesDataLabelsPosition Position_DefaultValue { get; set; }
