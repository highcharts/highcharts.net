...
{
	public partial class DumbbellSeriesDragDropDragHandle  : BaseObject
	{
		Hashtable h = new Hashtable();

		public DumbbellSeriesDragDropDragHandle()
		{
		...
		internal override Hashtable ToHashtable()
		{
			...
			if (PathFormatter != PathFormatter_DefaultValue) { h.Add("pathFormatter",PathFormatter); Highstock.AddFunction("DumbbellSeriesDragDropDragHandlePathFormatter.pathFormatter", PathFormatter); }  
