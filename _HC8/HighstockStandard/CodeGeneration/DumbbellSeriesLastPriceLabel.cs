...
{
	public partial class DumbbellSeriesLastPriceLabel  : BaseObject
	{
		Hashtable h = new Hashtable();

		public DumbbellSeriesLastPriceLabel()
		{
			Align = Align_DefaultValue = DumbbellSeriesLastPriceLabelAlign.Null;
		...
		/// 
		/// </summary>
		public DumbbellSeriesLastPriceLabelAlign Align { get; set; }
		private DumbbellSeriesLastPriceLabelAlign Align_DefaultValue { get; set; }
