...
{
	public partial class DumbbellSeriesMarker  : BaseObject
	{
		Hashtable h = new Hashtable();

		public DumbbellSeriesMarker()
		{
			...
			States = States_DefaultValue = new DumbbellSeriesMarkerStates();
		...
		/// </summary>
		public DumbbellSeriesMarkerStates States { get; set; }
		private DumbbellSeriesMarkerStates States_DefaultValue { get; set; }
