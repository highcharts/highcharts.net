...
{
	public partial class DumbbellSeriesStatesSelectMarker  : BaseObject
	{
		Hashtable h = new Hashtable();

		public DumbbellSeriesStatesSelectMarker()
		{
			...
			States = States_DefaultValue = new DumbbellSeriesStatesSelectMarkerStates();
		...
		/// </summary>
		public DumbbellSeriesStatesSelectMarkerStates States { get; set; }
		private DumbbellSeriesStatesSelectMarkerStates States_DefaultValue { get; set; }
