...
namespace Highsoft.Web.Mvc.Stocks
{
	public partial class EmaSeries  : Series
	{
		...
		public EmaSeries()
		{
			...
			DashStyle = DashStyle_DefaultValue = EmaSeriesDashStyle.Solid;
			...
			Type = Type_DefaultValue = EmaSeriesType.Ema;
		...
		/// </summary>
		public EmaSeriesType Type { get; set; }
		private EmaSeriesType Type_DefaultValue { get; set; }
		...
		internal override Hashtable ToHashtable()
		{
			...
			if (PointDescriptionFormatter != PointDescriptionFormatter_DefaultValue) { h.Add("pointDescriptionFormatter",PointDescriptionFormatter); Highstock.AddFunction("EmaSeriesPointDescriptionFormatter.pointDescriptionFormatter", PointDescriptionFormatter); }  
