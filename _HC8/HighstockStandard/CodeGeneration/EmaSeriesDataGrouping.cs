...
namespace Highsoft.Web.Mvc.Stocks
{
	public partial class EmaSeriesDataGrouping  : BaseObject
	{
		...
		internal override Hashtable ToHashtable()
		{
			...
			if (Approximation != Approximation_DefaultValue) { h.Add("approximation",Approximation); Highstock.AddFunction("EmaSeriesDataGroupingApproximation.approximation", Approximation); }  
