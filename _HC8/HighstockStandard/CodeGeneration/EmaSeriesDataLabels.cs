...
{
	public partial class EmaSeriesDataLabels  : BaseObject
	{
		Hashtable h = new Hashtable();

		public EmaSeriesDataLabels()
		{
			Align = Align_DefaultValue = EmaSeriesDataLabelsAlign.Center;
			...
			Filter = Filter_DefaultValue = new EmaSeriesDataLabelsFilter();
			...
			Overflow = Overflow_DefaultValue = EmaSeriesDataLabelsOverflow.Justify;
			Padding = Padding_DefaultValue = 5;
			Position = Position_DefaultValue = EmaSeriesDataLabelsPosition.Center;
			...
			TextPath = TextPath_DefaultValue = new EmaSeriesDataLabelsTextPath();
			UseHTML = UseHTML_DefaultValue = false;
			VerticalAlign = VerticalAlign_DefaultValue = EmaSeriesDataLabelsVerticalAlign.Bottom;
			X = X_DefaultValue = 0;
			Y = Y_DefaultValue = 0;
			Z = Z_DefaultValue = 6;
		...
		/// </summary>
		public EmaSeriesDataLabelsAlign Align { get; set; }
		private EmaSeriesDataLabelsAlign Align_DefaultValue { get; set; }
		...
		/// </summary>
		public EmaSeriesDataLabelsFilter Filter { get; set; }
		private EmaSeriesDataLabelsFilter Filter_DefaultValue { get; set; }
		...
		/// </summary>
		public EmaSeriesDataLabelsOverflow Overflow { get; set; }
		private EmaSeriesDataLabelsOverflow Overflow_DefaultValue { get; set; }
		...
		/// </summary>
		public EmaSeriesDataLabelsPosition Position { get; set; }
		private EmaSeriesDataLabelsPosition Position_DefaultValue { get; set; }
		...
		/// </summary>
		public EmaSeriesDataLabelsTextPath TextPath { get; set; }
		private EmaSeriesDataLabelsTextPath TextPath_DefaultValue { get; set; }
		...
		/// </summary>
		public EmaSeriesDataLabelsVerticalAlign VerticalAlign { get; set; }
		private EmaSeriesDataLabelsVerticalAlign VerticalAlign_DefaultValue { get; set; }
