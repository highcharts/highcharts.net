...
{
	public partial class EmaSeriesLastPriceLabel  : BaseObject
	{
		Hashtable h = new Hashtable();

		public EmaSeriesLastPriceLabel()
		{
			Align = Align_DefaultValue = EmaSeriesLastPriceLabelAlign.Null;
		...
		/// 
		/// </summary>
		public EmaSeriesLastPriceLabelAlign Align { get; set; }
		private EmaSeriesLastPriceLabelAlign Align_DefaultValue { get; set; }
