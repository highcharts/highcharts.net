...
{
	public partial class EmaSeriesLastVisiblePriceLabel  : BaseObject
	{
		Hashtable h = new Hashtable();

		public EmaSeriesLastVisiblePriceLabel()
		{
			Align = Align_DefaultValue = EmaSeriesLastVisiblePriceLabelAlign.Null;
		...
		/// 
		/// </summary>
		public EmaSeriesLastVisiblePriceLabelAlign Align { get; set; }
		private EmaSeriesLastVisiblePriceLabelAlign Align_DefaultValue { get; set; }
