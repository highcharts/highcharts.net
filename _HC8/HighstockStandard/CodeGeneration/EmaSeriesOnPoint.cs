...
{
	public partial class EmaSeriesOnPoint  : BaseObject
	{
		Hashtable h = new Hashtable();

		public EmaSeriesOnPoint()
		{
			ConnectorOptions = ConnectorOptions_DefaultValue = new EmaSeriesOnPointConnectorOptions();
			Id = Id_DefaultValue = "";
			Position = Position_DefaultValue = new EmaSeriesOnPointPosition();
		...
		/// </summary>
		public EmaSeriesOnPointConnectorOptions ConnectorOptions { get; set; }
		private EmaSeriesOnPointConnectorOptions ConnectorOptions_DefaultValue { get; set; }
		...
		/// </summary>
		public EmaSeriesOnPointPosition Position { get; set; }
		private EmaSeriesOnPointPosition Position_DefaultValue { get; set; }
