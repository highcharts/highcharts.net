...
{
	public partial class EmaSeriesSonificationContextTracksPointGrouping  : BaseObject
	{
		Hashtable h = new Hashtable();

		public EmaSeriesSonificationContextTracksPointGrouping()
		{
			Algorithm = Algorithm_DefaultValue = EmaSeriesSonificationContextTracksPointGroupingAlgorithm.Minimax;
		...
		/// </summary>
		public EmaSeriesSonificationContextTracksPointGroupingAlgorithm Algorithm { get; set; }
		private EmaSeriesSonificationContextTracksPointGroupingAlgorithm Algorithm_DefaultValue { get; set; }
