...
{
	public partial class EmaSeriesSonificationTracksPointGrouping  : BaseObject
	{
		Hashtable h = new Hashtable();

		public EmaSeriesSonificationTracksPointGrouping()
		{
			Algorithm = Algorithm_DefaultValue = EmaSeriesSonificationTracksPointGroupingAlgorithm.Minimax;
		...
		/// </summary>
		public EmaSeriesSonificationTracksPointGroupingAlgorithm Algorithm { get; set; }
		private EmaSeriesSonificationTracksPointGroupingAlgorithm Algorithm_DefaultValue { get; set; }
