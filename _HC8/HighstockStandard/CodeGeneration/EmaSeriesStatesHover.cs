...
{
	public partial class EmaSeriesStatesHover  : BaseObject
	{
		Hashtable h = new Hashtable();

		public EmaSeriesStatesHover()
		{
			Animation = Animation_DefaultValue = new Animation() { Enabled = true };
			Enabled = Enabled_DefaultValue = null;
			Halo = Halo_DefaultValue = new EmaSeriesStatesHoverHalo();
			LineWidth = LineWidth_DefaultValue = null;
			LineWidthPlus = LineWidthPlus_DefaultValue = null;
			Marker = Marker_DefaultValue = new EmaSeriesStatesHoverMarker();
		...
		/// </summary>
		public EmaSeriesStatesHoverHalo Halo { get; set; }
		private EmaSeriesStatesHoverHalo Halo_DefaultValue { get; set; }
		...
		/// </summary>
		public EmaSeriesStatesHoverMarker Marker { get; set; }
		private EmaSeriesStatesHoverMarker Marker_DefaultValue { get; set; }
