...
{
	public partial class EmaSeriesStatesSelect  : BaseObject
	{
		Hashtable h = new Hashtable();

		public EmaSeriesStatesSelect()
		{
			Animation = Animation_DefaultValue = new Animation() { Enabled = true };
			Enabled = Enabled_DefaultValue = null;
			Halo = Halo_DefaultValue = new EmaSeriesStatesSelectHalo();
			LineWidth = LineWidth_DefaultValue = null;
			LineWidthPlus = LineWidthPlus_DefaultValue = null;
			Marker = Marker_DefaultValue = new EmaSeriesStatesSelectMarker();
		...
		/// </summary>
		public EmaSeriesStatesSelectHalo Halo { get; set; }
		private EmaSeriesStatesSelectHalo Halo_DefaultValue { get; set; }
		...
		/// </summary>
		public EmaSeriesStatesSelectMarker Marker { get; set; }
		private EmaSeriesStatesSelectMarker Marker_DefaultValue { get; set; }
