...
{
	public partial class EmaSeriesStatesSelectMarker  : BaseObject
	{
		Hashtable h = new Hashtable();

		public EmaSeriesStatesSelectMarker()
		{
			...
			States = States_DefaultValue = new EmaSeriesStatesSelectMarkerStates();
		...
		/// </summary>
		public EmaSeriesStatesSelectMarkerStates States { get; set; }
		private EmaSeriesStatesSelectMarkerStates States_DefaultValue { get; set; }
