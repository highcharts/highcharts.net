...
namespace Highsoft.Web.Mvc.Stocks
{
	public partial class FlagsSeries  : Series
	{
		...
		public FlagsSeries()
		{
			...
			DashStyle = DashStyle_DefaultValue = FlagsSeriesDashStyle.Null;
			Data = Data_DefaultValue = new List<FlagsSeriesData>();
			DataGrouping = DataGrouping_DefaultValue = new FlagsSeriesDataGrouping();
		...
		/// </summary>
		public FlagsSeriesDashStyle DashStyle { get; set; }
		private FlagsSeriesDashStyle DashStyle_DefaultValue { get; set; }
		...
		/// </summary>
		public FlagsSeriesDataGrouping DataGrouping { get; set; }
		private FlagsSeriesDataGrouping DataGrouping_DefaultValue { get; set; }
