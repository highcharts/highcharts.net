...
{
	public partial class FlagsSeriesDataDragDrop  : BaseObject
	{
		Hashtable h = new Hashtable();

		public FlagsSeriesDataDragDrop()
		{
			DraggableX = DraggableX_DefaultValue = null;
			DraggableY = DraggableY_DefaultValue = null;
			DragHandle = DragHandle_DefaultValue = new FlagsSeriesDataDragDropDragHandle();
			...
			GuideBox = GuideBox_DefaultValue = new FlagsSeriesDataDragDropGuideBox();
		...
		/// </summary>
		public FlagsSeriesDataDragDropDragHandle DragHandle { get; set; }
		private FlagsSeriesDataDragDropDragHandle DragHandle_DefaultValue { get; set; }
		...
		/// </summary>
		public FlagsSeriesDataDragDropGuideBox GuideBox { get; set; }
		private FlagsSeriesDataDragDropGuideBox GuideBox_DefaultValue { get; set; }
