...
{
	public partial class FlagsSeriesDataLabels  : BaseObject
	{
		Hashtable h = new Hashtable();

		public FlagsSeriesDataLabels()
		{
			Align = Align_DefaultValue = FlagsSeriesDataLabelsAlign.Center;
			...
			Filter = Filter_DefaultValue = new FlagsSeriesDataLabelsFilter();
			...
			Overflow = Overflow_DefaultValue = FlagsSeriesDataLabelsOverflow.Justify;
			Padding = Padding_DefaultValue = 5;
			Position = Position_DefaultValue = FlagsSeriesDataLabelsPosition.Center;
			...
			TextPath = TextPath_DefaultValue = new FlagsSeriesDataLabelsTextPath();
			UseHTML = UseHTML_DefaultValue = false;
			VerticalAlign = VerticalAlign_DefaultValue = FlagsSeriesDataLabelsVerticalAlign.Bottom;
			X = X_DefaultValue = 0;
			Y = Y_DefaultValue = 0;
			Z = Z_DefaultValue = 6;
		...
		/// </summary>
		public FlagsSeriesDataLabelsAlign Align { get; set; }
		private FlagsSeriesDataLabelsAlign Align_DefaultValue { get; set; }
		...
		/// </summary>
		public FlagsSeriesDataLabelsFilter Filter { get; set; }
		private FlagsSeriesDataLabelsFilter Filter_DefaultValue { get; set; }
		...
		/// </summary>
		public FlagsSeriesDataLabelsOverflow Overflow { get; set; }
		private FlagsSeriesDataLabelsOverflow Overflow_DefaultValue { get; set; }
		...
		/// </summary>
		public FlagsSeriesDataLabelsPosition Position { get; set; }
		private FlagsSeriesDataLabelsPosition Position_DefaultValue { get; set; }
		...
		/// </summary>
		public FlagsSeriesDataLabelsTextPath TextPath { get; set; }
		private FlagsSeriesDataLabelsTextPath TextPath_DefaultValue { get; set; }
		...
		/// </summary>
		public FlagsSeriesDataLabelsVerticalAlign VerticalAlign { get; set; }
		private FlagsSeriesDataLabelsVerticalAlign VerticalAlign_DefaultValue { get; set; }
