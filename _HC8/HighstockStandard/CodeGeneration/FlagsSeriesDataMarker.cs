...
{
	public partial class FlagsSeriesDataMarker  : BaseObject
	{
		Hashtable h = new Hashtable();

		public FlagsSeriesDataMarker()
		{
			...
			States = States_DefaultValue = new FlagsSeriesDataMarkerStates();
		...
		/// </summary>
		public FlagsSeriesDataMarkerStates States { get; set; }
		private FlagsSeriesDataMarkerStates States_DefaultValue { get; set; }
