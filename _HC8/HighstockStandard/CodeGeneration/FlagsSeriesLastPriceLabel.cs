...
{
	public partial class FlagsSeriesLastPriceLabel  : BaseObject
	{
		Hashtable h = new Hashtable();

		public FlagsSeriesLastPriceLabel()
		{
			Align = Align_DefaultValue = FlagsSeriesLastPriceLabelAlign.Null;
		...
		/// 
		/// </summary>
		public FlagsSeriesLastPriceLabelAlign Align { get; set; }
		private FlagsSeriesLastPriceLabelAlign Align_DefaultValue { get; set; }
