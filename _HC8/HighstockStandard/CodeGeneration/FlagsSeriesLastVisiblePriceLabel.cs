...
{
	public partial class FlagsSeriesLastVisiblePriceLabel  : BaseObject
	{
		Hashtable h = new Hashtable();

		public FlagsSeriesLastVisiblePriceLabel()
		{
			Align = Align_DefaultValue = FlagsSeriesLastVisiblePriceLabelAlign.Null;
		...
		/// 
		/// </summary>
		public FlagsSeriesLastVisiblePriceLabelAlign Align { get; set; }
		private FlagsSeriesLastVisiblePriceLabelAlign Align_DefaultValue { get; set; }
