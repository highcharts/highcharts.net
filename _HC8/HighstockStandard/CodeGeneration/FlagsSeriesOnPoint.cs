...
{
	public partial class FlagsSeriesOnPoint  : BaseObject
	{
		Hashtable h = new Hashtable();

		public FlagsSeriesOnPoint()
		{
			ConnectorOptions = ConnectorOptions_DefaultValue = new FlagsSeriesOnPointConnectorOptions();
			Id = Id_DefaultValue = "";
			Position = Position_DefaultValue = new FlagsSeriesOnPointPosition();
		...
		/// </summary>
		public FlagsSeriesOnPointConnectorOptions ConnectorOptions { get; set; }
		private FlagsSeriesOnPointConnectorOptions ConnectorOptions_DefaultValue { get; set; }
		...
		/// </summary>
		public FlagsSeriesOnPointPosition Position { get; set; }
		private FlagsSeriesOnPointPosition Position_DefaultValue { get; set; }
