...
{
	public partial class FlagsSeriesSonificationContextTracksPointGrouping  : BaseObject
	{
		Hashtable h = new Hashtable();

		public FlagsSeriesSonificationContextTracksPointGrouping()
		{
			Algorithm = Algorithm_DefaultValue = FlagsSeriesSonificationContextTracksPointGroupingAlgorithm.Minimax;
		...
		/// </summary>
		public FlagsSeriesSonificationContextTracksPointGroupingAlgorithm Algorithm { get; set; }
		private FlagsSeriesSonificationContextTracksPointGroupingAlgorithm Algorithm_DefaultValue { get; set; }
