...
{
	public partial class FlagsSeriesSonificationPointGrouping  : BaseObject
	{
		Hashtable h = new Hashtable();

		public FlagsSeriesSonificationPointGrouping()
		{
			Algorithm = Algorithm_DefaultValue = FlagsSeriesSonificationPointGroupingAlgorithm.Minimax;
		...
		/// </summary>
		public FlagsSeriesSonificationPointGroupingAlgorithm Algorithm { get; set; }
		private FlagsSeriesSonificationPointGroupingAlgorithm Algorithm_DefaultValue { get; set; }
