...
{
	public partial class FlagsSeriesStatesHover  : BaseObject
	{
		Hashtable h = new Hashtable();

		public FlagsSeriesStatesHover()
		{
			Animation = Animation_DefaultValue = new Animation() { Enabled = true };
			Enabled = Enabled_DefaultValue = new Hashtable();
			Halo = Halo_DefaultValue = new FlagsSeriesStatesHoverHalo();
			LineWidth = LineWidth_DefaultValue = new Hashtable();
			LineWidthPlus = LineWidthPlus_DefaultValue = new Hashtable();
			Marker = Marker_DefaultValue = new FlagsSeriesStatesHoverMarker();
		...
		/// </summary>
		public FlagsSeriesStatesHoverHalo Halo { get; set; }
		private FlagsSeriesStatesHoverHalo Halo_DefaultValue { get; set; }
		...
		/// </summary>
		public FlagsSeriesStatesHoverMarker Marker { get; set; }
		private FlagsSeriesStatesHoverMarker Marker_DefaultValue { get; set; }
