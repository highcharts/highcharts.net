...
{
	public partial class FlagsSeriesStatesSelect  : BaseObject
	{
		Hashtable h = new Hashtable();

		public FlagsSeriesStatesSelect()
		{
			Animation = Animation_DefaultValue = new Animation() { Enabled = true };
			Enabled = Enabled_DefaultValue = null;
			Halo = Halo_DefaultValue = new FlagsSeriesStatesSelectHalo();
			LineWidth = LineWidth_DefaultValue = null;
			LineWidthPlus = LineWidthPlus_DefaultValue = null;
			Marker = Marker_DefaultValue = new FlagsSeriesStatesSelectMarker();
		...
		/// </summary>
		public FlagsSeriesStatesSelectHalo Halo { get; set; }
		private FlagsSeriesStatesSelectHalo Halo_DefaultValue { get; set; }
		...
		/// </summary>
		public FlagsSeriesStatesSelectMarker Marker { get; set; }
		private FlagsSeriesStatesSelectMarker Marker_DefaultValue { get; set; }
