...
{
	public partial class FlagsSeriesStatesSelectMarker  : BaseObject
	{
		Hashtable h = new Hashtable();

		public FlagsSeriesStatesSelectMarker()
		{
			...
			States = States_DefaultValue = new FlagsSeriesStatesSelectMarkerStates();
		...
		/// </summary>
		public FlagsSeriesStatesSelectMarkerStates States { get; set; }
		private FlagsSeriesStatesSelectMarkerStates States_DefaultValue { get; set; }
