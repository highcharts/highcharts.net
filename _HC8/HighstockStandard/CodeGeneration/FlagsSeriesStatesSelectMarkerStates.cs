...
namespace Highsoft.Web.Mvc.Stocks
{
	public partial class FlagsSeriesStatesSelectMarkerStates  : BaseObject
	{
		...
		public FlagsSeriesStatesSelectMarkerStates()
		{
			...
			Normal = Normal_DefaultValue = new FlagsSeriesStatesSelectMarkerStatesNormal();
		...
		/// </summary>
		public FlagsSeriesStatesSelectMarkerStatesNormal Normal { get; set; }
		private FlagsSeriesStatesSelectMarkerStatesNormal Normal_DefaultValue { get; set; }
