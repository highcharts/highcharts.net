...
{
	public partial class HeikinashiSeriesData  : BaseObject
	{
		Hashtable h = new Hashtable();

		public HeikinashiSeriesData()
		{
			...
			DragDrop = DragDrop_DefaultValue = new HeikinashiSeriesDataDragDrop();
			Drilldown = Drilldown_DefaultValue = "";
			Events = Events_DefaultValue = new HeikinashiSeriesDataEvents();
			High = High_DefaultValue = null;
			Id = Id_DefaultValue = "";
			Labelrank = Labelrank_DefaultValue = null;
			Low = Low_DefaultValue = null;
			Marker = Marker_DefaultValue = new HeikinashiSeriesDataMarker();
		...
		/// </summary>
		public HeikinashiSeriesDataAccessibility Accessibility { get; set; }
		private HeikinashiSeriesDataAccessibility Accessibility_DefaultValue { get; set; }
		...
		/// </summary>
		public HeikinashiSeriesDataDragDrop DragDrop { get; set; }
		private HeikinashiSeriesDataDragDrop DragDrop_DefaultValue { get; set; }
		...
		/// </summary>
		public HeikinashiSeriesDataEvents Events { get; set; }
		private HeikinashiSeriesDataEvents Events_DefaultValue { get; set; }
		...
		/// </summary>
		public HeikinashiSeriesDataMarker Marker { get; set; }
		private HeikinashiSeriesDataMarker Marker_DefaultValue { get; set; }
