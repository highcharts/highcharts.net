...
{
	public partial class HeikinashiSeriesDataLabels  : BaseObject
	{
		Hashtable h = new Hashtable();

		public HeikinashiSeriesDataLabels()
		{
			Align = Align_DefaultValue = HeikinashiSeriesDataLabelsAlign.Center;
			...
			Filter = Filter_DefaultValue = new HeikinashiSeriesDataLabelsFilter();
			...
			Overflow = Overflow_DefaultValue = HeikinashiSeriesDataLabelsOverflow.Justify;
			Padding = Padding_DefaultValue = 5;
			Position = Position_DefaultValue = HeikinashiSeriesDataLabelsPosition.Center;
			...
			TextPath = TextPath_DefaultValue = new HeikinashiSeriesDataLabelsTextPath();
			UseHTML = UseHTML_DefaultValue = false;
			VerticalAlign = VerticalAlign_DefaultValue = HeikinashiSeriesDataLabelsVerticalAlign.Bottom;
			X = X_DefaultValue = 0;
			Y = Y_DefaultValue = 0;
			Z = Z_DefaultValue = 6;
		...
		/// </summary>
		public HeikinashiSeriesDataLabelsAlign Align { get; set; }
		private HeikinashiSeriesDataLabelsAlign Align_DefaultValue { get; set; }
		...
		/// </summary>
		public HeikinashiSeriesDataLabelsFilter Filter { get; set; }
		private HeikinashiSeriesDataLabelsFilter Filter_DefaultValue { get; set; }
		...
		/// </summary>
		public HeikinashiSeriesDataLabelsOverflow Overflow { get; set; }
		private HeikinashiSeriesDataLabelsOverflow Overflow_DefaultValue { get; set; }
		...
		/// </summary>
		public HeikinashiSeriesDataLabelsPosition Position { get; set; }
		private HeikinashiSeriesDataLabelsPosition Position_DefaultValue { get; set; }
		...
		/// </summary>
		public HeikinashiSeriesDataLabelsTextPath TextPath { get; set; }
		private HeikinashiSeriesDataLabelsTextPath TextPath_DefaultValue { get; set; }
		...
		/// </summary>
		public HeikinashiSeriesDataLabelsVerticalAlign VerticalAlign { get; set; }
		private HeikinashiSeriesDataLabelsVerticalAlign VerticalAlign_DefaultValue { get; set; }
