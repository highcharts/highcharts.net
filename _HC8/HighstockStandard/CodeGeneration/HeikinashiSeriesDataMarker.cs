...
{
	public partial class HeikinashiSeriesDataMarker  : BaseObject
	{
		Hashtable h = new Hashtable();

		public HeikinashiSeriesDataMarker()
		{
			...
			States = States_DefaultValue = new HeikinashiSeriesDataMarkerStates();
		...
		/// </summary>
		public HeikinashiSeriesDataMarkerStates States { get; set; }
		private HeikinashiSeriesDataMarkerStates States_DefaultValue { get; set; }
