...
{
	public partial class HeikinashiSeriesDragDrop  : BaseObject
	{
		Hashtable h = new Hashtable();

		public HeikinashiSeriesDragDrop()
		{
			DraggableX = DraggableX_DefaultValue = null;
			DraggableY = DraggableY_DefaultValue = null;
			DragHandle = DragHandle_DefaultValue = new HeikinashiSeriesDragDropDragHandle();
			...
			GuideBox = GuideBox_DefaultValue = new HeikinashiSeriesDragDropGuideBox();
		...
		/// </summary>
		public HeikinashiSeriesDragDropDragHandle DragHandle { get; set; }
		private HeikinashiSeriesDragDropDragHandle DragHandle_DefaultValue { get; set; }
		...
		/// </summary>
		public HeikinashiSeriesDragDropGuideBox GuideBox { get; set; }
		private HeikinashiSeriesDragDropGuideBox GuideBox_DefaultValue { get; set; }
