...
{
	public partial class HeikinashiSeriesOnPoint  : BaseObject
	{
		Hashtable h = new Hashtable();

		public HeikinashiSeriesOnPoint()
		{
			ConnectorOptions = ConnectorOptions_DefaultValue = new HeikinashiSeriesOnPointConnectorOptions();
			Id = Id_DefaultValue = "";
			Position = Position_DefaultValue = new HeikinashiSeriesOnPointPosition();
		...
		/// </summary>
		public HeikinashiSeriesOnPointConnectorOptions ConnectorOptions { get; set; }
		private HeikinashiSeriesOnPointConnectorOptions ConnectorOptions_DefaultValue { get; set; }
		...
		/// </summary>
		public HeikinashiSeriesOnPointPosition Position { get; set; }
		private HeikinashiSeriesOnPointPosition Position_DefaultValue { get; set; }
