...
{
	public partial class HeikinashiSeriesStatesHoverMarker  : BaseObject
	{
		Hashtable h = new Hashtable();

		public HeikinashiSeriesStatesHoverMarker()
		{
			...
			States = States_DefaultValue = new HeikinashiSeriesStatesHoverMarkerStates();
		...
		/// </summary>
		public HeikinashiSeriesStatesHoverMarkerStates States { get; set; }
		private HeikinashiSeriesStatesHoverMarkerStates States_DefaultValue { get; set; }
