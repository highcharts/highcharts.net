...
{
	public partial class HeikinashiSeriesStatesSelect  : BaseObject
	{
		Hashtable h = new Hashtable();

		public HeikinashiSeriesStatesSelect()
		{
			Animation = Animation_DefaultValue = new Animation() { Enabled = true };
			Enabled = Enabled_DefaultValue = null;
			Halo = Halo_DefaultValue = new HeikinashiSeriesStatesSelectHalo();
			LineWidth = LineWidth_DefaultValue = null;
			LineWidthPlus = LineWidthPlus_DefaultValue = null;
			Marker = Marker_DefaultValue = new HeikinashiSeriesStatesSelectMarker();
		...
		/// </summary>
		public HeikinashiSeriesStatesSelectHalo Halo { get; set; }
		private HeikinashiSeriesStatesSelectHalo Halo_DefaultValue { get; set; }
		...
		/// </summary>
		public HeikinashiSeriesStatesSelectMarker Marker { get; set; }
		private HeikinashiSeriesStatesSelectMarker Marker_DefaultValue { get; set; }
