...
{
	public partial class HeikinashiSeriesStatesSelectMarker  : BaseObject
	{
		Hashtable h = new Hashtable();

		public HeikinashiSeriesStatesSelectMarker()
		{
			...
			States = States_DefaultValue = new HeikinashiSeriesStatesSelectMarkerStates();
		...
		/// </summary>
		public HeikinashiSeriesStatesSelectMarkerStates States { get; set; }
		private HeikinashiSeriesStatesSelectMarkerStates States_DefaultValue { get; set; }
