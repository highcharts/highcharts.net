...
{
	public partial class HeikinashiSeriesTooltip  : BaseObject
	{
		Hashtable h = new Hashtable();

		public HeikinashiSeriesTooltip()
		{
			...
			HeaderShape = HeaderShape_DefaultValue = HeikinashiSeriesTooltipHeaderShape.Callout;
		...
		/// </summary>
		public HeikinashiSeriesTooltipHeaderShape HeaderShape { get; set; }
		private HeikinashiSeriesTooltipHeaderShape HeaderShape_DefaultValue { get; set; }
