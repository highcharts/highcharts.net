...
{
	public partial class HlcSeriesDataDragDrop  : BaseObject
	{
		Hashtable h = new Hashtable();

		public HlcSeriesDataDragDrop()
		{
			DraggableX = DraggableX_DefaultValue = null;
			DraggableY = DraggableY_DefaultValue = null;
			DragHandle = DragHandle_DefaultValue = new HlcSeriesDataDragDropDragHandle();
			...
			GuideBox = GuideBox_DefaultValue = new HlcSeriesDataDragDropGuideBox();
		...
		/// </summary>
		public HlcSeriesDataDragDropDragHandle DragHandle { get; set; }
		private HlcSeriesDataDragDropDragHandle DragHandle_DefaultValue { get; set; }
		...
		/// </summary>
		public HlcSeriesDataDragDropGuideBox GuideBox { get; set; }
		private HlcSeriesDataDragDropGuideBox GuideBox_DefaultValue { get; set; }
