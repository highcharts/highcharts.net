...
{
	public partial class HlcSeriesDataLabels  : BaseObject
	{
		Hashtable h = new Hashtable();

		public HlcSeriesDataLabels()
		{
			Align = Align_DefaultValue = HlcSeriesDataLabelsAlign.Center;
			...
			Filter = Filter_DefaultValue = new HlcSeriesDataLabelsFilter();
			...
			Overflow = Overflow_DefaultValue = HlcSeriesDataLabelsOverflow.Justify;
			Padding = Padding_DefaultValue = 5;
			Position = Position_DefaultValue = HlcSeriesDataLabelsPosition.Center;
			...
			TextPath = TextPath_DefaultValue = new HlcSeriesDataLabelsTextPath();
			UseHTML = UseHTML_DefaultValue = false;
			VerticalAlign = VerticalAlign_DefaultValue = HlcSeriesDataLabelsVerticalAlign.Bottom;
			X = X_DefaultValue = 0;
			Y = Y_DefaultValue = 0;
			Z = Z_DefaultValue = 6;
		...
		/// </summary>
		public HlcSeriesDataLabelsAlign Align { get; set; }
		private HlcSeriesDataLabelsAlign Align_DefaultValue { get; set; }
		...
		/// </summary>
		public HlcSeriesDataLabelsFilter Filter { get; set; }
		private HlcSeriesDataLabelsFilter Filter_DefaultValue { get; set; }
		...
		/// </summary>
		public HlcSeriesDataLabelsOverflow Overflow { get; set; }
		private HlcSeriesDataLabelsOverflow Overflow_DefaultValue { get; set; }
		...
		/// </summary>
		public HlcSeriesDataLabelsPosition Position { get; set; }
		private HlcSeriesDataLabelsPosition Position_DefaultValue { get; set; }
		...
		/// </summary>
		public HlcSeriesDataLabelsTextPath TextPath { get; set; }
		private HlcSeriesDataLabelsTextPath TextPath_DefaultValue { get; set; }
		...
		/// </summary>
		public HlcSeriesDataLabelsVerticalAlign VerticalAlign { get; set; }
		private HlcSeriesDataLabelsVerticalAlign VerticalAlign_DefaultValue { get; set; }
