...
{
	public partial class HlcSeriesDataMarker  : BaseObject
	{
		Hashtable h = new Hashtable();

		public HlcSeriesDataMarker()
		{
			...
			States = States_DefaultValue = new HlcSeriesDataMarkerStates();
		...
		/// </summary>
		public HlcSeriesDataMarkerStates States { get; set; }
		private HlcSeriesDataMarkerStates States_DefaultValue { get; set; }
