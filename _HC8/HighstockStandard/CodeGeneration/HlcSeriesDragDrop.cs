...
{
	public partial class HlcSeriesDragDrop  : BaseObject
	{
		Hashtable h = new Hashtable();

		public HlcSeriesDragDrop()
		{
			DraggableX = DraggableX_DefaultValue = null;
			DraggableY = DraggableY_DefaultValue = null;
			DragHandle = DragHandle_DefaultValue = new HlcSeriesDragDropDragHandle();
			...
			GuideBox = GuideBox_DefaultValue = new HlcSeriesDragDropGuideBox();
		...
		/// </summary>
		public HlcSeriesDragDropDragHandle DragHandle { get; set; }
		private HlcSeriesDragDropDragHandle DragHandle_DefaultValue { get; set; }
		...
		/// </summary>
		public HlcSeriesDragDropGuideBox GuideBox { get; set; }
		private HlcSeriesDragDropGuideBox GuideBox_DefaultValue { get; set; }
