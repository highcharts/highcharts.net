...
{
	public partial class HlcSeriesLastPriceLabel  : BaseObject
	{
		Hashtable h = new Hashtable();

		public HlcSeriesLastPriceLabel()
		{
			Align = Align_DefaultValue = HlcSeriesLastPriceLabelAlign.Null;
		...
		/// 
		/// </summary>
		public HlcSeriesLastPriceLabelAlign Align { get; set; }
		private HlcSeriesLastPriceLabelAlign Align_DefaultValue { get; set; }
