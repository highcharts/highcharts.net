...
{
	public partial class HlcSeriesLastVisiblePriceLabel  : BaseObject
	{
		Hashtable h = new Hashtable();

		public HlcSeriesLastVisiblePriceLabel()
		{
			Align = Align_DefaultValue = HlcSeriesLastVisiblePriceLabelAlign.Null;
		...
		/// 
		/// </summary>
		public HlcSeriesLastVisiblePriceLabelAlign Align { get; set; }
		private HlcSeriesLastVisiblePriceLabelAlign Align_DefaultValue { get; set; }
