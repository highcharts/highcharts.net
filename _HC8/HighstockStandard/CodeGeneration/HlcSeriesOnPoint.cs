...
{
	public partial class HlcSeriesOnPoint  : BaseObject
	{
		Hashtable h = new Hashtable();

		public HlcSeriesOnPoint()
		{
			ConnectorOptions = ConnectorOptions_DefaultValue = new HlcSeriesOnPointConnectorOptions();
			Id = Id_DefaultValue = "";
			Position = Position_DefaultValue = new HlcSeriesOnPointPosition();
		...
		/// </summary>
		public HlcSeriesOnPointConnectorOptions ConnectorOptions { get; set; }
		private HlcSeriesOnPointConnectorOptions ConnectorOptions_DefaultValue { get; set; }
		...
		/// </summary>
		public HlcSeriesOnPointPosition Position { get; set; }
		private HlcSeriesOnPointPosition Position_DefaultValue { get; set; }
