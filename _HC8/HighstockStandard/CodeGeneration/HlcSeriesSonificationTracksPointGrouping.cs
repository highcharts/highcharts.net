...
{
	public partial class HlcSeriesSonificationTracksPointGrouping  : BaseObject
	{
		Hashtable h = new Hashtable();

		public HlcSeriesSonificationTracksPointGrouping()
		{
			Algorithm = Algorithm_DefaultValue = HlcSeriesSonificationTracksPointGroupingAlgorithm.Minimax;
		...
		/// </summary>
		public HlcSeriesSonificationTracksPointGroupingAlgorithm Algorithm { get; set; }
		private HlcSeriesSonificationTracksPointGroupingAlgorithm Algorithm_DefaultValue { get; set; }
