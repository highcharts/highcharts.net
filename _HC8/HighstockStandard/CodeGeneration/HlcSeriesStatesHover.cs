...
{
	public partial class HlcSeriesStatesHover  : BaseObject
	{
		Hashtable h = new Hashtable();

		public HlcSeriesStatesHover()
		{
			Animation = Animation_DefaultValue = new Animation() { Enabled = true };
			Enabled = Enabled_DefaultValue = null;
			Halo = Halo_DefaultValue = new HlcSeriesStatesHoverHalo();
			LineWidth = LineWidth_DefaultValue = null;
			LineWidthPlus = LineWidthPlus_DefaultValue = null;
			Marker = Marker_DefaultValue = new HlcSeriesStatesHoverMarker();
		...
		/// </summary>
		public HlcSeriesStatesHoverHalo Halo { get; set; }
		private HlcSeriesStatesHoverHalo Halo_DefaultValue { get; set; }
		...
		/// </summary>
		public HlcSeriesStatesHoverMarker Marker { get; set; }
		private HlcSeriesStatesHoverMarker Marker_DefaultValue { get; set; }
