...
{
	public partial class HlcSeriesStatesHoverMarker  : BaseObject
	{
		Hashtable h = new Hashtable();

		public HlcSeriesStatesHoverMarker()
		{
			...
			States = States_DefaultValue = new HlcSeriesStatesHoverMarkerStates();
		...
		/// </summary>
		public HlcSeriesStatesHoverMarkerStates States { get; set; }
		private HlcSeriesStatesHoverMarkerStates States_DefaultValue { get; set; }
