...
{
	public partial class HlcSeriesStatesSelect  : BaseObject
	{
		Hashtable h = new Hashtable();

		public HlcSeriesStatesSelect()
		{
			Animation = Animation_DefaultValue = new Animation() { Enabled = true };
			Enabled = Enabled_DefaultValue = null;
			Halo = Halo_DefaultValue = new HlcSeriesStatesSelectHalo();
			LineWidth = LineWidth_DefaultValue = null;
			LineWidthPlus = LineWidthPlus_DefaultValue = null;
			Marker = Marker_DefaultValue = new HlcSeriesStatesSelectMarker();
		...
		/// </summary>
		public HlcSeriesStatesSelectHalo Halo { get; set; }
		private HlcSeriesStatesSelectHalo Halo_DefaultValue { get; set; }
		...
		/// </summary>
		public HlcSeriesStatesSelectMarker Marker { get; set; }
		private HlcSeriesStatesSelectMarker Marker_DefaultValue { get; set; }
