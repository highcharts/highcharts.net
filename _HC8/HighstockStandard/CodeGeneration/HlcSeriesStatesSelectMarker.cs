...
{
	public partial class HlcSeriesStatesSelectMarker  : BaseObject
	{
		Hashtable h = new Hashtable();

		public HlcSeriesStatesSelectMarker()
		{
			...
			States = States_DefaultValue = new HlcSeriesStatesSelectMarkerStates();
		...
		/// </summary>
		public HlcSeriesStatesSelectMarkerStates States { get; set; }
		private HlcSeriesStatesSelectMarkerStates States_DefaultValue { get; set; }
