...
{
	public partial class HlcSeriesTooltip  : BaseObject
	{
		Hashtable h = new Hashtable();

		public HlcSeriesTooltip()
		{
			...
			HeaderShape = HeaderShape_DefaultValue = HlcSeriesTooltipHeaderShape.Callout;
		...
		/// </summary>
		public HlcSeriesTooltipHeaderShape HeaderShape { get; set; }
		private HlcSeriesTooltipHeaderShape HeaderShape_DefaultValue { get; set; }
