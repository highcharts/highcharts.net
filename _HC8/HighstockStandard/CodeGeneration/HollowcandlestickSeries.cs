...
namespace Highsoft.Web.Mvc.Stocks
{
	public partial class HollowcandlestickSeries  : Series
	{
		...
		public HollowcandlestickSeries()
		{
			...
			Type = Type_DefaultValue = HollowcandlestickSeriesType.Null;
		...
		/// </summary>
		public HollowcandlestickSeriesType Type { get; set; }
		private HollowcandlestickSeriesType Type_DefaultValue { get; set; }
