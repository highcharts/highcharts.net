...
{
	public partial class HollowcandlestickSeriesData  : BaseObject
	{
		Hashtable h = new Hashtable();

		public HollowcandlestickSeriesData()
		{
			...
			DragDrop = DragDrop_DefaultValue = new HollowcandlestickSeriesDataDragDrop();
			Drilldown = Drilldown_DefaultValue = "";
			Events = Events_DefaultValue = new HollowcandlestickSeriesDataEvents();
			High = High_DefaultValue = null;
			Id = Id_DefaultValue = "";
			Labelrank = Labelrank_DefaultValue = null;
			Low = Low_DefaultValue = null;
			Marker = Marker_DefaultValue = new HollowcandlestickSeriesDataMarker();
		...
		/// </summary>
		public HollowcandlestickSeriesDataAccessibility Accessibility { get; set; }
		private HollowcandlestickSeriesDataAccessibility Accessibility_DefaultValue { get; set; }
		...
		/// </summary>
		public HollowcandlestickSeriesDataDragDrop DragDrop { get; set; }
		private HollowcandlestickSeriesDataDragDrop DragDrop_DefaultValue { get; set; }
		...
		/// </summary>
		public HollowcandlestickSeriesDataEvents Events { get; set; }
		private HollowcandlestickSeriesDataEvents Events_DefaultValue { get; set; }
		...
		/// </summary>
		public HollowcandlestickSeriesDataMarker Marker { get; set; }
		private HollowcandlestickSeriesDataMarker Marker_DefaultValue { get; set; }
