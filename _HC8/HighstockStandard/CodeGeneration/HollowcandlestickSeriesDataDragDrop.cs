...
{
	public partial class HollowcandlestickSeriesDataDragDrop  : BaseObject
	{
		Hashtable h = new Hashtable();

		public HollowcandlestickSeriesDataDragDrop()
		{
			DraggableX = DraggableX_DefaultValue = null;
			DraggableY = DraggableY_DefaultValue = null;
			DragHandle = DragHandle_DefaultValue = new HollowcandlestickSeriesDataDragDropDragHandle();
			...
			GuideBox = GuideBox_DefaultValue = new HollowcandlestickSeriesDataDragDropGuideBox();
		...
		/// </summary>
		public HollowcandlestickSeriesDataDragDropDragHandle DragHandle { get; set; }
		private HollowcandlestickSeriesDataDragDropDragHandle DragHandle_DefaultValue { get; set; }
		...
		/// </summary>
		public HollowcandlestickSeriesDataDragDropGuideBox GuideBox { get; set; }
		private HollowcandlestickSeriesDataDragDropGuideBox GuideBox_DefaultValue { get; set; }
