...
{
	public partial class HollowcandlestickSeriesDataLabels  : BaseObject
	{
		Hashtable h = new Hashtable();

		public HollowcandlestickSeriesDataLabels()
		{
			Align = Align_DefaultValue = HollowcandlestickSeriesDataLabelsAlign.Center;
			...
			Filter = Filter_DefaultValue = new HollowcandlestickSeriesDataLabelsFilter();
			...
			Overflow = Overflow_DefaultValue = HollowcandlestickSeriesDataLabelsOverflow.Justify;
			Padding = Padding_DefaultValue = 5;
			Position = Position_DefaultValue = HollowcandlestickSeriesDataLabelsPosition.Center;
			...
			TextPath = TextPath_DefaultValue = new HollowcandlestickSeriesDataLabelsTextPath();
			UseHTML = UseHTML_DefaultValue = false;
			VerticalAlign = VerticalAlign_DefaultValue = HollowcandlestickSeriesDataLabelsVerticalAlign.Bottom;
			X = X_DefaultValue = 0;
			Y = Y_DefaultValue = 0;
			Z = Z_DefaultValue = 6;
		...
		/// </summary>
		public HollowcandlestickSeriesDataLabelsAlign Align { get; set; }
		private HollowcandlestickSeriesDataLabelsAlign Align_DefaultValue { get; set; }
		...
		/// </summary>
		public HollowcandlestickSeriesDataLabelsFilter Filter { get; set; }
		private HollowcandlestickSeriesDataLabelsFilter Filter_DefaultValue { get; set; }
		...
		/// </summary>
		public HollowcandlestickSeriesDataLabelsOverflow Overflow { get; set; }
		private HollowcandlestickSeriesDataLabelsOverflow Overflow_DefaultValue { get; set; }
		...
		/// </summary>
		public HollowcandlestickSeriesDataLabelsPosition Position { get; set; }
		private HollowcandlestickSeriesDataLabelsPosition Position_DefaultValue { get; set; }
		...
		/// </summary>
		public HollowcandlestickSeriesDataLabelsTextPath TextPath { get; set; }
		private HollowcandlestickSeriesDataLabelsTextPath TextPath_DefaultValue { get; set; }
		...
		/// </summary>
		public HollowcandlestickSeriesDataLabelsVerticalAlign VerticalAlign { get; set; }
		private HollowcandlestickSeriesDataLabelsVerticalAlign VerticalAlign_DefaultValue { get; set; }
