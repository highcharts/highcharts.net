...
{
	public partial class HollowcandlestickSeriesDataMarker  : BaseObject
	{
		Hashtable h = new Hashtable();

		public HollowcandlestickSeriesDataMarker()
		{
			...
			States = States_DefaultValue = new HollowcandlestickSeriesDataMarkerStates();
		...
		/// </summary>
		public HollowcandlestickSeriesDataMarkerStates States { get; set; }
		private HollowcandlestickSeriesDataMarkerStates States_DefaultValue { get; set; }
