...
{
	public partial class HollowcandlestickSeriesLastPriceLabel  : BaseObject
	{
		Hashtable h = new Hashtable();

		public HollowcandlestickSeriesLastPriceLabel()
		{
			Align = Align_DefaultValue = HollowcandlestickSeriesLastPriceLabelAlign.Null;
		...
		/// 
		/// </summary>
		public HollowcandlestickSeriesLastPriceLabelAlign Align { get; set; }
		private HollowcandlestickSeriesLastPriceLabelAlign Align_DefaultValue { get; set; }
