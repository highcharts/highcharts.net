...
{
	public partial class HollowcandlestickSeriesLastVisiblePriceLabel  : BaseObject
	{
		Hashtable h = new Hashtable();

		public HollowcandlestickSeriesLastVisiblePriceLabel()
		{
			Align = Align_DefaultValue = HollowcandlestickSeriesLastVisiblePriceLabelAlign.Null;
		...
		/// 
		/// </summary>
		public HollowcandlestickSeriesLastVisiblePriceLabelAlign Align { get; set; }
		private HollowcandlestickSeriesLastVisiblePriceLabelAlign Align_DefaultValue { get; set; }
