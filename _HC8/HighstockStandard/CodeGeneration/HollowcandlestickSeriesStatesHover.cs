...
{
	public partial class HollowcandlestickSeriesStatesHover  : BaseObject
	{
		Hashtable h = new Hashtable();

		public HollowcandlestickSeriesStatesHover()
		{
			Animation = Animation_DefaultValue = new Animation() { Enabled = true };
			Enabled = Enabled_DefaultValue = null;
			Halo = Halo_DefaultValue = new HollowcandlestickSeriesStatesHoverHalo();
			LineWidth = LineWidth_DefaultValue = null;
			LineWidthPlus = LineWidthPlus_DefaultValue = null;
			Marker = Marker_DefaultValue = new HollowcandlestickSeriesStatesHoverMarker();
		...
		/// </summary>
		public HollowcandlestickSeriesStatesHoverHalo Halo { get; set; }
		private HollowcandlestickSeriesStatesHoverHalo Halo_DefaultValue { get; set; }
		...
		/// </summary>
		public HollowcandlestickSeriesStatesHoverMarker Marker { get; set; }
		private HollowcandlestickSeriesStatesHoverMarker Marker_DefaultValue { get; set; }
