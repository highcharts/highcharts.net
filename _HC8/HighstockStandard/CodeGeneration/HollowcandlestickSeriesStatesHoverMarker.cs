...
{
	public partial class HollowcandlestickSeriesStatesHoverMarker  : BaseObject
	{
		Hashtable h = new Hashtable();

		public HollowcandlestickSeriesStatesHoverMarker()
		{
			...
			States = States_DefaultValue = new HollowcandlestickSeriesStatesHoverMarkerStates();
		...
		/// </summary>
		public HollowcandlestickSeriesStatesHoverMarkerStates States { get; set; }
		private HollowcandlestickSeriesStatesHoverMarkerStates States_DefaultValue { get; set; }
