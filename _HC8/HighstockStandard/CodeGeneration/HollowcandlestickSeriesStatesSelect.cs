...
{
	public partial class HollowcandlestickSeriesStatesSelect  : BaseObject
	{
		Hashtable h = new Hashtable();

		public HollowcandlestickSeriesStatesSelect()
		{
			Animation = Animation_DefaultValue = new Animation() { Enabled = true };
			Enabled = Enabled_DefaultValue = null;
			Halo = Halo_DefaultValue = new HollowcandlestickSeriesStatesSelectHalo();
			LineWidth = LineWidth_DefaultValue = null;
			LineWidthPlus = LineWidthPlus_DefaultValue = null;
			Marker = Marker_DefaultValue = new HollowcandlestickSeriesStatesSelectMarker();
		...
		/// </summary>
		public HollowcandlestickSeriesStatesSelectHalo Halo { get; set; }
		private HollowcandlestickSeriesStatesSelectHalo Halo_DefaultValue { get; set; }
		...
		/// </summary>
		public HollowcandlestickSeriesStatesSelectMarker Marker { get; set; }
		private HollowcandlestickSeriesStatesSelectMarker Marker_DefaultValue { get; set; }
