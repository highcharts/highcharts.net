...
{
	public partial class HollowcandlestickSeriesStatesSelectMarker  : BaseObject
	{
		Hashtable h = new Hashtable();

		public HollowcandlestickSeriesStatesSelectMarker()
		{
			...
			States = States_DefaultValue = new HollowcandlestickSeriesStatesSelectMarkerStates();
		...
		/// </summary>
		public HollowcandlestickSeriesStatesSelectMarkerStates States { get; set; }
		private HollowcandlestickSeriesStatesSelectMarkerStates States_DefaultValue { get; set; }
