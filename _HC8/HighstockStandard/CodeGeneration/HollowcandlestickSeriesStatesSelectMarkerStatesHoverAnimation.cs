...
{
	public partial class HollowcandlestickSeriesStatesSelectMarkerStatesHoverAnimation  : BaseObject
	{
		Hashtable h = new Hashtable();

		public HollowcandlestickSeriesStatesSelectMarkerStatesHoverAnimation()
		{
