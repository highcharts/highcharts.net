...
{
	public partial class HollowcandlestickSeriesTooltip  : BaseObject
	{
		Hashtable h = new Hashtable();

		public HollowcandlestickSeriesTooltip()
		{
			...
			HeaderShape = HeaderShape_DefaultValue = HollowcandlestickSeriesTooltipHeaderShape.Callout;
		...
		/// </summary>
		public HollowcandlestickSeriesTooltipHeaderShape HeaderShape { get; set; }
		private HollowcandlestickSeriesTooltipHeaderShape HeaderShape_DefaultValue { get; set; }
