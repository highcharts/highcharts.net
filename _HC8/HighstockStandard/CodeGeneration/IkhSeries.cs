...
namespace Highsoft.Web.Mvc.Stocks
{
	public partial class IkhSeries  : Series
	{
		...
		public IkhSeries()
		{
			...
			Type = Type_DefaultValue = IkhSeriesType.Null;
		...
		/// </summary>
		public IkhSeriesType Type { get; set; }
		private IkhSeriesType Type_DefaultValue { get; set; }
		...
		internal override Hashtable ToHashtable(ref Highstock highstock)
		{
			...
			if (ChikouLine.IsDirty(ref highstock)) h.Add("chikouLine",ChikouLine.ToHashtable(ref highstock));
			...
			if (KijunLine.IsDirty(ref highstock)) h.Add("kijunLine",KijunLine.ToHashtable(ref highstock));
			...
			if (TenkanLine.IsDirty(ref highstock)) h.Add("tenkanLine",TenkanLine.ToHashtable(ref highstock));
