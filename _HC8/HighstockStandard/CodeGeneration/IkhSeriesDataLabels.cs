...
{
	public partial class IkhSeriesDataLabels  : BaseObject
	{
		Hashtable h = new Hashtable();

		public IkhSeriesDataLabels()
		{
			Align = Align_DefaultValue = IkhSeriesDataLabelsAlign.Center;
			...
			Filter = Filter_DefaultValue = new IkhSeriesDataLabelsFilter();
			...
			Overflow = Overflow_DefaultValue = IkhSeriesDataLabelsOverflow.Justify;
			Padding = Padding_DefaultValue = 5;
			Position = Position_DefaultValue = IkhSeriesDataLabelsPosition.Center;
			...
			TextPath = TextPath_DefaultValue = new IkhSeriesDataLabelsTextPath();
			UseHTML = UseHTML_DefaultValue = false;
			VerticalAlign = VerticalAlign_DefaultValue = IkhSeriesDataLabelsVerticalAlign.Bottom;
			X = X_DefaultValue = 0;
			Y = Y_DefaultValue = 0;
			Z = Z_DefaultValue = 6;
		...
		/// </summary>
		public IkhSeriesDataLabelsAlign Align { get; set; }
		private IkhSeriesDataLabelsAlign Align_DefaultValue { get; set; }
		...
		/// </summary>
		public IkhSeriesDataLabelsFilter Filter { get; set; }
		private IkhSeriesDataLabelsFilter Filter_DefaultValue { get; set; }
		...
		/// </summary>
		public IkhSeriesDataLabelsOverflow Overflow { get; set; }
		private IkhSeriesDataLabelsOverflow Overflow_DefaultValue { get; set; }
		...
		/// </summary>
		public IkhSeriesDataLabelsPosition Position { get; set; }
		private IkhSeriesDataLabelsPosition Position_DefaultValue { get; set; }
		...
		/// </summary>
		public IkhSeriesDataLabelsTextPath TextPath { get; set; }
		private IkhSeriesDataLabelsTextPath TextPath_DefaultValue { get; set; }
		...
		/// </summary>
		public IkhSeriesDataLabelsVerticalAlign VerticalAlign { get; set; }
		private IkhSeriesDataLabelsVerticalAlign VerticalAlign_DefaultValue { get; set; }
