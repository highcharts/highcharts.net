...
{
	public partial class IkhSeriesLastPriceLabel  : BaseObject
	{
		Hashtable h = new Hashtable();

		public IkhSeriesLastPriceLabel()
		{
			Align = Align_DefaultValue = IkhSeriesLastPriceLabelAlign.Null;
		...
		/// 
		/// </summary>
		public IkhSeriesLastPriceLabelAlign Align { get; set; }
		private IkhSeriesLastPriceLabelAlign Align_DefaultValue { get; set; }
