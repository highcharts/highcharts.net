...
{
	public partial class IkhSeriesMarker  : BaseObject
	{
		Hashtable h = new Hashtable();

		public IkhSeriesMarker()
		{
			...
			States = States_DefaultValue = new IkhSeriesMarkerStates();
		...
		/// </summary>
		public IkhSeriesMarkerStates States { get; set; }
		private IkhSeriesMarkerStates States_DefaultValue { get; set; }
