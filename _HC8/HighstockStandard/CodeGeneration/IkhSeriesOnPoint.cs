...
{
	public partial class IkhSeriesOnPoint  : BaseObject
	{
		Hashtable h = new Hashtable();

		public IkhSeriesOnPoint()
		{
			ConnectorOptions = ConnectorOptions_DefaultValue = new IkhSeriesOnPointConnectorOptions();
			Id = Id_DefaultValue = "";
			Position = Position_DefaultValue = new IkhSeriesOnPointPosition();
		...
		/// </summary>
		public IkhSeriesOnPointConnectorOptions ConnectorOptions { get; set; }
		private IkhSeriesOnPointConnectorOptions ConnectorOptions_DefaultValue { get; set; }
		...
		/// </summary>
		public IkhSeriesOnPointPosition Position { get; set; }
		private IkhSeriesOnPointPosition Position_DefaultValue { get; set; }
