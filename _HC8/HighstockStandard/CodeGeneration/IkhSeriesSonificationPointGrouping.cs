...
{
	public partial class IkhSeriesSonificationPointGrouping  : BaseObject
	{
		Hashtable h = new Hashtable();

		public IkhSeriesSonificationPointGrouping()
		{
			Algorithm = Algorithm_DefaultValue = IkhSeriesSonificationPointGroupingAlgorithm.Minimax;
		...
		/// </summary>
		public IkhSeriesSonificationPointGroupingAlgorithm Algorithm { get; set; }
		private IkhSeriesSonificationPointGroupingAlgorithm Algorithm_DefaultValue { get; set; }
