...
{
	public partial class IkhSeriesSonificationTracksPointGrouping  : BaseObject
	{
		Hashtable h = new Hashtable();

		public IkhSeriesSonificationTracksPointGrouping()
		{
			Algorithm = Algorithm_DefaultValue = IkhSeriesSonificationTracksPointGroupingAlgorithm.Minimax;
		...
		/// </summary>
		public IkhSeriesSonificationTracksPointGroupingAlgorithm Algorithm { get; set; }
		private IkhSeriesSonificationTracksPointGroupingAlgorithm Algorithm_DefaultValue { get; set; }
