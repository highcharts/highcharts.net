...
{
	public partial class IkhSeriesStatesSelect  : BaseObject
	{
		Hashtable h = new Hashtable();

		public IkhSeriesStatesSelect()
		{
			Animation = Animation_DefaultValue = new Animation() { Enabled = true };
			Enabled = Enabled_DefaultValue = new Hashtable();
			Halo = Halo_DefaultValue = new IkhSeriesStatesSelectHalo();
			LineWidth = LineWidth_DefaultValue = new Hashtable();
			LineWidthPlus = LineWidthPlus_DefaultValue = new Hashtable();
			Marker = Marker_DefaultValue = new IkhSeriesStatesSelectMarker();
		...
		/// </summary>
		public IkhSeriesStatesSelectHalo Halo { get; set; }
		private IkhSeriesStatesSelectHalo Halo_DefaultValue { get; set; }
		...
		/// </summary>
		public IkhSeriesStatesSelectMarker Marker { get; set; }
		private IkhSeriesStatesSelectMarker Marker_DefaultValue { get; set; }
