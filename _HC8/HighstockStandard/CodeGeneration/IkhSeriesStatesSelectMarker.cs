...
{
	public partial class IkhSeriesStatesSelectMarker  : BaseObject
	{
		Hashtable h = new Hashtable();

		public IkhSeriesStatesSelectMarker()
		{
			...
			States = States_DefaultValue = new IkhSeriesStatesSelectMarkerStates();
		...
		/// </summary>
		public IkhSeriesStatesSelectMarkerStates States { get; set; }
		private IkhSeriesStatesSelectMarkerStates States_DefaultValue { get; set; }
