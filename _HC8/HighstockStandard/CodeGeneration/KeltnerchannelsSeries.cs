...
namespace Highsoft.Web.Mvc.Stocks
{
	public partial class KeltnerchannelsSeries  : Series
	{
		...
		public KeltnerchannelsSeries()
		{
			...
			DashStyle = DashStyle_DefaultValue = KeltnerchannelsSeriesDashStyle.Solid;
			...
			Type = Type_DefaultValue = KeltnerchannelsSeriesType.Keltnerchannels;
		...
		internal override Hashtable ToHashtable()
		{
			...
			if (PointDescriptionFormatter != PointDescriptionFormatter_DefaultValue) { h.Add("pointDescriptionFormatter",PointDescriptionFormatter); Highstock.AddFunction("KeltnerchannelsSeriesPointDescriptionFormatter.pointDescriptionFormatter", PointDescriptionFormatter); }  
