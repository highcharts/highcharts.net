...
namespace Highsoft.Web.Mvc.Stocks
{
	public partial class KeltnerchannelsSeries  : Series
	{
		...
		public KeltnerchannelsSeries()
		{
			...
			Type = Type_DefaultValue = KeltnerchannelsSeriesType.Null;
		...
		/// </summary>
		public KeltnerchannelsSeriesType Type { get; set; }
		private KeltnerchannelsSeriesType Type_DefaultValue { get; set; }
