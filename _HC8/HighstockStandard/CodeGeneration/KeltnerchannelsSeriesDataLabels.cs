...
{
	public partial class KeltnerchannelsSeriesDataLabels  : BaseObject
	{
		Hashtable h = new Hashtable();

		public KeltnerchannelsSeriesDataLabels()
		{
			Align = Align_DefaultValue = KeltnerchannelsSeriesDataLabelsAlign.Center;
			...
			Filter = Filter_DefaultValue = new KeltnerchannelsSeriesDataLabelsFilter();
			...
			Overflow = Overflow_DefaultValue = KeltnerchannelsSeriesDataLabelsOverflow.Justify;
			Padding = Padding_DefaultValue = 5;
			Position = Position_DefaultValue = KeltnerchannelsSeriesDataLabelsPosition.Center;
			...
			TextPath = TextPath_DefaultValue = new KeltnerchannelsSeriesDataLabelsTextPath();
			UseHTML = UseHTML_DefaultValue = false;
			VerticalAlign = VerticalAlign_DefaultValue = KeltnerchannelsSeriesDataLabelsVerticalAlign.Bottom;
			X = X_DefaultValue = 0;
			Y = Y_DefaultValue = 0;
			Z = Z_DefaultValue = 6;
		...
		/// </summary>
		public KeltnerchannelsSeriesDataLabelsAlign Align { get; set; }
		private KeltnerchannelsSeriesDataLabelsAlign Align_DefaultValue { get; set; }
		...
		/// </summary>
		public KeltnerchannelsSeriesDataLabelsFilter Filter { get; set; }
		private KeltnerchannelsSeriesDataLabelsFilter Filter_DefaultValue { get; set; }
		...
		/// </summary>
		public KeltnerchannelsSeriesDataLabelsOverflow Overflow { get; set; }
		private KeltnerchannelsSeriesDataLabelsOverflow Overflow_DefaultValue { get; set; }
		...
		/// </summary>
		public KeltnerchannelsSeriesDataLabelsPosition Position { get; set; }
		private KeltnerchannelsSeriesDataLabelsPosition Position_DefaultValue { get; set; }
		...
		/// </summary>
		public KeltnerchannelsSeriesDataLabelsTextPath TextPath { get; set; }
		private KeltnerchannelsSeriesDataLabelsTextPath TextPath_DefaultValue { get; set; }
		...
		/// </summary>
		public KeltnerchannelsSeriesDataLabelsVerticalAlign VerticalAlign { get; set; }
		private KeltnerchannelsSeriesDataLabelsVerticalAlign VerticalAlign_DefaultValue { get; set; }
