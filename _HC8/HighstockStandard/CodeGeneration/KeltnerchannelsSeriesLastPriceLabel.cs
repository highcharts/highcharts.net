...
{
	public partial class KeltnerchannelsSeriesLastPriceLabel  : BaseObject
	{
		Hashtable h = new Hashtable();

		public KeltnerchannelsSeriesLastPriceLabel()
		{
			Align = Align_DefaultValue = KeltnerchannelsSeriesLastPriceLabelAlign.Null;
		...
		/// 
		/// </summary>
		public KeltnerchannelsSeriesLastPriceLabelAlign Align { get; set; }
		private KeltnerchannelsSeriesLastPriceLabelAlign Align_DefaultValue { get; set; }
