...
{
	public partial class KeltnerchannelsSeriesMarker  : BaseObject
	{
		Hashtable h = new Hashtable();

		public KeltnerchannelsSeriesMarker()
		{
			...
			States = States_DefaultValue = new KeltnerchannelsSeriesMarkerStates();
		...
		/// </summary>
		public KeltnerchannelsSeriesMarkerStates States { get; set; }
		private KeltnerchannelsSeriesMarkerStates States_DefaultValue { get; set; }
