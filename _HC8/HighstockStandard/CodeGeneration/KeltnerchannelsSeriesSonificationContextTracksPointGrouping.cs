...
{
	public partial class KeltnerchannelsSeriesSonificationContextTracksPointGrouping  : BaseObject
	{
		Hashtable h = new Hashtable();

		public KeltnerchannelsSeriesSonificationContextTracksPointGrouping()
		{
			Algorithm = Algorithm_DefaultValue = KeltnerchannelsSeriesSonificationContextTracksPointGroupingAlgorithm.Minimax;
		...
		/// </summary>
		public KeltnerchannelsSeriesSonificationContextTracksPointGroupingAlgorithm Algorithm { get; set; }
		private KeltnerchannelsSeriesSonificationContextTracksPointGroupingAlgorithm Algorithm_DefaultValue { get; set; }
