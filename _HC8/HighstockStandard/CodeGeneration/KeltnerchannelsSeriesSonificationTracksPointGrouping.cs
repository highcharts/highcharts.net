...
{
	public partial class KeltnerchannelsSeriesSonificationTracksPointGrouping  : BaseObject
	{
		Hashtable h = new Hashtable();

		public KeltnerchannelsSeriesSonificationTracksPointGrouping()
		{
			Algorithm = Algorithm_DefaultValue = KeltnerchannelsSeriesSonificationTracksPointGroupingAlgorithm.Minimax;
		...
		/// </summary>
		public KeltnerchannelsSeriesSonificationTracksPointGroupingAlgorithm Algorithm { get; set; }
		private KeltnerchannelsSeriesSonificationTracksPointGroupingAlgorithm Algorithm_DefaultValue { get; set; }
