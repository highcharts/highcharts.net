...
{
	public partial class KeltnerchannelsSeriesStatesHover  : BaseObject
	{
		Hashtable h = new Hashtable();

		public KeltnerchannelsSeriesStatesHover()
		{
			Animation = Animation_DefaultValue = new Animation() { Enabled = true };
			Enabled = Enabled_DefaultValue = null;
			Halo = Halo_DefaultValue = new KeltnerchannelsSeriesStatesHoverHalo();
			LineWidth = LineWidth_DefaultValue = null;
			LineWidthPlus = LineWidthPlus_DefaultValue = null;
			Marker = Marker_DefaultValue = new KeltnerchannelsSeriesStatesHoverMarker();
		...
		/// </summary>
		public KeltnerchannelsSeriesStatesHoverHalo Halo { get; set; }
		private KeltnerchannelsSeriesStatesHoverHalo Halo_DefaultValue { get; set; }
		...
		/// </summary>
		public KeltnerchannelsSeriesStatesHoverMarker Marker { get; set; }
		private KeltnerchannelsSeriesStatesHoverMarker Marker_DefaultValue { get; set; }
