...
{
	public partial class KeltnerchannelsSeriesStatesHoverMarker  : BaseObject
	{
		Hashtable h = new Hashtable();

		public KeltnerchannelsSeriesStatesHoverMarker()
		{
			...
			States = States_DefaultValue = new KeltnerchannelsSeriesStatesHoverMarkerStates();
		...
		/// </summary>
		public KeltnerchannelsSeriesStatesHoverMarkerStates States { get; set; }
		private KeltnerchannelsSeriesStatesHoverMarkerStates States_DefaultValue { get; set; }
