...
{
	public partial class KeltnerchannelsSeriesStatesHoverMarkerStatesHoverAnimation  : BaseObject
	{
		Hashtable h = new Hashtable();

		public KeltnerchannelsSeriesStatesHoverMarkerStatesHoverAnimation()
		{
