...
{
	public partial class KeltnerchannelsSeriesStatesSelectMarker  : BaseObject
	{
		Hashtable h = new Hashtable();

		public KeltnerchannelsSeriesStatesSelectMarker()
		{
			...
			States = States_DefaultValue = new KeltnerchannelsSeriesStatesSelectMarkerStates();
		...
		/// </summary>
		public KeltnerchannelsSeriesStatesSelectMarkerStates States { get; set; }
		private KeltnerchannelsSeriesStatesSelectMarkerStates States_DefaultValue { get; set; }
