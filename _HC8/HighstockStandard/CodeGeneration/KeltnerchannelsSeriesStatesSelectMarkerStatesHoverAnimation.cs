...
{
	public partial class KeltnerchannelsSeriesStatesSelectMarkerStatesHoverAnimation  : BaseObject
	{
		Hashtable h = new Hashtable();

		public KeltnerchannelsSeriesStatesSelectMarkerStatesHoverAnimation()
		{
