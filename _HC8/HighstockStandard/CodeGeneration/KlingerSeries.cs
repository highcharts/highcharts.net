...
namespace Highsoft.Web.Mvc.Stocks
{
	public partial class KlingerSeries  : Series
	{
		...
		public KlingerSeries()
		{
			...
			DragDrop = DragDrop_DefaultValue = new KlingerSeriesDragDrop();
		...
		/// </summary>
		public KlingerSeriesDragDrop DragDrop { get; set; }
		private KlingerSeriesDragDrop DragDrop_DefaultValue { get; set; }
