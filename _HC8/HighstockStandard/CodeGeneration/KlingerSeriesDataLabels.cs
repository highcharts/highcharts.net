...
{
	public partial class KlingerSeriesDataLabels  : BaseObject
	{
		Hashtable h = new Hashtable();

		public KlingerSeriesDataLabels()
		{
			Align = Align_DefaultValue = KlingerSeriesDataLabelsAlign.Center;
			...
			Filter = Filter_DefaultValue = new KlingerSeriesDataLabelsFilter();
			...
			Overflow = Overflow_DefaultValue = KlingerSeriesDataLabelsOverflow.Justify;
			Padding = Padding_DefaultValue = 5;
			Position = Position_DefaultValue = KlingerSeriesDataLabelsPosition.Center;
			...
			TextPath = TextPath_DefaultValue = new KlingerSeriesDataLabelsTextPath();
			UseHTML = UseHTML_DefaultValue = false;
			VerticalAlign = VerticalAlign_DefaultValue = KlingerSeriesDataLabelsVerticalAlign.Bottom;
			X = X_DefaultValue = 0;
			Y = Y_DefaultValue = 0;
			Z = Z_DefaultValue = 6;
		...
		/// </summary>
		public KlingerSeriesDataLabelsAlign Align { get; set; }
		private KlingerSeriesDataLabelsAlign Align_DefaultValue { get; set; }
		...
		/// </summary>
		public KlingerSeriesDataLabelsFilter Filter { get; set; }
		private KlingerSeriesDataLabelsFilter Filter_DefaultValue { get; set; }
		...
		/// </summary>
		public KlingerSeriesDataLabelsOverflow Overflow { get; set; }
		private KlingerSeriesDataLabelsOverflow Overflow_DefaultValue { get; set; }
		...
		/// </summary>
		public KlingerSeriesDataLabelsPosition Position { get; set; }
		private KlingerSeriesDataLabelsPosition Position_DefaultValue { get; set; }
		...
		/// </summary>
		public KlingerSeriesDataLabelsTextPath TextPath { get; set; }
		private KlingerSeriesDataLabelsTextPath TextPath_DefaultValue { get; set; }
		...
		/// </summary>
		public KlingerSeriesDataLabelsVerticalAlign VerticalAlign { get; set; }
		private KlingerSeriesDataLabelsVerticalAlign VerticalAlign_DefaultValue { get; set; }
