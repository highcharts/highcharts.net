...
{
	public partial class KlingerSeriesDragDrop  : BaseObject
	{
		Hashtable h = new Hashtable();

		public KlingerSeriesDragDrop()
		{
			...
			GuideBox = GuideBox_DefaultValue = new KlingerSeriesDragDropGuideBox();
		...
		/// </summary>
		public KlingerSeriesDragDropGuideBox GuideBox { get; set; }
		private KlingerSeriesDragDropGuideBox GuideBox_DefaultValue { get; set; }
