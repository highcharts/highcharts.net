...
{
	public partial class KlingerSeriesLastPriceLabel  : BaseObject
	{
		Hashtable h = new Hashtable();

		public KlingerSeriesLastPriceLabel()
		{
			Align = Align_DefaultValue = KlingerSeriesLastPriceLabelAlign.Null;
		...
		/// 
		/// </summary>
		public KlingerSeriesLastPriceLabelAlign Align { get; set; }
		private KlingerSeriesLastPriceLabelAlign Align_DefaultValue { get; set; }
