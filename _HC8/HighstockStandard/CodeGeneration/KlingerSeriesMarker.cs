...
{
	public partial class KlingerSeriesMarker  : BaseObject
	{
		Hashtable h = new Hashtable();

		public KlingerSeriesMarker()
		{
			...
			States = States_DefaultValue = new KlingerSeriesMarkerStates();
		...
		/// </summary>
		public KlingerSeriesMarkerStates States { get; set; }
		private KlingerSeriesMarkerStates States_DefaultValue { get; set; }
