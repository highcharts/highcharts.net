...
{
	public partial class KlingerSeriesOnPoint  : BaseObject
	{
		Hashtable h = new Hashtable();

		public KlingerSeriesOnPoint()
		{
			ConnectorOptions = ConnectorOptions_DefaultValue = new KlingerSeriesOnPointConnectorOptions();
			Id = Id_DefaultValue = "";
			Position = Position_DefaultValue = new KlingerSeriesOnPointPosition();
		...
		/// </summary>
		public KlingerSeriesOnPointConnectorOptions ConnectorOptions { get; set; }
		private KlingerSeriesOnPointConnectorOptions ConnectorOptions_DefaultValue { get; set; }
		...
		/// </summary>
		public KlingerSeriesOnPointPosition Position { get; set; }
		private KlingerSeriesOnPointPosition Position_DefaultValue { get; set; }
