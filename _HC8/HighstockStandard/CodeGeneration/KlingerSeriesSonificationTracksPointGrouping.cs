...
{
	public partial class KlingerSeriesSonificationTracksPointGrouping  : BaseObject
	{
		Hashtable h = new Hashtable();

		public KlingerSeriesSonificationTracksPointGrouping()
		{
			Algorithm = Algorithm_DefaultValue = KlingerSeriesSonificationTracksPointGroupingAlgorithm.Minimax;
		...
		/// </summary>
		public KlingerSeriesSonificationTracksPointGroupingAlgorithm Algorithm { get; set; }
		private KlingerSeriesSonificationTracksPointGroupingAlgorithm Algorithm_DefaultValue { get; set; }
