...
{
	public partial class KlingerSeriesStatesHover  : BaseObject
	{
		Hashtable h = new Hashtable();

		public KlingerSeriesStatesHover()
		{
			Animation = Animation_DefaultValue = new Animation() { Enabled = true };
			Enabled = Enabled_DefaultValue = null;
			Halo = Halo_DefaultValue = new KlingerSeriesStatesHoverHalo();
			LineWidth = LineWidth_DefaultValue = null;
			LineWidthPlus = LineWidthPlus_DefaultValue = null;
			Marker = Marker_DefaultValue = new KlingerSeriesStatesHoverMarker();
		...
		/// </summary>
		public KlingerSeriesStatesHoverHalo Halo { get; set; }
		private KlingerSeriesStatesHoverHalo Halo_DefaultValue { get; set; }
		...
		/// </summary>
		public KlingerSeriesStatesHoverMarker Marker { get; set; }
		private KlingerSeriesStatesHoverMarker Marker_DefaultValue { get; set; }
