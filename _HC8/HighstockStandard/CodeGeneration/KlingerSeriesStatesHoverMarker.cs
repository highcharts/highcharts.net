...
{
	public partial class KlingerSeriesStatesHoverMarker  : BaseObject
	{
		Hashtable h = new Hashtable();

		public KlingerSeriesStatesHoverMarker()
		{
			...
			States = States_DefaultValue = new KlingerSeriesStatesHoverMarkerStates();
		...
		/// </summary>
		public KlingerSeriesStatesHoverMarkerStates States { get; set; }
		private KlingerSeriesStatesHoverMarkerStates States_DefaultValue { get; set; }
