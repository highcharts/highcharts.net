...
{
	public partial class KlingerSeriesStatesSelect  : BaseObject
	{
		Hashtable h = new Hashtable();

		public KlingerSeriesStatesSelect()
		{
			Animation = Animation_DefaultValue = new Animation() { Enabled = true };
			Enabled = Enabled_DefaultValue = null;
			Halo = Halo_DefaultValue = new KlingerSeriesStatesSelectHalo();
			LineWidth = LineWidth_DefaultValue = null;
			LineWidthPlus = LineWidthPlus_DefaultValue = null;
			Marker = Marker_DefaultValue = new KlingerSeriesStatesSelectMarker();
		...
		/// </summary>
		public KlingerSeriesStatesSelectHalo Halo { get; set; }
		private KlingerSeriesStatesSelectHalo Halo_DefaultValue { get; set; }
		...
		/// </summary>
		public KlingerSeriesStatesSelectMarker Marker { get; set; }
		private KlingerSeriesStatesSelectMarker Marker_DefaultValue { get; set; }
