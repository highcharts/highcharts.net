...
{
	public partial class KlingerSeriesStatesSelectMarker  : BaseObject
	{
		Hashtable h = new Hashtable();

		public KlingerSeriesStatesSelectMarker()
		{
			...
			States = States_DefaultValue = new KlingerSeriesStatesSelectMarkerStates();
		...
		/// </summary>
		public KlingerSeriesStatesSelectMarkerStates States { get; set; }
		private KlingerSeriesStatesSelectMarkerStates States_DefaultValue { get; set; }
