...
{
	public partial class KlingerSeriesTooltip  : BaseObject
	{
		Hashtable h = new Hashtable();

		public KlingerSeriesTooltip()
		{
			...
			HeaderShape = HeaderShape_DefaultValue = KlingerSeriesTooltipHeaderShape.Callout;
		...
		/// </summary>
		public KlingerSeriesTooltipHeaderShape HeaderShape { get; set; }
		private KlingerSeriesTooltipHeaderShape HeaderShape_DefaultValue { get; set; }
