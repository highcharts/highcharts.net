...
{
	public partial class LineSeriesLastVisiblePriceLabel  : BaseObject
	{
		Hashtable h = new Hashtable();

		public LineSeriesLastVisiblePriceLabel()
		{
			Align = Align_DefaultValue = LineSeriesLastVisiblePriceLabelAlign.Null;
		...
		/// 
		/// </summary>
		public LineSeriesLastVisiblePriceLabelAlign Align { get; set; }
		private LineSeriesLastVisiblePriceLabelAlign Align_DefaultValue { get; set; }
