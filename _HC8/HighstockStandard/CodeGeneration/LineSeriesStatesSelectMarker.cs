...
{
	public partial class LineSeriesStatesSelectMarker  : BaseObject
	{
		Hashtable h = new Hashtable();

		public LineSeriesStatesSelectMarker()
		{
			...
			States = States_DefaultValue = new LineSeriesStatesSelectMarkerStates();
		...
		/// </summary>
		public LineSeriesStatesSelectMarkerStates States { get; set; }
		private LineSeriesStatesSelectMarkerStates States_DefaultValue { get; set; }
