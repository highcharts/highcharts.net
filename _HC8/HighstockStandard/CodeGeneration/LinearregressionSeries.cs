...
namespace Highsoft.Web.Mvc.Stocks
{
	public partial class LinearregressionSeries  : Series
	{
		...
		public LinearregressionSeries()
		{
			...
			DragDrop = DragDrop_DefaultValue = new LinearregressionSeriesDragDrop();
		...
		/// </summary>
		public LinearregressionSeriesDragDrop DragDrop { get; set; }
		private LinearregressionSeriesDragDrop DragDrop_DefaultValue { get; set; }
