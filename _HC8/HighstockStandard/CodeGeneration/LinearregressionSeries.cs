...
namespace Highsoft.Web.Mvc.Stocks
{
	public partial class LinearregressionSeries  : Series
	{
		...
		public LinearregressionSeries()
		{
			...
			Type = Type_DefaultValue = LinearregressionSeriesType.Null;
		...
		/// </summary>
		public LinearregressionSeriesType Type { get; set; }
		private LinearregressionSeriesType Type_DefaultValue { get; set; }
