...
namespace Highsoft.Web.Mvc.Stocks
{
	public partial class LinearregressionSeriesAccessibility  : BaseObject
	{
		...
		public LinearregressionSeriesAccessibility()
		{
			...
			Point = Point_DefaultValue = new LinearregressionSeriesAccessibilityPoint();
		...
		/// </summary>
		public LinearregressionSeriesAccessibilityPoint Point { get; set; }
		private LinearregressionSeriesAccessibilityPoint Point_DefaultValue { get; set; }
