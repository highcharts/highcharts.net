...
namespace Highsoft.Web.Mvc.Stocks
{
	public partial class LinearregressionSeriesDataGrouping  : BaseObject
	{
		...
		internal override Hashtable ToHashtable()
		{
			...
			if (Approximation != Approximation_DefaultValue) { h.Add("approximation",Approximation); Highstock.AddFunction("LinearregressionSeriesDataGroupingApproximation.approximation", Approximation); }  
