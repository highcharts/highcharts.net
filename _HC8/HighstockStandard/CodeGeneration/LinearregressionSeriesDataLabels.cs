...
{
	public partial class LinearregressionSeriesDataLabels  : BaseObject
	{
		Hashtable h = new Hashtable();

		public LinearregressionSeriesDataLabels()
		{
			Align = Align_DefaultValue = LinearregressionSeriesDataLabelsAlign.Center;
			...
			Filter = Filter_DefaultValue = new LinearregressionSeriesDataLabelsFilter();
			...
			Overflow = Overflow_DefaultValue = LinearregressionSeriesDataLabelsOverflow.Justify;
			Padding = Padding_DefaultValue = 5;
			Position = Position_DefaultValue = LinearregressionSeriesDataLabelsPosition.Center;
			...
			TextPath = TextPath_DefaultValue = new LinearregressionSeriesDataLabelsTextPath();
			UseHTML = UseHTML_DefaultValue = false;
			VerticalAlign = VerticalAlign_DefaultValue = LinearregressionSeriesDataLabelsVerticalAlign.Bottom;
			X = X_DefaultValue = 0;
			Y = Y_DefaultValue = 0;
			Z = Z_DefaultValue = 6;
		...
		/// </summary>
		public LinearregressionSeriesDataLabelsAlign Align { get; set; }
		private LinearregressionSeriesDataLabelsAlign Align_DefaultValue { get; set; }
		...
		/// </summary>
		public LinearregressionSeriesDataLabelsFilter Filter { get; set; }
		private LinearregressionSeriesDataLabelsFilter Filter_DefaultValue { get; set; }
		...
		/// </summary>
		public LinearregressionSeriesDataLabelsOverflow Overflow { get; set; }
		private LinearregressionSeriesDataLabelsOverflow Overflow_DefaultValue { get; set; }
		...
		/// </summary>
		public LinearregressionSeriesDataLabelsPosition Position { get; set; }
		private LinearregressionSeriesDataLabelsPosition Position_DefaultValue { get; set; }
		...
		/// </summary>
		public LinearregressionSeriesDataLabelsTextPath TextPath { get; set; }
		private LinearregressionSeriesDataLabelsTextPath TextPath_DefaultValue { get; set; }
		...
		/// </summary>
		public LinearregressionSeriesDataLabelsVerticalAlign VerticalAlign { get; set; }
		private LinearregressionSeriesDataLabelsVerticalAlign VerticalAlign_DefaultValue { get; set; }
