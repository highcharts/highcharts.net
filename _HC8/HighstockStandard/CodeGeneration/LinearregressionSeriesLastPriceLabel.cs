...
{
	public partial class LinearregressionSeriesLastPriceLabel  : BaseObject
	{
		Hashtable h = new Hashtable();

		public LinearregressionSeriesLastPriceLabel()
		{
			Align = Align_DefaultValue = LinearregressionSeriesLastPriceLabelAlign.Null;
		...
		/// 
		/// </summary>
		public LinearregressionSeriesLastPriceLabelAlign Align { get; set; }
		private LinearregressionSeriesLastPriceLabelAlign Align_DefaultValue { get; set; }
