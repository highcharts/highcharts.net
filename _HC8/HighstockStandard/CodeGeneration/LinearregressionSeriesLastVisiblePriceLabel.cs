...
{
	public partial class LinearregressionSeriesLastVisiblePriceLabel  : BaseObject
	{
		Hashtable h = new Hashtable();

		public LinearregressionSeriesLastVisiblePriceLabel()
		{
			Align = Align_DefaultValue = LinearregressionSeriesLastVisiblePriceLabelAlign.Null;
		...
		/// 
		/// </summary>
		public LinearregressionSeriesLastVisiblePriceLabelAlign Align { get; set; }
		private LinearregressionSeriesLastVisiblePriceLabelAlign Align_DefaultValue { get; set; }
