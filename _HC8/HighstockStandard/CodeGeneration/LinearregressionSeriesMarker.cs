...
{
	public partial class LinearregressionSeriesMarker  : BaseObject
	{
		Hashtable h = new Hashtable();

		public LinearregressionSeriesMarker()
		{
			...
			States = States_DefaultValue = new LinearregressionSeriesMarkerStates();
		...
		/// </summary>
		public LinearregressionSeriesMarkerStates States { get; set; }
		private LinearregressionSeriesMarkerStates States_DefaultValue { get; set; }
