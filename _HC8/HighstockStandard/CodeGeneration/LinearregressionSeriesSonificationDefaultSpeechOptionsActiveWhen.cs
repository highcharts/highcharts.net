...
{
	public partial class LinearregressionSeriesSonificationDefaultSpeechOptionsActiveWhen  : BaseObject
	{
		Hashtable h = new Hashtable();

		public LinearregressionSeriesSonificationDefaultSpeechOptionsActiveWhen()
		{
