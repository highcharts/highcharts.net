...
{
	public partial class LinearregressionSeriesSonificationPointGrouping  : BaseObject
	{
		Hashtable h = new Hashtable();

		public LinearregressionSeriesSonificationPointGrouping()
		{
			Algorithm = Algorithm_DefaultValue = LinearregressionSeriesSonificationPointGroupingAlgorithm.Minimax;
		...
		/// </summary>
		public LinearregressionSeriesSonificationPointGroupingAlgorithm Algorithm { get; set; }
		private LinearregressionSeriesSonificationPointGroupingAlgorithm Algorithm_DefaultValue { get; set; }
