...
{
	public partial class LinearregressionSeriesStatesHover  : BaseObject
	{
		Hashtable h = new Hashtable();

		public LinearregressionSeriesStatesHover()
		{
			Animation = Animation_DefaultValue = new Animation() { Enabled = true };
			Enabled = Enabled_DefaultValue = null;
			Halo = Halo_DefaultValue = new LinearregressionSeriesStatesHoverHalo();
			LineWidth = LineWidth_DefaultValue = null;
			LineWidthPlus = LineWidthPlus_DefaultValue = null;
			Marker = Marker_DefaultValue = new LinearregressionSeriesStatesHoverMarker();
		...
		/// </summary>
		public LinearregressionSeriesStatesHoverHalo Halo { get; set; }
		private LinearregressionSeriesStatesHoverHalo Halo_DefaultValue { get; set; }
		...
		/// </summary>
		public LinearregressionSeriesStatesHoverMarker Marker { get; set; }
		private LinearregressionSeriesStatesHoverMarker Marker_DefaultValue { get; set; }
