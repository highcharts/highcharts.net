...
{
	public partial class LinearregressionSeriesStatesHoverMarker  : BaseObject
	{
		Hashtable h = new Hashtable();

		public LinearregressionSeriesStatesHoverMarker()
		{
			...
			States = States_DefaultValue = new LinearregressionSeriesStatesHoverMarkerStates();
		...
		/// </summary>
		public LinearregressionSeriesStatesHoverMarkerStates States { get; set; }
		private LinearregressionSeriesStatesHoverMarkerStates States_DefaultValue { get; set; }
