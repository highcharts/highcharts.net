...
{
	public partial class LinearregressionSeriesStatesHoverMarkerStatesHoverAnimation  : BaseObject
	{
		Hashtable h = new Hashtable();

		public LinearregressionSeriesStatesHoverMarkerStatesHoverAnimation()
		{
