...
{
	public partial class LinearregressionSeriesStatesSelect  : BaseObject
	{
		Hashtable h = new Hashtable();

		public LinearregressionSeriesStatesSelect()
		{
			Animation = Animation_DefaultValue = new Animation() { Enabled = true };
			Enabled = Enabled_DefaultValue = null;
			Halo = Halo_DefaultValue = new LinearregressionSeriesStatesSelectHalo();
			LineWidth = LineWidth_DefaultValue = null;
			LineWidthPlus = LineWidthPlus_DefaultValue = null;
			Marker = Marker_DefaultValue = new LinearregressionSeriesStatesSelectMarker();
		...
		/// </summary>
		public LinearregressionSeriesStatesSelectHalo Halo { get; set; }
		private LinearregressionSeriesStatesSelectHalo Halo_DefaultValue { get; set; }
		...
		/// </summary>
		public LinearregressionSeriesStatesSelectMarker Marker { get; set; }
		private LinearregressionSeriesStatesSelectMarker Marker_DefaultValue { get; set; }
