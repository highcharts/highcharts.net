...
{
	public partial class LinearregressionSeriesStatesSelectMarker  : BaseObject
	{
		Hashtable h = new Hashtable();

		public LinearregressionSeriesStatesSelectMarker()
		{
			...
			States = States_DefaultValue = new LinearregressionSeriesStatesSelectMarkerStates();
		...
		/// </summary>
		public LinearregressionSeriesStatesSelectMarkerStates States { get; set; }
		private LinearregressionSeriesStatesSelectMarkerStates States_DefaultValue { get; set; }
