...
namespace Highsoft.Web.Mvc.Stocks
{
	public partial class LinearregressionangleSeries  : Series
	{
		...
		public LinearregressionangleSeries()
		{
			...
			DragDrop = DragDrop_DefaultValue = new LinearregressionangleSeriesDragDrop();
		...
		/// </summary>
		public LinearregressionangleSeriesDragDrop DragDrop { get; set; }
		private LinearregressionangleSeriesDragDrop DragDrop_DefaultValue { get; set; }
