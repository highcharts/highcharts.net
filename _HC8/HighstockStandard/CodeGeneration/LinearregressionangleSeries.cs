...
namespace Highsoft.Web.Mvc.Stocks
{
	public partial class LinearregressionangleSeries  : Series
	{
		...
		public LinearregressionangleSeries()
		{
			...
			DashStyle = DashStyle_DefaultValue = LinearregressionangleSeriesDashStyle.Solid;
			...
			Type = Type_DefaultValue = LinearregressionangleSeriesType.Linearregressionangle;
		...
		internal override Hashtable ToHashtable()
		{
			...
			if (PointDescriptionFormatter != PointDescriptionFormatter_DefaultValue) { h.Add("pointDescriptionFormatter",PointDescriptionFormatter); Highstock.AddFunction("LinearregressionangleSeriesPointDescriptionFormatter.pointDescriptionFormatter", PointDescriptionFormatter); }  
