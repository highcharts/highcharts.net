...
namespace Highsoft.Web.Mvc.Stocks
{
	public partial class LinearregressionangleSeries  : Series
	{
		...
		public LinearregressionangleSeries()
		{
			...
			Type = Type_DefaultValue = LinearregressionangleSeriesType.Null;
		...
		/// </summary>
		public LinearregressionangleSeriesType Type { get; set; }
		private LinearregressionangleSeriesType Type_DefaultValue { get; set; }
