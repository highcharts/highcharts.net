...
namespace Highsoft.Web.Mvc.Stocks
{
	public partial class LinearregressionangleSeriesAccessibility  : BaseObject
	{
		...
		public LinearregressionangleSeriesAccessibility()
		{
			...
			Point = Point_DefaultValue = new LinearregressionangleSeriesAccessibilityPoint();
		...
		/// </summary>
		public LinearregressionangleSeriesAccessibilityPoint Point { get; set; }
		private LinearregressionangleSeriesAccessibilityPoint Point_DefaultValue { get; set; }
