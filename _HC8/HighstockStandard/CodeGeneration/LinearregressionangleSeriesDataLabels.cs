...
{
	public partial class LinearregressionangleSeriesDataLabels  : BaseObject
	{
		Hashtable h = new Hashtable();

		public LinearregressionangleSeriesDataLabels()
		{
			Align = Align_DefaultValue = LinearregressionangleSeriesDataLabelsAlign.Center;
			...
			Filter = Filter_DefaultValue = new LinearregressionangleSeriesDataLabelsFilter();
			...
			Overflow = Overflow_DefaultValue = LinearregressionangleSeriesDataLabelsOverflow.Justify;
			Padding = Padding_DefaultValue = 5;
			Position = Position_DefaultValue = LinearregressionangleSeriesDataLabelsPosition.Center;
			...
			TextPath = TextPath_DefaultValue = new LinearregressionangleSeriesDataLabelsTextPath();
			UseHTML = UseHTML_DefaultValue = false;
			VerticalAlign = VerticalAlign_DefaultValue = LinearregressionangleSeriesDataLabelsVerticalAlign.Bottom;
			X = X_DefaultValue = 0;
			Y = Y_DefaultValue = 0;
			Z = Z_DefaultValue = 6;
		...
		/// </summary>
		public LinearregressionangleSeriesDataLabelsAlign Align { get; set; }
		private LinearregressionangleSeriesDataLabelsAlign Align_DefaultValue { get; set; }
		...
		/// </summary>
		public LinearregressionangleSeriesDataLabelsFilter Filter { get; set; }
		private LinearregressionangleSeriesDataLabelsFilter Filter_DefaultValue { get; set; }
		...
		/// </summary>
		public LinearregressionangleSeriesDataLabelsOverflow Overflow { get; set; }
		private LinearregressionangleSeriesDataLabelsOverflow Overflow_DefaultValue { get; set; }
		...
		/// </summary>
		public LinearregressionangleSeriesDataLabelsPosition Position { get; set; }
		private LinearregressionangleSeriesDataLabelsPosition Position_DefaultValue { get; set; }
		...
		/// </summary>
		public LinearregressionangleSeriesDataLabelsTextPath TextPath { get; set; }
		private LinearregressionangleSeriesDataLabelsTextPath TextPath_DefaultValue { get; set; }
		...
		/// </summary>
		public LinearregressionangleSeriesDataLabelsVerticalAlign VerticalAlign { get; set; }
		private LinearregressionangleSeriesDataLabelsVerticalAlign VerticalAlign_DefaultValue { get; set; }
