...
namespace Highsoft.Web.Mvc.Stocks
{
	public partial class LinearregressionangleSeriesDataLabels  : BaseObject
	{
		...
		internal override Hashtable ToHashtable()
		{
			...
			if (Formatter != Formatter_DefaultValue) { h.Add("formatter",Formatter); Highstock.AddFunction("LinearregressionangleSeriesDataLabelsFormatter.formatter", Formatter); }  
			...
			if (NullFormatter != NullFormatter_DefaultValue) { h.Add("nullFormatter",NullFormatter); Highstock.AddFunction("LinearregressionangleSeriesDataLabelsNullFormatter.nullFormatter", NullFormatter); }  
