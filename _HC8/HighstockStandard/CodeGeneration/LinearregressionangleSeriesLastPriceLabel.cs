...
{
	public partial class LinearregressionangleSeriesLastPriceLabel  : BaseObject
	{
		Hashtable h = new Hashtable();

		public LinearregressionangleSeriesLastPriceLabel()
		{
			Align = Align_DefaultValue = LinearregressionangleSeriesLastPriceLabelAlign.Null;
		...
		/// 
		/// </summary>
		public LinearregressionangleSeriesLastPriceLabelAlign Align { get; set; }
		private LinearregressionangleSeriesLastPriceLabelAlign Align_DefaultValue { get; set; }
