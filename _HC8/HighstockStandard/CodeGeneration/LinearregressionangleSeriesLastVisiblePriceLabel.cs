...
{
	public partial class LinearregressionangleSeriesLastVisiblePriceLabel  : BaseObject
	{
		Hashtable h = new Hashtable();

		public LinearregressionangleSeriesLastVisiblePriceLabel()
		{
			Align = Align_DefaultValue = LinearregressionangleSeriesLastVisiblePriceLabelAlign.Null;
		...
		/// 
		/// </summary>
		public LinearregressionangleSeriesLastVisiblePriceLabelAlign Align { get; set; }
		private LinearregressionangleSeriesLastVisiblePriceLabelAlign Align_DefaultValue { get; set; }
