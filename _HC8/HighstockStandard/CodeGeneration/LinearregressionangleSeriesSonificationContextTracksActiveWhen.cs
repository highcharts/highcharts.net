...
{
	public partial class LinearregressionangleSeriesSonificationContextTracksActiveWhen  : BaseObject
	{
		Hashtable h = new Hashtable();

		public LinearregressionangleSeriesSonificationContextTracksActiveWhen()
		{
