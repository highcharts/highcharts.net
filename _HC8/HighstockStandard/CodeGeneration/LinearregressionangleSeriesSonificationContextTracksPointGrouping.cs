...
{
	public partial class LinearregressionangleSeriesSonificationContextTracksPointGrouping  : BaseObject
	{
		Hashtable h = new Hashtable();

		public LinearregressionangleSeriesSonificationContextTracksPointGrouping()
		{
			Algorithm = Algorithm_DefaultValue = LinearregressionangleSeriesSonificationContextTracksPointGroupingAlgorithm.Minimax;
		...
		/// </summary>
		public LinearregressionangleSeriesSonificationContextTracksPointGroupingAlgorithm Algorithm { get; set; }
		private LinearregressionangleSeriesSonificationContextTracksPointGroupingAlgorithm Algorithm_DefaultValue { get; set; }
