...
{
	public partial class LinearregressionangleSeriesStates  : BaseObject
	{
		Hashtable h = new Hashtable();

		public LinearregressionangleSeriesStates()
		{
		...
		/// </summary>
		public LinearregressionangleSeriesStatesHover Hover { get; set; }
		private LinearregressionangleSeriesStatesHover Hover_DefaultValue { get; set; }
		 

		/// <summary>
		/// The opposite state of a hover for series.
		/// </summary>
		public LinearregressionangleSeriesStatesInactive Inactive { get; set; }
		private LinearregressionangleSeriesStatesInactive Inactive_DefaultValue { get; set; }
