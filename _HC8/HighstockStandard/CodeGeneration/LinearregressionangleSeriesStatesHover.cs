...
{
	public partial class LinearregressionangleSeriesStatesHover  : BaseObject
	{
		Hashtable h = new Hashtable();

		public LinearregressionangleSeriesStatesHover()
		{
			Animation = Animation_DefaultValue = new Animation() { Enabled = true };
			Enabled = Enabled_DefaultValue = null;
			Halo = Halo_DefaultValue = new LinearregressionangleSeriesStatesHoverHalo();
			LineWidth = LineWidth_DefaultValue = null;
			LineWidthPlus = LineWidthPlus_DefaultValue = null;
			Marker = Marker_DefaultValue = new LinearregressionangleSeriesStatesHoverMarker();
		...
		/// </summary>
		public LinearregressionangleSeriesStatesHoverMarker Marker { get; set; }
		private LinearregressionangleSeriesStatesHoverMarker Marker_DefaultValue { get; set; }
