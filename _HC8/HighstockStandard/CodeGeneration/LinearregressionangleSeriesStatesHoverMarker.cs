...
{
	public partial class LinearregressionangleSeriesStatesHoverMarker  : BaseObject
	{
		Hashtable h = new Hashtable();

		public LinearregressionangleSeriesStatesHoverMarker()
		{
			...
			States = States_DefaultValue = new LinearregressionangleSeriesStatesHoverMarkerStates();
		...
		/// </summary>
		public LinearregressionangleSeriesStatesHoverMarkerStates States { get; set; }
		private LinearregressionangleSeriesStatesHoverMarkerStates States_DefaultValue { get; set; }
