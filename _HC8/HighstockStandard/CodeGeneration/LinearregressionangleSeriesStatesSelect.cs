...
{
	public partial class LinearregressionangleSeriesStatesSelect  : BaseObject
	{
		Hashtable h = new Hashtable();

		public LinearregressionangleSeriesStatesSelect()
		{
			Animation = Animation_DefaultValue = new Animation() { Enabled = true };
			Enabled = Enabled_DefaultValue = null;
			Halo = Halo_DefaultValue = new LinearregressionangleSeriesStatesSelectHalo();
			LineWidth = LineWidth_DefaultValue = null;
			LineWidthPlus = LineWidthPlus_DefaultValue = null;
			Marker = Marker_DefaultValue = new LinearregressionangleSeriesStatesSelectMarker();
		...
		/// </summary>
		public LinearregressionangleSeriesStatesSelectHalo Halo { get; set; }
		private LinearregressionangleSeriesStatesSelectHalo Halo_DefaultValue { get; set; }
		...
		/// </summary>
		public LinearregressionangleSeriesStatesSelectMarker Marker { get; set; }
		private LinearregressionangleSeriesStatesSelectMarker Marker_DefaultValue { get; set; }
