...
{
	public partial class LinearregressionangleSeriesStatesSelectMarker  : BaseObject
	{
		Hashtable h = new Hashtable();

		public LinearregressionangleSeriesStatesSelectMarker()
		{
			...
			States = States_DefaultValue = new LinearregressionangleSeriesStatesSelectMarkerStates();
		...
		/// </summary>
		public LinearregressionangleSeriesStatesSelectMarkerStates States { get; set; }
		private LinearregressionangleSeriesStatesSelectMarkerStates States_DefaultValue { get; set; }
