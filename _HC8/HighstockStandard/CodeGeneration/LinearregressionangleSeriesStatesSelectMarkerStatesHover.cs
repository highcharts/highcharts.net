...
{
	public partial class LinearregressionangleSeriesStatesSelectMarkerStatesHover  : BaseObject
	{
		Hashtable h = new Hashtable();

		public LinearregressionangleSeriesStatesSelectMarkerStatesHover()
		{
