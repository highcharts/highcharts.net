...
{
	public partial class LinearregressionangleSeriesStatesSelectMarkerStatesHoverAnimation  : BaseObject
	{
		Hashtable h = new Hashtable();

		public LinearregressionangleSeriesStatesSelectMarkerStatesHoverAnimation()
		{
