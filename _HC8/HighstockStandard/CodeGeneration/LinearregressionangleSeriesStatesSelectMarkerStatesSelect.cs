...
{
	public partial class LinearregressionangleSeriesStatesSelectMarkerStatesSelect  : BaseObject
	{
		Hashtable h = new Hashtable();

		public LinearregressionangleSeriesStatesSelectMarkerStatesSelect()
		{
