...
namespace Highsoft.Web.Mvc.Stocks
{
	public partial class LinearregressioninterceptSeries  : Series
	{
		...
		public LinearregressioninterceptSeries()
		{
			...
			Type = Type_DefaultValue = LinearregressioninterceptSeriesType.Null;
		...
		/// </summary>
		public LinearregressioninterceptSeriesType Type { get; set; }
		private LinearregressioninterceptSeriesType Type_DefaultValue { get; set; }
