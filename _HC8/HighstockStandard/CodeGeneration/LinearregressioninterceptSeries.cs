...
namespace Highsoft.Web.Mvc.Stocks
{
	public partial class LinearregressioninterceptSeries  : Series
	{
		...
		public LinearregressioninterceptSeries()
		{
			...
			DashStyle = DashStyle_DefaultValue = LinearregressioninterceptSeriesDashStyle.Solid;
            ...
            Type = Type_DefaultValue = LinearregressioninterceptSeriesType.Linearregressionintercept;
		...
		internal override Hashtable ToHashtable()
		{
			...
			if (PointDescriptionFormatter != PointDescriptionFormatter_DefaultValue) { h.Add("pointDescriptionFormatter",PointDescriptionFormatter); Highstock.AddFunction("LinearregressioninterceptSeriesPointDescriptionFormatter.pointDescriptionFormatter", PointDescriptionFormatter); }  
			...
			h.Add("type", Highstock.FirstCharacterToLower(Type.ToString()));
