...
{
	public partial class LinearregressioninterceptSeriesDataLabels  : BaseObject
	{
		Hashtable h = new Hashtable();

		public LinearregressioninterceptSeriesDataLabels()
		{
			Align = Align_DefaultValue = LinearregressioninterceptSeriesDataLabelsAlign.Center;
			...
			Filter = Filter_DefaultValue = new LinearregressioninterceptSeriesDataLabelsFilter();
			...
			Overflow = Overflow_DefaultValue = LinearregressioninterceptSeriesDataLabelsOverflow.Justify;
			Padding = Padding_DefaultValue = 5;
			Position = Position_DefaultValue = LinearregressioninterceptSeriesDataLabelsPosition.Center;
			...
			TextPath = TextPath_DefaultValue = new LinearregressioninterceptSeriesDataLabelsTextPath();
			UseHTML = UseHTML_DefaultValue = false;
			VerticalAlign = VerticalAlign_DefaultValue = LinearregressioninterceptSeriesDataLabelsVerticalAlign.Bottom;
			X = X_DefaultValue = 0;
			Y = Y_DefaultValue = 0;
			Z = Z_DefaultValue = 6;
		...
		/// </summary>
		public LinearregressioninterceptSeriesDataLabelsAlign Align { get; set; }
		private LinearregressioninterceptSeriesDataLabelsAlign Align_DefaultValue { get; set; }
		...
		/// </summary>
		public LinearregressioninterceptSeriesDataLabelsFilter Filter { get; set; }
		private LinearregressioninterceptSeriesDataLabelsFilter Filter_DefaultValue { get; set; }
		...
		/// </summary>
		public LinearregressioninterceptSeriesDataLabelsOverflow Overflow { get; set; }
		private LinearregressioninterceptSeriesDataLabelsOverflow Overflow_DefaultValue { get; set; }
		...
		/// </summary>
		public LinearregressioninterceptSeriesDataLabelsPosition Position { get; set; }
		private LinearregressioninterceptSeriesDataLabelsPosition Position_DefaultValue { get; set; }
		...
		/// </summary>
		public LinearregressioninterceptSeriesDataLabelsTextPath TextPath { get; set; }
		private LinearregressioninterceptSeriesDataLabelsTextPath TextPath_DefaultValue { get; set; }
		...
		/// </summary>
		public LinearregressioninterceptSeriesDataLabelsVerticalAlign VerticalAlign { get; set; }
		private LinearregressioninterceptSeriesDataLabelsVerticalAlign VerticalAlign_DefaultValue { get; set; }
