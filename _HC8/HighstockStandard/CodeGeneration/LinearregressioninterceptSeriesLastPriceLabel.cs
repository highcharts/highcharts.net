...
{
	public partial class LinearregressioninterceptSeriesLastPriceLabel  : BaseObject
	{
		Hashtable h = new Hashtable();

		public LinearregressioninterceptSeriesLastPriceLabel()
		{
			Align = Align_DefaultValue = LinearregressioninterceptSeriesLastPriceLabelAlign.Null;
		...
		/// 
		/// </summary>
		public LinearregressioninterceptSeriesLastPriceLabelAlign Align { get; set; }
		private LinearregressioninterceptSeriesLastPriceLabelAlign Align_DefaultValue { get; set; }
