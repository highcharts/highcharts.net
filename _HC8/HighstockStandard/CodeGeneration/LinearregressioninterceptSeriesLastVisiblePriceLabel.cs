...
{
	public partial class LinearregressioninterceptSeriesLastVisiblePriceLabel  : BaseObject
	{
		Hashtable h = new Hashtable();

		public LinearregressioninterceptSeriesLastVisiblePriceLabel()
		{
			Align = Align_DefaultValue = LinearregressioninterceptSeriesLastVisiblePriceLabelAlign.Null;
		...
		/// 
		/// </summary>
		public LinearregressioninterceptSeriesLastVisiblePriceLabelAlign Align { get; set; }
		private LinearregressioninterceptSeriesLastVisiblePriceLabelAlign Align_DefaultValue { get; set; }
