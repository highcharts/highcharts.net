...
{
	public partial class LinearregressioninterceptSeriesMarker  : BaseObject
	{
		Hashtable h = new Hashtable();

		public LinearregressioninterceptSeriesMarker()
		{
			...
			States = States_DefaultValue = new LinearregressioninterceptSeriesMarkerStates();
		...
		/// </summary>
		public LinearregressioninterceptSeriesMarkerStates States { get; set; }
		private LinearregressioninterceptSeriesMarkerStates States_DefaultValue { get; set; }
