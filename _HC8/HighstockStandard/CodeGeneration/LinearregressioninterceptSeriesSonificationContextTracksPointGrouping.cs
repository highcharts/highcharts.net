...
{
	public partial class LinearregressioninterceptSeriesSonificationContextTracksPointGrouping  : BaseObject
	{
		Hashtable h = new Hashtable();

		public LinearregressioninterceptSeriesSonificationContextTracksPointGrouping()
		{
			Algorithm = Algorithm_DefaultValue = LinearregressioninterceptSeriesSonificationContextTracksPointGroupingAlgorithm.Minimax;
		...
		/// </summary>
		public LinearregressioninterceptSeriesSonificationContextTracksPointGroupingAlgorithm Algorithm { get; set; }
		private LinearregressioninterceptSeriesSonificationContextTracksPointGroupingAlgorithm Algorithm_DefaultValue { get; set; }
