...
{
	public partial class LinearregressioninterceptSeriesSonificationTracksPointGrouping  : BaseObject
	{
		Hashtable h = new Hashtable();

		public LinearregressioninterceptSeriesSonificationTracksPointGrouping()
		{
			Algorithm = Algorithm_DefaultValue = LinearregressioninterceptSeriesSonificationTracksPointGroupingAlgorithm.Minimax;
		...
		/// </summary>
		public LinearregressioninterceptSeriesSonificationTracksPointGroupingAlgorithm Algorithm { get; set; }
		private LinearregressioninterceptSeriesSonificationTracksPointGroupingAlgorithm Algorithm_DefaultValue { get; set; }
