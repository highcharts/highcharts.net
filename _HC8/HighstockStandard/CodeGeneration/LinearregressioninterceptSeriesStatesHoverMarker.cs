...
{
	public partial class LinearregressioninterceptSeriesStatesHoverMarker  : BaseObject
	{
		Hashtable h = new Hashtable();

		public LinearregressioninterceptSeriesStatesHoverMarker()
		{
			...
			States = States_DefaultValue = new LinearregressioninterceptSeriesStatesHoverMarkerStates();
		...
		/// </summary>
		public LinearregressioninterceptSeriesStatesHoverMarkerStates States { get; set; }
		private LinearregressioninterceptSeriesStatesHoverMarkerStates States_DefaultValue { get; set; }
