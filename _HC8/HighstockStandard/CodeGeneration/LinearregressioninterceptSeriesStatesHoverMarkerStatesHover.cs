...
{
	public partial class LinearregressioninterceptSeriesStatesHoverMarkerStatesHover  : BaseObject
	{
		Hashtable h = new Hashtable();

		public LinearregressioninterceptSeriesStatesHoverMarkerStatesHover()
		{
