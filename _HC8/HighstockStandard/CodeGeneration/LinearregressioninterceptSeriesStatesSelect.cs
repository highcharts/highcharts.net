...
{
	public partial class LinearregressioninterceptSeriesStatesSelect  : BaseObject
	{
		Hashtable h = new Hashtable();

		public LinearregressioninterceptSeriesStatesSelect()
		{
			Animation = Animation_DefaultValue = new Animation() { Enabled = true };
			Enabled = Enabled_DefaultValue = null;
			Halo = Halo_DefaultValue = new LinearregressioninterceptSeriesStatesSelectHalo();
			LineWidth = LineWidth_DefaultValue = null;
			LineWidthPlus = LineWidthPlus_DefaultValue = null;
			Marker = Marker_DefaultValue = new LinearregressioninterceptSeriesStatesSelectMarker();
		...
		/// </summary>
		public LinearregressioninterceptSeriesStatesSelectHalo Halo { get; set; }
		private LinearregressioninterceptSeriesStatesSelectHalo Halo_DefaultValue { get; set; }
		...
		/// </summary>
		public LinearregressioninterceptSeriesStatesSelectMarker Marker { get; set; }
		private LinearregressioninterceptSeriesStatesSelectMarker Marker_DefaultValue { get; set; }
