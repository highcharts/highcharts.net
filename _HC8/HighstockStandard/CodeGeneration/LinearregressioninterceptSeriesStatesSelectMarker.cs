...
{
	public partial class LinearregressioninterceptSeriesStatesSelectMarker  : BaseObject
	{
		Hashtable h = new Hashtable();

		public LinearregressioninterceptSeriesStatesSelectMarker()
		{
			...
			States = States_DefaultValue = new LinearregressioninterceptSeriesStatesSelectMarkerStates();
		...
		/// </summary>
		public LinearregressioninterceptSeriesStatesSelectMarkerStates States { get; set; }
		private LinearregressioninterceptSeriesStatesSelectMarkerStates States_DefaultValue { get; set; }
