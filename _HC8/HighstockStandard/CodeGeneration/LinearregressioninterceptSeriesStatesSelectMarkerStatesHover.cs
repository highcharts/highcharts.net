...
{
	public partial class LinearregressioninterceptSeriesStatesSelectMarkerStatesHover  : BaseObject
	{
		Hashtable h = new Hashtable();

		public LinearregressioninterceptSeriesStatesSelectMarkerStatesHover()
		{
