...
{
	public partial class LinearregressioninterceptSeriesStatesSelectMarkerStatesHoverAnimation  : BaseObject
	{
		Hashtable h = new Hashtable();

		public LinearregressioninterceptSeriesStatesSelectMarkerStatesHoverAnimation()
		{
