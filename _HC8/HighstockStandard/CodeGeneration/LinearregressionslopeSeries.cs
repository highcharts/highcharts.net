...
namespace Highsoft.Web.Mvc.Stocks
{
	public partial class LinearregressionslopeSeries  : Series
	{
		...
		public LinearregressionslopeSeries()
		{
			...
			DashStyle = DashStyle_DefaultValue = LinearregressionslopeSeriesDashStyle.Solid;
			...
			Type = Type_DefaultValue = LinearregressionslopeSeriesType.Linearregressionslope;
		...
		internal override Hashtable ToHashtable()
		{
			...
			if (PointDescriptionFormatter != PointDescriptionFormatter_DefaultValue) { h.Add("pointDescriptionFormatter",PointDescriptionFormatter); Highstock.AddFunction("LinearregressionslopeSeriesPointDescriptionFormatter.pointDescriptionFormatter", PointDescriptionFormatter); }  
