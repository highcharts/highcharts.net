...
namespace Highsoft.Web.Mvc.Stocks
{
	public partial class LinearregressionslopeSeries  : Series
	{
		...
		public LinearregressionslopeSeries()
		{
			...
			Type = Type_DefaultValue = LinearregressionslopeSeriesType.Null;
		...
		/// </summary>
		public LinearregressionslopeSeriesType Type { get; set; }
		private LinearregressionslopeSeriesType Type_DefaultValue { get; set; }
