...
namespace Highsoft.Web.Mvc.Stocks
{
	public partial class LinearregressionslopeSeries  : Series
	{
		...
		public LinearregressionslopeSeries()
		{
			...
			DragDrop = DragDrop_DefaultValue = new LinearregressionslopeSeriesDragDrop();
		...
		/// </summary>
		public LinearregressionslopeSeriesDragDrop DragDrop { get; set; }
		private LinearregressionslopeSeriesDragDrop DragDrop_DefaultValue { get; set; }
