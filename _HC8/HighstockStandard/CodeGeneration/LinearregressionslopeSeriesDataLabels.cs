...
{
	public partial class LinearregressionslopeSeriesDataLabels  : BaseObject
	{
		Hashtable h = new Hashtable();

		public LinearregressionslopeSeriesDataLabels()
		{
			Align = Align_DefaultValue = LinearregressionslopeSeriesDataLabelsAlign.Center;
			...
			Filter = Filter_DefaultValue = new LinearregressionslopeSeriesDataLabelsFilter();
			...
			Overflow = Overflow_DefaultValue = LinearregressionslopeSeriesDataLabelsOverflow.Justify;
			Padding = Padding_DefaultValue = 5;
			Position = Position_DefaultValue = LinearregressionslopeSeriesDataLabelsPosition.Center;
			...
			TextPath = TextPath_DefaultValue = new LinearregressionslopeSeriesDataLabelsTextPath();
			UseHTML = UseHTML_DefaultValue = false;
			VerticalAlign = VerticalAlign_DefaultValue = LinearregressionslopeSeriesDataLabelsVerticalAlign.Bottom;
			X = X_DefaultValue = 0;
			Y = Y_DefaultValue = 0;
			Z = Z_DefaultValue = 6;
		...
		/// </summary>
		public LinearregressionslopeSeriesDataLabelsAlign Align { get; set; }
		private LinearregressionslopeSeriesDataLabelsAlign Align_DefaultValue { get; set; }
		...
		/// </summary>
		public LinearregressionslopeSeriesDataLabelsFilter Filter { get; set; }
		private LinearregressionslopeSeriesDataLabelsFilter Filter_DefaultValue { get; set; }
		...
		/// </summary>
		public LinearregressionslopeSeriesDataLabelsOverflow Overflow { get; set; }
		private LinearregressionslopeSeriesDataLabelsOverflow Overflow_DefaultValue { get; set; }
		...
		/// </summary>
		public LinearregressionslopeSeriesDataLabelsPosition Position { get; set; }
		private LinearregressionslopeSeriesDataLabelsPosition Position_DefaultValue { get; set; }
		...
		/// </summary>
		public LinearregressionslopeSeriesDataLabelsTextPath TextPath { get; set; }
		private LinearregressionslopeSeriesDataLabelsTextPath TextPath_DefaultValue { get; set; }
		...
		/// </summary>
		public LinearregressionslopeSeriesDataLabelsVerticalAlign VerticalAlign { get; set; }
		private LinearregressionslopeSeriesDataLabelsVerticalAlign VerticalAlign_DefaultValue { get; set; }
