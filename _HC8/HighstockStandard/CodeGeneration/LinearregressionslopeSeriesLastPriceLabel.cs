...
{
	public partial class LinearregressionslopeSeriesLastPriceLabel  : BaseObject
	{
		Hashtable h = new Hashtable();

		public LinearregressionslopeSeriesLastPriceLabel()
		{
			Align = Align_DefaultValue = LinearregressionslopeSeriesLastPriceLabelAlign.Null;
		...
		/// 
		/// </summary>
		public LinearregressionslopeSeriesLastPriceLabelAlign Align { get; set; }
		private LinearregressionslopeSeriesLastPriceLabelAlign Align_DefaultValue { get; set; }
