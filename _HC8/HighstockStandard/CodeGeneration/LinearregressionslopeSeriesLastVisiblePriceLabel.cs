...
{
	public partial class LinearregressionslopeSeriesLastVisiblePriceLabel  : BaseObject
	{
		Hashtable h = new Hashtable();

		public LinearregressionslopeSeriesLastVisiblePriceLabel()
		{
			Align = Align_DefaultValue = LinearregressionslopeSeriesLastVisiblePriceLabelAlign.Null;
		...
		/// 
		/// </summary>
		public LinearregressionslopeSeriesLastVisiblePriceLabelAlign Align { get; set; }
		private LinearregressionslopeSeriesLastVisiblePriceLabelAlign Align_DefaultValue { get; set; }
