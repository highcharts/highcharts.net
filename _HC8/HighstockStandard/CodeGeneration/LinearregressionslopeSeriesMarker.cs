...
{
	public partial class LinearregressionslopeSeriesMarker  : BaseObject
	{
		Hashtable h = new Hashtable();

		public LinearregressionslopeSeriesMarker()
		{
			...
			States = States_DefaultValue = new LinearregressionslopeSeriesMarkerStates();
		...
		/// </summary>
		public LinearregressionslopeSeriesMarkerStates States { get; set; }
		private LinearregressionslopeSeriesMarkerStates States_DefaultValue { get; set; }
