...
{
	public partial class LinearregressionslopeSeriesSonificationPointGrouping  : BaseObject
	{
		Hashtable h = new Hashtable();

		public LinearregressionslopeSeriesSonificationPointGrouping()
		{
			Algorithm = Algorithm_DefaultValue = LinearregressionslopeSeriesSonificationPointGroupingAlgorithm.Minimax;
		...
		/// </summary>
		public LinearregressionslopeSeriesSonificationPointGroupingAlgorithm Algorithm { get; set; }
		private LinearregressionslopeSeriesSonificationPointGroupingAlgorithm Algorithm_DefaultValue { get; set; }
