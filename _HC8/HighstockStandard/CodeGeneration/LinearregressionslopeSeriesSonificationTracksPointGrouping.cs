...
{
	public partial class LinearregressionslopeSeriesSonificationTracksPointGrouping  : BaseObject
	{
		Hashtable h = new Hashtable();

		public LinearregressionslopeSeriesSonificationTracksPointGrouping()
		{
			Algorithm = Algorithm_DefaultValue = LinearregressionslopeSeriesSonificationTracksPointGroupingAlgorithm.Minimax;
		...
		/// </summary>
		public LinearregressionslopeSeriesSonificationTracksPointGroupingAlgorithm Algorithm { get; set; }
		private LinearregressionslopeSeriesSonificationTracksPointGroupingAlgorithm Algorithm_DefaultValue { get; set; }
