...
{
	public partial class LinearregressionslopeSeriesStatesHover  : BaseObject
	{
		Hashtable h = new Hashtable();

		public LinearregressionslopeSeriesStatesHover()
		{
			Animation = Animation_DefaultValue = new Animation() { Enabled = true };
			Enabled = Enabled_DefaultValue = null;
			Halo = Halo_DefaultValue = new LinearregressionslopeSeriesStatesHoverHalo();
			LineWidth = LineWidth_DefaultValue = null;
			LineWidthPlus = LineWidthPlus_DefaultValue = null;
			Marker = Marker_DefaultValue = new LinearregressionslopeSeriesStatesHoverMarker();
		...
		/// </summary>
		public LinearregressionslopeSeriesStatesHoverHalo Halo { get; set; }
		private LinearregressionslopeSeriesStatesHoverHalo Halo_DefaultValue { get; set; }
		...
		/// </summary>
		public LinearregressionslopeSeriesStatesHoverMarker Marker { get; set; }
		private LinearregressionslopeSeriesStatesHoverMarker Marker_DefaultValue { get; set; }
