...
{
	public partial class LinearregressionslopeSeriesStatesHoverMarkerStatesHoverAnimation  : BaseObject
	{
		Hashtable h = new Hashtable();

		public LinearregressionslopeSeriesStatesHoverMarkerStatesHoverAnimation()
		{
