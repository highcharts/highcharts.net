...
{
	public partial class LinearregressionslopeSeriesStatesHoverMarkerStatesSelect  : BaseObject
	{
		Hashtable h = new Hashtable();

		public LinearregressionslopeSeriesStatesHoverMarkerStatesSelect()
		{
