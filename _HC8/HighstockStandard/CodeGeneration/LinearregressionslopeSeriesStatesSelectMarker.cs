...
{
	public partial class LinearregressionslopeSeriesStatesSelectMarker  : BaseObject
	{
		Hashtable h = new Hashtable();

		public LinearregressionslopeSeriesStatesSelectMarker()
		{
			...
			States = States_DefaultValue = new LinearregressionslopeSeriesStatesSelectMarkerStates();
		...
		/// </summary>
		public LinearregressionslopeSeriesStatesSelectMarkerStates States { get; set; }
		private LinearregressionslopeSeriesStatesSelectMarkerStates States_DefaultValue { get; set; }
