...
{
	public partial class LinearregressionslopeSeriesStatesSelectMarkerStatesHover  : BaseObject
	{
		Hashtable h = new Hashtable();

		public LinearregressionslopeSeriesStatesSelectMarkerStatesHover()
		{
