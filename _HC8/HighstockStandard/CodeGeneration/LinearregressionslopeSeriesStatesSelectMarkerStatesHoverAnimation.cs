...
{
	public partial class LinearregressionslopeSeriesStatesSelectMarkerStatesHoverAnimation  : BaseObject
	{
		Hashtable h = new Hashtable();

		public LinearregressionslopeSeriesStatesSelectMarkerStatesHoverAnimation()
		{
