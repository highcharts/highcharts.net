...
{
	public partial class LinearregressionslopeSeriesStatesSelectMarkerStatesSelect  : BaseObject
	{
		Hashtable h = new Hashtable();

		public LinearregressionslopeSeriesStatesSelectMarkerStatesSelect()
		{
