...
namespace Highsoft.Web.Mvc.Stocks
{
	public partial class LollipopSeries  : Series
	{
		...
		public LollipopSeries()
		{
			...
			Type = Type_DefaultValue = LollipopSeriesType.Null;
		...
		/// </summary>
		public LollipopSeriesType Type { get; set; }
		private LollipopSeriesType Type_DefaultValue { get; set; }
		...
		internal override Hashtable ToHashtable()
		{
			...
			if (PointDescriptionFormatter != PointDescriptionFormatter_DefaultValue) { h.Add("pointDescriptionFormatter",PointDescriptionFormatter); Highstock.AddFunction("LollipopSeriesPointDescriptionFormatter.pointDescriptionFormatter", PointDescriptionFormatter); }  
