...
{
	public partial class LollipopSeriesData  : BaseObject
	{
		Hashtable h = new Hashtable();

		public LollipopSeriesData()
		{
			Accessibility = Accessibility_DefaultValue = new LollipopSeriesDataAccessibility();
			...
			DragDrop = DragDrop_DefaultValue = new LollipopSeriesDataDragDrop();
			Drilldown = Drilldown_DefaultValue = "";
			Events = Events_DefaultValue = new LollipopSeriesDataEvents();
			High = High_DefaultValue = null;
			Id = Id_DefaultValue = "";
			Labelrank = Labelrank_DefaultValue = null;
			Low = Low_DefaultValue = null;
			LowColor = LowColor_DefaultValue = "#333333";
			Marker = Marker_DefaultValue = new LollipopSeriesDataMarker();
		...
		/// </summary>
		public LollipopSeriesDataAccessibility Accessibility { get; set; }
		private LollipopSeriesDataAccessibility Accessibility_DefaultValue { get; set; }
		...
		/// </summary>
		public LollipopSeriesDataDragDrop DragDrop { get; set; }
		private LollipopSeriesDataDragDrop DragDrop_DefaultValue { get; set; }
		...
		/// </summary>
		public LollipopSeriesDataEvents Events { get; set; }
		private LollipopSeriesDataEvents Events_DefaultValue { get; set; }
		...
		/// </summary>
		public LollipopSeriesDataMarker Marker { get; set; }
		private LollipopSeriesDataMarker Marker_DefaultValue { get; set; }
