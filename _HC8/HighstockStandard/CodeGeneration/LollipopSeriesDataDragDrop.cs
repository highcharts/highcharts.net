...
{
	public partial class LollipopSeriesDataDragDrop  : BaseObject
	{
		Hashtable h = new Hashtable();

		public LollipopSeriesDataDragDrop()
		{
			DraggableX = DraggableX_DefaultValue = null;
			DraggableY = DraggableY_DefaultValue = null;
			DragHandle = DragHandle_DefaultValue = new LollipopSeriesDataDragDropDragHandle();
			...
			GuideBox = GuideBox_DefaultValue = new LollipopSeriesDataDragDropGuideBox();
		...
		/// </summary>
		public LollipopSeriesDataDragDropDragHandle DragHandle { get; set; }
		private LollipopSeriesDataDragDropDragHandle DragHandle_DefaultValue { get; set; }
		...
		/// </summary>
		public LollipopSeriesDataDragDropGuideBox GuideBox { get; set; }
		private LollipopSeriesDataDragDropGuideBox GuideBox_DefaultValue { get; set; }
