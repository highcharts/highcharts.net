...
{
	public partial class LollipopSeriesDataGrouping  : BaseObject
	{
		Hashtable h = new Hashtable();

		public LollipopSeriesDataGrouping()
		{
		...
		internal override Hashtable ToHashtable()
		{
			...
			if (Approximation != Approximation_DefaultValue) { h.Add("approximation",Approximation); Highstock.AddFunction("LollipopSeriesDataGroupingApproximation.approximation", Approximation); }  
