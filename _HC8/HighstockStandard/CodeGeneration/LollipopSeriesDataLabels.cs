...
namespace Highsoft.Web.Mvc.Stocks
{
	public partial class LollipopSeriesDataLabels  : BaseObject
	{
		...
		internal override Hashtable ToHashtable()
		{
			...
			if (Formatter != Formatter_DefaultValue) { h.Add("formatter",Formatter); Highstock.AddFunction("LollipopSeriesDataLabelsFormatter.formatter", Formatter); }  
			...
			if (NullFormatter != NullFormatter_DefaultValue) { h.Add("nullFormatter",NullFormatter); Highstock.AddFunction("LollipopSeriesDataLabelsNullFormatter.nullFormatter", NullFormatter); }  
