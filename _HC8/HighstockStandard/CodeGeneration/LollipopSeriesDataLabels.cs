...
namespace Highsoft.Web.Mvc.Stocks
{
	public partial class LollipopSeriesDataLabels  : BaseObject
	{
		...
		public LollipopSeriesDataLabels()
		{
			...
			Overflow = Overflow_DefaultValue = LollipopSeriesDataLabelsOverflow.Justify;
			Padding = Padding_DefaultValue = 5;
			Position = Position_DefaultValue = LollipopSeriesDataLabelsPosition.Center;
		...
		/// </summary>
		public LollipopSeriesDataLabelsOverflow Overflow { get; set; }
		private LollipopSeriesDataLabelsOverflow Overflow_DefaultValue { get; set; }
		...
		/// </summary>
		public LollipopSeriesDataLabelsPosition Position { get; set; }
		private LollipopSeriesDataLabelsPosition Position_DefaultValue { get; set; }
