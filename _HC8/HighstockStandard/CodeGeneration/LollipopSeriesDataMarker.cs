...
{
	public partial class LollipopSeriesDataMarker  : BaseObject
	{
		Hashtable h = new Hashtable();

		public LollipopSeriesDataMarker()
		{
			...
			States = States_DefaultValue = new LollipopSeriesDataMarkerStates();
		...
		/// </summary>
		public LollipopSeriesDataMarkerStates States { get; set; }
		private LollipopSeriesDataMarkerStates States_DefaultValue { get; set; }
