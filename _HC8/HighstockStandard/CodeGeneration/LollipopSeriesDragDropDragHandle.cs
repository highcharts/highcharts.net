...
{
	public partial class LollipopSeriesDragDropDragHandle  : BaseObject
	{
		Hashtable h = new Hashtable();

		public LollipopSeriesDragDropDragHandle()
		{
		...
		internal override Hashtable ToHashtable()
		{
			...
			if (PathFormatter != PathFormatter_DefaultValue) { h.Add("pathFormatter",PathFormatter); Highstock.AddFunction("LollipopSeriesDragDropDragHandlePathFormatter.pathFormatter", PathFormatter); }  
