...
{
	public partial class LollipopSeriesLastVisiblePriceLabel  : BaseObject
	{
		Hashtable h = new Hashtable();

		public LollipopSeriesLastVisiblePriceLabel()
		{
			Align = Align_DefaultValue = LollipopSeriesLastVisiblePriceLabelAlign.Null;
		...
		/// 
		/// </summary>
		public LollipopSeriesLastVisiblePriceLabelAlign Align { get; set; }
		private LollipopSeriesLastVisiblePriceLabelAlign Align_DefaultValue { get; set; }
