...
{
	public partial class LollipopSeriesStatesHover  : BaseObject
	{
		Hashtable h = new Hashtable();

		public LollipopSeriesStatesHover()
		{
			Animation = Animation_DefaultValue = new Animation() { Enabled = true };
			Enabled = Enabled_DefaultValue = null;
			Halo = Halo_DefaultValue = new LollipopSeriesStatesHoverHalo();
			LineWidth = LineWidth_DefaultValue = null;
			LineWidthPlus = LineWidthPlus_DefaultValue = null;
			Marker = Marker_DefaultValue = new LollipopSeriesStatesHoverMarker();
		...
		/// </summary>
		public LollipopSeriesStatesHoverHalo Halo { get; set; }
		private LollipopSeriesStatesHoverHalo Halo_DefaultValue { get; set; }
		...
		/// </summary>
		public LollipopSeriesStatesHoverMarker Marker { get; set; }
		private LollipopSeriesStatesHoverMarker Marker_DefaultValue { get; set; }
