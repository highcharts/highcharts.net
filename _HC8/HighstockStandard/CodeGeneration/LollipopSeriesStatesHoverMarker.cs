...
{
	public partial class LollipopSeriesStatesHoverMarker  : BaseObject
	{
		Hashtable h = new Hashtable();

		public LollipopSeriesStatesHoverMarker()
		{
			...
			States = States_DefaultValue = new LollipopSeriesStatesHoverMarkerStates();
		...
		/// </summary>
		public LollipopSeriesStatesHoverMarkerStates States { get; set; }
		private LollipopSeriesStatesHoverMarkerStates States_DefaultValue { get; set; }
