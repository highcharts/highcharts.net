...
namespace Highsoft.Web.Mvc.Stocks
{
	public partial class MacdSeries  : Series
	{
		...
		public MacdSeries()
		{
			...
			Type = Type_DefaultValue = MacdSeriesType.Null;
		...
		/// </summary>
		public MacdSeriesType Type { get; set; }
		private MacdSeriesType Type_DefaultValue { get; set; }
		...
		internal override Hashtable ToHashtable(ref Highstock highstock)
		{
			...
			if (MacdLine.IsDirty(ref highstock)) h.Add("macdLine",MacdLine.ToHashtable(ref highstock));
