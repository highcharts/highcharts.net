...
namespace Highsoft.Web.Mvc.Stocks
{
	public partial class MacdSeries  : Series
	{
		...
		public MacdSeries()
		{
			...
			DashStyle = DashStyle_DefaultValue = MacdSeriesDashStyle.Solid;
			...
			Type = Type_DefaultValue = MacdSeriesType.Macd;
		...
		internal override Hashtable ToHashtable()
		{
			...
			if (MacdLine.IsDirty()) h.Add("macdLine",MacdLine.ToHashtable());
			...
			if (PointDescriptionFormatter != PointDescriptionFormatter_DefaultValue) { h.Add("pointDescriptionFormatter",PointDescriptionFormatter); Highstock.AddFunction("MacdSeriesPointDescriptionFormatter.pointDescriptionFormatter", PointDescriptionFormatter); }  
