...
{
	public partial class MacdSeriesDataLabels  : BaseObject
	{
		Hashtable h = new Hashtable();

		public MacdSeriesDataLabels()
		{
			Align = Align_DefaultValue = MacdSeriesDataLabelsAlign.Center;
			...
			Filter = Filter_DefaultValue = new MacdSeriesDataLabelsFilter();
			...
			Overflow = Overflow_DefaultValue = MacdSeriesDataLabelsOverflow.Justify;
			Padding = Padding_DefaultValue = 5;
			Position = Position_DefaultValue = MacdSeriesDataLabelsPosition.Center;
			...
			TextPath = TextPath_DefaultValue = new MacdSeriesDataLabelsTextPath();
			UseHTML = UseHTML_DefaultValue = false;
			VerticalAlign = VerticalAlign_DefaultValue = MacdSeriesDataLabelsVerticalAlign.Bottom;
			X = X_DefaultValue = 0;
			Y = Y_DefaultValue = 0;
			Z = Z_DefaultValue = 6;
		...
		/// </summary>
		public MacdSeriesDataLabelsAlign Align { get; set; }
		private MacdSeriesDataLabelsAlign Align_DefaultValue { get; set; }
		...
		/// </summary>
		public MacdSeriesDataLabelsFilter Filter { get; set; }
		private MacdSeriesDataLabelsFilter Filter_DefaultValue { get; set; }
		...
		/// </summary>
		public MacdSeriesDataLabelsOverflow Overflow { get; set; }
		private MacdSeriesDataLabelsOverflow Overflow_DefaultValue { get; set; }
		...
		/// </summary>
		public MacdSeriesDataLabelsPosition Position { get; set; }
		private MacdSeriesDataLabelsPosition Position_DefaultValue { get; set; }
		...
		/// </summary>
		public MacdSeriesDataLabelsTextPath TextPath { get; set; }
		private MacdSeriesDataLabelsTextPath TextPath_DefaultValue { get; set; }
		...
		/// </summary>
		public MacdSeriesDataLabelsVerticalAlign VerticalAlign { get; set; }
		private MacdSeriesDataLabelsVerticalAlign VerticalAlign_DefaultValue { get; set; }
