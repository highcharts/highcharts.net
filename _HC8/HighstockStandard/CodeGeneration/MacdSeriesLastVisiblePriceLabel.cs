...
{
	public partial class MacdSeriesLastVisiblePriceLabel  : BaseObject
	{
		Hashtable h = new Hashtable();

		public MacdSeriesLastVisiblePriceLabel()
		{
			Align = Align_DefaultValue = MacdSeriesLastVisiblePriceLabelAlign.Null;
		...
		/// 
		/// </summary>
		public MacdSeriesLastVisiblePriceLabelAlign Align { get; set; }
		private MacdSeriesLastVisiblePriceLabelAlign Align_DefaultValue { get; set; }
