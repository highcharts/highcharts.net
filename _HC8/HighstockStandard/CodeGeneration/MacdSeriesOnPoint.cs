...
{
	public partial class MacdSeriesOnPoint  : BaseObject
	{
		Hashtable h = new Hashtable();

		public MacdSeriesOnPoint()
		{
			ConnectorOptions = ConnectorOptions_DefaultValue = new MacdSeriesOnPointConnectorOptions();
			Id = Id_DefaultValue = "";
			Position = Position_DefaultValue = new MacdSeriesOnPointPosition();
		...
		/// </summary>
		public MacdSeriesOnPointConnectorOptions ConnectorOptions { get; set; }
		private MacdSeriesOnPointConnectorOptions ConnectorOptions_DefaultValue { get; set; }
		...
		/// </summary>
		public MacdSeriesOnPointPosition Position { get; set; }
		private MacdSeriesOnPointPosition Position_DefaultValue { get; set; }
