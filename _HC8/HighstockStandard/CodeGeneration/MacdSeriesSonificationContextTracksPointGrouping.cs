...
{
	public partial class MacdSeriesSonificationContextTracksPointGrouping  : BaseObject
	{
		Hashtable h = new Hashtable();

		public MacdSeriesSonificationContextTracksPointGrouping()
		{
			Algorithm = Algorithm_DefaultValue = MacdSeriesSonificationContextTracksPointGroupingAlgorithm.Minimax;
		...
		/// </summary>
		public MacdSeriesSonificationContextTracksPointGroupingAlgorithm Algorithm { get; set; }
		private MacdSeriesSonificationContextTracksPointGroupingAlgorithm Algorithm_DefaultValue { get; set; }
