...
{
	public partial class MacdSeriesSonificationPointGrouping  : BaseObject
	{
		Hashtable h = new Hashtable();

		public MacdSeriesSonificationPointGrouping()
		{
			Algorithm = Algorithm_DefaultValue = MacdSeriesSonificationPointGroupingAlgorithm.Minimax;
		...
		/// </summary>
		public MacdSeriesSonificationPointGroupingAlgorithm Algorithm { get; set; }
		private MacdSeriesSonificationPointGroupingAlgorithm Algorithm_DefaultValue { get; set; }
