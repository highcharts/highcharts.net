...
{
	public partial class MacdSeriesSonificationTracksPointGrouping  : BaseObject
	{
		Hashtable h = new Hashtable();

		public MacdSeriesSonificationTracksPointGrouping()
		{
			Algorithm = Algorithm_DefaultValue = MacdSeriesSonificationTracksPointGroupingAlgorithm.Minimax;
		...
		/// </summary>
		public MacdSeriesSonificationTracksPointGroupingAlgorithm Algorithm { get; set; }
		private MacdSeriesSonificationTracksPointGroupingAlgorithm Algorithm_DefaultValue { get; set; }
