...
{
	public partial class MacdSeriesStatesHover  : BaseObject
	{
		Hashtable h = new Hashtable();

		public MacdSeriesStatesHover()
		{
			Animation = Animation_DefaultValue = new Animation() { Enabled = true };
			Enabled = Enabled_DefaultValue = null;
			Halo = Halo_DefaultValue = new MacdSeriesStatesHoverHalo();
			LineWidth = LineWidth_DefaultValue = null;
			LineWidthPlus = LineWidthPlus_DefaultValue = null;
			Marker = Marker_DefaultValue = new MacdSeriesStatesHoverMarker();
		...
		/// </summary>
		public MacdSeriesStatesHoverHalo Halo { get; set; }
		private MacdSeriesStatesHoverHalo Halo_DefaultValue { get; set; }
		...
		/// </summary>
		public MacdSeriesStatesHoverMarker Marker { get; set; }
		private MacdSeriesStatesHoverMarker Marker_DefaultValue { get; set; }
