...
{
	public partial class MacdSeriesStatesHoverMarker  : BaseObject
	{
		Hashtable h = new Hashtable();

		public MacdSeriesStatesHoverMarker()
		{
			...
			States = States_DefaultValue = new MacdSeriesStatesHoverMarkerStates();
		...
		/// </summary>
		public MacdSeriesStatesHoverMarkerStates States { get; set; }
		private MacdSeriesStatesHoverMarkerStates States_DefaultValue { get; set; }
