...
{
	public partial class MacdSeriesStatesSelect  : BaseObject
	{
		Hashtable h = new Hashtable();

		public MacdSeriesStatesSelect()
		{
			Animation = Animation_DefaultValue = new Animation() { Enabled = true };
			Enabled = Enabled_DefaultValue = null;
			Halo = Halo_DefaultValue = new MacdSeriesStatesSelectHalo();
			LineWidth = LineWidth_DefaultValue = null;
			LineWidthPlus = LineWidthPlus_DefaultValue = null;
			Marker = Marker_DefaultValue = new MacdSeriesStatesSelectMarker();
		...
		/// </summary>
		public MacdSeriesStatesSelectHalo Halo { get; set; }
		private MacdSeriesStatesSelectHalo Halo_DefaultValue { get; set; }
		...
		/// </summary>
		public MacdSeriesStatesSelectMarker Marker { get; set; }
		private MacdSeriesStatesSelectMarker Marker_DefaultValue { get; set; }
