...
namespace Highsoft.Web.Mvc.Stocks
{
	public partial class MfiSeriesDataGrouping  : BaseObject
	{
		...
		internal override Hashtable ToHashtable()
		{
			...
			if (Approximation != Approximation_DefaultValue) { h.Add("approximation",Approximation); Highstock.AddFunction("MfiSeriesDataGroupingApproximation.approximation", Approximation); }  
