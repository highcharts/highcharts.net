...
{
	public partial class MfiSeriesDataLabels  : BaseObject
	{
		Hashtable h = new Hashtable();

		public MfiSeriesDataLabels()
		{
			Align = Align_DefaultValue = MfiSeriesDataLabelsAlign.Center;
			...
			Filter = Filter_DefaultValue = new MfiSeriesDataLabelsFilter();
			...
			Overflow = Overflow_DefaultValue = MfiSeriesDataLabelsOverflow.Justify;
			Padding = Padding_DefaultValue = 5;
			Position = Position_DefaultValue = MfiSeriesDataLabelsPosition.Center;
			...
			TextPath = TextPath_DefaultValue = new MfiSeriesDataLabelsTextPath();
			UseHTML = UseHTML_DefaultValue = false;
			VerticalAlign = VerticalAlign_DefaultValue = MfiSeriesDataLabelsVerticalAlign.Bottom;
			X = X_DefaultValue = 0;
			Y = Y_DefaultValue = 0;
			Z = Z_DefaultValue = 6;
		...
		/// </summary>
		public MfiSeriesDataLabelsAlign Align { get; set; }
		private MfiSeriesDataLabelsAlign Align_DefaultValue { get; set; }
		...
		/// </summary>
		public MfiSeriesDataLabelsFilter Filter { get; set; }
		private MfiSeriesDataLabelsFilter Filter_DefaultValue { get; set; }
		...
		/// </summary>
		public MfiSeriesDataLabelsOverflow Overflow { get; set; }
		private MfiSeriesDataLabelsOverflow Overflow_DefaultValue { get; set; }
		...
		/// </summary>
		public MfiSeriesDataLabelsPosition Position { get; set; }
		private MfiSeriesDataLabelsPosition Position_DefaultValue { get; set; }
		...
		/// </summary>
		public MfiSeriesDataLabelsTextPath TextPath { get; set; }
		private MfiSeriesDataLabelsTextPath TextPath_DefaultValue { get; set; }
		...
		/// </summary>
		public MfiSeriesDataLabelsVerticalAlign VerticalAlign { get; set; }
		private MfiSeriesDataLabelsVerticalAlign VerticalAlign_DefaultValue { get; set; }
