...
{
	public partial class MfiSeriesLastPriceLabel  : BaseObject
	{
		Hashtable h = new Hashtable();

		public MfiSeriesLastPriceLabel()
		{
			Align = Align_DefaultValue = MfiSeriesLastPriceLabelAlign.Null;
		...
		/// 
		/// </summary>
		public MfiSeriesLastPriceLabelAlign Align { get; set; }
		private MfiSeriesLastPriceLabelAlign Align_DefaultValue { get; set; }
