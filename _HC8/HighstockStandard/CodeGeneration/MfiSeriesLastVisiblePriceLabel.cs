...
{
	public partial class MfiSeriesLastVisiblePriceLabel  : BaseObject
	{
		Hashtable h = new Hashtable();

		public MfiSeriesLastVisiblePriceLabel()
		{
			Align = Align_DefaultValue = MfiSeriesLastVisiblePriceLabelAlign.Null;
		...
		/// 
		/// </summary>
		public MfiSeriesLastVisiblePriceLabelAlign Align { get; set; }
		private MfiSeriesLastVisiblePriceLabelAlign Align_DefaultValue { get; set; }
