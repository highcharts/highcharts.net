...
{
	public partial class MfiSeriesMarker  : BaseObject
	{
		Hashtable h = new Hashtable();

		public MfiSeriesMarker()
		{
			...
			States = States_DefaultValue = new MfiSeriesMarkerStates();
		...
		/// </summary>
		public MfiSeriesMarkerStates States { get; set; }
		private MfiSeriesMarkerStates States_DefaultValue { get; set; }
