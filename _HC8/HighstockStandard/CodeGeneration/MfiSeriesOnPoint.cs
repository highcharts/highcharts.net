...
{
	public partial class MfiSeriesOnPoint  : BaseObject
	{
		Hashtable h = new Hashtable();

		public MfiSeriesOnPoint()
		{
			ConnectorOptions = ConnectorOptions_DefaultValue = new MfiSeriesOnPointConnectorOptions();
			Id = Id_DefaultValue = "";
			Position = Position_DefaultValue = new MfiSeriesOnPointPosition();
		...
		/// </summary>
		public MfiSeriesOnPointConnectorOptions ConnectorOptions { get; set; }
		private MfiSeriesOnPointConnectorOptions ConnectorOptions_DefaultValue { get; set; }
		...
		/// </summary>
		public MfiSeriesOnPointPosition Position { get; set; }
		private MfiSeriesOnPointPosition Position_DefaultValue { get; set; }
