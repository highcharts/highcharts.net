...
{
	public partial class MfiSeriesSonificationPointGrouping  : BaseObject
	{
		Hashtable h = new Hashtable();

		public MfiSeriesSonificationPointGrouping()
		{
			Algorithm = Algorithm_DefaultValue = MfiSeriesSonificationPointGroupingAlgorithm.Minimax;
		...
		/// </summary>
		public MfiSeriesSonificationPointGroupingAlgorithm Algorithm { get; set; }
		private MfiSeriesSonificationPointGroupingAlgorithm Algorithm_DefaultValue { get; set; }
