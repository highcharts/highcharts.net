...
{
	public partial class MfiSeriesStatesHover  : BaseObject
	{
		Hashtable h = new Hashtable();

		public MfiSeriesStatesHover()
		{
			Animation = Animation_DefaultValue = new Animation() { Enabled = true };
			Enabled = Enabled_DefaultValue = null;
			Halo = Halo_DefaultValue = new MfiSeriesStatesHoverHalo();
			LineWidth = LineWidth_DefaultValue = null;
			LineWidthPlus = LineWidthPlus_DefaultValue = null;
			Marker = Marker_DefaultValue = new MfiSeriesStatesHoverMarker();
		...
		/// </summary>
		public MfiSeriesStatesHoverHalo Halo { get; set; }
		private MfiSeriesStatesHoverHalo Halo_DefaultValue { get; set; }
		...
		/// </summary>
		public MfiSeriesStatesHoverMarker Marker { get; set; }
		private MfiSeriesStatesHoverMarker Marker_DefaultValue { get; set; }
