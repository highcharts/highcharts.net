...
namespace Highsoft.Web.Mvc.Stocks
{
	public partial class MomentumSeries  : Series
	{
		...
		public MomentumSeries()
		{
			...
			DashStyle = DashStyle_DefaultValue = MomentumSeriesDashStyle.Solid;
			...
			Type = Type_DefaultValue = MomentumSeriesType.Momentum;
		...
		internal override Hashtable ToHashtable()
		{
			...
			if (PointDescriptionFormatter != PointDescriptionFormatter_DefaultValue) { h.Add("pointDescriptionFormatter",PointDescriptionFormatter); Highstock.AddFunction("MomentumSeriesPointDescriptionFormatter.pointDescriptionFormatter", PointDescriptionFormatter); }  
