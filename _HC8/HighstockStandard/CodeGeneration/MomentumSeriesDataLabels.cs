...
{
	public partial class MomentumSeriesDataLabels  : BaseObject
	{
		Hashtable h = new Hashtable();

		public MomentumSeriesDataLabels()
		{
			Align = Align_DefaultValue = MomentumSeriesDataLabelsAlign.Center;
			...
			Filter = Filter_DefaultValue = new MomentumSeriesDataLabelsFilter();
			...
			Overflow = Overflow_DefaultValue = MomentumSeriesDataLabelsOverflow.Justify;
			Padding = Padding_DefaultValue = 5;
			Position = Position_DefaultValue = MomentumSeriesDataLabelsPosition.Center;
			...
			TextPath = TextPath_DefaultValue = new MomentumSeriesDataLabelsTextPath();
			UseHTML = UseHTML_DefaultValue = false;
			VerticalAlign = VerticalAlign_DefaultValue = MomentumSeriesDataLabelsVerticalAlign.Bottom;
			X = X_DefaultValue = 0;
			Y = Y_DefaultValue = 0;
			Z = Z_DefaultValue = 6;
		...
		/// </summary>
		public MomentumSeriesDataLabelsAlign Align { get; set; }
		private MomentumSeriesDataLabelsAlign Align_DefaultValue { get; set; }
		...
		/// </summary>
		public MomentumSeriesDataLabelsFilter Filter { get; set; }
		private MomentumSeriesDataLabelsFilter Filter_DefaultValue { get; set; }
		...
		/// </summary>
		public MomentumSeriesDataLabelsOverflow Overflow { get; set; }
		private MomentumSeriesDataLabelsOverflow Overflow_DefaultValue { get; set; }
		...
		/// </summary>
		public MomentumSeriesDataLabelsPosition Position { get; set; }
		private MomentumSeriesDataLabelsPosition Position_DefaultValue { get; set; }
		...
		/// </summary>
		public MomentumSeriesDataLabelsTextPath TextPath { get; set; }
		private MomentumSeriesDataLabelsTextPath TextPath_DefaultValue { get; set; }
		...
		/// </summary>
		public MomentumSeriesDataLabelsVerticalAlign VerticalAlign { get; set; }
		private MomentumSeriesDataLabelsVerticalAlign VerticalAlign_DefaultValue { get; set; }
