...
{
	public partial class MomentumSeriesLastPriceLabel  : BaseObject
	{
		Hashtable h = new Hashtable();

		public MomentumSeriesLastPriceLabel()
		{
			Align = Align_DefaultValue = MomentumSeriesLastPriceLabelAlign.Null;
		...
		/// 
		/// </summary>
		public MomentumSeriesLastPriceLabelAlign Align { get; set; }
		private MomentumSeriesLastPriceLabelAlign Align_DefaultValue { get; set; }
