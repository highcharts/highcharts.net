...
{
	public partial class MomentumSeriesLastVisiblePriceLabel  : BaseObject
	{
		Hashtable h = new Hashtable();

		public MomentumSeriesLastVisiblePriceLabel()
		{
			Align = Align_DefaultValue = MomentumSeriesLastVisiblePriceLabelAlign.Null;
		...
		/// 
		/// </summary>
		public MomentumSeriesLastVisiblePriceLabelAlign Align { get; set; }
		private MomentumSeriesLastVisiblePriceLabelAlign Align_DefaultValue { get; set; }
