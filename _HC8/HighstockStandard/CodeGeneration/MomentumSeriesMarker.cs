...
{
	public partial class MomentumSeriesMarker  : BaseObject
	{
		Hashtable h = new Hashtable();

		public MomentumSeriesMarker()
		{
			...
			States = States_DefaultValue = new MomentumSeriesMarkerStates();
		...
		/// </summary>
		public MomentumSeriesMarkerStates States { get; set; }
		private MomentumSeriesMarkerStates States_DefaultValue { get; set; }
