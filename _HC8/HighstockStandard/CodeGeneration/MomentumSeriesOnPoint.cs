...
{
	public partial class MomentumSeriesOnPoint  : BaseObject
	{
		Hashtable h = new Hashtable();

		public MomentumSeriesOnPoint()
		{
			ConnectorOptions = ConnectorOptions_DefaultValue = new MomentumSeriesOnPointConnectorOptions();
			Id = Id_DefaultValue = "";
			Position = Position_DefaultValue = new MomentumSeriesOnPointPosition();
		...
		/// </summary>
		public MomentumSeriesOnPointConnectorOptions ConnectorOptions { get; set; }
		private MomentumSeriesOnPointConnectorOptions ConnectorOptions_DefaultValue { get; set; }
		...
		/// </summary>
		public MomentumSeriesOnPointPosition Position { get; set; }
		private MomentumSeriesOnPointPosition Position_DefaultValue { get; set; }
