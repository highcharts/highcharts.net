...
{
	public partial class MomentumSeriesSonificationContextTracksPointGrouping  : BaseObject
	{
		Hashtable h = new Hashtable();

		public MomentumSeriesSonificationContextTracksPointGrouping()
		{
			Algorithm = Algorithm_DefaultValue = MomentumSeriesSonificationContextTracksPointGroupingAlgorithm.Minimax;
		...
		/// </summary>
		public MomentumSeriesSonificationContextTracksPointGroupingAlgorithm Algorithm { get; set; }
		private MomentumSeriesSonificationContextTracksPointGroupingAlgorithm Algorithm_DefaultValue { get; set; }
