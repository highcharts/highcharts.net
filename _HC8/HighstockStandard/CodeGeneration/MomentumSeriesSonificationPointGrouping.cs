...
{
	public partial class MomentumSeriesSonificationPointGrouping  : BaseObject
	{
		Hashtable h = new Hashtable();

		public MomentumSeriesSonificationPointGrouping()
		{
			Algorithm = Algorithm_DefaultValue = MomentumSeriesSonificationPointGroupingAlgorithm.Minimax;
		...
		/// </summary>
		public MomentumSeriesSonificationPointGroupingAlgorithm Algorithm { get; set; }
		private MomentumSeriesSonificationPointGroupingAlgorithm Algorithm_DefaultValue { get; set; }
