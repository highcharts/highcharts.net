...
{
	public partial class MomentumSeriesStatesSelect  : BaseObject
	{
		Hashtable h = new Hashtable();

		public MomentumSeriesStatesSelect()
		{
			Animation = Animation_DefaultValue = new Animation() { Enabled = true };
			Enabled = Enabled_DefaultValue = true;
			Halo = Halo_DefaultValue = new MomentumSeriesStatesSelectHalo();
			LineWidth = LineWidth_DefaultValue = null;
			LineWidthPlus = LineWidthPlus_DefaultValue = 1;
			Marker = Marker_DefaultValue = new MomentumSeriesStatesSelectMarker();
		...
		/// </summary>
		public MomentumSeriesStatesSelectHalo Halo { get; set; }
		private MomentumSeriesStatesSelectHalo Halo_DefaultValue { get; set; }
		...
		/// </summary>
		public MomentumSeriesStatesSelectMarker Marker { get; set; }
		private MomentumSeriesStatesSelectMarker Marker_DefaultValue { get; set; }
