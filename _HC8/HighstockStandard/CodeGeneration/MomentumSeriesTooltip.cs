...
{
	public partial class MomentumSeriesTooltip  : BaseObject
	{
		Hashtable h = new Hashtable();

		public MomentumSeriesTooltip()
		{
			...
			HeaderShape = HeaderShape_DefaultValue = MomentumSeriesTooltipHeaderShape.Callout;
		...
		/// </summary>
		public MomentumSeriesTooltipHeaderShape HeaderShape { get; set; }
		private MomentumSeriesTooltipHeaderShape HeaderShape_DefaultValue { get; set; }
		...
		internal override Hashtable ToHashtable()
		{
			...
			if (NullFormatter != NullFormatter_DefaultValue) { h.Add("nullFormatter",NullFormatter); Highstock.AddFunction("MomentumSeriesTooltipNullFormatter.nullFormatter", NullFormatter); }  
			if (Outside != Outside_DefaultValue) h.Add("outside",Outside);
			if (Padding != Padding_DefaultValue) h.Add("padding",Padding);
			if (PointFormat != PointFormat_DefaultValue) h.Add("pointFormat",PointFormat);
			if (PointFormatter != PointFormatter_DefaultValue) { h.Add("pointFormatter",PointFormatter); Highstock.AddFunction("MomentumSeriesTooltipPointFormatter.pointFormatter", PointFormatter); }  
