...
namespace Highsoft.Web.Mvc.Stocks
{
	public partial class NatrSeries  : Series
	{
		...
		public NatrSeries()
		{
			...
			DashStyle = DashStyle_DefaultValue = NatrSeriesDashStyle.Solid;
			...
			Type = Type_DefaultValue = NatrSeriesType.Natr;
		...
		/// </summary>
		public NatrSeriesType Type { get; set; }
		private NatrSeriesType Type_DefaultValue { get; set; }
		...
		internal override Hashtable ToHashtable()
		{
			...
			if (PointDescriptionFormatter != PointDescriptionFormatter_DefaultValue) { h.Add("pointDescriptionFormatter",PointDescriptionFormatter); Highstock.AddFunction("NatrSeriesPointDescriptionFormatter.pointDescriptionFormatter", PointDescriptionFormatter); }  
