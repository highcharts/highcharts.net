...
{
	public partial class NatrSeriesDataLabels  : BaseObject
	{
		Hashtable h = new Hashtable();

		public NatrSeriesDataLabels()
		{
			Align = Align_DefaultValue = NatrSeriesDataLabelsAlign.Center;
			...
			Filter = Filter_DefaultValue = new NatrSeriesDataLabelsFilter();
			...
			Overflow = Overflow_DefaultValue = NatrSeriesDataLabelsOverflow.Justify;
			Padding = Padding_DefaultValue = 5;
			Position = Position_DefaultValue = NatrSeriesDataLabelsPosition.Center;
			...
			TextPath = TextPath_DefaultValue = new NatrSeriesDataLabelsTextPath();
			UseHTML = UseHTML_DefaultValue = false;
			VerticalAlign = VerticalAlign_DefaultValue = NatrSeriesDataLabelsVerticalAlign.Bottom;
			X = X_DefaultValue = 0;
			Y = Y_DefaultValue = 0;
			Z = Z_DefaultValue = 6;
		...
		/// </summary>
		public NatrSeriesDataLabelsAlign Align { get; set; }
		private NatrSeriesDataLabelsAlign Align_DefaultValue { get; set; }
		...
		/// </summary>
		public NatrSeriesDataLabelsFilter Filter { get; set; }
		private NatrSeriesDataLabelsFilter Filter_DefaultValue { get; set; }
		...
		/// </summary>
		public NatrSeriesDataLabelsOverflow Overflow { get; set; }
		private NatrSeriesDataLabelsOverflow Overflow_DefaultValue { get; set; }
		...
		/// </summary>
		public NatrSeriesDataLabelsPosition Position { get; set; }
		private NatrSeriesDataLabelsPosition Position_DefaultValue { get; set; }
		...
		/// </summary>
		public NatrSeriesDataLabelsTextPath TextPath { get; set; }
		private NatrSeriesDataLabelsTextPath TextPath_DefaultValue { get; set; }
		...
		/// </summary>
		public NatrSeriesDataLabelsVerticalAlign VerticalAlign { get; set; }
		private NatrSeriesDataLabelsVerticalAlign VerticalAlign_DefaultValue { get; set; }
