...
namespace Highsoft.Web.Mvc.Stocks
{
	public partial class NatrSeriesLastPrice  : BaseObject
	{
		...
		public NatrSeriesLastPrice()
		{
			...
			Label = Label_DefaultValue = new NatrSeriesLastPriceLabel();
		...
		/// 
		/// </summary>
		public NatrSeriesLastPriceLabel Label { get; set; }
		private NatrSeriesLastPriceLabel Label_DefaultValue { get; set; }
