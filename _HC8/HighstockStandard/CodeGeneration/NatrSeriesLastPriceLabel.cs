...
{
	public partial class NatrSeriesLastPriceLabel  : BaseObject
	{
		Hashtable h = new Hashtable();

		public NatrSeriesLastPriceLabel()
		{
			Align = Align_DefaultValue = NatrSeriesLastPriceLabelAlign.Null;
		...
		/// 
		/// </summary>
		public NatrSeriesLastPriceLabelAlign Align { get; set; }
		private NatrSeriesLastPriceLabelAlign Align_DefaultValue { get; set; }
