...
{
	public partial class NatrSeriesLastVisiblePriceLabel  : BaseObject
	{
		Hashtable h = new Hashtable();

		public NatrSeriesLastVisiblePriceLabel()
		{
			Align = Align_DefaultValue = NatrSeriesLastVisiblePriceLabelAlign.Null;
		...
		/// 
		/// </summary>
		public NatrSeriesLastVisiblePriceLabelAlign Align { get; set; }
		private NatrSeriesLastVisiblePriceLabelAlign Align_DefaultValue { get; set; }
