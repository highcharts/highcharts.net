...
{
	public partial class NatrSeriesMarker  : BaseObject
	{
		Hashtable h = new Hashtable();

		public NatrSeriesMarker()
		{
			...
			States = States_DefaultValue = new NatrSeriesMarkerStates();
		...
		/// </summary>
		public NatrSeriesMarkerStates States { get; set; }
		private NatrSeriesMarkerStates States_DefaultValue { get; set; }
