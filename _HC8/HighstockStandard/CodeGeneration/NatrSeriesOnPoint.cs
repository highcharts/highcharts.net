...
{
	public partial class NatrSeriesOnPoint  : BaseObject
	{
		Hashtable h = new Hashtable();

		public NatrSeriesOnPoint()
		{
			ConnectorOptions = ConnectorOptions_DefaultValue = new NatrSeriesOnPointConnectorOptions();
			Id = Id_DefaultValue = "";
			Position = Position_DefaultValue = new NatrSeriesOnPointPosition();
		...
		/// </summary>
		public NatrSeriesOnPointConnectorOptions ConnectorOptions { get; set; }
		private NatrSeriesOnPointConnectorOptions ConnectorOptions_DefaultValue { get; set; }
		...
		/// </summary>
		public NatrSeriesOnPointPosition Position { get; set; }
		private NatrSeriesOnPointPosition Position_DefaultValue { get; set; }
