...
{
	public partial class NatrSeriesSonificationTracksPointGrouping  : BaseObject
	{
		Hashtable h = new Hashtable();

		public NatrSeriesSonificationTracksPointGrouping()
		{
			Algorithm = Algorithm_DefaultValue = NatrSeriesSonificationTracksPointGroupingAlgorithm.Minimax;
		...
		/// </summary>
		public NatrSeriesSonificationTracksPointGroupingAlgorithm Algorithm { get; set; }
		private NatrSeriesSonificationTracksPointGroupingAlgorithm Algorithm_DefaultValue { get; set; }
