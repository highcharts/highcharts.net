...
{
	public partial class NatrSeriesStatesHover  : BaseObject
	{
		Hashtable h = new Hashtable();

		public NatrSeriesStatesHover()
		{
			Animation = Animation_DefaultValue = new Animation() { Enabled = true };
			Enabled = Enabled_DefaultValue = null;
			Halo = Halo_DefaultValue = new NatrSeriesStatesHoverHalo();
			LineWidth = LineWidth_DefaultValue = null;
			LineWidthPlus = LineWidthPlus_DefaultValue = null;
			Marker = Marker_DefaultValue = new NatrSeriesStatesHoverMarker();
		...
		/// </summary>
		public NatrSeriesStatesHoverHalo Halo { get; set; }
		private NatrSeriesStatesHoverHalo Halo_DefaultValue { get; set; }
		...
		/// </summary>
		public NatrSeriesStatesHoverMarker Marker { get; set; }
		private NatrSeriesStatesHoverMarker Marker_DefaultValue { get; set; }
