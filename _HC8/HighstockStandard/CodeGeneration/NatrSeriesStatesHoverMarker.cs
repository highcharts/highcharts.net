...
{
	public partial class NatrSeriesStatesHoverMarker  : BaseObject
	{
		Hashtable h = new Hashtable();

		public NatrSeriesStatesHoverMarker()
		{
			...
			States = States_DefaultValue = new NatrSeriesStatesHoverMarkerStates();
		...
		/// </summary>
		public NatrSeriesStatesHoverMarkerStates States { get; set; }
		private NatrSeriesStatesHoverMarkerStates States_DefaultValue { get; set; }
