...
{
	public partial class NatrSeriesStatesSelect  : BaseObject
	{
		Hashtable h = new Hashtable();

		public NatrSeriesStatesSelect()
		{
			Animation = Animation_DefaultValue = new Animation() { Enabled = true };
			Enabled = Enabled_DefaultValue = null;
			Halo = Halo_DefaultValue = new NatrSeriesStatesSelectHalo();
			LineWidth = LineWidth_DefaultValue = null;
			LineWidthPlus = LineWidthPlus_DefaultValue = null;
			Marker = Marker_DefaultValue = new NatrSeriesStatesSelectMarker();
		...
		/// </summary>
		public NatrSeriesStatesSelectHalo Halo { get; set; }
		private NatrSeriesStatesSelectHalo Halo_DefaultValue { get; set; }
		...
		/// </summary>
		public NatrSeriesStatesSelectMarker Marker { get; set; }
		private NatrSeriesStatesSelectMarker Marker_DefaultValue { get; set; }
