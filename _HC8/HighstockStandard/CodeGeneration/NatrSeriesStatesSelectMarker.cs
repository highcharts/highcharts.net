...
{
	public partial class NatrSeriesStatesSelectMarker  : BaseObject
	{
		Hashtable h = new Hashtable();

		public NatrSeriesStatesSelectMarker()
		{
			...
			States = States_DefaultValue = new NatrSeriesStatesSelectMarkerStates();
		...
		/// </summary>
		public NatrSeriesStatesSelectMarkerStates States { get; set; }
		private NatrSeriesStatesSelectMarkerStates States_DefaultValue { get; set; }
