...
{
	public partial class NavigationAnnotationsOptionsFibonacciTimeZonesShapeOptions  : BaseObject
	{
		Hashtable h = new Hashtable();

		public NavigationAnnotationsOptionsFibonacciTimeZonesShapeOptions()
		{
			DashStyle = DashStyle_DefaultValue = NavigationAnnotationsOptionsFibonacciTimeZonesShapeOptionsDashStyle.Null;
		...
		/// </summary>
		public NavigationAnnotationsOptionsFibonacciTimeZonesShapeOptionsDashStyle DashStyle { get; set; }
		private NavigationAnnotationsOptionsFibonacciTimeZonesShapeOptionsDashStyle DashStyle_DefaultValue { get; set; }
