...
namespace Highsoft.Web.Mvc.Stocks
{
	public partial class NavigationAnnotationsOptionsLabelOptions  : BaseObject
	{
		...
		internal override Hashtable ToHashtable()
		{
			...
			if (Formatter != Formatter_DefaultValue) { h.Add("formatter",Formatter); Highstock.AddFunction("NavigationAnnotationsOptionsLabelOptionsFormatter.formatter", Formatter); }  
