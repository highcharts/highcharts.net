...
namespace Highsoft.Web.Mvc.Stocks
{
	public partial class NavigatorYAxisPlotBands  : BaseObject
	{
		...
		public NavigatorYAxisPlotBands()
		{
			...
			Events = Events_DefaultValue = new NavigatorYAxisPlotBandsEvents();
		...
		/// </summary>
		public NavigatorYAxisPlotBandsEvents Events { get; set; }
		private NavigatorYAxisPlotBandsEvents Events_DefaultValue { get; set; }
