...
{
	public partial class ObvSeriesDataLabels  : BaseObject
	{
		Hashtable h = new Hashtable();

		public ObvSeriesDataLabels()
		{
			Align = Align_DefaultValue = ObvSeriesDataLabelsAlign.Center;
			...
			Filter = Filter_DefaultValue = new ObvSeriesDataLabelsFilter();
			...
			Overflow = Overflow_DefaultValue = ObvSeriesDataLabelsOverflow.Justify;
			Padding = Padding_DefaultValue = 5;
			Position = Position_DefaultValue = ObvSeriesDataLabelsPosition.Center;
			...
			TextPath = TextPath_DefaultValue = new ObvSeriesDataLabelsTextPath();
			UseHTML = UseHTML_DefaultValue = false;
			VerticalAlign = VerticalAlign_DefaultValue = ObvSeriesDataLabelsVerticalAlign.Bottom;
			X = X_DefaultValue = 0;
			Y = Y_DefaultValue = 0;
			Z = Z_DefaultValue = 6;
		...
		/// </summary>
		public ObvSeriesDataLabelsAlign Align { get; set; }
		private ObvSeriesDataLabelsAlign Align_DefaultValue { get; set; }
		...
		/// </summary>
		public ObvSeriesDataLabelsFilter Filter { get; set; }
		private ObvSeriesDataLabelsFilter Filter_DefaultValue { get; set; }
		...
		/// </summary>
		public ObvSeriesDataLabelsOverflow Overflow { get; set; }
		private ObvSeriesDataLabelsOverflow Overflow_DefaultValue { get; set; }
		...
		/// </summary>
		public ObvSeriesDataLabelsPosition Position { get; set; }
		private ObvSeriesDataLabelsPosition Position_DefaultValue { get; set; }
		...
		/// </summary>
		public ObvSeriesDataLabelsTextPath TextPath { get; set; }
		private ObvSeriesDataLabelsTextPath TextPath_DefaultValue { get; set; }
		...
		/// </summary>
		public ObvSeriesDataLabelsVerticalAlign VerticalAlign { get; set; }
		private ObvSeriesDataLabelsVerticalAlign VerticalAlign_DefaultValue { get; set; }
