...
{
	public partial class ObvSeriesDragDrop  : BaseObject
	{
		Hashtable h = new Hashtable();

		public ObvSeriesDragDrop()
		{
			...
			GuideBox = GuideBox_DefaultValue = new ObvSeriesDragDropGuideBox();
		...
		/// </summary>
		public ObvSeriesDragDropGuideBox GuideBox { get; set; }
		private ObvSeriesDragDropGuideBox GuideBox_DefaultValue { get; set; }
