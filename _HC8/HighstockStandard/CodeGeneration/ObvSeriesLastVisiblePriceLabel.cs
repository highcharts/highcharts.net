...
{
	public partial class ObvSeriesLastVisiblePriceLabel  : BaseObject
	{
		Hashtable h = new Hashtable();

		public ObvSeriesLastVisiblePriceLabel()
		{
			Align = Align_DefaultValue = ObvSeriesLastVisiblePriceLabelAlign.Null;
		...
		/// 
		/// </summary>
		public ObvSeriesLastVisiblePriceLabelAlign Align { get; set; }
		private ObvSeriesLastVisiblePriceLabelAlign Align_DefaultValue { get; set; }
