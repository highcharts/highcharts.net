...
{
	public partial class ObvSeriesMarker  : BaseObject
	{
		Hashtable h = new Hashtable();

		public ObvSeriesMarker()
		{
			...
			States = States_DefaultValue = new ObvSeriesMarkerStates();
		...
		/// </summary>
		public ObvSeriesMarkerStates States { get; set; }
		private ObvSeriesMarkerStates States_DefaultValue { get; set; }
