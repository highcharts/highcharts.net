...
{
	public partial class ObvSeriesOnPoint  : BaseObject
	{
		Hashtable h = new Hashtable();

		public ObvSeriesOnPoint()
		{
			ConnectorOptions = ConnectorOptions_DefaultValue = new ObvSeriesOnPointConnectorOptions();
			Id = Id_DefaultValue = "";
			Position = Position_DefaultValue = new ObvSeriesOnPointPosition();
		...
		/// </summary>
		public ObvSeriesOnPointConnectorOptions ConnectorOptions { get; set; }
		private ObvSeriesOnPointConnectorOptions ConnectorOptions_DefaultValue { get; set; }
		...
		/// </summary>
		public ObvSeriesOnPointPosition Position { get; set; }
		private ObvSeriesOnPointPosition Position_DefaultValue { get; set; }
