...
{
	public partial class ObvSeriesSonificationTracksPointGrouping  : BaseObject
	{
		Hashtable h = new Hashtable();

		public ObvSeriesSonificationTracksPointGrouping()
		{
			Algorithm = Algorithm_DefaultValue = ObvSeriesSonificationTracksPointGroupingAlgorithm.Minimax;
		...
		/// </summary>
		public ObvSeriesSonificationTracksPointGroupingAlgorithm Algorithm { get; set; }
		private ObvSeriesSonificationTracksPointGroupingAlgorithm Algorithm_DefaultValue { get; set; }
