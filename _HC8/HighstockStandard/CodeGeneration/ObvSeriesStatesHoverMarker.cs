...
{
	public partial class ObvSeriesStatesHoverMarker  : BaseObject
	{
		Hashtable h = new Hashtable();

		public ObvSeriesStatesHoverMarker()
		{
			...
			States = States_DefaultValue = new ObvSeriesStatesHoverMarkerStates();
		...
		/// </summary>
		public ObvSeriesStatesHoverMarkerStates States { get; set; }
		private ObvSeriesStatesHoverMarkerStates States_DefaultValue { get; set; }
