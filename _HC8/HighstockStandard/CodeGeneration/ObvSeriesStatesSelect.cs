...
{
	public partial class ObvSeriesStatesSelect  : BaseObject
	{
		Hashtable h = new Hashtable();

		public ObvSeriesStatesSelect()
		{
			Animation = Animation_DefaultValue = new Animation() { Enabled = true };
			Enabled = Enabled_DefaultValue = null;
			Halo = Halo_DefaultValue = new ObvSeriesStatesSelectHalo();
			LineWidth = LineWidth_DefaultValue = null;
			LineWidthPlus = LineWidthPlus_DefaultValue = null;
			Marker = Marker_DefaultValue = new ObvSeriesStatesSelectMarker();
		...
		/// </summary>
		public ObvSeriesStatesSelectHalo Halo { get; set; }
		private ObvSeriesStatesSelectHalo Halo_DefaultValue { get; set; }
		...
		/// </summary>
		public ObvSeriesStatesSelectMarker Marker { get; set; }
		private ObvSeriesStatesSelectMarker Marker_DefaultValue { get; set; }
