...
{
	public partial class ObvSeriesStatesSelectMarker  : BaseObject
	{
		Hashtable h = new Hashtable();

		public ObvSeriesStatesSelectMarker()
		{
			...
			States = States_DefaultValue = new ObvSeriesStatesSelectMarkerStates();
		...
		/// </summary>
		public ObvSeriesStatesSelectMarkerStates States { get; set; }
		private ObvSeriesStatesSelectMarkerStates States_DefaultValue { get; set; }
