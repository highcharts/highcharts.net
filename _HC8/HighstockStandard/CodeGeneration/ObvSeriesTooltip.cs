...
{
	public partial class ObvSeriesTooltip  : BaseObject
	{
		Hashtable h = new Hashtable();

		public ObvSeriesTooltip()
		{
			...
			HeaderShape = HeaderShape_DefaultValue = ObvSeriesTooltipHeaderShape.Callout;
		...
		/// </summary>
		public ObvSeriesTooltipHeaderShape HeaderShape { get; set; }
		private ObvSeriesTooltipHeaderShape HeaderShape_DefaultValue { get; set; }
