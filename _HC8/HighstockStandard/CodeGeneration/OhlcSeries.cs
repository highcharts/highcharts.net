...
namespace Highsoft.Web.Mvc.Stocks
{
	public partial class OhlcSeries  : Series
	{
		...
		public OhlcSeries()
		{
			...
			Type = Type_DefaultValue = OhlcSeriesType.Ohlc;
		...
		internal override Hashtable ToHashtable()
		{
			...
			if (PointDescriptionFormatter != PointDescriptionFormatter_DefaultValue) { h.Add("pointDescriptionFormatter",PointDescriptionFormatter); Highstock.AddFunction("OhlcSeriesPointDescriptionFormatter.pointDescriptionFormatter", PointDescriptionFormatter); }  
