...
{
	public partial class OhlcSeriesDataDragDrop  : BaseObject
	{
		Hashtable h = new Hashtable();

		public OhlcSeriesDataDragDrop()
		{
			DraggableX = DraggableX_DefaultValue = null;
			DraggableY = DraggableY_DefaultValue = null;
			DragHandle = DragHandle_DefaultValue = new OhlcSeriesDataDragDropDragHandle();
			...
			GuideBox = GuideBox_DefaultValue = new OhlcSeriesDataDragDropGuideBox();
		...
		/// </summary>
		public OhlcSeriesDataDragDropDragHandle DragHandle { get; set; }
		private OhlcSeriesDataDragDropDragHandle DragHandle_DefaultValue { get; set; }
		...
		/// </summary>
		public OhlcSeriesDataDragDropGuideBox GuideBox { get; set; }
		private OhlcSeriesDataDragDropGuideBox GuideBox_DefaultValue { get; set; }
