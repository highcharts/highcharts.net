...
{
	public partial class OhlcSeriesDataLabels  : BaseObject
	{
		Hashtable h = new Hashtable();

		public OhlcSeriesDataLabels()
		{
			Align = Align_DefaultValue = OhlcSeriesDataLabelsAlign.Center;
			...
			Filter = Filter_DefaultValue = new OhlcSeriesDataLabelsFilter();
			...
			Overflow = Overflow_DefaultValue = OhlcSeriesDataLabelsOverflow.Justify;
			Padding = Padding_DefaultValue = 5;
			Position = Position_DefaultValue = OhlcSeriesDataLabelsPosition.Center;
			...
			TextPath = TextPath_DefaultValue = new OhlcSeriesDataLabelsTextPath();
			UseHTML = UseHTML_DefaultValue = false;
			VerticalAlign = VerticalAlign_DefaultValue = OhlcSeriesDataLabelsVerticalAlign.Bottom;
			X = X_DefaultValue = 0;
			Y = Y_DefaultValue = 0;
			Z = Z_DefaultValue = 6;
		...
		/// </summary>
		public OhlcSeriesDataLabelsAlign Align { get; set; }
		private OhlcSeriesDataLabelsAlign Align_DefaultValue { get; set; }
		...
		/// </summary>
		public OhlcSeriesDataLabelsFilter Filter { get; set; }
		private OhlcSeriesDataLabelsFilter Filter_DefaultValue { get; set; }
		...
		/// </summary>
		public OhlcSeriesDataLabelsOverflow Overflow { get; set; }
		private OhlcSeriesDataLabelsOverflow Overflow_DefaultValue { get; set; }
		...
		/// </summary>
		public OhlcSeriesDataLabelsPosition Position { get; set; }
		private OhlcSeriesDataLabelsPosition Position_DefaultValue { get; set; }
		...
		/// </summary>
		public OhlcSeriesDataLabelsTextPath TextPath { get; set; }
		private OhlcSeriesDataLabelsTextPath TextPath_DefaultValue { get; set; }
		...
		/// </summary>
		public OhlcSeriesDataLabelsVerticalAlign VerticalAlign { get; set; }
		private OhlcSeriesDataLabelsVerticalAlign VerticalAlign_DefaultValue { get; set; }
