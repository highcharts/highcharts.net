...
{
	public partial class OhlcSeriesDataMarker  : BaseObject
	{
		Hashtable h = new Hashtable();

		public OhlcSeriesDataMarker()
		{
			...
			States = States_DefaultValue = new OhlcSeriesDataMarkerStates();
		...
		/// </summary>
		public OhlcSeriesDataMarkerStates States { get; set; }
		private OhlcSeriesDataMarkerStates States_DefaultValue { get; set; }
