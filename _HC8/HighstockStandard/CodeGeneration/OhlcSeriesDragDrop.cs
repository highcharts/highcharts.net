...
{
	public partial class OhlcSeriesDragDrop  : BaseObject
	{
		Hashtable h = new Hashtable();

		public OhlcSeriesDragDrop()
		{
			DraggableX = DraggableX_DefaultValue = null;
			DraggableY = DraggableY_DefaultValue = null;
			DragHandle = DragHandle_DefaultValue = new OhlcSeriesDragDropDragHandle();
			...
			GuideBox = GuideBox_DefaultValue = new OhlcSeriesDragDropGuideBox();
		...
		/// </summary>
		public OhlcSeriesDragDropDragHandle DragHandle { get; set; }
		private OhlcSeriesDragDropDragHandle DragHandle_DefaultValue { get; set; }
		...
		/// </summary>
		public OhlcSeriesDragDropGuideBox GuideBox { get; set; }
		private OhlcSeriesDragDropGuideBox GuideBox_DefaultValue { get; set; }
