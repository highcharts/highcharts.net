...
{
	public partial class OhlcSeriesLastPriceLabel  : BaseObject
	{
		Hashtable h = new Hashtable();

		public OhlcSeriesLastPriceLabel()
		{
			Align = Align_DefaultValue = OhlcSeriesLastPriceLabelAlign.Null;
		...
		/// 
		/// </summary>
		public OhlcSeriesLastPriceLabelAlign Align { get; set; }
		private OhlcSeriesLastPriceLabelAlign Align_DefaultValue { get; set; }
