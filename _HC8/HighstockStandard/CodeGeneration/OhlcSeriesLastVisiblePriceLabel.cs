...
{
	public partial class OhlcSeriesLastVisiblePriceLabel  : BaseObject
	{
		Hashtable h = new Hashtable();

		public OhlcSeriesLastVisiblePriceLabel()
		{
			Align = Align_DefaultValue = OhlcSeriesLastVisiblePriceLabelAlign.Null;
		...
		/// 
		/// </summary>
		public OhlcSeriesLastVisiblePriceLabelAlign Align { get; set; }
		private OhlcSeriesLastVisiblePriceLabelAlign Align_DefaultValue { get; set; }
