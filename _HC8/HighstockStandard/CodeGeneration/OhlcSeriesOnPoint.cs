...
{
	public partial class OhlcSeriesOnPoint  : BaseObject
	{
		Hashtable h = new Hashtable();

		public OhlcSeriesOnPoint()
		{
			ConnectorOptions = ConnectorOptions_DefaultValue = new OhlcSeriesOnPointConnectorOptions();
			Id = Id_DefaultValue = "";
			Position = Position_DefaultValue = new OhlcSeriesOnPointPosition();
		...
		/// </summary>
		public OhlcSeriesOnPointConnectorOptions ConnectorOptions { get; set; }
		private OhlcSeriesOnPointConnectorOptions ConnectorOptions_DefaultValue { get; set; }
		...
		/// </summary>
		public OhlcSeriesOnPointPosition Position { get; set; }
		private OhlcSeriesOnPointPosition Position_DefaultValue { get; set; }
