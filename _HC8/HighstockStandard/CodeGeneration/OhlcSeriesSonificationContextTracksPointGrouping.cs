...
{
	public partial class OhlcSeriesSonificationContextTracksPointGrouping  : BaseObject
	{
		Hashtable h = new Hashtable();

		public OhlcSeriesSonificationContextTracksPointGrouping()
		{
			Algorithm = Algorithm_DefaultValue = OhlcSeriesSonificationContextTracksPointGroupingAlgorithm.Minimax;
		...
		/// </summary>
		public OhlcSeriesSonificationContextTracksPointGroupingAlgorithm Algorithm { get; set; }
		private OhlcSeriesSonificationContextTracksPointGroupingAlgorithm Algorithm_DefaultValue { get; set; }
