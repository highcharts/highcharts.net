...
{
	public partial class OhlcSeriesSonificationPointGrouping  : BaseObject
	{
		Hashtable h = new Hashtable();

		public OhlcSeriesSonificationPointGrouping()
		{
			Algorithm = Algorithm_DefaultValue = OhlcSeriesSonificationPointGroupingAlgorithm.Minimax;
		...
		/// </summary>
		public OhlcSeriesSonificationPointGroupingAlgorithm Algorithm { get; set; }
		private OhlcSeriesSonificationPointGroupingAlgorithm Algorithm_DefaultValue { get; set; }
