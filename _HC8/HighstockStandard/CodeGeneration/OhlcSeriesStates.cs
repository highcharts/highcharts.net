...
namespace Highsoft.Web.Mvc.Stocks
{
	public partial class OhlcSeriesStates  : BaseObject
	{
		...
		public OhlcSeriesStates()
		{
			...
			Inactive = Inactive_DefaultValue = new OhlcSeriesStatesInactive();
			Normal = Normal_DefaultValue = new OhlcSeriesStatesNormal();
			Select = Select_DefaultValue = new OhlcSeriesStatesSelect();
		...
		/// </summary>
		public OhlcSeriesStatesInactive Inactive { get; set; }
		private OhlcSeriesStatesInactive Inactive_DefaultValue { get; set; }
		 

		/// <summary>
		/// The normal state of a series, or for point items in column, pieand similar series. Currently only used for setting animationwhen returning to normal state from hover.
		/// </summary>
		public OhlcSeriesStatesNormal Normal { get; set; }
		private OhlcSeriesStatesNormal Normal_DefaultValue { get; set; }
		 

		/// <summary>
		/// Specific options for point in selected states, after beingselected by[allowPointSelect](#plotOptions.series.allowPointSelect)or programmatically.
		/// </summary>
		public OhlcSeriesStatesSelect Select { get; set; }
		private OhlcSeriesStatesSelect Select_DefaultValue { get; set; }
