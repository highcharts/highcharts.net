...
namespace Highsoft.Web.Mvc.Stocks
{
	public partial class OhlcSeriesStatesHover  : BaseObject
	{
		...
		public OhlcSeriesStatesHover()
		{
			...
			Marker = Marker_DefaultValue = new OhlcSeriesStatesHoverMarker();
		...
		/// </summary>
		public OhlcSeriesStatesHoverMarker Marker { get; set; }
		private OhlcSeriesStatesHoverMarker Marker_DefaultValue { get; set; }
