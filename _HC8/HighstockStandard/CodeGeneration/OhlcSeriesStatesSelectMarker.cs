...
{
	public partial class OhlcSeriesStatesSelectMarker  : BaseObject
	{
		Hashtable h = new Hashtable();

		public OhlcSeriesStatesSelectMarker()
		{
			...
			States = States_DefaultValue = new OhlcSeriesStatesSelectMarkerStates();
		...
		/// </summary>
		public OhlcSeriesStatesSelectMarkerStates States { get; set; }
		private OhlcSeriesStatesSelectMarkerStates States_DefaultValue { get; set; }
