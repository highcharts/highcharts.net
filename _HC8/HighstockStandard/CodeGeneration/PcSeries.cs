...
namespace Highsoft.Web.Mvc.Stocks
{
	public partial class PcSeries  : Series
	{
		...
		public PcSeries()
		{
			...
			DashStyle = DashStyle_DefaultValue = PcSeriesDashStyle.Solid;
			...
			Type = Type_DefaultValue = PcSeriesType.Pc;
		...
		internal override Hashtable ToHashtable()
		{
			...
			if (PointDescriptionFormatter != PointDescriptionFormatter_DefaultValue) { h.Add("pointDescriptionFormatter",PointDescriptionFormatter); Highstock.AddFunction("PcSeriesPointDescriptionFormatter.pointDescriptionFormatter", PointDescriptionFormatter); }  
