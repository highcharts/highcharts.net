...
namespace Highsoft.Web.Mvc.Stocks
{
	public partial class PcSeriesDataGrouping  : BaseObject
	{
		...
		internal override Hashtable ToHashtable()
		{
			...
			if (Approximation != Approximation_DefaultValue) { h.Add("approximation",Approximation); Highstock.AddFunction("PcSeriesDataGroupingApproximation.approximation", Approximation); }  
