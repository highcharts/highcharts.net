...
{
	public partial class PcSeriesDataLabels  : BaseObject
	{
		Hashtable h = new Hashtable();

		public PcSeriesDataLabels()
		{
			Align = Align_DefaultValue = PcSeriesDataLabelsAlign.Center;
			...
			Filter = Filter_DefaultValue = new PcSeriesDataLabelsFilter();
			...
			Overflow = Overflow_DefaultValue = PcSeriesDataLabelsOverflow.Justify;
			Padding = Padding_DefaultValue = 5;
			Position = Position_DefaultValue = PcSeriesDataLabelsPosition.Center;
			...
			TextPath = TextPath_DefaultValue = new PcSeriesDataLabelsTextPath();
			UseHTML = UseHTML_DefaultValue = false;
			VerticalAlign = VerticalAlign_DefaultValue = PcSeriesDataLabelsVerticalAlign.Bottom;
			X = X_DefaultValue = 0;
			Y = Y_DefaultValue = 0;
			Z = Z_DefaultValue = 6;
		...
		/// </summary>
		public PcSeriesDataLabelsAlign Align { get; set; }
		private PcSeriesDataLabelsAlign Align_DefaultValue { get; set; }
		...
		/// </summary>
		public PcSeriesDataLabelsFilter Filter { get; set; }
		private PcSeriesDataLabelsFilter Filter_DefaultValue { get; set; }
		...
		/// </summary>
		public PcSeriesDataLabelsOverflow Overflow { get; set; }
		private PcSeriesDataLabelsOverflow Overflow_DefaultValue { get; set; }
		...
		/// </summary>
		public PcSeriesDataLabelsPosition Position { get; set; }
		private PcSeriesDataLabelsPosition Position_DefaultValue { get; set; }
		...
		/// </summary>
		public PcSeriesDataLabelsTextPath TextPath { get; set; }
		private PcSeriesDataLabelsTextPath TextPath_DefaultValue { get; set; }
		...
		/// </summary>
		public PcSeriesDataLabelsVerticalAlign VerticalAlign { get; set; }
		private PcSeriesDataLabelsVerticalAlign VerticalAlign_DefaultValue { get; set; }
