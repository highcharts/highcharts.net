...
{
	public partial class PcSeriesLastPriceLabel  : BaseObject
	{
		Hashtable h = new Hashtable();

		public PcSeriesLastPriceLabel()
		{
			Align = Align_DefaultValue = PcSeriesLastPriceLabelAlign.Null;
		...
		/// 
		/// </summary>
		public PcSeriesLastPriceLabelAlign Align { get; set; }
		private PcSeriesLastPriceLabelAlign Align_DefaultValue { get; set; }
