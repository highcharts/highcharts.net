...
{
	public partial class PcSeriesLastVisiblePriceLabel  : BaseObject
	{
		Hashtable h = new Hashtable();

		public PcSeriesLastVisiblePriceLabel()
		{
			Align = Align_DefaultValue = PcSeriesLastVisiblePriceLabelAlign.Null;
		...
		/// 
		/// </summary>
		public PcSeriesLastVisiblePriceLabelAlign Align { get; set; }
		private PcSeriesLastVisiblePriceLabelAlign Align_DefaultValue { get; set; }
