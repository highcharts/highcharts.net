...
{
	public partial class PcSeriesMarker  : BaseObject
	{
		Hashtable h = new Hashtable();

		public PcSeriesMarker()
		{
			...
			States = States_DefaultValue = new PcSeriesMarkerStates();
		...
		/// </summary>
		public PcSeriesMarkerStates States { get; set; }
		private PcSeriesMarkerStates States_DefaultValue { get; set; }
