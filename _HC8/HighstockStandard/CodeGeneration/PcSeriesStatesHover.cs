...
{
	public partial class PcSeriesStatesHover  : BaseObject
	{
		Hashtable h = new Hashtable();

		public PcSeriesStatesHover()
		{
			Animation = Animation_DefaultValue = new Animation() { Enabled = true };
			Enabled = Enabled_DefaultValue = null;
			Halo = Halo_DefaultValue = new PcSeriesStatesHoverHalo();
			LineWidth = LineWidth_DefaultValue = null;
			LineWidthPlus = LineWidthPlus_DefaultValue = null;
			Marker = Marker_DefaultValue = new PcSeriesStatesHoverMarker();
		...
		/// </summary>
		public PcSeriesStatesHoverHalo Halo { get; set; }
		private PcSeriesStatesHoverHalo Halo_DefaultValue { get; set; }
		...
		/// </summary>
		public PcSeriesStatesHoverMarker Marker { get; set; }
		private PcSeriesStatesHoverMarker Marker_DefaultValue { get; set; }
