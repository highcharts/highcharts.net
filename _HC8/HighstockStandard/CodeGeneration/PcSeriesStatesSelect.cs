...
{
	public partial class PcSeriesStatesSelect  : BaseObject
	{
		Hashtable h = new Hashtable();

		public PcSeriesStatesSelect()
		{
			Animation = Animation_DefaultValue = new Animation() { Enabled = true };
			Enabled = Enabled_DefaultValue = null;
			Halo = Halo_DefaultValue = new PcSeriesStatesSelectHalo();
			LineWidth = LineWidth_DefaultValue = null;
			LineWidthPlus = LineWidthPlus_DefaultValue = null;
			Marker = Marker_DefaultValue = new PcSeriesStatesSelectMarker();
		...
		/// </summary>
		public PcSeriesStatesSelectHalo Halo { get; set; }
		private PcSeriesStatesSelectHalo Halo_DefaultValue { get; set; }
		...
		/// </summary>
		public PcSeriesStatesSelectMarker Marker { get; set; }
		private PcSeriesStatesSelectMarker Marker_DefaultValue { get; set; }
