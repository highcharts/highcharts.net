...
{
	public partial class PcSeriesStatesSelectMarker  : BaseObject
	{
		Hashtable h = new Hashtable();

		public PcSeriesStatesSelectMarker()
		{
			...
			States = States_DefaultValue = new PcSeriesStatesSelectMarkerStates();
		...
		/// </summary>
		public PcSeriesStatesSelectMarkerStates States { get; set; }
		private PcSeriesStatesSelectMarkerStates States_DefaultValue { get; set; }
