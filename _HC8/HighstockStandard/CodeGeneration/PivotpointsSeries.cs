...
namespace Highsoft.Web.Mvc.Stocks
{
	public partial class PivotpointsSeries  : Series
	{
		...
		public PivotpointsSeries()
		{
			...
			DashStyle = DashStyle_DefaultValue = PivotpointsSeriesDashStyle.Solid;
			...
			Type = Type_DefaultValue = PivotpointsSeriesType.Pivotpoints;
		...
		internal override Hashtable ToHashtable()
		{
			...
			if (PointDescriptionFormatter != PointDescriptionFormatter_DefaultValue) { h.Add("pointDescriptionFormatter",PointDescriptionFormatter); Highstock.AddFunction("PivotpointsSeriesPointDescriptionFormatter.pointDescriptionFormatter", PointDescriptionFormatter); }  
