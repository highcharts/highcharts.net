...
{
	public partial class PivotpointsSeriesDataLabels  : BaseObject
	{
		Hashtable h = new Hashtable();

		public PivotpointsSeriesDataLabels()
		{
			Align = Align_DefaultValue = PivotpointsSeriesDataLabelsAlign.Center;
			...
			Filter = Filter_DefaultValue = new PivotpointsSeriesDataLabelsFilter();
			...
			Overflow = Overflow_DefaultValue = PivotpointsSeriesDataLabelsOverflow.Justify;
			Padding = Padding_DefaultValue = 5;
			Position = Position_DefaultValue = PivotpointsSeriesDataLabelsPosition.Center;
			...
			TextPath = TextPath_DefaultValue = new PivotpointsSeriesDataLabelsTextPath();
			UseHTML = UseHTML_DefaultValue = false;
			VerticalAlign = VerticalAlign_DefaultValue = PivotpointsSeriesDataLabelsVerticalAlign.Bottom;
			X = X_DefaultValue = 0;
			Y = Y_DefaultValue = 0;
			Z = Z_DefaultValue = 6;
		...
		/// </summary>
		public PivotpointsSeriesDataLabelsAlign Align { get; set; }
		private PivotpointsSeriesDataLabelsAlign Align_DefaultValue { get; set; }
		...
		/// </summary>
		public PivotpointsSeriesDataLabelsFilter Filter { get; set; }
		private PivotpointsSeriesDataLabelsFilter Filter_DefaultValue { get; set; }
		...
		/// </summary>
		public PivotpointsSeriesDataLabelsOverflow Overflow { get; set; }
		private PivotpointsSeriesDataLabelsOverflow Overflow_DefaultValue { get; set; }
		...
		/// </summary>
		public PivotpointsSeriesDataLabelsPosition Position { get; set; }
		private PivotpointsSeriesDataLabelsPosition Position_DefaultValue { get; set; }
		...
		/// </summary>
		public PivotpointsSeriesDataLabelsTextPath TextPath { get; set; }
		private PivotpointsSeriesDataLabelsTextPath TextPath_DefaultValue { get; set; }
		...
		/// </summary>
		public PivotpointsSeriesDataLabelsVerticalAlign VerticalAlign { get; set; }
		private PivotpointsSeriesDataLabelsVerticalAlign VerticalAlign_DefaultValue { get; set; }
