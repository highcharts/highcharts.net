...
{
	public partial class PivotpointsSeriesLastPriceLabel  : BaseObject
	{
		Hashtable h = new Hashtable();

		public PivotpointsSeriesLastPriceLabel()
		{
			Align = Align_DefaultValue = PivotpointsSeriesLastPriceLabelAlign.Null;
		...
		/// 
		/// </summary>
		public PivotpointsSeriesLastPriceLabelAlign Align { get; set; }
		private PivotpointsSeriesLastPriceLabelAlign Align_DefaultValue { get; set; }
