...
{
	public partial class PivotpointsSeriesLastVisiblePriceLabel  : BaseObject
	{
		Hashtable h = new Hashtable();

		public PivotpointsSeriesLastVisiblePriceLabel()
		{
			Align = Align_DefaultValue = PivotpointsSeriesLastVisiblePriceLabelAlign.Null;
		...
		/// 
		/// </summary>
		public PivotpointsSeriesLastVisiblePriceLabelAlign Align { get; set; }
		private PivotpointsSeriesLastVisiblePriceLabelAlign Align_DefaultValue { get; set; }
