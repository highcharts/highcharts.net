...
{
	public partial class PivotpointsSeriesMarker  : BaseObject
	{
		Hashtable h = new Hashtable();

		public PivotpointsSeriesMarker()
		{
			...
			States = States_DefaultValue = new PivotpointsSeriesMarkerStates();
		...
		/// </summary>
		public PivotpointsSeriesMarkerStates States { get; set; }
		private PivotpointsSeriesMarkerStates States_DefaultValue { get; set; }
