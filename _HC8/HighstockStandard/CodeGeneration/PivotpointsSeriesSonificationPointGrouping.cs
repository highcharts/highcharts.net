...
{
	public partial class PivotpointsSeriesSonificationPointGrouping  : BaseObject
	{
		Hashtable h = new Hashtable();

		public PivotpointsSeriesSonificationPointGrouping()
		{
			Algorithm = Algorithm_DefaultValue = PivotpointsSeriesSonificationPointGroupingAlgorithm.Minimax;
		...
		/// </summary>
		public PivotpointsSeriesSonificationPointGroupingAlgorithm Algorithm { get; set; }
		private PivotpointsSeriesSonificationPointGroupingAlgorithm Algorithm_DefaultValue { get; set; }
