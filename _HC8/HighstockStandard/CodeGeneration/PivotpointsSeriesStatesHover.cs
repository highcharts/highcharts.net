...
{
	public partial class PivotpointsSeriesStatesHover  : BaseObject
	{
		Hashtable h = new Hashtable();

		public PivotpointsSeriesStatesHover()
		{
			Animation = Animation_DefaultValue = new Animation() { Enabled = true };
			Enabled = Enabled_DefaultValue = null;
			Halo = Halo_DefaultValue = new PivotpointsSeriesStatesHoverHalo();
			LineWidth = LineWidth_DefaultValue = null;
			LineWidthPlus = LineWidthPlus_DefaultValue = null;
			Marker = Marker_DefaultValue = new PivotpointsSeriesStatesHoverMarker();
		...
		/// </summary>
		public PivotpointsSeriesStatesHoverHalo Halo { get; set; }
		private PivotpointsSeriesStatesHoverHalo Halo_DefaultValue { get; set; }
		...
		/// </summary>
		public PivotpointsSeriesStatesHoverMarker Marker { get; set; }
		private PivotpointsSeriesStatesHoverMarker Marker_DefaultValue { get; set; }
