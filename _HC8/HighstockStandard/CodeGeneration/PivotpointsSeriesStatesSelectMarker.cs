...
{
	public partial class PivotpointsSeriesStatesSelectMarker  : BaseObject
	{
		Hashtable h = new Hashtable();

		public PivotpointsSeriesStatesSelectMarker()
		{
			...
			States = States_DefaultValue = new PivotpointsSeriesStatesSelectMarkerStates();
		...
		/// </summary>
		public PivotpointsSeriesStatesSelectMarkerStates States { get; set; }
		private PivotpointsSeriesStatesSelectMarkerStates States_DefaultValue { get; set; }
