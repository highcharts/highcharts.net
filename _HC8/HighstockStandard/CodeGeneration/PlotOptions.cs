...
namespace Highsoft.Web.Mvc.Stocks
{
	public partial class PlotOptions  : BaseObject
	{
		...
		internal override Hashtable ToHashtable(Highstock highstock)
		{
			...
			if (Abands.IsDirty(highstock)) h.Add("abands",Abands.ToHashtable(highstock));
			if (Ad.IsDirty(highstock)) h.Add("ad",Ad.ToHashtable(highstock));
			if (Ao.IsDirty(highstock)) h.Add("ao",Ao.ToHashtable(highstock));
			if (Apo.IsDirty(highstock)) h.Add("apo",Apo.ToHashtable(highstock));
			if (Area.IsDirty(highstock)) h.Add("area",Area.ToHashtable(highstock));
			if (Arearange.IsDirty(highstock)) h.Add("arearange",Arearange.ToHashtable(highstock));
			if (Areaspline.IsDirty(highstock)) h.Add("areaspline",Areaspline.ToHashtable(highstock));
			if (Areasplinerange.IsDirty(highstock)) h.Add("areasplinerange",Areasplinerange.ToHashtable(highstock));
			if (Aroon.IsDirty(highstock)) h.Add("aroon",Aroon.ToHashtable(highstock));
			if (Aroonoscillator.IsDirty(highstock)) h.Add("aroonoscillator",Aroonoscillator.ToHashtable(highstock));
			if (Atr.IsDirty(highstock)) h.Add("atr",Atr.ToHashtable(highstock));
			if (Bb.IsDirty(highstock)) h.Add("bb",Bb.ToHashtable(highstock));
			if (Bubble.IsDirty(highstock)) h.Add("bubble",Bubble.ToHashtable(highstock));
			if (Candlestick.IsDirty(highstock)) h.Add("candlestick",Candlestick.ToHashtable(highstock));
			if (Cci.IsDirty(highstock)) h.Add("cci",Cci.ToHashtable(highstock));
			if (Chaikin.IsDirty(highstock)) h.Add("chaikin",Chaikin.ToHashtable(highstock));
			if (Cmf.IsDirty(highstock)) h.Add("cmf",Cmf.ToHashtable(highstock));
			if (Cmo.IsDirty(highstock)) h.Add("cmo",Cmo.ToHashtable(highstock));
			if (Column.IsDirty(highstock)) h.Add("column",Column.ToHashtable(highstock));
			if (Columnpyramid.IsDirty(highstock)) h.Add("columnpyramid",Columnpyramid.ToHashtable(highstock));
			if (Columnrange.IsDirty(highstock)) h.Add("columnrange",Columnrange.ToHashtable(highstock));
			if (Dema.IsDirty(highstock)) h.Add("dema",Dema.ToHashtable(highstock));
			if (Disparityindex.IsDirty(highstock)) h.Add("disparityindex",Disparityindex.ToHashtable(highstock));
			if (Dmi.IsDirty(highstock)) h.Add("dmi",Dmi.ToHashtable(highstock));
			...
			if (Hollowcandlestick.IsDirty(highstock)) h.Add("hollowcandlestick",Hollowcandlestick.ToHashtable(highstock));
			if (Ikh.IsDirty(highstock)) h.Add("ikh",Ikh.ToHashtable(highstock));
			if (Keltnerchannels.IsDirty(highstock)) h.Add("keltnerchannels",Keltnerchannels.ToHashtable(highstock));
			if (Klinger.IsDirty(highstock)) h.Add("klinger",Klinger.ToHashtable(highstock));
			if (Line.IsDirty(highstock)) h.Add("line",Line.ToHashtable(highstock));
			if (Linearregression.IsDirty(highstock)) h.Add("linearregression",Linearregression.ToHashtable(highstock));
			if (Linearregressionangle.IsDirty(highstock)) h.Add("linearregressionangle",Linearregressionangle.ToHashtable(highstock));
			if (Linearregressionintercept.IsDirty(highstock)) h.Add("linearregressionintercept",Linearregressionintercept.ToHashtable(highstock));
			if (Linearregressionslope.IsDirty(highstock)) h.Add("linearregressionslope",Linearregressionslope.ToHashtable(highstock));
			if (Lollipop.IsDirty(highstock)) h.Add("lollipop",Lollipop.ToHashtable(highstock));
			if (Macd.IsDirty(highstock)) h.Add("macd",Macd.ToHashtable(highstock));
			if (Mfi.IsDirty(highstock)) h.Add("mfi",Mfi.ToHashtable(highstock));
			if (Momentum.IsDirty(highstock)) h.Add("momentum",Momentum.ToHashtable(highstock));
			if (Natr.IsDirty(highstock)) h.Add("natr",Natr.ToHashtable(highstock));
			if (Obv.IsDirty(highstock)) h.Add("obv",Obv.ToHashtable(highstock));
			if (Ohlc.IsDirty(highstock)) h.Add("ohlc",Ohlc.ToHashtable(highstock));
			if (Pc.IsDirty(highstock)) h.Add("pc",Pc.ToHashtable(highstock));
			if (Pivotpoints.IsDirty(highstock)) h.Add("pivotpoints",Pivotpoints.ToHashtable(highstock));
			if (Polygon.IsDirty(highstock)) h.Add("polygon",Polygon.ToHashtable(highstock));
			if (Ppo.IsDirty(highstock)) h.Add("ppo",Ppo.ToHashtable(highstock));
			if (Priceenvelopes.IsDirty(highstock)) h.Add("priceenvelopes",Priceenvelopes.ToHashtable(highstock));
			if (Psar.IsDirty(highstock)) h.Add("psar",Psar.ToHashtable(highstock));
			if (Roc.IsDirty(highstock)) h.Add("roc",Roc.ToHashtable(highstock));
			if (Rsi.IsDirty(highstock)) h.Add("rsi",Rsi.ToHashtable(highstock));
			if (Scatter.IsDirty(highstock)) h.Add("scatter",Scatter.ToHashtable(highstock));
			if (Series.IsDirty(highstock)) h.Add("series",Series.ToHashtable(highstock));
			if (Slowstochastic.IsDirty(highstock)) h.Add("slowstochastic",Slowstochastic.ToHashtable(highstock));
			if (Sma.IsDirty(highstock)) h.Add("sma",Sma.ToHashtable(highstock));
			if (Spline.IsDirty(highstock)) h.Add("spline",Spline.ToHashtable(highstock));
			if (Stochastic.IsDirty(highstock)) h.Add("stochastic",Stochastic.ToHashtable(highstock));
			if (Streamgraph.IsDirty(highstock)) h.Add("streamgraph",Streamgraph.ToHashtable(highstock));
			if (Supertrend.IsDirty(highstock)) h.Add("supertrend",Supertrend.ToHashtable(highstock));
			if (Tema.IsDirty(highstock)) h.Add("tema",Tema.ToHashtable(highstock));
			if (Trendline.IsDirty(highstock)) h.Add("trendline",Trendline.ToHashtable(highstock));
			if (Trix.IsDirty(highstock)) h.Add("trix",Trix.ToHashtable(highstock));
			if (Vbp.IsDirty(highstock)) h.Add("vbp",Vbp.ToHashtable(highstock));
			if (Vector.IsDirty(highstock)) h.Add("vector",Vector.ToHashtable(highstock));
			if (Vwap.IsDirty(highstock)) h.Add("vwap",Vwap.ToHashtable(highstock));
			if (Williamsr.IsDirty(highstock)) h.Add("williamsr",Williamsr.ToHashtable(highstock));
			if (Windbarb.IsDirty(highstock)) h.Add("windbarb",Windbarb.ToHashtable(highstock));
