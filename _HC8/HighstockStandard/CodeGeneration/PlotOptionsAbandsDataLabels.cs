...
{
	public partial class PlotOptionsAbandsDataLabels  : BaseObject
	{
		Hashtable h = new Hashtable();

		public PlotOptionsAbandsDataLabels()
		{
			Align = Align_DefaultValue = PlotOptionsAbandsDataLabelsAlign.Center;
			...
			Filter = Filter_DefaultValue = new PlotOptionsAbandsDataLabelsFilter();
			...
			Overflow = Overflow_DefaultValue = PlotOptionsAbandsDataLabelsOverflow.Justify;
			Padding = Padding_DefaultValue = 5;
			Position = Position_DefaultValue = PlotOptionsAbandsDataLabelsPosition.Center;
			...
			TextPath = TextPath_DefaultValue = new PlotOptionsAbandsDataLabelsTextPath();
			UseHTML = UseHTML_DefaultValue = false;
			VerticalAlign = VerticalAlign_DefaultValue = PlotOptionsAbandsDataLabelsVerticalAlign.Bottom;
			X = X_DefaultValue = 0;
			Y = Y_DefaultValue = 0;
			Z = Z_DefaultValue = 6;
		...
		/// </summary>
		public PlotOptionsAbandsDataLabelsAlign Align { get; set; }
		private PlotOptionsAbandsDataLabelsAlign Align_DefaultValue { get; set; }
		...
		/// </summary>
		public PlotOptionsAbandsDataLabelsFilter Filter { get; set; }
		private PlotOptionsAbandsDataLabelsFilter Filter_DefaultValue { get; set; }
		...
		/// </summary>
		public PlotOptionsAbandsDataLabelsOverflow Overflow { get; set; }
		private PlotOptionsAbandsDataLabelsOverflow Overflow_DefaultValue { get; set; }
		...
		/// </summary>
		public PlotOptionsAbandsDataLabelsPosition Position { get; set; }
		private PlotOptionsAbandsDataLabelsPosition Position_DefaultValue { get; set; }
		...
		/// </summary>
		public PlotOptionsAbandsDataLabelsTextPath TextPath { get; set; }
		private PlotOptionsAbandsDataLabelsTextPath TextPath_DefaultValue { get; set; }
		...
		/// </summary>
		public PlotOptionsAbandsDataLabelsVerticalAlign VerticalAlign { get; set; }
		private PlotOptionsAbandsDataLabelsVerticalAlign VerticalAlign_DefaultValue { get; set; }
