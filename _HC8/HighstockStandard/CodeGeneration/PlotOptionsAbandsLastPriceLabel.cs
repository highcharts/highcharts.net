...
{
	public partial class PlotOptionsAbandsLastPriceLabel  : BaseObject
	{
		Hashtable h = new Hashtable();

		public PlotOptionsAbandsLastPriceLabel()
		{
			Align = Align_DefaultValue = PlotOptionsAbandsLastPriceLabelAlign.Null;
		...
		/// 
		/// </summary>
		public PlotOptionsAbandsLastPriceLabelAlign Align { get; set; }
		private PlotOptionsAbandsLastPriceLabelAlign Align_DefaultValue { get; set; }
