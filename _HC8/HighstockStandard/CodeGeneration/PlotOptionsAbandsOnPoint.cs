...
{
	public partial class PlotOptionsAbandsOnPoint  : BaseObject
	{
		Hashtable h = new Hashtable();

		public PlotOptionsAbandsOnPoint()
		{
			ConnectorOptions = ConnectorOptions_DefaultValue = new PlotOptionsAbandsOnPointConnectorOptions();
			Id = Id_DefaultValue = "";
			Position = Position_DefaultValue = new PlotOptionsAbandsOnPointPosition();
		...
		/// </summary>
		public PlotOptionsAbandsOnPointConnectorOptions ConnectorOptions { get; set; }
		private PlotOptionsAbandsOnPointConnectorOptions ConnectorOptions_DefaultValue { get; set; }
		...
		/// </summary>
		public PlotOptionsAbandsOnPointPosition Position { get; set; }
		private PlotOptionsAbandsOnPointPosition Position_DefaultValue { get; set; }
