...
{
	public partial class PlotOptionsAbandsSonificationContextTracks  : BaseObject
	{
		Hashtable h = new Hashtable();

		public PlotOptionsAbandsSonificationContextTracks()
		{
			ActiveWhen = ActiveWhen_DefaultValue = new PlotOptionsAbandsSonificationContextTracksActiveWhen();
			Instrument = Instrument_DefaultValue = null;
			InstrumentString = InstrumentString_DefaultValue = "null";
			Mapping = Mapping_DefaultValue = new PlotOptionsAbandsSonificationContextTracksMapping();
			MidiName = MidiName_DefaultValue = "";
			PointGrouping = PointGrouping_DefaultValue = new PlotOptionsAbandsSonificationContextTracksPointGrouping();
			...
			Type = Type_DefaultValue = PlotOptionsAbandsSonificationContextTracksType.Instrument;
			ValueInterval = ValueInterval_DefaultValue = null;
			ValueMapFunction = ValueMapFunction_DefaultValue = PlotOptionsAbandsSonificationContextTracksValueMapFunction.Linear;
		...
		/// </summary>
		public PlotOptionsAbandsSonificationContextTracksActiveWhen ActiveWhen { get; set; }
		private PlotOptionsAbandsSonificationContextTracksActiveWhen ActiveWhen_DefaultValue { get; set; }
		...
		/// </summary>
		public PlotOptionsAbandsSonificationContextTracksMapping Mapping { get; set; }
		private PlotOptionsAbandsSonificationContextTracksMapping Mapping_DefaultValue { get; set; }
		...
		/// </summary>
		public PlotOptionsAbandsSonificationContextTracksPointGrouping PointGrouping { get; set; }
		private PlotOptionsAbandsSonificationContextTracksPointGrouping PointGrouping_DefaultValue { get; set; }
		...
		/// </summary>
		public PlotOptionsAbandsSonificationContextTracksType Type { get; set; }
		private PlotOptionsAbandsSonificationContextTracksType Type_DefaultValue { get; set; }
		...
		/// </summary>
		public PlotOptionsAbandsSonificationContextTracksValueMapFunction ValueMapFunction { get; set; }
		private PlotOptionsAbandsSonificationContextTracksValueMapFunction ValueMapFunction_DefaultValue { get; set; }
