...
{
	public partial class PlotOptionsAbandsSonificationPointGrouping  : BaseObject
	{
		Hashtable h = new Hashtable();

		public PlotOptionsAbandsSonificationPointGrouping()
		{
			Algorithm = Algorithm_DefaultValue = PlotOptionsAbandsSonificationPointGroupingAlgorithm.Minimax;
		...
		/// </summary>
		public PlotOptionsAbandsSonificationPointGroupingAlgorithm Algorithm { get; set; }
		private PlotOptionsAbandsSonificationPointGroupingAlgorithm Algorithm_DefaultValue { get; set; }
