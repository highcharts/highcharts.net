...
{
	public partial class PlotOptionsAbandsStatesHoverMarker  : BaseObject
	{
		Hashtable h = new Hashtable();

		public PlotOptionsAbandsStatesHoverMarker()
		{
			...
			States = States_DefaultValue = new PlotOptionsAbandsStatesHoverMarkerStates();
		...
		/// </summary>
		public PlotOptionsAbandsStatesHoverMarkerStates States { get; set; }
		private PlotOptionsAbandsStatesHoverMarkerStates States_DefaultValue { get; set; }
