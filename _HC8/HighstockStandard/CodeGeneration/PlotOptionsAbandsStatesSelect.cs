...
{
	public partial class PlotOptionsAbandsStatesSelect  : BaseObject
	{
		Hashtable h = new Hashtable();

		public PlotOptionsAbandsStatesSelect()
		{
			Animation = Animation_DefaultValue = new Animation() { Enabled = true };
			Enabled = Enabled_DefaultValue = null;
			Halo = Halo_DefaultValue = new PlotOptionsAbandsStatesSelectHalo();
			LineWidth = LineWidth_DefaultValue = null;
			LineWidthPlus = LineWidthPlus_DefaultValue = null;
			Marker = Marker_DefaultValue = new PlotOptionsAbandsStatesSelectMarker();
		...
		/// </summary>
		public PlotOptionsAbandsStatesSelectHalo Halo { get; set; }
		private PlotOptionsAbandsStatesSelectHalo Halo_DefaultValue { get; set; }
		...
		/// </summary>
		public PlotOptionsAbandsStatesSelectMarker Marker { get; set; }
		private PlotOptionsAbandsStatesSelectMarker Marker_DefaultValue { get; set; }
