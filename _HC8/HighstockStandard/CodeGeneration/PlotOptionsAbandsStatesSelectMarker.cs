...
{
	public partial class PlotOptionsAbandsStatesSelectMarker  : BaseObject
	{
		Hashtable h = new Hashtable();

		public PlotOptionsAbandsStatesSelectMarker()
		{
			...
			States = States_DefaultValue = new PlotOptionsAbandsStatesSelectMarkerStates();
		...
		/// </summary>
		public PlotOptionsAbandsStatesSelectMarkerStates States { get; set; }
		private PlotOptionsAbandsStatesSelectMarkerStates States_DefaultValue { get; set; }
