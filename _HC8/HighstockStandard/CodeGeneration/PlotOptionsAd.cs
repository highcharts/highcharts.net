...
namespace Highsoft.Web.Mvc.Stocks
{
	public partial class PlotOptionsAd  : BaseObject
	{
		...
		public PlotOptionsAd()
		{
			...
			DragDrop = DragDrop_DefaultValue = new PlotOptionsAdDragDrop();
		...
		/// </summary>
		public PlotOptionsAdDragDrop DragDrop { get; set; }
		private PlotOptionsAdDragDrop DragDrop_DefaultValue { get; set; }
