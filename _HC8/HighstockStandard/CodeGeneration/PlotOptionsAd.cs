...
namespace Highsoft.Web.Mvc.Stocks
{
	public partial class PlotOptionsAd  : BaseObject
	{
		...
		public PlotOptionsAd()
		{
			...
			DashStyle = DashStyle_DefaultValue = PlotOptionsAdDashStyle.Solid;
		...
		internal override Hashtable ToHashtable()
		{
			...
			if (PointDescriptionFormatter != PointDescriptionFormatter_DefaultValue) { h.Add("pointDescriptionFormatter",PointDescriptionFormatter); Highstock.AddFunction("PlotOptionsAdPointDescriptionFormatter.pointDescriptionFormatter", PointDescriptionFormatter); }  
