...
{
	public partial class PlotOptionsAdDataLabels  : BaseObject
	{
		Hashtable h = new Hashtable();

		public PlotOptionsAdDataLabels()
		{
			Align = Align_DefaultValue = PlotOptionsAdDataLabelsAlign.Center;
			...
			Filter = Filter_DefaultValue = new PlotOptionsAdDataLabelsFilter();
			...
			Overflow = Overflow_DefaultValue = PlotOptionsAdDataLabelsOverflow.Justify;
			Padding = Padding_DefaultValue = 5;
			Position = Position_DefaultValue = PlotOptionsAdDataLabelsPosition.Center;
			...
			TextPath = TextPath_DefaultValue = new PlotOptionsAdDataLabelsTextPath();
			UseHTML = UseHTML_DefaultValue = false;
			VerticalAlign = VerticalAlign_DefaultValue = PlotOptionsAdDataLabelsVerticalAlign.Bottom;
			X = X_DefaultValue = 0;
			Y = Y_DefaultValue = 0;
			Z = Z_DefaultValue = 6;
		...
		/// </summary>
		public PlotOptionsAdDataLabelsAlign Align { get; set; }
		private PlotOptionsAdDataLabelsAlign Align_DefaultValue { get; set; }
		...
		/// </summary>
		public PlotOptionsAdDataLabelsFilter Filter { get; set; }
		private PlotOptionsAdDataLabelsFilter Filter_DefaultValue { get; set; }
		...
		/// </summary>
		public PlotOptionsAdDataLabelsOverflow Overflow { get; set; }
		private PlotOptionsAdDataLabelsOverflow Overflow_DefaultValue { get; set; }
		...
		/// </summary>
		public PlotOptionsAdDataLabelsPosition Position { get; set; }
		private PlotOptionsAdDataLabelsPosition Position_DefaultValue { get; set; }
		...
		/// </summary>
		public PlotOptionsAdDataLabelsTextPath TextPath { get; set; }
		private PlotOptionsAdDataLabelsTextPath TextPath_DefaultValue { get; set; }
		...
		/// </summary>
		public PlotOptionsAdDataLabelsVerticalAlign VerticalAlign { get; set; }
		private PlotOptionsAdDataLabelsVerticalAlign VerticalAlign_DefaultValue { get; set; }
