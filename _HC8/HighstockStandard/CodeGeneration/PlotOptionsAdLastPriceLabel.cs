...
{
	public partial class PlotOptionsAdLastPriceLabel  : BaseObject
	{
		Hashtable h = new Hashtable();

		public PlotOptionsAdLastPriceLabel()
		{
			Align = Align_DefaultValue = PlotOptionsAdLastPriceLabelAlign.Null;
		...
		/// 
		/// </summary>
		public PlotOptionsAdLastPriceLabelAlign Align { get; set; }
		private PlotOptionsAdLastPriceLabelAlign Align_DefaultValue { get; set; }
