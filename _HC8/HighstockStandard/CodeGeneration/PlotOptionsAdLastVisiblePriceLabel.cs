...
{
	public partial class PlotOptionsAdLastVisiblePriceLabel  : BaseObject
	{
		Hashtable h = new Hashtable();

		public PlotOptionsAdLastVisiblePriceLabel()
		{
			Align = Align_DefaultValue = PlotOptionsAdLastVisiblePriceLabelAlign.Null;
		...
		/// 
		/// </summary>
		public PlotOptionsAdLastVisiblePriceLabelAlign Align { get; set; }
		private PlotOptionsAdLastVisiblePriceLabelAlign Align_DefaultValue { get; set; }
