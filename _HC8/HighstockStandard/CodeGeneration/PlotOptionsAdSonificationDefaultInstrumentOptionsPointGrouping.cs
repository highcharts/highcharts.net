...
{
	public partial class PlotOptionsAdSonificationDefaultInstrumentOptionsPointGrouping  : BaseObject
	{
		Hashtable h = new Hashtable();

		public PlotOptionsAdSonificationDefaultInstrumentOptionsPointGrouping()
		{
			Algorithm = Algorithm_DefaultValue = PlotOptionsAdSonificationDefaultInstrumentOptionsPointGroupingAlgorithm.Minimax;
		...
		/// </summary>
		public PlotOptionsAdSonificationDefaultInstrumentOptionsPointGroupingAlgorithm Algorithm { get; set; }
		private PlotOptionsAdSonificationDefaultInstrumentOptionsPointGroupingAlgorithm Algorithm_DefaultValue { get; set; }
