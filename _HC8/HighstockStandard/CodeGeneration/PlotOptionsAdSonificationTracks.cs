...
{
	public partial class PlotOptionsAdSonificationTracks  : BaseObject
	{
		Hashtable h = new Hashtable();

		public PlotOptionsAdSonificationTracks()
		{
			ActiveWhen = ActiveWhen_DefaultValue = new PlotOptionsAdSonificationTracksActiveWhen();
			Instrument = Instrument_DefaultValue = null;
			InstrumentString = InstrumentString_DefaultValue = "null";
			Mapping = Mapping_DefaultValue = new PlotOptionsAdSonificationTracksMapping();
			MidiName = MidiName_DefaultValue = "";
			PointGrouping = PointGrouping_DefaultValue = new PlotOptionsAdSonificationTracksPointGrouping();
			RoundToMusicalNotes = RoundToMusicalNotes_DefaultValue = true;
			ShowPlayMarker = ShowPlayMarker_DefaultValue = true;
			Type = Type_DefaultValue = PlotOptionsAdSonificationTracksType.Instrument;
		...
		/// </summary>
		public PlotOptionsAdSonificationTracksActiveWhen ActiveWhen { get; set; }
		private PlotOptionsAdSonificationTracksActiveWhen ActiveWhen_DefaultValue { get; set; }
		...
		/// </summary>
		public PlotOptionsAdSonificationTracksMapping Mapping { get; set; }
		private PlotOptionsAdSonificationTracksMapping Mapping_DefaultValue { get; set; }
		...
		/// </summary>
		public PlotOptionsAdSonificationTracksPointGrouping PointGrouping { get; set; }
		private PlotOptionsAdSonificationTracksPointGrouping PointGrouping_DefaultValue { get; set; }
		...
		/// </summary>
		public PlotOptionsAdSonificationTracksType Type { get; set; }
		private PlotOptionsAdSonificationTracksType Type_DefaultValue { get; set; }
