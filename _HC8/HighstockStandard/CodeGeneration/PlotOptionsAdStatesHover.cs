...
{
	public partial class PlotOptionsAdStatesHover  : BaseObject
	{
		Hashtable h = new Hashtable();

		public PlotOptionsAdStatesHover()
		{
			Animation = Animation_DefaultValue = new Animation() { Enabled = true };
			Enabled = Enabled_DefaultValue = new Hashtable();
			Halo = Halo_DefaultValue = new PlotOptionsAdStatesHoverHalo();
			LineWidth = LineWidth_DefaultValue = new Hashtable();
			LineWidthPlus = LineWidthPlus_DefaultValue = new Hashtable();
			Marker = Marker_DefaultValue = new PlotOptionsAdStatesHoverMarker();
		...
		/// </summary>
		public PlotOptionsAdStatesHoverHalo Halo { get; set; }
		private PlotOptionsAdStatesHoverHalo Halo_DefaultValue { get; set; }
		...
		/// </summary>
		public PlotOptionsAdStatesHoverMarker Marker { get; set; }
		private PlotOptionsAdStatesHoverMarker Marker_DefaultValue { get; set; }
