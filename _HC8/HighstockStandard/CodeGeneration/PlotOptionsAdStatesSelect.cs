...
{
	public partial class PlotOptionsAdStatesSelect  : BaseObject
	{
		Hashtable h = new Hashtable();

		public PlotOptionsAdStatesSelect()
		{
			Animation = Animation_DefaultValue = new Animation() { Enabled = true };
			Enabled = Enabled_DefaultValue = true;
			Halo = Halo_DefaultValue = new PlotOptionsAdStatesSelectHalo();
			LineWidth = LineWidth_DefaultValue = null;
			LineWidthPlus = LineWidthPlus_DefaultValue = 1;
			Marker = Marker_DefaultValue = new PlotOptionsAdStatesSelectMarker();
		...
		/// </summary>
		public PlotOptionsAdStatesSelectHalo Halo { get; set; }
		private PlotOptionsAdStatesSelectHalo Halo_DefaultValue { get; set; }
		...
		/// </summary>
		public PlotOptionsAdStatesSelectMarker Marker { get; set; }
		private PlotOptionsAdStatesSelectMarker Marker_DefaultValue { get; set; }
