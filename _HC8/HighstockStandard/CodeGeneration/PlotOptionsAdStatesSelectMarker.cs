...
{
	public partial class PlotOptionsAdStatesSelectMarker  : BaseObject
	{
		Hashtable h = new Hashtable();

		public PlotOptionsAdStatesSelectMarker()
		{
			...
			States = States_DefaultValue = new PlotOptionsAdStatesSelectMarkerStates();
		...
		/// </summary>
		public PlotOptionsAdStatesSelectMarkerStates States { get; set; }
		private PlotOptionsAdStatesSelectMarkerStates States_DefaultValue { get; set; }
