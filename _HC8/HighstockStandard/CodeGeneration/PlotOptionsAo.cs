...
namespace Highsoft.Web.Mvc.Stocks
{
	public partial class PlotOptionsAo  : BaseObject
	{
		...
		public PlotOptionsAo()
		{
			...
			DragDrop = DragDrop_DefaultValue = new PlotOptionsAoDragDrop();
		...
		/// </summary>
		public PlotOptionsAoDragDrop DragDrop { get; set; }
		private PlotOptionsAoDragDrop DragDrop_DefaultValue { get; set; }
