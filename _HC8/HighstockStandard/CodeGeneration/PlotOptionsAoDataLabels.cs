...
{
	public partial class PlotOptionsAoDataLabels  : BaseObject
	{
		Hashtable h = new Hashtable();

		public PlotOptionsAoDataLabels()
		{
			Align = Align_DefaultValue = PlotOptionsAoDataLabelsAlign.Center;
			...
			Filter = Filter_DefaultValue = new PlotOptionsAoDataLabelsFilter();
			...
			Overflow = Overflow_DefaultValue = PlotOptionsAoDataLabelsOverflow.Justify;
			Padding = Padding_DefaultValue = 5;
			Position = Position_DefaultValue = PlotOptionsAoDataLabelsPosition.Center;
			...
			TextPath = TextPath_DefaultValue = new PlotOptionsAoDataLabelsTextPath();
			UseHTML = UseHTML_DefaultValue = false;
			VerticalAlign = VerticalAlign_DefaultValue = PlotOptionsAoDataLabelsVerticalAlign.Bottom;
			X = X_DefaultValue = 0;
			Y = Y_DefaultValue = 0;
			Z = Z_DefaultValue = 6;
		...
		/// </summary>
		public PlotOptionsAoDataLabelsAlign Align { get; set; }
		private PlotOptionsAoDataLabelsAlign Align_DefaultValue { get; set; }
		...
		/// </summary>
		public PlotOptionsAoDataLabelsFilter Filter { get; set; }
		private PlotOptionsAoDataLabelsFilter Filter_DefaultValue { get; set; }
		...
		/// </summary>
		public PlotOptionsAoDataLabelsOverflow Overflow { get; set; }
		private PlotOptionsAoDataLabelsOverflow Overflow_DefaultValue { get; set; }
		...
		/// </summary>
		public PlotOptionsAoDataLabelsPosition Position { get; set; }
		private PlotOptionsAoDataLabelsPosition Position_DefaultValue { get; set; }
		...
		/// </summary>
		public PlotOptionsAoDataLabelsTextPath TextPath { get; set; }
		private PlotOptionsAoDataLabelsTextPath TextPath_DefaultValue { get; set; }
		...
		/// </summary>
		public PlotOptionsAoDataLabelsVerticalAlign VerticalAlign { get; set; }
		private PlotOptionsAoDataLabelsVerticalAlign VerticalAlign_DefaultValue { get; set; }
