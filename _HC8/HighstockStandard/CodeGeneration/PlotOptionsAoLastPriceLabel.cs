...
{
	public partial class PlotOptionsAoLastPriceLabel  : BaseObject
	{
		Hashtable h = new Hashtable();

		public PlotOptionsAoLastPriceLabel()
		{
			Align = Align_DefaultValue = PlotOptionsAoLastPriceLabelAlign.Null;
		...
		/// 
		/// </summary>
		public PlotOptionsAoLastPriceLabelAlign Align { get; set; }
		private PlotOptionsAoLastPriceLabelAlign Align_DefaultValue { get; set; }
