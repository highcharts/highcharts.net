...
{
	public partial class PlotOptionsAoLastVisiblePriceLabel  : BaseObject
	{
		Hashtable h = new Hashtable();

		public PlotOptionsAoLastVisiblePriceLabel()
		{
			Align = Align_DefaultValue = PlotOptionsAoLastVisiblePriceLabelAlign.Null;
		...
		/// 
		/// </summary>
		public PlotOptionsAoLastVisiblePriceLabelAlign Align { get; set; }
		private PlotOptionsAoLastVisiblePriceLabelAlign Align_DefaultValue { get; set; }
