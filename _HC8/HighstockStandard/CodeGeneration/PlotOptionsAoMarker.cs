...
{
	public partial class PlotOptionsAoMarker  : BaseObject
	{
		Hashtable h = new Hashtable();

		public PlotOptionsAoMarker()
		{
			...
			States = States_DefaultValue = new PlotOptionsAoMarkerStates();
		...
		/// </summary>
		public PlotOptionsAoMarkerStates States { get; set; }
		private PlotOptionsAoMarkerStates States_DefaultValue { get; set; }
