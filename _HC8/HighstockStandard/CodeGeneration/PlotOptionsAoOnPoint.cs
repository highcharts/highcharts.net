...
{
	public partial class PlotOptionsAoOnPoint  : BaseObject
	{
		Hashtable h = new Hashtable();

		public PlotOptionsAoOnPoint()
		{
			ConnectorOptions = ConnectorOptions_DefaultValue = new PlotOptionsAoOnPointConnectorOptions();
			Id = Id_DefaultValue = "";
			Position = Position_DefaultValue = new PlotOptionsAoOnPointPosition();
		...
		/// </summary>
		public PlotOptionsAoOnPointConnectorOptions ConnectorOptions { get; set; }
		private PlotOptionsAoOnPointConnectorOptions ConnectorOptions_DefaultValue { get; set; }
		...
		/// </summary>
		public PlotOptionsAoOnPointPosition Position { get; set; }
		private PlotOptionsAoOnPointPosition Position_DefaultValue { get; set; }
