...
{
	public partial class PlotOptionsAoSonificationTracksPointGrouping  : BaseObject
	{
		Hashtable h = new Hashtable();

		public PlotOptionsAoSonificationTracksPointGrouping()
		{
			Algorithm = Algorithm_DefaultValue = PlotOptionsAoSonificationTracksPointGroupingAlgorithm.Minimax;
		...
		/// </summary>
		public PlotOptionsAoSonificationTracksPointGroupingAlgorithm Algorithm { get; set; }
		private PlotOptionsAoSonificationTracksPointGroupingAlgorithm Algorithm_DefaultValue { get; set; }
