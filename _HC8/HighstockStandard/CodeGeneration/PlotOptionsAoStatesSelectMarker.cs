...
{
	public partial class PlotOptionsAoStatesSelectMarker  : BaseObject
	{
		Hashtable h = new Hashtable();

		public PlotOptionsAoStatesSelectMarker()
		{
			...
			States = States_DefaultValue = new PlotOptionsAoStatesSelectMarkerStates();
		...
		/// </summary>
		public PlotOptionsAoStatesSelectMarkerStates States { get; set; }
		private PlotOptionsAoStatesSelectMarkerStates States_DefaultValue { get; set; }
