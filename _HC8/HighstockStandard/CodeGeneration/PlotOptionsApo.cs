...
namespace Highsoft.Web.Mvc.Stocks
{
	public partial class PlotOptionsApo  : BaseObject
	{
		...
		public PlotOptionsApo()
		{
			...
			DashStyle = DashStyle_DefaultValue = PlotOptionsApoDashStyle.Solid;
		...
		internal override Hashtable ToHashtable()
		{
			...
			if (PointDescriptionFormatter != PointDescriptionFormatter_DefaultValue) { h.Add("pointDescriptionFormatter",PointDescriptionFormatter); Highstock.AddFunction("PlotOptionsApoPointDescriptionFormatter.pointDescriptionFormatter", PointDescriptionFormatter); }  
