...
namespace Highsoft.Web.Mvc.Stocks
{
	public partial class PlotOptionsApo  : BaseObject
	{
		...
		public PlotOptionsApo()
		{
			...
			DragDrop = DragDrop_DefaultValue = new PlotOptionsApoDragDrop();
		...
		/// </summary>
		public PlotOptionsApoDragDrop DragDrop { get; set; }
		private PlotOptionsApoDragDrop DragDrop_DefaultValue { get; set; }
