...
namespace Highsoft.Web.Mvc.Stocks
{
	public partial class PlotOptionsApoDataLabels  : BaseObject
	{
		...
		{
			Align = Align_DefaultValue = PlotOptionsApoDataLabelsAlign.Center;
			...
			Filter = Filter_DefaultValue = new PlotOptionsApoDataLabelsFilter();
			...
			Overflow = Overflow_DefaultValue = PlotOptionsApoDataLabelsOverflow.Justify;
			Padding = Padding_DefaultValue = 5;
			Position = Position_DefaultValue = PlotOptionsApoDataLabelsPosition.Center;
			...
			TextPath = TextPath_DefaultValue = new PlotOptionsApoDataLabelsTextPath();
			UseHTML = UseHTML_DefaultValue = false;
			VerticalAlign = VerticalAlign_DefaultValue = PlotOptionsApoDataLabelsVerticalAlign.Bottom;
			X = X_DefaultValue = 0;
			Y = Y_DefaultValue = 0;
			Z = Z_DefaultValue = 6;
		...
		private PlotOptionsApoDataLabelsAlign Align_DefaultValue { get; set; }
		...
		private PlotOptionsApoDataLabelsFilter Filter_DefaultValue { get; set; }
		...
		private PlotOptionsApoDataLabelsOverflow Overflow_DefaultValue { get; set; }
		...
		private PlotOptionsApoDataLabelsPosition Position_DefaultValue { get; set; }
		...
		private PlotOptionsApoDataLabelsTextPath TextPath_DefaultValue { get; set; }
		...
		private PlotOptionsApoDataLabelsVerticalAlign VerticalAlign_DefaultValue { get; set; }
