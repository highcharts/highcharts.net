...
{
	public partial class PlotOptionsApoLastPriceLabel  : BaseObject
	{
		Hashtable h = new Hashtable();

		public PlotOptionsApoLastPriceLabel()
		{
			Align = Align_DefaultValue = PlotOptionsApoLastPriceLabelAlign.Null;
		...
		/// 
		/// </summary>
		public PlotOptionsApoLastPriceLabelAlign Align { get; set; }
		private PlotOptionsApoLastPriceLabelAlign Align_DefaultValue { get; set; }
