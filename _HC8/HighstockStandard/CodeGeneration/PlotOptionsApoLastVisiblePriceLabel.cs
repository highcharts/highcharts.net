...
{
	public partial class PlotOptionsApoLastVisiblePriceLabel  : BaseObject
	{
		Hashtable h = new Hashtable();

		public PlotOptionsApoLastVisiblePriceLabel()
		{
			Align = Align_DefaultValue = PlotOptionsApoLastVisiblePriceLabelAlign.Null;
		...
		/// 
		/// </summary>
		public PlotOptionsApoLastVisiblePriceLabelAlign Align { get; set; }
		private PlotOptionsApoLastVisiblePriceLabelAlign Align_DefaultValue { get; set; }
