...
{
	public partial class PlotOptionsApoMarker  : BaseObject
	{
		Hashtable h = new Hashtable();

		public PlotOptionsApoMarker()
		{
			...
			States = States_DefaultValue = new PlotOptionsApoMarkerStates();
		...
		/// </summary>
		public PlotOptionsApoMarkerStates States { get; set; }
		private PlotOptionsApoMarkerStates States_DefaultValue { get; set; }
