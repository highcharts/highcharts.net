...
{
	public partial class PlotOptionsApoOnPoint  : BaseObject
	{
		Hashtable h = new Hashtable();

		public PlotOptionsApoOnPoint()
		{
			ConnectorOptions = ConnectorOptions_DefaultValue = new PlotOptionsApoOnPointConnectorOptions();
			Id = Id_DefaultValue = "";
			Position = Position_DefaultValue = new PlotOptionsApoOnPointPosition();
		...
		/// </summary>
		public PlotOptionsApoOnPointConnectorOptions ConnectorOptions { get; set; }
		private PlotOptionsApoOnPointConnectorOptions ConnectorOptions_DefaultValue { get; set; }
		...
		/// </summary>
		public PlotOptionsApoOnPointPosition Position { get; set; }
		private PlotOptionsApoOnPointPosition Position_DefaultValue { get; set; }
