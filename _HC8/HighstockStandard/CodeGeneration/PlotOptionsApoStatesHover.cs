...
{
	public partial class PlotOptionsApoStatesHover  : BaseObject
	{
		Hashtable h = new Hashtable();

		public PlotOptionsApoStatesHover()
		{
			Animation = Animation_DefaultValue = new Animation() { Enabled = true };
			Enabled = Enabled_DefaultValue = null;
			Halo = Halo_DefaultValue = new PlotOptionsApoStatesHoverHalo();
			LineWidth = LineWidth_DefaultValue = null;
			LineWidthPlus = LineWidthPlus_DefaultValue = null;
			Marker = Marker_DefaultValue = new PlotOptionsApoStatesHoverMarker();
		...
		/// </summary>
		public PlotOptionsApoStatesHoverHalo Halo { get; set; }
		private PlotOptionsApoStatesHoverHalo Halo_DefaultValue { get; set; }
		...
		/// </summary>
		public PlotOptionsApoStatesHoverMarker Marker { get; set; }
		private PlotOptionsApoStatesHoverMarker Marker_DefaultValue { get; set; }
