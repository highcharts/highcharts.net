...
{
	public partial class PlotOptionsApoStatesSelectMarker  : BaseObject
	{
		Hashtable h = new Hashtable();

		public PlotOptionsApoStatesSelectMarker()
		{
			...
			States = States_DefaultValue = new PlotOptionsApoStatesSelectMarkerStates();
		...
		/// </summary>
		public PlotOptionsApoStatesSelectMarkerStates States { get; set; }
		private PlotOptionsApoStatesSelectMarkerStates States_DefaultValue { get; set; }
