...
{
	public partial class PlotOptionsAreaLastPriceLabel  : BaseObject
	{
		Hashtable h = new Hashtable();

		public PlotOptionsAreaLastPriceLabel()
		{
			Align = Align_DefaultValue = PlotOptionsAreaLastPriceLabelAlign.Null;
		...
		/// 
		/// </summary>
		public PlotOptionsAreaLastPriceLabelAlign Align { get; set; }
		private PlotOptionsAreaLastPriceLabelAlign Align_DefaultValue { get; set; }
