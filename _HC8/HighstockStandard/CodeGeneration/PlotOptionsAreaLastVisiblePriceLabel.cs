...
{
	public partial class PlotOptionsAreaLastVisiblePriceLabel  : BaseObject
	{
		Hashtable h = new Hashtable();

		public PlotOptionsAreaLastVisiblePriceLabel()
		{
			Align = Align_DefaultValue = PlotOptionsAreaLastVisiblePriceLabelAlign.Null;
		...
		/// 
		/// </summary>
		public PlotOptionsAreaLastVisiblePriceLabelAlign Align { get; set; }
		private PlotOptionsAreaLastVisiblePriceLabelAlign Align_DefaultValue { get; set; }
