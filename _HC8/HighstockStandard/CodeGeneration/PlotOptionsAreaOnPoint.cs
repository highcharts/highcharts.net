...
{
	public partial class PlotOptionsAreaOnPoint  : BaseObject
	{
		Hashtable h = new Hashtable();

		public PlotOptionsAreaOnPoint()
		{
			ConnectorOptions = ConnectorOptions_DefaultValue = new PlotOptionsAreaOnPointConnectorOptions();
			Id = Id_DefaultValue = "";
			Position = Position_DefaultValue = new PlotOptionsAreaOnPointPosition();
		...
		/// </summary>
		public PlotOptionsAreaOnPointConnectorOptions ConnectorOptions { get; set; }
		private PlotOptionsAreaOnPointConnectorOptions ConnectorOptions_DefaultValue { get; set; }
		...
		/// </summary>
		public PlotOptionsAreaOnPointPosition Position { get; set; }
		private PlotOptionsAreaOnPointPosition Position_DefaultValue { get; set; }
