...
{
	public partial class PlotOptionsAreaSonificationContextTracks  : BaseObject
	{
		Hashtable h = new Hashtable();

		public PlotOptionsAreaSonificationContextTracks()
		{
			ActiveWhen = ActiveWhen_DefaultValue = new PlotOptionsAreaSonificationContextTracksActiveWhen();
			Instrument = Instrument_DefaultValue = null;
			InstrumentString = InstrumentString_DefaultValue = "null";
			Mapping = Mapping_DefaultValue = new PlotOptionsAreaSonificationContextTracksMapping();
			MidiName = MidiName_DefaultValue = "";
			PointGrouping = PointGrouping_DefaultValue = new PlotOptionsAreaSonificationContextTracksPointGrouping();
			...
			Type = Type_DefaultValue = PlotOptionsAreaSonificationContextTracksType.Instrument;
			ValueInterval = ValueInterval_DefaultValue = null;
			ValueMapFunction = ValueMapFunction_DefaultValue = PlotOptionsAreaSonificationContextTracksValueMapFunction.Linear;
		...
		/// </summary>
		public PlotOptionsAreaSonificationContextTracksActiveWhen ActiveWhen { get; set; }
		private PlotOptionsAreaSonificationContextTracksActiveWhen ActiveWhen_DefaultValue { get; set; }
		...
		/// </summary>
		public PlotOptionsAreaSonificationContextTracksMapping Mapping { get; set; }
		private PlotOptionsAreaSonificationContextTracksMapping Mapping_DefaultValue { get; set; }
		...
		/// </summary>
		public PlotOptionsAreaSonificationContextTracksPointGrouping PointGrouping { get; set; }
		private PlotOptionsAreaSonificationContextTracksPointGrouping PointGrouping_DefaultValue { get; set; }
		...
		/// </summary>
		public PlotOptionsAreaSonificationContextTracksType Type { get; set; }
		private PlotOptionsAreaSonificationContextTracksType Type_DefaultValue { get; set; }
		...
		/// </summary>
		public PlotOptionsAreaSonificationContextTracksValueMapFunction ValueMapFunction { get; set; }
		private PlotOptionsAreaSonificationContextTracksValueMapFunction ValueMapFunction_DefaultValue { get; set; }
