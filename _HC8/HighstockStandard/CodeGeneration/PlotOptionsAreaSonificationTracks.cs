...
{
	public partial class PlotOptionsAreaSonificationTracks  : BaseObject
	{
		Hashtable h = new Hashtable();

		public PlotOptionsAreaSonificationTracks()
		{
			ActiveWhen = ActiveWhen_DefaultValue = new PlotOptionsAreaSonificationTracksActiveWhen();
			Instrument = Instrument_DefaultValue = null;
			InstrumentString = InstrumentString_DefaultValue = "null";
			Mapping = Mapping_DefaultValue = new PlotOptionsAreaSonificationTracksMapping();
			MidiName = MidiName_DefaultValue = "";
			PointGrouping = PointGrouping_DefaultValue = new PlotOptionsAreaSonificationTracksPointGrouping();
			RoundToMusicalNotes = RoundToMusicalNotes_DefaultValue = true;
			ShowPlayMarker = ShowPlayMarker_DefaultValue = true;
			Type = Type_DefaultValue = PlotOptionsAreaSonificationTracksType.Instrument;
		...
		/// </summary>
		public PlotOptionsAreaSonificationTracksActiveWhen ActiveWhen { get; set; }
		private PlotOptionsAreaSonificationTracksActiveWhen ActiveWhen_DefaultValue { get; set; }
		...
		/// </summary>
		public PlotOptionsAreaSonificationTracksMapping Mapping { get; set; }
		private PlotOptionsAreaSonificationTracksMapping Mapping_DefaultValue { get; set; }
		...
		/// </summary>
		public PlotOptionsAreaSonificationTracksPointGrouping PointGrouping { get; set; }
		private PlotOptionsAreaSonificationTracksPointGrouping PointGrouping_DefaultValue { get; set; }
		...
		/// </summary>
		public PlotOptionsAreaSonificationTracksType Type { get; set; }
		private PlotOptionsAreaSonificationTracksType Type_DefaultValue { get; set; }
