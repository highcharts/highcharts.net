...
{
	public partial class PlotOptionsArearangeLastPriceLabel  : BaseObject
	{
		Hashtable h = new Hashtable();

		public PlotOptionsArearangeLastPriceLabel()
		{
			Align = Align_DefaultValue = PlotOptionsArearangeLastPriceLabelAlign.Null;
		...
		/// 
		/// </summary>
		public PlotOptionsArearangeLastPriceLabelAlign Align { get; set; }
		private PlotOptionsArearangeLastPriceLabelAlign Align_DefaultValue { get; set; }
