...
{
	public partial class PlotOptionsArearangeLastVisiblePriceLabel  : BaseObject
	{
		Hashtable h = new Hashtable();

		public PlotOptionsArearangeLastVisiblePriceLabel()
		{
			Align = Align_DefaultValue = PlotOptionsArearangeLastVisiblePriceLabelAlign.Null;
		...
		/// 
		/// </summary>
		public PlotOptionsArearangeLastVisiblePriceLabelAlign Align { get; set; }
		private PlotOptionsArearangeLastVisiblePriceLabelAlign Align_DefaultValue { get; set; }
