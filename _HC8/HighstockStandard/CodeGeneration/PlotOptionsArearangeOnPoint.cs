...
{
	public partial class PlotOptionsArearangeOnPoint  : BaseObject
	{
		Hashtable h = new Hashtable();

		public PlotOptionsArearangeOnPoint()
		{
			ConnectorOptions = ConnectorOptions_DefaultValue = new PlotOptionsArearangeOnPointConnectorOptions();
			Id = Id_DefaultValue = "";
			Position = Position_DefaultValue = new PlotOptionsArearangeOnPointPosition();
		...
		/// </summary>
		public PlotOptionsArearangeOnPointConnectorOptions ConnectorOptions { get; set; }
		private PlotOptionsArearangeOnPointConnectorOptions ConnectorOptions_DefaultValue { get; set; }
		...
		private PlotOptionsArearangeOnPointPosition Position_DefaultValue { get; set; }
