...
{
	public partial class PlotOptionsAreasplineDataLabels  : BaseObject
	{
		Hashtable h = new Hashtable();

		public PlotOptionsAreasplineDataLabels()
		{
			Align = Align_DefaultValue = PlotOptionsAreasplineDataLabelsAlign.Center;
			...
			Filter = Filter_DefaultValue = new PlotOptionsAreasplineDataLabelsFilter();
			...
			Overflow = Overflow_DefaultValue = PlotOptionsAreasplineDataLabelsOverflow.Justify;
			Padding = Padding_DefaultValue = 5;
			Position = Position_DefaultValue = PlotOptionsAreasplineDataLabelsPosition.Center;
			...
			TextPath = TextPath_DefaultValue = new PlotOptionsAreasplineDataLabelsTextPath();
			UseHTML = UseHTML_DefaultValue = false;
			VerticalAlign = VerticalAlign_DefaultValue = PlotOptionsAreasplineDataLabelsVerticalAlign.Bottom;
			X = X_DefaultValue = 0;
			Y = Y_DefaultValue = 0;
			Z = Z_DefaultValue = 6;
		...
		/// </summary>
		public PlotOptionsAreasplineDataLabelsAlign Align { get; set; }
		private PlotOptionsAreasplineDataLabelsAlign Align_DefaultValue { get; set; }
		...
		/// </summary>
		public PlotOptionsAreasplineDataLabelsFilter Filter { get; set; }
		private PlotOptionsAreasplineDataLabelsFilter Filter_DefaultValue { get; set; }
		...
		/// </summary>
		public PlotOptionsAreasplineDataLabelsOverflow Overflow { get; set; }
		private PlotOptionsAreasplineDataLabelsOverflow Overflow_DefaultValue { get; set; }
		...
		/// </summary>
		public PlotOptionsAreasplineDataLabelsPosition Position { get; set; }
		private PlotOptionsAreasplineDataLabelsPosition Position_DefaultValue { get; set; }
		...
		/// </summary>
		public PlotOptionsAreasplineDataLabelsTextPath TextPath { get; set; }
		private PlotOptionsAreasplineDataLabelsTextPath TextPath_DefaultValue { get; set; }
		...
		/// </summary>
		public PlotOptionsAreasplineDataLabelsVerticalAlign VerticalAlign { get; set; }
		private PlotOptionsAreasplineDataLabelsVerticalAlign VerticalAlign_DefaultValue { get; set; }
