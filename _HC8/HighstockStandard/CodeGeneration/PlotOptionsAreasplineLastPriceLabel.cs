...
{
	public partial class PlotOptionsAreasplineLastPriceLabel  : BaseObject
	{
		Hashtable h = new Hashtable();

		public PlotOptionsAreasplineLastPriceLabel()
		{
			Align = Align_DefaultValue = PlotOptionsAreasplineLastPriceLabelAlign.Null;
		...
		/// 
		/// </summary>
		public PlotOptionsAreasplineLastPriceLabelAlign Align { get; set; }
		private PlotOptionsAreasplineLastPriceLabelAlign Align_DefaultValue { get; set; }
