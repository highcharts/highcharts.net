...
{
	public partial class PlotOptionsAreasplineLastVisiblePriceLabel  : BaseObject
	{
		Hashtable h = new Hashtable();

		public PlotOptionsAreasplineLastVisiblePriceLabel()
		{
			Align = Align_DefaultValue = PlotOptionsAreasplineLastVisiblePriceLabelAlign.Null;
		...
		/// 
		/// </summary>
		public PlotOptionsAreasplineLastVisiblePriceLabelAlign Align { get; set; }
		private PlotOptionsAreasplineLastVisiblePriceLabelAlign Align_DefaultValue { get; set; }
