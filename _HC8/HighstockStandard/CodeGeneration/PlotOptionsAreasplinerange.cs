...
namespace Highsoft.Web.Mvc.Stocks
{
	public partial class PlotOptionsAreasplinerange  : BaseObject
	{
		...
		public PlotOptionsAreasplinerange()
		{
			...
			BoostBlending = BoostBlending_DefaultValue = PlotOptionsAreasplinerangeBoostBlending.Undefined;
			...
			Step = Step_DefaultValue = PlotOptionsAreasplinerangeStep.Null;
		...
		/// </summary>
		public PlotOptionsAreasplinerangeBoostBlending BoostBlending { get; set; }
		private PlotOptionsAreasplinerangeBoostBlending BoostBlending_DefaultValue { get; set; }
