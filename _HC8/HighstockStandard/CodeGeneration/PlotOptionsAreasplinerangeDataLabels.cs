...
namespace Highsoft.Web.Mvc.Stocks
{
	public partial class PlotOptionsAreasplinerangeDataLabels  : BaseObject
	{
		...
		public PlotOptionsAreasplinerangeDataLabels()
		{
			...
			Overflow = Overflow_DefaultValue = PlotOptionsAreasplinerangeDataLabelsOverflow.Justify;
			Padding = Padding_DefaultValue = 5;
			Position = Position_DefaultValue = PlotOptionsAreasplinerangeDataLabelsPosition.Center;
			...
			TextPath = TextPath_DefaultValue = new PlotOptionsAreasplinerangeDataLabelsTextPath();
			UseHTML = UseHTML_DefaultValue = false;
			VerticalAlign = VerticalAlign_DefaultValue = PlotOptionsAreasplinerangeDataLabelsVerticalAlign.Bottom;
			X = X_DefaultValue = 0;
			Y = Y_DefaultValue = 0;
			Z = Z_DefaultValue = 6;
