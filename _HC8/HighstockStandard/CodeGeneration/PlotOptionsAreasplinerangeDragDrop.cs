...
{
	public partial class PlotOptionsAreasplinerangeDragDrop  : BaseObject
	{
		Hashtable h = new Hashtable();

		public PlotOptionsAreasplinerangeDragDrop()
		{
			DraggableX = DraggableX_DefaultValue = null;
			DraggableY = DraggableY_DefaultValue = null;
			DragHandle = DragHandle_DefaultValue = new PlotOptionsAreasplinerangeDragDropDragHandle();
			...
			GuideBox = GuideBox_DefaultValue = new PlotOptionsAreasplinerangeDragDropGuideBox();
		...
		/// </summary>
		public PlotOptionsAreasplinerangeDragDropDragHandle DragHandle { get; set; }
		private PlotOptionsAreasplinerangeDragDropDragHandle DragHandle_DefaultValue { get; set; }
		...
		/// </summary>
		public PlotOptionsAreasplinerangeDragDropGuideBox GuideBox { get; set; }
		private PlotOptionsAreasplinerangeDragDropGuideBox GuideBox_DefaultValue { get; set; }
