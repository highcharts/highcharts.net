...
{
	public partial class PlotOptionsAreasplinerangeLastPriceLabel  : BaseObject
	{
		Hashtable h = new Hashtable();

		public PlotOptionsAreasplinerangeLastPriceLabel()
		{
			Align = Align_DefaultValue = PlotOptionsAreasplinerangeLastPriceLabelAlign.Null;
		...
		/// 
		/// </summary>
		public PlotOptionsAreasplinerangeLastPriceLabelAlign Align { get; set; }
		private PlotOptionsAreasplinerangeLastPriceLabelAlign Align_DefaultValue { get; set; }
