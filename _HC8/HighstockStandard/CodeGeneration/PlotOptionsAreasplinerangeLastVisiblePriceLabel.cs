...
{
	public partial class PlotOptionsAreasplinerangeLastVisiblePriceLabel  : BaseObject
	{
		Hashtable h = new Hashtable();

		public PlotOptionsAreasplinerangeLastVisiblePriceLabel()
		{
			Align = Align_DefaultValue = PlotOptionsAreasplinerangeLastVisiblePriceLabelAlign.Null;
		...
		/// 
		/// </summary>
		public PlotOptionsAreasplinerangeLastVisiblePriceLabelAlign Align { get; set; }
		private PlotOptionsAreasplinerangeLastVisiblePriceLabelAlign Align_DefaultValue { get; set; }
