...
namespace Highsoft.Web.Mvc.Stocks
{
	public partial class PlotOptionsAroon  : BaseObject
	{
		...
		public PlotOptionsAroon()
		{
			...
			DashStyle = DashStyle_DefaultValue = PlotOptionsAroonDashStyle.Solid;
		...
		internal override Hashtable ToHashtable()
		{
			...
			if (AroonDown.IsDirty()) h.Add("aroonDown",AroonDown.ToHashtable());
			...
			if (PointDescriptionFormatter != PointDescriptionFormatter_DefaultValue) { h.Add("pointDescriptionFormatter",PointDescriptionFormatter); Highstock.AddFunction("PlotOptionsAroonPointDescriptionFormatter.pointDescriptionFormatter", PointDescriptionFormatter); }  
