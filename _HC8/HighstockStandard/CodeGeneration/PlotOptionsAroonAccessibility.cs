...
namespace Highsoft.Web.Mvc.Stocks
{
	public partial class PlotOptionsAroonAccessibility  : BaseObject
	{
		...
		public PlotOptionsAroonAccessibility()
		{
			...
			Point = Point_DefaultValue = new PlotOptionsAroonAccessibilityPoint();
		...
		/// </summary>
		public PlotOptionsAroonAccessibilityPoint Point { get; set; }
		private PlotOptionsAroonAccessibilityPoint Point_DefaultValue { get; set; }
