...
{
	public partial class PlotOptionsAroonDataLabels  : BaseObject
	{
		Hashtable h = new Hashtable();

		public PlotOptionsAroonDataLabels()
		{
			Align = Align_DefaultValue = PlotOptionsAroonDataLabelsAlign.Center;
			...
			Filter = Filter_DefaultValue = new PlotOptionsAroonDataLabelsFilter();
			...
			Overflow = Overflow_DefaultValue = PlotOptionsAroonDataLabelsOverflow.Justify;
			Padding = Padding_DefaultValue = 5;
			Position = Position_DefaultValue = PlotOptionsAroonDataLabelsPosition.Center;
			...
			TextPath = TextPath_DefaultValue = new PlotOptionsAroonDataLabelsTextPath();
			UseHTML = UseHTML_DefaultValue = false;
			VerticalAlign = VerticalAlign_DefaultValue = PlotOptionsAroonDataLabelsVerticalAlign.Bottom;
			X = X_DefaultValue = 0;
			Y = Y_DefaultValue = 0;
			Z = Z_DefaultValue = 6;
		...
		/// </summary>
		public PlotOptionsAroonDataLabelsAlign Align { get; set; }
		private PlotOptionsAroonDataLabelsAlign Align_DefaultValue { get; set; }
		...
		/// </summary>
		public PlotOptionsAroonDataLabelsFilter Filter { get; set; }
		private PlotOptionsAroonDataLabelsFilter Filter_DefaultValue { get; set; }
		...
		/// </summary>
		public PlotOptionsAroonDataLabelsOverflow Overflow { get; set; }
		private PlotOptionsAroonDataLabelsOverflow Overflow_DefaultValue { get; set; }
		...
		/// </summary>
		public PlotOptionsAroonDataLabelsPosition Position { get; set; }
		private PlotOptionsAroonDataLabelsPosition Position_DefaultValue { get; set; }
		...
		/// </summary>
		public PlotOptionsAroonDataLabelsTextPath TextPath { get; set; }
		private PlotOptionsAroonDataLabelsTextPath TextPath_DefaultValue { get; set; }
		...
		/// </summary>
		public PlotOptionsAroonDataLabelsVerticalAlign VerticalAlign { get; set; }
		private PlotOptionsAroonDataLabelsVerticalAlign VerticalAlign_DefaultValue { get; set; }
