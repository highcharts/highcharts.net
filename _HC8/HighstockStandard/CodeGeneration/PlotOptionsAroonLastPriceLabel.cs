...
{
	public partial class PlotOptionsAroonLastPriceLabel  : BaseObject
	{
		Hashtable h = new Hashtable();

		public PlotOptionsAroonLastPriceLabel()
		{
			Align = Align_DefaultValue = PlotOptionsAroonLastPriceLabelAlign.Null;
		...
		/// 
		/// </summary>
		public PlotOptionsAroonLastPriceLabelAlign Align { get; set; }
		private PlotOptionsAroonLastPriceLabelAlign Align_DefaultValue { get; set; }
