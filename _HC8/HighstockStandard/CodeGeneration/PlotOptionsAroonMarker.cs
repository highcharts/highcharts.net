...
{
	public partial class PlotOptionsAroonMarker  : BaseObject
	{
		Hashtable h = new Hashtable();

		public PlotOptionsAroonMarker()
		{
			...
			States = States_DefaultValue = new PlotOptionsAroonMarkerStates();
		...
		/// </summary>
		public PlotOptionsAroonMarkerStates States { get; set; }
		private PlotOptionsAroonMarkerStates States_DefaultValue { get; set; }
