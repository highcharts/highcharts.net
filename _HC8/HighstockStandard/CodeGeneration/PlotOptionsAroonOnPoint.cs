...
{
	public partial class PlotOptionsAroonOnPoint  : BaseObject
	{
		Hashtable h = new Hashtable();

		public PlotOptionsAroonOnPoint()
		{
			ConnectorOptions = ConnectorOptions_DefaultValue = new PlotOptionsAroonOnPointConnectorOptions();
			Id = Id_DefaultValue = "";
			Position = Position_DefaultValue = new PlotOptionsAroonOnPointPosition();
		...
		/// </summary>
		public PlotOptionsAroonOnPointConnectorOptions ConnectorOptions { get; set; }
		private PlotOptionsAroonOnPointConnectorOptions ConnectorOptions_DefaultValue { get; set; }
		...
		/// </summary>
		public PlotOptionsAroonOnPointPosition Position { get; set; }
		private PlotOptionsAroonOnPointPosition Position_DefaultValue { get; set; }
