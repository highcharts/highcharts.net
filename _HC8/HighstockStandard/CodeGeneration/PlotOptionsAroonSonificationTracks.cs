...
{
	public partial class PlotOptionsAroonSonificationTracks  : BaseObject
	{
		Hashtable h = new Hashtable();

		public PlotOptionsAroonSonificationTracks()
		{
			ActiveWhen = ActiveWhen_DefaultValue = new PlotOptionsAroonSonificationTracksActiveWhen();
			Instrument = Instrument_DefaultValue = null;
			InstrumentString = InstrumentString_DefaultValue = "null";
			Mapping = Mapping_DefaultValue = new PlotOptionsAroonSonificationTracksMapping();
			MidiName = MidiName_DefaultValue = "";
			PointGrouping = PointGrouping_DefaultValue = new PlotOptionsAroonSonificationTracksPointGrouping();
			RoundToMusicalNotes = RoundToMusicalNotes_DefaultValue = true;
			ShowPlayMarker = ShowPlayMarker_DefaultValue = true;
			Type = Type_DefaultValue = PlotOptionsAroonSonificationTracksType.Instrument;
		...
		/// </summary>
		public PlotOptionsAroonSonificationTracksActiveWhen ActiveWhen { get; set; }
		private PlotOptionsAroonSonificationTracksActiveWhen ActiveWhen_DefaultValue { get; set; }
		...
		/// </summary>
		public PlotOptionsAroonSonificationTracksMapping Mapping { get; set; }
		private PlotOptionsAroonSonificationTracksMapping Mapping_DefaultValue { get; set; }
		...
		/// </summary>
		public PlotOptionsAroonSonificationTracksPointGrouping PointGrouping { get; set; }
		private PlotOptionsAroonSonificationTracksPointGrouping PointGrouping_DefaultValue { get; set; }
		...
		/// </summary>
		public PlotOptionsAroonSonificationTracksType Type { get; set; }
		private PlotOptionsAroonSonificationTracksType Type_DefaultValue { get; set; }
