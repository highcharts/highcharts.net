...
{
	public partial class PlotOptionsAroonStates  : BaseObject
	{
		Hashtable h = new Hashtable();

		public PlotOptionsAroonStates()
		{
		...
		/// </summary>
		public PlotOptionsAroonStatesHover Hover { get; set; }
		private PlotOptionsAroonStatesHover Hover_DefaultValue { get; set; }
		 

		/// <summary>
		/// The opposite state of a hover for series.
		/// </summary>
		public PlotOptionsAroonStatesInactive Inactive { get; set; }
		private PlotOptionsAroonStatesInactive Inactive_DefaultValue { get; set; }
