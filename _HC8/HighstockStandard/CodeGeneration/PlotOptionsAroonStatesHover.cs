...
{
	public partial class PlotOptionsAroonStatesHover  : BaseObject
	{
		Hashtable h = new Hashtable();

		public PlotOptionsAroonStatesHover()
		{
			Animation = Animation_DefaultValue = new Animation() { Enabled = true };
			Enabled = Enabled_DefaultValue = null;
			Halo = Halo_DefaultValue = new PlotOptionsAroonStatesHoverHalo();
			LineWidth = LineWidth_DefaultValue = null;
			LineWidthPlus = LineWidthPlus_DefaultValue = null;
			Marker = Marker_DefaultValue = new PlotOptionsAroonStatesHoverMarker();
		...
		/// </summary>
		public PlotOptionsAroonStatesHoverHalo Halo { get; set; }
		private PlotOptionsAroonStatesHoverHalo Halo_DefaultValue { get; set; }
		...
		/// </summary>
		public PlotOptionsAroonStatesHoverMarker Marker { get; set; }
		private PlotOptionsAroonStatesHoverMarker Marker_DefaultValue { get; set; }
