...
{
	public partial class PlotOptionsAroonStatesHoverMarker  : BaseObject
	{
		Hashtable h = new Hashtable();

		public PlotOptionsAroonStatesHoverMarker()
		{
			...
			States = States_DefaultValue = new PlotOptionsAroonStatesHoverMarkerStates();
		...
		/// </summary>
		public PlotOptionsAroonStatesHoverMarkerStates States { get; set; }
		private PlotOptionsAroonStatesHoverMarkerStates States_DefaultValue { get; set; }
