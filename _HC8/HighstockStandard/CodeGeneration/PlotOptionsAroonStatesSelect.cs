...
{
	public partial class PlotOptionsAroonStatesSelect  : BaseObject
	{
		Hashtable h = new Hashtable();

		public PlotOptionsAroonStatesSelect()
		{
			Animation = Animation_DefaultValue = new Animation() { Enabled = true };
			Enabled = Enabled_DefaultValue = null;
			Halo = Halo_DefaultValue = new PlotOptionsAroonStatesSelectHalo();
			LineWidth = LineWidth_DefaultValue = null;
			LineWidthPlus = LineWidthPlus_DefaultValue = null;
			Marker = Marker_DefaultValue = new PlotOptionsAroonStatesSelectMarker();
		...
		/// </summary>
		public PlotOptionsAroonStatesSelectHalo Halo { get; set; }
		private PlotOptionsAroonStatesSelectHalo Halo_DefaultValue { get; set; }
		...
		/// </summary>
		public PlotOptionsAroonStatesSelectMarker Marker { get; set; }
		private PlotOptionsAroonStatesSelectMarker Marker_DefaultValue { get; set; }
