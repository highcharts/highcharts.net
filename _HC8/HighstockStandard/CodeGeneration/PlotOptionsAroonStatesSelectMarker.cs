...
{
	public partial class PlotOptionsAroonStatesSelectMarker  : BaseObject
	{
		Hashtable h = new Hashtable();

		public PlotOptionsAroonStatesSelectMarker()
		{
			...
			States = States_DefaultValue = new PlotOptionsAroonStatesSelectMarkerStates();
		...
		/// </summary>
		public PlotOptionsAroonStatesSelectMarkerStates States { get; set; }
		private PlotOptionsAroonStatesSelectMarkerStates States_DefaultValue { get; set; }
