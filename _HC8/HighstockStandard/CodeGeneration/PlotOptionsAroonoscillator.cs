...
namespace Highsoft.Web.Mvc.Stocks
{
	public partial class PlotOptionsAroonoscillator  : BaseObject
	{
		...
		public PlotOptionsAroonoscillator()
		{
			...
			DashStyle = DashStyle_DefaultValue = PlotOptionsAroonoscillatorDashStyle.Solid;
		...
		internal override Hashtable ToHashtable()
		{
			...
			if (PointDescriptionFormatter != PointDescriptionFormatter_DefaultValue) { h.Add("pointDescriptionFormatter",PointDescriptionFormatter); Highstock.AddFunction("PlotOptionsAroonoscillatorPointDescriptionFormatter.pointDescriptionFormatter", PointDescriptionFormatter); }  
