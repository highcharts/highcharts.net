...
{
	public partial class PlotOptionsAroonoscillatorDataLabels  : BaseObject
	{
		Hashtable h = new Hashtable();

		public PlotOptionsAroonoscillatorDataLabels()
		{
			Align = Align_DefaultValue = PlotOptionsAroonoscillatorDataLabelsAlign.Center;
			...
			Filter = Filter_DefaultValue = new PlotOptionsAroonoscillatorDataLabelsFilter();
			...
			Overflow = Overflow_DefaultValue = PlotOptionsAroonoscillatorDataLabelsOverflow.Justify;
			Padding = Padding_DefaultValue = 5;
			Position = Position_DefaultValue = PlotOptionsAroonoscillatorDataLabelsPosition.Center;
			...
			TextPath = TextPath_DefaultValue = new PlotOptionsAroonoscillatorDataLabelsTextPath();
			UseHTML = UseHTML_DefaultValue = false;
			VerticalAlign = VerticalAlign_DefaultValue = PlotOptionsAroonoscillatorDataLabelsVerticalAlign.Bottom;
			X = X_DefaultValue = 0;
			Y = Y_DefaultValue = 0;
			Z = Z_DefaultValue = 6;
		...
		/// </summary>
		public PlotOptionsAroonoscillatorDataLabelsAlign Align { get; set; }
		private PlotOptionsAroonoscillatorDataLabelsAlign Align_DefaultValue { get; set; }
		...
		/// </summary>
		public PlotOptionsAroonoscillatorDataLabelsFilter Filter { get; set; }
		private PlotOptionsAroonoscillatorDataLabelsFilter Filter_DefaultValue { get; set; }
		...
		/// </summary>
		public PlotOptionsAroonoscillatorDataLabelsOverflow Overflow { get; set; }
		private PlotOptionsAroonoscillatorDataLabelsOverflow Overflow_DefaultValue { get; set; }
		...
		/// </summary>
		public PlotOptionsAroonoscillatorDataLabelsPosition Position { get; set; }
		private PlotOptionsAroonoscillatorDataLabelsPosition Position_DefaultValue { get; set; }
		...
		/// </summary>
		public PlotOptionsAroonoscillatorDataLabelsTextPath TextPath { get; set; }
		private PlotOptionsAroonoscillatorDataLabelsTextPath TextPath_DefaultValue { get; set; }
		...
		/// </summary>
		public PlotOptionsAroonoscillatorDataLabelsVerticalAlign VerticalAlign { get; set; }
		private PlotOptionsAroonoscillatorDataLabelsVerticalAlign VerticalAlign_DefaultValue { get; set; }
