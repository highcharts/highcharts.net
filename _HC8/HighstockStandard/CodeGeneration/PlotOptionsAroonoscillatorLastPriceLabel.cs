...
{
	public partial class PlotOptionsAroonoscillatorLastPriceLabel  : BaseObject
	{
		Hashtable h = new Hashtable();

		public PlotOptionsAroonoscillatorLastPriceLabel()
		{
			Align = Align_DefaultValue = PlotOptionsAroonoscillatorLastPriceLabelAlign.Null;
		...
		/// 
		/// </summary>
		public PlotOptionsAroonoscillatorLastPriceLabelAlign Align { get; set; }
		private PlotOptionsAroonoscillatorLastPriceLabelAlign Align_DefaultValue { get; set; }
