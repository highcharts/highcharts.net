...
{
	public partial class PlotOptionsAroonoscillatorLastVisiblePriceLabel  : BaseObject
	{
		Hashtable h = new Hashtable();

		public PlotOptionsAroonoscillatorLastVisiblePriceLabel()
		{
			Align = Align_DefaultValue = PlotOptionsAroonoscillatorLastVisiblePriceLabelAlign.Null;
		...
		/// 
		/// </summary>
		public PlotOptionsAroonoscillatorLastVisiblePriceLabelAlign Align { get; set; }
		private PlotOptionsAroonoscillatorLastVisiblePriceLabelAlign Align_DefaultValue { get; set; }
