...
{
	public partial class PlotOptionsAroonoscillatorMarker  : BaseObject
	{
		Hashtable h = new Hashtable();

		public PlotOptionsAroonoscillatorMarker()
		{
			...
			States = States_DefaultValue = new PlotOptionsAroonoscillatorMarkerStates();
		...
		/// </summary>
		public PlotOptionsAroonoscillatorMarkerStates States { get; set; }
		private PlotOptionsAroonoscillatorMarkerStates States_DefaultValue { get; set; }
