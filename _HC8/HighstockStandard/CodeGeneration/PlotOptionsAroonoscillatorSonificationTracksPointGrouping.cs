...
{
	public partial class PlotOptionsAroonoscillatorSonificationTracksPointGrouping  : BaseObject
	{
		Hashtable h = new Hashtable();

		public PlotOptionsAroonoscillatorSonificationTracksPointGrouping()
		{
			Algorithm = Algorithm_DefaultValue = PlotOptionsAroonoscillatorSonificationTracksPointGroupingAlgorithm.Minimax;
		...
		/// </summary>
		public PlotOptionsAroonoscillatorSonificationTracksPointGroupingAlgorithm Algorithm { get; set; }
		private PlotOptionsAroonoscillatorSonificationTracksPointGroupingAlgorithm Algorithm_DefaultValue { get; set; }
