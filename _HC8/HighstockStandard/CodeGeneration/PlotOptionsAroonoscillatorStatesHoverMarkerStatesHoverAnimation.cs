...
{
	public partial class PlotOptionsAroonoscillatorStatesHoverMarkerStatesHoverAnimation  : BaseObject
	{
		Hashtable h = new Hashtable();

		public PlotOptionsAroonoscillatorStatesHoverMarkerStatesHoverAnimation()
		{
