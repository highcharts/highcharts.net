...
{
	public partial class PlotOptionsAroonoscillatorStatesSelect  : BaseObject
	{
		Hashtable h = new Hashtable();

		public PlotOptionsAroonoscillatorStatesSelect()
		{
			Animation = Animation_DefaultValue = new Animation() { Enabled = true };
			Enabled = Enabled_DefaultValue = null;
			Halo = Halo_DefaultValue = new PlotOptionsAroonoscillatorStatesSelectHalo();
			LineWidth = LineWidth_DefaultValue = null;
			LineWidthPlus = LineWidthPlus_DefaultValue = null;
			Marker = Marker_DefaultValue = new PlotOptionsAroonoscillatorStatesSelectMarker();
		...
		/// </summary>
		public PlotOptionsAroonoscillatorStatesSelectHalo Halo { get; set; }
		private PlotOptionsAroonoscillatorStatesSelectHalo Halo_DefaultValue { get; set; }
		...
		/// </summary>
		public PlotOptionsAroonoscillatorStatesSelectMarker Marker { get; set; }
		private PlotOptionsAroonoscillatorStatesSelectMarker Marker_DefaultValue { get; set; }
