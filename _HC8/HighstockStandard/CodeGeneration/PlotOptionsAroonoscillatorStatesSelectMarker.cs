...
{
	public partial class PlotOptionsAroonoscillatorStatesSelectMarker  : BaseObject
	{
		Hashtable h = new Hashtable();

		public PlotOptionsAroonoscillatorStatesSelectMarker()
		{
			...
			States = States_DefaultValue = new PlotOptionsAroonoscillatorStatesSelectMarkerStates();
		...
		/// </summary>
		public PlotOptionsAroonoscillatorStatesSelectMarkerStates States { get; set; }
		private PlotOptionsAroonoscillatorStatesSelectMarkerStates States_DefaultValue { get; set; }
