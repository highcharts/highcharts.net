...
{
	public partial class PlotOptionsAroonoscillatorStatesSelectMarkerStatesHoverAnimation  : BaseObject
	{
		Hashtable h = new Hashtable();

		public PlotOptionsAroonoscillatorStatesSelectMarkerStatesHoverAnimation()
		{
