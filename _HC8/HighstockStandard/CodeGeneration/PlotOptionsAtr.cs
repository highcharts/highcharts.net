...
namespace Highsoft.Web.Mvc.Stocks
{
	public partial class PlotOptionsAtr  : BaseObject
	{
		...
		public PlotOptionsAtr()
		{
			...
			DashStyle = DashStyle_DefaultValue = PlotOptionsAtrDashStyle.Solid;
		...
		internal override Hashtable ToHashtable()
		{
			...
			if (PointDescriptionFormatter != PointDescriptionFormatter_DefaultValue) { h.Add("pointDescriptionFormatter",PointDescriptionFormatter); Highstock.AddFunction("PlotOptionsAtrPointDescriptionFormatter.pointDescriptionFormatter", PointDescriptionFormatter); }  
