...
namespace Highsoft.Web.Mvc.Stocks
{
	public partial class PlotOptionsAtr  : BaseObject
	{
		...
		public PlotOptionsAtr()
		{
			...
			DragDrop = DragDrop_DefaultValue = new PlotOptionsAtrDragDrop();
		...
		/// </summary>
		public PlotOptionsAtrDragDrop DragDrop { get; set; }
		private PlotOptionsAtrDragDrop DragDrop_DefaultValue { get; set; }
