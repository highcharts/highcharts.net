...
namespace Highsoft.Web.Mvc.Stocks
{
	public partial class PlotOptionsAtrDataGrouping  : BaseObject
	{
		...
		internal override Hashtable ToHashtable()
		{
			...
			if (Approximation != Approximation_DefaultValue) { h.Add("approximation",Approximation); Highstock.AddFunction("PlotOptionsAtrDataGroupingApproximation.approximation", Approximation); }  
