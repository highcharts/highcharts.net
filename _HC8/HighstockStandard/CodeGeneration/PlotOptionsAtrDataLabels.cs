...
{
	public partial class PlotOptionsAtrDataLabels  : BaseObject
	{
		Hashtable h = new Hashtable();

		public PlotOptionsAtrDataLabels()
		{
			Align = Align_DefaultValue = PlotOptionsAtrDataLabelsAlign.Center;
			...
			Filter = Filter_DefaultValue = new PlotOptionsAtrDataLabelsFilter();
			...
			Overflow = Overflow_DefaultValue = PlotOptionsAtrDataLabelsOverflow.Justify;
			Padding = Padding_DefaultValue = 5;
			Position = Position_DefaultValue = PlotOptionsAtrDataLabelsPosition.Center;
			...
			TextPath = TextPath_DefaultValue = new PlotOptionsAtrDataLabelsTextPath();
			UseHTML = UseHTML_DefaultValue = false;
			VerticalAlign = VerticalAlign_DefaultValue = PlotOptionsAtrDataLabelsVerticalAlign.Bottom;
			X = X_DefaultValue = 0;
			Y = Y_DefaultValue = 0;
			Z = Z_DefaultValue = 6;
		...
		/// </summary>
		public PlotOptionsAtrDataLabelsAlign Align { get; set; }
		private PlotOptionsAtrDataLabelsAlign Align_DefaultValue { get; set; }
		...
		/// </summary>
		public PlotOptionsAtrDataLabelsFilter Filter { get; set; }
		private PlotOptionsAtrDataLabelsFilter Filter_DefaultValue { get; set; }
		...
		/// </summary>
		public PlotOptionsAtrDataLabelsOverflow Overflow { get; set; }
		private PlotOptionsAtrDataLabelsOverflow Overflow_DefaultValue { get; set; }
		...
		/// </summary>
		public PlotOptionsAtrDataLabelsPosition Position { get; set; }
		private PlotOptionsAtrDataLabelsPosition Position_DefaultValue { get; set; }
		...
		/// </summary>
		public PlotOptionsAtrDataLabelsTextPath TextPath { get; set; }
		private PlotOptionsAtrDataLabelsTextPath TextPath_DefaultValue { get; set; }
		...
		/// </summary>
		public PlotOptionsAtrDataLabelsVerticalAlign VerticalAlign { get; set; }
		private PlotOptionsAtrDataLabelsVerticalAlign VerticalAlign_DefaultValue { get; set; }
