...
{
	public partial class PlotOptionsAtrLastPriceLabel  : BaseObject
	{
		Hashtable h = new Hashtable();

		public PlotOptionsAtrLastPriceLabel()
		{
			Align = Align_DefaultValue = PlotOptionsAtrLastPriceLabelAlign.Null;
		...
		/// 
		/// </summary>
		public PlotOptionsAtrLastPriceLabelAlign Align { get; set; }
		private PlotOptionsAtrLastPriceLabelAlign Align_DefaultValue { get; set; }
