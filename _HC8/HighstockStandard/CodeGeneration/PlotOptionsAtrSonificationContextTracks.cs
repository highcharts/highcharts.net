...
{
	public partial class PlotOptionsAtrSonificationContextTracks  : BaseObject
	{
		Hashtable h = new Hashtable();

		public PlotOptionsAtrSonificationContextTracks()
		{
			ActiveWhen = ActiveWhen_DefaultValue = new PlotOptionsAtrSonificationContextTracksActiveWhen();
			Instrument = Instrument_DefaultValue = null;
			InstrumentString = InstrumentString_DefaultValue = "null";
			Mapping = Mapping_DefaultValue = new PlotOptionsAtrSonificationContextTracksMapping();
			MidiName = MidiName_DefaultValue = "";
			PointGrouping = PointGrouping_DefaultValue = new PlotOptionsAtrSonificationContextTracksPointGrouping();
			...
			Type = Type_DefaultValue = PlotOptionsAtrSonificationContextTracksType.Instrument;
			ValueInterval = ValueInterval_DefaultValue = null;
			ValueMapFunction = ValueMapFunction_DefaultValue = PlotOptionsAtrSonificationContextTracksValueMapFunction.Linear;
		...
		/// </summary>
		public PlotOptionsAtrSonificationContextTracksActiveWhen ActiveWhen { get; set; }
		private PlotOptionsAtrSonificationContextTracksActiveWhen ActiveWhen_DefaultValue { get; set; }
		...
		/// </summary>
		public PlotOptionsAtrSonificationContextTracksMapping Mapping { get; set; }
		private PlotOptionsAtrSonificationContextTracksMapping Mapping_DefaultValue { get; set; }
		...
		/// </summary>
		public PlotOptionsAtrSonificationContextTracksPointGrouping PointGrouping { get; set; }
		private PlotOptionsAtrSonificationContextTracksPointGrouping PointGrouping_DefaultValue { get; set; }
		...
		/// </summary>
		public PlotOptionsAtrSonificationContextTracksType Type { get; set; }
		private PlotOptionsAtrSonificationContextTracksType Type_DefaultValue { get; set; }
		...
		/// </summary>
		public PlotOptionsAtrSonificationContextTracksValueMapFunction ValueMapFunction { get; set; }
		private PlotOptionsAtrSonificationContextTracksValueMapFunction ValueMapFunction_DefaultValue { get; set; }
