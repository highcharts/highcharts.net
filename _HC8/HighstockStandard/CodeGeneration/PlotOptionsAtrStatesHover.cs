...
{
	public partial class PlotOptionsAtrStatesHover  : BaseObject
	{
		Hashtable h = new Hashtable();

		public PlotOptionsAtrStatesHover()
		{
			Animation = Animation_DefaultValue = new Animation() { Enabled = true };
			Enabled = Enabled_DefaultValue = null;
			Halo = Halo_DefaultValue = new PlotOptionsAtrStatesHoverHalo();
			LineWidth = LineWidth_DefaultValue = null;
			LineWidthPlus = LineWidthPlus_DefaultValue = null;
			Marker = Marker_DefaultValue = new PlotOptionsAtrStatesHoverMarker();
		...
		/// </summary>
		public PlotOptionsAtrStatesHoverHalo Halo { get; set; }
		private PlotOptionsAtrStatesHoverHalo Halo_DefaultValue { get; set; }
		...
		/// </summary>
		public PlotOptionsAtrStatesHoverMarker Marker { get; set; }
		private PlotOptionsAtrStatesHoverMarker Marker_DefaultValue { get; set; }
