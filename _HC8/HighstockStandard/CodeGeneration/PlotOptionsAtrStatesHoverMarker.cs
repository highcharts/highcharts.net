...
{
	public partial class PlotOptionsAtrStatesHoverMarker  : BaseObject
	{
		Hashtable h = new Hashtable();

		public PlotOptionsAtrStatesHoverMarker()
		{
			...
			States = States_DefaultValue = new PlotOptionsAtrStatesHoverMarkerStates();
		...
		/// </summary>
		public PlotOptionsAtrStatesHoverMarkerStates States { get; set; }
		private PlotOptionsAtrStatesHoverMarkerStates States_DefaultValue { get; set; }
