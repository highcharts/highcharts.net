...
{
	public partial class PlotOptionsAtrStatesSelectMarker  : BaseObject
	{
		Hashtable h = new Hashtable();

		public PlotOptionsAtrStatesSelectMarker()
		{
			...
			States = States_DefaultValue = new PlotOptionsAtrStatesSelectMarkerStates();
		...
		/// </summary>
		public PlotOptionsAtrStatesSelectMarkerStates States { get; set; }
		private PlotOptionsAtrStatesSelectMarkerStates States_DefaultValue { get; set; }
