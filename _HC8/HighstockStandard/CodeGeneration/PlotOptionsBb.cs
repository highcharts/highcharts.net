...
namespace Highsoft.Web.Mvc.Stocks
{
	public partial class PlotOptionsBb  : BaseObject
	{
		...
		public PlotOptionsBb()
		{
			...
			DragDrop = DragDrop_DefaultValue = new PlotOptionsBbDragDrop();
		...
		/// </summary>
		public PlotOptionsBbDragDrop DragDrop { get; set; }
		private PlotOptionsBbDragDrop DragDrop_DefaultValue { get; set; }
