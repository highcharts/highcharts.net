...
{
	public partial class PlotOptionsBbDataLabels  : BaseObject
	{
		Hashtable h = new Hashtable();

		public PlotOptionsBbDataLabels()
		{
			Align = Align_DefaultValue = PlotOptionsBbDataLabelsAlign.Center;
			...
			Filter = Filter_DefaultValue = new PlotOptionsBbDataLabelsFilter();
			...
			Overflow = Overflow_DefaultValue = PlotOptionsBbDataLabelsOverflow.Justify;
			Padding = Padding_DefaultValue = 5;
			Position = Position_DefaultValue = PlotOptionsBbDataLabelsPosition.Center;
			...
			TextPath = TextPath_DefaultValue = new PlotOptionsBbDataLabelsTextPath();
			UseHTML = UseHTML_DefaultValue = false;
			VerticalAlign = VerticalAlign_DefaultValue = PlotOptionsBbDataLabelsVerticalAlign.Bottom;
			X = X_DefaultValue = 0;
			Y = Y_DefaultValue = 0;
			Z = Z_DefaultValue = 6;
		...
		/// </summary>
		public PlotOptionsBbDataLabelsAlign Align { get; set; }
		private PlotOptionsBbDataLabelsAlign Align_DefaultValue { get; set; }
		...
		/// </summary>
		public PlotOptionsBbDataLabelsFilter Filter { get; set; }
		private PlotOptionsBbDataLabelsFilter Filter_DefaultValue { get; set; }
		...
		/// </summary>
		public PlotOptionsBbDataLabelsOverflow Overflow { get; set; }
		private PlotOptionsBbDataLabelsOverflow Overflow_DefaultValue { get; set; }
		...
		/// </summary>
		public PlotOptionsBbDataLabelsPosition Position { get; set; }
		private PlotOptionsBbDataLabelsPosition Position_DefaultValue { get; set; }
		...
		/// </summary>
		public PlotOptionsBbDataLabelsTextPath TextPath { get; set; }
		private PlotOptionsBbDataLabelsTextPath TextPath_DefaultValue { get; set; }
		...
		/// </summary>
		public PlotOptionsBbDataLabelsVerticalAlign VerticalAlign { get; set; }
		private PlotOptionsBbDataLabelsVerticalAlign VerticalAlign_DefaultValue { get; set; }
