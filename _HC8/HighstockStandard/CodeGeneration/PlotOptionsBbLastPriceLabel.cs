...
{
	public partial class PlotOptionsBbLastPriceLabel  : BaseObject
	{
		Hashtable h = new Hashtable();

		public PlotOptionsBbLastPriceLabel()
		{
			Align = Align_DefaultValue = PlotOptionsBbLastPriceLabelAlign.Null;
		...
		/// 
		/// </summary>
		public PlotOptionsBbLastPriceLabelAlign Align { get; set; }
		private PlotOptionsBbLastPriceLabelAlign Align_DefaultValue { get; set; }
