...
{
	public partial class PlotOptionsBbLastVisiblePriceLabel  : BaseObject
	{
		Hashtable h = new Hashtable();

		public PlotOptionsBbLastVisiblePriceLabel()
		{
			Align = Align_DefaultValue = PlotOptionsBbLastVisiblePriceLabelAlign.Null;
		...
		/// 
		/// </summary>
		public PlotOptionsBbLastVisiblePriceLabelAlign Align { get; set; }
		private PlotOptionsBbLastVisiblePriceLabelAlign Align_DefaultValue { get; set; }
