...
{
	public partial class PlotOptionsBbMarker  : BaseObject
	{
		Hashtable h = new Hashtable();

		public PlotOptionsBbMarker()
		{
			...
			States = States_DefaultValue = new PlotOptionsBbMarkerStates();
		...
		/// </summary>
		public PlotOptionsBbMarkerStates States { get; set; }
		private PlotOptionsBbMarkerStates States_DefaultValue { get; set; }
