...
{
	public partial class PlotOptionsBbOnPoint  : BaseObject
	{
		Hashtable h = new Hashtable();

		public PlotOptionsBbOnPoint()
		{
			ConnectorOptions = ConnectorOptions_DefaultValue = new PlotOptionsBbOnPointConnectorOptions();
			Id = Id_DefaultValue = "";
			Position = Position_DefaultValue = new PlotOptionsBbOnPointPosition();
		...
		/// </summary>
		public PlotOptionsBbOnPointConnectorOptions ConnectorOptions { get; set; }
		private PlotOptionsBbOnPointConnectorOptions ConnectorOptions_DefaultValue { get; set; }
		...
		/// </summary>
		public PlotOptionsBbOnPointPosition Position { get; set; }
		private PlotOptionsBbOnPointPosition Position_DefaultValue { get; set; }
