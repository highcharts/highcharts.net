...
{
	public partial class PlotOptionsBbSonificationContextTracks  : BaseObject
	{
		Hashtable h = new Hashtable();

		public PlotOptionsBbSonificationContextTracks()
		{
			ActiveWhen = ActiveWhen_DefaultValue = new PlotOptionsBbSonificationContextTracksActiveWhen();
			Instrument = Instrument_DefaultValue = null;
			InstrumentString = InstrumentString_DefaultValue = "null";
			Mapping = Mapping_DefaultValue = new PlotOptionsBbSonificationContextTracksMapping();
			MidiName = MidiName_DefaultValue = "";
			PointGrouping = PointGrouping_DefaultValue = new PlotOptionsBbSonificationContextTracksPointGrouping();
			...
			Type = Type_DefaultValue = PlotOptionsBbSonificationContextTracksType.Instrument;
			ValueInterval = ValueInterval_DefaultValue = null;
			ValueMapFunction = ValueMapFunction_DefaultValue = PlotOptionsBbSonificationContextTracksValueMapFunction.Linear;
		...
		/// </summary>
		public PlotOptionsBbSonificationContextTracksActiveWhen ActiveWhen { get; set; }
		private PlotOptionsBbSonificationContextTracksActiveWhen ActiveWhen_DefaultValue { get; set; }
		...
		/// </summary>
		public PlotOptionsBbSonificationContextTracksMapping Mapping { get; set; }
		private PlotOptionsBbSonificationContextTracksMapping Mapping_DefaultValue { get; set; }
		...
		/// </summary>
		public PlotOptionsBbSonificationContextTracksPointGrouping PointGrouping { get; set; }
		private PlotOptionsBbSonificationContextTracksPointGrouping PointGrouping_DefaultValue { get; set; }
		...
		/// </summary>
		public PlotOptionsBbSonificationContextTracksType Type { get; set; }
		private PlotOptionsBbSonificationContextTracksType Type_DefaultValue { get; set; }
		...
		/// </summary>
		public PlotOptionsBbSonificationContextTracksValueMapFunction ValueMapFunction { get; set; }
		private PlotOptionsBbSonificationContextTracksValueMapFunction ValueMapFunction_DefaultValue { get; set; }
