...
{
	public partial class PlotOptionsBbStatesHover  : BaseObject
	{
		Hashtable h = new Hashtable();

		public PlotOptionsBbStatesHover()
		{
			Animation = Animation_DefaultValue = new Animation() { Enabled = true };
			Enabled = Enabled_DefaultValue = null;
			Halo = Halo_DefaultValue = new PlotOptionsBbStatesHoverHalo();
			LineWidth = LineWidth_DefaultValue = null;
			LineWidthPlus = LineWidthPlus_DefaultValue = null;
			Marker = Marker_DefaultValue = new PlotOptionsBbStatesHoverMarker();
		...
		/// </summary>
		public PlotOptionsBbStatesHoverHalo Halo { get; set; }
		private PlotOptionsBbStatesHoverHalo Halo_DefaultValue { get; set; }
		...
		/// </summary>
		public PlotOptionsBbStatesHoverMarker Marker { get; set; }
		private PlotOptionsBbStatesHoverMarker Marker_DefaultValue { get; set; }
