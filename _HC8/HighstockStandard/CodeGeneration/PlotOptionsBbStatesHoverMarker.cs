...
{
	public partial class PlotOptionsBbStatesHoverMarker  : BaseObject
	{
		Hashtable h = new Hashtable();

		public PlotOptionsBbStatesHoverMarker()
		{
			...
			States = States_DefaultValue = new PlotOptionsBbStatesHoverMarkerStates();
		...
		/// </summary>
		public PlotOptionsBbStatesHoverMarkerStates States { get; set; }
		private PlotOptionsBbStatesHoverMarkerStates States_DefaultValue { get; set; }
