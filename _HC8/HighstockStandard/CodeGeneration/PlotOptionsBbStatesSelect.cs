...
{
	public partial class PlotOptionsBbStatesSelect  : BaseObject
	{
		Hashtable h = new Hashtable();

		public PlotOptionsBbStatesSelect()
		{
			Animation = Animation_DefaultValue = new Animation() { Enabled = true };
			Enabled = Enabled_DefaultValue = null;
			Halo = Halo_DefaultValue = new PlotOptionsBbStatesSelectHalo();
			LineWidth = LineWidth_DefaultValue = null;
			LineWidthPlus = LineWidthPlus_DefaultValue = null;
			Marker = Marker_DefaultValue = new PlotOptionsBbStatesSelectMarker();
		...
		/// </summary>
		public PlotOptionsBbStatesSelectHalo Halo { get; set; }
		private PlotOptionsBbStatesSelectHalo Halo_DefaultValue { get; set; }
		...
		/// </summary>
		public PlotOptionsBbStatesSelectMarker Marker { get; set; }
		private PlotOptionsBbStatesSelectMarker Marker_DefaultValue { get; set; }
