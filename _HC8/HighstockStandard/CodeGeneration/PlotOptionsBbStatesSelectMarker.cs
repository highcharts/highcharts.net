...
{
	public partial class PlotOptionsBbStatesSelectMarker  : BaseObject
	{
		Hashtable h = new Hashtable();

		public PlotOptionsBbStatesSelectMarker()
		{
			...
			States = States_DefaultValue = new PlotOptionsBbStatesSelectMarkerStates();
		...
		/// </summary>
		public PlotOptionsBbStatesSelectMarkerStates States { get; set; }
		private PlotOptionsBbStatesSelectMarkerStates States_DefaultValue { get; set; }
