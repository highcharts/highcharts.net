...
{
	public partial class PlotOptionsBubbleClusterEvents  : BaseObject
	{
		Hashtable h = new Hashtable();

		public PlotOptionsBubbleClusterEvents()
		{
		...
		internal override Hashtable ToHashtable()
		{
			...
			if (DrillToCluster != DrillToCluster_DefaultValue) { h.Add("drillToCluster",DrillToCluster); Highstock.AddFunction("PlotOptionsBubbleClusterEventsDrillToCluster.drillToCluster", DrillToCluster); }  
