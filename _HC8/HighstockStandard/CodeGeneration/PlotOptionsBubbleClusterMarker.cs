...
{
	public partial class PlotOptionsBubbleClusterMarker  : BaseObject
	{
		Hashtable h = new Hashtable();

		public PlotOptionsBubbleClusterMarker()
		{
			...
			States = States_DefaultValue = new PlotOptionsBubbleClusterMarkerStates();
		...
		/// </summary>
		public PlotOptionsBubbleClusterMarkerStates States { get; set; }
		private PlotOptionsBubbleClusterMarkerStates States_DefaultValue { get; set; }
