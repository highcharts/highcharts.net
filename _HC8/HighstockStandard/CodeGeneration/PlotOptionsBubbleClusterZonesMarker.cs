...
{
	public partial class PlotOptionsBubbleClusterZonesMarker  : BaseObject
	{
		Hashtable h = new Hashtable();

		public PlotOptionsBubbleClusterZonesMarker()
		{
			...
			States = States_DefaultValue = new PlotOptionsBubbleClusterZonesMarkerStates();
		...
		/// </summary>
		public PlotOptionsBubbleClusterZonesMarkerStates States { get; set; }
		private PlotOptionsBubbleClusterZonesMarkerStates States_DefaultValue { get; set; }
