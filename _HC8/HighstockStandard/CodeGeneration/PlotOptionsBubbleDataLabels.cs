...
namespace Highsoft.Web.Mvc.Stocks
{
	public partial class PlotOptionsBubbleDataLabels  : BaseObject
	{
		...
		internal override Hashtable ToHashtable()
		{
			...
			if (NullFormatter != NullFormatter_DefaultValue) { h.Add("nullFormatter",NullFormatter); Highstock.AddFunction("PlotOptionsBubbleDataLabelsNullFormatter.nullFormatter", NullFormatter); }  
