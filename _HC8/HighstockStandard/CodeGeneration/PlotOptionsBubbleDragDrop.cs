...
namespace Highsoft.Web.Mvc.Stocks
{
	public partial class PlotOptionsBubbleDragDrop  : BaseObject
	{
		...
		public PlotOptionsBubbleDragDrop()
		{
			DraggableX = DraggableX_DefaultValue = null;
			DraggableY = DraggableY_DefaultValue = null;
			DragHandle = DragHandle_DefaultValue = new PlotOptionsBubbleDragDropDragHandle();
			...
			GuideBox = GuideBox_DefaultValue = new PlotOptionsBubbleDragDropGuideBox();
		...
		/// </summary>
		public PlotOptionsBubbleDragDropDragHandle DragHandle { get; set; }
		private PlotOptionsBubbleDragDropDragHandle DragHandle_DefaultValue { get; set; }
		...
		/// </summary>
		public PlotOptionsBubbleDragDropGuideBox GuideBox { get; set; }
		private PlotOptionsBubbleDragDropGuideBox GuideBox_DefaultValue { get; set; }
