...
{
	public partial class PlotOptionsBubbleLastPriceLabel  : BaseObject
	{
		Hashtable h = new Hashtable();

		public PlotOptionsBubbleLastPriceLabel()
		{
			Align = Align_DefaultValue = PlotOptionsBubbleLastPriceLabelAlign.Null;
		...
		/// 
		/// </summary>
		public PlotOptionsBubbleLastPriceLabelAlign Align { get; set; }
		private PlotOptionsBubbleLastPriceLabelAlign Align_DefaultValue { get; set; }
