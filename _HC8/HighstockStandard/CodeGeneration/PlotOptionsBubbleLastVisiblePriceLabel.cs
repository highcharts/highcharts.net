...
{
	public partial class PlotOptionsBubbleLastVisiblePriceLabel  : BaseObject
	{
		Hashtable h = new Hashtable();

		public PlotOptionsBubbleLastVisiblePriceLabel()
		{
			Align = Align_DefaultValue = PlotOptionsBubbleLastVisiblePriceLabelAlign.Null;
		...
		/// 
		/// </summary>
		public PlotOptionsBubbleLastVisiblePriceLabelAlign Align { get; set; }
		private PlotOptionsBubbleLastVisiblePriceLabelAlign Align_DefaultValue { get; set; }
