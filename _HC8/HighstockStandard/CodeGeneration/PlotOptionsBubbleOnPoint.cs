...
{
	public partial class PlotOptionsBubbleOnPoint  : BaseObject
	{
		Hashtable h = new Hashtable();

		public PlotOptionsBubbleOnPoint()
		{
			ConnectorOptions = ConnectorOptions_DefaultValue = new PlotOptionsBubbleOnPointConnectorOptions();
			Id = Id_DefaultValue = "";
			Position = Position_DefaultValue = new PlotOptionsBubbleOnPointPosition();
		...
		/// </summary>
		public PlotOptionsBubbleOnPointConnectorOptions ConnectorOptions { get; set; }
		private PlotOptionsBubbleOnPointConnectorOptions ConnectorOptions_DefaultValue { get; set; }
		...
		/// </summary>
		public PlotOptionsBubbleOnPointPosition Position { get; set; }
		private PlotOptionsBubbleOnPointPosition Position_DefaultValue { get; set; }
