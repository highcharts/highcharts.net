...
namespace Highsoft.Web.Mvc.Stocks
{
	public partial class PlotOptionsCandlestick  : BaseObject
	{
		...
		/// <summary>
		/// The specific line color for up candle sticks. The default is to inheritthe general `lineColor` setting.
		/// </summary>
		...
		internal override Hashtable ToHashtable()
		{
			...
			if (PointDescriptionFormatter != PointDescriptionFormatter_DefaultValue) { h.Add("pointDescriptionFormatter",PointDescriptionFormatter); Highstock.AddFunction("PlotOptionsCandlestickPointDescriptionFormatter.pointDescriptionFormatter", PointDescriptionFormatter); }  
