...
namespace Highsoft.Web.Mvc.Stocks
{
	public partial class PlotOptionsCandlestickAccessibility  : BaseObject
	{
		...
		public PlotOptionsCandlestickAccessibility()
		{
			...
			Point = Point_DefaultValue = new PlotOptionsCandlestickAccessibilityPoint();
		...
		/// </summary>
		public PlotOptionsCandlestickAccessibilityPoint Point { get; set; }
		private PlotOptionsCandlestickAccessibilityPoint Point_DefaultValue { get; set; }
