...
namespace Highsoft.Web.Mvc.Stocks
{
	public partial class PlotOptionsCandlestickDataGrouping  : BaseObject
	{
		...
		internal override Hashtable ToHashtable()
		{
			...
			if (Approximation != Approximation_DefaultValue) { h.Add("approximation",Approximation); Highstock.AddFunction("PlotOptionsCandlestickDataGroupingApproximation.approximation", Approximation); }  
