...
{
	public partial class PlotOptionsCandlestickDataLabels  : BaseObject
	{
		Hashtable h = new Hashtable();

		public PlotOptionsCandlestickDataLabels()
		{
			Align = Align_DefaultValue = PlotOptionsCandlestickDataLabelsAlign.Center;
			...
			Filter = Filter_DefaultValue = new PlotOptionsCandlestickDataLabelsFilter();
			...
			Overflow = Overflow_DefaultValue = PlotOptionsCandlestickDataLabelsOverflow.Justify;
			Padding = Padding_DefaultValue = 5;
			Position = Position_DefaultValue = PlotOptionsCandlestickDataLabelsPosition.Center;
			...
			TextPath = TextPath_DefaultValue = new PlotOptionsCandlestickDataLabelsTextPath();
			UseHTML = UseHTML_DefaultValue = false;
			VerticalAlign = VerticalAlign_DefaultValue = PlotOptionsCandlestickDataLabelsVerticalAlign.Bottom;
			X = X_DefaultValue = 0;
			Y = Y_DefaultValue = 0;
			Z = Z_DefaultValue = 6;
		...
		/// </summary>
		public PlotOptionsCandlestickDataLabelsAlign Align { get; set; }
		private PlotOptionsCandlestickDataLabelsAlign Align_DefaultValue { get; set; }
		...
		/// </summary>
		public PlotOptionsCandlestickDataLabelsFilter Filter { get; set; }
		private PlotOptionsCandlestickDataLabelsFilter Filter_DefaultValue { get; set; }
		...
		/// </summary>
		public PlotOptionsCandlestickDataLabelsOverflow Overflow { get; set; }
		private PlotOptionsCandlestickDataLabelsOverflow Overflow_DefaultValue { get; set; }
		...
		/// </summary>
		public PlotOptionsCandlestickDataLabelsPosition Position { get; set; }
		private PlotOptionsCandlestickDataLabelsPosition Position_DefaultValue { get; set; }
		...
		/// </summary>
		public PlotOptionsCandlestickDataLabelsTextPath TextPath { get; set; }
		private PlotOptionsCandlestickDataLabelsTextPath TextPath_DefaultValue { get; set; }
		...
		/// </summary>
		public PlotOptionsCandlestickDataLabelsVerticalAlign VerticalAlign { get; set; }
		private PlotOptionsCandlestickDataLabelsVerticalAlign VerticalAlign_DefaultValue { get; set; }
