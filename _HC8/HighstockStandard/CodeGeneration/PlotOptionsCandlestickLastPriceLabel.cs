...
{
	public partial class PlotOptionsCandlestickLastPriceLabel  : BaseObject
	{
		Hashtable h = new Hashtable();

		public PlotOptionsCandlestickLastPriceLabel()
		{
			Align = Align_DefaultValue = PlotOptionsCandlestickLastPriceLabelAlign.Null;
		...
		/// 
		/// </summary>
		public PlotOptionsCandlestickLastPriceLabelAlign Align { get; set; }
		private PlotOptionsCandlestickLastPriceLabelAlign Align_DefaultValue { get; set; }
