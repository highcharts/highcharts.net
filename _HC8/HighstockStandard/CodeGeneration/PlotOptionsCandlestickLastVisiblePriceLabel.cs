...
{
	public partial class PlotOptionsCandlestickLastVisiblePriceLabel  : BaseObject
	{
		Hashtable h = new Hashtable();

		public PlotOptionsCandlestickLastVisiblePriceLabel()
		{
			Align = Align_DefaultValue = PlotOptionsCandlestickLastVisiblePriceLabelAlign.Null;
		...
		/// 
		/// </summary>
		public PlotOptionsCandlestickLastVisiblePriceLabelAlign Align { get; set; }
		private PlotOptionsCandlestickLastVisiblePriceLabelAlign Align_DefaultValue { get; set; }
