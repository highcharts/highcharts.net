...
{
	public partial class PlotOptionsCandlestickSonificationContextTracks  : BaseObject
	{
		Hashtable h = new Hashtable();

		public PlotOptionsCandlestickSonificationContextTracks()
		{
			ActiveWhen = ActiveWhen_DefaultValue = new PlotOptionsCandlestickSonificationContextTracksActiveWhen();
			Instrument = Instrument_DefaultValue = null;
			InstrumentString = InstrumentString_DefaultValue = "null";
			Mapping = Mapping_DefaultValue = new PlotOptionsCandlestickSonificationContextTracksMapping();
			MidiName = MidiName_DefaultValue = "";
			PointGrouping = PointGrouping_DefaultValue = new PlotOptionsCandlestickSonificationContextTracksPointGrouping();
			...
			Type = Type_DefaultValue = PlotOptionsCandlestickSonificationContextTracksType.Instrument;
			ValueInterval = ValueInterval_DefaultValue = null;
			ValueMapFunction = ValueMapFunction_DefaultValue = PlotOptionsCandlestickSonificationContextTracksValueMapFunction.Linear;
		...
		/// </summary>
		public PlotOptionsCandlestickSonificationContextTracksActiveWhen ActiveWhen { get; set; }
		private PlotOptionsCandlestickSonificationContextTracksActiveWhen ActiveWhen_DefaultValue { get; set; }
		...
		/// </summary>
		public PlotOptionsCandlestickSonificationContextTracksMapping Mapping { get; set; }
		private PlotOptionsCandlestickSonificationContextTracksMapping Mapping_DefaultValue { get; set; }
		...
		/// </summary>
		public PlotOptionsCandlestickSonificationContextTracksPointGrouping PointGrouping { get; set; }
		private PlotOptionsCandlestickSonificationContextTracksPointGrouping PointGrouping_DefaultValue { get; set; }
		...
		/// </summary>
		public PlotOptionsCandlestickSonificationContextTracksType Type { get; set; }
		private PlotOptionsCandlestickSonificationContextTracksType Type_DefaultValue { get; set; }
		...
		/// </summary>
		public PlotOptionsCandlestickSonificationContextTracksValueMapFunction ValueMapFunction { get; set; }
		private PlotOptionsCandlestickSonificationContextTracksValueMapFunction ValueMapFunction_DefaultValue { get; set; }
