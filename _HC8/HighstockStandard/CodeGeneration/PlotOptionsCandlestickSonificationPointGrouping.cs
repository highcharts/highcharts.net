...
{
	public partial class PlotOptionsCandlestickSonificationPointGrouping  : BaseObject
	{
		Hashtable h = new Hashtable();

		public PlotOptionsCandlestickSonificationPointGrouping()
		{
			Algorithm = Algorithm_DefaultValue = PlotOptionsCandlestickSonificationPointGroupingAlgorithm.Minimax;
		...
		/// </summary>
		public PlotOptionsCandlestickSonificationPointGroupingAlgorithm Algorithm { get; set; }
		private PlotOptionsCandlestickSonificationPointGroupingAlgorithm Algorithm_DefaultValue { get; set; }
