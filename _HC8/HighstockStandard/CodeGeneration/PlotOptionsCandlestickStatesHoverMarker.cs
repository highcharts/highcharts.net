...
{
	public partial class PlotOptionsCandlestickStatesHoverMarker  : BaseObject
	{
		Hashtable h = new Hashtable();

		public PlotOptionsCandlestickStatesHoverMarker()
		{
			...
			States = States_DefaultValue = new PlotOptionsCandlestickStatesHoverMarkerStates();
		...
		/// </summary>
		public PlotOptionsCandlestickStatesHoverMarkerStates States { get; set; }
		private PlotOptionsCandlestickStatesHoverMarkerStates States_DefaultValue { get; set; }
