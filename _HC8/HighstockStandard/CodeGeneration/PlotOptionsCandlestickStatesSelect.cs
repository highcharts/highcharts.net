...
{
	public partial class PlotOptionsCandlestickStatesSelect  : BaseObject
	{
		Hashtable h = new Hashtable();

		public PlotOptionsCandlestickStatesSelect()
		{
			Animation = Animation_DefaultValue = new Animation() { Enabled = true };
			Enabled = Enabled_DefaultValue = null;
			Halo = Halo_DefaultValue = new PlotOptionsCandlestickStatesSelectHalo();
			LineWidth = LineWidth_DefaultValue = null;
			LineWidthPlus = LineWidthPlus_DefaultValue = null;
			Marker = Marker_DefaultValue = new PlotOptionsCandlestickStatesSelectMarker();
		...
		/// </summary>
		public PlotOptionsCandlestickStatesSelectHalo Halo { get; set; }
		private PlotOptionsCandlestickStatesSelectHalo Halo_DefaultValue { get; set; }
		...
		/// </summary>
		public PlotOptionsCandlestickStatesSelectMarker Marker { get; set; }
		private PlotOptionsCandlestickStatesSelectMarker Marker_DefaultValue { get; set; }
