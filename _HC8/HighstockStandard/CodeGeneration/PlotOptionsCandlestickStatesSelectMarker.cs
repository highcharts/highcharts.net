...
{
	public partial class PlotOptionsCandlestickStatesSelectMarker  : BaseObject
	{
		Hashtable h = new Hashtable();

		public PlotOptionsCandlestickStatesSelectMarker()
		{
			...
			States = States_DefaultValue = new PlotOptionsCandlestickStatesSelectMarkerStates();
		...
		/// </summary>
		public PlotOptionsCandlestickStatesSelectMarkerStates States { get; set; }
		private PlotOptionsCandlestickStatesSelectMarkerStates States_DefaultValue { get; set; }
