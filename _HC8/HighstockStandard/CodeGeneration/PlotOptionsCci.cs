...
namespace Highsoft.Web.Mvc.Stocks
{
	public partial class PlotOptionsCci  : BaseObject
	{
		...
		public PlotOptionsCci()
		{
			...
			DragDrop = DragDrop_DefaultValue = new PlotOptionsCciDragDrop();
		...
		/// </summary>
		public PlotOptionsCciDragDrop DragDrop { get; set; }
		private PlotOptionsCciDragDrop DragDrop_DefaultValue { get; set; }
