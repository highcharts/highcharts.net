...
namespace Highsoft.Web.Mvc.Stocks
{
	public partial class PlotOptionsCci  : BaseObject
	{
		...
		public PlotOptionsCci()
		{
			...
			DashStyle = DashStyle_DefaultValue = PlotOptionsCciDashStyle.Solid;
		...
		internal override Hashtable ToHashtable()
		{
			...
			if (PointDescriptionFormatter != PointDescriptionFormatter_DefaultValue) { h.Add("pointDescriptionFormatter",PointDescriptionFormatter); Highstock.AddFunction("PlotOptionsCciPointDescriptionFormatter.pointDescriptionFormatter", PointDescriptionFormatter); }  
