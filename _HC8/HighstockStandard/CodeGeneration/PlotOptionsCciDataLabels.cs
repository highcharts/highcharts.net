...
{
	public partial class PlotOptionsCciDataLabels  : BaseObject
	{
		Hashtable h = new Hashtable();

		public PlotOptionsCciDataLabels()
		{
			Align = Align_DefaultValue = PlotOptionsCciDataLabelsAlign.Center;
			...
			Filter = Filter_DefaultValue = new PlotOptionsCciDataLabelsFilter();
			...
			Overflow = Overflow_DefaultValue = PlotOptionsCciDataLabelsOverflow.Justify;
			Padding = Padding_DefaultValue = 5;
			Position = Position_DefaultValue = PlotOptionsCciDataLabelsPosition.Center;
			...
			TextPath = TextPath_DefaultValue = new PlotOptionsCciDataLabelsTextPath();
			UseHTML = UseHTML_DefaultValue = false;
			VerticalAlign = VerticalAlign_DefaultValue = PlotOptionsCciDataLabelsVerticalAlign.Bottom;
			X = X_DefaultValue = 0;
			Y = Y_DefaultValue = 0;
			Z = Z_DefaultValue = 6;
		...
		/// </summary>
		public PlotOptionsCciDataLabelsAlign Align { get; set; }
		private PlotOptionsCciDataLabelsAlign Align_DefaultValue { get; set; }
		...
		/// </summary>
		public PlotOptionsCciDataLabelsFilter Filter { get; set; }
		private PlotOptionsCciDataLabelsFilter Filter_DefaultValue { get; set; }
		...
		/// </summary>
		public PlotOptionsCciDataLabelsOverflow Overflow { get; set; }
		private PlotOptionsCciDataLabelsOverflow Overflow_DefaultValue { get; set; }
		...
		/// </summary>
		public PlotOptionsCciDataLabelsPosition Position { get; set; }
		private PlotOptionsCciDataLabelsPosition Position_DefaultValue { get; set; }
		...
		/// </summary>
		public PlotOptionsCciDataLabelsTextPath TextPath { get; set; }
		private PlotOptionsCciDataLabelsTextPath TextPath_DefaultValue { get; set; }
		...
		/// </summary>
		public PlotOptionsCciDataLabelsVerticalAlign VerticalAlign { get; set; }
		private PlotOptionsCciDataLabelsVerticalAlign VerticalAlign_DefaultValue { get; set; }
