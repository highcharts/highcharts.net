...
{
	public partial class PlotOptionsCciLastPriceLabel  : BaseObject
	{
		Hashtable h = new Hashtable();

		public PlotOptionsCciLastPriceLabel()
		{
			Align = Align_DefaultValue = PlotOptionsCciLastPriceLabelAlign.Null;
		...
		/// 
		/// </summary>
		public PlotOptionsCciLastPriceLabelAlign Align { get; set; }
		private PlotOptionsCciLastPriceLabelAlign Align_DefaultValue { get; set; }
