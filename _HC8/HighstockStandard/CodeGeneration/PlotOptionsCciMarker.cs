...
{
	public partial class PlotOptionsCciMarker  : BaseObject
	{
		Hashtable h = new Hashtable();

		public PlotOptionsCciMarker()
		{
			...
			States = States_DefaultValue = new PlotOptionsCciMarkerStates();
		...
		/// </summary>
		public PlotOptionsCciMarkerStates States { get; set; }
		private PlotOptionsCciMarkerStates States_DefaultValue { get; set; }
