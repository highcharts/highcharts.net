...
{
	public partial class PlotOptionsCciSonificationContextTracksPointGrouping  : BaseObject
	{
		Hashtable h = new Hashtable();

		public PlotOptionsCciSonificationContextTracksPointGrouping()
		{
			Algorithm = Algorithm_DefaultValue = PlotOptionsCciSonificationContextTracksPointGroupingAlgorithm.Minimax;
		...
		/// </summary>
		public PlotOptionsCciSonificationContextTracksPointGroupingAlgorithm Algorithm { get; set; }
		private PlotOptionsCciSonificationContextTracksPointGroupingAlgorithm Algorithm_DefaultValue { get; set; }
