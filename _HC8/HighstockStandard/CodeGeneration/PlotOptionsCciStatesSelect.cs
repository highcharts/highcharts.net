...
{
	public partial class PlotOptionsCciStatesSelect  : BaseObject
	{
		Hashtable h = new Hashtable();

		public PlotOptionsCciStatesSelect()
		{
			Animation = Animation_DefaultValue = new Animation() { Enabled = true };
			Enabled = Enabled_DefaultValue = true;
			Halo = Halo_DefaultValue = new PlotOptionsCciStatesSelectHalo();
			LineWidth = LineWidth_DefaultValue = null;
			LineWidthPlus = LineWidthPlus_DefaultValue = 1;
			Marker = Marker_DefaultValue = new PlotOptionsCciStatesSelectMarker();
		...
		/// </summary>
		public PlotOptionsCciStatesSelectHalo Halo { get; set; }
		private PlotOptionsCciStatesSelectHalo Halo_DefaultValue { get; set; }
		...
		/// </summary>
		public PlotOptionsCciStatesSelectMarker Marker { get; set; }
		private PlotOptionsCciStatesSelectMarker Marker_DefaultValue { get; set; }
