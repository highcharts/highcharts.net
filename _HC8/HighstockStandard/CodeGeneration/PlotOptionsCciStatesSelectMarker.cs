...
{
	public partial class PlotOptionsCciStatesSelectMarker  : BaseObject
	{
		Hashtable h = new Hashtable();

		public PlotOptionsCciStatesSelectMarker()
		{
			...
			States = States_DefaultValue = new PlotOptionsCciStatesSelectMarkerStates();
		...
		/// </summary>
		public PlotOptionsCciStatesSelectMarkerStates States { get; set; }
		private PlotOptionsCciStatesSelectMarkerStates States_DefaultValue { get; set; }
