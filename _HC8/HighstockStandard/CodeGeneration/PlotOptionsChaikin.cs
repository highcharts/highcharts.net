...
namespace Highsoft.Web.Mvc.Stocks
{
	public partial class PlotOptionsChaikin  : BaseObject
	{
		...
		public PlotOptionsChaikin()
		{
			...
			DashStyle = DashStyle_DefaultValue = PlotOptionsChaikinDashStyle.Solid;
		...
		internal override Hashtable ToHashtable()
		{
			...
			if (PointDescriptionFormatter != PointDescriptionFormatter_DefaultValue) { h.Add("pointDescriptionFormatter",PointDescriptionFormatter); Highstock.AddFunction("PlotOptionsChaikinPointDescriptionFormatter.pointDescriptionFormatter", PointDescriptionFormatter); }  
