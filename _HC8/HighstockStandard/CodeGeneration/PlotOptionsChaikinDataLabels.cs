...
{
	public partial class PlotOptionsChaikinDataLabels  : BaseObject
	{
		Hashtable h = new Hashtable();

		public PlotOptionsChaikinDataLabels()
		{
			Align = Align_DefaultValue = PlotOptionsChaikinDataLabelsAlign.Center;
			...
			Filter = Filter_DefaultValue = new PlotOptionsChaikinDataLabelsFilter();
			...
			Overflow = Overflow_DefaultValue = PlotOptionsChaikinDataLabelsOverflow.Justify;
			Padding = Padding_DefaultValue = 5;
			Position = Position_DefaultValue = PlotOptionsChaikinDataLabelsPosition.Center;
			...
			TextPath = TextPath_DefaultValue = new PlotOptionsChaikinDataLabelsTextPath();
			UseHTML = UseHTML_DefaultValue = false;
			VerticalAlign = VerticalAlign_DefaultValue = PlotOptionsChaikinDataLabelsVerticalAlign.Bottom;
			X = X_DefaultValue = 0;
			Y = Y_DefaultValue = 0;
			Z = Z_DefaultValue = 6;
		...
		/// </summary>
		public PlotOptionsChaikinDataLabelsAlign Align { get; set; }
		private PlotOptionsChaikinDataLabelsAlign Align_DefaultValue { get; set; }
		...
		/// </summary>
		public PlotOptionsChaikinDataLabelsFilter Filter { get; set; }
		private PlotOptionsChaikinDataLabelsFilter Filter_DefaultValue { get; set; }
		...
		/// </summary>
		public PlotOptionsChaikinDataLabelsOverflow Overflow { get; set; }
		private PlotOptionsChaikinDataLabelsOverflow Overflow_DefaultValue { get; set; }
		...
		/// </summary>
		public PlotOptionsChaikinDataLabelsPosition Position { get; set; }
		private PlotOptionsChaikinDataLabelsPosition Position_DefaultValue { get; set; }
		...
		/// </summary>
		public PlotOptionsChaikinDataLabelsTextPath TextPath { get; set; }
		private PlotOptionsChaikinDataLabelsTextPath TextPath_DefaultValue { get; set; }
		...
		/// </summary>
		public PlotOptionsChaikinDataLabelsVerticalAlign VerticalAlign { get; set; }
		private PlotOptionsChaikinDataLabelsVerticalAlign VerticalAlign_DefaultValue { get; set; }
