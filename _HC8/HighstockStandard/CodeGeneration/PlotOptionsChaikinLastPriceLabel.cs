...
{
	public partial class PlotOptionsChaikinLastPriceLabel  : BaseObject
	{
		Hashtable h = new Hashtable();

		public PlotOptionsChaikinLastPriceLabel()
		{
			Align = Align_DefaultValue = PlotOptionsChaikinLastPriceLabelAlign.Null;
		...
		/// 
		/// </summary>
		public PlotOptionsChaikinLastPriceLabelAlign Align { get; set; }
		private PlotOptionsChaikinLastPriceLabelAlign Align_DefaultValue { get; set; }
