...
{
	public partial class PlotOptionsChaikinLastVisiblePriceLabel  : BaseObject
	{
		Hashtable h = new Hashtable();

		public PlotOptionsChaikinLastVisiblePriceLabel()
		{
			Align = Align_DefaultValue = PlotOptionsChaikinLastVisiblePriceLabelAlign.Null;
		...
		/// 
		/// </summary>
		public PlotOptionsChaikinLastVisiblePriceLabelAlign Align { get; set; }
		private PlotOptionsChaikinLastVisiblePriceLabelAlign Align_DefaultValue { get; set; }
