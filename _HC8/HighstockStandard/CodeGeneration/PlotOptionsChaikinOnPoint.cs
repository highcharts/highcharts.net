...
{
	public partial class PlotOptionsChaikinOnPoint  : BaseObject
	{
		Hashtable h = new Hashtable();

		public PlotOptionsChaikinOnPoint()
		{
			ConnectorOptions = ConnectorOptions_DefaultValue = new PlotOptionsChaikinOnPointConnectorOptions();
			Id = Id_DefaultValue = "";
			Position = Position_DefaultValue = new PlotOptionsChaikinOnPointPosition();
		...
		/// </summary>
		public PlotOptionsChaikinOnPointConnectorOptions ConnectorOptions { get; set; }
		private PlotOptionsChaikinOnPointConnectorOptions ConnectorOptions_DefaultValue { get; set; }
		...
		/// </summary>
		public PlotOptionsChaikinOnPointPosition Position { get; set; }
		private PlotOptionsChaikinOnPointPosition Position_DefaultValue { get; set; }
