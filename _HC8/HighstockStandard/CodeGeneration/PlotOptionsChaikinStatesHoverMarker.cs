...
{
	public partial class PlotOptionsChaikinStatesHoverMarker  : BaseObject
	{
		Hashtable h = new Hashtable();

		public PlotOptionsChaikinStatesHoverMarker()
		{
			...
			States = States_DefaultValue = new PlotOptionsChaikinStatesHoverMarkerStates();
		...
		/// </summary>
		public PlotOptionsChaikinStatesHoverMarkerStates States { get; set; }
		private PlotOptionsChaikinStatesHoverMarkerStates States_DefaultValue { get; set; }
