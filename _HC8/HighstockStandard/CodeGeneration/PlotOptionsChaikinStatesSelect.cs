...
{
	public partial class PlotOptionsChaikinStatesSelect  : BaseObject
	{
		Hashtable h = new Hashtable();

		public PlotOptionsChaikinStatesSelect()
		{
			Animation = Animation_DefaultValue = new Animation() { Enabled = true };
			Enabled = Enabled_DefaultValue = null;
			Halo = Halo_DefaultValue = new PlotOptionsChaikinStatesSelectHalo();
			LineWidth = LineWidth_DefaultValue = null;
			LineWidthPlus = LineWidthPlus_DefaultValue = null;
			Marker = Marker_DefaultValue = new PlotOptionsChaikinStatesSelectMarker();
		...
		/// </summary>
		public PlotOptionsChaikinStatesSelectHalo Halo { get; set; }
		private PlotOptionsChaikinStatesSelectHalo Halo_DefaultValue { get; set; }
		...
		/// </summary>
		public PlotOptionsChaikinStatesSelectMarker Marker { get; set; }
		private PlotOptionsChaikinStatesSelectMarker Marker_DefaultValue { get; set; }
