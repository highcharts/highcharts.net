...
{
	public partial class PlotOptionsChaikinStatesSelectMarker  : BaseObject
	{
		Hashtable h = new Hashtable();

		public PlotOptionsChaikinStatesSelectMarker()
		{
			...
			States = States_DefaultValue = new PlotOptionsChaikinStatesSelectMarkerStates();
		...
		/// </summary>
		public PlotOptionsChaikinStatesSelectMarkerStates States { get; set; }
		private PlotOptionsChaikinStatesSelectMarkerStates States_DefaultValue { get; set; }
