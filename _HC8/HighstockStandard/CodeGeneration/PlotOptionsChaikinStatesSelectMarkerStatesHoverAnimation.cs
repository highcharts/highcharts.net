...
{
	public partial class PlotOptionsChaikinStatesSelectMarkerStatesHoverAnimation  : BaseObject
	{
		Hashtable h = new Hashtable();

		public PlotOptionsChaikinStatesSelectMarkerStatesHoverAnimation()
		{
