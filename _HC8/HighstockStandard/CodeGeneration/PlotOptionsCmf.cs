...
namespace Highsoft.Web.Mvc.Stocks
{
	public partial class PlotOptionsCmf  : BaseObject
	{
		...
		public PlotOptionsCmf()
		{
			...
			DashStyle = DashStyle_DefaultValue = PlotOptionsCmfDashStyle.Solid;
		...
		internal override Hashtable ToHashtable()
		{
			...
			if (PointDescriptionFormatter != PointDescriptionFormatter_DefaultValue) { h.Add("pointDescriptionFormatter",PointDescriptionFormatter); Highstock.AddFunction("PlotOptionsCmfPointDescriptionFormatter.pointDescriptionFormatter", PointDescriptionFormatter); }  
