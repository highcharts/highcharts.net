...
namespace Highsoft.Web.Mvc.Stocks
{
	public partial class PlotOptionsCmfAccessibility  : BaseObject
	{
		...
		public PlotOptionsCmfAccessibility()
		{
			...
			Point = Point_DefaultValue = new PlotOptionsCmfAccessibilityPoint();
		...
		/// </summary>
		public PlotOptionsCmfAccessibilityPoint Point { get; set; }
		private PlotOptionsCmfAccessibilityPoint Point_DefaultValue { get; set; }
