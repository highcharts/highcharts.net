...
{
	public partial class PlotOptionsCmfDataLabels  : BaseObject
	{
		Hashtable h = new Hashtable();

		public PlotOptionsCmfDataLabels()
		{
			Align = Align_DefaultValue = PlotOptionsCmfDataLabelsAlign.Center;
			...
			Filter = Filter_DefaultValue = new PlotOptionsCmfDataLabelsFilter();
			...
			Overflow = Overflow_DefaultValue = PlotOptionsCmfDataLabelsOverflow.Justify;
			Padding = Padding_DefaultValue = 5;
			Position = Position_DefaultValue = PlotOptionsCmfDataLabelsPosition.Center;
			...
			TextPath = TextPath_DefaultValue = new PlotOptionsCmfDataLabelsTextPath();
			UseHTML = UseHTML_DefaultValue = false;
			VerticalAlign = VerticalAlign_DefaultValue = PlotOptionsCmfDataLabelsVerticalAlign.Bottom;
			X = X_DefaultValue = 0;
			Y = Y_DefaultValue = 0;
			Z = Z_DefaultValue = 6;
		...
		/// </summary>
		public PlotOptionsCmfDataLabelsAlign Align { get; set; }
		private PlotOptionsCmfDataLabelsAlign Align_DefaultValue { get; set; }
		...
		/// </summary>
		public PlotOptionsCmfDataLabelsFilter Filter { get; set; }
		private PlotOptionsCmfDataLabelsFilter Filter_DefaultValue { get; set; }
		...
		/// </summary>
		public PlotOptionsCmfDataLabelsOverflow Overflow { get; set; }
		private PlotOptionsCmfDataLabelsOverflow Overflow_DefaultValue { get; set; }
		...
		/// </summary>
		public PlotOptionsCmfDataLabelsPosition Position { get; set; }
		private PlotOptionsCmfDataLabelsPosition Position_DefaultValue { get; set; }
		...
		/// </summary>
		public PlotOptionsCmfDataLabelsTextPath TextPath { get; set; }
		private PlotOptionsCmfDataLabelsTextPath TextPath_DefaultValue { get; set; }
		...
		/// </summary>
		public PlotOptionsCmfDataLabelsVerticalAlign VerticalAlign { get; set; }
		private PlotOptionsCmfDataLabelsVerticalAlign VerticalAlign_DefaultValue { get; set; }
