...
{
	public partial class PlotOptionsCmfLastPriceLabel  : BaseObject
	{
		Hashtable h = new Hashtable();

		public PlotOptionsCmfLastPriceLabel()
		{
			Align = Align_DefaultValue = PlotOptionsCmfLastPriceLabelAlign.Null;
		...
		/// 
		/// </summary>
		public PlotOptionsCmfLastPriceLabelAlign Align { get; set; }
		private PlotOptionsCmfLastPriceLabelAlign Align_DefaultValue { get; set; }
