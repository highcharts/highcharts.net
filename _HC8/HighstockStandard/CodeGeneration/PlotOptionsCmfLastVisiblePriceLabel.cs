...
{
	public partial class PlotOptionsCmfLastVisiblePriceLabel  : BaseObject
	{
		Hashtable h = new Hashtable();

		public PlotOptionsCmfLastVisiblePriceLabel()
		{
			Align = Align_DefaultValue = PlotOptionsCmfLastVisiblePriceLabelAlign.Null;
		...
		/// 
		/// </summary>
		public PlotOptionsCmfLastVisiblePriceLabelAlign Align { get; set; }
		private PlotOptionsCmfLastVisiblePriceLabelAlign Align_DefaultValue { get; set; }
