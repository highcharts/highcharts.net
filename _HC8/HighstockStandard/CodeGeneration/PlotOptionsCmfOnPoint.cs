...
{
	public partial class PlotOptionsCmfOnPoint  : BaseObject
	{
		Hashtable h = new Hashtable();

		public PlotOptionsCmfOnPoint()
		{
			ConnectorOptions = ConnectorOptions_DefaultValue = new PlotOptionsCmfOnPointConnectorOptions();
			Id = Id_DefaultValue = "";
			Position = Position_DefaultValue = new PlotOptionsCmfOnPointPosition();
		...
		/// </summary>
		public PlotOptionsCmfOnPointConnectorOptions ConnectorOptions { get; set; }
		private PlotOptionsCmfOnPointConnectorOptions ConnectorOptions_DefaultValue { get; set; }
		...
		/// </summary>
		public PlotOptionsCmfOnPointPosition Position { get; set; }
		private PlotOptionsCmfOnPointPosition Position_DefaultValue { get; set; }
