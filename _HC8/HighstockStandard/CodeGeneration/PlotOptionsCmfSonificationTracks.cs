...
{
	public partial class PlotOptionsCmfSonificationTracks  : BaseObject
	{
		Hashtable h = new Hashtable();

		public PlotOptionsCmfSonificationTracks()
		{
			ActiveWhen = ActiveWhen_DefaultValue = new PlotOptionsCmfSonificationTracksActiveWhen();
			Instrument = Instrument_DefaultValue = null;
			InstrumentString = InstrumentString_DefaultValue = "null";
			Mapping = Mapping_DefaultValue = new PlotOptionsCmfSonificationTracksMapping();
			MidiName = MidiName_DefaultValue = "";
			PointGrouping = PointGrouping_DefaultValue = new PlotOptionsCmfSonificationTracksPointGrouping();
			RoundToMusicalNotes = RoundToMusicalNotes_DefaultValue = true;
			ShowPlayMarker = ShowPlayMarker_DefaultValue = true;
			Type = Type_DefaultValue = PlotOptionsCmfSonificationTracksType.Instrument;
		...
		/// </summary>
		public PlotOptionsCmfSonificationTracksActiveWhen ActiveWhen { get; set; }
		private PlotOptionsCmfSonificationTracksActiveWhen ActiveWhen_DefaultValue { get; set; }
		...
		/// </summary>
		public PlotOptionsCmfSonificationTracksMapping Mapping { get; set; }
		private PlotOptionsCmfSonificationTracksMapping Mapping_DefaultValue { get; set; }
		...
		/// </summary>
		public PlotOptionsCmfSonificationTracksPointGrouping PointGrouping { get; set; }
		private PlotOptionsCmfSonificationTracksPointGrouping PointGrouping_DefaultValue { get; set; }
		...
		/// </summary>
		public PlotOptionsCmfSonificationTracksType Type { get; set; }
		private PlotOptionsCmfSonificationTracksType Type_DefaultValue { get; set; }
