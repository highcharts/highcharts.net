...
{
	public partial class PlotOptionsCmfStatesHover  : BaseObject
	{
		Hashtable h = new Hashtable();

		public PlotOptionsCmfStatesHover()
		{
			Animation = Animation_DefaultValue = new Animation() { Enabled = true };
			AnimationBool = AnimationBool_DefaultValue = null;
			Enabled = Enabled_DefaultValue = true;
			Halo = Halo_DefaultValue = new PlotOptionsCmfStatesHoverHalo();
			LineWidth = LineWidth_DefaultValue = null;
			LineWidthPlus = LineWidthPlus_DefaultValue = 1;
			Marker = Marker_DefaultValue = new PlotOptionsCmfStatesHoverMarker();
		...
		/// </summary>
		public PlotOptionsCmfStatesHoverHalo Halo { get; set; }
		private PlotOptionsCmfStatesHoverHalo Halo_DefaultValue { get; set; }
		...
		/// </summary>
		public PlotOptionsCmfStatesHoverMarker Marker { get; set; }
		private PlotOptionsCmfStatesHoverMarker Marker_DefaultValue { get; set; }
