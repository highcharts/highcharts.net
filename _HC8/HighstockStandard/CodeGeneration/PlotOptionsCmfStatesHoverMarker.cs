...
{
	public partial class PlotOptionsCmfStatesHoverMarker  : BaseObject
	{
		Hashtable h = new Hashtable();

		public PlotOptionsCmfStatesHoverMarker()
		{
			...
			States = States_DefaultValue = new PlotOptionsCmfStatesHoverMarkerStates();
		...
		/// </summary>
		public PlotOptionsCmfStatesHoverMarkerStates States { get; set; }
		private PlotOptionsCmfStatesHoverMarkerStates States_DefaultValue { get; set; }
