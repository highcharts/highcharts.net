...
{
	public partial class PlotOptionsCmfStatesSelectMarker  : BaseObject
	{
		Hashtable h = new Hashtable();

		public PlotOptionsCmfStatesSelectMarker()
		{
			...
			States = States_DefaultValue = new PlotOptionsCmfStatesSelectMarkerStates();
		...
		/// </summary>
		public PlotOptionsCmfStatesSelectMarkerStates States { get; set; }
		private PlotOptionsCmfStatesSelectMarkerStates States_DefaultValue { get; set; }
