...
namespace Highsoft.Web.Mvc.Stocks
{
	public partial class PlotOptionsCmo  : BaseObject
	{
		...
		public PlotOptionsCmo()
		{
			...
			DragDrop = DragDrop_DefaultValue = new PlotOptionsCmoDragDrop();
		...
		/// </summary>
		public PlotOptionsCmoDragDrop DragDrop { get; set; }
		private PlotOptionsCmoDragDrop DragDrop_DefaultValue { get; set; }
