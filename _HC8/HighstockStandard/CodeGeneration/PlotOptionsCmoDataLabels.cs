...
{
	public partial class PlotOptionsCmoDataLabels  : BaseObject
	{
		Hashtable h = new Hashtable();

		public PlotOptionsCmoDataLabels()
		{
			Align = Align_DefaultValue = PlotOptionsCmoDataLabelsAlign.Center;
			...
			Filter = Filter_DefaultValue = new PlotOptionsCmoDataLabelsFilter();
			...
			Overflow = Overflow_DefaultValue = PlotOptionsCmoDataLabelsOverflow.Justify;
			Padding = Padding_DefaultValue = 5;
			Position = Position_DefaultValue = PlotOptionsCmoDataLabelsPosition.Center;
			...
			TextPath = TextPath_DefaultValue = new PlotOptionsCmoDataLabelsTextPath();
			UseHTML = UseHTML_DefaultValue = false;
			VerticalAlign = VerticalAlign_DefaultValue = PlotOptionsCmoDataLabelsVerticalAlign.Bottom;
			X = X_DefaultValue = 0;
			Y = Y_DefaultValue = 0;
			Z = Z_DefaultValue = 6;
		...
		/// </summary>
		public PlotOptionsCmoDataLabelsAlign Align { get; set; }
		private PlotOptionsCmoDataLabelsAlign Align_DefaultValue { get; set; }
		...
		/// </summary>
		public PlotOptionsCmoDataLabelsFilter Filter { get; set; }
		private PlotOptionsCmoDataLabelsFilter Filter_DefaultValue { get; set; }
		...
		/// </summary>
		public PlotOptionsCmoDataLabelsOverflow Overflow { get; set; }
		private PlotOptionsCmoDataLabelsOverflow Overflow_DefaultValue { get; set; }
		...
		/// </summary>
		public PlotOptionsCmoDataLabelsPosition Position { get; set; }
		private PlotOptionsCmoDataLabelsPosition Position_DefaultValue { get; set; }
		...
		/// </summary>
		public PlotOptionsCmoDataLabelsTextPath TextPath { get; set; }
		private PlotOptionsCmoDataLabelsTextPath TextPath_DefaultValue { get; set; }
		...
		/// </summary>
		public PlotOptionsCmoDataLabelsVerticalAlign VerticalAlign { get; set; }
		private PlotOptionsCmoDataLabelsVerticalAlign VerticalAlign_DefaultValue { get; set; }
