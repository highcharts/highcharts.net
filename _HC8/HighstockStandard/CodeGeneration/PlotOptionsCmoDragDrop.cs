...
{
	public partial class PlotOptionsCmoDragDrop  : BaseObject
	{
		Hashtable h = new Hashtable();

		public PlotOptionsCmoDragDrop()
		{
			...
			GuideBox = GuideBox_DefaultValue = new PlotOptionsCmoDragDropGuideBox();
		...
		/// </summary>
		public PlotOptionsCmoDragDropGuideBox GuideBox { get; set; }
		private PlotOptionsCmoDragDropGuideBox GuideBox_DefaultValue { get; set; }
