...
{
	public partial class PlotOptionsCmoLastVisiblePriceLabel  : BaseObject
	{
		Hashtable h = new Hashtable();

		public PlotOptionsCmoLastVisiblePriceLabel()
		{
			Align = Align_DefaultValue = PlotOptionsCmoLastVisiblePriceLabelAlign.Null;
		...
		/// 
		/// </summary>
		public PlotOptionsCmoLastVisiblePriceLabelAlign Align { get; set; }
		private PlotOptionsCmoLastVisiblePriceLabelAlign Align_DefaultValue { get; set; }
