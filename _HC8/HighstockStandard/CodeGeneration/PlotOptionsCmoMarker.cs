...
{
	public partial class PlotOptionsCmoMarker  : BaseObject
	{
		Hashtable h = new Hashtable();

		public PlotOptionsCmoMarker()
		{
			...
			States = States_DefaultValue = new PlotOptionsCmoMarkerStates();
		...
		/// </summary>
		public PlotOptionsCmoMarkerStates States { get; set; }
		private PlotOptionsCmoMarkerStates States_DefaultValue { get; set; }
