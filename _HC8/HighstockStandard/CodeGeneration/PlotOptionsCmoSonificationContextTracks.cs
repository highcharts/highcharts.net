...
{
	public partial class PlotOptionsCmoSonificationContextTracks  : BaseObject
	{
		Hashtable h = new Hashtable();

		public PlotOptionsCmoSonificationContextTracks()
		{
			ActiveWhen = ActiveWhen_DefaultValue = new PlotOptionsCmoSonificationContextTracksActiveWhen();
			Instrument = Instrument_DefaultValue = null;
			InstrumentString = InstrumentString_DefaultValue = "null";
			Mapping = Mapping_DefaultValue = new PlotOptionsCmoSonificationContextTracksMapping();
			MidiName = MidiName_DefaultValue = "";
			PointGrouping = PointGrouping_DefaultValue = new PlotOptionsCmoSonificationContextTracksPointGrouping();
			...
			Type = Type_DefaultValue = PlotOptionsCmoSonificationContextTracksType.Instrument;
			ValueInterval = ValueInterval_DefaultValue = null;
			ValueMapFunction = ValueMapFunction_DefaultValue = PlotOptionsCmoSonificationContextTracksValueMapFunction.Linear;
		...
		/// </summary>
		public PlotOptionsCmoSonificationContextTracksActiveWhen ActiveWhen { get; set; }
		private PlotOptionsCmoSonificationContextTracksActiveWhen ActiveWhen_DefaultValue { get; set; }
		...
		/// </summary>
		public PlotOptionsCmoSonificationContextTracksMapping Mapping { get; set; }
		private PlotOptionsCmoSonificationContextTracksMapping Mapping_DefaultValue { get; set; }
		...
		/// </summary>
		public PlotOptionsCmoSonificationContextTracksPointGrouping PointGrouping { get; set; }
		private PlotOptionsCmoSonificationContextTracksPointGrouping PointGrouping_DefaultValue { get; set; }
		...
		/// </summary>
		public PlotOptionsCmoSonificationContextTracksType Type { get; set; }
		private PlotOptionsCmoSonificationContextTracksType Type_DefaultValue { get; set; }
		...
		/// </summary>
		public PlotOptionsCmoSonificationContextTracksValueMapFunction ValueMapFunction { get; set; }
		private PlotOptionsCmoSonificationContextTracksValueMapFunction ValueMapFunction_DefaultValue { get; set; }
