...
{
	public partial class PlotOptionsCmoSonificationPointGrouping  : BaseObject
	{
		Hashtable h = new Hashtable();

		public PlotOptionsCmoSonificationPointGrouping()
		{
			Algorithm = Algorithm_DefaultValue = PlotOptionsCmoSonificationPointGroupingAlgorithm.Minimax;
		...
		/// </summary>
		public PlotOptionsCmoSonificationPointGroupingAlgorithm Algorithm { get; set; }
		private PlotOptionsCmoSonificationPointGroupingAlgorithm Algorithm_DefaultValue { get; set; }
