...
{
	public partial class PlotOptionsCmoStatesHoverMarker  : BaseObject
	{
		Hashtable h = new Hashtable();

		public PlotOptionsCmoStatesHoverMarker()
		{
			...
			States = States_DefaultValue = new PlotOptionsCmoStatesHoverMarkerStates();
		...
		/// </summary>
		public PlotOptionsCmoStatesHoverMarkerStates States { get; set; }
		private PlotOptionsCmoStatesHoverMarkerStates States_DefaultValue { get; set; }
