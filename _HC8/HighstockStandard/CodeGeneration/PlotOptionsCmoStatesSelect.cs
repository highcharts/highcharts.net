...
{
	public partial class PlotOptionsCmoStatesSelect  : BaseObject
	{
		Hashtable h = new Hashtable();

		public PlotOptionsCmoStatesSelect()
		{
			Animation = Animation_DefaultValue = new Animation() { Enabled = true };
			Enabled = Enabled_DefaultValue = null;
			Halo = Halo_DefaultValue = new PlotOptionsCmoStatesSelectHalo();
			LineWidth = LineWidth_DefaultValue = null;
			LineWidthPlus = LineWidthPlus_DefaultValue = null;
			Marker = Marker_DefaultValue = new PlotOptionsCmoStatesSelectMarker();
		...
		/// </summary>
		public PlotOptionsCmoStatesSelectHalo Halo { get; set; }
		private PlotOptionsCmoStatesSelectHalo Halo_DefaultValue { get; set; }
		...
		/// </summary>
		public PlotOptionsCmoStatesSelectMarker Marker { get; set; }
		private PlotOptionsCmoStatesSelectMarker Marker_DefaultValue { get; set; }
