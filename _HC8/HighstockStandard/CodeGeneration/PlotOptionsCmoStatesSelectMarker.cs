...
{
	public partial class PlotOptionsCmoStatesSelectMarker  : BaseObject
	{
		Hashtable h = new Hashtable();

		public PlotOptionsCmoStatesSelectMarker()
		{
			...
			States = States_DefaultValue = new PlotOptionsCmoStatesSelectMarkerStates();
		...
		/// </summary>
		public PlotOptionsCmoStatesSelectMarkerStates States { get; set; }
		private PlotOptionsCmoStatesSelectMarkerStates States_DefaultValue { get; set; }
