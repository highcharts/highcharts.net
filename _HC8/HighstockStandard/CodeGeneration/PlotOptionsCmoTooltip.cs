...
{
	public partial class PlotOptionsCmoTooltip  : BaseObject
	{
		Hashtable h = new Hashtable();

		public PlotOptionsCmoTooltip()
		{
			...
			HeaderShape = HeaderShape_DefaultValue = PlotOptionsCmoTooltipHeaderShape.Callout;
		...
		/// </summary>
		public PlotOptionsCmoTooltipHeaderShape HeaderShape { get; set; }
		private PlotOptionsCmoTooltipHeaderShape HeaderShape_DefaultValue { get; set; }
