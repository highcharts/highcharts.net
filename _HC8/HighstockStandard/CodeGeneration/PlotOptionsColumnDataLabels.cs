...
namespace Highsoft.Web.Mvc.Stocks
{
	public partial class PlotOptionsColumnDataLabels  : BaseObject
	{
		...
		public PlotOptionsColumnDataLabels()
		{
			...
			Filter = Filter_DefaultValue = new PlotOptionsColumnDataLabelsFilter();
			...
			Overflow = Overflow_DefaultValue = PlotOptionsColumnDataLabelsOverflow.Justify;
			Padding = Padding_DefaultValue = 5;
			Position = Position_DefaultValue = PlotOptionsColumnDataLabelsPosition.Center;
