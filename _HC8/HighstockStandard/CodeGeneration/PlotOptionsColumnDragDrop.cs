...
{
	public partial class PlotOptionsColumnDragDrop  : BaseObject
	{
		Hashtable h = new Hashtable();

		public PlotOptionsColumnDragDrop()
		{
			DraggableX = DraggableX_DefaultValue = null;
			DraggableY = DraggableY_DefaultValue = null;
			DragHandle = DragHandle_DefaultValue = new PlotOptionsColumnDragDropDragHandle();
			...
			GuideBox = GuideBox_DefaultValue = new PlotOptionsColumnDragDropGuideBox();
