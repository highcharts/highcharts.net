...
{
	public partial class PlotOptionsColumnLastPriceLabel  : BaseObject
	{
		Hashtable h = new Hashtable();

		public PlotOptionsColumnLastPriceLabel()
		{
			Align = Align_DefaultValue = PlotOptionsColumnLastPriceLabelAlign.Null;
		...
		/// 
		/// </summary>
		public PlotOptionsColumnLastPriceLabelAlign Align { get; set; }
		private PlotOptionsColumnLastPriceLabelAlign Align_DefaultValue { get; set; }
