...
{
	public partial class PlotOptionsColumnLastVisiblePriceLabel  : BaseObject
	{
		Hashtable h = new Hashtable();

		public PlotOptionsColumnLastVisiblePriceLabel()
		{
			Align = Align_DefaultValue = PlotOptionsColumnLastVisiblePriceLabelAlign.Null;
		...
		/// 
		/// </summary>
		public PlotOptionsColumnLastVisiblePriceLabelAlign Align { get; set; }
		private PlotOptionsColumnLastVisiblePriceLabelAlign Align_DefaultValue { get; set; }
