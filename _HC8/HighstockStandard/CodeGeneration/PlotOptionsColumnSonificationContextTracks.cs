...
{
	public partial class PlotOptionsColumnSonificationContextTracks  : BaseObject
	{
		Hashtable h = new Hashtable();

		public PlotOptionsColumnSonificationContextTracks()
		{
			ActiveWhen = ActiveWhen_DefaultValue = new PlotOptionsColumnSonificationContextTracksActiveWhen();
			Instrument = Instrument_DefaultValue = null;
			InstrumentString = InstrumentString_DefaultValue = "null";
			Mapping = Mapping_DefaultValue = new PlotOptionsColumnSonificationContextTracksMapping();
			MidiName = MidiName_DefaultValue = "";
			PointGrouping = PointGrouping_DefaultValue = new PlotOptionsColumnSonificationContextTracksPointGrouping();
			...
			Type = Type_DefaultValue = PlotOptionsColumnSonificationContextTracksType.Instrument;
			ValueInterval = ValueInterval_DefaultValue = null;
			ValueMapFunction = ValueMapFunction_DefaultValue = PlotOptionsColumnSonificationContextTracksValueMapFunction.Linear;
		...
		/// </summary>
		public PlotOptionsColumnSonificationContextTracksActiveWhen ActiveWhen { get; set; }
		private PlotOptionsColumnSonificationContextTracksActiveWhen ActiveWhen_DefaultValue { get; set; }
		...
		/// </summary>
		public PlotOptionsColumnSonificationContextTracksMapping Mapping { get; set; }
		private PlotOptionsColumnSonificationContextTracksMapping Mapping_DefaultValue { get; set; }
		...
		/// </summary>
		public PlotOptionsColumnSonificationContextTracksPointGrouping PointGrouping { get; set; }
		private PlotOptionsColumnSonificationContextTracksPointGrouping PointGrouping_DefaultValue { get; set; }
		...
		/// </summary>
		public PlotOptionsColumnSonificationContextTracksType Type { get; set; }
		private PlotOptionsColumnSonificationContextTracksType Type_DefaultValue { get; set; }
		...
		/// </summary>
		public PlotOptionsColumnSonificationContextTracksValueMapFunction ValueMapFunction { get; set; }
		private PlotOptionsColumnSonificationContextTracksValueMapFunction ValueMapFunction_DefaultValue { get; set; }
