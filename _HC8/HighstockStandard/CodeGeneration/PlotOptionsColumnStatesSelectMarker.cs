...
{
	public partial class PlotOptionsColumnStatesSelectMarker  : BaseObject
	{
		Hashtable h = new Hashtable();

		public PlotOptionsColumnStatesSelectMarker()
		{
			...
			States = States_DefaultValue = new PlotOptionsColumnStatesSelectMarkerStates();
		...
		/// </summary>
		public PlotOptionsColumnStatesSelectMarkerStates States { get; set; }
		private PlotOptionsColumnStatesSelectMarkerStates States_DefaultValue { get; set; }
