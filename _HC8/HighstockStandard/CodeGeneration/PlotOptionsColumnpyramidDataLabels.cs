...
{
	public partial class PlotOptionsColumnpyramidDataLabels  : BaseObject
	{
		Hashtable h = new Hashtable();

		public PlotOptionsColumnpyramidDataLabels()
		{
			Align = Align_DefaultValue = PlotOptionsColumnpyramidDataLabelsAlign.Center;
			...
			Filter = Filter_DefaultValue = new PlotOptionsColumnpyramidDataLabelsFilter();
			...
			Overflow = Overflow_DefaultValue = PlotOptionsColumnpyramidDataLabelsOverflow.Justify;
			Padding = Padding_DefaultValue = 5;
			Position = Position_DefaultValue = PlotOptionsColumnpyramidDataLabelsPosition.Center;
			...
			TextPath = TextPath_DefaultValue = new PlotOptionsColumnpyramidDataLabelsTextPath();
			UseHTML = UseHTML_DefaultValue = false;
			VerticalAlign = VerticalAlign_DefaultValue = PlotOptionsColumnpyramidDataLabelsVerticalAlign.Bottom;
			X = X_DefaultValue = 0;
			Y = Y_DefaultValue = 0;
			Z = Z_DefaultValue = 6;
		...
		/// </summary>
		public PlotOptionsColumnpyramidDataLabelsAlign Align { get; set; }
		private PlotOptionsColumnpyramidDataLabelsAlign Align_DefaultValue { get; set; }
		...
		/// </summary>
		public PlotOptionsColumnpyramidDataLabelsFilter Filter { get; set; }
		private PlotOptionsColumnpyramidDataLabelsFilter Filter_DefaultValue { get; set; }
		...
		/// </summary>
		public PlotOptionsColumnpyramidDataLabelsOverflow Overflow { get; set; }
		private PlotOptionsColumnpyramidDataLabelsOverflow Overflow_DefaultValue { get; set; }
		...
		/// </summary>
		public PlotOptionsColumnpyramidDataLabelsPosition Position { get; set; }
		private PlotOptionsColumnpyramidDataLabelsPosition Position_DefaultValue { get; set; }
		...
		/// </summary>
		public PlotOptionsColumnpyramidDataLabelsTextPath TextPath { get; set; }
		private PlotOptionsColumnpyramidDataLabelsTextPath TextPath_DefaultValue { get; set; }
		...
		/// </summary>
		public PlotOptionsColumnpyramidDataLabelsVerticalAlign VerticalAlign { get; set; }
		private PlotOptionsColumnpyramidDataLabelsVerticalAlign VerticalAlign_DefaultValue { get; set; }
