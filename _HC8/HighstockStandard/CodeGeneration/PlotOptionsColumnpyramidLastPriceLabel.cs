...
{
	public partial class PlotOptionsColumnpyramidLastPriceLabel  : BaseObject
	{
		Hashtable h = new Hashtable();

		public PlotOptionsColumnpyramidLastPriceLabel()
		{
			Align = Align_DefaultValue = PlotOptionsColumnpyramidLastPriceLabelAlign.Null;
		...
		/// 
		/// </summary>
		public PlotOptionsColumnpyramidLastPriceLabelAlign Align { get; set; }
		private PlotOptionsColumnpyramidLastPriceLabelAlign Align_DefaultValue { get; set; }
