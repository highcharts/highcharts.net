...
{
	public partial class PlotOptionsColumnrangeLastPriceLabel  : BaseObject
	{
		Hashtable h = new Hashtable();

		public PlotOptionsColumnrangeLastPriceLabel()
		{
			Align = Align_DefaultValue = PlotOptionsColumnrangeLastPriceLabelAlign.Null;
		...
		/// 
		/// </summary>
		public PlotOptionsColumnrangeLastPriceLabelAlign Align { get; set; }
		private PlotOptionsColumnrangeLastPriceLabelAlign Align_DefaultValue { get; set; }
