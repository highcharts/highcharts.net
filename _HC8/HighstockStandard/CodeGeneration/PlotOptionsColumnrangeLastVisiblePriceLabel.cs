...
{
	public partial class PlotOptionsColumnrangeLastVisiblePriceLabel  : BaseObject
	{
		Hashtable h = new Hashtable();

		public PlotOptionsColumnrangeLastVisiblePriceLabel()
		{
			Align = Align_DefaultValue = PlotOptionsColumnrangeLastVisiblePriceLabelAlign.Null;
		...
		/// 
		/// </summary>
		public PlotOptionsColumnrangeLastVisiblePriceLabelAlign Align { get; set; }
		private PlotOptionsColumnrangeLastVisiblePriceLabelAlign Align_DefaultValue { get; set; }
