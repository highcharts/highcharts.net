...
namespace Highsoft.Web.Mvc.Stocks
{
	public partial class PlotOptionsDema  : BaseObject
	{
		...
		public PlotOptionsDema()
		{
			...
			DashStyle = DashStyle_DefaultValue = PlotOptionsDemaDashStyle.Solid;
		...
		internal override Hashtable ToHashtable()
		{
			...
			if (PointDescriptionFormatter != PointDescriptionFormatter_DefaultValue) { h.Add("pointDescriptionFormatter",PointDescriptionFormatter); Highstock.AddFunction("PlotOptionsDemaPointDescriptionFormatter.pointDescriptionFormatter", PointDescriptionFormatter); }  
