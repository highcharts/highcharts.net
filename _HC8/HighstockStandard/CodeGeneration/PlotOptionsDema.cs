...
namespace Highsoft.Web.Mvc.Stocks
{
	public partial class PlotOptionsDema  : BaseObject
	{
		...
		public PlotOptionsDema()
		{
			...
			DragDrop = DragDrop_DefaultValue = new PlotOptionsDemaDragDrop();
		...
		/// </summary>
		public PlotOptionsDemaDragDrop DragDrop { get; set; }
		private PlotOptionsDemaDragDrop DragDrop_DefaultValue { get; set; }
