...
{
	public partial class PlotOptionsDemaDataLabels  : BaseObject
	{
		Hashtable h = new Hashtable();

		public PlotOptionsDemaDataLabels()
		{
			Align = Align_DefaultValue = PlotOptionsDemaDataLabelsAlign.Center;
			...
			Filter = Filter_DefaultValue = new PlotOptionsDemaDataLabelsFilter();
			...
			Overflow = Overflow_DefaultValue = PlotOptionsDemaDataLabelsOverflow.Justify;
			Padding = Padding_DefaultValue = 5;
			Position = Position_DefaultValue = PlotOptionsDemaDataLabelsPosition.Center;
			...
			TextPath = TextPath_DefaultValue = new PlotOptionsDemaDataLabelsTextPath();
			UseHTML = UseHTML_DefaultValue = false;
			VerticalAlign = VerticalAlign_DefaultValue = PlotOptionsDemaDataLabelsVerticalAlign.Bottom;
			X = X_DefaultValue = 0;
			Y = Y_DefaultValue = 0;
			Z = Z_DefaultValue = 6;
		...
		/// </summary>
		public PlotOptionsDemaDataLabelsAlign Align { get; set; }
		private PlotOptionsDemaDataLabelsAlign Align_DefaultValue { get; set; }
		...
		/// </summary>
		public PlotOptionsDemaDataLabelsFilter Filter { get; set; }
		private PlotOptionsDemaDataLabelsFilter Filter_DefaultValue { get; set; }
		...
		/// </summary>
		public PlotOptionsDemaDataLabelsOverflow Overflow { get; set; }
		private PlotOptionsDemaDataLabelsOverflow Overflow_DefaultValue { get; set; }
		...
		/// </summary>
		public PlotOptionsDemaDataLabelsPosition Position { get; set; }
		private PlotOptionsDemaDataLabelsPosition Position_DefaultValue { get; set; }
		...
		/// </summary>
		public PlotOptionsDemaDataLabelsTextPath TextPath { get; set; }
		private PlotOptionsDemaDataLabelsTextPath TextPath_DefaultValue { get; set; }
		...
		/// </summary>
		public PlotOptionsDemaDataLabelsVerticalAlign VerticalAlign { get; set; }
		private PlotOptionsDemaDataLabelsVerticalAlign VerticalAlign_DefaultValue { get; set; }
