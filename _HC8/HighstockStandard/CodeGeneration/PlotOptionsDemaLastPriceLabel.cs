...
{
	public partial class PlotOptionsDemaLastPriceLabel  : BaseObject
	{
		Hashtable h = new Hashtable();

		public PlotOptionsDemaLastPriceLabel()
		{
			Align = Align_DefaultValue = PlotOptionsDemaLastPriceLabelAlign.Null;
		...
		/// 
		/// </summary>
		public PlotOptionsDemaLastPriceLabelAlign Align { get; set; }
		private PlotOptionsDemaLastPriceLabelAlign Align_DefaultValue { get; set; }
