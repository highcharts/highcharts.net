...
{
	public partial class PlotOptionsDemaLastVisiblePriceLabel  : BaseObject
	{
		Hashtable h = new Hashtable();

		public PlotOptionsDemaLastVisiblePriceLabel()
		{
			Align = Align_DefaultValue = PlotOptionsDemaLastVisiblePriceLabelAlign.Null;
		...
		/// 
		/// </summary>
		public PlotOptionsDemaLastVisiblePriceLabelAlign Align { get; set; }
		private PlotOptionsDemaLastVisiblePriceLabelAlign Align_DefaultValue { get; set; }
