...
{
	public partial class PlotOptionsDemaOnPoint  : BaseObject
	{
		Hashtable h = new Hashtable();

		public PlotOptionsDemaOnPoint()
		{
			ConnectorOptions = ConnectorOptions_DefaultValue = new PlotOptionsDemaOnPointConnectorOptions();
			Id = Id_DefaultValue = "";
			Position = Position_DefaultValue = new PlotOptionsDemaOnPointPosition();
		...
		/// </summary>
		public PlotOptionsDemaOnPointConnectorOptions ConnectorOptions { get; set; }
		private PlotOptionsDemaOnPointConnectorOptions ConnectorOptions_DefaultValue { get; set; }
		...
		/// </summary>
		public PlotOptionsDemaOnPointPosition Position { get; set; }
		private PlotOptionsDemaOnPointPosition Position_DefaultValue { get; set; }
