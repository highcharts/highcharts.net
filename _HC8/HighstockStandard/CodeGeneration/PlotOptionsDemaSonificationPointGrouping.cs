...
{
	public partial class PlotOptionsDemaSonificationPointGrouping  : BaseObject
	{
		Hashtable h = new Hashtable();

		public PlotOptionsDemaSonificationPointGrouping()
		{
			Algorithm = Algorithm_DefaultValue = PlotOptionsDemaSonificationPointGroupingAlgorithm.Minimax;
		...
		/// </summary>
		public PlotOptionsDemaSonificationPointGroupingAlgorithm Algorithm { get; set; }
		private PlotOptionsDemaSonificationPointGroupingAlgorithm Algorithm_DefaultValue { get; set; }
