...
{
	public partial class PlotOptionsDemaStatesHover  : BaseObject
	{
		Hashtable h = new Hashtable();

		public PlotOptionsDemaStatesHover()
		{
			Animation = Animation_DefaultValue = new Animation() { Enabled = true };
			Enabled = Enabled_DefaultValue = null;
			Halo = Halo_DefaultValue = new PlotOptionsDemaStatesHoverHalo();
			LineWidth = LineWidth_DefaultValue = null;
			LineWidthPlus = LineWidthPlus_DefaultValue = null;
			Marker = Marker_DefaultValue = new PlotOptionsDemaStatesHoverMarker();
		...
		/// </summary>
		public PlotOptionsDemaStatesHoverHalo Halo { get; set; }
		private PlotOptionsDemaStatesHoverHalo Halo_DefaultValue { get; set; }
		...
		/// </summary>
		public PlotOptionsDemaStatesHoverMarker Marker { get; set; }
		private PlotOptionsDemaStatesHoverMarker Marker_DefaultValue { get; set; }
