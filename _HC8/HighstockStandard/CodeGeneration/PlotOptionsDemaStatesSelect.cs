...
{
	public partial class PlotOptionsDemaStatesSelect  : BaseObject
	{
		Hashtable h = new Hashtable();

		public PlotOptionsDemaStatesSelect()
		{
			Animation = Animation_DefaultValue = new Animation() { Enabled = true };
			Enabled = Enabled_DefaultValue = null;
			Halo = Halo_DefaultValue = new PlotOptionsDemaStatesSelectHalo();
			LineWidth = LineWidth_DefaultValue = null;
			LineWidthPlus = LineWidthPlus_DefaultValue = null;
			Marker = Marker_DefaultValue = new PlotOptionsDemaStatesSelectMarker();
		...
		/// </summary>
		public PlotOptionsDemaStatesSelectHalo Halo { get; set; }
		private PlotOptionsDemaStatesSelectHalo Halo_DefaultValue { get; set; }
		...
		/// </summary>
		public PlotOptionsDemaStatesSelectMarker Marker { get; set; }
		private PlotOptionsDemaStatesSelectMarker Marker_DefaultValue { get; set; }
