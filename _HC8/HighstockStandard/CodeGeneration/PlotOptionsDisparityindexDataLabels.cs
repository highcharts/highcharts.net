...
{
	public partial class PlotOptionsDisparityindexDataLabels  : BaseObject
	{
		Hashtable h = new Hashtable();

		public PlotOptionsDisparityindexDataLabels()
		{
			Align = Align_DefaultValue = PlotOptionsDisparityindexDataLabelsAlign.Center;
			...
			Filter = Filter_DefaultValue = new PlotOptionsDisparityindexDataLabelsFilter();
			...
			Overflow = Overflow_DefaultValue = PlotOptionsDisparityindexDataLabelsOverflow.Justify;
			Padding = Padding_DefaultValue = 5;
			Position = Position_DefaultValue = PlotOptionsDisparityindexDataLabelsPosition.Center;
			...
			TextPath = TextPath_DefaultValue = new PlotOptionsDisparityindexDataLabelsTextPath();
			UseHTML = UseHTML_DefaultValue = false;
			VerticalAlign = VerticalAlign_DefaultValue = PlotOptionsDisparityindexDataLabelsVerticalAlign.Bottom;
			X = X_DefaultValue = 0;
			Y = Y_DefaultValue = 0;
			Z = Z_DefaultValue = 6;
		...
		/// </summary>
		public PlotOptionsDisparityindexDataLabelsAlign Align { get; set; }
		private PlotOptionsDisparityindexDataLabelsAlign Align_DefaultValue { get; set; }
		...
		/// </summary>
		public PlotOptionsDisparityindexDataLabelsFilter Filter { get; set; }
		private PlotOptionsDisparityindexDataLabelsFilter Filter_DefaultValue { get; set; }
		...
		/// </summary>
		public PlotOptionsDisparityindexDataLabelsOverflow Overflow { get; set; }
		private PlotOptionsDisparityindexDataLabelsOverflow Overflow_DefaultValue { get; set; }
		...
		/// </summary>
		public PlotOptionsDisparityindexDataLabelsPosition Position { get; set; }
		private PlotOptionsDisparityindexDataLabelsPosition Position_DefaultValue { get; set; }
		...
		/// </summary>
		public PlotOptionsDisparityindexDataLabelsTextPath TextPath { get; set; }
		private PlotOptionsDisparityindexDataLabelsTextPath TextPath_DefaultValue { get; set; }
		...
		/// </summary>
		public PlotOptionsDisparityindexDataLabelsVerticalAlign VerticalAlign { get; set; }
		private PlotOptionsDisparityindexDataLabelsVerticalAlign VerticalAlign_DefaultValue { get; set; }
