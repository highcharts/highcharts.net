...
{
	public partial class PlotOptionsDisparityindexDragDrop  : BaseObject
	{
		Hashtable h = new Hashtable();

		public PlotOptionsDisparityindexDragDrop()
		{
			...
			GuideBox = GuideBox_DefaultValue = new PlotOptionsDisparityindexDragDropGuideBox();
		...
		/// </summary>
		public PlotOptionsDisparityindexDragDropGuideBox GuideBox { get; set; }
		private PlotOptionsDisparityindexDragDropGuideBox GuideBox_DefaultValue { get; set; }
