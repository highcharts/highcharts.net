...
namespace Highsoft.Web.Mvc.Stocks
{
	public partial class PlotOptionsDisparityindexLastPriceLabel  : BaseObject
	{
		...
		{
			Align = Align_DefaultValue = PlotOptionsDisparityindexLastPriceLabelAlign.Null;
		...
		private PlotOptionsDisparityindexLastPriceLabelAlign Align_DefaultValue { get; set; }
