...
{
	public partial class PlotOptionsDisparityindexLastVisiblePriceLabel  : BaseObject
	{
		Hashtable h = new Hashtable();

		public PlotOptionsDisparityindexLastVisiblePriceLabel()
		{
			Align = Align_DefaultValue = PlotOptionsDisparityindexLastVisiblePriceLabelAlign.Null;
		...
		/// 
		/// </summary>
		public PlotOptionsDisparityindexLastVisiblePriceLabelAlign Align { get; set; }
		private PlotOptionsDisparityindexLastVisiblePriceLabelAlign Align_DefaultValue { get; set; }
