...
{
	public partial class PlotOptionsDisparityindexMarker  : BaseObject
	{
		Hashtable h = new Hashtable();

		public PlotOptionsDisparityindexMarker()
		{
			...
			States = States_DefaultValue = new PlotOptionsDisparityindexMarkerStates();
		...
		/// </summary>
		public PlotOptionsDisparityindexMarkerStates States { get; set; }
		private PlotOptionsDisparityindexMarkerStates States_DefaultValue { get; set; }
