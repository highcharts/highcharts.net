...
{
	public partial class PlotOptionsDisparityindexStatesHover  : BaseObject
	{
		Hashtable h = new Hashtable();

		public PlotOptionsDisparityindexStatesHover()
		{
			Animation = Animation_DefaultValue = new Animation() { Enabled = true };
			Enabled = Enabled_DefaultValue = null;
			Halo = Halo_DefaultValue = new PlotOptionsDisparityindexStatesHoverHalo();
			LineWidth = LineWidth_DefaultValue = null;
			LineWidthPlus = LineWidthPlus_DefaultValue = null;
			Marker = Marker_DefaultValue = new PlotOptionsDisparityindexStatesHoverMarker();
		...
		/// </summary>
		public PlotOptionsDisparityindexStatesHoverHalo Halo { get; set; }
		private PlotOptionsDisparityindexStatesHoverHalo Halo_DefaultValue { get; set; }
		...
		/// </summary>
		public PlotOptionsDisparityindexStatesHoverMarker Marker { get; set; }
		private PlotOptionsDisparityindexStatesHoverMarker Marker_DefaultValue { get; set; }
