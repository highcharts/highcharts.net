...
{
	public partial class PlotOptionsDisparityindexStatesHoverMarker  : BaseObject
	{
		Hashtable h = new Hashtable();

		public PlotOptionsDisparityindexStatesHoverMarker()
		{
			...
			States = States_DefaultValue = new PlotOptionsDisparityindexStatesHoverMarkerStates();
		...
		/// </summary>
		public PlotOptionsDisparityindexStatesHoverMarkerStates States { get; set; }
		private PlotOptionsDisparityindexStatesHoverMarkerStates States_DefaultValue { get; set; }
