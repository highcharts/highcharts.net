...
{
	public partial class PlotOptionsDisparityindexStatesHoverMarkerStatesHoverAnimation  : BaseObject
	{
		Hashtable h = new Hashtable();

		public PlotOptionsDisparityindexStatesHoverMarkerStatesHoverAnimation()
		{
