...
{
	public partial class PlotOptionsDisparityindexStatesSelectMarker  : BaseObject
	{
		Hashtable h = new Hashtable();

		public PlotOptionsDisparityindexStatesSelectMarker()
		{
			...
			States = States_DefaultValue = new PlotOptionsDisparityindexStatesSelectMarkerStates();
		...
		/// </summary>
		public PlotOptionsDisparityindexStatesSelectMarkerStates States { get; set; }
		private PlotOptionsDisparityindexStatesSelectMarkerStates States_DefaultValue { get; set; }
