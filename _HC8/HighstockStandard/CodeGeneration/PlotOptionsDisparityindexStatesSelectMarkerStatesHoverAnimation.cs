...
{
	public partial class PlotOptionsDisparityindexStatesSelectMarkerStatesHoverAnimation  : BaseObject
	{
		Hashtable h = new Hashtable();

		public PlotOptionsDisparityindexStatesSelectMarkerStatesHoverAnimation()
		{
