...
{
	public partial class PlotOptionsDisparityindexTooltip  : BaseObject
	{
		Hashtable h = new Hashtable();

		public PlotOptionsDisparityindexTooltip()
		{
			...
			HeaderShape = HeaderShape_DefaultValue = PlotOptionsDisparityindexTooltipHeaderShape.Callout;
		...
		/// </summary>
		public PlotOptionsDisparityindexTooltipHeaderShape HeaderShape { get; set; }
		private PlotOptionsDisparityindexTooltipHeaderShape HeaderShape_DefaultValue { get; set; }
