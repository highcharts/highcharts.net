...
{
	public partial class PlotOptionsDmiDataLabels  : BaseObject
	{
		Hashtable h = new Hashtable();

		public PlotOptionsDmiDataLabels()
		{
			Align = Align_DefaultValue = PlotOptionsDmiDataLabelsAlign.Center;
			...
			Filter = Filter_DefaultValue = new PlotOptionsDmiDataLabelsFilter();
			...
			Overflow = Overflow_DefaultValue = PlotOptionsDmiDataLabelsOverflow.Justify;
			Padding = Padding_DefaultValue = 5;
			Position = Position_DefaultValue = PlotOptionsDmiDataLabelsPosition.Center;
			...
			TextPath = TextPath_DefaultValue = new PlotOptionsDmiDataLabelsTextPath();
			UseHTML = UseHTML_DefaultValue = false;
			VerticalAlign = VerticalAlign_DefaultValue = PlotOptionsDmiDataLabelsVerticalAlign.Bottom;
			X = X_DefaultValue = 0;
			Y = Y_DefaultValue = 0;
			Z = Z_DefaultValue = 6;
		...
		/// </summary>
		public PlotOptionsDmiDataLabelsAlign Align { get; set; }
		private PlotOptionsDmiDataLabelsAlign Align_DefaultValue { get; set; }
		...
		/// </summary>
		public PlotOptionsDmiDataLabelsFilter Filter { get; set; }
		private PlotOptionsDmiDataLabelsFilter Filter_DefaultValue { get; set; }
		...
		/// </summary>
		public PlotOptionsDmiDataLabelsOverflow Overflow { get; set; }
		private PlotOptionsDmiDataLabelsOverflow Overflow_DefaultValue { get; set; }
		...
		/// </summary>
		public PlotOptionsDmiDataLabelsPosition Position { get; set; }
		private PlotOptionsDmiDataLabelsPosition Position_DefaultValue { get; set; }
		...
		/// </summary>
		public PlotOptionsDmiDataLabelsTextPath TextPath { get; set; }
		private PlotOptionsDmiDataLabelsTextPath TextPath_DefaultValue { get; set; }
		...
		/// </summary>
		public PlotOptionsDmiDataLabelsVerticalAlign VerticalAlign { get; set; }
		private PlotOptionsDmiDataLabelsVerticalAlign VerticalAlign_DefaultValue { get; set; }
