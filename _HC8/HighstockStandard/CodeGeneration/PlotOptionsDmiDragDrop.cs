...
{
	public partial class PlotOptionsDmiDragDrop  : BaseObject
	{
		Hashtable h = new Hashtable();

		public PlotOptionsDmiDragDrop()
		{
			...
			GuideBox = GuideBox_DefaultValue = new PlotOptionsDmiDragDropGuideBox();
		...
		/// </summary>
		public PlotOptionsDmiDragDropGuideBox GuideBox { get; set; }
		private PlotOptionsDmiDragDropGuideBox GuideBox_DefaultValue { get; set; }
