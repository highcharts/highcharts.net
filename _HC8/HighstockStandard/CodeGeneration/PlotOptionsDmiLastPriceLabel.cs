...
{
	public partial class PlotOptionsDmiLastPriceLabel  : BaseObject
	{
		Hashtable h = new Hashtable();

		public PlotOptionsDmiLastPriceLabel()
		{
			Align = Align_DefaultValue = PlotOptionsDmiLastPriceLabelAlign.Null;
		...
		/// 
		/// </summary>
		public PlotOptionsDmiLastPriceLabelAlign Align { get; set; }
		private PlotOptionsDmiLastPriceLabelAlign Align_DefaultValue { get; set; }
