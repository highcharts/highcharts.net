...
{
	public partial class PlotOptionsDmiLastVisiblePriceLabel  : BaseObject
	{
		Hashtable h = new Hashtable();

		public PlotOptionsDmiLastVisiblePriceLabel()
		{
			Align = Align_DefaultValue = PlotOptionsDmiLastVisiblePriceLabelAlign.Null;
		...
		/// 
		/// </summary>
		public PlotOptionsDmiLastVisiblePriceLabelAlign Align { get; set; }
		private PlotOptionsDmiLastVisiblePriceLabelAlign Align_DefaultValue { get; set; }
