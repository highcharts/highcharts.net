...
{
	public partial class PlotOptionsDmiMarker  : BaseObject
	{
		Hashtable h = new Hashtable();

		public PlotOptionsDmiMarker()
		{
			...
			States = States_DefaultValue = new PlotOptionsDmiMarkerStates();
		...
		/// </summary>
		public PlotOptionsDmiMarkerStates States { get; set; }
		private PlotOptionsDmiMarkerStates States_DefaultValue { get; set; }
