...
{
	public partial class PlotOptionsDmiOnPoint  : BaseObject
	{
		Hashtable h = new Hashtable();

		public PlotOptionsDmiOnPoint()
		{
			ConnectorOptions = ConnectorOptions_DefaultValue = new PlotOptionsDmiOnPointConnectorOptions();
			Id = Id_DefaultValue = "";
			Position = Position_DefaultValue = new PlotOptionsDmiOnPointPosition();
		...
		/// </summary>
		public PlotOptionsDmiOnPointConnectorOptions ConnectorOptions { get; set; }
		private PlotOptionsDmiOnPointConnectorOptions ConnectorOptions_DefaultValue { get; set; }
		...
		/// </summary>
		public PlotOptionsDmiOnPointPosition Position { get; set; }
		private PlotOptionsDmiOnPointPosition Position_DefaultValue { get; set; }
