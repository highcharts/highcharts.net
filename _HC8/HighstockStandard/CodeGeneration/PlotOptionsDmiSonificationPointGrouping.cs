...
{
	public partial class PlotOptionsDmiSonificationPointGrouping  : BaseObject
	{
		Hashtable h = new Hashtable();

		public PlotOptionsDmiSonificationPointGrouping()
		{
			Algorithm = Algorithm_DefaultValue = PlotOptionsDmiSonificationPointGroupingAlgorithm.Minimax;
		...
		/// </summary>
		public PlotOptionsDmiSonificationPointGroupingAlgorithm Algorithm { get; set; }
		private PlotOptionsDmiSonificationPointGroupingAlgorithm Algorithm_DefaultValue { get; set; }
