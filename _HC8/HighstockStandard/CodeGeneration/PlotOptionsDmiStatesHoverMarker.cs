...
{
	public partial class PlotOptionsDmiStatesHoverMarker  : BaseObject
	{
		Hashtable h = new Hashtable();

		public PlotOptionsDmiStatesHoverMarker()
		{
			...
			States = States_DefaultValue = new PlotOptionsDmiStatesHoverMarkerStates();
		...
		/// </summary>
		public PlotOptionsDmiStatesHoverMarkerStates States { get; set; }
		private PlotOptionsDmiStatesHoverMarkerStates States_DefaultValue { get; set; }
