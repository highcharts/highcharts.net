...
{
	public partial class PlotOptionsDmiStatesSelect  : BaseObject
	{
		Hashtable h = new Hashtable();

		public PlotOptionsDmiStatesSelect()
		{
			Animation = Animation_DefaultValue = new Animation() { Enabled = true };
			Enabled = Enabled_DefaultValue = null;
			Halo = Halo_DefaultValue = new PlotOptionsDmiStatesSelectHalo();
			LineWidth = LineWidth_DefaultValue = null;
			LineWidthPlus = LineWidthPlus_DefaultValue = null;
			Marker = Marker_DefaultValue = new PlotOptionsDmiStatesSelectMarker();
		...
		/// </summary>
		public PlotOptionsDmiStatesSelectHalo Halo { get; set; }
		private PlotOptionsDmiStatesSelectHalo Halo_DefaultValue { get; set; }
		...
		/// </summary>
		public PlotOptionsDmiStatesSelectMarker Marker { get; set; }
		private PlotOptionsDmiStatesSelectMarker Marker_DefaultValue { get; set; }
