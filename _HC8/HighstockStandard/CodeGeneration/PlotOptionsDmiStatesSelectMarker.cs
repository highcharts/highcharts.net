...
{
	public partial class PlotOptionsDmiStatesSelectMarker  : BaseObject
	{
		Hashtable h = new Hashtable();

		public PlotOptionsDmiStatesSelectMarker()
		{
			...
			States = States_DefaultValue = new PlotOptionsDmiStatesSelectMarkerStates();
		...
		/// </summary>
		public PlotOptionsDmiStatesSelectMarkerStates States { get; set; }
		private PlotOptionsDmiStatesSelectMarkerStates States_DefaultValue { get; set; }
