...
namespace Highsoft.Web.Mvc.Stocks
{
	public partial class PlotOptionsDpo  : BaseObject
	{
		...
		public PlotOptionsDpo()
		{
			...
			DashStyle = DashStyle_DefaultValue = PlotOptionsDpoDashStyle.Solid;
		...
		internal override Hashtable ToHashtable()
		{
			...
			if (PointDescriptionFormatter != PointDescriptionFormatter_DefaultValue) { h.Add("pointDescriptionFormatter",PointDescriptionFormatter); Highstock.AddFunction("PlotOptionsDpoPointDescriptionFormatter.pointDescriptionFormatter", PointDescriptionFormatter); }  
