...
{
	public partial class PlotOptionsDpoDataLabels  : BaseObject
	{
		Hashtable h = new Hashtable();

		public PlotOptionsDpoDataLabels()
		{
			Align = Align_DefaultValue = PlotOptionsDpoDataLabelsAlign.Center;
			...
			Filter = Filter_DefaultValue = new PlotOptionsDpoDataLabelsFilter();
			...
			Overflow = Overflow_DefaultValue = PlotOptionsDpoDataLabelsOverflow.Justify;
			Padding = Padding_DefaultValue = 5;
			Position = Position_DefaultValue = PlotOptionsDpoDataLabelsPosition.Center;
			...
			TextPath = TextPath_DefaultValue = new PlotOptionsDpoDataLabelsTextPath();
			UseHTML = UseHTML_DefaultValue = false;
			VerticalAlign = VerticalAlign_DefaultValue = PlotOptionsDpoDataLabelsVerticalAlign.Bottom;
			X = X_DefaultValue = 0;
			Y = Y_DefaultValue = 0;
			Z = Z_DefaultValue = 6;
		...
		/// </summary>
		public PlotOptionsDpoDataLabelsAlign Align { get; set; }
		private PlotOptionsDpoDataLabelsAlign Align_DefaultValue { get; set; }
		...
		/// </summary>
		public PlotOptionsDpoDataLabelsFilter Filter { get; set; }
		private PlotOptionsDpoDataLabelsFilter Filter_DefaultValue { get; set; }
		...
		/// </summary>
		public PlotOptionsDpoDataLabelsOverflow Overflow { get; set; }
		private PlotOptionsDpoDataLabelsOverflow Overflow_DefaultValue { get; set; }
		...
		/// </summary>
		public PlotOptionsDpoDataLabelsPosition Position { get; set; }
		private PlotOptionsDpoDataLabelsPosition Position_DefaultValue { get; set; }
		...
		/// </summary>
		public PlotOptionsDpoDataLabelsTextPath TextPath { get; set; }
		private PlotOptionsDpoDataLabelsTextPath TextPath_DefaultValue { get; set; }
		...
		/// </summary>
		public PlotOptionsDpoDataLabelsVerticalAlign VerticalAlign { get; set; }
		private PlotOptionsDpoDataLabelsVerticalAlign VerticalAlign_DefaultValue { get; set; }
