...
{
	public partial class PlotOptionsDpoLastPriceLabel  : BaseObject
	{
		Hashtable h = new Hashtable();

		public PlotOptionsDpoLastPriceLabel()
		{
			Align = Align_DefaultValue = PlotOptionsDpoLastPriceLabelAlign.Null;
		...
		/// 
		/// </summary>
		public PlotOptionsDpoLastPriceLabelAlign Align { get; set; }
		private PlotOptionsDpoLastPriceLabelAlign Align_DefaultValue { get; set; }
