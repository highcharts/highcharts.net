...
{
	public partial class PlotOptionsDpoMarker  : BaseObject
	{
		Hashtable h = new Hashtable();

		public PlotOptionsDpoMarker()
		{
			...
			States = States_DefaultValue = new PlotOptionsDpoMarkerStates();
		...
		/// </summary>
		public PlotOptionsDpoMarkerStates States { get; set; }
		private PlotOptionsDpoMarkerStates States_DefaultValue { get; set; }
