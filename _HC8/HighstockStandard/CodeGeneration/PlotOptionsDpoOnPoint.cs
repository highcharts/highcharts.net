...
{
	public partial class PlotOptionsDpoOnPoint  : BaseObject
	{
		Hashtable h = new Hashtable();

		public PlotOptionsDpoOnPoint()
		{
			ConnectorOptions = ConnectorOptions_DefaultValue = new PlotOptionsDpoOnPointConnectorOptions();
			Id = Id_DefaultValue = "";
			Position = Position_DefaultValue = new PlotOptionsDpoOnPointPosition();
		...
		/// </summary>
		public PlotOptionsDpoOnPointConnectorOptions ConnectorOptions { get; set; }
		private PlotOptionsDpoOnPointConnectorOptions ConnectorOptions_DefaultValue { get; set; }
		...
		/// </summary>
		public PlotOptionsDpoOnPointPosition Position { get; set; }
		private PlotOptionsDpoOnPointPosition Position_DefaultValue { get; set; }
