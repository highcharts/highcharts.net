...
{
	public partial class PlotOptionsDpoSonificationPointGrouping  : BaseObject
	{
		Hashtable h = new Hashtable();

		public PlotOptionsDpoSonificationPointGrouping()
		{
			Algorithm = Algorithm_DefaultValue = PlotOptionsDpoSonificationPointGroupingAlgorithm.Minimax;
		...
		/// </summary>
		public PlotOptionsDpoSonificationPointGroupingAlgorithm Algorithm { get; set; }
		private PlotOptionsDpoSonificationPointGroupingAlgorithm Algorithm_DefaultValue { get; set; }
