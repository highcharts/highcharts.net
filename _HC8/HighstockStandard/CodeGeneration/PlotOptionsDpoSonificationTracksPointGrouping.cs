...
{
	public partial class PlotOptionsDpoSonificationTracksPointGrouping  : BaseObject
	{
		Hashtable h = new Hashtable();

		public PlotOptionsDpoSonificationTracksPointGrouping()
		{
			Algorithm = Algorithm_DefaultValue = PlotOptionsDpoSonificationTracksPointGroupingAlgorithm.Minimax;
		...
		/// </summary>
		public PlotOptionsDpoSonificationTracksPointGroupingAlgorithm Algorithm { get; set; }
		private PlotOptionsDpoSonificationTracksPointGroupingAlgorithm Algorithm_DefaultValue { get; set; }
