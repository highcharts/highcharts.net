...
{
	public partial class PlotOptionsDpoStatesHoverMarker  : BaseObject
	{
		Hashtable h = new Hashtable();

		public PlotOptionsDpoStatesHoverMarker()
		{
			...
			States = States_DefaultValue = new PlotOptionsDpoStatesHoverMarkerStates();
		...
		/// </summary>
		public PlotOptionsDpoStatesHoverMarkerStates States { get; set; }
		private PlotOptionsDpoStatesHoverMarkerStates States_DefaultValue { get; set; }
