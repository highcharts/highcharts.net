...
{
	public partial class PlotOptionsDpoStatesSelectMarker  : BaseObject
	{
		Hashtable h = new Hashtable();

		public PlotOptionsDpoStatesSelectMarker()
		{
			...
			States = States_DefaultValue = new PlotOptionsDpoStatesSelectMarkerStates();
		...
		/// </summary>
		public PlotOptionsDpoStatesSelectMarkerStates States { get; set; }
		private PlotOptionsDpoStatesSelectMarkerStates States_DefaultValue { get; set; }
