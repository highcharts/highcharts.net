...
namespace Highsoft.Web.Mvc.Stocks
{
	public partial class PlotOptionsDpoTooltip  : BaseObject
	{
		...
		public PlotOptionsDpoTooltip()
		{
			...
			HeaderShape = HeaderShape_DefaultValue = PlotOptionsDpoTooltipHeaderShape.Callout;
		...
		/// </summary>
		public PlotOptionsDpoTooltipHeaderShape HeaderShape { get; set; }
		private PlotOptionsDpoTooltipHeaderShape HeaderShape_DefaultValue { get; set; }
