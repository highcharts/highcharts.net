...
namespace Highsoft.Web.Mvc.Stocks
{
	public partial class PlotOptionsDumbbell  : BaseObject
	{
		...
		public PlotOptionsDumbbell()
		{
			...
			DashStyle = DashStyle_DefaultValue = PlotOptionsDumbbellDashStyle.Solid;
		...
		internal override Hashtable ToHashtable()
		{
			...
			if (PointDescriptionFormatter != PointDescriptionFormatter_DefaultValue) { h.Add("pointDescriptionFormatter",PointDescriptionFormatter); Highstock.AddFunction("PlotOptionsDumbbellPointDescriptionFormatter.pointDescriptionFormatter", PointDescriptionFormatter); }  
