...
{
	public partial class PlotOptionsDumbbellDataGrouping  : BaseObject
	{
		Hashtable h = new Hashtable();

		public PlotOptionsDumbbellDataGrouping()
		{
		...
		internal override Hashtable ToHashtable()
		{
			...
			if (Approximation != Approximation_DefaultValue) { h.Add("approximation",Approximation); Highstock.AddFunction("PlotOptionsDumbbellDataGroupingApproximation.approximation", Approximation); }  
