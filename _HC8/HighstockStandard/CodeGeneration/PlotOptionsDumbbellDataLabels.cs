...
{
	public partial class PlotOptionsDumbbellDataLabels  : BaseObject
	{
		Hashtable h = new Hashtable();

		public PlotOptionsDumbbellDataLabels()
		{
			Align = Align_DefaultValue = PlotOptionsDumbbellDataLabelsAlign.Center;
			...
			Filter = Filter_DefaultValue = new PlotOptionsDumbbellDataLabelsFilter();
			...
			Overflow = Overflow_DefaultValue = PlotOptionsDumbbellDataLabelsOverflow.Justify;
			Padding = Padding_DefaultValue = 5;
			Position = Position_DefaultValue = PlotOptionsDumbbellDataLabelsPosition.Center;
			...
			TextPath = TextPath_DefaultValue = new PlotOptionsDumbbellDataLabelsTextPath();
			UseHTML = UseHTML_DefaultValue = false;
			VerticalAlign = VerticalAlign_DefaultValue = PlotOptionsDumbbellDataLabelsVerticalAlign.Bottom;
			X = X_DefaultValue = 0;
			Y = Y_DefaultValue = 0;
			Z = Z_DefaultValue = 6;
		...
		/// </summary>
		public PlotOptionsDumbbellDataLabelsAlign Align { get; set; }
		private PlotOptionsDumbbellDataLabelsAlign Align_DefaultValue { get; set; }
		...
		/// </summary>
		public PlotOptionsDumbbellDataLabelsFilter Filter { get; set; }
		private PlotOptionsDumbbellDataLabelsFilter Filter_DefaultValue { get; set; }
		...
		/// </summary>
		public PlotOptionsDumbbellDataLabelsOverflow Overflow { get; set; }
		private PlotOptionsDumbbellDataLabelsOverflow Overflow_DefaultValue { get; set; }
		...
		/// </summary>
		public PlotOptionsDumbbellDataLabelsPosition Position { get; set; }
		private PlotOptionsDumbbellDataLabelsPosition Position_DefaultValue { get; set; }
		...
		/// </summary>
		public PlotOptionsDumbbellDataLabelsTextPath TextPath { get; set; }
		private PlotOptionsDumbbellDataLabelsTextPath TextPath_DefaultValue { get; set; }
		...
		/// </summary>
		public PlotOptionsDumbbellDataLabelsVerticalAlign VerticalAlign { get; set; }
		private PlotOptionsDumbbellDataLabelsVerticalAlign VerticalAlign_DefaultValue { get; set; }
