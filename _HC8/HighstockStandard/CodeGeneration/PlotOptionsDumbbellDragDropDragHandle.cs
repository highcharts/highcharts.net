...
{
	public partial class PlotOptionsDumbbellDragDropDragHandle  : BaseObject
	{
		Hashtable h = new Hashtable();

		public PlotOptionsDumbbellDragDropDragHandle()
		{
		...
		internal override Hashtable ToHashtable()
		{
			...
			if (PathFormatter != PathFormatter_DefaultValue) { h.Add("pathFormatter",PathFormatter); Highstock.AddFunction("PlotOptionsDumbbellDragDropDragHandlePathFormatter.pathFormatter", PathFormatter); }  
