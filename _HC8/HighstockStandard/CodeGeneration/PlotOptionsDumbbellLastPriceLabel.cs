...
{
	public partial class PlotOptionsDumbbellLastPriceLabel  : BaseObject
	{
		Hashtable h = new Hashtable();

		public PlotOptionsDumbbellLastPriceLabel()
		{
			Align = Align_DefaultValue = PlotOptionsDumbbellLastPriceLabelAlign.Null;
		...
		/// 
		/// </summary>
		public PlotOptionsDumbbellLastPriceLabelAlign Align { get; set; }
		private PlotOptionsDumbbellLastPriceLabelAlign Align_DefaultValue { get; set; }
