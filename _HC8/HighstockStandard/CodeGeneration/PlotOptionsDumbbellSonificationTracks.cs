...
{
	public partial class PlotOptionsDumbbellSonificationTracks  : BaseObject
	{
		Hashtable h = new Hashtable();

		public PlotOptionsDumbbellSonificationTracks()
		{
			ActiveWhen = ActiveWhen_DefaultValue = new PlotOptionsDumbbellSonificationTracksActiveWhen();
			Instrument = Instrument_DefaultValue = null;
			InstrumentString = InstrumentString_DefaultValue = "null";
			Mapping = Mapping_DefaultValue = new PlotOptionsDumbbellSonificationTracksMapping();
			MidiName = MidiName_DefaultValue = "";
			PointGrouping = PointGrouping_DefaultValue = new PlotOptionsDumbbellSonificationTracksPointGrouping();
			RoundToMusicalNotes = RoundToMusicalNotes_DefaultValue = true;
			ShowPlayMarker = ShowPlayMarker_DefaultValue = true;
			Type = Type_DefaultValue = PlotOptionsDumbbellSonificationTracksType.Instrument;
		...
		/// </summary>
		public PlotOptionsDumbbellSonificationTracksActiveWhen ActiveWhen { get; set; }
		private PlotOptionsDumbbellSonificationTracksActiveWhen ActiveWhen_DefaultValue { get; set; }
		...
		/// </summary>
		public PlotOptionsDumbbellSonificationTracksMapping Mapping { get; set; }
		private PlotOptionsDumbbellSonificationTracksMapping Mapping_DefaultValue { get; set; }
		...
		/// </summary>
		public PlotOptionsDumbbellSonificationTracksPointGrouping PointGrouping { get; set; }
		private PlotOptionsDumbbellSonificationTracksPointGrouping PointGrouping_DefaultValue { get; set; }
		...
		/// </summary>
		public PlotOptionsDumbbellSonificationTracksType Type { get; set; }
		private PlotOptionsDumbbellSonificationTracksType Type_DefaultValue { get; set; }
