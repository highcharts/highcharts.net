...
{
	public partial class PlotOptionsDumbbellTooltip  : BaseObject
	{
		Hashtable h = new Hashtable();

		public PlotOptionsDumbbellTooltip()
		{
			...
			HeaderShape = HeaderShape_DefaultValue = PlotOptionsDumbbellTooltipHeaderShape.Callout;
		...
		/// </summary>
		public PlotOptionsDumbbellTooltipHeaderShape HeaderShape { get; set; }
		private PlotOptionsDumbbellTooltipHeaderShape HeaderShape_DefaultValue { get; set; }
		...
		internal override Hashtable ToHashtable()
		{
			...
			if (NullFormatter != NullFormatter_DefaultValue) { h.Add("nullFormatter",NullFormatter); Highstock.AddFunction("PlotOptionsDumbbellTooltipNullFormatter.nullFormatter", NullFormatter); }  
			if (Outside != Outside_DefaultValue) h.Add("outside",Outside);
			if (Padding != Padding_DefaultValue) h.Add("padding",Padding);
			if (PointFormat != PointFormat_DefaultValue) h.Add("pointFormat",PointFormat);
			if (PointFormatter != PointFormatter_DefaultValue) { h.Add("pointFormatter",PointFormatter); Highstock.AddFunction("PlotOptionsDumbbellTooltipPointFormatter.pointFormatter", PointFormatter); }  
