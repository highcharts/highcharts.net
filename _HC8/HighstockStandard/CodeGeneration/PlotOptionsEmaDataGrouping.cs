...
namespace Highsoft.Web.Mvc.Stocks
{
	public partial class PlotOptionsEmaDataGrouping  : BaseObject
	{
		...
		internal override Hashtable ToHashtable()
		{
			...
			if (Approximation != Approximation_DefaultValue) { h.Add("approximation",Approximation); Highstock.AddFunction("PlotOptionsEmaDataGroupingApproximation.approximation", Approximation); }  
