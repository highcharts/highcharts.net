...
{
	public partial class PlotOptionsEmaDataLabels  : BaseObject
	{
		Hashtable h = new Hashtable();

		public PlotOptionsEmaDataLabels()
		{
			Align = Align_DefaultValue = PlotOptionsEmaDataLabelsAlign.Center;
			...
			Filter = Filter_DefaultValue = new PlotOptionsEmaDataLabelsFilter();
			...
			Overflow = Overflow_DefaultValue = PlotOptionsEmaDataLabelsOverflow.Justify;
			Padding = Padding_DefaultValue = 5;
			Position = Position_DefaultValue = PlotOptionsEmaDataLabelsPosition.Center;
			...
			TextPath = TextPath_DefaultValue = new PlotOptionsEmaDataLabelsTextPath();
			UseHTML = UseHTML_DefaultValue = false;
			VerticalAlign = VerticalAlign_DefaultValue = PlotOptionsEmaDataLabelsVerticalAlign.Bottom;
			X = X_DefaultValue = 0;
			Y = Y_DefaultValue = 0;
			Z = Z_DefaultValue = 6;
		...
		/// </summary>
		public PlotOptionsEmaDataLabelsAlign Align { get; set; }
		private PlotOptionsEmaDataLabelsAlign Align_DefaultValue { get; set; }
		...
		/// </summary>
		public PlotOptionsEmaDataLabelsFilter Filter { get; set; }
		private PlotOptionsEmaDataLabelsFilter Filter_DefaultValue { get; set; }
		...
		/// </summary>
		public PlotOptionsEmaDataLabelsOverflow Overflow { get; set; }
		private PlotOptionsEmaDataLabelsOverflow Overflow_DefaultValue { get; set; }
		...
		/// </summary>
		public PlotOptionsEmaDataLabelsPosition Position { get; set; }
		private PlotOptionsEmaDataLabelsPosition Position_DefaultValue { get; set; }
		...
		/// </summary>
		public PlotOptionsEmaDataLabelsTextPath TextPath { get; set; }
		private PlotOptionsEmaDataLabelsTextPath TextPath_DefaultValue { get; set; }
		...
		/// </summary>
		public PlotOptionsEmaDataLabelsVerticalAlign VerticalAlign { get; set; }
		private PlotOptionsEmaDataLabelsVerticalAlign VerticalAlign_DefaultValue { get; set; }
