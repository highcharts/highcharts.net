...
{
	public partial class PlotOptionsEmaLastPriceLabel  : BaseObject
	{
		Hashtable h = new Hashtable();

		public PlotOptionsEmaLastPriceLabel()
		{
			Align = Align_DefaultValue = PlotOptionsEmaLastPriceLabelAlign.Null;
		...
		/// 
		/// </summary>
		public PlotOptionsEmaLastPriceLabelAlign Align { get; set; }
		private PlotOptionsEmaLastPriceLabelAlign Align_DefaultValue { get; set; }
