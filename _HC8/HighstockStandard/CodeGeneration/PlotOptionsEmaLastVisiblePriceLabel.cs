...
{
	public partial class PlotOptionsEmaLastVisiblePriceLabel  : BaseObject
	{
		Hashtable h = new Hashtable();

		public PlotOptionsEmaLastVisiblePriceLabel()
		{
			Align = Align_DefaultValue = PlotOptionsEmaLastVisiblePriceLabelAlign.Null;
		...
		/// 
		/// </summary>
		public PlotOptionsEmaLastVisiblePriceLabelAlign Align { get; set; }
		private PlotOptionsEmaLastVisiblePriceLabelAlign Align_DefaultValue { get; set; }
