...
{
	public partial class PlotOptionsEmaOnPoint  : BaseObject
	{
		Hashtable h = new Hashtable();

		public PlotOptionsEmaOnPoint()
		{
			ConnectorOptions = ConnectorOptions_DefaultValue = new PlotOptionsEmaOnPointConnectorOptions();
			Id = Id_DefaultValue = "";
			Position = Position_DefaultValue = new PlotOptionsEmaOnPointPosition();
		...
		/// </summary>
		public PlotOptionsEmaOnPointConnectorOptions ConnectorOptions { get; set; }
		private PlotOptionsEmaOnPointConnectorOptions ConnectorOptions_DefaultValue { get; set; }
		...
		/// </summary>
		public PlotOptionsEmaOnPointPosition Position { get; set; }
		private PlotOptionsEmaOnPointPosition Position_DefaultValue { get; set; }
