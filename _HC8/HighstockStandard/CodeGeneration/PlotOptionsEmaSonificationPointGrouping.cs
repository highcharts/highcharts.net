...
{
	public partial class PlotOptionsEmaSonificationPointGrouping  : BaseObject
	{
		Hashtable h = new Hashtable();

		public PlotOptionsEmaSonificationPointGrouping()
		{
			Algorithm = Algorithm_DefaultValue = PlotOptionsEmaSonificationPointGroupingAlgorithm.Minimax;
		...
		/// </summary>
		public PlotOptionsEmaSonificationPointGroupingAlgorithm Algorithm { get; set; }
		private PlotOptionsEmaSonificationPointGroupingAlgorithm Algorithm_DefaultValue { get; set; }
