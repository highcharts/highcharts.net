...
{
	public partial class PlotOptionsEmaSonificationTracks  : BaseObject
	{
		Hashtable h = new Hashtable();

		public PlotOptionsEmaSonificationTracks()
		{
			ActiveWhen = ActiveWhen_DefaultValue = new PlotOptionsEmaSonificationTracksActiveWhen();
			Instrument = Instrument_DefaultValue = null;
			InstrumentString = InstrumentString_DefaultValue = "null";
			Mapping = Mapping_DefaultValue = new PlotOptionsEmaSonificationTracksMapping();
			MidiName = MidiName_DefaultValue = "";
			PointGrouping = PointGrouping_DefaultValue = new PlotOptionsEmaSonificationTracksPointGrouping();
			RoundToMusicalNotes = RoundToMusicalNotes_DefaultValue = true;
			ShowPlayMarker = ShowPlayMarker_DefaultValue = true;
			Type = Type_DefaultValue = PlotOptionsEmaSonificationTracksType.Instrument;
		...
		/// </summary>
		public PlotOptionsEmaSonificationTracksActiveWhen ActiveWhen { get; set; }
		private PlotOptionsEmaSonificationTracksActiveWhen ActiveWhen_DefaultValue { get; set; }
		...
		/// </summary>
		public PlotOptionsEmaSonificationTracksMapping Mapping { get; set; }
		private PlotOptionsEmaSonificationTracksMapping Mapping_DefaultValue { get; set; }
		...
		/// </summary>
		public PlotOptionsEmaSonificationTracksPointGrouping PointGrouping { get; set; }
		private PlotOptionsEmaSonificationTracksPointGrouping PointGrouping_DefaultValue { get; set; }
		...
		/// </summary>
		public PlotOptionsEmaSonificationTracksType Type { get; set; }
		private PlotOptionsEmaSonificationTracksType Type_DefaultValue { get; set; }
