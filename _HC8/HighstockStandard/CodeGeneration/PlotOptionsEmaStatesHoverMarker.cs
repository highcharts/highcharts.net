...
{
	public partial class PlotOptionsEmaStatesHoverMarker  : BaseObject
	{
		Hashtable h = new Hashtable();

		public PlotOptionsEmaStatesHoverMarker()
		{
			...
			States = States_DefaultValue = new PlotOptionsEmaStatesHoverMarkerStates();
		...
		/// </summary>
		public PlotOptionsEmaStatesHoverMarkerStates States { get; set; }
		private PlotOptionsEmaStatesHoverMarkerStates States_DefaultValue { get; set; }
