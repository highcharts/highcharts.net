...
{
	public partial class PlotOptionsEmaStatesSelectMarker  : BaseObject
	{
		Hashtable h = new Hashtable();

		public PlotOptionsEmaStatesSelectMarker()
		{
			...
			States = States_DefaultValue = new PlotOptionsEmaStatesSelectMarkerStates();
		...
		/// </summary>
		public PlotOptionsEmaStatesSelectMarkerStates States { get; set; }
		private PlotOptionsEmaStatesSelectMarkerStates States_DefaultValue { get; set; }
