...
{
	public partial class PlotOptionsFlagsDataLabels  : BaseObject
	{
		Hashtable h = new Hashtable();

		public PlotOptionsFlagsDataLabels()
		{
			Align = Align_DefaultValue = PlotOptionsFlagsDataLabelsAlign.Center;
			...
			Filter = Filter_DefaultValue = new PlotOptionsFlagsDataLabelsFilter();
			...
			Overflow = Overflow_DefaultValue = PlotOptionsFlagsDataLabelsOverflow.Justify;
			Padding = Padding_DefaultValue = 5;
			Position = Position_DefaultValue = PlotOptionsFlagsDataLabelsPosition.Center;
			...
			TextPath = TextPath_DefaultValue = new PlotOptionsFlagsDataLabelsTextPath();
			UseHTML = UseHTML_DefaultValue = false;
			VerticalAlign = VerticalAlign_DefaultValue = PlotOptionsFlagsDataLabelsVerticalAlign.Bottom;
			X = X_DefaultValue = 0;
			Y = Y_DefaultValue = 0;
			Z = Z_DefaultValue = 6;
		...
		/// </summary>
		public PlotOptionsFlagsDataLabelsAlign Align { get; set; }
		private PlotOptionsFlagsDataLabelsAlign Align_DefaultValue { get; set; }
		...
		/// </summary>
		public PlotOptionsFlagsDataLabelsFilter Filter { get; set; }
		private PlotOptionsFlagsDataLabelsFilter Filter_DefaultValue { get; set; }
		...
		/// </summary>
		public PlotOptionsFlagsDataLabelsOverflow Overflow { get; set; }
		private PlotOptionsFlagsDataLabelsOverflow Overflow_DefaultValue { get; set; }
		...
		/// </summary>
		public PlotOptionsFlagsDataLabelsPosition Position { get; set; }
		private PlotOptionsFlagsDataLabelsPosition Position_DefaultValue { get; set; }
		...
		/// </summary>
		public PlotOptionsFlagsDataLabelsTextPath TextPath { get; set; }
		private PlotOptionsFlagsDataLabelsTextPath TextPath_DefaultValue { get; set; }
		...
		/// </summary>
		public PlotOptionsFlagsDataLabelsVerticalAlign VerticalAlign { get; set; }
		private PlotOptionsFlagsDataLabelsVerticalAlign VerticalAlign_DefaultValue { get; set; }
