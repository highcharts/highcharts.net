...
{
	public partial class PlotOptionsFlagsLastPriceLabel  : BaseObject
	{
		Hashtable h = new Hashtable();

		public PlotOptionsFlagsLastPriceLabel()
		{
			Align = Align_DefaultValue = PlotOptionsFlagsLastPriceLabelAlign.Null;
		...
		/// 
		/// </summary>
		public PlotOptionsFlagsLastPriceLabelAlign Align { get; set; }
		private PlotOptionsFlagsLastPriceLabelAlign Align_DefaultValue { get; set; }
