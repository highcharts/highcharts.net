...
{
	public partial class PlotOptionsFlagsLastVisiblePriceLabel  : BaseObject
	{
		Hashtable h = new Hashtable();

		public PlotOptionsFlagsLastVisiblePriceLabel()
		{
			Align = Align_DefaultValue = PlotOptionsFlagsLastVisiblePriceLabelAlign.Null;
		...
		/// 
		/// </summary>
		public PlotOptionsFlagsLastVisiblePriceLabelAlign Align { get; set; }
		private PlotOptionsFlagsLastVisiblePriceLabelAlign Align_DefaultValue { get; set; }
