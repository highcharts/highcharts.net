...
{
	public partial class PlotOptionsFlagsOnPoint  : BaseObject
	{
		Hashtable h = new Hashtable();

		public PlotOptionsFlagsOnPoint()
		{
			ConnectorOptions = ConnectorOptions_DefaultValue = new PlotOptionsFlagsOnPointConnectorOptions();
			Id = Id_DefaultValue = "";
			Position = Position_DefaultValue = new PlotOptionsFlagsOnPointPosition();
		...
		/// </summary>
		public PlotOptionsFlagsOnPointConnectorOptions ConnectorOptions { get; set; }
		private PlotOptionsFlagsOnPointConnectorOptions ConnectorOptions_DefaultValue { get; set; }
		...
		/// </summary>
		public PlotOptionsFlagsOnPointPosition Position { get; set; }
		private PlotOptionsFlagsOnPointPosition Position_DefaultValue { get; set; }
