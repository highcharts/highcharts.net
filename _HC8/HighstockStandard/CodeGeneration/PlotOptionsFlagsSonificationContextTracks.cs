...
{
	public partial class PlotOptionsFlagsSonificationContextTracks  : BaseObject
	{
		Hashtable h = new Hashtable();

		public PlotOptionsFlagsSonificationContextTracks()
		{
			ActiveWhen = ActiveWhen_DefaultValue = new PlotOptionsFlagsSonificationContextTracksActiveWhen();
			Instrument = Instrument_DefaultValue = null;
			InstrumentString = InstrumentString_DefaultValue = "null";
			Mapping = Mapping_DefaultValue = new PlotOptionsFlagsSonificationContextTracksMapping();
			MidiName = MidiName_DefaultValue = "";
			PointGrouping = PointGrouping_DefaultValue = new PlotOptionsFlagsSonificationContextTracksPointGrouping();
			...
			Type = Type_DefaultValue = PlotOptionsFlagsSonificationContextTracksType.Instrument;
			ValueInterval = ValueInterval_DefaultValue = null;
			ValueMapFunction = ValueMapFunction_DefaultValue = PlotOptionsFlagsSonificationContextTracksValueMapFunction.Linear;
		...
		/// </summary>
		public PlotOptionsFlagsSonificationContextTracksActiveWhen ActiveWhen { get; set; }
		private PlotOptionsFlagsSonificationContextTracksActiveWhen ActiveWhen_DefaultValue { get; set; }
		...
		/// </summary>
		public PlotOptionsFlagsSonificationContextTracksMapping Mapping { get; set; }
		private PlotOptionsFlagsSonificationContextTracksMapping Mapping_DefaultValue { get; set; }
		...
		/// </summary>
		public PlotOptionsFlagsSonificationContextTracksPointGrouping PointGrouping { get; set; }
		private PlotOptionsFlagsSonificationContextTracksPointGrouping PointGrouping_DefaultValue { get; set; }
		...
		/// </summary>
		public PlotOptionsFlagsSonificationContextTracksType Type { get; set; }
		private PlotOptionsFlagsSonificationContextTracksType Type_DefaultValue { get; set; }
		...
		/// </summary>
		public PlotOptionsFlagsSonificationContextTracksValueMapFunction ValueMapFunction { get; set; }
		private PlotOptionsFlagsSonificationContextTracksValueMapFunction ValueMapFunction_DefaultValue { get; set; }
