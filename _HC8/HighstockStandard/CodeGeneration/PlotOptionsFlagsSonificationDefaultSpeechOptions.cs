...
{
	public partial class PlotOptionsFlagsSonificationDefaultSpeechOptions  : BaseObject
	{
		Hashtable h = new Hashtable();

		public PlotOptionsFlagsSonificationDefaultSpeechOptions()
		{
			ActiveWhen = ActiveWhen_DefaultValue = new PlotOptionsFlagsSonificationDefaultSpeechOptionsActiveWhen();
			Language = Language_DefaultValue = "en-US";
			Mapping = Mapping_DefaultValue = new PlotOptionsFlagsSonificationDefaultSpeechOptionsMapping();
			PointGrouping = PointGrouping_DefaultValue = new PlotOptionsFlagsSonificationDefaultSpeechOptionsPointGrouping();
			PreferredVoice = PreferredVoice_DefaultValue = "";
			ShowPlayMarker = ShowPlayMarker_DefaultValue = true;
			Type = Type_DefaultValue = PlotOptionsFlagsSonificationDefaultSpeechOptionsType.Instrument;
		...
		/// </summary>
		public PlotOptionsFlagsSonificationDefaultSpeechOptionsActiveWhen ActiveWhen { get; set; }
		private PlotOptionsFlagsSonificationDefaultSpeechOptionsActiveWhen ActiveWhen_DefaultValue { get; set; }
		...
		/// </summary>
		public PlotOptionsFlagsSonificationDefaultSpeechOptionsMapping Mapping { get; set; }
		private PlotOptionsFlagsSonificationDefaultSpeechOptionsMapping Mapping_DefaultValue { get; set; }
		 

		/// <summary>
		/// Options for point grouping, specifically for instrument tracks.
		/// </summary>
		public PlotOptionsFlagsSonificationDefaultSpeechOptionsPointGrouping PointGrouping { get; set; }
		private PlotOptionsFlagsSonificationDefaultSpeechOptionsPointGrouping PointGrouping_DefaultValue { get; set; }
		...
		/// </summary>
		public PlotOptionsFlagsSonificationDefaultSpeechOptionsType Type { get; set; }
		private PlotOptionsFlagsSonificationDefaultSpeechOptionsType Type_DefaultValue { get; set; }
