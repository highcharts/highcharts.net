...
{
	public partial class PlotOptionsFlagsSonificationPointGrouping  : BaseObject
	{
		Hashtable h = new Hashtable();

		public PlotOptionsFlagsSonificationPointGrouping()
		{
			Algorithm = Algorithm_DefaultValue = PlotOptionsFlagsSonificationPointGroupingAlgorithm.Minimax;
		...
		/// </summary>
		public PlotOptionsFlagsSonificationPointGroupingAlgorithm Algorithm { get; set; }
		private PlotOptionsFlagsSonificationPointGroupingAlgorithm Algorithm_DefaultValue { get; set; }
