...
{
	public partial class PlotOptionsFlagsSonificationTracks  : BaseObject
	{
		Hashtable h = new Hashtable();

		public PlotOptionsFlagsSonificationTracks()
		{
			ActiveWhen = ActiveWhen_DefaultValue = new PlotOptionsFlagsSonificationTracksActiveWhen();
			Instrument = Instrument_DefaultValue = null;
			InstrumentString = InstrumentString_DefaultValue = "null";
			Mapping = Mapping_DefaultValue = new PlotOptionsFlagsSonificationTracksMapping();
			MidiName = MidiName_DefaultValue = "";
			PointGrouping = PointGrouping_DefaultValue = new PlotOptionsFlagsSonificationTracksPointGrouping();
			RoundToMusicalNotes = RoundToMusicalNotes_DefaultValue = true;
			ShowPlayMarker = ShowPlayMarker_DefaultValue = true;
			Type = Type_DefaultValue = PlotOptionsFlagsSonificationTracksType.Instrument;
		...
		/// </summary>
		public PlotOptionsFlagsSonificationTracksActiveWhen ActiveWhen { get; set; }
		private PlotOptionsFlagsSonificationTracksActiveWhen ActiveWhen_DefaultValue { get; set; }
		...
		/// </summary>
		public PlotOptionsFlagsSonificationTracksMapping Mapping { get; set; }
		private PlotOptionsFlagsSonificationTracksMapping Mapping_DefaultValue { get; set; }
		...
		/// </summary>
		public PlotOptionsFlagsSonificationTracksPointGrouping PointGrouping { get; set; }
		private PlotOptionsFlagsSonificationTracksPointGrouping PointGrouping_DefaultValue { get; set; }
		...
		/// </summary>
		public PlotOptionsFlagsSonificationTracksType Type { get; set; }
		private PlotOptionsFlagsSonificationTracksType Type_DefaultValue { get; set; }
