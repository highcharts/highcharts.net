...
{
	public partial class PlotOptionsFlagsSonificationTracksPointGrouping  : BaseObject
	{
		Hashtable h = new Hashtable();

		public PlotOptionsFlagsSonificationTracksPointGrouping()
		{
			Algorithm = Algorithm_DefaultValue = PlotOptionsFlagsSonificationTracksPointGroupingAlgorithm.Minimax;
		...
		/// </summary>
		public PlotOptionsFlagsSonificationTracksPointGroupingAlgorithm Algorithm { get; set; }
		private PlotOptionsFlagsSonificationTracksPointGroupingAlgorithm Algorithm_DefaultValue { get; set; }
