...
{
	public partial class PlotOptionsHeikinashiLastPriceLabel  : BaseObject
	{
		Hashtable h = new Hashtable();

		public PlotOptionsHeikinashiLastPriceLabel()
		{
			Align = Align_DefaultValue = PlotOptionsHeikinashiLastPriceLabelAlign.Null;
		...
		/// 
		/// </summary>
		public PlotOptionsHeikinashiLastPriceLabelAlign Align { get; set; }
		private PlotOptionsHeikinashiLastPriceLabelAlign Align_DefaultValue { get; set; }
