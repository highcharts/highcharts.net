...
{
	public partial class PlotOptionsHeikinashiSonificationDefaultInstrumentOptionsActiveWhen  : BaseObject
	{
		Hashtable h = new Hashtable();

		public PlotOptionsHeikinashiSonificationDefaultInstrumentOptionsActiveWhen()
		{
