...
{
	public partial class PlotOptionsHeikinashiSonificationTracks  : BaseObject
	{
		Hashtable h = new Hashtable();

		public PlotOptionsHeikinashiSonificationTracks()
		{
			ActiveWhen = ActiveWhen_DefaultValue = new PlotOptionsHeikinashiSonificationTracksActiveWhen();
			Instrument = Instrument_DefaultValue = null;
			InstrumentString = InstrumentString_DefaultValue = "null";
			Mapping = Mapping_DefaultValue = new PlotOptionsHeikinashiSonificationTracksMapping();
			MidiName = MidiName_DefaultValue = "";
			PointGrouping = PointGrouping_DefaultValue = new PlotOptionsHeikinashiSonificationTracksPointGrouping();
			RoundToMusicalNotes = RoundToMusicalNotes_DefaultValue = true;
			ShowPlayMarker = ShowPlayMarker_DefaultValue = true;
			Type = Type_DefaultValue = PlotOptionsHeikinashiSonificationTracksType.Instrument;
		...
		/// </summary>
		public PlotOptionsHeikinashiSonificationTracksActiveWhen ActiveWhen { get; set; }
		private PlotOptionsHeikinashiSonificationTracksActiveWhen ActiveWhen_DefaultValue { get; set; }
		...
		/// </summary>
		public PlotOptionsHeikinashiSonificationTracksMapping Mapping { get; set; }
		private PlotOptionsHeikinashiSonificationTracksMapping Mapping_DefaultValue { get; set; }
		...
		/// </summary>
		public PlotOptionsHeikinashiSonificationTracksPointGrouping PointGrouping { get; set; }
		private PlotOptionsHeikinashiSonificationTracksPointGrouping PointGrouping_DefaultValue { get; set; }
		...
		/// </summary>
		public PlotOptionsHeikinashiSonificationTracksType Type { get; set; }
		private PlotOptionsHeikinashiSonificationTracksType Type_DefaultValue { get; set; }
