...
{
	public partial class PlotOptionsHeikinashiStatesHover  : BaseObject
	{
		Hashtable h = new Hashtable();

		public PlotOptionsHeikinashiStatesHover()
		{
			Animation = Animation_DefaultValue = new Animation() { Enabled = true };
			Enabled = Enabled_DefaultValue = null;
			Halo = Halo_DefaultValue = new PlotOptionsHeikinashiStatesHoverHalo();
			LineWidth = LineWidth_DefaultValue = null;
			LineWidthPlus = LineWidthPlus_DefaultValue = null;
			Marker = Marker_DefaultValue = new PlotOptionsHeikinashiStatesHoverMarker();
		...
		/// </summary>
		public PlotOptionsHeikinashiStatesHoverHalo Halo { get; set; }
		private PlotOptionsHeikinashiStatesHoverHalo Halo_DefaultValue { get; set; }
		...
		/// </summary>
		public PlotOptionsHeikinashiStatesHoverMarker Marker { get; set; }
		private PlotOptionsHeikinashiStatesHoverMarker Marker_DefaultValue { get; set; }
