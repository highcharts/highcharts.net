...
{
	public partial class PlotOptionsHeikinashiStatesHoverMarker  : BaseObject
	{
		Hashtable h = new Hashtable();

		public PlotOptionsHeikinashiStatesHoverMarker()
		{
			...
			States = States_DefaultValue = new PlotOptionsHeikinashiStatesHoverMarkerStates();
		...
		/// </summary>
		public PlotOptionsHeikinashiStatesHoverMarkerStates States { get; set; }
		private PlotOptionsHeikinashiStatesHoverMarkerStates States_DefaultValue { get; set; }
