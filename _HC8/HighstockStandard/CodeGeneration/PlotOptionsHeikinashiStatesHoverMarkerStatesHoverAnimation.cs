...
{
	public partial class PlotOptionsHeikinashiStatesHoverMarkerStatesHoverAnimation  : BaseObject
	{
		Hashtable h = new Hashtable();

		public PlotOptionsHeikinashiStatesHoverMarkerStatesHoverAnimation()
		{
