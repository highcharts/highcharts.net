...
{
	public partial class PlotOptionsHeikinashiStatesSelect  : BaseObject
	{
		Hashtable h = new Hashtable();

		public PlotOptionsHeikinashiStatesSelect()
		{
			Animation = Animation_DefaultValue = new Animation() { Enabled = true };
			Enabled = Enabled_DefaultValue = null;
			Halo = Halo_DefaultValue = new PlotOptionsHeikinashiStatesSelectHalo();
			LineWidth = LineWidth_DefaultValue = null;
			LineWidthPlus = LineWidthPlus_DefaultValue = null;
			Marker = Marker_DefaultValue = new PlotOptionsHeikinashiStatesSelectMarker();
		...
		/// </summary>
		public PlotOptionsHeikinashiStatesSelectHalo Halo { get; set; }
		private PlotOptionsHeikinashiStatesSelectHalo Halo_DefaultValue { get; set; }
		...
		/// </summary>
		public PlotOptionsHeikinashiStatesSelectMarker Marker { get; set; }
		private PlotOptionsHeikinashiStatesSelectMarker Marker_DefaultValue { get; set; }
