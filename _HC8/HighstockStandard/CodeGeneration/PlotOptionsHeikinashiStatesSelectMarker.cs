...
{
	public partial class PlotOptionsHeikinashiStatesSelectMarker  : BaseObject
	{
		Hashtable h = new Hashtable();

		public PlotOptionsHeikinashiStatesSelectMarker()
		{
			...
			States = States_DefaultValue = new PlotOptionsHeikinashiStatesSelectMarkerStates();
		...
		/// </summary>
		public PlotOptionsHeikinashiStatesSelectMarkerStates States { get; set; }
		private PlotOptionsHeikinashiStatesSelectMarkerStates States_DefaultValue { get; set; }
