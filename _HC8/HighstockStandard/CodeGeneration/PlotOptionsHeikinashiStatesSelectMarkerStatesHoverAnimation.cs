...
{
	public partial class PlotOptionsHeikinashiStatesSelectMarkerStatesHoverAnimation  : BaseObject
	{
		Hashtable h = new Hashtable();

		public PlotOptionsHeikinashiStatesSelectMarkerStatesHoverAnimation()
		{
