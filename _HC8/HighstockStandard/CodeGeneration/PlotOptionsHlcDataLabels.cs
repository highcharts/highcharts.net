...
{
	public partial class PlotOptionsHlcDataLabels  : BaseObject
	{
		Hashtable h = new Hashtable();

		public PlotOptionsHlcDataLabels()
		{
			Align = Align_DefaultValue = PlotOptionsHlcDataLabelsAlign.Center;
			...
			Filter = Filter_DefaultValue = new PlotOptionsHlcDataLabelsFilter();
			...
			Overflow = Overflow_DefaultValue = PlotOptionsHlcDataLabelsOverflow.Justify;
			Padding = Padding_DefaultValue = 5;
			Position = Position_DefaultValue = PlotOptionsHlcDataLabelsPosition.Center;
			...
			TextPath = TextPath_DefaultValue = new PlotOptionsHlcDataLabelsTextPath();
			UseHTML = UseHTML_DefaultValue = false;
			VerticalAlign = VerticalAlign_DefaultValue = PlotOptionsHlcDataLabelsVerticalAlign.Bottom;
			X = X_DefaultValue = 0;
			Y = Y_DefaultValue = 0;
			Z = Z_DefaultValue = 6;
		...
		/// </summary>
		public PlotOptionsHlcDataLabelsAlign Align { get; set; }
		private PlotOptionsHlcDataLabelsAlign Align_DefaultValue { get; set; }
		...
		/// </summary>
		public PlotOptionsHlcDataLabelsFilter Filter { get; set; }
		private PlotOptionsHlcDataLabelsFilter Filter_DefaultValue { get; set; }
		...
		/// </summary>
		public PlotOptionsHlcDataLabelsOverflow Overflow { get; set; }
		private PlotOptionsHlcDataLabelsOverflow Overflow_DefaultValue { get; set; }
		...
		/// </summary>
		public PlotOptionsHlcDataLabelsPosition Position { get; set; }
		private PlotOptionsHlcDataLabelsPosition Position_DefaultValue { get; set; }
		...
		/// </summary>
		public PlotOptionsHlcDataLabelsTextPath TextPath { get; set; }
		private PlotOptionsHlcDataLabelsTextPath TextPath_DefaultValue { get; set; }
		...
		/// </summary>
		public PlotOptionsHlcDataLabelsVerticalAlign VerticalAlign { get; set; }
		private PlotOptionsHlcDataLabelsVerticalAlign VerticalAlign_DefaultValue { get; set; }
