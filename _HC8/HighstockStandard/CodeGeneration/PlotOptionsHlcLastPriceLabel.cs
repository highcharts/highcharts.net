...
{
	public partial class PlotOptionsHlcLastPriceLabel  : BaseObject
	{
		Hashtable h = new Hashtable();

		public PlotOptionsHlcLastPriceLabel()
		{
			Align = Align_DefaultValue = PlotOptionsHlcLastPriceLabelAlign.Null;
		...
		/// 
		/// </summary>
		public PlotOptionsHlcLastPriceLabelAlign Align { get; set; }
		private PlotOptionsHlcLastPriceLabelAlign Align_DefaultValue { get; set; }
