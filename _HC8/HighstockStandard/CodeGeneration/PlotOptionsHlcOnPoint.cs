...
{
	public partial class PlotOptionsHlcOnPoint  : BaseObject
	{
		Hashtable h = new Hashtable();

		public PlotOptionsHlcOnPoint()
		{
			ConnectorOptions = ConnectorOptions_DefaultValue = new PlotOptionsHlcOnPointConnectorOptions();
			Id = Id_DefaultValue = "";
			Position = Position_DefaultValue = new PlotOptionsHlcOnPointPosition();
		...
		/// </summary>
		public PlotOptionsHlcOnPointConnectorOptions ConnectorOptions { get; set; }
		private PlotOptionsHlcOnPointConnectorOptions ConnectorOptions_DefaultValue { get; set; }
		...
		/// </summary>
		public PlotOptionsHlcOnPointPosition Position { get; set; }
		private PlotOptionsHlcOnPointPosition Position_DefaultValue { get; set; }
