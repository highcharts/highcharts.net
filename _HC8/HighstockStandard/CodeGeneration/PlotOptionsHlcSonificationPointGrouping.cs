...
{
	public partial class PlotOptionsHlcSonificationPointGrouping  : BaseObject
	{
		Hashtable h = new Hashtable();

		public PlotOptionsHlcSonificationPointGrouping()
		{
			Algorithm = Algorithm_DefaultValue = PlotOptionsHlcSonificationPointGroupingAlgorithm.Minimax;
		...
		/// </summary>
		public PlotOptionsHlcSonificationPointGroupingAlgorithm Algorithm { get; set; }
		private PlotOptionsHlcSonificationPointGroupingAlgorithm Algorithm_DefaultValue { get; set; }
