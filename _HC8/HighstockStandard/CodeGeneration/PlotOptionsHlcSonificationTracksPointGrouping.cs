...
{
	public partial class PlotOptionsHlcSonificationTracksPointGrouping  : BaseObject
	{
		Hashtable h = new Hashtable();

		public PlotOptionsHlcSonificationTracksPointGrouping()
		{
			Algorithm = Algorithm_DefaultValue = PlotOptionsHlcSonificationTracksPointGroupingAlgorithm.Minimax;
		...
		/// </summary>
		public PlotOptionsHlcSonificationTracksPointGroupingAlgorithm Algorithm { get; set; }
		private PlotOptionsHlcSonificationTracksPointGroupingAlgorithm Algorithm_DefaultValue { get; set; }
