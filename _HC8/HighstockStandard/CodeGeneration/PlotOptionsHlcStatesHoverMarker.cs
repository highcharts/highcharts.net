...
{
	public partial class PlotOptionsHlcStatesHoverMarker  : BaseObject
	{
		Hashtable h = new Hashtable();

		public PlotOptionsHlcStatesHoverMarker()
		{
			...
			States = States_DefaultValue = new PlotOptionsHlcStatesHoverMarkerStates();
		...
		/// </summary>
		public PlotOptionsHlcStatesHoverMarkerStates States { get; set; }
		private PlotOptionsHlcStatesHoverMarkerStates States_DefaultValue { get; set; }
