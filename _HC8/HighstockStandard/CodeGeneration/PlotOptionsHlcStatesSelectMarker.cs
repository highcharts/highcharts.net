...
{
	public partial class PlotOptionsHlcStatesSelectMarker  : BaseObject
	{
		Hashtable h = new Hashtable();

		public PlotOptionsHlcStatesSelectMarker()
		{
			...
			States = States_DefaultValue = new PlotOptionsHlcStatesSelectMarkerStates();
		...
		/// </summary>
		public PlotOptionsHlcStatesSelectMarkerStates States { get; set; }
		private PlotOptionsHlcStatesSelectMarkerStates States_DefaultValue { get; set; }
