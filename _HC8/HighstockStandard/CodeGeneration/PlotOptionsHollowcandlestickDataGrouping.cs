...
{
	public partial class PlotOptionsHollowcandlestickDataGrouping  : BaseObject
	{
		Hashtable h = new Hashtable();

		public PlotOptionsHollowcandlestickDataGrouping()
		{
			...
			GroupAll = GroupAll_DefaultValue = true;
