...
{
	public partial class PlotOptionsHollowcandlestickDataLabels  : BaseObject
	{
		Hashtable h = new Hashtable();

		public PlotOptionsHollowcandlestickDataLabels()
		{
			Align = Align_DefaultValue = PlotOptionsHollowcandlestickDataLabelsAlign.Center;
			...
			Filter = Filter_DefaultValue = new PlotOptionsHollowcandlestickDataLabelsFilter();
			...
			Overflow = Overflow_DefaultValue = PlotOptionsHollowcandlestickDataLabelsOverflow.Justify;
			Padding = Padding_DefaultValue = 5;
			Position = Position_DefaultValue = PlotOptionsHollowcandlestickDataLabelsPosition.Center;
			...
			TextPath = TextPath_DefaultValue = new PlotOptionsHollowcandlestickDataLabelsTextPath();
			UseHTML = UseHTML_DefaultValue = false;
			VerticalAlign = VerticalAlign_DefaultValue = PlotOptionsHollowcandlestickDataLabelsVerticalAlign.Bottom;
			X = X_DefaultValue = 0;
			Y = Y_DefaultValue = 0;
			Z = Z_DefaultValue = 6;
		...
		/// </summary>
		public PlotOptionsHollowcandlestickDataLabelsAlign Align { get; set; }
		private PlotOptionsHollowcandlestickDataLabelsAlign Align_DefaultValue { get; set; }
		...
		/// </summary>
		public PlotOptionsHollowcandlestickDataLabelsFilter Filter { get; set; }
		private PlotOptionsHollowcandlestickDataLabelsFilter Filter_DefaultValue { get; set; }
		...
		/// </summary>
		public PlotOptionsHollowcandlestickDataLabelsOverflow Overflow { get; set; }
		private PlotOptionsHollowcandlestickDataLabelsOverflow Overflow_DefaultValue { get; set; }
		...
		/// </summary>
		public PlotOptionsHollowcandlestickDataLabelsPosition Position { get; set; }
		private PlotOptionsHollowcandlestickDataLabelsPosition Position_DefaultValue { get; set; }
		...
		/// </summary>
		public PlotOptionsHollowcandlestickDataLabelsTextPath TextPath { get; set; }
		private PlotOptionsHollowcandlestickDataLabelsTextPath TextPath_DefaultValue { get; set; }
		...
		/// </summary>
		public PlotOptionsHollowcandlestickDataLabelsVerticalAlign VerticalAlign { get; set; }
		private PlotOptionsHollowcandlestickDataLabelsVerticalAlign VerticalAlign_DefaultValue { get; set; }
