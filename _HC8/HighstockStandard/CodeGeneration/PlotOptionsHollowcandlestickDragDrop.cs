...
{
	public partial class PlotOptionsHollowcandlestickDragDrop  : BaseObject
	{
		Hashtable h = new Hashtable();

		public PlotOptionsHollowcandlestickDragDrop()
		{
			DraggableX = DraggableX_DefaultValue = null;
			DraggableY = DraggableY_DefaultValue = null;
			DragHandle = DragHandle_DefaultValue = new PlotOptionsHollowcandlestickDragDropDragHandle();
			...
			GuideBox = GuideBox_DefaultValue = new PlotOptionsHollowcandlestickDragDropGuideBox();
		...
		/// </summary>
		public PlotOptionsHollowcandlestickDragDropDragHandle DragHandle { get; set; }
		private PlotOptionsHollowcandlestickDragDropDragHandle DragHandle_DefaultValue { get; set; }
		...
		/// </summary>
		public PlotOptionsHollowcandlestickDragDropGuideBox GuideBox { get; set; }
		private PlotOptionsHollowcandlestickDragDropGuideBox GuideBox_DefaultValue { get; set; }
