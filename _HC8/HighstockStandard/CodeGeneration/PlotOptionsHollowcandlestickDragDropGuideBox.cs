...
namespace Highsoft.Web.Mvc.Stocks
{
	public partial class PlotOptionsHollowcandlestickDragDropGuideBox  : BaseObject
	{
		...
		{
			Default = Default_DefaultValue = new PlotOptionsHollowcandlestickDragDropGuideBoxDefault();
		...
		private PlotOptionsHollowcandlestickDragDropGuideBoxDefault Default_DefaultValue { get; set; }
